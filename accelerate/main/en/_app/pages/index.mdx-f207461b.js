import{S as ba,i as Pa,s as ka,e as o,k as n,w as f,t as p,M as Ea,c as i,d as t,m as c,a as s,x as y,h as m,b as u,F as a,g as l,y as _,L as Aa,q as v,o as w,B as g,v as za}from"../chunks/vendor-19e06bd2.js";import{I as Pe}from"../chunks/IconCopyLink-3c713d38.js";import{C as Z}from"../chunks/CodeBlock-9dd1fdfb.js";function ja(Mt){let $,ke,b,z,ee,N,tt,te,at,Ee,j,rt,ae,ot,it,Ae,P,U,re,C,st,oe,lt,ze,x,ie,se,nt,ct,le,ne,pt,je,k,S,ce,G,mt,pe,ut,Ue,B,dt,xe,F,Se,Y,ht,Le,q,Te,K,ft,Ie,Q,yt,Ne,M,Ce,E,L,me,H,_t,ue,vt,Ge,T,wt,de,gt,$t,Fe,V,bt,qe,J,Me,W,Pt,He,O,Je,X,kt,Oe,R,Re,A,I,he,D,Et,fe,At,De,d,ye,zt,jt,_e,Ut,xt,ve,St,Lt,we,Tt,It,ge,Nt,Ct,$e,Gt,Ft,be,qt,Be;return N=new Pe({}),C=new Pe({}),G=new Pe({}),F=new Z({props:{code:`my_model.to(device)
