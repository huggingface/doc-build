import{S as vl,i as $l,s as kl,e as n,k as c,w as h,t as o,M as yl,c as i,d as t,m as d,a as p,x as u,h as r,b,F as a,g as l,y as m,q as f,o as _,B as w,v as jl,O as zl}from"../../chunks/vendor-e7c81d8a.js";import{T as wl}from"../../chunks/Tip-989931f5.js";import{Y as bl}from"../../chunks/Youtube-365ea064.js";import{I as Ht}from"../../chunks/WidgetTextarea.svelte_svelte_type_style_lang-08e92eaf.js";import{C as v}from"../../chunks/CodeBlock-105940ae.js";import{D as El}from"../../chunks/DocNotebookDropdown-928568b4.js";const{document:gl}=zl;function ql(Ie){let g,y,$,E,W;return{c(){g=n("p"),y=o("\u270F\uFE0F "),$=n("strong"),E=o("Try it out!"),W=o(" Modify the previous training loop to fine-tune your model on the SST-2 dataset.")},l(z){g=i(z,"P",{});var C=p(g);y=r(C,"\u270F\uFE0F "),$=i(C,"STRONG",{});var U=p($);E=r(U,"Try it out!"),U.forEach(t),W=r(C," Modify the previous training loop to fine-tune your model on the SST-2 dataset."),C.forEach(t)},m(z,C){l(z,g,C),a(g,y),a(g,$),a($,E),a(g,W)},d(z){z&&t(g)}}}function Al(Ie){let g;return{c(){g=o('\u26A0\uFE0F In order to benefit from the speed-up offered by Cloud TPUs, we recommend padding your samples to a fixed length with the `padding="max_length"` and `max_length` arguments of the tokenizer.')},l(y){g=r(y,'\u26A0\uFE0F In order to benefit from the speed-up offered by Cloud TPUs, we recommend padding your samples to a fixed length with the `padding="max_length"` and `max_length` arguments of the tokenizer.')},m(y,$){l(y,g,$)},d(y){y&&t(g)}}}function Tl(Ie){let g,y,$,E,W,z,C,U,hs,Bt,ie,Gt,pe,Rt,I,us,st,ms,fs,Yt,ce,Jt,O,H,ot,de,_s,rt,ws,Qt,x,bs,lt,gs,vs,nt,$s,ks,Kt,S,N,ys,it,js,zs,pt,Es,qs,As,P,Ts,ct,Ps,Cs,dt,xs,Ss,ht,Ds,Ws,Os,ut,Ns,Vt,B,Ms,mt,Fs,Ls,Xt,he,Zt,He,Us,ea,ue,ta,Be,Is,aa,me,sa,Ge,Hs,oa,fe,ra,_e,la,G,Bs,ft,Gs,Rs,na,Re,Ys,ia,we,pa,Ye,Js,ca,be,da,ge,ha,R,Qs,_t,Ks,Vs,ua,j,Xs,wt,Zs,eo,bt,to,ao,gt,so,oo,ve,ro,lo,ma,$e,fa,Y,no,vt,io,po,_a,ke,wa,ye,ba,M,J,$t,je,co,kt,ho,ga,Q,uo,yt,mo,fo,va,ze,$a,Ee,ka,K,_o,jt,wo,bo,ya,qe,ja,Je,go,za,F,V,zt,Ae,vo,Et,$o,Ea,q,ko,qt,yo,jo,At,zo,Eo,Tt,qo,Ao,qa,Te,Aa,Pe,Ta,Qe,To,Pa,X,Ca,L,Z,Pt,Ce,Po,Ct,Co,xa,xe,Sa,ee,xo,Se,So,Do,Da,De,Wa,Ke,Wo,Oa,We,Na,A,Oo,xt,No,Mo,St,Fo,Lo,Dt,Uo,Io,Ma,k,Ho,Wt,Bo,Go,Ot,Ro,Yo,Nt,Jo,Qo,Mt,Ko,Vo,Ft,Xo,Zo,Fa,te,La,Ve,er,Ua,Oe,Ia,ae,tr,Lt,ar,sr,Ha,Ne,Ba,Xe,or,Ga,Me,Ra,Ze,rr,Ya,se,lr,Ut,nr,ir,Ja,Fe,Qa,oe,pr,Le,cr,dr,Ka;return z=new Ht({}),ie=new El({props:{classNames:"absolute z-10 right-0 top-0",options:[{label:"Google Colab",value:"https://colab.research.google.com/github/huggingface/notebooks/blob/master/course/chapter3/section4.ipynb"},{label:"Aws Studio",value:"https://studiolab.sagemaker.aws/import/github/huggingface/notebooks/blob/master/course/chapter3/section4.ipynb"}]}}),pe=new bl({props:{id:"Dh9CL8fyG80"}}),ce=new v({props:{codee:`from datasets import load_dataset
...
data_collator = DataCollatorWithPadding(tokenizer=tokenizer)`}}),de=new Ht({}),he=new v({props:{codee:`tokenized_datasets = tokenized_datasets.remove_columns(["sentence1", "sentence2", "idx"])
...
tokenized_datasets[<span class="hljs-string">&quot;train&quot;</span>].column_names`}}),ue=new v({props:{codee:'["attention_mask", "input_ids", "labels", "token_type_ids"],',highlighted:'[<span class="hljs-string">&quot;attention_mask&quot;</span>, <span class="hljs-string">&quot;input_ids&quot;</span>, <span class="hljs-string">&quot;labels&quot;</span>, <span class="hljs-string">&quot;token_type_ids&quot;</span>]'}}),me=new v({props:{codee:`from torch.utils.data import DataLoader
...
)`}}),fe=new v({props:{codee:`for batch in train_dataloader:
    break
...
{k: v.shape <span class="hljs-keyword">for</span> k, v <span class="hljs-keyword">in</span> batch.items()}`}}),_e=new v({props:{codee:`{'attention_mask': torch.Size([8, 65]),
 ...
 <span class="hljs-string">&#x27;token_type_ids&#x27;</span>: torch.Size([<span class="hljs-number">8</span>, <span class="hljs-number">65</span>])}`}}),we=new v({props:{codee:`from transformers import AutoModelForSequenceClassification
...
model = AutoModelForSequenceClassification.from_pretrained(checkpoint, num_labels=<span class="hljs-number">2</span>)`}}),be=new v({props:{codee:`outputs = model(**batch)
print(outputs.loss, outputs.logits.shape),`,highlighted:`outputs = model(**batch)
<span class="hljs-built_in">print</span>(outputs.loss, outputs.logits.shape)`}}),ge=new v({props:{codee:"tensor(0.5441, grad_fn=<NllLossBackward>) torch.Size([8, 2]),",highlighted:'tensor(<span class="hljs-number">0.5441</span>, grad_fn=&lt;NllLossBackward&gt;) torch.Size([<span class="hljs-number">8</span>, <span class="hljs-number">2</span>])'}}),$e=new v({props:{codee:`from transformers import AdamW
...
optimizer = AdamW(model.parameters(), lr=<span class="hljs-number">5e-5</span>)`}}),ke=new v({props:{codee:`from transformers import get_scheduler
...
<span class="hljs-built_in">print</span>(num_training_steps)`}}),ye=new v({props:{codee:"1377,",highlighted:'<span class="hljs-number">1377</span>'}}),je=new Ht({}),ze=new v({props:{codee:`import torch
...
model.to(device)
device`}}),Ee=new v({props:{codee:"device(type='cuda'),",highlighted:'device(<span class="hljs-built_in">type</span>=<span class="hljs-string">&#x27;cuda&#x27;</span>)'}}),qe=new v({props:{codee:`from tqdm.auto import tqdm
...
<span class="hljs-keyword">for</span> epoch <span class="hljs-keyword">in</span> <span class="hljs-built_in">range</span>(num_epochs):
    <span class="hljs-keyword">for</span> batch <span class="hljs-keyword">in</span> train_dataloader:
        ...
        lr_scheduler.step()
        optimizer.zero_grad()
        progress_bar.update(<span class="hljs-number">1</span>)`}}),Ae=new Ht({}),Te=new v({props:{codee:`from datasets import load_metric
...
metric.compute()`}}),Pe=new v({props:{codee:"{'accuracy': 0.8431372549019608, 'f1': 0.8907849829351535},",highlighted:'{<span class="hljs-string">&#x27;accuracy&#x27;</span>: <span class="hljs-number">0.8431372549019608</span>, <span class="hljs-string">&#x27;f1&#x27;</span>: <span class="hljs-number">0.8907849829351535</span>}'}}),X=new wl({props:{$$slots:{default:[ql]},$$scope:{ctx:Ie}}}),Ce=new Ht({}),xe=new bl({props:{id:"s7dy8QRgjJ0"}}),De=new v({props:{codee:`from transformers import AdamW, AutoModelForSequenceClassification, get_scheduler
...
<span class="hljs-keyword">for</span> epoch <span class="hljs-keyword">in</span> <span class="hljs-built_in">range</span>(num_epochs):
    <span class="hljs-keyword">for</span> batch <span class="hljs-keyword">in</span> train_dataloader:
        ...
        lr_scheduler.step()
        optimizer.zero_grad()
        progress_bar.update(<span class="hljs-number">1</span>)`}}),We=new v({props:{codee:`+ from accelerate import Accelerator
...
<span class="hljs-addition">+         accelerator.backward(loss)</span>
          ...
          lr_scheduler.step()
          optimizer.zero_grad()
          progress_bar.update(1)`}}),te=new wl({props:{$$slots:{default:[Al]},$$scope:{ctx:Ie}}}),Oe=new v({props:{codee:`from accelerate import Accelerator
from transformers import AdamW, AutoModelForSequenceClassification, get_scheduler
...
<span class="hljs-keyword">for</span> epoch <span class="hljs-keyword">in</span> <span class="hljs-built_in">range</span>(num_epochs):
    <span class="hljs-keyword">for</span> batch <span class="hljs-keyword">in</span> train_dl:
        ...
        lr_scheduler.step()
        optimizer.zero_grad()
        progress_bar.update(<span class="hljs-number">1</span>)`}}),Ne=new v({props:{codee:"accelerate config,",highlighted:"accelerate config"}}),Me=new v({props:{codee:"accelerate launch train.py,",highlighted:'accelerate <span class="hljs-built_in">launch</span> train.py'}}),Fe=new v({props:{codee:`from accelerate import notebook_launcher
