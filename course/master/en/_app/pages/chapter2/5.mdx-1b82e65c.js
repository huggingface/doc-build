import{S as Go,i as Yo,s as Jo,e as u,k as d,w,t as f,M as Qo,c,d as o,m as b,x as j,a as h,h as m,b as q,F as a,g as i,y as v,o as k,p as fe,q as g,B as y,v as Ko,O as Vo,n as me}from"../../chunks/vendor-e7c81d8a.js";import{T as Bo}from"../../chunks/Tip-989931f5.js";import{Y as Uo}from"../../chunks/Youtube-365ea064.js";import{I as Hs}from"../../chunks/WidgetTextarea.svelte_svelte_type_style_lang-08e92eaf.js";import{C as E}from"../../chunks/CodeBlock-105940ae.js";import{D as Ro}from"../../chunks/DocNotebookDropdown-928568b4.js";import{F as Xo}from"../../chunks/FrameworkSwitch-287292d8.js";const{document:Wo}=Vo;function Zo($){let n,r;return n=new Ro({props:{classNames:"absolute z-10 right-0 top-0",options:[{label:"Google Colab",value:"https://colab.research.google.com/github/huggingface/notebooks/blob/master/course/chapter2/section5_tf.ipynb"},{label:"Aws Studio",value:"https://studiolab.sagemaker.aws/import/github/huggingface/notebooks/blob/master/course/chapter2/section5_tf.ipynb"}]}}),{c(){w(n.$$.fragment)},l(s){j(n.$$.fragment,s)},m(s,p){v(n,s,p),r=!0},i(s){r||(g(n.$$.fragment,s),r=!0)},o(s){k(n.$$.fragment,s),r=!1},d(s){y(n,s)}}}function ea($){let n,r;return n=new Ro({props:{classNames:"absolute z-10 right-0 top-0",options:[{label:"Google Colab",value:"https://colab.research.google.com/github/huggingface/notebooks/blob/master/course/chapter2/section5_pt.ipynb"},{label:"Aws Studio",value:"https://studiolab.sagemaker.aws/import/github/huggingface/notebooks/blob/master/course/chapter2/section5_pt.ipynb"}]}}),{c(){w(n.$$.fragment)},l(s){j(n.$$.fragment,s)},m(s,p){v(n,s,p),r=!0},i(s){r||(g(n.$$.fragment,s),r=!0)},o(s){k(n.$$.fragment,s),r=!1},d(s){y(n,s)}}}function sa($){let n,r;return n=new Uo({props:{id:"ROxrFOEbsQE"}}),{c(){w(n.$$.fragment)},l(s){j(n.$$.fragment,s)},m(s,p){v(n,s,p),r=!0},i(s){r||(g(n.$$.fragment,s),r=!0)},o(s){k(n.$$.fragment,s),r=!1},d(s){y(n,s)}}}function ta($){let n,r;return n=new Uo({props:{id:"M6adb1j2jPI"}}),{c(){w(n.$$.fragment)},l(s){j(n.$$.fragment,s)},m(s,p){v(n,s,p),r=!0},i(s){r||(g(n.$$.fragment,s),r=!0)},o(s){k(n.$$.fragment,s),r=!1},d(s){y(n,s)}}}function na($){let n,r,s,p;return n=new E({props:{codee:`import tensorflow as tf
...
input_ids = torch.tensor(ids)
<span class="hljs-comment"># This line will fail.</span>
model(input_ids)`}}),s=new E({props:{codee:"IndexError: Dimension out of range (expected to be in range of [-1, 0], but got 1),",highlighted:'IndexError: Dimension out of <span class="hljs-built_in">range</span> (expected to be <span class="hljs-keyword">in</span> <span class="hljs-built_in">range</span> of [-<span class="hljs-number">1</span>, <span class="hljs-number">0</span>], but got <span class="hljs-number">1</span>)'}}),{c(){w(n.$$.fragment),r=d(),w(s.$$.fragment)},l(t){j(n.$$.fragment,t),r=b(t),j(s.$$.fragment,t)},m(t,_){v(n,t,_),i(t,r,_),v(s,t,_),p=!0},i(t){p||(g(n.$$.fragment,t),g(s.$$.fragment,t),p=!0)},o(t){k(n.$$.fragment,t),k(s.$$.fragment,t),p=!1},d(t){y(n,t),t&&o(r),y(s,t)}}}function aa($){let n,r,s,p;return n=new E({props:{codee:`tokenized_inputs = tokenizer(sequence, return_tensors="tf")
...
<span class="hljs-built_in">print</span>(tokenized_inputs[<span class="hljs-string">&quot;input_ids&quot;</span>])`}}),s=new E({props:{codee:`<tf.Tensor: shape=(1, 16), dtype=int32, numpy=
...
<span class="hljs-built_in">print</span>(tokenized_inputs[<span class="hljs-string">&quot;input_ids&quot;</span>])`}}),s=new E({props:{codee:`tensor([[  101,  1045,  1005,  2310,  2042,  3403,  2005,  1037, 17662, 12172,
...
output = model(input_ids)
<span class="hljs-built_in">print</span>(<span class="hljs-string">&quot;Logits:&quot;</span>, output.logits)`}}),{c(){w(n.$$.fragment)},l(s){j(n.$$.fragment,s)},m(s,p){v(n,s,p),r=!0},i(s){r||(g(n.$$.fragment,s),r=!0)},o(s){k(n.$$.fragment,s),r=!1},d(s){y(n,s)}}}function ia($){let n,r;return n=new E({props:{codee:`import torch
from transformers import AutoTokenizer, AutoModelForSequenceClassification
...
output = model(input_ids)
<span class="hljs-built_in">print</span>(<span class="hljs-string">&quot;Logits:&quot;</span>, output.logits)`}}),{c(){w(n.$$.fragment)},l(s){j(n.$$.fragment,s)},m(s,p){v(n,s,p),r=!0},i(s){r||(g(n.$$.fragment,s),r=!0)},o(s){k(n.$$.fragment,s),r=!1},d(s){y(n,s)}}}function pa($){let n,r;return n=new E({props:{codee:`Input IDs: tf.Tensor(
...
Logits: tf.Tensor([[-<span class="hljs-number">2.7276208</span>  <span class="hljs-number">2.8789377</span>]], shape=(<span class="hljs-number">1</span>, <span class="hljs-number">2</span>), dtype=float32)`}}),{c(){w(n.$$.fragment)},l(s){j(n.$$.fragment,s)},m(s,p){v(n,s,p),r=!0},i(s){r||(g(n.$$.fragment,s),r=!0)},o(s){k(n.$$.fragment,s),r=!1},d(s){y(n,s)}}}function ua($){let n,r;return n=new E({props:{codee:`Input IDs: [[ 1045,  1005,  2310,  2042,  3403,  2005,  1037, 17662, 12172,  2607, 2026,  2878,  2166,  1012]]
...
Logits: [[-<span class="hljs-number">2.7276</span>,  <span class="hljs-number">2.8789</span>]]`}}),{c(){w(n.$$.fragment)},l(s){j(n.$$.fragment,s)},m(s,p){v(n,s,p),r=!0},i(s){r||(g(n.$$.fragment,s),r=!0)},o(s){k(n.$$.fragment,s),r=!1},d(s){y(n,s)}}}function ca($){let n,r,s,p,t,_,T,z;return{c(){n=u("p"),r=f("\u270F\uFE0F "),s=u("strong"),p=f("Try it out!"),t=f(" Convert this "),_=u("code"),T=f("batched_ids"),z=f(" list into a tensor and pass it through your model. Check that you obtain the same logits as before (but twice)!")},l(K){n=c(K,"P",{});var A=h(n);r=m(A,"\u270F\uFE0F "),s=c(A,"STRONG",{});var Ne=h(s);p=m(Ne,"Try it out!"),Ne.forEach(o),t=m(A," Convert this "),_=c(A,"CODE",{});var de=h(_);T=m(de,"batched_ids"),de.forEach(o),z=m(A," list into a tensor and pass it through your model. Check that you obtain the same logits as before (but twice)!"),A.forEach(o)},m(K,A){i(K,n,A),a(n,r),a(n,s),a(s,p),a(n,t),a(n,_),a(_,T),a(n,z)},d(K){K&&o(n)}}}function ha($){let n,r,s,p;return n=new E({props:{codee:`model = TFAutoModelForSequenceClassification.from_pretrained(checkpoint)
...
<span class="hljs-built_in">print</span>(model(tf.constant(batched_ids)).logits)`}}),s=new E({props:{codee:`tf.Tensor([[ 1.5693678 -1.3894581]], shape=(1, 2), dtype=float32)
...
<span class="hljs-built_in">print</span>(model(torch.tensor(batched_ids)).logits)`}}),s=new E({props:{codee:`tensor([[ 1.5694, -1.3895]], grad_fn=<AddmmBackward>)
...
outputs = model(torch.tensor(batched_ids), attention_mask=torch.tensor(attention_mask))
<span class="hljs-built_in">print</span>(outputs.logits)`}}),s=new E({props:{codee:`tensor([[ 1.5694, -1.3895],
        ...
        [ <span class="hljs-number">0.5803</span>, -<span class="hljs-number">0.4125</span>]], grad_fn=&lt;AddmmBackward&gt;)`}}),{c(){w(n.$$.fragment),r=d(),w(s.$$.fragment)},l(t){j(n.$$.fragment,t),r=b(t),j(s.$$.fragment,t)},m(t,_){v(n,t,_),i(t,r,_),v(s,t,_),p=!0},i(t){p||(g(n.$$.fragment,t),g(s.$$.fragment,t),p=!0)},o(t){k(n.$$.fragment,t),k(s.$$.fragment,t),p=!1},d(t){y(n,t),t&&o(r),y(s,t)}}}function ba($){let n,r,s,p,t;return{c(){n=u("p"),r=f("\u270F\uFE0F "),s=u("strong"),p=f("Try it out!"),t=f(" Apply the tokenization manually on the two sentences used in section 2 (\u201CI\u2019ve been waiting for a HuggingFace course my whole life.\u201D and \u201CI hate this so much!\u201D). Pass them through the model and check that you get the same logits as in section 2. Now batch them together using the padding token, then create the proper attention mask. Check that you obtain the same results when going through the model!")},l(_){n=c(_,"P",{});var T=h(n);r=m(T,"\u270F\uFE0F "),s=c(T,"STRONG",{});var z=h(s);p=m(z,"Try it out!"),z.forEach(o),t=m(T," Apply the tokenization manually on the two sentences used in section 2 (\u201CI\u2019ve been waiting for a HuggingFace course my whole life.\u201D and \u201CI hate this so much!\u201D). Pass them through the model and check that you get the same logits as in section 2. Now batch them together using the padding token, then create the proper attention mask. Check that you obtain the same results when going through the model!"),T.forEach(o)},m(_,T){i(_,n,T),a(n,r),a(n,s),a(s,p),a(n,t)},d(_){_&&o(n)}}}function _a($){let n,r,s,p,t,_,T,z,K,A,Ne,de,x,P,He,M,S,Oe,Be,Ft,Os,I,bs,xt,Pt,be,Mt,_s,St,Ct,Lt,ks,Dt,Nt,gs,Ht,Bs,We,Ot,Ws,V,se,$s,_e,Bt,ws,Wt,Us,Ue,Ut,Rs,C,L,Re,Ge,Rt,Gs,te,Gt,js,Yt,Jt,Ys,D,N,Ye,Je,Qt,Js,H,O,Qe,Ke,Kt,Qs,B,W,Ve,ke,vs,Vt,Xt,Ks,ge,Vs,Xe,Zt,Xs,ne,Zs,oe,en,ys,sn,tn,et,X,ae,qs,$e,nn,Es,on,st,Ze,an,tt,we,nt,J,ln,Ts,rn,pn,zs,un,cn,ot,je,at,le,hn,As,fn,mn,lt,U,R,es,ss,dn,rt,re,bn,Is,_n,kn,it,Z,ie,Fs,ve,gn,xs,$n,pt,ye,Ps,wn,jn,ut,ts,vn,ct,G,Y,ns,os,yn,ht,as,qn,ft,pe,mt,ee,ue,Ms,qe,En,Ss,Tn,dt,ls,zn,bt,ce,Cs,An,In,Ls,Fn,_t,Q,xn,Ee,Pn,Mn,Te,Sn,Cn,kt,he,Ln,Ds,Dn,Nn,gt,ze,$t;s=new Xo({props:{fw:$[0]}}),z=new Hs({});const Bn=[ea,Zo],Ae=[];function Wn(e,l){return e[0]==="pt"?0:1}x=Wn($),P=Ae[x]=Bn[x]($);const Un=[ta,sa],Ie=[];function Rn(e,l){return e[0]==="pt"?0:1}M=Rn($),S=Ie[M]=Un[M]($),_e=new Hs({});const Gn=[oa,na],Fe=[];function Yn(e,l){return e[0]==="pt"?0:1}C=Yn($),L=Fe[C]=Gn[C]($);const Jn=[la,aa],xe=[];function Qn(e,l){return e[0]==="pt"?0:1}D=Qn($),N=xe[D]=Jn[D]($);const Kn=[ia,ra],Pe=[];function Vn(e,l){return e[0]==="pt"?0:1}H=Vn($),O=Pe[H]=Kn[H]($);const Xn=[ua,pa],Me=[];function Zn(e,l){return e[0]==="pt"?0:1}B=Zn($),W=Me[B]=Xn[B]($),ge=new E({props:{codee:"batched_ids = [ids, ids],",highlighted:'<span class="hljs-attr">batched_ids</span> = [ids, ids]'}}),ne=new Bo({props:{$$slots:{default:[ca]},$$scope:{ctx:$}}}),$e=new Hs({}),we=new E({props:{codee:`batched_ids = [
    [200, 200, 200],
    [200, 200]
],`,highlighted:`batched_ids = [
    [<span class="hljs-number">200</span>, <span class="hljs-number">200</span>, <span class="hljs-number">200</span>],
    [<span class="hljs-number">200</span>, <span class="hljs-number">200</span>]
]`}}),je=new E({props:{codee:`padding_id = 100
