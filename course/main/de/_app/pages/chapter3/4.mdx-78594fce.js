import{S as fi,i as _i,s as gi,e as l,k as p,w as u,t as r,M as bi,c as o,d as s,m as c,a as d,x as m,h as a,b,F as t,g as i,y as h,q as f,o as _,B as g,v as wi}from"../../chunks/vendor-e6c5d93e.js";import{D as vi,Y as mi,T as hi}from"../../chunks/DocNotebookDropdown-b3e38740.js";import{I as Zs}from"../../chunks/IconCopyLink-7b8d27fe.js";import{C as v}from"../../chunks/CodeBlock-37867453.js";function ki(Ze){let w,z,k,E,M;return{c(){w=l("p"),z=r("\u270F\uFE0F "),k=l("strong"),E=r("Probier es selbt!"),M=r(" \xC4ndere die vorherige Trainingsschleife, um dein Modell auf dem SST-2-Datensatz fein zu tunen.")},l(j){w=o(j,"P",{});var S=d(w);z=a(S,"\u270F\uFE0F "),k=o(S,"STRONG",{});var U=d(k);E=a(U,"Probier es selbt!"),U.forEach(s),M=a(S," \xC4ndere die vorherige Trainingsschleife, um dein Modell auf dem SST-2-Datensatz fein zu tunen."),S.forEach(s)},m(j,S){i(j,w,S),t(w,z),t(w,k),t(k,E),t(w,M)},d(j){j&&s(w)}}}function $i(Ze){let w;return{c(){w=r('\u26A0\uFE0F Um von dem Geschwindigkeitsvorteil der Cloud TPUs zu profitieren, empfehlen wir, deine Samples mit den Argumenten `padding="max_length"` und `max_length` des Tokenizers auf eine feste L\xE4nge aufzuf\xFCllen.')},l(z){w=a(z,'\u26A0\uFE0F Um von dem Geschwindigkeitsvorteil der Cloud TPUs zu profitieren, empfehlen wir, deine Samples mit den Argumenten `padding="max_length"` und `max_length` des Tokenizers auf eine feste L\xE4nge aufzuf\xFCllen.')},m(z,k){i(z,w,k)},d(z){z&&s(w)}}}function zi(Ze){let w,z,k,E,M,j,S,U,un,Gs,oe,Hs,de,Ns,F,mn,ns,hn,fn,Is,pe,Vs,x,Z,rs,ce,_n,as,gn,Ks,C,bn,is,wn,vn,ls,kn,$n,Rs,P,W,zn,os,jn,En,ds,An,Dn,yn,q,Tn,ps,qn,Sn,cs,Cn,Pn,us,Mn,xn,Wn,ms,On,Js,G,Bn,hs,Ln,Un,Ys,ue,Qs,Ge,Fn,Xs,me,et,He,Zn,st,he,tt,Ne,Gn,nt,fe,rt,_e,at,H,Hn,fs,Nn,In,it,Ie,Vn,lt,ge,ot,Ve,Kn,dt,be,pt,we,ct,N,Rn,_s,Jn,Yn,ut,A,Qn,gs,Xn,er,bs,sr,tr,ve,nr,rr,mt,ke,ht,I,ar,ws,ir,lr,ft,$e,_t,ze,gt,O,V,vs,je,or,ks,dr,bt,K,pr,$s,cr,ur,wt,Ee,vt,Ae,kt,R,mr,zs,hr,fr,$t,De,zt,Ke,_r,jt,B,J,js,ye,gr,Es,br,Et,D,wr,As,vr,kr,Ds,$r,zr,ys,jr,Er,At,Te,Dt,qe,yt,Re,Ar,Tt,Y,qt,L,Q,Ts,Se,Dr,qs,yr,St,Ce,Ct,X,Tr,Pe,qr,Sr,Pt,Me,Mt,Je,Cr,xt,xe,Wt,y,Pr,Ss,Mr,xr,Cs,Wr,Or,Ps,Br,Lr,Ot,$,Ur,Ms,Fr,Zr,xs,Gr,Hr,Ws,Nr,Ir,Os,Vr,Kr,Bs,Rr,Jr,Bt,ee,Lt,Ye,Yr,Ut,We,Ft,se,Qr,Ls,Xr,ea,Zt,Oe,Gt,Qe,sa,Ht,Be,Nt,Xe,ta,It,te,na,Us,ra,aa,Vt,Le,Kt,ne,ia,Ue,la,oa,Rt;return j=new Zs({}),oe=new vi({props:{classNames:"absolute z-10 right-0 top-0",options:[{label:"Google Colab",value:"https://colab.research.google.com/github/huggingface/notebooks/blob/master/course/chapter3/section4.ipynb"},{label:"Aws Studio",value:"https://studiolab.sagemaker.aws/import/github/huggingface/notebooks/blob/master/course/chapter3/section4.ipynb"}]}}),de=new mi({props:{id:"Dh9CL8fyG80"}}),pe=new v({props:{code:`from datasets import load_dataset
...
<span class="hljs-built_in">print</span>(num_training_steps)`}}),ze=new v({props:{code:"1377",highlighted:'<span class="hljs-number">1377</span>'}}),je=new Zs({}),Ee=new v({props:{code:`import torch
...
<span class="hljs-keyword">for</span> epoch <span class="hljs-keyword">in</span> <span class="hljs-built_in">range</span>(num_epochs):
    <span class="hljs-keyword">for</span> batch <span class="hljs-keyword">in</span> train_dataloader:
        ...
        lr_scheduler.step()
        optimizer.zero_grad()
        progress_bar.update(<span class="hljs-number">1</span>)`}}),ye=new Zs({}),Te=new v({props:{code:`from datasets import load_metric
...
<span class="hljs-addition">+         accelerator.backward(loss)</span>
          ...
          lr_scheduler.step()
          optimizer.zero_grad()
          progress_bar.update(1)`}}),ee=new hi({props:{$$slots:{default:[$i]},$$scope:{ctx:Ze}}}),We=new v({props:{code:`from accelerate import Accelerator
from transformers import AdamW, AutoModelForSequenceClassification, get_scheduler
