...
If the revision to download from cannot be found.`),C.forEach(t),S.forEach(t),this.h()},h(){w(r,"href","/docs/huggingface_hub/v0.8.1/en/package_reference/utilities#huggingface_hub.utils.RepositoryNotFoundError"),w(I,"href","/docs/huggingface_hub/v0.8.1/en/package_reference/utilities#huggingface_hub.utils.RevisionNotFoundError")},m(_,L){v(_,l,L),e(l,b),v(_,f,L),v(_,i,L),e(i,d),e(d,r),e(r,m),e(d,N),e(d,u),e(u,y),e(d,A),e(i,k),e(i,E),e(E,I),e(I,P),e(E,O)},d(_){_&&t(l),_&&t(f),_&&t(i)}}}function wi(U){let l,b,f,i,d,r,m,N,u,y,A,k,E,I,P,O,_,L,S,M,V,G,C,W,Z,J,re,ee,Q,X,Y,me,_e;return{c(){l=a("p"),b=c("Raises the following errors:"),f=g(),i=a("ul"),d=a("li"),r=a("a"),m=a("code"),N=c("HTTPError"),u=c(`
...
Setting it to 2 means at most 2 files will be uploaded concurrently.`,name:"num_threads"}],source:"https://github.com/huggingface/huggingface_hub/blob/v0.8.1/src/huggingface_hub/hf_api.py#L1726",returnDescription:`
...
&#x201C;streamlit&#x201D;, &#x201C;gradio&#x201D;, or &#x201C;static&#x201D;.`,name:"space_sdk"}],source:"https://github.com/huggingface/huggingface_hub/blob/v0.8.1/src/huggingface_hub/hf_api.py#L1343",returnDescription:`
...
Whether to set a timeout for the request to the Hub.`,name:"timeout"}],source:"https://github.com/huggingface/huggingface_hub/blob/v0.8.1/src/huggingface_hub/hf_api.py#L1140",returnDescription:`
...
The Hugging Face authentication token`,name:"token"}],source:"https://github.com/huggingface/huggingface_hub/blob/v0.8.1/src/huggingface_hub/hf_api.py#L2214",returnDescription:`
<p>The repository name in the user\u2019s namespace
({username}/{model_id}) if no organization is passed, and under the
organization namespace ({organization}/{model_id}) otherwise.</p>
`,returnType:`
<p><code>str</code></p>
`}}),It=new z({props:{name:"get_model_tags",anchor:"huggingface_hub.HfApi.get_model_tags",parameters:[],source:"https://github.com/huggingface/huggingface_hub/blob/v0.8.1/src/huggingface_hub/hf_api.py#L674"}}),Lt=new z({props:{name:"list_datasets",anchor:"huggingface_hub.HfApi.list_datasets",parameters:[{name:"filter",val:": typing.Union[huggingface_hub.utils.endpoint_helpers.DatasetFilter, str, typing.Iterable[str], NoneType] = None"},{name:"author",val:": typing.Optional[str] = None"},{name:"search",val:": typing.Optional[str] = None"},{name:"sort",val:": typing.Union[typing.Literal['lastModified'], str, NoneType] = None"},{name:"direction",val:": typing.Optional[typing.Literal[-1]] = None"},{name:"limit",val:": typing.Optional[int] = None"},{name:"cardData",val:": typing.Optional[bool] = None"},{name:"full",val:": typing.Optional[bool] = None"},{name:"use_auth_token",val:": typing.Optional[str] = None"}],parametersDescription:[{anchor:"huggingface_hub.HfApi.list_datasets.filter",description:`<strong>filter</strong> (<a href="/docs/huggingface_hub/v0.8.1/en/package_reference/hf_api#huggingface_hub.DatasetFilter">DatasetFilter</a> or <code>str</code> or <code>Iterable</code>, <em>optional</em>) &#x2014;
A string or <a href="/docs/huggingface_hub/v0.8.1/en/package_reference/hf_api#huggingface_hub.DatasetFilter">DatasetFilter</a> which can be used to identify
...
Whether to set a timeout for the request to the Hub.`,name:"timeout"}],source:"https://github.com/huggingface/huggingface_hub/blob/v0.8.1/src/huggingface_hub/hf_api.py#L1303",returnDescription:`
...
repository as well.`,name:"securityStatus"}],source:"https://github.com/huggingface/huggingface_hub/blob/v0.8.1/src/huggingface_hub/hf_api.py#L1079",returnDescription:`
...
Whether to set a timeout for the request to the Hub.`,name:"timeout"}],source:"https://github.com/huggingface/huggingface_hub/blob/v0.8.1/src/huggingface_hub/hf_api.py#L1248",returnDescription:`
<p>The repository
information.</p>
`,returnType:`
...
Whether to set a timeout for the request to the Hub.`,name:"timeout"}],source:"https://github.com/huggingface/huggingface_hub/blob/v0.8.1/src/huggingface_hub/hf_api.py#L1194",returnDescription:`
...
Set to <code>&quot;dataset&quot;</code> or <code>&quot;space&quot;</code> if uploading to a dataset or
space, <code>None</code> or <code>&quot;model&quot;</code> if uploading to a model. Default is
<code>None</code>.`,name:"repo_type"}],source:"https://github.com/huggingface/huggingface_hub/blob/v0.8.1/src/huggingface_hub/hf_api.py#L1573",returnDescription:`
...
Whether or not to create a Pull Request from <code>revision</code> with that commit.
Defaults to <code>False</code>.`,name:"create_pr"}],source:"https://github.com/huggingface/huggingface_hub/blob/v0.8.1/src/huggingface_hub/hf_api.py#L1847",returnDescription:`
...
to <code>False</code>.`,name:"create_pr"}],source:"https://github.com/huggingface/huggingface_hub/blob/v0.8.1/src/huggingface_hub/hf_api.py#L1992",returnDescription:`
