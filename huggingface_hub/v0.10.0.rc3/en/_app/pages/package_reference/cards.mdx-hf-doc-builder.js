...
in with <code>template_kwargs</code>. Defaults to the default template.`,name:"template_path"}],source:"https://github.com/huggingface/huggingface_hub/blob/v0.10.0.rc3/src/huggingface_hub/repocard.py#L277",returnDescription:`
<p>A RepoCard instance with the specified card data and content from the
template.</p>
`,returnType:`
<p><a
  href="/docs/huggingface_hub/v0.10.0.rc3/en/package_reference/cards#huggingface_hub.repocard.RepoCard"
...
the stored token.`,name:"token"}],source:"https://github.com/huggingface/huggingface_hub/blob/v0.10.0.rc3/src/huggingface_hub/repocard.py#L125",returnDescription:`
...
especially useful if the repo is updated / committed to concurrently.`,name:"parent_commit"}],source:"https://github.com/huggingface/huggingface_hub/blob/v0.10.0.rc3/src/huggingface_hub/repocard.py#L214",returnDescription:`
...
The line break to use when dumping to yaml.`,name:"line_break"}],source:"https://github.com/huggingface/huggingface_hub/blob/v0.10.0.rc3/src/huggingface_hub/repocard_data.py#L145",returnDescription:`
...
A path to a markdown file with optional Jinja template variables that can be filled
in with <code>template_kwargs</code>. Defaults to the default template.`,name:"template_path"}],source:"https://github.com/huggingface/huggingface_hub/blob/v0.10.0.rc3/src/huggingface_hub/repocard.py#L322",returnDescription:`
<p>A ModelCard instance with the specified card data and content from the
template.</p>
`,returnType:`
<p><a
  href="/docs/huggingface_hub/v0.10.0.rc3/en/package_reference/cards#huggingface_hub.ModelCard"
...
A path to a markdown file with optional Jinja template variables that can be filled
in with <code>template_kwargs</code>. Defaults to the default template.`,name:"template_path"}],source:"https://github.com/huggingface/huggingface_hub/blob/v0.10.0.rc3/src/huggingface_hub/repocard.py#L402",returnDescription:`
<p>A DatasetCard instance with the specified card data and content from the
template.</p>
`,returnType:`
<p><a
  href="/docs/huggingface_hub/v0.10.0.rc3/en/package_reference/cards#huggingface_hub.DatasetCard"
...
Hugging Face Hub.`,name:"model_index"}],source:"https://github.com/huggingface/huggingface_hub/blob/v0.10.0.rc3/src/huggingface_hub/repocard_data.py#L340",returnDescription:`
...
reported in the model-index.`,name:"eval_results"}],source:"https://github.com/huggingface/huggingface_hub/blob/v0.10.0.rc3/src/huggingface_hub/repocard_data.py#L456",returnDescription:`
...
used in <code>load_dataset()</code>.`,name:"dataset_revision"}],source:"https://github.com/huggingface/huggingface_hub/blob/v0.10.0.rc3/src/huggingface_hub/repocard.py#L532",returnDescription:`
...
If specified and <code>create_pr</code> is <code>True</code>, the pull request will be created from <code>parent_commit</code>.
Specifying <code>parent_commit</code> ensures the repo has not changed before committing the changes, and can be
especially useful if the repo is updated / committed to concurrently.`,name:"parent_commit"}],source:"https://github.com/huggingface/huggingface_hub/blob/v0.10.0.rc3/src/huggingface_hub/repocard.py#L657",returnDescription:`
<p>URL of the commit which updated the card metadata.</p>
`,returnType:`
<p><code>str</code></p>
