import{S as Rr,i as Sr,s as Ur,e as o,k as p,w as j,t as c,M as Cr,c as n,d as t,m as h,a as s,x as H,h as g,b as w,G as e,g as b,y as F,q as D,o as N,B as q,v as zr,L as Oe}from"../../chunks/vendor-hf-doc-builder.js";import{T as Te}from"../../chunks/Tip-hf-doc-builder.js";import{D as z}from"../../chunks/Docstring-hf-doc-builder.js";import{C as we}from"../../chunks/CodeBlock-hf-doc-builder.js";import{I as Zs}from"../../chunks/IconCopyLink-hf-doc-builder.js";import{E as Pe}from"../../chunks/ExampleCodeBlock-hf-doc-builder.js";function Vr(M){let i,$,u,l,d,r,m,x,f,y,A,k,E,L,T,R;return{c(){i=o("p"),$=c("Raises the following errors:"),u=p(),l=o("ul"),d=o("li"),r=o("a"),m=c("RepositoryNotFoundError"),x=c(`
If the repository to download from cannot be found. This may be because it doesn\u2019t exist,
or because it is set to `),f=o("code"),y=c("private"),A=c(" and you do not have access."),k=p(),E=o("li"),L=o("a"),T=c("RevisionNotFoundError"),R=c(`
If the revision to download from cannot be found.`),this.h()},l(_){i=n(_,"P",{});var P=s(i);$=g(P,"Raises the following errors:"),P.forEach(t),u=h(_),l=n(_,"UL",{});var U=s(l);d=n(U,"LI",{});var S=s(d);r=n(S,"A",{href:!0});var V=s(r);m=g(V,"RepositoryNotFoundError"),V.forEach(t),x=g(S,`
If the repository to download from cannot be found. This may be because it doesn\u2019t exist,
or because it is set to `),f=n(S,"CODE",{});var G=s(f);y=g(G,"private"),G.forEach(t),A=g(S," and you do not have access."),S.forEach(t),k=h(U),E=n(U,"LI",{});var C=s(E);L=n(C,"A",{href:!0});var W=s(L);T=g(W,"RevisionNotFoundError"),W.forEach(t),R=g(C,`
If the revision to download from cannot be found.`),C.forEach(t),U.forEach(t),this.h()},h(){w(r,"href","/docs/huggingface_hub/v0.8.0.rc1/en/package_reference/utilities#huggingface_hub.utils.RepositoryNotFoundError"),w(L,"href","/docs/huggingface_hub/v0.8.0.rc1/en/package_reference/utilities#huggingface_hub.utils.RevisionNotFoundError")},m(_,P){b(_,i,P),e(i,$),b(_,u,P),b(_,l,P),e(l,d),e(d,r),e(r,m),e(d,x),e(d,f),e(f,y),e(d,A),e(l,k),e(l,E),e(E,L),e(L,T),e(E,R)},d(_){_&&t(i),_&&t(u),_&&t(l)}}}function Gr(M){let i,$,u,l,d,r,m,x,f,y,A,k,E,L,T,R,_,P,U,S,V,G,C,W,Z,J,se,ee,Q,X,Y,de,fe;return{c(){i=o("p"),$=c("Raises the following errors:"),u=p(),l=o("ul"),d=o("li"),r=o("a"),m=o("code"),x=c("HTTPError"),f=c(`
if the HuggingFace API returned an error`),y=p(),A=o("li"),k=o("a"),E=o("code"),L=c("ValueError"),T=c(`
if some parameter value is invalid`),R=p(),_=o("li"),P=o("a"),U=c("RepositoryNotFoundError"),S=c(`
If the repository to download from cannot be found. This may be because it doesn\u2019t exist,
or because it is set to `),V=o("code"),G=c("private"),C=c(" and you do not have access."),W=p(),Z=o("li"),J=o("a"),se=c("RevisionNotFoundError"),ee=c(`
If the revision to download from cannot be found.`),Q=p(),X=o("li"),Y=o("a"),de=c("EntryNotFoundError"),fe=c(`
If the file to download cannot be found.`),this.h()},l(B){i=n(B,"P",{});var te=s(i);$=g(te,"Raises the following errors:"),te.forEach(t),u=h(B),l=n(B,"UL",{});var K=s(l);d=n(K,"LI",{});var Ee=s(d);r=n(Ee,"A",{href:!0,rel:!0});var ae=s(r);m=n(ae,"CODE",{});var Ne=s(m);x=g(Ne,"HTTPError"),Ne.forEach(t),ae.forEach(t),f=g(Ee,`
if the HuggingFace API returned an error`),Ee.forEach(t),y=h(K),A=n(K,"LI",{});var Ae=s(A);k=n(Ae,"A",{href:!0,rel:!0});var ue=s(k);E=n(ue,"CODE",{});var I=s(E);L=g(I,"ValueError"),I.forEach(t),ue.forEach(t),T=g(Ae,`
if some parameter value is invalid`),Ae.forEach(t),R=h(K),_=n(K,"LI",{});var oe=s(_);P=n(oe,"A",{href:!0});var la=s(P);U=g(la,"RepositoryNotFoundError"),la.forEach(t),S=g(oe,`
If the repository to download from cannot be found. This may be because it doesn\u2019t exist,
or because it is set to `),V=n(oe,"CODE",{});var me=s(V);G=g(me,"private"),me.forEach(t),C=g(oe," and you do not have access."),oe.forEach(t),W=h(K),Z=n(K,"LI",{});var _e=s(Z);J=n(_e,"A",{href:!0});var ca=s(J);se=g(ca,"RevisionNotFoundError"),ca.forEach(t),ee=g(_e,`
If the revision to download from cannot be found.`),_e.forEach(t),Q=h(K),X=n(K,"LI",{});var qe=s(X);Y=n(qe,"A",{href:!0});var ga=s(Y);de=g(ga,"EntryNotFoundError"),ga.forEach(t),fe=g(qe,`
If the file to download cannot be found.`),qe.forEach(t),K.forEach(t),this.h()},h(){w(r,"href","https://2.python-requests.org/en/master/api/#requests.HTTPError"),w(r,"rel","nofollow"),w(k,"href","https://docs.python.org/3/library/exceptions.html#ValueError"),w(k,"rel","nofollow"),w(P,"href","/docs/huggingface_hub/v0.8.0.rc1/en/package_reference/utilities#huggingface_hub.utils.RepositoryNotFoundError"),w(J,"href","/docs/huggingface_hub/v0.8.0.rc1/en/package_reference/utilities#huggingface_hub.utils.RevisionNotFoundError"),w(Y,"href","/docs/huggingface_hub/v0.8.0.rc1/en/package_reference/utilities#huggingface_hub.utils.EntryNotFoundError")},m(B,te){b(B,i,te),e(i,$),b(B,u,te),b(B,l,te),e(l,d),e(d,r),e(r,m),e(m,x),e(d,f),e(l,y),e(l,A),e(A,k),e(k,E),e(E,L),e(A,T),e(l,R),e(l,_),e(_,P),e(P,U),e(_,S),e(_,V),e(V,G),e(_,C),e(l,W),e(l,Z),e(Z,J),e(J,se),e(Z,ee),e(l,Q),e(l,X),e(X,Y),e(Y,de),e(X,fe)},d(B){B&&t(i),B&&t(u),B&&t(l)}}}function Wr(M){let i,$,u,l,d,r,m,x,f,y,A;return{c(){i=o("p"),$=c("Raises the following errors:"),u=p(),l=o("ul"),d=o("li"),r=o("a"),m=c("RepositoryNotFoundError"),x=c(`
If the repository to download from cannot be found. This may be because it doesn\u2019t exist,
or because it is set to `),f=o("code"),y=c("private"),A=c(" and you do not have access."),this.h()},l(k){i=n(k,"P",{});var E=s(i);$=g(E,"Raises the following errors:"),E.forEach(t),u=h(k),l=n(k,"UL",{});var L=s(l);d=n(L,"LI",{});var T=s(d);r=n(T,"A",{href:!0});var R=s(r);m=g(R,"RepositoryNotFoundError"),R.forEach(t),x=g(T,`
If the repository to download from cannot be found. This may be because it doesn\u2019t exist,
or because it is set to `),f=n(T,"CODE",{});var _=s(f);y=g(_,"private"),_.forEach(t),A=g(T," and you do not have access."),T.forEach(t),L.forEach(t),this.h()},h(){w(r,"href","/docs/huggingface_hub/v0.8.0.rc1/en/package_reference/utilities#huggingface_hub.utils.RepositoryNotFoundError")},m(k,E){b(k,i,E),e(i,$),b(k,u,E),b(k,l,E),e(l,d),e(d,r),e(r,m),e(d,x),e(d,f),e(f,y),e(d,A)},d(k){k&&t(i),k&&t(u),k&&t(l)}}}function Br(M){let i,$,u,l,d,r,m,x;return m=new we({props:{code:`from huggingface_hub import HfApi
...
<span class="hljs-meta">... </span>)
<span class="hljs-meta">&gt;&gt;&gt; </span>api.list_datasets(<span class="hljs-built_in">filter</span>=filt)`}}),{c(){i=o("p"),$=c("Example usage with the "),u=o("code"),l=c("filter"),d=c(" argument:"),r=p(),j(m.$$.fragment)},l(f){i=n(f,"P",{});var y=s(i);$=g(y,"Example usage with the "),u=n(y,"CODE",{});var A=s(u);l=g(A,"filter"),A.forEach(t),d=g(y," argument:"),y.forEach(t),r=h(f),H(m.$$.fragment,f)},m(f,y){b(f,i,y),e(i,$),e(i,u),e(u,l),e(i,d),b(f,r,y),F(m,f,y),x=!0},p:Oe,i(f){x||(D(m.$$.fragment,f),x=!0)},o(f){N(m.$$.fragment,f),x=!1},d(f){f&&t(i),f&&t(r),q(m,f)}}}function Kr(M){let i,$,u,l,d,r,m,x;return m=new we({props:{code:`from huggingface_hub import HfApi
...
<span class="hljs-meta">&gt;&gt;&gt; </span>api.list_datasets(search=<span class="hljs-string">&quot;text&quot;</span>, author=<span class="hljs-string">&quot;google&quot;</span>)`}}),{c(){i=o("p"),$=c("Example usage with the "),u=o("code"),l=c("search"),d=c(" argument:"),r=p(),j(m.$$.fragment)},l(f){i=n(f,"P",{});var y=s(i);$=g(y,"Example usage with the "),u=n(y,"CODE",{});var A=s(u);l=g(A,"search"),A.forEach(t),d=g(y," argument:"),y.forEach(t),r=h(f),H(m.$$.fragment,f)},m(f,y){b(f,i,y),e(i,$),e(i,u),e(u,l),e(i,d),b(f,r,y),F(m,f,y),x=!0},p:Oe,i(f){x||(D(m.$$.fragment,f),x=!0)},o(f){N(m.$$.fragment,f),x=!1},d(f){f&&t(i),f&&t(r),q(m,f)}}}function Jr(M){let i,$,u,l,d,r,m,x;return m=new we({props:{code:`from huggingface_hub import HfApi
...
<span class="hljs-meta">&gt;&gt;&gt; </span>filt = ModelFilter(library=args.library.allennlp)`}}),{c(){i=o("p"),$=c("Example usage with the "),u=o("code"),l=c("filter"),d=c(" argument:"),r=p(),j(m.$$.fragment)},l(f){i=n(f,"P",{});var y=s(i);$=g(y,"Example usage with the "),u=n(y,"CODE",{});var A=s(u);l=g(A,"filter"),A.forEach(t),d=g(y," argument:"),y.forEach(t),r=h(f),H(m.$$.fragment,f)},m(f,y){b(f,i,y),e(i,$),e(i,u),e(u,l),e(i,d),b(f,r,y),F(m,f,y),x=!0},p:Oe,i(f){x||(D(m.$$.fragment,f),x=!0)},o(f){N(m.$$.fragment,f),x=!1},d(f){f&&t(i),f&&t(r),q(m,f)}}}function Qr(M){let i,$,u,l,d,r,m,x;return m=new we({props:{code:`from huggingface_hub import HfApi
...
<span class="hljs-meta">&gt;&gt;&gt; </span>api.list_models(search=<span class="hljs-string">&quot;bert&quot;</span>, author=<span class="hljs-string">&quot;google&quot;</span>)`}}),{c(){i=o("p"),$=c("Example usage with the "),u=o("code"),l=c("search"),d=c(" argument:"),r=p(),j(m.$$.fragment)},l(f){i=n(f,"P",{});var y=s(i);$=g(y,"Example usage with the "),u=n(y,"CODE",{});var A=s(u);l=g(A,"search"),A.forEach(t),d=g(y," argument:"),y.forEach(t),r=h(f),H(m.$$.fragment,f)},m(f,y){b(f,i,y),e(i,$),e(i,u),e(u,l),e(i,d),b(f,r,y),F(m,f,y),x=!0},p:Oe,i(f){x||(D(m.$$.fragment,f),x=!0)},o(f){N(m.$$.fragment,f),x=!1},d(f){f&&t(i),f&&t(r),q(m,f)}}}function Xr(M){let i,$,u,l,d,r,m,x,f,y,A,k,E,L,T,R;return{c(){i=o("p"),$=c("Raises the following errors:"),u=p(),l=o("ul"),d=o("li"),r=o("a"),m=c("RepositoryNotFoundError"),x=c(`
If the repository to download from cannot be found. This may be because it doesn\u2019t exist,
or because it is set to `),f=o("code"),y=c("private"),A=c(" and you do not have access."),k=p(),E=o("li"),L=o("a"),T=c("RevisionNotFoundError"),R=c(`
If the revision to download from cannot be found.`),this.h()},l(_){i=n(_,"P",{});var P=s(i);$=g(P,"Raises the following errors:"),P.forEach(t),u=h(_),l=n(_,"UL",{});var U=s(l);d=n(U,"LI",{});var S=s(d);r=n(S,"A",{href:!0});var V=s(r);m=g(V,"RepositoryNotFoundError"),V.forEach(t),x=g(S,`
If the repository to download from cannot be found. This may be because it doesn\u2019t exist,
or because it is set to `),f=n(S,"CODE",{});var G=s(f);y=g(G,"private"),G.forEach(t),A=g(S," and you do not have access."),S.forEach(t),k=h(U),E=n(U,"LI",{});var C=s(E);L=n(C,"A",{href:!0});var W=s(L);T=g(W,"RevisionNotFoundError"),W.forEach(t),R=g(C,`
If the revision to download from cannot be found.`),C.forEach(t),U.forEach(t),this.h()},h(){w(r,"href","/docs/huggingface_hub/v0.8.0.rc1/en/package_reference/utilities#huggingface_hub.utils.RepositoryNotFoundError"),w(L,"href","/docs/huggingface_hub/v0.8.0.rc1/en/package_reference/utilities#huggingface_hub.utils.RevisionNotFoundError")},m(_,P){b(_,i,P),e(i,$),b(_,u,P),b(_,l,P),e(l,d),e(d,r),e(r,m),e(d,x),e(d,f),e(f,y),e(d,A),e(l,k),e(l,E),e(E,L),e(L,T),e(E,R)},d(_){_&&t(i),_&&t(u),_&&t(l)}}}function Yr(M){let i,$,u,l,d,r,m,x,f,y,A;return{c(){i=o("p"),$=c("Raises the following errors:"),u=p(),l=o("ul"),d=o("li"),r=o("a"),m=c("RepositoryNotFoundError"),x=c(`
If the repository to download from cannot be found. This may be because it doesn\u2019t exist,
or because it is set to `),f=o("code"),y=c("private"),A=c(" and you do not have access."),this.h()},l(k){i=n(k,"P",{});var E=s(i);$=g(E,"Raises the following errors:"),E.forEach(t),u=h(k),l=n(k,"UL",{});var L=s(l);d=n(L,"LI",{});var T=s(d);r=n(T,"A",{href:!0});var R=s(r);m=g(R,"RepositoryNotFoundError"),R.forEach(t),x=g(T,`
If the repository to download from cannot be found. This may be because it doesn\u2019t exist,
...
If the repository to download from cannot be found. This may be because it doesn\u2019t exist,
or because it is set to `),f=n(S,"CODE",{});var G=s(f);y=g(G,"private"),G.forEach(t),A=g(S," and you do not have access."),S.forEach(t),k=h(U),E=n(U,"LI",{});var C=s(E);L=n(C,"A",{href:!0});var W=s(L);T=g(W,"RevisionNotFoundError"),W.forEach(t),R=g(C,`
If the revision to download from cannot be found.`),C.forEach(t),U.forEach(t),this.h()},h(){w(r,"href","/docs/huggingface_hub/v0.8.0.rc1/en/package_reference/utilities#huggingface_hub.utils.RepositoryNotFoundError"),w(L,"href","/docs/huggingface_hub/v0.8.0.rc1/en/package_reference/utilities#huggingface_hub.utils.RevisionNotFoundError")},m(_,P){b(_,i,P),e(i,$),b(_,u,P),b(_,l,P),e(l,d),e(d,r),e(r,m),e(d,x),e(d,f),e(f,y),e(d,A),e(l,k),e(l,E),e(E,L),e(L,T),e(E,R)},d(_){_&&t(i),_&&t(u),_&&t(l)}}}function ei(M){let i,$,u,l,d,r,m,x,f,y,A,k,E,L,T,R;return{c(){i=o("p"),$=c("Raises the following errors:"),u=p(),l=o("ul"),d=o("li"),r=o("a"),m=c("RepositoryNotFoundError"),x=c(`
If the repository to download from cannot be found. This may be because it doesn\u2019t exist,
or because it is set to `),f=o("code"),y=c("private"),A=c(" and you do not have access."),k=p(),E=o("li"),L=o("a"),T=c("RevisionNotFoundError"),R=c(`
If the revision to download from cannot be found.`),this.h()},l(_){i=n(_,"P",{});var P=s(i);$=g(P,"Raises the following errors:"),P.forEach(t),u=h(_),l=n(_,"UL",{});var U=s(l);d=n(U,"LI",{});var S=s(d);r=n(S,"A",{href:!0});var V=s(r);m=g(V,"RepositoryNotFoundError"),V.forEach(t),x=g(S,`
If the repository to download from cannot be found. This may be because it doesn\u2019t exist,
or because it is set to `),f=n(S,"CODE",{});var G=s(f);y=g(G,"private"),G.forEach(t),A=g(S," and you do not have access."),S.forEach(t),k=h(U),E=n(U,"LI",{});var C=s(E);L=n(C,"A",{href:!0});var W=s(L);T=g(W,"RevisionNotFoundError"),W.forEach(t),R=g(C,`
If the revision to download from cannot be found.`),C.forEach(t),U.forEach(t),this.h()},h(){w(r,"href","/docs/huggingface_hub/v0.8.0.rc1/en/package_reference/utilities#huggingface_hub.utils.RepositoryNotFoundError"),w(L,"href","/docs/huggingface_hub/v0.8.0.rc1/en/package_reference/utilities#huggingface_hub.utils.RevisionNotFoundError")},m(_,P){b(_,i,P),e(i,$),b(_,u,P),b(_,l,P),e(l,d),e(d,r),e(r,m),e(d,x),e(d,f),e(f,y),e(d,A),e(l,k),e(l,E),e(E,L),e(L,T),e(E,R)},d(_){_&&t(i),_&&t(u),_&&t(l)}}}function ti(M){let i,$,u,l,d,r,m,x,f,y,A;return{c(){i=o("p"),$=c("Raises the following errors:"),u=p(),l=o("ul"),d=o("li"),r=o("a"),m=c("RepositoryNotFoundError"),x=c(`
If the repository to download from cannot be found. This may be because it doesn\u2019t exist,
or because it is set to `),f=o("code"),y=c("private"),A=c(" and you do not have access."),this.h()},l(k){i=n(k,"P",{});var E=s(i);$=g(E,"Raises the following errors:"),E.forEach(t),u=h(k),l=n(k,"UL",{});var L=s(l);d=n(L,"LI",{});var T=s(d);r=n(T,"A",{href:!0});var R=s(r);m=g(R,"RepositoryNotFoundError"),R.forEach(t),x=g(T,`
If the repository to download from cannot be found. This may be because it doesn\u2019t exist,
or because it is set to `),f=n(T,"CODE",{});var _=s(f);y=g(_,"private"),_.forEach(t),A=g(T," and you do not have access."),T.forEach(t),L.forEach(t),this.h()},h(){w(r,"href","/docs/huggingface_hub/v0.8.0.rc1/en/package_reference/utilities#huggingface_hub.utils.RepositoryNotFoundError")},m(k,E){b(k,i,E),e(i,$),b(k,u,E),b(k,l,E),e(l,d),e(d,r),e(r,m),e(d,x),e(d,f),e(f,y),e(d,A)},d(k){k&&t(i),k&&t(u),k&&t(l)}}}function ai(M){let i,$,u,l,d,r,m,x,f,y,A,k,E,L,T,R,_,P,U,S,V,G,C,W,Z,J,se,ee;return{c(){i=o("p"),$=c("Raises the following errors:"),u=p(),l=o("ul"),d=o("li"),r=o("a"),m=o("code"),x=c("HTTPError"),f=c(`
if the HuggingFace API returned an error`),y=p(),A=o("li"),k=o("a"),E=o("code"),L=c("ValueError"),T=c(`
if some parameter value is invalid`),R=p(),_=o("li"),P=o("a"),U=c("RepositoryNotFoundError"),S=c(`
If the repository to download from cannot be found. This may be because it doesn\u2019t exist,
or because it is set to `),V=o("code"),G=c("private"),C=c(" and you do not have access."),W=p(),Z=o("li"),J=o("a"),se=c("RevisionNotFoundError"),ee=c(`
If the revision to download from cannot be found.`),this.h()},l(Q){i=n(Q,"P",{});var X=s(i);$=g(X,"Raises the following errors:"),X.forEach(t),u=h(Q),l=n(Q,"UL",{});var Y=s(l);d=n(Y,"LI",{});var de=s(d);r=n(de,"A",{href:!0,rel:!0});var fe=s(r);m=n(fe,"CODE",{});var B=s(m);x=g(B,"HTTPError"),B.forEach(t),fe.forEach(t),f=g(de,`
if the HuggingFace API returned an error`),de.forEach(t),y=h(Y),A=n(Y,"LI",{});var te=s(A);k=n(te,"A",{href:!0,rel:!0});var K=s(k);E=n(K,"CODE",{});var Ee=s(E);L=g(Ee,"ValueError"),Ee.forEach(t),K.forEach(t),T=g(te,`
if some parameter value is invalid`),te.forEach(t),R=h(Y),_=n(Y,"LI",{});var ae=s(_);P=n(ae,"A",{href:!0});var Ne=s(P);U=g(Ne,"RepositoryNotFoundError"),Ne.forEach(t),S=g(ae,`
If the repository to download from cannot be found. This may be because it doesn\u2019t exist,
or because it is set to `),V=n(ae,"CODE",{});var Ae=s(V);G=g(Ae,"private"),Ae.forEach(t),C=g(ae," and you do not have access."),ae.forEach(t),W=h(Y),Z=n(Y,"LI",{});var ue=s(Z);J=n(ue,"A",{href:!0});var I=s(J);se=g(I,"RevisionNotFoundError"),I.forEach(t),ee=g(ue,`
If the revision to download from cannot be found.`),ue.forEach(t),Y.forEach(t),this.h()},h(){w(r,"href","https://2.python-requests.org/en/master/api/#requests.HTTPError"),w(r,"rel","nofollow"),w(k,"href","https://docs.python.org/3/library/exceptions.html#ValueError"),w(k,"rel","nofollow"),w(P,"href","/docs/huggingface_hub/v0.8.0.rc1/en/package_reference/utilities#huggingface_hub.utils.RepositoryNotFoundError"),w(J,"href","/docs/huggingface_hub/v0.8.0.rc1/en/package_reference/utilities#huggingface_hub.utils.RevisionNotFoundError")},m(Q,X){b(Q,i,X),e(i,$),b(Q,u,X),b(Q,l,X),e(l,d),e(d,r),e(r,m),e(m,x),e(d,f),e(l,y),e(l,A),e(A,k),e(k,E),e(E,L),e(A,T),e(l,R),e(l,_),e(_,P),e(P,U),e(_,S),e(_,V),e(V,G),e(_,C),e(l,W),e(l,Z),e(Z,J),e(J,se),e(Z,ee)},d(Q){Q&&t(i),Q&&t(u),Q&&t(l)}}}function oi(M){let i,$,u,l,d;return l=new we({props:{code:`with open("./local/filepath", "rb") as fobj:
    upload_file(
...
<span class="hljs-meta">... </span>    token=<span class="hljs-string">&quot;my_token&quot;</span>,
<span class="hljs-meta">... </span>)
<span class="hljs-string">&quot;https://huggingface.co/username/my-model/blob/main/remote/file/path.h5&quot;</span>`}}),{c(){i=o("p"),$=c("Example usage:"),u=p(),j(l.$$.fragment)},l(r){i=n(r,"P",{});var m=s(i);$=g(m,"Example usage:"),m.forEach(t),u=h(r),H(l.$$.fragment,r)},m(r,m){b(r,i,m),e(i,$),b(r,u,m),F(l,r,m),d=!0},p:Oe,i(r){d||(D(l.$$.fragment,r),d=!0)},o(r){N(l.$$.fragment,r),d=!1},d(r){r&&t(i),r&&t(u),q(l,r)}}}function ni(M){let i,$,u,l,d;return l=new we({props:{code:`from huggingface_hub import DatasetFilter
...
<span class="hljs-meta">&gt;&gt;&gt; </span>new_filter = DatasetFilter(task_ids=<span class="hljs-string">&quot;paraphrase&quot;</span>)`}}),{c(){i=o("p"),$=c("Examples:"),u=p(),j(l.$$.fragment)},l(r){i=n(r,"P",{});var m=s(i);$=g(m,"Examples:"),m.forEach(t),u=h(r),H(l.$$.fragment,r)},m(r,m){b(r,i,m),e(i,$),b(r,u,m),F(l,r,m),d=!0},p:Oe,i(r){d||(D(l.$$.fragment,r),d=!0)},o(r){N(l.$$.fragment,r),d=!1},d(r){r&&t(i),r&&t(u),q(l,r)}}}function si(M){let i,$;return i=new we({props:{code:`from huggingface_hub import ModelFilter
...
<span class="hljs-meta">&gt;&gt;&gt; </span>args.language.en`}}),{c(){i=o("p"),$=c("Example:"),u=p(),j(l.$$.fragment)},l(r){i=n(r,"P",{});var m=s(i);$=g(m,"Example:"),m.forEach(t),u=h(r),H(l.$$.fragment,r)},m(r,m){b(r,i,m),e(i,$),b(r,u,m),F(l,r,m),d=!0},p:Oe,i(r){d||(D(l.$$.fragment,r),d=!0)},o(r){N(l.$$.fragment,r),d=!1},d(r){r&&t(i),r&&t(u),q(l,r)}}}function ii(M){let i,$,u,l,d;return l=new we({props:{code:`args = ModelSearchArguments()
args.author_or_organization.huggingface
args.language.en`,highlighted:`<span class="hljs-meta">&gt;&gt;&gt; </span>args = ModelSearchArguments()
<span class="hljs-meta">&gt;&gt;&gt; </span>args.author_or_organization.huggingface
<span class="hljs-meta">&gt;&gt;&gt; </span>args.language.en`}}),{c(){i=o("p"),$=c("Example:"),u=p(),j(l.$$.fragment)},l(r){i=n(r,"P",{});var m=s(i);$=g(m,"Example:"),m.forEach(t),u=h(r),H(l.$$.fragment,r)},m(r,m){b(r,i,m),e(i,$),b(r,u,m),F(l,r,m),d=!0},p:Oe,i(r){d||(D(l.$$.fragment,r),d=!0)},o(r){N(l.$$.fragment,r),d=!1},d(r){r&&t(i),r&&t(u),q(l,r)}}}function li(M){let i,$,u,l,d,r,m,x,f,y,A,k,E,L,T,R,_,P,U,S,V,G,C,W,Z,J,se,ee,Q,X,Y,de,fe,B,te,K,Ee,ae,Ne,Ae,ue,I,oe,la,me,_e,ca,qe,ga,Uo,re,wt,Co,ya,zo,Vo,ka,Go,Wo,Me,Bo,xe,Et,Ko,wa,Jo,Qo,Re,Xo,je,At,Yo,Ea,Zo,en,Se,tn,Ue,xt,an,Aa,on,nn,Ce,jt,sn,xa,rn,ln,ze,Ht,cn,ja,gn,pn,ie,Ft,hn,Ha,dn,fn,Ve,un,Ge,mn,We,Dt,_n,Fa,bn,vn,le,Nt,$n,Da,yn,kn,Be,wn,Ke,En,Je,qt,An,Na,xn,jn,ce,It,Hn,qa,Fn,Dn,Ia,Nn,qn,Qe,In,ge,Lt,Ln,La,Tn,Pn,Tt,On,Pt,Mn,Rn,Sn,Xe,Un,He,Ot,Cn,Ta,zn,Vn,Ye,Gn,Ze,Mt,Wn,Pa,Bn,Kn,pe,Rt,Jn,Oa,Qn,Xn,Ma,Yn,Zn,et,es,tt,St,ts,Ra,as,os,Fe,Ut,ns,Sa,ss,rs,at,is,he,Ct,ls,Ua,cs,gs,ot,ps,nt,hs,st,zt,ds,Ca,fs,fo,Ie,rt,za,Vt,us,Va,ms,uo,Gt,Ga,_s,bs,mo,it,vs,pa,$s,ys,_o,ne,Wt,ks,lt,Bt,ws,Wa,Es,As,De,Kt,xs,Ba,js,Hs,Jt,Fs,Ka,Ds,Ns,qs,ct,Qt,Is,Ja,Ls,bo,Le,gt,Qa,Xt,Ts,Xa,Ps,vo,pt,Os,Ya,Ms,Rs,$o,be,Yt,Ss,Za,Us,Cs,ht,yo,ve,Zt,zs,eo,Vs,Gs,dt,ko,$e,ea,Ws,to,Bs,Ks,ft,wo,ye,ta,Js,ao,Qs,Xs,ut,Eo;return r=new Zs({}),J=new we({props:{code:`from huggingface_hub import list_models
...
&#x201C;streamlit&#x201D;, &#x201C;gradio&#x201D;, or &#x201C;static&#x201D;.`,name:"space_sdk"}],source:"https://github.com/huggingface/huggingface_hub/blob/v0.8.0.rc1/src/huggingface_hub/hf_api.py#L1297",returnDescription:`
...
Whether to set a timeout for the request to the Hub.`,name:"timeout"}],source:"https://github.com/huggingface/huggingface_hub/blob/v0.8.0.rc1/src/huggingface_hub/hf_api.py#L1094",returnDescription:`
...
The Hugging Face authentication token`,name:"token"}],source:"https://github.com/huggingface/huggingface_hub/blob/v0.8.0.rc1/src/huggingface_hub/hf_api.py#L1883",returnDescription:`
<p>The repository name in the user\u2019s namespace
({username}/{model_id}) if no organization is passed, and under the
organization namespace ({organization}/{model_id}) otherwise.</p>
`,returnType:`
<p><code>str</code></p>
`}}),Ht=new z({props:{name:"get_model_tags",anchor:"huggingface_hub.HfApi.get_model_tags",parameters:[],source:"https://github.com/huggingface/huggingface_hub/blob/v0.8.0.rc1/src/huggingface_hub/hf_api.py#L628"}}),Ft=new z({props:{name:"list_datasets",anchor:"huggingface_hub.HfApi.list_datasets",parameters:[{name:"filter",val:": typing.Union[huggingface_hub.utils.endpoint_helpers.DatasetFilter, str, typing.Iterable[str], NoneType] = None"},{name:"author",val:": typing.Optional[str] = None"},{name:"search",val:": typing.Optional[str] = None"},{name:"sort",val:": typing.Union[typing.Literal['lastModified'], str, NoneType] = None"},{name:"direction",val:": typing.Optional[typing.Literal[-1]] = None"},{name:"limit",val:": typing.Optional[int] = None"},{name:"cardData",val:": typing.Optional[bool] = None"},{name:"full",val:": typing.Optional[bool] = None"},{name:"use_auth_token",val:": typing.Optional[str] = None"}],parametersDescription:[{anchor:"huggingface_hub.HfApi.list_datasets.filter",description:`<strong>filter</strong> (<a href="/docs/huggingface_hub/v0.8.0.rc1/en/package_reference/hf_api#huggingface_hub.DatasetFilter">DatasetFilter</a> or <code>str</code> or <code>Iterable</code>, <em>optional</em>) &#x2014;
A string or <a href="/docs/huggingface_hub/v0.8.0.rc1/en/package_reference/hf_api#huggingface_hub.DatasetFilter">DatasetFilter</a> which can be used to identify
...
Whether to set a timeout for the request to the Hub.`,name:"timeout"}],source:"https://github.com/huggingface/huggingface_hub/blob/v0.8.0.rc1/src/huggingface_hub/hf_api.py#L1257",returnDescription:`
...
repository as well.`,name:"securityStatus"}],source:"https://github.com/huggingface/huggingface_hub/blob/v0.8.0.rc1/src/huggingface_hub/hf_api.py#L1033",returnDescription:`
...
Whether to set a timeout for the request to the Hub.`,name:"timeout"}],source:"https://github.com/huggingface/huggingface_hub/blob/v0.8.0.rc1/src/huggingface_hub/hf_api.py#L1202",returnDescription:`
<p>The repository
information.</p>
`,returnType:`
...
Whether to set a timeout for the request to the Hub.`,name:"timeout"}],source:"https://github.com/huggingface/huggingface_hub/blob/v0.8.0.rc1/src/huggingface_hub/hf_api.py#L1148",returnDescription:`
...
Set to <code>&quot;dataset&quot;</code> or <code>&quot;space&quot;</code> if uploading to a dataset or
space, <code>None</code> or <code>&quot;model&quot;</code> if uploading to a model. Default is
<code>None</code>.`,name:"repo_type"}],source:"https://github.com/huggingface/huggingface_hub/blob/v0.8.0.rc1/src/huggingface_hub/hf_api.py#L1524",returnDescription:`
...
Changing this value has no effect.`,name:"identical_ok"}],source:"https://github.com/huggingface/huggingface_hub/blob/v0.8.0.rc1/src/huggingface_hub/hf_api.py#L1677",returnDescription:`
...
model on the Hub.`,name:"trained_dataset"}],source:"https://github.com/huggingface/huggingface_hub/blob/v0.8.0.rc1/src/huggingface_hub/utils/endpoint_helpers.py#L153"}}),dt=new Pe({props:{anchor:"huggingface_hub.ModelFilter.example",$$slots:{default:[si]},$$scope:{ctx:M}}}),ea=new z({props:{name:"class huggingface_hub.DatasetSearchArguments",anchor:"huggingface_hub.DatasetSearchArguments",parameters:[],source:"https://github.com/huggingface/huggingface_hub/blob/v0.8.0.rc1/src/huggingface_hub/hf_api.py#L403"}}),ft=new Pe({props:{anchor:"huggingface_hub.DatasetSearchArguments.example",$$slots:{default:[ri]},$$scope:{ctx:M}}}),ta=new z({props:{name:"class huggingface_hub.ModelSearchArguments",anchor:"huggingface_hub.ModelSearchArguments",parameters:[],source:"https://github.com/huggingface/huggingface_hub/blob/v0.8.0.rc1/src/huggingface_hub/hf_api.py#L365"}}),ut=new Pe({props:{anchor:"huggingface_hub.ModelSearchArguments.example",$$slots:{default:[ii]},$$scope:{ctx:M}}}),{c(){i=o("meta"),$=p(),u=o("h1"),l=o("a"),d=o("span"),j(r.$$.fragment),m=p(),x=o("span"),f=c("Hugging Face Hub API"),y=p(),A=o("p"),k=c("Below is the documentation for the "),E=o("code"),L=c("HfApi"),T=c(` class, which serves as a Python wrapper for the Hugging Face
Hub\u2019s API.`),R=p(),_=o("p"),P=c("All methods from the "),U=o("code"),S=c("HfApi"),V=c(` are also accessible from the package\u2019s root directly, both approaches are detailed
below.`),G=p(),C=o("p"),W=c("The following approach uses the method from the root of the package:"),Z=p(),j(J.$$.fragment),se=p(),ee=o("p"),Q=c("The following approach uses the "),X=o("code"),Y=c("HfApi"),de=c(" class:"),fe=p(),j(B.$$.fragment),te=p(),K=o("p"),Ee=c("Using the "),ae=o("code"),Ne=c("HfApi"),Ae=c(" class directly enables you to set a different endpoint to that of the Hugging Face\u2019s Hub."),ue=p(),I=o("div"),j(oe.$$.fragment),la=p(),me=o("div"),j(_e.$$.fragment),ca=p(),qe=o("p"),ga=c("Create an empty repo on the HuggingFace Hub."),Uo=p(),re=o("div"),j(wt.$$.fragment),Co=p(),ya=o("p"),zo=c("Get info on one specific dataset on huggingface.co."),Vo=p(),ka=o("p"),Go=c("Dataset can be private if you pass an acceptable token."),Wo=p(),j(Me.$$.fragment),Bo=p(),xe=o("div"),j(Et.$$.fragment),Ko=p(),wa=o("p"),Jo=c("Deletes a file in the given repo."),Qo=p(),j(Re.$$.fragment),Xo=p(),je=o("div"),j(At.$$.fragment),Yo=p(),Ea=o("p"),Zo=c("Delete a repo from the HuggingFace Hub. CAUTION: this is irreversible."),en=p(),j(Se.$$.fragment),tn=p(),Ue=o("div"),j(xt.$$.fragment),an=p(),Aa=o("p"),on=c("Gets all valid dataset tags as a nested namespace object."),nn=p(),Ce=o("div"),j(jt.$$.fragment),sn=p(),xa=o("p"),rn=c(`Returns the repository name for a given model ID and optional
organization.`),ln=p(),ze=o("div"),j(Ht.$$.fragment),cn=p(),ja=o("p"),gn=c("Gets all valid model tags as a nested namespace object"),pn=p(),ie=o("div"),j(Ft.$$.fragment),hn=p(),Ha=o("p"),dn=c("Get the public list of all the datasets on huggingface.co"),fn=p(),j(Ve.$$.fragment),un=p(),j(Ge.$$.fragment),mn=p(),We=o("div"),j(Dt.$$.fragment),_n=p(),Fa=o("p"),bn=c("Get the public list of all the metrics on huggingface.co"),vn=p(),le=o("div"),j(Nt.$$.fragment),$n=p(),Da=o("p"),yn=c("Get the public list of all the models on huggingface.co"),kn=p(),j(Be.$$.fragment),wn=p(),j(Ke.$$.fragment),En=p(),Je=o("div"),j(qt.$$.fragment),An=p(),Na=o("p"),xn=c("Get the list of files in a given repo."),jn=p(),ce=o("div"),j(It.$$.fragment),Hn=p(),qa=o("p"),Fn=c("Get info on one specific model on huggingface.co"),Dn=p(),Ia=o("p"),Nn=c("Model can be private if you pass an acceptable token or are logged in."),qn=p(),j(Qe.$$.fragment),In=p(),ge=o("div"),j(Lt.$$.fragment),Ln=p(),La=o("p"),Tn=c("Moving a repository from namespace1/repo_name1 to namespace2/repo_name2"),Pn=p(),Tt=o("p"),On=c(`Note there are certain limitations. For more information about moving
repositories, please see
`),Pt=o("a"),Mn=c("https://hf.co/docs/hub/main#how-can-i-rename-or-transfer-a-repo"),Rn=c("."),Sn=p(),j(Xe.$$.fragment),Un=p(),He=o("div"),j(Ot.$$.fragment),Cn=p(),Ta=o("p"),zn=c("Get the info object for a given repo of a given type."),Vn=p(),j(Ye.$$.fragment),Gn=p(),Ze=o("div"),j(Mt.$$.fragment),Wn=p(),Pa=o("p"),Bn=c(`Saves the passed access token so git can correctly authenticate the
user.`),Kn=p(),pe=o("div"),j(Rt.$$.fragment),Jn=p(),Oa=o("p"),Qn=c("Get info on one specific Space on huggingface.co."),Xn=p(),Ma=o("p"),Yn=c("Space can be private if you pass an acceptable token."),Zn=p(),j(et.$$.fragment),es=p(),tt=o("div"),j(St.$$.fragment),ts=p(),Ra=o("p"),as=c("Resets the user\u2019s access token."),os=p(),Fe=o("div"),j(Ut.$$.fragment),ns=p(),Sa=o("p"),ss=c("Update the visibility setting of a repository."),rs=p(),j(at.$$.fragment),is=p(),he=o("div"),j(Ct.$$.fragment),ls=p(),Ua=o("p"),cs=c(`Upload a local file (up to 5GB) to the given repo. The upload is done
through a HTTP post request, and doesn\u2019t require git or git-lfs to be
installed.`),gs=p(),j(ot.$$.fragment),ps=p(),j(nt.$$.fragment),hs=p(),st=o("div"),j(zt.$$.fragment),ds=p(),Ca=o("p"),fs=c("Call HF API to know \u201Cwhoami\u201D."),fo=p(),Ie=o("h2"),rt=o("a"),za=o("span"),j(Vt.$$.fragment),us=p(),Va=o("span"),ms=c("Hugging Face local storage"),uo=p(),Gt=o("p"),Ga=o("code"),_s=c("huggingface_hub"),bs=c(` stores the authentication information locally so that it may be re-used in subsequent
methods.`),mo=p(),it=o("p"),vs=c("It does this using the "),pa=o("a"),$s=c("HfFolder"),ys=c(" utility, which saves data at the root of the user."),_o=p(),ne=o("div"),j(Wt.$$.fragment),ks=p(),lt=o("div"),j(Bt.$$.fragment),ws=p(),Wa=o("p"),Es=c("Deletes the token from storage. Does not fail if token does not exist."),As=p(),De=o("div"),j(Kt.$$.fragment),xs=p(),Ba=o("p"),js=c("Get token or None if not existent."),Hs=p(),Jt=o("p"),Fs=c("Note that a token can be also provided using the "),Ka=o("code"),Ds=c("HUGGING_FACE_HUB_TOKEN"),Ns=c(`
environment variable.`),qs=p(),ct=o("div"),j(Qt.$$.fragment),Is=p(),Ja=o("p"),Ls=c("Save token, creating folder as needed."),bo=p(),Le=o("h2"),gt=o("a"),Qa=o("span"),j(Xt.$$.fragment),Ts=p(),Xa=o("span"),Ps=c("Filtering helpers"),vo=p(),pt=o("p"),Os=c("Some helpers to filter repositories on the Hub are available in the "),Ya=o("code"),Ms=c("huggingface_hub"),Rs=c(" package."),$o=p(),be=o("div"),j(Yt.$$.fragment),Ss=p(),Za=o("p"),Us=c(`A class that converts human-readable dataset search parameters into ones
compatible with the REST API. For all parameters capitalization does not
matter.`),Cs=p(),j(ht.$$.fragment),yo=p(),ve=o("div"),j(Zt.$$.fragment),zs=p(),eo=o("p"),Vs=c(`A class that converts human-readable model search parameters into ones
compatible with the REST API. For all parameters capitalization does not
matter.`),Gs=p(),j(dt.$$.fragment),ko=p(),$e=o("div"),j(ea.$$.fragment),Ws=p(),to=o("p"),Bs=c(`A nested namespace object holding all possible values for properties of
datasets currently hosted in the Hub with tab-completion. If a value starts
with a number, it will only exist in the dictionary`),Ks=p(),j(ft.$$.fragment),wo=p(),ye=o("div"),j(ta.$$.fragment),Js=p(),ao=o("p"),Qs=c(`A nested namespace object holding all possible values for properties of
models currently hosted in the Hub with tab-completion. If a value starts
with a number, it will only exist in the dictionary`),Xs=p(),j(ut.$$.fragment),this.h()},l(a){const v=Cr('[data-svelte="svelte-1phssyn"]',document.head);i=n(v,"META",{name:!0,content:!0}),v.forEach(t),$=h(a),u=n(a,"H1",{class:!0});var aa=s(u);l=n(aa,"A",{id:!0,class:!0,href:!0});var oo=s(l);d=n(oo,"SPAN",{});var no=s(d);H(r.$$.fragment,no),no.forEach(t),oo.forEach(t),m=h(aa),x=n(aa,"SPAN",{});var so=s(x);f=g(so,"Hugging Face Hub API"),so.forEach(t),aa.forEach(t),y=h(a),A=n(a,"P",{});var oa=s(A);k=g(oa,"Below is the documentation for the "),E=n(oa,"CODE",{});var ro=s(E);L=g(ro,"HfApi"),ro.forEach(t),T=g(oa,` class, which serves as a Python wrapper for the Hugging Face
Hub\u2019s API.`),oa.forEach(t),R=h(a),_=n(a,"P",{});var na=s(_);P=g(na,"All methods from the "),U=n(na,"CODE",{});var io=s(U);S=g(io,"HfApi"),io.forEach(t),V=g(na,` are also accessible from the package\u2019s root directly, both approaches are detailed
below.`),na.forEach(t),G=h(a),C=n(a,"P",{});var lo=s(C);W=g(lo,"The following approach uses the method from the root of the package:"),lo.forEach(t),Z=h(a),H(J.$$.fragment,a),se=h(a),ee=n(a,"P",{});var sa=s(ee);Q=g(sa,"The following approach uses the "),X=n(sa,"CODE",{});var co=s(X);Y=g(co,"HfApi"),co.forEach(t),de=g(sa," class:"),sa.forEach(t),fe=h(a),H(B.$$.fragment,a),te=h(a),K=n(a,"P",{});var ra=s(K);Ee=g(ra,"Using the "),ae=n(ra,"CODE",{});var go=s(ae);Ne=g(go,"HfApi"),go.forEach(t),Ae=g(ra," class directly enables you to set a different endpoint to that of the Hugging Face\u2019s Hub."),ra.forEach(t),ue=h(a),I=n(a,"DIV",{class:!0});var O=s(I);H(oe.$$.fragment,O),la=h(O),me=n(O,"DIV",{class:!0});var ia=s(me);H(_e.$$.fragment,ia),ca=h(ia),qe=n(ia,"P",{});var po=s(qe);ga=g(po,"Create an empty repo on the HuggingFace Hub."),po.forEach(t),ia.forEach(t),Uo=h(O),re=n(O,"DIV",{class:!0});var ke=s(re);H(wt.$$.fragment,ke),Co=h(ke),ya=n(ke,"P",{});var ho=s(ya);zo=g(ho,"Get info on one specific dataset on huggingface.co."),ho.forEach(t),Vo=h(ke),ka=n(ke,"P",{});var er=s(ka);Go=g(er,"Dataset can be private if you pass an acceptable token."),er.forEach(t),Wo=h(ke),H(Me.$$.fragment,ke),ke.forEach(t),Bo=h(O),xe=n(O,"DIV",{class:!0});var ha=s(xe);H(Et.$$.fragment,ha),Ko=h(ha),wa=n(ha,"P",{});var tr=s(wa);Jo=g(tr,"Deletes a file in the given repo."),tr.forEach(t),Qo=h(ha),H(Re.$$.fragment,ha),ha.forEach(t),Xo=h(O),je=n(O,"DIV",{class:!0});var da=s(je);H(At.$$.fragment,da),Yo=h(da),Ea=n(da,"P",{});var ar=s(Ea);Zo=g(ar,"Delete a repo from the HuggingFace Hub. CAUTION: this is irreversible."),ar.forEach(t),en=h(da),H(Se.$$.fragment,da),da.forEach(t),tn=h(O),Ue=n(O,"DIV",{class:!0});var Ao=s(Ue);H(xt.$$.fragment,Ao),an=h(Ao),Aa=n(Ao,"P",{});var or=s(Aa);on=g(or,"Gets all valid dataset tags as a nested namespace object."),or.forEach(t),Ao.forEach(t),nn=h(O),Ce=n(O,"DIV",{class:!0});var xo=s(Ce);H(jt.$$.fragment,xo),sn=h(xo),xa=n(xo,"P",{});var nr=s(xa);rn=g(nr,`Returns the repository name for a given model ID and optional
organization.`),nr.forEach(t),xo.forEach(t),ln=h(O),ze=n(O,"DIV",{class:!0});var jo=s(ze);H(Ht.$$.fragment,jo),cn=h(jo),ja=n(jo,"P",{});var sr=s(ja);gn=g(sr,"Gets all valid model tags as a nested namespace object"),sr.forEach(t),jo.forEach(t),pn=h(O),ie=n(O,"DIV",{class:!0});var mt=s(ie);H(Ft.$$.fragment,mt),hn=h(mt),Ha=n(mt,"P",{});var rr=s(Ha);dn=g(rr,"Get the public list of all the datasets on huggingface.co"),rr.forEach(t),fn=h(mt),H(Ve.$$.fragment,mt),un=h(mt),H(Ge.$$.fragment,mt),mt.forEach(t),mn=h(O),We=n(O,"DIV",{class:!0});var Ho=s(We);H(Dt.$$.fragment,Ho),_n=h(Ho),Fa=n(Ho,"P",{});var ir=s(Fa);bn=g(ir,"Get the public list of all the metrics on huggingface.co"),ir.forEach(t),Ho.forEach(t),vn=h(O),le=n(O,"DIV",{class:!0});var _t=s(le);H(Nt.$$.fragment,_t),$n=h(_t),Da=n(_t,"P",{});var lr=s(Da);yn=g(lr,"Get the public list of all the models on huggingface.co"),lr.forEach(t),kn=h(_t),H(Be.$$.fragment,_t),wn=h(_t),H(Ke.$$.fragment,_t),_t.forEach(t),En=h(O),Je=n(O,"DIV",{class:!0});var Fo=s(Je);H(qt.$$.fragment,Fo),An=h(Fo),Na=n(Fo,"P",{});var cr=s(Na);xn=g(cr,"Get the list of files in a given repo."),cr.forEach(t),Fo.forEach(t),jn=h(O),ce=n(O,"DIV",{class:!0});var bt=s(ce);H(It.$$.fragment,bt),Hn=h(bt),qa=n(bt,"P",{});var gr=s(qa);Fn=g(gr,"Get info on one specific model on huggingface.co"),gr.forEach(t),Dn=h(bt),Ia=n(bt,"P",{});var pr=s(Ia);Nn=g(pr,"Model can be private if you pass an acceptable token or are logged in."),pr.forEach(t),qn=h(bt),H(Qe.$$.fragment,bt),bt.forEach(t),In=h(O),ge=n(O,"DIV",{class:!0});var vt=s(ge);H(Lt.$$.fragment,vt),Ln=h(vt),La=n(vt,"P",{});var hr=s(La);Tn=g(hr,"Moving a repository from namespace1/repo_name1 to namespace2/repo_name2"),hr.forEach(t),Pn=h(vt),Tt=n(vt,"P",{});var Do=s(Tt);On=g(Do,`Note there are certain limitations. For more information about moving
repositories, please see
`),Pt=n(Do,"A",{href:!0,rel:!0});var dr=s(Pt);Mn=g(dr,"https://hf.co/docs/hub/main#how-can-i-rename-or-transfer-a-repo"),dr.forEach(t),Rn=g(Do,"."),Do.forEach(t),Sn=h(vt),H(Xe.$$.fragment,vt),vt.forEach(t),Un=h(O),He=n(O,"DIV",{class:!0});var fa=s(He);H(Ot.$$.fragment,fa),Cn=h(fa),Ta=n(fa,"P",{});var fr=s(Ta);zn=g(fr,"Get the info object for a given repo of a given type."),fr.forEach(t),Vn=h(fa),H(Ye.$$.fragment,fa),fa.forEach(t),Gn=h(O),Ze=n(O,"DIV",{class:!0});var No=s(Ze);H(Mt.$$.fragment,No),Wn=h(No),Pa=n(No,"P",{});var ur=s(Pa);Bn=g(ur,`Saves the passed access token so git can correctly authenticate the
user.`),ur.forEach(t),No.forEach(t),Kn=h(O),pe=n(O,"DIV",{class:!0});var $t=s(pe);H(Rt.$$.fragment,$t),Jn=h($t),Oa=n($t,"P",{});var mr=s(Oa);Qn=g(mr,"Get info on one specific Space on huggingface.co."),mr.forEach(t),Xn=h($t),Ma=n($t,"P",{});var _r=s(Ma);Yn=g(_r,"Space can be private if you pass an acceptable token."),_r.forEach(t),Zn=h($t),H(et.$$.fragment,$t),$t.forEach(t),es=h(O),tt=n(O,"DIV",{class:!0});var qo=s(tt);H(St.$$.fragment,qo),ts=h(qo),Ra=n(qo,"P",{});var br=s(Ra);as=g(br,"Resets the user\u2019s access token."),br.forEach(t),qo.forEach(t),os=h(O),Fe=n(O,"DIV",{class:!0});var ua=s(Fe);H(Ut.$$.fragment,ua),ns=h(ua),Sa=n(ua,"P",{});var vr=s(Sa);ss=g(vr,"Update the visibility setting of a repository."),vr.forEach(t),rs=h(ua),H(at.$$.fragment,ua),ua.forEach(t),is=h(O),he=n(O,"DIV",{class:!0});var yt=s(he);H(Ct.$$.fragment,yt),ls=h(yt),Ua=n(yt,"P",{});var $r=s(Ua);cs=g($r,`Upload a local file (up to 5GB) to the given repo. The upload is done
through a HTTP post request, and doesn\u2019t require git or git-lfs to be
installed.`),$r.forEach(t),gs=h(yt),H(ot.$$.fragment,yt),ps=h(yt),H(nt.$$.fragment,yt),yt.forEach(t),hs=h(O),st=n(O,"DIV",{class:!0});var Io=s(st);H(zt.$$.fragment,Io),ds=h(Io),Ca=n(Io,"P",{});var yr=s(Ca);fs=g(yr,"Call HF API to know \u201Cwhoami\u201D."),yr.forEach(t),Io.forEach(t),O.forEach(t),fo=h(a),Ie=n(a,"H2",{class:!0});var Lo=s(Ie);rt=n(Lo,"A",{id:!0,class:!0,href:!0});var kr=s(rt);za=n(kr,"SPAN",{});var wr=s(za);H(Vt.$$.fragment,wr),wr.forEach(t),kr.forEach(t),us=h(Lo),Va=n(Lo,"SPAN",{});var Er=s(Va);ms=g(Er,"Hugging Face local storage"),Er.forEach(t),Lo.forEach(t),uo=h(a),Gt=n(a,"P",{});var Ys=s(Gt);Ga=n(Ys,"CODE",{});var Ar=s(Ga);_s=g(Ar,"huggingface_hub"),Ar.forEach(t),bs=g(Ys,` stores the authentication information locally so that it may be re-used in subsequent
methods.`),Ys.forEach(t),mo=h(a),it=n(a,"P",{});var To=s(it);vs=g(To,"It does this using the "),pa=n(To,"A",{href:!0});var xr=s(pa);$s=g(xr,"HfFolder"),xr.forEach(t),ys=g(To," utility, which saves data at the root of the user."),To.forEach(t),_o=h(a),ne=n(a,"DIV",{class:!0});var kt=s(ne);H(Wt.$$.fragment,kt),ks=h(kt),lt=n(kt,"DIV",{class:!0});var Po=s(lt);H(Bt.$$.fragment,Po),ws=h(Po),Wa=n(Po,"P",{});var jr=s(Wa);Es=g(jr,"Deletes the token from storage. Does not fail if token does not exist."),jr.forEach(t),Po.forEach(t),As=h(kt),De=n(kt,"DIV",{class:!0});var ma=s(De);H(Kt.$$.fragment,ma),xs=h(ma),Ba=n(ma,"P",{});var Hr=s(Ba);js=g(Hr,"Get token or None if not existent."),Hr.forEach(t),Hs=h(ma),Jt=n(ma,"P",{});var Oo=s(Jt);Fs=g(Oo,"Note that a token can be also provided using the "),Ka=n(Oo,"CODE",{});var Fr=s(Ka);Ds=g(Fr,"HUGGING_FACE_HUB_TOKEN"),Fr.forEach(t),Ns=g(Oo,`
environment variable.`),Oo.forEach(t),ma.forEach(t),qs=h(kt),ct=n(kt,"DIV",{class:!0});var Mo=s(ct);H(Qt.$$.fragment,Mo),Is=h(Mo),Ja=n(Mo,"P",{});var Dr=s(Ja);Ls=g(Dr,"Save token, creating folder as needed."),Dr.forEach(t),Mo.forEach(t),kt.forEach(t),bo=h(a),Le=n(a,"H2",{class:!0});var Ro=s(Le);gt=n(Ro,"A",{id:!0,class:!0,href:!0});var Nr=s(gt);Qa=n(Nr,"SPAN",{});var qr=s(Qa);H(Xt.$$.fragment,qr),qr.forEach(t),Nr.forEach(t),Ts=h(Ro),Xa=n(Ro,"SPAN",{});var Ir=s(Xa);Ps=g(Ir,"Filtering helpers"),Ir.forEach(t),Ro.forEach(t),vo=h(a),pt=n(a,"P",{});var So=s(pt);Os=g(So,"Some helpers to filter repositories on the Hub are available in the "),Ya=n(So,"CODE",{});var Lr=s(Ya);Ms=g(Lr,"huggingface_hub"),Lr.forEach(t),Rs=g(So," package."),So.forEach(t),$o=h(a),be=n(a,"DIV",{class:!0});var _a=s(be);H(Yt.$$.fragment,_a),Ss=h(_a),Za=n(_a,"P",{});var Tr=s(Za);Us=g(Tr,`A class that converts human-readable dataset search parameters into ones
compatible with the REST API. For all parameters capitalization does not
matter.`),Tr.forEach(t),Cs=h(_a),H(ht.$$.fragment,_a),_a.forEach(t),yo=h(a),ve=n(a,"DIV",{class:!0});var ba=s(ve);H(Zt.$$.fragment,ba),zs=h(ba),eo=n(ba,"P",{});var Pr=s(eo);Vs=g(Pr,`A class that converts human-readable model search parameters into ones
compatible with the REST API. For all parameters capitalization does not
matter.`),Pr.forEach(t),Gs=h(ba),H(dt.$$.fragment,ba),ba.forEach(t),ko=h(a),$e=n(a,"DIV",{class:!0});var va=s($e);H(ea.$$.fragment,va),Ws=h(va),to=n(va,"P",{});var Or=s(to);Bs=g(Or,`A nested namespace object holding all possible values for properties of
datasets currently hosted in the Hub with tab-completion. If a value starts
with a number, it will only exist in the dictionary`),Or.forEach(t),Ks=h(va),H(ft.$$.fragment,va),va.forEach(t),wo=h(a),ye=n(a,"DIV",{class:!0});var $a=s(ye);H(ta.$$.fragment,$a),Js=h($a),ao=n($a,"P",{});var Mr=s(ao);Qs=g(Mr,`A nested namespace object holding all possible values for properties of
models currently hosted in the Hub with tab-completion. If a value starts
with a number, it will only exist in the dictionary`),Mr.forEach(t),Xs=h($a),H(ut.$$.fragment,$a),$a.forEach(t),this.h()},h(){w(i,"name","hf:doc:metadata"),w(i,"content",JSON.stringify(ci)),w(l,"id","huggingface_hub.HfApi"),w(l,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),w(l,"href","#huggingface_hub.HfApi"),w(u,"class","relative group"),w(me,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),w(re,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),w(xe,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),w(je,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),w(Ue,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),w(Ce,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),w(ze,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),w(ie,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),w(We,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),w(le,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),w(Je,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),w(ce,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),w(Pt,"href","https://hf.co/docs/hub/main#how-can-i-rename-or-transfer-a-repo"),w(Pt,"rel","nofollow"),w(ge,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),w(He,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),w(Ze,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),w(pe,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),w(tt,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),w(Fe,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),w(he,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),w(st,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),w(I,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),w(rt,"id","huggingface_hub.HfFolder"),w(rt,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),w(rt,"href","#huggingface_hub.HfFolder"),w(Ie,"class","relative group"),w(pa,"href","/docs/huggingface_hub/v0.8.0.rc1/en/package_reference/hf_api#huggingface_hub.HfFolder"),w(lt,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),w(De,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),w(ct,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),w(ne,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),w(gt,"id","huggingface_hub.DatasetFilter"),w(gt,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),w(gt,"href","#huggingface_hub.DatasetFilter"),w(Le,"class","relative group"),w(be,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),w(ve,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),w($e,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),w(ye,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8")},m(a,v){e(document.head,i),b(a,$,v),b(a,u,v),e(u,l),e(l,d),F(r,d,null),e(u,m),e(u,x),e(x,f),b(a,y,v),b(a,A,v),e(A,k),e(A,E),e(E,L),e(A,T),b(a,R,v),b(a,_,v),e(_,P),e(_,U),e(U,S),e(_,V),b(a,G,v),b(a,C,v),e(C,W),b(a,Z,v),F(J,a,v),b(a,se,v),b(a,ee,v),e(ee,Q),e(ee,X),e(X,Y),e(ee,de),b(a,fe,v),F(B,a,v),b(a,te,v),b(a,K,v),e(K,Ee),e(K,ae),e(ae,Ne),e(K,Ae),b(a,ue,v),b(a,I,v),F(oe,I,null),e(I,la),e(I,me),F(_e,me,null),e(me,ca),e(me,qe),e(qe,ga),e(I,Uo),e(I,re),F(wt,re,null),e(re,Co),e(re,ya),e(ya,zo),e(re,Vo),e(re,ka),e(ka,Go),e(re,Wo),F(Me,re,null),e(I,Bo),e(I,xe),F(Et,xe,null),e(xe,Ko),e(xe,wa),e(wa,Jo),e(xe,Qo),F(Re,xe,null),e(I,Xo),e(I,je),F(At,je,null),e(je,Yo),e(je,Ea),e(Ea,Zo),e(je,en),F(Se,je,null),e(I,tn),e(I,Ue),F(xt,Ue,null),e(Ue,an),e(Ue,Aa),e(Aa,on),e(I,nn),e(I,Ce),F(jt,Ce,null),e(Ce,sn),e(Ce,xa),e(xa,rn),e(I,ln),e(I,ze),F(Ht,ze,null),e(ze,cn),e(ze,ja),e(ja,gn),e(I,pn),e(I,ie),F(Ft,ie,null),e(ie,hn),e(ie,Ha),e(Ha,dn),e(ie,fn),F(Ve,ie,null),e(ie,un),F(Ge,ie,null),e(I,mn),e(I,We),F(Dt,We,null),e(We,_n),e(We,Fa),e(Fa,bn),e(I,vn),e(I,le),F(Nt,le,null),e(le,$n),e(le,Da),e(Da,yn),e(le,kn),F(Be,le,null),e(le,wn),F(Ke,le,null),e(I,En),e(I,Je),F(qt,Je,null),e(Je,An),e(Je,Na),e(Na,xn),e(I,jn),e(I,ce),F(It,ce,null),e(ce,Hn),e(ce,qa),e(qa,Fn),e(ce,Dn),e(ce,Ia),e(Ia,Nn),e(ce,qn),F(Qe,ce,null),e(I,In),e(I,ge),F(Lt,ge,null),e(ge,Ln),e(ge,La),e(La,Tn),e(ge,Pn),e(ge,Tt),e(Tt,On),e(Tt,Pt),e(Pt,Mn),e(Tt,Rn),e(ge,Sn),F(Xe,ge,null),e(I,Un),e(I,He),F(Ot,He,null),e(He,Cn),e(He,Ta),e(Ta,zn),e(He,Vn),F(Ye,He,null),e(I,Gn),e(I,Ze),F(Mt,Ze,null),e(Ze,Wn),e(Ze,Pa),e(Pa,Bn),e(I,Kn),e(I,pe),F(Rt,pe,null),e(pe,Jn),e(pe,Oa),e(Oa,Qn),e(pe,Xn),e(pe,Ma),e(Ma,Yn),e(pe,Zn),F(et,pe,null),e(I,es),e(I,tt),F(St,tt,null),e(tt,ts),e(tt,Ra),e(Ra,as),e(I,os),e(I,Fe),F(Ut,Fe,null),e(Fe,ns),e(Fe,Sa),e(Sa,ss),e(Fe,rs),F(at,Fe,null),e(I,is),e(I,he),F(Ct,he,null),e(he,ls),e(he,Ua),e(Ua,cs),e(he,gs),F(ot,he,null),e(he,ps),F(nt,he,null),e(I,hs),e(I,st),F(zt,st,null),e(st,ds),e(st,Ca),e(Ca,fs),b(a,fo,v),b(a,Ie,v),e(Ie,rt),e(rt,za),F(Vt,za,null),e(Ie,us),e(Ie,Va),e(Va,ms),b(a,uo,v),b(a,Gt,v),e(Gt,Ga),e(Ga,_s),e(Gt,bs),b(a,mo,v),b(a,it,v),e(it,vs),e(it,pa),e(pa,$s),e(it,ys),b(a,_o,v),b(a,ne,v),F(Wt,ne,null),e(ne,ks),e(ne,lt),F(Bt,lt,null),e(lt,ws),e(lt,Wa),e(Wa,Es),e(ne,As),e(ne,De),F(Kt,De,null),e(De,xs),e(De,Ba),e(Ba,js),e(De,Hs),e(De,Jt),e(Jt,Fs),e(Jt,Ka),e(Ka,Ds),e(Jt,Ns),e(ne,qs),e(ne,ct),F(Qt,ct,null),e(ct,Is),e(ct,Ja),e(Ja,Ls),b(a,bo,v),b(a,Le,v),e(Le,gt),e(gt,Qa),F(Xt,Qa,null),e(Le,Ts),e(Le,Xa),e(Xa,Ps),b(a,vo,v),b(a,pt,v),e(pt,Os),e(pt,Ya),e(Ya,Ms),e(pt,Rs),b(a,$o,v),b(a,be,v),F(Yt,be,null),e(be,Ss),e(be,Za),e(Za,Us),e(be,Cs),F(ht,be,null),b(a,yo,v),b(a,ve,v),F(Zt,ve,null),e(ve,zs),e(ve,eo),e(eo,Vs),e(ve,Gs),F(dt,ve,null),b(a,ko,v),b(a,$e,v),F(ea,$e,null),e($e,Ws),e($e,to),e(to,Bs),e($e,Ks),F(ft,$e,null),b(a,wo,v),b(a,ye,v),F(ta,ye,null),e(ye,Js),e(ye,ao),e(ao,Qs),e(ye,Xs),F(ut,ye,null),Eo=!0},p(a,[v]){const aa={};v&2&&(aa.$$scope={dirty:v,ctx:a}),Me.$set(aa);const oo={};v&2&&(oo.$$scope={dirty:v,ctx:a}),Re.$set(oo);const no={};v&2&&(no.$$scope={dirty:v,ctx:a}),Se.$set(no);const so={};v&2&&(so.$$scope={dirty:v,ctx:a}),Ve.$set(so);const oa={};v&2&&(oa.$$scope={dirty:v,ctx:a}),Ge.$set(oa);const ro={};v&2&&(ro.$$scope={dirty:v,ctx:a}),Be.$set(ro);const na={};v&2&&(na.$$scope={dirty:v,ctx:a}),Ke.$set(na);const io={};v&2&&(io.$$scope={dirty:v,ctx:a}),Qe.$set(io);const lo={};v&2&&(lo.$$scope={dirty:v,ctx:a}),Xe.$set(lo);const sa={};v&2&&(sa.$$scope={dirty:v,ctx:a}),Ye.$set(sa);const co={};v&2&&(co.$$scope={dirty:v,ctx:a}),et.$set(co);const ra={};v&2&&(ra.$$scope={dirty:v,ctx:a}),at.$set(ra);const go={};v&2&&(go.$$scope={dirty:v,ctx:a}),ot.$set(go);const O={};v&2&&(O.$$scope={dirty:v,ctx:a}),nt.$set(O);const ia={};v&2&&(ia.$$scope={dirty:v,ctx:a}),ht.$set(ia);const po={};v&2&&(po.$$scope={dirty:v,ctx:a}),dt.$set(po);const ke={};v&2&&(ke.$$scope={dirty:v,ctx:a}),ft.$set(ke);const ho={};v&2&&(ho.$$scope={dirty:v,ctx:a}),ut.$set(ho)},i(a){Eo||(D(r.$$.fragment,a),D(J.$$.fragment,a),D(B.$$.fragment,a),D(oe.$$.fragment,a),D(_e.$$.fragment,a),D(wt.$$.fragment,a),D(Me.$$.fragment,a),D(Et.$$.fragment,a),D(Re.$$.fragment,a),D(At.$$.fragment,a),D(Se.$$.fragment,a),D(xt.$$.fragment,a),D(jt.$$.fragment,a),D(Ht.$$.fragment,a),D(Ft.$$.fragment,a),D(Ve.$$.fragment,a),D(Ge.$$.fragment,a),D(Dt.$$.fragment,a),D(Nt.$$.fragment,a),D(Be.$$.fragment,a),D(Ke.$$.fragment,a),D(qt.$$.fragment,a),D(It.$$.fragment,a),D(Qe.$$.fragment,a),D(Lt.$$.fragment,a),D(Xe.$$.fragment,a),D(Ot.$$.fragment,a),D(Ye.$$.fragment,a),D(Mt.$$.fragment,a),D(Rt.$$.fragment,a),D(et.$$.fragment,a),D(St.$$.fragment,a),D(Ut.$$.fragment,a),D(at.$$.fragment,a),D(Ct.$$.fragment,a),D(ot.$$.fragment,a),D(nt.$$.fragment,a),D(zt.$$.fragment,a),D(Vt.$$.fragment,a),D(Wt.$$.fragment,a),D(Bt.$$.fragment,a),D(Kt.$$.fragment,a),D(Qt.$$.fragment,a),D(Xt.$$.fragment,a),D(Yt.$$.fragment,a),D(ht.$$.fragment,a),D(Zt.$$.fragment,a),D(dt.$$.fragment,a),D(ea.$$.fragment,a),D(ft.$$.fragment,a),D(ta.$$.fragment,a),D(ut.$$.fragment,a),Eo=!0)},o(a){N(r.$$.fragment,a),N(J.$$.fragment,a),N(B.$$.fragment,a),N(oe.$$.fragment,a),N(_e.$$.fragment,a),N(wt.$$.fragment,a),N(Me.$$.fragment,a),N(Et.$$.fragment,a),N(Re.$$.fragment,a),N(At.$$.fragment,a),N(Se.$$.fragment,a),N(xt.$$.fragment,a),N(jt.$$.fragment,a),N(Ht.$$.fragment,a),N(Ft.$$.fragment,a),N(Ve.$$.fragment,a),N(Ge.$$.fragment,a),N(Dt.$$.fragment,a),N(Nt.$$.fragment,a),N(Be.$$.fragment,a),N(Ke.$$.fragment,a),N(qt.$$.fragment,a),N(It.$$.fragment,a),N(Qe.$$.fragment,a),N(Lt.$$.fragment,a),N(Xe.$$.fragment,a),N(Ot.$$.fragment,a),N(Ye.$$.fragment,a),N(Mt.$$.fragment,a),N(Rt.$$.fragment,a),N(et.$$.fragment,a),N(St.$$.fragment,a),N(Ut.$$.fragment,a),N(at.$$.fragment,a),N(Ct.$$.fragment,a),N(ot.$$.fragment,a),N(nt.$$.fragment,a),N(zt.$$.fragment,a),N(Vt.$$.fragment,a),N(Wt.$$.fragment,a),N(Bt.$$.fragment,a),N(Kt.$$.fragment,a),N(Qt.$$.fragment,a),N(Xt.$$.fragment,a),N(Yt.$$.fragment,a),N(ht.$$.fragment,a),N(Zt.$$.fragment,a),N(dt.$$.fragment,a),N(ea.$$.fragment,a),N(ft.$$.fragment,a),N(ta.$$.fragment,a),N(ut.$$.fragment,a),Eo=!1},d(a){t(i),a&&t($),a&&t(u),q(r),a&&t(y),a&&t(A),a&&t(R),a&&t(_),a&&t(G),a&&t(C),a&&t(Z),q(J,a),a&&t(se),a&&t(ee),a&&t(fe),q(B,a),a&&t(te),a&&t(K),a&&t(ue),a&&t(I),q(oe),q(_e),q(wt),q(Me),q(Et),q(Re),q(At),q(Se),q(xt),q(jt),q(Ht),q(Ft),q(Ve),q(Ge),q(Dt),q(Nt),q(Be),q(Ke),q(qt),q(It),q(Qe),q(Lt),q(Xe),q(Ot),q(Ye),q(Mt),q(Rt),q(et),q(St),q(Ut),q(at),q(Ct),q(ot),q(nt),q(zt),a&&t(fo),a&&t(Ie),q(Vt),a&&t(uo),a&&t(Gt),a&&t(mo),a&&t(it),a&&t(_o),a&&t(ne),q(Wt),q(Bt),q(Kt),q(Qt),a&&t(bo),a&&t(Le),q(Xt),a&&t(vo),a&&t(pt),a&&t($o),a&&t(be),q(Yt),q(ht),a&&t(yo),a&&t(ve),q(Zt),q(dt),a&&t(ko),a&&t($e),q(ea),q(ft),a&&t(wo),a&&t(ye),q(ta),q(ut)}}}const ci={local:"huggingface_hub.HfApi",sections:[{local:"huggingface_hub.HfFolder",title:"Hugging Face local storage"},{local:"huggingface_hub.DatasetFilter",title:"Filtering helpers"}],title:"Hugging Face Hub API"};function gi(M){return zr(()=>{new URLSearchParams(window.location.search).get("fw")}),[]}class _i extends Rr{constructor(i){super();Sr(this,i,gi,li,Ur,{})}}export{_i as default,ci as metadata};
