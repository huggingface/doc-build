import{S as Ar,i as Tr,s as Pr,e as r,k as h,w as u,t as s,M as Sr,c as n,d as a,m as f,a as o,x as g,h as l,b as p,N as kr,F as t,g as c,y as m,L as Dr,q as d,o as _,B as b,v as Fr}from"../chunks/vendor-d3924577.js";import{I as Ba}from"../chunks/IconCopyLink-f94c3d80.js";import{C as y}from"../chunks/CodeBlock-ff545b14.js";function Mr(ii){let M,Ra,C,q,Xe,Z,Vt,Ze,es,Ja,L,as,Ve,ts,ss,Ua,I,z,ea,V,ls,aa,is,Ga,ee,ta,rs,ns,Wa,ae,Ya,K,os,ye,cs,hs,Qa,te,Xa,xe,fs,Za,B,sa,we,ps,us,la,$e,gs,Va,Ee,ms,et,x,ia,ra,ds,_s,na,oa,bs,vs,ca,ha,ys,xs,fa,ws,at,w,$s,pa,Es,js,ua,ks,As,ga,Ts,Ps,tt,H,R,ma,se,Ss,da,Ds,st,v,Fs,_a,Ms,Cs,ba,Is,Hs,je,Os,Ns,ke,qs,Ls,lt,le,it,E,zs,va,Ks,Bs,ya,Rs,Js,rt,O,J,xa,ie,Us,wa,Gs,nt,Ae,Ws,ot,Te,re,Ys,$a,Qs,Xs,ct,U,Zs,Ea,Vs,el,ht,ne,ft,j,al,ja,tl,sl,ka,ll,il,pt,G,rl,Aa,nl,ol,ut,oe,gt,k,cl,Ta,hl,fl,Pa,pl,ul,mt,ce,dt,A,gl,Sa,ml,dl,Da,_l,bl,_t,Pe,Se,ri,bt,De,Fe,ni,vt,T,vl,Me,yl,xl,Ce,wl,$l,yt,he,xt,W,El,Fa,jl,kl,wt,fe,$t,N,Y,Ma,pe,Al,Ca,Tl,Et,Ie,Pl,jt,He,Sl,kt,Oe,ue,Dl,Ia,Fl,Ml,At,P,Cl,Ne,Il,Hl,qe,Ol,Nl,Tt,ge,Pt,$,Ha,ql,Ll,Oa,zl,Kl,Na,Bl,Rl,St,me,Dt,S,Jl,qa,Ul,Gl,La,Wl,Yl,Ft,D,Ql,za,Xl,Zl,Ka,Vl,ei,Mt,de,Ct,Le,ai,It,_e,Ht,ze,ti,Ot,be,Nt,Ke,si,qt;return Z=new Ba({}),V=new Ba({}),ae=new y({props:{code:"pip install huggingface_hub",highlighted:"pip install huggingface_hub"}}),te=new y({props:{code:`from huggingface_hub import HfApi
...
}`}}),{c(){M=r("meta"),Ra=h(),C=r("h1"),q=r("a"),Xe=r("span"),u(Z.$$.fragment),Vt=h(),Ze=r("span"),es=s("Searching the Hub Efficiently with Python"),Ja=h(),L=r("p"),as=s("In this tutorial, we will explore how to interact and explore the Hugging Face Hub with the "),Ve=r("code"),ts=s("huggingface_hub"),ss=s(" library to help find available models and datasets quickly."),Ua=h(),I=r("h2"),z=r("a"),ea=r("span"),u(V.$$.fragment),ls=h(),aa=r("span"),is=s("The Basics"),Ga=h(),ee=r("p"),ta=r("code"),rs=s("huggingface_hub"),ns=s(" is a Python library that allows anyone to freely extract useful information from the Hub, as well as downloading and publishing models. You can install it with:"),Wa=h(),u(ae.$$.fragment),Ya=h(),K=r("p"),os=s("It comes packaged with an interface that can interact with the Hub in the "),ye=r("a"),cs=s("HfApi"),hs=s(" class:"),Qa=h(),u(te.$$.fragment),Xa=h(),xe=r("p"),fs=s("This class lets you perform a variety of operations that interact with the raw Hub API. We\u2019ll be focusing on two specific functions:"),Za=h(),B=r("ul"),sa=r("li"),we=r("a"),ps=s("list_models()"),us=h(),la=r("li"),$e=r("a"),gs=s("list_datasets()"),Va=h(),Ee=r("p"),ms=s("If you look at what can be passed into each function, you will find the parameter list looks something like:"),et=h(),x=r("ul"),ia=r("li"),ra=r("code"),ds=s("filter"),_s=h(),na=r("li"),oa=r("code"),bs=s("author"),vs=h(),ca=r("li"),ha=r("code"),ys=s("search"),xs=h(),fa=r("li"),ws=s("\u2026"),at=h(),w=r("p"),$s=s("Two of these parameters are intuitive ("),pa=r("code"),Es=s("author"),js=s(" and "),ua=r("code"),ks=s("search"),As=s("), but what about that "),ga=r("code"),Ts=s("filter"),Ps=s("? \u{1F914} Let\u2019s dive into a few helpers quickly and revisit that question."),tt=h(),H=r("h2"),R=r("a"),ma=r("span"),u(se.$$.fragment),Ss=h(),da=r("span"),Ds=s("Search Parameters"),st=h(),v=r("p"),Fs=s("The "),_a=r("code"),Ms=s("huggingface_hub"),Cs=s(" provides a user-friendly interface to know what exactly can be passed into this "),ba=r("code"),Is=s("filter"),Hs=s(" parameter through the "),je=r("a"),Os=s("ModelSearchArguments"),Ns=s(" and "),ke=r("a"),qs=s("DatasetSearchArguments"),Ls=s(" classes:"),lt=h(),u(le.$$.fragment),it=h(),E=r("p"),zs=s("These are nested namespace objects that have "),va=r("strong"),Ks=s("every single option"),Bs=s(" available on the Hub and that will return what should be passed to "),ya=r("code"),Rs=s("filter"),Js=s(". The best of all is: it has tab completion \u{1F38A} ."),rt=h(),O=r("h2"),J=r("a"),xa=r("span"),u(ie.$$.fragment),Us=h(),wa=r("span"),Gs=s("Searching for a Model"),nt=h(),Ae=r("p"),Ws=s("Let\u2019s pose a problem that would be complicated to solve without access to this information:"),ot=h(),Te=r("blockquote"),re=r("p"),Ys=s("I want to search the Hub for all PyTorch models trained on the "),$a=r("code"),Qs=s("glue"),Xs=s(" dataset that can do Text Classification."),ct=h(),U=r("p"),Zs=s("If you check what is available in "),Ea=r("code"),Vs=s("model_args"),el=s(" by checking it\u2019s output, you will find:"),ht=h(),u(ne.$$.fragment),ft=h(),j=r("p"),al=s("It has a variety of attributes or keys available to you. This is because it is both an object and a dictionary, so you can either do "),ja=r("code"),tl=s('model_args["author"]'),sl=s(" or "),ka=r("code"),ll=s("model_args.author"),il=s(". For this tutorial, let\u2019s follow the latter format."),pt=h(),G=r("p"),rl=s("The first criteria is getting all PyTorch models. This would be found under the "),Aa=r("code"),nl=s("library"),ol=s(" attribute, so let\u2019s see if it is there:"),ut=h(),u(oe.$$.fragment),gt=h(),k=r("p"),cl=s("It is! The "),Ta=r("code"),hl=s("PyTorch"),fl=s(" name is there, so you\u2019ll need to use "),Pa=r("code"),pl=s("model_args.library.PyTorch"),ul=s(":"),mt=h(),u(ce.$$.fragment),dt=h(),A=r("p"),gl=s("Below is an animation repeating the process for finding both the "),Sa=r("code"),ml=s("Text Classification"),dl=s(" and "),Da=r("code"),_l=s("glue"),bl=s(" requirements:"),_t=h(),Pe=r("p"),Se=r("img"),bt=h(),De=r("p"),Fe=r("img"),vt=h(),T=r("p"),vl=s("Now that all the pieces are there, the last step is to combine them all for something the API can use through the "),Me=r("a"),yl=s("ModelFilter"),xl=s(" and "),Ce=r("a"),wl=s("DatasetFilter"),$l=s(" classes. The classes transform the outputs of the previous step into something the API can use conveniently:"),yt=h(),u(he.$$.fragment),xt=h(),W=r("p"),El=s("As you can see, it found the models that fit all the criteria. You can even take it further by passing in an array for each of the parameters from before. For example, let\u2019s take a look for the same configuration, but also include "),Fa=r("code"),jl=s("TensorFlow"),kl=s(" in the filter:"),wt=h(),u(fe.$$.fragment),$t=h(),N=r("h2"),Y=r("a"),Ma=r("span"),u(pe.$$.fragment),Al=h(),Ca=r("span"),Tl=s("Searching for a Dataset"),Et=h(),Ie=r("p"),Pl=s("Similarly to finding a model, you can find a dataset easily by following the same steps."),jt=h(),He=r("p"),Sl=s("The new scenario will be:"),kt=h(),Oe=r("blockquote"),ue=r("p"),Dl=s("I want to search the Hub for all datasets that can be used for "),Ia=r("code"),Fl=s("text_classification"),Ml=s(" and are in English."),At=h(),P=r("p"),Cl=s("First, you should look at what is available in the "),Ne=r("a"),Il=s("DatasetSearchArguments"),Hl=s(", similar to the "),qe=r("a"),Ol=s("ModelSearchArguments"),Nl=s(":"),Tt=h(),u(ge.$$.fragment),Pt=h(),$=r("p"),Ha=r("code"),ql=s("text_classification"),Ll=s(" is a "),Oa=r("em"),zl=s("task"),Kl=s(", so first you should check "),Na=r("code"),Bl=s("task_categories"),Rl=s(":"),St=h(),u(me.$$.fragment),Dt=h(),S=r("p"),Jl=s("There you will find "),qa=r("code"),Ul=s("text_classification"),Gl=s(", so you should use "),La=r("code"),Wl=s("dataset_args.task_categories.text_classification"),Yl=s("."),Ft=h(),D=r("p"),Ql=s("Next we need to find the proper language. There is a "),za=r("code"),Xl=s("languages"),Zl=s(" property we can check. These are two-letter language codes, so you should check if it has "),Ka=r("code"),Vl=s("en"),ei=s(":"),Mt=h(),u(de.$$.fragment),Ct=h(),Le=r("p"),ai=s("Now that the pieces are found, you can write a filter:"),It=h(),u(_e.$$.fragment),Ht=h(),ze=r("p"),ti=s("And search the API!"),Ot=h(),u(be.$$.fragment),Nt=h(),Ke=r("p"),si=s("With these two functionalities combined, you can search for all available parameters and tags within the Hub to search for with ease for both Datasets and Models!"),this.h()},l(e){const i=Sr('[data-svelte="svelte-1phssyn"]',document.head);M=n(i,"META",{name:!0,content:!0}),i.forEach(a),Ra=f(e),C=n(e,"H1",{class:!0});var Lt=o(C);q=n(Lt,"A",{id:!0,class:!0,href:!0});var oi=o(q);Xe=n(oi,"SPAN",{});var ci=o(Xe);g(Z.$$.fragment,ci),ci.forEach(a),oi.forEach(a),Vt=f(Lt),Ze=n(Lt,"SPAN",{});var hi=o(Ze);es=l(hi,"Searching the Hub Efficiently with Python"),hi.forEach(a),Lt.forEach(a),Ja=f(e),L=n(e,"P",{});var zt=o(L);as=l(zt,"In this tutorial, we will explore how to interact and explore the Hugging Face Hub with the "),Ve=n(zt,"CODE",{});var fi=o(Ve);ts=l(fi,"huggingface_hub"),fi.forEach(a),ss=l(zt," library to help find available models and datasets quickly."),zt.forEach(a),Ua=f(e),I=n(e,"H2",{class:!0});var Kt=o(I);z=n(Kt,"A",{id:!0,class:!0,href:!0});var pi=o(z);ea=n(pi,"SPAN",{});var ui=o(ea);g(V.$$.fragment,ui),ui.forEach(a),pi.forEach(a),ls=f(Kt),aa=n(Kt,"SPAN",{});var gi=o(aa);is=l(gi,"The Basics"),gi.forEach(a),Kt.forEach(a),Ga=f(e),ee=n(e,"P",{});var li=o(ee);ta=n(li,"CODE",{});var mi=o(ta);rs=l(mi,"huggingface_hub"),mi.forEach(a),ns=l(li," is a Python library that allows anyone to freely extract useful information from the Hub, as well as downloading and publishing models. You can install it with:"),li.forEach(a),Wa=f(e),g(ae.$$.fragment,e),Ya=f(e),K=n(e,"P",{});var Bt=o(K);os=l(Bt,"It comes packaged with an interface that can interact with the Hub in the "),ye=n(Bt,"A",{href:!0});var di=o(ye);cs=l(di,"HfApi"),di.forEach(a),hs=l(Bt," class:"),Bt.forEach(a),Qa=f(e),g(te.$$.fragment,e),Xa=f(e),xe=n(e,"P",{});var _i=o(xe);fs=l(_i,"This class lets you perform a variety of operations that interact with the raw Hub API. We\u2019ll be focusing on two specific functions:"),_i.forEach(a),Za=f(e),B=n(e,"UL",{});var Rt=o(B);sa=n(Rt,"LI",{});var bi=o(sa);we=n(bi,"A",{href:!0});var vi=o(we);ps=l(vi,"list_models()"),vi.forEach(a),bi.forEach(a),us=f(Rt),la=n(Rt,"LI",{});var yi=o(la);$e=n(yi,"A",{href:!0});var xi=o($e);gs=l(xi,"list_datasets()"),xi.forEach(a),yi.forEach(a),Rt.forEach(a),Va=f(e),Ee=n(e,"P",{});var wi=o(Ee);ms=l(wi,"If you look at what can be passed into each function, you will find the parameter list looks something like:"),wi.forEach(a),et=f(e),x=n(e,"UL",{});var Q=o(x);ia=n(Q,"LI",{});var $i=o(ia);ra=n($i,"CODE",{});var Ei=o(ra);ds=l(Ei,"filter"),Ei.forEach(a),$i.forEach(a),_s=f(Q),na=n(Q,"LI",{});var ji=o(na);oa=n(ji,"CODE",{});var ki=o(oa);bs=l(ki,"author"),ki.forEach(a),ji.forEach(a),vs=f(Q),ca=n(Q,"LI",{});var Ai=o(ca);ha=n(Ai,"CODE",{});var Ti=o(ha);ys=l(Ti,"search"),Ti.forEach(a),Ai.forEach(a),xs=f(Q),fa=n(Q,"LI",{});var Pi=o(fa);ws=l(Pi,"\u2026"),Pi.forEach(a),Q.forEach(a),at=f(e),w=n(e,"P",{});var X=o(w);$s=l(X,"Two of these parameters are intuitive ("),pa=n(X,"CODE",{});var Si=o(pa);Es=l(Si,"author"),Si.forEach(a),js=l(X," and "),ua=n(X,"CODE",{});var Di=o(ua);ks=l(Di,"search"),Di.forEach(a),As=l(X,"), but what about that "),ga=n(X,"CODE",{});var Fi=o(ga);Ts=l(Fi,"filter"),Fi.forEach(a),Ps=l(X,"? \u{1F914} Let\u2019s dive into a few helpers quickly and revisit that question."),X.forEach(a),tt=f(e),H=n(e,"H2",{class:!0});var Jt=o(H);R=n(Jt,"A",{id:!0,class:!0,href:!0});var Mi=o(R);ma=n(Mi,"SPAN",{});var Ci=o(ma);g(se.$$.fragment,Ci),Ci.forEach(a),Mi.forEach(a),Ss=f(Jt),da=n(Jt,"SPAN",{});var Ii=o(da);Ds=l(Ii,"Search Parameters"),Ii.forEach(a),Jt.forEach(a),st=f(e),v=n(e,"P",{});var F=o(v);Fs=l(F,"The "),_a=n(F,"CODE",{});var Hi=o(_a);Ms=l(Hi,"huggingface_hub"),Hi.forEach(a),Cs=l(F," provides a user-friendly interface to know what exactly can be passed into this "),ba=n(F,"CODE",{});var Oi=o(ba);Is=l(Oi,"filter"),Oi.forEach(a),Hs=l(F," parameter through the "),je=n(F,"A",{href:!0});var Ni=o(je);Os=l(Ni,"ModelSearchArguments"),Ni.forEach(a),Ns=l(F," and "),ke=n(F,"A",{href:!0});var qi=o(ke);qs=l(qi,"DatasetSearchArguments"),qi.forEach(a),Ls=l(F," classes:"),F.forEach(a),lt=f(e),g(le.$$.fragment,e),it=f(e),E=n(e,"P",{});var Be=o(E);zs=l(Be,"These are nested namespace objects that have "),va=n(Be,"STRONG",{});var Li=o(va);Ks=l(Li,"every single option"),Li.forEach(a),Bs=l(Be," available on the Hub and that will return what should be passed to "),ya=n(Be,"CODE",{});var zi=o(ya);Rs=l(zi,"filter"),zi.forEach(a),Js=l(Be,". The best of all is: it has tab completion \u{1F38A} ."),Be.forEach(a),rt=f(e),O=n(e,"H2",{class:!0});var Ut=o(O);J=n(Ut,"A",{id:!0,class:!0,href:!0});var Ki=o(J);xa=n(Ki,"SPAN",{});var Bi=o(xa);g(ie.$$.fragment,Bi),Bi.forEach(a),Ki.forEach(a),Us=f(Ut),wa=n(Ut,"SPAN",{});var Ri=o(wa);Gs=l(Ri,"Searching for a Model"),Ri.forEach(a),Ut.forEach(a),nt=f(e),Ae=n(e,"P",{});var Ji=o(Ae);Ws=l(Ji,"Let\u2019s pose a problem that would be complicated to solve without access to this information:"),Ji.forEach(a),ot=f(e),Te=n(e,"BLOCKQUOTE",{});var Ui=o(Te);re=n(Ui,"P",{});var Gt=o(re);Ys=l(Gt,"I want to search the Hub for all PyTorch models trained on the "),$a=n(Gt,"CODE",{});var Gi=o($a);Qs=l(Gi,"glue"),Gi.forEach(a),Xs=l(Gt," dataset that can do Text Classification."),Gt.forEach(a),Ui.forEach(a),ct=f(e),U=n(e,"P",{});var Wt=o(U);Zs=l(Wt,"If you check what is available in "),Ea=n(Wt,"CODE",{});var Wi=o(Ea);Vs=l(Wi,"model_args"),Wi.forEach(a),el=l(Wt," by checking it\u2019s output, you will find:"),Wt.forEach(a),ht=f(e),g(ne.$$.fragment,e),ft=f(e),j=n(e,"P",{});var Re=o(j);al=l(Re,"It has a variety of attributes or keys available to you. This is because it is both an object and a dictionary, so you can either do "),ja=n(Re,"CODE",{});var Yi=o(ja);tl=l(Yi,'model_args["author"]'),Yi.forEach(a),sl=l(Re," or "),ka=n(Re,"CODE",{});var Qi=o(ka);ll=l(Qi,"model_args.author"),Qi.forEach(a),il=l(Re,". For this tutorial, let\u2019s follow the latter format."),Re.forEach(a),pt=f(e),G=n(e,"P",{});var Yt=o(G);rl=l(Yt,"The first criteria is getting all PyTorch models. This would be found under the "),Aa=n(Yt,"CODE",{});var Xi=o(Aa);nl=l(Xi,"library"),Xi.forEach(a),ol=l(Yt," attribute, so let\u2019s see if it is there:"),Yt.forEach(a),ut=f(e),g(oe.$$.fragment,e),gt=f(e),k=n(e,"P",{});var Je=o(k);cl=l(Je,"It is! The "),Ta=n(Je,"CODE",{});var Zi=o(Ta);hl=l(Zi,"PyTorch"),Zi.forEach(a),fl=l(Je," name is there, so you\u2019ll need to use "),Pa=n(Je,"CODE",{});var Vi=o(Pa);pl=l(Vi,"model_args.library.PyTorch"),Vi.forEach(a),ul=l(Je,":"),Je.forEach(a),mt=f(e),g(ce.$$.fragment,e),dt=f(e),A=n(e,"P",{});var Ue=o(A);gl=l(Ue,"Below is an animation repeating the process for finding both the "),Sa=n(Ue,"CODE",{});var er=o(Sa);ml=l(er,"Text Classification"),er.forEach(a),dl=l(Ue," and "),Da=n(Ue,"CODE",{});var ar=o(Da);_l=l(ar,"glue"),ar.forEach(a),bl=l(Ue," requirements:"),Ue.forEach(a),_t=f(e),Pe=n(e,"P",{});var tr=o(Pe);Se=n(tr,"IMG",{src:!0,alt:!0}),tr.forEach(a),bt=f(e),De=n(e,"P",{});var sr=o(De);Fe=n(sr,"IMG",{src:!0,alt:!0}),sr.forEach(a),vt=f(e),T=n(e,"P",{});var Ge=o(T);vl=l(Ge,"Now that all the pieces are there, the last step is to combine them all for something the API can use through the "),Me=n(Ge,"A",{href:!0});var lr=o(Me);yl=l(lr,"ModelFilter"),lr.forEach(a),xl=l(Ge," and "),Ce=n(Ge,"A",{href:!0});var ir=o(Ce);wl=l(ir,"DatasetFilter"),ir.forEach(a),$l=l(Ge," classes. The classes transform the outputs of the previous step into something the API can use conveniently:"),Ge.forEach(a),yt=f(e),g(he.$$.fragment,e),xt=f(e),W=n(e,"P",{});var Qt=o(W);El=l(Qt,"As you can see, it found the models that fit all the criteria. You can even take it further by passing in an array for each of the parameters from before. For example, let\u2019s take a look for the same configuration, but also include "),Fa=n(Qt,"CODE",{});var rr=o(Fa);jl=l(rr,"TensorFlow"),rr.forEach(a),kl=l(Qt," in the filter:"),Qt.forEach(a),wt=f(e),g(fe.$$.fragment,e),$t=f(e),N=n(e,"H2",{class:!0});var Xt=o(N);Y=n(Xt,"A",{id:!0,class:!0,href:!0});var nr=o(Y);Ma=n(nr,"SPAN",{});var or=o(Ma);g(pe.$$.fragment,or),or.forEach(a),nr.forEach(a),Al=f(Xt),Ca=n(Xt,"SPAN",{});var cr=o(Ca);Tl=l(cr,"Searching for a Dataset"),cr.forEach(a),Xt.forEach(a),Et=f(e),Ie=n(e,"P",{});var hr=o(Ie);Pl=l(hr,"Similarly to finding a model, you can find a dataset easily by following the same steps."),hr.forEach(a),jt=f(e),He=n(e,"P",{});var fr=o(He);Sl=l(fr,"The new scenario will be:"),fr.forEach(a),kt=f(e),Oe=n(e,"BLOCKQUOTE",{});var pr=o(Oe);ue=n(pr,"P",{});var Zt=o(ue);Dl=l(Zt,"I want to search the Hub for all datasets that can be used for "),Ia=n(Zt,"CODE",{});var ur=o(Ia);Fl=l(ur,"text_classification"),ur.forEach(a),Ml=l(Zt," and are in English."),Zt.forEach(a),pr.forEach(a),At=f(e),P=n(e,"P",{});var We=o(P);Cl=l(We,"First, you should look at what is available in the "),Ne=n(We,"A",{href:!0});var gr=o(Ne);Il=l(gr,"DatasetSearchArguments"),gr.forEach(a),Hl=l(We,", similar to the "),qe=n(We,"A",{href:!0});var mr=o(qe);Ol=l(mr,"ModelSearchArguments"),mr.forEach(a),Nl=l(We,":"),We.forEach(a),Tt=f(e),g(ge.$$.fragment,e),Pt=f(e),$=n(e,"P",{});var ve=o($);Ha=n(ve,"CODE",{});var dr=o(Ha);ql=l(dr,"text_classification"),dr.forEach(a),Ll=l(ve," is a "),Oa=n(ve,"EM",{});var _r=o(Oa);zl=l(_r,"task"),_r.forEach(a),Kl=l(ve,", so first you should check "),Na=n(ve,"CODE",{});var br=o(Na);Bl=l(br,"task_categories"),br.forEach(a),Rl=l(ve,":"),ve.forEach(a),St=f(e),g(me.$$.fragment,e),Dt=f(e),S=n(e,"P",{});var Ye=o(S);Jl=l(Ye,"There you will find "),qa=n(Ye,"CODE",{});var vr=o(qa);Ul=l(vr,"text_classification"),vr.forEach(a),Gl=l(Ye,", so you should use "),La=n(Ye,"CODE",{});var yr=o(La);Wl=l(yr,"dataset_args.task_categories.text_classification"),yr.forEach(a),Yl=l(Ye,"."),Ye.forEach(a),Ft=f(e),D=n(e,"P",{});var Qe=o(D);Ql=l(Qe,"Next we need to find the proper language. There is a "),za=n(Qe,"CODE",{});var xr=o(za);Xl=l(xr,"languages"),xr.forEach(a),Zl=l(Qe," property we can check. These are two-letter language codes, so you should check if it has "),Ka=n(Qe,"CODE",{});var wr=o(Ka);Vl=l(wr,"en"),wr.forEach(a),ei=l(Qe,":"),Qe.forEach(a),Mt=f(e),g(de.$$.fragment,e),Ct=f(e),Le=n(e,"P",{});var $r=o(Le);ai=l($r,"Now that the pieces are found, you can write a filter:"),$r.forEach(a),It=f(e),g(_e.$$.fragment,e),Ht=f(e),ze=n(e,"P",{});var Er=o(ze);ti=l(Er,"And search the API!"),Er.forEach(a),Ot=f(e),g(be.$$.fragment,e),Nt=f(e),Ke=n(e,"P",{});var jr=o(Ke);si=l(jr,"With these two functionalities combined, you can search for all available parameters and tags within the Hub to search for with ease for both Datasets and Models!"),jr.forEach(a),this.h()},h(){p(M,"name","hf:doc:metadata"),p(M,"content",JSON.stringify(Cr)),p(q,"id","searching-the-hub-efficiently-with-python"),p(q,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),p(q,"href","#searching-the-hub-efficiently-with-python"),p(C,"class","relative group"),p(z,"id","the-basics"),p(z,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),p(z,"href","#the-basics"),p(I,"class","relative group"),p(ye,"href","/docs/huggingface_hub/main/en/package_reference/hf_api#huggingface_hub.HfApi"),p(we,"href","/docs/huggingface_hub/main/en/package_reference/hf_api#huggingface_hub.HfApi.list_models"),p($e,"href","/docs/huggingface_hub/main/en/package_reference/hf_api#huggingface_hub.HfApi.list_datasets"),p(R,"id","search-parameters"),p(R,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),p(R,"href","#search-parameters"),p(H,"class","relative group"),p(je,"href","/docs/huggingface_hub/main/en/package_reference/hf_api#huggingface_hub.ModelSearchArguments"),p(ke,"href","/docs/huggingface_hub/main/en/package_reference/hf_api#huggingface_hub.DatasetSearchArguments"),p(J,"id","searching-for-a-model"),p(J,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),p(J,"href","#searching-for-a-model"),p(O,"class","relative group"),kr(Se.src,ri="https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/search_text_classification.gif")||p(Se,"src",ri),p(Se,"alt","Animation exploring `model_args.pipeline_tag`"),kr(Fe.src,ni="https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/search_glue.gif")||p(Fe,"src",ni),p(Fe,"alt","Animation exploring `model_args.dataset`"),p(Me,"href","/docs/huggingface_hub/main/en/package_reference/hf_api#huggingface_hub.ModelFilter"),p(Ce,"href","/docs/huggingface_hub/main/en/package_reference/hf_api#huggingface_hub.DatasetFilter"),p(Y,"id","searching-for-a-dataset"),p(Y,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),p(Y,"href","#searching-for-a-dataset"),p(N,"class","relative group"),p(Ne,"href","/docs/huggingface_hub/main/en/package_reference/hf_api#huggingface_hub.DatasetSearchArguments"),p(qe,"href","/docs/huggingface_hub/main/en/package_reference/hf_api#huggingface_hub.ModelSearchArguments")},m(e,i){t(document.head,M),c(e,Ra,i),c(e,C,i),t(C,q),t(q,Xe),m(Z,Xe,null),t(C,Vt),t(C,Ze),t(Ze,es),c(e,Ja,i),c(e,L,i),t(L,as),t(L,Ve),t(Ve,ts),t(L,ss),c(e,Ua,i),c(e,I,i),t(I,z),t(z,ea),m(V,ea,null),t(I,ls),t(I,aa),t(aa,is),c(e,Ga,i),c(e,ee,i),t(ee,ta),t(ta,rs),t(ee,ns),c(e,Wa,i),m(ae,e,i),c(e,Ya,i),c(e,K,i),t(K,os),t(K,ye),t(ye,cs),t(K,hs),c(e,Qa,i),m(te,e,i),c(e,Xa,i),c(e,xe,i),t(xe,fs),c(e,Za,i),c(e,B,i),t(B,sa),t(sa,we),t(we,ps),t(B,us),t(B,la),t(la,$e),t($e,gs),c(e,Va,i),c(e,Ee,i),t(Ee,ms),c(e,et,i),c(e,x,i),t(x,ia),t(ia,ra),t(ra,ds),t(x,_s),t(x,na),t(na,oa),t(oa,bs),t(x,vs),t(x,ca),t(ca,ha),t(ha,ys),t(x,xs),t(x,fa),t(fa,ws),c(e,at,i),c(e,w,i),t(w,$s),t(w,pa),t(pa,Es),t(w,js),t(w,ua),t(ua,ks),t(w,As),t(w,ga),t(ga,Ts),t(w,Ps),c(e,tt,i),c(e,H,i),t(H,R),t(R,ma),m(se,ma,null),t(H,Ss),t(H,da),t(da,Ds),c(e,st,i),c(e,v,i),t(v,Fs),t(v,_a),t(_a,Ms),t(v,Cs),t(v,ba),t(ba,Is),t(v,Hs),t(v,je),t(je,Os),t(v,Ns),t(v,ke),t(ke,qs),t(v,Ls),c(e,lt,i),m(le,e,i),c(e,it,i),c(e,E,i),t(E,zs),t(E,va),t(va,Ks),t(E,Bs),t(E,ya),t(ya,Rs),t(E,Js),c(e,rt,i),c(e,O,i),t(O,J),t(J,xa),m(ie,xa,null),t(O,Us),t(O,wa),t(wa,Gs),c(e,nt,i),c(e,Ae,i),t(Ae,Ws),c(e,ot,i),c(e,Te,i),t(Te,re),t(re,Ys),t(re,$a),t($a,Qs),t(re,Xs),c(e,ct,i),c(e,U,i),t(U,Zs),t(U,Ea),t(Ea,Vs),t(U,el),c(e,ht,i),m(ne,e,i),c(e,ft,i),c(e,j,i),t(j,al),t(j,ja),t(ja,tl),t(j,sl),t(j,ka),t(ka,ll),t(j,il),c(e,pt,i),c(e,G,i),t(G,rl),t(G,Aa),t(Aa,nl),t(G,ol),c(e,ut,i),m(oe,e,i),c(e,gt,i),c(e,k,i),t(k,cl),t(k,Ta),t(Ta,hl),t(k,fl),t(k,Pa),t(Pa,pl),t(k,ul),c(e,mt,i),m(ce,e,i),c(e,dt,i),c(e,A,i),t(A,gl),t(A,Sa),t(Sa,ml),t(A,dl),t(A,Da),t(Da,_l),t(A,bl),c(e,_t,i),c(e,Pe,i),t(Pe,Se),c(e,bt,i),c(e,De,i),t(De,Fe),c(e,vt,i),c(e,T,i),t(T,vl),t(T,Me),t(Me,yl),t(T,xl),t(T,Ce),t(Ce,wl),t(T,$l),c(e,yt,i),m(he,e,i),c(e,xt,i),c(e,W,i),t(W,El),t(W,Fa),t(Fa,jl),t(W,kl),c(e,wt,i),m(fe,e,i),c(e,$t,i),c(e,N,i),t(N,Y),t(Y,Ma),m(pe,Ma,null),t(N,Al),t(N,Ca),t(Ca,Tl),c(e,Et,i),c(e,Ie,i),t(Ie,Pl),c(e,jt,i),c(e,He,i),t(He,Sl),c(e,kt,i),c(e,Oe,i),t(Oe,ue),t(ue,Dl),t(ue,Ia),t(Ia,Fl),t(ue,Ml),c(e,At,i),c(e,P,i),t(P,Cl),t(P,Ne),t(Ne,Il),t(P,Hl),t(P,qe),t(qe,Ol),t(P,Nl),c(e,Tt,i),m(ge,e,i),c(e,Pt,i),c(e,$,i),t($,Ha),t(Ha,ql),t($,Ll),t($,Oa),t(Oa,zl),t($,Kl),t($,Na),t(Na,Bl),t($,Rl),c(e,St,i),m(me,e,i),c(e,Dt,i),c(e,S,i),t(S,Jl),t(S,qa),t(qa,Ul),t(S,Gl),t(S,La),t(La,Wl),t(S,Yl),c(e,Ft,i),c(e,D,i),t(D,Ql),t(D,za),t(za,Xl),t(D,Zl),t(D,Ka),t(Ka,Vl),t(D,ei),c(e,Mt,i),m(de,e,i),c(e,Ct,i),c(e,Le,i),t(Le,ai),c(e,It,i),m(_e,e,i),c(e,Ht,i),c(e,ze,i),t(ze,ti),c(e,Ot,i),m(be,e,i),c(e,Nt,i),c(e,Ke,i),t(Ke,si),qt=!0},p:Dr,i(e){qt||(d(Z.$$.fragment,e),d(V.$$.fragment,e),d(ae.$$.fragment,e),d(te.$$.fragment,e),d(se.$$.fragment,e),d(le.$$.fragment,e),d(ie.$$.fragment,e),d(ne.$$.fragment,e),d(oe.$$.fragment,e),d(ce.$$.fragment,e),d(he.$$.fragment,e),d(fe.$$.fragment,e),d(pe.$$.fragment,e),d(ge.$$.fragment,e),d(me.$$.fragment,e),d(de.$$.fragment,e),d(_e.$$.fragment,e),d(be.$$.fragment,e),qt=!0)},o(e){_(Z.$$.fragment,e),_(V.$$.fragment,e),_(ae.$$.fragment,e),_(te.$$.fragment,e),_(se.$$.fragment,e),_(le.$$.fragment,e),_(ie.$$.fragment,e),_(ne.$$.fragment,e),_(oe.$$.fragment,e),_(ce.$$.fragment,e),_(he.$$.fragment,e),_(fe.$$.fragment,e),_(pe.$$.fragment,e),_(ge.$$.fragment,e),_(me.$$.fragment,e),_(de.$$.fragment,e),_(_e.$$.fragment,e),_(be.$$.fragment,e),qt=!1},d(e){a(M),e&&a(Ra),e&&a(C),b(Z),e&&a(Ja),e&&a(L),e&&a(Ua),e&&a(I),b(V),e&&a(Ga),e&&a(ee),e&&a(Wa),b(ae,e),e&&a(Ya),e&&a(K),e&&a(Qa),b(te,e),e&&a(Xa),e&&a(xe),e&&a(Za),e&&a(B),e&&a(Va),e&&a(Ee),e&&a(et),e&&a(x),e&&a(at),e&&a(w),e&&a(tt),e&&a(H),b(se),e&&a(st),e&&a(v),e&&a(lt),b(le,e),e&&a(it),e&&a(E),e&&a(rt),e&&a(O),b(ie),e&&a(nt),e&&a(Ae),e&&a(ot),e&&a(Te),e&&a(ct),e&&a(U),e&&a(ht),b(ne,e),e&&a(ft),e&&a(j),e&&a(pt),e&&a(G),e&&a(ut),b(oe,e),e&&a(gt),e&&a(k),e&&a(mt),b(ce,e),e&&a(dt),e&&a(A),e&&a(_t),e&&a(Pe),e&&a(bt),e&&a(De),e&&a(vt),e&&a(T),e&&a(yt),b(he,e),e&&a(xt),e&&a(W),e&&a(wt),b(fe,e),e&&a($t),e&&a(N),b(pe),e&&a(Et),e&&a(Ie),e&&a(jt),e&&a(He),e&&a(kt),e&&a(Oe),e&&a(At),e&&a(P),e&&a(Tt),b(ge,e),e&&a(Pt),e&&a($),e&&a(St),b(me,e),e&&a(Dt),e&&a(S),e&&a(Ft),e&&a(D),e&&a(Mt),b(de,e),e&&a(Ct),e&&a(Le),e&&a(It),b(_e,e),e&&a(Ht),e&&a(ze),e&&a(Ot),b(be,e),e&&a(Nt),e&&a(Ke)}}}const Cr={local:"searching-the-hub-efficiently-with-python",sections:[{local:"the-basics",title:"The Basics"},{local:"search-parameters",title:"Search Parameters"},{local:"searching-for-a-model",title:"Searching for a Model"},{local:"searching-for-a-dataset",title:"Searching for a Dataset"}],title:"Searching the Hub Efficiently with Python"};function Ir(ii){return Fr(()=>{new URLSearchParams(window.location.search).get("fw")}),[]}class qr extends Ar{constructor(M){super();Tr(this,M,Ir,Mr,Pr,{})}}export{qr as default,Cr as metadata};
