import{S as rm,i as cm,s as hm,e as l,k as h,w as p,t as s,M as dm,c as n,d as t,m as d,a as i,x as m,h as o,b as f,T as fm,G as a,g as c,y as u,q as b,o as g,B as v,v as pm}from"../chunks/vendor-hf-doc-builder.js";import{T as wd}from"../chunks/Tip-hf-doc-builder.js";import{I}from"../chunks/IconCopyLink-hf-doc-builder.js";import{C as D}from"../chunks/CodeBlock-hf-doc-builder.js";function mm(_e){let w,$,y,E;return{c(){w=l("p"),$=l("a"),y=s("cached_assets_path()"),E=s(` is the recommended way to store assets but is not mandatory. If
...
your library already uses its own cache, feel free to use it!`),_.forEach(t),this.h()},h(){f($,"href","/docs/huggingface_hub/main/en/package_reference/cache#huggingface_hub.cached_assets_path")},m(k,_){c(k,w,_),a(w,$),a($,y),a(w,E)},d(k){k&&t(w)}}}function um(_e){let w,$,y,E,k,_,C,S;return{c(){w=l("p"),$=s(`Revision hashes are unique across all repositories. This means you don\u2019t need to
...
provide any `),y=n(P,"CODE",{});var Qa=i(y);E=o(Qa,"repo_id"),Qa.forEach(t),k=o(P," or "),_=n(P,"CODE",{});var Za=i(_);C=o(Za,"repo_type"),Za.forEach(t),S=o(P," when removing revisions."),P.forEach(t)},m(ae,P){c(ae,w,P),a(w,$),a(w,y),a(y,E),a(w,k),a(w,_),a(_,C),a(w,S)},d(ae){ae&&t(w)}}}function bm(_e){let w,$,y,E,k;return{c(){w=l("p"),$=s(`If a revision is not found in the cache, it will be silently ignored. Besides, if a file
...
or folder cannot be found while trying to delete it, a warning will be logged but no
error is thrown. The deletion continues for other paths contained in the
`),y=n(C,"A",{href:!0});var S=i(y);E=o(S,"DeleteCacheStrategy"),S.forEach(t),k=o(C," object."),C.forEach(t),this.h()},h(){f(y,"href","/docs/huggingface_hub/main/en/package_reference/cache#huggingface_hub.DeleteCacheStrategy")},m(_,C){c(_,w,C),a(w,$),a(w,y),a(y,E),a(w,k)},d(_){_&&t(w)}}}function gm(_e){let w,$,y,E,k,_,C,S,ae,P,Qa,Za,To,te,Ee,Lt,ia,Wn,Mt,zn,jo,Xa,Yn,Oo,et,Jn,xo,ra,Ho,T,Vn,Ft,Qn,Zn,Gt,Xn,ei,Ut,ai,ti,qt,si,oi,No,at,li,Ro,ca,Lo,tt,ni,Mo,st,ii,Fo,ha,Go,ot,ri,Uo,se,$e,Bt,da,ci,Kt,hi,qo,j,di,Wt,fi,pi,zt,mi,ui,Yt,bi,gi,Jt,vi,wi,Bo,N,yi,Vt,_i,Ei,Qt,$i,ki,Zt,Ii,Ci,Ko,R,Di,Xt,Ai,Si,es,Pi,Ti,as,ji,Oi,Wo,oe,ke,ts,fa,xi,ss,Hi,zo,Ie,Ni,os,Ri,Li,Yo,le,Ce,ls,pa,Mi,ns,Fi,Jo,De,Gi,is,Ui,qi,Vo,A,Bi,rs,Ki,Wi,cs,zi,Yi,hs,Ji,Vi,ds,Qi,Zi,fs,Xi,er,Qo,K,ar,ps,tr,sr,ms,or,lr,Zo,ma,Xo,Ae,nr,us,ir,rr,el,Se,cr,bs,hr,dr,al,ne,Pe,gs,ua,fr,vs,pr,tl,lt,mr,sl,ba,ol,ie,Te,ws,ga,ur,ys,br,ll,O,gr,_s,vr,wr,Es,yr,_r,$s,Er,$r,ks,kr,Ir,nl,je,Cr,va,Dr,Ar,il,Oe,Sr,Is,Pr,Tr,rl,re,xe,Cs,wa,jr,Ds,Or,cl,x,xr,As,Hr,Nr,Ss,Rr,Lr,nt,Mr,Fr,Ps,Gr,Ur,hl,ya,dl,He,fl,ce,Ne,Ts,_a,qr,js,Br,pl,it,Kr,ml,Ea,ul,he,Re,Os,$a,Wr,xs,zr,bl,W,Yr,Hs,Jr,Vr,Ns,Qr,Zr,gl,de,Le,Rs,ka,Xr,Ls,ec,vl,z,ac,Ms,tc,sc,Fs,oc,lc,wl,rt,nc,yl,Ia,_l,Y,ic,Gs,rc,cc,Us,hc,dc,El,Ca,$l,fe,Me,qs,Da,fc,Bs,pc,kl,Fe,mc,Ks,uc,bc,Il,Aa,Cl,pe,Ge,Ws,Sa,gc,zs,vc,Dl,Ue,wc,ct,yc,_c,Al,ht,Ec,Sl,L,Pa,dt,$c,kc,ft,Ic,Cc,pt,mt,Dc,Ac,Sc,ut,bt,Pc,Tc,jc,gt,vt,Oc,xc,Pl,wt,Hc,Tl,Ta,jl,me,qe,Ys,ja,Nc,Js,Rc,Ol,M,Lc,Vs,Mc,Fc,yt,Gc,Uc,_t,qc,Bc,xl,ue,Be,Qs,Oa,Kc,Zs,Wc,Hl,J,zc,Et,Yc,Jc,$t,Vc,Qc,Nl,kt,Zc,Rl,F,xa,Xc,Xs,eh,ah,th,eo,sh,oh,Ha,lh,ao,nh,ih,rh,to,ch,Ll,Ke,Ml,We,Fl,be,ze,so,Na,hh,oo,dh,Gl,G,fh,lo,ph,mh,no,uh,bh,io,gh,vh,Ul,ge,Ye,ro,Ra,wh,co,yh,ql,It,_h,Bl,La,Kl,Ct,Eh,Wl,Ma,zl,Dt,$h,Yl,Fa,ho,yd,Jl,At,kh,Vl,H,ve,Ih,fo,Ch,Dh,po,Ah,Sh,Ph,Ga,Th,mo,jh,Oh,xh,uo,Hh,Nh,Ua,Rh,bo,Lh,Mh,Fh,qa,Gh,go,Uh,qh,Ql,U,Bh,vo,Kh,Wh,wo,zh,Yh,yo,Jh,Vh,Zl,Ba,Xl,we,Je,_o,Ka,Qh,Eo,Zh,en,St,Xh,an,Ve,ed,$o,ad,td,tn,q,sd,ko,od,ld,Io,nd,id,Co,rd,cd,sn,Wa,on,Pt,hd,ln,za,nn,ye,Qe,Do,Ya,dd,Ao,fd,rn,Ze,pd,Tt,md,ud,cn,Ja,hn;return _=new I({}),ia=new I({}),ra=new D({props:{code:`<CACHE_DIR>
\u251C\u2500 <MODELS>
\u251C\u2500 <DATASETS>
...
\u2502  \u251C\u2500 blobs
\u2502  \u251C\u2500 snapshots
<span class="hljs-string">...</span>`}}),da=new I({}),fa=new I({}),pa=new I({}),ma=new D({props:{code:"<CACHE_DIR>/<REPO_NAME>/snapshots/aaaaaa/README.md",highlighted:'&lt;CACHE_DIR&gt;<span class="hljs-regexp">/&lt;REPO_NAME&gt;/</span>snapshots<span class="hljs-regexp">/aaaaaa/</span>README.md'}}),ua=new I({}),ba=new D({props:{code:`    [  96]  .
...
something_path = assets_path / <span class="hljs-string">&quot;something.json&quot;</span> <span class="hljs-comment"># Do anything you like in your assets folder !</span>`}}),He=new wd({props:{$$slots:{default:[mm]},$$scope:{ctx:_e}}}),_a=new I({}),Ea=new D({props:{code:`    assets/
    \u2514\u2500\u2500 datasets/
    \u2502   \u251C\u2500\u2500 SQuAD/
    \u2502   \u2502   \u251C\u2500\u2500 downloaded/
    \u2502   \u2502   \u251C\u2500\u2500 extracted/
...
if we have previously fetched a file from the `),zt=l("code"),mi=s("main"),ui=s(" branch of a repository, the "),Yt=l("code"),bi=s("refs"),gi=s(`
...
if we had downloaded the `),ps=l("code"),tr=s("README.md"),sr=s(" file at revision "),ms=l("code"),or=s("aaaaaa"),lr=s(", we would have the following path:"),Zo=h(),p(ma.$$.fragment),Xo=h(),Ae=l("p"),nr=s("That "),us=l("code"),ir=s("README.md"),rr=s(" file is actually a symlink linking to the blob that has the hash of the file."),el=h(),Se=l("p"),cr=s(`By creating the skeleton this way we open the mechanism to file sharing: if the same file was fetched in
revision `),bs=l("code"),hr=s("bbbbbb"),dr=s(", it would have the same hash and the file would not need to be re-downloaded."),al=h(),ne=l("h3"),Pe=l("a"),gs=l("span"),p(ua.$$.fragment),fr=h(),vs=l("span"),pr=s("In practice"),tl=h(),lt=l("p"),mr=s("In practice, your cache should look like the following tree:"),sl=h(),p(ba.$$.fragment),ol=h(),ie=l("h3"),Te=l("a"),ws=l("span"),p(ga.$$.fragment),ur=h(),ys=l("span"),br=s("Limitations"),ll=h(),O=l("p"),gr=s("In order to have an efficient cache-system, "),_s=l("code"),vr=s("huggingface-hub"),wr=s(` uses symlinks. However,
...
usage is only 1.9G.`),El=h(),p(Ca.$$.fragment),$l=h(),fe=l("h4"),Me=l("a"),qs=l("span"),p(Da.$$.fragment),fc=h(),Bs=l("span"),pc=s("Grep example"),kl=h(),Fe=l("p"),mc=s("Since the output is in tabular format, you can combine it with any "),Ks=l("code"),uc=s("grep"),bc=s(`-like tools to
...
the CLI tool.`),Al=h(),ht=l("p"),Ec=s("You can use it to get a detailed report structured around 4 dataclasses:"),Sl=h(),L=l("ul"),Pa=l("li"),dt=l("a"),$c=s("HFCacheInfo"),kc=s(": complete report returned by "),ft=l("a"),Ic=s("scan_cache_dir()"),Cc=h(),pt=l("li"),mt=l("a"),Dc=s("CachedRepoInfo"),Ac=s(": information about a cached repo"),Sc=h(),ut=l("li"),bt=l("a"),Pc=s("CachedRevisionInfo"),Tc=s(": information about a cached revision (e.g. \u201Csnapshot\u201D) inside a repo"),jc=h(),gt=l("li"),vt=l("a"),Oc=s("CachedFileInfo"),xc=s(": information about a cached file in a snapshot"),Pl=h(),wt=l("p"),Hc=s("Here is a simple usage example. See reference for details."),Tl=h(),p(Ta.$$.fragment),jl=h(),me=l("h2"),qe=l("a"),Ys=l("span"),p(ja.$$.fragment),Nc=h(),Js=l("span"),Rc=s("Clean your cache"),Ol=h(),M=l("p"),Lc=s(`Scanning your cache is interesting but what you really want to do next is usually to
...
scanning the cache.`),xl=h(),ue=l("h3"),Be=l("a"),Qs=l("span"),p(Oa.$$.fragment),Kc=h(),Zs=l("span"),Wc=s("Delete strategy"),Hl=h(),J=l("p"),zc=s(`To delete some cache, you need to pass a list of revisions to delete. The tool will
...
`),lo=l("code"),ph=s("delete-cache"),mh=s(" command from "),no=l("code"),uh=s("huggingface-cli"),bh=s(` tool. The command has two modes. By
...
running the following command:`),Bl=h(),p(La.$$.fragment),Kl=h(),Ct=l("p"),Eh=s("Then run the command:"),Wl=h(),p(Ma.$$.fragment),zl=h(),Dt=l("p"),$h=s("You should now see a list of revisions that you can select/deselect:"),Yl=h(),Fa=l("div"),ho=l("img"),Jl=h(),At=l("p"),kh=s("Instructions:"),Vl=h(),H=l("ul"),ve=l("li"),Ih=s("Press keyboard arrow keys "),fo=l("code"),Ch=s("<up>"),Dh=s(" and "),po=l("code"),Ah=s("<down>"),Sh=s(" to move the cursor."),Ph=h(),Ga=l("li"),Th=s("Press "),mo=l("code"),jh=s("<space>"),Oh=s(" to toggle (select/unselect) an item."),xh=h(),uo=l("li"),Hh=s(`When a revision is selected, the first line is updated to show you how much space
...
updated list of revisions. You can continue to edit the file or confirm with `),Co=l("code"),rd=s('"y"'),cd=s("."),sn=h(),p(Wa.$$.fragment),on=h(),Pt=l("p"),hd=s("Example of command file:"),ln=h(),p(za.$$.fragment),nn=h(),ye=l("h3"),Qe=l("a"),Do=l("span"),p(Ya.$$.fragment),dd=h(),Ao=l("span"),fd=s("Clean cache from Python"),rn=h(),Ze=l("p"),pd=s("For more flexibility, you can also use the "),Tt=l("a"),md=s("delete_revisions()"),ud=s(` method
programmatically. Here is a simple example. See reference for details.`),cn=h(),p(Ja.$$.fragment),this.h()},l(e){const r=dm('[data-svelte="svelte-1phssyn"]',document.head);w=n(r,"META",{name:!0,content:!0}),r.forEach(t),$=d(e),y=n(e,"H1",{class:!0});var Va=i(y);E=n(Va,"A",{id:!0,class:!0,href:!0});var So=i(E);k=n(So,"SPAN",{});var Po=i(k);m(_.$$.fragment,Po),Po.forEach(t),So.forEach(t),C=d(Va),S=n(Va,"SPAN",{});var dn=i(S);ae=o(dn,"Manage "),P=n(dn,"CODE",{});var _d=i(P);Qa=o(_d,"huggingface_hub"),_d.forEach(t),Za=o(dn," cache-system"),dn.forEach(t),Va.forEach(t),To=d(e),te=n(e,"H2",{class:!0});var fn=i(te);Ee=n(fn,"A",{id:!0,class:!0,href:!0});var Ed=i(Ee);Lt=n(Ed,"SPAN",{});var $d=i(Lt);m(ia.$$.fragment,$d),$d.forEach(t),Ed.forEach(t),Wn=d(fn),Mt=n(fn,"SPAN",{});var kd=i(Mt);zn=o(kd,"Understand caching"),kd.forEach(t),fn.forEach(t),jo=d(e),Xa=n(e,"P",{});var Id=i(Xa);Yn=o(Id,`The Hugging Face Hub cache-system is designed to be the central cache shared across libraries
that depend on the Hub. It has been updated in v0.8.0 to prevent re-downloading same files
between revisions.`),Id.forEach(t),Oo=d(e),et=n(e,"P",{});var Cd=i(et);Jn=o(Cd,"The caching system is designed as follows:"),Cd.forEach(t),xo=d(e),m(ra.$$.fragment,e),Ho=d(e),T=n(e,"P",{});var V=i(T);Vn=o(V,"The "),Ft=n(V,"CODE",{});var Dd=i(Ft);Qn=o(Dd,"<CACHE_DIR>"),Dd.forEach(t),Zn=o(V,` is usually your user\u2019s home directory. However, it is customizable with the
...
repository type, the namespace (organization or username) if it exists and the
repository name:`),Td.forEach(t),Ro=d(e),m(ca.$$.fragment,e),Lo=d(e),tt=n(e,"P",{});var jd=i(tt);ni=o(jd,`It is within these folders that all files will now be downloaded from the Hub. Caching ensures that
a file isn\u2019t downloaded twice if it already exists and wasn\u2019t updated; but if it was updated,
and you\u2019re asking for the latest file, then it will download the latest file (while keeping
the previous file intact in case you need it again).`),jd.forEach(t),Mo=d(e),st=n(e,"P",{});var Od=i(st);ii=o(Od,"In order to achieve this, all folders contain the same skeleton:"),Od.forEach(t),Fo=d(e),m(ha.$$.fragment,e),Go=d(e),ot=n(e,"P",{});var xd=i(ot);ri=o(xd,"Each folder is designed to contain the following:"),xd.forEach(t),Uo=d(e),se=n(e,"H3",{class:!0});var pn=i(se);$e=n(pn,"A",{id:!0,class:!0,href:!0});var Hd=i($e);Bt=n(Hd,"SPAN",{});var Nd=i(Bt);m(da.$$.fragment,Nd),Nd.forEach(t),Hd.forEach(t),ci=d(pn),Kt=n(pn,"SPAN",{});var Rd=i(Kt);hi=o(Rd,"Refs"),Rd.forEach(t),pn.forEach(t),qo=d(e),j=n(e,"P",{});var Q=i(j);di=o(Q,"The "),Wt=n(Q,"CODE",{});var Ld=i(Wt);fi=o(Ld,"refs"),Ld.forEach(t),pi=o(Q,` folder contains files which indicates the latest revision of the given reference. For example,
if we have previously fetched a file from the `),zt=n(Q,"CODE",{});var Md=i(zt);mi=o(Md,"main"),Md.forEach(t),ui=o(Q," branch of a repository, the "),Yt=n(Q,"CODE",{});var Fd=i(Yt);bi=o(Fd,"refs"),Fd.forEach(t),gi=o(Q,`
...
re-downloading a file from that reference will update the `),es=n(ea,"CODE",{});var Wd=i(es);Pi=o(Wd,"refs/main"),Wd.forEach(t),Ti=o(ea," file to contain "),as=n(ea,"CODE",{});var zd=i(as);ji=o(zd,"bbbbbb"),zd.forEach(t),Oi=o(ea,"."),ea.forEach(t),Wo=d(e),oe=n(e,"H3",{class:!0});var mn=i(oe);ke=n(mn,"A",{id:!0,class:!0,href:!0});var Yd=i(ke);ts=n(Yd,"SPAN",{});var Jd=i(ts);m(fa.$$.fragment,Jd),Jd.forEach(t),Yd.forEach(t),xi=d(mn),ss=n(mn,"SPAN",{});var Vd=i(ss);Hi=o(Vd,"Blobs"),Vd.forEach(t),mn.forEach(t),zo=d(e),Ie=n(e,"P",{});var un=i(Ie);Ni=o(un,"The "),os=n(un,"CODE",{});var Qd=i(os);Ri=o(Qd,"blobs"),Qd.forEach(t),Li=o(un," folder contains the actual files that we have downloaded. The name of each file is their hash."),un.forEach(t),Yo=d(e),le=n(e,"H3",{class:!0});var bn=i(le);Ce=n(bn,"A",{id:!0,class:!0,href:!0});var Zd=i(Ce);ls=n(Zd,"SPAN",{});var Xd=i(ls);m(pa.$$.fragment,Xd),Xd.forEach(t),Zd.forEach(t),Mi=d(bn),ns=n(bn,"SPAN",{});var ef=i(ns);Fi=o(ef,"Snapshots"),ef.forEach(t),bn.forEach(t),Jo=d(e),De=n(e,"P",{});var gn=i(De);Gi=o(gn,"The "),is=n(gn,"CODE",{});var af=i(is);Ui=o(af,"snapshots"),af.forEach(t),qi=o(gn,` folder contains symlinks to the blobs mentioned above. It is itself made up of several folders:
...
if we had downloaded the `),ps=n(jt,"CODE",{});var rf=i(ps);tr=o(rf,"README.md"),rf.forEach(t),sr=o(jt," file at revision "),ms=n(jt,"CODE",{});var cf=i(ms);or=o(cf,"aaaaaa"),cf.forEach(t),lr=o(jt,", we would have the following path:"),jt.forEach(t),Zo=d(e),m(ma.$$.fragment,e),Xo=d(e),Ae=n(e,"P",{});var vn=i(Ae);nr=o(vn,"That "),us=n(vn,"CODE",{});var hf=i(us);ir=o(hf,"README.md"),hf.forEach(t),rr=o(vn," file is actually a symlink linking to the blob that has the hash of the file."),vn.forEach(t),el=d(e),Se=n(e,"P",{});var wn=i(Se);cr=o(wn,`By creating the skeleton this way we open the mechanism to file sharing: if the same file was fetched in
revision `),bs=n(wn,"CODE",{});var df=i(bs);hr=o(df,"bbbbbb"),df.forEach(t),dr=o(wn,", it would have the same hash and the file would not need to be re-downloaded."),wn.forEach(t),al=d(e),ne=n(e,"H3",{class:!0});var yn=i(ne);Pe=n(yn,"A",{id:!0,class:!0,href:!0});var ff=i(Pe);gs=n(ff,"SPAN",{});var pf=i(gs);m(ua.$$.fragment,pf),pf.forEach(t),ff.forEach(t),fr=d(yn),vs=n(yn,"SPAN",{});var mf=i(vs);pr=o(mf,"In practice"),mf.forEach(t),yn.forEach(t),tl=d(e),lt=n(e,"P",{});var uf=i(lt);mr=o(uf,"In practice, your cache should look like the following tree:"),uf.forEach(t),sl=d(e),m(ba.$$.fragment,e),ol=d(e),ie=n(e,"H3",{class:!0});var _n=i(ie);Te=n(_n,"A",{id:!0,class:!0,href:!0});var bf=i(Te);ws=n(bf,"SPAN",{});var gf=i(ws);m(ga.$$.fragment,gf),gf.forEach(t),bf.forEach(t),ur=d(_n),ys=n(_n,"SPAN",{});var vf=i(ys);br=o(vf,"Limitations"),vf.forEach(t),_n.forEach(t),ll=d(e),O=n(e,"P",{});var Z=i(O);gr=o(Z,"In order to have an efficient cache-system, "),_s=n(Z,"CODE",{});var wf=i(_s);vr=o(wf,"huggingface-hub"),wf.forEach(t),wr=o(Z,` uses symlinks. However,
symlinks are not supported on all machines. This is a known limitation especially on
...
them they are using a degraded version of the cache-system. This warning can be disabled
by setting the `),Is=n($n,"CODE",{});var kf=i(Is);Pr=o(kf,"HF_HUB_DISABLE_SYMLINKS_WARNING"),kf.forEach(t),Tr=o($n," environment variable to true."),$n.forEach(t),rl=d(e),re=n(e,"H2",{class:!0});var kn=i(re);xe=n(kn,"A",{id:!0,class:!0,href:!0});var If=i(xe);Cs=n(If,"SPAN",{});var Cf=i(Cs);m(wa.$$.fragment,Cf),Cf.forEach(t),If.forEach(t),jr=d(kn),Ds=n(kn,"SPAN",{});var Df=i(Ds);Or=o(Df,"Caching assets"),Df.forEach(t),kn.forEach(t),cl=d(e),x=n(e,"P",{});var X=i(x);xr=o(X,`In addition to caching files from the Hub, downstream libraries often requires to cache
...
cached.`),Wf.forEach(t),yl=d(e),m(Ia.$$.fragment,e),_l=d(e),Y=n(e,"P",{});var Ht=i(Y);ic=o(Ht,"To get a more detailed report, use the "),Gs=n(Ht,"CODE",{});var zf=i(Gs);rc=o(zf,"--verbose"),zf.forEach(t),cc=o(Ht,` option. For each repo, you get a
list of all revisions that have been downloaded. As explained above, the files that don\u2019t
change between 2 revisions are shared thanks to the symlinks. This means that the size of
the repo on disk is expected to be less than the sum of the size of each of its revisions.
...
usage is only 1.9G.`),Ht.forEach(t),El=d(e),m(Ca.$$.fragment,e),$l=d(e),fe=n(e,"H4",{class:!0});var An=i(fe);Me=n(An,"A",{id:!0,class:!0,href:!0});var Jf=i(Me);qs=n(Jf,"SPAN",{});var Vf=i(qs);m(Da.$$.fragment,Vf),Vf.forEach(t),Jf.forEach(t),fc=d(An),Bs=n(An,"SPAN",{});var Qf=i(Bs);pc=o(Qf,"Grep example"),Qf.forEach(t),An.forEach(t),kl=d(e),Fe=n(e,"P",{});var Sn=i(Fe);mc=o(Sn,"Since the output is in tabular format, you can combine it with any "),Ks=n(Sn,"CODE",{});var Zf=i(Ks);uc=o(Zf,"grep"),Zf.forEach(t),bc=o(Sn,`-like tools to
filter the entries. Here is an example to filter only revisions from the \u201Ct5-small\u201D
model on a Unix-based machine.`),Sn.forEach(t),Il=d(e),m(Aa.$$.fragment,e),Cl=d(e),pe=n(e,"H3",{class:!0});var Pn=i(pe);Ge=n(Pn,"A",{id:!0,class:!0,href:!0});var Xf=i(Ge);Ws=n(Xf,"SPAN",{});var ep=i(Ws);m(Sa.$$.fragment,ep),ep.forEach(t),Xf.forEach(t),gc=d(Pn),zs=n(Pn,"SPAN",{});var ap=i(zs);vc=o(ap,"Scan cache from Python"),ap.forEach(t),Pn.forEach(t),Dl=d(e),Ue=n(e,"P",{});var Tn=i(Ue);wc=o(Tn,"For a more advanced usage, use "),ct=n(Tn,"A",{href:!0});var tp=i(ct);yc=o(tp,"scan_cache_dir()"),tp.forEach(t),_c=o(Tn,` which is the python utility called by
the CLI tool.`),Tn.forEach(t),Al=d(e),ht=n(e,"P",{});var sp=i(ht);Ec=o(sp,"You can use it to get a detailed report structured around 4 dataclasses:"),sp.forEach(t),Sl=d(e),L=n(e,"UL",{});var aa=i(L);Pa=n(aa,"LI",{});var jn=i(Pa);dt=n(jn,"A",{href:!0});var op=i(dt);$c=o(op,"HFCacheInfo"),op.forEach(t),kc=o(jn,": complete report returned by "),ft=n(jn,"A",{href:!0});var lp=i(ft);Ic=o(lp,"scan_cache_dir()"),lp.forEach(t),jn.forEach(t),Cc=d(aa),pt=n(aa,"LI",{});var bd=i(pt);mt=n(bd,"A",{href:!0});var np=i(mt);Dc=o(np,"CachedRepoInfo"),np.forEach(t),Ac=o(bd,": information about a cached repo"),bd.forEach(t),Sc=d(aa),ut=n(aa,"LI",{});var gd=i(ut);bt=n(gd,"A",{href:!0});var ip=i(bt);Pc=o(ip,"CachedRevisionInfo"),ip.forEach(t),Tc=o(gd,": information about a cached revision (e.g. \u201Csnapshot\u201D) inside a repo"),gd.forEach(t),jc=d(aa),gt=n(aa,"LI",{});var vd=i(gt);vt=n(vd,"A",{href:!0});var rp=i(vt);Oc=o(rp,"CachedFileInfo"),rp.forEach(t),xc=o(vd,": information about a cached file in a snapshot"),vd.forEach(t),aa.forEach(t),Pl=d(e),wt=n(e,"P",{});var cp=i(wt);Hc=o(cp,"Here is a simple usage example. See reference for details."),cp.forEach(t),Tl=d(e),m(Ta.$$.fragment,e),jl=d(e),me=n(e,"H2",{class:!0});var On=i(me);qe=n(On,"A",{id:!0,class:!0,href:!0});var hp=i(qe);Ys=n(hp,"SPAN",{});var dp=i(Ys);m(ja.$$.fragment,dp),dp.forEach(t),hp.forEach(t),Nc=d(On),Js=n(On,"SPAN",{});var fp=i(Js);Rc=o(fp,"Clean your cache"),fp.forEach(t),On.forEach(t),Ol=d(e),M=n(e,"P",{});var ta=i(M);Lc=o(ta,`Scanning your cache is interesting but what you really want to do next is usually to
delete some portions to free up some space on your drive. This is possible using the
`),Vs=n(ta,"CODE",{});var pp=i(Vs);Mc=o(pp,"delete-cache"),pp.forEach(t),Fc=o(ta,` CLI command. One can also programmatically use the
`),yt=n(ta,"A",{href:!0});var mp=i(yt);Gc=o(mp,"delete_revisions()"),mp.forEach(t),Uc=o(ta," helper from "),_t=n(ta,"A",{href:!0});var up=i(_t);qc=o(up,"HFCacheInfo"),up.forEach(t),Bc=o(ta,` object returned when
scanning the cache.`),ta.forEach(t),xl=d(e),ue=n(e,"H3",{class:!0});var xn=i(ue);Be=n(xn,"A",{id:!0,class:!0,href:!0});var bp=i(Be);Qs=n(bp,"SPAN",{});var gp=i(Qs);m(Oa.$$.fragment,gp),gp.forEach(t),bp.forEach(t),Kc=d(xn),Zs=n(xn,"SPAN",{});var vp=i(Zs);Wc=o(vp,"Delete strategy"),vp.forEach(t),xn.forEach(t),Hl=d(e),J=n(e,"P",{});var Nt=i(J);zc=o(Nt,`To delete some cache, you need to pass a list of revisions to delete. The tool will
define a strategy to free up the space based on this list. It returns a
...
effective. If you want to cancel, enter `),yo=n(la,"CODE",{});var Yp=i(yo);Jh=o(Yp,"n"),Yp.forEach(t),Vh=o(la,"."),la.forEach(t),Zl=d(e),m(Ba.$$.fragment,e),Xl=d(e),we=n(e,"H4",{class:!0});var Un=i(we);Je=n(Un,"A",{id:!0,class:!0,href:!0});var Jp=i(Je);_o=n(Jp,"SPAN",{});var Vp=i(_o);m(Ka.$$.fragment,Vp),Vp.forEach(t),Jp.forEach(t),Qh=d(Un),Eo=n(Un,"SPAN",{});var Qp=i(Eo);Zh=o(Qp,"Without TUI"),Qp.forEach(t),Un.forEach(t),en=d(e),St=n(e,"P",{});var Zp=i(St);Xh=o(Zp,`As mentioned above, the TUI mode is currently in beta and is optional. It may be the
