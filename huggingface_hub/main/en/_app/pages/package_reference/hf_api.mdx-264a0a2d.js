import{S as Br,i as Kr,s as Jr,e as n,k as l,w as k,t as c,M as Qr,c as o,d as a,m as g,a as s,x as w,h as p,b as y,F as e,g as b,y as A,q as j,o as H,B as x,v as Xr,L as de}from"../../chunks/vendor-d3924577.js";import{T as Qa}from"../../chunks/Tip-4377bed8.js";import{D as N}from"../../chunks/Docstring-6e765b82.js";import{C as Z}from"../../chunks/CodeBlock-ff545b14.js";import{I as nr}from"../../chunks/IconCopyLink-f94c3d80.js";import{E as he}from"../../chunks/ExampleCodeBlock-53170663.js";function Yr(P){let i,$,d,f,m,r,h,q,u,v,F,L,M,O,S;return{c(){i=n("p"),$=c("Raises the following errors:"),d=l(),f=n("ul"),m=n("li"),r=n("a"),h=n("code"),q=c("HTTPError"),u=c(`
...
<span class="hljs-meta">&gt;&gt;&gt; </span>api.list_models(search=<span class="hljs-string">&quot;bert&quot;</span>, author=<span class="hljs-string">&quot;google&quot;</span>)`}}),{c(){i=n("p"),$=c("Example usage with the "),d=n("code"),f=c("search"),m=c(" argument:"),r=l(),k(h.$$.fragment)},l(u){i=o(u,"P",{});var v=s(i);$=p(v,"Example usage with the "),d=o(v,"CODE",{});var F=s(d);f=p(F,"search"),F.forEach(a),m=p(v," argument:"),v.forEach(a),r=g(u),w(h.$$.fragment,u)},m(u,v){b(u,i,v),e(i,$),e(i,d),e(d,f),e(i,m),b(u,r,v),A(h,u,v),q=!0},p:de,i(u){q||(j(h.$$.fragment,u),q=!0)},o(u){H(h.$$.fragment,u),q=!1},d(u){u&&a(i),u&&a(r),x(h,u)}}}function ni(P){let i,$,d,f,m;return{c(){i=n("p"),$=c(`Warning: Deprecated, will be removed in v0.7. Please use
`),d=n("a"),f=c("HfApi.set_access_token()"),m=c(" instead."),this.h()},l(r){i=o(r,"P",{});var h=s(i);$=p(h,`Warning: Deprecated, will be removed in v0.7. Please use
...
if credentials are invalid`),M.forEach(a),L.forEach(a),this.h()},h(){y(r,"href","https://2.python-requests.org/en/master/api/#requests.HTTPError"),y(r,"rel","nofollow")},m(v,F){b(v,i,F),e(i,$),b(v,d,F),b(v,f,F),e(f,m),e(m,r),e(r,h),e(h,q),e(m,u)},d(v){v&&a(i),v&&a(d),v&&a(f)}}}function si(P){let i,$,d,f,m;return{c(){i=n("p"),$=c(`Warning: Deprecated, will be removed in v0.7. Please use
`),d=n("a"),f=c("HfApi.unset_access_token()"),m=c(" instead."),this.h()},l(r){i=o(r,"P",{});var h=s(i);$=p(h,`Warning: Deprecated, will be removed in v0.7. Please use
...
&#x201C;streamlit&#x201D;, &#x201C;gradio&#x201D;, or &#x201C;static&#x201D;.`,name:"space_sdk"}],source:"https://github.com/huggingface/huggingface_hub/blob/vmain/src/huggingface_hub/hf_api.py#L1370",returnDescription:`
...
Whether to set a timeout for the request to the Hub.`,name:"timeout"}],source:"https://github.com/huggingface/huggingface_hub/blob/vmain/src/huggingface_hub/hf_api.py#L1199",returnDescription:`
...
The Hugging Face authentication token`,name:"token"}],source:"https://github.com/huggingface/huggingface_hub/blob/vmain/src/huggingface_hub/hf_api.py#L1930",returnDescription:`
...
Whether to set a timeout for the request to the Hub.`,name:"timeout"}],source:"https://github.com/huggingface/huggingface_hub/blob/vmain/src/huggingface_hub/hf_api.py#L1329",returnDescription:`
...
The password of the account with which to login.`,name:"password"}],source:"https://github.com/huggingface/huggingface_hub/blob/vmain/src/huggingface_hub/hf_api.py#L555",returnDescription:`
...
repository as well.`,name:"securityStatus"}],source:"https://github.com/huggingface/huggingface_hub/blob/vmain/src/huggingface_hub/hf_api.py#L1149",returnDescription:`
...
Whether to set a timeout for the request to the Hub.`,name:"timeout"}],source:"https://github.com/huggingface/huggingface_hub/blob/vmain/src/huggingface_hub/hf_api.py#L1285",returnDescription:`
<p>The repository
information.</p>
`,returnType:`
...
Whether to set a timeout for the request to the Hub.`,name:"timeout"}],source:"https://github.com/huggingface/huggingface_hub/blob/vmain/src/huggingface_hub/hf_api.py#L1242",returnDescription:`
...
Set to <code>&quot;dataset&quot;</code> or <code>&quot;space&quot;</code> if uploading to a dataset or
space, <code>None</code> or <code>&quot;model&quot;</code> if uploading to a model. Default is
<code>None</code>.`,name:"repo_type"}],source:"https://github.com/huggingface/huggingface_hub/blob/vmain/src/huggingface_hub/hf_api.py#L1591",returnDescription:`
...
and its content did not change.`,name:"identical_ok"}],source:"https://github.com/huggingface/huggingface_hub/blob/vmain/src/huggingface_hub/hf_api.py#L1727",returnDescription:`
