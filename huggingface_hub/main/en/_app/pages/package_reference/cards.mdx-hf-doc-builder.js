...
`}}),{c(){h=n("p"),v=d("Example:"),_=c(),x(i.$$.fragment)},l(s){h=r(s,"P",{});var f=o(h);v=g(f,"Example:"),f.forEach(t),_=p(s),$(i.$$.fragment,s)},m(s,f){u(s,h,f),a(h,v),u(s,_,f),y(i,s,f),b=!0},p:oe,i(s){b||(j(i.$$.fragment,s),b=!0)},o(s){w(i.$$.fragment,s),b=!1},d(s){s&&t(h),s&&t(_),D(i,s)}}}function bi(C){let h,v,_,i,b,s,f,A,T,q,k,Z,V,L,B,ee,Qa,Xa,Ce,H,z,xt,oa,vn,$t,xn,$s,I,$n,yt,yn,jn,Za,wn,Dn,et,Cn,En,ys,R,la,kn,O,ia,Rn,jt,An,Tn,Ee,qn,ke,Mn,ae,ca,Nn,wt,Pn,Ln,Dt,Hn,In,te,pa,On,Ct,Fn,Un,Re,Sn,Ae,da,Vn,Et,Bn,zn,se,ga,Jn,kt,Wn,Gn,Te,Yn,ne,ha,Kn,ma,Qn,at,Xn,Zn,er,qe,js,ie,Me,Rt,ua,ar,At,tr,ws,F,sr,tt,nr,rr,st,or,lr,nt,ir,cr,Ds,J,fa,pr,Ne,_a,dr,Tt,gr,hr,Pe,ba,mr,qt,ur,Cs,ce,Le,Mt,va,fr,Nt,_r,Es,pe,He,Pt,xa,br,Lt,vr,ks,de,$a,xr,U,ya,$r,rt,yr,ja,jr,wr,Ht,Dr,Cr,Ie,Rs,ge,Oe,It,wa,Er,Ot,kr,As,W,Da,Rr,Ft,Ar,Tr,Fe,Ts,he,Ue,Ut,Ca,qr,St,Mr,qs,ot,Nr,Ms,me,Se,Vt,Ea,Pr,Bt,Lr,Ns,ue,ka,Hr,S,Ra,Ir,lt,Or,Aa,Fr,Ur,zt,Sr,Vr,Ve,Ps,fe,Be,Jt,Ta,Br,Wt,zr,Ls,_e,qa,Jr,Gt,Wr,Hs,be,ze,Yt,Ma,Gr,Kt,Yr,Is,ve,Je,Qt,Na,Kr,Xt,Qr,Os,G,Pa,Xr,Zt,Zr,eo,La,ao,Ha,to,so,Fs,xe,We,es,Ia,no,as,ro,Us,P,Oa,oo,Fa,lo,ts,io,co,po,it,go,Ua,ho,mo,Ge,Ss,$e,Ye,ss,Sa,uo,ns,fo,Vs,Y,Va,_o,Ba,bo,rs,vo,xo,$o,Ke,Bs,ye,Qe,os,za,yo,ls,jo,zs,K,Ja,wo,is,Do,Co,Xe,Js,je,Ze,cs,Wa,Eo,ps,ko,Ws,Q,Ga,Ro,we,Ao,ds,To,qo,gs,Mo,No,Po,ea,Gs;return s=new M({}),oa=new M({}),la=new E({props:{name:"class huggingface_hub.repocard.RepoCard",anchor:"huggingface_hub.repocard.RepoCard",parameters:[{name:"content",val:": str"}],source:"https://github.com/huggingface/huggingface_hub/blob/main/src/huggingface_hub/repocard.py#L45"}}),ia=new E({props:{name:"__init__",anchor:"huggingface_hub.repocard.RepoCard.__init__",parameters:[{name:"content",val:": str"}],parametersDescription:[{anchor:"huggingface_hub.repocard.RepoCard.__init__.content",description:"<strong>content</strong> (<code>str</code>) &#x2014; The content of the Markdown file.",name:"content"}],source:"https://github.com/huggingface/huggingface_hub/blob/main/src/huggingface_hub/repocard.py#L50"}}),Ee=new re({props:{anchor:"huggingface_hub.repocard.RepoCard.__init__.example",$$slots:{default:[oi]},$$scope:{ctx:C}}}),ke=new ei({props:{$$slots:{default:[li]},$$scope:{ctx:C}}}),ca=new E({props:{name:"from_template",anchor:"huggingface_hub.repocard.RepoCard.from_template",parameters:[{name:"card_data",val:": CardData"},{name:"template_path",val:": typing.Optional[str] = None"},{name:"**template_kwargs",val:""}],parametersDescription:[{anchor:"huggingface_hub.repocard.RepoCard.from_template.card_data",description:`<strong>card_data</strong> (<code>huggingface_hub.CardData</code>) &#x2014;
...
in with <code>template_kwargs</code>. Defaults to the default template.`,name:"template_path"}],source:"https://github.com/huggingface/huggingface_hub/blob/main/src/huggingface_hub/repocard.py#L296",returnDescription:`
...
the stored token.`,name:"token"}],source:"https://github.com/huggingface/huggingface_hub/blob/main/src/huggingface_hub/repocard.py#L140",returnDescription:`
...
A path to a markdown file with optional Jinja template variables that can be filled
in with <code>template_kwargs</code>. Defaults to the default template.`,name:"template_path"}],source:"https://github.com/huggingface/huggingface_hub/blob/main/src/huggingface_hub/repocard.py#L341",returnDescription:`
...
Additional metadata that will be added to the model card. Defaults to None.`,name:"kwargs"}],source:"https://github.com/huggingface/huggingface_hub/blob/main/src/huggingface_hub/repocard_data.py#L166"}}),Fe=new re({props:{anchor:"huggingface_hub.ModelCardData.example",$$slots:{default:[gi]},$$scope:{ctx:C}}}),Ca=new M({}),Ea=new M({}),ka=new E({props:{name:"class huggingface_hub.DatasetCard",anchor:"huggingface_hub.DatasetCard",parameters:[{name:"content",val:": str"}],source:"https://github.com/huggingface/huggingface_hub/blob/main/src/huggingface_hub/repocard.py#L416"}}),Ra=new E({props:{name:"from_template",anchor:"huggingface_hub.DatasetCard.from_template",parameters:[{name:"card_data",val:": DatasetCardData"},{name:"template_path",val:": typing.Optional[str] = None"},{name:"**template_kwargs",val:""}],parametersDescription:[{anchor:"huggingface_hub.DatasetCard.from_template.card_data",description:`<strong>card_data</strong> (<code>huggingface_hub.DatasetCardData</code>) &#x2014;
...
A path to a markdown file with optional Jinja template variables that can be filled
in with <code>template_kwargs</code>. Defaults to the default template.`,name:"template_path"}],source:"https://github.com/huggingface/huggingface_hub/blob/main/src/huggingface_hub/repocard.py#L421",returnDescription:`
...
Hugging Face Hub.`,name:"model_index"}],source:"https://github.com/huggingface/huggingface_hub/blob/main/src/huggingface_hub/repocard_data.py#L346",returnDescription:`
...
`,returnType:`
<p><code>dict</code></p>
`}}),Xe=new re({props:{anchor:"huggingface_hub.metadata_eval_result.example",$$slots:{default:[fi]},$$scope:{ctx:C}}}),Wa=new M({}),Ga=new E({props:{name:"huggingface_hub.metadata_update",anchor:"huggingface_hub.metadata_update",parameters:[{name:"repo_id",val:": str"},{name:"metadata",val:": typing.Dict"},{name:"repo_type",val:": typing.Optional[str] = None"},{name:"overwrite",val:": bool = False"},{name:"token",val:": typing.Optional[str] = None"},{name:"commit_message",val:": typing.Optional[str] = None"},{name:"commit_description",val:": typing.Optional[str] = None"},{name:"revision",val:": typing.Optional[str] = None"},{name:"create_pr",val:": bool = False"},{name:"parent_commit",val:": typing.Optional[str] = None"}],parametersDescription:[{anchor:"huggingface_hub.metadata_update.repo_id",description:`<strong>repo_id</strong> (<code>str</code>) &#x2014;
...
If specified and <code>create_pr</code> is <code>True</code>, the pull request will be created from <code>parent_commit</code>.
Specifying <code>parent_commit</code> ensures the repo has not changed before committing the changes, and can be
especially useful if the repo is updated / committed to concurrently.`,name:"parent_commit"}],source:"https://github.com/huggingface/huggingface_hub/blob/main/src/huggingface_hub/repocard.py#L680",returnDescription:`
<p>URL of the commit which updated the card metadata.</p>
`,returnType:`
<p><code>str</code></p>
...
Markdown file with a YAML block at the beginning and a Markdown body.`),Tn=c(),x(Ee.$$.fragment),qn=c(),x(ke.$$.fragment),Mn=c(),ae=n("div"),x(ca.$$.fragment),Nn=c(),wt=n("p"),Pn=d("Initialize a RepoCard from a template. By default, it uses the default template."),Ln=c(),Dt=n("p"),Hn=d("Templates are Jinja2 templates that can be customized by passing keyword arguments."),In=c(),te=n("div"),x(pa.$$.fragment),On=c(),Ct=n("p"),Fn=d("Initialize a RepoCard from a Hugging Face Hub repo\u2019s README.md or a local filepath."),Un=c(),x(Re.$$.fragment),Sn=c(),Ae=n("div"),x(da.$$.fragment),Vn=c(),Et=n("p"),Bn=d("Push a RepoCard to a Hugging Face Hub repo."),zn=c(),se=n("div"),x(ga.$$.fragment),Jn=c(),kt=n("p"),Wn=d("Save a RepoCard to a file."),Gn=c(),x(Te.$$.fragment),Yn=c(),ne=n("div"),x(ha.$$.fragment),Kn=c(),ma=n("p"),Qn=d(`Validates card against Hugging Face Hub\u2019s card validation logic.
Using this function requires access to the internet, so it is only called
internally by `),at=n("a"),Xn=d("huggingface_hub.repocard.RepoCard.push_to_hub()"),Zn=d("."),er=c(),x(qe.$$.fragment),js=c(),ie=n("h2"),Me=n("a"),Rt=n("span"),x(ua.$$.fragment),ar=c(),At=n("span"),tr=d("Card Data"),ws=c(),F=n("p"),sr=d("The "),tt=n("a"),nr=d("CardData"),rr=d(" object is the parent class of "),st=n("a"),or=d("ModelCardData"),lr=d(" and "),nt=n("a"),ir=d("DatasetCardData"),cr=d("."),Ds=c(),J=n("div"),x(fa.$$.fragment),pr=c(),Ne=n("div"),x(_a.$$.fragment),dr=c(),Tt=n("p"),gr=d("Converts CardData to a dict."),hr=c(),Pe=n("div"),x(ba.$$.fragment),mr=c(),qt=n("p"),ur=d("Dumps CardData to a YAML block for inclusion in a README.md file."),Cs=c(),ce=n("h2"),Le=n("a"),Mt=n("span"),x(va.$$.fragment),fr=c(),Nt=n("span"),_r=d("Model Cards"),Es=c(),pe=n("h3"),He=n("a"),Pt=n("span"),x(xa.$$.fragment),br=c(),Lt=n("span"),vr=d("ModelCard"),ks=c(),de=n("div"),x($a.$$.fragment),xr=c(),U=n("div"),x(ya.$$.fragment),$r=c(),rt=n("p"),yr=d(`Initialize a ModelCard from a template. By default, it uses the default template, which can be found here:
`),ja=n("a"),jr=d("https://github.com/huggingface/huggingface_hub/blob/main/src/huggingface_hub/templates/modelcard_template.md"),wr=c(),Ht=n("p"),Dr=d("Templates are Jinja2 templates that can be customized by passing keyword arguments."),Cr=c(),x(Ie.$$.fragment),Rs=c(),ge=n("h3"),Oe=n("a"),It=n("span"),x(wa.$$.fragment),Er=c(),Ot=n("span"),kr=d("ModelCardData"),As=c(),W=n("div"),x(Da.$$.fragment),Rr=c(),Ft=n("p"),Ar=d("Model Card Metadata that is used by Hugging Face Hub when included at the top of your README.md"),Tr=c(),x(Fe.$$.fragment),Ts=c(),he=n("h2"),Ue=n("a"),Ut=n("span"),x(Ca.$$.fragment),qr=c(),St=n("span"),Mr=d("Dataset Cards"),qs=c(),ot=n("p"),Nr=d("Dataset cards are also known as Data Cards in the ML Community."),Ms=c(),me=n("h3"),Se=n("a"),Vt=n("span"),x(Ea.$$.fragment),Pr=c(),Bt=n("span"),Lr=d("DatasetCard"),Ns=c(),ue=n("div"),x(ka.$$.fragment),Hr=c(),S=n("div"),x(Ra.$$.fragment),Ir=c(),lt=n("p"),Or=d(`Initialize a DatasetCard from a template. By default, it uses the default template, which can be found here:
`),Aa=n("a"),Fr=d("https://github.com/huggingface/huggingface_hub/blob/main/src/huggingface_hub/templates/datasetcard_template.md"),Ur=c(),zt=n("p"),Sr=d("Templates are Jinja2 templates that can be customized by passing keyword arguments."),Vr=c(),x(Ve.$$.fragment),Ps=c(),fe=n("h3"),Be=n("a"),Jt=n("span"),x(Ta.$$.fragment),Br=c(),Wt=n("span"),zr=d("DatasetCardData"),Ls=c(),_e=n("div"),x(qa.$$.fragment),Jr=c(),Gt=n("p"),Wr=d("Dataset Card Metadata that is used by Hugging Face Hub when included at the top of your README.md"),Hs=c(),be=n("h2"),ze=n("a"),Yt=n("span"),x(Ma.$$.fragment),Gr=c(),Kt=n("span"),Yr=d("Utilities"),Is=c(),ve=n("h3"),Je=n("a"),Qt=n("span"),x(Na.$$.fragment),Kr=c(),Xt=n("span"),Qr=d("EvalResult"),Os=c(),G=n("div"),x(Pa.$$.fragment),Xr=c(),Zt=n("p"),Zr=d("Flattened representation of individual evaluation results found in model-index of Model Cards."),eo=c(),La=n("p"),ao=d("For more information on the model-index spec, see "),Ha=n("a"),to=d("https://github.com/huggingface/hub-docs/blob/main/modelcard.md?plain=1"),so=d("."),Fs=c(),xe=n("h3"),We=n("a"),es=n("span"),x(Ia.$$.fragment),no=c(),as=n("span"),ro=d("model_index_to_eval_results"),Us=c(),P=n("div"),x(Oa.$$.fragment),oo=c(),Fa=n("p"),lo=d("Takes in a model index and returns the model name and a list of "),ts=n("code"),io=d("huggingface_hub.EvalResult"),co=d(" objects."),po=c(),it=n("p"),go=d(`A detailed spec of the model index can be found here:
`),Ua=n("a"),ho=d("https://github.com/huggingface/hub-docs/blob/main/modelcard.md?plain=1"),mo=c(),x(Ge.$$.fragment),Ss=c(),$e=n("h3"),Ye=n("a"),ss=n("span"),x(Sa.$$.fragment),uo=c(),ns=n("span"),fo=d("eval_results_to_model_index"),Vs=c(),Y=n("div"),x(Va.$$.fragment),_o=c(),Ba=n("p"),bo=d("Takes in given model name and list of "),rs=n("code"),vo=d("huggingface_hub.EvalResult"),xo=d(` and returns a
valid model-index that will be compatible with the format expected by the
Hugging Face Hub.`),$o=c(),x(Ke.$$.fragment),Bs=c(),ye=n("h3"),Qe=n("a"),os=n("span"),x(za.$$.fragment),yo=c(),ls=n("span"),jo=d("metadata_eval_result"),zs=c(),K=n("div"),x(Ja.$$.fragment),wo=c(),is=n("p"),Do=d("Creates a metadata dict with the result from a model evaluated on a dataset."),Co=c(),x(Xe.$$.fragment),Js=c(),je=n("h3"),Ze=n("a"),cs=n("span"),x(Wa.$$.fragment),Eo=c(),ps=n("span"),ko=d("metadata_update"),Ws=c(),Q=n("div"),x(Ga.$$.fragment),Ro=c(),we=n("p"),Ao=d(`Updates the metadata in the README.md of a repository on the Hugging Face Hub.
...
get a feel for how you would use these utilities in your own projects.`),De.forEach(t),Ce=p(e),H=r(e,"H2",{class:!0});var Ka=o(H);z=r(Ka,"A",{id:!0,class:!0,href:!0});var bs=o(z);xt=r(bs,"SPAN",{});var vs=o(xt);$(oa.$$.fragment,vs),vs.forEach(t),bs.forEach(t),vn=p(Ka),$t=r(Ka,"SPAN",{});var xs=o($t);xn=g(xs,"Repo Card"),xs.forEach(t),Ka.forEach(t),$s=p(e),I=r(e,"P",{});var X=o(I);$n=g(X,"The "),yt=r(X,"CODE",{});var Oo=o(yt);yn=g(Oo,"RepoCard"),Oo.forEach(t),jn=g(X," object is the parent class of "),Za=r(X,"A",{href:!0});var Fo=o(Za);wn=g(Fo,"ModelCard"),Fo.forEach(t),Dn=g(X," and "),et=r(X,"A",{href:!0});var Uo=o(et);Cn=g(Uo,"DatasetCard"),Uo.forEach(t),En=g(X,"."),X.forEach(t),ys=p(e),R=r(e,"DIV",{class:!0});var N=o(R);$(la.$$.fragment,N),kn=p(N),O=r(N,"DIV",{class:!0});var aa=o(O);$(ia.$$.fragment,aa),Rn=p(aa),jt=r(aa,"P",{});var So=o(jt);An=g(So,`Initialize a RepoCard from string content. The content should be a
Markdown file with a YAML block at the beginning and a Markdown body.`),So.forEach(t),Tn=p(aa),$(Ee.$$.fragment,aa),qn=p(aa),$(ke.$$.fragment,aa),aa.forEach(t),Mn=p(N),ae=r(N,"DIV",{class:!0});var ct=o(ae);$(ca.$$.fragment,ct),Nn=p(ct),wt=r(ct,"P",{});var Vo=o(wt);Pn=g(Vo,"Initialize a RepoCard from a template. By default, it uses the default template."),Vo.forEach(t),Ln=p(ct),Dt=r(ct,"P",{});var Bo=o(Dt);Hn=g(Bo,"Templates are Jinja2 templates that can be customized by passing keyword arguments."),Bo.forEach(t),ct.forEach(t),In=p(N),te=r(N,"DIV",{class:!0});var pt=o(te);$(pa.$$.fragment,pt),On=p(pt),Ct=r(pt,"P",{});var zo=o(Ct);Fn=g(zo,"Initialize a RepoCard from a Hugging Face Hub repo\u2019s README.md or a local filepath."),zo.forEach(t),Un=p(pt),$(Re.$$.fragment,pt),pt.forEach(t),Sn=p(N),Ae=r(N,"DIV",{class:!0});var Ys=o(Ae);$(da.$$.fragment,Ys),Vn=p(Ys),Et=r(Ys,"P",{});var Jo=o(Et);Bn=g(Jo,"Push a RepoCard to a Hugging Face Hub repo."),Jo.forEach(t),Ys.forEach(t),zn=p(N),se=r(N,"DIV",{class:!0});var dt=o(se);$(ga.$$.fragment,dt),Jn=p(dt),kt=r(dt,"P",{});var Wo=o(kt);Wn=g(Wo,"Save a RepoCard to a file."),Wo.forEach(t),Gn=p(dt),$(Te.$$.fragment,dt),dt.forEach(t),Yn=p(N),ne=r(N,"DIV",{class:!0});var gt=o(ne);$(ha.$$.fragment,gt),Kn=p(gt),ma=r(gt,"P",{});var Ks=o(ma);Qn=g(Ks,`Validates card against Hugging Face Hub\u2019s card validation logic.
Using this function requires access to the internet, so it is only called
internally by `),at=r(Ks,"A",{href:!0});var Go=o(at);Xn=g(Go,"huggingface_hub.repocard.RepoCard.push_to_hub()"),Go.forEach(t),Zn=g(Ks,"."),Ks.forEach(t),er=p(gt),$(qe.$$.fragment,gt),gt.forEach(t),N.forEach(t),js=p(e),ie=r(e,"H2",{class:!0});var Qs=o(ie);Me=r(Qs,"A",{id:!0,class:!0,href:!0});var Yo=o(Me);Rt=r(Yo,"SPAN",{});var Ko=o(Rt);$(ua.$$.fragment,Ko),Ko.forEach(t),Yo.forEach(t),ar=p(Qs),At=r(Qs,"SPAN",{});var Qo=o(At);tr=g(Qo,"Card Data"),Qo.forEach(t),Qs.forEach(t),ws=p(e),F=r(e,"P",{});var ta=o(F);sr=g(ta,"The "),tt=r(ta,"A",{href:!0});var Xo=o(tt);nr=g(Xo,"CardData"),Xo.forEach(t),rr=g(ta," object is the parent class of "),st=r(ta,"A",{href:!0});var Zo=o(st);or=g(Zo,"ModelCardData"),Zo.forEach(t),lr=g(ta," and "),nt=r(ta,"A",{href:!0});var el=o(nt);ir=g(el,"DatasetCardData"),el.forEach(t),cr=g(ta,"."),ta.forEach(t),Ds=p(e),J=r(e,"DIV",{class:!0});var ht=o(J);$(fa.$$.fragment,ht),pr=p(ht),Ne=r(ht,"DIV",{class:!0});var Xs=o(Ne);$(_a.$$.fragment,Xs),dr=p(Xs),Tt=r(Xs,"P",{});var al=o(Tt);gr=g(al,"Converts CardData to a dict."),al.forEach(t),Xs.forEach(t),hr=p(ht),Pe=r(ht,"DIV",{class:!0});var Zs=o(Pe);$(ba.$$.fragment,Zs),mr=p(Zs),qt=r(Zs,"P",{});var tl=o(qt);ur=g(tl,"Dumps CardData to a YAML block for inclusion in a README.md file."),tl.forEach(t),Zs.forEach(t),ht.forEach(t),Cs=p(e),ce=r(e,"H2",{class:!0});var en=o(ce);Le=r(en,"A",{id:!0,class:!0,href:!0});var sl=o(Le);Mt=r(sl,"SPAN",{});var nl=o(Mt);$(va.$$.fragment,nl),nl.forEach(t),sl.forEach(t),fr=p(en),Nt=r(en,"SPAN",{});var rl=o(Nt);_r=g(rl,"Model Cards"),rl.forEach(t),en.forEach(t),Es=p(e),pe=r(e,"H3",{class:!0});var an=o(pe);He=r(an,"A",{id:!0,class:!0,href:!0});var ol=o(He);Pt=r(ol,"SPAN",{});var ll=o(Pt);$(xa.$$.fragment,ll),ll.forEach(t),ol.forEach(t),br=p(an),Lt=r(an,"SPAN",{});var il=o(Lt);vr=g(il,"ModelCard"),il.forEach(t),an.forEach(t),ks=p(e),de=r(e,"DIV",{class:!0});var tn=o(de);$($a.$$.fragment,tn),xr=p(tn),U=r(tn,"DIV",{class:!0});var sa=o(U);$(ya.$$.fragment,sa),$r=p(sa),rt=r(sa,"P",{});var Lo=o(rt);yr=g(Lo,`Initialize a ModelCard from a template. By default, it uses the default template, which can be found here:
`),ja=r(Lo,"A",{href:!0,rel:!0});var cl=o(ja);jr=g(cl,"https://github.com/huggingface/huggingface_hub/blob/main/src/huggingface_hub/templates/modelcard_template.md"),cl.forEach(t),Lo.forEach(t),wr=p(sa),Ht=r(sa,"P",{});var pl=o(Ht);Dr=g(pl,"Templates are Jinja2 templates that can be customized by passing keyword arguments."),pl.forEach(t),Cr=p(sa),$(Ie.$$.fragment,sa),sa.forEach(t),tn.forEach(t),Rs=p(e),ge=r(e,"H3",{class:!0});var sn=o(ge);Oe=r(sn,"A",{id:!0,class:!0,href:!0});var dl=o(Oe);It=r(dl,"SPAN",{});var gl=o(It);$(wa.$$.fragment,gl),gl.forEach(t),dl.forEach(t),Er=p(sn),Ot=r(sn,"SPAN",{});var hl=o(Ot);kr=g(hl,"ModelCardData"),hl.forEach(t),sn.forEach(t),As=p(e),W=r(e,"DIV",{class:!0});var mt=o(W);$(Da.$$.fragment,mt),Rr=p(mt),Ft=r(mt,"P",{});var ml=o(Ft);Ar=g(ml,"Model Card Metadata that is used by Hugging Face Hub when included at the top of your README.md"),ml.forEach(t),Tr=p(mt),$(Fe.$$.fragment,mt),mt.forEach(t),Ts=p(e),he=r(e,"H2",{class:!0});var nn=o(he);Ue=r(nn,"A",{id:!0,class:!0,href:!0});var ul=o(Ue);Ut=r(ul,"SPAN",{});var fl=o(Ut);$(Ca.$$.fragment,fl),fl.forEach(t),ul.forEach(t),qr=p(nn),St=r(nn,"SPAN",{});var _l=o(St);Mr=g(_l,"Dataset Cards"),_l.forEach(t),nn.forEach(t),qs=p(e),ot=r(e,"P",{});var bl=o(ot);Nr=g(bl,"Dataset cards are also known as Data Cards in the ML Community."),bl.forEach(t),Ms=p(e),me=r(e,"H3",{class:!0});var rn=o(me);Se=r(rn,"A",{id:!0,class:!0,href:!0});var vl=o(Se);Vt=r(vl,"SPAN",{});var xl=o(Vt);$(Ea.$$.fragment,xl),xl.forEach(t),vl.forEach(t),Pr=p(rn),Bt=r(rn,"SPAN",{});var $l=o(Bt);Lr=g($l,"DatasetCard"),$l.forEach(t),rn.forEach(t),Ns=p(e),ue=r(e,"DIV",{class:!0});var on=o(ue);$(ka.$$.fragment,on),Hr=p(on),S=r(on,"DIV",{class:!0});var na=o(S);$(Ra.$$.fragment,na),Ir=p(na),lt=r(na,"P",{});var Ho=o(lt);Or=g(Ho,`Initialize a DatasetCard from a template. By default, it uses the default template, which can be found here:
`),Aa=r(Ho,"A",{href:!0,rel:!0});var yl=o(Aa);Fr=g(yl,"https://github.com/huggingface/huggingface_hub/blob/main/src/huggingface_hub/templates/datasetcard_template.md"),yl.forEach(t),Ho.forEach(t),Ur=p(na),zt=r(na,"P",{});var jl=o(zt);Sr=g(jl,"Templates are Jinja2 templates that can be customized by passing keyword arguments."),jl.forEach(t),Vr=p(na),$(Ve.$$.fragment,na),na.forEach(t),on.forEach(t),Ps=p(e),fe=r(e,"H3",{class:!0});var ln=o(fe);Be=r(ln,"A",{id:!0,class:!0,href:!0});var wl=o(Be);Jt=r(wl,"SPAN",{});var Dl=o(Jt);$(Ta.$$.fragment,Dl),Dl.forEach(t),wl.forEach(t),Br=p(ln),Wt=r(ln,"SPAN",{});var Cl=o(Wt);zr=g(Cl,"DatasetCardData"),Cl.forEach(t),ln.forEach(t),Ls=p(e),_e=r(e,"DIV",{class:!0});var cn=o(_e);$(qa.$$.fragment,cn),Jr=p(cn),Gt=r(cn,"P",{});var El=o(Gt);Wr=g(El,"Dataset Card Metadata that is used by Hugging Face Hub when included at the top of your README.md"),El.forEach(t),cn.forEach(t),Hs=p(e),be=r(e,"H2",{class:!0});var pn=o(be);ze=r(pn,"A",{id:!0,class:!0,href:!0});var kl=o(ze);Yt=r(kl,"SPAN",{});var Rl=o(Yt);$(Ma.$$.fragment,Rl),Rl.forEach(t),kl.forEach(t),Gr=p(pn),Kt=r(pn,"SPAN",{});var Al=o(Kt);Yr=g(Al,"Utilities"),Al.forEach(t),pn.forEach(t),Is=p(e),ve=r(e,"H3",{class:!0});var dn=o(ve);Je=r(dn,"A",{id:!0,class:!0,href:!0});var Tl=o(Je);Qt=r(Tl,"SPAN",{});var ql=o(Qt);$(Na.$$.fragment,ql),ql.forEach(t),Tl.forEach(t),Kr=p(dn),Xt=r(dn,"SPAN",{});var Ml=o(Xt);Qr=g(Ml,"EvalResult"),Ml.forEach(t),dn.forEach(t),Os=p(e),G=r(e,"DIV",{class:!0});var ut=o(G);$(Pa.$$.fragment,ut),Xr=p(ut),Zt=r(ut,"P",{});var Nl=o(Zt);Zr=g(Nl,"Flattened representation of individual evaluation results found in model-index of Model Cards."),Nl.forEach(t),eo=p(ut),La=r(ut,"P",{});var gn=o(La);ao=g(gn,"For more information on the model-index spec, see "),Ha=r(gn,"A",{href:!0,rel:!0});var Pl=o(Ha);to=g(Pl,"https://github.com/huggingface/hub-docs/blob/main/modelcard.md?plain=1"),Pl.forEach(t),so=g(gn,"."),gn.forEach(t),ut.forEach(t),Fs=p(e),xe=r(e,"H3",{class:!0});var hn=o(xe);We=r(hn,"A",{id:!0,class:!0,href:!0});var Ll=o(We);es=r(Ll,"SPAN",{});var Hl=o(es);$(Ia.$$.fragment,Hl),Hl.forEach(t),Ll.forEach(t),no=p(hn),as=r(hn,"SPAN",{});var Il=o(as);ro=g(Il,"model_index_to_eval_results"),Il.forEach(t),hn.forEach(t),Us=p(e),P=r(e,"DIV",{class:!0});var ra=o(P);$(Oa.$$.fragment,ra),oo=p(ra),Fa=r(ra,"P",{});var mn=o(Fa);lo=g(mn,"Takes in a model index and returns the model name and a list of "),ts=r(mn,"CODE",{});var Ol=o(ts);io=g(Ol,"huggingface_hub.EvalResult"),Ol.forEach(t),co=g(mn," objects."),mn.forEach(t),po=p(ra),it=r(ra,"P",{});var Io=o(it);go=g(Io,`A detailed spec of the model index can be found here:
`),Ua=r(Io,"A",{href:!0,rel:!0});var Fl=o(Ua);ho=g(Fl,"https://github.com/huggingface/hub-docs/blob/main/modelcard.md?plain=1"),Fl.forEach(t),Io.forEach(t),mo=p(ra),$(Ge.$$.fragment,ra),ra.forEach(t),Ss=p(e),$e=r(e,"H3",{class:!0});var un=o($e);Ye=r(un,"A",{id:!0,class:!0,href:!0});var Ul=o(Ye);ss=r(Ul,"SPAN",{});var Sl=o(ss);$(Sa.$$.fragment,Sl),Sl.forEach(t),Ul.forEach(t),uo=p(un),ns=r(un,"SPAN",{});var Vl=o(ns);fo=g(Vl,"eval_results_to_model_index"),Vl.forEach(t),un.forEach(t),Vs=p(e),Y=r(e,"DIV",{class:!0});var ft=o(Y);$(Va.$$.fragment,ft),_o=p(ft),Ba=r(ft,"P",{});var fn=o(Ba);bo=g(fn,"Takes in given model name and list of "),rs=r(fn,"CODE",{});var Bl=o(rs);vo=g(Bl,"huggingface_hub.EvalResult"),Bl.forEach(t),xo=g(fn,` and returns a
valid model-index that will be compatible with the format expected by the
Hugging Face Hub.`),fn.forEach(t),$o=p(ft),$(Ke.$$.fragment,ft),ft.forEach(t),Bs=p(e),ye=r(e,"H3",{class:!0});var _n=o(ye);Qe=r(_n,"A",{id:!0,class:!0,href:!0});var zl=o(Qe);os=r(zl,"SPAN",{});var Jl=o(os);$(za.$$.fragment,Jl),Jl.forEach(t),zl.forEach(t),yo=p(_n),ls=r(_n,"SPAN",{});var Wl=o(ls);jo=g(Wl,"metadata_eval_result"),Wl.forEach(t),_n.forEach(t),zs=p(e),K=r(e,"DIV",{class:!0});var _t=o(K);$(Ja.$$.fragment,_t),wo=p(_t),is=r(_t,"P",{});var Gl=o(is);Do=g(Gl,"Creates a metadata dict with the result from a model evaluated on a dataset."),Gl.forEach(t),Co=p(_t),$(Xe.$$.fragment,_t),_t.forEach(t),Js=p(e),je=r(e,"H3",{class:!0});var bn=o(je);Ze=r(bn,"A",{id:!0,class:!0,href:!0});var Yl=o(Ze);cs=r(Yl,"SPAN",{});var Kl=o(cs);$(Wa.$$.fragment,Kl),Kl.forEach(t),Yl.forEach(t),Eo=p(bn),ps=r(bn,"SPAN",{});var Ql=o(ps);ko=g(Ql,"metadata_update"),Ql.forEach(t),bn.forEach(t),Ws=p(e),Q=r(e,"DIV",{class:!0});var bt=o(Q);$(Ga.$$.fragment,bt),Ro=p(bt),we=r(bt,"P",{});var vt=o(we);Ao=g(vt,`Updates the metadata in the README.md of a repository on the Hugging Face Hub.
If the README.md file doesn\u2019t exist yet, a new one is created with metadata and an
...
as a Space cannot exist without a `),gs=r(vt,"CODE",{});var Zl=o(gs);Mo=g(Zl,"README.md"),Zl.forEach(t),No=g(vt," file."),vt.forEach(t),Po=p(bt),$(ea.$$.fragment,bt),bt.forEach(t),this.h()},h(){l(h,"name","hf:doc:metadata"),l(h,"content",JSON.stringify(vi)),l(i,"id","repository-cards"),l(i,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),l(i,"href","#repository-cards"),l(_,"class","relative group"),l(V,"href","https://huggingface.co/docs/hub/models-cards"),l(V,"rel","nofollow"),l(ee,"href","../how-to-model-cards"),l(z,"id","huggingface_hub.repocard.RepoCard"),l(z,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),l(z,"href","#huggingface_hub.repocard.RepoCard"),l(H,"class","relative group"),l(Za,"href","/docs/huggingface_hub/main/en/package_reference/cards#huggingface_hub.ModelCard"),l(et,"href","/docs/huggingface_hub/main/en/package_reference/cards#huggingface_hub.DatasetCard"),l(O,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),l(ae,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),l(te,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),l(Ae,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),l(se,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),l(at,"href","/docs/huggingface_hub/main/en/package_reference/cards#huggingface_hub.repocard.RepoCard.push_to_hub"),l(ne,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),l(R,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),l(Me,"id","huggingface_hub.CardData"),l(Me,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),l(Me,"href","#huggingface_hub.CardData"),l(ie,"class","relative group"),l(tt,"href","/docs/huggingface_hub/main/en/package_reference/cards#huggingface_hub.CardData"),l(st,"href","/docs/huggingface_hub/main/en/package_reference/cards#huggingface_hub.ModelCardData"),l(nt,"href","/docs/huggingface_hub/main/en/package_reference/cards#huggingface_hub.DatasetCardData"),l(Ne,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),l(Pe,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),l(J,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),l(Le,"id","model-cards"),l(Le,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),l(Le,"href","#model-cards"),l(ce,"class","relative group"),l(He,"id","huggingface_hub.ModelCard"),l(He,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),l(He,"href","#huggingface_hub.ModelCard"),l(pe,"class","relative group"),l(ja,"href","https://github.com/huggingface/huggingface_hub/blob/main/src/huggingface_hub/templates/modelcard_template.md"),l(ja,"rel","nofollow"),l(U,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),l(de,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),l(Oe,"id","huggingface_hub.ModelCardData"),l(Oe,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),l(Oe,"href","#huggingface_hub.ModelCardData"),l(ge,"class","relative group"),l(W,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),l(Ue,"id","dataset-cards"),l(Ue,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),l(Ue,"href","#dataset-cards"),l(he,"class","relative group"),l(Se,"id","huggingface_hub.DatasetCard"),l(Se,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),l(Se,"href","#huggingface_hub.DatasetCard"),l(me,"class","relative group"),l(Aa,"href","https://github.com/huggingface/huggingface_hub/blob/main/src/huggingface_hub/templates/datasetcard_template.md"),l(Aa,"rel","nofollow"),l(S,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),l(ue,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),l(Be,"id","huggingface_hub.DatasetCardData"),l(Be,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),l(Be,"href","#huggingface_hub.DatasetCardData"),l(fe,"class","relative group"),l(_e,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),l(ze,"id","utilities"),l(ze,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),l(ze,"href","#utilities"),l(be,"class","relative group"),l(Je,"id","huggingface_hub.EvalResult"),l(Je,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),l(Je,"href","#huggingface_hub.EvalResult"),l(ve,"class","relative group"),l(Ha,"href","https://github.com/huggingface/hub-docs/blob/main/modelcard.md?plain=1"),l(Ha,"rel","nofollow"),l(G,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),l(We,"id","huggingface_hub.repocard_data.model_index_to_eval_results"),l(We,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),l(We,"href","#huggingface_hub.repocard_data.model_index_to_eval_results"),l(xe,"class","relative group"),l(Ua,"href","https://github.com/huggingface/hub-docs/blob/main/modelcard.md?plain=1"),l(Ua,"rel","nofollow"),l(P,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),l(Ye,"id","huggingface_hub.repocard_data.eval_results_to_model_index"),l(Ye,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),l(Ye,"href","#huggingface_hub.repocard_data.eval_results_to_model_index"),l($e,"class","relative group"),l(Y,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),l(Qe,"id","huggingface_hub.metadata_eval_result"),l(Qe,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),l(Qe,"href","#huggingface_hub.metadata_eval_result"),l(ye,"class","relative group"),l(K,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),l(Ze,"id","huggingface_hub.metadata_update"),l(Ze,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),l(Ze,"href","#huggingface_hub.metadata_update"),l(je,"class","relative group"),l(Q,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8")},m(e,m){a(document.head,h),u(e,v,m),u(e,_,m),a(_,i),a(i,b),y(s,b,null),a(_,f),a(_,A),a(A,T),u(e,q,m),u(e,k,m),a(k,Z),a(k,V),a(V,L),a(k,B),a(k,ee),a(ee,Qa),a(k,Xa),u(e,Ce,m),u(e,H,m),a(H,z),a(z,xt),y(oa,xt,null),a(H,vn),a(H,$t),a($t,xn),u(e,$s,m),u(e,I,m),a(I,$n),a(I,yt),a(yt,yn),a(I,jn),a(I,Za),a(Za,wn),a(I,Dn),a(I,et),a(et,Cn),a(I,En),u(e,ys,m),u(e,R,m),y(la,R,null),a(R,kn),a(R,O),y(ia,O,null),a(O,Rn),a(O,jt),a(jt,An),a(O,Tn),y(Ee,O,null),a(O,qn),y(ke,O,null),a(R,Mn),a(R,ae),y(ca,ae,null),a(ae,Nn),a(ae,wt),a(wt,Pn),a(ae,Ln),a(ae,Dt),a(Dt,Hn),a(R,In),a(R,te),y(pa,te,null),a(te,On),a(te,Ct),a(Ct,Fn),a(te,Un),y(Re,te,null),a(R,Sn),a(R,Ae),y(da,Ae,null),a(Ae,Vn),a(Ae,Et),a(Et,Bn),a(R,zn),a(R,se),y(ga,se,null),a(se,Jn),a(se,kt),a(kt,Wn),a(se,Gn),y(Te,se,null),a(R,Yn),a(R,ne),y(ha,ne,null),a(ne,Kn),a(ne,ma),a(ma,Qn),a(ma,at),a(at,Xn),a(ma,Zn),a(ne,er),y(qe,ne,null),u(e,js,m),u(e,ie,m),a(ie,Me),a(Me,Rt),y(ua,Rt,null),a(ie,ar),a(ie,At),a(At,tr),u(e,ws,m),u(e,F,m),a(F,sr),a(F,tt),a(tt,nr),a(F,rr),a(F,st),a(st,or),a(F,lr),a(F,nt),a(nt,ir),a(F,cr),u(e,Ds,m),u(e,J,m),y(fa,J,null),a(J,pr),a(J,Ne),y(_a,Ne,null),a(Ne,dr),a(Ne,Tt),a(Tt,gr),a(J,hr),a(J,Pe),y(ba,Pe,null),a(Pe,mr),a(Pe,qt),a(qt,ur),u(e,Cs,m),u(e,ce,m),a(ce,Le),a(Le,Mt),y(va,Mt,null),a(ce,fr),a(ce,Nt),a(Nt,_r),u(e,Es,m),u(e,pe,m),a(pe,He),a(He,Pt),y(xa,Pt,null),a(pe,br),a(pe,Lt),a(Lt,vr),u(e,ks,m),u(e,de,m),y($a,de,null),a(de,xr),a(de,U),y(ya,U,null),a(U,$r),a(U,rt),a(rt,yr),a(rt,ja),a(ja,jr),a(U,wr),a(U,Ht),a(Ht,Dr),a(U,Cr),y(Ie,U,null),u(e,Rs,m),u(e,ge,m),a(ge,Oe),a(Oe,It),y(wa,It,null),a(ge,Er),a(ge,Ot),a(Ot,kr),u(e,As,m),u(e,W,m),y(Da,W,null),a(W,Rr),a(W,Ft),a(Ft,Ar),a(W,Tr),y(Fe,W,null),u(e,Ts,m),u(e,he,m),a(he,Ue),a(Ue,Ut),y(Ca,Ut,null),a(he,qr),a(he,St),a(St,Mr),u(e,qs,m),u(e,ot,m),a(ot,Nr),u(e,Ms,m),u(e,me,m),a(me,Se),a(Se,Vt),y(Ea,Vt,null),a(me,Pr),a(me,Bt),a(Bt,Lr),u(e,Ns,m),u(e,ue,m),y(ka,ue,null),a(ue,Hr),a(ue,S),y(Ra,S,null),a(S,Ir),a(S,lt),a(lt,Or),a(lt,Aa),a(Aa,Fr),a(S,Ur),a(S,zt),a(zt,Sr),a(S,Vr),y(Ve,S,null),u(e,Ps,m),u(e,fe,m),a(fe,Be),a(Be,Jt),y(Ta,Jt,null),a(fe,Br),a(fe,Wt),a(Wt,zr),u(e,Ls,m),u(e,_e,m),y(qa,_e,null),a(_e,Jr),a(_e,Gt),a(Gt,Wr),u(e,Hs,m),u(e,be,m),a(be,ze),a(ze,Yt),y(Ma,Yt,null),a(be,Gr),a(be,Kt),a(Kt,Yr),u(e,Is,m),u(e,ve,m),a(ve,Je),a(Je,Qt),y(Na,Qt,null),a(ve,Kr),a(ve,Xt),a(Xt,Qr),u(e,Os,m),u(e,G,m),y(Pa,G,null),a(G,Xr),a(G,Zt),a(Zt,Zr),a(G,eo),a(G,La),a(La,ao),a(La,Ha),a(Ha,to),a(La,so),u(e,Fs,m),u(e,xe,m),a(xe,We),a(We,es),y(Ia,es,null),a(xe,no),a(xe,as),a(as,ro),u(e,Us,m),u(e,P,m),y(Oa,P,null),a(P,oo),a(P,Fa),a(Fa,lo),a(Fa,ts),a(ts,io),a(Fa,co),a(P,po),a(P,it),a(it,go),a(it,Ua),a(Ua,ho),a(P,mo),y(Ge,P,null),u(e,Ss,m),u(e,$e,m),a($e,Ye),a(Ye,ss),y(Sa,ss,null),a($e,uo),a($e,ns),a(ns,fo),u(e,Vs,m),u(e,Y,m),y(Va,Y,null),a(Y,_o),a(Y,Ba),a(Ba,bo),a(Ba,rs),a(rs,vo),a(Ba,xo),a(Y,$o),y(Ke,Y,null),u(e,Bs,m),u(e,ye,m),a(ye,Qe),a(Qe,os),y(za,os,null),a(ye,yo),a(ye,ls),a(ls,jo),u(e,zs,m),u(e,K,m),y(Ja,K,null),a(K,wo),a(K,is),a(is,Do),a(K,Co),y(Xe,K,null),u(e,Js,m),u(e,je,m),a(je,Ze),a(Ze,cs),y(Wa,cs,null),a(je,Eo),a(je,ps),a(ps,ko),u(e,Ws,m),u(e,Q,m),y(Ga,Q,null),a(Q,Ro),a(Q,we),a(we,Ao),a(we,ds),a(ds,To),a(we,qo),a(we,gs),a(gs,Mo),a(we,No),a(Q,Po),y(ea,Q,null),Gs=!0},p(e,[m]){const Ya={};m&2&&(Ya.$$scope={dirty:m,ctx:e}),Ee.$set(Ya);const hs={};m&2&&(hs.$$scope={dirty:m,ctx:e}),ke.$set(hs);const ms={};m&2&&(ms.$$scope={dirty:m,ctx:e}),Re.$set(ms);const us={};m&2&&(us.$$scope={dirty:m,ctx:e}),Te.$set(us);const De={};m&2&&(De.$$scope={dirty:m,ctx:e}),qe.$set(De);const fs={};m&2&&(fs.$$scope={dirty:m,ctx:e}),Ie.$set(fs);const _s={};m&2&&(_s.$$scope={dirty:m,ctx:e}),Fe.$set(_s);const Ka={};m&2&&(Ka.$$scope={dirty:m,ctx:e}),Ve.$set(Ka);const bs={};m&2&&(bs.$$scope={dirty:m,ctx:e}),Ge.$set(bs);const vs={};m&2&&(vs.$$scope={dirty:m,ctx:e}),Ke.$set(vs);const xs={};m&2&&(xs.$$scope={dirty:m,ctx:e}),Xe.$set(xs);const X={};m&2&&(X.$$scope={dirty:m,ctx:e}),ea.$set(X)},i(e){Gs||(j(s.$$.fragment,e),j(oa.$$.fragment,e),j(la.$$.fragment,e),j(ia.$$.fragment,e),j(Ee.$$.fragment,e),j(ke.$$.fragment,e),j(ca.$$.fragment,e),j(pa.$$.fragment,e),j(Re.$$.fragment,e),j(da.$$.fragment,e),j(ga.$$.fragment,e),j(Te.$$.fragment,e),j(ha.$$.fragment,e),j(qe.$$.fragment,e),j(ua.$$.fragment,e),j(fa.$$.fragment,e),j(_a.$$.fragment,e),j(ba.$$.fragment,e),j(va.$$.fragment,e),j(xa.$$.fragment,e),j($a.$$.fragment,e),j(ya.$$.fragment,e),j(Ie.$$.fragment,e),j(wa.$$.fragment,e),j(Da.$$.fragment,e),j(Fe.$$.fragment,e),j(Ca.$$.fragment,e),j(Ea.$$.fragment,e),j(ka.$$.fragment,e),j(Ra.$$.fragment,e),j(Ve.$$.fragment,e),j(Ta.$$.fragment,e),j(qa.$$.fragment,e),j(Ma.$$.fragment,e),j(Na.$$.fragment,e),j(Pa.$$.fragment,e),j(Ia.$$.fragment,e),j(Oa.$$.fragment,e),j(Ge.$$.fragment,e),j(Sa.$$.fragment,e),j(Va.$$.fragment,e),j(Ke.$$.fragment,e),j(za.$$.fragment,e),j(Ja.$$.fragment,e),j(Xe.$$.fragment,e),j(Wa.$$.fragment,e),j(Ga.$$.fragment,e),j(ea.$$.fragment,e),Gs=!0)},o(e){w(s.$$.fragment,e),w(oa.$$.fragment,e),w(la.$$.fragment,e),w(ia.$$.fragment,e),w(Ee.$$.fragment,e),w(ke.$$.fragment,e),w(ca.$$.fragment,e),w(pa.$$.fragment,e),w(Re.$$.fragment,e),w(da.$$.fragment,e),w(ga.$$.fragment,e),w(Te.$$.fragment,e),w(ha.$$.fragment,e),w(qe.$$.fragment,e),w(ua.$$.fragment,e),w(fa.$$.fragment,e),w(_a.$$.fragment,e),w(ba.$$.fragment,e),w(va.$$.fragment,e),w(xa.$$.fragment,e),w($a.$$.fragment,e),w(ya.$$.fragment,e),w(Ie.$$.fragment,e),w(wa.$$.fragment,e),w(Da.$$.fragment,e),w(Fe.$$.fragment,e),w(Ca.$$.fragment,e),w(Ea.$$.fragment,e),w(ka.$$.fragment,e),w(Ra.$$.fragment,e),w(Ve.$$.fragment,e),w(Ta.$$.fragment,e),w(qa.$$.fragment,e),w(Ma.$$.fragment,e),w(Na.$$.fragment,e),w(Pa.$$.fragment,e),w(Ia.$$.fragment,e),w(Oa.$$.fragment,e),w(Ge.$$.fragment,e),w(Sa.$$.fragment,e),w(Va.$$.fragment,e),w(Ke.$$.fragment,e),w(za.$$.fragment,e),w(Ja.$$.fragment,e),w(Xe.$$.fragment,e),w(Wa.$$.fragment,e),w(Ga.$$.fragment,e),w(ea.$$.fragment,e),Gs=!1},d(e){t(h),e&&t(v),e&&t(_),D(s),e&&t(q),e&&t(k),e&&t(Ce),e&&t(H),D(oa),e&&t($s),e&&t(I),e&&t(ys),e&&t(R),D(la),D(ia),D(Ee),D(ke),D(ca),D(pa),D(Re),D(da),D(ga),D(Te),D(ha),D(qe),e&&t(js),e&&t(ie),D(ua),e&&t(ws),e&&t(F),e&&t(Ds),e&&t(J),D(fa),D(_a),D(ba),e&&t(Cs),e&&t(ce),D(va),e&&t(Es),e&&t(pe),D(xa),e&&t(ks),e&&t(de),D($a),D(ya),D(Ie),e&&t(Rs),e&&t(ge),D(wa),e&&t(As),e&&t(W),D(Da),D(Fe),e&&t(Ts),e&&t(he),D(Ca),e&&t(qs),e&&t(ot),e&&t(Ms),e&&t(me),D(Ea),e&&t(Ns),e&&t(ue),D(ka),D(Ra),D(Ve),e&&t(Ps),e&&t(fe),D(Ta),e&&t(Ls),e&&t(_e),D(qa),e&&t(Hs),e&&t(be),D(Ma),e&&t(Is),e&&t(ve),D(Na),e&&t(Os),e&&t(G),D(Pa),e&&t(Fs),e&&t(xe),D(Ia),e&&t(Us),e&&t(P),D(Oa),D(Ge),e&&t(Ss),e&&t($e),D(Sa),e&&t(Vs),e&&t(Y),D(Va),D(Ke),e&&t(Bs),e&&t(ye),D(za),e&&t(zs),e&&t(K),D(Ja),D(Xe),e&&t(Js),e&&t(je),D(Wa),e&&t(Ws),e&&t(Q),D(Ga),D(ea)}}}const vi={local:"repository-cards",sections:[{local:"huggingface_hub.repocard.RepoCard",title:"Repo Card"},{local:"huggingface_hub.CardData",title:"Card Data"},{local:"model-cards",sections:[{local:"huggingface_hub.ModelCard",title:"ModelCard"},{local:"huggingface_hub.ModelCardData",title:"ModelCardData"}],title:"Model Cards"},{local:"dataset-cards",sections:[{local:"huggingface_hub.DatasetCard",title:"DatasetCard"},{local:"huggingface_hub.DatasetCardData",title:"DatasetCardData"}],title:"Dataset Cards"},{local:"utilities",sections:[{local:"huggingface_hub.EvalResult",title:"EvalResult"},{local:"huggingface_hub.repocard_data.model_index_to_eval_results",title:"model_index_to_eval_results"},{local:"huggingface_hub.repocard_data.eval_results_to_model_index",title:"eval_results_to_model_index"},{local:"huggingface_hub.metadata_eval_result",title:"metadata_eval_result"},{local:"huggingface_hub.metadata_update",title:"metadata_update"}],title:"Utilities"}],title:"Repository Cards"};function xi(C){return ri(()=>{new URLSearchParams(window.location.search).get("fw")}),[]}class Ei extends ai{constructor(h){super();ti(this,h,xi,bi,si,{})}}export{Ei as default,vi as metadata};
