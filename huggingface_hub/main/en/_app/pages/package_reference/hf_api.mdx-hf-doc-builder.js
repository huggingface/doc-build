...
If the revision to download from cannot be found.`),this.h()},l(_){i=n(_,"P",{});var P=s(i);v=c(P,"Raises the following errors:"),P.forEach(t),u=h(_),l=n(_,"UL",{});var U=s(l);d=n(U,"LI",{});var S=s(d);r=n(S,"A",{href:!0});var V=s(r);m=c(V,"RepositoryNotFoundError"),V.forEach(t),x=c(S,`
If the repository to download from cannot be found. This may be because it doesn\u2019t exist,
...
If the revision to download from cannot be found.`),C.forEach(t),U.forEach(t),this.h()},h(){w(r,"href","/docs/huggingface_hub/main/en/package_reference/utilities#huggingface_hub.utils.RepositoryNotFoundError"),w(L,"href","/docs/huggingface_hub/main/en/package_reference/utilities#huggingface_hub.utils.RevisionNotFoundError")},m(_,P){b(_,i,P),e(i,v),b(_,u,P),b(_,l,P),e(l,d),e(d,r),e(r,m),e(d,x),e(d,f),e(f,y),e(d,A),e(l,k),e(l,E),e(E,L),e(L,T),e(E,R)},d(_){_&&t(i),_&&t(u),_&&t(l)}}}function Gr(M){let i,v,u,l,d,r,m,x,f,y,A,k,E,L,T,R,_,P,U,S,V,G,C,W,Z,J,se,ee,Q,X,Y,de,fe;return{c(){i=o("p"),v=g("Raises the following errors:"),u=p(),l=o("ul"),d=o("li"),r=o("a"),m=o("code"),x=g("HTTPError"),f=g(`
...
If the file to download cannot be found.`),this.h()},l(B){i=n(B,"P",{});var te=s(i);v=c(te,"Raises the following errors:"),te.forEach(t),u=h(B),l=n(B,"UL",{});var K=s(l);d=n(K,"LI",{});var Ee=s(d);r=n(Ee,"A",{href:!0,rel:!0});var ae=s(r);m=n(ae,"CODE",{});var Ne=s(m);x=c(Ne,"HTTPError"),Ne.forEach(t),ae.forEach(t),f=c(Ee,`
...
<span class="hljs-meta">... </span>)
<span class="hljs-meta">&gt;&gt;&gt; </span>api.list_datasets(<span class="hljs-built_in">filter</span>=filt)`}}),{c(){i=o("p"),v=g("Example usage with the "),u=o("code"),l=g("filter"),d=g(" argument:"),r=p(),j(m.$$.fragment)},l(f){i=n(f,"P",{});var y=s(i);v=c(y,"Example usage with the "),u=n(y,"CODE",{});var A=s(u);l=c(A,"filter"),A.forEach(t),d=c(y," argument:"),y.forEach(t),r=h(f),H(m.$$.fragment,f)},m(f,y){b(f,i,y),e(i,v),e(i,u),e(u,l),e(i,d),b(f,r,y),F(m,f,y),x=!0},p:Oe,i(f){x||(D(m.$$.fragment,f),x=!0)},o(f){N(m.$$.fragment,f),x=!1},d(f){f&&t(i),f&&t(r),q(m,f)}}}function Kr(M){let i,v,u,l,d,r,m,x;return m=new we({props:{code:`from huggingface_hub import HfApi
...
<span class="hljs-meta">&gt;&gt;&gt; </span>api.list_datasets(search=<span class="hljs-string">&quot;text&quot;</span>, author=<span class="hljs-string">&quot;google&quot;</span>)`}}),{c(){i=o("p"),v=g("Example usage with the "),u=o("code"),l=g("search"),d=g(" argument:"),r=p(),j(m.$$.fragment)},l(f){i=n(f,"P",{});var y=s(i);v=c(y,"Example usage with the "),u=n(y,"CODE",{});var A=s(u);l=c(A,"search"),A.forEach(t),d=c(y," argument:"),y.forEach(t),r=h(f),H(m.$$.fragment,f)},m(f,y){b(f,i,y),e(i,v),e(i,u),e(u,l),e(i,d),b(f,r,y),F(m,f,y),x=!0},p:Oe,i(f){x||(D(m.$$.fragment,f),x=!0)},o(f){N(m.$$.fragment,f),x=!1},d(f){f&&t(i),f&&t(r),q(m,f)}}}function Jr(M){let i,v,u,l,d,r,m,x;return m=new we({props:{code:`from huggingface_hub import HfApi
...
<span class="hljs-meta">&gt;&gt;&gt; </span>filt = ModelFilter(library=args.library.allennlp)`}}),{c(){i=o("p"),v=g("Example usage with the "),u=o("code"),l=g("filter"),d=g(" argument:"),r=p(),j(m.$$.fragment)},l(f){i=n(f,"P",{});var y=s(i);v=c(y,"Example usage with the "),u=n(y,"CODE",{});var A=s(u);l=c(A,"filter"),A.forEach(t),d=c(y," argument:"),y.forEach(t),r=h(f),H(m.$$.fragment,f)},m(f,y){b(f,i,y),e(i,v),e(i,u),e(u,l),e(i,d),b(f,r,y),F(m,f,y),x=!0},p:Oe,i(f){x||(D(m.$$.fragment,f),x=!0)},o(f){N(m.$$.fragment,f),x=!1},d(f){f&&t(i),f&&t(r),q(m,f)}}}function Qr(M){let i,v,u,l,d,r,m,x;return m=new we({props:{code:`from huggingface_hub import HfApi
...
<span class="hljs-meta">&gt;&gt;&gt; </span>api.list_models(search=<span class="hljs-string">&quot;bert&quot;</span>, author=<span class="hljs-string">&quot;google&quot;</span>)`}}),{c(){i=o("p"),v=g("Example usage with the "),u=o("code"),l=g("search"),d=g(" argument:"),r=p(),j(m.$$.fragment)},l(f){i=n(f,"P",{});var y=s(i);v=c(y,"Example usage with the "),u=n(y,"CODE",{});var A=s(u);l=c(A,"search"),A.forEach(t),d=c(y," argument:"),y.forEach(t),r=h(f),H(m.$$.fragment,f)},m(f,y){b(f,i,y),e(i,v),e(i,u),e(u,l),e(i,d),b(f,r,y),F(m,f,y),x=!0},p:Oe,i(f){x||(D(m.$$.fragment,f),x=!0)},o(f){N(m.$$.fragment,f),x=!1},d(f){f&&t(i),f&&t(r),q(m,f)}}}function Xr(M){let i,v,u,l,d,r,m,x,f,y,A,k,E,L,T,R;return{c(){i=o("p"),v=g("Raises the following errors:"),u=p(),l=o("ul"),d=o("li"),r=o("a"),m=g("RepositoryNotFoundError"),x=g(`
If the repository to download from cannot be found. This may be because it doesn\u2019t exist,
or because it is set to `),f=o("code"),y=g("private"),A=g(" and you do not have access."),k=p(),E=o("li"),L=o("a"),T=g("RevisionNotFoundError"),R=g(`
If the revision to download from cannot be found.`),this.h()},l(_){i=n(_,"P",{});var P=s(i);v=c(P,"Raises the following errors:"),P.forEach(t),u=h(_),l=n(_,"UL",{});var U=s(l);d=n(U,"LI",{});var S=s(d);r=n(S,"A",{href:!0});var V=s(r);m=c(V,"RepositoryNotFoundError"),V.forEach(t),x=c(S,`
If the repository to download from cannot be found. This may be because it doesn\u2019t exist,
or because it is set to `),f=n(S,"CODE",{});var G=s(f);y=c(G,"private"),G.forEach(t),A=c(S," and you do not have access."),S.forEach(t),k=h(U),E=n(U,"LI",{});var C=s(E);L=n(C,"A",{href:!0});var W=s(L);T=c(W,"RevisionNotFoundError"),W.forEach(t),R=c(C,`
If the revision to download from cannot be found.`),C.forEach(t),U.forEach(t),this.h()},h(){w(r,"href","/docs/huggingface_hub/main/en/package_reference/utilities#huggingface_hub.utils.RepositoryNotFoundError"),w(L,"href","/docs/huggingface_hub/main/en/package_reference/utilities#huggingface_hub.utils.RevisionNotFoundError")},m(_,P){b(_,i,P),e(i,v),b(_,u,P),b(_,l,P),e(l,d),e(d,r),e(r,m),e(d,x),e(d,f),e(f,y),e(d,A),e(l,k),e(l,E),e(E,L),e(L,T),e(E,R)},d(_){_&&t(i),_&&t(u),_&&t(l)}}}function Yr(M){let i,v,u,l,d,r,m,x,f,y,A;return{c(){i=o("p"),v=g("Raises the following errors:"),u=p(),l=o("ul"),d=o("li"),r=o("a"),m=g("RepositoryNotFoundError"),x=g(`
If the repository to download from cannot be found. This may be because it doesn\u2019t exist,
or because it is set to `),f=o("code"),y=g("private"),A=g(" and you do not have access."),this.h()},l(k){i=n(k,"P",{});var E=s(i);v=c(E,"Raises the following errors:"),E.forEach(t),u=h(k),l=n(k,"UL",{});var L=s(l);d=n(L,"LI",{});var T=s(d);r=n(T,"A",{href:!0});var R=s(r);m=c(R,"RepositoryNotFoundError"),R.forEach(t),x=c(T,`
If the repository to download from cannot be found. This may be because it doesn\u2019t exist,
or because it is set to `),f=n(T,"CODE",{});var _=s(f);y=c(_,"private"),_.forEach(t),A=c(T," and you do not have access."),T.forEach(t),L.forEach(t),this.h()},h(){w(r,"href","/docs/huggingface_hub/main/en/package_reference/utilities#huggingface_hub.utils.RepositoryNotFoundError")},m(k,E){b(k,i,E),e(i,v),b(k,u,E),b(k,l,E),e(l,d),e(d,r),e(r,m),e(d,x),e(d,f),e(f,y),e(d,A)},d(k){k&&t(i),k&&t(u),k&&t(l)}}}function Zr(M){let i,v,u,l,d,r,m,x,f,y,A,k,E,L,T,R;return{c(){i=o("p"),v=g("Raises the following errors:"),u=p(),l=o("ul"),d=o("li"),r=o("a"),m=g("RepositoryNotFoundError"),x=g(`
If the repository to download from cannot be found. This may be because it doesn\u2019t exist,
or because it is set to `),f=o("code"),y=g("private"),A=g(" and you do not have access."),k=p(),E=o("li"),L=o("a"),T=g("RevisionNotFoundError"),R=g(`
If the revision to download from cannot be found.`),this.h()},l(_){i=n(_,"P",{});var P=s(i);v=c(P,"Raises the following errors:"),P.forEach(t),u=h(_),l=n(_,"UL",{});var U=s(l);d=n(U,"LI",{});var S=s(d);r=n(S,"A",{href:!0});var V=s(r);m=c(V,"RepositoryNotFoundError"),V.forEach(t),x=c(S,`
If the repository to download from cannot be found. This may be because it doesn\u2019t exist,
or because it is set to `),f=n(S,"CODE",{});var G=s(f);y=c(G,"private"),G.forEach(t),A=c(S," and you do not have access."),S.forEach(t),k=h(U),E=n(U,"LI",{});var C=s(E);L=n(C,"A",{href:!0});var W=s(L);T=c(W,"RevisionNotFoundError"),W.forEach(t),R=c(C,`
If the revision to download from cannot be found.`),C.forEach(t),U.forEach(t),this.h()},h(){w(r,"href","/docs/huggingface_hub/main/en/package_reference/utilities#huggingface_hub.utils.RepositoryNotFoundError"),w(L,"href","/docs/huggingface_hub/main/en/package_reference/utilities#huggingface_hub.utils.RevisionNotFoundError")},m(_,P){b(_,i,P),e(i,v),b(_,u,P),b(_,l,P),e(l,d),e(d,r),e(r,m),e(d,x),e(d,f),e(f,y),e(d,A),e(l,k),e(l,E),e(E,L),e(L,T),e(E,R)},d(_){_&&t(i),_&&t(u),_&&t(l)}}}function ei(M){let i,v,u,l,d,r,m,x,f,y,A,k,E,L,T,R;return{c(){i=o("p"),v=g("Raises the following errors:"),u=p(),l=o("ul"),d=o("li"),r=o("a"),m=g("RepositoryNotFoundError"),x=g(`
If the repository to download from cannot be found. This may be because it doesn\u2019t exist,
or because it is set to `),f=o("code"),y=g("private"),A=g(" and you do not have access."),k=p(),E=o("li"),L=o("a"),T=g("RevisionNotFoundError"),R=g(`
If the revision to download from cannot be found.`),this.h()},l(_){i=n(_,"P",{});var P=s(i);v=c(P,"Raises the following errors:"),P.forEach(t),u=h(_),l=n(_,"UL",{});var U=s(l);d=n(U,"LI",{});var S=s(d);r=n(S,"A",{href:!0});var V=s(r);m=c(V,"RepositoryNotFoundError"),V.forEach(t),x=c(S,`
If the repository to download from cannot be found. This may be because it doesn\u2019t exist,
or because it is set to `),f=n(S,"CODE",{});var G=s(f);y=c(G,"private"),G.forEach(t),A=c(S," and you do not have access."),S.forEach(t),k=h(U),E=n(U,"LI",{});var C=s(E);L=n(C,"A",{href:!0});var W=s(L);T=c(W,"RevisionNotFoundError"),W.forEach(t),R=c(C,`
If the revision to download from cannot be found.`),C.forEach(t),U.forEach(t),this.h()},h(){w(r,"href","/docs/huggingface_hub/main/en/package_reference/utilities#huggingface_hub.utils.RepositoryNotFoundError"),w(L,"href","/docs/huggingface_hub/main/en/package_reference/utilities#huggingface_hub.utils.RevisionNotFoundError")},m(_,P){b(_,i,P),e(i,v),b(_,u,P),b(_,l,P),e(l,d),e(d,r),e(r,m),e(d,x),e(d,f),e(f,y),e(d,A),e(l,k),e(l,E),e(E,L),e(L,T),e(E,R)},d(_){_&&t(i),_&&t(u),_&&t(l)}}}function ti(M){let i,v,u,l,d,r,m,x,f,y,A;return{c(){i=o("p"),v=g("Raises the following errors:"),u=p(),l=o("ul"),d=o("li"),r=o("a"),m=g("RepositoryNotFoundError"),x=g(`
If the repository to download from cannot be found. This may be because it doesn\u2019t exist,
or because it is set to `),f=o("code"),y=g("private"),A=g(" and you do not have access."),this.h()},l(k){i=n(k,"P",{});var E=s(i);v=c(E,"Raises the following errors:"),E.forEach(t),u=h(k),l=n(k,"UL",{});var L=s(l);d=n(L,"LI",{});var T=s(d);r=n(T,"A",{href:!0});var R=s(r);m=c(R,"RepositoryNotFoundError"),R.forEach(t),x=c(T,`
If the repository to download from cannot be found. This may be because it doesn\u2019t exist,
or because it is set to `),f=n(T,"CODE",{});var _=s(f);y=c(_,"private"),_.forEach(t),A=c(T," and you do not have access."),T.forEach(t),L.forEach(t),this.h()},h(){w(r,"href","/docs/huggingface_hub/main/en/package_reference/utilities#huggingface_hub.utils.RepositoryNotFoundError")},m(k,E){b(k,i,E),e(i,v),b(k,u,E),b(k,l,E),e(l,d),e(d,r),e(r,m),e(d,x),e(d,f),e(f,y),e(d,A)},d(k){k&&t(i),k&&t(u),k&&t(l)}}}function ai(M){let i,v,u,l,d,r,m,x,f,y,A,k,E,L,T,R,_,P,U,S,V,G,C,W,Z,J,se,ee;return{c(){i=o("p"),v=g("Raises the following errors:"),u=p(),l=o("ul"),d=o("li"),r=o("a"),m=o("code"),x=g("HTTPError"),f=g(`
if the HuggingFace API returned an error`),y=p(),A=o("li"),k=o("a"),E=o("code"),L=g("ValueError"),T=g(`
if some parameter value is invalid`),R=p(),_=o("li"),P=o("a"),U=g("RepositoryNotFoundError"),S=g(`
If the repository to download from cannot be found. This may be because it doesn\u2019t exist,
or because it is set to `),V=o("code"),G=g("private"),C=g(" and you do not have access."),W=p(),Z=o("li"),J=o("a"),se=g("RevisionNotFoundError"),ee=g(`
If the revision to download from cannot be found.`),this.h()},l(Q){i=n(Q,"P",{});var X=s(i);v=c(X,"Raises the following errors:"),X.forEach(t),u=h(Q),l=n(Q,"UL",{});var Y=s(l);d=n(Y,"LI",{});var de=s(d);r=n(de,"A",{href:!0,rel:!0});var fe=s(r);m=n(fe,"CODE",{});var B=s(m);x=c(B,"HTTPError"),B.forEach(t),fe.forEach(t),f=c(de,`
...
If the revision to download from cannot be found.`),ue.forEach(t),Y.forEach(t),this.h()},h(){w(r,"href","https://2.python-requests.org/en/master/api/#requests.HTTPError"),w(r,"rel","nofollow"),w(k,"href","https://docs.python.org/3/library/exceptions.html#ValueError"),w(k,"rel","nofollow"),w(P,"href","/docs/huggingface_hub/main/en/package_reference/utilities#huggingface_hub.utils.RepositoryNotFoundError"),w(J,"href","/docs/huggingface_hub/main/en/package_reference/utilities#huggingface_hub.utils.RevisionNotFoundError")},m(Q,X){b(Q,i,X),e(i,v),b(Q,u,X),b(Q,l,X),e(l,d),e(d,r),e(r,m),e(m,x),e(d,f),e(l,y),e(l,A),e(A,k),e(k,E),e(E,L),e(A,T),e(l,R),e(l,_),e(_,P),e(P,U),e(_,S),e(_,V),e(V,G),e(_,C),e(l,W),e(l,Z),e(Z,J),e(J,se),e(Z,ee)},d(Q){Q&&t(i),Q&&t(u),Q&&t(l)}}}function oi(M){let i,v,u,l,d;return l=new we({props:{code:`with open("./local/filepath", "rb") as fobj:
    upload_file(
...
<span class="hljs-meta">... </span>    token=<span class="hljs-string">&quot;my_token&quot;</span>,
<span class="hljs-meta">... </span>)
<span class="hljs-string">&quot;https://huggingface.co/username/my-model/blob/main/remote/file/path.h5&quot;</span>`}}),{c(){i=o("p"),v=g("Example usage:"),u=p(),j(l.$$.fragment)},l(r){i=n(r,"P",{});var m=s(i);v=c(m,"Example usage:"),m.forEach(t),u=h(r),H(l.$$.fragment,r)},m(r,m){b(r,i,m),e(i,v),b(r,u,m),F(l,r,m),d=!0},p:Oe,i(r){d||(D(l.$$.fragment,r),d=!0)},o(r){N(l.$$.fragment,r),d=!1},d(r){r&&t(i),r&&t(u),q(l,r)}}}function ni(M){let i,v,u,l,d;return l=new we({props:{code:`from huggingface_hub import DatasetFilter
...
<span class="hljs-meta">&gt;&gt;&gt; </span>new_filter = DatasetFilter(task_ids=<span class="hljs-string">&quot;paraphrase&quot;</span>)`}}),{c(){i=o("p"),v=g("Examples:"),u=p(),j(l.$$.fragment)},l(r){i=n(r,"P",{});var m=s(i);v=c(m,"Examples:"),m.forEach(t),u=h(r),H(l.$$.fragment,r)},m(r,m){b(r,i,m),e(i,v),b(r,u,m),F(l,r,m),d=!0},p:Oe,i(r){d||(D(l.$$.fragment,r),d=!0)},o(r){N(l.$$.fragment,r),d=!1},d(r){r&&t(i),r&&t(u),q(l,r)}}}function si(M){let i,v;return i=new we({props:{code:`from huggingface_hub import ModelFilter
...
<span class="hljs-meta">&gt;&gt;&gt; </span>new_filter = ModelFilter(trained_dataset=<span class="hljs-string">&quot;common_voice&quot;</span>)`}}),{c(){j(i.$$.fragment)},l(u){H(i.$$.fragment,u)},m(u,l){F(i,u,l),v=!0},p:Oe,i(u){v||(D(i.$$.fragment,u),v=!0)},o(u){N(i.$$.fragment,u),v=!1},d(u){q(i,u)}}}function ri(M){let i,v,u,l,d;return l=new we({props:{code:`args = DatasetSearchArguments()
...
<span class="hljs-meta">&gt;&gt;&gt; </span>args.language.en`}}),{c(){i=o("p"),v=g("Example:"),u=p(),j(l.$$.fragment)},l(r){i=n(r,"P",{});var m=s(i);v=c(m,"Example:"),m.forEach(t),u=h(r),H(l.$$.fragment,r)},m(r,m){b(r,i,m),e(i,v),b(r,u,m),F(l,r,m),d=!0},p:Oe,i(r){d||(D(l.$$.fragment,r),d=!0)},o(r){N(l.$$.fragment,r),d=!1},d(r){r&&t(i),r&&t(u),q(l,r)}}}function ii(M){let i,v,u,l,d;return l=new we({props:{code:`args = ModelSearchArguments()
args.author_or_organization.huggingface
args.language.en`,highlighted:`<span class="hljs-meta">&gt;&gt;&gt; </span>args = ModelSearchArguments()
<span class="hljs-meta">&gt;&gt;&gt; </span>args.author_or_organization.huggingface
<span class="hljs-meta">&gt;&gt;&gt; </span>args.language.en`}}),{c(){i=o("p"),v=g("Example:"),u=p(),j(l.$$.fragment)},l(r){i=n(r,"P",{});var m=s(i);v=c(m,"Example:"),m.forEach(t),u=h(r),H(l.$$.fragment,r)},m(r,m){b(r,i,m),e(i,v),b(r,u,m),F(l,r,m),d=!0},p:Oe,i(r){d||(D(l.$$.fragment,r),d=!0)},o(r){N(l.$$.fragment,r),d=!1},d(r){r&&t(i),r&&t(u),q(l,r)}}}function li(M){let i,v,u,l,d,r,m,x,f,y,A,k,E,L,T,R,_,P,U,S,V,G,C,W,Z,J,se,ee,Q,X,Y,de,fe,B,te,K,Ee,ae,Ne,Ae,ue,I,oe,la,me,_e,ga,qe,ca,Uo,re,wt,Co,ya,zo,Vo,ka,Go,Wo,Me,Bo,xe,Et,Ko,wa,Jo,Qo,Re,Xo,je,At,Yo,Ea,Zo,en,Se,tn,Ue,xt,an,Aa,on,nn,Ce,jt,sn,xa,rn,ln,ze,Ht,gn,ja,cn,pn,ie,Ft,hn,Ha,dn,fn,Ve,un,Ge,mn,We,Dt,_n,Fa,bn,$n,le,Nt,vn,Da,yn,kn,Be,wn,Ke,En,Je,qt,An,Na,xn,jn,ge,It,Hn,qa,Fn,Dn,Ia,Nn,qn,Qe,In,ce,Lt,Ln,La,Tn,Pn,Tt,On,Pt,Mn,Rn,Sn,Xe,Un,He,Ot,Cn,Ta,zn,Vn,Ye,Gn,Ze,Mt,Wn,Pa,Bn,Kn,pe,Rt,Jn,Oa,Qn,Xn,Ma,Yn,Zn,et,es,tt,St,ts,Ra,as,os,Fe,Ut,ns,Sa,ss,rs,at,is,he,Ct,ls,Ua,gs,cs,ot,ps,nt,hs,st,zt,ds,Ca,fs,fo,Ie,rt,za,Vt,us,Va,ms,uo,Gt,Ga,_s,bs,mo,it,$s,pa,vs,ys,_o,ne,Wt,ks,lt,Bt,ws,Wa,Es,As,De,Kt,xs,Ba,js,Hs,Jt,Fs,Ka,Ds,Ns,qs,gt,Qt,Is,Ja,Ls,bo,Le,ct,Qa,Xt,Ts,Xa,Ps,$o,pt,Os,Ya,Ms,Rs,vo,be,Yt,Ss,Za,Us,Cs,ht,yo,$e,Zt,zs,eo,Vs,Gs,dt,ko,ve,ea,Ws,to,Bs,Ks,ft,wo,ye,ta,Js,ao,Qs,Xs,ut,Eo;return r=new Zs({}),J=new we({props:{code:`from huggingface_hub import list_models
...
&#x201C;streamlit&#x201D;, &#x201C;gradio&#x201D;, or &#x201C;static&#x201D;.`,name:"space_sdk"}],source:"https://github.com/huggingface/huggingface_hub/blob/main/src/huggingface_hub/hf_api.py#L1297",returnDescription:`
...
Whether to set a timeout for the request to the Hub.`,name:"timeout"}],source:"https://github.com/huggingface/huggingface_hub/blob/main/src/huggingface_hub/hf_api.py#L1094",returnDescription:`
...
The Hugging Face authentication token`,name:"token"}],source:"https://github.com/huggingface/huggingface_hub/blob/main/src/huggingface_hub/hf_api.py#L1883",returnDescription:`
...
Whether to set a timeout for the request to the Hub.`,name:"timeout"}],source:"https://github.com/huggingface/huggingface_hub/blob/main/src/huggingface_hub/hf_api.py#L1257",returnDescription:`
...
repository as well.`,name:"securityStatus"}],source:"https://github.com/huggingface/huggingface_hub/blob/main/src/huggingface_hub/hf_api.py#L1033",returnDescription:`
...
Whether to set a timeout for the request to the Hub.`,name:"timeout"}],source:"https://github.com/huggingface/huggingface_hub/blob/main/src/huggingface_hub/hf_api.py#L1202",returnDescription:`
<p>The repository
information.</p>
`,returnType:`
...
Whether to set a timeout for the request to the Hub.`,name:"timeout"}],source:"https://github.com/huggingface/huggingface_hub/blob/main/src/huggingface_hub/hf_api.py#L1148",returnDescription:`
...
Set to <code>&quot;dataset&quot;</code> or <code>&quot;space&quot;</code> if uploading to a dataset or
space, <code>None</code> or <code>&quot;model&quot;</code> if uploading to a model. Default is
<code>None</code>.`,name:"repo_type"}],source:"https://github.com/huggingface/huggingface_hub/blob/main/src/huggingface_hub/hf_api.py#L1524",returnDescription:`
...
Changing this value has no effect.`,name:"identical_ok"}],source:"https://github.com/huggingface/huggingface_hub/blob/main/src/huggingface_hub/hf_api.py#L1677",returnDescription:`
...
methods.`),mo=p(),it=o("p"),$s=g("It does this using the "),pa=o("a"),vs=g("HfFolder"),ys=g(" utility, which saves data at the root of the user."),_o=p(),ne=o("div"),j(Wt.$$.fragment),ks=p(),lt=o("div"),j(Bt.$$.fragment),ws=p(),Wa=o("p"),Es=g("Deletes the token from storage. Does not fail if token does not exist."),As=p(),De=o("div"),j(Kt.$$.fragment),xs=p(),Ba=o("p"),js=g("Get token or None if not existent."),Hs=p(),Jt=o("p"),Fs=g("Note that a token can be also provided using the "),Ka=o("code"),Ds=g("HUGGING_FACE_HUB_TOKEN"),Ns=g(`
environment variable.`),qs=p(),gt=o("div"),j(Qt.$$.fragment),Is=p(),Ja=o("p"),Ls=g("Save token, creating folder as needed."),bo=p(),Le=o("h2"),ct=o("a"),Qa=o("span"),j(Xt.$$.fragment),Ts=p(),Xa=o("span"),Ps=g("Filtering helpers"),$o=p(),pt=o("p"),Os=g("Some helpers to filter repositories on the Hub are available in the "),Ya=o("code"),Ms=g("huggingface_hub"),Rs=g(" package."),vo=p(),be=o("div"),j(Yt.$$.fragment),Ss=p(),Za=o("p"),Us=g(`A class that converts human-readable dataset search parameters into ones
compatible with the REST API. For all parameters capitalization does not
matter.`),Cs=p(),j(ht.$$.fragment),yo=p(),$e=o("div"),j(Zt.$$.fragment),zs=p(),eo=o("p"),Vs=g(`A class that converts human-readable model search parameters into ones
compatible with the REST API. For all parameters capitalization does not
matter.`),Gs=p(),j(dt.$$.fragment),ko=p(),ve=o("div"),j(ea.$$.fragment),Ws=p(),to=o("p"),Bs=g(`A nested namespace object holding all possible values for properties of
...
with a number, it will only exist in the dictionary`),Xs=p(),j(ut.$$.fragment),this.h()},l(a){const $=Cr('[data-svelte="svelte-1phssyn"]',document.head);i=n($,"META",{name:!0,content:!0}),$.forEach(t),v=h(a),u=n(a,"H1",{class:!0});var aa=s(u);l=n(aa,"A",{id:!0,class:!0,href:!0});var oo=s(l);d=n(oo,"SPAN",{});var no=s(d);H(r.$$.fragment,no),no.forEach(t),oo.forEach(t),m=h(aa),x=n(aa,"SPAN",{});var so=s(x);f=c(so,"Hugging Face Hub API"),so.forEach(t),aa.forEach(t),y=h(a),A=n(a,"P",{});var oa=s(A);k=c(oa,"Below is the documentation for the "),E=n(oa,"CODE",{});var ro=s(E);L=c(ro,"HfApi"),ro.forEach(t),T=c(oa,` class, which serves as a Python wrapper for the Hugging Face
