import{S as as,i as ns,s as ts,e as i,k as v,w as F,t as j,M as rs,c as o,d as a,m as y,a as f,x as H,h as x,b as m,F as n,g as _,y as B,q as N,o as T,B as D,v as ls,L as ps}from"../../chunks/vendor-a09ded63.js";import{D as cs}from"../../chunks/Docstring-3f63de13.js";import{C as is}from"../../chunks/CodeBlock-879da7fe.js";import{I as os}from"../../chunks/IconCopyLink-3f5556be.js";import{E as gs}from"../../chunks/ExampleCodeBlock-7aff195a.js";function us(C){let t,d,l,r,g;return r=new is({props:{code:`from huggingface_hub.inference_api import InferenceApi
...
<span class="hljs-meta">&gt;&gt;&gt; </span>inference = InferenceApi(<span class="hljs-string">&quot;bert-base-uncased&quot;</span>, task=<span class="hljs-string">&quot;feature-extraction&quot;</span>)`}}),{c(){t=i("p"),d=j("Example:"),l=v(),F(r.$$.fragment)},l(e){t=o(e,"P",{});var u=f(t);d=x(u,"Example:"),u.forEach(a),l=y(e),H(r.$$.fragment,e)},m(e,u){_(e,t,u),n(t,d),_(e,l,u),B(r,e,u),g=!0},p:ps,i(e){g||(N(r.$$.fragment,e),g=!0)},o(e){T(r.$$.fragment,e),g=!1},d(e){e&&a(t),e&&a(l),D(r,e)}}}function hs(C){let t,d,l,r,g,e,u,w,L,M,h,K,E,Q,W,I,Z,J,S,c,q,R,P,U,V,b,O;return e=new os({}),q=new cs({props:{name:"class huggingface_hub.InferenceApi",anchor:"huggingface_hub.InferenceApi",parameters:[{name:"repo_id",val:": str"},{name:"task",val:": typing.Optional[str] = None"},{name:"token",val:": typing.Optional[str] = None"},{name:"gpu",val:": typing.Optional[bool] = False"}],source:"https://github.com/huggingface/huggingface_hub/blob/v0.6.0.rc0/src/huggingface_hub/inference_api.py#L45"}}),b=new gs({props:{anchor:"huggingface_hub.InferenceApi.example",$$slots:{default:[us]},$$scope:{ctx:C}}}),{c(){t=i("meta"),d=v(),l=i("h1"),r=i("a"),g=i("span"),F(e.$$.fragment),u=v(),w=i("span"),L=j("Inference API"),M=v(),h=i("p"),K=j("The "),E=i("code"),Q=j("huggingface_hub"),W=j(" library allows users to programmatically access the Inference API. For more information about the Accelerated Inference API, please refer to the documentation "),I=i("a"),Z=j("here"),J=j("."),S=v(),c=i("div"),F(q.$$.fragment),R=v(),P=i("p"),U=j("Client to configure requests and make calls to the HuggingFace Inference API."),V=v(),F(b.$$.fragment),this.h()},l(s){const p=rs('[data-svelte="svelte-1phssyn"]',document.head);t=o(p,"META",{name:!0,content:!0}),p.forEach(a),d=y(s),l=o(s,"H1",{class:!0});var $=f(l);r=o($,"A",{id:!0,class:!0,href:!0});var z=f(r);g=o(z,"SPAN",{});var G=f(g);H(e.$$.fragment,G),G.forEach(a),z.forEach(a),u=y($),w=o($,"SPAN",{});var X=f(w);L=x(X,"Inference API"),X.forEach(a),$.forEach(a),M=y(s),h=o(s,"P",{});var A=f(h);K=x(A,"The "),E=o(A,"CODE",{});var Y=f(E);Q=x(Y,"huggingface_hub"),Y.forEach(a),W=x(A," library allows users to programmatically access the Inference API. For more information about the Accelerated Inference API, please refer to the documentation "),I=o(A,"A",{href:!0,rel:!0});var ss=f(I);Z=x(ss,"here"),ss.forEach(a),J=x(A,"."),A.forEach(a),S=y(s),c=o(s,"DIV",{class:!0});var k=f(c);H(q.$$.fragment,k),R=y(k),P=o(k,"P",{});var es=f(P);U=x(es,"Client to configure requests and make calls to the HuggingFace Inference API."),es.forEach(a),V=y(k),H(b.$$.fragment,k),k.forEach(a),this.h()},h(){m(t,"name","hf:doc:metadata"),m(t,"content",JSON.stringify(fs)),m(r,"id","huggingface_hub.InferenceApi"),m(r,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),m(r,"href","#huggingface_hub.InferenceApi"),m(l,"class","relative group"),m(I,"href","https://huggingface.co/docs/api-inference/index"),m(I,"rel","nofollow"),m(c,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8")},m(s,p){n(document.head,t),_(s,d,p),_(s,l,p),n(l,r),n(r,g),B(e,g,null),n(l,u),n(l,w),n(w,L),_(s,M,p),_(s,h,p),n(h,K),n(h,E),n(E,Q),n(h,W),n(h,I),n(I,Z),n(h,J),_(s,S,p),_(s,c,p),B(q,c,null),n(c,R),n(c,P),n(P,U),n(c,V),B(b,c,null),O=!0},p(s,[p]){const $={};p&2&&($.$$scope={dirty:p,ctx:s}),b.$set($)},i(s){O||(N(e.$$.fragment,s),N(q.$$.fragment,s),N(b.$$.fragment,s),O=!0)},o(s){T(e.$$.fragment,s),T(q.$$.fragment,s),T(b.$$.fragment,s),O=!1},d(s){a(t),s&&a(d),s&&a(l),D(e),s&&a(M),s&&a(h),s&&a(S),s&&a(c),D(q),D(b)}}}const fs={local:"huggingface_hub.InferenceApi",title:"Inference API"};function ms(C){return ls(()=>{new URLSearchParams(window.location.search).get("fw")}),[]}class Is extends as{constructor(t){super();ns(this,t,ms,hs,ts,{})}}export{Is as default,fs as metadata};
