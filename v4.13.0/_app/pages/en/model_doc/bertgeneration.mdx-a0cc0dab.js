import{S as la,i as ca,s as ha,e as s,k as l,w as b,t as o,L as pa,c as a,d as n,m as c,a as i,x as v,h as r,b as d,J as e,g as p,y as k,q as y,o as T,B as w}from"../../../chunks/vendor-e859c359.js";import{T as da}from"../../../chunks/Tip-edc75249.js";import{D as gt}from"../../../chunks/Docstring-ade913b3.js";import{C as Vt}from"../../../chunks/CodeBlock-ce4317c2.js";import{I as _t}from"../../../chunks/IconCopyLink-5fae3b20.js";import"../../../chunks/CopyButton-77addb3d.js";function ua(ie){let u,q,m,g,D;return{c(){u=s("p"),q=o(`Although the recipe for forward pass needs to be defined within this function, one should call the
...
processing steps while the latter silently ignores them.`)},l(_){u=a(_,"P",{});var E=i(u);q=r(E,`Although the recipe for forward pass needs to be defined within this function, one should call the
`),m=a(E,"CODE",{});var S=i(m);g=r(S,"Module"),S.forEach(n),D=r(E,` instance afterwards instead of this since the former takes care of running the pre and post
processing steps while the latter silently ignores them.`),E.forEach(n)},m(_,E){p(_,u,E),e(u,q),e(u,m),e(m,g),e(u,D)},d(_){_&&n(u)}}}function fa(ie){let u,q,m,g,D,_,E,S,Dn,Jt,R,Y,bt,de,jn,vt,Sn,Kt,A,An,Ue,Mn,Nn,le,Ln,Fn,Qt,He,In,Xt,Ve,kt,On,Yt,Je,Rn,Zt,Ke,ce,Wn,Qe,Un,Hn,en,he,tn,Xe,pe,Vn,Ye,Jn,Kn,nn,ue,on,Ze,Qn,rn,Z,M,et,Xn,Yn,tt,Zn,eo,yt,to,no,oo,Tt,ro,sn,N,so,me,ao,io,fe,lo,co,an,W,ee,wt,ge,ho,Et,po,dn,$,_e,uo,be,mo,Bt,fo,go,_o,U,bo,nt,vo,ko,ot,yo,To,wo,zt,Eo,Bo,ve,ln,H,te,$t,ke,zo,Gt,$o,cn,j,ye,Go,Te,qo,we,xo,Po,Co,Ee,Do,rt,jo,So,Ao,qt,hn,V,ne,xt,Be,Mo,Pt,No,pn,f,ze,Lo,Ct,Fo,Io,$e,Oo,st,Ro,Wo,Uo,Ge,Ho,qe,Vo,Jo,Ko,xe,Qo,Pe,Xo,Yo,Zo,J,er,at,tr,nr,Ce,or,rr,sr,B,ar,Dt,ir,dr,jt,lr,cr,St,hr,pr,At,ur,mr,Mt,fr,gr,Nt,_r,br,vr,x,De,kr,K,yr,it,Tr,wr,Lt,Er,Br,zr,oe,$r,Ft,Gr,qr,je,un,Q,re,It,Se,xr,Ot,Pr,mn,G,Ae,Cr,Me,Dr,Rt,jr,Sr,Ar,Ne,Mr,dt,Nr,Lr,Fr,Le,Ir,Fe,Or,Rr,Wr,P,Ie,Ur,X,Hr,lt,Vr,Jr,Wt,Kr,Qr,Xr,se,Yr,Ut,Zr,es,Oe,fn;return _=new _t({}),de=new _t({}),he=new Vt({props:{code:`# leverage checkpoints for Bert2Bert model...
...
<span class="hljs-meta">&gt;&gt;&gt; </span>prediction_logits = outputs.logits`}}),{c(){u=s("meta"),q=l(),m=s("h1"),g=s("a"),D=s("span"),b(_.$$.fragment),E=l(),S=s("span"),Dn=o("BertGeneration"),Jt=l(),R=s("h2"),Y=s("a"),bt=s("span"),b(de.$$.fragment),jn=l(),vt=s("span"),Sn=o("Overview"),Kt=l(),A=s("p"),An=o(`The BertGeneration model is a BERT model that can be leveraged for sequence-to-sequence tasks using
...
BERT checkpoints for subsequent fine-tuning.`),en=l(),b(he.$$.fragment),tn=l(),Xe=s("ul"),pe=s("li"),Vn=o("Pretrained "),Ye=s("a"),Jn=o("EncoderDecoderModel"),Kn=o(" are also directly available in the model hub, e.g.,"),nn=l(),b(ue.$$.fragment),on=l(),Ze=s("p"),Qn=o("Tips:"),rn=l(),Z=s("ul"),M=s("li"),et=s("a"),Xn=o("BertGenerationEncoder"),Yn=o(" and "),tt=s("a"),Zn=o("BertGenerationDecoder"),eo=o(` should be used in
...
Users should refer to this superclass for more information regarding those methods.`),Ao=l(),qt=s("div"),hn=l(),V=s("h2"),ne=s("a"),xt=s("span"),b(Be.$$.fragment),Mo=l(),Pt=s("span"),No=o("BertGenerationEncoder"),pn=l(),f=s("div"),b(ze.$$.fragment),Lo=l(),Ct=s("p"),Fo=o("The bare BertGeneration model transformer outputting raw hidden-states without any specific head on top."),Io=l(),$e=s("p"),Oo=o("This model inherits from "),st=s("a"),Ro=o("PreTrainedModel"),Wo=o(`. Check the superclass documentation for the generic
