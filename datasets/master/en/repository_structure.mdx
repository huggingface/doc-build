---
local: structure-your-repository
sections:
- local: main-usecase
  title: Main use-case
- local: splits-and-file-names
  title: Splits and file names
- local: multiple-files-per-split
  title: Multiple files per split
- local: custom-split-names
  title: Custom split names
- local: multiple-configuration-wip
  title: Multiple configuration (WIP)
...
<h1 id="structure-your-repository">Structure your repository</h1>
...
<h2 id="main-usecase">Main use-case</h2>
...
<h2 id="splits-and-file-names">Splits and file names</h2>
...
<h2 id="multiple-files-per-split">Multiple files per split</h2>
...
<h2 id="custom-split-names">Custom split names</h2>
...
<h2 id="multiple-configuration-wip">Multiple configuration (WIP)</h2>
