---
local: upload-a-dataset-to-the-hub
sections:
- local: create-a-repository
  title: Create a repository
- local: upload-your-files
  title: Upload your files
- local: create-a-dataset-card
  title: Create a Dataset card
- local: load-dataset
  title: Load dataset
- local: upload-from-python
  title: Upload from Python
- local: privacy
  title: Privacy
- local: whats-next
  title: What's next?
...
<h1 id="upload-a-dataset-to-the-hub">Upload a dataset to the Hub</h1>
...
<h2 id="upload-your-files">Upload your files</h2>
...
<h2 id="create-a-dataset-card">Create a Dataset card</h2>
...
<h2 id="upload-from-python">Upload from Python</h2>

To upload a [datasets.DatasetDict](/docs/datasets/master/en/package_reference/main_classes#datasets.DatasetDict) on the Hugging Face Hub in Python, you can login and use the [datasets.DatasetDict.push_to_hub()](/docs/datasets/master/en/package_reference/main_classes#datasets.DatasetDict.push_to_hub) method:
