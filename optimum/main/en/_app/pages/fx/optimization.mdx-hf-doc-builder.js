import{S as Rr,i as Sr,s as Or,e as s,k as m,w as $,t as p,M as Gr,c as r,d as o,m as l,a as n,x as v,h as f,b as g,G as e,g as c,y as b,q as x,o as y,B as w,v as Vr,L as wt}from"../../chunks/vendor-hf-doc-builder.js";import{D as I}from"../../chunks/Docstring-hf-doc-builder.js";import{C as D}from"../../chunks/CodeBlock-hf-doc-builder.js";import{I as xt}from"../../chunks/IconCopyLink-hf-doc-builder.js";import{E as yt}from"../../chunks/ExampleCodeBlock-hf-doc-builder.js";function Wr(z){let d,j,u,h,T;return h=new D({props:{code:`from transformers import BertModel
...
<span class="hljs-meta">&gt;&gt;&gt; </span>transformed_model = composition(traced)`}}),{c(){d=s("p"),j=p("Example:"),u=m(),$(h.$$.fragment)},l(a){d=r(a,"P",{});var _=n(d);j=f(_,"Example:"),_.forEach(o),u=l(a),v(h.$$.fragment,a)},m(a,_){c(a,d,_),e(d,j),c(a,u,_),b(h,a,_),T=!0},p:wt,i(a){T||(x(h.$$.fragment,a),T=!0)},o(a){y(h.$$.fragment,a),T=!1},d(a){a&&o(d),a&&o(u),w(h,a)}}}function Hr(z){let d,j,u,h,T;return h=new D({props:{code:`from transformers import BertModel
from transformers.utils.fx import symbolic_trace
...
<span class="hljs-meta">&gt;&gt;&gt; </span>restored_model = transformation(transformed_model, reverse=<span class="hljs-literal">True</span>)`}}),{c(){d=s("p"),j=p("Example:"),u=m(),$(h.$$.fragment)},l(a){d=r(a,"P",{});var _=n(d);j=f(_,"Example:"),_.forEach(o),u=l(a),v(h.$$.fragment,a)},m(a,_){c(a,d,_),e(d,j),c(a,u,_),b(h,a,_),T=!0},p:wt,i(a){T||(x(h.$$.fragment,a),T=!0)},o(a){y(h.$$.fragment,a),T=!1},d(a){a&&o(d),a&&o(u),w(h,a)}}}function Ur(z){let d,j,u,h,T;return h=new D({props:{code:`from transformers import BertModel
from transformers.utils.fx import symbolic_trace
...
<span class="hljs-meta">&gt;&gt;&gt; </span>transformed_model = transformation(traced)
<span class="hljs-meta">&gt;&gt;&gt; </span>restored_model = transformation(transformed_model, reverse=<span class="hljs-literal">True</span>)`}}),{c(){d=s("p"),j=p("Example:"),u=m(),$(h.$$.fragment)},l(a){d=r(a,"P",{});var _=n(d);j=f(_,"Example:"),_.forEach(o),u=l(a),v(h.$$.fragment,a)},m(a,_){c(a,d,_),e(d,j),c(a,u,_),b(h,a,_),T=!0},p:wt,i(a){T||(x(h.$$.fragment,a),T=!0)},o(a){y(h.$$.fragment,a),T=!1},d(a){a&&o(d),a&&o(u),w(h,a)}}}function Jr(z){let d,j,u,h,T;return h=new D({props:{code:`from transformers import BertModel
from transformers.utils.fx import symbolic_trace
...
<span class="hljs-meta">&gt;&gt;&gt; </span>transformed_model = transformation(traced)
<span class="hljs-meta">&gt;&gt;&gt; </span>restored_model = transformation(transformed_model, reverse=<span class="hljs-literal">True</span>)`}}),{c(){d=s("p"),j=p("Example:"),u=m(),$(h.$$.fragment)},l(a){d=r(a,"P",{});var _=n(d);j=f(_,"Example:"),_.forEach(o),u=l(a),v(h.$$.fragment,a)},m(a,_){c(a,d,_),e(d,j),c(a,u,_),b(h,a,_),T=!0},p:wt,i(a){T||(x(h.$$.fragment,a),T=!0)},o(a){y(h.$$.fragment,a),T=!1},d(a){a&&o(d),a&&o(u),w(h,a)}}}function Kr(z){let d,j;return d=new D({props:{code:`     Conv2d
     /   \\
    /     \\
ReLU   BatchNorm2d`,highlighted:`     Co<span class="hljs-symbol">nv2</span>d
     /   \\
    /     \\
ReLU   Batch<span class="hljs-symbol">Norm2</span>d`}}),{c(){$(d.$$.fragment)},l(u){v(d.$$.fragment,u)},m(u,h){b(d,u,h),j=!0},p:wt,i(u){j||(x(d.$$.fragment,u),j=!0)},o(u){y(d.$$.fragment,u),j=!1},d(u){w(d,u)}}}function Qr(z){let d,j,u,h,T;return h=new D({props:{code:`from transformers.utils.fx import symbolic_trace
...
transformation = FuseBatchNorm2dInConv2d()
transformed_model = transformation(traced_model)`}}),{c(){d=s("p"),j=p("Example:"),u=m(),$(h.$$.fragment)},l(a){d=r(a,"P",{});var _=n(d);j=f(_,"Example:"),_.forEach(o),u=l(a),v(h.$$.fragment,a)},m(a,_){c(a,d,_),e(d,j),c(a,u,_),b(h,a,_),T=!0},p:wt,i(a){T||(x(h.$$.fragment,a),T=!0)},o(a){y(h.$$.fragment,a),T=!1},d(a){a&&o(d),a&&o(u),w(h,a)}}}function Xr(z){let d,j;return d=new D({props:{code:`     Linear
     /   \\
    /     \\
ReLU   BatchNorm1d`,highlighted:`     Linear
     /   <span class="hljs-string">\\</span>
    /     <span class="hljs-string">\\</span>
ReLU   BatchNorm1d`}}),{c(){$(d.$$.fragment)},l(u){v(d.$$.fragment,u)},m(u,h){b(d,u,h),j=!0},p:wt,i(u){j||(x(d.$$.fragment,u),j=!0)},o(u){y(d.$$.fragment,u),j=!1},d(u){w(d,u)}}}function Yr(z){let d,j,u,h,T;return h=new D({props:{code:`from transformers.utils.fx import symbolic_trace
...
transformation = FuseBatchNorm1dInLinear()
transformed_model = transformation(traced_model)`}}),{c(){d=s("p"),j=p("Example:"),u=m(),$(h.$$.fragment)},l(a){d=r(a,"P",{});var _=n(d);j=f(_,"Example:"),_.forEach(o),u=l(a),v(h.$$.fragment,a)},m(a,_){c(a,d,_),e(d,j),c(a,u,_),b(h,a,_),T=!0},p:wt,i(a){T||(x(h.$$.fragment,a),T=!0)},o(a){y(h.$$.fragment,a),T=!1},d(a){a&&o(d),a&&o(u),w(h,a)}}}function Zr(z){let d,j,u,h,T,a,_,ke,Jo,lo,Z,Ko,ze,Qo,Xo,po,W,tt,Ee,jt,Yo,Me,Zo,fo,ee,ta,co,H,et,Ie,Tt,ea,Be,oa,ho,O,aa,oe,sa,ra,ae,na,ia,uo,se,ma,go,kt,_o,re,la,$o,zt,vo,U,ot,Le,Et,pa,qe,fa,bo,q,da,ne,ca,ha,ie,ua,ga,me,_a,$a,xo,le,va,yo,Mt,wo,J,at,Ae,It,ba,De,xa,jo,st,ya,pe,wa,ja,To,Bt,ko,K,rt,Ce,Lt,Ta,Fe,ka,zo,Q,nt,Ne,qt,za,Pe,Ea,Eo,k,At,Ma,Re,Ia,Ba,Dt,La,fe,qa,Aa,Da,de,Ct,Ca,ce,Ft,Fa,it,Nt,Na,Se,Pa,Ra,he,Pt,Sa,ue,Rt,Mo,E,St,Oa,Oe,Ga,Va,X,Wa,ge,Ha,Ua,_e,Ja,Ka,Qa,$e,Ot,Xa,mt,Gt,Ya,Ge,Za,ts,ve,Vt,Io,C,Wt,es,Ve,os,as,lt,Bo,Y,pt,We,Ht,ss,He,rs,Lo,F,Ut,ns,Ue,is,ms,ft,qo,N,Jt,ls,Je,ps,fs,dt,Ao,P,Kt,ds,Ke,cs,hs,ct,Do,B,Qt,us,R,gs,Qe,_s,$s,Xe,vs,bs,Ye,xs,ys,ws,Ze,js,Ts,ht,ks,ut,Co,L,Xt,zs,S,Es,to,Ms,Is,eo,Bs,Ls,oo,qs,As,Ds,ao,Cs,Fs,gt,Ns,_t,Fo;return a=new xt({}),jt=new xt({}),Tt=new xt({}),kt=new D({props:{code:`from optimum.fx.optimization import Transformation
...
This can be set to <code>False</code> when chaining transformations together to perform this operation only once.`,name:"lint_and_recompile"}],source:"https://github.com/huggingface/optimum/blob/main/optimum/fx/optimization/transformations.py#L112",returnDescription:`
...
The graph_module to get the nodes from.`,name:"graph_module"}],source:"https://github.com/huggingface/optimum/blob/main/optimum/fx/optimization/transformations.py#L165",returnDescription:`
...
The node to check.`,name:"node"}],source:"https://github.com/huggingface/optimum/blob/main/optimum/fx/optimization/transformations.py#L153",returnDescription:`
...
If <code>True</code>, the reverse transformation is performed.`,name:"reverse"}],source:"https://github.com/huggingface/optimum/blob/main/optimum/fx/optimization/transformations.py#L201",returnDescription:`
<p>The transformed module.</p>
`,returnType:`
<p><code>torch.fx.GraphModule</code></p>
...
The node to mark as restored.`,name:"node"}],source:"https://github.com/huggingface/optimum/blob/main/optimum/fx/optimization/transformations.py#L226"}}),Vt=new I({props:{name:"reverse",anchor:"optimum.fx.optimization.ReversibleTransformation.reverse",parameters:[{name:"graph_module",val:": GraphModule"}],parametersDescription:[{anchor:"optimum.fx.optimization.ReversibleTransformation.reverse.graph_module",description:`<strong>graph_module</strong> (<code>torch.fx.GraphModule</code>) &#x2014;
The module to transform.`,name:"graph_module"}],source:"https://github.com/huggingface/optimum/blob/main/optimum/fx/optimization/transformations.py#L188",returnDescription:`
...
Whether the resulting transformation should be inplace, or create a new graph module.`,name:"inplace"}],source:"https://github.com/huggingface/optimum/blob/main/optimum/fx/optimization/transformations.py#L725",returnDescription:`
