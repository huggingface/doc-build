import{S as Te,i as Ae,s as Re,e as o,k as c,w as I,t as s,M as De,c as i,d as e,m,a as l,x as L,h as n,b as j,F as a,g as r,y as S,L as Qe,q as X,o as B,B as J,v as Pe}from"../chunks/vendor-19e06bd2.js";import{I as Fe}from"../chunks/IconCopyLink-3c713d38.js";import{C as W}from"../chunks/CodeBlock-9dd1fdfb.js";function He(te){let q,yt,b,k,Y,T,Jt,Z,Ut,kt,u,Gt,tt,Kt,Vt,at,Wt,Yt,et,Zt,ta,st,aa,ea,vt,A,wt,h,sa,nt,na,oa,ot,ia,la,it,pa,ra,lt,ca,ma,Et,R,$t,d,ua,pt,ha,da,rt,fa,ga,ct,_a,za,Ot,D,Ct,f,ja,mt,qa,ba,ut,xa,ya,Q,ht,ka,va,Tt,P,At,v,wa,dt,Ea,$a,Rt,F,Dt,w,Oa,ft,Ca,Ta,Qt,H,Pt,U,Aa,Ft,g,x,Ra,gt,Da,Qa,_t,Pa,Fa,Ha,y,Ma,zt,Na,Ia,jt,La,Sa,Xa,M,Ba,qt,Ja,Ua,Ga,bt,Ka,Ht,E,Va,N,xt,Wa,Ya,Mt,G,Za,Nt;return T=new Fe({}),A=new W({props:{code:`from optimum.onnxruntime import ORTConfig, ORTQuantizer
...
<span class="hljs-meta">... </span>    quantization_config=qconfig,
<span class="hljs-meta">... </span>)`}}),F=new W({props:{code:`from optimum.onnxruntime.configuration import OptimizationConfig
...
<span class="hljs-meta">&gt;&gt;&gt; </span>optimization_config = OptimizationConfig(optimization_level=<span class="hljs-number">99</span>)`}}),H=new W({props:{code:`from optimum.onnxruntime import ORTOptimizer
