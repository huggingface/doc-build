...
This is the configuration class to store the configuration of a [SegformerModel](/docs/transformers/master/en/model_doc/segformer#transformers.SegformerModel). It is used
...
<docstring><name>forward</name><anchor>transformers.SegformerModel.forward</anchor><source>https://github.com/huggingface/transformers/blob/master/src/transformers/models/segformer/modeling_segformer.py#L481</source><parameters>[{"name": "pixel_values", "val": ""}, {"name": "output_attentions", "val": " = None"}, {"name": "output_hidden_states", "val": " = None"}, {"name": "return_dict", "val": " = None"}]</parameters><paramsdesc>- **pixel_values** (`torch.FloatTensor` of shape `(batch_size, num_channels, height, width)`) --
  ...
  [SegformerFeatureExtractor](/docs/transformers/master/en/model_doc/segformer#transformers.SegformerFeatureExtractor). See
  [transformers.SegformerFeatureExtractor.__call__()](/docs/transformers/master/en/model_doc/segformer#transformers.SegformerFeatureExtractor.__call__) for details.
...
various elements depending on the configuration ([SegformerConfig](/docs/transformers/master/en/model_doc/segformer#transformers.SegformerConfig)) and inputs.
