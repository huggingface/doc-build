...
We have seen in the [training tutorial](/docs/transformers/master/en/training): how to fine-tune a model on a given task. You have probably
...
or removing TF. For instance, if you trained a [DistilBertForSequenceClassification](/docs/transformers/master/en/model_doc/distilbert#transformers.DistilBertForSequenceClassification), try to type

```
>>> from transformers import TFDistilBertForSequenceClassification
```

and if you trained a [TFDistilBertForSequenceClassification](/docs/transformers/master/en/model_doc/distilbert#transformers.TFDistilBertForSequenceClassification), try to type
...
- a _config.json_ file, which saves the [configuration](/docs/transformers/master/en/main_classes/configuration) of your model ;
...
- a _special_tokens_map.json_, which is part of your [tokenizer](/docs/transformers/master/en/main_classes/tokenizer) save;
- a _tokenizer_config.json_, which is part of your [tokenizer](/docs/transformers/master/en/main_classes/tokenizer) save;
- files named _vocab.json_, _vocab.txt_, _merges.txt_, or similar, which contain the vocabulary of your tokenizer, part
  of your [tokenizer](/docs/transformers/master/en/main_classes/tokenizer) save;
- maybe a _added_tokens.json_, which is part of your [tokenizer](/docs/transformers/master/en/main_classes/tokenizer) save.
