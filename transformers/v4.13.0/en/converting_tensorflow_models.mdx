...
be imported using `from_pretrained()` (see example in [quicktour](/docs/transformers/master/en/quicktour) , [run_glue.py](https://github.com/huggingface/transformers/tree/master/examples/pytorch/text-classification/run_glue.py) ).
