...
local: benchmarks
sections:
- local: how-to-benchmark-transformer-models
  title: How to benchmark 🤗 Transformer models
...
<h2 id="how-to-benchmark-transformer-models">How to benchmark 🤗 Transformer models</h2>
