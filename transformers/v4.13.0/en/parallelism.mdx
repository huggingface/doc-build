...
![DeepSpeed-Image-1](/docs/transformers/master/en/imgs/parallelism-zero.png)
...
![mp-pp](/docs/transformers/master/en/imgs/parallelism-gpipe-bubble.png)
...
![interleaved-pipeline-execution](/docs/transformers/master/en/imgs/parallelism-sagemaker-interleaved-pipeline.png)
...
![Parallel GEMM](/docs/transformers/master/en/imgs/parallelism-tp-parallel_gemm.png)
...
![independent GeLU](/docs/transformers/master/en/imgs/parallelism-tp-independent-gelu.png)
...
![parallel shard processing](/docs/transformers/master/en/imgs/parallelism-tp-parallel_shard_processing.png)

Parallelizing the multi-headed attention layers is even simpler, since they are already inherently parallel, due to having multiple independent heads!
![parallel self-attention](/docs/transformers/master/en/imgs/parallelism-tp-parallel_self_attention.png)
...
![dp-pp-2d](/docs/transformers/master/en/imgs/parallelism-zero-dp-pp.png)
...
![dp-pp-tp-3d](/docs/transformers/master/en/imgs/parallelism-deepspeed-3d.png)
...
![flex-flow-soap](/docs/transformers/master/en/imgs/parallelism-flexflow.jpeg)
