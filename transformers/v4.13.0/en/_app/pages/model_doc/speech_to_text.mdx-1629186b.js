import{S as ll,i as pl,s as hl,e as a,k as d,w as u,t as n,M as ml,c as r,d as o,m as l,a as i,x as _,h as s,b as c,F as e,g as h,y as g,q as v,o as T,B as x}from"../../chunks/vendor-68651a14.js";import{T as zs}from"../../chunks/Tip-3fbaa85f.js";import{D as F}from"../../chunks/Docstring-d699e906.js";import{C as En}from"../../chunks/CodeBlock-b98730f5.js";import{I as xe}from"../../chunks/IconCopyLink-8ff17449.js";import"../../chunks/CopyButton-e88c769b.js";function fl(Y){let m,w,f,b,z,k,y,E;return{c(){m=a("p"),w=n(`This class method is simply calling Speech2TextFeatureExtractor\u2019s
`),f=a("code"),b=n("from_pretrained"),z=n(` and Speech2TextTokenizer\u2019s
`),k=a("code"),y=n("from_pretrained"),E=n(`. Please refer to the
docstrings of the methods above for more information.`)},l(C){m=r(C,"P",{});var $=i(m);w=s($,`This class method is simply calling Speech2TextFeatureExtractor\u2019s
...
docstrings of the methods above for more information.`),$.forEach(o)},m(C,$){h(C,m,$),e(m,w),e(m,f),e(f,b),e(m,z),e(m,k),e(k,y),e(m,E)},d(C){C&&o(m)}}}function ul(Y){let m,w,f,b,z,k,y,E;return{c(){m=a("p"),w=n("This class method is simply calling "),f=a("code"),b=n("save_pretrained"),z=n(` and
`),k=a("code"),y=n("save_pretrained"),E=n(`. Please refer to the
docstrings of the methods above for more information.`)},l(C){m=r(C,"P",{});var $=i(m);w=s($,"This class method is simply calling "),f=r($,"CODE",{});var M=i(f);b=s(M,"save_pretrained"),M.forEach(o),z=s($,` and
`),k=r($,"CODE",{});var L=i(k);y=s(L,"save_pretrained"),L.forEach(o),E=s($,`. Please refer to the
docstrings of the methods above for more information.`),$.forEach(o)},m(C,$){h(C,m,$),e(m,w),e(m,f),e(f,b),e(m,z),e(m,k),e(k,y),e(m,E)},d(C){C&&o(m)}}}function _l(Y){let m,w,f,b,z;return{c(){m=a("p"),w=n(`Although the recipe for forward pass needs to be defined within this function, one should call the
...
<a href="/docs/transformers/master/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),It=new F({props:{name:"forward",anchor:"transformers.Speech2TextModel.forward",parameters:[{name:"input_features",val:" = None"},{name:"attention_mask",val:" = None"},{name:"decoder_input_ids",val:" = None"},{name:"decoder_attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"decoder_head_mask",val:" = None"},{name:"cross_attn_head_mask",val:" = None"},{name:"encoder_outputs",val:" = None"},{name:"past_key_values",val:" = None"},{name:"decoder_inputs_embeds",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/master/src/transformers/models/speech_to_text/modeling_speech_to_text.py#L1150",parametersDescription:[{anchor:"transformers.Speech2TextModel.forward.input_features",description:`<strong>input_features</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length, feature_size)</code>) &#x2014;
...
Model configuration class with all the parameters of the model. Initializing with a config file does not
load the weights associated with the model, only the configuration. Check out the
<a href="/docs/transformers/master/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),Ut=new F({props:{name:"forward",anchor:"transformers.Speech2TextForConditionalGeneration.forward",parameters:[{name:"input_features",val:" = None"},{name:"attention_mask",val:" = None"},{name:"decoder_input_ids",val:" = None"},{name:"decoder_attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"decoder_head_mask",val:" = None"},{name:"cross_attn_head_mask",val:" = None"},{name:"encoder_outputs",val:" = None"},{name:"past_key_values",val:" = None"},{name:"decoder_inputs_embeds",val:" = None"},{name:"labels",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/master/src/transformers/models/speech_to_text/modeling_speech_to_text.py#L1278",parametersDescription:[{anchor:"transformers.Speech2TextForConditionalGeneration.forward.input_features",description:`<strong>input_features</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length, feature_size)</code>) &#x2014;
Float values of fbank features extracted from the raw speech waveform. Raw speech waveform can be obtained
by loading a <code>.flac</code> or <code>.wav</code> audio file into an array of type <code>List[float]</code> or a
<code>numpy.ndarray</code>, <em>e.g.</em> via the soundfile library (<code>pip install soundfile</code>). To prepare the array
into <code>input_features</code>, the <a href="/docs/transformers/master/en/model_doc/speech_to_text#transformers.Speech2TextTokenizer">Speech2TextTokenizer</a> should be used for extracting
...
<span class="hljs-meta">&gt;&gt;&gt; </span>transcription = processor.batch_decode(generated_ids)`}}),{c(){m=a("meta"),w=d(),f=a("h1"),b=a("a"),z=a("span"),u(k.$$.fragment),y=d(),E=a("span"),C=n("Speech2Text"),$=d(),M=a("h2"),L=a("a"),qo=a("span"),u(Ue.$$.fragment),Es=d(),Po=a("span"),qs=n("Overview"),qn=d(),O=a("p"),Ps=n("The Speech2Text model was proposed in "),Be=a("a"),js=n("fairseq S2T: Fast Speech-to-Text Modeling with fairseq"),Fs=n(` by Changhan Wang, Yun Tang, Xutai Ma, Anne Wu, Dmytro Okhonko, Juan Pino. It\u2019s a
...
subclass. Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to
general usage and behavior.`),pc=d(),U=a("div"),u(Ut.$$.fragment),hc=d(),Te=a("p"),mc=n("The "),To=a("a"),fc=n("Speech2TextForConditionalGeneration"),uc=n(" forward method, overrides the "),yn=a("code"),_c=n("__call__"),gc=n(" special method."),vc=d(),u(Oe.$$.fragment),Tc=d(),Sn=a("p"),xc=n("Example:"),kc=d(),u(Bt.$$.fragment),this.h()},l(t){const p=ml('[data-svelte="svelte-1phssyn"]',document.head);m=r(p,"META",{name:!0,content:!0}),p.forEach(o),w=l(t),f=r(t,"H1",{class:!0});var Ht=i(f);b=r(Ht,"A",{id:!0,class:!0,href:!0});var wn=i(b);z=r(wn,"SPAN",{});var $n=i(z);_(k.$$.fragment,$n),$n.forEach(o),wn.forEach(o),y=l(Ht),E=r(Ht,"SPAN",{});var zn=i(E);C=s(zn,"Speech2Text"),zn.forEach(o),Ht.forEach(o),$=l(t),M=r(t,"H2",{class:!0});var Zn=i(M);L=r(Zn,"A",{id:!0,class:!0,href:!0});var $c=i(L);qo=r($c,"SPAN",{});var zc=i(qo);_(Ue.$$.fragment,zc),zc.forEach(o),$c.forEach(o),Es=l(Zn),Po=r(Zn,"SPAN",{});var Ec=i(Po);qs=s(Ec,"Overview"),Ec.forEach(o),Zn.forEach(o),qn=l(t),O=r(t,"P",{});var oe=i(O);Ps=s(oe,"The Speech2Text model was proposed in "),Be=r(oe,"A",{href:!0,rel:!0});var qc=i(Be);js=s(qc,"fairseq S2T: Fast Speech-to-Text Modeling with fairseq"),qc.forEach(o),Fs=s(oe,` by Changhan Wang, Yun Tang, Xutai Ma, Anne Wu, Dmytro Okhonko, Juan Pino. It\u2019s a
transformer-based seq2seq (encoder-decoder) model designed for end-to-end Automatic Speech Recognition (ASR) and Speech
Translation (ST). It uses a convolutional downsampler to reduce the length of speech inputs by 3/4th before they are
fed into the encoder. The model is trained with standard autoregressive cross-entropy loss and generates the
transcripts/translations autoregressively. Speech2Text has been fine-tuned on several datasets for ASR and ST:
...
the above two methods for more information.`),Ge.forEach(o),fs.forEach(o),ii=l(j),ee=r(j,"DIV",{class:!0});var So=i(ee);_(St.$$.fragment,So),ci=l(So),wt=r(So,"P",{});var us=i(wt);di=s(us,"Instantiate a "),ho=r(us,"A",{href:!0});var Wd=i(ho);li=s(Wd,"Speech2TextProcessor"),Wd.forEach(o),pi=s(us," from a pretrained Speech2Text processor."),us.forEach(o),hi=l(So),_(Fe.$$.fragment,So),So.forEach(o),mi=l(j),te=r(j,"DIV",{class:!0});var wo=i(te);_($t.$$.fragment,wo),fi=l(wo),ue=r(wo,"P",{});var $o=i(ue);ui=s($o,`Save a Speech2Text feature extractor object and Speech2Text tokenizer object to the directory
`),un=r($o,"CODE",{});var Vd=i(un);_i=s(Vd,"save_directory"),Vd.forEach(o),gi=s($o,`, so that it can be re-loaded using the
`),mo=r($o,"A",{href:!0});var Ud=i(mo);vi=s(Ud,"from_pretrained()"),Ud.forEach(o),Ti=s($o," class method."),$o.forEach(o),xi=l(wo),_(Ce.$$.fragment,wo),wo.forEach(o),ki=l(j),Me=r(j,"DIV",{class:!0});var _s=i(Me);_(zt.$$.fragment,_s),bi=l(_s),Et=r(_s,"P",{});var gs=i(Et);yi=s(gs,`This method forwards all its arguments to Speech2TextTokenizer\u2019s
