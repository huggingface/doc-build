import{S as Oi,i as Ii,s as Li,e as a,k as l,w as k,t as s,M as Ni,c as r,d as t,m as d,a as i,x as $,h as n,b as c,F as e,g as u,y as H,q as C,o as E,B as j}from"../../chunks/vendor-68651a14.js";import{T as uo}from"../../chunks/Tip-3fbaa85f.js";import{D as ze}from"../../chunks/Docstring-d699e906.js";import{C as zo}from"../../chunks/CodeBlock-b98730f5.js";import{I as Tt}from"../../chunks/IconCopyLink-8ff17449.js";import"../../chunks/CopyButton-e88c769b.js";function Wi(A){let p,T,f,g,v;return{c(){p=a("p"),T=s(`Although the recipe for forward pass needs to be defined within this function, one should call the
...
processing steps while the latter silently ignores them.`)},l(b){p=r(b,"P",{});var _=i(p);T=n(_,`Although the recipe for forward pass needs to be defined within this function, one should call the
`),f=r(_,"CODE",{});var w=i(f);g=n(w,"Module"),w.forEach(t),v=n(_,` instance afterwards instead of this since the former takes care of running the pre and post
processing steps while the latter silently ignores them.`),_.forEach(t)},m(b,_){u(b,p,_),e(p,T),e(p,f),e(f,g),e(p,v)},d(b){b&&t(p)}}}function Vi(A){let p,T,f,g,v,b,_,w,Ee,ie,F,K,O,J,je,I,Fe,ye,D,L,G,_e,M,q,le,Q,we,de,N,Me,ke,x,xe,Y,X,be,Z,qe,ee,W,ce,te,Pe;return{c(){p=a("p"),T=s("TF 2.0 models accepts two formats as inputs:"),f=l(),g=a("ul"),v=a("li"),b=s("having all inputs as keyword arguments (like PyTorch models), or"),_=l(),w=a("li"),Ee=s("having all inputs as a list, tuple or dict in the first positional arguments."),ie=l(),F=a("p"),K=s("This second option is useful when using "),O=a("code"),J=s("tf.keras.Model.fit"),je=s(` method which currently requires having all
...
`),Y=r(se,"CODE",{});var Ae=i(Y);X=n(Ae,"model([input_values, attention_mask])"),Ae.forEach(t),be=n(se," or "),Z=r(se,"CODE",{});var P=i(Z);qe=n(P,"model([input_values, attention_mask, token_type_ids])"),P.forEach(t),se.forEach(t),ee=d(S),W=r(S,"LI",{});var ne=i(W);ce=n(ne,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),te=r(ne,"CODE",{});var Ye=i(te);Pe=n(Ye,'model({"input_values": input_values, "token_type_ids": token_type_ids})'),Ye.forEach(t),ne.forEach(t),S.forEach(t)},m(h,y){u(h,p,y),e(p,T),u(h,f,y),u(h,g,y),e(g,v),e(v,b),e(g,_),e(g,w),e(w,Ee),u(h,ie,y),u(h,F,y),e(F,K),e(F,O),e(O,J),e(F,je),e(F,I),e(I,Fe),e(F,ye),u(h,D,y),u(h,L,y),e(L,G),u(h,_e,y),u(h,M,y),e(M,q),e(q,le),e(q,Q),e(Q,we),e(q,de),e(q,N),e(N,Me),e(M,ke),e(M,x),e(x,xe),e(x,Y),e(Y,X),e(x,be),e(x,Z),e(Z,qe),e(M,ee),e(M,W),e(W,ce),e(W,te),e(te,Pe)},d(h){h&&t(p),h&&t(f),h&&t(g),h&&t(ie),h&&t(F),h&&t(D),h&&t(L),h&&t(_e),h&&t(M)}}}function Ui(A){let p,T,f,g,v;return{c(){p=a("p"),T=s(`Although the recipe for forward pass needs to be defined within this function, one should call the
`),f=a("code"),g=s("Module"),v=s(` instance afterwards instead of this since the former takes care of running the pre and post
processing steps while the latter silently ignores them.`)},l(b){p=r(b,"P",{});var _=i(p);T=n(_,`Although the recipe for forward pass needs to be defined within this function, one should call the
`),f=r(_,"CODE",{});var w=i(f);g=n(w,"Module"),w.forEach(t),v=n(_,` instance afterwards instead of this since the former takes care of running the pre and post
processing steps while the latter silently ignores them.`),_.forEach(t)},m(b,_){u(b,p,_),e(p,T),e(p,f),e(f,g),e(p,v)},d(b){b&&t(p)}}}function Ki(A){let p,T,f,g,v,b,_,w,Ee,ie,F,K,O,J,je,I,Fe,ye,D,L,G,_e,M,q,le,Q,we,de,N,Me,ke,x,xe,Y,X,be,Z,qe,ee,W,ce,te,Pe;return{c(){p=a("p"),T=s("TF 2.0 models accepts two formats as inputs:"),f=l(),g=a("ul"),v=a("li"),b=s("having all inputs as keyword arguments (like PyTorch models), or"),_=l(),w=a("li"),Ee=s("having all inputs as a list, tuple or dict in the first positional arguments."),ie=l(),F=a("p"),K=s("This second option is useful when using "),O=a("code"),J=s("tf.keras.Model.fit"),je=s(` method which currently requires having all
the tensors in the first argument of the model call function: `),I=a("code"),Fe=s("model(inputs)"),ye=s("."),D=l(),L=a("p"),G=s(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in
the first positional argument :`),_e=l(),M=a("ul"),q=a("li"),le=s("a single Tensor with "),Q=a("code"),we=s("input_values"),de=s(" only and nothing else: "),N=a("code"),Me=s("model(inputs_ids)"),ke=l(),x=a("li"),xe=s(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),Y=a("code"),X=s("model([input_values, attention_mask])"),be=s(" or "),Z=a("code"),qe=s("model([input_values, attention_mask, token_type_ids])"),ee=l(),W=a("li"),ce=s(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),te=a("code"),Pe=s('model({"input_values": input_values, "token_type_ids": token_type_ids})')},l(h){p=r(h,"P",{});var y=i(p);T=n(y,"TF 2.0 models accepts two formats as inputs:"),y.forEach(t),f=d(h),g=r(h,"UL",{});var ve=i(g);v=r(ve,"LI",{});var Te=i(v);b=n(Te,"having all inputs as keyword arguments (like PyTorch models), or"),Te.forEach(t),_=d(ve),w=r(ve,"LI",{});var Ue=i(w);Ee=n(Ue,"having all inputs as a list, tuple or dict in the first positional arguments."),Ue.forEach(t),ve.forEach(t),ie=d(h),F=r(h,"P",{});var B=i(F);K=n(B,"This second option is useful when using "),O=r(B,"CODE",{});var De=i(O);J=n(De,"tf.keras.Model.fit"),De.forEach(t),je=n(B,` method which currently requires having all
...
processing steps while the latter silently ignores them.`)},l(b){p=r(b,"P",{});var _=i(p);T=n(_,`Although the recipe for forward pass needs to be defined within this function, one should call the
`),f=r(_,"CODE",{});var w=i(f);g=n(w,"Module"),w.forEach(t),v=n(_,` instance afterwards instead of this since the former takes care of running the pre and post
processing steps while the latter silently ignores them.`),_.forEach(t)},m(b,_){u(b,p,_),e(p,T),e(p,f),e(f,g),e(p,v)},d(b){b&&t(p)}}}function Xi(A){let p,T,f,g,v,b,_,w,Ee,ie,F,K,O,J,je,I,Fe,ye,D,L,G,_e,M,q,le,Q,we,de,N,Me,ke,x,xe,Y,X,be,Z,qe,ee,W,ce,te,Pe,h,y,ve,Te,Ue,B,De,oe,pe,S,z,Ke,Se,se,Ae,P,ne,Ye,Xe,Us,mo,Ks,Ys,yt,Xs,Js,Gs,Je,Qs,fo,Zs,en,go,tn,on,sn,Do,nn,an,wt,hs,Ge,lt,Ao,kt,rn,Oo,ln,us,ae,$t,dn,Ht,cn,Ct,pn,hn,un,Et,mn,_o,fn,gn,_n,jt,bn,Ft,vn,Tn,yn,he,Mt,wn,Qe,kn,bo,$n,Hn,Io,Cn,En,jn,dt,Fn,Lo,Mn,xn,xt,ms,Ze,ct,No,qt,qn,Wo,Pn,fs,re,Pt,Sn,et,zn,Bo,Dn,An,St,On,In,Ln,zt,Nn,vo,Wn,Bn,Rn,Dt,Vn,At,Un,Kn,Yn,ue,Ot,Xn,tt,Jn,To,Gn,Qn,Ro,Zn,ea,ta,pt,oa,Vo,sa,na,It,gs,ot,ht,Uo,Lt,aa,Ko,ra,_s,R,Nt,ia,Yo,la,da,Wt,ca,Bt,pa,ha,ua,Rt,ma,yo,fa,ga,_a,Vt,ba,Ut,va,Ta,ya,me,Kt,wa,st,ka,wo,$a,Ha,Xo,Ca,Ea,ja,ut,Fa,Jo,Ma,xa,Yt,bs,nt,mt,Go,Xt,qa,Qo,Pa,vs,V,Jt,Sa,Zo,za,Da,Gt,Aa,ko,Oa,Ia,La,Qt,Na,Zt,Wa,Ba,Ra,ft,Va,fe,eo,Ua,at,Ka,$o,Ya,Xa,es,Ja,Ga,Qa,gt,Za,ts,er,tr,to,Ts,rt,_t,os,oo,or,ss,sr,ys,U,so,nr,no,ar,ns,rr,ir,lr,ao,dr,Ho,cr,pr,hr,ro,ur,io,mr,fr,gr,bt,_r,ge,lo,br,it,vr,Co,Tr,yr,as,wr,kr,$r,vt,Hr,rs,Cr,Er,co,ws;return b=new Tt({}),J=new Tt({}),z=new Tt({}),ne=new ze({props:{name:"class transformers.HubertConfig",anchor:"transformers.HubertConfig",parameters:[{name:"vocab_size",val:" = 32"},{name:"hidden_size",val:" = 768"},{name:"num_hidden_layers",val:" = 12"},{name:"num_attention_heads",val:" = 12"},{name:"intermediate_size",val:" = 3072"},{name:"hidden_act",val:" = 'gelu'"},{name:"hidden_dropout",val:" = 0.1"},{name:"activation_dropout",val:" = 0.1"},{name:"attention_dropout",val:" = 0.1"},{name:"feat_proj_layer_norm",val:" = True"},{name:"feat_proj_dropout",val:" = 0.0"},{name:"final_dropout",val:" = 0.1"},{name:"layerdrop",val:" = 0.1"},{name:"initializer_range",val:" = 0.02"},{name:"layer_norm_eps",val:" = 1e-05"},{name:"feat_extract_norm",val:" = 'group'"},{name:"feat_extract_activation",val:" = 'gelu'"},{name:"conv_dim",val:" = (512, 512, 512, 512, 512, 512, 512)"},{name:"conv_stride",val:" = (5, 2, 2, 2, 2, 2, 2)"},{name:"conv_kernel",val:" = (10, 3, 3, 3, 3, 2, 2)"},{name:"conv_bias",val:" = False"},{name:"num_conv_pos_embeddings",val:" = 128"},{name:"num_conv_pos_embedding_groups",val:" = 16"},{name:"do_stable_layer_norm",val:" = False"},{name:"apply_spec_augment",val:" = True"},{name:"mask_time_prob",val:" = 0.05"},{name:"mask_time_length",val:" = 10"},{name:"mask_time_min_masks",val:" = 2"},{name:"mask_feature_prob",val:" = 0.0"},{name:"mask_feature_length",val:" = 10"},{name:"mask_feature_min_masks",val:" = 0"},{name:"ctc_loss_reduction",val:" = 'sum'"},{name:"ctc_zero_infinity",val:" = False"},{name:"use_weighted_layer_sum",val:" = False"},{name:"classifier_proj_size",val:" = 256"},{name:"pad_token_id",val:" = 0"},{name:"bos_token_id",val:" = 1"},{name:"eos_token_id",val:" = 2"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/master/src/transformers/models/hubert/configuration_hubert.py#L29",parametersDescription:[{anchor:"transformers.HubertConfig.vocab_size",description:`<strong>vocab_size</strong> (<code>int</code>, <em>optional</em>, defaults to 32) &#x2014;
Vocabulary size of the Hubert model. Defines the number of different tokens that can be represented by the
<code>inputs_ids</code> passed when calling <a href="/docs/transformers/master/en/model_doc/hubert#transformers.HubertModel">HubertModel</a>. Vocabulary size of the model.
Defines the different tokens that can be represented by the <em>inputs_ids</em> passed to the forward method of
<a href="/docs/transformers/master/en/model_doc/hubert#transformers.HubertModel">HubertModel</a>.`,name:"vocab_size"},{anchor:"transformers.HubertConfig.hidden_size",description:`<strong>hidden_size</strong> (<code>int</code>, <em>optional</em>, defaults to 768) &#x2014;
...
instance of <a href="/docs/transformers/master/en/model_doc/hubert#transformers.HubertForCTC">HubertForCTC</a>.`,name:"ctc_zero_infinity"},{anchor:"transformers.HubertConfig.use_weighted_layer_sum",description:`<strong>use_weighted_layer_sum</strong> (<code>bool</code>, <em>optional</em>, defaults to <code>False</code>) &#x2014;
...
<span class="hljs-meta">&gt;&gt;&gt; </span>loss = model(input_values, labels=labels).loss`}}),{c(){p=a("meta"),T=l(),f=a("h1"),g=a("a"),v=a("span"),k(b.$$.fragment),_=l(),w=a("span"),Ee=s("Hubert"),ie=l(),F=a("h2"),K=a("a"),O=a("span"),k(J.$$.fragment),je=l(),I=a("span"),Fe=s("Overview"),ye=l(),D=a("p"),L=s("Hubert was proposed in "),G=a("a"),_e=s("HuBERT: Self-Supervised Speech Representation Learning by Masked Prediction of Hidden Units"),M=s(` by Wei-Ning Hsu, Benjamin Bolte, Yao-Hung Hubert Tsai, Kushal Lakhotia, Ruslan
...
reduction on the more challenging dev-other and test-other evaluation subsets.`),ke=l(),x=a("p"),xe=s("Tips:"),Y=l(),X=a("ul"),be=a("li"),Z=s("Hubert is a speech model that accepts a float array corresponding to the raw waveform of the speech signal."),qe=l(),ee=a("li"),W=s(`Hubert model was fine-tuned using connectionist temporal classification (CTC) so the model output has to be decoded
using `),ce=a("a"),te=s("Wav2Vec2CTCTokenizer"),Pe=s("."),h=l(),y=a("p"),ve=s("This model was contributed by "),Te=a("a"),Ue=s("patrickvonplaten"),B=s("."),De=l(),oe=a("h2"),pe=a("a"),S=a("span"),k(z.$$.fragment),Ke=l(),Se=a("span"),se=s("HubertConfig"),Ae=l(),P=a("div"),k(ne.$$.fragment),Ye=l(),Xe=a("p"),Us=s("This is the configuration class to store the configuration of a "),mo=a("a"),Ks=s("HubertModel"),Ys=s(`. It is used to
...
`),yt=a("a"),Xs=s("facebook/hubert-base-ls960"),Js=s(" architecture."),Gs=l(),Je=a("p"),Qs=s("Configuration objects inherit from "),fo=a("a"),Zs=s("PretrainedConfig"),en=s(` and can be used to control the model
...
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),ya=l(),me=a("div"),k(Kt.$$.fragment),wa=l(),st=a("p"),ka=s("The "),wo=a("a"),$a=s("HubertForSequenceClassification"),Ha=s(" forward method, overrides the "),Xo=a("code"),Ca=s("__call__"),Ea=s(" special method."),ja=l(),k(ut.$$.fragment),Fa=l(),Jo=a("p"),Ma=s("Example:"),xa=l(),k(Yt.$$.fragment),bs=l(),nt=a("h2"),mt=a("a"),Go=a("span"),k(Xt.$$.fragment),qa=l(),Qo=a("span"),Pa=s("TFHubertModel"),vs=l(),V=a("div"),k(Jt.$$.fragment),Sa=l(),Zo=a("p"),za=s("The bare TFHubert Model transformer outputing raw hidden-states without any specific head on top."),Da=l(),Gt=a("p"),Aa=s("This model inherits from "),ko=a("a"),Oa=s("TFPreTrainedModel"),Ia=s(`. Check the superclass documentation for the
...
Ruslan Salakhutdinov, Abdelrahman Mohamed.`),Fs.forEach(t),un=d(Ie),Et=r(Ie,"P",{});var Ms=i(Et);mn=n(Ms,"This model inherits from "),_o=r(Ms,"A",{href:!0});var Xr=i(_o);fn=n(Xr,"PreTrainedModel"),Xr.forEach(t),gn=n(Ms,`. Check the superclass documentation for the generic
methods the library implements for all its model (such as downloading or saving etc.).`),Ms.forEach(t),_n=d(Ie),jt=r(Ie,"P",{});var xs=i(jt);bn=n(xs,"This model is a PyTorch "),Ft=r(xs,"A",{href:!0,rel:!0});var Jr=i(Ft);vn=n(Jr,"torch.nn.Module"),Jr.forEach(t),Tn=n(xs,` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
...
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),Os.forEach(t),ya=d($e),me=r($e,"DIV",{class:!0});var Be=i(me);$(Kt.$$.fragment,Be),wa=d(Be),st=r(Be,"P",{});var qo=i(st);ka=n(qo,"The "),wo=r(qo,"A",{href:!0});var _i=i(wo);$a=n(_i,"HubertForSequenceClassification"),_i.forEach(t),Ha=n(qo," forward method, overrides the "),Xo=r(qo,"CODE",{});var bi=i(Xo);Ca=n(bi,"__call__"),bi.forEach(t),Ea=n(qo," special method."),qo.forEach(t),ja=d(Be),$(ut.$$.fragment,Be),Fa=d(Be),Jo=r(Be,"P",{});var vi=i(Jo);Ma=n(vi,"Example:"),vi.forEach(t),xa=d(Be),$(Yt.$$.fragment,Be),Be.forEach(t),$e.forEach(t),bs=d(o),nt=r(o,"H2",{class:!0});var Is=i(nt);mt=r(Is,"A",{id:!0,class:!0,href:!0});var Ti=i(mt);Go=r(Ti,"SPAN",{});var yi=i(Go);$(Xt.$$.fragment,yi),yi.forEach(t),Ti.forEach(t),qa=d(Is),Qo=r(Is,"SPAN",{});var wi=i(Qo);Pa=n(wi,"TFHubertModel"),wi.forEach(t),Is.forEach(t),vs=d(o),V=r(o,"DIV",{class:!0});var He=i(V);$(Jt.$$.fragment,He),Sa=d(He),Zo=r(He,"P",{});var ki=i(Zo);za=n(ki,"The bare TFHubert Model transformer outputing raw hidden-states without any specific head on top."),ki.forEach(t),Da=d(He),Gt=r(He,"P",{});var Ls=i(Gt);Aa=n(Ls,"This model inherits from "),ko=r(Ls,"A",{href:!0});var $i=i(ko);Oa=n($i,"TFPreTrainedModel"),$i.forEach(t),Ia=n(Ls,`. Check the superclass documentation for the
generic methods the library implements for all its model (such as downloading or saving, resizing the input
...
it as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage
and behavior.`),Vs.forEach(t),gr=d(Ce),$(bt.$$.fragment,Ce),_r=d(Ce),ge=r(Ce,"DIV",{class:!0});var Ve=i(ge);$(lo.$$.fragment,Ve),br=d(Ve),it=r(Ve,"P",{});var So=i(it);vr=n(So,"The "),Co=r(So,"A",{href:!0});var zi=i(Co);Tr=n(zi,"TFHubertForCTC"),zi.forEach(t),yr=n(So," forward method, overrides the "),as=r(So,"CODE",{});var Di=i(as);wr=n(Di,"__call__"),Di.forEach(t),kr=n(So," special method."),So.forEach(t),$r=d(Ve),$(vt.$$.fragment,Ve),Hr=d(Ve),rs=r(Ve,"P",{});var Ai=i(rs);Cr=n(Ai,"Example:"),Ai.forEach(t),Er=d(Ve),$(co.$$.fragment,Ve),Ve.forEach(t),Ce.forEach(t),this.h()},h(){c(p,"name","hf:doc:metadata"),c(p,"content",JSON.stringify(Ji)),c(g,"id","hubert"),c(g,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(g,"href","#hubert"),c(f,"class","relative group"),c(K,"id","overview"),c(K,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(K,"href","#overview"),c(F,"class","relative group"),c(G,"href","https://arxiv.org/abs/2106.07447"),c(G,"rel","nofollow"),c(ce,"href","/docs/transformers/master/en/model_doc/wav2vec2#transformers.Wav2Vec2CTCTokenizer"),c(Te,"href","https://huggingface.co/patrickvonplaten"),c(Te,"rel","nofollow"),c(pe,"id","transformers.HubertConfig"),c(pe,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(pe,"href","#transformers.HubertConfig"),c(oe,"class","relative group"),c(mo,"href","/docs/transformers/master/en/model_doc/hubert#transformers.HubertModel"),c(yt,"href","https://huggingface.co/facebook/hubert-base-ls960"),c(yt,"rel","nofollow"),c(fo,"href","/docs/transformers/master/en/main_classes/configuration#transformers.PretrainedConfig"),c(go,"href","/docs/transformers/master/en/main_classes/configuration#transformers.PretrainedConfig"),c(P,"class","docstring"),c(lt,"id","transformers.HubertModel"),c(lt,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(lt,"href","#transformers.HubertModel"),c(Ge,"class","relative group"),c(Ct,"href","https://arxiv.org/abs/2106.07447"),c(Ct,"rel","nofollow"),c(_o,"href","/docs/transformers/master/en/main_classes/model#transformers.PreTrainedModel"),c(Ft,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),c(Ft,"rel","nofollow"),c(bo,"href","/docs/transformers/master/en/model_doc/hubert#transformers.HubertModel"),c(he,"class","docstring"),c(ae,"class","docstring"),c(ct,"id","transformers.HubertForCTC"),c(ct,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(ct,"href","#transformers.HubertForCTC"),c(Ze,"class","relative group"),c(St,"href","https://arxiv.org/abs/2106.07447"),c(St,"rel","nofollow"),c(vo,"href","/docs/transformers/master/en/main_classes/model#transformers.PreTrainedModel"),c(At,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),c(At,"rel","nofollow"),c(To,"href","/docs/transformers/master/en/model_doc/hubert#transformers.HubertForCTC"),c(ue,"class","docstring"),c(re,"class","docstring"),c(ht,"id","transformers.HubertForSequenceClassification"),c(ht,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(ht,"href","#transformers.HubertForSequenceClassification"),c(ot,"class","relative group"),c(Bt,"href","https://arxiv.org/abs/2106.07447"),c(Bt,"rel","nofollow"),c(yo,"href","/docs/transformers/master/en/main_classes/model#transformers.PreTrainedModel"),c(Ut,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),c(Ut,"rel","nofollow"),c(wo,"href","/docs/transformers/master/en/model_doc/hubert#transformers.HubertForSequenceClassification"),c(me,"class","docstring"),c(R,"class","docstring"),c(mt,"id","transformers.TFHubertModel"),c(mt,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(mt,"href","#transformers.TFHubertModel"),c(nt,"class","relative group"),c(ko,"href","/docs/transformers/master/en/main_classes/model#transformers.TFPreTrainedModel"),c(Zt,"href","https://www.tensorflow.org/api_docs/python/tf/keras/Model"),c(Zt,"rel","nofollow"),c($o,"href","/docs/transformers/master/en/model_doc/hubert#transformers.TFHubertModel"),c(fe,"class","docstring"),c(V,"class","docstring"),c(_t,"id","transformers.TFHubertForCTC"),c(_t,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(_t,"href","#transformers.TFHubertForCTC"),c(rt,"class","relative group"),c(Ho,"href","/docs/transformers/master/en/main_classes/model#transformers.TFPreTrainedModel"),c(io,"href","https://www.tensorflow.org/api_docs/python/tf/keras/Model"),c(io,"rel","nofollow"),c(Co,"href","/docs/transformers/master/en/model_doc/hubert#transformers.TFHubertForCTC"),c(ge,"class","docstring"),c(U,"class","docstring")},m(o,m){e(document.head,p),u(o,T,m),u(o,f,m),e(f,g),e(g,v),H(b,v,null),e(f,_),e(f,w),e(w,Ee),u(o,ie,m),u(o,F,m),e(F,K),e(K,O),H(J,O,null),e(F,je),e(F,I),e(I,Fe),u(o,ye,m),u(o,D,m),e(D,L),e(D,G),e(G,_e),e(D,M),u(o,q,m),u(o,le,m),e(le,Q),u(o,we,m),u(o,de,m),e(de,N),e(N,Me),u(o,ke,m),u(o,x,m),e(x,xe),u(o,Y,m),u(o,X,m),e(X,be),e(be,Z),e(X,qe),e(X,ee),e(ee,W),e(ee,ce),e(ce,te),e(ee,Pe),u(o,h,m),u(o,y,m),e(y,ve),e(y,Te),e(Te,Ue),e(y,B),u(o,De,m),u(o,oe,m),e(oe,pe),e(pe,S),H(z,S,null),e(oe,Ke),e(oe,Se),e(Se,se),u(o,Ae,m),u(o,P,m),H(ne,P,null),e(P,Ye),e(P,Xe),e(Xe,Us),e(Xe,mo),e(mo,Ks),e(Xe,Ys),e(Xe,yt),e(yt,Xs),e(Xe,Js),e(P,Gs),e(P,Je),e(Je,Qs),e(Je,fo),e(fo,Zs),e(Je,en),e(Je,go),e(go,tn),e(Je,on),e(P,sn),e(P,Do),e(Do,nn),e(P,an),H(wt,P,null),u(o,hs,m),u(o,Ge,m),e(Ge,lt),e(lt,Ao),H(kt,Ao,null),e(Ge,rn),e(Ge,Oo),e(Oo,ln),u(o,us,m),u(o,ae,m),H($t,ae,null),e(ae,dn),e(ae,Ht),e(Ht,cn),e(Ht,Ct),e(Ct,pn),e(Ht,hn),e(ae,un),e(ae,Et),e(Et,mn),e(Et,_o),e(_o,fn),e(Et,gn),e(ae,_n),e(ae,jt),e(jt,bn),e(jt,Ft),e(Ft,vn),e(jt,Tn),e(ae,yn),e(ae,he),H(Mt,he,null),e(he,wn),e(he,Qe),e(Qe,kn),e(Qe,bo),e(bo,$n),e(Qe,Hn),e(Qe,Io),e(Io,Cn),e(Qe,En),e(he,jn),H(dt,he,null),e(he,Fn),e(he,Lo),e(Lo,Mn),e(he,xn),H(xt,he,null),u(o,ms,m),u(o,Ze,m),e(Ze,ct),e(ct,No),H(qt,No,null),e(Ze,qn),e(Ze,Wo),e(Wo,Pn),u(o,fs,m),u(o,re,m),H(Pt,re,null),e(re,Sn),e(re,et),e(et,zn),e(et,Bo),e(Bo,Dn),e(et,An),e(et,St),e(St,On),e(et,In),e(re,Ln),e(re,zt),e(zt,Nn),e(zt,vo),e(vo,Wn),e(zt,Bn),e(re,Rn),e(re,Dt),e(Dt,Vn),e(Dt,At),e(At,Un),e(Dt,Kn),e(re,Yn),e(re,ue),H(Ot,ue,null),e(ue,Xn),e(ue,tt),e(tt,Jn),e(tt,To),e(To,Gn),e(tt,Qn),e(tt,Ro),e(Ro,Zn),e(tt,ea),e(ue,ta),H(pt,ue,null),e(ue,oa),e(ue,Vo),e(Vo,sa),e(ue,na),H(It,ue,null),u(o,gs,m),u(o,ot,m),e(ot,ht),e(ht,Uo),H(Lt,Uo,null),e(ot,aa),e(ot,Ko),e(Ko,ra),u(o,_s,m),u(o,R,m),H(Nt,R,null),e(R,ia),e(R,Yo),e(Yo,la),e(R,da),e(R,Wt),e(Wt,ca),e(Wt,Bt),e(Bt,pa),e(Wt,ha),e(R,ua),e(R,Rt),e(Rt,ma),e(Rt,yo),e(yo,fa),e(Rt,ga),e(R,_a),e(R,Vt),e(Vt,ba),e(Vt,Ut),e(Ut,va),e(Vt,Ta),e(R,ya),e(R,me),H(Kt,me,null),e(me,wa),e(me,st),e(st,ka),e(st,wo),e(wo,$a),e(st,Ha),e(st,Xo),e(Xo,Ca),e(st,Ea),e(me,ja),H(ut,me,null),e(me,Fa),e(me,Jo),e(Jo,Ma),e(me,xa),H(Yt,me,null),u(o,bs,m),u(o,nt,m),e(nt,mt),e(mt,Go),H(Xt,Go,null),e(nt,qa),e(nt,Qo),e(Qo,Pa),u(o,vs,m),u(o,V,m),H(Jt,V,null),e(V,Sa),e(V,Zo),e(Zo,za),e(V,Da),e(V,Gt),e(Gt,Aa),e(Gt,ko),e(ko,Oa),e(Gt,Ia),e(V,La),e(V,Qt),e(Qt,Na),e(Qt,Zt),e(Zt,Wa),e(Qt,Ba),e(V,Ra),H(ft,V,null),e(V,Va),e(V,fe),H(eo,fe,null),e(fe,Ua),e(fe,at),e(at,Ka),e(at,$o),e($o,Ya),e(at,Xa),e(at,es),e(es,Ja),e(at,Ga),e(fe,Qa),H(gt,fe,null),e(fe,Za),e(fe,ts),e(ts,er),e(fe,tr),H(to,fe,null),u(o,Ts,m),u(o,rt,m),e(rt,_t),e(_t,os),H(oo,os,null),e(rt,or),e(rt,ss),e(ss,sr),u(o,ys,m),u(o,U,m),H(so,U,null),e(U,nr),e(U,no),e(no,ar),e(no,ns),e(ns,rr),e(no,ir),e(U,lr),e(U,ao),e(ao,dr),e(ao,Ho),e(Ho,cr),e(ao,pr),e(U,hr),e(U,ro),e(ro,ur),e(ro,io),e(io,mr),e(ro,fr),e(U,gr),H(bt,U,null),e(U,_r),e(U,ge),H(lo,ge,null),e(ge,br),e(ge,it),e(it,vr),e(it,Co),e(Co,Tr),e(it,yr),e(it,as),e(as,wr),e(it,kr),e(ge,$r),H(vt,ge,null),e(ge,Hr),e(ge,rs),e(rs,Cr),e(ge,Er),H(co,ge,null),ws=!0},p(o,[m]){const po={};m&2&&(po.$$scope={dirty:m,ctx:o}),dt.$set(po);const is={};m&2&&(is.$$scope={dirty:m,ctx:o}),pt.$set(is);const ls={};m&2&&(ls.$$scope={dirty:m,ctx:o}),ut.$set(ls);const ds={};m&2&&(ds.$$scope={dirty:m,ctx:o}),ft.$set(ds);const ho={};m&2&&(ho.$$scope={dirty:m,ctx:o}),gt.$set(ho);const cs={};m&2&&(cs.$$scope={dirty:m,ctx:o}),bt.$set(cs);const ps={};m&2&&(ps.$$scope={dirty:m,ctx:o}),vt.$set(ps)},i(o){ws||(C(b.$$.fragment,o),C(J.$$.fragment,o),C(z.$$.fragment,o),C(ne.$$.fragment,o),C(wt.$$.fragment,o),C(kt.$$.fragment,o),C($t.$$.fragment,o),C(Mt.$$.fragment,o),C(dt.$$.fragment,o),C(xt.$$.fragment,o),C(qt.$$.fragment,o),C(Pt.$$.fragment,o),C(Ot.$$.fragment,o),C(pt.$$.fragment,o),C(It.$$.fragment,o),C(Lt.$$.fragment,o),C(Nt.$$.fragment,o),C(Kt.$$.fragment,o),C(ut.$$.fragment,o),C(Yt.$$.fragment,o),C(Xt.$$.fragment,o),C(Jt.$$.fragment,o),C(ft.$$.fragment,o),C(eo.$$.fragment,o),C(gt.$$.fragment,o),C(to.$$.fragment,o),C(oo.$$.fragment,o),C(so.$$.fragment,o),C(bt.$$.fragment,o),C(lo.$$.fragment,o),C(vt.$$.fragment,o),C(co.$$.fragment,o),ws=!0)},o(o){E(b.$$.fragment,o),E(J.$$.fragment,o),E(z.$$.fragment,o),E(ne.$$.fragment,o),E(wt.$$.fragment,o),E(kt.$$.fragment,o),E($t.$$.fragment,o),E(Mt.$$.fragment,o),E(dt.$$.fragment,o),E(xt.$$.fragment,o),E(qt.$$.fragment,o),E(Pt.$$.fragment,o),E(Ot.$$.fragment,o),E(pt.$$.fragment,o),E(It.$$.fragment,o),E(Lt.$$.fragment,o),E(Nt.$$.fragment,o),E(Kt.$$.fragment,o),E(ut.$$.fragment,o),E(Yt.$$.fragment,o),E(Xt.$$.fragment,o),E(Jt.$$.fragment,o),E(ft.$$.fragment,o),E(eo.$$.fragment,o),E(gt.$$.fragment,o),E(to.$$.fragment,o),E(oo.$$.fragment,o),E(so.$$.fragment,o),E(bt.$$.fragment,o),E(lo.$$.fragment,o),E(vt.$$.fragment,o),E(co.$$.fragment,o),ws=!1},d(o){t(p),o&&t(T),o&&t(f),j(b),o&&t(ie),o&&t(F),j(J),o&&t(ye),o&&t(D),o&&t(q),o&&t(le),o&&t(we),o&&t(de),o&&t(ke),o&&t(x),o&&t(Y),o&&t(X),o&&t(h),o&&t(y),o&&t(De),o&&t(oe),j(z),o&&t(Ae),o&&t(P),j(ne),j(wt),o&&t(hs),o&&t(Ge),j(kt),o&&t(us),o&&t(ae),j($t),j(Mt),j(dt),j(xt),o&&t(ms),o&&t(Ze),j(qt),o&&t(fs),o&&t(re),j(Pt),j(Ot),j(pt),j(It),o&&t(gs),o&&t(ot),j(Lt),o&&t(_s),o&&t(R),j(Nt),j(Kt),j(ut),j(Yt),o&&t(bs),o&&t(nt),j(Xt),o&&t(vs),o&&t(V),j(Jt),j(ft),j(eo),j(gt),j(to),o&&t(Ts),o&&t(rt),j(oo),o&&t(ys),o&&t(U),j(so),j(bt),j(lo),j(vt),j(co)}}}const Ji={local:"hubert",sections:[{local:"overview",title:"Overview"},{local:"transformers.HubertConfig",title:"HubertConfig"},{local:"transformers.HubertModel",title:"HubertModel"},{local:"transformers.HubertForCTC",title:"HubertForCTC"},{local:"transformers.HubertForSequenceClassification",title:"HubertForSequenceClassification"},{local:"transformers.TFHubertModel",title:"TFHubertModel"},{local:"transformers.TFHubertForCTC",title:"TFHubertForCTC"}],title:"Hubert"};function Gi(A,p,T){let{fw:f}=p;return A.$$set=g=>{"fw"in g&&T(0,f=g.fw)},[f]}class nl extends Oi{constructor(p){super();Ii(this,p,Gi,Xi,Li,{fw:0})}}export{nl as default,Ji as metadata};
