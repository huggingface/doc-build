import{S as nv,i as rv,s as av,e as r,k as i,w as v,t,M as sv,c as a,d as n,m as l,a as s,x as b,h as o,b as c,F as e,g as m,y as E,q as y,o as k,B as T}from"../../chunks/vendor-68651a14.js";import{T as Kf}from"../../chunks/Tip-3fbaa85f.js";import{D as Z}from"../../chunks/Docstring-d699e906.js";import{C as xt}from"../../chunks/CodeBlock-b98730f5.js";import{I as Za}from"../../chunks/IconCopyLink-8ff17449.js";import"../../chunks/CopyButton-e88c769b.js";function dv(Te){let h,F,f,j,L;return{c(){h=r("p"),F=t(`Although the recipe for forward pass needs to be defined within this function, one should call the
...
processing steps while the latter silently ignores them.`)},l(M){h=a(M,"P",{});var D=s(h);F=o(D,`Although the recipe for forward pass needs to be defined within this function, one should call the
`),f=a(D,"CODE",{});var B=s(f);j=o(B,"Module"),B.forEach(n),L=o(D,` instance afterwards instead of this since the former takes care of running the pre and post
processing steps while the latter silently ignores them.`),D.forEach(n)},m(M,D){m(M,h,D),e(h,F),e(h,f),e(f,j),e(h,L)},d(M){M&&n(h)}}}function cv(Te){let h,F,f,j,L,M,D,B,Ss,Ka,Xe,Ls,zo,Os,Ns,Qa,et,Bs,zt,Us,Ws,Xa,tt,Vs,jo,Rs,Gs,es,he,Hs,$o,Ys,Js,jt,Zs,Ks,ts,me,Qs,Mn,Xs,ed,Dn,td,od,os,$t,ns,fe,nd,Pt,rd,ad,qt,sd,dd,rs,we,ot,xn,Ct,id,zn,ld,as,C,Ft,cd,nt,Po,pd,hd,qo,md,fd,ud,Me,gd,Co,_d,vd,Fo,bd,Ed,yd,jn,kd,Td,At,wd,rt,It,Md,St,Dd,Ao,xd,zd,jd,at,Lt,$d,De,Pd,$n,qd,Cd,Pn,Fd,Ad,ss,xe,st,qn,Ot,Id,Cn,Sd,ds,$,Nt,Ld,ze,Od,Fn,Nd,Bd,An,Ud,Wd,Vd,Bt,Rd,Ut,Gd,Hd,Yd,In,Jd,Zd,Wt,Kd,Io,Qd,Xd,ei,Vt,ti,Rt,oi,ni,ri,ue,So,ai,si,Sn,di,ii,Ln,li,ci,pi,U,Gt,hi,je,mi,Lo,fi,ui,On,gi,_i,vi,dt,bi,Nn,Ei,yi,Ht,ki,u,Yt,Ti,Bn,wi,Mi,$e,Di,Un,xi,zi,Wn,ji,$i,Pi,Pe,qi,Vn,Ci,Fi,Rn,Ai,Ii,Si,qe,K,Li,Gn,Oi,Ni,Hn,Bi,Ui,Yn,Wi,Vi,Ri,Q,Gi,Jn,Hi,Yi,Oo,Ji,Zi,Zn,Ki,Qi,Xi,O,el,Kn,tl,ol,Qn,nl,rl,Xn,al,sl,er,dl,il,tr,ll,cl,pl,X,hl,or,ml,fl,nr,ul,gl,rr,_l,vl,bl,Ce,ee,El,ar,yl,kl,sr,Tl,wl,dr,Ml,Dl,xl,te,zl,ir,jl,$l,No,Pl,ql,lr,Cl,Fl,Al,N,Il,cr,Sl,Ll,pr,Ol,Nl,hr,Bl,Ul,mr,Wl,Vl,fr,Rl,Gl,Hl,Fe,Yl,ur,Jl,Zl,gr,Kl,Ql,Xl,Ae,ec,_r,tc,oc,vr,nc,rc,ac,Ie,br,sc,dc,Er,ic,lc,yr,cc,pc,Jt,hc,kr,mc,fc,uc,Tr,gc,_c,Zt,is,Se,it,wr,Kt,vc,Mr,bc,ls,P,Qt,Ec,Le,yc,Dr,kc,Tc,xr,wc,Mc,Dc,Xt,xc,eo,zc,jc,$c,zr,Pc,qc,to,Cc,Bo,Fc,Ac,Ic,oo,Sc,no,Lc,Oc,Nc,ge,jr,Bc,Uc,$r,Wc,Vc,Pr,Rc,Gc,Hc,W,ro,Yc,Oe,Jc,Uo,Zc,Kc,qr,Qc,Xc,ep,lt,tp,Cr,op,np,ao,rp,g,so,ap,Fr,sp,dp,Ne,ip,Ar,lp,cp,Ir,pp,hp,mp,Be,oe,fp,Sr,up,gp,Lr,_p,vp,Or,bp,Ep,yp,ne,kp,Nr,Tp,wp,Wo,Mp,Dp,Br,xp,zp,jp,G,$p,Ur,Pp,qp,Wr,Cp,Fp,Vr,Ap,Ip,Rr,Sp,Lp,Op,re,Np,Gr,Bp,Up,Hr,Wp,Vp,Yr,Rp,Gp,Hp,Ue,ae,Yp,Jr,Jp,Zp,Zr,Kp,Qp,Kr,Xp,eh,th,se,oh,Qr,nh,rh,Vo,ah,sh,Xr,dh,ih,lh,H,ch,ea,ph,hh,ta,mh,fh,oa,uh,gh,na,_h,vh,bh,We,Eh,ra,yh,kh,aa,Th,wh,Mh,Ve,Dh,sa,xh,zh,da,jh,$h,Ph,Re,ia,qh,Ch,la,Fh,Ah,ca,Ih,Sh,io,Lh,pa,Oh,Nh,Bh,ha,Uh,Wh,lo,cs,Ge,ct,ma,co,Vh,fa,Rh,ps,q,po,Gh,He,Hh,ua,Yh,Jh,ga,Zh,Kh,Qh,ho,Xh,mo,em,tm,om,_a,nm,rm,fo,am,Ro,sm,dm,im,uo,lm,go,cm,pm,hm,_e,Go,mm,fm,va,um,gm,ba,_m,vm,bm,V,_o,Em,Ye,ym,Ho,km,Tm,Ea,wm,Mm,Dm,pt,xm,ya,zm,jm,vo,$m,_,bo,Pm,ka,qm,Cm,Je,Fm,Ta,Am,Im,wa,Sm,Lm,Om,Eo,de,Nm,Ma,Bm,Um,Da,Wm,Vm,xa,Rm,Gm,Hm,ie,Ym,za,Jm,Zm,Yo,Km,Qm,ja,Xm,ef,tf,le,of,$a,nf,rf,Pa,af,sf,qa,df,lf,cf,yo,ce,pf,Ca,hf,mf,Fa,ff,uf,Aa,gf,_f,vf,pe,bf,Ia,Ef,yf,Jo,kf,Tf,Sa,wf,Mf,Df,Ze,xf,La,zf,jf,Oa,$f,Pf,qf,Ke,Cf,Na,Ff,Af,Ba,If,Sf,Lf,Qe,Ua,Of,Nf,Wa,Bf,Uf,Va,Wf,Vf,ko,Rf,Ra,Gf,Hf,Yf,Ga,Jf,Zf,To,hs;return M=new Za({}),$t=new xt({props:{code:`# a workaround to load from pytorch checkpoint
...
<span class="hljs-meta">&gt;&gt;&gt; </span>model = EncoderDecoderModel.from_pretrained(<span class="hljs-string">&#x27;my-model&#x27;</span>, config=encoder_decoder_config)`}}),It=new Z({props:{name:"from_encoder_decoder_configs",anchor:"transformers.EncoderDecoderConfig.from_encoder_decoder_configs",parameters:[{name:"encoder_config",val:": PretrainedConfig"},{name:"decoder_config",val:": PretrainedConfig"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/master/src/transformers/models/encoder_decoder/configuration_encoder_decoder.py#L90",returnDescription:`
...
`}}),Lt=new Z({props:{name:"to_dict",anchor:"transformers.EncoderDecoderConfig.to_dict",parameters:[],source:"https://github.com/huggingface/transformers/blob/master/src/transformers/models/encoder_decoder/configuration_encoder_decoder.py#L107",returnDescription:`
...
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-comment"># generation</span>
<span class="hljs-meta">&gt;&gt;&gt; </span>generated = model.generate(input_ids, decoder_start_token_id=model.config.decoder.bos_token_id)`}}),so=new Z({props:{name:"from_encoder_decoder_pretrained",anchor:"transformers.TFEncoderDecoderModel.from_encoder_decoder_pretrained",parameters:[{name:"encoder_pretrained_model_name_or_path",val:": str = None"},{name:"decoder_pretrained_model_name_or_path",val:": str = None"},{name:"*model_args",val:""},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/master/src/transformers/models/encoder_decoder/modeling_tf_encoder_decoder.py#L300"}}),lo=new xt({props:{code:`from transformers import TFEncoderDecoderModel
...
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-keyword">assert</span> summary == <span class="hljs-string">&quot;SAS Alpha Epsilon suspended Sigma Alpha Epsilon members&quot;</span>`}}),bo=new Z({props:{name:"from_encoder_decoder_pretrained",anchor:"transformers.FlaxEncoderDecoderModel.from_encoder_decoder_pretrained",parameters:[{name:"encoder_pretrained_model_name_or_path",val:": typing.Union[str, os.PathLike, NoneType] = None"},{name:"decoder_pretrained_model_name_or_path",val:": typing.Union[str, os.PathLike, NoneType] = None"},{name:"*model_args",val:""},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/master/src/transformers/models/encoder_decoder/modeling_flax_encoder_decoder.py#L743"}}),To=new xt({props:{code:`from transformers import FlaxEncoderDecoderModel
...
any other models (see the examples for more information).`),es=i(),he=r("p"),Hs=t("An application of this architecture could be to leverage two pretrained "),$o=r("a"),Ys=t("BertModel"),Js=t(` as the encoder
...
Zhou, Wei Li, Peter J. Liu.`),Yd=i(),In=r("p"),Jd=t(`After such an Encoder Decoder model has been trained/fine-tuned, it can be saved/loaded just like any other models
...
:meth`),Ln=r("em"),li=t("~transformers.AutoModelForCausalLM.from_pretrained"),ci=t(" class method for the decoder."),pi=i(),U=r("div"),v(Gt.$$.fragment),hi=i(),je=r("p"),mi=t("The "),Lo=r("a"),fi=t("EncoderDecoderModel"),ui=t(" forward method, overrides the "),On=r("code"),gi=t("__call__"),_i=t(" special method."),vi=i(),v(dt.$$.fragment),bi=i(),Nn=r("p"),Ei=t("Examples:"),yi=i(),v(Ht.$$.fragment),ki=i(),u=r("div"),v(Yt.$$.fragment),Ti=i(),Bn=r("p"),wi=t(`Instantiate an encoder and a decoder from one or two base classes of the library from pretrained model
...
a user or organization name, like `),Yn=r("code"),Wi=t("dbmdz/bert-base-german-cased"),Vi=t("."),Ri=i(),Q=r("li"),Gi=t("A path to a "),Jn=r("em"),Hi=t("directory"),Yi=t(` containing model weights saved using
`),Oo=r("a"),Ji=t("save_pretrained()"),Zi=t(", e.g., "),Zn=r("code"),Ki=t("./my_model_directory/"),Qi=t("."),Xi=i(),O=r("li"),el=t("A path or url to a "),Kn=r("em"),tl=t("tensorflow index checkpoint file"),ol=t(" (e.g, "),Qn=r("code"),nl=t("./tf_model/model.ckpt.index"),rl=t(`). In
...
a PyTorch model using the provided conversion scripts and loading the PyTorch model afterwards.`),Hl=i(),Fe=r("p"),Yl=t("model"),ur=r("em"),Jl=t("args (remaining positional arguments, _optional"),Zl=t(`):
...
`),vr=r("code"),nc=t("output_attentions=True"),rc=t(")."),ac=i(),Ie=r("ul"),br=r("li"),sc=t("To update the encoder configuration, use the prefix _encoder__ for each configuration parameter."),dc=i(),Er=r("li"),ic=t("To update the decoder configuration, use the prefix _decoder__ for each configuration parameter."),lc=i(),yr=r("li"),cc=t("To update the parent model configuration, do not use a prefix for each configuration parameter."),pc=i(),Jt=r("p"),hc=t("Behaves differently depending on whether a "),kr=r("code"),mc=t("config"),fc=t(" is provided or automatically loaded."),uc=i(),Tr=r("p"),gc=t("Example:"),_c=i(),v(Zt.$$.fragment),is=i(),Se=r("h2"),it=r("a"),wr=r("span"),v(Kt.$$.fragment),vc=i(),Mr=r("span"),bc=t("TFEncoderDecoderModel"),ls=i(),P=r("div"),v(Qt.$$.fragment),Ec=i(),Le=r("p"),yc=t(`This class can be used to initialize a sequence-to-sequence model with any pretrained autoencoding model as the
encoder and any pretrained autoregressive model as the decoder. The encoder is loaded via
...
:meth`),Pr=r("em"),Rc=t("~transformers.TFAutoModelForCausalLM.from_pretrained"),Gc=t(" class method for the decoder."),Hc=i(),W=r("div"),v(ro.$$.fragment),Yc=i(),Oe=r("p"),Jc=t("The "),Uo=r("a"),Zc=t("TFEncoderDecoderModel"),Kc=t(" forward method, overrides the "),qr=r("code"),Qc=t("__call__"),Xc=t(" special method."),ep=i(),v(lt.$$.fragment),tp=i(),Cr=r("p"),op=t("Examples:"),np=i(),v(ao.$$.fragment),rp=i(),g=r("div"),v(so.$$.fragment),ap=i(),Fr=r("p"),sp=t(`Instantiate an encoder and a decoder from one or two base classes of the library from pretrained model
...
`),Vr=r("code"),Ap=t("encoder_from_pt"),Ip=t(" should be set to "),Rr=r("code"),Sp=t("True"),Lp=t("."),Op=i(),re=r("p"),Np=t("decoder"),Gr=r("em"),Bp=t("pretrained_model_name_or_path (:obj: _str"),Up=t(", "),Hr=r("em"),Wp=t("optional"),Vp=t(", defaults to "),Yr=r("em"),Rp=t("None"),Gp=t(`):
Information necessary to initiate the decoder. Can be either:`),Hp=i(),Ue=r("ul"),ae=r("li"),Yp=t("A string, the "),Jr=r("em"),Jp=t("model id"),Zp=t(` of a pretrained model hosted inside a model repo on huggingface.co.
...
encoder and any pretrained autoregressive model as the decoder. The encoder is loaded via
`),ua=r("code"),Yh=t("from_pretrained()"),Jh=t(` function and the decoder is loaded via
...
a user or organization name, like `),xa=r("code"),Rm=t("dbmdz/bert-base-german-cased"),Gm=t("."),Hm=i(),ie=r("li"),Ym=t("A path to a "),za=r("em"),Jm=t("directory"),Zm=t(` containing model weights saved using
`),Yo=r("a"),Km=t("save_pretrained()"),Qm=t(", e.g., "),ja=r("code"),Xm=t("./my_model_directory/"),ef=t("."),tf=i(),le=r("p"),of=t("decoder"),$a=r("em"),nf=t("pretrained_model_name_or_path (:obj: _Union[str, os.PathLike]"),rf=t(", "),Pa=r("em"),af=t("optional"),sf=t(", defaults to "),qa=r("em"),df=t("None"),lf=t(`):
...
`),Jo=r("a"),kf=t("save_pretrained()"),Tf=t(", e.g., "),Sa=r("code"),wf=t("./my_model_directory/"),Mf=t("."),Df=i(),Ze=r("p"),xf=t("model"),La=r("em"),zf=t("args (remaining positional arguments, _optional"),jf=t(`):
...
Can be used to update the configuration object (after it being loaded) and initiate the model (e.g.,
`),Ba=r("code"),If=t("output_attentions=True"),Sf=t(")."),Lf=i(),Qe=r("ul"),Ua=r("li"),Of=t("To update the encoder configuration, use the prefix _encoder__ for each configuration parameter."),Nf=i(),Wa=r("li"),Bf=t("To update the decoder configuration, use the prefix _decoder__ for each configuration parameter."),Uf=i(),Va=r("li"),Wf=t("To update the parent model configuration, do not use a prefix for each configuration parameter."),Vf=i(),ko=r("p"),Rf=t("Behaves differently depending on whether a "),Ra=r("code"),Gf=t("config"),Hf=t(" is provided or automatically loaded."),Yf=i(),Ga=r("p"),Jf=t("Example:"),Zf=i(),v(To.$$.fragment),this.h()},l(d){const p=sv('[data-svelte="svelte-1phssyn"]',document.head);h=a(p,"META",{name:!0,content:!0}),p.forEach(n),F=l(d),f=a(d,"H1",{class:!0});var wo=s(f);j=a(wo,"A",{id:!0,class:!0,href:!0});var Ha=s(j);L=a(Ha,"SPAN",{});var Ya=s(L);b(M.$$.fragment,Ya),Ya.forEach(n),Ha.forEach(n),D=l(wo),B=a(wo,"SPAN",{});var Qf=s(B);Ss=o(Qf,"Encoder Decoder Models"),Qf.forEach(n),wo.forEach(n),Ka=l(d),Xe=a(d,"P",{});var ms=s(Xe);Ls=o(ms,"The "),zo=a(ms,"A",{href:!0});var Xf=s(zo);Os=o(Xf,"EncoderDecoderModel"),Xf.forEach(n),Ns=o(ms,` can be used to initialize a sequence-to-sequence model with any
...
any other models (see the examples for more information).`),us.forEach(n),es=l(d),he=a(d,"P",{});var Zo=s(he);Hs=o(Zo,"An application of this architecture could be to leverage two pretrained "),$o=a(Zo,"A",{href:!0});var ou=s($o);Ys=o(ou,"BertModel"),ou.forEach(n),Js=o(Zo,` as the encoder
...
were contributed by `),qt=a(Qo,"A",{href:!0,rel:!0});var du=s(qt);sd=o(du,"ydshieh"),du.forEach(n),dd=o(Qo,"."),Qo.forEach(n),rs=l(d),we=a(d,"H2",{class:!0});var gs=s(we);ot=a(gs,"A",{id:!0,class:!0,href:!0});var iu=s(ot);xn=a(iu,"SPAN",{});var lu=s(xn);b(Ct.$$.fragment,lu),lu.forEach(n),iu.forEach(n),id=l(gs),zn=a(gs,"SPAN",{});var cu=s(zn);ld=o(cu,"EncoderDecoderConfig"),cu.forEach(n),gs.forEach(n),as=l(d),C=a(d,"DIV",{class:!0});var R=s(C);b(Ft.$$.fragment,R),cd=l(R),nt=a(R,"P",{});var Ja=s(nt);Po=a(Ja,"A",{href:!0});var pu=s(Po);pd=o(pu,"EncoderDecoderConfig"),pu.forEach(n),hd=o(Ja,` is the configuration class to store the configuration of a
`),qo=a(Ja,"A",{href:!0});var hu=s(qo);md=o(hu,"EncoderDecoderModel"),hu.forEach(n),fd=o(Ja,`. It is used to instantiate an Encoder Decoder model according to the
specified arguments, defining the encoder and decoder configs.`),Ja.forEach(n),ud=l(R),Me=a(R,"P",{});var Xo=s(Me);gd=o(Xo,"Configuration objects inherit from "),Co=a(Xo,"A",{href:!0});var mu=s(Co);_d=o(mu,"PretrainedConfig"),mu.forEach(n),vd=o(Xo,` and can be used to control the model
...
Zhou, Wei Li, Peter J. Liu.`),ys.forEach(n),Yd=l(A),In=a(A,"P",{});var Mu=s(In);Jd=o(Mu,`After such an Encoder Decoder model has been trained/fine-tuned, it can be saved/loaded just like any other models
...
:meth`),Ln=a(Mo,"EM",{});var $u=s(Ln);li=o($u,"~transformers.AutoModelForCausalLM.from_pretrained"),$u.forEach(n),ci=o(Mo," class method for the decoder."),Mo.forEach(n),pi=l(A),U=a(A,"DIV",{class:!0});var ve=s(U);b(Gt.$$.fragment,ve),hi=l(ve),je=a(ve,"P",{});var on=s(je);mi=o(on,"The "),Lo=a(on,"A",{href:!0});var Pu=s(Lo);fi=o(Pu,"EncoderDecoderModel"),Pu.forEach(n),ui=o(on," forward method, overrides the "),On=a(on,"CODE",{});var qu=s(On);gi=o(qu,"__call__"),qu.forEach(n),_i=o(on," special method."),on.forEach(n),vi=l(ve),b(dt.$$.fragment,ve),bi=l(ve),Nn=a(ve,"P",{});var Cu=s(Nn);Ei=o(Cu,"Examples:"),Cu.forEach(n),yi=l(ve),b(Ht.$$.fragment,ve),ve.forEach(n),ki=l(A),u=a(A,"DIV",{class:!0});var w=s(u);b(Yt.$$.fragment,w),Ti=l(w),Bn=a(w,"P",{});var Fu=s(Bn);wi=o(Fu,`Instantiate an encoder and a decoder from one or two base classes of the library from pretrained model
...
a user or organization name, like `),Yn=a(ht,"CODE",{});var Bu=s(Yn);Wi=o(Bu,"dbmdz/bert-base-german-cased"),Bu.forEach(n),Vi=o(ht,"."),ht.forEach(n),Ri=l(an),Q=a(an,"LI",{});var mt=s(Q);Gi=o(mt,"A path to a "),Jn=a(mt,"EM",{});var Uu=s(Jn);Hi=o(Uu,"directory"),Uu.forEach(n),Yi=o(mt,` containing model weights saved using
`),Oo=a(mt,"A",{href:!0});var Wu=s(Oo);Ji=o(Wu,"save_pretrained()"),Wu.forEach(n),Zi=o(mt,", e.g., "),Zn=a(mt,"CODE",{});var Vu=s(Zn);Ki=o(Vu,"./my_model_directory/"),Vu.forEach(n),Qi=o(mt,"."),mt.forEach(n),Xi=l(an),O=a(an,"LI",{});var Y=s(O);el=o(Y,"A path or url to a "),Kn=a(Y,"EM",{});var Ru=s(Kn);tl=o(Ru,"tensorflow index checkpoint file"),Ru.forEach(n),ol=o(Y," (e.g, "),Qn=a(Y,"CODE",{});var Gu=s(Qn);nl=o(Gu,"./tf_model/model.ckpt.index"),Gu.forEach(n),rl=o(Y,`). In
this case, `),Xn=a(Y,"CODE",{});var Hu=s(Xn);al=o(Hu,"from_tf"),Hu.forEach(n),sl=o(Y," should be set to "),er=a(Y,"CODE",{});var Yu=s(er);dl=o(Yu,"True"),Yu.forEach(n),il=o(Y,` and a configuration object should be provided
as `),tr=a(Y,"CODE",{});var Ju=s(tr);ll=o(Ju,"config"),Ju.forEach(n),cl=o(Y,` argument. This loading path is slower than converting the TensorFlow checkpoint in
a PyTorch model using the provided conversion scripts and loading the PyTorch model afterwards.`),Y.forEach(n),an.forEach(n),pl=l(w),X=a(w,"P",{});var ft=s(X);hl=o(ft,"decoder"),or=a(ft,"EM",{});var Zu=s(or);ml=o(Zu,"pretrained_model_name_or_path (:obj: _str"),Zu.forEach(n),fl=o(ft,", "),nr=a(ft,"EM",{});var Ku=s(nr);ul=o(Ku,"optional"),Ku.forEach(n),gl=o(ft,", defaults to "),rr=a(ft,"EM",{});var Qu=s(rr);_l=o(Qu,"None"),Qu.forEach(n),vl=o(ft,`):
...
`),No=a(gt,"A",{href:!0});var ng=s(No);Pl=o(ng,"save_pretrained()"),ng.forEach(n),ql=o(gt,", e.g., "),lr=a(gt,"CODE",{});var rg=s(lr);Cl=o(rg,"./my_model_directory/"),rg.forEach(n),Fl=o(gt,"."),gt.forEach(n),Al=l(sn),N=a(sn,"LI",{});var J=s(N);Il=o(J,"A path or url to a "),cr=a(J,"EM",{});var ag=s(cr);Sl=o(ag,"tensorflow index checkpoint file"),ag.forEach(n),Ll=o(J," (e.g, "),pr=a(J,"CODE",{});var sg=s(pr);Ol=o(sg,"./tf_model/model.ckpt.index"),sg.forEach(n),Nl=o(J,`). In
this case, `),hr=a(J,"CODE",{});var dg=s(hr);Bl=o(dg,"from_tf"),dg.forEach(n),Ul=o(J," should be set to "),mr=a(J,"CODE",{});var ig=s(mr);Wl=o(ig,"True"),ig.forEach(n),Vl=o(J,` and a configuration object should be provided
as `),fr=a(J,"CODE",{});var lg=s(fr);Rl=o(lg,"config"),lg.forEach(n),Gl=o(J,` argument. This loading path is slower than converting the TensorFlow checkpoint in
a PyTorch model using the provided conversion scripts and loading the PyTorch model afterwards.`),J.forEach(n),sn.forEach(n),Hl=l(w),Fe=a(w,"P",{});var dn=s(Fe);Yl=o(dn,"model"),ur=a(dn,"EM",{});var cg=s(ur);Jl=o(cg,"args (remaining positional arguments, _optional"),cg.forEach(n),Zl=o(dn,`):
...
`),Vr=a(Ee,"CODE",{});var Rg=s(Vr);Ap=o(Rg,"encoder_from_pt"),Rg.forEach(n),Ip=o(Ee," should be set to "),Rr=a(Ee,"CODE",{});var Gg=s(Rr);Sp=o(Gg,"True"),Gg.forEach(n),Lp=o(Ee,"."),Ee.forEach(n),fn.forEach(n),Op=l(x),re=a(x,"P",{});var bt=s(re);Np=o(bt,"decoder"),Gr=a(bt,"EM",{});var Hg=s(Gr);Bp=o(Hg,"pretrained_model_name_or_path (:obj: _str"),Hg.forEach(n),Up=o(bt,", "),Hr=a(bt,"EM",{});var Yg=s(Hr);Wp=o(Yg,"optional"),Yg.forEach(n),Vp=o(bt,", defaults to "),Yr=a(bt,"EM",{});var Jg=s(Yr);Rp=o(Jg,"None"),Jg.forEach(n),Gp=o(bt,`):
Information necessary to initiate the decoder. Can be either:`),bt.forEach(n),Hp=l(x),Ue=a(x,"UL",{});var un=s(Ue);ae=a(un,"LI",{});var Et=s(ae);Yp=o(Et,"A string, the "),Jr=a(Et,"EM",{});var Zg=s(Jr);Jp=o(Zg,"model id"),Zg.forEach(n),Zp=o(Et,` of a pretrained model hosted inside a model repo on huggingface.co.
...
encoder and any pretrained autoregressive model as the decoder. The encoder is loaded via
`),ua=a(bn,"CODE",{});var v_=s(ua);Yh=o(v_,"from_pretrained()"),v_.forEach(n),Jh=o(bn,` function and the decoder is loaded via
...
a user or organization name, like `),xa=a(kt,"CODE",{});var A_=s(xa);Rm=o(A_,"dbmdz/bert-base-german-cased"),A_.forEach(n),Gm=o(kt,"."),kt.forEach(n),Hm=l(Fs),ie=a(Fs,"LI",{});var Tt=s(ie);Ym=o(Tt,"A path to a "),za=a(Tt,"EM",{});var I_=s(za);Jm=o(I_,"directory"),I_.forEach(n),Zm=o(Tt,` containing model weights saved using
`),Yo=a(Tt,"A",{href:!0});var S_=s(Yo);Km=o(S_,"save_pretrained()"),S_.forEach(n),Qm=o(Tt,", e.g., "),ja=a(Tt,"CODE",{});var L_=s(ja);Xm=o(L_,"./my_model_directory/"),L_.forEach(n),ef=o(Tt,"."),Tt.forEach(n),Fs.forEach(n),tf=l(z),le=a(z,"P",{});var wt=s(le);of=o(wt,"decoder"),$a=a(wt,"EM",{});var O_=s($a);nf=o(O_,"pretrained_model_name_or_path (:obj: _Union[str, os.PathLike]"),O_.forEach(n),rf=o(wt,", "),Pa=a(wt,"EM",{});var N_=s(Pa);af=o(N_,"optional"),N_.forEach(n),sf=o(wt,", defaults to "),qa=a(wt,"EM",{});var B_=s(qa);df=o(B_,"None"),B_.forEach(n),lf=o(wt,`):
