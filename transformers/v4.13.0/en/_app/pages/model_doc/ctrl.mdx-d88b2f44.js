import{S as xc,i as Pc,s as Sc,e as a,k as l,w,t as n,M as jc,c as r,d as t,m as d,a as i,x as L,h as s,b as c,F as e,g as u,y as $,q as R,o as M,B as E}from"../../chunks/vendor-68651a14.js";import{T as wt}from"../../chunks/Tip-3fbaa85f.js";import{D as Ie}from"../../chunks/Docstring-d699e906.js";import{C as Vt}from"../../chunks/CodeBlock-b98730f5.js";import{I as it}from"../../chunks/IconCopyLink-8ff17449.js";import"../../chunks/CopyButton-e88c769b.js";function Ic(B){let p,C,f,g,v;return{c(){p=a("p"),C=n(`Although the recipe for forward pass needs to be defined within this function, one should call the
`),f=a("code"),g=n("Module"),v=n(` instance afterwards instead of this since the former takes care of running the pre and post
processing steps while the latter silently ignores them.`)},l(T){p=r(T,"P",{});var _=i(p);C=s(_,`Although the recipe for forward pass needs to be defined within this function, one should call the
`),f=r(_,"CODE",{});var y=i(f);g=s(y,"Module"),y.forEach(t),v=s(_,` instance afterwards instead of this since the former takes care of running the pre and post
processing steps while the latter silently ignores them.`),_.forEach(t)},m(T,_){u(T,p,_),e(p,C),e(p,f),e(f,g),e(p,v)},d(T){T&&t(p)}}}function Nc(B){let p,C,f,g,v;return{c(){p=a("p"),C=n(`Although the recipe for forward pass needs to be defined within this function, one should call the
`),f=a("code"),g=n("Module"),v=n(` instance afterwards instead of this since the former takes care of running the pre and post
processing steps while the latter silently ignores them.`)},l(T){p=r(T,"P",{});var _=i(p);C=s(_,`Although the recipe for forward pass needs to be defined within this function, one should call the
`),f=r(_,"CODE",{});var y=i(f);g=s(y,"Module"),y.forEach(t),v=s(_,` instance afterwards instead of this since the former takes care of running the pre and post
processing steps while the latter silently ignores them.`),_.forEach(t)},m(T,_){u(T,p,_),e(p,C),e(p,f),e(f,g),e(p,v)},d(T){T&&t(p)}}}function Dc(B){let p,C,f,g,v;return{c(){p=a("p"),C=n(`Although the recipe for forward pass needs to be defined within this function, one should call the
`),f=a("code"),g=n("Module"),v=n(` instance afterwards instead of this since the former takes care of running the pre and post
processing steps while the latter silently ignores them.`)},l(T){p=r(T,"P",{});var _=i(p);C=s(_,`Although the recipe for forward pass needs to be defined within this function, one should call the
`),f=r(_,"CODE",{});var y=i(f);g=s(y,"Module"),y.forEach(t),v=s(_,` instance afterwards instead of this since the former takes care of running the pre and post
processing steps while the latter silently ignores them.`),_.forEach(t)},m(T,_){u(T,p,_),e(p,C),e(p,f),e(f,g),e(p,v)},d(T){T&&t(p)}}}function Ac(B){let p,C,f,g,v,T,_,y,fe,Q,b,J,A,Y,ge,H,_e,ce,P,S,Z,oe,F,z,Te,U,he,ne,V,pe,se,q,ve,O,ae,ke,W,j,ee,I,te,G,Ce;return{c(){p=a("p"),C=n("TF 2.0 models accepts two formats as inputs:"),f=l(),g=a("ul"),v=a("li"),T=n("having all inputs as keyword arguments (like PyTorch models), or"),_=l(),y=a("li"),fe=n("having all inputs as a list, tuple or dict in the first positional arguments."),Q=l(),b=a("p"),J=n("This second option is useful when using "),A=a("code"),Y=n("tf.keras.Model.fit"),ge=n(` method which currently requires having all
the tensors in the first argument of the model call function: `),H=a("code"),_e=n("model(inputs)"),ce=n("."),P=l(),S=a("p"),Z=n(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in
the first positional argument :`),oe=l(),F=a("ul"),z=a("li"),Te=n("a single Tensor with "),U=a("code"),he=n("input_ids"),ne=n(" only and nothing else: "),V=a("code"),pe=n("model(inputs_ids)"),se=l(),q=a("li"),ve=n(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
...
`),G=a("code"),Ce=n('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(h){p=r(h,"P",{});var k=i(p);C=s(k,"TF 2.0 models accepts two formats as inputs:"),k.forEach(t),f=d(h),g=r(h,"UL",{});var re=i(g);v=r(re,"LI",{});var Ae=i(v);T=s(Ae,"having all inputs as keyword arguments (like PyTorch models), or"),Ae.forEach(t),_=d(re),y=r(re,"LI",{});var ue=i(y);fe=s(ue,"having all inputs as a list, tuple or dict in the first positional arguments."),ue.forEach(t),re.forEach(t),Q=d(h),b=r(h,"P",{});var N=i(b);J=s(N,"This second option is useful when using "),A=r(N,"CODE",{});var Me=i(A);Y=s(Me,"tf.keras.Model.fit"),Me.forEach(t),ge=s(N,` method which currently requires having all
the tensors in the first argument of the model call function: `),H=r(N,"CODE",{});var He=i(H);_e=s(He,"model(inputs)"),He.forEach(t),ce=s(N,"."),N.forEach(t),P=d(h),S=r(h,"P",{});var Oe=i(S);Z=s(Oe,`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in
the first positional argument :`),Oe.forEach(t),oe=d(h),F=r(h,"UL",{});var D=i(F);z=r(D,"LI",{});var x=i(z);Te=s(x,"a single Tensor with "),U=r(x,"CODE",{});var We=i(U);he=s(We,"input_ids"),We.forEach(t),ne=s(x," only and nothing else: "),V=r(x,"CODE",{});var Ee=i(V);pe=s(Ee,"model(inputs_ids)"),Ee.forEach(t),x.forEach(t),se=d(D),q=r(D,"LI",{});var K=i(q);ve=s(K,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
...
`),G=r(be,"CODE",{});var Ue=i(G);Ce=s(Ue,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),Ue.forEach(t),be.forEach(t),D.forEach(t)},m(h,k){u(h,p,k),e(p,C),u(h,f,k),u(h,g,k),e(g,v),e(v,T),e(g,_),e(g,y),e(y,fe),u(h,Q,k),u(h,b,k),e(b,J),e(b,A),e(A,Y),e(b,ge),e(b,H),e(H,_e),e(b,ce),u(h,P,k),u(h,S,k),e(S,Z),u(h,oe,k),u(h,F,k),e(F,z),e(z,Te),e(z,U),e(U,he),e(z,ne),e(z,V),e(V,pe),e(F,se),e(F,q),e(q,ve),e(q,O),e(O,ae),e(q,ke),e(q,W),e(W,j),e(F,ee),e(F,I),e(I,te),e(I,G),e(G,Ce)},d(h){h&&t(p),h&&t(f),h&&t(g),h&&t(Q),h&&t(b),h&&t(P),h&&t(S),h&&t(oe),h&&t(F)}}}function Hc(B){let p,C,f,g,v;return{c(){p=a("p"),C=n(`Although the recipe for forward pass needs to be defined within this function, one should call the
`),f=a("code"),g=n("Module"),v=n(` instance afterwards instead of this since the former takes care of running the pre and post
processing steps while the latter silently ignores them.`)},l(T){p=r(T,"P",{});var _=i(p);C=s(_,`Although the recipe for forward pass needs to be defined within this function, one should call the
`),f=r(_,"CODE",{});var y=i(f);g=s(y,"Module"),y.forEach(t),v=s(_,` instance afterwards instead of this since the former takes care of running the pre and post
processing steps while the latter silently ignores them.`),_.forEach(t)},m(T,_){u(T,p,_),e(p,C),e(p,f),e(f,g),e(p,v)},d(T){T&&t(p)}}}function Oc(B){let p,C,f,g,v,T,_,y,fe,Q,b,J,A,Y,ge,H,_e,ce,P,S,Z,oe,F,z,Te,U,he,ne,V,pe,se,q,ve,O,ae,ke,W,j,ee,I,te,G,Ce;return{c(){p=a("p"),C=n("TF 2.0 models accepts two formats as inputs:"),f=l(),g=a("ul"),v=a("li"),T=n("having all inputs as keyword arguments (like PyTorch models), or"),_=l(),y=a("li"),fe=n("having all inputs as a list, tuple or dict in the first positional arguments."),Q=l(),b=a("p"),J=n("This second option is useful when using "),A=a("code"),Y=n("tf.keras.Model.fit"),ge=n(` method which currently requires having all
the tensors in the first argument of the model call function: `),H=a("code"),_e=n("model(inputs)"),ce=n("."),P=l(),S=a("p"),Z=n(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in
the first positional argument :`),oe=l(),F=a("ul"),z=a("li"),Te=n("a single Tensor with "),U=a("code"),he=n("input_ids"),ne=n(" only and nothing else: "),V=a("code"),pe=n("model(inputs_ids)"),se=l(),q=a("li"),ve=n(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),O=a("code"),ae=n("model([input_ids, attention_mask])"),ke=n(" or "),W=a("code"),j=n("model([input_ids, attention_mask, token_type_ids])"),ee=l(),I=a("li"),te=n(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),G=a("code"),Ce=n('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(h){p=r(h,"P",{});var k=i(p);C=s(k,"TF 2.0 models accepts two formats as inputs:"),k.forEach(t),f=d(h),g=r(h,"UL",{});var re=i(g);v=r(re,"LI",{});var Ae=i(v);T=s(Ae,"having all inputs as keyword arguments (like PyTorch models), or"),Ae.forEach(t),_=d(re),y=r(re,"LI",{});var ue=i(y);fe=s(ue,"having all inputs as a list, tuple or dict in the first positional arguments."),ue.forEach(t),re.forEach(t),Q=d(h),b=r(h,"P",{});var N=i(b);J=s(N,"This second option is useful when using "),A=r(N,"CODE",{});var Me=i(A);Y=s(Me,"tf.keras.Model.fit"),Me.forEach(t),ge=s(N,` method which currently requires having all
...
the first positional argument :`),Oe.forEach(t),oe=d(h),F=r(h,"UL",{});var D=i(F);z=r(D,"LI",{});var x=i(z);Te=s(x,"a single Tensor with "),U=r(x,"CODE",{});var We=i(U);he=s(We,"input_ids"),We.forEach(t),ne=s(x," only and nothing else: "),V=r(x,"CODE",{});var Ee=i(V);pe=s(Ee,"model(inputs_ids)"),Ee.forEach(t),x.forEach(t),se=d(D),q=r(D,"LI",{});var K=i(q);ve=s(K,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),O=r(K,"CODE",{});var Be=i(O);ae=s(Be,"model([input_ids, attention_mask])"),Be.forEach(t),ke=s(K," or "),W=r(K,"CODE",{});var Fe=i(W);j=s(Fe,"model([input_ids, attention_mask, token_type_ids])"),Fe.forEach(t),K.forEach(t),ee=d(D),I=r(D,"LI",{});var be=i(I);te=s(be,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),G=r(be,"CODE",{});var Ue=i(G);Ce=s(Ue,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),Ue.forEach(t),be.forEach(t),D.forEach(t)},m(h,k){u(h,p,k),e(p,C),u(h,f,k),u(h,g,k),e(g,v),e(v,T),e(g,_),e(g,y),e(y,fe),u(h,Q,k),u(h,b,k),e(b,J),e(b,A),e(A,Y),e(b,ge),e(b,H),e(H,_e),e(b,ce),u(h,P,k),u(h,S,k),e(S,Z),u(h,oe,k),u(h,F,k),e(F,z),e(z,Te),e(z,U),e(U,he),e(z,ne),e(z,V),e(V,pe),e(F,se),e(F,q),e(q,ve),e(q,O),e(O,ae),e(q,ke),e(q,W),e(W,j),e(F,ee),e(F,I),e(I,te),e(I,G),e(G,Ce)},d(h){h&&t(p),h&&t(f),h&&t(g),h&&t(Q),h&&t(b),h&&t(P),h&&t(S),h&&t(oe),h&&t(F)}}}function Wc(B){let p,C,f,g,v;return{c(){p=a("p"),C=n(`Although the recipe for forward pass needs to be defined within this function, one should call the
`),f=a("code"),g=n("Module"),v=n(` instance afterwards instead of this since the former takes care of running the pre and post
processing steps while the latter silently ignores them.`)},l(T){p=r(T,"P",{});var _=i(p);C=s(_,`Although the recipe for forward pass needs to be defined within this function, one should call the
`),f=r(_,"CODE",{});var y=i(f);g=s(y,"Module"),y.forEach(t),v=s(_,` instance afterwards instead of this since the former takes care of running the pre and post
processing steps while the latter silently ignores them.`),_.forEach(t)},m(T,_){u(T,p,_),e(p,C),e(p,f),e(f,g),e(p,v)},d(T){T&&t(p)}}}function Bc(B){let p,C,f,g,v,T,_,y,fe,Q,b,J,A,Y,ge,H,_e,ce,P,S,Z,oe,F,z,Te,U,he,ne,V,pe,se,q,ve,O,ae,ke,W,j,ee,I,te,G,Ce;return{c(){p=a("p"),C=n("TF 2.0 models accepts two formats as inputs:"),f=l(),g=a("ul"),v=a("li"),T=n("having all inputs as keyword arguments (like PyTorch models), or"),_=l(),y=a("li"),fe=n("having all inputs as a list, tuple or dict in the first positional arguments."),Q=l(),b=a("p"),J=n("This second option is useful when using "),A=a("code"),Y=n("tf.keras.Model.fit"),ge=n(` method which currently requires having all
the tensors in the first argument of the model call function: `),H=a("code"),_e=n("model(inputs)"),ce=n("."),P=l(),S=a("p"),Z=n(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in
the first positional argument :`),oe=l(),F=a("ul"),z=a("li"),Te=n("a single Tensor with "),U=a("code"),he=n("input_ids"),ne=n(" only and nothing else: "),V=a("code"),pe=n("model(inputs_ids)"),se=l(),q=a("li"),ve=n(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),O=a("code"),ae=n("model([input_ids, attention_mask])"),ke=n(" or "),W=a("code"),j=n("model([input_ids, attention_mask, token_type_ids])"),ee=l(),I=a("li"),te=n(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),G=a("code"),Ce=n('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(h){p=r(h,"P",{});var k=i(p);C=s(k,"TF 2.0 models accepts two formats as inputs:"),k.forEach(t),f=d(h),g=r(h,"UL",{});var re=i(g);v=r(re,"LI",{});var Ae=i(v);T=s(Ae,"having all inputs as keyword arguments (like PyTorch models), or"),Ae.forEach(t),_=d(re),y=r(re,"LI",{});var ue=i(y);fe=s(ue,"having all inputs as a list, tuple or dict in the first positional arguments."),ue.forEach(t),re.forEach(t),Q=d(h),b=r(h,"P",{});var N=i(b);J=s(N,"This second option is useful when using "),A=r(N,"CODE",{});var Me=i(A);Y=s(Me,"tf.keras.Model.fit"),Me.forEach(t),ge=s(N,` method which currently requires having all
...
the first positional argument :`),Oe.forEach(t),oe=d(h),F=r(h,"UL",{});var D=i(F);z=r(D,"LI",{});var x=i(z);Te=s(x,"a single Tensor with "),U=r(x,"CODE",{});var We=i(U);he=s(We,"input_ids"),We.forEach(t),ne=s(x," only and nothing else: "),V=r(x,"CODE",{});var Ee=i(V);pe=s(Ee,"model(inputs_ids)"),Ee.forEach(t),x.forEach(t),se=d(D),q=r(D,"LI",{});var K=i(q);ve=s(K,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),O=r(K,"CODE",{});var Be=i(O);ae=s(Be,"model([input_ids, attention_mask])"),Be.forEach(t),ke=s(K," or "),W=r(K,"CODE",{});var Fe=i(W);j=s(Fe,"model([input_ids, attention_mask, token_type_ids])"),Fe.forEach(t),K.forEach(t),ee=d(D),I=r(D,"LI",{});var be=i(I);te=s(be,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),G=r(be,"CODE",{});var Ue=i(G);Ce=s(Ue,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),Ue.forEach(t),be.forEach(t),D.forEach(t)},m(h,k){u(h,p,k),e(p,C),u(h,f,k),u(h,g,k),e(g,v),e(v,T),e(g,_),e(g,y),e(y,fe),u(h,Q,k),u(h,b,k),e(b,J),e(b,A),e(A,Y),e(b,ge),e(b,H),e(H,_e),e(b,ce),u(h,P,k),u(h,S,k),e(S,Z),u(h,oe,k),u(h,F,k),e(F,z),e(z,Te),e(z,U),e(U,he),e(z,ne),e(z,V),e(V,pe),e(F,se),e(F,q),e(q,ve),e(q,O),e(O,ae),e(q,ke),e(q,W),e(W,j),e(F,ee),e(F,I),e(I,te),e(I,G),e(G,Ce)},d(h){h&&t(p),h&&t(f),h&&t(g),h&&t(Q),h&&t(b),h&&t(P),h&&t(S),h&&t(oe),h&&t(F)}}}function Uc(B){let p,C,f,g,v;return{c(){p=a("p"),C=n(`Although the recipe for forward pass needs to be defined within this function, one should call the
`),f=a("code"),g=n("Module"),v=n(` instance afterwards instead of this since the former takes care of running the pre and post
processing steps while the latter silently ignores them.`)},l(T){p=r(T,"P",{});var _=i(p);C=s(_,`Although the recipe for forward pass needs to be defined within this function, one should call the
`),f=r(_,"CODE",{});var y=i(f);g=s(y,"Module"),y.forEach(t),v=s(_,` instance afterwards instead of this since the former takes care of running the pre and post
processing steps while the latter silently ignores them.`),_.forEach(t)},m(T,_){u(T,p,_),e(p,C),e(p,f),e(f,g),e(p,v)},d(T){T&&t(p)}}}function Vc(B){let p,C,f,g,v,T,_,y,fe,Q,b,J,A,Y,ge,H,_e,ce,P,S,Z,oe,F,z,Te,U,he,ne,V,pe,se,q,ve,O,ae,ke,W,j,ee,I,te,G,Ce,h,k,re,Ae,ue,N,Me,He,Oe,D,x,We,Ee,K,Be,Fe,be,Ue,Ko,la,da,Cs,Je,ca,Gt,ha,pa,Kt,ua,ma,bs,lt,Lt,wn,Xt,fa,Ln,ga,ys,ye,Jt,_a,Xe,Ta,Xo,va,ka,Jo,Ca,ba,Qt,ya,wa,La,dt,$a,Qo,Ra,Ma,Yo,Ea,Fa,za,$n,qa,xa,Yt,ws,ct,$t,Rn,Zt,Pa,Mn,Sa,Ls,Ne,eo,ja,En,Ia,Na,to,Da,Zo,Aa,Ha,Oa,Fn,$s,ht,Rt,zn,oo,Wa,qn,Ba,Rs,we,no,Ua,xn,Va,Ga,so,Ka,en,Xa,Ja,Qa,ao,Ya,ro,Za,er,tr,ze,io,or,pt,nr,tn,sr,ar,Pn,rr,ir,lr,Mt,dr,Sn,cr,hr,lo,Ms,ut,Et,jn,co,pr,In,ur,Es,Le,ho,mr,Nn,fr,gr,po,_r,on,Tr,vr,kr,uo,Cr,mo,br,yr,wr,qe,fo,Lr,mt,$r,nn,Rr,Mr,Dn,Er,Fr,zr,Ft,qr,An,xr,Pr,go,Fs,ft,zt,Hn,_o,Sr,On,jr,zs,$e,To,Ir,Re,Nr,sn,Dr,Ar,Wn,Hr,Or,Bn,Wr,Br,Un,Ur,Vr,Vn,Gr,Kr,Xr,vo,Jr,an,Qr,Yr,Zr,ko,ei,Co,ti,oi,ni,ie,bo,si,gt,ai,rn,ri,ii,Gn,li,di,ci,qt,hi,Kn,pi,ui,yo,mi,Xn,fi,gi,wo,qs,_t,xt,Jn,Lo,_i,Qn,Ti,xs,le,$o,vi,Yn,ki,Ci,Ro,bi,ln,yi,wi,Li,Mo,$i,Eo,Ri,Mi,Ei,Pt,Fi,xe,Fo,zi,Tt,qi,dn,xi,Pi,Zn,Si,ji,Ii,St,Ni,es,Di,Ai,zo,Ps,vt,jt,ts,qo,Hi,os,Oi,Ss,de,xo,Wi,ns,Bi,Ui,Po,Vi,cn,Gi,Ki,Xi,So,Ji,jo,Qi,Yi,Zi,It,el,Pe,Io,tl,kt,ol,hn,nl,sl,ss,al,rl,il,Nt,ll,as,dl,cl,No,js,Ct,Dt,rs,Do,hl,is,pl,Is,X,Ao,ul,ls,ml,fl,pn,un,gl,_l,Tl,De,vl,ds,kl,Cl,cs,bl,yl,hs,wl,Ll,ps,$l,Rl,Ml,Ho,El,mn,Fl,zl,ql,Oo,xl,Wo,Pl,Sl,jl,At,Il,Se,Bo,Nl,bt,Dl,fn,Al,Hl,us,Ol,Wl,Bl,Ht,Ul,ms,Vl,Gl,Uo,Ns;return T=new it({}),Y=new it({}),Xt=new it({}),Jt=new Ie({props:{name:"class transformers.CTRLConfig",anchor:"transformers.CTRLConfig",parameters:[{name:"vocab_size",val:" = 246534"},{name:"n_positions",val:" = 256"},{name:"n_embd",val:" = 1280"},{name:"dff",val:" = 8192"},{name:"n_layer",val:" = 48"},{name:"n_head",val:" = 16"},{name:"resid_pdrop",val:" = 0.1"},{name:"embd_pdrop",val:" = 0.1"},{name:"attn_pdrop",val:" = 0.1"},{name:"layer_norm_epsilon",val:" = 1e-06"},{name:"initializer_range",val:" = 0.02"},{name:"summary_type",val:" = 'cls_index'"},{name:"summary_use_proj",val:" = True"},{name:"summary_activation",val:" = None"},{name:"summary_proj_to_labels",val:" = True"},{name:"summary_first_dropout",val:" = 0.1"},{name:"use_cache",val:" = True"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/master/src/transformers/models/ctrl/configuration_ctrl.py#L26",parametersDescription:[{anchor:"transformers.CTRLConfig.vocab_size",description:`<strong>vocab_size</strong> (<code>int</code>, <em>optional</em>, defaults to 246534) &#x2014;
Vocabulary size of the CTRL model. Defines the number of different tokens that can be represented by the
<code>inputs_ids</code> passed when calling <a href="/docs/transformers/master/en/model_doc/ctrl#transformers.CTRLModel">CTRLModel</a> or
<a href="/docs/transformers/master/en/model_doc/ctrl#transformers.TFCTRLModel">TFCTRLModel</a>.`,name:"vocab_size"},{anchor:"transformers.CTRLConfig.n_positions",description:`<strong>n_positions</strong> (<code>int</code>, <em>optional</em>, defaults to 256) &#x2014;
...
<p>Indices can be obtained using <a href="/docs/transformers/master/en/model_doc/ctrl#transformers.CTRLTokenizer">CTRLTokenizer</a>. See
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),co=new it({}),ho=new Ie({props:{name:"class transformers.CTRLLMHeadModel",anchor:"transformers.CTRLLMHeadModel",parameters:[{name:"config",val:""}],source:"https://github.com/huggingface/transformers/blob/master/src/transformers/models/ctrl/modeling_ctrl.py#L497",parametersDescription:[{anchor:"transformers.CTRLLMHeadModel.config",description:`<strong>config</strong> (<a href="/docs/transformers/master/en/model_doc/ctrl#transformers.CTRLConfig">CTRLConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/master/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model
weights.`,name:"config"}]}}),fo=new Ie({props:{name:"forward",anchor:"transformers.CTRLLMHeadModel.forward",parameters:[{name:"input_ids",val:" = None"},{name:"past_key_values",val:" = None"},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"labels",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/master/src/transformers/models/ctrl/modeling_ctrl.py#L519",parametersDescription:[{anchor:"transformers.CTRLLMHeadModel.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
<code>input_ids_length</code> = <code>sequence_length</code> if <code>past_key_values</code> is <code>None</code> else
<code>past_key_values[0].shape[-2]</code> (<code>sequence_length</code> of input past key value states). Indices of input
sequence tokens in the vocabulary.</p>
<p>If <code>past_key_values</code> is used, only input IDs that do not have their past calculated should be passed
...
>TFBaseModelOutputWithPast</a> or a tuple of
...
<p><a
  href="/docs/transformers/master/en/main_classes/output#transformers.modeling_tf_outputs.TFBaseModelOutputWithPast"
>TFBaseModelOutputWithPast</a> or <code>tuple(tf.Tensor)</code></p>
...
>TFCausalLMOutputWithPast</a> or a tuple of
<code>tf.Tensor</code> (if <code>return_dict=False</code> is passed or when <code>config.return_dict=False</code>) comprising various
elements depending on the configuration (<a
  href="/docs/transformers/master/en/model_doc/ctrl#transformers.CTRLConfig"
>CTRLConfig</a>) and inputs.</p>
...
<p><a
  href="/docs/transformers/master/en/main_classes/output#transformers.modeling_tf_outputs.TFCausalLMOutputWithPast"
>TFCausalLMOutputWithPast</a> or <code>tuple(tf.Tensor)</code></p>
...
<span class="hljs-meta">&gt;&gt;&gt; </span>outputs = model(inputs)
<span class="hljs-meta">&gt;&gt;&gt; </span>loss = outputs.loss
<span class="hljs-meta">&gt;&gt;&gt; </span>logits = outputs.logits`}}),{c(){p=a("meta"),C=l(),f=a("h1"),g=a("a"),v=a("span"),w(T.$$.fragment),_=l(),y=a("span"),fe=n("CTRL"),Q=l(),b=a("h2"),J=a("a"),A=a("span"),w(Y.$$.fragment),ge=l(),H=a("span"),_e=n("Overview"),ce=l(),P=a("p"),S=n("CTRL model was proposed in "),Z=a("a"),oe=n("CTRL: A Conditional Transformer Language Model for Controllable Generation"),F=n(" by Nitish Shirish Keskar"),z=a("em"),Te=n(", Bryan McCann"),U=n(`, Lav R. Varshney, Caiming Xiong and
...
this argument.`),Cs=l(),Je=a("p"),ca=n("This model was contributed by "),Gt=a("a"),ha=n("keskarnitishr"),pa=n(`. The original code can be found
`),Kt=a("a"),ua=n("here"),ma=n("."),bs=l(),lt=a("h2"),Lt=a("a"),wn=a("span"),w(Xt.$$.fragment),fa=l(),Ln=a("span"),ga=n("CTRLConfig"),ys=l(),ye=a("div"),w(Jt.$$.fragment),_a=l(),Xe=a("p"),Ta=n("This is the configuration class to store the configuration of a "),Xo=a("a"),va=n("CTRLModel"),ka=n(` or a
`),Jo=a("a"),Ca=n("TFCTRLModel"),ba=n(`. It is used to instantiate a CTRL model according to the specified arguments,
...
Users should refer to this superclass for more information regarding those methods.`),Oa=l(),Fn=a("div"),$s=l(),ht=a("h2"),Rt=a("a"),zn=a("span"),w(oo.$$.fragment),Wa=l(),qn=a("span"),Ba=n("CTRLModel"),Rs=l(),we=a("div"),w(no.$$.fragment),Ua=l(),xn=a("p"),Va=n("The bare CTRL Model transformer outputting raw hidden-states without any specific head on top."),Ga=l(),so=a("p"),Ka=n("This model inherits from "),en=a("a"),Xa=n("PreTrainedModel"),Ja=n(`. Check the superclass documentation for the generic
...
methods the library implements for all its model (such as downloading or saving, resizing the input embeddings,
pruning heads etc.)`),kr=l(),uo=a("p"),Cr=n("This model is also a PyTorch "),mo=a("a"),br=n("torch.nn.Module"),yr=n(`
subclass. Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to
general usage and behavior.`),wr=l(),qe=a("div"),w(fo.$$.fragment),Lr=l(),mt=a("p"),$r=n("The "),nn=a("a"),Rr=n("CTRLLMHeadModel"),Mr=n(" forward method, overrides the "),Dn=a("code"),Er=n("__call__"),Fr=n(" special method."),zr=l(),w(Ft.$$.fragment),qr=l(),An=a("p"),xr=n("Example:"),Pr=l(),w(go.$$.fragment),Fs=l(),ft=a("h2"),zt=a("a"),Hn=a("span"),w(_o.$$.fragment),Sr=l(),On=a("span"),jr=n("CTRLForSequenceClassification"),zs=l(),$e=a("div"),w(To.$$.fragment),Ir=l(),Re=a("p"),Nr=n(`The CTRL Model transformer with a sequence classification head on top (linear layer).
...
generic methods the library implements for all its model (such as downloading or saving, resizing the input
embeddings, pruning heads etc.)`),Xi=l(),So=a("p"),Ji=n("This model is also a "),jo=a("a"),Qi=n("tf.keras.Model"),Yi=n(` subclass. Use
it as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage
and behavior.`),Zi=l(),w(It.$$.fragment),el=l(),Pe=a("div"),w(Io.$$.fragment),tl=l(),kt=a("p"),ol=n("The "),hn=a("a"),nl=n("TFCTRLLMHeadModel"),sl=n(" forward method, overrides the "),ss=a("code"),al=n("__call__"),rl=n(" special method."),il=l(),w(Nt.$$.fragment),ll=l(),as=a("p"),dl=n("Example:"),cl=l(),w(No.$$.fragment),js=l(),Ct=a("h2"),Dt=a("a"),rs=a("span"),w(Do.$$.fragment),hl=l(),is=a("span"),pl=n("TFCTRLForSequenceClassification"),Is=l(),X=a("div"),w(Ao.$$.fragment),ul=l(),ls=a("p"),ml=n("The CTRL Model transformer with a sequence classification head on top (linear layer)."),fl=l(),pn=a("p"),un=a("a"),gl=n("TFCTRLForSequenceClassification"),_l=n(` uses the last token in order to do the classification, as
other causal models (e.g. GPT-1, GPT-2) do.`),Tl=l(),De=a("p"),vl=n(`Since it does classification on the last token, it requires to know the position of the last token. If a
...
the last value in each row of the batch).`),Ml=l(),Ho=a("p"),El=n("This model inherits from "),mn=a("a"),Fl=n("TFPreTrainedModel"),zl=n(`. Check the superclass documentation for the
generic methods the library implements for all its model (such as downloading or saving, resizing the input
embeddings, pruning heads etc.)`),ql=l(),Oo=a("p"),xl=n("This model is also a "),Wo=a("a"),Pl=n("tf.keras.Model"),Sl=n(` subclass. Use
it as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage
and behavior.`),jl=l(),w(At.$$.fragment),Il=l(),Se=a("div"),w(Bo.$$.fragment),Nl=l(),bt=a("p"),Dl=n("The "),fn=a("a"),Al=n("TFCTRLForSequenceClassification"),Hl=n(" forward method, overrides the "),us=a("code"),Ol=n("__call__"),Wl=n(" special method."),Bl=l(),w(Ht.$$.fragment),Ul=l(),ms=a("p"),Vl=n("Example:"),Gl=l(),w(Uo.$$.fragment),this.h()},l(o){const m=jc('[data-svelte="svelte-1phssyn"]',document.head);p=r(m,"META",{name:!0,content:!0}),m.forEach(t),C=d(o),f=r(o,"H1",{class:!0});var Vo=i(f);g=r(Vo,"A",{id:!0,class:!0,href:!0});var fs=i(g);v=r(fs,"SPAN",{});var gs=i(v);L(T.$$.fragment,gs),gs.forEach(t),fs.forEach(t),_=d(Vo),y=r(Vo,"SPAN",{});var _s=i(y);fe=s(_s,"CTRL"),_s.forEach(t),Vo.forEach(t),Q=d(o),b=r(o,"H2",{class:!0});var Go=i(b);J=r(Go,"A",{id:!0,class:!0,href:!0});var Ts=i(J);A=r(Ts,"SPAN",{});var vs=i(A);L(Y.$$.fragment,vs),vs.forEach(t),Ts.forEach(t),ge=d(Go),H=r(Go,"SPAN",{});var ks=i(H);_e=s(ks,"Overview"),ks.forEach(t),Go.forEach(t),ce=d(o),P=r(o,"P",{});var yt=i(P);S=s(yt,"CTRL model was proposed in "),Z=r(yt,"A",{href:!0,rel:!0});var Xl=i(Z);oe=s(Xl,"CTRL: A Conditional Transformer Language Model for Controllable Generation"),Xl.forEach(t),F=s(yt," by Nitish Shirish Keskar"),z=r(yt,"EM",{});var Jl=i(z);Te=s(Jl,", Bryan McCann"),Jl.forEach(t),U=s(yt,`, Lav R. Varshney, Caiming Xiong and
Richard Socher. It\u2019s a causal (unidirectional) transformer pre-trained using language modeling on a very large corpus
...
this argument.`),Wt.forEach(t),Ot.forEach(t),Cs=d(o),Je=r(o,"P",{});var gn=i(Je);ca=s(gn,"This model was contributed by "),Gt=r(gn,"A",{href:!0,rel:!0});var id=i(Gt);ha=s(id,"keskarnitishr"),id.forEach(t),pa=s(gn,`. The original code can be found
`),Kt=r(gn,"A",{href:!0,rel:!0});var ld=i(Kt);ua=s(ld,"here"),ld.forEach(t),ma=s(gn,"."),gn.forEach(t),bs=d(o),lt=r(o,"H2",{class:!0});var Hs=i(lt);Lt=r(Hs,"A",{id:!0,class:!0,href:!0});var dd=i(Lt);wn=r(dd,"SPAN",{});var cd=i(wn);L(Xt.$$.fragment,cd),cd.forEach(t),dd.forEach(t),fa=d(Hs),Ln=r(Hs,"SPAN",{});var hd=i(Ln);ga=s(hd,"CTRLConfig"),hd.forEach(t),Hs.forEach(t),ys=d(o),ye=r(o,"DIV",{class:!0});var Qe=i(ye);L(Jt.$$.fragment,Qe),_a=d(Qe),Xe=r(Qe,"P",{});var Bt=i(Xe);Ta=s(Bt,"This is the configuration class to store the configuration of a "),Xo=r(Bt,"A",{href:!0});var pd=i(Xo);va=s(pd,"CTRLModel"),pd.forEach(t),ka=s(Bt,` or a
`),Jo=r(Bt,"A",{href:!0});var ud=i(Jo);Ca=s(ud,"TFCTRLModel"),ud.forEach(t),ba=s(Bt,`. It is used to instantiate a CTRL model according to the specified arguments,
defining the model architecture. Instantiating a configuration with the defaults will yield a similar configuration
to that of the `),Qt=r(Bt,"A",{href:!0,rel:!0});var md=i(Qt);ya=s(md,"ctrl"),md.forEach(t),wa=s(Bt," architecture from SalesForce."),Bt.forEach(t),La=d(Qe),dt=r(Qe,"P",{});var _n=i(dt);$a=s(_n,"Configuration objects inherit from "),Qo=r(_n,"A",{href:!0});var fd=i(Qo);Ra=s(fd,"PretrainedConfig"),fd.forEach(t),Ma=s(_n,` and can be used to control the model
outputs. Read the documentation from `),Yo=r(_n,"A",{href:!0});var gd=i(Yo);Ea=s(gd,"PretrainedConfig"),gd.forEach(t),Fa=s(_n," for more information."),_n.forEach(t),za=d(Qe),$n=r(Qe,"P",{});var _d=i($n);qa=s(_d,"Examples:"),_d.forEach(t),xa=d(Qe),L(Yt.$$.fragment,Qe),Qe.forEach(t),ws=d(o),ct=r(o,"H2",{class:!0});var Os=i(ct);$t=r(Os,"A",{id:!0,class:!0,href:!0});var Td=i($t);Rn=r(Td,"SPAN",{});var vd=i(Rn);L(Zt.$$.fragment,vd),vd.forEach(t),Td.forEach(t),Pa=d(Os),Mn=r(Os,"SPAN",{});var kd=i(Mn);Sa=s(kd,"CTRLTokenizer"),kd.forEach(t),Os.forEach(t),Ls=d(o),Ne=r(o,"DIV",{class:!0});var Ut=i(Ne);L(eo.$$.fragment,Ut),ja=d(Ut),En=r(Ut,"P",{});var Cd=i(En);Ia=s(Cd,"Construct a CTRL tokenizer. Based on Byte-Pair-Encoding."),Cd.forEach(t),Na=d(Ut),to=r(Ut,"P",{});var Ws=i(to);Da=s(Ws,"This tokenizer inherits from "),Zo=r(Ws,"A",{href:!0});var bd=i(Zo);Aa=s(bd,"PreTrainedTokenizer"),bd.forEach(t),Ha=s(Ws,` which contains most of the main methods.
Users should refer to this superclass for more information regarding those methods.`),Ws.forEach(t),Oa=d(Ut),Fn=r(Ut,"DIV",{class:!0}),i(Fn).forEach(t),Ut.forEach(t),$s=d(o),ht=r(o,"H2",{class:!0});var Bs=i(ht);Rt=r(Bs,"A",{id:!0,class:!0,href:!0});var yd=i(Rt);zn=r(yd,"SPAN",{});var wd=i(zn);L(oo.$$.fragment,wd),wd.forEach(t),yd.forEach(t),Wa=d(Bs),qn=r(Bs,"SPAN",{});var Ld=i(qn);Ba=s(Ld,"CTRLModel"),Ld.forEach(t),Bs.forEach(t),Rs=d(o),we=r(o,"DIV",{class:!0});var Ye=i(we);L(no.$$.fragment,Ye),Ua=d(Ye),xn=r(Ye,"P",{});var $d=i(xn);Va=s($d,"The bare CTRL Model transformer outputting raw hidden-states without any specific head on top."),$d.forEach(t),Ga=d(Ye),so=r(Ye,"P",{});var Us=i(so);Ka=s(Us,"This model inherits from "),en=r(Us,"A",{href:!0});var Rd=i(en);Xa=s(Rd,"PreTrainedModel"),Rd.forEach(t),Ja=s(Us,`. Check the superclass documentation for the generic
methods the library implements for all its model (such as downloading or saving, resizing the input embeddings,
pruning heads etc.)`),Us.forEach(t),Qa=d(Ye),ao=r(Ye,"P",{});var Vs=i(ao);Ya=s(Vs,"This model is also a PyTorch "),ro=r(Vs,"A",{href:!0,rel:!0});var Md=i(ro);Za=s(Md,"torch.nn.Module"),Md.forEach(t),er=s(Vs,`
subclass. Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to
general usage and behavior.`),Vs.forEach(t),tr=d(Ye),ze=r(Ye,"DIV",{class:!0});var Ze=i(ze);L(io.$$.fragment,Ze),or=d(Ze),pt=r(Ze,"P",{});var Tn=i(pt);nr=s(Tn,"The "),tn=r(Tn,"A",{href:!0});var Ed=i(tn);sr=s(Ed,"CTRLModel"),Ed.forEach(t),ar=s(Tn," forward method, overrides the "),Pn=r(Tn,"CODE",{});var Fd=i(Pn);rr=s(Fd,"__call__"),Fd.forEach(t),ir=s(Tn," special method."),Tn.forEach(t),lr=d(Ze),L(Mt.$$.fragment,Ze),dr=d(Ze),Sn=r(Ze,"P",{});var zd=i(Sn);cr=s(zd,"Example:"),zd.forEach(t),hr=d(Ze),L(lo.$$.fragment,Ze),Ze.forEach(t),Ye.forEach(t),Ms=d(o),ut=r(o,"H2",{class:!0});var Gs=i(ut);Et=r(Gs,"A",{id:!0,class:!0,href:!0});var qd=i(Et);jn=r(qd,"SPAN",{});var xd=i(jn);L(co.$$.fragment,xd),xd.forEach(t),qd.forEach(t),pr=d(Gs),In=r(Gs,"SPAN",{});var Pd=i(In);ur=s(Pd,"CTRLLMHeadModel"),Pd.forEach(t),Gs.forEach(t),Es=d(o),Le=r(o,"DIV",{class:!0});var et=i(Le);L(ho.$$.fragment,et),mr=d(et),Nn=r(et,"P",{});var Sd=i(Nn);fr=s(Sd,`The CTRL Model transformer with a language modeling head on top (linear layer with weights tied to the input
embeddings).`),Sd.forEach(t),gr=d(et),po=r(et,"P",{});var Ks=i(po);_r=s(Ks,"This model inherits from "),on=r(Ks,"A",{href:!0});var jd=i(on);Tr=s(jd,"PreTrainedModel"),jd.forEach(t),vr=s(Ks,`. Check the superclass documentation for the generic
methods the library implements for all its model (such as downloading or saving, resizing the input embeddings,
pruning heads etc.)`),Ks.forEach(t),kr=d(et),uo=r(et,"P",{});var Xs=i(uo);Cr=s(Xs,"This model is also a PyTorch "),mo=r(Xs,"A",{href:!0,rel:!0});var Id=i(mo);br=s(Id,"torch.nn.Module"),Id.forEach(t),yr=s(Xs,`
subclass. Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to
general usage and behavior.`),Xs.forEach(t),wr=d(et),qe=r(et,"DIV",{class:!0});var tt=i(qe);L(fo.$$.fragment,tt),Lr=d(tt),mt=r(tt,"P",{});var vn=i(mt);$r=s(vn,"The "),nn=r(vn,"A",{href:!0});var Nd=i(nn);Rr=s(Nd,"CTRLLMHeadModel"),Nd.forEach(t),Mr=s(vn," forward method, overrides the "),Dn=r(vn,"CODE",{});var Dd=i(Dn);Er=s(Dd,"__call__"),Dd.forEach(t),Fr=s(vn," special method."),vn.forEach(t),zr=d(tt),L(Ft.$$.fragment,tt),qr=d(tt),An=r(tt,"P",{});var Ad=i(An);xr=s(Ad,"Example:"),Ad.forEach(t),Pr=d(tt),L(go.$$.fragment,tt),tt.forEach(t),et.forEach(t),Fs=d(o),ft=r(o,"H2",{class:!0});var Js=i(ft);zt=r(Js,"A",{id:!0,class:!0,href:!0});var Hd=i(zt);Hn=r(Hd,"SPAN",{});var Od=i(Hn);L(_o.$$.fragment,Od),Od.forEach(t),Hd.forEach(t),Sr=d(Js),On=r(Js,"SPAN",{});var Wd=i(On);jr=s(Wd,"CTRLForSequenceClassification"),Wd.forEach(t),Js.forEach(t),zs=d(o),$e=r(o,"DIV",{class:!0});var ot=i($e);L(To.$$.fragment,ot),Ir=d(ot),Re=r(ot,"P",{});var Ve=i(Re);Nr=s(Ve,`The CTRL Model transformer with a sequence classification head on top (linear layer).
`),sn=r(Ve,"A",{href:!0});var Bd=i(sn);Dr=s(Bd,"CTRLForSequenceClassification"),Bd.forEach(t),Ar=s(Ve,` uses the last token in order to do the classification, as
other causal models (e.g. GPT-2) do. Since it does classification on the last token, it requires to know the
position of the last token. If a `),Wn=r(Ve,"CODE",{});var Ud=i(Wn);Hr=s(Ud,"pad_token_id"),Ud.forEach(t),Or=s(Ve,` is defined in the configuration, it finds the last token that
is not a padding token in each row. If no `),Bn=r(Ve,"CODE",{});var Vd=i(Bn);Wr=s(Vd,"pad_token_id"),Vd.forEach(t),Br=s(Ve,` is defined, it simply takes the last value in each
row of the batch. Since it cannot guess the padding tokens when `),Un=r(Ve,"CODE",{});var Gd=i(Un);Ur=s(Gd,"inputs_embeds"),Gd.forEach(t),Vr=s(Ve,` are passed instead of
`),Vn=r(Ve,"CODE",{});var Kd=i(Vn);Gr=s(Kd,"input_ids"),Kd.forEach(t),Kr=s(Ve,", it does the same (take the last value in each row of the batch)."),Ve.forEach(t),Xr=d(ot),vo=r(ot,"P",{});var Qs=i(vo);Jr=s(Qs,"This model inherits from "),an=r(Qs,"A",{href:!0});var Xd=i(an);Qr=s(Xd,"PreTrainedModel"),Xd.forEach(t),Yr=s(Qs,`. Check the superclass documentation for the generic
methods the library implements for all its model (such as downloading or saving, resizing the input embeddings,
pruning heads etc.)`),Qs.forEach(t),Zr=d(ot),ko=r(ot,"P",{});var Ys=i(ko);ei=s(Ys,"This model is also a PyTorch "),Co=r(Ys,"A",{href:!0,rel:!0});var Jd=i(Co);ti=s(Jd,"torch.nn.Module"),Jd.forEach(t),oi=s(Ys,`
subclass. Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to
general usage and behavior.`),Ys.forEach(t),ni=d(ot),ie=r(ot,"DIV",{class:!0});var je=i(ie);L(bo.$$.fragment,je),si=d(je),gt=r(je,"P",{});var kn=i(gt);ai=s(kn,"The "),rn=r(kn,"A",{href:!0});var Qd=i(rn);ri=s(Qd,"CTRLForSequenceClassification"),Qd.forEach(t),ii=s(kn," forward method, overrides the "),Gn=r(kn,"CODE",{});var Yd=i(Gn);li=s(Yd,"__call__"),Yd.forEach(t),di=s(kn," special method."),kn.forEach(t),ci=d(je),L(qt.$$.fragment,je),hi=d(je),Kn=r(je,"P",{});var Zd=i(Kn);pi=s(Zd,"Example of single-label classification:"),Zd.forEach(t),ui=d(je),L(yo.$$.fragment,je),mi=d(je),Xn=r(je,"P",{});var ec=i(Xn);fi=s(ec,"Example of multi-label classification:"),ec.forEach(t),gi=d(je),L(wo.$$.fragment,je),je.forEach(t),ot.forEach(t),qs=d(o),_t=r(o,"H2",{class:!0});var Zs=i(_t);xt=r(Zs,"A",{id:!0,class:!0,href:!0});var tc=i(xt);Jn=r(tc,"SPAN",{});var oc=i(Jn);L(Lo.$$.fragment,oc),oc.forEach(t),tc.forEach(t),_i=d(Zs),Qn=r(Zs,"SPAN",{});var nc=i(Qn);Ti=s(nc,"TFCTRLModel"),nc.forEach(t),Zs.forEach(t),xs=d(o),le=r(o,"DIV",{class:!0});var Ge=i(le);L($o.$$.fragment,Ge),vi=d(Ge),Yn=r(Ge,"P",{});var sc=i(Yn);ki=s(sc,"The bare CTRL Model transformer outputting raw hidden-states without any specific head on top."),sc.forEach(t),Ci=d(Ge),Ro=r(Ge,"P",{});var ea=i(Ro);bi=s(ea,"This model inherits from "),ln=r(ea,"A",{href:!0});var ac=i(ln);yi=s(ac,"TFPreTrainedModel"),ac.forEach(t),wi=s(ea,`. Check the superclass documentation for the
generic methods the library implements for all its model (such as downloading or saving, resizing the input
embeddings, pruning heads etc.)`),ea.forEach(t),Li=d(Ge),Mo=r(Ge,"P",{});var ta=i(Mo);$i=s(ta,"This model is also a "),Eo=r(ta,"A",{href:!0,rel:!0});var rc=i(Eo);Ri=s(rc,"tf.keras.Model"),rc.forEach(t),Mi=s(ta,` subclass. Use
it as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage
and behavior.`),ta.forEach(t),Ei=d(Ge),L(Pt.$$.fragment,Ge),Fi=d(Ge),xe=r(Ge,"DIV",{class:!0});var nt=i(xe);L(Fo.$$.fragment,nt),zi=d(nt),Tt=r(nt,"P",{});var Cn=i(Tt);qi=s(Cn,"The "),dn=r(Cn,"A",{href:!0});var ic=i(dn);xi=s(ic,"TFCTRLModel"),ic.forEach(t),Pi=s(Cn," forward method, overrides the "),Zn=r(Cn,"CODE",{});var lc=i(Zn);Si=s(lc,"__call__"),lc.forEach(t),ji=s(Cn," special method."),Cn.forEach(t),Ii=d(nt),L(St.$$.fragment,nt),Ni=d(nt),es=r(nt,"P",{});var dc=i(es);Di=s(dc,"Example:"),dc.forEach(t),Ai=d(nt),L(zo.$$.fragment,nt),nt.forEach(t),Ge.forEach(t),Ps=d(o),vt=r(o,"H2",{class:!0});var oa=i(vt);jt=r(oa,"A",{id:!0,class:!0,href:!0});var cc=i(jt);ts=r(cc,"SPAN",{});var hc=i(ts);L(qo.$$.fragment,hc),hc.forEach(t),cc.forEach(t),Hi=d(oa),os=r(oa,"SPAN",{});var pc=i(os);Oi=s(pc,"TFCTRLLMHeadModel"),pc.forEach(t),oa.forEach(t),Ss=d(o),de=r(o,"DIV",{class:!0});var Ke=i(de);L(xo.$$.fragment,Ke),Wi=d(Ke),ns=r(Ke,"P",{});var uc=i(ns);Bi=s(uc,`The CTRL Model transformer with a language modeling head on top (linear layer with weights tied to the input
embeddings).`),uc.forEach(t),Ui=d(Ke),Po=r(Ke,"P",{});var na=i(Po);Vi=s(na,"This model inherits from "),cn=r(na,"A",{href:!0});var mc=i(cn);Gi=s(mc,"TFPreTrainedModel"),mc.forEach(t),Ki=s(na,`. Check the superclass documentation for the
generic methods the library implements for all its model (such as downloading or saving, resizing the input
embeddings, pruning heads etc.)`),na.forEach(t),Xi=d(Ke),So=r(Ke,"P",{});var sa=i(So);Ji=s(sa,"This model is also a "),jo=r(sa,"A",{href:!0,rel:!0});var fc=i(jo);Qi=s(fc,"tf.keras.Model"),fc.forEach(t),Yi=s(sa,` subclass. Use
it as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage
and behavior.`),sa.forEach(t),Zi=d(Ke),L(It.$$.fragment,Ke),el=d(Ke),Pe=r(Ke,"DIV",{class:!0});var st=i(Pe);L(Io.$$.fragment,st),tl=d(st),kt=r(st,"P",{});var bn=i(kt);ol=s(bn,"The "),hn=r(bn,"A",{href:!0});var gc=i(hn);nl=s(gc,"TFCTRLLMHeadModel"),gc.forEach(t),sl=s(bn," forward method, overrides the "),ss=r(bn,"CODE",{});var _c=i(ss);al=s(_c,"__call__"),_c.forEach(t),rl=s(bn," special method."),bn.forEach(t),il=d(st),L(Nt.$$.fragment,st),ll=d(st),as=r(st,"P",{});var Tc=i(as);dl=s(Tc,"Example:"),Tc.forEach(t),cl=d(st),L(No.$$.fragment,st),st.forEach(t),Ke.forEach(t),js=d(o),Ct=r(o,"H2",{class:!0});var aa=i(Ct);Dt=r(aa,"A",{id:!0,class:!0,href:!0});var vc=i(Dt);rs=r(vc,"SPAN",{});var kc=i(rs);L(Do.$$.fragment,kc),kc.forEach(t),vc.forEach(t),hl=d(aa),is=r(aa,"SPAN",{});var Cc=i(is);pl=s(Cc,"TFCTRLForSequenceClassification"),Cc.forEach(t),aa.forEach(t),Is=d(o),X=r(o,"DIV",{class:!0});var me=i(X);L(Ao.$$.fragment,me),ul=d(me),ls=r(me,"P",{});var bc=i(ls);ml=s(bc,"The CTRL Model transformer with a sequence classification head on top (linear layer)."),bc.forEach(t),fl=d(me),pn=r(me,"P",{});var Kl=i(pn);un=r(Kl,"A",{href:!0});var yc=i(un);gl=s(yc,"TFCTRLForSequenceClassification"),yc.forEach(t),_l=s(Kl,` uses the last token in order to do the classification, as
other causal models (e.g. GPT-1, GPT-2) do.`),Kl.forEach(t),Tl=d(me),De=r(me,"P",{});var at=i(De);vl=s(at,`Since it does classification on the last token, it requires to know the position of the last token. If a
`),ds=r(at,"CODE",{});var wc=i(ds);kl=s(wc,"pad_token_id"),wc.forEach(t),Cl=s(at,` is defined in the configuration, it finds the last token that is not a padding token in each
row. If no `),cs=r(at,"CODE",{});var Lc=i(cs);bl=s(Lc,"pad_token_id"),Lc.forEach(t),yl=s(at,` is defined, it simply takes the last value in each row of the batch. Since it cannot
guess the padding tokens when `),hs=r(at,"CODE",{});var $c=i(hs);wl=s($c,"inputs_embeds"),$c.forEach(t),Ll=s(at," are passed instead of "),ps=r(at,"CODE",{});var Rc=i(ps);$l=s(Rc,"input_ids"),Rc.forEach(t),Rl=s(at,`, it does the same (take
the last value in each row of the batch).`),at.forEach(t),Ml=d(me),Ho=r(me,"P",{});var ra=i(Ho);El=s(ra,"This model inherits from "),mn=r(ra,"A",{href:!0});var Mc=i(mn);Fl=s(Mc,"TFPreTrainedModel"),Mc.forEach(t),zl=s(ra,`. Check the superclass documentation for the
generic methods the library implements for all its model (such as downloading or saving, resizing the input
embeddings, pruning heads etc.)`),ra.forEach(t),ql=d(me),Oo=r(me,"P",{});var ia=i(Oo);xl=s(ia,"This model is also a "),Wo=r(ia,"A",{href:!0,rel:!0});var Ec=i(Wo);Pl=s(Ec,"tf.keras.Model"),Ec.forEach(t),Sl=s(ia,` subclass. Use
it as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage
and behavior.`),ia.forEach(t),jl=d(me),L(At.$$.fragment,me),Il=d(me),Se=r(me,"DIV",{class:!0});var rt=i(Se);L(Bo.$$.fragment,rt),Nl=d(rt),bt=r(rt,"P",{});var yn=i(bt);Dl=s(yn,"The "),fn=r(yn,"A",{href:!0});var Fc=i(fn);Al=s(Fc,"TFCTRLForSequenceClassification"),Fc.forEach(t),Hl=s(yn," forward method, overrides the "),us=r(yn,"CODE",{});var zc=i(us);Ol=s(zc,"__call__"),zc.forEach(t),Wl=s(yn," special method."),yn.forEach(t),Bl=d(rt),L(Ht.$$.fragment,rt),Ul=d(rt),ms=r(rt,"P",{});var qc=i(ms);Vl=s(qc,"Example:"),qc.forEach(t),Gl=d(rt),L(Uo.$$.fragment,rt),rt.forEach(t),me.forEach(t),this.h()},h(){c(p,"name","hf:doc:metadata"),c(p,"content",JSON.stringify(Gc)),c(g,"id","ctrl"),c(g,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(g,"href","#ctrl"),c(f,"class","relative group"),c(J,"id","overview"),c(J,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(J,"href","#overview"),c(b,"class","relative group"),c(Z,"href","https://arxiv.org/abs/1909.05858"),c(Z,"rel","nofollow"),c(te,"href","https://github.com/salesforce/ctrl"),c(te,"rel","nofollow"),c(Ko,"href","../quickstart#using-the-past"),c(Gt,"href","https://huggingface.co/keskarnitishr"),c(Gt,"rel","nofollow"),c(Kt,"href","https://github.com/salesforce/ctrl"),c(Kt,"rel","nofollow"),c(Lt,"id","transformers.CTRLConfig"),c(Lt,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(Lt,"href","#transformers.CTRLConfig"),c(lt,"class","relative group"),c(Xo,"href","/docs/transformers/master/en/model_doc/ctrl#transformers.CTRLModel"),c(Jo,"href","/docs/transformers/master/en/model_doc/ctrl#transformers.TFCTRLModel"),c(Qt,"href","https://huggingface.co/ctrl"),c(Qt,"rel","nofollow"),c(Qo,"href","/docs/transformers/master/en/main_classes/configuration#transformers.PretrainedConfig"),c(Yo,"href","/docs/transformers/master/en/main_classes/configuration#transformers.PretrainedConfig"),c(ye,"class","docstring"),c($t,"id","transformers.CTRLTokenizer"),c($t,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c($t,"href","#transformers.CTRLTokenizer"),c(ct,"class","relative group"),c(Zo,"href","/docs/transformers/master/en/main_classes/tokenizer#transformers.PreTrainedTokenizer"),c(Fn,"class","docstring"),c(Ne,"class","docstring"),c(Rt,"id","transformers.CTRLModel"),c(Rt,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(Rt,"href","#transformers.CTRLModel"),c(ht,"class","relative group"),c(en,"href","/docs/transformers/master/en/main_classes/model#transformers.PreTrainedModel"),c(ro,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),c(ro,"rel","nofollow"),c(tn,"href","/docs/transformers/master/en/model_doc/ctrl#transformers.CTRLModel"),c(ze,"class","docstring"),c(we,"class","docstring"),c(Et,"id","transformers.CTRLLMHeadModel"),c(Et,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(Et,"href","#transformers.CTRLLMHeadModel"),c(ut,"class","relative group"),c(on,"href","/docs/transformers/master/en/main_classes/model#transformers.PreTrainedModel"),c(mo,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),c(mo,"rel","nofollow"),c(nn,"href","/docs/transformers/master/en/model_doc/ctrl#transformers.CTRLLMHeadModel"),c(qe,"class","docstring"),c(Le,"class","docstring"),c(zt,"id","transformers.CTRLForSequenceClassification"),c(zt,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(zt,"href","#transformers.CTRLForSequenceClassification"),c(ft,"class","relative group"),c(sn,"href","/docs/transformers/master/en/model_doc/ctrl#transformers.CTRLForSequenceClassification"),c(an,"href","/docs/transformers/master/en/main_classes/model#transformers.PreTrainedModel"),c(Co,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),c(Co,"rel","nofollow"),c(rn,"href","/docs/transformers/master/en/model_doc/ctrl#transformers.CTRLForSequenceClassification"),c(ie,"class","docstring"),c($e,"class","docstring"),c(xt,"id","transformers.TFCTRLModel"),c(xt,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(xt,"href","#transformers.TFCTRLModel"),c(_t,"class","relative group"),c(ln,"href","/docs/transformers/master/en/main_classes/model#transformers.TFPreTrainedModel"),c(Eo,"href","https://www.tensorflow.org/api_docs/python/tf/keras/Model"),c(Eo,"rel","nofollow"),c(dn,"href","/docs/transformers/master/en/model_doc/ctrl#transformers.TFCTRLModel"),c(xe,"class","docstring"),c(le,"class","docstring"),c(jt,"id","transformers.TFCTRLLMHeadModel"),c(jt,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(jt,"href","#transformers.TFCTRLLMHeadModel"),c(vt,"class","relative group"),c(cn,"href","/docs/transformers/master/en/main_classes/model#transformers.TFPreTrainedModel"),c(jo,"href","https://www.tensorflow.org/api_docs/python/tf/keras/Model"),c(jo,"rel","nofollow"),c(hn,"href","/docs/transformers/master/en/model_doc/ctrl#transformers.TFCTRLLMHeadModel"),c(Pe,"class","docstring"),c(de,"class","docstring"),c(Dt,"id","transformers.TFCTRLForSequenceClassification"),c(Dt,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(Dt,"href","#transformers.TFCTRLForSequenceClassification"),c(Ct,"class","relative group"),c(un,"href","/docs/transformers/master/en/model_doc/ctrl#transformers.TFCTRLForSequenceClassification"),c(mn,"href","/docs/transformers/master/en/main_classes/model#transformers.TFPreTrainedModel"),c(Wo,"href","https://www.tensorflow.org/api_docs/python/tf/keras/Model"),c(Wo,"rel","nofollow"),c(fn,"href","/docs/transformers/master/en/model_doc/ctrl#transformers.TFCTRLForSequenceClassification"),c(Se,"class","docstring"),c(X,"class","docstring")},m(o,m){e(document.head,p),u(o,C,m),u(o,f,m),e(f,g),e(g,v),$(T,v,null),e(f,_),e(f,y),e(y,fe),u(o,Q,m),u(o,b,m),e(b,J),e(J,A),$(Y,A,null),e(b,ge),e(b,H),e(H,_e),u(o,ce,m),u(o,P,m),e(P,S),e(P,Z),e(Z,oe),e(P,F),e(P,z),e(z,Te),e(P,U),u(o,he,m),u(o,ne,m),e(ne,V),u(o,pe,m),u(o,se,m),e(se,q),e(q,ve),u(o,O,m),u(o,ae,m),e(ae,ke),u(o,W,m),u(o,j,m),e(j,ee),e(ee,I),e(ee,te),e(te,G),e(ee,Ce),e(j,h),e(j,k),e(k,re),e(j,Ae),e(j,ue),e(ue,N),e(ue,Me),e(Me,He),e(ue,Oe),e(j,D),e(j,x),e(x,We),e(x,Ee),e(Ee,K),e(x,Be),e(x,Fe),e(Fe,be),e(x,Ue),e(x,Ko),e(Ko,la),e(x,da),u(o,Cs,m),u(o,Je,m),e(Je,ca),e(Je,Gt),e(Gt,ha),e(Je,pa),e(Je,Kt),e(Kt,ua),e(Je,ma),u(o,bs,m),u(o,lt,m),e(lt,Lt),e(Lt,wn),$(Xt,wn,null),e(lt,fa),e(lt,Ln),e(Ln,ga),u(o,ys,m),u(o,ye,m),$(Jt,ye,null),e(ye,_a),e(ye,Xe),e(Xe,Ta),e(Xe,Xo),e(Xo,va),e(Xe,ka),e(Xe,Jo),e(Jo,Ca),e(Xe,ba),e(Xe,Qt),e(Qt,ya),e(Xe,wa),e(ye,La),e(ye,dt),e(dt,$a),e(dt,Qo),e(Qo,Ra),e(dt,Ma),e(dt,Yo),e(Yo,Ea),e(dt,Fa),e(ye,za),e(ye,$n),e($n,qa),e(ye,xa),$(Yt,ye,null),u(o,ws,m),u(o,ct,m),e(ct,$t),e($t,Rn),$(Zt,Rn,null),e(ct,Pa),e(ct,Mn),e(Mn,Sa),u(o,Ls,m),u(o,Ne,m),$(eo,Ne,null),e(Ne,ja),e(Ne,En),e(En,Ia),e(Ne,Na),e(Ne,to),e(to,Da),e(to,Zo),e(Zo,Aa),e(to,Ha),e(Ne,Oa),e(Ne,Fn),u(o,$s,m),u(o,ht,m),e(ht,Rt),e(Rt,zn),$(oo,zn,null),e(ht,Wa),e(ht,qn),e(qn,Ba),u(o,Rs,m),u(o,we,m),$(no,we,null),e(we,Ua),e(we,xn),e(xn,Va),e(we,Ga),e(we,so),e(so,Ka),e(so,en),e(en,Xa),e(so,Ja),e(we,Qa),e(we,ao),e(ao,Ya),e(ao,ro),e(ro,Za),e(ao,er),e(we,tr),e(we,ze),$(io,ze,null),e(ze,or),e(ze,pt),e(pt,nr),e(pt,tn),e(tn,sr),e(pt,ar),e(pt,Pn),e(Pn,rr),e(pt,ir),e(ze,lr),$(Mt,ze,null),e(ze,dr),e(ze,Sn),e(Sn,cr),e(ze,hr),$(lo,ze,null),u(o,Ms,m),u(o,ut,m),e(ut,Et),e(Et,jn),$(co,jn,null),e(ut,pr),e(ut,In),e(In,ur),u(o,Es,m),u(o,Le,m),$(ho,Le,null),e(Le,mr),e(Le,Nn),e(Nn,fr),e(Le,gr),e(Le,po),e(po,_r),e(po,on),e(on,Tr),e(po,vr),e(Le,kr),e(Le,uo),e(uo,Cr),e(uo,mo),e(mo,br),e(uo,yr),e(Le,wr),e(Le,qe),$(fo,qe,null),e(qe,Lr),e(qe,mt),e(mt,$r),e(mt,nn),e(nn,Rr),e(mt,Mr),e(mt,Dn),e(Dn,Er),e(mt,Fr),e(qe,zr),$(Ft,qe,null),e(qe,qr),e(qe,An),e(An,xr),e(qe,Pr),$(go,qe,null),u(o,Fs,m),u(o,ft,m),e(ft,zt),e(zt,Hn),$(_o,Hn,null),e(ft,Sr),e(ft,On),e(On,jr),u(o,zs,m),u(o,$e,m),$(To,$e,null),e($e,Ir),e($e,Re),e(Re,Nr),e(Re,sn),e(sn,Dr),e(Re,Ar),e(Re,Wn),e(Wn,Hr),e(Re,Or),e(Re,Bn),e(Bn,Wr),e(Re,Br),e(Re,Un),e(Un,Ur),e(Re,Vr),e(Re,Vn),e(Vn,Gr),e(Re,Kr),e($e,Xr),e($e,vo),e(vo,Jr),e(vo,an),e(an,Qr),e(vo,Yr),e($e,Zr),e($e,ko),e(ko,ei),e(ko,Co),e(Co,ti),e(ko,oi),e($e,ni),e($e,ie),$(bo,ie,null),e(ie,si),e(ie,gt),e(gt,ai),e(gt,rn),e(rn,ri),e(gt,ii),e(gt,Gn),e(Gn,li),e(gt,di),e(ie,ci),$(qt,ie,null),e(ie,hi),e(ie,Kn),e(Kn,pi),e(ie,ui),$(yo,ie,null),e(ie,mi),e(ie,Xn),e(Xn,fi),e(ie,gi),$(wo,ie,null),u(o,qs,m),u(o,_t,m),e(_t,xt),e(xt,Jn),$(Lo,Jn,null),e(_t,_i),e(_t,Qn),e(Qn,Ti),u(o,xs,m),u(o,le,m),$($o,le,null),e(le,vi),e(le,Yn),e(Yn,ki),e(le,Ci),e(le,Ro),e(Ro,bi),e(Ro,ln),e(ln,yi),e(Ro,wi),e(le,Li),e(le,Mo),e(Mo,$i),e(Mo,Eo),e(Eo,Ri),e(Mo,Mi),e(le,Ei),$(Pt,le,null),e(le,Fi),e(le,xe),$(Fo,xe,null),e(xe,zi),e(xe,Tt),e(Tt,qi),e(Tt,dn),e(dn,xi),e(Tt,Pi),e(Tt,Zn),e(Zn,Si),e(Tt,ji),e(xe,Ii),$(St,xe,null),e(xe,Ni),e(xe,es),e(es,Di),e(xe,Ai),$(zo,xe,null),u(o,Ps,m),u(o,vt,m),e(vt,jt),e(jt,ts),$(qo,ts,null),e(vt,Hi),e(vt,os),e(os,Oi),u(o,Ss,m),u(o,de,m),$(xo,de,null),e(de,Wi),e(de,ns),e(ns,Bi),e(de,Ui),e(de,Po),e(Po,Vi),e(Po,cn),e(cn,Gi),e(Po,Ki),e(de,Xi),e(de,So),e(So,Ji),e(So,jo),e(jo,Qi),e(So,Yi),e(de,Zi),$(It,de,null),e(de,el),e(de,Pe),$(Io,Pe,null),e(Pe,tl),e(Pe,kt),e(kt,ol),e(kt,hn),e(hn,nl),e(kt,sl),e(kt,ss),e(ss,al),e(kt,rl),e(Pe,il),$(Nt,Pe,null),e(Pe,ll),e(Pe,as),e(as,dl),e(Pe,cl),$(No,Pe,null),u(o,js,m),u(o,Ct,m),e(Ct,Dt),e(Dt,rs),$(Do,rs,null),e(Ct,hl),e(Ct,is),e(is,pl),u(o,Is,m),u(o,X,m),$(Ao,X,null),e(X,ul),e(X,ls),e(ls,ml),e(X,fl),e(X,pn),e(pn,un),e(un,gl),e(pn,_l),e(X,Tl),e(X,De),e(De,vl),e(De,ds),e(ds,kl),e(De,Cl),e(De,cs),e(cs,bl),e(De,yl),e(De,hs),e(hs,wl),e(De,Ll),e(De,ps),e(ps,$l),e(De,Rl),e(X,Ml),e(X,Ho),e(Ho,El),e(Ho,mn),e(mn,Fl),e(Ho,zl),e(X,ql),e(X,Oo),e(Oo,xl),e(Oo,Wo),e(Wo,Pl),e(Oo,Sl),e(X,jl),$(At,X,null),e(X,Il),e(X,Se),$(Bo,Se,null),e(Se,Nl),e(Se,bt),e(bt,Dl),e(bt,fn),e(fn,Al),e(bt,Hl),e(bt,us),e(us,Ol),e(bt,Wl),e(Se,Bl),$(Ht,Se,null),e(Se,Ul),e(Se,ms),e(ms,Vl),e(Se,Gl),$(Uo,Se,null),Ns=!0},p(o,[m]){const Vo={};m&2&&(Vo.$$scope={dirty:m,ctx:o}),Mt.$set(Vo);const fs={};m&2&&(fs.$$scope={dirty:m,ctx:o}),Ft.$set(fs);const gs={};m&2&&(gs.$$scope={dirty:m,ctx:o}),qt.$set(gs);const _s={};m&2&&(_s.$$scope={dirty:m,ctx:o}),Pt.$set(_s);const Go={};m&2&&(Go.$$scope={dirty:m,ctx:o}),St.$set(Go);const Ts={};m&2&&(Ts.$$scope={dirty:m,ctx:o}),It.$set(Ts);const vs={};m&2&&(vs.$$scope={dirty:m,ctx:o}),Nt.$set(vs);const ks={};m&2&&(ks.$$scope={dirty:m,ctx:o}),At.$set(ks);const yt={};m&2&&(yt.$$scope={dirty:m,ctx:o}),Ht.$set(yt)},i(o){Ns||(R(T.$$.fragment,o),R(Y.$$.fragment,o),R(Xt.$$.fragment,o),R(Jt.$$.fragment,o),R(Yt.$$.fragment,o),R(Zt.$$.fragment,o),R(eo.$$.fragment,o),R(oo.$$.fragment,o),R(no.$$.fragment,o),R(io.$$.fragment,o),R(Mt.$$.fragment,o),R(lo.$$.fragment,o),R(co.$$.fragment,o),R(ho.$$.fragment,o),R(fo.$$.fragment,o),R(Ft.$$.fragment,o),R(go.$$.fragment,o),R(_o.$$.fragment,o),R(To.$$.fragment,o),R(bo.$$.fragment,o),R(qt.$$.fragment,o),R(yo.$$.fragment,o),R(wo.$$.fragment,o),R(Lo.$$.fragment,o),R($o.$$.fragment,o),R(Pt.$$.fragment,o),R(Fo.$$.fragment,o),R(St.$$.fragment,o),R(zo.$$.fragment,o),R(qo.$$.fragment,o),R(xo.$$.fragment,o),R(It.$$.fragment,o),R(Io.$$.fragment,o),R(Nt.$$.fragment,o),R(No.$$.fragment,o),R(Do.$$.fragment,o),R(Ao.$$.fragment,o),R(At.$$.fragment,o),R(Bo.$$.fragment,o),R(Ht.$$.fragment,o),R(Uo.$$.fragment,o),Ns=!0)},o(o){M(T.$$.fragment,o),M(Y.$$.fragment,o),M(Xt.$$.fragment,o),M(Jt.$$.fragment,o),M(Yt.$$.fragment,o),M(Zt.$$.fragment,o),M(eo.$$.fragment,o),M(oo.$$.fragment,o),M(no.$$.fragment,o),M(io.$$.fragment,o),M(Mt.$$.fragment,o),M(lo.$$.fragment,o),M(co.$$.fragment,o),M(ho.$$.fragment,o),M(fo.$$.fragment,o),M(Ft.$$.fragment,o),M(go.$$.fragment,o),M(_o.$$.fragment,o),M(To.$$.fragment,o),M(bo.$$.fragment,o),M(qt.$$.fragment,o),M(yo.$$.fragment,o),M(wo.$$.fragment,o),M(Lo.$$.fragment,o),M($o.$$.fragment,o),M(Pt.$$.fragment,o),M(Fo.$$.fragment,o),M(St.$$.fragment,o),M(zo.$$.fragment,o),M(qo.$$.fragment,o),M(xo.$$.fragment,o),M(It.$$.fragment,o),M(Io.$$.fragment,o),M(Nt.$$.fragment,o),M(No.$$.fragment,o),M(Do.$$.fragment,o),M(Ao.$$.fragment,o),M(At.$$.fragment,o),M(Bo.$$.fragment,o),M(Ht.$$.fragment,o),M(Uo.$$.fragment,o),Ns=!1},d(o){t(p),o&&t(C),o&&t(f),E(T),o&&t(Q),o&&t(b),E(Y),o&&t(ce),o&&t(P),o&&t(he),o&&t(ne),o&&t(pe),o&&t(se),o&&t(O),o&&t(ae),o&&t(W),o&&t(j),o&&t(Cs),o&&t(Je),o&&t(bs),o&&t(lt),E(Xt),o&&t(ys),o&&t(ye),E(Jt),E(Yt),o&&t(ws),o&&t(ct),E(Zt),o&&t(Ls),o&&t(Ne),E(eo),o&&t($s),o&&t(ht),E(oo),o&&t(Rs),o&&t(we),E(no),E(io),E(Mt),E(lo),o&&t(Ms),o&&t(ut),E(co),o&&t(Es),o&&t(Le),E(ho),E(fo),E(Ft),E(go),o&&t(Fs),o&&t(ft),E(_o),o&&t(zs),o&&t($e),E(To),E(bo),E(qt),E(yo),E(wo),o&&t(qs),o&&t(_t),E(Lo),o&&t(xs),o&&t(le),E($o),E(Pt),E(Fo),E(St),E(zo),o&&t(Ps),o&&t(vt),E(qo),o&&t(Ss),o&&t(de),E(xo),E(It),E(Io),E(Nt),E(No),o&&t(js),o&&t(Ct),E(Do),o&&t(Is),o&&t(X),E(Ao),E(At),E(Bo),E(Ht),E(Uo)}}}const Gc={local:"ctrl",sections:[{local:"overview",title:"Overview"},{local:"transformers.CTRLConfig",title:"CTRLConfig"},{local:"transformers.CTRLTokenizer",title:"CTRLTokenizer"},{local:"transformers.CTRLModel",title:"CTRLModel"},{local:"transformers.CTRLLMHeadModel",title:"CTRLLMHeadModel"},{local:"transformers.CTRLForSequenceClassification",title:"CTRLForSequenceClassification"},{local:"transformers.TFCTRLModel",title:"TFCTRLModel"},{local:"transformers.TFCTRLLMHeadModel",title:"TFCTRLLMHeadModel"},{local:"transformers.TFCTRLForSequenceClassification",title:"TFCTRLForSequenceClassification"}],title:"CTRL"};function Kc(B,p,C){let{fw:f}=p;return B.$$set=g=>{"fw"in g&&C(0,f=g.fw)},[f]}class th extends xc{constructor(p){super();Pc(this,p,Kc,Vc,Sc,{fw:0})}}export{th as default,Gc as metadata};
