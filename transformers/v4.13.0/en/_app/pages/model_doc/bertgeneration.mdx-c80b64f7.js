import{S as la,i as ca,s as ha,e as s,k as l,w as b,t as o,M as pa,c as a,d as n,m as c,a as i,x as v,h as r,b as d,F as e,g as p,y as k,q as y,o as T,B as w}from"../../chunks/vendor-68651a14.js";import{T as da}from"../../chunks/Tip-3fbaa85f.js";import{D as gt}from"../../chunks/Docstring-d699e906.js";import{C as Vt}from"../../chunks/CodeBlock-b98730f5.js";import{I as _t}from"../../chunks/IconCopyLink-8ff17449.js";import"../../chunks/CopyButton-e88c769b.js";function ua(ie){let u,q,m,g,D;return{c(){u=s("p"),q=o(`Although the recipe for forward pass needs to be defined within this function, one should call the
`),m=s("code"),g=o("Module"),D=o(` instance afterwards instead of this since the former takes care of running the pre and post
...
`),m=a(E,"CODE",{});var S=i(m);g=r(S,"Module"),S.forEach(n),D=r(E,` instance afterwards instead of this since the former takes care of running the pre and post
processing steps while the latter silently ignores them.`),E.forEach(n)},m(_,E){p(_,u,E),e(u,q),e(u,m),e(m,g),e(u,D)},d(_){_&&n(u)}}}function ma(ie){let u,q,m,g,D;return{c(){u=s("p"),q=o(`Although the recipe for forward pass needs to be defined within this function, one should call the
`),m=s("code"),g=o("Module"),D=o(` instance afterwards instead of this since the former takes care of running the pre and post
processing steps while the latter silently ignores them.`)},l(_){u=a(_,"P",{});var E=i(u);q=r(E,`Although the recipe for forward pass needs to be defined within this function, one should call the
`),m=a(E,"CODE",{});var S=i(m);g=r(S,"Module"),S.forEach(n),D=r(E,` instance afterwards instead of this since the former takes care of running the pre and post
processing steps while the latter silently ignores them.`),E.forEach(n)},m(_,E){p(_,u,E),e(u,q),e(u,m),e(m,g),e(u,D)},d(_){_&&n(u)}}}function fa(ie){let u,q,m,g,D,_,E,S,Dn,Jt,R,Y,bt,de,jn,vt,Sn,Kt,M,Mn,Ue,An,Nn,le,Ln,Fn,Qt,He,In,Xt,Ve,kt,On,Yt,Je,Rn,Zt,Ke,ce,Wn,Qe,Un,Hn,en,he,tn,Xe,pe,Vn,Ye,Jn,Kn,nn,ue,on,Ze,Qn,rn,Z,A,et,Xn,Yn,tt,Zn,eo,yt,to,no,oo,Tt,ro,sn,N,so,me,ao,io,fe,lo,co,an,W,ee,wt,ge,ho,Et,po,dn,$,_e,uo,be,mo,Bt,fo,go,_o,U,bo,nt,vo,ko,ot,yo,To,wo,zt,Eo,Bo,ve,ln,H,te,$t,ke,zo,Gt,$o,cn,j,ye,Go,Te,qo,we,xo,Po,Co,Ee,Do,rt,jo,So,Mo,qt,hn,V,ne,xt,Be,Ao,Pt,No,pn,f,ze,Lo,Ct,Fo,Io,$e,Oo,st,Ro,Wo,Uo,Ge,Ho,qe,Vo,Jo,Ko,xe,Qo,Pe,Xo,Yo,Zo,J,er,at,tr,nr,Ce,or,rr,sr,B,ar,Dt,ir,dr,jt,lr,cr,St,hr,pr,Mt,ur,mr,At,fr,gr,Nt,_r,br,vr,x,De,kr,K,yr,it,Tr,wr,Lt,Er,Br,zr,oe,$r,Ft,Gr,qr,je,un,Q,re,It,Se,xr,Ot,Pr,mn,G,Me,Cr,Ae,Dr,Rt,jr,Sr,Mr,Ne,Ar,dt,Nr,Lr,Fr,Le,Ir,Fe,Or,Rr,Wr,P,Ie,Ur,X,Hr,lt,Vr,Jr,Wt,Kr,Qr,Xr,se,Yr,Ut,Zr,es,Oe,fn;return _=new _t({}),de=new _t({}),he=new Vt({props:{code:`# leverage checkpoints for Bert2Bert model...
...
various elements depending on the configuration (<a
  href="/docs/transformers/master/en/model_doc/bertgeneration#transformers.BertGenerationConfig"
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),Se=new _t({}),Me=new gt({props:{name:"class transformers.BertGenerationDecoder",anchor:"transformers.BertGenerationDecoder",parameters:[{name:"config",val:""}],source:"https://github.com/huggingface/transformers/blob/master/src/transformers/models/bert_generation/modeling_bert_generation.py#L450",parametersDescription:[{anchor:"transformers.BertGenerationDecoder.config",description:`<strong>config</strong> (<a href="/docs/transformers/master/en/model_doc/bertgeneration#transformers.BertGenerationConfig">BertGenerationConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/master/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model
weights.`,name:"config"}]}}),Ie=new gt({props:{name:"forward",anchor:"transformers.BertGenerationDecoder.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"encoder_hidden_states",val:" = None"},{name:"encoder_attention_mask",val:" = None"},{name:"labels",val:" = None"},{name:"past_key_values",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/master/src/transformers/models/bert_generation/modeling_bert_generation.py#L469",parametersDescription:[{anchor:"transformers.BertGenerationDecoder.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/master/en/model_doc/bertgeneration#transformers.BertGenerationTokenizer">BertGenerationTokenizer</a>. See
<a href="/docs/transformers/master/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">transformers.PreTrainedTokenizer.<strong>call</strong>()</a> and <a href="/docs/transformers/master/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">transformers.PreTrainedTokenizer.encode()</a> for
details.</p>
...
`}}),se=new da({props:{$$slots:{default:[ma]},$$scope:{ctx:ie}}}),Oe=new Vt({props:{code:`from transformers import BertGenerationTokenizer, BertGenerationDecoder, BertGenerationConfig
import torch
...
<span class="hljs-meta">&gt;&gt;&gt; </span>prediction_logits = outputs.logits`}}),{c(){u=s("meta"),q=l(),m=s("h1"),g=s("a"),D=s("span"),b(_.$$.fragment),E=l(),S=s("span"),Dn=o("BertGeneration"),Jt=l(),R=s("h2"),Y=s("a"),bt=s("span"),b(de.$$.fragment),jn=l(),vt=s("span"),Sn=o("Overview"),Kt=l(),M=s("p"),Mn=o(`The BertGeneration model is a BERT model that can be leveraged for sequence-to-sequence tasks using
`),Ue=s("a"),An=o("EncoderDecoderModel"),Nn=o(" as proposed in "),le=s("a"),Ln=o(`Leveraging Pre-trained Checkpoints for Sequence Generation
...
BERT checkpoints for subsequent fine-tuning.`),en=l(),b(he.$$.fragment),tn=l(),Xe=s("ul"),pe=s("li"),Vn=o("Pretrained "),Ye=s("a"),Jn=o("EncoderDecoderModel"),Kn=o(" are also directly available in the model hub, e.g.,"),nn=l(),b(ue.$$.fragment),on=l(),Ze=s("p"),Qn=o("Tips:"),rn=l(),Z=s("ul"),A=s("li"),et=s("a"),Xn=o("BertGenerationEncoder"),Yn=o(" and "),tt=s("a"),Zn=o("BertGenerationDecoder"),eo=o(` should be used in
...
Therefore, no EOS token should be added to the end of the input.`),sn=l(),N=s("p"),so=o("This model was contributed by "),me=s("a"),ao=o("patrickvonplaten"),io=o(`. The original code can be
found `),fe=s("a"),lo=o("here"),co=o("."),an=l(),W=s("h2"),ee=s("a"),wt=s("span"),b(ge.$$.fragment),ho=l(),Et=s("span"),po=o("BertGenerationConfig"),dn=l(),$=s("div"),b(_e.$$.fragment),uo=l(),be=s("p"),mo=o(`This is the configuration class to store the configuration of a
`),Bt=s("code"),fo=o("BertGenerationPreTrainedModel"),go=o(`. It is used to instantiate a BertGeneration model according to
the specified arguments, defining the model architecture.`),_o=l(),U=s("p"),bo=o("Configuration objects inherit from "),nt=s("a"),vo=o("PretrainedConfig"),ko=o(` and can be used to control the model
outputs. Read the documentation from `),ot=s("a"),yo=o("PretrainedConfig"),To=o(" for more information."),wo=l(),zt=s("p"),Eo=o("Examples:"),Bo=l(),b(ve.$$.fragment),ln=l(),H=s("h2"),te=s("a"),$t=s("span"),b(ke.$$.fragment),zo=l(),Gt=s("span"),$o=o("BertGenerationTokenizer"),cn=l(),j=s("div"),b(ye.$$.fragment),Go=l(),Te=s("p"),qo=o("Construct a BertGeneration tokenizer. Based on "),we=s("a"),xo=o("SentencePiece"),Po=o("."),Co=l(),Ee=s("p"),Do=o("This tokenizer inherits from "),rt=s("a"),jo=o("PreTrainedTokenizer"),So=o(` which contains most of the main methods.
Users should refer to this superclass for more information regarding those methods.`),Mo=l(),qt=s("div"),hn=l(),V=s("h2"),ne=s("a"),xt=s("span"),b(Be.$$.fragment),Ao=l(),Pt=s("span"),No=o("BertGenerationEncoder"),pn=l(),f=s("div"),b(ze.$$.fragment),Lo=l(),Ct=s("p"),Fo=o("The bare BertGeneration model transformer outputting raw hidden-states without any specific head on top."),Io=l(),$e=s("p"),Oo=o("This model inherits from "),st=s("a"),Ro=o("PreTrainedModel"),Wo=o(`. Check the superclass documentation for the generic
...
argument and `),Mt=s("code"),ur=o("add_cross_attention"),mr=o(" set to "),At=s("code"),fr=o("True"),gr=o("; an "),Nt=s("code"),_r=o("encoder_hidden_states"),br=o(` is then expected as an
input to the forward pass.`),vr=l(),x=s("div"),b(De.$$.fragment),kr=l(),K=s("p"),yr=o("The "),it=s("a"),Tr=o("BertGenerationEncoder"),wr=o(" forward method, overrides the "),Lt=s("code"),Er=o("__call__"),Br=o(" special method."),zr=l(),b(oe.$$.fragment),$r=l(),Ft=s("p"),Gr=o("Example:"),qr=l(),b(je.$$.fragment),un=l(),Q=s("h2"),re=s("a"),It=s("span"),b(Se.$$.fragment),xr=l(),Ot=s("span"),Pr=o("BertGenerationDecoder"),mn=l(),G=s("div"),b(Me.$$.fragment),Cr=l(),Ae=s("p"),Dr=o("BertGeneration Model with a "),Rt=s("em"),jr=o("language modeling"),Sr=o(" head on top for CLM fine-tuning."),Mr=l(),Ne=s("p"),Ar=o("This model inherits from "),dt=s("a"),Nr=o("PreTrainedModel"),Lr=o(`. Check the superclass documentation for the generic
methods the library implements for all its model (such as downloading or saving, resizing the input embeddings,
pruning heads etc.)`),Fr=l(),Le=s("p"),Ir=o("This model is also a PyTorch "),Fe=s("a"),Or=o("torch.nn.Module"),Rr=o(`
subclass. Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to
general usage and behavior.`),Wr=l(),P=s("div"),b(Ie.$$.fragment),Ur=l(),X=s("p"),Hr=o("The "),lt=s("a"),Vr=o("BertGenerationDecoder"),Jr=o(" forward method, overrides the "),Wt=s("code"),Kr=o("__call__"),Qr=o(" special method."),Xr=l(),b(se.$$.fragment),Yr=l(),Ut=s("p"),Zr=o("Example:"),es=l(),b(Oe.$$.fragment),this.h()},l(t){const h=pa('[data-svelte="svelte-1phssyn"]',document.head);u=a(h,"META",{name:!0,content:!0}),h.forEach(n),q=c(t),m=a(t,"H1",{class:!0});var Re=i(m);g=a(Re,"A",{id:!0,class:!0,href:!0});var Ht=i(g);D=a(Ht,"SPAN",{});var ts=i(D);v(_.$$.fragment,ts),ts.forEach(n),Ht.forEach(n),E=c(Re),S=a(Re,"SPAN",{});var ns=i(S);Dn=r(ns,"BertGeneration"),ns.forEach(n),Re.forEach(n),Jt=c(t),R=a(t,"H2",{class:!0});var gn=i(R);Y=a(gn,"A",{id:!0,class:!0,href:!0});var os=i(Y);bt=a(os,"SPAN",{});var rs=i(bt);v(de.$$.fragment,rs),rs.forEach(n),os.forEach(n),jn=c(gn),vt=a(gn,"SPAN",{});var ss=i(vt);Sn=r(ss,"Overview"),ss.forEach(n),gn.forEach(n),Kt=c(t),M=a(t,"P",{});var ct=i(M);Mn=r(ct,`The BertGeneration model is a BERT model that can be leveraged for sequence-to-sequence tasks using
`),Ue=a(ct,"A",{href:!0});var as=i(Ue);An=r(as,"EncoderDecoderModel"),as.forEach(n),Nn=r(ct," as proposed in "),le=a(ct,"A",{href:!0,rel:!0});var is=i(le);Ln=r(is,`Leveraging Pre-trained Checkpoints for Sequence Generation
...
BERT checkpoints for subsequent fine-tuning.`),_n.forEach(n),ps.forEach(n),en=c(t),v(he.$$.fragment,t),tn=c(t),Xe=a(t,"UL",{});var ms=i(Xe);pe=a(ms,"LI",{});var bn=i(pe);Vn=r(bn,"Pretrained "),Ye=a(bn,"A",{href:!0});var fs=i(Ye);Jn=r(fs,"EncoderDecoderModel"),fs.forEach(n),Kn=r(bn," are also directly available in the model hub, e.g.,"),bn.forEach(n),ms.forEach(n),nn=c(t),v(ue.$$.fragment,t),on=c(t),Ze=a(t,"P",{});var gs=i(Ze);Qn=r(gs,"Tips:"),gs.forEach(n),rn=c(t),Z=a(t,"UL",{});var vn=i(Z);A=a(vn,"LI",{});var We=i(A);et=a(We,"A",{href:!0});var _s=i(et);Xn=r(_s,"BertGenerationEncoder"),_s.forEach(n),Yn=r(We," and "),tt=a(We,"A",{href:!0});var bs=i(tt);Zn=r(bs,"BertGenerationDecoder"),bs.forEach(n),eo=r(We,` should be used in
combination with `),yt=a(We,"CODE",{});var vs=i(yt);to=r(vs,"EncoderDecoder"),vs.forEach(n),no=r(We,"."),We.forEach(n),oo=c(vn),Tt=a(vn,"LI",{});var ks=i(Tt);ro=r(ks,`For summarization, sentence splitting, sentence fusion and translation, no special tokens are required for the input.
Therefore, no EOS token should be added to the end of the input.`),ks.forEach(n),vn.forEach(n),sn=c(t),N=a(t,"P",{});var ht=i(N);so=r(ht,"This model was contributed by "),me=a(ht,"A",{href:!0,rel:!0});var ys=i(me);ao=r(ys,"patrickvonplaten"),ys.forEach(n),io=r(ht,`. The original code can be
found `),fe=a(ht,"A",{href:!0,rel:!0});var Ts=i(fe);lo=r(Ts,"here"),Ts.forEach(n),co=r(ht,"."),ht.forEach(n),an=c(t),W=a(t,"H2",{class:!0});var kn=i(W);ee=a(kn,"A",{id:!0,class:!0,href:!0});var ws=i(ee);wt=a(ws,"SPAN",{});var Es=i(wt);v(ge.$$.fragment,Es),Es.forEach(n),ws.forEach(n),ho=c(kn),Et=a(kn,"SPAN",{});var Bs=i(Et);po=r(Bs,"BertGenerationConfig"),Bs.forEach(n),kn.forEach(n),dn=c(t),$=a(t,"DIV",{class:!0});var L=i($);v(_e.$$.fragment,L),uo=c(L),be=a(L,"P",{});var yn=i(be);mo=r(yn,`This is the configuration class to store the configuration of a
`),Bt=a(yn,"CODE",{});var zs=i(Bt);fo=r(zs,"BertGenerationPreTrainedModel"),zs.forEach(n),go=r(yn,`. It is used to instantiate a BertGeneration model according to
the specified arguments, defining the model architecture.`),yn.forEach(n),_o=c(L),U=a(L,"P",{});var pt=i(U);bo=r(pt,"Configuration objects inherit from "),nt=a(pt,"A",{href:!0});var $s=i(nt);vo=r($s,"PretrainedConfig"),$s.forEach(n),ko=r(pt,` and can be used to control the model
outputs. Read the documentation from `),ot=a(pt,"A",{href:!0});var Gs=i(ot);yo=r(Gs,"PretrainedConfig"),Gs.forEach(n),To=r(pt," for more information."),pt.forEach(n),wo=c(L),zt=a(L,"P",{});var qs=i(zt);Eo=r(qs,"Examples:"),qs.forEach(n),Bo=c(L),v(ve.$$.fragment,L),L.forEach(n),ln=c(t),H=a(t,"H2",{class:!0});var Tn=i(H);te=a(Tn,"A",{id:!0,class:!0,href:!0});var xs=i(te);$t=a(xs,"SPAN",{});var Ps=i($t);v(ke.$$.fragment,Ps),Ps.forEach(n),xs.forEach(n),zo=c(Tn),Gt=a(Tn,"SPAN",{});var Cs=i(Gt);$o=r(Cs,"BertGenerationTokenizer"),Cs.forEach(n),Tn.forEach(n),cn=c(t),j=a(t,"DIV",{class:!0});var ae=i(j);v(ye.$$.fragment,ae),Go=c(ae),Te=a(ae,"P",{});var wn=i(Te);qo=r(wn,"Construct a BertGeneration tokenizer. Based on "),we=a(wn,"A",{href:!0,rel:!0});var Ds=i(we);xo=r(Ds,"SentencePiece"),Ds.forEach(n),Po=r(wn,"."),wn.forEach(n),Co=c(ae),Ee=a(ae,"P",{});var En=i(Ee);Do=r(En,"This tokenizer inherits from "),rt=a(En,"A",{href:!0});var js=i(rt);jo=r(js,"PreTrainedTokenizer"),js.forEach(n),So=r(En,` which contains most of the main methods.
Users should refer to this superclass for more information regarding those methods.`),En.forEach(n),Mo=c(ae),qt=a(ae,"DIV",{class:!0}),i(qt).forEach(n),ae.forEach(n),hn=c(t),V=a(t,"H2",{class:!0});var Bn=i(V);ne=a(Bn,"A",{id:!0,class:!0,href:!0});var Ss=i(ne);xt=a(Ss,"SPAN",{});var Ms=i(xt);v(Be.$$.fragment,Ms),Ms.forEach(n),Ss.forEach(n),Ao=c(Bn),Pt=a(Bn,"SPAN",{});var As=i(Pt);No=r(As,"BertGenerationEncoder"),As.forEach(n),Bn.forEach(n),pn=c(t),f=a(t,"DIV",{class:!0});var z=i(f);v(ze.$$.fragment,z),Lo=c(z),Ct=a(z,"P",{});var Ns=i(Ct);Fo=r(Ns,"The bare BertGeneration model transformer outputting raw hidden-states without any specific head on top."),Ns.forEach(n),Io=c(z),$e=a(z,"P",{});var zn=i($e);Oo=r(zn,"This model inherits from "),st=a(zn,"A",{href:!0});var Ls=i(st);Ro=r(Ls,"PreTrainedModel"),Ls.forEach(n),Wo=r(zn,`. Check the superclass documentation for the generic
methods the library implements for all its model (such as downloading or saving, resizing the input embeddings,
...
argument and `),Mt=a(C,"CODE",{});var Vs=i(Mt);ur=r(Vs,"add_cross_attention"),Vs.forEach(n),mr=r(C," set to "),At=a(C,"CODE",{});var Js=i(At);fr=r(Js,"True"),Js.forEach(n),gr=r(C,"; an "),Nt=a(C,"CODE",{});var Ks=i(Nt);_r=r(Ks,"encoder_hidden_states"),Ks.forEach(n),br=r(C,` is then expected as an
input to the forward pass.`),C.forEach(n),vr=c(z),x=a(z,"DIV",{class:!0});var F=i(x);v(De.$$.fragment,F),kr=c(F),K=a(F,"P",{});var mt=i(K);yr=r(mt,"The "),it=a(mt,"A",{href:!0});var Qs=i(it);Tr=r(Qs,"BertGenerationEncoder"),Qs.forEach(n),wr=r(mt," forward method, overrides the "),Lt=a(mt,"CODE",{});var Xs=i(Lt);Er=r(Xs,"__call__"),Xs.forEach(n),Br=r(mt," special method."),mt.forEach(n),zr=c(F),v(oe.$$.fragment,F),$r=c(F),Ft=a(F,"P",{});var Ys=i(Ft);Gr=r(Ys,"Example:"),Ys.forEach(n),qr=c(F),v(je.$$.fragment,F),F.forEach(n),z.forEach(n),un=c(t),Q=a(t,"H2",{class:!0});var qn=i(Q);re=a(qn,"A",{id:!0,class:!0,href:!0});var Zs=i(re);It=a(Zs,"SPAN",{});var ea=i(It);v(Se.$$.fragment,ea),ea.forEach(n),Zs.forEach(n),xr=c(qn),Ot=a(qn,"SPAN",{});var ta=i(Ot);Pr=r(ta,"BertGenerationDecoder"),ta.forEach(n),qn.forEach(n),mn=c(t),G=a(t,"DIV",{class:!0});var I=i(G);v(Me.$$.fragment,I),Cr=c(I),Ae=a(I,"P",{});var xn=i(Ae);Dr=r(xn,"BertGeneration Model with a "),Rt=a(xn,"EM",{});var na=i(Rt);jr=r(na,"language modeling"),na.forEach(n),Sr=r(xn," head on top for CLM fine-tuning."),xn.forEach(n),Mr=c(I),Ne=a(I,"P",{});var Pn=i(Ne);Ar=r(Pn,"This model inherits from "),dt=a(Pn,"A",{href:!0});var oa=i(dt);Nr=r(oa,"PreTrainedModel"),oa.forEach(n),Lr=r(Pn,`. Check the superclass documentation for the generic
methods the library implements for all its model (such as downloading or saving, resizing the input embeddings,
...
subclass. Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to
general usage and behavior.`),Cn.forEach(n),Wr=c(I),P=a(I,"DIV",{class:!0});var O=i(P);v(Ie.$$.fragment,O),Ur=c(O),X=a(O,"P",{});var ft=i(X);Hr=r(ft,"The "),lt=a(ft,"A",{href:!0});var sa=i(lt);Vr=r(sa,"BertGenerationDecoder"),sa.forEach(n),Jr=r(ft," forward method, overrides the "),Wt=a(ft,"CODE",{});var aa=i(Wt);Kr=r(aa,"__call__"),aa.forEach(n),Qr=r(ft," special method."),ft.forEach(n),Xr=c(O),v(se.$$.fragment,O),Yr=c(O),Ut=a(O,"P",{});var ia=i(Ut);Zr=r(ia,"Example:"),ia.forEach(n),es=c(O),v(Oe.$$.fragment,O),O.forEach(n),I.forEach(n),this.h()},h(){d(u,"name","hf:doc:metadata"),d(u,"content",JSON.stringify(ga)),d(g,"id","bertgeneration"),d(g,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),d(g,"href","#bertgeneration"),d(m,"class","relative group"),d(Y,"id","overview"),d(Y,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),d(Y,"href","#overview"),d(R,"class","relative group"),d(Ue,"href","/docs/transformers/master/en/model_doc/encoderdecoder#transformers.EncoderDecoderModel"),d(le,"href","https://arxiv.org/abs/1907.12461"),d(le,"rel","nofollow"),d(Qe,"href","/docs/transformers/master/en/model_doc/encoderdecoder#transformers.EncoderDecoderModel"),d(Ye,"href","/docs/transformers/master/en/model_doc/encoderdecoder#transformers.EncoderDecoderModel"),d(et,"href","/docs/transformers/master/en/model_doc/bertgeneration#transformers.BertGenerationEncoder"),d(tt,"href","/docs/transformers/master/en/model_doc/bertgeneration#transformers.BertGenerationDecoder"),d(me,"href","https://huggingface.co/patrickvonplaten"),d(me,"rel","nofollow"),d(fe,"href","https://tfhub.dev/s?module-type=text-generation&subtype=module,placeholder"),d(fe,"rel","nofollow"),d(ee,"id","transformers.BertGenerationConfig"),d(ee,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),d(ee,"href","#transformers.BertGenerationConfig"),d(W,"class","relative group"),d(nt,"href","/docs/transformers/master/en/main_classes/configuration#transformers.PretrainedConfig"),d(ot,"href","/docs/transformers/master/en/main_classes/configuration#transformers.PretrainedConfig"),d($,"class","docstring"),d(te,"id","transformers.BertGenerationTokenizer"),d(te,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),d(te,"href","#transformers.BertGenerationTokenizer"),d(H,"class","relative group"),d(we,"href","https://github.com/google/sentencepiece"),d(we,"rel","nofollow"),d(rt,"href","/docs/transformers/master/en/main_classes/tokenizer#transformers.PreTrainedTokenizer"),d(qt,"class","docstring"),d(j,"class","docstring"),d(ne,"id","transformers.BertGenerationEncoder"),d(ne,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),d(ne,"href","#transformers.BertGenerationEncoder"),d(V,"class","relative group"),d(st,"href","/docs/transformers/master/en/main_classes/model#transformers.PreTrainedModel"),d(qe,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),d(qe,"rel","nofollow"),d(Pe,"href","https://arxiv.org/abs/1706.03762"),d(Pe,"rel","nofollow"),d(at,"href","/docs/transformers/master/en/model_doc/encoderdecoder#transformers.EncoderDecoderModel"),d(Ce,"href","https://arxiv.org/abs/1907.12461"),d(Ce,"rel","nofollow"),d(it,"href","/docs/transformers/master/en/model_doc/bertgeneration#transformers.BertGenerationEncoder"),d(x,"class","docstring"),d(f,"class","docstring"),d(re,"id","transformers.BertGenerationDecoder"),d(re,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),d(re,"href","#transformers.BertGenerationDecoder"),d(Q,"class","relative group"),d(dt,"href","/docs/transformers/master/en/main_classes/model#transformers.PreTrainedModel"),d(Fe,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),d(Fe,"rel","nofollow"),d(lt,"href","/docs/transformers/master/en/model_doc/bertgeneration#transformers.BertGenerationDecoder"),d(P,"class","docstring"),d(G,"class","docstring")},m(t,h){e(document.head,u),p(t,q,h),p(t,m,h),e(m,g),e(g,D),k(_,D,null),e(m,E),e(m,S),e(S,Dn),p(t,Jt,h),p(t,R,h),e(R,Y),e(Y,bt),k(de,bt,null),e(R,jn),e(R,vt),e(vt,Sn),p(t,Kt,h),p(t,M,h),e(M,Mn),e(M,Ue),e(Ue,An),e(M,Nn),e(M,le),e(le,Ln),e(M,Fn),p(t,Qt,h),p(t,He,h),e(He,In),p(t,Xt,h),p(t,Ve,h),e(Ve,kt),e(kt,On),p(t,Yt,h),p(t,Je,h),e(Je,Rn),p(t,Zt,h),p(t,Ke,h),e(Ke,ce),e(ce,Wn),e(ce,Qe),e(Qe,Un),e(ce,Hn),p(t,en,h),k(he,t,h),p(t,tn,h),p(t,Xe,h),e(Xe,pe),e(pe,Vn),e(pe,Ye),e(Ye,Jn),e(pe,Kn),p(t,nn,h),k(ue,t,h),p(t,on,h),p(t,Ze,h),e(Ze,Qn),p(t,rn,h),p(t,Z,h),e(Z,A),e(A,et),e(et,Xn),e(A,Yn),e(A,tt),e(tt,Zn),e(A,eo),e(A,yt),e(yt,to),e(A,no),e(Z,oo),e(Z,Tt),e(Tt,ro),p(t,sn,h),p(t,N,h),e(N,so),e(N,me),e(me,ao),e(N,io),e(N,fe),e(fe,lo),e(N,co),p(t,an,h),p(t,W,h),e(W,ee),e(ee,wt),k(ge,wt,null),e(W,ho),e(W,Et),e(Et,po),p(t,dn,h),p(t,$,h),k(_e,$,null),e($,uo),e($,be),e(be,mo),e(be,Bt),e(Bt,fo),e(be,go),e($,_o),e($,U),e(U,bo),e(U,nt),e(nt,vo),e(U,ko),e(U,ot),e(ot,yo),e(U,To),e($,wo),e($,zt),e(zt,Eo),e($,Bo),k(ve,$,null),p(t,ln,h),p(t,H,h),e(H,te),e(te,$t),k(ke,$t,null),e(H,zo),e(H,Gt),e(Gt,$o),p(t,cn,h),p(t,j,h),k(ye,j,null),e(j,Go),e(j,Te),e(Te,qo),e(Te,we),e(we,xo),e(Te,Po),e(j,Co),e(j,Ee),e(Ee,Do),e(Ee,rt),e(rt,jo),e(Ee,So),e(j,Mo),e(j,qt),p(t,hn,h),p(t,V,h),e(V,ne),e(ne,xt),k(Be,xt,null),e(V,Ao),e(V,Pt),e(Pt,No),p(t,pn,h),p(t,f,h),k(ze,f,null),e(f,Lo),e(f,Ct),e(Ct,Fo),e(f,Io),e(f,$e),e($e,Oo),e($e,st),e(st,Ro),e($e,Wo),e(f,Uo),e(f,Ge),e(Ge,Ho),e(Ge,qe),e(qe,Vo),e(Ge,Jo),e(f,Ko),e(f,xe),e(xe,Qo),e(xe,Pe),e(Pe,Xo),e(xe,Yo),e(f,Zo),e(f,J),e(J,er),e(J,at),e(at,tr),e(J,nr),e(J,Ce),e(Ce,or),e(J,rr),e(f,sr),e(f,B),e(B,ar),e(B,Dt),e(Dt,ir),e(B,dr),e(B,jt),e(jt,lr),e(B,cr),e(B,St),e(St,hr),e(B,pr),e(B,Mt),e(Mt,ur),e(B,mr),e(B,At),e(At,fr),e(B,gr),e(B,Nt),e(Nt,_r),e(B,br),e(f,vr),e(f,x),k(De,x,null),e(x,kr),e(x,K),e(K,yr),e(K,it),e(it,Tr),e(K,wr),e(K,Lt),e(Lt,Er),e(K,Br),e(x,zr),k(oe,x,null),e(x,$r),e(x,Ft),e(Ft,Gr),e(x,qr),k(je,x,null),p(t,un,h),p(t,Q,h),e(Q,re),e(re,It),k(Se,It,null),e(Q,xr),e(Q,Ot),e(Ot,Pr),p(t,mn,h),p(t,G,h),k(Me,G,null),e(G,Cr),e(G,Ae),e(Ae,Dr),e(Ae,Rt),e(Rt,jr),e(Ae,Sr),e(G,Mr),e(G,Ne),e(Ne,Ar),e(Ne,dt),e(dt,Nr),e(Ne,Lr),e(G,Fr),e(G,Le),e(Le,Ir),e(Le,Fe),e(Fe,Or),e(Le,Rr),e(G,Wr),e(G,P),k(Ie,P,null),e(P,Ur),e(P,X),e(X,Hr),e(X,lt),e(lt,Vr),e(X,Jr),e(X,Wt),e(Wt,Kr),e(X,Qr),e(P,Xr),k(se,P,null),e(P,Yr),e(P,Ut),e(Ut,Zr),e(P,es),k(Oe,P,null),fn=!0},p(t,[h]){const Re={};h&2&&(Re.$$scope={dirty:h,ctx:t}),oe.$set(Re);const Ht={};h&2&&(Ht.$$scope={dirty:h,ctx:t}),se.$set(Ht)},i(t){fn||(y(_.$$.fragment,t),y(de.$$.fragment,t),y(he.$$.fragment,t),y(ue.$$.fragment,t),y(ge.$$.fragment,t),y(_e.$$.fragment,t),y(ve.$$.fragment,t),y(ke.$$.fragment,t),y(ye.$$.fragment,t),y(Be.$$.fragment,t),y(ze.$$.fragment,t),y(De.$$.fragment,t),y(oe.$$.fragment,t),y(je.$$.fragment,t),y(Se.$$.fragment,t),y(Me.$$.fragment,t),y(Ie.$$.fragment,t),y(se.$$.fragment,t),y(Oe.$$.fragment,t),fn=!0)},o(t){T(_.$$.fragment,t),T(de.$$.fragment,t),T(he.$$.fragment,t),T(ue.$$.fragment,t),T(ge.$$.fragment,t),T(_e.$$.fragment,t),T(ve.$$.fragment,t),T(ke.$$.fragment,t),T(ye.$$.fragment,t),T(Be.$$.fragment,t),T(ze.$$.fragment,t),T(De.$$.fragment,t),T(oe.$$.fragment,t),T(je.$$.fragment,t),T(Se.$$.fragment,t),T(Me.$$.fragment,t),T(Ie.$$.fragment,t),T(se.$$.fragment,t),T(Oe.$$.fragment,t),fn=!1},d(t){n(u),t&&n(q),t&&n(m),w(_),t&&n(Jt),t&&n(R),w(de),t&&n(Kt),t&&n(M),t&&n(Qt),t&&n(He),t&&n(Xt),t&&n(Ve),t&&n(Yt),t&&n(Je),t&&n(Zt),t&&n(Ke),t&&n(en),w(he,t),t&&n(tn),t&&n(Xe),t&&n(nn),w(ue,t),t&&n(on),t&&n(Ze),t&&n(rn),t&&n(Z),t&&n(sn),t&&n(N),t&&n(an),t&&n(W),w(ge),t&&n(dn),t&&n($),w(_e),w(ve),t&&n(ln),t&&n(H),w(ke),t&&n(cn),t&&n(j),w(ye),t&&n(hn),t&&n(V),w(Be),t&&n(pn),t&&n(f),w(ze),w(De),w(oe),w(je),t&&n(un),t&&n(Q),w(Se),t&&n(mn),t&&n(G),w(Me),w(Ie),w(se),w(Oe)}}}const ga={local:"bertgeneration",sections:[{local:"overview",title:"Overview"},{local:"transformers.BertGenerationConfig",title:"BertGenerationConfig"},{local:"transformers.BertGenerationTokenizer",title:"BertGenerationTokenizer"},{local:"transformers.BertGenerationEncoder",title:"BertGenerationEncoder"},{local:"transformers.BertGenerationDecoder",title:"BertGenerationDecoder"}],title:"BertGeneration"};function _a(ie,u,q){let{fw:m}=u;return ie.$$set=g=>{"fw"in g&&q(0,m=g.fw)},[m]}class Ea extends la{constructor(u){super();ca(this,u,_a,fa,ha,{fw:0})}}export{Ea as default,ga as metadata};
