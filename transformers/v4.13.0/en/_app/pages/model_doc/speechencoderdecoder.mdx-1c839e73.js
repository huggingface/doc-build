import{S as Bd,i as Rd,s as Hd,e as r,k as c,w as M,t as o,M as Ud,c as a,d as n,m as i,a as s,x as $,h as t,b as l,F as e,g as E,y as x,q as C,o as P,B as j}from"../../chunks/vendor-68651a14.js";import{T as Jd}from"../../chunks/Tip-3fbaa85f.js";import{D as _o}from"../../chunks/Docstring-d699e906.js";import{C as vs}from"../../chunks/CodeBlock-b98730f5.js";import{I as Es}from"../../chunks/IconCopyLink-8ff17449.js";import"../../chunks/CopyButton-e88c769b.js";function Gd(vo){let g,N,v,b,J;return{c(){g=r("p"),N=o(`Although the recipe for forward pass needs to be defined within this function, one should call the
`),v=r("code"),b=o("Module"),J=o(` instance afterwards instead of this since the former takes care of running the pre and post
...
`),v=a(W,"CODE",{});var de=s(v);b=t(de,"Module"),de.forEach(n),J=t(W,` instance afterwards instead of this since the former takes care of running the pre and post
processing steps while the latter silently ignores them.`),W.forEach(n)},m(D,W){E(D,g,W),e(g,N),e(g,v),e(v,b),e(g,J)},d(D){D&&n(g)}}}function Yd(vo){let g,N,v,b,J,D,W,de,It,Et,T,Ft,Ve,Ot,Nt,Eo,Wt,Vt,Be,Bt,Rt,Re,Ht,Ut,bt,V,Jt,bo,Gt,Yt,Ee,Zt,Kt,wt,B,Qt,He,Xt,en,Ue,on,tn,yt,G,ce,wo,be,nn,yo,rn,Tt,_,we,an,ie,Je,sn,dn,Ge,cn,ln,hn,Y,pn,Ye,mn,fn,Ze,un,gn,_n,To,vn,En,ye,bn,le,Te,wn,ke,yn,Ke,Tn,kn,Sn,he,Se,Dn,Z,Mn,ko,$n,xn,So,Cn,Pn,kt,K,pe,Do,De,jn,Mo,zn,St,m,Me,qn,Q,An,$o,Ln,In,xo,Fn,On,Nn,$e,Wn,xe,Vn,Bn,Rn,Ce,Hn,Pe,Un,Jn,Gn,Co,Yn,Zn,je,Kn,Qe,Qn,Xn,er,ze,or,qe,tr,nr,rr,R,Xe,ar,sr,Po,dr,cr,jo,ir,lr,hr,k,Ae,pr,X,mr,eo,fr,ur,zo,gr,_r,vr,me,Er,qo,br,wr,Le,yr,h,Ie,Tr,Ao,kr,Sr,ee,Dr,Lo,Mr,$r,Io,xr,Cr,Pr,oe,jr,Fo,zr,qr,Oo,Ar,Lr,Ir,te,A,Fr,No,Or,Nr,Wo,Wr,Vr,Vo,Br,Rr,Hr,L,Ur,Bo,Jr,Gr,oo,Yr,Zr,Ro,Kr,Qr,Xr,w,ea,Ho,oa,ta,Uo,na,ra,Jo,aa,sa,Go,da,ca,Yo,ia,la,ha,I,pa,Zo,ma,fa,Ko,ua,ga,Qo,_a,va,Ea,ne,F,ba,Xo,wa,ya,et,Ta,ka,ot,Sa,Da,Ma,O,$a,tt,xa,Ca,to,Pa,ja,nt,za,qa,Aa,y,La,rt,Ia,Fa,at,Oa,Na,st,Wa,Va,dt,Ba,Ra,ct,Ha,Ua,Ja,re,Ga,it,Ya,Za,lt,Ka,Qa,Xa,ae,es,ht,os,ts,pt,ns,rs,as,se,mt,ss,ds,ft,cs,is,ut,ls,hs,Fe,ps,gt,ms,fs,us,_t,gs,_s,Oe,Dt;return D=new Es({}),be=new Es({}),we=new _o({props:{name:"class transformers.SpeechEncoderDecoderConfig",anchor:"transformers.SpeechEncoderDecoderConfig",parameters:[{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/master/src/transformers/models/speech_encoder_decoder/configuration_speech_encoder_decoder.py#L27",parametersDescription:[{anchor:"transformers.SpeechEncoderDecoderConfig.kwargs",description:`<strong>kwargs</strong> (<em>optional</em>) &#x2014;
...
`,returnType:`
<p><a
  href="/docs/transformers/master/en/model_doc/speechencoderdecoder#transformers.SpeechEncoderDecoderConfig"
>SpeechEncoderDecoderConfig</a></p>
`}}),Se=new _o({props:{name:"to_dict",anchor:"transformers.SpeechEncoderDecoderConfig.to_dict",parameters:[],source:"https://github.com/huggingface/transformers/blob/master/src/transformers/models/speech_encoder_decoder/configuration_speech_encoder_decoder.py#L108",returnDescription:`
...
`}}),me=new Jd({props:{$$slots:{default:[Gd]},$$scope:{ctx:vo}}}),Le=new vs({props:{code:`from transformers import SpeechEncoderDecoderModel, Speech2Text2Processor
...
<span class="hljs-meta">&gt;&gt;&gt; </span>model = SpeechEncoderDecoderModel.from_pretrained(<span class="hljs-string">&quot;./wav2vec2bert&quot;</span>)`}}),{c(){g=r("meta"),N=c(),v=r("h1"),b=r("a"),J=r("span"),M(D.$$.fragment),W=c(),de=r("span"),It=o("Speech Encoder Decoder Models"),Et=c(),T=r("p"),Ft=o("The "),Ve=r("a"),Ot=o("SpeechEncoderDecoderModel"),Nt=o(` can be used to initialize a speech-sequence-to-text-sequence model
with any pretrained speech autoencoding model as the encoder (`),Eo=r("em"),Wt=o("e.g."),Vt=c(),Be=r("a"),Bt=o("Wav2Vec2"),Rt=o(", "),Re=r("a"),Ht=o("Hubert"),Ut=o(") and any pretrained autoregressive model as the decoder."),bt=c(),V=r("p"),Jt=o(`The effectiveness of initializing speech-sequence-to-text-sequence models with pretrained checkpoints for speech
...
`),Ue=r("a"),on=o("Speech2Text2"),tn=o("."),yt=c(),G=r("h2"),ce=r("a"),wo=r("span"),M(be.$$.fragment),nn=c(),yo=r("span"),rn=o("SpeechEncoderDecoderConfig"),Tt=c(),_=r("div"),M(we.$$.fragment),an=c(),ie=r("p"),Je=r("a"),sn=o("SpeechEncoderDecoderConfig"),dn=o(` is the configuration class to store the configuration of a
`),Ge=r("a"),cn=o("SpeechEncoderDecoderModel"),ln=o(`. It is used to instantiate an Encoder Decoder model according to
the specified arguments, defining the encoder and decoder configs.`),hn=c(),Y=r("p"),pn=o("Configuration objects inherit from "),Ye=r("a"),mn=o("PretrainedConfig"),fn=o(` and can be used to control the model
...
Zhou, Wei Li, Peter J. Liu.`),Rn=c(),Ce=r("p"),Hn=o("Additionally, in "),Pe=r("a"),Un=o("Large-Scale Self- and Semi-Supervised Learning for Speech Translation"),Jn=o(` it is shown how leveraging large pretrained speech models for speech
...
:meth`),jo=r("em"),ir=o("~transformers.AutoModelForCausalLM.from_pretrained"),lr=o(" class method for the decoder."),hr=c(),k=r("div"),M(Ae.$$.fragment),pr=c(),X=r("p"),mr=o("The "),eo=r("a"),fr=o("SpeechEncoderDecoderModel"),ur=o(" forward method, overrides the "),zo=r("code"),gr=o("__call__"),_r=o(" special method."),vr=c(),M(me.$$.fragment),Er=c(),qo=r("p"),br=o("Examples:"),wr=c(),M(Le.$$.fragment),yr=c(),h=r("div"),M(Ie.$$.fragment),Tr=c(),Ao=r("p"),kr=o(`Instantiate an encoder and a decoder from one or two base classes of the library from pretrained model
...
a user or organization name, like `),Vo=r("code"),Br=o("dbmdz/bert-base-german-cased"),Rr=o("."),Hr=c(),L=r("li"),Ur=o("A path to a "),Bo=r("em"),Jr=o("directory"),Gr=o(` containing model weights saved using
`),oo=r("a"),Yr=o("save_pretrained()"),Zr=o(", e.g., "),Ro=r("code"),Kr=o("./my_model_directory/"),Qr=o("."),Xr=c(),w=r("li"),ea=o("A path or url to a "),Ho=r("em"),oa=o("tensorflow index checkpoint file"),ta=o(" (e.g, "),Uo=r("code"),na=o("./tf_model/model.ckpt.index"),ra=o(`). In
this case, `),Jo=r("code"),aa=o("from_tf"),sa=o(" should be set to "),Go=r("code"),da=o("True"),ca=o(` and a configuration object should be provided
as `),Yo=r("code"),ia=o("config"),la=o(` argument. This loading path is slower than converting the TensorFlow checkpoint in
a PyTorch model using the provided conversion scripts and loading the PyTorch model afterwards.`),ha=c(),I=r("p"),pa=o("decoder"),Zo=r("em"),ma=o("pretrained_model_name_or_path (:obj: _str"),fa=o(", "),Ko=r("em"),ua=o("optional"),ga=o(", defaults to "),Qo=r("em"),_a=o("None"),va=o(`):
...
as `),ct=r("code"),Ha=o("config"),Ua=o(` argument. This loading path is slower than converting the TensorFlow checkpoint in
a PyTorch model using the provided conversion scripts and loading the PyTorch model afterwards.`),Ja=c(),re=r("p"),Ga=o("model"),it=r("em"),Ya=o("args (remaining positional arguments, _optional"),Za=o(`):
...
`),pt=r("code"),ns=o("output_attentions=True"),rs=o(")."),as=c(),se=r("ul"),mt=r("li"),ss=o("To update the encoder configuration, use the prefix _encoder__ for each configuration parameter."),ds=c(),ft=r("li"),cs=o("To update the decoder configuration, use the prefix _decoder__ for each configuration parameter."),is=c(),ut=r("li"),ls=o("To update the parent model configuration, do not use a prefix for each configuration parameter."),hs=c(),Fe=r("p"),ps=o("Behaves differently depending on whether a "),gt=r("code"),ms=o("config"),fs=o(" is provided or automatically loaded."),us=c(),_t=r("p"),gs=o("Example:"),_s=c(),M(Oe.$$.fragment),this.h()},l(d){const f=Ud('[data-svelte="svelte-1phssyn"]',document.head);g=a(f,"META",{name:!0,content:!0}),f.forEach(n),N=i(d),v=a(d,"H1",{class:!0});var Ne=s(v);b=a(Ne,"A",{id:!0,class:!0,href:!0});var bs=s(b);J=a(bs,"SPAN",{});var ws=s(J);$(D.$$.fragment,ws),ws.forEach(n),bs.forEach(n),W=i(Ne),de=a(Ne,"SPAN",{});var ys=s(de);It=t(ys,"Speech Encoder Decoder Models"),ys.forEach(n),Ne.forEach(n),Et=i(d),T=a(d,"P",{});var H=s(T);Ft=t(H,"The "),Ve=a(H,"A",{href:!0});var Ts=s(Ve);Ot=t(Ts,"SpeechEncoderDecoderModel"),Ts.forEach(n),Nt=t(H,` can be used to initialize a speech-sequence-to-text-sequence model
with any pretrained speech autoencoding model as the encoder (`),Eo=a(H,"EM",{});var ks=s(Eo);Wt=t(ks,"e.g."),ks.forEach(n),Vt=i(H),Be=a(H,"A",{href:!0});var Ss=s(Be);Bt=t(Ss,"Wav2Vec2"),Ss.forEach(n),Rt=t(H,", "),Re=a(H,"A",{href:!0});var Ds=s(Re);Ht=t(Ds,"Hubert"),Ds.forEach(n),Ut=t(H,") and any pretrained autoregressive model as the decoder."),H.forEach(n),bt=i(d),V=a(d,"P",{});var no=s(V);Jt=t(no,`The effectiveness of initializing speech-sequence-to-text-sequence models with pretrained checkpoints for speech
...
`),Ue=a(ro,"A",{href:!0});var Cs=s(Ue);on=t(Cs,"Speech2Text2"),Cs.forEach(n),tn=t(ro,"."),ro.forEach(n),yt=i(d),G=a(d,"H2",{class:!0});var Mt=s(G);ce=a(Mt,"A",{id:!0,class:!0,href:!0});var Ps=s(ce);wo=a(Ps,"SPAN",{});var js=s(wo);$(be.$$.fragment,js),js.forEach(n),Ps.forEach(n),nn=i(Mt),yo=a(Mt,"SPAN",{});var zs=s(yo);rn=t(zs,"SpeechEncoderDecoderConfig"),zs.forEach(n),Mt.forEach(n),Tt=i(d),_=a(d,"DIV",{class:!0});var S=s(_);$(we.$$.fragment,S),an=i(S),ie=a(S,"P",{});var vt=s(ie);Je=a(vt,"A",{href:!0});var qs=s(Je);sn=t(qs,"SpeechEncoderDecoderConfig"),qs.forEach(n),dn=t(vt,` is the configuration class to store the configuration of a
...
the specified arguments, defining the encoder and decoder configs.`),vt.forEach(n),hn=i(S),Y=a(S,"P",{});var ao=s(Y);pn=t(ao,"Configuration objects inherit from "),Ye=a(ao,"A",{href:!0});var Ls=s(Ye);mn=t(Ls,"PretrainedConfig"),Ls.forEach(n),fn=t(ao,` and can be used to control the model
...
tasks was shown in `),xe=a(jt,"A",{href:!0,rel:!0});var Js=s(xe);Vn=t(Js,"Leveraging Pre-trained Checkpoints for Sequence Generation Tasks"),Js.forEach(n),Bn=t(jt,` by Sascha Rothe, Shashi Narayan, Aliaksei Severyn. Michael Matena, Yanqi
Zhou, Wei Li, Peter J. Liu.`),jt.forEach(n),Rn=i(u),Ce=a(u,"P",{});var zt=s(Ce);Hn=t(zt,"Additionally, in "),Pe=a(zt,"A",{href:!0,rel:!0});var Gs=s(Pe);Un=t(Gs,"Large-Scale Self- and Semi-Supervised Learning for Speech Translation"),Gs.forEach(n),Jn=t(zt,` it is shown how leveraging large pretrained speech models for speech
...
:meth`),jo=a(We,"EM",{});var ed=s(jo);ir=t(ed,"~transformers.AutoModelForCausalLM.from_pretrained"),ed.forEach(n),lr=t(We," class method for the decoder."),We.forEach(n),hr=i(u),k=a(u,"DIV",{class:!0});var U=s(k);$(Ae.$$.fragment,U),pr=i(U),X=a(U,"P",{});var io=s(X);mr=t(io,"The "),eo=a(io,"A",{href:!0});var od=s(eo);fr=t(od,"SpeechEncoderDecoderModel"),od.forEach(n),ur=t(io," forward method, overrides the "),zo=a(io,"CODE",{});var td=s(zo);gr=t(td,"__call__"),td.forEach(n),_r=t(io," special method."),io.forEach(n),vr=i(U),$(me.$$.fragment,U),Er=i(U),qo=a(U,"P",{});var nd=s(qo);br=t(nd,"Examples:"),nd.forEach(n),wr=i(U),$(Le.$$.fragment,U),U.forEach(n),yr=i(u),h=a(u,"DIV",{class:!0});var p=s(h);$(Ie.$$.fragment,p),Tr=i(p),Ao=a(p,"P",{});var rd=s(Ao);kr=t(rd,`Instantiate an encoder and a decoder from one or two base classes of the library from pretrained model
...
Information necessary to initiate the encoder. Can be either:`),ho.forEach(n),Ir=i(p),te=a(p,"UL",{});var po=s(te);A=a(po,"LI",{});var fe=s(A);Fr=t(fe,"A string, the "),No=a(fe,"EM",{});var id=s(No);Or=t(id,"model id"),id.forEach(n),Nr=t(fe,` of a pretrained model hosted inside a model repo on huggingface.co.
Valid model ids can be located at the root-level, like `),Wo=a(fe,"CODE",{});var ld=s(Wo);Wr=t(ld,"bert-base-uncased"),ld.forEach(n),Vr=t(fe,`, or namespaced under
a user or organization name, like `),Vo=a(fe,"CODE",{});var hd=s(Vo);Br=t(hd,"dbmdz/bert-base-german-cased"),hd.forEach(n),Rr=t(fe,"."),fe.forEach(n),Hr=i(po),L=a(po,"LI",{});var ue=s(L);Ur=t(ue,"A path to a "),Bo=a(ue,"EM",{});var pd=s(Bo);Jr=t(pd,"directory"),pd.forEach(n),Gr=t(ue,` containing model weights saved using
`),oo=a(ue,"A",{href:!0});var md=s(oo);Yr=t(md,"save_pretrained()"),md.forEach(n),Zr=t(ue,", e.g., "),Ro=a(ue,"CODE",{});var fd=s(Ro);Kr=t(fd,"./my_model_directory/"),fd.forEach(n),Qr=t(ue,"."),ue.forEach(n),Xr=i(po),w=a(po,"LI",{});var z=s(w);ea=t(z,"A path or url to a "),Ho=a(z,"EM",{});var ud=s(Ho);oa=t(ud,"tensorflow index checkpoint file"),ud.forEach(n),ta=t(z," (e.g, "),Uo=a(z,"CODE",{});var gd=s(Uo);na=t(gd,"./tf_model/model.ckpt.index"),gd.forEach(n),ra=t(z,`). In
this case, `),Jo=a(z,"CODE",{});var _d=s(Jo);aa=t(_d,"from_tf"),_d.forEach(n),sa=t(z," should be set to "),Go=a(z,"CODE",{});var vd=s(Go);da=t(vd,"True"),vd.forEach(n),ca=t(z,` and a configuration object should be provided
...
a PyTorch model using the provided conversion scripts and loading the PyTorch model afterwards.`),z.forEach(n),po.forEach(n),ha=i(p),I=a(p,"P",{});var ge=s(I);pa=t(ge,"decoder"),Zo=a(ge,"EM",{});var bd=s(Zo);ma=t(bd,"pretrained_model_name_or_path (:obj: _str"),bd.forEach(n),fa=t(ge,", "),Ko=a(ge,"EM",{});var wd=s(Ko);ua=t(wd,"optional"),wd.forEach(n),ga=t(ge,", defaults to "),Qo=a(ge,"EM",{});var yd=s(Qo);_a=t(yd,"None"),yd.forEach(n),va=t(ge,`):
Information necessary to initiate the decoder. Can be either:`),ge.forEach(n),Ea=i(p),ne=a(p,"UL",{});var mo=s(ne);F=a(mo,"LI",{});var _e=s(F);ba=t(_e,"A string, the "),Xo=a(_e,"EM",{});var Td=s(Xo);wa=t(Td,"model id"),Td.forEach(n),ya=t(_e,` of a pretrained model hosted inside a model repo on huggingface.co.
...
a user or organization name, like `),ot=a(_e,"CODE",{});var Sd=s(ot);Sa=t(Sd,"dbmdz/bert-base-german-cased"),Sd.forEach(n),Da=t(_e,"."),_e.forEach(n),Ma=i(mo),O=a(mo,"LI",{});var ve=s(O);$a=t(ve,"A path to a "),tt=a(ve,"EM",{});var Dd=s(tt);xa=t(Dd,"directory"),Dd.forEach(n),Ca=t(ve,` containing model weights saved using
`),to=a(ve,"A",{href:!0});var Md=s(to);Pa=t(Md,"save_pretrained()"),Md.forEach(n),ja=t(ve,", e.g., "),nt=a(ve,"CODE",{});var $d=s(nt);za=t($d,"./my_model_directory/"),$d.forEach(n),qa=t(ve,"."),ve.forEach(n),Aa=i(mo),y=a(mo,"LI",{});var q=s(y);La=t(q,"A path or url to a "),rt=a(q,"EM",{});var xd=s(rt);Ia=t(xd,"tensorflow index checkpoint file"),xd.forEach(n),Fa=t(q," (e.g, "),at=a(q,"CODE",{});var Cd=s(at);Oa=t(Cd,"./tf_model/model.ckpt.index"),Cd.forEach(n),Na=t(q,`). In
...
as `),ct=a(q,"CODE",{});var zd=s(ct);Ha=t(zd,"config"),zd.forEach(n),Ua=t(q,` argument. This loading path is slower than converting the TensorFlow checkpoint in
a PyTorch model using the provided conversion scripts and loading the PyTorch model afterwards.`),q.forEach(n),mo.forEach(n),Ja=i(p),re=a(p,"P",{});var fo=s(re);Ga=t(fo,"model"),it=a(fo,"EM",{});var qd=s(it);Ya=t(qd,"args (remaining positional arguments, _optional"),qd.forEach(n),Za=t(fo,`):
All remaning positional arguments will be passed to the underlying model\u2019s `),lt=a(fo,"CODE",{});var Ad=s(lt);Ka=t(Ad,"__init__"),Ad.forEach(n),Qa=t(fo," method."),fo.forEach(n),Xa=i(p),ae=a(p,"P",{});var uo=s(ae);es=t(uo,"kwargs (remaining dictionary of keyword arguments, "),ht=a(uo,"EM",{});var Ld=s(ht);os=t(Ld,"optional"),Ld.forEach(n),ts=t(uo,`):
Can be used to update the configuration object (after it being loaded) and initiate the model (e.g.,
`),pt=a(uo,"CODE",{});var Id=s(pt);ns=t(Id,"output_attentions=True"),Id.forEach(n),rs=t(uo,")."),uo.forEach(n),as=i(p),se=a(p,"UL",{});var go=s(se);mt=a(go,"LI",{});var Fd=s(mt);ss=t(Fd,"To update the encoder configuration, use the prefix _encoder__ for each configuration parameter."),Fd.forEach(n),ds=i(go),ft=a(go,"LI",{});var Od=s(ft);cs=t(Od,"To update the decoder configuration, use the prefix _decoder__ for each configuration parameter."),Od.forEach(n),is=i(go),ut=a(go,"LI",{});var Nd=s(ut);ls=t(Nd,"To update the parent model configuration, do not use a prefix for each configuration parameter."),Nd.forEach(n),go.forEach(n),hs=i(p),Fe=a(p,"P",{});var Lt=s(Fe);ps=t(Lt,"Behaves differently depending on whether a "),gt=a(Lt,"CODE",{});var Wd=s(gt);ms=t(Wd,"config"),Wd.forEach(n),fs=t(Lt," is provided or automatically loaded."),Lt.forEach(n),us=i(p),_t=a(p,"P",{});var Vd=s(_t);gs=t(Vd,"Example:"),Vd.forEach(n),_s=i(p),$(Oe.$$.fragment,p),p.forEach(n),u.forEach(n),this.h()},h(){l(g,"name","hf:doc:metadata"),l(g,"content",JSON.stringify(Zd)),l(b,"id","speech-encoder-decoder-models"),l(b,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),l(b,"href","#speech-encoder-decoder-models"),l(v,"class","relative group"),l(Ve,"href","/docs/transformers/master/en/model_doc/speechencoderdecoder#transformers.SpeechEncoderDecoderModel"),l(Be,"href","/docs/transformers/master/en/wav2vec2"),l(Re,"href","/docs/transformers/master/en/hubert"),l(Ee,"href","https://arxiv.org/abs/2104.06678"),l(Ee,"rel","nofollow"),l(He,"href","/docs/transformers/master/en/model_doc/speechencoderdecoder#transformers.SpeechEncoderDecoderModel"),l(Ue,"href","/docs/transformers/master/en/speech_to_text_2"),l(ce,"id","transformers.SpeechEncoderDecoderConfig"),l(ce,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),l(ce,"href","#transformers.SpeechEncoderDecoderConfig"),l(G,"class","relative group"),l(Je,"href","/docs/transformers/master/en/model_doc/speechencoderdecoder#transformers.SpeechEncoderDecoderConfig"),l(Ge,"href","/docs/transformers/master/en/model_doc/speechencoderdecoder#transformers.SpeechEncoderDecoderModel"),l(Ye,"href","/docs/transformers/master/en/main_classes/configuration#transformers.PretrainedConfig"),l(Ze,"href","/docs/transformers/master/en/main_classes/configuration#transformers.PretrainedConfig"),l(Ke,"href","/docs/transformers/master/en/model_doc/speechencoderdecoder#transformers.SpeechEncoderDecoderConfig"),l(le,"class","docstring"),l(he,"class","docstring"),l(_,"class","docstring"),l(pe,"id","transformers.SpeechEncoderDecoderModel"),l(pe,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),l(pe,"href","#transformers.SpeechEncoderDecoderModel"),l(K,"class","relative group"),l(xe,"href","https://arxiv.org/abs/1907.12461"),l(xe,"rel","nofollow"),l(Pe,"href","https://arxiv.org/abs/2104.06678"),l(Pe,"rel","nofollow"),l(Qe,"href","/docs/transformers/master/en/main_classes/model#transformers.PreTrainedModel"),l(qe,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),l(qe,"rel","nofollow"),l(Xe,"href","/docs/transformers/master/en/model_doc/speechencoderdecoder#transformers.SpeechEncoderDecoderModel"),l(eo,"href","/docs/transformers/master/en/model_doc/speechencoderdecoder#transformers.SpeechEncoderDecoderModel"),l(k,"class","docstring"),l(oo,"href","/docs/transformers/master/en/main_classes/model#transformers.PreTrainedModel.save_pretrained"),l(to,"href","/docs/transformers/master/en/main_classes/model#transformers.PreTrainedModel.save_pretrained"),l(h,"class","docstring"),l(m,"class","docstring")},m(d,f){e(document.head,g),E(d,N,f),E(d,v,f),e(v,b),e(b,J),x(D,J,null),e(v,W),e(v,de),e(de,It),E(d,Et,f),E(d,T,f),e(T,Ft),e(T,Ve),e(Ve,Ot),e(T,Nt),e(T,Eo),e(Eo,Wt),e(T,Vt),e(T,Be),e(Be,Bt),e(T,Rt),e(T,Re),e(Re,Ht),e(T,Ut),E(d,bt,f),E(d,V,f),e(V,Jt),e(V,bo),e(bo,Gt),e(V,Yt),e(V,Ee),e(Ee,Zt),e(V,Kt),E(d,wt,f),E(d,B,f),e(B,Qt),e(B,He),e(He,Xt),e(B,en),e(B,Ue),e(Ue,on),e(B,tn),E(d,yt,f),E(d,G,f),e(G,ce),e(ce,wo),x(be,wo,null),e(G,nn),e(G,yo),e(yo,rn),E(d,Tt,f),E(d,_,f),x(we,_,null),e(_,an),e(_,ie),e(ie,Je),e(Je,sn),e(ie,dn),e(ie,Ge),e(Ge,cn),e(ie,ln),e(_,hn),e(_,Y),e(Y,pn),e(Y,Ye),e(Ye,mn),e(Y,fn),e(Y,Ze),e(Ze,un),e(Y,gn),e(_,_n),e(_,To),e(To,vn),e(_,En),x(ye,_,null),e(_,bn),e(_,le),x(Te,le,null),e(le,wn),e(le,ke),e(ke,yn),e(ke,Ke),e(Ke,Tn),e(ke,kn),e(_,Sn),e(_,he),x(Se,he,null),e(he,Dn),e(he,Z),e(Z,Mn),e(Z,ko),e(ko,$n),e(Z,xn),e(Z,So),e(So,Cn),e(Z,Pn),E(d,kt,f),E(d,K,f),e(K,pe),e(pe,Do),x(De,Do,null),e(K,jn),e(K,Mo),e(Mo,zn),E(d,St,f),E(d,m,f),x(Me,m,null),e(m,qn),e(m,Q),e(Q,An),e(Q,$o),e($o,Ln),e(Q,In),e(Q,xo),e(xo,Fn),e(Q,On),e(m,Nn),e(m,$e),e($e,Wn),e($e,xe),e(xe,Vn),e($e,Bn),e(m,Rn),e(m,Ce),e(Ce,Hn),e(Ce,Pe),e(Pe,Un),e(Ce,Jn),e(m,Gn),e(m,Co),e(Co,Yn),e(m,Zn),e(m,je),e(je,Kn),e(je,Qe),e(Qe,Qn),e(je,Xn),e(m,er),e(m,ze),e(ze,or),e(ze,qe),e(qe,tr),e(ze,nr),e(m,rr),e(m,R),e(R,Xe),e(Xe,ar),e(R,sr),e(R,Po),e(Po,dr),e(R,cr),e(R,jo),e(jo,ir),e(R,lr),e(m,hr),e(m,k),x(Ae,k,null),e(k,pr),e(k,X),e(X,mr),e(X,eo),e(eo,fr),e(X,ur),e(X,zo),e(zo,gr),e(X,_r),e(k,vr),x(me,k,null),e(k,Er),e(k,qo),e(qo,br),e(k,wr),x(Le,k,null),e(m,yr),e(m,h),x(Ie,h,null),e(h,Tr),e(h,Ao),e(Ao,kr),e(h,Sr),e(h,ee),e(ee,Dr),e(ee,Lo),e(Lo,Mr),e(ee,$r),e(ee,Io),e(Io,xr),e(ee,Cr),e(h,Pr),e(h,oe),e(oe,jr),e(oe,Fo),e(Fo,zr),e(oe,qr),e(oe,Oo),e(Oo,Ar),e(oe,Lr),e(h,Ir),e(h,te),e(te,A),e(A,Fr),e(A,No),e(No,Or),e(A,Nr),e(A,Wo),e(Wo,Wr),e(A,Vr),e(A,Vo),e(Vo,Br),e(A,Rr),e(te,Hr),e(te,L),e(L,Ur),e(L,Bo),e(Bo,Jr),e(L,Gr),e(L,oo),e(oo,Yr),e(L,Zr),e(L,Ro),e(Ro,Kr),e(L,Qr),e(te,Xr),e(te,w),e(w,ea),e(w,Ho),e(Ho,oa),e(w,ta),e(w,Uo),e(Uo,na),e(w,ra),e(w,Jo),e(Jo,aa),e(w,sa),e(w,Go),e(Go,da),e(w,ca),e(w,Yo),e(Yo,ia),e(w,la),e(h,ha),e(h,I),e(I,pa),e(I,Zo),e(Zo,ma),e(I,fa),e(I,Ko),e(Ko,ua),e(I,ga),e(I,Qo),e(Qo,_a),e(I,va),e(h,Ea),e(h,ne),e(ne,F),e(F,ba),e(F,Xo),e(Xo,wa),e(F,ya),e(F,et),e(et,Ta),e(F,ka),e(F,ot),e(ot,Sa),e(F,Da),e(ne,Ma),e(ne,O),e(O,$a),e(O,tt),e(tt,xa),e(O,Ca),e(O,to),e(to,Pa),e(O,ja),e(O,nt),e(nt,za),e(O,qa),e(ne,Aa),e(ne,y),e(y,La),e(y,rt),e(rt,Ia),e(y,Fa),e(y,at),e(at,Oa),e(y,Na),e(y,st),e(st,Wa),e(y,Va),e(y,dt),e(dt,Ba),e(y,Ra),e(y,ct),e(ct,Ha),e(y,Ua),e(h,Ja),e(h,re),e(re,Ga),e(re,it),e(it,Ya),e(re,Za),e(re,lt),e(lt,Ka),e(re,Qa),e(h,Xa),e(h,ae),e(ae,es),e(ae,ht),e(ht,os),e(ae,ts),e(ae,pt),e(pt,ns),e(ae,rs),e(h,as),e(h,se),e(se,mt),e(mt,ss),e(se,ds),e(se,ft),e(ft,cs),e(se,is),e(se,ut),e(ut,ls),e(h,hs),e(h,Fe),e(Fe,ps),e(Fe,gt),e(gt,ms),e(Fe,fs),e(h,us),e(h,_t),e(_t,gs),e(h,_s),x(Oe,h,null),Dt=!0},p(d,[f]){const Ne={};f&2&&(Ne.$$scope={dirty:f,ctx:d}),me.$set(Ne)},i(d){Dt||(C(D.$$.fragment,d),C(be.$$.fragment,d),C(we.$$.fragment,d),C(ye.$$.fragment,d),C(Te.$$.fragment,d),C(Se.$$.fragment,d),C(De.$$.fragment,d),C(Me.$$.fragment,d),C(Ae.$$.fragment,d),C(me.$$.fragment,d),C(Le.$$.fragment,d),C(Ie.$$.fragment,d),C(Oe.$$.fragment,d),Dt=!0)},o(d){P(D.$$.fragment,d),P(be.$$.fragment,d),P(we.$$.fragment,d),P(ye.$$.fragment,d),P(Te.$$.fragment,d),P(Se.$$.fragment,d),P(De.$$.fragment,d),P(Me.$$.fragment,d),P(Ae.$$.fragment,d),P(me.$$.fragment,d),P(Le.$$.fragment,d),P(Ie.$$.fragment,d),P(Oe.$$.fragment,d),Dt=!1},d(d){n(g),d&&n(N),d&&n(v),j(D),d&&n(Et),d&&n(T),d&&n(bt),d&&n(V),d&&n(wt),d&&n(B),d&&n(yt),d&&n(G),j(be),d&&n(Tt),d&&n(_),j(we),j(ye),j(Te),j(Se),d&&n(kt),d&&n(K),j(De),d&&n(St),d&&n(m),j(Me),j(Ae),j(me),j(Le),j(Ie),j(Oe)}}}const Zd={local:"speech-encoder-decoder-models",sections:[{local:"transformers.SpeechEncoderDecoderConfig",title:"SpeechEncoderDecoderConfig"},{local:"transformers.SpeechEncoderDecoderModel",title:"SpeechEncoderDecoderModel"}],title:"Speech Encoder Decoder Models"};function Kd(vo,g,N){let{fw:v}=g;return vo.$$set=b=>{"fw"in b&&N(0,v=b.fw)},[v]}class rc extends Bd{constructor(g){super();Rd(this,g,Kd,Yd,Hd,{fw:0})}}export{rc as default,Zd as metadata};
