import{S as Np,i as Rp,s as Bp,e as r,k as i,w as k,t as o,M as Gp,c as a,d as n,m as l,a as s,x as j,h as t,b as c,F as e,g as y,y as M,q as D,o as V,B as $}from"../../chunks/vendor-68651a14.js";import{T as Sp}from"../../chunks/Tip-3fbaa85f.js";import{D as je}from"../../chunks/Docstring-d699e906.js";import{C as tr}from"../../chunks/CodeBlock-b98730f5.js";import{I as Cr}from"../../chunks/IconCopyLink-8ff17449.js";import"../../chunks/CopyButton-e88c769b.js";function Up(Ge){let p,L,v,P,N;return{c(){p=r("p"),L=o(`Although the recipe for forward pass needs to be defined within this function, one should call the
...
processing steps while the latter silently ignores them.`)},l(C){p=a(C,"P",{});var q=s(p);L=t(q,`Although the recipe for forward pass needs to be defined within this function, one should call the
`),v=a(q,"CODE",{});var G=s(v);P=t(G,"Module"),G.forEach(n),N=t(q,` instance afterwards instead of this since the former takes care of running the pre and post
processing steps while the latter silently ignores them.`),q.forEach(n)},m(C,q){y(C,p,q),e(p,L),e(p,v),e(v,P),e(p,N)},d(C){C&&n(p)}}}function Hp(Ge){let p,L,v,P,N,C,q,G,zr,nr,E,qr,Co,Fr,Ar,wt,Lr,Ir,zo,Or,Sr,qo,Nr,Rr,Fo,Br,Gr,Tt,Ur,Wr,Ao,Hr,Zr,Lo,Yr,Jr,Io,Kr,Qr,rr,Me,Xr,Ue,ea,oa,ar,X,ta,Oo,na,ra,So,aa,sa,sr,re,De,xt,We,da,kt,ia,dr,z,He,la,Ve,No,ca,ha,Ro,pa,ma,fa,ae,ga,Bo,ua,_a,Go,va,Ea,ba,jt,ya,wa,Ze,Ta,$e,Ye,xa,Je,ka,Uo,ja,Ma,Da,Pe,Ke,Va,se,$a,Mt,Pa,Ca,Dt,za,qa,ir,de,Ce,Vt,Qe,Fa,$t,Aa,lr,u,Xe,La,ie,Ia,Pt,Oa,Sa,Ct,Na,Ra,Ba,eo,Ga,oo,Ua,Wa,Ha,to,Za,no,Ya,Ja,Ka,zt,Qa,Xa,ro,es,Wo,os,ts,ns,ao,rs,so,as,ss,ds,ee,Ho,is,ls,qt,cs,hs,Ft,ps,ms,fs,I,io,gs,le,us,Zo,_s,vs,At,Es,bs,ys,ze,ws,Lt,Ts,xs,lo,ks,h,co,js,It,Ms,Ds,ce,Vs,Ot,$s,Ps,St,Cs,zs,qs,he,Fs,Nt,As,Ls,Rt,Is,Os,Ss,pe,me,Ns,Bt,Rs,Bs,Gt,Gs,Us,Ws,U,Hs,Ut,Zs,Ys,Yo,Js,Ks,Wt,Qs,Xs,ed,F,od,Ht,td,nd,Zt,rd,ad,Yt,sd,dd,Jt,id,ld,Kt,cd,hd,pd,W,md,Qt,fd,gd,Xt,ud,_d,en,vd,Ed,bd,fe,H,yd,on,wd,Td,tn,xd,kd,nn,jd,Md,Dd,Z,Vd,rn,$d,Pd,Jo,Cd,zd,an,qd,Fd,Ad,A,Ld,sn,Id,Od,dn,Sd,Nd,ln,Rd,Bd,cn,Gd,Ud,hn,Wd,Hd,Zd,ge,Yd,pn,Jd,Kd,mn,Qd,Xd,ei,ue,oi,fn,ti,ni,gn,ri,ai,si,_e,un,di,ii,_n,li,ci,vn,hi,pi,ho,mi,En,fi,gi,ui,bn,_i,vi,po,cr,ve,qe,yn,mo,Ei,wn,bi,hr,_,fo,yi,Ee,wi,Tn,Ti,xi,xn,ki,ji,Mi,go,Di,uo,Vi,$i,Pi,_o,Ci,vo,zi,qi,Fi,kn,Ai,Li,Eo,Ii,Ko,Oi,Si,Ni,bo,Ri,yo,Bi,Gi,Ui,oe,Qo,Wi,Hi,jn,Zi,Yi,Mn,Ji,Ki,Qi,O,wo,Xi,be,el,Xo,ol,tl,Dn,nl,rl,al,Fe,sl,Vn,dl,il,To,ll,m,xo,cl,$n,hl,pl,ye,ml,Pn,fl,gl,Cn,ul,_l,vl,ko,we,El,zn,bl,yl,qn,wl,Tl,xl,Y,kl,Fn,jl,Ml,et,Dl,Vl,An,$l,Pl,Cl,J,zl,Ln,ql,Fl,In,Al,Ll,On,Il,Ol,Sl,jo,K,Nl,Sn,Rl,Bl,Nn,Gl,Ul,Rn,Wl,Hl,Zl,Q,Yl,Bn,Jl,Kl,ot,Ql,Xl,Gn,ec,oc,tc,Te,nc,Un,rc,ac,Wn,sc,dc,ic,xe,lc,Hn,cc,hc,Zn,pc,mc,fc,ke,Yn,gc,uc,Jn,_c,vc,Kn,Ec,bc,Mo,yc,Qn,wc,Tc,xc,Xn,kc,jc,Do,pr;return C=new Cr({}),We=new Cr({}),He=new je({props:{name:"class transformers.VisionEncoderDecoderConfig",anchor:"transformers.VisionEncoderDecoderConfig",parameters:[{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/master/src/transformers/models/vision_encoder_decoder/configuration_vision_encoder_decoder.py#L27",parametersDescription:[{anchor:"transformers.VisionEncoderDecoderConfig.kwargs",description:`<strong>kwargs</strong> (<em>optional</em>) &#x2014;
...
<span class="hljs-meta">&gt;&gt;&gt; </span>model = VisionEncoderDecoderModel.from_pretrained(<span class="hljs-string">&#x27;my-model&#x27;</span>, config=encoder_decoder_config)`}}),Ye=new je({props:{name:"from_encoder_decoder_configs",anchor:"transformers.VisionEncoderDecoderConfig.from_encoder_decoder_configs",parameters:[{name:"encoder_config",val:": PretrainedConfig"},{name:"decoder_config",val:": PretrainedConfig"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/master/src/transformers/models/vision_encoder_decoder/configuration_vision_encoder_decoder.py#L92",returnDescription:`
<p>An instance of a configuration object</p>
`,returnType:`
<p><a
  href="/docs/transformers/master/en/model_doc/visionencoderdecoder#transformers.VisionEncoderDecoderConfig"
>VisionEncoderDecoderConfig</a></p>
`}}),Ke=new je({props:{name:"to_dict",anchor:"transformers.VisionEncoderDecoderConfig.to_dict",parameters:[],source:"https://github.com/huggingface/transformers/blob/master/src/transformers/models/vision_encoder_decoder/configuration_vision_encoder_decoder.py#L109",returnDescription:`
<p>Dictionary of all the attributes that make up this configuration instance,</p>
`,returnType:`
<p><code>Dict[str, any]</code></p>
`}}),Qe=new Cr({}),Xe=new je({props:{name:"class transformers.VisionEncoderDecoderModel",anchor:"transformers.VisionEncoderDecoderModel",parameters:[{name:"config",val:": typing.Optional[transformers.configuration_utils.PretrainedConfig] = None"},{name:"encoder",val:": typing.Optional[transformers.modeling_utils.PreTrainedModel] = None"},{name:"decoder",val:": typing.Optional[transformers.modeling_utils.PreTrainedModel] = None"}],source:"https://github.com/huggingface/transformers/blob/master/src/transformers/models/vision_encoder_decoder/modeling_vision_encoder_decoder.py#L154",parametersDescription:[{anchor:"transformers.VisionEncoderDecoderModel.config",description:`<strong>config</strong> (<a href="/docs/transformers/master/en/model_doc/visionencoderdecoder#transformers.VisionEncoderDecoderConfig">VisionEncoderDecoderConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
...
<span class="hljs-meta">&gt;&gt;&gt; </span>generated_text = processor.batch_decode(generated_ids, skip_special_tokens=<span class="hljs-literal">True</span>)[<span class="hljs-number">0</span>]`}}),co=new je({props:{name:"from_encoder_decoder_pretrained",anchor:"transformers.VisionEncoderDecoderModel.from_encoder_decoder_pretrained",parameters:[{name:"encoder_pretrained_model_name_or_path",val:": str = None"},{name:"decoder_pretrained_model_name_or_path",val:": str = None"},{name:"*model_args",val:""},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/master/src/transformers/models/vision_encoder_decoder/modeling_vision_encoder_decoder.py#L250"}}),po=new tr({props:{code:`from transformers import VisionEncoderDecoderModel
...
`}}),Fe=new Sp({props:{$$slots:{default:[Wp]},$$scope:{ctx:Ge}}}),To=new tr({props:{code:`from transformers import FlaxVisionEncoderDecoderModel, ViTFeatureExtractor, GPT2Tokenizer
from PIL import Image
import requests
...
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-comment"># load fine-tuned model</span>
<span class="hljs-meta">&gt;&gt;&gt; </span>model = FlaxVisionEncoderDecoderModel.from_pretrained(<span class="hljs-string">&quot;./vit-gpt2&quot;</span>)`}}),{c(){p=r("meta"),L=i(),v=r("h1"),P=r("a"),N=r("span"),k(C.$$.fragment),q=i(),G=r("span"),zr=o("Vision Encoder Decoder Models"),nr=i(),E=r("p"),qr=o("The "),Co=r("a"),Fr=o("VisionEncoderDecoderModel"),Ar=o(` can be used to initialize an image-to-text-sequence model with any
pretrained vision autoencoding model as the encoder (`),wt=r("em"),Lr=o("e.g."),Ir=i(),zo=r("a"),Or=o("ViT"),Sr=o(", "),qo=r("a"),Nr=o("BEiT"),Rr=o(", "),Fo=r("a"),Br=o("DeiT"),Gr=o(`)
and any pretrained language model as the decoder (`),Tt=r("em"),Ur=o("e.g."),Wr=i(),Ao=r("a"),Hr=o("RoBERTa"),Zr=o(", "),Lo=r("a"),Yr=o("GPT2"),Jr=o(", "),Io=r("a"),Kr=o("BERT"),Qr=o(")."),rr=i(),Me=r("p"),Xr=o(`The effectiveness of initializing image-to-text-sequence models with pretrained checkpoints has been shown in (for
...
outputs. Read the documentation from `),Go=r("a"),va=o("PretrainedConfig"),Ea=o(" for more information."),ba=i(),jt=r("p"),ya=o("Examples:"),wa=i(),k(Ze.$$.fragment),Ta=i(),$e=r("div"),k(Ye.$$.fragment),xa=i(),Je=r("p"),ka=o("Instantiate a "),Uo=r("a"),ja=o("VisionEncoderDecoderConfig"),Ma=o(` (or a derived class) from a pre-trained encoder
model configuration and decoder model configuration.`),Da=i(),Pe=r("div"),k(Ke.$$.fragment),Va=i(),se=r("p"),$a=o("Serializes this instance to a Python dictionary. Override the default "),Mt=r("em"),Pa=o("to_dict()"),Ca=o(" from "),Dt=r("em"),za=o("PretrainedConfig"),qa=o("."),ir=i(),de=r("h2"),Ce=r("a"),Vt=r("span"),k(Qe.$$.fragment),Fa=i(),$t=r("span"),Aa=o("VisionEncoderDecoderModel"),lr=i(),u=r("div"),k(Xe.$$.fragment),La=i(),ie=r("p"),Ia=o(`This class can be used to initialize an image-to-text-sequence model with any pretrained vision autoencoding model
...
Zhou, Wei Li, Peter J. Liu.`),Ha=i(),to=r("p"),Za=o("Additionally, in "),no=r("a"),Ya=o("TrOCR: Transformer-based Optical Character Recognition with Pre-trained Models"),Ja=o(` it is shown how leveraging large pretrained vision models for optical
...
:meth`),Ft=r("em"),ps=o("~transformers.AutoModelForCausalLM.from_pretrained"),ms=o(" class method for the decoder."),fs=i(),I=r("div"),k(io.$$.fragment),gs=i(),le=r("p"),us=o("The "),Zo=r("a"),_s=o("VisionEncoderDecoderModel"),vs=o(" forward method, overrides the "),At=r("code"),Es=o("__call__"),bs=o(" special method."),ys=i(),k(ze.$$.fragment),ws=i(),Lt=r("p"),Ts=o("Examples:"),xs=i(),k(lo.$$.fragment),ks=i(),h=r("div"),k(co.$$.fragment),js=i(),It=r("p"),Ms=o(`Instantiate an encoder and a decoder from one or two base classes of the library from pretrained model
...
train the model, you need to first set it back in training mode with `),St=r("code"),Cs=o("model.train()"),zs=o("."),qs=i(),he=r("p"),Fs=o(`Params:
encoder`),Nt=r("em"),As=o("pretrained_model_name_or_path (:obj: _str"),Ls=o(", "),Rt=r("em"),Is=o("optional"),Os=o(`):
...
example is `),Gt=r("code"),Gs=o("google/vit-base-patch16-224-in21k"),Us=o("."),Ws=i(),U=r("li"),Hs=o("A path to a "),Ut=r("em"),Zs=o("directory"),Ys=o(` containing model weights saved using
`),Yo=r("a"),Js=o("save_pretrained()"),Ks=o(", e.g., "),Wt=r("code"),Qs=o("./my_model_directory/"),Xs=o("."),ed=i(),F=r("li"),od=o("A path or url to a "),Ht=r("em"),td=o("tensorflow index checkpoint file"),nd=o(" (e.g, "),Zt=r("code"),rd=o("./tf_model/model.ckpt.index"),ad=o(`). In
this case, `),Yt=r("code"),sd=o("from_tf"),dd=o(" should be set to "),Jt=r("code"),id=o("True"),ld=o(` and a configuration object should be provided
...
`),Jo=r("a"),Cd=o("save_pretrained()"),zd=o(", e.g., "),an=r("code"),qd=o("./my_model_directory/"),Fd=o("."),Ad=i(),A=r("li"),Ld=o("A path or url to a "),sn=r("em"),Id=o("tensorflow index checkpoint file"),Od=o(" (e.g, "),dn=r("code"),Sd=o("./tf_model/model.ckpt.index"),Nd=o(`). In
...
a PyTorch model using the provided conversion scripts and loading the PyTorch model afterwards.`),Zd=i(),ge=r("p"),Yd=o("model"),pn=r("em"),Jd=o("args (remaining positional arguments, _optional"),Kd=o(`):
...
character recognition (OCR) yields a significant performance improvement.`),Fi=i(),kn=r("p"),Ai=o(`After such a Vision-Encoder-Text-Decoder model has been trained/fine-tuned, it can be saved/loaded just like any
...
:meth`),jn=r("em"),Zi=o("~transformers.FlaxAutoModel.from_pretrained"),Yi=o(` class method for the encoder and
:meth`),Mn=r("em"),Ji=o("~transformers.FlaxAutoModelForCausalLM.from_pretrained"),Ki=o(" class method for the decoder."),Qi=i(),O=r("div"),k(wo.$$.fragment),Xi=i(),be=r("p"),el=o("The "),Xo=r("a"),ol=o("FlaxVisionEncoderDecoderModel"),tl=o(" forward method, overrides the "),Dn=r("code"),nl=o("__call__"),rl=o(" special method."),al=i(),k(Fe.$$.fragment),sl=i(),Vn=r("p"),dl=o("Examples:"),il=i(),k(To.$$.fragment),ll=i(),m=r("div"),k(xo.$$.fragment),cl=i(),$n=r("p"),hl=o(`Instantiate an encoder and a decoder from one or two base classes of the library from pretrained model
...
example is `),qn=r("code"),wl=o("google/vit-base-patch16-224-in21k"),Tl=o("."),xl=i(),Y=r("li"),kl=o("A path to a "),Fn=r("em"),jl=o("directory"),Ml=o(` containing model weights saved using
`),et=r("a"),Dl=o("save_pretrained()"),Vl=o(", e.g., "),An=r("code"),$l=o("./my_model_directory/"),Pl=o("."),Cl=i(),J=r("p"),zl=o("decoder"),Ln=r("em"),ql=o("pretrained_model_name_or_path (:obj: _Union[str, os.PathLike]"),Fl=o(", "),In=r("em"),Al=o("optional"),Ll=o(", defaults to "),On=r("em"),Il=o("None"),Ol=o(`):
...
a user or organization name, like `),Rn=r("code"),Wl=o("dbmdz/bert-base-german-cased"),Hl=o("."),Zl=i(),Q=r("li"),Yl=o("A path to a "),Bn=r("em"),Jl=o("directory"),Kl=o(` containing model weights saved using
...
Can be used to update the configuration object (after it being loaded) and initiate the model (e.g.,
`),Zn=r("code"),pc=o("output_attentions=True"),mc=o(")."),fc=i(),ke=r("ul"),Yn=r("li"),gc=o("To update the encoder configuration, use the prefix _encoder__ for each configuration parameter."),uc=i(),Jn=r("li"),_c=o("To update the decoder configuration, use the prefix _decoder__ for each configuration parameter."),vc=i(),Kn=r("li"),Ec=o("To update the parent model configuration, do not use a prefix for each configuration parameter."),bc=i(),Mo=r("p"),yc=o("Behaves differently depending on whether a "),Qn=r("code"),wc=o("config"),Tc=o(" is provided or automatically loaded."),xc=i(),Xn=r("p"),kc=o("Example:"),jc=i(),k(Do.$$.fragment),this.h()},l(d){const f=Gp('[data-svelte="svelte-1phssyn"]',document.head);p=a(f,"META",{name:!0,content:!0}),f.forEach(n),L=l(d),v=a(d,"H1",{class:!0});var Vo=s(v);P=a(Vo,"A",{id:!0,class:!0,href:!0});var er=s(P);N=a(er,"SPAN",{});var Mc=s(N);j(C.$$.fragment,Mc),Mc.forEach(n),er.forEach(n),q=l(Vo),G=a(Vo,"SPAN",{});var Dc=s(G);zr=t(Dc,"Vision Encoder Decoder Models"),Dc.forEach(n),Vo.forEach(n),nr=l(d),E=a(d,"P",{});var w=s(E);qr=t(w,"The "),Co=a(w,"A",{href:!0});var Vc=s(Co);Fr=t(Vc,"VisionEncoderDecoderModel"),Vc.forEach(n),Ar=t(w,` can be used to initialize an image-to-text-sequence model with any
pretrained vision autoencoding model as the encoder (`),wt=a(w,"EM",{});var $c=s(wt);Lr=t($c,"e.g."),$c.forEach(n),Ir=l(w),zo=a(w,"A",{href:!0});var Pc=s(zo);Or=t(Pc,"ViT"),Pc.forEach(n),Sr=t(w,", "),qo=a(w,"A",{href:!0});var Cc=s(qo);Nr=t(Cc,"BEiT"),Cc.forEach(n),Rr=t(w,", "),Fo=a(w,"A",{href:!0});var zc=s(Fo);Br=t(zc,"DeiT"),zc.forEach(n),Gr=t(w,`)
and any pretrained language model as the decoder (`),Tt=a(w,"EM",{});var qc=s(Tt);Ur=t(qc,"e.g."),qc.forEach(n),Wr=l(w),Ao=a(w,"A",{href:!0});var Fc=s(Ao);Hr=t(Fc,"RoBERTa"),Fc.forEach(n),Zr=t(w,", "),Lo=a(w,"A",{href:!0});var Ac=s(Lo);Yr=t(Ac,"GPT2"),Ac.forEach(n),Jr=t(w,", "),Io=a(w,"A",{href:!0});var Lc=s(Io);Kr=t(Lc,"BERT"),Lc.forEach(n),Qr=t(w,")."),w.forEach(n),rr=l(d),Me=a(d,"P",{});var mr=s(Me);Xr=t(mr,`The effectiveness of initializing image-to-text-sequence models with pretrained checkpoints has been shown in (for
...
outputs. Read the documentation from `),Go=a(nt,"A",{href:!0});var Hc=s(Go);va=t(Hc,"PretrainedConfig"),Hc.forEach(n),Ea=t(nt," for more information."),nt.forEach(n),ba=l(S),jt=a(S,"P",{});var Zc=s(jt);ya=t(Zc,"Examples:"),Zc.forEach(n),wa=l(S),j(Ze.$$.fragment,S),Ta=l(S),$e=a(S,"DIV",{class:!0});var gr=s($e);j(Ye.$$.fragment,gr),xa=l(gr),Je=a(gr,"P",{});var ur=s(Je);ka=t(ur,"Instantiate a "),Uo=a(ur,"A",{href:!0});var Yc=s(Uo);ja=t(Yc,"VisionEncoderDecoderConfig"),Yc.forEach(n),Ma=t(ur,` (or a derived class) from a pre-trained encoder
model configuration and decoder model configuration.`),ur.forEach(n),gr.forEach(n),Da=l(S),Pe=a(S,"DIV",{class:!0});var _r=s(Pe);j(Ke.$$.fragment,_r),Va=l(_r),se=a(_r,"P",{});var rt=s(se);$a=t(rt,"Serializes this instance to a Python dictionary. Override the default "),Mt=a(rt,"EM",{});var Jc=s(Mt);Pa=t(Jc,"to_dict()"),Jc.forEach(n),Ca=t(rt," from "),Dt=a(rt,"EM",{});var Kc=s(Dt);za=t(Kc,"PretrainedConfig"),Kc.forEach(n),qa=t(rt,"."),rt.forEach(n),_r.forEach(n),S.forEach(n),ir=l(d),de=a(d,"H2",{class:!0});var vr=s(de);Ce=a(vr,"A",{id:!0,class:!0,href:!0});var Qc=s(Ce);Vt=a(Qc,"SPAN",{});var Xc=s(Vt);j(Qe.$$.fragment,Xc),Xc.forEach(n),Qc.forEach(n),Fa=l(vr),$t=a(vr,"SPAN",{});var eh=s($t);Aa=t(eh,"VisionEncoderDecoderModel"),eh.forEach(n),vr.forEach(n),lr=l(d),u=a(d,"DIV",{class:!0});var T=s(u);j(Xe.$$.fragment,T),La=l(T),ie=a(T,"P",{});var at=s(ie);Ia=t(at,`This class can be used to initialize an image-to-text-sequence model with any pretrained vision autoencoding model
as the encoder and any pretrained text autoregressive model as the decoder. The encoder is loaded via
...
Zhou, Wei Li, Peter J. Liu.`),Er.forEach(n),Ha=l(T),to=a(T,"P",{});var br=s(to);Za=t(br,"Additionally, in "),no=a(br,"A",{href:!0,rel:!0});var rh=s(no);Ya=t(rh,"TrOCR: Transformer-based Optical Character Recognition with Pre-trained Models"),rh.forEach(n),Ja=t(br,` it is shown how leveraging large pretrained vision models for optical
...
:meth`),Ft=a($o,"EM",{});var ch=s(Ft);ps=t(ch,"~transformers.AutoModelForCausalLM.from_pretrained"),ch.forEach(n),ms=t($o," class method for the decoder."),$o.forEach(n),fs=l(T),I=a(T,"DIV",{class:!0});var te=s(I);j(io.$$.fragment,te),gs=l(te),le=a(te,"P",{});var st=s(le);us=t(st,"The "),Zo=a(st,"A",{href:!0});var hh=s(Zo);_s=t(hh,"VisionEncoderDecoderModel"),hh.forEach(n),vs=t(st," forward method, overrides the "),At=a(st,"CODE",{});var ph=s(At);Es=t(ph,"__call__"),ph.forEach(n),bs=t(st," special method."),st.forEach(n),ys=l(te),j(ze.$$.fragment,te),ws=l(te),Lt=a(te,"P",{});var mh=s(Lt);Ts=t(mh,"Examples:"),mh.forEach(n),xs=l(te),j(lo.$$.fragment,te),te.forEach(n),ks=l(T),h=a(T,"DIV",{class:!0});var g=s(h);j(co.$$.fragment,g),js=l(g),It=a(g,"P",{});var fh=s(It);Ms=t(fh,`Instantiate an encoder and a decoder from one or two base classes of the library from pretrained model
...
train the model, you need to first set it back in training mode with `),St=a(dt,"CODE",{});var uh=s(St);Cs=t(uh,"model.train()"),uh.forEach(n),zs=t(dt,"."),dt.forEach(n),qs=l(g),he=a(g,"P",{});var it=s(he);Fs=t(it,`Params:
encoder`),Nt=a(it,"EM",{});var _h=s(Nt);As=t(_h,"pretrained_model_name_or_path (:obj: _str"),_h.forEach(n),Ls=t(it,", "),Rt=a(it,"EM",{});var vh=s(Rt);Is=t(vh,"optional"),vh.forEach(n),Os=t(it,`):
...
example is `),Gt=a(ct,"CODE",{});var bh=s(Gt);Gs=t(bh,"google/vit-base-patch16-224-in21k"),bh.forEach(n),Us=t(ct,"."),ct.forEach(n),Ws=l(lt),U=a(lt,"LI",{});var Ae=s(U);Hs=t(Ae,"A path to a "),Ut=a(Ae,"EM",{});var yh=s(Ut);Zs=t(yh,"directory"),yh.forEach(n),Ys=t(Ae,` containing model weights saved using
`),Yo=a(Ae,"A",{href:!0});var wh=s(Yo);Js=t(wh,"save_pretrained()"),wh.forEach(n),Ks=t(Ae,", e.g., "),Wt=a(Ae,"CODE",{});var Th=s(Wt);Qs=t(Th,"./my_model_directory/"),Th.forEach(n),Xs=t(Ae,"."),Ae.forEach(n),ed=l(lt),F=a(lt,"LI",{});var R=s(F);od=t(R,"A path or url to a "),Ht=a(R,"EM",{});var xh=s(Ht);td=t(xh,"tensorflow index checkpoint file"),xh.forEach(n),nd=t(R," (e.g, "),Zt=a(R,"CODE",{});var kh=s(Zt);rd=t(kh,"./tf_model/model.ckpt.index"),kh.forEach(n),ad=t(R,`). In
this case, `),Yt=a(R,"CODE",{});var jh=s(Yt);sd=t(jh,"from_tf"),jh.forEach(n),dd=t(R," should be set to "),Jt=a(R,"CODE",{});var Mh=s(Jt);id=t(Mh,"True"),Mh.forEach(n),ld=t(R,` and a configuration object should be provided
...
a user or organization name, like `),nn=a(Ie,"CODE",{});var qh=s(nn);jd=t(qh,"dbmdz/bert-base-german-cased"),qh.forEach(n),Md=t(Ie,"."),Ie.forEach(n),Dd=l(ht),Z=a(ht,"LI",{});var Oe=s(Z);Vd=t(Oe,"A path to a "),rn=a(Oe,"EM",{});var Fh=s(rn);$d=t(Fh,"directory"),Fh.forEach(n),Pd=t(Oe,` containing model weights saved using
`),Jo=a(Oe,"A",{href:!0});var Ah=s(Jo);Cd=t(Ah,"save_pretrained()"),Ah.forEach(n),zd=t(Oe,", e.g., "),an=a(Oe,"CODE",{});var Lh=s(an);qd=t(Lh,"./my_model_directory/"),Lh.forEach(n),Fd=t(Oe,"."),Oe.forEach(n),Ad=l(ht),A=a(ht,"LI",{});var B=s(A);Ld=t(B,"A path or url to a "),sn=a(B,"EM",{});var Ih=s(sn);Id=t(Ih,"tensorflow index checkpoint file"),Ih.forEach(n),Od=t(B," (e.g, "),dn=a(B,"CODE",{});var Oh=s(dn);Sd=t(Oh,"./tf_model/model.ckpt.index"),Oh.forEach(n),Nd=t(B,`). In
...
a PyTorch model using the provided conversion scripts and loading the PyTorch model afterwards.`),B.forEach(n),ht.forEach(n),Zd=l(g),ge=a(g,"P",{});var pt=s(ge);Yd=t(pt,"model"),pn=a(pt,"EM",{});var Bh=s(pn);Jd=t(Bh,"args (remaining positional arguments, _optional"),Bh.forEach(n),Kd=t(pt,`):
...
character recognition (OCR) yields a significant performance improvement.`),jr.forEach(n),Fi=l(x),kn=a(x,"P",{});var ap=s(kn);Ai=t(ap,`After such a Vision-Encoder-Text-Decoder model has been trained/fine-tuned, it can be saved/loaded just like any
...
example is `),qn=a(vt,"CODE",{});var vp=s(qn);wl=t(vp,"google/vit-base-patch16-224-in21k"),vp.forEach(n),Tl=t(vt,"."),vt.forEach(n),xl=l(Vr),Y=a(Vr,"LI",{});var Se=s(Y);kl=t(Se,"A path to a "),Fn=a(Se,"EM",{});var Ep=s(Fn);jl=t(Ep,"directory"),Ep.forEach(n),Ml=t(Se,` containing model weights saved using
`),et=a(Se,"A",{href:!0});var bp=s(et);Dl=t(bp,"save_pretrained()"),bp.forEach(n),Vl=t(Se,", e.g., "),An=a(Se,"CODE",{});var yp=s(An);$l=t(yp,"./my_model_directory/"),yp.forEach(n),Pl=t(Se,"."),Se.forEach(n),Vr.forEach(n),Cl=l(b),J=a(b,"P",{});var Ne=s(J);zl=t(Ne,"decoder"),Ln=a(Ne,"EM",{});var wp=s(Ln);ql=t(wp,"pretrained_model_name_or_path (:obj: _Union[str, os.PathLike]"),wp.forEach(n),Fl=t(Ne,", "),In=a(Ne,"EM",{});var Tp=s(In);Al=t(Tp,"optional"),Tp.forEach(n),Ll=t(Ne,", defaults to "),On=a(Ne,"EM",{});var xp=s(On);Il=t(xp,"None"),xp.forEach(n),Ol=t(Ne,`):
...
a user or organization name, like `),Rn=a(Re,"CODE",{});var Mp=s(Rn);Wl=t(Mp,"dbmdz/bert-base-german-cased"),Mp.forEach(n),Hl=t(Re,"."),Re.forEach(n),Zl=l($r),Q=a($r,"LI",{});var Be=s(Q);Yl=t(Be,"A path to a "),Bn=a(Be,"EM",{});var Dp=s(Bn);Jl=t(Dp,"directory"),Dp.forEach(n),Kl=t(Be,` containing model weights saved using
...
Can be used to update the configuration object (after it being loaded) and initiate the model (e.g.,
`),Zn=a(bt,"CODE",{});var qp=s(Zn);pc=t(qp,"output_attentions=True"),qp.forEach(n),mc=t(bt,")."),bt.forEach(n),fc=l(b),ke=a(b,"UL",{});var yt=s(ke);Yn=a(yt,"LI",{});var Fp=s(Yn);gc=t(Fp,"To update the encoder configuration, use the prefix _encoder__ for each configuration parameter."),Fp.forEach(n),uc=l(yt),Jn=a(yt,"LI",{});var Ap=s(Jn);_c=t(Ap,"To update the decoder configuration, use the prefix _decoder__ for each configuration parameter."),Ap.forEach(n),vc=l(yt),Kn=a(yt,"LI",{});var Lp=s(Kn);Ec=t(Lp,"To update the parent model configuration, do not use a prefix for each configuration parameter."),Lp.forEach(n),yt.forEach(n),bc=l(b),Mo=a(b,"P",{});var Pr=s(Mo);yc=t(Pr,"Behaves differently depending on whether a "),Qn=a(Pr,"CODE",{});var Ip=s(Qn);wc=t(Ip,"config"),Ip.forEach(n),Tc=t(Pr," is provided or automatically loaded."),Pr.forEach(n),xc=l(b),Xn=a(b,"P",{});var Op=s(Xn);kc=t(Op,"Example:"),Op.forEach(n),jc=l(b),j(Do.$$.fragment,b),b.forEach(n),x.forEach(n),this.h()},h(){c(p,"name","hf:doc:metadata"),c(p,"content",JSON.stringify(Zp)),c(P,"id","vision-encoder-decoder-models"),c(P,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(P,"href","#vision-encoder-decoder-models"),c(v,"class","relative group"),c(Co,"href","/docs/transformers/master/en/model_doc/visionencoderdecoder#transformers.VisionEncoderDecoderModel"),c(zo,"href","/docs/transformers/master/en/vit"),c(qo,"href","/docs/transformers/master/en/beit"),c(Fo,"href","/docs/transformers/master/en/deit"),c(Ao,"href","/docs/transformers/master/en/roberta"),c(Lo,"href","/docs/transformers/master/en/gpt2"),c(Io,"href","/docs/transformers/master/en/bert"),c(Ue,"href","https://arxiv.org/abs/2109.10282"),c(Ue,"rel","nofollow"),c(Oo,"href","/docs/transformers/master/en/model_doc/visionencoderdecoder#transformers.VisionEncoderDecoderModel"),c(So,"href","/docs/transformers/master/en/trocr"),c(De,"id","transformers.VisionEncoderDecoderConfig"),c(De,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(De,"href","#transformers.VisionEncoderDecoderConfig"),c(re,"class","relative group"),c(No,"href","/docs/transformers/master/en/model_doc/visionencoderdecoder#transformers.VisionEncoderDecoderConfig"),c(Ro,"href","/docs/transformers/master/en/model_doc/visionencoderdecoder#transformers.VisionEncoderDecoderModel"),c(Bo,"href","/docs/transformers/master/en/main_classes/configuration#transformers.PretrainedConfig"),c(Go,"href","/docs/transformers/master/en/main_classes/configuration#transformers.PretrainedConfig"),c(Uo,"href","/docs/transformers/master/en/model_doc/visionencoderdecoder#transformers.VisionEncoderDecoderConfig"),c($e,"class","docstring"),c(Pe,"class","docstring"),c(z,"class","docstring"),c(Ce,"id","transformers.VisionEncoderDecoderModel"),c(Ce,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(Ce,"href","#transformers.VisionEncoderDecoderModel"),c(de,"class","relative group"),c(oo,"href","https://arxiv.org/abs/1907.12461"),c(oo,"rel","nofollow"),c(no,"href","https://arxiv.org/abs/2109.10282"),c(no,"rel","nofollow"),c(Wo,"href","/docs/transformers/master/en/main_classes/model#transformers.PreTrainedModel"),c(so,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),c(so,"rel","nofollow"),c(Ho,"href","/docs/transformers/master/en/model_doc/visionencoderdecoder#transformers.VisionEncoderDecoderModel"),c(Zo,"href","/docs/transformers/master/en/model_doc/visionencoderdecoder#transformers.VisionEncoderDecoderModel"),c(I,"class","docstring"),c(Yo,"href","/docs/transformers/master/en/main_classes/model#transformers.PreTrainedModel.save_pretrained"),c(Jo,"href","/docs/transformers/master/en/main_classes/model#transformers.PreTrainedModel.save_pretrained"),c(h,"class","docstring"),c(u,"class","docstring"),c(qe,"id","transformers.FlaxVisionEncoderDecoderModel"),c(qe,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(qe,"href","#transformers.FlaxVisionEncoderDecoderModel"),c(ve,"class","relative group"),c(uo,"href","https://arxiv.org/abs/1907.12461"),c(uo,"rel","nofollow"),c(vo,"href","https://arxiv.org/abs/2109.10282"),c(vo,"rel","nofollow"),c(Ko,"href","/docs/transformers/master/en/main_classes/model#transformers.FlaxPreTrainedModel"),c(yo,"href","https://flax.readthedocs.io/en/latest/_autosummary/flax.nn.module.html"),c(yo,"rel","nofollow"),c(Qo,"href","/docs/transformers/master/en/model_doc/visionencoderdecoder#transformers.FlaxVisionEncoderDecoderModel"),c(Xo,"href","/docs/transformers/master/en/model_doc/visionencoderdecoder#transformers.FlaxVisionEncoderDecoderModel"),c(O,"class","docstring"),c(et,"href","/docs/transformers/master/en/main_classes/model#transformers.FlaxPreTrainedModel.save_pretrained"),c(ot,"href","/docs/transformers/master/en/main_classes/model#transformers.FlaxPreTrainedModel.save_pretrained"),c(m,"class","docstring"),c(_,"class","docstring")},m(d,f){e(document.head,p),y(d,L,f),y(d,v,f),e(v,P),e(P,N),M(C,N,null),e(v,q),e(v,G),e(G,zr),y(d,nr,f),y(d,E,f),e(E,qr),e(E,Co),e(Co,Fr),e(E,Ar),e(E,wt),e(wt,Lr),e(E,Ir),e(E,zo),e(zo,Or),e(E,Sr),e(E,qo),e(qo,Nr),e(E,Rr),e(E,Fo),e(Fo,Br),e(E,Gr),e(E,Tt),e(Tt,Ur),e(E,Wr),e(E,Ao),e(Ao,Hr),e(E,Zr),e(E,Lo),e(Lo,Yr),e(E,Jr),e(E,Io),e(Io,Kr),e(E,Qr),y(d,rr,f),y(d,Me,f),e(Me,Xr),e(Me,Ue),e(Ue,ea),e(Me,oa),y(d,ar,f),y(d,X,f),e(X,ta),e(X,Oo),e(Oo,na),e(X,ra),e(X,So),e(So,aa),e(X,sa),y(d,sr,f),y(d,re,f),e(re,De),e(De,xt),M(We,xt,null),e(re,da),e(re,kt),e(kt,ia),y(d,dr,f),y(d,z,f),M(He,z,null),e(z,la),e(z,Ve),e(Ve,No),e(No,ca),e(Ve,ha),e(Ve,Ro),e(Ro,pa),e(Ve,ma),e(z,fa),e(z,ae),e(ae,ga),e(ae,Bo),e(Bo,ua),e(ae,_a),e(ae,Go),e(Go,va),e(ae,Ea),e(z,ba),e(z,jt),e(jt,ya),e(z,wa),M(Ze,z,null),e(z,Ta),e(z,$e),M(Ye,$e,null),e($e,xa),e($e,Je),e(Je,ka),e(Je,Uo),e(Uo,ja),e(Je,Ma),e(z,Da),e(z,Pe),M(Ke,Pe,null),e(Pe,Va),e(Pe,se),e(se,$a),e(se,Mt),e(Mt,Pa),e(se,Ca),e(se,Dt),e(Dt,za),e(se,qa),y(d,ir,f),y(d,de,f),e(de,Ce),e(Ce,Vt),M(Qe,Vt,null),e(de,Fa),e(de,$t),e($t,Aa),y(d,lr,f),y(d,u,f),M(Xe,u,null),e(u,La),e(u,ie),e(ie,Ia),e(ie,Pt),e(Pt,Oa),e(ie,Sa),e(ie,Ct),e(Ct,Na),e(ie,Ra),e(u,Ba),e(u,eo),e(eo,Ga),e(eo,oo),e(oo,Ua),e(eo,Wa),e(u,Ha),e(u,to),e(to,Za),e(to,no),e(no,Ya),e(to,Ja),e(u,Ka),e(u,zt),e(zt,Qa),e(u,Xa),e(u,ro),e(ro,es),e(ro,Wo),e(Wo,os),e(ro,ts),e(u,ns),e(u,ao),e(ao,rs),e(ao,so),e(so,as),e(ao,ss),e(u,ds),e(u,ee),e(ee,Ho),e(Ho,is),e(ee,ls),e(ee,qt),e(qt,cs),e(ee,hs),e(ee,Ft),e(Ft,ps),e(ee,ms),e(u,fs),e(u,I),M(io,I,null),e(I,gs),e(I,le),e(le,us),e(le,Zo),e(Zo,_s),e(le,vs),e(le,At),e(At,Es),e(le,bs),e(I,ys),M(ze,I,null),e(I,ws),e(I,Lt),e(Lt,Ts),e(I,xs),M(lo,I,null),e(u,ks),e(u,h),M(co,h,null),e(h,js),e(h,It),e(It,Ms),e(h,Ds),e(h,ce),e(ce,Vs),e(ce,Ot),e(Ot,$s),e(ce,Ps),e(ce,St),e(St,Cs),e(ce,zs),e(h,qs),e(h,he),e(he,Fs),e(he,Nt),e(Nt,As),e(he,Ls),e(he,Rt),e(Rt,Is),e(he,Os),e(h,Ss),e(h,pe),e(pe,me),e(me,Ns),e(me,Bt),e(Bt,Rs),e(me,Bs),e(me,Gt),e(Gt,Gs),e(me,Us),e(pe,Ws),e(pe,U),e(U,Hs),e(U,Ut),e(Ut,Zs),e(U,Ys),e(U,Yo),e(Yo,Js),e(U,Ks),e(U,Wt),e(Wt,Qs),e(U,Xs),e(pe,ed),e(pe,F),e(F,od),e(F,Ht),e(Ht,td),e(F,nd),e(F,Zt),e(Zt,rd),e(F,ad),e(F,Yt),e(Yt,sd),e(F,dd),e(F,Jt),e(Jt,id),e(F,ld),e(F,Kt),e(Kt,cd),e(F,hd),e(h,pd),e(h,W),e(W,md),e(W,Qt),e(Qt,fd),e(W,gd),e(W,Xt),e(Xt,ud),e(W,_d),e(W,en),e(en,vd),e(W,Ed),e(h,bd),e(h,fe),e(fe,H),e(H,yd),e(H,on),e(on,wd),e(H,Td),e(H,tn),e(tn,xd),e(H,kd),e(H,nn),e(nn,jd),e(H,Md),e(fe,Dd),e(fe,Z),e(Z,Vd),e(Z,rn),e(rn,$d),e(Z,Pd),e(Z,Jo),e(Jo,Cd),e(Z,zd),e(Z,an),e(an,qd),e(Z,Fd),e(fe,Ad),e(fe,A),e(A,Ld),e(A,sn),e(sn,Id),e(A,Od),e(A,dn),e(dn,Sd),e(A,Nd),e(A,ln),e(ln,Rd),e(A,Bd),e(A,cn),e(cn,Gd),e(A,Ud),e(A,hn),e(hn,Wd),e(A,Hd),e(h,Zd),e(h,ge),e(ge,Yd),e(ge,pn),e(pn,Jd),e(ge,Kd),e(ge,mn),e(mn,Qd),e(ge,Xd),e(h,ei),e(h,ue),e(ue,oi),e(ue,fn),e(fn,ti),e(ue,ni),e(ue,gn),e(gn,ri),e(ue,ai),e(h,si),e(h,_e),e(_e,un),e(un,di),e(_e,ii),e(_e,_n),e(_n,li),e(_e,ci),e(_e,vn),e(vn,hi),e(h,pi),e(h,ho),e(ho,mi),e(ho,En),e(En,fi),e(ho,gi),e(h,ui),e(h,bn),e(bn,_i),e(h,vi),M(po,h,null),y(d,cr,f),y(d,ve,f),e(ve,qe),e(qe,yn),M(mo,yn,null),e(ve,Ei),e(ve,wn),e(wn,bi),y(d,hr,f),y(d,_,f),M(fo,_,null),e(_,yi),e(_,Ee),e(Ee,wi),e(Ee,Tn),e(Tn,Ti),e(Ee,xi),e(Ee,xn),e(xn,ki),e(Ee,ji),e(_,Mi),e(_,go),e(go,Di),e(go,uo),e(uo,Vi),e(go,$i),e(_,Pi),e(_,_o),e(_o,Ci),e(_o,vo),e(vo,zi),e(_o,qi),e(_,Fi),e(_,kn),e(kn,Ai),e(_,Li),e(_,Eo),e(Eo,Ii),e(Eo,Ko),e(Ko,Oi),e(Eo,Si),e(_,Ni),e(_,bo),e(bo,Ri),e(bo,yo),e(yo,Bi),e(bo,Gi),e(_,Ui),e(_,oe),e(oe,Qo),e(Qo,Wi),e(oe,Hi),e(oe,jn),e(jn,Zi),e(oe,Yi),e(oe,Mn),e(Mn,Ji),e(oe,Ki),e(_,Qi),e(_,O),M(wo,O,null),e(O,Xi),e(O,be),e(be,el),e(be,Xo),e(Xo,ol),e(be,tl),e(be,Dn),e(Dn,nl),e(be,rl),e(O,al),M(Fe,O,null),e(O,sl),e(O,Vn),e(Vn,dl),e(O,il),M(To,O,null),e(_,ll),e(_,m),M(xo,m,null),e(m,cl),e(m,$n),e($n,hl),e(m,pl),e(m,ye),e(ye,ml),e(ye,Pn),e(Pn,fl),e(ye,gl),e(ye,Cn),e(Cn,ul),e(ye,_l),e(m,vl),e(m,ko),e(ko,we),e(we,El),e(we,zn),e(zn,bl),e(we,yl),e(we,qn),e(qn,wl),e(we,Tl),e(ko,xl),e(ko,Y),e(Y,kl),e(Y,Fn),e(Fn,jl),e(Y,Ml),e(Y,et),e(et,Dl),e(Y,Vl),e(Y,An),e(An,$l),e(Y,Pl),e(m,Cl),e(m,J),e(J,zl),e(J,Ln),e(Ln,ql),e(J,Fl),e(J,In),e(In,Al),e(J,Ll),e(J,On),e(On,Il),e(J,Ol),e(m,Sl),e(m,jo),e(jo,K),e(K,Nl),e(K,Sn),e(Sn,Rl),e(K,Bl),e(K,Nn),e(Nn,Gl),e(K,Ul),e(K,Rn),e(Rn,Wl),e(K,Hl),e(jo,Zl),e(jo,Q),e(Q,Yl),e(Q,Bn),e(Bn,Jl),e(Q,Kl),e(Q,ot),e(ot,Ql),e(Q,Xl),e(Q,Gn),e(Gn,ec),e(Q,oc),e(m,tc),e(m,Te),e(Te,nc),e(Te,Un),e(Un,rc),e(Te,ac),e(Te,Wn),e(Wn,sc),e(Te,dc),e(m,ic),e(m,xe),e(xe,lc),e(xe,Hn),e(Hn,cc),e(xe,hc),e(xe,Zn),e(Zn,pc),e(xe,mc),e(m,fc),e(m,ke),e(ke,Yn),e(Yn,gc),e(ke,uc),e(ke,Jn),e(Jn,_c),e(ke,vc),e(ke,Kn),e(Kn,Ec),e(m,bc),e(m,Mo),e(Mo,yc),e(Mo,Qn),e(Qn,wc),e(Mo,Tc),e(m,xc),e(m,Xn),e(Xn,kc),e(m,jc),M(Do,m,null),pr=!0},p(d,[f]){const Vo={};f&2&&(Vo.$$scope={dirty:f,ctx:d}),ze.$set(Vo);const er={};f&2&&(er.$$scope={dirty:f,ctx:d}),Fe.$set(er)},i(d){pr||(D(C.$$.fragment,d),D(We.$$.fragment,d),D(He.$$.fragment,d),D(Ze.$$.fragment,d),D(Ye.$$.fragment,d),D(Ke.$$.fragment,d),D(Qe.$$.fragment,d),D(Xe.$$.fragment,d),D(io.$$.fragment,d),D(ze.$$.fragment,d),D(lo.$$.fragment,d),D(co.$$.fragment,d),D(po.$$.fragment,d),D(mo.$$.fragment,d),D(fo.$$.fragment,d),D(wo.$$.fragment,d),D(Fe.$$.fragment,d),D(To.$$.fragment,d),D(xo.$$.fragment,d),D(Do.$$.fragment,d),pr=!0)},o(d){V(C.$$.fragment,d),V(We.$$.fragment,d),V(He.$$.fragment,d),V(Ze.$$.fragment,d),V(Ye.$$.fragment,d),V(Ke.$$.fragment,d),V(Qe.$$.fragment,d),V(Xe.$$.fragment,d),V(io.$$.fragment,d),V(ze.$$.fragment,d),V(lo.$$.fragment,d),V(co.$$.fragment,d),V(po.$$.fragment,d),V(mo.$$.fragment,d),V(fo.$$.fragment,d),V(wo.$$.fragment,d),V(Fe.$$.fragment,d),V(To.$$.fragment,d),V(xo.$$.fragment,d),V(Do.$$.fragment,d),pr=!1},d(d){n(p),d&&n(L),d&&n(v),$(C),d&&n(nr),d&&n(E),d&&n(rr),d&&n(Me),d&&n(ar),d&&n(X),d&&n(sr),d&&n(re),$(We),d&&n(dr),d&&n(z),$(He),$(Ze),$(Ye),$(Ke),d&&n(ir),d&&n(de),$(Qe),d&&n(lr),d&&n(u),$(Xe),$(io),$(ze),$(lo),$(co),$(po),d&&n(cr),d&&n(ve),$(mo),d&&n(hr),d&&n(_),$(fo),$(wo),$(Fe),$(To),$(xo),$(Do)}}}const Zp={local:"vision-encoder-decoder-models",sections:[{local:"transformers.VisionEncoderDecoderConfig",title:"VisionEncoderDecoderConfig"},{local:"transformers.VisionEncoderDecoderModel",title:"VisionEncoderDecoderModel"},{local:"transformers.FlaxVisionEncoderDecoderModel",title:"FlaxVisionEncoderDecoderModel"}],title:"Vision Encoder Decoder Models"};function Yp(Ge,p,L){let{fw:v}=p;return Ge.$$set=P=>{"fw"in P&&L(0,v=P.fw)},[v]}class tm extends Np{constructor(p){super();Rp(this,p,Yp,Hp,Bp,{fw:0})}}export{tm as default,Zp as metadata};
