import{S as di,i as hi,s as pi,e as a,k as l,w as m,t as r,M as fi,c as n,d as o,m as d,a as c,x as u,h as s,b as i,F as e,g as p,y as _,q as g,o as v,B as T}from"../../chunks/vendor-68651a14.js";import{T as li}from"../../chunks/Tip-3fbaa85f.js";import{D as I}from"../../chunks/Docstring-d699e906.js";import{C as Vn}from"../../chunks/CodeBlock-b98730f5.js";import{I as ut}from"../../chunks/IconCopyLink-8ff17449.js";import"../../chunks/CopyButton-e88c769b.js";function mi(ye){let f,q,k,S,L,w,N,j;return{c(){f=a("p"),q=r(`This class method is simply calling AutoFeatureExtractor\u2019s
`),k=a("code"),S=r("from_pretrained"),L=r(` and Speech2Text2Tokenizer\u2019s
...
`),k=n(b,"CODE",{});var C=c(k);S=s(C,"from_pretrained"),C.forEach(o),L=s(b,` and Speech2Text2Tokenizer\u2019s
`),w=n(b,"CODE",{});var A=c(w);N=s(A,"from_pretrained"),A.forEach(o),j=s(b,`. Please refer to the
docstrings of the methods above for more information.`),b.forEach(o)},m(z,b){p(z,f,b),e(f,q),e(f,k),e(k,S),e(f,L),e(f,w),e(w,N),e(f,j)},d(z){z&&o(f)}}}function ui(ye){let f,q,k,S,L,w,N,j;return{c(){f=a("p"),q=r("This class method is simply calling "),k=a("code"),S=r("save_pretrained"),L=r(` and
`),w=a("code"),N=r("save_pretrained"),j=r(`. Please refer to the
docstrings of the methods above for more information.`)},l(z){f=n(z,"P",{});var b=c(f);q=s(b,"This class method is simply calling "),k=n(b,"CODE",{});var C=c(k);S=s(C,"save_pretrained"),C.forEach(o),L=s(b,` and
`),w=n(b,"CODE",{});var A=c(w);N=s(A,"save_pretrained"),A.forEach(o),j=s(b,`. Please refer to the
docstrings of the methods above for more information.`),b.forEach(o)},m(z,b){p(z,f,b),e(f,q),e(f,k),e(k,S),e(f,L),e(f,w),e(w,N),e(f,j)},d(z){z&&o(f)}}}function _i(ye){let f,q,k,S,L,w,N,j,z,b,C,A,so,$e,Cr,ao,qr,Do,H,Ar,_t,Mr,Fr,Ee,Lr,jr,Io,y,Dr,no,Ir,Wr,co,Vr,Nr,gt,Br,Or,vt,Ur,Rr,Tt,Hr,Jr,io,Gr,Kr,Wo,ce,Qr,Pe,Xr,Yr,Vo,ie,Zr,ze,es,ts,No,kt,os,Bo,J,Ce,rs,qe,ss,as,ns,Ae,cs,xt,is,ls,ds,Me,hs,bt,ps,Fe,fs,ms,Oo,Z,le,lo,Le,us,ho,_s,Uo,G,gs,St,vs,Ts,wt,ks,xs,Ro,P,bs,yt,Ss,ws,$t,ys,$s,Et,Es,Ps,Pt,zs,Cs,zt,qs,As,Ho,Ct,po,Ms,Jo,je,Go,qt,De,fo,Fs,Ls,mo,js,Ko,Ie,Qo,de,Ds,We,Is,Ws,Xo,ee,he,uo,Ve,Vs,_o,Ns,Yo,B,Ne,Bs,te,Os,At,Us,Rs,Be,Hs,Js,Gs,oe,Ks,Mt,Qs,Xs,Ft,Ys,Zs,Zo,re,pe,go,Oe,ea,vo,ta,er,E,Ue,oa,To,ra,sa,Re,aa,Lt,na,ca,ia,fe,He,la,ko,da,ha,K,Je,pa,xo,fa,ma,Ge,ua,bo,_a,ga,va,So,tr,se,me,wo,Ke,Ta,yo,ka,or,x,Qe,xa,$o,ba,Sa,M,jt,wa,ya,Dt,$a,Ea,It,Pa,za,Xe,Eo,Ca,qa,Aa,Wt,Ma,Fa,La,ue,Ye,ja,O,Da,Po,Ia,Wa,Vt,Va,Na,Ze,zo,Ba,Oa,Ua,Ra,Q,et,Ha,tt,Ja,Nt,Ga,Ka,Qa,_e,Xa,X,ot,Ya,ae,Za,Co,en,tn,Bt,on,rn,sn,ge,an,ve,rt,nn,st,cn,Ot,ln,dn,hn,Te,at,pn,nt,fn,Ut,mn,un,_n,ke,ct,gn,qo,vn,rr,ne,xe,Ao,it,Tn,Mo,kn,sr,D,lt,xn,U,bn,Rt,Sn,wn,Fo,yn,$n,Ht,En,Pn,zn,dt,Cn,ht,qn,An,Mn,Y,pt,Fn,Lo,Ln,jn,ft,ar;return w=new ut({}),$e=new ut({}),Le=new ut({}),je=new Vn({props:{code:`import torch
...
<span class="hljs-meta">&gt;&gt;&gt; </span>model = SpeechEncoderDecoderModel(encoder=encoder, decoder=decoder)`}}),{c(){f=a("meta"),q=l(),k=a("h1"),S=a("a"),L=a("span"),m(w.$$.fragment),N=l(),j=a("span"),z=r("Speech2Text2"),b=l(),C=a("h2"),A=a("a"),so=a("span"),m($e.$$.fragment),Cr=l(),ao=a("span"),qr=r("Overview"),Do=l(),H=a("p"),Ar=r("The Speech2Text2 model is used together with "),_t=a("a"),Mr=r("Wav2Vec2"),Fr=r(` for Speech Translation models proposed in
`),Ee=a("a"),Lr=r("Large-Scale Self- and Semi-Supervised Learning for Speech Translation"),jr=r(` by
...
the `),qe=a("a"),ss=r("official models"),as=r(" ."),ns=l(),Ae=a("li"),cs=r("Speech2Text2 is always used within the "),xt=a("a"),is=r("SpeechEncoderDecoder"),ls=r(" framework."),ds=l(),Me=a("li"),hs=r("Speech2Text2\u2019s tokenizer is based on "),bt=a("em"),ps=r("fastBPE <"),Fe=a("a"),fs=r("https://github.com/glample/fastBPE>"),ms=r("."),Oo=l(),Z=a("h2"),le=a("a"),lo=a("span"),m(Le.$$.fragment),us=l(),ho=a("span"),_s=r("Inference"),Uo=l(),G=a("p"),gs=r("Speech2Text2\u2019s "),St=a("a"),vs=r("SpeechEncoderDecoderModel"),Ts=r(` model accepts raw waveform input values from speech and
...
outputs. Read the documentation from `),Ft=a("a"),Ys=r("PretrainedConfig"),Zs=r(" for more information."),Zo=l(),re=a("h2"),pe=a("a"),go=a("span"),m(Oe.$$.fragment),ea=l(),vo=a("span"),ta=r("Speech2TextTokenizer"),er=l(),E=a("div"),m(Ue.$$.fragment),oa=l(),To=a("p"),ra=r("Constructs a Speech2Text2Tokenizer."),sa=l(),Re=a("p"),aa=r("This tokenizer inherits from "),Lt=a("a"),na=r("PreTrainedTokenizer"),ca=r(` which contains some of the main methods.
...
`),Xe=a("a"),Eo=a("strong"),Ca=r("call"),qa=r("()"),Aa=r(" and "),Wt=a("a"),Ma=r("decode()"),Fa=r(` for
more information.`),La=l(),ue=a("div"),m(Ye.$$.fragment),ja=l(),O=a("p"),Da=r(`When used in normal mode, this method forwards all its arguments to AutoFeatureExtractor\u2019s
...
general usage and behavior.`),Mn=l(),Y=a("div"),m(pt.$$.fragment),Fn=l(),Lo=a("p"),Ln=r("Example:"),jn=l(),m(ft.$$.fragment),this.h()},l(t){const h=fi('[data-svelte="svelte-1phssyn"]',document.head);f=n(h,"META",{name:!0,content:!0}),h.forEach(o),q=d(t),k=n(t,"H1",{class:!0});var mt=c(k);S=n(mt,"A",{id:!0,class:!0,href:!0});var jo=c(S);L=n(jo,"SPAN",{});var Nn=c(L);u(w.$$.fragment,Nn),Nn.forEach(o),jo.forEach(o),N=d(mt),j=n(mt,"SPAN",{});var Bn=c(j);z=s(Bn,"Speech2Text2"),Bn.forEach(o),mt.forEach(o),b=d(t),C=n(t,"H2",{class:!0});var nr=c(C);A=n(nr,"A",{id:!0,class:!0,href:!0});var On=c(A);so=n(On,"SPAN",{});var Un=c(so);u($e.$$.fragment,Un),Un.forEach(o),On.forEach(o),Cr=d(nr),ao=n(nr,"SPAN",{});var Rn=c(ao);qr=s(Rn,"Overview"),Rn.forEach(o),nr.forEach(o),Do=d(t),H=n(t,"P",{});var Jt=c(H);Ar=s(Jt,"The Speech2Text2 model is used together with "),_t=n(Jt,"A",{href:!0});var Hn=c(_t);Mr=s(Hn,"Wav2Vec2"),Hn.forEach(o),Fr=s(Jt,` for Speech Translation models proposed in
`),Ee=n(Jt,"A",{href:!0,rel:!0});var Jn=c(Ee);Lr=s(Jn,"Large-Scale Self- and Semi-Supervised Learning for Speech Translation"),Jn.forEach(o),jr=s(Jt,` by
Changhan Wang, Anne Wu, Juan Pino, Alexei Baevski, Michael Auli, Alexis Conneau.`),Jt.forEach(o),Io=d(t),y=n(t,"P",{});var F=c(y);Dr=s(F,"Speech2Text2 is a "),no=n(F,"EM",{});var Gn=c(no);Ir=s(Gn,"decoder-only"),Gn.forEach(o),Wr=s(F," transformer model that can be used with any speech "),co=n(F,"EM",{});var Kn=c(co);Vr=s(Kn,"encoder-only"),Kn.forEach(o),Nr=s(F,`, such as
`),gt=n(F,"A",{href:!0});var Qn=c(gt);Br=s(Qn,"Wav2Vec2"),Qn.forEach(o),Or=s(F," or "),vt=n(F,"A",{href:!0});var Xn=c(vt);Ur=s(Xn,"HuBERT"),Xn.forEach(o),Rr=s(F,` for Speech-to-Text tasks. Please refer to the
`),Tt=n(F,"A",{href:!0});var Yn=c(Tt);Hr=s(Yn,"SpeechEncoderDecoder"),Yn.forEach(o),Jr=s(F," class on how to combine Speech2Text2 with any speech "),io=n(F,"EM",{});var Zn=c(io);Gr=s(Zn,"encoder-only"),Zn.forEach(o),Kr=s(F,`
model.`),F.forEach(o),Wo=d(t),ce=n(t,"P",{});var cr=c(ce);Qr=s(cr,"This model was contributed by "),Pe=n(cr,"A",{href:!0,rel:!0});var ec=c(Pe);Xr=s(ec,"Patrick von Platen"),ec.forEach(o),Yr=s(cr,"."),cr.forEach(o),Vo=d(t),ie=n(t,"P",{});var ir=c(ie);Zr=s(ir,"The original code can be found "),ze=n(ir,"A",{href:!0,rel:!0});var tc=c(ze);es=s(tc,"here"),tc.forEach(o),ts=s(ir,"."),ir.forEach(o),No=d(t),kt=n(t,"P",{});var oc=c(kt);os=s(oc,"Tips:"),oc.forEach(o),Bo=d(t),J=n(t,"UL",{});var Gt=c(J);Ce=n(Gt,"LI",{});var lr=c(Ce);rs=s(lr,`Speech2Text2 achieves state-of-the-art results on the CoVoST Speech Translation dataset. For more information, see
the `),qe=n(lr,"A",{href:!0,rel:!0});var rc=c(qe);ss=s(rc,"official models"),rc.forEach(o),as=s(lr," ."),lr.forEach(o),ns=d(Gt),Ae=n(Gt,"LI",{});var dr=c(Ae);cs=s(dr,"Speech2Text2 is always used within the "),xt=n(dr,"A",{href:!0});var sc=c(xt);is=s(sc,"SpeechEncoderDecoder"),sc.forEach(o),ls=s(dr," framework."),dr.forEach(o),ds=d(Gt),Me=n(Gt,"LI",{});var hr=c(Me);hs=s(hr,"Speech2Text2\u2019s tokenizer is based on "),bt=n(hr,"EM",{});var Dn=c(bt);ps=s(Dn,"fastBPE <"),Fe=n(Dn,"A",{href:!0,rel:!0});var ac=c(Fe);fs=s(ac,"https://github.com/glample/fastBPE>"),ac.forEach(o),Dn.forEach(o),ms=s(hr,"."),hr.forEach(o),Gt.forEach(o),Oo=d(t),Z=n(t,"H2",{class:!0});var pr=c(Z);le=n(pr,"A",{id:!0,class:!0,href:!0});var nc=c(le);lo=n(nc,"SPAN",{});var cc=c(lo);u(Le.$$.fragment,cc),cc.forEach(o),nc.forEach(o),us=d(pr),ho=n(pr,"SPAN",{});var ic=c(ho);_s=s(ic,"Inference"),ic.forEach(o),pr.forEach(o),Uo=d(t),G=n(t,"P",{});var Kt=c(G);gs=s(Kt,"Speech2Text2\u2019s "),St=n(Kt,"A",{href:!0});var lc=c(St);vs=s(lc,"SpeechEncoderDecoderModel"),lc.forEach(o),Ts=s(Kt,` model accepts raw waveform input values from speech and
...
`),Xe=n(R,"A",{href:!0});var In=c(Xe);Eo=n(In,"STRONG",{});var Uc=c(Eo);Ca=s(Uc,"call"),Uc.forEach(o),qa=s(In,"()"),In.forEach(o),Aa=s(R," and "),Wt=n(R,"A",{href:!0});var Rc=c(Wt);Ma=s(Rc,"decode()"),Rc.forEach(o),Fa=s(R,` for
more information.`),R.forEach(o),La=d($),ue=n($,"DIV",{class:!0});var xr=c(ue);u(Ye.$$.fragment,xr),ja=d(xr),O=n(xr,"P",{});var be=c(O);Da=s(be,`When used in normal mode, this method forwards all its arguments to AutoFeatureExtractor\u2019s
