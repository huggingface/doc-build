import{S as Jf,i as Rf,s as Xf,e as l,k as p,w as h,t as r,L as Zf,c as i,d as t,m,a as f,x as u,h as o,b as d,J as a,g as n,y as c,K as Qf,q as _,o as w,B as v}from"../chunks/vendor-e859c359.js";import{Y as Rr}from"../chunks/Youtube-ea771e89.js";import{I as ta}from"../chunks/IconCopyLink-5fae3b20.js";import{C as y}from"../chunks/CodeBlock-ce4317c2.js";import"../chunks/CopyButton-77addb3d.js";function Vf(Xr){let x,rt,g,P,aa,_e,Zr,sa,Qr,Ja,z,Vr,ra,eo,to,ot,ao,so,Ra,F,ro,we,oo,no,nt,lo,io,Xa,lt,Za,N,H,oa,ve,fo,na,po,Qa,ye,Va,k,mo,be,ho,uo,$e,co,_o,it,wo,vo,es,K,yo,la,bo,$o,ts,ge,as,C,go,ia,ko,Eo,fa,To,jo,ss,b,Ao,pa,Po,qo,ma,xo,zo,da,Fo,Co,ha,Do,So,ua,Io,Mo,ca,No,Oo,rs,ft,Lo,os,ke,ns,G,Wo,pt,Bo,Ho,ls,Ee,is,mt,Ko,fs,U,Go,_a,Uo,Yo,ps,Te,ms,Y,Jo,je,Ro,Xo,ds,dt,Zo,hs,Ae,us,E,Qo,wa,Vo,en,va,tn,an,ya,sn,rn,cs,ht,_s,O,J,ba,Pe,on,$a,nn,ws,qe,vs,R,ln,ut,fn,pn,ys,ct,mn,bs,xe,$s,_t,dn,gs,T,hn,wt,un,cn,vt,_n,wn,yt,vn,yn,ks,ze,Es,X,bn,bt,$n,gn,Ts,Fe,js,$t,kn,As,Ce,Ps,Z,En,gt,Tn,jn,qs,j,An,kt,Pn,qn,ga,xn,zn,Et,Fn,Cn,xs,A,Dn,ka,Sn,In,Ea,Mn,Nn,Ta,On,Ln,zs,De,Fs,Tt,Wn,Cs,Q,Bn,jt,Hn,Kn,Ds,Se,Ss,At,Gn,Is,Pt,Un,Ms,Ie,Ns,V,Yn,qt,Jn,Rn,Os,xt,Ls,L,ee,ja,Me,Xn,Aa,Zn,Ws,Ne,Bs,zt,Qn,Hs,Oe,Ks,D,Vn,Pa,el,tl,qa,al,sl,Gs,Le,Us,te,rl,xa,ol,nl,Ys,We,Js,Ft,ll,Rs,Be,Xs,Ct,il,Zs,He,Qs,Dt,Vs,W,ae,za,Ke,fl,Fa,pl,er,Ge,tr,St,ml,ar,Ue,sr,S,dl,It,hl,ul,Ca,cl,_l,rr,I,Ye,wl,Da,vl,yl,bl,q,$l,Sa,gl,kl,Ia,El,Tl,Ma,jl,Al,Pl,Na,ql,or,se,xl,Oa,zl,Fl,nr,Je,lr,Mt,Cl,ir,Re,fr,Nt,Dl,pr,Xe,mr,M,Sl,Ot,Il,Ml,Lt,Nl,Ol,dr,Ze,hr,Wt,Ll,ur,Qe,cr,re,Wl,La,Bl,Hl,_r,Ve,wr,oe,Kl,Wa,Gl,Ul,vr,et,yr,Bt,Yl,br,ne,Jl,Ht,Rl,Xl,$r,tt,gr,Kt,kr,B,le,Ba,at,Zl,Ha,Ql,Er,Gt,Vl,Tr,ie,Ka,Ut,st,ei,ti,ai,Ga,fe,Yt,si,ri,Ua,oi,ni,jr;return _e=new ta({}),ve=new ta({}),ye=new Rr({props:{id:"_BZearw7f0w"}}),ge=new y({props:{code:`from datasets import load_dataset
...
full_eval_dataset = tokenized_datasets[<span class="hljs-string">&quot;test&quot;</span>]`}}),Pe=new ta({}),qe=new Rr({props:{id:"nvBXf7s7vTI"}}),xe=new y({props:{code:`from transformers import AutoModelForSequenceClassification
...
training_args = TrainingArguments(<span class="hljs-string">&quot;test_trainer&quot;</span>, evaluation_strategy=<span class="hljs-string">&quot;epoch&quot;</span>)`}}),Me=new ta({}),Ne=new Rr({props:{id:"rnTGBy2ax1c"}}),Oe=new y({props:{code:`import tensorflow as tf
...
pytorch_model = AutoModelForSequenceClassification.from_pretrained(<span class="hljs-string">&quot;my_imdb_model&quot;</span>, from_tf=<span class="hljs-literal">True</span>)`}}),Ke=new ta({}),Ge=new Rr({props:{id:"Dh9CL8fyG80"}}),Ue=new y({props:{code:`del model
del pytorch_model
del trainer
...
torch.cuda.empty_cache()`}}),Je=new y({props:{code:`tokenized_datasets = tokenized_datasets.remove_columns(["text"])
...
small_eval_dataset = tokenized_datasets[<span class="hljs-string">&quot;test&quot;</span>].shuffle(seed=<span class="hljs-number">42</span>).select(<span class="hljs-built_in">range</span>(<span class="hljs-number">1000</span>))`}}),Re=new y({props:{code:`from torch.utils.data import DataLoader
...
metric.compute()`}}),at=new ta({}),{c(){x=l("meta"),rt=p(),g=l("h1"),P=l("a"),aa=l("span"),h(_e.$$.fragment),Zr=p(),sa=l("span"),Qr=r("Fine-tuning a pretrained model"),Ja=p(),z=l("p"),Vr=r(`In this tutorial, we will show you how to fine-tune a pretrained model from the Transformers library. In TensorFlow,
...
a model from scratch easily. Then we will show you how to alternatively write the whole training loop in PyTorch.`),Ra=p(),F=l("p"),ro=r(`Before we can fine-tune a model, we need a dataset. In this tutorial, we will show you how to fine-tune BERT on the
...
`),_a=l("code"),Uo=r("map"),Yo=r(" method:"),ps=p(),h(Te.$$.fragment),ms=p(),Y=l("p"),Jo=r("You can learn more about the map method or the other ways to preprocess the data in the \u{1F917} Datasets "),je=l("a"),Ro=r("documentation"),Xo=r("."),ds=p(),dt=l("p"),Zo=r("Next we will generate a small subset of the training and validation set, to enable faster training:"),hs=p(),h(Ae.$$.fragment),us=p(),E=l("p"),Qo=r("In all the examples below, we will always use "),wa=l("code"),Vo=r("small_train_dataset"),en=r(" and "),va=l("code"),tn=r("small_eval_dataset"),an=r(`. Just replace
them by their `),ya=l("em"),sn=r("full"),rn=r(" equivalent to train or evaluate on the full dataset."),cs=p(),ht=l("a"),_s=p(),O=l("h2"),J=l("a"),ba=l("span"),h(Pe.$$.fragment),on=p(),$a=l("span"),nn=r("Fine-tuning in PyTorch with the Trainer API"),ws=p(),h(qe.$$.fragment),vs=p(),R=l("p"),ln=r("Since PyTorch does not provide a training loop, the \u{1F917} Transformers library provides a "),ut=l("a"),fn=r("Trainer"),pn=r(`
...
epoch), here is how you should define your training arguments:`),Ms=p(),h(Ie.$$.fragment),Ns=p(),V=l("p"),Yn=r("See the documentation of "),qt=l("a"),Jn=r("TrainingArguments"),Rn=r(" for more options."),Os=p(),xt=l("a"),Ls=p(),L=l("h2"),ee=l("a"),ja=l("span"),h(Me.$$.fragment),Xn=p(),Aa=l("span"),Zn=r("Fine-tuning with Keras"),Ws=p(),h(Ne.$$.fragment),Bs=p(),zt=l("p"),Qn=r("Models can also be trained natively in TensorFlow using the Keras API. First, let\u2019s define our model:"),Hs=p(),h(Oe.$$.fragment),Ks=p(),D=l("p"),Vn=r("Then we will need to convert our datasets from before in standard "),Pa=l("code"),el=r("tf.data.Dataset"),tl=r(`. Since we have fixed shapes,
...
format:`),Gs=p(),h(Le.$$.fragment),Us=p(),te=l("p"),rl=r("Then we convert everything in big tensors and use the "),xa=l("code"),ol=r("tf.data.Dataset.from_tensor_slices"),nl=r(" method:"),Ys=p(),h(We.$$.fragment),Js=p(),Ft=l("p"),ll=r("With this done, the model can then be compiled and trained as any Keras model:"),Rs=p(),h(Be.$$.fragment),Xs=p(),Ct=l("p"),il=r(`With the tight interoperability between TensorFlow and PyTorch models, you can even save the model and then reload it
...
the body\u201D of the model means, forget you read this paragraph.`),br=p(),ne=l("p"),Jl=r("Now to check the results, we need to write the evaluation loop. Like in the "),Ht=l("a"),Rl=r("trainer section"),Xl=r(` we will
...
the `),Ua=l("em"),oi=r("how to finetune a model on xxx"),ni=r(")."),this.h()},l(e){const s=Zf('[data-svelte="svelte-1phssyn"]',document.head);x=i(s,"META",{name:!0,content:!0}),s.forEach(t),rt=m(e),g=i(e,"H1",{class:!0});var Ar=f(g);P=i(Ar,"A",{id:!0,class:!0,href:!0});var ii=f(P);aa=i(ii,"SPAN",{});var fi=f(aa);u(_e.$$.fragment,fi),fi.forEach(t),ii.forEach(t),Zr=m(Ar),sa=i(Ar,"SPAN",{});var pi=f(sa);Qr=o(pi,"Fine-tuning a pretrained model"),pi.forEach(t),Ar.forEach(t),Ja=m(e),z=i(e,"P",{});var Jt=f(z);Vr=o(Jt,`In this tutorial, we will show you how to fine-tune a pretrained model from the Transformers library. In TensorFlow,
models can be directly trained using Keras and the `),ra=i(Jt,"CODE",{});var mi=f(ra);eo=o(mi,"fit"),mi.forEach(t),to=o(Jt,` method. In PyTorch, there is no generic training loop so
the \u{1F917} Transformers library provides an API with the class `),ot=i(Jt,"A",{href:!0});var di=f(ot);ao=o(di,"Trainer"),di.forEach(t),so=o(Jt,` to let you fine-tune or train
a model from scratch easily. Then we will show you how to alternatively write the whole training loop in PyTorch.`),Jt.forEach(t),Ra=m(e),F=i(e,"P",{});var Rt=f(F);ro=o(Rt,`Before we can fine-tune a model, we need a dataset. In this tutorial, we will show you how to fine-tune BERT on the
`),we=i(Rt,"A",{href:!0,rel:!0});var hi=f(we);oo=o(hi,"IMDB dataset"),hi.forEach(t),no=o(Rt,`: the task is to classify whether movie reviews are positive or
negative. For examples of other tasks, refer to the `),nt=i(Rt,"A",{href:!0});var ui=f(nt);lo=o(ui,"additional-resources"),ui.forEach(t),io=o(Rt," section!"),Rt.forEach(t),Xa=m(e),lt=i(e,"A",{id:!0}),f(lt).forEach(t),Za=m(e),N=i(e,"H2",{class:!0});var Pr=f(N);H=i(Pr,"A",{id:!0,class:!0,href:!0});var ci=f(H);oa=i(ci,"SPAN",{});var _i=f(oa);u(ve.$$.fragment,_i),_i.forEach(t),ci.forEach(t),fo=m(Pr),na=i(Pr,"SPAN",{});var wi=f(na);po=o(wi,"Preparing the datasets"),wi.forEach(t),Pr.forEach(t),Qa=m(e),u(ye.$$.fragment,e),Va=m(e),k=i(e,"P",{});var pe=f(k);mo=o(pe,"We will use the "),be=i(pe,"A",{href:!0,rel:!0});var vi=f(be);ho=o(vi,"\u{1F917} Datasets"),vi.forEach(t),uo=o(pe,` library to download and preprocess the IMDB
datasets. We will go over this part pretty quickly. Since the focus of this tutorial is on training, you should refer
...
`),_a=i(zr,"CODE",{});var Ci=f(_a);Uo=o(Ci,"map"),Ci.forEach(t),Yo=o(zr," method:"),zr.forEach(t),ps=m(e),u(Te.$$.fragment,e),ms=m(e),Y=i(e,"P",{});var Fr=f(Y);Jo=o(Fr,"You can learn more about the map method or the other ways to preprocess the data in the \u{1F917} Datasets "),je=i(Fr,"A",{href:!0,rel:!0});var Di=f(je);Ro=o(Di,"documentation"),Di.forEach(t),Xo=o(Fr,"."),Fr.forEach(t),ds=m(e),dt=i(e,"P",{});var Si=f(dt);Zo=o(Si,"Next we will generate a small subset of the training and validation set, to enable faster training:"),Si.forEach(t),hs=m(e),u(Ae.$$.fragment,e),us=m(e),E=i(e,"P",{});var me=f(E);Qo=o(me,"In all the examples below, we will always use "),wa=i(me,"CODE",{});var Ii=f(wa);Vo=o(Ii,"small_train_dataset"),Ii.forEach(t),en=o(me," and "),va=i(me,"CODE",{});var Mi=f(va);tn=o(Mi,"small_eval_dataset"),Mi.forEach(t),an=o(me,`. Just replace
them by their `),ya=i(me,"EM",{});var Ni=f(ya);sn=o(Ni,"full"),Ni.forEach(t),rn=o(me," equivalent to train or evaluate on the full dataset."),me.forEach(t),cs=m(e),ht=i(e,"A",{id:!0}),f(ht).forEach(t),_s=m(e),O=i(e,"H2",{class:!0});var Cr=f(O);J=i(Cr,"A",{id:!0,class:!0,href:!0});var Oi=f(J);ba=i(Oi,"SPAN",{});var Li=f(ba);u(Pe.$$.fragment,Li),Li.forEach(t),Oi.forEach(t),on=m(Cr),$a=i(Cr,"SPAN",{});var Wi=f($a);nn=o(Wi,"Fine-tuning in PyTorch with the Trainer API"),Wi.forEach(t),Cr.forEach(t),ws=m(e),u(qe.$$.fragment,e),vs=m(e),R=i(e,"P",{});var Dr=f(R);ln=o(Dr,"Since PyTorch does not provide a training loop, the \u{1F917} Transformers library provides a "),ut=i(Dr,"A",{href:!0});var Bi=f(ut);fn=o(Bi,"Trainer"),Bi.forEach(t),pn=o(Dr,`
API that is optimized for \u{1F917} Transformers models, with a wide range of training options and with built-in features like
...
using all the defaults, the only thing we then have to provide is a directory in which the checkpoints will be saved:`),de.forEach(t),ks=m(e),u(ze.$$.fragment,e),Es=m(e),X=i(e,"P",{});var Sr=f(X);bn=o(Sr,"Then we can instantiate a "),bt=i(Sr,"A",{href:!0});var Ji=f(bt);$n=o(Ji,"Trainer"),Ji.forEach(t),gn=o(Sr," like this:"),Sr.forEach(t),Ts=m(e),u(Fe.$$.fragment,e),js=m(e),$t=i(e,"P",{});var Ri=f($t);kn=o(Ri,"To fine-tune our model, we just need to call"),Ri.forEach(t),As=m(e),u(Ce.$$.fragment,e),Ps=m(e),Z=i(e,"P",{});var Ir=f(Z);En=o(Ir,`which will start a training that you can follow with a progress bar, which should take a couple of minutes to complete
(as long as you have access to a GPU). It won\u2019t actually tell you anything useful about how well (or badly) your model
is performing however as by default, there is no evaluation during training, and we didn\u2019t tell the
...
epoch), here is how you should define your training arguments:`),nf.forEach(t),Ms=m(e),u(Ie.$$.fragment,e),Ns=m(e),V=i(e,"P",{});var Nr=f(V);Yn=o(Nr,"See the documentation of "),qt=i(Nr,"A",{href:!0});var lf=f(qt);Jn=o(lf,"TrainingArguments"),lf.forEach(t),Rn=o(Nr," for more options."),Nr.forEach(t),Os=m(e),xt=i(e,"A",{id:!0}),f(xt).forEach(t),Ls=m(e),L=i(e,"H2",{class:!0});var Or=f(L);ee=i(Or,"A",{id:!0,class:!0,href:!0});var ff=f(ee);ja=i(ff,"SPAN",{});var pf=f(ja);u(Me.$$.fragment,pf),pf.forEach(t),ff.forEach(t),Xn=m(Or),Aa=i(Or,"SPAN",{});var mf=f(Aa);Zn=o(mf,"Fine-tuning with Keras"),mf.forEach(t),Or.forEach(t),Ws=m(e),u(Ne.$$.fragment,e),Bs=m(e),zt=i(e,"P",{});var df=f(zt);Qn=o(df,"Models can also be trained natively in TensorFlow using the Keras API. First, let\u2019s define our model:"),df.forEach(t),Hs=m(e),u(Oe.$$.fragment,e),Ks=m(e),D=i(e,"P",{});var Zt=f(D);Vn=o(Zt,"Then we will need to convert our datasets from before in standard "),Pa=i(Zt,"CODE",{});var hf=f(Pa);el=o(hf,"tf.data.Dataset"),hf.forEach(t),tl=o(Zt,`. Since we have fixed shapes,
...
format:`),Zt.forEach(t),Gs=m(e),u(Le.$$.fragment,e),Us=m(e),te=i(e,"P",{});var Lr=f(te);rl=o(Lr,"Then we convert everything in big tensors and use the "),xa=i(Lr,"CODE",{});var cf=f(xa);ol=o(cf,"tf.data.Dataset.from_tensor_slices"),cf.forEach(t),nl=o(Lr," method:"),Lr.forEach(t),Ys=m(e),u(We.$$.fragment,e),Js=m(e),Ft=i(e,"P",{});var _f=f(Ft);ll=o(_f,"With this done, the model can then be compiled and trained as any Keras model:"),_f.forEach(t),Rs=m(e),u(Be.$$.fragment,e),Xs=m(e),Ct=i(e,"P",{});var wf=f(Ct);il=o(wf,`With the tight interoperability between TensorFlow and PyTorch models, you can even save the model and then reload it
...
bit strange, as we are directly fine-tuning the whole model without taking any precaution. It actually works better
this way for Transformers model (so this is not an oversight on our side). If you\u2019re not familiar with what \u201Cfreezing
the body\u201D of the model means, forget you read this paragraph.`),Mf.forEach(t),br=m(e),ne=i(e,"P",{});var Ur=f(ne);Jl=o(Ur,"Now to check the results, we need to write the evaluation loop. Like in the "),Ht=i(Ur,"A",{href:!0});var Nf=f(Ht);Rl=o(Nf,"trainer section"),Nf.forEach(t),Xl=o(Ur,` we will
use a metric from the datasets library. Here we accumulate the predictions at each batch before computing the final
result when the loop is finished.`),Ur.forEach(t),$r=m(e),u(tt.$$.fragment,e),gr=m(e),Kt=i(e,"A",{id:!0}),f(Kt).forEach(t),kr=m(e),B=i(e,"H2",{class:!0});var Yr=f(B);le=i(Yr,"A",{id:!0,class:!0,href:!0});var Of=f(le);Ba=i(Of,"SPAN",{});var Lf=f(Ba);u(at.$$.fragment,Lf),Lf.forEach(t),Of.forEach(t),Zl=m(Yr),Ha=i(Yr,"SPAN",{});var Wf=f(Ha);Ql=o(Wf,"Additional resources"),Wf.forEach(t),Yr.forEach(t),Er=m(e),Gt=i(e,"P",{});var Bf=f(Gt);Vl=o(Bf,"To look at more fine-tuning examples you can refer to:"),Bf.forEach(t),Tr=m(e),ie=i(e,"UL",{});var Jr=f(ie);Ka=i(Jr,"LI",{});var Hf=f(Ka);Ut=i(Hf,"P",{});var li=f(Ut);st=i(li,"A",{href:!0,rel:!0});var Kf=f(st);ei=o(Kf,"\u{1F917} Transformers Examples"),Kf.forEach(t),ti=o(li,` which includes scripts
to train on all common NLP tasks in PyTorch and TensorFlow.`),li.forEach(t),Hf.forEach(t),ai=m(Jr),Ga=i(Jr,"LI",{});var Gf=f(Ga);fe=i(Gf,"P",{});var Ya=f(fe);Yt=i(Ya,"A",{href:!0});var Uf=f(Yt);si=o(Uf,"\u{1F917} Transformers Notebooks"),Uf.forEach(t),ri=o(Ya,` which contains various notebooks and in particular one per task (look for
the `),Ua=i(Ya,"EM",{});var Yf=f(Ua);oi=o(Yf,"how to finetune a model on xxx"),Yf.forEach(t),ni=o(Ya,")."),Ya.forEach(t),Gf.forEach(t),Jr.forEach(t),this.h()},h(){d(x,"name","hf:doc:metadata"),d(x,"content",JSON.stringify(ep)),d(P,"id","finetuning-a-pretrained-model"),d(P,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),d(P,"href","#finetuning-a-pretrained-model"),d(g,"class","relative group"),d(ot,"href","/docs/transformers/master/en/main_classes/trainer#transformers.Trainer"),d(we,"href","https://www.imdb.com/interfaces/"),d(we,"rel","nofollow"),d(nt,"href","#additional-resources"),d(lt,"id","data-processing"),d(H,"id","preparing-the-datasets"),d(H,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),d(H,"href","#preparing-the-datasets"),d(N,"class","relative group"),d(be,"href","https://github.com/huggingface/datasets/"),d(be,"rel","nofollow"),d($e,"href","https://huggingface.co/docs/datasets/"),d($e,"rel","nofollow"),d(it,"href","preprocessing"),d(pt,"href","preprocessing"),d(je,"href","https://huggingface.co/docs/datasets/"),d(je,"rel","nofollow"),d(ht,"id","trainer"),d(J,"id","finetuning-in-pytorch-with-the-trainer-api"),d(J,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),d(J,"href","#finetuning-in-pytorch-with-the-trainer-api"),d(O,"class","relative group"),d(ut,"href","/docs/transformers/master/en/main_classes/trainer#transformers.Trainer"),d(wt,"href","/docs/transformers/master/en/main_classes/trainer#transformers.Trainer"),d(vt,"href","/docs/transformers/master/en/main_classes/trainer#transformers.TrainingArguments"),d(yt,"href","/docs/transformers/master/en/main_classes/trainer#transformers.Trainer"),d(bt,"href","/docs/transformers/master/en/main_classes/trainer#transformers.Trainer"),d(gt,"href","/docs/transformers/master/en/main_classes/trainer#transformers.Trainer"),d(kt,"href","/docs/transformers/master/en/main_classes/trainer#transformers.Trainer"),d(Et,"href","/docs/transformers/master/en/internal/trainer_utils#transformers.EvalPrediction"),d(jt,"href","/docs/transformers/master/en/main_classes/trainer#transformers.Trainer"),d(qt,"href","/docs/transformers/master/en/main_classes/trainer#transformers.TrainingArguments"),d(xt,"id","keras"),d(ee,"id","finetuning-with-keras"),d(ee,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),d(ee,"href","#finetuning-with-keras"),d(L,"class","relative group"),d(Dt,"id","pytorch_native"),d(ae,"id","finetuning-in-native-pytorch"),d(ae,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),d(ae,"href","#finetuning-in-native-pytorch"),d(W,"class","relative group"),d(It,"href","#trainer"),d(Ot,"href","/docs/transformers/master/en/main_classes/trainer#transformers.Trainer"),d(Lt,"href","/docs/transformers/master/en/main_classes/optimizer_schedules#transformers.AdamW"),d(Ht,"href","#trainer"),d(Kt,"id","additional-resources"),d(le,"id","additional-resources"),d(le,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),d(le,"href","#additional-resources"),d(B,"class","relative group"),d(st,"href","https://github.com/huggingface/transformers/tree/master/examples"),d(st,"rel","nofollow"),d(Yt,"href","notebooks")},m(e,s){a(document.head,x),n(e,rt,s),n(e,g,s),a(g,P),a(P,aa),c(_e,aa,null),a(g,Zr),a(g,sa),a(sa,Qr),n(e,Ja,s),n(e,z,s),a(z,Vr),a(z,ra),a(ra,eo),a(z,to),a(z,ot),a(ot,ao),a(z,so),n(e,Ra,s),n(e,F,s),a(F,ro),a(F,we),a(we,oo),a(F,no),a(F,nt),a(nt,lo),a(F,io),n(e,Xa,s),n(e,lt,s),n(e,Za,s),n(e,N,s),a(N,H),a(H,oa),c(ve,oa,null),a(N,fo),a(N,na),a(na,po),n(e,Qa,s),c(ye,e,s),n(e,Va,s),n(e,k,s),a(k,mo),a(k,be),a(be,ho),a(k,uo),a(k,$e),a($e,co),a(k,_o),a(k,it),a(it,wo),a(k,vo),n(e,es,s),n(e,K,s),a(K,yo),a(K,la),a(la,bo),a(K,$o),n(e,ts,s),c(ge,e,s),n(e,as,s),n(e,C,s),a(C,go),a(C,ia),a(ia,ko),a(C,Eo),a(C,fa),a(fa,To),a(C,jo),n(e,ss,s),n(e,b,s),a(b,Ao),a(b,pa),a(pa,Po),a(b,qo),a(b,ma),a(ma,xo),a(b,zo),a(b,da),a(da,Fo),a(b,Co),a(b,ha),a(ha,Do),a(b,So),a(b,ua),a(ua,Io),a(b,Mo),a(b,ca),a(ca,No),a(b,Oo),n(e,rs,s),n(e,ft,s),a(ft,Lo),n(e,os,s),c(ke,e,s),n(e,ns,s),n(e,G,s),a(G,Wo),a(G,pt),a(pt,Bo),a(G,Ho),n(e,ls,s),c(Ee,e,s),n(e,is,s),n(e,mt,s),a(mt,Ko),n(e,fs,s),n(e,U,s),a(U,Go),a(U,_a),a(_a,Uo),a(U,Yo),n(e,ps,s),c(Te,e,s),n(e,ms,s),n(e,Y,s),a(Y,Jo),a(Y,je),a(je,Ro),a(Y,Xo),n(e,ds,s),n(e,dt,s),a(dt,Zo),n(e,hs,s),c(Ae,e,s),n(e,us,s),n(e,E,s),a(E,Qo),a(E,wa),a(wa,Vo),a(E,en),a(E,va),a(va,tn),a(E,an),a(E,ya),a(ya,sn),a(E,rn),n(e,cs,s),n(e,ht,s),n(e,_s,s),n(e,O,s),a(O,J),a(J,ba),c(Pe,ba,null),a(O,on),a(O,$a),a($a,nn),n(e,ws,s),c(qe,e,s),n(e,vs,s),n(e,R,s),a(R,ln),a(R,ut),a(ut,fn),a(R,pn),n(e,ys,s),n(e,ct,s),a(ct,mn),n(e,bs,s),c(xe,e,s),n(e,$s,s),n(e,_t,s),a(_t,dn),n(e,gs,s),n(e,T,s),a(T,hn),a(T,wt),a(wt,un),a(T,cn),a(T,vt),a(vt,_n),a(T,wn),a(T,yt),a(yt,vn),a(T,yn),n(e,ks,s),c(ze,e,s),n(e,Es,s),n(e,X,s),a(X,bn),a(X,bt),a(bt,$n),a(X,gn),n(e,Ts,s),c(Fe,e,s),n(e,js,s),n(e,$t,s),a($t,kn),n(e,As,s),c(Ce,e,s),n(e,Ps,s),n(e,Z,s),a(Z,En),a(Z,gt),a(gt,Tn),a(Z,jn),n(e,qs,s),n(e,j,s),a(j,An),a(j,kt),a(kt,Pn),a(j,qn),a(j,ga),a(ga,xn),a(j,zn),a(j,Et),a(Et,Fn),a(j,Cn),n(e,xs,s),n(e,A,s),a(A,Dn),a(A,ka),a(ka,Sn),a(A,In),a(A,Ea),a(Ea,Mn),a(A,Nn),a(A,Ta),a(Ta,On),a(A,Ln),n(e,zs,s),c(De,e,s),n(e,Fs,s),n(e,Tt,s),a(Tt,Wn),n(e,Cs,s),n(e,Q,s),a(Q,Bn),a(Q,jt),a(jt,Hn),a(Q,Kn),n(e,Ds,s),c(Se,e,s),n(e,Ss,s),n(e,At,s),a(At,Gn),n(e,Is,s),n(e,Pt,s),a(Pt,Un),n(e,Ms,s),c(Ie,e,s),n(e,Ns,s),n(e,V,s),a(V,Yn),a(V,qt),a(qt,Jn),a(V,Rn),n(e,Os,s),n(e,xt,s),n(e,Ls,s),n(e,L,s),a(L,ee),a(ee,ja),c(Me,ja,null),a(L,Xn),a(L,Aa),a(Aa,Zn),n(e,Ws,s),c(Ne,e,s),n(e,Bs,s),n(e,zt,s),a(zt,Qn),n(e,Hs,s),c(Oe,e,s),n(e,Ks,s),n(e,D,s),a(D,Vn),a(D,Pa),a(Pa,el),a(D,tl),a(D,qa),a(qa,al),a(D,sl),n(e,Gs,s),c(Le,e,s),n(e,Us,s),n(e,te,s),a(te,rl),a(te,xa),a(xa,ol),a(te,nl),n(e,Ys,s),c(We,e,s),n(e,Js,s),n(e,Ft,s),a(Ft,ll),n(e,Rs,s),c(Be,e,s),n(e,Xs,s),n(e,Ct,s),a(Ct,il),n(e,Zs,s),c(He,e,s),n(e,Qs,s),n(e,Dt,s),n(e,Vs,s),n(e,W,s),a(W,ae),a(ae,za),c(Ke,za,null),a(W,fl),a(W,Fa),a(Fa,pl),n(e,er,s),c(Ge,e,s),n(e,tr,s),n(e,St,s),a(St,ml),n(e,ar,s),c(Ue,e,s),n(e,sr,s),n(e,S,s),a(S,dl),a(S,It),a(It,hl),a(S,ul),a(S,Ca),a(Ca,cl),a(S,_l),n(e,rr,s),n(e,I,s),a(I,Ye),a(Ye,wl),a(Ye,Da),a(Da,vl),a(Ye,yl),a(I,bl),a(I,q),a(q,$l),a(q,Sa),a(Sa,gl),a(q,kl),a(q,Ia),a(Ia,El),a(q,Tl),a(q,Ma),a(Ma,jl),a(q,Al),a(I,Pl),a(I,Na),a(Na,ql),n(e,or,s),n(e,se,s),a(se,xl),a(se,Oa),a(Oa,zl),a(se,Fl),n(e,nr,s),c(Je,e,s),n(e,lr,s),n(e,Mt,s),a(Mt,Cl),n(e,ir,s),c(Re,e,s),n(e,fr,s),n(e,Nt,s),a(Nt,Dl),n(e,pr,s),c(Xe,e,s),n(e,mr,s),n(e,M,s),a(M,Sl),a(M,Ot),a(Ot,Il),a(M,Ml),a(M,Lt),a(Lt,Nl),a(M,Ol),n(e,dr,s),c(Ze,e,s),n(e,hr,s),n(e,Wt,s),a(Wt,Ll),n(e,ur,s),c(Qe,e,s),n(e,cr,s),n(e,re,s),a(re,Wl),a(re,La),a(La,Bl),a(re,Hl),n(e,_r,s),c(Ve,e,s),n(e,wr,s),n(e,oe,s),a(oe,Kl),a(oe,Wa),a(Wa,Gl),a(oe,Ul),n(e,vr,s),c(et,e,s),n(e,yr,s),n(e,Bt,s),a(Bt,Yl),n(e,br,s),n(e,ne,s),a(ne,Jl),a(ne,Ht),a(Ht,Rl),a(ne,Xl),n(e,$r,s),c(tt,e,s),n(e,gr,s),n(e,Kt,s),n(e,kr,s),n(e,B,s),a(B,le),a(le,Ba),c(at,Ba,null),a(B,Zl),a(B,Ha),a(Ha,Ql),n(e,Er,s),n(e,Gt,s),a(Gt,Vl),n(e,Tr,s),n(e,ie,s),a(ie,Ka),a(Ka,Ut),a(Ut,st),a(st,ei),a(Ut,ti),a(ie,ai),a(ie,Ga),a(Ga,fe),a(fe,Yt),a(Yt,si),a(fe,ri),a(fe,Ua),a(Ua,oi),a(fe,ni),jr=!0},p:Qf,i(e){jr||(_(_e.$$.fragment,e),_(ve.$$.fragment,e),_(ye.$$.fragment,e),_(ge.$$.fragment,e),_(ke.$$.fragment,e),_(Ee.$$.fragment,e),_(Te.$$.fragment,e),_(Ae.$$.fragment,e),_(Pe.$$.fragment,e),_(qe.$$.fragment,e),_(xe.$$.fragment,e),_(ze.$$.fragment,e),_(Fe.$$.fragment,e),_(Ce.$$.fragment,e),_(De.$$.fragment,e),_(Se.$$.fragment,e),_(Ie.$$.fragment,e),_(Me.$$.fragment,e),_(Ne.$$.fragment,e),_(Oe.$$.fragment,e),_(Le.$$.fragment,e),_(We.$$.fragment,e),_(Be.$$.fragment,e),_(He.$$.fragment,e),_(Ke.$$.fragment,e),_(Ge.$$.fragment,e),_(Ue.$$.fragment,e),_(Je.$$.fragment,e),_(Re.$$.fragment,e),_(Xe.$$.fragment,e),_(Ze.$$.fragment,e),_(Qe.$$.fragment,e),_(Ve.$$.fragment,e),_(et.$$.fragment,e),_(tt.$$.fragment,e),_(at.$$.fragment,e),jr=!0)},o(e){w(_e.$$.fragment,e),w(ve.$$.fragment,e),w(ye.$$.fragment,e),w(ge.$$.fragment,e),w(ke.$$.fragment,e),w(Ee.$$.fragment,e),w(Te.$$.fragment,e),w(Ae.$$.fragment,e),w(Pe.$$.fragment,e),w(qe.$$.fragment,e),w(xe.$$.fragment,e),w(ze.$$.fragment,e),w(Fe.$$.fragment,e),w(Ce.$$.fragment,e),w(De.$$.fragment,e),w(Se.$$.fragment,e),w(Ie.$$.fragment,e),w(Me.$$.fragment,e),w(Ne.$$.fragment,e),w(Oe.$$.fragment,e),w(Le.$$.fragment,e),w(We.$$.fragment,e),w(Be.$$.fragment,e),w(He.$$.fragment,e),w(Ke.$$.fragment,e),w(Ge.$$.fragment,e),w(Ue.$$.fragment,e),w(Je.$$.fragment,e),w(Re.$$.fragment,e),w(Xe.$$.fragment,e),w(Ze.$$.fragment,e),w(Qe.$$.fragment,e),w(Ve.$$.fragment,e),w(et.$$.fragment,e),w(tt.$$.fragment,e),w(at.$$.fragment,e),jr=!1},d(e){t(x),e&&t(rt),e&&t(g),v(_e),e&&t(Ja),e&&t(z),e&&t(Ra),e&&t(F),e&&t(Xa),e&&t(lt),e&&t(Za),e&&t(N),v(ve),e&&t(Qa),v(ye,e),e&&t(Va),e&&t(k),e&&t(es),e&&t(K),e&&t(ts),v(ge,e),e&&t(as),e&&t(C),e&&t(ss),e&&t(b),e&&t(rs),e&&t(ft),e&&t(os),v(ke,e),e&&t(ns),e&&t(G),e&&t(ls),v(Ee,e),e&&t(is),e&&t(mt),e&&t(fs),e&&t(U),e&&t(ps),v(Te,e),e&&t(ms),e&&t(Y),e&&t(ds),e&&t(dt),e&&t(hs),v(Ae,e),e&&t(us),e&&t(E),e&&t(cs),e&&t(ht),e&&t(_s),e&&t(O),v(Pe),e&&t(ws),v(qe,e),e&&t(vs),e&&t(R),e&&t(ys),e&&t(ct),e&&t(bs),v(xe,e),e&&t($s),e&&t(_t),e&&t(gs),e&&t(T),e&&t(ks),v(ze,e),e&&t(Es),e&&t(X),e&&t(Ts),v(Fe,e),e&&t(js),e&&t($t),e&&t(As),v(Ce,e),e&&t(Ps),e&&t(Z),e&&t(qs),e&&t(j),e&&t(xs),e&&t(A),e&&t(zs),v(De,e),e&&t(Fs),e&&t(Tt),e&&t(Cs),e&&t(Q),e&&t(Ds),v(Se,e),e&&t(Ss),e&&t(At),e&&t(Is),e&&t(Pt),e&&t(Ms),v(Ie,e),e&&t(Ns),e&&t(V),e&&t(Os),e&&t(xt),e&&t(Ls),e&&t(L),v(Me),e&&t(Ws),v(Ne,e),e&&t(Bs),e&&t(zt),e&&t(Hs),v(Oe,e),e&&t(Ks),e&&t(D),e&&t(Gs),v(Le,e),e&&t(Us),e&&t(te),e&&t(Ys),v(We,e),e&&t(Js),e&&t(Ft),e&&t(Rs),v(Be,e),e&&t(Xs),e&&t(Ct),e&&t(Zs),v(He,e),e&&t(Qs),e&&t(Dt),e&&t(Vs),e&&t(W),v(Ke),e&&t(er),v(Ge,e),e&&t(tr),e&&t(St),e&&t(ar),v(Ue,e),e&&t(sr),e&&t(S),e&&t(rr),e&&t(I),e&&t(or),e&&t(se),e&&t(nr),v(Je,e),e&&t(lr),e&&t(Mt),e&&t(ir),v(Re,e),e&&t(fr),e&&t(Nt),e&&t(pr),v(Xe,e),e&&t(mr),e&&t(M),e&&t(dr),v(Ze,e),e&&t(hr),e&&t(Wt),e&&t(ur),v(Qe,e),e&&t(cr),e&&t(re),e&&t(_r),v(Ve,e),e&&t(wr),e&&t(oe),e&&t(vr),v(et,e),e&&t(yr),e&&t(Bt),e&&t(br),e&&t(ne),e&&t($r),v(tt,e),e&&t(gr),e&&t(Kt),e&&t(kr),e&&t(B),v(at),e&&t(Er),e&&t(Gt),e&&t(Tr),e&&t(ie)}}}const ep={local:"finetuning-a-pretrained-model",sections:[{local:"preparing-the-datasets",title:"Preparing the datasets"},{local:"finetuning-in-pytorch-with-the-trainer-api",title:"Fine-tuning in PyTorch with the Trainer API"},{local:"finetuning-with-keras",title:"Fine-tuning with Keras"},{local:"finetuning-in-native-pytorch",title:"Fine-tuning in native PyTorch"},{local:"additional-resources",title:"Additional resources"}],title:"Fine-tuning a pretrained model"};function tp(Xr,x,rt){let{fw:g}=x;return Xr.$$set=P=>{"fw"in P&&rt(0,g=P.fw)},[g]}class lp extends Jf{constructor(x){super();Rf(this,x,tp,Vf,Xf,{fw:0})}}export{lp as default,ep as metadata};
