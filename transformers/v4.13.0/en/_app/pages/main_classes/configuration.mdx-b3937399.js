import{S as Os,i as As,s as Ss,e as r,k as d,w as p,t as o,M as Fs,c as a,d as t,m as c,a as s,x as g,h as n,b as h,F as e,g as F,y as _,q as b,o as v,B as y}from"../../chunks/vendor-68651a14.js";import{T as Ds}from"../../chunks/Tip-3fbaa85f.js";import{D as z}from"../../chunks/Docstring-d699e906.js";import{C as js}from"../../chunks/CodeBlock-b98730f5.js";import{I as zs}from"../../chunks/IconCopyLink-8ff17449.js";import"../../chunks/CopyButton-e88c769b.js";function Is(ge){let m,x,u,w,O;return{c(){m=r("p"),x=o(`A configuration file can be loaded and saved to disk. Loading the configuration file and using this file to
...
initialize a model does `),u=a(C,"STRONG",{});var I=s(u);w=n(I,"not"),I.forEach(t),O=n(C," load the model weights. It only affects the model\u2019s configuration."),C.forEach(t)},m($,C){F($,m,C),e(m,x),e(m,u),e(u,w),e(m,O)},d($){$&&t(m)}}}function Ns(ge){let m,x,u,w,O;return{c(){m=r("p"),x=o("Passing "),u=r("code"),w=o("use_auth_token=True"),O=o(" is required when you want to use a private model.")},l($){m=a($,"P",{});var C=s(m);x=n(C,"Passing "),u=a(C,"CODE",{});var I=s(u);w=n(I,"use_auth_token=True"),I.forEach(t),O=n(C," is required when you want to use a private model."),C.forEach(t)},m($,C){F($,m,C),e(m,x),e(m,u),e(u,w),e(m,O)},d($){$&&t(m)}}}function Ls(ge){let m,x,u,w,O,$,C,I,Do,ro,R,jo,Ve,zo,Oo,ao,T,Ao,tt,So,Fo,ot,Io,No,nt,Lo,qo,rt,Mo,Wo,so,V,U,at,_e,Ho,st,Vo,io,l,be,Bo,it,Jo,Ro,G,Uo,dt,Go,Xo,P,ct,M,lt,Ko,Qo,ft,Yo,Zo,Be,en,tn,on,ht,D,mt,nn,rn,ut,an,sn,Je,dn,cn,Re,ln,fn,Ue,hn,mn,un,pt,X,gt,pn,gn,_t,_n,bn,vn,ve,K,bt,yn,wn,vt,$n,Pn,kn,yt,Cn,En,wt,Q,$t,xn,Tn,Pt,Dn,jn,zn,kt,Y,Ct,On,An,Et,Sn,Fn,In,xt,Z,Tt,Nn,Ln,Dt,qn,Mn,Wn,jt,ee,zt,Hn,Vn,Ot,Bn,Jn,Rn,A,ye,Un,we,Gn,At,Xn,Kn,Qn,St,Yn,Zn,$e,er,te,Pe,tr,N,or,Ft,nr,rr,It,ar,sr,Nt,ir,dr,cr,oe,ke,lr,Ce,fr,Ge,hr,mr,ur,ne,Ee,pr,xe,gr,Xe,_r,br,vr,j,Te,yr,De,wr,Ke,$r,Pr,kr,re,Cr,Lt,Er,xr,je,Tr,ae,ze,Dr,L,jr,qt,zr,Or,Qe,Ar,Sr,Mt,Fr,Ir,Nr,se,Oe,Lr,B,qr,Wt,Mr,Wr,Ye,Hr,Vr,Br,ie,Ae,Jr,Ht,Rr,Ur,de,Se,Gr,Vt,Xr,Kr,ce,Fe,Qr,Bt,Yr,Zr,le,Ie,ea,Jt,ta,oa,fe,Ne,na,Le,ra,Rt,aa,sa,ia,S,qe,da,Me,ca,Ut,la,fa,ha,J,ma,Gt,ua,pa,Xt,ga,_a,ba,Kt,va,co;return $=new zs({}),_e=new zs({}),be=new z({props:{name:"class transformers.PretrainedConfig",anchor:"transformers.PretrainedConfig",parameters:[{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/master/src/transformers/configuration_utils.py#L48",parametersDescription:[{anchor:"transformers.PretrainedConfig.name_or_path",description:`<strong>name_or_path</strong> (<code>str</code>, <em>optional</em>, defaults to <code>&quot;&quot;</code>) &#x2014;
...
that can be used as decoder models within the <a href="/docs/transformers/master/en/model_doc/encoderdecoder#transformers.EncoderDecoderModel">EncoderDecoderModel</a> class, which consists of all models
...
config.push_to_hub(<span class="hljs-string">&quot;my-finetuned-bert&quot;</span>, repo_url=<span class="hljs-string">&quot;https://huggingface.co/sgugger/my-finetuned-bert&quot;</span>)`}}),Pe=new z({props:{name:"dict_torch_dtype_to_str",anchor:"transformers.PretrainedConfig.dict_torch_dtype_to_str",parameters:[{name:"d",val:": typing.Dict[str, typing.Any]"}],source:"https://github.com/huggingface/transformers/blob/master/src/transformers/configuration_utils.py#L805"}}),ke=new z({props:{name:"from_dict",anchor:"transformers.PretrainedConfig.from_dict",parameters:[{name:"config_dict",val:": typing.Dict[str, typing.Any]"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/master/src/transformers/configuration_utils.py#L608",parametersDescription:[{anchor:"transformers.PretrainedConfig.from_dict.config_dict",description:`<strong>config_dict</strong> (<code>Dict[str, Any]</code>) &#x2014;
Dictionary that will be used to instantiate the configuration object. Such a dictionary can be
retrieved from a pretrained checkpoint by leveraging the
<a href="/docs/transformers/master/en/main_classes/configuration#transformers.PretrainedConfig.get_config_dict">get_config_dict()</a> method.`,name:"config_dict"},{anchor:"transformers.PretrainedConfig.from_dict.kwargs",description:`<strong>kwargs</strong> (<code>Dict[str, Any]</code>) &#x2014;
...
`}}),Ee=new z({props:{name:"from_json_file",anchor:"transformers.PretrainedConfig.from_json_file",parameters:[{name:"json_file",val:": typing.Union[str, os.PathLike]"}],source:"https://github.com/huggingface/transformers/blob/master/src/transformers/configuration_utils.py#L647",parametersDescription:[{anchor:"transformers.PretrainedConfig.from_json_file.json_file",description:`<strong>json_file</strong> (<code>str</code> or <code>os.PathLike</code>) &#x2014;
...
<p><a
  href="/docs/transformers/master/en/main_classes/configuration#transformers.PretrainedConfig"
>PretrainedConfig</a></p>
`}}),Te=new z({props:{name:"from_pretrained",anchor:"transformers.PretrainedConfig.from_pretrained",parameters:[{name:"pretrained_model_name_or_path",val:": typing.Union[str, os.PathLike]"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/master/src/transformers/configuration_utils.py#L431",parametersDescription:[{anchor:"transformers.PretrainedConfig.from_pretrained.pretrained_model_name_or_path",description:`<strong>pretrained_model_name_or_path</strong> (<code>str</code> or <code>os.PathLike</code>) &#x2014;
...
<p><a
  href="/docs/transformers/master/en/main_classes/configuration#transformers.PretrainedConfig"
>PretrainedConfig</a></p>
`}}),re=new Ds({props:{$$slots:{default:[Ns]},$$scope:{ctx:ge}}}),je=new js({props:{code:`# We can't instantiate directly the base class _PretrainedConfig_ so let's show the examples on a
...
<span class="hljs-keyword">assert</span> config.output_attentions == <span class="hljs-literal">True</span>
<span class="hljs-keyword">assert</span> unused_kwargs == {<span class="hljs-string">&#x27;foo&#x27;</span>: <span class="hljs-literal">False</span>}`}}),ze=new z({props:{name:"get_config_dict",anchor:"transformers.PretrainedConfig.get_config_dict",parameters:[{name:"pretrained_model_name_or_path",val:": typing.Union[str, os.PathLike]"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/master/src/transformers/configuration_utils.py#L510",parametersDescription:[{anchor:"transformers.PretrainedConfig.get_config_dict.pretrained_model_name_or_path",description:`<strong>pretrained_model_name_or_path</strong> (<code>str</code> or <code>os.PathLike</code>) &#x2014;
...
`}}),Oe=new z({props:{name:"save_pretrained",anchor:"transformers.PretrainedConfig.save_pretrained",parameters:[{name:"save_directory",val:": typing.Union[str, os.PathLike]"},{name:"push_to_hub",val:": bool = False"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/master/src/transformers/configuration_utils.py#L391",parametersDescription:[{anchor:"transformers.PretrainedConfig.save_pretrained.save_directory",description:`<strong>save_directory</strong> (<code>str</code> or <code>os.PathLike</code>) &#x2014;
...
Whether or not to push your model to the Hugging Face model hub after saving it.`,name:"push_to_hub"}]}}),Ae=new z({props:{name:"to_dict",anchor:"transformers.PretrainedConfig.to_dict",parameters:[],source:"https://github.com/huggingface/transformers/blob/master/src/transformers/configuration_utils.py#L707",returnDescription:`
<p>Dictionary of all the attributes that make up this configuration instance.</p>
`,returnType:`
<p><code>Dict[str, Any]</code></p>
`}}),Se=new z({props:{name:"to_diff_dict",anchor:"transformers.PretrainedConfig.to_diff_dict",parameters:[],source:"https://github.com/huggingface/transformers/blob/master/src/transformers/configuration_utils.py#L675",returnDescription:`
<p>Dictionary of all the attributes that make up this configuration instance,</p>
`,returnType:`
<p><code>Dict[str, Any]</code></p>
`}}),Fe=new z({props:{name:"to_json_file",anchor:"transformers.PretrainedConfig.to_json_file",parameters:[{name:"json_file_path",val:": typing.Union[str, os.PathLike]"},{name:"use_diff",val:": bool = True"}],source:"https://github.com/huggingface/transformers/blob/master/src/transformers/configuration_utils.py#L743",parametersDescription:[{anchor:"transformers.PretrainedConfig.to_json_file.json_file_path",description:`<strong>json_file_path</strong> (<code>str</code> or <code>os.PathLike</code>) &#x2014;
...
<code>PretrainedConfig()</code> is serialized to JSON file.`,name:"use_diff"}]}}),Ie=new z({props:{name:"to_json_string",anchor:"transformers.PretrainedConfig.to_json_string",parameters:[{name:"use_diff",val:": bool = True"}],source:"https://github.com/huggingface/transformers/blob/master/src/transformers/configuration_utils.py#L725",parametersDescription:[{anchor:"transformers.PretrainedConfig.to_json_string.use_diff",description:`<strong>use_diff</strong> (<code>bool</code>, <em>optional</em>, defaults to <code>True</code>) &#x2014;
If set to <code>True</code>, only the difference between the config instance and the default
...
`,returnType:`
<p><code>str</code></p>
`}}),Ne=new z({props:{name:"update",anchor:"transformers.PretrainedConfig.update",parameters:[{name:"config_dict",val:": typing.Dict[str, typing.Any]"}],source:"https://github.com/huggingface/transformers/blob/master/src/transformers/configuration_utils.py#L757",parametersDescription:[{anchor:"transformers.PretrainedConfig.update.config_dict",description:"<strong>config_dict</strong> (<code>Dict[str, Any]</code>) &#x2014; Dictionary of attributes that should be updated for this class.",name:"config_dict"}]}}),qe=new z({props:{name:"update_from_string",anchor:"transformers.PretrainedConfig.update_from_string",parameters:[{name:"update_str",val:": str"}],source:"https://github.com/huggingface/transformers/blob/master/src/transformers/configuration_utils.py#L767",parametersDescription:[{anchor:"transformers.PretrainedConfig.update_from_string.update_str",description:"<strong>update_str</strong> (<code>str</code>) &#x2014; String with attributes that should be updated for this class.",name:"update_str"}]}}),{c(){m=r("meta"),x=d(),u=r("h1"),w=r("a"),O=r("span"),p($.$$.fragment),C=d(),I=r("span"),Do=o("Configuration"),ro=d(),R=r("p"),jo=o("The base class "),Ve=r("a"),zo=o("PretrainedConfig"),Oo=o(` implements the common methods for loading/saving a configuration
...
`),tt=r("code"),So=o("hidden_size"),Fo=o(", "),ot=r("code"),Io=o("num_attention_heads"),No=o(", and "),nt=r("code"),Lo=o("num_hidden_layers"),qo=o(`. Text models further implement:
...
embeddings matrix (this attribute may be missing for models that don\u2019t have a text modality like ViT).`),zn=d(),kt=r("li"),Y=r("p"),Ct=r("strong"),On=o("hidden_size"),An=o(" ("),Et=r("code"),Sn=o("int"),Fn=o(") \u2014 The hidden size of the model."),In=d(),xt=r("li"),Z=r("p"),Tt=r("strong"),Nn=o("num_attention_heads"),Ln=o(" ("),Dt=r("code"),qn=o("int"),Mn=o(`) \u2014 The number of attention heads used in the multi-head attention layers of the
...
`),At=r("code"),Xn=o("repo_path_or_name"),Kn=o("."),Qn=d(),St=r("p"),Yn=o("Examples:"),Zn=d(),p($e.$$.fragment),er=d(),te=r("div"),p(Pe.$$.fragment),tr=d(),N=r("p"),or=o("Checks whether the passed dictionary has a "),Ft=r("em"),nr=o("torch_dtype"),rr=o(` key and if it\u2019s not None, converts torch.dtype to a
string of just the type. For example, `),It=r("code"),ar=o("torch.float32"),sr=o(" get converted into "),Nt=r("em"),ir=o("\u201Cfloat32\u201D"),dr=o(` string, which can
...
configuration.`),kr=d(),p(re.$$.fragment),Cr=d(),Lt=r("p"),Er=o("Examples:"),xr=d(),p(je.$$.fragment),Tr=d(),ae=r("div"),p(ze.$$.fragment),Dr=d(),L=r("p"),jr=o("From a "),qt=r("code"),zr=o("pretrained_model_name_or_path"),Or=o(`, resolve to a dictionary of parameters, to be used for instantiating a
`),Qe=r("a"),Ar=o("PretrainedConfig"),Sr=o(" using "),Mt=r("code"),Fr=o("from_dict"),Ir=o("."),Nr=d(),se=r("div"),p(Oe.$$.fragment),Lr=d(),B=r("p"),qr=o("Save a configuration object to the directory "),Wt=r("code"),Mr=o("save_directory"),Wr=o(`, so that it can be re-loaded using the
...
serializes to a Python dictionary.`),Kr=d(),ce=r("div"),p(Fe.$$.fragment),Qr=d(),Bt=r("p"),Yr=o("Save this instance to a JSON file."),Zr=d(),le=r("div"),p(Ie.$$.fragment),ea=d(),Jt=r("p"),ta=o("Serializes this instance to a JSON string."),oa=d(),fe=r("div"),p(Ne.$$.fragment),na=d(),Le=r("p"),ra=o("Updates attributes of this class with attributes from "),Rt=r("code"),aa=o("config_dict"),sa=o("."),ia=d(),S=r("div"),p(qe.$$.fragment),da=d(),Me=r("p"),ca=o("Updates attributes of this class with attributes from "),Ut=r("code"),la=o("update_str"),fa=o("."),ha=d(),J=r("p"),ma=o("The expected format is ints, floats and strings as is, and for booleans use "),Gt=r("code"),ua=o("true"),pa=o(" or "),Xt=r("code"),ga=o("false"),_a=o(`. For example:
...
`),tt=a(W,"CODE",{});var Pa=s(tt);So=n(Pa,"hidden_size"),Pa.forEach(t),Fo=n(W,", "),ot=a(W,"CODE",{});var ka=s(ot);Io=n(ka,"num_attention_heads"),ka.forEach(t),No=n(W,", and "),nt=a(W,"CODE",{});var Ca=s(nt);Lo=n(Ca,"num_hidden_layers"),Ca.forEach(t),qo=n(W,`. Text models further implement:
...
the correct object in `),Be=a(He,"A",{href:!0});var Fa=s(Be);en=n(Fa,"AutoConfig"),Fa.forEach(t),tn=n(He,"."),He.forEach(t),Oa.forEach(t),on=c(E),ht=a(E,"LI",{});var Ia=s(ht);D=a(Ia,"P",{});var q=s(D);mt=a(q,"STRONG",{});var Na=s(mt);nn=n(Na,"is_composition"),Na.forEach(t),rn=n(q," ("),ut=a(q,"CODE",{});var La=s(ut);an=n(La,"bool"),La.forEach(t),sn=n(q,`) \u2014 Whether the config class is composed of multiple sub-configs. In this case the
...
`),At=a(mo,"CODE",{});var ss=s(At);Xn=n(ss,"repo_path_or_name"),ss.forEach(t),Kn=n(mo,"."),mo.forEach(t),Qn=c(he),St=a(he,"P",{});var is=s(St);Yn=n(is,"Examples:"),is.forEach(t),Zn=c(he),g($e.$$.fragment,he),he.forEach(t),er=c(f),te=a(f,"DIV",{class:!0});var uo=s(te);g(Pe.$$.fragment,uo),tr=c(uo),N=a(uo,"P",{});var me=s(N);or=n(me,"Checks whether the passed dictionary has a "),Ft=a(me,"EM",{});var ds=s(Ft);nr=n(ds,"torch_dtype"),ds.forEach(t),rr=n(me,` key and if it\u2019s not None, converts torch.dtype to a
string of just the type. For example, `),It=a(me,"CODE",{});var cs=s(It);ar=n(cs,"torch.float32"),cs.forEach(t),sr=n(me," get converted into "),Nt=a(me,"EM",{});var ls=s(Nt);ir=n(ls,"\u201Cfloat32\u201D"),ls.forEach(t),dr=n(me,` string, which can
...
configuration.`),vo.forEach(t),kr=c(H),g(re.$$.fragment,H),Cr=c(H),Lt=a(H,"P",{});var us=s(Lt);Er=n(us,"Examples:"),us.forEach(t),xr=c(H),g(je.$$.fragment,H),H.forEach(t),Tr=c(f),ae=a(f,"DIV",{class:!0});var yo=s(ae);g(ze.$$.fragment,yo),Dr=c(yo),L=a(yo,"P",{});var ue=s(L);jr=n(ue,"From a "),qt=a(ue,"CODE",{});var ps=s(qt);zr=n(ps,"pretrained_model_name_or_path"),ps.forEach(t),Or=n(ue,`, resolve to a dictionary of parameters, to be used for instantiating a
`),Qe=a(ue,"A",{href:!0});var gs=s(Qe);Ar=n(gs,"PretrainedConfig"),gs.forEach(t),Sr=n(ue," using "),Mt=a(ue,"CODE",{});var _s=s(Mt);Fr=n(_s,"from_dict"),_s.forEach(t),Ir=n(ue,"."),ue.forEach(t),yo.forEach(t),Nr=c(f),se=a(f,"DIV",{class:!0});var wo=s(se);g(Oe.$$.fragment,wo),Lr=c(wo),B=a(wo,"P",{});var Ze=s(B);qr=n(Ze,"Save a configuration object to the directory "),Wt=a(Ze,"CODE",{});var bs=s(Wt);Mr=n(bs,"save_directory"),bs.forEach(t),Wr=n(Ze,`, so that it can be re-loaded using the
...
serializes to a Python dictionary.`),ws.forEach(t),Po.forEach(t),Kr=c(f),ce=a(f,"DIV",{class:!0});var ko=s(ce);g(Fe.$$.fragment,ko),Qr=c(ko),Bt=a(ko,"P",{});var $s=s(Bt);Yr=n($s,"Save this instance to a JSON file."),$s.forEach(t),ko.forEach(t),Zr=c(f),le=a(f,"DIV",{class:!0});var Co=s(le);g(Ie.$$.fragment,Co),ea=c(Co),Jt=a(Co,"P",{});var Ps=s(Jt);ta=n(Ps,"Serializes this instance to a JSON string."),Ps.forEach(t),Co.forEach(t),oa=c(f),fe=a(f,"DIV",{class:!0});var Eo=s(fe);g(Ne.$$.fragment,Eo),na=c(Eo),Le=a(Eo,"P",{});var xo=s(Le);ra=n(xo,"Updates attributes of this class with attributes from "),Rt=a(xo,"CODE",{});var ks=s(Rt);aa=n(ks,"config_dict"),ks.forEach(t),sa=n(xo,"."),xo.forEach(t),Eo.forEach(t),ia=c(f),S=a(f,"DIV",{class:!0});var pe=s(S);g(qe.$$.fragment,pe),da=c(pe),Me=a(pe,"P",{});var To=s(Me);ca=n(To,"Updates attributes of this class with attributes from "),Ut=a(To,"CODE",{});var Cs=s(Ut);la=n(Cs,"update_str"),Cs.forEach(t),fa=n(To,"."),To.forEach(t),ha=c(pe),J=a(pe,"P",{});var et=s(J);ma=n(et,"The expected format is ints, floats and strings as is, and for booleans use "),Gt=a(et,"CODE",{});var Es=s(Gt);ua=n(Es,"true"),Es.forEach(t),pa=n(et," or "),Xt=a(et,"CODE",{});var xs=s(Xt);ga=n(xs,"false"),xs.forEach(t),_a=n(et,`. For example:
\u201Cn_embd=10,resid_pdrop=0.2,scale_attn_weights=false,summary_type=cls_index\u201D`),et.forEach(t),ba=c(pe),Kt=a(pe,"P",{});var Ts=s(Kt);va=n(Ts,"The keys to change have to already exist in the config object."),Ts.forEach(t),pe.forEach(t),f.forEach(t),this.h()},h(){h(m,"name","hf:doc:metadata"),h(m,"content",JSON.stringify(qs)),h(w,"id","configuration"),h(w,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),h(w,"href","#configuration"),h(u,"class","relative group"),h(Ve,"href","/docs/transformers/master/en/main_classes/configuration#transformers.PretrainedConfig"),h(U,"id","transformers.PretrainedConfig"),h(U,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),h(U,"href","#transformers.PretrainedConfig"),h(V,"class","relative group"),h(Be,"href","/docs/transformers/master/en/model_doc/auto#transformers.AutoConfig"),h(Je,"href","/docs/transformers/master/en/main_classes/configuration#transformers.PretrainedConfig"),h(Re,"href","/docs/transformers/master/en/model_doc/encoderdecoder#transformers.EncoderDecoderConfig"),h(Ue,"href","/docs/transformers/master/en/model_doc/rag#transformers.RagConfig"),h(A,"class","docstring"),h(te,"class","docstring"),h(Ge,"href","/docs/transformers/master/en/main_classes/configuration#transformers.PretrainedConfig"),h(oe,"class","docstring"),h(Xe,"href","/docs/transformers/master/en/main_classes/configuration#transformers.PretrainedConfig"),h(ne,"class","docstring"),h(Ke,"href","/docs/transformers/master/en/main_classes/configuration#transformers.PretrainedConfig"),h(j,"class","docstring"),h(Qe,"href","/docs/transformers/master/en/main_classes/configuration#transformers.PretrainedConfig"),h(ae,"class","docstring"),h(Ye,"href","/docs/transformers/master/en/main_classes/configuration#transformers.PretrainedConfig.from_pretrained"),h(se,"class","docstring"),h(ie,"class","docstring"),h(de,"class","docstring"),h(ce,"class","docstring"),h(le,"class","docstring"),h(fe,"class","docstring"),h(S,"class","docstring"),h(l,"class","docstring")},m(i,k){e(document.head,m),F(i,x,k),F(i,u,k),e(u,w),e(w,O),_($,O,null),e(u,C),e(u,I),e(I,Do),F(i,ro,k),F(i,R,k),e(R,jo),e(R,Ve),e(Ve,zo),e(R,Oo),F(i,ao,k),F(i,T,k),e(T,Ao),e(T,tt),e(tt,So),e(T,Fo),e(T,ot),e(ot,Io),e(T,No),e(T,nt),e(nt,Lo),e(T,qo),e(T,rt),e(rt,Mo),e(T,Wo),F(i,so,k),F(i,V,k),e(V,U),e(U,at),_(_e,at,null),e(V,Ho),e(V,st),e(st,Vo),F(i,io,k),F(i,l,k),_(be,l,null),e(l,Bo),e(l,it),e(it,Jo),e(l,Ro),_(G,l,null),e(l,Uo),e(l,dt),e(dt,Go),e(l,Xo),e(l,P),e(P,ct),e(ct,M),e(M,lt),e(lt,Ko),e(M,Qo),e(M,ft),e(ft,Yo),e(M,Zo),e(M,Be),e(Be,en),e(M,tn),e(P,on),e(P,ht),e(ht,D),e(D,mt),e(mt,nn),e(D,rn),e(D,ut),e(ut,an),e(D,sn),e(D,Je),e(Je,dn),e(D,cn),e(D,Re),e(Re,ln),e(D,fn),e(D,Ue),e(Ue,hn),e(D,mn),e(P,un),e(P,pt),e(pt,X),e(X,gt),e(gt,pn),e(X,gn),e(X,_t),e(_t,_n),e(X,bn),e(P,vn),e(P,ve),e(ve,K),e(K,bt),e(bt,yn),e(K,wn),e(K,vt),e(vt,$n),e(K,Pn),e(ve,kn),e(ve,yt),e(yt,Cn),e(P,En),e(P,wt),e(wt,Q),e(Q,$t),e($t,xn),e(Q,Tn),e(Q,Pt),e(Pt,Dn),e(Q,jn),e(P,zn),e(P,kt),e(kt,Y),e(Y,Ct),e(Ct,On),e(Y,An),e(Y,Et),e(Et,Sn),e(Y,Fn),e(P,In),e(P,xt),e(xt,Z),e(Z,Tt),e(Tt,Nn),e(Z,Ln),e(Z,Dt),e(Dt,qn),e(Z,Mn),e(P,Wn),e(P,jt),e(jt,ee),e(ee,zt),e(zt,Hn),e(ee,Vn),e(ee,Ot),e(Ot,Bn),e(ee,Jn),e(l,Rn),e(l,A),_(ye,A,null),e(A,Un),e(A,we),e(we,Gn),e(we,At),e(At,Xn),e(we,Kn),e(A,Qn),e(A,St),e(St,Yn),e(A,Zn),_($e,A,null),e(l,er),e(l,te),_(Pe,te,null),e(te,tr),e(te,N),e(N,or),e(N,Ft),e(Ft,nr),e(N,rr),e(N,It),e(It,ar),e(N,sr),e(N,Nt),e(Nt,ir),e(N,dr),e(l,cr),e(l,oe),_(ke,oe,null),e(oe,lr),e(oe,Ce),e(Ce,fr),e(Ce,Ge),e(Ge,hr),e(Ce,mr),e(l,ur),e(l,ne),_(Ee,ne,null),e(ne,pr),e(ne,xe),e(xe,gr),e(xe,Xe),e(Xe,_r),e(xe,br),e(l,vr),e(l,j),_(Te,j,null),e(j,yr),e(j,De),e(De,wr),e(De,Ke),e(Ke,$r),e(De,Pr),e(j,kr),_(re,j,null),e(j,Cr),e(j,Lt),e(Lt,Er),e(j,xr),_(je,j,null),e(l,Tr),e(l,ae),_(ze,ae,null),e(ae,Dr),e(ae,L),e(L,jr),e(L,qt),e(qt,zr),e(L,Or),e(L,Qe),e(Qe,Ar),e(L,Sr),e(L,Mt),e(Mt,Fr),e(L,Ir),e(l,Nr),e(l,se),_(Oe,se,null),e(se,Lr),e(se,B),e(B,qr),e(B,Wt),e(Wt,Mr),e(B,Wr),e(B,Ye),e(Ye,Hr),e(B,Vr),e(l,Br),e(l,ie),_(Ae,ie,null),e(ie,Jr),e(ie,Ht),e(Ht,Rr),e(l,Ur),e(l,de),_(Se,de,null),e(de,Gr),e(de,Vt),e(Vt,Xr),e(l,Kr),e(l,ce),_(Fe,ce,null),e(ce,Qr),e(ce,Bt),e(Bt,Yr),e(l,Zr),e(l,le),_(Ie,le,null),e(le,ea),e(le,Jt),e(Jt,ta),e(l,oa),e(l,fe),_(Ne,fe,null),e(fe,na),e(fe,Le),e(Le,ra),e(Le,Rt),e(Rt,aa),e(Le,sa),e(l,ia),e(l,S),_(qe,S,null),e(S,da),e(S,Me),e(Me,ca),e(Me,Ut),e(Ut,la),e(Me,fa),e(S,ha),e(S,J),e(J,ma),e(J,Gt),e(Gt,ua),e(J,pa),e(J,Xt),e(Xt,ga),e(J,_a),e(S,ba),e(S,Kt),e(Kt,va),co=!0},p(i,[k]){const We={};k&2&&(We.$$scope={dirty:k,ctx:i}),G.$set(We);const Qt={};k&2&&(Qt.$$scope={dirty:k,ctx:i}),re.$set(Qt)},i(i){co||(b($.$$.fragment,i),b(_e.$$.fragment,i),b(be.$$.fragment,i),b(G.$$.fragment,i),b(ye.$$.fragment,i),b($e.$$.fragment,i),b(Pe.$$.fragment,i),b(ke.$$.fragment,i),b(Ee.$$.fragment,i),b(Te.$$.fragment,i),b(re.$$.fragment,i),b(je.$$.fragment,i),b(ze.$$.fragment,i),b(Oe.$$.fragment,i),b(Ae.$$.fragment,i),b(Se.$$.fragment,i),b(Fe.$$.fragment,i),b(Ie.$$.fragment,i),b(Ne.$$.fragment,i),b(qe.$$.fragment,i),co=!0)},o(i){v($.$$.fragment,i),v(_e.$$.fragment,i),v(be.$$.fragment,i),v(G.$$.fragment,i),v(ye.$$.fragment,i),v($e.$$.fragment,i),v(Pe.$$.fragment,i),v(ke.$$.fragment,i),v(Ee.$$.fragment,i),v(Te.$$.fragment,i),v(re.$$.fragment,i),v(je.$$.fragment,i),v(ze.$$.fragment,i),v(Oe.$$.fragment,i),v(Ae.$$.fragment,i),v(Se.$$.fragment,i),v(Fe.$$.fragment,i),v(Ie.$$.fragment,i),v(Ne.$$.fragment,i),v(qe.$$.fragment,i),co=!1},d(i){t(m),i&&t(x),i&&t(u),y($),i&&t(ro),i&&t(R),i&&t(ao),i&&t(T),i&&t(so),i&&t(V),y(_e),i&&t(io),i&&t(l),y(be),y(G),y(ye),y($e),y(Pe),y(ke),y(Ee),y(Te),y(re),y(je),y(ze),y(Oe),y(Ae),y(Se),y(Fe),y(Ie),y(Ne),y(qe)}}}const qs={local:"configuration",sections:[{local:"transformers.PretrainedConfig",title:"PretrainedConfig"}],title:"Configuration"};function Ms(ge,m,x){let{fw:u}=m;return ge.$$set=w=>{"fw"in w&&x(0,u=w.fw)},[u]}class Us extends Os{constructor(m){super();As(this,m,Ms,Ls,Ss,{fw:0})}}export{Us as default,qs as metadata};
