import{S as hm,i as dm,s as um,e as l,k as f,w as u,t as n,M as cm,c as i,d as t,m as h,a as p,x as c,h as o,b as d,F as s,g as r,y as m,q as _,o as w,B as $}from"../chunks/vendor-68651a14.js";import{T as Cd}from"../chunks/Tip-3fbaa85f.js";import{I as A}from"../chunks/IconCopyLink-8ff17449.js";import{C as g}from"../chunks/CodeBlock-b98730f5.js";import"../chunks/CopyButton-e88c769b.js";function mm(G){let b,E,k,y,q,v,z,T;return{c(){b=l("p"),E=n(`For a more in-depth example of how to fine-tune a model for text classification, take a look at the corresponding
...
`),k=i(x,"A",{href:!0,rel:!0});var P=p(k);y=o(P,"PyTorch notebook"),P.forEach(t),q=o(x,`
or `),v=i(x,"A",{href:!0,rel:!0});var C=p(v);z=o(C,"TensorFlow notebook"),C.forEach(t),T=o(x,"."),x.forEach(t),this.h()},h(){d(k,"href","https://colab.research.google.com/github/huggingface/notebooks/blob/master/examples/question_answering.ipynb"),d(k,"rel","nofollow"),d(v,"href","https://colab.research.google.com/github/huggingface/notebooks/blob/master/examples/question_answering-tf.ipynb"),d(v,"rel","nofollow")},m(j,x){r(j,b,x),s(b,E),s(b,k),s(k,y),s(b,q),s(b,v),s(v,z),s(b,T)},d(j){j&&t(b)}}}function $m(G){let b,E,k,y,q,v,z,T,j,x,P,C,eo,de,wi,st,$i,gi,to,at,so,Es,bi,ao,M,Ca,qs,ki,vi,Da,Ts,xi,yi,Sa,As,ji,no,zs,oo,J,ue,Ia,nt,Ei,Ma,qi,ro,ce,Ti,ot,Ai,zi,lo,me,io,K,_e,Na,rt,Pi,La,Fi,po,Ps,Ci,fo,lt,ho,we,Di,Ba,Si,Ii,uo,it,co,X,$e,Oa,pt,Mi,Ha,Ni,mo,N,Li,Fs,Bi,Oi,ft,Hi,Wi,_o,ht,wo,Cs,Qi,$o,dt,go,L,Ri,Wa,Ui,Vi,Qa,Yi,Gi,bo,ut,ko,F,Ji,Ra,Ki,Xi,Ua,Zi,ep,Va,tp,sp,Ya,ap,np,vo,ct,xo,Z,ge,Ga,mt,op,Ja,rp,yo,be,lp,Ds,ip,pp,jo,_t,Eo,Ss,fp,qo,B,wt,hp,Is,dp,up,cp,$t,mp,Ms,_p,wp,$p,gt,gp,Ka,bp,kp,To,bt,Ao,ee,ke,Xa,kt,vp,Za,xp,zo,Ns,yp,Po,D,jp,Ls,Ep,qp,en,Tp,Ap,tn,zp,Pp,Fo,vt,Co,S,Fp,sn,Cp,Dp,an,Sp,Ip,nn,Mp,Np,Do,xt,So,Bs,Lp,Io,yt,Mo,ve,Bp,Os,Op,Hp,No,jt,Lo,Hs,Wp,Bo,Et,Oo,xe,Qp,on,Rp,Up,Ho,qt,Wo,Ws,Qo,te,ye,rn,Tt,Vp,ln,Yp,Ro,je,Gp,At,Jp,Kp,Uo,Ee,Vo,se,qe,pn,zt,Xp,fn,Zp,Yo,Qs,ef,Go,Pt,Jo,Rs,tf,Ko,Ft,Xo,Us,sf,Zo,Ct,er,Vs,af,tr,O,Ys,hn,nf,of,rf,H,dn,lf,pf,un,ff,hf,cn,df,uf,cf,Gs,mn,mf,_f,sr,ae,Te,_n,Dt,wf,wn,$f,ar,Ae,gf,Js,bf,kf,nr,St,or,ze,vf,$n,xf,yf,rr,It,lr,W,jf,gn,Ef,qf,bn,Tf,Af,ir,Q,Mt,zf,kn,Pf,Ff,Cf,ne,Df,vn,Sf,If,xn,Mf,Nf,Lf,Nt,Bf,yn,Of,Hf,pr,Ks,Wf,fr,Lt,hr,Pe,Qf,jn,Rf,Uf,dr,Bt,ur,Xs,Vf,cr,Ot,mr,oe,Fe,En,Ht,Yf,qn,Gf,_r,Ce,Jf,Zs,Kf,Xf,wr,Wt,$r,De,Zf,ea,eh,th,gr,Qt,br,Se,sh,ta,ah,nh,kr,Rt,vr,sa,oh,xr,Ut,yr,re,Ie,Tn,Vt,rh,An,lh,jr,aa,ih,Er,Yt,qr,R,ph,zn,fh,hh,Pn,dh,uh,Tr,Gt,Ar,Me,ch,na,mh,_h,zr,Jt,Pr,oa,wh,Fr,Kt,Cr,ra,$h,Dr,Xt,Sr,Ne,gh,Fn,bh,kh,Ir,Zt,Mr,la,Nr,le,Le,Cn,es,vh,Dn,xh,Lr,Be,yh,ts,jh,Eh,Br,Oe,Or,ie,He,Sn,ss,qh,In,Th,Hr,ia,Ah,Wr,as,Qr,pa,zh,Rr,ns,Ur,pe,We,Mn,os,Ph,Nn,Fh,Vr,Qe,Ch,fa,Dh,Sh,Yr,rs,Gr,ha,Ih,Jr,U,I,Mh,Ln,Nh,Lh,Bn,Bh,Oh,On,Hh,Wh,Qh,ls,Rh,Hn,Uh,Vh,Yh,is,Gh,Wn,Jh,Kh,Kr,da,Xh,Xr,ps,Zr,Re,Zh,Qn,ed,td,el,fs,tl,ua,sd,sl,hs,al,fe,Ue,Rn,ds,ad,Un,nd,nl,Ve,od,ca,rd,ld,ol,us,rl,Ye,id,ma,pd,fd,ll,cs,il,Ge,hd,_a,dd,ud,pl,ms,fl,wa,cd,hl,_s,dl,he,Je,Vn,ws,md,Yn,_d,ul,$a,wd,cl,$s,ml,V,$d,Gn,gd,bd,Jn,kd,vd,_l,gs,wl,ga,xd,$l,bs,gl,Ke,yd,ba,jd,Ed,bl,ks,kl,ka,qd,vl,vs,xl,Xe,Td,Kn,Ad,zd,yl,xs,jl;return v=new A({}),at=new g({props:{code:"pip install datasets,",highlighted:"pip install datasets"}}),nt=new A({}),me=new Cd({props:{$$slots:{default:[mm]},$$scope:{ctx:G}}}),rt=new A({}),lt=new g({props:{code:`from datasets import load_dataset
...
examples in this guide will use \u{1F917} Datasets to load and preprocess a dataset.`),to=f(),u(at.$$.fragment),so=f(),Es=l("p"),bi=n("Learn how to fine-tune a model for:"),ao=f(),M=l("ul"),Ca=l("li"),qs=l("a"),ki=n("seq_imdb"),vi=f(),Da=l("li"),Ts=l("a"),xi=n("tok_ner"),yi=f(),Sa=l("li"),As=l("a"),ji=n("qa_squad"),no=f(),zs=l("a"),oo=f(),J=l("h2"),ue=l("a"),Ia=l("span"),u(nt.$$.fragment),Ei=f(),Ma=l("span"),qi=n("Sequence classification with IMDb reviews"),ro=f(),ce=l("p"),Ti=n(`Sequence classification refers to the task of classifying sequences of text according to a given number of classes. In
this example, learn how to fine-tune a model on the `),ot=l("a"),Ai=n("IMDb dataset"),zi=n(` to determine
whether a review is positive or negative.`),lo=f(),u(me.$$.fragment),io=f(),K=l("h3"),_e=l("a"),Na=l("span"),u(rt.$$.fragment),Pi=f(),La=l("span"),Fi=n("Load IMDb dataset"),po=f(),Ps=l("p"),Ci=n("The \u{1F917} Datasets library makes it simple to load a dataset:"),fo=f(),u(lt.$$.fragment),ho=f(),we=l("p"),Di=n("This loads a "),Ba=l("code"),Si=n("DatasetDict"),Ii=n(" object which you can index into to view an example:"),uo=f(),u(it.$$.fragment),co=f(),X=l("h3"),$e=l("a"),Oa=l("span"),u(pt.$$.fragment),Mi=f(),Ha=l("span"),Ni=n("Preprocess"),mo=f(),N=l("p"),Li=n(`The next step is to tokenize the text into a readable format by the model. It is important to load the same tokenizer a
...
batch. This is known as `),Va=l("strong"),tp=n("dynamic padding"),sp=n(". You can do this with the "),Ya=l("code"),ap=n("DataCollatorWithPadding"),np=n(" function:"),vo=f(),u(ct.$$.fragment),xo=f(),Z=l("h3"),ge=l("a"),Ga=l("span"),u(mt.$$.fragment),op=f(),Ja=l("span"),rp=n("Fine-tune with the Trainer API"),yo=f(),be=l("p"),lp=n("Now load your model with the "),Ds=l("a"),ip=n("AutoModelForSequenceClassification"),pp=n(" class along with the number of expected labels:"),jo=f(),u(_t.$$.fragment),Eo=f(),Ss=l("p"),fp=n("At this point, only three steps remain:"),qo=f(),B=l("ol"),wt=l("li"),hp=n("Define your training hyperparameters in "),Is=l("a"),dp=n("TrainingArguments"),up=n("."),cp=f(),$t=l("li"),mp=n("Pass the training arguments to a "),Ms=l("a"),_p=n("Trainer"),wp=n(" along with the model, dataset, tokenizer, and data collator."),$p=f(),gt=l("li"),gp=n("Call "),Ka=l("code"),bp=n("Trainer.train()"),kp=n(" to fine-tune your model."),To=f(),u(bt.$$.fragment),Ao=f(),ee=l("h3"),ke=l("a"),Xa=l("span"),u(kt.$$.fragment),vp=f(),Za=l("span"),xp=n("Fine-tune with TensorFlow"),zo=f(),Ns=l("p"),yp=n("Fine-tuning with TensorFlow is just as easy, with only a few differences."),Po=f(),D=l("p"),jp=n("Start by batching the processed examples together with dynamic padding using the "),Ls=l("a"),Ep=n("DataCollatorWithPadding"),qp=n(` function.
...
`),nn=l("code"),Mp=n("columns"),Np=n(" argument:"),Do=f(),u(xt.$$.fragment),So=f(),Bs=l("p"),Lp=n("Set up an optimizer function, learning rate schedule, and some training hyperparameters:"),Io=f(),u(yt.$$.fragment),Mo=f(),ve=l("p"),Bp=n("Load your model with the "),Os=l("a"),Op=n("TFAutoModelForSequenceClassification"),Hp=n(" class along with the number of expected labels:"),No=f(),u(jt.$$.fragment),Lo=f(),Hs=l("p"),Wp=n("Compile the model:"),Bo=f(),u(Et.$$.fragment),Oo=f(),xe=l("p"),Qp=n("Finally, fine-tune the model by calling "),on=l("code"),Rp=n("model.fit"),Up=n(":"),Ho=f(),u(qt.$$.fragment),Wo=f(),Ws=l("a"),Qo=f(),te=l("h2"),ye=l("a"),rn=l("span"),u(Tt.$$.fragment),Vp=f(),ln=l("span"),Yp=n("Token classification with WNUT emerging entities"),Ro=f(),je=l("p"),Gp=n(`Token classification refers to the task of classifying individual tokens in a sentence. One of the most common token
...
examples in this guide will use \u{1F917} Datasets to load and preprocess a dataset.`),El.forEach(t),to=h(e),c(at.$$.fragment,e),so=h(e),Es=i(e,"P",{});var Md=p(Es);bi=o(Md,"Learn how to fine-tune a model for:"),Md.forEach(t),ao=h(e),M=i(e,"UL",{});var va=p(M);Ca=i(va,"LI",{});var Nd=p(Ca);qs=i(Nd,"A",{href:!0});var Ld=p(qs);ki=o(Ld,"seq_imdb"),Ld.forEach(t),Nd.forEach(t),vi=h(va),Da=i(va,"LI",{});var Bd=p(Da);Ts=i(Bd,"A",{href:!0});var Od=p(Ts);xi=o(Od,"tok_ner"),Od.forEach(t),Bd.forEach(t),yi=h(va),Sa=i(va,"LI",{});var Hd=p(Sa);As=i(Hd,"A",{href:!0});var Wd=p(As);ji=o(Wd,"qa_squad"),Wd.forEach(t),Hd.forEach(t),va.forEach(t),no=h(e),zs=i(e,"A",{id:!0}),p(zs).forEach(t),oo=h(e),J=i(e,"H2",{class:!0});var ql=p(J);ue=i(ql,"A",{id:!0,class:!0,href:!0});var Qd=p(ue);Ia=i(Qd,"SPAN",{});var Rd=p(Ia);c(nt.$$.fragment,Rd),Rd.forEach(t),Qd.forEach(t),Ei=h(ql),Ma=i(ql,"SPAN",{});var Ud=p(Ma);qi=o(Ud,"Sequence classification with IMDb reviews"),Ud.forEach(t),ql.forEach(t),ro=h(e),ce=i(e,"P",{});var Tl=p(ce);Ti=o(Tl,`Sequence classification refers to the task of classifying sequences of text according to a given number of classes. In
...
whether a review is positive or negative.`),Tl.forEach(t),lo=h(e),c(me.$$.fragment,e),io=h(e),K=i(e,"H3",{class:!0});var Al=p(K);_e=i(Al,"A",{id:!0,class:!0,href:!0});var Yd=p(_e);Na=i(Yd,"SPAN",{});var Gd=p(Na);c(rt.$$.fragment,Gd),Gd.forEach(t),Yd.forEach(t),Pi=h(Al),La=i(Al,"SPAN",{});var Jd=p(La);Fi=o(Jd,"Load IMDb dataset"),Jd.forEach(t),Al.forEach(t),po=h(e),Ps=i(e,"P",{});var Kd=p(Ps);Ci=o(Kd,"The \u{1F917} Datasets library makes it simple to load a dataset:"),Kd.forEach(t),fo=h(e),c(lt.$$.fragment,e),ho=h(e),we=i(e,"P",{});var zl=p(we);Di=o(zl,"This loads a "),Ba=i(zl,"CODE",{});var Xd=p(Ba);Si=o(Xd,"DatasetDict"),Xd.forEach(t),Ii=o(zl," object which you can index into to view an example:"),zl.forEach(t),uo=h(e),c(it.$$.fragment,e),co=h(e),X=i(e,"H3",{class:!0});var Pl=p(X);$e=i(Pl,"A",{id:!0,class:!0,href:!0});var Zd=p($e);Oa=i(Zd,"SPAN",{});var eu=p(Oa);c(pt.$$.fragment,eu),eu.forEach(t),Zd.forEach(t),Mi=h(Pl),Ha=i(Pl,"SPAN",{});var tu=p(Ha);Ni=o(tu,"Preprocess"),tu.forEach(t),Pl.forEach(t),mo=h(e),N=i(e,"P",{});var xa=p(N);Li=o(xa,`The next step is to tokenize the text into a readable format by the model. It is important to load the same tokenizer a
model was trained with to ensure appropriately tokenized words. Load the DistilBERT tokenizer with the
