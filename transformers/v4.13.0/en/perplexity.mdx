...
<img width="600" alt="Full decomposition of a sequence with unlimited context length" src="/docs/transformers/master/en/imgs/ppl_full.gif"/>
...
<img width="600" alt="Suboptimal PPL not taking advantage of full available context" src="/docs/transformers/master/en/imgs/ppl_chunked.gif"/>
...
<img width="600" alt="Sliding window PPL taking advantage of all available context" src="/docs/transformers/master/en/imgs/ppl_sliding.gif"/>
