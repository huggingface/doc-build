...
Examples of use can be found in the [example scripts](/docs/transformers/master/en/../examples) or [example notebooks](/docs/transformers/master/en/../notebooks).
...
[PreTrainedTokenizer](/docs/transformers/master/en/main_classes/tokenizer#transformers.PreTrainedTokenizer) or a [PreTrainedTokenizerFast](/docs/transformers/master/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast) with the
...
[BertTokenizer](/docs/transformers/master/en/model_doc/bert#transformers.BertTokenizer), specifically that subword tokens are prefixed with _##_. For tokenizers
...
<div class="docstring">
<docstring><name>numpy\_mask\_tokens</name><anchor>transformers.DataCollatorForPermutationLanguageModeling.numpy_mask_tokens</anchor><source>https://github.com/huggingface/transformers/blob/master/src/transformers/data/data_collator.py#L1433</source><parameters>[{"name": "inputs", "val": ": typing.Any"}]</parameters></docstring>
...
<div class="docstring">
<docstring><name>tf\_mask\_tokens</name><anchor>transformers.DataCollatorForPermutationLanguageModeling.tf_mask_tokens</anchor><source>https://github.com/huggingface/transformers/blob/master/src/transformers/data/data_collator.py#L1324</source><parameters>[{"name": "inputs", "val": ": typing.Any"}]</parameters></docstring>
...
<div class="docstring">
<docstring><name>torch\_mask\_tokens</name><anchor>transformers.DataCollatorForPermutationLanguageModeling.torch_mask_tokens</anchor><source>https://github.com/huggingface/transformers/blob/master/src/transformers/data/data_collator.py#L1226</source><parameters>[{"name": "inputs", "val": ": typing.Any"}]</parameters></docstring>
