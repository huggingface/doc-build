...
<docstring><name>class transformers.PretrainedConfig</name><anchor>transformers.PretrainedConfig</anchor><source>https://github.com/huggingface/transformers/blob/master/src/transformers/configuration_utils.py#L48</source><parameters>[{"name": "**kwargs", "val": ""}]</parameters><paramsdesc>- **name_or_path** (`str`, _optional_, defaults to `""`) --
...
- **add_cross_attention** (`bool`, _optional_, defaults to `False`) --
            ...
            that can be used as decoder models within the [EncoderDecoderModel](/docs/transformers/master/en/model_doc/encoderdecoder#transformers.EncoderDecoderModel) class, which consists of all models
...
- **use_bfloat16** (`bool`, _optional_, defaults to `False`) --
    ...
    - **is_composition** (`bool`) -- Whether the config class is composed of multiple sub-configs. In this case the
      ...
      [EncoderDecoderConfig](/docs/transformers/master/en/model_doc/encoderdecoder#transformers.EncoderDecoderConfig) or [~RagConfig](/docs/transformers/master/en/model_doc/rag#transformers.RagConfig).
...
<div class="docstring">
<docstring><name>dict\_torch\_dtype\_to\_str</name><anchor>transformers.PretrainedConfig.dict_torch_dtype_to_str</anchor><source>https://github.com/huggingface/transformers/blob/master/src/transformers/configuration_utils.py#L805</source><parameters>[{"name": "d", "val": ": typing.Dict[str, typing.Any]"}]</parameters></docstring>
...
<div class="docstring">
<docstring><name>from\_dict</name><anchor>transformers.PretrainedConfig.from_dict</anchor><source>https://github.com/huggingface/transformers/blob/master/src/transformers/configuration_utils.py#L608</source><parameters>[{"name": "config_dict", "val": ": typing.Dict[str, typing.Any]"}, {"name": "**kwargs", "val": ""}]</parameters><paramsdesc>- **config_dict** (`Dict[str, Any]`) --
  Dictionary that will be used to instantiate the configuration object. Such a dictionary can be
  retrieved from a pretrained checkpoint by leveraging the
  [get_config_dict()](/docs/transformers/master/en/main_classes/configuration#transformers.PretrainedConfig.get_config_dict) method.
- **kwargs** (`Dict[str, Any]`) --
...
Instantiate a [PretrainedConfig](/docs/transformers/master/en/main_classes/configuration#transformers.PretrainedConfig) (or a derived class) from a pretrained model
configuration.
...
<div class="docstring">
<docstring><name>get\_config\_dict</name><anchor>transformers.PretrainedConfig.get_config_dict</anchor><source>https://github.com/huggingface/transformers/blob/master/src/transformers/configuration_utils.py#L510</source><parameters>[{"name": "pretrained_model_name_or_path", "val": ": typing.Union[str, os.PathLike]"}, {"name": "**kwargs", "val": ""}]</parameters><paramsdesc>- **pretrained_model_name_or_path** (`str` or `os.PathLike`) --
...
<div class="docstring">
<docstring><name>update</name><anchor>transformers.PretrainedConfig.update</anchor><source>https://github.com/huggingface/transformers/blob/master/src/transformers/configuration_utils.py#L757</source><parameters>[{"name": "config_dict", "val": ": typing.Dict[str, typing.Any]"}]</parameters><paramsdesc>- **config_dict** (`Dict[str, Any]`) -- Dictionary of attributes that should be updated for this class.</paramsdesc><paramgroups>0</paramgroups></docstring>
