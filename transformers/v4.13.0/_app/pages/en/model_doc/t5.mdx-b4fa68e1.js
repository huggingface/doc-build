import{S as Vy,i as Ky,s as Yy,e as o,k as d,w as f,t as r,L as Jy,c as s,d as t,m as l,a,x as _,h as i,b as c,J as e,g as p,y as g,q as T,o as v,B as k}from"../../../chunks/vendor-e859c359.js";import{T as xt}from"../../../chunks/Tip-edc75249.js";import{D as P}from"../../../chunks/Docstring-ade913b3.js";import{C as se}from"../../../chunks/CodeBlock-ce4317c2.js";import{I as pe}from"../../../chunks/IconCopyLink-5fae3b20.js";import"../../../chunks/CopyButton-77addb3d.js";function Zy(L){let u,z,b,y,$;return{c(){u=o("p"),z=r(`Although the recipe for forward pass needs to be defined within this function, one should call the
...
it as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage
and behavior.`),Wv=d(),f(to.$$.fragment),Hv=d(),et=o("div"),f(Ta.$$.fragment),Rv=d(),_n=o("p"),Vv=r("The "),qr=o("a"),Kv=r("TFT5ForConditionalGeneration"),Yv=r(" forward method, overrides the "),yl=o("code"),Jv=r("__call__"),Zv=r(" special method."),Xv=d(),f(no.$$.fragment),Qv=d(),xl=o("p"),ek=r("Examples:"),tk=d(),f(va.$$.fragment),Yc=d(),gn=o("h2"),oo=o("a"),$l=o("span"),f(ka.$$.fragment),nk=d(),zl=o("span"),ok=r("TFT5EncoderModel"),Jc=d(),ce=o("div"),f(ba.$$.fragment),sk=d(),El=o("p"),ak=r("The bare T5 Model transformer outputting encoder\u2019s raw hidden-stateswithout any specific head on top."),rk=d(),wa=o("p"),ik=r("The T5 model was proposed in "),ya=o("a"),dk=r("Exploring the Limits of Transfer Learning with a Unified Text-to-Text Transformer"),lk=r(` by Colin Raffel, Noam Shazeer, Adam Roberts, Katherine Lee, Sharan Narang,
Michael Matena, Yanqi Zhou, Wei Li, Peter J. Liu. It\u2019s an encoder decoder transformer pre-trained in a text-to-text
...
language modeling head on top of the decoder.`),sp.forEach(t),pc=l(n),er=s(n,"UL",{});var mb=a(er);Jt=s(mb,"LI",{});var Lr=a(Jt);zi=s(Lr,"P",{});var fb=a(zi);Yh=i(fb,"Unsupervised denoising training"),fb.forEach(t),Jh=l(Lr),Te=s(Lr,"P",{});var st=a(Te);Zh=i(st,"In this setup, spans of the input sequence are masked by so-called sentinel tokens ("),Ei=s(st,"EM",{});var _b=a(Ei);Xh=i(_b,"a.k.a"),_b.forEach(t),Qh=i(st,` unique mask tokens) and
...
`),Ki=s(at,"CODE",{});var Gb=a(Ki);Yu=i(Gb,"attention_mask"),Gb.forEach(t),Ju=i(at,` as additional input to the model, which makes sure that padding tokens of the inputs are
ignored. The code example below illustrates all of this.`),at.forEach(t),vc=l(n),_(qo.$$.fragment,n),kc=l(n),or=s(n,"P",{});var Bb=a(or);Zu=i(Bb,"Additional training tips:"),Bb.forEach(t),bc=l(n),jt=s(n,"UL",{});var Sr=a(jt);Yi=s(Sr,"LI",{});var Ub=a(Yi);Fo=s(Ub,"P",{});var ip=a(Fo);Xu=i(ip,"T5 models need a slightly higher learning rate than the default one set in the "),Ji=s(ip,"CODE",{});var Wb=a(Ji);Qu=i(Wb,"Trainer"),Wb.forEach(t),em=i(ip,` when using the AdamW
optimizer. Typically, 1e-4 and 3e-4 work well for most problems (classification, summarization, translation, question
answering, question generation). Note that T5 was pre-trained using the AdaFactor optimizer.`),ip.forEach(t),Ub.forEach(t),tm=l(Sr),Zi=s(Sr,"LI",{});var Hb=a(Zi);Zt=s(Hb,"P",{});var Dr=a(Zt);nm=i(Dr,"According to "),Mo=s(Dr,"A",{href:!0,rel:!0});var Rb=a(Mo);om=i(Rb,"this forum post"),Rb.forEach(t),sm=i(Dr,`, task prefixes matter when
(1) doing multi-task training (2) your task is similar or related to one of the supervised tasks used in T5\u2019s
...
batches to the longest example is not recommended on TPU as it triggers a recompilation for every batch shape that is
encountered during training thus significantly slowing down the training. only padding up to the longest example in a
batch) leads to very slow training on TPU.`),dp.forEach(t),Kb.forEach(t),Sr.forEach(t),wc=l(n),sr=s(n,"A",{id:!0}),a(sr).forEach(t),yc=l(n),Xt=s(n,"H2",{class:!0});var lp=a(Xt);Fn=s(lp,"A",{id:!0,class:!0,href:!0});var Jb=a(Fn);ed=s(Jb,"SPAN",{});var Zb=a(ed);_(Ao.$$.fragment,Zb),Zb.forEach(t),Jb.forEach(t),pm=l(lp),td=s(lp,"SPAN",{});var Xb=a(td);hm=i(Xb,"Inference"),Xb.forEach(t),lp.forEach(t),xc=l(n),ft=s(n,"P",{});var uo=a(ft);um=i(uo,"At inference time, it is recommended to use "),ar=s(uo,"A",{href:!0});var Qb=a(ar);mm=i(Qb,"generate()"),Qb.forEach(t),fm=i(uo,`. This
method takes care of encoding the input and feeding the encoded hidden states via cross-attention layers to the decoder
...
use of token type ids, therefore a list of zeros is returned.`),S1.forEach(t),bp.forEach(t),Rf=l(ze),vd=s(ze,"DIV",{class:!0}),a(vd).forEach(t),ze.forEach(t),Ic=l(n),sn=s(n,"H2",{class:!0});var wp=a(sn);In=s(wp,"A",{id:!0,class:!0,href:!0});var D1=a(In);kd=s(D1,"SPAN",{});var O1=a(kd);_(ds.$$.fragment,O1),O1.forEach(t),D1.forEach(t),Vf=l(wp),bd=s(wp,"SPAN",{});var G1=a(bd);Kf=i(G1,"T5TokenizerFast"),G1.forEach(t),wp.forEach(t),Sc=l(n),Be=s(n,"DIV",{class:!0});var It=a(Be);_(ls.$$.fragment,It),Yf=l(It),an=s(It,"P",{});var Wr=a(an);Jf=i(Wr,"Construct a \u201Cfast\u201D T5 tokenizer (backed by HuggingFace\u2019s "),wd=s(Wr,"EM",{});var B1=a(wd);Zf=i(B1,"tokenizers"),B1.forEach(t),Xf=i(Wr," library). Based on "),cs=s(Wr,"A",{href:!0,rel:!0});var U1=a(cs);Qf=i(U1,"Unigram"),U1.forEach(t),e_=i(Wr,"."),Wr.forEach(t),t_=l(It),ps=s(It,"P",{});var yp=a(ps);n_=i(yp,"This tokenizer inherits from "),gr=s(yp,"A",{href:!0});var W1=a(gr);o_=i(W1,"PreTrainedTokenizerFast"),W1.forEach(t),s_=i(yp,` which contains most of the main
...
use of token type ids, therefore a list of zeros is returned.`),K1.forEach(t),$p.forEach(t),It.forEach(t),Dc=l(n),rn=s(n,"H2",{class:!0});var zp=a(rn);Dn=s(zp,"A",{id:!0,class:!0,href:!0});var Y1=a(Dn);Ed=s(Y1,"SPAN",{});var J1=a(Ed);_(fs.$$.fragment,J1),J1.forEach(t),Y1.forEach(t),g_=l(zp),jd=s(zp,"SPAN",{});var Z1=a(jd);T_=i(Z1,"T5Model"),Z1.forEach(t),zp.forEach(t),Oc=l(n),Z=s(n,"DIV",{class:!0});var Ee=a(Z);_(_s.$$.fragment,Ee),v_=l(Ee),qd=s(Ee,"P",{});var X1=a(qd);k_=i(X1,"The bare T5 Model transformer outputting raw hidden-states without any specific head on top."),X1.forEach(t),b_=l(Ee),gs=s(Ee,"P",{});var Ep=a(gs);w_=i(Ep,"The T5 model was proposed in "),Ts=s(Ep,"A",{href:!0,rel:!0});var Q1=a(Ts);y_=i(Q1,"Exploring the Limits of Transfer Learning with a Unified Text-to-Text Transformer"),Q1.forEach(t),x_=i(Ep,` by Colin Raffel, Noam Shazeer, Adam Roberts, Katherine Lee, Sharan Narang,
Michael Matena, Yanqi Zhou, Wei Li, Peter J. Liu. It\u2019s an encoder decoder transformer pre-trained in a text-to-text
