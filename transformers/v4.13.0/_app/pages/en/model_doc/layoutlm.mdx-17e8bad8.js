import{S as Dh,i as Ah,s as Oh,e as a,k as l,w as L,t as n,L as Uh,c as r,d as t,m as d,a as i,x as w,h as s,b as c,J as e,g as u,y as T,q as v,o as M,B as x}from"../../../chunks/vendor-e859c359.js";import{T as Qe}from"../../../chunks/Tip-edc75249.js";import{D as _e}from"../../../chunks/Docstring-ade913b3.js";import{C as tt}from"../../../chunks/CodeBlock-ce4317c2.js";import{I as Ve}from"../../../chunks/IconCopyLink-5fae3b20.js";import"../../../chunks/CopyButton-77addb3d.js";function Wh(B){let h,$,f,g,b;return{c(){h=a("p"),$=n(`Although the recipe for forward pass needs to be defined within this function, one should call the
...
processing steps while the latter silently ignores them.`)},l(y){h=r(y,"P",{});var _=i(h);$=s(_,`Although the recipe for forward pass needs to be defined within this function, one should call the
`),f=r(_,"CODE",{});var j=i(f);g=s(j,"Module"),j.forEach(t),b=s(_,` instance afterwards instead of this since the former takes care of running the pre and post
processing steps while the latter silently ignores them.`),_.forEach(t)},m(y,_){u(y,h,_),e(h,$),e(h,f),e(f,g),e(h,b)},d(y){y&&t(h)}}}function em(B){let h,$,f,g,b,y,_,j,re,Y,z,ae,I,Z,ne,A,ie,se,J,D,G,Q,F,E,le,W,V,ee,H,te,de,q,ce,O,pe,oe,R,ue,he,P,me,U,fe,p,k,X,je,Me,N,be,Fe,xe,S,K,$e,ye,C,ze,ke,ge,Ee,zs,Ur,Wr,Es,Br,Hr,fo,Rr,Kr,go,Vr,Xr,Na,_o,Sa,ot,Yr,qs,Zr,Gr,Cs,Jr,Qr,Ia,yo,Da,Xn,et,ei,Yn,ti,oi,bo,ni,si,ko,ai,ri,Aa,nt,ii,Lo,li,di,wo,ci,pi,Oa,ft,At,Ps,To,ui,Ns,hi,Ua,qe,vo,mi,gt,fi,Zn,gi,_i,Mo,yi,bi,ki,_t,Li,Gn,wi,Ti,Jn,vi,Mi,xi,Ss,$i,ji,xo,Wa,yt,Ot,Is,$o,Fi,Ds,zi,Ba,Be,jo,Ei,As,qi,Ci,Qn,Os,Pi,Ni,Si,Fo,Ii,es,Di,Ai,Ha,bt,Ut,Us,zo,Oi,Ws,Ui,Ra,He,Eo,Wi,Bs,Bi,Hi,Wt,ts,Ri,Ki,os,Vi,Xi,Yi,qo,Zi,ns,Gi,Ji,Ka,kt,Bt,Hs,Co,Qi,Rs,el,Va,Re,Po,tl,No,ol,So,nl,sl,al,Io,rl,Do,il,ll,dl,Ne,Ao,cl,Lt,pl,ss,ul,hl,Ks,ml,fl,gl,Ht,_l,Vs,yl,bl,Oo,Xa,wt,Rt,Xs,Uo,kl,Ys,Ll,Ya,Ke,Wo,wl,Tt,Tl,Zs,vl,Ml,Bo,xl,$l,jl,Ho,Fl,Ro,zl,El,ql,Se,Ko,Cl,vt,Pl,as,Nl,Sl,Gs,Il,Dl,Al,Kt,Ol,Js,Ul,Wl,Vo,Za,Mt,Vt,Qs,Xo,Bl,ea,Hl,Ga,Ce,Yo,Rl,Zo,Kl,Go,Vl,Xl,Yl,Jo,Zl,Qo,Gl,Jl,Ql,en,ed,tn,td,od,nd,Ie,on,sd,xt,ad,rs,rd,id,ta,ld,dd,cd,Xt,pd,oa,ud,hd,nn,Ja,$t,Yt,na,sn,md,sa,fd,Qa,Pe,an,gd,jt,_d,rn,yd,bd,ln,kd,Ld,wd,dn,Td,cn,vd,Md,xd,pn,$d,un,jd,Fd,zd,De,hn,Ed,Ft,qd,is,Cd,Pd,aa,Nd,Sd,Id,Zt,Dd,ra,Ad,Od,mn,er,zt,Gt,ia,fn,Ud,la,Wd,tr,Le,gn,Bd,da,Hd,Rd,_n,Kd,ls,Vd,Xd,Yd,yn,Zd,bn,Gd,Jd,Qd,Jt,ec,Ae,kn,tc,Et,oc,ds,nc,sc,ca,ac,rc,ic,Qt,lc,pa,dc,cc,Ln,or,qt,eo,ua,wn,pc,ha,uc,nr,we,Tn,hc,vn,mc,ma,fc,gc,_c,Mn,yc,cs,bc,kc,Lc,xn,wc,$n,Tc,vc,Mc,to,xc,Oe,jn,$c,Ct,jc,ps,Fc,zc,fa,Ec,qc,Cc,oo,Pc,ga,Nc,Sc,Fn,sr,Pt,no,_a,zn,Ic,ya,Dc,ar,Te,En,Ac,ba,Oc,Uc,qn,Wc,us,Bc,Hc,Rc,Cn,Kc,Pn,Vc,Xc,Yc,so,Zc,Ue,Nn,Gc,Nt,Jc,hs,Qc,ep,ka,tp,op,np,ao,sp,La,ap,rp,Sn,rr,St,ro,wa,In,ip,Ta,lp,ir,ve,Dn,dp,va,cp,pp,An,up,ms,hp,mp,fp,On,gp,Un,_p,yp,bp,io,kp,We,Wn,Lp,It,wp,fs,Tp,vp,Ma,Mp,xp,$p,lo,jp,xa,Fp,zp,Bn,lr;return y=new Ve({}),A=new Ve({}),_o=new tt({props:{code:`def normalize_bbox(bbox, width, height):
     return [
...
<span class="hljs-meta">&gt;&gt;&gt; </span>configuration = model.config`}}),$o=new Ve({}),jo=new _e({props:{name:"class transformers.LayoutLMTokenizer",anchor:"transformers.LayoutLMTokenizer",parameters:[{name:"vocab_file",val:""},{name:"do_lower_case",val:" = True"},{name:"do_basic_tokenize",val:" = True"},{name:"never_split",val:" = None"},{name:"unk_token",val:" = '[UNK]'"},{name:"sep_token",val:" = '[SEP]'"},{name:"pad_token",val:" = '[PAD]'"},{name:"cls_token",val:" = '[CLS]'"},{name:"mask_token",val:" = '[MASK]'"},{name:"tokenize_chinese_chars",val:" = True"},{name:"strip_accents",val:" = None"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/master/src/transformers/models/layoutlm/tokenization_layoutlm.py#L46"}}),zo=new Ve({}),Eo=new _e({props:{name:"class transformers.LayoutLMTokenizerFast",anchor:"transformers.LayoutLMTokenizerFast",parameters:[{name:"vocab_file",val:" = None"},{name:"tokenizer_file",val:" = None"},{name:"do_lower_case",val:" = True"},{name:"unk_token",val:" = '[UNK]'"},{name:"sep_token",val:" = '[SEP]'"},{name:"pad_token",val:" = '[PAD]'"},{name:"cls_token",val:" = '[CLS]'"},{name:"mask_token",val:" = '[MASK]'"},{name:"tokenize_chinese_chars",val:" = True"},{name:"strip_accents",val:" = None"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/master/src/transformers/models/layoutlm/tokenization_layoutlm_fast.py#L51"}}),Co=new Ve({}),Po=new _e({props:{name:"class transformers.LayoutLMModel",anchor:"transformers.LayoutLMModel",parameters:[{name:"config",val:""}],source:"https://github.com/huggingface/transformers/blob/master/src/transformers/models/layoutlm/modeling_layoutlm.py#L708",parametersDescription:[{anchor:"transformers.LayoutLMModel.config",description:`<strong>config</strong> (<a href="/docs/transformers/master/en/model_doc/layoutlm#transformers.LayoutLMConfig">LayoutLMConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
...
If set to <code>True</code>, the model will return a <a href="/docs/transformers/master/en/main_classes/output#transformers.file_utils.ModelOutput">ModelOutput</a> instead of a
...
<span class="hljs-meta">&gt;&gt;&gt; </span>loss = outputs.loss
<span class="hljs-meta">&gt;&gt;&gt; </span>logits = outputs.logits`}}),In=new Ve({}),Dn=new _e({props:{name:"class transformers.TFLayoutLMForTokenClassification",anchor:"transformers.TFLayoutLMForTokenClassification",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/master/src/transformers/models/layoutlm/modeling_tf_layoutlm.py#L1321",parametersDescription:[{anchor:"transformers.TFLayoutLMForTokenClassification.config",description:`<strong>config</strong> (<a href="/docs/transformers/master/en/model_doc/layoutlm#transformers.LayoutLMConfig">LayoutLMConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/master/en/main_classes/model#transformers.TFPreTrainedModel.from_pretrained">from_pretrained()</a> method to load the
model weights.`,name:"config"}]}}),io=new Qe({props:{$$slots:{default:[Jh]},$$scope:{ctx:B}}}),Wn=new _e({props:{name:"call",anchor:"transformers.TFLayoutLMForTokenClassification.call",parameters:[{name:"input_ids",val:": typing.Union[typing.List[tensorflow.python.framework.ops.Tensor], typing.List[numpy.ndarray], typing.List[tensorflow.python.keras.engine.keras_tensor.KerasTensor], typing.Dict[str, tensorflow.python.framework.ops.Tensor], typing.Dict[str, numpy.ndarray], typing.Dict[str, tensorflow.python.keras.engine.keras_tensor.KerasTensor], tensorflow.python.framework.ops.Tensor, numpy.ndarray, tensorflow.python.keras.engine.keras_tensor.KerasTensor, NoneType] = None"},{name:"bbox",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"attention_mask",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"token_type_ids",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"position_ids",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"head_mask",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"inputs_embeds",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"labels",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"training",val:": typing.Optional[bool] = False"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/master/src/transformers/models/layoutlm/modeling_tf_layoutlm.py#L1345",parametersDescription:[{anchor:"transformers.TFLayoutLMForTokenClassification.call.input_ids",description:`<strong>input_ids</strong> (<code>Numpy array</code> or <code>tf.Tensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/master/en/model_doc/layoutlm#transformers.LayoutLMTokenizer">LayoutLMTokenizer</a>. See
<a href="/docs/transformers/master/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">transformers.PreTrainedTokenizer.<strong>call</strong>()</a> and <a href="/docs/transformers/master/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">transformers.PreTrainedTokenizer.encode()</a> for
details.</p>
...
`),wo=a("a"),ci=n("here"),pi=n("."),Oa=l(),ft=a("h2"),At=a("a"),Ps=a("span"),L(To.$$.fragment),ui=l(),Ns=a("span"),hi=n("LayoutLMConfig"),Ua=l(),qe=a("div"),L(vo.$$.fragment),mi=l(),gt=a("p"),fi=n("This is the configuration class to store the configuration of a "),Zn=a("a"),gi=n("LayoutLMModel"),_i=n(`. It is used to
instantiate a LayoutLM model according to the specified arguments, defining the model architecture. Instantiating a
configuration with the defaults will yield a similar configuration to that of the LayoutLM `),Mo=a("a"),yi=n("layoutlm-base-uncased"),bi=n(" architecture."),ki=l(),_t=a("p"),Li=n("Configuration objects inherit from "),Gn=a("a"),wi=n("BertConfig"),Ti=n(` and can be used to control the model outputs.
Read the documentation from `),Jn=a("a"),vi=n("BertConfig"),Mi=n(" for more information."),xi=l(),Ss=a("p"),$i=n("Examples:"),ji=l(),L(xo.$$.fragment),Wa=l(),yt=a("h2"),Ot=a("a"),Is=a("span"),L($o.$$.fragment),Fi=l(),Ds=a("span"),zi=n("LayoutLMTokenizer"),Ba=l(),Be=a("div"),L(jo.$$.fragment),Ei=l(),As=a("p"),qi=n("Constructs a LayoutLM tokenizer."),Ci=l(),Qn=a("p"),Os=a("code"),Pi=n("LayoutLMTokenizer is identical to :class:"),Ni=n("~transformers.BertTokenizer` and runs end-to-end\ntokenization: punctuation splitting + wordpiece."),Si=l(),Fo=a("p"),Ii=n("Refer to superclass "),es=a("a"),Di=n("BertTokenizer"),Ai=n(` for usage examples and documentation concerning
...
behavior.`),dl=l(),Ne=a("div"),L(Ao.$$.fragment),cl=l(),Lt=a("p"),pl=n("The "),ss=a("a"),ul=n("LayoutLMModel"),hl=n(" forward method, overrides the "),Ks=a("code"),ml=n("__call__"),fl=n(" special method."),gl=l(),L(Ht.$$.fragment),_l=l(),Vs=a("p"),yl=n("Examples:"),bl=l(),L(Oo.$$.fragment),Xa=l(),wt=a("h2"),Rt=a("a"),Xs=a("span"),L(Uo.$$.fragment),kl=l(),Ys=a("span"),Ll=n("LayoutLMForMaskedLM"),Ya=l(),Ke=a("div"),L(Wo.$$.fragment),wl=l(),Tt=a("p"),Tl=n("LayoutLM Model with a "),Zs=a("em"),vl=n("language modeling"),Ml=n(` head on top.
...
and behavior.`),Qd=l(),L(Jt.$$.fragment),ec=l(),Ae=a("div"),L(kn.$$.fragment),tc=l(),Et=a("p"),oc=n("The "),ds=a("a"),nc=n("TFLayoutLMModel"),sc=n(" forward method, overrides the "),ca=a("code"),ac=n("__call__"),rc=n(" special method."),ic=l(),L(Qt.$$.fragment),lc=l(),pa=a("p"),dc=n("Examples:"),cc=l(),L(Ln.$$.fragment),or=l(),qt=a("h2"),eo=a("a"),ua=a("span"),L(wn.$$.fragment),pc=l(),ha=a("span"),uc=n("TFLayoutLMForMaskedLM"),nr=l(),we=a("div"),L(Tn.$$.fragment),hc=l(),vn=a("p"),mc=n("LayoutLM Model with a "),ma=a("em"),fc=n("language modeling"),gc=n(" head on top."),_c=l(),Mn=a("p"),yc=n("This model inherits from "),cs=a("a"),bc=n("TFPreTrainedModel"),kc=n(`. Check the superclass documentation for the
generic methods the library implements for all its model (such as downloading or saving, resizing the input
embeddings, pruning heads etc.)`),Lc=l(),xn=a("p"),wc=n("This model is also a "),$n=a("a"),Tc=n("tf.keras.Model"),vc=n(` subclass. Use
it as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage
and behavior.`),Mc=l(),L(to.$$.fragment),xc=l(),Oe=a("div"),L(jn.$$.fragment),$c=l(),Ct=a("p"),jc=n("The "),ps=a("a"),Fc=n("TFLayoutLMForMaskedLM"),zc=n(" forward method, overrides the "),fa=a("code"),Ec=n("__call__"),qc=n(" special method."),Cc=l(),L(oo.$$.fragment),Pc=l(),ga=a("p"),Nc=n("Examples:"),Sc=l(),L(Fn.$$.fragment),sr=l(),Pt=a("h2"),no=a("a"),_a=a("span"),L(zn.$$.fragment),Ic=l(),ya=a("span"),Dc=n("TFLayoutLMForSequenceClassification"),ar=l(),Te=a("div"),L(En.$$.fragment),Ac=l(),ba=a("p"),Oc=n(`LayoutLM Model transformer with a sequence classification/regression head on top (a linear layer on top of the
...
it as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage
and behavior.`),Yc=l(),L(so.$$.fragment),Zc=l(),Ue=a("div"),L(Nn.$$.fragment),Gc=l(),Nt=a("p"),Jc=n("The "),hs=a("a"),Qc=n("TFLayoutLMForSequenceClassification"),ep=n(" forward method, overrides the "),ka=a("code"),tp=n("__call__"),op=n(" special method."),np=l(),L(ao.$$.fragment),sp=l(),La=a("p"),ap=n("Examples:"),rp=l(),L(Sn.$$.fragment),rr=l(),St=a("h2"),ro=a("a"),wa=a("span"),L(In.$$.fragment),ip=l(),Ta=a("span"),lp=n("TFLayoutLMForTokenClassification"),ir=l(),ve=a("div"),L(Dn.$$.fragment),dp=l(),va=a("p"),cp=n(`LayoutLM Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g. for
...
it as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage
and behavior.`),bp=l(),L(io.$$.fragment),kp=l(),We=a("div"),L(Wn.$$.fragment),Lp=l(),It=a("p"),wp=n("The "),fs=a("a"),Tp=n("TFLayoutLMForTokenClassification"),vp=n(" forward method, overrides the "),Ma=a("code"),Mp=n("__call__"),xp=n(" special method."),$p=l(),L(lo.$$.fragment),jp=l(),xa=a("p"),Fp=n("Examples:"),zp=l(),L(Bn.$$.fragment),this.h()},l(o){const m=Uh('[data-svelte="svelte-1phssyn"]',document.head);h=r(m,"META",{name:!0,content:!0}),m.forEach(t),$=d(o),f=r(o,"H1",{class:!0});var Hn=i(f);g=r(Hn,"A",{id:!0,class:!0,href:!0});var $a=i(g);b=r($a,"SPAN",{});var ja=i(b);w(y.$$.fragment,ja),ja.forEach(t),$a.forEach(t),_=d(Hn),j=r(Hn,"SPAN",{});var Fa=i(j);re=s(Fa,"LayoutLM"),Fa.forEach(t),Hn.forEach(t),Y=d(o),z=r(o,"A",{id:!0}),i(z).forEach(t),ae=d(o),I=r(o,"H2",{class:!0});var Rn=i(I);Z=r(Rn,"A",{id:!0,class:!0,href:!0});var za=i(Z);ne=r(za,"SPAN",{});var Ea=i(ne);w(A.$$.fragment,Ea),Ea.forEach(t),za.forEach(t),ie=d(Rn),se=r(Rn,"SPAN",{});var qa=i(se);J=s(qa,"Overview"),qa.forEach(t),Rn.forEach(t),D=d(o),G=r(o,"P",{});var Kn=i(G);Q=s(Kn,"The LayoutLM model was proposed in the paper "),F=r(Kn,"A",{href:!0,rel:!0});var Ca=i(F);E=s(Ca,`LayoutLM: Pre-training of Text and Layout for Document Image
...
(x0, y0) corresponds to the position of the upper left corner in the bounding box, and (x1, y1) represents the
position of the lower right corner. Note that one first needs to normalize the bounding boxes to be on a 0-1000
scale. To normalize, you can use the following function:`),Xe.forEach(t),Ap.forEach(t),Na=d(o),w(_o.$$.fragment,o),Sa=d(o),ot=r(o,"P",{});var gs=i(ot);Yr=s(gs,"Here, "),qs=r(gs,"CODE",{});var Rp=i(qs);Zr=s(Rp,"width"),Rp.forEach(t),Gr=s(gs," and "),Cs=r(gs,"CODE",{});var Kp=i(Cs);Jr=s(Kp,"height"),Kp.forEach(t),Qr=s(gs,` correspond to the width and height of the original document in which the token
occurs. Those can be obtained using the Python Image Library (PIL) library for example, as follows:`),gs.forEach(t),Ia=d(o),w(yo.$$.fragment,o),Da=d(o),Xn=r(o,"UL",{});var Vp=i(Xn);et=r(Vp,"LI",{});var co=i(et);ei=s(co,"For a demo which shows how to fine-tune "),Yn=r(co,"A",{href:!0});var Xp=i(Yn);ti=s(Xp,"LayoutLMForTokenClassification"),Xp.forEach(t),oi=s(co," on the "),bo=r(co,"A",{href:!0,rel:!0});var Yp=i(bo);ni=s(Yp,"FUNSD dataset"),Yp.forEach(t),si=s(co," (a collection of annotated forms), see "),ko=r(co,"A",{href:!0,rel:!0});var Zp=i(ko);ai=s(Zp,"this notebook"),Zp.forEach(t),ri=s(co,`.
...
`),wo=r(_s,"A",{href:!0,rel:!0});var Jp=i(wo);ci=s(Jp,"here"),Jp.forEach(t),pi=s(_s,"."),_s.forEach(t),Oa=d(o),ft=r(o,"H2",{class:!0});var pr=i(ft);At=r(pr,"A",{id:!0,class:!0,href:!0});var Qp=i(At);Ps=r(Qp,"SPAN",{});var eu=i(Ps);w(To.$$.fragment,eu),eu.forEach(t),Qp.forEach(t),ui=d(pr),Ns=r(pr,"SPAN",{});var tu=i(Ns);hi=s(tu,"LayoutLMConfig"),tu.forEach(t),pr.forEach(t),Ua=d(o),qe=r(o,"DIV",{class:!0});var st=i(qe);w(vo.$$.fragment,st),mi=d(st),gt=r(st,"P",{});var ys=i(gt);fi=s(ys,"This is the configuration class to store the configuration of a "),Zn=r(ys,"A",{href:!0});var ou=i(Zn);gi=s(ou,"LayoutLMModel"),ou.forEach(t),_i=s(ys,`. It is used to
instantiate a LayoutLM model according to the specified arguments, defining the model architecture. Instantiating a
configuration with the defaults will yield a similar configuration to that of the LayoutLM `),Mo=r(ys,"A",{href:!0,rel:!0});var nu=i(Mo);yi=s(nu,"layoutlm-base-uncased"),nu.forEach(t),bi=s(ys," architecture."),ys.forEach(t),ki=d(st),_t=r(st,"P",{});var bs=i(_t);Li=s(bs,"Configuration objects inherit from "),Gn=r(bs,"A",{href:!0});var su=i(Gn);wi=s(su,"BertConfig"),su.forEach(t),Ti=s(bs,` and can be used to control the model outputs.
Read the documentation from `),Jn=r(bs,"A",{href:!0});var au=i(Jn);vi=s(au,"BertConfig"),au.forEach(t),Mi=s(bs," for more information."),bs.forEach(t),xi=d(st),Ss=r(st,"P",{});var ru=i(Ss);$i=s(ru,"Examples:"),ru.forEach(t),ji=d(st),w(xo.$$.fragment,st),st.forEach(t),Wa=d(o),yt=r(o,"H2",{class:!0});var ur=i(yt);Ot=r(ur,"A",{id:!0,class:!0,href:!0});var iu=i(Ot);Is=r(iu,"SPAN",{});var lu=i(Is);w($o.$$.fragment,lu),lu.forEach(t),iu.forEach(t),Fi=d(ur),Ds=r(ur,"SPAN",{});var du=i(Ds);zi=s(du,"LayoutLMTokenizer"),du.forEach(t),ur.forEach(t),Ba=d(o),Be=r(o,"DIV",{class:!0});var po=i(Be);w(jo.$$.fragment,po),Ei=d(po),As=r(po,"P",{});var cu=i(As);qi=s(cu,"Constructs a LayoutLM tokenizer."),cu.forEach(t),Ci=d(po),Qn=r(po,"P",{});var Ep=i(Qn);Os=r(Ep,"CODE",{});var pu=i(Os);Pi=s(pu,"LayoutLMTokenizer is identical to :class:"),pu.forEach(t),Ni=s(Ep,"~transformers.BertTokenizer` and runs end-to-end\ntokenization: punctuation splitting + wordpiece."),Ep.forEach(t),Si=d(po),Fo=r(po,"P",{});var hr=i(Fo);Ii=s(hr,"Refer to superclass "),es=r(hr,"A",{href:!0});var uu=i(es);Di=s(uu,"BertTokenizer"),uu.forEach(t),Ai=s(hr,` for usage examples and documentation concerning
parameters.`),hr.forEach(t),po.forEach(t),Ha=d(o),bt=r(o,"H2",{class:!0});var mr=i(bt);Ut=r(mr,"A",{id:!0,class:!0,href:!0});var hu=i(Ut);Us=r(hu,"SPAN",{});var mu=i(Us);w(zo.$$.fragment,mu),mu.forEach(t),hu.forEach(t),Oi=d(mr),Ws=r(mr,"SPAN",{});var fu=i(Ws);Ui=s(fu,"LayoutLMTokenizerFast"),fu.forEach(t),mr.forEach(t),Ra=d(o),He=r(o,"DIV",{class:!0});var uo=i(He);w(Eo.$$.fragment,uo),Wi=d(uo),Bs=r(uo,"P",{});var gu=i(Bs);Bi=s(gu,"Constructs a \u201CFast\u201D LayoutLMTokenizer."),gu.forEach(t),Hi=d(uo),Wt=r(uo,"P",{});var Pa=i(Wt);ts=r(Pa,"A",{href:!0});var _u=i(ts);Ri=s(_u,"LayoutLMTokenizerFast"),_u.forEach(t),Ki=s(Pa," is identical to "),os=r(Pa,"A",{href:!0});var yu=i(os);Vi=s(yu,"BertTokenizerFast"),yu.forEach(t),Xi=s(Pa,` and runs
...
parameters.`),fr.forEach(t),uo.forEach(t),Ka=d(o),kt=r(o,"H2",{class:!0});var gr=i(kt);Bt=r(gr,"A",{id:!0,class:!0,href:!0});var ku=i(Bt);Hs=r(ku,"SPAN",{});var Lu=i(Hs);w(Co.$$.fragment,Lu),Lu.forEach(t),ku.forEach(t),Qi=d(gr),Rs=r(gr,"SPAN",{});var wu=i(Rs);el=s(wu,"LayoutLMModel"),wu.forEach(t),gr.forEach(t),Va=d(o),Re=r(o,"DIV",{class:!0});var ho=i(Re);w(Po.$$.fragment,ho),tl=d(ho),No=r(ho,"P",{});var _r=i(No);ol=s(_r,`The bare LayoutLM Model transformer outputting raw hidden-states without any specific head on top.
The LayoutLM model was proposed in `),So=r(_r,"A",{href:!0,rel:!0});var Tu=i(So);nl=s(Tu,"LayoutLM: Pre-training of Text and Layout for Document Image Understanding"),Tu.forEach(t),sl=s(_r," by Yiheng Xu, Minghao Li, Lei Cui, Shaohan Huang, Furu Wei and Ming Zhou."),_r.forEach(t),al=d(ho),Io=r(ho,"P",{});var yr=i(Io);rl=s(yr,"This model is a PyTorch "),Do=r(yr,"A",{href:!0,rel:!0});var vu=i(Do);il=s(vu,"torch.nn.Module"),vu.forEach(t),ll=s(yr,` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),yr.forEach(t),dl=d(ho),Ne=r(ho,"DIV",{class:!0});var at=i(Ne);w(Ao.$$.fragment,at),cl=d(at),Lt=r(at,"P",{});var ks=i(Lt);pl=s(ks,"The "),ss=r(ks,"A",{href:!0});var Mu=i(ss);ul=s(Mu,"LayoutLMModel"),Mu.forEach(t),hl=s(ks," forward method, overrides the "),Ks=r(ks,"CODE",{});var xu=i(Ks);ml=s(xu,"__call__"),xu.forEach(t),fl=s(ks," special method."),ks.forEach(t),gl=d(at),w(Ht.$$.fragment,at),_l=d(at),Vs=r(at,"P",{});var $u=i(Vs);yl=s($u,"Examples:"),$u.forEach(t),bl=d(at),w(Oo.$$.fragment,at),at.forEach(t),ho.forEach(t),Xa=d(o),wt=r(o,"H2",{class:!0});var br=i(wt);Rt=r(br,"A",{id:!0,class:!0,href:!0});var ju=i(Rt);Xs=r(ju,"SPAN",{});var Fu=i(Xs);w(Uo.$$.fragment,Fu),Fu.forEach(t),ju.forEach(t),kl=d(br),Ys=r(br,"SPAN",{});var zu=i(Ys);Ll=s(zu,"LayoutLMForMaskedLM"),zu.forEach(t),br.forEach(t),Ya=d(o),Ke=r(o,"DIV",{class:!0});var mo=i(Ke);w(Wo.$$.fragment,mo),wl=d(mo),Tt=r(mo,"P",{});var Ls=i(Tt);Tl=s(Ls,"LayoutLM Model with a "),Zs=r(Ls,"EM",{});var Eu=i(Zs);vl=s(Eu,"language modeling"),Eu.forEach(t),Ml=s(Ls,` head on top.
...
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),kr.forEach(t),ql=d(mo),Se=r(mo,"DIV",{class:!0});var rt=i(Se);w(Ko.$$.fragment,rt),Cl=d(rt),vt=r(rt,"P",{});var ws=i(vt);Pl=s(ws,"The "),as=r(ws,"A",{href:!0});var Pu=i(as);Nl=s(Pu,"LayoutLMForMaskedLM"),Pu.forEach(t),Sl=s(ws," forward method, overrides the "),Gs=r(ws,"CODE",{});var Nu=i(Gs);Il=s(Nu,"__call__"),Nu.forEach(t),Dl=s(ws," special method."),ws.forEach(t),Al=d(rt),w(Kt.$$.fragment,rt),Ol=d(rt),Js=r(rt,"P",{});var Su=i(Js);Ul=s(Su,"Examples:"),Su.forEach(t),Wl=d(rt),w(Vo.$$.fragment,rt),rt.forEach(t),mo.forEach(t),Za=d(o),Mt=r(o,"H2",{class:!0});var Lr=i(Mt);Vt=r(Lr,"A",{id:!0,class:!0,href:!0});var Iu=i(Vt);Qs=r(Iu,"SPAN",{});var Du=i(Qs);w(Xo.$$.fragment,Du),Du.forEach(t),Iu.forEach(t),Bl=d(Lr),ea=r(Lr,"SPAN",{});var Au=i(ea);Hl=s(Au,"LayoutLMForSequenceClassification"),Au.forEach(t),Lr.forEach(t),Ga=d(o),Ce=r(o,"DIV",{class:!0});var it=i(Ce);w(Yo.$$.fragment,it),Rl=d(it),Zo=r(it,"P",{});var wr=i(Zo);Kl=s(wr,`LayoutLM Model with a sequence classification head on top (a linear layer on top of the pooled output) e.g. for
document image classification tasks such as the `),Go=r(wr,"A",{href:!0,rel:!0});var Ou=i(Go);Vl=s(Ou,"RVL-CDIP"),Ou.forEach(t),Xl=s(wr," dataset."),wr.forEach(t),Yl=d(it),Jo=r(it,"P",{});var Tr=i(Jo);Zl=s(Tr,"The LayoutLM model was proposed in "),Qo=r(Tr,"A",{href:!0,rel:!0});var Uu=i(Qo);Gl=s(Uu,"LayoutLM: Pre-training of Text and Layout for Document Image Understanding"),Uu.forEach(t),Jl=s(Tr," by Yiheng Xu, Minghao Li, Lei Cui, Shaohan Huang, Furu Wei and Ming Zhou."),Tr.forEach(t),Ql=d(it),en=r(it,"P",{});var vr=i(en);ed=s(vr,"This model is a PyTorch "),tn=r(vr,"A",{href:!0,rel:!0});var Wu=i(tn);td=s(Wu,"torch.nn.Module"),Wu.forEach(t),od=s(vr,` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),vr.forEach(t),nd=d(it),Ie=r(it,"DIV",{class:!0});var lt=i(Ie);w(on.$$.fragment,lt),sd=d(lt),xt=r(lt,"P",{});var Ts=i(xt);ad=s(Ts,"The "),rs=r(Ts,"A",{href:!0});var Bu=i(rs);rd=s(Bu,"LayoutLMForSequenceClassification"),Bu.forEach(t),id=s(Ts," forward method, overrides the "),ta=r(Ts,"CODE",{});var Hu=i(ta);ld=s(Hu,"__call__"),Hu.forEach(t),dd=s(Ts," special method."),Ts.forEach(t),cd=d(lt),w(Xt.$$.fragment,lt),pd=d(lt),oa=r(lt,"P",{});var Ru=i(oa);ud=s(Ru,"Examples:"),Ru.forEach(t),hd=d(lt),w(nn.$$.fragment,lt),lt.forEach(t),it.forEach(t),Ja=d(o),$t=r(o,"H2",{class:!0});var Mr=i($t);Yt=r(Mr,"A",{id:!0,class:!0,href:!0});var Ku=i(Yt);na=r(Ku,"SPAN",{});var Vu=i(na);w(sn.$$.fragment,Vu),Vu.forEach(t),Ku.forEach(t),md=d(Mr),sa=r(Mr,"SPAN",{});var Xu=i(sa);fd=s(Xu,"LayoutLMForTokenClassification"),Xu.forEach(t),Mr.forEach(t),Qa=d(o),Pe=r(o,"DIV",{class:!0});var dt=i(Pe);w(an.$$.fragment,dt),gd=d(dt),jt=r(dt,"P",{});var vs=i(jt);_d=s(vs,`LayoutLM Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g. for
sequence labeling (information extraction) tasks such as the `),rn=r(vs,"A",{href:!0,rel:!0});var Yu=i(rn);yd=s(Yu,"FUNSD"),Yu.forEach(t),bd=s(vs,`
dataset and the `),ln=r(vs,"A",{href:!0,rel:!0});var Zu=i(ln);kd=s(Zu,"SROIE"),Zu.forEach(t),Ld=s(vs," dataset."),vs.forEach(t),wd=d(dt),dn=r(dt,"P",{});var xr=i(dn);Td=s(xr,"The LayoutLM model was proposed in "),cn=r(xr,"A",{href:!0,rel:!0});var Gu=i(cn);vd=s(Gu,"LayoutLM: Pre-training of Text and Layout for Document Image Understanding"),Gu.forEach(t),Md=s(xr," by Yiheng Xu, Minghao Li, Lei Cui, Shaohan Huang, Furu Wei and Ming Zhou."),xr.forEach(t),xd=d(dt),pn=r(dt,"P",{});var $r=i(pn);$d=s($r,"This model is a PyTorch "),un=r($r,"A",{href:!0,rel:!0});var Ju=i(un);jd=s(Ju,"torch.nn.Module"),Ju.forEach(t),Fd=s($r,` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),$r.forEach(t),zd=d(dt),De=r(dt,"DIV",{class:!0});var ct=i(De);w(hn.$$.fragment,ct),Ed=d(ct),Ft=r(ct,"P",{});var Ms=i(Ft);qd=s(Ms,"The "),is=r(Ms,"A",{href:!0});var Qu=i(is);Cd=s(Qu,"LayoutLMForTokenClassification"),Qu.forEach(t),Pd=s(Ms," forward method, overrides the "),aa=r(Ms,"CODE",{});var eh=i(aa);Nd=s(eh,"__call__"),eh.forEach(t),Sd=s(Ms," special method."),Ms.forEach(t),Id=d(ct),w(Zt.$$.fragment,ct),Dd=d(ct),ra=r(ct,"P",{});var th=i(ra);Ad=s(th,"Examples:"),th.forEach(t),Od=d(ct),w(mn.$$.fragment,ct),ct.forEach(t),dt.forEach(t),er=d(o),zt=r(o,"H2",{class:!0});var jr=i(zt);Gt=r(jr,"A",{id:!0,class:!0,href:!0});var oh=i(Gt);ia=r(oh,"SPAN",{});var nh=i(ia);w(fn.$$.fragment,nh),nh.forEach(t),oh.forEach(t),Ud=d(jr),la=r(jr,"SPAN",{});var sh=i(la);Wd=s(sh,"TFLayoutLMModel"),sh.forEach(t),jr.forEach(t),tr=d(o),Le=r(o,"DIV",{class:!0});var Ye=i(Le);w(gn.$$.fragment,Ye),Bd=d(Ye),da=r(Ye,"P",{});var ah=i(da);Hd=s(ah,"The bare LayoutLM Model transformer outputting raw hidden-states without any specific head on top."),ah.forEach(t),Rd=d(Ye),_n=r(Ye,"P",{});var Fr=i(_n);Kd=s(Fr,"This model inherits from "),ls=r(Fr,"A",{href:!0});var rh=i(ls);Vd=s(rh,"TFPreTrainedModel"),rh.forEach(t),Xd=s(Fr,`. Check the superclass documentation for the
generic methods the library implements for all its model (such as downloading or saving, resizing the input
...
it as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage
and behavior.`),zr.forEach(t),Qd=d(Ye),w(Jt.$$.fragment,Ye),ec=d(Ye),Ae=r(Ye,"DIV",{class:!0});var pt=i(Ae);w(kn.$$.fragment,pt),tc=d(pt),Et=r(pt,"P",{});var xs=i(Et);oc=s(xs,"The "),ds=r(xs,"A",{href:!0});var lh=i(ds);nc=s(lh,"TFLayoutLMModel"),lh.forEach(t),sc=s(xs," forward method, overrides the "),ca=r(xs,"CODE",{});var dh=i(ca);ac=s(dh,"__call__"),dh.forEach(t),rc=s(xs," special method."),xs.forEach(t),ic=d(pt),w(Qt.$$.fragment,pt),lc=d(pt),pa=r(pt,"P",{});var ch=i(pa);dc=s(ch,"Examples:"),ch.forEach(t),cc=d(pt),w(Ln.$$.fragment,pt),pt.forEach(t),Ye.forEach(t),or=d(o),qt=r(o,"H2",{class:!0});var Er=i(qt);eo=r(Er,"A",{id:!0,class:!0,href:!0});var ph=i(eo);ua=r(ph,"SPAN",{});var uh=i(ua);w(wn.$$.fragment,uh),uh.forEach(t),ph.forEach(t),pc=d(Er),ha=r(Er,"SPAN",{});var hh=i(ha);uc=s(hh,"TFLayoutLMForMaskedLM"),hh.forEach(t),Er.forEach(t),nr=d(o),we=r(o,"DIV",{class:!0});var Ze=i(we);w(Tn.$$.fragment,Ze),hc=d(Ze),vn=r(Ze,"P",{});var qr=i(vn);mc=s(qr,"LayoutLM Model with a "),ma=r(qr,"EM",{});var mh=i(ma);fc=s(mh,"language modeling"),mh.forEach(t),gc=s(qr," head on top."),qr.forEach(t),_c=d(Ze),Mn=r(Ze,"P",{});var Cr=i(Mn);yc=s(Cr,"This model inherits from "),cs=r(Cr,"A",{href:!0});var fh=i(cs);bc=s(fh,"TFPreTrainedModel"),fh.forEach(t),kc=s(Cr,`. Check the superclass documentation for the
generic methods the library implements for all its model (such as downloading or saving, resizing the input
embeddings, pruning heads etc.)`),Cr.forEach(t),Lc=d(Ze),xn=r(Ze,"P",{});var Pr=i(xn);wc=s(Pr,"This model is also a "),$n=r(Pr,"A",{href:!0,rel:!0});var gh=i($n);Tc=s(gh,"tf.keras.Model"),gh.forEach(t),vc=s(Pr,` subclass. Use
it as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage
and behavior.`),Pr.forEach(t),Mc=d(Ze),w(to.$$.fragment,Ze),xc=d(Ze),Oe=r(Ze,"DIV",{class:!0});var ut=i(Oe);w(jn.$$.fragment,ut),$c=d(ut),Ct=r(ut,"P",{});var $s=i(Ct);jc=s($s,"The "),ps=r($s,"A",{href:!0});var _h=i(ps);Fc=s(_h,"TFLayoutLMForMaskedLM"),_h.forEach(t),zc=s($s," forward method, overrides the "),fa=r($s,"CODE",{});var yh=i(fa);Ec=s(yh,"__call__"),yh.forEach(t),qc=s($s," special method."),$s.forEach(t),Cc=d(ut),w(oo.$$.fragment,ut),Pc=d(ut),ga=r(ut,"P",{});var bh=i(ga);Nc=s(bh,"Examples:"),bh.forEach(t),Sc=d(ut),w(Fn.$$.fragment,ut),ut.forEach(t),Ze.forEach(t),sr=d(o),Pt=r(o,"H2",{class:!0});var Nr=i(Pt);no=r(Nr,"A",{id:!0,class:!0,href:!0});var kh=i(no);_a=r(kh,"SPAN",{});var Lh=i(_a);w(zn.$$.fragment,Lh),Lh.forEach(t),kh.forEach(t),Ic=d(Nr),ya=r(Nr,"SPAN",{});var wh=i(ya);Dc=s(wh,"TFLayoutLMForSequenceClassification"),wh.forEach(t),Nr.forEach(t),ar=d(o),Te=r(o,"DIV",{class:!0});var Ge=i(Te);w(En.$$.fragment,Ge),Ac=d(Ge),ba=r(Ge,"P",{});var Th=i(ba);Oc=s(Th,`LayoutLM Model transformer with a sequence classification/regression head on top (a linear layer on top of the
pooled output) e.g. for GLUE tasks.`),Th.forEach(t),Uc=d(Ge),qn=r(Ge,"P",{});var Sr=i(qn);Wc=s(Sr,"This model inherits from "),us=r(Sr,"A",{href:!0});var vh=i(us);Bc=s(vh,"TFPreTrainedModel"),vh.forEach(t),Hc=s(Sr,`. Check the superclass documentation for the
generic methods the library implements for all its model (such as downloading or saving, resizing the input
...
it as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage
and behavior.`),Ir.forEach(t),Yc=d(Ge),w(so.$$.fragment,Ge),Zc=d(Ge),Ue=r(Ge,"DIV",{class:!0});var ht=i(Ue);w(Nn.$$.fragment,ht),Gc=d(ht),Nt=r(ht,"P",{});var js=i(Nt);Jc=s(js,"The "),hs=r(js,"A",{href:!0});var xh=i(hs);Qc=s(xh,"TFLayoutLMForSequenceClassification"),xh.forEach(t),ep=s(js," forward method, overrides the "),ka=r(js,"CODE",{});var $h=i(ka);tp=s($h,"__call__"),$h.forEach(t),op=s(js," special method."),js.forEach(t),np=d(ht),w(ao.$$.fragment,ht),sp=d(ht),La=r(ht,"P",{});var jh=i(La);ap=s(jh,"Examples:"),jh.forEach(t),rp=d(ht),w(Sn.$$.fragment,ht),ht.forEach(t),Ge.forEach(t),rr=d(o),St=r(o,"H2",{class:!0});var Dr=i(St);ro=r(Dr,"A",{id:!0,class:!0,href:!0});var Fh=i(ro);wa=r(Fh,"SPAN",{});var zh=i(wa);w(In.$$.fragment,zh),zh.forEach(t),Fh.forEach(t),ip=d(Dr),Ta=r(Dr,"SPAN",{});var Eh=i(Ta);lp=s(Eh,"TFLayoutLMForTokenClassification"),Eh.forEach(t),Dr.forEach(t),ir=d(o),ve=r(o,"DIV",{class:!0});var Je=i(ve);w(Dn.$$.fragment,Je),dp=d(Je),va=r(Je,"P",{});var qh=i(va);cp=s(qh,`LayoutLM Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g. for
...
it as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage
and behavior.`),Or.forEach(t),bp=d(Je),w(io.$$.fragment,Je),kp=d(Je),We=r(Je,"DIV",{class:!0});var mt=i(We);w(Wn.$$.fragment,mt),Lp=d(mt),It=r(mt,"P",{});var Fs=i(It);wp=s(Fs,"The "),fs=r(Fs,"A",{href:!0});var Nh=i(fs);Tp=s(Nh,"TFLayoutLMForTokenClassification"),Nh.forEach(t),vp=s(Fs," forward method, overrides the "),Ma=r(Fs,"CODE",{});var Sh=i(Ma);Mp=s(Sh,"__call__"),Sh.forEach(t),xp=s(Fs," special method."),Fs.forEach(t),$p=d(mt),w(lo.$$.fragment,mt),jp=d(mt),xa=r(mt,"P",{});var Ih=i(xa);Fp=s(Ih,"Examples:"),Ih.forEach(t),zp=d(mt),w(Bn.$$.fragment,mt),mt.forEach(t),Je.forEach(t),this.h()},h(){c(h,"name","hf:doc:metadata"),c(h,"content",JSON.stringify(tm)),c(g,"id","layoutlm"),c(g,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(g,"href","#layoutlm"),c(f,"class","relative group"),c(z,"id","Overview"),c(Z,"id","overview"),c(Z,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(Z,"href","#overview"),c(I,"class","relative group"),c(F,"href","https://arxiv.org/abs/1912.13318"),c(F,"rel","nofollow"),c(te,"href","https://guillaumejaume.github.io/FUNSD/"),c(te,"rel","nofollow"),c(oe,"href","https://rrc.cvc.uab.es/?ch=13"),c(oe,"rel","nofollow"),c(U,"href","https://www.cs.cmu.edu/~aharley/rvl-cdip/"),c(U,"rel","nofollow"),c(fo,"href","https://github.com/tesseract-ocr/tesseract"),c(fo,"rel","nofollow"),c(go,"href","https://pypi.org/project/pytesseract/"),c(go,"rel","nofollow"),c(Yn,"href","/docs/transformers/master/en/model_doc/layoutlm#transformers.LayoutLMForTokenClassification"),c(bo,"href","https://guillaumejaume.github.io/FUNSD/"),c(bo,"rel","nofollow"),c(ko,"href","https://github.com/NielsRogge/Transformers-Tutorials/blob/master/LayoutLM/Fine_tuning_LayoutLMForTokenClassification_on_FUNSD.ipynb"),c(ko,"rel","nofollow"),c(Lo,"href","https://huggingface.co/liminghao1630"),c(Lo,"rel","nofollow"),c(wo,"href","https://github.com/microsoft/unilm/tree/master/layoutlm"),c(wo,"rel","nofollow"),c(At,"id","transformers.LayoutLMConfig"),c(At,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(At,"href","#transformers.LayoutLMConfig"),c(ft,"class","relative group"),c(Zn,"href","/docs/transformers/master/en/model_doc/layoutlm#transformers.LayoutLMModel"),c(Mo,"href","https://huggingface.co/microsoft/layoutlm-base-uncased"),c(Mo,"rel","nofollow"),c(Gn,"href","/docs/transformers/master/en/model_doc/bert#transformers.BertConfig"),c(Jn,"href","/docs/transformers/master/en/model_doc/bert#transformers.BertConfig"),c(qe,"class","docstring"),c(Ot,"id","transformers.LayoutLMTokenizer"),c(Ot,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(Ot,"href","#transformers.LayoutLMTokenizer"),c(yt,"class","relative group"),c(es,"href","/docs/transformers/master/en/model_doc/bert#transformers.BertTokenizer"),c(Be,"class","docstring"),c(Ut,"id","transformers.LayoutLMTokenizerFast"),c(Ut,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(Ut,"href","#transformers.LayoutLMTokenizerFast"),c(bt,"class","relative group"),c(ts,"href","/docs/transformers/master/en/model_doc/layoutlm#transformers.LayoutLMTokenizerFast"),c(os,"href","/docs/transformers/master/en/model_doc/bert#transformers.BertTokenizerFast"),c(ns,"href","/docs/transformers/master/en/model_doc/bert#transformers.BertTokenizerFast"),c(He,"class","docstring"),c(Bt,"id","transformers.LayoutLMModel"),c(Bt,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(Bt,"href","#transformers.LayoutLMModel"),c(kt,"class","relative group"),c(So,"href","https://arxiv.org/abs/1912.13318"),c(So,"rel","nofollow"),c(Do,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),c(Do,"rel","nofollow"),c(ss,"href","/docs/transformers/master/en/model_doc/layoutlm#transformers.LayoutLMModel"),c(Ne,"class","docstring"),c(Re,"class","docstring"),c(Rt,"id","transformers.LayoutLMForMaskedLM"),c(Rt,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(Rt,"href","#transformers.LayoutLMForMaskedLM"),c(wt,"class","relative group"),c(Bo,"href","https://arxiv.org/abs/1912.13318"),c(Bo,"rel","nofollow"),c(Ro,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),c(Ro,"rel","nofollow"),c(as,"href","/docs/transformers/master/en/model_doc/layoutlm#transformers.LayoutLMForMaskedLM"),c(Se,"class","docstring"),c(Ke,"class","docstring"),c(Vt,"id","transformers.LayoutLMForSequenceClassification"),c(Vt,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(Vt,"href","#transformers.LayoutLMForSequenceClassification"),c(Mt,"class","relative group"),c(Go,"href","https://www.cs.cmu.edu/~aharley/rvl-cdip/"),c(Go,"rel","nofollow"),c(Qo,"href","https://arxiv.org/abs/1912.13318"),c(Qo,"rel","nofollow"),c(tn,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),c(tn,"rel","nofollow"),c(rs,"href","/docs/transformers/master/en/model_doc/layoutlm#transformers.LayoutLMForSequenceClassification"),c(Ie,"class","docstring"),c(Ce,"class","docstring"),c(Yt,"id","transformers.LayoutLMForTokenClassification"),c(Yt,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(Yt,"href","#transformers.LayoutLMForTokenClassification"),c($t,"class","relative group"),c(rn,"href","https://guillaumejaume.github.io/FUNSD/"),c(rn,"rel","nofollow"),c(ln,"href","https://rrc.cvc.uab.es/?ch=13"),c(ln,"rel","nofollow"),c(cn,"href","https://arxiv.org/abs/1912.13318"),c(cn,"rel","nofollow"),c(un,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),c(un,"rel","nofollow"),c(is,"href","/docs/transformers/master/en/model_doc/layoutlm#transformers.LayoutLMForTokenClassification"),c(De,"class","docstring"),c(Pe,"class","docstring"),c(Gt,"id","transformers.TFLayoutLMModel"),c(Gt,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(Gt,"href","#transformers.TFLayoutLMModel"),c(zt,"class","relative group"),c(ls,"href","/docs/transformers/master/en/main_classes/model#transformers.TFPreTrainedModel"),c(bn,"href","https://www.tensorflow.org/api_docs/python/tf/keras/Model"),c(bn,"rel","nofollow"),c(ds,"href","/docs/transformers/master/en/model_doc/layoutlm#transformers.TFLayoutLMModel"),c(Ae,"class","docstring"),c(Le,"class","docstring"),c(eo,"id","transformers.TFLayoutLMForMaskedLM"),c(eo,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(eo,"href","#transformers.TFLayoutLMForMaskedLM"),c(qt,"class","relative group"),c(cs,"href","/docs/transformers/master/en/main_classes/model#transformers.TFPreTrainedModel"),c($n,"href","https://www.tensorflow.org/api_docs/python/tf/keras/Model"),c($n,"rel","nofollow"),c(ps,"href","/docs/transformers/master/en/model_doc/layoutlm#transformers.TFLayoutLMForMaskedLM"),c(Oe,"class","docstring"),c(we,"class","docstring"),c(no,"id","transformers.TFLayoutLMForSequenceClassification"),c(no,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(no,"href","#transformers.TFLayoutLMForSequenceClassification"),c(Pt,"class","relative group"),c(us,"href","/docs/transformers/master/en/main_classes/model#transformers.TFPreTrainedModel"),c(Pn,"href","https://www.tensorflow.org/api_docs/python/tf/keras/Model"),c(Pn,"rel","nofollow"),c(hs,"href","/docs/transformers/master/en/model_doc/layoutlm#transformers.TFLayoutLMForSequenceClassification"),c(Ue,"class","docstring"),c(Te,"class","docstring"),c(ro,"id","transformers.TFLayoutLMForTokenClassification"),c(ro,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(ro,"href","#transformers.TFLayoutLMForTokenClassification"),c(St,"class","relative group"),c(ms,"href","/docs/transformers/master/en/main_classes/model#transformers.TFPreTrainedModel"),c(Un,"href","https://www.tensorflow.org/api_docs/python/tf/keras/Model"),c(Un,"rel","nofollow"),c(fs,"href","/docs/transformers/master/en/model_doc/layoutlm#transformers.TFLayoutLMForTokenClassification"),c(We,"class","docstring"),c(ve,"class","docstring")},m(o,m){e(document.head,h),u(o,$,m),u(o,f,m),e(f,g),e(g,b),T(y,b,null),e(f,_),e(f,j),e(j,re),u(o,Y,m),u(o,z,m),u(o,ae,m),u(o,I,m),e(I,Z),e(Z,ne),T(A,ne,null),e(I,ie),e(I,se),e(se,J),u(o,D,m),u(o,G,m),e(G,Q),e(G,F),e(F,E),e(G,le),u(o,W,m),u(o,V,m),e(V,ee),e(ee,H),e(ee,te),e(te,de),e(ee,q),e(V,ce),e(V,O),e(O,pe),e(O,oe),e(oe,R),e(O,ue),e(V,he),e(V,P),e(P,me),e(P,U),e(U,fe),e(P,p),u(o,k,m),u(o,X,m),e(X,je),u(o,Me,m),u(o,N,m),e(N,be),e(be,Fe),u(o,xe,m),u(o,S,m),e(S,K),u(o,$e,m),u(o,ye,m),e(ye,C),e(C,ze),e(C,ke),e(ke,ge),e(C,Ee),e(C,zs),e(zs,Ur),e(C,Wr),e(C,Es),e(Es,Br),e(C,Hr),e(C,fo),e(fo,Rr),e(C,Kr),e(C,go),e(go,Vr),e(C,Xr),u(o,Na,m),T(_o,o,m),u(o,Sa,m),u(o,ot,m),e(ot,Yr),e(ot,qs),e(qs,Zr),e(ot,Gr),e(ot,Cs),e(Cs,Jr),e(ot,Qr),u(o,Ia,m),T(yo,o,m),u(o,Da,m),u(o,Xn,m),e(Xn,et),e(et,ei),e(et,Yn),e(Yn,ti),e(et,oi),e(et,bo),e(bo,ni),e(et,si),e(et,ko),e(ko,ai),e(et,ri),u(o,Aa,m),u(o,nt,m),e(nt,ii),e(nt,Lo),e(Lo,li),e(nt,di),e(nt,wo),e(wo,ci),e(nt,pi),u(o,Oa,m),u(o,ft,m),e(ft,At),e(At,Ps),T(To,Ps,null),e(ft,ui),e(ft,Ns),e(Ns,hi),u(o,Ua,m),u(o,qe,m),T(vo,qe,null),e(qe,mi),e(qe,gt),e(gt,fi),e(gt,Zn),e(Zn,gi),e(gt,_i),e(gt,Mo),e(Mo,yi),e(gt,bi),e(qe,ki),e(qe,_t),e(_t,Li),e(_t,Gn),e(Gn,wi),e(_t,Ti),e(_t,Jn),e(Jn,vi),e(_t,Mi),e(qe,xi),e(qe,Ss),e(Ss,$i),e(qe,ji),T(xo,qe,null),u(o,Wa,m),u(o,yt,m),e(yt,Ot),e(Ot,Is),T($o,Is,null),e(yt,Fi),e(yt,Ds),e(Ds,zi),u(o,Ba,m),u(o,Be,m),T(jo,Be,null),e(Be,Ei),e(Be,As),e(As,qi),e(Be,Ci),e(Be,Qn),e(Qn,Os),e(Os,Pi),e(Qn,Ni),e(Be,Si),e(Be,Fo),e(Fo,Ii),e(Fo,es),e(es,Di),e(Fo,Ai),u(o,Ha,m),u(o,bt,m),e(bt,Ut),e(Ut,Us),T(zo,Us,null),e(bt,Oi),e(bt,Ws),e(Ws,Ui),u(o,Ra,m),u(o,He,m),T(Eo,He,null),e(He,Wi),e(He,Bs),e(Bs,Bi),e(He,Hi),e(He,Wt),e(Wt,ts),e(ts,Ri),e(Wt,Ki),e(Wt,os),e(os,Vi),e(Wt,Xi),e(He,Yi),e(He,qo),e(qo,Zi),e(qo,ns),e(ns,Gi),e(qo,Ji),u(o,Ka,m),u(o,kt,m),e(kt,Bt),e(Bt,Hs),T(Co,Hs,null),e(kt,Qi),e(kt,Rs),e(Rs,el),u(o,Va,m),u(o,Re,m),T(Po,Re,null),e(Re,tl),e(Re,No),e(No,ol),e(No,So),e(So,nl),e(No,sl),e(Re,al),e(Re,Io),e(Io,rl),e(Io,Do),e(Do,il),e(Io,ll),e(Re,dl),e(Re,Ne),T(Ao,Ne,null),e(Ne,cl),e(Ne,Lt),e(Lt,pl),e(Lt,ss),e(ss,ul),e(Lt,hl),e(Lt,Ks),e(Ks,ml),e(Lt,fl),e(Ne,gl),T(Ht,Ne,null),e(Ne,_l),e(Ne,Vs),e(Vs,yl),e(Ne,bl),T(Oo,Ne,null),u(o,Xa,m),u(o,wt,m),e(wt,Rt),e(Rt,Xs),T(Uo,Xs,null),e(wt,kl),e(wt,Ys),e(Ys,Ll),u(o,Ya,m),u(o,Ke,m),T(Wo,Ke,null),e(Ke,wl),e(Ke,Tt),e(Tt,Tl),e(Tt,Zs),e(Zs,vl),e(Tt,Ml),e(Tt,Bo),e(Bo,xl),e(Tt,$l),e(Ke,jl),e(Ke,Ho),e(Ho,Fl),e(Ho,Ro),e(Ro,zl),e(Ho,El),e(Ke,ql),e(Ke,Se),T(Ko,Se,null),e(Se,Cl),e(Se,vt),e(vt,Pl),e(vt,as),e(as,Nl),e(vt,Sl),e(vt,Gs),e(Gs,Il),e(vt,Dl),e(Se,Al),T(Kt,Se,null),e(Se,Ol),e(Se,Js),e(Js,Ul),e(Se,Wl),T(Vo,Se,null),u(o,Za,m),u(o,Mt,m),e(Mt,Vt),e(Vt,Qs),T(Xo,Qs,null),e(Mt,Bl),e(Mt,ea),e(ea,Hl),u(o,Ga,m),u(o,Ce,m),T(Yo,Ce,null),e(Ce,Rl),e(Ce,Zo),e(Zo,Kl),e(Zo,Go),e(Go,Vl),e(Zo,Xl),e(Ce,Yl),e(Ce,Jo),e(Jo,Zl),e(Jo,Qo),e(Qo,Gl),e(Jo,Jl),e(Ce,Ql),e(Ce,en),e(en,ed),e(en,tn),e(tn,td),e(en,od),e(Ce,nd),e(Ce,Ie),T(on,Ie,null),e(Ie,sd),e(Ie,xt),e(xt,ad),e(xt,rs),e(rs,rd),e(xt,id),e(xt,ta),e(ta,ld),e(xt,dd),e(Ie,cd),T(Xt,Ie,null),e(Ie,pd),e(Ie,oa),e(oa,ud),e(Ie,hd),T(nn,Ie,null),u(o,Ja,m),u(o,$t,m),e($t,Yt),e(Yt,na),T(sn,na,null),e($t,md),e($t,sa),e(sa,fd),u(o,Qa,m),u(o,Pe,m),T(an,Pe,null),e(Pe,gd),e(Pe,jt),e(jt,_d),e(jt,rn),e(rn,yd),e(jt,bd),e(jt,ln),e(ln,kd),e(jt,Ld),e(Pe,wd),e(Pe,dn),e(dn,Td),e(dn,cn),e(cn,vd),e(dn,Md),e(Pe,xd),e(Pe,pn),e(pn,$d),e(pn,un),e(un,jd),e(pn,Fd),e(Pe,zd),e(Pe,De),T(hn,De,null),e(De,Ed),e(De,Ft),e(Ft,qd),e(Ft,is),e(is,Cd),e(Ft,Pd),e(Ft,aa),e(aa,Nd),e(Ft,Sd),e(De,Id),T(Zt,De,null),e(De,Dd),e(De,ra),e(ra,Ad),e(De,Od),T(mn,De,null),u(o,er,m),u(o,zt,m),e(zt,Gt),e(Gt,ia),T(fn,ia,null),e(zt,Ud),e(zt,la),e(la,Wd),u(o,tr,m),u(o,Le,m),T(gn,Le,null),e(Le,Bd),e(Le,da),e(da,Hd),e(Le,Rd),e(Le,_n),e(_n,Kd),e(_n,ls),e(ls,Vd),e(_n,Xd),e(Le,Yd),e(Le,yn),e(yn,Zd),e(yn,bn),e(bn,Gd),e(yn,Jd),e(Le,Qd),T(Jt,Le,null),e(Le,ec),e(Le,Ae),T(kn,Ae,null),e(Ae,tc),e(Ae,Et),e(Et,oc),e(Et,ds),e(ds,nc),e(Et,sc),e(Et,ca),e(ca,ac),e(Et,rc),e(Ae,ic),T(Qt,Ae,null),e(Ae,lc),e(Ae,pa),e(pa,dc),e(Ae,cc),T(Ln,Ae,null),u(o,or,m),u(o,qt,m),e(qt,eo),e(eo,ua),T(wn,ua,null),e(qt,pc),e(qt,ha),e(ha,uc),u(o,nr,m),u(o,we,m),T(Tn,we,null),e(we,hc),e(we,vn),e(vn,mc),e(vn,ma),e(ma,fc),e(vn,gc),e(we,_c),e(we,Mn),e(Mn,yc),e(Mn,cs),e(cs,bc),e(Mn,kc),e(we,Lc),e(we,xn),e(xn,wc),e(xn,$n),e($n,Tc),e(xn,vc),e(we,Mc),T(to,we,null),e(we,xc),e(we,Oe),T(jn,Oe,null),e(Oe,$c),e(Oe,Ct),e(Ct,jc),e(Ct,ps),e(ps,Fc),e(Ct,zc),e(Ct,fa),e(fa,Ec),e(Ct,qc),e(Oe,Cc),T(oo,Oe,null),e(Oe,Pc),e(Oe,ga),e(ga,Nc),e(Oe,Sc),T(Fn,Oe,null),u(o,sr,m),u(o,Pt,m),e(Pt,no),e(no,_a),T(zn,_a,null),e(Pt,Ic),e(Pt,ya),e(ya,Dc),u(o,ar,m),u(o,Te,m),T(En,Te,null),e(Te,Ac),e(Te,ba),e(ba,Oc),e(Te,Uc),e(Te,qn),e(qn,Wc),e(qn,us),e(us,Bc),e(qn,Hc),e(Te,Rc),e(Te,Cn),e(Cn,Kc),e(Cn,Pn),e(Pn,Vc),e(Cn,Xc),e(Te,Yc),T(so,Te,null),e(Te,Zc),e(Te,Ue),T(Nn,Ue,null),e(Ue,Gc),e(Ue,Nt),e(Nt,Jc),e(Nt,hs),e(hs,Qc),e(Nt,ep),e(Nt,ka),e(ka,tp),e(Nt,op),e(Ue,np),T(ao,Ue,null),e(Ue,sp),e(Ue,La),e(La,ap),e(Ue,rp),T(Sn,Ue,null),u(o,rr,m),u(o,St,m),e(St,ro),e(ro,wa),T(In,wa,null),e(St,ip),e(St,Ta),e(Ta,lp),u(o,ir,m),u(o,ve,m),T(Dn,ve,null),e(ve,dp),e(ve,va),e(va,cp),e(ve,pp),e(ve,An),e(An,up),e(An,ms),e(ms,hp),e(An,mp),e(ve,fp),e(ve,On),e(On,gp),e(On,Un),e(Un,_p),e(On,yp),e(ve,bp),T(io,ve,null),e(ve,kp),e(ve,We),T(Wn,We,null),e(We,Lp),e(We,It),e(It,wp),e(It,fs),e(fs,Tp),e(It,vp),e(It,Ma),e(Ma,Mp),e(It,xp),e(We,$p),T(lo,We,null),e(We,jp),e(We,xa),e(xa,Fp),e(We,zp),T(Bn,We,null),lr=!0},p(o,[m]){const Hn={};m&2&&(Hn.$$scope={dirty:m,ctx:o}),Ht.$set(Hn);const $a={};m&2&&($a.$$scope={dirty:m,ctx:o}),Kt.$set($a);const ja={};m&2&&(ja.$$scope={dirty:m,ctx:o}),Xt.$set(ja);const Fa={};m&2&&(Fa.$$scope={dirty:m,ctx:o}),Zt.$set(Fa);const Rn={};m&2&&(Rn.$$scope={dirty:m,ctx:o}),Jt.$set(Rn);const za={};m&2&&(za.$$scope={dirty:m,ctx:o}),Qt.$set(za);const Ea={};m&2&&(Ea.$$scope={dirty:m,ctx:o}),to.$set(Ea);const qa={};m&2&&(qa.$$scope={dirty:m,ctx:o}),oo.$set(qa);const Kn={};m&2&&(Kn.$$scope={dirty:m,ctx:o}),so.$set(Kn);const Ca={};m&2&&(Ca.$$scope={dirty:m,ctx:o}),ao.$set(Ca);const Dt={};m&2&&(Dt.$$scope={dirty:m,ctx:o}),io.$set(Dt);const Vn={};m&2&&(Vn.$$scope={dirty:m,ctx:o}),lo.$set(Vn)},i(o){lr||(v(y.$$.fragment,o),v(A.$$.fragment,o),v(_o.$$.fragment,o),v(yo.$$.fragment,o),v(To.$$.fragment,o),v(vo.$$.fragment,o),v(xo.$$.fragment,o),v($o.$$.fragment,o),v(jo.$$.fragment,o),v(zo.$$.fragment,o),v(Eo.$$.fragment,o),v(Co.$$.fragment,o),v(Po.$$.fragment,o),v(Ao.$$.fragment,o),v(Ht.$$.fragment,o),v(Oo.$$.fragment,o),v(Uo.$$.fragment,o),v(Wo.$$.fragment,o),v(Ko.$$.fragment,o),v(Kt.$$.fragment,o),v(Vo.$$.fragment,o),v(Xo.$$.fragment,o),v(Yo.$$.fragment,o),v(on.$$.fragment,o),v(Xt.$$.fragment,o),v(nn.$$.fragment,o),v(sn.$$.fragment,o),v(an.$$.fragment,o),v(hn.$$.fragment,o),v(Zt.$$.fragment,o),v(mn.$$.fragment,o),v(fn.$$.fragment,o),v(gn.$$.fragment,o),v(Jt.$$.fragment,o),v(kn.$$.fragment,o),v(Qt.$$.fragment,o),v(Ln.$$.fragment,o),v(wn.$$.fragment,o),v(Tn.$$.fragment,o),v(to.$$.fragment,o),v(jn.$$.fragment,o),v(oo.$$.fragment,o),v(Fn.$$.fragment,o),v(zn.$$.fragment,o),v(En.$$.fragment,o),v(so.$$.fragment,o),v(Nn.$$.fragment,o),v(ao.$$.fragment,o),v(Sn.$$.fragment,o),v(In.$$.fragment,o),v(Dn.$$.fragment,o),v(io.$$.fragment,o),v(Wn.$$.fragment,o),v(lo.$$.fragment,o),v(Bn.$$.fragment,o),lr=!0)},o(o){M(y.$$.fragment,o),M(A.$$.fragment,o),M(_o.$$.fragment,o),M(yo.$$.fragment,o),M(To.$$.fragment,o),M(vo.$$.fragment,o),M(xo.$$.fragment,o),M($o.$$.fragment,o),M(jo.$$.fragment,o),M(zo.$$.fragment,o),M(Eo.$$.fragment,o),M(Co.$$.fragment,o),M(Po.$$.fragment,o),M(Ao.$$.fragment,o),M(Ht.$$.fragment,o),M(Oo.$$.fragment,o),M(Uo.$$.fragment,o),M(Wo.$$.fragment,o),M(Ko.$$.fragment,o),M(Kt.$$.fragment,o),M(Vo.$$.fragment,o),M(Xo.$$.fragment,o),M(Yo.$$.fragment,o),M(on.$$.fragment,o),M(Xt.$$.fragment,o),M(nn.$$.fragment,o),M(sn.$$.fragment,o),M(an.$$.fragment,o),M(hn.$$.fragment,o),M(Zt.$$.fragment,o),M(mn.$$.fragment,o),M(fn.$$.fragment,o),M(gn.$$.fragment,o),M(Jt.$$.fragment,o),M(kn.$$.fragment,o),M(Qt.$$.fragment,o),M(Ln.$$.fragment,o),M(wn.$$.fragment,o),M(Tn.$$.fragment,o),M(to.$$.fragment,o),M(jn.$$.fragment,o),M(oo.$$.fragment,o),M(Fn.$$.fragment,o),M(zn.$$.fragment,o),M(En.$$.fragment,o),M(so.$$.fragment,o),M(Nn.$$.fragment,o),M(ao.$$.fragment,o),M(Sn.$$.fragment,o),M(In.$$.fragment,o),M(Dn.$$.fragment,o),M(io.$$.fragment,o),M(Wn.$$.fragment,o),M(lo.$$.fragment,o),M(Bn.$$.fragment,o),lr=!1},d(o){t(h),o&&t($),o&&t(f),x(y),o&&t(Y),o&&t(z),o&&t(ae),o&&t(I),x(A),o&&t(D),o&&t(G),o&&t(W),o&&t(V),o&&t(k),o&&t(X),o&&t(Me),o&&t(N),o&&t(xe),o&&t(S),o&&t($e),o&&t(ye),o&&t(Na),x(_o,o),o&&t(Sa),o&&t(ot),o&&t(Ia),x(yo,o),o&&t(Da),o&&t(Xn),o&&t(Aa),o&&t(nt),o&&t(Oa),o&&t(ft),x(To),o&&t(Ua),o&&t(qe),x(vo),x(xo),o&&t(Wa),o&&t(yt),x($o),o&&t(Ba),o&&t(Be),x(jo),o&&t(Ha),o&&t(bt),x(zo),o&&t(Ra),o&&t(He),x(Eo),o&&t(Ka),o&&t(kt),x(Co),o&&t(Va),o&&t(Re),x(Po),x(Ao),x(Ht),x(Oo),o&&t(Xa),o&&t(wt),x(Uo),o&&t(Ya),o&&t(Ke),x(Wo),x(Ko),x(Kt),x(Vo),o&&t(Za),o&&t(Mt),x(Xo),o&&t(Ga),o&&t(Ce),x(Yo),x(on),x(Xt),x(nn),o&&t(Ja),o&&t($t),x(sn),o&&t(Qa),o&&t(Pe),x(an),x(hn),x(Zt),x(mn),o&&t(er),o&&t(zt),x(fn),o&&t(tr),o&&t(Le),x(gn),x(Jt),x(kn),x(Qt),x(Ln),o&&t(or),o&&t(qt),x(wn),o&&t(nr),o&&t(we),x(Tn),x(to),x(jn),x(oo),x(Fn),o&&t(sr),o&&t(Pt),x(zn),o&&t(ar),o&&t(Te),x(En),x(so),x(Nn),x(ao),x(Sn),o&&t(rr),o&&t(St),x(In),o&&t(ir),o&&t(ve),x(Dn),x(io),x(Wn),x(lo),x(Bn)}}}const tm={local:"layoutlm",sections:[{local:"overview",title:"Overview"},{local:"transformers.LayoutLMConfig",title:"LayoutLMConfig"},{local:"transformers.LayoutLMTokenizer",title:"LayoutLMTokenizer"},{local:"transformers.LayoutLMTokenizerFast",title:"LayoutLMTokenizerFast"},{local:"transformers.LayoutLMModel",title:"LayoutLMModel"},{local:"transformers.LayoutLMForMaskedLM",title:"LayoutLMForMaskedLM"},{local:"transformers.LayoutLMForSequenceClassification",title:"LayoutLMForSequenceClassification"},{local:"transformers.LayoutLMForTokenClassification",title:"LayoutLMForTokenClassification"},{local:"transformers.TFLayoutLMModel",title:"TFLayoutLMModel"},{local:"transformers.TFLayoutLMForMaskedLM",title:"TFLayoutLMForMaskedLM"},{local:"transformers.TFLayoutLMForSequenceClassification",title:"TFLayoutLMForSequenceClassification"},{local:"transformers.TFLayoutLMForTokenClassification",title:"TFLayoutLMForTokenClassification"}],title:"LayoutLM"};function om(B,h,$){let{fw:f}=h;return B.$$set=g=>{"fw"in g&&$(0,f=g.fw)},[f]}class dm extends Dh{constructor(h){super();Ah(this,h,om,em,Oh,{fw:0})}}export{dm as default,tm as metadata};
