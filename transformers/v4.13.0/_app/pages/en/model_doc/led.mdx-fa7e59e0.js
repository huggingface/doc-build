import{S as am,i as rm,s as dm,e as a,k as i,w as _,t as n,L as im,c as r,d as t,m as l,a as d,x as g,h as s,b as c,J as e,g as h,y as T,q as v,o as k,B as b}from"../../../chunks/vendor-e859c359.js";import{T as lo}from"../../../chunks/Tip-edc75249.js";import{D as M}from"../../../chunks/Docstring-ade913b3.js";import{C as co}from"../../../chunks/CodeBlock-ce4317c2.js";import{I as Ce}from"../../../chunks/IconCopyLink-5fae3b20.js";import"../../../chunks/CopyButton-77addb3d.js";function lm(N){let u,q,f,w,L;return{c(){u=a("p"),q=n(`Although the recipe for forward pass needs to be defined within this function, one should call the
`),f=a("code"),w=n("Module"),L=n(` instance afterwards instead of this since the former takes care of running the pre and post
...
`),f=r(y,"CODE",{});var D=d(f);w=s(D,"Module"),D.forEach(t),L=s(y,` instance afterwards instead of this since the former takes care of running the pre and post
processing steps while the latter silently ignores them.`),y.forEach(t)},m(E,y){h(E,u,y),e(u,q),e(u,f),e(f,w),e(u,L)},d(E){E&&t(u)}}}function cm(N){let u,q,f,w,L;return{c(){u=a("p"),q=n(`Although the recipe for forward pass needs to be defined within this function, one should call the
`),f=a("code"),w=n("Module"),L=n(` instance afterwards instead of this since the former takes care of running the pre and post
processing steps while the latter silently ignores them.`)},l(E){u=r(E,"P",{});var y=d(u);q=s(y,`Although the recipe for forward pass needs to be defined within this function, one should call the
`),f=r(y,"CODE",{});var D=d(f);w=s(D,"Module"),D.forEach(t),L=s(y,` instance afterwards instead of this since the former takes care of running the pre and post
processing steps while the latter silently ignores them.`),y.forEach(t)},m(E,y){h(E,u,y),e(u,q),e(u,f),e(f,w),e(u,L)},d(E){E&&t(u)}}}function hm(N){let u,q,f,w,L;return{c(){u=a("p"),q=n(`Although the recipe for forward pass needs to be defined within this function, one should call the
`),f=a("code"),w=n("Module"),L=n(` instance afterwards instead of this since the former takes care of running the pre and post
processing steps while the latter silently ignores them.`)},l(E){u=r(E,"P",{});var y=d(u);q=s(y,`Although the recipe for forward pass needs to be defined within this function, one should call the
`),f=r(y,"CODE",{});var D=d(f);w=s(D,"Module"),D.forEach(t),L=s(y,` instance afterwards instead of this since the former takes care of running the pre and post
processing steps while the latter silently ignores them.`),y.forEach(t)},m(E,y){h(E,u,y),e(u,q),e(u,f),e(f,w),e(u,L)},d(E){E&&t(u)}}}function pm(N){let u,q,f,w,L;return{c(){u=a("p"),q=n(`Although the recipe for forward pass needs to be defined within this function, one should call the
`),f=a("code"),w=n("Module"),L=n(` instance afterwards instead of this since the former takes care of running the pre and post
processing steps while the latter silently ignores them.`)},l(E){u=r(E,"P",{});var y=d(u);q=s(y,`Although the recipe for forward pass needs to be defined within this function, one should call the
`),f=r(y,"CODE",{});var D=d(f);w=s(D,"Module"),D.forEach(t),L=s(y,` instance afterwards instead of this since the former takes care of running the pre and post
processing steps while the latter silently ignores them.`),y.forEach(t)},m(E,y){h(E,u,y),e(u,q),e(u,f),e(f,w),e(u,L)},d(E){E&&t(u)}}}function um(N){let u,q,f,w,L,E,y,D,Oe,pe,z,J,H,Y,Pe,R,Ae,Fe,I,W,ee,ye,S,O,ue,te,$e,me,U,Ne,xe,C,je,Z,$,x,B,Ie,Be,A,Ge,oe,Ee;return{c(){u=a("p"),q=n("TF 2.0 models accepts two formats as inputs:"),f=i(),w=a("ul"),L=a("li"),E=n("having all inputs as keyword arguments (like PyTorch models), or"),y=i(),D=a("li"),Oe=n("having all inputs as a list, tuple or dict in the first positional arguments."),pe=i(),z=a("p"),J=n("This second option is useful when using "),H=a("code"),Y=n("tf.keras.Model.fit"),Pe=n(` method which currently requires having all
...
the first positional argument :`),ye=i(),S=a("ul"),O=a("li"),ue=n("a single Tensor with "),te=a("code"),$e=n("input_ids"),me=n(" only and nothing else: "),U=a("code"),Ne=n("model(input_ids)"),xe=i(),C=a("li"),je=n(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
...
`),oe=a("code"),Ee=n('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(m){u=r(m,"P",{});var F=d(u);q=s(F,"TF 2.0 models accepts two formats as inputs:"),F.forEach(t),f=l(m),w=r(m,"UL",{});var ne=d(w);L=r(ne,"LI",{});var ot=d(L);E=s(ot,"having all inputs as keyword arguments (like PyTorch models), or"),ot.forEach(t),y=l(ne),D=r(ne,"LI",{});var nt=d(D);Oe=s(nt,"having all inputs as a list, tuple or dict in the first positional arguments."),nt.forEach(t),ne.forEach(t),pe=l(m),z=r(m,"P",{});var j=d(z);J=s(j,"This second option is useful when using "),H=r(j,"CODE",{});var st=d(H);Y=s(st,"tf.keras.Model.fit"),st.forEach(t),Pe=s(j,` method which currently requires having all
the tensors in the first argument of the model call function: `),R=r(j,"CODE",{});var at=d(R);Ae=s(at,"model(inputs)"),at.forEach(t),Fe=s(j,"."),j.forEach(t),I=l(m),W=r(m,"P",{});var Me=d(W);ee=s(Me,`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in
the first positional argument :`),Me.forEach(t),ye=l(m),S=r(m,"UL",{});var V=d(S);O=r(V,"LI",{});var se=d(O);ue=s(se,"a single Tensor with "),te=r(se,"CODE",{});var Se=d(te);$e=s(Se,"input_ids"),Se.forEach(t),me=s(se," only and nothing else: "),U=r(se,"CODE",{});var rt=d(U);Ne=s(rt,"model(input_ids)"),rt.forEach(t),se.forEach(t),xe=l(V),C=r(V,"LI",{});var ae=d(C);je=s(ae,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
...
`),oe=r(Qe,"CODE",{});var He=d(oe);Ee=s(He,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),He.forEach(t),Qe.forEach(t),V.forEach(t)},m(m,F){h(m,u,F),e(u,q),h(m,f,F),h(m,w,F),e(w,L),e(L,E),e(w,y),e(w,D),e(D,Oe),h(m,pe,F),h(m,z,F),e(z,J),e(z,H),e(H,Y),e(z,Pe),e(z,R),e(R,Ae),e(z,Fe),h(m,I,F),h(m,W,F),e(W,ee),h(m,ye,F),h(m,S,F),e(S,O),e(O,ue),e(O,te),e(te,$e),e(O,me),e(O,U),e(U,Ne),e(S,xe),e(S,C),e(C,je),e(C,Z),e(Z,$),e(C,x),e(C,B),e(B,Ie),e(S,Be),e(S,A),e(A,Ge),e(A,oe),e(oe,Ee)},d(m){m&&t(u),m&&t(f),m&&t(w),m&&t(pe),m&&t(z),m&&t(I),m&&t(W),m&&t(ye),m&&t(S)}}}function mm(N){let u,q,f,w,L;return{c(){u=a("p"),q=n(`Although the recipe for forward pass needs to be defined within this function, one should call the
`),f=a("code"),w=n("Module"),L=n(` instance afterwards instead of this since the former takes care of running the pre and post
processing steps while the latter silently ignores them.`)},l(E){u=r(E,"P",{});var y=d(u);q=s(y,`Although the recipe for forward pass needs to be defined within this function, one should call the
`),f=r(y,"CODE",{});var D=d(f);w=s(D,"Module"),D.forEach(t),L=s(y,` instance afterwards instead of this since the former takes care of running the pre and post
processing steps while the latter silently ignores them.`),y.forEach(t)},m(E,y){h(E,u,y),e(u,q),e(u,f),e(f,w),e(u,L)},d(E){E&&t(u)}}}function fm(N){let u,q,f,w,L,E,y,D,Oe,pe,z,J,H,Y,Pe,R,Ae,Fe,I,W,ee,ye,S,O,ue,te,$e,me,U,Ne,xe,C,je,Z,$,x,B,Ie,Be,A,Ge,oe,Ee;return{c(){u=a("p"),q=n("TF 2.0 models accepts two formats as inputs:"),f=i(),w=a("ul"),L=a("li"),E=n("having all inputs as keyword arguments (like PyTorch models), or"),y=i(),D=a("li"),Oe=n("having all inputs as a list, tuple or dict in the first positional arguments."),pe=i(),z=a("p"),J=n("This second option is useful when using "),H=a("code"),Y=n("tf.keras.Model.fit"),Pe=n(` method which currently requires having all
the tensors in the first argument of the model call function: `),R=a("code"),Ae=n("model(inputs)"),Fe=n("."),I=i(),W=a("p"),ee=n(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in
the first positional argument :`),ye=i(),S=a("ul"),O=a("li"),ue=n("a single Tensor with "),te=a("code"),$e=n("input_ids"),me=n(" only and nothing else: "),U=a("code"),Ne=n("model(input_ids)"),xe=i(),C=a("li"),je=n(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),Z=a("code"),$=n("model([input_ids, attention_mask])"),x=n(" or "),B=a("code"),Ie=n("model([input_ids, attention_mask, token_type_ids])"),Be=i(),A=a("li"),Ge=n(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),oe=a("code"),Ee=n('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(m){u=r(m,"P",{});var F=d(u);q=s(F,"TF 2.0 models accepts two formats as inputs:"),F.forEach(t),f=l(m),w=r(m,"UL",{});var ne=d(w);L=r(ne,"LI",{});var ot=d(L);E=s(ot,"having all inputs as keyword arguments (like PyTorch models), or"),ot.forEach(t),y=l(ne),D=r(ne,"LI",{});var nt=d(D);Oe=s(nt,"having all inputs as a list, tuple or dict in the first positional arguments."),nt.forEach(t),ne.forEach(t),pe=l(m),z=r(m,"P",{});var j=d(z);J=s(j,"This second option is useful when using "),H=r(j,"CODE",{});var st=d(H);Y=s(st,"tf.keras.Model.fit"),st.forEach(t),Pe=s(j,` method which currently requires having all
...
the first positional argument :`),Me.forEach(t),ye=l(m),S=r(m,"UL",{});var V=d(S);O=r(V,"LI",{});var se=d(O);ue=s(se,"a single Tensor with "),te=r(se,"CODE",{});var Se=d(te);$e=s(Se,"input_ids"),Se.forEach(t),me=s(se," only and nothing else: "),U=r(se,"CODE",{});var rt=d(U);Ne=s(rt,"model(input_ids)"),rt.forEach(t),se.forEach(t),xe=l(V),C=r(V,"LI",{});var ae=d(C);je=s(ae,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),Z=r(ae,"CODE",{});var dt=d(Z);$=s(dt,"model([input_ids, attention_mask])"),dt.forEach(t),x=s(ae," or "),B=r(ae,"CODE",{});var re=d(B);Ie=s(re,"model([input_ids, attention_mask, token_type_ids])"),re.forEach(t),ae.forEach(t),Be=l(V),A=r(V,"LI",{});var Qe=d(A);Ge=s(Qe,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),oe=r(Qe,"CODE",{});var He=d(oe);Ee=s(He,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),He.forEach(t),Qe.forEach(t),V.forEach(t)},m(m,F){h(m,u,F),e(u,q),h(m,f,F),h(m,w,F),e(w,L),e(L,E),e(w,y),e(w,D),e(D,Oe),h(m,pe,F),h(m,z,F),e(z,J),e(z,H),e(H,Y),e(z,Pe),e(z,R),e(R,Ae),e(z,Fe),h(m,I,F),h(m,W,F),e(W,ee),h(m,ye,F),h(m,S,F),e(S,O),e(O,ue),e(O,te),e(te,$e),e(O,me),e(O,U),e(U,Ne),e(S,xe),e(S,C),e(C,je),e(C,Z),e(Z,$),e(C,x),e(C,B),e(B,Ie),e(S,Be),e(S,A),e(A,Ge),e(A,oe),e(oe,Ee)},d(m){m&&t(u),m&&t(f),m&&t(w),m&&t(pe),m&&t(z),m&&t(I),m&&t(W),m&&t(ye),m&&t(S)}}}function _m(N){let u,q,f,w,L;return{c(){u=a("p"),q=n(`Although the recipe for forward pass needs to be defined within this function, one should call the
`),f=a("code"),w=n("Module"),L=n(` instance afterwards instead of this since the former takes care of running the pre and post
processing steps while the latter silently ignores them.`)},l(E){u=r(E,"P",{});var y=d(u);q=s(y,`Although the recipe for forward pass needs to be defined within this function, one should call the
`),f=r(y,"CODE",{});var D=d(f);w=s(D,"Module"),D.forEach(t),L=s(y,` instance afterwards instead of this since the former takes care of running the pre and post
processing steps while the latter silently ignores them.`),y.forEach(t)},m(E,y){h(E,u,y),e(u,q),e(u,f),e(f,w),e(u,L)},d(E){E&&t(u)}}}function gm(N){let u,q,f,w,L,E,y,D,Oe,pe,z,J,H,Y,Pe,R,Ae,Fe,I,W,ee,ye,S,O,ue,te,$e,me,U,Ne,xe,C,je,Z,$,x,B,Ie,Be,A,Ge,oe,Ee,m,F,ne,ot,nt,j,st,at,Me,V,se,Se,rt,ae,dt,re,Qe,He,Zr,Kr,gs,Yr,ed,td,Le,od,Ts,nd,sd,vs,ad,rd,Sn,dd,id,ks,ld,cd,hd,X,pd,bs,ud,md,ws,fd,_d,Cn,gd,Td,ys,vd,kd,Es,bd,wd,Ls,yd,Ed,Ld,it,qd,qs,Dd,zd,Ds,Fd,$d,xd,ho,Md,po,Sd,Cd,Od,uo,Pd,mo,Ad,Nd,Oa,Pt,jd,fo,Id,Bd,Pa,lt,At,zs,_o,Gd,Fs,Qd,Aa,Re,go,Hd,ct,Rd,On,Wd,Ud,To,Vd,Xd,Jd,ht,Zd,Pn,Kd,Yd,An,ei,ti,Na,pt,Nt,$s,vo,oi,xs,ni,ja,P,ko,si,Ms,ai,ri,jt,Nn,di,ii,jn,li,ci,hi,bo,pi,In,ui,mi,fi,We,wo,_i,Ss,gi,Ti,yo,Bn,vi,Cs,ki,bi,Gn,wi,Os,yi,Ei,It,Eo,Li,Lo,qi,Ps,Di,zi,Fi,Bt,qo,$i,As,xi,Mi,Ns,Ia,ut,Gt,js,Do,Si,Is,Ci,Ba,qe,zo,Oi,Fo,Pi,Bs,Ai,Ni,ji,Qt,Qn,Ii,Bi,Hn,Gi,Qi,Hi,$o,Ri,Rn,Wi,Ui,Ga,mt,Ht,Gs,xo,Vi,Qs,Xi,Qa,ft,Mo,Ji,Hs,Zi,Ha,_t,So,Ki,Rs,Yi,Ra,gt,Co,el,Ws,tl,Wa,Tt,Oo,ol,Us,nl,Ua,vt,Po,sl,Vs,al,Va,kt,Ao,rl,Xs,dl,Xa,bt,No,il,Js,ll,Ja,wt,jo,cl,Zs,hl,Za,yt,Rt,Ks,Io,pl,Ys,ul,Ka,De,Bo,ml,Go,fl,Wn,_l,gl,Tl,Qo,vl,Ho,kl,bl,wl,fe,Ro,yl,Et,El,Un,Ll,ql,ea,Dl,zl,Fl,Wt,$l,ta,xl,Ml,Wo,Ya,Lt,Ut,oa,Uo,Sl,na,Cl,er,ze,Vo,Ol,Xo,Pl,Vn,Al,Nl,jl,Jo,Il,Zo,Bl,Gl,Ql,G,Ko,Hl,qt,Rl,Xn,Wl,Ul,sa,Vl,Xl,Jl,Vt,Zl,aa,Kl,Yl,Yo,ec,ra,tc,oc,en,tr,Dt,Xt,da,tn,nc,ia,sc,or,de,on,ac,la,rc,dc,nn,ic,Jn,lc,cc,hc,sn,pc,an,uc,mc,fc,Q,rn,_c,zt,gc,Zn,Tc,vc,ca,kc,bc,wc,Jt,yc,ha,Ec,Lc,dn,qc,pa,Dc,zc,ln,nr,Ft,Zt,ua,cn,Fc,ma,$c,sr,ie,hn,xc,$t,Mc,fa,Sc,Cc,_a,Oc,Pc,Ac,pn,Nc,Kn,jc,Ic,Bc,un,Gc,mn,Qc,Hc,Rc,_e,fn,Wc,xt,Uc,Yn,Vc,Xc,ga,Jc,Zc,Kc,Kt,Yc,Ta,eh,th,_n,ar,Mt,Yt,va,gn,oh,ka,nh,rr,le,Tn,sh,vn,ah,es,rh,dh,ih,kn,lh,bn,ch,hh,ph,eo,uh,ge,wn,mh,St,fh,ts,_h,gh,ba,Th,vh,kh,to,bh,wa,wh,yh,yn,dr,Ct,oo,ya,En,Eh,Ea,Lh,ir,ce,Ln,qh,qn,Dh,os,zh,Fh,$h,Dn,xh,zn,Mh,Sh,Ch,no,Oh,Te,Fn,Ph,Ot,Ah,ns,Nh,jh,La,Ih,Bh,Gh,so,Qh,qa,Hh,Rh,$n,lr;return E=new Ce({}),Y=new Ce({}),_o=new Ce({}),go=new M({props:{name:"class transformers.LEDConfig",anchor:"transformers.LEDConfig",parameters:[{name:"vocab_size",val:" = 50265"},{name:"max_encoder_position_embeddings",val:" = 16384"},{name:"max_decoder_position_embeddings",val:" = 1024"},{name:"encoder_layers",val:" = 12"},{name:"encoder_ffn_dim",val:" = 4096"},{name:"encoder_attention_heads",val:" = 16"},{name:"decoder_layers",val:" = 12"},{name:"decoder_ffn_dim",val:" = 4096"},{name:"decoder_attention_heads",val:" = 16"},{name:"encoder_layerdrop",val:" = 0.0"},{name:"decoder_layerdrop",val:" = 0.0"},{name:"use_cache",val:" = True"},{name:"is_encoder_decoder",val:" = True"},{name:"activation_function",val:" = 'gelu'"},{name:"d_model",val:" = 1024"},{name:"dropout",val:" = 0.1"},{name:"attention_dropout",val:" = 0.0"},{name:"activation_dropout",val:" = 0.0"},{name:"init_std",val:" = 0.02"},{name:"decoder_start_token_id",val:" = 2"},{name:"classifier_dropout",val:" = 0.0"},{name:"pad_token_id",val:" = 1"},{name:"bos_token_id",val:" = 0"},{name:"eos_token_id",val:" = 2"},{name:"attention_window",val:": typing.Union[typing.List[int], int] = 512"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/master/src/transformers/models/led/configuration_led.py#L31",parametersDescription:[{anchor:"transformers.LEDConfig.vocab_size",description:`<strong>vocab_size</strong> (<code>int</code>, <em>optional</em>, defaults to 50265) &#x2014;
...
<p>Example &#x2014;:`,name:"use_cache"}]}}),vo=new Ce({}),ko=new M({props:{name:"class transformers.LEDTokenizer",anchor:"transformers.LEDTokenizer",parameters:[{name:"vocab_file",val:""},{name:"merges_file",val:""},{name:"errors",val:" = 'replace'"},{name:"bos_token",val:" = '<s>'"},{name:"eos_token",val:" = '</s>'"},{name:"sep_token",val:" = '</s>'"},{name:"cls_token",val:" = '<s>'"},{name:"unk_token",val:" = '<unk>'"},{name:"pad_token",val:" = '<pad>'"},{name:"mask_token",val:" = '<mask>'"},{name:"add_prefix_space",val:" = False"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/master/src/transformers/models/led/tokenization_led.py#L39"}}),wo=new M({props:{name:"build\\_inputs\\_with\\_special\\_tokens",anchor:"transformers.RobertaTokenizer.build_inputs_with_special_tokens",parameters:[{name:"token_ids_0",val:": typing.List[int]"},{name:"token_ids_1",val:": typing.Optional[typing.List[int]] = None"}],source:"https://github.com/huggingface/transformers/blob/master/src/transformers/models/roberta/tokenization_roberta.py#L174",parametersDescription:[{anchor:"transformers.RobertaTokenizer.build_inputs_with_special_tokens.token_ids_0",description:`<strong>token_ids_0</strong> (<code>List[int]</code>) &#x2014;
...
<p>Global attentions weights after the attention softmax, used to compute the weighted average in the
self-attention heads. Those are the attention weights from every token with global attention to every token
in the sequence.`,name:"encoder_global_attentions"}]}}),Co=new M({props:{name:"class transformers.models.led.modeling\\_led.LEDSeq2SeqLMOutput",anchor:"transformers.models.led.modeling_led.LEDSeq2SeqLMOutput",parameters:[{name:"loss",val:": typing.Optional[torch.FloatTensor] = None"},{name:"logits",val:": FloatTensor = None"},{name:"past_key_values",val:": typing.Optional[typing.List[torch.FloatTensor]] = None"},{name:"decoder_hidden_states",val:": typing.Optional[typing.Tuple[torch.FloatTensor]] = None"},{name:"decoder_attentions",val:": typing.Optional[typing.Tuple[torch.FloatTensor]] = None"},{name:"cross_attentions",val:": typing.Optional[typing.Tuple[torch.FloatTensor]] = None"},{name:"encoder_last_hidden_state",val:": typing.Optional[torch.FloatTensor] = None"},{name:"encoder_hidden_states",val:": typing.Optional[typing.Tuple[torch.FloatTensor]] = None"},{name:"encoder_attentions",val:": typing.Optional[typing.Tuple[torch.FloatTensor]] = None"},{name:"encoder_global_attentions",val:": typing.Optional[typing.Tuple[torch.FloatTensor]] = None"}],source:"https://github.com/huggingface/transformers/blob/master/src/transformers/models/led/modeling_led.py#L1222",parametersDescription:[{anchor:"transformers.models.led.modeling_led.LEDSeq2SeqLMOutput.loss",description:`<strong>loss</strong> (<code>torch.FloatTensor</code> of shape <code>(1,)</code>, <em>optional</em>, returned when <code>labels</code> is provided) &#x2014;
...
<p>Global attentions weights after the attention softmax, used to compute the weighted average in the
self-attention heads. Those are the attention weights from every token with global attention to every token
in the sequence.`,name:"encoder_global_attentions"}]}}),Io=new Ce({}),Bo=new M({props:{name:"class transformers.LEDModel",anchor:"transformers.LEDModel",parameters:[{name:"config",val:": LEDConfig"}],source:"https://github.com/huggingface/transformers/blob/master/src/transformers/models/led/modeling_led.py#L2151",parametersDescription:[{anchor:"transformers.LEDModel.config",description:`<strong>config</strong> (<a href="/docs/transformers/master/en/model_doc/led#transformers.LEDConfig">LEDConfig</a>) &#x2014;
Model configuration class with all the parameters of the model. Initializing with a config file does not
load the weights associated with the model, only the configuration. Check out the
<a href="/docs/transformers/master/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),Ro=new M({props:{name:"forward",anchor:"transformers.LEDModel.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"decoder_input_ids",val:" = None"},{name:"decoder_attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"decoder_head_mask",val:" = None"},{name:"cross_attn_head_mask",val:" = None"},{name:"encoder_outputs",val:" = None"},{name:"global_attention_mask",val:" = None"},{name:"past_key_values",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"decoder_inputs_embeds",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/master/src/transformers/models/led/modeling_led.py#L2178",parametersDescription:[{anchor:"transformers.LEDModel.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. Padding will be ignored by default should you provide
it.</p>
<p>Indices can be obtained using <a href="/docs/transformers/master/en/model_doc/led#transformers.LEDTokenizer">LEDTokenizer</a>. See
...
`}}),Wt=new lo({props:{$$slots:{default:[lm]},$$scope:{ctx:N}}}),Wo=new co({props:{code:`from transformers import LEDTokenizer, LEDModel
import torch
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),Uo=new Ce({}),Vo=new M({props:{name:"class transformers.LEDForConditionalGeneration",anchor:"transformers.LEDForConditionalGeneration",parameters:[{name:"config",val:": LEDConfig"}],source:"https://github.com/huggingface/transformers/blob/master/src/transformers/models/led/modeling_led.py#L2274",parametersDescription:[{anchor:"transformers.LEDForConditionalGeneration.config",description:`<strong>config</strong> (<a href="/docs/transformers/master/en/model_doc/led#transformers.LEDConfig">LEDConfig</a>) &#x2014;
Model configuration class with all the parameters of the model. Initializing with a config file does not
load the weights associated with the model, only the configuration. Check out the
<a href="/docs/transformers/master/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),Ko=new M({props:{name:"forward",anchor:"transformers.LEDForConditionalGeneration.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"decoder_input_ids",val:" = None"},{name:"decoder_attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"decoder_head_mask",val:" = None"},{name:"cross_attn_head_mask",val:" = None"},{name:"encoder_outputs",val:" = None"},{name:"global_attention_mask",val:" = None"},{name:"past_key_values",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"decoder_inputs_embeds",val:" = None"},{name:"labels",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/master/src/transformers/models/led/modeling_led.py#L2318",parametersDescription:[{anchor:"transformers.LEDForConditionalGeneration.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. Padding will be ignored by default should you provide
it.</p>
<p>Indices can be obtained using <a href="/docs/transformers/master/en/model_doc/led#transformers.LEDTokenizer">LEDTokenizer</a>. See
<a href="/docs/transformers/master/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">transformers.PreTrainedTokenizer.encode()</a> and <a href="/docs/transformers/master/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">transformers.PreTrainedTokenizer.<strong>call</strong>()</a> for
...
`}}),Vt=new lo({props:{$$slots:{default:[cm]},$$scope:{ctx:N}}}),Yo=new co({props:{code:`from transformers import LEDTokenizer, LEDForConditionalGeneration
tokenizer = LEDTokenizer.from_pretrained('allenai/led-base-16384')
...
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-built_in">print</span>(tokenizer.decode(summary_ids[<span class="hljs-number">0</span>], skip_special_tokens=<span class="hljs-literal">True</span>, clean_up_tokenization_spaces=<span class="hljs-literal">True</span>))`}}),tn=new Ce({}),on=new M({props:{name:"class transformers.LEDForSequenceClassification",anchor:"transformers.LEDForSequenceClassification",parameters:[{name:"config",val:": LEDConfig"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/master/src/transformers/models/led/modeling_led.py#L2460",parametersDescription:[{anchor:"transformers.LEDForSequenceClassification.config",description:`<strong>config</strong> (<a href="/docs/transformers/master/en/model_doc/led#transformers.LEDConfig">LEDConfig</a>) &#x2014;
Model configuration class with all the parameters of the model. Initializing with a config file does not
load the weights associated with the model, only the configuration. Check out the
<a href="/docs/transformers/master/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),rn=new M({props:{name:"forward",anchor:"transformers.LEDForSequenceClassification.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"decoder_input_ids",val:" = None"},{name:"decoder_attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"decoder_head_mask",val:" = None"},{name:"cross_attn_head_mask",val:" = None"},{name:"encoder_outputs",val:" = None"},{name:"global_attention_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"decoder_inputs_embeds",val:" = None"},{name:"labels",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/master/src/transformers/models/led/modeling_led.py#L2473",parametersDescription:[{anchor:"transformers.LEDForSequenceClassification.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. Padding will be ignored by default should you provide
it.</p>
<p>Indices can be obtained using <a href="/docs/transformers/master/en/model_doc/led#transformers.LEDTokenizer">LEDTokenizer</a>. See
<a href="/docs/transformers/master/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">transformers.PreTrainedTokenizer.encode()</a> and <a href="/docs/transformers/master/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">transformers.PreTrainedTokenizer.<strong>call</strong>()</a> for
...
`}}),Jt=new lo({props:{$$slots:{default:[hm]},$$scope:{ctx:N}}}),dn=new co({props:{code:`from transformers import LEDTokenizer, LEDForSequenceClassification
import torch
...
`}}),Kt=new lo({props:{$$slots:{default:[pm]},$$scope:{ctx:N}}}),_n=new co({props:{code:`from transformers import LEDTokenizer, LEDForQuestionAnswering
import torch
...
<span class="hljs-meta">&gt;&gt;&gt; </span>end_scores = outputs.end_logits`}}),gn=new Ce({}),Tn=new M({props:{name:"class transformers.TFLEDModel",anchor:"transformers.TFLEDModel",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/master/src/transformers/models/led/modeling_tf_led.py#L2219",parametersDescription:[{anchor:"transformers.TFLEDModel.config",description:`<strong>config</strong> (<a href="/docs/transformers/master/en/model_doc/led#transformers.LEDConfig">LEDConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
...
model weights.`,name:"config"}]}}),eo=new lo({props:{$$slots:{default:[um]},$$scope:{ctx:N}}}),wn=new M({props:{name:"call",anchor:"transformers.TFLEDModel.call",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"decoder_input_ids",val:" = None"},{name:"decoder_attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"decoder_head_mask",val:" = None"},{name:"encoder_outputs",val:": typing.Union[typing.Tuple, transformers.models.led.modeling_tf_led.TFLEDEncoderBaseModelOutput, NoneType] = None"},{name:"global_attention_mask",val:" = None"},{name:"past_key_values",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"decoder_inputs_embeds",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"},{name:"training",val:" = False"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/master/src/transformers/models/led/modeling_tf_led.py#L2231",parametersDescription:[{anchor:"transformers.TFLEDModel.call.input_ids",description:`<strong>input_ids</strong> (<code>tf.Tensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
...
`}}),to=new lo({props:{$$slots:{default:[mm]},$$scope:{ctx:N}}}),yn=new co({props:{code:`from transformers import LEDTokenizer, TFLEDModel
...
`}}),so=new lo({props:{$$slots:{default:[_m]},$$scope:{ctx:N}}}),$n=new co({props:{code:`from transformers import LEDTokenizer, TFLEDForConditionalGeneration
import tensorflow as tf
...
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-comment"># probs[5] is associated with the mask token</span>`}}),{c(){u=a("meta"),q=i(),f=a("h1"),w=a("a"),L=a("span"),_(E.$$.fragment),y=i(),D=a("span"),Oe=n("LED"),pe=i(),z=a("h2"),J=a("a"),H=a("span"),_(Y.$$.fragment),Pe=i(),R=a("span"),Ae=n("Overview"),Fe=i(),I=a("p"),W=n("The LED model was proposed in "),ee=a("a"),ye=n("Longformer: The Long-Document Transformer"),S=n(` by Iz
Beltagy, Matthew E. Peters, Arman Cohan.`),O=i(),ue=a("p"),te=n("The abstract from the paper is the following:"),$e=i(),me=a("p"),U=a("em"),Ne=n(`Transformer-based models are unable to process long sequences due to their self-attention operation, which scales
...
`),A=a("a"),Ge=n("BartForConditionalGeneration"),oe=n(" exchanging the traditional "),Ee=a("em"),m=n("self-attention"),F=n(` layer with
...
1024 tokens.`),td=i(),Le=a("li"),od=n("LED pads the "),Ts=a("code"),nd=n("input_ids"),sd=n(" to be a multiple of "),vs=a("code"),ad=n("config.attention_window"),rd=n(` if required. Therefore a small speed-up is
gained, when `),Sn=a("a"),dd=n("LEDTokenizer"),id=n(" is used with the "),ks=a("code"),ld=n("pad_to_multiple_of"),cd=n(" argument."),hd=i(),X=a("li"),pd=n("LED makes use of "),bs=a("em"),ud=n("global attention"),md=n(" by means of the "),ws=a("code"),fd=n("global_attention_mask"),_d=n(` (see
`),Cn=a("a"),gd=n("LongformerModel"),Td=n("). For summarization, it is advised to put "),ys=a("em"),vd=n("global attention"),kd=n(` only on the first
...
`),Ds=a("code"),Fd=n("model.gradient_checkpointing_enable()"),$d=n("."),xd=i(),ho=a("li"),Md=n("A notebook showing how to evaluate LED, can be accessed "),po=a("a"),Sd=n("here"),Cd=n("."),Od=i(),uo=a("li"),Pd=n("A notebook showing how to fine-tune LED, can be accessed "),mo=a("a"),Ad=n("here"),Nd=n("."),Oa=i(),Pt=a("p"),jd=n("This model was contributed by "),fo=a("a"),Id=n("patrickvonplaten"),Bd=n("."),Pa=i(),lt=a("h2"),At=a("a"),zs=a("span"),_(_o.$$.fragment),Gd=i(),Fs=a("span"),Qd=n("LEDConfig"),Aa=i(),Re=a("div"),_(go.$$.fragment),Hd=i(),ct=a("p"),Rd=n("This is the configuration class to store the configuration of a "),On=a("a"),Wd=n("LEDModel"),Ud=n(`. It is used to
instantiate an LED model according to the specified arguments, defining the model architecture. Instantiating a
configuration with the defaults will yield a similar configuration to that of the LED `),To=a("a"),Vd=n("allenai/led-base-16384"),Xd=n(" architecture."),Jd=i(),ht=a("p"),Zd=n("Configuration objects inherit from "),Pn=a("a"),Kd=n("PretrainedConfig"),Yd=n(` and can be used to control the model
outputs. Read the documentation from `),An=a("a"),ei=n("PretrainedConfig"),ti=n(" for more information."),Na=i(),pt=a("h2"),Nt=a("a"),$s=a("span"),_(vo.$$.fragment),oi=i(),xs=a("span"),ni=n("LEDTokenizer"),ja=i(),P=a("div"),_(ko.$$.fragment),si=i(),Ms=a("p"),ai=n("Construct a LED tokenizer."),ri=i(),jt=a("p"),Nn=a("a"),di=n("LEDTokenizer"),ii=n(" is identical to "),jn=a("a"),li=n("BartTokenizer"),ci=n(` and runs end-to-end
tokenization: punctuation splitting and wordpiece.`),hi=i(),bo=a("p"),pi=n("Refer to superclass "),In=a("a"),ui=n("BartTokenizer"),mi=n(` for usage examples and documentation concerning
parameters.`),fi=i(),We=a("div"),_(wo.$$.fragment),_i=i(),Ss=a("p"),gi=n(`Build model inputs from a sequence or a pair of sequence for sequence classification tasks by concatenating and
adding special tokens. A RoBERTa sequence has the following format:`),Ti=i(),yo=a("ul"),Bn=a("li"),vi=n("single sequence: "),Cs=a("code"),ki=n("<s> X </s>"),bi=i(),Gn=a("li"),wi=n("pair of sequences: "),Os=a("code"),yi=n("<s> A </s></s> B </s>"),Ei=i(),It=a("div"),_(Eo.$$.fragment),Li=i(),Lo=a("p"),qi=n(`Retrieve sequence ids from a token list that has no special tokens added. This method is called when adding
...
methods the library implements for all its model (such as downloading or saving, resizing the input embeddings,
pruning heads etc.)`),hc=i(),sn=a("p"),pc=n("This model is also a PyTorch "),an=a("a"),uc=n("torch.nn.Module"),mc=n(`
subclass. Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to
general usage and behavior.`),fc=i(),Q=a("div"),_(rn.$$.fragment),_c=i(),zt=a("p"),gc=n("The "),Zn=a("a"),Tc=n("LEDForSequenceClassification"),vc=n(" forward method, overrides the "),ca=a("code"),kc=n("__call__"),bc=n(" special method."),wc=i(),_(Jt.$$.fragment),yc=i(),ha=a("p"),Ec=n("Example of single-label classification:"),Lc=i(),_(dn.$$.fragment),qc=i(),pa=a("p"),Dc=n("Example of multi-label classification:"),zc=i(),_(ln.$$.fragment),nr=i(),Ft=a("h2"),Zt=a("a"),ua=a("span"),_(cn.$$.fragment),Fc=i(),ma=a("span"),$c=n("LEDForQuestionAnswering"),sr=i(),ie=a("div"),_(hn.$$.fragment),xc=i(),$t=a("p"),Mc=n(`LED Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear layer
on top of the hidden-states output to compute `),fa=a("em"),Sc=n("span start logits"),Cc=n(" and "),_a=a("em"),Oc=n("span end logits"),Pc=n(")."),Ac=i(),pn=a("p"),Nc=n("This model inherits from "),Kn=a("a"),jc=n("PreTrainedModel"),Ic=n(`. Check the superclass documentation for the generic
methods the library implements for all its model (such as downloading or saving, resizing the input embeddings,
pruning heads etc.)`),Bc=i(),un=a("p"),Gc=n("This model is also a PyTorch "),mn=a("a"),Qc=n("torch.nn.Module"),Hc=n(`
subclass. Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to
general usage and behavior.`),Rc=i(),_e=a("div"),_(fn.$$.fragment),Wc=i(),xt=a("p"),Uc=n("The "),Yn=a("a"),Vc=n("LEDForQuestionAnswering"),Xc=n(" forward method, overrides the "),ga=a("code"),Jc=n("__call__"),Zc=n(" special method."),Kc=i(),_(Kt.$$.fragment),Yc=i(),Ta=a("p"),eh=n("Example:"),th=i(),_(_n.$$.fragment),ar=i(),Mt=a("h2"),Yt=a("a"),va=a("span"),_(gn.$$.fragment),oh=i(),ka=a("span"),nh=n("TFLEDModel"),rr=i(),le=a("div"),_(Tn.$$.fragment),sh=i(),vn=a("p"),ah=n(`The bare LED Model outputting raw hidden-states without any specific head on top.
...
and behavior.`),ph=i(),_(eo.$$.fragment),uh=i(),ge=a("div"),_(wn.$$.fragment),mh=i(),St=a("p"),fh=n("The "),ts=a("a"),_h=n("TFLEDModel"),gh=n(" forward method, overrides the "),ba=a("code"),Th=n("__call__"),vh=n(" special method."),kh=i(),_(to.$$.fragment),bh=i(),wa=a("p"),wh=n("Example:"),yh=i(),_(yn.$$.fragment),dr=i(),Ct=a("h2"),oo=a("a"),ya=a("span"),_(En.$$.fragment),Eh=i(),Ea=a("span"),Lh=n("TFLEDForConditionalGeneration"),ir=i(),ce=a("div"),_(Ln.$$.fragment),qh=i(),qn=a("p"),Dh=n(`The LED Model with a language modeling head. Can be used for summarization.
...
WikiHop and TriviaQA. We finally introduce the Longformer-Encoder-Decoder (LED), a Longformer variant for supporting
long document generative sequence-to-sequence tasks, and demonstrate its effectiveness on the arXiv summarization
dataset.`),Zh.forEach(t),Jh.forEach(t),xe=l(o),C=r(o,"P",{});var Kh=d(C);je=s(Kh,"Tips:"),Kh.forEach(t),Z=l(o),$=r(o,"UL",{});var ve=d($);x=r(ve,"LI",{});var he=d(x);B=r(he,"A",{href:!0});var Yh=d(B);Ie=s(Yh,"LEDForConditionalGeneration"),Yh.forEach(t),Be=s(he,` is an extension of
`),A=r(he,"A",{href:!0});var ep=d(A);Ge=s(ep,"BartForConditionalGeneration"),ep.forEach(t),oe=s(he," exchanging the traditional "),Ee=r(he,"EM",{});var tp=d(Ee);m=s(tp,"self-attention"),tp.forEach(t),F=s(he,` layer with
...
`),Se=r(he,"A",{href:!0});var ap=d(Se);rt=s(ap,"BartTokenizer"),ap.forEach(t),ae=s(he,"."),he.forEach(t),dt=l(ve),re=r(ve,"LI",{});var ss=d(re);Qe=s(ss,"LED works very well on long-range "),He=r(ss,"EM",{});var rp=d(He);Zr=s(rp,"sequence-to-sequence"),rp.forEach(t),Kr=s(ss," tasks where the "),gs=r(ss,"CODE",{});var dp=d(gs);Yr=s(dp,"input_ids"),dp.forEach(t),ed=s(ss,` largely exceed a length of
1024 tokens.`),ss.forEach(t),td=l(ve),Le=r(ve,"LI",{});var Ue=d(Le);od=s(Ue,"LED pads the "),Ts=r(Ue,"CODE",{});var ip=d(Ts);nd=s(ip,"input_ids"),ip.forEach(t),sd=s(Ue," to be a multiple of "),vs=r(Ue,"CODE",{});var lp=d(vs);ad=s(lp,"config.attention_window"),lp.forEach(t),rd=s(Ue,` if required. Therefore a small speed-up is
gained, when `),Sn=r(Ue,"A",{href:!0});var cp=d(Sn);dd=s(cp,"LEDTokenizer"),cp.forEach(t),id=s(Ue," is used with the "),ks=r(Ue,"CODE",{});var hp=d(ks);ld=s(hp,"pad_to_multiple_of"),hp.forEach(t),cd=s(Ue," argument."),Ue.forEach(t),hd=l(ve),X=r(ve,"LI",{});var ke=d(X);pd=s(ke,"LED makes use of "),bs=r(ke,"EM",{});var pp=d(bs);ud=s(pp,"global attention"),pp.forEach(t),md=s(ke," by means of the "),ws=r(ke,"CODE",{});var up=d(ws);fd=s(up,"global_attention_mask"),up.forEach(t),_d=s(ke,` (see
`),Cn=r(ke,"A",{href:!0});var mp=d(Cn);gd=s(mp,"LongformerModel"),mp.forEach(t),Td=s(ke,"). For summarization, it is advised to put "),ys=r(ke,"EM",{});var fp=d(ys);vd=s(fp,"global attention"),fp.forEach(t),kd=s(ke,` only on the first
`),Es=r(ke,"CODE",{});var _p=d(Es);bd=s(_p,"<s>"),_p.forEach(t),wd=s(ke," token. For question answering, it is advised to put "),Ls=r(ke,"EM",{});var gp=d(Ls);yd=s(gp,"global attention"),gp.forEach(t),Ed=s(ke," on all tokens of the question."),ke.forEach(t),Ld=l(ve),it=r(ve,"LI",{});var as=d(it);qd=s(as,"To fine-tune LED on all 16384, it is necessary to enable "),qs=r(as,"EM",{});var Tp=d(qs);Dd=s(Tp,"gradient checkpointing"),Tp.forEach(t),zd=s(as,` by executing
`),Ds=r(as,"CODE",{});var vp=d(Ds);Fd=s(vp,"model.gradient_checkpointing_enable()"),vp.forEach(t),$d=s(as,"."),as.forEach(t),xd=l(ve),ho=r(ve,"LI",{});var hr=d(ho);Md=s(hr,"A notebook showing how to evaluate LED, can be accessed "),po=r(hr,"A",{href:!0,rel:!0});var kp=d(po);Sd=s(kp,"here"),kp.forEach(t),Cd=s(hr,"."),hr.forEach(t),Od=l(ve),uo=r(ve,"LI",{});var pr=d(uo);Pd=s(pr,"A notebook showing how to fine-tune LED, can be accessed "),mo=r(pr,"A",{href:!0,rel:!0});var bp=d(mo);Ad=s(bp,"here"),bp.forEach(t),Nd=s(pr,"."),pr.forEach(t),ve.forEach(t),Oa=l(o),Pt=r(o,"P",{});var ur=d(Pt);jd=s(ur,"This model was contributed by "),fo=r(ur,"A",{href:!0,rel:!0});var wp=d(fo);Id=s(wp,"patrickvonplaten"),wp.forEach(t),Bd=s(ur,"."),ur.forEach(t),Pa=l(o),lt=r(o,"H2",{class:!0});var mr=d(lt);At=r(mr,"A",{id:!0,class:!0,href:!0});var yp=d(At);zs=r(yp,"SPAN",{});var Ep=d(zs);g(_o.$$.fragment,Ep),Ep.forEach(t),yp.forEach(t),Gd=l(mr),Fs=r(mr,"SPAN",{});var Lp=d(Fs);Qd=s(Lp,"LEDConfig"),Lp.forEach(t),mr.forEach(t),Aa=l(o),Re=r(o,"DIV",{class:!0});var rs=d(Re);g(go.$$.fragment,rs),Hd=l(rs),ct=r(rs,"P",{});var ds=d(ct);Rd=s(ds,"This is the configuration class to store the configuration of a "),On=r(ds,"A",{href:!0});var qp=d(On);Wd=s(qp,"LEDModel"),qp.forEach(t),Ud=s(ds,`. It is used to
instantiate an LED model according to the specified arguments, defining the model architecture. Instantiating a
configuration with the defaults will yield a similar configuration to that of the LED `),To=r(ds,"A",{href:!0,rel:!0});var Dp=d(To);Vd=s(Dp,"allenai/led-base-16384"),Dp.forEach(t),Xd=s(ds," architecture."),ds.forEach(t),Jd=l(rs),ht=r(rs,"P",{});var is=d(ht);Zd=s(is,"Configuration objects inherit from "),Pn=r(is,"A",{href:!0});var zp=d(Pn);Kd=s(zp,"PretrainedConfig"),zp.forEach(t),Yd=s(is,` and can be used to control the model
outputs. Read the documentation from `),An=r(is,"A",{href:!0});var Fp=d(An);ei=s(Fp,"PretrainedConfig"),Fp.forEach(t),ti=s(is," for more information."),is.forEach(t),rs.forEach(t),Na=l(o),pt=r(o,"H2",{class:!0});var fr=d(pt);Nt=r(fr,"A",{id:!0,class:!0,href:!0});var $p=d(Nt);$s=r($p,"SPAN",{});var xp=d($s);g(vo.$$.fragment,xp),xp.forEach(t),$p.forEach(t),oi=l(fr),xs=r(fr,"SPAN",{});var Mp=d(xs);ni=s(Mp,"LEDTokenizer"),Mp.forEach(t),fr.forEach(t),ja=l(o),P=r(o,"DIV",{class:!0});var K=d(P);g(ko.$$.fragment,K),si=l(K),Ms=r(K,"P",{});var Sp=d(Ms);ai=s(Sp,"Construct a LED tokenizer."),Sp.forEach(t),ri=l(K),jt=r(K,"P",{});var Sa=d(jt);Nn=r(Sa,"A",{href:!0});var Cp=d(Nn);di=s(Cp,"LEDTokenizer"),Cp.forEach(t),ii=s(Sa," is identical to "),jn=r(Sa,"A",{href:!0});var Op=d(jn);li=s(Op,"BartTokenizer"),Op.forEach(t),ci=s(Sa,` and runs end-to-end
tokenization: punctuation splitting and wordpiece.`),Sa.forEach(t),hi=l(K),bo=r(K,"P",{});var _r=d(bo);pi=s(_r,"Refer to superclass "),In=r(_r,"A",{href:!0});var Pp=d(In);ui=s(Pp,"BartTokenizer"),Pp.forEach(t),mi=s(_r,` for usage examples and documentation concerning
parameters.`),_r.forEach(t),fi=l(K),We=r(K,"DIV",{class:!0});var ls=d(We);g(wo.$$.fragment,ls),_i=l(ls),Ss=r(ls,"P",{});var Ap=d(Ss);gi=s(Ap,`Build model inputs from a sequence or a pair of sequence for sequence classification tasks by concatenating and
adding special tokens. A RoBERTa sequence has the following format:`),Ap.forEach(t),Ti=l(ls),yo=r(ls,"UL",{});var gr=d(yo);Bn=r(gr,"LI",{});var Wh=d(Bn);vi=s(Wh,"single sequence: "),Cs=r(Wh,"CODE",{});var Np=d(Cs);ki=s(Np,"<s> X </s>"),Np.forEach(t),Wh.forEach(t),bi=l(gr),Gn=r(gr,"LI",{});var Uh=d(Gn);wi=s(Uh,"pair of sequences: "),Os=r(Uh,"CODE",{});var jp=d(Os);yi=s(jp,"<s> A </s></s> B </s>"),jp.forEach(t),Uh.forEach(t),gr.forEach(t),ls.forEach(t),Ei=l(K),It=r(K,"DIV",{class:!0});var Tr=d(It);g(Eo.$$.fragment,Tr),Li=l(Tr),Lo=r(Tr,"P",{});var vr=d(Lo);qi=s(vr,`Retrieve sequence ids from a token list that has no special tokens added. This method is called when adding
special tokens using the tokenizer `),Ps=r(vr,"CODE",{});var Ip=d(Ps);Di=s(Ip,"prepare_for_model"),Ip.forEach(t),zi=s(vr," method."),vr.forEach(t),Tr.forEach(t),Fi=l(K),Bt=r(K,"DIV",{class:!0});var kr=d(Bt);g(qo.$$.fragment,kr),$i=l(kr),As=r(kr,"P",{});var Bp=d(As);xi=s(Bp,`Create a mask from the two sequences passed to be used in a sequence-pair classification task. RoBERTa does not
...
parameters.`),yr.forEach(t),ao.forEach(t),Ga=l(o),mt=r(o,"H2",{class:!0});var Er=d(mt);Ht=r(Er,"A",{id:!0,class:!0,href:!0});var Xp=d(Ht);Gs=r(Xp,"SPAN",{});var Jp=d(Gs);g(xo.$$.fragment,Jp),Jp.forEach(t),Xp.forEach(t),Vi=l(Er),Qs=r(Er,"SPAN",{});var Zp=d(Qs);Xi=s(Zp,"LED specific outputs"),Zp.forEach(t),Er.forEach(t),Qa=l(o),ft=r(o,"DIV",{class:!0});var Lr=d(ft);g(Mo.$$.fragment,Lr),Ji=l(Lr),Hs=r(Lr,"P",{});var Kp=d(Hs);Zi=s(Kp,"Base class for LEDEncoder\u2019s outputs, with potential hidden states, local and global attentions."),Kp.forEach(t),Lr.forEach(t),Ha=l(o),_t=r(o,"DIV",{class:!0});var qr=d(_t);g(So.$$.fragment,qr),Ki=l(qr),Rs=r(qr,"P",{});var Yp=d(Rs);Yi=s(Yp,`Base class for model encoder\u2019s outputs that also contains : pre-computed hidden states that can speed up sequential
decoding.`),Yp.forEach(t),qr.forEach(t),Ra=l(o),gt=r(o,"DIV",{class:!0});var Dr=d(gt);g(Co.$$.fragment,Dr),el=l(Dr),Ws=r(Dr,"P",{});var eu=d(Ws);tl=s(eu,"Base class for sequence-to-sequence language models outputs."),eu.forEach(t),Dr.forEach(t),Wa=l(o),Tt=r(o,"DIV",{class:!0});var zr=d(Tt);g(Oo.$$.fragment,zr),ol=l(zr),Us=r(zr,"P",{});var tu=d(Us);nl=s(tu,"Base class for outputs of sequence-to-sequence sentence classification models."),tu.forEach(t),zr.forEach(t),Ua=l(o),vt=r(o,"DIV",{class:!0});var Fr=d(vt);g(Po.$$.fragment,Fr),sl=l(Fr),Vs=r(Fr,"P",{});var ou=d(Vs);al=s(ou,"Base class for outputs of sequence-to-sequence question answering models."),ou.forEach(t),Fr.forEach(t),Va=l(o),kt=r(o,"DIV",{class:!0});var $r=d(kt);g(Ao.$$.fragment,$r),rl=l($r),Xs=r($r,"P",{});var nu=d(Xs);dl=s(nu,"Base class for Longformer\u2019s outputs, with potential hidden states, local and global attentions."),nu.forEach(t),$r.forEach(t),Xa=l(o),bt=r(o,"DIV",{class:!0});var xr=d(bt);g(No.$$.fragment,xr),il=l(xr),Js=r(xr,"P",{});var su=d(Js);ll=s(su,`Base class for model encoder\u2019s outputs that also contains : pre-computed hidden states that can speed up sequential
decoding.`),su.forEach(t),xr.forEach(t),Ja=l(o),wt=r(o,"DIV",{class:!0});var Mr=d(wt);g(jo.$$.fragment,Mr),cl=l(Mr),Zs=r(Mr,"P",{});var au=d(Zs);hl=s(au,"Base class for sequence-to-sequence language models outputs."),au.forEach(t),Mr.forEach(t),Za=l(o),yt=r(o,"H2",{class:!0});var Sr=d(yt);Rt=r(Sr,"A",{id:!0,class:!0,href:!0});var ru=d(Rt);Ks=r(ru,"SPAN",{});var du=d(Ks);g(Io.$$.fragment,du),du.forEach(t),ru.forEach(t),pl=l(Sr),Ys=r(Sr,"SPAN",{});var iu=d(Ys);ul=s(iu,"LEDModel"),iu.forEach(t),Sr.forEach(t),Ka=l(o),De=r(o,"DIV",{class:!0});var ro=d(De);g(Bo.$$.fragment,ro),ml=l(ro),Go=r(ro,"P",{});var Cr=d(Go);fl=s(Cr,`The bare LED Model outputting raw hidden-states without any specific head on top.
...
methods the library implements for all its model (such as downloading or saving, resizing the input embeddings,
pruning heads etc.)`),Cr.forEach(t),Tl=l(ro),Qo=r(ro,"P",{});var Or=d(Qo);vl=s(Or,"This model is also a PyTorch "),Ho=r(Or,"A",{href:!0,rel:!0});var cu=d(Ho);kl=s(cu,"torch.nn.Module"),cu.forEach(t),bl=s(Or,`
subclass. Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to
general usage and behavior.`),Or.forEach(t),wl=l(ro),fe=r(ro,"DIV",{class:!0});var Ve=d(fe);g(Ro.$$.fragment,Ve),yl=l(Ve),Et=r(Ve,"P",{});var cs=d(Et);El=s(cs,"The "),Un=r(cs,"A",{href:!0});var hu=d(Un);Ll=s(hu,"LEDModel"),hu.forEach(t),ql=s(cs," forward method, overrides the "),ea=r(cs,"CODE",{});var pu=d(ea);Dl=s(pu,"__call__"),pu.forEach(t),zl=s(cs," special method."),cs.forEach(t),Fl=l(Ve),g(Wt.$$.fragment,Ve),$l=l(Ve),ta=r(Ve,"P",{});var uu=d(ta);xl=s(uu,"Example:"),uu.forEach(t),Ml=l(Ve),g(Wo.$$.fragment,Ve),Ve.forEach(t),ro.forEach(t),Ya=l(o),Lt=r(o,"H2",{class:!0});var Pr=d(Lt);Ut=r(Pr,"A",{id:!0,class:!0,href:!0});var mu=d(Ut);oa=r(mu,"SPAN",{});var fu=d(oa);g(Uo.$$.fragment,fu),fu.forEach(t),mu.forEach(t),Sl=l(Pr),na=r(Pr,"SPAN",{});var _u=d(na);Cl=s(_u,"LEDForConditionalGeneration"),_u.forEach(t),Pr.forEach(t),er=l(o),ze=r(o,"DIV",{class:!0});var io=d(ze);g(Vo.$$.fragment,io),Ol=l(io),Xo=r(io,"P",{});var Ar=d(Xo);Pl=s(Ar,`The LED Model with a language modeling head. Can be used for summarization.
...
methods the library implements for all its model (such as downloading or saving, resizing the input embeddings,
pruning heads etc.)`),Ir.forEach(t),hc=l(Xe),sn=r(Xe,"P",{});var Br=d(sn);pc=s(Br,"This model is also a PyTorch "),an=r(Br,"A",{href:!0,rel:!0});var zu=d(an);uc=s(zu,"torch.nn.Module"),zu.forEach(t),mc=s(Br,`
subclass. Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to
general usage and behavior.`),Br.forEach(t),fc=l(Xe),Q=r(Xe,"DIV",{class:!0});var we=d(Q);g(rn.$$.fragment,we),_c=l(we),zt=r(we,"P",{});var ps=d(zt);gc=s(ps,"The "),Zn=r(ps,"A",{href:!0});var Fu=d(Zn);Tc=s(Fu,"LEDForSequenceClassification"),Fu.forEach(t),vc=s(ps," forward method, overrides the "),ca=r(ps,"CODE",{});var $u=d(ca);kc=s($u,"__call__"),$u.forEach(t),bc=s(ps," special method."),ps.forEach(t),wc=l(we),g(Jt.$$.fragment,we),yc=l(we),ha=r(we,"P",{});var xu=d(ha);Ec=s(xu,"Example of single-label classification:"),xu.forEach(t),Lc=l(we),g(dn.$$.fragment,we),qc=l(we),pa=r(we,"P",{});var Mu=d(pa);Dc=s(Mu,"Example of multi-label classification:"),Mu.forEach(t),zc=l(we),g(ln.$$.fragment,we),we.forEach(t),Xe.forEach(t),nr=l(o),Ft=r(o,"H2",{class:!0});var Gr=d(Ft);Zt=r(Gr,"A",{id:!0,class:!0,href:!0});var Su=d(Zt);ua=r(Su,"SPAN",{});var Cu=d(ua);g(cn.$$.fragment,Cu),Cu.forEach(t),Su.forEach(t),Fc=l(Gr),ma=r(Gr,"SPAN",{});var Ou=d(ma);$c=s(Ou,"LEDForQuestionAnswering"),Ou.forEach(t),Gr.forEach(t),sr=l(o),ie=r(o,"DIV",{class:!0});var Je=d(ie);g(hn.$$.fragment,Je),xc=l(Je),$t=r(Je,"P",{});var us=d($t);Mc=s(us,`LED Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear layer
on top of the hidden-states output to compute `),fa=r(us,"EM",{});var Pu=d(fa);Sc=s(Pu,"span start logits"),Pu.forEach(t),Cc=s(us," and "),_a=r(us,"EM",{});var Au=d(_a);Oc=s(Au,"span end logits"),Au.forEach(t),Pc=s(us,")."),us.forEach(t),Ac=l(Je),pn=r(Je,"P",{});var Qr=d(pn);Nc=s(Qr,"This model inherits from "),Kn=r(Qr,"A",{href:!0});var Nu=d(Kn);jc=s(Nu,"PreTrainedModel"),Nu.forEach(t),Ic=s(Qr,`. Check the superclass documentation for the generic
methods the library implements for all its model (such as downloading or saving, resizing the input embeddings,
pruning heads etc.)`),Qr.forEach(t),Bc=l(Je),un=r(Je,"P",{});var Hr=d(un);Gc=s(Hr,"This model is also a PyTorch "),mn=r(Hr,"A",{href:!0,rel:!0});var ju=d(mn);Qc=s(ju,"torch.nn.Module"),ju.forEach(t),Hc=s(Hr,`
subclass. Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to
general usage and behavior.`),Hr.forEach(t),Rc=l(Je),_e=r(Je,"DIV",{class:!0});var Ze=d(_e);g(fn.$$.fragment,Ze),Wc=l(Ze),xt=r(Ze,"P",{});var ms=d(xt);Uc=s(ms,"The "),Yn=r(ms,"A",{href:!0});var Iu=d(Yn);Vc=s(Iu,"LEDForQuestionAnswering"),Iu.forEach(t),Xc=s(ms," forward method, overrides the "),ga=r(ms,"CODE",{});var Bu=d(ga);Jc=s(Bu,"__call__"),Bu.forEach(t),Zc=s(ms," special method."),ms.forEach(t),Kc=l(Ze),g(Kt.$$.fragment,Ze),Yc=l(Ze),Ta=r(Ze,"P",{});var Gu=d(Ta);eh=s(Gu,"Example:"),Gu.forEach(t),th=l(Ze),g(_n.$$.fragment,Ze),Ze.forEach(t),Je.forEach(t),ar=l(o),Mt=r(o,"H2",{class:!0});var Rr=d(Mt);Yt=r(Rr,"A",{id:!0,class:!0,href:!0});var Qu=d(Yt);va=r(Qu,"SPAN",{});var Hu=d(va);g(gn.$$.fragment,Hu),Hu.forEach(t),Qu.forEach(t),oh=l(Rr),ka=r(Rr,"SPAN",{});var Ru=d(ka);nh=s(Ru,"TFLEDModel"),Ru.forEach(t),Rr.forEach(t),rr=l(o),le=r(o,"DIV",{class:!0});var Ke=d(le);g(Tn.$$.fragment,Ke),sh=l(Ke),vn=r(Ke,"P",{});var Wr=d(vn);ah=s(Wr,`The bare LED Model outputting raw hidden-states without any specific head on top.
...
it as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage
and behavior.`),Ur.forEach(t),ph=l(Ke),g(eo.$$.fragment,Ke),uh=l(Ke),ge=r(Ke,"DIV",{class:!0});var Ye=d(ge);g(wn.$$.fragment,Ye),mh=l(Ye),St=r(Ye,"P",{});var fs=d(St);fh=s(fs,"The "),ts=r(fs,"A",{href:!0});var Vu=d(ts);_h=s(Vu,"TFLEDModel"),Vu.forEach(t),gh=s(fs," forward method, overrides the "),ba=r(fs,"CODE",{});var Xu=d(ba);Th=s(Xu,"__call__"),Xu.forEach(t),vh=s(fs," special method."),fs.forEach(t),kh=l(Ye),g(to.$$.fragment,Ye),bh=l(Ye),wa=r(Ye,"P",{});var Ju=d(wa);wh=s(Ju,"Example:"),Ju.forEach(t),yh=l(Ye),g(yn.$$.fragment,Ye),Ye.forEach(t),Ke.forEach(t),dr=l(o),Ct=r(o,"H2",{class:!0});var Vr=d(Ct);oo=r(Vr,"A",{id:!0,class:!0,href:!0});var Zu=d(oo);ya=r(Zu,"SPAN",{});var Ku=d(ya);g(En.$$.fragment,Ku),Ku.forEach(t),Zu.forEach(t),Eh=l(Vr),Ea=r(Vr,"SPAN",{});var Yu=d(Ea);Lh=s(Yu,"TFLEDForConditionalGeneration"),Yu.forEach(t),Vr.forEach(t),ir=l(o),ce=r(o,"DIV",{class:!0});var et=d(ce);g(Ln.$$.fragment,et),qh=l(et),qn=r(et,"P",{});var Xr=d(qn);Dh=s(Xr,`The LED Model with a language modeling head. Can be used for summarization.
This model inherits from `),os=r(Xr,"A",{href:!0});var em=d(os);zh=s(em,"TFPreTrainedModel"),em.forEach(t),Fh=s(Xr,`. Check the superclass documentation for the
generic methods the library implements for all its model (such as downloading or saving, resizing the input
embeddings, pruning heads etc.)`),Xr.forEach(t),$h=l(et),Dn=r(et,"P",{});var Jr=d(Dn);xh=s(Jr,"This model is also a "),zn=r(Jr,"A",{href:!0,rel:!0});var tm=d(zn);Mh=s(tm,"tf.keras.Model"),tm.forEach(t),Sh=s(Jr,` subclass. Use
it as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage
and behavior.`),Jr.forEach(t),Ch=l(et),g(no.$$.fragment,et),Oh=l(et),Te=r(et,"DIV",{class:!0});var tt=d(Te);g(Fn.$$.fragment,tt),Ph=l(tt),Ot=r(tt,"P",{});var _s=d(Ot);Ah=s(_s,"The "),ns=r(_s,"A",{href:!0});var om=d(ns);Nh=s(om,"TFLEDForConditionalGeneration"),om.forEach(t),jh=s(_s," forward method, overrides the "),La=r(_s,"CODE",{});var nm=d(La);Ih=s(nm,"__call__"),nm.forEach(t),Bh=s(_s," special method."),_s.forEach(t),Gh=l(tt),g(so.$$.fragment,tt),Qh=l(tt),qa=r(tt,"P",{});var sm=d(qa);Hh=s(sm,"Examples:"),sm.forEach(t),Rh=l(tt),g($n.$$.fragment,tt),tt.forEach(t),et.forEach(t),this.h()},h(){c(u,"name","hf:doc:metadata"),c(u,"content",JSON.stringify(Tm)),c(w,"id","led"),c(w,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(w,"href","#led"),c(f,"class","relative group"),c(J,"id","overview"),c(J,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(J,"href","#overview"),c(z,"class","relative group"),c(ee,"href","https://arxiv.org/abs/2004.05150"),c(ee,"rel","nofollow"),c(B,"href","/docs/transformers/master/en/model_doc/led#transformers.LEDForConditionalGeneration"),c(A,"href","/docs/transformers/master/en/model_doc/bart#transformers.BartForConditionalGeneration"),c(Me,"href","/docs/transformers/master/en/model_doc/led#transformers.LEDTokenizer"),c(Se,"href","/docs/transformers/master/en/model_doc/bart#transformers.BartTokenizer"),c(Sn,"href","/docs/transformers/master/en/model_doc/led#transformers.LEDTokenizer"),c(Cn,"href","/docs/transformers/master/en/model_doc/longformer#transformers.LongformerModel"),c(po,"href","https://colab.research.google.com/drive/12INTTR6n64TzS4RrXZxMSXfrOd9Xzamo?usp=sharing"),c(po,"rel","nofollow"),c(mo,"href","https://colab.research.google.com/drive/12LjJazBl7Gam0XBPy_y0CTOJZeZ34c2v?usp=sharing"),c(mo,"rel","nofollow"),c(fo,"href","https://huggingface.co/patrickvonplaten"),c(fo,"rel","nofollow"),c(At,"id","transformers.LEDConfig"),c(At,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(At,"href","#transformers.LEDConfig"),c(lt,"class","relative group"),c(On,"href","/docs/transformers/master/en/model_doc/led#transformers.LEDModel"),c(To,"href","https://huggingface.co/allenai/led-base-16384"),c(To,"rel","nofollow"),c(Pn,"href","/docs/transformers/master/en/main_classes/configuration#transformers.PretrainedConfig"),c(An,"href","/docs/transformers/master/en/main_classes/configuration#transformers.PretrainedConfig"),c(Re,"class","docstring"),c(Nt,"id","transformers.LEDTokenizer"),c(Nt,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(Nt,"href","#transformers.LEDTokenizer"),c(pt,"class","relative group"),c(Nn,"href","/docs/transformers/master/en/model_doc/led#transformers.LEDTokenizer"),c(jn,"href","/docs/transformers/master/en/model_doc/bart#transformers.BartTokenizer"),c(In,"href","/docs/transformers/master/en/model_doc/bart#transformers.BartTokenizer"),c(We,"class","docstring"),c(It,"class","docstring"),c(Bt,"class","docstring"),c(Ns,"class","docstring"),c(P,"class","docstring"),c(Gt,"id","transformers.LEDTokenizerFast"),c(Gt,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(Gt,"href","#transformers.LEDTokenizerFast"),c(ut,"class","relative group"),c(Qn,"href","/docs/transformers/master/en/model_doc/led#transformers.LEDTokenizerFast"),c(Hn,"href","/docs/transformers/master/en/model_doc/bart#transformers.BartTokenizerFast"),c(Rn,"href","/docs/transformers/master/en/model_doc/bart#transformers.BartTokenizerFast"),c(qe,"class","docstring"),c(Ht,"id","transformers.models.led.modeling_led.LEDEncoderBaseModelOutput"),c(Ht,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(Ht,"href","#transformers.models.led.modeling_led.LEDEncoderBaseModelOutput"),c(mt,"class","relative group"),c(ft,"class","docstring"),c(_t,"class","docstring"),c(gt,"class","docstring"),c(Tt,"class","docstring"),c(vt,"class","docstring"),c(kt,"class","docstring"),c(bt,"class","docstring"),c(wt,"class","docstring"),c(Rt,"id","transformers.LEDModel"),c(Rt,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(Rt,"href","#transformers.LEDModel"),c(yt,"class","relative group"),c(Wn,"href","/docs/transformers/master/en/main_classes/model#transformers.PreTrainedModel"),c(Ho,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),c(Ho,"rel","nofollow"),c(Un,"href","/docs/transformers/master/en/model_doc/led#transformers.LEDModel"),c(fe,"class","docstring"),c(De,"class","docstring"),c(Ut,"id","transformers.LEDForConditionalGeneration"),c(Ut,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(Ut,"href","#transformers.LEDForConditionalGeneration"),c(Lt,"class","relative group"),c(Vn,"href","/docs/transformers/master/en/main_classes/model#transformers.PreTrainedModel"),c(Zo,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),c(Zo,"rel","nofollow"),c(Xn,"href","/docs/transformers/master/en/model_doc/led#transformers.LEDForConditionalGeneration"),c(G,"class","docstring"),c(ze,"class","docstring"),c(Xt,"id","transformers.LEDForSequenceClassification"),c(Xt,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(Xt,"href","#transformers.LEDForSequenceClassification"),c(Dt,"class","relative group"),c(Jn,"href","/docs/transformers/master/en/main_classes/model#transformers.PreTrainedModel"),c(an,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),c(an,"rel","nofollow"),c(Zn,"href","/docs/transformers/master/en/model_doc/led#transformers.LEDForSequenceClassification"),c(Q,"class","docstring"),c(de,"class","docstring"),c(Zt,"id","transformers.LEDForQuestionAnswering"),c(Zt,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(Zt,"href","#transformers.LEDForQuestionAnswering"),c(Ft,"class","relative group"),c(Kn,"href","/docs/transformers/master/en/main_classes/model#transformers.PreTrainedModel"),c(mn,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),c(mn,"rel","nofollow"),c(Yn,"href","/docs/transformers/master/en/model_doc/led#transformers.LEDForQuestionAnswering"),c(_e,"class","docstring"),c(ie,"class","docstring"),c(Yt,"id","transformers.TFLEDModel"),c(Yt,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(Yt,"href","#transformers.TFLEDModel"),c(Mt,"class","relative group"),c(es,"href","/docs/transformers/master/en/main_classes/model#transformers.TFPreTrainedModel"),c(bn,"href","https://www.tensorflow.org/api_docs/python/tf/keras/Model"),c(bn,"rel","nofollow"),c(ts,"href","/docs/transformers/master/en/model_doc/led#transformers.TFLEDModel"),c(ge,"class","docstring"),c(le,"class","docstring"),c(oo,"id","transformers.TFLEDForConditionalGeneration"),c(oo,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(oo,"href","#transformers.TFLEDForConditionalGeneration"),c(Ct,"class","relative group"),c(os,"href","/docs/transformers/master/en/main_classes/model#transformers.TFPreTrainedModel"),c(zn,"href","https://www.tensorflow.org/api_docs/python/tf/keras/Model"),c(zn,"rel","nofollow"),c(ns,"href","/docs/transformers/master/en/model_doc/led#transformers.TFLEDForConditionalGeneration"),c(Te,"class","docstring"),c(ce,"class","docstring")},m(o,p){e(document.head,u),h(o,q,p),h(o,f,p),e(f,w),e(w,L),T(E,L,null),e(f,y),e(f,D),e(D,Oe),h(o,pe,p),h(o,z,p),e(z,J),e(J,H),T(Y,H,null),e(z,Pe),e(z,R),e(R,Ae),h(o,Fe,p),h(o,I,p),e(I,W),e(I,ee),e(ee,ye),e(I,S),h(o,O,p),h(o,ue,p),e(ue,te),h(o,$e,p),h(o,me,p),e(me,U),e(U,Ne),h(o,xe,p),h(o,C,p),e(C,je),h(o,Z,p),h(o,$,p),e($,x),e(x,B),e(B,Ie),e(x,Be),e(x,A),e(A,Ge),e(x,oe),e(x,Ee),e(Ee,m),e(x,F),e(x,ne),e(ne,ot),e(x,nt),e(x,j),e(j,st),e(x,at),e(x,Me),e(Me,V),e(x,se),e(x,Se),e(Se,rt),e(x,ae),e($,dt),e($,re),e(re,Qe),e(re,He),e(He,Zr),e(re,Kr),e(re,gs),e(gs,Yr),e(re,ed),e($,td),e($,Le),e(Le,od),e(Le,Ts),e(Ts,nd),e(Le,sd),e(Le,vs),e(vs,ad),e(Le,rd),e(Le,Sn),e(Sn,dd),e(Le,id),e(Le,ks),e(ks,ld),e(Le,cd),e($,hd),e($,X),e(X,pd),e(X,bs),e(bs,ud),e(X,md),e(X,ws),e(ws,fd),e(X,_d),e(X,Cn),e(Cn,gd),e(X,Td),e(X,ys),e(ys,vd),e(X,kd),e(X,Es),e(Es,bd),e(X,wd),e(X,Ls),e(Ls,yd),e(X,Ed),e($,Ld),e($,it),e(it,qd),e(it,qs),e(qs,Dd),e(it,zd),e(it,Ds),e(Ds,Fd),e(it,$d),e($,xd),e($,ho),e(ho,Md),e(ho,po),e(po,Sd),e(ho,Cd),e($,Od),e($,uo),e(uo,Pd),e(uo,mo),e(mo,Ad),e(uo,Nd),h(o,Oa,p),h(o,Pt,p),e(Pt,jd),e(Pt,fo),e(fo,Id),e(Pt,Bd),h(o,Pa,p),h(o,lt,p),e(lt,At),e(At,zs),T(_o,zs,null),e(lt,Gd),e(lt,Fs),e(Fs,Qd),h(o,Aa,p),h(o,Re,p),T(go,Re,null),e(Re,Hd),e(Re,ct),e(ct,Rd),e(ct,On),e(On,Wd),e(ct,Ud),e(ct,To),e(To,Vd),e(ct,Xd),e(Re,Jd),e(Re,ht),e(ht,Zd),e(ht,Pn),e(Pn,Kd),e(ht,Yd),e(ht,An),e(An,ei),e(ht,ti),h(o,Na,p),h(o,pt,p),e(pt,Nt),e(Nt,$s),T(vo,$s,null),e(pt,oi),e(pt,xs),e(xs,ni),h(o,ja,p),h(o,P,p),T(ko,P,null),e(P,si),e(P,Ms),e(Ms,ai),e(P,ri),e(P,jt),e(jt,Nn),e(Nn,di),e(jt,ii),e(jt,jn),e(jn,li),e(jt,ci),e(P,hi),e(P,bo),e(bo,pi),e(bo,In),e(In,ui),e(bo,mi),e(P,fi),e(P,We),T(wo,We,null),e(We,_i),e(We,Ss),e(Ss,gi),e(We,Ti),e(We,yo),e(yo,Bn),e(Bn,vi),e(Bn,Cs),e(Cs,ki),e(yo,bi),e(yo,Gn),e(Gn,wi),e(Gn,Os),e(Os,yi),e(P,Ei),e(P,It),T(Eo,It,null),e(It,Li),e(It,Lo),e(Lo,qi),e(Lo,Ps),e(Ps,Di),e(Lo,zi),e(P,Fi),e(P,Bt),T(qo,Bt,null),e(Bt,$i),e(Bt,As),e(As,xi),e(P,Mi),e(P,Ns),h(o,Ia,p),h(o,ut,p),e(ut,Gt),e(Gt,js),T(Do,js,null),e(ut,Si),e(ut,Is),e(Is,Ci),h(o,Ba,p),h(o,qe,p),T(zo,qe,null),e(qe,Oi),e(qe,Fo),e(Fo,Pi),e(Fo,Bs),e(Bs,Ai),e(Fo,Ni),e(qe,ji),e(qe,Qt),e(Qt,Qn),e(Qn,Ii),e(Qt,Bi),e(Qt,Hn),e(Hn,Gi),e(Qt,Qi),e(qe,Hi),e(qe,$o),e($o,Ri),e($o,Rn),e(Rn,Wi),e($o,Ui),h(o,Ga,p),h(o,mt,p),e(mt,Ht),e(Ht,Gs),T(xo,Gs,null),e(mt,Vi),e(mt,Qs),e(Qs,Xi),h(o,Qa,p),h(o,ft,p),T(Mo,ft,null),e(ft,Ji),e(ft,Hs),e(Hs,Zi),h(o,Ha,p),h(o,_t,p),T(So,_t,null),e(_t,Ki),e(_t,Rs),e(Rs,Yi),h(o,Ra,p),h(o,gt,p),T(Co,gt,null),e(gt,el),e(gt,Ws),e(Ws,tl),h(o,Wa,p),h(o,Tt,p),T(Oo,Tt,null),e(Tt,ol),e(Tt,Us),e(Us,nl),h(o,Ua,p),h(o,vt,p),T(Po,vt,null),e(vt,sl),e(vt,Vs),e(Vs,al),h(o,Va,p),h(o,kt,p),T(Ao,kt,null),e(kt,rl),e(kt,Xs),e(Xs,dl),h(o,Xa,p),h(o,bt,p),T(No,bt,null),e(bt,il),e(bt,Js),e(Js,ll),h(o,Ja,p),h(o,wt,p),T(jo,wt,null),e(wt,cl),e(wt,Zs),e(Zs,hl),h(o,Za,p),h(o,yt,p),e(yt,Rt),e(Rt,Ks),T(Io,Ks,null),e(yt,pl),e(yt,Ys),e(Ys,ul),h(o,Ka,p),h(o,De,p),T(Bo,De,null),e(De,ml),e(De,Go),e(Go,fl),e(Go,Wn),e(Wn,_l),e(Go,gl),e(De,Tl),e(De,Qo),e(Qo,vl),e(Qo,Ho),e(Ho,kl),e(Qo,bl),e(De,wl),e(De,fe),T(Ro,fe,null),e(fe,yl),e(fe,Et),e(Et,El),e(Et,Un),e(Un,Ll),e(Et,ql),e(Et,ea),e(ea,Dl),e(Et,zl),e(fe,Fl),T(Wt,fe,null),e(fe,$l),e(fe,ta),e(ta,xl),e(fe,Ml),T(Wo,fe,null),h(o,Ya,p),h(o,Lt,p),e(Lt,Ut),e(Ut,oa),T(Uo,oa,null),e(Lt,Sl),e(Lt,na),e(na,Cl),h(o,er,p),h(o,ze,p),T(Vo,ze,null),e(ze,Ol),e(ze,Xo),e(Xo,Pl),e(Xo,Vn),e(Vn,Al),e(Xo,Nl),e(ze,jl),e(ze,Jo),e(Jo,Il),e(Jo,Zo),e(Zo,Bl),e(Jo,Gl),e(ze,Ql),e(ze,G),T(Ko,G,null),e(G,Hl),e(G,qt),e(qt,Rl),e(qt,Xn),e(Xn,Wl),e(qt,Ul),e(qt,sa),e(sa,Vl),e(qt,Xl),e(G,Jl),T(Vt,G,null),e(G,Zl),e(G,aa),e(aa,Kl),e(G,Yl),T(Yo,G,null),e(G,ec),e(G,ra),e(ra,tc),e(G,oc),T(en,G,null),h(o,tr,p),h(o,Dt,p),e(Dt,Xt),e(Xt,da),T(tn,da,null),e(Dt,nc),e(Dt,ia),e(ia,sc),h(o,or,p),h(o,de,p),T(on,de,null),e(de,ac),e(de,la),e(la,rc),e(de,dc),e(de,nn),e(nn,ic),e(nn,Jn),e(Jn,lc),e(nn,cc),e(de,hc),e(de,sn),e(sn,pc),e(sn,an),e(an,uc),e(sn,mc),e(de,fc),e(de,Q),T(rn,Q,null),e(Q,_c),e(Q,zt),e(zt,gc),e(zt,Zn),e(Zn,Tc),e(zt,vc),e(zt,ca),e(ca,kc),e(zt,bc),e(Q,wc),T(Jt,Q,null),e(Q,yc),e(Q,ha),e(ha,Ec),e(Q,Lc),T(dn,Q,null),e(Q,qc),e(Q,pa),e(pa,Dc),e(Q,zc),T(ln,Q,null),h(o,nr,p),h(o,Ft,p),e(Ft,Zt),e(Zt,ua),T(cn,ua,null),e(Ft,Fc),e(Ft,ma),e(ma,$c),h(o,sr,p),h(o,ie,p),T(hn,ie,null),e(ie,xc),e(ie,$t),e($t,Mc),e($t,fa),e(fa,Sc),e($t,Cc),e($t,_a),e(_a,Oc),e($t,Pc),e(ie,Ac),e(ie,pn),e(pn,Nc),e(pn,Kn),e(Kn,jc),e(pn,Ic),e(ie,Bc),e(ie,un),e(un,Gc),e(un,mn),e(mn,Qc),e(un,Hc),e(ie,Rc),e(ie,_e),T(fn,_e,null),e(_e,Wc),e(_e,xt),e(xt,Uc),e(xt,Yn),e(Yn,Vc),e(xt,Xc),e(xt,ga),e(ga,Jc),e(xt,Zc),e(_e,Kc),T(Kt,_e,null),e(_e,Yc),e(_e,Ta),e(Ta,eh),e(_e,th),T(_n,_e,null),h(o,ar,p),h(o,Mt,p),e(Mt,Yt),e(Yt,va),T(gn,va,null),e(Mt,oh),e(Mt,ka),e(ka,nh),h(o,rr,p),h(o,le,p),T(Tn,le,null),e(le,sh),e(le,vn),e(vn,ah),e(vn,es),e(es,rh),e(vn,dh),e(le,ih),e(le,kn),e(kn,lh),e(kn,bn),e(bn,ch),e(kn,hh),e(le,ph),T(eo,le,null),e(le,uh),e(le,ge),T(wn,ge,null),e(ge,mh),e(ge,St),e(St,fh),e(St,ts),e(ts,_h),e(St,gh),e(St,ba),e(ba,Th),e(St,vh),e(ge,kh),T(to,ge,null),e(ge,bh),e(ge,wa),e(wa,wh),e(ge,yh),T(yn,ge,null),h(o,dr,p),h(o,Ct,p),e(Ct,oo),e(oo,ya),T(En,ya,null),e(Ct,Eh),e(Ct,Ea),e(Ea,Lh),h(o,ir,p),h(o,ce,p),T(Ln,ce,null),e(ce,qh),e(ce,qn),e(qn,Dh),e(qn,os),e(os,zh),e(qn,Fh),e(ce,$h),e(ce,Dn),e(Dn,xh),e(Dn,zn),e(zn,Mh),e(Dn,Sh),e(ce,Ch),T(no,ce,null),e(ce,Oh),e(ce,Te),T(Fn,Te,null),e(Te,Ph),e(Te,Ot),e(Ot,Ah),e(Ot,ns),e(ns,Nh),e(Ot,jh),e(Ot,La),e(La,Ih),e(Ot,Bh),e(Te,Gh),T(so,Te,null),e(Te,Qh),e(Te,qa),e(qa,Hh),e(Te,Rh),T($n,Te,null),lr=!0},p(o,[p]){const xn={};p&2&&(xn.$$scope={dirty:p,ctx:o}),Wt.$set(xn);const Da={};p&2&&(Da.$$scope={dirty:p,ctx:o}),Vt.$set(Da);const za={};p&2&&(za.$$scope={dirty:p,ctx:o}),Jt.$set(za);const Fa={};p&2&&(Fa.$$scope={dirty:p,ctx:o}),Kt.$set(Fa);const Mn={};p&2&&(Mn.$$scope={dirty:p,ctx:o}),eo.$set(Mn);const $a={};p&2&&($a.$$scope={dirty:p,ctx:o}),to.$set($a);const xa={};p&2&&(xa.$$scope={dirty:p,ctx:o}),no.$set(xa);const Ma={};p&2&&(Ma.$$scope={dirty:p,ctx:o}),so.$set(Ma)},i(o){lr||(v(E.$$.fragment,o),v(Y.$$.fragment,o),v(_o.$$.fragment,o),v(go.$$.fragment,o),v(vo.$$.fragment,o),v(ko.$$.fragment,o),v(wo.$$.fragment,o),v(Eo.$$.fragment,o),v(qo.$$.fragment,o),v(Do.$$.fragment,o),v(zo.$$.fragment,o),v(xo.$$.fragment,o),v(Mo.$$.fragment,o),v(So.$$.fragment,o),v(Co.$$.fragment,o),v(Oo.$$.fragment,o),v(Po.$$.fragment,o),v(Ao.$$.fragment,o),v(No.$$.fragment,o),v(jo.$$.fragment,o),v(Io.$$.fragment,o),v(Bo.$$.fragment,o),v(Ro.$$.fragment,o),v(Wt.$$.fragment,o),v(Wo.$$.fragment,o),v(Uo.$$.fragment,o),v(Vo.$$.fragment,o),v(Ko.$$.fragment,o),v(Vt.$$.fragment,o),v(Yo.$$.fragment,o),v(en.$$.fragment,o),v(tn.$$.fragment,o),v(on.$$.fragment,o),v(rn.$$.fragment,o),v(Jt.$$.fragment,o),v(dn.$$.fragment,o),v(ln.$$.fragment,o),v(cn.$$.fragment,o),v(hn.$$.fragment,o),v(fn.$$.fragment,o),v(Kt.$$.fragment,o),v(_n.$$.fragment,o),v(gn.$$.fragment,o),v(Tn.$$.fragment,o),v(eo.$$.fragment,o),v(wn.$$.fragment,o),v(to.$$.fragment,o),v(yn.$$.fragment,o),v(En.$$.fragment,o),v(Ln.$$.fragment,o),v(no.$$.fragment,o),v(Fn.$$.fragment,o),v(so.$$.fragment,o),v($n.$$.fragment,o),lr=!0)},o(o){k(E.$$.fragment,o),k(Y.$$.fragment,o),k(_o.$$.fragment,o),k(go.$$.fragment,o),k(vo.$$.fragment,o),k(ko.$$.fragment,o),k(wo.$$.fragment,o),k(Eo.$$.fragment,o),k(qo.$$.fragment,o),k(Do.$$.fragment,o),k(zo.$$.fragment,o),k(xo.$$.fragment,o),k(Mo.$$.fragment,o),k(So.$$.fragment,o),k(Co.$$.fragment,o),k(Oo.$$.fragment,o),k(Po.$$.fragment,o),k(Ao.$$.fragment,o),k(No.$$.fragment,o),k(jo.$$.fragment,o),k(Io.$$.fragment,o),k(Bo.$$.fragment,o),k(Ro.$$.fragment,o),k(Wt.$$.fragment,o),k(Wo.$$.fragment,o),k(Uo.$$.fragment,o),k(Vo.$$.fragment,o),k(Ko.$$.fragment,o),k(Vt.$$.fragment,o),k(Yo.$$.fragment,o),k(en.$$.fragment,o),k(tn.$$.fragment,o),k(on.$$.fragment,o),k(rn.$$.fragment,o),k(Jt.$$.fragment,o),k(dn.$$.fragment,o),k(ln.$$.fragment,o),k(cn.$$.fragment,o),k(hn.$$.fragment,o),k(fn.$$.fragment,o),k(Kt.$$.fragment,o),k(_n.$$.fragment,o),k(gn.$$.fragment,o),k(Tn.$$.fragment,o),k(eo.$$.fragment,o),k(wn.$$.fragment,o),k(to.$$.fragment,o),k(yn.$$.fragment,o),k(En.$$.fragment,o),k(Ln.$$.fragment,o),k(no.$$.fragment,o),k(Fn.$$.fragment,o),k(so.$$.fragment,o),k($n.$$.fragment,o),lr=!1},d(o){t(u),o&&t(q),o&&t(f),b(E),o&&t(pe),o&&t(z),b(Y),o&&t(Fe),o&&t(I),o&&t(O),o&&t(ue),o&&t($e),o&&t(me),o&&t(xe),o&&t(C),o&&t(Z),o&&t($),o&&t(Oa),o&&t(Pt),o&&t(Pa),o&&t(lt),b(_o),o&&t(Aa),o&&t(Re),b(go),o&&t(Na),o&&t(pt),b(vo),o&&t(ja),o&&t(P),b(ko),b(wo),b(Eo),b(qo),o&&t(Ia),o&&t(ut),b(Do),o&&t(Ba),o&&t(qe),b(zo),o&&t(Ga),o&&t(mt),b(xo),o&&t(Qa),o&&t(ft),b(Mo),o&&t(Ha),o&&t(_t),b(So),o&&t(Ra),o&&t(gt),b(Co),o&&t(Wa),o&&t(Tt),b(Oo),o&&t(Ua),o&&t(vt),b(Po),o&&t(Va),o&&t(kt),b(Ao),o&&t(Xa),o&&t(bt),b(No),o&&t(Ja),o&&t(wt),b(jo),o&&t(Za),o&&t(yt),b(Io),o&&t(Ka),o&&t(De),b(Bo),b(Ro),b(Wt),b(Wo),o&&t(Ya),o&&t(Lt),b(Uo),o&&t(er),o&&t(ze),b(Vo),b(Ko),b(Vt),b(Yo),b(en),o&&t(tr),o&&t(Dt),b(tn),o&&t(or),o&&t(de),b(on),b(rn),b(Jt),b(dn),b(ln),o&&t(nr),o&&t(Ft),b(cn),o&&t(sr),o&&t(ie),b(hn),b(fn),b(Kt),b(_n),o&&t(ar),o&&t(Mt),b(gn),o&&t(rr),o&&t(le),b(Tn),b(eo),b(wn),b(to),b(yn),o&&t(dr),o&&t(Ct),b(En),o&&t(ir),o&&t(ce),b(Ln),b(no),b(Fn),b(so),b($n)}}}const Tm={local:"led",sections:[{local:"overview",title:"Overview"},{local:"transformers.LEDConfig",title:"LEDConfig"},{local:"transformers.LEDTokenizer",title:"LEDTokenizer"},{local:"transformers.LEDTokenizerFast",title:"LEDTokenizerFast"},{local:"transformers.models.led.modeling_led.LEDEncoderBaseModelOutput",title:"LED specific outputs"},{local:"transformers.LEDModel",title:"LEDModel"},{local:"transformers.LEDForConditionalGeneration",title:"LEDForConditionalGeneration"},{local:"transformers.LEDForSequenceClassification",title:"LEDForSequenceClassification"},{local:"transformers.LEDForQuestionAnswering",title:"LEDForQuestionAnswering"},{local:"transformers.TFLEDModel",title:"TFLEDModel"},{local:"transformers.TFLEDForConditionalGeneration",title:"TFLEDForConditionalGeneration"}],title:"LED"};function vm(N,u,q){let{fw:f}=u;return N.$$set=w=>{"fw"in w&&q(0,f=w.fw)},[f]}class qm extends am{constructor(u){super();rm(this,u,vm,gm,dm,{fw:0})}}export{qm as default,Tm as metadata};
