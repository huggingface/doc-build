import{S as Bd,i as Rd,s as Hd,e as r,k as c,w as M,t as o,L as Jd,c as a,d as n,m as i,a as s,x as $,h as t,b as l,J as e,g as E,y as x,q as C,o as P,B as j}from"../../../chunks/vendor-e859c359.js";import{T as Ud}from"../../../chunks/Tip-edc75249.js";import{D as _o}from"../../../chunks/Docstring-ade913b3.js";import{C as vs}from"../../../chunks/CodeBlock-ce4317c2.js";import{I as Es}from"../../../chunks/IconCopyLink-5fae3b20.js";import"../../../chunks/CopyButton-77addb3d.js";function Gd(vo){let g,N,v,b,U;return{c(){g=r("p"),N=o(`Although the recipe for forward pass needs to be defined within this function, one should call the
...
processing steps while the latter silently ignores them.`),W.forEach(n)},m(D,W){E(D,g,W),e(g,N),e(g,v),e(v,b),e(g,U)},d(D){D&&n(g)}}}function Yd(vo){let g,N,v,b,U,D,W,de,It,Et,T,Ft,Ve,Ot,Nt,Eo,Wt,Vt,Be,Bt,Rt,Re,Ht,Jt,bt,V,Ut,bo,Gt,Yt,Ee,Zt,Kt,wt,B,Qt,He,Xt,en,Je,on,tn,yt,G,ce,wo,be,nn,yo,rn,Tt,_,we,an,ie,Ue,sn,dn,Ge,cn,ln,hn,Y,pn,Ye,mn,fn,Ze,un,gn,_n,To,vn,En,ye,bn,le,Te,wn,ke,yn,Ke,Tn,kn,Sn,he,Se,Dn,Z,Mn,ko,$n,xn,So,Cn,Pn,kt,K,pe,Do,De,jn,Mo,zn,St,m,Me,qn,Q,An,$o,Ln,In,xo,Fn,On,Nn,$e,Wn,xe,Vn,Bn,Rn,Ce,Hn,Pe,Jn,Un,Gn,Co,Yn,Zn,je,Kn,Qe,Qn,Xn,er,ze,or,qe,tr,nr,rr,R,Xe,ar,sr,Po,dr,cr,jo,ir,lr,hr,k,Ae,pr,X,mr,eo,fr,ur,zo,gr,_r,vr,me,Er,qo,br,wr,Le,yr,h,Ie,Tr,Ao,kr,Sr,ee,Dr,Lo,Mr,$r,Io,xr,Cr,Pr,oe,jr,Fo,zr,qr,Oo,Ar,Lr,Ir,te,A,Fr,No,Or,Nr,Wo,Wr,Vr,Vo,Br,Rr,Hr,L,Jr,Bo,Ur,Gr,oo,Yr,Zr,Ro,Kr,Qr,Xr,w,ea,Ho,oa,ta,Jo,na,ra,Uo,aa,sa,Go,da,ca,Yo,ia,la,ha,I,pa,Zo,ma,fa,Ko,ua,ga,Qo,_a,va,Ea,ne,F,ba,Xo,wa,ya,et,Ta,ka,ot,Sa,Da,Ma,O,$a,tt,xa,Ca,to,Pa,ja,nt,za,qa,Aa,y,La,rt,Ia,Fa,at,Oa,Na,st,Wa,Va,dt,Ba,Ra,ct,Ha,Ja,Ua,re,Ga,it,Ya,Za,lt,Ka,Qa,Xa,ae,es,ht,os,ts,pt,ns,rs,as,se,mt,ss,ds,ft,cs,is,ut,ls,hs,Fe,ps,gt,ms,fs,us,_t,gs,_s,Oe,Dt;return D=new Es({}),be=new Es({}),we=new _o({props:{name:"class transformers.SpeechEncoderDecoderConfig",anchor:"transformers.SpeechEncoderDecoderConfig",parameters:[{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/master/src/transformers/models/speech_encoder_decoder/configuration_speech_encoder_decoder.py#L27",parametersDescription:[{anchor:"transformers.SpeechEncoderDecoderConfig.kwargs",description:`<strong>kwargs</strong> (<em>optional</em>) &#x2014;
...
<span class="hljs-meta">&gt;&gt;&gt; </span>model = SpeechEncoderDecoderModel.from_pretrained(<span class="hljs-string">&#x27;my-model&#x27;</span>, config=encoder_decoder_config)`}}),Te=new _o({props:{name:"from\\_encoder\\_decoder\\_configs",anchor:"transformers.SpeechEncoderDecoderConfig.from_encoder_decoder_configs",parameters:[{name:"encoder_config",val:": PretrainedConfig"},{name:"decoder_config",val:": PretrainedConfig"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/master/src/transformers/models/speech_encoder_decoder/configuration_speech_encoder_decoder.py#L91",returnDescription:`
...
`}}),Se=new _o({props:{name:"to\\_dict",anchor:"transformers.SpeechEncoderDecoderConfig.to_dict",parameters:[],source:"https://github.com/huggingface/transformers/blob/master/src/transformers/models/speech_encoder_decoder/configuration_speech_encoder_decoder.py#L108",returnDescription:`
...
`}}),me=new Ud({props:{$$slots:{default:[Gd]},$$scope:{ctx:vo}}}),Le=new vs({props:{code:`from transformers import SpeechEncoderDecoderModel, Speech2Text2Processor
...
a user or organization name, like `),Vo=a(fe,"CODE",{});var hd=s(Vo);Br=t(hd,"dbmdz/bert-base-german-cased"),hd.forEach(n),Rr=t(fe,"."),fe.forEach(n),Hr=i(po),L=a(po,"LI",{});var ue=s(L);Jr=t(ue,"A path to a "),Bo=a(ue,"EM",{});var pd=s(Bo);Ur=t(pd,"directory"),pd.forEach(n),Gr=t(ue,` containing model weights saved using
...
a PyTorch model using the provided conversion scripts and loading the PyTorch model afterwards.`),q.forEach(n),mo.forEach(n),Ua=i(p),re=a(p,"P",{});var fo=s(re);Ga=t(fo,"model"),it=a(fo,"EM",{});var qd=s(it);Ya=t(qd,"args (remaining positional arguments, _optional"),qd.forEach(n),Za=t(fo,`):
