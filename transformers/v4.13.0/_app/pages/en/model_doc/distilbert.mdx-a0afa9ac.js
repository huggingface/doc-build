import{S as ry,i as ay,s as iy,e as o,k as l,w as b,t as a,L as ly,c as n,d as t,m as d,a as r,x as k,h as i,b as c,J as e,g as u,y as w,q as $,o as D,B as F}from"../../../chunks/vendor-e859c359.js";import{T as fe}from"../../../chunks/Tip-edc75249.js";import{D as U}from"../../../chunks/Docstring-ade913b3.js";import{C as ye}from"../../../chunks/CodeBlock-ce4317c2.js";import{I as ve}from"../../../chunks/IconCopyLink-5fae3b20.js";import"../../../chunks/CopyButton-77addb3d.js";function dy(C){let h,y,g,v,T;return{c(){h=o("p"),y=a(`Although the recipe for forward pass needs to be defined within this function, one should call the
...
`),H=n(ne,"CODE",{});var Fe=r(H);le=i(Fe,'model({"input_ids": input_ids})'),Fe.forEach(t),ne.forEach(t),j.forEach(t)},m(p,M){u(p,h,M),e(h,y),u(p,g,M),u(p,v,M),e(v,T),e(T,_),e(v,m),e(v,B),e(B,de),u(p,J,M),u(p,E,M),e(E,G),e(E,N),e(N,X),e(E,ce),e(E,O),e(O,he),e(E,re),u(p,L,M),u(p,q,M),e(q,Y),u(p,V,M),u(p,x,M),e(x,z),e(z,pe),e(z,W),e(W,se),e(z,ue),e(z,R),e(R,ae),e(x,ee),e(x,A),e(A,ie),e(A,S),e(S,oe),e(x,me),e(x,P),e(P,te),e(P,H),e(H,le)},d(p){p&&t(h),p&&t(g),p&&t(v),p&&t(J),p&&t(E),p&&t(L),p&&t(q),p&&t(V),p&&t(x)}}}function gy(C){let h,y,g,v,T;return{c(){h=o("p"),y=a(`Although the recipe for forward pass needs to be defined within this function, one should call the
`),g=o("code"),v=a("Module"),T=a(` instance afterwards instead of this since the former takes care of running the pre and post
processing steps while the latter silently ignores them.`)},l(_){h=n(_,"P",{});var m=r(h);y=i(m,`Although the recipe for forward pass needs to be defined within this function, one should call the
`),g=n(m,"CODE",{});var B=r(g);v=i(B,"Module"),B.forEach(t),T=i(m,` instance afterwards instead of this since the former takes care of running the pre and post
processing steps while the latter silently ignores them.`),m.forEach(t)},m(_,m){u(_,h,m),e(h,y),e(h,g),e(g,v),e(h,T)},d(_){_&&t(h)}}}function _y(C){let h,y,g,v,T,_,m,B,de,J,E,G,N,X,ce,O,he,re,L,q,Y,V,x,z,pe,W,se,ue,R,ae,ee,A,ie,S,oe,me,P,te,H,le;return{c(){h=o("p"),y=a("TF 2.0 models accepts two formats as inputs:"),g=l(),v=o("ul"),T=o("li"),_=a("having all inputs as keyword arguments (like PyTorch models), or"),m=l(),B=o("li"),de=a("having all inputs as a list, tuple or dict in the first positional arguments."),J=l(),E=o("p"),G=a("This second option is useful when using "),N=o("code"),X=a("tf.keras.Model.fit"),ce=a(` method which currently requires having all
the tensors in the first argument of the model call function: `),O=o("code"),he=a("model(inputs)"),re=a("."),L=l(),q=o("p"),Y=a(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in
the first positional argument :`),V=l(),x=o("ul"),z=o("li"),pe=a("a single Tensor with "),W=o("code"),se=a("input_ids"),ue=a(" only and nothing else: "),R=o("code"),ae=a("model(inputs_ids)"),ee=l(),A=o("li"),ie=a(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),S=o("code"),oe=a("model([input_ids, attention_mask])"),me=l(),P=o("li"),te=a(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),H=o("code"),le=a('model({"input_ids": input_ids})')},l(p){h=n(p,"P",{});var M=r(h);y=i(M,"TF 2.0 models accepts two formats as inputs:"),M.forEach(t),g=d(p),v=n(p,"UL",{});var K=r(v);T=n(K,"LI",{});var ge=r(T);_=i(ge,"having all inputs as keyword arguments (like PyTorch models), or"),ge.forEach(t),m=d(K),B=n(K,"LI",{});var Te=r(B);de=i(Te,"having all inputs as a list, tuple or dict in the first positional arguments."),Te.forEach(t),K.forEach(t),J=d(p),E=n(p,"P",{});var I=r(E);G=i(I,"This second option is useful when using "),N=n(I,"CODE",{});var _e=r(N);X=i(_e,"tf.keras.Model.fit"),_e.forEach(t),ce=i(I,` method which currently requires having all
...
the first positional argument :`),ke.forEach(t),V=d(p),x=n(p,"UL",{});var j=r(x);z=n(j,"LI",{});var Q=r(z);pe=i(Q,"a single Tensor with "),W=n(Q,"CODE",{});var we=r(W);se=i(we,"input_ids"),we.forEach(t),ue=i(Q," only and nothing else: "),R=n(Q,"CODE",{});var $e=r(R);ae=i($e,"model(inputs_ids)"),$e.forEach(t),Q.forEach(t),ee=d(j),A=n(j,"LI",{});var Z=r(A);ie=i(Z,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),S=n(Z,"CODE",{});var De=r(S);oe=i(De,"model([input_ids, attention_mask])"),De.forEach(t),Z.forEach(t),me=d(j),P=n(j,"LI",{});var ne=r(P);te=i(ne,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),H=n(ne,"CODE",{});var Fe=r(H);le=i(Fe,'model({"input_ids": input_ids})'),Fe.forEach(t),ne.forEach(t),j.forEach(t)},m(p,M){u(p,h,M),e(h,y),u(p,g,M),u(p,v,M),e(v,T),e(T,_),e(v,m),e(v,B),e(B,de),u(p,J,M),u(p,E,M),e(E,G),e(E,N),e(N,X),e(E,ce),e(E,O),e(O,he),e(E,re),u(p,L,M),u(p,q,M),e(q,Y),u(p,V,M),u(p,x,M),e(x,z),e(z,pe),e(z,W),e(W,se),e(z,ue),e(z,R),e(R,ae),e(x,ee),e(x,A),e(A,ie),e(A,S),e(S,oe),e(x,me),e(x,P),e(P,te),e(P,H),e(H,le)},d(p){p&&t(h),p&&t(g),p&&t(v),p&&t(J),p&&t(E),p&&t(L),p&&t(q),p&&t(V),p&&t(x)}}}function vy(C){let h,y,g,v,T;return{c(){h=o("p"),y=a(`Although the recipe for forward pass needs to be defined within this function, one should call the
`),g=o("code"),v=a("Module"),T=a(` instance afterwards instead of this since the former takes care of running the pre and post
processing steps while the latter silently ignores them.`)},l(_){h=n(_,"P",{});var m=r(h);y=i(m,`Although the recipe for forward pass needs to be defined within this function, one should call the
`),g=n(m,"CODE",{});var B=r(g);v=i(B,"Module"),B.forEach(t),T=i(m,` instance afterwards instead of this since the former takes care of running the pre and post
processing steps while the latter silently ignores them.`),m.forEach(t)},m(_,m){u(_,h,m),e(h,y),e(h,g),e(g,v),e(h,T)},d(_){_&&t(h)}}}function Ty(C){let h,y,g,v,T,_,m,B,de,J,E,G,N,X,ce,O,he,re,L,q,Y,V,x,z,pe,W,se,ue,R,ae,ee,A,ie,S,oe,me,P,te,H,le;return{c(){h=o("p"),y=a("TF 2.0 models accepts two formats as inputs:"),g=l(),v=o("ul"),T=o("li"),_=a("having all inputs as keyword arguments (like PyTorch models), or"),m=l(),B=o("li"),de=a("having all inputs as a list, tuple or dict in the first positional arguments."),J=l(),E=o("p"),G=a("This second option is useful when using "),N=o("code"),X=a("tf.keras.Model.fit"),ce=a(` method which currently requires having all
the tensors in the first argument of the model call function: `),O=o("code"),he=a("model(inputs)"),re=a("."),L=l(),q=o("p"),Y=a(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in
the first positional argument :`),V=l(),x=o("ul"),z=o("li"),pe=a("a single Tensor with "),W=o("code"),se=a("input_ids"),ue=a(" only and nothing else: "),R=o("code"),ae=a("model(inputs_ids)"),ee=l(),A=o("li"),ie=a(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),S=o("code"),oe=a("model([input_ids, attention_mask])"),me=l(),P=o("li"),te=a(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),H=o("code"),le=a('model({"input_ids": input_ids})')},l(p){h=n(p,"P",{});var M=r(h);y=i(M,"TF 2.0 models accepts two formats as inputs:"),M.forEach(t),g=d(p),v=n(p,"UL",{});var K=r(v);T=n(K,"LI",{});var ge=r(T);_=i(ge,"having all inputs as keyword arguments (like PyTorch models), or"),ge.forEach(t),m=d(K),B=n(K,"LI",{});var Te=r(B);de=i(Te,"having all inputs as a list, tuple or dict in the first positional arguments."),Te.forEach(t),K.forEach(t),J=d(p),E=n(p,"P",{});var I=r(E);G=i(I,"This second option is useful when using "),N=n(I,"CODE",{});var _e=r(N);X=i(_e,"tf.keras.Model.fit"),_e.forEach(t),ce=i(I,` method which currently requires having all
...
the first positional argument :`),ke.forEach(t),V=d(p),x=n(p,"UL",{});var j=r(x);z=n(j,"LI",{});var Q=r(z);pe=i(Q,"a single Tensor with "),W=n(Q,"CODE",{});var we=r(W);se=i(we,"input_ids"),we.forEach(t),ue=i(Q," only and nothing else: "),R=n(Q,"CODE",{});var $e=r(R);ae=i($e,"model(inputs_ids)"),$e.forEach(t),Q.forEach(t),ee=d(j),A=n(j,"LI",{});var Z=r(A);ie=i(Z,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),S=n(Z,"CODE",{});var De=r(S);oe=i(De,"model([input_ids, attention_mask])"),De.forEach(t),Z.forEach(t),me=d(j),P=n(j,"LI",{});var ne=r(P);te=i(ne,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),H=n(ne,"CODE",{});var Fe=r(H);le=i(Fe,'model({"input_ids": input_ids})'),Fe.forEach(t),ne.forEach(t),j.forEach(t)},m(p,M){u(p,h,M),e(h,y),u(p,g,M),u(p,v,M),e(v,T),e(T,_),e(v,m),e(v,B),e(B,de),u(p,J,M),u(p,E,M),e(E,G),e(E,N),e(N,X),e(E,ce),e(E,O),e(O,he),e(E,re),u(p,L,M),u(p,q,M),e(q,Y),u(p,V,M),u(p,x,M),e(x,z),e(z,pe),e(z,W),e(W,se),e(z,ue),e(z,R),e(R,ae),e(x,ee),e(x,A),e(A,ie),e(A,S),e(S,oe),e(x,me),e(x,P),e(P,te),e(P,H),e(H,le)},d(p){p&&t(h),p&&t(g),p&&t(v),p&&t(J),p&&t(E),p&&t(L),p&&t(q),p&&t(V),p&&t(x)}}}function by(C){let h,y,g,v,T;return{c(){h=o("p"),y=a(`Although the recipe for forward pass needs to be defined within this function, one should call the
`),g=o("code"),v=a("Module"),T=a(` instance afterwards instead of this since the former takes care of running the pre and post
processing steps while the latter silently ignores them.`)},l(_){h=n(_,"P",{});var m=r(h);y=i(m,`Although the recipe for forward pass needs to be defined within this function, one should call the
`),g=n(m,"CODE",{});var B=r(g);v=i(B,"Module"),B.forEach(t),T=i(m,` instance afterwards instead of this since the former takes care of running the pre and post
processing steps while the latter silently ignores them.`),m.forEach(t)},m(_,m){u(_,h,m),e(h,y),e(h,g),e(g,v),e(h,T)},d(_){_&&t(h)}}}function ky(C){let h,y,g,v,T,_,m,B,de,J,E,G,N,X,ce,O,he,re,L,q,Y,V,x,z,pe,W,se,ue,R,ae,ee,A,ie,S,oe,me,P,te,H,le;return{c(){h=o("p"),y=a("TF 2.0 models accepts two formats as inputs:"),g=l(),v=o("ul"),T=o("li"),_=a("having all inputs as keyword arguments (like PyTorch models), or"),m=l(),B=o("li"),de=a("having all inputs as a list, tuple or dict in the first positional arguments."),J=l(),E=o("p"),G=a("This second option is useful when using "),N=o("code"),X=a("tf.keras.Model.fit"),ce=a(` method which currently requires having all
the tensors in the first argument of the model call function: `),O=o("code"),he=a("model(inputs)"),re=a("."),L=l(),q=o("p"),Y=a(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in
the first positional argument :`),V=l(),x=o("ul"),z=o("li"),pe=a("a single Tensor with "),W=o("code"),se=a("input_ids"),ue=a(" only and nothing else: "),R=o("code"),ae=a("model(inputs_ids)"),ee=l(),A=o("li"),ie=a(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),S=o("code"),oe=a("model([input_ids, attention_mask])"),me=l(),P=o("li"),te=a(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),H=o("code"),le=a('model({"input_ids": input_ids})')},l(p){h=n(p,"P",{});var M=r(h);y=i(M,"TF 2.0 models accepts two formats as inputs:"),M.forEach(t),g=d(p),v=n(p,"UL",{});var K=r(v);T=n(K,"LI",{});var ge=r(T);_=i(ge,"having all inputs as keyword arguments (like PyTorch models), or"),ge.forEach(t),m=d(K),B=n(K,"LI",{});var Te=r(B);de=i(Te,"having all inputs as a list, tuple or dict in the first positional arguments."),Te.forEach(t),K.forEach(t),J=d(p),E=n(p,"P",{});var I=r(E);G=i(I,"This second option is useful when using "),N=n(I,"CODE",{});var _e=r(N);X=i(_e,"tf.keras.Model.fit"),_e.forEach(t),ce=i(I,` method which currently requires having all
...
the first positional argument :`),ke.forEach(t),V=d(p),x=n(p,"UL",{});var j=r(x);z=n(j,"LI",{});var Q=r(z);pe=i(Q,"a single Tensor with "),W=n(Q,"CODE",{});var we=r(W);se=i(we,"input_ids"),we.forEach(t),ue=i(Q," only and nothing else: "),R=n(Q,"CODE",{});var $e=r(R);ae=i($e,"model(inputs_ids)"),$e.forEach(t),Q.forEach(t),ee=d(j),A=n(j,"LI",{});var Z=r(A);ie=i(Z,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),S=n(Z,"CODE",{});var De=r(S);oe=i(De,"model([input_ids, attention_mask])"),De.forEach(t),Z.forEach(t),me=d(j),P=n(j,"LI",{});var ne=r(P);te=i(ne,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),H=n(ne,"CODE",{});var Fe=r(H);le=i(Fe,'model({"input_ids": input_ids})'),Fe.forEach(t),ne.forEach(t),j.forEach(t)},m(p,M){u(p,h,M),e(h,y),u(p,g,M),u(p,v,M),e(v,T),e(T,_),e(v,m),e(v,B),e(B,de),u(p,J,M),u(p,E,M),e(E,G),e(E,N),e(N,X),e(E,ce),e(E,O),e(O,he),e(E,re),u(p,L,M),u(p,q,M),e(q,Y),u(p,V,M),u(p,x,M),e(x,z),e(z,pe),e(z,W),e(W,se),e(z,ue),e(z,R),e(R,ae),e(x,ee),e(x,A),e(A,ie),e(A,S),e(S,oe),e(x,me),e(x,P),e(P,te),e(P,H),e(H,le)},d(p){p&&t(h),p&&t(g),p&&t(v),p&&t(J),p&&t(E),p&&t(L),p&&t(q),p&&t(V),p&&t(x)}}}function wy(C){let h,y,g,v,T;return{c(){h=o("p"),y=a(`Although the recipe for forward pass needs to be defined within this function, one should call the
`),g=o("code"),v=a("Module"),T=a(` instance afterwards instead of this since the former takes care of running the pre and post
processing steps while the latter silently ignores them.`)},l(_){h=n(_,"P",{});var m=r(h);y=i(m,`Although the recipe for forward pass needs to be defined within this function, one should call the
`),g=n(m,"CODE",{});var B=r(g);v=i(B,"Module"),B.forEach(t),T=i(m,` instance afterwards instead of this since the former takes care of running the pre and post
processing steps while the latter silently ignores them.`),m.forEach(t)},m(_,m){u(_,h,m),e(h,y),e(h,g),e(g,v),e(h,T)},d(_){_&&t(h)}}}function $y(C){let h,y,g,v,T,_,m,B,de,J,E,G,N,X,ce,O,he,re,L,q,Y,V,x,z,pe,W,se,ue,R,ae,ee,A,ie,S,oe,me,P,te,H,le;return{c(){h=o("p"),y=a("TF 2.0 models accepts two formats as inputs:"),g=l(),v=o("ul"),T=o("li"),_=a("having all inputs as keyword arguments (like PyTorch models), or"),m=l(),B=o("li"),de=a("having all inputs as a list, tuple or dict in the first positional arguments."),J=l(),E=o("p"),G=a("This second option is useful when using "),N=o("code"),X=a("tf.keras.Model.fit"),ce=a(` method which currently requires having all
the tensors in the first argument of the model call function: `),O=o("code"),he=a("model(inputs)"),re=a("."),L=l(),q=o("p"),Y=a(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in
the first positional argument :`),V=l(),x=o("ul"),z=o("li"),pe=a("a single Tensor with "),W=o("code"),se=a("input_ids"),ue=a(" only and nothing else: "),R=o("code"),ae=a("model(inputs_ids)"),ee=l(),A=o("li"),ie=a(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),S=o("code"),oe=a("model([input_ids, attention_mask])"),me=l(),P=o("li"),te=a(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),H=o("code"),le=a('model({"input_ids": input_ids})')},l(p){h=n(p,"P",{});var M=r(h);y=i(M,"TF 2.0 models accepts two formats as inputs:"),M.forEach(t),g=d(p),v=n(p,"UL",{});var K=r(v);T=n(K,"LI",{});var ge=r(T);_=i(ge,"having all inputs as keyword arguments (like PyTorch models), or"),ge.forEach(t),m=d(K),B=n(K,"LI",{});var Te=r(B);de=i(Te,"having all inputs as a list, tuple or dict in the first positional arguments."),Te.forEach(t),K.forEach(t),J=d(p),E=n(p,"P",{});var I=r(E);G=i(I,"This second option is useful when using "),N=n(I,"CODE",{});var _e=r(N);X=i(_e,"tf.keras.Model.fit"),_e.forEach(t),ce=i(I,` method which currently requires having all
...
the first positional argument :`),ke.forEach(t),V=d(p),x=n(p,"UL",{});var j=r(x);z=n(j,"LI",{});var Q=r(z);pe=i(Q,"a single Tensor with "),W=n(Q,"CODE",{});var we=r(W);se=i(we,"input_ids"),we.forEach(t),ue=i(Q," only and nothing else: "),R=n(Q,"CODE",{});var $e=r(R);ae=i($e,"model(inputs_ids)"),$e.forEach(t),Q.forEach(t),ee=d(j),A=n(j,"LI",{});var Z=r(A);ie=i(Z,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),S=n(Z,"CODE",{});var De=r(S);oe=i(De,"model([input_ids, attention_mask])"),De.forEach(t),Z.forEach(t),me=d(j),P=n(j,"LI",{});var ne=r(P);te=i(ne,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),H=n(ne,"CODE",{});var Fe=r(H);le=i(Fe,'model({"input_ids": input_ids})'),Fe.forEach(t),ne.forEach(t),j.forEach(t)},m(p,M){u(p,h,M),e(h,y),u(p,g,M),u(p,v,M),e(v,T),e(T,_),e(v,m),e(v,B),e(B,de),u(p,J,M),u(p,E,M),e(E,G),e(E,N),e(N,X),e(E,ce),e(E,O),e(O,he),e(E,re),u(p,L,M),u(p,q,M),e(q,Y),u(p,V,M),u(p,x,M),e(x,z),e(z,pe),e(z,W),e(W,se),e(z,ue),e(z,R),e(R,ae),e(x,ee),e(x,A),e(A,ie),e(A,S),e(S,oe),e(x,me),e(x,P),e(P,te),e(P,H),e(H,le)},d(p){p&&t(h),p&&t(g),p&&t(v),p&&t(J),p&&t(E),p&&t(L),p&&t(q),p&&t(V),p&&t(x)}}}function Dy(C){let h,y,g,v,T;return{c(){h=o("p"),y=a(`Although the recipe for forward pass needs to be defined within this function, one should call the
`),g=o("code"),v=a("Module"),T=a(` instance afterwards instead of this since the former takes care of running the pre and post
processing steps while the latter silently ignores them.`)},l(_){h=n(_,"P",{});var m=r(h);y=i(m,`Although the recipe for forward pass needs to be defined within this function, one should call the
`),g=n(m,"CODE",{});var B=r(g);v=i(B,"Module"),B.forEach(t),T=i(m,` instance afterwards instead of this since the former takes care of running the pre and post
processing steps while the latter silently ignores them.`),m.forEach(t)},m(_,m){u(_,h,m),e(h,y),e(h,g),e(g,v),e(h,T)},d(_){_&&t(h)}}}function Fy(C){let h,y,g,v,T,_,m,B,de,J,E,G,N,X,ce,O,he,re,L,q,Y,V,x,z,pe,W,se,ue,R,ae,ee,A,ie,S,oe,me,P,te,H,le;return{c(){h=o("p"),y=a("TF 2.0 models accepts two formats as inputs:"),g=l(),v=o("ul"),T=o("li"),_=a("having all inputs as keyword arguments (like PyTorch models), or"),m=l(),B=o("li"),de=a("having all inputs as a list, tuple or dict in the first positional arguments."),J=l(),E=o("p"),G=a("This second option is useful when using "),N=o("code"),X=a("tf.keras.Model.fit"),ce=a(` method which currently requires having all
...
the first positional argument :`),ke.forEach(t),V=d(p),x=n(p,"UL",{});var j=r(x);z=n(j,"LI",{});var Q=r(z);pe=i(Q,"a single Tensor with "),W=n(Q,"CODE",{});var we=r(W);se=i(we,"input_ids"),we.forEach(t),ue=i(Q," only and nothing else: "),R=n(Q,"CODE",{});var $e=r(R);ae=i($e,"model(inputs_ids)"),$e.forEach(t),Q.forEach(t),ee=d(j),A=n(j,"LI",{});var Z=r(A);ie=i(Z,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),S=n(Z,"CODE",{});var De=r(S);oe=i(De,"model([input_ids, attention_mask])"),De.forEach(t),Z.forEach(t),me=d(j),P=n(j,"LI",{});var ne=r(P);te=i(ne,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),H=n(ne,"CODE",{});var Fe=r(H);le=i(Fe,'model({"input_ids": input_ids})'),Fe.forEach(t),ne.forEach(t),j.forEach(t)},m(p,M){u(p,h,M),e(h,y),u(p,g,M),u(p,v,M),e(v,T),e(T,_),e(v,m),e(v,B),e(B,de),u(p,J,M),u(p,E,M),e(E,G),e(E,N),e(N,X),e(E,ce),e(E,O),e(O,he),e(E,re),u(p,L,M),u(p,q,M),e(q,Y),u(p,V,M),u(p,x,M),e(x,z),e(z,pe),e(z,W),e(W,se),e(z,ue),e(z,R),e(R,ae),e(x,ee),e(x,A),e(A,ie),e(A,S),e(S,oe),e(x,me),e(x,P),e(P,te),e(P,H),e(H,le)},d(p){p&&t(h),p&&t(g),p&&t(v),p&&t(J),p&&t(E),p&&t(L),p&&t(q),p&&t(V),p&&t(x)}}}function yy(C){let h,y,g,v,T;return{c(){h=o("p"),y=a(`Although the recipe for forward pass needs to be defined within this function, one should call the
`),g=o("code"),v=a("Module"),T=a(` instance afterwards instead of this since the former takes care of running the pre and post
processing steps while the latter silently ignores them.`)},l(_){h=n(_,"P",{});var m=r(h);y=i(m,`Although the recipe for forward pass needs to be defined within this function, one should call the
`),g=n(m,"CODE",{});var B=r(g);v=i(B,"Module"),B.forEach(t),T=i(m,` instance afterwards instead of this since the former takes care of running the pre and post
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/master/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model
weights.`,name:"config"}]}}),ua=new U({props:{name:"\\_\\_call\\_\\_",anchor:"transformers.FlaxDistilBertPreTrainedModel.__call__",parameters:[{name:"input_ids",val:""},{name:"attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"params",val:": dict = None"},{name:"dropout_rng",val:": PRNGKey = None"},{name:"train",val:": bool = False"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],source:"https://github.com/huggingface/transformers/blob/master/src/transformers/models/distilbert/modeling_flax_distilbert.py#L453",parametersDescription:[{anchor:"transformers.FlaxDistilBertPreTrainedModel.__call__.input_ids",description:`<strong>input_ids</strong> (<code>numpy.ndarray</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/master/en/model_doc/bert#transformers.BertTokenizer">BertTokenizer</a>. See
<a href="/docs/transformers/master/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">transformers.PreTrainedTokenizer.encode()</a> and <a href="/docs/transformers/master/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">transformers.PreTrainedTokenizer.<strong>call</strong>()</a> for
details.</p>
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/master/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model
weights.`,name:"config"}]}}),Da=new U({props:{name:"\\_\\_call\\_\\_",anchor:"transformers.FlaxDistilBertPreTrainedModel.__call__",parameters:[{name:"input_ids",val:""},{name:"attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"params",val:": dict = None"},{name:"dropout_rng",val:": PRNGKey = None"},{name:"train",val:": bool = False"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],source:"https://github.com/huggingface/transformers/blob/master/src/transformers/models/distilbert/modeling_flax_distilbert.py#L453",parametersDescription:[{anchor:"transformers.FlaxDistilBertPreTrainedModel.__call__.input_ids",description:`<strong>input_ids</strong> (<code>numpy.ndarray</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/master/en/model_doc/bert#transformers.BertTokenizer">BertTokenizer</a>. See
<a href="/docs/transformers/master/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">transformers.PreTrainedTokenizer.encode()</a> and <a href="/docs/transformers/master/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">transformers.PreTrainedTokenizer.<strong>call</strong>()</a> for
details.</p>
...
`}}),No=new fe({props:{$$slots:{default:[zy]},$$scope:{ctx:C}}}),Ja=new ye({props:{code:`from transformers import DistilBertTokenizer, FlaxDistilBertForTokenClassification
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/master/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model
weights.`,name:"config"}]}}),oi=new U({props:{name:"\\_\\_call\\_\\_",anchor:"transformers.FlaxDistilBertPreTrainedModel.__call__",parameters:[{name:"input_ids",val:""},{name:"attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"params",val:": dict = None"},{name:"dropout_rng",val:": PRNGKey = None"},{name:"train",val:": bool = False"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],source:"https://github.com/huggingface/transformers/blob/master/src/transformers/models/distilbert/modeling_flax_distilbert.py#L453",parametersDescription:[{anchor:"transformers.FlaxDistilBertPreTrainedModel.__call__.input_ids",description:`<strong>input_ids</strong> (<code>numpy.ndarray</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/master/en/model_doc/bert#transformers.BertTokenizer">BertTokenizer</a>. See
<a href="/docs/transformers/master/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">transformers.PreTrainedTokenizer.encode()</a> and <a href="/docs/transformers/master/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">transformers.PreTrainedTokenizer.<strong>call</strong>()</a> for
details.</p>
...
<span class="hljs-meta">&gt;&gt;&gt; </span>outputs = model(**inputs)
<span class="hljs-meta">&gt;&gt;&gt; </span>start_scores = outputs.start_logits
<span class="hljs-meta">&gt;&gt;&gt; </span>end_scores = outputs.end_logits`}}),{c(){h=o("meta"),y=l(),g=o("h1"),v=o("a"),T=o("span"),b(_.$$.fragment),m=l(),B=o("span"),de=a("DistilBERT"),J=l(),E=o("h2"),G=o("a"),N=o("span"),b(X.$$.fragment),ce=l(),O=o("span"),he=a("Overview"),re=l(),L=o("p"),q=a("The DistilBERT model was proposed in the blog post "),Y=o("a"),V=a(`Smaller, faster, cheaper, lighter: Introducing DistilBERT, a
...
outputs. Read the documentation from `),pi=o("a"),Pu=a("PretrainedConfig"),qu=a(" for more information."),Au=l(),Tl=o("p"),Iu=a("Examples:"),Lu=l(),b(nn.$$.fragment),gh=l(),ls=o("h2"),Gs=o("a"),bl=o("span"),b(rn.$$.fragment),Su=l(),kl=o("span"),Nu=a("DistilBertTokenizer"),_h=l(),_t=o("div"),b(an.$$.fragment),Ou=l(),wl=o("p"),Wu=a("Construct a DistilBERT tokenizer."),Ru=l(),Xs=o("p"),ui=o("a"),Hu=a("DistilBertTokenizer"),Qu=a(" is identical to "),mi=o("a"),Uu=a("BertTokenizer"),Ju=a(` and runs end-to-end
tokenization: punctuation splitting and wordpiece.`),Vu=l(),ln=o("p"),Ku=a("Refer to superclass "),fi=o("a"),Gu=a("BertTokenizer"),Xu=a(` for usage examples and documentation concerning
...
general usage and behavior.`),Fm=l(),Je=o("div"),b(vn.$$.fragment),ym=l(),hs=o("p"),Bm=a("The "),bi=o("a"),Mm=a("DistilBertModel"),Em=a(" forward method, overrides the "),El=o("code"),xm=a("__call__"),zm=a(" special method."),Cm=l(),b(to.$$.fragment),jm=l(),xl=o("p"),Pm=a("Example:"),qm=l(),b(Tn.$$.fragment),wh=l(),ps=o("h2"),so=o("a"),zl=o("span"),b(bn.$$.fragment),Am=l(),Cl=o("span"),Im=a("DistilBertForMaskedLM"),$h=l(),We=o("div"),b(kn.$$.fragment),Lm=l(),wn=o("p"),Sm=a("DistilBert Model with a "),jl=o("em"),Nm=a("masked language modeling"),Om=a(" head on top."),Wm=l(),$n=o("p"),Rm=a("This model inherits from "),ki=o("a"),Hm=a("PreTrainedModel"),Qm=a(`. Check the superclass documentation for the generic
methods the library implements for all its model (such as downloading or saving, resizing the input embeddings,
pruning heads etc.)`),Um=l(),Dn=o("p"),Jm=a("This model is also a PyTorch "),Fn=o("a"),Vm=a("torch.nn.Module"),Km=a(`
subclass. Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to
general usage and behavior.`),Gm=l(),Ve=o("div"),b(yn.$$.fragment),Xm=l(),us=o("p"),Ym=a("The "),wi=o("a"),Zm=a("DistilBertForMaskedLM"),ef=a(" forward method, overrides the "),Pl=o("code"),tf=a("__call__"),sf=a(" special method."),of=l(),b(oo.$$.fragment),nf=l(),ql=o("p"),rf=a("Example:"),af=l(),b(Bn.$$.fragment),Dh=l(),ms=o("h2"),no=o("a"),Al=o("span"),b(Mn.$$.fragment),lf=l(),Il=o("span"),df=a("DistilBertForSequenceClassification"),Fh=l(),Re=o("div"),b(En.$$.fragment),cf=l(),Ll=o("p"),hf=a(`DistilBert Model transformer with a sequence classification/regression head on top (a linear layer on top of the
...
methods the library implements for all its model (such as downloading or saving, resizing the input embeddings,
pruning heads etc.)`),hg=l(),Un=o("p"),pg=a("This model is also a PyTorch "),Jn=o("a"),ug=a("torch.nn.Module"),mg=a(`
subclass. Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to
general usage and behavior.`),fg=l(),Ge=o("div"),b(Vn.$$.fragment),gg=l(),Ts=o("p"),_g=a("The "),Mi=o("a"),vg=a("DistilBertForTokenClassification"),Tg=a(" forward method, overrides the "),Gl=o("code"),bg=a("__call__"),kg=a(" special method."),wg=l(),b(co.$$.fragment),$g=l(),Xl=o("p"),Dg=a("Example:"),Fg=l(),b(Kn.$$.fragment),xh=l(),bs=o("h2"),ho=o("a"),Yl=o("span"),b(Gn.$$.fragment),yg=l(),Zl=o("span"),Bg=a("DistilBertForQuestionAnswering"),zh=l(),Ue=o("div"),b(Xn.$$.fragment),Mg=l(),ks=o("p"),Eg=a(`DistilBert Model with a span classification head on top for extractive question-answering tasks like SQuAD (a
...
it as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage
and behavior.`),I_=l(),b(_o.$$.fragment),L_=l(),Ze=o("div"),b(gr.$$.fragment),S_=l(),ys=o("p"),N_=a("The "),Pi=o("a"),O_=a("TFDistilBertForMaskedLM"),W_=a(" forward method, overrides the "),pd=o("code"),R_=a("__call__"),H_=a(" special method."),Q_=l(),b(vo.$$.fragment),U_=l(),ud=o("p"),J_=a("Example:"),V_=l(),b(_r.$$.fragment),Ah=l(),Bs=o("h2"),To=o("a"),md=o("span"),b(vr.$$.fragment),K_=l(),fd=o("span"),G_=a("TFDistilBertForSequenceClassification"),Ih=l(),Ae=o("div"),b(Tr.$$.fragment),X_=l(),gd=o("p"),Y_=a(`DistilBert Model transformer with a sequence classification/regression head on top (a linear layer on top of the
...
and refer to the Flax documentation for all matter related to general usage and behavior.`),ZT=l(),Ld=o("p"),eb=a("Finally, this model supports inherent JAX features such as:"),tb=l(),Bt=o("ul"),Sd=o("li"),Xr=o("a"),sb=a("Just-In-Time (JIT) compilation"),ob=l(),Nd=o("li"),Yr=o("a"),nb=a("Automatic Differentiation"),rb=l(),Od=o("li"),Zr=o("a"),ab=a("Vectorization"),ib=l(),Wd=o("li"),ea=o("a"),lb=a("Parallelization"),db=l(),nt=o("div"),b(ta.$$.fragment),cb=l(),Is=o("p"),hb=a("The "),Rd=o("code"),pb=a("FlaxDistilBertPreTrainedModel"),ub=a(" forward method, overrides the "),Hd=o("code"),mb=a("__call__"),fb=a(" special method."),gb=l(),b(Co.$$.fragment),_b=l(),Qd=o("p"),vb=a("Example:"),Tb=l(),b(sa.$$.fragment),Uh=l(),Ls=o("h2"),jo=o("a"),Ud=o("span"),b(oa.$$.fragment),bb=l(),Jd=o("span"),kb=a("FlaxDistilBertForMaskedLM"),Jh=l(),Me=o("div"),b(na.$$.fragment),wb=l(),ra=o("p"),$b=a("DistilBert Model with a "),Vd=o("em"),Db=a("language modeling"),Fb=a(" head on top."),yb=l(),aa=o("p"),Bb=a("This model inherits from "),Hi=o("a"),Mb=a("FlaxPreTrainedModel"),Eb=a(`. Check the superclass documentation for the
generic methods the library implements for all its model (such as downloading, saving and converting weights from
...
and refer to the Flax documentation for all matter related to general usage and behavior.`),Fw=l(),Mc=o("p"),yw=a("Finally, this model supports inherent JAX features such as:"),Bw=l(),zt=o("ul"),Ec=o("li"),Wa=o("a"),Mw=a("Just-In-Time (JIT) compilation"),Ew=l(),xc=o("li"),Ra=o("a"),xw=a("Automatic Differentiation"),zw=l(),zc=o("li"),Ha=o("a"),Cw=a("Vectorization"),jw=l(),Cc=o("li"),Qa=o("a"),Pw=a("Parallelization"),qw=l(),lt=o("div"),b(Ua.$$.fragment),Aw=l(),Qs=o("p"),Iw=a("The "),jc=o("code"),Lw=a("FlaxDistilBertPreTrainedModel"),Sw=a(" forward method, overrides the "),Pc=o("code"),Nw=a("__call__"),Ow=a(" special method."),Ww=l(),b(No.$$.fragment),Rw=l(),qc=o("p"),Hw=a("Example:"),Qw=l(),b(Ja.$$.fragment),ep=l(),Us=o("h2"),Oo=o("a"),Ac=o("span"),b(Va.$$.fragment),Uw=l(),Ic=o("span"),Jw=a("FlaxDistilBertForQuestionAnswering"),tp=l(),Ce=o("div"),b(Ka.$$.fragment),Vw=l(),Js=o("p"),Kw=a(`DistilBert Model with a span classification head on top for extractive question-answering tasks like SQuAD (a
linear layers on top of the hidden-states output to compute `),Lc=o("em"),Gw=a("span start logits"),Xw=a(" and "),Sc=o("em"),Yw=a("span end logits"),Zw=a(")."),e1=l(),Ga=o("p"),t1=a("This model inherits from "),Vi=o("a"),s1=a("FlaxPreTrainedModel"),o1=a(`. Check the superclass documentation for the
generic methods the library implements for all its model (such as downloading, saving and converting weights from
...
and refer to the Flax documentation for all matter related to general usage and behavior.`),l1=l(),Nc=o("p"),d1=a("Finally, this model supports inherent JAX features such as:"),c1=l(),Ct=o("ul"),Oc=o("li"),Za=o("a"),h1=a("Just-In-Time (JIT) compilation"),p1=l(),Wc=o("li"),ei=o("a"),u1=a("Automatic Differentiation"),m1=l(),Rc=o("li"),ti=o("a"),f1=a("Vectorization"),g1=l(),Hc=o("li"),si=o("a"),_1=a("Parallelization"),v1=l(),dt=o("div"),b(oi.$$.fragment),T1=l(),Vs=o("p"),b1=a("The "),Qc=o("code"),k1=a("FlaxDistilBertPreTrainedModel"),w1=a(" forward method, overrides the "),Uc=o("code"),$1=a("__call__"),D1=a(" special method."),F1=l(),b(Wo.$$.fragment),y1=l(),Jc=o("p"),B1=a("Example:"),M1=l(),b(ni.$$.fragment),this.h()},l(s){const f=ly('[data-svelte="svelte-1phssyn"]',document.head);h=n(f,"META",{name:!0,content:!0}),f.forEach(t),y=d(s),g=n(s,"H1",{class:!0});var ri=r(g);v=n(ri,"A",{id:!0,class:!0,href:!0});var Vc=r(v);T=n(Vc,"SPAN",{});var Kc=r(T);k(_.$$.fragment,Kc),Kc.forEach(t),Vc.forEach(t),m=d(ri),B=n(ri,"SPAN",{});var Gc=r(B);de=i(Gc,"DistilBERT"),Gc.forEach(t),ri.forEach(t),J=d(s),E=n(s,"H2",{class:!0});var ai=r(E);G=n(ai,"A",{id:!0,class:!0,href:!0});var Xc=r(G);N=n(Xc,"SPAN",{});var Yc=r(N);k(X.$$.fragment,Yc),Yc.forEach(t),Xc.forEach(t),ce=d(ai),O=n(ai,"SPAN",{});var Zc=r(O);he=i(Zc,"Overview"),Zc.forEach(t),ai.forEach(t),re=d(s),L=n(s,"P",{});var jt=r(L);q=i(jt,"The DistilBERT model was proposed in the blog post "),Y=n(jt,"A",{href:!0,rel:!0});var eh=r(Y);V=i(eh,`Smaller, faster, cheaper, lighter: Introducing DistilBERT, a
...
subclass. Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to
general usage and behavior.`),kp.forEach(t),Uf=d(Wt),Ke=n(Wt,"DIV",{class:!0});var Rt=r(Ke);k(On.$$.fragment,Rt),Jf=d(Rt),_s=n(Rt,"P",{});var Zi=r(_s);Vf=i(Zi,"The "),yi=n(Zi,"A",{href:!0});var q$=r(yi);Kf=i(q$,"DistilBertForMultipleChoice"),q$.forEach(t),Gf=i(Zi," forward method, overrides the "),Ql=n(Zi,"CODE",{});var A$=r(Ql);Xf=i(A$,"__call__"),A$.forEach(t),Yf=i(Zi," special method."),Zi.forEach(t),Zf=d(Rt),k(io.$$.fragment,Rt),eg=d(Rt),Ul=n(Rt,"P",{});var I$=r(Ul);tg=i(I$,"Examples:"),I$.forEach(t),sg=d(Rt),k(Wn.$$.fragment,Rt),Rt.forEach(t),Wt.forEach(t),Mh=d(s),vs=n(s,"H2",{class:!0});var wp=r(vs);lo=n(wp,"A",{id:!0,class:!0,href:!0});var L$=r(lo);Jl=n(L$,"SPAN",{});var S$=r(Jl);k(Rn.$$.fragment,S$),S$.forEach(t),L$.forEach(t),og=d(wp),Vl=n(wp,"SPAN",{});var N$=r(Vl);ng=i(N$,"DistilBertForTokenClassification"),N$.forEach(t),wp.forEach(t),Eh=d(s),Qe=n(s,"DIV",{class:!0});var Ht=r(Qe);k(Hn.$$.fragment,Ht),rg=d(Ht),Kl=n(Ht,"P",{});var O$=r(Kl);ag=i(O$,`DistilBert Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g.
...
methods the library implements for all its model (such as downloading or saving, resizing the input embeddings,
pruning heads etc.)`),$p.forEach(t),hg=d(Ht),Un=n(Ht,"P",{});var Dp=r(Un);pg=i(Dp,"This model is also a PyTorch "),Jn=n(Dp,"A",{href:!0,rel:!0});var R$=r(Jn);ug=i(R$,"torch.nn.Module"),R$.forEach(t),mg=i(Dp,`
subclass. Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to
general usage and behavior.`),Dp.forEach(t),fg=d(Ht),Ge=n(Ht,"DIV",{class:!0});var Qt=r(Ge);k(Vn.$$.fragment,Qt),gg=d(Qt),Ts=n(Qt,"P",{});var el=r(Ts);_g=i(el,"The "),Mi=n(el,"A",{href:!0});var H$=r(Mi);vg=i(H$,"DistilBertForTokenClassification"),H$.forEach(t),Tg=i(el," forward method, overrides the "),Gl=n(el,"CODE",{});var Q$=r(Gl);bg=i(Q$,"__call__"),Q$.forEach(t),kg=i(el," special method."),el.forEach(t),wg=d(Qt),k(co.$$.fragment,Qt),$g=d(Qt),Xl=n(Qt,"P",{});var U$=r(Xl);Dg=i(U$,"Example:"),U$.forEach(t),Fg=d(Qt),k(Kn.$$.fragment,Qt),Qt.forEach(t),Ht.forEach(t),xh=d(s),bs=n(s,"H2",{class:!0});var Fp=r(bs);ho=n(Fp,"A",{id:!0,class:!0,href:!0});var J$=r(ho);Yl=n(J$,"SPAN",{});var V$=r(Yl);k(Gn.$$.fragment,V$),V$.forEach(t),J$.forEach(t),yg=d(Fp),Zl=n(Fp,"SPAN",{});var K$=r(Zl);Bg=i(K$,"DistilBertForQuestionAnswering"),K$.forEach(t),Fp.forEach(t),zh=d(s),Ue=n(s,"DIV",{class:!0});var Ut=r(Ue);k(Xn.$$.fragment,Ut),Mg=d(Ut),ks=n(Ut,"P",{});var tl=r(ks);Eg=i(tl,`DistilBert Model with a span classification head on top for extractive question-answering tasks like SQuAD (a
...
it as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage
and behavior.`),Up.forEach(t),ET=d(Ft),k(Eo.$$.fragment,Ft),xT=d(Ft),ot=n(Ft,"DIV",{class:!0});var Zt=r(ot);k(Hr.$$.fragment,Zt),zT=d(Zt),qs=n(Zt,"P",{});var dl=r(qs);CT=i(dl,"The "),Wi=n(dl,"A",{href:!0});var tD=r(Wi);jT=i(tD,"TFDistilBertForQuestionAnswering"),tD.forEach(t),PT=i(dl," forward method, overrides the "),jd=n(dl,"CODE",{});var sD=r(jd);qT=i(sD,"__call__"),sD.forEach(t),AT=i(dl," special method."),dl.forEach(t),IT=d(Zt),k(xo.$$.fragment,Zt),LT=d(Zt),Pd=n(Zt,"P",{});var oD=r(Pd);ST=i(oD,"Example:"),oD.forEach(t),NT=d(Zt),k(Qr.$$.fragment,Zt),Zt.forEach(t),Ft.forEach(t),Hh=d(s),As=n(s,"H2",{class:!0});var Jp=r(As);zo=n(Jp,"A",{id:!0,class:!0,href:!0});var nD=r(zo);qd=n(nD,"SPAN",{});var rD=r(qd);k(Ur.$$.fragment,rD),rD.forEach(t),nD.forEach(t),OT=d(Jp),Ad=n(Jp,"SPAN",{});var aD=r(Ad);WT=i(aD,"FlaxDistilBertModel"),aD.forEach(t),Jp.forEach(t),Qh=d(s),Be=n(s,"DIV",{class:!0});var ht=r(Be);k(Jr.$$.fragment,ht),RT=d(ht),Id=n(ht,"P",{});var iD=r(Id);HT=i(iD,"The bare DistilBert Model transformer outputting raw hidden-states without any specific head on top."),iD.forEach(t),QT=d(ht),Vr=n(ht,"P",{});var Vp=r(Vr);UT=i(Vp,"This model inherits from "),Ri=n(Vp,"A",{href:!0});var lD=r(Ri);JT=i(lD,"FlaxPreTrainedModel"),lD.forEach(t),VT=i(Vp,`. Check the superclass documentation for the
generic methods the library implements for all its model (such as downloading, saving and converting weights from
PyTorch models)`),Vp.forEach(t),KT=d(ht),Kr=n(ht,"P",{});var Kp=r(Kr);GT=i(Kp,"This model is also a Flax Linen "),Gr=n(Kp,"A",{href:!0,rel:!0});var dD=r(Gr);XT=i(dD,"flax.linen.Module"),dD.forEach(t),YT=i(Kp,` subclass. Use it as a regular Flax linen Module
and refer to the Flax documentation for all matter related to general usage and behavior.`),Kp.forEach(t),ZT=d(ht),Ld=n(ht,"P",{});var cD=r(Ld);eb=i(cD,"Finally, this model supports inherent JAX features such as:"),cD.forEach(t),tb=d(ht),Bt=n(ht,"UL",{});var Uo=r(Bt);Sd=n(Uo,"LI",{});var hD=r(Sd);Xr=n(hD,"A",{href:!0,rel:!0});var pD=r(Xr);sb=i(pD,"Just-In-Time (JIT) compilation"),pD.forEach(t),hD.forEach(t),ob=d(Uo),Nd=n(Uo,"LI",{});var uD=r(Nd);Yr=n(uD,"A",{href:!0,rel:!0});var mD=r(Yr);nb=i(mD,"Automatic Differentiation"),mD.forEach(t),uD.forEach(t),rb=d(Uo),Od=n(Uo,"LI",{});var fD=r(Od);Zr=n(fD,"A",{href:!0,rel:!0});var gD=r(Zr);ab=i(gD,"Vectorization"),gD.forEach(t),fD.forEach(t),ib=d(Uo),Wd=n(Uo,"LI",{});var _D=r(Wd);ea=n(_D,"A",{href:!0,rel:!0});var vD=r(ea);lb=i(vD,"Parallelization"),vD.forEach(t),_D.forEach(t),Uo.forEach(t),db=d(ht),nt=n(ht,"DIV",{class:!0});var es=r(nt);k(ta.$$.fragment,es),cb=d(es),Is=n(es,"P",{});var cl=r(Is);hb=i(cl,"The "),Rd=n(cl,"CODE",{});var TD=r(Rd);pb=i(TD,"FlaxDistilBertPreTrainedModel"),TD.forEach(t),ub=i(cl," forward method, overrides the "),Hd=n(cl,"CODE",{});var bD=r(Hd);mb=i(bD,"__call__"),bD.forEach(t),fb=i(cl," special method."),cl.forEach(t),gb=d(es),k(Co.$$.fragment,es),_b=d(es),Qd=n(es,"P",{});var kD=r(Qd);vb=i(kD,"Example:"),kD.forEach(t),Tb=d(es),k(sa.$$.fragment,es),es.forEach(t),ht.forEach(t),Uh=d(s),Ls=n(s,"H2",{class:!0});var Gp=r(Ls);jo=n(Gp,"A",{id:!0,class:!0,href:!0});var wD=r(jo);Ud=n(wD,"SPAN",{});var $D=r(Ud);k(oa.$$.fragment,$D),$D.forEach(t),wD.forEach(t),bb=d(Gp),Jd=n(Gp,"SPAN",{});var DD=r(Jd);kb=i(DD,"FlaxDistilBertForMaskedLM"),DD.forEach(t),Gp.forEach(t),Jh=d(s),Me=n(s,"DIV",{class:!0});var pt=r(Me);k(na.$$.fragment,pt),wb=d(pt),ra=n(pt,"P",{});var Xp=r(ra);$b=i(Xp,"DistilBert Model with a "),Vd=n(Xp,"EM",{});var FD=r(Vd);Db=i(FD,"language modeling"),FD.forEach(t),Fb=i(Xp," head on top."),Xp.forEach(t),yb=d(pt),aa=n(pt,"P",{});var Yp=r(aa);Bb=i(Yp,"This model inherits from "),Hi=n(Yp,"A",{href:!0});var yD=r(Hi);Mb=i(yD,"FlaxPreTrainedModel"),yD.forEach(t),Eb=i(Yp,`. Check the superclass documentation for the
generic methods the library implements for all its model (such as downloading, saving and converting weights from
...
and refer to the Flax documentation for all matter related to general usage and behavior.`),Zp.forEach(t),Pb=d(pt),Kd=n(pt,"P",{});var MD=r(Kd);qb=i(MD,"Finally, this model supports inherent JAX features such as:"),MD.forEach(t),Ab=d(pt),Mt=n(pt,"UL",{});var Jo=r(Mt);Gd=n(Jo,"LI",{});var ED=r(Gd);da=n(ED,"A",{href:!0,rel:!0});var xD=r(da);Ib=i(xD,"Just-In-Time (JIT) compilation"),xD.forEach(t),ED.forEach(t),Lb=d(Jo),Xd=n(Jo,"LI",{});var zD=r(Xd);ca=n(zD,"A",{href:!0,rel:!0});var CD=r(ca);Sb=i(CD,"Automatic Differentiation"),CD.forEach(t),zD.forEach(t),Nb=d(Jo),Yd=n(Jo,"LI",{});var jD=r(Yd);ha=n(jD,"A",{href:!0,rel:!0});var PD=r(ha);Ob=i(PD,"Vectorization"),PD.forEach(t),jD.forEach(t),Wb=d(Jo),Zd=n(Jo,"LI",{});var qD=r(Zd);pa=n(qD,"A",{href:!0,rel:!0});var AD=r(pa);Rb=i(AD,"Parallelization"),AD.forEach(t),qD.forEach(t),Jo.forEach(t),Hb=d(pt),rt=n(pt,"DIV",{class:!0});var ts=r(rt);k(ua.$$.fragment,ts),Qb=d(ts),Ss=n(ts,"P",{});var hl=r(Ss);Ub=i(hl,"The "),ec=n(hl,"CODE",{});var ID=r(ec);Jb=i(ID,"FlaxDistilBertPreTrainedModel"),ID.forEach(t),Vb=i(hl," forward method, overrides the "),tc=n(hl,"CODE",{});var LD=r(tc);Kb=i(LD,"__call__"),LD.forEach(t),Gb=i(hl," special method."),hl.forEach(t),Xb=d(ts),k(Po.$$.fragment,ts),Yb=d(ts),sc=n(ts,"P",{});var SD=r(sc);Zb=i(SD,"Example:"),SD.forEach(t),ek=d(ts),k(ma.$$.fragment,ts),ts.forEach(t),pt.forEach(t),Vh=d(s),Ns=n(s,"H2",{class:!0});var eu=r(Ns);qo=n(eu,"A",{id:!0,class:!0,href:!0});var ND=r(qo);oc=n(ND,"SPAN",{});var OD=r(oc);k(fa.$$.fragment,OD),OD.forEach(t),ND.forEach(t),tk=d(eu),nc=n(eu,"SPAN",{});var WD=r(nc);sk=i(WD,"FlaxDistilBertForSequenceClassification"),WD.forEach(t),eu.forEach(t),Kh=d(s),Ee=n(s,"DIV",{class:!0});var ut=r(Ee);k(ga.$$.fragment,ut),ok=d(ut),rc=n(ut,"P",{});var RD=r(rc);nk=i(RD,`DistilBert Model transformer with a sequence classification/regression head on top (a linear layer on top of the
...
and refer to the Flax documentation for all matter related to general usage and behavior.`),su.forEach(t),uk=d(ut),ac=n(ut,"P",{});var UD=r(ac);mk=i(UD,"Finally, this model supports inherent JAX features such as:"),UD.forEach(t),fk=d(ut),Et=n(ut,"UL",{});var Vo=r(Et);ic=n(Vo,"LI",{});var JD=r(ic);ba=n(JD,"A",{href:!0,rel:!0});var VD=r(ba);gk=i(VD,"Just-In-Time (JIT) compilation"),VD.forEach(t),JD.forEach(t),_k=d(Vo),lc=n(Vo,"LI",{});var KD=r(lc);ka=n(KD,"A",{href:!0,rel:!0});var GD=r(ka);vk=i(GD,"Automatic Differentiation"),GD.forEach(t),KD.forEach(t),Tk=d(Vo),dc=n(Vo,"LI",{});var XD=r(dc);wa=n(XD,"A",{href:!0,rel:!0});var YD=r(wa);bk=i(YD,"Vectorization"),YD.forEach(t),XD.forEach(t),kk=d(Vo),cc=n(Vo,"LI",{});var ZD=r(cc);$a=n(ZD,"A",{href:!0,rel:!0});var eF=r($a);wk=i(eF,"Parallelization"),eF.forEach(t),ZD.forEach(t),Vo.forEach(t),$k=d(ut),at=n(ut,"DIV",{class:!0});var ss=r(at);k(Da.$$.fragment,ss),Dk=d(ss),Os=n(ss,"P",{});var pl=r(Os);Fk=i(pl,"The "),hc=n(pl,"CODE",{});var tF=r(hc);yk=i(tF,"FlaxDistilBertPreTrainedModel"),tF.forEach(t),Bk=i(pl," forward method, overrides the "),pc=n(pl,"CODE",{});var sF=r(pc);Mk=i(sF,"__call__"),sF.forEach(t),Ek=i(pl," special method."),pl.forEach(t),xk=d(ss),k(Ao.$$.fragment,ss),zk=d(ss),uc=n(ss,"P",{});var oF=r(uc);Ck=i(oF,"Example:"),oF.forEach(t),jk=d(ss),k(Fa.$$.fragment,ss),ss.forEach(t),ut.forEach(t),Gh=d(s),Ws=n(s,"H2",{class:!0});var ou=r(Ws);Io=n(ou,"A",{id:!0,class:!0,href:!0});var nF=r(Io);mc=n(nF,"SPAN",{});var rF=r(mc);k(ya.$$.fragment,rF),rF.forEach(t),nF.forEach(t),Pk=d(ou),fc=n(ou,"SPAN",{});var aF=r(fc);qk=i(aF,"FlaxDistilBertForMultipleChoice"),aF.forEach(t),ou.forEach(t),Xh=d(s),xe=n(s,"DIV",{class:!0});var mt=r(xe);k(Ba.$$.fragment,mt),Ak=d(mt),gc=n(mt,"P",{});var iF=r(gc);Ik=i(iF,`DistilBert Model with a multiple choice classification head on top (a linear layer on top of the pooled output and
