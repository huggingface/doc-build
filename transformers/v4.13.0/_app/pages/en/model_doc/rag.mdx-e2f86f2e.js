import{S as eT,i as tT,s as oT,e as r,k as c,w as v,t,L as nT,c as s,d as n,m as l,a,x as b,h as o,b as i,J as e,g as _,y as T,q as w,o as k,B as q}from"../../../chunks/vendor-e859c359.js";import{T as ge}from"../../../chunks/Tip-edc75249.js";import{D as G}from"../../../chunks/Docstring-ade913b3.js";import{C as rn}from"../../../chunks/CodeBlock-ce4317c2.js";import{I as _e}from"../../../chunks/IconCopyLink-5fae3b20.js";import"../../../chunks/CopyButton-77addb3d.js";function rT($){let h,y,m,f,x;return{c(){h=r("p"),y=t(`Although the recipe for forward pass needs to be defined within this function, one should call the
...
processing steps while the latter silently ignores them.`)},l(g){h=s(g,"P",{});var p=a(h);y=o(p,`Although the recipe for forward pass needs to be defined within this function, one should call the
`),m=s(p,"CODE",{});var R=a(m);f=o(R,"Module"),R.forEach(n),x=o(p,` instance afterwards instead of this since the former takes care of running the pre and post
processing steps while the latter silently ignores them.`),p.forEach(n)},m(g,p){_(g,h,p),e(h,y),e(h,m),e(m,f),e(h,x)},d(g){g&&n(h)}}}function _T($){let h,y,m,f,x,g,p,R,Zd,La,$e,tt,Rr,Ct,ei,Fr,ti,Ia,sn,oi,Oa,ot,ni,St,ri,si,Wa,an,ai,Ha,dn,zr,di,Ba,nt,ii,Dt,ci,li,Qa,Ee,rt,$r,Lt,hi,Er,pi,Va,de,It,mi,ue,cn,ui,gi,Mr,_i,fi,ln,vi,bi,hn,Ti,wi,ki,st,Ot,qi,Wt,yi,pn,xi,Ri,Fi,at,Ht,zi,Bt,$i,mn,Ei,Mi,Ua,Me,dt,Gr,Qt,Gi,Ar,Ai,Ka,Vt,it,Ut,ji,jr,Ni,Ya,Ge,ct,Nr,Kt,Pi,Pr,Ci,Ja,Ae,Yt,Si,Cr,Di,Xa,Jt,Xt,Za,je,lt,Sr,Zt,Li,Dr,Ii,ed,X,eo,Oi,Lr,Wi,Hi,Ir,Bi,Qi,to,Vi,ht,oo,Ui,Or,Ki,Yi,pt,no,Ji,Ne,Xi,Wr,Zi,ec,Hr,tc,oc,nc,mt,ro,rc,so,sc,Br,ac,dc,td,Pe,ut,Qr,ao,ic,Vr,cc,od,D,io,lc,Ce,hc,un,pc,mc,Ur,uc,gc,_c,gt,fc,Kr,vc,bc,ie,Tc,Yr,wc,kc,gn,qc,yc,Jr,xc,Rc,_n,Fc,zc,$c,A,Ec,fn,Mc,Gc,Xr,Ac,jc,Zr,Nc,Pc,es,Cc,Sc,ts,Dc,Lc,vn,Ic,Oc,os,Wc,Hc,bn,Bc,Qc,Tn,Vc,Uc,ns,Kc,Yc,Jc,co,Xc,wn,Zc,el,tl,lo,ol,ho,nl,rl,sl,ee,po,al,Se,dl,kn,il,cl,rs,ll,hl,pl,_t,ml,ss,ul,gl,mo,nd,De,ft,as,uo,_l,ds,fl,rd,E,go,vl,Le,bl,qn,Tl,wl,is,kl,ql,yl,vt,xl,cs,Rl,Fl,ls,zl,$l,ce,El,hs,Ml,Gl,yn,Al,jl,ps,Nl,Pl,xn,Cl,Sl,Dl,j,Ll,Rn,Il,Ol,ms,Wl,Hl,us,Bl,Ql,gs,Vl,Ul,_s,Kl,Yl,Fn,Jl,Xl,fs,Zl,eh,zn,th,oh,$n,nh,rh,vs,sh,ah,dh,_o,ih,En,ch,lh,hh,fo,ph,vo,mh,uh,gh,te,bo,_h,Ie,fh,Mn,vh,bh,bs,Th,wh,kh,bt,qh,Ts,yh,xh,To,Rh,Tt,wo,Fh,ko,zh,Gn,$h,Eh,sd,Oe,wt,ws,qo,Mh,ks,Gh,ad,M,yo,Ah,We,jh,An,Nh,Ph,qs,Ch,Sh,Dh,kt,Lh,ys,Ih,Oh,xs,Wh,Hh,le,Bh,Rs,Qh,Vh,jn,Uh,Kh,Fs,Yh,Jh,Nn,Xh,Zh,ep,N,tp,Pn,op,np,zs,rp,sp,$s,ap,dp,Es,ip,cp,Ms,lp,hp,Cn,pp,mp,Gs,up,gp,Sn,_p,fp,Dn,vp,bp,As,Tp,wp,kp,xo,qp,Ln,yp,xp,Rp,Ro,Fp,Fo,zp,$p,Ep,oe,zo,Mp,He,Gp,In,Ap,jp,js,Np,Pp,Cp,qt,Sp,Ns,Dp,Lp,$o,Ip,yt,Eo,Op,Ps,Wp,dd,Be,xt,Cs,Mo,Hp,Ss,Bp,id,P,Go,Qp,Qe,Vp,On,Up,Kp,Ds,Yp,Jp,Xp,Rt,Zp,Ls,em,tm,he,om,Is,nm,rm,Wn,sm,am,Os,dm,im,Hn,cm,lm,hm,L,pm,Bn,mm,um,Ws,gm,_m,Hs,fm,vm,Bs,bm,Tm,Qs,wm,km,Qn,qm,ym,Vs,xm,Rm,Vn,Fm,zm,Us,$m,Em,Mm,Ao,Gm,Un,Am,jm,Nm,jo,Pm,No,Cm,Sm,Dm,Ks,Lm,Im,ne,Po,Om,Ve,Wm,Kn,Hm,Bm,Ys,Qm,Vm,Um,Ft,Km,Js,Ym,Jm,Co,cd,Ue,zt,Xs,So,Xm,Zs,Zm,ld,F,Do,eu,Ke,tu,Yn,ou,nu,ea,ru,su,au,$t,du,ta,iu,cu,oa,lu,hu,pe,pu,na,mu,uu,Jn,gu,_u,ra,fu,vu,Xn,bu,Tu,wu,I,ku,Zn,qu,yu,sa,xu,Ru,aa,Fu,zu,da,$u,Eu,ia,Mu,Gu,er,Au,ju,ca,Nu,Pu,tr,Cu,Su,la,Du,Lu,Iu,Lo,Ou,or,Wu,Hu,Bu,Io,Qu,Oo,Vu,Uu,Ku,ha,Yu,Ju,re,Wo,Xu,Ye,Zu,nr,eg,tg,pa,og,ng,rg,Et,sg,ma,ag,dg,Ho,ig,Mt,Bo,cg,Qo,lg,rr,hg,pg,hd,Je,Gt,ua,Vo,mg,ga,ug,pd,z,Uo,gg,Xe,_g,sr,fg,vg,_a,bg,Tg,wg,At,kg,fa,qg,yg,va,xg,Rg,me,Fg,ba,zg,$g,ar,Eg,Mg,Ta,Gg,Ag,dr,jg,Ng,Pg,O,Cg,ir,Sg,Dg,wa,Lg,Ig,ka,Og,Wg,qa,Hg,Bg,ya,Qg,Vg,cr,Ug,Kg,xa,Yg,Jg,lr,Xg,Zg,Ra,e_,t_,o_,Ko,n_,hr,r_,s_,a_,Yo,d_,Jo,i_,c_,l_,Fa,h_,p_,se,Xo,m_,Ze,u_,pr,g_,__,za,f_,v_,b_,jt,T_,$a,w_,k_,Zo,q_,Nt,en,y_,Ea,x_,md;return g=new _e({}),Ct=new _e({}),Lt=new _e({}),It=new G({props:{name:"class transformers.RagConfig",anchor:"transformers.RagConfig",parameters:[{name:"vocab_size",val:" = None"},{name:"is_encoder_decoder",val:" = True"},{name:"prefix",val:" = None"},{name:"bos_token_id",val:" = None"},{name:"pad_token_id",val:" = None"},{name:"eos_token_id",val:" = None"},{name:"decoder_start_token_id",val:" = None"},{name:"title_sep",val:" = ' / '"},{name:"doc_sep",val:" = ' // '"},{name:"n_docs",val:" = 5"},{name:"max_combined_length",val:" = 300"},{name:"retrieval_vector_size",val:" = 768"},{name:"retrieval_batch_size",val:" = 8"},{name:"dataset",val:" = 'wiki_dpr'"},{name:"dataset_split",val:" = 'train'"},{name:"index_name",val:" = 'compressed'"},{name:"index_path",val:" = None"},{name:"passages_path",val:" = None"},{name:"use_dummy_dataset",val:" = False"},{name:"reduce_loss",val:" = False"},{name:"label_smoothing",val:" = 0.0"},{name:"do_deduplication",val:" = True"},{name:"exclude_bos_score",val:" = False"},{name:"do_marginalize",val:" = False"},{name:"output_retrieved",val:" = False"},{name:"use_cache",val:" = True"},{name:"forced_eos_token_id",val:" = None"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/master/src/transformers/models/rag/configuration_rag.py#L84",parametersDescription:[{anchor:"transformers.RagConfig.title_sep",description:`<strong>title_sep</strong> (<code>str</code>, <em>optional</em>, defaults to  <code>&quot; / &quot;</code>) &#x2014;
...
<code>eos_token_id</code>.`,name:"forced_eos_token_id"}]}}),Ot=new G({props:{name:"from\\_question\\_encoder\\_generator\\_configs",anchor:"transformers.RagConfig.from_question_encoder_generator_configs",parameters:[{name:"question_encoder_config",val:": PretrainedConfig"},{name:"generator_config",val:": PretrainedConfig"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/master/src/transformers/models/rag/configuration_rag.py#L172",returnDescription:`
...
weighted average in the cross-attention heads.`,name:"generator_cross_attentions"}]}}),Xt=new G({props:{name:"class transformers.models.rag.modeling\\_rag.RetrievAugLMOutput",anchor:"transformers.models.rag.modeling_rag.RetrievAugLMOutput",parameters:[{name:"logits",val:": FloatTensor = None"},{name:"doc_scores",val:": FloatTensor = None"},{name:"past_key_values",val:": typing.Optional[typing.List[torch.FloatTensor]] = None"},{name:"retrieved_doc_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"retrieved_doc_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"context_input_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"context_attention_mask",val:": typing.Optional[torch.LongTensor] = None"},{name:"question_encoder_last_hidden_state",val:": typing.Optional[torch.FloatTensor] = None"},{name:"question_enc_hidden_states",val:": typing.Optional[typing.Tuple[torch.FloatTensor]] = None"},{name:"question_enc_attentions",val:": typing.Optional[typing.Tuple[torch.FloatTensor]] = None"},{name:"generator_enc_last_hidden_state",val:": typing.Optional[torch.FloatTensor] = None"},{name:"generator_enc_hidden_states",val:": typing.Optional[typing.Tuple[torch.FloatTensor]] = None"},{name:"generator_enc_attentions",val:": typing.Optional[typing.Tuple[torch.FloatTensor]] = None"},{name:"generator_dec_hidden_states",val:": typing.Optional[typing.Tuple[torch.FloatTensor]] = None"},{name:"generator_dec_attentions",val:": typing.Optional[typing.Tuple[torch.FloatTensor]] = None"},{name:"generator_cross_attentions",val:": typing.Optional[typing.Tuple[torch.FloatTensor]] = None"}],source:"https://github.com/huggingface/transformers/blob/master/src/transformers/models/rag/modeling_rag.py#L134",parametersDescription:[{anchor:"transformers.models.rag.modeling_rag.RetrievAugLMOutput.logits",description:`<strong>logits</strong> (<code>torch.FloatTensor</code> of shape <code>(batch_size, sequence_length, config.vocab_size)</code>) &#x2014;
Prediction scores of the language modeling head. The score is possibly marginalized over all documents for
...
`,returnType:`
<p><code>tf.Tensor</code> of shape <code>(batch_size * num_return_sequences, sequence_length)</code></p>
`}}),{c(){h=r("meta"),y=c(),m=r("h1"),f=r("a"),x=r("span"),v(g.$$.fragment),p=c(),R=r("span"),Zd=t("RAG"),La=c(),$e=r("h2"),tt=r("a"),Rr=r("span"),v(Ct.$$.fragment),ei=c(),Fr=r("span"),ti=t("Overview"),Ia=c(),sn=r("p"),oi=t(`Retrieval-augmented generation (\u201CRAG\u201D) models combine the powers of pretrained dense retrieval (DPR) and
...
parametric-only seq2seq baseline.`),Ba=c(),nt=r("p"),ii=t("This model was contributed by "),Dt=r("a"),ci=t("ola13"),li=t("."),Qa=c(),Ee=r("h2"),rt=r("a"),$r=r("span"),v(Lt.$$.fragment),hi=c(),Er=r("span"),pi=t("RagConfig"),Va=c(),de=r("div"),v(It.$$.fragment),mi=c(),ue=r("p"),cn=r("a"),ui=t("RagConfig"),gi=t(" stores the configuration of a "),Mr=r("em"),_i=t("RagModel"),fi=t(`. Configuration objects inherit from
...
sequence-to-sequence models that need a slightly different processing for the labels.`),Ya=c(),Ge=r("h2"),ct=r("a"),Nr=r("span"),v(Kt.$$.fragment),Pi=c(),Pr=r("span"),Ci=t("Rag specific outputs"),Ja=c(),Ae=r("div"),v(Yt.$$.fragment),Si=c(),Cr=r("p"),Di=t("Base class for retriever augmented marginalized models outputs."),Xa=c(),Jt=r("div"),v(Xt.$$.fragment),Za=c(),je=r("h2"),lt=r("a"),Sr=r("span"),v(Zt.$$.fragment),Li=c(),Dr=r("span"),Ii=t("RagRetriever"),ed=c(),X=r("div"),v(eo.$$.fragment),Oi=c(),Lr=r("p"),Wi=t(`Retriever used to get documents from vector queries. It retrieves the documents embeddings as well as the documents
...
the `),ts=r("code"),Dc=t("generator"),Lc=t(". It has been tested with "),vn=r("a"),Ic=t("DPRQuestionEncoder"),Oc=t(" as the "),os=r("code"),Wc=t("question_encoder"),Hc=t(`
...
generator can be any `),ps=r("em"),Nl=t("seq2seq"),Pl=t(" model, preferably "),xn=r("a"),Cl=t("BartForConditionalGeneration"),Sl=t("."),Dl=c(),j=r("p"),Ll=t("The model can be initialized with a "),Rn=r("a"),Il=t("RagRetriever"),Ol=t(` for end-to-end generation or used in
combination with the outputs of a retriever in multiple steps---see examples for more details. The model is
...
subclass. Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to
general usage and behavior.`),gh=c(),te=r("div"),v(bo.$$.fragment),_h=c(),Ie=r("p"),fh=t("The "),Mn=r("a"),vh=t("RagSequenceForGeneration"),bh=t(" forward method, overrides the "),bs=r("code"),Th=t("__call__"),wh=t(" special method."),kh=c(),v(bt.$$.fragment),qh=c(),Ts=r("p"),yh=t("Example:"),xh=c(),v(To.$$.fragment),Rh=c(),Tt=r("div"),v(wo.$$.fragment),Fh=c(),ko=r("p"),zh=t(`Implements RAG sequence \u201Cthorough\u201D decoding. Read the
`),Gn=r("a"),$h=t("generate()"),Eh=t("` documentation for more information on how to\nset other generate input parameters."),sd=c(),Oe=r("h2"),wt=r("a"),ws=r("span"),v(qo.$$.fragment),Mh=c(),ks=r("span"),Gh=t("RagTokenForGeneration"),ad=c(),M=r("div"),v(yo.$$.fragment),Ah=c(),We=r("p"),jh=t("The "),An=r("a"),Nh=t("RagTokenForGeneration"),Ph=t(" forward method, overrides the "),qs=r("code"),Ch=t("__call__"),Sh=t(" special method."),Dh=c(),v(kt.$$.fragment),Lh=c(),ys=r("p"),Ih=t("A RAG-token model implementation. It performs RAG-token specific marginalization in the forward pass."),Oh=c(),xs=r("p"),Wh=t(`RAG is a seq2seq model which encapsulates two core components: a question encoder and a generator. During a forward
pass, we encode the input with the question encoder and pass it to the retriever to extract relevant context
...
`),As=r("code"),Tp=t("generator"),wp=t("."),kp=c(),xo=r("p"),qp=t("This model inherits from "),Ln=r("a"),yp=t("PreTrainedModel"),xp=t(`. Check the superclass documentation for the generic
methods the library implements for all its model (such as downloading or saving, resizing the input embeddings,
pruning heads etc.)`),Rp=c(),Ro=r("p"),Fp=t("This model is also a PyTorch "),Fo=r("a"),zp=t("torch.nn.Module"),$p=t(`
subclass. Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to
general usage and behavior.`),Ep=c(),oe=r("div"),v(zo.$$.fragment),Mp=c(),He=r("p"),Gp=t("The "),In=r("a"),Ap=t("RagTokenForGeneration"),jp=t(" forward method, overrides the "),js=r("code"),Np=t("__call__"),Pp=t(" special method."),Cp=c(),v(qt.$$.fragment),Sp=c(),Ns=r("p"),Dp=t("Example:"),Lp=c(),v($o.$$.fragment),Ip=c(),yt=r("div"),v(Eo.$$.fragment),Op=c(),Ps=r("p"),Wp=t("Implements RAG token decoding."),dd=c(),Be=r("h2"),xt=r("a"),Cs=r("span"),v(Mo.$$.fragment),Hp=c(),Ss=r("span"),Bp=t("TFRagModel"),id=c(),P=r("div"),v(Go.$$.fragment),Qp=c(),Qe=r("p"),Vp=t("The "),On=r("a"),Up=t("TFRagModel"),Kp=t(" forward method, overrides the "),Ds=r("code"),Yp=t("__call__"),Jp=t(" special method."),Xp=c(),v(Rt.$$.fragment),Zp=c(),Ls=r("p"),em=t(`RAG is a sequence-to-sequence model which encapsulates two core components: a question encoder and a generator.
...
the generator.`),tm=c(),he=r("p"),om=t("The question encoder can be any "),Is=r("em"),nm=t("autoencoding"),rm=t(" model, preferably "),Wn=r("a"),sm=t("TFDPRQuestionEncoder"),am=t(`, and
the generator can be any `),Os=r("em"),dm=t("seq2seq"),im=t(" model, preferably "),Hn=r("a"),cm=t("TFBartForConditionalGeneration"),lm=t("."),hm=c(),L=r("p"),pm=t("The model can be initialized with a "),Bn=r("a"),mm=t("RagRetriever"),um=t(` for end-to-end generation or used in
combination with the outputs of a retriever in multiple steps---see examples for more details. The model is
...
the generator can be any `),ra=r("em"),fu=t("seq2seq"),vu=t(" model, preferably "),Xn=r("a"),bu=t("TFBartForConditionalGeneration"),Tu=t("."),wu=c(),I=r("p"),ku=t("The model can be initialized with a "),Zn=r("a"),qu=t("RagRetriever"),yu=t(` for end-to-end generation or used in
combination with the outputs of a retriever in multiple steps---see examples for more details. The model is
...
and `),tr=r("a"),Cu=t("TFBartForConditionalGeneration"),Su=t(" as the "),la=r("code"),Du=t("generator"),Lu=t("."),Iu=c(),Lo=r("p"),Ou=t("This model inherits from "),or=r("a"),Wu=t("TFPreTrainedModel"),Hu=t(`. Check the superclass documentation for the
generic methods the library implements for all its model (such as downloading or saving, resizing the input
embeddings, pruning heads etc.)`),Bu=c(),Io=r("p"),Qu=t("This model is also a Tensorflow "),Oo=r("a"),Vu=t("tf.keras.Model"),Uu=t(`
subclass. Use it as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to
...
combination with the outputs of a retriever in multiple steps---see examples for more details. The model is
compatible any `),wa=r("em"),Lg=t("autoencoding"),Ig=t(" model as the "),ka=r("code"),Og=t("question_encoder"),Wg=t(" and any "),qa=r("em"),Hg=t("seq2seq"),Bg=t(` model with language model head as
...
outperforming parametric seq2seq models and task-specific retrieve-and-extract architectures. For language generation
tasks, we find that RAG models generate more specific, diverse and factual language than a state-of-the-art
parametric-only seq2seq baseline.`),F_.forEach(n),R_.forEach(n),Ba=l(d),nt=s(d,"P",{});var ud=a(nt);ii=o(ud,"This model was contributed by "),Dt=s(ud,"A",{href:!0,rel:!0});var z_=a(Dt);ci=o(z_,"ola13"),z_.forEach(n),li=o(ud,"."),ud.forEach(n),Qa=l(d),Ee=s(d,"H2",{class:!0});var gd=a(Ee);rt=s(gd,"A",{id:!0,class:!0,href:!0});var $_=a(rt);$r=s($_,"SPAN",{});var E_=a($r);b(Lt.$$.fragment,E_),E_.forEach(n),$_.forEach(n),hi=l(gd),Er=s(gd,"SPAN",{});var M_=a(Er);pi=o(M_,"RagConfig"),M_.forEach(n),gd.forEach(n),Va=l(d),de=s(d,"DIV",{class:!0});var Pt=a(de);b(It.$$.fragment,Pt),mi=l(Pt),ue=s(Pt,"P",{});var et=a(ue);cn=s(et,"A",{href:!0});var G_=a(cn);ui=o(G_,"RagConfig"),G_.forEach(n),gi=o(et," stores the configuration of a "),Mr=s(et,"EM",{});var A_=a(Mr);_i=o(A_,"RagModel"),A_.forEach(n),fi=o(et,`. Configuration objects inherit from
...
the `),ts=s(W,"CODE",{});var vf=a(ts);Dc=o(vf,"generator"),vf.forEach(n),Lc=o(W,". It has been tested with "),vn=s(W,"A",{href:!0});var bf=a(vn);Ic=o(bf,"DPRQuestionEncoder"),bf.forEach(n),Oc=o(W," as the "),os=s(W,"CODE",{});var Tf=a(os);Wc=o(Tf,"question_encoder"),Tf.forEach(n),Hc=o(W,`
...
generator can be any `),ps=s(be,"EM",{});var Sf=a(ps);Nl=o(Sf,"seq2seq"),Sf.forEach(n),Pl=o(be," model, preferably "),xn=s(be,"A",{href:!0});var Df=a(xn);Cl=o(Df,"BartForConditionalGeneration"),Df.forEach(n),Sl=o(be,"."),be.forEach(n),Dl=l(H),j=s(H,"P",{});var B=a(j);Ll=o(B,"The model can be initialized with a "),Rn=s(B,"A",{href:!0});var Lf=a(Rn);Il=o(Lf,"RagRetriever"),Lf.forEach(n),Ol=o(B,` for end-to-end generation or used in
combination with the outputs of a retriever in multiple steps---see examples for more details. The model is
compatible any `),ms=s(B,"EM",{});var If=a(ms);Wl=o(If,"autoencoding"),If.forEach(n),Hl=o(B," model as the "),us=s(B,"CODE",{});var Of=a(us);Bl=o(Of,"question_encoder"),Of.forEach(n),Ql=o(B," and any "),gs=s(B,"EM",{});var Wf=a(gs);Vl=o(Wf,"seq2seq"),Wf.forEach(n),Ul=o(B,` model with language model head as
...
subclass. Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to
general usage and behavior.`),Dd.forEach(n),Ep=l(Q),oe=s(Q,"DIV",{class:!0});var ke=a(oe);b(zo.$$.fragment,ke),Mp=l(ke),He=s(ke,"P",{});var br=a(He);Gp=o(br,"The "),In=s(br,"A",{href:!0});var xv=a(In);Ap=o(xv,"RagTokenForGeneration"),xv.forEach(n),jp=o(br," forward method, overrides the "),js=s(br,"CODE",{});var Rv=a(js);Np=o(Rv,"__call__"),Rv.forEach(n),Pp=o(br," special method."),br.forEach(n),Cp=l(ke),b(qt.$$.fragment,ke),Sp=l(ke),Ns=s(ke,"P",{});var Fv=a(Ns);Dp=o(Fv,"Example:"),Fv.forEach(n),Lp=l(ke),b($o.$$.fragment,ke),ke.forEach(n),Ip=l(Q),yt=s(Q,"DIV",{class:!0});var Ld=a(yt);b(Eo.$$.fragment,Ld),Op=l(Ld),Ps=s(Ld,"P",{});var zv=a(Ps);Wp=o(zv,"Implements RAG token decoding."),zv.forEach(n),Ld.forEach(n),Q.forEach(n),dd=l(d),Be=s(d,"H2",{class:!0});var Id=a(Be);xt=s(Id,"A",{id:!0,class:!0,href:!0});var $v=a(xt);Cs=s($v,"SPAN",{});var Ev=a(Cs);b(Mo.$$.fragment,Ev),Ev.forEach(n),$v.forEach(n),Hp=l(Id),Ss=s(Id,"SPAN",{});var Mv=a(Ss);Bp=o(Mv,"TFRagModel"),Mv.forEach(n),Id.forEach(n),id=l(d),P=s(d,"DIV",{class:!0});var U=a(P);b(Go.$$.fragment,U),Qp=l(U),Qe=s(U,"P",{});var Tr=a(Qe);Vp=o(Tr,"The "),On=s(Tr,"A",{href:!0});var Gv=a(On);Up=o(Gv,"TFRagModel"),Gv.forEach(n),Kp=o(Tr," forward method, overrides the "),Ds=s(Tr,"CODE",{});var Av=a(Ds);Yp=o(Av,"__call__"),Av.forEach(n),Jp=o(Tr," special method."),Tr.forEach(n),Xp=l(U),b(Rt.$$.fragment,U),Zp=l(U),Ls=s(U,"P",{});var jv=a(Ls);em=o(jv,`RAG is a sequence-to-sequence model which encapsulates two core components: a question encoder and a generator.
During a forward pass, we encode the input with the question encoder and pass it to the retriever to extract
relevant context documents. The documents are then prepended to the input. Such contextualized inputs is passed to
the generator.`),jv.forEach(n),tm=l(U),he=s(U,"P",{});var qe=a(he);om=o(qe,"The question encoder can be any "),Is=s(qe,"EM",{});var Nv=a(Is);nm=o(Nv,"autoencoding"),Nv.forEach(n),rm=o(qe," model, preferably "),Wn=s(qe,"A",{href:!0});var Pv=a(Wn);sm=o(Pv,"TFDPRQuestionEncoder"),Pv.forEach(n),am=o(qe,`, and
the generator can be any `),Os=s(qe,"EM",{});var Cv=a(Os);dm=o(Cv,"seq2seq"),Cv.forEach(n),im=o(qe," model, preferably "),Hn=s(qe,"A",{href:!0});var Sv=a(Hn);cm=o(Sv,"TFBartForConditionalGeneration"),Sv.forEach(n),lm=o(qe,"."),qe.forEach(n),hm=l(U),L=s(U,"P",{});var K=a(L);pm=o(K,"The model can be initialized with a "),Bn=s(K,"A",{href:!0});var Dv=a(Bn);mm=o(Dv,"RagRetriever"),Dv.forEach(n),um=o(K,` for end-to-end generation or used in
combination with the outputs of a retriever in multiple steps---see examples for more details. The model is
compatible any `),Ws=s(K,"EM",{});var Lv=a(Ws);gm=o(Lv,"autoencoding"),Lv.forEach(n),_m=o(K," model as the "),Hs=s(K,"CODE",{});var Iv=a(Hs);fm=o(Iv,"question_encoder"),Iv.forEach(n),vm=o(K," and any "),Bs=s(K,"EM",{});var Ov=a(Bs);bm=o(Ov,"seq2seq"),Ov.forEach(n),Tm=o(K,` model with language model head as
...
and `),tr=s(Y,"A",{href:!0});var vb=a(tr);Cu=o(vb,"TFBartForConditionalGeneration"),vb.forEach(n),Su=o(Y," as the "),la=s(Y,"CODE",{});var bb=a(la);Du=o(bb,"generator"),bb.forEach(n),Lu=o(Y,"."),Y.forEach(n),Iu=l(C),Lo=s(C,"P",{});var Bd=a(Lo);Ou=o(Bd,"This model inherits from "),or=s(Bd,"A",{href:!0});var Tb=a(or);Wu=o(Tb,"TFPreTrainedModel"),Tb.forEach(n),Hu=o(Bd,`. Check the superclass documentation for the
generic methods the library implements for all its model (such as downloading or saving, resizing the input
embeddings, pruning heads etc.)`),Bd.forEach(n),Bu=l(C),Io=s(C,"P",{});var Qd=a(Io);Qu=o(Qd,"This model is also a Tensorflow "),Oo=s(Qd,"A",{href:!0,rel:!0});var wb=a(Oo);Vu=o(wb,"tf.keras.Model"),wb.forEach(n),Uu=o(Qd,`
subclass. Use it as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to
...
combination with the outputs of a retriever in multiple steps---see examples for more details. The model is
compatible any `),wa=s(J,"EM",{});var Db=a(wa);Lg=o(Db,"autoencoding"),Db.forEach(n),Ig=o(J," model as the "),ka=s(J,"CODE",{});var Lb=a(ka);Og=o(Lb,"question_encoder"),Lb.forEach(n),Wg=o(J," and any "),qa=s(J,"EM",{});var Ib=a(qa);Hg=o(Ib,"seq2seq"),Ib.forEach(n),Bg=o(J,` model with language model head as
