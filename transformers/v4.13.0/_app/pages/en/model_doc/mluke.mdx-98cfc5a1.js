import{S as mn,i as un,s as hn,e as o,k as p,w as B,t as r,L as fn,c as s,d as n,m,a,x as C,h as i,b as l,J as t,g as d,y as X,K as _n,q as Y,o as H,B as V}from"../../../chunks/vendor-e859c359.js";import{D as dn}from"../../../chunks/Docstring-ade913b3.js";import{C as pn}from"../../../chunks/CodeBlock-ce4317c2.js";import{I as Wt}from"../../../chunks/IconCopyLink-5fae3b20.js";import"../../../chunks/CopyButton-77addb3d.js";function gn(De){let k,J,h,_,le,M,Fe,ce,Oe,ke,w,T,de,$,Be,pe,Ce,ye,y,Xe,A,Ye,He,P,Ve,Je,ve,G,Ge,we,Q,Qe,be,Z,me,Ze,Te,ee,et,Le,I,xe,L,tt,te,nt,ot,ze,N,Ee,x,st,ne,at,rt,qe,v,it,U,lt,ct,W,dt,pt,Me,b,z,ue,K,mt,he,ut,$e,u,S,ht,g,ft,oe,_t,gt,se,kt,yt,R,vt,wt,bt,j,Tt,ae,Lt,xt,zt,D,Et,F,qt,fe,Mt,$t,At,Pt,E,O,It,_e,Nt,Ut,ge,Ae;return M=new Wt({}),$=new Wt({}),I=new pn({props:{code:`from transformers import LukeModel
...
<p><a
  href="/docs/transformers/master/en/main_classes/tokenizer#transformers.BatchEncoding"
>BatchEncoding</a></p>
`}}),{c(){k=o("meta"),J=p(),h=o("h1"),_=o("a"),le=o("span"),B(M.$$.fragment),Fe=p(),ce=o("span"),Oe=r("mLUKE"),ke=p(),w=o("h2"),T=o("a"),de=o("span"),B($.$$.fragment),Be=p(),pe=o("span"),Ce=r("Overview"),ye=p(),y=o("p"),Xe=r("The mLUKE model was proposed in "),A=o("a"),Ye=r("mLUKE: The Power of Entity Representations in Multilingual Pretrained Language Models"),He=r(` by Ryokan Ri, Ikuya Yamada, and Yoshimasa Tsuruoka. It\u2019s a multilingual extension
of the `),P=o("a"),Ve=r("LUKE model"),Je=r(" trained on the basis of XLM-RoBERTa."),ve=p(),G=o("p"),Ge=r(`It is based on XLM-RoBERTa and adds entity embeddings, which helps improve performance on various downstream tasks
involving reasoning about entities such as named entity recognition, extractive question answering, relation
classification, cloze-style knowledge completion.`),we=p(),Q=o("p"),Qe=r("The abstract from the paper is the following:"),be=p(),Z=o("p"),me=o("em"),Ze=r(`Recent studies have shown that multilingual pretrained language models can be effectively improved with cross-lingual
...
knowledge more likely than using only word representations.`),Te=p(),ee=o("p"),et=r("One can directly plug in the weights of mLUKE into a LUKE model, like so:"),Le=p(),B(I.$$.fragment),xe=p(),L=o("p"),tt=r("Note that mLUKE has its own tokenizer, "),te=o("a"),nt=r("MLukeTokenizer"),ot=r(". You can initialize it as follows:"),ze=p(),B(N.$$.fragment),Ee=p(),x=o("p"),st=r("As mLUKE\u2019s architecture is equivalent to that of LUKE, one can refer to "),ne=o("a"),at=r("LUKE\u2019s documentation page"),rt=r(` for all
tips, code examples and notebooks.`),qe=p(),v=o("p"),it=r("This model was contributed by "),U=o("a"),lt=r("ryo0634"),ct=r(". The original code can be found "),W=o("a"),dt=r("here"),pt=r("."),Me=p(),b=o("h2"),z=o("a"),ue=o("span"),B(K.$$.fragment),mt=p(),he=o("span"),ut=r("MLukeTokenizer"),$e=p(),u=o("div"),B(S.$$.fragment),ht=p(),g=o("p"),ft=r("Adapted from "),oe=o("a"),_t=r("XLMRobertaTokenizer"),gt=r(" and "),se=o("a"),kt=r("LukeTokenizer"),yt=r(`. Based on
`),R=o("a"),vt=r("SentencePiece"),wt=r("."),bt=p(),j=o("p"),Tt=r("This tokenizer inherits from "),ae=o("a"),Lt=r("PreTrainedTokenizer"),xt=r(` which contains most of the main methods.
Users should refer to this superclass for more information regarding those methods.`),zt=p(),D=o("p"),Et=r(`Attributes:
sp`),F=o("em"),qt=r("model ("),fe=o("code"),Mt=r("SentencePieceProcessor"),$t=r(`):
The _SentencePiece`),At=r(" processor that is used for every conversion (string, tokens and IDs)."),Pt=p(),E=o("div"),B(O.$$.fragment),It=p(),_e=o("p"),Nt=r(`Main method to tokenize and prepare for the model one or several sequence(s) or one or several pair(s) of
sequences, depending on the task you want to prepare them for.`),Ut=p(),ge=o("div"),this.h()},l(e){const c=fn('[data-svelte="svelte-1phssyn"]',document.head);k=s(c,"META",{name:!0,content:!0}),c.forEach(n),J=m(e),h=s(e,"H1",{class:!0});var Pe=a(h);_=s(Pe,"A",{id:!0,class:!0,href:!0});var Kt=a(_);le=s(Kt,"SPAN",{});var St=a(le);C(M.$$.fragment,St),St.forEach(n),Kt.forEach(n),Fe=m(Pe),ce=s(Pe,"SPAN",{});var Rt=a(ce);Oe=i(Rt,"mLUKE"),Rt.forEach(n),Pe.forEach(n),ke=m(e),w=s(e,"H2",{class:!0});var Ie=a(w);T=s(Ie,"A",{id:!0,class:!0,href:!0});var jt=a(T);de=s(jt,"SPAN",{});var Dt=a(de);C($.$$.fragment,Dt),Dt.forEach(n),jt.forEach(n),Be=m(Ie),pe=s(Ie,"SPAN",{});var Ft=a(pe);Ce=i(Ft,"Overview"),Ft.forEach(n),Ie.forEach(n),ye=m(e),y=s(e,"P",{});var re=a(y);Xe=i(re,"The mLUKE model was proposed in "),A=s(re,"A",{href:!0,rel:!0});var Ot=a(A);Ye=i(Ot,"mLUKE: The Power of Entity Representations in Multilingual Pretrained Language Models"),Ot.forEach(n),He=i(re,` by Ryokan Ri, Ikuya Yamada, and Yoshimasa Tsuruoka. It\u2019s a multilingual extension
of the `),P=s(re,"A",{href:!0,rel:!0});var Bt=a(P);Ve=i(Bt,"LUKE model"),Bt.forEach(n),Je=i(re," trained on the basis of XLM-RoBERTa."),re.forEach(n),ve=m(e),G=s(e,"P",{});var Ct=a(G);Ge=i(Ct,`It is based on XLM-RoBERTa and adds entity embeddings, which helps improve performance on various downstream tasks
involving reasoning about entities such as named entity recognition, extractive question answering, relation
classification, cloze-style knowledge completion.`),Ct.forEach(n),we=m(e),Q=s(e,"P",{});var Xt=a(Q);Qe=i(Xt,"The abstract from the paper is the following:"),Xt.forEach(n),be=m(e),Z=s(e,"P",{});var Yt=a(Z);me=s(Yt,"EM",{});var Ht=a(me);Ze=i(Ht,`Recent studies have shown that multilingual pretrained language models can be effectively improved with cross-lingual
alignment information from Wikipedia entities. However, existing methods only exploit entity information in pretraining
and do not explicitly use entities in downstream tasks. In this study, we explore the effectiveness of leveraging
entity representations for downstream cross-lingual tasks. We train a multilingual language model with 24 languages
with entity representations and show the model consistently outperforms word-based pretrained models in various
