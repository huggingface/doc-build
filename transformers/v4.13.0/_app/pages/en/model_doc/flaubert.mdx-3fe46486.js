import{S as Eb,i as zb,s as Cb,e as a,k as l,w as y,t as o,L as qb,c as r,d as t,m as d,a as i,x as F,h as n,b as h,J as e,g as m,y as M,q as $,o as x,B as L}from"../../../chunks/vendor-e859c359.js";import{T as Le}from"../../../chunks/Tip-edc75249.js";import{D as ie}from"../../../chunks/Docstring-ade913b3.js";import{C as nt}from"../../../chunks/CodeBlock-ce4317c2.js";import{I as Oe}from"../../../chunks/IconCopyLink-5fae3b20.js";import"../../../chunks/CopyButton-77addb3d.js";function Pb(O){let p,k,u,g,v;return{c(){p=a("p"),k=o(`Although the recipe for forward pass needs to be defined within this function, one should call the
...
processing steps while the latter silently ignores them.`)},l(b){p=r(b,"P",{});var f=i(p);k=n(f,`Although the recipe for forward pass needs to be defined within this function, one should call the
`),u=r(f,"CODE",{});var w=i(u);g=n(w,"Module"),w.forEach(t),v=n(f,` instance afterwards instead of this since the former takes care of running the pre and post
processing steps while the latter silently ignores them.`),f.forEach(t)},m(b,f){m(b,p,f),e(p,k),e(p,u),e(u,g),e(p,v)},d(b){b&&t(p)}}}function Db(O){let p,k,u,g,v,b,f,w,le,Y,E,G,H,Z,de,Q,ce,se,U,X,ee,J,z,q,te,R,ae,oe,B,pe,re,C,he,N,me,ue,I,fe,ge,j,K,S,ne;return{c(){p=a("p"),k=o("TF 2.0 models accepts two formats as inputs:"),u=l(),g=a("ul"),v=a("li"),b=o("having all inputs as keyword arguments (like PyTorch models), or"),f=l(),w=a("li"),le=o("having all inputs as a list, tuple or dict in the first positional arguments."),Y=l(),E=a("p"),G=o("This second option is useful when using "),H=a("code"),Z=o("tf.keras.Model.fit"),de=o(` method which currently requires having all
...
the first positional argument :`),J=l(),z=a("ul"),q=a("li"),te=o("a single Tensor with "),R=a("code"),ae=o("input_ids"),oe=o(" only and nothing else: "),B=a("code"),pe=o("model(inputs_ids)"),re=l(),C=a("li"),he=o(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
...
`),N=r(W,"CODE",{});var $e=i(N);me=n($e,"model([input_ids, attention_mask])"),$e.forEach(t),ue=n(W," or "),I=r(W,"CODE",{});var xe=i(I);fe=n(xe,"model([input_ids, attention_mask, token_type_ids])"),xe.forEach(t),W.forEach(t),ge=d(A),j=r(A,"LI",{});var be=i(j);K=n(be,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),S=r(be,"CODE",{});var ve=i(S);ne=n(ve,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),ve.forEach(t),be.forEach(t),A.forEach(t)},m(c,T){m(c,p,T),e(p,k),m(c,u,T),m(c,g,T),e(g,v),e(v,b),e(g,f),e(g,w),e(w,le),m(c,Y,T),m(c,E,T),e(E,G),e(E,H),e(H,Z),e(E,de),e(E,Q),e(Q,ce),e(E,se),m(c,U,T),m(c,X,T),e(X,ee),m(c,J,T),m(c,z,T),e(z,q),e(q,te),e(q,R),e(R,ae),e(q,oe),e(q,B),e(B,pe),e(z,re),e(z,C),e(C,he),e(C,N),e(N,me),e(C,ue),e(C,I),e(I,fe),e(z,ge),e(z,j),e(j,K),e(j,S),e(S,ne)},d(c){c&&t(p),c&&t(u),c&&t(g),c&&t(Y),c&&t(E),c&&t(U),c&&t(X),c&&t(J),c&&t(z)}}}function Wb(O){let p,k,u,g,v;return{c(){p=a("p"),k=o(`Although the recipe for forward pass needs to be defined within this function, one should call the
`),u=a("code"),g=o("Module"),v=o(` instance afterwards instead of this since the former takes care of running the pre and post
processing steps while the latter silently ignores them.`)},l(b){p=r(b,"P",{});var f=i(p);k=n(f,`Although the recipe for forward pass needs to be defined within this function, one should call the
`),u=r(f,"CODE",{});var w=i(u);g=n(w,"Module"),w.forEach(t),v=n(f,` instance afterwards instead of this since the former takes care of running the pre and post
processing steps while the latter silently ignores them.`),f.forEach(t)},m(b,f){m(b,p,f),e(p,k),e(p,u),e(u,g),e(p,v)},d(b){b&&t(p)}}}function Ob(O){let p,k,u,g,v,b,f,w,le,Y,E,G,H,Z,de,Q,ce,se,U,X,ee,J,z,q,te,R,ae,oe,B,pe,re,C,he,N,me,ue,I,fe,ge,j,K,S,ne;return{c(){p=a("p"),k=o("TF 2.0 models accepts two formats as inputs:"),u=l(),g=a("ul"),v=a("li"),b=o("having all inputs as keyword arguments (like PyTorch models), or"),f=l(),w=a("li"),le=o("having all inputs as a list, tuple or dict in the first positional arguments."),Y=l(),E=a("p"),G=o("This second option is useful when using "),H=a("code"),Z=o("tf.keras.Model.fit"),de=o(` method which currently requires having all
the tensors in the first argument of the model call function: `),Q=a("code"),ce=o("model(inputs)"),se=o("."),U=l(),X=a("p"),ee=o(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in
the first positional argument :`),J=l(),z=a("ul"),q=a("li"),te=o("a single Tensor with "),R=a("code"),ae=o("input_ids"),oe=o(" only and nothing else: "),B=a("code"),pe=o("model(inputs_ids)"),re=l(),C=a("li"),he=o(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),N=a("code"),me=o("model([input_ids, attention_mask])"),ue=o(" or "),I=a("code"),fe=o("model([input_ids, attention_mask, token_type_ids])"),ge=l(),j=a("li"),K=o(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),S=a("code"),ne=o('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(c){p=r(c,"P",{});var T=i(p);k=n(T,"TF 2.0 models accepts two formats as inputs:"),T.forEach(t),u=d(c),g=r(c,"UL",{});var V=i(g);v=r(V,"LI",{});var we=i(v);b=n(we,"having all inputs as keyword arguments (like PyTorch models), or"),we.forEach(t),f=d(V),w=r(V,"LI",{});var Te=i(w);le=n(Te,"having all inputs as a list, tuple or dict in the first positional arguments."),Te.forEach(t),V.forEach(t),Y=d(c),E=r(c,"P",{});var P=i(E);G=n(P,"This second option is useful when using "),H=r(P,"CODE",{});var ke=i(H);Z=n(ke,"tf.keras.Model.fit"),ke.forEach(t),de=n(P,` method which currently requires having all
...
the first positional argument :`),_e.forEach(t),J=d(c),z=r(c,"UL",{});var A=i(z);q=r(A,"LI",{});var D=i(q);te=n(D,"a single Tensor with "),R=r(D,"CODE",{});var Fe=i(R);ae=n(Fe,"input_ids"),Fe.forEach(t),oe=n(D," only and nothing else: "),B=r(D,"CODE",{});var Me=i(B);pe=n(Me,"model(inputs_ids)"),Me.forEach(t),D.forEach(t),re=d(A),C=r(A,"LI",{});var W=i(C);he=n(W,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),N=r(W,"CODE",{});var $e=i(N);me=n($e,"model([input_ids, attention_mask])"),$e.forEach(t),ue=n(W," or "),I=r(W,"CODE",{});var xe=i(I);fe=n(xe,"model([input_ids, attention_mask, token_type_ids])"),xe.forEach(t),W.forEach(t),ge=d(A),j=r(A,"LI",{});var be=i(j);K=n(be,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),S=r(be,"CODE",{});var ve=i(S);ne=n(ve,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),ve.forEach(t),be.forEach(t),A.forEach(t)},m(c,T){m(c,p,T),e(p,k),m(c,u,T),m(c,g,T),e(g,v),e(v,b),e(g,f),e(g,w),e(w,le),m(c,Y,T),m(c,E,T),e(E,G),e(E,H),e(H,Z),e(E,de),e(E,Q),e(Q,ce),e(E,se),m(c,U,T),m(c,X,T),e(X,ee),m(c,J,T),m(c,z,T),e(z,q),e(q,te),e(q,R),e(R,ae),e(q,oe),e(q,B),e(B,pe),e(z,re),e(z,C),e(C,he),e(C,N),e(N,me),e(C,ue),e(C,I),e(I,fe),e(z,ge),e(z,j),e(j,K),e(j,S),e(S,ne)},d(c){c&&t(p),c&&t(u),c&&t(g),c&&t(Y),c&&t(E),c&&t(U),c&&t(X),c&&t(J),c&&t(z)}}}function Hb(O){let p,k,u,g,v;return{c(){p=a("p"),k=o(`Although the recipe for forward pass needs to be defined within this function, one should call the
`),u=a("code"),g=o("Module"),v=o(` instance afterwards instead of this since the former takes care of running the pre and post
processing steps while the latter silently ignores them.`)},l(b){p=r(b,"P",{});var f=i(p);k=n(f,`Although the recipe for forward pass needs to be defined within this function, one should call the
`),u=r(f,"CODE",{});var w=i(u);g=n(w,"Module"),w.forEach(t),v=n(f,` instance afterwards instead of this since the former takes care of running the pre and post
processing steps while the latter silently ignores them.`),f.forEach(t)},m(b,f){m(b,p,f),e(p,k),e(p,u),e(u,g),e(p,v)},d(b){b&&t(p)}}}function Qb(O){let p,k,u,g,v,b,f,w,le,Y,E,G,H,Z,de,Q,ce,se,U,X,ee,J,z,q,te,R,ae,oe,B,pe,re,C,he,N,me,ue,I,fe,ge,j,K,S,ne;return{c(){p=a("p"),k=o("TF 2.0 models accepts two formats as inputs:"),u=l(),g=a("ul"),v=a("li"),b=o("having all inputs as keyword arguments (like PyTorch models), or"),f=l(),w=a("li"),le=o("having all inputs as a list, tuple or dict in the first positional arguments."),Y=l(),E=a("p"),G=o("This second option is useful when using "),H=a("code"),Z=o("tf.keras.Model.fit"),de=o(` method which currently requires having all
the tensors in the first argument of the model call function: `),Q=a("code"),ce=o("model(inputs)"),se=o("."),U=l(),X=a("p"),ee=o(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in
the first positional argument :`),J=l(),z=a("ul"),q=a("li"),te=o("a single Tensor with "),R=a("code"),ae=o("input_ids"),oe=o(" only and nothing else: "),B=a("code"),pe=o("model(inputs_ids)"),re=l(),C=a("li"),he=o(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),N=a("code"),me=o("model([input_ids, attention_mask])"),ue=o(" or "),I=a("code"),fe=o("model([input_ids, attention_mask, token_type_ids])"),ge=l(),j=a("li"),K=o(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),S=a("code"),ne=o('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(c){p=r(c,"P",{});var T=i(p);k=n(T,"TF 2.0 models accepts two formats as inputs:"),T.forEach(t),u=d(c),g=r(c,"UL",{});var V=i(g);v=r(V,"LI",{});var we=i(v);b=n(we,"having all inputs as keyword arguments (like PyTorch models), or"),we.forEach(t),f=d(V),w=r(V,"LI",{});var Te=i(w);le=n(Te,"having all inputs as a list, tuple or dict in the first positional arguments."),Te.forEach(t),V.forEach(t),Y=d(c),E=r(c,"P",{});var P=i(E);G=n(P,"This second option is useful when using "),H=r(P,"CODE",{});var ke=i(H);Z=n(ke,"tf.keras.Model.fit"),ke.forEach(t),de=n(P,` method which currently requires having all
...
the first positional argument :`),_e.forEach(t),J=d(c),z=r(c,"UL",{});var A=i(z);q=r(A,"LI",{});var D=i(q);te=n(D,"a single Tensor with "),R=r(D,"CODE",{});var Fe=i(R);ae=n(Fe,"input_ids"),Fe.forEach(t),oe=n(D," only and nothing else: "),B=r(D,"CODE",{});var Me=i(B);pe=n(Me,"model(inputs_ids)"),Me.forEach(t),D.forEach(t),re=d(A),C=r(A,"LI",{});var W=i(C);he=n(W,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),N=r(W,"CODE",{});var $e=i(N);me=n($e,"model([input_ids, attention_mask])"),$e.forEach(t),ue=n(W," or "),I=r(W,"CODE",{});var xe=i(I);fe=n(xe,"model([input_ids, attention_mask, token_type_ids])"),xe.forEach(t),W.forEach(t),ge=d(A),j=r(A,"LI",{});var be=i(j);K=n(be,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),S=r(be,"CODE",{});var ve=i(S);ne=n(ve,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),ve.forEach(t),be.forEach(t),A.forEach(t)},m(c,T){m(c,p,T),e(p,k),m(c,u,T),m(c,g,T),e(g,v),e(v,b),e(g,f),e(g,w),e(w,le),m(c,Y,T),m(c,E,T),e(E,G),e(E,H),e(H,Z),e(E,de),e(E,Q),e(Q,ce),e(E,se),m(c,U,T),m(c,X,T),e(X,ee),m(c,J,T),m(c,z,T),e(z,q),e(q,te),e(q,R),e(R,ae),e(q,oe),e(q,B),e(B,pe),e(z,re),e(z,C),e(C,he),e(C,N),e(N,me),e(C,ue),e(C,I),e(I,fe),e(z,ge),e(z,j),e(j,K),e(j,S),e(S,ne)},d(c){c&&t(p),c&&t(u),c&&t(g),c&&t(Y),c&&t(E),c&&t(U),c&&t(X),c&&t(J),c&&t(z)}}}function Bb(O){let p,k,u,g,v;return{c(){p=a("p"),k=o(`Although the recipe for forward pass needs to be defined within this function, one should call the
`),u=a("code"),g=o("Module"),v=o(` instance afterwards instead of this since the former takes care of running the pre and post
processing steps while the latter silently ignores them.`)},l(b){p=r(b,"P",{});var f=i(p);k=n(f,`Although the recipe for forward pass needs to be defined within this function, one should call the
`),u=r(f,"CODE",{});var w=i(u);g=n(w,"Module"),w.forEach(t),v=n(f,` instance afterwards instead of this since the former takes care of running the pre and post
processing steps while the latter silently ignores them.`),f.forEach(t)},m(b,f){m(b,p,f),e(p,k),e(p,u),e(u,g),e(p,v)},d(b){b&&t(p)}}}function Rb(O){let p,k,u,g,v,b,f,w,le,Y,E,G,H,Z,de,Q,ce,se,U,X,ee,J,z,q,te,R,ae,oe,B,pe,re,C,he,N,me,ue,I,fe,ge,j,K,S,ne;return{c(){p=a("p"),k=o("TF 2.0 models accepts two formats as inputs:"),u=l(),g=a("ul"),v=a("li"),b=o("having all inputs as keyword arguments (like PyTorch models), or"),f=l(),w=a("li"),le=o("having all inputs as a list, tuple or dict in the first positional arguments."),Y=l(),E=a("p"),G=o("This second option is useful when using "),H=a("code"),Z=o("tf.keras.Model.fit"),de=o(` method which currently requires having all
the tensors in the first argument of the model call function: `),Q=a("code"),ce=o("model(inputs)"),se=o("."),U=l(),X=a("p"),ee=o(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in
the first positional argument :`),J=l(),z=a("ul"),q=a("li"),te=o("a single Tensor with "),R=a("code"),ae=o("input_ids"),oe=o(" only and nothing else: "),B=a("code"),pe=o("model(inputs_ids)"),re=l(),C=a("li"),he=o(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),N=a("code"),me=o("model([input_ids, attention_mask])"),ue=o(" or "),I=a("code"),fe=o("model([input_ids, attention_mask, token_type_ids])"),ge=l(),j=a("li"),K=o(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),S=a("code"),ne=o('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(c){p=r(c,"P",{});var T=i(p);k=n(T,"TF 2.0 models accepts two formats as inputs:"),T.forEach(t),u=d(c),g=r(c,"UL",{});var V=i(g);v=r(V,"LI",{});var we=i(v);b=n(we,"having all inputs as keyword arguments (like PyTorch models), or"),we.forEach(t),f=d(V),w=r(V,"LI",{});var Te=i(w);le=n(Te,"having all inputs as a list, tuple or dict in the first positional arguments."),Te.forEach(t),V.forEach(t),Y=d(c),E=r(c,"P",{});var P=i(E);G=n(P,"This second option is useful when using "),H=r(P,"CODE",{});var ke=i(H);Z=n(ke,"tf.keras.Model.fit"),ke.forEach(t),de=n(P,` method which currently requires having all
...
the first positional argument :`),_e.forEach(t),J=d(c),z=r(c,"UL",{});var A=i(z);q=r(A,"LI",{});var D=i(q);te=n(D,"a single Tensor with "),R=r(D,"CODE",{});var Fe=i(R);ae=n(Fe,"input_ids"),Fe.forEach(t),oe=n(D," only and nothing else: "),B=r(D,"CODE",{});var Me=i(B);pe=n(Me,"model(inputs_ids)"),Me.forEach(t),D.forEach(t),re=d(A),C=r(A,"LI",{});var W=i(C);he=n(W,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),N=r(W,"CODE",{});var $e=i(N);me=n($e,"model([input_ids, attention_mask])"),$e.forEach(t),ue=n(W," or "),I=r(W,"CODE",{});var xe=i(I);fe=n(xe,"model([input_ids, attention_mask, token_type_ids])"),xe.forEach(t),W.forEach(t),ge=d(A),j=r(A,"LI",{});var be=i(j);K=n(be,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),S=r(be,"CODE",{});var ve=i(S);ne=n(ve,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),ve.forEach(t),be.forEach(t),A.forEach(t)},m(c,T){m(c,p,T),e(p,k),m(c,u,T),m(c,g,T),e(g,v),e(v,b),e(g,f),e(g,w),e(w,le),m(c,Y,T),m(c,E,T),e(E,G),e(E,H),e(H,Z),e(E,de),e(E,Q),e(Q,ce),e(E,se),m(c,U,T),m(c,X,T),e(X,ee),m(c,J,T),m(c,z,T),e(z,q),e(q,te),e(q,R),e(R,ae),e(q,oe),e(q,B),e(B,pe),e(z,re),e(z,C),e(C,he),e(C,N),e(N,me),e(C,ue),e(C,I),e(I,fe),e(z,ge),e(z,j),e(j,K),e(j,S),e(S,ne)},d(c){c&&t(p),c&&t(u),c&&t(g),c&&t(Y),c&&t(E),c&&t(U),c&&t(X),c&&t(J),c&&t(z)}}}function Ub(O){let p,k,u,g,v;return{c(){p=a("p"),k=o(`Although the recipe for forward pass needs to be defined within this function, one should call the
`),u=a("code"),g=o("Module"),v=o(` instance afterwards instead of this since the former takes care of running the pre and post
processing steps while the latter silently ignores them.`)},l(b){p=r(b,"P",{});var f=i(p);k=n(f,`Although the recipe for forward pass needs to be defined within this function, one should call the
`),u=r(f,"CODE",{});var w=i(u);g=n(w,"Module"),w.forEach(t),v=n(f,` instance afterwards instead of this since the former takes care of running the pre and post
processing steps while the latter silently ignores them.`),f.forEach(t)},m(b,f){m(b,p,f),e(p,k),e(p,u),e(u,g),e(p,v)},d(b){b&&t(p)}}}function Vb(O){let p,k,u,g,v,b,f,w,le,Y,E,G,H,Z,de,Q,ce,se,U,X,ee,J,z,q,te,R,ae,oe,B,pe,re,C,he,N,me,ue,I,fe,ge,j,K,S,ne;return{c(){p=a("p"),k=o("TF 2.0 models accepts two formats as inputs:"),u=l(),g=a("ul"),v=a("li"),b=o("having all inputs as keyword arguments (like PyTorch models), or"),f=l(),w=a("li"),le=o("having all inputs as a list, tuple or dict in the first positional arguments."),Y=l(),E=a("p"),G=o("This second option is useful when using "),H=a("code"),Z=o("tf.keras.Model.fit"),de=o(` method which currently requires having all
the tensors in the first argument of the model call function: `),Q=a("code"),ce=o("model(inputs)"),se=o("."),U=l(),X=a("p"),ee=o(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in
the first positional argument :`),J=l(),z=a("ul"),q=a("li"),te=o("a single Tensor with "),R=a("code"),ae=o("input_ids"),oe=o(" only and nothing else: "),B=a("code"),pe=o("model(inputs_ids)"),re=l(),C=a("li"),he=o(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),N=a("code"),me=o("model([input_ids, attention_mask])"),ue=o(" or "),I=a("code"),fe=o("model([input_ids, attention_mask, token_type_ids])"),ge=l(),j=a("li"),K=o(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),S=a("code"),ne=o('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(c){p=r(c,"P",{});var T=i(p);k=n(T,"TF 2.0 models accepts two formats as inputs:"),T.forEach(t),u=d(c),g=r(c,"UL",{});var V=i(g);v=r(V,"LI",{});var we=i(v);b=n(we,"having all inputs as keyword arguments (like PyTorch models), or"),we.forEach(t),f=d(V),w=r(V,"LI",{});var Te=i(w);le=n(Te,"having all inputs as a list, tuple or dict in the first positional arguments."),Te.forEach(t),V.forEach(t),Y=d(c),E=r(c,"P",{});var P=i(E);G=n(P,"This second option is useful when using "),H=r(P,"CODE",{});var ke=i(H);Z=n(ke,"tf.keras.Model.fit"),ke.forEach(t),de=n(P,` method which currently requires having all
...
the first positional argument :`),_e.forEach(t),J=d(c),z=r(c,"UL",{});var A=i(z);q=r(A,"LI",{});var D=i(q);te=n(D,"a single Tensor with "),R=r(D,"CODE",{});var Fe=i(R);ae=n(Fe,"input_ids"),Fe.forEach(t),oe=n(D," only and nothing else: "),B=r(D,"CODE",{});var Me=i(B);pe=n(Me,"model(inputs_ids)"),Me.forEach(t),D.forEach(t),re=d(A),C=r(A,"LI",{});var W=i(C);he=n(W,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),N=r(W,"CODE",{});var $e=i(N);me=n($e,"model([input_ids, attention_mask])"),$e.forEach(t),ue=n(W," or "),I=r(W,"CODE",{});var xe=i(I);fe=n(xe,"model([input_ids, attention_mask, token_type_ids])"),xe.forEach(t),W.forEach(t),ge=d(A),j=r(A,"LI",{});var be=i(j);K=n(be,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),S=r(be,"CODE",{});var ve=i(S);ne=n(ve,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),ve.forEach(t),be.forEach(t),A.forEach(t)},m(c,T){m(c,p,T),e(p,k),m(c,u,T),m(c,g,T),e(g,v),e(v,b),e(g,f),e(g,w),e(w,le),m(c,Y,T),m(c,E,T),e(E,G),e(E,H),e(H,Z),e(E,de),e(E,Q),e(Q,ce),e(E,se),m(c,U,T),m(c,X,T),e(X,ee),m(c,J,T),m(c,z,T),e(z,q),e(q,te),e(q,R),e(R,ae),e(q,oe),e(q,B),e(B,pe),e(z,re),e(z,C),e(C,he),e(C,N),e(N,me),e(C,ue),e(C,I),e(I,fe),e(z,ge),e(z,j),e(j,K),e(j,S),e(S,ne)},d(c){c&&t(p),c&&t(u),c&&t(g),c&&t(Y),c&&t(E),c&&t(U),c&&t(X),c&&t(J),c&&t(z)}}}function Yb(O){let p,k,u,g,v;return{c(){p=a("p"),k=o(`Although the recipe for forward pass needs to be defined within this function, one should call the
`),u=a("code"),g=o("Module"),v=o(` instance afterwards instead of this since the former takes care of running the pre and post
processing steps while the latter silently ignores them.`)},l(b){p=r(b,"P",{});var f=i(p);k=n(f,`Although the recipe for forward pass needs to be defined within this function, one should call the
`),u=r(f,"CODE",{});var w=i(u);g=n(w,"Module"),w.forEach(t),v=n(f,` instance afterwards instead of this since the former takes care of running the pre and post
processing steps while the latter silently ignores them.`),f.forEach(t)},m(b,f){m(b,p,f),e(p,k),e(p,u),e(u,g),e(p,v)},d(b){b&&t(p)}}}function Jb(O){let p,k,u,g,v,b,f,w,le,Y,E,G,H,Z,de,Q,ce,se,U,X,ee,J,z,q,te,R,ae,oe,B,pe,re,C,he,N,me,ue,I,fe,ge,j,K,S,ne;return{c(){p=a("p"),k=o("TF 2.0 models accepts two formats as inputs:"),u=l(),g=a("ul"),v=a("li"),b=o("having all inputs as keyword arguments (like PyTorch models), or"),f=l(),w=a("li"),le=o("having all inputs as a list, tuple or dict in the first positional arguments."),Y=l(),E=a("p"),G=o("This second option is useful when using "),H=a("code"),Z=o("tf.keras.Model.fit"),de=o(` method which currently requires having all
the tensors in the first argument of the model call function: `),Q=a("code"),ce=o("model(inputs)"),se=o("."),U=l(),X=a("p"),ee=o(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in
the first positional argument :`),J=l(),z=a("ul"),q=a("li"),te=o("a single Tensor with "),R=a("code"),ae=o("input_ids"),oe=o(" only and nothing else: "),B=a("code"),pe=o("model(inputs_ids)"),re=l(),C=a("li"),he=o(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),N=a("code"),me=o("model([input_ids, attention_mask])"),ue=o(" or "),I=a("code"),fe=o("model([input_ids, attention_mask, token_type_ids])"),ge=l(),j=a("li"),K=o(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),S=a("code"),ne=o('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(c){p=r(c,"P",{});var T=i(p);k=n(T,"TF 2.0 models accepts two formats as inputs:"),T.forEach(t),u=d(c),g=r(c,"UL",{});var V=i(g);v=r(V,"LI",{});var we=i(v);b=n(we,"having all inputs as keyword arguments (like PyTorch models), or"),we.forEach(t),f=d(V),w=r(V,"LI",{});var Te=i(w);le=n(Te,"having all inputs as a list, tuple or dict in the first positional arguments."),Te.forEach(t),V.forEach(t),Y=d(c),E=r(c,"P",{});var P=i(E);G=n(P,"This second option is useful when using "),H=r(P,"CODE",{});var ke=i(H);Z=n(ke,"tf.keras.Model.fit"),ke.forEach(t),de=n(P,` method which currently requires having all
...
the first positional argument :`),_e.forEach(t),J=d(c),z=r(c,"UL",{});var A=i(z);q=r(A,"LI",{});var D=i(q);te=n(D,"a single Tensor with "),R=r(D,"CODE",{});var Fe=i(R);ae=n(Fe,"input_ids"),Fe.forEach(t),oe=n(D," only and nothing else: "),B=r(D,"CODE",{});var Me=i(B);pe=n(Me,"model(inputs_ids)"),Me.forEach(t),D.forEach(t),re=d(A),C=r(A,"LI",{});var W=i(C);he=n(W,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),N=r(W,"CODE",{});var $e=i(N);me=n($e,"model([input_ids, attention_mask])"),$e.forEach(t),ue=n(W," or "),I=r(W,"CODE",{});var xe=i(I);fe=n(xe,"model([input_ids, attention_mask, token_type_ids])"),xe.forEach(t),W.forEach(t),ge=d(A),j=r(A,"LI",{});var be=i(j);K=n(be,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),S=r(be,"CODE",{});var ve=i(S);ne=n(ve,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),ve.forEach(t),be.forEach(t),A.forEach(t)},m(c,T){m(c,p,T),e(p,k),m(c,u,T),m(c,g,T),e(g,v),e(v,b),e(g,f),e(g,w),e(w,le),m(c,Y,T),m(c,E,T),e(E,G),e(E,H),e(H,Z),e(E,de),e(E,Q),e(Q,ce),e(E,se),m(c,U,T),m(c,X,T),e(X,ee),m(c,J,T),m(c,z,T),e(z,q),e(q,te),e(q,R),e(R,ae),e(q,oe),e(q,B),e(B,pe),e(z,re),e(z,C),e(C,he),e(C,N),e(N,me),e(C,ue),e(C,I),e(I,fe),e(z,ge),e(z,j),e(j,K),e(j,S),e(S,ne)},d(c){c&&t(p),c&&t(u),c&&t(g),c&&t(Y),c&&t(E),c&&t(U),c&&t(X),c&&t(J),c&&t(z)}}}function Kb(O){let p,k,u,g,v;return{c(){p=a("p"),k=o(`Although the recipe for forward pass needs to be defined within this function, one should call the
`),u=a("code"),g=o("Module"),v=o(` instance afterwards instead of this since the former takes care of running the pre and post
processing steps while the latter silently ignores them.`)},l(b){p=r(b,"P",{});var f=i(p);k=n(f,`Although the recipe for forward pass needs to be defined within this function, one should call the
`),u=r(f,"CODE",{});var w=i(u);g=n(w,"Module"),w.forEach(t),v=n(f,` instance afterwards instead of this since the former takes care of running the pre and post
processing steps while the latter silently ignores them.`),f.forEach(t)},m(b,f){m(b,p,f),e(p,k),e(p,u),e(u,g),e(p,v)},d(b){b&&t(p)}}}function Gb(O){let p,k,u,g,v,b,f,w,le,Y,E,G,H,Z,de,Q,ce,se,U,X,ee,J,z,q,te,R,ae,oe,B,pe,re,C,he,N,me,ue,I,fe,ge,j,K,S,ne,c,T,V,we,Te,P,ke,ye,_e,A,D,Fe,Me,W,$e,xe,be,ve,Gl,Bs,Zl,ed,Rs,td,od,Ei,qt,co,Ba,Ro,nd,Ra,sd,zi,st,Uo,ad,Ua,rd,id,_t,Va,ld,dd,Ya,cd,pd,bt,hd,Ja,md,ud,Ka,fd,gd,Ga,_d,bd,vd,Vo,kd,Za,Td,wd,yd,Yo,Fd,Us,Md,$d,Ci,Pt,po,er,Jo,xd,tr,Ld,qi,He,Ko,Ed,or,zd,Cd,Go,qd,Vs,Pd,jd,Xd,Zo,Ad,en,Sd,Nd,Id,Qe,tn,Dd,jt,Wd,Ys,Od,Hd,nr,Qd,Bd,Rd,ho,Ud,sr,Vd,Yd,on,Pi,Xt,mo,ar,nn,Jd,rr,Kd,ji,ze,sn,Gd,ir,Zd,ec,an,tc,Js,oc,nc,sc,rn,ac,ln,rc,ic,lc,dn,dc,Ks,cc,pc,hc,Be,cn,mc,At,uc,Gs,fc,gc,lr,_c,bc,vc,uo,kc,dr,Tc,wc,pn,Xi,St,fo,cr,hn,yc,pr,Fc,Ai,Ce,mn,Mc,hr,$c,xc,un,Lc,Zs,Ec,zc,Cc,fn,qc,gn,Pc,jc,Xc,_n,Ac,ea,Sc,Nc,Ic,Ee,bn,Dc,Nt,Wc,ta,Oc,Hc,mr,Qc,Bc,Rc,go,Uc,ur,Vc,Yc,vn,Jc,fr,Kc,Gc,kn,Si,It,_o,gr,Tn,Zc,_r,ep,Ni,qe,wn,tp,br,op,np,yn,sp,oa,ap,rp,ip,Fn,lp,Mn,dp,cp,pp,$n,hp,na,mp,up,fp,Re,xn,gp,Dt,_p,sa,bp,vp,vr,kp,Tp,wp,bo,yp,kr,Fp,Mp,Ln,Ii,Wt,vo,Tr,En,$p,wr,xp,Di,Pe,zn,Lp,yr,Ep,zp,Cn,Cp,aa,qp,Pp,jp,qn,Xp,Pn,Ap,Sp,Np,jn,Ip,ra,Dp,Wp,Op,Ue,Xn,Hp,Ot,Qp,ia,Bp,Rp,Fr,Up,Vp,Yp,ko,Jp,Mr,Kp,Gp,An,Wi,Ht,To,$r,Sn,Zp,xr,eh,Oi,je,Nn,th,Qt,oh,Lr,nh,sh,Er,ah,rh,ih,In,lh,la,dh,ch,ph,Dn,hh,Wn,mh,uh,fh,On,gh,da,_h,bh,vh,Ve,Hn,kh,Bt,Th,ca,wh,yh,zr,Fh,Mh,$h,wo,xh,Cr,Lh,Eh,Qn,Hi,Rt,yo,qr,Bn,zh,Pr,Ch,Qi,Xe,Rn,qh,Ut,Ph,jr,jh,Xh,Xr,Ah,Sh,Nh,Un,Ih,pa,Dh,Wh,Oh,Vn,Hh,Yn,Qh,Bh,Rh,Jn,Uh,ha,Vh,Yh,Jh,Ye,Kn,Kh,Vt,Gh,ma,Zh,em,Ar,tm,om,nm,Fo,sm,Sr,am,rm,Gn,Bi,Yt,Mo,Nr,Zn,im,Ir,lm,Ri,Ae,es,dm,Dr,cm,pm,ts,hm,ua,mm,um,fm,os,gm,ns,_m,bm,vm,$o,km,Je,ss,Tm,Jt,wm,fa,ym,Fm,Wr,Mm,$m,xm,xo,Lm,Or,Em,zm,as,Ui,Kt,Lo,Hr,rs,Cm,Qr,qm,Vi,Se,is,Pm,Br,jm,Xm,ls,Am,ga,Sm,Nm,Im,ds,Dm,cs,Wm,Om,Hm,Eo,Qm,Ke,ps,Bm,Gt,Rm,_a,Um,Vm,Rr,Ym,Jm,Km,zo,Gm,Ur,Zm,eu,hs,Yi,Zt,Co,Vr,ms,tu,Yr,ou,Ji,Ne,us,nu,Jr,su,au,fs,ru,ba,iu,lu,du,gs,cu,_s,pu,hu,mu,qo,uu,Ge,bs,fu,eo,gu,va,_u,bu,Kr,vu,ku,Tu,Po,wu,Gr,yu,Fu,vs,Ki,to,jo,Zr,ks,Mu,ei,$u,Gi,Ie,Ts,xu,ti,Lu,Eu,ws,zu,ka,Cu,qu,Pu,ys,ju,Fs,Xu,Au,Su,Xo,Nu,Ze,Ms,Iu,oo,Du,Ta,Wu,Ou,oi,Hu,Qu,Bu,Ao,Ru,ni,Uu,Vu,$s,Zi,no,So,si,xs,Yu,ai,Ju,el,De,Ls,Ku,ri,Gu,Zu,Es,ef,wa,tf,of,nf,zs,sf,Cs,af,rf,lf,No,df,et,qs,cf,so,pf,ya,hf,mf,ii,uf,ff,gf,Io,_f,li,bf,vf,Ps,tl,ao,Do,di,js,kf,ci,Tf,ol,We,Xs,wf,ro,yf,pi,Ff,Mf,hi,$f,xf,Lf,As,Ef,Fa,zf,Cf,qf,Ss,Pf,Ns,jf,Xf,Af,Wo,Sf,tt,Is,Nf,io,If,Ma,Df,Wf,mi,Of,Hf,Qf,Oo,Bf,ui,Rf,Uf,Ds,nl;return b=new Oe({}),Z=new Oe({}),c=new Oe({}),ke=new ie({props:{name:"class transformers.FlaubertConfig",anchor:"transformers.FlaubertConfig",parameters:[{name:"layerdrop",val:" = 0.0"},{name:"pre_norm",val:" = False"},{name:"pad_token_id",val:" = 2"},{name:"bos_token_id",val:" = 0"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/master/src/transformers/models/flaubert/configuration_flaubert.py#L31",parametersDescription:[{anchor:"transformers.FlaubertConfig.pre_norm",description:`<strong>pre_norm</strong> (<code>bool</code>, <em>optional</em>, defaults to <code>False</code>) &#x2014;
...
<span class="hljs-meta">&gt;&gt;&gt; </span>answer = <span class="hljs-string">&#x27; &#x27;</span>.join(all_tokens[tf.math.argmax(start_logits, <span class="hljs-number">1</span>)[<span class="hljs-number">0</span>] : tf.math.argmax(end_logits, <span class="hljs-number">1</span>)[<span class="hljs-number">0</span>]+<span class="hljs-number">1</span>])`}}),{c(){p=a("meta"),k=l(),u=a("h1"),g=a("a"),v=a("span"),y(b.$$.fragment),f=l(),w=a("span"),le=o("FlauBERT"),Y=l(),E=a("h2"),G=a("a"),H=a("span"),y(Z.$$.fragment),de=l(),Q=a("span"),ce=o("Overview"),se=l(),U=a("p"),X=o("The FlauBERT model was proposed in the paper "),ee=a("a"),J=o("FlauBERT: Unsupervised Language Model Pre-training for French"),z=o(` by Hang Le et al. It\u2019s a transformer model pretrained using a masked language
...
outputs. Read the documentation from `),Rs=a("a"),td=o("PretrainedConfig"),od=o(" for more information."),Ei=l(),qt=a("h2"),co=a("a"),Ba=a("span"),y(Ro.$$.fragment),nd=l(),Ra=a("span"),sd=o("FlaubertTokenizer"),zi=l(),st=a("div"),y(Uo.$$.fragment),ad=l(),Ua=a("p"),rd=o("Construct a Flaubert tokenizer. Based on Byte-Pair Encoding. The tokenization process is the following:"),id=l(),_t=a("ul"),Va=a("li"),ld=o("Moses preprocessing and tokenization."),dd=l(),Ya=a("li"),cd=o("Normalizing all inputs text."),pd=l(),bt=a("li"),hd=o("The arguments "),Ja=a("code"),md=o("special_tokens"),ud=o(" and the function "),Ka=a("code"),fd=o("set_special_tokens"),gd=o(`, can be used to add additional symbols
...
general usage and behavior.`),Id=l(),Qe=a("div"),y(tn.$$.fragment),Dd=l(),jt=a("p"),Wd=o("The "),Ys=a("a"),Od=o("FlaubertModel"),Hd=o(" forward method, overrides the "),nr=a("code"),Qd=o("__call__"),Bd=o(" special method."),Rd=l(),y(ho.$$.fragment),Ud=l(),sr=a("p"),Vd=o("Example:"),Yd=l(),y(on.$$.fragment),Pi=l(),Xt=a("h2"),mo=a("a"),ar=a("span"),y(nn.$$.fragment),Jd=l(),rr=a("span"),Kd=o("FlaubertWithLMHeadModel"),ji=l(),ze=a("div"),y(sn.$$.fragment),Gd=l(),ir=a("p"),Zd=o(`The Flaubert Model transformer with a language modeling head on top (linear layer with weights tied to the input
embeddings).`),ec=l(),an=a("p"),tc=o("This model inherits from "),Js=a("a"),oc=o("PreTrainedModel"),nc=o(`. Check the superclass documentation for the generic
methods the library implements for all its model (such as downloading or saving, resizing the input embeddings,
pruning heads etc.)`),sc=l(),rn=a("p"),ac=o("This model is also a PyTorch "),ln=a("a"),rc=o("torch.nn.Module"),ic=o(`
subclass. Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to
general usage and behavior.`),lc=l(),dn=a("p"),dc=o("This class overrides "),Ks=a("a"),cc=o("XLMWithLMHeadModel"),pc=o(`. Please check the superclass for the appropriate
documentation alongside usage examples.`),hc=l(),Be=a("div"),y(cn.$$.fragment),mc=l(),At=a("p"),uc=o("The "),Gs=a("a"),fc=o("XLMWithLMHeadModel"),gc=o(" forward method, overrides the "),lr=a("code"),_c=o("__call__"),bc=o(" special method."),vc=l(),y(uo.$$.fragment),kc=l(),dr=a("p"),Tc=o("Example:"),wc=l(),y(pn.$$.fragment),Xi=l(),St=a("h2"),fo=a("a"),cr=a("span"),y(hn.$$.fragment),yc=l(),pr=a("span"),Fc=o("FlaubertForSequenceClassification"),Ai=l(),Ce=a("div"),y(mn.$$.fragment),Mc=l(),hr=a("p"),$c=o(`Flaubert Model with a sequence classification/regression head on top (a linear layer on top of the pooled output)
...
appropriate documentation alongside usage examples.`),Ic=l(),Ee=a("div"),y(bn.$$.fragment),Dc=l(),Nt=a("p"),Wc=o("The "),ta=a("a"),Oc=o("XLMForSequenceClassification"),Hc=o(" forward method, overrides the "),mr=a("code"),Qc=o("__call__"),Bc=o(" special method."),Rc=l(),y(go.$$.fragment),Uc=l(),ur=a("p"),Vc=o("Example of single-label classification:"),Yc=l(),y(vn.$$.fragment),Jc=l(),fr=a("p"),Kc=o("Example of multi-label classification:"),Gc=l(),y(kn.$$.fragment),Si=l(),It=a("h2"),_o=a("a"),gr=a("span"),y(Tn.$$.fragment),Zc=l(),_r=a("span"),ep=o("FlaubertForMultipleChoice"),Ni=l(),qe=a("div"),y(wn.$$.fragment),tp=l(),br=a("p"),op=o(`Flaubert Model with a multiple choice classification head on top (a linear layer on top of the pooled output and a
...
appropriate documentation alongside usage examples.`),Op=l(),Ue=a("div"),y(Xn.$$.fragment),Hp=l(),Ot=a("p"),Qp=o("The "),ia=a("a"),Bp=o("XLMForTokenClassification"),Rp=o(" forward method, overrides the "),Fr=a("code"),Up=o("__call__"),Vp=o(" special method."),Yp=l(),y(ko.$$.fragment),Jp=l(),Mr=a("p"),Kp=o("Example:"),Gp=l(),y(An.$$.fragment),Wi=l(),Ht=a("h2"),To=a("a"),$r=a("span"),y(Sn.$$.fragment),Zp=l(),xr=a("span"),eh=o("FlaubertForQuestionAnsweringSimple"),Oi=l(),je=a("div"),y(Nn.$$.fragment),th=l(),Qt=a("p"),oh=o(`Flaubert Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
...
subclass. Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to
general usage and behavior.`),Rh=l(),Jn=a("p"),Uh=o("This class overrides "),ha=a("a"),Vh=o("XLMForQuestionAnswering"),Yh=o(`. Please check the superclass for the
appropriate documentation alongside usage examples.`),Jh=l(),Ye=a("div"),y(Kn.$$.fragment),Kh=l(),Vt=a("p"),Gh=o("The "),ma=a("a"),Zh=o("XLMForQuestionAnswering"),em=o(" forward method, overrides the "),Ar=a("code"),tm=o("__call__"),om=o(" special method."),nm=l(),y(Fo.$$.fragment),sm=l(),Sr=a("p"),am=o("Example:"),rm=l(),y(Gn.$$.fragment),Bi=l(),Yt=a("h2"),Mo=a("a"),Nr=a("span"),y(Zn.$$.fragment),im=l(),Ir=a("span"),lm=o("TFFlaubertModel"),Ri=l(),Ae=a("div"),y(es.$$.fragment),dm=l(),Dr=a("p"),cm=o("The bare Flaubert Model transformer outputting raw hidden-states without any specific head on top."),pm=l(),ts=a("p"),hm=o("This model inherits from "),ua=a("a"),mm=o("TFPreTrainedModel"),um=o(`. Check the superclass documentation for the
...
and behavior.`),vm=l(),y($o.$$.fragment),km=l(),Je=a("div"),y(ss.$$.fragment),Tm=l(),Jt=a("p"),wm=o("The "),fa=a("a"),ym=o("TFFlaubertModel"),Fm=o(" forward method, overrides the "),Wr=a("code"),Mm=o("__call__"),$m=o(" special method."),xm=l(),y(xo.$$.fragment),Lm=l(),Or=a("p"),Em=o("Example:"),zm=l(),y(as.$$.fragment),Ui=l(),Kt=a("h2"),Lo=a("a"),Hr=a("span"),y(rs.$$.fragment),Cm=l(),Qr=a("span"),qm=o("TFFlaubertWithLMHeadModel"),Vi=l(),Se=a("div"),y(is.$$.fragment),Pm=l(),Br=a("p"),jm=o(`The Flaubert Model transformer with a language modeling head on top (linear layer with weights tied to the input
...
it as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage
and behavior.`),Hm=l(),y(Eo.$$.fragment),Qm=l(),Ke=a("div"),y(ps.$$.fragment),Bm=l(),Gt=a("p"),Rm=o("The "),_a=a("a"),Um=o("TFFlaubertWithLMHeadModel"),Vm=o(" forward method, overrides the "),Rr=a("code"),Ym=o("__call__"),Jm=o(" special method."),Km=l(),y(zo.$$.fragment),Gm=l(),Ur=a("p"),Zm=o("Example:"),eu=l(),y(hs.$$.fragment),Yi=l(),Zt=a("h2"),Co=a("a"),Vr=a("span"),y(ms.$$.fragment),tu=l(),Yr=a("span"),ou=o("TFFlaubertForSequenceClassification"),Ji=l(),Ne=a("div"),y(us.$$.fragment),nu=l(),Jr=a("p"),su=o(`Flaubert Model with a sequence classification/regression head on top (a linear layer on top of the pooled output)
...
it as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage
and behavior.`),mu=l(),y(qo.$$.fragment),uu=l(),Ge=a("div"),y(bs.$$.fragment),fu=l(),eo=a("p"),gu=o("The "),va=a("a"),_u=o("TFXLMForSequenceClassification"),bu=o(" forward method, overrides the "),Kr=a("code"),vu=o("__call__"),ku=o(" special method."),Tu=l(),y(Po.$$.fragment),wu=l(),Gr=a("p"),yu=o("Example:"),Fu=l(),y(vs.$$.fragment),Ki=l(),to=a("h2"),jo=a("a"),Zr=a("span"),y(ks.$$.fragment),Mu=l(),ei=a("span"),$u=o("TFFlaubertForMultipleChoice"),Gi=l(),Ie=a("div"),y(Ts.$$.fragment),xu=l(),ti=a("p"),Lu=o(`Flaubert Model with a multiple choice classification head on top (a linear layer on top of the pooled output and a
...
it as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage
and behavior.`),Su=l(),y(Xo.$$.fragment),Nu=l(),Ze=a("div"),y(Ms.$$.fragment),Iu=l(),oo=a("p"),Du=o("The "),Ta=a("a"),Wu=o("TFXLMForMultipleChoice"),Ou=o(" forward method, overrides the "),oi=a("code"),Hu=o("__call__"),Qu=o(" special method."),Bu=l(),y(Ao.$$.fragment),Ru=l(),ni=a("p"),Uu=o("Example:"),Vu=l(),y($s.$$.fragment),Zi=l(),no=a("h2"),So=a("a"),si=a("span"),y(xs.$$.fragment),Yu=l(),ai=a("span"),Ju=o("TFFlaubertForTokenClassification"),el=l(),De=a("div"),y(Ls.$$.fragment),Ku=l(),ri=a("p"),Gu=o(`Flaubert Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g. for
...
and documentation regarding arguments.`),rl.forEach(t),Ho.forEach(t),Ci=d(s),Pt=r(s,"H2",{class:!0});var il=i(Pt);po=r(il,"A",{id:!0,class:!0,href:!0});var cg=i(po);er=r(cg,"SPAN",{});var pg=i(er);F(Jo.$$.fragment,pg),pg.forEach(t),cg.forEach(t),xd=d(il),tr=r(il,"SPAN",{});var hg=i(tr);Ld=n(hg,"FlaubertModel"),hg.forEach(t),il.forEach(t),qi=d(s),He=r(s,"DIV",{class:!0});var vt=i(He);F(Ko.$$.fragment,vt),Ed=d(vt),or=r(vt,"P",{});var mg=i(or);zd=n(mg,"The bare Flaubert Model transformer outputting raw hidden-states without any specific head on top."),mg.forEach(t),Cd=d(vt),Go=r(vt,"P",{});var ll=i(Go);qd=n(ll,"This model inherits from "),Vs=r(ll,"A",{href:!0});var ug=i(Vs);Pd=n(ug,"PreTrainedModel"),ug.forEach(t),jd=n(ll,`. Check the superclass documentation for the generic
methods the library implements for all its model (such as downloading or saving, resizing the input embeddings,
...
subclass. Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to
general usage and behavior.`),dl.forEach(t),Id=d(vt),Qe=r(vt,"DIV",{class:!0});var kt=i(Qe);F(tn.$$.fragment,kt),Dd=d(kt),jt=r(kt,"P",{});var Ea=i(jt);Wd=n(Ea,"The "),Ys=r(Ea,"A",{href:!0});var gg=i(Ys);Od=n(gg,"FlaubertModel"),gg.forEach(t),Hd=n(Ea," forward method, overrides the "),nr=r(Ea,"CODE",{});var _g=i(nr);Qd=n(_g,"__call__"),_g.forEach(t),Bd=n(Ea," special method."),Ea.forEach(t),Rd=d(kt),F(ho.$$.fragment,kt),Ud=d(kt),sr=r(kt,"P",{});var bg=i(sr);Vd=n(bg,"Example:"),bg.forEach(t),Yd=d(kt),F(on.$$.fragment,kt),kt.forEach(t),vt.forEach(t),Pi=d(s),Xt=r(s,"H2",{class:!0});var cl=i(Xt);mo=r(cl,"A",{id:!0,class:!0,href:!0});var vg=i(mo);ar=r(vg,"SPAN",{});var kg=i(ar);F(nn.$$.fragment,kg),kg.forEach(t),vg.forEach(t),Jd=d(cl),rr=r(cl,"SPAN",{});var Tg=i(rr);Kd=n(Tg,"FlaubertWithLMHeadModel"),Tg.forEach(t),cl.forEach(t),ji=d(s),ze=r(s,"DIV",{class:!0});var at=i(ze);F(sn.$$.fragment,at),Gd=d(at),ir=r(at,"P",{});var wg=i(ir);Zd=n(wg,`The Flaubert Model transformer with a language modeling head on top (linear layer with weights tied to the input
...
it as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage
and behavior.`),Il.forEach(t),Hm=d(ht),F(Eo.$$.fragment,ht),Qm=d(ht),Ke=r(ht,"DIV",{class:!0});var xt=i(Ke);F(ps.$$.fragment,xt),Bm=d(xt),Gt=r(xt,"P",{});var Ia=i(Gt);Rm=n(Ia,"The "),_a=r(Ia,"A",{href:!0});var H_=i(_a);Um=n(H_,"TFFlaubertWithLMHeadModel"),H_.forEach(t),Vm=n(Ia," forward method, overrides the "),Rr=r(Ia,"CODE",{});var Q_=i(Rr);Ym=n(Q_,"__call__"),Q_.forEach(t),Jm=n(Ia," special method."),Ia.forEach(t),Km=d(xt),F(zo.$$.fragment,xt),Gm=d(xt),Ur=r(xt,"P",{});var B_=i(Ur);Zm=n(B_,"Example:"),B_.forEach(t),eu=d(xt),F(hs.$$.fragment,xt),xt.forEach(t),ht.forEach(t),Yi=d(s),Zt=r(s,"H2",{class:!0});var Dl=i(Zt);Co=r(Dl,"A",{id:!0,class:!0,href:!0});var R_=i(Co);Vr=r(R_,"SPAN",{});var U_=i(Vr);F(ms.$$.fragment,U_),U_.forEach(t),R_.forEach(t),tu=d(Dl),Yr=r(Dl,"SPAN",{});var V_=i(Yr);ou=n(V_,"TFFlaubertForSequenceClassification"),V_.forEach(t),Dl.forEach(t),Ji=d(s),Ne=r(s,"DIV",{class:!0});var mt=i(Ne);F(us.$$.fragment,mt),nu=d(mt),Jr=r(mt,"P",{});var Y_=i(Jr);su=n(Y_,`Flaubert Model with a sequence classification/regression head on top (a linear layer on top of the pooled output)
e.g. for GLUE tasks.`),Y_.forEach(t),au=d(mt),fs=r(mt,"P",{});var Wl=i(fs);ru=n(Wl,"This model inherits from "),ba=r(Wl,"A",{href:!0});var J_=i(ba);iu=n(J_,"TFPreTrainedModel"),J_.forEach(t),lu=n(Wl,`. Check the superclass documentation for the
generic methods the library implements for all its model (such as downloading or saving, resizing the input
embeddings, pruning heads etc.)`),Wl.forEach(t),du=d(mt),gs=r(mt,"P",{});var Ol=i(gs);cu=n(Ol,"This model is also a "),_s=r(Ol,"A",{href:!0,rel:!0});var K_=i(_s);pu=n(K_,"tf.keras.Model"),K_.forEach(t),hu=n(Ol,` subclass. Use
it as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage
and behavior.`),Ol.forEach(t),mu=d(mt),F(qo.$$.fragment,mt),uu=d(mt),Ge=r(mt,"DIV",{class:!0});var Lt=i(Ge);F(bs.$$.fragment,Lt),fu=d(Lt),eo=r(Lt,"P",{});var Da=i(eo);gu=n(Da,"The "),va=r(Da,"A",{href:!0});var G_=i(va);_u=n(G_,"TFXLMForSequenceClassification"),G_.forEach(t),bu=n(Da," forward method, overrides the "),Kr=r(Da,"CODE",{});var Z_=i(Kr);vu=n(Z_,"__call__"),Z_.forEach(t),ku=n(Da," special method."),Da.forEach(t),Tu=d(Lt),F(Po.$$.fragment,Lt),wu=d(Lt),Gr=r(Lt,"P",{});var eb=i(Gr);yu=n(eb,"Example:"),eb.forEach(t),Fu=d(Lt),F(vs.$$.fragment,Lt),Lt.forEach(t),mt.forEach(t),Ki=d(s),to=r(s,"H2",{class:!0});var Hl=i(to);jo=r(Hl,"A",{id:!0,class:!0,href:!0});var tb=i(jo);Zr=r(tb,"SPAN",{});var ob=i(Zr);F(ks.$$.fragment,ob),ob.forEach(t),tb.forEach(t),Mu=d(Hl),ei=r(Hl,"SPAN",{});var nb=i(ei);$u=n(nb,"TFFlaubertForMultipleChoice"),nb.forEach(t),Hl.forEach(t),Gi=d(s),Ie=r(s,"DIV",{class:!0});var ut=i(Ie);F(Ts.$$.fragment,ut),xu=d(ut),ti=r(ut,"P",{});var sb=i(ti);Lu=n(sb,`Flaubert Model with a multiple choice classification head on top (a linear layer on top of the pooled output and a
