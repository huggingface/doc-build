import{S as e1,i as t1,s as o1,e as a,k as l,w as k,t as n,T as Po,L as n1,c as r,d as t,m as d,a as i,x as v,h as s,U as jo,b as c,J as e,g as h,y as b,q as T,o as y,B as L}from"../../../chunks/vendor-e859c359.js";import{T as je}from"../../../chunks/Tip-edc75249.js";import{D as S}from"../../../chunks/Docstring-ade913b3.js";import{C as rt}from"../../../chunks/CodeBlock-ce4317c2.js";import{I as ze}from"../../../chunks/IconCopyLink-5fae3b20.js";import"../../../chunks/CopyButton-77addb3d.js";function s1(W){let p,F,g,u,x;return{c(){p=a("p"),F=n(`Although the recipe for forward pass needs to be defined within this function, one should call the
`),g=a("code"),u=n("Module"),x=n(` instance afterwards instead of this since the former takes care of running the pre and post
processing steps while the latter silently ignores them.`)},l(w){p=r(w,"P",{});var _=i(p);F=s(_,`Although the recipe for forward pass needs to be defined within this function, one should call the
`),g=r(_,"CODE",{});var M=i(g);u=s(M,"Module"),M.forEach(t),x=s(_,` instance afterwards instead of this since the former takes care of running the pre and post
processing steps while the latter silently ignores them.`),_.forEach(t)},m(w,_){h(w,p,_),e(p,F),e(p,g),e(g,u),e(p,x)},d(w){w&&t(p)}}}function a1(W){let p,F,g,u,x;return{c(){p=a("p"),F=n(`Although the recipe for forward pass needs to be defined within this function, one should call the
`),g=a("code"),u=n("Module"),x=n(` instance afterwards instead of this since the former takes care of running the pre and post
processing steps while the latter silently ignores them.`)},l(w){p=r(w,"P",{});var _=i(p);F=s(_,`Although the recipe for forward pass needs to be defined within this function, one should call the
`),g=r(_,"CODE",{});var M=i(g);u=s(M,"Module"),M.forEach(t),x=s(_,` instance afterwards instead of this since the former takes care of running the pre and post
processing steps while the latter silently ignores them.`),_.forEach(t)},m(w,_){h(w,p,_),e(p,F),e(p,g),e(g,u),e(p,x)},d(w){w&&t(p)}}}function r1(W){let p,F,g,u,x;return{c(){p=a("p"),F=n(`Although the recipe for forward pass needs to be defined within this function, one should call the
`),g=a("code"),u=n("Module"),x=n(` instance afterwards instead of this since the former takes care of running the pre and post
processing steps while the latter silently ignores them.`)},l(w){p=r(w,"P",{});var _=i(p);F=s(_,`Although the recipe for forward pass needs to be defined within this function, one should call the
`),g=r(_,"CODE",{});var M=i(g);u=s(M,"Module"),M.forEach(t),x=s(_,` instance afterwards instead of this since the former takes care of running the pre and post
processing steps while the latter silently ignores them.`),_.forEach(t)},m(w,_){h(w,p,_),e(p,F),e(p,g),e(g,u),e(p,x)},d(w){w&&t(p)}}}function i1(W){let p,F,g,u,x;return{c(){p=a("p"),F=n(`Although the recipe for forward pass needs to be defined within this function, one should call the
`),g=a("code"),u=n("Module"),x=n(` instance afterwards instead of this since the former takes care of running the pre and post
processing steps while the latter silently ignores them.`)},l(w){p=r(w,"P",{});var _=i(p);F=s(_,`Although the recipe for forward pass needs to be defined within this function, one should call the
`),g=r(_,"CODE",{});var M=i(g);u=s(M,"Module"),M.forEach(t),x=s(_,` instance afterwards instead of this since the former takes care of running the pre and post
processing steps while the latter silently ignores them.`),_.forEach(t)},m(w,_){h(w,p,_),e(p,F),e(p,g),e(g,u),e(p,x)},d(w){w&&t(p)}}}function l1(W){let p,F,g,u,x;return{c(){p=a("p"),F=n(`Although the recipe for forward pass needs to be defined within this function, one should call the
`),g=a("code"),u=n("Module"),x=n(` instance afterwards instead of this since the former takes care of running the pre and post
processing steps while the latter silently ignores them.`)},l(w){p=r(w,"P",{});var _=i(p);F=s(_,`Although the recipe for forward pass needs to be defined within this function, one should call the
`),g=r(_,"CODE",{});var M=i(g);u=s(M,"Module"),M.forEach(t),x=s(_,` instance afterwards instead of this since the former takes care of running the pre and post
processing steps while the latter silently ignores them.`),_.forEach(t)},m(w,_){h(w,p,_),e(p,F),e(p,g),e(g,u),e(p,x)},d(w){w&&t(p)}}}function d1(W){let p,F,g,u,x;return{c(){p=a("p"),F=n(`Although the recipe for forward pass needs to be defined within this function, one should call the
`),g=a("code"),u=n("Module"),x=n(` instance afterwards instead of this since the former takes care of running the pre and post
processing steps while the latter silently ignores them.`)},l(w){p=r(w,"P",{});var _=i(p);F=s(_,`Although the recipe for forward pass needs to be defined within this function, one should call the
`),g=r(_,"CODE",{});var M=i(g);u=s(M,"Module"),M.forEach(t),x=s(_,` instance afterwards instead of this since the former takes care of running the pre and post
processing steps while the latter silently ignores them.`),_.forEach(t)},m(w,_){h(w,p,_),e(p,F),e(p,g),e(g,u),e(p,x)},d(w){w&&t(p)}}}function c1(W){let p,F,g,u,x,w,_,M,de,X,E,ne,Q,ce,Z,H,he,ae,R,P,se,K,z,q,me,D,Y,fe,I,pe,ge,C,ee,U,re,te,N,ue,ie,j,_e,B,oe;return{c(){p=a("p"),F=n("TF 2.0 models accepts two formats as inputs:"),g=l(),u=a("ul"),x=a("li"),w=n("having all inputs as keyword arguments (like PyTorch models), or"),_=l(),M=a("li"),de=n("having all inputs as a list, tuple or dict in the first positional arguments."),X=l(),E=a("p"),ne=n("This second option is useful when using "),Q=a("code"),ce=n("tf.keras.Model.fit"),Z=n(` method which currently requires having all
the tensors in the first argument of the model call function: `),H=a("code"),he=n("model(inputs)"),ae=n("."),R=l(),P=a("p"),se=n(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in
the first positional argument :`),K=l(),z=a("ul"),q=a("li"),me=n("a single Tensor with "),D=a("code"),Y=n("input_ids"),fe=n(" only and nothing else: "),I=a("code"),pe=n("model(inputs_ids)"),ge=l(),C=a("li"),ee=n(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
...
`),B=a("code"),oe=n('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(m){p=r(m,"P",{});var $=i(p);F=s($,"TF 2.0 models accepts two formats as inputs:"),$.forEach(t),g=d(m),u=r(m,"UL",{});var J=i(u);x=r(J,"LI",{});var Le=i(x);w=s(Le,"having all inputs as keyword arguments (like PyTorch models), or"),Le.forEach(t),_=d(J),M=r(J,"LI",{});var xe=i(M);de=s(xe,"having all inputs as a list, tuple or dict in the first positional arguments."),xe.forEach(t),J.forEach(t),X=d(m),E=r(m,"P",{});var O=i(E);ne=s(O,"This second option is useful when using "),Q=r(O,"CODE",{});var $e=i(Q);ce=s($e,"tf.keras.Model.fit"),$e.forEach(t),Z=s(O,` method which currently requires having all
the tensors in the first argument of the model call function: `),H=r(O,"CODE",{});var Fe=i(H);he=s(Fe,"model(inputs)"),Fe.forEach(t),ae=s(O,"."),O.forEach(t),R=d(m),P=r(m,"P",{});var be=i(P);se=s(be,`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in
...
`),B=r(we,"CODE",{});var ve=i(B);oe=s(ve,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),ve.forEach(t),we.forEach(t),A.forEach(t)},m(m,$){h(m,p,$),e(p,F),h(m,g,$),h(m,u,$),e(u,x),e(x,w),e(u,_),e(u,M),e(M,de),h(m,X,$),h(m,E,$),e(E,ne),e(E,Q),e(Q,ce),e(E,Z),e(E,H),e(H,he),e(E,ae),h(m,R,$),h(m,P,$),e(P,se),h(m,K,$),h(m,z,$),e(z,q),e(q,me),e(q,D),e(D,Y),e(q,fe),e(q,I),e(I,pe),e(z,ge),e(z,C),e(C,ee),e(C,U),e(U,re),e(C,te),e(C,N),e(N,ue),e(z,ie),e(z,j),e(j,_e),e(j,B),e(B,oe)},d(m){m&&t(p),m&&t(g),m&&t(u),m&&t(X),m&&t(E),m&&t(R),m&&t(P),m&&t(K),m&&t(z)}}}function h1(W){let p,F,g,u,x;return{c(){p=a("p"),F=n(`Although the recipe for forward pass needs to be defined within this function, one should call the
`),g=a("code"),u=n("Module"),x=n(` instance afterwards instead of this since the former takes care of running the pre and post
processing steps while the latter silently ignores them.`)},l(w){p=r(w,"P",{});var _=i(p);F=s(_,`Although the recipe for forward pass needs to be defined within this function, one should call the
`),g=r(_,"CODE",{});var M=i(g);u=s(M,"Module"),M.forEach(t),x=s(_,` instance afterwards instead of this since the former takes care of running the pre and post
...
the first positional argument :`),be.forEach(t),K=d(m),z=r(m,"UL",{});var A=i(z);q=r(A,"LI",{});var V=i(q);me=s(V,"a single Tensor with "),D=r(V,"CODE",{});var Te=i(D);Y=s(Te,"input_ids"),Te.forEach(t),fe=s(V," only and nothing else: "),I=r(V,"CODE",{});var le=i(I);pe=s(le,"model(inputs_ids)"),le.forEach(t),V.forEach(t),ge=d(A),C=r(A,"LI",{});var G=i(C);ee=s(G,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),U=r(G,"CODE",{});var ke=i(U);re=s(ke,"model([input_ids, attention_mask])"),ke.forEach(t),te=s(G," or "),N=r(G,"CODE",{});var Me=i(N);ue=s(Me,"model([input_ids, attention_mask, token_type_ids])"),Me.forEach(t),G.forEach(t),ie=d(A),j=r(A,"LI",{});var we=i(j);_e=s(we,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),B=r(we,"CODE",{});var ve=i(B);oe=s(ve,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),ve.forEach(t),we.forEach(t),A.forEach(t)},m(m,$){h(m,p,$),e(p,F),h(m,g,$),h(m,u,$),e(u,x),e(x,w),e(u,_),e(u,M),e(M,de),h(m,X,$),h(m,E,$),e(E,ne),e(E,Q),e(Q,ce),e(E,Z),e(E,H),e(H,he),e(E,ae),h(m,R,$),h(m,P,$),e(P,se),h(m,K,$),h(m,z,$),e(z,q),e(q,me),e(q,D),e(D,Y),e(q,fe),e(q,I),e(I,pe),e(z,ge),e(z,C),e(C,ee),e(C,U),e(U,re),e(C,te),e(C,N),e(N,ue),e(z,ie),e(z,j),e(j,_e),e(j,B),e(B,oe)},d(m){m&&t(p),m&&t(g),m&&t(u),m&&t(X),m&&t(E),m&&t(R),m&&t(P),m&&t(K),m&&t(z)}}}function f1(W){let p,F,g,u,x;return{c(){p=a("p"),F=n(`Although the recipe for forward pass needs to be defined within this function, one should call the
`),g=a("code"),u=n("Module"),x=n(` instance afterwards instead of this since the former takes care of running the pre and post
processing steps while the latter silently ignores them.`)},l(w){p=r(w,"P",{});var _=i(p);F=s(_,`Although the recipe for forward pass needs to be defined within this function, one should call the
`),g=r(_,"CODE",{});var M=i(g);u=s(M,"Module"),M.forEach(t),x=s(_,` instance afterwards instead of this since the former takes care of running the pre and post
...
the first positional argument :`),be.forEach(t),K=d(m),z=r(m,"UL",{});var A=i(z);q=r(A,"LI",{});var V=i(q);me=s(V,"a single Tensor with "),D=r(V,"CODE",{});var Te=i(D);Y=s(Te,"input_ids"),Te.forEach(t),fe=s(V," only and nothing else: "),I=r(V,"CODE",{});var le=i(I);pe=s(le,"model(inputs_ids)"),le.forEach(t),V.forEach(t),ge=d(A),C=r(A,"LI",{});var G=i(C);ee=s(G,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),U=r(G,"CODE",{});var ke=i(U);re=s(ke,"model([input_ids, attention_mask])"),ke.forEach(t),te=s(G," or "),N=r(G,"CODE",{});var Me=i(N);ue=s(Me,"model([input_ids, attention_mask, token_type_ids])"),Me.forEach(t),G.forEach(t),ie=d(A),j=r(A,"LI",{});var we=i(j);_e=s(we,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),B=r(we,"CODE",{});var ve=i(B);oe=s(ve,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),ve.forEach(t),we.forEach(t),A.forEach(t)},m(m,$){h(m,p,$),e(p,F),h(m,g,$),h(m,u,$),e(u,x),e(x,w),e(u,_),e(u,M),e(M,de),h(m,X,$),h(m,E,$),e(E,ne),e(E,Q),e(Q,ce),e(E,Z),e(E,H),e(H,he),e(E,ae),h(m,R,$),h(m,P,$),e(P,se),h(m,K,$),h(m,z,$),e(z,q),e(q,me),e(q,D),e(D,Y),e(q,fe),e(q,I),e(I,pe),e(z,ge),e(z,C),e(C,ee),e(C,U),e(U,re),e(C,te),e(C,N),e(N,ue),e(z,ie),e(z,j),e(j,_e),e(j,B),e(B,oe)},d(m){m&&t(p),m&&t(g),m&&t(u),m&&t(X),m&&t(E),m&&t(R),m&&t(P),m&&t(K),m&&t(z)}}}function g1(W){let p,F,g,u,x;return{c(){p=a("p"),F=n(`Although the recipe for forward pass needs to be defined within this function, one should call the
`),g=a("code"),u=n("Module"),x=n(` instance afterwards instead of this since the former takes care of running the pre and post
processing steps while the latter silently ignores them.`)},l(w){p=r(w,"P",{});var _=i(p);F=s(_,`Although the recipe for forward pass needs to be defined within this function, one should call the
`),g=r(_,"CODE",{});var M=i(g);u=s(M,"Module"),M.forEach(t),x=s(_,` instance afterwards instead of this since the former takes care of running the pre and post
...
the first positional argument :`),be.forEach(t),K=d(m),z=r(m,"UL",{});var A=i(z);q=r(A,"LI",{});var V=i(q);me=s(V,"a single Tensor with "),D=r(V,"CODE",{});var Te=i(D);Y=s(Te,"input_ids"),Te.forEach(t),fe=s(V," only and nothing else: "),I=r(V,"CODE",{});var le=i(I);pe=s(le,"model(inputs_ids)"),le.forEach(t),V.forEach(t),ge=d(A),C=r(A,"LI",{});var G=i(C);ee=s(G,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),U=r(G,"CODE",{});var ke=i(U);re=s(ke,"model([input_ids, attention_mask])"),ke.forEach(t),te=s(G," or "),N=r(G,"CODE",{});var Me=i(N);ue=s(Me,"model([input_ids, attention_mask, token_type_ids])"),Me.forEach(t),G.forEach(t),ie=d(A),j=r(A,"LI",{});var we=i(j);_e=s(we,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),B=r(we,"CODE",{});var ve=i(B);oe=s(ve,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),ve.forEach(t),we.forEach(t),A.forEach(t)},m(m,$){h(m,p,$),e(p,F),h(m,g,$),h(m,u,$),e(u,x),e(x,w),e(u,_),e(u,M),e(M,de),h(m,X,$),h(m,E,$),e(E,ne),e(E,Q),e(Q,ce),e(E,Z),e(E,H),e(H,he),e(E,ae),h(m,R,$),h(m,P,$),e(P,se),h(m,K,$),h(m,z,$),e(z,q),e(q,me),e(q,D),e(D,Y),e(q,fe),e(q,I),e(I,pe),e(z,ge),e(z,C),e(C,ee),e(C,U),e(U,re),e(C,te),e(C,N),e(N,ue),e(z,ie),e(z,j),e(j,_e),e(j,B),e(B,oe)},d(m){m&&t(p),m&&t(g),m&&t(u),m&&t(X),m&&t(E),m&&t(R),m&&t(P),m&&t(K),m&&t(z)}}}function _1(W){let p,F,g,u,x;return{c(){p=a("p"),F=n(`Although the recipe for forward pass needs to be defined within this function, one should call the
`),g=a("code"),u=n("Module"),x=n(` instance afterwards instead of this since the former takes care of running the pre and post
processing steps while the latter silently ignores them.`)},l(w){p=r(w,"P",{});var _=i(p);F=s(_,`Although the recipe for forward pass needs to be defined within this function, one should call the
`),g=r(_,"CODE",{});var M=i(g);u=s(M,"Module"),M.forEach(t),x=s(_,` instance afterwards instead of this since the former takes care of running the pre and post
...
the first positional argument :`),be.forEach(t),K=d(m),z=r(m,"UL",{});var A=i(z);q=r(A,"LI",{});var V=i(q);me=s(V,"a single Tensor with "),D=r(V,"CODE",{});var Te=i(D);Y=s(Te,"input_ids"),Te.forEach(t),fe=s(V," only and nothing else: "),I=r(V,"CODE",{});var le=i(I);pe=s(le,"model(inputs_ids)"),le.forEach(t),V.forEach(t),ge=d(A),C=r(A,"LI",{});var G=i(C);ee=s(G,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),U=r(G,"CODE",{});var ke=i(U);re=s(ke,"model([input_ids, attention_mask])"),ke.forEach(t),te=s(G," or "),N=r(G,"CODE",{});var Me=i(N);ue=s(Me,"model([input_ids, attention_mask, token_type_ids])"),Me.forEach(t),G.forEach(t),ie=d(A),j=r(A,"LI",{});var we=i(j);_e=s(we,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),B=r(we,"CODE",{});var ve=i(B);oe=s(ve,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),ve.forEach(t),we.forEach(t),A.forEach(t)},m(m,$){h(m,p,$),e(p,F),h(m,g,$),h(m,u,$),e(u,x),e(x,w),e(u,_),e(u,M),e(M,de),h(m,X,$),h(m,E,$),e(E,ne),e(E,Q),e(Q,ce),e(E,Z),e(E,H),e(H,he),e(E,ae),h(m,R,$),h(m,P,$),e(P,se),h(m,K,$),h(m,z,$),e(z,q),e(q,me),e(q,D),e(D,Y),e(q,fe),e(q,I),e(I,pe),e(z,ge),e(z,C),e(C,ee),e(C,U),e(U,re),e(C,te),e(C,N),e(N,ue),e(z,ie),e(z,j),e(j,_e),e(j,B),e(B,oe)},d(m){m&&t(p),m&&t(g),m&&t(u),m&&t(X),m&&t(E),m&&t(R),m&&t(P),m&&t(K),m&&t(z)}}}function k1(W){let p,F,g,u,x;return{c(){p=a("p"),F=n(`Although the recipe for forward pass needs to be defined within this function, one should call the
`),g=a("code"),u=n("Module"),x=n(` instance afterwards instead of this since the former takes care of running the pre and post
processing steps while the latter silently ignores them.`)},l(w){p=r(w,"P",{});var _=i(p);F=s(_,`Although the recipe for forward pass needs to be defined within this function, one should call the
`),g=r(_,"CODE",{});var M=i(g);u=s(M,"Module"),M.forEach(t),x=s(_,` instance afterwards instead of this since the former takes care of running the pre and post
processing steps while the latter silently ignores them.`),_.forEach(t)},m(w,_){h(w,p,_),e(p,F),e(p,g),e(g,u),e(p,x)},d(w){w&&t(p)}}}function v1(W){let p,F,g,u,x,w,_,M,de,X,E,ne,Q,ce,Z,H,he,ae,R,P,se,K,z,q,me,D,Y,fe,I,pe,ge,C,ee,U,re,te,N,ue,ie,j,_e,B,oe;return{c(){p=a("p"),F=n("TF 2.0 models accepts two formats as inputs:"),g=l(),u=a("ul"),x=a("li"),w=n("having all inputs as keyword arguments (like PyTorch models), or"),_=l(),M=a("li"),de=n("having all inputs as a list, tuple or dict in the first positional arguments."),X=l(),E=a("p"),ne=n("This second option is useful when using "),Q=a("code"),ce=n("tf.keras.Model.fit"),Z=n(` method which currently requires having all
the tensors in the first argument of the model call function: `),H=a("code"),he=n("model(inputs)"),ae=n("."),R=l(),P=a("p"),se=n(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in
the first positional argument :`),K=l(),z=a("ul"),q=a("li"),me=n("a single Tensor with "),D=a("code"),Y=n("input_ids"),fe=n(" only and nothing else: "),I=a("code"),pe=n("model(inputs_ids)"),ge=l(),C=a("li"),ee=n(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),U=a("code"),re=n("model([input_ids, attention_mask])"),te=n(" or "),N=a("code"),ue=n("model([input_ids, attention_mask, token_type_ids])"),ie=l(),j=a("li"),_e=n(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),B=a("code"),oe=n('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(m){p=r(m,"P",{});var $=i(p);F=s($,"TF 2.0 models accepts two formats as inputs:"),$.forEach(t),g=d(m),u=r(m,"UL",{});var J=i(u);x=r(J,"LI",{});var Le=i(x);w=s(Le,"having all inputs as keyword arguments (like PyTorch models), or"),Le.forEach(t),_=d(J),M=r(J,"LI",{});var xe=i(M);de=s(xe,"having all inputs as a list, tuple or dict in the first positional arguments."),xe.forEach(t),J.forEach(t),X=d(m),E=r(m,"P",{});var O=i(E);ne=s(O,"This second option is useful when using "),Q=r(O,"CODE",{});var $e=i(Q);ce=s($e,"tf.keras.Model.fit"),$e.forEach(t),Z=s(O,` method which currently requires having all
...
>LongformerBaseModelOutputWithPooling</a> or a tuple of
...
<p><a
  href="/docs/transformers/master/en/model_doc/longformer#transformers.models.longformer.modeling_longformer.LongformerBaseModelOutputWithPooling"
>LongformerBaseModelOutputWithPooling</a> or <code>tuple(torch.FloatTensor)</code></p>
...
>LongformerMaskedLMOutput</a> or a tuple of
<code>torch.FloatTensor</code> (if <code>return_dict=False</code> is passed or when <code>config.return_dict=False</code>) comprising
various elements depending on the configuration (<a
  href="/docs/transformers/master/en/model_doc/longformer#transformers.LongformerConfig"
>LongformerConfig</a>) and inputs.</p>
...
<p><a
  href="/docs/transformers/master/en/model_doc/longformer#transformers.models.longformer.modeling_longformer.LongformerMaskedLMOutput"
>LongformerMaskedLMOutput</a> or <code>tuple(torch.FloatTensor)</code></p>
...
>LongformerSequenceClassifierOutput</a> or a tuple of
<code>torch.FloatTensor</code> (if <code>return_dict=False</code> is passed or when <code>config.return_dict=False</code>) comprising
various elements depending on the configuration (<a
  href="/docs/transformers/master/en/model_doc/longformer#transformers.LongformerConfig"
>LongformerConfig</a>) and inputs.</p>
...
<p><a
  href="/docs/transformers/master/en/model_doc/longformer#transformers.models.longformer.modeling_longformer.LongformerSequenceClassifierOutput"
>LongformerSequenceClassifierOutput</a> or <code>tuple(torch.FloatTensor)</code></p>
...
>LongformerMultipleChoiceModelOutput</a> or a tuple of
<code>torch.FloatTensor</code> (if <code>return_dict=False</code> is passed or when <code>config.return_dict=False</code>) comprising
various elements depending on the configuration (<a
  href="/docs/transformers/master/en/model_doc/longformer#transformers.LongformerConfig"
>LongformerConfig</a>) and inputs.</p>
...
<p><a
  href="/docs/transformers/master/en/model_doc/longformer#transformers.models.longformer.modeling_longformer.LongformerMultipleChoiceModelOutput"
>LongformerMultipleChoiceModelOutput</a> or <code>tuple(torch.FloatTensor)</code></p>
...
>LongformerTokenClassifierOutput</a> or a tuple of
<code>torch.FloatTensor</code> (if <code>return_dict=False</code> is passed or when <code>config.return_dict=False</code>) comprising
various elements depending on the configuration (<a
  href="/docs/transformers/master/en/model_doc/longformer#transformers.LongformerConfig"
>LongformerConfig</a>) and inputs.</p>
...
<p><a
  href="/docs/transformers/master/en/model_doc/longformer#transformers.models.longformer.modeling_longformer.LongformerTokenClassifierOutput"
>LongformerTokenClassifierOutput</a> or <code>tuple(torch.FloatTensor)</code></p>
...
>LongformerQuestionAnsweringModelOutput</a> or a tuple of
<code>torch.FloatTensor</code> (if <code>return_dict=False</code> is passed or when <code>config.return_dict=False</code>) comprising
various elements depending on the configuration (<a
  href="/docs/transformers/master/en/model_doc/longformer#transformers.LongformerConfig"
>LongformerConfig</a>) and inputs.</p>
...
<p><a
  href="/docs/transformers/master/en/model_doc/longformer#transformers.models.longformer.modeling_longformer.LongformerQuestionAnsweringModelOutput"
>LongformerQuestionAnsweringModelOutput</a> or <code>tuple(torch.FloatTensor)</code></p>
...
>TFLongformerMaskedLMOutput</a> or a tuple of
...
<p><a
  href="/docs/transformers/master/en/model_doc/longformer#transformers.models.longformer.modeling_tf_longformer.TFLongformerMaskedLMOutput"
>TFLongformerMaskedLMOutput</a> or <code>tuple(tf.Tensor)</code></p>
...
>TFLongformerQuestionAnsweringModelOutput</a> or a tuple of
<code>tf.Tensor</code> (if <code>return_dict=False</code> is passed or when <code>config.return_dict=False</code>) comprising various
elements depending on the configuration (<a
  href="/docs/transformers/master/en/model_doc/longformer#transformers.LongformerConfig"
>LongformerConfig</a>) and inputs.</p>
...
<p><a
  href="/docs/transformers/master/en/model_doc/longformer#transformers.models.longformer.modeling_tf_longformer.TFLongformerQuestionAnsweringModelOutput"
>TFLongformerQuestionAnsweringModelOutput</a> or <code>tuple(tf.Tensor)</code></p>
...
>TFLongformerSequenceClassifierOutput</a> or a tuple of
<code>tf.Tensor</code> (if <code>return_dict=False</code> is passed or when <code>config.return_dict=False</code>) comprising various
elements depending on the configuration (<a
  href="/docs/transformers/master/en/model_doc/longformer#transformers.LongformerConfig"
>LongformerConfig</a>) and inputs.</p>
...
<p><a
  href="/docs/transformers/master/en/model_doc/longformer#transformers.models.longformer.modeling_tf_longformer.TFLongformerSequenceClassifierOutput"
>TFLongformerSequenceClassifierOutput</a> or <code>tuple(tf.Tensor)</code></p>
...
>TFLongformerTokenClassifierOutput</a> or a tuple of
<code>tf.Tensor</code> (if <code>return_dict=False</code> is passed or when <code>config.return_dict=False</code>) comprising various
elements depending on the configuration (<a
  href="/docs/transformers/master/en/model_doc/longformer#transformers.LongformerConfig"
>LongformerConfig</a>) and inputs.</p>
...
<p><a
  href="/docs/transformers/master/en/model_doc/longformer#transformers.models.longformer.modeling_tf_longformer.TFLongformerTokenClassifierOutput"
>TFLongformerTokenClassifierOutput</a> or <code>tuple(tf.Tensor)</code></p>
`}}),kn=new je({props:{$$slots:{default:[k1]},$$scope:{ctx:W}}}),Fa=new rt({props:{code:`from transformers import LongformerTokenizer, TFLongformerForTokenClassification
import tensorflow as tf
...
>TFLongformerMultipleChoiceModelOutput</a> or a tuple of
<code>tf.Tensor</code> (if <code>return_dict=False</code> is passed or when <code>config.return_dict=False</code>) comprising various
elements depending on the configuration (<a
  href="/docs/transformers/master/en/model_doc/longformer#transformers.LongformerConfig"
>LongformerConfig</a>) and inputs.</p>
...
<p><a
  href="/docs/transformers/master/en/model_doc/longformer#transformers.models.longformer.modeling_tf_longformer.TFLongformerMultipleChoiceModelOutput"
>TFLongformerMultipleChoiceModelOutput</a> or <code>tuple(tf.Tensor)</code></p>
...
WikiHop and TriviaQA.`),ie=l(),j=a("p"),_e=n("Tips:"),B=l(),oe=a("ul"),m=a("li"),$=n("Since the Longformer is based on RoBERTa, it doesn\u2019t have "),J=a("code"),Le=n("token_type_ids"),xe=n(`. You don\u2019t need to indicate which
token belongs to which segment. Just separate your segments with the separation token `),O=a("code"),$e=n("tokenizer.sep_token"),Fe=n(` (or
`),be=a("code"),A=n("</s>"),V=n(")."),Te=l(),le=a("p"),G=n("This model was contributed by "),ke=a("a"),Me=n("beltagy"),we=n(". The Authors\u2019 code can be found "),ve=a("a"),Oh=n("here"),Ah=n("."),sd=l(),jt=a("h2"),Oo=a("a"),Vr=a("span"),k(xn.$$.fragment),Ih=l(),Gr=a("span"),Nh=n("Longformer Self Attention"),ad=l(),ye=a("p"),Sh=n(`Longformer self attention employs self attention on both a \u201Clocal\u201D context and a \u201Cglobal\u201D context. Most tokens only
...
\u201Clocally\u201D attending tokens.`),Ed=l(),No=a("p"),dm=n("For more information, please refer to the official "),$n=a("a"),cm=n("paper"),hm=n("."),zd=l(),Ot=a("h2"),So=a("a"),si=a("span"),k(Fn.$$.fragment),mm=l(),ai=a("span"),fm=n("Training"),qd=l(),At=a("p"),Sa=a("a"),pm=n("LongformerForMaskedLM"),gm=n(" is trained the exact same way "),Da=a("a"),um=n("RobertaForMaskedLM"),_m=n(` is
trained and should be used as follows:`),Cd=l(),k(Mn.$$.fragment),Pd=l(),It=a("h2"),Do=a("a"),ri=a("span"),k(En.$$.fragment),wm=l(),ii=a("span"),km=n("LongformerConfig"),jd=l(),Oe=a("div"),k(zn.$$.fragment),vm=l(),Nt=a("p"),bm=n("This is the configuration class to store the configuration of a "),Ba=a("a"),Tm=n("LongformerModel"),ym=n(` or a
`),Wa=a("a"),Lm=n("TFLongformerModel"),xm=n(`. It is used to instantiate a Longformer model according to the specified
...
`),qn=a("a"),zm=n("roberta-base"),qm=n(" architecture with a sequence length 4,096."),Cm=l(),Dt=a("p"),Pm=n("The "),Ha=a("a"),jm=n("LongformerConfig"),Om=n(" class directly inherits "),Ra=a("a"),Am=n("RobertaConfig"),Im=n(`. It reuses
the same defaults. Please check the parent class for more information.`),Nm=l(),li=a("p"),Sm=n("Example:"),Dm=l(),k(Cn.$$.fragment),Od=l(),Bt=a("h2"),Bo=a("a"),di=a("span"),k(Pn.$$.fragment),Bm=l(),ci=a("span"),Wm=n("LongformerTokenizer"),Ad=l(),ft=a("div"),k(jn.$$.fragment),Qm=l(),hi=a("p"),Hm=n("Construct a Longformer tokenizer."),Rm=l(),Wo=a("p"),Ua=a("a"),Um=n("LongformerTokenizer"),Vm=n(" is identical to "),Va=a("a"),Gm=n("RobertaTokenizer"),Km=n(`. Refer to the
superclass for usage examples and documentation concerning parameters.`),Id=l(),Wt=a("h2"),Qo=a("a"),mi=a("span"),k(On.$$.fragment),Jm=l(),fi=a("span"),Xm=n("LongformerTokenizerFast"),Nd=l(),pt=a("div"),k(An.$$.fragment),Ym=l(),In=a("p"),Zm=n("Construct a \u201Cfast\u201D Longformer tokenizer (backed by HuggingFace\u2019s "),pi=a("em"),ef=n("tokenizers"),tf=n(" library)."),of=l(),Ho=a("p"),Ga=a("a"),nf=n("LongformerTokenizerFast"),sf=n(" is identical to "),Ka=a("a"),af=n("RobertaTokenizerFast"),rf=n(`. Refer
to the superclass for usage examples and documentation concerning parameters.`),Sd=l(),Qt=a("h2"),Ro=a("a"),gi=a("span"),k(Nn.$$.fragment),lf=l(),ui=a("span"),df=n("Longformer specific outputs"),Dd=l(),Ht=a("div"),k(Sn.$$.fragment),cf=l(),_i=a("p"),hf=n("Base class for Longformer\u2019s outputs, with potential hidden states, local and global attentions."),Bd=l(),Rt=a("div"),k(Dn.$$.fragment),mf=l(),wi=a("p"),ff=n("Base class for Longformer\u2019s outputs that also contains a pooling of the last hidden states."),Wd=l(),Ut=a("div"),k(Bn.$$.fragment),pf=l(),ki=a("p"),gf=n("Base class for masked language models outputs."),Qd=l(),Vt=a("div"),k(Wn.$$.fragment),uf=l(),vi=a("p"),_f=n("Base class for outputs of question answering Longformer models."),Hd=l(),Gt=a("div"),k(Qn.$$.fragment),wf=l(),bi=a("p"),kf=n("Base class for outputs of sentence classification models."),Rd=l(),Kt=a("div"),k(Hn.$$.fragment),vf=l(),Ti=a("p"),bf=n("Base class for outputs of multiple choice Longformer models."),Ud=l(),Jt=a("div"),k(Rn.$$.fragment),Tf=l(),yi=a("p"),yf=n("Base class for outputs of token classification models."),Vd=l(),Xt=a("div"),k(Un.$$.fragment),Lf=l(),Li=a("p"),xf=n("Base class for Longformer\u2019s outputs, with potential hidden states, local and global attentions."),Gd=l(),Yt=a("div"),k(Vn.$$.fragment),$f=l(),xi=a("p"),Ff=n("Base class for Longformer\u2019s outputs that also contains a pooling of the last hidden states."),Kd=l(),Zt=a("div"),k(Gn.$$.fragment),Mf=l(),$i=a("p"),Ef=n("Base class for masked language models outputs."),Jd=l(),eo=a("div"),k(Kn.$$.fragment),zf=l(),Fi=a("p"),qf=n("Base class for outputs of question answering Longformer models."),Xd=l(),to=a("div"),k(Jn.$$.fragment),Cf=l(),Mi=a("p"),Pf=n("Base class for outputs of sentence classification models."),Yd=l(),oo=a("div"),k(Xn.$$.fragment),jf=l(),Ei=a("p"),Of=n("Base class for outputs of multiple choice models."),Zd=l(),no=a("div"),k(Yn.$$.fragment),Af=l(),zi=a("p"),If=n("Base class for outputs of token classification models."),ec=l(),so=a("h2"),Uo=a("a"),qi=a("span"),k(Zn.$$.fragment),Nf=l(),Ci=a("span"),Sf=n("LongformerModel"),tc=l(),qe=a("div"),k(es.$$.fragment),Df=l(),Pi=a("p"),Bf=n("The bare Longformer Model outputting raw hidden-states without any specific head on top."),Wf=l(),ts=a("p"),Qf=n("This model inherits from "),Ja=a("a"),Hf=n("PreTrainedModel"),Rf=n(`. Check the superclass documentation for the generic
...
general usage and behavior.`),Jf=l(),ao=a("p"),Xf=n("This class copied code from "),Xa=a("a"),Yf=n("RobertaModel"),Zf=n(` and overwrote standard self-attention with
longformer self-attention to provide the ability to process long sequences following the self-attention approach
described in `),ss=a("a"),ep=n("Longformer: the Long-Document Transformer"),tp=n(` by Iz Beltagy,
Matthew E. Peters, and Arman Cohan. Longformer self-attention combines a local (sliding window) and global
attention to extend to long documents without the O(n^2) increase in memory and compute.`),op=l(),as=a("p"),np=n("The self-attention module "),ji=a("code"),sp=n("LongformerSelfAttention"),ap=n(` implemented here supports the combination of local and
...
custom CUDA kernel to be memory and compute efficient.`),rp=l(),Ge=a("div"),k(rs.$$.fragment),ip=l(),ro=a("p"),lp=n("The "),Ya=a("a"),dp=n("LongformerModel"),cp=n(" forward method, overrides the "),Oi=a("code"),hp=n("__call__"),mp=n(" special method."),fp=l(),k(Vo.$$.fragment),pp=l(),Ai=a("p"),gp=n("Examples:"),up=l(),k(is.$$.fragment),oc=l(),io=a("h2"),Go=a("a"),Ii=a("span"),k(ls.$$.fragment),_p=l(),Ni=a("span"),wp=n("LongformerForMaskedLM"),nc=l(),We=a("div"),k(ds.$$.fragment),kp=l(),cs=a("p"),vp=n("Longformer Model with a "),Si=a("em"),bp=n("language modeling"),Tp=n(" head on top."),yp=l(),hs=a("p"),Lp=n("This model inherits from "),Za=a("a"),xp=n("PreTrainedModel"),$p=n(`. Check the superclass documentation for the generic
methods the library implements for all its model (such as downloading or saving, resizing the input embeddings,
pruning heads etc.)`),Fp=l(),ms=a("p"),Mp=n("This model is also a PyTorch "),fs=a("a"),Ep=n("torch.nn.Module"),zp=n(`
subclass. Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to
general usage and behavior.`),qp=l(),Ke=a("div"),k(ps.$$.fragment),Cp=l(),lo=a("p"),Pp=n("The "),er=a("a"),jp=n("LongformerForMaskedLM"),Op=n(" forward method, overrides the "),Di=a("code"),Ap=n("__call__"),Ip=n(" special method."),Np=l(),k(Ko.$$.fragment),Sp=l(),Bi=a("p"),Dp=n("Examples:"),Bp=l(),k(gs.$$.fragment),sc=l(),co=a("h2"),Jo=a("a"),Wi=a("span"),k(us.$$.fragment),Wp=l(),Qi=a("span"),Qp=n("LongformerForSequenceClassification"),ac=l(),Qe=a("div"),k(_s.$$.fragment),Hp=l(),Hi=a("p"),Rp=n(`Longformer Model transformer with a sequence classification/regression head on top (a linear layer on top of the
pooled output) e.g. for GLUE tasks.`),Up=l(),ws=a("p"),Vp=n("This model inherits from "),tr=a("a"),Gp=n("PreTrainedModel"),Kp=n(`. Check the superclass documentation for the generic
methods the library implements for all its model (such as downloading or saving, resizing the input embeddings,
pruning heads etc.)`),Jp=l(),ks=a("p"),Xp=n("This model is also a PyTorch "),vs=a("a"),Yp=n("torch.nn.Module"),Zp=n(`
subclass. Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to
general usage and behavior.`),eg=l(),Ce=a("div"),k(bs.$$.fragment),tg=l(),ho=a("p"),og=n("The "),or=a("a"),ng=n("LongformerForSequenceClassification"),sg=n(" forward method, overrides the "),Ri=a("code"),ag=n("__call__"),rg=n(" special method."),ig=l(),k(Xo.$$.fragment),lg=l(),Ui=a("p"),dg=n("Example of single-label classification:"),cg=l(),k(Ts.$$.fragment),hg=l(),Vi=a("p"),mg=n("Example of multi-label classification:"),fg=l(),k(ys.$$.fragment),rc=l(),mo=a("h2"),Yo=a("a"),Gi=a("span"),k(Ls.$$.fragment),pg=l(),Ki=a("span"),gg=n("LongformerForMultipleChoice"),ic=l(),He=a("div"),k(xs.$$.fragment),ug=l(),Ji=a("p"),_g=n(`Longformer Model with a multiple choice classification head on top (a linear layer on top of the pooled output and
a softmax) e.g. for RocStories/SWAG tasks.`),wg=l(),$s=a("p"),kg=n("This model inherits from "),nr=a("a"),vg=n("PreTrainedModel"),bg=n(`. Check the superclass documentation for the generic
methods the library implements for all its model (such as downloading or saving, resizing the input embeddings,
pruning heads etc.)`),Tg=l(),Fs=a("p"),yg=n("This model is also a PyTorch "),Ms=a("a"),Lg=n("torch.nn.Module"),xg=n(`
subclass. Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to
general usage and behavior.`),$g=l(),Je=a("div"),k(Es.$$.fragment),Fg=l(),fo=a("p"),Mg=n("The "),sr=a("a"),Eg=n("LongformerForMultipleChoice"),zg=n(" forward method, overrides the "),Xi=a("code"),qg=n("__call__"),Cg=n(" special method."),Pg=l(),k(Zo.$$.fragment),jg=l(),Yi=a("p"),Og=n("Example:"),Ag=l(),k(zs.$$.fragment),lc=l(),po=a("h2"),en=a("a"),Zi=a("span"),k(qs.$$.fragment),Ig=l(),el=a("span"),Ng=n("LongformerForTokenClassification"),dc=l(),Re=a("div"),k(Cs.$$.fragment),Sg=l(),tl=a("p"),Dg=n(`Longformer Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g.
for Named-Entity-Recognition (NER) tasks.`),Bg=l(),Ps=a("p"),Wg=n("This model inherits from "),ar=a("a"),Qg=n("PreTrainedModel"),Hg=n(`. Check the superclass documentation for the generic
methods the library implements for all its model (such as downloading or saving, resizing the input embeddings,
pruning heads etc.)`),Rg=l(),js=a("p"),Ug=n("This model is also a PyTorch "),Os=a("a"),Vg=n("torch.nn.Module"),Gg=n(`
subclass. Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to
general usage and behavior.`),Kg=l(),Xe=a("div"),k(As.$$.fragment),Jg=l(),go=a("p"),Xg=n("The "),rr=a("a"),Yg=n("LongformerForTokenClassification"),Zg=n(" forward method, overrides the "),ol=a("code"),eu=n("__call__"),tu=n(" special method."),ou=l(),k(tn.$$.fragment),nu=l(),nl=a("p"),su=n("Example:"),au=l(),k(Is.$$.fragment),cc=l(),uo=a("h2"),on=a("a"),sl=a("span"),k(Ns.$$.fragment),ru=l(),al=a("span"),iu=n("LongformerForQuestionAnswering"),hc=l(),Ue=a("div"),k(Ss.$$.fragment),lu=l(),_o=a("p"),du=n(`Longformer Model with a span classification head on top for extractive question-answering tasks like SQuAD /
TriviaQA (a linear layers on top of the hidden-states output to compute `),rl=a("em"),cu=n("span start logits"),hu=n(" and "),il=a("em"),mu=n("span end logits"),fu=n(")."),pu=l(),Ds=a("p"),gu=n("This model inherits from "),ir=a("a"),uu=n("PreTrainedModel"),_u=n(`. Check the superclass documentation for the generic
methods the library implements for all its model (such as downloading or saving, resizing the input embeddings,
pruning heads etc.)`),wu=l(),Bs=a("p"),ku=n("This model is also a PyTorch "),Ws=a("a"),vu=n("torch.nn.Module"),bu=n(`
subclass. Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to
general usage and behavior.`),Tu=l(),Ye=a("div"),k(Qs.$$.fragment),yu=l(),wo=a("p"),Lu=n("The "),lr=a("a"),xu=n("LongformerForQuestionAnswering"),$u=n(" forward method, overrides the "),ll=a("code"),Fu=n("__call__"),Mu=n(" special method."),Eu=l(),k(nn.$$.fragment),zu=l(),dl=a("p"),qu=n("Examples:"),Cu=l(),k(Hs.$$.fragment),mc=l(),ko=a("h2"),sn=a("a"),cl=a("span"),k(Rs.$$.fragment),Pu=l(),hl=a("span"),ju=n("TFLongformerModel"),fc=l(),Ee=a("div"),k(Us.$$.fragment),Ou=l(),ml=a("p"),Au=n("The bare Longformer Model outputting raw hidden-states without any specific head on top."),Iu=l(),Vs=a("p"),Nu=n("This model inherits from "),dr=a("a"),Su=n("TFPreTrainedModel"),Du=n(`. Check the superclass documentation for the
generic methods the library implements for all its model (such as downloading or saving, resizing the input
embeddings, pruning heads etc.)`),Bu=l(),Gs=a("p"),Wu=n("This model is also a "),Ks=a("a"),Qu=n("tf.keras.Model"),Hu=n(` subclass. Use
it as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage
and behavior.`),Ru=l(),k(an.$$.fragment),Uu=l(),vo=a("p"),Vu=n("This class copies code from "),cr=a("a"),Gu=n("TFRobertaModel"),Ku=n(` and overwrites standard self-attention with
longformer self-attention to provide the ability to process long sequences following the self-attention approach
described in `),Js=a("a"),Ju=n("Longformer: the Long-Document Transformer"),Xu=n(` by Iz Beltagy,
Matthew E. Peters, and Arman Cohan. Longformer self-attention combines a local (sliding window) and global
attention to extend to long documents without the O(n^2) increase in memory and compute.`),Yu=l(),Xs=a("p"),Zu=n("The self-attention module "),fl=a("code"),e_=n("TFLongformerSelfAttention"),t_=n(` implemented here supports the combination of local and
global attention but it lacks support for autoregressive attention and dilated attention. Autoregressive and
dilated attention are more relevant for autoregressive language modeling than finetuning on downstream tasks.
Future release will add support for autoregressive attention, but the support for dilated attention requires a
custom CUDA kernel to be memory and compute efficient.`),o_=l(),_t=a("div"),k(Ys.$$.fragment),n_=l(),bo=a("p"),s_=n("The "),hr=a("a"),a_=n("TFLongformerModel"),r_=n(" forward method, overrides the "),pl=a("code"),i_=n("__call__"),l_=n(" special method."),d_=l(),k(rn.$$.fragment),pc=l(),To=a("h2"),ln=a("a"),gl=a("span"),k(Zs.$$.fragment),c_=l(),ul=a("span"),h_=n("TFLongformerForMaskedLM"),gc=l(),Ae=a("div"),k(ea.$$.fragment),m_=l(),ta=a("p"),f_=n("Longformer Model with a "),_l=a("em"),p_=n("language modeling"),g_=n(" head on top."),u_=l(),oa=a("p"),__=n("This model inherits from "),mr=a("a"),w_=n("TFPreTrainedModel"),k_=n(`. Check the superclass documentation for the
generic methods the library implements for all its model (such as downloading or saving, resizing the input
embeddings, pruning heads etc.)`),v_=l(),na=a("p"),b_=n("This model is also a "),sa=a("a"),T_=n("tf.keras.Model"),y_=n(` subclass. Use
it as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage
and behavior.`),L_=l(),k(dn.$$.fragment),x_=l(),Ze=a("div"),k(aa.$$.fragment),$_=l(),yo=a("p"),F_=n("The "),fr=a("a"),M_=n("TFLongformerForMaskedLM"),E_=n(" forward method, overrides the "),wl=a("code"),z_=n("__call__"),q_=n(" special method."),C_=l(),k(cn.$$.fragment),P_=l(),kl=a("p"),j_=n("Example:"),O_=l(),k(ra.$$.fragment),uc=l(),Lo=a("h2"),hn=a("a"),vl=a("span"),k(ia.$$.fragment),A_=l(),bl=a("span"),I_=n("TFLongformerForQuestionAnswering"),_c=l(),Ie=a("div"),k(la.$$.fragment),N_=l(),xo=a("p"),S_=n(`Longformer Model with a span classification head on top for extractive question-answering tasks like SQuAD /
TriviaQA (a linear layer on top of the hidden-states output to compute `),Tl=a("em"),D_=n("span start logits"),B_=n(" and "),yl=a("em"),W_=n("span end logits"),Q_=n(")."),H_=l(),da=a("p"),R_=n("This model inherits from "),pr=a("a"),U_=n("TFPreTrainedModel"),V_=n(`. Check the superclass documentation for the
generic methods the library implements for all its model (such as downloading or saving, resizing the input
embeddings, pruning heads etc.)`),G_=l(),ca=a("p"),K_=n("This model is also a "),ha=a("a"),J_=n("tf.keras.Model"),X_=n(` subclass. Use
it as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage
and behavior.`),Y_=l(),k(mn.$$.fragment),Z_=l(),et=a("div"),k(ma.$$.fragment),ew=l(),$o=a("p"),tw=n("The "),gr=a("a"),ow=n("TFLongformerForQuestionAnswering"),nw=n(" forward method, overrides the "),Ll=a("code"),sw=n("__call__"),aw=n(" special method."),rw=l(),k(fn.$$.fragment),iw=l(),xl=a("p"),lw=n("Example:"),dw=l(),k(fa.$$.fragment),wc=l(),Fo=a("h2"),pn=a("a"),$l=a("span"),k(pa.$$.fragment),cw=l(),Fl=a("span"),hw=n("TFLongformerForSequenceClassification"),kc=l(),Ne=a("div"),k(ga.$$.fragment),mw=l(),Ml=a("p"),fw=n(`Longformer Model transformer with a sequence classification/regression head on top (a linear layer on top of the
pooled output) e.g. for GLUE tasks.`),pw=l(),ua=a("p"),gw=n("This model inherits from "),ur=a("a"),uw=n("TFPreTrainedModel"),_w=n(`. Check the superclass documentation for the
generic methods the library implements for all its model (such as downloading or saving, resizing the input
embeddings, pruning heads etc.)`),ww=l(),_a=a("p"),kw=n("This model is also a "),wa=a("a"),vw=n("tf.keras.Model"),bw=n(` subclass. Use
it as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage
and behavior.`),Tw=l(),k(gn.$$.fragment),yw=l(),tt=a("div"),k(ka.$$.fragment),Lw=l(),Mo=a("p"),xw=n("The "),_r=a("a"),$w=n("TFLongformerForSequenceClassification"),Fw=n(" forward method, overrides the "),El=a("code"),Mw=n("__call__"),Ew=n(" special method."),zw=l(),k(un.$$.fragment),qw=l(),zl=a("p"),Cw=n("Example:"),Pw=l(),k(va.$$.fragment),vc=l(),Eo=a("h2"),_n=a("a"),ql=a("span"),k(ba.$$.fragment),jw=l(),Cl=a("span"),Ow=n("TFLongformerForTokenClassification"),bc=l(),Se=a("div"),k(Ta.$$.fragment),Aw=l(),Pl=a("p"),Iw=n(`Longformer Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g.
for Named-Entity-Recognition (NER) tasks.`),Nw=l(),ya=a("p"),Sw=n("This model inherits from "),wr=a("a"),Dw=n("TFPreTrainedModel"),Bw=n(`. Check the superclass documentation for the
generic methods the library implements for all its model (such as downloading or saving, resizing the input
embeddings, pruning heads etc.)`),Ww=l(),La=a("p"),Qw=n("This model is also a "),xa=a("a"),Hw=n("tf.keras.Model"),Rw=n(` subclass. Use
it as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage
and behavior.`),Uw=l(),k(wn.$$.fragment),Vw=l(),ot=a("div"),k($a.$$.fragment),Gw=l(),zo=a("p"),Kw=n("The "),kr=a("a"),Jw=n("TFLongformerForTokenClassification"),Xw=n(" forward method, overrides the "),jl=a("code"),Yw=n("__call__"),Zw=n(" special method."),ek=l(),k(kn.$$.fragment),tk=l(),Ol=a("p"),ok=n("Example:"),nk=l(),k(Fa.$$.fragment),Tc=l(),qo=a("h2"),vn=a("a"),Al=a("span"),k(Ma.$$.fragment),sk=l(),Il=a("span"),ak=n("TFLongformerForMultipleChoice"),yc=l(),De=a("div"),k(Ea.$$.fragment),rk=l(),Nl=a("p"),ik=n(`Longformer Model with a multiple choice classification head on top (a linear layer on top of the pooled output and
a softmax) e.g. for RocStories/SWAG tasks.`),lk=l(),za=a("p"),dk=n("This model inherits from "),vr=a("a"),ck=n("TFPreTrainedModel"),hk=n(`. Check the superclass documentation for the
generic methods the library implements for all its model (such as downloading or saving, resizing the input
embeddings, pruning heads etc.)`),mk=l(),qa=a("p"),fk=n("This model is also a "),Ca=a("a"),pk=n("tf.keras.Model"),gk=n(` subclass. Use
it as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage
and behavior.`),uk=l(),k(bn.$$.fragment),_k=l(),nt=a("div"),k(Pa.$$.fragment),wk=l(),Co=a("p"),kk=n("The "),br=a("a"),vk=n("TFLongformerForMultipleChoice"),bk=n(" forward method, overrides the "),Sl=a("code"),Tk=n("__call__"),yk=n(" special method."),Lk=l(),k(Tn.$$.fragment),xk=l(),Dl=a("p"),$k=n("Example:"),Fk=l(),k(ja.$$.fragment),this.h()},l(o){const f=n1('[data-svelte="svelte-1phssyn"]',document.head);p=r(f,"META",{name:!0,content:!0}),f.forEach(t),F=d(o),g=r(o,"H1",{class:!0});var Oa=i(g);u=r(Oa,"A",{id:!0,class:!0,href:!0});var Bl=i(u);x=r(Bl,"SPAN",{});var Wl=i(x);v(w.$$.fragment,Wl),Wl.forEach(t),Bl.forEach(t),_=d(Oa),M=r(Oa,"SPAN",{});var Ql=i(M);de=s(Ql,"Longformer"),Ql.forEach(t),Oa.forEach(t),X=d(o),E=r(o,"P",{});var yn=i(E);ne=r(yn,"STRONG",{});var Hl=i(ne);Q=s(Hl,"DISCLAIMER:"),Hl.forEach(t),ce=s(yn," This model is still a work in progress, if you see something strange, file a "),Z=r(yn,"A",{href:!0,rel:!0});var Rl=i(Z);H=s(Rl,"Github Issue"),Rl.forEach(t),he=s(yn,"."),yn.forEach(t),ae=d(o),R=r(o,"H2",{class:!0});var Aa=i(R);P=r(Aa,"A",{id:!0,class:!0,href:!0});var Ul=i(P);se=r(Ul,"SPAN",{});var Vl=i(se);v(K.$$.fragment,Vl),Vl.forEach(t),Ul.forEach(t),z=d(Aa),q=r(Aa,"SPAN",{});var Gl=i(q);me=s(Gl,"Overview"),Gl.forEach(t),Aa.forEach(t),D=d(o),Y=r(o,"P",{});var Ia=i(Y);fe=s(Ia,"The Longformer model was presented in "),I=r(Ia,"A",{href:!0,rel:!0});var Kl=i(I);pe=s(Kl,"Longformer: The Long-Document Transformer"),Kl.forEach(t),ge=s(Ia," by Iz Beltagy, Matthew E. Peters, Arman Cohan."),Ia.forEach(t),C=d(o),ee=r(o,"P",{});var Jl=i(ee);U=s(Jl,"The abstract from the paper is the following:"),Jl.forEach(t),re=d(o),te=r(o,"P",{});var Xl=i(te);N=r(Xl,"EM",{});var Yl=i(N);ue=s(Yl,`Transformer-based models are unable to process long sequences due to their self-attention operation, which scales
quadratically with the sequence length. To address this limitation, we introduce the Longformer with an attention
mechanism that scales linearly with sequence length, making it easy to process documents of thousands of tokens or
longer. Longformer\u2019s attention mechanism is a drop-in replacement for the standard self-attention and combines a local
windowed attention with a task motivated global attention. Following prior work on long-sequence transformers, we
...
contrast to most prior work, we also pretrain Longformer and finetune it on a variety of downstream tasks. Our
pretrained Longformer consistently outperforms RoBERTa on long document tasks and sets new state-of-the-art results on
WikiHop and TriviaQA.`),Yl.forEach(t),Xl.forEach(t),ie=d(o),j=r(o,"P",{});var Zl=i(j);_e=s(Zl,"Tips:"),Zl.forEach(t),B=d(o),oe=r(o,"UL",{});var ed=i(oe);m=r(ed,"LI",{});var Ln=i(m);$=s(Ln,"Since the Longformer is based on RoBERTa, it doesn\u2019t have "),J=r(Ln,"CODE",{});var Mk=i(J);Le=s(Mk,"token_type_ids"),Mk.forEach(t),xe=s(Ln,`. You don\u2019t need to indicate which
token belongs to which segment. Just separate your segments with the separation token `),O=r(Ln,"CODE",{});var Ek=i(O);$e=s(Ek,"tokenizer.sep_token"),Ek.forEach(t),Fe=s(Ln,` (or
`),be=r(Ln,"CODE",{});var zk=i(be);A=s(zk,"</s>"),zk.forEach(t),V=s(Ln,")."),Ln.forEach(t),ed.forEach(t),Te=d(o),le=r(o,"P",{});var Tr=i(le);G=s(Tr,"This model was contributed by "),ke=r(Tr,"A",{href:!0,rel:!0});var qk=i(ke);Me=s(qk,"beltagy"),qk.forEach(t),we=s(Tr,". The Authors\u2019 code can be found "),ve=r(Tr,"A",{href:!0,rel:!0});var Ck=i(ve);Oh=s(Ck,"here"),Ck.forEach(t),Ah=s(Tr,"."),Tr.forEach(t),sd=d(o),jt=r(o,"H2",{class:!0});var xc=i(jt);Oo=r(xc,"A",{id:!0,class:!0,href:!0});var Pk=i(Oo);Vr=r(Pk,"SPAN",{});var jk=i(Vr);v(xn.$$.fragment,jk),jk.forEach(t),Pk.forEach(t),Ih=d(xc),Gr=r(xc,"SPAN",{});var Ok=i(Gr);Nh=s(Ok,"Longformer Self Attention"),Ok.forEach(t),xc.forEach(t),ad=d(o),ye=r(o,"P",{});var Pe=i(ye);Sh=s(Pe,`Longformer self attention employs self attention on both a \u201Clocal\u201D context and a \u201Cglobal\u201D context. Most tokens only
...
`),ti=r(Lr,"CODE",{});var Wk=i(ti);em=s(Wk,"global_attention_mask"),Wk.forEach(t),tm=s(Lr,":"),Lr.forEach(t),wd=d(o),Ao=r(o,"UL",{});var $c=i(Ao);oi=r($c,"LI",{});var Qk=i(oi);om=s(Qk,"0: the token attends \u201Clocally\u201D,"),Qk.forEach(t),nm=d($c),ni=r($c,"LI",{});var Hk=i(ni);sm=s(Hk,"1: the token attends \u201Cglobally\u201D."),Hk.forEach(t),$c.forEach(t),kd=d(o),Io=r(o,"P",{});var Fc=i(Io);am=s(Fc,"For more information please also refer to "),Na=r(Fc,"A",{href:!0});var Rk=i(Na);rm=s(Rk,"forward()"),Rk.forEach(t),im=s(Fc," method."),Fc.forEach(t),vd=d(o),Ve=r(o,"P",{});var wt=i(Ve);lm=s(wt,`Using Longformer self attention, the memory and time complexity of the query-key matmul operation, which usually
represents the memory and time bottleneck, can be reduced from `),bd=jo(wt),Td=s(wt,` to
`),yd=jo(wt),Ld=s(wt,", with "),xd=jo(wt),$d=s(wt," being the sequence length and "),Fd=jo(wt),Md=s(wt,` being the average window
size. It is assumed that the number of \u201Cglobally\u201D attending tokens is insignificant as compared to the number of
\u201Clocally\u201D attending tokens.`),wt.forEach(t),Ed=d(o),No=r(o,"P",{});var Mc=i(No);dm=s(Mc,"For more information, please refer to the official "),$n=r(Mc,"A",{href:!0,rel:!0});var Uk=i($n);cm=s(Uk,"paper"),Uk.forEach(t),hm=s(Mc,"."),Mc.forEach(t),zd=d(o),Ot=r(o,"H2",{class:!0});var Ec=i(Ot);So=r(Ec,"A",{id:!0,class:!0,href:!0});var Vk=i(So);si=r(Vk,"SPAN",{});var Gk=i(si);v(Fn.$$.fragment,Gk),Gk.forEach(t),Vk.forEach(t),mm=d(Ec),ai=r(Ec,"SPAN",{});var Kk=i(ai);fm=s(Kk,"Training"),Kk.forEach(t),Ec.forEach(t),qd=d(o),At=r(o,"P",{});var td=i(At);Sa=r(td,"A",{href:!0});var Jk=i(Sa);pm=s(Jk,"LongformerForMaskedLM"),Jk.forEach(t),gm=s(td," is trained the exact same way "),Da=r(td,"A",{href:!0});var Xk=i(Da);um=s(Xk,"RobertaForMaskedLM"),Xk.forEach(t),_m=s(td,` is
trained and should be used as follows:`),td.forEach(t),Cd=d(o),v(Mn.$$.fragment,o),Pd=d(o),It=r(o,"H2",{class:!0});var zc=i(It);Do=r(zc,"A",{id:!0,class:!0,href:!0});var Yk=i(Do);ri=r(Yk,"SPAN",{});var Zk=i(ri);v(En.$$.fragment,Zk),Zk.forEach(t),Yk.forEach(t),wm=d(zc),ii=r(zc,"SPAN",{});var ev=i(ii);km=s(ev,"LongformerConfig"),ev.forEach(t),zc.forEach(t),jd=d(o),Oe=r(o,"DIV",{class:!0});var it=i(Oe);v(zn.$$.fragment,it),vm=d(it),Nt=r(it,"P",{});var xr=i(Nt);bm=s(xr,"This is the configuration class to store the configuration of a "),Ba=r(xr,"A",{href:!0});var tv=i(Ba);Tm=s(tv,"LongformerModel"),tv.forEach(t),ym=s(xr,` or a
`),Wa=r(xr,"A",{href:!0});var ov=i(Wa);Lm=s(ov,"TFLongformerModel"),ov.forEach(t),xm=s(xr,`. It is used to instantiate a Longformer model according to the specified
arguments, defining the model architecture.`),xr.forEach(t),$m=d(it),St=r(it,"P",{});var $r=i(St);Fm=s($r,"This is the configuration class to store the configuration of a "),Qa=r($r,"A",{href:!0});var nv=i(Qa);Mm=s(nv,"LongformerModel"),nv.forEach(t),Em=s($r,`. It is used
to instantiate an Longformer model according to the specified arguments, defining the model architecture.
Instantiating a configuration with the defaults will yield a similar configuration to that of the RoBERTa
`),qn=r($r,"A",{href:!0,rel:!0});var sv=i(qn);zm=s(sv,"roberta-base"),sv.forEach(t),qm=s($r," architecture with a sequence length 4,096."),$r.forEach(t),Cm=d(it),Dt=r(it,"P",{});var Fr=i(Dt);Pm=s(Fr,"The "),Ha=r(Fr,"A",{href:!0});var av=i(Ha);jm=s(av,"LongformerConfig"),av.forEach(t),Om=s(Fr," class directly inherits "),Ra=r(Fr,"A",{href:!0});var rv=i(Ra);Am=s(rv,"RobertaConfig"),rv.forEach(t),Im=s(Fr,`. It reuses
the same defaults. Please check the parent class for more information.`),Fr.forEach(t),Nm=d(it),li=r(it,"P",{});var iv=i(li);Sm=s(iv,"Example:"),iv.forEach(t),Dm=d(it),v(Cn.$$.fragment,it),it.forEach(t),Od=d(o),Bt=r(o,"H2",{class:!0});var qc=i(Bt);Bo=r(qc,"A",{id:!0,class:!0,href:!0});var lv=i(Bo);di=r(lv,"SPAN",{});var dv=i(di);v(Pn.$$.fragment,dv),dv.forEach(t),lv.forEach(t),Bm=d(qc),ci=r(qc,"SPAN",{});var cv=i(ci);Wm=s(cv,"LongformerTokenizer"),cv.forEach(t),qc.forEach(t),Ad=d(o),ft=r(o,"DIV",{class:!0});var Mr=i(ft);v(jn.$$.fragment,Mr),Qm=d(Mr),hi=r(Mr,"P",{});var hv=i(hi);Hm=s(hv,"Construct a Longformer tokenizer."),hv.forEach(t),Rm=d(Mr),Wo=r(Mr,"P",{});var od=i(Wo);Ua=r(od,"A",{href:!0});var mv=i(Ua);Um=s(mv,"LongformerTokenizer"),mv.forEach(t),Vm=s(od," is identical to "),Va=r(od,"A",{href:!0});var fv=i(Va);Gm=s(fv,"RobertaTokenizer"),fv.forEach(t),Km=s(od,`. Refer to the
