import{S as Kg,i as Yg,s as Qg,e as n,k as d,w as m,t as r,L as e_,c as s,d as t,m as l,a,x as f,h as i,b as c,J as e,g as u,y as g,q as _,o as k,B as v}from"../../../chunks/vendor-e859c359.js";import{T as xo}from"../../../chunks/Tip-edc75249.js";import{D as M}from"../../../chunks/Docstring-ade913b3.js";import{C as we}from"../../../chunks/CodeBlock-ce4317c2.js";import{I as ne}from"../../../chunks/IconCopyLink-5fae3b20.js";import"../../../chunks/CopyButton-77addb3d.js";function t_(O){let h,z,T,b,x;return{c(){h=n("p"),z=r(`Although the recipe for forward pass needs to be defined within this function, one should call the
...
processing steps while the latter silently ignores them.`)},l(w){h=s(w,"P",{});var P=a(h);z=i(P,`Although the recipe for forward pass needs to be defined within this function, one should call the
`),T=s(P,"CODE",{});var $=a(T);b=i($,"Module"),$.forEach(t),x=i(P,` instance afterwards instead of this since the former takes care of running the pre and post
processing steps while the latter silently ignores them.`),P.forEach(t)},m(w,P){u(w,h,P),e(h,z),e(h,T),e(T,b),e(h,x)},d(w){w&&t(h)}}}function l_(O){let h,z,T,b,x,w,P,$,Ae,he,E,xe,se,Ie,ae,re,Ne,qe,L,C,ze,H,j,q,Oe,K,Y,Le,G,Ge,De,S,me,ie,Ce,Q,V,Ue,We,D,Be,ee,W,y,F,$e,mt,Fe,J,ft,Je,de,A,X,Ee,gt,Z,_t,Xe,B,kt,zo,md,fd,ia,gd,_d,Xr,fe,da,kd,vd,la,yd,Td,ca,bd,Pd,$o,wd,Fo,xd,zd,$d,Wt,Eo,Fd,Ed,Mo,Md,jd,Zr,vt,Bt,ua,jo,qd,pa,Cd,Kr,Ze,Rt,qo,Sd,Ad,Co,Id,Nd,Od,ha,Ld,Gd,ma,Dd,Yr,yt,Ht,fa,So,Ud,ga,Wd,Qr,ge,_a,ka,Bd,Rd,va,bs,Hd,Ps,Vd,Jd,Ao,ya,Xd,Zd,Tt,Ta,Kd,Yd,ba,Qd,el,Io,tl,Pa,ol,nl,sl,wa,Re,al,xa,rl,il,za,dl,ll,$a,cl,ul,pl,Fa,bt,hl,No,ml,fl,Ea,gl,_l,ei,Pt,Vt,Ma,Oo,kl,ja,vl,ti,Lo,oi,wt,Jt,qa,Go,yl,Ca,Tl,ni,le,Do,bl,xt,Pl,ws,wl,xl,Uo,zl,$l,Fl,zt,El,xs,Ml,jl,zs,ql,Cl,Sl,Sa,Al,Il,Wo,si,$t,Xt,Aa,Bo,Nl,Ia,Ol,ai,Zt,Ll,Na,Gl,Dl,ri,U,Ro,Ul,Ho,Wl,Vo,Bl,Rl,Hl,Jo,Vl,$s,Jl,Xl,Zl,Se,Xo,Kl,Zo,Yl,Oa,Ql,ec,tc,Ko,Fs,oc,La,nc,sc,Yo,ac,Ga,rc,ic,dc,Da,lc,cc,Kt,Qo,uc,Ua,pc,hc,Yt,en,mc,Wa,fc,gc,Qt,tn,_c,Ba,kc,ii,Ft,eo,Ra,on,vc,Ha,yc,di,ce,nn,Tc,Et,bc,Va,Pc,wc,sn,xc,zc,$c,an,Fc,Es,Ec,Mc,jc,Ke,rn,qc,Ja,Cc,Sc,dn,Ms,Ac,Xa,Ic,Nc,ln,Oc,Za,Lc,Gc,Dc,to,cn,Uc,Ka,Wc,li,Mt,oo,Ya,un,Bc,Qa,Rc,ci,Me,pn,Hc,hn,Vc,js,Jc,Xc,Zc,mn,Kc,fn,Yc,Qc,eu,_e,gn,tu,jt,ou,qs,nu,su,er,au,ru,iu,no,du,tr,lu,cu,_n,ui,qt,so,or,kn,uu,nr,pu,pi,je,vn,hu,yn,mu,Cs,fu,gu,_u,Tn,ku,bn,vu,yu,Tu,ke,Pn,bu,Ct,Pu,Ss,wu,xu,sr,zu,$u,Fu,ao,Eu,ar,Mu,ju,wn,hi,St,ro,rr,xn,qu,ir,Cu,mi,zn,Ye,$n,Su,dr,Au,Iu,Fn,fi,At,io,lr,En,Nu,cr,Ou,gi,ue,Mn,Lu,jn,Gu,As,Du,Uu,Wu,qn,Bu,Cn,Ru,Hu,Vu,lo,Ju,ve,Sn,Xu,It,Zu,Is,Ku,Yu,ur,Qu,ep,tp,co,op,pr,np,sp,An,_i,Nt,uo,hr,In,ap,mr,rp,ki,pe,Nn,ip,On,dp,Ns,lp,cp,up,Ln,pp,Gn,hp,mp,fp,po,gp,ye,Dn,_p,Ot,kp,Os,vp,yp,fr,Tp,bp,Pp,ho,wp,gr,xp,zp,Un,vi,Lt,mo,_r,Wn,$p,kr,Fp,yi,I,Bn,Ep,Rn,Mp,Ls,jp,qp,Cp,Hn,Sp,Vn,Ap,Ip,Np,vr,Op,Lp,He,yr,Jn,Gp,Dp,Tr,Xn,Up,Wp,br,Zn,Bp,Rp,Pr,Kn,Hp,Vp,Te,Yn,Jp,Gt,Xp,wr,Zp,Kp,xr,Yp,Qp,eh,fo,th,zr,oh,nh,Qn,sh,Qe,es,ah,$r,rh,ih,ts,dh,et,os,lh,Fr,ch,uh,ns,Ti,Dt,go,Er,ss,ph,Mr,hh,bi,N,as,mh,rs,fh,Gs,gh,_h,kh,is,vh,ds,yh,Th,bh,jr,Ph,wh,Ve,qr,ls,xh,zh,Cr,cs,$h,Fh,Sr,us,Eh,Mh,Ar,ps,jh,qh,R,hs,Ch,Ut,Sh,Ir,Ah,Ih,Nr,Nh,Oh,Lh,_o,Gh,Or,Dh,Uh,ms,Wh,Lr,Bh,Rh,fs,Hh,tt,gs,Vh,Gr,Jh,Xh,_s,Zh,ot,ks,Kh,Dr,Yh,Qh,vs,Pi;return w=new ne({}),H=new ne({}),Ee=new ne({}),jo=new ne({}),So=new ne({}),Oo=new ne({}),Lo=new we({props:{code:`from transformers import PegasusForConditionalGeneration, PegasusTokenizer
import torch
src_text = [
...
<code>inputs_ids</code> passed when calling <a href="/docs/transformers/master/en/model_doc/pegasus#transformers.PegasusModel">PegasusModel</a> or
<a href="/docs/transformers/master/en/model_doc/pegasus#transformers.TFPegasusModel">TFPegasusModel</a>.`,name:"vocab_size"},{anchor:"transformers.PegasusConfig.d_model",description:`<strong>d_model</strong> (<code>int</code>, <em>optional</em>, defaults to 1024) &#x2014;
...
The end of sequence token.`,name:"eos_token"}]}}),rn=new M({props:{name:"build\\_inputs\\_with\\_special\\_tokens",anchor:"transformers.PegasusTokenizerFast.build_inputs_with_special_tokens",parameters:[{name:"token_ids_0",val:""},{name:"token_ids_1",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/master/src/transformers/models/pegasus/tokenization_pegasus_fast.py#L174",parametersDescription:[{anchor:"transformers.PegasusTokenizerFast.build_inputs_with_special_tokens.token_ids_0",description:`<strong>token_ids_0</strong> (<code>List[int]</code>) &#x2014;
...
`,returnType:`
<p><code>List[int]</code></p>
`}}),cn=new M({props:{name:"get\\_special\\_tokens\\_mask",anchor:"transformers.PegasusTokenizerFast.get_special_tokens_mask",parameters:[{name:"token_ids_0",val:": typing.List"},{name:"token_ids_1",val:": typing.Optional[typing.List] = None"},{name:"already_has_special_tokens",val:": bool = False"}],source:"https://github.com/huggingface/transformers/blob/master/src/transformers/models/pegasus/tokenization_pegasus_fast.py#L163"}}),un=new ne({}),pn=new M({props:{name:"class transformers.PegasusModel",anchor:"transformers.PegasusModel",parameters:[{name:"config",val:": PegasusConfig"}],source:"https://github.com/huggingface/transformers/blob/master/src/transformers/models/pegasus/modeling_pegasus.py#L1137",parametersDescription:[{anchor:"transformers.PegasusModel.config",description:`<strong>config</strong> (<a href="/docs/transformers/master/en/model_doc/pegasus#transformers.PegasusConfig">PegasusConfig</a>) &#x2014;
Model configuration class with all the parameters of the model. Initializing with a config file does not
load the weights associated with the model, only the configuration. Check out the
<a href="/docs/transformers/master/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),gn=new M({props:{name:"forward",anchor:"transformers.PegasusModel.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"decoder_input_ids",val:" = None"},{name:"decoder_attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"decoder_head_mask",val:" = None"},{name:"cross_attn_head_mask",val:" = None"},{name:"encoder_outputs",val:" = None"},{name:"past_key_values",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"decoder_inputs_embeds",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/master/src/transformers/models/pegasus/modeling_pegasus.py#L1187",parametersDescription:[{anchor:"transformers.PegasusModel.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),kn=new ne({}),vn=new M({props:{name:"class transformers.PegasusForConditionalGeneration",anchor:"transformers.PegasusForConditionalGeneration",parameters:[{name:"config",val:": PegasusConfig"}],source:"https://github.com/huggingface/transformers/blob/master/src/transformers/models/pegasus/modeling_pegasus.py#L1283",parametersDescription:[{anchor:"transformers.PegasusForConditionalGeneration.config",description:`<strong>config</strong> (<a href="/docs/transformers/master/en/model_doc/pegasus#transformers.PegasusConfig">PegasusConfig</a>) &#x2014;
Model configuration class with all the parameters of the model. Initializing with a config file does not
load the weights associated with the model, only the configuration. Check out the
<a href="/docs/transformers/master/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),Pn=new M({props:{name:"forward",anchor:"transformers.PegasusForConditionalGeneration.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"decoder_input_ids",val:" = None"},{name:"decoder_attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"decoder_head_mask",val:" = None"},{name:"cross_attn_head_mask",val:" = None"},{name:"encoder_outputs",val:" = None"},{name:"past_key_values",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"decoder_inputs_embeds",val:" = None"},{name:"labels",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/master/src/transformers/models/pegasus/modeling_pegasus.py#L1351",parametersDescription:[{anchor:"transformers.PegasusForConditionalGeneration.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. Padding will be ignored by default should you provide
it.</p>
<p>Indices can be obtained using <a href="/docs/transformers/master/en/model_doc/pegasus#transformers.PegasusTokenizer">PegasusTokenizer</a>. See
<a href="/docs/transformers/master/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">transformers.PreTrainedTokenizer.encode()</a> and <a href="/docs/transformers/master/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">transformers.PreTrainedTokenizer.<strong>call</strong>()</a> for
...
last_hidden_states = outputs.last_hidden_state,`,highlighted:`<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-keyword">from</span> transformers <span class="hljs-keyword">import</span> PegasusTokenizer, PegasusForCausalLM
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),En=new ne({}),Mn=new M({props:{name:"class transformers.TFPegasusModel",anchor:"transformers.TFPegasusModel",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/master/src/transformers/models/pegasus/modeling_tf_pegasus.py#L1222",parametersDescription:[{anchor:"transformers.TFPegasusModel.config",description:`<strong>config</strong> (<a href="/docs/transformers/master/en/model_doc/pegasus#transformers.PegasusConfig">PegasusConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
...
parameters.</strong></p>
<p>If you wish to change the dtype of the model parameters, see
<a href="/docs/transformers/master/en/main_classes/model#transformers.FlaxPreTrainedModel.to_fp16">to_fp16()</a> and <a href="/docs/transformers/master/en/main_classes/model#transformers.FlaxPreTrainedModel.to_bf16">to_bf16()</a>.`,name:"dtype"}]}}),hs=new M({props:{name:"\\_\\_call\\_\\_",anchor:"transformers.FlaxPegasusPreTrainedModel.__call__",parameters:[{name:"input_ids",val:": ndarray"},{name:"attention_mask",val:": typing.Optional[jax._src.numpy.lax_numpy.ndarray] = None"},{name:"decoder_input_ids",val:": typing.Optional[jax._src.numpy.lax_numpy.ndarray] = None"},{name:"decoder_attention_mask",val:": typing.Optional[jax._src.numpy.lax_numpy.ndarray] = None"},{name:"position_ids",val:": typing.Optional[jax._src.numpy.lax_numpy.ndarray] = None"},{name:"decoder_position_ids",val:": typing.Optional[jax._src.numpy.lax_numpy.ndarray] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"train",val:": bool = False"},{name:"params",val:": dict = None"},{name:"dropout_rng",val:": PRNGKey = None"}],source:"https://github.com/huggingface/transformers/blob/master/src/transformers/models/pegasus/modeling_flax_pegasus.py#L1155",parametersDescription:[{anchor:"transformers.FlaxPegasusPreTrainedModel.__call__.input_ids",description:`<strong>input_ids</strong> (<code>jnp.ndarray</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. Padding will be ignored by default should you provide
it.</p>
<p>Indices can be obtained using <a href="/docs/transformers/master/en/model_doc/pegasus#transformers.PegasusTokenizer">PegasusTokenizer</a>. See
<a href="/docs/transformers/master/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">transformers.PreTrainedTokenizer.encode()</a> and <a href="/docs/transformers/master/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">transformers.PreTrainedTokenizer.<strong>call</strong>()</a> for
...
`}}),vs=new we({props:{code:`from transformers import PegasusTokenizer, FlaxPegasusForConditionalGeneration
...
general usage and behavior.`),eu=d(),_e=n("div"),m(gn.$$.fragment),tu=d(),jt=n("p"),ou=r("The "),qs=n("a"),nu=r("PegasusModel"),su=r(" forward method, overrides the "),er=n("code"),au=r("__call__"),ru=r(" special method."),iu=d(),m(no.$$.fragment),du=d(),tr=n("p"),lu=r("Example:"),cu=d(),m(_n.$$.fragment),ui=d(),qt=n("h2"),so=n("a"),or=n("span"),m(kn.$$.fragment),uu=d(),nr=n("span"),pu=r("PegasusForConditionalGeneration"),pi=d(),je=n("div"),m(vn.$$.fragment),hu=d(),yn=n("p"),mu=r(`The PEGASUS Model with a language modeling head. Can be used for summarization.
This model inherits from `),Cs=n("a"),fu=r("PreTrainedModel"),gu=r(`. Check the superclass documentation for the generic
methods the library implements for all its model (such as downloading or saving, resizing the input embeddings,
pruning heads etc.)`),_u=d(),Tn=n("p"),ku=r("This model is also a PyTorch "),bn=n("a"),vu=r("torch.nn.Module"),yu=r(`
subclass. Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to
general usage and behavior.`),Tu=d(),ke=n("div"),m(Pn.$$.fragment),bu=d(),Ct=n("p"),Pu=r("The "),Ss=n("a"),wu=r("PegasusForConditionalGeneration"),xu=r(" forward method, overrides the "),sr=n("code"),zu=r("__call__"),$u=r(" special method."),Fu=d(),m(ao.$$.fragment),Eu=d(),ar=n("p"),Mu=r("Summarization example:"),ju=d(),m(wn.$$.fragment),hi=d(),St=n("h2"),ro=n("a"),rr=n("span"),m(xn.$$.fragment),qu=d(),ir=n("span"),Cu=r("PegasusForCausalLM"),mi=d(),zn=n("div"),Ye=n("div"),m($n.$$.fragment),Su=d(),dr=n("p"),Au=r("Example:"),Iu=d(),m(Fn.$$.fragment),fi=d(),At=n("h2"),io=n("a"),lr=n("span"),m(En.$$.fragment),Nu=d(),cr=n("span"),Ou=r("TFPegasusModel"),gi=d(),ue=n("div"),m(Mn.$$.fragment),Lu=d(),jn=n("p"),Gu=r(`The bare PEGASUS Model outputting raw hidden-states without any specific head on top.
...
it as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage
and behavior.`),fp=d(),m(po.$$.fragment),gp=d(),ye=n("div"),m(Dn.$$.fragment),_p=d(),Ot=n("p"),kp=r("The "),Os=n("a"),vp=r("TFPegasusForConditionalGeneration"),yp=r(" forward method, overrides the "),fr=n("code"),Tp=r("__call__"),bp=r(" special method."),Pp=d(),m(ho.$$.fragment),wp=d(),gr=n("p"),xp=r("Summarization example:"),zp=d(),m(Un.$$.fragment),vi=d(),Lt=n("h2"),mo=n("a"),_r=n("span"),m(Wn.$$.fragment),$p=d(),kr=n("span"),Fp=r("FlaxPegasusModel"),yi=d(),I=n("div"),m(Bn.$$.fragment),Ep=d(),Rn=n("p"),Mp=r(`The bare Pegasus Model transformer outputting raw hidden-states without any specific head on top.
...
Module and refer to the Flax documentation for all matter related to general usage and behavior.`),Np=d(),vr=n("p"),Op=r("Finally, this model supports inherent JAX features such as:"),Lp=d(),He=n("ul"),yr=n("li"),Jn=n("a"),Gp=r("Just-In-Time (JIT) compilation"),Dp=d(),Tr=n("li"),Xn=n("a"),Up=r("Automatic Differentiation"),Wp=d(),br=n("li"),Zn=n("a"),Bp=r("Vectorization"),Rp=d(),Pr=n("li"),Kn=n("a"),Hp=r("Parallelization"),Vp=d(),Te=n("div"),m(Yn.$$.fragment),Jp=d(),Gt=n("p"),Xp=r("The "),wr=n("code"),Zp=r("FlaxPegasusPreTrainedModel"),Kp=r(" forward method, overrides the "),xr=n("code"),Yp=r("__call__"),Qp=r(" special method."),eh=d(),m(fo.$$.fragment),th=d(),zr=n("p"),oh=r("Example:"),nh=d(),m(Qn.$$.fragment),sh=d(),Qe=n("div"),m(es.$$.fragment),ah=d(),$r=n("p"),rh=r("Example:"),ih=d(),m(ts.$$.fragment),dh=d(),et=n("div"),m(os.$$.fragment),lh=d(),Fr=n("p"),ch=r("Example:"),uh=d(),m(ns.$$.fragment),Ti=d(),Dt=n("h2"),go=n("a"),Er=n("span"),m(ss.$$.fragment),ph=d(),Mr=n("span"),hh=r("FlaxPegasusForConditionalGeneration"),bi=d(),N=n("div"),m(as.$$.fragment),mh=d(),rs=n("p"),fh=r(`The PEGASUS Model with a language modeling head. Can be used for summarization.
This model inherits from `),Gs=n("a"),gh=r("FlaxPreTrainedModel"),_h=r(`. Check the superclass documentation for the
generic methods the library implements for all its model (such as downloading or saving, resizing the input
embeddings, pruning heads etc.)`),kh=d(),is=n("p"),vh=r("This model is also a Flax Linen "),ds=n("a"),yh=r("flax.nn.Module"),Th=r(` subclass. Use it as a regular Flax
Module and refer to the Flax documentation for all matter related to general usage and behavior.`),bh=d(),jr=n("p"),Ph=r("Finally, this model supports inherent JAX features such as:"),wh=d(),Ve=n("ul"),qr=n("li"),ls=n("a"),xh=r("Just-In-Time (JIT) compilation"),zh=d(),Cr=n("li"),cs=n("a"),$h=r("Automatic Differentiation"),Fh=d(),Sr=n("li"),us=n("a"),Eh=r("Vectorization"),Mh=d(),Ar=n("li"),ps=n("a"),jh=r("Parallelization"),qh=d(),R=n("div"),m(hs.$$.fragment),Ch=d(),Ut=n("p"),Sh=r("The "),Ir=n("code"),Ah=r("FlaxPegasusPreTrainedModel"),Ih=r(" forward method, overrides the "),Nr=n("code"),Nh=r("__call__"),Oh=r(" special method."),Lh=d(),m(_o.$$.fragment),Gh=d(),Or=n("p"),Dh=r("Summarization example:"),Uh=d(),m(ms.$$.fragment),Wh=d(),Lr=n("p"),Bh=r("Mask filling example:"),Rh=d(),m(fs.$$.fragment),Hh=d(),tt=n("div"),m(gs.$$.fragment),Vh=d(),Gr=n("p"),Jh=r("Example:"),Xh=d(),m(_s.$$.fragment),Zh=d(),ot=n("div"),m(ks.$$.fragment),Kh=d(),Dr=n("p"),Yh=r("Example:"),Qh=d(),m(vs.$$.fragment),this.h()},l(o){const p=e_('[data-svelte="svelte-1phssyn"]',document.head);h=s(p,"META",{name:!0,content:!0}),p.forEach(t),z=l(o),T=s(o,"H1",{class:!0});var ys=a(T);b=s(ys,"A",{id:!0,class:!0,href:!0});var Ur=a(b);x=s(Ur,"SPAN",{});var Wr=a(x);f(w.$$.fragment,Wr),Wr.forEach(t),Ur.forEach(t),P=l(ys),$=s(ys,"SPAN",{});var Br=a($);Ae=i(Br,"Pegasus"),Br.forEach(t),ys.forEach(t),he=l(o),E=s(o,"P",{});var ko=a(E);xe=s(ko,"STRONG",{});var Rr=a(xe);se=i(Rr,"DISCLAIMER:"),Rr.forEach(t),Ie=i(ko," If you see something strange, file a "),ae=s(ko,"A",{href:!0,rel:!0});var Hr=a(ae);re=i(Hr,"Github Issue"),Hr.forEach(t),Ne=i(ko,`
and assign @patrickvonplaten.`),ko.forEach(t),qe=l(o),L=s(o,"H2",{class:!0});var Ts=a(L);C=s(Ts,"A",{id:!0,class:!0,href:!0});var nm=a(C);ze=s(nm,"SPAN",{});var sm=a(ze);f(H.$$.fragment,sm),sm.forEach(t),nm.forEach(t),j=l(Ts),q=s(Ts,"SPAN",{});var am=a(q);Oe=i(am,"Overview"),am.forEach(t),Ts.forEach(t),K=l(o),Y=s(o,"P",{});var wi=a(Y);Le=i(wi,"The Pegasus model was proposed in "),G=s(wi,"A",{href:!0,rel:!0});var rm=a(G);Ge=i(rm,"PEGASUS: Pre-training with Extracted Gap-sentences for Abstractive Summarization"),rm.forEach(t),De=i(wi," by Jingqing Zhang, Yao Zhao, Mohammad Saleh and Peter J. Liu on Dec 18, 2019."),wi.forEach(t),S=l(o),me=s(o,"P",{});var im=a(me);ie=i(im,"According to the abstract,"),im.forEach(t),Ce=l(o),Q=s(o,"UL",{});var xi=a(Q);V=s(xi,"LI",{});var dm=a(V);Ue=i(dm,`Pegasus\u2019 pretraining task is intentionally similar to summarization: important sentences are removed/masked from an
input document and are generated together as one output sequence from the remaining sentences, similar to an
extractive summary.`),dm.forEach(t),We=l(xi),D=s(xi,"LI",{});var lm=a(D);Be=i(lm,"Pegasus achieves SOTA summarization performance on all 12 downstream tasks, as measured by ROUGE and human eval."),lm.forEach(t),xi.forEach(t),ee=l(o),W=s(o,"P",{});var Ds=a(W);y=i(Ds,"This model was contributed by "),F=s(Ds,"A",{href:!0,rel:!0});var cm=a(F);$e=i(cm,"sshleifer"),cm.forEach(t),mt=i(Ds,". The Authors\u2019 code can be found "),Fe=s(Ds,"A",{href:!0,rel:!0});var um=a(Fe);J=i(um,"here"),um.forEach(t),ft=i(Ds,"."),Ds.forEach(t),Je=l(o),de=s(o,"H2",{class:!0});var zi=a(de);A=s(zi,"A",{id:!0,class:!0,href:!0});var pm=a(A);X=s(pm,"SPAN",{});var hm=a(X);f(Ee.$$.fragment,hm),hm.forEach(t),pm.forEach(t),gt=l(zi),Z=s(zi,"SPAN",{});var mm=a(Z);_t=i(mm,"Checkpoints"),mm.forEach(t),zi.forEach(t),Xe=l(o),B=s(o,"P",{});var Us=a(B);kt=i(Us,"All the "),zo=s(Us,"A",{href:!0,rel:!0});var fm=a(zo);md=i(fm,"checkpoints"),fm.forEach(t),fd=i(Us,` are fine-tuned for summarization, besides
`),ia=s(Us,"EM",{});var gm=a(ia);gd=i(gm,"pegasus-large"),gm.forEach(t),_d=i(Us,", whence the other checkpoints are fine-tuned:"),Us.forEach(t),Xr=l(o),fe=s(o,"UL",{});var nt=a(fe);da=s(nt,"LI",{});var _m=a(da);kd=i(_m,"Each checkpoint is 2.2 GB on disk and 568M parameters."),_m.forEach(t),vd=l(nt),la=s(nt,"LI",{});var km=a(la);yd=i(km,"FP16 is not supported (help/ideas on this appreciated!)."),km.forEach(t),Td=l(nt),ca=s(nt,"LI",{});var vm=a(ca);bd=i(vm,"Summarizing xsum in fp32 takes about 400ms/sample, with default parameters on a v100 GPU."),vm.forEach(t),Pd=l(nt),$o=s(nt,"LI",{});var $i=a($o);wd=i($i,"Full replication results and correctly pre-processed data can be found in this "),Fo=s($i,"A",{href:!0,rel:!0});var ym=a(Fo);xd=i(ym,"Issue"),ym.forEach(t),zd=i($i,"."),$i.forEach(t),$d=l(nt),Wt=s(nt,"LI",{});var Vr=a(Wt);Eo=s(Vr,"A",{href:!0,rel:!0});var Tm=a(Eo);Fd=i(Tm,"Distilled checkpoints"),Tm.forEach(t),Ed=i(Vr," are described in this "),Mo=s(Vr,"A",{href:!0,rel:!0});var bm=a(Mo);Md=i(bm,"paper"),bm.forEach(t),jd=i(Vr,"."),Vr.forEach(t),nt.forEach(t),Zr=l(o),vt=s(o,"H3",{class:!0});var Fi=a(vt);Bt=s(Fi,"A",{id:!0,class:!0,href:!0});var Pm=a(Bt);ua=s(Pm,"SPAN",{});var wm=a(ua);f(jo.$$.fragment,wm),wm.forEach(t),Pm.forEach(t),qd=l(Fi),pa=s(Fi,"SPAN",{});var xm=a(pa);Cd=i(xm,"Examples"),xm.forEach(t),Fi.forEach(t),Kr=l(o),Ze=s(o,"UL",{});var Ws=a(Ze);Rt=s(Ws,"LI",{});var Jr=a(Rt);qo=s(Jr,"A",{href:!0,rel:!0});var zm=a(qo);Sd=i(zm,"Script"),zm.forEach(t),Ad=i(Jr,` to fine-tune pegasus
on the XSUM dataset. Data download instructions at `),Co=s(Jr,"A",{href:!0,rel:!0});var $m=a(Co);Id=i($m,"examples/pytorch/summarization/"),$m.forEach(t),Nd=i(Jr,"."),Jr.forEach(t),Od=l(Ws),ha=s(Ws,"LI",{});var Fm=a(ha);Ld=i(Fm,"FP16 is not supported (help/ideas on this appreciated!)."),Fm.forEach(t),Gd=l(Ws),ma=s(Ws,"LI",{});var Em=a(ma);Dd=i(Em,"The adafactor optimizer is recommended for pegasus fine-tuning."),Em.forEach(t),Ws.forEach(t),Yr=l(o),yt=s(o,"H2",{class:!0});var Ei=a(yt);Ht=s(Ei,"A",{id:!0,class:!0,href:!0});var Mm=a(Ht);fa=s(Mm,"SPAN",{});var jm=a(fa);f(So.$$.fragment,jm),jm.forEach(t),Mm.forEach(t),Ud=l(Ei),ga=s(Ei,"SPAN",{});var qm=a(ga);Wd=i(qm,"Implementation Notes"),qm.forEach(t),Ei.forEach(t),Qr=l(o),ge=s(o,"UL",{});var st=a(ge);_a=s(st,"LI",{});var Cm=a(_a);ka=s(Cm,"P",{});var Sm=a(ka);Bd=i(Sm,"All models are transformer encoder-decoders with 16 layers in each component."),Sm.forEach(t),Cm.forEach(t),Rd=l(st),va=s(st,"LI",{});var Am=a(va);bs=s(Am,"P",{});var em=a(bs);Hd=i(em,"The implementation is completely inherited from "),Ps=s(em,"A",{href:!0});var Im=a(Ps);Vd=i(Im,"BartForConditionalGeneration"),Im.forEach(t),em.forEach(t),Am.forEach(t),Jd=l(st),Ao=s(st,"LI",{});var Mi=a(Ao);ya=s(Mi,"P",{});var Nm=a(ya);Xd=i(Nm,"Some key configuration differences:"),Nm.forEach(t),Zd=l(Mi),Tt=s(Mi,"UL",{});var Bs=a(Tt);Ta=s(Bs,"LI",{});var Om=a(Ta);Kd=i(Om,"static, sinusoidal position embeddings"),Om.forEach(t),Yd=l(Bs),ba=s(Bs,"LI",{});var Lm=a(ba);Qd=i(Lm,"the model starts generating with pad_token_id (which has 0 token_embedding) as the prefix."),Lm.forEach(t),el=l(Bs),Io=s(Bs,"LI",{});var ji=a(Io);tl=i(ji,"more beams are used ("),Pa=s(ji,"CODE",{});var Gm=a(Pa);ol=i(Gm,"num_beams=8"),Gm.forEach(t),nl=i(ji,")"),ji.forEach(t),Bs.forEach(t),Mi.forEach(t),sl=l(st),wa=s(st,"LI",{});var Dm=a(wa);Re=s(Dm,"P",{});var vo=a(Re);al=i(vo,"All pretrained pegasus checkpoints are the same besides three attributes: "),xa=s(vo,"CODE",{});var Um=a(xa);rl=i(Um,"tokenizer.model_max_length"),Um.forEach(t),il=i(vo,` (maximum
input size), `),za=s(vo,"CODE",{});var Wm=a(za);dl=i(Wm,"max_length"),Wm.forEach(t),ll=i(vo," (the maximum number of tokens to generate) and "),$a=s(vo,"CODE",{});var Bm=a($a);cl=i(Bm,"length_penalty"),Bm.forEach(t),ul=i(vo,"."),vo.forEach(t),Dm.forEach(t),pl=l(st),Fa=s(st,"LI",{});var Rm=a(Fa);bt=s(Rm,"P",{});var Rs=a(bt);hl=i(Rs,"The code to convert checkpoints trained in the author\u2019s "),No=s(Rs,"A",{href:!0,rel:!0});var Hm=a(No);ml=i(Hm,"repo"),Hm.forEach(t),fl=i(Rs,` can be
found in `),Ea=s(Rs,"CODE",{});var Vm=a(Ea);gl=i(Vm,"convert_pegasus_tf_to_pytorch.py"),Vm.forEach(t),_l=i(Rs,"."),Rs.forEach(t),Rm.forEach(t),st.forEach(t),ei=l(o),Pt=s(o,"H2",{class:!0});var qi=a(Pt);Vt=s(qi,"A",{id:!0,class:!0,href:!0});var Jm=a(Vt);Ma=s(Jm,"SPAN",{});var Xm=a(Ma);f(Oo.$$.fragment,Xm),Xm.forEach(t),Jm.forEach(t),kl=l(qi),ja=s(qi,"SPAN",{});var Zm=a(ja);vl=i(Zm,"Usage Example"),Zm.forEach(t),qi.forEach(t),ti=l(o),f(Lo.$$.fragment,o),oi=l(o),wt=s(o,"H2",{class:!0});var Ci=a(wt);Jt=s(Ci,"A",{id:!0,class:!0,href:!0});var Km=a(Jt);qa=s(Km,"SPAN",{});var Ym=a(qa);f(Go.$$.fragment,Ym),Ym.forEach(t),Km.forEach(t),yl=l(Ci),Ca=s(Ci,"SPAN",{});var Qm=a(Ca);Tl=i(Qm,"PegasusConfig"),Qm.forEach(t),Ci.forEach(t),ni=l(o),le=s(o,"DIV",{class:!0});var at=a(le);f(Do.$$.fragment,at),bl=l(at),xt=s(at,"P",{});var Hs=a(xt);Pl=i(Hs,"This is the configuration class to store the configuration of a "),ws=s(Hs,"A",{href:!0});var ef=a(ws);wl=i(ef,"PegasusModel"),ef.forEach(t),xl=i(Hs,`. It is used to
instantiate an PEGASUS model according to the specified arguments, defining the model architecture. Instantiating a
...
separator.`),ff.forEach(t),yo.forEach(t),cc=l(be),Kt=s(be,"DIV",{class:!0});var Di=a(Kt);f(Qo.$$.fragment,Di),uc=l(Di),Ua=s(Di,"P",{});var gf=a(Ua);pc=i(gf,"Converts a sequence of tokens (string) in a single string."),gf.forEach(t),Di.forEach(t),hc=l(be),Yt=s(be,"DIV",{class:!0});var Ui=a(Yt);f(en.$$.fragment,Ui),mc=l(Ui),Wa=s(Ui,"P",{});var _f=a(Wa);fc=i(_f,"Get list where entries are [1] if a token is [eos] or [pad] else 0."),_f.forEach(t),Ui.forEach(t),gc=l(be),Qt=s(be,"DIV",{class:!0});var Wi=a(Qt);f(tn.$$.fragment,Wi),_c=l(Wi),Ba=s(Wi,"P",{});var kf=a(Ba);kc=i(kf,"Just EOS"),kf.forEach(t),Wi.forEach(t),be.forEach(t),ii=l(o),Ft=s(o,"H2",{class:!0});var Bi=a(Ft);eo=s(Bi,"A",{id:!0,class:!0,href:!0});var vf=a(eo);Ra=s(vf,"SPAN",{});var yf=a(Ra);f(on.$$.fragment,yf),yf.forEach(t),vf.forEach(t),vc=l(Bi),Ha=s(Bi,"SPAN",{});var Tf=a(Ha);yc=i(Tf,"PegasusTokenizerFast"),Tf.forEach(t),Bi.forEach(t),di=l(o),ce=s(o,"DIV",{class:!0});var rt=a(ce);f(nn.$$.fragment,rt),Tc=l(rt),Et=s(rt,"P",{});var Js=a(Et);bc=i(Js,"Construct a \u201Cfast\u201D PEGASUS tokenizer (backed by HuggingFace\u2019s "),Va=s(Js,"EM",{});var bf=a(Va);Pc=i(bf,"tokenizers"),bf.forEach(t),wc=i(Js," library). Based on "),sn=s(Js,"A",{href:!0,rel:!0});var Pf=a(sn);xc=i(Pf,"Unigram"),Pf.forEach(t),zc=i(Js,"."),Js.forEach(t),$c=l(rt),an=s(rt,"P",{});var Ri=a(an);Fc=i(Ri,"This tokenizer inherits from "),Es=s(Ri,"A",{href:!0});var wf=a(Es);Ec=i(wf,"PreTrainedTokenizerFast"),wf.forEach(t),Mc=i(Ri,` which contains most of the main
...
subclass. Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to
general usage and behavior.`),Ki.forEach(t),eu=l(To),_e=s(To,"DIV",{class:!0});var it=a(_e);f(gn.$$.fragment,it),tu=l(it),jt=s(it,"P",{});var Zs=a(jt);ou=i(Zs,"The "),qs=s(Zs,"A",{href:!0});var Sf=a(qs);nu=i(Sf,"PegasusModel"),Sf.forEach(t),su=i(Zs," forward method, overrides the "),er=s(Zs,"CODE",{});var Af=a(er);au=i(Af,"__call__"),Af.forEach(t),ru=i(Zs," special method."),Zs.forEach(t),iu=l(it),f(no.$$.fragment,it),du=l(it),tr=s(it,"P",{});var If=a(tr);lu=i(If,"Example:"),If.forEach(t),cu=l(it),f(_n.$$.fragment,it),it.forEach(t),To.forEach(t),ui=l(o),qt=s(o,"H2",{class:!0});var Yi=a(qt);so=s(Yi,"A",{id:!0,class:!0,href:!0});var Nf=a(so);or=s(Nf,"SPAN",{});var Of=a(or);f(kn.$$.fragment,Of),Of.forEach(t),Nf.forEach(t),uu=l(Yi),nr=s(Yi,"SPAN",{});var Lf=a(nr);pu=i(Lf,"PegasusForConditionalGeneration"),Lf.forEach(t),Yi.forEach(t),pi=l(o),je=s(o,"DIV",{class:!0});var bo=a(je);f(vn.$$.fragment,bo),hu=l(bo),yn=s(bo,"P",{});var Qi=a(yn);mu=i(Qi,`The PEGASUS Model with a language modeling head. Can be used for summarization.
...
it as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage
and behavior.`),id.forEach(t),fp=l(ut),f(po.$$.fragment,ut),gp=l(ut),ye=s(ut,"DIV",{class:!0});var pt=a(ye);f(Dn.$$.fragment,pt),_p=l(pt),Ot=s(pt,"P",{});var ea=a(Ot);kp=i(ea,"The "),Os=s(ea,"A",{href:!0});var lg=a(Os);vp=i(lg,"TFPegasusForConditionalGeneration"),lg.forEach(t),yp=i(ea," forward method, overrides the "),fr=s(ea,"CODE",{});var cg=a(fr);Tp=i(cg,"__call__"),cg.forEach(t),bp=i(ea," special method."),ea.forEach(t),Pp=l(pt),f(ho.$$.fragment,pt),wp=l(pt),gr=s(pt,"P",{});var ug=a(gr);xp=i(ug,"Summarization example:"),ug.forEach(t),zp=l(pt),f(Un.$$.fragment,pt),pt.forEach(t),ut.forEach(t),vi=l(o),Lt=s(o,"H2",{class:!0});var dd=a(Lt);mo=s(dd,"A",{id:!0,class:!0,href:!0});var pg=a(mo);_r=s(pg,"SPAN",{});var hg=a(_r);f(Wn.$$.fragment,hg),hg.forEach(t),pg.forEach(t),$p=l(dd),kr=s(dd,"SPAN",{});var mg=a(kr);Fp=i(mg,"FlaxPegasusModel"),mg.forEach(t),dd.forEach(t),yi=l(o),I=s(o,"DIV",{class:!0});var te=a(I);f(Bn.$$.fragment,te),Ep=l(te),Rn=s(te,"P",{});var ld=a(Rn);Mp=i(ld,`The bare Pegasus Model transformer outputting raw hidden-states without any specific head on top.
