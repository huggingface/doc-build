import{S as xc,i as Pc,s as Sc,e as a,k as l,w,t as n,L as jc,c as r,d as t,m as d,a as i,x as L,h as s,b as c,J as e,g as u,y as $,q as R,o as M,B as E}from"../../chunks/vendor-e859c359.js";import{T as wt}from"../../chunks/Tip-edc75249.js";import{D as Ie}from"../../chunks/Docstring-ade913b3.js";import{C as Vt}from"../../chunks/CodeBlock-ce4317c2.js";import{I as it}from"../../chunks/IconCopyLink-5fae3b20.js";import"../../chunks/CopyButton-77addb3d.js";function Ic(B){let p,C,f,g,v;return{c(){p=a("p"),C=n(`Although the recipe for forward pass needs to be defined within this function, one should call the
...
`),G=r(be,"CODE",{});var Ue=i(G);Ce=s(Ue,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),Ue.forEach(t),be.forEach(t),D.forEach(t)},m(h,k){u(h,p,k),e(p,C),u(h,f,k),u(h,g,k),e(g,v),e(v,T),e(g,_),e(g,y),e(y,fe),u(h,Q,k),u(h,b,k),e(b,X),e(b,A),e(A,Y),e(b,ge),e(b,H),e(H,_e),e(b,ce),u(h,P,k),u(h,S,k),e(S,Z),u(h,oe,k),u(h,F,k),e(F,z),e(z,Te),e(z,U),e(U,he),e(z,ne),e(z,V),e(V,pe),e(F,se),e(F,q),e(q,ve),e(q,O),e(O,ae),e(q,ke),e(q,W),e(W,j),e(F,ee),e(F,I),e(I,te),e(I,G),e(G,Ce)},d(h){h&&t(p),h&&t(f),h&&t(g),h&&t(Q),h&&t(b),h&&t(P),h&&t(S),h&&t(oe),h&&t(F)}}}function Hc(B){let p,C,f,g,v;return{c(){p=a("p"),C=n(`Although the recipe for forward pass needs to be defined within this function, one should call the
`),f=a("code"),g=n("Module"),v=n(` instance afterwards instead of this since the former takes care of running the pre and post
processing steps while the latter silently ignores them.`)},l(T){p=r(T,"P",{});var _=i(p);C=s(_,`Although the recipe for forward pass needs to be defined within this function, one should call the
`),f=r(_,"CODE",{});var y=i(f);g=s(y,"Module"),y.forEach(t),v=s(_,` instance afterwards instead of this since the former takes care of running the pre and post
processing steps while the latter silently ignores them.`),_.forEach(t)},m(T,_){u(T,p,_),e(p,C),e(p,f),e(f,g),e(p,v)},d(T){T&&t(p)}}}function Oc(B){let p,C,f,g,v,T,_,y,fe,Q,b,X,A,Y,ge,H,_e,ce,P,S,Z,oe,F,z,Te,U,he,ne,V,pe,se,q,ve,O,ae,ke,W,j,ee,I,te,G,Ce;return{c(){p=a("p"),C=n("TF 2.0 models accepts two formats as inputs:"),f=l(),g=a("ul"),v=a("li"),T=n("having all inputs as keyword arguments (like PyTorch models), or"),_=l(),y=a("li"),fe=n("having all inputs as a list, tuple or dict in the first positional arguments."),Q=l(),b=a("p"),X=n("This second option is useful when using "),A=a("code"),Y=n("tf.keras.Model.fit"),ge=n(` method which currently requires having all
the tensors in the first argument of the model call function: `),H=a("code"),_e=n("model(inputs)"),ce=n("."),P=l(),S=a("p"),Z=n(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in
the first positional argument :`),oe=l(),F=a("ul"),z=a("li"),Te=n("a single Tensor with "),U=a("code"),he=n("input_ids"),ne=n(" only and nothing else: "),V=a("code"),pe=n("model(inputs_ids)"),se=l(),q=a("li"),ve=n(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),O=a("code"),ae=n("model([input_ids, attention_mask])"),ke=n(" or "),W=a("code"),j=n("model([input_ids, attention_mask, token_type_ids])"),ee=l(),I=a("li"),te=n(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),G=a("code"),Ce=n('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(h){p=r(h,"P",{});var k=i(p);C=s(k,"TF 2.0 models accepts two formats as inputs:"),k.forEach(t),f=d(h),g=r(h,"UL",{});var re=i(g);v=r(re,"LI",{});var Ae=i(v);T=s(Ae,"having all inputs as keyword arguments (like PyTorch models), or"),Ae.forEach(t),_=d(re),y=r(re,"LI",{});var ue=i(y);fe=s(ue,"having all inputs as a list, tuple or dict in the first positional arguments."),ue.forEach(t),re.forEach(t),Q=d(h),b=r(h,"P",{});var N=i(b);X=s(N,"This second option is useful when using "),A=r(N,"CODE",{});var Me=i(A);Y=s(Me,"tf.keras.Model.fit"),Me.forEach(t),ge=s(N,` method which currently requires having all
...
the first positional argument :`),Oe.forEach(t),oe=d(h),F=r(h,"UL",{});var D=i(F);z=r(D,"LI",{});var x=i(z);Te=s(x,"a single Tensor with "),U=r(x,"CODE",{});var We=i(U);he=s(We,"input_ids"),We.forEach(t),ne=s(x," only and nothing else: "),V=r(x,"CODE",{});var Ee=i(V);pe=s(Ee,"model(inputs_ids)"),Ee.forEach(t),x.forEach(t),se=d(D),q=r(D,"LI",{});var K=i(q);ve=s(K,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),O=r(K,"CODE",{});var Be=i(O);ae=s(Be,"model([input_ids, attention_mask])"),Be.forEach(t),ke=s(K," or "),W=r(K,"CODE",{});var Fe=i(W);j=s(Fe,"model([input_ids, attention_mask, token_type_ids])"),Fe.forEach(t),K.forEach(t),ee=d(D),I=r(D,"LI",{});var be=i(I);te=s(be,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),G=r(be,"CODE",{});var Ue=i(G);Ce=s(Ue,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),Ue.forEach(t),be.forEach(t),D.forEach(t)},m(h,k){u(h,p,k),e(p,C),u(h,f,k),u(h,g,k),e(g,v),e(v,T),e(g,_),e(g,y),e(y,fe),u(h,Q,k),u(h,b,k),e(b,X),e(b,A),e(A,Y),e(b,ge),e(b,H),e(H,_e),e(b,ce),u(h,P,k),u(h,S,k),e(S,Z),u(h,oe,k),u(h,F,k),e(F,z),e(z,Te),e(z,U),e(U,he),e(z,ne),e(z,V),e(V,pe),e(F,se),e(F,q),e(q,ve),e(q,O),e(O,ae),e(q,ke),e(q,W),e(W,j),e(F,ee),e(F,I),e(I,te),e(I,G),e(G,Ce)},d(h){h&&t(p),h&&t(f),h&&t(g),h&&t(Q),h&&t(b),h&&t(P),h&&t(S),h&&t(oe),h&&t(F)}}}function Wc(B){let p,C,f,g,v;return{c(){p=a("p"),C=n(`Although the recipe for forward pass needs to be defined within this function, one should call the
`),f=a("code"),g=n("Module"),v=n(` instance afterwards instead of this since the former takes care of running the pre and post
processing steps while the latter silently ignores them.`)},l(T){p=r(T,"P",{});var _=i(p);C=s(_,`Although the recipe for forward pass needs to be defined within this function, one should call the
`),f=r(_,"CODE",{});var y=i(f);g=s(y,"Module"),y.forEach(t),v=s(_,` instance afterwards instead of this since the former takes care of running the pre and post
processing steps while the latter silently ignores them.`),_.forEach(t)},m(T,_){u(T,p,_),e(p,C),e(p,f),e(f,g),e(p,v)},d(T){T&&t(p)}}}function Bc(B){let p,C,f,g,v,T,_,y,fe,Q,b,X,A,Y,ge,H,_e,ce,P,S,Z,oe,F,z,Te,U,he,ne,V,pe,se,q,ve,O,ae,ke,W,j,ee,I,te,G,Ce;return{c(){p=a("p"),C=n("TF 2.0 models accepts two formats as inputs:"),f=l(),g=a("ul"),v=a("li"),T=n("having all inputs as keyword arguments (like PyTorch models), or"),_=l(),y=a("li"),fe=n("having all inputs as a list, tuple or dict in the first positional arguments."),Q=l(),b=a("p"),X=n("This second option is useful when using "),A=a("code"),Y=n("tf.keras.Model.fit"),ge=n(` method which currently requires having all
the tensors in the first argument of the model call function: `),H=a("code"),_e=n("model(inputs)"),ce=n("."),P=l(),S=a("p"),Z=n(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in
the first positional argument :`),oe=l(),F=a("ul"),z=a("li"),Te=n("a single Tensor with "),U=a("code"),he=n("input_ids"),ne=n(" only and nothing else: "),V=a("code"),pe=n("model(inputs_ids)"),se=l(),q=a("li"),ve=n(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),O=a("code"),ae=n("model([input_ids, attention_mask])"),ke=n(" or "),W=a("code"),j=n("model([input_ids, attention_mask, token_type_ids])"),ee=l(),I=a("li"),te=n(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),G=a("code"),Ce=n('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(h){p=r(h,"P",{});var k=i(p);C=s(k,"TF 2.0 models accepts two formats as inputs:"),k.forEach(t),f=d(h),g=r(h,"UL",{});var re=i(g);v=r(re,"LI",{});var Ae=i(v);T=s(Ae,"having all inputs as keyword arguments (like PyTorch models), or"),Ae.forEach(t),_=d(re),y=r(re,"LI",{});var ue=i(y);fe=s(ue,"having all inputs as a list, tuple or dict in the first positional arguments."),ue.forEach(t),re.forEach(t),Q=d(h),b=r(h,"P",{});var N=i(b);X=s(N,"This second option is useful when using "),A=r(N,"CODE",{});var Me=i(A);Y=s(Me,"tf.keras.Model.fit"),Me.forEach(t),ge=s(N,` method which currently requires having all
...
the first positional argument :`),Oe.forEach(t),oe=d(h),F=r(h,"UL",{});var D=i(F);z=r(D,"LI",{});var x=i(z);Te=s(x,"a single Tensor with "),U=r(x,"CODE",{});var We=i(U);he=s(We,"input_ids"),We.forEach(t),ne=s(x," only and nothing else: "),V=r(x,"CODE",{});var Ee=i(V);pe=s(Ee,"model(inputs_ids)"),Ee.forEach(t),x.forEach(t),se=d(D),q=r(D,"LI",{});var K=i(q);ve=s(K,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),O=r(K,"CODE",{});var Be=i(O);ae=s(Be,"model([input_ids, attention_mask])"),Be.forEach(t),ke=s(K," or "),W=r(K,"CODE",{});var Fe=i(W);j=s(Fe,"model([input_ids, attention_mask, token_type_ids])"),Fe.forEach(t),K.forEach(t),ee=d(D),I=r(D,"LI",{});var be=i(I);te=s(be,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),G=r(be,"CODE",{});var Ue=i(G);Ce=s(Ue,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),Ue.forEach(t),be.forEach(t),D.forEach(t)},m(h,k){u(h,p,k),e(p,C),u(h,f,k),u(h,g,k),e(g,v),e(v,T),e(g,_),e(g,y),e(y,fe),u(h,Q,k),u(h,b,k),e(b,X),e(b,A),e(A,Y),e(b,ge),e(b,H),e(H,_e),e(b,ce),u(h,P,k),u(h,S,k),e(S,Z),u(h,oe,k),u(h,F,k),e(F,z),e(z,Te),e(z,U),e(U,he),e(z,ne),e(z,V),e(V,pe),e(F,se),e(F,q),e(q,ve),e(q,O),e(O,ae),e(q,ke),e(q,W),e(W,j),e(F,ee),e(F,I),e(I,te),e(I,G),e(G,Ce)},d(h){h&&t(p),h&&t(f),h&&t(g),h&&t(Q),h&&t(b),h&&t(P),h&&t(S),h&&t(oe),h&&t(F)}}}function Uc(B){let p,C,f,g,v;return{c(){p=a("p"),C=n(`Although the recipe for forward pass needs to be defined within this function, one should call the
`),f=a("code"),g=n("Module"),v=n(` instance afterwards instead of this since the former takes care of running the pre and post
processing steps while the latter silently ignores them.`)},l(T){p=r(T,"P",{});var _=i(p);C=s(_,`Although the recipe for forward pass needs to be defined within this function, one should call the
`),f=r(_,"CODE",{});var y=i(f);g=s(y,"Module"),y.forEach(t),v=s(_,` instance afterwards instead of this since the former takes care of running the pre and post
processing steps while the latter silently ignores them.`),_.forEach(t)},m(T,_){u(T,p,_),e(p,C),e(p,f),e(f,g),e(p,v)},d(T){T&&t(p)}}}function Vc(B){let p,C,f,g,v,T,_,y,fe,Q,b,X,A,Y,ge,H,_e,ce,P,S,Z,oe,F,z,Te,U,he,ne,V,pe,se,q,ve,O,ae,ke,W,j,ee,I,te,G,Ce,h,k,re,Ae,ue,N,Me,He,Oe,D,x,We,Ee,K,Be,Fe,be,Ue,Ko,la,da,Cs,Xe,ca,Gt,ha,pa,Kt,ua,ma,bs,lt,Lt,wn,Jt,fa,Ln,ga,ys,ye,Xt,_a,Je,Ta,Jo,va,ka,Xo,Ca,ba,Qt,ya,wa,La,dt,$a,Qo,Ra,Ma,Yo,Ea,Fa,za,$n,qa,xa,Yt,ws,ct,$t,Rn,Zt,Pa,Mn,Sa,Ls,Ne,eo,ja,En,Ia,Na,to,Da,Zo,Aa,Ha,Oa,Fn,$s,ht,Rt,zn,oo,Wa,qn,Ba,Rs,we,no,Ua,xn,Va,Ga,so,Ka,en,Ja,Xa,Qa,ao,Ya,ro,Za,er,tr,ze,io,or,pt,nr,tn,sr,ar,Pn,rr,ir,lr,Mt,dr,Sn,cr,hr,lo,Ms,ut,Et,jn,co,pr,In,ur,Es,Le,ho,mr,Nn,fr,gr,po,_r,on,Tr,vr,kr,uo,Cr,mo,br,yr,wr,qe,fo,Lr,mt,$r,nn,Rr,Mr,Dn,Er,Fr,zr,Ft,qr,An,xr,Pr,go,Fs,ft,zt,Hn,_o,Sr,On,jr,zs,$e,To,Ir,Re,Nr,sn,Dr,Ar,Wn,Hr,Or,Bn,Wr,Br,Un,Ur,Vr,Vn,Gr,Kr,Jr,vo,Xr,an,Qr,Yr,Zr,ko,ei,Co,ti,oi,ni,ie,bo,si,gt,ai,rn,ri,ii,Gn,li,di,ci,qt,hi,Kn,pi,ui,yo,mi,Jn,fi,gi,wo,qs,_t,xt,Xn,Lo,_i,Qn,Ti,xs,le,$o,vi,Yn,ki,Ci,Ro,bi,ln,yi,wi,Li,Mo,$i,Eo,Ri,Mi,Ei,Pt,Fi,xe,Fo,zi,Tt,qi,dn,xi,Pi,Zn,Si,ji,Ii,St,Ni,es,Di,Ai,zo,Ps,vt,jt,ts,qo,Hi,os,Oi,Ss,de,xo,Wi,ns,Bi,Ui,Po,Vi,cn,Gi,Ki,Ji,So,Xi,jo,Qi,Yi,Zi,It,el,Pe,Io,tl,kt,ol,hn,nl,sl,ss,al,rl,il,Nt,ll,as,dl,cl,No,js,Ct,Dt,rs,Do,hl,is,pl,Is,J,Ao,ul,ls,ml,fl,pn,un,gl,_l,Tl,De,vl,ds,kl,Cl,cs,bl,yl,hs,wl,Ll,ps,$l,Rl,Ml,Ho,El,mn,Fl,zl,ql,Oo,xl,Wo,Pl,Sl,jl,At,Il,Se,Bo,Nl,bt,Dl,fn,Al,Hl,us,Ol,Wl,Bl,Ht,Ul,ms,Vl,Gl,Uo,Ns;return T=new it({}),Y=new it({}),Jt=new it({}),Xt=new Ie({props:{name:"class transformers.CTRLConfig",anchor:"transformers.CTRLConfig",parameters:[{name:"vocab_size",val:" = 246534"},{name:"n_positions",val:" = 256"},{name:"n_embd",val:" = 1280"},{name:"dff",val:" = 8192"},{name:"n_layer",val:" = 48"},{name:"n_head",val:" = 16"},{name:"resid_pdrop",val:" = 0.1"},{name:"embd_pdrop",val:" = 0.1"},{name:"attn_pdrop",val:" = 0.1"},{name:"layer_norm_epsilon",val:" = 1e-06"},{name:"initializer_range",val:" = 0.02"},{name:"summary_type",val:" = 'cls_index'"},{name:"summary_use_proj",val:" = True"},{name:"summary_activation",val:" = None"},{name:"summary_proj_to_labels",val:" = True"},{name:"summary_first_dropout",val:" = 0.1"},{name:"use_cache",val:" = True"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/master/src/transformers/models/ctrl/configuration_ctrl.py#L26",parametersDescription:[{anchor:"transformers.CTRLConfig.vocab_size",description:`<strong>vocab_size</strong> (<code>int</code>, <em>optional</em>, defaults to 246534) &#x2014;
...
<span class="hljs-meta">&gt;&gt;&gt; </span>outputs = model(inputs)
<span class="hljs-meta">&gt;&gt;&gt; </span>loss = outputs.loss
<span class="hljs-meta">&gt;&gt;&gt; </span>logits = outputs.logits`}}),{c(){p=a("meta"),C=l(),f=a("h1"),g=a("a"),v=a("span"),w(T.$$.fragment),_=l(),y=a("span"),fe=n("CTRL"),Q=l(),b=a("h2"),X=a("a"),A=a("span"),w(Y.$$.fragment),ge=l(),H=a("span"),_e=n("Overview"),ce=l(),P=a("p"),S=n("CTRL model was proposed in "),Z=a("a"),oe=n("CTRL: A Conditional Transformer Language Model for Controllable Generation"),F=n(" by Nitish Shirish Keskar"),z=a("em"),Te=n(", Bryan McCann"),U=n(`, Lav R. Varshney, Caiming Xiong and
...
`),Kt=a("a"),ua=n("here"),ma=n("."),bs=l(),lt=a("h2"),Lt=a("a"),wn=a("span"),w(Jt.$$.fragment),fa=l(),Ln=a("span"),ga=n("CTRLConfig"),ys=l(),ye=a("div"),w(Xt.$$.fragment),_a=l(),Je=a("p"),Ta=n("This is the configuration class to store the configuration of a "),Jo=a("a"),va=n("CTRLModel"),ka=n(` or a
...
`),Kt=r(gn,"A",{href:!0,rel:!0});var ld=i(Kt);ua=s(ld,"here"),ld.forEach(t),ma=s(gn,"."),gn.forEach(t),bs=d(o),lt=r(o,"H2",{class:!0});var Hs=i(lt);Lt=r(Hs,"A",{id:!0,class:!0,href:!0});var dd=i(Lt);wn=r(dd,"SPAN",{});var cd=i(wn);L(Jt.$$.fragment,cd),cd.forEach(t),dd.forEach(t),fa=d(Hs),Ln=r(Hs,"SPAN",{});var hd=i(Ln);ga=s(hd,"CTRLConfig"),hd.forEach(t),Hs.forEach(t),ys=d(o),ye=r(o,"DIV",{class:!0});var Qe=i(ye);L(Xt.$$.fragment,Qe),_a=d(Qe),Je=r(Qe,"P",{});var Bt=i(Je);Ta=s(Bt,"This is the configuration class to store the configuration of a "),Jo=r(Bt,"A",{href:!0});var pd=i(Jo);va=s(pd,"CTRLModel"),pd.forEach(t),ka=s(Bt,` or a
...
Users should refer to this superclass for more information regarding those methods.`),Ws.forEach(t),Oa=d(Ut),Fn=r(Ut,"DIV",{class:!0}),i(Fn).forEach(t),Ut.forEach(t),$s=d(o),ht=r(o,"H2",{class:!0});var Bs=i(ht);Rt=r(Bs,"A",{id:!0,class:!0,href:!0});var yd=i(Rt);zn=r(yd,"SPAN",{});var wd=i(zn);L(oo.$$.fragment,wd),wd.forEach(t),yd.forEach(t),Wa=d(Bs),qn=r(Bs,"SPAN",{});var Ld=i(qn);Ba=s(Ld,"CTRLModel"),Ld.forEach(t),Bs.forEach(t),Rs=d(o),we=r(o,"DIV",{class:!0});var Ye=i(we);L(no.$$.fragment,Ye),Ua=d(Ye),xn=r(Ye,"P",{});var $d=i(xn);Va=s($d,"The bare CTRL Model transformer outputting raw hidden-states without any specific head on top."),$d.forEach(t),Ga=d(Ye),so=r(Ye,"P",{});var Us=i(so);Ka=s(Us,"This model inherits from "),en=r(Us,"A",{href:!0});var Rd=i(en);Ja=s(Rd,"PreTrainedModel"),Rd.forEach(t),Xa=s(Us,`. Check the superclass documentation for the generic
methods the library implements for all its model (such as downloading or saving, resizing the input embeddings,
...
methods the library implements for all its model (such as downloading or saving, resizing the input embeddings,
pruning heads etc.)`),Ks.forEach(t),kr=d(et),uo=r(et,"P",{});var Js=i(uo);Cr=s(Js,"This model is also a PyTorch "),mo=r(Js,"A",{href:!0,rel:!0});var Id=i(mo);br=s(Id,"torch.nn.Module"),Id.forEach(t),yr=s(Js,`
subclass. Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to
general usage and behavior.`),Js.forEach(t),wr=d(et),qe=r(et,"DIV",{class:!0});var tt=i(qe);L(fo.$$.fragment,tt),Lr=d(tt),mt=r(tt,"P",{});var vn=i(mt);$r=s(vn,"The "),nn=r(vn,"A",{href:!0});var Nd=i(nn);Rr=s(Nd,"CTRLLMHeadModel"),Nd.forEach(t),Mr=s(vn," forward method, overrides the "),Dn=r(vn,"CODE",{});var Dd=i(Dn);Er=s(Dd,"__call__"),Dd.forEach(t),Fr=s(vn," special method."),vn.forEach(t),zr=d(tt),L(Ft.$$.fragment,tt),qr=d(tt),An=r(tt,"P",{});var Ad=i(An);xr=s(Ad,"Example:"),Ad.forEach(t),Pr=d(tt),L(go.$$.fragment,tt),tt.forEach(t),et.forEach(t),Fs=d(o),ft=r(o,"H2",{class:!0});var Xs=i(ft);zt=r(Xs,"A",{id:!0,class:!0,href:!0});var Hd=i(zt);Hn=r(Hd,"SPAN",{});var Od=i(Hn);L(_o.$$.fragment,Od),Od.forEach(t),Hd.forEach(t),Sr=d(Xs),On=r(Xs,"SPAN",{});var Wd=i(On);jr=s(Wd,"CTRLForSequenceClassification"),Wd.forEach(t),Xs.forEach(t),zs=d(o),$e=r(o,"DIV",{class:!0});var ot=i($e);L(To.$$.fragment,ot),Ir=d(ot),Re=r(ot,"P",{});var Ve=i(Re);Nr=s(Ve,`The CTRL Model transformer with a sequence classification head on top (linear layer).
