import{S as Ec,i as $c,s as qc,e as r,k as d,w as _,t as a,M as wc,c as n,d as s,m as p,a as i,x as g,h as t,b as m,G as o,g as c,y as h,q as b,o as v,B as y,v as Cc}from"../chunks/vendor-hf-doc-builder.js";import{T as Tn}from"../chunks/Tip-hf-doc-builder.js";import{I as wo}from"../chunks/IconCopyLink-hf-doc-builder.js";import{C}from"../chunks/CodeBlock-hf-doc-builder.js";function jc(ae){let u,j;return{c(){u=r("p"),j=a("Si tu modelo es muy similar a un modelo dentro de la biblioteca, puedes reutilizar la misma configuraci\xF3n de ese modelo.")},l(f){u=n(f,"P",{});var E=i(u);j=t(E,"Si tu modelo es muy similar a un modelo dentro de la biblioteca, puedes reutilizar la misma configuraci\xF3n de ese modelo."),E.forEach(s)},m(f,E){c(f,u,E),o(u,j)},d(f){f&&s(u)}}}function kc(ae){let u,j,f,E,A;return{c(){u=r("p"),j=a("Esta "),f=r("em"),E=a("API"),A=a(" es experimental y puede tener algunos cambios leves en las pr\xF3ximas versiones.")},l(q){u=n(q,"P",{});var w=i(u);j=t(w,"Esta "),f=n(w,"EM",{});var I=i(f);E=t(I,"API"),I.forEach(s),A=t(w," es experimental y puede tener algunos cambios leves en las pr\xF3ximas versiones."),w.forEach(s)},m(q,w){c(q,u,w),o(u,j),o(u,f),o(f,E),o(u,A)},d(q){q&&s(u)}}}function Pc(ae){let u,j,f,E,A;return{c(){u=r("p"),j=a(`Si copias archivos del modelo desde la biblioteca, deber\xE1s reemplazar todas las importaciones relativas en la parte superior
del archivo para importarlos desde el paquete `),f=r("code"),E=a("transformers"),A=a(".")},l(q){u=n(q,"P",{});var w=i(u);j=t(w,`Si copias archivos del modelo desde la biblioteca, deber\xE1s reemplazar todas las importaciones relativas en la parte superior
del archivo para importarlos desde el paquete `),f=n(w,"CODE",{});var I=i(f);E=t(I,"transformers"),I.forEach(s),A=t(w,"."),w.forEach(s)},m(q,w){c(q,u,w),o(u,j),o(u,f),o(f,E),o(u,A)},d(q){q&&s(u)}}}function zc(ae){let u,j,f,E,A,q,w,I,ft,Bs,Ze,_t,Us,eo,gt,Gs,F,ht,je,bt,vt,Co,yt,Et,Ks,X,te,jo,ke,$t,ko,qt,Vs,le,wt,Po,Ct,jt,Js,oo,kt,Qs,Pe,Ws,so,Pt,Xs,x,ze,zt,zo,Rt,At,Mt,L,Ot,Ro,Dt,Tt,Ao,Nt,It,Mo,Lt,Ft,xt,Y,St,Oo,Ht,Bt,Do,Ut,Gt,Ys,P,Kt,To,Vt,Jt,No,Qt,Wt,Io,Xt,Yt,Lo,Zt,el,Zs,S,ol,Fo,sl,al,xo,tl,ll,ea,ao,rl,oa,Re,sa,M,nl,So,il,cl,Ho,dl,pl,Bo,ul,ml,aa,Ae,ta,H,fl,Uo,_l,gl,Go,hl,bl,la,Z,re,Ko,Me,vl,Vo,yl,ra,B,El,Jo,$l,ql,Qo,wl,Cl,na,U,jl,Wo,kl,Pl,Xo,zl,Rl,ia,Oe,ca,ne,Al,Yo,Ml,Ol,da,De,pa,z,Dl,Zo,Tl,Nl,es,Il,Ll,os,Fl,xl,ss,Sl,Hl,ua,ie,ma,O,Bl,as,Ul,Gl,ts,Kl,Vl,ls,Jl,Ql,fa,to,Wl,_a,Te,ga,D,Xl,rs,Yl,Zl,ns,er,or,is,sr,ar,ha,lo,tr,ba,Ne,va,G,lr,cs,rr,nr,ds,ir,cr,ya,ee,ce,ps,Ie,dr,us,pr,Ea,de,$a,$,ur,ms,mr,fr,fs,_r,gr,_s,hr,br,gs,vr,yr,hs,Er,$r,bs,qr,wr,vs,Cr,jr,qa,Le,wa,K,kr,ys,Pr,zr,Es,Rr,Ar,Ca,pe,ja,ro,Mr,ka,no,Or,Pa,Fe,za,ue,Dr,$s,Tr,Nr,Ra,xe,Aa,me,Ir,qs,Lr,Fr,Ma,io,xr,Oa,Se,Da,co,Sr,Ta,He,Na,fe,Hr,ws,Br,Ur,Ia,Be,La,po,Gr,Fa,Ue,xa,T,Kr,Cs,Vr,Jr,js,Qr,Wr,Ge,Xr,Yr,Sa,_e,Zr,uo,en,on,Ha,oe,ge,ks,Ke,sn,Ps,an,Ba,R,tn,zs,ln,rn,Rs,nn,cn,Ve,dn,pn,As,un,mn,Ua,Je,Ga,he,fn,Ms,_n,gn,Ka,Qe,Va,be,hn,Os,bn,vn,Ja,se,ve,Ds,We,yn,Ts,En,Qa,mo,$n,Wa,V,qn,Ns,wn,Cn,Is,jn,kn,Xa,Xe,Ya,N,Pn,Ls,zn,Rn,Fs,An,Mn,xs,On,Dn,Za;return q=new wo({}),ke=new wo({}),Pe=new C({props:{code:`from transformers import PretrainedConfig
...
<span class="hljs-keyword">class</span> <span class="hljs-title class_">ResnetModel</span>(<span class="hljs-title class_ inherited__">PreTrainedModel</span>):
    ...
    <span class="hljs-keyword">def</span> <span class="hljs-title function_">forward</span>(<span class="hljs-params">self, tensor</span>):
        <span class="hljs-keyword">return</span> self.model.forward_features(tensor)`}}),De=new C({props:{code:`import torch
...
AutoModel.register(ResnetConfig, ResnetModel)
AutoModelForImageClassification.register(ResnetConfig, ResnetModelForImageClassification)`}}),{c(){u=r("meta"),j=d(),f=r("h1"),E=r("a"),A=r("span"),_(q.$$.fragment),w=d(),I=r("span"),ft=a("Compartir modelos personalizados"),Bs=d(),Ze=r("p"),_t=a(`La biblioteca \u{1F917} Transformers est\xE1 dise\xF1ada para ser f\xE1cilmente ampliable. Cada modelo est\xE1 completamente codificado
...
directamente tu configuraci\xF3n en el Hub.`),la=d(),Z=r("h2"),re=r("a"),Ko=r("span"),_(Me.$$.fragment),vl=d(),Vo=r("span"),yl=a("Escribir un modelo personalizado"),ra=d(),B=r("p"),El=a(`Ahora que tenemos nuestra configuraci\xF3n de ResNet, podemos seguir escribiendo el modelo. En realidad escribiremos dos: una que
...
se guarda el c\xF3digo del modelo.`),ya=d(),ee=r("h2"),ce=r("a"),ps=r("span"),_(Ie.$$.fragment),dr=d(),us=r("span"),pr=a("Enviar el c\xF3digo al _Hub_"),Ea=d(),_(de.$$.fragment),$a=d(),$=r("p"),ur=a("Primero, aseg\xFArate de que tu modelo est\xE9 completamente definido en un archivo "),ms=r("code"),mr=a(".py"),fr=a(`. Puedes basarte en importaciones
...
`),_s=r("code"),hr=a("configuration_resnet.py"),br=a(" en una carpeta del directorio de trabajo actual llamado "),gs=r("code"),vr=a("resnet_model"),yr=a(`. El archivo de configuraci\xF3n
contiene el c\xF3digo de `),hs=r("code"),Er=a("ResnetConfig"),$r=a(" y el archivo del modelo contiene el c\xF3digo de "),bs=r("code"),qr=a("ResnetModel"),wr=a(` y
`),vs=r("code"),Cr=a("ResnetModelForImageClassification"),jr=a("."),qa=d(),_(Le.$$.fragment),wa=d(),K=r("p"),kr=a("El "),ys=r("code"),Pr=a("__init__.py"),zr=a("  puede estar vac\xEDo, solo est\xE1 ah\xED para que Python detecte que "),Es=r("code"),Rr=a("resnet_model"),Ar=a(" se puede usar como un m\xF3dulo."),Ca=d(),_(pe.$$.fragment),ja=d(),ro=r("p"),Mr=a("Ten en cuenta que puedes reutilizar (o subclasificar) una configuraci\xF3n o modelo existente."),ka=d(),no=r("p"),Or=a(`Para compartir tu modelo con la comunidad, sigue estos pasos: primero importa el modelo y la configuraci\xF3n de ResNet desde
...
c\xF3mo escribir un modelo personalizado y su configuraci\xF3n para que pueda usarse dentro de Transformers, y c\xF3mo puedes compartirlo
con la comunidad (con el c\xF3digo en el que se basa) para que cualquiera pueda usarlo, incluso si no est\xE1 presente en la biblioteca
\u{1F917} Transformers.`),Ln.forEach(s),Gs=p(e),F=n(e,"P",{});var fo=i(F);ht=t(fo,"Ilustraremos todo esto con un modelo ResNet, envolviendo la clase ResNet de la "),je=n(fo,"A",{href:!0,rel:!0});var Fn=i(je);bt=t(Fn,"biblioteca timm"),Fn.forEach(s),vt=t(fo," en un "),Co=n(fo,"CODE",{});var xn=i(Co);yt=t(xn,"PreTrainedModel"),xn.forEach(s),Et=t(fo,"."),fo.forEach(s),Ks=p(e),X=n(e,"H2",{class:!0});var et=i(X);te=n(et,"A",{id:!0,class:!0,href:!0});var Sn=i(te);jo=n(Sn,"SPAN",{});var Hn=i(jo);g(ke.$$.fragment,Hn),Hn.forEach(s),Sn.forEach(s),$t=p(et),ko=n(et,"SPAN",{});var Bn=i(ko);qt=t(Bn,"Escribir una configuraci\xF3n personalizada"),Bn.forEach(s),et.forEach(s),Vs=p(e),le=n(e,"P",{});var ot=i(le);wt=t(ot,`Antes de adentrarnos en el modelo, primero escribamos su configuraci\xF3n. La configuraci\xF3n de un modelo es un objeto que
contendr\xE1 toda la informaci\xF3n necesaria para construir el modelo. Como veremos en la siguiente secci\xF3n, el modelo solo puede
...
modelo de la biblioteca. As\xED es como podemos crear una configuraci\xF3n resnet50d y guardarla:`),li.forEach(s),oa=p(e),g(Re.$$.fragment,e),sa=p(e),M=n(e,"P",{});var Ee=i(M);nl=t(Ee,"Esto guardar\xE1 un archivo llamado "),So=n(Ee,"CODE",{});var ri=i(So);il=t(ri,"config.json"),ri.forEach(s),cl=t(Ee," dentro de la carpeta "),Ho=n(Ee,"CODE",{});var ni=i(Ho);dl=t(ni,"custom-resnet"),ni.forEach(s),pl=t(Ee,`. Luego puedes volver a cargar tu configuraci\xF3n
con el m\xE9todo `),Bo=n(Ee,"CODE",{});var ii=i(Bo);ul=t(ii,"from_pretrained"),ii.forEach(s),ml=t(Ee,":"),Ee.forEach(s),aa=p(e),g(Ae.$$.fragment,e),ta=p(e),H=n(e,"P",{});var bo=i(H);fl=t(bo,"Tambi\xE9n puedes usar cualquier otro m\xE9todo de la clase "),Uo=n(bo,"CODE",{});var ci=i(Uo);_l=t(ci,"PretrainedConfig"),ci.forEach(s),gl=t(bo,", como "),Go=n(bo,"CODE",{});var di=i(Go);hl=t(di,"push_to_hub()"),di.forEach(s),bl=t(bo,`, para cargar
directamente tu configuraci\xF3n en el Hub.`),bo.forEach(s),la=p(e),Z=n(e,"H2",{class:!0});var at=i(Z);re=n(at,"A",{id:!0,class:!0,href:!0});var pi=i(re);Ko=n(pi,"SPAN",{});var ui=i(Ko);g(Me.$$.fragment,ui),ui.forEach(s),pi.forEach(s),vl=p(at),Vo=n(at,"SPAN",{});var mi=i(Vo);yl=t(mi,"Escribir un modelo personalizado"),mi.forEach(s),at.forEach(s),ra=p(e),B=n(e,"P",{});var vo=i(B);El=t(vo,`Ahora que tenemos nuestra configuraci\xF3n de ResNet, podemos seguir escribiendo el modelo. En realidad escribiremos dos: una que
...
imagenes (como `),Qo=n(vo,"CODE",{});var _i=i(Qo);wl=t(_i,"BertForSequenceClassification"),_i.forEach(s),Cl=t(vo,")."),vo.forEach(s),na=p(e),U=n(e,"P",{});var yo=i(U);jl=t(yo,"Como mencionamos antes, solo escribiremos un envoltura ("),Wo=n(yo,"EM",{});var gi=i(Wo);kl=t(gi,"wrapper"),gi.forEach(s),Pl=t(yo,`) libre del modelo para simplificar este ejemplo. Lo \xFAnico que debemos
hacer antes de escribir esta clase es un mapeo entre los tipos de bloques y las clases de bloques reales. Luego se define el
modelo desde la configuraci\xF3n pasando todo a la clase `),Xo=n(yo,"CODE",{});var hi=i(Xo);zl=t(hi,"ResNet"),hi.forEach(s),Rl=t(yo,":"),yo.forEach(s),ia=p(e),g(Oe.$$.fragment,e),ca=p(e),ne=n(e,"P",{});var tt=i(ne);Al=t(tt,"Para el modelo que clasificar\xE1 las im\xE1genes, solo cambiamos el m\xE9todo de avance (es decir, el m\xE9todo "),Yo=n(tt,"CODE",{});var bi=i(Yo);Ml=t(bi,"forward"),bi.forEach(s),Ol=t(tt,"):"),tt.forEach(s),da=p(e),g(De.$$.fragment,e),pa=p(e),z=n(e,"P",{});var Q=i(z);Dl=t(Q,"En ambos casos, observa c\xF3mo heredamos de "),Zo=n(Q,"CODE",{});var vi=i(Zo);Tl=t(vi,"PreTrainedModel"),vi.forEach(s),Nl=t(Q," y llamamos a la inicializaci\xF3n de la superclase con "),es=n(Q,"CODE",{});var yi=i(es);Il=t(yi,"config"),yi.forEach(s),Ll=t(Q,`
(un poco como cuando escribes `),os=n(Q,"CODE",{});var Ei=i(os);Fl=t(Ei,"torch.nn.Module"),Ei.forEach(s),xl=t(Q,"). La l\xEDnea que establece "),ss=n(Q,"CODE",{});var $i=i(ss);Sl=t($i,"config_class"),$i.forEach(s),Hl=t(Q,` no es obligatoria, a menos
...
tutorial, usaremos la versi\xF3n preentrenada de resnet50d. Dado que nuestro modelo es solo un envoltorio alrededor del resnet50d
original, ser\xE1 f\xE1cil transferir esos pesos:`),Ri.forEach(s),ba=p(e),g(Ne.$$.fragment,e),va=p(e),G=n(e,"P",{});var Eo=i(G);lr=t(Eo,"Ahora veamos c\xF3mo asegurarnos de que cuando hacemos "),cs=n(Eo,"CODE",{});var Ai=i(cs);rr=t(Ai,"save_pretrained()"),Ai.forEach(s),nr=t(Eo," o "),ds=n(Eo,"CODE",{});var Mi=i(ds);ir=t(Mi,"push_to_hub()"),Mi.forEach(s),cr=t(Eo,`,
se guarda el c\xF3digo del modelo.`),Eo.forEach(s),ya=p(e),ee=n(e,"H2",{class:!0});var lt=i(ee);ce=n(lt,"A",{id:!0,class:!0,href:!0});var Oi=i(ce);ps=n(Oi,"SPAN",{});var Di=i(ps);g(Ie.$$.fragment,Di),Di.forEach(s),Oi.forEach(s),dr=p(lt),us=n(lt,"SPAN",{});var Ti=i(us);pr=t(Ti,"Enviar el c\xF3digo al _Hub_"),Ti.forEach(s),lt.forEach(s),Ea=p(e),g(de.$$.fragment,e),$a=p(e),$=n(e,"P",{});var k=i($);ur=t(k,"Primero, aseg\xFArate de que tu modelo est\xE9 completamente definido en un archivo "),ms=n(k,"CODE",{});var Ni=i(ms);mr=t(Ni,".py"),Ni.forEach(s),fr=t(k,`. Puedes basarte en importaciones
relativas a otros archivos, siempre que todos los archivos est\xE9n en el mismo directorio (a\xFAn no admitimos subm\xF3dulos
...
`),_s=n(k,"CODE",{});var Li=i(_s);hr=t(Li,"configuration_resnet.py"),Li.forEach(s),br=t(k," en una carpeta del directorio de trabajo actual llamado "),gs=n(k,"CODE",{});var Fi=i(gs);vr=t(Fi,"resnet_model"),Fi.forEach(s),yr=t(k,`. El archivo de configuraci\xF3n
contiene el c\xF3digo de `),hs=n(k,"CODE",{});var xi=i(hs);Er=t(xi,"ResnetConfig"),xi.forEach(s),$r=t(k," y el archivo del modelo contiene el c\xF3digo de "),bs=n(k,"CODE",{});var Si=i(bs);qr=t(Si,"ResnetModel"),Si.forEach(s),wr=t(k,` y
`),vs=n(k,"CODE",{});var Hi=i(vs);Cr=t(Hi,"ResnetModelForImageClassification"),Hi.forEach(s),jr=t(k,"."),k.forEach(s),qa=p(e),g(Le.$$.fragment,e),wa=p(e),K=n(e,"P",{});var $o=i(K);kr=t($o,"El "),ys=n($o,"CODE",{});var Bi=i(ys);Pr=t(Bi,"__init__.py"),Bi.forEach(s),zr=t($o,"  puede estar vac\xEDo, solo est\xE1 ah\xED para que Python detecte que "),Es=n($o,"CODE",{});var Ui=i(Es);Rr=t(Ui,"resnet_model"),Ui.forEach(s),Ar=t($o," se puede usar como un m\xF3dulo."),$o.forEach(s),Ca=p(e),g(pe.$$.fragment,e),ja=p(e),ro=n(e,"P",{});var Gi=i(ro);Mr=t(Gi,"Ten en cuenta que puedes reutilizar (o subclasificar) una configuraci\xF3n o modelo existente."),Gi.forEach(s),ka=p(e),no=n(e,"P",{});var Ki=i(no);Or=t(Ki,`Para compartir tu modelo con la comunidad, sigue estos pasos: primero importa el modelo y la configuraci\xF3n de ResNet desde
