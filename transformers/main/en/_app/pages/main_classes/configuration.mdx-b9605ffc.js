...
`),Qe=r("a"),fn=o("EncoderDecoderConfig"),hn=o(" or "),Ye=r("a"),mn=o("~RagConfig"),gn=o("."),un=d(),Q=r("li"),yt=r("strong"),pn=o("keys_to_ignore_at_inference"),_n=o(" ("),vt=r("code"),bn=o("List[str]"),yn=o(`) \u2014 A list of keys to ignore by default when looking at dictionary
...
`),Qe=a(N,"A",{href:!0});var Ua=s(Qe);fn=n(Ua,"EncoderDecoderConfig"),Ua.forEach(t),hn=n(N," or "),Ye=a(N,"A",{href:!0});var Ja=s(Ye);mn=n(Ja,"~RagConfig"),Ja.forEach(t),gn=n(N,"."),N.forEach(t),un=c(ue),Q=a(ue,"LI",{});var Zt=s(Q);yt=a(Zt,"STRONG",{});var Ha=s(yt);pn=n(Ha,"keys_to_ignore_at_inference"),Ha.forEach(t),_n=n(Zt," ("),vt=a(Zt,"CODE",{});var Ga=s(vt);bn=n(Ga,"List[str]"),Ga.forEach(t),yn=n(Zt,`) \u2014 A list of keys to ignore by default when looking at dictionary
