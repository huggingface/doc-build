...
of the training.`)},l(q){g=l(q,"P",{});var E=r(g);S=n(E,"Note, that once "),b=l(E,"CODE",{});var gs=r(b);k=n(gs,"load_state_dict_from_zero_checkpoint"),gs.forEach(t),X=n(E," was run, the "),z=l(E,"CODE",{});var W=r(z);C=n(W,"model"),W.forEach(t),Q=n(E,` will no longer be usable in the
DeepSpeed context of the same application. i.e. you will need to re-initialize the deepspeed engine, since
...
rank1:
  ...
  <span class="hljs-keyword">out</span>=negative`}}),up=new y({}),{c(){g=o("meta"),S=u(),b=o("h1"),k=o("a"),X=o("span"),f(z.$$.fragment),C=u(),Q=o("span"),x=a("DeepSpeed Integration"),te=u(),T=o("p"),q=o("a"),E=a("DeepSpeed"),gs=a(" implements everything described in the "),W=o("a"),bs=a("ZeRO paper"),i6=a(". Currently it provides full support for:"),wj=u(),R=o("ol"),Gh=o("li"),u6=a("Optimizer state partitioning (ZeRO stage 1)"),c6=u(),Mh=o("li"),h6=a("Gradient partitioning (ZeRO stage 2)"),f6=u(),Lh=o("li"),d6=a("Parameter partitioning (ZeRO stage 3)"),m6=u(),Zh=o("li"),_6=a("Custom mixed precision training handling"),v6=u(),Nh=o("li"),j6=a("A range of fast CUDA-extension-based optimizers"),w6=u(),Hh=o("li"),y6=a("ZeRO-Offload to CPU and NVMe"),yj=u(),Te=o("p"),g6=a("ZeRO-Offload has its own dedicated paper: "),Kn=o("a"),b6=a("ZeRO-Offload: Democratizing Billion-Scale Model Training"),q6=a(". And NVMe-support is described in the paper "),Jn=o("a"),E6=a(`ZeRO-Infinity: Breaking the GPU
Memory Wall for Extreme Scale Deep Learning`),$6=a("."),gj=u(),kp=o("p"),k6=a("DeepSpeed ZeRO-2 is primarily used only for training, as its features are of no use to inference."),bj=u(),Pp=o("p"),P6=a(`DeepSpeed ZeRO-3 can be used for inference as well, since it allows huge models to be loaded on multiple GPUs, which
won\u2019t be possible on a single GPU.`),qj=u(),wt=o("p"),z6=a("\u{1F917} Transformers integrates "),Xn=o("a"),D6=a("DeepSpeed"),O6=a(" via 2 options:"),Ej=u(),yt=o("ol"),Qn=o("li"),A6=a("Integration of the core DeepSpeed features via "),zp=o("a"),T6=a("Trainer"),S6=a(`. This is an everything-done-for-you type
of integration - just supply your custom config file or use our template and you have nothing else to do. Most of
this document is focused on this feature.`),C6=u(),F=o("li"),x6=a("If you don\u2019t use "),Dp=o("a"),R6=a("Trainer"),I6=a(` and want to use your own Trainer where you integrated DeepSpeed
yourself, core functionality functions like `),Bh=o("code"),U6=a("from_pretrained"),G6=a(" and "),Wh=o("code"),M6=a("from_config"),L6=a(` include integration of essential
parts of DeepSpeed like `),Fh=o("code"),Z6=a("zero.Init"),N6=a(` for ZeRO stage 3 and higher. To tap into this feature read the docs on
`),Op=o("a"),H6=a("non-Trainer DeepSpeed Integration"),B6=a("."),$j=u(),Ap=o("p"),W6=a("What is integrated:"),kj=u(),Tp=o("p"),F6=a("Training:"),Pj=u(),Sp=o("ol"),Vh=o("li"),V6=a("DeepSpeed ZeRO training supports the full ZeRO stages 1, 2 and 3 with ZeRO-Infinity (CPU and NVME offload)."),zj=u(),Cp=o("p"),Y6=a("Inference:"),Dj=u(),xp=o("ol"),eo=o("li"),K6=a(`DeepSpeed ZeRO Inference supports ZeRO stage 3 with ZeRO-Infinity. It uses the same ZeRO protocol as training, but
it doesn\u2019t use an optimizer and a lr scheduler and only stage 3 is relevant. For more details see:
`),Rp=o("a"),J6=a("zero-inference"),X6=a("."),Oj=u(),Ip=o("p"),Q6=a(`There is also DeepSpeed Inference - this is a totally different technology which uses Tensor Parallelism instead of
ZeRO (coming soon).`),Aj=u(),Up=o("a"),Tj=u(),qs=o("h2"),gt=o("a"),Yh=o("span"),f(so.$$.fragment),e$=u(),Kh=o("span"),s$=a("Trainer Deepspeed Integration"),Sj=u(),Gp=o("a"),Cj=u(),Es=o("h3"),bt=o("a"),Jh=o("span"),f(to.$$.fragment),t$=u(),Xh=o("span"),a$=a("Installation"),xj=u(),Mp=o("p"),n$=a("Install the library via pypi:"),Rj=u(),f(ao.$$.fragment),Ij=u(),Se=o("p"),o$=a("or via "),Qh=o("code"),l$=a("transformers"),r$=a("\u2019 "),ef=o("code"),p$=a("extras"),i$=a(":"),Uj=u(),f(no.$$.fragment),Gj=u(),Ce=o("p"),u$=a("or find more details on "),oo=o("a"),c$=a("the DeepSpeed\u2019s GitHub page"),h$=a(` and
`),lo=o("a"),f$=a("advanced install"),d$=a("."),Mj=u(),qt=o("p"),m$=a("If you\u2019re still struggling with the build, first make sure to read "),Lp=o("a"),_$=a("CUDA Extension Installation Notes"),v$=a("."),Lj=u(),Zp=o("p"),j$=a(`If you don\u2019t prebuild the extensions and rely on them to be built at run time and you tried all of the above solutions
to no avail, the next thing to try is to pre-build the modules before installing them.`),Zj=u(),Np=o("p"),w$=a("To make a local build for DeepSpeed:"),Nj=u(),f(ro.$$.fragment),Hj=u(),xe=o("p"),y$=a("If you intend to use NVMe offload you will also need to include "),sf=o("code"),g$=a("DS_BUILD_AIO=1"),b$=a(` in the instructions above (and also
install `),tf=o("em"),q$=a("libaio-dev"),E$=a(" system-wide)."),Bj=u(),Et=o("p"),$$=a("Edit "),af=o("code"),k$=a("TORCH_CUDA_ARCH_LIST"),P$=a(` to insert the code for the architectures of the GPU cards you intend to use. Assuming all
your cards are the same you can get the arch via:`),Wj=u(),f(po.$$.fragment),Fj=u(),ke=o("p"),z$=a("So if you get "),nf=o("code"),D$=a("8, 6"),O$=a(", then use "),of=o("code"),A$=a('TORCH_CUDA_ARCH_LIST="8.6"'),T$=a(`. If you have multiple different cards, you can list all
of them like so `),lf=o("code"),S$=a('TORCH_CUDA_ARCH_LIST="6.1;8.6"'),Vj=u(),Hp=o("p"),C$=a("If you need to use the same setup on multiple machines, make a binary wheel:"),Yj=u(),f(io.$$.fragment),Kj=u(),Re=o("p"),x$=a("it will generate something like "),rf=o("code"),R$=a("dist/deepspeed-0.3.13+8cd046f-cp38-cp38-linux_x86_64.whl"),I$=a(` which now you can install
as `),pf=o("code"),U$=a("pip install deepspeed-0.3.13+8cd046f-cp38-cp38-linux_x86_64.whl"),G$=a(" locally or on any other machine."),Jj=u(),$t=o("p"),M$=a("Again, remember to ensure to adjust "),uf=o("code"),L$=a("TORCH_CUDA_ARCH_LIST"),Z$=a(" to the target architectures."),Xj=u(),Ie=o("p"),N$=a("You can find the complete list of NVIDIA GPUs and their corresponding "),cf=o("strong"),H$=a("Compute Capabilities"),B$=a(` (same as arch in this
context) `),uo=o("a"),W$=a("here"),F$=a("."),Qj=u(),Bp=o("p"),V$=a("You can check the archs pytorch was built with using:"),ew=u(),f(co.$$.fragment),sw=u(),Wp=o("p"),Y$=a("Here is how to find out the arch for one of the installed GPUs. For example, for GPU 0:"),tw=u(),f(ho.$$.fragment),aw=u(),Fp=o("p"),K$=a("If the output is:"),nw=u(),f(fo.$$.fragment),ow=u(),kt=o("p"),J$=a("then you know that this card\u2019s arch is "),hf=o("code"),X$=a("8.6"),Q$=a("."),lw=u(),Pt=o("p"),e5=a("You can also leave "),ff=o("code"),s5=a("TORCH_CUDA_ARCH_LIST"),t5=a(` out completely and then the build program will automatically query the
architecture of the GPUs the build is made on. This may or may not match the GPUs on the target machines, that\u2019s why
it\u2019s best to specify the desired archs explicitly.`),rw=u(),zt=o("p"),a5=a(`If after trying everything suggested you still encounter build issues, please, proceed with the GitHub Issue of
`),mo=o("a"),n5=a("Deepspeed"),o5=a(","),pw=u(),Vp=o("a"),iw=u(),$s=o("h3"),Dt=o("a"),df=o("span"),f(_o.$$.fragment),l5=u(),mf=o("span"),r5=a("Deployment with multiple GPUs"),uw=u(),Ot=o("p"),p5=a("To deploy this feature with multiple GPUs adjust the "),Yp=o("a"),i5=a("Trainer"),u5=a(` command line arguments as
following:`),cw=u(),At=o("ol"),ks=o("li"),c5=a("replace "),_f=o("code"),h5=a("python -m torch.distributed.launch"),f5=a(" with "),vf=o("code"),d5=a("deepspeed"),m5=a("."),_5=u(),Pe=o("li"),v5=a("add a new argument "),jf=o("code"),j5=a("--deepspeed ds_config.json"),w5=a(", where "),wf=o("code"),y5=a("ds_config.json"),g5=a(` is the DeepSpeed configuration file as
documented `),vo=o("a"),b5=a("here"),q5=a(". The file naming is up to you."),hw=u(),Kp=o("p"),E5=a("Therefore, if your original command line looked as follows:"),fw=u(),f(jo.$$.fragment),dw=u(),Jp=o("p"),$5=a("Now it should be:"),mw=u(),f(wo.$$.fragment),_w=u(),I=o("p"),k5=a("Unlike, "),yf=o("code"),P5=a("torch.distributed.launch"),z5=a(" where you have to specify how many GPUs to use with "),gf=o("code"),D5=a("--nproc_per_node"),O5=a(`, with the
`),bf=o("code"),A5=a("deepspeed"),T5=a(" launcher you don\u2019t have to use the corresponding "),qf=o("code"),S5=a("--num_gpus"),C5=a(` if you want all of your GPUs used. The
full details on how to configure various nodes and GPUs can be found `),yo=o("a"),x5=a("here"),R5=a("."),vw=u(),ae=o("p"),I5=a("In fact, you can continue using "),Ef=o("code"),U5=a("-m torch.distributed.launch"),G5=a(` with DeepSpeed as long as you don\u2019t need to use
`),$f=o("code"),M5=a("deepspeed"),L5=a(` launcher-specific arguments. Typically if you don\u2019t need a multi-node setup you\u2019re not required to use
the `),kf=o("code"),Z5=a("deepspeed"),N5=a(` launcher. But since in the DeepSpeed documentation it\u2019ll be used everywhere, for consistency we will
use it here as well.`),jw=u(),Tt=o("p"),H5=a("Here is an example of running "),Pf=o("code"),B5=a("run_translation.py"),W5=a(" under DeepSpeed deploying all available GPUs:"),ww=u(),f(go.$$.fragment),yw=u(),St=o("p"),F5=a("Note that in the DeepSpeed documentation you are likely to see "),zf=o("code"),V5=a("--deepspeed --deepspeed_config ds_config.json"),Y5=a(` - i.e.
two DeepSpeed-related arguments, but for the sake of simplicity, and since there are already so many arguments to deal
with, we combined the two into a single argument.`),gw=u(),Ct=o("p"),K5=a("For some practical usage examples, please, see this "),bo=o("a"),J5=a("post"),X5=a("."),bw=u(),Xp=o("a"),qw=u(),Ps=o("h3"),xt=o("a"),Df=o("span"),f(qo.$$.fragment),Q5=u(),Of=o("span"),e4=a("Deployment with one GPU"),Ew=u(),Rt=o("p"),s4=a("To deploy DeepSpeed with one GPU adjust the "),Qp=o("a"),t4=a("Trainer"),a4=a(" command line arguments as follows:"),$w=u(),f(Eo.$$.fragment),kw=u(),Ue=o("p"),n4=a(`This is almost the same as with multiple-GPUs, but here we tell DeepSpeed explicitly to use just one GPU via
`),Af=o("code"),o4=a("--num_gpus=1"),l4=a(`. By default, DeepSpeed deploys all GPUs it can see on the given node. If you have only 1 GPU to start
with, then you don\u2019t need this argument. The following `),$o=o("a"),r4=a("documentation"),p4=a(" discusses the launcher options."),Pw=u(),ei=o("p"),i4=a("Why would you want to use DeepSpeed with just one GPU?"),zw=u(),It=o("ol"),Tf=o("li"),u4=a(`It has a ZeRO-offload feature which can delegate some computations and memory to the host\u2019s CPU and RAM, and thus
leave more GPU resources for model\u2019s needs - e.g. larger batch size, or enabling a fitting of a very big model which
normally won\u2019t fit.`),c4=u(),Sf=o("li"),h4=a(`It provides a smart GPU memory management system, that minimizes memory fragmentation, which again allows you to fit
bigger models and data batches.`),Dw=u(),si=o("p"),f4=a(`While we are going to discuss the configuration in details next, the key to getting a huge improvement on a single GPU
with DeepSpeed is to have at least the following configuration in the configuration file:`),Ow=u(),f(ko.$$.fragment),Aw=u(),ti=o("p"),d4=a(`which enables optimizer offload and some other important features. You may experiment with the buffer sizes, you will
find more details in the discussion below.`),Tw=u(),Ut=o("p"),m4=a("For a practical usage example of this type of deployment, please, see this "),Po=o("a"),_4=a("post"),v4=a("."),Sw=u(),ai=o("p"),j4=a("You may also try the ZeRO-3 with CPU and NVMe offload as explained further in this document."),Cw=u(),ni=o("p"),w4=a("Notes:"),xw=u(),oi=o("ul"),zs=o("li"),zo=o("p"),y4=a("if you need to run on a specific GPU, which is different from GPU 0, you can\u2019t use "),Cf=o("code"),g4=a("CUDA_VISIBLE_DEVICES"),b4=a(` to limit
the visible scope of available GPUs. Instead, you have to use the following syntax:`),q4=u(),f(Do.$$.fragment),E4=u(),xf=o("p"),$4=a("In this example, we tell DeepSpeed to use GPU 1 (second gpu)."),Rw=u(),li=o("a"),Iw=u(),Ds=o("h3"),Gt=o("a"),Rf=o("span"),f(Oo.$$.fragment),k4=u(),If=o("span"),P4=a("Deployment in Notebooks"),Uw=u(),Mt=o("p"),z4=a("The problem with running notebook cells as a script is that there is no normal "),Uf=o("code"),D4=a("deepspeed"),O4=a(` launcher to rely on, so
under certain setups we have to emulate it.`),Gw=u(),ri=o("p"),A4=a("If you\u2019re using only 1 GPU, here is how you\u2019d have to adjust your training code in the notebook to use DeepSpeed."),Mw=u(),f(Ao.$$.fragment),Lw=u(),Lt=o("p"),T4=a("Note: "),Gf=o("code"),S4=a("..."),C4=a(" stands for the normal arguments that you\u2019d pass to the functions."),Zw=u(),pi=o("p"),x4=a(`If you want to use more than 1 GPU, you must use a multi-process environment for DeepSpeed to work. That is, you have
to use the launcher for that purpose and this cannot be accomplished by emulating the distributed environment presented
at the beginning of this section.`),Nw=u(),ii=o("p"),R4=a(`If you want to create the config file on the fly in the notebook in the current directory, you could have a dedicated
cell with:`),Hw=u(),f(To.$$.fragment),Bw=u(),Ge=o("p"),I4=a("If the training script is in a normal file and not in the notebook cells, you can launch "),Mf=o("code"),U4=a("deepspeed"),G4=a(` normally via
shell from a cell. For example, to use `),Lf=o("code"),M4=a("run_translation.py"),L4=a(" you would launch it with:"),Ww=u(),f(So.$$.fragment),Fw=u(),Zt=o("p"),Z4=a("or with "),Zf=o("code"),N4=a("%%bash"),H4=a(" magic, where you can write a multi-line code for the shell program to run:"),Vw=u(),f(Co.$$.fragment),Yw=u(),ui=o("p"),B4=a("In such case you don\u2019t need any of the code presented at the beginning of this section."),Kw=u(),Nt=o("p"),W4=a("Note: While "),Nf=o("code"),F4=a("%%bash"),V4=a(` magic is neat, but currently it buffers the output so you won\u2019t see the logs until the process
completes.`),Jw=u(),ci=o("a"),Xw=u(),Os=o("h3"),Ht=o("a"),Hf=o("span"),f(xo.$$.fragment),Y4=u(),Bf=o("span"),K4=a("Configuration"),Qw=u(),Bt=o("p"),J4=a(`For the complete guide to the DeepSpeed configuration options that can be used in its configuration file please refer
to the `),Ro=o("a"),X4=a("following documentation"),Q4=a("."),ey=u(),Wt=o("p"),e8=a("You can find dozens of DeepSpeed configuration examples that address various practical needs in "),Io=o("a"),s8=a(`the DeepSpeedExamples
...
have any problems or questions with regards to DeepSpeed usage, please, file an issue with `),jp=o("a"),fU=a("DeepSpeed GitHub"),dU=a("."),this.h()},l(e){const p=DY('[data-svelte="svelte-1phssyn"]',document.head);g=l(p,"META",{name:!0,content:!0}),p.forEach(t),S=c(e),b=l(e,"H1",{class:!0});var wp=r(b);k=l(wp,"A",{id:!0,class:!0,href:!0});var dj=r(k);X=l(dj,"SPAN",{});var mj=r(X);d(z.$$.fragment,mj),mj.forEach(t),dj.forEach(t),C=c(wp),Q=l(wp,"SPAN",{});var gU=r(Q);x=n(gU,"DeepSpeed Integration"),gU.forEach(t),wp.forEach(t),te=c(e),T=l(e,"P",{});var _j=r(T);q=l(_j,"A",{href:!0,rel:!0});var bU=r(q);E=n(bU,"DeepSpeed"),bU.forEach(t),gs=n(_j," implements everything described in the "),W=l(_j,"A",{href:!0,rel:!0});var qU=r(W);bs=n(qU,"ZeRO paper"),qU.forEach(t),i6=n(_j,". Currently it provides full support for:"),_j.forEach(t),wj=c(e),R=l(e,"OL",{});var ve=r(R);Gh=l(ve,"LI",{});var EU=r(Gh);u6=n(EU,"Optimizer state partitioning (ZeRO stage 1)"),EU.forEach(t),c6=c(ve),Mh=l(ve,"LI",{});var $U=r(Mh);h6=n($U,"Gradient partitioning (ZeRO stage 2)"),$U.forEach(t),f6=c(ve),Lh=l(ve,"LI",{});var kU=r(Lh);d6=n(kU,"Parameter partitioning (ZeRO stage 3)"),kU.forEach(t),m6=c(ve),Zh=l(ve,"LI",{});var PU=r(Zh);_6=n(PU,"Custom mixed precision training handling"),PU.forEach(t),v6=c(ve),Nh=l(ve,"LI",{});var zU=r(Nh);j6=n(zU,"A range of fast CUDA-extension-based optimizers"),zU.forEach(t),w6=c(ve),Hh=l(ve,"LI",{});var DU=r(Hh);y6=n(DU,"ZeRO-Offload to CPU and NVMe"),DU.forEach(t),ve.forEach(t),yj=c(e),Te=l(e,"P",{});var Vc=r(Te);g6=n(Vc,"ZeRO-Offload has its own dedicated paper: "),Kn=l(Vc,"A",{href:!0,rel:!0});var OU=r(Kn);b6=n(OU,"ZeRO-Offload: Democratizing Billion-Scale Model Training"),OU.forEach(t),q6=n(Vc,". And NVMe-support is described in the paper "),Jn=l(Vc,"A",{href:!0,rel:!0});var AU=r(Jn);E6=n(AU,`ZeRO-Infinity: Breaking the GPU
Memory Wall for Extreme Scale Deep Learning`),AU.forEach(t),$6=n(Vc,"."),Vc.forEach(t),gj=c(e),kp=l(e,"P",{});var TU=r(kp);k6=n(TU,"DeepSpeed ZeRO-2 is primarily used only for training, as its features are of no use to inference."),TU.forEach(t),bj=c(e),Pp=l(e,"P",{});var SU=r(Pp);P6=n(SU,`DeepSpeed ZeRO-3 can be used for inference as well, since it allows huge models to be loaded on multiple GPUs, which
won\u2019t be possible on a single GPU.`),SU.forEach(t),qj=c(e),wt=l(e,"P",{});var A0=r(wt);z6=n(A0,"\u{1F917} Transformers integrates "),Xn=l(A0,"A",{href:!0,rel:!0});var CU=r(Xn);D6=n(CU,"DeepSpeed"),CU.forEach(t),O6=n(A0," via 2 options:"),A0.forEach(t),Ej=c(e),yt=l(e,"OL",{});var T0=r(yt);Qn=l(T0,"LI",{});var S0=r(Qn);A6=n(S0,"Integration of the core DeepSpeed features via "),zp=l(S0,"A",{href:!0});var xU=r(zp);T6=n(xU,"Trainer"),xU.forEach(t),S6=n(S0,`. This is an everything-done-for-you type
of integration - just supply your custom config file or use our template and you have nothing else to do. Most of
this document is focused on this feature.`),S0.forEach(t),C6=c(T0),F=l(T0,"LI",{});var je=r(F);x6=n(je,"If you don\u2019t use "),Dp=l(je,"A",{href:!0});var RU=r(Dp);R6=n(RU,"Trainer"),RU.forEach(t),I6=n(je,` and want to use your own Trainer where you integrated DeepSpeed
yourself, core functionality functions like `),Bh=l(je,"CODE",{});var IU=r(Bh);U6=n(IU,"from_pretrained"),IU.forEach(t),G6=n(je," and "),Wh=l(je,"CODE",{});var UU=r(Wh);M6=n(UU,"from_config"),UU.forEach(t),L6=n(je,` include integration of essential
parts of DeepSpeed like `),Fh=l(je,"CODE",{});var GU=r(Fh);Z6=n(GU,"zero.Init"),GU.forEach(t),N6=n(je,` for ZeRO stage 3 and higher. To tap into this feature read the docs on
`),Op=l(je,"A",{href:!0});var MU=r(Op);H6=n(MU,"non-Trainer DeepSpeed Integration"),MU.forEach(t),B6=n(je,"."),je.forEach(t),T0.forEach(t),$j=c(e),Ap=l(e,"P",{});var LU=r(Ap);W6=n(LU,"What is integrated:"),LU.forEach(t),kj=c(e),Tp=l(e,"P",{});var ZU=r(Tp);F6=n(ZU,"Training:"),ZU.forEach(t),Pj=c(e),Sp=l(e,"OL",{});var NU=r(Sp);Vh=l(NU,"LI",{});var HU=r(Vh);V6=n(HU,"DeepSpeed ZeRO training supports the full ZeRO stages 1, 2 and 3 with ZeRO-Infinity (CPU and NVME offload)."),HU.forEach(t),NU.forEach(t),zj=c(e),Cp=l(e,"P",{});var BU=r(Cp);Y6=n(BU,"Inference:"),BU.forEach(t),Dj=c(e),xp=l(e,"OL",{});var WU=r(xp);eo=l(WU,"LI",{});var C0=r(eo);K6=n(C0,`DeepSpeed ZeRO Inference supports ZeRO stage 3 with ZeRO-Infinity. It uses the same ZeRO protocol as training, but
it doesn\u2019t use an optimizer and a lr scheduler and only stage 3 is relevant. For more details see:
`),Rp=l(C0,"A",{href:!0});var FU=r(Rp);J6=n(FU,"zero-inference"),FU.forEach(t),X6=n(C0,"."),C0.forEach(t),WU.forEach(t),Oj=c(e),Ip=l(e,"P",{});var VU=r(Ip);Q6=n(VU,`There is also DeepSpeed Inference - this is a totally different technology which uses Tensor Parallelism instead of
ZeRO (coming soon).`),VU.forEach(t),Aj=c(e),Up=l(e,"A",{id:!0}),r(Up).forEach(t),Tj=c(e),qs=l(e,"H2",{class:!0});var x0=r(qs);gt=l(x0,"A",{id:!0,class:!0,href:!0});var YU=r(gt);Yh=l(YU,"SPAN",{});var KU=r(Yh);d(so.$$.fragment,KU),KU.forEach(t),YU.forEach(t),e$=c(x0),Kh=l(x0,"SPAN",{});var JU=r(Kh);s$=n(JU,"Trainer Deepspeed Integration"),JU.forEach(t),x0.forEach(t),Sj=c(e),Gp=l(e,"A",{id:!0}),r(Gp).forEach(t),Cj=c(e),Es=l(e,"H3",{class:!0});var R0=r(Es);bt=l(R0,"A",{id:!0,class:!0,href:!0});var XU=r(bt);Jh=l(XU,"SPAN",{});var QU=r(Jh);d(to.$$.fragment,QU),QU.forEach(t),XU.forEach(t),t$=c(R0),Xh=l(R0,"SPAN",{});var eG=r(Xh);a$=n(eG,"Installation"),eG.forEach(t),R0.forEach(t),xj=c(e),Mp=l(e,"P",{});var sG=r(Mp);n$=n(sG,"Install the library via pypi:"),sG.forEach(t),Rj=c(e),d(ao.$$.fragment,e),Ij=c(e),Se=l(e,"P",{});var Yc=r(Se);o$=n(Yc,"or via "),Qh=l(Yc,"CODE",{});var tG=r(Qh);l$=n(tG,"transformers"),tG.forEach(t),r$=n(Yc,"\u2019 "),ef=l(Yc,"CODE",{});var aG=r(ef);p$=n(aG,"extras"),aG.forEach(t),i$=n(Yc,":"),Yc.forEach(t),Uj=c(e),d(no.$$.fragment,e),Gj=c(e),Ce=l(e,"P",{});var Kc=r(Ce);u$=n(Kc,"or find more details on "),oo=l(Kc,"A",{href:!0,rel:!0});var nG=r(oo);c$=n(nG,"the DeepSpeed\u2019s GitHub page"),nG.forEach(t),h$=n(Kc,` and
`),lo=l(Kc,"A",{href:!0,rel:!0});var oG=r(lo);f$=n(oG,"advanced install"),oG.forEach(t),d$=n(Kc,"."),Kc.forEach(t),Mj=c(e),qt=l(e,"P",{});var I0=r(qt);m$=n(I0,"If you\u2019re still struggling with the build, first make sure to read "),Lp=l(I0,"A",{href:!0});var lG=r(Lp);_$=n(lG,"CUDA Extension Installation Notes"),lG.forEach(t),v$=n(I0,"."),I0.forEach(t),Lj=c(e),Zp=l(e,"P",{});var rG=r(Zp);j$=n(rG,`If you don\u2019t prebuild the extensions and rely on them to be built at run time and you tried all of the above solutions
to no avail, the next thing to try is to pre-build the modules before installing them.`),rG.forEach(t),Zj=c(e),Np=l(e,"P",{});var pG=r(Np);w$=n(pG,"To make a local build for DeepSpeed:"),pG.forEach(t),Nj=c(e),d(ro.$$.fragment,e),Hj=c(e),xe=l(e,"P",{});var Jc=r(xe);y$=n(Jc,"If you intend to use NVMe offload you will also need to include "),sf=l(Jc,"CODE",{});var iG=r(sf);g$=n(iG,"DS_BUILD_AIO=1"),iG.forEach(t),b$=n(Jc,` in the instructions above (and also
install `),tf=l(Jc,"EM",{});var uG=r(tf);q$=n(uG,"libaio-dev"),uG.forEach(t),E$=n(Jc," system-wide)."),Jc.forEach(t),Bj=c(e),Et=l(e,"P",{});var U0=r(Et);$$=n(U0,"Edit "),af=l(U0,"CODE",{});var cG=r(af);k$=n(cG,"TORCH_CUDA_ARCH_LIST"),cG.forEach(t),P$=n(U0,` to insert the code for the architectures of the GPU cards you intend to use. Assuming all
your cards are the same you can get the arch via:`),U0.forEach(t),Wj=c(e),d(po.$$.fragment,e),Fj=c(e),ke=l(e,"P",{});var yp=r(ke);z$=n(yp,"So if you get "),nf=l(yp,"CODE",{});var hG=r(nf);D$=n(hG,"8, 6"),hG.forEach(t),O$=n(yp,", then use "),of=l(yp,"CODE",{});var fG=r(of);A$=n(fG,'TORCH_CUDA_ARCH_LIST="8.6"'),fG.forEach(t),T$=n(yp,`. If you have multiple different cards, you can list all
of them like so `),lf=l(yp,"CODE",{});var dG=r(lf);S$=n(dG,'TORCH_CUDA_ARCH_LIST="6.1;8.6"'),dG.forEach(t),yp.forEach(t),Vj=c(e),Hp=l(e,"P",{});var mG=r(Hp);C$=n(mG,"If you need to use the same setup on multiple machines, make a binary wheel:"),mG.forEach(t),Yj=c(e),d(io.$$.fragment,e),Kj=c(e),Re=l(e,"P",{});var Xc=r(Re);x$=n(Xc,"it will generate something like "),rf=l(Xc,"CODE",{});var _G=r(rf);R$=n(_G,"dist/deepspeed-0.3.13+8cd046f-cp38-cp38-linux_x86_64.whl"),_G.forEach(t),I$=n(Xc,` which now you can install
as `),pf=l(Xc,"CODE",{});var vG=r(pf);U$=n(vG,"pip install deepspeed-0.3.13+8cd046f-cp38-cp38-linux_x86_64.whl"),vG.forEach(t),G$=n(Xc," locally or on any other machine."),Xc.forEach(t),Jj=c(e),$t=l(e,"P",{});var G0=r($t);M$=n(G0,"Again, remember to ensure to adjust "),uf=l(G0,"CODE",{});var jG=r(uf);L$=n(jG,"TORCH_CUDA_ARCH_LIST"),jG.forEach(t),Z$=n(G0," to the target architectures."),G0.forEach(t),Xj=c(e),Ie=l(e,"P",{});var Qc=r(Ie);N$=n(Qc,"You can find the complete list of NVIDIA GPUs and their corresponding "),cf=l(Qc,"STRONG",{});var wG=r(cf);H$=n(wG,"Compute Capabilities"),wG.forEach(t),B$=n(Qc,` (same as arch in this
context) `),uo=l(Qc,"A",{href:!0,rel:!0});var yG=r(uo);W$=n(yG,"here"),yG.forEach(t),F$=n(Qc,"."),Qc.forEach(t),Qj=c(e),Bp=l(e,"P",{});var gG=r(Bp);V$=n(gG,"You can check the archs pytorch was built with using:"),gG.forEach(t),ew=c(e),d(co.$$.fragment,e),sw=c(e),Wp=l(e,"P",{});var bG=r(Wp);Y$=n(bG,"Here is how to find out the arch for one of the installed GPUs. For example, for GPU 0:"),bG.forEach(t),tw=c(e),d(ho.$$.fragment,e),aw=c(e),Fp=l(e,"P",{});var qG=r(Fp);K$=n(qG,"If the output is:"),qG.forEach(t),nw=c(e),d(fo.$$.fragment,e),ow=c(e),kt=l(e,"P",{});var M0=r(kt);J$=n(M0,"then you know that this card\u2019s arch is "),hf=l(M0,"CODE",{});var EG=r(hf);X$=n(EG,"8.6"),EG.forEach(t),Q$=n(M0,"."),M0.forEach(t),lw=c(e),Pt=l(e,"P",{});var L0=r(Pt);e5=n(L0,"You can also leave "),ff=l(L0,"CODE",{});var $G=r(ff);s5=n($G,"TORCH_CUDA_ARCH_LIST"),$G.forEach(t),t5=n(L0,` out completely and then the build program will automatically query the
architecture of the GPUs the build is made on. This may or may not match the GPUs on the target machines, that\u2019s why
it\u2019s best to specify the desired archs explicitly.`),L0.forEach(t),rw=c(e),zt=l(e,"P",{});var Z0=r(zt);a5=n(Z0,`If after trying everything suggested you still encounter build issues, please, proceed with the GitHub Issue of
`),mo=l(Z0,"A",{href:!0,rel:!0});var kG=r(mo);n5=n(kG,"Deepspeed"),kG.forEach(t),o5=n(Z0,","),Z0.forEach(t),pw=c(e),Vp=l(e,"A",{id:!0}),r(Vp).forEach(t),iw=c(e),$s=l(e,"H3",{class:!0});var N0=r($s);Dt=l(N0,"A",{id:!0,class:!0,href:!0});var PG=r(Dt);df=l(PG,"SPAN",{});var zG=r(df);d(_o.$$.fragment,zG),zG.forEach(t),PG.forEach(t),l5=c(N0),mf=l(N0,"SPAN",{});var DG=r(mf);r5=n(DG,"Deployment with multiple GPUs"),DG.forEach(t),N0.forEach(t),uw=c(e),Ot=l(e,"P",{});var H0=r(Ot);p5=n(H0,"To deploy this feature with multiple GPUs adjust the "),Yp=l(H0,"A",{href:!0});var OG=r(Yp);i5=n(OG,"Trainer"),OG.forEach(t),u5=n(H0,` command line arguments as
following:`),H0.forEach(t),cw=c(e),At=l(e,"OL",{});var B0=r(At);ks=l(B0,"LI",{});var eh=r(ks);c5=n(eh,"replace "),_f=l(eh,"CODE",{});var AG=r(_f);h5=n(AG,"python -m torch.distributed.launch"),AG.forEach(t),f5=n(eh," with "),vf=l(eh,"CODE",{});var TG=r(vf);d5=n(TG,"deepspeed"),TG.forEach(t),m5=n(eh,"."),eh.forEach(t),_5=c(B0),Pe=l(B0,"LI",{});var Sn=r(Pe);v5=n(Sn,"add a new argument "),jf=l(Sn,"CODE",{});var SG=r(jf);j5=n(SG,"--deepspeed ds_config.json"),SG.forEach(t),w5=n(Sn,", where "),wf=l(Sn,"CODE",{});var CG=r(wf);y5=n(CG,"ds_config.json"),CG.forEach(t),g5=n(Sn,` is the DeepSpeed configuration file as
documented `),vo=l(Sn,"A",{href:!0,rel:!0});var xG=r(vo);b5=n(xG,"here"),xG.forEach(t),q5=n(Sn,". The file naming is up to you."),Sn.forEach(t),B0.forEach(t),hw=c(e),Kp=l(e,"P",{});var RG=r(Kp);E5=n(RG,"Therefore, if your original command line looked as follows:"),RG.forEach(t),fw=c(e),d(jo.$$.fragment,e),dw=c(e),Jp=l(e,"P",{});var IG=r(Jp);$5=n(IG,"Now it should be:"),IG.forEach(t),mw=c(e),d(wo.$$.fragment,e),_w=c(e),I=l(e,"P",{});var we=r(I);k5=n(we,"Unlike, "),yf=l(we,"CODE",{});var UG=r(yf);P5=n(UG,"torch.distributed.launch"),UG.forEach(t),z5=n(we," where you have to specify how many GPUs to use with "),gf=l(we,"CODE",{});var GG=r(gf);D5=n(GG,"--nproc_per_node"),GG.forEach(t),O5=n(we,`, with the
`),bf=l(we,"CODE",{});var MG=r(bf);A5=n(MG,"deepspeed"),MG.forEach(t),T5=n(we," launcher you don\u2019t have to use the corresponding "),qf=l(we,"CODE",{});var LG=r(qf);S5=n(LG,"--num_gpus"),LG.forEach(t),C5=n(we,` if you want all of your GPUs used. The
full details on how to configure various nodes and GPUs can be found `),yo=l(we,"A",{href:!0,rel:!0});var ZG=r(yo);x5=n(ZG,"here"),ZG.forEach(t),R5=n(we,"."),we.forEach(t),vw=c(e),ae=l(e,"P",{});var Cn=r(ae);I5=n(Cn,"In fact, you can continue using "),Ef=l(Cn,"CODE",{});var NG=r(Ef);U5=n(NG,"-m torch.distributed.launch"),NG.forEach(t),G5=n(Cn,` with DeepSpeed as long as you don\u2019t need to use
`),$f=l(Cn,"CODE",{});var HG=r($f);M5=n(HG,"deepspeed"),HG.forEach(t),L5=n(Cn,` launcher-specific arguments. Typically if you don\u2019t need a multi-node setup you\u2019re not required to use
the `),kf=l(Cn,"CODE",{});var BG=r(kf);Z5=n(BG,"deepspeed"),BG.forEach(t),N5=n(Cn,` launcher. But since in the DeepSpeed documentation it\u2019ll be used everywhere, for consistency we will
use it here as well.`),Cn.forEach(t),jw=c(e),Tt=l(e,"P",{});var W0=r(Tt);H5=n(W0,"Here is an example of running "),Pf=l(W0,"CODE",{});var WG=r(Pf);B5=n(WG,"run_translation.py"),WG.forEach(t),W5=n(W0," under DeepSpeed deploying all available GPUs:"),W0.forEach(t),ww=c(e),d(go.$$.fragment,e),yw=c(e),St=l(e,"P",{});var F0=r(St);F5=n(F0,"Note that in the DeepSpeed documentation you are likely to see "),zf=l(F0,"CODE",{});var FG=r(zf);V5=n(FG,"--deepspeed --deepspeed_config ds_config.json"),FG.forEach(t),Y5=n(F0,` - i.e.
two DeepSpeed-related arguments, but for the sake of simplicity, and since there are already so many arguments to deal
with, we combined the two into a single argument.`),F0.forEach(t),gw=c(e),Ct=l(e,"P",{});var V0=r(Ct);K5=n(V0,"For some practical usage examples, please, see this "),bo=l(V0,"A",{href:!0,rel:!0});var VG=r(bo);J5=n(VG,"post"),VG.forEach(t),X5=n(V0,"."),V0.forEach(t),bw=c(e),Xp=l(e,"A",{id:!0}),r(Xp).forEach(t),qw=c(e),Ps=l(e,"H3",{class:!0});var Y0=r(Ps);xt=l(Y0,"A",{id:!0,class:!0,href:!0});var YG=r(xt);Df=l(YG,"SPAN",{});var KG=r(Df);d(qo.$$.fragment,KG),KG.forEach(t),YG.forEach(t),Q5=c(Y0),Of=l(Y0,"SPAN",{});var JG=r(Of);e4=n(JG,"Deployment with one GPU"),JG.forEach(t),Y0.forEach(t),Ew=c(e),Rt=l(e,"P",{});var K0=r(Rt);s4=n(K0,"To deploy DeepSpeed with one GPU adjust the "),Qp=l(K0,"A",{href:!0});var XG=r(Qp);t4=n(XG,"Trainer"),XG.forEach(t),a4=n(K0," command line arguments as follows:"),K0.forEach(t),$w=c(e),d(Eo.$$.fragment,e),kw=c(e),Ue=l(e,"P",{});var sh=r(Ue);n4=n(sh,`This is almost the same as with multiple-GPUs, but here we tell DeepSpeed explicitly to use just one GPU via
`),Af=l(sh,"CODE",{});var QG=r(Af);o4=n(QG,"--num_gpus=1"),QG.forEach(t),l4=n(sh,`. By default, DeepSpeed deploys all GPUs it can see on the given node. If you have only 1 GPU to start
with, then you don\u2019t need this argument. The following `),$o=l(sh,"A",{href:!0,rel:!0});var eM=r($o);r4=n(eM,"documentation"),eM.forEach(t),p4=n(sh," discusses the launcher options."),sh.forEach(t),Pw=c(e),ei=l(e,"P",{});var sM=r(ei);i4=n(sM,"Why would you want to use DeepSpeed with just one GPU?"),sM.forEach(t),zw=c(e),It=l(e,"OL",{});var J0=r(It);Tf=l(J0,"LI",{});var tM=r(Tf);u4=n(tM,`It has a ZeRO-offload feature which can delegate some computations and memory to the host\u2019s CPU and RAM, and thus
leave more GPU resources for model\u2019s needs - e.g. larger batch size, or enabling a fitting of a very big model which
normally won\u2019t fit.`),tM.forEach(t),c4=c(J0),Sf=l(J0,"LI",{});var aM=r(Sf);h4=n(aM,`It provides a smart GPU memory management system, that minimizes memory fragmentation, which again allows you to fit
bigger models and data batches.`),aM.forEach(t),J0.forEach(t),Dw=c(e),si=l(e,"P",{});var nM=r(si);f4=n(nM,`While we are going to discuss the configuration in details next, the key to getting a huge improvement on a single GPU
with DeepSpeed is to have at least the following configuration in the configuration file:`),nM.forEach(t),Ow=c(e),d(ko.$$.fragment,e),Aw=c(e),ti=l(e,"P",{});var oM=r(ti);d4=n(oM,`which enables optimizer offload and some other important features. You may experiment with the buffer sizes, you will
find more details in the discussion below.`),oM.forEach(t),Tw=c(e),Ut=l(e,"P",{});var X0=r(Ut);m4=n(X0,"For a practical usage example of this type of deployment, please, see this "),Po=l(X0,"A",{href:!0,rel:!0});var lM=r(Po);_4=n(lM,"post"),lM.forEach(t),v4=n(X0,"."),X0.forEach(t),Sw=c(e),ai=l(e,"P",{});var rM=r(ai);j4=n(rM,"You may also try the ZeRO-3 with CPU and NVMe offload as explained further in this document."),rM.forEach(t),Cw=c(e),ni=l(e,"P",{});var pM=r(ni);w4=n(pM,"Notes:"),pM.forEach(t),xw=c(e),oi=l(e,"UL",{});var iM=r(oi);zs=l(iM,"LI",{});var th=r(zs);zo=l(th,"P",{});var Q0=r(zo);y4=n(Q0,"if you need to run on a specific GPU, which is different from GPU 0, you can\u2019t use "),Cf=l(Q0,"CODE",{});var uM=r(Cf);g4=n(uM,"CUDA_VISIBLE_DEVICES"),uM.forEach(t),b4=n(Q0,` to limit
the visible scope of available GPUs. Instead, you have to use the following syntax:`),Q0.forEach(t),q4=c(th),d(Do.$$.fragment,th),E4=c(th),xf=l(th,"P",{});var cM=r(xf);$4=n(cM,"In this example, we tell DeepSpeed to use GPU 1 (second gpu)."),cM.forEach(t),th.forEach(t),iM.forEach(t),Rw=c(e),li=l(e,"A",{id:!0}),r(li).forEach(t),Iw=c(e),Ds=l(e,"H3",{class:!0});var eq=r(Ds);Gt=l(eq,"A",{id:!0,class:!0,href:!0});var hM=r(Gt);Rf=l(hM,"SPAN",{});var fM=r(Rf);d(Oo.$$.fragment,fM),fM.forEach(t),hM.forEach(t),k4=c(eq),If=l(eq,"SPAN",{});var dM=r(If);P4=n(dM,"Deployment in Notebooks"),dM.forEach(t),eq.forEach(t),Uw=c(e),Mt=l(e,"P",{});var sq=r(Mt);z4=n(sq,"The problem with running notebook cells as a script is that there is no normal "),Uf=l(sq,"CODE",{});var mM=r(Uf);D4=n(mM,"deepspeed"),mM.forEach(t),O4=n(sq,` launcher to rely on, so
under certain setups we have to emulate it.`),sq.forEach(t),Gw=c(e),ri=l(e,"P",{});var _M=r(ri);A4=n(_M,"If you\u2019re using only 1 GPU, here is how you\u2019d have to adjust your training code in the notebook to use DeepSpeed."),_M.forEach(t),Mw=c(e),d(Ao.$$.fragment,e),Lw=c(e),Lt=l(e,"P",{});var tq=r(Lt);T4=n(tq,"Note: "),Gf=l(tq,"CODE",{});var vM=r(Gf);S4=n(vM,"..."),vM.forEach(t),C4=n(tq," stands for the normal arguments that you\u2019d pass to the functions."),tq.forEach(t),Zw=c(e),pi=l(e,"P",{});var jM=r(pi);x4=n(jM,`If you want to use more than 1 GPU, you must use a multi-process environment for DeepSpeed to work. That is, you have
to use the launcher for that purpose and this cannot be accomplished by emulating the distributed environment presented
at the beginning of this section.`),jM.forEach(t),Nw=c(e),ii=l(e,"P",{});var wM=r(ii);R4=n(wM,`If you want to create the config file on the fly in the notebook in the current directory, you could have a dedicated
cell with:`),wM.forEach(t),Hw=c(e),d(To.$$.fragment,e),Bw=c(e),Ge=l(e,"P",{});var ah=r(Ge);I4=n(ah,"If the training script is in a normal file and not in the notebook cells, you can launch "),Mf=l(ah,"CODE",{});var yM=r(Mf);U4=n(yM,"deepspeed"),yM.forEach(t),G4=n(ah,` normally via
shell from a cell. For example, to use `),Lf=l(ah,"CODE",{});var gM=r(Lf);M4=n(gM,"run_translation.py"),gM.forEach(t),L4=n(ah," you would launch it with:"),ah.forEach(t),Ww=c(e),d(So.$$.fragment,e),Fw=c(e),Zt=l(e,"P",{});var aq=r(Zt);Z4=n(aq,"or with "),Zf=l(aq,"CODE",{});var bM=r(Zf);N4=n(bM,"%%bash"),bM.forEach(t),H4=n(aq," magic, where you can write a multi-line code for the shell program to run:"),aq.forEach(t),Vw=c(e),d(Co.$$.fragment,e),Yw=c(e),ui=l(e,"P",{});var qM=r(ui);B4=n(qM,"In such case you don\u2019t need any of the code presented at the beginning of this section."),qM.forEach(t),Kw=c(e),Nt=l(e,"P",{});var nq=r(Nt);W4=n(nq,"Note: While "),Nf=l(nq,"CODE",{});var EM=r(Nf);F4=n(EM,"%%bash"),EM.forEach(t),V4=n(nq,` magic is neat, but currently it buffers the output so you won\u2019t see the logs until the process
completes.`),nq.forEach(t),Jw=c(e),ci=l(e,"A",{id:!0}),r(ci).forEach(t),Xw=c(e),Os=l(e,"H3",{class:!0});var oq=r(Os);Ht=l(oq,"A",{id:!0,class:!0,href:!0});var $M=r(Ht);Hf=l($M,"SPAN",{});var kM=r(Hf);d(xo.$$.fragment,kM),kM.forEach(t),$M.forEach(t),Y4=c(oq),Bf=l(oq,"SPAN",{});var PM=r(Bf);K4=n(PM,"Configuration"),PM.forEach(t),oq.forEach(t),Qw=c(e),Bt=l(e,"P",{});var lq=r(Bt);J4=n(lq,`For the complete guide to the DeepSpeed configuration options that can be used in its configuration file please refer
to the `),Ro=l(lq,"A",{href:!0,rel:!0});var zM=r(Ro);X4=n(zM,"following documentation"),zM.forEach(t),Q4=n(lq,"."),lq.forEach(t),ey=c(e),Wt=l(e,"P",{});var rq=r(Wt);e8=n(rq,"You can find dozens of DeepSpeed configuration examples that address various practical needs in "),Io=l(rq,"A",{href:!0,rel:!0});var DM=r(Io);s8=n(DM,`the DeepSpeedExamples
