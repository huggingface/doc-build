...
`),Rp=o("a"),J6=a("deepspeed-zero-inference"),X6=a("."),Oj=u(),Ip=o("p"),Q6=a(`There is also DeepSpeed Inference - this is a totally different technology which uses Tensor Parallelism instead of
...
`),lo=o("a"),f$=a("advanced install"),d$=a("."),Mj=u(),qt=o("p"),m$=a("If you\u2019re still struggling with the build, first make sure to read "),Lp=o("a"),_$=a("zero-install-notes"),v$=a("."),Lj=u(),Zp=o("p"),j$=a(`If you don\u2019t prebuild the extensions and rely on them to be built at run time and you tried all of the above solutions
...
it doesn\u2019t use an optimizer and a lr scheduler and only stage 3 is relevant. For more details see:
`),Rp=l(C0,"A",{href:!0});var FU=r(Rp);J6=n(FU,"deepspeed-zero-inference"),FU.forEach(t),X6=n(C0,"."),C0.forEach(t),WU.forEach(t),Oj=c(e),Ip=l(e,"P",{});var VU=r(Ip);Q6=n(VU,`There is also DeepSpeed Inference - this is a totally different technology which uses Tensor Parallelism instead of
