import{S as Cm,i as Im,s as Bm,e as s,k as l,w as m,t,M as Wm,c as a,d as o,m as d,a as r,x as g,h as n,b as c,F as e,g as M,y as u,q as _,o as h,B as f,v as Hm}from"../../chunks/vendor-6b77c823.js";import{T as Nm}from"../../chunks/Tip-39098574.js";import{D as ue}from"../../chunks/Docstring-1088f2fb.js";import{C as be}from"../../chunks/CodeBlock-3a8b25a8.js";import{I as Bs}from"../../chunks/IconCopyLink-7a11ce68.js";function Rm(en){let p,C,L,q,D,w,_e,N,O,I,G;return{c(){p=s("p"),C=t("Apart from "),L=s("code"),q=t("inputs"),D=t(`, all the arguments below will default to the value of the attribute of the same name as
...
should be prefixed with *decoder</em>*.`,name:"exponential_decay_length_penalty"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/generation_utils.py#L842",returnDescription:`
<p>A <a
...
If model is an encoder-decoder model the kwargs should include <code>encoder_outputs</code>.`,name:"synced_gpus"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/generation_utils.py#L1522",returnDescription:`
<p><a
  href="/docs/transformers/main/en/internal/generation_utils#transformers.generation_utils.GreedySearchDecoderOnlyOutput"
...
an encoder-decoder model the kwargs should include <code>encoder_outputs</code>.`,name:"synced_gpus"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/generation_utils.py#L1754",returnDescription:`
<p><a
  href="/docs/transformers/main/en/internal/generation_utils#transformers.generation_utils.SampleDecoderOnlyOutput"
...
model_kwargs &#x2014;
Additional model specific kwargs will be forwarded to the <code>forward</code> function of the model. If model is
an encoder-decoder model the kwargs should include <code>encoder_outputs</code>.`,name:"synced_gpus"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/generation_utils.py#L2010",returnDescription:`
...
model_kwargs &#x2014;
Additional model specific kwargs will be forwarded to the <code>forward</code> function of the model. If model is
an encoder-decoder model the kwargs should include <code>encoder_outputs</code>.`,name:"synced_gpus"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/generation_utils.py#L2322",returnDescription:`
<p><a
  href="/docs/transformers/main/en/internal/generation_utils#transformers.generation_utils.BeamSampleDecoderOnlyOutput"
...
model is an encoder-decoder model the kwargs should include <code>encoder_outputs</code>.`,name:"synced_gpus"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/generation_utils.py#L2644",returnDescription:`
<p><a
  href="/docs/transformers/main/en/internal/generation_utils#transformers.generation_utils.BeamSearchDecoderOnlyOutput"
...
model_kwargs &#x2014;
Additional model specific kwargs will be forwarded to the <code>forward</code> function of the model. If model is
an encoder-decoder model the kwargs should include <code>encoder_outputs</code>.`,name:"synced_gpus"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/generation_utils.py#L3009",returnDescription:`
<p><code>generation_utilsBeamSearchDecoderOnlyOutput</code>, <a
  href="/docs/transformers/main/en/internal/generation_utils#transformers.generation_utils.BeamSearchEncoderDecoderOutput"
>BeamSearchEncoderDecoderOutput</a> or
<code>torch.LongTensor</code>: A <code>torch.LongTensor</code> containing the generated tokens (default behaviour) or a
...
post`),ji=t("."),Li=l(),xo=s("p"),Mi=t("Examples:"),wi=l(),ko=s("p"),Ti=t("Greedy Decoding:"),Ei=l(),m(_t.$$.fragment),Oi=l(),vo=s("p"),qi=t("Multinomial Sampling:"),Gi=l(),m(ht.$$.fragment),Si=l(),yo=s("p"),$i=t("Beam-search decoding:"),Fi=l(),m(ft.$$.fragment),zi=l(),ee=s("div"),m(bt.$$.fragment),Ai=l(),xt=s("p"),Pi=t("Generates sequences of token ids for models with a language modeling head using "),jo=s("strong"),Di=t("greedy decoding"),Ni=t(` and can be
...
`),Rn=a(ze,"CODE",{});var Qc=r(Rn);Ka=n(Qc,"num_beams>1"),Qc.forEach(o),Za=n(ze," and "),Un=a(ze,"CODE",{});var Yc=r(Un);Xa=n(Yc,"do_sample=True"),Yc.forEach(o),Ja=n(ze,"."),ze.forEach(o),Qa=d(me),U=a(me,"LI",{});var Ae=r(U);Vn=a(Ae,"EM",{});var ep=r(Vn);Ya=n(ep,"diverse beam-search decoding"),ep.forEach(o),er=n(Ae," by calling "),un=a(Ae,"A",{href:!0});var tp=r(un);tr=n(tp,"group_beam_search()"),tp.forEach(o),nr=n(Ae,`, if
...
`),vn=a(We,"A",{href:!0});var qp=r(vn);gi=n(qp,"constrained_beam_search()"),qp.forEach(o),ui=n(We,", if "),fo=a(We,"CODE",{});var Gp=r(fo);_i=n(Gp,"constraints!=None"),Gp.forEach(o),hi=n(We,` or
`),bo=a(We,"CODE",{});var Sp=r(bo);fi=n(Sp,"force_words_ids!=None"),Sp.forEach(o),bi=n(We,"."),We.forEach(o),ge.forEach(o),xi=d(y),g(Je.$$.fragment,y),ki=d(y),gt=a(y,"P",{});var Ts=r(gt);vi=n(Ts,"Most of these parameters are explained in more detail in "),ut=a(Ts,"A",{href:!0,rel:!0});var $p=r(ut);yi=n($p,`this blog
post`),$p.forEach(o),ji=n(Ts,"."),Ts.forEach(o),Li=d(y),xo=a(y,"P",{});var Fp=r(xo);Mi=n(Fp,"Examples:"),Fp.forEach(o),wi=d(y),ko=a(y,"P",{});var zp=r(ko);Ti=n(zp,"Greedy Decoding:"),zp.forEach(o),Ei=d(y),g(_t.$$.fragment,y),Oi=d(y),vo=a(y,"P",{});var Ap=r(vo);qi=n(Ap,"Multinomial Sampling:"),Ap.forEach(o),Gi=d(y),g(ht.$$.fragment,y),Si=d(y),yo=a(y,"P",{});var Pp=r(yo);$i=n(Pp,"Beam-search decoding:"),Pp.forEach(o),Fi=d(y),g(ft.$$.fragment,y),y.forEach(o),zi=d(j),ee=a(j,"DIV",{class:!0});var tt=r(ee);g(bt.$$.fragment,tt),Ai=d(tt),xt=a(tt,"P",{});var Es=r(xt);Pi=n(Es,"Generates sequences of token ids for models with a language modeling head using "),jo=a(Es,"STRONG",{});var Dp=r(jo);Di=n(Dp,"greedy decoding"),Dp.forEach(o),Ni=n(Es,` and can be
...
`),Ln=a(Ns,"A",{href:!0});var cm=r(Ln);id=n(cm,"FlaxPreTrainedModel"),cm.forEach(o),ld=n(Ns,"."),Ns.forEach(o),dd=d(ve),Kt=a(ve,"P",{});var Cs=r(Kt);cd=n(Cs,"The class exposes "),Mn=a(Cs,"A",{href:!0});var pm=r(Mn);pd=n(pm,"generate()"),pm.forEach(o),md=n(Cs,", which can be used for:"),Cs.forEach(o),gd=d(ve),qe=a(ve,"UL",{});var Gn=r(qe);re=a(Gn,"LI",{});var He=r(re);Wo=a(He,"EM",{});var mm=r(Wo);ud=n(mm,"greedy decoding"),mm.forEach(o),_d=n(He," by calling "),Ho=a(He,"CODE",{});var gm=r(Ho);hd=n(gm,"_greedy_search()"),gm.forEach(o),fd=n(He,` if
