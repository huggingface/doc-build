import{S as As,i as Os,s as qs,e as r,k as d,w as u,t as o,M as Ss,c as a,d as t,m as l,a as s,x as p,h as n,b as m,F as e,g as z,y as _,q as b,o as y,B as v,v as Fs}from"../../chunks/vendor-6b77c823.js";import{T as xa}from"../../chunks/Tip-39098574.js";import{D as E}from"../../chunks/Docstring-1088f2fb.js";import{C as js}from"../../chunks/CodeBlock-3a8b25a8.js";import{I as zs}from"../../chunks/IconCopyLink-7a11ce68.js";function Is(H){let h,C,g,w,j;return{c(){h=r("p"),C=o(`A configuration file can be loaded and saved to disk. Loading the configuration file and using this file to
initialize a model does `),g=r("strong"),w=o("not"),j=o(" load the model weights. It only affects the model\u2019s configuration.")},l(k){h=a(k,"P",{});var P=s(h);C=n(P,`A configuration file can be loaded and saved to disk. Loading the configuration file and using this file to
initialize a model does `),g=a(P,"STRONG",{});var q=s(g);w=n(q,"not"),q.forEach(t),j=n(P," load the model weights. It only affects the model\u2019s configuration."),P.forEach(t)},m(k,P){z(k,h,P),e(h,C),e(h,g),e(g,w),e(h,j)},d(k){k&&t(h)}}}function Ls(H){let h,C,g,w,j;return{c(){h=r("p"),C=o("Passing "),g=r("code"),w=o("use_auth_token=True"),j=o(" is required when you want to use a private model.")},l(k){h=a(k,"P",{});var P=s(h);C=n(P,"Passing "),g=a(P,"CODE",{});var q=s(g);w=n(q,"use_auth_token=True"),q.forEach(t),j=n(P," is required when you want to use a private model."),P.forEach(t)},m(k,P){z(k,h,P),e(h,C),e(h,g),e(g,w),e(h,j)},d(k){k&&t(h)}}}function Ns(H){let h,C;return{c(){h=r("p"),C=o("This API is experimental and may have some slight breaking changes in the next releases.")},l(g){h=a(g,"P",{});var w=s(h);C=n(w,"This API is experimental and may have some slight breaking changes in the next releases."),w.forEach(t)},m(g,w){z(g,h,w),e(h,C)},d(g){g&&t(h)}}}function Ws(H){let h,C,g,w,j,k,P,q,jo,ao,G,zo,Ge,Ao,Oo,so,x,qo,it,So,Fo,dt,Io,Lo,lt,No,Wo,ct,Mo,Vo,io,R,X,ft,we,Bo,mt,Ro,lo,c,$e,Uo,ht,Jo,Ho,K,Go,gt,Xo,Ko,S,W,ut,Qo,Yo,pt,Zo,en,Xe,tn,on,nn,T,_t,rn,an,bt,sn,dn,Ke,ln,cn,Qe,fn,mn,Ye,hn,gn,un,Q,yt,pn,_n,vt,bn,yn,vn,Y,wt,wn,$n,$t,kn,Pn,Cn,kt,En,xn,F,Z,Pt,Tn,Dn,Ct,jn,zn,An,ee,Et,On,qn,xt,Sn,Fn,In,te,Tt,Ln,Nn,Dt,Wn,Mn,Vn,oe,jt,Bn,Rn,zt,Un,Jn,Hn,A,ke,Gn,Pe,Xn,At,Kn,Qn,Yn,Ot,Zn,er,Ce,tr,ne,Ee,or,I,nr,qt,rr,ar,St,sr,ir,Ft,dr,lr,cr,re,xe,fr,Te,mr,Ze,hr,gr,ur,ae,De,pr,je,_r,et,br,yr,vr,D,ze,wr,Ae,$r,tt,kr,Pr,Cr,se,Er,It,xr,Tr,Oe,Dr,ie,qe,jr,L,zr,Lt,Ar,Or,ot,qr,Sr,Nt,Fr,Ir,Lr,M,Se,Nr,Fe,Wr,Wt,Mr,Vr,Br,de,Rr,le,Ie,Ur,U,Jr,Mt,Hr,Gr,nt,Xr,Kr,Qr,ce,Le,Yr,Vt,Zr,ea,fe,Ne,ta,Bt,oa,na,me,We,ra,Rt,aa,sa,he,Me,ia,Ut,da,la,ge,Ve,ca,Be,fa,Jt,ma,ha,ga,O,Re,ua,Ue,pa,Ht,_a,ba,ya,J,va,Gt,wa,$a,Xt,ka,Pa,Ca,Kt,Ea,co;return k=new zs({}),we=new zs({}),$e=new E({props:{name:"class transformers.PretrainedConfig",anchor:"transformers.PretrainedConfig",parameters:[{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.PretrainedConfig.name_or_path",description:`<strong>name_or_path</strong> (<code>str</code>, <em>optional</em>, defaults to <code>&quot;&quot;</code>) &#x2014;
...
<p>kwargs &#x2014;
Additional key word arguments passed along to the <a href="/docs/transformers/main/en/main_classes/model#transformers.utils.PushToHubMixin.push_to_hub">push_to_hub()</a> method.`,name:"push_to_hub"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/configuration_utils.py#L406"}}),Le=new E({props:{name:"to_dict",anchor:"transformers.PretrainedConfig.to_dict",parameters:[],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/configuration_utils.py#L770",returnDescription:`
<p>Dictionary of all the attributes that make up this configuration instance.</p>
`,returnType:`
<p><code>Dict[str, Any]</code></p>
`}}),Ne=new E({props:{name:"to_diff_dict",anchor:"transformers.PretrainedConfig.to_diff_dict",parameters:[],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/configuration_utils.py#L738",returnDescription:`
<p>Dictionary of all the attributes that make up this configuration instance,</p>
`,returnType:`
<p><code>Dict[str, Any]</code></p>
...
`),ct=r("code"),Mo=o("vocab_size"),Vo=o("."),io=d(),R=r("h2"),X=r("a"),ft=r("span"),u(we.$$.fragment),Bo=d(),mt=r("span"),Ro=o("PretrainedConfig"),lo=d(),c=r("div"),u($e.$$.fragment),Uo=d(),ht=r("p"),Jo=o(`Base class for all configuration classes. Handles a few parameters common to all models\u2019 configurations as well as
...
`),Qe=r("a"),fn=o("EncoderDecoderConfig"),mn=o(" or "),Ye=r("a"),hn=o("~RagConfig"),gn=o("."),un=d(),Q=r("li"),yt=r("strong"),pn=o("keys_to_ignore_at_inference"),_n=o(" ("),vt=r("code"),bn=o("List[str]"),yn=o(`) \u2014 A list of keys to ignore by default when looking at dictionary
...
string, which can then be stored in the json format.`),cr=d(),re=r("div"),u(xe.$$.fragment),fr=d(),Te=r("p"),mr=o("Instantiates a "),Ze=r("a"),hr=o("PretrainedConfig"),gr=o(" from a Python dictionary of parameters."),ur=d(),ae=r("div"),u(De.$$.fragment),pr=d(),je=r("p"),_r=o("Instantiates a "),et=r("a"),br=o("PretrainedConfig"),yr=o(" from the path to a JSON file of parameters."),vr=d(),D=r("div"),u(ze.$$.fragment),wr=d(),Ae=r("p"),$r=o("Instantiate a "),tt=r("a"),kr=o("PretrainedConfig"),Pr=o(" (or a derived class) from a pretrained model configuration."),Cr=d(),u(se.$$.fragment),Er=d(),It=r("p"),xr=o("Examples:"),Tr=d(),u(Oe.$$.fragment),Dr=d(),ie=r("div"),u(qe.$$.fragment),jr=d(),L=r("p"),zr=o("From a "),Lt=r("code"),Ar=o("pretrained_model_name_or_path"),Or=o(`, resolve to a dictionary of parameters, to be used for instantiating a
...
the library are already mapped with `),Wt=r("code"),Mr=o("AutoConfig"),Vr=o("."),Br=d(),u(de.$$.fragment),Rr=d(),le=r("div"),u(Ie.$$.fragment),Ur=d(),U=r("p"),Jr=o("Save a configuration object to the directory "),Mt=r("code"),Hr=o("save_directory"),Gr=o(`, so that it can be re-loaded using the
`),nt=r("a"),Xr=o("from_pretrained()"),Kr=o(" class method."),Qr=d(),ce=r("div"),u(Le.$$.fragment),Yr=d(),Vt=r("p"),Zr=o("Serializes this instance to a Python dictionary."),ea=d(),fe=r("div"),u(Ne.$$.fragment),ta=d(),Bt=r("p"),oa=o(`Removes all attributes from config which correspond to the default config attributes for better readability and
serializes to a Python dictionary.`),na=d(),me=r("div"),u(We.$$.fragment),ra=d(),Rt=r("p"),aa=o("Save this instance to a JSON file."),sa=d(),he=r("div"),u(Me.$$.fragment),ia=d(),Ut=r("p"),da=o("Serializes this instance to a JSON string."),la=d(),ge=r("div"),u(Ve.$$.fragment),ca=d(),Be=r("p"),fa=o("Updates attributes of this class with attributes from "),Jt=r("code"),ma=o("config_dict"),ha=o("."),ga=d(),O=r("div"),u(Re.$$.fragment),ua=d(),Ue=r("p"),pa=o("Updates attributes of this class with attributes from "),Ht=r("code"),_a=o("update_str"),ba=o("."),ya=d(),J=r("p"),va=o("The expected format is ints, floats and strings as is, and for booleans use "),Gt=r("code"),wa=o("true"),$a=o(" or "),Xt=r("code"),ka=o("false"),Pa=o(`. For example:
\u201Cn_embd=10,resid_pdrop=0.2,scale_attn_weights=false,summary_type=cls_index\u201D`),Ca=d(),Kt=r("p"),Ea=o("The keys to change have to already exist in the config object."),this.h()},l(i){const $=Ss('[data-svelte="svelte-1phssyn"]',document.head);h=a($,"META",{name:!0,content:!0}),$.forEach(t),C=l(i),g=a(i,"H1",{class:!0});var Je=s(g);w=a(Je,"A",{id:!0,class:!0,href:!0});var Qt=s(w);j=a(Qt,"SPAN",{});var Yt=s(j);p(k.$$.fragment,Yt),Yt.forEach(t),Qt.forEach(t),P=l(Je),q=a(Je,"SPAN",{});var Ta=s(q);jo=n(Ta,"Configuration"),Ta.forEach(t),Je.forEach(t),ao=l(i),G=a(i,"P",{});var fo=s(G);zo=n(fo,"The base class "),Ge=a(fo,"A",{href:!0});var Da=s(Ge);Ao=n(Da,"PretrainedConfig"),Da.forEach(t),Oo=n(fo,` implements the common methods for loading/saving a configuration
either from a local file or directory, or from a pretrained model configuration provided by the library (downloaded
...
`),Qe=a(N,"A",{href:!0});var Ua=s(Qe);fn=n(Ua,"EncoderDecoderConfig"),Ua.forEach(t),mn=n(N," or "),Ye=a(N,"A",{href:!0});var Ja=s(Ye);hn=n(Ja,"~RagConfig"),Ja.forEach(t),gn=n(N,"."),N.forEach(t),un=l(ue),Q=a(ue,"LI",{});var Zt=s(Q);yt=a(Zt,"STRONG",{});var Ha=s(yt);pn=n(Ha,"keys_to_ignore_at_inference"),Ha.forEach(t),_n=n(Zt," ("),vt=a(Zt,"CODE",{});var Ga=s(vt);bn=n(Ga,"List[str]"),Ga.forEach(t),yn=n(Zt,`) \u2014 A list of keys to ignore by default when looking at dictionary
outputs of the model during inference.`),Zt.forEach(t),vn=l(ue),Y=a(ue,"LI",{});var eo=s(Y);wt=a(eo,"STRONG",{});var Xa=s(wt);wn=n(Xa,"attribute_map"),Xa.forEach(t),$n=n(eo," ("),$t=a(eo,"CODE",{});var Ka=s($t);kn=n(Ka,"Dict[str, str]"),Ka.forEach(t),Pn=n(eo,`) \u2014 A dict that maps model specific attribute names to the standardized
naming of attributes.`),eo.forEach(t),ue.forEach(t),Cn=l(f),kt=a(f,"P",{});var Qa=s(kt);En=n(Qa,"Common attributes (present in all subclasses):"),Qa.forEach(t),xn=l(f),F=a(f,"UL",{});var pe=s(F);Z=a(pe,"LI",{});var to=s(Z);Pt=a(to,"STRONG",{});var Ya=s(Pt);Tn=n(Ya,"vocab_size"),Ya.forEach(t),Dn=n(to," ("),Ct=a(to,"CODE",{});var Za=s(Ct);jn=n(Za,"int"),Za.forEach(t),zn=n(to,`) \u2014 The number of tokens in the vocabulary, which is also the first dimension of the
embeddings matrix (this attribute may be missing for models that don\u2019t have a text modality like ViT).`),to.forEach(t),An=l(pe),ee=a(pe,"LI",{});var oo=s(ee);Et=a(oo,"STRONG",{});var es=s(Et);On=n(es,"hidden_size"),es.forEach(t),qn=n(oo," ("),xt=a(oo,"CODE",{});var ts=s(xt);Sn=n(ts,"int"),ts.forEach(t),Fn=n(oo,") \u2014 The hidden size of the model."),oo.forEach(t),In=l(pe),te=a(pe,"LI",{});var no=s(te);Tt=a(no,"STRONG",{});var os=s(Tt);Ln=n(os,"num_attention_heads"),os.forEach(t),Nn=n(no," ("),Dt=a(no,"CODE",{});var ns=s(Dt);Wn=n(ns,"int"),ns.forEach(t),Mn=n(no,`) \u2014 The number of attention heads used in the multi-head attention layers of the
model.`),no.forEach(t),Vn=l(pe),oe=a(pe,"LI",{});var ro=s(oe);jt=a(ro,"STRONG",{});var rs=s(jt);Bn=n(rs,"num_hidden_layers"),rs.forEach(t),Rn=n(ro," ("),zt=a(ro,"CODE",{});var as=s(zt);Un=n(as,"int"),as.forEach(t),Jn=n(ro,") \u2014 The number of blocks in the model."),ro.forEach(t),pe.forEach(t),Hn=l(f),A=a(f,"DIV",{class:!0});var _e=s(A);p(ke.$$.fragment,_e),Gn=l(_e),Pe=a(_e,"P",{});var ho=s(Pe);Xn=n(ho,`Upload the configuration file to the \u{1F917} Model Hub while synchronizing a local clone of the repo in
`),At=a(ho,"CODE",{});var ss=s(At);Kn=n(ss,"repo_path_or_name"),ss.forEach(t),Qn=n(ho,"."),ho.forEach(t),Yn=l(_e),Ot=a(_e,"P",{});var is=s(Ot);Zn=n(is,"Examples:"),is.forEach(t),er=l(_e),p(Ce.$$.fragment,_e),_e.forEach(t),tr=l(f),ne=a(f,"DIV",{class:!0});var go=s(ne);p(Ee.$$.fragment,go),or=l(go),I=a(go,"P",{});var be=s(I);nr=n(be,"Checks whether the passed dictionary and its nested dicts have a "),qt=a(be,"EM",{});var ds=s(qt);rr=n(ds,"torch_dtype"),ds.forEach(t),ar=n(be,` key and if it\u2019s not None,
...
string, which can then be stored in the json format.`),be.forEach(t),go.forEach(t),cr=l(f),re=a(f,"DIV",{class:!0});var uo=s(re);p(xe.$$.fragment,uo),fr=l(uo),Te=a(uo,"P",{});var po=s(Te);mr=n(po,"Instantiates a "),Ze=a(po,"A",{href:!0});var fs=s(Ze);hr=n(fs,"PretrainedConfig"),fs.forEach(t),gr=n(po," from a Python dictionary of parameters."),po.forEach(t),uo.forEach(t),ur=l(f),ae=a(f,"DIV",{class:!0});var _o=s(ae);p(De.$$.fragment,_o),pr=l(_o),je=a(_o,"P",{});var bo=s(je);_r=n(bo,"Instantiates a "),et=a(bo,"A",{href:!0});var ms=s(et);br=n(ms,"PretrainedConfig"),ms.forEach(t),yr=n(bo," from the path to a JSON file of parameters."),bo.forEach(t),_o.forEach(t),vr=l(f),D=a(f,"DIV",{class:!0});var B=s(D);p(ze.$$.fragment,B),wr=l(B),Ae=a(B,"P",{});var yo=s(Ae);$r=n(yo,"Instantiate a "),tt=a(yo,"A",{href:!0});var hs=s(tt);kr=n(hs,"PretrainedConfig"),hs.forEach(t),Pr=n(yo," (or a derived class) from a pretrained model configuration."),yo.forEach(t),Cr=l(B),p(se.$$.fragment,B),Er=l(B),It=a(B,"P",{});var gs=s(It);xr=n(gs,"Examples:"),gs.forEach(t),Tr=l(B),p(Oe.$$.fragment,B),B.forEach(t),Dr=l(f),ie=a(f,"DIV",{class:!0});var vo=s(ie);p(qe.$$.fragment,vo),jr=l(vo),L=a(vo,"P",{});var ye=s(L);zr=n(ye,"From a "),Lt=a(ye,"CODE",{});var us=s(Lt);Ar=n(us,"pretrained_model_name_or_path"),us.forEach(t),Or=n(ye,`, resolve to a dictionary of parameters, to be used for instantiating a
`),ot=a(ye,"A",{href:!0});var ps=s(ot);qr=n(ps,"PretrainedConfig"),ps.forEach(t),Sr=n(ye," using "),Nt=a(ye,"CODE",{});var _s=s(Nt);Fr=n(_s,"from_dict"),_s.forEach(t),Ir=n(ye,"."),ye.forEach(t),vo.forEach(t),Lr=l(f),M=a(f,"DIV",{class:!0});var rt=s(M);p(Se.$$.fragment,rt),Nr=l(rt),Fe=a(rt,"P",{});var wo=s(Fe);Wr=n(wo,`Register this class with a given auto class. This should only be used for custom configurations as the ones in
the library are already mapped with `),Wt=a(wo,"CODE",{});var bs=s(Wt);Mr=n(bs,"AutoConfig"),bs.forEach(t),Vr=n(wo,"."),wo.forEach(t),Br=l(rt),p(de.$$.fragment,rt),rt.forEach(t),Rr=l(f),le=a(f,"DIV",{class:!0});var $o=s(le);p(Ie.$$.fragment,$o),Ur=l($o),U=a($o,"P",{});var at=s(U);Jr=n(at,"Save a configuration object to the directory "),Mt=a(at,"CODE",{});var ys=s(Mt);Hr=n(ys,"save_directory"),ys.forEach(t),Gr=n(at,`, so that it can be re-loaded using the
`),nt=a(at,"A",{href:!0});var vs=s(nt);Xr=n(vs,"from_pretrained()"),vs.forEach(t),Kr=n(at," class method."),at.forEach(t),$o.forEach(t),Qr=l(f),ce=a(f,"DIV",{class:!0});var ko=s(ce);p(Le.$$.fragment,ko),Yr=l(ko),Vt=a(ko,"P",{});var ws=s(Vt);Zr=n(ws,"Serializes this instance to a Python dictionary."),ws.forEach(t),ko.forEach(t),ea=l(f),fe=a(f,"DIV",{class:!0});var Po=s(fe);p(Ne.$$.fragment,Po),ta=l(Po),Bt=a(Po,"P",{});var $s=s(Bt);oa=n($s,`Removes all attributes from config which correspond to the default config attributes for better readability and
serializes to a Python dictionary.`),$s.forEach(t),Po.forEach(t),na=l(f),me=a(f,"DIV",{class:!0});var Co=s(me);p(We.$$.fragment,Co),ra=l(Co),Rt=a(Co,"P",{});var ks=s(Rt);aa=n(ks,"Save this instance to a JSON file."),ks.forEach(t),Co.forEach(t),sa=l(f),he=a(f,"DIV",{class:!0});var Eo=s(he);p(Me.$$.fragment,Eo),ia=l(Eo),Ut=a(Eo,"P",{});var Ps=s(Ut);da=n(Ps,"Serializes this instance to a JSON string."),Ps.forEach(t),Eo.forEach(t),la=l(f),ge=a(f,"DIV",{class:!0});var xo=s(ge);p(Ve.$$.fragment,xo),ca=l(xo),Be=a(xo,"P",{});var To=s(Be);fa=n(To,"Updates attributes of this class with attributes from "),Jt=a(To,"CODE",{});var Cs=s(Jt);ma=n(Cs,"config_dict"),Cs.forEach(t),ha=n(To,"."),To.forEach(t),xo.forEach(t),ga=l(f),O=a(f,"DIV",{class:!0});var ve=s(O);p(Re.$$.fragment,ve),ua=l(ve),Ue=a(ve,"P",{});var Do=s(Ue);pa=n(Do,"Updates attributes of this class with attributes from "),Ht=a(Do,"CODE",{});var Es=s(Ht);_a=n(Es,"update_str"),Es.forEach(t),ba=n(Do,"."),Do.forEach(t),ya=l(ve),J=a(ve,"P",{});var st=s(J);va=n(st,"The expected format is ints, floats and strings as is, and for booleans use "),Gt=a(st,"CODE",{});var xs=s(Gt);wa=n(xs,"true"),xs.forEach(t),$a=n(st," or "),Xt=a(st,"CODE",{});var Ts=s(Xt);ka=n(Ts,"false"),Ts.forEach(t),Pa=n(st,`. For example:
\u201Cn_embd=10,resid_pdrop=0.2,scale_attn_weights=false,summary_type=cls_index\u201D`),st.forEach(t),Ca=l(ve),Kt=a(ve,"P",{});var Ds=s(Kt);Ea=n(Ds,"The keys to change have to already exist in the config object."),Ds.forEach(t),ve.forEach(t),f.forEach(t),this.h()},h(){m(h,"name","hf:doc:metadata"),m(h,"content",JSON.stringify(Ms)),m(w,"id","configuration"),m(w,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),m(w,"href","#configuration"),m(g,"class","relative group"),m(Ge,"href","/docs/transformers/main/en/main_classes/configuration#transformers.PretrainedConfig"),m(X,"id","transformers.PretrainedConfig"),m(X,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),m(X,"href","#transformers.PretrainedConfig"),m(R,"class","relative group"),m(Xe,"href","/docs/transformers/main/en/model_doc/auto#transformers.AutoConfig"),m(Ke,"href","/docs/transformers/main/en/main_classes/configuration#transformers.PretrainedConfig"),m(Qe,"href","/docs/transformers/main/en/model_doc/encoder-decoder#transformers.EncoderDecoderConfig"),m(Ye,"href","/docs/transformers/main/en/model_doc/rag#transformers.RagConfig"),m(A,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),m(ne,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),m(Ze,"href","/docs/transformers/main/en/main_classes/configuration#transformers.PretrainedConfig"),m(re,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),m(et,"href","/docs/transformers/main/en/main_classes/configuration#transformers.PretrainedConfig"),m(ae,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),m(tt,"href","/docs/transformers/main/en/main_classes/configuration#transformers.PretrainedConfig"),m(D,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),m(ot,"href","/docs/transformers/main/en/main_classes/configuration#transformers.PretrainedConfig"),m(ie,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),m(M,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),m(nt,"href","/docs/transformers/main/en/main_classes/configuration#transformers.PretrainedConfig.from_pretrained"),m(le,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),m(ce,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),m(fe,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),m(me,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),m(he,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),m(ge,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),m(O,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),m(c,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8")},m(i,$){e(document.head,h),z(i,C,$),z(i,g,$),e(g,w),e(w,j),_(k,j,null),e(g,P),e(g,q),e(q,jo),z(i,ao,$),z(i,G,$),e(G,zo),e(G,Ge),e(Ge,Ao),e(G,Oo),z(i,so,$),z(i,x,$),e(x,qo),e(x,it),e(it,So),e(x,Fo),e(x,dt),e(dt,Io),e(x,Lo),e(x,lt),e(lt,No),e(x,Wo),e(x,ct),e(ct,Mo),e(x,Vo),z(i,io,$),z(i,R,$),e(R,X),e(X,ft),_(we,ft,null),e(R,Bo),e(R,mt),e(mt,Ro),z(i,lo,$),z(i,c,$),_($e,c,null),e(c,Uo),e(c,ht),e(ht,Jo),e(c,Ho),_(K,c,null),e(c,Go),e(c,gt),e(gt,Xo),e(c,Ko),e(c,S),e(S,W),e(W,ut),e(ut,Qo),e(W,Yo),e(W,pt),e(pt,Zo),e(W,en),e(W,Xe),e(Xe,tn),e(W,on),e(S,nn),e(S,T),e(T,_t),e(_t,rn),e(T,an),e(T,bt),e(bt,sn),e(T,dn),e(T,Ke),e(Ke,ln),e(T,cn),e(T,Qe),e(Qe,fn),e(T,mn),e(T,Ye),e(Ye,hn),e(T,gn),e(S,un),e(S,Q),e(Q,yt),e(yt,pn),e(Q,_n),e(Q,vt),e(vt,bn),e(Q,yn),e(S,vn),e(S,Y),e(Y,wt),e(wt,wn),e(Y,$n),e(Y,$t),e($t,kn),e(Y,Pn),e(c,Cn),e(c,kt),e(kt,En),e(c,xn),e(c,F),e(F,Z),e(Z,Pt),e(Pt,Tn),e(Z,Dn),e(Z,Ct),e(Ct,jn),e(Z,zn),e(F,An),e(F,ee),e(ee,Et),e(Et,On),e(ee,qn),e(ee,xt),e(xt,Sn),e(ee,Fn),e(F,In),e(F,te),e(te,Tt),e(Tt,Ln),e(te,Nn),e(te,Dt),e(Dt,Wn),e(te,Mn),e(F,Vn),e(F,oe),e(oe,jt),e(jt,Bn),e(oe,Rn),e(oe,zt),e(zt,Un),e(oe,Jn),e(c,Hn),e(c,A),_(ke,A,null),e(A,Gn),e(A,Pe),e(Pe,Xn),e(Pe,At),e(At,Kn),e(Pe,Qn),e(A,Yn),e(A,Ot),e(Ot,Zn),e(A,er),_(Ce,A,null),e(c,tr),e(c,ne),_(Ee,ne,null),e(ne,or),e(ne,I),e(I,nr),e(I,qt),e(qt,rr),e(I,ar),e(I,St),e(St,sr),e(I,ir),e(I,Ft),e(Ft,dr),e(I,lr),e(c,cr),e(c,re),_(xe,re,null),e(re,fr),e(re,Te),e(Te,mr),e(Te,Ze),e(Ze,hr),e(Te,gr),e(c,ur),e(c,ae),_(De,ae,null),e(ae,pr),e(ae,je),e(je,_r),e(je,et),e(et,br),e(je,yr),e(c,vr),e(c,D),_(ze,D,null),e(D,wr),e(D,Ae),e(Ae,$r),e(Ae,tt),e(tt,kr),e(Ae,Pr),e(D,Cr),_(se,D,null),e(D,Er),e(D,It),e(It,xr),e(D,Tr),_(Oe,D,null),e(c,Dr),e(c,ie),_(qe,ie,null),e(ie,jr),e(ie,L),e(L,zr),e(L,Lt),e(Lt,Ar),e(L,Or),e(L,ot),e(ot,qr),e(L,Sr),e(L,Nt),e(Nt,Fr),e(L,Ir),e(c,Lr),e(c,M),_(Se,M,null),e(M,Nr),e(M,Fe),e(Fe,Wr),e(Fe,Wt),e(Wt,Mr),e(Fe,Vr),e(M,Br),_(de,M,null),e(c,Rr),e(c,le),_(Ie,le,null),e(le,Ur),e(le,U),e(U,Jr),e(U,Mt),e(Mt,Hr),e(U,Gr),e(U,nt),e(nt,Xr),e(U,Kr),e(c,Qr),e(c,ce),_(Le,ce,null),e(ce,Yr),e(ce,Vt),e(Vt,Zr),e(c,ea),e(c,fe),_(Ne,fe,null),e(fe,ta),e(fe,Bt),e(Bt,oa),e(c,na),e(c,me),_(We,me,null),e(me,ra),e(me,Rt),e(Rt,aa),e(c,sa),e(c,he),_(Me,he,null),e(he,ia),e(he,Ut),e(Ut,da),e(c,la),e(c,ge),_(Ve,ge,null),e(ge,ca),e(ge,Be),e(Be,fa),e(Be,Jt),e(Jt,ma),e(Be,ha),e(c,ga),e(c,O),_(Re,O,null),e(O,ua),e(O,Ue),e(Ue,pa),e(Ue,Ht),e(Ht,_a),e(Ue,ba),e(O,ya),e(O,J),e(J,va),e(J,Gt),e(Gt,wa),e(J,$a),e(J,Xt),e(Xt,ka),e(J,Pa),e(O,Ca),e(O,Kt),e(Kt,Ea),co=!0},p(i,[$]){const Je={};$&2&&(Je.$$scope={dirty:$,ctx:i}),K.$set(Je);const Qt={};$&2&&(Qt.$$scope={dirty:$,ctx:i}),se.$set(Qt);const Yt={};$&2&&(Yt.$$scope={dirty:$,ctx:i}),de.$set(Yt)},i(i){co||(b(k.$$.fragment,i),b(we.$$.fragment,i),b($e.$$.fragment,i),b(K.$$.fragment,i),b(ke.$$.fragment,i),b(Ce.$$.fragment,i),b(Ee.$$.fragment,i),b(xe.$$.fragment,i),b(De.$$.fragment,i),b(ze.$$.fragment,i),b(se.$$.fragment,i),b(Oe.$$.fragment,i),b(qe.$$.fragment,i),b(Se.$$.fragment,i),b(de.$$.fragment,i),b(Ie.$$.fragment,i),b(Le.$$.fragment,i),b(Ne.$$.fragment,i),b(We.$$.fragment,i),b(Me.$$.fragment,i),b(Ve.$$.fragment,i),b(Re.$$.fragment,i),co=!0)},o(i){y(k.$$.fragment,i),y(we.$$.fragment,i),y($e.$$.fragment,i),y(K.$$.fragment,i),y(ke.$$.fragment,i),y(Ce.$$.fragment,i),y(Ee.$$.fragment,i),y(xe.$$.fragment,i),y(De.$$.fragment,i),y(ze.$$.fragment,i),y(se.$$.fragment,i),y(Oe.$$.fragment,i),y(qe.$$.fragment,i),y(Se.$$.fragment,i),y(de.$$.fragment,i),y(Ie.$$.fragment,i),y(Le.$$.fragment,i),y(Ne.$$.fragment,i),y(We.$$.fragment,i),y(Me.$$.fragment,i),y(Ve.$$.fragment,i),y(Re.$$.fragment,i),co=!1},d(i){t(h),i&&t(C),i&&t(g),v(k),i&&t(ao),i&&t(G),i&&t(so),i&&t(x),i&&t(io),i&&t(R),v(we),i&&t(lo),i&&t(c),v($e),v(K),v(ke),v(Ce),v(Ee),v(xe),v(De),v(ze),v(se),v(Oe),v(qe),v(Se),v(de),v(Ie),v(Le),v(Ne),v(We),v(Me),v(Ve),v(Re)}}}const Ms={local:"configuration",sections:[{local:"transformers.PretrainedConfig",title:"PretrainedConfig"}],title:"Configuration"};function Vs(H){return Fs(()=>{new URLSearchParams(window.location.search).get("fw")}),[]}class Gs extends As{constructor(h){super();Os(this,h,Vs,Ws,qs,{})}}export{Gs as default,Ms as metadata};
