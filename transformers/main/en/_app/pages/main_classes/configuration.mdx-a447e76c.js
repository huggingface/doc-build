...
<span class="hljs-keyword">assert</span> config.output_attentions == <span class="hljs-literal">True</span>
<span class="hljs-keyword">assert</span> unused_kwargs == {<span class="hljs-string">&quot;foo&quot;</span>: <span class="hljs-literal">False</span>}`}}),{c(){f=r("p"),b=o("Examples:"),u=d(),v(g.$$.fragment)},l(c){f=a(c,"P",{});var _=s(f);b=n(_,"Examples:"),_.forEach(t),u=l(c),w(g.$$.fragment,c)},m(c,_){x(c,f,_),e(f,b),x(c,u,_),$(g,c,_),E=!0},p:Ps,i(c){E||(k(g.$$.fragment,c),E=!0)},o(c){P(g.$$.fragment,c),E=!1},d(c){c&&t(f),c&&t(u),C(g,c)}}}function Ss(z){let f,b;return{c(){f=r("p"),b=o("This API is experimental and may have some slight breaking changes in the next releases.")},l(u){f=a(u,"P",{});var g=s(f);b=n(g,"This API is experimental and may have some slight breaking changes in the next releases."),g.forEach(t)},m(u,g){x(u,f,g),e(f,b)},d(u){u&&t(f)}}}function Fs(z){let f,b,u,g,E,c,_,q,Do,ao,H,jo,Ge,zo,Ao,so,D,Oo,dt,qo,So,lt,Fo,Io,ct,Lo,No,ft,Wo,Mo,io,R,G,mt,$e,Vo,ht,Bo,lo,m,ke,Ro,ut,Uo,Jo,X,Ho,gt,Go,Xo,S,W,pt,Ko,Qo,_t,Yo,Zo,Xe,en,tn,on,j,bt,nn,rn,yt,an,sn,Ke,dn,ln,Qe,cn,fn,Ye,mn,hn,un,K,vt,gn,pn,wt,_n,bn,yn,Q,$t,vn,wn,kt,$n,kn,Pn,Pt,Cn,En,F,Y,Ct,xn,Tn,Et,Dn,jn,zn,Z,xt,An,On,Tt,qn,Sn,Fn,ee,Dt,In,Ln,jt,Nn,Wn,Mn,te,zt,Vn,Bn,At,Rn,Un,Jn,M,Pe,Hn,Ce,Gn,Ot,Xn,Kn,Qn,oe,Yn,ne,Ee,Zn,I,er,qt,tr,or,St,nr,rr,Ft,ar,sr,ir,re,xe,dr,Te,lr,Ze,cr,fr,mr,ae,De,hr,je,ur,et,gr,pr,_r,A,ze,br,Ae,yr,tt,vr,wr,$r,se,kr,ie,Pr,de,Oe,Cr,L,Er,It,xr,Tr,ot,Dr,jr,Lt,zr,Ar,Or,V,qe,qr,Se,Sr,Nt,Fr,Ir,Lr,le,Nr,ce,Fe,Wr,U,Mr,Wt,Vr,Br,nt,Rr,Ur,Jr,fe,Ie,Hr,Mt,Gr,Xr,me,Le,Kr,Vt,Qr,Yr,he,Ne,Zr,Bt,ea,ta,ue,We,oa,Rt,na,ra,ge,Me,aa,Ve,sa,Ut,ia,da,la,O,Be,ca,Re,fa,Jt,ma,ha,ua,J,ga,Ht,pa,_a,Gt,ba,ya,va,Xt,wa,co;return c=new $s({}),$e=new $s({}),ke=new T({props:{name:"class transformers.PretrainedConfig",anchor:"transformers.PretrainedConfig",parameters:[{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.PretrainedConfig.name_or_path",description:`<strong>name_or_path</strong> (<code>str</code>, <em>optional</em>, defaults to <code>&quot;&quot;</code>) &#x2014;
...
Forward Chunking work?</a>.`,name:"chunk_size_feed_forward"}],source:"https://github.com/huggingface/transformers/blob/vmain/src/transformers/configuration_utils.py#L54",parameterGroups:[{title:"Parameters for sequence generation",parametersDescription:`
<ul>
...
Additional parameters from which to initialize the configuration object.`,name:"kwargs"}],source:"https://github.com/huggingface/transformers/blob/vmain/src/transformers/configuration_utils.py#L663",returnDescription:`
...
Path to the JSON file containing the parameters.`,name:"json_file"}],source:"https://github.com/huggingface/transformers/blob/vmain/src/transformers/configuration_utils.py#L710",returnDescription:`
...
by the <code>return_unused_kwargs</code> keyword parameter.`,name:"kwargs"}],source:"https://github.com/huggingface/transformers/blob/vmain/src/transformers/configuration_utils.py#L452",returnDescription:`
...
The identifier of the pre-trained checkpoint from which we want the dictionary of parameters.`,name:"pretrained_model_name_or_path"}],source:"https://github.com/huggingface/transformers/blob/vmain/src/transformers/configuration_utils.py#L535",returnDescription:`
...
<p>kwargs &#x2014;
Additional key word arguments passed along to the <a href="/docs/transformers/main/en/main_classes/model#transformers.utils.PushToHubMixin.push_to_hub">push_to_hub()</a> method.`,name:"push_to_hub"}],source:"https://github.com/huggingface/transformers/blob/vmain/src/transformers/configuration_utils.py#L406"}}),Ie=new T({props:{name:"to_dict",anchor:"transformers.PretrainedConfig.to_dict",parameters:[],source:"https://github.com/huggingface/transformers/blob/vmain/src/transformers/configuration_utils.py#L770",returnDescription:`
<p>Dictionary of all the attributes that make up this configuration instance.</p>
`,returnType:`
<p><code>Dict[str, Any]</code></p>
`}}),Le=new T({props:{name:"to_diff_dict",anchor:"transformers.PretrainedConfig.to_diff_dict",parameters:[],source:"https://github.com/huggingface/transformers/blob/vmain/src/transformers/configuration_utils.py#L738",returnDescription:`
<p>Dictionary of all the attributes that make up this configuration instance,</p>
`,returnType:`
<p><code>Dict[str, Any]</code></p>
...
`),ft=r("code"),Wo=o("vocab_size"),Mo=o("."),io=d(),R=r("h2"),G=r("a"),mt=r("span"),v($e.$$.fragment),Vo=d(),ht=r("span"),Bo=o("PretrainedConfig"),lo=d(),m=r("div"),v(ke.$$.fragment),Ro=d(),ut=r("p"),Uo=o(`Base class for all configuration classes. Handles a few parameters common to all models\u2019 configurations as well as
...
serializes to a Python dictionary.`),Yr=d(),he=r("div"),v(Ne.$$.fragment),Zr=d(),Bt=r("p"),ea=o("Save this instance to a JSON file."),ta=d(),ue=r("div"),v(We.$$.fragment),oa=d(),Rt=r("p"),na=o("Serializes this instance to a JSON string."),ra=d(),ge=r("div"),v(Me.$$.fragment),aa=d(),Ve=r("p"),sa=o("Updates attributes of this class with attributes from "),Ut=r("code"),ia=o("config_dict"),da=o("."),la=d(),O=r("div"),v(Be.$$.fragment),ca=d(),Re=r("p"),fa=o("Updates attributes of this class with attributes from "),Jt=r("code"),ma=o("update_str"),ha=o("."),ua=d(),J=r("p"),ga=o("The expected format is ints, floats and strings as is, and for booleans use "),Ht=r("code"),pa=o("true"),_a=o(" or "),Gt=r("code"),ba=o("false"),ya=o(`. For example:
...
outputs of the model during inference.`),Zt.forEach(t),yn=l(pe),Q=a(pe,"LI",{});var eo=s(Q);$t=a(eo,"STRONG",{});var Ba=s($t);vn=n(Ba,"attribute_map"),Ba.forEach(t),wn=n(eo," ("),kt=a(eo,"CODE",{});var Ra=s(kt);$n=n(Ra,"Dict[str, str]"),Ra.forEach(t),kn=n(eo,`) \u2014 A dict that maps model specific attribute names to the standardized
