import{S as Cm,i as Im,s as Wm,e as s,k as l,w as m,t,M as Bm,c as a,d as o,m as d,a as r,x as g,h as n,b as c,F as e,g as M,y as u,q as _,o as h,B as f,v as Hm}from"../../chunks/vendor-6b77c823.js";import{T as Dm}from"../../chunks/Tip-39098574.js";import{D as ue}from"../../chunks/Docstring-abef54e3.js";import{C as be}from"../../chunks/CodeBlock-3a8b25a8.js";import{I as Ws}from"../../chunks/IconCopyLink-7a11ce68.js";function Rm(en){let p,C,L,q,N,w,_e,D,O,I,G;return{c(){p=s("p"),C=t("Apart from "),L=s("code"),q=t("inputs"),N=t(`, all the arguments below will default to the value of the attribute of the same name as
defined in the model\u2019s config (`),w=s("code"),_e=t("config.json"),D=t(`) which in turn defaults to the
...
`}}),Je=new Dm({props:{warning:!0,$$slots:{default:[Rm]},$$scope:{ctx:en}}}),_t=new be({props:{code:`from transformers import AutoTokenizer, AutoModelForCausalLM
...
`),vn=s("a"),gi=t("constrained_beam_search()"),ui=t(", if "),fo=s("code"),_i=t("constraints!=None"),hi=t(` or
`),bo=s("code"),fi=t("force_words_ids!=None"),bi=t("."),xi=l(),m(Je.$$.fragment),ki=l(),gt=s("p"),vi=t("Most of these parameters are explained in more detail in "),ut=s("a"),yi=t(`this blog
post`),ji=t("."),Li=l(),xo=s("p"),Mi=t("Examples:"),wi=l(),ko=s("p"),Ti=t("Greedy Decoding:"),Ei=l(),m(_t.$$.fragment),Oi=l(),vo=s("p"),qi=t("Multinomial Sampling:"),Gi=l(),m(ht.$$.fragment),Si=l(),yo=s("p"),$i=t("Beam-search decoding:"),Fi=l(),m(ft.$$.fragment),Ai=l(),ee=s("div"),m(bt.$$.fragment),zi=l(),xt=s("p"),Pi=t("Generates sequences of token ids for models with a language modeling head using "),jo=s("strong"),Ni=t("greedy decoding"),Di=t(` and can be
...
`),Ln=s("a"),id=t("FlaxPreTrainedModel"),ld=t("."),dd=l(),Kt=s("p"),cd=t("The class exposes "),Mn=s("a"),pd=t("generate()"),md=t(", which can be used for:"),gd=l(),qe=s("ul"),re=s("li"),Bo=s("em"),ud=t("greedy decoding"),_d=t(" by calling "),Ho=s("code"),hd=t("_greedy_search()"),fd=t(`if
...
`),no=a(Ne,"CODE",{});var mp=r(no);wr=n(mp,"do_sample=False"),mp.forEach(o),Tr=n(Ne,"."),Ne.forEach(o),Er=d(ge),Z=a(ge,"LI",{});var De=r(Z);oo=a(De,"EM",{});var gp=r(oo);Or=n(gp,"multinomial sampling"),gp.forEach(o),qr=n(De," by calling "),fn=a(De,"A",{href:!0});var up=r(fn);Gr=n(up,"sample()"),up.forEach(o),Sr=n(De," if "),so=a(De,"CODE",{});var _p=r(so);$r=n(_p,"num_beams=1"),_p.forEach(o),Fr=n(De,` and
...
`),uo=a(We,"CODE",{});var Tp=r(uo);ri=n(Tp,"num_beams>1"),Tp.forEach(o),ii=n(We," and "),_o=a(We,"CODE",{});var Ep=r(_o);li=n(Ep,"num_beam_groups>1"),Ep.forEach(o),di=n(We,"."),We.forEach(o),ci=d(ge),Y=a(ge,"LI",{});var Be=r(Y);ho=a(Be,"EM",{});var Op=r(ho);pi=n(Op,"constrained beam-search decoding"),Op.forEach(o),mi=n(Be,` by calling
`),vn=a(Be,"A",{href:!0});var qp=r(vn);gi=n(qp,"constrained_beam_search()"),qp.forEach(o),ui=n(Be,", if "),fo=a(Be,"CODE",{});var Gp=r(fo);_i=n(Gp,"constraints!=None"),Gp.forEach(o),hi=n(Be,` or
`),bo=a(Be,"CODE",{});var Sp=r(bo);fi=n(Sp,"force_words_ids!=None"),Sp.forEach(o),bi=n(Be,"."),Be.forEach(o),ge.forEach(o),xi=d(y),g(Je.$$.fragment,y),ki=d(y),gt=a(y,"P",{});var Ts=r(gt);vi=n(Ts,"Most of these parameters are explained in more detail in "),ut=a(Ts,"A",{href:!0,rel:!0});var $p=r(ut);yi=n($p,`this blog
post`),$p.forEach(o),ji=n(Ts,"."),Ts.forEach(o),Li=d(y),xo=a(y,"P",{});var Fp=r(xo);Mi=n(Fp,"Examples:"),Fp.forEach(o),wi=d(y),ko=a(y,"P",{});var Ap=r(ko);Ti=n(Ap,"Greedy Decoding:"),Ap.forEach(o),Ei=d(y),g(_t.$$.fragment,y),Oi=d(y),vo=a(y,"P",{});var zp=r(vo);qi=n(zp,"Multinomial Sampling:"),zp.forEach(o),Gi=d(y),g(ht.$$.fragment,y),Si=d(y),yo=a(y,"P",{});var Pp=r(yo);$i=n(Pp,"Beam-search decoding:"),Pp.forEach(o),Fi=d(y),g(ft.$$.fragment,y),y.forEach(o),Ai=d(j),ee=a(j,"DIV",{class:!0});var tt=r(ee);g(bt.$$.fragment,tt),zi=d(tt),xt=a(tt,"P",{});var Es=r(xt);Pi=n(Es,"Generates sequences of token ids for models with a language modeling head using "),jo=a(Es,"STRONG",{});var Np=r(jo);Ni=n(Np,"greedy decoding"),Np.forEach(o),Di=n(Es,` and can be
...
`),Ln=a(Ds,"A",{href:!0});var cm=r(Ln);id=n(cm,"FlaxPreTrainedModel"),cm.forEach(o),ld=n(Ds,"."),Ds.forEach(o),dd=d(ve),Kt=a(ve,"P",{});var Cs=r(Kt);cd=n(Cs,"The class exposes "),Mn=a(Cs,"A",{href:!0});var pm=r(Mn);pd=n(pm,"generate()"),pm.forEach(o),md=n(Cs,", which can be used for:"),Cs.forEach(o),gd=d(ve),qe=a(ve,"UL",{});var Gn=r(qe);re=a(Gn,"LI",{});var He=r(re);Bo=a(He,"EM",{});var mm=r(Bo);ud=n(mm,"greedy decoding"),mm.forEach(o),_d=n(He," by calling "),Ho=a(He,"CODE",{});var gm=r(Ho);hd=n(gm,"_greedy_search()"),gm.forEach(o),fd=n(He,`if
`),Ro=a(He,"CODE",{});var um=r(Ro);bd=n(um,"num_beams=1"),um.forEach(o),xd=n(He," and "),Uo=a(He,"CODE",{});var _m=r(Uo);kd=n(_m,"do_sample=False"),_m.forEach(o),vd=n(He,"."),He.forEach(o),yd=d(Gn),ie=a(Gn,"LI",{});var Re=r(ie);Vo=a(Re,"EM",{});var hm=r(Vo);jd=n(hm,"multinomial sampling"),hm.forEach(o),Ld=n(Re," by calling "),Ko=a(Re,"CODE",{});var fm=r(Ko);Md=n(fm,"_sample()"),fm.forEach(o),wd=n(Re,"if "),Zo=a(Re,"CODE",{});var bm=r(Zo);Td=n(bm,"num_beams=1"),bm.forEach(o),Ed=n(Re,`
...
post`),Pm.forEach(o),kc=n(Is,"."),Is.forEach(o),vc=d(P),us=a(P,"P",{});var Nm=r(us);yc=n(Nm,"Examples:"),Nm.forEach(o),jc=d(P),g(Qt.$$.fragment,P),P.forEach(o),ve.forEach(o),this.h()},h(){c(p,"name","hf:doc:metadata"),c(p,"content",JSON.stringify(Km)),c(q,"id","generation"),c(q,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(q,"href","#generation"),c(L,"class","relative group"),c(tn,"href","/docs/transformers/main/en/main_classes/text_generation#transformers.generation_utils.GenerationMixin.generate"),c(nn,"href","/docs/transformers/main/en/main_classes/text_generation#transformers.generation_utils.GenerationMixin"),c(on,"href","/docs/transformers/main/en/main_classes/text_generation#transformers.generation_tf_utils.TFGenerationMixin.generate"),c(sn,"href","/docs/transformers/main/en/main_classes/text_generation#transformers.generation_tf_utils.TFGenerationMixin"),c(an,"href","/docs/transformers/main/en/main_classes/text_generation#transformers.generation_flax_utils.FlaxGenerationMixin.generate"),c(rn,"href","/docs/transformers/main/en/main_classes/text_generation#transformers.generation_flax_utils.FlaxGenerationMixin"),c(Xe,"id","transformers.generation_utils.GenerationMixin"),c(Xe,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(Xe,"href","#transformers.generation_utils.GenerationMixin"),c(Te,"class","relative group"),c(ln,"href","/docs/transformers/main/en/main_classes/model#transformers.PreTrainedModel"),c(dn,"href","/docs/transformers/main/en/main_classes/text_generation#transformers.generation_utils.GenerationMixin.generate"),c(cn,"href","/docs/transformers/main/en/main_classes/text_generation#transformers.generation_utils.GenerationMixin.greedy_search"),c(pn,"href","/docs/transformers/main/en/main_classes/text_generation#transformers.generation_utils.GenerationMixin.sample"),c(mn,"href","/docs/transformers/main/en/main_classes/text_generation#transformers.generation_utils.GenerationMixin.beam_search"),c(gn,"href","/docs/transformers/main/en/main_classes/text_generation#transformers.generation_utils.GenerationMixin.beam_sample"),c(un,"href","/docs/transformers/main/en/main_classes/text_generation#transformers.generation_utils.GenerationMixin.group_beam_search"),c(_n,"href","/docs/transformers/main/en/main_classes/text_generation#transformers.generation_utils.GenerationMixin.constrained_beam_search"),c(hn,"href","/docs/transformers/main/en/main_classes/text_generation#transformers.generation_utils.GenerationMixin.greedy_search"),c(fn,"href","/docs/transformers/main/en/main_classes/text_generation#transformers.generation_utils.GenerationMixin.sample"),c(bn,"href","/docs/transformers/main/en/main_classes/text_generation#transformers.generation_utils.GenerationMixin.beam_search"),c(xn,"href","/docs/transformers/main/en/main_classes/text_generation#transformers.generation_utils.GenerationMixin.beam_sample"),c(kn,"href","/docs/transformers/main/en/main_classes/text_generation#transformers.generation_utils.GenerationMixin.group_beam_search"),c(vn,"href","/docs/transformers/main/en/main_classes/text_generation#transformers.generation_utils.GenerationMixin.constrained_beam_search"),c(ut,"href","https://huggingface.co/blog/how-to-generate"),c(ut,"rel","nofollow"),c(b,"class","docstring"),c(ee,"class","docstring"),c(te,"class","docstring"),c(ne,"class","docstring"),c(oe,"class","docstring"),c(se,"class","docstring"),c(ae,"class","docstring"),c(k,"class","docstring"),c(Qe,"id","transformers.generation_tf_utils.TFGenerationMixin"),c(Qe,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(Qe,"href","#transformers.generation_tf_utils.TFGenerationMixin"),c(Ee,"class","relative group"),c(yn,"href","/docs/transformers/main/en/main_classes/model#transformers.TFPreTrainedModel"),c(It,"href","https://github.com/facebookresearch/XLM/blob/9e6f6814d17be4fe5b15f2e6c43eb2b2d76daeb4/src/model/transformer.py#L529"),c(It,"rel","nofollow"),c(jn,"href","/docs/transformers/main/en/main_classes/configuration#transformers.PretrainedConfig"),c(Bt,"href","https://huggingface.co/blog/how-to-generate"),c(Bt,"rel","nofollow"),c(T,"class","docstring"),c(he,"class","docstring"),c(Ye,"id","transformers.generation_flax_utils.FlaxGenerationMixin"),c(Ye,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(Ye,"href","#transformers.generation_flax_utils.FlaxGenerationMixin"),c(Oe,"class","relative group"),c(Ln,"href","/docs/transformers/main/en/main_classes/model#transformers.FlaxPreTrainedModel"),c(Mn,"href","/docs/transformers/main/en/main_classes/text_generation#transformers.generation_flax_utils.FlaxGenerationMixin.generate"),c(Jt,"href","https://huggingface.co/blog/how-to-generate"),c(Jt,"rel","nofollow"),c(E,"class","docstring"),c(A,"class","docstring")},m(i,v){e(document.head,p),M(i,C,v),M(i,L,v),e(L,q),e(q,N),u(w,N,null),e(L,_e),e(L,D),e(D,O),M(i,I,v),M(i,G,v),e(G,S),e(G,x),e(x,ye),e(G,je),M(i,xe,v),M(i,ke,v),e(ke,Le),e(Le,Bs),e(Le,tn),e(tn,Hs),e(Le,Rs),e(Le,nn),e(nn,Us),e(Le,Vs),e(ke,Ks),e(ke,Me),e(Me,Zs),e(Me,on),e(on,Xs),e(Me,Js),e(Me,sn),e(sn,Qs),e(Me,Ys),e(ke,ea),e(ke,we),e(we,ta),e(we,an),e(an,na),e(we,oa),e(we,rn),e(rn,sa),e(we,aa),M(i,hs,v),M(i,Te,v),e(Te,Xe),e(Xe,$n),u(lt,$n,null),e(Te,ra),e(Te,Fn),e(Fn,ia),M(i,fs,v),M(i,k,v),u(dt,k,null),e(k,la),e(k,ct),e(ct,da),e(ct,ln),e(ln,ca),e(ct,pa),e(k,ma),e(k,pt),e(pt,ga),e(pt,dn),e(dn,ua),e(pt,_a),e(k,ha),e(k,$),e($,W),e(W,An),e(An,fa),e(W,ba),e(W,cn),e(cn,xa),e(W,ka),e(W,zn),e(zn,va),e(W,ya),e(W,Pn),e(Pn,ja),e(W,La),e($,Ma),e($,B),e(B,Nn),e(Nn,wa),e(B,Ta),e(B,pn),e(pn,Ea),e(B,Oa),e(B,Dn),e(Dn,qa),e(B,Ga),e(B,Cn),e(Cn,Sa),e(B,$a),e($,Fa),e($,H),e(H,In),e(In,Aa),e(H,za),e(H,mn),e(mn,Pa),e(H,Na),e(H,Wn),e(Wn,Da),e(H,Ca),e(H,Bn),e(Bn,Ia),e(H,Wa),e($,Ba),e($,R),e(R,Hn),e(Hn,Ha),e(R,Ra),e(R,gn),e(gn,Ua),e(R,Va),e(R,Rn),e(Rn,Ka),e(R,Za),e(R,Un),e(Un,Xa),e(R,Ja),e($,Qa),e($,U),e(U,Vn),e(Vn,Ya),e(U,er),e(U,un),e(un,tr),e(U,nr),e(U,Kn),e(Kn,or),e(U,sr),e(U,Zn),e(Zn,ar),e(U,rr),e($,ir),e($,V),e(V,Xn),e(Xn,lr),e(V,dr),e(V,_n),e(_n,cr),e(V,pr),e(V,Jn),e(Jn,mr),e(V,gr),e(V,Qn),e(Qn,ur),e(V,_r),e(k,hr),e(k,b),u(mt,b,null),e(b,fr),e(b,Yn),e(Yn,br),e(b,xr),e(b,F),e(F,K),e(K,eo),e(eo,kr),e(K,vr),e(K,hn),e(hn,yr),e(K,jr),e(K,to),e(to,Lr),e(K,Mr),e(K,no),e(no,wr),e(K,Tr),e(F,Er),e(F,Z),e(Z,oo),e(oo,Or),e(Z,qr),e(Z,fn),e(fn,Gr),e(Z,Sr),e(Z,so),e(so,$r),e(Z,Fr),e(Z,ao),e(ao,Ar),e(Z,zr),e(F,Pr),e(F,X),e(X,ro),e(ro,Nr),e(X,Dr),e(X,bn),e(bn,Cr),e(X,Ir),e(X,io),e(io,Wr),e(X,Br),e(X,lo),e(lo,Hr),e(X,Rr),e(F,Ur),e(F,J),e(J,co),e(co,Vr),e(J,Kr),e(J,xn),e(xn,Zr),e(J,Xr),e(J,po),e(po,Jr),e(J,Qr),e(J,mo),e(mo,Yr),e(J,ei),e(F,ti),e(F,Q),e(Q,go),e(go,ni),e(Q,oi),e(Q,kn),e(kn,si),e(Q,ai),e(Q,uo),e(uo,ri),e(Q,ii),e(Q,_o),e(_o,li),e(Q,di),e(F,ci),e(F,Y),e(Y,ho),e(ho,pi),e(Y,mi),e(Y,vn),e(vn,gi),e(Y,ui),e(Y,fo),e(fo,_i),e(Y,hi),e(Y,bo),e(bo,fi),e(Y,bi),e(b,xi),u(Je,b,null),e(b,ki),e(b,gt),e(gt,vi),e(gt,ut),e(ut,yi),e(gt,ji),e(b,Li),e(b,xo),e(xo,Mi),e(b,wi),e(b,ko),e(ko,Ti),e(b,Ei),u(_t,b,null),e(b,Oi),e(b,vo),e(vo,qi),e(b,Gi),u(ht,b,null),e(b,Si),e(b,yo),e(yo,$i),e(b,Fi),u(ft,b,null),e(k,Ai),e(k,ee),u(bt,ee,null),e(ee,zi),e(ee,xt),e(xt,Pi),e(xt,jo),e(jo,Ni),e(xt,Di),e(ee,Ci),e(ee,Lo),e(Lo,Ii),e(ee,Wi),u(kt,ee,null),e(k,Bi),e(k,te),u(vt,te,null),e(te,Hi),e(te,yt),e(yt,Ri),e(yt,Mo),e(Mo,Ui),e(yt,Vi),e(te,Ki),e(te,wo),e(wo,Zi),e(te,Xi),u(jt,te,null),e(k,Ji),e(k,ne),u(Lt,ne,null),e(ne,Qi),e(ne,Mt),e(Mt,Yi),e(Mt,To),e(To,el),e(Mt,tl),e(ne,nl),e(ne,Eo),e(Eo,ol),e(ne,sl),u(wt,ne,null),e(k,al),e(k,oe),u(Tt,oe,null),e(oe,rl),e(oe,Et),e(Et,il),e(Et,Oo),e(Oo,ll),e(Et,dl),e(oe,cl),e(oe,qo),e(qo,pl),e(oe,ml),u(Ot,oe,null),e(k,gl),e(k,se),u(qt,se,null),e(se,ul),e(se,Gt),e(Gt,_l),e(Gt,Go),e(Go,hl),e(Gt,fl),e(se,bl),e(se,So),e(So,xl),e(se,kl),u(St,se,null),e(k,vl),e(k,ae),u($t,ae,null),e(ae,yl),e(ae,Ft),e(Ft,jl),e(Ft,$o),e($o,Ll),e(Ft,Ml),e(ae,wl),e(ae,Fo),e(Fo,Tl),e(ae,El),u(At,ae,null),M(i,bs,v),M(i,Ee,v),e(Ee,Qe),e(Qe,Ao),u(zt,Ao,null),e(Ee,Ol),e(Ee,zo),e(zo,ql),M(i,xs,v),M(i,he,v),u(Pt,he,null),e(he,Gl),e(he,Nt),e(Nt,Sl),e(Nt,yn),e(yn,$l),e(Nt,Fl),e(he,Al),e(he,T),u(Dt,T,null),e(T,zl),e(T,Po),e(Po,Pl),e(T,Nl),e(T,Ct),e(Ct,Dl),e(Ct,It),e(It,Cl),e(Ct,Il),e(T,Wl),e(T,fe),e(fe,Bl),e(fe,No),e(No,Hl),e(fe,Rl),e(fe,Do),e(Do,Ul),e(fe,Vl),e(fe,jn),e(jn,Kl),e(fe,Zl),e(T,Xl),e(T,Wt),e(Wt,Jl),e(Wt,Bt),e(Bt,Ql),e(Wt,Yl),e(T,ed),e(T,Co),e(Co,td),e(T,nd),u(Ht,T,null),M(i,ks,v),M(i,Oe,v),e(Oe,Ye),e(Ye,Io),u(Rt,Io,null),e(Oe,od),e(Oe,Wo),e(Wo,sd),M(i,vs,v),M(i,A,v),u(Ut,A,null),e(A,ad),e(A,Vt),e(Vt,rd),e(Vt,Ln),e(Ln,id),e(Vt,ld),e(A,dd),e(A,Kt),e(Kt,cd),e(Kt,Mn),e(Mn,pd),e(Kt,md),e(A,gd),e(A,qe),e(qe,re),e(re,Bo),e(Bo,ud),e(re,_d),e(re,Ho),e(Ho,hd),e(re,fd),e(re,Ro),e(Ro,bd),e(re,xd),e(re,Uo),e(Uo,kd),e(re,vd),e(qe,yd),e(qe,ie),e(ie,Vo),e(Vo,jd),e(ie,Ld),e(ie,Ko),e(Ko,Md),e(ie,wd),e(ie,Zo),e(Zo,Td),e(ie,Ed),e(ie,Xo),e(Xo,Od),e(ie,qd),e(qe,Gd),e(qe,le),e(le,Jo),e(Jo,Sd),e(le,$d),e(le,Qo),e(Qo,Fd),e(le,Ad),e(le,Yo),e(Yo,zd),e(le,Pd),e(le,es),e(es,Nd),e(le,Dd),e(A,Cd),e(A,E),u(Zt,E,null),e(E,Id),e(E,ts),e(ts,Wd),e(E,Bd),e(E,Ge),e(Ge,de),e(de,ns),e(ns,Hd),e(de,Rd),e(de,os),e(os,Ud),e(de,Vd),e(de,ss),e(ss,Kd),e(de,Zd),e(de,as),e(as,Xd),e(de,Jd),e(Ge,Qd),e(Ge,ce),e(ce,rs),e(rs,Yd),e(ce,ec),e(ce,is),e(is,tc),e(ce,nc),e(ce,ls),e(ls,oc),e(ce,sc),e(ce,ds),e(ds,ac),e(ce,rc),e(Ge,ic),e(Ge,pe),e(pe,cs),e(cs,lc),e(pe,dc),e(pe,ps),e(ps,cc),e(pe,pc),e(pe,ms),e(ms,mc),e(pe,gc),e(pe,gs),e(gs,uc),e(pe,_c),e(E,hc),u(et,E,null),e(E,fc),e(E,Xt),e(Xt,bc),e(Xt,Jt),e(Jt,xc),e(Xt,kc),e(E,vc),e(E,us),e(us,yc),e(E,jc),u(Qt,E,null),ys=!0},p(i,[v]){const Yt={};v&2&&(Yt.$$scope={dirty:v,ctx:i}),Je.$set(Yt);const _s={};v&2&&(_s.$$scope={dirty:v,ctx:i}),et.$set(_s)},i(i){ys||(_(w.$$.fragment,i),_(lt.$$.fragment,i),_(dt.$$.fragment,i),_(mt.$$.fragment,i),_(Je.$$.fragment,i),_(_t.$$.fragment,i),_(ht.$$.fragment,i),_(ft.$$.fragment,i),_(bt.$$.fragment,i),_(kt.$$.fragment,i),_(vt.$$.fragment,i),_(jt.$$.fragment,i),_(Lt.$$.fragment,i),_(wt.$$.fragment,i),_(Tt.$$.fragment,i),_(Ot.$$.fragment,i),_(qt.$$.fragment,i),_(St.$$.fragment,i),_($t.$$.fragment,i),_(At.$$.fragment,i),_(zt.$$.fragment,i),_(Pt.$$.fragment,i),_(Dt.$$.fragment,i),_(Ht.$$.fragment,i),_(Rt.$$.fragment,i),_(Ut.$$.fragment,i),_(Zt.$$.fragment,i),_(et.$$.fragment,i),_(Qt.$$.fragment,i),ys=!0)},o(i){h(w.$$.fragment,i),h(lt.$$.fragment,i),h(dt.$$.fragment,i),h(mt.$$.fragment,i),h(Je.$$.fragment,i),h(_t.$$.fragment,i),h(ht.$$.fragment,i),h(ft.$$.fragment,i),h(bt.$$.fragment,i),h(kt.$$.fragment,i),h(vt.$$.fragment,i),h(jt.$$.fragment,i),h(Lt.$$.fragment,i),h(wt.$$.fragment,i),h(Tt.$$.fragment,i),h(Ot.$$.fragment,i),h(qt.$$.fragment,i),h(St.$$.fragment,i),h($t.$$.fragment,i),h(At.$$.fragment,i),h(zt.$$.fragment,i),h(Pt.$$.fragment,i),h(Dt.$$.fragment,i),h(Ht.$$.fragment,i),h(Rt.$$.fragment,i),h(Ut.$$.fragment,i),h(Zt.$$.fragment,i),h(et.$$.fragment,i),h(Qt.$$.fragment,i),ys=!1},d(i){o(p),i&&o(C),i&&o(L),f(w),i&&o(I),i&&o(G),i&&o(xe),i&&o(ke),i&&o(hs),i&&o(Te),f(lt),i&&o(fs),i&&o(k),f(dt),f(mt),f(Je),f(_t),f(ht),f(ft),f(bt),f(kt),f(vt),f(jt),f(Lt),f(wt),f(Tt),f(Ot),f(qt),f(St),f($t),f(At),i&&o(bs),i&&o(Ee),f(zt),i&&o(xs),i&&o(he),f(Pt),f(Dt),f(Ht),i&&o(ks),i&&o(Oe),f(Rt),i&&o(vs),i&&o(A),f(Ut),f(Zt),f(et),f(Qt)}}}const Km={local:"generation",sections:[{local:"transformers.generation_utils.GenerationMixin",title:"GenerationMixin"},{local:"transformers.generation_tf_utils.TFGenerationMixin",title:"TFGenerationMixin"},{local:"transformers.generation_flax_utils.FlaxGenerationMixin",title:"FlaxGenerationMixin"}],title:"Generation"};function Zm(en){return Hm(()=>{new URLSearchParams(window.location.search).get("fw")}),[]}class tg extends Cm{constructor(p){super();Im(this,p,Zm,Vm,Wm,{})}}export{tg as default,Km as metadata};
