...
<span class="hljs-keyword">assert</span> config.output_attentions == <span class="hljs-literal">True</span>
<span class="hljs-keyword">assert</span> unused_kwargs == {<span class="hljs-string">&quot;foo&quot;</span>: <span class="hljs-literal">False</span>}`}}),{c(){f=r("p"),b=o("Examples:"),p=d(),v(u.$$.fragment)},l(c){f=a(c,"P",{});var _=s(f);b=n(_,"Examples:"),_.forEach(t),p=l(c),w(u.$$.fragment,c)},m(c,_){x(c,f,_),e(f,b),x(c,p,_),$(u,c,_),E=!0},p:Ps,i(c){E||(k(u.$$.fragment,c),E=!0)},o(c){P(u.$$.fragment,c),E=!1},d(c){c&&t(f),c&&t(p),C(u,c)}}}function Ss(z){let f,b;return{c(){f=r("p"),b=o("This API is experimental and may have some slight breaking changes in the next releases.")},l(p){f=a(p,"P",{});var u=s(f);b=n(u,"This API is experimental and may have some slight breaking changes in the next releases."),u.forEach(t)},m(p,u){x(p,f,u),e(f,b)},d(p){p&&t(f)}}}function Fs(z){let f,b,p,u,E,c,_,q,Do,ao,H,jo,Ge,zo,Ao,so,D,Oo,dt,qo,So,lt,Fo,Io,ct,Lo,No,ft,Wo,Mo,io,U,G,mt,$e,Bo,ht,Vo,lo,m,ke,Uo,pt,Ro,Jo,X,Ho,ut,Go,Xo,S,W,gt,Ko,Qo,_t,Yo,Zo,Xe,en,tn,on,j,bt,nn,rn,yt,an,sn,Ke,dn,ln,Qe,cn,fn,Ye,mn,hn,pn,K,vt,un,gn,wt,_n,bn,yn,Q,$t,vn,wn,kt,$n,kn,Pn,Pt,Cn,En,F,Y,Ct,xn,Tn,Et,Dn,jn,zn,Z,xt,An,On,Tt,qn,Sn,Fn,ee,Dt,In,Ln,jt,Nn,Wn,Mn,te,zt,Bn,Vn,At,Un,Rn,Jn,M,Pe,Hn,Ce,Gn,Ot,Xn,Kn,Qn,oe,Yn,ne,Ee,Zn,I,er,qt,tr,or,St,nr,rr,Ft,ar,sr,ir,re,xe,dr,Te,lr,Ze,cr,fr,mr,ae,De,hr,je,pr,et,ur,gr,_r,A,ze,br,Ae,yr,tt,vr,wr,$r,se,kr,ie,Pr,de,Oe,Cr,L,Er,It,xr,Tr,ot,Dr,jr,Lt,zr,Ar,Or,B,qe,qr,Se,Sr,Nt,Fr,Ir,Lr,le,Nr,ce,Fe,Wr,R,Mr,Wt,Br,Vr,nt,Ur,Rr,Jr,fe,Ie,Hr,Mt,Gr,Xr,me,Le,Kr,Bt,Qr,Yr,he,Ne,Zr,Vt,ea,ta,pe,We,oa,Ut,na,ra,ue,Me,aa,Be,sa,Rt,ia,da,la,O,Ve,ca,Ue,fa,Jt,ma,ha,pa,J,ua,Ht,ga,_a,Gt,ba,ya,va,Xt,wa,co;return c=new $s({}),$e=new $s({}),ke=new T({props:{name:"class transformers.PretrainedConfig",anchor:"transformers.PretrainedConfig",parameters:[{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.PretrainedConfig.name_or_path",description:`<strong>name_or_path</strong> (<code>str</code>, <em>optional</em>, defaults to <code>&quot;&quot;</code>) &#x2014;
...
`),ft=r("code"),Wo=o("vocab_size"),Mo=o("."),io=d(),U=r("h2"),G=r("a"),mt=r("span"),v($e.$$.fragment),Bo=d(),ht=r("span"),Vo=o("PretrainedConfig"),lo=d(),m=r("div"),v(ke.$$.fragment),Uo=d(),pt=r("p"),Ro=o(`Base class for all configuration classes. Handles a few parameters common to all models\u2019 configurations as well as
...
model.`),Mn=d(),te=r("li"),zt=r("strong"),Bn=o("num_hidden_layers"),Vn=o(" ("),At=r("code"),Un=o("int"),Rn=o(") \u2014 The number of blocks in the model."),Jn=d(),M=r("div"),v(Pe.$$.fragment),Hn=d(),Ce=r("p"),Gn=o(`Upload the configuration file to the \u{1F917} Model Hub while synchronizing a local clone of the repo in
...
the library are already mapped with `),Nt=r("code"),Fr=o("AutoConfig"),Ir=o("."),Lr=d(),v(le.$$.fragment),Nr=d(),ce=r("div"),v(Fe.$$.fragment),Wr=d(),R=r("p"),Mr=o("Save a configuration object to the directory "),Wt=r("code"),Br=o("save_directory"),Vr=o(`, so that it can be re-loaded using the
`),nt=r("a"),Ur=o("from_pretrained()"),Rr=o(" class method."),Jr=d(),fe=r("div"),v(Ie.$$.fragment),Hr=d(),Mt=r("p"),Gr=o("Serializes this instance to a Python dictionary."),Xr=d(),me=r("div"),v(Le.$$.fragment),Kr=d(),Bt=r("p"),Qr=o(`Removes all attributes from config which correspond to the default config attributes for better readability and
serializes to a Python dictionary.`),Yr=d(),he=r("div"),v(Ne.$$.fragment),Zr=d(),Vt=r("p"),ea=o("Save this instance to a JSON file."),ta=d(),pe=r("div"),v(We.$$.fragment),oa=d(),Ut=r("p"),na=o("Serializes this instance to a JSON string."),ra=d(),ue=r("div"),v(Me.$$.fragment),aa=d(),Be=r("p"),sa=o("Updates attributes of this class with attributes from "),Rt=r("code"),ia=o("config_dict"),da=o("."),la=d(),O=r("div"),v(Ve.$$.fragment),ca=d(),Ue=r("p"),fa=o("Updates attributes of this class with attributes from "),Jt=r("code"),ma=o("update_str"),ha=o("."),pa=d(),J=r("p"),ua=o("The expected format is ints, floats and strings as is, and for booleans use "),Ht=r("code"),ga=o("true"),_a=o(" or "),Gt=r("code"),ba=o("false"),ya=o(`. For example:
\u201Cn_embd=10,resid_pdrop=0.2,scale_attn_weights=false,summary_type=cls_index\u201D`),va=d(),Xt=r("p"),wa=o("The keys to change have to already exist in the config object."),this.h()},l(i){const y=Ds('[data-svelte="svelte-1phssyn"]',document.head);f=a(y,"META",{name:!0,content:!0}),y.forEach(t),b=l(i),p=a(i,"H1",{class:!0});var Re=s(p);u=a(Re,"A",{id:!0,class:!0,href:!0});var Kt=s(u);E=a(Kt,"SPAN",{});var Qt=s(E);w(c.$$.fragment,Qt),Qt.forEach(t),Kt.forEach(t),_=l(Re),q=a(Re,"SPAN",{});var Yt=s(q);Do=n(Yt,"Configuration"),Yt.forEach(t),Re.forEach(t),ao=l(i),H=a(i,"P",{});var Je=s(H);jo=n(Je,"The base class "),Ge=a(Je,"A",{href:!0});var ka=s(Ge);zo=n(ka,"PretrainedConfig"),ka.forEach(t),Ao=n(Je,` implements the common methods for loading/saving a configuration
either from a local file or directory, or from a pretrained model configuration provided by the library (downloaded
...
`),ft=a(V,"CODE",{});var xa=s(ft);Wo=n(xa,"vocab_size"),xa.forEach(t),Mo=n(V,"."),V.forEach(t),io=l(i),U=a(i,"H2",{class:!0});var fo=s(U);G=a(fo,"A",{id:!0,class:!0,href:!0});var Ta=s(G);mt=a(Ta,"SPAN",{});var Da=s(mt);w($e.$$.fragment,Da),Da.forEach(t),Ta.forEach(t),Bo=l(fo),ht=a(fo,"SPAN",{});var ja=s(ht);Vo=n(ja,"PretrainedConfig"),ja.forEach(t),fo.forEach(t),lo=l(i),m=a(i,"DIV",{class:!0});var h=s(m);w(ke.$$.fragment,h),Uo=l(h),pt=a(h,"P",{});var za=s(pt);Ro=n(za,`Base class for all configuration classes. Handles a few parameters common to all models\u2019 configurations as well as
...
outputs of the model during inference.`),Zt.forEach(t),yn=l(ge),Q=a(ge,"LI",{});var eo=s(Q);$t=a(eo,"STRONG",{});var Va=s($t);vn=n(Va,"attribute_map"),Va.forEach(t),wn=n(eo," ("),kt=a(eo,"CODE",{});var Ua=s(kt);$n=n(Ua,"Dict[str, str]"),Ua.forEach(t),kn=n(eo,`) \u2014 A dict that maps model specific attribute names to the standardized
naming of attributes.`),eo.forEach(t),ge.forEach(t),Pn=l(h),Pt=a(h,"P",{});var Ra=s(Pt);Cn=n(Ra,"Common attributes (present in all subclasses):"),Ra.forEach(t),En=l(h),F=a(h,"UL",{});var _e=s(F);Y=a(_e,"LI",{});var to=s(Y);Ct=a(to,"STRONG",{});var Ja=s(Ct);xn=n(Ja,"vocab_size"),Ja.forEach(t),Tn=n(to," ("),Et=a(to,"CODE",{});var Ha=s(Et);Dn=n(Ha,"int"),Ha.forEach(t),jn=n(to,`) \u2014 The number of tokens in the vocabulary, which is also the first dimension of the
