import{S as Es,i as xs,s as Ts,e as r,k as d,w as v,t as o,M as Ds,c as a,d as t,m as l,a as s,x as w,h as n,b as g,G as e,g as x,y as $,q as k,o as P,B as C,v as js,L as Ps}from"../../chunks/vendor-hf-doc-builder.js";import{T as $a}from"../../chunks/Tip-hf-doc-builder.js";import{D as T}from"../../chunks/Docstring-hf-doc-builder.js";import{C as Cs}from"../../chunks/CodeBlock-hf-doc-builder.js";import{I as $s}from"../../chunks/IconCopyLink-hf-doc-builder.js";import{E as ks}from"../../chunks/ExampleCodeBlock-hf-doc-builder.js";function zs(z){let f,b,p,u,E;return{c(){f=r("p"),b=o(`A configuration file can be loaded and saved to disk. Loading the configuration file and using this file to
...
<span class="hljs-keyword">assert</span> config.output_attentions == <span class="hljs-literal">True</span>
<span class="hljs-keyword">assert</span> unused_kwargs == {<span class="hljs-string">&quot;foo&quot;</span>: <span class="hljs-literal">False</span>}`}}),{c(){f=r("p"),b=o("Examples:"),p=d(),v(u.$$.fragment)},l(c){f=a(c,"P",{});var _=s(f);b=n(_,"Examples:"),_.forEach(t),p=l(c),w(u.$$.fragment,c)},m(c,_){x(c,f,_),e(f,b),x(c,p,_),$(u,c,_),E=!0},p:Ps,i(c){E||(k(u.$$.fragment,c),E=!0)},o(c){P(u.$$.fragment,c),E=!1},d(c){c&&t(f),c&&t(p),C(u,c)}}}function Ss(z){let f,b;return{c(){f=r("p"),b=o("This API is experimental and may have some slight breaking changes in the next releases.")},l(p){f=a(p,"P",{});var u=s(f);b=n(u,"This API is experimental and may have some slight breaking changes in the next releases."),u.forEach(t)},m(p,u){x(p,f,u),e(f,b)},d(p){p&&t(f)}}}function Fs(z){let f,b,p,u,E,c,_,q,Do,ao,H,jo,Ge,zo,Ao,so,D,Oo,dt,qo,So,lt,Fo,Io,ct,Lo,No,ft,Wo,Mo,io,R,G,mt,$e,Vo,ht,Bo,lo,m,ke,Ro,pt,Uo,Jo,X,Ho,ut,Go,Xo,S,W,gt,Ko,Qo,_t,Yo,Zo,Xe,en,tn,on,j,bt,nn,rn,yt,an,sn,Ke,dn,ln,Qe,cn,fn,Ye,mn,hn,pn,K,vt,un,gn,wt,_n,bn,yn,Q,$t,vn,wn,kt,$n,kn,Pn,Pt,Cn,En,F,Y,Ct,xn,Tn,Et,Dn,jn,zn,Z,xt,An,On,Tt,qn,Sn,Fn,ee,Dt,In,Ln,jt,Nn,Wn,Mn,te,zt,Vn,Bn,At,Rn,Un,Jn,M,Pe,Hn,Ce,Gn,Ot,Xn,Kn,Qn,oe,Yn,ne,Ee,Zn,I,er,qt,tr,or,St,nr,rr,Ft,ar,sr,ir,re,xe,dr,Te,lr,Ze,cr,fr,mr,ae,De,hr,je,pr,et,ur,gr,_r,A,ze,br,Ae,yr,tt,vr,wr,$r,se,kr,ie,Pr,de,Oe,Cr,L,Er,It,xr,Tr,ot,Dr,jr,Lt,zr,Ar,Or,V,qe,qr,Se,Sr,Nt,Fr,Ir,Lr,le,Nr,ce,Fe,Wr,U,Mr,Wt,Vr,Br,nt,Rr,Ur,Jr,fe,Ie,Hr,Mt,Gr,Xr,me,Le,Kr,Vt,Qr,Yr,he,Ne,Zr,Bt,ea,ta,pe,We,oa,Rt,na,ra,ue,Me,aa,Ve,sa,Ut,ia,da,la,O,Be,ca,Re,fa,Jt,ma,ha,pa,J,ua,Ht,ga,_a,Gt,ba,ya,va,Xt,wa,co;return c=new $s({}),$e=new $s({}),ke=new T({props:{name:"class transformers.PretrainedConfig",anchor:"transformers.PretrainedConfig",parameters:[{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.PretrainedConfig.name_or_path",description:`<strong>name_or_path</strong> (<code>str</code>, <em>optional</em>, defaults to <code>&quot;&quot;</code>) &#x2014;
...
Path to the JSON file containing the parameters.`,name:"json_file"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/configuration_utils.py#L714",returnDescription:`
...
`}}),Le=new T({props:{name:"to_diff_dict",anchor:"transformers.PretrainedConfig.to_diff_dict",parameters:[],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/configuration_utils.py#L742",returnDescription:`
<p>Dictionary of all the attributes that make up this configuration instance,</p>
`,returnType:`
<p><code>Dict[str, Any]</code></p>
...
`),ft=r("code"),Wo=o("vocab_size"),Mo=o("."),io=d(),R=r("h2"),G=r("a"),mt=r("span"),v($e.$$.fragment),Vo=d(),ht=r("span"),Bo=o("PretrainedConfig"),lo=d(),m=r("div"),v(ke.$$.fragment),Ro=d(),pt=r("p"),Uo=o(`Base class for all configuration classes. Handles a few parameters common to all models\u2019 configurations as well as
methods for loading/downloading/saving configurations.`),Jo=d(),v(X.$$.fragment),Ho=d(),ut=r("p"),Go=o("Class attributes (overridden by derived classes):"),Xo=d(),S=r("ul"),W=r("li"),gt=r("strong"),Ko=o("model_type"),Qo=o(" ("),_t=r("code"),Yo=o("str"),Zo=o(`) \u2014 An identifier for the model type, serialized into the JSON file, and used to recreate
...
`),Qe=r("a"),cn=o("EncoderDecoderConfig"),fn=o(" or "),Ye=r("a"),mn=o("~RagConfig"),hn=o("."),pn=d(),K=r("li"),vt=r("strong"),un=o("keys_to_ignore_at_inference"),gn=o(" ("),wt=r("code"),_n=o("List[str]"),bn=o(`) \u2014 A list of keys to ignore by default when looking at dictionary
...
model.`),Mn=d(),te=r("li"),zt=r("strong"),Vn=o("num_hidden_layers"),Bn=o(" ("),At=r("code"),Rn=o("int"),Un=o(") \u2014 The number of blocks in the model."),Jn=d(),M=r("div"),v(Pe.$$.fragment),Hn=d(),Ce=r("p"),Gn=o(`Upload the configuration file to the \u{1F917} Model Hub while synchronizing a local clone of the repo in
...
string, which can then be stored in the json format.`),ir=d(),re=r("div"),v(xe.$$.fragment),dr=d(),Te=r("p"),lr=o("Instantiates a "),Ze=r("a"),cr=o("PretrainedConfig"),fr=o(" from a Python dictionary of parameters."),mr=d(),ae=r("div"),v(De.$$.fragment),hr=d(),je=r("p"),pr=o("Instantiates a "),et=r("a"),ur=o("PretrainedConfig"),gr=o(" from the path to a JSON file of parameters."),_r=d(),A=r("div"),v(ze.$$.fragment),br=d(),Ae=r("p"),yr=o("Instantiate a "),tt=r("a"),vr=o("PretrainedConfig"),wr=o(" (or a derived class) from a pretrained model configuration."),$r=d(),v(se.$$.fragment),kr=d(),v(ie.$$.fragment),Pr=d(),de=r("div"),v(Oe.$$.fragment),Cr=d(),L=r("p"),Er=o("From a "),It=r("code"),xr=o("pretrained_model_name_or_path"),Tr=o(`, resolve to a dictionary of parameters, to be used for instantiating a
`),ot=r("a"),Dr=o("PretrainedConfig"),jr=o(" using "),Lt=r("code"),zr=o("from_dict"),Ar=o("."),Or=d(),V=r("div"),v(qe.$$.fragment),qr=d(),Se=r("p"),Sr=o(`Register this class with a given auto class. This should only be used for custom configurations as the ones in
the library are already mapped with `),Nt=r("code"),Fr=o("AutoConfig"),Ir=o("."),Lr=d(),v(le.$$.fragment),Nr=d(),ce=r("div"),v(Fe.$$.fragment),Wr=d(),U=r("p"),Mr=o("Save a configuration object to the directory "),Wt=r("code"),Vr=o("save_directory"),Br=o(`, so that it can be re-loaded using the
`),nt=r("a"),Rr=o("from_pretrained()"),Ur=o(" class method."),Jr=d(),fe=r("div"),v(Ie.$$.fragment),Hr=d(),Mt=r("p"),Gr=o("Serializes this instance to a Python dictionary."),Xr=d(),me=r("div"),v(Le.$$.fragment),Kr=d(),Vt=r("p"),Qr=o(`Removes all attributes from config which correspond to the default config attributes for better readability and
serializes to a Python dictionary.`),Yr=d(),he=r("div"),v(Ne.$$.fragment),Zr=d(),Bt=r("p"),ea=o("Save this instance to a JSON file."),ta=d(),pe=r("div"),v(We.$$.fragment),oa=d(),Rt=r("p"),na=o("Serializes this instance to a JSON string."),ra=d(),ue=r("div"),v(Me.$$.fragment),aa=d(),Ve=r("p"),sa=o("Updates attributes of this class with attributes from "),Ut=r("code"),ia=o("config_dict"),da=o("."),la=d(),O=r("div"),v(Be.$$.fragment),ca=d(),Re=r("p"),fa=o("Updates attributes of this class with attributes from "),Jt=r("code"),ma=o("update_str"),ha=o("."),pa=d(),J=r("p"),ua=o("The expected format is ints, floats and strings as is, and for booleans use "),Ht=r("code"),ga=o("true"),_a=o(" or "),Gt=r("code"),ba=o("false"),ya=o(`. For example:
...
`),Qe=a(N,"A",{href:!0});var Na=s(Qe);cn=n(Na,"EncoderDecoderConfig"),Na.forEach(t),fn=n(N," or "),Ye=a(N,"A",{href:!0});var Wa=s(Ye);mn=n(Wa,"~RagConfig"),Wa.forEach(t),hn=n(N,"."),N.forEach(t),pn=l(ge),K=a(ge,"LI",{});var Zt=s(K);vt=a(Zt,"STRONG",{});var Ma=s(vt);un=n(Ma,"keys_to_ignore_at_inference"),Ma.forEach(t),gn=n(Zt," ("),wt=a(Zt,"CODE",{});var Va=s(wt);_n=n(Va,"List[str]"),Va.forEach(t),bn=n(Zt,`) \u2014 A list of keys to ignore by default when looking at dictionary
outputs of the model during inference.`),Zt.forEach(t),yn=l(ge),Q=a(ge,"LI",{});var eo=s(Q);$t=a(eo,"STRONG",{});var Ba=s($t);vn=n(Ba,"attribute_map"),Ba.forEach(t),wn=n(eo," ("),kt=a(eo,"CODE",{});var Ra=s(kt);$n=n(Ra,"Dict[str, str]"),Ra.forEach(t),kn=n(eo,`) \u2014 A dict that maps model specific attribute names to the standardized
...
serializes to a Python dictionary.`),ps.forEach(t),ko.forEach(t),Yr=l(h),he=a(h,"DIV",{class:!0});var Po=s(he);w(Ne.$$.fragment,Po),Zr=l(Po),Bt=a(Po,"P",{});var us=s(Bt);ea=n(us,"Save this instance to a JSON file."),us.forEach(t),Po.forEach(t),ta=l(h),pe=a(h,"DIV",{class:!0});var Co=s(pe);w(We.$$.fragment,Co),oa=l(Co),Rt=a(Co,"P",{});var gs=s(Rt);na=n(gs,"Serializes this instance to a JSON string."),gs.forEach(t),Co.forEach(t),ra=l(h),ue=a(h,"DIV",{class:!0});var Eo=s(ue);w(Me.$$.fragment,Eo),aa=l(Eo),Ve=a(Eo,"P",{});var xo=s(Ve);sa=n(xo,"Updates attributes of this class with attributes from "),Ut=a(xo,"CODE",{});var _s=s(Ut);ia=n(_s,"config_dict"),_s.forEach(t),da=n(xo,"."),xo.forEach(t),Eo.forEach(t),la=l(h),O=a(h,"DIV",{class:!0});var we=s(O);w(Be.$$.fragment,we),ca=l(we),Re=a(we,"P",{});var To=s(Re);fa=n(To,"Updates attributes of this class with attributes from "),Jt=a(To,"CODE",{});var bs=s(Jt);ma=n(bs,"update_str"),bs.forEach(t),ha=n(To,"."),To.forEach(t),pa=l(we),J=a(we,"P",{});var it=s(J);ua=n(it,"The expected format is ints, floats and strings as is, and for booleans use "),Ht=a(it,"CODE",{});var ys=s(Ht);ga=n(ys,"true"),ys.forEach(t),_a=n(it," or "),Gt=a(it,"CODE",{});var vs=s(Gt);ba=n(vs,"false"),vs.forEach(t),ya=n(it,`. For example:
\u201Cn_embd=10,resid_pdrop=0.2,scale_attn_weights=false,summary_type=cls_index\u201D`),it.forEach(t),va=l(we),Xt=a(we,"P",{});var ws=s(Xt);wa=n(ws,"The keys to change have to already exist in the config object."),ws.forEach(t),we.forEach(t),h.forEach(t),this.h()},h(){g(f,"name","hf:doc:metadata"),g(f,"content",JSON.stringify(Is)),g(u,"id","configuration"),g(u,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),g(u,"href","#configuration"),g(p,"class","relative group"),g(Ge,"href","/docs/transformers/main/en/main_classes/configuration#transformers.PretrainedConfig"),g(G,"id","transformers.PretrainedConfig"),g(G,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),g(G,"href","#transformers.PretrainedConfig"),g(R,"class","relative group"),g(Xe,"href","/docs/transformers/main/en/model_doc/auto#transformers.AutoConfig"),g(Ke,"href","/docs/transformers/main/en/main_classes/configuration#transformers.PretrainedConfig"),g(Qe,"href","/docs/transformers/main/en/model_doc/encoder-decoder#transformers.EncoderDecoderConfig"),g(Ye,"href","/docs/transformers/main/en/model_doc/rag#transformers.RagConfig"),g(M,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),g(ne,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),g(Ze,"href","/docs/transformers/main/en/main_classes/configuration#transformers.PretrainedConfig"),g(re,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),g(et,"href","/docs/transformers/main/en/main_classes/configuration#transformers.PretrainedConfig"),g(ae,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),g(tt,"href","/docs/transformers/main/en/main_classes/configuration#transformers.PretrainedConfig"),g(A,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),g(ot,"href","/docs/transformers/main/en/main_classes/configuration#transformers.PretrainedConfig"),g(de,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),g(V,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),g(nt,"href","/docs/transformers/main/en/main_classes/configuration#transformers.PretrainedConfig.from_pretrained"),g(ce,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),g(fe,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),g(me,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),g(he,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),g(pe,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),g(ue,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),g(O,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),g(m,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8")},m(i,y){e(document.head,f),x(i,b,y),x(i,p,y),e(p,u),e(u,E),$(c,E,null),e(p,_),e(p,q),e(q,Do),x(i,ao,y),x(i,H,y),e(H,jo),e(H,Ge),e(Ge,zo),e(H,Ao),x(i,so,y),x(i,D,y),e(D,Oo),e(D,dt),e(dt,qo),e(D,So),e(D,lt),e(lt,Fo),e(D,Io),e(D,ct),e(ct,Lo),e(D,No),e(D,ft),e(ft,Wo),e(D,Mo),x(i,io,y),x(i,R,y),e(R,G),e(G,mt),$($e,mt,null),e(R,Vo),e(R,ht),e(ht,Bo),x(i,lo,y),x(i,m,y),$(ke,m,null),e(m,Ro),e(m,pt),e(pt,Uo),e(m,Jo),$(X,m,null),e(m,Ho),e(m,ut),e(ut,Go),e(m,Xo),e(m,S),e(S,W),e(W,gt),e(gt,Ko),e(W,Qo),e(W,_t),e(_t,Yo),e(W,Zo),e(W,Xe),e(Xe,en),e(W,tn),e(S,on),e(S,j),e(j,bt),e(bt,nn),e(j,rn),e(j,yt),e(yt,an),e(j,sn),e(j,Ke),e(Ke,dn),e(j,ln),e(j,Qe),e(Qe,cn),e(j,fn),e(j,Ye),e(Ye,mn),e(j,hn),e(S,pn),e(S,K),e(K,vt),e(vt,un),e(K,gn),e(K,wt),e(wt,_n),e(K,bn),e(S,yn),e(S,Q),e(Q,$t),e($t,vn),e(Q,wn),e(Q,kt),e(kt,$n),e(Q,kn),e(m,Pn),e(m,Pt),e(Pt,Cn),e(m,En),e(m,F),e(F,Y),e(Y,Ct),e(Ct,xn),e(Y,Tn),e(Y,Et),e(Et,Dn),e(Y,jn),e(F,zn),e(F,Z),e(Z,xt),e(xt,An),e(Z,On),e(Z,Tt),e(Tt,qn),e(Z,Sn),e(F,Fn),e(F,ee),e(ee,Dt),e(Dt,In),e(ee,Ln),e(ee,jt),e(jt,Nn),e(ee,Wn),e(F,Mn),e(F,te),e(te,zt),e(zt,Vn),e(te,Bn),e(te,At),e(At,Rn),e(te,Un),e(m,Jn),e(m,M),$(Pe,M,null),e(M,Hn),e(M,Ce),e(Ce,Gn),e(Ce,Ot),e(Ot,Xn),e(Ce,Kn),e(M,Qn),$(oe,M,null),e(m,Yn),e(m,ne),$(Ee,ne,null),e(ne,Zn),e(ne,I),e(I,er),e(I,qt),e(qt,tr),e(I,or),e(I,St),e(St,nr),e(I,rr),e(I,Ft),e(Ft,ar),e(I,sr),e(m,ir),e(m,re),$(xe,re,null),e(re,dr),e(re,Te),e(Te,lr),e(Te,Ze),e(Ze,cr),e(Te,fr),e(m,mr),e(m,ae),$(De,ae,null),e(ae,hr),e(ae,je),e(je,pr),e(je,et),e(et,ur),e(je,gr),e(m,_r),e(m,A),$(ze,A,null),e(A,br),e(A,Ae),e(Ae,yr),e(Ae,tt),e(tt,vr),e(Ae,wr),e(A,$r),$(se,A,null),e(A,kr),$(ie,A,null),e(m,Pr),e(m,de),$(Oe,de,null),e(de,Cr),e(de,L),e(L,Er),e(L,It),e(It,xr),e(L,Tr),e(L,ot),e(ot,Dr),e(L,jr),e(L,Lt),e(Lt,zr),e(L,Ar),e(m,Or),e(m,V),$(qe,V,null),e(V,qr),e(V,Se),e(Se,Sr),e(Se,Nt),e(Nt,Fr),e(Se,Ir),e(V,Lr),$(le,V,null),e(m,Nr),e(m,ce),$(Fe,ce,null),e(ce,Wr),e(ce,U),e(U,Mr),e(U,Wt),e(Wt,Vr),e(U,Br),e(U,nt),e(nt,Rr),e(U,Ur),e(m,Jr),e(m,fe),$(Ie,fe,null),e(fe,Hr),e(fe,Mt),e(Mt,Gr),e(m,Xr),e(m,me),$(Le,me,null),e(me,Kr),e(me,Vt),e(Vt,Qr),e(m,Yr),e(m,he),$(Ne,he,null),e(he,Zr),e(he,Bt),e(Bt,ea),e(m,ta),e(m,pe),$(We,pe,null),e(pe,oa),e(pe,Rt),e(Rt,na),e(m,ra),e(m,ue),$(Me,ue,null),e(ue,aa),e(ue,Ve),e(Ve,sa),e(Ve,Ut),e(Ut,ia),e(Ve,da),e(m,la),e(m,O),$(Be,O,null),e(O,ca),e(O,Re),e(Re,fa),e(Re,Jt),e(Jt,ma),e(Re,ha),e(O,pa),e(O,J),e(J,ua),e(J,Ht),e(Ht,ga),e(J,_a),e(J,Gt),e(Gt,ba),e(J,ya),e(O,va),e(O,Xt),e(Xt,wa),co=!0},p(i,[y]){const Ue={};y&2&&(Ue.$$scope={dirty:y,ctx:i}),X.$set(Ue);const Kt={};y&2&&(Kt.$$scope={dirty:y,ctx:i}),oe.$set(Kt);const Qt={};y&2&&(Qt.$$scope={dirty:y,ctx:i}),se.$set(Qt);const Yt={};y&2&&(Yt.$$scope={dirty:y,ctx:i}),ie.$set(Yt);const Je={};y&2&&(Je.$$scope={dirty:y,ctx:i}),le.$set(Je)},i(i){co||(k(c.$$.fragment,i),k($e.$$.fragment,i),k(ke.$$.fragment,i),k(X.$$.fragment,i),k(Pe.$$.fragment,i),k(oe.$$.fragment,i),k(Ee.$$.fragment,i),k(xe.$$.fragment,i),k(De.$$.fragment,i),k(ze.$$.fragment,i),k(se.$$.fragment,i),k(ie.$$.fragment,i),k(Oe.$$.fragment,i),k(qe.$$.fragment,i),k(le.$$.fragment,i),k(Fe.$$.fragment,i),k(Ie.$$.fragment,i),k(Le.$$.fragment,i),k(Ne.$$.fragment,i),k(We.$$.fragment,i),k(Me.$$.fragment,i),k(Be.$$.fragment,i),co=!0)},o(i){P(c.$$.fragment,i),P($e.$$.fragment,i),P(ke.$$.fragment,i),P(X.$$.fragment,i),P(Pe.$$.fragment,i),P(oe.$$.fragment,i),P(Ee.$$.fragment,i),P(xe.$$.fragment,i),P(De.$$.fragment,i),P(ze.$$.fragment,i),P(se.$$.fragment,i),P(ie.$$.fragment,i),P(Oe.$$.fragment,i),P(qe.$$.fragment,i),P(le.$$.fragment,i),P(Fe.$$.fragment,i),P(Ie.$$.fragment,i),P(Le.$$.fragment,i),P(Ne.$$.fragment,i),P(We.$$.fragment,i),P(Me.$$.fragment,i),P(Be.$$.fragment,i),co=!1},d(i){t(f),i&&t(b),i&&t(p),C(c),i&&t(ao),i&&t(H),i&&t(so),i&&t(D),i&&t(io),i&&t(R),C($e),i&&t(lo),i&&t(m),C(ke),C(X),C(Pe),C(oe),C(Ee),C(xe),C(De),C(ze),C(se),C(ie),C(Oe),C(qe),C(le),C(Fe),C(Ie),C(Le),C(Ne),C(We),C(Me),C(Be)}}}const Is={local:"configuration",sections:[{local:"transformers.PretrainedConfig",title:"PretrainedConfig"}],title:"Configuration"};function Ls(z){return js(()=>{new URLSearchParams(window.location.search).get("fw")}),[]}class Us extends Es{constructor(f){super();xs(this,f,Ls,Fs,Ts,{})}}export{Us as default,Is as metadata};
