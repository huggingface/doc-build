...
`}}),De=new E({props:{name:"from_json_file",anchor:"transformers.PretrainedConfig.from_json_file",parameters:[{name:"json_file",val:": typing.Union[str, os.PathLike]"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/configuration_utils.py#L710",parametersDescription:[{anchor:"transformers.PretrainedConfig.from_json_file.json_file",description:`<strong>json_file</strong> (<code>str</code> or <code>os.PathLike</code>) &#x2014;
...
`),lt=r("code"),Mo=o("vocab_size"),Vo=o("."),io=d(),R=r("h2"),X=r("a"),ft=r("span"),u(we.$$.fragment),Bo=d(),mt=r("span"),Ro=o("PretrainedConfig"),co=d(),l=r("div"),u($e.$$.fragment),Uo=d(),ht=r("p"),Jo=o(`Base class for all configuration classes. Handles a few parameters common to all models\u2019 configurations as well as
...
serializes to a Python dictionary.`),na=d(),me=r("div"),u(We.$$.fragment),ra=d(),Rt=r("p"),aa=o("Save this instance to a JSON file."),sa=d(),he=r("div"),u(Me.$$.fragment),ia=d(),Ut=r("p"),da=o("Serializes this instance to a JSON string."),ca=d(),ge=r("div"),u(Ve.$$.fragment),la=d(),Be=r("p"),fa=o("Updates attributes of this class with attributes from "),Jt=r("code"),ma=o("config_dict"),ha=o("."),ga=d(),O=r("div"),u(Re.$$.fragment),ua=d(),Ue=r("p"),pa=o("Updates attributes of this class with attributes from "),Ht=r("code"),_a=o("update_str"),ba=o("."),ya=d(),J=r("p"),va=o("The expected format is ints, floats and strings as is, and for booleans use "),Gt=r("code"),wa=o("true"),$a=o(" or "),Xt=r("code"),ka=o("false"),Pa=o(`. For example:
\u201Cn_embd=10,resid_pdrop=0.2,scale_attn_weights=false,summary_type=cls_index\u201D`),Ca=d(),Kt=r("p"),Ea=o("The keys to change have to already exist in the config object."),this.h()},l(i){const $=Ss('[data-svelte="svelte-1phssyn"]',document.head);h=a($,"META",{name:!0,content:!0}),$.forEach(t),C=c(i),g=a(i,"H1",{class:!0});var Je=s(g);w=a(Je,"A",{id:!0,class:!0,href:!0});var Qt=s(w);j=a(Qt,"SPAN",{});var Yt=s(j);p(k.$$.fragment,Yt),Yt.forEach(t),Qt.forEach(t),P=c(Je),q=a(Je,"SPAN",{});var xa=s(q);jo=n(xa,"Configuration"),xa.forEach(t),Je.forEach(t),ao=c(i),G=a(i,"P",{});var fo=s(G);zo=n(fo,"The base class "),Ge=a(fo,"A",{href:!0});var Da=s(Ge);Ao=n(Da,"PretrainedConfig"),Da.forEach(t),Oo=n(fo,` implements the common methods for loading/saving a configuration
either from a local file or directory, or from a pretrained model configuration provided by the library (downloaded
...
`),lt=a(V,"CODE",{});var Oa=s(lt);Mo=n(Oa,"vocab_size"),Oa.forEach(t),Vo=n(V,"."),V.forEach(t),io=c(i),R=a(i,"H2",{class:!0});var mo=s(R);X=a(mo,"A",{id:!0,class:!0,href:!0});var qa=s(X);ft=a(qa,"SPAN",{});var Sa=s(ft);p(we.$$.fragment,Sa),Sa.forEach(t),qa.forEach(t),Bo=c(mo),mt=a(mo,"SPAN",{});var Fa=s(mt);Ro=n(Fa,"PretrainedConfig"),Fa.forEach(t),mo.forEach(t),co=c(i),l=a(i,"DIV",{class:!0});var f=s(l);p($e.$$.fragment,f),Uo=c(f),ht=a(f,"P",{});var Ia=s(ht);Jo=n(Ia,`Base class for all configuration classes. Handles a few parameters common to all models\u2019 configurations as well as
...
`),Qe=a(N,"A",{href:!0});var Ua=s(Qe);fn=n(Ua,"EncoderDecoderConfig"),Ua.forEach(t),mn=n(N," or "),Ye=a(N,"A",{href:!0});var Ja=s(Ye);hn=n(Ja,"~RagConfig"),Ja.forEach(t),gn=n(N,"."),N.forEach(t),un=c(ue),Q=a(ue,"LI",{});var Zt=s(Q);yt=a(Zt,"STRONG",{});var Ha=s(yt);pn=n(Ha,"keys_to_ignore_at_inference"),Ha.forEach(t),_n=n(Zt," ("),vt=a(Zt,"CODE",{});var Ga=s(vt);bn=n(Ga,"List[str]"),Ga.forEach(t),yn=n(Zt,`) \u2014 A list of keys to ignore by default when looking at dictionary
outputs of the model during inference.`),Zt.forEach(t),vn=c(ue),Y=a(ue,"LI",{});var eo=s(Y);wt=a(eo,"STRONG",{});var Xa=s(wt);wn=n(Xa,"attribute_map"),Xa.forEach(t),$n=n(eo," ("),$t=a(eo,"CODE",{});var Ka=s($t);kn=n(Ka,"Dict[str, str]"),Ka.forEach(t),Pn=n(eo,`) \u2014 A dict that maps model specific attribute names to the standardized
...
string, which can then be stored in the json format.`),be.forEach(t),go.forEach(t),lr=c(f),re=a(f,"DIV",{class:!0});var uo=s(re);p(Te.$$.fragment,uo),fr=c(uo),xe=a(uo,"P",{});var po=s(xe);mr=n(po,"Instantiates a "),Ze=a(po,"A",{href:!0});var fs=s(Ze);hr=n(fs,"PretrainedConfig"),fs.forEach(t),gr=n(po," from a Python dictionary of parameters."),po.forEach(t),uo.forEach(t),ur=c(f),ae=a(f,"DIV",{class:!0});var _o=s(ae);p(De.$$.fragment,_o),pr=c(_o),je=a(_o,"P",{});var bo=s(je);_r=n(bo,"Instantiates a "),et=a(bo,"A",{href:!0});var ms=s(et);br=n(ms,"PretrainedConfig"),ms.forEach(t),yr=n(bo," from the path to a JSON file of parameters."),bo.forEach(t),_o.forEach(t),vr=c(f),D=a(f,"DIV",{class:!0});var B=s(D);p(ze.$$.fragment,B),wr=c(B),Ae=a(B,"P",{});var yo=s(Ae);$r=n(yo,"Instantiate a "),tt=a(yo,"A",{href:!0});var hs=s(tt);kr=n(hs,"PretrainedConfig"),hs.forEach(t),Pr=n(yo," (or a derived class) from a pretrained model configuration."),yo.forEach(t),Cr=c(B),p(se.$$.fragment,B),Er=c(B),It=a(B,"P",{});var gs=s(It);Tr=n(gs,"Examples:"),gs.forEach(t),xr=c(B),p(Oe.$$.fragment,B),B.forEach(t),Dr=c(f),ie=a(f,"DIV",{class:!0});var vo=s(ie);p(qe.$$.fragment,vo),jr=c(vo),L=a(vo,"P",{});var ye=s(L);zr=n(ye,"From a "),Lt=a(ye,"CODE",{});var us=s(Lt);Ar=n(us,"pretrained_model_name_or_path"),us.forEach(t),Or=n(ye,`, resolve to a dictionary of parameters, to be used for instantiating a
`),ot=a(ye,"A",{href:!0});var ps=s(ot);qr=n(ps,"PretrainedConfig"),ps.forEach(t),Sr=n(ye," using "),Nt=a(ye,"CODE",{});var _s=s(Nt);Fr=n(_s,"from_dict"),_s.forEach(t),Ir=n(ye,"."),ye.forEach(t),vo.forEach(t),Lr=c(f),M=a(f,"DIV",{class:!0});var rt=s(M);p(Se.$$.fragment,rt),Nr=c(rt),Fe=a(rt,"P",{});var wo=s(Fe);Wr=n(wo,`Register this class with a given auto class. This should only be used for custom configurations as the ones in
...
serializes to a Python dictionary.`),$s.forEach(t),Po.forEach(t),na=c(f),me=a(f,"DIV",{class:!0});var Co=s(me);p(We.$$.fragment,Co),ra=c(Co),Rt=a(Co,"P",{});var ks=s(Rt);aa=n(ks,"Save this instance to a JSON file."),ks.forEach(t),Co.forEach(t),sa=c(f),he=a(f,"DIV",{class:!0});var Eo=s(he);p(Me.$$.fragment,Eo),ia=c(Eo),Ut=a(Eo,"P",{});var Ps=s(Ut);da=n(Ps,"Serializes this instance to a JSON string."),Ps.forEach(t),Eo.forEach(t),ca=c(f),ge=a(f,"DIV",{class:!0});var To=s(ge);p(Ve.$$.fragment,To),la=c(To),Be=a(To,"P",{});var xo=s(Be);fa=n(xo,"Updates attributes of this class with attributes from "),Jt=a(xo,"CODE",{});var Cs=s(Jt);ma=n(Cs,"config_dict"),Cs.forEach(t),ha=n(xo,"."),xo.forEach(t),To.forEach(t),ga=c(f),O=a(f,"DIV",{class:!0});var ve=s(O);p(Re.$$.fragment,ve),ua=c(ve),Ue=a(ve,"P",{});var Do=s(Ue);pa=n(Do,"Updates attributes of this class with attributes from "),Ht=a(Do,"CODE",{});var Es=s(Ht);_a=n(Es,"update_str"),Es.forEach(t),ba=n(Do,"."),Do.forEach(t),ya=c(ve),J=a(ve,"P",{});var st=s(J);va=n(st,"The expected format is ints, floats and strings as is, and for booleans use "),Gt=a(st,"CODE",{});var Ts=s(Gt);wa=n(Ts,"true"),Ts.forEach(t),$a=n(st," or "),Xt=a(st,"CODE",{});var xs=s(Xt);ka=n(xs,"false"),xs.forEach(t),Pa=n(st,`. For example:
\u201Cn_embd=10,resid_pdrop=0.2,scale_attn_weights=false,summary_type=cls_index\u201D`),st.forEach(t),Ca=c(ve),Kt=a(ve,"P",{});var Ds=s(Kt);Ea=n(Ds,"The keys to change have to already exist in the config object."),Ds.forEach(t),ve.forEach(t),f.forEach(t),this.h()},h(){m(h,"name","hf:doc:metadata"),m(h,"content",JSON.stringify(Ms)),m(w,"id","configuration"),m(w,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),m(w,"href","#configuration"),m(g,"class","relative group"),m(Ge,"href","/docs/transformers/main/en/main_classes/configuration#transformers.PretrainedConfig"),m(X,"id","transformers.PretrainedConfig"),m(X,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),m(X,"href","#transformers.PretrainedConfig"),m(R,"class","relative group"),m(Xe,"href","/docs/transformers/main/en/model_doc/auto#transformers.AutoConfig"),m(Ke,"href","/docs/transformers/main/en/main_classes/configuration#transformers.PretrainedConfig"),m(Qe,"href","/docs/transformers/main/en/model_doc/encoder-decoder#transformers.EncoderDecoderConfig"),m(Ye,"href","/docs/transformers/main/en/model_doc/rag#transformers.RagConfig"),m(A,"class","docstring"),m(ne,"class","docstring"),m(Ze,"href","/docs/transformers/main/en/main_classes/configuration#transformers.PretrainedConfig"),m(re,"class","docstring"),m(et,"href","/docs/transformers/main/en/main_classes/configuration#transformers.PretrainedConfig"),m(ae,"class","docstring"),m(tt,"href","/docs/transformers/main/en/main_classes/configuration#transformers.PretrainedConfig"),m(D,"class","docstring"),m(ot,"href","/docs/transformers/main/en/main_classes/configuration#transformers.PretrainedConfig"),m(ie,"class","docstring"),m(M,"class","docstring"),m(nt,"href","/docs/transformers/main/en/main_classes/configuration#transformers.PretrainedConfig.from_pretrained"),m(ce,"class","docstring"),m(le,"class","docstring"),m(fe,"class","docstring"),m(me,"class","docstring"),m(he,"class","docstring"),m(ge,"class","docstring"),m(O,"class","docstring"),m(l,"class","docstring")},m(i,$){e(document.head,h),z(i,C,$),z(i,g,$),e(g,w),e(w,j),_(k,j,null),e(g,P),e(g,q),e(q,jo),z(i,ao,$),z(i,G,$),e(G,zo),e(G,Ge),e(Ge,Ao),e(G,Oo),z(i,so,$),z(i,T,$),e(T,qo),e(T,it),e(it,So),e(T,Fo),e(T,dt),e(dt,Io),e(T,Lo),e(T,ct),e(ct,No),e(T,Wo),e(T,lt),e(lt,Mo),e(T,Vo),z(i,io,$),z(i,R,$),e(R,X),e(X,ft),_(we,ft,null),e(R,Bo),e(R,mt),e(mt,Ro),z(i,co,$),z(i,l,$),_($e,l,null),e(l,Uo),e(l,ht),e(ht,Jo),e(l,Ho),_(K,l,null),e(l,Go),e(l,gt),e(gt,Xo),e(l,Ko),e(l,S),e(S,W),e(W,ut),e(ut,Qo),e(W,Yo),e(W,pt),e(pt,Zo),e(W,en),e(W,Xe),e(Xe,tn),e(W,on),e(S,nn),e(S,x),e(x,_t),e(_t,rn),e(x,an),e(x,bt),e(bt,sn),e(x,dn),e(x,Ke),e(Ke,cn),e(x,ln),e(x,Qe),e(Qe,fn),e(x,mn),e(x,Ye),e(Ye,hn),e(x,gn),e(S,un),e(S,Q),e(Q,yt),e(yt,pn),e(Q,_n),e(Q,vt),e(vt,bn),e(Q,yn),e(S,vn),e(S,Y),e(Y,wt),e(wt,wn),e(Y,$n),e(Y,$t),e($t,kn),e(Y,Pn),e(l,Cn),e(l,kt),e(kt,En),e(l,Tn),e(l,F),e(F,Z),e(Z,Pt),e(Pt,xn),e(Z,Dn),e(Z,Ct),e(Ct,jn),e(Z,zn),e(F,An),e(F,ee),e(ee,Et),e(Et,On),e(ee,qn),e(ee,Tt),e(Tt,Sn),e(ee,Fn),e(F,In),e(F,te),e(te,xt),e(xt,Ln),e(te,Nn),e(te,Dt),e(Dt,Wn),e(te,Mn),e(F,Vn),e(F,oe),e(oe,jt),e(jt,Bn),e(oe,Rn),e(oe,zt),e(zt,Un),e(oe,Jn),e(l,Hn),e(l,A),_(ke,A,null),e(A,Gn),e(A,Pe),e(Pe,Xn),e(Pe,At),e(At,Kn),e(Pe,Qn),e(A,Yn),e(A,Ot),e(Ot,Zn),e(A,er),_(Ce,A,null),e(l,tr),e(l,ne),_(Ee,ne,null),e(ne,or),e(ne,I),e(I,nr),e(I,qt),e(qt,rr),e(I,ar),e(I,St),e(St,sr),e(I,ir),e(I,Ft),e(Ft,dr),e(I,cr),e(l,lr),e(l,re),_(Te,re,null),e(re,fr),e(re,xe),e(xe,mr),e(xe,Ze),e(Ze,hr),e(xe,gr),e(l,ur),e(l,ae),_(De,ae,null),e(ae,pr),e(ae,je),e(je,_r),e(je,et),e(et,br),e(je,yr),e(l,vr),e(l,D),_(ze,D,null),e(D,wr),e(D,Ae),e(Ae,$r),e(Ae,tt),e(tt,kr),e(Ae,Pr),e(D,Cr),_(se,D,null),e(D,Er),e(D,It),e(It,Tr),e(D,xr),_(Oe,D,null),e(l,Dr),e(l,ie),_(qe,ie,null),e(ie,jr),e(ie,L),e(L,zr),e(L,Lt),e(Lt,Ar),e(L,Or),e(L,ot),e(ot,qr),e(L,Sr),e(L,Nt),e(Nt,Fr),e(L,Ir),e(l,Lr),e(l,M),_(Se,M,null),e(M,Nr),e(M,Fe),e(Fe,Wr),e(Fe,Wt),e(Wt,Mr),e(Fe,Vr),e(M,Br),_(de,M,null),e(l,Rr),e(l,ce),_(Ie,ce,null),e(ce,Ur),e(ce,U),e(U,Jr),e(U,Mt),e(Mt,Hr),e(U,Gr),e(U,nt),e(nt,Xr),e(U,Kr),e(l,Qr),e(l,le),_(Le,le,null),e(le,Yr),e(le,Vt),e(Vt,Zr),e(l,ea),e(l,fe),_(Ne,fe,null),e(fe,ta),e(fe,Bt),e(Bt,oa),e(l,na),e(l,me),_(We,me,null),e(me,ra),e(me,Rt),e(Rt,aa),e(l,sa),e(l,he),_(Me,he,null),e(he,ia),e(he,Ut),e(Ut,da),e(l,ca),e(l,ge),_(Ve,ge,null),e(ge,la),e(ge,Be),e(Be,fa),e(Be,Jt),e(Jt,ma),e(Be,ha),e(l,ga),e(l,O),_(Re,O,null),e(O,ua),e(O,Ue),e(Ue,pa),e(Ue,Ht),e(Ht,_a),e(Ue,ba),e(O,ya),e(O,J),e(J,va),e(J,Gt),e(Gt,wa),e(J,$a),e(J,Xt),e(Xt,ka),e(J,Pa),e(O,Ca),e(O,Kt),e(Kt,Ea),lo=!0},p(i,[$]){const Je={};$&2&&(Je.$$scope={dirty:$,ctx:i}),K.$set(Je);const Qt={};$&2&&(Qt.$$scope={dirty:$,ctx:i}),se.$set(Qt);const Yt={};$&2&&(Yt.$$scope={dirty:$,ctx:i}),de.$set(Yt)},i(i){lo||(b(k.$$.fragment,i),b(we.$$.fragment,i),b($e.$$.fragment,i),b(K.$$.fragment,i),b(ke.$$.fragment,i),b(Ce.$$.fragment,i),b(Ee.$$.fragment,i),b(Te.$$.fragment,i),b(De.$$.fragment,i),b(ze.$$.fragment,i),b(se.$$.fragment,i),b(Oe.$$.fragment,i),b(qe.$$.fragment,i),b(Se.$$.fragment,i),b(de.$$.fragment,i),b(Ie.$$.fragment,i),b(Le.$$.fragment,i),b(Ne.$$.fragment,i),b(We.$$.fragment,i),b(Me.$$.fragment,i),b(Ve.$$.fragment,i),b(Re.$$.fragment,i),lo=!0)},o(i){y(k.$$.fragment,i),y(we.$$.fragment,i),y($e.$$.fragment,i),y(K.$$.fragment,i),y(ke.$$.fragment,i),y(Ce.$$.fragment,i),y(Ee.$$.fragment,i),y(Te.$$.fragment,i),y(De.$$.fragment,i),y(ze.$$.fragment,i),y(se.$$.fragment,i),y(Oe.$$.fragment,i),y(qe.$$.fragment,i),y(Se.$$.fragment,i),y(de.$$.fragment,i),y(Ie.$$.fragment,i),y(Le.$$.fragment,i),y(Ne.$$.fragment,i),y(We.$$.fragment,i),y(Me.$$.fragment,i),y(Ve.$$.fragment,i),y(Re.$$.fragment,i),lo=!1},d(i){t(h),i&&t(C),i&&t(g),v(k),i&&t(ao),i&&t(G),i&&t(so),i&&t(T),i&&t(io),i&&t(R),v(we),i&&t(co),i&&t(l),v($e),v(K),v(ke),v(Ce),v(Ee),v(Te),v(De),v(ze),v(se),v(Oe),v(qe),v(Se),v(de),v(Ie),v(Le),v(Ne),v(We),v(Me),v(Ve),v(Re)}}}const Ms={local:"configuration",sections:[{local:"transformers.PretrainedConfig",title:"PretrainedConfig"}],title:"Configuration"};function Vs(H){return Fs(()=>{new URLSearchParams(window.location.search).get("fw")}),[]}class Gs extends As{constructor(h){super();Os(this,h,Vs,Ws,qs,{})}}export{Gs as default,Ms as metadata};
