import{S as Cm,i as Im,s as Wm,e as s,k as l,w as m,t,M as Bm,c as a,d as o,m as d,a as r,x as g,h as n,b as c,F as e,g as M,y as u,q as _,o as h,B as f}from"../../chunks/vendor-6b77c823.js";import{T as Dm}from"../../chunks/Tip-39098574.js";import{D as ue}from"../../chunks/Docstring-abef54e3.js";import{C as be}from"../../chunks/CodeBlock-3a8b25a8.js";import{I as Ws}from"../../chunks/IconCopyLink-7a11ce68.js";function Hm(lt){let p,z,y,w,D,T,_e,C,q,I,G;return{c(){p=s("p"),z=t("Apart from "),y=s("code"),w=t("inputs"),D=t(`, all the arguments below will default to the value of the attribute of the same name as
defined in the model\u2019s config (`),T=s("code"),_e=t("config.json"),C=t(`) which in turn defaults to the
...
if `),Jn=s("code"),mr=t("constraints!=None"),gr=t(" or "),Qn=s("code"),ur=t("force_words_ids!=None"),_r=t("."),hr=l(),b=s("div"),m(gt.$$.fragment),fr=l(),Yn=s("p"),br=t(`Generates sequences of token ids for models with a language modeling head. The method supports the following
...
`),bo=s("code"),fi=t("force_words_ids!=None"),bi=t("."),xi=l(),m(Je.$$.fragment),ki=l(),ut=s("p"),vi=t("Most of these parameters are explained in more detail in "),_t=s("a"),yi=t(`this blog
...
`),Ln=s("a"),id=t("FlaxPreTrainedModel"),ld=t("."),dd=l(),Zt=s("p"),cd=t("The class exposes "),Mn=s("a"),pd=t("generate()"),md=t(", which can be used for:"),gd=l(),qe=s("ul"),re=s("li"),Bo=s("em"),ud=t("greedy decoding"),_d=t(" by calling "),Ho=s("code"),hd=t("_greedy_search()"),fd=t(`if
...
`),bo=a(Be,"CODE",{});var Sp=r(bo);fi=n(Sp,"force_words_ids!=None"),Sp.forEach(o),bi=n(Be,"."),Be.forEach(o),ge.forEach(o),xi=d(j),g(Je.$$.fragment,j),ki=d(j),ut=a(j,"P",{});var Ts=r(ut);vi=n(Ts,"Most of these parameters are explained in more detail in "),_t=a(Ts,"A",{href:!0,rel:!0});var $p=r(_t);yi=n($p,`this blog
...
sampling`),Hp.forEach(o),dl=n(Gs," and can be used for text-decoder, text-to-text, speech-to-text, and vision-to-text models."),Gs.forEach(o),cl=d(st),qo=a(st,"P",{});var Rp=r(qo);pl=n(Rp,"Examples:"),Rp.forEach(o),ml=d(st),g(qt.$$.fragment,st),st.forEach(o),gl=d(L),se=a(L,"DIV",{class:!0});var at=r(se);g(Gt.$$.fragment,at),ul=d(at),St=a(at,"P",{});var Ss=r(St);_l=n(Ss,"Generates sequences of token ids for models with a language modeling head using "),Go=a(Ss,"STRONG",{});var Up=r(Go);hl=n(Up,`diverse beam search
...
`),Ln=a(Ds,"A",{href:!0});var cm=r(Ln);id=n(cm,"FlaxPreTrainedModel"),cm.forEach(o),ld=n(Ds,"."),Ds.forEach(o),dd=d(ve),Zt=a(ve,"P",{});var Cs=r(Zt);cd=n(Cs,"The class exposes "),Mn=a(Cs,"A",{href:!0});var pm=r(Mn);pd=n(pm,"generate()"),pm.forEach(o),md=n(Cs,", which can be used for:"),Cs.forEach(o),gd=d(ve),qe=a(ve,"UL",{});var Gn=r(qe);re=a(Gn,"LI",{});var He=r(re);Bo=a(He,"EM",{});var mm=r(Bo);ud=n(mm,"greedy decoding"),mm.forEach(o),_d=n(He," by calling "),Ho=a(He,"CODE",{});var gm=r(Ho);hd=n(gm,"_greedy_search()"),gm.forEach(o),fd=n(He,`if
