...
[<span class="hljs-string">&#x27;Today I believe we can finally get to the point where we can make a difference in the lives of the people of the United States of America.\\n&#x27;</span>]`}}),{c(){d=a("p"),f=t("Greedy Decoding:"),u=m(),k(c.$$.fragment)},l(s){d=r(s,"P",{});var p=i(d);f=n(p,"Greedy Decoding:"),p.forEach(o),u=g(s),v(c.$$.fragment,s)},m(s,p){x(s,d,p),e(d,f),x(s,u,p),y(c,s,p),_=!0},p:ue,i(s){_||(j(c.$$.fragment,s),_=!0)},o(s){w(c.$$.fragment,s),_=!1},d(s){s&&o(d),s&&o(u),M(c,s)}}}function am(L){let d,f,u,c,_;return c=new _e({props:{code:`from transformers import AutoTokenizer, AutoModelForCausalLM
import torch
...
<span class="hljs-meta">&gt;&gt;&gt; </span>tokenizer.batch_decode(outputs, skip_special_tokens=<span class="hljs-literal">True</span>)
[<span class="hljs-string">&#x27;Today I believe we can finally get rid of discrimination,&quot; said Rep. Mark Pocan (D-Wis.).\\n\\n&quot;Just look at the&#x27;</span>]`}}),{c(){d=a("p"),f=t("Multinomial Sampling:"),u=m(),k(c.$$.fragment)},l(s){d=r(s,"P",{});var p=i(d);f=n(p,"Multinomial Sampling:"),p.forEach(o),u=g(s),v(c.$$.fragment,s)},m(s,p){x(s,d,p),e(d,f),x(s,u,p),y(c,s,p),_=!0},p:ue,i(s){_||(j(c.$$.fragment,s),_=!0)},o(s){w(c.$$.fragment,s),_=!1},d(s){s&&o(d),s&&o(u),M(c,s)}}}function rm(L){let d,f,u,c,_;return c=new _e({props:{code:`from transformers import AutoTokenizer, AutoModelForSeq2SeqLM
...
<span class="hljs-meta">&gt;&gt;&gt; </span>tokenizer.batch_decode(outputs, skip_special_tokens=<span class="hljs-literal">True</span>)
[<span class="hljs-string">&#x27;Paris ist eines der dichtesten besiedelten Gebiete Europas.&#x27;</span>]`}}),{c(){d=a("p"),f=t("Beam-search decoding:"),u=m(),k(c.$$.fragment)},l(s){d=r(s,"P",{});var p=i(d);f=n(p,"Beam-search decoding:"),p.forEach(o),u=g(s),v(c.$$.fragment,s)},m(s,p){x(s,d,p),e(d,f),x(s,u,p),y(c,s,p),_=!0},p:ue,i(s){_||(j(c.$$.fragment,s),_=!0)},o(s){w(c.$$.fragment,s),_=!1},d(s){s&&o(d),s&&o(u),M(c,s)}}}function im(L){let d,f,u,c,_;return c=new _e({props:{code:`from transformers import (
    AutoTokenizer,
...
<span class="hljs-meta">&gt;&gt;&gt; </span>tokenizer.batch_decode(outputs, skip_special_tokens=<span class="hljs-literal">True</span>)
[<span class="hljs-string">&quot;It might be possible to get a better understanding of the nature of the problem, but it&#x27;s not&quot;</span>]`}}),{c(){d=a("p"),f=t("Examples:"),u=m(),k(c.$$.fragment)},l(s){d=r(s,"P",{});var p=i(d);f=n(p,"Examples:"),p.forEach(o),u=g(s),v(c.$$.fragment,s)},m(s,p){x(s,d,p),e(d,f),x(s,u,p),y(c,s,p),_=!0},p:ue,i(s){_||(j(c.$$.fragment,s),_=!0)},o(s){w(c.$$.fragment,s),_=!1},d(s){s&&o(d),s&&o(u),M(c,s)}}}function lm(L){let d,f,u,c,_;return c=new _e({props:{code:`from transformers import (
    AutoTokenizer,
    AutoModelForCausalLM,
    LogitsProcessorList,
    MinLengthLogitsProcessor,
...
<span class="hljs-meta">&gt;&gt;&gt; </span>tokenizer.batch_decode(outputs, skip_special_tokens=<span class="hljs-literal">True</span>)
[<span class="hljs-string">&#x27;Wie alt bist du?&#x27;</span>]`}}),{c(){d=a("p"),f=t("Examples:"),u=m(),k(c.$$.fragment)},l(s){d=r(s,"P",{});var p=i(d);f=n(p,"Examples:"),p.forEach(o),u=g(s),v(c.$$.fragment,s)},m(s,p){x(s,d,p),e(d,f),x(s,u,p),y(c,s,p),_=!0},p:ue,i(s){_||(j(c.$$.fragment,s),_=!0)},o(s){w(c.$$.fragment,s),_=!1},d(s){s&&o(d),s&&o(u),M(c,s)}}}function cm(L){let d,f,u,c,_;return c=new _e({props:{code:`from transformers import (
    AutoTokenizer,
    AutoModelForSeq2SeqLM,
    LogitsProcessorList,
    MinLengthLogitsProcessor,
...
<span class="hljs-meta">&gt;&gt;&gt; </span>tokenizer.batch_decode(outputs, skip_special_tokens=<span class="hljs-literal">True</span>)
[<span class="hljs-string">&#x27;Wie alt bist du?&#x27;</span>]`}}),{c(){d=a("p"),f=t("Examples:"),u=m(),k(c.$$.fragment)},l(s){d=r(s,"P",{});var p=i(d);f=n(p,"Examples:"),p.forEach(o),u=g(s),v(c.$$.fragment,s)},m(s,p){x(s,d,p),e(d,f),x(s,u,p),y(c,s,p),_=!0},p:ue,i(s){_||(j(c.$$.fragment,s),_=!0)},o(s){w(c.$$.fragment,s),_=!1},d(s){s&&o(d),s&&o(u),M(c,s)}}}function pm(L){let d,f,u,c,_;return c=new _e({props:{code:`from transformers import (
    AutoTokenizer,
    AutoModelForSeq2SeqLM,
    LogitsProcessorList,
    MinLengthLogitsProcessor,
...
<span class="hljs-meta">&gt;&gt;&gt; </span>tokenizer.batch_decode(outputs, skip_special_tokens=<span class="hljs-literal">True</span>)
[<span class="hljs-string">&#x27;Wie alt bist du?&#x27;</span>]`}}),{c(){d=a("p"),f=t("Examples:"),u=m(),k(c.$$.fragment)},l(s){d=r(s,"P",{});var p=i(d);f=n(p,"Examples:"),p.forEach(o),u=g(s),v(c.$$.fragment,s)},m(s,p){x(s,d,p),e(d,f),x(s,u,p),y(c,s,p),_=!0},p:ue,i(s){_||(j(c.$$.fragment,s),_=!0)},o(s){w(c.$$.fragment,s),_=!1},d(s){s&&o(d),s&&o(u),M(c,s)}}}function mm(L){let d,f,u,c,_;return c=new _e({props:{code:`from transformers import (
    AutoTokenizer,
    AutoModelForSeq2SeqLM,
    LogitsProcessorList,
    MinLengthLogitsProcessor,
...
<span class="hljs-meta">&gt;&gt;&gt; </span>tokenizer.batch_decode(outputs, skip_special_tokens=<span class="hljs-literal">True</span>)
[<span class="hljs-string">&#x27;Wie alt sind Sie?&#x27;</span>]`}}),{c(){d=a("p"),f=t("Examples:"),u=m(),k(c.$$.fragment)},l(s){d=r(s,"P",{});var p=i(d);f=n(p,"Examples:"),p.forEach(o),u=g(s),v(c.$$.fragment,s)},m(s,p){x(s,d,p),e(d,f),x(s,u,p),y(c,s,p),_=!0},p:ue,i(s){_||(j(c.$$.fragment,s),_=!0)},o(s){w(c.$$.fragment,s),_=!1},d(s){s&&o(d),s&&o(u),M(c,s)}}}function gm(L){let d,f,u,c,_;return c=new _e({props:{code:`tokenizer = AutoTokenizer.from_pretrained("distilgpt2")  # Initialize tokenizer
...
should be prefixed with *decoder</em>*.`,name:"forced_decoder_ids"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/generation_utils.py#L914",returnDescription:`
<p>A <a
...
If model is an encoder-decoder model the kwargs should include <code>encoder_outputs</code>.`,name:"synced_gpus"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/generation_utils.py#L1649",returnDescription:`
<p><a
  href="/docs/transformers/main/en/internal/generation_utils#transformers.generation_utils.GreedySearchDecoderOnlyOutput"
...
an encoder-decoder model the kwargs should include <code>encoder_outputs</code>.`,name:"synced_gpus"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/generation_utils.py#L1877",returnDescription:`
<p><a
  href="/docs/transformers/main/en/internal/generation_utils#transformers.generation_utils.SampleDecoderOnlyOutput"
...
model_kwargs &#x2014;
Additional model specific kwargs will be forwarded to the <code>forward</code> function of the model. If model is
an encoder-decoder model the kwargs should include <code>encoder_outputs</code>.`,name:"synced_gpus"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/generation_utils.py#L2128",returnDescription:`
...
model_kwargs &#x2014;
Additional model specific kwargs will be forwarded to the <code>forward</code> function of the model. If model is
an encoder-decoder model the kwargs should include <code>encoder_outputs</code>.`,name:"synced_gpus"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/generation_utils.py#L2437",returnDescription:`
<p><a
  href="/docs/transformers/main/en/internal/generation_utils#transformers.generation_utils.BeamSampleDecoderOnlyOutput"
...
model is an encoder-decoder model the kwargs should include <code>encoder_outputs</code>.`,name:"synced_gpus"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/generation_utils.py#L2753",returnDescription:`
<p><a
  href="/docs/transformers/main/en/internal/generation_utils#transformers.generation_utils.BeamSearchDecoderOnlyOutput"
...
model_kwargs &#x2014;
Additional model specific kwargs will be forwarded to the <code>forward</code> function of the model. If model is
an encoder-decoder model the kwargs should include <code>encoder_outputs</code>.`,name:"synced_gpus"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/generation_utils.py#L3115",returnDescription:`
<p><code>generation_utilsBeamSearchDecoderOnlyOutput</code>, <a
  href="/docs/transformers/main/en/internal/generation_utils#transformers.generation_utils.BeamSearchEncoderDecoderOutput"
>BeamSearchEncoderDecoderOutput</a> or
<code>torch.LongTensor</code>: A <code>torch.LongTensor</code> containing the generated tokens (default behaviour) or a
...
<p><a
  href="/docs/transformers/main/en/main_classes/output#transformers.utils.ModelOutput"
>ModelOutput</a>.</p>
`}}),ht=new Jp({props:{warning:!0,$$slots:{default:[um]},$$scope:{ctx:L}}}),ft=new ge({props:{anchor:"transformers.generation_flax_utils.FlaxGenerationMixin.generate.example",$$slots:{default:[_m]},$$scope:{ctx:L}}}),{c(){d=a("meta"),f=m(),u=a("h1"),c=a("a"),_=a("span"),k(s.$$.fragment),p=m(),C=a("span"),q=t("Generation"),I=m(),S=a("p"),z=t("Each framework has a generate method for auto-regressive text generation implemented in their respective "),$=a("code"),Me=t("GenerationMixin"),Le=t(" class:"),he=m(),fe=a("ul"),$e=a("li"),Is=t("PyTorch "),tn=a("a"),Bs=t("generate()"),Ws=t(" is implemented in "),nn=a("a"),Hs=t("GenerationMixin"),Rs=t("."),Us=m(),Te=a("li"),Vs=t("TensorFlow "),on=a("a"),Ks=t("generate()"),Zs=t(" is implemented in "),sn=a("a"),Xs=t("TFGenerationMixin"),Js=t("."),Qs=m(),Ee=a("li"),Ys=t("Flax/JAX "),an=a("a"),ea=t("generate()"),ta=t(" is implemented in "),rn=a("a"),na=t("FlaxGenerationMixin"),oa=t("."),_s=m(),Oe=a("h2"),nt=a("a"),zn=a("span"),k(xt.$$.fragment),sa=m(),Pn=a("span"),aa=t("GenerationMixin"),hs=m(),T=a("div"),k(kt.$$.fragment),ra=m(),vt=a("p"),ia=t("A class containing all functions for auto-regressive text generation, to be used as a mixin in "),ln=a("a"),la=t("PreTrainedModel"),da=t("."),ca=m(),yt=a("p"),pa=t("The class exposes "),dn=a("a"),ma=t("generate()"),ga=t(", which can be used for:"),ua=m(),P=a("ul"),B=a("li"),Dn=a("em"),_a=t("greedy decoding"),ha=t(" by calling "),cn=a("a"),fa=t("greedy_search()"),ba=t(" if "),Nn=a("code"),xa=t("num_beams=1"),ka=t(` and
`),Cn=a("code"),va=t("do_sample=False"),ya=t("."),ja=m(),W=a("li"),In=a("em"),wa=t("multinomial sampling"),Ma=t(" by calling "),pn=a("a"),La=t("sample()"),$a=t(" if "),Bn=a("code"),Ta=t("num_beams=1"),Ea=t(` and
...
`),ao=a("code"),wr=t("do_sample=False"),Mr=t("."),Lr=m(),Z=a("li"),ro=a("em"),$r=t("multinomial sampling"),Tr=t(" by calling "),fn=a("a"),Er=t("sample()"),Or=t(" if "),io=a("code"),Gr=t("num_beams=1"),qr=t(` and
...
`),vo=a("code"),_i=t("force_words_ids!=None"),hi=t("."),fi=m(),k(ot.$$.fragment),bi=m(),wt=a("p"),xi=t("Most of these parameters are explained in more detail in "),Mt=a("a"),ki=t(`this blog
post`),vi=t("."),yi=m(),yo=a("p"),ji=t("Examples:"),wi=m(),k(st.$$.fragment),Mi=m(),k(at.$$.fragment),Li=m(),k(rt.$$.fragment),$i=m(),be=a("div"),k(Lt.$$.fragment),Ti=m(),$t=a("p"),Ei=t("Generates sequences of token ids for models with a language modeling head using "),jo=a("strong"),Oi=t("greedy decoding"),Gi=t(` and can be
used for text-decoder, text-to-text, speech-to-text, and vision-to-text models.`),qi=m(),k(it.$$.fragment),Si=m(),xe=a("div"),k(Tt.$$.fragment),Fi=m(),Et=a("p"),Ai=t("Generates sequences of token ids for models with a language modeling head using "),wo=a("strong"),zi=t("multinomial sampling"),Pi=t(` and
can be used for text-decoder, text-to-text, speech-to-text, and vision-to-text models.`),Di=m(),k(lt.$$.fragment),Ni=m(),ke=a("div"),k(Ot.$$.fragment),Ci=m(),Gt=a("p"),Ii=t("Generates sequences of token ids for models with a language modeling head using "),Mo=a("strong"),Bi=t("beam search decoding"),Wi=t(` and
...
sampling`),Zi=t(" and can be used for text-decoder, text-to-text, speech-to-text, and vision-to-text models."),Xi=m(),k(ct.$$.fragment),Ji=m(),ye=a("div"),k(Ft.$$.fragment),Qi=m(),At=a("p"),Yi=t("Generates sequences of token ids for models with a language modeling head using "),$o=a("strong"),el=t(`diverse beam search
decoding`),tl=t(" and can be used for text-decoder, text-to-text, speech-to-text, and vision-to-text models."),nl=m(),k(pt.$$.fragment),ol=m(),je=a("div"),k(zt.$$.fragment),sl=m(),Pt=a("p"),al=t("Generates sequences of token ids for models with a language modeling head using "),To=a("strong"),rl=t(`constrained beam search
...
code`),vl=t("."),yl=m(),me=a("p"),jl=t("Apart from "),qo=a("code"),wl=t("input_ids"),Ml=t(" and "),So=a("code"),Ll=t("attention_mask"),$l=t(`, all the arguments below will default to the value of the attribute
...
post`),Sl=t("."),Fl=m(),k(ut.$$.fragment),xs=m(),qe=a("h2"),_t=a("a"),Fo=a("span"),k(Ut.$$.fragment),Al=m(),Ao=a("span"),zl=t("FlaxGenerationMixin"),ks=m(),N=a("div"),k(Vt.$$.fragment),Pl=m(),Kt=a("p"),Dl=t(`A class containing all functions for auto-regressive text generation, to be used as a mixin in
`),wn=a("a"),Nl=t("FlaxPreTrainedModel"),Cl=t("."),Il=m(),Zt=a("p"),Bl=t("The class exposes "),Mn=a("a"),Wl=t("generate()"),Hl=t(", which can be used for:"),Rl=m(),Se=a("ul"),ee=a("li"),zo=a("em"),Ul=t("greedy decoding"),Vl=t(" by calling "),Po=a("code"),Kl=t("_greedy_search()"),Zl=t(` if
...
and `),Wo=a("code"),id=t("do_sample=True"),ld=t("."),dd=m(),ne=a("li"),Ho=a("em"),cd=t("beam-search decoding"),pd=t(" by calling "),Ro=a("code"),md=t("~generation_utils.FlaxGenerationMixin._beam_search"),gd=t(" if "),Uo=a("code"),ud=t("num_beams>1"),_d=t(`
...
generation methods for text-decoder, text-to-text, speech-to-text, and vision-to-text models:`),vd=m(),Fe=a("ul"),oe=a("li"),Zo=a("em"),yd=t("greedy decoding"),jd=t(" by calling "),Xo=a("code"),wd=t("_greedy_search()"),Md=t(` if
`),Jo=a("code"),Ld=t("num_beams=1"),$d=t(" and "),Qo=a("code"),Td=t("do_sample=False"),Ed=t("."),Od=m(),se=a("li"),Yo=a("em"),Gd=t("multinomial sampling"),qd=t(" by calling "),es=a("code"),Sd=t("_sample()"),Fd=t(" if "),ts=a("code"),Ad=t("num_beams=1"),zd=t(`
and `),ns=a("code"),Pd=t("do_sample=True"),Dd=t("."),Nd=m(),ae=a("li"),os=a("em"),Cd=t("beam-search decoding"),Id=t(" by calling "),ss=a("code"),Bd=t("~generation_utils.FlaxGenerationMixin._beam_search"),Wd=t(" if "),as=a("code"),Hd=t("num_beams>1"),Rd=t(`
...
post`),Qd=t("."),Yd=m(),k(ft.$$.fragment),this.h()},l(l){const b=tm('[data-svelte="svelte-1phssyn"]',document.head);d=r(b,"META",{name:!0,content:!0}),b.forEach(o),f=g(l),u=r(l,"H1",{class:!0});var Yt=i(u);c=r(Yt,"A",{id:!0,class:!0,href:!0});var is=i(c);_=r(is,"SPAN",{});var ls=i(_);v(s.$$.fragment,ls),ls.forEach(o),is.forEach(o),p=g(Yt),C=r(Yt,"SPAN",{});var ds=i(C);q=n(ds,"Generation"),ds.forEach(o),Yt.forEach(o),I=g(l),S=r(l,"P",{});var en=i(S);z=n(en,"Each framework has a generate method for auto-regressive text generation implemented in their respective "),$=r(en,"CODE",{});var cs=i($);Me=n(cs,"GenerationMixin"),cs.forEach(o),Le=n(en," class:"),en.forEach(o),he=g(l),fe=r(l,"UL",{});var Ae=i(fe);$e=r(Ae,"LI",{});var ze=i($e);Is=n(ze,"PyTorch "),tn=r(ze,"A",{href:!0});var ps=i(tn);Bs=n(ps,"generate()"),ps.forEach(o),Ws=n(ze," is implemented in "),nn=r(ze,"A",{href:!0});var ms=i(nn);Hs=n(ms,"GenerationMixin"),ms.forEach(o),Rs=n(ze,"."),ze.forEach(o),Us=g(Ae),Te=r(Ae,"LI",{});var Pe=i(Te);Vs=n(Pe,"TensorFlow "),on=r(Pe,"A",{href:!0});var gs=i(on);Ks=n(gs,"generate()"),gs.forEach(o),Zs=n(Pe," is implemented in "),sn=r(Pe,"A",{href:!0});var us=i(sn);Xs=n(us,"TFGenerationMixin"),us.forEach(o),Js=n(Pe,"."),Pe.forEach(o),Qs=g(Ae),Ee=r(Ae,"LI",{});var Ln=i(Ee);Ys=n(Ln,"Flax/JAX "),an=r(Ln,"A",{href:!0});var ec=i(an);ea=n(ec,"generate()"),ec.forEach(o),ta=n(Ln," is implemented in "),rn=r(Ln,"A",{href:!0});var tc=i(rn);na=n(tc,"FlaxGenerationMixin"),tc.forEach(o),oa=n(Ln,"."),Ln.forEach(o),Ae.forEach(o),_s=g(l),Oe=r(l,"H2",{class:!0});var ys=i(Oe);nt=r(ys,"A",{id:!0,class:!0,href:!0});var nc=i(nt);zn=r(nc,"SPAN",{});var oc=i(zn);v(xt.$$.fragment,oc),oc.forEach(o),nc.forEach(o),sa=g(ys),Pn=r(ys,"SPAN",{});var sc=i(Pn);aa=n(sc,"GenerationMixin"),sc.forEach(o),ys.forEach(o),hs=g(l),T=r(l,"DIV",{class:!0});var O=i(T);v(kt.$$.fragment,O),ra=g(O),vt=r(O,"P",{});var js=i(vt);ia=n(js,"A class containing all functions for auto-regressive text generation, to be used as a mixin in "),ln=r(js,"A",{href:!0});var ac=i(ln);la=n(ac,"PreTrainedModel"),ac.forEach(o),da=n(js,"."),js.forEach(o),ca=g(O),yt=r(O,"P",{});var ws=i(yt);pa=n(ws,"The class exposes "),dn=r(ws,"A",{href:!0});var rc=i(dn);ma=n(rc,"generate()"),rc.forEach(o),ga=n(ws,", which can be used for:"),ws.forEach(o),ua=g(O),P=r(O,"UL",{});var re=i(P);B=r(re,"LI",{});var De=i(B);Dn=r(De,"EM",{});var ic=i(Dn);_a=n(ic,"greedy decoding"),ic.forEach(o),ha=n(De," by calling "),cn=r(De,"A",{href:!0});var lc=i(cn);fa=n(lc,"greedy_search()"),lc.forEach(o),ba=n(De," if "),Nn=r(De,"CODE",{});var dc=i(Nn);xa=n(dc,"num_beams=1"),dc.forEach(o),ka=n(De,` and
`),Cn=r(De,"CODE",{});var cc=i(Cn);va=n(cc,"do_sample=False"),cc.forEach(o),ya=n(De,"."),De.forEach(o),ja=g(re),W=r(re,"LI",{});var Ne=i(W);In=r(Ne,"EM",{});var pc=i(In);wa=n(pc,"multinomial sampling"),pc.forEach(o),Ma=n(Ne," by calling "),pn=r(Ne,"A",{href:!0});var mc=i(pn);La=n(mc,"sample()"),mc.forEach(o),$a=n(Ne," if "),Bn=r(Ne,"CODE",{});var gc=i(Bn);Ta=n(gc,"num_beams=1"),gc.forEach(o),Ea=n(Ne,` and
...
`),ao=r(He,"CODE",{});var Ac=i(ao);wr=n(Ac,"do_sample=False"),Ac.forEach(o),Mr=n(He,"."),He.forEach(o),Lr=g(ie),Z=r(ie,"LI",{});var Re=i(Z);ro=r(Re,"EM",{});var zc=i(ro);$r=n(zc,"multinomial sampling"),zc.forEach(o),Tr=n(Re," by calling "),fn=r(Re,"A",{href:!0});var Pc=i(fn);Er=n(Pc,"sample()"),Pc.forEach(o),Or=n(Re," if "),io=r(Re,"CODE",{});var Dc=i(io);Gr=n(Dc,"num_beams=1"),Dc.forEach(o),qr=n(Re,` and
...
`),vo=r(Ze,"CODE",{});var tp=i(vo);_i=n(tp,"force_words_ids!=None"),tp.forEach(o),hi=n(Ze,"."),Ze.forEach(o),ie.forEach(o),fi=g(G),v(ot.$$.fragment,G),bi=g(G),wt=r(G,"P",{});var Ms=i(wt);xi=n(Ms,"Most of these parameters are explained in more detail in "),Mt=r(Ms,"A",{href:!0,rel:!0});var np=i(Mt);ki=n(np,`this blog
post`),np.forEach(o),vi=n(Ms,"."),Ms.forEach(o),yi=g(G),yo=r(G,"P",{});var op=i(yo);ji=n(op,"Examples:"),op.forEach(o),wi=g(G),v(st.$$.fragment,G),Mi=g(G),v(at.$$.fragment,G),Li=g(G),v(rt.$$.fragment,G),G.forEach(o),$i=g(O),be=r(O,"DIV",{class:!0});var $n=i(be);v(Lt.$$.fragment,$n),Ti=g($n),$t=r($n,"P",{});var Ls=i($t);Ei=n(Ls,"Generates sequences of token ids for models with a language modeling head using "),jo=r(Ls,"STRONG",{});var sp=i(jo);Oi=n(sp,"greedy decoding"),sp.forEach(o),Gi=n(Ls,` and can be
used for text-decoder, text-to-text, speech-to-text, and vision-to-text models.`),Ls.forEach(o),qi=g($n),v(it.$$.fragment,$n),$n.forEach(o),Si=g(O),xe=r(O,"DIV",{class:!0});var Tn=i(xe);v(Tt.$$.fragment,Tn),Fi=g(Tn),Et=r(Tn,"P",{});var $s=i(Et);Ai=n($s,"Generates sequences of token ids for models with a language modeling head using "),wo=r($s,"STRONG",{});var ap=i(wo);zi=n(ap,"multinomial sampling"),ap.forEach(o),Pi=n($s,` and
can be used for text-decoder, text-to-text, speech-to-text, and vision-to-text models.`),$s.forEach(o),Di=g(Tn),v(lt.$$.fragment,Tn),Tn.forEach(o),Ni=g(O),ke=r(O,"DIV",{class:!0});var En=i(ke);v(Ot.$$.fragment,En),Ci=g(En),Gt=r(En,"P",{});var Ts=i(Gt);Ii=n(Ts,"Generates sequences of token ids for models with a language modeling head using "),Mo=r(Ts,"STRONG",{});var rp=i(Mo);Bi=n(rp,"beam search decoding"),rp.forEach(o),Wi=n(Ts,` and
...
code`),_p.forEach(o),vl=n(Fs,"."),Fs.forEach(o),yl=g(le),me=r(le,"P",{});var bt=i(me);jl=n(bt,"Apart from "),qo=r(bt,"CODE",{});var hp=i(qo);wl=n(hp,"input_ids"),hp.forEach(o),Ml=n(bt," and "),So=r(bt,"CODE",{});var fp=i(So);Ll=n(fp,"attention_mask"),fp.forEach(o),$l=n(bt,`, all the arguments below will default to the value of the attribute
...
post`),xp.forEach(o),Sl=n(As,"."),As.forEach(o),Fl=g(le),v(ut.$$.fragment,le),le.forEach(o),Sn.forEach(o),xs=g(l),qe=r(l,"H2",{class:!0});var zs=i(qe);_t=r(zs,"A",{id:!0,class:!0,href:!0});var kp=i(_t);Fo=r(kp,"SPAN",{});var vp=i(Fo);v(Ut.$$.fragment,vp),vp.forEach(o),kp.forEach(o),Al=g(zs),Ao=r(zs,"SPAN",{});var yp=i(Ao);zl=n(yp,"FlaxGenerationMixin"),yp.forEach(o),zs.forEach(o),ks=g(l),N=r(l,"DIV",{class:!0});var we=i(N);v(Vt.$$.fragment,we),Pl=g(we),Kt=r(we,"P",{});var Ps=i(Kt);Dl=n(Ps,`A class containing all functions for auto-regressive text generation, to be used as a mixin in
`),wn=r(Ps,"A",{href:!0});var jp=i(wn);Nl=n(jp,"FlaxPreTrainedModel"),jp.forEach(o),Cl=n(Ps,"."),Ps.forEach(o),Il=g(we),Zt=r(we,"P",{});var Ds=i(Zt);Bl=n(Ds,"The class exposes "),Mn=r(Ds,"A",{href:!0});var wp=i(Mn);Wl=n(wp,"generate()"),wp.forEach(o),Hl=n(Ds,", which can be used for:"),Ds.forEach(o),Rl=g(we),Se=r(we,"UL",{});var Fn=i(Se);ee=r(Fn,"LI",{});var Xe=i(ee);zo=r(Xe,"EM",{});var Mp=i(zo);Ul=n(Mp,"greedy decoding"),Mp.forEach(o),Vl=n(Xe," by calling "),Po=r(Xe,"CODE",{});var Lp=i(Po);Kl=n(Lp,"_greedy_search()"),Lp.forEach(o),Zl=n(Xe,` if
...
and `),Vo=r(Qe,"CODE",{});var zp=i(Vo);hd=n(zp,"do_sample=False"),zp.forEach(o),fd=n(Qe,"."),Qe.forEach(o),Fn.forEach(o),bd=g(we),A=r(we,"DIV",{class:!0});var de=i(A);v(Xt.$$.fragment,de),xd=g(de),Ko=r(de,"P",{});var Pp=i(Ko);kd=n(Pp,`Generates sequences of token ids for models with a language modeling head. The method supports the following
generation methods for text-decoder, text-to-text, speech-to-text, and vision-to-text models:`),Pp.forEach(o),vd=g(de),Fe=r(de,"UL",{});var An=i(Fe);oe=r(An,"LI",{});var Ye=i(oe);Zo=r(Ye,"EM",{});var Dp=i(Zo);yd=n(Dp,"greedy decoding"),Dp.forEach(o),jd=n(Ye," by calling "),Xo=r(Ye,"CODE",{});var Np=i(Xo);wd=n(Np,"_greedy_search()"),Np.forEach(o),Md=n(Ye,` if
