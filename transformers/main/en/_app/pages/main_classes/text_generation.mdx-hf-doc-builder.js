...
`),mo=a("code"),Tr=t("num_beams>1"),Er=t(" and "),go=a("code"),Or=t("num_beam_groups>1"),Gr=t("."),Sr=m(),X=a("li"),uo=a("em"),qr=t("constrained beam-search decoding"),Fr=t(" by calling "),Ln=a("a"),Ar=t("constrained_beam_search()"),zr=t(`,
...
sampling`),Ol=t(" and can be used for text-decoder, text-to-text, speech-to-text, and vision-to-text models."),Gl=m(),k(ut.$$.fragment),Sl=m(),Me=a("div"),k(It.$$.fragment),ql=m(),Bt=a("p"),Fl=t("Generates sequences of token ids for models with a language modeling head using "),Ho=a("strong"),Al=t("contrastive search"),zl=t(` and can
...
and `),ks=a("code"),Mc=t("do_sample=True"),Lc=t("."),wc=m(),le=a("li"),vs=a("em"),$c=t("beam-search decoding"),Tc=t(" by calling "),ys=a("code"),Ec=t("~generation_utils.FlaxGenerationMixin._beam_search"),Oc=t(" if "),js=a("code"),Gc=t("num_beams>1"),Sc=t(`
and `),Ms=a("code"),qc=t("do_sample=False"),Fc=t("."),Ac=m(),k(vt.$$.fragment),zc=m(),rn=a("p"),Pc=t("Most of these parameters are explained in more detail in "),ln=a("a"),Dc=t(`this blog
post`),Nc=t("."),Cc=m(),k(yt.$$.fragment),this.h()},l(l){const b=Jm('[data-svelte="svelte-1phssyn"]',document.head);d=r(b,"META",{name:!0,content:!0}),b.forEach(o),f=g(l),u=r(l,"H1",{class:!0});var dn=i(u);c=r(dn,"A",{id:!0,class:!0,href:!0});var Ls=i(c);_=r(Ls,"SPAN",{});var ws=i(_);v(s.$$.fragment,ws),ws.forEach(o),Ls.forEach(o),p=g(dn),B=r(dn,"SPAN",{});var $s=i(B);S=n($s,"Generation"),$s.forEach(o),dn.forEach(o),H=g(l),A=r(l,"P",{});var cn=i(A);D=n(cn,"Each framework has a generate method for auto-regressive text generation implemented in their respective "),T=r(cn,"CODE",{});var Ts=i(T);Te=n(Ts,"GenerationMixin"),Ts.forEach(o),Ee=n(cn," class:"),cn.forEach(o),be=g(l),xe=r(l,"UL",{});var De=i(xe);Oe=r(De,"LI",{});var Ne=i(Oe);ra=n(Ne,"PyTorch "),pn=r(Ne,"A",{href:!0});var Es=i(pn);ia=n(Es,"generate()"),Es.forEach(o),la=n(Ne," is implemented in "),mn=r(Ne,"A",{href:!0});var Os=i(mn);da=n(Os,"GenerationMixin"),Os.forEach(o),ca=n(Ne,"."),Ne.forEach(o),pa=g(De),Ge=r(De,"LI",{});var Ce=i(Ge);ma=n(Ce,"TensorFlow "),gn=r(Ce,"A",{href:!0});var Gs=i(gn);ga=n(Gs,"generate()"),Gs.forEach(o),ua=n(Ce," is implemented in "),un=r(Ce,"A",{href:!0});var Ss=i(un);_a=n(Ss,"TFGenerationMixin"),Ss.forEach(o),ha=n(Ce,"."),Ce.forEach(o),fa=g(De),Se=r(De,"LI",{});var Ie=i(Se);ba=n(Ie,"Flax/JAX "),_n=r(Ie,"A",{href:!0});var Ic=i(_n);xa=n(Ic,"generate()"),Ic.forEach(o),ka=n(Ie," is implemented in "),hn=r(Ie,"A",{href:!0});var Bc=i(hn);va=n(Bc,"FlaxGenerationMixin"),Bc.forEach(o),ya=n(Ie,"."),Ie.forEach(o),De.forEach(o),qs=g(l),qe=r(l,"H2",{class:!0});var Cs=i(qe);rt=r(Cs,"A",{id:!0,class:!0,href:!0});var Wc=i(rt);Vn=r(Wc,"SPAN",{});var Hc=i(Vn);v(wt.$$.fragment,Hc),Hc.forEach(o),Wc.forEach(o),ja=g(Cs),Kn=r(Cs,"SPAN",{});var Rc=i(Kn);Ma=n(Rc,"GenerationMixin"),Rc.forEach(o),Cs.forEach(o),Fs=g(l),$=r(l,"DIV",{class:!0});var E=i($);v($t.$$.fragment,E),La=g(E),Tt=r(E,"P",{});var Is=i(Tt);wa=n(Is,"A class containing all functions for auto-regressive text generation, to be used as a mixin in "),fn=r(Is,"A",{href:!0});var Uc=i(fn);$a=n(Uc,"PreTrainedModel"),Uc.forEach(o),Ta=n(Is,"."),Is.forEach(o),Ea=g(E),Et=r(E,"P",{});var Bs=i(Et);Oa=n(Bs,"The class exposes "),bn=r(Bs,"A",{href:!0});var Vc=i(bn);Ga=n(Vc,"generate()"),Vc.forEach(o),Sa=n(Bs,", which can be used for:"),Bs.forEach(o),qa=g(E),q=r(E,"UL",{});var C=i(q);R=r(C,"LI",{});var Be=i(R);Zn=r(Be,"EM",{});var Kc=i(Zn);Fa=n(Kc,"greedy decoding"),Kc.forEach(o),Aa=n(Be," by calling "),xn=r(Be,"A",{href:!0});var Zc=i(xn);za=n(Zc,"greedy_search()"),Zc.forEach(o),Pa=n(Be," if "),Xn=r(Be,"CODE",{});var Xc=i(Xn);Da=n(Xc,"num_beams=1"),Xc.forEach(o),Na=n(Be,` and
...
`),mo=r(Ue,"CODE",{});var hp=i(mo);Tr=n(hp,"num_beams>1"),hp.forEach(o),Er=n(Ue," and "),go=r(Ue,"CODE",{});var fp=i(go);Or=n(fp,"num_beam_groups>1"),fp.forEach(o),Gr=n(Ue,"."),Ue.forEach(o),Sr=g(C),X=r(C,"LI",{});var Ve=i(X);uo=r(Ve,"EM",{});var bp=i(uo);qr=n(bp,"constrained beam-search decoding"),bp.forEach(o),Fr=n(Ve," by calling "),Ln=r(Ve,"A",{href:!0});var xp=i(Ln);Ar=n(xp,"constrained_beam_search()"),xp.forEach(o),zr=n(Ve,`,
...
`),yo=r(Mt,"CODE",{});var Ep=i(yo);si=n(Ep,"penalty_alpha>0."),Ep.forEach(o),ai=n(Mt," and "),jo=r(Mt,"CODE",{});var Op=i(jo);ri=n(Op,"top_k>1"),Op.forEach(o),Mt.forEach(o),ii=g(I),Q=r(I,"LI",{});var Ze=i(Q);Mo=r(Ze,"EM",{});var Gp=i(Mo);li=n(Gp,"multinomial sampling"),Gp.forEach(o),di=n(Ze," by calling "),Tn=r(Ze,"A",{href:!0});var Sp=i(Tn);ci=n(Sp,"sample()"),Sp.forEach(o),pi=n(Ze," if "),Lo=r(Ze,"CODE",{});var qp=i(Lo);mi=n(qp,"num_beams=1"),qp.forEach(o),gi=n(Ze,` and
...
`),Go=r(Je,"CODE",{});var Ip=i(Go);Oi=n(Ip,"num_beams>1"),Ip.forEach(o),Gi=n(Je," and "),So=r(Je,"CODE",{});var Bp=i(So);Si=n(Bp,"do_sample=True"),Bp.forEach(o),qi=n(Je,"."),Je.forEach(o),Fi=g(I),te=r(I,"LI",{});var Qe=i(te);qo=r(Qe,"EM",{});var Wp=i(qo);Ai=n(Wp,"diverse beam-search decoding"),Wp.forEach(o),zi=n(Qe," by calling "),Gn=r(Qe,"A",{href:!0});var Hp=i(Gn);Pi=n(Hp,"group_beam_search()"),Hp.forEach(o),Di=n(Qe,`, if
...
`),Do=r(Ye,"CODE",{});var Xp=i(Do);Xi=n(Xp,"force_words_ids!=None"),Xp.forEach(o),Ji=n(Ye,"."),Ye.forEach(o),I.forEach(o),Qi=g(G),v(it.$$.fragment,G),Yi=g(G),Gt=r(G,"P",{});var Ws=i(Gt);el=n(Ws,"Most of these parameters are explained in more detail in "),St=r(Ws,"A",{href:!0,rel:!0});var Jp=i(St);tl=n(Jp,`this blog
...
sampling`),nm.forEach(o),Ol=n(Vs," and can be used for text-decoder, text-to-text, speech-to-text, and vision-to-text models."),Vs.forEach(o),Gl=g(Cn),v(ut.$$.fragment,Cn),Cn.forEach(o),Sl=g(E),Me=r(E,"DIV",{class:!0});var In=i(Me);v(It.$$.fragment,In),ql=g(In),Bt=r(In,"P",{});var Ks=i(Bt);Fl=n(Ks,"Generates sequences of token ids for models with a language modeling head using "),Ho=r(Ks,"STRONG",{});var om=i(Ho);Al=n(om,"contrastive search"),om.forEach(o),zl=n(Ks,` and can
