...
`),be=l("a"),la=o("timm library"),ra=o(" into a "),Ve=l("a"),ia=o("PreTrainedModel"),fa=o("."),xs=c(),U=l("h2"),te=l("a"),Ot=l("span"),p(ve.$$.fragment),ca=c(),Dt=l("span"),da=o("Writing a custom configuration"),Os=c(),se=l("p"),ha=o(`Before we dive into the model, let\u2019s first write its configuration. The configuration of a model is an object that
...
after checking the validity of a few of them.`),Fs=c(),p($e.$$.fragment),Ss=c(),Qe=l("p"),_a=o("The three important things to remember when writing you own configuration are the following:"),Bs=c(),x=l("ul"),ke=l("li"),ga=o("you have to inherit from "),St=l("code"),ya=o("PretrainedConfig"),wa=o(","),ba=c(),G=l("li"),va=o("the "),Bt=l("code"),$a=o("__init__"),ka=o(" of your "),Ht=l("code"),Ea=o("PretrainedConfig"),ja=o(" must accept any kwargs,"),Ca=c(),K=l("li"),Pa=o("those "),Wt=l("code"),Aa=o("kwargs"),Ta=o(" need to be passed to the superclass "),Lt=l("code"),Ma=o("__init__"),Ra=o("."),Hs=c(),O=l("p"),qa=o(`The inheritance is to make sure you get all the functionality from the \u{1F917} Transformers library, while the two other
...
superclass.`),Ws=c(),D=l("p"),Da=o("Defining a "),Ut=l("code"),Fa=o("model_type"),Sa=o(" for your configuration (here "),Gt=l("code"),Ba=o('model_type="resnet"'),Ha=o(`) is not mandatory, unless you want to
...
library. Here is how we can create a resnet50d config and save it:`),Ys=c(),p(Ee.$$.fragment),zs=c(),A=l("p"),La=o("This will save a file named "),Kt=l("code"),Ya=o("config.json"),za=o(" inside the folder "),Vt=l("code"),Ua=o("custom-resnet"),Ga=o(`. You can then reload your config with the
`),Jt=l("code"),Ka=o("from_pretrained"),Va=o(" method:"),Us=c(),p(je.$$.fragment),Gs=c(),F=l("p"),Ja=o("You can also use any other method of the "),Ze=l("a"),Qa=o("PretrainedConfig"),Xa=o(" class, like "),et=l("a"),Za=o("push_to_hub()"),en=o(` to
directly upload your config to the Hub.`),Ks=c(),V=l("h2"),oe=l("a"),Qt=l("span"),p(Ce.$$.fragment),tn=c(),Xt=l("span"),sn=o("Writing a custom model"),Vs=c(),S=l("p"),on=o(`Now that we have our ResNet configuration, we can go on writing the model. We will actually write two: one that
...
easy to transfer those weights:`),ro=c(),p(Me.$$.fragment),io=c(),H=l("p"),On=o("Now let\u2019s see how to make sure that when we do "),ct=l("a"),Dn=o("save_pretrained()"),Fn=o(" or "),dt=l("a"),Sn=o("push_to_hub()"),Bn=o(`, the
...
in this `),Se=l("a"),Cl=o("model repo"),Pl=o("."),Ro=c(),de=l("p"),Al=o("See the "),wt=l("a"),Tl=o("sharing tutorial"),Ml=o(" for more information on the push to Hub method."),qo=c(),Q=l("h2"),he=l("a"),ws=l("span"),p(Be.$$.fragment),Rl=c(),bs=l("span"),ql=o("Using a model with custom code"),Io=c(),R=l("p"),Il=o(`You can use any configuration, model or tokenizer with custom code files in its repository with the auto-classes and
...
review the model code and author to avoid executing malicious code on your machine. Set `),$s=l("code"),Fl=o("trust_remote_code=True"),Sl=o(` to use
a model with custom code:`),No=c(),p(We.$$.fragment),xo=c(),me=l("p"),Bl=o("It is also strongly encouraged to pass a commit hash as a "),ks=l("code"),Hl=o("revision"),Wl=o(` to make sure the author of the models did not
...
hash of any commit.`),Fo=c(),X=l("h2"),ue=l("a"),Es=l("span"),p(Ye.$$.fragment),Yl=c(),js=l("span"),zl=o("Registering a model with custom code to the auto classes"),So=c(),vt=l("p"),Ul=o(`If you are writing a library that extends \u{1F917} Transformers, you may want to extend the auto classes to include your own
model. This is different from pushing the code to the Hub in the sense that users will need to import your library to
get the custom models (contrarily to automatically downloading the model code from the Hub).`),Bo=c(),L=l("p"),Gl=o("As long as your config has a "),Cs=l("code"),Kl=o("model_type"),Vl=o(` attribute that is different from existing model types, and that your model
classes have the right `),Ps=l("code"),Jl=o("config_class"),Ql=o(" attributes, you can just add them to the auto classes likes this:"),Ho=c(),p(ze.$$.fragment),Wo=c(),q=l("p"),Xl=o("Note that the first argument used when registering your custom config to "),$t=l("a"),Zl=o("AutoConfig"),er=o(" needs to match the "),As=l("code"),tr=o("model_type"),sr=o(`
...
`),be=r(kt,"A",{href:!0,rel:!0});var fr=i(be);la=a(fr,"timm library"),fr.forEach(s),ra=a(kt," into a "),Ve=r(kt,"A",{href:!0});var cr=i(Ve);ia=a(cr,"PreTrainedModel"),cr.forEach(s),fa=a(kt,"."),kt.forEach(s),xs=d(e),U=r(e,"H2",{class:!0});var Yo=i(U);te=r(Yo,"A",{id:!0,class:!0,href:!0});var dr=i(te);Ot=r(dr,"SPAN",{});var hr=i(Ot);_(ve.$$.fragment,hr),hr.forEach(s),dr.forEach(s),ca=d(Yo),Dt=r(Yo,"SPAN",{});var mr=i(Dt);da=a(mr,"Writing a custom configuration"),mr.forEach(s),Yo.forEach(s),Os=d(e),se=r(e,"P",{});var zo=i(se);ha=a(zo,`Before we dive into the model, let\u2019s first write its configuration. The configuration of a model is an object that
will contain all the necessary information to build the model. As we will see in the next section, the model can only
...
configurations will then give us the different types of ResNets that are possible. We then just store those arguments,
after checking the validity of a few of them.`),pr.forEach(s),Fs=d(e),_($e.$$.fragment,e),Ss=d(e),Qe=r(e,"P",{});var _r=i(Qe);_a=a(_r,"The three important things to remember when writing you own configuration are the following:"),_r.forEach(s),Bs=d(e),x=r(e,"UL",{});var Et=i(x);ke=r(Et,"LI",{});var Uo=i(ke);ga=a(Uo,"you have to inherit from "),St=r(Uo,"CODE",{});var gr=i(St);ya=a(gr,"PretrainedConfig"),gr.forEach(s),wa=a(Uo,","),Uo.forEach(s),ba=d(Et),G=r(Et,"LI",{});var jt=i(G);va=a(jt,"the "),Bt=r(jt,"CODE",{});var yr=i(Bt);$a=a(yr,"__init__"),yr.forEach(s),ka=a(jt," of your "),Ht=r(jt,"CODE",{});var wr=i(Ht);Ea=a(wr,"PretrainedConfig"),wr.forEach(s),ja=a(jt," must accept any kwargs,"),jt.forEach(s),Ca=d(Et),K=r(Et,"LI",{});var Ct=i(K);Pa=a(Ct,"those "),Wt=r(Ct,"CODE",{});var br=i(Wt);Aa=a(br,"kwargs"),br.forEach(s),Ta=a(Ct," need to be passed to the superclass "),Lt=r(Ct,"CODE",{});var vr=i(Lt);Ma=a(vr,"__init__"),vr.forEach(s),Ra=a(Ct,"."),Ct.forEach(s),Et.forEach(s),Hs=d(e),O=r(e,"P",{});var Pt=i(O);qa=a(Pt,`The inheritance is to make sure you get all the functionality from the \u{1F917} Transformers library, while the two other
...
superclass.`),Pt.forEach(s),Ws=d(e),D=r(e,"P",{});var At=i(D);Da=a(At,"Defining a "),Ut=r(At,"CODE",{});var Er=i(Ut);Fa=a(Er,"model_type"),Er.forEach(s),Sa=a(At," for your configuration (here "),Gt=r(At,"CODE",{});var jr=i(Gt);Ba=a(jr,'model_type="resnet"'),jr.forEach(s),Ha=a(At,`) is not mandatory, unless you want to
...
library. Here is how we can create a resnet50d config and save it:`),Cr.forEach(s),Ys=d(e),_(Ee.$$.fragment,e),zs=d(e),A=r(e,"P",{});var pe=i(A);La=a(pe,"This will save a file named "),Kt=r(pe,"CODE",{});var Pr=i(Kt);Ya=a(Pr,"config.json"),Pr.forEach(s),za=a(pe," inside the folder "),Vt=r(pe,"CODE",{});var Ar=i(Vt);Ua=a(Ar,"custom-resnet"),Ar.forEach(s),Ga=a(pe,`. You can then reload your config with the
`),Jt=r(pe,"CODE",{});var Tr=i(Jt);Ka=a(Tr,"from_pretrained"),Tr.forEach(s),Va=a(pe," method:"),pe.forEach(s),Us=d(e),_(je.$$.fragment,e),Gs=d(e),F=r(e,"P",{});var Tt=i(F);Ja=a(Tt,"You can also use any other method of the "),Ze=r(Tt,"A",{href:!0});var Mr=i(Ze);Qa=a(Mr,"PretrainedConfig"),Mr.forEach(s),Xa=a(Tt," class, like "),et=r(Tt,"A",{href:!0});var Rr=i(et);Za=a(Rr,"push_to_hub()"),Rr.forEach(s),en=a(Tt,` to
directly upload your config to the Hub.`),Tt.forEach(s),Ks=d(e),V=r(e,"H2",{class:!0});var Go=i(V);oe=r(Go,"A",{id:!0,class:!0,href:!0});var qr=i(oe);Qt=r(qr,"SPAN",{});var Ir=i(Qt);_(Ce.$$.fragment,Ir),Ir.forEach(s),qr.forEach(s),tn=d(Go),Xt=r(Go,"SPAN",{});var Nr=i(Xt);sn=a(Nr,"Writing a custom model"),Nr.forEach(s),Go.forEach(s),Vs=d(e),S=r(e,"P",{});var Mt=i(S);on=a(Mt,`Now that we have our ResNet configuration, we can go on writing the model. We will actually write two: one that
...
you want to register your model with the auto classes (see last section).`),Y.forEach(s),to=d(e),_(ne.$$.fragment,e),so=d(e),B=r(e,"P",{});var Rt=i(B);$n=a(Rt,`You can have your model return anything you want, but returning a dictionary like we did for
...
training loop or another library for training.`),Rt.forEach(s),oo=d(e),nt=r(e,"P",{});var zr=i(nt);Pn=a(zr,"Now that we have our model class, let\u2019s create one:"),zr.forEach(s),ao=d(e),_(Te.$$.fragment,e),no=d(e),T=r(e,"P",{});var _e=i(T);An=a(_e,"Again, you can use any of the methods of "),lt=r(_e,"A",{href:!0});var Ur=i(lt);Tn=a(Ur,"PreTrainedModel"),Ur.forEach(s),Mn=a(_e,", like "),rt=r(_e,"A",{href:!0});var Gr=i(rt);Rn=a(Gr,"save_pretrained()"),Gr.forEach(s),qn=a(_e,` or
...
we will use the pretrained version of the resnet50d. Since our model is just a wrapper around it, it\u2019s going to be
easy to transfer those weights:`),Vr.forEach(s),ro=d(e),_(Me.$$.fragment,e),io=d(e),H=r(e,"P",{});var qt=i(H);On=a(qt,"Now let\u2019s see how to make sure that when we do "),ct=r(qt,"A",{href:!0});var Jr=i(ct);Dn=a(Jr,"save_pretrained()"),Jr.forEach(s),Fn=a(qt," or "),dt=r(qt,"A",{href:!0});var Qr=i(dt);Sn=a(Qr,"push_to_hub()"),Qr.forEach(s),Bn=a(qt,`, the
...
in this `),Se=r(ge,"A",{href:!0,rel:!0});var bi=i(Se);Cl=a(bi,"model repo"),bi.forEach(s),Pl=a(ge,"."),ge.forEach(s),Ro=d(e),de=r(e,"P",{});var Xo=i(de);Al=a(Xo,"See the "),wt=r(Xo,"A",{href:!0});var vi=i(wt);Tl=a(vi,"sharing tutorial"),vi.forEach(s),Ml=a(Xo," for more information on the push to Hub method."),Xo.forEach(s),qo=d(e),Q=r(e,"H2",{class:!0});var Zo=i(Q);he=r(Zo,"A",{id:!0,class:!0,href:!0});var $i=i(he);ws=r($i,"SPAN",{});var ki=i(ws);_(Be.$$.fragment,ki),ki.forEach(s),$i.forEach(s),Rl=d(Zo),bs=r(Zo,"SPAN",{});var Ei=i(bs);ql=a(Ei,"Using a model with custom code"),Ei.forEach(s),Zo.forEach(s),Io=d(e),R=r(e,"P",{});var ye=i(R);Il=a(ye,`You can use any configuration, model or tokenizer with custom code files in its repository with the auto-classes and
...
review the model code and author to avoid executing malicious code on your machine. Set `),$s=r(ye,"CODE",{});var Pi=i($s);Fl=a(Pi,"trust_remote_code=True"),Pi.forEach(s),Sl=a(ye,` to use
a model with custom code:`),ye.forEach(s),No=d(e),_(We.$$.fragment,e),xo=d(e),me=r(e,"P",{});var ea=i(me);Bl=a(ea,"It is also strongly encouraged to pass a commit hash as a "),ks=r(ea,"CODE",{});var Ai=i(ks);Hl=a(Ai,"revision"),Ai.forEach(s),Wl=a(ea,` to make sure the author of the models did not
