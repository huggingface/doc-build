import{S as Hi,i as Bi,s as Si,e as l,k as c,w as p,t as o,M as Wi,c as r,d as s,m as d,a as i,x as _,h as n,b as h,F as t,g as f,y as g,q as y,o as w,B as b}from"../chunks/vendor-6b77c823.js";import{T as ar}from"../chunks/Tip-39098574.js";import{I as Nt}from"../chunks/IconCopyLink-7a11ce68.js";import{C as E}from"../chunks/CodeBlock-3a8b25a8.js";function Li(z){let m,k;return{c(){m=l("p"),k=o("If your model is very similar to a model inside the library, you can re-use the same configuration as this model.")},l(u){m=r(u,"P",{});var v=i(m);k=n(v,"If your model is very similar to a model inside the library, you can re-use the same configuration as this model."),v.forEach(s)},m(u,v){f(u,m,v),t(m,k)},d(u){u&&s(m)}}}function Yi(z){let m,k;return{c(){m=l("p"),k=o("This API is experimental and may have some slight breaking changes in the next releases.")},l(u){m=r(u,"P",{});var v=i(m);k=n(v,"This API is experimental and may have some slight breaking changes in the next releases."),v.forEach(s)},m(u,v){f(u,m,v),t(m,k)},d(u){u&&s(m)}}}function zi(z){let m,k,u,v,G;return{c(){m=l("p"),k=o(`If copying a modeling files from the library, you will need to replace all the relative imports at the top of the file
to import from the `),u=l("code"),v=o("transformers"),G=o(" package.")},l(P){m=r(P,"P",{});var I=i(m);k=n(I,`If copying a modeling files from the library, you will need to replace all the relative imports at the top of the file
to import from the `),u=r(I,"CODE",{});var ee=i(u);v=n(ee,"transformers"),ee.forEach(s),G=n(I," package."),I.forEach(s)},m(P,I){f(P,m,I),t(m,k),t(m,u),t(u,v),t(m,G)},d(P){P&&s(m)}}}function Gi(z){let m,k,u,v,G,P,I,ee,sn,qs,Ke,on,Is,Ue,nn,Ns,N,an,be,ln,rn,Ve,fn,cn,xs,K,te,xt,ve,dn,Ot,hn,Os,se,mn,Dt,un,pn,Ds,Je,_n,Fs,$e,Hs,Qe,gn,Bs,x,ke,yn,Ft,wn,bn,vn,U,$n,Ht,kn,En,Bt,jn,Cn,Pn,V,An,St,Tn,Mn,Wt,Rn,qn,Ss,O,In,Lt,Nn,xn,Yt,On,Dn,Ws,D,Fn,zt,Hn,Bn,Gt,Sn,Wn,Ls,Xe,Ln,Ys,Ee,zs,A,Yn,Kt,zn,Gn,Ut,Kn,Un,Vt,Vn,Jn,Gs,je,Ks,F,Qn,Ze,Xn,Zn,et,ea,ta,Us,J,oe,Jt,Ce,sa,Qt,oa,Vs,H,na,tt,aa,la,Xt,ra,ia,Js,ne,fa,Zt,ca,da,Qs,Pe,Xs,st,ha,Zs,Ae,eo,C,ma,es,ua,pa,ts,_a,ga,ss,ya,wa,os,ba,va,to,ae,so,B,$a,ns,ka,Ea,ot,ja,Ca,oo,nt,Pa,no,Te,ao,T,Aa,at,Ta,Ma,lt,Ra,qa,rt,Ia,Na,lo,it,xa,ro,Me,io,S,Oa,ft,Da,Fa,ct,Ha,Ba,fo,Q,le,as,Re,Sa,ls,Wa,co,re,ho,$,La,rs,Ya,za,is,Ga,Ka,fs,Ua,Va,cs,Ja,Qa,ds,Xa,Za,hs,el,tl,ms,sl,ol,mo,qe,uo,W,nl,us,al,ll,ps,rl,il,po,ie,_o,dt,fl,go,ht,cl,yo,Ie,wo,fe,dl,_s,hl,ml,bo,Ne,vo,ce,ul,mt,pl,_l,$o,ut,gl,ko,xe,Eo,pt,yl,jo,Oe,Co,_t,wl,Po,De,Ao,gt,bl,To,Fe,Mo,M,vl,gs,$l,kl,ys,El,jl,He,Cl,Pl,Ro,de,Al,yt,Tl,Ml,qo,X,he,ws,Be,Rl,bs,ql,Io,R,Il,vs,Nl,xl,Se,Ol,Dl,$s,Fl,Hl,No,We,xo,me,Bl,ks,Sl,Wl,Oo,Le,Do,wt,Ll,Fo,Z,ue,Es,Ye,Yl,js,zl,Ho,bt,Gl,Bo,L,Kl,Cs,Ul,Vl,Ps,Jl,Ql,So,ze,Wo,q,Xl,vt,Zl,er,As,tr,sr,Ts,or,nr,Lo;return P=new Nt({}),ve=new Nt({}),$e=new E({props:{code:`from transformers import PretrainedConfig
...
AutoModel.register(ResnetConfig, ResnetModel)
AutoModelForImageClassification.register(ResnetConfig, ResnetModelForImageClassification)`}}),{c(){m=l("meta"),k=c(),u=l("h1"),v=l("a"),G=l("span"),p(P.$$.fragment),I=c(),ee=l("span"),sn=o("Sharing custom models"),qs=c(),Ke=l("p"),on=o(`The \u{1F917} Transformers library is designed to be easily extensible. Every model is fully coded in a given subfolder
...
`),be=l("a"),ln=o("timm library"),rn=o(" into a "),Ve=l("a"),fn=o("PreTrainedModel"),cn=o("."),xs=c(),K=l("h2"),te=l("a"),xt=l("span"),p(ve.$$.fragment),dn=c(),Ot=l("span"),hn=o("Writing a custom configuration"),Os=c(),se=l("p"),mn=o(`Before we dive into the model, let\u2019s first write its configuration. The configuration of a model is an object that
will contain all the necessary information to build the model. As we will see in the next section, the model can only
take a `),Dt=l("code"),un=o("config"),pn=o(" to be initialized, so we really need that object to be as complete as possible."),Ds=c(),Je=l("p"),_n=o(`In our example, we will take a couple of arguments of the ResNet class that we might want to tweak. Different
...
contains the code of `),hs=l("code"),el=o("ResnetModel"),tl=o(" and "),ms=l("code"),sl=o("ResnetModelForImageClassification"),ol=o("."),mo=c(),p(qe.$$.fragment),uo=c(),W=l("p"),nl=o("The "),us=l("code"),al=o("__init__.py"),ll=o(" can be empty, it\u2019s just there so that Python detects "),ps=l("code"),rl=o("resnet_model"),il=o(" can be use as a module."),po=c(),p(ie.$$.fragment),_o=c(),dt=l("p"),fl=o("Note that you can re-use (or subclass) an existing configuration/model."),go=c(),ht=l("p"),cl=o(`To share your model with the community, follow those steps: first import the ResNet model and config from the newly
...
`),be=r($t,"A",{href:!0,rel:!0});var fr=i(be);ln=n(fr,"timm library"),fr.forEach(s),rn=n($t," into a "),Ve=r($t,"A",{href:!0});var cr=i(Ve);fn=n(cr,"PreTrainedModel"),cr.forEach(s),cn=n($t,"."),$t.forEach(s),xs=d(e),K=r(e,"H2",{class:!0});var Yo=i(K);te=r(Yo,"A",{id:!0,class:!0,href:!0});var dr=i(te);xt=r(dr,"SPAN",{});var hr=i(xt);_(ve.$$.fragment,hr),hr.forEach(s),dr.forEach(s),dn=d(Yo),Ot=r(Yo,"SPAN",{});var mr=i(Ot);hn=n(mr,"Writing a custom configuration"),mr.forEach(s),Yo.forEach(s),Os=d(e),se=r(e,"P",{});var zo=i(se);mn=n(zo,`Before we dive into the model, let\u2019s first write its configuration. The configuration of a model is an object that
will contain all the necessary information to build the model. As we will see in the next section, the model can only
take a `),Dt=r(zo,"CODE",{});var ur=i(Dt);un=n(ur,"config"),ur.forEach(s),pn=n(zo," to be initialized, so we really need that object to be as complete as possible."),zo.forEach(s),Ds=d(e),Je=r(e,"P",{});var pr=i(Je);_n=n(pr,`In our example, we will take a couple of arguments of the ResNet class that we might want to tweak. Different
configurations will then give us the different types of ResNets that are possible. We then just store those arguments,
...
contains the code of `),hs=r(j,"CODE",{});var li=i(hs);el=n(li,"ResnetModel"),li.forEach(s),tl=n(j," and "),ms=r(j,"CODE",{});var ri=i(ms);sl=n(ri,"ResnetModelForImageClassification"),ri.forEach(s),ol=n(j,"."),j.forEach(s),mo=d(e),_(qe.$$.fragment,e),uo=d(e),W=r(e,"P",{});var qt=i(W);nl=n(qt,"The "),us=r(qt,"CODE",{});var ii=i(us);al=n(ii,"__init__.py"),ii.forEach(s),ll=n(qt," can be empty, it\u2019s just there so that Python detects "),ps=r(qt,"CODE",{});var fi=i(ps);rl=n(fi,"resnet_model"),fi.forEach(s),il=n(qt," can be use as a module."),qt.forEach(s),po=d(e),_(ie.$$.fragment,e),_o=d(e),dt=r(e,"P",{});var ci=i(dt);fl=n(ci,"Note that you can re-use (or subclass) an existing configuration/model."),ci.forEach(s),go=d(e),ht=r(e,"P",{});var di=i(ht);cl=n(di,`To share your model with the community, follow those steps: first import the ResNet model and config from the newly
created files:`),di.forEach(s),yo=d(e),_(Ie.$$.fragment,e),wo=d(e),fe=r(e,"P",{});var Jo=i(fe);dl=n(Jo,"Then you have to tell the library you want to copy the code files of those objects when using the "),_s=r(Jo,"CODE",{});var hi=i(_s);hl=n(hi,"save_pretrained"),hi.forEach(s),ml=n(Jo,`
method and properly register them with a given Auto class (especially for models), just run:`),Jo.forEach(s),bo=d(e),_(Ne.$$.fragment,e),vo=d(e),ce=r(e,"P",{});var Qo=i(ce);ul=n(Qo,`Note that there is no need to specify an auto class for the configuration (there is only one auto class for them,
`),mt=r(Qo,"A",{href:!0});var mi=i(mt);pl=n(mi,"AutoConfig"),mi.forEach(s),_l=n(Qo,`) but it\u2019s different for models. Your custom model could be suitable for many different tasks, so you
have to specify which one of the auto classes is the correct one for your model.`),Qo.forEach(s),$o=d(e),ut=r(e,"P",{});var ui=i(ut);gl=n(ui,"Next, let\u2019s create the config and models as we did before:"),ui.forEach(s),ko=d(e),_(xe.$$.fragment,e),Eo=d(e),pt=r(e,"P",{});var pi=i(pt);yl=n(pi,"Now to send the model to the Hub, make sure you are logged in. Either run in your terminal:"),pi.forEach(s),jo=d(e),_(Oe.$$.fragment,e),Co=d(e),_t=r(e,"P",{});var _i=i(_t);wl=n(_i,"or from a notebook:"),_i.forEach(s),Po=d(e),_(De.$$.fragment,e),Ao=d(e),gt=r(e,"P",{});var gi=i(gt);bl=n(gi,"You can then push to to your own namespace (or an organization you are a member of) like this:"),gi.forEach(s),To=d(e),_(Fe.$$.fragment,e),Mo=d(e),M=r(e,"P",{});var ge=i(M);vl=n(ge,`On top of the modeling weights and the configuration in json format, this also copied the modeling and
...
a model with custom code:`),ye.forEach(s),No=d(e),_(We.$$.fragment,e),xo=d(e),me=r(e,"P",{});var en=i(me);Bl=n(en,"It is also strongly encouraged to pass a commit hash as a "),ks=r(en,"CODE",{});var Ai=i(ks);Sl=n(Ai,"revision"),Ai.forEach(s),Wl=n(en,` to make sure the author of the models did not
