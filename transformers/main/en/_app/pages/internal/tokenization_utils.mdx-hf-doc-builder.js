...
<span class="hljs-built_in">print</span>(<span class="hljs-string">&quot;We have added&quot;</span>, num_added_toks, <span class="hljs-string">&quot;tokens&quot;</span>)
<span class="hljs-comment"># Notice: resize_token_embeddings expect to receive the full size of the new vocabulary, i.e., the length of the tokenizer.</span>
model.resize_token_embeddings(<span class="hljs-built_in">len</span>(tokenizer))`}}),{c(){p=r("p"),$=o("Examples:"),f=d(),k(h.$$.fragment)},l(c){p=s(c,"P",{});var g=a(p);$=n(g,"Examples:"),g.forEach(t),f=l(c),b(h.$$.fragment,c)},m(c,g){P(c,p,g),e(p,$),P(c,f,g),v(h,c,g),x=!0},p:ks,i(c){x||(T(h.$$.fragment,c),x=!0)},o(c){y(h.$$.fragment,c),x=!1},d(c){c&&t(p),c&&t(f),w(h,c)}}}function Km(E){let p,$,f,h,x,c,g,L,ge,W,D,no,ro,vs,Ts,so,ys,ws,ao,zs,xs,io,$s,Ps,qr,lo,qs,Er,_e,Le,Fo,st,Es,Co,Bs,Br,u,at,Ls,ke,Ds,co,Is,Ns,po,As,Ss,Fs,Oo,Cs,Os,Wo,Ws,js,I,Z,jo,Rs,Us,Ro,Ms,Vs,Uo,Gs,Hs,Xs,S,Mo,Ys,Js,Vo,Ks,Qs,Go,Zs,ea,Ho,ta,oa,Xo,na,ra,sa,M,Yo,aa,ia,Jo,da,la,Ko,ca,pa,Qo,ma,ha,ua,F,Zo,fa,ga,en,_a,ka,tn,ba,va,on,Ta,ya,mo,wa,za,xa,De,nn,$a,Pa,rn,qa,Ea,Ba,V,sn,La,Da,an,Ia,Na,dn,Aa,Sa,ln,Fa,Ca,Oa,G,cn,Wa,ja,pn,Ra,Ua,mn,Ma,Va,hn,Ga,Ha,Xa,Ie,it,Ya,un,Ja,Ka,Ne,dt,Qa,fn,Za,ei,Ae,lt,ti,gn,oi,ni,ee,ct,ri,_n,si,ai,Se,ii,te,pt,di,kn,li,ci,bn,pi,mi,Fe,mt,hi,vn,ui,fi,Ce,ht,gi,ut,_i,Tn,ki,bi,vi,oe,ft,Ti,ho,yi,uo,wi,zi,yn,xi,$i,ne,gt,Pi,wn,qi,Ei,_t,Bi,zn,Li,Di,Ii,re,kt,Ni,xn,Ai,Si,bt,Fi,$n,Ci,Oi,Wi,se,vt,ji,Pn,Ri,Ui,Oe,Mi,H,Tt,Vi,yt,Gi,fo,Hi,Xi,Yi,We,Ji,je,Ki,Re,wt,Qi,be,Zi,qn,ed,td,En,od,nd,rd,ae,zt,sd,Bn,ad,id,ie,Ln,dd,ld,Dn,cd,pd,In,md,hd,ud,X,xt,fd,Nn,gd,_d,J,kd,An,bd,vd,Sn,Td,yd,Fn,wd,zd,xd,Ue,$d,Me,$t,Pd,j,qd,Cn,Ed,Bd,On,Ld,Dd,Wn,Id,Nd,jn,Ad,Sd,Fd,Ve,Pt,Cd,Rn,Od,Wd,de,qt,jd,Et,Rd,Un,Ud,Md,Vd,Ge,Gd,le,Bt,Hd,Lt,Xd,Mn,Yd,Jd,Kd,He,Qd,Y,Dt,Zd,Vn,el,tl,It,ol,Gn,nl,rl,sl,Nt,al,Hn,il,dl,ll,ce,At,cl,Xn,pl,ml,St,hl,Yn,ul,fl,gl,Xe,Ft,_l,Ct,kl,Jn,bl,vl,Tl,Ye,Ot,yl,Kn,wl,Lr,ve,Je,Qn,Wt,zl,Zn,xl,Dr,A,jt,$l,Te,Pl,go,ql,El,_o,Bl,Ll,Dl,B,Rt,Il,er,Nl,Al,tr,Sl,Fl,Ut,Cl,ko,Ol,Wl,jl,Mt,Rl,or,Ul,Ml,Vl,Vt,nr,Gl,Hl,Gt,Xl,rr,Yl,Jl,Kl,R,Ql,bo,Zl,ec,sr,tc,oc,ar,nc,rc,ir,sc,ac,ic,Ke,dc,C,Ht,lc,dr,cc,pc,lr,mc,hc,Xt,uc,vo,fc,gc,_c,Qe,kc,pe,Yt,bc,ye,vc,cr,Tc,yc,pr,wc,zc,xc,mr,$c,Ir,we,Ze,hr,Jt,Pc,ur,qc,Nr,ze,Kt,Ec,xe,Bc,fr,Lc,Dc,et,Ic,gr,Nc,Ac,Sc,Ar,$e,Qt,Fc,_r,Cc,Sr,Pe,Zt,Oc,kr,Wc,Fr;return c=new gs({}),st=new gs({}),at=new q({props:{name:"class transformers.PreTrainedTokenizerBase",anchor:"transformers.PreTrainedTokenizerBase",parameters:[{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.PreTrainedTokenizerBase.model_max_length",description:`<strong>model_max_length</strong> (<code>int</code>, <em>optional</em>) &#x2014;
...
**kwargs &#x2014; passed to the <code>self.tokenize()</code> method`,name:"verbose"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/tokenization_utils_base.py#L2429",returnDescription:`
<p>A <a
...
Will be passed to the underlying model specific decode method.`,name:"kwargs"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/tokenization_utils_base.py#L3303",returnDescription:`
...
Whether or not to print more information and warnings.
**kwargs &#x2014; passed to the <code>self.tokenize()</code> method`,name:"verbose"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/tokenization_utils_base.py#L2652",returnDescription:`
<p>A <a
  href="/docs/transformers/main/en/main_classes/tokenizer#transformers.BatchEncoding"
>BatchEncoding</a> with the following fields:</p>
<ul>
...
Will be passed to the underlying model specific decode method.`,name:"kwargs"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/tokenization_utils_base.py#L3336",returnDescription:`
...
<p>**kwargs &#x2014; Passed along to the <code>.tokenize()</code> method.`,name:"return_tensors"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/tokenization_utils_base.py#L2239",returnDescription:`
...
Whether or not to print more information and warnings.
**kwargs &#x2014; passed to the <code>self.tokenize()</code> method`,name:"verbose"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/tokenization_utils_base.py#L2556",returnDescription:`
<p>A <a
  href="/docs/transformers/main/en/main_classes/tokenizer#transformers.BatchEncoding"
>BatchEncoding</a> with the following fields:</p>
<ul>
...
Whether or not the token list is already formatted with special tokens for the model.`,name:"already_has_special_tokens"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/tokenization_utils_base.py#L3381",returnDescription:`
<p>1 for a special token, 0 for a sequence token.</p>
`,returnType:`
<p>A list of integers in the range [0, 1]</p>
`}}),zt=new q({props:{name:"get_vocab",anchor:"transformers.PreTrainedTokenizerBase.get_vocab",parameters:[],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/tokenization_utils_base.py#L1557",returnDescription:`
<p>The vocabulary.</p>
`,returnType:`
...
Whether or not to print more information and warnings.
**kwargs &#x2014; passed to the <code>self.tokenize()</code> method`,name:"verbose"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/tokenization_utils_base.py#L2956",returnDescription:`
<p>A <a
  href="/docs/transformers/main/en/main_classes/tokenizer#transformers.BatchEncoding"
>BatchEncoding</a> with the following fields:</p>
<ul>
...
</ul>`,name:"truncation"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/tokenization_utils_base.py#L3491",returnDescription:`
<p>A <a
  href="/docs/transformers/main/en/main_classes/tokenizer#transformers.BatchEncoding"
>BatchEncoding</a> with the following fields:</p>
<ul>
...
<code>repo_url</code> is not specified.`,name:"use_auth_token"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/utils/hub.py#L855",returnDescription:`
...
folder. Pass along <code>temp_dir=True</code> to use a temporary directory instead.</p>
					...
					</div>`,name:"push_to_hub"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/tokenization_utils_base.py#L2038",returnDescription:`
<p>The files saved.</p>
`,returnType:`
...
An optional prefix to add to the named of the saved files.`,name:"filename_prefix"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/tokenization_utils_base.py#L2201",returnDescription:`
...
<a href="/docs/transformers/main/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__"><strong>call</strong>()</a>`,name:"kwargs"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/tokenization_utils_base.py#L2219",returnDescription:`
...
sequence returned. The value of this argument defines the number of additional tokens.`,name:"stride"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/tokenization_utils_base.py#L3092",returnDescription:`
...
assign the index of the <code>unk_token</code> to them).`,name:"special_tokens_dict"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/tokenization_utils_base.py#L844",returnDescription:`
...
or `),Qo=r("code"),ma=o("None"),ha=o(" if the model has no maximum input size."),ua=d(),F=r("li"),Zo=r("strong"),fa=o("pretrained_init_configuration"),ga=o(" ("),en=r("code"),_a=o("Dict[str, Dict[str, Any]]"),ka=o(`) \u2014 A dictionary with, as keys, the
...
sequence-to-sequence models that need a slightly different processing for the labels.`),ei=d(),Ae=r("div"),k(lt.$$.fragment),ti=d(),gn=r("p"),oi=o("Convert a list of lists of token ids into a list of strings by calling decode."),ni=d(),ee=r("div"),k(ct.$$.fragment),ri=d(),_n=r("p"),si=o("Tokenize and prepare for the model a list of sequences or a list of pairs of sequences."),ai=d(),k(Se.$$.fragment),ii=d(),te=r("div"),k(pt.$$.fragment),di=d(),kn=r("p"),li=o(`Build model inputs from a sequence or a pair of sequence for sequence classification tasks by concatenating and
...
of the pretrained models, and as associated values, the maximum length of the sequence inputs of this model,
or `),Qo=s(qe,"CODE",{});var ip=a(Qo);ma=n(ip,"None"),ip.forEach(t),ha=n(qe," if the model has no maximum input size."),qe.forEach(t),ua=l(O),F=s(O,"LI",{});var Q=a(F);Zo=s(Q,"STRONG",{});var dp=a(Zo);fa=n(dp,"pretrained_init_configuration"),dp.forEach(t),ga=n(Q," ("),en=s(Q,"CODE",{});var lp=a(en);_a=n(lp,"Dict[str, Dict[str, Any]]"),lp.forEach(t),ka=n(Q,`) \u2014 A dictionary with, as keys, the
...
sequence-to-sequence models that need a slightly different processing for the labels.`),zp.forEach(t),Wr.forEach(t),ei=l(_),Ae=s(_,"DIV",{class:!0});var jr=a(Ae);b(lt.$$.fragment,jr),ti=l(jr),gn=s(jr,"P",{});var xp=a(gn);oi=n(xp,"Convert a list of lists of token ids into a list of strings by calling decode."),xp.forEach(t),jr.forEach(t),ni=l(_),ee=s(_,"DIV",{class:!0});var yo=a(ee);b(ct.$$.fragment,yo),ri=l(yo),_n=s(yo,"P",{});var $p=a(_n);si=n($p,"Tokenize and prepare for the model a list of sequences or a list of pairs of sequences."),$p.forEach(t),ai=l(yo),b(Se.$$.fragment,yo),yo.forEach(t),ii=l(_),te=s(_,"DIV",{class:!0});var wo=a(te);b(pt.$$.fragment,wo),di=l(wo),kn=s(wo,"P",{});var Pp=a(kn);li=n(Pp,`Build model inputs from a sequence or a pair of sequence for sequence classification tasks by concatenating and
adding special tokens.`),Pp.forEach(t),ci=l(wo),bn=s(wo,"P",{});var qp=a(bn);pi=n(qp,"This implementation does not add special tokens and this method should be overridden in a subclass."),qp.forEach(t),wo.forEach(t),mi=l(_),Fe=s(_,"DIV",{class:!0});var Rr=a(Fe);b(mt.$$.fragment,Rr),hi=l(Rr),vn=s(Rr,"P",{});var Ep=a(vn);ui=n(Ep,"Clean up a list of simple English tokenization artifacts like spaces before punctuations and abbreviated forms."),Ep.forEach(t),Rr.forEach(t),fi=l(_),Ce=s(_,"DIV",{class:!0});var Ur=a(Ce);b(ht.$$.fragment,Ur),gi=l(Ur),ut=s(Ur,"P",{});var Mr=a(ut);_i=n(Mr,"Converts a sequence of tokens in a single string. The most simple way to do it is "),Tn=s(Mr,"CODE",{});var Bp=a(Tn);ki=n(Bp,'" ".join(tokens)'),Bp.forEach(t),bi=n(Mr,` but we
...
tokens and clean up tokenization spaces.`),Ip.forEach(t),Ei=l(xo),_t=s(xo,"P",{});var Vr=a(_t);Bi=n(Vr,"Similar to doing "),zn=s(Vr,"CODE",{});var Np=a(zn);Li=n(Np,"self.convert_tokens_to_string(self.convert_ids_to_tokens(token_ids))"),Np.forEach(t),Di=n(Vr,"."),Vr.forEach(t),xo.forEach(t),Ii=l(_),re=s(_,"DIV",{class:!0});var $o=a(re);b(kt.$$.fragment,$o),Ni=l($o),xn=s($o,"P",{});var Ap=a(xn);Ai=n(Ap,"Converts a string to a sequence of ids (integer), using the tokenizer and vocabulary."),Ap.forEach(t),Si=l($o),bt=s($o,"P",{});var Gr=a(bt);Fi=n(Gr,"Same as doing "),$n=s(Gr,"CODE",{});var Sp=a($n);Ci=n(Sp,"self.convert_tokens_to_ids(self.tokenize(text))"),Sp.forEach(t),Oi=n(Gr,"."),Gr.forEach(t),$o.forEach(t),Wi=l(_),se=s(_,"DIV",{class:!0});var Po=a(se);b(vt.$$.fragment,Po),ji=l(Po),Pn=s(Po,"P",{});var Fp=a(Pn);Ri=n(Fp,"Tokenize and prepare for the model a sequence or a pair of sequences."),Fp.forEach(t),Ui=l(Po),b(Oe.$$.fragment,Po),Po.forEach(t),Mi=l(_),H=s(_,"DIV",{class:!0});var tt=a(H);b(Tt.$$.fragment,tt),Vi=l(tt),yt=s(tt,"P",{});var Hr=a(yt);Gi=n(Hr,"Instantiate a "),fo=s(Hr,"A",{href:!0});var Cp=a(fo);Hi=n(Cp,"PreTrainedTokenizerBase"),Cp.forEach(t),Xi=n(Hr,` (or a derived class) from a predefined
