...
<span class="hljs-built_in">print</span>(<span class="hljs-string">&quot;We have added&quot;</span>, num_added_toks, <span class="hljs-string">&quot;tokens&quot;</span>)
<span class="hljs-comment"># Notice: resize_token_embeddings expect to receive the full size of the new vocabulary, i.e., the length of the tokenizer.</span>
model.resize_token_embeddings(<span class="hljs-built_in">len</span>(tokenizer))`}}),{c(){p=r("p"),$=o("Examples:"),f=d(),k(h.$$.fragment)},l(c){p=s(c,"P",{});var _=a(p);$=n(_,"Examples:"),_.forEach(t),f=l(c),b(h.$$.fragment,c)},m(c,_){P(c,p,_),e(p,$),P(c,f,_),v(h,c,_),x=!0},p:ks,i(c){x||(T(h.$$.fragment,c),x=!0)},o(c){y(h.$$.fragment,c),x=!1},d(c){c&&t(p),c&&t(f),z(h,c)}}}function Km(E){let p,$,f,h,x,c,_,L,_e,W,D,no,ro,vs,Ts,so,ys,zs,ao,ws,xs,io,$s,Ps,qr,lo,qs,Er,ge,Le,So,st,Es,Co,Bs,Br,u,at,Ls,ke,Ds,co,Is,Ns,po,As,Fs,Ss,Oo,Cs,Os,Wo,Ws,js,I,Z,jo,Rs,Us,Ro,Ms,Vs,Uo,Gs,Hs,Xs,F,Mo,Ys,Js,Vo,Ks,Qs,Go,Zs,ea,Ho,ta,oa,Xo,na,ra,sa,M,Yo,aa,ia,Jo,da,la,Ko,ca,pa,Qo,ma,ha,ua,S,Zo,fa,_a,en,ga,ka,tn,ba,va,on,Ta,ya,mo,za,wa,xa,De,nn,$a,Pa,rn,qa,Ea,Ba,V,sn,La,Da,an,Ia,Na,dn,Aa,Fa,ln,Sa,Ca,Oa,G,cn,Wa,ja,pn,Ra,Ua,mn,Ma,Va,hn,Ga,Ha,Xa,Ie,it,Ya,un,Ja,Ka,Ne,dt,Qa,fn,Za,ei,Ae,lt,ti,_n,oi,ni,ee,ct,ri,gn,si,ai,Fe,ii,te,pt,di,kn,li,ci,bn,pi,mi,Se,mt,hi,vn,ui,fi,Ce,ht,_i,ut,gi,Tn,ki,bi,vi,oe,ft,Ti,ho,yi,uo,zi,wi,yn,xi,$i,ne,_t,Pi,zn,qi,Ei,gt,Bi,wn,Li,Di,Ii,re,kt,Ni,xn,Ai,Fi,bt,Si,$n,Ci,Oi,Wi,se,vt,ji,Pn,Ri,Ui,Oe,Mi,H,Tt,Vi,yt,Gi,fo,Hi,Xi,Yi,We,Ji,je,Ki,Re,zt,Qi,be,Zi,qn,ed,td,En,od,nd,rd,ae,wt,sd,Bn,ad,id,ie,Ln,dd,ld,Dn,cd,pd,In,md,hd,ud,X,xt,fd,Nn,_d,gd,J,kd,An,bd,vd,Fn,Td,yd,Sn,zd,wd,xd,Ue,$d,Me,$t,Pd,j,qd,Cn,Ed,Bd,On,Ld,Dd,Wn,Id,Nd,jn,Ad,Fd,Sd,Ve,Pt,Cd,Rn,Od,Wd,de,qt,jd,Et,Rd,Un,Ud,Md,Vd,Ge,Gd,le,Bt,Hd,Lt,Xd,Mn,Yd,Jd,Kd,He,Qd,Y,Dt,Zd,Vn,el,tl,It,ol,Gn,nl,rl,sl,Nt,al,Hn,il,dl,ll,ce,At,cl,Xn,pl,ml,Ft,hl,Yn,ul,fl,_l,Xe,St,gl,Ct,kl,Jn,bl,vl,Tl,Ye,Ot,yl,Kn,zl,Lr,ve,Je,Qn,Wt,wl,Zn,xl,Dr,A,jt,$l,Te,Pl,_o,ql,El,go,Bl,Ll,Dl,B,Rt,Il,er,Nl,Al,tr,Fl,Sl,Ut,Cl,ko,Ol,Wl,jl,Mt,Rl,or,Ul,Ml,Vl,Vt,nr,Gl,Hl,Gt,Xl,rr,Yl,Jl,Kl,R,Ql,bo,Zl,ec,sr,tc,oc,ar,nc,rc,ir,sc,ac,ic,Ke,dc,C,Ht,lc,dr,cc,pc,lr,mc,hc,Xt,uc,vo,fc,_c,gc,Qe,kc,pe,Yt,bc,ye,vc,cr,Tc,yc,pr,zc,wc,xc,mr,$c,Ir,ze,Ze,hr,Jt,Pc,ur,qc,Nr,we,Kt,Ec,xe,Bc,fr,Lc,Dc,et,Ic,_r,Nc,Ac,Fc,Ar,$e,Qt,Sc,gr,Cc,Fr,Pe,Zt,Oc,kr,Wc,Sr;return c=new _s({}),st=new _s({}),at=new q({props:{name:"class transformers.PreTrainedTokenizerBase",anchor:"transformers.PreTrainedTokenizerBase",parameters:[{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.PreTrainedTokenizerBase.model_max_length",description:`<strong>model_max_length</strong> (<code>int</code>, <em>optional</em>) &#x2014;
...
Will be passed to the underlying model specific decode method.`,name:"kwargs"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/tokenization_utils_base.py#L3379",returnDescription:`
...
Whether or not to print more information and warnings.
**kwargs &#x2014; passed to the <code>self.tokenize()</code> method`,name:"verbose"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/tokenization_utils_base.py#L2728",returnDescription:`
<p>A <a
  href="/docs/transformers/main/en/main_classes/tokenizer#transformers.BatchEncoding"
>BatchEncoding</a> with the following fields:</p>
<ul>
...
Will be passed to the underlying model specific decode method.`,name:"kwargs"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/tokenization_utils_base.py#L3412",returnDescription:`
...
<p>**kwargs &#x2014; Passed along to the <code>.tokenize()</code> method.`,name:"return_tensors"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/tokenization_utils_base.py#L2241",returnDescription:`
...
Whether or not the token list is already formatted with special tokens for the model.`,name:"already_has_special_tokens"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/tokenization_utils_base.py#L3457",returnDescription:`
<p>1 for a special token, 0 for a sequence token.</p>
`,returnType:`
<p>A list of integers in the range [0, 1]</p>
`}}),wt=new q({props:{name:"get_vocab",anchor:"transformers.PreTrainedTokenizerBase.get_vocab",parameters:[],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/tokenization_utils_base.py#L1559",returnDescription:`
<p>The vocabulary.</p>
`,returnType:`
...
Whether or not to print more information and warnings.
**kwargs &#x2014; passed to the <code>self.tokenize()</code> method`,name:"verbose"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/tokenization_utils_base.py#L3032",returnDescription:`
<p>A <a
  href="/docs/transformers/main/en/main_classes/tokenizer#transformers.BatchEncoding"
>BatchEncoding</a> with the following fields:</p>
<ul>
...
</ul>`,name:"truncation"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/tokenization_utils_base.py#L3588",returnDescription:`
<p>A <a
  href="/docs/transformers/main/en/main_classes/tokenizer#transformers.BatchEncoding"
>BatchEncoding</a> with the following fields:</p>
<ul>
...
<code>repo_url</code> is not specified.`,name:"use_auth_token"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/utils/hub.py#L872",returnDescription:`
...
folder. Pass along <code>temp_dir=True</code> to use a temporary directory instead.</p>
					...
					</div>`,name:"push_to_hub"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/tokenization_utils_base.py#L2040",returnDescription:`
<p>The files saved.</p>
`,returnType:`
...
An optional prefix to add to the named of the saved files.`,name:"filename_prefix"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/tokenization_utils_base.py#L2203",returnDescription:`
...
<a href="/docs/transformers/main/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.__call__"><strong>call</strong>()</a>`,name:"kwargs"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/tokenization_utils_base.py#L2221",returnDescription:`
...
sequence returned. The value of this argument defines the number of additional tokens.`,name:"stride"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/tokenization_utils_base.py#L3168",returnDescription:`
...
assign the index of the <code>unk_token</code> to them).`,name:"special_tokens_dict"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/tokenization_utils_base.py#L846",returnDescription:`
...
<p>See details for <code>tokenizers.AddedToken</code> in HuggingFace tokenizers library.`,name:"special_tokens"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/tokenization_utils_base.py#L918",returnDescription:`
<p>Number of tokens added to the vocabulary.</p>
`,returnType:`
<p><code>int</code></p>
`}}),Qe=new gs({props:{anchor:"transformers.SpecialTokensMixin.add_tokens.example",$$slots:{default:[Jm]},$$scope:{ctx:E}}}),Yt=new q({props:{name:"sanitize_special_tokens",anchor:"transformers.SpecialTokensMixin.sanitize_special_tokens",parameters:[],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/tokenization_utils_base.py#L834",returnDescription:`
