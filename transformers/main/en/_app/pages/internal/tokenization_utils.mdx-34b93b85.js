import{S as Km,i as Qm,s as Zm,e as r,k as d,w as u,t as n,M as eh,c as s,d as t,m as c,a,x as f,h as o,b as l,F as e,g as $,y as _,q as g,o as k,B as b,v as th}from"../../chunks/vendor-6b77c823.js";import{T as Pr}from"../../chunks/Tip-39098574.js";import{D as w}from"../../chunks/Docstring-90e3aa51.js";import{C as _s}from"../../chunks/CodeBlock-3a8b25a8.js";import{I as gs}from"../../chunks/IconCopyLink-7a11ce68.js";function nh(M){let h,P,v,z,E;return{c(){h=r("p"),P=n("This method is deprecated, "),v=r("code"),z=n("__call__"),E=n(" should be used instead.")},l(y){h=s(y,"P",{});var x=a(h);P=o(x,"This method is deprecated, "),v=s(x,"CODE",{});var B=a(v);z=o(B,"__call__"),B.forEach(t),E=o(x," should be used instead."),x.forEach(t)},m(y,x){$(y,h,x),e(h,P),e(h,v),e(v,z),e(h,E)},d(y){y&&t(h)}}}function oh(M){let h,P,v,z,E;return{c(){h=r("p"),P=n("This method is deprecated, "),v=r("code"),z=n("__call__"),E=n(" should be used instead.")},l(y){h=s(y,"P",{});var x=a(h);P=o(x,"This method is deprecated, "),v=s(x,"CODE",{});var B=a(v);z=o(B,"__call__"),B.forEach(t),E=o(x," should be used instead."),x.forEach(t)},m(y,x){$(y,h,x),e(h,P),e(h,v),e(v,z),e(h,E)},d(y){y&&t(h)}}}function rh(M){let h,P,v,z,E;return{c(){h=r("p"),P=n("Passing "),v=r("code"),z=n("use_auth_token=True"),E=n(" is required when you want to use a private model.")},l(y){h=s(y,"P",{});var x=a(h);P=o(x,"Passing "),v=s(x,"CODE",{});var B=a(v);z=o(B,"use_auth_token=True"),B.forEach(t),E=o(x," is required when you want to use a private model."),x.forEach(t)},m(y,x){$(y,h,x),e(h,P),e(h,v),e(v,z),e(h,E)},d(y){y&&t(h)}}}function sh(M){let h,P,v,z,E,y,x,B;return{c(){h=r("p"),P=n("If the "),v=r("code"),z=n("encoded_inputs"),E=n(` passed are dictionary of numpy arrays, PyTorch tensors or TensorFlow tensors, the
result will use the same type unless you provide a different tensor type with `),y=r("code"),x=n("return_tensors"),B=n(`. In the case of
PyTorch tensors, you will lose the specific device of your tensors however.`)},l(ge){h=s(ge,"P",{});var W=a(h);P=o(W,"If the "),v=s(W,"CODE",{});var D=a(v);z=o(D,"encoded_inputs"),D.forEach(t),E=o(W,` passed are dictionary of numpy arrays, PyTorch tensors or TensorFlow tensors, the
result will use the same type unless you provide a different tensor type with `),y=s(W,"CODE",{});var rn=a(y);x=o(rn,"return_tensors"),rn.forEach(t),B=o(W,`. In the case of
PyTorch tensors, you will lose the specific device of your tensors however.`),W.forEach(t)},m(ge,W){$(ge,h,W),e(h,P),e(h,v),e(v,z),e(h,E),e(h,y),e(y,x),e(h,B)},d(ge){ge&&t(h)}}}function ah(M){let h,P;return{c(){h=r("p"),P=n("This API is experimental and may have some slight breaking changes in the next releases.")},l(v){h=s(v,"P",{});var z=a(h);P=o(z,"This API is experimental and may have some slight breaking changes in the next releases."),z.forEach(t)},m(v,z){$(v,h,z),e(h,P)},d(v){v&&t(h)}}}function ih(M){let h,P,v,z,E,y,x,B,ge,W,D,rn,sn,ks,bs,an,vs,Ts,dn,ys,ws,cn,zs,xs,qr,ln,$s,Er,ke,De,Sn,nt,Ps,Cn,qs,Br,p,ot,Es,be,Bs,pn,Ls,Ds,mn,Is,Ns,As,On,Fs,Ss,Wn,Cs,Os,I,te,jn,Ws,js,Rn,Rs,Us,Un,Ms,Vs,Gs,F,Mn,Hs,Xs,Vn,Ys,Js,Gn,Ks,Qs,Hn,Zs,ea,Xn,ta,na,oa,V,Yn,ra,sa,Jn,aa,ia,Kn,da,ca,Qn,la,pa,ma,S,Zn,ha,ua,eo,fa,_a,to,ga,ka,no,ba,va,hn,Ta,ya,wa,Ie,oo,za,xa,ro,$a,Pa,qa,G,so,Ea,Ba,ao,La,Da,io,Ia,Na,co,Aa,Fa,Sa,H,lo,Ca,Oa,po,Wa,ja,mo,Ra,Ua,ho,Ma,Va,Ga,Ne,rt,Ha,uo,Xa,Ya,Ae,st,Ja,fo,Ka,Qa,Fe,at,Za,_o,ei,ti,ne,it,ni,go,oi,ri,Se,si,oe,dt,ai,ko,ii,di,bo,ci,li,Ce,ct,pi,vo,mi,hi,Oe,lt,ui,pt,fi,To,_i,gi,ki,re,mt,bi,un,vi,fn,Ti,yi,yo,wi,zi,se,ht,xi,wo,$i,Pi,ut,qi,zo,Ei,Bi,Li,ae,ft,Di,xo,Ii,Ni,_t,Ai,$o,Fi,Si,Ci,ie,gt,Oi,Po,Wi,ji,We,Ri,C,kt,Ui,bt,Mi,_n,Vi,Gi,Hi,je,Xi,qo,Yi,Ji,vt,Ki,Re,Tt,Qi,ve,Zi,Eo,ed,td,Bo,nd,od,rd,de,yt,sd,Lo,ad,id,ce,Do,dd,cd,Io,ld,pd,No,md,hd,ud,X,wt,fd,Ao,_d,gd,Q,kd,Fo,bd,vd,So,Td,yd,Co,wd,zd,xd,Ue,$d,Me,zt,Pd,j,qd,Oo,Ed,Bd,Wo,Ld,Dd,jo,Id,Nd,Ro,Ad,Fd,Sd,Ve,xt,Cd,Uo,Od,Wd,Y,$t,jd,Pt,Rd,Mo,Ud,Md,Vd,Vo,Gd,Hd,qt,Xd,le,Et,Yd,Bt,Jd,Go,Kd,Qd,Zd,Ge,ec,J,Lt,tc,Ho,nc,oc,Dt,rc,Xo,sc,ac,ic,It,dc,Yo,cc,lc,pc,pe,Nt,mc,Jo,hc,uc,At,fc,Ko,_c,gc,kc,He,Ft,bc,St,vc,Qo,Tc,yc,wc,Xe,Ct,zc,Zo,xc,Lr,Te,Ye,er,Ot,$c,tr,Pc,Dr,A,Wt,qc,ye,Ec,gn,Bc,Lc,kn,Dc,Ic,Nc,q,jt,Ac,nr,Fc,Sc,or,Cc,Oc,Rt,Wc,bn,jc,Rc,Uc,Ut,Mc,rr,Vc,Gc,Hc,Mt,sr,Xc,Yc,Vt,Jc,ar,Kc,Qc,Zc,R,el,vn,tl,nl,ir,ol,rl,dr,sl,al,cr,il,dl,cl,lr,ll,pl,Gt,ml,N,Ht,hl,pr,ul,fl,mr,_l,gl,Xt,kl,Tn,bl,vl,Tl,hr,yl,wl,Yt,zl,me,Jt,xl,we,$l,ur,Pl,ql,fr,El,Bl,Ll,_r,Dl,Ir,ze,Je,gr,Kt,Il,kr,Nl,Nr,xe,Qt,Al,$e,Fl,br,Sl,Cl,Ke,Ol,vr,Wl,jl,Rl,Ar,Pe,Zt,Ul,Tr,Ml,Fr,qe,en,Vl,yr,Gl,Sr;return y=new gs({}),nt=new gs({}),ot=new w({props:{name:"class transformers.PreTrainedTokenizerBase",anchor:"transformers.PreTrainedTokenizerBase",parameters:[{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.PreTrainedTokenizerBase.model_max_length",description:`<strong>model_max_length</strong> (<code>int</code>, <em>optional</em>) &#x2014;
...
**kwargs &#x2014; passed to the <code>self.tokenize()</code> method`,name:"verbose"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/tokenization_utils_base.py#L2371",returnDescription:`
<p>A <a
...
Will be passed to the underlying model specific decode method.`,name:"kwargs"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/tokenization_utils_base.py#L3242",returnDescription:`
...
Whether or not to print more information and warnings.
**kwargs &#x2014; passed to the <code>self.tokenize()</code> method`,name:"verbose"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/tokenization_utils_base.py#L2592",returnDescription:`
<p>A <a
  href="/docs/transformers/main/en/main_classes/tokenizer#transformers.BatchEncoding"
>BatchEncoding</a> with the following fields:</p>
<ul>
...
Will be passed to the underlying model specific decode method.`,name:"kwargs"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/tokenization_utils_base.py#L3275",returnDescription:`
...
<p>**kwargs &#x2014; Passed along to the <code>.tokenize()</code> method.`,name:"return_tensors"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/tokenization_utils_base.py#L2181",returnDescription:`
...
Whether or not to print more information and warnings.
**kwargs &#x2014; passed to the <code>self.tokenize()</code> method`,name:"verbose"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/tokenization_utils_base.py#L2496",returnDescription:`
<p>A <a
  href="/docs/transformers/main/en/main_classes/tokenizer#transformers.BatchEncoding"
>BatchEncoding</a> with the following fields:</p>
<ul>
...
<code>additional_special_tokens</code>. See parameters in the <code>__init__</code> for more details.`,name:"kwargs"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/tokenization_utils_base.py#L1546"}}),je=new Pr({props:{$$slots:{default:[rh]},$$scope:{ctx:M}}}),vt=new _s({props:{code:`# We can't instantiate directly the base class *PreTrainedTokenizerBase* so let's show our examples on a derived class: BertTokenizer
...
Whether or not the token list is already formatted with special tokens for the model.`,name:"already_has_special_tokens"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/tokenization_utils_base.py#L3320",returnDescription:`
<p>1 for a special token, 0 for a sequence token.</p>
`,returnType:`
<p>A list of integers in the range [0, 1]</p>
`}}),yt=new w({props:{name:"get_vocab",anchor:"transformers.PreTrainedTokenizerBase.get_vocab",parameters:[],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/tokenization_utils_base.py#L1534",returnDescription:`
<p>The vocabulary.</p>
`,returnType:`
...
Whether or not to print more information and warnings.
**kwargs &#x2014; passed to the <code>self.tokenize()</code> method`,name:"verbose"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/tokenization_utils_base.py#L2896",returnDescription:`
<p>A <a
  href="/docs/transformers/main/en/main_classes/tokenizer#transformers.BatchEncoding"
>BatchEncoding</a> with the following fields:</p>
<ul>
...
</ul>`,name:"truncation"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/tokenization_utils_base.py#L3430",returnDescription:`
<p>A <a
  href="/docs/transformers/main/en/main_classes/tokenizer#transformers.BatchEncoding"
>BatchEncoding</a> with the following fields:</p>
<ul>
...
folder. Pass along <code>temp_dir=True</code> to use a temporary directory instead.</p>
					...
					</div>`,name:"push_to_hub"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/tokenization_utils_base.py#L1982",returnDescription:`
<p>The files saved.</p>
`,returnType:`
...
An optional prefix to add to the named of the saved files.`,name:"filename_prefix"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/tokenization_utils_base.py#L2143",returnDescription:`
...
<a href="/docs/transformers/main/en/model_doc/wav2vec2_phoneme#transformers.Wav2Vec2PhonemeCTCTokenizer.__call__"><strong>call</strong>()</a>`,name:"kwargs"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/tokenization_utils_base.py#L2161",returnDescription:`
...
sequence returned. The value of this argument defines the number of additional tokens.`,name:"stride"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/tokenization_utils_base.py#L3032",returnDescription:`
...
assign the index of the <code>unk_token</code> to them).`,name:"special_tokens_dict"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/tokenization_utils_base.py#L828",returnDescription:`
...
<p>See details for <code>tokenizers.AddedToken</code> in HuggingFace tokenizers library.`,name:"special_tokens"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/tokenization_utils_base.py#L900",returnDescription:`
<p>Number of tokens added to the vocabulary.</p>
`,returnType:`
<p><code>int</code></p>
...
<span class="hljs-built_in">print</span>(<span class="hljs-string">&quot;We have added&quot;</span>, num_added_toks, <span class="hljs-string">&quot;tokens&quot;</span>)
<span class="hljs-comment"># Notice: resize_token_embeddings expect to receive the full size of the new vocabulary, i.e., the length of the tokenizer.</span>
model.resize_token_embeddings(<span class="hljs-built_in">len</span>(tokenizer))`}}),Jt=new w({props:{name:"sanitize_special_tokens",anchor:"transformers.SpecialTokensMixin.sanitize_special_tokens",parameters:[],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/tokenization_utils_base.py#L816",returnDescription:`
<p>The number of tokens added in the vocabulary during the operation.</p>
`,returnType:`
<p><code>int</code></p>
`}}),Kt=new gs({}),Qt=new w({props:{name:"class transformers.tokenization_utils_base.TruncationStrategy",anchor:"transformers.tokenization_utils_base.TruncationStrategy",parameters:[{name:"value",val:""},{name:"names",val:" = None"},{name:"module",val:" = None"},{name:"qualname",val:" = None"},{name:"type",val:" = None"},{name:"start",val:" = 1"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/tokenization_utils_base.py#L123"}}),Zt=new w({props:{name:"class transformers.CharSpan",anchor:"transformers.CharSpan",parameters:[{name:"start",val:": int"},{name:"end",val:": int"}],parametersDescription:[{anchor:"transformers.CharSpan.start",description:"<strong>start</strong> (<code>int</code>) &#x2014; Index of the first character in the original string.",name:"start"},{anchor:"transformers.CharSpan.end",description:"<strong>end</strong> (<code>int</code>) &#x2014; Index of the character following the last character in the original string.",name:"end"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/tokenization_utils_base.py#L135"}}),en=new w({props:{name:"class transformers.TokenSpan",anchor:"transformers.TokenSpan",parameters:[{name:"start",val:": int"},{name:"end",val:": int"}],parametersDescription:[{anchor:"transformers.TokenSpan.start",description:"<strong>start</strong> (<code>int</code>) &#x2014; Index of the first token in the span.",name:"start"},{anchor:"transformers.TokenSpan.end",description:"<strong>end</strong> (<code>int</code>) &#x2014; Index of the token following the last token in the span.",name:"end"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/tokenization_utils_base.py#L148"}}),{c(){h=r("meta"),P=d(),v=r("h1"),z=r("a"),E=r("span"),u(y.$$.fragment),x=d(),B=r("span"),ge=n("Utilities for Tokenizers"),W=d(),D=r("p"),rn=n(`This page lists all the utility functions used by the tokenizers, mainly the class
`),sn=r("a"),ks=n("PreTrainedTokenizerBase"),bs=n(` that implements the common methods between
`),an=r("a"),vs=n("PreTrainedTokenizer"),Ts=n(" and "),dn=r("a"),ys=n("PreTrainedTokenizerFast"),ws=n(` and the mixin
`),cn=r("a"),zs=n("SpecialTokensMixin"),xs=n("."),qr=d(),ln=r("p"),$s=n("Most of those are only useful if you are studying the code of the tokenizers in the library."),Er=d(),ke=r("h2"),De=r("a"),Sn=r("span"),u(nt.$$.fragment),Ps=d(),Cn=r("span"),qs=n("PreTrainedTokenizerBase"),Br=d(),p=r("div"),u(ot.$$.fragment),Es=d(),be=r("p"),Bs=n("Base class for "),pn=r("a"),Ls=n("PreTrainedTokenizer"),Ds=n(" and "),mn=r("a"),Is=n("PreTrainedTokenizerFast"),Ns=n("."),As=d(),On=r("p"),Fs=n("Handles shared (mostly boiler plate) methods for those two classes."),Ss=d(),Wn=r("p"),Cs=n("Class attributes (overridden by derived classes)"),Os=d(),I=r("ul"),te=r("li"),jn=r("strong"),Ws=n("vocab_files_names"),js=n(" ("),Rn=r("code"),Rs=n("Dict[str, str]"),Us=n(") \u2014 A dictionary with, as keys, the "),Un=r("code"),Ms=n("__init__"),Vs=n(` keyword name of each
vocabulary file required by the model, and as associated values, the filename for saving the associated file
(string).`),Gs=d(),F=r("li"),Mn=r("strong"),Hs=n("pretrained_vocab_files_map"),Xs=n(" ("),Vn=r("code"),Ys=n("Dict[str, Dict[str, str]]"),Js=n(`) \u2014 A dictionary of dictionaries, with the
high-level keys being the `),Gn=r("code"),Ks=n("__init__"),Qs=n(` keyword name of each vocabulary file required by the model, the
low-level being the `),Hn=r("code"),Zs=n("short-cut-names"),ea=n(" of the pretrained models with, as associated values, the "),Xn=r("code"),ta=n("url"),na=n(` to the
associated pretrained vocabulary file.`),oa=d(),V=r("li"),Yn=r("strong"),ra=n("max_model_input_sizes"),sa=n(" ("),Jn=r("code"),aa=n("Dict[str, Optional[int]]"),ia=n(") \u2014 A dictionary with, as keys, the "),Kn=r("code"),da=n("short-cut-names"),ca=n(`
of the pretrained models, and as associated values, the maximum length of the sequence inputs of this model,
or `),Qn=r("code"),la=n("None"),pa=n(" if the model has no maximum input size."),ma=d(),S=r("li"),Zn=r("strong"),ha=n("pretrained_init_configuration"),ua=n(" ("),eo=r("code"),fa=n("Dict[str, Dict[str, Any]]"),_a=n(`) \u2014 A dictionary with, as keys, the
`),to=r("code"),ga=n("short-cut-names"),ka=n(` of the pretrained models, and as associated values, a dictionary of specific arguments to
pass to the `),no=r("code"),ba=n("__init__"),va=n(` method of the tokenizer class for this pretrained model when loading the tokenizer
with the `),hn=r("a"),Ta=n("from_pretrained()"),ya=n(" method."),wa=d(),Ie=r("li"),oo=r("strong"),za=n("model_input_names"),xa=n(" ("),ro=r("code"),$a=n("List[str]"),Pa=n(") \u2014 A list of inputs expected in the forward pass of the model."),qa=d(),G=r("li"),so=r("strong"),Ea=n("padding_side"),Ba=n(" ("),ao=r("code"),La=n("str"),Da=n(`) \u2014 The default value for the side on which the model should have padding applied.
Should be `),io=r("code"),Ia=n("'right'"),Na=n(" or "),co=r("code"),Aa=n("'left'"),Fa=n("."),Sa=d(),H=r("li"),lo=r("strong"),Ca=n("truncation_side"),Oa=n(" ("),po=r("code"),Wa=n("str"),ja=n(`) \u2014 The default value for the side on which the model should have truncation
applied. Should be `),mo=r("code"),Ra=n("'right'"),Ua=n(" or "),ho=r("code"),Ma=n("'left'"),Va=n("."),Ga=d(),Ne=r("div"),u(rt.$$.fragment),Ha=d(),uo=r("p"),Xa=n(`Main method to tokenize and prepare for the model one or several sequence(s) or one or several pair(s) of
sequences.`),Ya=d(),Ae=r("div"),u(st.$$.fragment),Ja=d(),fo=r("p"),Ka=n(`Temporarily sets the tokenizer for encoding the targets. Useful for tokenizer associated to
sequence-to-sequence models that need a slightly different processing for the labels.`),Qa=d(),Fe=r("div"),u(at.$$.fragment),Za=d(),_o=r("p"),ei=n("Convert a list of lists of token ids into a list of strings by calling decode."),ti=d(),ne=r("div"),u(it.$$.fragment),ni=d(),go=r("p"),oi=n("Tokenize and prepare for the model a list of sequences or a list of pairs of sequences."),ri=d(),u(Se.$$.fragment),si=d(),oe=r("div"),u(dt.$$.fragment),ai=d(),ko=r("p"),ii=n(`Build model inputs from a sequence or a pair of sequence for sequence classification tasks by concatenating and
adding special tokens.`),di=d(),bo=r("p"),ci=n("This implementation does not add special tokens and this method should be overridden in a subclass."),li=d(),Ce=r("div"),u(ct.$$.fragment),pi=d(),vo=r("p"),mi=n("Clean up a list of simple English tokenization artifacts like spaces before punctuations and abbreviated forms."),hi=d(),Oe=r("div"),u(lt.$$.fragment),ui=d(),pt=r("p"),fi=n("Converts a sequence of tokens in a single string. The most simple way to do it is "),To=r("code"),_i=n('" ".join(tokens)'),gi=n(` but we
often want to remove sub-word tokenization artifacts at the same time.`),ki=d(),re=r("div"),u(mt.$$.fragment),bi=d(),un=r("p"),vi=n("Create the token type IDs corresponding to the sequences passed. "),fn=r("a"),Ti=n(`What are token type
IDs?`),yi=d(),yo=r("p"),wi=n("Should be overridden in a subclass if the model has a special way of building those."),zi=d(),se=r("div"),u(ht.$$.fragment),xi=d(),wo=r("p"),$i=n(`Converts a sequence of ids in a string, using the tokenizer and vocabulary with options to remove special
tokens and clean up tokenization spaces.`),Pi=d(),ut=r("p"),qi=n("Similar to doing "),zo=r("code"),Ei=n("self.convert_tokens_to_string(self.convert_ids_to_tokens(token_ids))"),Bi=n("."),Li=d(),ae=r("div"),u(ft.$$.fragment),Di=d(),xo=r("p"),Ii=n("Converts a string to a sequence of ids (integer), using the tokenizer and vocabulary."),Ni=d(),_t=r("p"),Ai=n("Same as doing "),$o=r("code"),Fi=n("self.convert_tokens_to_ids(self.tokenize(text))"),Si=n("."),Ci=d(),ie=r("div"),u(gt.$$.fragment),Oi=d(),Po=r("p"),Wi=n("Tokenize and prepare for the model a sequence or a pair of sequences."),ji=d(),u(We.$$.fragment),Ri=d(),C=r("div"),u(kt.$$.fragment),Ui=d(),bt=r("p"),Mi=n("Instantiate a "),_n=r("a"),Vi=n("PreTrainedTokenizerBase"),Gi=n(` (or a derived class) from a predefined
tokenizer.`),Hi=d(),u(je.$$.fragment),Xi=d(),qo=r("p"),Yi=n("Examples:"),Ji=d(),u(vt.$$.fragment),Ki=d(),Re=r("div"),u(Tt.$$.fragment),Qi=d(),ve=r("p"),Zi=n(`Retrieves sequence ids from a token list that has no special tokens added. This method is called when adding
special tokens using the tokenizer `),Eo=r("code"),ed=n("prepare_for_model"),td=n(" or "),Bo=r("code"),nd=n("encode_plus"),od=n(" methods."),rd=d(),de=r("div"),u(yt.$$.fragment),sd=d(),Lo=r("p"),ad=n("Returns the vocabulary as a dictionary of token to index."),id=d(),ce=r("p"),Do=r("code"),dd=n("tokenizer.get_vocab()[token]"),cd=n(" is equivalent to "),Io=r("code"),ld=n("tokenizer.convert_tokens_to_ids(token)"),pd=n(" when "),No=r("code"),md=n("token"),hd=n(` is in the
vocab.`),ud=d(),X=r("div"),u(wt.$$.fragment),fd=d(),Ao=r("p"),_d=n(`Pad a single encoded input or a batch of encoded inputs up to predefined length or to the max sequence length
in the batch.`),gd=d(),Q=r("p"),kd=n("Padding side (left/right) padding token ids are defined at the tokenizer level (with "),Fo=r("code"),bd=n("self.padding_side"),vd=n(`,
`),So=r("code"),Td=n("self.pad_token_id"),yd=n(" and "),Co=r("code"),wd=n("self.pad_token_type_id"),zd=n(")"),xd=d(),u(Ue.$$.fragment),$d=d(),Me=r("div"),u(zt.$$.fragment),Pd=d(),j=r("p"),qd=n(`Prepares a sequence of input id, or a pair of sequences of inputs ids so that it can be used by the model. It
adds special tokens, truncates sequences if overflowing while taking into account the special tokens and
manages a moving window (with user defined stride) for overflowing tokens. Please Note, for `),Oo=r("em"),Ed=n("pair_ids"),Bd=n(`
different than `),Wo=r("code"),Ld=n("None"),Dd=n(" and "),jo=r("em"),Id=n("truncation_strategy = longest_first"),Nd=n(" or "),Ro=r("code"),Ad=n("True"),Fd=n(`, it is not possible to return
overflowing tokens. Such a combination of arguments will raise an error.`),Sd=d(),Ve=r("div"),u(xt.$$.fragment),Cd=d(),Uo=r("p"),Od=n("Prepare model inputs for translation. For best performance, translate one sentence at a time."),Wd=d(),Y=r("div"),u($t.$$.fragment),jd=d(),Pt=r("p"),Rd=n(`Upload the tokenizer files to the \u{1F917} Model Hub while synchronizing a local clone of the repo in
`),Mo=r("code"),Ud=n("repo_path_or_name"),Md=n("."),Vd=d(),Vo=r("p"),Gd=n("Examples:"),Hd=d(),u(qt.$$.fragment),Xd=d(),le=r("div"),u(Et.$$.fragment),Yd=d(),Bt=r("p"),Jd=n(`Register this class with a given auto class. This should only be used for custom tokenizers as the ones in the
library are already mapped with `),Go=r("code"),Kd=n("AutoTokenizer"),Qd=n("."),Zd=d(),u(Ge.$$.fragment),ec=d(),J=r("div"),u(Lt.$$.fragment),tc=d(),Ho=r("p"),nc=n("Save the full tokenizer state."),oc=d(),Dt=r("p"),rc=n(`This method make sure the full tokenizer can then be re-loaded using the
`),Xo=r("code"),sc=n("from_pretrained"),ac=n(" class method.."),ic=d(),It=r("p"),dc=n(`Warning,None This won\u2019t save modifications you may have applied to the tokenizer after the instantiation (for
instance, modifying `),Yo=r("code"),cc=n("tokenizer.do_lower_case"),lc=n(" after creation)."),pc=d(),pe=r("div"),u(Nt.$$.fragment),mc=d(),Jo=r("p"),hc=n("Save only the vocabulary of the tokenizer (vocabulary + added tokens)."),uc=d(),At=r("p"),fc=n(`This method won\u2019t save the configuration and special token mappings of the tokenizer. Use
`),Ko=r("code"),_c=n("_save_pretrained()"),gc=n(" to save the whole state of the tokenizer."),kc=d(),He=r("div"),u(Ft.$$.fragment),bc=d(),St=r("p"),vc=n("Converts a string in a sequence of tokens, replacing unknown tokens with the "),Qo=r("code"),Tc=n("unk_token"),yc=n("."),wc=d(),Xe=r("div"),u(Ct.$$.fragment),zc=d(),Zo=r("p"),xc=n("Truncates a sequence pair in-place following the strategy."),Lr=d(),Te=r("h2"),Ye=r("a"),er=r("span"),u(Ot.$$.fragment),$c=d(),tr=r("span"),Pc=n("SpecialTokensMixin"),Dr=d(),A=r("div"),u(Wt.$$.fragment),qc=d(),ye=r("p"),Ec=n("A mixin derived by "),gn=r("a"),Bc=n("PreTrainedTokenizer"),Lc=n(" and "),kn=r("a"),Dc=n("PreTrainedTokenizerFast"),Ic=n(` to handle specific behaviors related to
special tokens. In particular, this class hold the attributes which can be used to directly access these special
tokens in a model-independent manner and allow to set and update the special tokens.`),Nc=d(),q=r("div"),u(jt.$$.fragment),Ac=d(),nr=r("p"),Fc=n(`Add a dictionary of special tokens (eos, pad, cls, etc.) to the encoder and link them to class attributes. If
special tokens are NOT in the vocabulary, they are added to it (indexed starting from the last index of the
current vocabulary).`),Sc=d(),or=r("p"),Cc=n(`Note,None When adding new tokens to the vocabulary, you should make sure to also resize the token embedding
matrix of the model so that its embedding matrix matches the tokenizer.`),Oc=d(),Rt=r("p"),Wc=n("In order to do that, please use the "),bn=r("a"),jc=n("resize_token_embeddings()"),Rc=n(" method."),Uc=d(),Ut=r("p"),Mc=n("Using "),rr=r("code"),Vc=n("add_special_tokens"),Gc=n(" will ensure your special tokens can be used in several ways:"),Hc=d(),Mt=r("ul"),sr=r("li"),Xc=n("Special tokens are carefully handled by the tokenizer (they are never split)."),Yc=d(),Vt=r("li"),Jc=n("You can easily refer to special tokens using tokenizer class attributes like "),ar=r("code"),Kc=n("tokenizer.cls_token"),Qc=n(`. This
makes it easy to develop model-agnostic training and fine-tuning scripts.`),Zc=d(),R=r("p"),el=n(`When possible, special tokens are already registered for provided pretrained models (for instance
`),vn=r("a"),tl=n("BertTokenizer"),nl=d(),ir=r("code"),ol=n("cls_token"),rl=n(" is already registered to be :obj"),dr=r("em"),sl=n("\u2019[CLS]\u2019"),al=n(` and XLM\u2019s one is also registered to be
`),cr=r("code"),il=n("'</s>'"),dl=n(")."),cl=d(),lr=r("p"),ll=n("Examples:"),pl=d(),u(Gt.$$.fragment),ml=d(),N=r("div"),u(Ht.$$.fragment),hl=d(),pr=r("p"),ul=n(`Add a list of new tokens to the tokenizer class. If the new tokens are not in the vocabulary, they are added to
it with indices starting from length of the current vocabulary.`),fl=d(),mr=r("p"),_l=n(`Note,None When adding new tokens to the vocabulary, you should make sure to also resize the token embedding
matrix of the model so that its embedding matrix matches the tokenizer.`),gl=d(),Xt=r("p"),kl=n("In order to do that, please use the "),Tn=r("a"),bl=n("resize_token_embeddings()"),vl=n(" method."),Tl=d(),hr=r("p"),yl=n("Examples:"),wl=d(),u(Yt.$$.fragment),zl=d(),me=r("div"),u(Jt.$$.fragment),xl=d(),we=r("p"),$l=n("Make sure that all the special tokens attributes of the tokenizer ("),ur=r("code"),Pl=n("tokenizer.mask_token"),ql=n(`,
`),fr=r("code"),El=n("tokenizer.cls_token"),Bl=n(", etc.) are in the vocabulary."),Ll=d(),_r=r("p"),Dl=n("Add the missing ones to the vocabulary if needed."),Ir=d(),ze=r("h2"),Je=r("a"),gr=r("span"),u(Kt.$$.fragment),Il=d(),kr=r("span"),Nl=n("Enums and namedtuples"),Nr=d(),xe=r("div"),u(Qt.$$.fragment),Al=d(),$e=r("p"),Fl=n("Possible values for the "),br=r("code"),Sl=n("truncation"),Cl=n(" argument in "),Ke=r("a"),Ol=n("PreTrainedTokenizerBase."),vr=r("strong"),Wl=n("call"),jl=n("()"),Rl=n(`. Useful for tab-completion in
an IDE.`),Ar=d(),Pe=r("div"),u(Zt.$$.fragment),Ul=d(),Tr=r("p"),Ml=n("Character span in the original string."),Fr=d(),qe=r("div"),u(en.$$.fragment),Vl=d(),yr=r("p"),Gl=n("Token span in an encoded string (list of tokens)."),this.h()},l(i){const T=eh('[data-svelte="svelte-1phssyn"]',document.head);h=s(T,"META",{name:!0,content:!0}),T.forEach(t),P=c(i),v=s(i,"H1",{class:!0});var tn=a(v);z=s(tn,"A",{id:!0,class:!0,href:!0});var wr=a(z);E=s(wr,"SPAN",{});var zr=a(E);f(y.$$.fragment,zr),zr.forEach(t),wr.forEach(t),x=c(tn),B=s(tn,"SPAN",{});var xr=a(B);ge=o(xr,"Utilities for Tokenizers"),xr.forEach(t),tn.forEach(t),W=c(i),D=s(i,"P",{});var U=a(D);rn=o(U,`This page lists all the utility functions used by the tokenizers, mainly the class
`),sn=s(U,"A",{href:!0});var Xl=a(sn);ks=o(Xl,"PreTrainedTokenizerBase"),Xl.forEach(t),bs=o(U,` that implements the common methods between
`),an=s(U,"A",{href:!0});var Yl=a(an);vs=o(Yl,"PreTrainedTokenizer"),Yl.forEach(t),Ts=o(U," and "),dn=s(U,"A",{href:!0});var Jl=a(dn);ys=o(Jl,"PreTrainedTokenizerFast"),Jl.forEach(t),ws=o(U,` and the mixin
`),cn=s(U,"A",{href:!0});var Kl=a(cn);zs=o(Kl,"SpecialTokensMixin"),Kl.forEach(t),xs=o(U,"."),U.forEach(t),qr=c(i),ln=s(i,"P",{});var Ql=a(ln);$s=o(Ql,"Most of those are only useful if you are studying the code of the tokenizers in the library."),Ql.forEach(t),Er=c(i),ke=s(i,"H2",{class:!0});var Cr=a(ke);De=s(Cr,"A",{id:!0,class:!0,href:!0});var Zl=a(De);Sn=s(Zl,"SPAN",{});var ep=a(Sn);f(nt.$$.fragment,ep),ep.forEach(t),Zl.forEach(t),Ps=c(Cr),Cn=s(Cr,"SPAN",{});var tp=a(Cn);qs=o(tp,"PreTrainedTokenizerBase"),tp.forEach(t),Cr.forEach(t),Br=c(i),p=s(i,"DIV",{class:!0});var m=a(p);f(ot.$$.fragment,m),Es=c(m),be=s(m,"P",{});var yn=a(be);Bs=o(yn,"Base class for "),pn=s(yn,"A",{href:!0});var np=a(pn);Ls=o(np,"PreTrainedTokenizer"),np.forEach(t),Ds=o(yn," and "),mn=s(yn,"A",{href:!0});var op=a(mn);Is=o(op,"PreTrainedTokenizerFast"),op.forEach(t),Ns=o(yn,"."),yn.forEach(t),As=c(m),On=s(m,"P",{});var rp=a(On);Fs=o(rp,"Handles shared (mostly boiler plate) methods for those two classes."),rp.forEach(t),Ss=c(m),Wn=s(m,"P",{});var sp=a(Wn);Cs=o(sp,"Class attributes (overridden by derived classes)"),sp.forEach(t),Os=c(m),I=s(m,"UL",{});var O=a(I);te=s(O,"LI",{});var nn=a(te);jn=s(nn,"STRONG",{});var ap=a(jn);Ws=o(ap,"vocab_files_names"),ap.forEach(t),js=o(nn," ("),Rn=s(nn,"CODE",{});var ip=a(Rn);Rs=o(ip,"Dict[str, str]"),ip.forEach(t),Us=o(nn,") \u2014 A dictionary with, as keys, the "),Un=s(nn,"CODE",{});var dp=a(Un);Ms=o(dp,"__init__"),dp.forEach(t),Vs=o(nn,` keyword name of each
vocabulary file required by the model, and as associated values, the filename for saving the associated file
(string).`),nn.forEach(t),Gs=c(O),F=s(O,"LI",{});var Z=a(F);Mn=s(Z,"STRONG",{});var cp=a(Mn);Hs=o(cp,"pretrained_vocab_files_map"),cp.forEach(t),Xs=o(Z," ("),Vn=s(Z,"CODE",{});var lp=a(Vn);Ys=o(lp,"Dict[str, Dict[str, str]]"),lp.forEach(t),Js=o(Z,`) \u2014 A dictionary of dictionaries, with the
high-level keys being the `),Gn=s(Z,"CODE",{});var pp=a(Gn);Ks=o(pp,"__init__"),pp.forEach(t),Qs=o(Z,` keyword name of each vocabulary file required by the model, the
low-level being the `),Hn=s(Z,"CODE",{});var mp=a(Hn);Zs=o(mp,"short-cut-names"),mp.forEach(t),ea=o(Z," of the pretrained models with, as associated values, the "),Xn=s(Z,"CODE",{});var hp=a(Xn);ta=o(hp,"url"),hp.forEach(t),na=o(Z,` to the
associated pretrained vocabulary file.`),Z.forEach(t),oa=c(O),V=s(O,"LI",{});var Ee=a(V);Yn=s(Ee,"STRONG",{});var up=a(Yn);ra=o(up,"max_model_input_sizes"),up.forEach(t),sa=o(Ee," ("),Jn=s(Ee,"CODE",{});var fp=a(Jn);aa=o(fp,"Dict[str, Optional[int]]"),fp.forEach(t),ia=o(Ee,") \u2014 A dictionary with, as keys, the "),Kn=s(Ee,"CODE",{});var _p=a(Kn);da=o(_p,"short-cut-names"),_p.forEach(t),ca=o(Ee,`
of the pretrained models, and as associated values, the maximum length of the sequence inputs of this model,
or `),Qn=s(Ee,"CODE",{});var gp=a(Qn);la=o(gp,"None"),gp.forEach(t),pa=o(Ee," if the model has no maximum input size."),Ee.forEach(t),ma=c(O),S=s(O,"LI",{});var ee=a(S);Zn=s(ee,"STRONG",{});var kp=a(Zn);ha=o(kp,"pretrained_init_configuration"),kp.forEach(t),ua=o(ee," ("),eo=s(ee,"CODE",{});var bp=a(eo);fa=o(bp,"Dict[str, Dict[str, Any]]"),bp.forEach(t),_a=o(ee,`) \u2014 A dictionary with, as keys, the
`),to=s(ee,"CODE",{});var vp=a(to);ga=o(vp,"short-cut-names"),vp.forEach(t),ka=o(ee,` of the pretrained models, and as associated values, a dictionary of specific arguments to
pass to the `),no=s(ee,"CODE",{});var Tp=a(no);ba=o(Tp,"__init__"),Tp.forEach(t),va=o(ee,` method of the tokenizer class for this pretrained model when loading the tokenizer
with the `),hn=s(ee,"A",{href:!0});var yp=a(hn);Ta=o(yp,"from_pretrained()"),yp.forEach(t),ya=o(ee," method."),ee.forEach(t),wa=c(O),Ie=s(O,"LI",{});var $r=a(Ie);oo=s($r,"STRONG",{});var wp=a(oo);za=o(wp,"model_input_names"),wp.forEach(t),xa=o($r," ("),ro=s($r,"CODE",{});var zp=a(ro);$a=o(zp,"List[str]"),zp.forEach(t),Pa=o($r,") \u2014 A list of inputs expected in the forward pass of the model."),$r.forEach(t),qa=c(O),G=s(O,"LI",{});var Be=a(G);so=s(Be,"STRONG",{});var xp=a(so);Ea=o(xp,"padding_side"),xp.forEach(t),Ba=o(Be," ("),ao=s(Be,"CODE",{});var $p=a(ao);La=o($p,"str"),$p.forEach(t),Da=o(Be,`) \u2014 The default value for the side on which the model should have padding applied.
Should be `),io=s(Be,"CODE",{});var Pp=a(io);Ia=o(Pp,"'right'"),Pp.forEach(t),Na=o(Be," or "),co=s(Be,"CODE",{});var qp=a(co);Aa=o(qp,"'left'"),qp.forEach(t),Fa=o(Be,"."),Be.forEach(t),Sa=c(O),H=s(O,"LI",{});var Le=a(H);lo=s(Le,"STRONG",{});var Ep=a(lo);Ca=o(Ep,"truncation_side"),Ep.forEach(t),Oa=o(Le," ("),po=s(Le,"CODE",{});var Bp=a(po);Wa=o(Bp,"str"),Bp.forEach(t),ja=o(Le,`) \u2014 The default value for the side on which the model should have truncation
applied. Should be `),mo=s(Le,"CODE",{});var Lp=a(mo);Ra=o(Lp,"'right'"),Lp.forEach(t),Ua=o(Le," or "),ho=s(Le,"CODE",{});var Dp=a(ho);Ma=o(Dp,"'left'"),Dp.forEach(t),Va=o(Le,"."),Le.forEach(t),O.forEach(t),Ga=c(m),Ne=s(m,"DIV",{class:!0});var Or=a(Ne);f(rt.$$.fragment,Or),Ha=c(Or),uo=s(Or,"P",{});var Ip=a(uo);Xa=o(Ip,`Main method to tokenize and prepare for the model one or several sequence(s) or one or several pair(s) of
sequences.`),Ip.forEach(t),Or.forEach(t),Ya=c(m),Ae=s(m,"DIV",{class:!0});var Wr=a(Ae);f(st.$$.fragment,Wr),Ja=c(Wr),fo=s(Wr,"P",{});var Np=a(fo);Ka=o(Np,`Temporarily sets the tokenizer for encoding the targets. Useful for tokenizer associated to
sequence-to-sequence models that need a slightly different processing for the labels.`),Np.forEach(t),Wr.forEach(t),Qa=c(m),Fe=s(m,"DIV",{class:!0});var jr=a(Fe);f(at.$$.fragment,jr),Za=c(jr),_o=s(jr,"P",{});var Ap=a(_o);ei=o(Ap,"Convert a list of lists of token ids into a list of strings by calling decode."),Ap.forEach(t),jr.forEach(t),ti=c(m),ne=s(m,"DIV",{class:!0});var wn=a(ne);f(it.$$.fragment,wn),ni=c(wn),go=s(wn,"P",{});var Fp=a(go);oi=o(Fp,"Tokenize and prepare for the model a list of sequences or a list of pairs of sequences."),Fp.forEach(t),ri=c(wn),f(Se.$$.fragment,wn),wn.forEach(t),si=c(m),oe=s(m,"DIV",{class:!0});var zn=a(oe);f(dt.$$.fragment,zn),ai=c(zn),ko=s(zn,"P",{});var Sp=a(ko);ii=o(Sp,`Build model inputs from a sequence or a pair of sequence for sequence classification tasks by concatenating and
adding special tokens.`),Sp.forEach(t),di=c(zn),bo=s(zn,"P",{});var Cp=a(bo);ci=o(Cp,"This implementation does not add special tokens and this method should be overridden in a subclass."),Cp.forEach(t),zn.forEach(t),li=c(m),Ce=s(m,"DIV",{class:!0});var Rr=a(Ce);f(ct.$$.fragment,Rr),pi=c(Rr),vo=s(Rr,"P",{});var Op=a(vo);mi=o(Op,"Clean up a list of simple English tokenization artifacts like spaces before punctuations and abbreviated forms."),Op.forEach(t),Rr.forEach(t),hi=c(m),Oe=s(m,"DIV",{class:!0});var Ur=a(Oe);f(lt.$$.fragment,Ur),ui=c(Ur),pt=s(Ur,"P",{});var Mr=a(pt);fi=o(Mr,"Converts a sequence of tokens in a single string. The most simple way to do it is "),To=s(Mr,"CODE",{});var Wp=a(To);_i=o(Wp,'" ".join(tokens)'),Wp.forEach(t),gi=o(Mr,` but we
often want to remove sub-word tokenization artifacts at the same time.`),Mr.forEach(t),Ur.forEach(t),ki=c(m),re=s(m,"DIV",{class:!0});var xn=a(re);f(mt.$$.fragment,xn),bi=c(xn),un=s(xn,"P",{});var Hl=a(un);vi=o(Hl,"Create the token type IDs corresponding to the sequences passed. "),fn=s(Hl,"A",{href:!0});var jp=a(fn);Ti=o(jp,`What are token type
IDs?`),jp.forEach(t),Hl.forEach(t),yi=c(xn),yo=s(xn,"P",{});var Rp=a(yo);wi=o(Rp,"Should be overridden in a subclass if the model has a special way of building those."),Rp.forEach(t),xn.forEach(t),zi=c(m),se=s(m,"DIV",{class:!0});var $n=a(se);f(ht.$$.fragment,$n),xi=c($n),wo=s($n,"P",{});var Up=a(wo);$i=o(Up,`Converts a sequence of ids in a string, using the tokenizer and vocabulary with options to remove special
tokens and clean up tokenization spaces.`),Up.forEach(t),Pi=c($n),ut=s($n,"P",{});var Vr=a(ut);qi=o(Vr,"Similar to doing "),zo=s(Vr,"CODE",{});var Mp=a(zo);Ei=o(Mp,"self.convert_tokens_to_string(self.convert_ids_to_tokens(token_ids))"),Mp.forEach(t),Bi=o(Vr,"."),Vr.forEach(t),$n.forEach(t),Li=c(m),ae=s(m,"DIV",{class:!0});var Pn=a(ae);f(ft.$$.fragment,Pn),Di=c(Pn),xo=s(Pn,"P",{});var Vp=a(xo);Ii=o(Vp,"Converts a string to a sequence of ids (integer), using the tokenizer and vocabulary."),Vp.forEach(t),Ni=c(Pn),_t=s(Pn,"P",{});var Gr=a(_t);Ai=o(Gr,"Same as doing "),$o=s(Gr,"CODE",{});var Gp=a($o);Fi=o(Gp,"self.convert_tokens_to_ids(self.tokenize(text))"),Gp.forEach(t),Si=o(Gr,"."),Gr.forEach(t),Pn.forEach(t),Ci=c(m),ie=s(m,"DIV",{class:!0});var qn=a(ie);f(gt.$$.fragment,qn),Oi=c(qn),Po=s(qn,"P",{});var Hp=a(Po);Wi=o(Hp,"Tokenize and prepare for the model a sequence or a pair of sequences."),Hp.forEach(t),ji=c(qn),f(We.$$.fragment,qn),qn.forEach(t),Ri=c(m),C=s(m,"DIV",{class:!0});var he=a(C);f(kt.$$.fragment,he),Ui=c(he),bt=s(he,"P",{});var Hr=a(bt);Mi=o(Hr,"Instantiate a "),_n=s(Hr,"A",{href:!0});var Xp=a(_n);Vi=o(Xp,"PreTrainedTokenizerBase"),Xp.forEach(t),Gi=o(Hr,` (or a derived class) from a predefined
tokenizer.`),Hr.forEach(t),Hi=c(he),f(je.$$.fragment,he),Xi=c(he),qo=s(he,"P",{});var Yp=a(qo);Yi=o(Yp,"Examples:"),Yp.forEach(t),Ji=c(he),f(vt.$$.fragment,he),he.forEach(t),Ki=c(m),Re=s(m,"DIV",{class:!0});var Xr=a(Re);f(Tt.$$.fragment,Xr),Qi=c(Xr),ve=s(Xr,"P",{});var En=a(ve);Zi=o(En,`Retrieves sequence ids from a token list that has no special tokens added. This method is called when adding
special tokens using the tokenizer `),Eo=s(En,"CODE",{});var Jp=a(Eo);ed=o(Jp,"prepare_for_model"),Jp.forEach(t),td=o(En," or "),Bo=s(En,"CODE",{});var Kp=a(Bo);nd=o(Kp,"encode_plus"),Kp.forEach(t),od=o(En," methods."),En.forEach(t),Xr.forEach(t),rd=c(m),de=s(m,"DIV",{class:!0});var Bn=a(de);f(yt.$$.fragment,Bn),sd=c(Bn),Lo=s(Bn,"P",{});var Qp=a(Lo);ad=o(Qp,"Returns the vocabulary as a dictionary of token to index."),Qp.forEach(t),id=c(Bn),ce=s(Bn,"P",{});var on=a(ce);Do=s(on,"CODE",{});var Zp=a(Do);dd=o(Zp,"tokenizer.get_vocab()[token]"),Zp.forEach(t),cd=o(on," is equivalent to "),Io=s(on,"CODE",{});var em=a(Io);ld=o(em,"tokenizer.convert_tokens_to_ids(token)"),em.forEach(t),pd=o(on," when "),No=s(on,"CODE",{});var tm=a(No);md=o(tm,"token"),tm.forEach(t),hd=o(on,` is in the
vocab.`),on.forEach(t),Bn.forEach(t),ud=c(m),X=s(m,"DIV",{class:!0});var Qe=a(X);f(wt.$$.fragment,Qe),fd=c(Qe),Ao=s(Qe,"P",{});var nm=a(Ao);_d=o(nm,`Pad a single encoded input or a batch of encoded inputs up to predefined length or to the max sequence length
in the batch.`),nm.forEach(t),gd=c(Qe),Q=s(Qe,"P",{});var Ze=a(Q);kd=o(Ze,"Padding side (left/right) padding token ids are defined at the tokenizer level (with "),Fo=s(Ze,"CODE",{});var om=a(Fo);bd=o(om,"self.padding_side"),om.forEach(t),vd=o(Ze,`,
`),So=s(Ze,"CODE",{});var rm=a(So);Td=o(rm,"self.pad_token_id"),rm.forEach(t),yd=o(Ze," and "),Co=s(Ze,"CODE",{});var sm=a(Co);wd=o(sm,"self.pad_token_type_id"),sm.forEach(t),zd=o(Ze,")"),Ze.forEach(t),xd=c(Qe),f(Ue.$$.fragment,Qe),Qe.forEach(t),$d=c(m),Me=s(m,"DIV",{class:!0});var Yr=a(Me);f(zt.$$.fragment,Yr),Pd=c(Yr),j=s(Yr,"P",{});var ue=a(j);qd=o(ue,`Prepares a sequence of input id, or a pair of sequences of inputs ids so that it can be used by the model. It
adds special tokens, truncates sequences if overflowing while taking into account the special tokens and
manages a moving window (with user defined stride) for overflowing tokens. Please Note, for `),Oo=s(ue,"EM",{});var am=a(Oo);Ed=o(am,"pair_ids"),am.forEach(t),Bd=o(ue,`
different than `),Wo=s(ue,"CODE",{});var im=a(Wo);Ld=o(im,"None"),im.forEach(t),Dd=o(ue," and "),jo=s(ue,"EM",{});var dm=a(jo);Id=o(dm,"truncation_strategy = longest_first"),dm.forEach(t),Nd=o(ue," or "),Ro=s(ue,"CODE",{});var cm=a(Ro);Ad=o(cm,"True"),cm.forEach(t),Fd=o(ue,`, it is not possible to return
overflowing tokens. Such a combination of arguments will raise an error.`),ue.forEach(t),Yr.forEach(t),Sd=c(m),Ve=s(m,"DIV",{class:!0});var Jr=a(Ve);f(xt.$$.fragment,Jr),Cd=c(Jr),Uo=s(Jr,"P",{});var lm=a(Uo);Od=o(lm,"Prepare model inputs for translation. For best performance, translate one sentence at a time."),lm.forEach(t),Jr.forEach(t),Wd=c(m),Y=s(m,"DIV",{class:!0});var et=a(Y);f($t.$$.fragment,et),jd=c(et),Pt=s(et,"P",{});var Kr=a(Pt);Rd=o(Kr,`Upload the tokenizer files to the \u{1F917} Model Hub while synchronizing a local clone of the repo in
`),Mo=s(Kr,"CODE",{});var pm=a(Mo);Ud=o(pm,"repo_path_or_name"),pm.forEach(t),Md=o(Kr,"."),Kr.forEach(t),Vd=c(et),Vo=s(et,"P",{});var mm=a(Vo);Gd=o(mm,"Examples:"),mm.forEach(t),Hd=c(et),f(qt.$$.fragment,et),et.forEach(t),Xd=c(m),le=s(m,"DIV",{class:!0});var Ln=a(le);f(Et.$$.fragment,Ln),Yd=c(Ln),Bt=s(Ln,"P",{});var Qr=a(Bt);Jd=o(Qr,`Register this class with a given auto class. This should only be used for custom tokenizers as the ones in the
library are already mapped with `),Go=s(Qr,"CODE",{});var hm=a(Go);Kd=o(hm,"AutoTokenizer"),hm.forEach(t),Qd=o(Qr,"."),Qr.forEach(t),Zd=c(Ln),f(Ge.$$.fragment,Ln),Ln.forEach(t),ec=c(m),J=s(m,"DIV",{class:!0});var tt=a(J);f(Lt.$$.fragment,tt),tc=c(tt),Ho=s(tt,"P",{});var um=a(Ho);nc=o(um,"Save the full tokenizer state."),um.forEach(t),oc=c(tt),Dt=s(tt,"P",{});var Zr=a(Dt);rc=o(Zr,`This method make sure the full tokenizer can then be re-loaded using the
`),Xo=s(Zr,"CODE",{});var fm=a(Xo);sc=o(fm,"from_pretrained"),fm.forEach(t),ac=o(Zr," class method.."),Zr.forEach(t),ic=c(tt),It=s(tt,"P",{});var es=a(It);dc=o(es,`Warning,None This won\u2019t save modifications you may have applied to the tokenizer after the instantiation (for
instance, modifying `),Yo=s(es,"CODE",{});var _m=a(Yo);cc=o(_m,"tokenizer.do_lower_case"),_m.forEach(t),lc=o(es," after creation)."),es.forEach(t),tt.forEach(t),pc=c(m),pe=s(m,"DIV",{class:!0});var Dn=a(pe);f(Nt.$$.fragment,Dn),mc=c(Dn),Jo=s(Dn,"P",{});var gm=a(Jo);hc=o(gm,"Save only the vocabulary of the tokenizer (vocabulary + added tokens)."),gm.forEach(t),uc=c(Dn),At=s(Dn,"P",{});var ts=a(At);fc=o(ts,`This method won\u2019t save the configuration and special token mappings of the tokenizer. Use
`),Ko=s(ts,"CODE",{});var km=a(Ko);_c=o(km,"_save_pretrained()"),km.forEach(t),gc=o(ts," to save the whole state of the tokenizer."),ts.forEach(t),Dn.forEach(t),kc=c(m),He=s(m,"DIV",{class:!0});var ns=a(He);f(Ft.$$.fragment,ns),bc=c(ns),St=s(ns,"P",{});var os=a(St);vc=o(os,"Converts a string in a sequence of tokens, replacing unknown tokens with the "),Qo=s(os,"CODE",{});var bm=a(Qo);Tc=o(bm,"unk_token"),bm.forEach(t),yc=o(os,"."),os.forEach(t),ns.forEach(t),wc=c(m),Xe=s(m,"DIV",{class:!0});var rs=a(Xe);f(Ct.$$.fragment,rs),zc=c(rs),Zo=s(rs,"P",{});var vm=a(Zo);xc=o(vm,"Truncates a sequence pair in-place following the strategy."),vm.forEach(t),rs.forEach(t),m.forEach(t),Lr=c(i),Te=s(i,"H2",{class:!0});var ss=a(Te);Ye=s(ss,"A",{id:!0,class:!0,href:!0});var Tm=a(Ye);er=s(Tm,"SPAN",{});var ym=a(er);f(Ot.$$.fragment,ym),ym.forEach(t),Tm.forEach(t),$c=c(ss),tr=s(ss,"SPAN",{});var wm=a(tr);Pc=o(wm,"SpecialTokensMixin"),wm.forEach(t),ss.forEach(t),Dr=c(i),A=s(i,"DIV",{class:!0});var fe=a(A);f(Wt.$$.fragment,fe),qc=c(fe),ye=s(fe,"P",{});var In=a(ye);Ec=o(In,"A mixin derived by "),gn=s(In,"A",{href:!0});var zm=a(gn);Bc=o(zm,"PreTrainedTokenizer"),zm.forEach(t),Lc=o(In," and "),kn=s(In,"A",{href:!0});var xm=a(kn);Dc=o(xm,"PreTrainedTokenizerFast"),xm.forEach(t),Ic=o(In,` to handle specific behaviors related to
special tokens. In particular, this class hold the attributes which can be used to directly access these special
tokens in a model-independent manner and allow to set and update the special tokens.`),In.forEach(t),Nc=c(fe),q=s(fe,"DIV",{class:!0});var L=a(q);f(jt.$$.fragment,L),Ac=c(L),nr=s(L,"P",{});var $m=a(nr);Fc=o($m,`Add a dictionary of special tokens (eos, pad, cls, etc.) to the encoder and link them to class attributes. If
special tokens are NOT in the vocabulary, they are added to it (indexed starting from the last index of the
current vocabulary).`),$m.forEach(t),Sc=c(L),or=s(L,"P",{});var Pm=a(or);Cc=o(Pm,`Note,None When adding new tokens to the vocabulary, you should make sure to also resize the token embedding
matrix of the model so that its embedding matrix matches the tokenizer.`),Pm.forEach(t),Oc=c(L),Rt=s(L,"P",{});var as=a(Rt);Wc=o(as,"In order to do that, please use the "),bn=s(as,"A",{href:!0});var qm=a(bn);jc=o(qm,"resize_token_embeddings()"),qm.forEach(t),Rc=o(as," method."),as.forEach(t),Uc=c(L),Ut=s(L,"P",{});var is=a(Ut);Mc=o(is,"Using "),rr=s(is,"CODE",{});var Em=a(rr);Vc=o(Em,"add_special_tokens"),Em.forEach(t),Gc=o(is," will ensure your special tokens can be used in several ways:"),is.forEach(t),Hc=c(L),Mt=s(L,"UL",{});var ds=a(Mt);sr=s(ds,"LI",{});var Bm=a(sr);Xc=o(Bm,"Special tokens are carefully handled by the tokenizer (they are never split)."),Bm.forEach(t),Yc=c(ds),Vt=s(ds,"LI",{});var cs=a(Vt);Jc=o(cs,"You can easily refer to special tokens using tokenizer class attributes like "),ar=s(cs,"CODE",{});var Lm=a(ar);Kc=o(Lm,"tokenizer.cls_token"),Lm.forEach(t),Qc=o(cs,`. This
makes it easy to develop model-agnostic training and fine-tuning scripts.`),cs.forEach(t),ds.forEach(t),Zc=c(L),R=s(L,"P",{});var _e=a(R);el=o(_e,`When possible, special tokens are already registered for provided pretrained models (for instance
`),vn=s(_e,"A",{href:!0});var Dm=a(vn);tl=o(Dm,"BertTokenizer"),Dm.forEach(t),nl=c(_e),ir=s(_e,"CODE",{});var Im=a(ir);ol=o(Im,"cls_token"),Im.forEach(t),rl=o(_e," is already registered to be :obj"),dr=s(_e,"EM",{});var Nm=a(dr);sl=o(Nm,"\u2019[CLS]\u2019"),Nm.forEach(t),al=o(_e,` and XLM\u2019s one is also registered to be
`),cr=s(_e,"CODE",{});var Am=a(cr);il=o(Am,"'</s>'"),Am.forEach(t),dl=o(_e,")."),_e.forEach(t),cl=c(L),lr=s(L,"P",{});var Fm=a(lr);ll=o(Fm,"Examples:"),Fm.forEach(t),pl=c(L),f(Gt.$$.fragment,L),L.forEach(t),ml=c(fe),N=s(fe,"DIV",{class:!0});var K=a(N);f(Ht.$$.fragment,K),hl=c(K),pr=s(K,"P",{});var Sm=a(pr);ul=o(Sm,`Add a list of new tokens to the tokenizer class. If the new tokens are not in the vocabulary, they are added to
it with indices starting from length of the current vocabulary.`),Sm.forEach(t),fl=c(K),mr=s(K,"P",{});var Cm=a(mr);_l=o(Cm,`Note,None When adding new tokens to the vocabulary, you should make sure to also resize the token embedding
matrix of the model so that its embedding matrix matches the tokenizer.`),Cm.forEach(t),gl=c(K),Xt=s(K,"P",{});var ls=a(Xt);kl=o(ls,"In order to do that, please use the "),Tn=s(ls,"A",{href:!0});var Om=a(Tn);bl=o(Om,"resize_token_embeddings()"),Om.forEach(t),vl=o(ls," method."),ls.forEach(t),Tl=c(K),hr=s(K,"P",{});var Wm=a(hr);yl=o(Wm,"Examples:"),Wm.forEach(t),wl=c(K),f(Yt.$$.fragment,K),K.forEach(t),zl=c(fe),me=s(fe,"DIV",{class:!0});var Nn=a(me);f(Jt.$$.fragment,Nn),xl=c(Nn),we=s(Nn,"P",{});var An=a(we);$l=o(An,"Make sure that all the special tokens attributes of the tokenizer ("),ur=s(An,"CODE",{});var jm=a(ur);Pl=o(jm,"tokenizer.mask_token"),jm.forEach(t),ql=o(An,`,
`),fr=s(An,"CODE",{});var Rm=a(fr);El=o(Rm,"tokenizer.cls_token"),Rm.forEach(t),Bl=o(An,", etc.) are in the vocabulary."),An.forEach(t),Ll=c(Nn),_r=s(Nn,"P",{});var Um=a(_r);Dl=o(Um,"Add the missing ones to the vocabulary if needed."),Um.forEach(t),Nn.forEach(t),fe.forEach(t),Ir=c(i),ze=s(i,"H2",{class:!0});var ps=a(ze);Je=s(ps,"A",{id:!0,class:!0,href:!0});var Mm=a(Je);gr=s(Mm,"SPAN",{});var Vm=a(gr);f(Kt.$$.fragment,Vm),Vm.forEach(t),Mm.forEach(t),Il=c(ps),kr=s(ps,"SPAN",{});var Gm=a(kr);Nl=o(Gm,"Enums and namedtuples"),Gm.forEach(t),ps.forEach(t),Nr=c(i),xe=s(i,"DIV",{class:!0});var ms=a(xe);f(Qt.$$.fragment,ms),Al=c(ms),$e=s(ms,"P",{});var Fn=a($e);Fl=o(Fn,"Possible values for the "),br=s(Fn,"CODE",{});var Hm=a(br);Sl=o(Hm,"truncation"),Hm.forEach(t),Cl=o(Fn," argument in "),Ke=s(Fn,"A",{href:!0});var hs=a(Ke);Ol=o(hs,"PreTrainedTokenizerBase."),vr=s(hs,"STRONG",{});var Xm=a(vr);Wl=o(Xm,"call"),Xm.forEach(t),jl=o(hs,"()"),hs.forEach(t),Rl=o(Fn,`. Useful for tab-completion in
an IDE.`),Fn.forEach(t),ms.forEach(t),Ar=c(i),Pe=s(i,"DIV",{class:!0});var us=a(Pe);f(Zt.$$.fragment,us),Ul=c(us),Tr=s(us,"P",{});var Ym=a(Tr);Ml=o(Ym,"Character span in the original string."),Ym.forEach(t),us.forEach(t),Fr=c(i),qe=s(i,"DIV",{class:!0});var fs=a(qe);f(en.$$.fragment,fs),Vl=c(fs),yr=s(fs,"P",{});var Jm=a(yr);Gl=o(Jm,"Token span in an encoded string (list of tokens)."),Jm.forEach(t),fs.forEach(t),this.h()},h(){l(h,"name","hf:doc:metadata"),l(h,"content",JSON.stringify(dh)),l(z,"id","utilities-for-tokenizers"),l(z,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),l(z,"href","#utilities-for-tokenizers"),l(v,"class","relative group"),l(sn,"href","/docs/transformers/main/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase"),l(an,"href","/docs/transformers/main/en/main_classes/tokenizer#transformers.PreTrainedTokenizer"),l(dn,"href","/docs/transformers/main/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast"),l(cn,"href","/docs/transformers/main/en/internal/tokenization_utils#transformers.SpecialTokensMixin"),l(De,"id","transformers.PreTrainedTokenizerBase"),l(De,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),l(De,"href","#transformers.PreTrainedTokenizerBase"),l(ke,"class","relative group"),l(pn,"href","/docs/transformers/main/en/main_classes/tokenizer#transformers.PreTrainedTokenizer"),l(mn,"href","/docs/transformers/main/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast"),l(hn,"href","/docs/transformers/main/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.from_pretrained"),l(Ne,"class","docstring"),l(Ae,"class","docstring"),l(Fe,"class","docstring"),l(ne,"class","docstring"),l(oe,"class","docstring"),l(Ce,"class","docstring"),l(Oe,"class","docstring"),l(fn,"href","../glossary#token-type-ids"),l(re,"class","docstring"),l(se,"class","docstring"),l(ae,"class","docstring"),l(ie,"class","docstring"),l(_n,"href","/docs/transformers/main/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase"),l(C,"class","docstring"),l(Re,"class","docstring"),l(de,"class","docstring"),l(X,"class","docstring"),l(Me,"class","docstring"),l(Ve,"class","docstring"),l(Y,"class","docstring"),l(le,"class","docstring"),l(J,"class","docstring"),l(pe,"class","docstring"),l(He,"class","docstring"),l(Xe,"class","docstring"),l(p,"class","docstring"),l(Ye,"id","transformers.SpecialTokensMixin"),l(Ye,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),l(Ye,"href","#transformers.SpecialTokensMixin"),l(Te,"class","relative group"),l(gn,"href","/docs/transformers/main/en/main_classes/tokenizer#transformers.PreTrainedTokenizer"),l(kn,"href","/docs/transformers/main/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast"),l(bn,"href","/docs/transformers/main/en/main_classes/model#transformers.PreTrainedModel.resize_token_embeddings"),l(vn,"href","/docs/transformers/main/en/model_doc/bert#transformers.BertTokenizer"),l(q,"class","docstring"),l(Tn,"href","/docs/transformers/main/en/main_classes/model#transformers.PreTrainedModel.resize_token_embeddings"),l(N,"class","docstring"),l(me,"class","docstring"),l(A,"class","docstring"),l(Je,"id","transformers.tokenization_utils_base.TruncationStrategy"),l(Je,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),l(Je,"href","#transformers.tokenization_utils_base.TruncationStrategy"),l(ze,"class","relative group"),l(Ke,"href","/docs/transformers/main/en/model_doc/wav2vec2_phoneme#transformers.Wav2Vec2PhonemeCTCTokenizer.__call__"),l(xe,"class","docstring"),l(Pe,"class","docstring"),l(qe,"class","docstring")},m(i,T){e(document.head,h),$(i,P,T),$(i,v,T),e(v,z),e(z,E),_(y,E,null),e(v,x),e(v,B),e(B,ge),$(i,W,T),$(i,D,T),e(D,rn),e(D,sn),e(sn,ks),e(D,bs),e(D,an),e(an,vs),e(D,Ts),e(D,dn),e(dn,ys),e(D,ws),e(D,cn),e(cn,zs),e(D,xs),$(i,qr,T),$(i,ln,T),e(ln,$s),$(i,Er,T),$(i,ke,T),e(ke,De),e(De,Sn),_(nt,Sn,null),e(ke,Ps),e(ke,Cn),e(Cn,qs),$(i,Br,T),$(i,p,T),_(ot,p,null),e(p,Es),e(p,be),e(be,Bs),e(be,pn),e(pn,Ls),e(be,Ds),e(be,mn),e(mn,Is),e(be,Ns),e(p,As),e(p,On),e(On,Fs),e(p,Ss),e(p,Wn),e(Wn,Cs),e(p,Os),e(p,I),e(I,te),e(te,jn),e(jn,Ws),e(te,js),e(te,Rn),e(Rn,Rs),e(te,Us),e(te,Un),e(Un,Ms),e(te,Vs),e(I,Gs),e(I,F),e(F,Mn),e(Mn,Hs),e(F,Xs),e(F,Vn),e(Vn,Ys),e(F,Js),e(F,Gn),e(Gn,Ks),e(F,Qs),e(F,Hn),e(Hn,Zs),e(F,ea),e(F,Xn),e(Xn,ta),e(F,na),e(I,oa),e(I,V),e(V,Yn),e(Yn,ra),e(V,sa),e(V,Jn),e(Jn,aa),e(V,ia),e(V,Kn),e(Kn,da),e(V,ca),e(V,Qn),e(Qn,la),e(V,pa),e(I,ma),e(I,S),e(S,Zn),e(Zn,ha),e(S,ua),e(S,eo),e(eo,fa),e(S,_a),e(S,to),e(to,ga),e(S,ka),e(S,no),e(no,ba),e(S,va),e(S,hn),e(hn,Ta),e(S,ya),e(I,wa),e(I,Ie),e(Ie,oo),e(oo,za),e(Ie,xa),e(Ie,ro),e(ro,$a),e(Ie,Pa),e(I,qa),e(I,G),e(G,so),e(so,Ea),e(G,Ba),e(G,ao),e(ao,La),e(G,Da),e(G,io),e(io,Ia),e(G,Na),e(G,co),e(co,Aa),e(G,Fa),e(I,Sa),e(I,H),e(H,lo),e(lo,Ca),e(H,Oa),e(H,po),e(po,Wa),e(H,ja),e(H,mo),e(mo,Ra),e(H,Ua),e(H,ho),e(ho,Ma),e(H,Va),e(p,Ga),e(p,Ne),_(rt,Ne,null),e(Ne,Ha),e(Ne,uo),e(uo,Xa),e(p,Ya),e(p,Ae),_(st,Ae,null),e(Ae,Ja),e(Ae,fo),e(fo,Ka),e(p,Qa),e(p,Fe),_(at,Fe,null),e(Fe,Za),e(Fe,_o),e(_o,ei),e(p,ti),e(p,ne),_(it,ne,null),e(ne,ni),e(ne,go),e(go,oi),e(ne,ri),_(Se,ne,null),e(p,si),e(p,oe),_(dt,oe,null),e(oe,ai),e(oe,ko),e(ko,ii),e(oe,di),e(oe,bo),e(bo,ci),e(p,li),e(p,Ce),_(ct,Ce,null),e(Ce,pi),e(Ce,vo),e(vo,mi),e(p,hi),e(p,Oe),_(lt,Oe,null),e(Oe,ui),e(Oe,pt),e(pt,fi),e(pt,To),e(To,_i),e(pt,gi),e(p,ki),e(p,re),_(mt,re,null),e(re,bi),e(re,un),e(un,vi),e(un,fn),e(fn,Ti),e(re,yi),e(re,yo),e(yo,wi),e(p,zi),e(p,se),_(ht,se,null),e(se,xi),e(se,wo),e(wo,$i),e(se,Pi),e(se,ut),e(ut,qi),e(ut,zo),e(zo,Ei),e(ut,Bi),e(p,Li),e(p,ae),_(ft,ae,null),e(ae,Di),e(ae,xo),e(xo,Ii),e(ae,Ni),e(ae,_t),e(_t,Ai),e(_t,$o),e($o,Fi),e(_t,Si),e(p,Ci),e(p,ie),_(gt,ie,null),e(ie,Oi),e(ie,Po),e(Po,Wi),e(ie,ji),_(We,ie,null),e(p,Ri),e(p,C),_(kt,C,null),e(C,Ui),e(C,bt),e(bt,Mi),e(bt,_n),e(_n,Vi),e(bt,Gi),e(C,Hi),_(je,C,null),e(C,Xi),e(C,qo),e(qo,Yi),e(C,Ji),_(vt,C,null),e(p,Ki),e(p,Re),_(Tt,Re,null),e(Re,Qi),e(Re,ve),e(ve,Zi),e(ve,Eo),e(Eo,ed),e(ve,td),e(ve,Bo),e(Bo,nd),e(ve,od),e(p,rd),e(p,de),_(yt,de,null),e(de,sd),e(de,Lo),e(Lo,ad),e(de,id),e(de,ce),e(ce,Do),e(Do,dd),e(ce,cd),e(ce,Io),e(Io,ld),e(ce,pd),e(ce,No),e(No,md),e(ce,hd),e(p,ud),e(p,X),_(wt,X,null),e(X,fd),e(X,Ao),e(Ao,_d),e(X,gd),e(X,Q),e(Q,kd),e(Q,Fo),e(Fo,bd),e(Q,vd),e(Q,So),e(So,Td),e(Q,yd),e(Q,Co),e(Co,wd),e(Q,zd),e(X,xd),_(Ue,X,null),e(p,$d),e(p,Me),_(zt,Me,null),e(Me,Pd),e(Me,j),e(j,qd),e(j,Oo),e(Oo,Ed),e(j,Bd),e(j,Wo),e(Wo,Ld),e(j,Dd),e(j,jo),e(jo,Id),e(j,Nd),e(j,Ro),e(Ro,Ad),e(j,Fd),e(p,Sd),e(p,Ve),_(xt,Ve,null),e(Ve,Cd),e(Ve,Uo),e(Uo,Od),e(p,Wd),e(p,Y),_($t,Y,null),e(Y,jd),e(Y,Pt),e(Pt,Rd),e(Pt,Mo),e(Mo,Ud),e(Pt,Md),e(Y,Vd),e(Y,Vo),e(Vo,Gd),e(Y,Hd),_(qt,Y,null),e(p,Xd),e(p,le),_(Et,le,null),e(le,Yd),e(le,Bt),e(Bt,Jd),e(Bt,Go),e(Go,Kd),e(Bt,Qd),e(le,Zd),_(Ge,le,null),e(p,ec),e(p,J),_(Lt,J,null),e(J,tc),e(J,Ho),e(Ho,nc),e(J,oc),e(J,Dt),e(Dt,rc),e(Dt,Xo),e(Xo,sc),e(Dt,ac),e(J,ic),e(J,It),e(It,dc),e(It,Yo),e(Yo,cc),e(It,lc),e(p,pc),e(p,pe),_(Nt,pe,null),e(pe,mc),e(pe,Jo),e(Jo,hc),e(pe,uc),e(pe,At),e(At,fc),e(At,Ko),e(Ko,_c),e(At,gc),e(p,kc),e(p,He),_(Ft,He,null),e(He,bc),e(He,St),e(St,vc),e(St,Qo),e(Qo,Tc),e(St,yc),e(p,wc),e(p,Xe),_(Ct,Xe,null),e(Xe,zc),e(Xe,Zo),e(Zo,xc),$(i,Lr,T),$(i,Te,T),e(Te,Ye),e(Ye,er),_(Ot,er,null),e(Te,$c),e(Te,tr),e(tr,Pc),$(i,Dr,T),$(i,A,T),_(Wt,A,null),e(A,qc),e(A,ye),e(ye,Ec),e(ye,gn),e(gn,Bc),e(ye,Lc),e(ye,kn),e(kn,Dc),e(ye,Ic),e(A,Nc),e(A,q),_(jt,q,null),e(q,Ac),e(q,nr),e(nr,Fc),e(q,Sc),e(q,or),e(or,Cc),e(q,Oc),e(q,Rt),e(Rt,Wc),e(Rt,bn),e(bn,jc),e(Rt,Rc),e(q,Uc),e(q,Ut),e(Ut,Mc),e(Ut,rr),e(rr,Vc),e(Ut,Gc),e(q,Hc),e(q,Mt),e(Mt,sr),e(sr,Xc),e(Mt,Yc),e(Mt,Vt),e(Vt,Jc),e(Vt,ar),e(ar,Kc),e(Vt,Qc),e(q,Zc),e(q,R),e(R,el),e(R,vn),e(vn,tl),e(R,nl),e(R,ir),e(ir,ol),e(R,rl),e(R,dr),e(dr,sl),e(R,al),e(R,cr),e(cr,il),e(R,dl),e(q,cl),e(q,lr),e(lr,ll),e(q,pl),_(Gt,q,null),e(A,ml),e(A,N),_(Ht,N,null),e(N,hl),e(N,pr),e(pr,ul),e(N,fl),e(N,mr),e(mr,_l),e(N,gl),e(N,Xt),e(Xt,kl),e(Xt,Tn),e(Tn,bl),e(Xt,vl),e(N,Tl),e(N,hr),e(hr,yl),e(N,wl),_(Yt,N,null),e(A,zl),e(A,me),_(Jt,me,null),e(me,xl),e(me,we),e(we,$l),e(we,ur),e(ur,Pl),e(we,ql),e(we,fr),e(fr,El),e(we,Bl),e(me,Ll),e(me,_r),e(_r,Dl),$(i,Ir,T),$(i,ze,T),e(ze,Je),e(Je,gr),_(Kt,gr,null),e(ze,Il),e(ze,kr),e(kr,Nl),$(i,Nr,T),$(i,xe,T),_(Qt,xe,null),e(xe,Al),e(xe,$e),e($e,Fl),e($e,br),e(br,Sl),e($e,Cl),e($e,Ke),e(Ke,Ol),e(Ke,vr),e(vr,Wl),e(Ke,jl),e($e,Rl),$(i,Ar,T),$(i,Pe,T),_(Zt,Pe,null),e(Pe,Ul),e(Pe,Tr),e(Tr,Ml),$(i,Fr,T),$(i,qe,T),_(en,qe,null),e(qe,Vl),e(qe,yr),e(yr,Gl),Sr=!0},p(i,[T]){const tn={};T&2&&(tn.$$scope={dirty:T,ctx:i}),Se.$set(tn);const wr={};T&2&&(wr.$$scope={dirty:T,ctx:i}),We.$set(wr);const zr={};T&2&&(zr.$$scope={dirty:T,ctx:i}),je.$set(zr);const xr={};T&2&&(xr.$$scope={dirty:T,ctx:i}),Ue.$set(xr);const U={};T&2&&(U.$$scope={dirty:T,ctx:i}),Ge.$set(U)},i(i){Sr||(g(y.$$.fragment,i),g(nt.$$.fragment,i),g(ot.$$.fragment,i),g(rt.$$.fragment,i),g(st.$$.fragment,i),g(at.$$.fragment,i),g(it.$$.fragment,i),g(Se.$$.fragment,i),g(dt.$$.fragment,i),g(ct.$$.fragment,i),g(lt.$$.fragment,i),g(mt.$$.fragment,i),g(ht.$$.fragment,i),g(ft.$$.fragment,i),g(gt.$$.fragment,i),g(We.$$.fragment,i),g(kt.$$.fragment,i),g(je.$$.fragment,i),g(vt.$$.fragment,i),g(Tt.$$.fragment,i),g(yt.$$.fragment,i),g(wt.$$.fragment,i),g(Ue.$$.fragment,i),g(zt.$$.fragment,i),g(xt.$$.fragment,i),g($t.$$.fragment,i),g(qt.$$.fragment,i),g(Et.$$.fragment,i),g(Ge.$$.fragment,i),g(Lt.$$.fragment,i),g(Nt.$$.fragment,i),g(Ft.$$.fragment,i),g(Ct.$$.fragment,i),g(Ot.$$.fragment,i),g(Wt.$$.fragment,i),g(jt.$$.fragment,i),g(Gt.$$.fragment,i),g(Ht.$$.fragment,i),g(Yt.$$.fragment,i),g(Jt.$$.fragment,i),g(Kt.$$.fragment,i),g(Qt.$$.fragment,i),g(Zt.$$.fragment,i),g(en.$$.fragment,i),Sr=!0)},o(i){k(y.$$.fragment,i),k(nt.$$.fragment,i),k(ot.$$.fragment,i),k(rt.$$.fragment,i),k(st.$$.fragment,i),k(at.$$.fragment,i),k(it.$$.fragment,i),k(Se.$$.fragment,i),k(dt.$$.fragment,i),k(ct.$$.fragment,i),k(lt.$$.fragment,i),k(mt.$$.fragment,i),k(ht.$$.fragment,i),k(ft.$$.fragment,i),k(gt.$$.fragment,i),k(We.$$.fragment,i),k(kt.$$.fragment,i),k(je.$$.fragment,i),k(vt.$$.fragment,i),k(Tt.$$.fragment,i),k(yt.$$.fragment,i),k(wt.$$.fragment,i),k(Ue.$$.fragment,i),k(zt.$$.fragment,i),k(xt.$$.fragment,i),k($t.$$.fragment,i),k(qt.$$.fragment,i),k(Et.$$.fragment,i),k(Ge.$$.fragment,i),k(Lt.$$.fragment,i),k(Nt.$$.fragment,i),k(Ft.$$.fragment,i),k(Ct.$$.fragment,i),k(Ot.$$.fragment,i),k(Wt.$$.fragment,i),k(jt.$$.fragment,i),k(Gt.$$.fragment,i),k(Ht.$$.fragment,i),k(Yt.$$.fragment,i),k(Jt.$$.fragment,i),k(Kt.$$.fragment,i),k(Qt.$$.fragment,i),k(Zt.$$.fragment,i),k(en.$$.fragment,i),Sr=!1},d(i){t(h),i&&t(P),i&&t(v),b(y),i&&t(W),i&&t(D),i&&t(qr),i&&t(ln),i&&t(Er),i&&t(ke),b(nt),i&&t(Br),i&&t(p),b(ot),b(rt),b(st),b(at),b(it),b(Se),b(dt),b(ct),b(lt),b(mt),b(ht),b(ft),b(gt),b(We),b(kt),b(je),b(vt),b(Tt),b(yt),b(wt),b(Ue),b(zt),b(xt),b($t),b(qt),b(Et),b(Ge),b(Lt),b(Nt),b(Ft),b(Ct),i&&t(Lr),i&&t(Te),b(Ot),i&&t(Dr),i&&t(A),b(Wt),b(jt),b(Gt),b(Ht),b(Yt),b(Jt),i&&t(Ir),i&&t(ze),b(Kt),i&&t(Nr),i&&t(xe),b(Qt),i&&t(Ar),i&&t(Pe),b(Zt),i&&t(Fr),i&&t(qe),b(en)}}}const dh={local:"utilities-for-tokenizers",sections:[{local:"transformers.PreTrainedTokenizerBase",title:"PreTrainedTokenizerBase"},{local:"transformers.SpecialTokensMixin",title:"SpecialTokensMixin"},{local:"transformers.tokenization_utils_base.TruncationStrategy",title:"Enums and namedtuples"}],title:"Utilities for Tokenizers"};function ch(M){return th(()=>{new URLSearchParams(window.location.search).get("fw")}),[]}class fh extends Km{constructor(h){super();Qm(this,h,ch,ih,Zm,{})}}export{fh as default,dh as metadata};
