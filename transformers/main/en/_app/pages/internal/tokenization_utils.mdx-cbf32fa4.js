import{S as Km,i as Qm,s as Zm,e as r,k as d,w as u,t as n,M as eh,c as s,d as t,m as c,a,x as f,h as o,b as l,F as e,g as $,y as _,q as g,o as k,B as b}from"../../chunks/vendor-4833417e.js";import{T as Pr}from"../../chunks/Tip-fffd6df1.js";import{D as z}from"../../chunks/Docstring-4f315ed9.js";import{C as _s}from"../../chunks/CodeBlock-6a3d1b46.js";import{I as gs}from"../../chunks/IconCopyLink-4b81c553.js";import"../../chunks/CopyButton-dacfbfaf.js";function th(W){let h,P,v,y,E;return{c(){h=r("p"),P=n("This method is deprecated, "),v=r("code"),y=n("__call__"),E=n(" should be used instead.")},l(w){h=s(w,"P",{});var x=a(h);P=o(x,"This method is deprecated, "),v=s(x,"CODE",{});var B=a(v);y=o(B,"__call__"),B.forEach(t),E=o(x," should be used instead."),x.forEach(t)},m(w,x){$(w,h,x),e(h,P),e(h,v),e(v,y),e(h,E)},d(w){w&&t(h)}}}function nh(W){let h,P,v,y,E;return{c(){h=r("p"),P=n("This method is deprecated, "),v=r("code"),y=n("__call__"),E=n(" should be used instead.")},l(w){h=s(w,"P",{});var x=a(h);P=o(x,"This method is deprecated, "),v=s(x,"CODE",{});var B=a(v);y=o(B,"__call__"),B.forEach(t),E=o(x," should be used instead."),x.forEach(t)},m(w,x){$(w,h,x),e(h,P),e(h,v),e(v,y),e(h,E)},d(w){w&&t(h)}}}function oh(W){let h,P,v,y,E;return{c(){h=r("p"),P=n("Passing "),v=r("code"),y=n("use_auth_token=True"),E=n(" is required when you want to use a private model.")},l(w){h=s(w,"P",{});var x=a(h);P=o(x,"Passing "),v=s(x,"CODE",{});var B=a(v);y=o(B,"use_auth_token=True"),B.forEach(t),E=o(x," is required when you want to use a private model."),x.forEach(t)},m(w,x){$(w,h,x),e(h,P),e(h,v),e(v,y),e(h,E)},d(w){w&&t(h)}}}function rh(W){let h,P,v,y,E,w,x,B;return{c(){h=r("p"),P=n("If the "),v=r("code"),y=n("encoded_inputs"),E=n(` passed are dictionary of numpy arrays, PyTorch tensors or TensorFlow tensors, the
result will use the same type unless you provide a different tensor type with `),w=r("code"),x=n("return_tensors"),B=n(`. In the case of
PyTorch tensors, you will lose the specific device of your tensors however.`)},l(ge){h=s(ge,"P",{});var j=a(h);P=o(j,"If the "),v=s(j,"CODE",{});var D=a(v);y=o(D,"encoded_inputs"),D.forEach(t),E=o(j,` passed are dictionary of numpy arrays, PyTorch tensors or TensorFlow tensors, the
result will use the same type unless you provide a different tensor type with `),w=s(j,"CODE",{});var rn=a(w);x=o(rn,"return_tensors"),rn.forEach(t),B=o(j,`. In the case of
PyTorch tensors, you will lose the specific device of your tensors however.`),j.forEach(t)},m(ge,j){$(ge,h,j),e(h,P),e(h,v),e(v,y),e(h,E),e(h,w),e(w,x),e(h,B)},d(ge){ge&&t(h)}}}function sh(W){let h,P;return{c(){h=r("p"),P=n("This API is experimental and may have some slight breaking changes in the next releases.")},l(v){h=s(v,"P",{});var y=a(h);P=o(y,"This API is experimental and may have some slight breaking changes in the next releases."),y.forEach(t)},m(v,y){$(v,h,y),e(h,P)},d(v){v&&t(h)}}}function ah(W){let h,P,v,y,E,w,x,B,ge,j,D,rn,sn,ks,bs,an,vs,Ts,dn,ys,ws,cn,zs,xs,qr,ln,$s,Er,ke,De,Sn,nt,Ps,Cn,qs,Br,p,ot,Es,be,Bs,pn,Ls,Ds,mn,Is,Ns,As,On,Fs,Ss,Wn,Cs,Os,I,te,jn,Ws,js,Mn,Ms,Rs,Rn,Us,Vs,Hs,F,Un,Gs,Xs,Vn,Ys,Js,Hn,Ks,Qs,Gn,Zs,ea,Xn,ta,na,oa,V,Yn,ra,sa,Jn,aa,ia,Kn,da,ca,Qn,la,pa,ma,S,Zn,ha,ua,eo,fa,_a,to,ga,ka,no,ba,va,hn,Ta,ya,wa,Ie,oo,za,xa,ro,$a,Pa,qa,H,so,Ea,Ba,ao,La,Da,io,Ia,Na,co,Aa,Fa,Sa,G,lo,Ca,Oa,po,Wa,ja,mo,Ma,Ra,ho,Ua,Va,Ha,Ne,rt,Ga,uo,Xa,Ya,Ae,st,Ja,fo,Ka,Qa,Fe,at,Za,_o,ei,ti,ne,it,ni,go,oi,ri,Se,si,oe,dt,ai,ko,ii,di,bo,ci,li,Ce,ct,pi,vo,mi,hi,Oe,lt,ui,pt,fi,To,_i,gi,ki,re,mt,bi,un,vi,fn,Ti,yi,yo,wi,zi,se,ht,xi,wo,$i,Pi,ut,qi,zo,Ei,Bi,Li,ae,ft,Di,xo,Ii,Ni,_t,Ai,$o,Fi,Si,Ci,ie,gt,Oi,Po,Wi,ji,We,Mi,C,kt,Ri,bt,Ui,_n,Vi,Hi,Gi,je,Xi,qo,Yi,Ji,vt,Ki,Me,Tt,Qi,ve,Zi,Eo,ed,td,Bo,nd,od,rd,de,yt,sd,Lo,ad,id,ce,Do,dd,cd,Io,ld,pd,No,md,hd,ud,X,wt,fd,Ao,_d,gd,Q,kd,Fo,bd,vd,So,Td,yd,Co,wd,zd,xd,Re,$d,Ue,zt,Pd,M,qd,Oo,Ed,Bd,Wo,Ld,Dd,jo,Id,Nd,Mo,Ad,Fd,Sd,Ve,xt,Cd,Ro,Od,Wd,Y,$t,jd,Pt,Md,Uo,Rd,Ud,Vd,Vo,Hd,Gd,qt,Xd,le,Et,Yd,Bt,Jd,Ho,Kd,Qd,Zd,He,ec,J,Lt,tc,Go,nc,oc,Dt,rc,Xo,sc,ac,ic,It,dc,Yo,cc,lc,pc,pe,Nt,mc,Jo,hc,uc,At,fc,Ko,_c,gc,kc,Ge,Ft,bc,St,vc,Qo,Tc,yc,wc,Xe,Ct,zc,Zo,xc,Lr,Te,Ye,er,Ot,$c,tr,Pc,Dr,A,Wt,qc,ye,Ec,gn,Bc,Lc,kn,Dc,Ic,Nc,q,jt,Ac,nr,Fc,Sc,or,Cc,Oc,Mt,Wc,bn,jc,Mc,Rc,Rt,Uc,rr,Vc,Hc,Gc,Ut,sr,Xc,Yc,Vt,Jc,ar,Kc,Qc,Zc,R,el,vn,tl,nl,ir,ol,rl,dr,sl,al,cr,il,dl,cl,lr,ll,pl,Ht,ml,N,Gt,hl,pr,ul,fl,mr,_l,gl,Xt,kl,Tn,bl,vl,Tl,hr,yl,wl,Yt,zl,me,Jt,xl,we,$l,ur,Pl,ql,fr,El,Bl,Ll,_r,Dl,Ir,ze,Je,gr,Kt,Il,kr,Nl,Nr,xe,Qt,Al,$e,Fl,br,Sl,Cl,Ke,Ol,vr,Wl,jl,Ml,Ar,Pe,Zt,Rl,Tr,Ul,Fr,qe,en,Vl,yr,Hl,Sr;return w=new gs({}),nt=new gs({}),ot=new z({props:{name:"class transformers.PreTrainedTokenizerBase",anchor:"transformers.PreTrainedTokenizerBase",parameters:[{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/tokenization_utils_base.py#L1433",parametersDescription:[{anchor:"transformers.PreTrainedTokenizerBase.model_max_length",description:`<strong>model_max_length</strong> (<code>int</code>, <em>optional</em>) &#x2014;
...
<p><a
  href="/docs/transformers/main/en/main_classes/tokenizer#transformers.BatchEncoding"
>BatchEncoding</a></p>
`}}),We=new Pr({props:{warning:"&lcub;true}",$$slots:{default:[nh]},$$scope:{ctx:W}}}),kt=new z({props:{name:"from_pretrained",anchor:"transformers.PreTrainedTokenizerBase.from_pretrained",parameters:[{name:"pretrained_model_name_or_path",val:": typing.Union[str, os.PathLike]"},{name:"*init_inputs",val:""},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/tokenization_utils_base.py#L1551",parametersDescription:[{anchor:"transformers.PreTrainedTokenizerBase.from_pretrained.pretrained_model_name_or_path",description:`<strong>pretrained_model_name_or_path</strong> (<code>str</code> or <code>os.PathLike</code>) &#x2014;
Can be either:</p>
<ul>
...
<code>additional_special_tokens</code>. See parameters in the <code>__init__</code> for more details.`,name:"kwargs"}]}}),je=new Pr({props:{$$slots:{default:[oh]},$$scope:{ctx:W}}}),vt=new _s({props:{code:`# We can't instantiate directly the base class *PreTrainedTokenizerBase* so let's show our examples on a derived class: BertTokenizer
...
the note above for the return type.`,name:"encoded_inputs"},{anchor:"transformers.PreTrainedTokenizerBase.pad.padding",description:`<strong>padding</strong> (<code>bool</code>, <code>str</code> or <a href="/docs/transformers/main/en/internal/file_utils#transformers.file_utils.PaddingStrategy">PaddingStrategy</a>, <em>optional</em>, defaults to <code>True</code>) &#x2014;
...
`),So=r("code"),Td=n("self.pad_token_id"),yd=n(" and "),Co=r("code"),wd=n("self.pad_token_type_id"),zd=n(")"),xd=d(),u(Re.$$.fragment),$d=d(),Ue=r("div"),u(zt.$$.fragment),Pd=d(),M=r("p"),qd=n(`Prepares a sequence of input id, or a pair of sequences of inputs ids so that it can be used by the model. It
...
an IDE.`),Ar=d(),Pe=r("div"),u(Zt.$$.fragment),Rl=d(),Tr=r("p"),Ul=n("Character span in the original string."),Fr=d(),qe=r("div"),u(en.$$.fragment),Vl=d(),yr=r("p"),Hl=n("Token span in an encoded string (list of tokens)."),this.h()},l(i){const T=eh('[data-svelte="svelte-1phssyn"]',document.head);h=s(T,"META",{name:!0,content:!0}),T.forEach(t),P=c(i),v=s(i,"H1",{class:!0});var tn=a(v);y=s(tn,"A",{id:!0,class:!0,href:!0});var wr=a(y);E=s(wr,"SPAN",{});var zr=a(E);f(w.$$.fragment,zr),zr.forEach(t),wr.forEach(t),x=c(tn),B=s(tn,"SPAN",{});var xr=a(B);ge=o(xr,"Utilities for Tokenizers"),xr.forEach(t),tn.forEach(t),j=c(i),D=s(i,"P",{});var U=a(D);rn=o(U,`This page lists all the utility functions used by the tokenizers, mainly the class
