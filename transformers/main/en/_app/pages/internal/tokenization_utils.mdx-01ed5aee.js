...
PyTorch tensors, you will lose the specific device of your tensors however.`),W.forEach(t)},m(ge,W){$(ge,h,W),e(h,P),e(h,v),e(v,z),e(h,E),e(h,y),e(y,x),e(h,B)},d(ge){ge&&t(h)}}}function ah(U){let h,P;return{c(){h=r("p"),P=n("This API is experimental and may have some slight breaking changes in the next releases.")},l(v){h=s(v,"P",{});var z=a(h);P=o(z,"This API is experimental and may have some slight breaking changes in the next releases."),z.forEach(t)},m(v,z){$(v,h,z),e(h,P)},d(v){v&&t(h)}}}function ih(U){let h,P,v,z,E,y,x,B,ge,W,D,rn,sn,ks,bs,an,vs,Ts,dn,ys,ws,cn,zs,xs,qr,ln,$s,Er,ke,De,Sn,nt,Ps,Cn,qs,Br,p,ot,Es,be,Bs,pn,Ls,Ds,mn,Is,Ns,As,On,Fs,Ss,Wn,Cs,Os,I,te,jn,Ws,js,Mn,Ms,Rs,Rn,Us,Vs,Hs,F,Un,Gs,Xs,Vn,Ys,Js,Hn,Ks,Qs,Gn,Zs,ea,Xn,ta,na,oa,V,Yn,ra,sa,Jn,aa,ia,Kn,da,ca,Qn,la,pa,ma,S,Zn,ha,ua,eo,fa,_a,to,ga,ka,no,ba,va,hn,Ta,ya,wa,Ie,oo,za,xa,ro,$a,Pa,qa,H,so,Ea,Ba,ao,La,Da,io,Ia,Na,co,Aa,Fa,Sa,G,lo,Ca,Oa,po,Wa,ja,mo,Ma,Ra,ho,Ua,Va,Ha,Ne,rt,Ga,uo,Xa,Ya,Ae,st,Ja,fo,Ka,Qa,Fe,at,Za,_o,ei,ti,ne,it,ni,go,oi,ri,Se,si,oe,dt,ai,ko,ii,di,bo,ci,li,Ce,ct,pi,vo,mi,hi,Oe,lt,ui,pt,fi,To,_i,gi,ki,re,mt,bi,un,vi,fn,Ti,yi,yo,wi,zi,se,ht,xi,wo,$i,Pi,ut,qi,zo,Ei,Bi,Li,ae,ft,Di,xo,Ii,Ni,_t,Ai,$o,Fi,Si,Ci,ie,gt,Oi,Po,Wi,ji,We,Mi,C,kt,Ri,bt,Ui,_n,Vi,Hi,Gi,je,Xi,qo,Yi,Ji,vt,Ki,Me,Tt,Qi,ve,Zi,Eo,ed,td,Bo,nd,od,rd,de,yt,sd,Lo,ad,id,ce,Do,dd,cd,Io,ld,pd,No,md,hd,ud,X,wt,fd,Ao,_d,gd,Q,kd,Fo,bd,vd,So,Td,yd,Co,wd,zd,xd,Re,$d,Ue,zt,Pd,j,qd,Oo,Ed,Bd,Wo,Ld,Dd,jo,Id,Nd,Mo,Ad,Fd,Sd,Ve,xt,Cd,Ro,Od,Wd,Y,$t,jd,Pt,Md,Uo,Rd,Ud,Vd,Vo,Hd,Gd,qt,Xd,le,Et,Yd,Bt,Jd,Ho,Kd,Qd,Zd,He,ec,J,Lt,tc,Go,nc,oc,Dt,rc,Xo,sc,ac,ic,It,dc,Yo,cc,lc,pc,pe,Nt,mc,Jo,hc,uc,At,fc,Ko,_c,gc,kc,Ge,Ft,bc,St,vc,Qo,Tc,yc,wc,Xe,Ct,zc,Zo,xc,Lr,Te,Ye,er,Ot,$c,tr,Pc,Dr,A,Wt,qc,ye,Ec,gn,Bc,Lc,kn,Dc,Ic,Nc,q,jt,Ac,nr,Fc,Sc,or,Cc,Oc,Mt,Wc,bn,jc,Mc,Rc,Rt,Uc,rr,Vc,Hc,Gc,Ut,sr,Xc,Yc,Vt,Jc,ar,Kc,Qc,Zc,M,el,vn,tl,nl,ir,ol,rl,dr,sl,al,cr,il,dl,cl,lr,ll,pl,Ht,ml,N,Gt,hl,pr,ul,fl,mr,_l,gl,Xt,kl,Tn,bl,vl,Tl,hr,yl,wl,Yt,zl,me,Jt,xl,we,$l,ur,Pl,ql,fr,El,Bl,Ll,_r,Dl,Ir,ze,Je,gr,Kt,Il,kr,Nl,Nr,xe,Qt,Al,$e,Fl,br,Sl,Cl,Ke,Ol,vr,Wl,jl,Ml,Ar,Pe,Zt,Rl,Tr,Ul,Fr,qe,en,Vl,yr,Hl,Sr;return y=new gs({}),nt=new gs({}),ot=new w({props:{name:"class transformers.PreTrainedTokenizerBase",anchor:"transformers.PreTrainedTokenizerBase",parameters:[{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/tokenization_utils_base.py#L1428",parametersDescription:[{anchor:"transformers.PreTrainedTokenizerBase.model_max_length",description:`<strong>model_max_length</strong> (<code>int</code>, <em>optional</em>) &#x2014;
...
<a href="/docs/transformers/main/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__"><strong>call</strong>()</a>`,name:"kwargs"}],returnDescription:`
...
`),cn=r("a"),zs=n("SpecialTokensMixin"),xs=n("."),qr=d(),ln=r("p"),$s=n("Most of those are only useful if you are studying the code of the tokenizers in the library."),Er=d(),ke=r("h2"),De=r("a"),Sn=r("span"),u(nt.$$.fragment),Ps=d(),Cn=r("span"),qs=n("PreTrainedTokenizerBase"),Br=d(),p=r("div"),u(ot.$$.fragment),Es=d(),be=r("p"),Bs=n("Base class for "),pn=r("a"),Ls=n("PreTrainedTokenizer"),Ds=n(" and "),mn=r("a"),Is=n("PreTrainedTokenizerFast"),Ns=n("."),As=d(),On=r("p"),Fs=n("Handles shared (mostly boiler plate) methods for those two classes."),Ss=d(),Wn=r("p"),Cs=n("Class attributes (overridden by derived classes)"),Os=d(),I=r("ul"),te=r("li"),jn=r("strong"),Ws=n("vocab_files_names"),js=n(" ("),Mn=r("code"),Ms=n("Dict[str, str]"),Rs=n(") \u2014 A dictionary with, as keys, the "),Rn=r("code"),Us=n("__init__"),Vs=n(` keyword name of each
vocabulary file required by the model, and as associated values, the filename for saving the associated file
(string).`),Hs=d(),F=r("li"),Un=r("strong"),Gs=n("pretrained_vocab_files_map"),Xs=n(" ("),Vn=r("code"),Ys=n("Dict[str, Dict[str, str]]"),Js=n(`) \u2014 A dictionary of dictionaries, with the
high-level keys being the `),Hn=r("code"),Ks=n("__init__"),Qs=n(` keyword name of each vocabulary file required by the model, the
low-level being the `),Gn=r("code"),Zs=n("short-cut-names"),ea=n(" of the pretrained models with, as associated values, the "),Xn=r("code"),ta=n("url"),na=n(` to the
...
with the `),hn=r("a"),Ta=n("from_pretrained()"),ya=n(" method."),wa=d(),Ie=r("li"),oo=r("strong"),za=n("model_input_names"),xa=n(" ("),ro=r("code"),$a=n("List[str]"),Pa=n(") \u2014 A list of inputs expected in the forward pass of the model."),qa=d(),H=r("li"),so=r("strong"),Ea=n("padding_side"),Ba=n(" ("),ao=r("code"),La=n("str"),Da=n(`) \u2014 The default value for the side on which the model should have padding applied.
Should be `),io=r("code"),Ia=n("'right'"),Na=n(" or "),co=r("code"),Aa=n("'left'"),Fa=n("."),Sa=d(),G=r("li"),lo=r("strong"),Ca=n("truncation_side"),Oa=n(" ("),po=r("code"),Wa=n("str"),ja=n(`) \u2014 The default value for the side on which the model should have truncation
applied. Should be `),mo=r("code"),Ma=n("'right'"),Ra=n(" or "),ho=r("code"),Ua=n("'left'"),Va=n("."),Ha=d(),Ne=r("div"),u(rt.$$.fragment),Ga=d(),uo=r("p"),Xa=n(`Main method to tokenize and prepare for the model one or several sequence(s) or one or several pair(s) of
...
tokens and clean up tokenization spaces.`),Pi=d(),ut=r("p"),qi=n("Similar to doing "),zo=r("code"),Ei=n("self.convert_tokens_to_string(self.convert_ids_to_tokens(token_ids))"),Bi=n("."),Li=d(),ae=r("div"),u(ft.$$.fragment),Di=d(),xo=r("p"),Ii=n("Converts a string to a sequence of ids (integer), using the tokenizer and vocabulary."),Ni=d(),_t=r("p"),Ai=n("Same as doing "),$o=r("code"),Fi=n("self.convert_tokens_to_ids(self.tokenize(text))"),Si=n("."),Ci=d(),ie=r("div"),u(gt.$$.fragment),Oi=d(),Po=r("p"),Wi=n("Tokenize and prepare for the model a sequence or a pair of sequences."),ji=d(),u(We.$$.fragment),Mi=d(),C=r("div"),u(kt.$$.fragment),Ri=d(),bt=r("p"),Ui=n("Instantiate a "),_n=r("a"),Vi=n("PreTrainedTokenizerBase"),Hi=n(` (or a derived class) from a predefined
tokenizer.`),Gi=d(),u(je.$$.fragment),Xi=d(),qo=r("p"),Yi=n("Examples:"),Ji=d(),u(vt.$$.fragment),Ki=d(),Me=r("div"),u(Tt.$$.fragment),Qi=d(),ve=r("p"),Zi=n(`Retrieves sequence ids from a token list that has no special tokens added. This method is called when adding
...
`),So=r("code"),Td=n("self.pad_token_id"),yd=n(" and "),Co=r("code"),wd=n("self.pad_token_type_id"),zd=n(")"),xd=d(),u(Re.$$.fragment),$d=d(),Ue=r("div"),u(zt.$$.fragment),Pd=d(),j=r("p"),qd=n(`Prepares a sequence of input id, or a pair of sequences of inputs ids so that it can be used by the model. It
...
different than `),Wo=r("code"),Ld=n("None"),Dd=n(" and "),jo=r("em"),Id=n("truncation_strategy = longest_first"),Nd=n(" or "),Mo=r("code"),Ad=n("True"),Fd=n(`, it is not possible to return
overflowing tokens. Such a combination of arguments will raise an error.`),Sd=d(),Ve=r("div"),u(xt.$$.fragment),Cd=d(),Ro=r("p"),Od=n("Prepare model inputs for translation. For best performance, translate one sentence at a time."),Wd=d(),Y=r("div"),u($t.$$.fragment),jd=d(),Pt=r("p"),Md=n(`Upload the tokenizer files to the \u{1F917} Model Hub while synchronizing a local clone of the repo in
`),Uo=r("code"),Rd=n("repo_path_or_name"),Ud=n("."),Vd=d(),Vo=r("p"),Hd=n("Examples:"),Gd=d(),u(qt.$$.fragment),Xd=d(),le=r("div"),u(Et.$$.fragment),Yd=d(),Bt=r("p"),Jd=n(`Register this class with a given auto class. This should only be used for custom tokenizers as the ones in the
library are already mapped with `),Ho=r("code"),Kd=n("AutoTokenizer"),Qd=n("."),Zd=d(),u(He.$$.fragment),ec=d(),J=r("div"),u(Lt.$$.fragment),tc=d(),Go=r("p"),nc=n("Save the full tokenizer state."),oc=d(),Dt=r("p"),rc=n(`This method make sure the full tokenizer can then be re-loaded using the
...
matrix of the model so that its embedding matrix matches the tokenizer.`),Oc=d(),Mt=r("p"),Wc=n("In order to do that, please use the "),bn=r("a"),jc=n("resize_token_embeddings()"),Mc=n(" method."),Rc=d(),Rt=r("p"),Uc=n("Using "),rr=r("code"),Vc=n("add_special_tokens"),Hc=n(" will ensure your special tokens can be used in several ways:"),Gc=d(),Ut=r("ul"),sr=r("li"),Xc=n("Special tokens are carefully handled by the tokenizer (they are never split)."),Yc=d(),Vt=r("li"),Jc=n("You can easily refer to special tokens using tokenizer class attributes like "),ar=r("code"),Kc=n("tokenizer.cls_token"),Qc=n(`. This
makes it easy to develop model-agnostic training and fine-tuning scripts.`),Zc=d(),M=r("p"),el=n(`When possible, special tokens are already registered for provided pretrained models (for instance
...
`),cr=r("code"),il=n("'</s>'"),dl=n(")."),cl=d(),lr=r("p"),ll=n("Examples:"),pl=d(),u(Ht.$$.fragment),ml=d(),N=r("div"),u(Gt.$$.fragment),hl=d(),pr=r("p"),ul=n(`Add a list of new tokens to the tokenizer class. If the new tokens are not in the vocabulary, they are added to
...
`),fr=r("code"),El=n("tokenizer.cls_token"),Bl=n(", etc.) are in the vocabulary."),Ll=d(),_r=r("p"),Dl=n("Add the missing ones to the vocabulary if needed."),Ir=d(),ze=r("h2"),Je=r("a"),gr=r("span"),u(Kt.$$.fragment),Il=d(),kr=r("span"),Nl=n("Enums and namedtuples"),Nr=d(),xe=r("div"),u(Qt.$$.fragment),Al=d(),$e=r("p"),Fl=n("Possible values for the "),br=r("code"),Sl=n("truncation"),Cl=n(" argument in "),Ke=r("a"),Ol=n("PreTrainedTokenizerBase."),vr=r("strong"),Wl=n("call"),jl=n("()"),Ml=n(`. Useful for tab-completion in
an IDE.`),Ar=d(),Pe=r("div"),u(Zt.$$.fragment),Rl=d(),Tr=r("p"),Ul=n("Character span in the original string."),Fr=d(),qe=r("div"),u(en.$$.fragment),Vl=d(),yr=r("p"),Hl=n("Token span in an encoded string (list of tokens)."),this.h()},l(i){const T=eh('[data-svelte="svelte-1phssyn"]',document.head);h=s(T,"META",{name:!0,content:!0}),T.forEach(t),P=c(i),v=s(i,"H1",{class:!0});var tn=a(v);z=s(tn,"A",{id:!0,class:!0,href:!0});var wr=a(z);E=s(wr,"SPAN",{});var zr=a(E);f(y.$$.fragment,zr),zr.forEach(t),wr.forEach(t),x=c(tn),B=s(tn,"SPAN",{});var xr=a(B);ge=o(xr,"Utilities for Tokenizers"),xr.forEach(t),tn.forEach(t),W=c(i),D=s(i,"P",{});var R=a(D);rn=o(R,`This page lists all the utility functions used by the tokenizers, mainly the class
`),sn=s(R,"A",{href:!0});var Xl=a(sn);ks=o(Xl,"PreTrainedTokenizerBase"),Xl.forEach(t),bs=o(R,` that implements the common methods between
`),an=s(R,"A",{href:!0});var Yl=a(an);vs=o(Yl,"PreTrainedTokenizer"),Yl.forEach(t),Ts=o(R," and "),dn=s(R,"A",{href:!0});var Jl=a(dn);ys=o(Jl,"PreTrainedTokenizerFast"),Jl.forEach(t),ws=o(R,` and the mixin
`),cn=s(R,"A",{href:!0});var Kl=a(cn);zs=o(Kl,"SpecialTokensMixin"),Kl.forEach(t),xs=o(R,"."),R.forEach(t),qr=c(i),ln=s(i,"P",{});var Ql=a(ln);$s=o(Ql,"Most of those are only useful if you are studying the code of the tokenizers in the library."),Ql.forEach(t),Er=c(i),ke=s(i,"H2",{class:!0});var Cr=a(ke);De=s(Cr,"A",{id:!0,class:!0,href:!0});var Zl=a(De);Sn=s(Zl,"SPAN",{});var ep=a(Sn);f(nt.$$.fragment,ep),ep.forEach(t),Zl.forEach(t),Ps=c(Cr),Cn=s(Cr,"SPAN",{});var tp=a(Cn);qs=o(tp,"PreTrainedTokenizerBase"),tp.forEach(t),Cr.forEach(t),Br=c(i),p=s(i,"DIV",{class:!0});var m=a(p);f(ot.$$.fragment,m),Es=c(m),be=s(m,"P",{});var yn=a(be);Bs=o(yn,"Base class for "),pn=s(yn,"A",{href:!0});var np=a(pn);Ls=o(np,"PreTrainedTokenizer"),np.forEach(t),Ds=o(yn," and "),mn=s(yn,"A",{href:!0});var op=a(mn);Is=o(op,"PreTrainedTokenizerFast"),op.forEach(t),Ns=o(yn,"."),yn.forEach(t),As=c(m),On=s(m,"P",{});var rp=a(On);Fs=o(rp,"Handles shared (mostly boiler plate) methods for those two classes."),rp.forEach(t),Ss=c(m),Wn=s(m,"P",{});var sp=a(Wn);Cs=o(sp,"Class attributes (overridden by derived classes)"),sp.forEach(t),Os=c(m),I=s(m,"UL",{});var O=a(I);te=s(O,"LI",{});var nn=a(te);jn=s(nn,"STRONG",{});var ap=a(jn);Ws=o(ap,"vocab_files_names"),ap.forEach(t),js=o(nn," ("),Mn=s(nn,"CODE",{});var ip=a(Mn);Ms=o(ip,"Dict[str, str]"),ip.forEach(t),Rs=o(nn,") \u2014 A dictionary with, as keys, the "),Rn=s(nn,"CODE",{});var dp=a(Rn);Us=o(dp,"__init__"),dp.forEach(t),Vs=o(nn,` keyword name of each
vocabulary file required by the model, and as associated values, the filename for saving the associated file
(string).`),nn.forEach(t),Hs=c(O),F=s(O,"LI",{});var Z=a(F);Un=s(Z,"STRONG",{});var cp=a(Un);Gs=o(cp,"pretrained_vocab_files_map"),cp.forEach(t),Xs=o(Z," ("),Vn=s(Z,"CODE",{});var lp=a(Vn);Ys=o(lp,"Dict[str, Dict[str, str]]"),lp.forEach(t),Js=o(Z,`) \u2014 A dictionary of dictionaries, with the
high-level keys being the `),Hn=s(Z,"CODE",{});var pp=a(Hn);Ks=o(pp,"__init__"),pp.forEach(t),Qs=o(Z,` keyword name of each vocabulary file required by the model, the
low-level being the `),Gn=s(Z,"CODE",{});var mp=a(Gn);Zs=o(mp,"short-cut-names"),mp.forEach(t),ea=o(Z," of the pretrained models with, as associated values, the "),Xn=s(Z,"CODE",{});var hp=a(Xn);ta=o(hp,"url"),hp.forEach(t),na=o(Z,` to the
...
adding special tokens.`),Sp.forEach(t),di=c(zn),bo=s(zn,"P",{});var Cp=a(bo);ci=o(Cp,"This implementation does not add special tokens and this method should be overridden in a subclass."),Cp.forEach(t),zn.forEach(t),li=c(m),Ce=s(m,"DIV",{class:!0});var Mr=a(Ce);f(ct.$$.fragment,Mr),pi=c(Mr),vo=s(Mr,"P",{});var Op=a(vo);mi=o(Op,"Clean up a list of simple English tokenization artifacts like spaces before punctuations and abbreviated forms."),Op.forEach(t),Mr.forEach(t),hi=c(m),Oe=s(m,"DIV",{class:!0});var Rr=a(Oe);f(lt.$$.fragment,Rr),ui=c(Rr),pt=s(Rr,"P",{});var Ur=a(pt);fi=o(Ur,"Converts a sequence of tokens in a single string. The most simple way to do it is "),To=s(Ur,"CODE",{});var Wp=a(To);_i=o(Wp,'" ".join(tokens)'),Wp.forEach(t),gi=o(Ur,` but we
often want to remove sub-word tokenization artifacts at the same time.`),Ur.forEach(t),Rr.forEach(t),ki=c(m),re=s(m,"DIV",{class:!0});var xn=a(re);f(mt.$$.fragment,xn),bi=c(xn),un=s(xn,"P",{});var Gl=a(un);vi=o(Gl,"Create the token type IDs corresponding to the sequences passed. "),fn=s(Gl,"A",{href:!0});var jp=a(fn);Ti=o(jp,`What are token type
IDs?`),jp.forEach(t),Gl.forEach(t),yi=c(xn),yo=s(xn,"P",{});var Mp=a(yo);wi=o(Mp,"Should be overridden in a subclass if the model has a special way of building those."),Mp.forEach(t),xn.forEach(t),zi=c(m),se=s(m,"DIV",{class:!0});var $n=a(se);f(ht.$$.fragment,$n),xi=c($n),wo=s($n,"P",{});var Rp=a(wo);$i=o(Rp,`Converts a sequence of ids in a string, using the tokenizer and vocabulary with options to remove special
tokens and clean up tokenization spaces.`),Rp.forEach(t),Pi=c($n),ut=s($n,"P",{});var Vr=a(ut);qi=o(Vr,"Similar to doing "),zo=s(Vr,"CODE",{});var Up=a(zo);Ei=o(Up,"self.convert_tokens_to_string(self.convert_ids_to_tokens(token_ids))"),Up.forEach(t),Bi=o(Vr,"."),Vr.forEach(t),$n.forEach(t),Li=c(m),ae=s(m,"DIV",{class:!0});var Pn=a(ae);f(ft.$$.fragment,Pn),Di=c(Pn),xo=s(Pn,"P",{});var Vp=a(xo);Ii=o(Vp,"Converts a string to a sequence of ids (integer), using the tokenizer and vocabulary."),Vp.forEach(t),Ni=c(Pn),_t=s(Pn,"P",{});var Hr=a(_t);Ai=o(Hr,"Same as doing "),$o=s(Hr,"CODE",{});var Hp=a($o);Fi=o(Hp,"self.convert_tokens_to_ids(self.tokenize(text))"),Hp.forEach(t),Si=o(Hr,"."),Hr.forEach(t),Pn.forEach(t),Ci=c(m),ie=s(m,"DIV",{class:!0});var qn=a(ie);f(gt.$$.fragment,qn),Oi=c(qn),Po=s(qn,"P",{});var Gp=a(Po);Wi=o(Gp,"Tokenize and prepare for the model a sequence or a pair of sequences."),Gp.forEach(t),ji=c(qn),f(We.$$.fragment,qn),qn.forEach(t),Mi=c(m),C=s(m,"DIV",{class:!0});var he=a(C);f(kt.$$.fragment,he),Ri=c(he),bt=s(he,"P",{});var Gr=a(bt);Ui=o(Gr,"Instantiate a "),_n=s(Gr,"A",{href:!0});var Xp=a(_n);Vi=o(Xp,"PreTrainedTokenizerBase"),Xp.forEach(t),Hi=o(Gr,` (or a derived class) from a predefined
tokenizer.`),Gr.forEach(t),Gi=c(he),f(je.$$.fragment,he),Xi=c(he),qo=s(he,"P",{});var Yp=a(qo);Yi=o(Yp,"Examples:"),Yp.forEach(t),Ji=c(he),f(vt.$$.fragment,he),he.forEach(t),Ki=c(m),Me=s(m,"DIV",{class:!0});var Xr=a(Me);f(Tt.$$.fragment,Xr),Qi=c(Xr),ve=s(Xr,"P",{});var En=a(ve);Zi=o(En,`Retrieves sequence ids from a token list that has no special tokens added. This method is called when adding
...
`),So=s(Ze,"CODE",{});var rm=a(So);Td=o(rm,"self.pad_token_id"),rm.forEach(t),yd=o(Ze," and "),Co=s(Ze,"CODE",{});var sm=a(Co);wd=o(sm,"self.pad_token_type_id"),sm.forEach(t),zd=o(Ze,")"),Ze.forEach(t),xd=c(Qe),f(Re.$$.fragment,Qe),Qe.forEach(t),$d=c(m),Ue=s(m,"DIV",{class:!0});var Yr=a(Ue);f(zt.$$.fragment,Yr),Pd=c(Yr),j=s(Yr,"P",{});var ue=a(j);qd=o(ue,`Prepares a sequence of input id, or a pair of sequences of inputs ids so that it can be used by the model. It
adds special tokens, truncates sequences if overflowing while taking into account the special tokens and
...
different than `),Wo=s(ue,"CODE",{});var im=a(Wo);Ld=o(im,"None"),im.forEach(t),Dd=o(ue," and "),jo=s(ue,"EM",{});var dm=a(jo);Id=o(dm,"truncation_strategy = longest_first"),dm.forEach(t),Nd=o(ue," or "),Mo=s(ue,"CODE",{});var cm=a(Mo);Ad=o(cm,"True"),cm.forEach(t),Fd=o(ue,`, it is not possible to return
overflowing tokens. Such a combination of arguments will raise an error.`),ue.forEach(t),Yr.forEach(t),Sd=c(m),Ve=s(m,"DIV",{class:!0});var Jr=a(Ve);f(xt.$$.fragment,Jr),Cd=c(Jr),Ro=s(Jr,"P",{});var lm=a(Ro);Od=o(lm,"Prepare model inputs for translation. For best performance, translate one sentence at a time."),lm.forEach(t),Jr.forEach(t),Wd=c(m),Y=s(m,"DIV",{class:!0});var et=a(Y);f($t.$$.fragment,et),jd=c(et),Pt=s(et,"P",{});var Kr=a(Pt);Md=o(Kr,`Upload the tokenizer files to the \u{1F917} Model Hub while synchronizing a local clone of the repo in
`),Uo=s(Kr,"CODE",{});var pm=a(Uo);Rd=o(pm,"repo_path_or_name"),pm.forEach(t),Ud=o(Kr,"."),Kr.forEach(t),Vd=c(et),Vo=s(et,"P",{});var mm=a(Vo);Hd=o(mm,"Examples:"),mm.forEach(t),Gd=c(et),f(qt.$$.fragment,et),et.forEach(t),Xd=c(m),le=s(m,"DIV",{class:!0});var Ln=a(le);f(Et.$$.fragment,Ln),Yd=c(Ln),Bt=s(Ln,"P",{});var Qr=a(Bt);Jd=o(Qr,`Register this class with a given auto class. This should only be used for custom tokenizers as the ones in the
library are already mapped with `),Ho=s(Qr,"CODE",{});var hm=a(Ho);Kd=o(hm,"AutoTokenizer"),hm.forEach(t),Qd=o(Qr,"."),Qr.forEach(t),Zd=c(Ln),f(He.$$.fragment,Ln),Ln.forEach(t),ec=c(m),J=s(m,"DIV",{class:!0});var tt=a(J);f(Lt.$$.fragment,tt),tc=c(tt),Go=s(tt,"P",{});var um=a(Go);nc=o(um,"Save the full tokenizer state."),um.forEach(t),oc=c(tt),Dt=s(tt,"P",{});var Zr=a(Dt);rc=o(Zr,`This method make sure the full tokenizer can then be re-loaded using the
...
matrix of the model so that its embedding matrix matches the tokenizer.`),Pm.forEach(t),Oc=c(L),Mt=s(L,"P",{});var as=a(Mt);Wc=o(as,"In order to do that, please use the "),bn=s(as,"A",{href:!0});var qm=a(bn);jc=o(qm,"resize_token_embeddings()"),qm.forEach(t),Mc=o(as," method."),as.forEach(t),Rc=c(L),Rt=s(L,"P",{});var is=a(Rt);Uc=o(is,"Using "),rr=s(is,"CODE",{});var Em=a(rr);Vc=o(Em,"add_special_tokens"),Em.forEach(t),Hc=o(is," will ensure your special tokens can be used in several ways:"),is.forEach(t),Gc=c(L),Ut=s(L,"UL",{});var ds=a(Ut);sr=s(ds,"LI",{});var Bm=a(sr);Xc=o(Bm,"Special tokens are carefully handled by the tokenizer (they are never split)."),Bm.forEach(t),Yc=c(ds),Vt=s(ds,"LI",{});var cs=a(Vt);Jc=o(cs,"You can easily refer to special tokens using tokenizer class attributes like "),ar=s(cs,"CODE",{});var Lm=a(ar);Kc=o(Lm,"tokenizer.cls_token"),Lm.forEach(t),Qc=o(cs,`. This
makes it easy to develop model-agnostic training and fine-tuning scripts.`),cs.forEach(t),ds.forEach(t),Zc=c(L),M=s(L,"P",{});var _e=a(M);el=o(_e,`When possible, special tokens are already registered for provided pretrained models (for instance
...
`),cr=s(_e,"CODE",{});var Am=a(cr);il=o(Am,"'</s>'"),Am.forEach(t),dl=o(_e,")."),_e.forEach(t),cl=c(L),lr=s(L,"P",{});var Fm=a(lr);ll=o(Fm,"Examples:"),Fm.forEach(t),pl=c(L),f(Ht.$$.fragment,L),L.forEach(t),ml=c(fe),N=s(fe,"DIV",{class:!0});var K=a(N);f(Gt.$$.fragment,K),hl=c(K),pr=s(K,"P",{});var Sm=a(pr);ul=o(Sm,`Add a list of new tokens to the tokenizer class. If the new tokens are not in the vocabulary, they are added to
...
`),fr=s(An,"CODE",{});var Mm=a(fr);El=o(Mm,"tokenizer.cls_token"),Mm.forEach(t),Bl=o(An,", etc.) are in the vocabulary."),An.forEach(t),Ll=c(Nn),_r=s(Nn,"P",{});var Rm=a(_r);Dl=o(Rm,"Add the missing ones to the vocabulary if needed."),Rm.forEach(t),Nn.forEach(t),fe.forEach(t),Ir=c(i),ze=s(i,"H2",{class:!0});var ps=a(ze);Je=s(ps,"A",{id:!0,class:!0,href:!0});var Um=a(Je);gr=s(Um,"SPAN",{});var Vm=a(gr);f(Kt.$$.fragment,Vm),Vm.forEach(t),Um.forEach(t),Il=c(ps),kr=s(ps,"SPAN",{});var Hm=a(kr);Nl=o(Hm,"Enums and namedtuples"),Hm.forEach(t),ps.forEach(t),Nr=c(i),xe=s(i,"DIV",{class:!0});var ms=a(xe);f(Qt.$$.fragment,ms),Al=c(ms),$e=s(ms,"P",{});var Fn=a($e);Fl=o(Fn,"Possible values for the "),br=s(Fn,"CODE",{});var Gm=a(br);Sl=o(Gm,"truncation"),Gm.forEach(t),Cl=o(Fn," argument in "),Ke=s(Fn,"A",{href:!0});var hs=a(Ke);Ol=o(hs,"PreTrainedTokenizerBase."),vr=s(hs,"STRONG",{});var Xm=a(vr);Wl=o(Xm,"call"),Xm.forEach(t),jl=o(hs,"()"),hs.forEach(t),Ml=o(Fn,`. Useful for tab-completion in
an IDE.`),Fn.forEach(t),ms.forEach(t),Ar=c(i),Pe=s(i,"DIV",{class:!0});var us=a(Pe);f(Zt.$$.fragment,us),Rl=c(us),Tr=s(us,"P",{});var Ym=a(Tr);Ul=o(Ym,"Character span in the original string."),Ym.forEach(t),us.forEach(t),Fr=c(i),qe=s(i,"DIV",{class:!0});var fs=a(qe);f(en.$$.fragment,fs),Vl=c(fs),yr=s(fs,"P",{});var Jm=a(yr);Hl=o(Jm,"Token span in an encoded string (list of tokens)."),Jm.forEach(t),fs.forEach(t),this.h()},h(){l(h,"name","hf:doc:metadata"),l(h,"content",JSON.stringify(dh)),l(z,"id","utilities-for-tokenizers"),l(z,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),l(z,"href","#utilities-for-tokenizers"),l(v,"class","relative group"),l(sn,"href","/docs/transformers/main/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase"),l(an,"href","/docs/transformers/main/en/main_classes/tokenizer#transformers.PreTrainedTokenizer"),l(dn,"href","/docs/transformers/main/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast"),l(cn,"href","/docs/transformers/main/en/internal/tokenization_utils#transformers.SpecialTokensMixin"),l(De,"id","transformers.PreTrainedTokenizerBase"),l(De,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),l(De,"href","#transformers.PreTrainedTokenizerBase"),l(ke,"class","relative group"),l(pn,"href","/docs/transformers/main/en/main_classes/tokenizer#transformers.PreTrainedTokenizer"),l(mn,"href","/docs/transformers/main/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast"),l(hn,"href","/docs/transformers/main/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.from_pretrained"),l(Ne,"class","docstring"),l(Ae,"class","docstring"),l(Fe,"class","docstring"),l(ne,"class","docstring"),l(oe,"class","docstring"),l(Ce,"class","docstring"),l(Oe,"class","docstring"),l(fn,"href","../glossary#token-type-ids"),l(re,"class","docstring"),l(se,"class","docstring"),l(ae,"class","docstring"),l(ie,"class","docstring"),l(_n,"href","/docs/transformers/main/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase"),l(C,"class","docstring"),l(Me,"class","docstring"),l(de,"class","docstring"),l(X,"class","docstring"),l(Ue,"class","docstring"),l(Ve,"class","docstring"),l(Y,"class","docstring"),l(le,"class","docstring"),l(J,"class","docstring"),l(pe,"class","docstring"),l(Ge,"class","docstring"),l(Xe,"class","docstring"),l(p,"class","docstring"),l(Ye,"id","transformers.SpecialTokensMixin"),l(Ye,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),l(Ye,"href","#transformers.SpecialTokensMixin"),l(Te,"class","relative group"),l(gn,"href","/docs/transformers/main/en/main_classes/tokenizer#transformers.PreTrainedTokenizer"),l(kn,"href","/docs/transformers/main/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast"),l(bn,"href","/docs/transformers/main/en/main_classes/model#transformers.PreTrainedModel.resize_token_embeddings"),l(vn,"href","/docs/transformers/main/en/model_doc/bert#transformers.BertTokenizer"),l(q,"class","docstring"),l(Tn,"href","/docs/transformers/main/en/main_classes/model#transformers.PreTrainedModel.resize_token_embeddings"),l(N,"class","docstring"),l(me,"class","docstring"),l(A,"class","docstring"),l(Je,"id","transformers.tokenization_utils_base.TruncationStrategy"),l(Je,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),l(Je,"href","#transformers.tokenization_utils_base.TruncationStrategy"),l(ze,"class","relative group"),l(Ke,"href","/docs/transformers/main/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__"),l(xe,"class","docstring"),l(Pe,"class","docstring"),l(qe,"class","docstring")},m(i,T){e(document.head,h),$(i,P,T),$(i,v,T),e(v,z),e(z,E),_(y,E,null),e(v,x),e(v,B),e(B,ge),$(i,W,T),$(i,D,T),e(D,rn),e(D,sn),e(sn,ks),e(D,bs),e(D,an),e(an,vs),e(D,Ts),e(D,dn),e(dn,ys),e(D,ws),e(D,cn),e(cn,zs),e(D,xs),$(i,qr,T),$(i,ln,T),e(ln,$s),$(i,Er,T),$(i,ke,T),e(ke,De),e(De,Sn),_(nt,Sn,null),e(ke,Ps),e(ke,Cn),e(Cn,qs),$(i,Br,T),$(i,p,T),_(ot,p,null),e(p,Es),e(p,be),e(be,Bs),e(be,pn),e(pn,Ls),e(be,Ds),e(be,mn),e(mn,Is),e(be,Ns),e(p,As),e(p,On),e(On,Fs),e(p,Ss),e(p,Wn),e(Wn,Cs),e(p,Os),e(p,I),e(I,te),e(te,jn),e(jn,Ws),e(te,js),e(te,Mn),e(Mn,Ms),e(te,Rs),e(te,Rn),e(Rn,Us),e(te,Vs),e(I,Hs),e(I,F),e(F,Un),e(Un,Gs),e(F,Xs),e(F,Vn),e(Vn,Ys),e(F,Js),e(F,Hn),e(Hn,Ks),e(F,Qs),e(F,Gn),e(Gn,Zs),e(F,ea),e(F,Xn),e(Xn,ta),e(F,na),e(I,oa),e(I,V),e(V,Yn),e(Yn,ra),e(V,sa),e(V,Jn),e(Jn,aa),e(V,ia),e(V,Kn),e(Kn,da),e(V,ca),e(V,Qn),e(Qn,la),e(V,pa),e(I,ma),e(I,S),e(S,Zn),e(Zn,ha),e(S,ua),e(S,eo),e(eo,fa),e(S,_a),e(S,to),e(to,ga),e(S,ka),e(S,no),e(no,ba),e(S,va),e(S,hn),e(hn,Ta),e(S,ya),e(I,wa),e(I,Ie),e(Ie,oo),e(oo,za),e(Ie,xa),e(Ie,ro),e(ro,$a),e(Ie,Pa),e(I,qa),e(I,H),e(H,so),e(so,Ea),e(H,Ba),e(H,ao),e(ao,La),e(H,Da),e(H,io),e(io,Ia),e(H,Na),e(H,co),e(co,Aa),e(H,Fa),e(I,Sa),e(I,G),e(G,lo),e(lo,Ca),e(G,Oa),e(G,po),e(po,Wa),e(G,ja),e(G,mo),e(mo,Ma),e(G,Ra),e(G,ho),e(ho,Ua),e(G,Va),e(p,Ha),e(p,Ne),_(rt,Ne,null),e(Ne,Ga),e(Ne,uo),e(uo,Xa),e(p,Ya),e(p,Ae),_(st,Ae,null),e(Ae,Ja),e(Ae,fo),e(fo,Ka),e(p,Qa),e(p,Fe),_(at,Fe,null),e(Fe,Za),e(Fe,_o),e(_o,ei),e(p,ti),e(p,ne),_(it,ne,null),e(ne,ni),e(ne,go),e(go,oi),e(ne,ri),_(Se,ne,null),e(p,si),e(p,oe),_(dt,oe,null),e(oe,ai),e(oe,ko),e(ko,ii),e(oe,di),e(oe,bo),e(bo,ci),e(p,li),e(p,Ce),_(ct,Ce,null),e(Ce,pi),e(Ce,vo),e(vo,mi),e(p,hi),e(p,Oe),_(lt,Oe,null),e(Oe,ui),e(Oe,pt),e(pt,fi),e(pt,To),e(To,_i),e(pt,gi),e(p,ki),e(p,re),_(mt,re,null),e(re,bi),e(re,un),e(un,vi),e(un,fn),e(fn,Ti),e(re,yi),e(re,yo),e(yo,wi),e(p,zi),e(p,se),_(ht,se,null),e(se,xi),e(se,wo),e(wo,$i),e(se,Pi),e(se,ut),e(ut,qi),e(ut,zo),e(zo,Ei),e(ut,Bi),e(p,Li),e(p,ae),_(ft,ae,null),e(ae,Di),e(ae,xo),e(xo,Ii),e(ae,Ni),e(ae,_t),e(_t,Ai),e(_t,$o),e($o,Fi),e(_t,Si),e(p,Ci),e(p,ie),_(gt,ie,null),e(ie,Oi),e(ie,Po),e(Po,Wi),e(ie,ji),_(We,ie,null),e(p,Mi),e(p,C),_(kt,C,null),e(C,Ri),e(C,bt),e(bt,Ui),e(bt,_n),e(_n,Vi),e(bt,Hi),e(C,Gi),_(je,C,null),e(C,Xi),e(C,qo),e(qo,Yi),e(C,Ji),_(vt,C,null),e(p,Ki),e(p,Me),_(Tt,Me,null),e(Me,Qi),e(Me,ve),e(ve,Zi),e(ve,Eo),e(Eo,ed),e(ve,td),e(ve,Bo),e(Bo,nd),e(ve,od),e(p,rd),e(p,de),_(yt,de,null),e(de,sd),e(de,Lo),e(Lo,ad),e(de,id),e(de,ce),e(ce,Do),e(Do,dd),e(ce,cd),e(ce,Io),e(Io,ld),e(ce,pd),e(ce,No),e(No,md),e(ce,hd),e(p,ud),e(p,X),_(wt,X,null),e(X,fd),e(X,Ao),e(Ao,_d),e(X,gd),e(X,Q),e(Q,kd),e(Q,Fo),e(Fo,bd),e(Q,vd),e(Q,So),e(So,Td),e(Q,yd),e(Q,Co),e(Co,wd),e(Q,zd),e(X,xd),_(Re,X,null),e(p,$d),e(p,Ue),_(zt,Ue,null),e(Ue,Pd),e(Ue,j),e(j,qd),e(j,Oo),e(Oo,Ed),e(j,Bd),e(j,Wo),e(Wo,Ld),e(j,Dd),e(j,jo),e(jo,Id),e(j,Nd),e(j,Mo),e(Mo,Ad),e(j,Fd),e(p,Sd),e(p,Ve),_(xt,Ve,null),e(Ve,Cd),e(Ve,Ro),e(Ro,Od),e(p,Wd),e(p,Y),_($t,Y,null),e(Y,jd),e(Y,Pt),e(Pt,Md),e(Pt,Uo),e(Uo,Rd),e(Pt,Ud),e(Y,Vd),e(Y,Vo),e(Vo,Hd),e(Y,Gd),_(qt,Y,null),e(p,Xd),e(p,le),_(Et,le,null),e(le,Yd),e(le,Bt),e(Bt,Jd),e(Bt,Ho),e(Ho,Kd),e(Bt,Qd),e(le,Zd),_(He,le,null),e(p,ec),e(p,J),_(Lt,J,null),e(J,tc),e(J,Go),e(Go,nc),e(J,oc),e(J,Dt),e(Dt,rc),e(Dt,Xo),e(Xo,sc),e(Dt,ac),e(J,ic),e(J,It),e(It,dc),e(It,Yo),e(Yo,cc),e(It,lc),e(p,pc),e(p,pe),_(Nt,pe,null),e(pe,mc),e(pe,Jo),e(Jo,hc),e(pe,uc),e(pe,At),e(At,fc),e(At,Ko),e(Ko,_c),e(At,gc),e(p,kc),e(p,Ge),_(Ft,Ge,null),e(Ge,bc),e(Ge,St),e(St,vc),e(St,Qo),e(Qo,Tc),e(St,yc),e(p,wc),e(p,Xe),_(Ct,Xe,null),e(Xe,zc),e(Xe,Zo),e(Zo,xc),$(i,Lr,T),$(i,Te,T),e(Te,Ye),e(Ye,er),_(Ot,er,null),e(Te,$c),e(Te,tr),e(tr,Pc),$(i,Dr,T),$(i,A,T),_(Wt,A,null),e(A,qc),e(A,ye),e(ye,Ec),e(ye,gn),e(gn,Bc),e(ye,Lc),e(ye,kn),e(kn,Dc),e(ye,Ic),e(A,Nc),e(A,q),_(jt,q,null),e(q,Ac),e(q,nr),e(nr,Fc),e(q,Sc),e(q,or),e(or,Cc),e(q,Oc),e(q,Mt),e(Mt,Wc),e(Mt,bn),e(bn,jc),e(Mt,Mc),e(q,Rc),e(q,Rt),e(Rt,Uc),e(Rt,rr),e(rr,Vc),e(Rt,Hc),e(q,Gc),e(q,Ut),e(Ut,sr),e(sr,Xc),e(Ut,Yc),e(Ut,Vt),e(Vt,Jc),e(Vt,ar),e(ar,Kc),e(Vt,Qc),e(q,Zc),e(q,M),e(M,el),e(M,vn),e(vn,tl),e(M,nl),e(M,ir),e(ir,ol),e(M,rl),e(M,dr),e(dr,sl),e(M,al),e(M,cr),e(cr,il),e(M,dl),e(q,cl),e(q,lr),e(lr,ll),e(q,pl),_(Ht,q,null),e(A,ml),e(A,N),_(Gt,N,null),e(N,hl),e(N,pr),e(pr,ul),e(N,fl),e(N,mr),e(mr,_l),e(N,gl),e(N,Xt),e(Xt,kl),e(Xt,Tn),e(Tn,bl),e(Xt,vl),e(N,Tl),e(N,hr),e(hr,yl),e(N,wl),_(Yt,N,null),e(A,zl),e(A,me),_(Jt,me,null),e(me,xl),e(me,we),e(we,$l),e(we,ur),e(ur,Pl),e(we,ql),e(we,fr),e(fr,El),e(we,Bl),e(me,Ll),e(me,_r),e(_r,Dl),$(i,Ir,T),$(i,ze,T),e(ze,Je),e(Je,gr),_(Kt,gr,null),e(ze,Il),e(ze,kr),e(kr,Nl),$(i,Nr,T),$(i,xe,T),_(Qt,xe,null),e(xe,Al),e(xe,$e),e($e,Fl),e($e,br),e(br,Sl),e($e,Cl),e($e,Ke),e(Ke,Ol),e(Ke,vr),e(vr,Wl),e(Ke,jl),e($e,Ml),$(i,Ar,T),$(i,Pe,T),_(Zt,Pe,null),e(Pe,Rl),e(Pe,Tr),e(Tr,Ul),$(i,Fr,T),$(i,qe,T),_(en,qe,null),e(qe,Vl),e(qe,yr),e(yr,Hl),Sr=!0},p(i,[T]){const tn={};T&2&&(tn.$$scope={dirty:T,ctx:i}),Se.$set(tn);const wr={};T&2&&(wr.$$scope={dirty:T,ctx:i}),We.$set(wr);const zr={};T&2&&(zr.$$scope={dirty:T,ctx:i}),je.$set(zr);const xr={};T&2&&(xr.$$scope={dirty:T,ctx:i}),Re.$set(xr);const R={};T&2&&(R.$$scope={dirty:T,ctx:i}),He.$set(R)},i(i){Sr||(g(y.$$.fragment,i),g(nt.$$.fragment,i),g(ot.$$.fragment,i),g(rt.$$.fragment,i),g(st.$$.fragment,i),g(at.$$.fragment,i),g(it.$$.fragment,i),g(Se.$$.fragment,i),g(dt.$$.fragment,i),g(ct.$$.fragment,i),g(lt.$$.fragment,i),g(mt.$$.fragment,i),g(ht.$$.fragment,i),g(ft.$$.fragment,i),g(gt.$$.fragment,i),g(We.$$.fragment,i),g(kt.$$.fragment,i),g(je.$$.fragment,i),g(vt.$$.fragment,i),g(Tt.$$.fragment,i),g(yt.$$.fragment,i),g(wt.$$.fragment,i),g(Re.$$.fragment,i),g(zt.$$.fragment,i),g(xt.$$.fragment,i),g($t.$$.fragment,i),g(qt.$$.fragment,i),g(Et.$$.fragment,i),g(He.$$.fragment,i),g(Lt.$$.fragment,i),g(Nt.$$.fragment,i),g(Ft.$$.fragment,i),g(Ct.$$.fragment,i),g(Ot.$$.fragment,i),g(Wt.$$.fragment,i),g(jt.$$.fragment,i),g(Ht.$$.fragment,i),g(Gt.$$.fragment,i),g(Yt.$$.fragment,i),g(Jt.$$.fragment,i),g(Kt.$$.fragment,i),g(Qt.$$.fragment,i),g(Zt.$$.fragment,i),g(en.$$.fragment,i),Sr=!0)},o(i){k(y.$$.fragment,i),k(nt.$$.fragment,i),k(ot.$$.fragment,i),k(rt.$$.fragment,i),k(st.$$.fragment,i),k(at.$$.fragment,i),k(it.$$.fragment,i),k(Se.$$.fragment,i),k(dt.$$.fragment,i),k(ct.$$.fragment,i),k(lt.$$.fragment,i),k(mt.$$.fragment,i),k(ht.$$.fragment,i),k(ft.$$.fragment,i),k(gt.$$.fragment,i),k(We.$$.fragment,i),k(kt.$$.fragment,i),k(je.$$.fragment,i),k(vt.$$.fragment,i),k(Tt.$$.fragment,i),k(yt.$$.fragment,i),k(wt.$$.fragment,i),k(Re.$$.fragment,i),k(zt.$$.fragment,i),k(xt.$$.fragment,i),k($t.$$.fragment,i),k(qt.$$.fragment,i),k(Et.$$.fragment,i),k(He.$$.fragment,i),k(Lt.$$.fragment,i),k(Nt.$$.fragment,i),k(Ft.$$.fragment,i),k(Ct.$$.fragment,i),k(Ot.$$.fragment,i),k(Wt.$$.fragment,i),k(jt.$$.fragment,i),k(Ht.$$.fragment,i),k(Gt.$$.fragment,i),k(Yt.$$.fragment,i),k(Jt.$$.fragment,i),k(Kt.$$.fragment,i),k(Qt.$$.fragment,i),k(Zt.$$.fragment,i),k(en.$$.fragment,i),Sr=!1},d(i){t(h),i&&t(P),i&&t(v),b(y),i&&t(W),i&&t(D),i&&t(qr),i&&t(ln),i&&t(Er),i&&t(ke),b(nt),i&&t(Br),i&&t(p),b(ot),b(rt),b(st),b(at),b(it),b(Se),b(dt),b(ct),b(lt),b(mt),b(ht),b(ft),b(gt),b(We),b(kt),b(je),b(vt),b(Tt),b(yt),b(wt),b(Re),b(zt),b(xt),b($t),b(qt),b(Et),b(He),b(Lt),b(Nt),b(Ft),b(Ct),i&&t(Lr),i&&t(Te),b(Ot),i&&t(Dr),i&&t(A),b(Wt),b(jt),b(Ht),b(Gt),b(Yt),b(Jt),i&&t(Ir),i&&t(ze),b(Kt),i&&t(Nr),i&&t(xe),b(Qt),i&&t(Ar),i&&t(Pe),b(Zt),i&&t(Fr),i&&t(qe),b(en)}}}const dh={local:"utilities-for-tokenizers",sections:[{local:"transformers.PreTrainedTokenizerBase",title:"PreTrainedTokenizerBase"},{local:"transformers.SpecialTokensMixin",title:"SpecialTokensMixin"},{local:"transformers.tokenization_utils_base.TruncationStrategy",title:"Enums and namedtuples"}],title:"Utilities for Tokenizers"};function ch(U){return th(()=>{new URLSearchParams(window.location.search).get("fw")}),[]}class fh extends Km{constructor(h){super();Qm(this,h,ch,ih,Zm,{})}}export{fh as default,dh as metadata};
