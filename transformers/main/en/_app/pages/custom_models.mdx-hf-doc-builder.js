...
to import from the `),u=l(I,"CODE",{});var ee=i(u);v=a(ee,"transformers"),ee.forEach(s),Y=a(I," package."),I.forEach(s)},m(P,I){f(P,m,I),t(m,E),t(m,u),t(u,v),t(m,Y)},d(P){P&&s(m)}}}function Ui(Z){let m,E,u,v,Y,P,I,ee,sa,qs,Ue,oa,Is,Ke,aa,Ns,N,na,be,ra,la,Ve,ia,fa,xs,G,te,Ot,ve,ca,Dt,da,Os,se,ha,Ft,ma,ua,Ds,Je,pa,Fs,$e,Ss,Qe,_a,Bs,x,ke,ga,St,ya,wa,ba,U,va,Bt,$a,ka,Ht,Ea,ja,Ca,K,Pa,Wt,Aa,Ta,Lt,Ra,Ma,Hs,O,qa,zt,Ia,Na,Yt,xa,Oa,Ws,D,Da,Gt,Fa,Sa,Ut,Ba,Ha,Ls,Xe,Wa,zs,Ee,Ys,A,La,Kt,za,Ya,Vt,Ga,Ua,Jt,Ka,Va,Gs,je,Us,F,Ja,Ze,Qa,Xa,et,Za,en,Ks,V,oe,Qt,Ce,tn,Xt,sn,Vs,S,on,tt,an,nn,st,rn,ln,Js,ae,fn,Zt,cn,dn,Qs,Pe,Xs,ot,hn,Zs,Ae,eo,C,mn,es,un,pn,ts,_n,gn,ss,yn,wn,os,bn,vn,to,ne,so,B,$n,as,kn,En,at,jn,Cn,oo,nt,Pn,ao,Te,no,T,An,rt,Tn,Rn,lt,Mn,qn,it,In,Nn,ro,ft,xn,lo,Re,io,H,On,ct,Dn,Fn,dt,Sn,Bn,fo,J,re,ns,Me,Hn,rs,Wn,co,le,ho,$,Ln,ls,zn,Yn,is,Gn,Un,fs,Kn,Vn,cs,Jn,Qn,ds,Xn,Zn,hs,er,tr,ms,sr,or,mo,qe,uo,W,ar,us,nr,rr,ps,lr,ir,po,ie,_o,ht,fr,go,mt,cr,yo,Ie,wo,fe,dr,_s,hr,mr,bo,Ne,vo,ce,ur,ut,pr,_r,$o,pt,gr,ko,xe,Eo,_t,yr,jo,Oe,Co,gt,wr,Po,De,Ao,yt,br,To,Fe,Ro,R,vr,gs,$r,kr,ys,Er,jr,Se,Cr,Pr,Mo,de,Ar,wt,Tr,Rr,qo,Q,he,ws,Be,Mr,bs,qr,Io,M,Ir,vs,Nr,xr,He,Or,Dr,$s,Fr,Sr,No,We,xo,me,Br,ks,Hr,Wr,Oo,Le,Do,bt,Lr,Fo,X,ue,Es,ze,zr,js,Yr,So,vt,Gr,Bo,L,Ur,Cs,Kr,Vr,Ps,Jr,Qr,Ho,Ye,Wo,q,Xr,$t,Zr,el,As,tl,sl,Ts,ol,al,Lo;return P=new xt({}),ve=new xt({}),$e=new k({props:{code:`from transformers import PretrainedConfig
...
<span class="hljs-keyword">class</span> <span class="hljs-title class_">ResnetModel</span>(<span class="hljs-title class_ inherited__">PreTrainedModel</span>):
    ...
    <span class="hljs-keyword">def</span> <span class="hljs-title function_">forward</span>(<span class="hljs-params">self, tensor, labels=<span class="hljs-literal">None</span></span>):
        ...
        <span class="hljs-keyword">return</span> {<span class="hljs-string">&quot;logits&quot;</span>: logits}`}}),ne=new nl({props:{$$slots:{default:[zi]},$$scope:{ctx:Z}}}),Te=new k({props:{code:"resnet50d = ResnetModelForImageClassification(resnet50d_config)",highlighted:"resnet50d = ResnetModelForImageClassification(resnet50d_config)"}}),Re=new k({props:{code:`import timm
...
resnet50d.model.load_state_dict(pretrained_model.state_dict())`}}),Me=new xt({}),le=new nl({props:{warning:!0,$$slots:{default:[Yi]},$$scope:{ctx:Z}}}),qe=new k({props:{code:`.
\u2514\u2500\u2500 resnet_model
    \u251C\u2500\u2500 __init__.py
...
after checking the validity of a few of them.`),Fs=c(),p($e.$$.fragment),Ss=c(),Qe=r("p"),_a=o("The three important things to remember when writing you own configuration are the following:"),Bs=c(),x=r("ul"),ke=r("li"),ga=o("you have to inherit from "),St=r("code"),ya=o("PretrainedConfig"),wa=o(","),ba=c(),U=r("li"),va=o("the "),Bt=r("code"),$a=o("__init__"),ka=o(" of your "),Ht=r("code"),Ea=o("PretrainedConfig"),ja=o(" must accept any kwargs,"),Ca=c(),K=r("li"),Pa=o("those "),Wt=r("code"),Aa=o("kwargs"),Ta=o(" need to be passed to the superclass "),Lt=r("code"),Ra=o("__init__"),Ma=o("."),Hs=c(),O=r("p"),qa=o(`The inheritance is to make sure you get all the functionality from the \u{1F917} Transformers library, while the two other
constraints come from the fact a `),zt=r("code"),Ia=o("PretrainedConfig"),Na=o(` has more fields than the ones you are setting. When reloading a
config with the `),Yt=r("code"),xa=o("from_pretrained"),Oa=o(` method, those fields need to be accepted by your config and then sent to the
...
library. Here is how we can create a resnet50d config and save it:`),zs=c(),p(Ee.$$.fragment),Ys=c(),A=r("p"),La=o("This will save a file named "),Kt=r("code"),za=o("config.json"),Ya=o(" inside the folder "),Vt=r("code"),Ga=o("custom-resnet"),Ua=o(`. You can then reload your config with the
...
training loop or another library for training.`),oo=c(),nt=r("p"),Pn=o("Now that we have our model class, let\u2019s create one:"),ao=c(),p(Te.$$.fragment),no=c(),T=r("p"),An=o("Again, you can use any of the methods of "),rt=r("a"),Tn=o("PreTrainedModel"),Rn=o(", like "),lt=r("a"),Mn=o("save_pretrained()"),qn=o(` or
...
code of the model is saved.`),fo=c(),J=r("h2"),re=r("a"),ns=r("span"),p(Me.$$.fragment),Hn=c(),rs=r("span"),Wn=o("Sending the code to the Hub"),co=c(),p(le.$$.fragment),ho=c(),$=r("p"),Ln=o("First, make sure your model is fully defined in a "),ls=r("code"),zn=o(".py"),Yn=o(` file. It can rely on relative imports to some other files as
...
in this `),Se=r("a"),Cr=o("model repo"),Pr=o("."),Mo=c(),de=r("p"),Ar=o("See the "),wt=r("a"),Tr=o("sharing tutorial"),Rr=o(" for more information on the push to Hub method."),qo=c(),Q=r("h2"),he=r("a"),ws=r("span"),p(Be.$$.fragment),Mr=c(),bs=r("span"),qr=o("Using a model with custom code"),Io=c(),M=r("p"),Ir=o(`You can use any configuration, model or tokenizer with custom code files in its repository with the auto-classes and
...
hash of any commit.`),Fo=c(),X=r("h2"),ue=r("a"),Es=r("span"),p(ze.$$.fragment),zr=c(),js=r("span"),Yr=o("Registering a model with custom code to the auto classes"),So=c(),vt=r("p"),Gr=o(`If you are writing a library that extends \u{1F917} Transformers, you may want to extend the auto classes to include your own
...
to match the `),Ts=r("code"),ol=o("config_class"),al=o(" of those models."),this.h()},l(e){const n=Wi('[data-svelte="svelte-1phssyn"]',document.head);m=l(n,"META",{name:!0,content:!0}),n.forEach(s),E=d(e),u=l(e,"H1",{class:!0});var Ge=i(u);v=l(Ge,"A",{id:!0,class:!0,href:!0});var Rs=i(v);Y=l(Rs,"SPAN",{});var Ms=i(Y);_(P.$$.fragment,Ms),Ms.forEach(s),Rs.forEach(s),I=d(Ge),ee=l(Ge,"SPAN",{});var rl=i(ee);sa=a(rl,"Sharing custom models"),rl.forEach(s),Ge.forEach(s),qs=d(e),Ue=l(e,"P",{});var ll=i(Ue);oa=a(ll,`The \u{1F917} Transformers library is designed to be easily extensible. Every model is fully coded in a given subfolder
...
usable inside the `),at=l(Mt,"A",{href:!0});var zl=i(at);jn=a(zl,"Trainer"),zl.forEach(s),Cn=a(Mt,` class. Using another output format is fine as long as you are planning on using your own
training loop or another library for training.`),Mt.forEach(s),oo=d(e),nt=l(e,"P",{});var Yl=i(nt);Pn=a(Yl,"Now that we have our model class, let\u2019s create one:"),Yl.forEach(s),ao=d(e),_(Te.$$.fragment,e),no=d(e),T=l(e,"P",{});var _e=i(T);An=a(_e,"Again, you can use any of the methods of "),rt=l(_e,"A",{href:!0});var Gl=i(rt);Tn=a(Gl,"PreTrainedModel"),Gl.forEach(s),Rn=a(_e,", like "),lt=l(_e,"A",{href:!0});var Ul=i(lt);Mn=a(Ul,"save_pretrained()"),Ul.forEach(s),qn=a(_e,` or
...
code of the model is saved.`),qt.forEach(s),fo=d(e),J=l(e,"H2",{class:!0});var Vo=i(J);re=l(Vo,"A",{id:!0,class:!0,href:!0});var Xl=i(re);ns=l(Xl,"SPAN",{});var Zl=i(ns);_(Me.$$.fragment,Zl),Zl.forEach(s),Xl.forEach(s),Hn=d(Vo),rs=l(Vo,"SPAN",{});var ei=i(rs);Wn=a(ei,"Sending the code to the Hub"),ei.forEach(s),Vo.forEach(s),co=d(e),_(le.$$.fragment,e),ho=d(e),$=l(e,"P",{});var j=i($);Ln=a(j,"First, make sure your model is fully defined in a "),ls=l(j,"CODE",{});var ti=i(ls);zn=a(ti,".py"),ti.forEach(s),Yn=a(j,` file. It can rely on relative imports to some other files as
long as all the files are in the same directory (we don\u2019t support submodules for this feature yet). For our example,
...
in this `),Se=l(ge,"A",{href:!0,rel:!0});var bi=i(Se);Cr=a(bi,"model repo"),bi.forEach(s),Pr=a(ge,"."),ge.forEach(s),Mo=d(e),de=l(e,"P",{});var Xo=i(de);Ar=a(Xo,"See the "),wt=l(Xo,"A",{href:!0});var vi=i(wt);Tr=a(vi,"sharing tutorial"),vi.forEach(s),Rr=a(Xo," for more information on the push to Hub method."),Xo.forEach(s),qo=d(e),Q=l(e,"H2",{class:!0});var Zo=i(Q);he=l(Zo,"A",{id:!0,class:!0,href:!0});var $i=i(he);ws=l($i,"SPAN",{});var ki=i(ws);_(Be.$$.fragment,ki),ki.forEach(s),$i.forEach(s),Mr=d(Zo),bs=l(Zo,"SPAN",{});var Ei=i(bs);qr=a(Ei,"Using a model with custom code"),Ei.forEach(s),Zo.forEach(s),Io=d(e),M=l(e,"P",{});var ye=i(M);Ir=a(ye,`You can use any configuration, model or tokenizer with custom code files in its repository with the auto-classes and
...
hash of any commit.`),Ti.forEach(s),Fo=d(e),X=l(e,"H2",{class:!0});var ta=i(X);ue=l(ta,"A",{id:!0,class:!0,href:!0});var Ri=i(ue);Es=l(Ri,"SPAN",{});var Mi=i(Es);_(ze.$$.fragment,Mi),Mi.forEach(s),Ri.forEach(s),zr=d(ta),js=l(ta,"SPAN",{});var qi=i(js);Yr=a(qi,"Registering a model with custom code to the auto classes"),qi.forEach(s),ta.forEach(s),So=d(e),vt=l(e,"P",{});var Ii=i(vt);Gr=a(Ii,`If you are writing a library that extends \u{1F917} Transformers, you may want to extend the auto classes to include your own
model. This is different from pushing the code to the Hub in the sense that users will need to import your library to
