...
`),Tn=l("em"),_c=o("features"),jc=o("."),Rr=m(),ge=l("p"),kc=o("In the next section, we show how "),wa=l("a"),wc=o("generation.GenerationMixin.generate()"),xc=o(` can be used to
...
`),Tn=i(Ga,"EM",{});var Pf=p(Tn);_c=r(Pf,"features"),Pf.forEach(t),jc=r(Ga,"."),Ga.forEach(t),Rr=g(s),ge=i(s,"P",{});var li=p(ge);kc=r(li,"In the next section, we show how "),wa=i(li,"A",{href:!0});var Ff=p(wa);wc=r(Ff,"generation.GenerationMixin.generate()"),Ff.forEach(t),xc=r(li,` can be used to
