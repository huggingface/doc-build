import{S as xi,i as ji,s as $i,e as a,k as i,w as u,t,M as qi,c as s,d as o,m as c,a as d,x as g,h as r,b as l,F as e,g as h,y as _,q as b,o as v,B as y}from"../../chunks/vendor-4833417e.js";import{T as dd}from"../../chunks/Tip-fffd6df1.js";import{D as O}from"../../chunks/Docstring-4f315ed9.js";import{C as Me}from"../../chunks/CodeBlock-6a3d1b46.js";import{I as Gn}from"../../chunks/IconCopyLink-4b81c553.js";import"../../chunks/CopyButton-dacfbfaf.js";function Pi(Q){let m,x,f,w,P;return{c(){m=a("p"),x=t("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=a("code"),w=t("Module"),P=t(`
...
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),T.forEach(o)},m(k,T){h(k,m,T),e(m,x),e(m,f),e(f,w),e(m,P)},d(k){k&&o(m)}}}function Fi(Q){let m,x,f,w,P;return{c(){m=a("p"),x=t("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=a("code"),w=t("Module"),P=t(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(k){m=s(k,"P",{});var T=d(m);x=r(T,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=s(T,"CODE",{});var F=d(f);w=r(F,"Module"),F.forEach(o),P=r(T,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),T.forEach(o)},m(k,T){h(k,m,T),e(m,x),e(m,f),e(f,w),e(m,P)},d(k){k&&o(m)}}}function Ci(Q){let m,x,f,w,P;return{c(){m=a("p"),x=t("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=a("code"),w=t("Module"),P=t(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(k){m=s(k,"P",{});var T=d(m);x=r(T,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=s(T,"CODE",{});var F=d(f);w=r(F,"Module"),F.forEach(o),P=r(T,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),T.forEach(o)},m(k,T){h(k,m,T),e(m,x),e(m,f),e(f,w),e(m,P)},d(k){k&&o(m)}}}function Ai(Q){let m,x,f,w,P,k,T,F,zt,Un,me,Mt,wo,xt,jt,Vn,he,$t,xe,qt,Pt,Hn,fe,Ft,Eo,Ct,At,Yn,W,St,Do,Nt,It,je,Lt,Bt,Jn,R,Ot,Qo,Wt,Rt,Xo,Gt,Ut,Zn,$e,Kn,G,Vt,qe,Ht,Yt,Pe,Jt,Zt,Qn,X,ue,en,Fe,Kt,on,Qt,Xn,M,Ce,Xt,ge,zo,er,or,Mo,nr,tr,rr,ee,ar,xo,sr,dr,jo,ir,cr,lr,nn,pr,mr,Ae,hr,_e,Se,fr,Ne,ur,$o,gr,_r,br,be,Ie,vr,oe,yr,tn,kr,Tr,rn,wr,Er,et,ne,ve,an,Le,Dr,sn,zr,ot,E,Be,Mr,te,xr,dn,jr,$r,cn,qr,Pr,Fr,Oe,Cr,We,Ar,Sr,Nr,ln,Ir,Lr,Re,Br,qo,Or,Wr,Rr,Ge,Gr,Ue,Ur,Vr,Hr,U,Po,Yr,Jr,pn,Zr,Kr,mn,Qr,Xr,ea,C,Ve,oa,re,na,Fo,ta,ra,hn,aa,sa,da,ye,ia,fn,ca,la,He,pa,A,Ye,ma,un,ha,fa,ae,ua,gn,ga,_a,_n,ba,va,ya,bn,ka,Ta,Je,nt,se,ke,vn,Ze,wa,yn,Ea,tt,D,Ke,Da,de,za,kn,Ma,xa,Tn,ja,$a,qa,Qe,Pa,Xe,Fa,Ca,Aa,wn,Sa,Na,eo,Ia,Co,La,Ba,Oa,oo,Wa,no,Ra,Ga,Ua,V,Ao,Va,Ha,En,Ya,Ja,Dn,Za,Ka,Qa,S,to,Xa,ie,es,So,os,ns,zn,ts,rs,as,Te,ss,Mn,ds,is,ro,cs,L,ao,ls,xn,ps,ms,jn,hs,fs,so,rt,ce,we,$n,io,us,qn,gs,at,z,co,_s,le,bs,Pn,vs,ys,Fn,ks,Ts,ws,lo,Es,po,Ds,zs,Ms,Cn,xs,js,mo,$s,No,qs,Ps,Fs,ho,Cs,fo,As,Ss,Ns,H,Io,Is,Ls,An,Bs,Os,Sn,Ws,Rs,Gs,N,uo,Us,pe,Vs,Lo,Hs,Ys,Nn,Js,Zs,Ks,Ee,Qs,In,Xs,ed,go,od,B,_o,nd,Ln,td,rd,Bn,ad,sd,bo,st;return k=new Gn({}),$e=new Me({props:{code:`# a workaround to load from pytorch checkpoint
...
<span class="hljs-meta">&gt;&gt;&gt; </span>model.save_pretrained(<span class="hljs-string">&quot;./bert2gpt2&quot;</span>)
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-comment"># load fine-tuned model</span>
<span class="hljs-meta">&gt;&gt;&gt; </span>model = FlaxEncoderDecoderModel.from_pretrained(<span class="hljs-string">&quot;./bert2gpt2&quot;</span>)`}}),{c(){m=a("meta"),x=i(),f=a("h1"),w=a("a"),P=a("span"),u(k.$$.fragment),T=i(),F=a("span"),zt=t("Encoder Decoder Models"),Un=i(),me=a("p"),Mt=t("The "),wo=a("a"),xt=t("EncoderDecoderModel"),jt=t(` can be used to initialize a sequence-to-sequence model with any
...
was shown in `),xe=a("a"),qt=t("Leveraging Pre-trained Checkpoints for Sequence Generation Tasks"),Pt=t(` by
...
and decoder for a summarization model as was shown in: `),je=a("a"),Lt=t("Text Summarization with Pretrained Encoders"),Bt=t(" by Yang Liu and Mirella Lapata."),Jn=i(),R=a("p"),Ot=t("The "),Qo=a("code"),Wt=t("from_pretrained()"),Rt=t(`currently doesn\u2019t support initializing the model from a
...
checkpoints for a particular encoder-decoder model, a workaround is:`),Zn=i(),u($e.$$.fragment),Kn=i(),G=a("p"),Vt=t("This model was contributed by "),qe=a("a"),Ht=t("thomwolf"),Yt=t(`. This model\u2019s TensorFlow and Flax versions
...
configs.`),rr=i(),ee=a("p"),ar=t("Configuration objects inherit from "),xo=a("a"),sr=t("PretrainedConfig"),dr=t(` and can be used to control the model outputs. Read the
documentation from `),jo=a("a"),ir=t("PretrainedConfig"),cr=t(" for more information."),lr=i(),nn=a("p"),pr=t("Examples:"),mr=i(),u(Ae.$$.fragment),hr=i(),_e=a("div"),u(Se.$$.fragment),fr=i(),Ne=a("p"),ur=t("Instantiate a "),$o=a("a"),gr=t("EncoderDecoderConfig"),_r=t(` (or a derived class) from a pre-trained encoder model configuration and
decoder model configuration.`),br=i(),be=a("div"),u(Ie.$$.fragment),vr=i(),oe=a("p"),yr=t("Serializes this instance to a Python dictionary. Override the default "),tn=a("em"),kr=t("to_dict()"),Tr=t(" from "),rn=a("em"),wr=t("PretrainedConfig"),Er=t("."),et=i(),ne=a("h2"),ve=a("a"),an=a("span"),u(Le.$$.fragment),Dr=i(),sn=a("span"),zr=t("EncoderDecoderModel"),ot=i(),E=a("div"),u(Be.$$.fragment),Mr=i(),te=a("p"),xr=t(`This class can be used to initialize a sequence-to-sequence model with any pretrained autoencoding model as the
encoder and any pretrained autoregressive model as the decoder. The encoder is loaded via
`),dn=a("code"),jr=t("from_pretrained()"),$r=t("function and the decoder is loaded via "),cn=a("code"),qr=t("from_pretrained()"),Pr=t(`function. Cross-attention layers are automatically added to the decoder and should be fine-tuned on a downstream
...
(see the examples for more information).`),Lr=i(),Re=a("p"),Br=t("This model inherits from "),qo=a("a"),Or=t("PreTrainedModel"),Wr=t(`. Check the superclass documentation for the generic methods the
...
encoder and any pretrained autoregressive model as the decoder. The encoder is loaded via
`),kn=a("code"),Ma=t("from_pretrained()"),xa=t("function and the decoder is loaded via "),Tn=a("code"),ja=t("from_pretrained()"),$a=t(`function. Cross-attention layers are automatically added to the decoder and should be fine-tuned on a downstream
generative task, like summarization.`),qa=i(),Qe=a("p"),Pa=t(`The effectiveness of initializing sequence-to-sequence models with pretrained checkpoints for sequence generation
...
method for the decoder.`),Qa=i(),S=a("div"),u(to.$$.fragment),Xa=i(),ie=a("p"),es=t("The "),So=a("a"),os=t("TFEncoderDecoderModel"),ns=t(" forward method, overrides the "),zn=a("code"),ts=t("__call__"),rs=t(" special method."),as=i(),u(Te.$$.fragment),ss=i(),Mn=a("p"),ds=t("Examples:"),is=i(),u(ro.$$.fragment),cs=i(),L=a("div"),u(ao.$$.fragment),ls=i(),xn=a("p"),ps=t(`Instantiate an encoder and a decoder from one or two base classes of the library from pretrained model
checkpoints.`),ms=i(),jn=a("p"),hs=t("Example:"),fs=i(),u(so.$$.fragment),rt=i(),ce=a("h2"),we=a("a"),$n=a("span"),u(io.$$.fragment),us=i(),qn=a("span"),gs=t("FlaxEncoderDecoderModel"),at=i(),z=a("div"),u(co.$$.fragment),_s=i(),le=a("p"),bs=t(`This class can be used to initialize a sequence-to-sequence model with any pretrained autoencoding model as the
encoder and any pretrained autoregressive model as the decoder. The encoder is loaded via
...
Zhou, Wei Li, Peter J. Liu.`),Ms=i(),Cn=a("p"),xs=t(`After such an Encoder Decoder model has been trained/fine-tuned, it can be saved/loaded just like any other models
(see the examples for more information).`),js=i(),mo=a("p"),$s=t("This model inherits from "),No=a("a"),qs=t("FlaxPreTrainedModel"),Ps=t(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
checkpoints.`),rd=i(),Bn=a("p"),ad=t("Example:"),sd=i(),u(bo.$$.fragment),this.h()},l(n){const p=qi('[data-svelte="svelte-1phssyn"]',document.head);m=s(p,"META",{name:!0,content:!0}),p.forEach(o),x=c(n),f=s(n,"H1",{class:!0});var vo=d(f);w=s(vo,"A",{id:!0,class:!0,href:!0});var On=d(w);P=s(On,"SPAN",{});var Wn=d(P);g(k.$$.fragment,Wn),Wn.forEach(o),On.forEach(o),T=c(vo),F=s(vo,"SPAN",{});var id=d(F);zt=r(id,"Encoder Decoder Models"),id.forEach(o),vo.forEach(o),Un=c(n),me=s(n,"P",{});var dt=d(me);Mt=r(dt,"The "),wo=s(dt,"A",{href:!0});var cd=d(wo);xt=r(cd,"EncoderDecoderModel"),cd.forEach(o),jt=r(dt,` can be used to initialize a sequence-to-sequence model with any
...
was shown in `),xe=s(it,"A",{href:!0,rel:!0});var ld=d(xe);qt=r(ld,"Leveraging Pre-trained Checkpoints for Sequence Generation Tasks"),ld.forEach(o),Pt=r(it,` by
...
checkpoints for a particular encoder-decoder model, a workaround is:`),Oo.forEach(o),Zn=c(n),g($e.$$.fragment,n),Kn=c(n),G=s(n,"P",{});var Wo=d(G);Vt=r(Wo,"This model was contributed by "),qe=s(Wo,"A",{href:!0,rel:!0});var gd=d(qe);Ht=r(gd,"thomwolf"),gd.forEach(o),Yt=r(Wo,`. This model\u2019s TensorFlow and Flax versions
...
used to instantiate an Encoder Decoder model according to the specified arguments, defining the encoder and decoder
configs.`),Rn.forEach(o),rr=c(I),ee=s(I,"P",{});var Ro=d(ee);ar=r(Ro,"Configuration objects inherit from "),xo=s(Ro,"A",{href:!0});var wd=d(xo);sr=r(wd,"PretrainedConfig"),wd.forEach(o),dr=r(Ro,` and can be used to control the model outputs. Read the
documentation from `),jo=s(Ro,"A",{href:!0});var Ed=d(jo);ir=r(Ed,"PretrainedConfig"),Ed.forEach(o),cr=r(Ro," for more information."),Ro.forEach(o),lr=c(I),nn=s(I,"P",{});var Dd=d(nn);pr=r(Dd,"Examples:"),Dd.forEach(o),mr=c(I),g(Ae.$$.fragment,I),hr=c(I),_e=s(I,"DIV",{class:!0});var pt=d(_e);g(Se.$$.fragment,pt),fr=c(pt),Ne=s(pt,"P",{});var mt=d(Ne);ur=r(mt,"Instantiate a "),$o=s(mt,"A",{href:!0});var zd=d($o);gr=r(zd,"EncoderDecoderConfig"),zd.forEach(o),_r=r(mt,` (or a derived class) from a pre-trained encoder model configuration and
decoder model configuration.`),mt.forEach(o),pt.forEach(o),br=c(I),be=s(I,"DIV",{class:!0});var ht=d(be);g(Ie.$$.fragment,ht),vr=c(ht),oe=s(ht,"P",{});var Go=d(oe);yr=r(Go,"Serializes this instance to a Python dictionary. Override the default "),tn=s(Go,"EM",{});var Md=d(tn);kr=r(Md,"to_dict()"),Md.forEach(o),Tr=r(Go," from "),rn=s(Go,"EM",{});var xd=d(rn);wr=r(xd,"PretrainedConfig"),xd.forEach(o),Er=r(Go,"."),Go.forEach(o),ht.forEach(o),I.forEach(o),et=c(n),ne=s(n,"H2",{class:!0});var ft=d(ne);ve=s(ft,"A",{id:!0,class:!0,href:!0});var jd=d(ve);an=s(jd,"SPAN",{});var $d=d(an);g(Le.$$.fragment,$d),$d.forEach(o),jd.forEach(o),Dr=c(ft),sn=s(ft,"SPAN",{});var qd=d(sn);zr=r(qd,"EncoderDecoderModel"),qd.forEach(o),ft.forEach(o),ot=c(n),E=s(n,"DIV",{class:!0});var j=d(E);g(Be.$$.fragment,j),Mr=c(j),te=s(j,"P",{});var Uo=d(te);xr=r(Uo,`This class can be used to initialize a sequence-to-sequence model with any pretrained autoencoding model as the
encoder and any pretrained autoregressive model as the decoder. The encoder is loaded via
`),dn=s(Uo,"CODE",{});var Pd=d(dn);jr=r(Pd,"from_pretrained()"),Pd.forEach(o),$r=r(Uo,"function and the decoder is loaded via "),cn=s(Uo,"CODE",{});var Fd=d(cn);qr=r(Fd,"from_pretrained()"),Fd.forEach(o),Pr=r(Uo,`function. Cross-attention layers are automatically added to the decoder and should be fine-tuned on a downstream
generative task, like summarization.`),Uo.forEach(o),Fr=c(j),Oe=s(j,"P",{});var ut=d(Oe);Cr=r(ut,`The effectiveness of initializing sequence-to-sequence models with pretrained checkpoints for sequence generation
...
Zhou, Wei Li, Peter J. Liu.`),ut.forEach(o),Nr=c(j),ln=s(j,"P",{});var Ad=d(ln);Ir=r(Ad,`After such an Encoder Decoder model has been trained/fine-tuned, it can be saved/loaded just like any other models
(see the examples for more information).`),Ad.forEach(o),Lr=c(j),Re=s(j,"P",{});var gt=d(Re);Br=r(gt,"This model inherits from "),qo=s(gt,"A",{href:!0});var Sd=d(qo);Or=r(Sd,"PreTrainedModel"),Sd.forEach(o),Wr=r(gt,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),gt.forEach(o),Rr=c(j),Ge=s(j,"P",{});var _t=d(Ge);Gr=r(_t,"This model is also a PyTorch "),Ue=s(_t,"A",{href:!0,rel:!0});var Nd=d(Ue);Ur=r(Nd,"torch.nn.Module"),Nd.forEach(o),Vr=r(_t,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),_t.forEach(o),Hr=c(j),U=s(j,"P",{});var yo=d(U);Po=s(yo,"A",{href:!0});var Id=d(Po);Yr=r(Id,"EncoderDecoderModel"),Id.forEach(o),Jr=r(yo,` is a generic model class that will be instantiated as a transformer architecture with one
of the base model classes of the library as encoder and another one as decoder when created with the
...
:meth`),mn=s(yo,"EM",{});var Bd=d(mn);Qr=r(Bd,"~transformers.AutoModelForCausalLM.from_pretrained"),Bd.forEach(o),Xr=r(yo," class method for the decoder."),yo.forEach(o),ea=c(j),C=s(j,"DIV",{class:!0});var Y=d(C);g(Ve.$$.fragment,Y),oa=c(Y),re=s(Y,"P",{});var Vo=d(re);na=r(Vo,"The "),Fo=s(Vo,"A",{href:!0});var Od=d(Fo);ta=r(Od,"EncoderDecoderModel"),Od.forEach(o),ra=r(Vo," forward method, overrides the "),hn=s(Vo,"CODE",{});var Wd=d(hn);aa=r(Wd,"__call__"),Wd.forEach(o),sa=r(Vo," special method."),Vo.forEach(o),da=c(Y),g(ye.$$.fragment,Y),ia=c(Y),fn=s(Y,"P",{});var Rd=d(fn);ca=r(Rd,"Examples:"),Rd.forEach(o),la=c(Y),g(He.$$.fragment,Y),Y.forEach(o),pa=c(j),A=s(j,"DIV",{class:!0});var J=d(A);g(Ye.$$.fragment,J),ma=c(J),un=s(J,"P",{});var Gd=d(un);ha=r(Gd,`Instantiate an encoder and a decoder from one or two base classes of the library from pretrained model
...
the model, you need to first set it back in training mode with `),_n=s(Ho,"CODE",{});var Vd=d(_n);ba=r(Vd,"model.train()"),Vd.forEach(o),va=r(Ho,"."),Ho.forEach(o),ya=c(J),bn=s(J,"P",{});var Hd=d(bn);ka=r(Hd,"Example:"),Hd.forEach(o),Ta=c(J),g(Je.$$.fragment,J),J.forEach(o),j.forEach(o),nt=c(n),se=s(n,"H2",{class:!0});var bt=d(se);ke=s(bt,"A",{id:!0,class:!0,href:!0});var Yd=d(ke);vn=s(Yd,"SPAN",{});var Jd=d(vn);g(Ze.$$.fragment,Jd),Jd.forEach(o),Yd.forEach(o),wa=c(bt),yn=s(bt,"SPAN",{});var Zd=d(yn);Ea=r(Zd,"TFEncoderDecoderModel"),Zd.forEach(o),bt.forEach(o),tt=c(n),D=s(n,"DIV",{class:!0});var $=d(D);g(Ke.$$.fragment,$),Da=c($),de=s($,"P",{});var Yo=d(de);za=r(Yo,`This class can be used to initialize a sequence-to-sequence model with any pretrained autoencoding model as the
encoder and any pretrained autoregressive model as the decoder. The encoder is loaded via
`),kn=s(Yo,"CODE",{});var Kd=d(kn);Ma=r(Kd,"from_pretrained()"),Kd.forEach(o),xa=r(Yo,"function and the decoder is loaded via "),Tn=s(Yo,"CODE",{});var Qd=d(Tn);ja=r(Qd,"from_pretrained()"),Qd.forEach(o),$a=r(Yo,`function. Cross-attention layers are automatically added to the decoder and should be fine-tuned on a downstream
generative task, like summarization.`),Yo.forEach(o),qa=c($),Qe=s($,"P",{});var vt=d(Qe);Pa=r(vt,`The effectiveness of initializing sequence-to-sequence models with pretrained checkpoints for sequence generation
...
Zhou, Wei Li, Peter J. Liu.`),vt.forEach(o),Aa=c($),wn=s($,"P",{});var ei=d(wn);Sa=r(ei,`After such an Encoder Decoder model has been trained/fine-tuned, it can be saved/loaded just like any other models
(see the examples for more information).`),ei.forEach(o),Na=c($),eo=s($,"P",{});var yt=d(eo);Ia=r(yt,"This model inherits from "),Co=s(yt,"A",{href:!0});var oi=d(Co);La=r(oi,"TFPreTrainedModel"),oi.forEach(o),Ba=r(yt,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),yt.forEach(o),Oa=c($),oo=s($,"P",{});var kt=d(oo);Wa=r(kt,"This model is also a "),no=s(kt,"A",{href:!0,rel:!0});var ni=d(no);Ra=r(ni,"tf.keras.Model"),ni.forEach(o),Ga=r(kt,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),kt.forEach(o),Ua=c($),V=s($,"P",{});var ko=d(V);Ao=s(ko,"A",{href:!0});var ti=d(Ao);Va=r(ti,"TFEncoderDecoderModel"),ti.forEach(o),Ha=r(ko,` is a generic model class that will be instantiated as a transformer architecture with one
of the base model classes of the library as encoder and another one as decoder when created with the
...
method for the decoder.`),ko.forEach(o),Qa=c($),S=s($,"DIV",{class:!0});var Z=d(S);g(to.$$.fragment,Z),Xa=c(Z),ie=s(Z,"P",{});var Jo=d(ie);es=r(Jo,"The "),So=s(Jo,"A",{href:!0});var si=d(So);os=r(si,"TFEncoderDecoderModel"),si.forEach(o),ns=r(Jo," forward method, overrides the "),zn=s(Jo,"CODE",{});var di=d(zn);ts=r(di,"__call__"),di.forEach(o),rs=r(Jo," special method."),Jo.forEach(o),as=c(Z),g(Te.$$.fragment,Z),ss=c(Z),Mn=s(Z,"P",{});var ii=d(Mn);ds=r(ii,"Examples:"),ii.forEach(o),is=c(Z),g(ro.$$.fragment,Z),Z.forEach(o),cs=c($),L=s($,"DIV",{class:!0});var De=d(L);g(ao.$$.fragment,De),ls=c(De),xn=s(De,"P",{});var ci=d(xn);ps=r(ci,`Instantiate an encoder and a decoder from one or two base classes of the library from pretrained model
checkpoints.`),ci.forEach(o),ms=c(De),jn=s(De,"P",{});var li=d(jn);hs=r(li,"Example:"),li.forEach(o),fs=c(De),g(so.$$.fragment,De),De.forEach(o),$.forEach(o),rt=c(n),ce=s(n,"H2",{class:!0});var Tt=d(ce);we=s(Tt,"A",{id:!0,class:!0,href:!0});var pi=d(we);$n=s(pi,"SPAN",{});var mi=d($n);g(io.$$.fragment,mi),mi.forEach(o),pi.forEach(o),us=c(Tt),qn=s(Tt,"SPAN",{});var hi=d(qn);gs=r(hi,"FlaxEncoderDecoderModel"),hi.forEach(o),Tt.forEach(o),at=c(n),z=s(n,"DIV",{class:!0});var q=d(z);g(co.$$.fragment,q),_s=c(q),le=s(q,"P",{});var Zo=d(le);bs=r(Zo,`This class can be used to initialize a sequence-to-sequence model with any pretrained autoencoding model as the
encoder and any pretrained autoregressive model as the decoder. The encoder is loaded via
...
generative task, like summarization.`),Zo.forEach(o),ws=c(q),lo=s(q,"P",{});var wt=d(lo);Es=r(wt,`The effectiveness of initializing sequence-to-sequence models with pretrained checkpoints for sequence generation
...
Zhou, Wei Li, Peter J. Liu.`),wt.forEach(o),Ms=c(q),Cn=s(q,"P",{});var _i=d(Cn);xs=r(_i,`After such an Encoder Decoder model has been trained/fine-tuned, it can be saved/loaded just like any other models
(see the examples for more information).`),_i.forEach(o),js=c(q),mo=s(q,"P",{});var Et=d(mo);$s=r(Et,"This model inherits from "),No=s(Et,"A",{href:!0});var bi=d(No);qs=r(bi,"FlaxPreTrainedModel"),bi.forEach(o),Ps=r(Et,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Et.forEach(o),Fs=c(q),ho=s(q,"P",{});var Dt=d(ho);Cs=r(Dt,`This model is also a Flax Linen
`),fo=s(Dt,"A",{href:!0,rel:!0});var vi=d(fo);As=r(vi,"flax.nn.Module"),vi.forEach(o),Ss=r(Dt,` subclass. Use it as a
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),Dt.forEach(o),Ns=c(q),H=s(q,"P",{});var To=d(H);Io=s(To,"A",{href:!0});var yi=d(Io);Is=r(yi,"FlaxEncoderDecoderModel"),yi.forEach(o),Ls=r(To,` is a generic model class that will be instantiated as a transformer architecture with
the module (flax.nn.Module) of one of the base model classes of the library as encoder module and another one as
