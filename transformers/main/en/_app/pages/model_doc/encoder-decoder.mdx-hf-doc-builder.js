...
<span class="hljs-meta">&gt;&gt;&gt; </span>model.save_pretrained(<span class="hljs-string">&quot;./bert2gpt2&quot;</span>)
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-comment"># load fine-tuned model</span>
<span class="hljs-meta">&gt;&gt;&gt; </span>model = FlaxEncoderDecoderModel.from_pretrained(<span class="hljs-string">&quot;./bert2gpt2&quot;</span>)`}}),{c(){c=s("p"),v=t("Example:"),u=m(),y(p.$$.fragment)},l(a){c=d(a,"P",{});var f=i(c);v=r(f,"Example:"),f.forEach(o),u=h(a),k(p.$$.fragment,a)},m(a,f){b(a,c,f),e(c,v),b(a,u,f),T(p,a,f),_=!0},p:$o,i(a){_||(w(p.$$.fragment,a),_=!0)},o(a){E(p.$$.fragment,a),_=!1},d(a){a&&o(c),a&&o(u),$(p,a)}}}function _i(z){let c,v,u,p,_,a,f,A,$t,Hn,ie,xt,xo,Mt,Dt,Yn,ce,zt,Pe,qt,jt,Jn,le,Ft,Mo,Pt,At,Zn,B,Ct,Do,St,Nt,Ae,It,Lt,Kn,V,Ot,mn,Bt,Vt,hn,Wt,Rt,Qn,Ce,Xn,W,Gt,Se,Ut,Ht,Ne,Yt,Jt,et,J,pe,fn,Ie,Zt,un,Kt,ot,P,Le,Qt,me,zo,Xt,er,qo,or,nr,tr,Z,rr,jo,ar,sr,Fo,dr,ir,cr,he,lr,fe,Oe,pr,Be,mr,Po,hr,fr,ur,ue,Ve,gr,K,_r,gn,br,vr,_n,yr,kr,nt,Q,ge,bn,We,Tr,vn,wr,tt,x,Re,Er,X,$r,Ao,xr,Mr,Co,Dr,zr,qr,Ge,jr,Ue,Fr,Pr,Ar,yn,Cr,Sr,He,Nr,So,Ir,Lr,Or,Ye,Br,Je,Vr,Wr,Rr,R,No,Gr,Ur,kn,Hr,Yr,Tn,Jr,Zr,Kr,C,Ze,Qr,ee,Xr,Io,ea,oa,wn,na,ta,ra,_e,aa,be,sa,S,Ke,da,En,ia,ca,oe,la,$n,pa,ma,xn,ha,fa,ua,ve,rt,ne,ye,Mn,Qe,ga,Dn,_a,at,M,Xe,ba,te,va,Lo,ya,ka,Oo,Ta,wa,Ea,eo,$a,oo,xa,Ma,Da,zn,za,qa,no,ja,Bo,Fa,Pa,Aa,to,Ca,ro,Sa,Na,Ia,G,Vo,La,Oa,Wo,Ba,Va,Ro,Wa,Ra,Ga,N,ao,Ua,re,Ha,Go,Ya,Ja,qn,Za,Ka,Qa,ke,Xa,Te,es,U,so,os,jn,ns,ts,we,st,ae,Ee,Fn,io,rs,Pn,as,dt,D,co,ss,se,ds,Uo,is,cs,Ho,ls,ps,ms,lo,hs,po,fs,us,gs,An,_s,bs,mo,vs,Yo,ys,ks,Ts,ho,ws,fo,Es,$s,xs,H,Jo,Ms,Ds,Cn,zs,qs,Sn,js,Fs,Ps,I,uo,As,de,Cs,Zo,Ss,Ns,Nn,Is,Ls,Os,$e,Bs,xe,Vs,Y,go,Ws,In,Rs,Gs,Me,it;return a=new Un({}),Ce=new Fe({props:{code:`# a workaround to load from pytorch checkpoint
...
<span class="hljs-meta">&gt;&gt;&gt; </span>model.config = _model.config`}}),Ie=new Un({}),Le=new O({props:{name:"class transformers.EncoderDecoderConfig",anchor:"transformers.EncoderDecoderConfig",parameters:[{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.EncoderDecoderConfig.kwargs",description:`<strong>kwargs</strong> (<em>optional</em>) &#x2014;
...
<p>Behaves differently depending on whether a <code>config</code> is provided or automatically loaded.`,name:"kwargs"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/encoder_decoder/modeling_encoder_decoder.py#L280"}}),ve=new Eo({props:{anchor:"transformers.EncoderDecoderModel.from_encoder_decoder_pretrained.example",$$slots:{default:[li]},$$scope:{ctx:z}}}),Qe=new Un({}),Xe=new O({props:{name:"class transformers.TFEncoderDecoderModel",anchor:"transformers.TFEncoderDecoderModel",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.TFEncoderDecoderModel.config",description:`<strong>config</strong> (<a href="/docs/transformers/main/en/model_doc/encoder-decoder#transformers.EncoderDecoderConfig">EncoderDecoderConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
...
<p>Behaves differently depending on whether a <code>config</code> is provided or automatically loaded.`,name:"kwargs"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/encoder_decoder/modeling_tf_encoder_decoder.py#L332"}}),we=new Eo({props:{anchor:"transformers.TFEncoderDecoderModel.from_encoder_decoder_pretrained.example",$$slots:{default:[hi]},$$scope:{ctx:z}}}),io=new Un({}),co=new O({props:{name:"class transformers.FlaxEncoderDecoderModel",anchor:"transformers.FlaxEncoderDecoderModel",parameters:[{name:"config",val:": EncoderDecoderConfig"},{name:"input_shape",val:": typing.Optional[typing.Tuple] = None"},{name:"seed",val:": int = 0"},{name:"dtype",val:": dtype = <class 'jax._src.numpy.lax_numpy.float32'>"},{name:"_do_init",val:": bool = True"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.FlaxEncoderDecoderModel.config",description:`<strong>config</strong> (<a href="/docs/transformers/main/en/model_doc/encoder-decoder#transformers.EncoderDecoderConfig">EncoderDecoderConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
...
any other models (see the examples for more information).`),Zn=m(),B=s("p"),Ct=t("An application of this architecture could be to leverage two pretrained "),Do=s("a"),St=t("BertModel"),Nt=t(` as the encoder
and decoder for a summarization model as was shown in: `),Ae=s("a"),It=t("Text Summarization with Pretrained Encoders"),Lt=t(" by Yang Liu and Mirella Lapata."),Kn=m(),V=s("p"),Ot=t("The "),mn=s("code"),Bt=t("from_pretrained()"),Vt=t(` currently doesn\u2019t support initializing the model from a
...
documentation from `),Fo=s("a"),dr=t("PretrainedConfig"),ir=t(" for more information."),cr=m(),y(he.$$.fragment),lr=m(),fe=s("div"),y(Oe.$$.fragment),pr=m(),Be=s("p"),mr=t("Instantiate a "),Po=s("a"),hr=t("EncoderDecoderConfig"),fr=t(` (or a derived class) from a pre-trained encoder model configuration and
...
etc.)`),Or=m(),Ye=s("p"),Br=t("This model is also a PyTorch "),Je=s("a"),Vr=t("torch.nn.Module"),Wr=t(` subclass.
...
encoder and any pretrained autoregressive model as the decoder. The encoder is loaded via
`),Lo=s("a"),ya=t("from_pretrained()"),ka=t(" function and the decoder is loaded via "),Oo=s("a"),Ta=t("from_pretrained()"),wa=t(`
function. Cross-attention layers are automatically added to the decoder and should be fine-tuned on a downstream
...
(see the examples for more information).`),qa=m(),no=s("p"),ja=t("This model inherits from "),Bo=s("a"),Fa=t("TFPreTrainedModel"),Pa=t(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Aa=m(),to=s("p"),Ca=t("This model is also a "),ro=s("a"),Sa=t("tf.keras.Model"),Na=t(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Ia=m(),G=s("p"),Vo=s("a"),La=t("TFEncoderDecoderModel"),Oa=t(` is a generic model class that will be instantiated as a transformer architecture with one
of the base model classes of the library as encoder and another one as decoder when created with the
`),Wo=s("a"),Ba=t("from_pretrained()"),Va=t(" class method for the encoder and "),Ro=s("a"),Wa=t("from_pretrained()"),Ra=t(` class
...
encoder and :meth`),Sn=s("em"),js=t("~transformers.FlaxAutoModelForCausalLM.from_pretrained"),Fs=t(" class method for the decoder."),Ps=m(),I=s("div"),y(uo.$$.fragment),As=m(),de=s("p"),Cs=t("The "),Zo=s("a"),Ss=t("FlaxEncoderDecoderModel"),Ns=t(" forward method, overrides the "),Nn=s("code"),Is=t("__call__"),Ls=t(" special method."),Os=m(),y($e.$$.fragment),Bs=m(),y(xe.$$.fragment),Vs=m(),Y=s("div"),y(go.$$.fragment),Ws=m(),In=s("p"),Rs=t(`Instantiate an encoder and a decoder from one or two base classes of the library from pretrained model
checkpoints.`),Gs=m(),y(Me.$$.fragment),this.h()},l(n){const g=ai('[data-svelte="svelte-1phssyn"]',document.head);c=d(g,"META",{name:!0,content:!0}),g.forEach(o),v=h(n),u=d(n,"H1",{class:!0});var _o=i(u);p=d(_o,"A",{id:!0,class:!0,href:!0});var Ln=i(p);_=d(Ln,"SPAN",{});var On=i(_);k(a.$$.fragment,On),On.forEach(o),Ln.forEach(o),f=h(_o),A=d(_o,"SPAN",{});var Bn=i(A);$t=r(Bn,"Encoder Decoder Models"),Bn.forEach(o),_o.forEach(o),Hn=h(n),ie=d(n,"P",{});var bo=i(ie);xt=r(bo,"The "),xo=d(bo,"A",{href:!0});var Vn=i(xo);Mt=r(Vn,"EncoderDecoderModel"),Vn.forEach(o),Dt=r(bo,` can be used to initialize a sequence-to-sequence model with any
...
any other models (see the examples for more information).`),yo.forEach(o),Zn=h(n),B=d(n,"P",{});var Ko=i(B);Ct=r(Ko,"An application of this architecture could be to leverage two pretrained "),Do=d(Ko,"A",{href:!0});var Hs=i(Do);St=r(Hs,"BertModel"),Hs.forEach(o),Nt=r(Ko,` as the encoder
and decoder for a summarization model as was shown in: `),Ae=d(Ko,"A",{href:!0,rel:!0});var Ys=i(Ae);It=r(Ys,"Text Summarization with Pretrained Encoders"),Ys.forEach(o),Lt=r(Ko," by Yang Liu and Mirella Lapata."),Ko.forEach(o),Kn=h(n),V=d(n,"P",{});var Qo=i(V);Ot=r(Qo,"The "),mn=d(Qo,"CODE",{});var Js=i(mn);Bt=r(Js,"from_pretrained()"),Js.forEach(o),Vt=r(Qo,` currently doesn\u2019t support initializing the model from a
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),ut.forEach(o),Or=h(q),Ye=d(q,"P",{});var gt=i(Ye);Br=r(gt,"This model is also a PyTorch "),Je=d(gt,"A",{href:!0,rel:!0});var _d=i(Je);Vr=r(_d,"torch.nn.Module"),_d.forEach(o),Wr=r(gt,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
...
encoder and any pretrained autoregressive model as the decoder. The encoder is loaded via
`),Lo=d(an,"A",{href:!0});var zd=i(Lo);ya=r(zd,"from_pretrained()"),zd.forEach(o),ka=r(an," function and the decoder is loaded via "),Oo=d(an,"A",{href:!0});var qd=i(Oo);Ta=r(qd,"from_pretrained()"),qd.forEach(o),wa=r(an,`
function. Cross-attention layers are automatically added to the decoder and should be fine-tuned on a downstream
...
(see the examples for more information).`),Fd.forEach(o),qa=h(j),no=d(j,"P",{});var vt=i(no);ja=r(vt,"This model inherits from "),Bo=d(vt,"A",{href:!0});var Pd=i(Bo);Fa=r(Pd,"TFPreTrainedModel"),Pd.forEach(o),Pa=r(vt,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),yt.forEach(o),Ia=h(j),G=d(j,"P",{});var To=i(G);Vo=d(To,"A",{href:!0});var Cd=i(Vo);La=r(Cd,"TFEncoderDecoderModel"),Cd.forEach(o),Oa=r(To,` is a generic model class that will be instantiated as a transformer architecture with one
of the base model classes of the library as encoder and another one as decoder when created with the
...
method for the decoder.`),To.forEach(o),Ga=h(j),N=d(j,"DIV",{class:!0});var qe=i(N);k(ao.$$.fragment,qe),Ua=h(qe),re=d(qe,"P",{});var sn=i(re);Ha=r(sn,"The "),Go=d(sn,"A",{href:!0});var Id=i(Go);Ya=r(Id,"TFEncoderDecoderModel"),Id.forEach(o),Ja=r(sn," forward method, overrides the "),qn=d(sn,"CODE",{});var Ld=i(qn);Za=r(Ld,"__call__"),Ld.forEach(o),Ka=r(sn," special method."),sn.forEach(o),Qa=h(qe),k(ke.$$.fragment,qe),Xa=h(qe),k(Te.$$.fragment,qe),qe.forEach(o),es=h(j),U=d(j,"DIV",{class:!0});var dn=i(U);k(so.$$.fragment,dn),os=h(dn),jn=d(dn,"P",{});var Od=i(jn);ns=r(Od,`Instantiate an encoder and a decoder from one or two base classes of the library from pretrained model
checkpoints.`),Od.forEach(o),ts=h(dn),k(we.$$.fragment,dn),dn.forEach(o),j.forEach(o),st=h(n),ae=d(n,"H2",{class:!0});var kt=i(ae);Ee=d(kt,"A",{id:!0,class:!0,href:!0});var Bd=i(Ee);Fn=d(Bd,"SPAN",{});var Vd=i(Fn);k(io.$$.fragment,Vd),Vd.forEach(o),Bd.forEach(o),rs=h(kt),Pn=d(kt,"SPAN",{});var Wd=i(Pn);as=r(Wd,"FlaxEncoderDecoderModel"),Wd.forEach(o),kt.forEach(o),dt=h(n),D=d(n,"DIV",{class:!0});var F=i(D);k(co.$$.fragment,F),ss=h(F),se=d(F,"P",{});var cn=i(se);ds=r(cn,`This class can be used to initialize a sequence-to-sequence model with any pretrained autoencoding model as the
encoder and any pretrained autoregressive model as the decoder. The encoder is loaded via
