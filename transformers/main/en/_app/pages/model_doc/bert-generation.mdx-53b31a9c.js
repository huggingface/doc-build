...
the latter silently ignores them.`)},l(y){m=a(y,"P",{});var w=i(m);D=r(w,"Although the recipe for forward pass needs to be defined within this function, one should call the "),u=a(w,"CODE",{});var S=i(u);B=r(S,"Module"),S.forEach(n),x=r(w,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),w.forEach(n)},m(y,w){p(y,m,w),e(m,D),e(m,u),e(u,B),e(m,x)},d(y){y&&n(m)}}}function ba(He){let m,D,u,B,x,y,w,S,Dn,Kt,R,Y,kt,ie,Sn,Tt,Mn,Qt,M,An,Ve,Nn,Fn,de,Ln,On,Xt,Je,In,Yt,Ke,yt,Rn,Zt,Qe,Wn,en,Xe,le,Un,Ye,Hn,Vn,tn,ce,nn,Ze,he,Jn,et,Kn,Qn,on,pe,rn,tt,Xn,sn,Z,A,nt,Yn,Zn,ot,eo,to,wt,no,oo,ro,Et,so,an,N,ao,me,io,lo,ue,co,ho,dn,W,ee,Bt,fe,po,zt,mo,ln,$,ge,uo,_e,fo,$t,go,_o,bo,U,vo,rt,ko,To,st,yo,wo,Eo,Gt,Bo,zo,be,cn,H,te,qt,ve,$o,Pt,Go,hn,C,ke,qo,Te,Po,ye,jo,xo,Co,we,Do,at,So,Mo,Ao,it,Ee,pn,V,ne,jt,Be,No,xt,Fo,mn,f,ze,Lo,Ct,Oo,Io,$e,Ro,dt,Wo,Uo,Ho,Ge,Vo,qe,Jo,Ko,Qo,Pe,Xo,je,Yo,Zo,er,J,tr,lt,nr,or,xe,rr,sr,ar,E,ir,Dt,dr,lr,St,cr,hr,Mt,pr,mr,At,ur,fr,Nt,gr,_r,Ft,br,vr,kr,q,Ce,Tr,K,yr,ct,wr,Er,Lt,Br,zr,$r,oe,Gr,Ot,qr,Pr,De,un,Q,re,It,Se,jr,Rt,xr,fn,G,Me,Cr,Ae,Dr,Wt,Sr,Mr,Ar,Ne,Nr,ht,Fr,Lr,Or,Fe,Ir,Le,Rr,Wr,Ur,P,Oe,Hr,X,Vr,pt,Jr,Kr,Ut,Qr,Xr,Yr,se,Zr,Ht,es,ts,Ie,gn;return y=new vt({}),ie=new vt({}),ce=new Jt({props:{code:`# leverage checkpoints for Bert2Bert model...
...
`),Ve=s("a"),Nn=o("EncoderDecoderModel"),Fn=o(" as proposed in "),de=s("a"),Ln=o(`Leveraging Pre-trained Checkpoints for Sequence Generation
...
this superclass for more information regarding those methods.`),Ao=l(),it=s("div"),g(Ee.$$.fragment),pn=l(),V=s("h2"),ne=s("a"),jt=s("span"),g(Be.$$.fragment),No=l(),xt=s("span"),Fo=o("BertGenerationEncoder"),mn=l(),f=s("div"),g(ze.$$.fragment),Lo=l(),Ct=s("p"),Oo=o("The bare BertGeneration model transformer outputting raw hidden-states without any specific head on top."),Io=l(),$e=s("p"),Ro=o("This model inherits from "),dt=s("a"),Wo=o("PreTrainedModel"),Uo=o(`. Check the superclass documentation for the generic methods the
...
`),At=s("code"),ur=o("add_cross_attention"),fr=o(" set to "),Nt=s("code"),gr=o("True"),_r=o("; an "),Ft=s("code"),br=o("encoder_hidden_states"),vr=o(" is then expected as an input to the forward pass."),kr=l(),q=s("div"),g(Ce.$$.fragment),Tr=l(),K=s("p"),yr=o("The "),ct=s("a"),wr=o("BertGenerationEncoder"),Er=o(" forward method, overrides the "),Lt=s("code"),Br=o("__call__"),zr=o(" special method."),$r=l(),g(oe.$$.fragment),Gr=l(),Ot=s("p"),qr=o("Example:"),Pr=l(),g(De.$$.fragment),un=l(),Q=s("h2"),re=s("a"),It=s("span"),g(Se.$$.fragment),jr=l(),Rt=s("span"),xr=o("BertGenerationDecoder"),fn=l(),G=s("div"),g(Me.$$.fragment),Cr=l(),Ae=s("p"),Dr=o("BertGeneration Model with a "),Wt=s("code"),Sr=o("language modeling"),Mr=o(" head on top for CLM fine-tuning."),Ar=l(),Ne=s("p"),Nr=o("This model inherits from "),ht=s("a"),Fr=o("PreTrainedModel"),Lr=o(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Or=l(),Fe=s("p"),Ir=o("This model is also a PyTorch "),Le=s("a"),Rr=o("torch.nn.Module"),Wr=o(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
...
`),Ve=a(mt,"A",{href:!0});var is=i(Ve);Nn=r(is,"EncoderDecoderModel"),is.forEach(n),Fn=r(mt," as proposed in "),de=a(mt,"A",{href:!0,rel:!0});var ds=i(de);Ln=r(ds,`Leveraging Pre-trained Checkpoints for Sequence Generation
