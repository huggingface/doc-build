import{S as aP,i as rP,s as iP,e as n,k as l,w as g,t as r,M as lP,c as s,d as o,m as d,a,x as _,h as i,b as c,F as e,g as h,y as v,q as P,o as I,B as T}from"../../chunks/vendor-4833417e.js";import{T as ce}from"../../chunks/Tip-fffd6df1.js";import{D as w}from"../../chunks/Docstring-4f315ed9.js";import{C as N}from"../../chunks/CodeBlock-6a3d1b46.js";import{I as D}from"../../chunks/IconCopyLink-4b81c553.js";import"../../chunks/CopyButton-dacfbfaf.js";function dP(x){let p,L,u,b,y;return{c(){p=n("p"),L=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),u=n("code"),b=r("Module"),y=r(`
...
first positional argument :`),Zt=l(),H=n("ul"),me=n("li"),Me=r("a single Tensor with "),it=n("code"),Qt=r("input_ids"),Fe=r(" only and nothing else: "),ke=n("code"),Jo=r("model(input_ids)"),Yt=l(),A=n("li"),ge=r(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
...
the latter silently ignores them.`)},l(C){p=s(C,"P",{});var f=a(p);L=i(f,"Although the recipe for forward pass needs to be defined within this function, one should call the "),u=s(f,"CODE",{});var k=a(u);b=i(k,"Module"),k.forEach(o),y=i(f,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),f.forEach(o)},m(C,f){h(C,p,f),e(p,L),e(p,u),e(u,b),e(p,y)},d(C){C&&o(p)}}}function bP(x){let p,L,u,b,y,C,f,k,Ho,rt,j,ue,Ce,be,Ko,ye,Go,Xt,pe,je,Le,Zt,H,me,Me,it,Qt,Fe,ke,Jo,Yt,A,ge,we,$e,Xo,xe,Zo,eo,he,Qo,qe,_e,$,M,to,Qs,Yo,E,Ys,lt,ea,De,ve,ta,oa,Pe,na,sa,Ae,aa,xd,ra,Ed,zd,ia,jd,Md,nl,en,sl,Ne,Fd,tn,qd,Dd,on,Ad,Nd,al,dt,oo,pr,nn,Vd,mr,Od,rl,fe,sn,Sd,no,la,Wd,Bd,da,Ud,Rd,Hd,ct,Kd,ca,Gd,Jd,pa,Xd,Zd,Qd,so,an,Yd,rn,ec,ma,tc,oc,il,pt,ao,hr,ln,nc,fr,sc,ll,O,dn,ac,mt,rc,ha,ic,lc,cn,dc,cc,pc,ht,mc,fa,hc,fc,ua,uc,gc,_c,ur,vc,Pc,pn,dl,ft,ro,gr,mn,Ic,_r,Tc,cl,S,hn,Cc,ut,bc,ga,yc,Lc,fn,kc,wc,$c,gt,xc,_a,Ec,zc,va,jc,Mc,Fc,vr,qc,Dc,un,pl,_t,io,Pr,gn,Ac,Ir,Nc,ml,F,_n,Vc,Tr,Oc,Sc,vn,Wc,Pa,Bc,Uc,Rc,Ie,Pn,Hc,Cr,Kc,Gc,br,Ia,Jc,yr,Xc,Zc,Lr,Qc,Yc,lo,In,ep,Tn,tp,kr,op,np,sp,co,Cn,ap,wr,rp,ip,Ta,bn,hl,vt,po,$r,yn,lp,xr,dp,fl,W,Ln,cp,kn,pp,Er,mp,hp,fp,wn,up,Ca,gp,_p,vp,Te,$n,Pp,zr,Ip,Tp,jr,ba,Cp,Mr,bp,yp,Fr,Lp,kp,mo,xn,wp,qr,$p,ul,Pt,ho,Dr,En,xp,Ar,Ep,gl,B,zn,zp,Nr,jp,Mp,jn,Fp,ya,qp,Dp,Ap,fo,Mn,Np,Fn,Vp,Vr,Op,Sp,Wp,uo,qn,Bp,It,Up,Or,Rp,Hp,Sr,Kp,Gp,_l,Tt,go,Wr,Dn,Jp,Br,Xp,vl,U,An,Zp,Ur,Qp,Yp,K,La,em,tm,ka,om,nm,wa,sm,am,Rr,rm,im,$a,lm,dm,cm,_o,Nn,pm,Vn,mm,xa,hm,fm,um,vo,On,gm,Sn,_m,Ea,vm,Pm,Pl,Ct,Po,Hr,Wn,Im,Kr,Tm,Il,R,Bn,Cm,Un,bm,Rn,ym,Lm,km,G,Hn,wm,bt,$m,za,xm,Em,Gr,zm,jm,Mm,Io,Fm,Jr,qm,Dm,Kn,Am,J,Gn,Nm,yt,Vm,ja,Om,Sm,Xr,Wm,Bm,Um,To,Rm,Zr,Hm,Km,Jn,Gm,X,Xn,Jm,Lt,Xm,Ma,Zm,Qm,Qr,Ym,eh,th,Co,oh,Yr,nh,sh,Zn,Tl,kt,bo,ei,Qn,ah,ti,rh,Cl,wt,Yn,ih,Z,es,lh,$t,dh,Fa,ch,ph,oi,mh,hh,fh,yo,uh,ni,gh,_h,ts,bl,xt,Lo,si,os,vh,ai,Ph,yl,Et,ns,Ih,Q,ss,Th,zt,Ch,qa,bh,yh,ri,Lh,kh,wh,ko,$h,ii,xh,Eh,as,Ll,jt,wo,li,rs,zh,di,jh,kl,q,is,Mh,ls,Fh,Da,qh,Dh,Ah,ds,Nh,cs,Vh,Oh,Sh,$o,Wh,Y,ps,Bh,Mt,Uh,Aa,Rh,Hh,ci,Kh,Gh,Jh,xo,Xh,pi,Zh,Qh,ms,Yh,ee,hs,ef,Ft,tf,Na,of,nf,mi,sf,af,rf,Eo,lf,hi,df,cf,fs,pf,te,us,mf,qt,hf,Va,ff,uf,fi,gf,_f,vf,zo,Pf,ui,If,Tf,gs,wl,Dt,jo,gi,_s,Cf,_i,bf,$l,At,vs,yf,oe,Ps,Lf,Nt,kf,Oa,wf,$f,vi,xf,Ef,zf,Mo,jf,Pi,Mf,Ff,Is,xl,Vt,Fo,Ii,Ts,qf,Ti,Df,El,Ot,Cs,Af,ne,bs,Nf,St,Vf,Sa,Of,Sf,Ci,Wf,Bf,Uf,qo,Rf,bi,Hf,Kf,ys,zl,Wt,Do,yi,Ls,Gf,Li,Jf,jl,z,ks,Xf,ws,Zf,Wa,Qf,Yf,eu,$s,tu,xs,ou,nu,su,ki,au,ru,Ee,wi,Es,iu,lu,$i,zs,du,cu,xi,js,pu,mu,Ei,Ms,hu,fu,se,Fs,uu,Bt,gu,zi,_u,vu,ji,Pu,Iu,Tu,Ao,Cu,Mi,bu,yu,qs,Lu,Ve,Ds,ku,Fi,wu,$u,As,xu,Oe,Ns,Eu,qi,zu,ju,Vs,Ml,Ut,No,Di,Os,Mu,Ai,Fu,Fl,Rt,Ss,qu,ae,Ws,Du,Ht,Au,Ni,Nu,Vu,Vi,Ou,Su,Wu,Vo,Bu,Oi,Uu,Ru,Bs,ql,Kt,Oo,Si,Us,Hu,Wi,Ku,Dl,Gt,Rs,Gu,re,Hs,Ju,Jt,Xu,Bi,Zu,Qu,Ui,Yu,eg,tg,So,og,Ri,ng,sg,Ks,Al;return C=new D({}),be=new D({}),$e=new D({}),en=new N({props:{code:`from PIL import Image
import requests
...
for the task, similarly to the zero-shot capabilities of GPT-2 and 3.`),me=l(),Me=n("p"),it=r("The abstract from the paper is the following:"),Qt=l(),Fe=n("p"),ke=n("em"),Jo=r(`State-of-the-art computer vision systems are trained to predict a fixed set of predetermined object categories. This
...
configuration.`),il=l(),pt=n("h2"),ao=n("a"),hr=n("span"),g(ln.$$.fragment),nc=l(),fr=n("span"),sc=r("CLIPTextConfig"),ll=l(),O=n("div"),g(dn.$$.fragment),ac=l(),mt=n("p"),rc=r("This is the configuration class to store the configuration of a "),ha=n("a"),ic=r("CLIPModel"),lc=r(`. It is used to instantiate an CLIP
...
documentation from `),ua=n("a"),uc=r("PretrainedConfig"),gc=r(" for more information."),_c=l(),ur=n("p"),vc=r("Example:"),Pc=l(),g(pn.$$.fragment),dl=l(),ft=n("h2"),ro=n("a"),gr=n("span"),g(mn.$$.fragment),Ic=l(),_r=n("span"),Tc=r("CLIPVisionConfig"),cl=l(),S=n("div"),g(hn.$$.fragment),Cc=l(),ut=n("p"),bc=r("This is the configuration class to store the configuration of a "),ga=n("a"),yc=r("CLIPModel"),Lc=r(`. It is used to instantiate an CLIP
model according to the specified arguments, defining the model architecture. Instantiating a configuration with the
defaults will yield a similar configuration to that of the CLIP
...
zeros is returned.`),ip=l(),Ta=n("div"),g(bn.$$.fragment),hl=l(),vt=n("h2"),po=n("a"),$r=n("span"),g(yn.$$.fragment),lp=l(),xr=n("span"),dp=r("CLIPTokenizerFast"),fl=l(),W=n("div"),g(Ln.$$.fragment),cp=l(),kn=n("p"),pp=r("Construct a \u201Cfast\u201D CLIP tokenizer (backed by HuggingFace\u2019s "),Er=n("em"),mp=r("tokenizers"),hp=r(` library). Based on byte-level
...
adding special tokens. A CLIP sequence has the following format:`),Tp=l(),jr=n("ul"),ba=n("li"),Cp=r("single sequence: "),Mr=n("code"),bp=r("<|startoftext|> X <|endoftext|>"),yp=l(),Fr=n("p"),Lp=r("Pairs of sequences are not the expected use case, but they will be handled without a separator."),kp=l(),mo=n("div"),g(xn.$$.fragment),wp=l(),qr=n("p"),$p=r(`Create a mask from the two sequences passed. CLIP does not make use of token type ids, therefore a list of
zeros is returned.`),ul=l(),Pt=n("h2"),ho=n("a"),Dr=n("span"),g(En.$$.fragment),xp=l(),Ar=n("span"),Ep=r("CLIPFeatureExtractor"),gl=l(),B=n("div"),g(zn.$$.fragment),zp=l(),Nr=n("p"),jp=r("Constructs a CLIP feature extractor."),Mp=l(),jn=n("p"),Fp=r("This feature extractor inherits from "),ya=n("a"),qp=r("FeatureExtractionMixin"),Dp=r(` which contains most of the main methods. Users
...
size is given, it will be padded (so the returned result has the size asked).`),Wp=l(),uo=n("div"),g(qn.$$.fragment),Bp=l(),It=n("p"),Up=r("Resizes "),Or=n("code"),Rp=r("image"),Hp=r(". Note that this will trigger a conversion of "),Sr=n("code"),Kp=r("image"),Gp=r(" to a PIL Image."),_l=l(),Tt=n("h2"),go=n("a"),Wr=n("span"),g(Dn.$$.fragment),Jp=l(),Br=n("span"),Xp=r("CLIPProcessor"),vl=l(),U=n("div"),g(An.$$.fragment),Zp=l(),Ur=n("p"),Qp=r("Constructs a CLIP processor which wraps a CLIP feature extractor and a CLIP tokenizer into a single processor."),Yp=l(),K=n("p"),La=n("a"),em=r("CLIPProcessor"),tm=r(" offers all the functionalities of "),ka=n("a"),om=r("CLIPFeatureExtractor"),nm=r(" and "),wa=n("a"),sm=r("CLIPTokenizerFast"),am=r(`. See the
`),Rr=n("code"),rm=r("__call__()"),im=r("and "),$a=n("a"),lm=r("decode()"),dm=r(" for more information."),cm=l(),_o=n("div"),g(Nn.$$.fragment),pm=l(),Vn=n("p"),mm=r("This method forwards all its arguments to CLIPTokenizerFast\u2019s "),xa=n("a"),hm=r("batch_decode()"),fm=r(`. Please
refer to the docstring of this method for more information.`),um=l(),vo=n("div"),g(On.$$.fragment),gm=l(),Sn=n("p"),_m=r("This method forwards all its arguments to CLIPTokenizerFast\u2019s "),Ea=n("a"),vm=r("decode()"),Pm=r(`. Please refer to
the docstring of this method for more information.`),Pl=l(),Ct=n("h2"),Po=n("a"),Hr=n("span"),g(Wn.$$.fragment),Im=l(),Kr=n("span"),Tm=r("CLIPModel"),Il=l(),R=n("div"),g(Bn.$$.fragment),Cm=l(),Un=n("p"),bm=r("This model is a PyTorch "),Rn=n("a"),ym=r("torch.nn.Module"),Lm=r(` subclass. Use it
as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),km=l(),G=n("div"),g(Hn.$$.fragment),wm=l(),bt=n("p"),$m=r("The "),za=n("a"),xm=r("CLIPModel"),Em=r(" forward method, overrides the "),Gr=n("code"),zm=r("__call__"),jm=r(" special method."),Mm=l(),g(Io.$$.fragment),Fm=l(),Jr=n("p"),qm=r("Examples:"),Dm=l(),g(Kn.$$.fragment),Am=l(),J=n("div"),g(Gn.$$.fragment),Nm=l(),yt=n("p"),Vm=r("The "),ja=n("a"),Om=r("CLIPModel"),Sm=r(" forward method, overrides the "),Xr=n("code"),Wm=r("__call__"),Bm=r(" special method."),Um=l(),g(To.$$.fragment),Rm=l(),Zr=n("p"),Hm=r("Examples:"),Km=l(),g(Jn.$$.fragment),Gm=l(),X=n("div"),g(Xn.$$.fragment),Jm=l(),Lt=n("p"),Xm=r("The "),Ma=n("a"),Zm=r("CLIPModel"),Qm=r(" forward method, overrides the "),Qr=n("code"),Ym=r("__call__"),eh=r(" special method."),th=l(),g(Co.$$.fragment),oh=l(),Yr=n("p"),nh=r("Examples:"),sh=l(),g(Zn.$$.fragment),Tl=l(),kt=n("h2"),bo=n("a"),ei=n("span"),g(Qn.$$.fragment),ah=l(),ti=n("span"),rh=r("CLIPTextModel"),Cl=l(),wt=n("div"),g(Yn.$$.fragment),ih=l(),Z=n("div"),g(es.$$.fragment),lh=l(),$t=n("p"),dh=r("The "),Fa=n("a"),ch=r("CLIPTextModel"),ph=r(" forward method, overrides the "),oi=n("code"),mh=r("__call__"),hh=r(" special method."),fh=l(),g(yo.$$.fragment),uh=l(),ni=n("p"),gh=r("Examples:"),_h=l(),g(ts.$$.fragment),bl=l(),xt=n("h2"),Lo=n("a"),si=n("span"),g(os.$$.fragment),vh=l(),ai=n("span"),Ph=r("CLIPVisionModel"),yl=l(),Et=n("div"),g(ns.$$.fragment),Ih=l(),Q=n("div"),g(ss.$$.fragment),Th=l(),zt=n("p"),Ch=r("The "),qa=n("a"),bh=r("CLIPVisionModel"),yh=r(" forward method, overrides the "),ri=n("code"),Lh=r("__call__"),kh=r(" special method."),wh=l(),g(ko.$$.fragment),$h=l(),ii=n("p"),xh=r("Examples:"),Eh=l(),g(as.$$.fragment),Ll=l(),jt=n("h2"),wo=n("a"),li=n("span"),g(rs.$$.fragment),zh=l(),di=n("span"),jh=r("TFCLIPModel"),kl=l(),q=n("div"),g(is.$$.fragment),Mh=l(),ls=n("p"),Fh=r("This model inherits from "),Da=n("a"),qh=r("TFPreTrainedModel"),Dh=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Ah=l(),ds=n("p"),Nh=r("This model is also a "),cs=n("a"),Vh=r("tf.keras.Model"),Oh=r(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Sh=l(),g($o.$$.fragment),Wh=l(),Y=n("div"),g(ps.$$.fragment),Bh=l(),Mt=n("p"),Uh=r("The "),Aa=n("a"),Rh=r("TFCLIPModel"),Hh=r(" forward method, overrides the "),ci=n("code"),Kh=r("__call__"),Gh=r(" special method."),Jh=l(),g(xo.$$.fragment),Xh=l(),pi=n("p"),Zh=r("Examples:"),Qh=l(),g(ms.$$.fragment),Yh=l(),ee=n("div"),g(hs.$$.fragment),ef=l(),Ft=n("p"),tf=r("The "),Na=n("a"),of=r("TFCLIPModel"),nf=r(" forward method, overrides the "),mi=n("code"),sf=r("__call__"),af=r(" special method."),rf=l(),g(Eo.$$.fragment),lf=l(),hi=n("p"),df=r("Examples:"),cf=l(),g(fs.$$.fragment),pf=l(),te=n("div"),g(us.$$.fragment),mf=l(),qt=n("p"),hf=r("The "),Va=n("a"),ff=r("TFCLIPModel"),uf=r(" forward method, overrides the "),fi=n("code"),gf=r("__call__"),_f=r(" special method."),vf=l(),g(zo.$$.fragment),Pf=l(),ui=n("p"),If=r("Examples:"),Tf=l(),g(gs.$$.fragment),wl=l(),Dt=n("h2"),jo=n("a"),gi=n("span"),g(_s.$$.fragment),Cf=l(),_i=n("span"),bf=r("TFCLIPTextModel"),$l=l(),At=n("div"),g(vs.$$.fragment),yf=l(),oe=n("div"),g(Ps.$$.fragment),Lf=l(),Nt=n("p"),kf=r("The "),Oa=n("a"),wf=r("TFCLIPTextModel"),$f=r(" forward method, overrides the "),vi=n("code"),xf=r("__call__"),Ef=r(" special method."),zf=l(),g(Mo.$$.fragment),jf=l(),Pi=n("p"),Mf=r("Examples:"),Ff=l(),g(Is.$$.fragment),xl=l(),Vt=n("h2"),Fo=n("a"),Ii=n("span"),g(Ts.$$.fragment),qf=l(),Ti=n("span"),Df=r("TFCLIPVisionModel"),El=l(),Ot=n("div"),g(Cs.$$.fragment),Af=l(),ne=n("div"),g(bs.$$.fragment),Nf=l(),St=n("p"),Vf=r("The "),Sa=n("a"),Of=r("TFCLIPVisionModel"),Sf=r(" forward method, overrides the "),Ci=n("code"),Wf=r("__call__"),Bf=r(" special method."),Uf=l(),g(qo.$$.fragment),Rf=l(),bi=n("p"),Hf=r("Examples:"),Kf=l(),g(ys.$$.fragment),zl=l(),Wt=n("h2"),Do=n("a"),yi=n("span"),g(Ls.$$.fragment),Gf=l(),Li=n("span"),Jf=r("FlaxCLIPModel"),jl=l(),z=n("div"),g(ks.$$.fragment),Xf=l(),ws=n("p"),Zf=r("This model inherits from "),Wa=n("a"),Qf=r("FlaxPreTrainedModel"),Yf=r(`. Check the superclass documentation for the generic methods the
...
which are then linearly embedded. A [CLS] token is added to serve as representation of an entire image. The authors
also add absolute position embeddings, and feed the resulting sequence of vectors to a standard Transformer encoder.
The `),M=s(Nl,"A",{href:!0});var pg=a(M);to=i(pg,"CLIPFeatureExtractor"),pg.forEach(o),Qs=i(Nl," can be used to resize (or rescale) and normalize images for the model."),Nl.forEach(o),Yo=d(t),E=s(t,"P",{});var ie=a(E);Ys=i(ie,"The "),lt=s(ie,"A",{href:!0});var mg=a(lt);ea=i(mg,"CLIPTokenizer"),mg.forEach(o),De=i(ie," is used to encode the text. The "),ve=s(ie,"A",{href:!0});var hg=a(ve);ta=i(hg,"CLIPProcessor"),hg.forEach(o),oa=i(ie,` wraps
...
documentation from `),va=s(Ga,"A",{href:!0});var Wg=a(va);jc=i(Wg,"PretrainedConfig"),Wg.forEach(o),Mc=i(Ga," for more information."),Ga.forEach(o),Fc=d(We),vr=s(We,"P",{});var Bg=a(vr);qc=i(Bg,"Example:"),Bg.forEach(o),Dc=d(We),_(un.$$.fragment,We),We.forEach(o),pl=d(t),_t=s(t,"H2",{class:!0});var Ul=a(_t);io=s(Ul,"A",{id:!0,class:!0,href:!0});var Ug=a(io);Pr=s(Ug,"SPAN",{});var Rg=a(Pr);_(gn.$$.fragment,Rg),Rg.forEach(o),Ug.forEach(o),Ac=d(Ul),Ir=s(Ul,"SPAN",{});var Hg=a(Ir);Nc=i(Hg,"CLIPTokenizer"),Hg.forEach(o),Ul.forEach(o),ml=d(t),F=s(t,"DIV",{class:!0});var le=a(F);_(_n.$$.fragment,le),Vc=d(le),Tr=s(le,"P",{});var Kg=a(Tr);Oc=i(Kg,"Construct a CLIP tokenizer. Based on byte-level Byte-Pair-Encoding."),Kg.forEach(o),Sc=d(le),vn=s(le,"P",{});var Rl=a(vn);Wc=i(Rl,"This tokenizer inherits from "),Pa=s(Rl,"A",{href:!0});var Gg=a(Pa);Bc=i(Gg,"PreTrainedTokenizer"),Gg.forEach(o),Uc=i(Rl,` which contains most of the main methods. Users should refer to
...
adding special tokens. A CLIP sequence has the following format:`),i_.forEach(o),Tp=d(Uo),jr=s(Uo,"UL",{});var l_=a(jr);ba=s(l_,"LI",{});var rg=a(ba);Cp=i(rg,"single sequence: "),Mr=s(rg,"CODE",{});var d_=a(Mr);bp=i(d_,"<|startoftext|> X <|endoftext|>"),d_.forEach(o),rg.forEach(o),l_.forEach(o),yp=d(Uo),Fr=s(Uo,"P",{});var c_=a(Fr);Lp=i(c_,"Pairs of sequences are not the expected use case, but they will be handled without a separator."),c_.forEach(o),Uo.forEach(o),kp=d(Be),mo=s(Be,"DIV",{class:!0});var Ql=a(mo);_(xn.$$.fragment,Ql),wp=d(Ql),qr=s(Ql,"P",{});var p_=a(qr);$p=i(p_,`Create a mask from the two sequences passed. CLIP does not make use of token type ids, therefore a list of
