...
`),qe=n("code"),_e=r('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l($){p=s($,"P",{});var j=a(p);L=i(j,"TF 2.0 models accepts two formats as inputs:"),j.forEach(o),I=d($),y=s($,"UL",{});var to=a(y);b=s(to,"LI",{});var Qs=a(b);C=i(Qs,"having all inputs as keyword arguments (like PyTorch models), or"),Qs.forEach(o),f=d(to),w=s(to,"LI",{});var Yo=a(w);Ho=i(Yo,"having all inputs as a list, tuple or dict in the first positional arguments."),Yo.forEach(o),to.forEach(o),rt=d($),z=s($,"P",{});var E=a(z);ue=i(E,"This second option is useful when using "),Ce=s(E,"CODE",{});var Ys=a(Ce);ye=i(Ys,"tf.keras.Model.fit"),Ys.forEach(o),Ko=i(E,` method which currently requires having all the
...
`),qe=s(Oe,"CODE",{});var aa=a(qe);_e=i(aa,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),aa.forEach(o),Oe.forEach(o),De.forEach(o)},m($,j){h($,p,j),e(p,L),h($,I,j),h($,y,j),e(y,b),e(b,C),e(y,f),e(y,w),e(w,Ho),h($,rt,j),h($,z,j),e(z,ue),e(z,Ce),e(Ce,ye),e(z,Ko),e(z,be),e(be,Go),e(z,Xt),h($,pe,j),h($,ze,j),e(ze,Le),h($,Zt,j),h($,H,j),e(H,me),e(me,je),e(me,it),e(it,Qt),e(me,Fe),e(me,we),e(we,Jo),e(H,Yt),e(H,O),e(O,ge),e(O,ke),e(ke,$e),e(O,Xo),e(O,xe),e(xe,Zo),e(H,eo),e(H,he),e(he,Qo),e(he,qe),e(qe,_e)},d($){$&&o(p),$&&o(I),$&&o(y),$&&o(rt),$&&o(z),$&&o(pe),$&&o(ze),$&&o(Zt),$&&o(H)}}}function gP(x){let p,L,I,y,b;return{c(){p=n("p"),L=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),I=n("code"),y=r("Module"),b=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(C){p=s(C,"P",{});var f=a(p);L=i(f,"Although the recipe for forward pass needs to be defined within this function, one should call the "),I=s(f,"CODE",{});var w=a(I);y=i(w,"Module"),w.forEach(o),b=i(f,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
the latter silently ignores them.`)},l(C){p=s(C,"P",{});var f=a(p);L=i(f,"Although the recipe for forward pass needs to be defined within this function, one should call the "),I=s(f,"CODE",{});var w=a(I);y=i(w,"Module"),w.forEach(o),b=i(f,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),f.forEach(o)},m(C,f){h(C,p,f),e(p,L),e(p,I),e(I,y),e(p,b)},d(C){C&&o(p)}}}function bP(x){let p,L,I,y,b,C,f,w,Ho,rt,z,ue,Ce,ye,Ko,be,Go,Xt,pe,ze,Le,Zt,H,me,je,it,Qt,Fe,we,Jo,Yt,O,ge,ke,$e,Xo,xe,Zo,eo,he,Qo,qe,_e,$,j,to,Qs,Yo,E,Ys,lt,ea,De,ve,ta,oa,Pe,na,sa,Oe,aa,xd,ra,Ed,Md,ia,zd,jd,nl,en,sl,Ae,Fd,tn,qd,Dd,on,Od,Ad,al,dt,oo,pr,nn,Nd,mr,Vd,rl,fe,sn,Sd,no,la,Wd,Bd,da,Ud,Rd,Hd,ct,Kd,ca,Gd,Jd,pa,Xd,Zd,Qd,so,an,Yd,rn,ec,ma,tc,oc,il,pt,ao,hr,ln,nc,fr,sc,ll,V,dn,ac,mt,rc,ha,ic,lc,cn,dc,cc,pc,ht,mc,fa,hc,fc,ua,uc,gc,_c,ur,vc,Pc,pn,dl,ft,ro,gr,mn,Tc,_r,Ic,cl,S,hn,Cc,ut,yc,ga,bc,Lc,fn,wc,kc,$c,gt,xc,_a,Ec,Mc,va,zc,jc,Fc,vr,qc,Dc,un,pl,_t,io,Pr,gn,Oc,Tr,Ac,ml,F,_n,Nc,Ir,Vc,Sc,vn,Wc,Pa,Bc,Uc,Rc,Te,Pn,Hc,Cr,Kc,Gc,yr,Ta,Jc,br,Xc,Zc,Lr,Qc,Yc,lo,Tn,ep,In,tp,wr,op,np,sp,co,Cn,ap,kr,rp,ip,Ia,yn,hl,vt,po,$r,bn,lp,xr,dp,fl,W,Ln,cp,wn,pp,Er,mp,hp,fp,kn,up,Ca,gp,_p,vp,Ie,$n,Pp,Mr,Tp,Ip,zr,ya,Cp,jr,yp,bp,Fr,Lp,wp,mo,xn,kp,qr,$p,ul,Pt,ho,Dr,En,xp,Or,Ep,gl,B,Mn,Mp,Ar,zp,jp,zn,Fp,ba,qp,Dp,Op,fo,jn,Ap,Fn,Np,Nr,Vp,Sp,Wp,uo,qn,Bp,Tt,Up,Vr,Rp,Hp,Sr,Kp,Gp,_l,It,go,Wr,Dn,Jp,Br,Xp,vl,U,On,Zp,Ur,Qp,Yp,K,La,em,tm,wa,om,nm,ka,sm,am,Rr,rm,im,$a,lm,dm,cm,_o,An,pm,Nn,mm,xa,hm,fm,um,vo,Vn,gm,Sn,_m,Ea,vm,Pm,Pl,Ct,Po,Hr,Wn,Tm,Kr,Im,Tl,R,Bn,Cm,Un,ym,Rn,bm,Lm,wm,G,Hn,km,yt,$m,Ma,xm,Em,Gr,Mm,zm,jm,To,Fm,Jr,qm,Dm,Kn,Om,J,Gn,Am,bt,Nm,za,Vm,Sm,Xr,Wm,Bm,Um,Io,Rm,Zr,Hm,Km,Jn,Gm,X,Xn,Jm,Lt,Xm,ja,Zm,Qm,Qr,Ym,eh,th,Co,oh,Yr,nh,sh,Zn,Il,wt,yo,ei,Qn,ah,ti,rh,Cl,kt,Yn,ih,Z,es,lh,$t,dh,Fa,ch,ph,oi,mh,hh,fh,bo,uh,ni,gh,_h,ts,yl,xt,Lo,si,os,vh,ai,Ph,bl,Et,ns,Th,Q,ss,Ih,Mt,Ch,qa,yh,bh,ri,Lh,wh,kh,wo,$h,ii,xh,Eh,as,Ll,zt,ko,li,rs,Mh,di,zh,wl,q,is,jh,ls,Fh,Da,qh,Dh,Oh,ds,Ah,cs,Nh,Vh,Sh,$o,Wh,Y,ps,Bh,jt,Uh,Oa,Rh,Hh,ci,Kh,Gh,Jh,xo,Xh,pi,Zh,Qh,ms,Yh,ee,hs,ef,Ft,tf,Aa,of,nf,mi,sf,af,rf,Eo,lf,hi,df,cf,fs,pf,te,us,mf,qt,hf,Na,ff,uf,fi,gf,_f,vf,Mo,Pf,ui,Tf,If,gs,kl,Dt,zo,gi,_s,Cf,_i,yf,$l,Ot,vs,bf,oe,Ps,Lf,At,wf,Va,kf,$f,vi,xf,Ef,Mf,jo,zf,Pi,jf,Ff,Ts,xl,Nt,Fo,Ti,Is,qf,Ii,Df,El,Vt,Cs,Of,ne,ys,Af,St,Nf,Sa,Vf,Sf,Ci,Wf,Bf,Uf,qo,Rf,yi,Hf,Kf,bs,Ml,Wt,Do,bi,Ls,Gf,Li,Jf,zl,M,ws,Xf,ks,Zf,Wa,Qf,Yf,eu,$s,tu,xs,ou,nu,su,wi,au,ru,Ee,ki,Es,iu,lu,$i,Ms,du,cu,xi,zs,pu,mu,Ei,js,hu,fu,se,Fs,uu,Bt,gu,Mi,_u,vu,zi,Pu,Tu,Iu,Oo,Cu,ji,yu,bu,qs,Lu,Ne,Ds,wu,Fi,ku,$u,Os,xu,Ve,As,Eu,qi,Mu,zu,Ns,jl,Ut,Ao,Di,Vs,ju,Oi,Fu,Fl,Rt,Ss,qu,ae,Ws,Du,Ht,Ou,Ai,Au,Nu,Ni,Vu,Su,Wu,No,Bu,Vi,Uu,Ru,Bs,ql,Kt,Vo,Si,Us,Hu,Wi,Ku,Dl,Gt,Rs,Gu,re,Hs,Ju,Jt,Xu,Bi,Zu,Qu,Ui,Yu,eg,tg,So,og,Ri,ng,sg,Ks,Ol;return C=new D({}),ye=new D({}),$e=new D({}),en=new A({props:{code:`from PIL import Image
import requests
...
special tokens using the tokenizer `),wr=n("code"),op=r("prepare_for_model"),np=r(" method."),sp=l(),co=n("div"),u(Cn.$$.fragment),ap=l(),kr=n("p"),rp=r(`Create a mask from the two sequences passed. CLIP does not make use of token type ids, therefore a list of
zeros is returned.`),ip=l(),Ia=n("div"),u(yn.$$.fragment),hl=l(),vt=n("h2"),po=n("a"),$r=n("span"),u(bn.$$.fragment),lp=l(),xr=n("span"),dp=r("CLIPTokenizerFast"),fl=l(),W=n("div"),u(Ln.$$.fragment),cp=l(),wn=n("p"),pp=r("Construct a \u201Cfast\u201D CLIP tokenizer (backed by HuggingFace\u2019s "),Er=n("em"),mp=r("tokenizers"),hp=r(` library). Based on byte-level
Byte-Pair-Encoding.`),fp=l(),kn=n("p"),up=r("This tokenizer inherits from "),Ca=n("a"),gp=r("PreTrainedTokenizerFast"),_p=r(` which contains most of the main methods. Users should
...
adding special tokens. A CLIP sequence has the following format:`),Ip=l(),zr=n("ul"),ya=n("li"),Cp=r("single sequence: "),jr=n("code"),yp=r("<|startoftext|> X <|endoftext|>"),bp=l(),Fr=n("p"),Lp=r("Pairs of sequences are not the expected use case, but they will be handled without a separator."),wp=l(),mo=n("div"),u(xn.$$.fragment),kp=l(),qr=n("p"),$p=r(`Create a mask from the two sequences passed. CLIP does not make use of token type ids, therefore a list of
...
behavior.`),wm=l(),G=n("div"),u(Hn.$$.fragment),km=l(),yt=n("p"),$m=r("The "),Ma=n("a"),xm=r("CLIPModel"),Em=r(" forward method, overrides the "),Gr=n("code"),Mm=r("__call__"),zm=r(" special method."),jm=l(),u(To.$$.fragment),Fm=l(),Jr=n("p"),qm=r("Examples:"),Dm=l(),u(Kn.$$.fragment),Om=l(),J=n("div"),u(Gn.$$.fragment),Am=l(),bt=n("p"),Nm=r("The "),za=n("a"),Vm=r("CLIPModel"),Sm=r(" forward method, overrides the "),Xr=n("code"),Wm=r("__call__"),Bm=r(" special method."),Um=l(),u(Io.$$.fragment),Rm=l(),Zr=n("p"),Hm=r("Examples:"),Km=l(),u(Jn.$$.fragment),Gm=l(),X=n("div"),u(Xn.$$.fragment),Jm=l(),Lt=n("p"),Xm=r("The "),ja=n("a"),Zm=r("CLIPModel"),Qm=r(" forward method, overrides the "),Qr=n("code"),Ym=r("__call__"),eh=r(" special method."),th=l(),u(Co.$$.fragment),oh=l(),Yr=n("p"),nh=r("Examples:"),sh=l(),u(Zn.$$.fragment),Il=l(),wt=n("h2"),yo=n("a"),ei=n("span"),u(Qn.$$.fragment),ah=l(),ti=n("span"),rh=r("CLIPTextModel"),Cl=l(),kt=n("div"),u(Yn.$$.fragment),ih=l(),Z=n("div"),u(es.$$.fragment),lh=l(),$t=n("p"),dh=r("The "),Fa=n("a"),ch=r("CLIPTextModel"),ph=r(" forward method, overrides the "),oi=n("code"),mh=r("__call__"),hh=r(" special method."),fh=l(),u(bo.$$.fragment),uh=l(),ni=n("p"),gh=r("Examples:"),_h=l(),u(ts.$$.fragment),yl=l(),xt=n("h2"),Lo=n("a"),si=n("span"),u(os.$$.fragment),vh=l(),ai=n("span"),Ph=r("CLIPVisionModel"),bl=l(),Et=n("div"),u(ns.$$.fragment),Th=l(),Q=n("div"),u(ss.$$.fragment),Ih=l(),Mt=n("p"),Ch=r("The "),qa=n("a"),yh=r("CLIPVisionModel"),bh=r(" forward method, overrides the "),ri=n("code"),Lh=r("__call__"),wh=r(" special method."),kh=l(),u(wo.$$.fragment),$h=l(),ii=n("p"),xh=r("Examples:"),Eh=l(),u(as.$$.fragment),Ll=l(),zt=n("h2"),ko=n("a"),li=n("span"),u(rs.$$.fragment),Mh=l(),di=n("span"),zh=r("TFCLIPModel"),wl=l(),q=n("div"),u(is.$$.fragment),jh=l(),ls=n("p"),Fh=r("This model inherits from "),Da=n("a"),qh=r("TFPreTrainedModel"),Dh=r(`. Check the superclass documentation for the generic methods the
