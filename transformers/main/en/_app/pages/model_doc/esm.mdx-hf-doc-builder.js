...
`),Pt=a("a"),Er=l("facebook/esm-1b"),Mr=l(" architecture."),Fr=h(),Te=a("p"),zr=l("Configuration objects inherit from "),Jo=a("a"),qr=l("PretrainedConfig"),xr=l(` and can be used to control the model outputs. Read the
...
according to the specified arguments, defining the model architecture. Instantiating a configuration with the
defaults will yield a similar configuration to that of the ESM
`),Pt=r(bn,"A",{href:!0,rel:!0});var Oc=i(Pt);Er=d(Oc,"facebook/esm-1b"),Oc.forEach(o),Mr=d(bn," architecture."),bn.forEach(o),Fr=f($t),Te=r($t,"P",{});var Tn=i(Te);zr=d(Tn,"Configuration objects inherit from "),Jo=r(Tn,"A",{href:!0});var Ic=i(Jo);qr=d(Ic,"PretrainedConfig"),Ic.forEach(o),xr=d(Tn,` and can be used to control the model outputs. Read the
