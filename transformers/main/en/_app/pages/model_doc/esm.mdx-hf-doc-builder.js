...
special tokens using the tokenizer `),Un=a("code"),Ur=l("prepare_for_model"),Wr=l(" or "),Wn=a("code"),Hr=l("encode_plus"),Kr=l(" methods."),Br=h(),se=a("div"),T(Ot.$$.fragment),Vr=h(),Xo=a("p"),Zr=l("Create the token type IDs corresponding to the sequences passed. "),en=a("a"),Gr=l(`What are token type
IDs?`),Jr=h(),Hn=a("p"),Yr=l("Should be overridden in a subclass if the model has a special way of building those."),Qr=h(),tn=a("div"),T(It.$$.fragment),la=h(),$e=a("h2"),Ke=a("a"),Kn=a("span"),T(Rt.$$.fragment),Xr=h(),Bn=a("span"),ei=l("EsmModel"),da=h(),q=a("div"),T(Ut.$$.fragment),ti=h(),Vn=a("p"),oi=l("The bare ESM Model transformer outputting raw hidden-states without any specific head on top."),ni=h(),Wt=a("p"),si=l("This model inherits from "),on=a("a"),ai=l("PreTrainedModel"),ri=l(`. Check the superclass documentation for the generic methods the
...
`),Yn=a("code"),$i=l("add_cross_attention"),wi=l(" set to "),Qn=a("code"),Ei=l("True"),Mi=l("; an "),Xn=a("code"),Fi=l("encoder_hidden_states"),zi=l(" is then expected as an input to the forward pass."),qi=h(),X=a("div"),T(Zt.$$.fragment),xi=h(),we=a("p"),Ci=l("The "),nn=a("a"),ji=l("EsmModel"),Si=l(" forward method, overrides the "),es=a("code"),Pi=l("__call__"),Li=l(" special method."),Ni=h(),T(Be.$$.fragment),Di=h(),T(Ve.$$.fragment),ca=h(),Ee=a("h2"),Ze=a("a"),ts=a("span"),T(Gt.$$.fragment),Ai=h(),os=a("span"),Oi=l("EsmForMaskedLM"),ma=h(),N=a("div"),T(Jt.$$.fragment),Ii=h(),Yt=a("p"),Ri=l("ESM Model with a "),ns=a("code"),Ui=l("language modeling"),Wi=l(" head on top."),Hi=h(),Qt=a("p"),Ki=l("This model inherits from "),sn=a("a"),Bi=l("PreTrainedModel"),Vi=l(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
regular Keras model and refer to the TF/Keras documentation for all matters related to general usage and behavior.`),Ld=h(),K=a("div"),T(Fo.$$.fragment),Nd=h(),Pe=a("p"),Dd=l("The "),fn=a("a"),Ad=l("TFEsmForMaskedLM"),Od=l(" forward method, overrides the "),Ts=a("code"),Id=l("__call__"),Rd=l(" special method."),Ud=h(),T(pt.$$.fragment),Wd=h(),T(ht.$$.fragment),Hd=h(),T(ft.$$.fragment),Ta=h(),Le=a("h2"),ut=a("a"),ys=a("span"),T(zo.$$.fragment),Kd=h(),vs=a("span"),Bd=l("TFEsmForSequenceClassification"),ya=h(),R=a("div"),T(qo.$$.fragment),Vd=h(),$s=a("p"),Zd=l(`ESM Model transformer with a sequence classification/regression head on top (a linear layer on top of the pooled
...
\u201CLanguage models of protein sequences at the scale of evolution enable accurate structure prediction\u201D is`),Os.forEach(o),ea=f(t),Vo=r(t,"P",{});var Is=i(Vo);Pn=r(Is,"EM",{});var Rs=i(Pn);dr=d(Rs,`Large language models have recently been shown to develop emergent capabilities with scale, going beyond
simple pattern matching to perform higher level reasoning and generate lifelike images and text. While
language models trained on protein sequences have been studied at a smaller scale, little is known about
what they learn about biology as they are scaled up. In this work we train models up to 15 billion parameters,
the largest language models of proteins to be evaluated to date. We find that as models are scaled they learn
...
regular Keras model and refer to the TF/Keras documentation for all matters related to general usage and behavior.`),Va.forEach(o),Ld=f(me),K=r(me,"DIV",{class:!0});var pe=i(K);y(Fo.$$.fragment,pe),Nd=f(pe),Pe=r(pe,"P",{});var zn=i(Pe);Dd=d(zn,"The "),fn=r(zn,"A",{href:!0});var Ym=i(fn);Ad=d(Ym,"TFEsmForMaskedLM"),Ym.forEach(o),Od=d(zn," forward method, overrides the "),Ts=r(zn,"CODE",{});var Qm=i(Ts);Id=d(Qm,"__call__"),Qm.forEach(o),Rd=d(zn," special method."),zn.forEach(o),Ud=f(pe),y(pt.$$.fragment,pe),Wd=f(pe),y(ht.$$.fragment,pe),Hd=f(pe),y(ft.$$.fragment,pe),pe.forEach(o),me.forEach(o),Ta=f(t),Le=r(t,"H2",{class:!0});var Za=i(Le);ut=r(Za,"A",{id:!0,class:!0,href:!0});var Xm=i(ut);ys=r(Xm,"SPAN",{});var ep=i(ys);y(zo.$$.fragment,ep),ep.forEach(o),Xm.forEach(o),Kd=f(Za),vs=r(Za,"SPAN",{});var tp=i(vs);Bd=d(tp,"TFEsmForSequenceClassification"),tp.forEach(o),Za.forEach(o),ya=f(t),R=r(t,"DIV",{class:!0});var he=i(R);y(qo.$$.fragment,he),Vd=f(he),$s=r(he,"P",{});var op=i($s);Zd=d(op,`ESM Model transformer with a sequence classification/regression head on top (a linear layer on top of the pooled
