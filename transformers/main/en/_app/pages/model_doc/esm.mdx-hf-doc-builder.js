...
the latter silently ignores them.`)},l(l){d=s(l,"P",{});var g=a(d);_=i(g,"Although the recipe for forward pass needs to be defined within this function, one should call the "),c=s(g,"CODE",{});var F=a(c);h=i(F,"Module"),F.forEach(o),k=i(g,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
<span class="hljs-meta">&gt;&gt;&gt; </span>loss = model(**inputs, labels=labels).loss
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-built_in">round</span>(loss.item(), <span class="hljs-number">2</span>)
`}}),{c(){v(d.$$.fragment)},l(c){$(d.$$.fragment,c)},m(c,h){w(d,c,h),_=!0},p:Q,i(c){_||(E(d.$$.fragment,c),_=!0)},o(c){y(d.$$.fragment,c),_=!1},d(c){T(d,c)}}}function gl(M){let d,_,c,h,k,l,g,F,On,Xo,ee,fe,ao,We,Wn,ro,Rn,en,ue,Hn,Re,Vn,Un,tn,Ct,Bn,on,jt,io,Zn,nn,St,Jn,sn,Pt,lo,Gn,an,Lt,Kn,rn,At,co,Yn,ln,R,Qn,He,Xn,es,Ve,ts,os,Ue,ns,ss,dn,te,ge,mo,Be,as,po,rs,cn,W,Ze,is,oe,ls,ho,ds,cs,Je,ms,ps,hs,ne,fs,It,us,gs,Nt,_s,bs,ks,_e,mn,se,be,fo,Ge,vs,uo,$s,pn,x,Ke,ws,go,Es,ys,Dt,Ye,Ts,ke,Qe,Ms,ae,qs,_o,zs,Fs,bo,xs,Cs,js,U,Xe,Ss,Ot,Ps,Wt,Ls,As,ko,Is,Ns,Rt,et,hn,re,ve,vo,tt,Ds,$o,Os,fn,q,ot,Ws,wo,Rs,Hs,nt,Vs,Ht,Us,Bs,Zs,st,Js,at,Gs,Ks,Ys,rt,Qs,it,Xs,ea,ta,C,oa,Eo,na,sa,yo,aa,ra,To,ia,la,Mo,da,ca,qo,ma,pa,zo,ha,fa,ua,H,lt,ga,ie,_a,Vt,ba,ka,Fo,va,$a,wa,$e,Ea,we,un,le,Ee,xo,dt,ya,Co,Ta,gn,j,ct,Ma,mt,qa,jo,za,Fa,xa,pt,Ca,Ut,ja,Sa,Pa,ht,La,ft,Aa,Ia,Na,L,ut,Da,de,Oa,Bt,Wa,Ra,So,Ha,Va,Ua,ye,Ba,Te,Za,Me,_n,ce,qe,Po,gt,Ja,Lo,Ga,bn,S,_t,Ka,Ao,Ya,Qa,bt,Xa,Zt,er,tr,or,kt,nr,vt,sr,ar,rr,z,$t,ir,me,lr,Jt,dr,cr,Io,mr,pr,hr,ze,fr,Fe,ur,xe,gr,Ce,_r,je,kn,pe,Se,No,wt,br,Do,kr,vn,P,Et,vr,Oo,$r,wr,yt,Er,Gt,yr,Tr,Mr,Tt,qr,Mt,zr,Fr,xr,A,qt,Cr,he,jr,Kt,Sr,Pr,Wo,Lr,Ar,Ir,Pe,Nr,Le,Dr,Ae,$n;return l=new Oe({}),We=new Oe({}),Be=new Oe({}),Ze=new O({props:{name:"class transformers.EsmConfig",anchor:"transformers.EsmConfig",parameters:[{name:"vocab_size",val:" = None"},{name:"mask_token_id",val:" = None"},{name:"pad_token_id",val:" = None"},{name:"hidden_size",val:" = 768"},{name:"num_hidden_layers",val:" = 12"},{name:"num_attention_heads",val:" = 12"},{name:"intermediate_size",val:" = 3072"},{name:"hidden_act",val:" = 'gelu'"},{name:"hidden_dropout_prob",val:" = 0.1"},{name:"attention_probs_dropout_prob",val:" = 0.1"},{name:"max_position_embeddings",val:" = 1026"},{name:"initializer_range",val:" = 0.02"},{name:"layer_norm_eps",val:" = 1e-12"},{name:"position_embedding_type",val:" = 'absolute'"},{name:"use_cache",val:" = True"},{name:"classifier_dropout",val:" = None"},{name:"emb_layer_norm_before",val:" = None"},{name:"token_dropout",val:" = False"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.EsmConfig.vocab_size",description:`<strong>vocab_size</strong> (<code>int</code>, <em>optional</em>) &#x2014;
...
`}}),ze=new Dn({props:{$$slots:{default:[ll]},$$scope:{ctx:M}}}),Fe=new Y({props:{anchor:"transformers.EsmForSequenceClassification.forward.example",$$slots:{default:[dl]},$$scope:{ctx:M}}}),xe=new Y({props:{anchor:"transformers.EsmForSequenceClassification.forward.example-2",$$slots:{default:[cl]},$$scope:{ctx:M}}}),Ce=new Y({props:{anchor:"transformers.EsmForSequenceClassification.forward.example-3",$$slots:{default:[ml]},$$scope:{ctx:M}}}),je=new Y({props:{anchor:"transformers.EsmForSequenceClassification.forward.example-4",$$slots:{default:[pl]},$$scope:{ctx:M}}}),wt=new Oe({}),Et=new O({props:{name:"class transformers.EsmForTokenClassification",anchor:"transformers.EsmForTokenClassification",parameters:[{name:"config",val:""}],parametersDescription:[{anchor:"transformers.EsmForTokenClassification.config",description:`<strong>config</strong> (<a href="/docs/transformers/main/en/model_doc/esm#transformers.EsmConfig">EsmConfig</a>) &#x2014; Model configuration class with all the parameters of the
model. Initializing with a config file does not load the weights associated with the model, only the
...
It was released with the paper `),Re=n("a"),Vn=r(`Language models of protein sequences at the scale of evolution enable accurate
structure prediction`),Un=r(` by Zeming Lin, Halil Akin, Roshan Rao, Brian Hie,
Zhongkai Zhu, Wenting Lu, Allan dos Santos Costa, Maryam Fazel-Zarandi, Tom Sercu, Sal Candido and Alexander Rives.`),tn=m(),Ct=n("p"),Bn=r(`The abstract from
...
This model was contributed to huggingface by `),Ve=n("a"),ts=r("jasonliu"),os=r(`
and `),Ue=n("a"),ns=r("Matt"),ss=r("."),dn=m(),te=n("h2"),ge=n("a"),mo=n("span"),v(Be.$$.fragment),as=m(),po=n("span"),rs=r("EsmConfig"),cn=m(),W=n("div"),v(Ze.$$.fragment),is=m(),oe=n("p"),ls=r("This is the configuration class to store the configuration of a "),ho=n("code"),ds=r("ESMModel"),cs=r(`. It is used to instantiate a ESM model
...
documentation from `),Nt=n("a"),_s=r("PretrainedConfig"),bs=r(" for more information."),ks=m(),v(_e.$$.fragment),mn=m(),se=n("h2"),be=n("a"),fo=n("span"),v(Ge.$$.fragment),vs=m(),uo=n("span"),$s=r("EsmTokenizer"),pn=m(),x=n("div"),v(Ke.$$.fragment),ws=m(),go=n("p"),Es=r("Constructs an ESM tokenizer."),ys=m(),Dt=n("div"),v(Ye.$$.fragment),Ts=m(),ke=n("div"),v(Qe.$$.fragment),Ms=m(),ae=n("p"),qs=r(`Retrieves sequence ids from a token list that has no special tokens added. This method is called when adding
special tokens using the tokenizer `),_o=n("code"),zs=r("prepare_for_model"),Fs=r(" or "),bo=n("code"),xs=r("encode_plus"),Cs=r(" methods."),js=m(),U=n("div"),v(Xe.$$.fragment),Ss=m(),Ot=n("p"),Ps=r("Create the token type IDs corresponding to the sequences passed. "),Wt=n("a"),Ls=r(`What are token type
IDs?`),As=m(),ko=n("p"),Is=r("Should be overridden in a subclass if the model has a special way of building those."),Ns=m(),Rt=n("div"),v(et.$$.fragment),hn=m(),re=n("h2"),ve=n("a"),vo=n("span"),v(tt.$$.fragment),Ds=m(),$o=n("span"),Os=r("EsmModel"),fn=m(),q=n("div"),v(ot.$$.fragment),Ws=m(),wo=n("p"),Rs=r("The bare ESM Model transformer outputting raw hidden-states without any specific head on top."),Hs=m(),nt=n("p"),Vs=r("This model inherits from "),Ht=n("a"),Us=r("PreTrainedModel"),Bs=r(`. Check the superclass documentation for the generic methods the
...
Llion Jones, Aidan N. Gomez, Lukasz Kaiser and Illia Polosukhin.`),ta=m(),C=n("p"),oa=r("To behave as an decoder the model needs to be initialized with the "),Eo=n("code"),na=r("is_decoder"),sa=r(` argument of the configuration set
...
`),Mo=n("code"),da=r("add_cross_attention"),ca=r(" set to "),qo=n("code"),ma=r("True"),pa=r("; an "),zo=n("code"),ha=r("encoder_hidden_states"),fa=r(" is then expected as an input to the forward pass."),ua=m(),H=n("div"),v(lt.$$.fragment),ga=m(),ie=n("p"),_a=r("The "),Vt=n("a"),ba=r("EsmModel"),ka=r(" forward method, overrides the "),Fo=n("code"),va=r("__call__"),$a=r(" special method."),wa=m(),v($e.$$.fragment),Ea=m(),v(we.$$.fragment),un=m(),le=n("h2"),Ee=n("a"),xo=n("span"),v(dt.$$.fragment),ya=m(),Co=n("span"),Ta=r("EsmForMaskedLM"),gn=m(),j=n("div"),v(ct.$$.fragment),Ma=m(),mt=n("p"),qa=r("ESM Model with a "),jo=n("code"),za=r("language modeling"),Fa=r(" head on top."),xa=m(),pt=n("p"),Ca=r("This model inherits from "),Ut=n("a"),ja=r("PreTrainedModel"),Sa=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Pa=m(),ht=n("p"),La=r("This model is also a PyTorch "),ft=n("a"),Aa=r("torch.nn.Module"),Ia=r(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Na=m(),L=n("div"),v(ut.$$.fragment),Da=m(),de=n("p"),Oa=r("The "),Bt=n("a"),Wa=r("EsmForMaskedLM"),Ra=r(" forward method, overrides the "),So=n("code"),Ha=r("__call__"),Va=r(" special method."),Ua=m(),v(ye.$$.fragment),Ba=m(),v(Te.$$.fragment),Za=m(),v(Me.$$.fragment),_n=m(),ce=n("h2"),qe=n("a"),Po=n("span"),v(gt.$$.fragment),Ja=m(),Lo=n("span"),Ga=r("EsmForSequenceClassification"),bn=m(),S=n("div"),v(_t.$$.fragment),Ka=m(),Ao=n("p"),Ya=r(`ESM Model transformer with a sequence classification/regression head on top (a linear layer on top of the pooled
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),rr=m(),z=n("div"),v($t.$$.fragment),ir=m(),me=n("p"),lr=r("The "),Jt=n("a"),dr=r("EsmForSequenceClassification"),cr=r(" forward method, overrides the "),Io=n("code"),mr=r("__call__"),pr=r(" special method."),hr=m(),v(ze.$$.fragment),fr=m(),v(Fe.$$.fragment),ur=m(),v(xe.$$.fragment),gr=m(),v(Ce.$$.fragment),_r=m(),v(je.$$.fragment),kn=m(),pe=n("h2"),Se=n("a"),No=n("span"),v(wt.$$.fragment),br=m(),Do=n("span"),kr=r("EsmForTokenClassification"),vn=m(),P=n("div"),v(Et.$$.fragment),vr=m(),Oo=n("p"),$r=r(`ESM Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g. for
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Mr=m(),Tt=n("p"),qr=r("This model is also a PyTorch "),Mt=n("a"),zr=r("torch.nn.Module"),Fr=r(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),xr=m(),A=n("div"),v(qt.$$.fragment),Cr=m(),he=n("p"),jr=r("The "),Kt=n("a"),Sr=r("EsmForTokenClassification"),Pr=r(" forward method, overrides the "),Wo=n("code"),Lr=r("__call__"),Ar=r(" special method."),Ir=m(),v(Pe.$$.fragment),Nr=m(),v(Le.$$.fragment),Dr=m(),v(Ae.$$.fragment),this.h()},l(t){const u=el('[data-svelte="svelte-1phssyn"]',document.head);d=s(u,"META",{name:!0,content:!0}),u.forEach(o),_=p(t),c=s(t,"H1",{class:!0});var zt=a(c);h=s(zt,"A",{id:!0,class:!0,href:!0});var Ro=a(h);k=s(Ro,"SPAN",{});var Ho=a(k);$(l.$$.fragment,Ho),Ho.forEach(o),Ro.forEach(o),g=p(zt),F=s(zt,"SPAN",{});var Vo=a(F);On=i(Vo,"ESM"),Vo.forEach(o),zt.forEach(o),Xo=p(t),ee=s(t,"H2",{class:!0});var Ft=a(ee);fe=s(Ft,"A",{id:!0,class:!0,href:!0});var Uo=a(fe);ao=s(Uo,"SPAN",{});var Bo=a(ao);$(We.$$.fragment,Bo),Bo.forEach(o),Uo.forEach(o),Wn=p(Ft),ro=s(Ft,"SPAN",{});var Zo=a(ro);Rn=i(Zo,"Overview"),Zo.forEach(o),Ft.forEach(o),en=i(t,`
...
C. Lawrence Zitnick, Jerry Ma, and Rob Fergus.
The first version of this paper was [preprinted in 2019](https://www.biorxiv.org/content/10.1101/622803v1?versioned=true).
`),ue=s(t,"P",{});var xt=a(ue);Hn=i(xt,`ESM-2 outperforms all tested single-sequence protein language models across a range of structure prediction tasks,
and enables atomic resolution structure prediction.
It was released with the paper `),Re=s(xt,"A",{href:!0,rel:!0});var Jo=a(Re);Vn=i(Jo,`Language models of protein sequences at the scale of evolution enable accurate
structure prediction`),Jo.forEach(o),Un=i(xt,` by Zeming Lin, Halil Akin, Roshan Rao, Brian Hie,
Zhongkai Zhu, Wenting Lu, Allan dos Santos Costa, Maryam Fazel-Zarandi, Tom Sercu, Sal Candido and Alexander Rives.`),xt.forEach(o),tn=p(t),Ct=s(t,"P",{});var Go=a(Ct);Bn=i(Go,`The abstract from
\u201CBiological structure and function emerge from scaling unsupervised learning to 250
...
sequences with low perplexity that are well understood by the language model. ESMFold inference is an
order of magnitude faster than AlphaFold2, enabling exploration of the structural space of metagenomic
proteins in practical timescales.`),Rr.forEach(o),Wr.forEach(o),an=p(t),Lt=s(t,"P",{});var Hr=a(Lt);Kn=i(Hr,"Tips:"),Hr.forEach(o),rn=p(t),At=s(t,"UL",{});var Vr=a(At);co=s(Vr,"LI",{});var Ur=a(co);Yn=i(Ur,"ESM models are trained with a masked language modeling (MLM) objective."),Ur.forEach(o),Vr.forEach(o),ln=p(t),R=s(t,"P",{});var Ie=a(R);Qn=i(Ie,"The original code can be found "),He=s(Ie,"A",{href:!0,rel:!0});var Br=a(He);Xn=i(Br,"here"),Br.forEach(o),es=i(Ie,` and was
was developed by the Fundamental AI Research team at Meta AI.
This model was contributed to huggingface by `),Ve=s(Ie,"A",{href:!0,rel:!0});var Zr=a(Ve);ts=i(Zr,"jasonliu"),Zr.forEach(o),os=i(Ie,`
and `),Ue=s(Ie,"A",{href:!0,rel:!0});var Jr=a(Ue);ns=i(Jr,"Matt"),Jr.forEach(o),ss=i(Ie,"."),Ie.forEach(o),dn=p(t),te=s(t,"H2",{class:!0});var wn=a(te);ge=s(wn,"A",{id:!0,class:!0,href:!0});var Gr=a(ge);mo=s(Gr,"SPAN",{});var Kr=a(mo);$(Be.$$.fragment,Kr),Kr.forEach(o),Gr.forEach(o),as=p(wn),po=s(wn,"SPAN",{});var Yr=a(po);rs=i(Yr,"EsmConfig"),Yr.forEach(o),wn.forEach(o),cn=p(t),W=s(t,"DIV",{class:!0});var Ne=a(W);$(Ze.$$.fragment,Ne),is=p(Ne),oe=s(Ne,"P",{});var Yt=a(oe);ls=i(Yt,"This is the configuration class to store the configuration of a "),ho=s(Yt,"CODE",{});var Qr=a(ho);ds=i(Qr,"ESMModel"),Qr.forEach(o),cs=i(Yt,`. It is used to instantiate a ESM model
according to the specified arguments, defining the model architecture. Instantiating a configuration with the
defaults will yield a similar configuration to that of the ESM
...
documentation from `),Nt=s(Qt,"A",{href:!0});var ti=a(Nt);_s=i(ti,"PretrainedConfig"),ti.forEach(o),bs=i(Qt," for more information."),Qt.forEach(o),ks=p(Ne),$(_e.$$.fragment,Ne),Ne.forEach(o),mn=p(t),se=s(t,"H2",{class:!0});var En=a(se);be=s(En,"A",{id:!0,class:!0,href:!0});var oi=a(be);fo=s(oi,"SPAN",{});var ni=a(fo);$(Ge.$$.fragment,ni),ni.forEach(o),oi.forEach(o),vs=p(En),uo=s(En,"SPAN",{});var si=a(uo);$s=i(si,"EsmTokenizer"),si.forEach(o),En.forEach(o),pn=p(t),x=s(t,"DIV",{class:!0});var V=a(x);$(Ke.$$.fragment,V),ws=p(V),go=s(V,"P",{});var ai=a(go);Es=i(ai,"Constructs an ESM tokenizer."),ai.forEach(o),ys=p(V),Dt=s(V,"DIV",{class:!0});var ri=a(Dt);$(Ye.$$.fragment,ri),ri.forEach(o),Ts=p(V),ke=s(V,"DIV",{class:!0});var yn=a(ke);$(Qe.$$.fragment,yn),Ms=p(yn),ae=s(yn,"P",{});var Xt=a(ae);qs=i(Xt,`Retrieves sequence ids from a token list that has no special tokens added. This method is called when adding
special tokens using the tokenizer `),_o=s(Xt,"CODE",{});var ii=a(_o);zs=i(ii,"prepare_for_model"),ii.forEach(o),Fs=i(Xt," or "),bo=s(Xt,"CODE",{});var li=a(bo);xs=i(li,"encode_plus"),li.forEach(o),Cs=i(Xt," methods."),Xt.forEach(o),yn.forEach(o),js=p(V),U=s(V,"DIV",{class:!0});var eo=a(U);$(Xe.$$.fragment,eo),Ss=p(eo),Ot=s(eo,"P",{});var Or=a(Ot);Ps=i(Or,"Create the token type IDs corresponding to the sequences passed. "),Wt=s(Or,"A",{href:!0});var di=a(Wt);Ls=i(di,`What are token type
IDs?`),di.forEach(o),Or.forEach(o),As=p(eo),ko=s(eo,"P",{});var ci=a(ko);Is=i(ci,"Should be overridden in a subclass if the model has a special way of building those."),ci.forEach(o),eo.forEach(o),Ns=p(V),Rt=s(V,"DIV",{class:!0});var mi=a(Rt);$(et.$$.fragment,mi),mi.forEach(o),V.forEach(o),hn=p(t),re=s(t,"H2",{class:!0});var Tn=a(re);ve=s(Tn,"A",{id:!0,class:!0,href:!0});var pi=a(ve);vo=s(pi,"SPAN",{});var hi=a(vo);$(tt.$$.fragment,hi),hi.forEach(o),pi.forEach(o),Ds=p(Tn),$o=s(Tn,"SPAN",{});var fi=a($o);Os=i(fi,"EsmModel"),fi.forEach(o),Tn.forEach(o),fn=p(t),q=s(t,"DIV",{class:!0});var I=a(q);$(ot.$$.fragment,I),Ws=p(I),wo=s(I,"P",{});var ui=a(wo);Rs=i(ui,"The bare ESM Model transformer outputting raw hidden-states without any specific head on top."),ui.forEach(o),Hs=p(I),nt=s(I,"P",{});var Mn=a(nt);Vs=i(Mn,"This model inherits from "),Ht=s(Mn,"A",{href:!0});var gi=a(Ht);Us=i(gi,"PreTrainedModel"),gi.forEach(o),Bs=i(Mn,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
Llion Jones, Aidan N. Gomez, Lukasz Kaiser and Illia Polosukhin.`),zn.forEach(o),ta=p(I),C=s(I,"P",{});var N=a(C);oa=i(N,"To behave as an decoder the model needs to be initialized with the "),Eo=s(N,"CODE",{});var ki=a(Eo);na=i(ki,"is_decoder"),ki.forEach(o),sa=i(N,` argument of the configuration set
...
`),Mo=s(N,"CODE",{});var wi=a(Mo);da=i(wi,"add_cross_attention"),wi.forEach(o),ca=i(N," set to "),qo=s(N,"CODE",{});var Ei=a(qo);ma=i(Ei,"True"),Ei.forEach(o),pa=i(N,"; an "),zo=s(N,"CODE",{});var yi=a(zo);ha=i(yi,"encoder_hidden_states"),yi.forEach(o),fa=i(N," is then expected as an input to the forward pass."),N.forEach(o),ua=p(I),H=s(I,"DIV",{class:!0});var De=a(H);$(lt.$$.fragment,De),ga=p(De),ie=s(De,"P",{});var to=a(ie);_a=i(to,"The "),Vt=s(to,"A",{href:!0});var Ti=a(Vt);ba=i(Ti,"EsmModel"),Ti.forEach(o),ka=i(to," forward method, overrides the "),Fo=s(to,"CODE",{});var Mi=a(Fo);va=i(Mi,"__call__"),Mi.forEach(o),$a=i(to," special method."),to.forEach(o),wa=p(De),$($e.$$.fragment,De),Ea=p(De),$(we.$$.fragment,De),De.forEach(o),I.forEach(o),un=p(t),le=s(t,"H2",{class:!0});var Fn=a(le);Ee=s(Fn,"A",{id:!0,class:!0,href:!0});var qi=a(Ee);xo=s(qi,"SPAN",{});var zi=a(xo);$(dt.$$.fragment,zi),zi.forEach(o),qi.forEach(o),ya=p(Fn),Co=s(Fn,"SPAN",{});var Fi=a(Co);Ta=i(Fi,"EsmForMaskedLM"),Fi.forEach(o),Fn.forEach(o),gn=p(t),j=s(t,"DIV",{class:!0});var B=a(j);$(ct.$$.fragment,B),Ma=p(B),mt=s(B,"P",{});var xn=a(mt);qa=i(xn,"ESM Model with a "),jo=s(xn,"CODE",{});var xi=a(jo);za=i(xi,"language modeling"),xi.forEach(o),Fa=i(xn," head on top."),xn.forEach(o),xa=p(B),pt=s(B,"P",{});var Cn=a(pt);Ca=i(Cn,"This model inherits from "),Ut=s(Cn,"A",{href:!0});var Ci=a(Ut);ja=i(Ci,"PreTrainedModel"),Ci.forEach(o),Sa=i(Cn,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Cn.forEach(o),Pa=p(B),ht=s(B,"P",{});var jn=a(ht);La=i(jn,"This model is also a PyTorch "),ft=s(jn,"A",{href:!0,rel:!0});var ji=a(ft);Aa=i(ji,"torch.nn.Module"),ji.forEach(o),Ia=i(jn,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),jn.forEach(o),Na=p(B),L=s(B,"DIV",{class:!0});var Z=a(L);$(ut.$$.fragment,Z),Da=p(Z),de=s(Z,"P",{});var oo=a(de);Oa=i(oo,"The "),Bt=s(oo,"A",{href:!0});var Si=a(Bt);Wa=i(Si,"EsmForMaskedLM"),Si.forEach(o),Ra=i(oo," forward method, overrides the "),So=s(oo,"CODE",{});var Pi=a(So);Ha=i(Pi,"__call__"),Pi.forEach(o),Va=i(oo," special method."),oo.forEach(o),Ua=p(Z),$(ye.$$.fragment,Z),Ba=p(Z),$(Te.$$.fragment,Z),Za=p(Z),$(Me.$$.fragment,Z),Z.forEach(o),B.forEach(o),_n=p(t),ce=s(t,"H2",{class:!0});var Sn=a(ce);qe=s(Sn,"A",{id:!0,class:!0,href:!0});var Li=a(qe);Po=s(Li,"SPAN",{});var Ai=a(Po);$(gt.$$.fragment,Ai),Ai.forEach(o),Li.forEach(o),Ja=p(Sn),Lo=s(Sn,"SPAN",{});var Ii=a(Lo);Ga=i(Ii,"EsmForSequenceClassification"),Ii.forEach(o),Sn.forEach(o),bn=p(t),S=s(t,"DIV",{class:!0});var J=a(S);$(_t.$$.fragment,J),Ka=p(J),Ao=s(J,"P",{});var Ni=a(Ao);Ya=i(Ni,`ESM Model transformer with a sequence classification/regression head on top (a linear layer on top of the pooled
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Ln.forEach(o),rr=p(J),z=s(J,"DIV",{class:!0});var D=a(z);$($t.$$.fragment,D),ir=p(D),me=s(D,"P",{});var no=a(me);lr=i(no,"The "),Jt=s(no,"A",{href:!0});var Wi=a(Jt);dr=i(Wi,"EsmForSequenceClassification"),Wi.forEach(o),cr=i(no," forward method, overrides the "),Io=s(no,"CODE",{});var Ri=a(Io);mr=i(Ri,"__call__"),Ri.forEach(o),pr=i(no," special method."),no.forEach(o),hr=p(D),$(ze.$$.fragment,D),fr=p(D),$(Fe.$$.fragment,D),ur=p(D),$(xe.$$.fragment,D),gr=p(D),$(Ce.$$.fragment,D),_r=p(D),$(je.$$.fragment,D),D.forEach(o),J.forEach(o),kn=p(t),pe=s(t,"H2",{class:!0});var An=a(pe);Se=s(An,"A",{id:!0,class:!0,href:!0});var Hi=a(Se);No=s(Hi,"SPAN",{});var Vi=a(No);$(wt.$$.fragment,Vi),Vi.forEach(o),Hi.forEach(o),br=p(An),Do=s(An,"SPAN",{});var Ui=a(Do);kr=i(Ui,"EsmForTokenClassification"),Ui.forEach(o),An.forEach(o),vn=p(t),P=s(t,"DIV",{class:!0});var G=a(P);$(Et.$$.fragment,G),vr=p(G),Oo=s(G,"P",{});var Bi=a(Oo);$r=i(Bi,`ESM Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g. for
Named-Entity-Recognition (NER) tasks.`),Bi.forEach(o),wr=p(G),yt=s(G,"P",{});var In=a(yt);Er=i(In,"This model inherits from "),Gt=s(In,"A",{href:!0});var Zi=a(Gt);yr=i(Zi,"PreTrainedModel"),Zi.forEach(o),Tr=i(In,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),In.forEach(o),Mr=p(G),Tt=s(G,"P",{});var Nn=a(Tt);qr=i(Nn,"This model is also a PyTorch "),Mt=s(Nn,"A",{href:!0,rel:!0});var Ji=a(Mt);zr=i(Ji,"torch.nn.Module"),Ji.forEach(o),Fr=i(Nn,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Nn.forEach(o),xr=p(G),A=s(G,"DIV",{class:!0});var K=a(A);$(qt.$$.fragment,K),Cr=p(K),he=s(K,"P",{});var so=a(he);jr=i(so,"The "),Kt=s(so,"A",{href:!0});var Gi=a(Kt);Sr=i(Gi,"EsmForTokenClassification"),Gi.forEach(o),Pr=i(so," forward method, overrides the "),Wo=s(so,"CODE",{});var Ki=a(Wo);Lr=i(Ki,"__call__"),Ki.forEach(o),Ar=i(so," special method."),so.forEach(o),Ir=p(K),$(Pe.$$.fragment,K),Nr=p(K),$(Le.$$.fragment,K),Dr=p(K),$(Ae.$$.fragment,K),K.forEach(o),G.forEach(o),this.h()},h(){f(d,"name","hf:doc:metadata"),f(d,"content",JSON.stringify(_l)),f(h,"id","esm"),f(h,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),f(h,"href","#esm"),f(c,"class","relative group"),f(fe,"id","overview"),f(fe,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),f(fe,"href","#overview"),f(ee,"class","relative group"),f(Re,"href","https://doi.org/10.1101/2022.07.20.500902"),f(Re,"rel","nofollow"),f(He,"href","https://github.com/facebookresearch/esm"),f(He,"rel","nofollow"),f(Ve,"href","https://huggingface.co/jasonliu"),f(Ve,"rel","nofollow"),f(Ue,"href","https://huggingface.co/Rocketknight1"),f(Ue,"rel","nofollow"),f(ge,"id","transformers.EsmConfig"),f(ge,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),f(ge,"href","#transformers.EsmConfig"),f(te,"class","relative group"),f(Je,"href","https://huggingface.co/esm-base-uncased"),f(Je,"rel","nofollow"),f(It,"href","/docs/transformers/main/en/main_classes/configuration#transformers.PretrainedConfig"),f(Nt,"href","/docs/transformers/main/en/main_classes/configuration#transformers.PretrainedConfig"),f(W,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),f(be,"id","transformers.EsmTokenizer"),f(be,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),f(be,"href","#transformers.EsmTokenizer"),f(se,"class","relative group"),f(Dt,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),f(ke,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),f(Wt,"href","../glossary#token-type-ids"),f(U,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),f(Rt,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),f(x,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),f(ve,"id","transformers.EsmModel"),f(ve,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),f(ve,"href","#transformers.EsmModel"),f(re,"class","relative group"),f(Ht,"href","/docs/transformers/main/en/main_classes/model#transformers.PreTrainedModel"),f(at,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),f(at,"rel","nofollow"),f(it,"href","https://arxiv.org/abs/1706.03762"),f(it,"rel","nofollow"),f(Vt,"href","/docs/transformers/main/en/model_doc/esm#transformers.EsmModel"),f(H,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),f(q,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),f(Ee,"id","transformers.EsmForMaskedLM"),f(Ee,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),f(Ee,"href","#transformers.EsmForMaskedLM"),f(le,"class","relative group"),f(Ut,"href","/docs/transformers/main/en/main_classes/model#transformers.PreTrainedModel"),f(ft,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),f(ft,"rel","nofollow"),f(Bt,"href","/docs/transformers/main/en/model_doc/esm#transformers.EsmForMaskedLM"),f(L,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),f(j,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),f(qe,"id","transformers.EsmForSequenceClassification"),f(qe,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),f(qe,"href","#transformers.EsmForSequenceClassification"),f(ce,"class","relative group"),f(Zt,"href","/docs/transformers/main/en/main_classes/model#transformers.PreTrainedModel"),f(vt,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),f(vt,"rel","nofollow"),f(Jt,"href","/docs/transformers/main/en/model_doc/esm#transformers.EsmForSequenceClassification"),f(z,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),f(S,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),f(Se,"id","transformers.EsmForTokenClassification"),f(Se,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),f(Se,"href","#transformers.EsmForTokenClassification"),f(pe,"class","relative group"),f(Gt,"href","/docs/transformers/main/en/main_classes/model#transformers.PreTrainedModel"),f(Mt,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),f(Mt,"rel","nofollow"),f(Kt,"href","/docs/transformers/main/en/model_doc/esm#transformers.EsmForTokenClassification"),f(A,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),f(P,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8")},m(t,u){e(document.head,d),b(t,_,u),b(t,c,u),e(c,h),e(h,k),w(l,k,null),e(c,g),e(c,F),e(F,On),b(t,Xo,u),b(t,ee,u),e(ee,fe),e(fe,ao),w(We,ao,null),e(ee,Wn),e(ee,ro),e(ro,Rn),b(t,en,u),b(t,ue,u),e(ue,Hn),e(ue,Re),e(Re,Vn),e(ue,Un),b(t,tn,u),b(t,Ct,u),e(Ct,Bn),b(t,on,u),b(t,jt,u),e(jt,io),e(io,Zn),b(t,nn,u),b(t,St,u),e(St,Jn),b(t,sn,u),b(t,Pt,u),e(Pt,lo),e(lo,Gn),b(t,an,u),b(t,Lt,u),e(Lt,Kn),b(t,rn,u),b(t,At,u),e(At,co),e(co,Yn),b(t,ln,u),b(t,R,u),e(R,Qn),e(R,He),e(He,Xn),e(R,es),e(R,Ve),e(Ve,ts),e(R,os),e(R,Ue),e(Ue,ns),e(R,ss),b(t,dn,u),b(t,te,u),e(te,ge),e(ge,mo),w(Be,mo,null),e(te,as),e(te,po),e(po,rs),b(t,cn,u),b(t,W,u),w(Ze,W,null),e(W,is),e(W,oe),e(oe,ls),e(oe,ho),e(ho,ds),e(oe,cs),e(oe,Je),e(Je,ms),e(oe,ps),e(W,hs),e(W,ne),e(ne,fs),e(ne,It),e(It,us),e(ne,gs),e(ne,Nt),e(Nt,_s),e(ne,bs),e(W,ks),w(_e,W,null),b(t,mn,u),b(t,se,u),e(se,be),e(be,fo),w(Ge,fo,null),e(se,vs),e(se,uo),e(uo,$s),b(t,pn,u),b(t,x,u),w(Ke,x,null),e(x,ws),e(x,go),e(go,Es),e(x,ys),e(x,Dt),w(Ye,Dt,null),e(x,Ts),e(x,ke),w(Qe,ke,null),e(ke,Ms),e(ke,ae),e(ae,qs),e(ae,_o),e(_o,zs),e(ae,Fs),e(ae,bo),e(bo,xs),e(ae,Cs),e(x,js),e(x,U),w(Xe,U,null),e(U,Ss),e(U,Ot),e(Ot,Ps),e(Ot,Wt),e(Wt,Ls),e(U,As),e(U,ko),e(ko,Is),e(x,Ns),e(x,Rt),w(et,Rt,null),b(t,hn,u),b(t,re,u),e(re,ve),e(ve,vo),w(tt,vo,null),e(re,Ds),e(re,$o),e($o,Os),b(t,fn,u),b(t,q,u),w(ot,q,null),e(q,Ws),e(q,wo),e(wo,Rs),e(q,Hs),e(q,nt),e(nt,Vs),e(nt,Ht),e(Ht,Us),e(nt,Bs),e(q,Zs),e(q,st),e(st,Js),e(st,at),e(at,Gs),e(st,Ks),e(q,Ys),e(q,rt),e(rt,Qs),e(rt,it),e(it,Xs),e(rt,ea),e(q,ta),e(q,C),e(C,oa),e(C,Eo),e(Eo,na),e(C,sa),e(C,yo),e(yo,aa),e(C,ra),e(C,To),e(To,ia),e(C,la),e(C,Mo),e(Mo,da),e(C,ca),e(C,qo),e(qo,ma),e(C,pa),e(C,zo),e(zo,ha),e(C,fa),e(q,ua),e(q,H),w(lt,H,null),e(H,ga),e(H,ie),e(ie,_a),e(ie,Vt),e(Vt,ba),e(ie,ka),e(ie,Fo),e(Fo,va),e(ie,$a),e(H,wa),w($e,H,null),e(H,Ea),w(we,H,null),b(t,un,u),b(t,le,u),e(le,Ee),e(Ee,xo),w(dt,xo,null),e(le,ya),e(le,Co),e(Co,Ta),b(t,gn,u),b(t,j,u),w(ct,j,null),e(j,Ma),e(j,mt),e(mt,qa),e(mt,jo),e(jo,za),e(mt,Fa),e(j,xa),e(j,pt),e(pt,Ca),e(pt,Ut),e(Ut,ja),e(pt,Sa),e(j,Pa),e(j,ht),e(ht,La),e(ht,ft),e(ft,Aa),e(ht,Ia),e(j,Na),e(j,L),w(ut,L,null),e(L,Da),e(L,de),e(de,Oa),e(de,Bt),e(Bt,Wa),e(de,Ra),e(de,So),e(So,Ha),e(de,Va),e(L,Ua),w(ye,L,null),e(L,Ba),w(Te,L,null),e(L,Za),w(Me,L,null),b(t,_n,u),b(t,ce,u),e(ce,qe),e(qe,Po),w(gt,Po,null),e(ce,Ja),e(ce,Lo),e(Lo,Ga),b(t,bn,u),b(t,S,u),w(_t,S,null),e(S,Ka),e(S,Ao),e(Ao,Ya),e(S,Qa),e(S,bt),e(bt,Xa),e(bt,Zt),e(Zt,er),e(bt,tr),e(S,or),e(S,kt),e(kt,nr),e(kt,vt),e(vt,sr),e(kt,ar),e(S,rr),e(S,z),w($t,z,null),e(z,ir),e(z,me),e(me,lr),e(me,Jt),e(Jt,dr),e(me,cr),e(me,Io),e(Io,mr),e(me,pr),e(z,hr),w(ze,z,null),e(z,fr),w(Fe,z,null),e(z,ur),w(xe,z,null),e(z,gr),w(Ce,z,null),e(z,_r),w(je,z,null),b(t,kn,u),b(t,pe,u),e(pe,Se),e(Se,No),w(wt,No,null),e(pe,br),e(pe,Do),e(Do,kr),b(t,vn,u),b(t,P,u),w(Et,P,null),e(P,vr),e(P,Oo),e(Oo,$r),e(P,wr),e(P,yt),e(yt,Er),e(yt,Gt),e(Gt,yr),e(yt,Tr),e(P,Mr),e(P,Tt),e(Tt,qr),e(Tt,Mt),e(Mt,zr),e(Tt,Fr),e(P,xr),e(P,A),w(qt,A,null),e(A,Cr),e(A,he),e(he,jr),e(he,Kt),e(Kt,Sr),e(he,Pr),e(he,Wo),e(Wo,Lr),e(he,Ar),e(A,Ir),w(Pe,A,null),e(A,Nr),w(Le,A,null),e(A,Dr),w(Ae,A,null),$n=!0},p(t,[u]){const zt={};u&2&&(zt.$$scope={dirty:u,ctx:t}),_e.$set(zt);const Ro={};u&2&&(Ro.$$scope={dirty:u,ctx:t}),$e.$set(Ro);const Ho={};u&2&&(Ho.$$scope={dirty:u,ctx:t}),we.$set(Ho);const Vo={};u&2&&(Vo.$$scope={dirty:u,ctx:t}),ye.$set(Vo);const Ft={};u&2&&(Ft.$$scope={dirty:u,ctx:t}),Te.$set(Ft);const Uo={};u&2&&(Uo.$$scope={dirty:u,ctx:t}),Me.$set(Uo);const Bo={};u&2&&(Bo.$$scope={dirty:u,ctx:t}),ze.$set(Bo);const Zo={};u&2&&(Zo.$$scope={dirty:u,ctx:t}),Fe.$set(Zo);const xt={};u&2&&(xt.$$scope={dirty:u,ctx:t}),xe.$set(xt);const Jo={};u&2&&(Jo.$$scope={dirty:u,ctx:t}),Ce.$set(Jo);const Go={};u&2&&(Go.$$scope={dirty:u,ctx:t}),je.$set(Go);const Ko={};u&2&&(Ko.$$scope={dirty:u,ctx:t}),Pe.$set(Ko);const Yo={};u&2&&(Yo.$$scope={dirty:u,ctx:t}),Le.$set(Yo);const Qo={};u&2&&(Qo.$$scope={dirty:u,ctx:t}),Ae.$set(Qo)},i(t){$n||(E(l.$$.fragment,t),E(We.$$.fragment,t),E(Be.$$.fragment,t),E(Ze.$$.fragment,t),E(_e.$$.fragment,t),E(Ge.$$.fragment,t),E(Ke.$$.fragment,t),E(Ye.$$.fragment,t),E(Qe.$$.fragment,t),E(Xe.$$.fragment,t),E(et.$$.fragment,t),E(tt.$$.fragment,t),E(ot.$$.fragment,t),E(lt.$$.fragment,t),E($e.$$.fragment,t),E(we.$$.fragment,t),E(dt.$$.fragment,t),E(ct.$$.fragment,t),E(ut.$$.fragment,t),E(ye.$$.fragment,t),E(Te.$$.fragment,t),E(Me.$$.fragment,t),E(gt.$$.fragment,t),E(_t.$$.fragment,t),E($t.$$.fragment,t),E(ze.$$.fragment,t),E(Fe.$$.fragment,t),E(xe.$$.fragment,t),E(Ce.$$.fragment,t),E(je.$$.fragment,t),E(wt.$$.fragment,t),E(Et.$$.fragment,t),E(qt.$$.fragment,t),E(Pe.$$.fragment,t),E(Le.$$.fragment,t),E(Ae.$$.fragment,t),$n=!0)},o(t){y(l.$$.fragment,t),y(We.$$.fragment,t),y(Be.$$.fragment,t),y(Ze.$$.fragment,t),y(_e.$$.fragment,t),y(Ge.$$.fragment,t),y(Ke.$$.fragment,t),y(Ye.$$.fragment,t),y(Qe.$$.fragment,t),y(Xe.$$.fragment,t),y(et.$$.fragment,t),y(tt.$$.fragment,t),y(ot.$$.fragment,t),y(lt.$$.fragment,t),y($e.$$.fragment,t),y(we.$$.fragment,t),y(dt.$$.fragment,t),y(ct.$$.fragment,t),y(ut.$$.fragment,t),y(ye.$$.fragment,t),y(Te.$$.fragment,t),y(Me.$$.fragment,t),y(gt.$$.fragment,t),y(_t.$$.fragment,t),y($t.$$.fragment,t),y(ze.$$.fragment,t),y(Fe.$$.fragment,t),y(xe.$$.fragment,t),y(Ce.$$.fragment,t),y(je.$$.fragment,t),y(wt.$$.fragment,t),y(Et.$$.fragment,t),y(qt.$$.fragment,t),y(Pe.$$.fragment,t),y(Le.$$.fragment,t),y(Ae.$$.fragment,t),$n=!1},d(t){o(d),t&&o(_),t&&o(c),T(l),t&&o(Xo),t&&o(ee),T(We),t&&o(en),t&&o(ue),t&&o(tn),t&&o(Ct),t&&o(on),t&&o(jt),t&&o(nn),t&&o(St),t&&o(sn),t&&o(Pt),t&&o(an),t&&o(Lt),t&&o(rn),t&&o(At),t&&o(ln),t&&o(R),t&&o(dn),t&&o(te),T(Be),t&&o(cn),t&&o(W),T(Ze),T(_e),t&&o(mn),t&&o(se),T(Ge),t&&o(pn),t&&o(x),T(Ke),T(Ye),T(Qe),T(Xe),T(et),t&&o(hn),t&&o(re),T(tt),t&&o(fn),t&&o(q),T(ot),T(lt),T($e),T(we),t&&o(un),t&&o(le),T(dt),t&&o(gn),t&&o(j),T(ct),T(ut),T(ye),T(Te),T(Me),t&&o(_n),t&&o(ce),T(gt),t&&o(bn),t&&o(S),T(_t),T($t),T(ze),T(Fe),T(xe),T(Ce),T(je),t&&o(kn),t&&o(pe),T(wt),t&&o(vn),t&&o(P),T(Et),T(qt),T(Pe),T(Le),T(Ae)}}}const _l={local:"esm",sections:[{local:"overview",title:"Overview"},{local:"transformers.EsmConfig",title:"EsmConfig"},{local:"transformers.EsmTokenizer",title:"EsmTokenizer"},{local:"transformers.EsmModel",title:"EsmModel"},{local:"transformers.EsmForMaskedLM",title:"EsmForMaskedLM"},{local:"transformers.EsmForSequenceClassification",title:"EsmForSequenceClassification"},{local:"transformers.EsmForTokenClassification",title:"EsmForTokenClassification"}],title:"ESM"};function bl(M){return tl(()=>{new URLSearchParams(window.location.search).get("fw")}),[]}class Tl extends Yi{constructor(d){super();Qi(this,d,bl,gl,Xi,{})}}export{Tl as default,_l as metadata};
