...
pass your inputs and labels in any format that `),R=s("code"),Ke=a("model.fit()"),re=a(` supports! If, however, you want to use the second
...
pass your inputs and labels in any format that `),R=r(j,"CODE",{});var Tt=i(R);Ke=n(Tt,"model.fit()"),Tt.forEach(t),re=n(j,` supports! If, however, you want to use the second
...
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-built_in">print</span>(<span class="hljs-string">&quot;Predicted class:&quot;</span>, model.config.id2label[predicted_class_idx.item()])`}}),{c(){d=s("p"),T=a("Example:"),f=h(),w(u.$$.fragment)},l(l){d=r(l,"P",{});var p=i(d);T=n(p,"Example:"),p.forEach(t),f=m(l),y(u.$$.fragment,l)},m(l,p){_(l,d,p),e(d,T),_(l,f,p),$(u,l,p),v=!0},p:zo,i(l){v||(x(u.$$.fragment,l),v=!0)},o(l){E(u.$$.fragment,l),v=!1},d(l){l&&t(d),l&&t(f),k(u,l)}}}function Vm(V){let d,T,f,u,v,l,p,F,z,C,q,D,se,I,Ue,Q,He,Ce,R,Ke,re,ie,Je,Pe,X,Ge,Ae,Z,Ee,Xe,ve,A,L,qe,P,le,Ze,H,Qe,Ye,O,ke,de,et,ce,pe,Te,tt,Y,ot,S,at,he,W,nt,N,st,rt,b,M,ut,ee,gt,_t,j,vt,Tt,bt,me,wt,B,fe,yt,Fe,ue,$t,xt,Ve,Et,be,we,Qc,Ks,Do,Sr,Za,Wr,Js,Qa,Br,Gs,ze,qn,U,Ya,Rr,Ur,en,Hr,Kr,tn,Jr,Gr,zn,Xr,Zr,Nn,Qr,Yr,Dn,ei,ti,Ln,oi,ai,on,ni,si,ri,On,an,nn,ii,li,di,Sn,Lo,ci,Oo,pi,hi,mi,Wn,sn,rn,fi,ui,Xs,pt,gi,So,_i,vi,Wo,Ti,bi,Zs,Ut,wi,Bo,yi,$i,Qs,kt,Ht,Bn,Ro,xi,Rn,Ei,Ys,Ie,Uo,ki,Ft,Fi,ln,Vi,Ii,Ho,Mi,ji,Ci,Vt,Pi,dn,Ai,qi,cn,zi,Ni,Di,Kt,er,It,Jt,Un,Ko,Li,Hn,Oi,tr,Me,Jo,Si,Kn,Wi,Bi,Go,Ri,pn,Ui,Hi,Ki,ht,Xo,Ji,Jn,Gi,Xi,Gt,or,Mt,Xt,Gn,Zo,Zi,Xn,Qi,ar,it,Qo,Yi,Yo,el,ea,tl,ol,al,Ne,ta,nl,jt,sl,hn,rl,il,Zn,ll,dl,cl,Zt,pl,Qt,nr,Ct,Yt,Qn,oa,hl,Yn,ml,sr,ge,aa,fl,na,ul,sa,gl,_l,vl,eo,Tl,ra,bl,ia,wl,yl,$l,De,la,xl,Pt,El,mn,kl,Fl,es,Vl,Il,Ml,to,jl,oo,rr,At,ao,ts,da,Cl,os,Pl,ir,_e,ca,Al,as,ql,zl,no,Nl,pa,Dl,ha,Ll,Ol,Sl,Le,ma,Wl,qt,Bl,fn,Rl,Ul,ns,Hl,Kl,Jl,so,Gl,ro,lr,zt,io,ss,fa,Xl,rs,Zl,dr,te,ua,Ql,is,Yl,ed,ga,td,un,od,ad,nd,_a,sd,va,rd,id,ld,lo,dd,Oe,Ta,cd,Nt,pd,gn,hd,md,ls,fd,ud,gd,co,_d,po,cr,Dt,ho,ds,ba,vd,cs,Td,pr,K,wa,bd,ps,wd,yd,mo,$d,ya,xd,_n,Ed,kd,Fd,$a,Vd,xa,Id,Md,jd,fo,Cd,Se,Ea,Pd,Lt,Ad,vn,qd,zd,hs,Nd,Dd,Ld,uo,Od,go,hr,Ot,_o,ms,ka,Sd,fs,Wd,mr,J,Fa,Bd,us,Rd,Ud,Va,Hd,Tn,Kd,Jd,Gd,Ia,Xd,Ma,Zd,Qd,Yd,gs,ec,tc,lt,_s,ja,oc,ac,vs,Ca,nc,sc,Ts,Pa,rc,ic,bs,Aa,lc,dc,We,qa,cc,St,pc,ws,hc,mc,ys,fc,uc,gc,vo,_c,To,fr,Wt,bo,$s,za,vc,xs,Tc,ur,G,Na,bc,Es,wc,yc,Da,$c,bn,xc,Ec,kc,La,Fc,Oa,Vc,Ic,Mc,ks,jc,Cc,dt,Fs,Sa,Pc,Ac,Vs,Wa,qc,zc,Is,Ba,Nc,Dc,Ms,Ra,Lc,Oc,Be,Ua,Sc,Bt,Wc,js,Bc,Rc,Cs,Uc,Hc,Kc,wo,Jc,yo,gr;return l=new ct({}),I=new ct({}),Ro=new ct({}),Uo=new ne({props:{name:"class transformers.ViTConfig",anchor:"transformers.ViTConfig",parameters:[{name:"hidden_size",val:" = 768"},{name:"num_hidden_layers",val:" = 12"},{name:"num_attention_heads",val:" = 12"},{name:"intermediate_size",val:" = 3072"},{name:"hidden_act",val:" = 'gelu'"},{name:"hidden_dropout_prob",val:" = 0.0"},{name:"attention_probs_dropout_prob",val:" = 0.0"},{name:"initializer_range",val:" = 0.02"},{name:"layer_norm_eps",val:" = 1e-12"},{name:"is_encoder_decoder",val:" = False"},{name:"image_size",val:" = 224"},{name:"patch_size",val:" = 16"},{name:"num_channels",val:" = 3"},{name:"qkv_bias",val:" = True"},{name:"encoder_stride",val:" = 16"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.ViTConfig.hidden_size",description:`<strong>hidden_size</strong> (<code>int</code>, <em>optional</em>, defaults to 768) &#x2014;
...
</ul>`,name:"return_tensors"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/vit/feature_extraction_vit.py#L85",returnDescription:`
<p>A <a
...
<a href="/docs/transformers/main/en/main_classes/model#transformers.FlaxPreTrainedModel.to_bf16">to_bf16()</a>.`,name:"dtype"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/vit/modeling_flax_vit.py#L558"}}),qa=new ne({props:{name:"__call__",anchor:"transformers.FlaxViTModel.__call__",parameters:[{name:"pixel_values",val:""},{name:"params",val:": dict = None"},{name:"dropout_rng",val:": PRNGKey = None"},{name:"train",val:": bool = False"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/vit/modeling_flax_vit.py#L473",returnDescription:`
<p>A <a
...
parameters.</strong></p>
<p>If you wish to change the dtype of the model parameters, see <a href="/docs/transformers/main/en/main_classes/model#transformers.FlaxPreTrainedModel.to_fp16">to_fp16()</a> and
<a href="/docs/transformers/main/en/main_classes/model#transformers.FlaxPreTrainedModel.to_bf16">to_bf16()</a>.`,name:"dtype"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/vit/modeling_flax_vit.py#L641"}}),Ua=new ne({props:{name:"__call__",anchor:"transformers.FlaxViTForImageClassification.__call__",parameters:[{name:"pixel_values",val:""},{name:"params",val:": dict = None"},{name:"dropout_rng",val:": PRNGKey = None"},{name:"train",val:": bool = False"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/vit/modeling_flax_vit.py#L473",returnDescription:`
<p>A <a
...
improvement of 2% to training from scratch, but still 4% behind supervised pre-training.`),be=h(),we=s("img"),Ks=h(),Do=s("small"),Sr=a("ViT architecture. Taken from the "),Za=s("a"),Wr=a("original paper."),Js=h(),Qa=s("p"),Br=a("Following the original Vision Transformer, some follow-up works have been made:"),Gs=h(),ze=s("ul"),qn=s("li"),U=s("p"),Ya=s("a"),Rr=a("DeiT"),Ur=a(` (Data-efficient Image Transformers) by Facebook AI. DeiT models are distilled vision transformers.
...
found `),Wo=s("a"),Ti=a("here"),bi=a("."),Zs=h(),Ut=s("p"),wi=a("Note that we converted the weights from Ross Wightman\u2019s "),Bo=s("a"),yi=a("timm library"),$i=a(`, who already converted the weights from JAX to PyTorch. Credits
go to him!`),Qs=h(),kt=s("h2"),Ht=s("a"),Bn=s("span"),w(Ro.$$.fragment),xi=h(),Rn=s("span"),Ei=a("ViTConfig"),Ys=h(),Ie=s("div"),w(Uo.$$.fragment),ki=h(),Ft=s("p"),Fi=a("This is the configuration class to store the configuration of a "),ln=s("a"),Vi=a("ViTModel"),Ii=a(`. It is used to instantiate an ViT
...
documentation from `),cn=s("a"),zi=a("PretrainedConfig"),Ni=a(" for more information."),Di=h(),w(Kt.$$.fragment),er=h(),It=s("h2"),Jt=s("a"),Un=s("span"),w(Ko.$$.fragment),Li=h(),Hn=s("span"),Oi=a("ViTFeatureExtractor"),tr=h(),Me=s("div"),w(Jo.$$.fragment),Si=h(),Kn=s("p"),Wi=a("Constructs a ViT feature extractor."),Bi=h(),Go=s("p"),Ri=a("This feature extractor inherits from "),pn=s("a"),Ui=a("FeatureExtractionMixin"),Hi=a(` which contains most of the main methods. Users
...
data and transferred to multiple mid-sized or small image recognition benchmarks (ImageNet, CIFAR-100, VTAB, etc.),
Vision Transformer (ViT) attains excellent results compared to state-of-the-art convolutional networks while requiring
substantially fewer computational resources to train.`),Ws.forEach(t),Ss.forEach(t),ve=m(o),A=r(o,"P",{});var Bs=i(A);L=n(Bs,"Tips:"),Bs.forEach(t),qe=m(o),P=r(o,"UL",{});var oe=i(P);le=r(oe,"LI",{});var Ga=i(le);Ze=n(Ga,"Demo notebooks regarding inference as well as fine-tuning ViT on custom data can be found "),H=r(Ga,"A",{href:!0,rel:!0});var Rs=i(H);Qe=n(Rs,"here"),Rs.forEach(t),Ye=n(Ga,"."),Ga.forEach(t),O=m(oe),ke=r(oe,"LI",{});var Us=i(ke);de=n(Us,`To feed images to the Transformer encoder, each image is split into a sequence of fixed-size non-overlapping patches,
which are then linearly embedded. A [CLS] token is added to serve as representation of an entire image, which can be
used for classification. The authors also add absolute position embeddings, and feed the resulting sequence of
vectors to a standard Transformer encoder.`),Us.forEach(t),et=m(oe),ce=r(oe,"LI",{});var Xa=i(ce);pe=n(Xa,`As the Vision Transformer expects each image to be of the same size (resolution), one can use
`),Te=r(Xa,"A",{href:!0});var Hs=i(Te);tt=n(Hs,"ViTFeatureExtractor"),Hs.forEach(t),Y=n(Xa," to resize (or rescale) and normalize images for the model."),Xa.forEach(t),ot=m(oe),S=r(oe,"LI",{});var Rt=i(S);at=n(Rt,`Both the patch resolution and image resolution used during pre-training or fine-tuning are reflected in the name of
each checkpoint. For example, `),he=r(Rt,"CODE",{});var Yc=i(he);W=n(Yc,"google/vit-base-patch16-224"),Yc.forEach(t),nt=n(Rt,` refers to a base-sized architecture with patch
resolution of 16x16 and fine-tuning resolution of 224x224. All checkpoints can be found on the `),N=r(Rt,"A",{href:!0,rel:!0});var ep=i(N);st=n(ep,"hub"),ep.forEach(t),rt=n(Rt,"."),Rt.forEach(t),b=m(oe),M=r(oe,"LI",{});var wn=i(M);ut=n(wn,"The available checkpoints are either (1) pre-trained on "),ee=r(wn,"A",{href:!0,rel:!0});var tp=i(ee);gt=n(tp,"ImageNet-21k"),tp.forEach(t),_t=n(wn,` (a collection of
...
an experiment with a self-supervised pre-training objective, namely masked patched prediction (inspired by masked
language modeling). With this approach, the smaller ViT-B/16 model achieves 79.9% accuracy on ImageNet, a significant
improvement of 2% to training from scratch, but still 4% behind supervised pre-training.`),sp.forEach(t),oe.forEach(t),be=m(o),we=r(o,"IMG",{src:!0,alt:!0,width:!0}),Ks=m(o),Do=r(o,"SMALL",{});var Gc=i(Do);Sr=n(Gc,"ViT architecture. Taken from the "),Za=r(Gc,"A",{href:!0});var rp=i(Za);Wr=n(rp,"original paper."),rp.forEach(t),Gc.forEach(t),Js=m(o),Qa=r(o,"P",{});var ip=i(Qa);Br=n(ip,"Following the original Vision Transformer, some follow-up works have been made:"),ip.forEach(t),Gs=m(o),ze=r(o,"UL",{});var $o=i(ze);qn=r($o,"LI",{});var lp=i(qn);U=r(lp,"P",{});var ae=i(U);Ya=r(ae,"A",{href:!0});var dp=i(Ya);Rr=n(dp,"DeiT"),dp.forEach(t),Ur=n(ae,` (Data-efficient Image Transformers) by Facebook AI. DeiT models are distilled vision transformers.
...
found `),Wo=r($n,"A",{href:!0,rel:!0});var xp=i(Wo);Ti=n(xp,"here"),xp.forEach(t),bi=n($n,"."),$n.forEach(t),Zs=m(o),Ut=r(o,"P",{});var vr=i(Ut);wi=n(vr,"Note that we converted the weights from Ross Wightman\u2019s "),Bo=r(vr,"A",{href:!0,rel:!0});var Ep=i(Bo);yi=n(Ep,"timm library"),Ep.forEach(t),$i=n(vr,`, who already converted the weights from JAX to PyTorch. Credits
go to him!`),vr.forEach(t),Qs=m(o),kt=r(o,"H2",{class:!0});var Tr=i(kt);Ht=r(Tr,"A",{id:!0,class:!0,href:!0});var kp=i(Ht);Bn=r(kp,"SPAN",{});var Fp=i(Bn);y(Ro.$$.fragment,Fp),Fp.forEach(t),kp.forEach(t),xi=m(Tr),Rn=r(Tr,"SPAN",{});var Vp=i(Rn);Ei=n(Vp,"ViTConfig"),Vp.forEach(t),Tr.forEach(t),Ys=m(o),Ie=r(o,"DIV",{class:!0});var xo=i(Ie);y(Uo.$$.fragment,xo),ki=m(xo),Ft=r(xo,"P",{});var xn=i(Ft);Fi=n(xn,"This is the configuration class to store the configuration of a "),ln=r(xn,"A",{href:!0});var Ip=i(ln);Vi=n(Ip,"ViTModel"),Ip.forEach(t),Ii=n(xn,`. It is used to instantiate an ViT
model according to the specified arguments, defining the model architecture. Instantiating a configuration with the
defaults will yield a similar configuration to that of the ViT
...
documentation from `),cn=r(En,"A",{href:!0});var Cp=i(cn);zi=n(Cp,"PretrainedConfig"),Cp.forEach(t),Ni=n(En," for more information."),En.forEach(t),Di=m(xo),y(Kt.$$.fragment,xo),xo.forEach(t),er=m(o),It=r(o,"H2",{class:!0});var br=i(It);Jt=r(br,"A",{id:!0,class:!0,href:!0});var Pp=i(Jt);Un=r(Pp,"SPAN",{});var Ap=i(Un);y(Ko.$$.fragment,Ap),Ap.forEach(t),Pp.forEach(t),Li=m(br),Hn=r(br,"SPAN",{});var qp=i(Hn);Oi=n(qp,"ViTFeatureExtractor"),qp.forEach(t),br.forEach(t),tr=m(o),Me=r(o,"DIV",{class:!0});var Eo=i(Me);y(Jo.$$.fragment,Eo),Si=m(Eo),Kn=r(Eo,"P",{});var zp=i(Kn);Wi=n(zp,"Constructs a ViT feature extractor."),zp.forEach(t),Bi=m(Eo),Go=r(Eo,"P",{});var wr=i(Go);Ri=n(wr,"This feature extractor inherits from "),pn=r(wr,"A",{href:!0});var Np=i(pn);Ui=n(Np,"FeatureExtractionMixin"),Np.forEach(t),Hi=n(wr,` which contains most of the main methods. Users
...
as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),Vr.forEach(t),Sl=m(ft),Le=r(ft,"DIV",{class:!0});var Vo=i(Le);y(ma.$$.fragment,Vo),Wl=m(Vo),qt=r(Vo,"P",{});var Mn=i(qt);Bl=n(Mn,"The "),fn=r(Mn,"A",{href:!0});var ah=i(fn);Rl=n(ah,"ViTForImageClassification"),ah.forEach(t),Ul=n(Mn," forward method, overrides the "),ns=r(Mn,"CODE",{});var nh=i(ns);Hl=n(nh,"__call__"),nh.forEach(t),Kl=n(Mn," special method."),Mn.forEach(t),Jl=m(Vo),y(so.$$.fragment,Vo),Gl=m(Vo),y(ro.$$.fragment,Vo),Vo.forEach(t),ft.forEach(t),lr=m(o),zt=r(o,"H2",{class:!0});var Ir=i(zt);io=r(Ir,"A",{id:!0,class:!0,href:!0});var sh=i(io);ss=r(sh,"SPAN",{});var rh=i(ss);y(fa.$$.fragment,rh),rh.forEach(t),sh.forEach(t),Xl=m(Ir),rs=r(Ir,"SPAN",{});var ih=i(rs);Zl=n(ih,"TFViTModel"),ih.forEach(t),Ir.forEach(t),dr=m(o),te=r(o,"DIV",{class:!0});var Re=i(te);y(ua.$$.fragment,Re),Ql=m(Re),is=r(Re,"P",{});var lh=i(is);Yl=n(lh,"The bare ViT Model transformer outputting raw hidden-states without any specific head on top."),lh.forEach(t),ed=m(Re),ga=r(Re,"P",{});var Mr=i(ga);td=n(Mr,"This model inherits from "),un=r(Mr,"A",{href:!0});var dh=i(un);od=n(dh,"TFPreTrainedModel"),dh.forEach(t),ad=n(Mr,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Mr.forEach(t),nd=m(Re),_a=r(Re,"P",{});var jr=i(_a);sd=n(jr,"This model is also a "),va=r(jr,"A",{href:!0,rel:!0});var ch=i(va);rd=n(ch,"tf.keras.Model"),ch.forEach(t),id=n(jr,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),jr.forEach(t),ld=m(Re),y(lo.$$.fragment,Re),dd=m(Re),Oe=r(Re,"DIV",{class:!0});var Io=i(Oe);y(Ta.$$.fragment,Io),cd=m(Io),Nt=r(Io,"P",{});var jn=i(Nt);pd=n(jn,"The "),gn=r(jn,"A",{href:!0});var ph=i(gn);hd=n(ph,"TFViTModel"),ph.forEach(t),md=n(jn," forward method, overrides the "),ls=r(jn,"CODE",{});var hh=i(ls);fd=n(hh,"__call__"),hh.forEach(t),ud=n(jn," special method."),jn.forEach(t),gd=m(Io),y(co.$$.fragment,Io),_d=m(Io),y(po.$$.fragment,Io),Io.forEach(t),Re.forEach(t),cr=m(o),Dt=r(o,"H2",{class:!0});var Cr=i(Dt);ho=r(Cr,"A",{id:!0,class:!0,href:!0});var mh=i(ho);ds=r(mh,"SPAN",{});var fh=i(ds);y(ba.$$.fragment,fh),fh.forEach(t),mh.forEach(t),vd=m(Cr),cs=r(Cr,"SPAN",{});var uh=i(cs);Td=n(uh,"TFViTForImageClassification"),uh.forEach(t),Cr.forEach(t),pr=m(o),K=r(o,"DIV",{class:!0});var ye=i(K);y(wa.$$.fragment,ye),bd=m(ye),ps=r(ye,"P",{});var gh=i(ps);wd=n(gh,`ViT Model transformer with an image classification head on top (a linear layer on top of the final hidden state of
