import{S as ic,i as cc,s as lc,e as a,k as l,w as f,t as r,M as dc,c as n,d as o,m as d,a as i,x as u,h as s,b as c,F as e,g as h,y as _,q as g,o as v,B as T,v as pc}from"../../chunks/vendor-6b77c823.js";import{T as nc}from"../../chunks/Tip-39098574.js";import{D as A}from"../../chunks/Docstring-53452dc4.js";import{C as Pr}from"../../chunks/CodeBlock-3a8b25a8.js";import{I as _t}from"../../chunks/IconCopyLink-7a11ce68.js";function hc(gt){let m,I,x,E,L,S,O,D;return{c(){m=a("p"),I=r(`This class method is simply calling the feature extractor
...
instantiate an Speech2Text2 model according to the specified arguments, defining the model architecture.
Instantiating a configuration with the defaults will yield a similar configuration to that of the Speech2Text2
`),Ne=n(Xt,"A",{href:!0,rel:!0});var ki=i(Ne);Hs=s(ki,"facebook/s2t-small-librispeech-asr"),ki.forEach(o),Bs=s(Xt," architecture."),Xt.forEach(o),Js=d(Z),re=n(Z,"P",{});var Yt=i(re);Gs=s(Yt,"Configuration objects inherit from "),Mt=n(Yt,"A",{href:!0});var Si=i(Mt);Ks=s(Si,"PretrainedConfig"),Si.forEach(o),Qs=s(Yt,` and can be used to control the model outputs. Read the
