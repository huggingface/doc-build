...
methods above for more information.`),this.h()},l(P){m=n(P,"P",{});var b=i(m);I=a(b,`This class method is simply calling the feature extractor
...
methods above for more information.`),b.forEach(o),this.h()},h(){c(x,"href","/docs/transformers/main/en/main_classes/feature_extractor#transformers.FeatureExtractionMixin.from_pretrained")},m(P,b){h(P,m,b),e(m,I),e(m,x),e(x,E),e(m,L),e(m,S),e(S,O),e(m,D)},d(P){P&&o(m)}}}function mc(gt){let m,I,x,E,L,S,O,D;return{c(){m=r("p"),I=s("This class method is simply calling "),x=r("a"),E=s("save_pretrained()"),L=s(` and
`),S=r("code"),O=s("save_pretrained"),D=s(`. Please refer to the docstrings of the methods
above for more information.`),this.h()},l(P){m=n(P,"P",{});var b=i(m);I=a(b,"This class method is simply calling "),x=n(b,"A",{href:!0});var j=i(x);E=a(j,"save_pretrained()"),j.forEach(o),L=a(b,` and
`),S=n(b,"CODE",{});var q=i(S);O=a(q,"save_pretrained"),q.forEach(o),D=a(b,`. Please refer to the docstrings of the methods
above for more information.`),b.forEach(o),this.h()},h(){c(x,"href","/docs/transformers/main/en/main_classes/feature_extractor#transformers.FeatureExtractionMixin.save_pretrained")},m(P,b){h(P,m,b),e(m,I),e(m,x),e(x,E),e(m,L),e(m,S),e(S,O),e(m,D)},d(P){P&&o(m)}}}function fc(gt){let m,I,x,E,L,S,O,D,P,b,j,q,so,ye,js,ao,Cs,Lo,H,qs,vt,Fs,Ms,$e,As,Ls,Do,w,Ds,ro,Ws,Is,no,Vs,Ns,Tt,Os,Us,xt,Rs,Bs,kt,Hs,Js,io,Gs,Ks,Wo,ie,Qs,Ee,Xs,Ys,Io,ce,Zs,ze,ea,ta,Vo,bt,oa,No,J,Pe,sa,je,aa,ra,na,Ce,ia,St,ca,la,da,qe,pa,Fe,ha,ma,Oo,ee,le,co,Me,fa,lo,ua,Uo,G,_a,wt,ga,va,yt,Ta,xa,Ro,z,ka,$t,ba,Sa,Et,wa,ya,zt,$a,Ea,Pt,za,Pa,jt,ja,Ca,Bo,Ct,po,qa,Ho,Ae,Jo,qt,Le,ho,Fa,Ma,mo,Aa,Go,De,Ko,de,La,We,Da,Wa,Qo,te,pe,fo,Ie,Ia,uo,Va,Xo,C,Ve,Na,oe,Oa,Ft,Ua,Ra,Ne,Ba,Ha,Ja,se,Ga,Mt,Ka,Qa,At,Xa,Ya,Za,_o,er,tr,Oe,Yo,ae,he,go,Ue,or,vo,sr,Zo,$,Re,ar,To,rr,nr,Be,ir,Lt,cr,lr,dr,me,He,pr,xo,hr,mr,K,Je,fr,ko,ur,_r,Ge,gr,bo,vr,Tr,xr,Dt,Ke,es,re,fe,So,Qe,kr,wo,br,ts,k,Xe,Sr,yo,wr,yr,F,Wt,$r,Er,It,zr,Pr,Vt,jr,Cr,Ye,$o,qr,Fr,Mr,Nt,Ar,Lr,Dr,ue,Ze,Wr,U,Ir,Eo,Vr,Nr,Ot,Or,Ur,et,zo,Rr,Br,Hr,Jr,Q,tt,Gr,Po,Kr,Qr,_e,Xr,X,ot,Yr,st,Zr,Ut,en,tn,on,ge,sn,ve,at,an,rt,rn,Rt,nn,cn,ln,Te,nt,dn,it,pn,Bt,hn,mn,fn,xe,ct,un,jo,_n,os,ne,ke,Co,lt,gn,qo,vn,ss,W,dt,Tn,R,xn,Ht,kn,bn,Fo,Sn,wn,Jt,yn,$n,En,pt,zn,ht,Pn,jn,Cn,Y,mt,qn,Mo,Fn,Mn,ft,as;return S=new _t({}),ye=new _t({}),Me=new _t({}),Ae=new Ps({props:{code:`import torch
...
<span class="hljs-meta">&gt;&gt;&gt; </span>loss.backward()`}}),{c(){m=r("meta"),I=l(),x=r("h1"),E=r("a"),L=r("span"),f(S.$$.fragment),O=l(),D=r("span"),P=s("Speech2Text2"),b=l(),j=r("h2"),q=r("a"),so=r("span"),f(ye.$$.fragment),js=l(),ao=r("span"),Cs=s("Overview"),Lo=l(),H=r("p"),qs=s("The Speech2Text2 model is used together with "),vt=r("a"),Fs=s("Wav2Vec2"),Ms=s(` for Speech Translation models proposed in
`),$e=r("a"),As=s("Large-Scale Self- and Semi-Supervised Learning for Speech Translation"),Ls=s(` by
Changhan Wang, Anne Wu, Juan Pino, Alexei Baevski, Michael Auli, Alexis Conneau.`),Do=l(),w=r("p"),Ds=s("Speech2Text2 is a "),ro=r("em"),Ws=s("decoder-only"),Is=s(" transformer model that can be used with any speech "),no=r("em"),Vs=s("encoder-only"),Ns=s(`, such as
`),Tt=r("a"),Os=s("Wav2Vec2"),Us=s(" or "),xt=r("a"),Rs=s("HuBERT"),Bs=s(` for Speech-to-Text tasks. Please refer to the
`),kt=r("a"),Hs=s("SpeechEncoderDecoder"),Js=s(" class on how to combine Speech2Text2 with any speech "),io=r("em"),Gs=s("encoder-only"),Ks=s(`
model.`),Wo=l(),ie=r("p"),Qs=s("This model was contributed by "),Ee=r("a"),Xs=s("Patrick von Platen"),Ys=s("."),Io=l(),ce=r("p"),Zs=s("The original code can be found "),ze=r("a"),ea=s("here"),ta=s("."),Vo=l(),bt=r("p"),oa=s("Tips:"),No=l(),J=r("ul"),Pe=r("li"),sa=s(`Speech2Text2 achieves state-of-the-art results on the CoVoST Speech Translation dataset. For more information, see
...
`),Ne=r("a"),Ba=s("facebook/s2t-small-librispeech-asr"),Ha=s(" architecture."),Ja=l(),se=r("p"),Ga=s("Configuration objects inherit from "),Mt=r("a"),Ka=s("PretrainedConfig"),Qa=s(` and can be used to control the model outputs. Read the
documentation from `),At=r("a"),Xa=s("PretrainedConfig"),Ya=s(" for more information."),Za=l(),_o=r("p"),er=s("Example:"),tr=l(),f(Oe.$$.fragment),Yo=l(),ae=r("h2"),he=r("a"),go=r("span"),f(Ue.$$.fragment),or=l(),vo=r("span"),sr=s("Speech2TextTokenizer"),Zo=l(),$=r("div"),f(Re.$$.fragment),ar=l(),To=r("p"),rr=s("Constructs a Speech2Text2Tokenizer."),nr=l(),Be=r("p"),ir=s("This tokenizer inherits from "),Lt=r("a"),cr=s("PreTrainedTokenizer"),lr=s(` which contains some of the main methods. Users should refer to
the superclass for more information regarding such methods.`),dr=l(),me=r("div"),f(He.$$.fragment),pr=l(),xo=r("p"),hr=s("Convert a list of lists of token ids into a list of strings by calling decode."),mr=l(),K=r("div"),f(Je.$$.fragment),fr=l(),ko=r("p"),ur=s(`Converts a sequence of ids in a string, using the tokenizer and vocabulary with options to remove special
...
a single processor.`),yr=l(),F=r("p"),Wt=r("a"),$r=s("Speech2Text2Processor"),Er=s(" offers all the functionalities of "),It=r("a"),zr=s("AutoFeatureExtractor"),Pr=s(" and "),Vt=r("a"),jr=s("Speech2Text2Tokenizer"),Cr=s(`.
See the `),Ye=r("a"),$o=r("strong"),qr=s("call"),Fr=s("()"),Mr=s(" and "),Nt=r("a"),Ar=s("decode()"),Lr=s(" for more information."),Dr=l(),ue=r("div"),f(Ze.$$.fragment),Wr=l(),U=r("p"),Ir=s(`When used in normal mode, this method forwards all its arguments to AutoFeatureExtractor\u2019s
...
Speech2Text2Tokenizer\u2019s `),et=r("a"),zo=r("strong"),Rr=s("call"),Br=s("()"),Hr=s(`. Please refer to the doctsring of the above two
...
refer to the docstring of this method for more information.`),ln=l(),Te=r("div"),f(nt.$$.fragment),dn=l(),it=r("p"),pn=s("This method forwards all its arguments to Speech2Text2Tokenizer\u2019s "),Bt=r("a"),hn=s("decode()"),mn=s(`. Please refer
...
Speech2Text2.`),os=l(),ne=r("h2"),ke=r("a"),Co=r("span"),f(lt.$$.fragment),gn=l(),qo=r("span"),vn=s("Speech2Text2ForCausalLM"),ss=l(),W=r("div"),f(dt.$$.fragment),Tn=l(),R=r("p"),xn=s("The Speech2Text2 Decoder with a language modeling head. Can be used as the decoder part of "),Ht=r("a"),kn=s("EncoderDecoderModel"),bn=s(" and "),Fo=r("code"),Sn=s("SpeechEncoderDecoder"),wn=s(`.
...
Changhan Wang, Anne Wu, Juan Pino, Alexei Baevski, Michael Auli, Alexis Conneau.`),Gt.forEach(o),Do=d(t),w=n(t,"P",{});var M=i(w);Ds=a(M,"Speech2Text2 is a "),ro=n(M,"EM",{});var Rn=i(ro);Ws=a(Rn,"decoder-only"),Rn.forEach(o),Is=a(M," transformer model that can be used with any speech "),no=n(M,"EM",{});var Bn=i(no);Vs=a(Bn,"encoder-only"),Bn.forEach(o),Ns=a(M,`, such as
`),Tt=n(M,"A",{href:!0});var Hn=i(Tt);Os=a(Hn,"Wav2Vec2"),Hn.forEach(o),Us=a(M," or "),xt=n(M,"A",{href:!0});var Jn=i(xt);Rs=a(Jn,"HuBERT"),Jn.forEach(o),Bs=a(M,` for Speech-to-Text tasks. Please refer to the
`),kt=n(M,"A",{href:!0});var Gn=i(kt);Hs=a(Gn,"SpeechEncoderDecoder"),Gn.forEach(o),Js=a(M," class on how to combine Speech2Text2 with any speech "),io=n(M,"EM",{});var Kn=i(io);Gs=a(Kn,"encoder-only"),Kn.forEach(o),Ks=a(M,`
model.`),M.forEach(o),Wo=d(t),ie=n(t,"P",{});var ns=i(ie);Qs=a(ns,"This model was contributed by "),Ee=n(ns,"A",{href:!0,rel:!0});var Qn=i(Ee);Xs=a(Qn,"Patrick von Platen"),Qn.forEach(o),Ys=a(ns,"."),ns.forEach(o),Io=d(t),ce=n(t,"P",{});var is=i(ce);Zs=a(is,"The original code can be found "),ze=n(is,"A",{href:!0,rel:!0});var Xn=i(ze);ea=a(Xn,"here"),Xn.forEach(o),ta=a(is,"."),is.forEach(o),Vo=d(t),bt=n(t,"P",{});var Yn=i(bt);oa=a(Yn,"Tips:"),Yn.forEach(o),No=d(t),J=n(t,"UL",{});var Kt=i(J);Pe=n(Kt,"LI",{});var cs=i(Pe);sa=a(cs,`Speech2Text2 achieves state-of-the-art results on the CoVoST Speech Translation dataset. For more information, see
...
refer to the docstring of this method for more information.`),Ss.forEach(o),bs.forEach(o),ln=d(y),Te=n(y,"DIV",{class:!0});var ws=i(Te);u(nt.$$.fragment,ws),dn=d(ws),it=n(ws,"P",{});var ys=i(it);pn=a(ys,"This method forwards all its arguments to Speech2Text2Tokenizer\u2019s "),Bt=n(ys,"A",{href:!0});var Qi=i(Bt);hn=a(Qi,"decode()"),Qi.forEach(o),mn=a(ys,`. Please refer
...
Speech2Text2.`),Xi.forEach(o),$s.forEach(o),y.forEach(o),os=d(t),ne=n(t,"H2",{class:!0});var Es=i(ne);ke=n(Es,"A",{id:!0,class:!0,href:!0});var Yi=i(ke);Co=n(Yi,"SPAN",{});var Zi=i(Co);u(lt.$$.fragment,Zi),Zi.forEach(o),Yi.forEach(o),gn=d(Es),qo=n(Es,"SPAN",{});var ec=i(qo);vn=a(ec,"Speech2Text2ForCausalLM"),ec.forEach(o),Es.forEach(o),ss=d(t),W=n(t,"DIV",{class:!0});var Se=i(W);u(dt.$$.fragment,Se),Tn=d(Se),R=n(Se,"P",{});var we=i(R);xn=a(we,"The Speech2Text2 Decoder with a language modeling head. Can be used as the decoder part of "),Ht=n(we,"A",{href:!0});var tc=i(Ht);kn=a(tc,"EncoderDecoderModel"),tc.forEach(o),bn=a(we," and "),Fo=n(we,"CODE",{});var oc=i(Fo);Sn=a(oc,"SpeechEncoderDecoder"),oc.forEach(o),wn=a(we,`.
