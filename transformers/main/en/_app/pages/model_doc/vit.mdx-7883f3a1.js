...
the latter silently ignores them.`)},l(_){h=n(_,"P",{});var u=s(h);T=i(u,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=n(u,"CODE",{});var V=s(f);g=i(V,"Module"),V.forEach(t),v=i(u,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),u.forEach(t)},m(_,u){m(_,h,u),e(h,T),e(h,f),e(f,g),e(h,v)},d(_){_&&t(h)}}}function Im(I){let h,T,f,g,v,_,u,V,he,R,k,ie,j,B,oe,C,pe,ae,E,M,z,Me,ne,L,je,Te,Xo,tr,ss,Zo,Da,or,rs,Qo,ar,is,N,Vt,nr,Et,sr,rr,ir,Oa,lr,dr,kt,cr,Yo,hr,pr,mr,Pe,fr,Sa,ur,gr,It,_r,vr,Tr,Ce,wr,Mt,br,yr,jt,$r,xr,Fr,Ae,Vr,Pt,Er,kr,Ct,Ir,Mr,jr,Wa,Pr,ls,ea,Cr,ds,le,Ba,P,ta,Ar,qr,oa,zr,Nr,aa,Lr,Dr,Ua,Or,Sr,Ra,Wr,Br,Ha,Ur,Rr,Ja,Hr,Jr,na,Kr,Gr,Xr,Ka,sa,ra,Zr,Qr,Yr,Ga,At,ei,qt,ti,oi,ai,Xa,ia,la,ni,si,cs,we,ri,zt,ii,li,Nt,di,ci,hs,et,hi,Lt,pi,mi,ps,qe,tt,Za,Dt,fi,Qa,ui,ms,U,Ot,gi,ze,_i,da,vi,Ti,St,wi,bi,yi,Ne,$i,ca,xi,Fi,ha,Vi,Ei,ki,Ya,Ii,Mi,Wt,fs,Le,ot,en,Bt,ji,tn,Pi,us,se,Ut,Ci,on,Ai,qi,Rt,zi,pa,Ni,Li,Di,be,Ht,Oi,an,Si,Wi,at,gs,De,nt,nn,Jt,Bi,sn,Ui,_s,me,Kt,Ri,Gt,Hi,Xt,Ji,Ki,Gi,H,Zt,Xi,Oe,Zi,ma,Qi,Yi,rn,el,tl,ol,st,al,ln,nl,sl,Qt,vs,Se,rt,dn,Yt,rl,cn,il,Ts,fe,eo,ll,We,dl,hn,cl,hl,to,pl,ml,fl,J,oo,ul,Be,gl,fa,_l,vl,pn,Tl,wl,bl,it,yl,mn,$l,xl,ao,ws,Ue,lt,fn,no,Fl,un,Vl,bs,re,so,El,gn,kl,Il,ro,Ml,io,jl,Pl,Cl,K,lo,Al,Re,ql,ua,zl,Nl,_n,Ll,Dl,Ol,dt,Sl,vn,Wl,Bl,co,ys,He,ct,Tn,ho,Ul,wn,Rl,$s,D,po,Hl,bn,Jl,Kl,mo,Gl,ga,Xl,Zl,Ql,fo,Yl,uo,ed,td,od,ht,ad,G,go,nd,Je,sd,_a,rd,id,yn,ld,dd,cd,pt,hd,$n,pd,md,_o,xs,Ke,mt,xn,vo,fd,Fn,ud,Fs,O,To,gd,Vn,_d,vd,wo,Td,va,wd,bd,yd,bo,$d,yo,xd,Fd,Vd,ft,Ed,X,$o,kd,Ge,Id,Ta,Md,jd,En,Pd,Cd,Ad,ut,qd,kn,zd,Nd,xo,Vs,Xe,gt,In,Fo,Ld,Mn,Dd,Es,A,Vo,Od,jn,Sd,Wd,Eo,Bd,wa,Ud,Rd,Hd,ko,Jd,Io,Kd,Gd,Xd,Pn,Zd,Qd,ue,Cn,Mo,Yd,ec,An,jo,tc,oc,qn,Po,ac,nc,zn,Co,sc,rc,Z,Ao,ic,Ze,lc,Nn,dc,cc,Ln,hc,pc,mc,_t,fc,Dn,uc,gc,qo,ks,Qe,vt,On,zo,_c,Sn,vc,Is,q,No,Tc,Wn,wc,bc,Lo,yc,ba,$c,xc,Fc,Do,Vc,Oo,Ec,kc,Ic,Bn,Mc,jc,ge,Un,So,Pc,Cc,Rn,Wo,Ac,qc,Hn,Bo,zc,Nc,Jn,Uo,Lc,Dc,Q,Ro,Oc,Ye,Sc,Kn,Wc,Bc,Gn,Uc,Rc,Hc,Tt,Jc,Xn,Kc,Gc,Ho,Ms;return _=new ve({}),k=new _e({props:{$$slots:{default:[vm]},$$scope:{ctx:I}}}),C=new ve({}),Dt=new ve({}),Ot=new W({props:{name:"class transformers.ViTConfig",anchor:"transformers.ViTConfig",parameters:[{name:"hidden_size",val:" = 768"},{name:"num_hidden_layers",val:" = 12"},{name:"num_attention_heads",val:" = 12"},{name:"intermediate_size",val:" = 3072"},{name:"hidden_act",val:" = 'gelu'"},{name:"hidden_dropout_prob",val:" = 0.0"},{name:"attention_probs_dropout_prob",val:" = 0.0"},{name:"initializer_range",val:" = 0.02"},{name:"layer_norm_eps",val:" = 1e-12"},{name:"is_encoder_decoder",val:" = False"},{name:"image_size",val:" = 224"},{name:"patch_size",val:" = 16"},{name:"num_channels",val:" = 3"},{name:"qkv_bias",val:" = True"},{name:"encoder_stride",val:" = 16"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/vit/configuration_vit.py#L35",parametersDescription:[{anchor:"transformers.ViTConfig.hidden_size",description:`<strong>hidden_size</strong> (<code>int</code>, <em>optional</em>, defaults to 768) &#x2014;
...
go to him!`),ps=d(),qe=a("h2"),tt=a("a"),Za=a("span"),w(Dt.$$.fragment),fi=d(),Qa=a("span"),ui=r("ViTConfig"),ms=d(),U=a("div"),w(Ot.$$.fragment),gi=d(),ze=a("p"),_i=r("This is the configuration class to store the configuration of a "),da=a("a"),vi=r("ViTModel"),Ti=r(`. It is used to instantiate an ViT
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Vd=d(),w(ft.$$.fragment),Ed=d(),X=a("div"),w($o.$$.fragment),kd=d(),Ge=a("p"),Id=r("The "),Ta=a("a"),Md=r("TFViTForImageClassification"),jd=r(" forward method, overrides the "),En=a("code"),Pd=r("__call__"),Cd=r(" special method."),Ad=d(),w(ut.$$.fragment),qd=d(),kn=a("p"),zd=r("Examples:"),Nd=d(),w(xo.$$.fragment),Vs=d(),Xe=a("h2"),gt=a("a"),In=a("span"),w(Fo.$$.fragment),Ld=d(),Mn=a("span"),Dd=r("FlaxVitModel"),Es=d(),A=a("div"),w(Vo.$$.fragment),Od=d(),jn=a("p"),Sd=r("The bare ViT Model transformer outputting raw hidden-states without any specific head on top."),Wd=d(),Eo=a("p"),Bd=r("This model inherits from "),wa=a("a"),Ud=r("FlaxPreTrainedModel"),Rd=r(`. Check the superclass documentation for the generic methods the
...
general usage and behavior.`),Xd=d(),Pn=a("p"),Zd=r("Finally, this model supports inherent JAX features such as:"),Qd=d(),ue=a("ul"),Cn=a("li"),Mo=a("a"),Yd=r("Just-In-Time (JIT) compilation"),ec=d(),An=a("li"),jo=a("a"),tc=r("Automatic Differentiation"),oc=d(),qn=a("li"),Po=a("a"),ac=r("Vectorization"),nc=d(),zn=a("li"),Co=a("a"),sc=r("Parallelization"),rc=d(),Z=a("div"),w(Ao.$$.fragment),ic=d(),Ze=a("p"),lc=r("The "),Nn=a("code"),dc=r("FlaxViTPreTrainedModel"),cc=r("forward method, overrides the "),Ln=a("code"),hc=r("__call__"),pc=r(" special method."),mc=d(),w(_t.$$.fragment),fc=d(),Dn=a("p"),uc=r("Examples:"),gc=d(),w(qo.$$.fragment),ks=d(),Qe=a("h2"),vt=a("a"),On=a("span"),w(zo.$$.fragment),_c=d(),Sn=a("span"),vc=r("FlaxViTForImageClassification"),Is=d(),q=a("div"),w(No.$$.fragment),Tc=d(),Wn=a("p"),wc=r(`ViT Model transformer with an image classification head on top (a linear layer on top of the final hidden state of
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Rs.forEach(t),od=c(de),b(ht.$$.fragment,de),ad=c(de),G=n(de,"DIV",{class:!0});var Ve=s(G);b(go.$$.fragment,Ve),nd=c(Ve),Je=n(Ve,"P",{});var qa=s(Je);sd=i(qa,"The "),_a=n(qa,"A",{href:!0});var Tp=s(_a);rd=i(Tp,"TFViTModel"),Tp.forEach(t),id=i(qa," forward method, overrides the "),yn=n(qa,"CODE",{});var wp=s(yn);ld=i(wp,"__call__"),wp.forEach(t),dd=i(qa," special method."),qa.forEach(t),cd=c(Ve),b(pt.$$.fragment,Ve),hd=c(Ve),$n=n(Ve,"P",{});var bp=s($n);pd=i(bp,"Examples:"),bp.forEach(t),md=c(Ve),b(_o.$$.fragment,Ve),Ve.forEach(t),de.forEach(t),xs=c(o),Ke=n(o,"H2",{class:!0});var Hs=s(Ke);mt=n(Hs,"A",{id:!0,class:!0,href:!0});var yp=s(mt);xn=n(yp,"SPAN",{});var $p=s(xn);b(vo.$$.fragment,$p),$p.forEach(t),yp.forEach(t),fd=c(Hs),Fn=n(Hs,"SPAN",{});var xp=s(Fn);ud=i(xp,"TFViTForImageClassification"),xp.forEach(t),Hs.forEach(t),Fs=c(o),O=n(o,"DIV",{class:!0});var ce=s(O);b(To.$$.fragment,ce),gd=c(ce),Vn=n(ce,"P",{});var Fp=s(Vn);_d=i(Fp,`ViT Model transformer with an image classification head on top (a linear layer on top of the final hidden state of
