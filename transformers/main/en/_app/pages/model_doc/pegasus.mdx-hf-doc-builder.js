...
<span class="hljs-meta">&gt;&gt;&gt; </span>outputs = model.decode(decoder_input_ids, encoder_outputs)
<span class="hljs-meta">&gt;&gt;&gt; </span>logits = outputs.logits`}}),{c(){p=n("p"),b=r("Example:"),_=l(),v(m.$$.fragment)},l(d){p=s(d,"P",{});var h=a(p);b=i(h,"Example:"),h.forEach(t),_=c(d),y(m.$$.fragment,d)},m(d,h){f(d,p,h),e(p,b),f(d,_,h),T(m,d,h),k=!0},p:ht,i(d){k||(w(m.$$.fragment,d),k=!0)},o(d){P(m.$$.fragment,d),k=!1},d(d){d&&t(p),d&&t(_),$(m,d)}}}function fk(z){let p,b,_,m,k,d,h,E,Qe,Ge,L,Pe,$e,q,ie,de,Je,Le,N,ee,xe,K,Xe,ze,le,Ne,te,ce,ue,Ze,Fe,S,A,Ye,oe,ne,qe,pe,et,Ee,D,De,G,tt,he,me,ot,fe,Q,nt,se,J,V,I,ge,R,Me,st,x,F,Tt,X,wt,Pt,M,$t,xt,mt,W,at,Z,_e,rt,zt,ke,it,Ft,dt,Ce,je,Se,ll,cl,ul,to,ln,pl,hl,cn,ml,fl,Li,qt,oo,$a,un,gl,xa,_l,Ni,ft,no,pn,kl,bl,hn,vl,yl,Tl,za,wl,Pl,Fa,$l,Di,Et,so,qa,mn,xl,Ea,zl,Ui,Te,Ma,Ca,Fl,ql,ja,Rs,El,Hs,Ml,Cl,fn,Sa,jl,Sl,Mt,Oa,Ol,Al,Aa,Il,Gl,gn,Ll,Ia,Nl,Dl,Ul,Ga,lt,Bl,La,Wl,Kl,Na,Rl,Hl,Da,Vl,Ql,Jl,Ua,Ct,Xl,_n,Zl,Yl,Ba,ec,tc,Bi,jt,ao,Wa,kn,oc,Ka,nc,Wi,bn,Ki,St,ro,Ra,vn,sc,Ha,ac,Ri,Oe,yn,rc,Ot,ic,Vs,dc,lc,Tn,cc,uc,pc,At,hc,Qs,mc,fc,Js,gc,_c,kc,io,Hi,It,lo,Va,wn,bc,Qa,vc,Vi,co,yc,Ja,Tc,wc,Qi,H,Pn,Pc,$n,$c,xn,xc,zc,Fc,zn,qc,Xs,Ec,Mc,Cc,Ue,Fn,jc,qn,Sc,Xa,Oc,Ac,Ic,En,Zs,Gc,Za,Lc,Nc,Mn,Dc,Ya,Uc,Bc,Wc,er,Kc,Rc,uo,Cn,Hc,tr,Vc,Qc,po,jn,Jc,or,Xc,Zc,ho,Sn,Yc,nr,eu,Ji,Gt,mo,sr,On,tu,ar,ou,Xi,be,An,nu,Lt,su,rr,au,ru,In,iu,du,lu,Gn,cu,Ys,uu,pu,hu,gt,Ln,mu,ir,fu,gu,Nn,ea,_u,dr,ku,bu,Dn,vu,lr,yu,Tu,wu,fo,Un,Pu,cr,$u,Zi,Nt,go,ur,Bn,xu,pr,zu,Yi,Ae,Wn,Fu,Kn,qu,ta,Eu,Mu,Cu,Rn,ju,Hn,Su,Ou,Au,Be,Vn,Iu,Dt,Gu,oa,Lu,Nu,hr,Du,Uu,Bu,_o,Wu,ko,ed,Ut,bo,mr,Qn,Ku,fr,Ru,td,Ie,Jn,Hu,Xn,Vu,na,Qu,Ju,Xu,Zn,Zu,Yn,Yu,ep,tp,We,es,op,Bt,np,sa,sp,ap,gr,rp,ip,dp,vo,lp,yo,od,Wt,To,_r,ts,cp,kr,up,nd,Kt,os,pp,wo,ns,hp,Po,sd,Rt,$o,br,ss,mp,vr,fp,ad,ve,as,gp,rs,_p,aa,kp,bp,vp,is,yp,ds,Tp,wp,Pp,xo,$p,Ke,ls,xp,Ht,zp,ra,Fp,qp,yr,Ep,Mp,Cp,zo,jp,Fo,rd,Vt,qo,Tr,cs,Sp,wr,Op,id,ye,us,Ap,ps,Ip,ia,Gp,Lp,Np,hs,Dp,ms,Up,Bp,Wp,Eo,Kp,Re,fs,Rp,Qt,Hp,da,Vp,Qp,Pr,Jp,Xp,Zp,Mo,Yp,Co,dd,Jt,jo,$r,gs,eh,xr,th,ld,U,_s,oh,ks,nh,la,sh,ah,rh,bs,ih,vs,dh,lh,ch,zr,uh,ph,ct,Fr,ys,hh,mh,qr,Ts,fh,gh,Er,ws,_h,kh,Mr,Ps,bh,vh,He,$s,yh,Xt,Th,Cr,wh,Ph,jr,$h,xh,zh,So,Fh,Oo,qh,Ao,xs,Eh,Io,Mh,Go,zs,Ch,Lo,cd,Zt,No,Sr,Fs,jh,Or,Sh,ud,B,qs,Oh,Es,Ah,ca,Ih,Gh,Lh,Ms,Nh,Cs,Dh,Uh,Bh,Ar,Wh,Kh,ut,Ir,js,Rh,Hh,Gr,Ss,Vh,Qh,Lr,Os,Jh,Xh,Nr,As,Zh,Yh,C,Is,em,Yt,tm,Dr,om,nm,Ur,sm,am,rm,Do,im,Br,dm,lm,Wr,Kr,Rr,Hr,cm,um,Vr,Qr,Jr,Xr,pm,hm,Zr,Yr,ei,ti,mm,fm,oi,ni,Gs,Uo,Bo,si,Ls,gm,ai,_m,km,ri,bm,vm,ii,ym,Tm,di,li,ci,ui,wm,Pm,pi,hi,mi,fi,$m,xm,gi,_i,ki,bi,zm,Fm,vi,yi,Ti,wi,qm,Em,Wo,Ns,Mm,Ko,Cm,Ro,Ds,jm,Ho,pd;return d=new Y({}),K=new Y({}),ge=new Y({}),un=new Y({}),mn=new Y({}),kn=new Y({}),bn=new Ve({props:{code:`from transformers import PegasusForConditionalGeneration, PegasusTokenizer
import torch
...
behaviors between training and evaluation).`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/pegasus/modeling_tf_pegasus.py#L1225",returnDescription:`
<p>A <a
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/main/en/main_classes/model#transformers.TFPreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/pegasus/modeling_tf_pegasus.py#L1320"}}),Eo=new dn({props:{$$slots:{default:[ak]},$$scope:{ctx:z}}}),fs=new j({props:{name:"call",anchor:"transformers.TFPegasusForConditionalGeneration.call",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"decoder_input_ids",val:" = None"},{name:"decoder_attention_mask",val:" = None"},{name:"decoder_position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"decoder_head_mask",val:" = None"},{name:"cross_attn_head_mask",val:" = None"},{name:"encoder_outputs",val:": typing.Optional[transformers.modeling_tf_outputs.TFBaseModelOutput] = None"},{name:"past_key_values",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"decoder_inputs_embeds",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"},{name:"labels",val:" = None"},{name:"training",val:" = False"}],parametersDescription:[{anchor:"transformers.TFPegasusForConditionalGeneration.call.input_ids",description:`<strong>input_ids</strong> (<code>tf.Tensor</code> of shape <code>({0})</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/main/en/model_doc/pegasus#transformers.PegasusTokenizer">PegasusTokenizer</a>. See <a href="/docs/transformers/main/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/main/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
Labels for computing the masked language modeling loss. Indices should either be in <code>[0, ..., config.vocab_size]</code> or -100 (see <code>input_ids</code> docstring). Tokens with indices set to <code>-100</code> are ignored
(masked), the loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/pegasus/modeling_tf_pegasus.py#L1358",returnDescription:`
<p>A <a
...
found in `),Ba=n("code"),ec=r("convert_pegasus_tf_to_pytorch.py"),tc=r("."),Bi=l(),jt=n("h2"),ao=n("a"),Wa=n("span"),v(kn.$$.fragment),oc=l(),Ka=n("span"),nc=r("Usage Example"),Wi=l(),v(bn.$$.fragment),Ki=l(),St=n("h2"),ro=n("a"),Ra=n("span"),v(vn.$$.fragment),sc=l(),Ha=n("span"),ac=r("PegasusConfig"),Ri=l(),Oe=n("div"),v(yn.$$.fragment),rc=l(),Ot=n("p"),ic=r("This is the configuration class to store the configuration of a "),Vs=n("a"),dc=r("PegasusModel"),lc=r(`. It is used to instantiate an
...
and behavior.`),Au=l(),Be=n("div"),v(Vn.$$.fragment),Iu=l(),Dt=n("p"),Gu=r("The "),oa=n("a"),Lu=r("PegasusModel"),Nu=r(" forward method, overrides the "),hr=n("code"),Du=r("__call__"),Uu=r(" special method."),Bu=l(),v(_o.$$.fragment),Wu=l(),v(ko.$$.fragment),ed=l(),Ut=n("h2"),bo=n("a"),mr=n("span"),v(Qn.$$.fragment),Ku=l(),fr=n("span"),Ru=r("PegasusForConditionalGeneration"),td=l(),Ie=n("div"),v(Jn.$$.fragment),Hu=l(),Xn=n("p"),Vu=r(`The PEGASUS Model with a language modeling head. Can be used for summarization.
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),tp=l(),We=n("div"),v(es.$$.fragment),op=l(),Bt=n("p"),np=r("The "),sa=n("a"),sp=r("PegasusForConditionalGeneration"),ap=r(" forward method, overrides the "),gr=n("code"),rp=r("__call__"),ip=r(" special method."),dp=l(),v(vo.$$.fragment),lp=l(),v(yo.$$.fragment),od=l(),Wt=n("h2"),To=n("a"),_r=n("span"),v(ts.$$.fragment),cp=l(),kr=n("span"),up=r("PegasusForCausalLM"),nd=l(),Kt=n("div"),v(os.$$.fragment),pp=l(),wo=n("div"),v(ns.$$.fragment),hp=l(),v(Po.$$.fragment),sd=l(),Rt=n("h2"),$o=n("a"),br=n("span"),v(ss.$$.fragment),mp=l(),vr=n("span"),fp=r("TFPegasusModel"),ad=l(),ve=n("div"),v(as.$$.fragment),gp=l(),rs=n("p"),_p=r(`The bare PEGASUS Model outputting raw hidden-states without any specific head on top.
...
tokenizer([ARTICLE_TO_SUMMARIZE], max_length=1024, return_tensors=\u2018np\u2019)`),fm=l(),oi=n("blockquote"),ni=n("blockquote"),Gs=n("blockquote"),Uo=n("h1"),Bo=n("a"),si=n("span"),v(Ls.$$.fragment),gm=l(),ai=n("span"),_m=r("Generate Summary >>> summary_ids = model.generate(inputs[\u2018input_ids\u2019]).sequences >>>"),km=l(),ri=n("p"),bm=r("print(tokenizer.batch_decode(summary_ids, skip_special_tokens=True, clean_up_tokenization_spaces=False))"),vm=l(),ii=n("p"),ym=r("Mask filling example:"),Tm=l(),di=n("blockquote"),li=n("blockquote"),ci=n("blockquote"),ui=n("p"),wm=r(`from transformers import PegasusTokenizer, FlaxPegasusForConditionalGeneration >>> tokenizer =
...
found in `),Ba=s(ma,"CODE",{});var vf=a(Ba);ec=i(vf,"convert_pegasus_tf_to_pytorch.py"),vf.forEach(t),tc=i(ma,"."),ma.forEach(t),kf.forEach(t),kt.forEach(t),Bi=c(o),jt=s(o,"H2",{class:!0});var bd=a(jt);ao=s(bd,"A",{id:!0,class:!0,href:!0});var yf=a(ao);Wa=s(yf,"SPAN",{});var Tf=a(Wa);y(kn.$$.fragment,Tf),Tf.forEach(t),yf.forEach(t),oc=c(bd),Ka=s(bd,"SPAN",{});var wf=a(Ka);nc=i(wf,"Usage Example"),wf.forEach(t),bd.forEach(t),Wi=c(o),y(bn.$$.fragment,o),Ki=c(o),St=s(o,"H2",{class:!0});var vd=a(St);ro=s(vd,"A",{id:!0,class:!0,href:!0});var Pf=a(ro);Ra=s(Pf,"SPAN",{});var $f=a(Ra);y(vn.$$.fragment,$f),$f.forEach(t),Pf.forEach(t),sc=c(vd),Ha=s(vd,"SPAN",{});var xf=a(Ha);ac=i(xf,"PegasusConfig"),xf.forEach(t),vd.forEach(t),Ri=c(o),Oe=s(o,"DIV",{class:!0});var Jo=a(Oe);y(yn.$$.fragment,Jo),rc=c(Jo),Ot=s(Jo,"P",{});var fa=a(Ot);ic=i(fa,"This is the configuration class to store the configuration of a "),Vs=s(fa,"A",{href:!0});var zf=a(Vs);dc=i(zf,"PegasusModel"),zf.forEach(t),lc=i(fa,`. It is used to instantiate an
PEGASUS model according to the specified arguments, defining the model architecture. Instantiating a configuration
with the defaults will yield a similar configuration to that of the PEGASUS
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Gd.forEach(t),Au=c(Zo),Be=s(Zo,"DIV",{class:!0});var Yo=a(Be);y(Vn.$$.fragment,Yo),Iu=c(Yo),Dt=s(Yo,"P",{});var ba=a(Dt);Gu=i(ba,"The "),oa=s(ba,"A",{href:!0});var ag=a(oa);Lu=i(ag,"PegasusModel"),ag.forEach(t),Nu=i(ba," forward method, overrides the "),hr=s(ba,"CODE",{});var rg=a(hr);Du=i(rg,"__call__"),rg.forEach(t),Uu=i(ba," special method."),ba.forEach(t),Bu=c(Yo),y(_o.$$.fragment,Yo),Wu=c(Yo),y(ko.$$.fragment,Yo),Yo.forEach(t),Zo.forEach(t),ed=c(o),Ut=s(o,"H2",{class:!0});var Ld=a(Ut);bo=s(Ld,"A",{id:!0,class:!0,href:!0});var ig=a(bo);mr=s(ig,"SPAN",{});var dg=a(mr);y(Qn.$$.fragment,dg),dg.forEach(t),ig.forEach(t),Ku=c(Ld),fr=s(Ld,"SPAN",{});var lg=a(fr);Ru=i(lg,"PegasusForConditionalGeneration"),lg.forEach(t),Ld.forEach(t),td=c(o),Ie=s(o,"DIV",{class:!0});var en=a(Ie);y(Jn.$$.fragment,en),Hu=c(en),Xn=s(en,"P",{});var Nd=a(Xn);Vu=i(Nd,`The PEGASUS Model with a language modeling head. Can be used for summarization.
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Dd.forEach(t),tp=c(en),We=s(en,"DIV",{class:!0});var tn=a(We);y(es.$$.fragment,tn),op=c(tn),Bt=s(tn,"P",{});var va=a(Bt);np=i(va,"The "),sa=s(va,"A",{href:!0});var pg=a(sa);sp=i(pg,"PegasusForConditionalGeneration"),pg.forEach(t),ap=i(va," forward method, overrides the "),gr=s(va,"CODE",{});var hg=a(gr);rp=i(hg,"__call__"),hg.forEach(t),ip=i(va," special method."),va.forEach(t),dp=c(tn),y(vo.$$.fragment,tn),lp=c(tn),y(yo.$$.fragment,tn),tn.forEach(t),en.forEach(t),od=c(o),Wt=s(o,"H2",{class:!0});var Ud=a(Wt);To=s(Ud,"A",{id:!0,class:!0,href:!0});var mg=a(To);_r=s(mg,"SPAN",{});var fg=a(_r);y(ts.$$.fragment,fg),fg.forEach(t),mg.forEach(t),cp=c(Ud),kr=s(Ud,"SPAN",{});var gg=a(kr);up=i(gg,"PegasusForCausalLM"),gg.forEach(t),Ud.forEach(t),nd=c(o),Kt=s(o,"DIV",{class:!0});var Bd=a(Kt);y(os.$$.fragment,Bd),pp=c(Bd),wo=s(Bd,"DIV",{class:!0});var Wd=a(wo);y(ns.$$.fragment,Wd),hp=c(Wd),y(Po.$$.fragment,Wd),Wd.forEach(t),Bd.forEach(t),sd=c(o),Rt=s(o,"H2",{class:!0});var Kd=a(Rt);$o=s(Kd,"A",{id:!0,class:!0,href:!0});var _g=a($o);br=s(_g,"SPAN",{});var kg=a(br);y(ss.$$.fragment,kg),kg.forEach(t),_g.forEach(t),mp=c(Kd),vr=s(Kd,"SPAN",{});var bg=a(vr);fp=i(bg,"TFPegasusModel"),bg.forEach(t),Kd.forEach(t),ad=c(o),ve=s(o,"DIV",{class:!0});var vt=a(ve);y(as.$$.fragment,vt),gp=c(vt),rs=s(vt,"P",{});var Rd=a(rs);_p=i(Rd,`The bare PEGASUS Model outputting raw hidden-states without any specific head on top.
