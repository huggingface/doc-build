import{S as R_,i as H_,s as K_,e as n,k as l,w as v,t as r,M as V_,c as s,d as t,m as c,a,x as y,h as i,b as u,G as e,g as f,y as T,q as w,o as P,B as $,v as Q_,L as Qe}from"../../chunks/vendor-hf-doc-builder.js";import{T as Uo}from"../../chunks/Tip-hf-doc-builder.js";import{D as C}from"../../chunks/Docstring-hf-doc-builder.js";import{C as Se}from"../../chunks/CodeBlock-hf-doc-builder.js";import{I as Z}from"../../chunks/IconCopyLink-hf-doc-builder.js";import{E as Ve}from"../../chunks/ExampleCodeBlock-hf-doc-builder.js";function J_(z){let p,b,_,h,k;return h=new Se({props:{code:`from transformers import PegasusModel, PegasusConfig
...
<span class="hljs-meta">&gt;&gt;&gt; </span>configuration = model.config`}}),{c(){p=n("p"),b=r("Example:"),_=l(),v(h.$$.fragment)},l(d){p=s(d,"P",{});var m=a(p);b=i(m,"Example:"),m.forEach(t),_=c(d),y(h.$$.fragment,d)},m(d,m){f(d,p,m),e(p,b),f(d,_,m),T(h,d,m),k=!0},p:Qe,i(d){k||(w(h.$$.fragment,d),k=!0)},o(d){P(h.$$.fragment,d),k=!1},d(d){d&&t(p),d&&t(_),$(h,d)}}}function X_(z){let p,b,_,h,k;return{c(){p=n("p"),b=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),_=n("code"),h=r("Module"),k=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(d){p=s(d,"P",{});var m=a(p);b=i(m,"Although the recipe for forward pass needs to be defined within this function, one should call the "),_=s(m,"CODE",{});var F=a(_);h=i(F,"Module"),F.forEach(t),k=i(m,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),m.forEach(t)},m(d,m){f(d,p,m),e(p,b),e(p,_),e(_,h),e(p,k)},d(d){d&&t(p)}}}function Z_(z){let p,b,_,h,k;return h=new Se({props:{code:`from transformers import PegasusTokenizer, PegasusModel
...
[<span class="hljs-number">1</span>, <span class="hljs-number">4</span>, <span class="hljs-number">1024</span>]`}}),{c(){p=n("p"),b=r("Example:"),_=l(),v(h.$$.fragment)},l(d){p=s(d,"P",{});var m=a(p);b=i(m,"Example:"),m.forEach(t),_=c(d),y(h.$$.fragment,d)},m(d,m){f(d,p,m),e(p,b),f(d,_,m),T(h,d,m),k=!0},p:Qe,i(d){k||(w(h.$$.fragment,d),k=!0)},o(d){P(h.$$.fragment,d),k=!1},d(d){d&&t(p),d&&t(_),$(h,d)}}}function Y_(z){let p,b,_,h,k;return{c(){p=n("p"),b=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),_=n("code"),h=r("Module"),k=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(d){p=s(d,"P",{});var m=a(p);b=i(m,"Although the recipe for forward pass needs to be defined within this function, one should call the "),_=s(m,"CODE",{});var F=a(_);h=i(F,"Module"),F.forEach(t),k=i(m,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),m.forEach(t)},m(d,m){f(d,p,m),e(p,b),e(p,_),e(_,h),e(p,k)},d(d){d&&t(p)}}}function ek(z){let p,b,_,h,k;return h=new Se({props:{code:`from transformers import PegasusTokenizer, PegasusForConditionalGeneration
...
<span class="hljs-string">&quot;California&#x27;s largest electricity provider has turned off power to hundreds of thousands of customers.&quot;</span>`}}),{c(){p=n("p"),b=r("Summarization example:"),_=l(),v(h.$$.fragment)},l(d){p=s(d,"P",{});var m=a(p);b=i(m,"Summarization example:"),m.forEach(t),_=c(d),y(h.$$.fragment,d)},m(d,m){f(d,p,m),e(p,b),f(d,_,m),T(h,d,m),k=!0},p:Qe,i(d){k||(w(h.$$.fragment,d),k=!0)},o(d){P(h.$$.fragment,d),k=!1},d(d){d&&t(p),d&&t(_),$(h,d)}}}function tk(z){let p,b,_,h,k;return h=new Se({props:{code:`from transformers import PegasusTokenizer, PegasusForCausalLM
...
<span class="hljs-literal">True</span>`}}),{c(){p=n("p"),b=r("Example:"),_=l(),v(h.$$.fragment)},l(d){p=s(d,"P",{});var m=a(p);b=i(m,"Example:"),m.forEach(t),_=c(d),y(h.$$.fragment,d)},m(d,m){f(d,p,m),e(p,b),f(d,_,m),T(h,d,m),k=!0},p:Qe,i(d){k||(w(h.$$.fragment,d),k=!0)},o(d){P(h.$$.fragment,d),k=!1},d(d){d&&t(p),d&&t(_),$(h,d)}}}function ok(z){let p,b,_,h,k,d,m,F,Oe,he,E,ke,ae,Ae,re,ie,Ie,xe,D,A,be,K,S,O,Ge,Y,ee,Le,U,Ne,De,I,me,de,ze,te,V,Ue,Be,B,We,oe,R;return{c(){p=n("p"),b=r("TF 2.0 models accepts two formats as inputs:"),_=l(),h=n("ul"),k=n("li"),d=r("having all inputs as keyword arguments (like PyTorch models), or"),m=l(),F=n("li"),Oe=r("having all inputs as a list, tuple or dict in the first positional arguments."),he=l(),E=n("p"),ke=r("This second option is useful when using "),ae=n("code"),Ae=r("tf.keras.Model.fit"),re=r(` method which currently requires having all the
tensors in the first argument of the model call function: `),ie=n("code"),Ie=r("model(inputs)"),xe=r("."),D=l(),A=n("p"),be=r(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
...
`),oe=n("code"),R=r('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(x){p=s(x,"P",{});var q=a(p);b=i(q,"TF 2.0 models accepts two formats as inputs:"),q.forEach(t),_=c(x),h=s(x,"UL",{});var ve=a(h);k=s(ve,"LI",{});var at=a(k);d=i(at,"having all inputs as keyword arguments (like PyTorch models), or"),at.forEach(t),m=c(ve),F=s(ve,"LI",{});var ye=a(F);Oe=i(ye,"having all inputs as a list, tuple or dict in the first positional arguments."),ye.forEach(t),ve.forEach(t),he=c(x),E=s(x,"P",{});var Q=a(E);ke=i(Q,"This second option is useful when using "),ae=s(Q,"CODE",{});var rt=a(ae);Ae=i(rt,"tf.keras.Model.fit"),rt.forEach(t),re=i(Q,` method which currently requires having all the
tensors in the first argument of the model call function: `),ie=s(Q,"CODE",{});var Je=a(ie);Ie=i(Je,"model(inputs)"),Je.forEach(t),xe=i(Q,"."),Q.forEach(t),D=c(x),A=s(x,"P",{});var le=a(A);be=i(le,`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
...
`),oe=s(H,"CODE",{});var lt=a(oe);R=i(lt,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),lt.forEach(t),H.forEach(t),G.forEach(t)},m(x,q){f(x,p,q),e(p,b),f(x,_,q),f(x,h,q),e(h,k),e(k,d),e(h,m),e(h,F),e(F,Oe),f(x,he,q),f(x,E,q),e(E,ke),e(E,ae),e(ae,Ae),e(E,re),e(E,ie),e(ie,Ie),e(E,xe),f(x,D,q),f(x,A,q),e(A,be),f(x,K,q),f(x,S,q),e(S,O),e(O,Ge),e(O,Y),e(Y,ee),e(O,Le),e(O,U),e(U,Ne),e(S,De),e(S,I),e(I,me),e(I,de),e(de,ze),e(I,te),e(I,V),e(V,Ue),e(S,Be),e(S,B),e(B,We),e(B,oe),e(oe,R)},d(x){x&&t(p),x&&t(_),x&&t(h),x&&t(he),x&&t(E),x&&t(D),x&&t(A),x&&t(K),x&&t(S)}}}function nk(z){let p,b,_,h,k;return{c(){p=n("p"),b=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),_=n("code"),h=r("Module"),k=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(d){p=s(d,"P",{});var m=a(p);b=i(m,"Although the recipe for forward pass needs to be defined within this function, one should call the "),_=s(m,"CODE",{});var F=a(_);h=i(F,"Module"),F.forEach(t),k=i(m,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),m.forEach(t)},m(d,m){f(d,p,m),e(p,b),e(p,_),e(_,h),e(p,k)},d(d){d&&t(p)}}}function sk(z){let p,b,_,h,k;return h=new Se({props:{code:`from transformers import PegasusTokenizer, TFPegasusModel
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),{c(){p=n("p"),b=r("Example:"),_=l(),v(h.$$.fragment)},l(d){p=s(d,"P",{});var m=a(p);b=i(m,"Example:"),m.forEach(t),_=c(d),y(h.$$.fragment,d)},m(d,m){f(d,p,m),e(p,b),f(d,_,m),T(h,d,m),k=!0},p:Qe,i(d){k||(w(h.$$.fragment,d),k=!0)},o(d){P(h.$$.fragment,d),k=!1},d(d){d&&t(p),d&&t(_),$(h,d)}}}function ak(z){let p,b,_,h,k,d,m,F,Oe,he,E,ke,ae,Ae,re,ie,Ie,xe,D,A,be,K,S,O,Ge,Y,ee,Le,U,Ne,De,I,me,de,ze,te,V,Ue,Be,B,We,oe,R;return{c(){p=n("p"),b=r("TF 2.0 models accepts two formats as inputs:"),_=l(),h=n("ul"),k=n("li"),d=r("having all inputs as keyword arguments (like PyTorch models), or"),m=l(),F=n("li"),Oe=r("having all inputs as a list, tuple or dict in the first positional arguments."),he=l(),E=n("p"),ke=r("This second option is useful when using "),ae=n("code"),Ae=r("tf.keras.Model.fit"),re=r(` method which currently requires having all the
tensors in the first argument of the model call function: `),ie=n("code"),Ie=r("model(inputs)"),xe=r("."),D=l(),A=n("p"),be=r(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),K=l(),S=n("ul"),O=n("li"),Ge=r("a single Tensor with "),Y=n("code"),ee=r("input_ids"),Le=r(" only and nothing else: "),U=n("code"),Ne=r("model(input_ids)"),De=l(),I=n("li"),me=r(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),de=n("code"),ze=r("model([input_ids, attention_mask])"),te=r(" or "),V=n("code"),Ue=r("model([input_ids, attention_mask, token_type_ids])"),Be=l(),B=n("li"),We=r(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),oe=n("code"),R=r('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(x){p=s(x,"P",{});var q=a(p);b=i(q,"TF 2.0 models accepts two formats as inputs:"),q.forEach(t),_=c(x),h=s(x,"UL",{});var ve=a(h);k=s(ve,"LI",{});var at=a(k);d=i(at,"having all inputs as keyword arguments (like PyTorch models), or"),at.forEach(t),m=c(ve),F=s(ve,"LI",{});var ye=a(F);Oe=i(ye,"having all inputs as a list, tuple or dict in the first positional arguments."),ye.forEach(t),ve.forEach(t),he=c(x),E=s(x,"P",{});var Q=a(E);ke=i(Q,"This second option is useful when using "),ae=s(Q,"CODE",{});var rt=a(ae);Ae=i(rt,"tf.keras.Model.fit"),rt.forEach(t),re=i(Q,` method which currently requires having all the
...
first positional argument :`),le.forEach(t),K=c(x),S=s(x,"UL",{});var G=a(S);O=s(G,"LI",{});var J=a(O);Ge=i(J,"a single Tensor with "),Y=s(J,"CODE",{});var Te=a(Y);ee=i(Te,"input_ids"),Te.forEach(t),Le=i(J," only and nothing else: "),U=s(J,"CODE",{});var it=a(U);Ne=i(it,"model(input_ids)"),it.forEach(t),J.forEach(t),De=c(G),I=s(G,"LI",{});var X=a(I);me=i(X,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),de=s(X,"CODE",{});var dt=a(de);ze=i(dt,"model([input_ids, attention_mask])"),dt.forEach(t),te=i(X," or "),V=s(X,"CODE",{});var Xe=a(V);Ue=i(Xe,"model([input_ids, attention_mask, token_type_ids])"),Xe.forEach(t),X.forEach(t),Be=c(G),B=s(G,"LI",{});var H=a(B);We=i(H,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),oe=s(H,"CODE",{});var lt=a(oe);R=i(lt,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),lt.forEach(t),H.forEach(t),G.forEach(t)},m(x,q){f(x,p,q),e(p,b),f(x,_,q),f(x,h,q),e(h,k),e(k,d),e(h,m),e(h,F),e(F,Oe),f(x,he,q),f(x,E,q),e(E,ke),e(E,ae),e(ae,Ae),e(E,re),e(E,ie),e(ie,Ie),e(E,xe),f(x,D,q),f(x,A,q),e(A,be),f(x,K,q),f(x,S,q),e(S,O),e(O,Ge),e(O,Y),e(Y,ee),e(O,Le),e(O,U),e(U,Ne),e(S,De),e(S,I),e(I,me),e(I,de),e(de,ze),e(I,te),e(I,V),e(V,Ue),e(S,Be),e(S,B),e(B,We),e(B,oe),e(oe,R)},d(x){x&&t(p),x&&t(_),x&&t(h),x&&t(he),x&&t(E),x&&t(D),x&&t(A),x&&t(K),x&&t(S)}}}function rk(z){let p,b,_,h,k;return{c(){p=n("p"),b=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),_=n("code"),h=r("Module"),k=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(d){p=s(d,"P",{});var m=a(p);b=i(m,"Although the recipe for forward pass needs to be defined within this function, one should call the "),_=s(m,"CODE",{});var F=a(_);h=i(F,"Module"),F.forEach(t),k=i(m,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),m.forEach(t)},m(d,m){f(d,p,m),e(p,b),e(p,_),e(_,h),e(p,k)},d(d){d&&t(p)}}}function ik(z){let p,b,_,h,k;return h=new Se({props:{code:`from transformers import PegasusTokenizer, TFPegasusForConditionalGeneration
...
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-built_in">print</span>(tokenizer.batch_decode(summary_ids, skip_special_tokens=<span class="hljs-literal">True</span>, clean_up_tokenization_spaces=<span class="hljs-literal">False</span>))`}}),{c(){p=n("p"),b=r("Summarization example:"),_=l(),v(h.$$.fragment)},l(d){p=s(d,"P",{});var m=a(p);b=i(m,"Summarization example:"),m.forEach(t),_=c(d),y(h.$$.fragment,d)},m(d,m){f(d,p,m),e(p,b),f(d,_,m),T(h,d,m),k=!0},p:Qe,i(d){k||(w(h.$$.fragment,d),k=!0)},o(d){P(h.$$.fragment,d),k=!1},d(d){d&&t(p),d&&t(_),$(h,d)}}}function dk(z){let p,b,_,h,k;return{c(){p=n("p"),b=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),_=n("code"),h=r("Module"),k=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(d){p=s(d,"P",{});var m=a(p);b=i(m,"Although the recipe for forward pass needs to be defined within this function, one should call the "),_=s(m,"CODE",{});var F=a(_);h=i(F,"Module"),F.forEach(t),k=i(m,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),m.forEach(t)},m(d,m){f(d,p,m),e(p,b),e(p,_),e(_,h),e(p,k)},d(d){d&&t(p)}}}function lk(z){let p,b,_,h,k;return h=new Se({props:{code:`from transformers import PegasusTokenizer, FlaxPegasusModel
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),{c(){p=n("p"),b=r("Example:"),_=l(),v(h.$$.fragment)},l(d){p=s(d,"P",{});var m=a(p);b=i(m,"Example:"),m.forEach(t),_=c(d),y(h.$$.fragment,d)},m(d,m){f(d,p,m),e(p,b),f(d,_,m),T(h,d,m),k=!0},p:Qe,i(d){k||(w(h.$$.fragment,d),k=!0)},o(d){P(h.$$.fragment,d),k=!1},d(d){d&&t(p),d&&t(_),$(h,d)}}}function ck(z){let p,b,_,h,k;return h=new Se({props:{code:`from transformers import PegasusTokenizer, FlaxPegasusForConditionalGeneration
...
<span class="hljs-meta">&gt;&gt;&gt; </span>encoder_outputs = model.encode(**inputs)`}}),{c(){p=n("p"),b=r("Example:"),_=l(),v(h.$$.fragment)},l(d){p=s(d,"P",{});var m=a(p);b=i(m,"Example:"),m.forEach(t),_=c(d),y(h.$$.fragment,d)},m(d,m){f(d,p,m),e(p,b),f(d,_,m),T(h,d,m),k=!0},p:Qe,i(d){k||(w(h.$$.fragment,d),k=!0)},o(d){P(h.$$.fragment,d),k=!1},d(d){d&&t(p),d&&t(_),$(h,d)}}}function uk(z){let p,b,_,h,k;return h=new Se({props:{code:`import jax.numpy as jnp
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_decoder_hidden_states = outputs.last_hidden_state`}}),{c(){p=n("p"),b=r("Example:"),_=l(),v(h.$$.fragment)},l(d){p=s(d,"P",{});var m=a(p);b=i(m,"Example:"),m.forEach(t),_=c(d),y(h.$$.fragment,d)},m(d,m){f(d,p,m),e(p,b),f(d,_,m),T(h,d,m),k=!0},p:Qe,i(d){k||(w(h.$$.fragment,d),k=!0)},o(d){P(h.$$.fragment,d),k=!1},d(d){d&&t(p),d&&t(_),$(h,d)}}}function pk(z){let p,b,_,h,k;return{c(){p=n("p"),b=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),_=n("code"),h=r("Module"),k=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(d){p=s(d,"P",{});var m=a(p);b=i(m,"Although the recipe for forward pass needs to be defined within this function, one should call the "),_=s(m,"CODE",{});var F=a(_);h=i(F,"Module"),F.forEach(t),k=i(m,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),m.forEach(t)},m(d,m){f(d,p,m),e(p,b),e(p,_),e(_,h),e(p,k)},d(d){d&&t(p)}}}function hk(z){let p,b,_,h,k;return h=new Se({props:{code:`from transformers import PegasusTokenizer, FlaxPegasusForConditionalGeneration
...
<span class="hljs-meta">&gt;&gt;&gt; </span>text = <span class="hljs-string">&quot;My friends are cool but they eat too many carbs.&quot;</span>
<span class="hljs-meta">&gt;&gt;&gt; </span>inputs = tokenizer(text, max_length=<span class="hljs-number">1024</span>, return_tensors=<span class="hljs-string">&quot;np&quot;</span>)
<span class="hljs-meta">&gt;&gt;&gt; </span>encoder_outputs = model.encode(**inputs)`}}),{c(){p=n("p"),b=r("Example:"),_=l(),v(h.$$.fragment)},l(d){p=s(d,"P",{});var m=a(p);b=i(m,"Example:"),m.forEach(t),_=c(d),y(h.$$.fragment,d)},m(d,m){f(d,p,m),e(p,b),f(d,_,m),T(h,d,m),k=!0},p:Qe,i(d){k||(w(h.$$.fragment,d),k=!0)},o(d){P(h.$$.fragment,d),k=!1},d(d){d&&t(p),d&&t(_),$(h,d)}}}function mk(z){let p,b,_,h,k;return h=new Se({props:{code:`import jax.numpy as jnp
from transformers import PegasusTokenizer, FlaxPegasusForConditionalGeneration
...
<span class="hljs-meta">&gt;&gt;&gt; </span>outputs = model.decode(decoder_input_ids, encoder_outputs)
<span class="hljs-meta">&gt;&gt;&gt; </span>logits = outputs.logits`}}),{c(){p=n("p"),b=r("Example:"),_=l(),v(h.$$.fragment)},l(d){p=s(d,"P",{});var m=a(p);b=i(m,"Example:"),m.forEach(t),_=c(d),y(h.$$.fragment,d)},m(d,m){f(d,p,m),e(p,b),f(d,_,m),T(h,d,m),k=!0},p:Qe,i(d){k||(w(h.$$.fragment,d),k=!0)},o(d){P(h.$$.fragment,d),k=!1},d(d){d&&t(p),d&&t(_),$(h,d)}}}function fk(z){let p,b,_,h,k,d,m,F,Oe,he,E,ke,ae,Ae,re,ie,Ie,xe,D,A,be,K,S,O,Ge,Y,ee,Le,U,Ne,De,I,me,de,ze,te,V,Ue,Be,B,We,oe,R,x,q,ve,at,ye,Q,rt,Je,le,G,J,Te,it,X,dt,Xe,H,lt,Bo,Zd,Yd,la,el,tl,zi,fe,ca,ol,nl,ua,sl,al,pa,rl,il,Wo,dl,Ro,ll,cl,ul,At,Ho,pl,hl,Ko,ml,fl,Fi,ct,It,ha,Vo,gl,ma,_l,qi,Ze,Gt,Qo,kl,bl,Jo,vl,yl,Tl,fa,wl,Pl,ga,$l,Ei,ut,Lt,_a,Xo,xl,ka,zl,Mi,ge,ba,va,Fl,ql,ya,Es,El,Ms,Ml,Cl,Zo,Ta,jl,Sl,pt,wa,Ol,Al,Pa,Il,Gl,Yo,Ll,$a,Nl,Dl,Ul,xa,Re,Bl,za,Wl,Rl,Fa,Hl,Kl,qa,Vl,Ql,Jl,Ea,ht,Xl,en,Zl,Yl,Ma,ec,tc,Ci,mt,Nt,Ca,tn,oc,ja,nc,ji,on,Si,ft,Dt,Sa,nn,sc,Oa,ac,Oi,we,sn,rc,gt,ic,Cs,dc,lc,an,cc,uc,pc,_t,hc,js,mc,fc,Ss,gc,_c,kc,Ut,Ai,kt,Bt,Aa,rn,bc,Ia,vc,Ii,Wt,yc,Ga,Tc,wc,Gi,W,dn,Pc,ln,$c,cn,xc,zc,Fc,un,qc,Os,Ec,Mc,Cc,Fe,pn,jc,hn,Sc,La,Oc,Ac,Ic,mn,As,Gc,Na,Lc,Nc,fn,Dc,Da,Uc,Bc,Wc,Ua,Rc,Hc,Rt,gn,Kc,Ba,Vc,Qc,Ht,_n,Jc,Wa,Xc,Zc,Kt,kn,Yc,Ra,eu,Li,bt,Vt,Ha,bn,tu,Ka,ou,Ni,ce,vn,nu,vt,su,Va,au,ru,yn,iu,du,lu,Tn,cu,Is,uu,pu,hu,Ye,wn,mu,Qa,fu,gu,Pn,Gs,_u,Ja,ku,bu,$n,vu,Xa,yu,Tu,wu,Qt,xn,Pu,Za,$u,Di,yt,Jt,Ya,zn,xu,er,zu,Ui,Pe,Fn,Fu,qn,qu,Ls,Eu,Mu,Cu,En,ju,Mn,Su,Ou,Au,qe,Cn,Iu,Tt,Gu,Ns,Lu,Nu,tr,Du,Uu,Bu,Xt,Wu,Zt,Bi,wt,Yt,or,jn,Ru,nr,Hu,Wi,$e,Sn,Ku,On,Vu,Ds,Qu,Ju,Xu,An,Zu,In,Yu,ep,tp,Ee,Gn,op,Pt,np,Us,sp,ap,sr,rp,ip,dp,eo,lp,to,Ri,$t,oo,ar,Ln,cp,rr,up,Hi,xt,Nn,pp,no,Dn,hp,so,Ki,zt,ao,ir,Un,mp,dr,fp,Vi,ue,Bn,gp,Wn,_p,Bs,kp,bp,vp,Rn,yp,Hn,Tp,wp,Pp,ro,$p,Me,Kn,xp,Ft,zp,Ws,Fp,qp,lr,Ep,Mp,Cp,io,jp,lo,Qi,qt,co,cr,Vn,Sp,ur,Op,Ji,pe,Qn,Ap,Jn,Ip,Rs,Gp,Lp,Np,Xn,Dp,Zn,Up,Bp,Wp,uo,Rp,Ce,Yn,Hp,Et,Kp,Hs,Vp,Qp,pr,Jp,Xp,Zp,po,Yp,ho,Xi,Mt,mo,hr,es,eh,mr,th,Zi,L,ts,oh,os,nh,Ks,sh,ah,rh,ns,ih,ss,dh,lh,ch,fr,uh,ph,He,gr,as,hh,mh,_r,rs,fh,gh,kr,is,_h,kh,br,ds,bh,vh,je,ls,yh,Ct,Th,vr,wh,Ph,yr,$h,xh,zh,fo,Fh,go,qh,_o,cs,Eh,ko,Mh,bo,us,Ch,vo,Yi,jt,yo,Tr,ps,jh,wr,Sh,ed,N,hs,Oh,ms,Ah,Vs,Ih,Gh,Lh,fs,Nh,gs,Dh,Uh,Bh,Pr,Wh,Rh,Ke,$r,_s,Hh,Kh,xr,ks,Vh,Qh,zr,bs,Jh,Xh,Fr,vs,Zh,Yh,M,ys,em,St,tm,qr,om,nm,Er,sm,am,rm,To,im,Mr,dm,lm,Cr,jr,Sr,Or,cm,um,Ar,Ir,Gr,Lr,pm,hm,Nr,Dr,Ur,Br,mm,fm,Wr,Rr,Ts,wo,Po,Hr,ws,gm,Kr,_m,km,Vr,bm,vm,Qr,ym,Tm,Jr,Xr,Zr,Yr,wm,Pm,ei,ti,oi,ni,$m,xm,si,ai,ri,ii,zm,Fm,di,li,ci,ui,qm,Em,$o,Ps,Mm,xo,Cm,zo,$s,jm,Fo,td;return d=new Z({}),K=new Z({}),Te=new Z({}),Vo=new Z({}),Xo=new Z({}),tn=new Z({}),on=new Se({props:{code:`from transformers import PegasusForConditionalGeneration, PegasusTokenizer
import torch
...
Whether or not to return a <a href="/docs/transformers/main/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/pegasus/modeling_pegasus.py#L1190",returnDescription:`
<p>A <a
...
(masked), the loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/pegasus/modeling_pegasus.py#L1357",returnDescription:`
<p>A <a
...
Whether or not to return a <a href="/docs/transformers/main/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/pegasus/modeling_pegasus.py#L1549",returnDescription:`
<p>A <a
...
behaviors between training and evaluation).`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/pegasus/modeling_tf_pegasus.py#L1208",returnDescription:`
<p>A <a
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/main/en/main_classes/model#transformers.TFPreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/pegasus/modeling_tf_pegasus.py#L1285"}}),uo=new Uo({props:{$$slots:{default:[ak]},$$scope:{ctx:z}}}),Yn=new C({props:{name:"call",anchor:"transformers.TFPegasusForConditionalGeneration.call",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"decoder_input_ids",val:" = None"},{name:"decoder_attention_mask",val:" = None"},{name:"decoder_position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"decoder_head_mask",val:" = None"},{name:"cross_attn_head_mask",val:" = None"},{name:"encoder_outputs",val:": typing.Optional[transformers.modeling_tf_outputs.TFBaseModelOutput] = None"},{name:"past_key_values",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"decoder_inputs_embeds",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"},{name:"labels",val:" = None"},{name:"training",val:" = False"}],parametersDescription:[{anchor:"transformers.TFPegasusForConditionalGeneration.call.input_ids",description:`<strong>input_ids</strong> (<code>tf.Tensor</code> of shape <code>({0})</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/main/en/model_doc/pegasus#transformers.PegasusTokenizer">PegasusTokenizer</a>. See <a href="/docs/transformers/main/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/main/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
Labels for computing the masked language modeling loss. Indices should either be in <code>[0, ..., config.vocab_size]</code> or -100 (see <code>input_ids</code> docstring). Tokens with indices set to <code>-100</code> are ignored
(masked), the loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/pegasus/modeling_tf_pegasus.py#L1318",returnDescription:`
<p>A <a
...
`}}),vo=new Ve({props:{anchor:"transformers.FlaxPegasusModel.decode.example",$$slots:{default:[uk]},$$scope:{ctx:z}}}),ps=new Z({}),hs=new C({props:{name:"class transformers.FlaxPegasusForConditionalGeneration",anchor:"transformers.FlaxPegasusForConditionalGeneration",parameters:[{name:"config",val:": PegasusConfig"},{name:"input_shape",val:": typing.Tuple[int] = (1, 1)"},{name:"seed",val:": int = 0"},{name:"dtype",val:": dtype = <class 'jax.numpy.float32'>"},{name:"_do_init",val:": bool = True"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.FlaxPegasusForConditionalGeneration.config",description:`<strong>config</strong> (<a href="/docs/transformers/main/en/model_doc/pegasus#transformers.PegasusConfig">PegasusConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
...
`}}),Fo=new Ve({props:{anchor:"transformers.FlaxPegasusForConditionalGeneration.decode.example",$$slots:{default:[mk]},$$scope:{ctx:z}}}),{c(){p=n("meta"),b=l(),_=n("h1"),h=n("a"),k=n("span"),v(d.$$.fragment),m=l(),F=n("span"),Oe=r("Pegasus"),he=l(),E=n("p"),ke=n("strong"),ae=r("DISCLAIMER:"),Ae=r(" If you see something strange, file a "),re=n("a"),ie=r("Github Issue"),Ie=r(`
and assign @patrickvonplaten.`),xe=l(),D=n("h2"),A=n("a"),be=n("span"),v(K.$$.fragment),S=l(),O=n("span"),Ge=r("Overview"),Y=l(),ee=n("p"),Le=r("The Pegasus model was proposed in "),U=n("a"),Ne=r("PEGASUS: Pre-training with Extracted Gap-sentences for Abstractive Summarization"),De=r(" by Jingqing Zhang, Yao Zhao, Mohammad Saleh and Peter J. Liu on Dec 18, 2019."),I=l(),me=n("p"),de=r("According to the abstract,"),ze=l(),te=n("ul"),V=n("li"),Ue=r(`Pegasus\u2019 pretraining task is intentionally similar to summarization: important sentences are removed/masked from an
input document and are generated together as one output sequence from the remaining sentences, similar to an
extractive summary.`),Be=l(),B=n("li"),We=r("Pegasus achieves SOTA summarization performance on all 12 downstream tasks, as measured by ROUGE and human eval."),oe=l(),R=n("p"),x=r("This model was contributed by "),q=n("a"),ve=r("sshleifer"),at=r(". The Authors\u2019 code can be found "),ye=n("a"),Q=r("here"),rt=r("."),Je=l(),le=n("h2"),G=n("a"),J=n("span"),v(Te.$$.fragment),it=l(),X=n("span"),dt=r("Checkpoints"),Xe=l(),H=n("p"),lt=r("All the "),Bo=n("a"),Zd=r("checkpoints"),Yd=r(` are fine-tuned for summarization, besides
`),la=n("em"),el=r("pegasus-large"),tl=r(", whence the other checkpoints are fine-tuned:"),zi=l(),fe=n("ul"),ca=n("li"),ol=r("Each checkpoint is 2.2 GB on disk and 568M parameters."),nl=l(),ua=n("li"),sl=r("FP16 is not supported (help/ideas on this appreciated!)."),al=l(),pa=n("li"),rl=r("Summarizing xsum in fp32 takes about 400ms/sample, with default parameters on a v100 GPU."),il=l(),Wo=n("li"),dl=r("Full replication results and correctly pre-processed data can be found in this "),Ro=n("a"),ll=r("Issue"),cl=r("."),ul=l(),At=n("li"),Ho=n("a"),pl=r("Distilled checkpoints"),hl=r(" are described in this "),Ko=n("a"),ml=r("paper"),fl=r("."),Fi=l(),ct=n("h3"),It=n("a"),ha=n("span"),v(Vo.$$.fragment),gl=l(),ma=n("span"),_l=r("Examples"),qi=l(),Ze=n("ul"),Gt=n("li"),Qo=n("a"),kl=r("Script"),bl=r(` to fine-tune pegasus
on the XSUM dataset. Data download instructions at `),Jo=n("a"),vl=r("examples/pytorch/summarization/"),yl=r("."),Tl=l(),fa=n("li"),wl=r("FP16 is not supported (help/ideas on this appreciated!)."),Pl=l(),ga=n("li"),$l=r("The adafactor optimizer is recommended for pegasus fine-tuning."),Ei=l(),ut=n("h2"),Lt=n("a"),_a=n("span"),v(Xo.$$.fragment),xl=l(),ka=n("span"),zl=r("Implementation Notes"),Mi=l(),ge=n("ul"),ba=n("li"),va=n("p"),Fl=r("All models are transformer encoder-decoders with 16 layers in each component."),ql=l(),ya=n("li"),Es=n("p"),El=r("The implementation is completely inherited from "),Ms=n("a"),Ml=r("BartForConditionalGeneration"),Cl=l(),Zo=n("li"),Ta=n("p"),jl=r("Some key configuration differences:"),Sl=l(),pt=n("ul"),wa=n("li"),Ol=r("static, sinusoidal position embeddings"),Al=l(),Pa=n("li"),Il=r("the model starts generating with pad_token_id (which has 0 token_embedding) as the prefix."),Gl=l(),Yo=n("li"),Ll=r("more beams are used ("),$a=n("code"),Nl=r("num_beams=8"),Dl=r(")"),Ul=l(),xa=n("li"),Re=n("p"),Bl=r("All pretrained pegasus checkpoints are the same besides three attributes: "),za=n("code"),Wl=r("tokenizer.model_max_length"),Rl=r(` (maximum
...
found in `),Ma=n("code"),ec=r("convert_pegasus_tf_to_pytorch.py"),tc=r("."),Ci=l(),mt=n("h2"),Nt=n("a"),Ca=n("span"),v(tn.$$.fragment),oc=l(),ja=n("span"),nc=r("Usage Example"),ji=l(),v(on.$$.fragment),Si=l(),ft=n("h2"),Dt=n("a"),Sa=n("span"),v(nn.$$.fragment),sc=l(),Oa=n("span"),ac=r("PegasusConfig"),Oi=l(),we=n("div"),v(sn.$$.fragment),rc=l(),gt=n("p"),ic=r("This is the configuration class to store the configuration of a "),Cs=n("a"),dc=r("PegasusModel"),lc=r(`. It is used to instantiate an
...
documentation from `),Ss=n("a"),gc=r("PretrainedConfig"),_c=r(" for more information."),kc=l(),v(Ut.$$.fragment),Ai=l(),kt=n("h2"),Bt=n("a"),Aa=n("span"),v(rn.$$.fragment),bc=l(),Ia=n("span"),vc=r("PegasusTokenizer"),Ii=l(),Wt=n("p"),yc=r("warning: "),Ga=n("code"),Tc=r("add_tokens"),wc=r(" does not work at the moment."),Gi=l(),W=n("div"),v(dn.$$.fragment),Pc=l(),ln=n("p"),$c=r("Construct a PEGASUS tokenizer. Based on "),cn=n("a"),xc=r("SentencePiece"),zc=r("."),Fc=l(),un=n("p"),qc=r("This tokenizer inherits from "),Os=n("a"),Ec=r("PreTrainedTokenizer"),Mc=r(` which contains most of the main methods. Users should refer to
this superclass for more information regarding those methods.`),Cc=l(),Fe=n("div"),v(pn.$$.fragment),jc=l(),hn=n("p"),Sc=r(`Build model inputs from a sequence or a pair of sequences for sequence classification tasks by concatenating
...
separator.`),Hc=l(),Rt=n("div"),v(gn.$$.fragment),Kc=l(),Ba=n("p"),Vc=r("Converts a sequence of tokens (string) in a single string."),Qc=l(),Ht=n("div"),v(_n.$$.fragment),Jc=l(),Wa=n("p"),Xc=r("Get list where entries are [1] if a token is [eos] or [pad] else 0."),Zc=l(),Kt=n("div"),v(kn.$$.fragment),Yc=l(),Ra=n("p"),eu=r("Just EOS"),Li=l(),bt=n("h2"),Vt=n("a"),Ha=n("span"),v(bn.$$.fragment),tu=l(),Ka=n("span"),ou=r("PegasusTokenizerFast"),Ni=l(),ce=n("div"),v(vn.$$.fragment),nu=l(),vt=n("p"),su=r("Construct a \u201Cfast\u201D PEGASUS tokenizer (backed by HuggingFace\u2019s "),Va=n("em"),au=r("tokenizers"),ru=r(` library). Based on
...
refer to this superclass for more information regarding those methods.`),hu=l(),Ye=n("div"),v(wn.$$.fragment),mu=l(),Qa=n("p"),fu=r("Build model inputs from a sequence by adding eos to the end. no bos token is added to the front."),gu=l(),Pn=n("ul"),Gs=n("li"),_u=r("single sequence: "),Ja=n("code"),ku=r("X </s>"),bu=l(),$n=n("li"),vu=r("pair of sequences: "),Xa=n("code"),yu=r("A B </s>"),Tu=r(" (not intended use)"),wu=l(),Qt=n("div"),v(xn.$$.fragment),Pu=l(),Za=n("p"),$u=r("Get list where entries are [1] if a token is [eos] or [pad] else 0."),Di=l(),yt=n("h2"),Jt=n("a"),Ya=n("span"),v(zn.$$.fragment),xu=l(),er=n("span"),zu=r("PegasusModel"),Ui=l(),Pe=n("div"),v(Fn.$$.fragment),Fu=l(),qn=n("p"),qu=r(`The bare PEGASUS Model outputting raw hidden-states without any specific head on top.
...
and behavior.`),Au=l(),qe=n("div"),v(Cn.$$.fragment),Iu=l(),Tt=n("p"),Gu=r("The "),Ns=n("a"),Lu=r("PegasusModel"),Nu=r(" forward method, overrides the "),tr=n("code"),Du=r("__call__"),Uu=r(" special method."),Bu=l(),v(Xt.$$.fragment),Wu=l(),v(Zt.$$.fragment),Bi=l(),wt=n("h2"),Yt=n("a"),or=n("span"),v(jn.$$.fragment),Ru=l(),nr=n("span"),Hu=r("PegasusForConditionalGeneration"),Wi=l(),$e=n("div"),v(Sn.$$.fragment),Ku=l(),On=n("p"),Vu=r(`The PEGASUS Model with a language modeling head. Can be used for summarization.
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),tp=l(),Ee=n("div"),v(Gn.$$.fragment),op=l(),Pt=n("p"),np=r("The "),Us=n("a"),sp=r("PegasusForConditionalGeneration"),ap=r(" forward method, overrides the "),sr=n("code"),rp=r("__call__"),ip=r(" special method."),dp=l(),v(eo.$$.fragment),lp=l(),v(to.$$.fragment),Ri=l(),$t=n("h2"),oo=n("a"),ar=n("span"),v(Ln.$$.fragment),cp=l(),rr=n("span"),up=r("PegasusForCausalLM"),Hi=l(),xt=n("div"),v(Nn.$$.fragment),pp=l(),no=n("div"),v(Dn.$$.fragment),hp=l(),v(so.$$.fragment),Ki=l(),zt=n("h2"),ao=n("a"),ir=n("span"),v(Un.$$.fragment),mp=l(),dr=n("span"),fp=r("TFPegasusModel"),Vi=l(),ue=n("div"),v(Bn.$$.fragment),gp=l(),Wn=n("p"),_p=r(`The bare PEGASUS Model outputting raw hidden-states without any specific head on top.
This model inherits from `),Bs=n("a"),kp=r("TFPreTrainedModel"),bp=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),vp=l(),Rn=n("p"),yp=r("This model is also a "),Hn=n("a"),Tp=r("tf.keras.Model"),wp=r(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Pp=l(),v(ro.$$.fragment),$p=l(),Me=n("div"),v(Kn.$$.fragment),xp=l(),Ft=n("p"),zp=r("The "),Ws=n("a"),Fp=r("TFPegasusModel"),qp=r(" forward method, overrides the "),lr=n("code"),Ep=r("__call__"),Mp=r(" special method."),Cp=l(),v(io.$$.fragment),jp=l(),v(lo.$$.fragment),Qi=l(),qt=n("h2"),co=n("a"),cr=n("span"),v(Vn.$$.fragment),Sp=l(),ur=n("span"),Op=r("TFPegasusForConditionalGeneration"),Ji=l(),pe=n("div"),v(Qn.$$.fragment),Ap=l(),Jn=n("p"),Ip=r(`The PEGASUS Model with a language modeling head. Can be used for summarization.
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Np=l(),Xn=n("p"),Dp=r("This model is also a "),Zn=n("a"),Up=r("tf.keras.Model"),Bp=r(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Wp=l(),v(uo.$$.fragment),Rp=l(),Ce=n("div"),v(Yn.$$.fragment),Hp=l(),Et=n("p"),Kp=r("The "),Hs=n("a"),Vp=r("TFPegasusForConditionalGeneration"),Qp=r(" forward method, overrides the "),pr=n("code"),Jp=r("__call__"),Xp=r(" special method."),Zp=l(),v(po.$$.fragment),Yp=l(),v(ho.$$.fragment),Xi=l(),Mt=n("h2"),mo=n("a"),hr=n("span"),v(es.$$.fragment),eh=l(),mr=n("span"),th=r("FlaxPegasusModel"),Zi=l(),L=n("div"),v(ts.$$.fragment),oh=l(),os=n("p"),nh=r(`The bare Pegasus Model transformer outputting raw hidden-states without any specific head on top.
...
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),ch=l(),fr=n("p"),uh=r("Finally, this model supports inherent JAX features such as:"),ph=l(),He=n("ul"),gr=n("li"),as=n("a"),hh=r("Just-In-Time (JIT) compilation"),mh=l(),_r=n("li"),rs=n("a"),fh=r("Automatic Differentiation"),gh=l(),kr=n("li"),is=n("a"),_h=r("Vectorization"),kh=l(),br=n("li"),ds=n("a"),bh=r("Parallelization"),vh=l(),je=n("div"),v(ls.$$.fragment),yh=l(),Ct=n("p"),Th=r("The "),vr=n("code"),wh=r("FlaxPegasusPreTrainedModel"),Ph=r(" forward method, overrides the "),yr=n("code"),$h=r("__call__"),xh=r(" special method."),zh=l(),v(fo.$$.fragment),Fh=l(),v(go.$$.fragment),qh=l(),_o=n("div"),v(cs.$$.fragment),Eh=l(),v(ko.$$.fragment),Mh=l(),bo=n("div"),v(us.$$.fragment),Ch=l(),v(vo.$$.fragment),Yi=l(),jt=n("h2"),yo=n("a"),Tr=n("span"),v(ps.$$.fragment),jh=l(),wr=n("span"),Sh=r("FlaxPegasusForConditionalGeneration"),ed=l(),N=n("div"),v(hs.$$.fragment),Oh=l(),ms=n("p"),Ah=r(`The PEGASUS Model with a language modeling head. Can be used for summarization.
...
tokenizer([ARTICLE_TO_SUMMARIZE], max_length=1024, return_tensors=\u2018np\u2019)`),fm=l(),Wr=n("blockquote"),Rr=n("blockquote"),Ts=n("blockquote"),wo=n("h1"),Po=n("a"),Hr=n("span"),v(ws.$$.fragment),gm=l(),Kr=n("span"),_m=r("Generate Summary >>> summary_ids = model.generate(inputs[\u2018input_ids\u2019]).sequences >>>"),km=l(),Vr=n("p"),bm=r("print(tokenizer.batch_decode(summary_ids, skip_special_tokens=True, clean_up_tokenization_spaces=False))"),vm=l(),Qr=n("p"),ym=r("Mask filling example:"),Tm=l(),Jr=n("blockquote"),Xr=n("blockquote"),Zr=n("blockquote"),Yr=n("p"),wm=r(`from transformers import PegasusTokenizer, FlaxPegasusForConditionalGeneration >>> tokenizer =
...
documentation from `),Ss=s(ea,"A",{href:!0});var Ef=a(Ss);gc=i(Ef,"PretrainedConfig"),Ef.forEach(t),_c=i(ea," for more information."),ea.forEach(t),kc=c(Mo),y(Ut.$$.fragment,Mo),Mo.forEach(t),Ai=c(o),kt=s(o,"H2",{class:!0});var cd=a(kt);Bt=s(cd,"A",{id:!0,class:!0,href:!0});var Mf=a(Bt);Aa=s(Mf,"SPAN",{});var Cf=a(Aa);y(rn.$$.fragment,Cf),Cf.forEach(t),Mf.forEach(t),bc=c(cd),Ia=s(cd,"SPAN",{});var jf=a(Ia);vc=i(jf,"PegasusTokenizer"),jf.forEach(t),cd.forEach(t),Ii=c(o),Wt=s(o,"P",{});var ud=a(Wt);yc=i(ud,"warning: "),Ga=s(ud,"CODE",{});var Sf=a(Ga);Tc=i(Sf,"add_tokens"),Sf.forEach(t),wc=i(ud," does not work at the moment."),ud.forEach(t),Gi=c(o),W=s(o,"DIV",{class:!0});var _e=a(W);y(dn.$$.fragment,_e),Pc=c(_e),ln=s(_e,"P",{});var pd=a(ln);$c=i(pd,"Construct a PEGASUS tokenizer. Based on "),cn=s(pd,"A",{href:!0,rel:!0});var Of=a(cn);xc=i(Of,"SentencePiece"),Of.forEach(t),zc=i(pd,"."),pd.forEach(t),Fc=c(_e),un=s(_e,"P",{});var hd=a(un);qc=i(hd,"This tokenizer inherits from "),Os=s(hd,"A",{href:!0});var Af=a(Os);Ec=i(Af,"PreTrainedTokenizer"),Af.forEach(t),Mc=i(hd,` which contains most of the main methods. Users should refer to
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),zd.forEach(t),Au=c(jo),qe=s(jo,"DIV",{class:!0});var So=a(qe);y(Cn.$$.fragment,So),Iu=c(So),Tt=s(So,"P",{});var na=a(Tt);Gu=i(na,"The "),Ns=s(na,"A",{href:!0});var ag=a(Ns);Lu=i(ag,"PegasusModel"),ag.forEach(t),Nu=i(na," forward method, overrides the "),tr=s(na,"CODE",{});var rg=a(tr);Du=i(rg,"__call__"),rg.forEach(t),Uu=i(na," special method."),na.forEach(t),Bu=c(So),y(Xt.$$.fragment,So),Wu=c(So),y(Zt.$$.fragment,So),So.forEach(t),jo.forEach(t),Bi=c(o),wt=s(o,"H2",{class:!0});var Fd=a(wt);Yt=s(Fd,"A",{id:!0,class:!0,href:!0});var ig=a(Yt);or=s(ig,"SPAN",{});var dg=a(or);y(jn.$$.fragment,dg),dg.forEach(t),ig.forEach(t),Ru=c(Fd),nr=s(Fd,"SPAN",{});var lg=a(nr);Hu=i(lg,"PegasusForConditionalGeneration"),lg.forEach(t),Fd.forEach(t),Wi=c(o),$e=s(o,"DIV",{class:!0});var Oo=a($e);y(Sn.$$.fragment,Oo),Ku=c(Oo),On=s(Oo,"P",{});var qd=a(On);Vu=i(qd,`The PEGASUS Model with a language modeling head. Can be used for summarization.
...
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),Kd.forEach(t),Bh=c(se),Pr=s(se,"P",{});var Zg=a(Pr);Wh=i(Zg,"Finally, this model supports inherent JAX features such as:"),Zg.forEach(t),Rh=c(se),Ke=s(se,"UL",{});var Do=a(Ke);$r=s(Do,"LI",{});var Yg=a($r);_s=s(Yg,"A",{href:!0,rel:!0});var e_=a(_s);Hh=i(e_,"Just-In-Time (JIT) compilation"),e_.forEach(t),Yg.forEach(t),Kh=c(Do),xr=s(Do,"LI",{});var t_=a(xr);ks=s(t_,"A",{href:!0,rel:!0});var o_=a(ks);Vh=i(o_,"Automatic Differentiation"),o_.forEach(t),t_.forEach(t),Qh=c(Do),zr=s(Do,"LI",{});var n_=a(zr);bs=s(n_,"A",{href:!0,rel:!0});var s_=a(bs);Jh=i(s_,"Vectorization"),s_.forEach(t),n_.forEach(t),Xh=c(Do),Fr=s(Do,"LI",{});var a_=a(Fr);vs=s(a_,"A",{href:!0,rel:!0});var r_=a(vs);Zh=i(r_,"Parallelization"),r_.forEach(t),a_.forEach(t),Do.forEach(t),Yh=c(se),M=s(se,"DIV",{class:!0});var j=a(M);y(ys.$$.fragment,j),em=c(j),St=s(j,"P",{});var da=a(St);tm=i(da,"The "),qr=s(da,"CODE",{});var i_=a(qr);om=i(i_,"FlaxPegasusPreTrainedModel"),i_.forEach(t),nm=i(da," forward method, overrides the "),Er=s(da,"CODE",{});var d_=a(Er);sm=i(d_,"__call__"),d_.forEach(t),am=i(da," special method."),da.forEach(t),rm=c(j),y(To.$$.fragment,j),im=c(j),Mr=s(j,"P",{});var l_=a(Mr);dm=i(l_,"Summarization example:"),l_.forEach(t),lm=c(j),Cr=s(j,"BLOCKQUOTE",{});var c_=a(Cr);jr=s(c_,"BLOCKQUOTE",{});var u_=a(jr);Sr=s(u_,"BLOCKQUOTE",{});var p_=a(Sr);Or=s(p_,"P",{});var h_=a(Or);cm=i(h_,"from transformers import PegasusTokenizer, FlaxPegasusForConditionalGeneration"),h_.forEach(t),p_.forEach(t),u_.forEach(t),c_.forEach(t),um=c(j),Ar=s(j,"BLOCKQUOTE",{});var m_=a(Ar);Ir=s(m_,"BLOCKQUOTE",{});var f_=a(Ir);Gr=s(f_,"BLOCKQUOTE",{});var g_=a(Gr);Lr=s(g_,"P",{});var __=a(Lr);pm=i(__,`model = FlaxPegasusForConditionalGeneration.from_pretrained(\u2018google/pegasus-large\u2019) >>> tokenizer =
PegasusTokenizer.from_pretrained(\u2018google/pegasus-large\u2019)`),__.forEach(t),g_.forEach(t),f_.forEach(t),m_.forEach(t),hm=c(j),Nr=s(j,"BLOCKQUOTE",{});var k_=a(Nr);Dr=s(k_,"BLOCKQUOTE",{});var b_=a(Dr);Ur=s(b_,"BLOCKQUOTE",{});var v_=a(Ur);Br=s(v_,"P",{});var y_=a(Br);mm=i(y_,`ARTICLE_TO_SUMMARIZE = \u201CMy friends are cool but they eat too many carbs.\u201D >>> inputs =
tokenizer([ARTICLE_TO_SUMMARIZE], max_length=1024, return_tensors=\u2018np\u2019)`),y_.forEach(t),v_.forEach(t),b_.forEach(t),k_.forEach(t),fm=c(j),Wr=s(j,"BLOCKQUOTE",{});var T_=a(Wr);Rr=s(T_,"BLOCKQUOTE",{});var w_=a(Rr);Ts=s(w_,"BLOCKQUOTE",{});var Vd=a(Ts);wo=s(Vd,"H1",{class:!0});var Qd=a(wo);Po=s(Qd,"A",{id:!0,class:!0,href:!0});var P_=a(Po);Hr=s(P_,"SPAN",{});var $_=a(Hr);y(ws.$$.fragment,$_),$_.forEach(t),P_.forEach(t),gm=c(Qd),Kr=s(Qd,"SPAN",{});var x_=a(Kr);_m=i(x_,"Generate Summary >>> summary_ids = model.generate(inputs[\u2018input_ids\u2019]).sequences >>>"),x_.forEach(t),Qd.forEach(t),km=c(Vd),Vr=s(Vd,"P",{});var z_=a(Vr);bm=i(z_,"print(tokenizer.batch_decode(summary_ids, skip_special_tokens=True, clean_up_tokenization_spaces=False))"),z_.forEach(t),Vd.forEach(t),w_.forEach(t),T_.forEach(t),vm=c(j),Qr=s(j,"P",{});var F_=a(Qr);ym=i(F_,"Mask filling example:"),F_.forEach(t),Tm=c(j),Jr=s(j,"BLOCKQUOTE",{});var q_=a(Jr);Xr=s(q_,"BLOCKQUOTE",{});var E_=a(Xr);Zr=s(E_,"BLOCKQUOTE",{});var M_=a(Zr);Yr=s(M_,"P",{});var C_=a(Yr);wm=i(C_,`from transformers import PegasusTokenizer, FlaxPegasusForConditionalGeneration >>> tokenizer =
PegasusTokenizer.from_pretrained(\u2018google/pegasus-large\u2019) >>> TXT = \u201CMy friends are <mask> but they eat too many
