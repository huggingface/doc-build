...
extractive summary.`),We=l(),W=n("li"),Be=r("Pegasus achieves SOTA summarization performance on all 12 downstream tasks, as measured by ROUGE and human eval."),oe=l(),R=n("p"),x=r("This model was contributed by "),q=n("a"),ve=r("sshleifer"),at=r(". The Authors\u2019 code can be found "),ye=n("a"),Q=r("here"),rt=r("."),Je=l(),le=n("h2"),G=n("a"),J=n("span"),v(Te.$$.fragment),it=l(),X=n("span"),dt=r("Checkpoints"),Xe=l(),H=n("p"),lt=r("All the "),Wo=n("a"),Zd=r("checkpoints"),Yd=r(` are fine-tuned for summarization, besides
...
documentation from `),Ss=n("a"),gc=r("PretrainedConfig"),_c=r(" for more information."),kc=l(),v(Ut.$$.fragment),Ai=l(),kt=n("h2"),Wt=n("a"),Aa=n("span"),v(rn.$$.fragment),bc=l(),Ia=n("span"),vc=r("PegasusTokenizer"),Ii=l(),Bt=n("p"),yc=r("warning: "),Ga=n("code"),Tc=r("add_tokens"),wc=r(" does not work at the moment."),Gi=l(),B=n("div"),v(dn.$$.fragment),Pc=l(),ln=n("p"),$c=r("Construct a PEGASUS tokenizer. Based on "),cn=n("a"),xc=r("SentencePiece"),zc=r("."),Fc=l(),un=n("p"),qc=r("This tokenizer inherits from "),Os=n("a"),Ec=r("PreTrainedTokenizer"),Mc=r(` which contains most of the main methods. Users should refer to
...
separator.`),Hc=l(),Rt=n("div"),v(gn.$$.fragment),Kc=l(),Wa=n("p"),Vc=r("Converts a sequence of tokens (string) in a single string."),Qc=l(),Ht=n("div"),v(_n.$$.fragment),Jc=l(),Ba=n("p"),Xc=r("Get list where entries are [1] if a token is [eos] or [pad] else 0."),Zc=l(),Kt=n("div"),v(kn.$$.fragment),Yc=l(),Ra=n("p"),eu=r("Just EOS"),Li=l(),bt=n("h2"),Vt=n("a"),Ha=n("span"),v(bn.$$.fragment),tu=l(),Ka=n("span"),ou=r("PegasusTokenizerFast"),Ni=l(),ce=n("div"),v(vn.$$.fragment),nu=l(),vt=n("p"),su=r("Construct a \u201Cfast\u201D PEGASUS tokenizer (backed by HuggingFace\u2019s "),Va=n("em"),au=r("tokenizers"),ru=r(` library). Based on
...
and behavior.`),Au=l(),qe=n("div"),v(Cn.$$.fragment),Iu=l(),Tt=n("p"),Gu=r("The "),Ns=n("a"),Lu=r("PegasusModel"),Nu=r(" forward method, overrides the "),tr=n("code"),Du=r("__call__"),Uu=r(" special method."),Wu=l(),v(Xt.$$.fragment),Bu=l(),v(Zt.$$.fragment),Wi=l(),wt=n("h2"),Yt=n("a"),or=n("span"),v(jn.$$.fragment),Ru=l(),nr=n("span"),Hu=r("PegasusForConditionalGeneration"),Bi=l(),$e=n("div"),v(Sn.$$.fragment),Ku=l(),On=n("p"),Vu=r(`The PEGASUS Model with a language modeling head. Can be used for summarization.
...
tokenizer([ARTICLE_TO_SUMMARIZE], max_length=1024, return_tensors=\u2018np\u2019)`),fm=l(),Br=n("blockquote"),Rr=n("blockquote"),Ts=n("blockquote"),wo=n("h1"),Po=n("a"),Hr=n("span"),v(ws.$$.fragment),gm=l(),Kr=n("span"),_m=r("Generate Summary >>> summary_ids = model.generate(inputs[\u2018input_ids\u2019]).sequences >>>"),km=l(),Vr=n("p"),bm=r("print(tokenizer.batch_decode(summary_ids, skip_special_tokens=True, clean_up_tokenization_spaces=False))"),vm=l(),Qr=n("p"),ym=r("Mask filling example:"),Tm=l(),Jr=n("blockquote"),Xr=n("blockquote"),Zr=n("blockquote"),Yr=n("p"),wm=r(`from transformers import PegasusTokenizer, FlaxPegasusForConditionalGeneration >>> tokenizer =
...
This model inherits from `),Ws=s(Od,"A",{href:!0});var vg=a(Ws);kp=i(vg,"TFPreTrainedModel"),vg.forEach(t),bp=i(Od,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
PegasusTokenizer.from_pretrained(\u2018google/pegasus-large\u2019)`),__.forEach(t),g_.forEach(t),f_.forEach(t),m_.forEach(t),hm=c(j),Nr=s(j,"BLOCKQUOTE",{});var k_=a(Nr);Dr=s(k_,"BLOCKQUOTE",{});var b_=a(Dr);Ur=s(b_,"BLOCKQUOTE",{});var v_=a(Ur);Wr=s(v_,"P",{});var y_=a(Wr);mm=i(y_,`ARTICLE_TO_SUMMARIZE = \u201CMy friends are cool but they eat too many carbs.\u201D >>> inputs =
tokenizer([ARTICLE_TO_SUMMARIZE], max_length=1024, return_tensors=\u2018np\u2019)`),y_.forEach(t),v_.forEach(t),b_.forEach(t),k_.forEach(t),fm=c(j),Br=s(j,"BLOCKQUOTE",{});var T_=a(Br);Rr=s(T_,"BLOCKQUOTE",{});var w_=a(Rr);Ts=s(w_,"BLOCKQUOTE",{});var Vd=a(Ts);wo=s(Vd,"H1",{class:!0});var Qd=a(wo);Po=s(Qd,"A",{id:!0,class:!0,href:!0});var P_=a(Po);Hr=s(P_,"SPAN",{});var $_=a(Hr);y(ws.$$.fragment,$_),$_.forEach(t),P_.forEach(t),gm=c(Qd),Kr=s(Qd,"SPAN",{});var x_=a(Kr);_m=i(x_,"Generate Summary >>> summary_ids = model.generate(inputs[\u2018input_ids\u2019]).sequences >>>"),x_.forEach(t),Qd.forEach(t),km=c(Vd),Vr=s(Vd,"P",{});var z_=a(Vr);bm=i(z_,"print(tokenizer.batch_decode(summary_ids, skip_special_tokens=True, clean_up_tokenization_spaces=False))"),z_.forEach(t),Vd.forEach(t),w_.forEach(t),T_.forEach(t),vm=c(j),Qr=s(j,"P",{});var F_=a(Qr);ym=i(F_,"Mask filling example:"),F_.forEach(t),Tm=c(j),Jr=s(j,"BLOCKQUOTE",{});var q_=a(Jr);Xr=s(q_,"BLOCKQUOTE",{});var E_=a(Xr);Zr=s(E_,"BLOCKQUOTE",{});var M_=a(Zr);Yr=s(M_,"P",{});var C_=a(Yr);wm=i(C_,`from transformers import PegasusTokenizer, FlaxPegasusForConditionalGeneration >>> tokenizer =
PegasusTokenizer.from_pretrained(\u2018google/pegasus-large\u2019) >>> TXT = \u201CMy friends are <mask> but they eat too many
