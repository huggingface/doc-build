import{S as K_,i as R_,s as H_,e as n,k as l,w as b,t as r,M as V_,c as s,d as t,m as c,a,x as v,h as i,b as p,G as e,g as f,y as T,q as w,o as P,B as $,v as Q_,L as ht}from"../../chunks/vendor-hf-doc-builder.js";import{T as dn}from"../../chunks/Tip-hf-doc-builder.js";import{D as j}from"../../chunks/Docstring-hf-doc-builder.js";import{C as Ve}from"../../chunks/CodeBlock-hf-doc-builder.js";import{I as Y}from"../../chunks/IconCopyLink-hf-doc-builder.js";import{E as ut}from"../../chunks/ExampleCodeBlock-hf-doc-builder.js";function J_(z){let u,y,_,m,k;return m=new Ve({props:{code:`from transformers import PegasusConfig, PegasusModel
...
<span class="hljs-meta">&gt;&gt;&gt; </span>configuration = model.config`}}),{c(){u=n("p"),y=r("Example:"),_=l(),b(m.$$.fragment)},l(d){u=s(d,"P",{});var h=a(u);y=i(h,"Example:"),h.forEach(t),_=c(d),v(m.$$.fragment,d)},m(d,h){f(d,u,h),e(u,y),f(d,_,h),T(m,d,h),k=!0},p:ht,i(d){k||(w(m.$$.fragment,d),k=!0)},o(d){P(m.$$.fragment,d),k=!1},d(d){d&&t(u),d&&t(_),$(m,d)}}}function X_(z){let u,y,_,m,k;return{c(){u=n("p"),y=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),_=n("code"),m=r("Module"),k=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(d){u=s(d,"P",{});var h=a(u);y=i(h,"Although the recipe for forward pass needs to be defined within this function, one should call the "),_=s(h,"CODE",{});var E=a(_);m=i(E,"Module"),E.forEach(t),k=i(h,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),h.forEach(t)},m(d,h){f(d,u,h),e(u,y),e(u,_),e(_,m),e(u,k)},d(d){d&&t(u)}}}function Z_(z){let u,y,_,m,k;return m=new Ve({props:{code:`from transformers import PegasusTokenizer, PegasusModel
...
[<span class="hljs-number">1</span>, <span class="hljs-number">4</span>, <span class="hljs-number">1024</span>]`}}),{c(){u=n("p"),y=r("Example:"),_=l(),b(m.$$.fragment)},l(d){u=s(d,"P",{});var h=a(u);y=i(h,"Example:"),h.forEach(t),_=c(d),v(m.$$.fragment,d)},m(d,h){f(d,u,h),e(u,y),f(d,_,h),T(m,d,h),k=!0},p:ht,i(d){k||(w(m.$$.fragment,d),k=!0)},o(d){P(m.$$.fragment,d),k=!1},d(d){d&&t(u),d&&t(_),$(m,d)}}}function Y_(z){let u,y,_,m,k;return{c(){u=n("p"),y=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),_=n("code"),m=r("Module"),k=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(d){u=s(d,"P",{});var h=a(u);y=i(h,"Although the recipe for forward pass needs to be defined within this function, one should call the "),_=s(h,"CODE",{});var E=a(_);m=i(E,"Module"),E.forEach(t),k=i(h,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),h.forEach(t)},m(d,h){f(d,u,h),e(u,y),e(u,_),e(_,m),e(u,k)},d(d){d&&t(u)}}}function ek(z){let u,y,_,m,k;return m=new Ve({props:{code:`from transformers import PegasusTokenizer, PegasusForConditionalGeneration
...
<span class="hljs-string">&quot;California&#x27;s largest electricity provider has turned off power to hundreds of thousands of customers.&quot;</span>`}}),{c(){u=n("p"),y=r("Summarization example:"),_=l(),b(m.$$.fragment)},l(d){u=s(d,"P",{});var h=a(u);y=i(h,"Summarization example:"),h.forEach(t),_=c(d),v(m.$$.fragment,d)},m(d,h){f(d,u,h),e(u,y),f(d,_,h),T(m,d,h),k=!0},p:ht,i(d){k||(w(m.$$.fragment,d),k=!0)},o(d){P(m.$$.fragment,d),k=!1},d(d){d&&t(u),d&&t(_),$(m,d)}}}function tk(z){let u,y,_,m,k;return m=new Ve({props:{code:`from transformers import PegasusTokenizer, PegasusForCausalLM
...
<span class="hljs-literal">True</span>`}}),{c(){u=n("p"),y=r("Example:"),_=l(),b(m.$$.fragment)},l(d){u=s(d,"P",{});var h=a(u);y=i(h,"Example:"),h.forEach(t),_=c(d),v(m.$$.fragment,d)},m(d,h){f(d,u,h),e(u,y),f(d,_,h),T(m,d,h),k=!0},p:ht,i(d){k||(w(m.$$.fragment,d),k=!0)},o(d){P(m.$$.fragment,d),k=!1},d(d){d&&t(u),d&&t(_),$(m,d)}}}function ok(z){let u,y,_,m,k,d,h,E,Qe,Ne,L,Pe,$e,q,ie,de,Je,Le,G,ee,xe,K,Xe,ze,le,Ge,te,ce,pe,Ze,Fe,S,A,Ye,oe,ne,qe,ue,et,Ee,D,De,N,tt,he,me,ot,fe,Q,nt,se,J,V,I,ge,R,Me,st;return{c(){u=n("p"),y=r("TensorFlow models and layers in "),_=n("code"),m=r("transformers"),k=r(" accept two formats as input:"),d=l(),h=n("ul"),E=n("li"),Qe=r("having all inputs as keyword arguments (like PyTorch models), or"),Ne=l(),L=n("li"),Pe=r("having all inputs as a list, tuple or dict in the first positional argument."),$e=l(),q=n("p"),ie=r(`The reason the second format is supported is that Keras methods prefer this format when passing inputs to models
...
about any of this, as you can just pass inputs like you would to any other Python function!`),je.forEach(t),this.h()},h(){p(R,"href","https://keras.io/guides/making_new_layers_and_models_via_subclassing/"),p(R,"rel","nofollow")},m(x,F){f(x,u,F),e(u,y),e(u,_),e(_,m),e(u,k),f(x,d,F),f(x,h,F),e(h,E),e(E,Qe),e(h,Ne),e(h,L),e(L,Pe),f(x,$e,F),f(x,q,F),e(q,ie),e(q,de),e(de,Je),e(q,Le),e(q,G),e(G,ee),e(q,xe),e(q,K),e(K,Xe),e(q,ze),e(q,le),e(le,Ge),e(q,te),e(q,ce),e(ce,pe),e(q,Ze),f(x,Fe,F),f(x,S,F),e(S,A),e(A,Ye),e(A,oe),e(oe,ne),e(A,qe),e(A,ue),e(ue,et),e(S,Ee),e(S,D),e(D,De),e(D,N),e(N,tt),e(D,he),e(D,me),e(me,ot),e(S,fe),e(S,Q),e(Q,nt),e(Q,se),e(se,J),f(x,V,F),f(x,I,F),e(I,ge),e(I,R),e(R,Me),e(I,st)},d(x){x&&t(u),x&&t(d),x&&t(h),x&&t($e),x&&t(q),x&&t(Fe),x&&t(S),x&&t(V),x&&t(I)}}}function nk(z){let u,y,_,m,k;return{c(){u=n("p"),y=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),_=n("code"),m=r("Module"),k=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(d){u=s(d,"P",{});var h=a(u);y=i(h,"Although the recipe for forward pass needs to be defined within this function, one should call the "),_=s(h,"CODE",{});var E=a(_);m=i(E,"Module"),E.forEach(t),k=i(h,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),h.forEach(t)},m(d,h){f(d,u,h),e(u,y),e(u,_),e(_,m),e(u,k)},d(d){d&&t(u)}}}function sk(z){let u,y,_,m,k;return m=new Ve({props:{code:`from transformers import PegasusTokenizer, TFPegasusModel
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),{c(){u=n("p"),y=r("Example:"),_=l(),b(m.$$.fragment)},l(d){u=s(d,"P",{});var h=a(u);y=i(h,"Example:"),h.forEach(t),_=c(d),v(m.$$.fragment,d)},m(d,h){f(d,u,h),e(u,y),f(d,_,h),T(m,d,h),k=!0},p:ht,i(d){k||(w(m.$$.fragment,d),k=!0)},o(d){P(m.$$.fragment,d),k=!1},d(d){d&&t(u),d&&t(_),$(m,d)}}}function ak(z){let u,y,_,m,k,d,h,E,Qe,Ne,L,Pe,$e,q,ie,de,Je,Le,G,ee,xe,K,Xe,ze,le,Ge,te,ce,pe,Ze,Fe,S,A,Ye,oe,ne,qe,ue,et,Ee,D,De,N,tt,he,me,ot,fe,Q,nt,se,J,V,I,ge,R,Me,st;return{c(){u=n("p"),y=r("TensorFlow models and layers in "),_=n("code"),m=r("transformers"),k=r(" accept two formats as input:"),d=l(),h=n("ul"),E=n("li"),Qe=r("having all inputs as keyword arguments (like PyTorch models), or"),Ne=l(),L=n("li"),Pe=r("having all inputs as a list, tuple or dict in the first positional argument."),$e=l(),q=n("p"),ie=r(`The reason the second format is supported is that Keras methods prefer this format when passing inputs to models
and layers. Because of this support, when using methods like `),de=n("code"),Je=r("model.fit()"),Le=r(` things should \u201Cjust work\u201D for you - just
pass your inputs and labels in any format that `),G=n("code"),ee=r("model.fit()"),xe=r(` supports! If, however, you want to use the second
format outside of Keras methods like `),K=n("code"),Xe=r("fit()"),ze=r(" and "),le=n("code"),Ge=r("predict()"),te=r(`, such as when creating your own layers or models with
the Keras `),ce=n("code"),pe=r("Functional"),Ze=r(` API, there are three possibilities you can use to gather all the input Tensors in the first
...
`),se=s(dt,"CODE",{});var Ce=a(se);J=i(Ce,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),Ce.forEach(t),dt.forEach(t),Z.forEach(t),V=c(x),I=s(x,"P",{});var je=a(I);ge=i(je,`Note that when creating models and layers with
`),R=s(je,"A",{href:!0,rel:!0});var Se=a(R);Me=i(Se,"subclassing"),Se.forEach(t),st=i(je,` then you don\u2019t need to worry
about any of this, as you can just pass inputs like you would to any other Python function!`),je.forEach(t),this.h()},h(){p(R,"href","https://keras.io/guides/making_new_layers_and_models_via_subclassing/"),p(R,"rel","nofollow")},m(x,F){f(x,u,F),e(u,y),e(u,_),e(_,m),e(u,k),f(x,d,F),f(x,h,F),e(h,E),e(E,Qe),e(h,Ne),e(h,L),e(L,Pe),f(x,$e,F),f(x,q,F),e(q,ie),e(q,de),e(de,Je),e(q,Le),e(q,G),e(G,ee),e(q,xe),e(q,K),e(K,Xe),e(q,ze),e(q,le),e(le,Ge),e(q,te),e(q,ce),e(ce,pe),e(q,Ze),f(x,Fe,F),f(x,S,F),e(S,A),e(A,Ye),e(A,oe),e(oe,ne),e(A,qe),e(A,ue),e(ue,et),e(S,Ee),e(S,D),e(D,De),e(D,N),e(N,tt),e(D,he),e(D,me),e(me,ot),e(S,fe),e(S,Q),e(Q,nt),e(Q,se),e(se,J),f(x,V,F),f(x,I,F),e(I,ge),e(I,R),e(R,Me),e(I,st)},d(x){x&&t(u),x&&t(d),x&&t(h),x&&t($e),x&&t(q),x&&t(Fe),x&&t(S),x&&t(V),x&&t(I)}}}function rk(z){let u,y,_,m,k;return{c(){u=n("p"),y=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),_=n("code"),m=r("Module"),k=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(d){u=s(d,"P",{});var h=a(u);y=i(h,"Although the recipe for forward pass needs to be defined within this function, one should call the "),_=s(h,"CODE",{});var E=a(_);m=i(E,"Module"),E.forEach(t),k=i(h,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),h.forEach(t)},m(d,h){f(d,u,h),e(u,y),e(u,_),e(_,m),e(u,k)},d(d){d&&t(u)}}}function ik(z){let u,y,_,m,k;return m=new Ve({props:{code:`from transformers import PegasusTokenizer, TFPegasusForConditionalGeneration
...
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-built_in">print</span>(tokenizer.batch_decode(summary_ids, skip_special_tokens=<span class="hljs-literal">True</span>, clean_up_tokenization_spaces=<span class="hljs-literal">False</span>))`}}),{c(){u=n("p"),y=r("Summarization example:"),_=l(),b(m.$$.fragment)},l(d){u=s(d,"P",{});var h=a(u);y=i(h,"Summarization example:"),h.forEach(t),_=c(d),v(m.$$.fragment,d)},m(d,h){f(d,u,h),e(u,y),f(d,_,h),T(m,d,h),k=!0},p:ht,i(d){k||(w(m.$$.fragment,d),k=!0)},o(d){P(m.$$.fragment,d),k=!1},d(d){d&&t(u),d&&t(_),$(m,d)}}}function dk(z){let u,y,_,m,k;return{c(){u=n("p"),y=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),_=n("code"),m=r("Module"),k=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(d){u=s(d,"P",{});var h=a(u);y=i(h,"Although the recipe for forward pass needs to be defined within this function, one should call the "),_=s(h,"CODE",{});var E=a(_);m=i(E,"Module"),E.forEach(t),k=i(h,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),h.forEach(t)},m(d,h){f(d,u,h),e(u,y),e(u,_),e(_,m),e(u,k)},d(d){d&&t(u)}}}function lk(z){let u,y,_,m,k;return m=new Ve({props:{code:`from transformers import PegasusTokenizer, FlaxPegasusModel
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),{c(){u=n("p"),y=r("Example:"),_=l(),b(m.$$.fragment)},l(d){u=s(d,"P",{});var h=a(u);y=i(h,"Example:"),h.forEach(t),_=c(d),v(m.$$.fragment,d)},m(d,h){f(d,u,h),e(u,y),f(d,_,h),T(m,d,h),k=!0},p:ht,i(d){k||(w(m.$$.fragment,d),k=!0)},o(d){P(m.$$.fragment,d),k=!1},d(d){d&&t(u),d&&t(_),$(m,d)}}}function ck(z){let u,y,_,m,k;return m=new Ve({props:{code:`from transformers import PegasusTokenizer, FlaxPegasusForConditionalGeneration
...
<span class="hljs-meta">&gt;&gt;&gt; </span>encoder_outputs = model.encode(**inputs)`}}),{c(){u=n("p"),y=r("Example:"),_=l(),b(m.$$.fragment)},l(d){u=s(d,"P",{});var h=a(u);y=i(h,"Example:"),h.forEach(t),_=c(d),v(m.$$.fragment,d)},m(d,h){f(d,u,h),e(u,y),f(d,_,h),T(m,d,h),k=!0},p:ht,i(d){k||(w(m.$$.fragment,d),k=!0)},o(d){P(m.$$.fragment,d),k=!1},d(d){d&&t(u),d&&t(_),$(m,d)}}}function pk(z){let u,y,_,m,k;return m=new Ve({props:{code:`import jax.numpy as jnp
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_decoder_hidden_states = outputs.last_hidden_state`}}),{c(){u=n("p"),y=r("Example:"),_=l(),b(m.$$.fragment)},l(d){u=s(d,"P",{});var h=a(u);y=i(h,"Example:"),h.forEach(t),_=c(d),v(m.$$.fragment,d)},m(d,h){f(d,u,h),e(u,y),f(d,_,h),T(m,d,h),k=!0},p:ht,i(d){k||(w(m.$$.fragment,d),k=!0)},o(d){P(m.$$.fragment,d),k=!1},d(d){d&&t(u),d&&t(_),$(m,d)}}}function uk(z){let u,y,_,m,k;return{c(){u=n("p"),y=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),_=n("code"),m=r("Module"),k=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(d){u=s(d,"P",{});var h=a(u);y=i(h,"Although the recipe for forward pass needs to be defined within this function, one should call the "),_=s(h,"CODE",{});var E=a(_);m=i(E,"Module"),E.forEach(t),k=i(h,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),h.forEach(t)},m(d,h){f(d,u,h),e(u,y),e(u,_),e(_,m),e(u,k)},d(d){d&&t(u)}}}function hk(z){let u,y,_,m,k;return m=new Ve({props:{code:`from transformers import PegasusTokenizer, FlaxPegasusForConditionalGeneration
...
<span class="hljs-meta">&gt;&gt;&gt; </span>text = <span class="hljs-string">&quot;My friends are cool but they eat too many carbs.&quot;</span>
<span class="hljs-meta">&gt;&gt;&gt; </span>inputs = tokenizer(text, max_length=<span class="hljs-number">1024</span>, return_tensors=<span class="hljs-string">&quot;np&quot;</span>)
<span class="hljs-meta">&gt;&gt;&gt; </span>encoder_outputs = model.encode(**inputs)`}}),{c(){u=n("p"),y=r("Example:"),_=l(),b(m.$$.fragment)},l(d){u=s(d,"P",{});var h=a(u);y=i(h,"Example:"),h.forEach(t),_=c(d),v(m.$$.fragment,d)},m(d,h){f(d,u,h),e(u,y),f(d,_,h),T(m,d,h),k=!0},p:ht,i(d){k||(w(m.$$.fragment,d),k=!0)},o(d){P(m.$$.fragment,d),k=!1},d(d){d&&t(u),d&&t(_),$(m,d)}}}function mk(z){let u,y,_,m,k;return m=new Ve({props:{code:`import jax.numpy as jnp
from transformers import PegasusTokenizer, FlaxPegasusForConditionalGeneration
...
<span class="hljs-meta">&gt;&gt;&gt; </span>outputs = model.decode(decoder_input_ids, encoder_outputs)
<span class="hljs-meta">&gt;&gt;&gt; </span>logits = outputs.logits`}}),{c(){u=n("p"),y=r("Example:"),_=l(),b(m.$$.fragment)},l(d){u=s(d,"P",{});var h=a(u);y=i(h,"Example:"),h.forEach(t),_=c(d),v(m.$$.fragment,d)},m(d,h){f(d,u,h),e(u,y),f(d,_,h),T(m,d,h),k=!0},p:ht,i(d){k||(w(m.$$.fragment,d),k=!0)},o(d){P(m.$$.fragment,d),k=!1},d(d){d&&t(u),d&&t(_),$(m,d)}}}function fk(z){let u,y,_,m,k,d,h,E,Qe,Ne,L,Pe,$e,q,ie,de,Je,Le,G,ee,xe,K,Xe,ze,le,Ge,te,ce,pe,Ze,Fe,S,A,Ye,oe,ne,qe,ue,et,Ee,D,De,N,tt,he,me,ot,fe,Q,nt,se,J,V,I,ge,R,Me,st,x,F,Tt,X,wt,Pt,M,$t,xt,mt,W,at,Z,_e,rt,zt,ke,it,Ft,dt,Ce,je,Se,ll,cl,pl,to,ln,ul,hl,cn,ml,fl,Li,qt,oo,$a,pn,gl,xa,_l,Gi,ft,no,un,kl,yl,hn,bl,vl,Tl,za,wl,Pl,Fa,$l,Di,Et,so,qa,mn,xl,Ea,zl,Ui,Te,Ma,Ca,Fl,ql,ja,Rs,El,Hs,Ml,Cl,fn,Sa,jl,Sl,Mt,Oa,Ol,Al,Aa,Il,Nl,gn,Ll,Ia,Gl,Dl,Ul,Na,lt,Bl,La,Wl,Kl,Ga,Rl,Hl,Da,Vl,Ql,Jl,Ua,Ct,Xl,_n,Zl,Yl,Ba,ec,tc,Bi,jt,ao,Wa,kn,oc,Ka,nc,Wi,yn,Ki,St,ro,Ra,bn,sc,Ha,ac,Ri,Oe,vn,rc,Ot,ic,Vs,dc,lc,Tn,cc,pc,uc,At,hc,Qs,mc,fc,Js,gc,_c,kc,io,Hi,It,lo,Va,wn,yc,Qa,bc,Vi,co,vc,Ja,Tc,wc,Qi,H,Pn,Pc,$n,$c,xn,xc,zc,Fc,zn,qc,Xs,Ec,Mc,Cc,Ue,Fn,jc,qn,Sc,Xa,Oc,Ac,Ic,En,Zs,Nc,Za,Lc,Gc,Mn,Dc,Ya,Uc,Bc,Wc,er,Kc,Rc,po,Cn,Hc,tr,Vc,Qc,uo,jn,Jc,or,Xc,Zc,ho,Sn,Yc,nr,ep,Ji,Nt,mo,sr,On,tp,ar,op,Xi,ye,An,np,Lt,sp,rr,ap,rp,In,ip,dp,lp,Nn,cp,Ys,pp,up,hp,gt,Ln,mp,ir,fp,gp,Gn,ea,_p,dr,kp,yp,Dn,bp,lr,vp,Tp,wp,fo,Un,Pp,cr,$p,Zi,Gt,go,pr,Bn,xp,ur,zp,Yi,Ae,Wn,Fp,Kn,qp,ta,Ep,Mp,Cp,Rn,jp,Hn,Sp,Op,Ap,Be,Vn,Ip,Dt,Np,oa,Lp,Gp,hr,Dp,Up,Bp,_o,Wp,ko,ed,Ut,yo,mr,Qn,Kp,fr,Rp,td,Ie,Jn,Hp,Xn,Vp,na,Qp,Jp,Xp,Zn,Zp,Yn,Yp,eu,tu,We,es,ou,Bt,nu,sa,su,au,gr,ru,iu,du,bo,lu,vo,od,Wt,To,_r,ts,cu,kr,pu,nd,Kt,os,uu,wo,ns,hu,Po,sd,Rt,$o,yr,ss,mu,br,fu,ad,be,as,gu,rs,_u,aa,ku,yu,bu,is,vu,ds,Tu,wu,Pu,xo,$u,Ke,ls,xu,Ht,zu,ra,Fu,qu,vr,Eu,Mu,Cu,zo,ju,Fo,rd,Vt,qo,Tr,cs,Su,wr,Ou,id,ve,ps,Au,us,Iu,ia,Nu,Lu,Gu,hs,Du,ms,Uu,Bu,Wu,Eo,Ku,Re,fs,Ru,Qt,Hu,da,Vu,Qu,Pr,Ju,Xu,Zu,Mo,Yu,Co,dd,Jt,jo,$r,gs,eh,xr,th,ld,U,_s,oh,ks,nh,la,sh,ah,rh,ys,ih,bs,dh,lh,ch,zr,ph,uh,ct,Fr,vs,hh,mh,qr,Ts,fh,gh,Er,ws,_h,kh,Mr,Ps,yh,bh,He,$s,vh,Xt,Th,Cr,wh,Ph,jr,$h,xh,zh,So,Fh,Oo,qh,Ao,xs,Eh,Io,Mh,No,zs,Ch,Lo,cd,Zt,Go,Sr,Fs,jh,Or,Sh,pd,B,qs,Oh,Es,Ah,ca,Ih,Nh,Lh,Ms,Gh,Cs,Dh,Uh,Bh,Ar,Wh,Kh,pt,Ir,js,Rh,Hh,Nr,Ss,Vh,Qh,Lr,Os,Jh,Xh,Gr,As,Zh,Yh,C,Is,em,Yt,tm,Dr,om,nm,Ur,sm,am,rm,Do,im,Br,dm,lm,Wr,Kr,Rr,Hr,cm,pm,Vr,Qr,Jr,Xr,um,hm,Zr,Yr,ei,ti,mm,fm,oi,ni,Ns,Uo,Bo,si,Ls,gm,ai,_m,km,ri,ym,bm,ii,vm,Tm,di,li,ci,pi,wm,Pm,ui,hi,mi,fi,$m,xm,gi,_i,ki,yi,zm,Fm,bi,vi,Ti,wi,qm,Em,Wo,Gs,Mm,Ko,Cm,Ro,Ds,jm,Ho,ud;return d=new Y({}),K=new Y({}),ge=new Y({}),pn=new Y({}),mn=new Y({}),kn=new Y({}),yn=new Ve({props:{code:`from transformers import PegasusForConditionalGeneration, PegasusTokenizer
import torch
...
`,returnType:`
<p><code>List[int]</code></p>
`}}),Un=new j({props:{name:"get_special_tokens_mask",anchor:"transformers.PegasusTokenizerFast.get_special_tokens_mask",parameters:[{name:"token_ids_0",val:": typing.List"},{name:"token_ids_1",val:": typing.Optional[typing.List] = None"},{name:"already_has_special_tokens",val:": bool = False"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/pegasus/tokenization_pegasus_fast.py#L169"}}),Bn=new Y({}),Wn=new j({props:{name:"class transformers.PegasusModel",anchor:"transformers.PegasusModel",parameters:[{name:"config",val:": PegasusConfig"}],parametersDescription:[{anchor:"transformers.PegasusModel.config",description:`<strong>config</strong> (<a href="/docs/transformers/main/en/model_doc/pegasus#transformers.PegasusConfig">PegasusConfig</a>) &#x2014;
...
Whether or not to return a <a href="/docs/transformers/main/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/pegasus/modeling_pegasus.py#L1194",returnDescription:`
<p>A <a
...
(masked), the loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/pegasus/modeling_pegasus.py#L1363",returnDescription:`
<p>A <a
...
Whether or not to return a <a href="/docs/transformers/main/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/pegasus/modeling_pegasus.py#L1557",returnDescription:`
<p>A <a
...
behaviors between training and evaluation).`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/pegasus/modeling_tf_pegasus.py#L1226",returnDescription:`
<p>A <a
...
Labels for computing the masked language modeling loss. Indices should either be in <code>[0, ..., config.vocab_size]</code> or -100 (see <code>input_ids</code> docstring). Tokens with indices set to <code>-100</code> are ignored
(masked), the loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/pegasus/modeling_tf_pegasus.py#L1359",returnDescription:`
<p>A <a
...
found in `),Ba=n("code"),ec=r("convert_pegasus_tf_to_pytorch.py"),tc=r("."),Bi=l(),jt=n("h2"),ao=n("a"),Wa=n("span"),b(kn.$$.fragment),oc=l(),Ka=n("span"),nc=r("Usage Example"),Wi=l(),b(yn.$$.fragment),Ki=l(),St=n("h2"),ro=n("a"),Ra=n("span"),b(bn.$$.fragment),sc=l(),Ha=n("span"),ac=r("PegasusConfig"),Ri=l(),Oe=n("div"),b(vn.$$.fragment),rc=l(),Ot=n("p"),ic=r("This is the configuration class to store the configuration of a "),Vs=n("a"),dc=r("PegasusModel"),lc=r(`. It is used to instantiate an
...
documentation from `),Js=n("a"),gc=r("PretrainedConfig"),_c=r(" for more information."),kc=l(),b(io.$$.fragment),Hi=l(),It=n("h2"),lo=n("a"),Va=n("span"),b(wn.$$.fragment),yc=l(),Qa=n("span"),bc=r("PegasusTokenizer"),Vi=l(),co=n("p"),vc=r("warning: "),Ja=n("code"),Tc=r("add_tokens"),wc=r(" does not work at the moment."),Qi=l(),H=n("div"),b(Pn.$$.fragment),Pc=l(),$n=n("p"),$c=r("Construct a PEGASUS tokenizer. Based on "),xn=n("a"),xc=r("SentencePiece"),zc=r("."),Fc=l(),zn=n("p"),qc=r("This tokenizer inherits from "),Xs=n("a"),Ec=r("PreTrainedTokenizer"),Mc=r(` which contains most of the main methods. Users should refer to
this superclass for more information regarding those methods.`),Cc=l(),Ue=n("div"),b(Fn.$$.fragment),jc=l(),qn=n("p"),Sc=r(`Build model inputs from a sequence or a pair of sequences for sequence classification tasks by concatenating
...
separator.`),Rc=l(),po=n("div"),b(Cn.$$.fragment),Hc=l(),tr=n("p"),Vc=r("Converts a sequence of tokens (string) in a single string."),Qc=l(),uo=n("div"),b(jn.$$.fragment),Jc=l(),or=n("p"),Xc=r("Get list where entries are [1] if a token is [eos] or [pad] else 0."),Zc=l(),ho=n("div"),b(Sn.$$.fragment),Yc=l(),nr=n("p"),ep=r("Just EOS"),Ji=l(),Nt=n("h2"),mo=n("a"),sr=n("span"),b(On.$$.fragment),tp=l(),ar=n("span"),op=r("PegasusTokenizerFast"),Xi=l(),ye=n("div"),b(An.$$.fragment),np=l(),Lt=n("p"),sp=r("Construct a \u201Cfast\u201D PEGASUS tokenizer (backed by HuggingFace\u2019s "),rr=n("em"),ap=r("tokenizers"),rp=r(` library). Based on
...
refer to this superclass for more information regarding those methods.`),hp=l(),gt=n("div"),b(Ln.$$.fragment),mp=l(),ir=n("p"),fp=r("Build model inputs from a sequence by adding eos to the end. no bos token is added to the front."),gp=l(),Gn=n("ul"),ea=n("li"),_p=r("single sequence: "),dr=n("code"),kp=r("X </s>"),yp=l(),Dn=n("li"),bp=r("pair of sequences: "),lr=n("code"),vp=r("A B </s>"),Tp=r(" (not intended use)"),wp=l(),fo=n("div"),b(Un.$$.fragment),Pp=l(),cr=n("p"),$p=r("Get list where entries are [1] if a token is [eos] or [pad] else 0."),Zi=l(),Gt=n("h2"),go=n("a"),pr=n("span"),b(Bn.$$.fragment),xp=l(),ur=n("span"),zp=r("PegasusModel"),Yi=l(),Ae=n("div"),b(Wn.$$.fragment),Fp=l(),Kn=n("p"),qp=r(`The bare PEGASUS Model outputting raw hidden-states without any specific head on top.
...
and behavior.`),Ap=l(),Be=n("div"),b(Vn.$$.fragment),Ip=l(),Dt=n("p"),Np=r("The "),oa=n("a"),Lp=r("PegasusModel"),Gp=r(" forward method, overrides the "),hr=n("code"),Dp=r("__call__"),Up=r(" special method."),Bp=l(),b(_o.$$.fragment),Wp=l(),b(ko.$$.fragment),ed=l(),Ut=n("h2"),yo=n("a"),mr=n("span"),b(Qn.$$.fragment),Kp=l(),fr=n("span"),Rp=r("PegasusForConditionalGeneration"),td=l(),Ie=n("div"),b(Jn.$$.fragment),Hp=l(),Xn=n("p"),Vp=r(`The PEGASUS Model with a language modeling head. Can be used for summarization.
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),tu=l(),We=n("div"),b(es.$$.fragment),ou=l(),Bt=n("p"),nu=r("The "),sa=n("a"),su=r("PegasusForConditionalGeneration"),au=r(" forward method, overrides the "),gr=n("code"),ru=r("__call__"),iu=r(" special method."),du=l(),b(bo.$$.fragment),lu=l(),b(vo.$$.fragment),od=l(),Wt=n("h2"),To=n("a"),_r=n("span"),b(ts.$$.fragment),cu=l(),kr=n("span"),pu=r("PegasusForCausalLM"),nd=l(),Kt=n("div"),b(os.$$.fragment),uu=l(),wo=n("div"),b(ns.$$.fragment),hu=l(),b(Po.$$.fragment),sd=l(),Rt=n("h2"),$o=n("a"),yr=n("span"),b(ss.$$.fragment),mu=l(),br=n("span"),fu=r("TFPegasusModel"),ad=l(),be=n("div"),b(as.$$.fragment),gu=l(),rs=n("p"),_u=r(`The bare PEGASUS Model outputting raw hidden-states without any specific head on top.
This model inherits from `),aa=n("a"),ku=r("TFPreTrainedModel"),yu=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),bu=l(),is=n("p"),vu=r("This model is also a "),ds=n("a"),Tu=r("tf.keras.Model"),wu=r(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Pu=l(),b(xo.$$.fragment),$u=l(),Ke=n("div"),b(ls.$$.fragment),xu=l(),Ht=n("p"),zu=r("The "),ra=n("a"),Fu=r("TFPegasusModel"),qu=r(" forward method, overrides the "),vr=n("code"),Eu=r("__call__"),Mu=r(" special method."),Cu=l(),b(zo.$$.fragment),ju=l(),b(Fo.$$.fragment),rd=l(),Vt=n("h2"),qo=n("a"),Tr=n("span"),b(cs.$$.fragment),Su=l(),wr=n("span"),Ou=r("TFPegasusForConditionalGeneration"),id=l(),ve=n("div"),b(ps.$$.fragment),Au=l(),us=n("p"),Iu=r(`The PEGASUS Model with a language modeling head. Can be used for summarization.
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Wu=l(),b(Eo.$$.fragment),Ku=l(),Re=n("div"),b(fs.$$.fragment),Ru=l(),Qt=n("p"),Hu=r("The "),da=n("a"),Vu=r("TFPegasusForConditionalGeneration"),Qu=r(" forward method, overrides the "),Pr=n("code"),Ju=r("__call__"),Xu=r(" special method."),Zu=l(),b(Mo.$$.fragment),Yu=l(),b(Co.$$.fragment),dd=l(),Jt=n("h2"),jo=n("a"),$r=n("span"),b(gs.$$.fragment),eh=l(),xr=n("span"),th=r("FlaxPegasusModel"),ld=l(),U=n("div"),b(_s.$$.fragment),oh=l(),ks=n("p"),nh=r(`The bare Pegasus Model transformer outputting raw hidden-states without any specific head on top.
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),rh=l(),ys=n("p"),ih=r(`This model is also a Flax Linen
`),bs=n("a"),dh=r("flax.nn.Module"),lh=r(` subclass. Use it as a
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),ch=l(),zr=n("p"),ph=r("Finally, this model supports inherent JAX features such as:"),uh=l(),ct=n("ul"),Fr=n("li"),vs=n("a"),hh=r("Just-In-Time (JIT) compilation"),mh=l(),qr=n("li"),Ts=n("a"),fh=r("Automatic Differentiation"),gh=l(),Er=n("li"),ws=n("a"),_h=r("Vectorization"),kh=l(),Mr=n("li"),Ps=n("a"),yh=r("Parallelization"),bh=l(),He=n("div"),b($s.$$.fragment),vh=l(),Xt=n("p"),Th=r("The "),Cr=n("code"),wh=r("FlaxPegasusPreTrainedModel"),Ph=r(" forward method, overrides the "),jr=n("code"),$h=r("__call__"),xh=r(" special method."),zh=l(),b(So.$$.fragment),Fh=l(),b(Oo.$$.fragment),qh=l(),Ao=n("div"),b(xs.$$.fragment),Eh=l(),b(Io.$$.fragment),Mh=l(),No=n("div"),b(zs.$$.fragment),Ch=l(),b(Lo.$$.fragment),cd=l(),Zt=n("h2"),Go=n("a"),Sr=n("span"),b(Fs.$$.fragment),jh=l(),Or=n("span"),Sh=r("FlaxPegasusForConditionalGeneration"),pd=l(),B=n("div"),b(qs.$$.fragment),Oh=l(),Es=n("p"),Ah=r(`The PEGASUS Model with a language modeling head. Can be used for summarization.
...
tokenizer([ARTICLE_TO_SUMMARIZE], max_length=1024, return_tensors=\u2018np\u2019)`),fm=l(),oi=n("blockquote"),ni=n("blockquote"),Ns=n("blockquote"),Uo=n("h1"),Bo=n("a"),si=n("span"),b(Ls.$$.fragment),gm=l(),ai=n("span"),_m=r("Generate Summary >>> summary_ids = model.generate(inputs[\u2018input_ids\u2019]).sequences >>>"),km=l(),ri=n("p"),ym=r("print(tokenizer.batch_decode(summary_ids, skip_special_tokens=True, clean_up_tokenization_spaces=False))"),bm=l(),ii=n("p"),vm=r("Mask filling example:"),Tm=l(),di=n("blockquote"),li=n("blockquote"),ci=n("blockquote"),pi=n("p"),wm=r(`from transformers import PegasusTokenizer, FlaxPegasusForConditionalGeneration >>> tokenizer =
...
documentation from `),Js=s(ga,"A",{href:!0});var Ef=a(Js);gc=i(Ef,"PretrainedConfig"),Ef.forEach(t),_c=i(ga," for more information."),ga.forEach(t),kc=c(Jo),v(io.$$.fragment,Jo),Jo.forEach(t),Hi=c(o),It=s(o,"H2",{class:!0});var vd=a(It);lo=s(vd,"A",{id:!0,class:!0,href:!0});var Mf=a(lo);Va=s(Mf,"SPAN",{});var Cf=a(Va);v(wn.$$.fragment,Cf),Cf.forEach(t),Mf.forEach(t),yc=c(vd),Qa=s(vd,"SPAN",{});var jf=a(Qa);bc=i(jf,"PegasusTokenizer"),jf.forEach(t),vd.forEach(t),Vi=c(o),co=s(o,"P",{});var Td=a(co);vc=i(Td,"warning: "),Ja=s(Td,"CODE",{});var Sf=a(Ja);Tc=i(Sf,"add_tokens"),Sf.forEach(t),wc=i(Td," does not work at the moment."),Td.forEach(t),Qi=c(o),H=s(o,"DIV",{class:!0});var we=a(H);v(Pn.$$.fragment,we),Pc=c(we),$n=s(we,"P",{});var wd=a($n);$c=i(wd,"Construct a PEGASUS tokenizer. Based on "),xn=s(wd,"A",{href:!0,rel:!0});var Of=a(xn);xc=i(Of,"SentencePiece"),Of.forEach(t),zc=i(wd,"."),wd.forEach(t),Fc=c(we),zn=s(we,"P",{});var Pd=a(zn);qc=i(Pd,"This tokenizer inherits from "),Xs=s(Pd,"A",{href:!0});var Af=a(Xs);Ec=i(Af,"PreTrainedTokenizer"),Af.forEach(t),Mc=i(Pd,` which contains most of the main methods. Users should refer to
this superclass for more information regarding those methods.`),Pd.forEach(t),Cc=c(we),Ue=s(we,"DIV",{class:!0});var Xo=a(Ue);v(Fn.$$.fragment,Xo),jc=c(Xo),qn=s(Xo,"P",{});var $d=a(qn);Sc=i($d,`Build model inputs from a sequence or a pair of sequences for sequence classification tasks by concatenating
...
separator.`),Gf.forEach(t),Xo.forEach(t),Rc=c(we),po=s(we,"DIV",{class:!0});var Fd=a(po);v(Cn.$$.fragment,Fd),Hc=c(Fd),tr=s(Fd,"P",{});var Df=a(tr);Vc=i(Df,"Converts a sequence of tokens (string) in a single string."),Df.forEach(t),Fd.forEach(t),Qc=c(we),uo=s(we,"DIV",{class:!0});var qd=a(uo);v(jn.$$.fragment,qd),Jc=c(qd),or=s(qd,"P",{});var Uf=a(or);Xc=i(Uf,"Get list where entries are [1] if a token is [eos] or [pad] else 0."),Uf.forEach(t),qd.forEach(t),Zc=c(we),ho=s(we,"DIV",{class:!0});var Ed=a(ho);v(Sn.$$.fragment,Ed),Yc=c(Ed),nr=s(Ed,"P",{});var Bf=a(nr);ep=i(Bf,"Just EOS"),Bf.forEach(t),Ed.forEach(t),we.forEach(t),Ji=c(o),Nt=s(o,"H2",{class:!0});var Md=a(Nt);mo=s(Md,"A",{id:!0,class:!0,href:!0});var Wf=a(mo);sr=s(Wf,"SPAN",{});var Kf=a(sr);v(On.$$.fragment,Kf),Kf.forEach(t),Wf.forEach(t),tp=c(Md),ar=s(Md,"SPAN",{});var Rf=a(ar);op=i(Rf,"PegasusTokenizerFast"),Rf.forEach(t),Md.forEach(t),Xi=c(o),ye=s(o,"DIV",{class:!0});var yt=a(ye);v(An.$$.fragment,yt),np=c(yt),Lt=s(yt,"P",{});var _a=a(Lt);sp=i(_a,"Construct a \u201Cfast\u201D PEGASUS tokenizer (backed by HuggingFace\u2019s "),rr=s(_a,"EM",{});var Hf=a(rr);ap=i(Hf,"tokenizers"),Hf.forEach(t),rp=i(_a,` library). Based on
`),In=s(_a,"A",{href:!0,rel:!0});var Vf=a(In);ip=i(Vf,"Unigram"),Vf.forEach(t),dp=i(_a,"."),_a.forEach(t),lp=c(yt),Nn=s(yt,"P",{});var Cd=a(Nn);cp=i(Cd,"This tokenizer inherits from "),Ys=s(Cd,"A",{href:!0});var Qf=a(Ys);pp=i(Qf,"PreTrainedTokenizerFast"),Qf.forEach(t),up=i(Cd,` which contains most of the main methods. Users should
refer to this superclass for more information regarding those methods.`),Cd.forEach(t),hp=c(yt),gt=s(yt,"DIV",{class:!0});var ka=a(gt);v(Ln.$$.fragment,ka),mp=c(ka),ir=s(ka,"P",{});var Jf=a(ir);fp=i(Jf,"Build model inputs from a sequence by adding eos to the end. no bos token is added to the front."),Jf.forEach(t),gp=c(ka),Gn=s(ka,"UL",{});var jd=a(Gn);ea=s(jd,"LI",{});var Am=a(ea);_p=i(Am,"single sequence: "),dr=s(Am,"CODE",{});var Xf=a(dr);kp=i(Xf,"X </s>"),Xf.forEach(t),Am.forEach(t),yp=c(jd),Dn=s(jd,"LI",{});var Sd=a(Dn);bp=i(Sd,"pair of sequences: "),lr=s(Sd,"CODE",{});var Zf=a(lr);vp=i(Zf,"A B </s>"),Zf.forEach(t),Tp=i(Sd," (not intended use)"),Sd.forEach(t),jd.forEach(t),ka.forEach(t),wp=c(yt),fo=s(yt,"DIV",{class:!0});var Od=a(fo);v(Un.$$.fragment,Od),Pp=c(Od),cr=s(Od,"P",{});var Yf=a(cr);$p=i(Yf,"Get list where entries are [1] if a token is [eos] or [pad] else 0."),Yf.forEach(t),Od.forEach(t),yt.forEach(t),Zi=c(o),Gt=s(o,"H2",{class:!0});var Ad=a(Gt);go=s(Ad,"A",{id:!0,class:!0,href:!0});var eg=a(go);pr=s(eg,"SPAN",{});var tg=a(pr);v(Bn.$$.fragment,tg),tg.forEach(t),eg.forEach(t),xp=c(Ad),ur=s(Ad,"SPAN",{});var og=a(ur);zp=i(og,"PegasusModel"),og.forEach(t),Ad.forEach(t),Yi=c(o),Ae=s(o,"DIV",{class:!0});var Zo=a(Ae);v(Wn.$$.fragment,Zo),Fp=c(Zo),Kn=s(Zo,"P",{});var Id=a(Kn);qp=i(Id,`The bare PEGASUS Model outputting raw hidden-states without any specific head on top.
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Nd.forEach(t),Ap=c(Zo),Be=s(Zo,"DIV",{class:!0});var Yo=a(Be);v(Vn.$$.fragment,Yo),Ip=c(Yo),Dt=s(Yo,"P",{});var ya=a(Dt);Np=i(ya,"The "),oa=s(ya,"A",{href:!0});var ag=a(oa);Lp=i(ag,"PegasusModel"),ag.forEach(t),Gp=i(ya," forward method, overrides the "),hr=s(ya,"CODE",{});var rg=a(hr);Dp=i(rg,"__call__"),rg.forEach(t),Up=i(ya," special method."),ya.forEach(t),Bp=c(Yo),v(_o.$$.fragment,Yo),Wp=c(Yo),v(ko.$$.fragment,Yo),Yo.forEach(t),Zo.forEach(t),ed=c(o),Ut=s(o,"H2",{class:!0});var Ld=a(Ut);yo=s(Ld,"A",{id:!0,class:!0,href:!0});var ig=a(yo);mr=s(ig,"SPAN",{});var dg=a(mr);v(Qn.$$.fragment,dg),dg.forEach(t),ig.forEach(t),Kp=c(Ld),fr=s(Ld,"SPAN",{});var lg=a(fr);Rp=i(lg,"PegasusForConditionalGeneration"),lg.forEach(t),Ld.forEach(t),td=c(o),Ie=s(o,"DIV",{class:!0});var en=a(Ie);v(Jn.$$.fragment,en),Hp=c(en),Xn=s(en,"P",{});var Gd=a(Xn);Vp=i(Gd,`The PEGASUS Model with a language modeling head. Can be used for summarization.
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Dd.forEach(t),tu=c(en),We=s(en,"DIV",{class:!0});var tn=a(We);v(es.$$.fragment,tn),ou=c(tn),Bt=s(tn,"P",{});var ba=a(Bt);nu=i(ba,"The "),sa=s(ba,"A",{href:!0});var ug=a(sa);su=i(ug,"PegasusForConditionalGeneration"),ug.forEach(t),au=i(ba," forward method, overrides the "),gr=s(ba,"CODE",{});var hg=a(gr);ru=i(hg,"__call__"),hg.forEach(t),iu=i(ba," special method."),ba.forEach(t),du=c(tn),v(bo.$$.fragment,tn),lu=c(tn),v(vo.$$.fragment,tn),tn.forEach(t),en.forEach(t),od=c(o),Wt=s(o,"H2",{class:!0});var Ud=a(Wt);To=s(Ud,"A",{id:!0,class:!0,href:!0});var mg=a(To);_r=s(mg,"SPAN",{});var fg=a(_r);v(ts.$$.fragment,fg),fg.forEach(t),mg.forEach(t),cu=c(Ud),kr=s(Ud,"SPAN",{});var gg=a(kr);pu=i(gg,"PegasusForCausalLM"),gg.forEach(t),Ud.forEach(t),nd=c(o),Kt=s(o,"DIV",{class:!0});var Bd=a(Kt);v(os.$$.fragment,Bd),uu=c(Bd),wo=s(Bd,"DIV",{class:!0});var Wd=a(wo);v(ns.$$.fragment,Wd),hu=c(Wd),v(Po.$$.fragment,Wd),Wd.forEach(t),Bd.forEach(t),sd=c(o),Rt=s(o,"H2",{class:!0});var Kd=a(Rt);$o=s(Kd,"A",{id:!0,class:!0,href:!0});var _g=a($o);yr=s(_g,"SPAN",{});var kg=a(yr);v(ss.$$.fragment,kg),kg.forEach(t),_g.forEach(t),mu=c(Kd),br=s(Kd,"SPAN",{});var yg=a(br);fu=i(yg,"TFPegasusModel"),yg.forEach(t),Kd.forEach(t),ad=c(o),be=s(o,"DIV",{class:!0});var bt=a(be);v(as.$$.fragment,bt),gu=c(bt),rs=s(bt,"P",{});var Rd=a(rs);_u=i(Rd,`The bare PEGASUS Model outputting raw hidden-states without any specific head on top.
This model inherits from `),aa=s(Rd,"A",{href:!0});var bg=a(aa);ku=i(bg,"TFPreTrainedModel"),bg.forEach(t),yu=i(Rd,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Rd.forEach(t),bu=c(bt),is=s(bt,"P",{});var Hd=a(is);vu=i(Hd,"This model is also a "),ds=s(Hd,"A",{href:!0,rel:!0});var vg=a(ds);Tu=i(vg,"tf.keras.Model"),vg.forEach(t),wu=i(Hd,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Hd.forEach(t),Pu=c(bt),v(xo.$$.fragment,bt),$u=c(bt),Ke=s(bt,"DIV",{class:!0});var on=a(Ke);v(ls.$$.fragment,on),xu=c(on),Ht=s(on,"P",{});var va=a(Ht);zu=i(va,"The "),ra=s(va,"A",{href:!0});var Tg=a(ra);Fu=i(Tg,"TFPegasusModel"),Tg.forEach(t),qu=i(va," forward method, overrides the "),vr=s(va,"CODE",{});var wg=a(vr);Eu=i(wg,"__call__"),wg.forEach(t),Mu=i(va," special method."),va.forEach(t),Cu=c(on),v(zo.$$.fragment,on),ju=c(on),v(Fo.$$.fragment,on),on.forEach(t),bt.forEach(t),rd=c(o),Vt=s(o,"H2",{class:!0});var Vd=a(Vt);qo=s(Vd,"A",{id:!0,class:!0,href:!0});var Pg=a(qo);Tr=s(Pg,"SPAN",{});var $g=a(Tr);v(cs.$$.fragment,$g),$g.forEach(t),Pg.forEach(t),Su=c(Vd),wr=s(Vd,"SPAN",{});var xg=a(wr);Ou=i(xg,"TFPegasusForConditionalGeneration"),xg.forEach(t),Vd.forEach(t),id=c(o),ve=s(o,"DIV",{class:!0});var vt=a(ve);v(ps.$$.fragment,vt),Au=c(vt),us=s(vt,"P",{});var Qd=a(us);Iu=i(Qd,`The PEGASUS Model with a language modeling head. Can be used for summarization.
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Qd.forEach(t),Gu=c(vt),hs=s(vt,"P",{});var Jd=a(hs);Du=i(Jd,"This model is also a "),ms=s(Jd,"A",{href:!0,rel:!0});var Fg=a(ms);Uu=i(Fg,"tf.keras.Model"),Fg.forEach(t),Bu=i(Jd,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Jd.forEach(t),Wu=c(vt),v(Eo.$$.fragment,vt),Ku=c(vt),Re=s(vt,"DIV",{class:!0});var nn=a(Re);v(fs.$$.fragment,nn),Ru=c(nn),Qt=s(nn,"P",{});var Ta=a(Qt);Hu=i(Ta,"The "),da=s(Ta,"A",{href:!0});var qg=a(da);Vu=i(qg,"TFPegasusForConditionalGeneration"),qg.forEach(t),Qu=i(Ta," forward method, overrides the "),Pr=s(Ta,"CODE",{});var Eg=a(Pr);Ju=i(Eg,"__call__"),Eg.forEach(t),Xu=i(Ta," special method."),Ta.forEach(t),Zu=c(nn),v(Mo.$$.fragment,nn),Yu=c(nn),v(Co.$$.fragment,nn),nn.forEach(t),vt.forEach(t),dd=c(o),Jt=s(o,"H2",{class:!0});var Xd=a(Jt);jo=s(Xd,"A",{id:!0,class:!0,href:!0});var Mg=a(jo);$r=s(Mg,"SPAN",{});var Cg=a($r);v(gs.$$.fragment,Cg),Cg.forEach(t),Mg.forEach(t),eh=c(Xd),xr=s(Xd,"SPAN",{});var jg=a(xr);th=i(jg,"FlaxPegasusModel"),jg.forEach(t),Xd.forEach(t),ld=c(o),U=s(o,"DIV",{class:!0});var ae=a(U);v(_s.$$.fragment,ae),oh=c(ae),ks=s(ae,"P",{});var Zd=a(ks);nh=i(Zd,`The bare Pegasus Model transformer outputting raw hidden-states without any specific head on top.
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Zd.forEach(t),rh=c(ae),ys=s(ae,"P",{});var Yd=a(ys);ih=i(Yd,`This model is also a Flax Linen
`),bs=s(Yd,"A",{href:!0,rel:!0});var Og=a(bs);dh=i(Og,"flax.nn.Module"),Og.forEach(t),lh=i(Yd,` subclass. Use it as a
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),Yd.forEach(t),ch=c(ae),zr=s(ae,"P",{});var Ag=a(zr);ph=i(Ag,"Finally, this model supports inherent JAX features such as:"),Ag.forEach(t),uh=c(ae),ct=s(ae,"UL",{});var sn=a(ct);Fr=s(sn,"LI",{});var Ig=a(Fr);vs=s(Ig,"A",{href:!0,rel:!0});var Ng=a(vs);hh=i(Ng,"Just-In-Time (JIT) compilation"),Ng.forEach(t),Ig.forEach(t),mh=c(sn),qr=s(sn,"LI",{});var Lg=a(qr);Ts=s(Lg,"A",{href:!0,rel:!0});var Gg=a(Ts);fh=i(Gg,"Automatic Differentiation"),Gg.forEach(t),Lg.forEach(t),gh=c(sn),Er=s(sn,"LI",{});var Dg=a(Er);ws=s(Dg,"A",{href:!0,rel:!0});var Ug=a(ws);_h=i(Ug,"Vectorization"),Ug.forEach(t),Dg.forEach(t),kh=c(sn),Mr=s(sn,"LI",{});var Bg=a(Mr);Ps=s(Bg,"A",{href:!0,rel:!0});var Wg=a(Ps);yh=i(Wg,"Parallelization"),Wg.forEach(t),Bg.forEach(t),sn.forEach(t),bh=c(ae),He=s(ae,"DIV",{class:!0});var an=a(He);v($s.$$.fragment,an),vh=c(an),Xt=s(an,"P",{});var wa=a(Xt);Th=i(wa,"The "),Cr=s(wa,"CODE",{});var Kg=a(Cr);wh=i(Kg,"FlaxPegasusPreTrainedModel"),Kg.forEach(t),Ph=i(wa," forward method, overrides the "),jr=s(wa,"CODE",{});var Rg=a(jr);$h=i(Rg,"__call__"),Rg.forEach(t),xh=i(wa," special method."),wa.forEach(t),zh=c(an),v(So.$$.fragment,an),Fh=c(an),v(Oo.$$.fragment,an),an.forEach(t),qh=c(ae),Ao=s(ae,"DIV",{class:!0});var el=a(Ao);v(xs.$$.fragment,el),Eh=c(el),v(Io.$$.fragment,el),el.forEach(t),Mh=c(ae),No=s(ae,"DIV",{class:!0});var tl=a(No);v(zs.$$.fragment,tl),Ch=c(tl),v(Lo.$$.fragment,tl),tl.forEach(t),ae.forEach(t),cd=c(o),Zt=s(o,"H2",{class:!0});var ol=a(Zt);Go=s(ol,"A",{id:!0,class:!0,href:!0});var Hg=a(Go);Sr=s(Hg,"SPAN",{});var Vg=a(Sr);v(Fs.$$.fragment,Vg),Vg.forEach(t),Hg.forEach(t),jh=c(ol),Or=s(ol,"SPAN",{});var Qg=a(Or);Sh=i(Qg,"FlaxPegasusForConditionalGeneration"),Qg.forEach(t),ol.forEach(t),pd=c(o),B=s(o,"DIV",{class:!0});var re=a(B);v(qs.$$.fragment,re),Oh=c(re),Es=s(re,"P",{});var nl=a(Es);Ah=i(nl,`The PEGASUS Model with a language modeling head. Can be used for summarization.
...
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),sl.forEach(t),Bh=c(re),Ar=s(re,"P",{});var Zg=a(Ar);Wh=i(Zg,"Finally, this model supports inherent JAX features such as:"),Zg.forEach(t),Kh=c(re),pt=s(re,"UL",{});var rn=a(pt);Ir=s(rn,"LI",{});var Yg=a(Ir);js=s(Yg,"A",{href:!0,rel:!0});var e_=a(js);Rh=i(e_,"Just-In-Time (JIT) compilation"),e_.forEach(t),Yg.forEach(t),Hh=c(rn),Nr=s(rn,"LI",{});var t_=a(Nr);Ss=s(t_,"A",{href:!0,rel:!0});var o_=a(Ss);Vh=i(o_,"Automatic Differentiation"),o_.forEach(t),t_.forEach(t),Qh=c(rn),Lr=s(rn,"LI",{});var n_=a(Lr);Os=s(n_,"A",{href:!0,rel:!0});var s_=a(Os);Jh=i(s_,"Vectorization"),s_.forEach(t),n_.forEach(t),Xh=c(rn),Gr=s(rn,"LI",{});var a_=a(Gr);As=s(a_,"A",{href:!0,rel:!0});var r_=a(As);Zh=i(r_,"Parallelization"),r_.forEach(t),a_.forEach(t),rn.forEach(t),Yh=c(re),C=s(re,"DIV",{class:!0});var O=a(C);v(Is.$$.fragment,O),em=c(O),Yt=s(O,"P",{});var Pa=a(Yt);tm=i(Pa,"The "),Dr=s(Pa,"CODE",{});var i_=a(Dr);om=i(i_,"FlaxPegasusPreTrainedModel"),i_.forEach(t),nm=i(Pa," forward method, overrides the "),Ur=s(Pa,"CODE",{});var d_=a(Ur);sm=i(d_,"__call__"),d_.forEach(t),am=i(Pa," special method."),Pa.forEach(t),rm=c(O),v(Do.$$.fragment,O),im=c(O),Br=s(O,"P",{});var l_=a(Br);dm=i(l_,"Summarization example:"),l_.forEach(t),lm=c(O),Wr=s(O,"BLOCKQUOTE",{});var c_=a(Wr);Kr=s(c_,"BLOCKQUOTE",{});var p_=a(Kr);Rr=s(p_,"BLOCKQUOTE",{});var u_=a(Rr);Hr=s(u_,"P",{});var h_=a(Hr);cm=i(h_,"from transformers import PegasusTokenizer, FlaxPegasusForConditionalGeneration"),h_.forEach(t),u_.forEach(t),p_.forEach(t),c_.forEach(t),pm=c(O),Vr=s(O,"BLOCKQUOTE",{});var m_=a(Vr);Qr=s(m_,"BLOCKQUOTE",{});var f_=a(Qr);Jr=s(f_,"BLOCKQUOTE",{});var g_=a(Jr);Xr=s(g_,"P",{});var __=a(Xr);um=i(__,`model = FlaxPegasusForConditionalGeneration.from_pretrained(\u2018google/pegasus-large\u2019) >>> tokenizer =
PegasusTokenizer.from_pretrained(\u2018google/pegasus-large\u2019)`),__.forEach(t),g_.forEach(t),f_.forEach(t),m_.forEach(t),hm=c(O),Zr=s(O,"BLOCKQUOTE",{});var k_=a(Zr);Yr=s(k_,"BLOCKQUOTE",{});var y_=a(Yr);ei=s(y_,"BLOCKQUOTE",{});var b_=a(ei);ti=s(b_,"P",{});var v_=a(ti);mm=i(v_,`ARTICLE_TO_SUMMARIZE = \u201CMy friends are cool but they eat too many carbs.\u201D >>> inputs =
tokenizer([ARTICLE_TO_SUMMARIZE], max_length=1024, return_tensors=\u2018np\u2019)`),v_.forEach(t),b_.forEach(t),y_.forEach(t),k_.forEach(t),fm=c(O),oi=s(O,"BLOCKQUOTE",{});var T_=a(oi);ni=s(T_,"BLOCKQUOTE",{});var w_=a(ni);Ns=s(w_,"BLOCKQUOTE",{});var al=a(Ns);Uo=s(al,"H1",{class:!0});var rl=a(Uo);Bo=s(rl,"A",{id:!0,class:!0,href:!0});var P_=a(Bo);si=s(P_,"SPAN",{});var $_=a(si);v(Ls.$$.fragment,$_),$_.forEach(t),P_.forEach(t),gm=c(rl),ai=s(rl,"SPAN",{});var x_=a(ai);_m=i(x_,"Generate Summary >>> summary_ids = model.generate(inputs[\u2018input_ids\u2019]).sequences >>>"),x_.forEach(t),rl.forEach(t),km=c(al),ri=s(al,"P",{});var z_=a(ri);ym=i(z_,"print(tokenizer.batch_decode(summary_ids, skip_special_tokens=True, clean_up_tokenization_spaces=False))"),z_.forEach(t),al.forEach(t),w_.forEach(t),T_.forEach(t),bm=c(O),ii=s(O,"P",{});var F_=a(ii);vm=i(F_,"Mask filling example:"),F_.forEach(t),Tm=c(O),di=s(O,"BLOCKQUOTE",{});var q_=a(di);li=s(q_,"BLOCKQUOTE",{});var E_=a(li);ci=s(E_,"BLOCKQUOTE",{});var M_=a(ci);pi=s(M_,"P",{});var C_=a(pi);wm=i(C_,`from transformers import PegasusTokenizer, FlaxPegasusForConditionalGeneration >>> tokenizer =
PegasusTokenizer.from_pretrained(\u2018google/pegasus-large\u2019) >>> TXT = \u201CMy friends are <mask> but they eat too many
...
tokenizer([TXT], return_tensors=\u2018np\u2019)[\u2018input_ids\u2019] >>> logits = model(input_ids).logits`),A_.forEach(t),O_.forEach(t),S_.forEach(t),j_.forEach(t),xm=c(O),gi=s(O,"BLOCKQUOTE",{});var I_=a(gi);_i=s(I_,"BLOCKQUOTE",{});var N_=a(_i);ki=s(N_,"BLOCKQUOTE",{});var L_=a(ki);yi=s(L_,"P",{});var G_=a(yi);zm=i(G_,`masked_index = (input_ids[0] == tokenizer.mask_token_id).nonzero().item() >>> probs =
jax.nn.softmax(logits[0, masked_index], axis=0) >>> values, predictions = jax.lax.top_k(probs)`),G_.forEach(t),L_.forEach(t),N_.forEach(t),I_.forEach(t),Fm=c(O),bi=s(O,"BLOCKQUOTE",{});var D_=a(bi);vi=s(D_,"BLOCKQUOTE",{});var U_=a(vi);Ti=s(U_,"BLOCKQUOTE",{});var B_=a(Ti);wi=s(B_,"P",{});var W_=a(wi);qm=i(W_,"tokenizer.decode(predictions).split()"),W_.forEach(t),B_.forEach(t),U_.forEach(t),D_.forEach(t),O.forEach(t),Em=c(re),Wo=s(re,"DIV",{class:!0});var il=a(Wo);v(Gs.$$.fragment,il),Mm=c(il),v(Ko.$$.fragment,il),il.forEach(t),Cm=c(re),Ro=s(re,"DIV",{class:!0});var dl=a(Ro);v(Ds.$$.fragment,dl),jm=c(dl),v(Ho.$$.fragment,dl),dl.forEach(t),re.forEach(t),this.h()},h(){p(u,"name","hf:doc:metadata"),p(u,"content",JSON.stringify(gk)),p(m,"id","pegasus"),p(m,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),p(m,"href","#pegasus"),p(_,"class","relative group"),p(ie,"href","https://github.com/huggingface/transformers/issues/new?assignees=sshleifer&labels=&template=bug-report.md&title"),p(ie,"rel","nofollow"),p(ee,"id","overview"),p(ee,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),p(ee,"href","#overview"),p(G,"class","relative group"),p(pe,"href","https://arxiv.org/pdf/1912.08777.pdf"),p(pe,"rel","nofollow"),p(he,"href","https://huggingface.co/sshleifer"),p(he,"rel","nofollow"),p(fe,"href","https://github.com/google-research/pegasus"),p(fe,"rel","nofollow"),p(V,"id","checkpoints"),p(V,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),p(V,"href","#checkpoints"),p(J,"class","relative group"),p(X,"href","https://huggingface.co/models?search=pegasus"),p(X,"rel","nofollow"),p(Se,"href","https://github.com/huggingface/transformers/issues/6844#issue-689259666"),p(Se,"rel","nofollow"),p(ln,"href","https://huggingface.co/models?search=distill-pegasus"),p(ln,"rel","nofollow"),p(cn,"href","https://arxiv.org/abs/2010.13002"),p(cn,"rel","nofollow"),p(oo,"id","examples"),p(oo,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),p(oo,"href","#examples"),p(qt,"class","relative group"),p(un,"href","https://github.com/huggingface/transformers/tree/main/examples/research_projects/seq2seq-distillation/finetune_pegasus_xsum.sh"),p(un,"rel","nofollow"),p(hn,"href","https://github.com/huggingface/transformers/tree/main/examples/pytorch/summarization/README.md"),p(hn,"rel","nofollow"),p(so,"id","implementation-notes"),p(so,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),p(so,"href","#implementation-notes"),p(Et,"class","relative group"),p(Hs,"href","/docs/transformers/main/en/model_doc/bart#transformers.BartForConditionalGeneration"),p(_n,"href","https://github.com/google-research/pegasus"),p(_n,"rel","nofollow"),p(ao,"id","usage-example"),p(ao,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),p(ao,"href","#usage-example"),p(jt,"class","relative group"),p(ro,"id","transformers.PegasusConfig"),p(ro,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),p(ro,"href","#transformers.PegasusConfig"),p(St,"class","relative group"),p(Vs,"href","/docs/transformers/main/en/model_doc/pegasus#transformers.PegasusModel"),p(Tn,"href","https://huggingface.co/google/pegasus-large"),p(Tn,"rel","nofollow"),p(Qs,"href","/docs/transformers/main/en/main_classes/configuration#transformers.PretrainedConfig"),p(Js,"href","/docs/transformers/main/en/main_classes/configuration#transformers.PretrainedConfig"),p(Oe,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),p(lo,"id","transformers.PegasusTokenizer"),p(lo,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),p(lo,"href","#transformers.PegasusTokenizer"),p(It,"class","relative group"),p(xn,"href","https://github.com/google/sentencepiece"),p(xn,"rel","nofollow"),p(Xs,"href","/docs/transformers/main/en/main_classes/tokenizer#transformers.PreTrainedTokenizer"),p(Ue,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),p(po,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),p(uo,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),p(ho,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),p(H,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),p(mo,"id","transformers.PegasusTokenizerFast"),p(mo,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),p(mo,"href","#transformers.PegasusTokenizerFast"),p(Nt,"class","relative group"),p(In,"href","https://huggingface.co/docs/tokenizers/python/latest/components.html?highlight=unigram#models"),p(In,"rel","nofollow"),p(Ys,"href","/docs/transformers/main/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast"),p(gt,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),p(fo,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),p(ye,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),p(go,"id","transformers.PegasusModel"),p(go,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),p(go,"href","#transformers.PegasusModel"),p(Gt,"class","relative group"),p(ta,"href","/docs/transformers/main/en/main_classes/model#transformers.PreTrainedModel"),p(Hn,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),p(Hn,"rel","nofollow"),p(oa,"href","/docs/transformers/main/en/model_doc/pegasus#transformers.PegasusModel"),p(Be,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),p(Ae,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),p(yo,"id","transformers.PegasusForConditionalGeneration"),p(yo,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),p(yo,"href","#transformers.PegasusForConditionalGeneration"),p(Ut,"class","relative group"),p(na,"href","/docs/transformers/main/en/main_classes/model#transformers.PreTrainedModel"),p(Yn,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),p(Yn,"rel","nofollow"),p(sa,"href","/docs/transformers/main/en/model_doc/pegasus#transformers.PegasusForConditionalGeneration"),p(We,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),p(Ie,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),p(To,"id","transformers.PegasusForCausalLM"),p(To,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),p(To,"href","#transformers.PegasusForCausalLM"),p(Wt,"class","relative group"),p(wo,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),p(Kt,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),p($o,"id","transformers.TFPegasusModel"),p($o,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),p($o,"href","#transformers.TFPegasusModel"),p(Rt,"class","relative group"),p(aa,"href","/docs/transformers/main/en/main_classes/model#transformers.TFPreTrainedModel"),p(ds,"href","https://www.tensorflow.org/api_docs/python/tf/keras/Model"),p(ds,"rel","nofollow"),p(ra,"href","/docs/transformers/main/en/model_doc/pegasus#transformers.TFPegasusModel"),p(Ke,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),p(be,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),p(qo,"id","transformers.TFPegasusForConditionalGeneration"),p(qo,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),p(qo,"href","#transformers.TFPegasusForConditionalGeneration"),p(Vt,"class","relative group"),p(ia,"href","/docs/transformers/main/en/main_classes/model#transformers.TFPreTrainedModel"),p(ms,"href","https://www.tensorflow.org/api_docs/python/tf/keras/Model"),p(ms,"rel","nofollow"),p(da,"href","/docs/transformers/main/en/model_doc/pegasus#transformers.TFPegasusForConditionalGeneration"),p(Re,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),p(ve,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),p(jo,"id","transformers.FlaxPegasusModel"),p(jo,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),p(jo,"href","#transformers.FlaxPegasusModel"),p(Jt,"class","relative group"),p(la,"href","/docs/transformers/main/en/main_classes/model#transformers.FlaxPreTrainedModel"),p(bs,"href","https://flax.readthedocs.io/en/latest/_autosummary/flax.nn.module.html"),p(bs,"rel","nofollow"),p(vs,"href","https://jax.readthedocs.io/en/latest/jax.html#just-in-time-compilation-jit"),p(vs,"rel","nofollow"),p(Ts,"href","https://jax.readthedocs.io/en/latest/jax.html#automatic-differentiation"),p(Ts,"rel","nofollow"),p(ws,"href","https://jax.readthedocs.io/en/latest/jax.html#vectorization-vmap"),p(ws,"rel","nofollow"),p(Ps,"href","https://jax.readthedocs.io/en/latest/jax.html#parallelization-pmap"),p(Ps,"rel","nofollow"),p(He,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),p(Ao,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),p(No,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),p(U,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),p(Go,"id","transformers.FlaxPegasusForConditionalGeneration"),p(Go,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),p(Go,"href","#transformers.FlaxPegasusForConditionalGeneration"),p(Zt,"class","relative group"),p(ca,"href","/docs/transformers/main/en/main_classes/model#transformers.FlaxPreTrainedModel"),p(Cs,"href","https://flax.readthedocs.io/en/latest/_autosummary/flax.nn.module.html"),p(Cs,"rel","nofollow"),p(js,"href","https://jax.readthedocs.io/en/latest/jax.html#just-in-time-compilation-jit"),p(js,"rel","nofollow"),p(Ss,"href","https://jax.readthedocs.io/en/latest/jax.html#automatic-differentiation"),p(Ss,"rel","nofollow"),p(Os,"href","https://jax.readthedocs.io/en/latest/jax.html#vectorization-vmap"),p(Os,"rel","nofollow"),p(As,"href","https://jax.readthedocs.io/en/latest/jax.html#parallelization-pmap"),p(As,"rel","nofollow"),p(Bo,"id","generate-summary->>>-summary_ids-=-model.generate(inputs[\u2018input_ids\u2019]).sequences->>>"),p(Bo,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),p(Bo,"href","#generate-summary->>>-summary_ids-=-model.generate(inputs[\u2018input_ids\u2019]).sequences->>>"),p(Uo,"class","relative group"),p(C,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),p(Wo,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),p(Ro,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),p(B,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8")},m(o,g){e(document.head,u),f(o,y,g),f(o,_,g),e(_,m),e(m,k),T(d,k,null),e(_,h),e(_,E),e(E,Qe),f(o,Ne,g),f(o,L,g),e(L,Pe),e(Pe,$e),e(L,q),e(L,ie),e(ie,de),e(L,Je),f(o,Le,g),f(o,G,g),e(G,ee),e(ee,xe),T(K,xe,null),e(G,Xe),e(G,ze),e(ze,le),f(o,Ge,g),f(o,te,g),e(te,ce),e(te,pe),e(pe,Ze),e(te,Fe),f(o,S,g),f(o,A,g),e(A,Ye),f(o,oe,g),f(o,ne,g),e(ne,qe),e(qe,ue),e(ne,et),e(ne,Ee),e(Ee,D),f(o,De,g),f(o,N,g),e(N,tt),e(N,he),e(he,me),e(N,ot),e(N,fe),e(fe,Q),e(N,nt),f(o,se,g),f(o,J,g),e(J,V),e(V,I),T(ge,I,null),e(J,R),e(J,Me),e(Me,st),f(o,x,g),f(o,F,g),e(F,Tt),e(F,X),e(X,wt),e(F,Pt),e(F,M),e(M,$t),e(F,xt),f(o,mt,g),f(o,W,g),e(W,at),e(at,Z),e(W,_e),e(W,rt),e(rt,zt),e(W,ke),e(W,it),e(it,Ft),e(W,dt),e(W,Ce),e(Ce,je),e(Ce,Se),e(Se,ll),e(Ce,cl),e(W,pl),e(W,to),e(to,ln),e(ln,ul),e(to,hl),e(to,cn),e(cn,ml),e(to,fl),f(o,Li,g),f(o,qt,g),e(qt,oo),e(oo,$a),T(pn,$a,null),e(qt,gl),e(qt,xa),e(xa,_l),f(o,Gi,g),f(o,ft,g),e(ft,no),e(no,un),e(un,kl),e(no,yl),e(no,hn),e(hn,bl),e(no,vl),e(ft,Tl),e(ft,za),e(za,wl),e(ft,Pl),e(ft,Fa),e(Fa,$l),f(o,Di,g),f(o,Et,g),e(Et,so),e(so,qa),T(mn,qa,null),e(Et,xl),e(Et,Ea),e(Ea,zl),f(o,Ui,g),f(o,Te,g),e(Te,Ma),e(Ma,Ca),e(Ca,Fl),e(Te,ql),e(Te,ja),e(ja,Rs),e(Rs,El),e(Rs,Hs),e(Hs,Ml),e(Te,Cl),e(Te,fn),e(fn,Sa),e(Sa,jl),e(fn,Sl),e(fn,Mt),e(Mt,Oa),e(Oa,Ol),e(Mt,Al),e(Mt,Aa),e(Aa,Il),e(Mt,Nl),e(Mt,gn),e(gn,Ll),e(gn,Ia),e(Ia,Gl),e(gn,Dl),e(Te,Ul),e(Te,Na),e(Na,lt),e(lt,Bl),e(lt,La),e(La,Wl),e(lt,Kl),e(lt,Ga),e(Ga,Rl),e(lt,Hl),e(lt,Da),e(Da,Vl),e(lt,Ql),e(Te,Jl),e(Te,Ua),e(Ua,Ct),e(Ct,Xl),e(Ct,_n),e(_n,Zl),e(Ct,Yl),e(Ct,Ba),e(Ba,ec),e(Ct,tc),f(o,Bi,g),f(o,jt,g),e(jt,ao),e(ao,Wa),T(kn,Wa,null),e(jt,oc),e(jt,Ka),e(Ka,nc),f(o,Wi,g),T(yn,o,g),f(o,Ki,g),f(o,St,g),e(St,ro),e(ro,Ra),T(bn,Ra,null),e(St,sc),e(St,Ha),e(Ha,ac),f(o,Ri,g),f(o,Oe,g),T(vn,Oe,null),e(Oe,rc),e(Oe,Ot),e(Ot,ic),e(Ot,Vs),e(Vs,dc),e(Ot,lc),e(Ot,Tn),e(Tn,cc),e(Ot,pc),e(Oe,uc),e(Oe,At),e(At,hc),e(At,Qs),e(Qs,mc),e(At,fc),e(At,Js),e(Js,gc),e(At,_c),e(Oe,kc),T(io,Oe,null),f(o,Hi,g),f(o,It,g),e(It,lo),e(lo,Va),T(wn,Va,null),e(It,yc),e(It,Qa),e(Qa,bc),f(o,Vi,g),f(o,co,g),e(co,vc),e(co,Ja),e(Ja,Tc),e(co,wc),f(o,Qi,g),f(o,H,g),T(Pn,H,null),e(H,Pc),e(H,$n),e($n,$c),e($n,xn),e(xn,xc),e($n,zc),e(H,Fc),e(H,zn),e(zn,qc),e(zn,Xs),e(Xs,Ec),e(zn,Mc),e(H,Cc),e(H,Ue),T(Fn,Ue,null),e(Ue,jc),e(Ue,qn),e(qn,Sc),e(qn,Xa),e(Xa,Oc),e(qn,Ac),e(Ue,Ic),e(Ue,En),e(En,Zs),e(Zs,Nc),e(Zs,Za),e(Za,Lc),e(En,Gc),e(En,Mn),e(Mn,Dc),e(Mn,Ya),e(Ya,Uc),e(Mn,Bc),e(Ue,Wc),e(Ue,er),e(er,Kc),e(H,Rc),e(H,po),T(Cn,po,null),e(po,Hc),e(po,tr),e(tr,Vc),e(H,Qc),e(H,uo),T(jn,uo,null),e(uo,Jc),e(uo,or),e(or,Xc),e(H,Zc),e(H,ho),T(Sn,ho,null),e(ho,Yc),e(ho,nr),e(nr,ep),f(o,Ji,g),f(o,Nt,g),e(Nt,mo),e(mo,sr),T(On,sr,null),e(Nt,tp),e(Nt,ar),e(ar,op),f(o,Xi,g),f(o,ye,g),T(An,ye,null),e(ye,np),e(ye,Lt),e(Lt,sp),e(Lt,rr),e(rr,ap),e(Lt,rp),e(Lt,In),e(In,ip),e(Lt,dp),e(ye,lp),e(ye,Nn),e(Nn,cp),e(Nn,Ys),e(Ys,pp),e(Nn,up),e(ye,hp),e(ye,gt),T(Ln,gt,null),e(gt,mp),e(gt,ir),e(ir,fp),e(gt,gp),e(gt,Gn),e(Gn,ea),e(ea,_p),e(ea,dr),e(dr,kp),e(Gn,yp),e(Gn,Dn),e(Dn,bp),e(Dn,lr),e(lr,vp),e(Dn,Tp),e(ye,wp),e(ye,fo),T(Un,fo,null),e(fo,Pp),e(fo,cr),e(cr,$p),f(o,Zi,g),f(o,Gt,g),e(Gt,go),e(go,pr),T(Bn,pr,null),e(Gt,xp),e(Gt,ur),e(ur,zp),f(o,Yi,g),f(o,Ae,g),T(Wn,Ae,null),e(Ae,Fp),e(Ae,Kn),e(Kn,qp),e(Kn,ta),e(ta,Ep),e(Kn,Mp),e(Ae,Cp),e(Ae,Rn),e(Rn,jp),e(Rn,Hn),e(Hn,Sp),e(Rn,Op),e(Ae,Ap),e(Ae,Be),T(Vn,Be,null),e(Be,Ip),e(Be,Dt),e(Dt,Np),e(Dt,oa),e(oa,Lp),e(Dt,Gp),e(Dt,hr),e(hr,Dp),e(Dt,Up),e(Be,Bp),T(_o,Be,null),e(Be,Wp),T(ko,Be,null),f(o,ed,g),f(o,Ut,g),e(Ut,yo),e(yo,mr),T(Qn,mr,null),e(Ut,Kp),e(Ut,fr),e(fr,Rp),f(o,td,g),f(o,Ie,g),T(Jn,Ie,null),e(Ie,Hp),e(Ie,Xn),e(Xn,Vp),e(Xn,na),e(na,Qp),e(Xn,Jp),e(Ie,Xp),e(Ie,Zn),e(Zn,Zp),e(Zn,Yn),e(Yn,Yp),e(Zn,eu),e(Ie,tu),e(Ie,We),T(es,We,null),e(We,ou),e(We,Bt),e(Bt,nu),e(Bt,sa),e(sa,su),e(Bt,au),e(Bt,gr),e(gr,ru),e(Bt,iu),e(We,du),T(bo,We,null),e(We,lu),T(vo,We,null),f(o,od,g),f(o,Wt,g),e(Wt,To),e(To,_r),T(ts,_r,null),e(Wt,cu),e(Wt,kr),e(kr,pu),f(o,nd,g),f(o,Kt,g),T(os,Kt,null),e(Kt,uu),e(Kt,wo),T(ns,wo,null),e(wo,hu),T(Po,wo,null),f(o,sd,g),f(o,Rt,g),e(Rt,$o),e($o,yr),T(ss,yr,null),e(Rt,mu),e(Rt,br),e(br,fu),f(o,ad,g),f(o,be,g),T(as,be,null),e(be,gu),e(be,rs),e(rs,_u),e(rs,aa),e(aa,ku),e(rs,yu),e(be,bu),e(be,is),e(is,vu),e(is,ds),e(ds,Tu),e(is,wu),e(be,Pu),T(xo,be,null),e(be,$u),e(be,Ke),T(ls,Ke,null),e(Ke,xu),e(Ke,Ht),e(Ht,zu),e(Ht,ra),e(ra,Fu),e(Ht,qu),e(Ht,vr),e(vr,Eu),e(Ht,Mu),e(Ke,Cu),T(zo,Ke,null),e(Ke,ju),T(Fo,Ke,null),f(o,rd,g),f(o,Vt,g),e(Vt,qo),e(qo,Tr),T(cs,Tr,null),e(Vt,Su),e(Vt,wr),e(wr,Ou),f(o,id,g),f(o,ve,g),T(ps,ve,null),e(ve,Au),e(ve,us),e(us,Iu),e(us,ia),e(ia,Nu),e(us,Lu),e(ve,Gu),e(ve,hs),e(hs,Du),e(hs,ms),e(ms,Uu),e(hs,Bu),e(ve,Wu),T(Eo,ve,null),e(ve,Ku),e(ve,Re),T(fs,Re,null),e(Re,Ru),e(Re,Qt),e(Qt,Hu),e(Qt,da),e(da,Vu),e(Qt,Qu),e(Qt,Pr),e(Pr,Ju),e(Qt,Xu),e(Re,Zu),T(Mo,Re,null),e(Re,Yu),T(Co,Re,null),f(o,dd,g),f(o,Jt,g),e(Jt,jo),e(jo,$r),T(gs,$r,null),e(Jt,eh),e(Jt,xr),e(xr,th),f(o,ld,g),f(o,U,g),T(_s,U,null),e(U,oh),e(U,ks),e(ks,nh),e(ks,la),e(la,sh),e(ks,ah),e(U,rh),e(U,ys),e(ys,ih),e(ys,bs),e(bs,dh),e(ys,lh),e(U,ch),e(U,zr),e(zr,ph),e(U,uh),e(U,ct),e(ct,Fr),e(Fr,vs),e(vs,hh),e(ct,mh),e(ct,qr),e(qr,Ts),e(Ts,fh),e(ct,gh),e(ct,Er),e(Er,ws),e(ws,_h),e(ct,kh),e(ct,Mr),e(Mr,Ps),e(Ps,yh),e(U,bh),e(U,He),T($s,He,null),e(He,vh),e(He,Xt),e(Xt,Th),e(Xt,Cr),e(Cr,wh),e(Xt,Ph),e(Xt,jr),e(jr,$h),e(Xt,xh),e(He,zh),T(So,He,null),e(He,Fh),T(Oo,He,null),e(U,qh),e(U,Ao),T(xs,Ao,null),e(Ao,Eh),T(Io,Ao,null),e(U,Mh),e(U,No),T(zs,No,null),e(No,Ch),T(Lo,No,null),f(o,cd,g),f(o,Zt,g),e(Zt,Go),e(Go,Sr),T(Fs,Sr,null),e(Zt,jh),e(Zt,Or),e(Or,Sh),f(o,pd,g),f(o,B,g),T(qs,B,null),e(B,Oh),e(B,Es),e(Es,Ah),e(Es,ca),e(ca,Ih),e(Es,Nh),e(B,Lh),e(B,Ms),e(Ms,Gh),e(Ms,Cs),e(Cs,Dh),e(Ms,Uh),e(B,Bh),e(B,Ar),e(Ar,Wh),e(B,Kh),e(B,pt),e(pt,Ir),e(Ir,js),e(js,Rh),e(pt,Hh),e(pt,Nr),e(Nr,Ss),e(Ss,Vh),e(pt,Qh),e(pt,Lr),e(Lr,Os),e(Os,Jh),e(pt,Xh),e(pt,Gr),e(Gr,As),e(As,Zh),e(B,Yh),e(B,C),T(Is,C,null),e(C,em),e(C,Yt),e(Yt,tm),e(Yt,Dr),e(Dr,om),e(Yt,nm),e(Yt,Ur),e(Ur,sm),e(Yt,am),e(C,rm),T(Do,C,null),e(C,im),e(C,Br),e(Br,dm),e(C,lm),e(C,Wr),e(Wr,Kr),e(Kr,Rr),e(Rr,Hr),e(Hr,cm),e(C,pm),e(C,Vr),e(Vr,Qr),e(Qr,Jr),e(Jr,Xr),e(Xr,um),e(C,hm),e(C,Zr),e(Zr,Yr),e(Yr,ei),e(ei,ti),e(ti,mm),e(C,fm),e(C,oi),e(oi,ni),e(ni,Ns),e(Ns,Uo),e(Uo,Bo),e(Bo,si),T(Ls,si,null),e(Uo,gm),e(Uo,ai),e(ai,_m),e(Ns,km),e(Ns,ri),e(ri,ym),e(C,bm),e(C,ii),e(ii,vm),e(C,Tm),e(C,di),e(di,li),e(li,ci),e(ci,pi),e(pi,wm),e(C,Pm),e(C,ui),e(ui,hi),e(hi,mi),e(mi,fi),e(fi,$m),e(C,xm),e(C,gi),e(gi,_i),e(_i,ki),e(ki,yi),e(yi,zm),e(C,Fm),e(C,bi),e(bi,vi),e(vi,Ti),e(Ti,wi),e(wi,qm),e(B,Em),e(B,Wo),T(Gs,Wo,null),e(Wo,Mm),T(Ko,Wo,null),e(B,Cm),e(B,Ro),T(Ds,Ro,null),e(Ro,jm),T(Ho,Ro,null),ud=!0},p(o,[g]){const Us={};g&2&&(Us.$$scope={dirty:g,ctx:o}),io.$set(Us);const Pi={};g&2&&(Pi.$$scope={dirty:g,ctx:o}),_o.$set(Pi);const $i={};g&2&&($i.$$scope={dirty:g,ctx:o}),ko.$set($i);const xi={};g&2&&(xi.$$scope={dirty:g,ctx:o}),bo.$set(xi);const Vo={};g&2&&(Vo.$$scope={dirty:g,ctx:o}),vo.$set(Vo);const zi={};g&2&&(zi.$$scope={dirty:g,ctx:o}),Po.$set(zi);const Fi={};g&2&&(Fi.$$scope={dirty:g,ctx:o}),xo.$set(Fi);const Bs={};g&2&&(Bs.$$scope={dirty:g,ctx:o}),zo.$set(Bs);const qi={};g&2&&(qi.$$scope={dirty:g,ctx:o}),Fo.$set(qi);const Ei={};g&2&&(Ei.$$scope={dirty:g,ctx:o}),Eo.$set(Ei);const Mi={};g&2&&(Mi.$$scope={dirty:g,ctx:o}),Mo.$set(Mi);const Ws={};g&2&&(Ws.$$scope={dirty:g,ctx:o}),Co.$set(Ws);const Ci={};g&2&&(Ci.$$scope={dirty:g,ctx:o}),So.$set(Ci);const ji={};g&2&&(ji.$$scope={dirty:g,ctx:o}),Oo.$set(ji);const Ks={};g&2&&(Ks.$$scope={dirty:g,ctx:o}),Io.$set(Ks);const Si={};g&2&&(Si.$$scope={dirty:g,ctx:o}),Lo.$set(Si);const Oi={};g&2&&(Oi.$$scope={dirty:g,ctx:o}),Do.$set(Oi);const eo={};g&2&&(eo.$$scope={dirty:g,ctx:o}),Ko.$set(eo);const Ai={};g&2&&(Ai.$$scope={dirty:g,ctx:o}),Ho.$set(Ai)},i(o){ud||(w(d.$$.fragment,o),w(K.$$.fragment,o),w(ge.$$.fragment,o),w(pn.$$.fragment,o),w(mn.$$.fragment,o),w(kn.$$.fragment,o),w(yn.$$.fragment,o),w(bn.$$.fragment,o),w(vn.$$.fragment,o),w(io.$$.fragment,o),w(wn.$$.fragment,o),w(Pn.$$.fragment,o),w(Fn.$$.fragment,o),w(Cn.$$.fragment,o),w(jn.$$.fragment,o),w(Sn.$$.fragment,o),w(On.$$.fragment,o),w(An.$$.fragment,o),w(Ln.$$.fragment,o),w(Un.$$.fragment,o),w(Bn.$$.fragment,o),w(Wn.$$.fragment,o),w(Vn.$$.fragment,o),w(_o.$$.fragment,o),w(ko.$$.fragment,o),w(Qn.$$.fragment,o),w(Jn.$$.fragment,o),w(es.$$.fragment,o),w(bo.$$.fragment,o),w(vo.$$.fragment,o),w(ts.$$.fragment,o),w(os.$$.fragment,o),w(ns.$$.fragment,o),w(Po.$$.fragment,o),w(ss.$$.fragment,o),w(as.$$.fragment,o),w(xo.$$.fragment,o),w(ls.$$.fragment,o),w(zo.$$.fragment,o),w(Fo.$$.fragment,o),w(cs.$$.fragment,o),w(ps.$$.fragment,o),w(Eo.$$.fragment,o),w(fs.$$.fragment,o),w(Mo.$$.fragment,o),w(Co.$$.fragment,o),w(gs.$$.fragment,o),w(_s.$$.fragment,o),w($s.$$.fragment,o),w(So.$$.fragment,o),w(Oo.$$.fragment,o),w(xs.$$.fragment,o),w(Io.$$.fragment,o),w(zs.$$.fragment,o),w(Lo.$$.fragment,o),w(Fs.$$.fragment,o),w(qs.$$.fragment,o),w(Is.$$.fragment,o),w(Do.$$.fragment,o),w(Ls.$$.fragment,o),w(Gs.$$.fragment,o),w(Ko.$$.fragment,o),w(Ds.$$.fragment,o),w(Ho.$$.fragment,o),ud=!0)},o(o){P(d.$$.fragment,o),P(K.$$.fragment,o),P(ge.$$.fragment,o),P(pn.$$.fragment,o),P(mn.$$.fragment,o),P(kn.$$.fragment,o),P(yn.$$.fragment,o),P(bn.$$.fragment,o),P(vn.$$.fragment,o),P(io.$$.fragment,o),P(wn.$$.fragment,o),P(Pn.$$.fragment,o),P(Fn.$$.fragment,o),P(Cn.$$.fragment,o),P(jn.$$.fragment,o),P(Sn.$$.fragment,o),P(On.$$.fragment,o),P(An.$$.fragment,o),P(Ln.$$.fragment,o),P(Un.$$.fragment,o),P(Bn.$$.fragment,o),P(Wn.$$.fragment,o),P(Vn.$$.fragment,o),P(_o.$$.fragment,o),P(ko.$$.fragment,o),P(Qn.$$.fragment,o),P(Jn.$$.fragment,o),P(es.$$.fragment,o),P(bo.$$.fragment,o),P(vo.$$.fragment,o),P(ts.$$.fragment,o),P(os.$$.fragment,o),P(ns.$$.fragment,o),P(Po.$$.fragment,o),P(ss.$$.fragment,o),P(as.$$.fragment,o),P(xo.$$.fragment,o),P(ls.$$.fragment,o),P(zo.$$.fragment,o),P(Fo.$$.fragment,o),P(cs.$$.fragment,o),P(ps.$$.fragment,o),P(Eo.$$.fragment,o),P(fs.$$.fragment,o),P(Mo.$$.fragment,o),P(Co.$$.fragment,o),P(gs.$$.fragment,o),P(_s.$$.fragment,o),P($s.$$.fragment,o),P(So.$$.fragment,o),P(Oo.$$.fragment,o),P(xs.$$.fragment,o),P(Io.$$.fragment,o),P(zs.$$.fragment,o),P(Lo.$$.fragment,o),P(Fs.$$.fragment,o),P(qs.$$.fragment,o),P(Is.$$.fragment,o),P(Do.$$.fragment,o),P(Ls.$$.fragment,o),P(Gs.$$.fragment,o),P(Ko.$$.fragment,o),P(Ds.$$.fragment,o),P(Ho.$$.fragment,o),ud=!1},d(o){t(u),o&&t(y),o&&t(_),$(d),o&&t(Ne),o&&t(L),o&&t(Le),o&&t(G),$(K),o&&t(Ge),o&&t(te),o&&t(S),o&&t(A),o&&t(oe),o&&t(ne),o&&t(De),o&&t(N),o&&t(se),o&&t(J),$(ge),o&&t(x),o&&t(F),o&&t(mt),o&&t(W),o&&t(Li),o&&t(qt),$(pn),o&&t(Gi),o&&t(ft),o&&t(Di),o&&t(Et),$(mn),o&&t(Ui),o&&t(Te),o&&t(Bi),o&&t(jt),$(kn),o&&t(Wi),$(yn,o),o&&t(Ki),o&&t(St),$(bn),o&&t(Ri),o&&t(Oe),$(vn),$(io),o&&t(Hi),o&&t(It),$(wn),o&&t(Vi),o&&t(co),o&&t(Qi),o&&t(H),$(Pn),$(Fn),$(Cn),$(jn),$(Sn),o&&t(Ji),o&&t(Nt),$(On),o&&t(Xi),o&&t(ye),$(An),$(Ln),$(Un),o&&t(Zi),o&&t(Gt),$(Bn),o&&t(Yi),o&&t(Ae),$(Wn),$(Vn),$(_o),$(ko),o&&t(ed),o&&t(Ut),$(Qn),o&&t(td),o&&t(Ie),$(Jn),$(es),$(bo),$(vo),o&&t(od),o&&t(Wt),$(ts),o&&t(nd),o&&t(Kt),$(os),$(ns),$(Po),o&&t(sd),o&&t(Rt),$(ss),o&&t(ad),o&&t(be),$(as),$(xo),$(ls),$(zo),$(Fo),o&&t(rd),o&&t(Vt),$(cs),o&&t(id),o&&t(ve),$(ps),$(Eo),$(fs),$(Mo),$(Co),o&&t(dd),o&&t(Jt),$(gs),o&&t(ld),o&&t(U),$(_s),$($s),$(So),$(Oo),$(xs),$(Io),$(zs),$(Lo),o&&t(cd),o&&t(Zt),$(Fs),o&&t(pd),o&&t(B),$(qs),$(Is),$(Do),$(Ls),$(Gs),$(Ko),$(Ds),$(Ho)}}}const gk={local:"pegasus",sections:[{local:"overview",title:"Overview"},{local:"checkpoints",sections:[{local:"examples",title:"Examples"}],title:"Checkpoints"},{local:"implementation-notes",title:"Implementation Notes"},{local:"usage-example",title:"Usage Example"},{local:"transformers.PegasusConfig",title:"PegasusConfig"},{local:"transformers.PegasusTokenizer",title:"PegasusTokenizer"},{local:"transformers.PegasusTokenizerFast",title:"PegasusTokenizerFast"},{local:"transformers.PegasusModel",title:"PegasusModel"},{local:"transformers.PegasusForConditionalGeneration",title:"PegasusForConditionalGeneration"},{local:"transformers.PegasusForCausalLM",title:"PegasusForCausalLM"},{local:"transformers.TFPegasusModel",title:"TFPegasusModel"},{local:"transformers.TFPegasusForConditionalGeneration",title:"TFPegasusForConditionalGeneration"},{local:"transformers.FlaxPegasusModel",title:"FlaxPegasusModel"},{local:"transformers.FlaxPegasusForConditionalGeneration",title:"FlaxPegasusForConditionalGeneration"}],title:"Pegasus"};function _k(z){return Q_(()=>{new URLSearchParams(window.location.search).get("fw")}),[]}class Pk extends K_{constructor(u){super();R_(this,u,_k,fk,H_,{})}}export{Pk as default,gk as metadata};
