import{S as Xn,i as Sn,s as qn,e as s,k as m,w as y,t as i,M as En,c as a,d as t,m as f,a as r,x as T,h as d,b as c,G as o,g,y as k,q as w,o as P,B as $,v as Cn,L as Wt}from"../../chunks/vendor-hf-doc-builder.js";import{T as xn}from"../../chunks/Tip-hf-doc-builder.js";import{D as to}from"../../chunks/Docstring-hf-doc-builder.js";import{C as Rt}from"../../chunks/CodeBlock-hf-doc-builder.js";import{I as no}from"../../chunks/IconCopyLink-hf-doc-builder.js";import{E as Dt}from"../../chunks/ExampleCodeBlock-hf-doc-builder.js";function Fn(S){let l,v,_,p,b;return p=new Rt({props:{code:`from transformers import PegasusXModel, PegasusXConfig
...
`}}),B=new xn({props:{$$slots:{default:[Mn]},$$scope:{ctx:S}}}),V=new Dt({props:{anchor:"transformers.PegasusXModel.forward.example",$$slots:{default:[An]},$$scope:{ctx:S}}}),fe=new no({}),ge=new to({props:{name:"class transformers.PegasusXForConditionalGeneration",anchor:"transformers.PegasusXForConditionalGeneration",parameters:[{name:"config",val:": PegasusXConfig"}],parametersDescription:[{anchor:"transformers.PegasusXForConditionalGeneration.config",description:`<strong>config</strong> (<a href="/docs/transformers/main/en/model_doc/pegasus_x#transformers.PegasusXConfig">PegasusXConfig</a>) &#x2014;
Model configuration class with all the parameters of the model. Initializing with a config file does not
load the weights associated with the model, only the configuration. Check out the
...
`}}),J=new xn({props:{$$slots:{default:[Gn]},$$scope:{ctx:S}}}),K=new Dt({props:{anchor:"transformers.PegasusXForConditionalGeneration.forward.example",$$slots:{default:[jn]},$$scope:{ctx:S}}}),{c(){l=s("meta"),v=m(),_=s("h1"),p=s("a"),b=s("span"),y(n.$$.fragment),h=m(),C=s("span"),Xo=i("PEGASUS-X"),so=m(),M=s("h2"),L=s("a"),Ne=s("span"),y(ne.$$.fragment),So=m(),Le=s("span"),qo=i("Overview"),ao=m(),D=s("p"),Eo=i("The PEGASUS-X model was proposed in "),se=s("a"),Co=i("Investigating Efficiently Extending Transformers for Long Input Summarization"),Fo=i("  by Jason Phang, Yao Zhao and Peter J. Liu."),ro=m(),we=s("p"),Mo=i("PEGASUS-X (PEGASUS eXtended) extends the PEGASUS models for long input summarization through additional long input pretraining and using staggered block-local attention with global tokens in the encoder."),io=m(),Pe=s("p"),Ao=i("The abstract from the paper is the following:"),lo=m(),$e=s("p"),De=s("em"),Go=i("While large pretrained Transformer models have proven highly capable at tackling natural language tasks, handling long sequence inputs continues to be a significant challenge. One such task is long input summarization, where inputs are longer than the maximum input context of most pretrained models. Through an extensive set of experiments, we investigate what model architectural changes and pretraining paradigms can most efficiently adapt a pretrained Transformer for long input summarization. We find that a staggered, block-local Transformer with global encoder tokens strikes a good balance of performance and efficiency, and that an additional pretraining phase on long sequences meaningfully improves downstream summarization performance. Based on our findings, we introduce PEGASUS-X, an extension of the PEGASUS model with additional long input pretraining to handle inputs of up to 16K tokens. PEGASUS-X achieves strong performance on long input summarization tasks comparable with much larger models while adding few additional parameters and not requiring model parallelism to train."),co=m(),ze=s("p"),jo=i("Tips:"),uo=m(),xe=s("ul"),We=s("li"),Oo=i("PEGASUS-X uses the same tokenizer as PEGASUS."),po=m(),F=s("p"),Io=i("This model was contributed by "),Xe=s("a"),Uo=i("zphang"),No=i(". The original code can be found "),ae=s("a"),Lo=i("here"),Do=i("."),ho=m(),A=s("h2"),W=s("a"),Re=s("span"),y(re.$$.fragment),Wo=m(),He=s("span"),Ro=i("PegasusXConfig"),mo=m(),z=s("div"),y(ie.$$.fragment),Ho=m(),G=s("p"),Bo=i("This is the configuration class to store the configuration of a "),Se=s("a"),Vo=i("PegasusXModel"),Zo=i(`. It is used to instantiate a
...
documentation from `),Ee=s("a"),tt=i("PretrainedConfig"),nt=i(" for more information."),st=m(),y(R.$$.fragment),fo=m(),O=s("h2"),H=s("a"),Be=s("span"),y(le.$$.fragment),at=m(),Ve=s("span"),rt=i("PegasusXModel"),go=m(),x=s("div"),y(ce.$$.fragment),it=m(),ue=s("p"),dt=i(`The bare PEGASUS-X Model outputting raw hidden-states without any specific head on top.
...
and behavior.`),ft=m(),q=s("div"),y(me.$$.fragment),gt=m(),I=s("p"),_t=i("The "),Fe=s("a"),bt=i("PegasusXModel"),vt=i(" forward method, overrides the "),Ze=s("code"),yt=i("__call__"),Tt=i(" special method."),kt=m(),y(B.$$.fragment),wt=m(),y(V.$$.fragment),_o=m(),U=s("h2"),Z=s("a"),Je=s("span"),y(fe.$$.fragment),Pt=m(),Ke=s("span"),$t=i("PegasusXForConditionalGeneration"),bo=m(),X=s("div"),y(ge.$$.fragment),zt=m(),_e=s("p"),xt=i(`The PEGASUS-X for conditional generation (e.g. summarization).
This model inherits from `),Me=s("a"),Xt=i("PreTrainedModel"),St=i(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),qt=m(),be=s("p"),Et=i("This model is also a PyTorch "),ve=s("a"),Ct=i("torch.nn.Module"),Ft=i(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Mt=m(),E=s("div"),y(ye.$$.fragment),At=m(),N=s("p"),Gt=i("The "),Ae=s("a"),jt=i("PegasusXForConditionalGeneration"),Ot=i(" forward method, overrides the "),Ye=s("code"),It=i("__call__"),Ut=i(" special method."),Nt=m(),y(J.$$.fragment),Lt=m(),y(K.$$.fragment),this.h()},l(e){const u=En('[data-svelte="svelte-1phssyn"]',document.head);l=a(u,"META",{name:!0,content:!0}),u.forEach(t),v=f(e),_=a(e,"H1",{class:!0});var Te=r(_);p=a(Te,"A",{id:!0,class:!0,href:!0});var Qe=r(p);b=a(Qe,"SPAN",{});var eo=r(b);T(n.$$.fragment,eo),eo.forEach(t),Qe.forEach(t),h=f(Te),C=a(Te,"SPAN",{});var oo=r(C);Xo=d(oo,"PEGASUS-X"),oo.forEach(t),Te.forEach(t),so=f(e),M=a(e,"H2",{class:!0});var ke=r(M);L=a(ke,"A",{id:!0,class:!0,href:!0});var Ht=r(L);Ne=a(Ht,"SPAN",{});var Bt=r(Ne);T(ne.$$.fragment,Bt),Bt.forEach(t),Ht.forEach(t),So=f(ke),Le=a(ke,"SPAN",{});var Vt=r(Le);qo=d(Vt,"Overview"),Vt.forEach(t),ke.forEach(t),ao=f(e),D=a(e,"P",{});var yo=r(D);Eo=d(yo,"The PEGASUS-X model was proposed in "),se=a(yo,"A",{href:!0,rel:!0});var Zt=r(se);Co=d(Zt,"Investigating Efficiently Extending Transformers for Long Input Summarization"),Zt.forEach(t),Fo=d(yo,"  by Jason Phang, Yao Zhao and Peter J. Liu."),yo.forEach(t),ro=f(e),we=a(e,"P",{});var Jt=r(we);Mo=d(Jt,"PEGASUS-X (PEGASUS eXtended) extends the PEGASUS models for long input summarization through additional long input pretraining and using staggered block-local attention with global tokens in the encoder."),Jt.forEach(t),io=f(e),Pe=a(e,"P",{});var Kt=r(Pe);Ao=d(Kt,"The abstract from the paper is the following:"),Kt.forEach(t),lo=f(e),$e=a(e,"P",{});var Yt=r($e);De=a(Yt,"EM",{});var Qt=r(De);Go=d(Qt,"While large pretrained Transformer models have proven highly capable at tackling natural language tasks, handling long sequence inputs continues to be a significant challenge. One such task is long input summarization, where inputs are longer than the maximum input context of most pretrained models. Through an extensive set of experiments, we investigate what model architectural changes and pretraining paradigms can most efficiently adapt a pretrained Transformer for long input summarization. We find that a staggered, block-local Transformer with global encoder tokens strikes a good balance of performance and efficiency, and that an additional pretraining phase on long sequences meaningfully improves downstream summarization performance. Based on our findings, we introduce PEGASUS-X, an extension of the PEGASUS model with additional long input pretraining to handle inputs of up to 16K tokens. PEGASUS-X achieves strong performance on long input summarization tasks comparable with much larger models while adding few additional parameters and not requiring model parallelism to train."),Qt.forEach(t),Yt.forEach(t),co=f(e),ze=a(e,"P",{});var en=r(ze);jo=d(en,"Tips:"),en.forEach(t),uo=f(e),xe=a(e,"UL",{});var on=r(xe);We=a(on,"LI",{});var tn=r(We);Oo=d(tn,"PEGASUS-X uses the same tokenizer as PEGASUS."),tn.forEach(t),on.forEach(t),po=f(e),F=a(e,"P",{});var Ge=r(F);Io=d(Ge,"This model was contributed by "),Xe=a(Ge,"A",{href:!0});var nn=r(Xe);Uo=d(nn,"zphang"),nn.forEach(t),No=d(Ge,". The original code can be found "),ae=a(Ge,"A",{href:!0,rel:!0});var sn=r(ae);Lo=d(sn,"here"),sn.forEach(t),Do=d(Ge,"."),Ge.forEach(t),ho=f(e),A=a(e,"H2",{class:!0});var To=r(A);W=a(To,"A",{id:!0,class:!0,href:!0});var an=r(W);Re=a(an,"SPAN",{});var rn=r(Re);T(re.$$.fragment,rn),rn.forEach(t),an.forEach(t),Wo=f(To),He=a(To,"SPAN",{});var dn=r(He);Ro=d(dn,"PegasusXConfig"),dn.forEach(t),To.forEach(t),mo=f(e),z=a(e,"DIV",{class:!0});var Y=r(z);T(ie.$$.fragment,Y),Ho=f(Y),G=a(Y,"P",{});var je=r(G);Bo=d(je,"This is the configuration class to store the configuration of a "),Se=a(je,"A",{href:!0});var ln=r(Se);Vo=d(ln,"PegasusXModel"),ln.forEach(t),Zo=d(je,`. It is used to instantiate a
PEGASUS-X model according to the specified arguments, defining the model architecture. Instantiating a
configuration with the defaults will yield a similar configuration to that of the PEGASUS-X
...
documentation from `),Ee=a(Oe,"A",{href:!0});var pn=r(Ee);tt=d(pn,"PretrainedConfig"),pn.forEach(t),nt=d(Oe," for more information."),Oe.forEach(t),st=f(Y),T(R.$$.fragment,Y),Y.forEach(t),fo=f(e),O=a(e,"H2",{class:!0});var ko=r(O);H=a(ko,"A",{id:!0,class:!0,href:!0});var hn=r(H);Be=a(hn,"SPAN",{});var mn=r(Be);T(le.$$.fragment,mn),mn.forEach(t),hn.forEach(t),at=f(ko),Ve=a(ko,"SPAN",{});var fn=r(Ve);rt=d(fn,"PegasusXModel"),fn.forEach(t),ko.forEach(t),go=f(e),x=a(e,"DIV",{class:!0});var Q=r(x);T(ce.$$.fragment,Q),it=f(Q),ue=a(Q,"P",{});var wo=r(ue);dt=d(wo,`The bare PEGASUS-X Model outputting raw hidden-states without any specific head on top.
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),wo.forEach(t),ut=f(Q),pe=a(Q,"P",{});var Po=r(pe);pt=d(Po,"This model is also a PyTorch "),he=a(Po,"A",{href:!0,rel:!0});var _n=r(he);ht=d(_n,"torch.nn.Module"),_n.forEach(t),mt=d(Po,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Po.forEach(t),ft=f(Q),q=a(Q,"DIV",{class:!0});var ee=r(q);T(me.$$.fragment,ee),gt=f(ee),I=a(ee,"P",{});var Ie=r(I);_t=d(Ie,"The "),Fe=a(Ie,"A",{href:!0});var bn=r(Fe);bt=d(bn,"PegasusXModel"),bn.forEach(t),vt=d(Ie," forward method, overrides the "),Ze=a(Ie,"CODE",{});var vn=r(Ze);yt=d(vn,"__call__"),vn.forEach(t),Tt=d(Ie," special method."),Ie.forEach(t),kt=f(ee),T(B.$$.fragment,ee),wt=f(ee),T(V.$$.fragment,ee),ee.forEach(t),Q.forEach(t),_o=f(e),U=a(e,"H2",{class:!0});var $o=r(U);Z=a($o,"A",{id:!0,class:!0,href:!0});var yn=r(Z);Je=a(yn,"SPAN",{});var Tn=r(Je);T(fe.$$.fragment,Tn),Tn.forEach(t),yn.forEach(t),Pt=f($o),Ke=a($o,"SPAN",{});var kn=r(Ke);$t=d(kn,"PegasusXForConditionalGeneration"),kn.forEach(t),$o.forEach(t),bo=f(e),X=a(e,"DIV",{class:!0});var oe=r(X);T(ge.$$.fragment,oe),zt=f(oe),_e=a(oe,"P",{});var zo=r(_e);xt=d(zo,`The PEGASUS-X for conditional generation (e.g. summarization).
This model inherits from `),Me=a(zo,"A",{href:!0});var wn=r(Me);Xt=d(wn,"PreTrainedModel"),wn.forEach(t),St=d(zo,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),zo.forEach(t),qt=f(oe),be=a(oe,"P",{});var xo=r(be);Et=d(xo,"This model is also a PyTorch "),ve=a(xo,"A",{href:!0,rel:!0});var Pn=r(ve);Ct=d(Pn,"torch.nn.Module"),Pn.forEach(t),Ft=d(xo,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),xo.forEach(t),Mt=f(oe),E=a(oe,"DIV",{class:!0});var te=r(E);T(ye.$$.fragment,te),At=f(te),N=a(te,"P",{});var Ue=r(N);Gt=d(Ue,"The "),Ae=a(Ue,"A",{href:!0});var $n=r(Ae);jt=d($n,"PegasusXForConditionalGeneration"),$n.forEach(t),Ot=d(Ue," forward method, overrides the "),Ye=a(Ue,"CODE",{});var zn=r(Ye);It=d(zn,"__call__"),zn.forEach(t),Ut=d(Ue," special method."),Ue.forEach(t),Nt=f(te),T(J.$$.fragment,te),Lt=f(te),T(K.$$.fragment,te),te.forEach(t),oe.forEach(t),this.h()},h(){c(l,"name","hf:doc:metadata"),c(l,"content",JSON.stringify(In)),c(p,"id","pegasusx"),c(p,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(p,"href","#pegasusx"),c(_,"class","relative group"),c(L,"id","overview"),c(L,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(L,"href","#overview"),c(M,"class","relative group"),c(se,"href","https://arxiv.org/abs/2208.04347"),c(se,"rel","nofollow"),c(Xe,"href","<https://huggingface.co/zphang"),c(ae,"href","https://github.com/google-research/pegasus"),c(ae,"rel","nofollow"),c(W,"id","transformers.PegasusXConfig"),c(W,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(W,"href","#transformers.PegasusXConfig"),c(A,"class","relative group"),c(Se,"href","/docs/transformers/main/en/model_doc/pegasus_x#transformers.PegasusXModel"),c(de,"href","https://huggingface.co/google/pegasus-x-large"),c(de,"rel","nofollow"),c(qe,"href","/docs/transformers/main/en/main_classes/configuration#transformers.PretrainedConfig"),c(Ee,"href","/docs/transformers/main/en/main_classes/configuration#transformers.PretrainedConfig"),c(z,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),c(H,"id","transformers.PegasusXModel"),c(H,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(H,"href","#transformers.PegasusXModel"),c(O,"class","relative group"),c(Ce,"href","/docs/transformers/main/en/main_classes/model#transformers.PreTrainedModel"),c(he,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),c(he,"rel","nofollow"),c(Fe,"href","/docs/transformers/main/en/model_doc/pegasus_x#transformers.PegasusXModel"),c(q,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),c(x,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),c(Z,"id","transformers.PegasusXForConditionalGeneration"),c(Z,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(Z,"href","#transformers.PegasusXForConditionalGeneration"),c(U,"class","relative group"),c(Me,"href","/docs/transformers/main/en/main_classes/model#transformers.PreTrainedModel"),c(ve,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),c(ve,"rel","nofollow"),c(Ae,"href","/docs/transformers/main/en/model_doc/pegasus_x#transformers.PegasusXForConditionalGeneration"),c(E,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),c(X,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8")},m(e,u){o(document.head,l),g(e,v,u),g(e,_,u),o(_,p),o(p,b),k(n,b,null),o(_,h),o(_,C),o(C,Xo),g(e,so,u),g(e,M,u),o(M,L),o(L,Ne),k(ne,Ne,null),o(M,So),o(M,Le),o(Le,qo),g(e,ao,u),g(e,D,u),o(D,Eo),o(D,se),o(se,Co),o(D,Fo),g(e,ro,u),g(e,we,u),o(we,Mo),g(e,io,u),g(e,Pe,u),o(Pe,Ao),g(e,lo,u),g(e,$e,u),o($e,De),o(De,Go),g(e,co,u),g(e,ze,u),o(ze,jo),g(e,uo,u),g(e,xe,u),o(xe,We),o(We,Oo),g(e,po,u),g(e,F,u),o(F,Io),o(F,Xe),o(Xe,Uo),o(F,No),o(F,ae),o(ae,Lo),o(F,Do),g(e,ho,u),g(e,A,u),o(A,W),o(W,Re),k(re,Re,null),o(A,Wo),o(A,He),o(He,Ro),g(e,mo,u),g(e,z,u),k(ie,z,null),o(z,Ho),o(z,G),o(G,Bo),o(G,Se),o(Se,Vo),o(G,Zo),o(G,de),o(de,Jo),o(G,Ko),o(z,Yo),o(z,j),o(j,Qo),o(j,qe),o(qe,et),o(j,ot),o(j,Ee),o(Ee,tt),o(j,nt),o(z,st),k(R,z,null),g(e,fo,u),g(e,O,u),o(O,H),o(H,Be),k(le,Be,null),o(O,at),o(O,Ve),o(Ve,rt),g(e,go,u),g(e,x,u),k(ce,x,null),o(x,it),o(x,ue),o(ue,dt),o(ue,Ce),o(Ce,lt),o(ue,ct),o(x,ut),o(x,pe),o(pe,pt),o(pe,he),o(he,ht),o(pe,mt),o(x,ft),o(x,q),k(me,q,null),o(q,gt),o(q,I),o(I,_t),o(I,Fe),o(Fe,bt),o(I,vt),o(I,Ze),o(Ze,yt),o(I,Tt),o(q,kt),k(B,q,null),o(q,wt),k(V,q,null),g(e,_o,u),g(e,U,u),o(U,Z),o(Z,Je),k(fe,Je,null),o(U,Pt),o(U,Ke),o(Ke,$t),g(e,bo,u),g(e,X,u),k(ge,X,null),o(X,zt),o(X,_e),o(_e,xt),o(_e,Me),o(Me,Xt),o(_e,St),o(X,qt),o(X,be),o(be,Et),o(be,ve),o(ve,Ct),o(be,Ft),o(X,Mt),o(X,E),k(ye,E,null),o(E,At),o(E,N),o(N,Gt),o(N,Ae),o(Ae,jt),o(N,Ot),o(N,Ye),o(Ye,It),o(N,Ut),o(E,Nt),k(J,E,null),o(E,Lt),k(K,E,null),vo=!0},p(e,[u]){const Te={};u&2&&(Te.$$scope={dirty:u,ctx:e}),R.$set(Te);const Qe={};u&2&&(Qe.$$scope={dirty:u,ctx:e}),B.$set(Qe);const eo={};u&2&&(eo.$$scope={dirty:u,ctx:e}),V.$set(eo);const oo={};u&2&&(oo.$$scope={dirty:u,ctx:e}),J.$set(oo);const ke={};u&2&&(ke.$$scope={dirty:u,ctx:e}),K.$set(ke)},i(e){vo||(w(n.$$.fragment,e),w(ne.$$.fragment,e),w(re.$$.fragment,e),w(ie.$$.fragment,e),w(R.$$.fragment,e),w(le.$$.fragment,e),w(ce.$$.fragment,e),w(me.$$.fragment,e),w(B.$$.fragment,e),w(V.$$.fragment,e),w(fe.$$.fragment,e),w(ge.$$.fragment,e),w(ye.$$.fragment,e),w(J.$$.fragment,e),w(K.$$.fragment,e),vo=!0)},o(e){P(n.$$.fragment,e),P(ne.$$.fragment,e),P(re.$$.fragment,e),P(ie.$$.fragment,e),P(R.$$.fragment,e),P(le.$$.fragment,e),P(ce.$$.fragment,e),P(me.$$.fragment,e),P(B.$$.fragment,e),P(V.$$.fragment,e),P(fe.$$.fragment,e),P(ge.$$.fragment,e),P(ye.$$.fragment,e),P(J.$$.fragment,e),P(K.$$.fragment,e),vo=!1},d(e){t(l),e&&t(v),e&&t(_),$(n),e&&t(so),e&&t(M),$(ne),e&&t(ao),e&&t(D),e&&t(ro),e&&t(we),e&&t(io),e&&t(Pe),e&&t(lo),e&&t($e),e&&t(co),e&&t(ze),e&&t(uo),e&&t(xe),e&&t(po),e&&t(F),e&&t(ho),e&&t(A),$(re),e&&t(mo),e&&t(z),$(ie),$(R),e&&t(fo),e&&t(O),$(le),e&&t(go),e&&t(x),$(ce),$(me),$(B),$(V),e&&t(_o),e&&t(U),$(fe),e&&t(bo),e&&t(X),$(ge),$(ye),$(J),$(K)}}}const In={local:"pegasusx",sections:[{local:"overview",title:"Overview"},{local:"transformers.PegasusXConfig",title:"PegasusXConfig"},{local:"transformers.PegasusXModel",title:"PegasusXModel"},{local:"transformers.PegasusXForConditionalGeneration",title:"PegasusXForConditionalGeneration"}],title:"PEGASUS-X"};function Un(S){return Cn(()=>{new URLSearchParams(window.location.search).get("fw")}),[]}class Bn extends Xn{constructor(l){super();Sn(this,l,Un,On,qn,{})}}export{Bn as default,In as metadata};
