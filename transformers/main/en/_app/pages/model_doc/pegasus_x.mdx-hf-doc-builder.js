...
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),h.forEach(t)},m(n,h){g(n,l,h),o(l,v),o(l,_),o(_,p),o(l,b)},d(n){n&&t(l)}}}function An(S){let l,v,_,p,b;return p=new Bt({props:{code:`from transformers import PegasusTokenizer, PegasusModel
...
the latter silently ignores them.`)},l(n){l=a(n,"P",{});var h=r(l);v=d(h,"Although the recipe for forward pass needs to be defined within this function, one should call the "),_=a(h,"CODE",{});var C=r(_);p=d(C,"Module"),C.forEach(t),b=d(h,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),h.forEach(t)},m(n,h){g(n,l,h),o(l,v),o(l,_),o(_,p),o(l,b)},d(n){n&&t(l)}}}function jn(S){let l,v,_,p,b;return p=new Bt({props:{code:`from transformers import PegasusTokenizer, PegasusXForConditionalGeneration
...
Whether or not to return a <a href="/docs/transformers/main/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/pegasus_x/modeling_pegasus_x.py#L1429",returnDescription:`
<p>A <a
...
`}}),H=new xn({props:{$$slots:{default:[Fn]},$$scope:{ctx:S}}}),V=new Dt({props:{anchor:"transformers.PegasusXModel.forward.example",$$slots:{default:[An]},$$scope:{ctx:S}}}),fe=new no({}),ge=new to({props:{name:"class transformers.PegasusXForConditionalGeneration",anchor:"transformers.PegasusXForConditionalGeneration",parameters:[{name:"config",val:": PegasusXConfig"}],parametersDescription:[{anchor:"transformers.PegasusXForConditionalGeneration.config",description:`<strong>config</strong> (<a href="/docs/transformers/main/en/model_doc/pegasus_x#transformers.PegasusXConfig">PegasusXConfig</a>) &#x2014;
Model configuration class with all the parameters of the model. Initializing with a config file does not
load the weights associated with the model, only the configuration. Check out the
<a href="/docs/transformers/main/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/pegasus_x/modeling_pegasus_x.py#L1520"}}),ye=new to({props:{name:"forward",anchor:"transformers.PegasusXForConditionalGeneration.forward",parameters:[{name:"input_ids",val:": typing.Optional[torch.Tensor] = None"},{name:"attention_mask",val:": typing.Optional[torch.Tensor] = None"},{name:"decoder_input_ids",val:": typing.Optional[torch.Tensor] = None"},{name:"decoder_attention_mask",val:": typing.Optional[torch.Tensor] = None"},{name:"encoder_outputs",val:": typing.Optional[typing.Tuple[torch.FloatTensor]] = None"},{name:"past_key_values",val:": typing.Optional[typing.Tuple[torch.FloatTensor]] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.Tensor] = None"},{name:"decoder_inputs_embeds",val:": typing.Optional[torch.Tensor] = None"},{name:"labels",val:": typing.Optional[torch.Tensor] = None"},{name:"use_cache",val:": typing.Optional[bool] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.PegasusXForConditionalGeneration.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. Padding will be ignored by default should you provide
it.</p>
<p>Indices can be obtained using <a href="/docs/transformers/main/en/model_doc/pegasus#transformers.PegasusTokenizer">PegasusTokenizer</a>. See <a href="/docs/transformers/main/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/main/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
(masked), the loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/pegasus_x/modeling_pegasus_x.py#L1578",returnDescription:`
<p>A <a
...
documentation from `),Ee=s("a"),tt=i("PretrainedConfig"),nt=i(" for more information."),st=m(),y(B.$$.fragment),fo=m(),O=s("h2"),R=s("a"),He=s("span"),y(le.$$.fragment),at=m(),Ve=s("span"),rt=i("PegasusXModel"),go=m(),x=s("div"),y(ce.$$.fragment),it=m(),ue=s("p"),dt=i(`The bare PEGASUS-X Model outputting raw hidden-states without any specific head on top.
...
and behavior.`),ft=m(),q=s("div"),y(me.$$.fragment),gt=m(),I=s("p"),_t=i("The "),Me=s("a"),bt=i("PegasusXModel"),vt=i(" forward method, overrides the "),Ze=s("code"),yt=i("__call__"),Tt=i(" special method."),kt=m(),y(H.$$.fragment),wt=m(),y(V.$$.fragment),_o=m(),U=s("h2"),Z=s("a"),Je=s("span"),y(fe.$$.fragment),Pt=m(),Ke=s("span"),$t=i("PegasusXForConditionalGeneration"),bo=m(),X=s("div"),y(ge.$$.fragment),zt=m(),_e=s("p"),xt=i(`The PEGASUS-X for conditional generation (e.g. summarization).
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Ft=m(),E=s("div"),y(ye.$$.fragment),At=m(),N=s("p"),Gt=i("The "),Ae=s("a"),jt=i("PegasusXForConditionalGeneration"),Ot=i(" forward method, overrides the "),Ye=s("code"),It=i("__call__"),Ut=i(" special method."),Nt=m(),y(J.$$.fragment),Lt=m(),y(K.$$.fragment),this.h()},l(e){const u=En('[data-svelte="svelte-1phssyn"]',document.head);l=a(u,"META",{name:!0,content:!0}),u.forEach(t),v=f(e),_=a(e,"H1",{class:!0});var Te=r(_);p=a(Te,"A",{id:!0,class:!0,href:!0});var Qe=r(p);b=a(Qe,"SPAN",{});var eo=r(b);T(n.$$.fragment,eo),eo.forEach(t),Qe.forEach(t),h=f(Te),C=a(Te,"SPAN",{});var oo=r(C);Xo=d(oo,"PEGASUS-X"),oo.forEach(t),Te.forEach(t),so=f(e),F=a(e,"H2",{class:!0});var ke=r(F);L=a(ke,"A",{id:!0,class:!0,href:!0});var Rt=r(L);Ne=a(Rt,"SPAN",{});var Ht=r(Ne);T(ne.$$.fragment,Ht),Ht.forEach(t),Rt.forEach(t),So=f(ke),Le=a(ke,"SPAN",{});var Vt=r(Le);qo=d(Vt,"Overview"),Vt.forEach(t),ke.forEach(t),ao=f(e),D=a(e,"P",{});var yo=r(D);Eo=d(yo,"The PEGASUS-X model was proposed in "),se=a(yo,"A",{href:!0,rel:!0});var Zt=r(se);Co=d(Zt,"Investigating Efficiently Extending Transformers for Long Input Summarization"),Zt.forEach(t),Mo=d(yo,"  by Jason Phang, Yao Zhao and Peter J. Liu."),yo.forEach(t),ro=f(e),we=a(e,"P",{});var Jt=r(we);Fo=d(Jt,"PEGASUS-X (PEGASUS eXtended) extends the PEGASUS models for long input summarization through additional long input pretraining and using staggered block-local attention with global tokens in the encoder."),Jt.forEach(t),io=f(e),Pe=a(e,"P",{});var Kt=r(Pe);Ao=d(Kt,"The abstract from the paper is the following:"),Kt.forEach(t),lo=f(e),$e=a(e,"P",{});var Yt=r($e);De=a(Yt,"EM",{});var Qt=r(De);Go=d(Qt,"While large pretrained Transformer models have proven highly capable at tackling natural language tasks, handling long sequence inputs continues to be a significant challenge. One such task is long input summarization, where inputs are longer than the maximum input context of most pretrained models. Through an extensive set of experiments, we investigate what model architectural changes and pretraining paradigms can most efficiently adapt a pretrained Transformer for long input summarization. We find that a staggered, block-local Transformer with global encoder tokens strikes a good balance of performance and efficiency, and that an additional pretraining phase on long sequences meaningfully improves downstream summarization performance. Based on our findings, we introduce PEGASUS-X, an extension of the PEGASUS model with additional long input pretraining to handle inputs of up to 16K tokens. PEGASUS-X achieves strong performance on long input summarization tasks comparable with much larger models while adding few additional parameters and not requiring model parallelism to train."),Qt.forEach(t),Yt.forEach(t),co=f(e),ze=a(e,"P",{});var en=r(ze);jo=d(en,"Tips:"),en.forEach(t),uo=f(e),xe=a(e,"UL",{});var on=r(xe);We=a(on,"LI",{});var tn=r(We);Oo=d(tn,"PEGASUS-X uses the same tokenizer as PEGASUS."),tn.forEach(t),on.forEach(t),po=f(e),M=a(e,"P",{});var Ge=r(M);Io=d(Ge,"This model was contributed by "),Xe=a(Ge,"A",{href:!0});var nn=r(Xe);Uo=d(nn,"zphang"),nn.forEach(t),No=d(Ge,". The original code can be found "),ae=a(Ge,"A",{href:!0,rel:!0});var sn=r(ae);Lo=d(sn,"here"),sn.forEach(t),Do=d(Ge,"."),Ge.forEach(t),ho=f(e),A=a(e,"H2",{class:!0});var To=r(A);W=a(To,"A",{id:!0,class:!0,href:!0});var an=r(W);Be=a(an,"SPAN",{});var rn=r(Be);T(re.$$.fragment,rn),rn.forEach(t),an.forEach(t),Wo=f(To),Re=a(To,"SPAN",{});var dn=r(Re);Bo=d(dn,"PegasusXConfig"),dn.forEach(t),To.forEach(t),mo=f(e),z=a(e,"DIV",{class:!0});var Y=r(z);T(ie.$$.fragment,Y),Ro=f(Y),G=a(Y,"P",{});var je=r(G);Ho=d(je,"This is the configuration class to store the configuration of a "),Se=a(je,"A",{href:!0});var ln=r(Se);Vo=d(ln,"PegasusXModel"),ln.forEach(t),Zo=d(je,`. It is used to instantiate a
PEGASUS-X model according to the specified arguments, defining the model architecture. Instantiating a
configuration with the defaults will yield a similar configuration to that of the PEGASUS-X
...
documentation from `),Ee=a(Oe,"A",{href:!0});var pn=r(Ee);tt=d(pn,"PretrainedConfig"),pn.forEach(t),nt=d(Oe," for more information."),Oe.forEach(t),st=f(Y),T(B.$$.fragment,Y),Y.forEach(t),fo=f(e),O=a(e,"H2",{class:!0});var ko=r(O);R=a(ko,"A",{id:!0,class:!0,href:!0});var hn=r(R);He=a(hn,"SPAN",{});var mn=r(He);T(le.$$.fragment,mn),mn.forEach(t),hn.forEach(t),at=f(ko),Ve=a(ko,"SPAN",{});var fn=r(Ve);rt=d(fn,"PegasusXModel"),fn.forEach(t),ko.forEach(t),go=f(e),x=a(e,"DIV",{class:!0});var Q=r(x);T(ce.$$.fragment,Q),it=f(Q),ue=a(Q,"P",{});var wo=r(ue);dt=d(wo,`The bare PEGASUS-X Model outputting raw hidden-states without any specific head on top.
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),zo.forEach(t),qt=f(oe),be=a(oe,"P",{});var xo=r(be);Et=d(xo,"This model is also a PyTorch "),ve=a(xo,"A",{href:!0,rel:!0});var Pn=r(ve);Ct=d(Pn,"torch.nn.Module"),Pn.forEach(t),Mt=d(xo,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),xo.forEach(t),Ft=f(oe),E=a(oe,"DIV",{class:!0});var te=r(E);T(ye.$$.fragment,te),At=f(te),N=a(te,"P",{});var Ue=r(N);Gt=d(Ue,"The "),Ae=a(Ue,"A",{href:!0});var $n=r(Ae);jt=d($n,"PegasusXForConditionalGeneration"),$n.forEach(t),Ot=d(Ue," forward method, overrides the "),Ye=a(Ue,"CODE",{});var zn=r(Ye);It=d(zn,"__call__"),zn.forEach(t),Ut=d(Ue," special method."),Ue.forEach(t),Nt=f(te),T(J.$$.fragment,te),Lt=f(te),T(K.$$.fragment,te),te.forEach(t),oe.forEach(t),this.h()},h(){c(l,"name","hf:doc:metadata"),c(l,"content",JSON.stringify(In)),c(p,"id","pegasusx"),c(p,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(p,"href","#pegasusx"),c(_,"class","relative group"),c(L,"id","overview"),c(L,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(L,"href","#overview"),c(F,"class","relative group"),c(se,"href","https://arxiv.org/abs/2208.04347"),c(se,"rel","nofollow"),c(Xe,"href","<https://huggingface.co/zphang"),c(ae,"href","https://github.com/google-research/pegasus"),c(ae,"rel","nofollow"),c(W,"id","transformers.PegasusXConfig"),c(W,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(W,"href","#transformers.PegasusXConfig"),c(A,"class","relative group"),c(Se,"href","/docs/transformers/main/en/model_doc/pegasus_x#transformers.PegasusXModel"),c(de,"href","https://huggingface.co/google/pegasus-x-large"),c(de,"rel","nofollow"),c(qe,"href","/docs/transformers/main/en/main_classes/configuration#transformers.PretrainedConfig"),c(Ee,"href","/docs/transformers/main/en/main_classes/configuration#transformers.PretrainedConfig"),c(z,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),c(R,"id","transformers.PegasusXModel"),c(R,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(R,"href","#transformers.PegasusXModel"),c(O,"class","relative group"),c(Ce,"href","/docs/transformers/main/en/main_classes/model#transformers.PreTrainedModel"),c(he,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),c(he,"rel","nofollow"),c(Me,"href","/docs/transformers/main/en/model_doc/pegasus_x#transformers.PegasusXModel"),c(q,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),c(x,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),c(Z,"id","transformers.PegasusXForConditionalGeneration"),c(Z,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(Z,"href","#transformers.PegasusXForConditionalGeneration"),c(U,"class","relative group"),c(Fe,"href","/docs/transformers/main/en/main_classes/model#transformers.PreTrainedModel"),c(ve,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),c(ve,"rel","nofollow"),c(Ae,"href","/docs/transformers/main/en/model_doc/pegasus_x#transformers.PegasusXForConditionalGeneration"),c(E,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),c(X,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8")},m(e,u){o(document.head,l),g(e,v,u),g(e,_,u),o(_,p),o(p,b),k(n,b,null),o(_,h),o(_,C),o(C,Xo),g(e,so,u),g(e,F,u),o(F,L),o(L,Ne),k(ne,Ne,null),o(F,So),o(F,Le),o(Le,qo),g(e,ao,u),g(e,D,u),o(D,Eo),o(D,se),o(se,Co),o(D,Mo),g(e,ro,u),g(e,we,u),o(we,Fo),g(e,io,u),g(e,Pe,u),o(Pe,Ao),g(e,lo,u),g(e,$e,u),o($e,De),o(De,Go),g(e,co,u),g(e,ze,u),o(ze,jo),g(e,uo,u),g(e,xe,u),o(xe,We),o(We,Oo),g(e,po,u),g(e,M,u),o(M,Io),o(M,Xe),o(Xe,Uo),o(M,No),o(M,ae),o(ae,Lo),o(M,Do),g(e,ho,u),g(e,A,u),o(A,W),o(W,Be),k(re,Be,null),o(A,Wo),o(A,Re),o(Re,Bo),g(e,mo,u),g(e,z,u),k(ie,z,null),o(z,Ro),o(z,G),o(G,Ho),o(G,Se),o(Se,Vo),o(G,Zo),o(G,de),o(de,Jo),o(G,Ko),o(z,Yo),o(z,j),o(j,Qo),o(j,qe),o(qe,et),o(j,ot),o(j,Ee),o(Ee,tt),o(j,nt),o(z,st),k(B,z,null),g(e,fo,u),g(e,O,u),o(O,R),o(R,He),k(le,He,null),o(O,at),o(O,Ve),o(Ve,rt),g(e,go,u),g(e,x,u),k(ce,x,null),o(x,it),o(x,ue),o(ue,dt),o(ue,Ce),o(Ce,lt),o(ue,ct),o(x,ut),o(x,pe),o(pe,pt),o(pe,he),o(he,ht),o(pe,mt),o(x,ft),o(x,q),k(me,q,null),o(q,gt),o(q,I),o(I,_t),o(I,Me),o(Me,bt),o(I,vt),o(I,Ze),o(Ze,yt),o(I,Tt),o(q,kt),k(H,q,null),o(q,wt),k(V,q,null),g(e,_o,u),g(e,U,u),o(U,Z),o(Z,Je),k(fe,Je,null),o(U,Pt),o(U,Ke),o(Ke,$t),g(e,bo,u),g(e,X,u),k(ge,X,null),o(X,zt),o(X,_e),o(_e,xt),o(_e,Fe),o(Fe,Xt),o(_e,St),o(X,qt),o(X,be),o(be,Et),o(be,ve),o(ve,Ct),o(be,Mt),o(X,Ft),o(X,E),k(ye,E,null),o(E,At),o(E,N),o(N,Gt),o(N,Ae),o(Ae,jt),o(N,Ot),o(N,Ye),o(Ye,It),o(N,Ut),o(E,Nt),k(J,E,null),o(E,Lt),k(K,E,null),vo=!0},p(e,[u]){const Te={};u&2&&(Te.$$scope={dirty:u,ctx:e}),B.$set(Te);const Qe={};u&2&&(Qe.$$scope={dirty:u,ctx:e}),H.$set(Qe);const eo={};u&2&&(eo.$$scope={dirty:u,ctx:e}),V.$set(eo);const oo={};u&2&&(oo.$$scope={dirty:u,ctx:e}),J.$set(oo);const ke={};u&2&&(ke.$$scope={dirty:u,ctx:e}),K.$set(ke)},i(e){vo||(w(n.$$.fragment,e),w(ne.$$.fragment,e),w(re.$$.fragment,e),w(ie.$$.fragment,e),w(B.$$.fragment,e),w(le.$$.fragment,e),w(ce.$$.fragment,e),w(me.$$.fragment,e),w(H.$$.fragment,e),w(V.$$.fragment,e),w(fe.$$.fragment,e),w(ge.$$.fragment,e),w(ye.$$.fragment,e),w(J.$$.fragment,e),w(K.$$.fragment,e),vo=!0)},o(e){P(n.$$.fragment,e),P(ne.$$.fragment,e),P(re.$$.fragment,e),P(ie.$$.fragment,e),P(B.$$.fragment,e),P(le.$$.fragment,e),P(ce.$$.fragment,e),P(me.$$.fragment,e),P(H.$$.fragment,e),P(V.$$.fragment,e),P(fe.$$.fragment,e),P(ge.$$.fragment,e),P(ye.$$.fragment,e),P(J.$$.fragment,e),P(K.$$.fragment,e),vo=!1},d(e){t(l),e&&t(v),e&&t(_),$(n),e&&t(so),e&&t(F),$(ne),e&&t(ao),e&&t(D),e&&t(ro),e&&t(we),e&&t(io),e&&t(Pe),e&&t(lo),e&&t($e),e&&t(co),e&&t(ze),e&&t(uo),e&&t(xe),e&&t(po),e&&t(M),e&&t(ho),e&&t(A),$(re),e&&t(mo),e&&t(z),$(ie),$(B),e&&t(fo),e&&t(O),$(le),e&&t(go),e&&t(x),$(ce),$(me),$(H),$(V),e&&t(_o),e&&t(U),$(fe),e&&t(bo),e&&t(X),$(ge),$(ye),$(J),$(K)}}}const In={local:"pegasusx",sections:[{local:"overview",title:"Overview"},{local:"transformers.PegasusXConfig",title:"PegasusXConfig"},{local:"transformers.PegasusXModel",title:"PegasusXModel"},{local:"transformers.PegasusXForConditionalGeneration",title:"PegasusXForConditionalGeneration"}],title:"PEGASUS-X"};function Un(S){return Cn(()=>{new URLSearchParams(window.location.search).get("fw")}),[]}class Hn extends Xn{constructor(l){super();Sn(this,l,Un,On,qn,{})}}export{Hn as default,In as metadata};
