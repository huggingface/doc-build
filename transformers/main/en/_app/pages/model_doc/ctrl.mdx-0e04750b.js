...
`),G=r(we,"CODE",{});var Ue=i(G);ye=s(Ue,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),Ue.forEach(t),we.forEach(t),D.forEach(t)},m(h,$){u(h,p,$),e(p,E),u(h,f,$),u(h,g,$),e(g,v),e(v,T),e(g,_),e(g,M),e(M,_e),u(h,Y,$),u(h,R,$),e(R,Q),e(R,A),e(A,Z),e(R,Te),e(R,O),e(O,ve),e(R,he),u(h,x,$),u(h,j,$),e(j,ee),u(h,ne,$),u(h,F,$),e(F,q),e(q,ke),e(q,U),e(U,pe),e(q,se),e(q,V),e(V,ue),e(F,ae),e(F,z),e(z,be),e(z,H),e(H,re),e(z,Ce),e(z,W),e(W,S),e(F,te),e(F,I),e(I,oe),e(I,G),e(G,ye)},d(h){h&&t(p),h&&t(f),h&&t(g),h&&t(Y),h&&t(R),h&&t(x),h&&t(j),h&&t(ne),h&&t(F)}}}function oh(J){let p,E,f,g,v;return{c(){p=a("p"),E=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=a("code"),g=n("Module"),v=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(T){p=r(T,"P",{});var _=i(p);E=s(_,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=r(_,"CODE",{});var M=i(f);g=s(M,"Module"),M.forEach(t),v=s(_,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),_.forEach(t)},m(T,_){u(T,p,_),e(p,E),e(p,f),e(f,g),e(p,v)},d(T){T&&t(p)}}}function nh(J){let p,E,f,g,v,T,_,M,_e,Y,R,Q,A,Z,Te,O,ve,he,x,j,ee,ne,F,q,ke,U,pe,se,V,ue,ae,z,be,H,re,Ce,W,S,te,I,oe,G,ye;return{c(){p=a("p"),E=n("TF 2.0 models accepts two formats as inputs:"),f=l(),g=a("ul"),v=a("li"),T=n("having all inputs as keyword arguments (like PyTorch models), or"),_=l(),M=a("li"),_e=n("having all inputs as a list, tuple or dict in the first positional arguments."),Y=l(),R=a("p"),Q=n("This second option is useful when using "),A=a("code"),Z=n("tf.keras.Model.fit"),Te=n(` method which currently requires having all the
tensors in the first argument of the model call function: `),O=a("code"),ve=n("model(inputs)"),he=n("."),x=l(),j=a("p"),ee=n(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),ne=l(),F=a("ul"),q=a("li"),ke=n("a single Tensor with "),U=a("code"),pe=n("input_ids"),se=n(" only and nothing else: "),V=a("code"),ue=n("model(inputs_ids)"),ae=l(),z=a("li"),be=n(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),H=a("code"),re=n("model([input_ids, attention_mask])"),Ce=n(" or "),W=a("code"),S=n("model([input_ids, attention_mask, token_type_ids])"),te=l(),I=a("li"),oe=n(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),G=a("code"),ye=n('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(h){p=r(h,"P",{});var $=i(p);E=s($,"TF 2.0 models accepts two formats as inputs:"),$.forEach(t),f=d(h),g=r(h,"UL",{});var ie=i(g);v=r(ie,"LI",{});var Ae=i(v);T=s(Ae,"having all inputs as keyword arguments (like PyTorch models), or"),Ae.forEach(t),_=d(ie),M=r(ie,"LI",{});var me=i(M);_e=s(me,"having all inputs as a list, tuple or dict in the first positional arguments."),me.forEach(t),ie.forEach(t),Y=d(h),R=r(h,"P",{});var N=i(R);Q=s(N,"This second option is useful when using "),A=r(N,"CODE",{});var qe=i(A);Z=s(qe,"tf.keras.Model.fit"),qe.forEach(t),Te=s(N,` method which currently requires having all the
...
the latter silently ignores them.`)},l(T){p=r(T,"P",{});var _=i(p);E=s(_,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=r(_,"CODE",{});var M=i(f);g=s(M,"Module"),M.forEach(t),v=s(_,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),_.forEach(t)},m(T,_){u(T,p,_),e(p,E),e(p,f),e(f,g),e(p,v)},d(T){T&&t(p)}}}function ah(J){let p,E,f,g,v,T,_,M,_e,Y,R,Q,A,Z,Te,O,ve,he,x,j,ee,ne,F,q,ke,U,pe,se,V,ue,ae,z,be,H,re,Ce,W,S,te,I,oe,G,ye;return{c(){p=a("p"),E=n("TF 2.0 models accepts two formats as inputs:"),f=l(),g=a("ul"),v=a("li"),T=n("having all inputs as keyword arguments (like PyTorch models), or"),_=l(),M=a("li"),_e=n("having all inputs as a list, tuple or dict in the first positional arguments."),Y=l(),R=a("p"),Q=n("This second option is useful when using "),A=a("code"),Z=n("tf.keras.Model.fit"),Te=n(` method which currently requires having all the
tensors in the first argument of the model call function: `),O=a("code"),ve=n("model(inputs)"),he=n("."),x=l(),j=a("p"),ee=n(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),ne=l(),F=a("ul"),q=a("li"),ke=n("a single Tensor with "),U=a("code"),pe=n("input_ids"),se=n(" only and nothing else: "),V=a("code"),ue=n("model(inputs_ids)"),ae=l(),z=a("li"),be=n(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),H=a("code"),re=n("model([input_ids, attention_mask])"),Ce=n(" or "),W=a("code"),S=n("model([input_ids, attention_mask, token_type_ids])"),te=l(),I=a("li"),oe=n(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),G=a("code"),ye=n('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(h){p=r(h,"P",{});var $=i(p);E=s($,"TF 2.0 models accepts two formats as inputs:"),$.forEach(t),f=d(h),g=r(h,"UL",{});var ie=i(g);v=r(ie,"LI",{});var Ae=i(v);T=s(Ae,"having all inputs as keyword arguments (like PyTorch models), or"),Ae.forEach(t),_=d(ie),M=r(ie,"LI",{});var me=i(M);_e=s(me,"having all inputs as a list, tuple or dict in the first positional arguments."),me.forEach(t),ie.forEach(t),Y=d(h),R=r(h,"P",{});var N=i(R);Q=s(N,"This second option is useful when using "),A=r(N,"CODE",{});var qe=i(A);Z=s(qe,"tf.keras.Model.fit"),qe.forEach(t),Te=s(N,` method which currently requires having all the
...
the latter silently ignores them.`)},l(T){p=r(T,"P",{});var _=i(p);E=s(_,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=r(_,"CODE",{});var M=i(f);g=s(M,"Module"),M.forEach(t),v=s(_,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),_.forEach(t)},m(T,_){u(T,p,_),e(p,E),e(p,f),e(f,g),e(p,v)},d(T){T&&t(p)}}}function ih(J){let p,E,f,g,v,T,_,M,_e,Y,R,Q,A,Z,Te,O,ve,he,x,j,ee,ne,F,q,ke,U,pe,se,V,ue,ae,z,be,H,re,Ce,W,S,te,I,oe,G,ye,h,$,ie,Ae,me,N,qe,Oe,He,D,P,We,ze,K,Be,Pe,we,Ue,En,ma,fa,Yo,Fn,ga,_a,Rs,Ye,Ta,Gt,va,ka,Kt,ba,Ca,Ms,ct,Rt,qn,Xt,ya,zn,wa,Es,Le,Jt,La,Je,$a,Zo,Ra,Ma,en,Ea,Fa,Qt,qa,za,Pa,ht,xa,tn,ja,Sa,on,Ia,Na,Da,Pn,Aa,Oa,Yt,Fs,pt,Mt,xn,Zt,Ha,jn,Wa,qs,Ne,eo,Ba,Sn,Ua,Va,to,Ga,nn,Ka,Xa,Ja,sn,oo,zs,ut,Et,In,no,Qa,Nn,Ya,Ps,$e,so,Za,Dn,er,tr,ao,or,an,nr,sr,ar,ro,rr,io,ir,lr,dr,xe,lo,cr,mt,hr,rn,pr,ur,An,mr,fr,gr,Ft,_r,On,Tr,vr,co,xs,ft,qt,Hn,ho,kr,Wn,br,js,Re,po,Cr,Bn,yr,wr,uo,Lr,ln,$r,Rr,Mr,mo,Er,fo,Fr,qr,zr,je,go,Pr,gt,xr,dn,jr,Sr,Un,Ir,Nr,Dr,zt,Ar,Vn,Or,Hr,_o,Ss,_t,Pt,Gn,To,Wr,Kn,Br,Is,Me,vo,Ur,Ee,Vr,cn,Gr,Kr,Xn,Xr,Jr,Jn,Qr,Yr,Qn,Zr,ei,Yn,ti,oi,ni,ko,si,hn,ai,ri,ii,bo,li,Co,di,ci,hi,B,yo,pi,Tt,ui,pn,mi,fi,Zn,gi,_i,Ti,xt,vi,es,ki,bi,wo,Ci,Lo,yi,ts,wi,Li,$o,$i,Ro,Ns,vt,jt,os,Mo,Ri,ns,Mi,Ds,de,Eo,Ei,ss,Fi,qi,Fo,zi,un,Pi,xi,ji,qo,Si,zo,Ii,Ni,Di,St,Ai,Se,Po,Oi,kt,Hi,mn,Wi,Bi,as,Ui,Vi,Gi,It,Ki,rs,Xi,Ji,xo,As,bt,Nt,is,jo,Qi,ls,Yi,Os,ce,So,Zi,ds,el,tl,Io,ol,fn,nl,sl,al,No,rl,Do,il,ll,dl,Dt,cl,Ie,Ao,hl,Ct,pl,gn,ul,ml,cs,fl,gl,_l,At,Tl,hs,vl,kl,Oo,Hs,yt,Ot,ps,Ho,bl,us,Cl,Ws,X,Wo,yl,ms,wl,Ll,_n,Tn,$l,Rl,Ml,De,El,fs,Fl,ql,gs,zl,Pl,_s,xl,jl,Ts,Sl,Il,Nl,Bo,Dl,vn,Al,Ol,Hl,Uo,Wl,Vo,Bl,Ul,Vl,Ht,Gl,fe,Go,Kl,wt,Xl,kn,Jl,Ql,vs,Yl,Zl,ed,Wt,td,ks,od,nd,Ko,sd,Xo,Bs;return T=new dt({}),Z=new dt({}),Xt=new dt({}),Jt=new Fe({props:{name:"class transformers.CTRLConfig",anchor:"transformers.CTRLConfig",parameters:[{name:"vocab_size",val:" = 246534"},{name:"n_positions",val:" = 256"},{name:"n_embd",val:" = 1280"},{name:"dff",val:" = 8192"},{name:"n_layer",val:" = 48"},{name:"n_head",val:" = 16"},{name:"resid_pdrop",val:" = 0.1"},{name:"embd_pdrop",val:" = 0.1"},{name:"attn_pdrop",val:" = 0.1"},{name:"layer_norm_epsilon",val:" = 1e-06"},{name:"initializer_range",val:" = 0.02"},{name:"summary_type",val:" = 'cls_index'"},{name:"summary_use_proj",val:" = True"},{name:"summary_activation",val:" = None"},{name:"summary_proj_to_labels",val:" = True"},{name:"summary_first_dropout",val:" = 0.1"},{name:"use_cache",val:" = True"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/ctrl/configuration_ctrl.py#L26",parametersDescription:[{anchor:"transformers.CTRLConfig.vocab_size",description:`<strong>vocab_size</strong> (<code>int</code>, <em>optional</em>, defaults to 246534) &#x2014;
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/main/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),St=new $t({props:{$$slots:{default:[th]},$$scope:{ctx:J}}}),Po=new Fe({props:{name:"call",anchor:"transformers.TFCTRLModel.call",parameters:[{name:"input_ids",val:" = None"},{name:"past_key_values",val:" = None"},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"},{name:"training",val:" = False"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/ctrl/modeling_tf_ctrl.py#L522",parametersDescription:[{anchor:"transformers.TFCTRLModel.call.input_ids",description:`<strong>input_ids</strong> (<code>Numpy array</code> or <code>tf.Tensor</code> of shape <code>(batch_size, input_ids_length)</code>) &#x2014;
...
and behavior.`),dr=l(),xe=a("div"),k(lo.$$.fragment),cr=l(),mt=a("p"),hr=n("The "),rn=a("a"),pr=n("CTRLModel"),ur=n(" forward method, overrides the "),An=a("code"),mr=n("__call__"),fr=n(" special method."),gr=l(),k(Ft.$$.fragment),_r=l(),On=a("p"),Tr=n("Example:"),vr=l(),k(co.$$.fragment),xs=l(),ft=a("h2"),qt=a("a"),Hn=a("span"),k(ho.$$.fragment),kr=l(),Wn=a("span"),br=n("CTRLLMHeadModel"),js=l(),Re=a("div"),k(po.$$.fragment),Cr=l(),Bn=a("p"),yr=n(`The CTRL Model transformer with a language modeling head on top (linear layer with weights tied to the input
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),hi=l(),B=a("div"),k(yo.$$.fragment),pi=l(),Tt=a("p"),ui=n("The "),pn=a("a"),mi=n("CTRLForSequenceClassification"),fi=n(" forward method, overrides the "),Zn=a("code"),gi=n("__call__"),_i=n(" special method."),Ti=l(),k(xt.$$.fragment),vi=l(),es=a("p"),ki=n("Example of single-label classification:"),bi=l(),k(wo.$$.fragment),Ci=l(),k(Lo.$$.fragment),yi=l(),ts=a("p"),wi=n("Example of multi-label classification:"),Li=l(),k($o.$$.fragment),$i=l(),k(Ro.$$.fragment),Ns=l(),vt=a("h2"),jt=a("a"),os=a("span"),k(Mo.$$.fragment),Ri=l(),ns=a("span"),Mi=n("TFCTRLModel"),Ds=l(),de=a("div"),k(Eo.$$.fragment),Ei=l(),ss=a("p"),Fi=n("The bare CTRL Model transformer outputting raw hidden-states without any specific head on top."),qi=l(),Fo=a("p"),zi=n("This model inherits from "),un=a("a"),Pi=n("TFPreTrainedModel"),xi=n(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Ys.forEach(t),dr=d(tt),xe=r(tt,"DIV",{class:!0});var ot=i(xe);b(lo.$$.fragment,ot),cr=d(ot),mt=r(ot,"P",{});var yn=i(mt);hr=s(yn,"The "),rn=r(yn,"A",{href:!0});var Wd=i(rn);pr=s(Wd,"CTRLModel"),Wd.forEach(t),ur=s(yn," forward method, overrides the "),An=r(yn,"CODE",{});var Bd=i(An);mr=s(Bd,"__call__"),Bd.forEach(t),fr=s(yn," special method."),yn.forEach(t),gr=d(ot),b(Ft.$$.fragment,ot),_r=d(ot),On=r(ot,"P",{});var Ud=i(On);Tr=s(Ud,"Example:"),Ud.forEach(t),vr=d(ot),b(co.$$.fragment,ot),ot.forEach(t),tt.forEach(t),xs=d(o),ft=r(o,"H2",{class:!0});var Zs=i(ft);qt=r(Zs,"A",{id:!0,class:!0,href:!0});var Vd=i(qt);Hn=r(Vd,"SPAN",{});var Gd=i(Hn);b(ho.$$.fragment,Gd),Gd.forEach(t),Vd.forEach(t),kr=d(Zs),Wn=r(Zs,"SPAN",{});var Kd=i(Wn);br=s(Kd,"CTRLLMHeadModel"),Kd.forEach(t),Zs.forEach(t),js=d(o),Re=r(o,"DIV",{class:!0});var nt=i(Re);b(po.$$.fragment,nt),Cr=d(nt),Bn=r(nt,"P",{});var Xd=i(Bn);yr=s(Xd,`The CTRL Model transformer with a language modeling head on top (linear layer with weights tied to the input
