import{S as Uk,i as Rk,s as Gk,e as n,k as d,w as $,t as s,M as Bk,c as o,d as t,m as p,a as r,x as E,h as a,b as h,N as Vk,F as e,g as u,y as F,q as A,o as z,B as x,v as Kk,L as ro}from"../../chunks/vendor-6b77c823.js";import{T as Ms}from"../../chunks/Tip-39098574.js";import{D as He}from"../../chunks/Docstring-abef54e3.js";import{C as Ve}from"../../chunks/CodeBlock-3a8b25a8.js";import{I as Rt}from"../../chunks/IconCopyLink-7a11ce68.js";import{F as Cc,M as io}from"../../chunks/Markdown-4489c441.js";function Yk(U){let l,_,c,f,v,b,T,y,k,D,q,H,B,V,R,K,re,I,O;return T=new Ve({props:{code:`from transformers import TapasConfig, TapasForQuestionAnswering
...
the latter silently ignores them.`)},l(b){l=o(b,"P",{});var T=r(l);_=a(T,"Although the recipe for forward pass needs to be defined within this function, one should call the "),c=o(T,"CODE",{});var y=r(c);f=a(y,"Module"),y.forEach(t),v=a(T,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),T.forEach(t)},m(b,T){u(b,l,T),e(l,_),e(l,c),e(c,f),e(l,v)},d(b){b&&t(l)}}}function qy(U){let l,_,c,f,v,b,T,y,k,D,q,H,B,V,R,K,re,I,O,w,M,G,C,N,ee,te,ce,ne,se,P,L,W,X,Q,Y,ge,ue,_e,me,oe,qe,ie,be,g,S,ve,ze,we,le,xe,Me,Z,de,pe,De,je,Te,Ne,ke,Ae,Oe,Ze,Ps,Ss,ut,mt,pa,ft,gt,Ds,tt,Ns,Os,Ke,Pe,Ls,wt,ye,kt,yt,Qs,qt,jt,Is,$t,vs,Gt,Et,bs,Ye,$e,Ws,Ft,ae,nt,Bt,Hs,At,ns,Us,zt,xt,Rs,Ct,os,Gs,Mt,rs,Bs,Pt,Vs,Le,St,is,Ks,Dt,ls,Ys,ds,Ue,ps,Ee,cs,ot,Js,Nt,Ot,Xs,Zs,Re,ea,hs,us,et,Lt,j,J,xa,ta,Ca,ca,Qt,st,sa,rt,Ma,aa,Pa,ha,Ie,ms,ws,Ge,Sa,ua,ks,na,fs,ma,fe,Da,ys,Na,Oa,fa,_t,oa,gs,La,Fe,Qa,ra,Ia,Wa,Ha,he,Ua,ia,Ra,Ga,ga,qs,Ba,_a,Ce,la,It,da,Ki,Mc,Pc,Yi,Ji,Sc,Dc,Xi,Zi,Nc,Oc,Va,Ka,el,Lc,Qc,tl,Ic,Wc,sl,Hc,Uc,Ya,al,Rc,Gc,nl,Bc,Vc,ol,Kc,Yc,Ja,rl,Jc,Xc,il,Zc,eh,ll,th,sp,qn,ap,jn,sh,lo,ah,nh,np,$n,oh,po,rh,ih,op,Hr,dl,lh,rp,En,dh,co,ph,ch,ip,We,Ur,pl,hh,uh,mh,Rr,cl,fh,gh,_h,Gr,hl,Th,vh,bh,Br,ul,wh,kh,yh,Vr,ml,qh,jh,$h,Kr,fl,Eh,Fh,Ah,Yr,gl,zh,xh,Ch,Jr,_l,Mh,Ph,Sh,Xr,Tl,Dh,Nh,lp,Tt,Oh,ho,Lh,Qh,uo,Ih,Wh,vl,Hh,Uh,bl,Rh,Gh,wl,Bh,Vh,dp,Zr,kl,Kh,pp,Fn,cp,Se,Yh,yl,Jh,Xh,ql,Zh,eu,jl,tu,su,$l,au,nu,El,ou,ru,Fl,iu,lu,ei,du,pu,mo,cu,hu,fo,uu,mu,hp,ti,fu,up,An,mp,Xa,zn,Al,go,gu,zl,_u,fp,xn,gp,vt,Tu,xl,vu,bu,Cl,wu,ku,Ml,yu,qu,_o,ju,$u,To,Eu,Fu,_p,Za,Cn,Pl,vo,Au,Sl,zu,Tp,en,bo,xu,wo,Cu,si,Mu,Pu,vp,tn,Mn,Dl,ko,Su,Nl,Du,bp,Wt,yo,Nu,_s,Ou,ai,Lu,Qu,Ol,Iu,Wu,Ll,Hu,Uu,ni,Ru,Gu,Bu,qo,Vu,jo,Ku,Yu,Ju,Ql,Xu,Zu,$o,wp,sn,Pn,Il,Eo,em,Wl,tm,kp,Be,Fo,sm,Hl,am,nm,Qe,om,oi,rm,im,ri,lm,dm,Ul,pm,cm,Rl,hm,um,Gl,mm,fm,Bl,gm,_m,Vl,Tm,vm,Kl,bm,wm,Yl,km,ym,qm,it,Jl,jm,$m,Xl,Em,Fm,Zl,Am,zm,ed,xm,Cm,td,Mm,Pm,sd,Sm,Dm,ad,Nm,Om,ii,li,Lm,Qm,Im,Sn,Ao,Wm,nd,Hm,Um,Ta,zo,Rm,xo,Gm,di,Bm,Vm,Km,Co,Ym,Mo,Jm,Xm,Zm,pi,Po,yp,an,Dn,od,So,ef,rd,tf,qp,lt,Do,sf,No,af,ci,nf,of,rf,Oo,lf,Lo,df,pf,cf,Qo,hf,hi,uf,mf,ff,Io,gf,Wo,_f,Tf,vf,Vt,Ho,bf,nn,wf,ui,kf,yf,id,qf,jf,$f,Nn,Ef,ld,Ff,Af,Uo,jp,on,On,dd,Ro,zf,pd,xf,$p,Ts,Go,Cf,rn,Mf,cd,Pf,Sf,mi,Df,Nf,Of,Bo,Lf,Vo,Qf,If,Wf,Kt,Ko,Hf,ln,Uf,fi,Rf,Gf,hd,Bf,Vf,Kf,Ln,Yf,ud,Jf,Xf,Yo,Ep,dn,Qn,md,Jo,Zf,fd,eg,Fp,Ht,Xo,tg,gd,sg,ag,Zo,ng,gi,og,rg,ig,er,lg,tr,dg,pg,cg,Yt,sr,hg,pn,ug,_i,mg,fg,_d,gg,_g,Tg,In,vg,Td,bg,wg,ar,Ap,cn,Wn,vd,nr,kg,bd,yg,zp,Ut,or,qg,hn,jg,wd,$g,Eg,kd,Fg,Ag,zg,rr,xg,Ti,Cg,Mg,Pg,ir,Sg,lr,Dg,Ng,Og,Jt,dr,Lg,un,Qg,vi,Ig,Wg,yd,Hg,Ug,Rg,Hn,Gg,qd,Bg,Vg,pr,xp,mn,Un,jd,cr,Kg,$d,Yg,Cp,dt,hr,Jg,Ed,Xg,Zg,ur,e_,bi,t_,s_,a_,mr,n_,fr,o_,r_,i_,Rn,l_,Xt,gr,d_,fn,p_,wi,c_,h_,Fd,u_,m_,f_,Gn,g_,Ad,__,T_,_r,Mp,gn,Bn,zd,Tr,v_,xd,b_,Pp,pt,vr,w_,br,k_,Cd,y_,q_,j_,wr,$_,ki,E_,F_,A_,kr,z_,yr,x_,C_,M_,Vn,P_,Zt,qr,S_,_n,D_,yi,N_,O_,Md,L_,Q_,I_,Kn,W_,Pd,H_,U_,jr,Sp,Tn,Yn,Sd,$r,R_,Dd,G_,Dp,ct,Er,B_,Nd,V_,K_,Fr,Y_,qi,J_,X_,Z_,Ar,eT,zr,tT,sT,aT,Jn,nT,es,xr,oT,vn,rT,ji,iT,lT,Od,dT,pT,cT,Xn,hT,Ld,uT,mT,Cr,Np,bn,Zn,Qd,Mr,fT,Id,gT,Op,ht,Pr,_T,wn,TT,Wd,vT,bT,Hd,wT,kT,yT,Sr,qT,$i,jT,$T,ET,Dr,FT,Nr,AT,zT,xT,eo,CT,ts,Or,MT,kn,PT,Ei,ST,DT,Ud,NT,OT,LT,to,QT,Rd,IT,WT,Lr,Lp;return b=new Rt({}),V=new Rt({}),rt=new Rt({}),qn=new Cc({props:{pytorch:!0,tensorflow:!0,jax:!1,$$slots:{tensorflow:[Zk],pytorch:[Jk]},$$scope:{ctx:U}}}),Fn=new Cc({props:{pytorch:!0,tensorflow:!0,jax:!1,$$slots:{tensorflow:[ay],pytorch:[ty]},$$scope:{ctx:U}}}),An=new Cc({props:{pytorch:!0,tensorflow:!0,jax:!1,$$slots:{tensorflow:[iy],pytorch:[oy]},$$scope:{ctx:U}}}),go=new Rt({}),xn=new Cc({props:{pytorch:!0,tensorflow:!0,jax:!1,$$slots:{tensorflow:[cy],pytorch:[dy]},$$scope:{ctx:U}}}),vo=new Rt({}),bo=new He({props:{name:"class transformers.models.tapas.modeling_tapas.TableQuestionAnsweringOutput",anchor:"transformers.models.tapas.modeling_tapas.TableQuestionAnsweringOutput",parameters:[{name:"loss",val:": typing.Optional[torch.FloatTensor] = None"},{name:"logits",val:": FloatTensor = None"},{name:"logits_aggregation",val:": FloatTensor = None"},{name:"hidden_states",val:": typing.Optional[typing.Tuple[torch.FloatTensor]] = None"},{name:"attentions",val:": typing.Optional[typing.Tuple[torch.FloatTensor]] = None"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/tapas/modeling_tapas.py#L106",parametersDescription:[{anchor:"transformers.models.tapas.modeling_tapas.TableQuestionAnsweringOutput.loss",description:`<strong>loss</strong> (<code>torch.FloatTensor</code> of shape <code>(1,)</code>, <em>optional</em>, returned when <code>labels</code> (and possibly <code>answer</code>, <code>aggregation_labels</code>, <code>numeric_values</code> and <code>numeric_values_scale</code> are provided)) &#x2014;
...
`}}),Gn=new Ms({props:{$$slots:{default:[_y]},$$scope:{ctx:U}}}),_r=new Ve({props:{code:`from transformers import TapasTokenizer, TapasModel
import pandas as pd
...
documentation from `),ni=n("a"),Ru=s("PretrainedConfig"),Gu=s(" for more information."),Bu=d(),qo=n("p"),Vu=s(`Hyperparameters additional to BERT are taken from run_task_main.py and hparam_utils.py of the original
implementation. Original implementation available at `),jo=n("a"),Ku=s("https://github.com/google-research/tapas/tree/master"),Yu=s("."),Ju=d(),Ql=n("p"),Xu=s("Example:"),Zu=d(),$($o.$$.fragment),wp=d(),sn=n("h2"),Pn=n("a"),Il=n("span"),$(Eo.$$.fragment),em=d(),Wl=n("span"),tm=s("TapasTokenizer"),kp=d(),Be=n("div"),$(Fo.$$.fragment),sm=d(),Hl=n("p"),am=s(`Construct a TAPAS tokenizer. Based on WordPiece. Flattens a table and one or more related sentences to be used by
...
wordpiece.`),Im=d(),Sn=n("div"),$(Ao.$$.fragment),Wm=d(),nd=n("p"),Hm=s("Main method to tokenize and prepare for the model one or several sequence(s) related to a table."),Um=d(),Ta=n("div"),$(zo.$$.fragment),Rm=d(),xo=n("p"),Gm=s("Converts logits of "),di=n("a"),Bm=s("TapasForQuestionAnswering"),Vm=s(` to actual predicted answer coordinates and optional
...
documentation from `),ni=o(ba,"A",{href:!0});var Kb=r(ni);Ru=a(Kb,"PretrainedConfig"),Kb.forEach(t),Gu=a(ba," for more information."),ba.forEach(t),Bu=p(va),qo=o(va,"P",{});var tc=r(qo);Vu=a(tc,`Hyperparameters additional to BERT are taken from run_task_main.py and hparam_utils.py of the original
implementation. Original implementation available at `),jo=o(tc,"A",{href:!0,rel:!0});var Yb=r(jo);Ku=a(Yb,"https://github.com/google-research/tapas/tree/master"),Yb.forEach(t),Yu=a(tc,"."),tc.forEach(t),Ju=p(va),Ql=o(va,"P",{});var Jb=r(Ql);Xu=a(Jb,"Example:"),Jb.forEach(t),Zu=p(va),E($o.$$.fragment,va),va.forEach(t),wp=p(i),sn=o(i,"H2",{class:!0});var sc=r(sn);Pn=o(sc,"A",{id:!0,class:!0,href:!0});var Xb=r(Pn);Il=o(Xb,"SPAN",{});var Zb=r(Il);E(Eo.$$.fragment,Zb),Zb.forEach(t),Xb.forEach(t),em=p(sc),Wl=o(sc,"SPAN",{});var ew=r(Wl);tm=a(ew,"TapasTokenizer"),ew.forEach(t),sc.forEach(t),kp=p(i),Be=o(i,"DIV",{class:!0});var bt=r(Be);E(Fo.$$.fragment,bt),sm=p(bt),Hl=o(bt,"P",{});var tw=r(Hl);am=a(tw,`Construct a TAPAS tokenizer. Based on WordPiece. Flattens a table and one or more related sentences to be used by
...
wordpiece.`),ZT.forEach(t),Im=p(bt),Sn=o(bt,"DIV",{class:!0});var ac=r(Sn);E(Ao.$$.fragment,ac),Wm=p(ac),nd=o(ac,"P",{});var vw=r(nd);Hm=a(vw,"Main method to tokenize and prepare for the model one or several sequence(s) related to a table."),vw.forEach(t),ac.forEach(t),Um=p(bt),Ta=o(bt,"DIV",{class:!0});var Ni=r(Ta);E(zo.$$.fragment,Ni),Rm=p(Ni),xo=o(Ni,"P",{});var nc=r(xo);Gm=a(nc,"Converts logits of "),di=o(nc,"A",{href:!0});var bw=r(di);Bm=a(bw,"TapasForQuestionAnswering"),bw.forEach(t),Vm=a(nc,` to actual predicted answer coordinates and optional
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),hc.forEach(t),Wf=p(oo),Kt=o(oo,"DIV",{class:!0});var ka=r(Kt);E(Ko.$$.fragment,ka),Hf=p(ka),ln=o(ka,"P",{});var Qi=r(ln);Uf=a(Qi,"The "),fi=o(Qi,"A",{href:!0});var Lw=r(fi);Rf=a(Lw,"TapasForMaskedLM"),Lw.forEach(t),Gf=a(Qi," forward method, overrides the "),hd=o(Qi,"CODE",{});var Qw=r(hd);Bf=a(Qw,"__call__"),Qw.forEach(t),Vf=a(Qi," special method."),Qi.forEach(t),Kf=p(ka),E(Ln.$$.fragment,ka),Yf=p(ka),ud=o(ka,"P",{});var Iw=r(ud);Jf=a(Iw,"Examples:"),Iw.forEach(t),Xf=p(ka),E(Yo.$$.fragment,ka),ka.forEach(t),oo.forEach(t),Ep=p(i),dn=o(i,"H2",{class:!0});var uc=r(dn);Qn=o(uc,"A",{id:!0,class:!0,href:!0});var Ww=r(Qn);md=o(Ww,"SPAN",{});var Hw=r(md);E(Jo.$$.fragment,Hw),Hw.forEach(t),Ww.forEach(t),Zf=p(uc),fd=o(uc,"SPAN",{});var Uw=r(fd);eg=a(Uw,"TapasForSequenceClassification"),Uw.forEach(t),uc.forEach(t),Fp=p(i),Ht=o(i,"DIV",{class:!0});var ya=r(Ht);E(Xo.$$.fragment,ya),tg=p(ya),gd=o(ya,"P",{});var Rw=r(gd);sg=a(Rw,`Tapas Model with a sequence classification head on top (a linear layer on top of the pooled output), e.g. for table
entailment tasks, such as TabFact (Chen et al., 2020).`),Rw.forEach(t),ag=p(ya),Zo=o(ya,"P",{});var mc=r(Zo);ng=a(mc,"This model inherits from "),gi=o(mc,"A",{href:!0});var Gw=r(gi);og=a(Gw,"PreTrainedModel"),Gw.forEach(t),rg=a(mc,`. Check the superclass documentation for the generic methods the
library implements for all its models (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),mc.forEach(t),ig=p(ya),er=o(ya,"P",{});var fc=r(er);lg=a(fc,"This model is also a PyTorch "),tr=o(fc,"A",{href:!0,rel:!0});var Bw=r(tr);dg=a(Bw,"torch.nn.Module"),Bw.forEach(t),pg=a(fc,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),jc.forEach(t),M_=p(zs),E(Vn.$$.fragment,zs),P_=p(zs),Zt=o(zs,"DIV",{class:!0});var Fa=r(Zt);E(qr.$$.fragment,Fa),S_=p(Fa),_n=o(Fa,"P",{});var Ri=r(_n);D_=a(Ri,"The "),yi=o(Ri,"A",{href:!0});var kk=r(yi);N_=a(kk,"TFTapasForMaskedLM"),kk.forEach(t),O_=a(Ri," forward method, overrides the "),Md=o(Ri,"CODE",{});var yk=r(Md);L_=a(yk,"__call__"),yk.forEach(t),Q_=a(Ri," special method."),Ri.forEach(t),I_=p(Fa),E(Kn.$$.fragment,Fa),W_=p(Fa),Pd=o(Fa,"P",{});var qk=r(Pd);H_=a(qk,"Examples:"),qk.forEach(t),U_=p(Fa),E(jr.$$.fragment,Fa),Fa.forEach(t),zs.forEach(t),Sp=p(i),Tn=o(i,"H2",{class:!0});var $c=r(Tn);Yn=o($c,"A",{id:!0,class:!0,href:!0});var jk=r(Yn);Sd=o(jk,"SPAN",{});var $k=r(Sd);E($r.$$.fragment,$k),$k.forEach(t),jk.forEach(t),R_=p($c),Dd=o($c,"SPAN",{});var Ek=r(Dd);G_=a(Ek,"TFTapasForSequenceClassification"),Ek.forEach(t),$c.forEach(t),Dp=p(i),ct=o(i,"DIV",{class:!0});var xs=r(ct);E(Er.$$.fragment,xs),B_=p(xs),Nd=o(xs,"P",{});var Fk=r(Nd);V_=a(Fk,`Tapas Model with a sequence classification head on top (a linear layer on top of the pooled output), e.g. for table
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Fc.forEach(t),aT=p(xs),E(Jn.$$.fragment,xs),nT=p(xs),es=o(xs,"DIV",{class:!0});var Aa=r(es);E(xr.$$.fragment,Aa),oT=p(Aa),vn=o(Aa,"P",{});var Gi=r(vn);rT=a(Gi,"The "),ji=o(Gi,"A",{href:!0});var xk=r(ji);iT=a(xk,"TFTapasForSequenceClassification"),xk.forEach(t),lT=a(Gi," forward method, overrides the "),Od=o(Gi,"CODE",{});var Ck=r(Od);dT=a(Ck,"__call__"),Ck.forEach(t),pT=a(Gi," special method."),Gi.forEach(t),cT=p(Aa),E(Xn.$$.fragment,Aa),hT=p(Aa),Ld=o(Aa,"P",{});var Mk=r(Ld);uT=a(Mk,"Examples:"),Mk.forEach(t),mT=p(Aa),E(Cr.$$.fragment,Aa),Aa.forEach(t),xs.forEach(t),Np=p(i),bn=o(i,"H2",{class:!0});var Ac=r(bn);Zn=o(Ac,"A",{id:!0,class:!0,href:!0});var Pk=r(Zn);Qd=o(Pk,"SPAN",{});var Sk=r(Qd);E(Mr.$$.fragment,Sk),Sk.forEach(t),Pk.forEach(t),fT=p(Ac),Id=o(Ac,"SPAN",{});var Dk=r(Id);gT=a(Dk,"TFTapasForQuestionAnswering"),Dk.forEach(t),Ac.forEach(t),Op=p(i),ht=o(i,"DIV",{class:!0});var Cs=r(ht);E(Pr.$$.fragment,Cs),_T=p(Cs),wn=o(Cs,"P",{});var Bi=r(wn);TT=a(Bi,`Tapas Model with a cell selection head and optional aggregation head on top for question-answering tasks on tables
(linear layers on top of the hidden-states output to compute `),Wd=o(Bi,"CODE",{});var Nk=r(Wd);vT=a(Nk,"logits"),Nk.forEach(t),bT=a(Bi," and optional "),Hd=o(Bi,"CODE",{});var Ok=r(Hd);wT=a(Ok,"logits_aggregation"),Ok.forEach(t),kT=a(Bi,`), e.g. for
SQA, WTQ or WikiSQL-supervised tasks.`),Bi.forEach(t),yT=p(Cs),Sr=o(Cs,"P",{});var zc=r(Sr);qT=a(zc,"This model inherits from "),$i=o(zc,"A",{href:!0});var Lk=r($i);jT=a(Lk,"TFPreTrainedModel"),Lk.forEach(t),$T=a(zc,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
