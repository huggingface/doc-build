...
outputs = model(**inputs, labels=labels)
loss = outputs.loss
scores = outputs.logits`}}),{c(){d=n("p"),b=i("Example:"),g=p(),k(m.$$.fragment)},l(r){d=s(r,"P",{});var u=a(d);b=l(u,"Example:"),u.forEach(o),g=h(r),T(m.$$.fragment,r)},m(r,u){_(r,d,u),e(d,b),_(r,g,u),y(m,r,u),v=!0},p:Jt,i(r){v||(w(m.$$.fragment,r),v=!0)},o(r){$(m.$$.fragment,r),v=!1},d(r){r&&o(d),r&&o(g),V(m,r)}}}function Ed(B){let d,b,g,m,v,r,u,z,zs,Bn,G,me,Mo,Je,qs,Ao,Fs,zn,fe,xs,Ge,Ps,Es,qn,Gt,Ms,Fn,Yt,jo,As,xn,Xt,js,Pn,ge,Co,Ye,Cs,Zt,Ls,Os,Rs,Lo,Oo,Ns,En,Y,_e,Ro,Xe,Is,No,Ds,Mn,eo,Ss,An,to,Ws,jn,ve,Qs,oo,Hs,Us,Cn,be,Io,no,Ze,Ks,Js,Gs,Do,so,et,Ys,Xs,Ln,ke,Zs,ao,ea,ta,On,tt,Rn,D,oa,ot,na,sa,nt,aa,ra,Nn,X,Te,So,st,ia,Wo,la,In,A,at,da,Z,ca,ro,ua,pa,rt,ha,ma,fa,ee,ga,io,_a,va,lo,ba,ka,Ta,ye,Dn,te,we,Qo,it,ya,Ho,wa,Sn,q,lt,$a,dt,Va,co,Ba,za,qa,ct,Fa,ut,xa,Pa,Ea,pt,Ma,ht,Aa,ja,Ca,C,mt,La,oe,Oa,uo,Ra,Na,Uo,Ia,Da,Sa,$e,Wa,Ve,Wn,ne,Be,Ko,ft,Qa,Jo,Ha,Qn,F,gt,Ua,se,Ka,Go,Ja,Ga,Yo,Ya,Xa,Za,_t,er,po,tr,or,nr,vt,sr,bt,ar,rr,ir,L,kt,lr,ae,dr,ho,cr,ur,Xo,pr,hr,mr,ze,fr,qe,Hn,re,Fe,Zo,Tt,gr,en,_r,Un,x,yt,vr,tn,br,kr,wt,Tr,mo,yr,wr,$r,$t,Vr,Vt,Br,zr,qr,O,Bt,Fr,ie,xr,fo,Pr,Er,on,Mr,Ar,jr,xe,Cr,Pe,Kn,le,Ee,nn,zt,Lr,sn,Or,Jn,P,qt,Rr,an,Nr,Ir,Ft,Dr,go,Sr,Wr,Qr,xt,Hr,Pt,Ur,Kr,Jr,R,Et,Gr,de,Yr,_o,Xr,Zr,rn,ei,ti,oi,Me,ni,Ae,Gn,ce,je,ln,Mt,si,dn,ai,Yn,E,At,ri,cn,ii,li,jt,di,vo,ci,ui,pi,Ct,hi,Lt,mi,fi,gi,N,Ot,_i,ue,vi,bo,bi,ki,un,Ti,yi,wi,Ce,$i,Le,Xn,pe,Oe,pn,Rt,Vi,hn,Bi,Zn,M,Nt,zi,mn,qi,Fi,It,xi,ko,Pi,Ei,Mi,Dt,Ai,St,ji,Ci,Li,I,Wt,Oi,he,Ri,To,Ni,Ii,fn,Di,Si,Wi,Re,Qi,Ne,es;return r=new J({}),Je=new J({}),Xe=new J({}),tt=new Ke({props:{code:`import torch
from transformers import BertTokenizer, VisualBertModel
...
<p><a
  href="/docs/transformers/main/en/main_classes/output#transformers.modeling_outputs.SequenceClassifierOutput"
>transformers.modeling_outputs.SequenceClassifierOutput</a> or <code>tuple(torch.FloatTensor)</code></p>
`}}),Re=new Eo({props:{$$slots:{default:[xd]},$$scope:{ctx:B}}}),Ne=new Kt({props:{anchor:"transformers.VisualBertForRegionToPhraseAlignment.forward.example",$$slots:{default:[Pd]},$$scope:{ctx:B}}}),{c(){d=n("meta"),b=p(),g=n("h1"),m=n("a"),v=n("span"),k(r.$$.fragment),u=p(),z=n("span"),zs=i("VisualBERT"),Bn=p(),G=n("h2"),me=n("a"),Mo=n("span"),k(Je.$$.fragment),qs=p(),Ao=n("span"),Fs=i("Overview"),zn=p(),fe=n("p"),xs=i("The VisualBERT model was proposed in "),Ge=n("a"),Ps=i("VisualBERT: A Simple and Performant Baseline for Vision and Language"),Es=i(` by Liunian Harold Li, Mark Yatskar, Da Yin, Cho-Jui Hsieh, Kai-Wei Chang.
VisualBERT is a neural network trained on a variety of (image, text) pairs.`),qn=p(),Gt=n("p"),Ms=i("The abstract from the paper is the following:"),Fn=p(),Yt=n("p"),jo=n("em"),As=i(`We propose VisualBERT, a simple and flexible framework for modeling a broad range of vision-and-language tasks.
...
verbs and image regions corresponding to their arguments.`),xn=p(),Xt=n("p"),js=i("Tips:"),Pn=p(),ge=n("ol"),Co=n("li"),Ye=n("p"),Cs=i("Most of the checkpoints provided work with the "),Zt=n("a"),Ls=i("VisualBertForPreTraining"),Os=i(` configuration. Other
...
etc.)`),qa=p(),ct=n("p"),Fa=i("This model is also a PyTorch "),ut=n("a"),xa=i("torch.nn.Module"),Pa=i(` subclass.
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),ir=p(),L=n("div"),k(kt.$$.fragment),lr=p(),ae=n("p"),dr=i("The "),ho=n("a"),cr=i("VisualBertForPreTraining"),ur=i(" forward method, overrides the "),Xo=n("code"),pr=i("__call__"),hr=i(" special method."),mr=p(),k(ze.$$.fragment),fr=p(),k(qe.$$.fragment),Hn=p(),re=n("h2"),Fe=n("a"),Zo=n("span"),k(Tt.$$.fragment),gr=p(),en=n("span"),_r=i("VisualBertForQuestionAnswering"),Un=p(),x=n("div"),k(yt.$$.fragment),vr=p(),tn=n("p"),br=i(`VisualBert Model with a classification/regression head on top (a dropout and a linear layer on top of the pooled
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),qr=p(),O=n("div"),k(Bt.$$.fragment),Fr=p(),ie=n("p"),xr=i("The "),fo=n("a"),Pr=i("VisualBertForQuestionAnswering"),Er=i(" forward method, overrides the "),on=n("code"),Mr=i("__call__"),Ar=i(" special method."),jr=p(),k(xe.$$.fragment),Cr=p(),k(Pe.$$.fragment),Kn=p(),le=n("h2"),Ee=n("a"),nn=n("span"),k(zt.$$.fragment),Lr=p(),sn=n("span"),Or=i("VisualBertForMultipleChoice"),Jn=p(),P=n("div"),k(qt.$$.fragment),Rr=p(),an=n("p"),Nr=i(`VisualBert Model with a multiple choice classification head on top (a linear layer on top of the pooled output and
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Qr=p(),xt=n("p"),Hr=i("This model is also a PyTorch "),Pt=n("a"),Ur=i("torch.nn.Module"),Kr=i(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
...
simpler. Further analysis demonstrates that VisualBERT can ground elements of language to image regions without any
explicit supervision and is even sensitive to syntactic relationships, tracking, for example, associations between
verbs and image regions corresponding to their arguments.`),Vn.forEach(o),$n.forEach(o),xn=h(t),Xt=s(t,"P",{});var Ki=a(Xt);js=l(Ki,"Tips:"),Ki.forEach(o),Pn=h(t),ge=s(t,"OL",{});var ts=a(ge);Co=s(ts,"LI",{});var Ji=a(Co);Ye=s(Ji,"P",{});var os=a(Ye);Cs=l(os,"Most of the checkpoints provided work with the "),Zt=s(os,"A",{href:!0});var Gi=a(Zt);Ls=l(Gi,"VisualBertForPreTraining"),Gi.forEach(o),Os=l(os,` configuration. Other
checkpoints provided are the fine-tuned checkpoints for down-stream tasks - VQA (\u2018visualbert-vqa\u2019), VCR
(\u2018visualbert-vcr\u2019), NLVR2 (\u2018visualbert-nlvr2\u2019). Hence, if you are not working on these downstream tasks, it is
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),ds.forEach(o),qa=h(S),ct=s(S,"P",{});var cs=a(ct);Fa=l(cs,"This model is also a PyTorch "),ut=s(cs,"A",{href:!0,rel:!0});var wl=a(ut);xa=l(wl,"torch.nn.Module"),wl.forEach(o),Pa=l(cs,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),ms.forEach(o),ir=h(W),L=s(W,"DIV",{class:!0});var Se=a(L);T(kt.$$.fragment,Se),lr=h(Se),ae=s(Se,"P",{});var zo=a(ae);dr=l(zo,"The "),ho=s(zo,"A",{href:!0});var Al=a(ho);cr=l(Al,"VisualBertForPreTraining"),Al.forEach(o),ur=l(zo," forward method, overrides the "),Xo=s(zo,"CODE",{});var jl=a(Xo);pr=l(jl,"__call__"),jl.forEach(o),hr=l(zo," special method."),zo.forEach(o),mr=h(Se),T(ze.$$.fragment,Se),fr=h(Se),T(qe.$$.fragment,Se),Se.forEach(o),W.forEach(o),Hn=h(t),re=s(t,"H2",{class:!0});var fs=a(re);Fe=s(fs,"A",{id:!0,class:!0,href:!0});var Cl=a(Fe);Zo=s(Cl,"SPAN",{});var Ll=a(Zo);T(Tt.$$.fragment,Ll),Ll.forEach(o),Cl.forEach(o),gr=h(fs),en=s(fs,"SPAN",{});var Ol=a(en);_r=l(Ol,"VisualBertForQuestionAnswering"),Ol.forEach(o),fs.forEach(o),Un=h(t),x=s(t,"DIV",{class:!0});var Q=a(x);T(yt.$$.fragment,Q),vr=h(Q),tn=s(Q,"P",{});var Rl=a(tn);br=l(Rl,`VisualBert Model with a classification/regression head on top (a dropout and a linear layer on top of the pooled
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),_s.forEach(o),qr=h(Q),O=s(Q,"DIV",{class:!0});var We=a(O);T(Bt.$$.fragment,We),Fr=h(We),ie=s(We,"P",{});var qo=a(ie);xr=l(qo,"The "),fo=s(qo,"A",{href:!0});var Dl=a(fo);Pr=l(Dl,"VisualBertForQuestionAnswering"),Dl.forEach(o),Er=l(qo," forward method, overrides the "),on=s(qo,"CODE",{});var Sl=a(on);Mr=l(Sl,"__call__"),Sl.forEach(o),Ar=l(qo," special method."),qo.forEach(o),jr=h(We),T(xe.$$.fragment,We),Cr=h(We),T(Pe.$$.fragment,We),We.forEach(o),Q.forEach(o),Kn=h(t),le=s(t,"H2",{class:!0});var vs=a(le);Ee=s(vs,"A",{id:!0,class:!0,href:!0});var Wl=a(Ee);nn=s(Wl,"SPAN",{});var Ql=a(nn);T(zt.$$.fragment,Ql),Ql.forEach(o),Wl.forEach(o),Lr=h(vs),sn=s(vs,"SPAN",{});var Hl=a(sn);Or=l(Hl,"VisualBertForMultipleChoice"),Hl.forEach(o),vs.forEach(o),Jn=h(t),P=s(t,"DIV",{class:!0});var H=a(P);T(qt.$$.fragment,H),Rr=h(H),an=s(H,"P",{});var Ul=a(an);Nr=l(Ul,`VisualBert Model with a multiple choice classification head on top (a linear layer on top of the pooled output and
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),bs.forEach(o),Qr=h(H),xt=s(H,"P",{});var ks=a(xt);Hr=l(ks,"This model is also a PyTorch "),Pt=s(ks,"A",{href:!0,rel:!0});var Jl=a(Pt);Ur=l(Jl,"torch.nn.Module"),Jl.forEach(o),Kr=l(ks,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),ks.forEach(o),Jr=h(H),R=s(H,"DIV",{class:!0});var Qe=a(R);T(Et.$$.fragment,Qe),Gr=h(Qe),de=s(Qe,"P",{});var Fo=a(de);Yr=l(Fo,"The "),_o=s(Fo,"A",{href:!0});var Gl=a(_o);Xr=l(Gl,"VisualBertForMultipleChoice"),Gl.forEach(o),Zr=l(Fo," forward method, overrides the "),rn=s(Fo,"CODE",{});var Yl=a(rn);ei=l(Yl,"__call__"),Yl.forEach(o),ti=l(Fo," special method."),Fo.forEach(o),oi=h(Qe),T(Me.$$.fragment,Qe),ni=h(Qe),T(Ae.$$.fragment,Qe),Qe.forEach(o),H.forEach(o),Gn=h(t),ce=s(t,"H2",{class:!0});var Ts=a(ce);je=s(Ts,"A",{id:!0,class:!0,href:!0});var Xl=a(je);ln=s(Xl,"SPAN",{});var Zl=a(ln);T(Mt.$$.fragment,Zl),Zl.forEach(o),Xl.forEach(o),si=h(Ts),dn=s(Ts,"SPAN",{});var ed=a(dn);ai=l(ed,"VisualBertForVisualReasoning"),ed.forEach(o),Ts.forEach(o),Yn=h(t),E=s(t,"DIV",{class:!0});var U=a(E);T(At.$$.fragment,U),ri=h(U),cn=s(U,"P",{});var td=a(cn);ii=l(td,`VisualBert Model with a sequence classification head on top (a dropout and a linear layer on top of the pooled
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),ws.forEach(o),gi=h(U),N=s(U,"DIV",{class:!0});var He=a(N);T(Ot.$$.fragment,He),_i=h(He),ue=s(He,"P",{});var xo=a(ue);vi=l(xo,"The "),bo=s(xo,"A",{href:!0});var sd=a(bo);bi=l(sd,"VisualBertForVisualReasoning"),sd.forEach(o),ki=l(xo," forward method, overrides the "),un=s(xo,"CODE",{});var ad=a(un);Ti=l(ad,"__call__"),ad.forEach(o),yi=l(xo," special method."),xo.forEach(o),wi=h(He),T(Ce.$$.fragment,He),$i=h(He),T(Le.$$.fragment,He),He.forEach(o),U.forEach(o),Xn=h(t),pe=s(t,"H2",{class:!0});var $s=a(pe);Oe=s($s,"A",{id:!0,class:!0,href:!0});var rd=a(Oe);pn=s(rd,"SPAN",{});var id=a(pn);T(Rt.$$.fragment,id),id.forEach(o),rd.forEach(o),Vi=h($s),hn=s($s,"SPAN",{});var ld=a(hn);Bi=l(ld,"VisualBertForRegionToPhraseAlignment"),ld.forEach(o),$s.forEach(o),Zn=h(t),M=s(t,"DIV",{class:!0});var K=a(M);T(Nt.$$.fragment,K),zi=h(K),mn=s(K,"P",{});var dd=a(mn);qi=l(dd,`VisualBert Model with a Masked Language Modeling head and an attention layer on top for Region-to-Phrase Alignment
e.g. for Flickr30 Entities task.`),dd.forEach(o),Fi=h(K),It=s(K,"P",{});var Vs=a(It);xi=l(Vs,"This model inherits from "),ko=s(Vs,"A",{href:!0});var cd=a(ko);Pi=l(cd,"PreTrainedModel"),cd.forEach(o),Ei=l(Vs,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
