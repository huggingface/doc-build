...
<span class="hljs-literal">True</span>`}}),{c(){l=a("p"),k=i("Example:"),m=c(),y(h.$$.fragment)},l(n){l=s(n,"P",{});var u=r(l);k=d(u,"Example:"),u.forEach(t),m=p(n),v(h.$$.fragment,n)},m(n,u){b(n,l,u),e(l,k),b(n,m,u),T(h,n,u),g=!0},p:P,i(n){g||(w(h.$$.fragment,n),g=!0)},o(n){M(h.$$.fragment,n),g=!1},d(n){n&&t(l),n&&t(m),$(h,n)}}}function a1(x){let l,k,m,h,g,n,u,q,_t,tt,U,Ge,We,B,ye,ve,gt,ot,X,ue,Re,K,bt,Ue,Te,nt,he,we,Me,kt,Xe,O,I,yt,me,ie,vt,J,Tt,wt,A,Mt,fe,de,_e,le,$e,$t,Z,xt,ge,R,Qe,N,zt,Y,He,Ft;return{c(){l=a("p"),k=i("TensorFlow models and layers in "),m=a("code"),h=i("transformers"),g=i(" accept two formats as input:"),n=c(),u=a("ul"),q=a("li"),_t=i("having all inputs as keyword arguments (like PyTorch models), or"),tt=c(),U=a("li"),Ge=i("having all inputs as a list, tuple or dict in the first positional argument."),We=c(),B=a("p"),ye=i(`The reason the second format is supported is that Keras methods prefer this format when passing inputs to models
...
about any of this, as you can just pass inputs like you would to any other Python function!`),this.h()},l(z){l=s(z,"P",{});var j=r(l);k=d(j,"TensorFlow models and layers in "),m=s(j,"CODE",{});var Zt=r(m);h=d(Zt,"transformers"),Zt.forEach(t),g=d(j," accept two formats as input:"),j.forEach(t),n=p(z),u=s(z,"UL",{});var Ve=r(u);q=s(Ve,"LI",{});var qt=r(q);_t=d(qt,"having all inputs as keyword arguments (like PyTorch models), or"),qt.forEach(t),tt=p(Ve),U=s(Ve,"LI",{});var Yt=r(U);Ge=d(Yt,"having all inputs as a list, tuple or dict in the first positional argument."),Yt.forEach(t),Ve.forEach(t),We=p(z),B=s(z,"P",{});var S=r(B);ye=d(S,`The reason the second format is supported is that Keras methods prefer this format when passing inputs to models
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),{c(){l=a("p"),k=i("Example:"),m=c(),y(h.$$.fragment)},l(n){l=s(n,"P",{});var u=r(l);k=d(u,"Example:"),u.forEach(t),m=p(n),v(h.$$.fragment,n)},m(n,u){b(n,l,u),e(l,k),b(n,m,u),T(h,n,u),g=!0},p:P,i(n){g||(w(h.$$.fragment,n),g=!0)},o(n){M(h.$$.fragment,n),g=!1},d(n){n&&t(l),n&&t(m),$(h,n)}}}function i1(x){let l,k,m,h,g,n,u,q,_t,tt,U,Ge,We,B,ye,ve,gt,ot,X,ue,Re,K,bt,Ue,Te,nt,he,we,Me,kt,Xe,O,I,yt,me,ie,vt,J,Tt,wt,A,Mt,fe,de,_e,le,$e,$t,Z,xt,ge,R,Qe,N,zt,Y,He,Ft;return{c(){l=a("p"),k=i("TensorFlow models and layers in "),m=a("code"),h=i("transformers"),g=i(" accept two formats as input:"),n=c(),u=a("ul"),q=a("li"),_t=i("having all inputs as keyword arguments (like PyTorch models), or"),tt=c(),U=a("li"),Ge=i("having all inputs as a list, tuple or dict in the first positional argument."),We=c(),B=a("p"),ye=i(`The reason the second format is supported is that Keras methods prefer this format when passing inputs to models
and layers. Because of this support, when using methods like `),ve=a("code"),gt=i("model.fit()"),ot=i(` things should \u201Cjust work\u201D for you - just
pass your inputs and labels in any format that `),X=a("code"),ue=i("model.fit()"),Re=i(` supports! If, however, you want to use the second
format outside of Keras methods like `),K=a("code"),bt=i("fit()"),Ue=i(" and "),Te=a("code"),nt=i("predict()"),he=i(`, such as when creating your own layers or models with
the Keras `),we=a("code"),Me=i("Functional"),kt=i(` API, there are three possibilities you can use to gather all the input Tensors in the first
...
`),ge=s(Ct,"CODE",{});var no=r(ge);R=d(no,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),no.forEach(t),Ct.forEach(t),ce.forEach(t),Qe=p(z),N=s(z,"P",{});var Ce=r(N);zt=d(Ce,`Note that when creating models and layers with
`),Y=s(Ce,"A",{href:!0,rel:!0});var at=r(Y);He=d(at,"subclassing"),at.forEach(t),Ft=d(Ce,` then you don\u2019t need to worry
about any of this, as you can just pass inputs like you would to any other Python function!`),Ce.forEach(t),this.h()},h(){f(Y,"href","https://keras.io/guides/making_new_layers_and_models_via_subclassing/"),f(Y,"rel","nofollow")},m(z,j){b(z,l,j),e(l,k),e(l,m),e(m,h),e(l,g),b(z,n,j),b(z,u,j),e(u,q),e(q,_t),e(u,tt),e(u,U),e(U,Ge),b(z,We,j),b(z,B,j),e(B,ye),e(B,ve),e(ve,gt),e(B,ot),e(B,X),e(X,ue),e(B,Re),e(B,K),e(K,bt),e(B,Ue),e(B,Te),e(Te,nt),e(B,he),e(B,we),e(we,Me),e(B,kt),b(z,Xe,j),b(z,O,j),e(O,I),e(I,yt),e(I,me),e(me,ie),e(I,vt),e(I,J),e(J,Tt),e(O,wt),e(O,A),e(A,Mt),e(A,fe),e(fe,de),e(A,_e),e(A,le),e(le,$e),e(O,$t),e(O,Z),e(Z,xt),e(Z,ge),e(ge,R),b(z,Qe,j),b(z,N,j),e(N,zt),e(N,Y),e(Y,He),e(N,Ft)},d(z){z&&t(l),z&&t(n),z&&t(u),z&&t(We),z&&t(B),z&&t(Xe),z&&t(O),z&&t(Qe),z&&t(N)}}}function d1(x){let l,k,m,h,g;return{c(){l=a("p"),k=i("Although the recipe for forward pass needs to be defined within this function, one should call the "),m=a("code"),h=i("Module"),g=i(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(n){l=s(n,"P",{});var u=r(l);k=d(u,"Although the recipe for forward pass needs to be defined within this function, one should call the "),m=s(u,"CODE",{});var q=r(m);h=d(q,"Module"),q.forEach(t),g=d(u,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
<span class="hljs-meta">&gt;&gt;&gt; </span>outputs = model.decode(decoder_input_ids, encoder_outputs)
<span class="hljs-meta">&gt;&gt;&gt; </span>last_decoder_hidden_states = outputs.last_hidden_state`}}),{c(){l=a("p"),k=i("Example:"),m=c(),y(h.$$.fragment)},l(n){l=s(n,"P",{});var u=r(l);k=d(u,"Example:"),u.forEach(t),m=p(n),v(h.$$.fragment,n)},m(n,u){b(n,l,u),e(l,k),b(n,m,u),T(h,n,u),g=!0},p:P,i(n){g||(w(h.$$.fragment,n),g=!0)},o(n){M(h.$$.fragment,n),g=!1},d(n){n&&t(l),n&&t(m),$(h,n)}}}function F1(x){let l,k,m,h,g,n,u,q,_t,tt,U,Ge,We,B,ye,ve,gt,ot,X,ue,Re,K,bt,Ue,Te,nt,he,we,Me,kt,Xe,O,I,yt,me,ie,vt,J,Tt,wt,A,Mt,fe,de,_e,le,$e,$t,Z,xt,ge,R,Qe,N,zt,Y,He,Ft,z,j,Zt,Ve,qt,Yt,S,Dt,te,eo,Ke,Bt,ce,xe,to,jt,ze,oo,Et,Ct,no,Ce,at,yd,Lh,wp,Sa,Mp,Mi,Oa,vd,Gh,Wh,ao,Rh,Td,Uh,Xh,wd,Qh,Hh,$p,Aa,xp,so,Ro,Md,Ia,Vh,$d,Kh,zp,Lt,Jh,Na,Zh,Yh,xd,em,tm,Fp,$i,om,qp,xi,zd,nm,Bp,ro,Uo,Fd,Da,am,qd,sm,jp,st,rm,Bd,im,dm,jd,lm,cm,Ed,pm,um,Ep,Xo,hm,zi,mm,fm,Cp,Fi,Cd,_m,Pp,La,Sp,qi,Ga,Pd,gm,bm,Fe,km,Sd,ym,vm,Od,Tm,wm,Ad,Mm,$m,Id,xm,zm,Nd,Fm,qm,Op,Wa,Ap,io,Qo,Dd,Ra,Bm,Ld,jm,Ip,Je,Ua,Em,lo,Cm,Bi,Pm,Sm,Xa,Om,Am,Im,co,Nm,ji,Dm,Lm,Ei,Gm,Wm,Rm,Ho,Np,po,Vo,Gd,Qa,Um,Wd,Xm,Dp,pe,Ha,Qm,Rd,Hm,Vm,Pt,Km,Ci,Jm,Zm,Pi,Ym,ef,Va,tf,of,nf,uo,af,Ud,sf,rf,Xd,df,lf,cf,Ko,pf,rt,Ka,uf,Ja,hf,Qd,mf,ff,_f,Za,Ya,Hd,gf,bf,Vd,kf,yf,es,Kd,vf,Tf,Jd,wf,Mf,Zd,$f,Lp,ho,Jo,Yd,ts,xf,el,zf,Gp,D,os,Ff,mo,qf,tl,Bf,jf,ns,Ef,Cf,Pf,as,Sf,Si,Of,Af,If,fo,Nf,ol,Df,Lf,nl,Gf,Wf,Rf,Zo,Uf,Pe,ss,Xf,al,Qf,Hf,rs,Vf,sl,Kf,Jf,Zf,is,ds,rl,Yf,e_,il,t_,o_,ls,dl,n_,a_,ll,s_,r_,cl,i_,d_,Yo,cs,l_,pl,c_,p_,en,ps,u_,ul,h_,m_,tn,us,f_,hl,__,Wp,_o,on,ml,hs,g_,fl,b_,Rp,L,ms,k_,fs,y_,_s,v_,T_,w_,gs,M_,Oi,$_,x_,z_,nn,F_,it,bs,q_,ks,B_,_l,j_,E_,C_,ys,vs,gl,P_,S_,bl,O_,A_,Ts,kl,I_,N_,yl,D_,L_,vl,G_,W_,an,ws,R_,Tl,U_,X_,sn,Ms,Q_,$s,H_,wl,V_,K_,J_,rn,xs,Z_,Ml,Y_,eg,dn,zs,tg,$l,og,Up,go,ln,xl,Fs,ng,zl,ag,Xp,ee,qs,sg,bo,rg,Fl,ig,dg,Bs,lg,cg,pg,js,ug,Ai,hg,mg,fg,cn,_g,Se,Es,gg,ql,bg,kg,Cs,yg,Bl,vg,Tg,wg,Ps,Ss,jl,Mg,$g,El,xg,zg,Os,Cl,Fg,qg,Pl,Bg,jg,Sl,Eg,Cg,pn,As,Pg,Ol,Sg,Og,un,Is,Ag,Al,Ig,Qp,ko,hn,Il,Ns,Ng,Nl,Dg,Hp,Ze,Ds,Lg,Ls,Gg,Ii,Wg,Rg,Ug,Gs,Xg,Ws,Qg,Hg,Vg,dt,Rs,Kg,yo,Jg,Ni,Zg,Yg,Dl,eb,tb,ob,mn,nb,fn,Vp,vo,_n,Ll,Us,ab,Gl,sb,Kp,Ye,Xs,rb,Qs,ib,Di,db,lb,cb,Hs,pb,Vs,ub,hb,mb,Oe,Ks,fb,To,_b,Li,gb,bb,Wl,kb,yb,vb,gn,Tb,bn,wb,kn,Jp,wo,yn,Rl,Js,Mb,Ul,$b,Zp,qe,Zs,xb,Mo,zb,Xl,Fb,qb,Ql,Bb,jb,Eb,Ys,Cb,Gi,Pb,Sb,Ob,er,Ab,tr,Ib,Nb,Db,Ae,or,Lb,$o,Gb,Wi,Wb,Rb,Hl,Ub,Xb,Qb,vn,Hb,Tn,Vb,wn,Yp,xo,Mn,Vl,nr,Kb,Kl,Jb,eu,Be,ar,Zb,Jl,Yb,ek,sr,tk,Ri,ok,nk,ak,rr,sk,ir,rk,ik,dk,oe,dr,lk,zo,ck,Ui,pk,uk,Zl,hk,mk,fk,$n,_k,xn,gk,zn,bk,Fn,kk,qn,tu,Fo,Bn,Yl,lr,yk,ec,vk,ou,qo,cr,Tk,jn,pr,wk,En,nu,Bo,Cn,tc,ur,Mk,oc,$k,au,je,hr,xk,mr,zk,Xi,Fk,qk,Bk,fr,jk,_r,Ek,Ck,Pk,Pn,Sk,lt,gr,Ok,jo,Ak,Qi,Ik,Nk,nc,Dk,Lk,Gk,Sn,Wk,On,su,Eo,An,ac,br,Rk,sc,Uk,ru,Ee,kr,Xk,yr,Qk,Hi,Hk,Vk,Kk,vr,Jk,Tr,Zk,Yk,ey,In,ty,Ie,wr,oy,Co,ny,Vi,ay,sy,rc,ry,iy,dy,Nn,ly,Dn,cy,Ln,iu,Po,Gn,ic,Mr,py,dc,uy,du,Q,$r,hy,xr,my,Ki,fy,_y,gy,zr,by,Fr,ky,yy,vy,lc,Ty,wy,St,cc,qr,My,$y,pc,Br,xy,zy,uc,jr,Fy,qy,hc,Er,By,jy,ct,Cr,Ey,So,Cy,mc,Py,Sy,fc,Oy,Ay,Iy,Wn,Ny,Rn,Dy,Un,Pr,Ly,Xn,Gy,Qn,Sr,Wy,Hn,lu,Oo,Vn,_c,Or,Ry,gc,Uy,cu,H,Ar,Xy,Ir,Qy,Ji,Hy,Vy,Ky,Nr,Jy,Dr,Zy,Yy,ev,bc,tv,ov,Ot,kc,Lr,nv,av,yc,Gr,sv,rv,vc,Wr,iv,dv,Tc,Rr,lv,cv,Ne,Ur,pv,Ao,uv,wc,hv,mv,Mc,fv,_v,gv,Kn,bv,Jn,kv,Zn,yv,Yn,Xr,vv,ea,Tv,ta,Qr,wv,oa,pu,Io,na,$c,Hr,Mv,xc,$v,uu,G,Vr,xv,zc,zv,Fv,Kr,qv,Zi,Bv,jv,Ev,Jr,Cv,Zr,Pv,Sv,Ov,Fc,Av,Iv,At,qc,Yr,Nv,Dv,Bc,ei,Lv,Gv,jc,ti,Wv,Rv,Ec,oi,Uv,Xv,pt,ni,Qv,No,Hv,Cc,Vv,Kv,Pc,Jv,Zv,Yv,aa,eT,sa,tT,ra,ai,oT,ia,nT,da,si,aT,la,hu,Do,ca,Sc,ri,sT,Oc,rT,mu,W,ii,iT,Lo,dT,Ac,lT,cT,Ic,pT,uT,hT,di,mT,Yi,fT,_T,gT,li,bT,ci,kT,yT,vT,Nc,TT,wT,It,Dc,pi,MT,$T,Lc,ui,xT,zT,Gc,hi,FT,qT,Wc,mi,BT,jT,ut,fi,ET,Go,CT,Rc,PT,ST,Uc,OT,AT,IT,pa,NT,ua,DT,ha,_i,LT,ma,GT,fa,gi,WT,_a,fu;return n=new V({}),K=new V({}),$e=new V({}),Sa=new E({props:{code:`from transformers import MBartForConditionalGeneration, MBartTokenizer
...
`,returnType:`
<p><code>List[int]</code></p>
`}}),xs=new F({props:{name:"set_src_lang_special_tokens",anchor:"transformers.MBart50Tokenizer.set_src_lang_special_tokens",parameters:[{name:"src_lang",val:": str"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/mbart50/tokenization_mbart50.py#L343"}}),zs=new F({props:{name:"set_tgt_lang_special_tokens",anchor:"transformers.MBart50Tokenizer.set_tgt_lang_special_tokens",parameters:[{name:"tgt_lang",val:": str"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/mbart50/tokenization_mbart50.py#L349"}}),Fs=new V({}),qs=new F({props:{name:"class transformers.MBart50TokenizerFast",anchor:"transformers.MBart50TokenizerFast",parameters:[{name:"vocab_file",val:" = None"},{name:"src_lang",val:" = None"},{name:"tgt_lang",val:" = None"},{name:"tokenizer_file",val:" = None"},{name:"eos_token",val:" = '</s>'"},{name:"sep_token",val:" = '</s>'"},{name:"cls_token",val:" = '<s>'"},{name:"unk_token",val:" = '<unk>'"},{name:"pad_token",val:" = '<pad>'"},{name:"mask_token",val:" = '<mask>'"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.MBart50TokenizerFast.vocab_file",description:`<strong>vocab_file</strong> (<code>str</code>) &#x2014;
...
<p><a
  href="/docs/transformers/main/en/main_classes/output#transformers.modeling_flax_outputs.FlaxBaseModelOutputWithPastAndCrossAttentions"
>transformers.modeling_flax_outputs.FlaxBaseModelOutputWithPastAndCrossAttentions</a> or <code>tuple(torch.FloatTensor)</code></p>
`}}),_a=new C({props:{anchor:"transformers.FlaxMBartForQuestionAnswering.decode.example",$$slots:{default:[z1]},$$scope:{ctx:x}}}),{c(){l=a("meta"),k=c(),m=a("h1"),h=a("a"),g=a("span"),y(n.$$.fragment),u=c(),q=a("span"),_t=i("MBart and MBart-50"),tt=c(),U=a("p"),Ge=a("strong"),We=i("DISCLAIMER:"),B=i(" If you see something strange, file a "),ye=a("a"),ve=i("Github Issue"),gt=i(` and assign
...
target text format is `),j=a("code"),Zt=i("[tgt_lang_code] X [eos]"),Ve=i(". "),qt=a("code"),Yt=i("bos"),S=i(" is never used."),Dt=c(),te=a("p"),eo=i("The regular "),Ke=a("a"),Bt=a("strong"),ce=i("call"),xe=i("()"),to=i(" will encode source text format passed as first argument or with the "),jt=a("code"),ze=i("text"),oo=i(`
...
respectively.`),Ep=c(),Xo=a("p"),hm=i("MBart-50 has its own tokenizer "),zi=a("a"),mm=i("MBart50Tokenizer"),fm=i("."),Cp=c(),Fi=a("ul"),Cd=a("li"),_m=i("Supervised training"),Pp=c(),y(La.$$.fragment),Sp=c(),qi=a("ul"),Ga=a("li"),Pd=a("p"),gm=i("Generation"),bm=c(),Fe=a("p"),km=i("To generate using the mBART-50 multilingual translation models, "),Sd=a("code"),ym=i("eos_token_id"),vm=i(` is used as the
...
refer to this superclass for more information regarding those methods.`),fg=c(),y(cn.$$.fragment),_g=c(),Se=a("div"),y(Es.$$.fragment),gg=c(),ql=a("p"),bg=i(`Build model inputs from a sequence or a pair of sequence for sequence classification tasks by concatenating and
adding special tokens. The special tokens depend on calling set_lang.`),kg=c(),Cs=a("p"),yg=i("An MBART-50 sequence has the following format, where "),Bl=a("code"),vg=i("X"),Tg=i(" represents the sequence:"),wg=c(),Ps=a("ul"),Ss=a("li"),jl=a("code"),Mg=i("input_ids"),$g=i(" (for encoder) "),El=a("code"),xg=i("[src_lang_code] X [eos]"),zg=c(),Os=a("li"),Cl=a("code"),Fg=i("labels"),qg=i(": (for decoder) "),Pl=a("code"),Bg=i("[tgt_lang_code] X [eos]"),jg=c(),Sl=a("p"),Eg=i(`BOS is never used. Pairs of sequences are not the expected use case, but they will be handled without a
...
layer on top of the hidden-states output to compute `),Xl=a("code"),Fb=i("span start logits"),qb=i(" and "),Ql=a("code"),Bb=i("span end logits"),jb=i(")."),Eb=c(),Ys=a("p"),Cb=i("This model inherits from "),Gi=a("a"),Pb=i("PreTrainedModel"),Sb=i(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),dk=c(),oe=a("div"),y(dr.$$.fragment),lk=c(),zo=a("p"),ck=i("The "),Ui=a("a"),pk=i("MBartForSequenceClassification"),uk=i(" forward method, overrides the "),Zl=a("code"),hk=i("__call__"),mk=i(" special method."),fk=c(),y($n.$$.fragment),_k=c(),y(xn.$$.fragment),gk=c(),y(zn.$$.fragment),bk=c(),y(Fn.$$.fragment),kk=c(),y(qn.$$.fragment),tu=c(),Fo=a("h2"),Bn=a("a"),Yl=a("span"),y(lr.$$.fragment),yk=c(),ec=a("span"),vk=i("MBartForCausalLM"),ou=c(),qo=a("div"),y(cr.$$.fragment),Tk=c(),jn=a("div"),y(pr.$$.fragment),wk=c(),y(En.$$.fragment),nu=c(),Bo=a("h2"),Cn=a("a"),tc=a("span"),y(ur.$$.fragment),Mk=c(),oc=a("span"),$k=i("TFMBartModel"),au=c(),je=a("div"),y(hr.$$.fragment),xk=c(),mr=a("p"),zk=i(`The bare MBART Model outputting raw hidden-states without any specific head on top.
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Bk=c(),fr=a("p"),jk=i("This model is also a "),_r=a("a"),Ek=i("tf.keras.Model"),Ck=i(` subclass. Use it
...
its embedding layers with randomly initialized vectors for an extra set of 25 language tokens and then pretrained on 50
languages.`),td.forEach(t),Fp=p(o),$i=s(o,"P",{});var XT=r($i);om=d(XT,"According to the abstract"),XT.forEach(t),qp=p(o),xi=s(o,"P",{});var QT=r(xi);zd=s(QT,"EM",{});var HT=r(zd);nm=d(HT,`Multilingual translation models can be created through multilingual finetuning. Instead of finetuning on one
direction, a pretrained model is finetuned on many directions at the same time. It demonstrates that pretrained models
can be extended to incorporate additional languages without loss of performance. Multilingual finetuning improves on
average 1 BLEU over the strongest baselines (being either multilingual from scratch or bilingual finetuning) while
improving 9.3 BLEU on average over bilingual baselines from scratch.`),HT.forEach(t),QT.forEach(t),Bp=p(o),ro=s(o,"H3",{class:!0});var _u=r(ro);Uo=s(_u,"A",{id:!0,class:!0,href:!0});var VT=r(Uo);Fd=s(VT,"SPAN",{});var KT=r(Fd);v(Da.$$.fragment,KT),KT.forEach(t),VT.forEach(t),am=p(_u),qd=s(_u,"SPAN",{});var JT=r(qd);sm=d(JT,"Training of MBart-50"),JT.forEach(t),_u.forEach(t),jp=p(o),st=s(o,"P",{});var ka=r(st);rm=d(ka,`The text format for MBart-50 is slightly different from mBART. For MBart-50 the language id token is used as a prefix
...
respectively.`),ka.forEach(t),Ep=p(o),Xo=s(o,"P",{});var gu=r(Xo);hm=d(gu,"MBart-50 has its own tokenizer "),zi=s(gu,"A",{href:!0});var tw=r(zi);mm=d(tw,"MBart50Tokenizer"),tw.forEach(t),fm=d(gu,"."),gu.forEach(t),Cp=p(o),Fi=s(o,"UL",{});var ow=r(Fi);Cd=s(ow,"LI",{});var nw=r(Cd);_m=d(nw,"Supervised training"),nw.forEach(t),ow.forEach(t),Pp=p(o),v(La.$$.fragment,o),Sp=p(o),qi=s(o,"UL",{});var aw=r(qi);Ga=s(aw,"LI",{});var bu=r(Ga);Pd=s(bu,"P",{});var sw=r(Pd);gm=d(sw,"Generation"),sw.forEach(t),bm=p(bu),Fe=s(bu,"P",{});var ht=r(Fe);km=d(ht,"To generate using the mBART-50 multilingual translation models, "),Sd=s(ht,"CODE",{});var rw=r(Sd);ym=d(rw,"eos_token_id"),rw.forEach(t),vm=d(ht,` is used as the
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),dh.forEach(t),Db=p(Ut),Ae=s(Ut,"DIV",{class:!0});var Xt=r(Ae);v(or.$$.fragment,Xt),Lb=p(Xt),$o=s(Xt,"P",{});var pd=r($o);Gb=d(pd,"The "),Wi=s(pd,"A",{href:!0});var HM=r(Wi);Wb=d(HM,"MBartForQuestionAnswering"),HM.forEach(t),Rb=d(pd," forward method, overrides the "),Hl=s(pd,"CODE",{});var VM=r(Hl);Ub=d(VM,"__call__"),VM.forEach(t),Xb=d(pd," special method."),pd.forEach(t),Qb=p(Xt),v(vn.$$.fragment,Xt),Hb=p(Xt),v(Tn.$$.fragment,Xt),Vb=p(Xt),v(wn.$$.fragment,Xt),Xt.forEach(t),Ut.forEach(t),Yp=p(o),xo=s(o,"H2",{class:!0});var lh=r(xo);Mn=s(lh,"A",{id:!0,class:!0,href:!0});var KM=r(Mn);Vl=s(KM,"SPAN",{});var JM=r(Vl);v(nr.$$.fragment,JM),JM.forEach(t),KM.forEach(t),Kb=p(lh),Kl=s(lh,"SPAN",{});var ZM=r(Kl);Jb=d(ZM,"MBartForSequenceClassification"),ZM.forEach(t),lh.forEach(t),eu=p(o),Be=s(o,"DIV",{class:!0});var Qt=r(Be);v(ar.$$.fragment,Qt),Zb=p(Qt),Jl=s(Qt,"P",{});var YM=r(Jl);Yb=d(YM,`MBart model with a sequence classification/head on top (a linear layer on top of the pooled output) e.g. for GLUE
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),_h.forEach(t),Bk=p(Ht),fr=s(Ht,"P",{});var gh=r(fr);jk=d(gh,"This model is also a "),_r=s(gh,"A",{href:!0,rel:!0});var p$=r(_r);Ek=d(p$,"tf.keras.Model"),p$.forEach(t),Ck=d(gh,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
