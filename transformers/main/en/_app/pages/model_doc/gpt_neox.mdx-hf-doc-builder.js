...
<span class="hljs-meta">&gt;&gt;&gt; </span>configuration = model.config`}}),{c(){v(d.$$.fragment)},l(p){k(d.$$.fragment,p)},m(p,u){w(d,p,u),T=!0},p:oo,i(p){T||(P(d.$$.fragment,p),T=!0)},o(p){y(d.$$.fragment,p),T=!1},d(p){$(d,p)}}}function vs(G){let d,T,p,u,b;return u=new tt({props:{code:`from transformers import GPTNeoXTokenizerFast
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),{c(){d=n("p"),T=i("Example:"),p=m(),v(u.$$.fragment)},l(r){d=s(r,"P",{});var _=a(d);T=l(_,"Example:"),_.forEach(o),p=f(r),k(u.$$.fragment,r)},m(r,_){g(r,d,_),t(d,T),g(r,p,_),w(u,r,_),b=!0},p:oo,i(r){b||(P(u.$$.fragment,r),b=!0)},o(r){y(u.$$.fragment,r),b=!1},d(r){r&&o(d),r&&o(p),$(u,r)}}}function ys(G){let d,T,p,u,b;return{c(){d=n("p"),T=i("Although the recipe for forward pass needs to be defined within this function, one should call the "),p=n("code"),u=i("Module"),b=i(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(r){d=s(r,"P",{});var _=a(d);T=l(_,"Although the recipe for forward pass needs to be defined within this function, one should call the "),p=s(_,"CODE",{});var X=a(p);u=l(X,"Module"),X.forEach(o),b=l(_,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),_.forEach(o)},m(r,_){g(r,d,_),t(d,T),t(d,p),t(p,u),t(d,b)},d(r){r&&o(d)}}}function $s(G){let d,T,p,u,b;return u=new tt({props:{code:`from transformers import GPTNeoXTokenizerFast, GPTNeoXForCausalLM, GPTNeoXConfig
import torch
...
<span class="hljs-meta">&gt;&gt;&gt; </span>prediction_logits = outputs.logits`}}),{c(){d=n("p"),T=i("Example:"),p=m(),v(u.$$.fragment)},l(r){d=s(r,"P",{});var _=a(d);T=l(_,"Example:"),_.forEach(o),p=f(r),k(u.$$.fragment,r)},m(r,_){g(r,d,_),t(d,T),g(r,p,_),w(u,r,_),b=!0},p:oo,i(r){b||(P(u.$$.fragment,r),b=!0)},o(r){y(u.$$.fragment,r),b=!1},d(r){r&&o(d),r&&o(p),$(u,r)}}}function Ns(G){let d,T,p,u,b,r,_,X,I,z,M,q,ot,me,no,nt,so,Nt,R,ao,fe,ro,io,Gt,Y,lo,ue,co,po,Xt,Le,ho,xt,ge,zt,Oe,mo,Ft,L,K,st,_e,fo,at,uo,Mt,Q,go,rt,_o,To,Et,Te,Ct,O,Z,it,be,bo,lt,vo,qt,F,ve,ko,S,wo,Se,Po,yo,ke,$o,No,Go,D,Xo,De,xo,zo,Be,Fo,Mo,Eo,ee,jt,B,te,dt,we,Co,ct,qo,At,N,Pe,jo,ye,Ao,pt,Io,Lo,Oo,ht,So,Do,oe,Bo,$e,Wo,mt,Ho,Uo,Vo,ne,Jo,Ne,Ro,We,Yo,Ko,It,W,se,ft,Ge,Qo,ut,Zo,Lt,j,Xe,en,xe,tn,ze,on,nn,sn,E,Fe,an,H,rn,He,ln,dn,gt,cn,pn,hn,ae,mn,re,Ot,U,ie,_t,Me,fn,Tt,un,St,A,Ee,gn,V,_n,bt,Tn,bn,Ce,vn,kn,wn,C,qe,Pn,J,yn,Ue,$n,Nn,vt,Gn,Xn,xn,le,zn,de,Dt;return r=new Ie({}),me=new Ie({}),ge=new tt({props:{code:'model = GPTNeoXForCausalLM.from_pretrained("EleutherAI/gpt-neox-20b").half().cuda()',highlighted:'model = GPTNeoXForCausalLM.from_pretrained(<span class="hljs-string">&quot;EleutherAI/gpt-neox-20b&quot;</span>).half().cuda()'}}),_e=new Ie({}),Te=new tt({props:{code:`from transformers import GPTNeoXForCausalLM, GPTNeoXTokenizerFast
...
generous the support of `),ue=n("a"),co=i("CoreWeave"),po=i("."),Xt=m(),Le=n("p"),ho=i("GPT-NeoX-20B was trained with fp16, thus it is recommended to initialize the model as follows:"),xt=m(),v(ge.$$.fragment),zt=m(),Oe=n("p"),mo=i(`GPT-NeoX-20B also has a different tokenizer from the one used in GPT-J-6B and GPT-Neo. The new tokenizer allocates
additional tokens to whitespace characters, making the model more suitable for certain tasks like code generation.`),Ft=m(),L=n("h3"),K=n("a"),st=n("span"),v(_e.$$.fragment),fo=m(),at=n("span"),uo=i("Generation"),Mt=m(),Q=n("p"),go=i("The "),rt=n("code"),_o=i("generate()"),To=i(" method can be used to generate text using GPT Neo model."),Et=m(),v(Te.$$.fragment),Ct=m(),O=n("h2"),Z=n("a"),it=n("span"),v(be.$$.fragment),bo=m(),lt=n("span"),vo=i("GPTNeoXConfig"),qt=m(),F=n("div"),v(ve.$$.fragment),ko=m(),S=n("p"),wo=i("This is the configuration class to store the configuration of a "),Se=n("a"),Po=i("GPTNeoXModel"),yo=i(`. It is used to instantiate an
...
documentation from `),Be=n("a"),Fo=i("PretrainedConfig"),Mo=i(" for more information."),Eo=m(),v(ee.$$.fragment),jt=m(),B=n("h2"),te=n("a"),dt=n("span"),v(we.$$.fragment),Co=m(),ct=n("span"),qo=i("GPTNeoXTokenizerFast"),At=m(),N=n("div"),v(Pe.$$.fragment),jo=m(),ye=n("p"),Ao=i("Construct a \u201Cfast\u201D GPT-NeoX-20B tokenizer (backed by HuggingFace\u2019s "),pt=n("em"),Io=i("tokenizers"),Lo=i(` library). Based on byte-level
Byte-Pair-Encoding.`),Oo=m(),ht=n("p"),So=i("This tokenizer has been trained to treat spaces like parts of the tokens (a bit like sentencepiece) so a word will"),Do=m(),v(oe.$$.fragment),Bo=m(),$e=n("p"),Wo=i("You can get around that behavior by passing "),mt=n("code"),Ho=i("add_prefix_space=True"),Uo=i(` when instantiating this tokenizer, but since
