...
the latter silently ignores them.`)},l(r){d=s(r,"P",{});var _=a(d);T=l(_,"Although the recipe for forward pass needs to be defined within this function, one should call the "),p=s(_,"CODE",{});var X=a(p);u=l(X,"Module"),X.forEach(o),v=l(_,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),_.forEach(o)},m(r,_){g(r,d,_),t(d,T),t(d,p),t(p,u),t(d,v)},d(r){r&&o(d)}}}function $s(G){let d,T,p,u,v;return u=new tt({props:{code:`from transformers import GPTNeoXTokenizerFast, GPTNeoXForCausalLM, GPTNeoXConfig
import torch
...
<span class="hljs-meta">&gt;&gt;&gt; </span>prediction_logits = outputs.logits`}}),{c(){d=n("p"),T=i("Example:"),p=m(),b(u.$$.fragment)},l(r){d=s(r,"P",{});var _=a(d);T=l(_,"Example:"),_.forEach(o),p=f(r),k(u.$$.fragment,r)},m(r,_){g(r,d,_),t(d,T),g(r,p,_),w(u,r,_),v=!0},p:oo,i(r){v||(P(u.$$.fragment,r),v=!0)},o(r){y(u.$$.fragment,r),v=!1},d(r){r&&o(d),r&&o(p),$(u,r)}}}function Ns(G){let d,T,p,u,v,r,_,X,I,z,M,q,ot,me,no,nt,so,Nt,R,ao,fe,ro,io,Gt,Y,lo,ue,co,po,Xt,Le,ho,xt,ge,zt,Oe,mo,Ft,L,K,st,_e,fo,at,uo,Mt,Q,go,rt,_o,To,Et,Te,Ct,O,Z,it,ve,vo,lt,bo,qt,F,be,ko,S,wo,Se,Po,yo,ke,$o,No,Go,D,Xo,De,xo,zo,We,Fo,Mo,Eo,ee,jt,W,te,dt,we,Co,ct,qo,At,N,Pe,jo,ye,Ao,pt,Io,Lo,Oo,ht,So,Do,oe,Wo,$e,Bo,mt,Ho,Vo,Uo,ne,Jo,Ne,Ro,Be,Yo,Ko,It,B,se,ft,Ge,Qo,ut,Zo,Lt,j,Xe,en,xe,tn,ze,on,nn,sn,E,Fe,an,H,rn,He,ln,dn,gt,cn,pn,hn,ae,mn,re,Ot,V,ie,_t,Me,fn,Tt,un,St,A,Ee,gn,U,_n,vt,Tn,vn,Ce,bn,kn,wn,C,qe,Pn,J,yn,Ve,$n,Nn,bt,Gn,Xn,xn,le,zn,de,Dt;return r=new Ie({}),me=new Ie({}),ge=new tt({props:{code:'model = GPTNeoXForCausalLM.from_pretrained("EleutherAI/gpt-neox-20b").half().cuda()',highlighted:'model = GPTNeoXForCausalLM.from_pretrained(<span class="hljs-string">&quot;EleutherAI/gpt-neox-20b&quot;</span>).half().cuda()'}}),_e=new Ie({}),Te=new tt({props:{code:`from transformers import GPTNeoXForCausalLM, GPTNeoXTokenizerFast
...
Whether or not the post-processing step should trim offsets to avoid including whitespaces.`,name:"trim_offsets"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/gpt_neox/tokenization_gpt_neox_fast.py#L44"}}),oe=new to({props:{anchor:"transformers.GPTNeoXTokenizerFast.example",$$slots:{default:[bs]},$$scope:{ctx:G}}}),ne=new Fn({props:{$$slots:{default:[ks]},$$scope:{ctx:G}}}),Ge=new Ie({}),Xe=new et({props:{name:"class transformers.GPTNeoXModel",anchor:"transformers.GPTNeoXModel",parameters:[{name:"config",val:""}],parametersDescription:[{anchor:"transformers.GPTNeoXModel.config",description:`<strong>config</strong> (<a href="/docs/transformers/main/en/model_doc/gpt_neox#transformers.GPTNeoXConfig">~GPTNeoXConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
...
<p>Indices can be obtained using <a href="/docs/transformers/main/en/model_doc/gpt_neox#transformers.GPTNeoXTokenizerFast">GPTNeoXTokenizerFast</a>. See <a href="/docs/transformers/main/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
...
`}}),le=new Fn({props:{$$slots:{default:[ys]},$$scope:{ctx:G}}}),de=new to({props:{anchor:"transformers.GPTNeoXForCausalLM.forward.example",$$slots:{default:[$s]},$$scope:{ctx:G}}}),{c(){d=n("meta"),T=m(),p=n("h1"),u=n("a"),v=n("span"),b(r.$$.fragment),_=m(),X=n("span"),I=i("GPT-NeoX"),z=m(),M=n("h2"),q=n("a"),ot=n("span"),b(me.$$.fragment),no=m(),nt=n("span"),so=i("Overview"),Nt=m(),R=n("p"),ao=i(`We introduce GPT-NeoX-20B, a 20 billion parameter autoregressive language model trained on the Pile, whose weights will
...
generous the support of `),ue=n("a"),co=i("CoreWeave"),po=i("."),Xt=m(),Le=n("p"),ho=i("GPT-NeoX-20B was trained with fp16, thus it is recommended to initialize the model as follows:"),xt=m(),b(ge.$$.fragment),zt=m(),Oe=n("p"),mo=i(`GPT-NeoX-20B also has a different tokenizer from the one used in GPT-J-6B and GPT-Neo. The new tokenizer allocates
additional tokens to whitespace characters, making the model more suitable for certain tasks like code generation.`),Ft=m(),L=n("h3"),K=n("a"),st=n("span"),b(_e.$$.fragment),fo=m(),at=n("span"),uo=i("Generation"),Mt=m(),Q=n("p"),go=i("The "),rt=n("code"),_o=i("generate()"),To=i(" method can be used to generate text using GPT Neo model."),Et=m(),b(Te.$$.fragment),Ct=m(),O=n("h2"),Z=n("a"),it=n("span"),b(ve.$$.fragment),vo=m(),lt=n("span"),bo=i("GPTNeoXConfig"),qt=m(),F=n("div"),b(be.$$.fragment),ko=m(),S=n("p"),wo=i("This is the configuration class to store the configuration of a "),Se=n("a"),Po=i("GPTNeoXModel"),yo=i(`. It is used to instantiate an
...
documentation from `),We=n("a"),Fo=i("PretrainedConfig"),Mo=i(" for more information."),Eo=m(),b(ee.$$.fragment),jt=m(),W=n("h2"),te=n("a"),dt=n("span"),b(we.$$.fragment),Co=m(),ct=n("span"),qo=i("GPTNeoXTokenizerFast"),At=m(),N=n("div"),b(Pe.$$.fragment),jo=m(),ye=n("p"),Ao=i("Construct a \u201Cfast\u201D GPT-NeoX-20B tokenizer (backed by HuggingFace\u2019s "),pt=n("em"),Io=i("tokenizers"),Lo=i(` library). Based on byte-level
...
refer to this superclass for more information regarding those methods.`),It=m(),B=n("h2"),se=n("a"),ft=n("span"),b(Ge.$$.fragment),Qo=m(),ut=n("span"),Zo=i("GPTNeoXModel"),Lt=m(),j=n("div"),b(Xe.$$.fragment),en=m(),xe=n("p"),tn=i(`The bare GPTNeoX Model transformer outputting raw hidden-states without any specific head on top.
This model is a PyTorch `),ze=n("a"),on=i("torch.nn.Module"),nn=i(` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),sn=m(),E=n("div"),b(Fe.$$.fragment),an=m(),H=n("p"),rn=i("The "),He=n("a"),ln=i("GPTNeoXModel"),dn=i(" forward method, overrides the "),gt=n("code"),cn=i("__call__"),pn=i(" special method."),hn=m(),b(ae.$$.fragment),mn=m(),b(re.$$.fragment),Ot=m(),V=n("h2"),ie=n("a"),_t=n("span"),b(Me.$$.fragment),fn=m(),Tt=n("span"),un=i("GPTNeoXForCausalLM"),St=m(),A=n("div"),b(Ee.$$.fragment),gn=m(),U=n("p"),_n=i("GPTNeoX Model with a "),vt=n("code"),Tn=i("language modeling"),vn=i(` head on top for CLM fine-tuning.
This model is a PyTorch `),Ce=n("a"),bn=i("torch.nn.Module"),kn=i(` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),wn=m(),C=n("div"),b(qe.$$.fragment),Pn=m(),J=n("p"),yn=i("The "),Ve=n("a"),$n=i("GPTNeoXForCausalLM"),Nn=i(" forward method, overrides the "),bt=n("code"),Gn=i("__call__"),Xn=i(" special method."),xn=m(),b(le.$$.fragment),zn=m(),b(de.$$.fragment),this.h()},l(e){const c=_s('[data-svelte="svelte-1phssyn"]',document.head);d=s(c,"META",{name:!0,content:!0}),c.forEach(o),T=f(e),p=s(e,"H1",{class:!0});var je=a(p);u=s(je,"A",{id:!0,class:!0,href:!0});var kt=a(u);v=s(kt,"SPAN",{});var wt=a(v);k(r.$$.fragment,wt),wt.forEach(o),kt.forEach(o),_=f(je),X=s(je,"SPAN",{});var Pt=a(X);I=l(Pt,"GPT-NeoX"),Pt.forEach(o),je.forEach(o),z=f(e),M=s(e,"H2",{class:!0});var Ae=a(M);q=s(Ae,"A",{id:!0,class:!0,href:!0});var yt=a(q);ot=s(yt,"SPAN",{});var $t=a(ot);k(me.$$.fragment,$t),$t.forEach(o),yt.forEach(o),no=f(Ae),nt=s(Ae,"SPAN",{});var Mn=a(nt);so=l(Mn,"Overview"),Mn.forEach(o),Ae.forEach(o),Nt=f(e),R=s(e,"P",{});var Wt=a(R);ao=l(Wt,`We introduce GPT-NeoX-20B, a 20 billion parameter autoregressive language model trained on the Pile, whose weights will
be made freely and openly available to the public through a permissive license. It is, to the best of our knowledge,
the largest dense autoregressive model that has publicly available weights at the time of submission. In this work,
we describe GPT-NeoX-20B\u2019s architecture and training and evaluate its performance on a range of language-understanding,
mathematics, and knowledge-based tasks. We find that GPT-NeoX-20B is a particularly powerful few-shot reasoner and
gains far more in performance when evaluated five-shot than similarly sized GPT-3 and FairSeq models. We open-source
the training and evaluation code, as well as the model weights, at `),fe=s(Wt,"A",{href:!0,rel:!0});var En=a(fe);ro=l(En,"https://github.com/EleutherAI/gpt-neox"),En.forEach(o),io=l(Wt,"."),Wt.forEach(o),Gt=f(e),Y=s(e,"P",{});var Bt=a(Y);lo=l(Bt,`Development of the model was led by Sid Black, Stella Biderman and Eric Hallahan, and the model was trained with
generous the support of `),ue=s(Bt,"A",{href:!0,rel:!0});var Cn=a(ue);co=l(Cn,"CoreWeave"),Cn.forEach(o),po=l(Bt,"."),Bt.forEach(o),Xt=f(e),Le=s(e,"P",{});var qn=a(Le);ho=l(qn,"GPT-NeoX-20B was trained with fp16, thus it is recommended to initialize the model as follows:"),qn.forEach(o),xt=f(e),k(ge.$$.fragment,e),zt=f(e),Oe=s(e,"P",{});var jn=a(Oe);mo=l(jn,`GPT-NeoX-20B also has a different tokenizer from the one used in GPT-J-6B and GPT-Neo. The new tokenizer allocates
additional tokens to whitespace characters, making the model more suitable for certain tasks like code generation.`),jn.forEach(o),Ft=f(e),L=s(e,"H3",{class:!0});var Ht=a(L);K=s(Ht,"A",{id:!0,class:!0,href:!0});var An=a(K);st=s(An,"SPAN",{});var In=a(st);k(_e.$$.fragment,In),In.forEach(o),An.forEach(o),fo=f(Ht),at=s(Ht,"SPAN",{});var Ln=a(at);uo=l(Ln,"Generation"),Ln.forEach(o),Ht.forEach(o),Mt=f(e),Q=s(e,"P",{});var Vt=a(Q);go=l(Vt,"The "),rt=s(Vt,"CODE",{});var On=a(rt);_o=l(On,"generate()"),On.forEach(o),To=l(Vt," method can be used to generate text using GPT Neo model."),Vt.forEach(o),Et=f(e),k(Te.$$.fragment,e),Ct=f(e),O=s(e,"H2",{class:!0});var Ut=a(O);Z=s(Ut,"A",{id:!0,class:!0,href:!0});var Sn=a(Z);it=s(Sn,"SPAN",{});var Dn=a(it);k(ve.$$.fragment,Dn),Dn.forEach(o),Sn.forEach(o),vo=f(Ut),lt=s(Ut,"SPAN",{});var Wn=a(lt);bo=l(Wn,"GPTNeoXConfig"),Wn.forEach(o),Ut.forEach(o),qt=f(e),F=s(e,"DIV",{class:!0});var ce=a(F);k(be.$$.fragment,ce),ko=f(ce),S=s(ce,"P",{});var Ue=a(S);wo=l(Ue,"This is the configuration class to store the configuration of a "),Se=s(Ue,"A",{href:!0});var Bn=a(Se);Po=l(Bn,"GPTNeoXModel"),Bn.forEach(o),yo=l(Ue,`. It is used to instantiate an
GPTNeoX model according to the specified arguments, defining the model architecture. Instantiating a configuration
with the defaults will yield a similar configuration to that of the GPTNeoX
...
documentation from `),We=s(Je,"A",{href:!0});var Un=a(We);Fo=l(Un,"PretrainedConfig"),Un.forEach(o),Mo=l(Je," for more information."),Je.forEach(o),Eo=f(ce),k(ee.$$.fragment,ce),ce.forEach(o),jt=f(e),W=s(e,"H2",{class:!0});var Jt=a(W);te=s(Jt,"A",{id:!0,class:!0,href:!0});var Jn=a(te);dt=s(Jn,"SPAN",{});var Rn=a(dt);k(we.$$.fragment,Rn),Rn.forEach(o),Jn.forEach(o),Co=f(Jt),ct=s(Jt,"SPAN",{});var Yn=a(ct);qo=l(Yn,"GPTNeoXTokenizerFast"),Yn.forEach(o),Jt.forEach(o),At=f(e),N=s(e,"DIV",{class:!0});var x=a(N);k(Pe.$$.fragment,x),jo=f(x),ye=s(x,"P",{});var Rt=a(ye);Ao=l(Rt,"Construct a \u201Cfast\u201D GPT-NeoX-20B tokenizer (backed by HuggingFace\u2019s "),pt=s(Rt,"EM",{});var Kn=a(pt);Io=l(Kn,"tokenizers"),Kn.forEach(o),Lo=l(Rt,` library). Based on byte-level
