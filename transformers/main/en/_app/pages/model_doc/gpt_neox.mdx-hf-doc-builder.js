...
the latter silently ignores them.`)},l(r){d=s(r,"P",{});var _=a(d);T=l(_,"Although the recipe for forward pass needs to be defined within this function, one should call the "),p=s(_,"CODE",{});var X=a(p);u=l(X,"Module"),X.forEach(o),b=l(_,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),_.forEach(o)},m(r,_){g(r,d,_),t(d,T),t(d,p),t(p,u),t(d,b)},d(r){r&&o(d)}}}function $s(G){let d,T,p,u,b;return u=new tt({props:{code:`from transformers import GPTNeoXTokenizer, GPTNeoXForCausalLM, GPTNeoXConfig
import torch
...
<span class="hljs-meta">&gt;&gt;&gt; </span>prediction_logits = outputs.logits`}}),{c(){d=n("p"),T=i("Example:"),p=m(),v(u.$$.fragment)},l(r){d=s(r,"P",{});var _=a(d);T=l(_,"Example:"),_.forEach(o),p=f(r),k(u.$$.fragment,r)},m(r,_){g(r,d,_),t(d,T),g(r,p,_),w(u,r,_),b=!0},p:oo,i(r){b||(P(u.$$.fragment,r),b=!0)},o(r){y(u.$$.fragment,r),b=!1},d(r){r&&o(d),r&&o(p),$(u,r)}}}function Ns(G){let d,T,p,u,b,r,_,X,A,z,F,q,ot,me,no,nt,so,Nt,R,ao,fe,ro,io,Gt,Y,lo,ue,co,po,Xt,Ie,ho,xt,ge,zt,Oe,mo,Mt,I,K,st,_e,fo,at,uo,Ft,Q,go,rt,_o,To,Ct,Te,Et,O,Z,it,be,bo,lt,vo,qt,M,ve,ko,S,wo,Se,Po,yo,ke,$o,No,Go,D,Xo,De,xo,zo,Be,Mo,Fo,Co,ee,jt,B,te,dt,we,Eo,ct,qo,Lt,N,Pe,jo,ye,Lo,pt,Ao,Io,Oo,ht,So,Do,oe,Bo,$e,Wo,mt,Ho,Uo,Vo,ne,Jo,Ne,Ro,We,Yo,Ko,At,W,se,ft,Ge,Qo,ut,Zo,It,j,Xe,en,xe,tn,ze,on,nn,sn,C,Me,an,H,rn,He,ln,dn,gt,cn,pn,hn,ae,mn,re,Ot,U,ie,_t,Fe,fn,Tt,un,St,L,Ce,gn,V,_n,bt,Tn,bn,Ee,vn,kn,wn,E,qe,Pn,J,yn,Ue,$n,Nn,vt,Gn,Xn,xn,le,zn,de,Dt;return r=new Ae({}),me=new Ae({}),ge=new tt({props:{code:'model = GPTNeoXForCausalLM.from_pretrained("EleutherAI/gpt-neox-20b").half().cuda()',highlighted:'model = GPTNeoXForCausalLM.from_pretrained(<span class="hljs-string">&quot;EleutherAI/gpt-neox-20b&quot;</span>).half().cuda()'}}),_e=new Ae({}),Te=new tt({props:{code:`from transformers import GPTNeoXForCausalLM, GPTNeoXTokenizerFast
...
<span class="hljs-meta">&gt;&gt;&gt; </span>gen_text = tokenizer.batch_decode(gen_tokens)[<span class="hljs-number">0</span>]`}}),be=new Ae({}),ve=new et({props:{name:"class transformers.GPTNeoXConfig",anchor:"transformers.GPTNeoXConfig",parameters:[{name:"vocab_size",val:" = 50432"},{name:"hidden_size",val:" = 6144"},{name:"num_hidden_layers",val:" = 44"},{name:"num_attention_heads",val:" = 64"},{name:"intermediate_size",val:" = 24576"},{name:"hidden_act",val:" = 'gelu'"},{name:"rotary_pct",val:" = 0.25"},{name:"rotary_emb_base",val:" = 10000"},{name:"max_position_embeddings",val:" = 2048"},{name:"initializer_range",val:" = 0.02"},{name:"layer_norm_eps",val:" = 1e-05"},{name:"use_cache",val:" = True"},{name:"bos_token_id",val:" = 0"},{name:"eos_token_id",val:" = 2"},{name:"tie_word_embeddings",val:" = False"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.GPTNeoXConfig.vocab_size",description:`<strong>vocab_size</strong> (<code>int</code>, <em>optional</em>, defaults to 50432) &#x2014;
...
Whether or not the post-processing step should trim offsets to avoid including whitespaces.`,name:"trim_offsets"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/gpt_neox/tokenization_gpt_neox_fast.py#L44"}}),oe=new to({props:{anchor:"transformers.GPTNeoXTokenizerFast.example",$$slots:{default:[vs]},$$scope:{ctx:G}}}),ne=new Mn({props:{$$slots:{default:[ks]},$$scope:{ctx:G}}}),Ge=new Ae({}),Xe=new et({props:{name:"class transformers.GPTNeoXModel",anchor:"transformers.GPTNeoXModel",parameters:[{name:"config",val:""}],parametersDescription:[{anchor:"transformers.GPTNeoXModel.config",description:`<strong>config</strong> (<a href="/docs/transformers/main/en/model_doc/gpt_neox#transformers.GPTNeoXConfig">~GPTNeoXConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/main/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/gpt_neox/modeling_gpt_neox.py#L406"}}),Me=new et({props:{name:"forward",anchor:"transformers.GPTNeoXModel.forward",parameters:[{name:"input_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"attention_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"head_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"past_key_values",val:": typing.Optional[typing.Tuple[typing.Tuple[torch.FloatTensor]]] = None"},{name:"use_cache",val:": typing.Optional[bool] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.GPTNeoXModel.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <code>GPTNeoXTokenizer</code>. See <a href="/docs/transformers/main/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
...
generous the support of `),ue=n("a"),co=i("CoreWeave"),po=i("."),Xt=m(),Ie=n("p"),ho=i("GPT-NeoX-20B was trained with fp16, thus it is recommended to initialize the model as follows:"),xt=m(),v(ge.$$.fragment),zt=m(),Oe=n("p"),mo=i(`GPT-NeoX-20B also has a different tokenizer from the one used in GPT-J-6B and GPT-Neo. The new tokenizer allocates
additional tokens to whitespace characters, making the model more suitable for certain tasks like code generation.`),Mt=m(),I=n("h3"),K=n("a"),st=n("span"),v(_e.$$.fragment),fo=m(),at=n("span"),uo=i("Generation"),Ft=m(),Q=n("p"),go=i("The "),rt=n("code"),_o=i("generate()"),To=i(" method can be used to generate text using GPT Neo model."),Ct=m(),v(Te.$$.fragment),Et=m(),O=n("h2"),Z=n("a"),it=n("span"),v(be.$$.fragment),bo=m(),lt=n("span"),vo=i("GPTNeoXConfig"),qt=m(),M=n("div"),v(ve.$$.fragment),ko=m(),S=n("p"),wo=i("This is the configuration class to store the configuration of a "),Se=n("a"),Po=i("GPTNeoXModel"),yo=i(`. It is used to instantiate an
...
refer to this superclass for more information regarding those methods.`),At=m(),W=n("h2"),se=n("a"),ft=n("span"),v(Ge.$$.fragment),Qo=m(),ut=n("span"),Zo=i("GPTNeoXModel"),It=m(),j=n("div"),v(Xe.$$.fragment),en=m(),xe=n("p"),tn=i(`The bare GPTNeoX Model transformer outputting raw hidden-states without any specific head on top.
This model is a PyTorch `),ze=n("a"),on=i("torch.nn.Module"),nn=i(` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),sn=m(),C=n("div"),v(Me.$$.fragment),an=m(),H=n("p"),rn=i("The "),He=n("a"),ln=i("GPTNeoXModel"),dn=i(" forward method, overrides the "),gt=n("code"),cn=i("__call__"),pn=i(" special method."),hn=m(),v(ae.$$.fragment),mn=m(),v(re.$$.fragment),Ot=m(),U=n("h2"),ie=n("a"),_t=n("span"),v(Fe.$$.fragment),fn=m(),Tt=n("span"),un=i("GPTNeoXForCausalLM"),St=m(),L=n("div"),v(Ce.$$.fragment),gn=m(),V=n("p"),_n=i("GPTNeoX Model with a "),bt=n("code"),Tn=i("language modeling"),bn=i(` head on top for CLM fine-tuning.
