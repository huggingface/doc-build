...
<span class="hljs-meta">&gt;&gt;&gt; </span>prediction_logits = outputs.logits`}}),{c(){d=n("p"),T=i("Example:"),p=m(),v(f.$$.fragment)},l(r){d=s(r,"P",{});var _=a(d);T=l(_,"Example:"),_.forEach(o),p=u(r),k(f.$$.fragment,r)},m(r,_){g(r,d,_),t(d,T),g(r,p,_),w(f,r,_),b=!0},p:oo,i(r){b||(P(f.$$.fragment,r),b=!0)},o(r){y(f.$$.fragment,r),b=!1},d(r){r&&o(d),r&&o(p),$(f,r)}}}function Ns(G){let d,T,p,f,b,r,_,X,I,z,M,q,ot,me,no,nt,so,Nt,R,ao,ue,ro,io,Gt,Y,lo,fe,co,po,Xt,Le,ho,xt,ge,zt,Oe,mo,Ft,L,K,st,_e,uo,at,fo,Mt,Q,go,rt,_o,To,Et,Te,Ct,O,Z,it,be,bo,lt,vo,qt,F,ve,ko,B,wo,Be,Po,yo,ke,$o,No,Go,D,Xo,De,xo,zo,Se,Fo,Mo,Eo,ee,jt,S,te,dt,we,Co,ct,qo,At,N,Pe,jo,ye,Ao,pt,Io,Lo,Oo,ht,Bo,Do,oe,So,$e,Wo,mt,Ho,Uo,Vo,ne,Jo,Ne,Ro,We,Yo,Ko,It,W,se,ut,Ge,Qo,ft,Zo,Lt,j,Xe,en,xe,tn,ze,on,nn,sn,E,Fe,an,H,rn,He,ln,dn,gt,cn,pn,hn,ae,mn,re,Ot,U,ie,_t,Me,un,Tt,fn,Bt,A,Ee,gn,V,_n,bt,Tn,bn,Ce,vn,kn,wn,C,qe,Pn,J,yn,Ue,$n,Nn,vt,Gn,Xn,xn,le,zn,de,Dt;return r=new Ie({}),me=new Ie({}),ge=new tt({props:{code:'model = GPTNeoXForCausalLM.from_pretrained("EleutherAI/gpt-neox-20b").half().cuda()',highlighted:'model = GPTNeoXForCausalLM.from_pretrained(<span class="hljs-string">&quot;EleutherAI/gpt-neox-20b&quot;</span>).half().cuda()'}}),_e=new Ie({}),Te=new tt({props:{code:`from transformers import GPTNeoXForCausalLM, GPTNeoXTokenizerFast
...
documentation from `),Se=n("a"),Fo=i("PretrainedConfig"),Mo=i(" for more information."),Eo=m(),v(ee.$$.fragment),jt=m(),S=n("h2"),te=n("a"),dt=n("span"),v(we.$$.fragment),Co=m(),ct=n("span"),qo=i("GPTNeoXTokenizerFast"),At=m(),N=n("div"),v(Pe.$$.fragment),jo=m(),ye=n("p"),Ao=i("Construct a \u201Cfast\u201D GPT-NeoX-20B tokenizer (backed by HuggingFace\u2019s "),pt=n("em"),Io=i("tokenizers"),Lo=i(` library). Based on byte-level
Byte-Pair-Encoding.`),Oo=m(),ht=n("p"),Bo=i("This tokenizer has been trained to treat spaces like parts of the tokens (a bit like sentencepiece) so a word will"),Do=m(),v(oe.$$.fragment),So=m(),$e=n("p"),Wo=i("You can get around that behavior by passing "),mt=n("code"),Ho=i("add_prefix_space=True"),Uo=i(` when instantiating this tokenizer, but since
