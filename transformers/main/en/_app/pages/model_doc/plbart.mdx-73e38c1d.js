import{S as Pd,i as Ld,s as $d,e as n,k as u,w as v,t as i,M as qd,c as a,d as o,m,a as s,x as y,h as d,b as c,F as e,g as _,y as T,q as w,o as P,B as L,v as zd,L as ue}from"../../chunks/vendor-6b77c823.js";import{T as ii}from"../../chunks/Tip-39098574.js";import{D as I}from"../../chunks/Docstring-1088f2fb.js";import{C as G}from"../../chunks/CodeBlock-3a8b25a8.js";import{I as pe}from"../../chunks/IconCopyLink-7a11ce68.js";import{E as he}from"../../chunks/ExampleCodeBlock-5212b321.js";function Bd($){let l,b,p,f,k;return f=new G({props:{code:`from transformers import PLBartModel, PLBartConfig
...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/plbart/tokenization_plbart.py#L324",returnDescription:`
...
target text format is `),ko=n("code"),Fa=i("[tgt_lang_code] X [eos]"),Ca=i(". "),vo=n("code"),ja=i("bos"),Ea=i(" is never used."),fn=u(),ge=n("p"),Ma=i("However, for fine-tuning, in some cases no language token is provided in cases where a single language is used. Please refer to "),Qe=n("a"),Sa=i("the paper"),Aa=i(" to learn more about this."),gn=u(),H=n("p"),Na=i("In cases where the language code is needed, The regular "),Ye=n("a"),yo=n("strong"),Oa=i("call"),Ia=i("()"),Da=i(` will encode source text format, and it should be wrapped
...
`),it=n("a"),ws=i("SentencePiece"),Ps=i("."),Ls=u(),dt=n("p"),$s=i("The tokenization method is "),Fo=n("code"),qs=i("<tokens> <eos> <language code>"),zs=i(" for source language documents, and \u201C<language code>\n<tokens> <eos>``` for target language documents."),Bs=u(),v(ve.$$.fragment),xs=u(),ye=n("div"),v(lt.$$.fragment),Fs=u(),Co=n("p"),Cs=i(`Temporarily sets the tokenizer for encoding the targets. Useful for tokenizer associated to
...
example shows how to translate Python to English using the `),Lo=a(no,"CODE",{});var xi=s(Lo);Ka=d(xi,"uclanlp/plbart-python-en_XX"),xi.forEach(o),Qa=d(no," model."),no.forEach(o),Sn.forEach(o),qi.forEach(o),vn=m(t),y(tt.$$.fragment,t),yn=m(t),Z=a(t,"H2",{class:!0});var An=s(Z);_e=a(An,"A",{id:!0,class:!0,href:!0});var Fi=s(_e);$o=a(Fi,"SPAN",{});var Ci=s($o);y(ot.$$.fragment,Ci),Ci.forEach(o),Fi.forEach(o),Ya=m(An),qo=a(An,"SPAN",{});var ji=s(qo);Za=d(ji,"PLBartConfig"),ji.forEach(o),An.forEach(o),Tn=m(t),E=a(t,"DIV",{class:!0});var Ae=s(E);y(nt.$$.fragment,Ae),es=m(Ae),ee=a(Ae,"P",{});var ao=s(ee);ts=d(ao,"This is the configuration class to store the configuration of a "),Gt=a(ao,"A",{href:!0});var Ei=s(Gt);os=d(Ei,"PLBartModel"),Ei.forEach(o),ns=d(ao,`. It is used to instantiate an
PLBART model according to the specified arguments, defining the model architecture. Instantiating a configuration
with the defaults will yield a similar configuration to that of the PLBART
...
documentation from `),Wt=a(so,"A",{href:!0});var Ai=s(Wt);cs=d(Ai,"PretrainedConfig"),Ai.forEach(o),ps=d(so," for more information."),so.forEach(o),hs=m(Ae),y(be.$$.fragment,Ae),Ae.forEach(o),wn=m(t),oe=a(t,"H2",{class:!0});var Nn=s(oe);ke=a(Nn,"A",{id:!0,class:!0,href:!0});var Ni=s(ke);zo=a(Ni,"SPAN",{});var Oi=s(zo);y(st.$$.fragment,Oi),Oi.forEach(o),Ni.forEach(o),us=m(Nn),Bo=a(Nn,"SPAN",{});var Ii=s(Bo);ms=d(Ii,"PLBartTokenizer"),Ii.forEach(o),Nn.forEach(o),Pn=m(t),q=a(t,"DIV",{class:!0});var C=s(q);y(rt.$$.fragment,C),fs=m(C),xo=a(C,"P",{});var Di=s(xo);gs=d(Di,"Construct an PLBART tokenizer."),Di.forEach(o),_s=m(C),X=a(C,"P",{});var Ne=s(X);bs=d(Ne,"Adapted from "),Ht=a(Ne,"A",{href:!0});var Xi=s(Ht);ks=d(Xi,"RobertaTokenizer"),Xi.forEach(o),vs=d(Ne," and "),Ut=a(Ne,"A",{href:!0});var Gi=s(Ut);ys=d(Gi,"XLNetTokenizer"),Gi.forEach(o),Ts=d(Ne,`. Based on
`),it=a(Ne,"A",{href:!0,rel:!0});var Ri=s(it);ws=d(Ri,"SentencePiece"),Ri.forEach(o),Ps=d(Ne,"."),Ne.forEach(o),Ls=m(C),dt=a(C,"P",{});var On=s(dt);$s=d(On,"The tokenization method is "),Fo=a(On,"CODE",{});var Wi=s(Fo);qs=d(Wi,"<tokens> <eos> <language code>"),Wi.forEach(o),zs=d(On," for source language documents, and \u201C<language code>\n<tokens> <eos>``` for target language documents."),On.forEach(o),Bs=m(C),y(ve.$$.fragment,C),xs=m(C),ye=a(C,"DIV",{class:!0});var In=s(ye);y(lt.$$.fragment,In),Fs=m(In),Co=a(In,"P",{});var Hi=s(Co);Cs=d(Hi,`Temporarily sets the tokenizer for encoding the targets. Useful for tokenizer associated to
sequence-to-sequence models that need a slightly different processing for the labels.`),Hi.forEach(o),In.forEach(o),js=m(C),A=a(C,"DIV",{class:!0});var Oe=s(A);y(ct.$$.fragment,Oe),Es=m(Oe),pt=a(Oe,"P",{});var Dn=s(pt);Ms=d(Dn,`Build model inputs from a sequence or a pair of sequence for sequence classification tasks by concatenating and
...
separator.`),Yi.forEach(o),Oe.forEach(o),C.forEach(o),Ln=m(t),ne=a(t,"H2",{class:!0});var Wn=s(ne);Te=a(Wn,"A",{id:!0,class:!0,href:!0});var Zi=s(Te);Oo=a(Zi,"SPAN",{});var ed=s(Oo);y(ft.$$.fragment,ed),ed.forEach(o),Zi.forEach(o),Vs=m(Wn),Io=a(Wn,"SPAN",{});var td=s(Io);Js=d(td,"PLBartModel"),td.forEach(o),Wn.forEach(o),$n=m(t),M=a(t,"DIV",{class:!0});var Ie=s(M);y(gt.$$.fragment,Ie),Ks=m(Ie),_t=a(Ie,"P",{});var Hn=s(_t);Qs=d(Hn,`The bare PLBART Model outputting raw hidden-states without any specific head on top.
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Kn.forEach(o),wr=m(Xe),O=a(Xe,"DIV",{class:!0});var Ge=s(O);y($t.$$.fragment,Ge),Pr=m(Ge),re=a(Ge,"P",{});var io=s(re);Lr=d(io,"The "),Qt=a(io,"A",{href:!0});var pd=s(Qt);$r=d(pd,"PLBartForConditionalGeneration"),pd.forEach(o),qr=d(io," forward method, overrides the "),Ro=a(io,"CODE",{});var hd=s(Ro);zr=d(hd,"__call__"),hd.forEach(o),Br=d(io," special method."),io.forEach(o),xr=m(Ge),y($e.$$.fragment,Ge),Fr=m(Ge),y(qe.$$.fragment,Ge),Ge.forEach(o),Xe.forEach(o),Bn=m(t),ie=a(t,"H2",{class:!0});var Qn=s(ie);ze=a(Qn,"A",{id:!0,class:!0,href:!0});var ud=s(ze);Wo=a(ud,"SPAN",{});var md=s(Wo);y(qt.$$.fragment,md),md.forEach(o),ud.forEach(o),Cr=m(Qn),Ho=a(Qn,"SPAN",{});var fd=s(Ho);jr=d(fd,"PLBartForSequenceClassification"),fd.forEach(o),Qn.forEach(o),xn=m(t),B=a(t,"DIV",{class:!0});var J=s(B);y(zt.$$.fragment,J),Er=m(J),Uo=a(J,"P",{});var gd=s(Uo);Mr=d(gd,`PLBart model with a sequence classification/head on top (a linear layer on top of the pooled output) e.g. for code
