...
the latter silently ignores them.`)},l(T){u=a(T,"P",{});var y=s(u);B=i(y,"Although the recipe for forward pass needs to be defined within this function, one should call the "),v=a(y,"CODE",{});var C=s(v);L=i(C,"Module"),C.forEach(o),z=i(y,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
the latter silently ignores them.`)},l(T){u=a(T,"P",{});var y=s(u);B=i(y,"Although the recipe for forward pass needs to be defined within this function, one should call the "),v=a(y,"CODE",{});var C=s(v);L=i(C,"Module"),C.forEach(o),z=i(y,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),y.forEach(o)},m(T,y){h(T,u,y),e(u,B),e(u,v),e(v,L),e(u,z)},d(T){T&&o(u)}}}function al(me){let u,B,v,L,z,T,y,C,ta,an,I,io,oa,na,Ce,aa,sa,je,ra,ia,sn,Y,fe,lo,Ee,da,co,la,rn,G,ca,Me,pa,ha,po,ua,ma,dn,Mt,fa,ln,St,ho,ga,cn,R,_a,Se,ba,ka,Ae,va,Ta,pn,Z,ge,uo,Ne,ya,mo,wa,hn,j,Pa,fo,La,qa,go,za,Ba,_o,$a,xa,bo,Fa,Ca,un,_e,ja,Oe,Ea,Ma,mn,W,Sa,Ie,ko,Aa,Na,Oa,At,Ia,Da,fn,Nt,vo,Xa,gn,De,_n,Ot,Xe,To,Ga,Ra,ee,Wa,yo,Ha,Ua,wo,Va,Ja,bn,Ge,kn,te,be,Po,Re,Ka,Lo,Qa,vn,x,We,Ya,oe,Za,It,es,ts,He,os,ns,as,ne,ss,Dt,rs,is,Xt,ds,ls,cs,qo,ps,hs,Ue,Tn,ae,ke,zo,Ve,us,Bo,ms,yn,P,Je,fs,$o,gs,_s,D,bs,Gt,ks,vs,Rt,Ts,ys,Ke,ws,Ps,Ls,Qe,qs,xo,zs,Bs,$s,Fo,xs,Fs,Ye,Cs,ve,Ze,js,Co,Es,Ms,N,et,Ss,tt,As,jo,Ns,Os,Is,ot,nt,Eo,Ds,Xs,Mo,Gs,Rs,at,So,Ws,Hs,Ao,Us,Vs,No,Js,wn,se,Te,Oo,st,Ks,Io,Qs,Pn,S,rt,Ys,it,Zs,Wt,er,tr,or,dt,nr,lt,ar,sr,rr,E,ct,ir,re,dr,Ht,lr,cr,Do,pr,hr,ur,ye,mr,Xo,fr,gr,pt,Ln,ie,we,Go,ht,_r,Ro,br,qn,A,ut,kr,mt,vr,Ut,Tr,yr,wr,ft,Pr,gt,Lr,qr,zr,M,_t,Br,de,$r,Vt,xr,Fr,Wo,Cr,jr,Er,Pe,Mr,Ho,Sr,Ar,bt,zn,le,Le,Uo,kt,Nr,Vo,Or,Bn,F,vt,Ir,Jo,Dr,Xr,Tt,Gr,Jt,Rr,Wr,Hr,yt,Ur,wt,Vr,Jr,Kr,w,Pt,Qr,ce,Yr,Kt,Zr,ei,Ko,ti,oi,ni,qe,ai,Qo,si,ri,Lt,ii,qt,di,Yo,li,ci,zt,pi,Bt,$n,pe,ze,Zo,$t,hi,en,ui,xn,he,xt,mi,H,Ft,fi,tn,gi,_i,Ct,Fn;return T=new ue({}),Ee=new ue({}),Ne=new ue({}),De=new X({props:{code:`from transformers import PLBartForConditionalGeneration, PLBartTokenizer
...
<span class="hljs-literal">True</span>`}}),{c(){u=n("meta"),B=l(),v=n("h1"),L=n("a"),z=n("span"),m(T.$$.fragment),y=l(),C=n("span"),ta=r("PLBart"),an=l(),I=n("p"),io=n("strong"),oa=r("DISCLAIMER:"),na=r(" If you see something strange, file a "),Ce=n("a"),aa=r("Github Issue"),sa=r(` and assign
...
inside the context manager `),At=n("a"),Ia=r("as_target_tokenizer()"),Da=r(" to encode target text format."),fn=l(),Nt=n("ul"),vo=n("li"),Xa=r("Supervised training"),gn=l(),m(De.$$.fragment),_n=l(),Ot=n("ul"),Xe=n("li"),To=n("p"),Ga=r("Generation"),Ra=l(),ee=n("p"),Wa=r("While generating the target text set the "),yo=n("code"),Ha=r("decoder_start_token_id"),Ua=r(` to the target language id. The following
...
separator.`),kd.forEach(o),$e.forEach(o),$.forEach(o),wn=c(t),se=a(t,"H2",{class:!0});var Rn=s(se);Te=a(Rn,"A",{id:!0,class:!0,href:!0});var vd=s(Te);Oo=a(vd,"SPAN",{});var Td=s(Oo);f(st.$$.fragment,Td),Td.forEach(o),vd.forEach(o),Ks=c(Rn),Io=a(Rn,"SPAN",{});var yd=s(Io);Qs=i(yd,"PLBartModel"),yd.forEach(o),Rn.forEach(o),Pn=c(t),S=a(t,"DIV",{class:!0});var xe=s(S);f(rt.$$.fragment,xe),Ys=c(xe),it=a(xe,"P",{});var Wn=s(it);Zs=i(Wn,`The bare PLBART Model outputting raw hidden-states without any specific head on top.
...
This model inherits from `),Ut=a(Vn,"A",{href:!0});var Fd=s(Ut);Tr=i(Fd,"PreTrainedModel"),Fd.forEach(o),yr=i(Vn,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
classification.`),Od.forEach(o),Xr=c(Q),Tt=a(Q,"P",{});var Qn=s(Tt);Gr=i(Qn,"This model inherits from "),Jt=a(Qn,"A",{href:!0});var Id=s(Jt);Rr=i(Id,"PreTrainedModel"),Id.forEach(o),Wr=i(Qn,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
