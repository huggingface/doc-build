...
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),_.forEach(o)},m(m,_){u(m,h,_),e(h,x),e(h,f),e(f,g),e(h,T)},d(m){m&&o(h)}}}function Cv(F){let h,x,f,g,T;return g=new W({props:{code:`from transformers import LayoutLMv2Processor, LayoutLMv2Model, set_seed
from PIL import Image
import torch
...
torch.Size([<span class="hljs-number">1</span>, <span class="hljs-number">342</span>, <span class="hljs-number">768</span>])`}}),{c(){h=a("p"),x=n("Examples:"),f=c(),v(g.$$.fragment)},l(m){h=r(m,"P",{});var _=i(h);x=s(_,"Examples:"),_.forEach(o),f=p(m),y(g.$$.fragment,m)},m(m,_){u(m,h,_),e(h,x),u(m,f,_),b(g,m,_),T=!0},p:sn,i(m){T||(L(g.$$.fragment,m),T=!0)},o(m){k(g.$$.fragment,m),T=!1},d(m){m&&o(h),m&&o(f),w(g,m)}}}function Iv(F){let h,x,f,g,T;return{c(){h=a("p"),x=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=a("code"),g=n("Module"),T=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(m){h=r(m,"P",{});var _=i(h);x=s(_,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=r(_,"CODE",{});var O=i(f);g=s(O,"Module"),O.forEach(o),T=s(_,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),_.forEach(o)},m(m,_){u(m,h,_),e(h,x),e(h,f),e(f,g),e(h,T)},d(m){m&&o(h)}}}function Dv(F){let h,x,f,g,T;return g=new W({props:{code:`from transformers import LayoutLMv2Processor, LayoutLMv2ForSequenceClassification, set_seed
from PIL import Image
import torch
from datasets import load_dataset
...
(<span class="hljs-number">4</span>, <span class="hljs-string">&#x27;advertisement&#x27;</span>)`}}),{c(){h=a("p"),x=n("Example:"),f=c(),v(g.$$.fragment)},l(m){h=r(m,"P",{});var _=i(h);x=s(_,"Example:"),_.forEach(o),f=p(m),y(g.$$.fragment,m)},m(m,_){u(m,h,_),e(h,x),u(m,f,_),b(g,m,_),T=!0},p:sn,i(m){T||(L(g.$$.fragment,m),T=!0)},o(m){k(g.$$.fragment,m),T=!1},d(m){m&&o(h),m&&o(f),w(g,m)}}}function Av(F){let h,x,f,g,T;return{c(){h=a("p"),x=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=a("code"),g=n("Module"),T=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(m){h=r(m,"P",{});var _=i(h);x=s(_,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=r(_,"CODE",{});var O=i(f);g=s(O,"Module"),O.forEach(o),T=s(_,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),_.forEach(o)},m(m,_){u(m,h,_),e(h,x),e(h,f),e(f,g),e(h,T)},d(m){m&&o(h)}}}function Ov(F){let h,x,f,g,T;return g=new W({props:{code:`from transformers import LayoutLMv2Processor, LayoutLMv2ForTokenClassification, set_seed
from PIL import Image
from datasets import load_dataset
...
[<span class="hljs-string">&#x27;B-ANSWER&#x27;</span>, <span class="hljs-string">&#x27;B-HEADER&#x27;</span>, <span class="hljs-string">&#x27;B-HEADER&#x27;</span>, <span class="hljs-string">&#x27;B-HEADER&#x27;</span>, <span class="hljs-string">&#x27;B-HEADER&#x27;</span>]`}}),{c(){h=a("p"),x=n("Example:"),f=c(),v(g.$$.fragment)},l(m){h=r(m,"P",{});var _=i(h);x=s(_,"Example:"),_.forEach(o),f=p(m),y(g.$$.fragment,m)},m(m,_){u(m,h,_),e(h,x),u(m,f,_),b(g,m,_),T=!0},p:sn,i(m){T||(L(g.$$.fragment,m),T=!0)},o(m){k(g.$$.fragment,m),T=!1},d(m){m&&o(h),m&&o(f),w(g,m)}}}function Nv(F){let h,x,f,g,T;return{c(){h=a("p"),x=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=a("code"),g=n("Module"),T=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(m){h=r(m,"P",{});var _=i(h);x=s(_,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=r(_,"CODE",{});var O=i(f);g=s(O,"Module"),O.forEach(o),T=s(_,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),_.forEach(o)},m(m,_){u(m,h,_),e(h,x),e(h,f),e(f,g),e(h,T)},d(m){m&&o(h)}}}function Sv(F){let h,x;return h=new W({props:{code:`from transformers import LayoutLMv2Processor, LayoutLMv2ForQuestionAnswering, set_seed
import torch
from PIL import Image
from datasets import load_dataset
...
(<span class="hljs-number">154</span>, <span class="hljs-number">287</span>)`}}),{c(){v(h.$$.fragment)},l(f){y(h.$$.fragment,f)},m(f,g){b(h,f,g),x=!0},p:sn,i(f){x||(L(h.$$.fragment,f),x=!0)},o(f){k(h.$$.fragment,f),x=!1},d(f){w(h,f)}}}function Wv(F){let h,x,f,g,T,m,_,O,Hi,gr,Me,Ve,_s,Et,Ki,vs,Xi,_r,me,Yi,zt,Zi,Ji,an,el,tl,vr,he,X,ol,qt,nl,sl,Ft,al,rl,jt,il,ll,Pt,dl,cl,pl,Ct,ul,It,ml,hl,fl,Dt,gl,At,_l,vl,yr,rn,yl,br,ln,ys,bl,Lr,se,Ll,bs,kl,wl,Ls,xl,Tl,ks,Ml,$l,kr,Ot,wr,dn,El,xr,cn,zl,Tr,V,ws,ql,Fl,Nt,jl,St,Pl,Cl,Il,Rt,Dl,Wt,Al,Ol,Nl,$e,Sl,Ut,Rl,Wl,Bt,Ul,Bl,Vl,M,Ql,xs,Gl,Hl,pn,Kl,Xl,Ts,Yl,Zl,Ms,Jl,ed,$s,td,od,Es,nd,sd,zs,ad,rd,qs,id,ld,Fs,dd,cd,un,pd,ud,Vt,md,hd,Qt,fd,gd,Mr,Gt,$r,fe,_d,js,vd,yd,Ps,bd,Ld,Er,Ht,zr,Qe,kd,mn,wd,xd,qr,ge,I,Td,hn,Md,$d,Cs,Ed,zd,Is,qd,Fd,fn,jd,Pd,Ds,Cd,Id,As,Dd,Ad,Os,Od,Nd,Sd,Kt,Rd,gn,Wd,Ud,Bd,Xt,Vd,Ns,Qd,Gd,Fr,Ge,Hd,_n,Kd,Xd,jr,Ee,He,Ss,Yt,Yd,Rs,Zd,Pr,Q,Jd,vn,ec,tc,yn,oc,nc,bn,sc,ac,Ln,rc,ic,Cr,Zt,Ir,E,lc,kn,dc,cc,wn,pc,uc,Ws,mc,hc,xn,fc,gc,Tn,_c,vc,Us,yc,bc,Bs,Lc,kc,Vs,wc,xc,Qs,Tc,Mc,Gs,$c,Ec,Dr,U,Mn,zc,qc,Jt,Fc,jc,$n,Pc,Cc,Hs,Ic,Dc,Ks,Ac,Oc,Ar,En,Nc,Or,zn,Xs,Sc,Nr,qn,Rc,Sr,eo,Rr,Fn,Ys,Wc,Wr,_e,Uc,Zs,Bc,Vc,Js,Qc,Gc,Ur,to,Br,jn,ea,Hc,Vr,G,Kc,ta,Xc,Yc,oa,Zc,Jc,na,ep,tp,sa,op,np,Qr,oo,Gr,Pn,aa,sp,Hr,Cn,ap,Kr,no,Xr,In,ra,rp,Yr,Dn,ip,Zr,so,Jr,ze,Ke,ia,ao,lp,la,dp,ei,Y,ro,cp,qe,pp,An,up,mp,io,hp,fp,gp,Fe,_p,On,vp,yp,Nn,bp,Lp,kp,Xe,ti,je,Ye,da,lo,wp,ca,xp,oi,Z,co,Tp,pa,Mp,$p,po,Ep,ua,zp,qp,Fp,ve,uo,jp,ma,Pp,Cp,Ze,ni,Pe,Je,ha,mo,Ip,fa,Dp,si,N,ho,Ap,S,Op,Sn,Np,Sp,ga,Rp,Wp,_a,Up,Bp,va,Vp,Qp,ya,Gp,Hp,ba,Kp,Xp,Yp,fo,Zp,Rn,Jp,eu,tu,Wn,Un,ou,nu,su,et,go,au,La,ru,iu,Bn,_o,ai,Ce,tt,ka,vo,lu,wa,du,ri,J,yo,cu,bo,pu,xa,uu,mu,hu,Lo,fu,Vn,gu,_u,vu,ot,ko,yu,Ta,bu,ii,Ie,nt,Ma,wo,Lu,$a,ku,li,B,xo,wu,Ea,xu,Tu,Qn,Gn,Mu,$u,Eu,j,zu,Hn,qu,Fu,Kn,ju,Pu,Xn,Cu,Iu,za,Du,Au,qa,Ou,Nu,Fa,Su,Ru,ja,Wu,Uu,Pa,Bu,Vu,Ca,Qu,Gu,Hu,ye,To,Ku,$,Xu,Ia,Yu,Zu,Mo,Da,Ju,em,tm,Yn,om,nm,Aa,sm,am,Oa,rm,im,$o,Na,lm,dm,cm,Sa,pm,um,Zn,mm,hm,Ra,fm,gm,Wa,_m,vm,Ua,ym,bm,Ba,Lm,km,wm,Va,xm,di,De,st,Qa,Eo,Tm,Ga,Mm,ci,ce,zo,$m,qo,Em,Fo,zm,qm,Fm,ae,jo,jm,Ae,Pm,Jn,Cm,Im,Ha,Dm,Am,Om,at,Nm,rt,pi,Oe,it,Ka,Po,Sm,Xa,Rm,ui,ee,Co,Wm,Io,Um,Do,Bm,Vm,Qm,Ao,Gm,Oo,Hm,Km,Xm,re,No,Ym,Ne,Zm,es,Jm,eh,Ya,th,oh,nh,lt,sh,dt,mi,Se,ct,Za,So,ah,Ja,rh,hi,te,Ro,ih,oe,lh,Wo,dh,ch,Uo,ph,uh,Bo,mh,hh,Vo,fh,gh,_h,Qo,vh,Go,yh,bh,Lh,ie,Ho,kh,Re,wh,ts,xh,Th,er,Mh,$h,Eh,pt,zh,ut,fi,We,mt,tr,Ko,qh,or,Fh,gi,ne,Xo,jh,pe,Ph,Yo,Ch,Ih,nr,Dh,Ah,sr,Oh,Nh,Sh,Zo,Rh,Jo,Wh,Uh,Bh,D,en,Vh,Ue,Qh,os,Gh,Hh,ar,Kh,Xh,Yh,ht,Zh,rr,Jh,ef,ir,tf,of,ft,nf,gt,_i;return m=new de({}),Et=new de({}),Ot=new W({props:{code:`python -m pip install 'git+https://github.com/facebookresearch/detectron2.git'
...
set to <code>True</code>.`,name:"size"},{anchor:"transformers.LayoutLMv2FeatureExtractor.resample",description:`<strong>resample</strong> (<code>int</code>, <em>optional</em>, defaults to <code>PIL.Image.Resampling.BILINEAR</code>) &#x2014;
...
to <code>True</code>.`,name:"resample"},{anchor:"transformers.LayoutLMv2FeatureExtractor.apply_ocr",description:`<strong>apply_ocr</strong> (<code>bool</code>, <em>optional</em>, defaults to <code>True</code>) &#x2014;
...
</ul>`,name:"return_tensors"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/layoutlmv2/feature_extraction_layoutlmv2.py#L139",returnDescription:`
<p>A <a
...
configuration. Check out the <a href="/docs/transformers/main/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/layoutlmv2/modeling_layoutlmv2.py#L710"}}),jo=new A({props:{name:"forward",anchor:"transformers.LayoutLMv2Model.forward",parameters:[{name:"input_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"bbox",val:": typing.Optional[torch.LongTensor] = None"},{name:"image",val:": typing.Optional[torch.FloatTensor] = None"},{name:"attention_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"token_type_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"position_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"head_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.LayoutLMv2Model.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
...
`}}),at=new Gi({props:{$$slots:{default:[Pv]},$$scope:{ctx:F}}}),rt=new nn({props:{anchor:"transformers.LayoutLMv2Model.forward.example",$$slots:{default:[Cv]},$$scope:{ctx:F}}}),Po=new de({}),Co=new A({props:{name:"class transformers.LayoutLMv2ForSequenceClassification",anchor:"transformers.LayoutLMv2ForSequenceClassification",parameters:[{name:"config",val:""}],parametersDescription:[{anchor:"transformers.LayoutLMv2ForSequenceClassification.config",description:`<strong>config</strong> (<a href="/docs/transformers/main/en/model_doc/layoutlmv2#transformers.LayoutLMv2Config">LayoutLMv2Config</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
...
`}}),pt=new Gi({props:{$$slots:{default:[Av]},$$scope:{ctx:F}}}),ut=new nn({props:{anchor:"transformers.LayoutLMv2ForTokenClassification.forward.example",$$slots:{default:[Ov]},$$scope:{ctx:F}}}),Ko=new de({}),Xo=new A({props:{name:"class transformers.LayoutLMv2ForQuestionAnswering",anchor:"transformers.LayoutLMv2ForQuestionAnswering",parameters:[{name:"config",val:""},{name:"has_visual_segment_embedding",val:" = True"}],parametersDescription:[{anchor:"transformers.LayoutLMv2ForQuestionAnswering.config",description:`<strong>config</strong> (<a href="/docs/transformers/main/en/model_doc/layoutlmv2#transformers.LayoutLMv2Config">LayoutLMv2Config</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
...
`}}),ht=new Gi({props:{$$slots:{default:[Nv]},$$scope:{ctx:F}}}),ft=new nn({props:{anchor:"transformers.LayoutLMv2ForQuestionAnswering.forward.example",$$slots:{default:[Sv]},$$scope:{ctx:F}}}),gt=new nn({props:{anchor:"transformers.LayoutLMv2ForQuestionAnswering.forward.example-2",$$slots:{default:[Rv]},$$scope:{ctx:F}}}),{c(){h=a("meta"),x=c(),f=a("h1"),g=a("a"),T=a("span"),v(m.$$.fragment),_=c(),O=a("span"),Hi=n("LayoutLMV2"),gr=c(),Me=a("h2"),Ve=a("a"),_s=a("span"),v(Et.$$.fragment),Ki=c(),vs=a("span"),Xi=n("Overview"),_r=c(),me=a("p"),Yi=n("The LayoutLMV2 model was proposed in "),zt=a("a"),Zi=n("LayoutLMv2: Multi-modal Pre-training for Visually-Rich Document Understanding"),Ji=n(` by Yang Xu, Yiheng Xu, Tengchao Lv, Lei Cui, Furu Wei, Guoxin Wang, Yijuan Lu,
...
collection of 199 annotated forms comprising more than 30,000 words), the `),Ft=a("a"),al=n("CORD"),rl=n(`
dataset (a collection of 800 receipts for training, 100 for validation and 100 for testing), the `),jt=a("a"),il=n("SROIE"),ll=n(` dataset (a collection of 626 receipts for training and 347 receipts for testing)
...
in Detectron2 are pre-trained using the BGR format. The `),Fs=a("code"),dd=n("bbox"),cd=n(` input are the bounding boxes (i.e. 2D-positions)
...
a 0-1000 scale. To normalize, you can use the following function:`),Mr=c(),v(Gt.$$.fragment),$r=c(),fe=a("p"),_d=n("Here, "),js=a("code"),vd=n("width"),yd=n(" and "),Ps=a("code"),bd=n("height"),Ld=n(` correspond to the width and height of the original document in which the token
...
obtain a lower-resolution feature map, whose shape is equal to the `),Is=a("code"),qd=n("image_feature_pool_shape"),Fd=n(` attribute of
`),fn=a("a"),jd=n("LayoutLMv2Config"),Pd=n(`. This feature map is then flattened to obtain a sequence of image tokens. As
...
model in order to properly synchronize the batch normalization layers of the visual backbone.`),Fr=c(),Ge=a("p"),Hd=n(`In addition, there\u2019s LayoutXLM, which is a multilingual version of LayoutLMv2. More information can be found on
`),_n=a("a"),Kd=n("LayoutXLM\u2019s documentation page"),Xd=n("."),jr=c(),Ee=a("h2"),He=a("a"),Ss=a("span"),v(Yt.$$.fragment),Yd=c(),Rs=a("span"),Zd=n("Usage: LayoutLMv2Processor"),Pr=c(),Q=a("p"),Jd=n("The easiest way to prepare data for the model is to use "),vn=a("a"),ec=n("LayoutLMv2Processor"),tc=n(`, which internally
...
which are turned into token-level `),Gs=a("code"),$c=n("labels"),Ec=n("."),Dr=c(),U=a("p"),Mn=a("a"),zc=n("LayoutLMv2Processor"),qc=n(" uses "),Jt=a("a"),Fc=n("PyTesseract"),jc=n(`, a Python
...
the words and normalized bounding boxes.`),Sr=c(),v(eo.$$.fragment),Rr=c(),Fn=a("p"),Ys=a("strong"),Wc=n("Use case 2: document image classification (training, inference) + token classification (inference), apply_ocr=False"),Wr=c(),_e=a("p"),Uc=n("In case one wants to do OCR themselves, one can initialize the feature extractor with "),Zs=a("code"),Bc=n("apply_ocr"),Vc=n(` set to
...
the processor.`),Ur=c(),v(to.$$.fragment),Br=c(),jn=a("p"),ea=a("strong"),Hc=n("Use case 3: token classification (training), apply_ocr=False"),Vr=c(),G=a("p"),Kc=n(`For token classification tasks (such as FUNSD, CORD, SROIE, Kleister-NDA), one can also provide the corresponding word
...
`),io=a("a"),hp=n("microsoft/layoutlmv2-base-uncased"),fp=n(" architecture."),gp=c(),Fe=a("p"),_p=n("Configuration objects inherit from "),On=a("a"),vp=n("PretrainedConfig"),yp=n(` and can be used to control the model outputs. Read the
documentation from `),Nn=a("a"),bp=n("PretrainedConfig"),Lp=n(" for more information."),kp=c(),v(Xe.$$.fragment),ti=c(),je=a("h2"),Ye=a("a"),da=a("span"),v(lo.$$.fragment),wp=c(),ca=a("span"),xp=n("LayoutLMv2FeatureExtractor"),oi=c(),Z=a("div"),v(co.$$.fragment),Tp=c(),pa=a("p"),Mp=n(`Constructs a LayoutLMv2 feature extractor. This can be used to resize document images to the same size, as well as
...
single processor.`),Tu=c(),Qn=a("p"),Gn=a("a"),Mu=n("LayoutLMv2Processor"),$u=n(" offers all the functionalities you need to prepare data for the model."),Eu=c(),j=a("p"),zu=n("It first uses "),Hn=a("a"),qu=n("LayoutLMv2FeatureExtractor"),Fu=n(` to resize document images to a fixed size, and optionally applies OCR
to get words and normalized bounding boxes. These are then provided to `),Kn=a("a"),ju=n("LayoutLMv2Tokenizer"),Pu=n(` or
...
`),qa=a("code"),Ou=n("attention_mask"),Nu=n(", "),Fa=a("code"),Su=n("token_type_ids"),Ru=n(", "),ja=a("code"),Wu=n("bbox"),Uu=n(". Optionally, one can provide integer "),Pa=a("code"),Bu=n("word_labels"),Vu=n(`, which are turned
...
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),Lh=c(),ie=a("div"),v(Ho.$$.fragment),kh=c(),Re=a("p"),wh=n("The "),ts=a("a"),xh=n("LayoutLMv2ForTokenClassification"),Th=n(" forward method, overrides the "),er=a("code"),Mh=n("__call__"),$h=n(" special method."),Eh=c(),v(pt.$$.fragment),zh=c(),v(ut.$$.fragment),fi=c(),We=a("h2"),mt=a("a"),tr=a("span"),v(Ko.$$.fragment),qh=c(),or=a("span"),Fh=n("LayoutLMv2ForQuestionAnswering"),gi=c(),ne=a("div"),v(Xo.$$.fragment),jh=c(),pe=a("p"),Ph=n(`LayoutLMv2 Model with a span classification head on top for extractive question-answering tasks such as
...
collection of 199 annotated forms comprising more than 30,000 words), the `),Ft=r(be,"A",{href:!0,rel:!0});var cf=i(Ft);al=s(cf,"CORD"),cf.forEach(o),rl=s(be,`
dataset (a collection of 800 receipts for training, 100 for validation and 100 for testing), the `),jt=r(be,"A",{href:!0,rel:!0});var pf=i(jt);il=s(pf,"SROIE"),pf.forEach(o),ll=s(be,` dataset (a collection of 626 receipts for training and 347 receipts for testing)
...
following to install them:`),_t.forEach(o),kr=p(t),y(Ot.$$.fragment,t),wr=p(t),dn=r(t,"P",{});var Lf=i(dn);El=s(Lf,"(If you are developing for LayoutLMv2, note that passing the doctests also requires the installation of these packages.)"),Lf.forEach(o),xr=p(t),cn=r(t,"P",{});var kf=i(cn);zl=s(kf,"Tips:"),kf.forEach(o),Tr=p(t),V=r(t,"UL",{});var Le=i(V);ws=r(Le,"LI",{});var wf=i(ws);ql=s(wf,`The main difference between LayoutLMv1 and LayoutLMv2 is that the latter incorporates visual embeddings during
pre-training (while LayoutLMv1 only adds visual embeddings during fine-tuning).`),wf.forEach(o),Fl=p(Le),Nt=r(Le,"LI",{});var bi=i(Nt);jl=s(bi,`LayoutLMv2 adds both a relative 1D attention bias as well as a spatial 2D attention bias to the attention scores in
...
`),Ts=r(z,"CODE",{});var qf=i(Ts);Yl=s(qf,"image"),qf.forEach(o),Zl=s(z," and "),Ms=r(z,"CODE",{});var Ff=i(Ms);Jl=s(Ff,"bbox"),Ff.forEach(o),ed=s(z,". The "),$s=r(z,"CODE",{});var jf=i($s);td=s(jf,"image"),jf.forEach(o),od=s(z,` input corresponds to the original document image in which the text
tokens occur. The model expects each document image to be of size 224x224. This means that if you have a batch of
...
in Detectron2 are pre-trained using the BGR format. The `),Fs=r(z,"CODE",{});var Df=i(Fs);dd=s(Df,"bbox"),Df.forEach(o),cd=s(z,` input are the bounding boxes (i.e. 2D-positions)
...
obtain a lower-resolution feature map, whose shape is equal to the `),Is=r(R,"CODE",{});var Vf=i(Is);qd=s(Vf,"image_feature_pool_shape"),Vf.forEach(o),Fd=s(R,` attribute of
`),fn=r(R,"A",{href:!0});var Qf=i(fn);jd=s(Qf,"LayoutLMv2Config"),Qf.forEach(o),Pd=s(R,`. This feature map is then flattened to obtain a sequence of image tokens. As
the size of the feature map is 7x7 by default, one obtains 49 image tokens. These are then concatenated with the text
tokens, and send through the Transformer encoder. This means that the last hidden states of the model will have a
length of 512 + 49 = 561, if you pad the text tokens up to the max length. More generally, the last hidden states
...
`),Os=r(R,"CODE",{});var Kf=i(Os);Od=s(Kf,"config.image_feature_pool_shape[1]"),Kf.forEach(o),Nd=s(R,"."),R.forEach(o),Sd=p(rs),Kt=r(rs,"LI",{});var wi=i(Kt);Rd=s(wi,"When calling "),gn=r(wi,"A",{href:!0});var Xf=i(gn);Wd=s(Xf,"from_pretrained()"),Xf.forEach(o),Ud=s(wi,`, a warning will be printed with a long list of
parameter names that are not initialized. This is not a problem, as these parameters are batch normalization
...
which are turned into token-level `),Gs=r(P,"CODE",{});var fg=i(Gs);$c=s(fg,"labels"),fg.forEach(o),Ec=s(P,"."),P.forEach(o),Dr=p(t),U=r(t,"P",{});var ue=i(U);Mn=r(ue,"A",{href:!0});var gg=i(Mn);zc=s(gg,"LayoutLMv2Processor"),gg.forEach(o),qc=s(ue," uses "),Jt=r(ue,"A",{href:!0,rel:!0});var _g=i(Jt);Fc=s(_g,"PyTesseract"),_g.forEach(o),jc=s(ue,`, a Python
wrapper around Google\u2019s Tesseract OCR engine, under the hood. Note that you can still use your own OCR engine of
choice, and provide the words and normalized boxes yourself. This requires initializing
...
use cases work for both batched and non-batched inputs (we illustrate them for non-batched inputs).`),Lg.forEach(o),Or=p(t),zn=r(t,"P",{});var kg=i(zn);Xs=r(kg,"STRONG",{});var wg=i(Xs);Sc=s(wg,`Use case 1: document image classification (training, inference) + token classification (inference), apply_ocr =
...
the words and normalized bounding boxes.`),xg.forEach(o),Sr=p(t),y(eo.$$.fragment,t),Rr=p(t),Fn=r(t,"P",{});var Tg=i(Fn);Ys=r(Tg,"STRONG",{});var Mg=i(Ys);Wc=s(Mg,"Use case 2: document image classification (training, inference) + token classification (inference), apply_ocr=False"),Mg.forEach(o),Tg.forEach(o),Wr=p(t),_e=r(t,"P",{});var is=i(_e);Uc=s(is,"In case one wants to do OCR themselves, one can initialize the feature extractor with "),Zs=r(is,"CODE",{});var $g=i(Zs);Bc=s($g,"apply_ocr"),$g.forEach(o),Vc=s(is,` set to
...
the processor.`),is.forEach(o),Ur=p(t),y(to.$$.fragment,t),Br=p(t),jn=r(t,"P",{});var zg=i(jn);ea=r(zg,"STRONG",{});var qg=i(ea);Hc=s(qg,"Use case 3: token classification (training), apply_ocr=False"),qg.forEach(o),zg.forEach(o),Vr=p(t),G=r(t,"P",{});var we=i(G);Kc=s(we,`For token classification tasks (such as FUNSD, CORD, SROIE, Kleister-NDA), one can also provide the corresponding word
labels in order to train a model. The processor will then convert these into token-level `),ta=r(we,"CODE",{});var Fg=i(ta);Xc=s(Fg,"labels"),Fg.forEach(o),Yc=s(we,`. By default, it
will only label the first wordpiece of a word, and label the remaining wordpieces with -100, which is the
`),oa=r(we,"CODE",{});var jg=i(oa);Zc=s(jg,"ignore_index"),jg.forEach(o),Jc=s(we,` of PyTorch\u2019s CrossEntropyLoss. In case you want all wordpieces of a word to be labeled, you can
...
LayoutLMv2 model according to the specified arguments, defining the model architecture. Instantiating a
configuration with the defaults will yield a similar configuration to that of the LayoutLMv2
`),io=r(ls,"A",{href:!0,rel:!0});var Vg=i(io);hp=s(Vg,"microsoft/layoutlmv2-base-uncased"),Vg.forEach(o),fp=s(ls," architecture."),ls.forEach(o),gp=p(vt),Fe=r(vt,"P",{});var ds=i(Fe);_p=s(ds,"Configuration objects inherit from "),On=r(ds,"A",{href:!0});var Qg=i(On);vp=s(Qg,"PretrainedConfig"),Qg.forEach(o),yp=s(ds,` and can be used to control the model outputs. Read the
documentation from `),Nn=r(ds,"A",{href:!0});var Gg=i(Nn);bp=s(Gg,"PretrainedConfig"),Gg.forEach(o),Lp=s(ds," for more information."),ds.forEach(o),kp=p(vt),y(Xe.$$.fragment,vt),vt.forEach(o),ti=p(t),je=r(t,"H2",{class:!0});var Ei=i(je);Ye=r(Ei,"A",{id:!0,class:!0,href:!0});var Hg=i(Ye);da=r(Hg,"SPAN",{});var Kg=i(da);y(lo.$$.fragment,Kg),Kg.forEach(o),Hg.forEach(o),wp=p(Ei),ca=r(Ei,"SPAN",{});var Xg=i(ca);xp=s(Xg,"LayoutLMv2FeatureExtractor"),Xg.forEach(o),Ei.forEach(o),oi=p(t),Z=r(t,"DIV",{class:!0});var yt=i(Z);y(co.$$.fragment,yt),Tp=p(yt),pa=r(yt,"P",{});var Yg=i(pa);Mp=s(Yg,`Constructs a LayoutLMv2 feature extractor. This can be used to resize document images to the same size, as well as
...
optional `),ba=r(H,"CODE",{});var l_=i(ba);Kp=s(l_,"labels"),l_.forEach(o),Xp=s(H," (for token classification)."),H.forEach(o),Yp=p(le),fo=r(le,"P",{});var Fi=i(fo);Zp=s(Fi,"This tokenizer inherits from "),Rn=r(Fi,"A",{href:!0});var d_=i(Rn);Jp=s(d_,"PreTrainedTokenizer"),d_.forEach(o),eu=s(Fi,` which contains most of the main methods. Users should refer to
this superclass for more information regarding those methods.`),Fi.forEach(o),tu=p(le),Wn=r(le,"P",{});var sf=i(Wn);Un=r(sf,"A",{href:!0});var c_=i(Un);ou=s(c_,"LayoutLMv2Tokenizer"),c_.forEach(o),nu=s(sf,` runs end-to-end tokenization: punctuation splitting and wordpiece. It also turns the
word-level bounding boxes into token-level bounding boxes.`),sf.forEach(o),su=p(le),et=r(le,"DIV",{class:!0});var ji=i(et);y(go.$$.fragment,ji),au=p(ji),La=r(ji,"P",{});var p_=i(La);ru=s(p_,`Main method to tokenize and prepare for the model one or several sequence(s) or one or several pair(s) of
sequences with word-level normalized bounding boxes and optional labels.`),p_.forEach(o),ji.forEach(o),iu=p(le),Bn=r(le,"DIV",{class:!0});var u_=i(Bn);y(_o.$$.fragment,u_),u_.forEach(o),le.forEach(o),ai=p(t),Ce=r(t,"H2",{class:!0});var Pi=i(Ce);tt=r(Pi,"A",{id:!0,class:!0,href:!0});var m_=i(tt);ka=r(m_,"SPAN",{});var h_=i(ka);y(vo.$$.fragment,h_),h_.forEach(o),m_.forEach(o),lu=p(Pi),wa=r(Pi,"SPAN",{});var f_=i(wa);du=s(f_,"LayoutLMv2TokenizerFast"),f_.forEach(o),Pi.forEach(o),ri=p(t),J=r(t,"DIV",{class:!0});var bt=i(J);y(yo.$$.fragment,bt),cu=p(bt),bo=r(bt,"P",{});var Ci=i(bo);pu=s(Ci,"Construct a \u201Cfast\u201D LayoutLMv2 tokenizer (backed by HuggingFace\u2019s "),xa=r(Ci,"EM",{});var g_=i(xa);uu=s(g_,"tokenizers"),g_.forEach(o),mu=s(Ci," library). Based on WordPiece."),Ci.forEach(o),hu=p(bt),Lo=r(bt,"P",{});var Ii=i(Lo);fu=s(Ii,"This tokenizer inherits from "),Vn=r(Ii,"A",{href:!0});var __=i(Vn);gu=s(__,"PreTrainedTokenizerFast"),__.forEach(o),_u=s(Ii,` which contains most of the main methods. Users should
...
sequences with word-level normalized bounding boxes and optional labels.`),v_.forEach(o),Di.forEach(o),bt.forEach(o),ii=p(t),Ie=r(t,"H2",{class:!0});var Ai=i(Ie);nt=r(Ai,"A",{id:!0,class:!0,href:!0});var y_=i(nt);Ma=r(y_,"SPAN",{});var b_=i(Ma);y(wo.$$.fragment,b_),b_.forEach(o),y_.forEach(o),Lu=p(Ai),$a=r(Ai,"SPAN",{});var L_=i($a);ku=s(L_,"LayoutLMv2Processor"),L_.forEach(o),Ai.forEach(o),li=p(t),B=r(t,"DIV",{class:!0});var xe=i(B);y(xo.$$.fragment,xe),wu=p(xe),Ea=r(xe,"P",{});var k_=i(Ea);xu=s(k_,`Constructs a LayoutLMv2 processor which combines a LayoutLMv2 feature extractor and a LayoutLMv2 tokenizer into a
single processor.`),k_.forEach(o),Tu=p(xe),Qn=r(xe,"P",{});var af=i(Qn);Gn=r(af,"A",{href:!0});var w_=i(Gn);Mu=s(w_,"LayoutLMv2Processor"),w_.forEach(o),$u=s(af," offers all the functionalities you need to prepare data for the model."),af.forEach(o),Eu=p(xe),j=r(xe,"P",{});var C=i(j);zu=s(C,"It first uses "),Hn=r(C,"A",{href:!0});var x_=i(Hn);qu=s(x_,"LayoutLMv2FeatureExtractor"),x_.forEach(o),Fu=s(C,` to resize document images to a fixed size, and optionally applies OCR
to get words and normalized bounding boxes. These are then provided to `),Kn=r(C,"A",{href:!0});var T_=i(Kn);ju=s(T_,"LayoutLMv2Tokenizer"),T_.forEach(o),Pu=s(C,` or
...
`),qa=r(C,"CODE",{});var E_=i(qa);Ou=s(E_,"attention_mask"),E_.forEach(o),Nu=s(C,", "),Fa=r(C,"CODE",{});var z_=i(Fa);Su=s(z_,"token_type_ids"),z_.forEach(o),Ru=s(C,", "),ja=r(C,"CODE",{});var q_=i(ja);Wu=s(q_,"bbox"),q_.forEach(o),Uu=s(C,". Optionally, one can provide integer "),Pa=r(C,"CODE",{});var F_=i(Pa);Bu=s(F_,"word_labels"),F_.forEach(o),Vu=s(C,`, which are turned
into token-level `),Ca=r(C,"CODE",{});var j_=i(Ca);Qu=s(j_,"labels"),j_.forEach(o),Gu=s(C," for token classification tasks (such as FUNSD, CORD)."),C.forEach(o),Hu=p(xe),ye=r(xe,"DIV",{class:!0});var ps=i(ye);y(To.$$.fragment,ps),Ku=p(ps),$=r(ps,"P",{});var q=i($);Xu=s(q,"This method first forwards the "),Ia=r(q,"CODE",{});var P_=i(Ia);Yu=s(P_,"images"),P_.forEach(o),Zu=s(q," argument to "),Mo=r(q,"A",{href:!0});var rf=i(Mo);Da=r(rf,"STRONG",{});var C_=i(Da);Ju=s(C_,"call"),C_.forEach(o),em=s(rf,"()"),rf.forEach(o),tm=s(q,`. In case
