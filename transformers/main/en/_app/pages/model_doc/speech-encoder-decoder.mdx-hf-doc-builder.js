...
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-comment"># load fine-tuned model</span>
<span class="hljs-meta">&gt;&gt;&gt; </span>model = FlaxSpeechEncoderDecoderModel.from_pretrained(<span class="hljs-string">&quot;./wav2vec2-2-bart-large&quot;</span>)`}}),{c(){m=a("p"),S=n("Example:"),_=l(),b(f.$$.fragment)},l(c){m=s(c,"P",{});var g=d(m);S=r(g,"Example:"),g.forEach(t),_=p(c),y(f.$$.fragment,c)},m(c,g){u(c,m,g),e(m,S),u(c,_,g),w(f,c,g),v=!0},p:sn,i(c){v||(E(f.$$.fragment,c),v=!0)},o(c){k(f.$$.fragment,c),v=!1},d(c){c&&t(m),c&&t(_),$(f,c)}}}function Di(P){let m,S,_,f,v,c,g,O,Xn,dn,A,er,xo,or,tr,lt,nr,rr,To,ar,sr,jo,dr,cr,cn,R,ir,pt,lr,pr,Ce,hr,mr,ln,H,fr,Mo,ur,gr,Do,_r,vr,pn,Y,pe,ht,Le,br,Ne,yr,mt,wr,Er,hn,B,qo,kr,$r,zo,Sr,xr,ft,Tr,jr,mn,Ve,fn,Z,he,ut,We,Mr,Ie,Dr,gt,qr,zr,un,x,Po,Pr,Ar,_t,Fr,Cr,Ao,Lr,Nr,Fo,Vr,Wr,vt,Ir,Or,bt,Br,Rr,yt,Hr,Gr,Co,Ur,Jr,me,Yr,wt,Zr,Kr,Et,Qr,Xr,Lo,ea,oa,gn,Oe,_n,K,fe,kt,Be,ta,Re,na,$t,ra,aa,vn,C,sa,St,da,ca,No,ia,la,xt,pa,ha,bn,ue,ma,Tt,fa,ua,yn,He,wn,Q,ge,jt,Ge,ga,Mt,_a,En,L,va,Dt,ba,ya,qt,wa,Ea,zt,ka,$a,kn,Ue,$n,X,_e,Pt,Je,Sa,At,xa,Sn,z,Ye,Ta,ve,Vo,ja,Ma,Wo,Da,qa,za,ee,Pa,Io,Aa,Fa,Oo,Ca,La,Na,be,Va,ye,Ze,Wa,Ke,Ia,Bo,Oa,Ba,Ra,we,Qe,Ha,oe,Ga,Ft,Ua,Ja,Ct,Ya,Za,xn,te,Ee,Lt,Xe,Ka,Nt,Qa,Tn,T,eo,Xa,ne,es,Ro,os,ts,Ho,ns,rs,as,oo,ss,to,ds,cs,is,no,ls,ro,ps,hs,ms,Vt,fs,us,ao,gs,Go,_s,vs,bs,so,ys,co,ws,Es,ks,G,Uo,$s,Ss,Wt,xs,Ts,It,js,Ms,Ds,N,io,qs,re,zs,Jo,Ps,As,Ot,Fs,Cs,Ls,ke,Ns,$e,Vs,V,lo,Ws,Bt,Is,Os,ae,Bs,Rt,Rs,Hs,Ht,Gs,Us,Js,Se,jn,se,xe,Gt,po,Ys,Ut,Zs,Mn,j,ho,Ks,de,Qs,Yo,Xs,ed,Zo,od,td,nd,mo,rd,fo,ad,sd,dd,uo,cd,go,id,ld,pd,Jt,hd,md,_o,fd,Ko,ud,gd,_d,vo,vd,bo,bd,yd,wd,U,Qo,Ed,kd,Yt,$d,Sd,Zt,xd,Td,jd,W,yo,Md,ce,Dd,Xo,qd,zd,Kt,Pd,Ad,Fd,Te,Cd,je,Ld,J,wo,Nd,Qt,Vd,Wd,Me,Dn;return c=new Fe({}),Le=new Fe({}),Ve=new le({props:{code:`from transformers import BertConfig, Wav2Vec2Config, SpeechEncoderDecoderConfig, SpeechEncoderDecoderModel
...
<span class="hljs-meta">&gt;&gt;&gt; </span>config = SpeechEncoderDecoderConfig.from_encoder_decoder_configs(config_encoder, config_decoder)
<span class="hljs-meta">&gt;&gt;&gt; </span>model = SpeechEncoderDecoderModel(config=config)`}}),We=new Fe({}),Oe=new le({props:{code:`from transformers import SpeechEncoderDecoderModel
...
and the default `),ft=a("code"),Tr=n("BertForCausalLM"),jr=n(" configuration for the decoder."),mn=l(),b(Ve.$$.fragment),fn=l(),Z=a("h2"),he=a("a"),ut=a("span"),b(We.$$.fragment),Mr=l(),Ie=a("span"),Dr=n("Initialising "),gt=a("code"),qr=n("SpeechEncoderDecoderModel"),zr=n(" from a pretrained encoder and a pretrained decoder."),un=l(),x=a("p"),Po=a("a"),Pr=n("SpeechEncoderDecoderModel"),Ar=n(" can be initialized from a pretrained encoder checkpoint and a pretrained decoder checkpoint. Note that any pretrained Transformer-based speech model, "),_t=a("em"),Fr=n("e.g."),Cr=l(),Ao=a("a"),Lr=n("Wav2Vec2"),Nr=n(", "),Fo=a("a"),Vr=n("Hubert"),Wr=n(" can serve as the encoder and both pretrained auto-encoding models, "),vt=a("em"),Ir=n("e.g."),Or=n(" BERT, pretrained causal language models, "),bt=a("em"),Br=n("e.g."),Rr=n(" GPT2, as well as the pretrained decoder part of sequence-to-sequence models, "),yt=a("em"),Hr=n("e.g."),Gr=n(` decoder of BART, can be used as the decoder.
...
arguments, defining the encoder and decoder configs.`),za=l(),ee=a("p"),Pa=n("Configuration objects inherit from "),Io=a("a"),Aa=n("PretrainedConfig"),Fa=n(` and can be used to control the model outputs. Read the
documentation from `),Oo=a("a"),Ca=n("PretrainedConfig"),La=n(" for more information."),Na=l(),b(be.$$.fragment),Va=l(),ye=a("div"),b(Ze.$$.fragment),Wa=l(),Ke=a("p"),Ia=n("Instantiate a "),Bo=a("a"),Oa=n("SpeechEncoderDecoderConfig"),Ba=n(` (or a derived class) from a pre-trained encoder model
...
:meth`),It=a("em"),js=n("~transformers.AutoModelForCausalLM.from_pretrained"),Ms=n(" class method for the decoder."),Ds=l(),N=a("div"),b(io.$$.fragment),qs=l(),re=a("p"),zs=n("The "),Jo=a("a"),Ps=n("SpeechEncoderDecoderModel"),As=n(" forward method, overrides the "),Ot=a("code"),Fs=n("__call__"),Cs=n(" special method."),Ls=l(),b(ke.$$.fragment),Ns=l(),b($e.$$.fragment),Vs=l(),V=a("div"),b(lo.$$.fragment),Ws=l(),Bt=a("p"),Is=n(`Instantiate an encoder and a decoder from one or two base classes of the library from pretrained model
...
encoder and :meth`),Zt=a("em"),xd=n("~transformers.FlaxAutoModelForCausalLM.from_pretrained"),Td=n(" class method for the decoder."),jd=l(),W=a("div"),b(yo.$$.fragment),Md=l(),ce=a("p"),Dd=n("The "),Xo=a("a"),qd=n("FlaxSpeechEncoderDecoderModel"),zd=n(" forward method, overrides the "),Kt=a("code"),Pd=n("__call__"),Ad=n(" special method."),Fd=l(),b(Te.$$.fragment),Cd=l(),b(je.$$.fragment),Ld=l(),J=a("div"),b(wo.$$.fragment),Nd=l(),Qt=a("p"),Vd=n(`Instantiate an encoder and a decoder from one or two base classes of the library from pretrained model
checkpoints.`),Wd=l(),b(Me.$$.fragment),this.h()},l(o){const h=wi('[data-svelte="svelte-1phssyn"]',document.head);m=s(h,"META",{name:!0,content:!0}),h.forEach(t),S=p(o),_=s(o,"H1",{class:!0});var Eo=d(_);f=s(Eo,"A",{id:!0,class:!0,href:!0});var Xt=d(f);v=s(Xt,"SPAN",{});var en=d(v);y(c.$$.fragment,en),en.forEach(t),Xt.forEach(t),g=p(Eo),O=s(Eo,"SPAN",{});var on=d(O);Xn=r(on,"Speech Encoder Decoder Models"),on.forEach(t),Eo.forEach(t),dn=p(o),A=s(o,"P",{});var F=d(A);er=r(F,"The "),xo=s(F,"A",{href:!0});var tn=d(xo);or=r(tn,"SpeechEncoderDecoderModel"),tn.forEach(t),tr=r(F,` can be used to initialize a speech-to-text model
with any pretrained speech autoencoding model as the encoder (`),lt=s(F,"EM",{});var nn=d(lt);nr=r(nn,"e.g."),nn.forEach(t),rr=p(F),To=s(F,"A",{href:!0});var Od=d(To);ar=r(Od,"Wav2Vec2"),Od.forEach(t),sr=r(F,", "),jo=s(F,"A",{href:!0});var Bd=d(jo);dr=r(Bd,"Hubert"),Bd.forEach(t),cr=r(F,") and any pretrained autoregressive model as the decoder."),F.forEach(t),cn=p(o),R=s(o,"P",{});var et=d(R);ir=r(et,`The effectiveness of initializing speech-sequence-to-text-sequence models with pretrained checkpoints for speech
...
arguments, defining the encoder and decoder configs.`),rn.forEach(t),za=p(I),ee=s(I,"P",{});var tt=d(ee);Pa=r(tt,"Configuration objects inherit from "),Io=s(tt,"A",{href:!0});var zc=d(Io);Aa=r(zc,"PretrainedConfig"),zc.forEach(t),Fa=r(tt,` and can be used to control the model outputs. Read the
documentation from `),Oo=s(tt,"A",{href:!0});var Pc=d(Oo);Ca=r(Pc,"PretrainedConfig"),Pc.forEach(t),La=r(tt," for more information."),tt.forEach(t),Na=p(I),y(be.$$.fragment,I),Va=p(I),ye=s(I,"DIV",{class:!0});var Wn=d(ye);y(Ze.$$.fragment,Wn),Wa=p(Wn),Ke=s(Wn,"P",{});var In=d(Ke);Ia=r(In,"Instantiate a "),Bo=s(In,"A",{href:!0});var Ac=d(Bo);Oa=r(Ac,"SpeechEncoderDecoderConfig"),Ac.forEach(t),Ba=r(In,` (or a derived class) from a pre-trained encoder model
configuration and decoder model configuration.`),In.forEach(t),Wn.forEach(t),Ra=p(I),we=s(I,"DIV",{class:!0});var On=d(we);y(Qe.$$.fragment,On),Ha=p(On),oe=s(On,"P",{});var nt=d(oe);Ga=r(nt,"Serializes this instance to a Python dictionary. Override the default "),Ft=s(nt,"EM",{});var Fc=d(Ft);Ua=r(Fc,"to_dict()"),Fc.forEach(t),Ja=r(nt," from "),Ct=s(nt,"EM",{});var Cc=d(Ct);Ya=r(Cc,"PretrainedConfig"),Cc.forEach(t),Za=r(nt,"."),nt.forEach(t),On.forEach(t),I.forEach(t),xn=p(o),te=s(o,"H2",{class:!0});var Bn=d(te);Ee=s(Bn,"A",{id:!0,class:!0,href:!0});var Lc=d(Ee);Lt=s(Lc,"SPAN",{});var Nc=d(Lt);y(Xe.$$.fragment,Nc),Nc.forEach(t),Lc.forEach(t),Ka=p(Bn),Nt=s(Bn,"SPAN",{});var Vc=d(Nt);Qa=r(Vc,"SpeechEncoderDecoderModel"),Vc.forEach(t),Bn.forEach(t),Tn=p(o),T=s(o,"DIV",{class:!0});var D=d(T);y(eo.$$.fragment,D),Xa=p(D),ne=s(D,"P",{});var rt=d(ne);es=r(rt,`This class can be used to initialize a speech-sequence-to-text-sequence model with any pretrained speech
autoencoding model as the encoder and any pretrained text autoregressive model as the decoder. The encoder is
