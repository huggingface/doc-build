...
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),g.forEach(t)},m(c,g){u(c,m,g),e(m,S),e(m,_),e(_,f),e(m,v)},d(c){c&&t(m)}}}function Si(P){let m,S,_,f,v;return f=new le({props:{code:`from transformers import SpeechEncoderDecoderModel, Wav2Vec2Processor
...
<span class="hljs-meta">&gt;&gt;&gt; </span>model = SpeechEncoderDecoderModel.from_pretrained(<span class="hljs-string">&quot;./wav2vec2bert&quot;</span>)`}}),{c(){m=a("p"),S=n("Example:"),_=l(),b(f.$$.fragment)},l(c){m=s(c,"P",{});var g=d(m);S=r(g,"Example:"),g.forEach(t),_=p(c),y(f.$$.fragment,c)},m(c,g){u(c,m,g),e(m,S),u(c,_,g),w(f,c,g),v=!0},p:sn,i(c){v||(E(f.$$.fragment,c),v=!0)},o(c){k(f.$$.fragment,c),v=!1},d(c){c&&t(m),c&&t(_),$(f,c)}}}function Ti(P){let m,S,_,f,v;return{c(){m=a("p"),S=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),_=a("code"),f=n("Module"),v=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(c){m=s(c,"P",{});var g=d(m);S=r(g,"Although the recipe for forward pass needs to be defined within this function, one should call the "),_=s(g,"CODE",{});var O=d(_);f=r(O,"Module"),O.forEach(t),v=r(g,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),g.forEach(t)},m(c,g){u(c,m,g),e(m,S),e(m,_),e(_,f),e(m,v)},d(c){c&&t(m)}}}function ji(P){let m,S,_,f,v;return f=new le({props:{code:`from transformers import FlaxSpeechEncoderDecoderModel, BartTokenizer
...
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-comment"># load fine-tuned model</span>
<span class="hljs-meta">&gt;&gt;&gt; </span>model = FlaxSpeechEncoderDecoderModel.from_pretrained(<span class="hljs-string">&quot;./wav2vec2-2-bart-large&quot;</span>)`}}),{c(){m=a("p"),S=n("Example:"),_=l(),b(f.$$.fragment)},l(c){m=s(c,"P",{});var g=d(m);S=r(g,"Example:"),g.forEach(t),_=p(c),y(f.$$.fragment,c)},m(c,g){u(c,m,g),e(m,S),u(c,_,g),w(f,c,g),v=!0},p:sn,i(c){v||(E(f.$$.fragment,c),v=!0)},o(c){k(f.$$.fragment,c),v=!1},d(c){c&&t(m),c&&t(_),$(f,c)}}}function Di(P){let m,S,_,f,v,c,g,O,Xn,dn,A,er,xo,or,tr,lt,nr,rr,To,ar,sr,jo,dr,cr,cn,R,ir,pt,lr,pr,Fe,hr,mr,ln,H,fr,Mo,ur,gr,Do,_r,vr,pn,Y,pe,ht,Le,br,Ne,yr,mt,wr,Er,hn,B,qo,kr,$r,zo,Sr,xr,ft,Tr,jr,mn,Ve,fn,Z,he,ut,We,Mr,Ie,Dr,gt,qr,zr,un,x,Po,Pr,Ar,_t,Cr,Fr,Ao,Lr,Nr,Co,Vr,Wr,vt,Ir,Or,bt,Br,Rr,yt,Hr,Gr,Fo,Ur,Jr,me,Yr,wt,Zr,Kr,Et,Qr,Xr,Lo,ea,oa,gn,Oe,_n,K,fe,kt,Be,ta,Re,na,$t,ra,aa,vn,F,sa,St,da,ca,No,ia,la,xt,pa,ha,bn,ue,ma,Tt,fa,ua,yn,He,wn,Q,ge,jt,Ge,ga,Mt,_a,En,L,va,Dt,ba,ya,qt,wa,Ea,zt,ka,$a,kn,Ue,$n,X,_e,Pt,Je,Sa,At,xa,Sn,z,Ye,Ta,ve,Vo,ja,Ma,Wo,Da,qa,za,ee,Pa,Io,Aa,Ca,Oo,Fa,La,Na,be,Va,ye,Ze,Wa,Ke,Ia,Bo,Oa,Ba,Ra,we,Qe,Ha,oe,Ga,Ct,Ua,Ja,Ft,Ya,Za,xn,te,Ee,Lt,Xe,Ka,Nt,Qa,Tn,T,eo,Xa,ne,es,Ro,os,ts,Ho,ns,rs,as,oo,ss,to,ds,cs,is,no,ls,ro,ps,hs,ms,Vt,fs,us,ao,gs,Go,_s,vs,bs,so,ys,co,ws,Es,ks,G,Uo,$s,Ss,Wt,xs,Ts,It,js,Ms,Ds,N,io,qs,re,zs,Jo,Ps,As,Ot,Cs,Fs,Ls,ke,Ns,$e,Vs,V,lo,Ws,Bt,Is,Os,ae,Bs,Rt,Rs,Hs,Ht,Gs,Us,Js,Se,jn,se,xe,Gt,po,Ys,Ut,Zs,Mn,j,ho,Ks,de,Qs,Yo,Xs,ed,Zo,od,td,nd,mo,rd,fo,ad,sd,dd,uo,cd,go,id,ld,pd,Jt,hd,md,_o,fd,Ko,ud,gd,_d,vo,vd,bo,bd,yd,wd,U,Qo,Ed,kd,Yt,$d,Sd,Zt,xd,Td,jd,W,yo,Md,ce,Dd,Xo,qd,zd,Kt,Pd,Ad,Cd,Te,Fd,je,Ld,J,wo,Nd,Qt,Vd,Wd,Me,Dn;return c=new Ce({}),Le=new Ce({}),Ve=new le({props:{code:`from transformers import BertConfig, Wav2Vec2Config, SpeechEncoderDecoderConfig, SpeechEncoderDecoderModel
...
</ul>`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/speech_encoder_decoder/modeling_speech_encoder_decoder.py#L442",returnDescription:`
<p>A <a
...
If set to <code>True</code>, the model will return a <code>FlaxSeq2SeqLMOutput</code> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/speech_encoder_decoder/modeling_flax_speech_encoder_decoder.py#L662",returnDescription:`
<p>A <a
...
speech inputs) and `),qt=a("code"),wa=n("labels"),Ea=n(" (which are the "),zt=a("code"),ka=n("input_ids"),$a=n(" of the encoded target sequence)."),kn=l(),b(Ue.$$.fragment),$n=l(),X=a("h2"),_e=a("a"),Pt=a("span"),b(Je.$$.fragment),Sa=l(),At=a("span"),xa=n("SpeechEncoderDecoderConfig"),Sn=l(),z=a("div"),b(Ye.$$.fragment),Ta=l(),ve=a("p"),Vo=a("a"),ja=n("SpeechEncoderDecoderConfig"),Ma=n(` is the configuration class to store the configuration of a
...
:meth`),It=a("em"),js=n("~transformers.AutoModelForCausalLM.from_pretrained"),Ms=n(" class method for the decoder."),Ds=l(),N=a("div"),b(io.$$.fragment),qs=l(),re=a("p"),zs=n("The "),Jo=a("a"),Ps=n("SpeechEncoderDecoderModel"),As=n(" forward method, overrides the "),Ot=a("code"),Cs=n("__call__"),Fs=n(" special method."),Ls=l(),b(ke.$$.fragment),Ns=l(),b($e.$$.fragment),Vs=l(),V=a("div"),b(lo.$$.fragment),Ws=l(),Bt=a("p"),Is=n(`Instantiate an encoder and a decoder from one or two base classes of the library from pretrained model
...
checkpoints.`),Wd=l(),b(Me.$$.fragment),this.h()},l(o){const h=wi('[data-svelte="svelte-1phssyn"]',document.head);m=s(h,"META",{name:!0,content:!0}),h.forEach(t),S=p(o),_=s(o,"H1",{class:!0});var Eo=d(_);f=s(Eo,"A",{id:!0,class:!0,href:!0});var Xt=d(f);v=s(Xt,"SPAN",{});var en=d(v);y(c.$$.fragment,en),en.forEach(t),Xt.forEach(t),g=p(Eo),O=s(Eo,"SPAN",{});var on=d(O);Xn=r(on,"Speech Encoder Decoder Models"),on.forEach(t),Eo.forEach(t),dn=p(o),A=s(o,"P",{});var C=d(A);er=r(C,"The "),xo=s(C,"A",{href:!0});var tn=d(xo);or=r(tn,"SpeechEncoderDecoderModel"),tn.forEach(t),tr=r(C,` can be used to initialize a speech-to-text model
...
speech inputs) and `),qt=s(qe,"CODE",{});var Sc=d(qt);wa=r(Sc,"labels"),Sc.forEach(t),Ea=r(qe," (which are the "),zt=s(qe,"CODE",{});var xc=d(zt);ka=r(xc,"input_ids"),xc.forEach(t),$a=r(qe," of the encoded target sequence)."),qe.forEach(t),kn=p(o),y(Ue.$$.fragment,o),$n=p(o),X=s(o,"H2",{class:!0});var Vn=d(X);_e=s(Vn,"A",{id:!0,class:!0,href:!0});var Tc=d(_e);Pt=s(Tc,"SPAN",{});var jc=d(Pt);y(Je.$$.fragment,jc),jc.forEach(t),Tc.forEach(t),Sa=p(Vn),At=s(Vn,"SPAN",{});var Mc=d(At);xa=r(Mc,"SpeechEncoderDecoderConfig"),Mc.forEach(t),Vn.forEach(t),Sn=p(o),z=s(o,"DIV",{class:!0});var I=d(z);y(Ye.$$.fragment,I),Ta=p(I),ve=s(I,"P",{});var rn=d(ve);Vo=s(rn,"A",{href:!0});var Dc=d(Vo);ja=r(Dc,"SpeechEncoderDecoderConfig"),Dc.forEach(t),Ma=r(rn,` is the configuration class to store the configuration of a
...
one of the base model classes of the library as encoder and another one as decoder when created with the
:meth`),Wt=s($o,"EM",{});var Jc=d(Wt);xs=r(Jc,"~transformers.AutoModel.from_pretrained"),Jc.forEach(t),Ts=r($o,` class method for the encoder and
:meth`),It=s($o,"EM",{});var Yc=d(It);js=r(Yc,"~transformers.AutoModelForCausalLM.from_pretrained"),Yc.forEach(t),Ms=r($o," class method for the decoder."),$o.forEach(t),Ds=p(D),N=s(D,"DIV",{class:!0});var ze=d(N);y(io.$$.fragment,ze),qs=p(ze),re=s(ze,"P",{});var at=d(re);zs=r(at,"The "),Jo=s(at,"A",{href:!0});var Zc=d(Jo);Ps=r(Zc,"SpeechEncoderDecoderModel"),Zc.forEach(t),As=r(at," forward method, overrides the "),Ot=s(at,"CODE",{});var Kc=d(Ot);Cs=r(Kc,"__call__"),Kc.forEach(t),Fs=r(at," special method."),at.forEach(t),Ls=p(ze),y(ke.$$.fragment,ze),Ns=p(ze),y($e.$$.fragment,ze),ze.forEach(t),Vs=p(D),V=s(D,"DIV",{class:!0});var Pe=d(V);y(lo.$$.fragment,Pe),Ws=p(Pe),Bt=s(Pe,"P",{});var Qc=d(Bt);Is=r(Qc,`Instantiate an encoder and a decoder from one or two base classes of the library from pretrained model
