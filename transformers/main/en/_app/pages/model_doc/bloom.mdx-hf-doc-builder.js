...
Several smaller versions of the models have been trained on the same dataset. BLOOM is available in the following versions:`),Vt=u(),q=a("ul"),et=a("li"),He=a("a"),Cs=i("bloom-350m"),zs=u(),ot=a("li"),Ue=a("a"),Es=i("bloom-760m"),Ms=u(),tt=a("li"),Ve=a("a"),qs=i("bloom-1b3"),xs=u(),st=a("li"),Re=a("a"),js=i("bloom-2b5"),Ps=u(),nt=a("li"),Ge=a("a"),Os=i("bloom-6b3"),Ss=u(),qo=a("li"),Ye=a("a"),As=i("bloom"),Ns=i(" (176B parameters)"),Rt=u(),se=a("h2"),ge=a("a"),at=a("span"),v(Je.$$.fragment),Ls=u(),rt=a("span"),Is=i("BloomConfig"),Gt=u(),D=a("div"),v(Ke.$$.fragment),Ds=u(),ne=a("p"),Ws=i("This is the configuration class to store the configuration of a "),xo=a("a"),Hs=i("BloomModel"),Us=i(`. It is used to instantiate a Bloom
...
The architecture of BLOOM is essentially similar to GPT3 (auto-regressive model for next token prediction), but has been trained on 46 different languages and 13 programming languages.
Several smaller versions of the models have been trained on the same dataset. BLOOM is available in the following versions:`),Mo.forEach(t),Vt=f(o),q=r(o,"UL",{});var O=l(q);et=r(O,"LI",{});var Lt=l(et);He=r(Lt,"A",{href:!0,rel:!0});var It=l(He);Cs=d(It,"bloom-350m"),It.forEach(t),Lt.forEach(t),zs=f(O),ot=r(O,"LI",{});var Dt=l(ot);Ue=r(Dt,"A",{href:!0,rel:!0});var Wt=l(Ue);Es=d(Wt,"bloom-760m"),Wt.forEach(t),Dt.forEach(t),Ms=f(O),tt=r(O,"LI",{});var ur=l(tt);Ve=r(ur,"A",{href:!0,rel:!0});var fr=l(Ve);qs=d(fr,"bloom-1b3"),fr.forEach(t),ur.forEach(t),xs=f(O),st=r(O,"LI",{});var gr=l(st);Re=r(gr,"A",{href:!0,rel:!0});var _r=l(Re);js=d(_r,"bloom-2b5"),_r.forEach(t),gr.forEach(t),Ps=f(O),nt=r(O,"LI",{});var br=l(nt);Ge=r(br,"A",{href:!0,rel:!0});var kr=l(Ge);Os=d(kr,"bloom-6b3"),kr.forEach(t),br.forEach(t),Ss=f(O),qo=r(O,"LI",{});var pr=l(qo);Ye=r(pr,"A",{href:!0,rel:!0});var vr=l(Ye);As=d(vr,"bloom"),vr.forEach(t),Ns=d(pr," (176B parameters)"),pr.forEach(t),O.forEach(t),Rt=f(o),se=r(o,"H2",{class:!0});var as=l(se);ge=r(as,"A",{id:!0,class:!0,href:!0});var $r=l(ge);at=r($r,"SPAN",{});var yr=l(at);$(Je.$$.fragment,yr),yr.forEach(t),$r.forEach(t),Ls=f(as),rt=r(as,"SPAN",{});var wr=l(rt);Is=d(wr,"BloomConfig"),wr.forEach(t),as.forEach(t),Gt=f(o),D=r(o,"DIV",{class:!0});var Ae=l(D);$(Ke.$$.fragment,Ae),Ds=f(Ae),ne=r(Ae,"P",{});var Ro=l(ne);Ws=d(Ro,"This is the configuration class to store the configuration of a "),xo=r(Ro,"A",{href:!0});var Tr=l(xo);Hs=d(Tr,"BloomModel"),Tr.forEach(t),Us=d(Ro,`. It is used to instantiate a Bloom
model according to the specified arguments, defining the model architecture. Instantiating a configuration with the
defaults will yield a similar configuration to the Bloom architecture
