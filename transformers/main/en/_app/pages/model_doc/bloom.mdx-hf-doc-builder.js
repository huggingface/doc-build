...
<span class="hljs-meta">&gt;&gt;&gt; </span>configuration = model.config`}}),{c(){s=a("p"),g=i("Example:"),c=u(),v(m.$$.fragment)},l(n){s=r(n,"P",{});var p=l(s);g=d(p,"Example:"),p.forEach(t),c=f(n),$(m.$$.fragment,n)},m(n,p){k(n,s,p),e(s,g),k(n,c,p),y(m,n,p),b=!0},p:ee,i(n){b||(w(m.$$.fragment,n),b=!0)},o(n){T(m.$$.fragment,n),b=!1},d(n){n&&t(s),n&&t(c),B(m,n)}}}function Tl(F){let s,g,c,m,b;return{c(){s=a("p"),g=i("Although the recipe for forward pass needs to be defined within this function, one should call the "),c=a("code"),m=i("Module"),b=i(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(n){s=r(n,"P",{});var p=l(s);g=d(p,"Although the recipe for forward pass needs to be defined within this function, one should call the "),c=r(p,"CODE",{});var C=l(c);m=d(C,"Module"),C.forEach(t),b=d(p,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),p.forEach(t)},m(n,p){k(n,s,p),e(s,g),e(s,c),e(c,m),e(s,b)},d(n){n&&t(s)}}}function Bl(F){let s,g,c,m,b;return m=new oe({props:{code:`from transformers import BloomTokenizerFast, BloomModel
import torch
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),{c(){s=a("p"),g=i("Example:"),c=u(),v(m.$$.fragment)},l(n){s=r(n,"P",{});var p=l(s);g=d(p,"Example:"),p.forEach(t),c=f(n),$(m.$$.fragment,n)},m(n,p){k(n,s,p),e(s,g),k(n,c,p),y(m,n,p),b=!0},p:ee,i(n){b||(w(m.$$.fragment,n),b=!0)},o(n){T(m.$$.fragment,n),b=!1},d(n){n&&t(s),n&&t(c),B(m,n)}}}function Fl(F){let s,g,c,m,b;return m=new oe({props:{code:`from transformers import BloomTokenizerFast
...
[15496, 995]
<span class="hljs-meta">&gt;&gt;&gt;</span> <span class="language-python">tokenizer(<span class="hljs-string">&quot; Hello world&quot;</span>)[<span class="hljs-string">&#x27;input_ids&#x27;</span>]</span>
[18435, 995]`}}),{c(){s=a("p"),g=i("be encoded differently whether it is at the beginning of the sentence (without space) or not:"),c=u(),v(m.$$.fragment)},l(n){s=r(n,"P",{});var p=l(s);g=d(p,"be encoded differently whether it is at the beginning of the sentence (without space) or not:"),p.forEach(t),c=f(n),$(m.$$.fragment,n)},m(n,p){k(n,s,p),e(s,g),k(n,c,p),y(m,n,p),b=!0},p:ee,i(n){b||(w(m.$$.fragment,n),b=!0)},o(n){T(m.$$.fragment,n),b=!1},d(n){n&&t(s),n&&t(c),B(m,n)}}}function Cl(F){let s,g,c,m,b,n,p,C;return{c(){s=a("p"),g=i("When used with "),c=a("code"),m=i("is_split_into_words=True"),b=i(", this tokenizer needs to be instantiated with "),n=a("code"),p=i("add_prefix_space=True"),C=i(".")},l(te){s=r(te,"P",{});var I=l(s);g=d(I,"When used with "),c=r(I,"CODE",{});var H=l(c);m=d(H,"is_split_into_words=True"),H.forEach(t),b=d(I,", this tokenizer needs to be instantiated with "),n=r(I,"CODE",{});var R=l(n);p=d(R,"add_prefix_space=True"),R.forEach(t),C=d(I,"."),I.forEach(t)},m(te,I){k(te,s,I),e(s,g),e(s,c),e(c,m),e(s,b),e(s,n),e(n,p),e(s,C)},d(te){te&&t(s)}}}function zl(F){let s,g,c,m,b;return{c(){s=a("p"),g=i("Although the recipe for forward pass needs to be defined within this function, one should call the "),c=a("code"),m=i("Module"),b=i(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(n){s=r(n,"P",{});var p=l(s);g=d(p,"Although the recipe for forward pass needs to be defined within this function, one should call the "),c=r(p,"CODE",{});var C=l(c);m=d(C,"Module"),C.forEach(t),b=d(p,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),p.forEach(t)},m(n,p){k(n,s,p),e(s,g),e(s,c),e(c,m),e(s,b)},d(n){n&&t(s)}}}function El(F){let s,g,c,m,b;return m=new oe({props:{code:`import torch
...
<span class="hljs-meta">&gt;&gt;&gt; </span>logits = outputs.logits`}}),{c(){s=a("p"),g=i("Example:"),c=u(),v(m.$$.fragment)},l(n){s=r(n,"P",{});var p=l(s);g=d(p,"Example:"),p.forEach(t),c=f(n),$(m.$$.fragment,n)},m(n,p){k(n,s,p),e(s,g),k(n,c,p),y(m,n,p),b=!0},p:ee,i(n){b||(w(m.$$.fragment,n),b=!0)},o(n){T(m.$$.fragment,n),b=!1},d(n){n&&t(s),n&&t(c),B(m,n)}}}function Ml(F){let s,g,c,m,b;return{c(){s=a("p"),g=i("Although the recipe for forward pass needs to be defined within this function, one should call the "),c=a("code"),m=i("Module"),b=i(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(n){s=r(n,"P",{});var p=l(s);g=d(p,"Although the recipe for forward pass needs to be defined within this function, one should call the "),c=r(p,"CODE",{});var C=l(c);m=d(C,"Module"),C.forEach(t),b=d(p,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),p.forEach(t)},m(n,p){k(n,s,p),e(s,g),e(s,c),e(c,m),e(s,b)},d(n){n&&t(s)}}}function ql(F){let s,g,c,m,b;return m=new oe({props:{code:`import torch
...
`}}),{c(){s=a("p"),g=i("Example of single-label classification:"),c=u(),v(m.$$.fragment)},l(n){s=r(n,"P",{});var p=l(s);g=d(p,"Example of single-label classification:"),p.forEach(t),c=f(n),$(m.$$.fragment,n)},m(n,p){k(n,s,p),e(s,g),k(n,c,p),y(m,n,p),b=!0},p:ee,i(n){b||(w(m.$$.fragment,n),b=!0)},o(n){T(m.$$.fragment,n),b=!1},d(n){n&&t(s),n&&t(c),B(m,n)}}}function xl(F){let s,g;return s=new oe({props:{code:`# To train a model on \`num_labels\` classes, you can pass \`num_labels=num_labels\` to \`.from_pretrained(...)\`
...
`}}),{c(){v(s.$$.fragment)},l(c){$(s.$$.fragment,c)},m(c,m){y(s,c,m),g=!0},p:ee,i(c){g||(w(s.$$.fragment,c),g=!0)},o(c){T(s.$$.fragment,c),g=!1},d(c){B(s,c)}}}function jl(F){let s,g,c,m,b;return m=new oe({props:{code:`import torch
from transformers import BloomTokenizerFast, BloomForSequenceClassification
...
<span class="hljs-meta">&gt;&gt;&gt; </span>predicted_class_id = logits.argmax().item()
<span class="hljs-meta">&gt;&gt;&gt; </span>model.config.id2label[predicted_class_id]
`}}),{c(){s=a("p"),g=i("Example of multi-label classification:"),c=u(),v(m.$$.fragment)},l(n){s=r(n,"P",{});var p=l(s);g=d(p,"Example of multi-label classification:"),p.forEach(t),c=f(n),$(m.$$.fragment,n)},m(n,p){k(n,s,p),e(s,g),k(n,c,p),y(m,n,p),b=!0},p:ee,i(n){b||(w(m.$$.fragment,n),b=!0)},o(n){T(m.$$.fragment,n),b=!1},d(n){n&&t(s),n&&t(c),B(m,n)}}}function Pl(F){let s,g;return s=new oe({props:{code:`# To train a model on \`num_labels\` classes, you can pass \`num_labels=num_labels\` to \`.from_pretrained(...)\`
num_labels = len(model.config.id2label)
...
<span class="hljs-meta">... </span>)
<span class="hljs-meta">&gt;&gt;&gt; </span>loss = model(**inputs, labels=labels).loss
<span class="hljs-meta">&gt;&gt;&gt; </span>loss.backward()`}}),{c(){v(s.$$.fragment)},l(c){$(s.$$.fragment,c)},m(c,m){y(s,c,m),g=!0},p:ee,i(c){g||(w(s.$$.fragment,c),g=!0)},o(c){T(s.$$.fragment,c),g=!1},d(c){B(s,c)}}}function Ol(F){let s,g,c,m,b;return{c(){s=a("p"),g=i("Although the recipe for forward pass needs to be defined within this function, one should call the "),c=a("code"),m=i("Module"),b=i(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(n){s=r(n,"P",{});var p=l(s);g=d(p,"Although the recipe for forward pass needs to be defined within this function, one should call the "),c=r(p,"CODE",{});var C=l(c);m=d(C,"Module"),C.forEach(t),b=d(p,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),p.forEach(t)},m(n,p){k(n,s,p),e(s,g),e(s,c),e(c,m),e(s,b)},d(n){n&&t(s)}}}function Sl(F){let s,g,c,m,b;return m=new oe({props:{code:`from transformers import BloomTokenizerFast, BloomForTokenClassification
import torch
...
`}}),{c(){s=a("p"),g=i("Example:"),c=u(),v(m.$$.fragment)},l(n){s=r(n,"P",{});var p=l(s);g=d(p,"Example:"),p.forEach(t),c=f(n),$(m.$$.fragment,n)},m(n,p){k(n,s,p),e(s,g),k(n,c,p),y(m,n,p),b=!0},p:ee,i(n){b||(w(m.$$.fragment,n),b=!0)},o(n){T(m.$$.fragment,n),b=!1},d(n){n&&t(s),n&&t(c),B(m,n)}}}function Al(F){let s,g;return s=new oe({props:{code:`labels = predicted_token_class_ids
loss = model(**inputs, labels=labels).loss
round(loss.item(), 2)
`,highlighted:`<span class="hljs-meta">&gt;&gt;&gt; </span>labels = predicted_token_class_ids
<span class="hljs-meta">&gt;&gt;&gt; </span>loss = model(**inputs, labels=labels).loss
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-built_in">round</span>(loss.item(), <span class="hljs-number">2</span>)
`}}),{c(){v(s.$$.fragment)},l(c){$(s.$$.fragment,c)},m(c,m){y(s,c,m),g=!0},p:ee,i(c){g||(w(s.$$.fragment,c),g=!0)},o(c){T(s.$$.fragment,c),g=!1},d(c){B(s,c)}}}function Nl(F){let s,g,c,m,b,n,p,C,te,I,H,R,Xo,De,wn,Zo,Tn,Ut,fe,Bn,We,Fn,Cn,Vt,q,et,He,zn,En,ot,Ue,Mn,qn,tt,Ve,xn,jn,nt,Re,Pn,On,st,Ge,Sn,An,qo,Ye,Nn,Ln,Rt,ne,ge,at,Je,In,rt,Dn,Gt,D,Ke,Wn,se,Hn,xo,Un,Vn,Qe,Rn,Gn,Yn,ae,Jn,jo,Kn,Qn,Po,Xn,Zn,es,_e,Yt,re,be,lt,Xe,os,it,ts,Jt,x,Ze,ns,dt,ss,as,eo,rs,Oo,ls,is,ds,oo,cs,to,ms,ps,hs,U,no,us,le,fs,So,gs,_s,ct,bs,ks,vs,ke,$s,ve,Kt,ie,$e,mt,so,ys,pt,ws,Qt,z,ao,Ts,ro,Bs,ht,Fs,Cs,zs,ut,Es,Ms,ye,qs,lo,xs,ft,js,Ps,Os,we,Ss,io,As,Ao,Ns,Ls,Xt,de,Te,gt,co,Is,_t,Ds,Zt,j,mo,Ws,bt,Hs,Us,po,Vs,No,Rs,Gs,Ys,ho,Js,uo,Ks,Qs,Xs,V,fo,Zs,ce,ea,Lo,oa,ta,kt,na,sa,aa,Be,ra,Fe,en,me,Ce,vt,go,la,$t,ia,on,E,_o,da,yt,ca,ma,Io,Do,pa,ha,ua,W,fa,wt,ga,_a,Tt,ba,ka,Bt,va,$a,Ft,ya,wa,Ta,bo,Ba,Wo,Fa,Ca,za,ko,Ea,vo,Ma,qa,xa,M,$o,ja,pe,Pa,Ho,Oa,Sa,Ct,Aa,Na,La,ze,Ia,Ee,Da,Me,Wa,qe,Ha,xe,tn,he,je,zt,yo,Ua,Et,Va,nn,P,wo,Ra,Mt,Ga,Ya,To,Ja,Uo,Ka,Qa,Xa,Bo,Za,Fo,er,or,tr,S,Co,nr,ue,sr,Vo,ar,rr,qt,lr,ir,dr,Pe,cr,Oe,mr,Se,sn;return n=new Ie({}),De=new Ie({}),Je=new Ie({}),Ke=new X({props:{name:"class transformers.BloomConfig",anchor:"transformers.BloomConfig",parameters:[{name:"vocab_size",val:" = 250880"},{name:"hidden_size",val:" = 64"},{name:"n_layer",val:" = 2"},{name:"n_head",val:" = 8"},{name:"layer_norm_epsilon",val:" = 1e-05"},{name:"initializer_range",val:" = 0.02"},{name:"use_cache",val:" = True"},{name:"bos_token_id",val:" = 1"},{name:"eos_token_id",val:" = 2"},{name:"apply_residual_connection_post_layernorm",val:" = False"},{name:"hidden_dropout",val:" = 0.0"},{name:"attention_dropout",val:" = 0.0"},{name:"pretraining_tp",val:" = 1"},{name:"slow_but_exact",val:" = False"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.BloomConfig.vocab_size",description:`<strong>vocab_size</strong> (<code>int</code>, <em>optional</em>, defaults to 50257) &#x2014;
...
resolved in the future once the main model has been fine-tuned with TP_rank=1.`,name:"slow_but_exact"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/bloom/configuration_bloom.py#L44"}}),_e=new Z({props:{anchor:"transformers.BloomConfig.example",$$slots:{default:[wl]},$$scope:{ctx:F}}}),Xe=new Ie({}),Ze=new X({props:{name:"class transformers.BloomModel",anchor:"transformers.BloomModel",parameters:[{name:"config",val:": BloomConfig"}],parametersDescription:[{anchor:"transformers.BloomModel.config",description:`<strong>config</strong> (<a href="/docs/transformers/main/en/model_doc/bloom#transformers.BloomConfig">BloomConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
...
documentation from `),Po=a("a"),Xn=i("PretrainedConfig"),Zn=i(" for more information."),es=u(),v(_e.$$.fragment),Yt=u(),re=a("h2"),be=a("a"),lt=a("span"),v(Xe.$$.fragment),os=u(),it=a("span"),ts=i("BloomModel"),Jt=u(),x=a("div"),v(Ze.$$.fragment),ns=u(),dt=a("p"),ss=i("The bare Bloom Model transformer outputting raw hidden-states without any specific head on top."),as=u(),eo=a("p"),rs=i("This model inherits from "),Oo=a("a"),ls=i("PreTrainedModel"),is=i(`. Check the superclass documentation for the generic methods the
...
and behavior.`),hs=u(),U=a("div"),v(no.$$.fragment),us=u(),le=a("p"),fs=i("The "),So=a("a"),gs=i("BloomModel"),_s=i(" forward method, overrides the "),ct=a("code"),bs=i("__call__"),ks=i(" special method."),vs=u(),v(ke.$$.fragment),$s=u(),v(ve.$$.fragment),Kt=u(),ie=a("h2"),$e=a("a"),mt=a("span"),v(so.$$.fragment),ys=u(),pt=a("span"),ws=i("BloomTokenizerFast"),Qt=u(),z=a("div"),v(ao.$$.fragment),Ts=u(),ro=a("p"),Bs=i("Construct a \u201Cfast\u201D Bloom tokenizer (backed by HuggingFace\u2019s "),ht=a("em"),Fs=i("tokenizers"),Cs=i(` library). Based on byte-level
Byte-Pair-Encoding.`),zs=u(),ut=a("p"),Es=i("This tokenizer has been trained to treat spaces like parts of the tokens (a bit like sentencepiece) so a word will"),Ms=u(),v(ye.$$.fragment),qs=u(),lo=a("p"),xs=i("You can get around that behavior by passing "),ft=a("code"),js=i("add_prefix_space=True"),Ps=i(` when instantiating this tokenizer, but since
the model was not pretrained this way, it might yield a decrease in performance.`),Os=u(),v(we.$$.fragment),Ss=u(),io=a("p"),As=i("This tokenizer inherits from "),Ao=a("a"),Ns=i("PreTrainedTokenizerFast"),Ls=i(` which contains most of the main methods. Users should
refer to this superclass for more information regarding those methods.`),Xt=u(),de=a("h2"),Te=a("a"),gt=a("span"),v(co.$$.fragment),Is=u(),_t=a("span"),Ds=i("BloomForCausalLM"),Zt=u(),j=a("div"),v(mo.$$.fragment),Ws=u(),bt=a("p"),Hs=i(`The Bloom Model transformer with a language modeling head on top (linear layer with weights tied to the input
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Xs=u(),V=a("div"),v(fo.$$.fragment),Zs=u(),ce=a("p"),ea=i("The "),Lo=a("a"),oa=i("BloomForCausalLM"),ta=i(" forward method, overrides the "),kt=a("code"),na=i("__call__"),sa=i(" special method."),aa=u(),v(Be.$$.fragment),ra=u(),v(Fe.$$.fragment),en=u(),me=a("h2"),Ce=a("a"),vt=a("span"),v(go.$$.fragment),la=u(),$t=a("span"),ia=i("BloomForSequenceClassification"),on=u(),E=a("div"),v(_o.$$.fragment),da=u(),yt=a("p"),ca=i("The Bloom Model transformer with a sequence classification head on top (linear layer)."),ma=u(),Io=a("p"),Do=a("a"),pa=i("BloomForSequenceClassification"),ha=i(` uses the last token in order to do the classification, as other causal models
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),xa=u(),M=a("div"),v($o.$$.fragment),ja=u(),pe=a("p"),Pa=i("The "),Ho=a("a"),Oa=i("BloomForSequenceClassification"),Sa=i(" forward method, overrides the "),Ct=a("code"),Aa=i("__call__"),Na=i(" special method."),La=u(),v(ze.$$.fragment),Ia=u(),v(Ee.$$.fragment),Da=u(),v(Me.$$.fragment),Wa=u(),v(qe.$$.fragment),Ha=u(),v(xe.$$.fragment),tn=u(),he=a("h2"),je=a("a"),zt=a("span"),v(yo.$$.fragment),Ua=u(),Et=a("span"),Va=i("BloomForTokenClassification"),nn=u(),P=a("div"),v(wo.$$.fragment),Ra=u(),Mt=a("p"),Ga=i(`Bloom Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g. for
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),tr=u(),S=a("div"),v(Co.$$.fragment),nr=u(),ue=a("p"),sr=i("The "),Vo=a("a"),ar=i("BloomForTokenClassification"),rr=i(" forward method, overrides the "),qt=a("code"),lr=i("__call__"),ir=i(" special method."),dr=u(),v(Pe.$$.fragment),cr=u(),v(Oe.$$.fragment),mr=u(),v(Se.$$.fragment),this.h()},l(o){const _=$l('[data-svelte="svelte-1phssyn"]',document.head);s=r(_,"META",{name:!0,content:!0}),_.forEach(t),g=f(o),c=r(o,"H1",{class:!0});var zo=l(c);m=r(zo,"A",{id:!0,class:!0,href:!0});var xt=l(m);b=r(xt,"SPAN",{});var jt=l(b);$(n.$$.fragment,jt),jt.forEach(t),xt.forEach(t),p=f(zo),C=r(zo,"SPAN",{});var Pt=l(C);te=d(Pt,"BLOOM"),Pt.forEach(t),zo.forEach(t),I=f(o),H=r(o,"H2",{class:!0});var Eo=l(H);R=r(Eo,"A",{id:!0,class:!0,href:!0});var Ot=l(R);Xo=r(Ot,"SPAN",{});var St=l(Xo);$(De.$$.fragment,St),St.forEach(t),Ot.forEach(t),wn=f(Eo),Zo=r(Eo,"SPAN",{});var At=l(Zo);Tn=d(At,"Overview"),At.forEach(t),Eo.forEach(t),Ut=f(o),fe=r(o,"P",{});var Mo=l(fe);Bn=d(Mo,"The BLOOM model has been proposed with its various versions through the "),We=r(Mo,"A",{href:!0,rel:!0});var Nt=l(We);Fn=d(Nt,"BigScience Workshop"),Nt.forEach(t),Cn=d(Mo,`. BigScience is inspired by other open science initiatives where researchers have pooled their time and resources to collectively achieve a higher impact.
The architecture of BLOOM is essentially similar to GPT3 (auto-regressive model for next token prediction), but has been trained on 46 different languages and 13 programming languages.
Several smaller versions of the models have been trained on the same dataset. BLOOM is available in the following versions:`),Mo.forEach(t),Vt=f(o),q=r(o,"UL",{});var O=l(q);et=r(O,"LI",{});var Lt=l(et);He=r(Lt,"A",{href:!0,rel:!0});var It=l(He);zn=d(It,"bloom-560m"),It.forEach(t),Lt.forEach(t),En=f(O),ot=r(O,"LI",{});var Dt=l(ot);Ue=r(Dt,"A",{href:!0,rel:!0});var Wt=l(Ue);Mn=d(Wt,"bloom-1b1"),Wt.forEach(t),Dt.forEach(t),qn=f(O),tt=r(O,"LI",{});var ur=l(tt);Ve=r(ur,"A",{href:!0,rel:!0});var fr=l(Ve);xn=d(fr,"bloom-1b7"),fr.forEach(t),ur.forEach(t),jn=f(O),nt=r(O,"LI",{});var gr=l(nt);Re=r(gr,"A",{href:!0,rel:!0});var _r=l(Re);Pn=d(_r,"bloom-3b"),_r.forEach(t),gr.forEach(t),On=f(O),st=r(O,"LI",{});var br=l(st);Ge=r(br,"A",{href:!0,rel:!0});var kr=l(Ge);Sn=d(kr,"bloom-7b1"),kr.forEach(t),br.forEach(t),An=f(O),qo=r(O,"LI",{});var pr=l(qo);Ye=r(pr,"A",{href:!0,rel:!0});var vr=l(Ye);Nn=d(vr,"bloom"),vr.forEach(t),Ln=d(pr," (176B parameters)"),pr.forEach(t),O.forEach(t),Rt=f(o),ne=r(o,"H2",{class:!0});var an=l(ne);ge=r(an,"A",{id:!0,class:!0,href:!0});var $r=l(ge);at=r($r,"SPAN",{});var yr=l(at);$(Je.$$.fragment,yr),yr.forEach(t),$r.forEach(t),In=f(an),rt=r(an,"SPAN",{});var wr=l(rt);Dn=d(wr,"BloomConfig"),wr.forEach(t),an.forEach(t),Gt=f(o),D=r(o,"DIV",{class:!0});var Ae=l(D);$(Ke.$$.fragment,Ae),Wn=f(Ae),se=r(Ae,"P",{});var Ro=l(se);Hn=d(Ro,"This is the configuration class to store the configuration of a "),xo=r(Ro,"A",{href:!0});var Tr=l(xo);Un=d(Tr,"BloomModel"),Tr.forEach(t),Vn=d(Ro,`. It is used to instantiate a Bloom
model according to the specified arguments, defining the model architecture. Instantiating a configuration with the
defaults will yield a similar configuration to the Bloom architecture
`),Qe=r(Ro,"A",{href:!0,rel:!0});var Br=l(Qe);Rn=d(Br,"bigscience/bloom"),Br.forEach(t),Gn=d(Ro,"."),Ro.forEach(t),Yn=f(Ae),ae=r(Ae,"P",{});var Go=l(ae);Jn=d(Go,"Configuration objects inherit from "),jo=r(Go,"A",{href:!0});var Fr=l(jo);Kn=d(Fr,"PretrainedConfig"),Fr.forEach(t),Qn=d(Go,` and can be used to control the model outputs. Read the
documentation from `),Po=r(Go,"A",{href:!0});var Cr=l(Po);Xn=d(Cr,"PretrainedConfig"),Cr.forEach(t),Zn=d(Go," for more information."),Go.forEach(t),es=f(Ae),$(_e.$$.fragment,Ae),Ae.forEach(t),Yt=f(o),re=r(o,"H2",{class:!0});var rn=l(re);be=r(rn,"A",{id:!0,class:!0,href:!0});var zr=l(be);lt=r(zr,"SPAN",{});var Er=l(lt);$(Xe.$$.fragment,Er),Er.forEach(t),zr.forEach(t),os=f(rn),it=r(rn,"SPAN",{});var Mr=l(it);ts=d(Mr,"BloomModel"),Mr.forEach(t),rn.forEach(t),Jt=f(o),x=r(o,"DIV",{class:!0});var G=l(x);$(Ze.$$.fragment,G),ns=f(G),dt=r(G,"P",{});var qr=l(dt);ss=d(qr,"The bare Bloom Model transformer outputting raw hidden-states without any specific head on top."),qr.forEach(t),as=f(G),eo=r(G,"P",{});var ln=l(eo);rs=d(ln,"This model inherits from "),Oo=r(ln,"A",{href:!0});var xr=l(Oo);ls=d(xr,"PreTrainedModel"),xr.forEach(t),is=d(ln,`. Check the superclass documentation for the generic methods the
...
no `),Tt=r(J,"CODE",{});var nl=l(Tt);ba=d(nl,"pad_token_id"),nl.forEach(t),ka=d(J,` is defined, it simply takes the last value in each row of the batch. Since it cannot guess the
padding tokens when `),Bt=r(J,"CODE",{});var sl=l(Bt);va=d(sl,"inputs_embeds"),sl.forEach(t),$a=d(J," are passed instead of "),Ft=r(J,"CODE",{});var al=l(Ft);ya=d(al,"input_ids"),al.forEach(t),wa=d(J,`, it does the same (take the last value in
each row of the batch).`),J.forEach(t),Ta=f(N),bo=r(N,"P",{});var bn=l(bo);Ba=d(bn,"This model inherits from "),Wo=r(bn,"A",{href:!0});var rl=l(Wo);Fa=d(rl,"PreTrainedModel"),rl.forEach(t),Ca=d(bn,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings etc.)`),bn.forEach(t),za=f(N),ko=r(N,"P",{});var kn=l(ko);Ea=d(kn,"This model is also a PyTorch "),vo=r(kn,"A",{href:!0,rel:!0});var ll=l(vo);Ma=d(ll,"torch.nn.Module"),ll.forEach(t),qa=d(kn,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),kn.forEach(t),xa=f(N),M=r(N,"DIV",{class:!0});var L=l(M);$($o.$$.fragment,L),ja=f(L),pe=r(L,"P",{});var Ko=l(pe);Pa=d(Ko,"The "),Ho=r(Ko,"A",{href:!0});var il=l(Ho);Oa=d(il,"BloomForSequenceClassification"),il.forEach(t),Sa=d(Ko," forward method, overrides the "),Ct=r(Ko,"CODE",{});var dl=l(Ct);Aa=d(dl,"__call__"),dl.forEach(t),Na=d(Ko," special method."),Ko.forEach(t),La=f(L),$(ze.$$.fragment,L),Ia=f(L),$(Ee.$$.fragment,L),Da=f(L),$(Me.$$.fragment,L),Wa=f(L),$(qe.$$.fragment,L),Ha=f(L),$(xe.$$.fragment,L),L.forEach(t),N.forEach(t),tn=f(o),he=r(o,"H2",{class:!0});var vn=l(he);je=r(vn,"A",{id:!0,class:!0,href:!0});var cl=l(je);zt=r(cl,"SPAN",{});var ml=l(zt);$(yo.$$.fragment,ml),ml.forEach(t),cl.forEach(t),Ua=f(vn),Et=r(vn,"SPAN",{});var pl=l(Et);Va=d(pl,"BloomForTokenClassification"),pl.forEach(t),vn.forEach(t),nn=f(o),P=r(o,"DIV",{class:!0});var K=l(P);$(wo.$$.fragment,K),Ra=f(K),Mt=r(K,"P",{});var hl=l(Mt);Ga=d(hl,`Bloom Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g. for
