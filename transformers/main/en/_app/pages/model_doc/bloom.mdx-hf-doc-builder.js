...
<span class="hljs-meta">&gt;&gt;&gt; </span>loss = model(**inputs, labels=labels).loss
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-built_in">round</span>(loss.item(), <span class="hljs-number">2</span>)
`}}),{c(){k(n.$$.fragment)},l(c){$(n.$$.fragment,c)},m(c,m){w(n,c,m),g=!0},p:ee,i(c){g||(y(n.$$.fragment,c),g=!0)},o(c){T(n.$$.fragment,c),g=!1},d(c){B(n,c)}}}function Ni(C){let n,g,c,m,b,s,p,F,te,O,H,R,Xo,De,ws,Zo,ys,Vt,fe,Ts,We,Bs,Cs,Ut,M,et,He,Fs,zs,ot,Ve,xs,qs,tt,Ue,Ms,Es,st,Re,js,Ps,nt,Ge,Ss,As,Mo,Ye,Is,Ns,Rt,se,ge,at,Je,Ls,rt,Os,Gt,D,Ke,Ds,ne,Ws,Eo,Hs,Vs,Qe,Us,Rs,Gs,ae,Ys,jo,Js,Ks,Po,Qs,Xs,Zs,_e,Yt,re,be,it,Xe,en,lt,on,Jt,E,Ze,tn,dt,sn,nn,eo,an,So,rn,ln,dn,oo,cn,to,mn,pn,hn,V,so,un,ie,fn,Ao,gn,_n,ct,bn,vn,kn,ve,$n,ke,Kt,le,$e,mt,no,wn,pt,yn,Qt,z,ao,Tn,ro,Bn,ht,Cn,Fn,zn,ut,xn,qn,we,Mn,io,En,ft,jn,Pn,Sn,ye,An,lo,In,Io,Nn,Ln,Xt,de,Te,gt,co,On,_t,Dn,Zt,j,mo,Wn,bt,Hn,Vn,po,Un,No,Rn,Gn,Yn,ho,Jn,uo,Kn,Qn,Xn,U,fo,Zn,ce,ea,Lo,oa,ta,vt,sa,na,aa,Be,ra,Ce,es,me,Fe,kt,go,ia,$t,la,os,x,_o,da,wt,ca,ma,Oo,Do,pa,ha,ua,W,fa,yt,ga,_a,Tt,ba,va,Bt,ka,$a,Ct,wa,ya,Ta,bo,Ba,Wo,Ca,Fa,za,vo,xa,ko,qa,Ma,Ea,q,$o,ja,pe,Pa,Ho,Sa,Aa,Ft,Ia,Na,La,ze,Oa,xe,Da,qe,Wa,Me,Ha,Ee,ts,he,je,zt,wo,Va,xt,Ua,ss,P,yo,Ra,qt,Ga,Ya,To,Ja,Vo,Ka,Qa,Xa,Bo,Za,Co,er,or,tr,A,Fo,sr,ue,nr,Uo,ar,rr,Mt,ir,lr,dr,Pe,cr,Se,mr,Ae,ns;return s=new Oe({}),De=new Oe({}),Je=new Oe({}),Ke=new X({props:{name:"class transformers.BloomConfig",anchor:"transformers.BloomConfig",parameters:[{name:"vocab_size",val:" = 250880"},{name:"hidden_size",val:" = 64"},{name:"n_layer",val:" = 2"},{name:"n_head",val:" = 8"},{name:"masked_softmax_fusion",val:" = True"},{name:"layer_norm_epsilon",val:" = 1e-05"},{name:"initializer_range",val:" = 0.02"},{name:"use_cache",val:" = False"},{name:"bos_token_id",val:" = 1"},{name:"eos_token_id",val:" = 2"},{name:"apply_residual_connection_post_layernorm",val:" = False"},{name:"hidden_dropout",val:" = 0.0"},{name:"attention_dropout",val:" = 0.0"},{name:"attention_softmax_in_fp32",val:" = True"},{name:"pretraining_tp",val:" = 1"},{name:"dtype",val:" = 'bfloat16'"},{name:"slow_but_exact",val:" = False"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.BloomConfig.vocab_size",description:`<strong>vocab_size</strong> (<code>int</code>, <em>optional</em>, defaults to 50257) &#x2014;
...
`}}),Pe=new Ht({props:{$$slots:{default:[Si]},$$scope:{ctx:C}}}),Se=new Z({props:{anchor:"transformers.BloomForTokenClassification.forward.example",$$slots:{default:[Ai]},$$scope:{ctx:C}}}),Ae=new Z({props:{anchor:"transformers.BloomForTokenClassification.forward.example-2",$$slots:{default:[Ii]},$$scope:{ctx:C}}}),{c(){n=a("meta"),g=u(),c=a("h1"),m=a("a"),b=a("span"),k(s.$$.fragment),p=u(),F=a("span"),te=l("BLOOM"),O=u(),H=a("h2"),R=a("a"),Xo=a("span"),k(De.$$.fragment),ws=u(),Zo=a("span"),ys=l("Overview"),Vt=u(),fe=a("p"),Ts=l("The BLOOM model has been proposed with its various versions through the "),We=a("a"),Bs=l("BigScience Workshop"),Cs=l(`. BigScience is inspired by other open science initiatives where researchers have pooled their time and resources to collectively achieve a higher impact.
...
Several smaller versions of the models have been trained on the same dataset. BLOOM is available in the following versions:`),Ut=u(),M=a("ul"),et=a("li"),He=a("a"),Fs=l("bloom-350m"),zs=u(),ot=a("li"),Ve=a("a"),xs=l("bloom-760m"),qs=u(),tt=a("li"),Ue=a("a"),Ms=l("bloom-1b3"),Es=u(),st=a("li"),Re=a("a"),js=l("bloom-2b5"),Ps=u(),nt=a("li"),Ge=a("a"),Ss=l("bloom-6b3"),As=u(),Mo=a("li"),Ye=a("a"),Is=l("bloom"),Ns=l(" (175B parameters)"),Rt=u(),se=a("h2"),ge=a("a"),at=a("span"),k(Je.$$.fragment),Ls=u(),rt=a("span"),Os=l("BloomConfig"),Gt=u(),D=a("div"),k(Ke.$$.fragment),Ds=u(),ne=a("p"),Ws=l("This is the configuration class to store the configuration of a "),Eo=a("a"),Hs=l("BloomModel"),Vs=l(`. It is used to instantiate a Bloom
model according to the specified arguments, defining the model architecture. Instantiating a configuration with the
defaults will yield a similar configuration to the Bloom architecture
`),Qe=a("a"),Us=l("bigscience/bloom"),Rs=l("."),Gs=u(),ae=a("p"),Ys=l("Configuration objects inherit from "),jo=a("a"),Js=l("PretrainedConfig"),Ks=l(` and can be used to control the model outputs. Read the
...
and behavior.`),hn=u(),V=a("div"),k(so.$$.fragment),un=u(),ie=a("p"),fn=l("The "),Ao=a("a"),gn=l("BloomModel"),_n=l(" forward method, overrides the "),ct=a("code"),bn=l("__call__"),vn=l(" special method."),kn=u(),k(ve.$$.fragment),$n=u(),k(ke.$$.fragment),Kt=u(),le=a("h2"),$e=a("a"),mt=a("span"),k(no.$$.fragment),wn=u(),pt=a("span"),yn=l("BloomTokenizerFast"),Qt=u(),z=a("div"),k(ao.$$.fragment),Tn=u(),ro=a("p"),Bn=l("Construct a \u201Cfast\u201D Bloom tokenizer (backed by HuggingFace\u2019s "),ht=a("em"),Cn=l("tokenizers"),Fn=l(` library). Based on byte-level
...
embeddings).`),Vn=u(),po=a("p"),Un=l("This model inherits from "),No=a("a"),Rn=l("PreTrainedModel"),Gn=l(`. Check the superclass documentation for the generic methods the
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Ea=u(),q=a("div"),k($o.$$.fragment),ja=u(),pe=a("p"),Pa=l("The "),Ho=a("a"),Sa=l("BloomForSequenceClassification"),Aa=l(" forward method, overrides the "),Ft=a("code"),Ia=l("__call__"),Na=l(" special method."),La=u(),k(ze.$$.fragment),Oa=u(),k(xe.$$.fragment),Da=u(),k(qe.$$.fragment),Wa=u(),k(Me.$$.fragment),Ha=u(),k(Ee.$$.fragment),ts=u(),he=a("h2"),je=a("a"),zt=a("span"),k(wo.$$.fragment),Va=u(),xt=a("span"),Ua=l("BloomForTokenClassification"),ss=u(),P=a("div"),k(yo.$$.fragment),Ra=u(),qt=a("p"),Ga=l(`Bloom Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g. for
Named-Entity-Recognition (NER) tasks.`),Ya=u(),To=a("p"),Ja=l("This model inherits from "),Vo=a("a"),Ka=l("PreTrainedModel"),Qa=l(`. Check the superclass documentation for the generic methods the
...
refer to this superclass for more information regarding those methods.`),ps.forEach(t),I.forEach(t),Xt=f(o),de=r(o,"H2",{class:!0});var hs=i(de);Te=r(hs,"A",{id:!0,class:!0,href:!0});var Hr=i(Te);gt=r(Hr,"SPAN",{});var Vr=i(gt);$(co.$$.fragment,Vr),Vr.forEach(t),Hr.forEach(t),On=f(hs),_t=r(hs,"SPAN",{});var Ur=i(_t);Dn=d(Ur,"BloomForCausalLM"),Ur.forEach(t),hs.forEach(t),Zt=f(o),j=r(o,"DIV",{class:!0});var Y=i(j);$(mo.$$.fragment,Y),Wn=f(Y),bt=r(Y,"P",{});var Rr=i(bt);Hn=d(Rr,`The Bloom Model transformer with a language modeling head on top (linear layer with weights tied to the input
embeddings).`),Rr.forEach(t),Vn=f(Y),po=r(Y,"P",{});var us=i(po);Un=d(us,"This model inherits from "),No=r(us,"A",{href:!0});var Gr=i(No);Rn=d(Gr,"PreTrainedModel"),Gr.forEach(t),Gn=d(us,`. Check the superclass documentation for the generic methods the
