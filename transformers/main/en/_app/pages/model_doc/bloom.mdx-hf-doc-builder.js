...
Several smaller versions of the models have been trained on the same dataset. BLOOM is available in the following versions:`),Vt=u(),M=a("ul"),et=a("li"),He=a("a"),Cs=l("bloom-350m"),zs=u(),ot=a("li"),Ue=a("a"),qs=l("bloom-760m"),xs=u(),tt=a("li"),Ve=a("a"),Ms=l("bloom-1b3"),Es=u(),st=a("li"),Re=a("a"),js=l("bloom-2b5"),Ps=u(),nt=a("li"),Ge=a("a"),Ss=l("bloom-6b3"),As=u(),Mo=a("li"),Ye=a("a"),Ns=l("bloom"),Is=l(" (176B parameters)"),Rt=u(),se=a("h2"),ge=a("a"),at=a("span"),v(Je.$$.fragment),Ls=u(),rt=a("span"),Os=l("BloomConfig"),Gt=u(),D=a("div"),v(Ke.$$.fragment),Ds=u(),ne=a("p"),Ws=l("This is the configuration class to store the configuration of a "),Eo=a("a"),Hs=l("BloomModel"),Us=l(`. It is used to instantiate a Bloom
