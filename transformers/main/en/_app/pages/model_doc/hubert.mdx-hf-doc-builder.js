import{S as yi,i as Ti,s as wi,e as a,k as u,w as T,t as s,M as ki,c as r,d as t,m as h,a as i,x as w,h as n,b as f,G as e,g,y as k,q as $,o as C,B as H,v as $i,L as xt}from"../../chunks/vendor-hf-doc-builder.js";import{T as yo}from"../../chunks/Tip-hf-doc-builder.js";import{D as Oe}from"../../chunks/Docstring-hf-doc-builder.js";import{C as qt}from"../../chunks/CodeBlock-hf-doc-builder.js";import{I as jt}from"../../chunks/IconCopyLink-hf-doc-builder.js";import{E as Ft}from"../../chunks/ExampleCodeBlock-hf-doc-builder.js";function Ci(j){let d,v,c,p,b;return p=new qt({props:{code:`from transformers import HubertModel, HubertConfig
...
<span class="hljs-meta">&gt;&gt;&gt; </span>configuration = model.config`}}),{c(){d=a("p"),v=s("Example:"),c=u(),T(p.$$.fragment)},l(l){d=r(l,"P",{});var m=i(d);v=n(m,"Example:"),m.forEach(t),c=h(l),w(p.$$.fragment,l)},m(l,m){g(l,d,m),e(d,v),g(l,c,m),k(p,l,m),b=!0},p:xt,i(l){b||($(p.$$.fragment,l),b=!0)},o(l){C(p.$$.fragment,l),b=!1},d(l){l&&t(d),l&&t(c),H(p,l)}}}function Hi(j){let d,v,c,p,b;return{c(){d=a("p"),v=s("Although the recipe for forward pass needs to be defined within this function, one should call the "),c=a("code"),p=s("Module"),b=s(`
...
<span class="hljs-meta">&gt;&gt;&gt; </span>loss = model(**inputs).loss
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-built_in">round</span>(loss.item(), <span class="hljs-number">2</span>)
<span class="hljs-number">8.53</span>`}}),{c(){T(d.$$.fragment)},l(c){w(d.$$.fragment,c)},m(c,p){k(d,c,p),v=!0},p:xt,i(c){v||($(d.$$.fragment,c),v=!0)},o(c){C(d.$$.fragment,c),v=!1},d(c){H(d,c)}}}function Si(j){let d,v,c,p,b,l,m,F,Ee,ie,x,K,A,X,je,L,Fe,be,D,I,J,me,q,P,le,Q,ve,de,W,xe,ye,M,qe,Y,G,fe,Z,Me,ee,N,ce,te,Pe;return{c(){d=a("p"),v=s("TF 2.0 models accepts two formats as inputs:"),c=u(),p=a("ul"),b=a("li"),l=s("having all inputs as keyword arguments (like PyTorch models), or"),m=u(),F=a("li"),Ee=s("having all inputs as a list, tuple or dict in the first positional arguments."),ie=u(),x=a("p"),K=s("This second option is useful when using "),A=a("code"),X=s("tf.keras.Model.fit"),je=s(` method which currently requires having all the
...
`),te=a("code"),Pe=s('model({"input_values": input_values, "token_type_ids": token_type_ids})')},l(y){d=r(y,"P",{});var E=i(d);v=n(E,"TF 2.0 models accepts two formats as inputs:"),E.forEach(t),c=h(y),p=r(y,"UL",{});var ge=i(p);b=r(ge,"LI",{});var _e=i(b);l=n(_e,"having all inputs as keyword arguments (like PyTorch models), or"),_e.forEach(t),m=h(ge),F=r(ge,"LI",{});var Ne=i(F);Ee=n(Ne,"having all inputs as a list, tuple or dict in the first positional arguments."),Ne.forEach(t),ge.forEach(t),ie=h(y),x=r(y,"P",{});var B=i(x);K=n(B,"This second option is useful when using "),A=r(B,"CODE",{});var ze=i(A);X=n(ze,"tf.keras.Model.fit"),ze.forEach(t),je=n(B,` method which currently requires having all the
...
<span class="hljs-meta">&gt;&gt;&gt; </span>loss = model(input_values, labels=labels).loss`}}),{c(){d=a("p"),v=s("Example:"),c=u(),T(p.$$.fragment)},l(l){d=r(l,"P",{});var m=i(d);v=n(m,"Example:"),m.forEach(t),c=h(l),w(p.$$.fragment,l)},m(l,m){g(l,d,m),e(d,v),g(l,c,m),k(p,l,m),b=!0},p:xt,i(l){b||($(p.$$.fragment,l),b=!0)},o(l){C(p.$$.fragment,l),b=!1},d(l){l&&t(d),l&&t(c),H(p,l)}}}function Ii(j){let d,v,c,p,b,l,m,F,Ee,ie,x,K,A,X,je,L,Fe,be,D,I,J,me,q,P,le,Q,ve,de,W,xe,ye,M,qe,Y,G,fe,Z,Me,ee,N,ce,te,Pe,y,E,ge,_e,Ne,B,ze,oe,pe,S,O,Be,Se,se,De,z,ne,Re,Ve,Xs,To,Js,Qs,Mt,Zs,en,tn,Ue,on,wo,sn,nn,ko,an,rn,ln,nt,bs,Ke,at,No,Pt,dn,Bo,cn,vs,ae,St,pn,Ot,un,zt,hn,mn,fn,Dt,gn,$o,_n,bn,vn,At,yn,Lt,Tn,wn,kn,Te,It,$n,Ye,Cn,Co,Hn,En,Ro,jn,Fn,xn,rt,qn,it,ys,Ge,lt,Vo,Wt,Mn,Uo,Pn,Ts,re,Nt,Sn,Xe,On,Ko,zn,Dn,Bt,An,Ln,In,Rt,Wn,Ho,Nn,Bn,Rn,Vt,Vn,Ut,Un,Kn,Yn,ue,Kt,Gn,Je,Xn,Eo,Jn,Qn,Yo,Zn,ea,ta,dt,oa,ct,sa,pt,ws,Qe,ut,Go,Yt,na,Xo,aa,ks,R,Gt,ra,Jo,ia,la,Xt,da,Jt,ca,pa,ua,Qt,ha,jo,ma,fa,ga,Zt,_a,eo,ba,va,ya,he,to,Ta,Ze,wa,Fo,ka,$a,Qo,Ca,Ha,Ea,ht,ja,mt,Fa,ft,$s,et,gt,Zo,oo,xa,es,qa,Cs,V,so,Ma,ts,Pa,Sa,no,Oa,xo,za,Da,Aa,ao,La,ro,Ia,Wa,Na,_t,Ba,we,io,Ra,tt,Va,qo,Ua,Ka,os,Ya,Ga,Xa,bt,Ja,vt,Hs,ot,yt,ss,lo,Qa,ns,Za,Es,U,co,er,po,tr,as,or,sr,nr,uo,ar,Mo,rr,ir,lr,ho,dr,mo,cr,pr,ur,Tt,hr,ke,fo,mr,st,fr,Po,gr,_r,rs,br,vr,yr,wt,Tr,kt,js;return l=new jt({}),X=new jt({}),O=new jt({}),ne=new Oe({props:{name:"class transformers.HubertConfig",anchor:"transformers.HubertConfig",parameters:[{name:"vocab_size",val:" = 32"},{name:"hidden_size",val:" = 768"},{name:"num_hidden_layers",val:" = 12"},{name:"num_attention_heads",val:" = 12"},{name:"intermediate_size",val:" = 3072"},{name:"hidden_act",val:" = 'gelu'"},{name:"hidden_dropout",val:" = 0.1"},{name:"activation_dropout",val:" = 0.1"},{name:"attention_dropout",val:" = 0.1"},{name:"feat_proj_layer_norm",val:" = True"},{name:"feat_proj_dropout",val:" = 0.0"},{name:"final_dropout",val:" = 0.1"},{name:"layerdrop",val:" = 0.1"},{name:"initializer_range",val:" = 0.02"},{name:"layer_norm_eps",val:" = 1e-05"},{name:"feat_extract_norm",val:" = 'group'"},{name:"feat_extract_activation",val:" = 'gelu'"},{name:"conv_dim",val:" = (512, 512, 512, 512, 512, 512, 512)"},{name:"conv_stride",val:" = (5, 2, 2, 2, 2, 2, 2)"},{name:"conv_kernel",val:" = (10, 3, 3, 3, 3, 2, 2)"},{name:"conv_bias",val:" = False"},{name:"num_conv_pos_embeddings",val:" = 128"},{name:"num_conv_pos_embedding_groups",val:" = 16"},{name:"do_stable_layer_norm",val:" = False"},{name:"apply_spec_augment",val:" = True"},{name:"mask_time_prob",val:" = 0.05"},{name:"mask_time_length",val:" = 10"},{name:"mask_time_min_masks",val:" = 2"},{name:"mask_feature_prob",val:" = 0.0"},{name:"mask_feature_length",val:" = 10"},{name:"mask_feature_min_masks",val:" = 0"},{name:"ctc_loss_reduction",val:" = 'sum'"},{name:"ctc_zero_infinity",val:" = False"},{name:"use_weighted_layer_sum",val:" = False"},{name:"classifier_proj_size",val:" = 256"},{name:"pad_token_id",val:" = 0"},{name:"bos_token_id",val:" = 1"},{name:"eos_token_id",val:" = 2"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.HubertConfig.vocab_size",description:`<strong>vocab_size</strong> (<code>int</code>, <em>optional</em>, defaults to 32) &#x2014;
...
`}}),ht=new yo({props:{$$slots:{default:[qi]},$$scope:{ctx:j}}}),mt=new Ft({props:{anchor:"transformers.HubertForSequenceClassification.forward.example",$$slots:{default:[Mi]},$$scope:{ctx:j}}}),ft=new Ft({props:{anchor:"transformers.HubertForSequenceClassification.forward.example-2",$$slots:{default:[Pi]},$$scope:{ctx:j}}}),oo=new jt({}),so=new Oe({props:{name:"class transformers.TFHubertModel",anchor:"transformers.TFHubertModel",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.TFHubertModel.config",description:`<strong>config</strong> (<a href="/docs/transformers/main/en/model_doc/hubert#transformers.HubertConfig">HubertConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
...
using `),ce=a("a"),te=s("Wav2Vec2CTCTokenizer"),Pe=s("."),y=u(),E=a("p"),ge=s("This model was contributed by "),_e=a("a"),Ne=s("patrickvonplaten"),B=s("."),ze=u(),oe=a("h2"),pe=a("a"),S=a("span"),T(O.$$.fragment),Be=u(),Se=a("span"),se=s("HubertConfig"),De=u(),z=a("div"),T(ne.$$.fragment),Re=u(),Ve=a("p"),Xs=s("This is the configuration class to store the configuration of a "),To=a("a"),Js=s("HubertModel"),Qs=s(`. It is used to instantiate an
...
`),Mt=a("a"),Zs=s("facebook/hubert-base-ls960"),en=s(" architecture."),tn=u(),Ue=a("p"),on=s("Configuration objects inherit from "),wo=a("a"),sn=s("PretrainedConfig"),nn=s(` and can be used to control the model outputs. Read the
documentation from `),ko=a("a"),an=s("PretrainedConfig"),rn=s(" for more information."),ln=u(),T(nt.$$.fragment),bs=u(),Ke=a("h2"),at=a("a"),No=a("span"),T(Pt.$$.fragment),dn=u(),Bo=a("span"),cn=s("HubertModel"),vs=u(),ae=a("div"),T(St.$$.fragment),pn=u(),Ot=a("p"),un=s(`The bare Hubert Model transformer outputting raw hidden-states without any specific head on top.
...
library implements for all its model (such as downloading or saving etc.).`),vn=u(),At=a("p"),yn=s("This model is a PyTorch "),Lt=a("a"),Tn=s("torch.nn.Module"),wn=s(` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),kn=u(),Te=a("div"),T(It.$$.fragment),$n=u(),Ye=a("p"),Cn=s("The "),Co=a("a"),Hn=s("HubertModel"),En=s(" forward method, overrides the "),Ro=a("code"),jn=s("__call__"),Fn=s(" special method."),xn=u(),T(rt.$$.fragment),qn=u(),T(it.$$.fragment),ys=u(),Ge=a("h2"),lt=a("a"),Vo=a("span"),T(Wt.$$.fragment),Mn=u(),Uo=a("span"),Pn=s("HubertForCTC"),Ts=u(),re=a("div"),T(Nt.$$.fragment),Sn=u(),Xe=a("p"),On=s("Hubert Model with a "),Ko=a("code"),zn=s("language modeling"),Dn=s(` head on top for Connectionist Temporal Classification (CTC).
...
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),Yn=u(),ue=a("div"),T(Kt.$$.fragment),Gn=u(),Je=a("p"),Xn=s("The "),Eo=a("a"),Jn=s("HubertForCTC"),Qn=s(" forward method, overrides the "),Yo=a("code"),Zn=s("__call__"),ea=s(" special method."),ta=u(),T(dt.$$.fragment),oa=u(),T(ct.$$.fragment),sa=u(),T(pt.$$.fragment),ws=u(),Qe=a("h2"),ut=a("a"),Go=a("span"),T(Yt.$$.fragment),na=u(),Xo=a("span"),aa=s("HubertForSequenceClassification"),ks=u(),R=a("div"),T(Gt.$$.fragment),ra=u(),Jo=a("p"),ia=s(`Hubert Model with a sequence classification head on top (a linear layer over the pooled output) for tasks like
...
Ruslan Salakhutdinov, Abdelrahman Mohamed.`),ua=u(),Qt=a("p"),ha=s("This model inherits from "),jo=a("a"),ma=s("PreTrainedModel"),fa=s(`. Check the superclass documentation for the generic methods the
...
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),ya=u(),he=a("div"),T(to.$$.fragment),Ta=u(),Ze=a("p"),wa=s("The "),Fo=a("a"),ka=s("HubertForSequenceClassification"),$a=s(" forward method, overrides the "),Qo=a("code"),Ca=s("__call__"),Ha=s(" special method."),Ea=u(),T(ht.$$.fragment),ja=u(),T(mt.$$.fragment),Fa=u(),T(ft.$$.fragment),$s=u(),et=a("h2"),gt=a("a"),Zo=a("span"),T(oo.$$.fragment),xa=u(),es=a("span"),qa=s("TFHubertModel"),Cs=u(),V=a("div"),T(so.$$.fragment),Ma=u(),ts=a("p"),Pa=s("The bare TFHubert Model transformer outputing raw hidden-states without any specific head on top."),Sa=u(),no=a("p"),Oa=s("This model inherits from "),xo=a("a"),za=s("TFPreTrainedModel"),Da=s(`. Check the superclass documentation for the generic methods the
...
behavior.`),Na=u(),T(_t.$$.fragment),Ba=u(),we=a("div"),T(io.$$.fragment),Ra=u(),tt=a("p"),Va=s("The "),qo=a("a"),Ua=s("TFHubertModel"),Ka=s(" forward method, overrides the "),os=a("code"),Ya=s("__call__"),Ga=s(" special method."),Xa=u(),T(bt.$$.fragment),Ja=u(),T(vt.$$.fragment),Hs=u(),ot=a("h2"),yt=a("a"),ss=a("span"),T(lo.$$.fragment),Qa=u(),ns=a("span"),Za=s("TFHubertForCTC"),Es=u(),U=a("div"),T(co.$$.fragment),er=u(),po=a("p"),tr=s("TFHubert Model with a "),as=a("code"),or=s("language modeling"),sr=s(" head on top for Connectionist Temporal Classification (CTC)."),nr=u(),uo=a("p"),ar=s("This model inherits from "),Mo=a("a"),rr=s("TFPreTrainedModel"),ir=s(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),lr=u(),ho=a("p"),dr=s("This model is also a "),mo=a("a"),cr=s("tf.keras.Model"),pr=s(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),ur=u(),T(Tt.$$.fragment),hr=u(),ke=a("div"),T(fo.$$.fragment),mr=u(),st=a("p"),fr=s("The "),Po=a("a"),gr=s("TFHubertForCTC"),_r=s(" forward method, overrides the "),rs=a("code"),br=s("__call__"),vr=s(" special method."),yr=u(),T(wt.$$.fragment),Tr=u(),T(kt.$$.fragment),this.h()},l(o){const _=ki('[data-svelte="svelte-1phssyn"]',document.head);d=r(_,"META",{name:!0,content:!0}),_.forEach(t),v=h(o),c=r(o,"H1",{class:!0});var go=i(c);p=r(go,"A",{id:!0,class:!0,href:!0});var is=i(p);b=r(is,"SPAN",{});var ls=i(b);w(l.$$.fragment,ls),ls.forEach(t),is.forEach(t),m=h(go),F=r(go,"SPAN",{});var ds=i(F);Ee=n(ds,"Hubert"),ds.forEach(t),go.forEach(t),ie=h(o),x=r(o,"H2",{class:!0});var _o=i(x);K=r(_o,"A",{id:!0,class:!0,href:!0});var cs=i(K);A=r(cs,"SPAN",{});var ps=i(A);w(X.$$.fragment,ps),ps.forEach(t),cs.forEach(t),je=h(_o),L=r(_o,"SPAN",{});var us=i(L);Fe=n(us,"Overview"),us.forEach(t),_o.forEach(t),be=h(o),D=r(o,"P",{});var bo=i(D);I=n(bo,"Hubert was proposed in "),J=r(bo,"A",{href:!0,rel:!0});var hs=i(J);me=n(hs,"HuBERT: Self-Supervised Speech Representation Learning by Masked Prediction of Hidden Units"),hs.forEach(t),q=n(bo,` by Wei-Ning Hsu, Benjamin Bolte, Yao-Hung Hubert Tsai, Kushal Lakhotia, Ruslan
...
state-of-the-art wav2vec 2.0 performance on the Librispeech (960h) and Libri-light (60,000h) benchmarks with 10min, 1h,
10h, 100h, and 960h fine-tuning subsets. Using a 1B parameter model, HuBERT shows up to 19% and 13% relative WER
reduction on the more challenging dev-other and test-other evaluation subsets.`),gs.forEach(t),fs.forEach(t),ye=h(o),M=r(o,"P",{});var _s=i(M);qe=n(_s,"Tips:"),_s.forEach(t),Y=h(o),G=r(o,"UL",{});var vo=i(G);fe=r(vo,"LI",{});var wr=i(fe);Z=n(wr,"Hubert is a speech model that accepts a float array corresponding to the raw waveform of the speech signal."),wr.forEach(t),Me=h(vo),ee=r(vo,"LI",{});var Fs=i(ee);N=n(Fs,`Hubert model was fine-tuned using connectionist temporal classification (CTC) so the model output has to be decoded
using `),ce=r(Fs,"A",{href:!0});var kr=i(ce);te=n(kr,"Wav2Vec2CTCTokenizer"),kr.forEach(t),Pe=n(Fs,"."),Fs.forEach(t),vo.forEach(t),y=h(o),E=r(o,"P",{});var xs=i(E);ge=n(xs,"This model was contributed by "),_e=r(xs,"A",{href:!0,rel:!0});var $r=i(_e);Ne=n($r,"patrickvonplaten"),$r.forEach(t),B=n(xs,"."),xs.forEach(t),ze=h(o),oe=r(o,"H2",{class:!0});var qs=i(oe);pe=r(qs,"A",{id:!0,class:!0,href:!0});var Cr=i(pe);S=r(Cr,"SPAN",{});var Hr=i(S);w(O.$$.fragment,Hr),Hr.forEach(t),Cr.forEach(t),Be=h(qs),Se=r(qs,"SPAN",{});var Er=i(Se);se=n(Er,"HubertConfig"),Er.forEach(t),qs.forEach(t),De=h(o),z=r(o,"DIV",{class:!0});var $t=i(z);w(ne.$$.fragment,$t),Re=h($t),Ve=r($t,"P",{});var So=i(Ve);Xs=n(So,"This is the configuration class to store the configuration of a "),To=r(So,"A",{href:!0});var jr=i(To);Js=n(jr,"HubertModel"),jr.forEach(t),Qs=n(So,`. It is used to instantiate an
Hubert model according to the specified arguments, defining the model architecture. Instantiating a configuration
with the defaults will yield a similar configuration to that of the Hubert
`),Mt=r(So,"A",{href:!0,rel:!0});var Fr=i(Mt);Zs=n(Fr,"facebook/hubert-base-ls960"),Fr.forEach(t),en=n(So," architecture."),So.forEach(t),tn=h($t),Ue=r($t,"P",{});var Oo=i(Ue);on=n(Oo,"Configuration objects inherit from "),wo=r(Oo,"A",{href:!0});var xr=i(wo);sn=n(xr,"PretrainedConfig"),xr.forEach(t),nn=n(Oo,` and can be used to control the model outputs. Read the
documentation from `),ko=r(Oo,"A",{href:!0});var qr=i(ko);an=n(qr,"PretrainedConfig"),qr.forEach(t),rn=n(Oo," for more information."),Oo.forEach(t),ln=h($t),w(nt.$$.fragment,$t),$t.forEach(t),bs=h(o),Ke=r(o,"H2",{class:!0});var Ms=i(Ke);at=r(Ms,"A",{id:!0,class:!0,href:!0});var Mr=i(at);No=r(Mr,"SPAN",{});var Pr=i(No);w(Pt.$$.fragment,Pr),Pr.forEach(t),Mr.forEach(t),dn=h(Ms),Bo=r(Ms,"SPAN",{});var Sr=i(Bo);cn=n(Sr,"HubertModel"),Sr.forEach(t),Ms.forEach(t),vs=h(o),ae=r(o,"DIV",{class:!0});var Ae=i(ae);w(St.$$.fragment,Ae),pn=h(Ae),Ot=r(Ae,"P",{});var Ps=i(Ot);un=n(Ps,`The bare Hubert Model transformer outputting raw hidden-states without any specific head on top.
...
library implements for all its model (such as downloading or saving etc.).`),Ss.forEach(t),vn=h(Ae),At=r(Ae,"P",{});var Os=i(At);yn=n(Os,"This model is a PyTorch "),Lt=r(Os,"A",{href:!0,rel:!0});var Dr=i(Lt);Tn=n(Dr,"torch.nn.Module"),Dr.forEach(t),wn=n(Os,` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),Os.forEach(t),kn=h(Ae),Te=r(Ae,"DIV",{class:!0});var Ct=i(Te);w(It.$$.fragment,Ct),$n=h(Ct),Ye=r(Ct,"P",{});var zo=i(Ye);Cn=n(zo,"The "),Co=r(zo,"A",{href:!0});var Ar=i(Co);Hn=n(Ar,"HubertModel"),Ar.forEach(t),En=n(zo," forward method, overrides the "),Ro=r(zo,"CODE",{});var Lr=i(Ro);jn=n(Lr,"__call__"),Lr.forEach(t),Fn=n(zo," special method."),zo.forEach(t),xn=h(Ct),w(rt.$$.fragment,Ct),qn=h(Ct),w(it.$$.fragment,Ct),Ct.forEach(t),Ae.forEach(t),ys=h(o),Ge=r(o,"H2",{class:!0});var zs=i(Ge);lt=r(zs,"A",{id:!0,class:!0,href:!0});var Ir=i(lt);Vo=r(Ir,"SPAN",{});var Wr=i(Vo);w(Wt.$$.fragment,Wr),Wr.forEach(t),Ir.forEach(t),Mn=h(zs),Uo=r(zs,"SPAN",{});var Nr=i(Uo);Pn=n(Nr,"HubertForCTC"),Nr.forEach(t),zs.forEach(t),Ts=h(o),re=r(o,"DIV",{class:!0});var Le=i(re);w(Nt.$$.fragment,Le),Sn=h(Le),Xe=r(Le,"P",{});var Do=i(Xe);On=n(Do,"Hubert Model with a "),Ko=r(Do,"CODE",{});var Br=i(Ko);zn=n(Br,"language modeling"),Br.forEach(t),Dn=n(Do,` head on top for Connectionist Temporal Classification (CTC).
...
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),As.forEach(t),Yn=h(Le),ue=r(Le,"DIV",{class:!0});var Ie=i(ue);w(Kt.$$.fragment,Ie),Gn=h(Ie),Je=r(Ie,"P",{});var Ao=i(Je);Xn=n(Ao,"The "),Eo=r(Ao,"A",{href:!0});var Kr=i(Eo);Jn=n(Kr,"HubertForCTC"),Kr.forEach(t),Qn=n(Ao," forward method, overrides the "),Yo=r(Ao,"CODE",{});var Yr=i(Yo);Zn=n(Yr,"__call__"),Yr.forEach(t),ea=n(Ao," special method."),Ao.forEach(t),ta=h(Ie),w(dt.$$.fragment,Ie),oa=h(Ie),w(ct.$$.fragment,Ie),sa=h(Ie),w(pt.$$.fragment,Ie),Ie.forEach(t),Le.forEach(t),ws=h(o),Qe=r(o,"H2",{class:!0});var Ls=i(Qe);ut=r(Ls,"A",{id:!0,class:!0,href:!0});var Gr=i(ut);Go=r(Gr,"SPAN",{});var Xr=i(Go);w(Yt.$$.fragment,Xr),Xr.forEach(t),Gr.forEach(t),na=h(Ls),Xo=r(Ls,"SPAN",{});var Jr=i(Xo);aa=n(Jr,"HubertForSequenceClassification"),Jr.forEach(t),Ls.forEach(t),ks=h(o),R=r(o,"DIV",{class:!0});var $e=i(R);w(Gt.$$.fragment,$e),ra=h($e),Jo=r($e,"P",{});var Qr=i(Jo);ia=n(Qr,`Hubert Model with a sequence classification head on top (a linear layer over the pooled output) for tasks like
...
Ruslan Salakhutdinov, Abdelrahman Mohamed.`),Is.forEach(t),ua=h($e),Qt=r($e,"P",{});var Ws=i(Qt);ha=n(Ws,"This model inherits from "),jo=r(Ws,"A",{href:!0});var ei=i(jo);ma=n(ei,"PreTrainedModel"),ei.forEach(t),fa=n(Ws,`. Check the superclass documentation for the generic methods the
...
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),Ns.forEach(t),ya=h($e),he=r($e,"DIV",{class:!0});var We=i(he);w(to.$$.fragment,We),Ta=h(We),Ze=r(We,"P",{});var Lo=i(Ze);wa=n(Lo,"The "),Fo=r(Lo,"A",{href:!0});var oi=i(Fo);ka=n(oi,"HubertForSequenceClassification"),oi.forEach(t),$a=n(Lo," forward method, overrides the "),Qo=r(Lo,"CODE",{});var si=i(Qo);Ca=n(si,"__call__"),si.forEach(t),Ha=n(Lo," special method."),Lo.forEach(t),Ea=h(We),w(ht.$$.fragment,We),ja=h(We),w(mt.$$.fragment,We),Fa=h(We),w(ft.$$.fragment,We),We.forEach(t),$e.forEach(t),$s=h(o),et=r(o,"H2",{class:!0});var Bs=i(et);gt=r(Bs,"A",{id:!0,class:!0,href:!0});var ni=i(gt);Zo=r(ni,"SPAN",{});var ai=i(Zo);w(oo.$$.fragment,ai),ai.forEach(t),ni.forEach(t),xa=h(Bs),es=r(Bs,"SPAN",{});var ri=i(es);qa=n(ri,"TFHubertModel"),ri.forEach(t),Bs.forEach(t),Cs=h(o),V=r(o,"DIV",{class:!0});var Ce=i(V);w(so.$$.fragment,Ce),Ma=h(Ce),ts=r(Ce,"P",{});var ii=i(ts);Pa=n(ii,"The bare TFHubert Model transformer outputing raw hidden-states without any specific head on top."),ii.forEach(t),Sa=h(Ce),no=r(Ce,"P",{});var Rs=i(no);Oa=n(Rs,"This model inherits from "),xo=r(Rs,"A",{href:!0});var li=i(xo);za=n(li,"TFPreTrainedModel"),li.forEach(t),Da=n(Rs,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
