...
<span class="hljs-literal">True</span>`}}),{c(){p=n("p"),k=r("Example:"),f=i(),v(u.$$.fragment)},l(l){p=a(l,"P",{});var h=s(p);k=d(h,"Example:"),h.forEach(o),f=c(l),T(u.$$.fragment,l)},m(l,h){_(l,p,h),e(p,k),_(l,f,h),w(u,l,h),b=!0},p:uo,i(l){b||(S(u.$$.fragment,l),b=!0)},o(l){$(u.$$.fragment,l),b=!1},d(l){l&&o(p),l&&o(f),x(u,l)}}}function ku(z){let p,k,f,u,b,l,h,q,Ae,Me,C,De,re,B,Ge,Y,Ue,We,K,Re,Ke,Z,He,Qe,ee,Ve,Ce,G,de,we,te,P,I,Je,le,ie,Xe,H,Ye,Ze,A,ke,he,je,ye,ne,eo,Oe,N,oo,Q,to,Se,L,no,V,Pe,ae;return{c(){p=n("p"),k=r("TensorFlow models and layers in "),f=n("code"),u=r("transformers"),b=r(" accept two formats as input:"),l=i(),h=n("ul"),q=n("li"),Ae=r("having all inputs as keyword arguments (like PyTorch models), or"),Me=i(),C=n("li"),De=r("having all inputs as a list, tuple or dict in the first positional argument."),re=i(),B=n("p"),Ge=r(`The reason the second format is supported is that Keras methods prefer this format when passing inputs to models
...
format outside of Keras methods like `),Z=a(E,"CODE",{});var go=s(Z);He=d(go,"fit()"),go.forEach(o),Qe=d(E," and "),ee=a(E,"CODE",{});var ue=s(ee);Ve=d(ue,"predict()"),ue.forEach(o),Ce=d(E,`, such as when creating your own layers or models with
...
`),Q=a(se,"CODE",{});var To=s(Q);to=d(To,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),To.forEach(o),se.forEach(o),R.forEach(o),Se=c(y),L=a(y,"P",{});var ce=s(L);no=d(ce,`Note that when creating models and layers with
`),V=a(ce,"A",{href:!0,rel:!0});var wo=s(V);Pe=d(wo,"subclassing"),wo.forEach(o),ae=d(ce,` then you don\u2019t need to worry
about any of this, as you can just pass inputs like you would to any other Python function!`),ce.forEach(o),this.h()},h(){m(V,"href","https://keras.io/guides/making_new_layers_and_models_via_subclassing/"),m(V,"rel","nofollow")},m(y,F){_(y,p,F),e(p,k),e(p,f),e(f,u),e(p,b),_(y,l,F),_(y,h,F),e(h,q),e(q,Ae),e(h,Me),e(h,C),e(C,De),_(y,re,F),_(y,B,F),e(B,Ge),e(B,Y),e(Y,Ue),e(B,We),e(B,K),e(K,Re),e(B,Ke),e(B,Z),e(Z,He),e(B,Qe),e(B,ee),e(ee,Ve),e(B,Ce),e(B,G),e(G,de),e(B,we),_(y,te,F),_(y,P,F),e(P,I),e(I,Je),e(I,le),e(le,ie),e(I,Xe),e(I,H),e(H,Ye),e(P,Ze),e(P,A),e(A,ke),e(A,he),e(he,je),e(A,ye),e(A,ne),e(ne,eo),e(P,Oe),e(P,N),e(N,oo),e(N,Q),e(Q,to),_(y,Se,F),_(y,L,F),e(L,no),e(L,V),e(V,Pe),e(L,ae)},d(y){y&&o(p),y&&o(l),y&&o(h),y&&o(re),y&&o(B),y&&o(te),y&&o(P),y&&o(Se),y&&o(L)}}}function yu(z){let p,k,f,u,b;return{c(){p=n("p"),k=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=n("code"),u=r("Module"),b=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(l){p=a(l,"P",{});var h=s(p);k=d(h,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=a(h,"CODE",{});var q=s(f);u=d(q,"Module"),q.forEach(o),b=d(h,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),{c(){p=n("p"),k=r("Example:"),f=i(),v(u.$$.fragment)},l(l){p=a(l,"P",{});var h=s(p);k=d(h,"Example:"),h.forEach(o),f=c(l),T(u.$$.fragment,l)},m(l,h){_(l,p,h),e(p,k),_(l,f,h),w(u,l,h),b=!0},p:uo,i(l){b||(S(u.$$.fragment,l),b=!0)},o(l){$(u.$$.fragment,l),b=!1},d(l){l&&o(p),l&&o(f),x(u,l)}}}function Tu(z){let p,k,f,u,b,l,h,q,Ae,Me,C,De,re,B,Ge,Y,Ue,We,K,Re,Ke,Z,He,Qe,ee,Ve,Ce,G,de,we,te,P,I,Je,le,ie,Xe,H,Ye,Ze,A,ke,he,je,ye,ne,eo,Oe,N,oo,Q,to,Se,L,no,V,Pe,ae;return{c(){p=n("p"),k=r("TensorFlow models and layers in "),f=n("code"),u=r("transformers"),b=r(" accept two formats as input:"),l=i(),h=n("ul"),q=n("li"),Ae=r("having all inputs as keyword arguments (like PyTorch models), or"),Me=i(),C=n("li"),De=r("having all inputs as a list, tuple or dict in the first positional argument."),re=i(),B=n("p"),Ge=r(`The reason the second format is supported is that Keras methods prefer this format when passing inputs to models
and layers. Because of this support, when using methods like `),Y=n("code"),Ue=r("model.fit()"),We=r(` things should \u201Cjust work\u201D for you - just
pass your inputs and labels in any format that `),K=n("code"),Re=r("model.fit()"),Ke=r(` supports! If, however, you want to use the second
format outside of Keras methods like `),Z=n("code"),He=r("fit()"),Qe=r(" and "),ee=n("code"),Ve=r("predict()"),Ce=r(`, such as when creating your own layers or models with
the Keras `),G=n("code"),de=r("Functional"),we=r(` API, there are three possibilities you can use to gather all the input Tensors in the first
...
`),Q=a(se,"CODE",{});var To=s(Q);to=d(To,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),To.forEach(o),se.forEach(o),R.forEach(o),Se=c(y),L=a(y,"P",{});var ce=s(L);no=d(ce,`Note that when creating models and layers with
`),V=a(ce,"A",{href:!0,rel:!0});var wo=s(V);Pe=d(wo,"subclassing"),wo.forEach(o),ae=d(ce,` then you don\u2019t need to worry
about any of this, as you can just pass inputs like you would to any other Python function!`),ce.forEach(o),this.h()},h(){m(V,"href","https://keras.io/guides/making_new_layers_and_models_via_subclassing/"),m(V,"rel","nofollow")},m(y,F){_(y,p,F),e(p,k),e(p,f),e(f,u),e(p,b),_(y,l,F),_(y,h,F),e(h,q),e(q,Ae),e(h,Me),e(h,C),e(C,De),_(y,re,F),_(y,B,F),e(B,Ge),e(B,Y),e(Y,Ue),e(B,We),e(B,K),e(K,Re),e(B,Ke),e(B,Z),e(Z,He),e(B,Qe),e(B,ee),e(ee,Ve),e(B,Ce),e(B,G),e(G,de),e(B,we),_(y,te,F),_(y,P,F),e(P,I),e(I,Je),e(I,le),e(le,ie),e(I,Xe),e(I,H),e(H,Ye),e(P,Ze),e(P,A),e(A,ke),e(A,he),e(he,je),e(A,ye),e(A,ne),e(ne,eo),e(P,Oe),e(P,N),e(N,oo),e(N,Q),e(Q,to),_(y,Se,F),_(y,L,F),e(L,no),e(L,V),e(V,Pe),e(L,ae)},d(y){y&&o(p),y&&o(l),y&&o(h),y&&o(re),y&&o(B),y&&o(te),y&&o(P),y&&o(Se),y&&o(L)}}}function wu(z){let p,k,f,u,b;return{c(){p=n("p"),k=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=n("code"),u=r("Module"),b=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(l){p=a(l,"P",{});var h=s(p);k=d(h,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=a(h,"CODE",{});var q=s(f);u=d(q,"Module"),q.forEach(o),b=d(h,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
behaviors between training and evaluation).`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/blenderbot_small/modeling_tf_blenderbot_small.py#L1145",returnDescription:`
<p>A <a
...
Labels for computing the masked language modeling loss. Indices should either be in <code>[0, ..., config.vocab_size]</code> or -100 (see <code>input_ids</code> docstring). Tokens with indices set to <code>-100</code> are ignored
(masked), the loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/blenderbot_small/modeling_tf_blenderbot_small.py#L1274",returnDescription:`
<p>A <a
...
found `),L=n("a"),no=r("here"),V=r(" ."),Pe=i(),ae=n("h2"),y=n("a"),F=n("span"),v($e.$$.fragment),xe=i(),ao=n("span"),_o=r("BlenderbotSmallConfig"),E=i(),J=n("div"),v(Be.$$.fragment),go=i(),ue=n("p"),bo=r("This is the configuration class to store the configuration of a "),R=n("a"),fe=r("BlenderbotSmallModel"),ko=r(`. It is used to instantiate
...
special tokens using the tokenizer `),Sa=n("code"),Ud=r("prepare_for_model"),Wd=r(" or "),$a=n("code"),Rd=r("encode_plus"),Kd=r(" methods."),Hd=i(),co=n("div"),v(Ot.$$.fragment),Qd=i(),Qn=n("p"),Vd=r("Create the token type IDs corresponding to the sequences passed. "),Vn=n("a"),Jd=r(`What are token type
...
and behavior.`),kl=i(),Le=n("div"),v(Kt.$$.fragment),yl=i(),zo=n("p"),vl=r("The "),Yn=n("a"),Tl=r("BlenderbotSmallModel"),wl=r(" forward method, overrides the "),Ca=n("code"),Sl=r("__call__"),$l=r(" special method."),xl=i(),v(Ko.$$.fragment),Bl=i(),v(Ho.$$.fragment),zr=i(),Fo=n("h2"),Qo=n("a"),ja=n("span"),v(Ht.$$.fragment),zl=i(),Oa=n("span"),Fl=r("BlenderbotSmallForConditionalGeneration"),Fr=i(),qe=n("div"),v(Qt.$$.fragment),ql=i(),Vt=n("p"),El=r(`The BlenderbotSmall Model with a language modeling head. Can be used for summarization.
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Nl=i(),Ne=n("div"),v(Yt.$$.fragment),Il=i(),qo=n("p"),Al=r("The "),ea=n("a"),Dl=r("BlenderbotSmallForConditionalGeneration"),Gl=r(" forward method, overrides the "),Pa=n("code"),Ul=r("__call__"),Wl=r(" special method."),Rl=i(),v(Vo.$$.fragment),Kl=i(),v(Jo.$$.fragment),qr=i(),Eo=n("h2"),Xo=n("a"),La=n("span"),v(Zt.$$.fragment),Hl=i(),Na=n("span"),Ql=r("BlenderbotSmallForCausalLM"),Er=i(),Mo=n("div"),v(en.$$.fragment),Vl=i(),Yo=n("div"),v(on.$$.fragment),Jl=i(),v(Zo.$$.fragment),Mr=i(),Co=n("h2"),et=n("a"),Ia=n("span"),v(tn.$$.fragment),Xl=i(),Aa=n("span"),Yl=r("TFBlenderbotSmallModel"),Cr=i(),ge=n("div"),v(nn.$$.fragment),Zl=i(),an=n("p"),ei=r(`The bare BLENDERBOT_SMALL Model outputting raw hidden-states without any specific head on top.
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Bi=i(),v(st.$$.fragment),zi=i(),D=n("div"),v(un.$$.fragment),Fi=i(),Po=n("p"),qi=r("The "),aa=n("a"),Ei=r("TFBlenderbotSmallForConditionalGeneration"),Mi=r(" forward method, overrides the "),Wa=n("code"),Ci=r("__call__"),ji=r(" special method."),Oi=i(),v(rt.$$.fragment),Pi=i(),Ra=n("p"),Li=r("Conversation example::"),Ni=i(),Ka=n("blockquote"),Ha=n("blockquote"),Qa=n("blockquote"),Va=n("p"),Ii=r(`from transformers import BlenderbotSmallTokenizer, TFBlenderbotSmallForConditionalGeneration >>> mname =
...
\u201D<s>I\u2019m not sure.\u201D \u2026 )`),Qi=i(),ls=n("blockquote"),is=n("blockquote"),cs=n("blockquote"),ps=n("p"),Vi=r(`inputs = tokenizer([NEXT_UTTERANCE], return_tensors=\u2018tf\u2019) >>> inputs.pop(\u201Ctoken_type_ids\u201D) >>>
...
and code publicly available. Human evaluations show our best models are superior to existing approaches in multi-turn
dialogue in terms of engagingness and humanness measurements. We then discuss the limitations of this work by analyzing
failure cases of our models.`),$p.forEach(o),Sp.forEach(o),Oe=c(t),N=a(t,"P",{});var da=s(N);oo=d(da,"This model was contributed by "),Q=a(da,"A",{href:!0,rel:!0});var xp=s(Q);to=d(xp,"patrickvonplaten"),xp.forEach(o),Se=d(da,`. The authors\u2019 code can be
found `),L=a(da,"A",{href:!0,rel:!0});var Bp=s(L);no=d(Bp,"here"),Bp.forEach(o),V=d(da," ."),da.forEach(o),Pe=c(t),ae=a(t,"H2",{class:!0});var Dr=s(ae);y=a(Dr,"A",{id:!0,class:!0,href:!0});var zp=s(y);F=a(zp,"SPAN",{});var Fp=s(F);T($e.$$.fragment,Fp),Fp.forEach(o),zp.forEach(o),xe=c(Dr),ao=a(Dr,"SPAN",{});var qp=s(ao);_o=d(qp,"BlenderbotSmallConfig"),qp.forEach(o),Dr.forEach(o),E=c(t),J=a(t,"DIV",{class:!0});var Tt=s(J);T(Be.$$.fragment,Tt),go=c(Tt),ue=a(Tt,"P",{});var la=s(ue);bo=d(la,"This is the configuration class to store the configuration of a "),R=a(la,"A",{href:!0});var Ep=s(R);fe=d(Ep,"BlenderbotSmallModel"),Ep.forEach(o),ko=d(la,`. It is used to instantiate
an BlenderbotSmall model according to the specified arguments, defining the model architecture. Instantiating a
configuration with the defaults will yield a similar configuration to that of the BlenderbotSmall
...
special tokens using the tokenizer `),Sa=a(pa,"CODE",{});var Gp=s(Sa);Ud=d(Gp,"prepare_for_model"),Gp.forEach(o),Wd=d(pa," or "),$a=a(pa,"CODE",{});var Up=s($a);Rd=d(Up,"encode_plus"),Up.forEach(o),Kd=d(pa," methods."),pa.forEach(o),Wr.forEach(o),Hd=c(Te),co=a(Te,"DIV",{class:!0});var ma=s(co);T(Ot.$$.fragment,ma),Qd=c(ma),Qn=a(ma,"P",{});var wp=s(Qn);Vd=d(wp,"Create the token type IDs corresponding to the sequences passed. "),Vn=a(wp,"A",{href:!0});var Wp=s(Vn);Jd=d(Wp,`What are token type
IDs?`),Wp.forEach(o),wp.forEach(o),Xd=c(ma),xa=a(ma,"P",{});var Rp=s(xa);Yd=d(Rp,"Should be overridden in a subclass if the model has a special way of building those."),Rp.forEach(o),ma.forEach(o),Zd=c(Te),Jn=a(Te,"DIV",{class:!0});var Kp=s(Jn);T(Pt.$$.fragment,Kp),Kp.forEach(o),Te.forEach(o),Sr=c(t),xo=a(t,"H2",{class:!0});var Rr=s(xo);Uo=a(Rr,"A",{id:!0,class:!0,href:!0});var Hp=s(Uo);Ba=a(Hp,"SPAN",{});var Qp=s(Ba);T(Lt.$$.fragment,Qp),Qp.forEach(o),Hp.forEach(o),el=c(Rr),za=a(Rr,"SPAN",{});var Vp=s(za);ol=d(Vp,"BlenderbotSmallTokenizerFast"),Vp.forEach(o),Rr.forEach(o),$r=c(t),so=a(t,"DIV",{class:!0});var ha=s(so);T(Nt.$$.fragment,ha),tl=c(ha),It=a(ha,"P",{});var Kr=s(It);nl=d(Kr,"Construct a \u201Cfast\u201D BlenderbotSmall tokenizer (backed by HuggingFace\u2019s "),Fa=a(Kr,"EM",{});var Jp=s(Fa);al=d(Jp,"tokenizers"),Jp.forEach(o),sl=d(Kr," library)."),Kr.forEach(o),rl=c(ha),Wo=a(ha,"DIV",{class:!0});var Hr=s(Wo);T(At.$$.fragment,Hr),dl=c(Hr),qa=a(Hr,"P",{});var Xp=s(qa);ll=d(Xp,`Create a mask from the two sequences passed to be used in a sequence-pair classification task. BlenderbotSmall
does not make use of token type ids, therefore a list of zeros is returned.`),Xp.forEach(o),Hr.forEach(o),ha.forEach(o),xr=c(t),Bo=a(t,"H2",{class:!0});var Qr=s(Bo);Ro=a(Qr,"A",{id:!0,class:!0,href:!0});var Yp=s(Ro);Ea=a(Yp,"SPAN",{});var Zp=s(Ea);T(Dt.$$.fragment,Zp),Zp.forEach(o),Yp.forEach(o),il=c(Qr),Ma=a(Qr,"SPAN",{});var em=s(Ma);cl=d(em,"BlenderbotSmallModel"),em.forEach(o),Qr.forEach(o),Br=c(t),Fe=a(t,"DIV",{class:!0});var wt=s(Fe);T(Gt.$$.fragment,wt),pl=c(wt),Ut=a(wt,"P",{});var Vr=s(Ut);ml=d(Vr,`The bare BlenderbotSmall Model outputting raw hidden-states without any specific head on top.
This model inherits from `),Xn=a(Vr,"A",{href:!0});var om=s(Xn);hl=d(om,"PreTrainedModel"),om.forEach(o),ul=d(Vr,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Vr.forEach(o),fl=c(wt),Wt=a(wt,"P",{});var Jr=s(Wt);_l=d(Jr,"This model is also a PyTorch "),Rt=a(Jr,"A",{href:!0,rel:!0});var tm=s(Rt);gl=d(tm,"torch.nn.Module"),tm.forEach(o),bl=d(Jr,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Jr.forEach(o),kl=c(wt),Le=a(wt,"DIV",{class:!0});var St=s(Le);T(Kt.$$.fragment,St),yl=c(St),zo=a(St,"P",{});var ua=s(zo);vl=d(ua,"The "),Yn=a(ua,"A",{href:!0});var nm=s(Yn);Tl=d(nm,"BlenderbotSmallModel"),nm.forEach(o),wl=d(ua," forward method, overrides the "),Ca=a(ua,"CODE",{});var am=s(Ca);Sl=d(am,"__call__"),am.forEach(o),$l=d(ua," special method."),ua.forEach(o),xl=c(St),T(Ko.$$.fragment,St),Bl=c(St),T(Ho.$$.fragment,St),St.forEach(o),wt.forEach(o),zr=c(t),Fo=a(t,"H2",{class:!0});var Xr=s(Fo);Qo=a(Xr,"A",{id:!0,class:!0,href:!0});var sm=s(Qo);ja=a(sm,"SPAN",{});var rm=s(ja);T(Ht.$$.fragment,rm),rm.forEach(o),sm.forEach(o),zl=c(Xr),Oa=a(Xr,"SPAN",{});var dm=s(Oa);Fl=d(dm,"BlenderbotSmallForConditionalGeneration"),dm.forEach(o),Xr.forEach(o),Fr=c(t),qe=a(t,"DIV",{class:!0});var $t=s(qe);T(Qt.$$.fragment,$t),ql=c($t),Vt=a($t,"P",{});var Yr=s(Vt);El=d(Yr,`The BlenderbotSmall Model with a language modeling head. Can be used for summarization.
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Zr.forEach(o),Nl=c($t),Ne=a($t,"DIV",{class:!0});var xt=s(Ne);T(Yt.$$.fragment,xt),Il=c(xt),qo=a(xt,"P",{});var fa=s(qo);Al=d(fa,"The "),ea=a(fa,"A",{href:!0});var cm=s(ea);Dl=d(cm,"BlenderbotSmallForConditionalGeneration"),cm.forEach(o),Gl=d(fa," forward method, overrides the "),Pa=a(fa,"CODE",{});var pm=s(Pa);Ul=d(pm,"__call__"),pm.forEach(o),Wl=d(fa," special method."),fa.forEach(o),Rl=c(xt),T(Vo.$$.fragment,xt),Kl=c(xt),T(Jo.$$.fragment,xt),xt.forEach(o),$t.forEach(o),qr=c(t),Eo=a(t,"H2",{class:!0});var ed=s(Eo);Xo=a(ed,"A",{id:!0,class:!0,href:!0});var mm=s(Xo);La=a(mm,"SPAN",{});var hm=s(La);T(Zt.$$.fragment,hm),hm.forEach(o),mm.forEach(o),Hl=c(ed),Na=a(ed,"SPAN",{});var um=s(Na);Ql=d(um,"BlenderbotSmallForCausalLM"),um.forEach(o),ed.forEach(o),Er=c(t),Mo=a(t,"DIV",{class:!0});var od=s(Mo);T(en.$$.fragment,od),Vl=c(od),Yo=a(od,"DIV",{class:!0});var td=s(Yo);T(on.$$.fragment,td),Jl=c(td),T(Zo.$$.fragment,td),td.forEach(o),od.forEach(o),Mr=c(t),Co=a(t,"H2",{class:!0});var nd=s(Co);et=a(nd,"A",{id:!0,class:!0,href:!0});var fm=s(et);Ia=a(fm,"SPAN",{});var _m=s(Ia);T(tn.$$.fragment,_m),_m.forEach(o),fm.forEach(o),Xl=c(nd),Aa=a(nd,"SPAN",{});var gm=s(Aa);Yl=d(gm,"TFBlenderbotSmallModel"),gm.forEach(o),nd.forEach(o),Cr=c(t),ge=a(t,"DIV",{class:!0});var po=s(ge);T(nn.$$.fragment,po),Zl=c(po),an=a(po,"P",{});var ad=s(an);ei=d(ad,`The bare BLENDERBOT_SMALL Model outputting raw hidden-states without any specific head on top.
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),ld.forEach(o),Bi=c(mo),T(st.$$.fragment,mo),zi=c(mo),D=a(mo,"DIV",{class:!0});var oe=s(D);T(un.$$.fragment,oe),Fi=c(oe),Po=a(oe,"P",{});var ga=s(Po);qi=d(ga,"The "),aa=a(ga,"A",{href:!0});var Bm=s(aa);Ei=d(Bm,"TFBlenderbotSmallForConditionalGeneration"),Bm.forEach(o),Mi=d(ga," forward method, overrides the "),Wa=a(ga,"CODE",{});var zm=s(Wa);Ci=d(zm,"__call__"),zm.forEach(o),ji=d(ga," special method."),ga.forEach(o),Oi=c(oe),T(rt.$$.fragment,oe),Pi=c(oe),Ra=a(oe,"P",{});var Fm=s(Ra);Li=d(Fm,"Conversation example::"),Fm.forEach(o),Ni=c(oe),Ka=a(oe,"BLOCKQUOTE",{});var qm=s(Ka);Ha=a(qm,"BLOCKQUOTE",{});var Em=s(Ha);Qa=a(Em,"BLOCKQUOTE",{});var Mm=s(Qa);Va=a(Mm,"P",{});var Cm=s(Va);Ii=d(Cm,`from transformers import BlenderbotSmallTokenizer, TFBlenderbotSmallForConditionalGeneration >>> mname =
\u2018facebook/blenderbot_small-90M\u2019 >>> model = BlenderbotSmallForConditionalGeneration.from_pretrained(mname) >>>
...
\u201D<s>I\u2019m not sure.\u201D \u2026 )`),id.forEach(o),Wm.forEach(o),Um.forEach(o),Gm.forEach(o),Qi=c(oe),ls=a(oe,"BLOCKQUOTE",{});var Km=s(ls);is=a(Km,"BLOCKQUOTE",{});var Hm=s(is);cs=a(Hm,"BLOCKQUOTE",{});var Qm=s(cs);ps=a(Qm,"P",{});var Vm=s(ps);Vi=d(Vm,`inputs = tokenizer([NEXT_UTTERANCE], return_tensors=\u2018tf\u2019) >>> inputs.pop(\u201Ctoken_type_ids\u201D) >>>
next_reply_ids = model.generate(**inputs) >>> print(\u201CBot: \u201D, tokenizer.batch_decode(next_reply_ids,
...
tokenizer([ARTICLE_TO_SUMMARIZE], max_length=1024, return_tensors=\u2018np\u2019)`),Nh.forEach(o),Lh.forEach(o),Ph.forEach(o),Oh.forEach(o),ap=c(j),Ds=a(j,"BLOCKQUOTE",{});var Ih=s(Ds);Gs=a(Ih,"BLOCKQUOTE",{});var Ah=s(Gs);Nn=a(Ah,"BLOCKQUOTE",{});var kd=s(Nn);_t=a(kd,"H1",{class:!0});var yd=s(_t);gt=a(yd,"A",{id:!0,class:!0,href:!0});var Dh=s(gt);Us=a(Dh,"SPAN",{});var Gh=s(Us);T(In.$$.fragment,Gh),Gh.forEach(o),Dh.forEach(o),sp=c(yd),Ws=a(yd,"SPAN",{});var Uh=s(Ws);rp=d(Uh,"Generate Summary >>> summary_ids = model.generate(inputs[\u2018input_ids\u2019]).sequences >>>"),Uh.forEach(o),yd.forEach(o),dp=c(kd),Rs=a(kd,"P",{});var Wh=s(Rs);lp=d(Wh,"print(tokenizer.batch_decode(summary_ids, skip_special_tokens=True, clean_up_tokenization_spaces=False))"),Wh.forEach(o),kd.forEach(o),Ah.forEach(o),Ih.forEach(o),ip=c(j),Ks=a(j,"P",{});var Rh=s(Ks);cp=d(Rh,"Mask filling example:"),Rh.forEach(o),pp=c(j),Hs=a(j,"BLOCKQUOTE",{});var Kh=s(Hs);Qs=a(Kh,"BLOCKQUOTE",{});var Hh=s(Qs);Vs=a(Hh,"BLOCKQUOTE",{});var Qh=s(Vs);Js=a(Qh,"P",{});var Vh=s(Js);mp=d(Vh,`from transformers import BlenderbotSmallTokenizer, FlaxBlenderbotSmallForConditionalGeneration >>>
tokenizer = BlenderbotSmallTokenizer.from_pretrained(\u2018facebook/blenderbot_small-90M\u2019) >>> TXT = \u201CMy friends are
<mask> but they eat too many carbs.\u201D`),Vh.forEach(o),Qh.forEach(o),Hh.forEach(o),Kh.forEach(o),hp=c(j),Xs=a(j,"BLOCKQUOTE",{});var Jh=s(Xs);Ys=a(Jh,"BLOCKQUOTE",{});var Xh=s(Ys);Zs=a(Xh,"BLOCKQUOTE",{});var Yh=s(Zs);er=a(Yh,"P",{});var Zh=s(er);up=d(Zh,`model = FlaxBlenderbotSmallForConditionalGeneration.from_pretrained(\u2018facebook/blenderbot_small-90M\u2019) >>>
