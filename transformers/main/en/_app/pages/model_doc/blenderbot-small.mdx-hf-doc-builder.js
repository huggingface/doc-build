...
documentation from `),Cn=n("a"),$l=r("PretrainedConfig"),Sl=r(" for more information."),xl=i(),y(wo.$$.fragment),pr=i(),ro=n("h2"),$o=n("a"),la=n("span"),y(ft.$$.fragment),zl=i(),da=n("span"),Bl=r("BlenderbotSmallTokenizer"),mr=i(),U=n("div"),y(_t.$$.fragment),Fl=i(),ia=n("p"),ql=r("Constructs a Blenderbot-90M tokenizer based on BPE (Byte-Pair-Encoding)"),El=i(),gt=n("p"),Ml=r("This tokenizer inherits from "),jn=n("a"),Cl=r("PreTrainedTokenizer"),jl=r(` which contains most of the main methods. Users should refer to
...
IDs?`),Xl=i(),ha=n("p"),Yl=r("Should be overridden in a subclass if the model has a special way of building those."),Zl=i(),Ln=n("div"),y(vt.$$.fragment),ur=i(),io=n("h2"),xo=n("a"),fa=n("span"),y(Tt.$$.fragment),ed=i(),_a=n("span"),od=r("BlenderbotSmallTokenizerFast"),hr=i(),Ge=n("div"),y(wt.$$.fragment),td=i(),$t=n("p"),nd=r("Construct a \u201Cfast\u201D BlenderbotSmall tokenizer (backed by HuggingFace\u2019s "),ga=n("em"),ad=r("tokenizers"),sd=r(" library)."),rd=i(),zo=n("div"),y(St.$$.fragment),ld=i(),ba=n("p"),dd=r(`Create a mask from the two sequences passed to be used in a sequence-pair classification task. BlenderbotSmall
does not make use of token type ids, therefore a list of zeros is returned.`),fr=i(),co=n("h2"),Bo=n("a"),ka=n("span"),y(xt.$$.fragment),id=i(),ya=n("span"),cd=r("BlenderbotSmallModel"),_r=i(),$e=n("div"),y(zt.$$.fragment),pd=i(),Bt=n("p"),md=r(`The bare BlenderbotSmall Model outputting raw hidden-states without any specific head on top.
...
and behavior.`),kd=i(),qe=n("div"),y(Et.$$.fragment),yd=i(),po=n("p"),vd=r("The "),In=n("a"),Td=r("BlenderbotSmallModel"),wd=r(" forward method, overrides the "),va=n("code"),$d=r("__call__"),Sd=r(" special method."),xd=i(),y(Fo.$$.fragment),zd=i(),y(qo.$$.fragment),gr=i(),mo=n("h2"),Eo=n("a"),Ta=n("span"),y(Mt.$$.fragment),Bd=i(),wa=n("span"),Fd=r("BlenderbotSmallForConditionalGeneration"),br=i(),Se=n("div"),y(Ct.$$.fragment),qd=i(),jt=n("p"),Ed=r(`The BlenderbotSmall Model with a language modeling head. Can be used for summarization.
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Nd=i(),Ee=n("div"),y(Lt.$$.fragment),Id=i(),uo=n("p"),Ad=r("The "),Dn=n("a"),Dd=r("BlenderbotSmallForConditionalGeneration"),Gd=r(" forward method, overrides the "),$a=n("code"),Ud=r("__call__"),Wd=r(" special method."),Rd=i(),y(Mo.$$.fragment),Hd=i(),y(Co.$$.fragment),kr=i(),ho=n("h2"),jo=n("a"),Sa=n("span"),y(Nt.$$.fragment),Kd=i(),xa=n("span"),Qd=r("BlenderbotSmallForCausalLM"),yr=i(),fo=n("div"),y(It.$$.fragment),Vd=i(),Oo=n("div"),y(At.$$.fragment),Jd=i(),y(Po.$$.fragment),vr=i(),_o=n("h2"),Lo=n("a"),za=n("span"),y(Dt.$$.fragment),Xd=i(),Ba=n("span"),Yd=r("TFBlenderbotSmallModel"),Tr=i(),pe=n("div"),y(Gt.$$.fragment),Zd=i(),Ut=n("p"),ei=r(`The bare BLENDERBOT_SMALL Model outputting raw hidden-states without any specific head on top.
...
behavior.`),li=i(),y(No.$$.fragment),di=i(),Me=n("div"),y(Ht.$$.fragment),ii=i(),go=n("p"),ci=r("The "),Un=n("a"),pi=r("TFBlenderbotSmallModel"),mi=r(" forward method, overrides the "),Fa=n("code"),ui=r("__call__"),hi=r(" special method."),fi=i(),y(Io.$$.fragment),_i=i(),y(Ao.$$.fragment),wr=i(),bo=n("h2"),Do=n("a"),qa=n("span"),y(Kt.$$.fragment),gi=i(),Ea=n("span"),bi=r("TFBlenderbotSmallForConditionalGeneration"),$r=i(),me=n("div"),y(Qt.$$.fragment),ki=i(),Vt=n("p"),yi=r(`The BLENDERBOT_SMALL Model with a language modeling head. Can be used for summarization.
...
and code publicly available. Human evaluations show our best models are superior to existing approaches in multi-turn
dialogue in terms of engagingness and humanness measurements. We then discuss the limitations of this work by analyzing
failure cases of our models.`),Sp.forEach(o),$p.forEach(o),Re=c(t),O=a(t,"P",{});var Qn=s(O);eo=l(Qn,"This model was contributed by "),ye=a(Qn,"A",{href:!0,rel:!0});var xp=s(ye);oo=l(xp,"patrickvonplaten"),xp.forEach(o),Y=l(Qn,`. The authors\u2019 code can be
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Ir.forEach(o),kd=c(rt),qe=a(rt,"DIV",{class:!0});var lt=s(qe);v(Et.$$.fragment,lt),yd=c(lt),po=a(lt,"P",{});var oa=s(po);vd=l(oa,"The "),In=a(oa,"A",{href:!0});var nm=s(In);Td=l(nm,"BlenderbotSmallModel"),nm.forEach(o),wd=l(oa," forward method, overrides the "),va=a(oa,"CODE",{});var am=s(va);$d=l(am,"__call__"),am.forEach(o),Sd=l(oa," special method."),oa.forEach(o),xd=c(lt),v(Fo.$$.fragment,lt),zd=c(lt),v(qo.$$.fragment,lt),lt.forEach(o),rt.forEach(o),gr=c(t),mo=a(t,"H2",{class:!0});var Ar=s(mo);Eo=a(Ar,"A",{id:!0,class:!0,href:!0});var sm=s(Eo);Ta=a(sm,"SPAN",{});var rm=s(Ta);v(Mt.$$.fragment,rm),rm.forEach(o),sm.forEach(o),Bd=c(Ar),wa=a(Ar,"SPAN",{});var lm=s(wa);Fd=l(lm,"BlenderbotSmallForConditionalGeneration"),lm.forEach(o),Ar.forEach(o),br=c(t),Se=a(t,"DIV",{class:!0});var dt=s(Se);v(Ct.$$.fragment,dt),qd=c(dt),jt=a(dt,"P",{});var Dr=s(jt);Ed=l(Dr,`The BlenderbotSmall Model with a language modeling head. Can be used for summarization.
...
next_reply_ids = model.generate(**inputs) >>> print(\u201CBot: \u201D, tokenizer.batch_decode(next_reply_ids,
skip_special_tokens=True)[0])`),Vm.forEach(o),Qm.forEach(o),Km.forEach(o),Hm.forEach(o),K.forEach(o),Ve.forEach(o),Sr=c(t),yo=a(t,"H2",{class:!0});var Zr=s(yo);Wo=a(Zr,"A",{id:!0,class:!0,href:!0});var Jm=s(Wo);es=a(Jm,"SPAN",{});var Xm=s(es);v(en.$$.fragment,Xm),Xm.forEach(o),Jm.forEach(o),Ji=c(Zr),os=a(Zr,"SPAN",{});var Ym=s(os);Xi=l(Ym,"FlaxBlenderbotSmallModel"),Ym.forEach(o),Zr.forEach(o),xr=c(t),I=a(t,"DIV",{class:!0});var te=s(I);v(on.$$.fragment,te),Yi=c(te),tn=a(te,"P",{});var el=s(tn);Zi=l(el,`The bare BlenderbotSmall Model transformer outputting raw hidden-states without any specific head on top.
