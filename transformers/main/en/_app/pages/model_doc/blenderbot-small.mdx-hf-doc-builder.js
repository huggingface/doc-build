import{S as dh,i as ih,s as ch,e as n,k as i,w as y,t as r,M as ph,c as a,d as o,m as c,a as s,x as v,h as l,b as m,G as e,g as _,y as T,q as w,o as S,B as $,v as mh,L as Xe}from"../../chunks/vendor-hf-doc-builder.js";import{T as Fn}from"../../chunks/Tip-hf-doc-builder.js";import{D as C}from"../../chunks/Docstring-hf-doc-builder.js";import{C as Ye}from"../../chunks/CodeBlock-hf-doc-builder.js";import{I as xe}from"../../chunks/IconCopyLink-hf-doc-builder.js";import{E as Je}from"../../chunks/ExampleCodeBlock-hf-doc-builder.js";function uh(z){let p,k,f,u,b;return u=new Ye({props:{code:`from transformers import BlenderbotSmallModel, BlenderbotSmallConfig
...
<span class="hljs-literal">True</span>`}}),{c(){p=n("p"),k=r("Example:"),f=i(),y(u.$$.fragment)},l(d){p=a(d,"P",{});var h=s(p);k=l(h,"Example:"),h.forEach(o),f=c(d),v(u.$$.fragment,d)},m(d,h){_(d,p,h),e(p,k),_(d,f,h),T(u,d,h),b=!0},p:Xe,i(d){b||(w(u.$$.fragment,d),b=!0)},o(d){S(u.$$.fragment,d),b=!1},d(d){d&&o(p),d&&o(f),$(u,d)}}}function kh(z){let p,k,f,u,b,d,h,q,Ce,ue,B,je,W,Oe,Pe,R,Le,Ne,Q,V,Ie,Z,j,L,he,ae,Be,J,D,be,se,N,ke,re,ze,ee,le,de,Ae,X,qe,H,De;return{c(){p=n("p"),k=r("TF 2.0 models accepts two formats as inputs:"),f=i(),u=n("ul"),b=n("li"),d=r("having all inputs as keyword arguments (like PyTorch models), or"),h=i(),q=n("li"),Ce=r("having all inputs as a list, tuple or dict in the first positional arguments."),ue=i(),B=n("p"),je=r("This second option is useful when using "),W=n("code"),Oe=r("tf.keras.Model.fit"),Pe=r(` method which currently requires having all the
...
`),re=n("code"),ze=r("model([input_ids, attention_mask])"),ee=r(" or "),le=n("code"),de=r("model([input_ids, attention_mask, token_type_ids])"),Ae=i(),X=n("li"),qe=r(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),H=n("code"),De=r('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(x){p=a(x,"P",{});var F=s(p);k=l(F,"TF 2.0 models accepts two formats as inputs:"),F.forEach(o),f=c(x),u=a(x,"UL",{});var ie=s(u);b=a(ie,"LI",{});var Ze=s(b);d=l(Ze,"having all inputs as keyword arguments (like PyTorch models), or"),Ze.forEach(o),h=c(ie),q=a(ie,"LI",{});var Re=s(q);Ce=l(Re,"having all inputs as a list, tuple or dict in the first positional arguments."),Re.forEach(o),ie.forEach(o),ue=c(x),B=a(x,"P",{});var O=s(B);je=l(O,"This second option is useful when using "),W=a(O,"CODE",{});var eo=s(W);Oe=l(eo,"tf.keras.Model.fit"),eo.forEach(o),Pe=l(O,` method which currently requires having all the
...
`),re=a(oe,"CODE",{});var ce=s(re);ze=l(ce,"model([input_ids, attention_mask])"),ce.forEach(o),ee=l(oe," or "),le=a(oe,"CODE",{});var fe=s(le);de=l(fe,"model([input_ids, attention_mask, token_type_ids])"),fe.forEach(o),oe.forEach(o),Ae=c(Y),X=a(Y,"LI",{});var ve=s(X);qe=l(ve,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),H=a(ve,"CODE",{});var Te=s(H);De=l(Te,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),Te.forEach(o),ve.forEach(o),Y.forEach(o)},m(x,F){_(x,p,F),e(p,k),_(x,f,F),_(x,u,F),e(u,b),e(b,d),e(u,h),e(u,q),e(q,Ce),_(x,ue,F),_(x,B,F),e(B,je),e(B,W),e(W,Oe),e(B,Pe),e(B,R),e(R,Le),e(B,Ne),_(x,Q,F),_(x,V,F),e(V,Ie),_(x,Z,F),_(x,j,F),e(j,L),e(L,he),e(L,ae),e(ae,Be),e(L,J),e(L,D),e(D,be),e(j,se),e(j,N),e(N,ke),e(N,re),e(re,ze),e(N,ee),e(N,le),e(le,de),e(j,Ae),e(j,X),e(X,qe),e(X,H),e(H,De)},d(x){x&&o(p),x&&o(f),x&&o(u),x&&o(ue),x&&o(B),x&&o(Q),x&&o(V),x&&o(Z),x&&o(j)}}}function yh(z){let p,k,f,u,b;return{c(){p=n("p"),k=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=n("code"),u=r("Module"),b=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(d){p=a(d,"P",{});var h=s(p);k=l(h,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=a(h,"CODE",{});var q=s(f);u=l(q,"Module"),q.forEach(o),b=l(h,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),{c(){p=n("p"),k=r("Example:"),f=i(),y(u.$$.fragment)},l(d){p=a(d,"P",{});var h=s(p);k=l(h,"Example:"),h.forEach(o),f=c(d),v(u.$$.fragment,d)},m(d,h){_(d,p,h),e(p,k),_(d,f,h),T(u,d,h),b=!0},p:Xe,i(d){b||(w(u.$$.fragment,d),b=!0)},o(d){S(u.$$.fragment,d),b=!1},d(d){d&&o(p),d&&o(f),$(u,d)}}}function Th(z){let p,k,f,u,b,d,h,q,Ce,ue,B,je,W,Oe,Pe,R,Le,Ne,Q,V,Ie,Z,j,L,he,ae,Be,J,D,be,se,N,ke,re,ze,ee,le,de,Ae,X,qe,H,De;return{c(){p=n("p"),k=r("TF 2.0 models accepts two formats as inputs:"),f=i(),u=n("ul"),b=n("li"),d=r("having all inputs as keyword arguments (like PyTorch models), or"),h=i(),q=n("li"),Ce=r("having all inputs as a list, tuple or dict in the first positional arguments."),ue=i(),B=n("p"),je=r("This second option is useful when using "),W=n("code"),Oe=r("tf.keras.Model.fit"),Pe=r(` method which currently requires having all the
tensors in the first argument of the model call function: `),R=n("code"),Le=r("model(inputs)"),Ne=r("."),Q=i(),V=n("p"),Ie=r(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),Z=i(),j=n("ul"),L=n("li"),he=r("a single Tensor with "),ae=n("code"),Be=r("input_ids"),J=r(" only and nothing else: "),D=n("code"),be=r("model(input_ids)"),se=i(),N=n("li"),ke=r(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),re=n("code"),ze=r("model([input_ids, attention_mask])"),ee=r(" or "),le=n("code"),de=r("model([input_ids, attention_mask, token_type_ids])"),Ae=i(),X=n("li"),qe=r(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),H=n("code"),De=r('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(x){p=a(x,"P",{});var F=s(p);k=l(F,"TF 2.0 models accepts two formats as inputs:"),F.forEach(o),f=c(x),u=a(x,"UL",{});var ie=s(u);b=a(ie,"LI",{});var Ze=s(b);d=l(Ze,"having all inputs as keyword arguments (like PyTorch models), or"),Ze.forEach(o),h=c(ie),q=a(ie,"LI",{});var Re=s(q);Ce=l(Re,"having all inputs as a list, tuple or dict in the first positional arguments."),Re.forEach(o),ie.forEach(o),ue=c(x),B=a(x,"P",{});var O=s(B);je=l(O,"This second option is useful when using "),W=a(O,"CODE",{});var eo=s(W);Oe=l(eo,"tf.keras.Model.fit"),eo.forEach(o),Pe=l(O,` method which currently requires having all the
...
first positional argument :`),oo.forEach(o),Z=c(x),j=a(x,"UL",{});var Y=s(j);L=a(Y,"LI",{});var G=s(L);he=l(G,"a single Tensor with "),ae=a(G,"CODE",{});var to=s(ae);Be=l(to,"input_ids"),to.forEach(o),J=l(G," only and nothing else: "),D=a(G,"CODE",{});var no=s(D);be=l(no,"model(input_ids)"),no.forEach(o),G.forEach(o),se=c(Y),N=a(Y,"LI",{});var oe=s(N);ke=l(oe,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),re=a(oe,"CODE",{});var ce=s(re);ze=l(ce,"model([input_ids, attention_mask])"),ce.forEach(o),ee=l(oe," or "),le=a(oe,"CODE",{});var fe=s(le);de=l(fe,"model([input_ids, attention_mask, token_type_ids])"),fe.forEach(o),oe.forEach(o),Ae=c(Y),X=a(Y,"LI",{});var ve=s(X);qe=l(ve,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),H=a(ve,"CODE",{});var Te=s(H);De=l(Te,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),Te.forEach(o),ve.forEach(o),Y.forEach(o)},m(x,F){_(x,p,F),e(p,k),_(x,f,F),_(x,u,F),e(u,b),e(b,d),e(u,h),e(u,q),e(q,Ce),_(x,ue,F),_(x,B,F),e(B,je),e(B,W),e(W,Oe),e(B,Pe),e(B,R),e(R,Le),e(B,Ne),_(x,Q,F),_(x,V,F),e(V,Ie),_(x,Z,F),_(x,j,F),e(j,L),e(L,he),e(L,ae),e(ae,Be),e(L,J),e(L,D),e(D,be),e(j,se),e(j,N),e(N,ke),e(N,re),e(re,ze),e(N,ee),e(N,le),e(le,de),e(j,Ae),e(j,X),e(X,qe),e(X,H),e(H,De)},d(x){x&&o(p),x&&o(f),x&&o(u),x&&o(ue),x&&o(B),x&&o(Q),x&&o(V),x&&o(Z),x&&o(j)}}}function wh(z){let p,k,f,u,b;return{c(){p=n("p"),k=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=n("code"),u=r("Module"),b=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(d){p=a(d,"P",{});var h=s(p);k=l(h,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=a(h,"CODE",{});var q=s(f);u=l(q,"Module"),q.forEach(o),b=l(h,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_decoder_hidden_states = outputs.last_hidden_state`}}),{c(){p=n("p"),k=r("Example:"),f=i(),y(u.$$.fragment)},l(d){p=a(d,"P",{});var h=s(p);k=l(h,"Example:"),h.forEach(o),f=c(d),v(u.$$.fragment,d)},m(d,h){_(d,p,h),e(p,k),_(d,f,h),T(u,d,h),b=!0},p:Xe,i(d){b||(w(u.$$.fragment,d),b=!0)},o(d){S(u.$$.fragment,d),b=!1},d(d){d&&o(p),d&&o(f),$(u,d)}}}function Bh(z){let p,k,f,u,b;return{c(){p=n("p"),k=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=n("code"),u=r("Module"),b=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(d){p=a(d,"P",{});var h=s(p);k=l(h,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=a(h,"CODE",{});var q=s(f);u=l(q,"Module"),q.forEach(o),b=l(h,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
`}}),at=new Je({props:{anchor:"transformers.FlaxBlenderbotSmallForConditionalGeneration.decode.example",$$slots:{default:[qh]},$$scope:{ctx:z}}}),{c(){p=n("meta"),k=i(),f=n("h1"),u=n("a"),b=n("span"),y(d.$$.fragment),h=i(),q=n("span"),Ce=r("Blenderbot Small"),ue=i(),B=n("p"),je=r("Note that "),W=n("a"),Oe=r("BlenderbotSmallModel"),Pe=r(` and
...
Jing Xu, Myle Ott, Kurt Shuster, Eric M. Smith, Y-Lan Boureau, Jason Weston on 30 Apr 2020.`),qe=i(),H=n("p"),De=r("The abstract of the paper is the following:"),x=i(),F=n("p"),ie=n("em"),Ze=r(`Building open-domain chatbots is a challenging area for machine learning research. While prior work has shown that
...
documentation from `),Cn=n("a"),Sl=r("PretrainedConfig"),$l=r(" for more information."),xl=i(),y(wo.$$.fragment),pr=i(),ro=n("h2"),So=n("a"),la=n("span"),y(ft.$$.fragment),Bl=i(),da=n("span"),zl=r("BlenderbotSmallTokenizer"),mr=i(),U=n("div"),y(_t.$$.fragment),ql=i(),ia=n("p"),Fl=r("Constructs a Blenderbot-90M tokenizer based on BPE (Byte-Pair-Encoding)"),El=i(),gt=n("p"),Ml=r("This tokenizer inherits from "),jn=n("a"),Cl=r("PreTrainedTokenizer"),jl=r(` which contains most of the main methods. Users should refer to
...
IDs?`),Xl=i(),ha=n("p"),Yl=r("Should be overridden in a subclass if the model has a special way of building those."),Zl=i(),Ln=n("div"),y(vt.$$.fragment),ur=i(),io=n("h2"),xo=n("a"),fa=n("span"),y(Tt.$$.fragment),ed=i(),_a=n("span"),od=r("BlenderbotSmallTokenizerFast"),hr=i(),Ge=n("div"),y(wt.$$.fragment),td=i(),St=n("p"),nd=r("Construct a \u201Cfast\u201D BlenderbotSmall tokenizer (backed by HuggingFace\u2019s "),ga=n("em"),ad=r("tokenizers"),sd=r(" library)."),rd=i(),Bo=n("div"),y($t.$$.fragment),ld=i(),ba=n("p"),dd=r(`Create a mask from the two sequences passed to be used in a sequence-pair classification task. BlenderbotSmall
does not make use of token type ids, therefore a list of zeros is returned.`),fr=i(),co=n("h2"),zo=n("a"),ka=n("span"),y(xt.$$.fragment),id=i(),ya=n("span"),cd=r("BlenderbotSmallModel"),_r=i(),Se=n("div"),y(Bt.$$.fragment),pd=i(),zt=n("p"),md=r(`The bare BlenderbotSmall Model outputting raw hidden-states without any specific head on top.
...
etc.)`),fd=i(),qt=n("p"),_d=r("This model is also a PyTorch "),Ft=n("a"),gd=r("torch.nn.Module"),bd=r(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),kd=i(),Fe=n("div"),y(Et.$$.fragment),yd=i(),po=n("p"),vd=r("The "),In=n("a"),Td=r("BlenderbotSmallModel"),wd=r(" forward method, overrides the "),va=n("code"),Sd=r("__call__"),$d=r(" special method."),xd=i(),y(qo.$$.fragment),Bd=i(),y(Fo.$$.fragment),gr=i(),mo=n("h2"),Eo=n("a"),Ta=n("span"),y(Mt.$$.fragment),zd=i(),wa=n("span"),qd=r("BlenderbotSmallForConditionalGeneration"),br=i(),$e=n("div"),y(Ct.$$.fragment),Fd=i(),jt=n("p"),Ed=r(`The BlenderbotSmall Model with a language modeling head. Can be used for summarization.
...
behavior.`),li=i(),y(No.$$.fragment),di=i(),Me=n("div"),y(Ht.$$.fragment),ii=i(),go=n("p"),ci=r("The "),Un=n("a"),pi=r("TFBlenderbotSmallModel"),mi=r(" forward method, overrides the "),qa=n("code"),ui=r("__call__"),hi=r(" special method."),fi=i(),y(Io.$$.fragment),_i=i(),y(Ao.$$.fragment),wr=i(),bo=n("h2"),Do=n("a"),Fa=n("span"),y(Kt.$$.fragment),gi=i(),Ea=n("span"),bi=r("TFBlenderbotSmallForConditionalGeneration"),Sr=i(),me=n("div"),y(Qt.$$.fragment),ki=i(),Vt=n("p"),yi=r(`The BLENDERBOT_SMALL Model with a language modeling head. Can be used for summarization.
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Bi=i(),y(Go.$$.fragment),zi=i(),P=n("div"),y(Yt.$$.fragment),qi=i(),ko=n("p"),Fi=r("The "),Rn=n("a"),Ei=r("TFBlenderbotSmallForConditionalGeneration"),Mi=r(" forward method, overrides the "),Ma=n("code"),Ci=r("__call__"),ji=r(" special method."),Oi=i(),y(Uo.$$.fragment),Pi=i(),Ca=n("p"),Li=r("Conversation example::"),Ni=i(),ja=n("blockquote"),Oa=n("blockquote"),Pa=n("blockquote"),La=n("p"),Ii=r(`from transformers import BlenderbotSmallTokenizer, TFBlenderbotSmallForConditionalGeneration >>> mname =
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),zc=i(),_n=n("p"),qc=r(`This model is also a Flax Linen
`),gn=n("a"),Fc=r("flax.nn.Module"),Ec=r(` subclass. Use it as a
...
tokenizer([ARTICLE_TO_SUMMARIZE], max_length=1024, return_tensors=\u2018np\u2019)`),ap=i(),qs=n("blockquote"),Fs=n("blockquote"),wn=n("blockquote"),Zo=n("h1"),et=n("a"),Es=n("span"),y(Sn.$$.fragment),sp=i(),Ms=n("span"),rp=r("Generate Summary >>> summary_ids = model.generate(inputs[\u2018input_ids\u2019]).sequences >>>"),lp=i(),Cs=n("p"),dp=r("print(tokenizer.batch_decode(summary_ids, skip_special_tokens=True, clean_up_tokenization_spaces=False))"),ip=i(),js=n("p"),cp=r("Mask filling example:"),pp=i(),Os=n("blockquote"),Ps=n("blockquote"),Ls=n("blockquote"),Ns=n("p"),mp=r(`from transformers import BlenderbotSmallTokenizer, FlaxBlenderbotSmallForConditionalGeneration >>>
...
found `),G=a(Qn,"A",{href:!0,rel:!0});var Bp=s(G);to=l(Bp,"here"),Bp.forEach(o),no=l(Qn," ."),Qn.forEach(o),oe=c(t),ce=a(t,"H2",{class:!0});var Fr=s(ce);fe=a(Fr,"A",{id:!0,class:!0,href:!0});var zp=s(fe);ve=a(zp,"SPAN",{});var qp=s(ve);v(Te.$$.fragment,qp),qp.forEach(o),zp.forEach(o),ml=c(Fr),ra=a(Fr,"SPAN",{});var Fp=s(ra);ul=l(Fp,"BlenderbotSmallConfig"),Fp.forEach(o),Fr.forEach(o),cr=c(t),we=a(t,"DIV",{class:!0});var st=s(we);v(ut.$$.fragment,st),hl=c(st),ao=a(st,"P",{});var Vn=s(ao);fl=l(Vn,"This is the configuration class to store the configuration of a "),En=a(Vn,"A",{href:!0});var Ep=s(En);_l=l(Ep,"BlenderbotSmallModel"),Ep.forEach(o),gl=l(Vn,`. It is used to instantiate
an BlenderbotSmall model according to the specified arguments, defining the model architecture. Instantiating a
configuration with the defaults will yield a similar configuration to that of the BlenderbotSmall
...
documentation from `),Cn=a(Jn,"A",{href:!0});var jp=s(Cn);Sl=l(jp,"PretrainedConfig"),jp.forEach(o),$l=l(Jn," for more information."),Jn.forEach(o),xl=c(st),v(wo.$$.fragment,st),st.forEach(o),pr=c(t),ro=a(t,"H2",{class:!0});var Er=s(ro);So=a(Er,"A",{id:!0,class:!0,href:!0});var Op=s(So);la=a(Op,"SPAN",{});var Pp=s(la);v(ft.$$.fragment,Pp),Pp.forEach(o),Op.forEach(o),Bl=c(Er),da=a(Er,"SPAN",{});var Lp=s(da);zl=l(Lp,"BlenderbotSmallTokenizer"),Lp.forEach(o),Er.forEach(o),mr=c(t),U=a(t,"DIV",{class:!0});var ge=s(U);v(_t.$$.fragment,ge),ql=c(ge),ia=a(ge,"P",{});var Np=s(ia);Fl=l(Np,"Constructs a Blenderbot-90M tokenizer based on BPE (Byte-Pair-Encoding)"),Np.forEach(o),El=c(ge),gt=a(ge,"P",{});var Mr=s(gt);Ml=l(Mr,"This tokenizer inherits from "),jn=a(Mr,"A",{href:!0});var Ip=s(jn);Cl=l(Ip,"PreTrainedTokenizer"),Ip.forEach(o),jl=l(Mr,` which contains most of the main methods. Users should refer to
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Nr.forEach(o),fd=c(rt),qt=a(rt,"P",{});var Ir=s(qt);_d=l(Ir,"This model is also a PyTorch "),Ft=a(Ir,"A",{href:!0,rel:!0});var tm=s(Ft);gd=l(tm,"torch.nn.Module"),tm.forEach(o),bd=l(Ir,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Ir.forEach(o),kd=c(rt),Fe=a(rt,"DIV",{class:!0});var lt=s(Fe);v(Et.$$.fragment,lt),yd=c(lt),po=a(lt,"P",{});var oa=s(po);vd=l(oa,"The "),In=a(oa,"A",{href:!0});var nm=s(In);Td=l(nm,"BlenderbotSmallModel"),nm.forEach(o),wd=l(oa," forward method, overrides the "),va=a(oa,"CODE",{});var am=s(va);Sd=l(am,"__call__"),am.forEach(o),$d=l(oa," special method."),oa.forEach(o),xd=c(lt),v(qo.$$.fragment,lt),Bd=c(lt),v(Fo.$$.fragment,lt),lt.forEach(o),rt.forEach(o),gr=c(t),mo=a(t,"H2",{class:!0});var Ar=s(mo);Eo=a(Ar,"A",{id:!0,class:!0,href:!0});var sm=s(Eo);Ta=a(sm,"SPAN",{});var rm=s(Ta);v(Mt.$$.fragment,rm),rm.forEach(o),sm.forEach(o),zd=c(Ar),wa=a(Ar,"SPAN",{});var lm=s(wa);qd=l(lm,"BlenderbotSmallForConditionalGeneration"),lm.forEach(o),Ar.forEach(o),br=c(t),$e=a(t,"DIV",{class:!0});var dt=s($e);v(Ct.$$.fragment,dt),Fd=c(dt),jt=a(dt,"P",{});var Dr=s(jt);Ed=l(Dr,`The BlenderbotSmall Model with a language modeling head. Can be used for summarization.
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Qr.forEach(o),li=c(Qe),v(No.$$.fragment,Qe),di=c(Qe),Me=a(Qe,"DIV",{class:!0});var ct=s(Me);v(Ht.$$.fragment,ct),ii=c(ct),go=a(ct,"P",{});var na=s(go);ci=l(na,"The "),Un=a(na,"A",{href:!0});var ym=s(Un);pi=l(ym,"TFBlenderbotSmallModel"),ym.forEach(o),mi=l(na," forward method, overrides the "),qa=a(na,"CODE",{});var vm=s(qa);ui=l(vm,"__call__"),vm.forEach(o),hi=l(na," special method."),na.forEach(o),fi=c(ct),v(Io.$$.fragment,ct),_i=c(ct),v(Ao.$$.fragment,ct),ct.forEach(o),Qe.forEach(o),wr=c(t),bo=a(t,"H2",{class:!0});var Vr=s(bo);Do=a(Vr,"A",{id:!0,class:!0,href:!0});var Tm=s(Do);Fa=a(Tm,"SPAN",{});var wm=s(Fa);v(Kt.$$.fragment,wm),wm.forEach(o),Tm.forEach(o),gi=c(Vr),Ea=a(Vr,"SPAN",{});var Sm=s(Ea);bi=l(Sm,"TFBlenderbotSmallForConditionalGeneration"),Sm.forEach(o),Vr.forEach(o),Sr=c(t),me=a(t,"DIV",{class:!0});var Ve=s(me);v(Qt.$$.fragment,Ve),ki=c(Ve),Vt=a(Ve,"P",{});var Jr=s(Vt);yi=l(Jr,`The BLENDERBOT_SMALL Model with a language modeling head. Can be used for summarization.
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Xr.forEach(o),Bi=c(Ve),v(Go.$$.fragment,Ve),zi=c(Ve),P=a(Ve,"DIV",{class:!0});var K=s(P);v(Yt.$$.fragment,K),qi=c(K),ko=a(K,"P",{});var aa=s(ko);Fi=l(aa,"The "),Rn=a(aa,"A",{href:!0});var Bm=s(Rn);Ei=l(Bm,"TFBlenderbotSmallForConditionalGeneration"),Bm.forEach(o),Mi=l(aa," forward method, overrides the "),Ma=a(aa,"CODE",{});var zm=s(Ma);Ci=l(zm,"__call__"),zm.forEach(o),ji=l(aa," special method."),aa.forEach(o),Oi=c(K),v(Uo.$$.fragment,K),Pi=c(K),Ca=a(K,"P",{});var qm=s(Ca);Li=l(qm,"Conversation example::"),qm.forEach(o),Ni=c(K),ja=a(K,"BLOCKQUOTE",{});var Fm=s(ja);Oa=a(Fm,"BLOCKQUOTE",{});var Em=s(Oa);Pa=a(Em,"BLOCKQUOTE",{});var Mm=s(Pa);La=a(Mm,"P",{});var Cm=s(La);Ii=l(Cm,`from transformers import BlenderbotSmallTokenizer, TFBlenderbotSmallForConditionalGeneration >>> mname =
\u2018facebook/blenderbot_small-90M\u2019 >>> model = BlenderbotSmallForConditionalGeneration.from_pretrained(mname) >>>
