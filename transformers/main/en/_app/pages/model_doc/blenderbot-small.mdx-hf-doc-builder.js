import{S as dh,i as ih,s as ch,e as n,k as i,w as y,t as r,M as ph,c as a,d as o,m as c,a as s,x as v,h as l,b as m,G as e,g as _,y as T,q as w,o as $,B as S,v as mh,L as Xe}from"../../chunks/vendor-hf-doc-builder.js";import{T as qn}from"../../chunks/Tip-hf-doc-builder.js";import{D as C}from"../../chunks/Docstring-hf-doc-builder.js";import{C as Ye}from"../../chunks/CodeBlock-hf-doc-builder.js";import{I as xe}from"../../chunks/IconCopyLink-hf-doc-builder.js";import{E as Je}from"../../chunks/ExampleCodeBlock-hf-doc-builder.js";function uh(z){let p,k,f,u,b;return u=new Ye({props:{code:`from transformers import BlenderbotSmallModel, BlenderbotSmallConfig
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),{c(){p=n("p"),k=r("Example:"),f=i(),y(u.$$.fragment)},l(d){p=a(d,"P",{});var h=s(p);k=l(h,"Example:"),h.forEach(o),f=c(d),v(u.$$.fragment,d)},m(d,h){_(d,p,h),e(p,k),_(d,f,h),T(u,d,h),b=!0},p:Xe,i(d){b||(w(u.$$.fragment,d),b=!0)},o(d){$(u.$$.fragment,d),b=!1},d(d){d&&o(p),d&&o(f),S(u,d)}}}function Th(z){let p,k,f,u,b,d,h,F,Ce,ue,B,je,W,Oe,Pe,R,Le,Ne,V,Q,Ie,Z,j,L,he,ae,Be,J,D,be,se,N,ke,re,ze,ee,le,de,Ae,X,Fe,H,De;return{c(){p=n("p"),k=r("TF 2.0 models accepts two formats as inputs:"),f=i(),u=n("ul"),b=n("li"),d=r("having all inputs as keyword arguments (like PyTorch models), or"),h=i(),F=n("li"),Ce=r("having all inputs as a list, tuple or dict in the first positional arguments."),ue=i(),B=n("p"),je=r("This second option is useful when using "),W=n("code"),Oe=r("tf.keras.Model.fit"),Pe=r(` method which currently requires having all the
tensors in the first argument of the model call function: `),R=n("code"),Le=r("model(inputs)"),Ne=r("."),V=i(),Q=n("p"),Ie=r(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),Z=i(),j=n("ul"),L=n("li"),he=r("a single Tensor with "),ae=n("code"),Be=r("input_ids"),J=r(" only and nothing else: "),D=n("code"),be=r("model(input_ids)"),se=i(),N=n("li"),ke=r(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),re=n("code"),ze=r("model([input_ids, attention_mask])"),ee=r(" or "),le=n("code"),de=r("model([input_ids, attention_mask, token_type_ids])"),Ae=i(),X=n("li"),Fe=r(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),H=n("code"),De=r('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(x){p=a(x,"P",{});var q=s(p);k=l(q,"TF 2.0 models accepts two formats as inputs:"),q.forEach(o),f=c(x),u=a(x,"UL",{});var ie=s(u);b=a(ie,"LI",{});var Ze=s(b);d=l(Ze,"having all inputs as keyword arguments (like PyTorch models), or"),Ze.forEach(o),h=c(ie),F=a(ie,"LI",{});var Re=s(F);Ce=l(Re,"having all inputs as a list, tuple or dict in the first positional arguments."),Re.forEach(o),ie.forEach(o),ue=c(x),B=a(x,"P",{});var O=s(B);je=l(O,"This second option is useful when using "),W=a(O,"CODE",{});var eo=s(W);Oe=l(eo,"tf.keras.Model.fit"),eo.forEach(o),Pe=l(O,` method which currently requires having all the
...
first positional argument :`),oo.forEach(o),Z=c(x),j=a(x,"UL",{});var Y=s(j);L=a(Y,"LI",{});var G=s(L);he=l(G,"a single Tensor with "),ae=a(G,"CODE",{});var to=s(ae);Be=l(to,"input_ids"),to.forEach(o),J=l(G," only and nothing else: "),D=a(G,"CODE",{});var no=s(D);be=l(no,"model(input_ids)"),no.forEach(o),G.forEach(o),se=c(Y),N=a(Y,"LI",{});var oe=s(N);ke=l(oe,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),re=a(oe,"CODE",{});var ce=s(re);ze=l(ce,"model([input_ids, attention_mask])"),ce.forEach(o),ee=l(oe," or "),le=a(oe,"CODE",{});var fe=s(le);de=l(fe,"model([input_ids, attention_mask, token_type_ids])"),fe.forEach(o),oe.forEach(o),Ae=c(Y),X=a(Y,"LI",{});var ve=s(X);Fe=l(ve,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),H=a(ve,"CODE",{});var Te=s(H);De=l(Te,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),Te.forEach(o),ve.forEach(o),Y.forEach(o)},m(x,q){_(x,p,q),e(p,k),_(x,f,q),_(x,u,q),e(u,b),e(b,d),e(u,h),e(u,F),e(F,Ce),_(x,ue,q),_(x,B,q),e(B,je),e(B,W),e(W,Oe),e(B,Pe),e(B,R),e(R,Le),e(B,Ne),_(x,V,q),_(x,Q,q),e(Q,Ie),_(x,Z,q),_(x,j,q),e(j,L),e(L,he),e(L,ae),e(ae,Be),e(L,J),e(L,D),e(D,be),e(j,se),e(j,N),e(N,ke),e(N,re),e(re,ze),e(N,ee),e(N,le),e(le,de),e(j,Ae),e(j,X),e(X,Fe),e(X,H),e(H,De)},d(x){x&&o(p),x&&o(f),x&&o(u),x&&o(ue),x&&o(B),x&&o(V),x&&o(Q),x&&o(Z),x&&o(j)}}}function wh(z){let p,k,f,u,b;return{c(){p=n("p"),k=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=n("code"),u=r("Module"),b=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(d){p=a(d,"P",{});var h=s(p);k=l(h,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=a(h,"CODE",{});var F=s(f);u=l(F,"Module"),F.forEach(o),b=l(h,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_decoder_hidden_states = outputs.last_hidden_state`}}),{c(){p=n("p"),k=r("Example:"),f=i(),y(u.$$.fragment)},l(d){p=a(d,"P",{});var h=s(p);k=l(h,"Example:"),h.forEach(o),f=c(d),v(u.$$.fragment,d)},m(d,h){_(d,p,h),e(p,k),_(d,f,h),T(u,d,h),b=!0},p:Xe,i(d){b||(w(u.$$.fragment,d),b=!0)},o(d){$(u.$$.fragment,d),b=!1},d(d){d&&o(p),d&&o(f),S(u,d)}}}function Bh(z){let p,k,f,u,b;return{c(){p=n("p"),k=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=n("code"),u=r("Module"),b=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(d){p=a(d,"P",{});var h=s(p);k=l(h,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=a(h,"CODE",{});var F=s(f);u=l(F,"Module"),F.forEach(o),b=l(h,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
behaviors between training and evaluation).`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/blenderbot_small/modeling_tf_blenderbot_small.py#L1141",returnDescription:`
<p>A <a
...
Labels for computing the masked language modeling loss. Indices should either be in <code>[0, ..., config.vocab_size]</code> or -100 (see <code>input_ids</code> docstring). Tokens with indices set to <code>-100</code> are ignored
(masked), the loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/blenderbot_small/modeling_tf_blenderbot_small.py#L1249",returnDescription:`
<p>A <a
...
`}}),at=new Je({props:{anchor:"transformers.FlaxBlenderbotSmallForConditionalGeneration.decode.example",$$slots:{default:[Fh]},$$scope:{ctx:z}}}),{c(){p=n("meta"),k=i(),f=n("h1"),u=n("a"),b=n("span"),y(d.$$.fragment),h=i(),F=n("span"),Ce=r("Blenderbot Small"),ue=i(),B=n("p"),je=r("Note that "),W=n("a"),Oe=r("BlenderbotSmallModel"),Pe=r(` and
...
`),he=n("a"),ae=r("BlenderbotForConditionalGeneration"),Be=i(),J=n("h2"),D=n("a"),be=n("span"),y(se.$$.fragment),N=i(),ke=n("span"),re=r("Overview"),ze=i(),ee=n("p"),le=r("The Blender chatbot model was proposed in "),de=n("a"),Ae=r("Recipes for building an open-domain chatbot"),X=r(` Stephen Roller, Emily Dinan, Naman Goyal, Da Ju, Mary Williamson, Yinhan Liu,
...
special tokens using the tokenizer `),ma=n("code"),Ul=r("prepare_for_model"),Wl=r(" or "),ua=n("code"),Rl=r("encode_plus"),Hl=r(" methods."),Kl=i(),Ke=n("div"),y(yt.$$.fragment),Vl=i(),On=n("p"),Ql=r("Create the token type IDs corresponding to the sequences passed. "),Pn=n("a"),Jl=r(`What are token type
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Nd=i(),Ee=n("div"),y(Lt.$$.fragment),Id=i(),uo=n("p"),Ad=r("The "),Dn=n("a"),Dd=r("BlenderbotSmallForConditionalGeneration"),Gd=r(" forward method, overrides the "),$a=n("code"),Ud=r("__call__"),Wd=r(" special method."),Rd=i(),y(Mo.$$.fragment),Hd=i(),y(Co.$$.fragment),kr=i(),ho=n("h2"),jo=n("a"),Sa=n("span"),y(Nt.$$.fragment),Kd=i(),xa=n("span"),Vd=r("BlenderbotSmallForCausalLM"),yr=i(),fo=n("div"),y(It.$$.fragment),Qd=i(),Oo=n("div"),y(At.$$.fragment),Jd=i(),y(Po.$$.fragment),vr=i(),_o=n("h2"),Lo=n("a"),Ba=n("span"),y(Dt.$$.fragment),Xd=i(),za=n("span"),Yd=r("TFBlenderbotSmallModel"),Tr=i(),pe=n("div"),y(Gt.$$.fragment),Zd=i(),Ut=n("p"),ei=r(`The bare BLENDERBOT_SMALL Model outputting raw hidden-states without any specific head on top.
...
jax.nn.softmax(logits[0, masked_index], axis=0) >>> values, predictions = jax.lax.top_k(probs)`),gp=i(),Ks=n("blockquote"),Vs=n("blockquote"),Qs=n("blockquote"),Js=n("p"),bp=r("tokenizer.decode(predictions).split()"),kp=i(),ot=n("div"),y(Sn.$$.fragment),yp=i(),y(tt.$$.fragment),vp=i(),nt=n("div"),y(xn.$$.fragment),Tp=i(),y(at.$$.fragment),this.h()},l(t){const g=ph('[data-svelte="svelte-1phssyn"]',document.head);p=a(g,"META",{name:!0,content:!0}),g.forEach(o),k=c(t),f=a(t,"H1",{class:!0});var Bn=s(f);u=a(Bn,"A",{id:!0,class:!0,href:!0});var Xs=s(u);b=a(Xs,"SPAN",{});var Ys=s(b);v(d.$$.fragment,Ys),Ys.forEach(o),Xs.forEach(o),h=c(Bn),F=a(Bn,"SPAN",{});var Zs=s(F);Ce=l(Zs,"Blenderbot Small"),Zs.forEach(o),Bn.forEach(o),ue=c(t),B=a(t,"P",{});var _e=s(B);je=l(_e,"Note that "),W=a(_e,"A",{href:!0});var er=s(W);Oe=l(er,"BlenderbotSmallModel"),er.forEach(o),Pe=l(_e,` and
...
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),ol.forEach(o),rc=c(te),ts=a(te,"P",{});var ou=s(ts);lc=l(ou,"Finally, this model supports inherent JAX features such as:"),ou.forEach(o),dc=c(te),Ue=a(te,"UL",{});var pt=s(Ue);ns=a(pt,"LI",{});var tu=s(ns);sn=a(tu,"A",{href:!0,rel:!0});var nu=s(sn);ic=l(nu,"Just-In-Time (JIT) compilation"),nu.forEach(o),tu.forEach(o),cc=c(pt),as=a(pt,"LI",{});var au=s(as);rn=a(au,"A",{href:!0,rel:!0});var su=s(rn);pc=l(su,"Automatic Differentiation"),su.forEach(o),au.forEach(o),mc=c(pt),ss=a(pt,"LI",{});var ru=s(ss);ln=a(ru,"A",{href:!0,rel:!0});var lu=s(ln);uc=l(lu,"Vectorization"),lu.forEach(o),ru.forEach(o),hc=c(pt),rs=a(pt,"LI",{});var du=s(rs);dn=a(du,"A",{href:!0,rel:!0});var iu=s(dn);fc=l(iu,"Parallelization"),iu.forEach(o),du.forEach(o),pt.forEach(o),_c=c(te),Ro=a(te,"DIV",{class:!0});var tl=s(Ro);v(cn.$$.fragment,tl),gc=c(tl),v(Ho.$$.fragment,tl),tl.forEach(o),bc=c(te),Ko=a(te,"DIV",{class:!0});var nl=s(Ko);v(pn.$$.fragment,nl),kc=c(nl),v(Vo.$$.fragment,nl),nl.forEach(o),yc=c(te),Qo=a(te,"DIV",{class:!0});var al=s(Qo);v(mn.$$.fragment,al),vc=c(al),v(Jo.$$.fragment,al),al.forEach(o),te.forEach(o),Br=c(t),vo=a(t,"H2",{class:!0});var sl=s(vo);Xo=a(sl,"A",{id:!0,class:!0,href:!0});var cu=s(Xo);ls=a(cu,"SPAN",{});var pu=s(ls);v(un.$$.fragment,pu),pu.forEach(o),cu.forEach(o),Tc=c(sl),ds=a(sl,"SPAN",{});var mu=s(ds);wc=l(mu,"FlaxBlenderbotForConditionalGeneration"),mu.forEach(o),sl.forEach(o),zr=c(t),A=a(t,"DIV",{class:!0});var ne=s(A);v(hn.$$.fragment,ne),$c=c(ne),fn=a(ne,"P",{});var rl=s(fn);Sc=l(rl,`The BLENDERBOT_SMALL Model with a language modeling head. Can be used for summarization.
This model inherits from `),Kn=a(rl,"A",{href:!0});var uu=s(Kn);xc=l(uu,"FlaxPreTrainedModel"),uu.forEach(o),Bc=l(rl,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
