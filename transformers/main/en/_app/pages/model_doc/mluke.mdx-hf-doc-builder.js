import{S as tn,i as nn,s as on,e as o,k as p,w as E,t as r,M as sn,c as s,d as n,m,a as i,x as $,h as a,b as l,G as t,g as d,y as P,L as rn,q as A,o as N,B as I,v as an}from"../../chunks/vendor-316217a5.js";import{D as xt}from"../../chunks/Docstring-1fe4a33a.js";import{C as en}from"../../chunks/CodeBlock-8418a95e.js";import{I as qt}from"../../chunks/IconCopyLink-40460835.js";function ln(zt){let k,fe,y,w,ae,U,We,le,Ke,ge,v,T,ce,S,Re,de,De,_e,f,Fe,W,Oe,Be,K,je,Xe,ke,V,Ce,ye,G,Ye,ve,J,pe,He,be,Q,Ve,we,R,Te,L,Ge,Z,Je,Qe,Le,D,xe,x,Ze,ee,et,tt,qe,g,nt,F,ot,st,O,it,rt,ze,b,q,me,B,at,ue,lt,Me,u,j,ct,h,dt,te,pt,mt,ne,ut,ht,X,ft,gt,_t,C,kt,oe,yt,vt,bt,z,Y,wt,he,Tt,Lt,se,H,Ee;return U=new qt({}),S=new qt({}),R=new en({props:{code:`from transformers import LukeModel
...
knowledge more likely than using only word representations.`),be=p(),Q=o("p"),Ve=r("One can directly plug in the weights of mLUKE into a LUKE model, like so:"),we=p(),E(R.$$.fragment),Te=p(),L=o("p"),Ge=r("Note that mLUKE has its own tokenizer, "),Z=o("a"),Je=r("MLukeTokenizer"),Qe=r(". You can initialize it as follows:"),Le=p(),E(D.$$.fragment),xe=p(),x=o("p"),Ze=r("As mLUKE\u2019s architecture is equivalent to that of LUKE, one can refer to "),ee=o("a"),et=r("LUKE\u2019s documentation page"),tt=r(` for all
...
`),X=s(M,"A",{href:!0,rel:!0});var Gt=i(X);ft=a(Gt,"SentencePiece"),Gt.forEach(n),gt=a(M,"."),M.forEach(n),_t=m(_),C=s(_,"P",{});var Ue=i(C);kt=a(Ue,"This tokenizer inherits from "),oe=s(Ue,"A",{href:!0});var Jt=i(oe);yt=a(Jt,"PreTrainedTokenizer"),Jt.forEach(n),vt=a(Ue,` which contains most of the main methods. Users should refer to
