import{S as tn,i as nn,s as on,e as o,k as p,w as M,t as r,M as sn,c as s,d as n,m,a as i,x as $,h as a,b as l,G as t,g as d,y as P,L as rn,q as A,o as N,B as I,v as an}from"../../chunks/vendor-hf-doc-builder.js";import{D as xt}from"../../chunks/Docstring-hf-doc-builder.js";import{C as en}from"../../chunks/CodeBlock-hf-doc-builder.js";import{I as qt}from"../../chunks/IconCopyLink-hf-doc-builder.js";function ln(zt){let k,fe,y,w,ae,U,We,le,Ke,ge,v,T,ce,S,Re,de,De,_e,f,Fe,W,Oe,Be,K,je,Xe,ke,V,Ce,ye,G,Ye,ve,J,pe,He,be,Q,Ve,we,R,Te,L,Ge,Z,Je,Qe,Le,D,xe,x,Ze,ee,et,tt,qe,g,nt,F,ot,st,O,it,rt,ze,b,q,me,B,at,ue,lt,Ee,u,j,ct,h,dt,te,pt,mt,ne,ut,ht,X,ft,gt,_t,C,kt,oe,yt,vt,bt,z,Y,wt,he,Tt,Lt,se,H,Me;return U=new qt({}),S=new qt({}),R=new en({props:{code:"",highlighted:`<span class="hljs-keyword">from</span> transformers <span class="hljs-keyword">import</span> LukeModel
...
**kwargs &#x2014; passed to the <code>self.tokenize()</code> method`,name:"verbose"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/mluke/tokenization_mluke.py#L367",returnDescription:`
<p>A <a
...
sequences, depending on the task you want to prepare them for.`),Lt=p(),se=o("div"),M(H.$$.fragment),this.h()},l(e){const c=sn('[data-svelte="svelte-1phssyn"]',document.head);k=s(c,"META",{name:!0,content:!0}),c.forEach(n),fe=m(e),y=s(e,"H1",{class:!0});var $e=i(y);w=s($e,"A",{id:!0,class:!0,href:!0});var Et=i(w);ae=s(Et,"SPAN",{});var Mt=i(ae);$(U.$$.fragment,Mt),Mt.forEach(n),Et.forEach(n),We=m($e),le=s($e,"SPAN",{});var $t=i(le);Ke=a($t,"mLUKE"),$t.forEach(n),$e.forEach(n),ge=m(e),v=s(e,"H2",{class:!0});var Pe=i(v);T=s(Pe,"A",{id:!0,class:!0,href:!0});var Pt=i(T);ce=s(Pt,"SPAN",{});var At=i(ce);$(S.$$.fragment,At),At.forEach(n),Pt.forEach(n),Re=m(Pe),de=s(Pe,"SPAN",{});var Nt=i(de);De=a(Nt,"Overview"),Nt.forEach(n),Pe.forEach(n),_e=m(e),f=s(e,"P",{});var ie=i(f);Fe=a(ie,"The mLUKE model was proposed in "),W=s(ie,"A",{href:!0,rel:!0});var It=i(W);Oe=a(It,"mLUKE: The Power of Entity Representations in Multilingual Pretrained Language Models"),It.forEach(n),Be=a(ie,` by Ryokan Ri, Ikuya Yamada, and Yoshimasa Tsuruoka. It\u2019s a multilingual extension
...
representations into the input allows us to extract more language-agnostic features. We also evaluate the model with a
multilingual cloze prompt task with the mLAMA dataset. We show that entity-based prompt elicits correct factual
knowledge more likely than using only word representations.`),Rt.forEach(n),Kt.forEach(n),be=m(e),Q=s(e,"P",{});var Dt=i(Q);Ve=a(Dt,"One can directly plug in the weights of mLUKE into a LUKE model, like so:"),Dt.forEach(n),we=m(e),$(R.$$.fragment,e),Te=m(e),L=s(e,"P",{});var Ae=i(L);Ge=a(Ae,"Note that mLUKE has its own tokenizer, "),Z=s(Ae,"A",{href:!0});var Ft=i(Z);Je=a(Ft,"MLukeTokenizer"),Ft.forEach(n),Qe=a(Ae,". You can initialize it as follows:"),Ae.forEach(n),Le=m(e),$(D.$$.fragment,e),xe=m(e),x=s(e,"P",{});var Ne=i(x);Ze=a(Ne,"As mLUKE\u2019s architecture is equivalent to that of LUKE, one can refer to "),ee=s(Ne,"A",{href:!0});var Ot=i(ee);et=a(Ot,"LUKE\u2019s documentation page"),Ot.forEach(n),tt=a(Ne,` for all
tips, code examples and notebooks.`),Ne.forEach(n),qe=m(e),g=s(e,"P",{});var re=i(g);nt=a(re,"This model was contributed by "),F=s(re,"A",{href:!0,rel:!0});var Bt=i(F);ot=a(Bt,"ryo0634"),Bt.forEach(n),st=a(re,". The original code can be found "),O=s(re,"A",{href:!0,rel:!0});var jt=i(O);it=a(jt,"here"),jt.forEach(n),rt=a(re,"."),re.forEach(n),ze=m(e),b=s(e,"H2",{class:!0});var Ie=i(b);q=s(Ie,"A",{id:!0,class:!0,href:!0});var Xt=i(q);me=s(Xt,"SPAN",{});var Ct=i(me);$(B.$$.fragment,Ct),Ct.forEach(n),Xt.forEach(n),at=m(Ie),ue=s(Ie,"SPAN",{});var Yt=i(ue);lt=a(Yt,"MLukeTokenizer"),Yt.forEach(n),Ie.forEach(n),Ee=m(e),u=s(e,"DIV",{class:!0});var _=i(u);$(j.$$.fragment,_),ct=m(_),h=s(_,"P",{});var E=i(h);dt=a(E,"Adapted from "),te=s(E,"A",{href:!0});var Ht=i(te);pt=a(Ht,"XLMRobertaTokenizer"),Ht.forEach(n),mt=a(E," and "),ne=s(E,"A",{href:!0});var Vt=i(ne);ut=a(Vt,"LukeTokenizer"),Vt.forEach(n),ht=a(E,`. Based on
`),X=s(E,"A",{href:!0,rel:!0});var Gt=i(X);ft=a(Gt,"SentencePiece"),Gt.forEach(n),gt=a(E,"."),E.forEach(n),_t=m(_),C=s(_,"P",{});var Ue=i(C);kt=a(Ue,"This tokenizer inherits from "),oe=s(Ue,"A",{href:!0});var Jt=i(oe);yt=a(Jt,"PreTrainedTokenizer"),Jt.forEach(n),vt=a(Ue,` which contains most of the main methods. Users should refer to
