...
See <a href="/docs/transformers/main/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and <a href="/docs/transformers/main/en/model_doc/wav2vec2#transformers.Wav2Vec2CTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
target text format is `),_o=n("code"),$a=r("[tgt_lang_code] X [eos]"),xa=r(". "),bo=n("code"),Ca=r("bos"),ja=r(" is never used."),un=l(),_e=n("p"),Fa=r("However, for fine-tuning, in some cases no language token is provided in cases where a single language is used. Please refer to "),Ie=n("a"),Ea=r("the paper"),Ma=r(" to learn more about this."),mn=l(),R=n("p"),Sa=r("In cases where the language code is needed, The regular "),Oe=n("a"),ko=n("strong"),Aa=r("call"),Na=r("()"),Ia=r(` will encode source text format, and it should be wrapped
inside the context manager `),At=n("a"),Oa=r("as_target_tokenizer()"),Da=r(" to encode target text format."),fn=l(),Nt=n("ul"),vo=n("li"),Xa=r("Supervised training"),gn=l(),m(De.$$.fragment),_n=l(),It=n("ul"),Xe=n("li"),To=n("p"),Wa=r("Generation"),Ga=l(),ee=n("p"),Ra=r("While generating the target text set the "),yo=n("code"),Ha=r("decoder_start_token_id"),Ua=r(` to the target language id. The following
...
adding special tokens. An PLBART sequence has the following format, where `),Fo=n("code"),Ns=r("X"),Is=r(" represents the sequence:"),Os=l(),ot=n("ul"),nt=n("li"),Eo=n("code"),Ds=r("input_ids"),Xs=r(" (for encoder) "),Mo=n("code"),Ws=r("X [eos, src_lang_code]"),Gs=l(),at=n("li"),So=n("code"),Rs=r("decoder_input_ids"),Hs=r(": (for decoder) "),Ao=n("code"),Us=r("X [eos, tgt_lang_code]"),Vs=l(),No=n("p"),Js=r(`BOS is never used. Pairs of sequences are not the expected use case, but they will be handled without a
...
target text format is `),_o=a(U,"CODE",{});var Ii=s(_o);$a=i(Ii,"[tgt_lang_code] X [eos]"),Ii.forEach(o),xa=i(U,". "),bo=a(U,"CODE",{});var Oi=s(bo);Ca=i(Oi,"bos"),Oi.forEach(o),ja=i(U," is never used."),U.forEach(o),un=c(t),_e=a(t,"P",{});var En=s(_e);Fa=i(En,"However, for fine-tuning, in some cases no language token is provided in cases where a single language is used. Please refer to "),Ie=a(En,"A",{href:!0,rel:!0});var Di=s(Ie);Ea=i(Di,"the paper"),Di.forEach(o),Ma=i(En," to learn more about this."),En.forEach(o),mn=c(t),R=a(t,"P",{});var Zt=s(R);Sa=i(Zt,"In cases where the language code is needed, The regular "),Oe=a(Zt,"A",{href:!0});var bi=s(Oe);ko=a(bi,"STRONG",{});var Xi=s(ko);Aa=i(Xi,"call"),Xi.forEach(o),Na=i(bi,"()"),bi.forEach(o),Ia=i(Zt,` will encode source text format, and it should be wrapped
inside the context manager `),At=a(Zt,"A",{href:!0});var Wi=s(At);Oa=i(Wi,"as_target_tokenizer()"),Wi.forEach(o),Da=i(Zt," to encode target text format."),Zt.forEach(o),fn=c(t),Nt=a(t,"UL",{});var Gi=s(Nt);vo=a(Gi,"LI",{});var Ri=s(vo);Xa=i(Ri,"Supervised training"),Ri.forEach(o),Gi.forEach(o),gn=c(t),f(De.$$.fragment,t),_n=c(t),It=a(t,"UL",{});var Hi=s(It);Xe=a(Hi,"LI",{});var Mn=s(Xe);To=a(Mn,"P",{});var Ui=s(To);Wa=i(Ui,"Generation"),Ui.forEach(o),Ga=c(Mn),ee=a(Mn,"P",{});var eo=s(ee);Ra=i(eo,"While generating the target text set the "),yo=a(eo,"CODE",{});var Vi=s(yo);Ha=i(Vi,"decoder_start_token_id"),Vi.forEach(o),Ua=i(eo,` to the target language id. The following
...
separator.`),kd.forEach(o),$e.forEach(o),$.forEach(o),wn=c(t),se=a(t,"H2",{class:!0});var Gn=s(se);Te=a(Gn,"A",{id:!0,class:!0,href:!0});var vd=s(Te);Io=a(vd,"SPAN",{});var Td=s(Io);f(st.$$.fragment,Td),Td.forEach(o),vd.forEach(o),Ks=c(Gn),Oo=a(Gn,"SPAN",{});var yd=s(Oo);Qs=i(yd,"PLBartModel"),yd.forEach(o),Gn.forEach(o),Pn=c(t),S=a(t,"DIV",{class:!0});var xe=s(S);f(rt.$$.fragment,xe),Ys=c(xe),it=a(xe,"P",{});var Rn=s(it);Zs=i(Rn,`The bare PLBART Model outputting raw hidden-states without any specific head on top.
...
classification.`),Id.forEach(o),Xr=c(Q),Tt=a(Q,"P",{});var Qn=s(Tt);Wr=i(Qn,"This model inherits from "),Jt=a(Qn,"A",{href:!0});var Od=s(Jt);Gr=i(Od,"PreTrainedModel"),Od.forEach(o),Rr=i(Qn,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
