...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_state = outputs.last_hidden_state`}}),{c(){d=s("p"),x=i("Examples:"),g=f(),b(m.$$.fragment)},l(n){d=a(n,"P",{});var p=r(d);x=l(p,"Examples:"),p.forEach(o),g=h(n),P(m.$$.fragment,n)},m(n,p){_(n,d,p),e(d,x),_(n,g,p),C(m,n,p),v=!0},p:qt,i(n){v||($(m.$$.fragment,n),v=!0)},o(n){I(m.$$.fragment,n),v=!1},d(n){n&&o(d),n&&o(g),w(m,n)}}}function hl(y){let d,x,g,m,v,n,p,L,Gn,nn,H,he,$o,Ge,Un,Io,Jn,sn,S,Kn,Ue,Zn,Qn,Vt,Yn,es,an,Ot,ts,rn,Dt,wo,os,ln,Ft,ns,dn,ue,Je,ss,St,as,rs,is,Ke,ls,Ze,ds,cs,cn,ge,Sr,pn,Qe,ps,Nt,ms,mn,N,fs,Ye,hs,us,et,gs,_s,fn,G,_e,yo,tt,vs,Lo,xs,hn,T,ot,bs,To,Ps,Cs,k,Wt,$s,Is,Bt,ws,ys,Rt,Ls,Ts,jo,js,Xs,Ht,ks,Ms,Es,ve,nt,zs,st,qs,Gt,As,Vs,Os,xe,at,Ds,rt,Fs,Ut,Ss,Ns,un,U,be,Xo,it,Ws,ko,Bs,gn,M,lt,Rs,W,Jt,Hs,Gs,Kt,Us,Js,dt,Ks,Zs,Qs,J,Ys,Zt,ea,ta,Qt,oa,na,sa,Pe,ct,aa,pt,ra,Yt,ia,la,_n,K,Ce,Mo,mt,da,Eo,ca,vn,E,ft,pa,Z,ma,eo,fa,ha,ht,ua,ga,_a,Q,va,to,xa,ba,oo,Pa,Ca,$a,$e,xn,Y,Ie,zo,ut,Ia,qo,wa,bn,z,gt,ya,ee,La,no,Ta,ja,_t,Xa,ka,Ma,te,Ea,so,za,qa,ao,Aa,Va,Oa,we,Pn,oe,ye,Ao,vt,Da,Vo,Fa,Cn,j,xt,Sa,bt,Na,Pt,Wa,Ba,Ra,q,Ct,Ha,ne,Ga,ro,Ua,Ja,Oo,Ka,Za,Qa,Le,Ya,Te,er,A,$t,tr,se,or,io,nr,sr,Do,ar,rr,ir,je,lr,Xe,dr,V,It,cr,ae,pr,lo,mr,fr,Fo,hr,ur,gr,ke,_r,Me,$n,re,Ee,So,wt,vr,No,xr,In,ie,yt,br,O,Lt,Pr,le,Cr,co,$r,Ir,Wo,wr,yr,Lr,ze,Tr,qe,wn,de,Ae,Bo,Tt,jr,Ro,Xr,yn,ce,jt,kr,D,Xt,Mr,pe,Er,po,zr,qr,Ho,Ar,Vr,Or,Ve,Dr,Oe,Ln;return n=new fe({}),Ge=new fe({}),tt=new fe({}),ot=new X({props:{name:"class transformers.XCLIPProcessor",anchor:"transformers.XCLIPProcessor",parameters:[{name:"feature_extractor",val:""},{name:"tokenizer",val:""}],parametersDescription:[{anchor:"transformers.XCLIPProcessor.feature_extractor",description:`<strong>feature_extractor</strong> (<a href="/docs/transformers/main/en/model_doc/videomae#transformers.models.videomae.image_processing_videomae.VideoMAEImageProcessor">VideoMAEFeatureExtractor</a>) &#x2014;
...
The tokenizer is a required input.`,name:"tokenizer"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/x_clip/processing_x_clip.py#L22"}}),nt=new X({props:{name:"batch_decode",anchor:"transformers.XCLIPProcessor.batch_decode",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/x_clip/processing_x_clip.py#L97"}}),at=new X({props:{name:"decode",anchor:"transformers.XCLIPProcessor.decode",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/x_clip/processing_x_clip.py#L104"}}),it=new fe({}),lt=new X({props:{name:"class transformers.XCLIPConfig",anchor:"transformers.XCLIPConfig",parameters:[{name:"text_config",val:" = None"},{name:"vision_config",val:" = None"},{name:"projection_dim",val:" = 512"},{name:"prompt_layers",val:" = 2"},{name:"prompt_alpha",val:" = 0.1"},{name:"prompt_hidden_act",val:" = 'quick_gelu'"},{name:"prompt_num_attention_heads",val:" = 8"},{name:"prompt_attention_dropout",val:" = 0.0"},{name:"prompt_projection_dropout",val:" = 0.0"},{name:"logit_scale_init_value",val:" = 2.6592"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.XCLIPConfig.text_config",description:`<strong>text_config</strong> (<code>dict</code>, <em>optional</em>) &#x2014;
Dictionary of configuration options used to initialize <a href="/docs/transformers/main/en/model_doc/xclip#transformers.XCLIPTextConfig">XCLIPTextConfig</a>.`,name:"text_config"},{anchor:"transformers.XCLIPConfig.vision_config",description:`<strong>vision_config</strong> (<code>dict</code>, <em>optional</em>) &#x2014;
Dictionary of configuration options used to initialize <a href="/docs/transformers/main/en/model_doc/xclip#transformers.XCLIPVisionConfig">XCLIPVisionConfig</a>.`,name:"vision_config"},{anchor:"transformers.XCLIPConfig.projection_dim",description:`<strong>projection_dim</strong> (<code>int</code>, <em>optional</em>, defaults to 512) &#x2014;
...
Pixel values. Padding will be ignored by default should you provide it. Pixel values can be obtained using
<a href="/docs/transformers/main/en/model_doc/clip#transformers.models.clip.image_processing_clip.CLIPImageProcessor">CLIPFeatureExtractor</a>. See <a href="/docs/transformers/main/en/model_doc/layoutlmv2#transformers.models.layoutlmv2.image_processing_layoutlmv2.LayoutLMv2ImageProcessor.__call__">CLIPFeatureExtractor.<strong>call</strong>()</a> for details.`,name:"pixel_values"},{anchor:"transformers.XCLIPModel.get_video_features.output_attentions",description:`<strong>output_attentions</strong> (<code>bool</code>, <em>optional</em>) &#x2014;
Whether or not to return the attentions tensors of all attention layers. See <code>attentions</code> under returned
...
<p><a
  href="/docs/transformers/main/en/main_classes/output#transformers.modeling_outputs.BaseModelOutputWithPooling"
>transformers.modeling_outputs.BaseModelOutputWithPooling</a> or <code>tuple(torch.FloatTensor)</code></p>
`}}),Ve=new on({props:{$$slots:{default:[ml]},$$scope:{ctx:y}}}),Oe=new zt({props:{anchor:"transformers.XCLIPVisionModel.forward.example",$$slots:{default:[fl]},$$scope:{ctx:y}}}),{c(){d=s("meta"),x=f(),g=s("h1"),m=s("a"),v=s("span"),b(n.$$.fragment),p=f(),L=s("span"),Gn=i("X-CLIP"),nn=f(),H=s("h2"),he=s("a"),$o=s("span"),b(Ge.$$.fragment),Un=f(),Io=s("span"),Jn=i("Overview"),sn=f(),S=s("p"),Kn=i("The X-CLIP model was proposed in "),Ue=s("a"),Zn=i("Expanding Language-Image Pretrained Models for General Video Recognition"),Qn=i(` by Bolin Ni, Houwen Peng, Minghao Chen, Songyang Zhang, Gaofeng Meng, Jianlong Fu, Shiming Xiang, Haibin Ling.
X-CLIP is a minimal extension of `),Vt=s("a"),Yn=i("CLIP"),es=i(" for video. The model consists of a text encoder, a cross-frame vision encoder, a multi-frame integration Transformer, and a video-specific prompt generator."),an=f(),Ot=s("p"),ts=i("The abstract from the paper is the following:"),rn=f(),Dt=s("p"),wo=s("em"),os=i("Contrastive language-image pretraining has shown great success in learning visual-textual joint representation from web-scale data, demonstrating remarkable \u201Czero-shot\u201D generalization ability for various image tasks. However, how to effectively expand such new language-image pretraining methods to video domains is still an open problem. In this work, we present a simple yet effective approach that adapts the pretrained language-image models to video recognition directly, instead of pretraining a new model from scratch. More concretely, to capture the long-range dependencies of frames along the temporal dimension, we propose a cross-frame attention mechanism that explicitly exchanges information across frames. Such module is lightweight and can be plugged into pretrained language-image models seamlessly. Moreover, we propose a video-specific prompting scheme, which leverages video content information for generating discriminative textual prompts. Extensive experiments demonstrate that our approach is effective and can be generalized to different video recognition scenarios. In particular, under fully-supervised settings, our approach achieves a top-1 accuracy of 87.1% on Kinectics-400, while using 12 times fewer FLOPs compared with Swin-L and ViViT-H. In zero-shot experiments, our approach surpasses the current state-of-the-art methods by +7.6% and +14.9% in terms of top-1 accuracy under two popular protocols. In few-shot scenarios, our approach outperforms previous best methods by +32.1% and +23.1% when the labeled data is extremely limited."),ln=f(),Ft=s("p"),ns=i("Tips:"),dn=f(),ue=s("ul"),Je=s("li"),ss=i("Usage of X-CLIP is identical to "),St=s("a"),as=i("CLIP"),rs=i("."),is=f(),Ke=s("li"),ls=i("Demo notebooks for X-CLIP can be found "),Ze=s("a"),ds=i("here"),cs=i("."),cn=f(),ge=s("img"),pn=f(),Qe=s("small"),ps=i("X-CLIP architecture. Taken from the "),Nt=s("a"),ms=i("original paper."),mn=f(),N=s("p"),fs=i("This model was contributed by "),Ye=s("a"),hs=i("nielsr"),us=i(`.
...
refer to the docstring of this method for more information.`),Os=f(),xe=s("div"),b(at.$$.fragment),Ds=f(),rt=s("p"),Fs=i("This method forwards all its arguments to CLIPTokenizerFast\u2019s "),Ut=s("a"),Ss=i("decode()"),Ns=i(`. Please refer to
...
documentation from `),ao=s("a"),Aa=i("PretrainedConfig"),Va=i(" for more information."),Oa=f(),b(we.$$.fragment),Pn=f(),oe=s("h2"),ye=s("a"),Ao=s("span"),b(vt.$$.fragment),Da=f(),Vo=s("span"),Fa=i("XCLIPModel"),Cn=f(),j=s("div"),b(xt.$$.fragment),Sa=f(),bt=s("p"),Na=i("This model is a PyTorch "),Pt=s("a"),Wa=i("torch.nn.Module"),Ba=i(` subclass. Use it
as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),Ra=f(),q=s("div"),b(Ct.$$.fragment),Ha=f(),ne=s("p"),Ga=i("The "),ro=s("a"),Ua=i("XCLIPModel"),Ja=i(" forward method, overrides the "),Oo=s("code"),Ka=i("__call__"),Za=i(" special method."),Qa=f(),b(Le.$$.fragment),Ya=f(),b(Te.$$.fragment),er=f(),A=s("div"),b($t.$$.fragment),tr=f(),se=s("p"),or=i("The "),io=s("a"),nr=i("XCLIPModel"),sr=i(" forward method, overrides the "),Do=s("code"),ar=i("__call__"),rr=i(" special method."),ir=f(),b(je.$$.fragment),lr=f(),b(Xe.$$.fragment),dr=f(),V=s("div"),b(It.$$.fragment),cr=f(),ae=s("p"),pr=i("The "),lo=s("a"),mr=i("XCLIPModel"),fr=i(" forward method, overrides the "),Fo=s("code"),hr=i("__call__"),ur=i(" special method."),gr=f(),b(ke.$$.fragment),_r=f(),b(Me.$$.fragment),$n=f(),re=s("h2"),Ee=s("a"),So=s("span"),b(wt.$$.fragment),vr=f(),No=s("span"),xr=i("XCLIPTextModel"),In=f(),ie=s("div"),b(yt.$$.fragment),br=f(),O=s("div"),b(Lt.$$.fragment),Pr=f(),le=s("p"),Cr=i("The "),co=s("a"),$r=i("XCLIPTextModel"),Ir=i(" forward method, overrides the "),Wo=s("code"),wr=i("__call__"),yr=i(" special method."),Lr=f(),b(ze.$$.fragment),Tr=f(),b(qe.$$.fragment),wn=f(),de=s("h2"),Ae=s("a"),Bo=s("span"),b(Tt.$$.fragment),jr=f(),Ro=s("span"),Xr=i("XCLIPVisionModel"),yn=f(),ce=s("div"),b(jt.$$.fragment),kr=f(),D=s("div"),b(Xt.$$.fragment),Mr=f(),pe=s("p"),Er=i("The "),po=s("a"),zr=i("XCLIPVisionModel"),qr=i(" forward method, overrides the "),Ho=s("code"),Ar=i("__call__"),Vr=i(" special method."),Or=f(),b(Ve.$$.fragment),Dr=f(),b(Oe.$$.fragment),this.h()},l(t){const u=Yi('[data-svelte="svelte-1phssyn"]',document.head);d=a(u,"META",{name:!0,content:!0}),u.forEach(o),x=h(t),g=a(t,"H1",{class:!0});var kt=r(g);m=a(kt,"A",{id:!0,class:!0,href:!0});var Go=r(m);v=a(Go,"SPAN",{});var Uo=r(v);P(n.$$.fragment,Uo),Uo.forEach(o),Go.forEach(o),p=h(kt),L=a(kt,"SPAN",{});var Jo=r(L);Gn=l(Jo,"X-CLIP"),Jo.forEach(o),kt.forEach(o),nn=h(t),H=a(t,"H2",{class:!0});var Mt=r(H);he=a(Mt,"A",{id:!0,class:!0,href:!0});var Ko=r(he);$o=a(Ko,"SPAN",{});var Zo=r($o);P(Ge.$$.fragment,Zo),Zo.forEach(o),Ko.forEach(o),Un=h(Mt),Io=a(Mt,"SPAN",{});var Qo=r(Io);Jn=l(Qo,"Overview"),Qo.forEach(o),Mt.forEach(o),sn=h(t),S=a(t,"P",{});var me=r(S);Kn=l(me,"The X-CLIP model was proposed in "),Ue=a(me,"A",{href:!0,rel:!0});var Yo=r(Ue);Zn=l(Yo,"Expanding Language-Image Pretrained Models for General Video Recognition"),Yo.forEach(o),Qn=l(me,` by Bolin Ni, Houwen Peng, Minghao Chen, Songyang Zhang, Gaofeng Meng, Jianlong Fu, Shiming Xiang, Haibin Ling.
X-CLIP is a minimal extension of `),Vt=a(me,"A",{href:!0});var en=r(Vt);Yn=l(en,"CLIP"),en.forEach(o),es=l(me," for video. The model consists of a text encoder, a cross-frame vision encoder, a multi-frame integration Transformer, and a video-specific prompt generator."),me.forEach(o),an=h(t),Ot=a(t,"P",{});var tn=r(Ot);ts=l(tn,"The abstract from the paper is the following:"),tn.forEach(o),rn=h(t),Dt=a(t,"P",{});var Nr=r(Dt);wo=a(Nr,"EM",{});var Wr=r(wo);os=l(Wr,"Contrastive language-image pretraining has shown great success in learning visual-textual joint representation from web-scale data, demonstrating remarkable \u201Czero-shot\u201D generalization ability for various image tasks. However, how to effectively expand such new language-image pretraining methods to video domains is still an open problem. In this work, we present a simple yet effective approach that adapts the pretrained language-image models to video recognition directly, instead of pretraining a new model from scratch. More concretely, to capture the long-range dependencies of frames along the temporal dimension, we propose a cross-frame attention mechanism that explicitly exchanges information across frames. Such module is lightweight and can be plugged into pretrained language-image models seamlessly. Moreover, we propose a video-specific prompting scheme, which leverages video content information for generating discriminative textual prompts. Extensive experiments demonstrate that our approach is effective and can be generalized to different video recognition scenarios. In particular, under fully-supervised settings, our approach achieves a top-1 accuracy of 87.1% on Kinectics-400, while using 12 times fewer FLOPs compared with Swin-L and ViViT-H. In zero-shot experiments, our approach surpasses the current state-of-the-art methods by +7.6% and +14.9% in terms of top-1 accuracy under two popular protocols. In few-shot scenarios, our approach outperforms previous best methods by +32.1% and +23.1% when the labeled data is extremely limited."),Wr.forEach(o),Nr.forEach(o),ln=h(t),Ft=a(t,"P",{});var Br=r(Ft);ns=l(Br,"Tips:"),Br.forEach(o),dn=h(t),ue=a(t,"UL",{});var Tn=r(ue);Je=a(Tn,"LI",{});var jn=r(Je);ss=l(jn,"Usage of X-CLIP is identical to "),St=a(jn,"A",{href:!0});var Rr=r(St);as=l(Rr,"CLIP"),Rr.forEach(o),rs=l(jn,"."),jn.forEach(o),is=h(Tn),Ke=a(Tn,"LI",{});var Xn=r(Ke);ls=l(Xn,"Demo notebooks for X-CLIP can be found "),Ze=a(Xn,"A",{href:!0,rel:!0});var Hr=r(Ze);ds=l(Hr,"here"),Hr.forEach(o),cs=l(Xn,"."),Xn.forEach(o),Tn.forEach(o),cn=h(t),ge=a(t,"IMG",{src:!0,alt:!0,width:!0}),pn=h(t),Qe=a(t,"SMALL",{});var Fr=r(Qe);ps=l(Fr,"X-CLIP architecture. Taken from the "),Nt=a(Fr,"A",{href:!0});var Gr=r(Nt);ms=l(Gr,"original paper."),Gr.forEach(o),Fr.forEach(o),mn=h(t),N=a(t,"P",{});var mo=r(N);fs=l(mo,"This model was contributed by "),Ye=a(mo,"A",{href:!0,rel:!0});var Ur=r(Ye);hs=l(Ur,"nielsr"),Ur.forEach(o),us=l(mo,`.
...
processor.`),Yr.forEach(o),Cs=h(B),k=a(B,"P",{});var F=r(k);Wt=a(F,"A",{href:!0});var ei=r(Wt);$s=l(ei,"XCLIPProcessor"),ei.forEach(o),Is=l(F," offers all the functionalities of "),Bt=a(F,"A",{href:!0});var ti=r(Bt);ws=l(ti,"VideoMAEFeatureExtractor"),ti.forEach(o),ys=l(F," and "),Rt=a(F,"A",{href:!0});var oi=r(Rt);Ls=l(oi,"CLIPTokenizerFast"),oi.forEach(o),Ts=l(F,`. See
the `),jo=a(F,"CODE",{});var ni=r(jo);js=l(ni,"__call__()"),ni.forEach(o),Xs=l(F," and "),Ht=a(F,"A",{href:!0});var si=r(Ht);ks=l(si,"decode()"),si.forEach(o),Ms=l(F," for more information."),F.forEach(o),Es=h(B),ve=a(B,"DIV",{class:!0});var Mn=r(ve);P(nt.$$.fragment,Mn),zs=h(Mn),st=a(Mn,"P",{});var En=r(st);qs=l(En,"This method forwards all its arguments to CLIPTokenizerFast\u2019s "),Gt=a(En,"A",{href:!0});var ai=r(Gt);As=l(ai,"batch_decode()"),ai.forEach(o),Vs=l(En,`. Please
refer to the docstring of this method for more information.`),En.forEach(o),Mn.forEach(o),Os=h(B),xe=a(B,"DIV",{class:!0});var zn=r(xe);P(at.$$.fragment,zn),Ds=h(zn),rt=a(zn,"P",{});var qn=r(rt);Fs=l(qn,"This method forwards all its arguments to CLIPTokenizerFast\u2019s "),Ut=a(qn,"A",{href:!0});var ri=r(Ut);Ss=l(ri,"decode()"),ri.forEach(o),Ns=l(qn,`. Please refer to
the docstring of this method for more information.`),qn.forEach(o),zn.forEach(o),B.forEach(o),un=h(t),U=a(t,"H2",{class:!0});var An=r(U);be=a(An,"A",{id:!0,class:!0,href:!0});var ii=r(be);Xo=a(ii,"SPAN",{});var li=r(Xo);P(it.$$.fragment,li),li.forEach(o),ii.forEach(o),Ws=h(An),ko=a(An,"SPAN",{});var di=r(ko);Bs=l(di,"XCLIPConfig"),di.forEach(o),An.forEach(o),gn=h(t),M=a(t,"DIV",{class:!0});var De=r(M);P(lt.$$.fragment,De),Rs=h(De),W=a(De,"P",{});var Et=r(W);Jt=a(Et,"A",{href:!0});var ci=r(Jt);Hs=l(ci,"XCLIPConfig"),ci.forEach(o),Gs=l(Et," is the configuration class to store the configuration of a "),Kt=a(Et,"A",{href:!0});var pi=r(Kt);Us=l(pi,"XCLIPModel"),pi.forEach(o),Js=l(Et,`. It is used to
instantiate X-CLIP model according to the specified arguments, defining the text model and vision model configs.
Instantiating a configuration with the defaults will yield a similar configuration to that of the X-CLIP
`),dt=a(Et,"A",{href:!0,rel:!0});var mi=r(dt);Ks=l(mi,"microsoft/xclip-base-patch32"),mi.forEach(o),Zs=l(Et," architecture."),Et.forEach(o),Qs=h(De),J=a(De,"P",{});var fo=r(J);Ys=l(fo,"Configuration objects inherit from "),Zt=a(fo,"A",{href:!0});var fi=r(Zt);ea=l(fi,"PretrainedConfig"),fi.forEach(o),ta=l(fo,` and can be used to control the model outputs. Read the
documentation from `),Qt=a(fo,"A",{href:!0});var hi=r(Qt);oa=l(hi,"PretrainedConfig"),hi.forEach(o),na=l(fo," for more information."),fo.forEach(o),sa=h(De),Pe=a(De,"DIV",{class:!0});var Vn=r(Pe);P(ct.$$.fragment,Vn),aa=h(Vn),pt=a(Vn,"P",{});var On=r(pt);ra=l(On,"Instantiate a "),Yt=a(On,"A",{href:!0});var ui=r(Yt);ia=l(ui,"XCLIPConfig"),ui.forEach(o),la=l(On,` (or a derived class) from xclip text model configuration and xclip vision model
configuration.`),On.forEach(o),Vn.forEach(o),De.forEach(o),_n=h(t),K=a(t,"H2",{class:!0});var Dn=r(K);Ce=a(Dn,"A",{id:!0,class:!0,href:!0});var gi=r(Ce);Mo=a(gi,"SPAN",{});var _i=r(Mo);P(mt.$$.fragment,_i),_i.forEach(o),gi.forEach(o),da=h(Dn),Eo=a(Dn,"SPAN",{});var vi=r(Eo);ca=l(vi,"XCLIPTextConfig"),vi.forEach(o),Dn.forEach(o),vn=h(t),E=a(t,"DIV",{class:!0});var Fe=r(E);P(ft.$$.fragment,Fe),pa=h(Fe),Z=a(Fe,"P",{});var ho=r(Z);ma=l(ho,"This is the configuration class to store the configuration of a "),eo=a(ho,"A",{href:!0});var xi=r(eo);fa=l(xi,"XCLIPModel"),xi.forEach(o),ha=l(ho,`. It is used to instantiate an X-CLIP
model according to the specified arguments, defining the model architecture. Instantiating a configuration with the
defaults will yield a similar configuration to that of the X-CLIP
`),ht=a(ho,"A",{href:!0,rel:!0});var bi=r(ht);ua=l(bi,"microsoft/xclip-base-patch32"),bi.forEach(o),ga=l(ho," architecture."),ho.forEach(o),_a=h(Fe),Q=a(Fe,"P",{});var uo=r(Q);va=l(uo,"Configuration objects inherit from "),to=a(uo,"A",{href:!0});var Pi=r(to);xa=l(Pi,"PretrainedConfig"),Pi.forEach(o),ba=l(uo,` and can be used to control the model outputs. Read the
documentation from `),oo=a(uo,"A",{href:!0});var Ci=r(oo);Pa=l(Ci,"PretrainedConfig"),Ci.forEach(o),Ca=l(uo," for more information."),uo.forEach(o),$a=h(Fe),P($e.$$.fragment,Fe),Fe.forEach(o),xn=h(t),Y=a(t,"H2",{class:!0});var Fn=r(Y);Ie=a(Fn,"A",{id:!0,class:!0,href:!0});var $i=r(Ie);zo=a($i,"SPAN",{});var Ii=r(zo);P(ut.$$.fragment,Ii),Ii.forEach(o),$i.forEach(o),Ia=h(Fn),qo=a(Fn,"SPAN",{});var wi=r(qo);wa=l(wi,"XCLIPVisionConfig"),wi.forEach(o),Fn.forEach(o),bn=h(t),z=a(t,"DIV",{class:!0});var Se=r(z);P(gt.$$.fragment,Se),ya=h(Se),ee=a(Se,"P",{});var go=r(ee);La=l(go,"This is the configuration class to store the configuration of a "),no=a(go,"A",{href:!0});var yi=r(no);Ta=l(yi,"XCLIPModel"),yi.forEach(o),ja=l(go,`. It is used to instantiate an X-CLIP
model according to the specified arguments, defining the model architecture. Instantiating a configuration with the
defaults will yield a similar configuration to that of the X-CLIP
