...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_state = outputs.last_hidden_state`}}),{c(){d=s("p"),x=i("Examples:"),g=f(),b(m.$$.fragment)},l(n){d=a(n,"P",{});var p=r(d);x=l(p,"Examples:"),p.forEach(o),g=h(n),P(m.$$.fragment,n)},m(n,p){_(n,d,p),e(d,x),_(n,g,p),C(m,n,p),v=!0},p:Et,i(n){v||($(m.$$.fragment,n),v=!0)},o(n){I(m.$$.fragment,n),v=!1},d(n){n&&o(d),n&&o(g),w(m,n)}}}function cl(y){let d,x,g,m,v,n,p,L,Bn,on,H,fe,Po,Ge,Gn,Co,Un,nn,S,Jn,Ue,Kn,Zn,qt,Qn,Yn,sn,At,es,an,Vt,$o,ts,rn,Ft,os,ln,he,Je,ns,Ot,ss,as,rs,Ke,is,Ze,ls,ds,dn,ue,Fr,cn,Qe,cs,Dt,ps,pn,N,ms,Ye,fs,hs,et,us,gs,mn,B,ge,Io,tt,_s,wo,vs,fn,T,ot,xs,yo,bs,Ps,k,St,Cs,$s,Nt,Is,ws,Wt,ys,Ls,Lo,Ts,js,Rt,Xs,ks,Ms,_e,nt,Es,st,zs,Ht,qs,As,Vs,ve,at,Fs,rt,Os,Bt,Ds,Ss,hn,G,xe,To,it,Ns,jo,Ws,un,M,lt,Rs,be,Gt,Hs,Bs,Ut,Gs,Us,Js,U,Ks,Jt,Zs,Qs,Kt,Ys,ea,ta,Pe,dt,oa,ct,na,Zt,sa,aa,gn,J,Ce,Xo,pt,ra,ko,ia,_n,E,mt,la,K,da,Qt,ca,pa,ft,ma,fa,ha,Z,ua,Yt,ga,_a,eo,va,xa,ba,$e,vn,Q,Ie,Mo,ht,Pa,Eo,Ca,xn,z,ut,$a,Y,Ia,to,wa,ya,gt,La,Ta,ja,ee,Xa,oo,ka,Ma,no,Ea,za,qa,we,bn,te,ye,zo,_t,Aa,qo,Va,Pn,j,vt,Fa,xt,Oa,bt,Da,Sa,Na,q,Pt,Wa,oe,Ra,so,Ha,Ba,Ao,Ga,Ua,Ja,Le,Ka,Te,Za,A,Ct,Qa,ne,Ya,ao,er,tr,Vo,or,nr,sr,je,ar,Xe,rr,V,$t,ir,se,lr,ro,dr,cr,Fo,pr,mr,fr,ke,hr,Me,Cn,ae,Ee,Oo,It,ur,Do,gr,$n,re,wt,_r,F,yt,vr,ie,xr,io,br,Pr,So,Cr,$r,Ir,ze,wr,qe,In,le,Ae,No,Lt,yr,Wo,Lr,wn,de,Tt,Tr,O,jt,jr,ce,Xr,lo,kr,Mr,Ro,Er,zr,qr,Ve,Ar,Fe,yn;return n=new me({}),Ge=new me({}),tt=new me({}),ot=new X({props:{name:"class transformers.XCLIPProcessor",anchor:"transformers.XCLIPProcessor",parameters:[{name:"feature_extractor",val:""},{name:"tokenizer",val:""}],parametersDescription:[{anchor:"transformers.XCLIPProcessor.feature_extractor",description:`<strong>feature_extractor</strong> (<a href="/docs/transformers/main/en/model_doc/videomae#transformers.VideoMAEFeatureExtractor">VideoMAEFeatureExtractor</a>) &#x2014;
...
The original code can be found `),et=s("a"),us=i("here"),gs=i("."),mn=f(),B=s("h2"),ge=s("a"),Io=s("span"),b(tt.$$.fragment),_s=f(),wo=s("span"),vs=i("XCLIPProcessor"),fn=f(),T=s("div"),b(ot.$$.fragment),xs=f(),yo=s("p"),bs=i(`Constructs an X-CLIP processor which wraps a VideoMAE feature extractor and a CLIP tokenizer into a single
...
the `),Lo=s("code"),Ts=i("__call__()"),js=i(" and "),Rt=s("a"),Xs=i("decode()"),ks=i(" for more information."),Ms=f(),_e=s("div"),b(nt.$$.fragment),Es=f(),st=s("p"),zs=i("This method forwards all its arguments to CLIPTokenizerFast\u2019s "),Ht=s("a"),qs=i("batch_decode()"),As=i(`. Please
refer to the docstring of this method for more information.`),Vs=f(),ve=s("div"),b(at.$$.fragment),Fs=f(),rt=s("p"),Os=i("This method forwards all its arguments to CLIPTokenizerFast\u2019s "),Bt=s("a"),Ds=i("decode()"),Ss=i(`. Please refer to
the docstring of this method for more information.`),hn=f(),G=s("h2"),xe=s("a"),To=s("span"),b(it.$$.fragment),Ns=f(),jo=s("span"),Ws=i("XCLIPConfig"),un=f(),M=s("div"),b(lt.$$.fragment),Rs=f(),be=s("p"),Gt=s("a"),Hs=i("XCLIPConfig"),Bs=i(" is the configuration class to store the configuration of a "),Ut=s("a"),Gs=i("XCLIPModel"),Us=i(`. It is used to
...
the `),Lo=a(D,"CODE",{});var ei=r(Lo);Ts=l(ei,"__call__()"),ei.forEach(o),js=l(D," and "),Rt=a(D,"A",{href:!0});var ti=r(Rt);Xs=l(ti,"decode()"),ti.forEach(o),ks=l(D," for more information."),D.forEach(o),Ms=h(W),_e=a(W,"DIV",{class:!0});var kn=r(_e);P(nt.$$.fragment,kn),Es=h(kn),st=a(kn,"P",{});var Mn=r(st);zs=l(Mn,"This method forwards all its arguments to CLIPTokenizerFast\u2019s "),Ht=a(Mn,"A",{href:!0});var oi=r(Ht);qs=l(oi,"batch_decode()"),oi.forEach(o),As=l(Mn,`. Please
refer to the docstring of this method for more information.`),Mn.forEach(o),kn.forEach(o),Vs=h(W),ve=a(W,"DIV",{class:!0});var En=r(ve);P(at.$$.fragment,En),Fs=h(En),rt=a(En,"P",{});var zn=r(rt);Os=l(zn,"This method forwards all its arguments to CLIPTokenizerFast\u2019s "),Bt=a(zn,"A",{href:!0});var ni=r(Bt);Ds=l(ni,"decode()"),ni.forEach(o),Ss=l(zn,`. Please refer to
the docstring of this method for more information.`),zn.forEach(o),En.forEach(o),W.forEach(o),hn=h(t),G=a(t,"H2",{class:!0});var qn=r(G);xe=a(qn,"A",{id:!0,class:!0,href:!0});var si=r(xe);To=a(si,"SPAN",{});var ai=r(To);P(it.$$.fragment,ai),ai.forEach(o),si.forEach(o),Ns=h(qn),jo=a(qn,"SPAN",{});var ri=r(jo);Ws=l(ri,"XCLIPConfig"),ri.forEach(o),qn.forEach(o),un=h(t),M=a(t,"DIV",{class:!0});var Oe=r(M);P(lt.$$.fragment,Oe),Rs=h(Oe),be=a(Oe,"P",{});var en=r(be);Gt=a(en,"A",{href:!0});var ii=r(Gt);Hs=l(ii,"XCLIPConfig"),ii.forEach(o),Bs=l(en," is the configuration class to store the configuration of a "),Ut=a(en,"A",{href:!0});var li=r(Ut);Gs=l(li,"XCLIPModel"),li.forEach(o),Us=l(en,`. It is used to
