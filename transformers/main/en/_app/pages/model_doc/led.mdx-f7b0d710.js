import{S as zf,i as Ff,s as $f,e as n,k as d,w as f,t as r,M as xf,c as s,d as t,m as l,a,x as _,h as i,b as c,F as e,g as h,y as g,q as v,o as T,B as k}from"../../chunks/vendor-6b77c823.js";import{T as go}from"../../chunks/Tip-39098574.js";import{D as $}from"../../chunks/Docstring-abef54e3.js";import{C as Pt}from"../../chunks/CodeBlock-3a8b25a8.js";import{I as me}from"../../chunks/IconCopyLink-7a11ce68.js";function Mf(j){let u,L,b,w,q;return{c(){u=n("p"),L=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),b=n("code"),w=r("Module"),q=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(E){u=s(E,"P",{});var y=a(u);L=i(y,"Although the recipe for forward pass needs to be defined within this function, one should call the "),b=s(y,"CODE",{});var D=a(b);w=i(D,"Module"),D.forEach(t),q=i(y,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
first positional argument :`),Le=d(),S=n("ul"),A=n("li"),_e=r("a single Tensor with "),ne=n("code"),Se=r("input_ids"),ge=r(" only and nothing else: "),K=n("code"),Ie=r("model(input_ids)"),Ce=d(),C=n("li"),Be=r(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
...
`),se=n("code"),De=r('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(m){u=s(m,"P",{});var F=a(u);L=i(F,"TF 2.0 models accepts two formats as inputs:"),F.forEach(t),b=l(m),w=s(m,"UL",{});var ae=a(w);q=s(ae,"LI",{});var nt=a(q);E=i(nt,"having all inputs as keyword arguments (like PyTorch models), or"),nt.forEach(t),y=l(ae),D=s(ae,"LI",{});var st=a(D);Pe=i(st,"having all inputs as a list, tuple or dict in the first positional arguments."),st.forEach(t),ae.forEach(t),fe=l(m),z=s(m,"P",{});var I=a(z);Z=i(I,"This second option is useful when using "),U=s(I,"CODE",{});var at=a(U);te=i(at,"tf.keras.Model.fit"),at.forEach(t),Ne=i(I,` method which currently requires having all the
tensors in the first argument of the model call function: `),R=s(I,"CODE",{});var rt=a(R);je=i(rt,"model(inputs)"),rt.forEach(t),Me=i(I,"."),I.forEach(t),B=l(m),V=s(m,"P",{});var Oe=a(V);oe=i(Oe,`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),Oe.forEach(t),Le=l(m),S=s(m,"UL",{});var X=a(S);A=s(X,"LI",{});var re=a(A);_e=i(re,"a single Tensor with "),ne=s(re,"CODE",{});var Ae=a(ne);Se=i(Ae,"input_ids"),Ae.forEach(t),ge=i(re," only and nothing else: "),K=s(re,"CODE",{});var it=a(K);Ie=i(it,"model(input_ids)"),it.forEach(t),re.forEach(t),Ce=l(X),C=s(X,"LI",{});var ie=a(C);Be=i(ie,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
...
the latter silently ignores them.`)},l(E){u=s(E,"P",{});var y=a(u);L=i(y,"Although the recipe for forward pass needs to be defined within this function, one should call the "),b=s(y,"CODE",{});var D=a(b);w=i(D,"Module"),D.forEach(t),q=i(y,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),y.forEach(t)},m(E,y){h(E,u,y),e(u,L),e(u,b),e(b,w),e(u,q)},d(E){E&&t(u)}}}function If(j){let u,L,b,w,q,E,y,D,Pe,fe,z,Z,U,te,Ne,R,je,Me,B,V,oe,Le,S,A,_e,ne,Se,ge,K,Ie,Ce,C,Be,Y,x,M,G,Ge,Qe,N,He,se,De,m,F,ae,nt,st,I,at,rt,Oe,X,re,Ae,it,ie,dt,de,We,Ue,Si,Ci,$s,Oi,Ai,Pi,ze,Ni,xs,ji,Ii,Ms,Bi,Gi,Un,Qi,Hi,Ss,Wi,Ui,Ri,J,Vi,Cs,Ki,Xi,Os,Ji,Zi,Rn,Yi,ed,As,td,od,Ps,nd,sd,Ns,ad,rd,id,lt,dd,js,ld,cd,Is,hd,pd,ud,vo,md,To,fd,_d,gd,ko,vd,bo,Td,kd,ur,Nt,bd,wo,wd,yd,mr,ct,jt,Bs,yo,Ed,Gs,qd,fr,O,Eo,Ld,ht,Dd,Vn,zd,Fd,qo,$d,xd,Md,pt,Sd,Kn,Cd,Od,Xn,Ad,Pd,Nd,Qs,jd,Id,Lo,Bd,Hs,Ws,Us,Rs,Gd,Qd,Vs,Ks,Xs,It,Bt,Js,Do,Hd,Zs,Wd,Ud,Ys,ea,zo,Gt,Qt,ta,Fo,Rd,oa,Vd,Kd,na,Xd,Jd,sa,aa,ra,Ht,Wt,ia,$o,Zd,da,Yd,_r,ut,Ut,la,xo,el,ca,tl,gr,P,Mo,ol,ha,nl,sl,Rt,Jn,al,rl,Zn,il,dl,ll,So,cl,Yn,hl,pl,ul,Re,Co,ml,pa,fl,_l,Oo,es,gl,ua,vl,Tl,ts,kl,ma,bl,wl,Vt,Ao,yl,Po,El,fa,ql,Ll,Dl,Kt,No,zl,_a,Fl,$l,os,jo,vr,mt,Xt,ga,Io,xl,va,Ml,Tr,Fe,Bo,Sl,Go,Cl,Ta,Ol,Al,Pl,Jt,ns,Nl,jl,ss,Il,Bl,Gl,Qo,Ql,as,Hl,Wl,kr,ft,Zt,ka,Ho,Ul,ba,Rl,br,_t,Wo,Vl,wa,Kl,wr,gt,Uo,Xl,ya,Jl,yr,vt,Ro,Zl,Ea,Yl,Er,Tt,Vo,ec,qa,tc,qr,kt,Ko,oc,La,nc,Lr,bt,Xo,sc,Da,ac,Dr,wt,Jo,rc,za,ic,zr,yt,Zo,dc,Fa,lc,Fr,Et,Yt,$a,Yo,cc,xa,hc,$r,$e,en,pc,tn,uc,rs,mc,fc,_c,on,gc,nn,vc,Tc,kc,ve,sn,bc,qt,wc,is,yc,Ec,Ma,qc,Lc,Dc,eo,zc,Sa,Fc,$c,an,xr,Lt,to,Ca,rn,xc,Oa,Mc,Mr,xe,dn,Sc,ln,Cc,ds,Oc,Ac,Pc,cn,Nc,hn,jc,Ic,Bc,Q,pn,Gc,Dt,Qc,ls,Hc,Wc,Aa,Uc,Rc,Vc,oo,Kc,Pa,Xc,Jc,un,Zc,Na,Yc,eh,mn,Sr,zt,no,ja,fn,th,Ia,oh,Cr,le,_n,nh,Ba,sh,ah,gn,rh,cs,ih,dh,lh,vn,ch,Tn,hh,ph,uh,H,kn,mh,Ft,fh,hs,_h,gh,Ga,vh,Th,kh,so,bh,Qa,wh,yh,bn,Eh,Ha,qh,Lh,wn,Or,$t,ao,Wa,yn,Dh,Ua,zh,Ar,ce,En,Fh,xt,$h,Ra,xh,Mh,Va,Sh,Ch,Oh,qn,Ah,ps,Ph,Nh,jh,Ln,Ih,Dn,Bh,Gh,Qh,Te,zn,Hh,Mt,Wh,us,Uh,Rh,Ka,Vh,Kh,Xh,ro,Jh,Xa,Zh,Yh,Fn,Pr,St,io,Ja,$n,ep,Za,tp,Nr,he,xn,op,Mn,np,ms,sp,ap,rp,Sn,ip,Cn,dp,lp,cp,lo,hp,ke,On,pp,Ct,up,fs,mp,fp,Ya,_p,gp,vp,co,Tp,er,kp,bp,An,jr,Ot,ho,tr,Pn,wp,or,yp,Ir,pe,Nn,Ep,jn,qp,_s,Lp,Dp,zp,In,Fp,Bn,$p,xp,Mp,po,Sp,be,Gn,Cp,At,Op,gs,Ap,Pp,nr,Np,jp,Ip,uo,Bp,sr,Gp,Qp,Qn,Br;return E=new me({}),te=new me({}),yo=new me({}),Eo=new $({props:{name:"class transformers.LEDConfig",anchor:"transformers.LEDConfig",parameters:[{name:"vocab_size",val:" = 50265"},{name:"max_encoder_position_embeddings",val:" = 16384"},{name:"max_decoder_position_embeddings",val:" = 1024"},{name:"encoder_layers",val:" = 12"},{name:"encoder_ffn_dim",val:" = 4096"},{name:"encoder_attention_heads",val:" = 16"},{name:"decoder_layers",val:" = 12"},{name:"decoder_ffn_dim",val:" = 4096"},{name:"decoder_attention_heads",val:" = 16"},{name:"encoder_layerdrop",val:" = 0.0"},{name:"decoder_layerdrop",val:" = 0.0"},{name:"use_cache",val:" = True"},{name:"is_encoder_decoder",val:" = True"},{name:"activation_function",val:" = 'gelu'"},{name:"d_model",val:" = 1024"},{name:"dropout",val:" = 0.1"},{name:"attention_dropout",val:" = 0.0"},{name:"activation_dropout",val:" = 0.0"},{name:"init_std",val:" = 0.02"},{name:"decoder_start_token_id",val:" = 2"},{name:"classifier_dropout",val:" = 0.0"},{name:"pad_token_id",val:" = 1"},{name:"bos_token_id",val:" = 0"},{name:"eos_token_id",val:" = 2"},{name:"attention_window",val:": typing.Union[typing.List[int], int] = 512"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/led/configuration_led.py#L31",parametersDescription:[{anchor:"transformers.LEDConfig.vocab_size",description:`<strong>vocab_size</strong> (<code>int</code>, <em>optional</em>, defaults to 50265) &#x2014;
...
`}}),so=new go({props:{$$slots:{default:[Cf]},$$scope:{ctx:j}}}),bn=new Pt({props:{code:`import torch
...
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-comment"># probs[5] is associated with the mask token</span>`}}),{c(){u=n("meta"),L=d(),b=n("h1"),w=n("a"),q=n("span"),f(E.$$.fragment),y=d(),D=n("span"),Pe=r("LED"),fe=d(),z=n("h2"),Z=n("a"),U=n("span"),f(te.$$.fragment),Ne=d(),R=n("span"),je=r("Overview"),Me=d(),B=n("p"),V=r("The LED model was proposed in "),oe=n("a"),Le=r("Longformer: The Long-Document Transformer"),S=r(` by Iz
Beltagy, Matthew E. Peters, Arman Cohan.`),A=d(),_e=n("p"),ne=r("The abstract from the paper is the following:"),Se=d(),ge=n("p"),K=n("em"),Ie=r(`Transformer-based models are unable to process long sequences due to their self-attention operation, which scales
...
`),Ae=n("a"),it=r("BartTokenizer"),ie=r("."),dt=d(),de=n("li"),We=r("LED works very well on long-range "),Ue=n("em"),Si=r("sequence-to-sequence"),Ci=r(" tasks where the "),$s=n("code"),Oi=r("input_ids"),Ai=r(` largely exceed a length of
1024 tokens.`),Pi=d(),ze=n("li"),Ni=r("LED pads the "),xs=n("code"),ji=r("input_ids"),Ii=r(" to be a multiple of "),Ms=n("code"),Bi=r("config.attention_window"),Gi=r(` if required. Therefore a small speed-up is
...
`),Rn=n("a"),Yi=r("LongformerModel"),ed=r("). For summarization, it is advised to put "),As=n("em"),td=r("global attention"),od=r(` only on the first
`),Ps=n("code"),nd=r("<s>"),sd=r(" token. For question answering, it is advised to put "),Ns=n("em"),ad=r("global attention"),rd=r(" on all tokens of the question."),id=d(),lt=n("li"),dd=r("To fine-tune LED on all 16384, it is necessary to enable "),js=n("em"),ld=r("gradient checkpointing"),cd=r(` by executing
...
adding special tokens. A BART sequence has the following format:`),_l=d(),Oo=n("ul"),es=n("li"),gl=r("single sequence: "),ua=n("code"),vl=r("<s> X </s>"),Tl=d(),ts=n("li"),kl=r("pair of sequences: "),ma=n("code"),bl=r("<s> A </s></s> B </s>"),wl=d(),Vt=n("div"),f(Ao.$$.fragment),yl=d(),Po=n("p"),El=r(`Retrieve sequence ids from a token list that has no special tokens added. This method is called when adding
...
This model inherits from `),ds=n("a"),Oc=r("PreTrainedModel"),Ac=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Pc=d(),cn=n("p"),Nc=r("This model is also a PyTorch "),hn=n("a"),jc=r("torch.nn.Module"),Ic=r(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Bc=d(),Q=n("div"),f(pn.$$.fragment),Gc=d(),Dt=n("p"),Qc=r("The "),ls=n("a"),Hc=r("LEDForConditionalGeneration"),Wc=r(" forward method, overrides the "),Aa=n("code"),Uc=r("__call__"),Rc=r(" special method."),Vc=d(),f(oo.$$.fragment),Kc=d(),Pa=n("p"),Xc=r("Conditional generation example:"),Jc=d(),f(un.$$.fragment),Zc=d(),Na=n("p"),Yc=r("Summarization example:"),eh=d(),f(mn.$$.fragment),Sr=d(),zt=n("h2"),no=n("a"),ja=n("span"),f(fn.$$.fragment),th=d(),Ia=n("span"),oh=r("LEDForSequenceClassification"),Cr=d(),le=n("div"),f(_n.$$.fragment),nh=d(),Ba=n("p"),sh=r(`LED model with a sequence classification/head on top (a linear layer on top of the pooled output) e.g. for GLUE
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),uh=d(),H=n("div"),f(kn.$$.fragment),mh=d(),Ft=n("p"),fh=r("The "),hs=n("a"),_h=r("LEDForSequenceClassification"),gh=r(" forward method, overrides the "),Ga=n("code"),vh=r("__call__"),Th=r(" special method."),kh=d(),f(so.$$.fragment),bh=d(),Qa=n("p"),wh=r("Example of single-label classification:"),yh=d(),f(bn.$$.fragment),Eh=d(),Ha=n("p"),qh=r("Example of multi-label classification:"),Lh=d(),f(wn.$$.fragment),Or=d(),$t=n("h2"),ao=n("a"),Wa=n("span"),f(yn.$$.fragment),Dh=d(),Ua=n("span"),zh=r("LEDForQuestionAnswering"),Ar=d(),ce=n("div"),f(En.$$.fragment),Fh=d(),xt=n("p"),$h=r(`LED Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear layer
on top of the hidden-states output to compute `),Ra=n("code"),xh=r("span start logits"),Mh=r(" and "),Va=n("code"),Sh=r("span end logits"),Ch=r(")."),Oh=d(),qn=n("p"),Ah=r("This model inherits from "),ps=n("a"),Ph=r("PreTrainedModel"),Nh=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),jh=d(),Ln=n("p"),Ih=r("This model is also a PyTorch "),Dn=n("a"),Bh=r("torch.nn.Module"),Gh=r(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Qh=d(),Te=n("div"),f(zn.$$.fragment),Hh=d(),Mt=n("p"),Wh=r("The "),us=n("a"),Uh=r("LEDForQuestionAnswering"),Rh=r(" forward method, overrides the "),Ka=n("code"),Vh=r("__call__"),Kh=r(" special method."),Xh=d(),f(ro.$$.fragment),Jh=d(),Xa=n("p"),Zh=r("Example:"),Yh=d(),f(Fn.$$.fragment),Pr=d(),St=n("h2"),io=n("a"),Ja=n("span"),f($n.$$.fragment),ep=d(),Za=n("span"),tp=r("TFLEDModel"),Nr=d(),he=n("div"),f(xn.$$.fragment),op=d(),Mn=n("p"),np=r(`The bare LED Model outputting raw hidden-states without any specific head on top.
...
behavior.`),cp=d(),f(lo.$$.fragment),hp=d(),ke=n("div"),f(On.$$.fragment),pp=d(),Ct=n("p"),up=r("The "),fs=n("a"),mp=r("TFLEDModel"),fp=r(" forward method, overrides the "),Ya=n("code"),_p=r("__call__"),gp=r(" special method."),vp=d(),f(co.$$.fragment),Tp=d(),er=n("p"),kp=r("Example:"),bp=d(),f(An.$$.fragment),jr=d(),Ot=n("h2"),ho=n("a"),tr=n("span"),f(Pn.$$.fragment),wp=d(),or=n("span"),yp=r("TFLEDForConditionalGeneration"),Ir=d(),pe=n("div"),f(Nn.$$.fragment),Ep=d(),jn=n("p"),qp=r(`The LED Model with a language modeling head. Can be used for summarization.
...
`),ae=s(ue,"EM",{});var eu=a(ae);nt=i(eu,"Longformer"),eu.forEach(t),st=i(ue,"\u2019s "),I=s(ue,"EM",{});var tu=a(I);at=i(tu,"chunked self-attention"),tu.forEach(t),rt=i(ue," layer. "),Oe=s(ue,"A",{href:!0});var ou=a(Oe);X=i(ou,"LEDTokenizer"),ou.forEach(t),re=i(ue,` is an alias of
`),Ae=s(ue,"A",{href:!0});var nu=a(Ae);it=i(nu,"BartTokenizer"),nu.forEach(t),ie=i(ue,"."),ue.forEach(t),dt=l(we),de=s(we,"LI",{});var vs=a(de);We=i(vs,"LED works very well on long-range "),Ue=s(vs,"EM",{});var su=a(Ue);Si=i(su,"sequence-to-sequence"),su.forEach(t),Ci=i(vs," tasks where the "),$s=s(vs,"CODE",{});var au=a($s);Oi=i(au,"input_ids"),au.forEach(t),Ai=i(vs,` largely exceed a length of
1024 tokens.`),vs.forEach(t),Pi=l(we),ze=s(we,"LI",{});var Ve=a(ze);Ni=i(Ve,"LED pads the "),xs=s(Ve,"CODE",{});var ru=a(xs);ji=i(ru,"input_ids"),ru.forEach(t),Ii=i(Ve," to be a multiple of "),Ms=s(Ve,"CODE",{});var iu=a(Ms);Bi=i(iu,"config.attention_window"),iu.forEach(t),Gi=i(Ve,` if required. Therefore a small speed-up is
...
`),Rn=s(ye,"A",{href:!0});var pu=a(Rn);Yi=i(pu,"LongformerModel"),pu.forEach(t),ed=i(ye,"). For summarization, it is advised to put "),As=s(ye,"EM",{});var uu=a(As);td=i(uu,"global attention"),uu.forEach(t),od=i(ye,` only on the first
`),Ps=s(ye,"CODE",{});var mu=a(Ps);nd=i(mu,"<s>"),mu.forEach(t),sd=i(ye," token. For question answering, it is advised to put "),Ns=s(ye,"EM",{});var fu=a(Ns);ad=i(fu,"global attention"),fu.forEach(t),rd=i(ye," on all tokens of the question."),ye.forEach(t),id=l(we),lt=s(we,"LI",{});var Ts=a(lt);dd=i(Ts,"To fine-tune LED on all 16384, it is necessary to enable "),js=s(Ts,"EM",{});var _u=a(js);ld=i(_u,"gradient checkpointing"),_u.forEach(t),cd=i(Ts,` by executing
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),gi.forEach(t),kc=l(fo),ve=s(fo,"DIV",{class:!0});var Ke=a(ve);_(sn.$$.fragment,Ke),bc=l(Ke),qt=s(Ke,"P",{});var ys=a(qt);wc=i(ys,"The "),is=s(ys,"A",{href:!0});var Sm=a(is);yc=i(Sm,"LEDModel"),Sm.forEach(t),Ec=i(ys," forward method, overrides the "),Ma=s(ys,"CODE",{});var Cm=a(Ma);qc=i(Cm,"__call__"),Cm.forEach(t),Lc=i(ys," special method."),ys.forEach(t),Dc=l(Ke),_(eo.$$.fragment,Ke),zc=l(Ke),Sa=s(Ke,"P",{});var Om=a(Sa);Fc=i(Om,"Example:"),Om.forEach(t),$c=l(Ke),_(an.$$.fragment,Ke),Ke.forEach(t),fo.forEach(t),xr=l(o),Lt=s(o,"H2",{class:!0});var vi=a(Lt);to=s(vi,"A",{id:!0,class:!0,href:!0});var Am=a(to);Ca=s(Am,"SPAN",{});var Pm=a(Ca);_(rn.$$.fragment,Pm),Pm.forEach(t),Am.forEach(t),xc=l(vi),Oa=s(vi,"SPAN",{});var Nm=a(Oa);Mc=i(Nm,"LEDForConditionalGeneration"),Nm.forEach(t),vi.forEach(t),Mr=l(o),xe=s(o,"DIV",{class:!0});var _o=a(xe);_(dn.$$.fragment,_o),Sc=l(_o),ln=s(_o,"P",{});var Ti=a(ln);Cc=i(Ti,`The LED Model with a language modeling head. Can be used for summarization.
This model inherits from `),ds=s(Ti,"A",{href:!0});var jm=a(ds);Oc=i(jm,"PreTrainedModel"),jm.forEach(t),Ac=i(Ti,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Ti.forEach(t),Pc=l(_o),cn=s(_o,"P",{});var ki=a(cn);Nc=i(ki,"This model is also a PyTorch "),hn=s(ki,"A",{href:!0,rel:!0});var Im=a(hn);jc=i(Im,"torch.nn.Module"),Im.forEach(t),Ic=i(ki,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),ki.forEach(t),Bc=l(_o),Q=s(_o,"DIV",{class:!0});var Ee=a(Q);_(pn.$$.fragment,Ee),Gc=l(Ee),Dt=s(Ee,"P",{});var Es=a(Dt);Qc=i(Es,"The "),ls=s(Es,"A",{href:!0});var Bm=a(ls);Hc=i(Bm,"LEDForConditionalGeneration"),Bm.forEach(t),Wc=i(Es," forward method, overrides the "),Aa=s(Es,"CODE",{});var Gm=a(Aa);Uc=i(Gm,"__call__"),Gm.forEach(t),Rc=i(Es," special method."),Es.forEach(t),Vc=l(Ee),_(oo.$$.fragment,Ee),Kc=l(Ee),Pa=s(Ee,"P",{});var Qm=a(Pa);Xc=i(Qm,"Conditional generation example:"),Qm.forEach(t),Jc=l(Ee),_(un.$$.fragment,Ee),Zc=l(Ee),Na=s(Ee,"P",{});var Hm=a(Na);Yc=i(Hm,"Summarization example:"),Hm.forEach(t),eh=l(Ee),_(mn.$$.fragment,Ee),Ee.forEach(t),_o.forEach(t),Sr=l(o),zt=s(o,"H2",{class:!0});var bi=a(zt);no=s(bi,"A",{id:!0,class:!0,href:!0});var Wm=a(no);ja=s(Wm,"SPAN",{});var Um=a(ja);_(fn.$$.fragment,Um),Um.forEach(t),Wm.forEach(t),th=l(bi),Ia=s(bi,"SPAN",{});var Rm=a(Ia);oh=i(Rm,"LEDForSequenceClassification"),Rm.forEach(t),bi.forEach(t),Cr=l(o),le=s(o,"DIV",{class:!0});var Xe=a(le);_(_n.$$.fragment,Xe),nh=l(Xe),Ba=s(Xe,"P",{});var Vm=a(Ba);sh=i(Vm,`LED model with a sequence classification/head on top (a linear layer on top of the pooled output) e.g. for GLUE
