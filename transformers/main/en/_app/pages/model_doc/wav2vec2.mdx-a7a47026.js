...
above for more information.`),P.forEach(t),this.h()},h(){d(f,"href","/docs/transformers/main/en/main_classes/feature_extractor#transformers.FeatureExtractionMixin.save_pretrained")},m(D,P){h(D,p,P),e(p,W),e(p,f),e(f,T),e(p,x),e(p,k),e(k,y),e(p,j)},d(D){D&&t(p)}}}function T1(E){let p,W,f,T,x,k,y,j,D,P,F,A,O,X;return{c(){p=a("p"),W=r(`This class method is simply calling Wav2Vec2FeatureExtractor\u2019s
...
`),ye=s(xe,"CODE",{});var Ht=n(ye);mt=i(Ht,'model({"input_values": input_values, "token_type_ids": token_type_ids})'),Ht.forEach(t),xe.forEach(t),G.forEach(t)},m($,C){h($,p,C),e(p,W),h($,f,C),h($,T,C),e(T,x),e(x,k),e(T,y),e(T,j),e(j,D),h($,P,C),h($,F,C),e(F,A),e(F,O),e(O,X),e(F,S),e(F,q),e(q,Ve),e(F,ge),h($,B,C),h($,H,C),e(H,_e),h($,Ge,C),h($,z,C),e(z,I),e(I,Fe),e(I,ve),e(ve,Ye),e(I,Ee),e(I,oe),e(oe,ct),e(z,et),e(z,L),e(L,dt),e(L,de),e(de,pe),e(L,Je),e(L,we),e(we,pt),e(z,be),e(z,ae),e(ae,Ce),e(ae,ye),e(ye,mt)},d($){$&&t(p),$&&t(f),$&&t(T),$&&t(P),$&&t(F),$&&t(B),$&&t(H),$&&t(Ge),$&&t(z)}}}function q1(E){let p,W,f,T,x;return{c(){p=a("p"),W=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=a("code"),T=r("Module"),x=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(k){p=s(k,"P",{});var y=n(p);W=i(y,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=s(y,"CODE",{});var j=n(f);T=i(j,"Module"),j.forEach(t),x=i(y,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),y.forEach(t)},m(k,y){h(k,p,y),e(p,W),e(p,f),e(f,T),e(p,x)},d(k){k&&t(p)}}}function P1(E){let p,W,f,T,x,k,y,j,D,P,F,A,O,X,S,q,Ve,ge,B,H,_e,Ge,z,I,Fe,ve,Ye,Ee,oe,ct,et,L,dt,de,pe,Je,we,pt,be,ae,Ce,ye,mt;return{c(){p=a("p"),W=r("TF 2.0 models accepts two formats as inputs:"),f=l(),T=a("ul"),x=a("li"),k=r("having all inputs as keyword arguments (like PyTorch models), or"),y=l(),j=a("li"),D=r("having all inputs as a list, tuple or dict in the first positional arguments."),P=l(),F=a("p"),A=r("This second option is useful when using "),O=a("code"),X=r("tf.keras.Model.fit"),S=r(` method which currently requires having all the
tensors in the first argument of the model call function: `),q=a("code"),Ve=r("model(inputs)"),ge=r("."),B=l(),H=a("p"),_e=r(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),Ge=l(),z=a("ul"),I=a("li"),Fe=r("a single Tensor with "),ve=a("code"),Ye=r("input_values"),Ee=r(" only and nothing else: "),oe=a("code"),ct=r("model(inputs_ids)"),et=l(),L=a("li"),dt=r(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),de=a("code"),pe=r("model([input_values, attention_mask])"),Je=r(" or "),we=a("code"),pt=r("model([input_values, attention_mask, token_type_ids])"),be=l(),ae=a("li"),Ce=r(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),ye=a("code"),mt=r('model({"input_values": input_values, "token_type_ids": token_type_ids})')},l($){p=s($,"P",{});var C=n(p);W=i(C,"TF 2.0 models accepts two formats as inputs:"),C.forEach(t),f=c($),T=s($,"UL",{});var Ze=n(T);x=s(Ze,"LI",{});var Ke=n(x);k=i(Ke,"having all inputs as keyword arguments (like PyTorch models), or"),Ke.forEach(t),y=c(Ze),j=s(Ze,"LI",{});var Bt=n(j);D=i(Bt,"having all inputs as a list, tuple or dict in the first positional arguments."),Bt.forEach(t),Ze.forEach(t),P=c($),F=s($,"P",{});var se=n(F);A=i(se,"This second option is useful when using "),O=s(se,"CODE",{});var xt=n(O);X=i(xt,"tf.keras.Model.fit"),xt.forEach(t),S=i(se,` method which currently requires having all the
...
first positional argument :`),qe.forEach(t),Ge=c($),z=s($,"UL",{});var G=n(z);I=s(G,"LI",{});var J=n(I);Fe=i(J,"a single Tensor with "),ve=s(J,"CODE",{});var Ut=n(ve);Ye=i(Ut,"input_values"),Ut.forEach(t),Ee=i(J," only and nothing else: "),oe=s(J,"CODE",{});var ht=n(oe);ct=i(ht,"model(inputs_ids)"),ht.forEach(t),J.forEach(t),et=c(G),L=s(G,"LI",{});var Te=n(L);dt=i(Te,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),de=s(Te,"CODE",{});var Wt=n(de);pe=i(Wt,"model([input_values, attention_mask])"),Wt.forEach(t),Je=i(Te," or "),we=s(Te,"CODE",{});var U=n(we);pt=i(U,"model([input_values, attention_mask, token_type_ids])"),U.forEach(t),Te.forEach(t),be=c(G),ae=s(G,"LI",{});var xe=n(ae);Ce=i(xe,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),ye=s(xe,"CODE",{});var Ht=n(ye);mt=i(Ht,'model({"input_values": input_values, "token_type_ids": token_type_ids})'),Ht.forEach(t),xe.forEach(t),G.forEach(t)},m($,C){h($,p,C),e(p,W),h($,f,C),h($,T,C),e(T,x),e(x,k),e(T,y),e(T,j),e(j,D),h($,P,C),h($,F,C),e(F,A),e(F,O),e(O,X),e(F,S),e(F,q),e(q,Ve),e(F,ge),h($,B,C),h($,H,C),e(H,_e),h($,Ge,C),h($,z,C),e(z,I),e(I,Fe),e(I,ve),e(ve,Ye),e(I,Ee),e(I,oe),e(oe,ct),e(z,et),e(z,L),e(L,dt),e(L,de),e(de,pe),e(L,Je),e(L,we),e(we,pt),e(z,be),e(z,ae),e(ae,Ce),e(ae,ye),e(ye,mt)},d($){$&&t(p),$&&t(f),$&&t(T),$&&t(P),$&&t(F),$&&t(B),$&&t(H),$&&t(Ge),$&&t(z)}}}function z1(E){let p,W,f,T,x;return{c(){p=a("p"),W=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=a("code"),T=r("Module"),x=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(k){p=s(k,"P",{});var y=n(p);W=i(y,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=s(y,"CODE",{});var j=n(f);T=i(j,"Module"),j.forEach(t),x=i(y,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),y.forEach(t)},m(k,y){h(k,p,y),e(p,W),e(p,f),e(f,T),e(p,x)},d(k){k&&t(p)}}}function M1(E){let p,W,f,T,x;return{c(){p=a("p"),W=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=a("code"),T=r("Module"),x=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(k){p=s(k,"P",{});var y=n(p);W=i(y,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=s(y,"CODE",{});var j=n(f);T=i(j,"Module"),j.forEach(t),x=i(y,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
`}}),Ko=new fe({props:{$$slots:{default:[W1]},$$scope:{ctx:E}}}),Ds=new ue({props:{code:`from transformers import Wav2Vec2Processor, Wav2Vec2Model
import torch
from datasets import load_dataset
...
`}}),ia=new fe({props:{$$slots:{default:[E1]},$$scope:{ctx:E}}}),Cn=new ue({props:{code:`import torch
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/main/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),ca=new fe({props:{$$slots:{default:[C1]},$$scope:{ctx:E}}}),On=new V({props:{name:"call",anchor:"transformers.TFWav2Vec2Model.call",parameters:[{name:"input_values",val:": Tensor"},{name:"attention_mask",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"token_type_ids",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"position_ids",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"head_mask",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"inputs_embeds",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"training",val:": bool = False"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/wav2vec2/modeling_tf_wav2vec2.py#L1434",parametersDescription:[{anchor:"transformers.TFWav2Vec2Model.call.input_values",description:`<strong>input_values</strong> (<code>np.ndarray</code>, <code>tf.Tensor</code>, <code>List[tf.Tensor]</code> \`<code>Dict[str, tf.Tensor]</code> or <code>Dict[str, np.ndarray]</code> and each example must have the shape <code>({0})</code>) &#x2014;
...
`}}),da=new fe({props:{$$slots:{default:[q1]},$$scope:{ctx:E}}}),Ln=new ue({props:{code:`from transformers import Wav2Vec2Processor, TFWav2Vec2Model
from datasets import load_dataset
import soundfile as sf
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/main/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),ma=new fe({props:{$$slots:{default:[P1]},$$scope:{ctx:E}}}),Hn=new V({props:{name:"call",anchor:"transformers.TFWav2Vec2ForCTC.call",parameters:[{name:"input_values",val:": Tensor"},{name:"attention_mask",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"token_type_ids",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"position_ids",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"head_mask",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"inputs_embeds",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"labels",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"training",val:": typing.Optional[bool] = False"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/wav2vec2/modeling_tf_wav2vec2.py#L1558",parametersDescription:[{anchor:"transformers.TFWav2Vec2ForCTC.call.input_values",description:`<strong>input_values</strong> (<code>np.ndarray</code>, <code>tf.Tensor</code>, <code>List[tf.Tensor]</code> \`<code>Dict[str, tf.Tensor]</code> or <code>Dict[str, np.ndarray]</code> and each example must have the shape <code>({0})</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/main/en/model_doc/bert#transformers.BertTokenizer">BertTokenizer</a>. See <a href="/docs/transformers/main/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
<a href="/docs/transformers/main/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> for details.</p>
...
`}}),ha=new fe({props:{$$slots:{default:[z1]},$$scope:{ctx:E}}}),Rn=new ue({props:{code:`import tensorflow as tf
...
`}}),wa=new fe({props:{$$slots:{default:[O1]},$$scope:{ctx:E}}}),Fr=new ue({props:{code:`import optax
import numpy as np
...
library implements for all its model (such as downloading or saving etc.).`),Vp.forEach(t),lg=c(Pt),Us=s(Pt,"P",{});var Fp=n(Us);cg=i(Fp,"This model is a PyTorch "),Hs=s(Fp,"A",{href:!0,rel:!0});var ik=n(Hs);dg=i(ik,"torch.nn.Module"),ik.forEach(t),pg=i(Fp,` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),Fp.forEach(t),mg=c(Pt),me=s(Pt,"DIV",{class:!0});var ot=n(me);g(Rs.$$.fragment,ot),hg=c(ot),ro=s(ot,"P",{});var zi=n(ro);fg=i(zi,"The "),li=s(zi,"A",{href:!0});var lk=n(li);ug=i(lk,"Wav2Vec2ForCTC"),lk.forEach(t),gg=i(zi," forward method, overrides the "),Ol=s(zi,"CODE",{});var ck=n(Ol);_g=i(ck,"__call__"),ck.forEach(t),vg=i(zi," special method."),zi.forEach(t),wg=c(ot),g(Yo.$$.fragment,ot),bg=c(ot),Ll=s(ot,"P",{});var dk=n(Ll);yg=i(dk,"Example:"),dk.forEach(t),kg=c(ot),g(Xs.$$.fragment,ot),Tg=c(ot),g(Gs.$$.fragment,ot),ot.forEach(t),Pt.forEach(t),kd=c(o),io=s(o,"H2",{class:!0});var Ep=n(io);ea=s(Ep,"A",{id:!0,class:!0,href:!0});var pk=n(ea);Dl=s(pk,"SPAN",{});var mk=n(Dl);g(Js.$$.fragment,mk),mk.forEach(t),pk.forEach(t),xg=c(Ep),Sl=s(Ep,"SPAN",{});var hk=n(Sl);Wg=i(hk,"Wav2Vec2ForSequenceClassification"),hk.forEach(t),Ep.forEach(t),Td=c(o),ne=s(o,"DIV",{class:!0});var at=n(ne);g(Zs.$$.fragment,at),$g=c(at),Nl=s(at,"P",{});var fk=n(Nl);jg=i(fk,`Wav2Vec2 Model with a sequence classification head on top (a linear layer over the pooled output) for tasks like
SUPERB Keyword Spotting.`),fk.forEach(t),Vg=c(at),Ks=s(at,"P",{});var Cp=n(Ks);Fg=i(Cp,"Wav2Vec2 was proposed in "),Qs=s(Cp,"A",{href:!0,rel:!0});var uk=n(Qs);Eg=i(uk,`wav2vec 2.0: A Framework for Self-Supervised Learning of Speech
Representations`),uk.forEach(t),Cg=i(Cp,` by Alexei Baevski, Henry Zhou, Abdelrahman Mohamed, Michael
Auli.`),Cp.forEach(t),qg=c(at),Ys=s(at,"P",{});var qp=n(Ys);Pg=i(qp,"This model inherits from "),ci=s(qp,"A",{href:!0});var gk=n(ci);zg=i(gk,"PreTrainedModel"),gk.forEach(t),Mg=i(qp,`. Check the superclass documentation for the generic methods the
...
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),Op.forEach(t),f_=c(nt),Ae=s(nt,"DIV",{class:!0});var zt=n(Ae);g(hn.$$.fragment,zt),u_=c(zt),po=s(zt,"P",{});var Ai=n(po);g_=i(Ai,"The "),mi=s(Ai,"A",{href:!0});var Vk=n(mi);__=i(Vk,"Wav2Vec2ForAudioFrameClassification"),Vk.forEach(t),v_=i(Ai," forward method, overrides the "),Xl=s(Ai,"CODE",{});var Fk=n(Xl);w_=i(Fk,"__call__"),Fk.forEach(t),b_=i(Ai," special method."),Ai.forEach(t),y_=c(zt),g(aa.$$.fragment,zt),k_=c(zt),Gl=s(zt,"P",{});var Ek=n(Gl);T_=i(Ek,"Example:"),Ek.forEach(t),x_=c(zt),g(fn.$$.fragment,zt),zt.forEach(t),nt.forEach(t),$d=c(o),mo=s(o,"H2",{class:!0});var Lp=n(mo);sa=s(Lp,"A",{id:!0,class:!0,href:!0});var Ck=n(sa);Jl=s(Ck,"SPAN",{});var qk=n(Jl);g(un.$$.fragment,qk),qk.forEach(t),Ck.forEach(t),W_=c(Lp),Zl=s(Lp,"SPAN",{});var Pk=n(Zl);$_=i(Pk,"Wav2Vec2ForXVector"),Pk.forEach(t),Lp.forEach(t),jd=c(o),ie=s(o,"DIV",{class:!0});var rt=n(ie);g(gn.$$.fragment,rt),j_=c(rt),Kl=s(rt,"P",{});var zk=n(Kl);V_=i(zk,"Wav2Vec2 Model with an XVector feature extraction head on top for tasks like Speaker Verification."),zk.forEach(t),F_=c(rt),_n=s(rt,"P",{});var Dp=n(_n);E_=i(Dp,"Wav2Vec2 was proposed in "),vn=s(Dp,"A",{href:!0,rel:!0});var Mk=n(vn);C_=i(Mk,`wav2vec 2.0: A Framework for Self-Supervised Learning of Speech
...
Auli.`),Li.forEach(t),rv=c(At),jn=s(At,"P",{});var Bp=n(jn);iv=i(Bp,"This model inherits from "),ui=s(Bp,"A",{href:!0});var Rk=n(ui);lv=i(Rk,"PreTrainedModel"),Rk.forEach(t),cv=i(Bp,`. Check the superclass documentation for the generic methods the
...
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),Up.forEach(t),fv=c(At),Le=s(At,"DIV",{class:!0});var Ot=n(Le);g(En.$$.fragment,Ot),uv=c(Ot),go=s(Ot,"P",{});var Di=n(go);gv=i(Di,"The "),gi=s(Di,"A",{href:!0});var Gk=n(gi);_v=i(Gk,"Wav2Vec2ForPreTraining"),Gk.forEach(t),vv=i(Di," forward method, overrides the "),ac=s(Di,"CODE",{});var Jk=n(ac);wv=i(Jk,"__call__"),Jk.forEach(t),bv=i(Di," special method."),Di.forEach(t),yv=c(Ot),g(ia.$$.fragment,Ot),kv=c(Ot),sc=s(Ot,"P",{});var Zk=n(sc);Tv=i(Zk,"Example:"),Zk.forEach(t),xv=c(Ot),g(Cn.$$.fragment,Ot),Ot.forEach(t),At.forEach(t),Ed=c(o),_o=s(o,"H2",{class:!0});var Hp=n(_o);la=s(Hp,"A",{id:!0,class:!0,href:!0});var Kk=n(la);nc=s(Kk,"SPAN",{});var Qk=n(nc);g(qn.$$.fragment,Qk),Qk.forEach(t),Kk.forEach(t),Wv=c(Hp),rc=s(Hp,"SPAN",{});var Yk=n(rc);$v=i(Yk,"TFWav2Vec2Model"),Yk.forEach(t),Hp.forEach(t),Cd=c(o),le=s(o,"DIV",{class:!0});var it=n(le);g(Pn.$$.fragment,it),jv=c(it),ic=s(it,"P",{});var eT=n(ic);Vv=i(eT,"The bare TFWav2Vec2 Model transformer outputing raw hidden-states without any specific head on top."),eT.forEach(t),Fv=c(it),zn=s(it,"P",{});var Rp=n(zn);Ev=i(Rp,"This model inherits from "),_i=s(Rp,"A",{href:!0});var tT=n(_i);Cv=i(tT,"TFPreTrainedModel"),tT.forEach(t),qv=i(Rp,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),sm.forEach(t),vw=c(Re),Vc=s(Re,"P",{});var ST=n(Vc);ww=i(ST,"Finally, this model supports inherent JAX features such as:"),ST.forEach(t),bw=c(Re),yt=s(Re,"UL",{});var ja=n(yt);Fc=s(ja,"LI",{});var NT=n(Fc);mr=s(NT,"A",{href:!0,rel:!0});var IT=n(mr);yw=i(IT,"Just-In-Time (JIT) compilation"),IT.forEach(t),NT.forEach(t),kw=c(ja),Ec=s(ja,"LI",{});var BT=n(Ec);hr=s(BT,"A",{href:!0,rel:!0});var UT=n(hr);Tw=i(UT,"Automatic Differentiation"),UT.forEach(t),BT.forEach(t),xw=c(ja),Cc=s(ja,"LI",{});var HT=n(Cc);fr=s(HT,"A",{href:!0,rel:!0});var RT=n(fr);Ww=i(RT,"Vectorization"),RT.forEach(t),HT.forEach(t),$w=c(ja),qc=s(ja,"LI",{});var XT=n(qc);ur=s(XT,"A",{href:!0,rel:!0});var GT=n(ur);jw=i(GT,"Parallelization"),GT.forEach(t),XT.forEach(t),ja.forEach(t),Vw=c(Re),Ie=s(Re,"DIV",{class:!0});var Nt=n(Ie);g(gr.$$.fragment,Nt),Fw=c(Nt),Wo=s(Nt,"P",{});var Ui=n(Wo);Ew=i(Ui,"The "),Pc=s(Ui,"CODE",{});var JT=n(Pc);Cw=i(JT,"FlaxWav2Vec2PreTrainedModel"),JT.forEach(t),qw=i(Ui," forward method, overrides the "),zc=s(Ui,"CODE",{});var ZT=n(zc);Pw=i(ZT,"__call__"),ZT.forEach(t),zw=i(Ui," special method."),Ui.forEach(t),Mw=c(Nt),g(_a.$$.fragment,Nt),Aw=c(Nt),Mc=s(Nt,"P",{});var KT=n(Mc);Ow=i(KT,"Example:"),KT.forEach(t),Lw=c(Nt),g(_r.$$.fragment,Nt),Nt.forEach(t),Re.forEach(t),Ld=c(o),$o=s(o,"H2",{class:!0});var nm=n($o);va=s(nm,"A",{id:!0,class:!0,href:!0});var QT=n(va);Ac=s(QT,"SPAN",{});var YT=n(Ac);g(vr.$$.fragment,YT),YT.forEach(t),QT.forEach(t),Dw=c(nm),Oc=s(nm,"SPAN",{});var e1=n(Oc);Sw=i(e1,"FlaxWav2Vec2ForPreTraining"),e1.forEach(t),nm.forEach(t),Dd=c(o),Y=s(o,"DIV",{class:!0});var Xe=n(Y);g(wr.$$.fragment,Xe),Nw=c(Xe),jo=s(Xe,"P",{});var Hi=n(jo);Iw=i(Hi,"Wav2Vec2 Model with a quantizer and "),Lc=s(Hi,"CODE",{});var t1=n(Lc);Bw=i(t1,"VQ"),t1.forEach(t),Uw=i(Hi,` head on top.
