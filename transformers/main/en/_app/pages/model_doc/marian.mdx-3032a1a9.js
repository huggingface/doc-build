...
the latter silently ignores them.`)},l(x){u=s(x,"P",{});var _=a(u);z=i(_,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=s(_,"CODE",{});var $=a(f);g=i($,"Module"),$.forEach(t),w=i(_,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),_.forEach(t)},m(x,_){h(x,u,_),e(u,z),e(u,f),e(f,g),e(u,w)},d(x){x&&t(u)}}}function lf(C){let u,z,f,g,w,x,_,$,Le,ue,E,ve,X,Se,Q,ee,Oe,je,G,L,Ee,I,q,F,te,ne,ke,He,J,P,Te,N,De,oe,Me,se,ae,re,Ue,S,Re,O,H;return{c(){u=o("p"),z=r("TF 2.0 models accepts two formats as inputs:"),f=d(),g=o("ul"),w=o("li"),x=r("having all inputs as keyword arguments (like PyTorch models), or"),_=d(),$=o("li"),Le=r("having all inputs as a list, tuple or dict in the first positional arguments."),ue=d(),E=o("p"),ve=r("This second option is useful when using "),X=o("code"),Se=r("tf.keras.Model.fit"),Q=r(` method which currently requires having all the
...
`),O=s(de,"CODE",{});var xe=a(O);H=i(xe,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),xe.forEach(t),de.forEach(t),A.forEach(t)},m(m,j){h(m,u,j),e(u,z),h(m,f,j),h(m,g,j),e(g,w),e(w,x),e(g,_),e(g,$),e($,Le),h(m,ue,j),h(m,E,j),e(E,ve),e(E,X),e(X,Se),e(E,Q),e(E,ee),e(ee,Oe),e(E,je),h(m,G,j),h(m,L,j),e(L,Ee),h(m,I,j),h(m,q,j),e(q,F),e(F,te),e(F,ne),e(ne,ke),e(F,He),e(F,J),e(J,P),e(q,Te),e(q,N),e(N,De),e(N,oe),e(oe,Me),e(N,se),e(N,ae),e(ae,re),e(q,Ue),e(q,S),e(S,Re),e(S,O),e(O,H)},d(m){m&&t(u),m&&t(f),m&&t(g),m&&t(ue),m&&t(E),m&&t(G),m&&t(L),m&&t(I),m&&t(q)}}}function cf(C){let u,z,f,g,w;return{c(){u=o("p"),z=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=o("code"),g=r("Module"),w=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(x){u=s(x,"P",{});var _=a(u);z=i(_,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=s(_,"CODE",{});var $=a(f);g=i($,"Module"),$.forEach(t),w=i(_,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),_.forEach(t)},m(x,_){h(x,u,_),e(u,z),e(u,f),e(f,g),e(u,w)},d(x){x&&t(u)}}}function pf(C){let u,z,f,g,w,x,_,$,Le,ue,E,ve,X,Se,Q,ee,Oe,je,G,L,Ee,I,q,F,te,ne,ke,He,J,P,Te,N,De,oe,Me,se,ae,re,Ue,S,Re,O,H;return{c(){u=o("p"),z=r("TF 2.0 models accepts two formats as inputs:"),f=d(),g=o("ul"),w=o("li"),x=r("having all inputs as keyword arguments (like PyTorch models), or"),_=d(),$=o("li"),Le=r("having all inputs as a list, tuple or dict in the first positional arguments."),ue=d(),E=o("p"),ve=r("This second option is useful when using "),X=o("code"),Se=r("tf.keras.Model.fit"),Q=r(` method which currently requires having all the
tensors in the first argument of the model call function: `),ee=o("code"),Oe=r("model(inputs)"),je=r("."),G=d(),L=o("p"),Ee=r(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),I=d(),q=o("ul"),F=o("li"),te=r("a single Tensor with "),ne=o("code"),ke=r("input_ids"),He=r(" only and nothing else: "),J=o("code"),P=r("model(input_ids)"),Te=d(),N=o("li"),De=r(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),oe=o("code"),Me=r("model([input_ids, attention_mask])"),se=r(" or "),ae=o("code"),re=r("model([input_ids, attention_mask, token_type_ids])"),Ue=d(),S=o("li"),Re=r(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),O=o("code"),H=r('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(m){u=s(m,"P",{});var j=a(u);z=i(j,"TF 2.0 models accepts two formats as inputs:"),j.forEach(t),f=l(m),g=s(m,"UL",{});var be=a(g);w=s(be,"LI",{});var ot=a(w);x=i(ot,"having all inputs as keyword arguments (like PyTorch models), or"),ot.forEach(t),_=l(be),$=s(be,"LI",{});var ye=a($);Le=i(ye,"having all inputs as a list, tuple or dict in the first positional arguments."),ye.forEach(t),be.forEach(t),ue=l(m),E=s(m,"P",{});var D=a(E);ve=i(D,"This second option is useful when using "),X=s(D,"CODE",{});var st=a(X);Se=i(st,"tf.keras.Model.fit"),st.forEach(t),Q=i(D,` method which currently requires having all the
...
first positional argument :`),We.forEach(t),I=l(m),q=s(m,"UL",{});var A=a(q);F=s(A,"LI",{});var ie=a(F);te=i(ie,"a single Tensor with "),ne=s(ie,"CODE",{});var rt=a(ne);ke=i(rt,"input_ids"),rt.forEach(t),He=i(ie," only and nothing else: "),J=s(ie,"CODE",{});var Be=a(J);P=i(Be,"model(input_ids)"),Be.forEach(t),ie.forEach(t),Te=l(A),N=s(A,"LI",{});var U=a(N);De=i(U,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),oe=s(U,"CODE",{});var it=a(oe);Me=i(it,"model([input_ids, attention_mask])"),it.forEach(t),se=i(U," or "),ae=s(U,"CODE",{});var dt=a(ae);re=i(dt,"model([input_ids, attention_mask, token_type_ids])"),dt.forEach(t),U.forEach(t),Ue=l(A),S=s(A,"LI",{});var de=a(S);Re=i(de,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),O=s(de,"CODE",{});var xe=a(O);H=i(xe,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),xe.forEach(t),de.forEach(t),A.forEach(t)},m(m,j){h(m,u,j),e(u,z),h(m,f,j),h(m,g,j),e(g,w),e(w,x),e(g,_),e(g,$),e($,Le),h(m,ue,j),h(m,E,j),e(E,ve),e(E,X),e(X,Se),e(E,Q),e(E,ee),e(ee,Oe),e(E,je),h(m,G,j),h(m,L,j),e(L,Ee),h(m,I,j),h(m,q,j),e(q,F),e(F,te),e(F,ne),e(ne,ke),e(F,He),e(F,J),e(J,P),e(q,Te),e(q,N),e(N,De),e(N,oe),e(oe,Me),e(N,se),e(N,ae),e(ae,re),e(q,Ue),e(q,S),e(S,Re),e(S,O),e(O,H)},d(m){m&&t(u),m&&t(f),m&&t(g),m&&t(ue),m&&t(E),m&&t(G),m&&t(L),m&&t(I),m&&t(q)}}}function hf(C){let u,z,f,g,w;return{c(){u=o("p"),z=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=o("code"),g=r("Module"),w=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(x){u=s(x,"P",{});var _=a(u);z=i(_,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=s(_,"CODE",{});var $=a(f);g=i($,"Module"),$.forEach(t),w=i(_,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
the latter silently ignores them.`)},l(x){u=s(x,"P",{});var _=a(u);z=i(_,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=s(_,"CODE",{});var $=a(f);g=i($,"Module"),$.forEach(t),w=i(_,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),_.forEach(t)},m(x,_){h(x,u,_),e(u,z),e(u,f),e(f,g),e(u,w)},d(x){x&&t(u)}}}function ff(C){let u,z,f,g,w,x,_,$,Le,ue,E,ve,X,Se,Q,ee,Oe,je,G,L,Ee,I,q,F,te,ne,ke,He,J,P,Te,N,De,oe,Me,se,ae,re,Ue,S,Re,O,H,m,j,be,ot,ye,D,st,at,We,A,ie,rt,Be,U,it,dt,de,xe,wi,Xo,zi,$i,ji,lt,hn,Ei,Ps,qi,Pi,Fi,un,Ni,Fs,Ci,Ii,Ai,ct,Li,Ns,Si,Oi,Cs,Hi,Di,Ui,Is,mn,Ri,As,Wi,Bi,Vi,Ls,fn,Gi,gn,Ji,Yi,er,pt,Ct,Ss,_n,Ki,Os,Zi,tr,qe,Qo,Xi,Hs,Qi,ed,vn,td,kn,nd,od,sd,ht,ad,Ds,rd,id,Us,dd,ld,cd,Rs,pd,nr,ut,It,Ws,Tn,hd,Bs,ud,or,Je,Vs,md,fd,Gs,Mn,gd,_d,Js,bn,vd,sr,mt,At,Ys,yn,kd,Ks,Td,ar,Pe,xn,Md,Zs,bd,yd,xd,wn,wd,Xs,zd,$d,jd,zn,Ed,$n,qd,Pd,Fd,jn,Nd,Qs,Cd,Id,rr,Lt,Ad,En,Ld,Sd,ir,qn,dr,es,Od,lr,Pn,cr,ft,St,ea,Fn,Hd,ta,Dd,pr,ts,Ud,hr,Nn,ur,ns,Rd,mr,Cn,fr,gt,Ot,na,In,Wd,oa,Bd,gr,le,An,Vd,_t,Gd,os,Jd,Yd,Ln,Kd,Zd,Xd,vt,Qd,ss,el,tl,as,nl,ol,sl,sa,al,rl,Sn,_r,kt,Ht,aa,On,il,ra,dl,vr,R,Hn,ll,Dn,cl,Un,pl,hl,ul,Rn,ml,rs,fl,gl,_l,ia,vl,kl,Wn,Tl,Dt,Bn,Ml,da,bl,kr,Tt,Ut,la,Vn,yl,ca,xl,Tr,we,Gn,wl,Jn,zl,is,$l,jl,El,Yn,ql,Kn,Pl,Fl,Nl,me,Zn,Cl,Mt,Il,ds,Al,Ll,pa,Sl,Ol,Hl,Rt,Dl,ha,Ul,Rl,Xn,Mr,bt,Wt,ua,Qn,Wl,ma,Bl,br,ze,eo,Vl,to,Gl,ls,Jl,Yl,Kl,no,Zl,oo,Xl,Ql,ec,Y,so,tc,yt,nc,cs,oc,sc,fa,ac,rc,ic,Bt,dc,ao,lc,ro,cc,pc,hc,ga,uc,mc,io,yr,xt,Vt,_a,lo,fc,va,gc,xr,wt,co,_c,Ye,po,vc,ka,kc,Tc,ho,wr,zt,Gt,Ta,uo,Mc,Ma,bc,zr,ce,mo,yc,fo,xc,ps,wc,zc,$c,go,jc,_o,Ec,qc,Pc,Jt,Fc,fe,vo,Nc,$t,Cc,hs,Ic,Ac,ba,Lc,Sc,Oc,Yt,Hc,ya,Dc,Uc,ko,$r,jt,Kt,xa,To,Rc,wa,Wc,jr,pe,Mo,Bc,bo,Vc,us,Gc,Jc,Yc,yo,Kc,xo,Zc,Xc,Qc,Zt,ep,K,wo,tp,Et,np,ms,op,sp,za,ap,rp,ip,Xt,dp,zo,lp,$o,cp,pp,hp,$a,up,mp,jo,Er,qt,Qt,ja,Eo,fp,Ea,gp,qr,W,qo,_p,Po,vp,fs,kp,Tp,Mp,Fo,bp,No,yp,xp,wp,qa,zp,$p,Ve,Pa,Co,jp,Ep,Fa,Io,qp,Pp,Na,Ao,Fp,Np,Ca,Lo,Cp,Ip,ge,So,Ap,Pt,Lp,Ia,Sp,Op,Aa,Hp,Dp,Up,en,Rp,La,Wp,Bp,Oo,Pr,Ft,tn,Sa,Ho,Vp,Oa,Gp,Fr,B,Do,Jp,Uo,Yp,gs,Kp,Zp,Xp,Ro,Qp,Wo,eh,th,nh,Ha,oh,sh,Ge,Da,Bo,ah,rh,Ua,Vo,ih,dh,Ra,Go,lh,ch,Wa,Jo,ph,hh,_e,Yo,uh,Nt,mh,Ba,fh,gh,Va,_h,vh,kh,nn,Th,Ga,Mh,bh,Ko,Nr;return x=new he({}),te=new he({}),_n=new he({}),Tn=new he({}),yn=new he({}),qn=new $e({props:{code:`from transformers import MarianMTModel, MarianTokenizer
...
[<span class="hljs-number">1</span>, <span class="hljs-number">26</span>, <span class="hljs-number">512</span>]`}}),Qn=new he({}),eo=new V({props:{name:"class transformers.MarianMTModel",anchor:"transformers.MarianMTModel",parameters:[{name:"config",val:": MarianConfig"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/marian/modeling_marian.py#L1272",parametersDescription:[{anchor:"transformers.MarianMTModel.config",description:`<strong>config</strong> (<a href="/docs/transformers/main/en/model_doc/marian#transformers.MarianConfig">MarianConfig</a>) &#x2014;
Model configuration class with all the parameters of the model. Initializing with a config file does not
load the weights associated with the model, only the configuration. Check out the
<a href="/docs/transformers/main/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),so=new V({props:{name:"forward",anchor:"transformers.MarianMTModel.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"decoder_input_ids",val:" = None"},{name:"decoder_attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"decoder_head_mask",val:" = None"},{name:"cross_attn_head_mask",val:" = None"},{name:"encoder_outputs",val:" = None"},{name:"past_key_values",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"decoder_inputs_embeds",val:" = None"},{name:"labels",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/marian/modeling_marian.py#L1398",parametersDescription:[{anchor:"transformers.MarianMTModel.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. Padding will be ignored by default should you provide
it.</p>
<p>Indices can be obtained using <a href="/docs/transformers/main/en/model_doc/marian#transformers.MarianTokenizer">MarianTokenizer</a>. See <a href="/docs/transformers/main/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/main/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
<span class="hljs-string">&quot;Where&#x27;s the bus stop?&quot;</span>`}}),lo=new he({}),co=new V({props:{name:"class transformers.MarianForCausalLM",anchor:"transformers.MarianForCausalLM",parameters:[{name:"config",val:""}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/marian/modeling_marian.py#L1542"}}),po=new V({props:{name:"forward",anchor:"transformers.MarianForCausalLM.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"encoder_hidden_states",val:" = None"},{name:"encoder_attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"cross_attn_head_mask",val:" = None"},{name:"past_key_values",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"labels",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/marian/modeling_marian.py#L1573",parametersDescription:[{anchor:"transformers.MarianForCausalLM.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),To=new he({}),Mo=new V({props:{name:"class transformers.TFMarianMTModel",anchor:"transformers.TFMarianMTModel",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/marian/modeling_tf_marian.py#L1315",parametersDescription:[{anchor:"transformers.TFMarianMTModel.config",description:`<strong>config</strong> (<a href="/docs/transformers/main/en/model_doc/marian#transformers.MarianConfig">MarianConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/main/en/main_classes/model#transformers.TFPreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),Zt=new pn({props:{$$slots:{default:[pf]},$$scope:{ctx:C}}}),wo=new V({props:{name:"call",anchor:"transformers.TFMarianMTModel.call",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"decoder_input_ids",val:" = None"},{name:"decoder_attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"decoder_head_mask",val:" = None"},{name:"cross_attn_head_mask",val:" = None"},{name:"encoder_outputs",val:": typing.Optional[transformers.modeling_tf_outputs.TFBaseModelOutput] = None"},{name:"past_key_values",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"decoder_inputs_embeds",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"},{name:"labels",val:" = None"},{name:"training",val:" = False"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/marian/modeling_tf_marian.py#L1348",parametersDescription:[{anchor:"transformers.TFMarianMTModel.call.input_ids",description:`<strong>input_ids</strong> (<code>tf.Tensor</code> of shape <code>({0})</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/main/en/model_doc/marian#transformers.MarianTokenizer">MarianTokenizer</a>. See <a href="/docs/transformers/main/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/main/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-comment"># should give *Meine Freunde sind cool, aber sie essen zu viele Kohlenhydrate.*</span>`}}),{c(){u=o("meta"),z=d(),f=o("h1"),g=o("a"),w=o("span"),v(x.$$.fragment),_=d(),$=o("span"),Le=r("MarianMT"),ue=d(),E=o("p"),ve=o("strong"),X=r("Bugs:"),Se=r(" If you see something strange, file a "),Q=o("a"),ee=r("Github Issue"),Oe=r(`
...
group:`),hr=d(),v(Nn.$$.fragment),ur=d(),ns=o("p"),Rd=r("Example of translating english to many romance languages, using old-style 2 character language codes"),mr=d(),v(Cn.$$.fragment),fr=d(),gt=o("h2"),Ot=o("a"),na=o("span"),v(In.$$.fragment),Wd=d(),oa=o("span"),Bd=r("MarianConfig"),gr=d(),le=o("div"),v(An.$$.fragment),Vd=d(),_t=o("p"),Gd=r("This is the configuration class to store the configuration of a "),os=o("a"),Jd=r("MarianModel"),Yd=r(`. It is used to instantiate an
...
this superclass for more information regarding those methods.`),_l=d(),ia=o("p"),vl=r("Examples:"),kl=d(),v(Wn.$$.fragment),Tl=d(),Dt=o("div"),v(Bn.$$.fragment),Ml=d(),da=o("p"),bl=r(`Temporarily sets the tokenizer for encoding the targets. Useful for tokenizer associated to
...
`),Cs=s(ks,"CODE",{});var Uh=a(Cs);Hi=i(Uh,"<s/>"),Uh.forEach(t),Di=i(ks,"),"),ks.forEach(t),vs.forEach(t),Ar.forEach(t),Ui=l(Z),Is=s(Z,"LI",{});var Rh=a(Is);mn=s(Rh,"P",{});var Hr=a(mn);Ri=i(Hr,"Code to bulk convert models can be found in "),As=s(Hr,"CODE",{});var Wh=a(As);Wi=i(Wh,"convert_marian_to_pytorch.py"),Wh.forEach(t),Bi=i(Hr,"."),Hr.forEach(t),Rh.forEach(t),Vi=l(Z),Ls=s(Z,"LI",{});var Bh=a(Ls);fn=s(Bh,"P",{});var Dr=a(fn);Gi=i(Dr,"This model was contributed by "),gn=s(Dr,"A",{href:!0,rel:!0});var Vh=a(gn);Ji=i(Vh,"sshleifer"),Vh.forEach(t),Yi=i(Dr,"."),Dr.forEach(t),Bh.forEach(t),Z.forEach(t),er=l(n),pt=s(n,"H2",{class:!0});var Ur=a(pt);Ct=s(Ur,"A",{id:!0,class:!0,href:!0});var Gh=a(Ct);Ss=s(Gh,"SPAN",{});var Jh=a(Ss);k(_n.$$.fragment,Jh),Jh.forEach(t),Gh.forEach(t),Ki=l(Ur),Os=s(Ur,"SPAN",{});var Yh=a(Os);Zi=i(Yh,"Naming"),Yh.forEach(t),Ur.forEach(t),tr=l(n),qe=s(n,"UL",{});var sn=a(qe);Qo=s(sn,"LI",{});var yh=a(Qo);Xi=i(yh,"All model names use the following format: "),Hs=s(yh,"CODE",{});var Kh=a(Hs);Qi=i(Kh,"Helsinki-NLP/opus-mt-{src}-{tgt}"),Kh.forEach(t),yh.forEach(t),ed=l(sn),vn=s(sn,"LI",{});var Rr=a(vn);td=i(Rr,"The language codes used to name models are inconsistent. Two digit codes can usually be found "),kn=s(Rr,"A",{href:!0,rel:!0});var Zh=a(kn);nd=i(Zh,"here"),Zh.forEach(t),od=i(Rr,`, three digit codes require googling \u201Clanguage
...
fine-tuning experiments and integration tests.`),su.forEach(t),fd=l(Ms),Gs=s(Ms,"LI",{});var au=a(Gs);Mn=s(au,"A",{href:!0,rel:!0});var ru=a(Mn);gd=i(ru,"Fine-tune on GPU"),ru.forEach(t),au.forEach(t),_d=l(Ms),Js=s(Ms,"LI",{});var iu=a(Js);bn=s(iu,"A",{href:!0,rel:!0});var du=a(bn);vd=i(du,"Fine-tune on GPU with pytorch-lightning"),du.forEach(t),iu.forEach(t),Ms.forEach(t),sr=l(n),mt=s(n,"H2",{class:!0});var Br=a(mt);At=s(Br,"A",{id:!0,class:!0,href:!0});var lu=a(At);Ys=s(lu,"SPAN",{});var cu=a(Ys);k(yn.$$.fragment,cu),cu.forEach(t),lu.forEach(t),kd=l(Br),Ks=s(Br,"SPAN",{});var pu=a(Ks);Td=i(pu,"Multilingual Models"),pu.forEach(t),Br.forEach(t),ar=l(n),Pe=s(n,"UL",{});var an=a(Pe);xn=s(an,"LI",{});var Vr=a(xn);Md=i(Vr,"All model names use the following format: "),Zs=s(Vr,"CODE",{});var hu=a(Zs);bd=i(hu,"Helsinki-NLP/opus-mt-{src}-{tgt}"),hu.forEach(t),yd=i(Vr,":"),Vr.forEach(t),xd=l(an),wn=s(an,"LI",{});var Gr=a(wn);wd=i(Gr,`If a model can output multiple languages, and you should specify a language code by prepending the desired output
...
codes are required.`),Yr.forEach(t),an.forEach(t),rr=l(n),Lt=s(n,"P",{});var Kr=a(Lt);Ad=i(Kr,"New multi-lingual models from the "),En=s(Kr,"A",{href:!0,rel:!0});var gu=a(En);Ld=i(gu,"Tatoeba-Challenge repo"),gu.forEach(t),Sd=i(Kr,`
...
group:`),Mu.forEach(t),hr=l(n),k(Nn.$$.fragment,n),ur=l(n),ns=s(n,"P",{});var bu=a(ns);Rd=i(bu,"Example of translating english to many romance languages, using old-style 2 character language codes"),bu.forEach(t),mr=l(n),k(Cn.$$.fragment,n),fr=l(n),gt=s(n,"H2",{class:!0});var Xr=a(gt);Ot=s(Xr,"A",{id:!0,class:!0,href:!0});var yu=a(Ot);na=s(yu,"SPAN",{});var xu=a(na);k(In.$$.fragment,xu),xu.forEach(t),yu.forEach(t),Wd=l(Xr),oa=s(Xr,"SPAN",{});var wu=a(oa);Bd=i(wu,"MarianConfig"),wu.forEach(t),Xr.forEach(t),gr=l(n),le=s(n,"DIV",{class:!0});var Ke=a(le);k(An.$$.fragment,Ke),Vd=l(Ke),_t=s(Ke,"P",{});var bs=a(_t);Gd=i(bs,"This is the configuration class to store the configuration of a "),os=s(bs,"A",{href:!0});var zu=a(os);Jd=i(zu,"MarianModel"),zu.forEach(t),Yd=i(bs,`. It is used to instantiate an
Marian model according to the specified arguments, defining the model architecture. Instantiating a configuration
with the defaults will yield a similar configuration to that of the Marian
...
models are listed `),$o=s(vi,"A",{href:!0,rel:!0});var Tm=a($o);cp=i(Tm,"here"),Tm.forEach(t),pp=i(vi,"."),vi.forEach(t),hp=l(Ce),$a=s(Ce,"P",{});var Mm=a($a);up=i(Mm,"Examples:"),Mm.forEach(t),mp=l(Ce),k(jo.$$.fragment,Ce),Ce.forEach(t),et.forEach(t),Er=l(n),qt=s(n,"H2",{class:!0});var ki=a(qt);Qt=s(ki,"A",{id:!0,class:!0,href:!0});var bm=a(Qt);ja=s(bm,"SPAN",{});var ym=a(ja);k(Eo.$$.fragment,ym),ym.forEach(t),bm.forEach(t),fp=l(ki),Ea=s(ki,"SPAN",{});var xm=a(Ea);gp=i(xm,"FlaxMarianModel"),xm.forEach(t),ki.forEach(t),qr=l(n),W=s(n,"DIV",{class:!0});var Ie=a(W);k(qo.$$.fragment,Ie),_p=l(Ie),Po=s(Ie,"P",{});var Ti=a(Po);vp=i(Ti,`The bare Marian Model transformer outputting raw hidden-states without any specific head on top.
