...
the latter silently ignores them.`)},l(k){p=s(k,"P",{});var _=a(p);y=i(_,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=s(_,"CODE",{});var F=a(f);g=i(F,"Module"),F.forEach(t),v=i(_,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),_.forEach(t)},m(k,_){m(k,p,_),e(p,y),e(p,f),e(f,g),e(p,v)},d(k){k&&t(p)}}}function R_(H){let p,y,f,g,v,k,_,F,le,U,z,X,S,G,de,O,ce,se,R,A,Y,V,E,q,Z,Q,ae,ee,B,re,te,C,pe,W,oe,he,x,ne,j,me;return{c(){p=n("p"),y=r("TF 2.0 models accepts two formats as inputs:"),f=l(),g=n("ul"),v=n("li"),k=r("having all inputs as keyword arguments (like PyTorch models), or"),_=l(),F=n("li"),le=r("having all inputs as a list, tuple or dict in the first positional arguments."),U=l(),z=n("p"),X=r("This second option is useful when using "),S=n("code"),G=r("tf.keras.Model.fit"),de=r(` method which currently requires having all the
tensors in the first argument of the model call function: `),O=n("code"),ce=r("model(inputs)"),se=r("."),R=l(),A=n("p"),Y=r(`If you choose this second option, there are three possibilities you can use to gather all the input Tensor in the
first positional argument :`),V=l(),E=n("ul"),q=n("li"),Z=r("a single Tensor with "),Q=n("code"),ae=r("input_ids"),ee=r(" only and nothing else: "),B=n("code"),re=r("model(inputs_ids)"),te=l(),C=n("li"),pe=r(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),W=n("code"),oe=r("model([input_ids, attention_mask])"),he=l(),x=n("li"),ne=r(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),j=n("code"),me=r('model({"input_ids": input_ids, "attention_mask": attention_mask})')},l(c){p=s(c,"P",{});var T=a(p);y=i(T,"TF 2.0 models accepts two formats as inputs:"),T.forEach(t),f=d(c),g=s(c,"UL",{});var K=a(g);v=s(K,"LI",{});var _e=a(v);k=i(_e,"having all inputs as keyword arguments (like PyTorch models), or"),_e.forEach(t),_=d(K),F=s(K,"LI",{});var ve=a(F);le=i(ve,"having all inputs as a list, tuple or dict in the first positional arguments."),ve.forEach(t),K.forEach(t),U=d(c),z=s(c,"P",{});var I=a(z);X=i(I,"This second option is useful when using "),S=s(I,"CODE",{});var ke=a(S);G=i(ke,"tf.keras.Model.fit"),ke.forEach(t),de=i(I,` method which currently requires having all the
...
the latter silently ignores them.`)},l(k){p=s(k,"P",{});var _=a(p);y=i(_,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=s(_,"CODE",{});var F=a(f);g=i(F,"Module"),F.forEach(t),v=i(_,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),_.forEach(t)},m(k,_){m(k,p,_),e(p,y),e(p,f),e(f,g),e(p,v)},d(k){k&&t(p)}}}function V_(H){let p,y,f,g,v,k,_,F,le,U,z,X,S,G,de,O,ce,se,R,A,Y,V,E,q,Z,Q,ae,ee,B,re,te,C,pe,W,oe,he,x,ne,j,me;return{c(){p=n("p"),y=r("TF 2.0 models accepts two formats as inputs:"),f=l(),g=n("ul"),v=n("li"),k=r("having all inputs as keyword arguments (like PyTorch models), or"),_=l(),F=n("li"),le=r("having all inputs as a list, tuple or dict in the first positional arguments."),U=l(),z=n("p"),X=r("This second option is useful when using "),S=n("code"),G=r("tf.keras.Model.fit"),de=r(` method which currently requires having all the
tensors in the first argument of the model call function: `),O=n("code"),ce=r("model(inputs)"),se=r("."),R=l(),A=n("p"),Y=r(`If you choose this second option, there are three possibilities you can use to gather all the input Tensor in the
first positional argument :`),V=l(),E=n("ul"),q=n("li"),Z=r("a single Tensor with "),Q=n("code"),ae=r("input_ids"),ee=r(" only and nothing else: "),B=n("code"),re=r("model(inputs_ids)"),te=l(),C=n("li"),pe=r(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),W=n("code"),oe=r("model([input_ids, attention_mask])"),he=l(),x=n("li"),ne=r(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),j=n("code"),me=r('model({"input_ids": input_ids, "attention_mask": attention_mask})')},l(c){p=s(c,"P",{});var T=a(p);y=i(T,"TF 2.0 models accepts two formats as inputs:"),T.forEach(t),f=d(c),g=s(c,"UL",{});var K=a(g);v=s(K,"LI",{});var _e=a(v);k=i(_e,"having all inputs as keyword arguments (like PyTorch models), or"),_e.forEach(t),_=d(K),F=s(K,"LI",{});var ve=a(F);le=i(ve,"having all inputs as a list, tuple or dict in the first positional arguments."),ve.forEach(t),K.forEach(t),U=d(c),z=s(c,"P",{});var I=a(z);X=i(I,"This second option is useful when using "),S=s(I,"CODE",{});var ke=a(S);G=i(ke,"tf.keras.Model.fit"),ke.forEach(t),de=i(I,` method which currently requires having all the
...
the latter silently ignores them.`)},l(k){p=s(k,"P",{});var _=a(p);y=i(_,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=s(_,"CODE",{});var F=a(f);g=i(F,"Module"),F.forEach(t),v=i(_,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),_.forEach(t)},m(k,_){m(k,p,_),e(p,y),e(p,f),e(f,g),e(p,v)},d(k){k&&t(p)}}}function X_(H){let p,y,f,g,v,k,_,F,le,U,z,X,S,G,de,O,ce,se,R,A,Y,V,E,q,Z,Q,ae,ee,B,re,te,C,pe,W,oe,he,x,ne,j,me;return{c(){p=n("p"),y=r("TF 2.0 models accepts two formats as inputs:"),f=l(),g=n("ul"),v=n("li"),k=r("having all inputs as keyword arguments (like PyTorch models), or"),_=l(),F=n("li"),le=r("having all inputs as a list, tuple or dict in the first positional arguments."),U=l(),z=n("p"),X=r("This second option is useful when using "),S=n("code"),G=r("tf.keras.Model.fit"),de=r(` method which currently requires having all the
tensors in the first argument of the model call function: `),O=n("code"),ce=r("model(inputs)"),se=r("."),R=l(),A=n("p"),Y=r(`If you choose this second option, there are three possibilities you can use to gather all the input Tensor in the
first positional argument :`),V=l(),E=n("ul"),q=n("li"),Z=r("a single Tensor with "),Q=n("code"),ae=r("input_ids"),ee=r(" only and nothing else: "),B=n("code"),re=r("model(inputs_ids)"),te=l(),C=n("li"),pe=r(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),W=n("code"),oe=r("model([input_ids, attention_mask])"),he=l(),x=n("li"),ne=r(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),j=n("code"),me=r('model({"input_ids": input_ids, "attention_mask": attention_mask})')},l(c){p=s(c,"P",{});var T=a(p);y=i(T,"TF 2.0 models accepts two formats as inputs:"),T.forEach(t),f=d(c),g=s(c,"UL",{});var K=a(g);v=s(K,"LI",{});var _e=a(v);k=i(_e,"having all inputs as keyword arguments (like PyTorch models), or"),_e.forEach(t),_=d(K),F=s(K,"LI",{});var ve=a(F);le=i(ve,"having all inputs as a list, tuple or dict in the first positional arguments."),ve.forEach(t),K.forEach(t),U=d(c),z=s(c,"P",{});var I=a(z);X=i(I,"This second option is useful when using "),S=s(I,"CODE",{});var ke=a(S);G=i(ke,"tf.keras.Model.fit"),ke.forEach(t),de=i(I,` method which currently requires having all the
...
the latter silently ignores them.`)},l(k){p=s(k,"P",{});var _=a(p);y=i(_,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=s(_,"CODE",{});var F=a(f);g=i(F,"Module"),F.forEach(t),v=i(_,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),_.forEach(t)},m(k,_){m(k,p,_),e(p,y),e(p,f),e(f,g),e(p,v)},d(k){k&&t(p)}}}function G_(H){let p,y,f,g,v,k,_,F,le,U,z,X,S,G,de,O,ce,se,R,A,Y,V,E,q,Z,Q,ae,ee,B,re,te,C,pe,W,oe,he,x,ne,j,me;return{c(){p=n("p"),y=r("TF 2.0 models accepts two formats as inputs:"),f=l(),g=n("ul"),v=n("li"),k=r("having all inputs as keyword arguments (like PyTorch models), or"),_=l(),F=n("li"),le=r("having all inputs as a list, tuple or dict in the first positional arguments."),U=l(),z=n("p"),X=r("This second option is useful when using "),S=n("code"),G=r("tf.keras.Model.fit"),de=r(` method which currently requires having all the
tensors in the first argument of the model call function: `),O=n("code"),ce=r("model(inputs)"),se=r("."),R=l(),A=n("p"),Y=r(`If you choose this second option, there are three possibilities you can use to gather all the input Tensor in the
first positional argument :`),V=l(),E=n("ul"),q=n("li"),Z=r("a single Tensor with "),Q=n("code"),ae=r("input_ids"),ee=r(" only and nothing else: "),B=n("code"),re=r("model(inputs_ids)"),te=l(),C=n("li"),pe=r(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),W=n("code"),oe=r("model([input_ids, attention_mask])"),he=l(),x=n("li"),ne=r(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),j=n("code"),me=r('model({"input_ids": input_ids, "attention_mask": attention_mask})')},l(c){p=s(c,"P",{});var T=a(p);y=i(T,"TF 2.0 models accepts two formats as inputs:"),T.forEach(t),f=d(c),g=s(c,"UL",{});var K=a(g);v=s(K,"LI",{});var _e=a(v);k=i(_e,"having all inputs as keyword arguments (like PyTorch models), or"),_e.forEach(t),_=d(K),F=s(K,"LI",{});var ve=a(F);le=i(ve,"having all inputs as a list, tuple or dict in the first positional arguments."),ve.forEach(t),K.forEach(t),U=d(c),z=s(c,"P",{});var I=a(z);X=i(I,"This second option is useful when using "),S=s(I,"CODE",{});var ke=a(S);G=i(ke,"tf.keras.Model.fit"),ke.forEach(t),de=i(I,` method which currently requires having all the
...
the latter silently ignores them.`)},l(k){p=s(k,"P",{});var _=a(p);y=i(_,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=s(_,"CODE",{});var F=a(f);g=i(F,"Module"),F.forEach(t),v=i(_,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),_.forEach(t)},m(k,_){m(k,p,_),e(p,y),e(p,f),e(f,g),e(p,v)},d(k){k&&t(p)}}}function Z_(H){let p,y,f,g,v,k,_,F,le,U,z,X,S,G,de,O,ce,se,R,A,Y,V,E,q,Z,Q,ae,ee,B,re,te,C,pe,W,oe,he,x,ne,j,me;return{c(){p=n("p"),y=r("TF 2.0 models accepts two formats as inputs:"),f=l(),g=n("ul"),v=n("li"),k=r("having all inputs as keyword arguments (like PyTorch models), or"),_=l(),F=n("li"),le=r("having all inputs as a list, tuple or dict in the first positional arguments."),U=l(),z=n("p"),X=r("This second option is useful when using "),S=n("code"),G=r("tf.keras.Model.fit"),de=r(` method which currently requires having all the
tensors in the first argument of the model call function: `),O=n("code"),ce=r("model(inputs)"),se=r("."),R=l(),A=n("p"),Y=r(`If you choose this second option, there are three possibilities you can use to gather all the input Tensor in the
first positional argument :`),V=l(),E=n("ul"),q=n("li"),Z=r("a single Tensor with "),Q=n("code"),ae=r("input_ids"),ee=r(" only and nothing else: "),B=n("code"),re=r("model(inputs_ids)"),te=l(),C=n("li"),pe=r(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),W=n("code"),oe=r("model([input_ids, attention_mask])"),he=l(),x=n("li"),ne=r(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),j=n("code"),me=r('model({"input_ids": input_ids, "attention_mask": attention_mask})')},l(c){p=s(c,"P",{});var T=a(p);y=i(T,"TF 2.0 models accepts two formats as inputs:"),T.forEach(t),f=d(c),g=s(c,"UL",{});var K=a(g);v=s(K,"LI",{});var _e=a(v);k=i(_e,"having all inputs as keyword arguments (like PyTorch models), or"),_e.forEach(t),_=d(K),F=s(K,"LI",{});var ve=a(F);le=i(ve,"having all inputs as a list, tuple or dict in the first positional arguments."),ve.forEach(t),K.forEach(t),U=d(c),z=s(c,"P",{});var I=a(z);X=i(I,"This second option is useful when using "),S=s(I,"CODE",{});var ke=a(S);G=i(ke,"tf.keras.Model.fit"),ke.forEach(t),de=i(I,` method which currently requires having all the
...
the latter silently ignores them.`)},l(k){p=s(k,"P",{});var _=a(p);y=i(_,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=s(_,"CODE",{});var F=a(f);g=i(F,"Module"),F.forEach(t),v=i(_,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),_.forEach(t)},m(k,_){m(k,p,_),e(p,y),e(p,f),e(f,g),e(p,v)},d(k){k&&t(p)}}}function tk(H){let p,y,f,g,v,k,_,F,le,U,z,X,S,G,de,O,ce,se,R,A,Y,V,E,q,Z,Q,ae,ee,B,re,te,C,pe,W,oe,he,x,ne,j,me,c,T,K,_e,ve,I,ke,Te,Me,L,D,be,ge,ue,we,ie,fe,no,ja,Ho,Sl,xa,Ol,fi,xe,Qo,Wl,it,Hl,Ss,Ql,Bl,Os,Rl,Ul,Bo,Vl,Kl,Xl,yt,Jl,Ws,Gl,Yl,Hs,Zl,ed,td,La,od,nd,Ro,gi,Ft,so,Aa,Uo,sd,Ia,ad,_i,$e,Vo,rd,Ko,id,Qs,ld,dd,cd,dt,Xo,pd,Da,hd,md,Jo,Bs,ud,Sa,fd,gd,Rs,_d,Oa,kd,vd,ao,Go,Td,Yo,Md,Wa,bd,wd,Pd,ro,Zo,Nd,Ha,$d,yd,Us,en,ki,zt,io,Qa,tn,Fd,Ba,zd,vi,Ze,on,Ed,nn,qd,Ra,Cd,jd,xd,sn,Ld,Vs,Ad,Id,Dd,lo,an,Sd,Ua,Od,Ti,Et,co,Va,rn,Wd,Ka,Hd,Mi,Le,ln,Qd,Xa,Bd,Rd,dn,Ud,Ks,Vd,Kd,Xd,cn,Jd,pn,Gd,Yd,Zd,Oe,hn,ec,qt,tc,Xs,oc,nc,Ja,sc,ac,rc,po,ic,Ga,lc,dc,mn,bi,Ct,ho,Ya,un,cc,Za,pc,wi,jt,fn,hc,We,gn,mc,xt,uc,Js,fc,gc,er,_c,kc,vc,mo,Tc,tr,Mc,bc,_n,Pi,Lt,uo,or,kn,wc,nr,Pc,Ni,Ae,vn,Nc,sr,$c,yc,Tn,Fc,Gs,zc,Ec,qc,Mn,Cc,bn,jc,xc,Lc,Pe,wn,Ac,At,Ic,Ys,Dc,Sc,ar,Oc,Wc,Hc,fo,Qc,rr,Bc,Rc,Pn,Uc,ir,Vc,Kc,Nn,$i,It,go,lr,$n,Xc,dr,Jc,yi,Ie,yn,Gc,cr,Yc,Zc,Fn,ep,Zs,tp,op,np,zn,sp,En,ap,rp,ip,He,qn,lp,Dt,dp,ea,cp,pp,pr,hp,mp,up,_o,fp,hr,gp,_p,Cn,Fi,St,ko,mr,jn,kp,ur,vp,zi,De,xn,Tp,fr,Mp,bp,Ln,wp,ta,Pp,Np,$p,An,yp,In,Fp,zp,Ep,Qe,Dn,qp,Ot,Cp,oa,jp,xp,gr,Lp,Ap,Ip,vo,Dp,_r,Sp,Op,Sn,Ei,Wt,To,kr,On,Wp,vr,Hp,qi,Se,Wn,Qp,Ht,Bp,Tr,Rp,Up,Mr,Vp,Kp,Xp,Hn,Jp,na,Gp,Yp,Zp,Qn,eh,Bn,th,oh,nh,Be,Rn,sh,Qt,ah,sa,rh,ih,br,lh,dh,ch,Mo,ph,wr,hh,mh,Un,Ci,Bt,bo,Pr,Vn,uh,Nr,fh,ji,ye,Kn,gh,$r,_h,kh,Xn,vh,aa,Th,Mh,bh,Jn,wh,Gn,Ph,Nh,$h,wo,yh,Re,Yn,Fh,Rt,zh,ra,Eh,qh,yr,Ch,jh,xh,Po,Lh,Fr,Ah,Ih,Zn,xi,Ut,No,zr,es,Dh,Er,Sh,Li,Fe,ts,Oh,os,Wh,qr,Hh,Qh,Bh,ns,Rh,ia,Uh,Vh,Kh,ss,Xh,as,Jh,Gh,Yh,$o,Zh,Ue,rs,em,Vt,tm,la,om,nm,Cr,sm,am,rm,yo,im,jr,lm,dm,is,Ai,Kt,Fo,xr,ls,cm,Lr,pm,Ii,ze,ds,hm,Ar,mm,um,cs,fm,da,gm,_m,km,ps,vm,hs,Tm,Mm,bm,zo,wm,Ve,ms,Pm,Xt,Nm,ca,$m,ym,Ir,Fm,zm,Em,Eo,qm,Dr,Cm,jm,us,Di,Jt,qo,Sr,fs,xm,Or,Lm,Si,Ee,gs,Am,Wr,Im,Dm,_s,Sm,pa,Om,Wm,Hm,ks,Qm,vs,Bm,Rm,Um,Co,Vm,Ke,Ts,Km,Gt,Xm,ha,Jm,Gm,Hr,Ym,Zm,eu,jo,tu,Qr,ou,nu,Ms,Oi,Yt,xo,Br,bs,su,Rr,au,Wi,qe,ws,ru,Ur,iu,lu,Ps,du,ma,cu,pu,hu,Ns,mu,$s,uu,fu,gu,Lo,_u,Xe,ys,ku,Zt,vu,ua,Tu,Mu,Vr,bu,wu,Pu,Ao,Nu,Kr,$u,yu,Fs,Hi,eo,Io,Xr,zs,Fu,Jr,zu,Qi,Ce,Es,Eu,to,qu,Gr,Cu,ju,Yr,xu,Lu,Au,qs,Iu,fa,Du,Su,Ou,Cs,Wu,js,Hu,Qu,Bu,Do,Ru,Je,xs,Uu,oo,Vu,ga,Ku,Xu,Zr,Ju,Gu,Yu,So,Zu,ei,ef,tf,Ls,Bi;return k=new je({}),G=new je({}),Ho=new je({}),Qo=new J({props:{name:"class transformers.MPNetConfig",anchor:"transformers.MPNetConfig",parameters:[{name:"vocab_size",val:" = 30527"},{name:"hidden_size",val:" = 768"},{name:"num_hidden_layers",val:" = 12"},{name:"num_attention_heads",val:" = 12"},{name:"intermediate_size",val:" = 3072"},{name:"hidden_act",val:" = 'gelu'"},{name:"hidden_dropout_prob",val:" = 0.1"},{name:"attention_probs_dropout_prob",val:" = 0.1"},{name:"max_position_embeddings",val:" = 512"},{name:"initializer_range",val:" = 0.02"},{name:"layer_norm_eps",val:" = 1e-12"},{name:"relative_attention_num_buckets",val:" = 32"},{name:"pad_token_id",val:" = 1"},{name:"bos_token_id",val:" = 0"},{name:"eos_token_id",val:" = 2"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/mpnet/configuration_mpnet.py#L29",parametersDescription:[{anchor:"transformers.MPNetConfig.vocab_size",description:`<strong>vocab_size</strong> (<code>int</code>, <em>optional</em>, defaults to 30527) &#x2014;
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/main/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),wo=new Ne({props:{$$slots:{default:[Q_]},$$scope:{ctx:H}}}),Yn=new J({props:{name:"call",anchor:"transformers.TFMPNetModel.call",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"},{name:"training",val:" = False"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/mpnet/modeling_tf_mpnet.py#L683",parametersDescription:[{anchor:"transformers.TFMPNetModel.call.input_ids",description:`<strong>input_ids</strong> (<code>Numpy array</code> or <code>tf.Tensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/main/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),zo=new Ne({props:{$$slots:{default:[V_]},$$scope:{ctx:H}}}),ms=new J({props:{name:"call",anchor:"transformers.TFMPNetForSequenceClassification.call",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"},{name:"labels",val:" = None"},{name:"training",val:" = False"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/mpnet/modeling_tf_mpnet.py#L933",parametersDescription:[{anchor:"transformers.TFMPNetForSequenceClassification.call.input_ids",description:`<strong>input_ids</strong> (<code>Numpy array</code> or <code>tf.Tensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/main/en/model_doc/mpnet#transformers.MPNetTokenizer">MPNetTokenizer</a>. See <a href="/docs/transformers/main/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
<a href="/docs/transformers/main/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> for details.</p>
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/main/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),Lo=new Ne({props:{$$slots:{default:[G_]},$$scope:{ctx:H}}}),ys=new J({props:{name:"call",anchor:"transformers.TFMPNetForTokenClassification.call",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"},{name:"labels",val:" = None"},{name:"training",val:" = False"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/mpnet/modeling_tf_mpnet.py#L1170",parametersDescription:[{anchor:"transformers.TFMPNetForTokenClassification.call.input_ids",description:`<strong>input_ids</strong> (<code>Numpy array</code> or <code>tf.Tensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/main/en/model_doc/mpnet#transformers.MPNetTokenizer">MPNetTokenizer</a>. See <a href="/docs/transformers/main/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
<a href="/docs/transformers/main/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> for details.</p>
...
separate your segments with the separation token `),_e=n("code"),ve=r("tokenizer.sep_token"),I=r(" (or "),ke=n("code"),Te=r("[sep]"),Me=r(")."),L=l(),D=n("p"),be=r("The original code can be found "),ge=n("a"),ue=r("here"),we=r("."),ie=l(),fe=n("h2"),no=n("a"),ja=n("span"),M(Ho.$$.fragment),Sl=l(),xa=n("span"),Ol=r("MPNetConfig"),fi=l(),xe=n("div"),M(Qo.$$.fragment),Wl=l(),it=n("p"),Hl=r("This is the configuration class to store the configuration of a "),Ss=n("a"),Ql=r("MPNetModel"),Bl=r(" or a "),Os=n("a"),Rl=r("TFMPNetModel"),Ul=r(`. It is used to
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),ip=l(),He=n("div"),M(qn.$$.fragment),lp=l(),Dt=n("p"),dp=r("The "),ea=n("a"),cp=r("MPNetForMultipleChoice"),pp=r(" forward method, overrides the "),pr=n("code"),hp=r("__call__"),mp=r(" special method."),up=l(),M(_o.$$.fragment),fp=l(),hr=n("p"),gp=r("Example:"),_p=l(),M(Cn.$$.fragment),Fi=l(),St=n("h2"),ko=n("a"),mr=n("span"),M(jn.$$.fragment),kp=l(),ur=n("span"),vp=r("MPNetForTokenClassification"),zi=l(),De=n("div"),M(xn.$$.fragment),Tp=l(),fr=n("p"),Mp=r(`MPNet Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g. for
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),nh=l(),Be=n("div"),M(Rn.$$.fragment),sh=l(),Qt=n("p"),ah=r("The "),sa=n("a"),rh=r("MPNetForQuestionAnswering"),ih=r(" forward method, overrides the "),br=n("code"),lh=r("__call__"),dh=r(" special method."),ch=l(),M(Mo.$$.fragment),ph=l(),wr=n("p"),hh=r("Example:"),mh=l(),M(Un.$$.fragment),Ci=l(),Bt=n("h2"),bo=n("a"),Pr=n("span"),M(Vn.$$.fragment),uh=l(),Nr=n("span"),fh=r("TFMPNetModel"),ji=l(),ye=n("div"),M(Kn.$$.fragment),gh=l(),$r=n("p"),_h=r("The bare MPNet Model transformer outputting raw hidden-states without any specific head on top."),kh=l(),Xn=n("p"),vh=r("This model inherits from "),aa=n("a"),Th=r("TFPreTrainedModel"),Mh=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),bh=l(),Jn=n("p"),wh=r("This model is also a "),Gn=n("a"),Ph=r("tf.keras.Model"),Nh=r(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),$h=l(),M(wo.$$.fragment),yh=l(),Re=n("div"),M(Yn.$$.fragment),Fh=l(),Rt=n("p"),zh=r("The "),ra=n("a"),Eh=r("TFMPNetModel"),qh=r(" forward method, overrides the "),yr=n("code"),Ch=r("__call__"),jh=r(" special method."),xh=l(),M(Po.$$.fragment),Lh=l(),Fr=n("p"),Ah=r("Example:"),Ih=l(),M(Zn.$$.fragment),xi=l(),Ut=n("h2"),No=n("a"),zr=n("span"),M(es.$$.fragment),Dh=l(),Er=n("span"),Sh=r("TFMPNetForMaskedLM"),Li=l(),Fe=n("div"),M(ts.$$.fragment),Oh=l(),os=n("p"),Wh=r("MPNet Model with a "),qr=n("code"),Hh=r("language modeling"),Qh=r(" head on top."),Bh=l(),ns=n("p"),Rh=r("This model inherits from "),ia=n("a"),Uh=r("TFPreTrainedModel"),Vh=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Um=l(),M(Co.$$.fragment),Vm=l(),Ke=n("div"),M(Ts.$$.fragment),Km=l(),Gt=n("p"),Xm=r("The "),ha=n("a"),Jm=r("TFMPNetForMultipleChoice"),Gm=r(" forward method, overrides the "),Hr=n("code"),Ym=r("__call__"),Zm=r(" special method."),eu=l(),M(jo.$$.fragment),tu=l(),Qr=n("p"),ou=r("Example:"),nu=l(),M(Ms.$$.fragment),Oi=l(),Yt=n("h2"),xo=n("a"),Br=n("span"),M(bs.$$.fragment),su=l(),Rr=n("span"),au=r("TFMPNetForTokenClassification"),Wi=l(),qe=n("div"),M(ws.$$.fragment),ru=l(),Ur=n("p"),iu=r(`MPNet Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g. for
...
make use of token type ids, therefore a list of zeros is returned`),Cf.forEach(t),ol.forEach(t),Wo.forEach(t),Ti=d(o),Et=s(o,"H2",{class:!0});var nl=a(Et);co=s(nl,"A",{id:!0,class:!0,href:!0});var jf=a(co);Va=s(jf,"SPAN",{});var xf=a(Va);b(rn.$$.fragment,xf),xf.forEach(t),jf.forEach(t),Wd=d(nl),Ka=s(nl,"SPAN",{});var Lf=a(Ka);Hd=i(Lf,"MPNetModel"),Lf.forEach(t),nl.forEach(t),Mi=d(o),Le=s(o,"DIV",{class:!0});var pt=a(Le);b(ln.$$.fragment,pt),Qd=d(pt),Xa=s(pt,"P",{});var Af=a(Xa);Bd=i(Af,"The bare MPNet Model transformer outputting raw hidden-states without any specific head on top."),Af.forEach(t),Rd=d(pt),dn=s(pt,"P",{});var sl=a(dn);Ud=i(sl,"This model inherits from "),Ks=s(sl,"A",{href:!0});var If=a(Ks);Vd=i(If,"PreTrainedModel"),If.forEach(t),Kd=i(sl,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
