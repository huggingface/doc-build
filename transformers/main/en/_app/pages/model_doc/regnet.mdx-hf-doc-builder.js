...
behavior.`),va=m(),C=s("div"),$(De.$$.fragment),ya=m(),H=s("p"),Na=l("The "),it=s("a"),Ta=l("RegNetModel"),Ra=l(" forward method, overrides the "),Et=s("code"),xa=l("__call__"),Fa=l(" special method."),Ea=m(),$(re.$$.fragment),ka=m(),$(ne.$$.fragment),co=m(),V=s("h2"),le=s("a"),kt=s("span"),$(Se.$$.fragment),ja=m(),jt=s("span"),Ca=l("RegNetForImageClassification"),fo=m(),j=s("div"),$(Oe.$$.fragment),Aa=m(),Ct=s("p"),Ma=l(`RegNet Model with an image classification head on top (a linear layer on top of the pooled features), e.g. for
...
The original code can be found `),je=r(D,"A",{href:!0,rel:!0});var Cs=n(je);Yo=i(Cs,"here"),Cs.forEach(o),Zo=i(D,"."),D.forEach(o),ro=u(t),O=r(t,"H2",{class:!0});var bo=n(O);oe=r(bo,"A",{id:!0,class:!0,href:!0});var As=n(oe);Tt=r(As,"SPAN",{});var Ms=n(Tt);v(Ce.$$.fragment,Ms),Ms.forEach(o),As.forEach(o),ea=u(bo),Rt=r(bo,"SPAN",{});var Is=n(Rt);ta=i(Is,"RegNetConfig"),Is.forEach(o),bo.forEach(o),no=u(t),k=r(t,"DIV",{class:!0});var ue=n(k);v(Ae.$$.fragment,ue),oa=u(ue),L=r(ue,"P",{});var pt=n(L);aa=i(pt,"This is the configuration class to store the configuration of a "),rt=r(pt,"A",{href:!0});var Ps=n(rt);sa=i(Ps,"RegNetModel"),Ps.forEach(o),ra=i(pt,`. It is used to instantiate a RegNet
model according to the specified arguments, defining the model architecture. Instantiating a configuration with the
defaults will yield a similar configuration to that of the RegNet
...
documentation from `),lt=r(gt,"A",{href:!0});var Ds=n(lt);pa=i(Ds,"PretrainedConfig"),Ds.forEach(o),ga=i(gt," for more information."),gt.forEach(o),ha=u(ue),v(ae.$$.fragment,ue),ue.forEach(o),lo=u(t),U=r(t,"H2",{class:!0});var $o=n(U);se=r($o,"A",{id:!0,class:!0,href:!0});var Ss=n(se);xt=r(Ss,"SPAN",{});var Os=n(xt);v(Ie.$$.fragment,Os),Os.forEach(o),Ss.forEach(o),ma=u($o),Ft=r($o,"SPAN",{});var Ls=n(Ft);ua=i(Ls,"RegNetModel"),Ls.forEach(o),$o.forEach(o),io=u(t),P=r(t,"DIV",{class:!0});var ht=n(P);v(Pe.$$.fragment,ht),_a=u(ht),qe=r(ht,"P",{});var vo=n(qe);wa=i(vo,`The bare RegNet model outputting raw features without any specific head on top.
