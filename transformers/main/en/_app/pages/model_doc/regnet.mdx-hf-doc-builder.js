import{S as cr,i as fr,s as pr,e as s,k as m,w as $,t as l,M as gr,c as r,d as o,m as u,a as n,x as v,h as i,b as c,G as e,g as _,y,q as N,o as T,B as x,v as hr,L as Jt}from"../../chunks/vendor-hf-doc-builder.js";import{T as Ro}from"../../chunks/Tip-hf-doc-builder.js";import{D as X}from"../../chunks/Docstring-hf-doc-builder.js";import{C as Qt}from"../../chunks/CodeBlock-hf-doc-builder.js";import{I as Ze}from"../../chunks/IconCopyLink-hf-doc-builder.js";import{E as Kt}from"../../chunks/ExampleCodeBlock-hf-doc-builder.js";function mr(R){let d,b,h,p,w;return p=new Qt({props:{code:`from transformers import RegNetConfig, RegNetModel
...
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),f.forEach(o)},m(a,f){_(a,d,f),e(d,b),e(d,h),e(h,p),e(d,w)},d(a){a&&o(d)}}}function _r(R){let d,b,h,p,w;return p=new Qt({props:{code:`from transformers import AutoFeatureExtractor, RegNetModel
import torch
...
[<span class="hljs-number">1</span>, <span class="hljs-number">1088</span>, <span class="hljs-number">7</span>, <span class="hljs-number">7</span>]`}}),{c(){d=s("p"),b=l("Example:"),h=m(),$(p.$$.fragment)},l(a){d=r(a,"P",{});var f=n(d);b=i(f,"Example:"),f.forEach(o),h=u(a),v(p.$$.fragment,a)},m(a,f){_(a,d,f),e(d,b),_(a,h,f),y(p,a,f),w=!0},p:Jt,i(a){w||(N(p.$$.fragment,a),w=!0)},o(a){T(p.$$.fragment,a),w=!1},d(a){a&&o(d),a&&o(h),x(p,a)}}}function wr(R){let d,b,h,p,w;return{c(){d=s("p"),b=l("Although the recipe for forward pass needs to be defined within this function, one should call the "),h=s("code"),p=l("Module"),w=l(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(a){d=r(a,"P",{});var f=n(d);b=i(f,"Although the recipe for forward pass needs to be defined within this function, one should call the "),h=r(f,"CODE",{});var F=n(h);p=i(F,"Module"),F.forEach(o),w=i(f,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),f.forEach(o)},m(a,f){_(a,d,f),e(d,b),e(d,h),e(h,p),e(d,w)},d(a){a&&o(d)}}}function br(R){let d,b,h,p,w;return p=new Qt({props:{code:`from transformers import AutoFeatureExtractor, RegNetForImageClassification
import torch
from datasets import load_dataset
...
<span class="hljs-string">&#x27;tabby, tabby cat&#x27;</span>`}}),{c(){d=s("p"),b=l("Example:"),h=m(),$(p.$$.fragment)},l(a){d=r(a,"P",{});var f=n(d);b=i(f,"Example:"),f.forEach(o),h=u(a),v(p.$$.fragment,a)},m(a,f){_(a,d,f),e(d,b),_(a,h,f),y(p,a,f),w=!0},p:Jt,i(a){w||(N(p.$$.fragment,a),w=!0)},o(a){T(p.$$.fragment,a),w=!1},d(a){a&&o(d),a&&o(h),x(p,a)}}}function $r(R){let d,b,h,p,w;return{c(){d=s("p"),b=l("Although the recipe for forward pass needs to be defined within this function, one should call the "),h=s("code"),p=l("Module"),w=l(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(a){d=r(a,"P",{});var f=n(d);b=i(f,"Although the recipe for forward pass needs to be defined within this function, one should call the "),h=r(f,"CODE",{});var F=n(h);p=i(F,"Module"),F.forEach(o),w=i(f,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),f.forEach(o)},m(a,f){_(a,d,f),e(d,b),e(d,h),e(h,p),e(d,w)},d(a){a&&o(d)}}}function vr(R){let d,b,h,p,w;return p=new Qt({props:{code:`from transformers import AutoFeatureExtractor, TFRegNetModel
from datasets import load_dataset
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-built_in">list</span>(last_hidden_states.shape)
[<span class="hljs-number">1</span>, <span class="hljs-number">1088</span>, <span class="hljs-number">7</span>, <span class="hljs-number">7</span>]`}}),{c(){d=s("p"),b=l("Example:"),h=m(),$(p.$$.fragment)},l(a){d=r(a,"P",{});var f=n(d);b=i(f,"Example:"),f.forEach(o),h=u(a),v(p.$$.fragment,a)},m(a,f){_(a,d,f),e(d,b),_(a,h,f),y(p,a,f),w=!0},p:Jt,i(a){w||(N(p.$$.fragment,a),w=!0)},o(a){T(p.$$.fragment,a),w=!1},d(a){a&&o(d),a&&o(h),x(p,a)}}}function yr(R){let d,b,h,p,w;return{c(){d=s("p"),b=l("Although the recipe for forward pass needs to be defined within this function, one should call the "),h=s("code"),p=l("Module"),w=l(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(a){d=r(a,"P",{});var f=n(d);b=i(f,"Although the recipe for forward pass needs to be defined within this function, one should call the "),h=r(f,"CODE",{});var F=n(h);p=i(F,"Module"),F.forEach(o),w=i(f,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),f.forEach(o)},m(a,f){_(a,d,f),e(d,b),e(d,h),e(h,p),e(d,w)},d(a){a&&o(d)}}}function Nr(R){let d,b,h,p,w;return p=new Qt({props:{code:`from transformers import AutoFeatureExtractor, TFRegNetForImageClassification
...
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-built_in">print</span>(model.config.id2label[predicted_label])
<span class="hljs-string">&#x27;tabby, tabby cat&#x27;</span>`}}),{c(){d=s("p"),b=l("Example:"),h=m(),$(p.$$.fragment)},l(a){d=r(a,"P",{});var f=n(d);b=i(f,"Example:"),f.forEach(o),h=u(a),v(p.$$.fragment,a)},m(a,f){_(a,d,f),e(d,b),_(a,h,f),y(p,a,f),w=!0},p:Jt,i(a){w||(N(p.$$.fragment,a),w=!0)},o(a){T(p.$$.fragment,a),w=!1},d(a){a&&o(d),a&&o(h),x(p,a)}}}function Tr(R){let d,b,h,p,w,a,f,F,Fo,Xt,S,Y,vt,ye,Eo,yt,ko,Yt,Z,jo,Ne,Co,Ao,Zt,et,Mo,eo,tt,Io,to,ot,Nt,Po,oo,at,qo,ao,ee,Te,zo,st,Do,So,Oo,te,Lo,xe,Wo,Uo,Re,Ho,so,E,Vo,Fe,Bo,Go,Ee,Ko,Jo,ke,Qo,Xo,je,Yo,Zo,ro,O,oe,Tt,Ce,ea,xt,ta,no,k,Ae,oa,L,aa,rt,sa,ra,Me,na,la,ia,W,da,nt,ca,fa,lt,pa,ga,ha,ae,lo,U,se,Rt,Ie,ma,Ft,ua,io,P,Pe,_a,qe,wa,ze,ba,$a,va,C,De,ya,H,Na,it,Ta,xa,Et,Ra,Fa,Ea,re,ka,ne,co,V,le,kt,Se,ja,jt,Ca,fo,j,Oe,Aa,Ct,Ma,Ia,Le,Pa,We,qa,za,Da,A,Ue,Sa,B,Oa,dt,La,Wa,At,Ua,Ha,Va,ie,Ba,de,po,G,ce,Mt,He,Ga,It,Ka,go,q,Ve,Ja,Pt,Qa,Xa,M,Be,Ya,K,Za,ct,es,ts,qt,os,as,ss,fe,rs,pe,ho,J,ge,zt,Ge,ns,Dt,ls,mo,z,Ke,is,St,ds,cs,I,Je,fs,Q,ps,ft,gs,hs,Ot,ms,us,_s,he,ws,me,uo;return a=new Ze({}),ye=new Ze({}),Ce=new Ze({}),Ae=new X({props:{name:"class transformers.RegNetConfig",anchor:"transformers.RegNetConfig",parameters:[{name:"num_channels",val:" = 3"},{name:"embedding_size",val:" = 32"},{name:"hidden_sizes",val:" = [128, 192, 512, 1088]"},{name:"depths",val:" = [2, 6, 12, 2]"},{name:"groups_width",val:" = 64"},{name:"layer_type",val:" = 'y'"},{name:"hidden_act",val:" = 'relu'"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.RegNetConfig.num_channels",description:`<strong>num_channels</strong> (<code>int</code>, <em>optional</em>, defaults to 3) &#x2014;
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/main/en/main_classes/model#transformers.TFPreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"regular"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/regnet/modeling_tf_regnet.py#L405"}}),Be=new X({props:{name:"call",anchor:"transformers.TFRegNetModel.call",parameters:[{name:"pixel_values",val:": Tensor"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"training",val:" = False"}],parametersDescription:[{anchor:"transformers.TFRegNetModel.call.pixel_values",description:`<strong>pixel_values</strong> (<code>tf.Tensor</code> of shape <code>(batch_size, num_channels, height, width)</code>) &#x2014;
Pixel values. Pixel values can be obtained using <a href="/docs/transformers/main/en/model_doc/auto#transformers.AutoFeatureExtractor">AutoFeatureExtractor</a>. See
...
Whether or not to return a <a href="/docs/transformers/main/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/regnet/modeling_tf_regnet.py#L410",returnDescription:`
...
`}}),fe=new Ro({props:{$$slots:{default:[$r]},$$scope:{ctx:R}}}),pe=new Kt({props:{anchor:"transformers.TFRegNetModel.call.example",$$slots:{default:[vr]},$$scope:{ctx:R}}}),Ge=new Ze({}),Ke=new X({props:{name:"class transformers.TFRegNetForImageClassification",anchor:"transformers.TFRegNetForImageClassification",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.TFRegNetForImageClassification.This",description:`<strong>This</strong> model is a Tensorflow &#x2014;
...
config (<a href="/docs/transformers/main/en/model_doc/regnet#transformers.RegNetConfig">RegNetConfig</a>): Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/main/en/main_classes/model#transformers.TFPreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"regular"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/regnet/modeling_tf_regnet.py#L455"}}),Je=new X({props:{name:"call",anchor:"transformers.TFRegNetForImageClassification.call",parameters:[{name:"pixel_values",val:": Tensor = None"},{name:"labels",val:": Tensor = None"},{name:"output_hidden_states",val:": bool = None"},{name:"return_dict",val:": bool = None"},{name:"training",val:" = False"}],parametersDescription:[{anchor:"transformers.TFRegNetForImageClassification.call.pixel_values",description:`<strong>pixel_values</strong> (<code>tf.Tensor</code> of shape <code>(batch_size, num_channels, height, width)</code>) &#x2014;
Pixel values. Pixel values can be obtained using <a href="/docs/transformers/main/en/model_doc/auto#transformers.AutoFeatureExtractor">AutoFeatureExtractor</a>. See
...
Labels for computing the image classification/regression loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>. If <code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/regnet/modeling_tf_regnet.py#L466",returnDescription:`
<p>A <a
...
documentation from `),lt=s("a"),pa=l("PretrainedConfig"),ga=l(" for more information."),ha=m(),$(ae.$$.fragment),lo=m(),U=s("h2"),se=s("a"),Rt=s("span"),$(Ie.$$.fragment),ma=m(),Ft=s("span"),ua=l("RegNetModel"),io=m(),P=s("div"),$(Pe.$$.fragment),_a=m(),qe=s("p"),wa=l(`The bare RegNet model outputting raw features without any specific head on top.
This model is a PyTorch `),ze=s("a"),ba=l("torch.nn.Module"),$a=l(` subclass. Use it
as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),va=m(),C=s("div"),$(De.$$.fragment),ya=m(),H=s("p"),Na=l("The "),it=s("a"),Ta=l("RegNetModel"),xa=l(" forward method, overrides the "),Et=s("code"),Ra=l("__call__"),Fa=l(" special method."),Ea=m(),$(re.$$.fragment),ka=m(),$(ne.$$.fragment),co=m(),V=s("h2"),le=s("a"),kt=s("span"),$(Se.$$.fragment),ja=m(),jt=s("span"),Ca=l("RegNetForImageClassification"),fo=m(),j=s("div"),$(Oe.$$.fragment),Aa=m(),Ct=s("p"),Ma=l(`RegNet Model with an image classification head on top (a linear layer on top of the pooled features), e.g. for
ImageNet.`),Ia=m(),Le=s("p"),Pa=l("This model is a PyTorch "),We=s("a"),qa=l("torch.nn.Module"),za=l(` subclass. Use it
as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),Da=m(),A=s("div"),$(Ue.$$.fragment),Sa=m(),B=s("p"),Oa=l("The "),dt=s("a"),La=l("RegNetForImageClassification"),Wa=l(" forward method, overrides the "),At=s("code"),Ua=l("__call__"),Ha=l(" special method."),Va=m(),$(ie.$$.fragment),Ba=m(),$(de.$$.fragment),po=m(),G=s("h2"),ce=s("a"),Mt=s("span"),$(He.$$.fragment),Ga=m(),It=s("span"),Ka=l("TFRegNetModel"),go=m(),q=s("div"),$(Ve.$$.fragment),Ja=m(),Pt=s("p"),Qa=l("The bare RegNet model outputting raw features without any specific head on top."),Xa=m(),M=s("div"),$(Be.$$.fragment),Ya=m(),K=s("p"),Za=l("The "),ct=s("a"),es=l("TFRegNetModel"),ts=l(" forward method, overrides the "),qt=s("code"),os=l("__call__"),as=l(" special method."),ss=m(),$(fe.$$.fragment),rs=m(),$(pe.$$.fragment),ho=m(),J=s("h2"),ge=s("a"),zt=s("span"),$(Ge.$$.fragment),ns=m(),Dt=s("span"),ls=l("TFRegNetForImageClassification"),mo=m(),z=s("div"),$(Ke.$$.fragment),is=m(),St=s("p"),ds=l(`RegNet Model with an image classification head on top (a linear layer on top of the pooled features), e.g. for
ImageNet.`),cs=m(),I=s("div"),$(Je.$$.fragment),fs=m(),Q=s("p"),ps=l("The "),ft=s("a"),gs=l("TFRegNetForImageClassification"),hs=l(" forward method, overrides the "),Ot=s("code"),ms=l("__call__"),us=l(" special method."),_s=m(),$(he.$$.fragment),ws=m(),$(me.$$.fragment),this.h()},l(t){const g=gr('[data-svelte="svelte-1phssyn"]',document.head);d=r(g,"META",{name:!0,content:!0}),g.forEach(o),b=u(t),h=r(t,"H1",{class:!0});var Qe=n(h);p=r(Qe,"A",{id:!0,class:!0,href:!0});var Lt=n(p);w=r(Lt,"SPAN",{});var Wt=n(w);v(a.$$.fragment,Wt),Wt.forEach(o),Lt.forEach(o),f=u(Qe),F=r(Qe,"SPAN",{});var Ut=n(F);Fo=i(Ut,"RegNet"),Ut.forEach(o),Qe.forEach(o),Xt=u(t),S=r(t,"H2",{class:!0});var Xe=n(S);Y=r(Xe,"A",{id:!0,class:!0,href:!0});var Ht=n(Y);vt=r(Ht,"SPAN",{});var Vt=n(vt);v(ye.$$.fragment,Vt),Vt.forEach(o),Ht.forEach(o),Eo=u(Xe),yt=r(Xe,"SPAN",{});var Bt=n(yt);ko=i(Bt,"Overview"),Bt.forEach(o),Xe.forEach(o),Yt=u(t),Z=r(t,"P",{});var Ye=n(Z);jo=i(Ye,"The RegNet model was proposed in "),Ne=r(Ye,"A",{href:!0,rel:!0});var bs=n(Ne);Co=i(bs,"Designing Network Design Spaces"),bs.forEach(o),Ao=i(Ye," by Ilija Radosavovic, Raj Prateek Kosaraju, Ross Girshick, Kaiming He, Piotr Doll\xE1r."),Ye.forEach(o),Zt=u(t),et=r(t,"P",{});var $s=n(et);Mo=i($s,"The authors design search spaces to perform Neural Architecture Search (NAS). They first start from a high dimensional search space and iteratively reduce the search space by empirically applying constraints based on the best-performing models sampled by the current search space."),$s.forEach(o),eo=u(t),tt=r(t,"P",{});var vs=n(tt);Io=i(vs,"The abstract from the paper is the following:"),vs.forEach(o),to=u(t),ot=r(t,"P",{});var ys=n(ot);Nt=r(ys,"EM",{});var Ns=n(Nt);Po=i(Ns,"In this work, we present a new network design paradigm. Our goal is to help advance the understanding of network design and discover design principles that generalize across settings. Instead of focusing on designing individual network instances, we design network design spaces that parametrize populations of networks. The overall process is analogous to classic manual design of networks, but elevated to the design space level. Using our methodology we explore the structure aspect of network design and arrive at a low-dimensional design space consisting of simple, regular networks that we call RegNet. The core insight of the RegNet parametrization is surprisingly simple: widths and depths of good networks can be explained by a quantized linear function. We analyze the RegNet design space and arrive at interesting findings that do not match the current practice of network design. The RegNet design space provides simple and fast networks that work well across a wide range of flop regimes. Under comparable training settings and flops, the RegNet models outperform the popular EfficientNet models while being up to 5x faster on GPUs."),Ns.forEach(o),ys.forEach(o),oo=u(t),at=r(t,"P",{});var Ts=n(at);qo=i(Ts,"Tips:"),Ts.forEach(o),ao=u(t),ee=r(t,"UL",{});var _o=n(ee);Te=r(_o,"LI",{});var wo=n(Te);zo=i(wo,"One can use "),st=r(wo,"A",{href:!0});var xs=n(st);Do=i(xs,"AutoFeatureExtractor"),xs.forEach(o),So=i(wo," to prepare images for the model."),wo.forEach(o),Oo=u(_o),te=r(_o,"LI",{});var Gt=n(te);Lo=i(Gt,"The huge 10B model from "),xe=r(Gt,"A",{href:!0,rel:!0});var Rs=n(xe);Wo=i(Rs,"Self-supervised Pretraining of Visual Features in the Wild"),Rs.forEach(o),Uo=i(Gt,", trained on one billion Instagram images, is available on the "),Re=r(Gt,"A",{href:!0,rel:!0});var Fs=n(Re);Ho=i(Fs,"hub"),Fs.forEach(o),Gt.forEach(o),_o.forEach(o),so=u(t),E=r(t,"P",{});var D=n(E);Vo=i(D,"This model was contributed by "),Fe=r(D,"A",{href:!0,rel:!0});var Es=n(Fe);Bo=i(Es,"Francesco"),Es.forEach(o),Go=i(D,`. The TensorFlow version of the model
was contributed by `),Ee=r(D,"A",{href:!0,rel:!0});var ks=n(Ee);Ko=i(ks,"sayakpaul"),ks.forEach(o),Jo=i(D," and "),ke=r(D,"A",{href:!0,rel:!0});var js=n(ke);Qo=i(js,"ariG23498"),js.forEach(o),Xo=i(D,`.
The original code can be found `),je=r(D,"A",{href:!0,rel:!0});var Cs=n(je);Yo=i(Cs,"here"),Cs.forEach(o),Zo=i(D,"."),D.forEach(o),ro=u(t),O=r(t,"H2",{class:!0});var bo=n(O);oe=r(bo,"A",{id:!0,class:!0,href:!0});var As=n(oe);Tt=r(As,"SPAN",{});var Ms=n(Tt);v(Ce.$$.fragment,Ms),Ms.forEach(o),As.forEach(o),ea=u(bo),xt=r(bo,"SPAN",{});var Is=n(xt);ta=i(Is,"RegNetConfig"),Is.forEach(o),bo.forEach(o),no=u(t),k=r(t,"DIV",{class:!0});var ue=n(k);v(Ae.$$.fragment,ue),oa=u(ue),L=r(ue,"P",{});var pt=n(L);aa=i(pt,"This is the configuration class to store the configuration of a "),rt=r(pt,"A",{href:!0});var Ps=n(rt);sa=i(Ps,"RegNetModel"),Ps.forEach(o),ra=i(pt,`. It is used to instantiate a RegNet
model according to the specified arguments, defining the model architecture. Instantiating a configuration with the
defaults will yield a similar configuration to that of the RegNet
...
documentation from `),lt=r(gt,"A",{href:!0});var Ds=n(lt);pa=i(Ds,"PretrainedConfig"),Ds.forEach(o),ga=i(gt," for more information."),gt.forEach(o),ha=u(ue),v(ae.$$.fragment,ue),ue.forEach(o),lo=u(t),U=r(t,"H2",{class:!0});var $o=n(U);se=r($o,"A",{id:!0,class:!0,href:!0});var Ss=n(se);Rt=r(Ss,"SPAN",{});var Os=n(Rt);v(Ie.$$.fragment,Os),Os.forEach(o),Ss.forEach(o),ma=u($o),Ft=r($o,"SPAN",{});var Ls=n(Ft);ua=i(Ls,"RegNetModel"),Ls.forEach(o),$o.forEach(o),io=u(t),P=r(t,"DIV",{class:!0});var ht=n(P);v(Pe.$$.fragment,ht),_a=u(ht),qe=r(ht,"P",{});var vo=n(qe);wa=i(vo,`The bare RegNet model outputting raw features without any specific head on top.
This model is a PyTorch `),ze=r(vo,"A",{href:!0,rel:!0});var Ws=n(ze);ba=i(Ws,"torch.nn.Module"),Ws.forEach(o),$a=i(vo,` subclass. Use it
as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),vo.forEach(o),va=u(ht),C=r(ht,"DIV",{class:!0});var _e=n(C);v(De.$$.fragment,_e),ya=u(_e),H=r(_e,"P",{});var mt=n(H);Na=i(mt,"The "),it=r(mt,"A",{href:!0});var Us=n(it);Ta=i(Us,"RegNetModel"),Us.forEach(o),xa=i(mt," forward method, overrides the "),Et=r(mt,"CODE",{});var Hs=n(Et);Ra=i(Hs,"__call__"),Hs.forEach(o),Fa=i(mt," special method."),mt.forEach(o),Ea=u(_e),v(re.$$.fragment,_e),ka=u(_e),v(ne.$$.fragment,_e),_e.forEach(o),ht.forEach(o),co=u(t),V=r(t,"H2",{class:!0});var yo=n(V);le=r(yo,"A",{id:!0,class:!0,href:!0});var Vs=n(le);kt=r(Vs,"SPAN",{});var Bs=n(kt);v(Se.$$.fragment,Bs),Bs.forEach(o),Vs.forEach(o),ja=u(yo),jt=r(yo,"SPAN",{});var Gs=n(jt);Ca=i(Gs,"RegNetForImageClassification"),Gs.forEach(o),yo.forEach(o),fo=u(t),j=r(t,"DIV",{class:!0});var we=n(j);v(Oe.$$.fragment,we),Aa=u(we),Ct=r(we,"P",{});var Ks=n(Ct);Ma=i(Ks,`RegNet Model with an image classification head on top (a linear layer on top of the pooled features), e.g. for
