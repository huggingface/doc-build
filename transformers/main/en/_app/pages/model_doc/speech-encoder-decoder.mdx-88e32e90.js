import{S as Ts,i as xs,s as Ms,e as r,k as i,w as b,t as n,M as Ds,c as s,d as o,m as l,a as d,x as y,h as t,b as c,F as e,g,y as w,q as E,o as k,B as S}from"../../chunks/vendor-4833417e.js";import{T as Ss}from"../../chunks/Tip-fffd6df1.js";import{D as ne}from"../../chunks/Docstring-4f315ed9.js";import{C as en}from"../../chunks/CodeBlock-6a3d1b46.js";import{I as xn}from"../../chunks/IconCopyLink-4b81c553.js";import"../../chunks/CopyButton-dacfbfaf.js";function $s(he){let p,$,u,T,C;return{c(){p=r("p"),$=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),u=r("code"),T=n("Module"),C=n(`
...
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),D.forEach(o)},m(x,D){g(x,p,D),e(p,$),e(p,u),e(u,T),e(p,C)},d(x){x&&o(p)}}}function js(he){let p,$,u,T,C;return{c(){p=r("p"),$=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),u=r("code"),T=n("Module"),C=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(x){p=s(x,"P",{});var D=d(p);$=t(D,"Although the recipe for forward pass needs to be defined within this function, one should call the "),u=s(D,"CODE",{});var L=d(u);T=t(L,"Module"),L.forEach(o),C=t(D,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),D.forEach(o)},m(x,D){g(x,p,D),e(p,$),e(p,u),e(u,T),e(p,C)},d(x){x&&o(p)}}}function qs(he){let p,$,u,T,C,x,D,L,Mn,on,j,Dn,Ye,$n,jn,wo,qn,Pn,Ze,zn,Fn,Ke,Cn,An,nn,N,Ln,Eo,Nn,In,me,Wn,Vn,tn,I,On,Qe,Bn,Rn,Xe,Un,Hn,an,H,te,ko,fe,Gn,So,Jn,rn,M,ue,Yn,ae,eo,Zn,Kn,oo,Qn,Xn,et,G,ot,no,nt,tt,to,at,rt,st,To,dt,ct,ge,it,re,_e,lt,ve,pt,ao,ht,mt,ft,se,be,ut,J,gt,xo,_t,vt,Mo,bt,yt,sn,Y,de,Do,ye,wt,$o,Et,dn,m,we,kt,Z,St,jo,Tt,xt,qo,Mt,Dt,$t,Ee,jt,ke,qt,Pt,zt,Se,Ft,Te,Ct,At,Lt,Po,Nt,It,xe,Wt,ro,Vt,Ot,Bt,Me,Rt,De,Ut,Ht,Gt,W,so,Jt,Yt,zo,Zt,Kt,Fo,Qt,Xt,ea,q,$e,oa,K,na,co,ta,aa,Co,ra,sa,da,ce,ca,Ao,ia,la,je,pa,P,qe,ha,Lo,ma,fa,Q,ua,No,ga,_a,Io,va,ba,ya,Wo,wa,Ea,Pe,cn,X,ie,Vo,ze,ka,Oo,Sa,ln,f,Fe,Ta,ee,xa,Bo,Ma,Da,Ro,$a,ja,qa,Ce,Pa,Ae,za,Fa,Ca,Le,Aa,Ne,La,Na,Ia,Uo,Wa,Va,Ie,Oa,io,Ba,Ra,Ua,We,Ha,Ve,Ga,Ja,Ya,V,lo,Za,Ka,Ho,Qa,Xa,Go,er,or,nr,z,Oe,tr,oe,ar,po,rr,sr,Jo,dr,cr,ir,le,lr,Yo,pr,hr,Be,mr,A,Re,fr,Zo,ur,gr,Ko,_r,vr,Ue,pn;return x=new xn({}),fe=new xn({}),ue=new ne({props:{name:"class transformers.SpeechEncoderDecoderConfig",anchor:"transformers.SpeechEncoderDecoderConfig",parameters:[{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/speech_encoder_decoder/configuration_speech_encoder_decoder.py#L27",parametersDescription:[{anchor:"transformers.SpeechEncoderDecoderConfig.kwargs",description:`<strong>kwargs</strong> (<em>optional</em>) &#x2014;
...
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-comment"># load fine-tuned model</span>
<span class="hljs-meta">&gt;&gt;&gt; </span>model = FlaxSpeechEncoderDecoderModel.from_pretrained(<span class="hljs-string">&quot;./wav2vec2-2-bart-large&quot;</span>)`}}),{c(){p=r("meta"),$=i(),u=r("h1"),T=r("a"),C=r("span"),b(x.$$.fragment),D=i(),L=r("span"),Mn=n("Speech Encoder Decoder Models"),on=i(),j=r("p"),Dn=n("The "),Ye=r("a"),$n=n("SpeechEncoderDecoderModel"),jn=n(` can be used to initialize a speech-sequence-to-text-sequence model
...
`),Xe=r("a"),Un=n("Speech2Text2"),Hn=n("."),an=i(),H=r("h2"),te=r("a"),ko=r("span"),b(fe.$$.fragment),Gn=i(),So=r("span"),Jn=n("SpeechEncoderDecoderConfig"),rn=i(),M=r("div"),b(ue.$$.fragment),Yn=i(),ae=r("p"),eo=r("a"),Zn=n("SpeechEncoderDecoderConfig"),Kn=n(` is the configuration class to store the configuration of a
...
Zhou, Wei Li, Peter J. Liu.`),zt=i(),Se=r("p"),Ft=n("Additionally, in "),Te=r("a"),Ct=n(`Large-Scale Self- and Semi-Supervised Learning for Speech
...
etc.)`),Bt=i(),Me=r("p"),Rt=n("This model is also a PyTorch "),De=r("a"),Ut=n("torch.nn.Module"),Ht=n(` subclass.
...
the model, you need to first set it back in training mode with `),Io=r("code"),va=n("model.train()"),ba=n("."),ya=i(),Wo=r("p"),wa=n("Example:"),Ea=i(),b(Pe.$$.fragment),cn=i(),X=r("h2"),ie=r("a"),Vo=r("span"),b(ze.$$.fragment),ka=i(),Oo=r("span"),Sa=n("FlaxSpeechEncoderDecoderModel"),ln=i(),f=r("div"),b(Fe.$$.fragment),Ta=i(),ee=r("p"),xa=n(`This class can be used to initialize a speech-sequence-to-text-sequence model with any pretrained speech
autoencoding model as the encoder and any pretrained text autoregressive model as the decoder. The encoder is
...
and should be fine-tuned on a downstream generative task, like summarization.`),qa=i(),Ce=r("p"),Pa=n(`The effectiveness of initializing sequence-to-sequence models with pretrained checkpoints for sequence generation
...
Zhou, Wei Li, Peter J. Liu.`),Ca=i(),Le=r("p"),Aa=n("Additionally, in "),Ne=r("a"),La=n(`Large-Scale Self- and Semi-Supervised Learning for Speech
...
checkpoints.`),gr=i(),Ko=r("p"),_r=n("Example:"),vr=i(),b(Ue.$$.fragment),this.h()},l(a){const h=Ds('[data-svelte="svelte-1phssyn"]',document.head);p=s(h,"META",{name:!0,content:!0}),h.forEach(o),$=l(a),u=s(a,"H1",{class:!0});var He=d(u);T=s(He,"A",{id:!0,class:!0,href:!0});var Qo=d(T);C=s(Qo,"SPAN",{});var br=d(C);y(x.$$.fragment,br),br.forEach(o),Qo.forEach(o),D=l(He),L=s(He,"SPAN",{});var yr=d(L);Mn=t(yr,"Speech Encoder Decoder Models"),yr.forEach(o),He.forEach(o),on=l(a),j=s(a,"P",{});var O=d(j);Dn=t(O,"The "),Ye=s(O,"A",{href:!0});var wr=d(Ye);$n=t(wr,"SpeechEncoderDecoderModel"),wr.forEach(o),jn=t(O,` can be used to initialize a speech-sequence-to-text-sequence model
...
`),Xe=s(mo,"A",{href:!0});var Dr=d(Xe);Un=t(Dr,"Speech2Text2"),Dr.forEach(o),Hn=t(mo,"."),mo.forEach(o),an=l(a),H=s(a,"H2",{class:!0});var hn=d(H);te=s(hn,"A",{id:!0,class:!0,href:!0});var $r=d(te);ko=s($r,"SPAN",{});var jr=d(ko);y(fe.$$.fragment,jr),jr.forEach(o),$r.forEach(o),Gn=l(hn),So=s(hn,"SPAN",{});var qr=d(So);Jn=t(qr,"SpeechEncoderDecoderConfig"),qr.forEach(o),hn.forEach(o),rn=l(a),M=s(a,"DIV",{class:!0});var F=d(M);y(ue.$$.fragment,F),Yn=l(F),ae=s(F,"P",{});var Xo=d(ae);eo=s(Xo,"A",{href:!0});var Pr=d(eo);Zn=t(Pr,"SpeechEncoderDecoderConfig"),Pr.forEach(o),Kn=t(Xo,` is the configuration class to store the configuration of a
...
arguments, defining the encoder and decoder configs.`),Xo.forEach(o),et=l(F),G=s(F,"P",{});var fo=d(G);ot=t(fo,"Configuration objects inherit from "),no=s(fo,"A",{href:!0});var Fr=d(no);nt=t(Fr,"PretrainedConfig"),Fr.forEach(o),tt=t(fo,` and can be used to control the model outputs. Read the
documentation from `),to=s(fo,"A",{href:!0});var Cr=d(to);at=t(Cr,"PretrainedConfig"),Cr.forEach(o),rt=t(fo," for more information."),fo.forEach(o),st=l(F),To=s(F,"P",{});var Ar=d(To);dt=t(Ar,"Examples:"),Ar.forEach(o),ct=l(F),y(ge.$$.fragment,F),it=l(F),re=s(F,"DIV",{class:!0});var mn=d(re);y(_e.$$.fragment,mn),lt=l(mn),ve=s(mn,"P",{});var fn=d(ve);pt=t(fn,"Instantiate a "),ao=s(fn,"A",{href:!0});var Lr=d(ao);ht=t(Lr,"SpeechEncoderDecoderConfig"),Lr.forEach(o),mt=t(fn,` (or a derived class) from a pre-trained encoder model
configuration and decoder model configuration.`),fn.forEach(o),mn.forEach(o),ft=l(F),se=s(F,"DIV",{class:!0});var un=d(se);y(be.$$.fragment,un),ut=l(un),J=s(un,"P",{});var uo=d(J);gt=t(uo,"Serializes this instance to a Python dictionary. Override the default "),xo=s(uo,"EM",{});var Nr=d(xo);_t=t(Nr,"to_dict()"),Nr.forEach(o),vt=t(uo," from "),Mo=s(uo,"EM",{});var Ir=d(Mo);bt=t(Ir,"PretrainedConfig"),Ir.forEach(o),yt=t(uo,"."),uo.forEach(o),un.forEach(o),F.forEach(o),sn=l(a),Y=s(a,"H2",{class:!0});var gn=d(Y);de=s(gn,"A",{id:!0,class:!0,href:!0});var Wr=d(de);Do=s(Wr,"SPAN",{});var Vr=d(Do);y(ye.$$.fragment,Vr),Vr.forEach(o),Wr.forEach(o),wt=l(gn),$o=s(gn,"SPAN",{});var Or=d($o);Et=t(Or,"SpeechEncoderDecoderModel"),Or.forEach(o),gn.forEach(o),dn=l(a),m=s(a,"DIV",{class:!0});var _=d(m);y(we.$$.fragment,_),kt=l(_),Z=s(_,"P",{});var go=d(Z);St=t(go,`This class can be used to initialize a speech-sequence-to-text-sequence model with any pretrained speech
autoencoding model as the encoder and any pretrained text autoregressive model as the decoder. The encoder is
...
Zhou, Wei Li, Peter J. Liu.`),_n.forEach(o),zt=l(_),Se=s(_,"P",{});var vn=d(Se);Ft=t(vn,"Additionally, in "),Te=s(vn,"A",{href:!0,rel:!0});var Hr=d(Te);Ct=t(Hr,`Large-Scale Self- and Semi-Supervised Learning for Speech
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),bn.forEach(o),Bt=l(_),Me=s(_,"P",{});var yn=d(Me);Rt=t(yn,"This model is also a PyTorch "),De=s(yn,"A",{href:!0,rel:!0});var Yr=d(De);Ut=t(Yr,"torch.nn.Module"),Yr.forEach(o),Ht=t(yn,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
...
and should be fine-tuned on a downstream generative task, like summarization.`),bo.forEach(o),qa=l(v),Ce=s(v,"P",{});var En=d(Ce);Pa=t(En,`The effectiveness of initializing sequence-to-sequence models with pretrained checkpoints for sequence generation
...
Zhou, Wei Li, Peter J. Liu.`),En.forEach(o),Ca=l(v),Le=s(v,"P",{});var kn=d(Le);Aa=t(kn,"Additionally, in "),Ne=s(kn,"A",{href:!0,rel:!0});var hs=d(Ne);La=t(hs,`Large-Scale Self- and Semi-Supervised Learning for Speech
