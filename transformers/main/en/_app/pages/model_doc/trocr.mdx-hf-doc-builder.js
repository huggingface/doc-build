...
`),h=s("a"),_=r("save_pretrained()"),D=r(`. Please refer to the docstrings of the
...
`),h=n(b,"A",{href:!0});var F=i(h);_=a(F,"save_pretrained()"),F.forEach(o),D=a(b,`. Please refer to the docstrings of the
methods above for more information.`),b.forEach(o),this.h()},h(){l(u,"href","/docs/transformers/main/en/main_classes/feature_extractor#transformers.FeatureExtractionMixin.save_pretrained"),l(h,"href","/docs/transformers/main/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.save_pretrained")},m(j,b){f(j,p,b),e(p,E),e(p,u),e(u,g),e(p,T),e(p,h),e(h,_),e(p,D)},d(j){j&&o(p)}}}function hi(S){let p,E,u,g,T;return g=new As({props:{code:`from transformers import (
    TrOCRConfig,
    TrOCRProcessor,
    TrOCRForCausalLM,
    ViTConfig,
...
<span class="hljs-string">&#x27;industry, &quot; Mr. Brown commented icily. &quot; Let us have a&#x27;</span>`}}),{c(){p=s("p"),E=r("Example:"),u=c(),C(g.$$.fragment)},l(h){p=n(h,"P",{});var _=i(p);E=a(_,"Example:"),_.forEach(o),u=m(h),w(g.$$.fragment,h)},m(h,_){f(h,p,_),e(p,E),f(h,u,_),k(g,h,_),T=!0},p:oi,i(h){T||(O(g.$$.fragment,h),T=!0)},o(h){$(g.$$.fragment,h),T=!1},d(h){h&&o(p),h&&o(u),y(g,h)}}}function fi(S){let p,E,u,g,T,h,_,D,j,b,z,F,Pt,ke,Qo,Mt,er,fo,W,tr,Oe,or,rr,$e,ar,sr,po,rt,nr,uo,at,jt,ir,go,oe,Is,_o,re,lr,st,dr,cr,vo,ae,mr,zt,hr,fr,To,B,pr,ye,ur,gr,Re,_r,vr,bo,nt,Tr,Co,H,Ee,br,xe,Cr,wr,kr,I,Or,Pe,$r,yr,Me,Rr,Er,je,xr,Pr,Mr,ze,jr,it,zr,Lr,wo,Z,se,Lt,Le,Fr,Ft,Dr,ko,G,qr,Dt,Ar,Ir,lt,Vr,Nr,Oo,v,Sr,qt,Wr,Br,At,Hr,Gr,It,Xr,Ur,Vt,Zr,Jr,dt,Yr,Kr,Nt,Qr,ea,St,ta,oa,Wt,ra,aa,Bt,sa,na,$o,ct,Ht,ia,yo,Fe,Ro,ne,la,De,da,ca,Eo,J,ie,Gt,qe,ma,Xt,ha,xo,q,Ae,fa,Y,pa,mt,ua,ga,Ie,_a,va,Ta,K,ba,ht,Ca,wa,ft,ka,Oa,$a,le,Po,Q,de,Ut,Ve,ya,Zt,Ra,Mo,R,Ne,Ea,Jt,xa,Pa,P,pt,Ma,ja,Yt,za,La,Kt,Fa,Da,Qt,qa,Aa,eo,Ia,Va,Se,to,Na,Sa,Wa,ut,Ba,Ha,Ga,ce,We,Xa,V,Ua,oo,Za,Ja,ro,Ya,Ka,ao,Qa,es,ts,X,Be,os,so,rs,as,me,ss,U,He,ns,Ge,is,gt,ls,ds,cs,he,ms,fe,Xe,hs,Ue,fs,_t,ps,us,gs,pe,Ze,_s,Je,vs,vt,Ts,bs,jo,ee,ue,no,Ye,Cs,io,ws,zo,A,Ke,ks,N,Os,Tt,$s,ys,lo,Rs,Es,bt,xs,Ps,Ms,Qe,js,et,zs,Ls,Fs,ge,tt,Ds,_e,Lo;return h=new xt({}),ke=new xt({}),Le=new xt({}),Fe=new As({props:{code:`from transformers import TrOCRProcessor, VisionEncoderDecoderModel
import requests 
from PIL import Image
...
into a single instance to both extract the input features and decode the predicted token ids.`),$o=c(),ct=s("ul"),Ht=s("li"),ia=r("Step-by-step Optical Character Recognition (OCR)"),yo=c(),C(Fe.$$.fragment),Ro=c(),ne=s("p"),la=r("See the "),De=s("a"),da=r("model hub"),ca=r(" to look for TrOCR checkpoints."),Eo=c(),J=s("h2"),ie=s("a"),Gt=s("span"),C(qe.$$.fragment),ma=c(),Xt=s("span"),ha=r("TrOCRConfig"),xo=c(),q=s("div"),C(Ae.$$.fragment),fa=c(),Y=s("p"),pa=r("This is the configuration class to store the configuration of a "),mt=s("a"),ua=r("TrOCRForCausalLM"),ga=r(`. It is used to instantiate an
