...
`),m=n(b,"CODE",{});var L=i(m);_=a(L,"from_pretrained"),L.forEach(o),D=a(b,` methods. Please refer to the docstrings of the
...
`),m=n(b,"CODE",{});var L=i(m);_=a(L,"save_pretrained"),L.forEach(o),D=a(b,`. Please refer to the docstrings of the methods
...
<span class="hljs-string">&#x27;industry, &quot; Mr. Brown commented icily. &quot; Let us have a&#x27;</span>`}}),{c(){p=s("p"),R=r("Example:"),u=c(),C(g.$$.fragment)},l(m){p=n(m,"P",{});var _=i(p);R=a(_,"Example:"),_.forEach(o),u=h(m),w(g.$$.fragment,m)},m(m,_){f(m,p,_),e(p,R),f(m,u,_),k(g,m,_),T=!0},p:oi,i(m){T||($(g.$$.fragment,m),T=!0)},o(m){O(g.$$.fragment,m),T=!1},d(m){m&&o(p),m&&o(u),y(g,m)}}}function fi(S){let p,R,u,g,T,m,_,D,j,b,z,L,Pt,ke,Qo,Mt,er,fo,W,tr,$e,or,rr,Oe,ar,sr,po,rt,nr,uo,at,jt,ir,go,oe,Is,_o,re,lr,st,dr,cr,vo,ae,hr,zt,mr,fr,To,B,pr,ye,ur,gr,Ee,_r,vr,bo,nt,Tr,Co,H,Re,br,xe,Cr,wr,kr,I,$r,Pe,Or,yr,Me,Er,Rr,je,xr,Pr,Mr,ze,jr,it,zr,Fr,wo,Z,se,Ft,Fe,Lr,Lt,Dr,ko,G,qr,Dt,Ar,Ir,lt,Vr,Nr,$o,v,Sr,qt,Wr,Br,At,Hr,Gr,It,Xr,Ur,Vt,Zr,Jr,dt,Yr,Kr,Nt,Qr,ea,St,ta,oa,Wt,ra,aa,Bt,sa,na,Oo,ct,Ht,ia,yo,Le,Eo,ne,la,De,da,ca,Ro,J,ie,Gt,qe,ha,Xt,ma,xo,q,Ae,fa,Y,pa,ht,ua,ga,Ie,_a,va,Ta,K,ba,mt,Ca,wa,ft,ka,$a,Oa,le,Po,Q,de,Ut,Ve,ya,Zt,Ea,Mo,E,Ne,Ra,Jt,xa,Pa,P,pt,Ma,ja,Yt,za,Fa,Kt,La,Da,Qt,qa,Aa,eo,Ia,Va,Se,to,Na,Sa,Wa,ut,Ba,Ha,Ga,ce,We,Xa,V,Ua,oo,Za,Ja,ro,Ya,Ka,ao,Qa,es,ts,X,Be,os,so,rs,as,he,ss,U,He,ns,Ge,is,gt,ls,ds,cs,me,hs,fe,Xe,ms,Ue,fs,_t,ps,us,gs,pe,Ze,_s,Je,vs,vt,Ts,bs,jo,ee,ue,no,Ye,Cs,io,ws,zo,A,Ke,ks,N,$s,Tt,Os,ys,lo,Es,Rs,bt,xs,Ps,Ms,Qe,js,et,zs,Fs,Ls,ge,tt,Ds,_e,Fo;return m=new xt({}),ke=new xt({}),Fe=new xt({}),Le=new As({props:{code:`from transformers import TrOCRProcessor, VisionEncoderDecoderModel
import requests 
from PIL import Image
...
into a single instance to both extract the input features and decode the predicted token ids.`),Oo=c(),ct=s("ul"),Ht=s("li"),ia=r("Step-by-step Optical Character Recognition (OCR)"),yo=c(),C(Le.$$.fragment),Eo=c(),ne=s("p"),la=r("See the "),De=s("a"),da=r("model hub"),ca=r(" to look for TrOCR checkpoints."),Ro=c(),J=s("h2"),ie=s("a"),Gt=s("span"),C(qe.$$.fragment),ha=c(),Xt=s("span"),ma=r("TrOCRConfig"),xo=c(),q=s("div"),C(Ae.$$.fragment),fa=c(),Y=s("p"),pa=r("This is the configuration class to store the configuration of a "),ht=s("a"),ua=r("TrOCRForCausalLM"),ga=r(`. It is used to instantiate an
...
`),ao=s("code"),Qa=r("__call__"),es=r(". Please refer to the doctsring of the above two methods for more information."),ts=c(),X=s("div"),C(Be.$$.fragment),os=c(),so=s("p"),rs=r("Instantiate a processor associated with a pretrained model."),as=c(),C(he.$$.fragment),ss=c(),U=s("div"),C(He.$$.fragment),ns=c(),Ge=s("p"),is=r(`Saves the attributes of this processor (feature extractor, tokenizer\u2026) in the specified directory so that it
...
more information.`),F.forEach(o),Ga=h(M),ce=n(M,"DIV",{class:!0});var Bo=i(ce);w(We.$$.fragment,Bo),Xa=h(Bo),V=n(Bo,"P",{});var be=i(V);Ua=a(be,`When used in normal mode, this method forwards all its arguments to AutoFeatureExtractor\u2019s
...
`),ao=n(be,"CODE",{});var Sn=i(ao);Qa=a(Sn,"__call__"),Sn.forEach(o),es=a(be,". Please refer to the doctsring of the above two methods for more information."),be.forEach(o),Bo.forEach(o),ts=h(M),X=n(M,"DIV",{class:!0});var Et=i(X);w(Be.$$.fragment,Et),os=h(Et),so=n(Et,"P",{});var Wn=i(so);rs=a(Wn,"Instantiate a processor associated with a pretrained model."),Wn.forEach(o),as=h(Et),w(he.$$.fragment,Et),Et.forEach(o),ss=h(M),U=n(M,"DIV",{class:!0});var Rt=i(U);w(He.$$.fragment,Rt),ns=h(Rt),Ge=n(Rt,"P",{});var Ho=i(Ge);is=a(Ho,`Saves the attributes of this processor (feature extractor, tokenizer\u2026) in the specified directory so that it
can be reloaded using the `),gt=n(Ho,"A",{href:!0});var Bn=i(gt);ls=a(Bn,"from_pretrained()"),Bn.forEach(o),ds=a(Ho," method."),Ho.forEach(o),cs=h(Rt),w(me.$$.fragment,Rt),Rt.forEach(o),hs=h(M),fe=n(M,"DIV",{class:!0});var Go=i(fe);w(Xe.$$.fragment,Go),ms=h(Go),Ue=n(Go,"P",{});var Xo=i(Ue);fs=a(Xo,"This method forwards all its arguments to TrOCRTokenizer\u2019s "),_t=n(Xo,"A",{href:!0});var Hn=i(_t);ps=a(Hn,"batch_decode()"),Hn.forEach(o),us=a(Xo,`. Please refer
