import{S as ri,i as ai,s as si,e as s,k as c,w as C,t as r,M as ni,c as n,d as o,m,a as i,x as w,h as a,b as l,N as ii,G as e,g as f,y as k,q as O,o as $,B as y,v as li,L as oi}from"../../chunks/vendor-hf-doc-builder.js";import{T as ei}from"../../chunks/Tip-hf-doc-builder.js";import{D as te}from"../../chunks/Docstring-hf-doc-builder.js";import{C as As}from"../../chunks/CodeBlock-hf-doc-builder.js";import{I as xt}from"../../chunks/IconCopyLink-hf-doc-builder.js";import{E as ti}from"../../chunks/ExampleCodeBlock-hf-doc-builder.js";function di(S){let p,E,u,g,T;return g=new As({props:{code:`from transformers import TrOCRForCausalLM, TrOCRConfig
...
`),h=n(b,"CODE",{});var F=i(h);_=a(F,"~tokenization_utils_base.PreTrainedTokenizer.from_pretrained"),F.forEach(o),D=a(b,` methods. Please refer to the docstrings of the
methods above for more information.`),b.forEach(o),this.h()},h(){l(u,"href","/docs/transformers/main/en/main_classes/feature_extractor#transformers.FeatureExtractionMixin.from_pretrained")},m(j,b){f(j,p,b),e(p,E),e(p,u),e(u,g),e(p,T),e(p,h),e(h,_),e(p,D)},d(j){j&&o(p)}}}function mi(S){let p,E,u,g,T,h,_,D;return{c(){p=s("p"),E=r("This class method is simply calling "),u=s("a"),g=r("save_pretrained()"),T=r(` and
`),h=s("code"),_=r("~tokenization_utils_base.PreTrainedTokenizer.save_pretrained"),D=r(`. Please refer to the docstrings of the methods
...
`),h=n(b,"CODE",{});var F=i(h);_=a(F,"~tokenization_utils_base.PreTrainedTokenizer.save_pretrained"),F.forEach(o),D=a(b,`. Please refer to the docstrings of the methods
above for more information.`),b.forEach(o),this.h()},h(){l(u,"href","/docs/transformers/main/en/main_classes/feature_extractor#transformers.FeatureExtractionMixin.save_pretrained")},m(j,b){f(j,p,b),e(p,E),e(p,u),e(u,g),e(p,T),e(p,h),e(h,_),e(p,D)},d(j){j&&o(p)}}}function hi(S){let p,E,u,g,T;return g=new As({props:{code:`from transformers import (
    TrOCRConfig,
    TrOCRProcessor,
    TrOCRForCausalLM,
    ViTConfig,
...
<span class="hljs-string">&#x27;industry, &quot; Mr. Brown commented icily. &quot; Let us have a&#x27;</span>`}}),{c(){p=s("p"),E=r("Example:"),u=c(),C(g.$$.fragment)},l(h){p=n(h,"P",{});var _=i(p);E=a(_,"Example:"),_.forEach(o),u=m(h),w(g.$$.fragment,h)},m(h,_){f(h,p,_),e(p,E),f(h,u,_),k(g,h,_),T=!0},p:oi,i(h){T||(O(g.$$.fragment,h),T=!0)},o(h){$(g.$$.fragment,h),T=!1},d(h){h&&o(p),h&&o(u),y(g,h)}}}function fi(S){let p,E,u,g,T,h,_,D,j,b,z,F,Pt,ke,Qo,Mt,er,fo,W,tr,Oe,or,rr,$e,ar,sr,po,rt,nr,uo,at,jt,ir,go,oe,Is,_o,re,lr,st,dr,cr,vo,ae,mr,zt,hr,fr,To,H,pr,ye,ur,gr,Re,_r,vr,bo,nt,Tr,Co,B,Ee,br,xe,Cr,wr,kr,I,Or,Pe,$r,yr,Me,Rr,Er,je,xr,Pr,Mr,ze,jr,it,zr,Lr,wo,Z,se,Lt,Le,Fr,Ft,Dr,ko,G,qr,Dt,Ar,Ir,lt,Vr,Nr,Oo,v,Sr,qt,Wr,Hr,At,Br,Gr,It,Xr,Ur,Vt,Zr,Jr,dt,Yr,Kr,Nt,Qr,ea,St,ta,oa,Wt,ra,aa,Ht,sa,na,$o,ct,Bt,ia,yo,Fe,Ro,ne,la,De,da,ca,Eo,J,ie,Gt,qe,ma,Xt,ha,xo,q,Ae,fa,Y,pa,mt,ua,ga,Ie,_a,va,Ta,K,ba,ht,Ca,wa,ft,ka,Oa,$a,le,Po,Q,de,Ut,Ve,ya,Zt,Ra,Mo,R,Ne,Ea,Jt,xa,Pa,P,pt,Ma,ja,Yt,za,La,Kt,Fa,Da,Qt,qa,Aa,eo,Ia,Va,Se,to,Na,Sa,Wa,ut,Ha,Ba,Ga,ce,We,Xa,V,Ua,oo,Za,Ja,ro,Ya,Ka,ao,Qa,es,ts,X,He,os,so,rs,as,me,ss,U,Be,ns,Ge,is,gt,ls,ds,cs,he,ms,fe,Xe,hs,Ue,fs,_t,ps,us,gs,pe,Ze,_s,Je,vs,vt,Ts,bs,jo,ee,ue,no,Ye,Cs,io,ws,zo,A,Ke,ks,N,Os,Tt,$s,ys,lo,Rs,Es,bt,xs,Ps,Ms,Qe,js,et,zs,Ls,Fs,ge,tt,Ds,_e,Lo;return h=new xt({}),ke=new xt({}),Le=new xt({}),Fe=new As({props:{code:`from transformers import TrOCRProcessor, VisionEncoderDecoderModel
import requests 
from PIL import Image
...
An instance of [<code>RobertaTokenizer</code>/<code>XLMRobertaTokenizer</code>]. The tokenizer is a required input.`,name:"tokenizer"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/trocr/processing_trocr.py#L24"}}),We=new te({props:{name:"__call__",anchor:"transformers.TrOCRProcessor.__call__",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/trocr/processing_trocr.py#L46"}}),He=new te({props:{name:"from_pretrained",anchor:"transformers.TrOCRProcessor.from_pretrained",parameters:[{name:"pretrained_model_name_or_path",val:""},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.TrOCRProcessor.from_pretrained.pretrained_model_name_or_path",description:`<strong>pretrained_model_name_or_path</strong> (<code>str</code> or <code>os.PathLike</code>) &#x2014;
...
tasks.`),go=c(),oe=s("img"),_o=c(),re=s("small"),lr=r("TrOCR architecture. Taken from the "),st=s("a"),dr=r("original paper"),cr=r("."),vo=c(),ae=s("p"),mr=r("Please refer to the "),zt=s("code"),hr=r("VisionEncoderDecoder"),fr=r(" class on how to use this model."),To=c(),H=s("p"),pr=r("This model was contributed by "),ye=s("a"),ur=r("nielsr"),gr=r(`. The original code can be found
`),Re=s("a"),_r=r("here"),vr=r("."),bo=c(),nt=s("p"),Tr=r("Tips:"),Co=c(),B=s("ul"),Ee=s("li"),br=r("The quickest way to get started with TrOCR is by checking the "),xe=s("a"),Cr=r(`tutorial
...
`),lt=s("a"),Vr=r("generate()"),Nr=r(" to autoregressively generate text given the input image."),Oo=c(),v=s("p"),Sr=r("The ["),qt=s("code"),Wr=r("ViTFeatureExtractor"),Hr=r("/"),At=s("code"),Br=r("DeiTFeatureExtractor"),Gr=r(`] class is responsible for preprocessing the input image and
...
into a single instance to both extract the input features and decode the predicted token ids.`),$o=c(),ct=s("ul"),Bt=s("li"),ia=r("Step-by-step Optical Character Recognition (OCR)"),yo=c(),C(Fe.$$.fragment),Ro=c(),ne=s("p"),la=r("See the "),De=s("a"),da=r("model hub"),ca=r(" to look for TrOCR checkpoints."),Eo=c(),J=s("h2"),ie=s("a"),Gt=s("span"),C(qe.$$.fragment),ma=c(),Xt=s("span"),ha=r("TrOCRConfig"),xo=c(),q=s("div"),C(Ae.$$.fragment),fa=c(),Y=s("p"),pa=r("This is the configuration class to store the configuration of a "),mt=s("a"),ua=r("TrOCRForCausalLM"),ga=r(`. It is used to instantiate an
...
`),ao=s("code"),Qa=r("~TrOCRTokenizer.__call__"),es=r(". Please refer to the doctsring of the above two methods for more information."),ts=c(),X=s("div"),C(He.$$.fragment),os=c(),so=s("p"),rs=r("Instantiate a processor associated with a pretrained model."),as=c(),C(me.$$.fragment),ss=c(),U=s("div"),C(Be.$$.fragment),ns=c(),Ge=s("p"),is=r(`Saves the attributes of this processor (feature extractor, tokenizer\u2026) in the specified directory so that it
...
into a single instance to both extract the input features and decode the predicted token ids.`),x.forEach(o),$o=m(t),ct=n(t,"UL",{});var Tn=i(ct);Bt=n(Tn,"LI",{});var bn=i(Bt);ia=a(bn,"Step-by-step Optical Character Recognition (OCR)"),bn.forEach(o),Tn.forEach(o),yo=m(t),w(Fe.$$.fragment,t),Ro=m(t),ne=n(t,"P",{});var No=i(ne);la=a(No,"See the "),De=n(No,"A",{href:!0,rel:!0});var Cn=i(De);da=a(Cn,"model hub"),Cn.forEach(o),ca=a(No," to look for TrOCR checkpoints."),No.forEach(o),Eo=m(t),J=n(t,"H2",{class:!0});var So=i(J);ie=n(So,"A",{id:!0,class:!0,href:!0});var wn=i(ie);Gt=n(wn,"SPAN",{});var kn=i(Gt);w(qe.$$.fragment,kn),kn.forEach(o),wn.forEach(o),ma=m(So),Xt=n(So,"SPAN",{});var On=i(Xt);ha=a(On,"TrOCRConfig"),On.forEach(o),So.forEach(o),xo=m(t),q=n(t,"DIV",{class:!0});var Te=i(q);w(Ae.$$.fragment,Te),fa=m(Te),Y=n(Te,"P",{});var $t=i(Y);pa=a($t,"This is the configuration class to store the configuration of a "),mt=n($t,"A",{href:!0});var $n=i(mt);ua=a($n,"TrOCRForCausalLM"),$n.forEach(o),ga=a($t,`. It is used to instantiate an
TrOCR model according to the specified arguments, defining the model architecture. Instantiating a configuration
with the defaults will yield a similar configuration to that of the TrOCR
`),Ie=n($t,"A",{href:!0,rel:!0});var yn=i(Ie);_a=a(yn,"microsoft/trocr-base-handwritten"),yn.forEach(o),va=a($t," architecture."),$t.forEach(o),Ta=m(Te),K=n(Te,"P",{});var yt=i(K);ba=a(yt,"Configuration objects inherit from "),ht=n(yt,"A",{href:!0});var Rn=i(ht);Ca=a(Rn,"PretrainedConfig"),Rn.forEach(o),wa=a(yt,` and can be used to control the model outputs. Read the
...
[`),Qt=n(L,"CODE",{});var Dn=i(Qt);qa=a(Dn,"RobertaTokenizer"),Dn.forEach(o),Aa=a(L,"/"),eo=n(L,"CODE",{});var qn=i(eo);Ia=a(qn,"XLMRobertaTokenizer"),qn.forEach(o),Va=a(L,"]. See the "),Se=n(L,"A",{href:!0});var qs=i(Se);to=n(qs,"STRONG",{});var An=i(to);Na=a(An,"call"),An.forEach(o),Sa=a(qs,"()"),qs.forEach(o),Wa=a(L," and "),ut=n(L,"A",{href:!0});var In=i(ut);Ha=a(In,"decode()"),In.forEach(o),Ba=a(L,` for
more information.`),L.forEach(o),Ga=m(M),ce=n(M,"DIV",{class:!0});var Ho=i(ce);w(We.$$.fragment,Ho),Xa=m(Ho),V=n(Ho,"P",{});var be=i(V);Ua=a(be,`When used in normal mode, this method forwards all its arguments to AutoFeatureExtractor\u2019s
...
`),ao=n(be,"CODE",{});var Sn=i(ao);Qa=a(Sn,"~TrOCRTokenizer.__call__"),Sn.forEach(o),es=a(be,". Please refer to the doctsring of the above two methods for more information."),be.forEach(o),Ho.forEach(o),ts=m(M),X=n(M,"DIV",{class:!0});var Rt=i(X);w(He.$$.fragment,Rt),os=m(Rt),so=n(Rt,"P",{});var Wn=i(so);rs=a(Wn,"Instantiate a processor associated with a pretrained model."),Wn.forEach(o),as=m(Rt),w(me.$$.fragment,Rt),Rt.forEach(o),ss=m(M),U=n(M,"DIV",{class:!0});var Et=i(U);w(Be.$$.fragment,Et),ns=m(Et),Ge=n(Et,"P",{});var Bo=i(Ge);is=a(Bo,`Saves the attributes of this processor (feature extractor, tokenizer\u2026) in the specified directory so that it
can be reloaded using the `),gt=n(Bo,"A",{href:!0});var Hn=i(gt);ls=a(Hn,"from_pretrained()"),Hn.forEach(o),ds=a(Bo," method."),Bo.forEach(o),cs=m(Et),w(he.$$.fragment,Et),Et.forEach(o),ms=m(M),fe=n(M,"DIV",{class:!0});var Go=i(fe);w(Xe.$$.fragment,Go),hs=m(Go),Ue=n(Go,"P",{});var Xo=i(Ue);fs=a(Xo,"This method forwards all its arguments to TrOCRTokenizer\u2019s "),_t=n(Xo,"A",{href:!0});var Bn=i(_t);ps=a(Bn,"batch_decode()"),Bn.forEach(o),us=a(Xo,`. Please refer
