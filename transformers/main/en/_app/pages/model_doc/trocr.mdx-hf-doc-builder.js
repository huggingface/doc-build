import{S as ri,i as ai,s as si,e as s,k as c,w as C,t as r,M as ni,c as n,d as o,m,a as i,x as w,h as a,b as l,N as ii,G as e,g as f,y as k,q as O,o as $,B as y,v as li,L as oi}from"../../chunks/vendor-hf-doc-builder.js";import{T as ei}from"../../chunks/Tip-hf-doc-builder.js";import{D as te}from"../../chunks/Docstring-hf-doc-builder.js";import{C as qs}from"../../chunks/CodeBlock-hf-doc-builder.js";import{I as xt}from"../../chunks/IconCopyLink-hf-doc-builder.js";import{E as ti}from"../../chunks/ExampleCodeBlock-hf-doc-builder.js";function di(S){let p,E,u,g,T;return g=new qs({props:{code:`from transformers import TrOCRConfig, TrOCRForCausalLM
...
<span class="hljs-meta">&gt;&gt;&gt; </span>configuration = model.config`}}),{c(){p=s("p"),E=r("Example:"),u=c(),C(g.$$.fragment)},l(h){p=n(h,"P",{});var _=i(p);E=a(_,"Example:"),_.forEach(o),u=m(h),w(g.$$.fragment,h)},m(h,_){f(h,p,_),e(p,E),f(h,u,_),k(g,h,_),T=!0},p:oi,i(h){T||(O(g.$$.fragment,h),T=!0)},o(h){$(g.$$.fragment,h),T=!1},d(h){h&&o(p),h&&o(u),y(g,h)}}}function ci(S){let p,E,u,g,T,h,_,I;return{c(){p=s("p"),E=r(`This class method is simply calling the feature extractor
`),u=s("a"),g=r("from_pretrained()"),T=r(` and the tokenizer
`),h=s("code"),_=r("~tokenization_utils_base.PreTrainedTokenizer.from_pretrained"),I=r(` methods. Please refer to the docstrings of the
...
`),h=n(b,"CODE",{});var D=i(h);_=a(D,"~tokenization_utils_base.PreTrainedTokenizer.from_pretrained"),D.forEach(o),I=a(b,` methods. Please refer to the docstrings of the
methods above for more information.`),b.forEach(o),this.h()},h(){l(u,"href","/docs/transformers/main/en/main_classes/feature_extractor#transformers.FeatureExtractionMixin.from_pretrained")},m(j,b){f(j,p,b),e(p,E),e(p,u),e(u,g),e(p,T),e(p,h),e(h,_),e(p,I)},d(j){j&&o(p)}}}function mi(S){let p,E,u,g,T,h,_,I;return{c(){p=s("p"),E=r("This class method is simply calling "),u=s("a"),g=r("save_pretrained()"),T=r(` and
`),h=s("a"),_=r("save_pretrained()"),I=r(`. Please refer to the docstrings of the
...
`),h=n(b,"A",{href:!0});var D=i(h);_=a(D,"save_pretrained()"),D.forEach(o),I=a(b,`. Please refer to the docstrings of the
methods above for more information.`),b.forEach(o),this.h()},h(){l(u,"href","/docs/transformers/main/en/main_classes/feature_extractor#transformers.FeatureExtractionMixin.save_pretrained"),l(h,"href","/docs/transformers/main/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.save_pretrained")},m(j,b){f(j,p,b),e(p,E),e(p,u),e(u,g),e(p,T),e(p,h),e(h,_),e(p,I)},d(j){j&&o(p)}}}function hi(S){let p,E,u,g,T;return g=new qs({props:{code:`from transformers import (
    TrOCRConfig,
    TrOCRProcessor,
    TrOCRForCausalLM,
    ViTConfig,
...
<span class="hljs-string">&#x27;industry, &quot; Mr. Brown commented icily. &quot; Let us have a&#x27;</span>`}}),{c(){p=s("p"),E=r("Example:"),u=c(),C(g.$$.fragment)},l(h){p=n(h,"P",{});var _=i(p);E=a(_,"Example:"),_.forEach(o),u=m(h),w(g.$$.fragment,h)},m(h,_){f(h,p,_),e(p,E),f(h,u,_),k(g,h,_),T=!0},p:oi,i(h){T||(O(g.$$.fragment,h),T=!0)},o(h){$(g.$$.fragment,h),T=!1},d(h){h&&o(p),h&&o(u),y(g,h)}}}function fi(S){let p,E,u,g,T,h,_,I,j,b,z,D,Pt,ke,Qo,Mt,er,fo,W,tr,Oe,or,rr,$e,ar,sr,po,rt,nr,uo,at,jt,ir,go,oe,As,_o,re,lr,st,dr,cr,vo,ae,mr,zt,hr,fr,To,B,pr,ye,ur,gr,Re,_r,vr,bo,nt,Tr,Co,H,Ee,br,xe,Cr,wr,kr,A,Or,Pe,$r,yr,Me,Rr,Er,je,xr,Pr,Mr,ze,jr,it,zr,Lr,wo,Z,se,Lt,Le,Dr,Dt,Ir,ko,G,Fr,It,qr,Ar,lt,Vr,Nr,Oo,v,Sr,Ft,Wr,Br,qt,Hr,Gr,At,Xr,Ur,Vt,Zr,Jr,dt,Yr,Kr,Nt,Qr,ea,St,ta,oa,Wt,ra,aa,Bt,sa,na,$o,ct,Ht,ia,yo,De,Ro,ne,la,Ie,da,ca,Eo,J,ie,Gt,Fe,ma,Xt,ha,xo,F,qe,fa,Y,pa,mt,ua,ga,Ae,_a,va,Ta,K,ba,ht,Ca,wa,ft,ka,Oa,$a,le,Po,Q,de,Ut,Ve,ya,Zt,Ra,Mo,R,Ne,Ea,Jt,xa,Pa,P,pt,Ma,ja,Yt,za,La,Kt,Da,Ia,Qt,Fa,qa,eo,Aa,Va,Se,to,Na,Sa,Wa,ut,Ba,Ha,Ga,ce,We,Xa,V,Ua,oo,Za,Ja,ro,Ya,Ka,ao,Qa,es,ts,X,Be,os,so,rs,as,me,ss,U,He,ns,Ge,is,gt,ls,ds,cs,he,ms,fe,Xe,hs,Ue,fs,_t,ps,us,gs,pe,Ze,_s,Je,vs,vt,Ts,bs,jo,ee,ue,no,Ye,Cs,io,ws,zo,q,Ke,ks,N,Os,Tt,$s,ys,lo,Rs,Es,bt,xs,Ps,Ms,Qe,js,et,zs,Ls,Ds,ge,tt,Is,_e,Lo;return h=new xt({}),ke=new xt({}),Le=new xt({}),De=new qs({props:{code:`from transformers import TrOCRProcessor, VisionEncoderDecoderModel
import requests
from PIL import Image
...
Whether or not to use a layernorm after the word + position embeddings.`,name:"layernorm_embedding"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/trocr/configuration_trocr.py#L31"}}),le=new ti({props:{anchor:"transformers.TrOCRConfig.example",$$slots:{default:[di]},$$scope:{ctx:S}}}),Ve=new xt({}),Ne=new te({props:{name:"class transformers.TrOCRProcessor",anchor:"transformers.TrOCRProcessor",parameters:[{name:"image_processor",val:" = None"},{name:"tokenizer",val:" = None"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.TrOCRProcessor.image_processor",description:`<strong>image_processor</strong> ([<code>ViTImageProcessor</code>/<code>DeiTImageProcessor</code>]) &#x2014;
An instance of [<code>ViTImageProcessor</code>/<code>DeiTImageProcessor</code>]. The image processor is a required input.`,name:"image_processor"},{anchor:"transformers.TrOCRProcessor.tokenizer",description:`<strong>tokenizer</strong> ([<code>RobertaTokenizer</code>/<code>XLMRobertaTokenizer</code>]) &#x2014;
An instance of [<code>RobertaTokenizer</code>/<code>XLMRobertaTokenizer</code>]. The tokenizer is a required input.`,name:"tokenizer"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/trocr/processing_trocr.py#L24"}}),We=new te({props:{name:"__call__",anchor:"transformers.TrOCRProcessor.__call__",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/trocr/processing_trocr.py#L61"}}),Be=new te({props:{name:"from_pretrained",anchor:"transformers.TrOCRProcessor.from_pretrained",parameters:[{name:"pretrained_model_name_or_path",val:""},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.TrOCRProcessor.from_pretrained.pretrained_model_name_or_path",description:`<strong>pretrained_model_name_or_path</strong> (<code>str</code> or <code>os.PathLike</code>) &#x2014;
...
namespace).
kwargs &#x2014;
Additional key word arguments passed along to the <a href="/docs/transformers/main/en/internal/image_processing_utils#transformers.ImageProcessingMixin.push_to_hub">push_to_hub()</a> method.`,name:"push_to_hub"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/processing_utils.py#L95"}}),he=new ei({props:{$$slots:{default:[mi]},$$scope:{ctx:S}}}),Xe=new te({props:{name:"batch_decode",anchor:"transformers.TrOCRProcessor.batch_decode",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/trocr/processing_trocr.py#L94"}}),Ze=new te({props:{name:"decode",anchor:"transformers.TrOCRProcessor.decode",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/trocr/processing_trocr.py#L101"}}),Ye=new xt({}),Ke=new te({props:{name:"class transformers.TrOCRForCausalLM",anchor:"transformers.TrOCRForCausalLM",parameters:[{name:"config",val:""}],parametersDescription:[{anchor:"transformers.TrOCRForCausalLM.config",description:`<strong>config</strong> (<a href="/docs/transformers/main/en/model_doc/trocr#transformers.TrOCRConfig">TrOCRConfig</a>) &#x2014;
...
`}}),_e=new ti({props:{anchor:"transformers.TrOCRForCausalLM.forward.example",$$slots:{default:[hi]},$$scope:{ctx:S}}}),{c(){p=s("meta"),E=c(),u=s("h1"),g=s("a"),T=s("span"),C(h.$$.fragment),_=c(),I=s("span"),j=r("TrOCR"),b=c(),z=s("h2"),D=s("a"),Pt=s("span"),C(ke.$$.fragment),Qo=c(),Mt=s("span"),er=r("Overview"),fo=c(),W=s("p"),tr=r("The TrOCR model was proposed in "),Oe=s("a"),or=r(`TrOCR: Transformer-based Optical Character Recognition with Pre-trained
...
tasks.`),go=c(),oe=s("img"),_o=c(),re=s("small"),lr=r("TrOCR architecture. Taken from the "),st=s("a"),dr=r("original paper"),cr=r("."),vo=c(),ae=s("p"),mr=r("Please refer to the "),zt=s("code"),hr=r("VisionEncoderDecoder"),fr=r(" class on how to use this model."),To=c(),B=s("p"),pr=r("This model was contributed by "),ye=s("a"),ur=r("nielsr"),gr=r(`. The original code can be found
...
at inference time as well as fine-tuning on custom data.`),kr=c(),A=s("li"),Or=r(`TrOCR is pre-trained in 2 stages before being fine-tuned on downstream datasets. It achieves state-of-the-art results
...
information, see the `),je=s("a"),xr=r("official models"),Pr=r("."),Mr=c(),ze=s("li"),jr=r("TrOCR is always used within the "),it=s("a"),zr=r("VisionEncoderDecoder"),Lr=r(" framework."),wo=c(),Z=s("h2"),se=s("a"),Lt=s("span"),C(Le.$$.fragment),Dr=c(),Dt=s("span"),Ir=r("Inference"),ko=c(),G=s("p"),Fr=r("TrOCR\u2019s "),It=s("code"),qr=r("VisionEncoderDecoder"),Ar=r(` model accepts images as input and makes use of
`),lt=s("a"),Vr=r("generate()"),Nr=r(" to autoregressively generate text given the input image."),Oo=c(),v=s("p"),Sr=r("The ["),Ft=s("code"),Wr=r("ViTFeatureExtractor"),Br=r("/"),qt=s("code"),Hr=r("DeiTFeatureExtractor"),Gr=r(`] class is responsible for preprocessing the input image and
[`),At=s("code"),Xr=r("RobertaTokenizer"),Ur=r("/"),Vt=s("code"),Zr=r("XLMRobertaTokenizer"),Jr=r(`] decodes the generated target tokens to the target string. The
...
into a single instance to both extract the input features and decode the predicted token ids.`),$o=c(),ct=s("ul"),Ht=s("li"),ia=r("Step-by-step Optical Character Recognition (OCR)"),yo=c(),C(De.$$.fragment),Ro=c(),ne=s("p"),la=r("See the "),Ie=s("a"),da=r("model hub"),ca=r(" to look for TrOCR checkpoints."),Eo=c(),J=s("h2"),ie=s("a"),Gt=s("span"),C(Fe.$$.fragment),ma=c(),Xt=s("span"),ha=r("TrOCRConfig"),xo=c(),F=s("div"),C(qe.$$.fragment),fa=c(),Y=s("p"),pa=r("This is the configuration class to store the configuration of a "),mt=s("a"),ua=r("TrOCRForCausalLM"),ga=r(`. It is used to instantiate an
...
`),Ae=s("a"),_a=r("microsoft/trocr-base-handwritten"),va=r(" architecture."),Ta=c(),K=s("p"),ba=r("Configuration objects inherit from "),ht=s("a"),Ca=r("PretrainedConfig"),wa=r(` and can be used to control the model outputs. Read the
documentation from `),ft=s("a"),ka=r("PretrainedConfig"),Oa=r(" for more information."),$a=c(),C(le.$$.fragment),Po=c(),Q=s("h2"),de=s("a"),Ut=s("span"),C(Ve.$$.fragment),ya=c(),Zt=s("span"),Ra=r("TrOCRProcessor"),Mo=c(),R=s("div"),C(Ne.$$.fragment),Ea=c(),Jt=s("p"),xa=r("Constructs a TrOCR processor which wraps a vision feature extractor and a TrOCR tokenizer into a single processor."),Pa=c(),P=s("p"),pt=s("a"),Ma=r("TrOCRProcessor"),ja=r(" offers all the functionalities of ["),Yt=s("code"),za=r("ViTImageProcessor"),La=r("/"),Kt=s("code"),Da=r("DeiTImageProcessor"),Ia=r(`] and
[`),Qt=s("code"),Fa=r("RobertaTokenizer"),qa=r("/"),eo=s("code"),Aa=r("XLMRobertaTokenizer"),Va=r("]. See the "),Se=s("a"),to=s("strong"),Na=r("call"),Sa=r("()"),Wa=r(" and "),ut=s("a"),Ba=r("decode()"),Ha=r(` for
more information.`),Ga=c(),ce=s("div"),C(We.$$.fragment),Xa=c(),V=s("p"),Ua=r(`When used in normal mode, this method forwards all its arguments to AutoImageProcessor\u2019s
...
`),ao=s("code"),Qa=r("~TrOCRTokenizer.__call__"),es=r(". Please refer to the doctsring of the above two methods for more information."),ts=c(),X=s("div"),C(Be.$$.fragment),os=c(),so=s("p"),rs=r("Instantiate a processor associated with a pretrained model."),as=c(),C(me.$$.fragment),ss=c(),U=s("div"),C(He.$$.fragment),ns=c(),Ge=s("p"),is=r(`Saves the attributes of this processor (feature extractor, tokenizer\u2026) in the specified directory so that it
can be reloaded using the `),gt=s("a"),ls=r("from_pretrained()"),ds=r(" method."),cs=c(),C(he.$$.fragment),ms=c(),fe=s("div"),C(Xe.$$.fragment),hs=c(),Ue=s("p"),fs=r("This method forwards all its arguments to TrOCRTokenizer\u2019s "),_t=s("a"),ps=r("batch_decode()"),us=r(`. Please refer
...
docstring of this method for more information.`),jo=c(),ee=s("h2"),ue=s("a"),no=s("span"),C(Ye.$$.fragment),Cs=c(),io=s("span"),ws=r("TrOCRForCausalLM"),zo=c(),q=s("div"),C(Ke.$$.fragment),ks=c(),N=s("p"),Os=r("The TrOCR Decoder with a language modeling head. Can be used as the decoder part of "),Tt=s("a"),$s=r("EncoderDecoderModel"),ys=r(" and "),lo=s("code"),Rs=r("VisionEncoderDecoder"),Es=r(`.
...
effective, and can be pre-trained with large-scale synthetic data and fine-tuned with human-labeled datasets. Experiments
show that the TrOCR model outperforms the current state-of-the-art models on both printed and handwritten text recognition
tasks.`),Xs.forEach(o),Gs.forEach(o),go=m(t),oe=n(t,"IMG",{src:!0,alt:!0,width:!0}),_o=m(t),re=n(t,"SMALL",{});var Io=i(re);lr=a(Io,"TrOCR architecture. Taken from the "),st=n(Io,"A",{href:!0});var Us=i(st);dr=a(Us,"original paper"),Us.forEach(o),cr=a(Io,"."),Io.forEach(o),vo=m(t),ae=n(t,"P",{});var Fo=i(ae);mr=a(Fo,"Please refer to the "),zt=n(Fo,"CODE",{});var Zs=i(zt);hr=a(Zs,"VisionEncoderDecoder"),Zs.forEach(o),fr=a(Fo," class on how to use this model."),Fo.forEach(o),To=m(t),B=n(t,"P",{});var wt=i(B);pr=a(wt,"This model was contributed by "),ye=n(wt,"A",{href:!0,rel:!0});var Js=i(ye);ur=a(Js,"nielsr"),Js.forEach(o),gr=a(wt,`. The original code can be found
`),Re=n(wt,"A",{href:!0,rel:!0});var Ys=i(Re);_r=a(Ys,"here"),Ys.forEach(o),vr=a(wt,"."),wt.forEach(o),bo=m(t),nt=n(t,"P",{});var Ks=i(nt);Tr=a(Ks,"Tips:"),Ks.forEach(o),Co=m(t),H=n(t,"UL",{});var kt=i(H);Ee=n(kt,"LI",{});var qo=i(Ee);br=a(qo,"The quickest way to get started with TrOCR is by checking the "),xe=n(qo,"A",{href:!0,rel:!0});var Qs=i(xe);Cr=a(Qs,`tutorial
notebooks`),Qs.forEach(o),wr=a(qo,`, which show how to use the model
at inference time as well as fine-tuning on custom data.`),qo.forEach(o),kr=m(kt),A=n(kt,"LI",{});var ve=i(A);Or=a(ve,`TrOCR is pre-trained in 2 stages before being fine-tuned on downstream datasets. It achieves state-of-the-art results
...
information, see the `),je=n(ve,"A",{href:!0,rel:!0});var on=i(je);xr=a(on,"official models"),on.forEach(o),Pr=a(ve,"."),ve.forEach(o),Mr=m(kt),ze=n(kt,"LI",{});var Ao=i(ze);jr=a(Ao,"TrOCR is always used within the "),it=n(Ao,"A",{href:!0});var rn=i(it);zr=a(rn,"VisionEncoderDecoder"),rn.forEach(o),Lr=a(Ao," framework."),Ao.forEach(o),kt.forEach(o),wo=m(t),Z=n(t,"H2",{class:!0});var Vo=i(Z);se=n(Vo,"A",{id:!0,class:!0,href:!0});var an=i(se);Lt=n(an,"SPAN",{});var sn=i(Lt);w(Le.$$.fragment,sn),sn.forEach(o),an.forEach(o),Dr=m(Vo),Dt=n(Vo,"SPAN",{});var nn=i(Dt);Ir=a(nn,"Inference"),nn.forEach(o),Vo.forEach(o),ko=m(t),G=n(t,"P",{});var Ot=i(G);Fr=a(Ot,"TrOCR\u2019s "),It=n(Ot,"CODE",{});var ln=i(It);qr=a(ln,"VisionEncoderDecoder"),ln.forEach(o),Ar=a(Ot,` model accepts images as input and makes use of
`),lt=n(Ot,"A",{href:!0});var dn=i(lt);Vr=a(dn,"generate()"),dn.forEach(o),Nr=a(Ot," to autoregressively generate text given the input image."),Ot.forEach(o),Oo=m(t),v=n(t,"P",{});var x=i(v);Sr=a(x,"The ["),Ft=n(x,"CODE",{});var cn=i(Ft);Wr=a(cn,"ViTFeatureExtractor"),cn.forEach(o),Br=a(x,"/"),qt=n(x,"CODE",{});var mn=i(qt);Hr=a(mn,"DeiTFeatureExtractor"),mn.forEach(o),Gr=a(x,`] class is responsible for preprocessing the input image and
[`),At=n(x,"CODE",{});var hn=i(At);Xr=a(hn,"RobertaTokenizer"),hn.forEach(o),Ur=a(x,"/"),Vt=n(x,"CODE",{});var fn=i(Vt);Zr=a(fn,"XLMRobertaTokenizer"),fn.forEach(o),Jr=a(x,`] decodes the generated target tokens to the target string. The
...
into a single instance to both extract the input features and decode the predicted token ids.`),x.forEach(o),$o=m(t),ct=n(t,"UL",{});var Tn=i(ct);Ht=n(Tn,"LI",{});var bn=i(Ht);ia=a(bn,"Step-by-step Optical Character Recognition (OCR)"),bn.forEach(o),Tn.forEach(o),yo=m(t),w(De.$$.fragment,t),Ro=m(t),ne=n(t,"P",{});var No=i(ne);la=a(No,"See the "),Ie=n(No,"A",{href:!0,rel:!0});var Cn=i(Ie);da=a(Cn,"model hub"),Cn.forEach(o),ca=a(No," to look for TrOCR checkpoints."),No.forEach(o),Eo=m(t),J=n(t,"H2",{class:!0});var So=i(J);ie=n(So,"A",{id:!0,class:!0,href:!0});var wn=i(ie);Gt=n(wn,"SPAN",{});var kn=i(Gt);w(Fe.$$.fragment,kn),kn.forEach(o),wn.forEach(o),ma=m(So),Xt=n(So,"SPAN",{});var On=i(Xt);ha=a(On,"TrOCRConfig"),On.forEach(o),So.forEach(o),xo=m(t),F=n(t,"DIV",{class:!0});var Te=i(F);w(qe.$$.fragment,Te),fa=m(Te),Y=n(Te,"P",{});var $t=i(Y);pa=a($t,"This is the configuration class to store the configuration of a "),mt=n($t,"A",{href:!0});var $n=i(mt);ua=a($n,"TrOCRForCausalLM"),$n.forEach(o),ga=a($t,`. It is used to instantiate an
TrOCR model according to the specified arguments, defining the model architecture. Instantiating a configuration
with the defaults will yield a similar configuration to that of the TrOCR
`),Ae=n($t,"A",{href:!0,rel:!0});var yn=i(Ae);_a=a(yn,"microsoft/trocr-base-handwritten"),yn.forEach(o),va=a($t," architecture."),$t.forEach(o),Ta=m(Te),K=n(Te,"P",{});var yt=i(K);ba=a(yt,"Configuration objects inherit from "),ht=n(yt,"A",{href:!0});var Rn=i(ht);Ca=a(Rn,"PretrainedConfig"),Rn.forEach(o),wa=a(yt,` and can be used to control the model outputs. Read the
documentation from `),ft=n(yt,"A",{href:!0});var En=i(ft);ka=a(En,"PretrainedConfig"),En.forEach(o),Oa=a(yt," for more information."),yt.forEach(o),$a=m(Te),w(le.$$.fragment,Te),Te.forEach(o),Po=m(t),Q=n(t,"H2",{class:!0});var Wo=i(Q);de=n(Wo,"A",{id:!0,class:!0,href:!0});var xn=i(de);Ut=n(xn,"SPAN",{});var Pn=i(Ut);w(Ve.$$.fragment,Pn),Pn.forEach(o),xn.forEach(o),ya=m(Wo),Zt=n(Wo,"SPAN",{});var Mn=i(Zt);Ra=a(Mn,"TrOCRProcessor"),Mn.forEach(o),Wo.forEach(o),Mo=m(t),R=n(t,"DIV",{class:!0});var M=i(R);w(Ne.$$.fragment,M),Ea=m(M),Jt=n(M,"P",{});var jn=i(Jt);xa=a(jn,"Constructs a TrOCR processor which wraps a vision feature extractor and a TrOCR tokenizer into a single processor."),jn.forEach(o),Pa=m(M),P=n(M,"P",{});var L=i(P);pt=n(L,"A",{href:!0});var zn=i(pt);Ma=a(zn,"TrOCRProcessor"),zn.forEach(o),ja=a(L," offers all the functionalities of ["),Yt=n(L,"CODE",{});var Ln=i(Yt);za=a(Ln,"ViTImageProcessor"),Ln.forEach(o),La=a(L,"/"),Kt=n(L,"CODE",{});var Dn=i(Kt);Da=a(Dn,"DeiTImageProcessor"),Dn.forEach(o),Ia=a(L,`] and
[`),Qt=n(L,"CODE",{});var In=i(Qt);Fa=a(In,"RobertaTokenizer"),In.forEach(o),qa=a(L,"/"),eo=n(L,"CODE",{});var Fn=i(eo);Aa=a(Fn,"XLMRobertaTokenizer"),Fn.forEach(o),Va=a(L,"]. See the "),Se=n(L,"A",{href:!0});var Fs=i(Se);to=n(Fs,"STRONG",{});var qn=i(to);Na=a(qn,"call"),qn.forEach(o),Sa=a(Fs,"()"),Fs.forEach(o),Wa=a(L," and "),ut=n(L,"A",{href:!0});var An=i(ut);Ba=a(An,"decode()"),An.forEach(o),Ha=a(L,` for
more information.`),L.forEach(o),Ga=m(M),ce=n(M,"DIV",{class:!0});var Bo=i(ce);w(We.$$.fragment,Bo),Xa=m(Bo),V=n(Bo,"P",{});var be=i(V);Ua=a(be,`When used in normal mode, this method forwards all its arguments to AutoImageProcessor\u2019s
...
`),ao=n(be,"CODE",{});var Sn=i(ao);Qa=a(Sn,"~TrOCRTokenizer.__call__"),Sn.forEach(o),es=a(be,". Please refer to the doctsring of the above two methods for more information."),be.forEach(o),Bo.forEach(o),ts=m(M),X=n(M,"DIV",{class:!0});var Rt=i(X);w(Be.$$.fragment,Rt),os=m(Rt),so=n(Rt,"P",{});var Wn=i(so);rs=a(Wn,"Instantiate a processor associated with a pretrained model."),Wn.forEach(o),as=m(Rt),w(me.$$.fragment,Rt),Rt.forEach(o),ss=m(M),U=n(M,"DIV",{class:!0});var Et=i(U);w(He.$$.fragment,Et),ns=m(Et),Ge=n(Et,"P",{});var Ho=i(Ge);is=a(Ho,`Saves the attributes of this processor (feature extractor, tokenizer\u2026) in the specified directory so that it
can be reloaded using the `),gt=n(Ho,"A",{href:!0});var Bn=i(gt);ls=a(Bn,"from_pretrained()"),Bn.forEach(o),ds=a(Ho," method."),Ho.forEach(o),cs=m(Et),w(he.$$.fragment,Et),Et.forEach(o),ms=m(M),fe=n(M,"DIV",{class:!0});var Go=i(fe);w(Xe.$$.fragment,Go),hs=m(Go),Ue=n(Go,"P",{});var Xo=i(Ue);fs=a(Xo,"This method forwards all its arguments to TrOCRTokenizer\u2019s "),_t=n(Xo,"A",{href:!0});var Hn=i(_t);ps=a(Hn,"batch_decode()"),Hn.forEach(o),us=a(Xo,`. Please refer
to the docstring of this method for more information.`),Xo.forEach(o),Go.forEach(o),gs=m(M),pe=n(M,"DIV",{class:!0});var Uo=i(pe);w(Ze.$$.fragment,Uo),_s=m(Uo),Je=n(Uo,"P",{});var Zo=i(Je);vs=a(Zo,"This method forwards all its arguments to TrOCRTokenizer\u2019s "),vt=n(Zo,"A",{href:!0});var Gn=i(vt);Ts=a(Gn,"decode()"),Gn.forEach(o),bs=a(Zo,`. Please refer to the
docstring of this method for more information.`),Zo.forEach(o),Uo.forEach(o),M.forEach(o),jo=m(t),ee=n(t,"H2",{class:!0});var Jo=i(ee);ue=n(Jo,"A",{id:!0,class:!0,href:!0});var Xn=i(ue);no=n(Xn,"SPAN",{});var Un=i(no);w(Ye.$$.fragment,Un),Un.forEach(o),Xn.forEach(o),Cs=m(Jo),io=n(Jo,"SPAN",{});var Zn=i(io);ws=a(Zn,"TrOCRForCausalLM"),Zn.forEach(o),Jo.forEach(o),zo=m(t),q=n(t,"DIV",{class:!0});var Ce=i(q);w(Ke.$$.fragment,Ce),ks=m(Ce),N=n(Ce,"P",{});var we=i(N);Os=a(we,"The TrOCR Decoder with a language modeling head. Can be used as the decoder part of "),Tt=n(we,"A",{href:!0});var Jn=i(Tt);$s=a(Jn,"EncoderDecoderModel"),Jn.forEach(o),ys=a(we," and "),lo=n(we,"CODE",{});var Yn=i(lo);Rs=a(Yn,"VisionEncoderDecoder"),Yn.forEach(o),Es=a(we,`.
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),we.forEach(o),Ms=m(Ce),Qe=n(Ce,"P",{});var Yo=i(Qe);js=a(Yo,"This model is also a PyTorch "),et=n(Yo,"A",{href:!0,rel:!0});var Qn=i(et);zs=a(Qn,"torch.nn.Module"),Qn.forEach(o),Ls=a(Yo,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Yo.forEach(o),Ds=m(Ce),ge=n(Ce,"DIV",{class:!0});var Ko=i(ge);w(tt.$$.fragment,Ko),Is=m(Ko),w(_e.$$.fragment,Ko),Ko.forEach(o),Ce.forEach(o),this.h()},h(){l(p,"name","hf:doc:metadata"),l(p,"content",JSON.stringify(pi)),l(g,"id","trocr"),l(g,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),l(g,"href","#trocr"),l(u,"class","relative group"),l(D,"id","overview"),l(D,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),l(D,"href","#overview"),l(z,"class","relative group"),l(Oe,"href","https://arxiv.org/abs/2109.10282"),l(Oe,"rel","nofollow"),l($e,"href","https://en.wikipedia.org/wiki/Optical_character_recognition"),l($e,"rel","nofollow"),ii(oe.src,As="https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/trocr_architecture.jpg")||l(oe,"src",As),l(oe,"alt","drawing"),l(oe,"width","600"),l(st,"href","https://arxiv.org/abs/2109.10282"),l(ye,"href","https://huggingface.co/nielsr"),l(ye,"rel","nofollow"),l(Re,"href","https://github.com/microsoft/unilm/tree/6f60612e7cc86a2a1ae85c47231507a587ab4e01/trocr"),l(Re,"rel","nofollow"),l(xe,"href","https://github.com/NielsRogge/Transformers-Tutorials/tree/master/TrOCR"),l(xe,"rel","nofollow"),l(Pe,"href","https://paperswithcode.com/dataset/sroie"),l(Pe,"rel","nofollow"),l(Me,"href","https://fki.tic.heia-fr.ch/databases/iam-handwriting-database%3E"),l(Me,"rel","nofollow"),l(je,"href","https://huggingface.co/models?other=trocr%3E"),l(je,"rel","nofollow"),l(it,"href","vision-encoder-decoder"),l(se,"id","inference"),l(se,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),l(se,"href","#inference"),l(Z,"class","relative group"),l(lt,"href","/docs/transformers/main/en/main_classes/text_generation#transformers.GenerationMixin.generate"),l(dt,"href","/docs/transformers/main/en/model_doc/trocr#transformers.TrOCRProcessor"),l(Ie,"href","https://huggingface.co/models?filter=trocr"),l(Ie,"rel","nofollow"),l(ie,"id","transformers.TrOCRConfig"),l(ie,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),l(ie,"href","#transformers.TrOCRConfig"),l(J,"class","relative group"),l(mt,"href","/docs/transformers/main/en/model_doc/trocr#transformers.TrOCRForCausalLM"),l(Ae,"href","https://huggingface.co/microsoft/trocr-base-handwritten"),l(Ae,"rel","nofollow"),l(ht,"href","/docs/transformers/main/en/main_classes/configuration#transformers.PretrainedConfig"),l(ft,"href","/docs/transformers/main/en/main_classes/configuration#transformers.PretrainedConfig"),l(F,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),l(de,"id","transformers.TrOCRProcessor"),l(de,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),l(de,"href","#transformers.TrOCRProcessor"),l(Q,"class","relative group"),l(pt,"href","/docs/transformers/main/en/model_doc/trocr#transformers.TrOCRProcessor"),l(Se,"href","/docs/transformers/main/en/model_doc/trocr#transformers.TrOCRProcessor.__call__"),l(ut,"href","/docs/transformers/main/en/model_doc/trocr#transformers.TrOCRProcessor.decode"),l(ce,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),l(X,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),l(gt,"href","/docs/transformers/main/en/main_classes/processors#transformers.ProcessorMixin.from_pretrained"),l(U,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),l(_t,"href","/docs/transformers/main/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.batch_decode"),l(fe,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),l(vt,"href","/docs/transformers/main/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.decode"),l(pe,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),l(R,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),l(ue,"id","transformers.TrOCRForCausalLM"),l(ue,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),l(ue,"href","#transformers.TrOCRForCausalLM"),l(ee,"class","relative group"),l(Tt,"href","/docs/transformers/main/en/model_doc/encoder-decoder#transformers.EncoderDecoderModel"),l(bt,"href","/docs/transformers/main/en/main_classes/model#transformers.PreTrainedModel"),l(et,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),l(et,"rel","nofollow"),l(ge,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),l(q,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8")},m(t,d){e(document.head,p),f(t,E,d),f(t,u,d),e(u,g),e(g,T),k(h,T,null),e(u,_),e(u,I),e(I,j),f(t,b,d),f(t,z,d),e(z,D),e(D,Pt),k(ke,Pt,null),e(z,Qo),e(z,Mt),e(Mt,er),f(t,fo,d),f(t,W,d),e(W,tr),e(W,Oe),e(Oe,or),e(W,rr),e(W,$e),e($e,ar),e(W,sr),f(t,po,d),f(t,rt,d),e(rt,nr),f(t,uo,d),f(t,at,d),e(at,jt),e(jt,ir),f(t,go,d),f(t,oe,d),f(t,_o,d),f(t,re,d),e(re,lr),e(re,st),e(st,dr),e(re,cr),f(t,vo,d),f(t,ae,d),e(ae,mr),e(ae,zt),e(zt,hr),e(ae,fr),f(t,To,d),f(t,B,d),e(B,pr),e(B,ye),e(ye,ur),e(B,gr),e(B,Re),e(Re,_r),e(B,vr),f(t,bo,d),f(t,nt,d),e(nt,Tr),f(t,Co,d),f(t,H,d),e(H,Ee),e(Ee,br),e(Ee,xe),e(xe,Cr),e(Ee,wr),e(H,kr),e(H,A),e(A,Or),e(A,Pe),e(Pe,$r),e(A,yr),e(A,Me),e(Me,Rr),e(A,Er),e(A,je),e(je,xr),e(A,Pr),e(H,Mr),e(H,ze),e(ze,jr),e(ze,it),e(it,zr),e(ze,Lr),f(t,wo,d),f(t,Z,d),e(Z,se),e(se,Lt),k(Le,Lt,null),e(Z,Dr),e(Z,Dt),e(Dt,Ir),f(t,ko,d),f(t,G,d),e(G,Fr),e(G,It),e(It,qr),e(G,Ar),e(G,lt),e(lt,Vr),e(G,Nr),f(t,Oo,d),f(t,v,d),e(v,Sr),e(v,Ft),e(Ft,Wr),e(v,Br),e(v,qt),e(qt,Hr),e(v,Gr),e(v,At),e(At,Xr),e(v,Ur),e(v,Vt),e(Vt,Zr),e(v,Jr),e(v,dt),e(dt,Yr),e(v,Kr),e(v,Nt),e(Nt,Qr),e(v,ea),e(v,St),e(St,ta),e(v,oa),e(v,Wt),e(Wt,ra),e(v,aa),e(v,Bt),e(Bt,sa),e(v,na),f(t,$o,d),f(t,ct,d),e(ct,Ht),e(Ht,ia),f(t,yo,d),k(De,t,d),f(t,Ro,d),f(t,ne,d),e(ne,la),e(ne,Ie),e(Ie,da),e(ne,ca),f(t,Eo,d),f(t,J,d),e(J,ie),e(ie,Gt),k(Fe,Gt,null),e(J,ma),e(J,Xt),e(Xt,ha),f(t,xo,d),f(t,F,d),k(qe,F,null),e(F,fa),e(F,Y),e(Y,pa),e(Y,mt),e(mt,ua),e(Y,ga),e(Y,Ae),e(Ae,_a),e(Y,va),e(F,Ta),e(F,K),e(K,ba),e(K,ht),e(ht,Ca),e(K,wa),e(K,ft),e(ft,ka),e(K,Oa),e(F,$a),k(le,F,null),f(t,Po,d),f(t,Q,d),e(Q,de),e(de,Ut),k(Ve,Ut,null),e(Q,ya),e(Q,Zt),e(Zt,Ra),f(t,Mo,d),f(t,R,d),k(Ne,R,null),e(R,Ea),e(R,Jt),e(Jt,xa),e(R,Pa),e(R,P),e(P,pt),e(pt,Ma),e(P,ja),e(P,Yt),e(Yt,za),e(P,La),e(P,Kt),e(Kt,Da),e(P,Ia),e(P,Qt),e(Qt,Fa),e(P,qa),e(P,eo),e(eo,Aa),e(P,Va),e(P,Se),e(Se,to),e(to,Na),e(Se,Sa),e(P,Wa),e(P,ut),e(ut,Ba),e(P,Ha),e(R,Ga),e(R,ce),k(We,ce,null),e(ce,Xa),e(ce,V),e(V,Ua),e(V,oo),e(oo,Za),e(V,Ja),e(V,ro),e(ro,Ya),e(V,Ka),e(V,ao),e(ao,Qa),e(V,es),e(R,ts),e(R,X),k(Be,X,null),e(X,os),e(X,so),e(so,rs),e(X,as),k(me,X,null),e(R,ss),e(R,U),k(He,U,null),e(U,ns),e(U,Ge),e(Ge,is),e(Ge,gt),e(gt,ls),e(Ge,ds),e(U,cs),k(he,U,null),e(R,ms),e(R,fe),k(Xe,fe,null),e(fe,hs),e(fe,Ue),e(Ue,fs),e(Ue,_t),e(_t,ps),e(Ue,us),e(R,gs),e(R,pe),k(Ze,pe,null),e(pe,_s),e(pe,Je),e(Je,vs),e(Je,vt),e(vt,Ts),e(Je,bs),f(t,jo,d),f(t,ee,d),e(ee,ue),e(ue,no),k(Ye,no,null),e(ee,Cs),e(ee,io),e(io,ws),f(t,zo,d),f(t,q,d),k(Ke,q,null),e(q,ks),e(q,N),e(N,Os),e(N,Tt),e(Tt,$s),e(N,ys),e(N,lo),e(lo,Rs),e(N,Es),e(N,bt),e(bt,xs),e(N,Ps),e(q,Ms),e(q,Qe),e(Qe,js),e(Qe,et),e(et,zs),e(Qe,Ls),e(q,Ds),e(q,ge),k(tt,ge,null),e(ge,Is),k(_e,ge,null),Lo=!0},p(t,[d]){const ot={};d&2&&(ot.$$scope={dirty:d,ctx:t}),le.$set(ot);const co={};d&2&&(co.$$scope={dirty:d,ctx:t}),me.$set(co);const mo={};d&2&&(mo.$$scope={dirty:d,ctx:t}),he.$set(mo);const ho={};d&2&&(ho.$$scope={dirty:d,ctx:t}),_e.$set(ho)},i(t){Lo||(O(h.$$.fragment,t),O(ke.$$.fragment,t),O(Le.$$.fragment,t),O(De.$$.fragment,t),O(Fe.$$.fragment,t),O(qe.$$.fragment,t),O(le.$$.fragment,t),O(Ve.$$.fragment,t),O(Ne.$$.fragment,t),O(We.$$.fragment,t),O(Be.$$.fragment,t),O(me.$$.fragment,t),O(He.$$.fragment,t),O(he.$$.fragment,t),O(Xe.$$.fragment,t),O(Ze.$$.fragment,t),O(Ye.$$.fragment,t),O(Ke.$$.fragment,t),O(tt.$$.fragment,t),O(_e.$$.fragment,t),Lo=!0)},o(t){$(h.$$.fragment,t),$(ke.$$.fragment,t),$(Le.$$.fragment,t),$(De.$$.fragment,t),$(Fe.$$.fragment,t),$(qe.$$.fragment,t),$(le.$$.fragment,t),$(Ve.$$.fragment,t),$(Ne.$$.fragment,t),$(We.$$.fragment,t),$(Be.$$.fragment,t),$(me.$$.fragment,t),$(He.$$.fragment,t),$(he.$$.fragment,t),$(Xe.$$.fragment,t),$(Ze.$$.fragment,t),$(Ye.$$.fragment,t),$(Ke.$$.fragment,t),$(tt.$$.fragment,t),$(_e.$$.fragment,t),Lo=!1},d(t){o(p),t&&o(E),t&&o(u),y(h),t&&o(b),t&&o(z),y(ke),t&&o(fo),t&&o(W),t&&o(po),t&&o(rt),t&&o(uo),t&&o(at),t&&o(go),t&&o(oe),t&&o(_o),t&&o(re),t&&o(vo),t&&o(ae),t&&o(To),t&&o(B),t&&o(bo),t&&o(nt),t&&o(Co),t&&o(H),t&&o(wo),t&&o(Z),y(Le),t&&o(ko),t&&o(G),t&&o(Oo),t&&o(v),t&&o($o),t&&o(ct),t&&o(yo),y(De,t),t&&o(Ro),t&&o(ne),t&&o(Eo),t&&o(J),y(Fe),t&&o(xo),t&&o(F),y(qe),y(le),t&&o(Po),t&&o(Q),y(Ve),t&&o(Mo),t&&o(R),y(Ne),y(We),y(Be),y(me),y(He),y(he),y(Xe),y(Ze),t&&o(jo),t&&o(ee),y(Ye),t&&o(zo),t&&o(q),y(Ke),y(tt),y(_e)}}}const pi={local:"trocr",sections:[{local:"overview",title:"Overview"},{local:"inference",title:"Inference"},{local:"transformers.TrOCRConfig",title:"TrOCRConfig"},{local:"transformers.TrOCRProcessor",title:"TrOCRProcessor"},{local:"transformers.TrOCRForCausalLM",title:"TrOCRForCausalLM"}],title:"TrOCR"};function ui(S){return li(()=>{new URLSearchParams(window.location.search).get("fw")}),[]}class wi extends ri{constructor(p){super();ai(this,p,ui,fi,si,{})}}export{wi as default,pi as metadata};
