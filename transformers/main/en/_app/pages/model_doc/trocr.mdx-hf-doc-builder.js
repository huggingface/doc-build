import{S as ri,i as ai,s as si,e as s,k as c,w as C,t as r,M as ni,c as n,d as o,m,a as i,x as w,h as a,b as l,N as ii,G as e,g as f,y as k,q as $,o as O,B as y,v as li,L as oi}from"../../chunks/vendor-hf-doc-builder.js";import{T as ei}from"../../chunks/Tip-hf-doc-builder.js";import{D as te}from"../../chunks/Docstring-hf-doc-builder.js";import{C as As}from"../../chunks/CodeBlock-hf-doc-builder.js";import{I as xt}from"../../chunks/IconCopyLink-hf-doc-builder.js";import{E as ti}from"../../chunks/ExampleCodeBlock-hf-doc-builder.js";function di(S){let p,R,u,g,T;return g=new As({props:{code:`from transformers import TrOCRForCausalLM, TrOCRConfig
...
`),h=n(b,"CODE",{});var F=i(h);_=a(F,"from_pretrained"),F.forEach(o),D=a(b,` methods. Please refer to the docstrings of the
...
`),h=n(b,"CODE",{});var F=i(h);_=a(F,"save_pretrained"),F.forEach(o),D=a(b,`. Please refer to the docstrings of the methods
...
<span class="hljs-string">&#x27;industry, &quot; Mr. Brown commented icily. &quot; Let us have a&#x27;</span>`}}),{c(){p=s("p"),R=r("Example:"),u=c(),C(g.$$.fragment)},l(h){p=n(h,"P",{});var _=i(p);R=a(_,"Example:"),_.forEach(o),u=m(h),w(g.$$.fragment,h)},m(h,_){f(h,p,_),e(p,R),f(h,u,_),k(g,h,_),T=!0},p:oi,i(h){T||($(g.$$.fragment,h),T=!0)},o(h){O(g.$$.fragment,h),T=!1},d(h){h&&o(p),h&&o(u),y(g,h)}}}function fi(S){let p,R,u,g,T,h,_,D,j,b,z,F,Pt,ke,Qo,Mt,er,fo,W,tr,$e,or,rr,Oe,ar,sr,po,rt,nr,uo,at,jt,ir,go,oe,Is,_o,re,lr,st,dr,cr,vo,ae,mr,zt,hr,fr,To,B,pr,ye,ur,gr,Ee,_r,vr,bo,nt,Tr,Co,H,Re,br,xe,Cr,wr,kr,I,$r,Pe,Or,yr,Me,Er,Rr,je,xr,Pr,Mr,ze,jr,it,zr,Lr,wo,Z,se,Lt,Le,Fr,Ft,Dr,ko,G,qr,Dt,Ar,Ir,lt,Vr,Nr,$o,v,Sr,qt,Wr,Br,At,Hr,Gr,It,Xr,Ur,Vt,Zr,Jr,dt,Yr,Kr,Nt,Qr,ea,St,ta,oa,Wt,ra,aa,Bt,sa,na,Oo,ct,Ht,ia,yo,Fe,Eo,ne,la,De,da,ca,Ro,J,ie,Gt,qe,ma,Xt,ha,xo,q,Ae,fa,Y,pa,mt,ua,ga,Ie,_a,va,Ta,K,ba,ht,Ca,wa,ft,ka,$a,Oa,le,Po,Q,de,Ut,Ve,ya,Zt,Ea,Mo,E,Ne,Ra,Jt,xa,Pa,P,pt,Ma,ja,Yt,za,La,Kt,Fa,Da,Qt,qa,Aa,eo,Ia,Va,Se,to,Na,Sa,Wa,ut,Ba,Ha,Ga,ce,We,Xa,V,Ua,oo,Za,Ja,ro,Ya,Ka,ao,Qa,es,ts,X,Be,os,so,rs,as,me,ss,U,He,ns,Ge,is,gt,ls,ds,cs,he,ms,fe,Xe,hs,Ue,fs,_t,ps,us,gs,pe,Ze,_s,Je,vs,vt,Ts,bs,jo,ee,ue,no,Ye,Cs,io,ws,zo,A,Ke,ks,N,$s,Tt,Os,ys,lo,Es,Rs,bt,xs,Ps,Ms,Qe,js,et,zs,Ls,Fs,ge,tt,Ds,_e,Lo;return h=new xt({}),ke=new xt({}),Le=new xt({}),Fe=new As({props:{code:`from transformers import TrOCRProcessor, VisionEncoderDecoderModel
import requests 
from PIL import Image
...
`}}),_e=new ti({props:{anchor:"transformers.TrOCRForCausalLM.forward.example",$$slots:{default:[hi]},$$scope:{ctx:S}}}),{c(){p=s("meta"),R=c(),u=s("h1"),g=s("a"),T=s("span"),C(h.$$.fragment),_=c(),D=s("span"),j=r("TrOCR"),b=c(),z=s("h2"),F=s("a"),Pt=s("span"),C(ke.$$.fragment),Qo=c(),Mt=s("span"),er=r("Overview"),fo=c(),W=s("p"),tr=r("The TrOCR model was proposed in "),$e=s("a"),or=r(`TrOCR: Transformer-based Optical Character Recognition with Pre-trained
...
`),Ee=s("a"),_r=r("here"),vr=r("."),bo=c(),nt=s("p"),Tr=r("Tips:"),Co=c(),H=s("ul"),Re=s("li"),br=r("The quickest way to get started with TrOCR is by checking the "),xe=s("a"),Cr=r(`tutorial
...
into a single instance to both extract the input features and decode the predicted token ids.`),Oo=c(),ct=s("ul"),Ht=s("li"),ia=r("Step-by-step Optical Character Recognition (OCR)"),yo=c(),C(Fe.$$.fragment),Eo=c(),ne=s("p"),la=r("See the "),De=s("a"),da=r("model hub"),ca=r(" to look for TrOCR checkpoints."),Ro=c(),J=s("h2"),ie=s("a"),Gt=s("span"),C(qe.$$.fragment),ma=c(),Xt=s("span"),ha=r("TrOCRConfig"),xo=c(),q=s("div"),C(Ae.$$.fragment),fa=c(),Y=s("p"),pa=r("This is the configuration class to store the configuration of a "),mt=s("a"),ua=r("TrOCRForCausalLM"),ga=r(`. It is used to instantiate an
...
more information.`),L.forEach(o),Ga=m(M),ce=n(M,"DIV",{class:!0});var Bo=i(ce);w(We.$$.fragment,Bo),Xa=m(Bo),V=n(Bo,"P",{});var be=i(V);Ua=a(be,`When used in normal mode, this method forwards all its arguments to AutoFeatureExtractor\u2019s
...
`),ao=n(be,"CODE",{});var Sn=i(ao);Qa=a(Sn,"__call__"),Sn.forEach(o),es=a(be,". Please refer to the doctsring of the above two methods for more information."),be.forEach(o),Bo.forEach(o),ts=m(M),X=n(M,"DIV",{class:!0});var Et=i(X);w(Be.$$.fragment,Et),os=m(Et),so=n(Et,"P",{});var Wn=i(so);rs=a(Wn,"Instantiate a processor associated with a pretrained model."),Wn.forEach(o),as=m(Et),w(me.$$.fragment,Et),Et.forEach(o),ss=m(M),U=n(M,"DIV",{class:!0});var Rt=i(U);w(He.$$.fragment,Rt),ns=m(Rt),Ge=n(Rt,"P",{});var Ho=i(Ge);is=a(Ho,`Saves the attributes of this processor (feature extractor, tokenizer\u2026) in the specified directory so that it
