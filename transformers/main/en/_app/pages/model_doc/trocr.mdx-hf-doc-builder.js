...
<span class="hljs-string">&#x27;industry, &quot; Mr. Brown commented icily. &quot; Let us have a&#x27;</span>`}}),{c(){p=s("p"),E=r("Example:"),u=c(),C(g.$$.fragment)},l(m){p=n(m,"P",{});var _=i(p);E=a(_,"Example:"),_.forEach(o),u=h(m),w(g.$$.fragment,m)},m(m,_){f(m,p,_),e(p,E),f(m,u,_),k(g,m,_),T=!0},p:oi,i(m){T||(O(g.$$.fragment,m),T=!0)},o(m){$(g.$$.fragment,m),T=!1},d(m){m&&o(p),m&&o(u),y(g,m)}}}function fi(S){let p,E,u,g,T,m,_,D,j,b,z,F,Pt,ke,Qo,Mt,er,fo,W,tr,Oe,or,rr,$e,ar,sr,po,rt,nr,uo,at,jt,ir,go,oe,Is,_o,re,lr,st,dr,cr,vo,ae,hr,zt,mr,fr,To,H,pr,ye,ur,gr,Re,_r,vr,bo,nt,Tr,Co,B,Ee,br,xe,Cr,wr,kr,I,Or,Pe,$r,yr,Me,Rr,Er,je,xr,Pr,Mr,ze,jr,it,zr,Lr,wo,Z,se,Lt,Le,Fr,Ft,Dr,ko,G,qr,Dt,Ar,Ir,lt,Vr,Nr,Oo,v,Sr,qt,Wr,Hr,At,Br,Gr,It,Xr,Ur,Vt,Zr,Jr,dt,Yr,Kr,Nt,Qr,ea,St,ta,oa,Wt,ra,aa,Ht,sa,na,$o,ct,Bt,ia,yo,Fe,Ro,ne,la,De,da,ca,Eo,J,ie,Gt,qe,ha,Xt,ma,xo,q,Ae,fa,Y,pa,ht,ua,ga,Ie,_a,va,Ta,K,ba,mt,Ca,wa,ft,ka,Oa,$a,le,Po,Q,de,Ut,Ve,ya,Zt,Ra,Mo,R,Ne,Ea,Jt,xa,Pa,P,pt,Ma,ja,Yt,za,La,Kt,Fa,Da,Qt,qa,Aa,eo,Ia,Va,Se,to,Na,Sa,Wa,ut,Ha,Ba,Ga,ce,We,Xa,V,Ua,oo,Za,Ja,ro,Ya,Ka,ao,Qa,es,ts,X,He,os,so,rs,as,he,ss,U,Be,ns,Ge,is,gt,ls,ds,cs,me,hs,fe,Xe,ms,Ue,fs,_t,ps,us,gs,pe,Ze,_s,Je,vs,vt,Ts,bs,jo,ee,ue,no,Ye,Cs,io,ws,zo,A,Ke,ks,N,Os,Tt,$s,ys,lo,Rs,Es,bt,xs,Ps,Ms,Qe,js,et,zs,Ls,Fs,ge,tt,Ds,_e,Lo;return m=new xt({}),ke=new xt({}),Le=new xt({}),Fe=new As({props:{code:`from transformers import TrOCRProcessor, VisionEncoderDecoderModel
import requests 
from PIL import Image
...
tasks.`),go=c(),oe=s("img"),_o=c(),re=s("small"),lr=r("TrOCR architecture. Taken from the "),st=s("a"),dr=r("original paper"),cr=r("."),vo=c(),ae=s("p"),hr=r("Please refer to the "),zt=s("code"),mr=r("VisionEncoderDecoder"),fr=r(" class on how to use this model."),To=c(),H=s("p"),pr=r("This model was contributed by "),ye=s("a"),ur=r("nielsr"),gr=r(`. The original code can be found
...
into a single instance to both extract the input features and decode the predicted token ids.`),$o=c(),ct=s("ul"),Bt=s("li"),ia=r("Step-by-step Optical Character Recognition (OCR)"),yo=c(),C(Fe.$$.fragment),Ro=c(),ne=s("p"),la=r("See the "),De=s("a"),da=r("model hub"),ca=r(" to look for TrOCR checkpoints."),Eo=c(),J=s("h2"),ie=s("a"),Gt=s("span"),C(qe.$$.fragment),ha=c(),Xt=s("span"),ma=r("TrOCRConfig"),xo=c(),q=s("div"),C(Ae.$$.fragment),fa=c(),Y=s("p"),pa=r("This is the configuration class to store the configuration of a "),ht=s("a"),ua=r("TrOCRForCausalLM"),ga=r(`. It is used to instantiate an
...
`),ao=s("code"),Qa=r("~TrOCRTokenizer.__call__"),es=r(". Please refer to the doctsring of the above two methods for more information."),ts=c(),X=s("div"),C(He.$$.fragment),os=c(),so=s("p"),rs=r("Instantiate a processor associated with a pretrained model."),as=c(),C(he.$$.fragment),ss=c(),U=s("div"),C(Be.$$.fragment),ns=c(),Ge=s("p"),is=r(`Saves the attributes of this processor (feature extractor, tokenizer\u2026) in the specified directory so that it
...
more information.`),L.forEach(o),Ga=h(M),ce=n(M,"DIV",{class:!0});var Ho=i(ce);w(We.$$.fragment,Ho),Xa=h(Ho),V=n(Ho,"P",{});var be=i(V);Ua=a(be,`When used in normal mode, this method forwards all its arguments to AutoFeatureExtractor\u2019s
...
`),ao=n(be,"CODE",{});var Sn=i(ao);Qa=a(Sn,"~TrOCRTokenizer.__call__"),Sn.forEach(o),es=a(be,". Please refer to the doctsring of the above two methods for more information."),be.forEach(o),Ho.forEach(o),ts=h(M),X=n(M,"DIV",{class:!0});var Rt=i(X);w(He.$$.fragment,Rt),os=h(Rt),so=n(Rt,"P",{});var Wn=i(so);rs=a(Wn,"Instantiate a processor associated with a pretrained model."),Wn.forEach(o),as=h(Rt),w(he.$$.fragment,Rt),Rt.forEach(o),ss=h(M),U=n(M,"DIV",{class:!0});var Et=i(U);w(Be.$$.fragment,Et),ns=h(Et),Ge=n(Et,"P",{});var Bo=i(Ge);is=a(Bo,`Saves the attributes of this processor (feature extractor, tokenizer\u2026) in the specified directory so that it
can be reloaded using the `),gt=n(Bo,"A",{href:!0});var Hn=i(gt);ls=a(Hn,"from_pretrained()"),Hn.forEach(o),ds=a(Bo," method."),Bo.forEach(o),cs=h(Et),w(me.$$.fragment,Et),Et.forEach(o),hs=h(M),fe=n(M,"DIV",{class:!0});var Go=i(fe);w(Xe.$$.fragment,Go),ms=h(Go),Ue=n(Go,"P",{});var Xo=i(Ue);fs=a(Xo,"This method forwards all its arguments to TrOCRTokenizer\u2019s "),_t=n(Xo,"A",{href:!0});var Bn=i(_t);ps=a(Bn,"batch_decode()"),Bn.forEach(o),us=a(Xo,`. Please refer
