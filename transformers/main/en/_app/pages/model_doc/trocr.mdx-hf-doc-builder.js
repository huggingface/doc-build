import{S as ri,i as ai,s as si,e as s,k as c,w as C,t as r,M as ni,c as n,d as o,m as h,a as i,x as w,h as a,b as l,N as ii,G as e,g as f,y as k,q as $,o as O,B as E,v as li,L as oi}from"../../chunks/vendor-hf-doc-builder.js";import{T as ei}from"../../chunks/Tip-hf-doc-builder.js";import{D as te}from"../../chunks/Docstring-hf-doc-builder.js";import{C as As}from"../../chunks/CodeBlock-hf-doc-builder.js";import{I as xt}from"../../chunks/IconCopyLink-hf-doc-builder.js";import{E as ti}from"../../chunks/ExampleCodeBlock-hf-doc-builder.js";function di(S){let p,R,u,g,T;return g=new As({props:{code:`from transformers import TrOCRForCausalLM, TrOCRConfig
...
<span class="hljs-string">&#x27;industry, &quot; Mr. Brown commented icily. &quot; Let us have a&#x27;</span>`}}),{c(){p=s("p"),R=r("Example:"),u=c(),C(g.$$.fragment)},l(m){p=n(m,"P",{});var _=i(p);R=a(_,"Example:"),_.forEach(o),u=h(m),w(g.$$.fragment,m)},m(m,_){f(m,p,_),e(p,R),f(m,u,_),k(g,m,_),T=!0},p:oi,i(m){T||($(g.$$.fragment,m),T=!0)},o(m){O(g.$$.fragment,m),T=!1},d(m){m&&o(p),m&&o(u),E(g,m)}}}function fi(S){let p,R,u,g,T,m,_,D,j,b,L,F,Pt,ke,Qo,Mt,er,fo,W,tr,$e,or,rr,Oe,ar,sr,po,rt,nr,uo,at,jt,ir,go,oe,Is,_o,re,lr,st,dr,cr,vo,ae,hr,Lt,mr,fr,To,H,pr,Ee,ur,gr,ye,_r,vr,bo,nt,Tr,Co,B,Re,br,xe,Cr,wr,kr,I,$r,Pe,Or,Er,Me,yr,Rr,je,xr,Pr,Mr,Le,jr,it,Lr,zr,wo,Z,se,zt,ze,Fr,Ft,Dr,ko,G,qr,Dt,Ar,Ir,lt,Vr,Nr,$o,v,Sr,qt,Wr,Hr,At,Br,Gr,It,Xr,Ur,Vt,Zr,Jr,dt,Yr,Kr,Nt,Qr,ea,St,ta,oa,Wt,ra,aa,Ht,sa,na,Oo,ct,Bt,ia,Eo,Fe,yo,ne,la,De,da,ca,Ro,J,ie,Gt,qe,ha,Xt,ma,xo,q,Ae,fa,Y,pa,ht,ua,ga,Ie,_a,va,Ta,K,ba,mt,Ca,wa,ft,ka,$a,Oa,le,Po,Q,de,Ut,Ve,Ea,Zt,ya,Mo,y,Ne,Ra,Jt,xa,Pa,P,pt,Ma,ja,Yt,La,za,Kt,Fa,Da,Qt,qa,Aa,eo,Ia,Va,Se,to,Na,Sa,Wa,ut,Ha,Ba,Ga,ce,We,Xa,V,Ua,oo,Za,Ja,ro,Ya,Ka,ao,Qa,es,ts,X,He,os,so,rs,as,he,ss,U,Be,ns,Ge,is,gt,ls,ds,cs,me,hs,fe,Xe,ms,Ue,fs,_t,ps,us,gs,pe,Ze,_s,Je,vs,vt,Ts,bs,jo,ee,ue,no,Ye,Cs,io,ws,Lo,A,Ke,ks,N,$s,Tt,Os,Es,lo,ys,Rs,bt,xs,Ps,Ms,Qe,js,et,Ls,zs,Fs,ge,tt,Ds,_e,zo;return m=new xt({}),ke=new xt({}),ze=new xt({}),Fe=new As({props:{code:`from transformers import TrOCRProcessor, VisionEncoderDecoderModel
import requests 
from PIL import Image
...
tasks.`),go=c(),oe=s("img"),_o=c(),re=s("small"),lr=r("TrOCR architecture. Taken from the "),st=s("a"),dr=r("original paper"),cr=r("."),vo=c(),ae=s("p"),hr=r("Please refer to the "),Lt=s("code"),mr=r("VisionEncoderDecoder"),fr=r(" class on how to use this model."),To=c(),H=s("p"),pr=r("This model was contributed by "),Ee=s("a"),ur=r("nielsr"),gr=r(`. The original code can be found
`),ye=s("a"),_r=r("here"),vr=r("."),bo=c(),nt=s("p"),Tr=r("Tips:"),Co=c(),B=s("ul"),Re=s("li"),br=r("The quickest way to get started with TrOCR is by checking the "),xe=s("a"),Cr=r(`tutorial
...
into a single instance to both extract the input features and decode the predicted token ids.`),Oo=c(),ct=s("ul"),Bt=s("li"),ia=r("Step-by-step Optical Character Recognition (OCR)"),Eo=c(),C(Fe.$$.fragment),yo=c(),ne=s("p"),la=r("See the "),De=s("a"),da=r("model hub"),ca=r(" to look for TrOCR checkpoints."),Ro=c(),J=s("h2"),ie=s("a"),Gt=s("span"),C(qe.$$.fragment),ha=c(),Xt=s("span"),ma=r("TrOCRConfig"),xo=c(),q=s("div"),C(Ae.$$.fragment),fa=c(),Y=s("p"),pa=r("This is the configuration class to store the configuration of a "),ht=s("a"),ua=r("TrOCRForCausalLM"),ga=r(`. It is used to instantiate an
...
`),ao=n(be,"CODE",{});var Sn=i(ao);Qa=a(Sn,"__call__"),Sn.forEach(o),es=a(be,". Please refer to the doctsring of the above two methods for more information."),be.forEach(o),Ho.forEach(o),ts=h(M),X=n(M,"DIV",{class:!0});var yt=i(X);w(He.$$.fragment,yt),os=h(yt),so=n(yt,"P",{});var Wn=i(so);rs=a(Wn,"Instantiate a processor associated with a pretrained model."),Wn.forEach(o),as=h(yt),w(he.$$.fragment,yt),yt.forEach(o),ss=h(M),U=n(M,"DIV",{class:!0});var Rt=i(U);w(Be.$$.fragment,Rt),ns=h(Rt),Ge=n(Rt,"P",{});var Bo=i(Ge);is=a(Bo,`Saves the attributes of this processor (feature extractor, tokenizer\u2026) in the specified directory so that it
