...
`),oe=s(R,"CODE",{});var kt=a(oe);H=i(kt,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),kt.forEach(t),R.forEach(t),I.forEach(t)},m(y,q){u(y,h,q),e(h,z),u(y,b,q),u(y,T,q),e(T,x),e(x,w),e(T,P),e(T,$),e($,Oe),u(y,me,q),u(y,F,q),e(F,we),e(F,ae),e(ae,Ae),e(F,re),e(F,ie),e(ie,Ie),e(F,Me),u(y,D,q),u(y,O,q),e(O,xe),u(y,K,q),u(y,C,q),e(C,S),e(S,Le),e(S,Y),e(Y,ee),e(S,Ne),e(S,U),e(U,Ge),e(C,De),e(C,A),e(A,ge),e(A,de),e(de,je),e(A,te),e(A,V),e(V,Ue),e(C,Be),e(C,B),e(B,We),e(B,oe),e(oe,H)},d(y){y&&t(h),y&&t(b),y&&t(T),y&&t(me),y&&t(F),y&&t(D),y&&t(O),y&&t(K),y&&t(C)}}}function Gk(G){let h,z,b,T,x;return{c(){h=n("p"),z=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),b=n("code"),T=r("Module"),x=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(w){h=s(w,"P",{});var P=a(h);z=i(P,"Although the recipe for forward pass needs to be defined within this function, one should call the "),b=s(P,"CODE",{});var $=a(b);T=i($,"Module"),$.forEach(t),x=i(P,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),P.forEach(t)},m(w,P){u(w,h,P),e(h,z),e(h,b),e(b,T),e(h,x)},d(w){w&&t(h)}}}function Dk(G){let h,z,b,T,x,w,P,$,Oe,me,F,we,ae,Ae,re,ie,Ie,Me,D,O,xe,K,C,S,Le,Y,ee,Ne,U,Ge,De,A,ge,de,je,te,V,Ue,Be,B,We,oe,H;return{c(){h=n("p"),z=r("TF 2.0 models accepts two formats as inputs:"),b=d(),T=n("ul"),x=n("li"),w=r("having all inputs as keyword arguments (like PyTorch models), or"),P=d(),$=n("li"),Oe=r("having all inputs as a list, tuple or dict in the first positional arguments."),me=d(),F=n("p"),we=r("This second option is useful when using "),ae=n("code"),Ae=r("tf.keras.Model.fit"),re=r(` method which currently requires having all the
tensors in the first argument of the model call function: `),ie=n("code"),Ie=r("model(inputs)"),Me=r("."),D=d(),O=n("p"),xe=r(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),K=d(),C=n("ul"),S=n("li"),Le=r("a single Tensor with "),Y=n("code"),ee=r("input_ids"),Ne=r(" only and nothing else: "),U=n("code"),Ge=r("model(input_ids)"),De=d(),A=n("li"),ge=r(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),de=n("code"),je=r("model([input_ids, attention_mask])"),te=r(" or "),V=n("code"),Ue=r("model([input_ids, attention_mask, token_type_ids])"),Be=d(),B=n("li"),We=r(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),oe=n("code"),H=r('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(y){h=s(y,"P",{});var q=a(h);z=i(q,"TF 2.0 models accepts two formats as inputs:"),q.forEach(t),b=l(y),T=s(y,"UL",{});var ze=a(T);x=s(ze,"LI",{});var mt=a(x);w=i(mt,"having all inputs as keyword arguments (like PyTorch models), or"),mt.forEach(t),P=l(ze),$=s(ze,"LI",{});var $e=a($);Oe=i($e,"having all inputs as a list, tuple or dict in the first positional arguments."),$e.forEach(t),ze.forEach(t),me=l(y),F=s(y,"P",{});var Q=a(F);we=i(Q,"This second option is useful when using "),ae=s(Q,"CODE",{});var gt=a(ae);Ae=i(gt,"tf.keras.Model.fit"),gt.forEach(t),re=i(Q,` method which currently requires having all the
...
the latter silently ignores them.`)},l(w){h=s(w,"P",{});var P=a(h);z=i(P,"Although the recipe for forward pass needs to be defined within this function, one should call the "),b=s(P,"CODE",{});var $=a(b);T=i($,"Module"),$.forEach(t),x=i(P,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),P.forEach(t)},m(w,P){u(w,h,P),e(h,z),e(h,b),e(b,T),e(h,x)},d(w){w&&t(h)}}}function Hk(G){let h,z,b,T,x,w,P,$,Oe,me,F,we,ae,Ae,re,ie,Ie,Me,D,O,xe,K,C,S,Le,Y,ee,Ne,U,Ge,De,A,ge,de,je,te,V,Ue,Be,B,We,oe,H,y,q,ze,mt,$e,Q,gt,Ve,le,I,J,qe,ft,X,_t,Qe,R,kt,Fo,Yd,el,ca,tl,ol,Mi,fe,ua,nl,sl,pa,al,rl,ha,il,dl,Eo,ll,Mo,cl,ul,pl,Wt,jo,hl,ml,Co,gl,fl,ji,vt,Ht,ma,So,_l,ga,kl,Ci,Je,Rt,Oo,vl,yl,Ao,bl,Tl,Pl,fa,wl,xl,_a,zl,Si,yt,Kt,ka,Io,$l,va,ql,Oi,_e,ya,ba,Fl,El,Ta,xs,Ml,zs,jl,Cl,Lo,Pa,Sl,Ol,bt,wa,Al,Il,xa,Ll,Nl,No,Gl,za,Dl,Ul,Bl,$a,He,Wl,qa,Hl,Rl,Fa,Kl,Vl,Ea,Ql,Jl,Xl,Ma,Tt,Zl,Go,Yl,ec,ja,tc,oc,Ai,Pt,Vt,Ca,Do,nc,Sa,sc,Ii,Uo,Li,wt,Qt,Oa,Bo,ac,Aa,rc,Ni,ce,Wo,ic,xt,dc,$s,lc,cc,Ho,uc,pc,hc,zt,mc,qs,gc,fc,Fs,_c,kc,vc,Ia,yc,bc,Ro,Gi,$t,Jt,La,Ko,Tc,Na,Pc,Di,Xt,wc,Ga,xc,zc,Ui,W,Vo,$c,Qo,qc,Jo,Fc,Ec,Mc,Xo,jc,Es,Cc,Sc,Oc,Ce,Zo,Ac,Yo,Ic,Da,Lc,Nc,Gc,en,Ms,Dc,Ua,Uc,Bc,tn,Wc,Ba,Hc,Rc,Kc,Wa,Vc,Qc,Zt,on,Jc,Ha,Xc,Zc,Yt,nn,Yc,Ra,eu,tu,eo,sn,ou,Ka,nu,Bi,qt,to,Va,an,su,Qa,au,Wi,ue,rn,ru,Ft,iu,Ja,du,lu,dn,cu,uu,pu,ln,hu,js,mu,gu,fu,Xe,cn,_u,Xa,ku,vu,un,Cs,yu,Za,bu,Tu,pn,Pu,Ya,wu,xu,zu,oo,hn,$u,er,qu,Hi,Et,no,tr,mn,Fu,or,Eu,Ri,Fe,gn,Mu,fn,ju,Ss,Cu,Su,Ou,_n,Au,kn,Iu,Lu,Nu,ke,vn,Gu,Mt,Du,Os,Uu,Bu,nr,Wu,Hu,Ru,so,Ku,sr,Vu,Qu,yn,Ki,jt,ao,ar,bn,Ju,rr,Xu,Vi,Ee,Tn,Zu,Pn,Yu,As,ep,tp,op,wn,np,xn,sp,ap,rp,ve,zn,ip,Ct,dp,Is,lp,cp,ir,up,pp,hp,ro,mp,dr,gp,fp,$n,Qi,St,io,lr,qn,_p,cr,kp,Ji,Ot,Fn,vp,Ze,En,yp,ur,bp,Tp,Mn,Xi,At,lo,pr,jn,Pp,hr,wp,Zi,pe,Cn,xp,Sn,zp,Ls,$p,qp,Fp,On,Ep,An,Mp,jp,Cp,co,Sp,ye,In,Op,It,Ap,Ns,Ip,Lp,mr,Np,Gp,Dp,uo,Up,gr,Bp,Wp,Ln,Yi,Lt,po,fr,Nn,Hp,_r,Rp,ed,he,Gn,Kp,Dn,Vp,Gs,Qp,Jp,Xp,Un,Zp,Bn,Yp,eh,th,ho,oh,be,Wn,nh,Nt,sh,Ds,ah,rh,kr,ih,dh,lh,mo,ch,vr,uh,ph,Hn,td,Gt,go,yr,Rn,hh,br,mh,od,L,Kn,gh,Vn,fh,Us,_h,kh,vh,Qn,yh,Jn,bh,Th,Ph,Tr,wh,xh,Re,Pr,Xn,zh,$h,wr,Zn,qh,Fh,xr,Yn,Eh,Mh,zr,es,jh,Ch,Te,ts,Sh,Dt,Oh,$r,Ah,Ih,qr,Lh,Nh,Gh,fo,Dh,Fr,Uh,Bh,os,Wh,Ye,ns,Hh,Er,Rh,Kh,ss,Vh,et,as,Qh,Mr,Jh,Xh,rs,nd,Ut,_o,jr,is,Zh,Cr,Yh,sd,N,ds,em,ls,tm,Bs,om,nm,sm,cs,am,us,rm,im,dm,Sr,lm,cm,Ke,Or,ps,um,pm,Ar,hs,hm,mm,Ir,ms,gm,fm,Lr,gs,_m,km,E,fs,vm,Bt,ym,Nr,bm,Tm,Gr,Pm,wm,xm,ko,zm,Dr,$m,qm,Ur,Br,Wr,Hr,Fm,Em,Rr,Kr,Vr,Qr,Mm,jm,Jr,Xr,Zr,Yr,Cm,Sm,ei,ti,_s,vo,yo,oi,ks,Om,ni,Am,Im,si,Lm,Nm,ai,Gm,Dm,ri,ii,di,li,Um,Bm,ci,ui,pi,hi,Wm,Hm,mi,gi,fi,_i,Rm,Km,ki,vi,yi,bi,Vm,Qm,tt,vs,Jm,Ti,Xm,Zm,ys,Ym,ot,bs,eg,Pi,tg,og,Ts,ad;return w=new Z({}),K=new Z({}),qe=new Z({}),So=new Z({}),Io=new Z({}),Do=new Z({}),Uo=new Se({props:{code:`from transformers import PegasusForConditionalGeneration, PegasusTokenizer
import torch
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/main/en/main_classes/model#transformers.TFPreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),ho=new qo({props:{$$slots:{default:[Dk]},$$scope:{ctx:G}}}),Wn=new M({props:{name:"call",anchor:"transformers.TFPegasusForConditionalGeneration.call",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"decoder_input_ids",val:" = None"},{name:"decoder_attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"decoder_head_mask",val:" = None"},{name:"cross_attn_head_mask",val:" = None"},{name:"encoder_outputs",val:": typing.Optional[transformers.modeling_tf_outputs.TFBaseModelOutput] = None"},{name:"past_key_values",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"decoder_inputs_embeds",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"},{name:"labels",val:" = None"},{name:"training",val:" = False"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/pegasus/modeling_tf_pegasus.py#L1279",parametersDescription:[{anchor:"transformers.TFPegasusForConditionalGeneration.call.input_ids",description:`<strong>input_ids</strong> (<code>tf.Tensor</code> of shape <code>({0})</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/main/en/model_doc/pegasus#transformers.PegasusTokenizer">PegasusTokenizer</a>. See <a href="/docs/transformers/main/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/main/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
