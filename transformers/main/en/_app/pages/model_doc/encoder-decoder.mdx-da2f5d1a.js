import{S as Di,i as zi,s as $i,e as a,k as c,w as f,t,M as ji,c as s,d as o,m as l,a as d,x as u,h as r,b as i,F as e,g as h,y as g,q as _,o as b,B as v,v as Fi}from"../../chunks/vendor-6b77c823.js";import{T as dd}from"../../chunks/Tip-39098574.js";import{D as O}from"../../chunks/Docstring-53452dc4.js";import{C as qe}from"../../chunks/CodeBlock-3a8b25a8.js";import{I as Rn}from"../../chunks/IconCopyLink-7a11ce68.js";function Pi(pe){let m,F,y,x,j;return{c(){m=a("p"),F=t("Although the recipe for forward pass needs to be defined within this function, one should call the "),y=a("code"),x=t("Module"),j=t(`
...
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),T.forEach(o)},m(k,T){h(k,m,T),e(m,F),e(m,y),e(y,x),e(m,j)},d(k){k&&o(m)}}}function Ai(pe){let m,F,y,x,j;return{c(){m=a("p"),F=t("Although the recipe for forward pass needs to be defined within this function, one should call the "),y=a("code"),x=t("Module"),j=t(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(k){m=s(k,"P",{});var T=d(m);F=r(T,"Although the recipe for forward pass needs to be defined within this function, one should call the "),y=s(T,"CODE",{});var P=d(y);x=r(P,"Module"),P.forEach(o),j=r(T,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),T.forEach(o)},m(k,T){h(k,m,T),e(m,F),e(m,y),e(y,x),e(m,j)},d(k){k&&o(m)}}}function Ci(pe){let m,F,y,x,j;return{c(){m=a("p"),F=t("Although the recipe for forward pass needs to be defined within this function, one should call the "),y=a("code"),x=t("Module"),j=t(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(k){m=s(k,"P",{});var T=d(m);F=r(T,"Although the recipe for forward pass needs to be defined within this function, one should call the "),y=s(T,"CODE",{});var P=d(y);x=r(P,"Module"),P.forEach(o),j=r(T,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),T.forEach(o)},m(k,T){h(k,m,T),e(m,F),e(m,y),e(y,x),e(m,j)},d(k){k&&o(m)}}}function Si(pe){let m,F,y,x,j,k,T,P,xt,Gn,me,qt,wo,Dt,zt,Un,he,$t,De,jt,Ft,Hn,fe,Pt,Eo,At,Ct,Yn,V,St,Mo,Nt,It,ze,Lt,Bt,Jn,W,Ot,sn,Vt,Wt,dn,Rt,Gt,Zn,$e,Kn,R,Ut,je,Ht,Yt,Fe,Jt,Zt,Qn,Q,ue,cn,Pe,Kt,ln,Qt,Xn,q,Ae,Xt,ge,xo,er,or,qo,nr,tr,rr,X,ar,Do,sr,dr,zo,ir,cr,lr,pn,pr,mr,Ce,hr,_e,Se,fr,Ne,ur,$o,gr,_r,br,be,Ie,vr,ee,yr,mn,kr,Tr,hn,wr,Er,et,oe,ve,fn,Le,Mr,un,xr,ot,w,Be,qr,ne,Dr,jo,zr,$r,Fo,jr,Fr,Pr,Oe,Ar,Ve,Cr,Sr,Nr,gn,Ir,Lr,We,Br,Po,Or,Vr,Wr,Re,Rr,Ge,Gr,Ur,Hr,G,Ao,Yr,Jr,_n,Zr,Kr,bn,Qr,Xr,ea,A,Ue,oa,te,na,Co,ta,ra,vn,aa,sa,da,ye,ia,yn,ca,la,He,pa,C,Ye,ma,kn,ha,fa,re,ua,Tn,ga,_a,wn,ba,va,ya,En,ka,Ta,Je,nt,ae,ke,Mn,Ze,wa,xn,Ea,tt,E,Ke,Ma,se,xa,So,qa,Da,No,za,$a,ja,Qe,Fa,Xe,Pa,Aa,Ca,qn,Sa,Na,eo,Ia,Io,La,Ba,Oa,oo,Va,no,Wa,Ra,Ga,U,Lo,Ua,Ha,Bo,Ya,Ja,Oo,Za,Ka,Qa,S,to,Xa,de,es,Vo,os,ns,Dn,ts,rs,as,Te,ss,zn,ds,is,ro,cs,L,ao,ls,$n,ps,ms,jn,hs,fs,so,rt,ie,we,Fn,io,us,Pn,gs,at,M,co,_s,ce,bs,Wo,vs,ys,Ro,ks,Ts,ws,lo,Es,po,Ms,xs,qs,An,Ds,zs,mo,$s,Go,js,Fs,Ps,ho,As,fo,Cs,Ss,Ns,H,Uo,Is,Ls,Cn,Bs,Os,Sn,Vs,Ws,Rs,N,uo,Gs,le,Us,Ho,Hs,Ys,Nn,Js,Zs,Ks,Ee,Qs,In,Xs,ed,go,od,B,_o,nd,Ln,td,rd,Bn,ad,sd,bo,st;return k=new Rn({}),$e=new qe({props:{code:`# a workaround to load from pytorch checkpoint
...
<span class="hljs-meta">&gt;&gt;&gt; </span>model.config = _model.config`}}),Pe=new Rn({}),Ae=new O({props:{name:"class transformers.EncoderDecoderConfig",anchor:"transformers.EncoderDecoderConfig",parameters:[{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.EncoderDecoderConfig.kwargs",description:`<strong>kwargs</strong> (<em>optional</em>) &#x2014;
...
</ul>`,name:"kwargs"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/encoder_decoder/configuration_encoder_decoder.py#L26"}}),Ce=new qe({props:{code:`from transformers import BertConfig, EncoderDecoderConfig, EncoderDecoderModel
...
</ul>`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/encoder_decoder/modeling_encoder_decoder.py#L429",returnDescription:`
<p>A <a
...
<span class="hljs-meta">&gt;&gt;&gt; </span>model = EncoderDecoderModel.from_pretrained(<span class="hljs-string">&quot;./bert2bert&quot;</span>)`}}),Ze=new Rn({}),Ke=new O({props:{name:"class transformers.TFEncoderDecoderModel",anchor:"transformers.TFEncoderDecoderModel",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.TFEncoderDecoderModel.config",description:`<strong>config</strong> (<a href="/docs/transformers/main/en/model_doc/encoder-decoder#transformers.EncoderDecoderConfig">EncoderDecoderConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/main/en/main_classes/model#transformers.TFPreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/encoder_decoder/modeling_tf_encoder_decoder.py#L186"}}),to=new O({props:{name:"call",anchor:"transformers.TFEncoderDecoderModel.call",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"decoder_input_ids",val:" = None"},{name:"decoder_attention_mask",val:" = None"},{name:"encoder_outputs",val:" = None"},{name:"past_key_values",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"decoder_inputs_embeds",val:" = None"},{name:"labels",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"},{name:"training",val:" = False"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.TFEncoderDecoderModel.call.input_ids",description:`<strong>input_ids</strong> (<code>np.ndarray</code>, <code>tf.Tensor</code>, <code>List[tf.Tensor]</code> \`<code>Dict[str, tf.Tensor]</code> or <code>Dict[str, np.ndarray]</code> and each example must have the shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/main/en/main_classes/tokenizer#transformers.PreTrainedTokenizer">PreTrainedTokenizer</a>. See <a href="/docs/transformers/main/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/main/en/model_doc/wav2vec2_phoneme#transformers.Wav2Vec2PhonemeCTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
</ul>`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/encoder_decoder/modeling_tf_encoder_decoder.py#L494",returnDescription:`
<p>A <a
...
<span class="hljs-meta">&gt;&gt;&gt; </span>model.save_pretrained(<span class="hljs-string">&quot;./bert2gpt2&quot;</span>)
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-comment"># load fine-tuned model</span>
<span class="hljs-meta">&gt;&gt;&gt; </span>model = TFEncoderDecoderModel.from_pretrained(<span class="hljs-string">&quot;./bert2gpt2&quot;</span>)`}}),io=new Rn({}),co=new O({props:{name:"class transformers.FlaxEncoderDecoderModel",anchor:"transformers.FlaxEncoderDecoderModel",parameters:[{name:"config",val:": EncoderDecoderConfig"},{name:"input_shape",val:": typing.Optional[typing.Tuple] = None"},{name:"seed",val:": int = 0"},{name:"dtype",val:": dtype = <class 'jax._src.numpy.lax_numpy.float32'>"},{name:"_do_init",val:": bool = True"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.FlaxEncoderDecoderModel.config",description:`<strong>config</strong> (<a href="/docs/transformers/main/en/model_doc/encoder-decoder#transformers.EncoderDecoderConfig">EncoderDecoderConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
...
If set to <code>True</code>, the model will return a <code>FlaxSeq2SeqLMOutput</code> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/encoder_decoder/modeling_flax_encoder_decoder.py#L627",returnDescription:`
<p>A <a
...
<span class="hljs-meta">&gt;&gt;&gt; </span>model.save_pretrained(<span class="hljs-string">&quot;./bert2gpt2&quot;</span>)
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-comment"># load fine-tuned model</span>
<span class="hljs-meta">&gt;&gt;&gt; </span>model = FlaxEncoderDecoderModel.from_pretrained(<span class="hljs-string">&quot;./bert2gpt2&quot;</span>)`}}),{c(){m=a("meta"),F=c(),y=a("h1"),x=a("a"),j=a("span"),f(k.$$.fragment),T=c(),P=a("span"),xt=t("Encoder Decoder Models"),Gn=c(),me=a("p"),qt=t("The "),wo=a("a"),Dt=t("EncoderDecoderModel"),zt=t(` can be used to initialize a sequence-to-sequence model with any
...
was shown in `),De=a("a"),jt=t("Leveraging Pre-trained Checkpoints for Sequence Generation Tasks"),Ft=t(` by
...
and decoder for a summarization model as was shown in: `),ze=a("a"),Lt=t("Text Summarization with Pretrained Encoders"),Bt=t(" by Yang Liu and Mirella Lapata."),Jn=c(),W=a("p"),Ot=t("The "),sn=a("code"),Vt=t("from_pretrained()"),Wt=t(` currently doesn\u2019t support initializing the model from a
...
were contributed by `),Fe=a("a"),Jt=t("ydshieh"),Zt=t("."),Qn=c(),Q=a("h2"),ue=a("a"),cn=a("span"),f(Pe.$$.fragment),Kt=c(),ln=a("span"),Qt=t("EncoderDecoderConfig"),Xn=c(),q=a("div"),f(Ae.$$.fragment),Xt=c(),ge=a("p"),xo=a("a"),er=t("EncoderDecoderConfig"),or=t(" is the configuration class to store the configuration of a "),qo=a("a"),nr=t("EncoderDecoderModel"),tr=t(`. It is
used to instantiate an Encoder Decoder model according to the specified arguments, defining the encoder and decoder
configs.`),rr=c(),X=a("p"),ar=t("Configuration objects inherit from "),Do=a("a"),sr=t("PretrainedConfig"),dr=t(` and can be used to control the model outputs. Read the
documentation from `),zo=a("a"),ir=t("PretrainedConfig"),cr=t(" for more information."),lr=c(),pn=a("p"),pr=t("Examples:"),mr=c(),f(Ce.$$.fragment),hr=c(),_e=a("div"),f(Se.$$.fragment),fr=c(),Ne=a("p"),ur=t("Instantiate a "),$o=a("a"),gr=t("EncoderDecoderConfig"),_r=t(` (or a derived class) from a pre-trained encoder model configuration and
decoder model configuration.`),br=c(),be=a("div"),f(Ie.$$.fragment),vr=c(),ee=a("p"),yr=t("Serializes this instance to a Python dictionary. Override the default "),mn=a("em"),kr=t("to_dict()"),Tr=t(" from "),hn=a("em"),wr=t("PretrainedConfig"),Er=t("."),et=c(),oe=a("h2"),ve=a("a"),fn=a("span"),f(Le.$$.fragment),Mr=c(),un=a("span"),xr=t("EncoderDecoderModel"),ot=c(),w=a("div"),f(Be.$$.fragment),qr=c(),ne=a("p"),Dr=t(`This class can be used to initialize a sequence-to-sequence model with any pretrained autoencoding model as the
encoder and any pretrained autoregressive model as the decoder. The encoder is loaded via
`),jo=a("a"),zr=t("from_pretrained()"),$r=t(" function and the decoder is loaded via "),Fo=a("a"),jr=t("from_pretrained()"),Fr=t(`
...
the model, you need to first set it back in training mode with `),wn=a("code"),ba=t("model.train()"),va=t("."),ya=c(),En=a("p"),ka=t("Example:"),Ta=c(),f(Je.$$.fragment),nt=c(),ae=a("h2"),ke=a("a"),Mn=a("span"),f(Ze.$$.fragment),wa=c(),xn=a("span"),Ea=t("TFEncoderDecoderModel"),tt=c(),E=a("div"),f(Ke.$$.fragment),Ma=c(),se=a("p"),xa=t(`This class can be used to initialize a sequence-to-sequence model with any pretrained autoencoding model as the
encoder and any pretrained autoregressive model as the decoder. The encoder is loaded via
`),So=a("a"),qa=t("from_pretrained()"),Da=t(" function and the decoder is loaded via "),No=a("a"),za=t("from_pretrained()"),$a=t(`
function. Cross-attention layers are automatically added to the decoder and should be fine-tuned on a downstream
...
Zhou, Wei Li, Peter J. Liu.`),Ca=c(),qn=a("p"),Sa=t(`After such an Encoder Decoder model has been trained/fine-tuned, it can be saved/loaded just like any other models
...
method for the decoder.`),Qa=c(),S=a("div"),f(to.$$.fragment),Xa=c(),de=a("p"),es=t("The "),Vo=a("a"),os=t("TFEncoderDecoderModel"),ns=t(" forward method, overrides the "),Dn=a("code"),ts=t("__call__"),rs=t(" special method."),as=c(),f(Te.$$.fragment),ss=c(),zn=a("p"),ds=t("Examples:"),is=c(),f(ro.$$.fragment),cs=c(),L=a("div"),f(ao.$$.fragment),ls=c(),$n=a("p"),ps=t(`Instantiate an encoder and a decoder from one or two base classes of the library from pretrained model
...
Tasks`),xs=t(` by Sascha Rothe, Shashi Narayan, Aliaksei Severyn. Michael Matena, Yanqi
Zhou, Wei Li, Peter J. Liu.`),qs=c(),An=a("p"),Ds=t(`After such an Encoder Decoder model has been trained/fine-tuned, it can be saved/loaded just like any other models
(see the examples for more information).`),zs=c(),mo=a("p"),$s=t("This model inherits from "),Go=a("a"),js=t("FlaxPreTrainedModel"),Fs=t(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
checkpoints.`),rd=c(),Bn=a("p"),ad=t("Example:"),sd=c(),f(bo.$$.fragment),this.h()},l(n){const p=ji('[data-svelte="svelte-1phssyn"]',document.head);m=s(p,"META",{name:!0,content:!0}),p.forEach(o),F=l(n),y=s(n,"H1",{class:!0});var vo=d(y);x=s(vo,"A",{id:!0,class:!0,href:!0});var On=d(x);j=s(On,"SPAN",{});var Vn=d(j);u(k.$$.fragment,Vn),Vn.forEach(o),On.forEach(o),T=l(vo),P=s(vo,"SPAN",{});var id=d(P);xt=r(id,"Encoder Decoder Models"),id.forEach(o),vo.forEach(o),Gn=l(n),me=s(n,"P",{});var dt=d(me);qt=r(dt,"The "),wo=s(dt,"A",{href:!0});var cd=d(wo);Dt=r(cd,"EncoderDecoderModel"),cd.forEach(o),zt=r(dt,` can be used to initialize a sequence-to-sequence model with any
...
was shown in `),De=s(it,"A",{href:!0,rel:!0});var ld=d(De);jt=r(ld,"Leveraging Pre-trained Checkpoints for Sequence Generation Tasks"),ld.forEach(o),Ft=r(it,` by
...
were contributed by `),Fe=s(Zo,"A",{href:!0,rel:!0});var _d=d(Fe);Jt=r(_d,"ydshieh"),_d.forEach(o),Zt=r(Zo,"."),Zo.forEach(o),Qn=l(n),Q=s(n,"H2",{class:!0});var lt=d(Q);ue=s(lt,"A",{id:!0,class:!0,href:!0});var bd=d(ue);cn=s(bd,"SPAN",{});var vd=d(cn);u(Pe.$$.fragment,vd),vd.forEach(o),bd.forEach(o),Kt=l(lt),ln=s(lt,"SPAN",{});var yd=d(ln);Qt=r(yd,"EncoderDecoderConfig"),yd.forEach(o),lt.forEach(o),Xn=l(n),q=s(n,"DIV",{class:!0});var I=d(q);u(Ae.$$.fragment,I),Xt=l(I),ge=s(I,"P",{});var Wn=d(ge);xo=s(Wn,"A",{href:!0});var kd=d(xo);er=r(kd,"EncoderDecoderConfig"),kd.forEach(o),or=r(Wn," is the configuration class to store the configuration of a "),qo=s(Wn,"A",{href:!0});var Td=d(qo);nr=r(Td,"EncoderDecoderModel"),Td.forEach(o),tr=r(Wn,`. It is
used to instantiate an Encoder Decoder model according to the specified arguments, defining the encoder and decoder
configs.`),Wn.forEach(o),rr=l(I),X=s(I,"P",{});var Ko=d(X);ar=r(Ko,"Configuration objects inherit from "),Do=s(Ko,"A",{href:!0});var wd=d(Do);sr=r(wd,"PretrainedConfig"),wd.forEach(o),dr=r(Ko,` and can be used to control the model outputs. Read the
documentation from `),zo=s(Ko,"A",{href:!0});var Ed=d(zo);ir=r(Ed,"PretrainedConfig"),Ed.forEach(o),cr=r(Ko," for more information."),Ko.forEach(o),lr=l(I),pn=s(I,"P",{});var Md=d(pn);pr=r(Md,"Examples:"),Md.forEach(o),mr=l(I),u(Ce.$$.fragment,I),hr=l(I),_e=s(I,"DIV",{class:!0});var pt=d(_e);u(Se.$$.fragment,pt),fr=l(pt),Ne=s(pt,"P",{});var mt=d(Ne);ur=r(mt,"Instantiate a "),$o=s(mt,"A",{href:!0});var xd=d($o);gr=r(xd,"EncoderDecoderConfig"),xd.forEach(o),_r=r(mt,` (or a derived class) from a pre-trained encoder model configuration and
decoder model configuration.`),mt.forEach(o),pt.forEach(o),br=l(I),be=s(I,"DIV",{class:!0});var ht=d(be);u(Ie.$$.fragment,ht),vr=l(ht),ee=s(ht,"P",{});var Qo=d(ee);yr=r(Qo,"Serializes this instance to a Python dictionary. Override the default "),mn=s(Qo,"EM",{});var qd=d(mn);kr=r(qd,"to_dict()"),qd.forEach(o),Tr=r(Qo," from "),hn=s(Qo,"EM",{});var Dd=d(hn);wr=r(Dd,"PretrainedConfig"),Dd.forEach(o),Er=r(Qo,"."),Qo.forEach(o),ht.forEach(o),I.forEach(o),et=l(n),oe=s(n,"H2",{class:!0});var ft=d(oe);ve=s(ft,"A",{id:!0,class:!0,href:!0});var zd=d(ve);fn=s(zd,"SPAN",{});var $d=d(fn);u(Le.$$.fragment,$d),$d.forEach(o),zd.forEach(o),Mr=l(ft),un=s(ft,"SPAN",{});var jd=d(un);xr=r(jd,"EncoderDecoderModel"),jd.forEach(o),ft.forEach(o),ot=l(n),w=s(n,"DIV",{class:!0});var D=d(w);u(Be.$$.fragment,D),qr=l(D),ne=s(D,"P",{});var Xo=d(ne);Dr=r(Xo,`This class can be used to initialize a sequence-to-sequence model with any pretrained autoencoding model as the
encoder and any pretrained autoregressive model as the decoder. The encoder is loaded via
...
function. Cross-attention layers are automatically added to the decoder and should be fine-tuned on a downstream
generative task, like summarization.`),Xo.forEach(o),Pr=l(D),Oe=s(D,"P",{});var ut=d(Oe);Ar=r(ut,`The effectiveness of initializing sequence-to-sequence models with pretrained checkpoints for sequence generation
...
Zhou, Wei Li, Peter J. Liu.`),ut.forEach(o),Nr=l(D),gn=s(D,"P",{});var Cd=d(gn);Ir=r(Cd,`After such an Encoder Decoder model has been trained/fine-tuned, it can be saved/loaded just like any other models
(see the examples for more information).`),Cd.forEach(o),Lr=l(D),We=s(D,"P",{});var gt=d(We);Br=r(gt,"This model inherits from "),Po=s(gt,"A",{href:!0});var Sd=d(Po);Or=r(Sd,"PreTrainedModel"),Sd.forEach(o),Vr=r(gt,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),gt.forEach(o),Wr=l(D),Re=s(D,"P",{});var _t=d(Re);Rr=r(_t,"This model is also a PyTorch "),Ge=s(_t,"A",{href:!0,rel:!0});var Nd=d(Ge);Gr=r(Nd,"torch.nn.Module"),Nd.forEach(o),Ur=r(_t,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),_t.forEach(o),Hr=l(D),G=s(D,"P",{});var yo=d(G);Ao=s(yo,"A",{href:!0});var Id=d(Ao);Yr=r(Id,"EncoderDecoderModel"),Id.forEach(o),Jr=r(yo,` is a generic model class that will be instantiated as a transformer architecture with one
of the base model classes of the library as encoder and another one as decoder when created with the
...
:meth`),bn=s(yo,"EM",{});var Bd=d(bn);Qr=r(Bd,"~transformers.AutoModelForCausalLM.from_pretrained"),Bd.forEach(o),Xr=r(yo," class method for the decoder."),yo.forEach(o),ea=l(D),A=s(D,"DIV",{class:!0});var Y=d(A);u(Ue.$$.fragment,Y),oa=l(Y),te=s(Y,"P",{});var en=d(te);na=r(en,"The "),Co=s(en,"A",{href:!0});var Od=d(Co);ta=r(Od,"EncoderDecoderModel"),Od.forEach(o),ra=r(en," forward method, overrides the "),vn=s(en,"CODE",{});var Vd=d(vn);aa=r(Vd,"__call__"),Vd.forEach(o),sa=r(en," special method."),en.forEach(o),da=l(Y),u(ye.$$.fragment,Y),ia=l(Y),yn=s(Y,"P",{});var Wd=d(yn);ca=r(Wd,"Examples:"),Wd.forEach(o),la=l(Y),u(He.$$.fragment,Y),Y.forEach(o),pa=l(D),C=s(D,"DIV",{class:!0});var J=d(C);u(Ye.$$.fragment,J),ma=l(J),kn=s(J,"P",{});var Rd=d(kn);ha=r(Rd,`Instantiate an encoder and a decoder from one or two base classes of the library from pretrained model
...
the model, you need to first set it back in training mode with `),wn=s(on,"CODE",{});var Ud=d(wn);ba=r(Ud,"model.train()"),Ud.forEach(o),va=r(on,"."),on.forEach(o),ya=l(J),En=s(J,"P",{});var Hd=d(En);ka=r(Hd,"Example:"),Hd.forEach(o),Ta=l(J),u(Je.$$.fragment,J),J.forEach(o),D.forEach(o),nt=l(n),ae=s(n,"H2",{class:!0});var bt=d(ae);ke=s(bt,"A",{id:!0,class:!0,href:!0});var Yd=d(ke);Mn=s(Yd,"SPAN",{});var Jd=d(Mn);u(Ze.$$.fragment,Jd),Jd.forEach(o),Yd.forEach(o),wa=l(bt),xn=s(bt,"SPAN",{});var Zd=d(xn);Ea=r(Zd,"TFEncoderDecoderModel"),Zd.forEach(o),bt.forEach(o),tt=l(n),E=s(n,"DIV",{class:!0});var z=d(E);u(Ke.$$.fragment,z),Ma=l(z),se=s(z,"P",{});var nn=d(se);xa=r(nn,`This class can be used to initialize a sequence-to-sequence model with any pretrained autoencoding model as the
encoder and any pretrained autoregressive model as the decoder. The encoder is loaded via
`),So=s(nn,"A",{href:!0});var Kd=d(So);qa=r(Kd,"from_pretrained()"),Kd.forEach(o),Da=r(nn," function and the decoder is loaded via "),No=s(nn,"A",{href:!0});var Qd=d(No);za=r(Qd,"from_pretrained()"),Qd.forEach(o),$a=r(nn,`
function. Cross-attention layers are automatically added to the decoder and should be fine-tuned on a downstream
generative task, like summarization.`),nn.forEach(o),ja=l(z),Qe=s(z,"P",{});var vt=d(Qe);Fa=r(vt,`The effectiveness of initializing sequence-to-sequence models with pretrained checkpoints for sequence generation
...
Zhou, Wei Li, Peter J. Liu.`),vt.forEach(o),Ca=l(z),qn=s(z,"P",{});var ei=d(qn);Sa=r(ei,`After such an Encoder Decoder model has been trained/fine-tuned, it can be saved/loaded just like any other models
(see the examples for more information).`),ei.forEach(o),Na=l(z),eo=s(z,"P",{});var yt=d(eo);Ia=r(yt,"This model inherits from "),Io=s(yt,"A",{href:!0});var oi=d(Io);La=r(oi,"TFPreTrainedModel"),oi.forEach(o),Ba=r(yt,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),yt.forEach(o),Oa=l(z),oo=s(z,"P",{});var kt=d(oo);Va=r(kt,"This model is also a "),no=s(kt,"A",{href:!0,rel:!0});var ni=d(no);Wa=r(ni,"tf.keras.Model"),ni.forEach(o),Ra=r(kt,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),kt.forEach(o),Ga=l(z),U=s(z,"P",{});var ko=d(U);Lo=s(ko,"A",{href:!0});var ti=d(Lo);Ua=r(ti,"TFEncoderDecoderModel"),ti.forEach(o),Ha=r(ko,` is a generic model class that will be instantiated as a transformer architecture with one
of the base model classes of the library as encoder and another one as decoder when created with the
...
method for the decoder.`),ko.forEach(o),Qa=l(z),S=s(z,"DIV",{class:!0});var Z=d(S);u(to.$$.fragment,Z),Xa=l(Z),de=s(Z,"P",{});var tn=d(de);es=r(tn,"The "),Vo=s(tn,"A",{href:!0});var si=d(Vo);os=r(si,"TFEncoderDecoderModel"),si.forEach(o),ns=r(tn," forward method, overrides the "),Dn=s(tn,"CODE",{});var di=d(Dn);ts=r(di,"__call__"),di.forEach(o),rs=r(tn," special method."),tn.forEach(o),as=l(Z),u(Te.$$.fragment,Z),ss=l(Z),zn=s(Z,"P",{});var ii=d(zn);ds=r(ii,"Examples:"),ii.forEach(o),is=l(Z),u(ro.$$.fragment,Z),Z.forEach(o),cs=l(z),L=s(z,"DIV",{class:!0});var Me=d(L);u(ao.$$.fragment,Me),ls=l(Me),$n=s(Me,"P",{});var ci=d($n);ps=r(ci,`Instantiate an encoder and a decoder from one or two base classes of the library from pretrained model
checkpoints.`),ci.forEach(o),ms=l(Me),jn=s(Me,"P",{});var li=d(jn);hs=r(li,"Example:"),li.forEach(o),fs=l(Me),u(so.$$.fragment,Me),Me.forEach(o),z.forEach(o),rt=l(n),ie=s(n,"H2",{class:!0});var Tt=d(ie);we=s(Tt,"A",{id:!0,class:!0,href:!0});var pi=d(we);Fn=s(pi,"SPAN",{});var mi=d(Fn);u(io.$$.fragment,mi),mi.forEach(o),pi.forEach(o),us=l(Tt),Pn=s(Tt,"SPAN",{});var hi=d(Pn);gs=r(hi,"FlaxEncoderDecoderModel"),hi.forEach(o),Tt.forEach(o),at=l(n),M=s(n,"DIV",{class:!0});var $=d(M);u(co.$$.fragment,$),_s=l($),ce=s($,"P",{});var rn=d(ce);bs=r(rn,`This class can be used to initialize a sequence-to-sequence model with any pretrained autoencoding model as the
encoder and any pretrained autoregressive model as the decoder. The encoder is loaded via
...
Tasks`),gi.forEach(o),xs=r(wt,` by Sascha Rothe, Shashi Narayan, Aliaksei Severyn. Michael Matena, Yanqi
Zhou, Wei Li, Peter J. Liu.`),wt.forEach(o),qs=l($),An=s($,"P",{});var _i=d(An);Ds=r(_i,`After such an Encoder Decoder model has been trained/fine-tuned, it can be saved/loaded just like any other models
(see the examples for more information).`),_i.forEach(o),zs=l($),mo=s($,"P",{});var Et=d(mo);$s=r(Et,"This model inherits from "),Go=s(Et,"A",{href:!0});var bi=d(Go);js=r(bi,"FlaxPreTrainedModel"),bi.forEach(o),Fs=r(Et,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
