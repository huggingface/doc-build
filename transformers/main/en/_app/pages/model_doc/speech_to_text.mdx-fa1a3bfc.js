...
methods above for more information.`),q.forEach(t),this.h()},h(){d(u,"href","/docs/transformers/main/en/main_classes/feature_extractor#transformers.FeatureExtractionMixin.from_pretrained")},m(A,q){p(A,h,q),e(h,z),e(h,u),e(u,g),e(h,S),e(h,_),e(_,w),e(h,$)},d(A){A&&t(h)}}}function Tp(R){let h,z,u,g,S,_,w,$;return{c(){h=a("p"),z=n("This class method is simply calling "),u=a("a"),g=n("save_pretrained()"),S=n(` and
`),_=a("code"),w=n("save_pretrained"),$=n(`. Please refer to the docstrings of the methods
above for more information.`),this.h()},l(A){h=r(A,"P",{});var q=i(h);z=s(q,"This class method is simply calling "),u=r(q,"A",{href:!0});var E=i(u);g=s(E,"save_pretrained()"),E.forEach(t),S=s(q,` and
`),_=r(q,"CODE",{});var N=i(_);w=s(N,"save_pretrained"),N.forEach(t),$=s(q,`. Please refer to the docstrings of the methods
above for more information.`),q.forEach(t),this.h()},h(){d(u,"href","/docs/transformers/main/en/main_classes/feature_extractor#transformers.FeatureExtractionMixin.save_pretrained")},m(A,q){p(A,h,q),e(h,z),e(h,u),e(u,g),e(h,S),e(h,_),e(_,w),e(h,$)},d(A){A&&t(h)}}}function vp(R){let h,z,u,g,S;return{c(){h=a("p"),z=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),u=a("code"),g=n("Module"),S=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(_){h=r(_,"P",{});var w=i(h);z=s(w,"Although the recipe for forward pass needs to be defined within this function, one should call the "),u=r(w,"CODE",{});var $=i(u);g=s($,"Module"),$.forEach(t),S=s(w,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),w.forEach(t)},m(_,w){p(_,h,w),e(h,z),e(h,u),e(u,g),e(h,S)},d(_){_&&t(h)}}}function xp(R){let h,z,u,g,S;return{c(){h=a("p"),z=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),u=a("code"),g=n("Module"),S=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(_){h=r(_,"P",{});var w=i(h);z=s(w,"Although the recipe for forward pass needs to be defined within this function, one should call the "),u=r(w,"CODE",{});var $=i(u);g=s($,"Module"),$.forEach(t),S=s(w,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),w.forEach(t)},m(_,w){p(_,h,w),e(h,z),e(h,u),e(u,g),e(h,S)},d(_){_&&t(h)}}}function kp(R){let h,z,u,g,S,_,w,$,A,q,E,N,V,ee,Fe,B,je,$e,C,J,te,ye,P,M,Pe,oe,ne,Me,se,ae,Ce,O,Ee,L,Ae,re,ie,Ie,de,K,De,Z,Y;return{c(){h=a("p"),z=n("TF 2.0 models accepts two formats as inputs:"),u=c(),g=a("ul"),S=a("li"),_=n("having all inputs as keyword arguments (like PyTorch models), or"),w=c(),$=a("li"),A=n("having all inputs as a list, tuple or dict in the first positional arguments."),q=c(),E=a("p"),N=n("This second option is useful when using "),V=a("code"),ee=n("tf.keras.Model.fit"),Fe=n(` method which currently requires having all the
...
`),Z=r(Le,"CODE",{});var dt=i(Z);Y=s(dt,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),dt.forEach(t),Le.forEach(t),G.forEach(t)},m(f,F){p(f,h,F),e(h,z),p(f,u,F),p(f,g,F),e(g,S),e(S,_),e(g,w),e(g,$),e($,A),p(f,q,F),p(f,E,F),e(E,N),e(E,V),e(V,ee),e(E,Fe),e(E,B),e(B,je),e(E,$e),p(f,C,F),p(f,J,F),e(J,te),p(f,ye,F),p(f,P,F),e(P,M),e(M,Pe),e(M,oe),e(oe,ne),e(M,Me),e(M,se),e(se,ae),e(P,Ce),e(P,O),e(O,Ee),e(O,L),e(L,Ae),e(O,re),e(O,ie),e(ie,Ie),e(P,de),e(P,K),e(K,De),e(K,Z),e(Z,Y)},d(f){f&&t(h),f&&t(u),f&&t(g),f&&t(q),f&&t(E),f&&t(C),f&&t(J),f&&t(ye),f&&t(P)}}}function bp(R){let h,z,u,g,S;return{c(){h=a("p"),z=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),u=a("code"),g=n("Module"),S=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(_){h=r(_,"P",{});var w=i(h);z=s(w,"Although the recipe for forward pass needs to be defined within this function, one should call the "),u=r(w,"CODE",{});var $=i(u);g=s($,"Module"),$.forEach(t),S=s(w,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),w.forEach(t)},m(_,w){p(_,h,w),e(h,z),e(h,u),e(u,g),e(h,S)},d(_){_&&t(h)}}}function yp(R){let h,z,u,g,S,_,w,$,A,q,E,N,V,ee,Fe,B,je,$e,C,J,te,ye,P,M,Pe,oe,ne,Me,se,ae,Ce,O,Ee,L,Ae,re,ie,Ie,de,K,De,Z,Y;return{c(){h=a("p"),z=n("TF 2.0 models accepts two formats as inputs:"),u=c(),g=a("ul"),S=a("li"),_=n("having all inputs as keyword arguments (like PyTorch models), or"),w=c(),$=a("li"),A=n("having all inputs as a list, tuple or dict in the first positional arguments."),q=c(),E=a("p"),N=n("This second option is useful when using "),V=a("code"),ee=n("tf.keras.Model.fit"),Fe=n(` method which currently requires having all the
tensors in the first argument of the model call function: `),B=a("code"),je=n("model(inputs)"),$e=n("."),C=c(),J=a("p"),te=n(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),ye=c(),P=a("ul"),M=a("li"),Pe=n("a single Tensor with "),oe=a("code"),ne=n("input_ids"),Me=n(" only and nothing else: "),se=a("code"),ae=n("model(input_ids)"),Ce=c(),O=a("li"),Ee=n(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),L=a("code"),Ae=n("model([input_ids, attention_mask])"),re=n(" or "),ie=a("code"),Ie=n("model([input_ids, attention_mask, token_type_ids])"),de=c(),K=a("li"),De=n(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),Z=a("code"),Y=n('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(f){h=r(f,"P",{});var F=i(h);z=s(F,"TF 2.0 models accepts two formats as inputs:"),F.forEach(t),u=l(f),g=r(f,"UL",{});var X=i(g);S=r(X,"LI",{});var st=i(S);_=s(st,"having all inputs as keyword arguments (like PyTorch models), or"),st.forEach(t),w=l(X),$=r(X,"LI",{});var Ne=i($);A=s(Ne,"having all inputs as a list, tuple or dict in the first positional arguments."),Ne.forEach(t),X.forEach(t),q=l(f),E=r(f,"P",{});var Q=i(E);N=s(Q,"This second option is useful when using "),V=r(Q,"CODE",{});var Ue=i(V);ee=s(Ue,"tf.keras.Model.fit"),Ue.forEach(t),Fe=s(Q,` method which currently requires having all the
...
first positional argument :`),at.forEach(t),ye=l(f),P=r(f,"UL",{});var G=i(P);M=r(G,"LI",{});var ce=i(M);Pe=s(ce,"a single Tensor with "),oe=r(ce,"CODE",{});var rt=i(oe);ne=s(rt,"input_ids"),rt.forEach(t),Me=s(ce," only and nothing else: "),se=r(ce,"CODE",{});var Re=i(se);ae=s(Re,"model(input_ids)"),Re.forEach(t),ce.forEach(t),Ce=l(G),O=r(G,"LI",{});var j=i(O);Ee=s(j,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),L=r(j,"CODE",{});var it=i(L);Ae=s(it,"model([input_ids, attention_mask])"),it.forEach(t),re=s(j," or "),ie=r(j,"CODE",{});var ze=i(ie);Ie=s(ze,"model([input_ids, attention_mask, token_type_ids])"),ze.forEach(t),j.forEach(t),de=l(G),K=r(G,"LI",{});var Le=i(K);De=s(Le,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),Z=r(Le,"CODE",{});var dt=i(Z);Y=s(dt,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),dt.forEach(t),Le.forEach(t),G.forEach(t)},m(f,F){p(f,h,F),e(h,z),p(f,u,F),p(f,g,F),e(g,S),e(S,_),e(g,w),e(g,$),e($,A),p(f,q,F),p(f,E,F),e(E,N),e(E,V),e(V,ee),e(E,Fe),e(E,B),e(B,je),e(E,$e),p(f,C,F),p(f,J,F),e(J,te),p(f,ye,F),p(f,P,F),e(P,M),e(M,Pe),e(M,oe),e(oe,ne),e(M,Me),e(M,se),e(se,ae),e(P,Ce),e(P,O),e(O,Ee),e(O,L),e(L,Ae),e(O,re),e(O,ie),e(ie,Ie),e(P,de),e(P,K),e(K,De),e(K,Z),e(Z,Y)},d(f){f&&t(h),f&&t(u),f&&t(g),f&&t(q),f&&t(E),f&&t(C),f&&t(J),f&&t(ye),f&&t(P)}}}function wp(R){let h,z,u,g,S;return{c(){h=a("p"),z=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),u=a("code"),g=n("Module"),S=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(_){h=r(_,"P",{});var w=i(h);z=s(w,"Although the recipe for forward pass needs to be defined within this function, one should call the "),u=r(w,"CODE",{});var $=i(u);g=s($,"Module"),$.forEach(t),S=s(w,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),w.forEach(t)},m(_,w){p(_,h,w),e(h,z),e(h,u),e(u,g),e(h,S)},d(_){_&&t(h)}}}function Sp(R){let h,z,u,g,S,_,w,$,A,q,E,N,V,ee,Fe,B,je,$e,C,J,te,ye,P,M,Pe,oe,ne,Me,se,ae,Ce,O,Ee,L,Ae,re,ie,Ie,de,K,De,Z,Y,f,F,X,st,Ne,Q,Ue,_e,at,G,ce,rt,Re,j,it,ze,Le,dt,hn,tr,or,pn,nr,sr,mn,ar,rr,Zs,W,ir,Yn,dr,cr,Xn,lr,hr,Qn,pr,mr,Zn,fr,ur,es,_r,gr,Xt,Tr,vr,ts,xr,ea,fn,os,kr,ta,Qt,oa,un,Zt,ns,br,yr,le,wr,ss,Sr,$r,as,Er,zr,rs,qr,Fr,is,jr,Pr,ds,Mr,Cr,na,eo,sa,yt,Ar,to,Ir,Dr,aa,ct,wt,cs,oo,Nr,ls,Lr,ra,he,no,Or,lt,Gr,_n,Wr,Ur,so,Rr,Hr,Vr,ht,Br,gn,Jr,Kr,Tn,Yr,Xr,Qr,hs,Zr,ei,ao,ia,pt,St,ps,ro,ti,ms,oi,da,U,io,ni,fs,si,ai,co,ri,vn,ii,di,ci,$t,lo,li,us,hi,pi,Et,ho,mi,po,fi,_s,ui,_i,gi,He,mo,Ti,xn,vi,kn,xi,ki,gs,bi,yi,bn,fo,ca,mt,zt,Ts,uo,wi,vs,Si,la,pe,_o,$i,xs,Ei,zi,go,qi,yn,Fi,ji,Pi,ks,Mi,Ci,qt,To,Ai,bs,Ii,ha,ft,Ft,ys,vo,Di,ws,Ni,pa,I,xo,Li,Ss,Oi,Gi,ge,wn,Wi,Ui,Sn,Ri,Hi,$n,Vi,Bi,ko,$s,Ji,Ki,Yi,En,Xi,Qi,Zi,jt,bo,ed,Oe,td,yo,Es,od,nd,sd,zn,ad,rd,wo,zs,id,dd,cd,ld,Ve,So,hd,qs,pd,md,Pt,fd,Be,$o,ud,Eo,_d,qn,gd,Td,vd,Mt,xd,Ct,zo,kd,qo,bd,Fn,yd,wd,Sd,At,Fo,$d,jo,Ed,jn,zd,qd,Fd,It,Po,jd,Fs,Pd,ma,ut,Dt,js,Mo,Md,Ps,Cd,fa,we,Co,Ad,Ao,Id,Pn,Dd,Nd,Ld,Io,Od,Do,Gd,Wd,Ud,Te,No,Rd,_t,Hd,Mn,Vd,Bd,Ms,Jd,Kd,Yd,Nt,Xd,Cs,Qd,Zd,Lo,ua,gt,Lt,As,Oo,ec,Is,tc,_a,Se,Go,oc,Wo,nc,Cn,sc,ac,rc,Uo,ic,Ro,dc,cc,lc,ve,Ho,hc,Tt,pc,An,mc,fc,Ds,uc,_c,gc,Ot,Tc,Ns,vc,xc,Vo,ga,vt,Gt,Ls,Bo,kc,Os,bc,Ta,me,Jo,yc,Ko,wc,In,Sc,$c,Ec,Yo,zc,Xo,qc,Fc,jc,Wt,Pc,xe,Qo,Mc,xt,Cc,Dn,Ac,Ic,Gs,Dc,Nc,Lc,Ut,Oc,Ws,Gc,Wc,Zo,va,kt,Rt,Us,en,Uc,Rs,Rc,xa,fe,tn,Hc,on,Vc,Nn,Bc,Jc,Kc,nn,Yc,sn,Xc,Qc,Zc,Ht,el,ke,an,tl,bt,ol,Ln,nl,sl,Hs,al,rl,il,Vt,dl,Vs,cl,ll,rn,ka;return _=new We({}),ee=new We({}),X=new We({}),Qt=new ln({props:{code:`import torch
...
Speech2Text.`),ma=c(),ut=a("h2"),Dt=a("a"),js=a("span"),T(Mo.$$.fragment),Md=c(),Ps=a("span"),Cd=n("Speech2TextModel"),fa=c(),we=a("div"),T(Co.$$.fragment),Ad=c(),Ao=a("p"),Id=n(`The bare Speech2Text Model outputting raw hidden-states without any specific head on top.
...
and behavior.`),Ud=c(),Te=a("div"),T(No.$$.fragment),Rd=c(),_t=a("p"),Hd=n("The "),Mn=a("a"),Vd=n("Speech2TextModel"),Bd=n(" forward method, overrides the "),Ms=a("code"),Jd=n("__call__"),Kd=n(" special method."),Yd=c(),T(Nt.$$.fragment),Xd=c(),Cs=a("p"),Qd=n("Example:"),Zd=c(),T(Lo.$$.fragment),ua=c(),gt=a("h2"),Lt=a("a"),As=a("span"),T(Oo.$$.fragment),ec=c(),Is=a("span"),tc=n("Speech2TextForConditionalGeneration"),_a=c(),Se=a("div"),T(Go.$$.fragment),oc=c(),Wo=a("p"),nc=n(`The Speech2Text Model with a language modeling head. Can be used for summarization.
...
predicted token ids.`),Ke.forEach(t),Zs=l(o),W=r(o,"P",{});var ue=i(W);ir=s(ue,"The feature extractor depends on "),Yn=r(ue,"CODE",{});var ql=i(Yn);dr=s(ql,"torchaudio"),ql.forEach(t),cr=s(ue," and the tokenizer depends on "),Xn=r(ue,"CODE",{});var Fl=i(Xn);lr=s(Fl,"sentencepiece"),Fl.forEach(t),hr=s(ue,` so be sure to
install those packages before running the examples. You could either install those as extra speech dependencies with
`),Qn=r(ue,"CODE",{});var jl=i(Qn);pr=s(jl,'pip install transformers"[speech, sentencepiece]"'),jl.forEach(t),mr=s(ue," or install the packages seperately with "),Zn=r(ue,"CODE",{});var Pl=i(Zn);fr=s(Pl,"pip install torchaudio sentencepiece"),Pl.forEach(t),ur=s(ue,". Also "),es=r(ue,"CODE",{});var Ml=i(es);_r=s(Ml,"torchaudio"),Ml.forEach(t),gr=s(ue," requires the development version of the "),Xt=r(ue,"A",{href:!0,rel:!0});var Cl=i(Xt);Tr=s(Cl,"libsndfile"),Cl.forEach(t),vr=s(ue,` package which can be installed via a system package manager. On Ubuntu it can
...
Speech2Text.`),Mh.forEach(t),Wa.forEach(t),H.forEach(t),ma=l(o),ut=r(o,"H2",{class:!0});var Ua=i(ut);Dt=r(Ua,"A",{id:!0,class:!0,href:!0});var Ch=i(Dt);js=r(Ch,"SPAN",{});var Ah=i(js);v(Mo.$$.fragment,Ah),Ah.forEach(t),Ch.forEach(t),Md=l(Ua),Ps=r(Ua,"SPAN",{});var Ih=i(Ps);Cd=s(Ih,"Speech2TextModel"),Ih.forEach(t),Ua.forEach(t),fa=l(o),we=r(o,"DIV",{class:!0});var Jt=i(we);v(Co.$$.fragment,Jt),Ad=l(Jt),Ao=r(Jt,"P",{});var Ra=i(Ao);Id=s(Ra,`The bare Speech2Text Model outputting raw hidden-states without any specific head on top.
