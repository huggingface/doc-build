import{S as zf,i as Ff,s as $f,e as n,k as i,w as f,t as r,M as xf,c as s,d as t,m as l,a,x as _,h as d,b as c,F as e,g as h,y as g,q as v,o as T,B as k,v as Mf}from"../../chunks/vendor-6b77c823.js";import{T as go}from"../../chunks/Tip-39098574.js";import{D as $}from"../../chunks/Docstring-abef54e3.js";import{C as At}from"../../chunks/CodeBlock-3a8b25a8.js";import{I as me}from"../../chunks/IconCopyLink-7a11ce68.js";function Sf(I){let u,L,b,E,q;return{c(){u=n("p"),L=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),b=n("code"),E=r("Module"),q=r(`
...
`),se=n("code"),De=r('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(m){u=s(m,"P",{});var F=a(u);L=d(F,"TF 2.0 models accepts two formats as inputs:"),F.forEach(t),b=l(m),E=s(m,"UL",{});var ae=a(E);q=s(ae,"LI",{});var nt=a(q);y=d(nt,"having all inputs as keyword arguments (like PyTorch models), or"),nt.forEach(t),w=l(ae),D=s(ae,"LI",{});var st=a(D);Ae=d(st,"having all inputs as a list, tuple or dict in the first positional arguments."),st.forEach(t),ae.forEach(t),fe=l(m),z=s(m,"P",{});var j=a(z);Z=d(j,"This second option is useful when using "),U=s(j,"CODE",{});var at=a(U);te=d(at,"tf.keras.Model.fit"),at.forEach(t),Ne=d(j,` method which currently requires having all the
tensors in the first argument of the model call function: `),R=s(j,"CODE",{});var rt=a(R);je=d(rt,"model(inputs)"),rt.forEach(t),Me=d(j,"."),j.forEach(t),B=l(m),V=s(m,"P",{});var Oe=a(V);oe=d(Oe,`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),Oe.forEach(t),Le=l(m),S=s(m,"UL",{});var X=a(S);P=s(X,"LI",{});var re=a(P);_e=d(re,"a single Tensor with "),ne=s(re,"CODE",{});var Pe=a(ne);Se=d(Pe,"input_ids"),Pe.forEach(t),ge=d(re," only and nothing else: "),K=s(re,"CODE",{});var dt=a(K);Ie=d(dt,"model(input_ids)"),dt.forEach(t),re.forEach(t),Ce=l(X),C=s(X,"LI",{});var de=a(C);Be=d(de,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
...
the latter silently ignores them.`)},l(y){u=s(y,"P",{});var w=a(u);L=d(w,"Although the recipe for forward pass needs to be defined within this function, one should call the "),b=s(w,"CODE",{});var D=a(b);E=d(D,"Module"),D.forEach(t),q=d(w,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),w.forEach(t)},m(y,w){h(y,u,w),e(u,L),e(u,b),e(b,E),e(u,q)},d(y){y&&t(u)}}}function Bf(I){let u,L,b,E,q,y,w,D,Ae,fe,z,Z,U,te,Ne,R,je,Me,B,V,oe,Le,S,P,_e,ne,Se,ge,K,Ie,Ce,C,Be,Y,x,M,G,Ge,Qe,N,He,se,De,m,F,ae,nt,st,j,at,rt,Oe,X,re,Pe,dt,de,it,ie,We,Ue,Sd,Cd,$s,Od,Pd,Ad,ze,Nd,xs,jd,Id,Ms,Bd,Gd,Un,Qd,Hd,Ss,Wd,Ud,Rd,J,Vd,Cs,Kd,Xd,Os,Jd,Zd,Rn,Yd,ei,Ps,ti,oi,As,ni,si,Ns,ai,ri,di,lt,ii,js,li,ci,Is,hi,pi,ui,vo,mi,To,fi,_i,gi,ko,vi,bo,Ti,ki,ur,Nt,bi,wo,wi,yi,mr,ct,jt,Bs,yo,Ei,Gs,qi,fr,O,Eo,Li,ht,Di,Vn,zi,Fi,qo,$i,xi,Mi,pt,Si,Kn,Ci,Oi,Xn,Pi,Ai,Ni,Qs,ji,Ii,Lo,Bi,Hs,Ws,Us,Rs,Gi,Qi,Vs,Ks,Xs,It,Bt,Js,Do,Hi,Zs,Wi,Ui,Ys,ea,zo,Gt,Qt,ta,Fo,Ri,oa,Vi,Ki,na,Xi,Ji,sa,aa,ra,Ht,Wt,da,$o,Zi,ia,Yi,_r,ut,Ut,la,xo,el,ca,tl,gr,A,Mo,ol,ha,nl,sl,Rt,Jn,al,rl,Zn,dl,il,ll,So,cl,Yn,hl,pl,ul,Re,Co,ml,pa,fl,_l,Oo,es,gl,ua,vl,Tl,ts,kl,ma,bl,wl,Vt,Po,yl,Ao,El,fa,ql,Ll,Dl,Kt,No,zl,_a,Fl,$l,os,jo,vr,mt,Xt,ga,Io,xl,va,Ml,Tr,Fe,Bo,Sl,Go,Cl,Ta,Ol,Pl,Al,Jt,ns,Nl,jl,ss,Il,Bl,Gl,Qo,Ql,as,Hl,Wl,kr,ft,Zt,ka,Ho,Ul,ba,Rl,br,_t,Wo,Vl,wa,Kl,wr,gt,Uo,Xl,ya,Jl,yr,vt,Ro,Zl,Ea,Yl,Er,Tt,Vo,ec,qa,tc,qr,kt,Ko,oc,La,nc,Lr,bt,Xo,sc,Da,ac,Dr,wt,Jo,rc,za,dc,zr,yt,Zo,ic,Fa,lc,Fr,Et,Yt,$a,Yo,cc,xa,hc,$r,$e,en,pc,tn,uc,rs,mc,fc,_c,on,gc,nn,vc,Tc,kc,ve,sn,bc,qt,wc,ds,yc,Ec,Ma,qc,Lc,Dc,eo,zc,Sa,Fc,$c,an,xr,Lt,to,Ca,rn,xc,Oa,Mc,Mr,xe,dn,Sc,ln,Cc,is,Oc,Pc,Ac,cn,Nc,hn,jc,Ic,Bc,Q,pn,Gc,Dt,Qc,ls,Hc,Wc,Pa,Uc,Rc,Vc,oo,Kc,Aa,Xc,Jc,un,Zc,Na,Yc,eh,mn,Sr,zt,no,ja,fn,th,Ia,oh,Cr,le,_n,nh,Ba,sh,ah,gn,rh,cs,dh,ih,lh,vn,ch,Tn,hh,ph,uh,H,kn,mh,Ft,fh,hs,_h,gh,Ga,vh,Th,kh,so,bh,Qa,wh,yh,bn,Eh,Ha,qh,Lh,wn,Or,$t,ao,Wa,yn,Dh,Ua,zh,Pr,ce,En,Fh,xt,$h,Ra,xh,Mh,Va,Sh,Ch,Oh,qn,Ph,ps,Ah,Nh,jh,Ln,Ih,Dn,Bh,Gh,Qh,Te,zn,Hh,Mt,Wh,us,Uh,Rh,Ka,Vh,Kh,Xh,ro,Jh,Xa,Zh,Yh,Fn,Ar,St,io,Ja,$n,ep,Za,tp,Nr,he,xn,op,Mn,np,ms,sp,ap,rp,Sn,dp,Cn,ip,lp,cp,lo,hp,ke,On,pp,Ct,up,fs,mp,fp,Ya,_p,gp,vp,co,Tp,er,kp,bp,Pn,jr,Ot,ho,tr,An,wp,or,yp,Ir,pe,Nn,Ep,jn,qp,_s,Lp,Dp,zp,In,Fp,Bn,$p,xp,Mp,po,Sp,be,Gn,Cp,Pt,Op,gs,Pp,Ap,nr,Np,jp,Ip,uo,Bp,sr,Gp,Qp,Qn,Br;return y=new me({}),te=new me({}),yo=new me({}),Eo=new $({props:{name:"class transformers.LEDConfig",anchor:"transformers.LEDConfig",parameters:[{name:"vocab_size",val:" = 50265"},{name:"max_encoder_position_embeddings",val:" = 16384"},{name:"max_decoder_position_embeddings",val:" = 1024"},{name:"encoder_layers",val:" = 12"},{name:"encoder_ffn_dim",val:" = 4096"},{name:"encoder_attention_heads",val:" = 16"},{name:"decoder_layers",val:" = 12"},{name:"decoder_ffn_dim",val:" = 4096"},{name:"decoder_attention_heads",val:" = 16"},{name:"encoder_layerdrop",val:" = 0.0"},{name:"decoder_layerdrop",val:" = 0.0"},{name:"use_cache",val:" = True"},{name:"is_encoder_decoder",val:" = True"},{name:"activation_function",val:" = 'gelu'"},{name:"d_model",val:" = 1024"},{name:"dropout",val:" = 0.1"},{name:"attention_dropout",val:" = 0.0"},{name:"activation_dropout",val:" = 0.0"},{name:"init_std",val:" = 0.02"},{name:"decoder_start_token_id",val:" = 2"},{name:"classifier_dropout",val:" = 0.0"},{name:"pad_token_id",val:" = 1"},{name:"bos_token_id",val:" = 0"},{name:"eos_token_id",val:" = 2"},{name:"attention_window",val:": typing.Union[typing.List[int], int] = 512"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/led/configuration_led.py#L31",parametersDescription:[{anchor:"transformers.LEDConfig.vocab_size",description:`<strong>vocab_size</strong> (<code>int</code>, <em>optional</em>, defaults to 50265) &#x2014;
...
adding special tokens. A BART sequence has the following format:`),_l=i(),Oo=n("ul"),es=n("li"),gl=r("single sequence: "),ua=n("code"),vl=r("<s> X </s>"),Tl=i(),ts=n("li"),kl=r("pair of sequences: "),ma=n("code"),bl=r("<s> A </s></s> B </s>"),wl=i(),Vt=n("div"),f(Po.$$.fragment),yl=i(),Ao=n("p"),El=r(`Retrieve sequence ids from a token list that has no special tokens added. This method is called when adding
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),uh=i(),H=n("div"),f(kn.$$.fragment),mh=i(),Ft=n("p"),fh=r("The "),hs=n("a"),_h=r("LEDForSequenceClassification"),gh=r(" forward method, overrides the "),Ga=n("code"),vh=r("__call__"),Th=r(" special method."),kh=i(),f(so.$$.fragment),bh=i(),Qa=n("p"),wh=r("Example of single-label classification:"),yh=i(),f(bn.$$.fragment),Eh=i(),Ha=n("p"),qh=r("Example of multi-label classification:"),Lh=i(),f(wn.$$.fragment),Or=i(),$t=n("h2"),ao=n("a"),Wa=n("span"),f(yn.$$.fragment),Dh=i(),Ua=n("span"),zh=r("LEDForQuestionAnswering"),Pr=i(),ce=n("div"),f(En.$$.fragment),Fh=i(),xt=n("p"),$h=r(`LED Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear layer
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Qh=i(),Te=n("div"),f(zn.$$.fragment),Hh=i(),Mt=n("p"),Wh=r("The "),us=n("a"),Uh=r("LEDForQuestionAnswering"),Rh=r(" forward method, overrides the "),Ka=n("code"),Vh=r("__call__"),Kh=r(" special method."),Xh=i(),f(ro.$$.fragment),Jh=i(),Xa=n("p"),Zh=r("Example:"),Yh=i(),f(Fn.$$.fragment),Ar=i(),St=n("h2"),io=n("a"),Ja=n("span"),f($n.$$.fragment),ep=i(),Za=n("span"),tp=r("TFLEDModel"),Nr=i(),he=n("div"),f(xn.$$.fragment),op=i(),Mn=n("p"),np=r(`The bare LED Model outputting raw hidden-states without any specific head on top.
...
behavior.`),cp=i(),f(lo.$$.fragment),hp=i(),ke=n("div"),f(On.$$.fragment),pp=i(),Ct=n("p"),up=r("The "),fs=n("a"),mp=r("TFLEDModel"),fp=r(" forward method, overrides the "),Ya=n("code"),_p=r("__call__"),gp=r(" special method."),vp=i(),f(co.$$.fragment),Tp=i(),er=n("p"),kp=r("Example:"),bp=i(),f(Pn.$$.fragment),jr=i(),Ot=n("h2"),ho=n("a"),tr=n("span"),f(An.$$.fragment),wp=i(),or=n("span"),yp=r("TFLEDForConditionalGeneration"),Ir=i(),pe=n("div"),f(Nn.$$.fragment),Ep=i(),jn=n("p"),qp=r(`The LED Model with a language modeling head. Can be used for summarization.
...
`),As=s(ye,"CODE",{});var mu=a(As);ni=d(mu,"<s>"),mu.forEach(t),si=d(ye," token. For question answering, it is advised to put "),Ns=s(ye,"EM",{});var fu=a(Ns);ai=d(fu,"global attention"),fu.forEach(t),ri=d(ye," on all tokens of the question."),ye.forEach(t),di=l(we),lt=s(we,"LI",{});var Ts=a(lt);ii=d(Ts,"To fine-tune LED on all 16384, it is necessary to enable "),js=s(Ts,"EM",{});var _u=a(js);li=d(_u,"gradient checkpointing"),_u.forEach(t),ci=d(Ts,` by executing
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),gd.forEach(t),kc=l(fo),ve=s(fo,"DIV",{class:!0});var Ke=a(ve);_(sn.$$.fragment,Ke),bc=l(Ke),qt=s(Ke,"P",{});var ys=a(qt);wc=d(ys,"The "),ds=s(ys,"A",{href:!0});var Sm=a(ds);yc=d(Sm,"LEDModel"),Sm.forEach(t),Ec=d(ys," forward method, overrides the "),Ma=s(ys,"CODE",{});var Cm=a(Ma);qc=d(Cm,"__call__"),Cm.forEach(t),Lc=d(ys," special method."),ys.forEach(t),Dc=l(Ke),_(eo.$$.fragment,Ke),zc=l(Ke),Sa=s(Ke,"P",{});var Om=a(Sa);Fc=d(Om,"Example:"),Om.forEach(t),$c=l(Ke),_(an.$$.fragment,Ke),Ke.forEach(t),fo.forEach(t),xr=l(o),Lt=s(o,"H2",{class:!0});var vd=a(Lt);to=s(vd,"A",{id:!0,class:!0,href:!0});var Pm=a(to);Ca=s(Pm,"SPAN",{});var Am=a(Ca);_(rn.$$.fragment,Am),Am.forEach(t),Pm.forEach(t),xc=l(vd),Oa=s(vd,"SPAN",{});var Nm=a(Oa);Mc=d(Nm,"LEDForConditionalGeneration"),Nm.forEach(t),vd.forEach(t),Mr=l(o),xe=s(o,"DIV",{class:!0});var _o=a(xe);_(dn.$$.fragment,_o),Sc=l(_o),ln=s(_o,"P",{});var Td=a(ln);Cc=d(Td,`The LED Model with a language modeling head. Can be used for summarization.
This model inherits from `),is=s(Td,"A",{href:!0});var jm=a(is);Oc=d(jm,"PreTrainedModel"),jm.forEach(t),Pc=d(Td,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Td.forEach(t),Ac=l(_o),cn=s(_o,"P",{});var kd=a(cn);Nc=d(kd,"This model is also a PyTorch "),hn=s(kd,"A",{href:!0,rel:!0});var Im=a(hn);jc=d(Im,"torch.nn.Module"),Im.forEach(t),Ic=d(kd,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),kd.forEach(t),Bc=l(_o),Q=s(_o,"DIV",{class:!0});var Ee=a(Q);_(pn.$$.fragment,Ee),Gc=l(Ee),Dt=s(Ee,"P",{});var Es=a(Dt);Qc=d(Es,"The "),ls=s(Es,"A",{href:!0});var Bm=a(ls);Hc=d(Bm,"LEDForConditionalGeneration"),Bm.forEach(t),Wc=d(Es," forward method, overrides the "),Pa=s(Es,"CODE",{});var Gm=a(Pa);Uc=d(Gm,"__call__"),Gm.forEach(t),Rc=d(Es," special method."),Es.forEach(t),Vc=l(Ee),_(oo.$$.fragment,Ee),Kc=l(Ee),Aa=s(Ee,"P",{});var Qm=a(Aa);Xc=d(Qm,"Conditional generation example:"),Qm.forEach(t),Jc=l(Ee),_(un.$$.fragment,Ee),Zc=l(Ee),Na=s(Ee,"P",{});var Hm=a(Na);Yc=d(Hm,"Summarization example:"),Hm.forEach(t),eh=l(Ee),_(mn.$$.fragment,Ee),Ee.forEach(t),_o.forEach(t),Sr=l(o),zt=s(o,"H2",{class:!0});var bd=a(zt);no=s(bd,"A",{id:!0,class:!0,href:!0});var Wm=a(no);ja=s(Wm,"SPAN",{});var Um=a(ja);_(fn.$$.fragment,Um),Um.forEach(t),Wm.forEach(t),th=l(bd),Ia=s(bd,"SPAN",{});var Rm=a(Ia);oh=d(Rm,"LEDForSequenceClassification"),Rm.forEach(t),bd.forEach(t),Cr=l(o),le=s(o,"DIV",{class:!0});var Xe=a(le);_(_n.$$.fragment,Xe),nh=l(Xe),Ba=s(Xe,"P",{});var Vm=a(Ba);sh=d(Vm,`LED model with a sequence classification/head on top (a linear layer on top of the pooled output) e.g. for GLUE
