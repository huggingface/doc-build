import{S as ic,i as lc,s as dc,e as a,k as l,w as b,t as r,M as cc,c as n,d as t,m as d,a as s,x as y,h as i,b as m,N as mc,F as e,g as u,y as I,q as w,o as P,B as k,v as pc,L as mn}from"../../chunks/vendor-6b77c823.js";import{T as dn}from"../../chunks/Tip-39098574.js";import{D as fe}from"../../chunks/Docstring-1088f2fb.js";import{C as pn}from"../../chunks/CodeBlock-3a8b25a8.js";import{I as $t}from"../../chunks/IconCopyLink-7a11ce68.js";import{E as cn}from"../../chunks/ExampleCodeBlock-5212b321.js";function hc($){let p,v,f,g,T;return g=new pn({props:{code:`from transformers import ImageGPTModel, ImageGPTConfig
...
<span class="hljs-meta">&gt;&gt;&gt; </span>inputs = feature_extractor(images=image, return_tensors=<span class="hljs-string">&quot;pt&quot;</span>)
<span class="hljs-meta">&gt;&gt;&gt; </span>outputs = model(**inputs)
<span class="hljs-meta">&gt;&gt;&gt; </span>logits = outputs.logits`}}),{c(){p=a("p"),v=r("Examples:"),f=l(),b(g.$$.fragment)},l(c){p=n(c,"P",{});var _=s(p);v=i(_,"Examples:"),_.forEach(t),f=d(c),y(g.$$.fragment,c)},m(c,_){u(c,p,_),e(p,v),u(c,f,_),I(g,c,_),T=!0},p:mn,i(c){T||(w(g.$$.fragment,c),T=!0)},o(c){P(g.$$.fragment,c),T=!1},d(c){c&&t(p),c&&t(f),k(g,c)}}}function yc($){let p,v,f,g,T,c,_,O,hn,ya,re,_e,Qt,Se,gn,Kt,un,Ia,Te,fn,We,_n,Tn,wa,xt,vn,Pa,Gt,Yt,bn,ka,ve,pl,$a,Et,yn,xa,W,In,Re,wn,Pn,Be,kn,$n,He,xn,Gn,Ga,Ft,En,Ea,x,Ve,Fn,Ue,Cn,Mn,zn,Je,jn,Ct,qn,An,Dn,Xe,Nn,Mt,On,Ln,Sn,Qe,Wn,Zt,Rn,Bn,Hn,Ke,Vn,zt,Un,Jn,Xn,eo,Qn,Fa,be,to,G,oo,ao,Kn,Yn,no,so,Zn,es,ro,io,ts,os,lo,co,as,ns,mo,po,ss,rs,ho,go,is,ls,E,F,uo,ds,cs,fo,ms,ps,_o,hs,gs,To,us,fs,vo,_s,Ts,bo,vs,bs,C,yo,ys,Is,Io,ws,Ps,wo,ks,$s,Po,xs,Gs,ko,Es,Fs,$o,Cs,Ms,M,xo,zs,js,Go,qs,As,Eo,Ds,Ns,Fo,Os,Ls,Co,Ss,Ws,Mo,Rs,Bs,z,zo,Hs,Vs,jo,Us,Js,qo,Xs,Qs,Ao,Ks,Ys,Do,Zs,er,No,tr,or,j,Oo,ar,nr,Lo,sr,rr,So,ir,lr,Wo,dr,cr,Ro,mr,pr,Bo,hr,gr,q,Ho,ur,fr,Vo,_r,Tr,Uo,vr,br,Jo,yr,Ir,Xo,wr,Pr,Qo,kr,Ca,ie,ye,Ko,Ye,$r,Yo,xr,Ma,L,Ze,Gr,te,Er,jt,Fr,Cr,Zo,Mr,zr,et,jr,qr,Ar,le,Dr,qt,Nr,Or,At,Lr,Sr,Wr,Ie,za,de,we,ea,tt,Rr,ta,Br,ja,S,ot,Hr,oa,Vr,Ur,at,Jr,Dt,Xr,Qr,Kr,oe,nt,Yr,aa,Zr,ei,Pe,qa,ce,ke,na,st,ti,sa,oi,Aa,A,rt,ai,ra,ni,si,it,ri,Nt,ii,li,di,lt,ci,dt,mi,pi,hi,R,ct,gi,me,ui,Ot,fi,_i,ia,Ti,vi,bi,$e,yi,xe,Da,pe,Ge,la,mt,Ii,da,wi,Na,D,pt,Pi,ca,ki,$i,ht,xi,Lt,Gi,Ei,Fi,gt,Ci,ut,Mi,zi,ji,B,ft,qi,he,Ai,St,Di,Ni,ma,Oi,Li,Si,Ee,Wi,Fe,Oa,ge,Ce,pa,_t,Ri,ha,Bi,La,N,Tt,Hi,vt,Vi,Wt,Ui,Ji,Xi,bt,Qi,Rt,Ki,Yi,Zi,yt,el,It,tl,ol,al,H,wt,nl,ue,sl,Bt,rl,il,ga,ll,dl,cl,Me,ml,ze,Sa;return c=new $t({}),Se=new $t({}),Ye=new $t({}),Ze=new fe({props:{name:"class transformers.ImageGPTConfig",anchor:"transformers.ImageGPTConfig",parameters:[{name:"vocab_size",val:" = 513"},{name:"n_positions",val:" = 1024"},{name:"n_embd",val:" = 512"},{name:"n_layer",val:" = 24"},{name:"n_head",val:" = 8"},{name:"n_inner",val:" = None"},{name:"activation_function",val:" = 'quick_gelu'"},{name:"resid_pdrop",val:" = 0.1"},{name:"embd_pdrop",val:" = 0.1"},{name:"attn_pdrop",val:" = 0.1"},{name:"layer_norm_epsilon",val:" = 1e-05"},{name:"initializer_range",val:" = 0.02"},{name:"scale_attn_weights",val:" = True"},{name:"use_cache",val:" = True"},{name:"tie_word_embeddings",val:" = False"},{name:"scale_attn_by_inverse_layer_idx",val:" = False"},{name:"reorder_and_upcast_attn",val:" = False"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.ImageGPTConfig.vocab_size",description:`<strong>vocab_size</strong> (<code>int</code>, <em>optional</em>, defaults to 512) &#x2014;
...
</ul>`,name:"return_tensors"}],source:"https://github.com/huggingface/transformers/blob/vmain/src/transformers/models/imagegpt/feature_extraction_imagegpt.py#L96",returnDescription:`
<p>A <a
...
are ignored (masked), the loss is only computed for labels in <code>[0, ..., config.vocab_size]</code>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vmain/src/transformers/models/imagegpt/modeling_imagegpt.py#L655",returnDescription:`
<p>A <a
...
Labels for language modeling. Note that the labels <strong>are shifted</strong> inside the model, i.e. you can set
<code>labels = input_ids</code> Indices are selected in <code>[-100, 0, ..., config.vocab_size]</code> All labels set to <code>-100</code>
are ignored (masked), the loss is only computed for labels in <code>[0, ..., config.vocab_size]</code>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vmain/src/transformers/models/imagegpt/modeling_imagegpt.py#L948",returnDescription:`
<p>A <a
...
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vmain/src/transformers/models/imagegpt/modeling_imagegpt.py#L1100",returnDescription:`
...
`}}),Me=new dn({props:{$$slots:{default:[vc]},$$scope:{ctx:$}}}),ze=new cn({props:{anchor:"transformers.ImageGPTForImageClassification.forward.example",$$slots:{default:[bc]},$$scope:{ctx:$}}}),{c(){p=a("meta"),v=l(),f=a("h1"),g=a("a"),T=a("span"),b(c.$$.fragment),_=l(),O=a("span"),hn=r("ImageGPT"),ya=l(),re=a("h2"),_e=a("a"),Qt=a("span"),b(Se.$$.fragment),gn=l(),Kt=a("span"),un=r("Overview"),Ia=l(),Te=a("p"),fn=r("The ImageGPT model was proposed in "),We=a("a"),_n=r("Generative Pretraining from Pixels"),Tn=r(` by Mark
...
train an XL variant, which they didn\u2019t release. The differences in size are summarized in the following table:`),Fa=l(),be=a("table"),to=a("thead"),G=a("tr"),oo=a("th"),ao=a("strong"),Kn=r("Model variant"),Yn=l(),no=a("th"),so=a("strong"),Zn=r("Depths"),es=l(),ro=a("th"),io=a("strong"),ts=r("Hidden sizes"),os=l(),lo=a("th"),co=a("strong"),as=r("Decoder hidden size"),ns=l(),mo=a("th"),po=a("strong"),ss=r("Params (M)"),rs=l(),ho=a("th"),go=a("strong"),is=r("ImageNet-1k Top 1"),ls=l(),E=a("tbody"),F=a("tr"),uo=a("td"),ds=r("MiT-b0"),cs=l(),fo=a("td"),ms=r("[2, 2, 2, 2]"),ps=l(),_o=a("td"),hs=r("[32, 64, 160, 256]"),gs=l(),To=a("td"),us=r("256"),fs=l(),vo=a("td"),_s=r("3.7"),Ts=l(),bo=a("td"),vs=r("70.5"),bs=l(),C=a("tr"),yo=a("td"),ys=r("MiT-b1"),Is=l(),Io=a("td"),ws=r("[2, 2, 2, 2]"),Ps=l(),wo=a("td"),ks=r("[64, 128, 320, 512]"),$s=l(),Po=a("td"),xs=r("256"),Gs=l(),ko=a("td"),Es=r("14.0"),Fs=l(),$o=a("td"),Cs=r("78.7"),Ms=l(),M=a("tr"),xo=a("td"),zs=r("MiT-b2"),js=l(),Go=a("td"),qs=r("[3, 4, 6, 3]"),As=l(),Eo=a("td"),Ds=r("[64, 128, 320, 512]"),Ns=l(),Fo=a("td"),Os=r("768"),Ls=l(),Co=a("td"),Ss=r("25.4"),Ws=l(),Mo=a("td"),Rs=r("81.6"),Bs=l(),z=a("tr"),zo=a("td"),Hs=r("MiT-b3"),Vs=l(),jo=a("td"),Us=r("[3, 4, 18, 3]"),Js=l(),qo=a("td"),Xs=r("[64, 128, 320, 512]"),Qs=l(),Ao=a("td"),Ks=r("768"),Ys=l(),Do=a("td"),Zs=r("45.2"),er=l(),No=a("td"),tr=r("83.1"),or=l(),j=a("tr"),Oo=a("td"),ar=r("MiT-b4"),nr=l(),Lo=a("td"),sr=r("[3, 8, 27, 3]"),rr=l(),So=a("td"),ir=r("[64, 128, 320, 512]"),lr=l(),Wo=a("td"),dr=r("768"),cr=l(),Ro=a("td"),mr=r("62.6"),pr=l(),Bo=a("td"),hr=r("83.6"),gr=l(),q=a("tr"),Ho=a("td"),ur=r("MiT-b5"),fr=l(),Vo=a("td"),_r=r("[3, 6, 40, 3]"),Tr=l(),Uo=a("td"),vr=r("[64, 128, 320, 512]"),br=l(),Jo=a("td"),yr=r("768"),Ir=l(),Xo=a("td"),wr=r("82.0"),Pr=l(),Qo=a("td"),kr=r("83.8"),Ca=l(),ie=a("h2"),ye=a("a"),Ko=a("span"),b(Ye.$$.fragment),$r=l(),Yo=a("span"),xr=r("ImageGPTConfig"),Ma=l(),L=a("div"),b(Ze.$$.fragment),Gr=l(),te=a("p"),Er=r("This is the configuration class to store the configuration of a "),jt=a("a"),Fr=r("ImageGPTModel"),Cr=r(" or a "),Zo=a("code"),Mr=r("TFImageGPTModel"),zr=r(`. It is
...
and behavior.`),hi=l(),R=a("div"),b(ct.$$.fragment),gi=l(),me=a("p"),ui=r("The "),Ot=a("a"),fi=r("ImageGPTModel"),_i=r(" forward method, overrides the "),ia=a("code"),Ti=r("__call__"),vi=r(" special method."),bi=l(),b($e.$$.fragment),yi=l(),b(xe.$$.fragment),Da=l(),pe=a("h2"),Ge=a("a"),la=a("span"),b(mt.$$.fragment),Ii=l(),da=a("span"),wi=r("ImageGPTForCausalImageModeling"),Na=l(),D=a("div"),b(pt.$$.fragment),Pi=l(),ca=a("p"),ki=r(`The ImageGPT Model transformer with a language modeling head on top (linear layer with weights tied to the input
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),ji=l(),B=a("div"),b(ft.$$.fragment),qi=l(),he=a("p"),Ai=r("The "),St=a("a"),Di=r("ImageGPTForCausalImageModeling"),Ni=r(" forward method, overrides the "),ma=a("code"),Oi=r("__call__"),Li=r(" special method."),Si=l(),b(Ee.$$.fragment),Wi=l(),b(Fe.$$.fragment),Oa=l(),ge=a("h2"),Ce=a("a"),pa=a("span"),b(_t.$$.fragment),Ri=l(),ha=a("span"),Bi=r("ImageGPTForImageClassification"),La=l(),N=a("div"),b(Tt.$$.fragment),Hi=l(),vt=a("p"),Vi=r(`The ImageGPT Model transformer with an image classification head on top (linear layer).
