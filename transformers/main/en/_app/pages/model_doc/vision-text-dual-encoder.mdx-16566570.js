import{S as Pr,i as Mr,s as zr,e as n,k as c,w as T,t as r,M as Cr,c as a,d as t,m,a as s,x as b,h as i,b as l,F as e,g as _,y as E,q as $,o as j,B as w,v as Fr,L as vs}from"../../chunks/vendor-6b77c823.js";import{T as Dr}from"../../chunks/Tip-39098574.js";import{D as R}from"../../chunks/Docstring-1088f2fb.js";import{C as Ts}from"../../chunks/CodeBlock-3a8b25a8.js";import{I as Pt}from"../../chunks/IconCopyLink-7a11ce68.js";import{E as xs}from"../../chunks/ExampleCodeBlock-5212b321.js";function Ir(I){let p,v,g,f,x;return f=new Ts({props:{code:`from transformers import ViTConfig, BertConfig, VisionTextDualEncoderConfig, VisionTextDualEncoderModel
...
`}}),de=new Dr({props:{$$slots:{default:[Ar]},$$scope:{ctx:I}}}),ce=new xs({props:{anchor:"transformers.VisionTextDualEncoderModel.forward.example",$$slots:{default:[qr]},$$scope:{ctx:I}}}),Ne=new Pt({}),Be=new R({props:{name:"class transformers.FlaxVisionTextDualEncoderModel",anchor:"transformers.FlaxVisionTextDualEncoderModel",parameters:[{name:"config",val:": VisionTextDualEncoderConfig"},{name:"input_shape",val:": typing.Optional[typing.Tuple] = None"},{name:"seed",val:": int = 0"},{name:"dtype",val:": dtype = <class 'jax._src.numpy.lax_numpy.float32'>"},{name:"_do_init",val:": bool = True"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.FlaxVisionTextDualEncoderModel.config",description:`<strong>config</strong> (<a href="/docs/transformers/main/en/model_doc/vision-text-dual-encoder#transformers.VisionTextDualEncoderConfig">VisionTextDualEncoderConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
...
and behavior.`),ja=c(),A=n("div"),T(Se.$$.fragment),wa=c(),X=n("p"),ya=r("The "),$t=n("a"),ka=r("VisionTextDualEncoderModel"),Va=r(" forward method, overrides the "),Rt=n("code"),Da=r("__call__"),Pa=r(" special method."),Ma=c(),T(de.$$.fragment),za=c(),T(ce.$$.fragment),fo=c(),K=n("h2"),me=n("a"),Ut=n("span"),T(Ne.$$.fragment),Ca=c(),Jt=n("span"),Fa=r("FlaxVisionTextDualEncoderModel"),ho=c(),y=n("div"),T(Be.$$.fragment),Ia=c(),Oe=n("p"),Aa=r(`This class can be used to initialize a vision-text dual encoder model with any pretrained vision autoencoding model
as the vision encoder and any pretrained text model as the text encoder. The vision and text encoders are loaded
...
general usage and behavior.`),Ya=c(),Zt=n("p"),es=r("Finally, this model supports inherent JAX features such as:"),ts=c(),N=n("ul"),Gt=n("li"),Ze=n("a"),os=r("Just-In-Time (JIT) compilation"),ns=c(),Xt=n("li"),Ge=n("a"),as=r("Automatic Differentiation"),ss=c(),Kt=n("li"),Xe=n("a"),rs=r("Vectorization"),is=c(),Qt=n("li"),Ke=n("a"),ls=r("Parallelization"),ds=c(),q=n("div"),T(Qe.$$.fragment),cs=c(),Q=n("p"),ms=r("The "),yt=n("a"),ps=r("FlaxVisionTextDualEncoderModel"),fs=r(" forward method, overrides the "),Yt=n("code"),hs=r("__call__"),us=r(" special method."),gs=c(),T(pe.$$.fragment),_s=c(),T(fe.$$.fragment),this.h()},l(o){const u=Cr('[data-svelte="svelte-1phssyn"]',document.head);p=a(u,"META",{name:!0,content:!0}),u.forEach(t),v=m(o),g=a(o,"H1",{class:!0});var Ye=s(g);f=a(Ye,"A",{id:!0,class:!0,href:!0});var eo=s(f);x=a(eo,"SPAN",{});var to=s(x);b(d.$$.fragment,to),to.forEach(t),eo.forEach(t),h=m(Ye),S=a(Ye,"SPAN",{});var oo=s(S);qo=i(oo,"VisionTextDualEncoder"),oo.forEach(t),Ye.forEach(t),no=m(o),U=a(o,"H2",{class:!0});var et=s(U);Y=a(et,"A",{id:!0,class:!0,href:!0});var bs=s(Y);Mt=a(bs,"SPAN",{});var Es=s(Mt);b(_e.$$.fragment,Es),Es.forEach(t),bs.forEach(t),Lo=m(et),zt=a(et,"SPAN",{});var $s=s(zt);So=i($s,"Overview"),$s.forEach(t),et.forEach(t),ao=m(o),k=a(o,"P",{});var D=s(k);No=i(D,"The "),ot=a(D,"A",{href:!0});var js=s(ot);Bo=i(js,"VisionTextDualEncoderModel"),js.forEach(t),Oo=i(D,` can be used to initialize a vision-text dual encoder model with
...
documentation from `),pt=a(kt,"A",{href:!0});var Ns=s(pt);Tn=i(Ns,"PretrainedConfig"),Ns.forEach(t),bn=i(kt," for more information."),kt.forEach(t),En=m(L),b(oe.$$.fragment,L),$n=m(L),ne=a(L,"DIV",{class:!0});var xo=s(ne);b(be.$$.fragment,xo),jn=m(xo),Ee=a(xo,"P",{});var vo=s(Ee);wn=i(vo,"Instantiate a "),ft=a(vo,"A",{href:!0});var Bs=s(ft);yn=i(Bs,"VisionTextDualEncoderConfig"),Bs.forEach(t),kn=i(vo,` (or a derived class) from text model configuration and vision
model configuration.`),vo.forEach(t),xo.forEach(t),Vn=m(L),ae=a(L,"DIV",{class:!0});var To=s(ae);b($e.$$.fragment,To),Dn=m(To),je=a(To,"P",{});var bo=s(je);Pn=i(bo,"Serializes this instance to a Python dictionary. Override the default "),ht=a(bo,"A",{href:!0});var Os=s(ht);Mn=i(Os,"to_dict()"),Os.forEach(t),zn=i(bo,"."),bo.forEach(t),To.forEach(t),L.forEach(t),lo=m(o),Z=a(o,"H2",{class:!0});var Eo=s(Z);se=a(Eo,"A",{id:!0,class:!0,href:!0});var Ws=s(se);qt=a(Ws,"SPAN",{});var Rs=s(qt);b(we.$$.fragment,Rs),Rs.forEach(t),Ws.forEach(t),Cn=m(Eo),Lt=a(Eo,"SPAN",{});var Us=s(Lt);Fn=i(Us,"VisionTextDualEncoderProcessor"),Us.forEach(t),Eo.forEach(t),co=m(o),z=a(o,"DIV",{class:!0});var W=s(z);b(ye.$$.fragment,W),In=m(W),St=a(W,"P",{});var Js=s(St);An=i(Js,`Constructs a VisionTextDualEncoder processor which wraps a vision feature extractor and a tokenizer into a single
...
`),xt=a(B,"A",{href:!0});var Ks=s(xt);Jn=i(Ks,"decode()"),Ks.forEach(t),Hn=i(B," for more information."),B.forEach(t),Zn=m(W),re=a(W,"DIV",{class:!0});var $o=s(re);b(ke.$$.fragment,$o),Gn=m($o),Ve=a($o,"P",{});var jo=s(Ve);Xn=i(jo,`This method forwards all its arguments to VisionTextDualEncoderTokenizer\u2019s
