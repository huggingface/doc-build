...
Legacy dictionary, which is required so that model can use <em>generate()</em> function.`,name:"kwargs"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/rag/modeling_rag.py#L770",returnDescription:`
<p>A <a
...
is not the value we pass to the <code>generator</code>&#x2019;s <code>[generate()](/docs/transformers/main/en/main_classes/text_generation#transformers.GenerationMixin.generate)</code> function,
...
kwargs &#x2014;
Additional kwargs will be passed to <a href="/docs/transformers/main/en/main_classes/text_generation#transformers.GenerationMixin.generate">generate()</a>.`,name:"n_docs"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/rag/modeling_rag.py#L911",returnDescription:`
<p>The generated
...
Legacy dictionary, which is required so that model can use <em>generate()</em> function.`,name:"kwargs"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/rag/modeling_rag.py#L1238",returnDescription:`
<p>A <a
  href="/docs/transformers/main/en/model_doc/rag#transformers.models.rag.modeling_rag.RetrievAugLMMarginOutput"
>transformers.models.rag.modeling_rag.RetrievAugLMMarginOutput</a> or a tuple of
<code>torch.FloatTensor</code> (if <code>return_dict=False</code> is passed or when <code>config.return_dict=False</code>) comprising various
...
The number of independently computed returned sequences for each element in the batch. Note that this
is not the value we pass to the <code>generator</code>&#x2019;s <code>[generate()](/docs/transformers/main/en/main_classes/text_generation#transformers.GenerationMixin.generate) function, where we set </code>num_return_sequences<code>to</code>num_beams<code>. decoder_start_token_id (</code>int\`, <em>optional</em>): If an
...
crash. Note that using <code>remove_invalid_values</code> can slow down generation.`,name:"remove_invalid_values"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/rag/modeling_rag.py#L1379",returnDescription:`
<p>The generated
...
Legacy dictionary, which is required so that model can use <em>generate()</em> function.`,name:"kwargs"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/rag/modeling_tf_rag.py#L1430",returnDescription:`
...
Number of documents to retrieve and/or number of documents for which to generate an answer.
kwargs &#x2014;
Additional kwargs will be passed to <a href="/docs/transformers/main/en/main_classes/text_generation#transformers.GenerationMixin.generate">generate()</a>`,name:"n_docs"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/rag/modeling_tf_rag.py#L1665",returnDescription:`
...
SavedModel format.`),Pu=p(),he=s("div"),T(Wo.$$.fragment),Ou=p(),We=s("p"),Cu=o("The "),ar=s("a"),Lu=o("TFRagSequenceForGeneration"),Su=o(" forward method, overrides the "),ca=s("code"),Du=o("__call__"),Iu=o(" special method."),Uu=p(),T($t.$$.fragment),Wu=p(),T(zt.$$.fragment),Hu=p(),Et=s("div"),T(Ho.$$.fragment),Bu=p(),Bo=s("p"),Qu=o("Implements RAG sequence \u201Cthorough\u201D decoding. Read the "),dr=s("a"),Ku=o("generate()"),Vu=o("` documentation\nfor more information on how to set other generate input parameters"),pd=p(),He=s("h2"),jt=s("a"),la=s("span"),T(Qo.$$.fragment),Yu=p(),pa=s("span"),Ju=o("TFRagTokenForGeneration"),hd=p(),z=s("div"),T(Ko.$$.fragment),Xu=p(),Be=s("p"),Zu=o("The "),ir=s("a"),eg=o("TFRagTokenForGeneration"),tg=o(" forward method, overrides the "),ha=s("code"),og=o("__call__"),ng=o(" special method."),rg=p(),T(Gt.$$.fragment),sg=p(),ma=s("p"),ag=o("A TF RAG-token model implementation. It performs RAG-token specific marginalization in the forward pass."),dg=p(),ua=s("p"),ig=o(`RAG is a sequence-to-sequence model which encapsulates two core components: a question encoder and a generator.
During a forward pass, we encode the input with the question encoder and pass it to the retriever to extract
relevant context documents. The documents are then prepended to the input. Such contextualized inputs is passed to
