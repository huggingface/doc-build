...
PIL images.`),g.forEach(t)},m(f,g){m(f,h,g),e(h,T)},d(f){f&&t(h)}}}function wm(M){let h,T,f,g,v;return{c(){h=a("p"),T=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=a("code"),g=r("Module"),v=r(`
...
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),u.forEach(t)},m(_,u){m(_,h,u),e(h,T),e(h,f),e(f,g),e(h,v)},d(_){_&&t(h)}}}function bm(M){let h,T,f,g,v;return{c(){h=a("p"),T=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=a("code"),g=r("Module"),v=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(_){h=n(_,"P",{});var u=s(h);T=i(u,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=n(u,"CODE",{});var V=s(f);g=i(V,"Module"),V.forEach(t),v=i(u,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
the latter silently ignores them.`)},l(_){h=n(_,"P",{});var u=s(h);T=i(u,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=n(u,"CODE",{});var V=s(f);g=i(V,"Module"),V.forEach(t),v=i(u,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),u.forEach(t)},m(_,u){m(_,h,u),e(h,T),e(h,f),e(f,g),e(h,v)},d(_){_&&t(h)}}}function Mm(M){let h,T,f,g,v,_,u,V,he,R,k,ie,j,B,oe,C,pe,ae,E,I,z,Ie,ne,L,je,Te,Xo,tr,ss,Zo,Da,or,rs,Qo,ar,is,N,Vt,nr,Et,sr,rr,ir,Oa,lr,dr,kt,cr,Yo,hr,pr,mr,Pe,fr,Sa,ur,gr,Mt,_r,vr,Tr,Ce,wr,It,br,yr,jt,$r,xr,Fr,qe,Vr,Pt,Er,kr,Ct,Mr,Ir,jr,Wa,Pr,ls,ea,Cr,ds,le,Ba,P,ta,qr,Ar,oa,zr,Nr,aa,Lr,Dr,Ua,Or,Sr,Ra,Wr,Br,Ha,Ur,Rr,Ja,Hr,Jr,na,Kr,Gr,Xr,Ka,sa,ra,Zr,Qr,Yr,Ga,qt,ei,At,ti,oi,ai,Xa,ia,la,ni,si,cs,we,ri,zt,ii,li,Nt,di,ci,hs,et,hi,Lt,pi,mi,ps,Ae,tt,Za,Dt,fi,Qa,ui,ms,U,Ot,gi,ze,_i,da,vi,Ti,St,wi,bi,yi,Ne,$i,ca,xi,Fi,ha,Vi,Ei,ki,Ya,Mi,Ii,Wt,fs,Le,ot,en,Bt,ji,tn,Pi,us,se,Ut,Ci,on,qi,Ai,Rt,zi,pa,Ni,Li,Di,be,Ht,Oi,an,Si,Wi,at,gs,De,nt,nn,Jt,Bi,sn,Ui,_s,me,Kt,Ri,Gt,Hi,Xt,Ji,Ki,Gi,H,Zt,Xi,Oe,Zi,ma,Qi,Yi,rn,el,tl,ol,st,al,ln,nl,sl,Qt,vs,Se,rt,dn,Yt,rl,cn,il,Ts,fe,eo,ll,We,dl,hn,cl,hl,to,pl,ml,fl,J,oo,ul,Be,gl,fa,_l,vl,pn,Tl,wl,bl,it,yl,mn,$l,xl,ao,ws,Ue,lt,fn,no,Fl,un,Vl,bs,re,so,El,gn,kl,Ml,ro,Il,io,jl,Pl,Cl,K,lo,ql,Re,Al,ua,zl,Nl,_n,Ll,Dl,Ol,dt,Sl,vn,Wl,Bl,co,ys,He,ct,Tn,ho,Ul,wn,Rl,$s,D,po,Hl,bn,Jl,Kl,mo,Gl,ga,Xl,Zl,Ql,fo,Yl,uo,ed,td,od,ht,ad,G,go,nd,Je,sd,_a,rd,id,yn,ld,dd,cd,pt,hd,$n,pd,md,_o,xs,Ke,mt,xn,vo,fd,Fn,ud,Fs,O,To,gd,Vn,_d,vd,wo,Td,va,wd,bd,yd,bo,$d,yo,xd,Fd,Vd,ft,Ed,X,$o,kd,Ge,Md,Ta,Id,jd,En,Pd,Cd,qd,ut,Ad,kn,zd,Nd,xo,Vs,Xe,gt,Mn,Fo,Ld,In,Dd,Es,q,Vo,Od,jn,Sd,Wd,Eo,Bd,wa,Ud,Rd,Hd,ko,Jd,Mo,Kd,Gd,Xd,Pn,Zd,Qd,ue,Cn,Io,Yd,ec,qn,jo,tc,oc,An,Po,ac,nc,zn,Co,sc,rc,Z,qo,ic,Ze,lc,Nn,dc,cc,Ln,hc,pc,mc,_t,fc,Dn,uc,gc,Ao,ks,Qe,vt,On,zo,_c,Sn,vc,Ms,A,No,Tc,Wn,wc,bc,Lo,yc,ba,$c,xc,Fc,Do,Vc,Oo,Ec,kc,Mc,Bn,Ic,jc,ge,Un,So,Pc,Cc,Rn,Wo,qc,Ac,Hn,Bo,zc,Nc,Jn,Uo,Lc,Dc,Q,Ro,Oc,Ye,Sc,Kn,Wc,Bc,Gn,Uc,Rc,Hc,Tt,Jc,Xn,Kc,Gc,Ho,Is;return _=new ve({}),k=new _e({props:{$$slots:{default:[vm]},$$scope:{ctx:M}}}),C=new ve({}),Dt=new ve({}),Ot=new W({props:{name:"class transformers.ViTConfig",anchor:"transformers.ViTConfig",parameters:[{name:"hidden_size",val:" = 768"},{name:"num_hidden_layers",val:" = 12"},{name:"num_attention_heads",val:" = 12"},{name:"intermediate_size",val:" = 3072"},{name:"hidden_act",val:" = 'gelu'"},{name:"hidden_dropout_prob",val:" = 0.0"},{name:"attention_probs_dropout_prob",val:" = 0.0"},{name:"initializer_range",val:" = 0.02"},{name:"layer_norm_eps",val:" = 1e-12"},{name:"is_encoder_decoder",val:" = False"},{name:"image_size",val:" = 224"},{name:"patch_size",val:" = 16"},{name:"num_channels",val:" = 3"},{name:"qkv_bias",val:" = True"},{name:"encoder_stride",val:" = 16"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/vit/configuration_vit.py#L35",parametersDescription:[{anchor:"transformers.ViTConfig.hidden_size",description:`<strong>hidden_size</strong> (<code>int</code>, <em>optional</em>, defaults to 768) &#x2014;
...
`}}),st=new _e({props:{$$slots:{default:[wm]},$$scope:{ctx:M}}}),Qt=new Ft({props:{code:`from transformers import ViTFeatureExtractor, ViTModel
import torch
...
[<span class="hljs-number">1</span>, <span class="hljs-number">3</span>, <span class="hljs-number">224</span>, <span class="hljs-number">224</span>]`}}),no=new ve({}),so=new W({props:{name:"class transformers.ViTForImageClassification",anchor:"transformers.ViTForImageClassification",parameters:[{name:"config",val:""}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/vit/modeling_vit.py#L726",parametersDescription:[{anchor:"transformers.ViTForImageClassification.config",description:`<strong>config</strong> (<a href="/docs/transformers/main/en/model_doc/vit#transformers.ViTConfig">ViTConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
...
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-built_in">print</span>(<span class="hljs-string">&quot;Predicted class:&quot;</span>, model.config.id2label[predicted_class_idx.item()])`}}),{c(){h=a("meta"),T=d(),f=a("h1"),g=a("a"),v=a("span"),w(_.$$.fragment),u=d(),V=a("span"),he=r("Vision Transformer (ViT)"),R=d(),w(k.$$.fragment),ie=d(),j=a("h2"),B=a("a"),oe=a("span"),w(C.$$.fragment),pe=d(),ae=a("span"),E=r("Overview"),I=d(),z=a("p"),Ie=r("The Vision Transformer (ViT) model was proposed in "),ne=a("a"),L=r(`An Image is Worth 16x16 Words: Transformers for Image Recognition
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Vd=d(),w(ft.$$.fragment),Ed=d(),X=a("div"),w($o.$$.fragment),kd=d(),Ge=a("p"),Md=r("The "),Ta=a("a"),Id=r("TFViTForImageClassification"),jd=r(" forward method, overrides the "),En=a("code"),Pd=r("__call__"),Cd=r(" special method."),qd=d(),w(ut.$$.fragment),Ad=d(),kn=a("p"),zd=r("Examples:"),Nd=d(),w(xo.$$.fragment),Vs=d(),Xe=a("h2"),gt=a("a"),Mn=a("span"),w(Fo.$$.fragment),Ld=d(),In=a("span"),Dd=r("FlaxVitModel"),Es=d(),q=a("div"),w(Vo.$$.fragment),Od=d(),jn=a("p"),Sd=r("The bare ViT Model transformer outputting raw hidden-states without any specific head on top."),Wd=d(),Eo=a("p"),Bd=r("This model inherits from "),wa=a("a"),Ud=r("FlaxPreTrainedModel"),Rd=r(`. Check the superclass documentation for the generic methods the
...
general usage and behavior.`),Xd=d(),Pn=a("p"),Zd=r("Finally, this model supports inherent JAX features such as:"),Qd=d(),ue=a("ul"),Cn=a("li"),Io=a("a"),Yd=r("Just-In-Time (JIT) compilation"),ec=d(),qn=a("li"),jo=a("a"),tc=r("Automatic Differentiation"),oc=d(),An=a("li"),Po=a("a"),ac=r("Vectorization"),nc=d(),zn=a("li"),Co=a("a"),sc=r("Parallelization"),rc=d(),Z=a("div"),w(qo.$$.fragment),ic=d(),Ze=a("p"),lc=r("The "),Nn=a("code"),dc=r("FlaxViTPreTrainedModel"),cc=r("forward method, overrides the "),Ln=a("code"),hc=r("__call__"),pc=r(" special method."),mc=d(),w(_t.$$.fragment),fc=d(),Dn=a("p"),uc=r("Examples:"),gc=d(),w(Ao.$$.fragment),ks=d(),Qe=a("h2"),vt=a("a"),On=a("span"),w(zo.$$.fragment),_c=d(),Sn=a("span"),vc=r("FlaxViTForImageClassification"),Ms=d(),A=a("div"),w(No.$$.fragment),Tc=d(),Wn=a("p"),wc=r(`ViT Model transformer with an image classification head on top (a linear layer on top of the final hidden state of
...
resolution of 16x16 and fine-tuning resolution of 224x224. All checkpoints can be found on the `),Mt=n(ya,"A",{href:!0,rel:!0});var sh=s(Mt);_r=i(sh,"hub"),sh.forEach(t),vr=i(ya,"."),ya.forEach(t),Tr=c(Y),Ce=n(Y,"LI",{});var $a=s(Ce);wr=i($a,"The available checkpoints are either (1) pre-trained on "),It=n($a,"A",{href:!0,rel:!0});var rh=s(It);br=i(rh,"ImageNet-21k"),rh.forEach(t),yr=i($a,` (a collection of
...
found `),Nt=n(Fa,"A",{href:!0,rel:!0});var kh=s(Nt);di=i(kh,"here"),kh.forEach(t),ci=i(Fa,"."),Fa.forEach(t),hs=c(o),et=n(o,"P",{});var qs=s(et);hi=i(qs,"Note that we converted the weights from Ross Wightman\u2019s "),Lt=n(qs,"A",{href:!0,rel:!0});var Mh=s(Lt);pi=i(Mh,"timm library"),Mh.forEach(t),mi=i(qs,`, who already converted the weights from JAX to PyTorch. Credits
go to him!`),qs.forEach(t),ps=c(o),Ae=n(o,"H2",{class:!0});var As=s(Ae);tt=n(As,"A",{id:!0,class:!0,href:!0});var Ih=s(tt);Za=n(Ih,"SPAN",{});var jh=s(Za);b(Dt.$$.fragment,jh),jh.forEach(t),Ih.forEach(t),fi=c(As),Qa=n(As,"SPAN",{});var Ph=s(Qa);ui=i(Ph,"ViTConfig"),Ph.forEach(t),As.forEach(t),ms=c(o),U=n(o,"DIV",{class:!0});var ye=s(U);b(Ot.$$.fragment,ye),gi=c(ye),ze=n(ye,"P",{});var Va=s(ze);_i=i(Va,"This is the configuration class to store the configuration of a "),da=n(Va,"A",{href:!0});var Ch=s(da);vi=i(Ch,"ViTModel"),Ch.forEach(t),Ti=i(Va,`. It is used to instantiate an ViT
model according to the specified arguments, defining the model architecture. Instantiating a configuration with the
defaults will yield a similar configuration to that of the ViT
