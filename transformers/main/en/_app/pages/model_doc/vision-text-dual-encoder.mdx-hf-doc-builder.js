import{S as Pr,i as Mr,s as zr,e as n,k as c,w as T,t as r,M as Cr,c as a,d as t,m,a as s,x as b,h as i,b as l,G as e,g as _,y as E,q as $,o as y,B as w,v as Ir,L as vs}from"../../chunks/vendor-hf-doc-builder.js";import{T as Dr}from"../../chunks/Tip-hf-doc-builder.js";import{D as R}from"../../chunks/Docstring-hf-doc-builder.js";import{C as Ts}from"../../chunks/CodeBlock-hf-doc-builder.js";import{I as Pt}from"../../chunks/IconCopyLink-hf-doc-builder.js";import{E as xs}from"../../chunks/ExampleCodeBlock-hf-doc-builder.js";function Fr(F){let p,v,g,f,x;return f=new Ts({props:{code:`from transformers import ViTConfig, BertConfig, VisionTextDualEncoderConfig, VisionTextDualEncoderModel
...
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),h.forEach(t)},m(d,h){_(d,p,h),e(p,v),e(p,g),e(g,f),e(p,x)},d(d){d&&t(p)}}}function qr(F){let p,v,g,f,x;return f=new Ts({props:{code:`from PIL import Image
import requests
...
<span class="hljs-meta">&gt;&gt;&gt; </span>probs = logits_per_image.softmax(dim=<span class="hljs-number">1</span>)  <span class="hljs-comment"># we can take the softmax to get the label probabilities</span>`}}),{c(){p=n("p"),v=r("Examples:"),g=c(),T(f.$$.fragment)},l(d){p=a(d,"P",{});var h=s(p);v=i(h,"Examples:"),h.forEach(t),g=m(d),b(f.$$.fragment,d)},m(d,h){_(d,p,h),e(p,v),_(d,g,h),E(f,d,h),x=!0},p:vs,i(d){x||($(f.$$.fragment,d),x=!0)},o(d){y(f.$$.fragment,d),x=!1},d(d){d&&t(p),d&&t(g),w(f,d)}}}function Lr(F){let p,v,g,f,x;return{c(){p=n("p"),v=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),g=n("code"),f=r("Module"),x=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(d){p=a(d,"P",{});var h=s(p);v=i(h,"Although the recipe for forward pass needs to be defined within this function, one should call the "),g=a(h,"CODE",{});var S=s(g);f=i(S,"Module"),S.forEach(t),x=i(h,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),h.forEach(t)},m(d,h){_(d,p,h),e(p,v),e(p,g),e(g,f),e(p,x)},d(d){d&&t(p)}}}function Sr(F){let p,v,g,f,x;return f=new Ts({props:{code:`from PIL import Image
import requests
import jax
from transformers import (
...
<span class="hljs-meta">&gt;&gt;&gt; </span>outputs = model(**inputs)
<span class="hljs-meta">&gt;&gt;&gt; </span>logits_per_image = outputs.logits_per_image  <span class="hljs-comment"># this is the image-text similarity score</span>
<span class="hljs-meta">&gt;&gt;&gt; </span>probs = jax.nn.softmax(logits_per_image, axis=<span class="hljs-number">1</span>)  <span class="hljs-comment"># we can take the softmax to get the label probabilities</span>`}}),{c(){p=n("p"),v=r("Examples:"),g=c(),T(f.$$.fragment)},l(d){p=a(d,"P",{});var h=s(p);v=i(h,"Examples:"),h.forEach(t),g=m(d),b(f.$$.fragment,d)},m(d,h){_(d,p,h),e(p,v),_(d,g,h),E(f,d,h),x=!0},p:vs,i(d){x||($(f.$$.fragment,d),x=!0)},o(d){y(f.$$.fragment,d),x=!1},d(d){d&&t(p),d&&t(g),w(f,d)}}}function Nr(F){let p,v,g,f,x,d,h,S,qo,no,U,Y,Mt,_e,Lo,zt,So,ao,k,No,ot,Bo,Oo,Ct,Wo,Ro,nt,Uo,Jo,at,Ho,Zo,st,Go,Xo,It,Ko,Qo,rt,Yo,en,it,tn,on,so,ee,nn,xe,an,sn,ro,J,te,Ft,ve,rn,At,ln,io,M,Te,dn,O,lt,cn,mn,dt,pn,fn,ct,hn,un,gn,H,_n,mt,xn,vn,pt,Tn,bn,En,oe,$n,ne,be,yn,Ee,wn,ft,jn,kn,Vn,ae,$e,Dn,ye,Pn,ht,Mn,zn,lo,Z,se,qt,we,Cn,Lt,In,co,z,je,Fn,St,An,qn,C,ut,Ln,Sn,gt,Nn,Bn,_t,On,Wn,Nt,Rn,Un,xt,Jn,Hn,Zn,re,ke,Gn,Ve,Xn,vt,Kn,Qn,Yn,ie,De,ea,Pe,ta,Tt,oa,na,mo,G,le,Bt,Me,aa,Ot,sa,po,V,ze,ra,Ce,ia,bt,la,da,ca,Ie,ma,Fe,pa,fa,ha,Wt,ua,ga,Ae,_a,Et,xa,va,Ta,qe,ba,Le,Ea,$a,ya,A,Se,wa,X,ja,$t,ka,Va,Rt,Da,Pa,Ma,de,za,ce,fo,K,me,Ut,Ne,Ca,Jt,Ia,ho,j,Be,Fa,Oe,Aa,yt,qa,La,Sa,We,Na,Re,Ba,Oa,Wa,Ht,Ra,Ua,Ue,Ja,wt,Ha,Za,Ga,Je,Xa,He,Ka,Qa,Ya,Zt,es,ts,N,Gt,Ze,os,ns,Xt,Ge,as,ss,Kt,Xe,rs,is,Qt,Ke,ls,ds,q,Qe,cs,Q,ms,jt,ps,fs,Yt,hs,us,gs,pe,_s,fe,uo;return d=new Pt({}),_e=new Pt({}),ve=new Pt({}),Te=new R({props:{name:"class transformers.VisionTextDualEncoderConfig",anchor:"transformers.VisionTextDualEncoderConfig",parameters:[{name:"projection_dim",val:" = 512"},{name:"logit_scale_init_value",val:" = 2.6592"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.VisionTextDualEncoderConfig.text_config",description:`<strong>text_config</strong> (<code>dict</code>) &#x2014;
...
`}}),we=new Pt({}),je=new R({props:{name:"class transformers.VisionTextDualEncoderProcessor",anchor:"transformers.VisionTextDualEncoderProcessor",parameters:[{name:"feature_extractor",val:""},{name:"tokenizer",val:""}],parametersDescription:[{anchor:"transformers.VisionTextDualEncoderProcessor.feature_extractor",description:`<strong>feature_extractor</strong> (<a href="/docs/transformers/main/en/model_doc/auto#transformers.AutoFeatureExtractor">AutoFeatureExtractor</a>) &#x2014;
...
a feature extractor (e.g. if you use ViT as the encoder, you should use <a href="/docs/transformers/main/en/model_doc/vit#transformers.models.vit.image_processing_vit.ViTImageProcessor">ViTFeatureExtractor</a>). See
...
`}}),de=new Dr({props:{$$slots:{default:[Ar]},$$scope:{ctx:F}}}),ce=new xs({props:{anchor:"transformers.VisionTextDualEncoderModel.forward.example",$$slots:{default:[qr]},$$scope:{ctx:F}}}),Ne=new Pt({}),Be=new R({props:{name:"class transformers.FlaxVisionTextDualEncoderModel",anchor:"transformers.FlaxVisionTextDualEncoderModel",parameters:[{name:"config",val:": VisionTextDualEncoderConfig"},{name:"input_shape",val:": typing.Optional[typing.Tuple] = None"},{name:"seed",val:": int = 0"},{name:"dtype",val:": dtype = <class 'jax.numpy.float32'>"},{name:"_do_init",val:": bool = True"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.FlaxVisionTextDualEncoderModel.config",description:`<strong>config</strong> (<a href="/docs/transformers/main/en/model_doc/vision-text-dual-encoder#transformers.VisionTextDualEncoderConfig">VisionTextDualEncoderConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
...
`}}),pe=new Dr({props:{$$slots:{default:[Lr]},$$scope:{ctx:F}}}),fe=new xs({props:{anchor:"transformers.FlaxVisionTextDualEncoderModel.__call__.example",$$slots:{default:[Sr]},$$scope:{ctx:F}}}),{c(){p=n("meta"),v=c(),g=n("h1"),f=n("a"),x=n("span"),T(d.$$.fragment),h=c(),S=n("span"),qo=r("VisionTextDualEncoder"),no=c(),U=n("h2"),Y=n("a"),Mt=n("span"),T(_e.$$.fragment),Lo=c(),zt=n("span"),So=r("Overview"),ao=c(),k=n("p"),No=r("The "),ot=n("a"),Bo=r("VisionTextDualEncoderModel"),Oo=r(` can be used to initialize a vision-text dual encoder model with
...
new zero-shot vision tasks such as image classification or retrieval.`),ro=c(),J=n("h2"),te=n("a"),Ft=n("span"),T(ve.$$.fragment),rn=c(),At=n("span"),ln=r("VisionTextDualEncoderConfig"),io=c(),M=n("div"),T(Te.$$.fragment),dn=c(),O=n("p"),lt=n("a"),cn=r("VisionTextDualEncoderConfig"),mn=r(` is the configuration class to store the configuration of a
...
documentation from `),pt=n("a"),Tn=r("PretrainedConfig"),bn=r(" for more information."),En=c(),T(oe.$$.fragment),$n=c(),ne=n("div"),T(be.$$.fragment),yn=c(),Ee=n("p"),wn=r("Instantiate a "),ft=n("a"),jn=r("VisionTextDualEncoderConfig"),kn=r(` (or a derived class) from text model configuration and vision
model configuration.`),Vn=c(),ae=n("div"),T($e.$$.fragment),Dn=c(),ye=n("p"),Pn=r("Serializes this instance to a Python dictionary. Override the default "),ht=n("a"),Mn=r("to_dict()"),zn=r("."),lo=c(),Z=n("h2"),se=n("a"),qt=n("span"),T(we.$$.fragment),Cn=c(),Lt=n("span"),In=r("VisionTextDualEncoderProcessor"),co=c(),z=n("div"),T(je.$$.fragment),Fn=c(),St=n("p"),An=r(`Constructs a VisionTextDualEncoder processor which wraps a vision feature extractor and a tokenizer into a single
...
should be fine-tuned on a downstream task, like contrastive image-text modeling.`),ca=c(),Ie=n("p"),ma=r("In "),Fe=n("a"),pa=r("LiT: Zero-Shot Transfer with Locked-image Text Tuning"),fa=r(` it is shown how
...
and behavior.`),ya=c(),A=n("div"),T(Se.$$.fragment),wa=c(),X=n("p"),ja=r("The "),$t=n("a"),ka=r("VisionTextDualEncoderModel"),Va=r(" forward method, overrides the "),Rt=n("code"),Da=r("__call__"),Pa=r(" special method."),Ma=c(),T(de.$$.fragment),za=c(),T(ce.$$.fragment),fo=c(),K=n("h2"),me=n("a"),Ut=n("span"),T(Ne.$$.fragment),Ca=c(),Jt=n("span"),Ia=r("FlaxVisionTextDualEncoderModel"),ho=c(),j=n("div"),T(Be.$$.fragment),Fa=c(),Oe=n("p"),Aa=r(`This class can be used to initialize a vision-text dual encoder model with any pretrained vision autoencoding model
as the vision encoder and any pretrained text model as the text encoder. The vision and text encoders are loaded
via the `),yt=n("a"),qa=r("from_pretrained()"),La=r(` method. The projection layers are automatically added to the model and
should be fine-tuned on a downstream task, like contrastive image-text modeling.`),Sa=c(),We=n("p"),Na=r("In "),Re=n("a"),Ba=r("LiT: Zero-Shot Transfer with Locked-image Text Tuning"),Oa=r(` it is shown how
leveraging pre-trained (locked/frozen) image and text model for contrastive learning yields significant improvment
...
general usage and behavior.`),Ya=c(),Zt=n("p"),es=r("Finally, this model supports inherent JAX features such as:"),ts=c(),N=n("ul"),Gt=n("li"),Ze=n("a"),os=r("Just-In-Time (JIT) compilation"),ns=c(),Xt=n("li"),Ge=n("a"),as=r("Automatic Differentiation"),ss=c(),Kt=n("li"),Xe=n("a"),rs=r("Vectorization"),is=c(),Qt=n("li"),Ke=n("a"),ls=r("Parallelization"),ds=c(),q=n("div"),T(Qe.$$.fragment),cs=c(),Q=n("p"),ms=r("The "),jt=n("a"),ps=r("FlaxVisionTextDualEncoderModel"),fs=r(" forward method, overrides the "),Yt=n("code"),hs=r("__call__"),us=r(" special method."),gs=c(),T(pe.$$.fragment),_s=c(),T(fe.$$.fragment),this.h()},l(o){const u=Cr('[data-svelte="svelte-1phssyn"]',document.head);p=a(u,"META",{name:!0,content:!0}),u.forEach(t),v=m(o),g=a(o,"H1",{class:!0});var Ye=s(g);f=a(Ye,"A",{id:!0,class:!0,href:!0});var eo=s(f);x=a(eo,"SPAN",{});var to=s(x);b(d.$$.fragment,to),to.forEach(t),eo.forEach(t),h=m(Ye),S=a(Ye,"SPAN",{});var oo=s(S);qo=i(oo,"VisionTextDualEncoder"),oo.forEach(t),Ye.forEach(t),no=m(o),U=a(o,"H2",{class:!0});var et=s(U);Y=a(et,"A",{id:!0,class:!0,href:!0});var bs=s(Y);Mt=a(bs,"SPAN",{});var Es=s(Mt);b(_e.$$.fragment,Es),Es.forEach(t),bs.forEach(t),Lo=m(et),zt=a(et,"SPAN",{});var $s=s(zt);So=i($s,"Overview"),$s.forEach(t),et.forEach(t),ao=m(o),k=a(o,"P",{});var D=s(k);No=i(D,"The "),ot=a(D,"A",{href:!0});var ys=s(ot);Bo=i(ys,"VisionTextDualEncoderModel"),ys.forEach(t),Oo=i(D,` can be used to initialize a vision-text dual encoder model with
any pretrained vision autoencoding model as the vision encoder (`),Ct=a(D,"EM",{});var ws=s(Ct);Wo=i(ws,"e.g."),ws.forEach(t),Ro=m(D),nt=a(D,"A",{href:!0});var js=s(nt);Uo=i(js,"ViT"),js.forEach(t),Jo=i(D,", "),at=a(D,"A",{href:!0});var ks=s(at);Ho=i(ks,"BEiT"),ks.forEach(t),Zo=i(D,", "),st=a(D,"A",{href:!0});var Vs=s(st);Go=i(Vs,"DeiT"),Vs.forEach(t),Xo=i(D,") and any pretrained text autoencoding model as the text encoder ("),It=a(D,"EM",{});var Ds=s(It);Ko=i(Ds,"e.g."),Ds.forEach(t),Qo=m(D),rt=a(D,"A",{href:!0});var Ps=s(rt);Yo=i(Ps,"RoBERTa"),Ps.forEach(t),en=i(D,", "),it=a(D,"A",{href:!0});var Ms=s(it);tn=i(Ms,"BERT"),Ms.forEach(t),on=i(D,`). Two projection layers are added on top of both the vision and text encoder to project the output embeddings
to a shared latent space. The projection layers are randomly initialized so the model should be fine-tuned on a
downstream task. This model can be used to align the vision-text embeddings using CLIP like contrastive image-text
...
leveraging pre-trained (locked/frozen) image and text model for contrastive learning yields significant improvement on
new zero-shot vision tasks such as image classification or retrieval.`),go.forEach(t),ro=m(o),J=a(o,"H2",{class:!0});var _o=s(J);te=a(_o,"A",{id:!0,class:!0,href:!0});var Cs=s(te);Ft=a(Cs,"SPAN",{});var Is=s(Ft);b(ve.$$.fragment,Is),Is.forEach(t),Cs.forEach(t),rn=m(_o),At=a(_o,"SPAN",{});var Fs=s(At);ln=i(Fs,"VisionTextDualEncoderConfig"),Fs.forEach(t),_o.forEach(t),io=m(o),M=a(o,"DIV",{class:!0});var L=s(M);b(Te.$$.fragment,L),dn=m(L),O=a(L,"P",{});var tt=s(O);lt=a(tt,"A",{href:!0});var As=s(lt);cn=i(As,"VisionTextDualEncoderConfig"),As.forEach(t),mn=i(tt,` is the configuration class to store the configuration of a
...
documentation from `),pt=a(kt,"A",{href:!0});var Ns=s(pt);Tn=i(Ns,"PretrainedConfig"),Ns.forEach(t),bn=i(kt," for more information."),kt.forEach(t),En=m(L),b(oe.$$.fragment,L),$n=m(L),ne=a(L,"DIV",{class:!0});var xo=s(ne);b(be.$$.fragment,xo),yn=m(xo),Ee=a(xo,"P",{});var vo=s(Ee);wn=i(vo,"Instantiate a "),ft=a(vo,"A",{href:!0});var Bs=s(ft);jn=i(Bs,"VisionTextDualEncoderConfig"),Bs.forEach(t),kn=i(vo,` (or a derived class) from text model configuration and vision
model configuration.`),vo.forEach(t),xo.forEach(t),Vn=m(L),ae=a(L,"DIV",{class:!0});var To=s(ae);b($e.$$.fragment,To),Dn=m(To),ye=a(To,"P",{});var bo=s(ye);Pn=i(bo,"Serializes this instance to a Python dictionary. Override the default "),ht=a(bo,"A",{href:!0});var Os=s(ht);Mn=i(Os,"to_dict()"),Os.forEach(t),zn=i(bo,"."),bo.forEach(t),To.forEach(t),L.forEach(t),lo=m(o),Z=a(o,"H2",{class:!0});var Eo=s(Z);se=a(Eo,"A",{id:!0,class:!0,href:!0});var Ws=s(se);qt=a(Ws,"SPAN",{});var Rs=s(qt);b(we.$$.fragment,Rs),Rs.forEach(t),Ws.forEach(t),Cn=m(Eo),Lt=a(Eo,"SPAN",{});var Us=s(Lt);In=i(Us,"VisionTextDualEncoderProcessor"),Us.forEach(t),Eo.forEach(t),co=m(o),z=a(o,"DIV",{class:!0});var W=s(z);b(je.$$.fragment,W),Fn=m(W),St=a(W,"P",{});var Js=s(St);An=i(Js,`Constructs a VisionTextDualEncoder processor which wraps a vision feature extractor and a tokenizer into a single
processor.`),Js.forEach(t),qn=m(W),C=a(W,"P",{});var B=s(C);ut=a(B,"A",{href:!0});var Hs=s(ut);Ln=i(Hs,"VisionTextDualEncoderProcessor"),Hs.forEach(t),Sn=i(B," offers all the functionalities of "),gt=a(B,"A",{href:!0});var Zs=s(gt);Nn=i(Zs,"AutoFeatureExtractor"),Zs.forEach(t),Bn=i(B,` and
`),_t=a(B,"A",{href:!0});var Gs=s(_t);On=i(Gs,"AutoTokenizer"),Gs.forEach(t),Wn=i(B,". See the "),Nt=a(B,"CODE",{});var Xs=s(Nt);Rn=i(Xs,"__call__()"),Xs.forEach(t),Un=i(B,` and
`),xt=a(B,"A",{href:!0});var Ks=s(xt);Jn=i(Ks,"decode()"),Ks.forEach(t),Hn=i(B," for more information."),B.forEach(t),Zn=m(W),re=a(W,"DIV",{class:!0});var $o=s(re);b(ke.$$.fragment,$o),Gn=m($o),Ve=a($o,"P",{});var yo=s(Ve);Xn=i(yo,`This method forwards all its arguments to VisionTextDualEncoderTokenizer\u2019s
`),vt=a(yo,"A",{href:!0});var Qs=s(vt);Kn=i(Qs,"batch_decode()"),Qs.forEach(t),Qn=i(yo,". Please refer to the docstring of this method for more information."),yo.forEach(t),$o.forEach(t),Yn=m(W),ie=a(W,"DIV",{class:!0});var wo=s(ie);b(De.$$.fragment,wo),ea=m(wo),Pe=a(wo,"P",{});var jo=s(Pe);ta=i(jo,"This method forwards all its arguments to VisionTextDualEncoderTokenizer\u2019s "),Tt=a(jo,"A",{href:!0});var Ys=s(Tt);oa=i(Ys,"decode()"),Ys.forEach(t),na=i(jo,`.
Please refer to the docstring of this method for more information.`),jo.forEach(t),wo.forEach(t),W.forEach(t),mo=m(o),G=a(o,"H2",{class:!0});var ko=s(G);le=a(ko,"A",{id:!0,class:!0,href:!0});var er=s(le);Bt=a(er,"SPAN",{});var tr=s(Bt);b(Me.$$.fragment,tr),tr.forEach(t),er.forEach(t),aa=m(ko),Ot=a(ko,"SPAN",{});var or=s(Ot);sa=i(or,"VisionTextDualEncoderModel"),or.forEach(t),ko.forEach(t),po=m(o),V=a(o,"DIV",{class:!0});var I=s(V);b(ze.$$.fragment,I),ra=m(I),Ce=a(I,"P",{});var Vo=s(Ce);ia=i(Vo,`This class can be used to initialize a vision-text dual encoder model with any pretrained vision autoencoding model
as the vision encoder and any pretrained text model as the text encoder. The vision and text encoders are loaded
...
should be fine-tuned on a downstream task, like contrastive image-text modeling.`),Vo.forEach(t),ca=m(I),Ie=a(I,"P",{});var Do=s(Ie);ma=i(Do,"In "),Fe=a(Do,"A",{href:!0,rel:!0});var ar=s(Fe);pa=i(ar,"LiT: Zero-Shot Transfer with Locked-image Text Tuning"),ar.forEach(t),fa=i(Do,` it is shown how
leveraging pre-trained (locked/frozen) image and text model for contrastive learning yields significant improvment
on new zero-shot vision tasks such as image classification or retrieval.`),Do.forEach(t),ha=m(I),Wt=a(I,"P",{});var sr=s(Wt);ua=i(sr,`After such a Vision-Text-Dual-Encoder model has been trained/fine-tuned, it can be saved/loaded just like any other
models (see the examples for more information).`),sr.forEach(t),ga=m(I),Ae=a(I,"P",{});var Po=s(Ae);_a=i(Po,"This model inherits from "),Et=a(Po,"A",{href:!0});var rr=s(Et);xa=i(rr,"PreTrainedModel"),rr.forEach(t),va=i(Po,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Po.forEach(t),Ta=m(I),qe=a(I,"P",{});var Mo=s(qe);ba=i(Mo,"This model is also a PyTorch "),Le=a(Mo,"A",{href:!0,rel:!0});var ir=s(Le);Ea=i(ir,"torch.nn.Module"),ir.forEach(t),$a=i(Mo,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Mo.forEach(t),ya=m(I),A=a(I,"DIV",{class:!0});var he=s(A);b(Se.$$.fragment,he),wa=m(he),X=a(he,"P",{});var Vt=s(X);ja=i(Vt,"The "),$t=a(Vt,"A",{href:!0});var lr=s($t);ka=i(lr,"VisionTextDualEncoderModel"),lr.forEach(t),Va=i(Vt," forward method, overrides the "),Rt=a(Vt,"CODE",{});var dr=s(Rt);Da=i(dr,"__call__"),dr.forEach(t),Pa=i(Vt," special method."),Vt.forEach(t),Ma=m(he),b(de.$$.fragment,he),za=m(he),b(ce.$$.fragment,he),he.forEach(t),I.forEach(t),fo=m(o),K=a(o,"H2",{class:!0});var zo=s(K);me=a(zo,"A",{id:!0,class:!0,href:!0});var cr=s(me);Ut=a(cr,"SPAN",{});var mr=s(Ut);b(Ne.$$.fragment,mr),mr.forEach(t),cr.forEach(t),Ca=m(zo),Jt=a(zo,"SPAN",{});var pr=s(Jt);Ia=i(pr,"FlaxVisionTextDualEncoderModel"),pr.forEach(t),zo.forEach(t),ho=m(o),j=a(o,"DIV",{class:!0});var P=s(j);b(Be.$$.fragment,P),Fa=m(P),Oe=a(P,"P",{});var Co=s(Oe);Aa=i(Co,`This class can be used to initialize a vision-text dual encoder model with any pretrained vision autoencoding model
as the vision encoder and any pretrained text model as the text encoder. The vision and text encoders are loaded
via the `),yt=a(Co,"A",{href:!0});var fr=s(yt);qa=i(fr,"from_pretrained()"),fr.forEach(t),La=i(Co,` method. The projection layers are automatically added to the model and
should be fine-tuned on a downstream task, like contrastive image-text modeling.`),Co.forEach(t),Sa=m(P),We=a(P,"P",{});var Io=s(We);Na=i(Io,"In "),Re=a(Io,"A",{href:!0,rel:!0});var hr=s(Re);Ba=i(hr,"LiT: Zero-Shot Transfer with Locked-image Text Tuning"),hr.forEach(t),Oa=i(Io,` it is shown how
leveraging pre-trained (locked/frozen) image and text model for contrastive learning yields significant improvment
on new zero-shot vision tasks such as image classification or retrieval.`),Io.forEach(t),Wa=m(P),Ht=a(P,"P",{});var ur=s(Ht);Ra=i(ur,`After such a Vision-Text-Dual-Encoder model has been trained/fine-tuned, it can be saved/loaded just like any other
models (see the examples for more information).`),ur.forEach(t),Ua=m(P),Ue=a(P,"P",{});var Fo=s(Ue);Ja=i(Fo,"This model inherits from "),wt=a(Fo,"A",{href:!0});var gr=s(wt);Ha=i(gr,"PreTrainedModel"),gr.forEach(t),Za=i(Fo,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Fo.forEach(t),Ga=m(P),Je=a(P,"P",{});var Ao=s(Je);Xa=i(Ao,"This model is also a Flax Linen "),He=a(Ao,"A",{href:!0,rel:!0});var _r=s(He);Ka=i(_r,"flax.linen.Module"),_r.forEach(t),Qa=i(Ao,`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),Ao.forEach(t),Ya=m(P),Zt=a(P,"P",{});var xr=s(Zt);es=i(xr,"Finally, this model supports inherent JAX features such as:"),xr.forEach(t),ts=m(P),N=a(P,"UL",{});var ue=s(N);Gt=a(ue,"LI",{});var vr=s(Gt);Ze=a(vr,"A",{href:!0,rel:!0});var Tr=s(Ze);os=i(Tr,"Just-In-Time (JIT) compilation"),Tr.forEach(t),vr.forEach(t),ns=m(ue),Xt=a(ue,"LI",{});var br=s(Xt);Ge=a(br,"A",{href:!0,rel:!0});var Er=s(Ge);as=i(Er,"Automatic Differentiation"),Er.forEach(t),br.forEach(t),ss=m(ue),Kt=a(ue,"LI",{});var $r=s(Kt);Xe=a($r,"A",{href:!0,rel:!0});var yr=s(Xe);rs=i(yr,"Vectorization"),yr.forEach(t),$r.forEach(t),is=m(ue),Qt=a(ue,"LI",{});var wr=s(Qt);Ke=a(wr,"A",{href:!0,rel:!0});var jr=s(Ke);ls=i(jr,"Parallelization"),jr.forEach(t),wr.forEach(t),ue.forEach(t),ds=m(P),q=a(P,"DIV",{class:!0});var ge=s(q);b(Qe.$$.fragment,ge),cs=m(ge),Q=a(ge,"P",{});var Dt=s(Q);ms=i(Dt,"The "),jt=a(Dt,"A",{href:!0});var kr=s(jt);ps=i(kr,"FlaxVisionTextDualEncoderModel"),kr.forEach(t),fs=i(Dt," forward method, overrides the "),Yt=a(Dt,"CODE",{});var Vr=s(Yt);hs=i(Vr,"__call__"),Vr.forEach(t),us=i(Dt," special method."),Dt.forEach(t),gs=m(ge),b(pe.$$.fragment,ge),_s=m(ge),b(fe.$$.fragment,ge),ge.forEach(t),P.forEach(t),this.h()},h(){l(p,"name","hf:doc:metadata"),l(p,"content",JSON.stringify(Br)),l(f,"id","visiontextdualencoder"),l(f,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),l(f,"href","#visiontextdualencoder"),l(g,"class","relative group"),l(Y,"id","overview"),l(Y,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),l(Y,"href","#overview"),l(U,"class","relative group"),l(ot,"href","/docs/transformers/main/en/model_doc/vision-text-dual-encoder#transformers.VisionTextDualEncoderModel"),l(nt,"href","vit"),l(at,"href","beit"),l(st,"href","deit"),l(rt,"href","roberta"),l(it,"href","bert"),l(xe,"href","https://arxiv.org/abs/2111.07991"),l(xe,"rel","nofollow"),l(te,"id","transformers.VisionTextDualEncoderConfig"),l(te,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),l(te,"href","#transformers.VisionTextDualEncoderConfig"),l(J,"class","relative group"),l(lt,"href","/docs/transformers/main/en/model_doc/vision-text-dual-encoder#transformers.VisionTextDualEncoderConfig"),l(dt,"href","/docs/transformers/main/en/model_doc/vision-text-dual-encoder#transformers.VisionTextDualEncoderModel"),l(ct,"href","/docs/transformers/main/en/model_doc/vision-text-dual-encoder#transformers.VisionTextDualEncoderModel"),l(mt,"href","/docs/transformers/main/en/main_classes/configuration#transformers.PretrainedConfig"),l(pt,"href","/docs/transformers/main/en/main_classes/configuration#transformers.PretrainedConfig"),l(ft,"href","/docs/transformers/main/en/model_doc/vision-text-dual-encoder#transformers.VisionTextDualEncoderConfig"),l(ne,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),l(ht,"href","/docs/transformers/main/en/main_classes/configuration#transformers.PretrainedConfig.to_dict"),l(ae,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),l(M,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),l(se,"id","transformers.VisionTextDualEncoderProcessor"),l(se,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),l(se,"href","#transformers.VisionTextDualEncoderProcessor"),l(Z,"class","relative group"),l(ut,"href","/docs/transformers/main/en/model_doc/vision-text-dual-encoder#transformers.VisionTextDualEncoderProcessor"),l(gt,"href","/docs/transformers/main/en/model_doc/auto#transformers.AutoFeatureExtractor"),l(_t,"href","/docs/transformers/main/en/model_doc/auto#transformers.AutoTokenizer"),l(xt,"href","/docs/transformers/main/en/model_doc/vision-text-dual-encoder#transformers.VisionTextDualEncoderProcessor.decode"),l(vt,"href","/docs/transformers/main/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.batch_decode"),l(re,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),l(Tt,"href","/docs/transformers/main/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.decode"),l(ie,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),l(z,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),l(le,"id","transformers.VisionTextDualEncoderModel"),l(le,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),l(le,"href","#transformers.VisionTextDualEncoderModel"),l(G,"class","relative group"),l(bt,"href","/docs/transformers/main/en/model_doc/auto#transformers.FlaxAutoModelForVision2Seq.from_pretrained"),l(Fe,"href","https://arxiv.org/abs/2111.07991"),l(Fe,"rel","nofollow"),l(Et,"href","/docs/transformers/main/en/main_classes/model#transformers.PreTrainedModel"),l(Le,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),l(Le,"rel","nofollow"),l($t,"href","/docs/transformers/main/en/model_doc/vision-text-dual-encoder#transformers.VisionTextDualEncoderModel"),l(A,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),l(V,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),l(me,"id","transformers.FlaxVisionTextDualEncoderModel"),l(me,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),l(me,"href","#transformers.FlaxVisionTextDualEncoderModel"),l(K,"class","relative group"),l(yt,"href","/docs/transformers/main/en/model_doc/auto#transformers.FlaxAutoModelForVision2Seq.from_pretrained"),l(Re,"href","https://arxiv.org/abs/2111.07991"),l(Re,"rel","nofollow"),l(wt,"href","/docs/transformers/main/en/main_classes/model#transformers.PreTrainedModel"),l(He,"href","https://flax.readthedocs.io/en/latest/flax.linen.html#module"),l(He,"rel","nofollow"),l(Ze,"href","https://jax.readthedocs.io/en/latest/jax.html#just-in-time-compilation-jit"),l(Ze,"rel","nofollow"),l(Ge,"href","https://jax.readthedocs.io/en/latest/jax.html#automatic-differentiation"),l(Ge,"rel","nofollow"),l(Xe,"href","https://jax.readthedocs.io/en/latest/jax.html#vectorization-vmap"),l(Xe,"rel","nofollow"),l(Ke,"href","https://jax.readthedocs.io/en/latest/jax.html#parallelization-pmap"),l(Ke,"rel","nofollow"),l(jt,"href","/docs/transformers/main/en/model_doc/vision-text-dual-encoder#transformers.FlaxVisionTextDualEncoderModel"),l(q,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),l(j,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8")},m(o,u){e(document.head,p),_(o,v,u),_(o,g,u),e(g,f),e(f,x),E(d,x,null),e(g,h),e(g,S),e(S,qo),_(o,no,u),_(o,U,u),e(U,Y),e(Y,Mt),E(_e,Mt,null),e(U,Lo),e(U,zt),e(zt,So),_(o,ao,u),_(o,k,u),e(k,No),e(k,ot),e(ot,Bo),e(k,Oo),e(k,Ct),e(Ct,Wo),e(k,Ro),e(k,nt),e(nt,Uo),e(k,Jo),e(k,at),e(at,Ho),e(k,Zo),e(k,st),e(st,Go),e(k,Xo),e(k,It),e(It,Ko),e(k,Qo),e(k,rt),e(rt,Yo),e(k,en),e(k,it),e(it,tn),e(k,on),_(o,so,u),_(o,ee,u),e(ee,nn),e(ee,xe),e(xe,an),e(ee,sn),_(o,ro,u),_(o,J,u),e(J,te),e(te,Ft),E(ve,Ft,null),e(J,rn),e(J,At),e(At,ln),_(o,io,u),_(o,M,u),E(Te,M,null),e(M,dn),e(M,O),e(O,lt),e(lt,cn),e(O,mn),e(O,dt),e(dt,pn),e(O,fn),e(O,ct),e(ct,hn),e(O,un),e(M,gn),e(M,H),e(H,_n),e(H,mt),e(mt,xn),e(H,vn),e(H,pt),e(pt,Tn),e(H,bn),e(M,En),E(oe,M,null),e(M,$n),e(M,ne),E(be,ne,null),e(ne,yn),e(ne,Ee),e(Ee,wn),e(Ee,ft),e(ft,jn),e(Ee,kn),e(M,Vn),e(M,ae),E($e,ae,null),e(ae,Dn),e(ae,ye),e(ye,Pn),e(ye,ht),e(ht,Mn),e(ye,zn),_(o,lo,u),_(o,Z,u),e(Z,se),e(se,qt),E(we,qt,null),e(Z,Cn),e(Z,Lt),e(Lt,In),_(o,co,u),_(o,z,u),E(je,z,null),e(z,Fn),e(z,St),e(St,An),e(z,qn),e(z,C),e(C,ut),e(ut,Ln),e(C,Sn),e(C,gt),e(gt,Nn),e(C,Bn),e(C,_t),e(_t,On),e(C,Wn),e(C,Nt),e(Nt,Rn),e(C,Un),e(C,xt),e(xt,Jn),e(C,Hn),e(z,Zn),e(z,re),E(ke,re,null),e(re,Gn),e(re,Ve),e(Ve,Xn),e(Ve,vt),e(vt,Kn),e(Ve,Qn),e(z,Yn),e(z,ie),E(De,ie,null),e(ie,ea),e(ie,Pe),e(Pe,ta),e(Pe,Tt),e(Tt,oa),e(Pe,na),_(o,mo,u),_(o,G,u),e(G,le),e(le,Bt),E(Me,Bt,null),e(G,aa),e(G,Ot),e(Ot,sa),_(o,po,u),_(o,V,u),E(ze,V,null),e(V,ra),e(V,Ce),e(Ce,ia),e(Ce,bt),e(bt,la),e(Ce,da),e(V,ca),e(V,Ie),e(Ie,ma),e(Ie,Fe),e(Fe,pa),e(Ie,fa),e(V,ha),e(V,Wt),e(Wt,ua),e(V,ga),e(V,Ae),e(Ae,_a),e(Ae,Et),e(Et,xa),e(Ae,va),e(V,Ta),e(V,qe),e(qe,ba),e(qe,Le),e(Le,Ea),e(qe,$a),e(V,ya),e(V,A),E(Se,A,null),e(A,wa),e(A,X),e(X,ja),e(X,$t),e($t,ka),e(X,Va),e(X,Rt),e(Rt,Da),e(X,Pa),e(A,Ma),E(de,A,null),e(A,za),E(ce,A,null),_(o,fo,u),_(o,K,u),e(K,me),e(me,Ut),E(Ne,Ut,null),e(K,Ca),e(K,Jt),e(Jt,Ia),_(o,ho,u),_(o,j,u),E(Be,j,null),e(j,Fa),e(j,Oe),e(Oe,Aa),e(Oe,yt),e(yt,qa),e(Oe,La),e(j,Sa),e(j,We),e(We,Na),e(We,Re),e(Re,Ba),e(We,Oa),e(j,Wa),e(j,Ht),e(Ht,Ra),e(j,Ua),e(j,Ue),e(Ue,Ja),e(Ue,wt),e(wt,Ha),e(Ue,Za),e(j,Ga),e(j,Je),e(Je,Xa),e(Je,He),e(He,Ka),e(Je,Qa),e(j,Ya),e(j,Zt),e(Zt,es),e(j,ts),e(j,N),e(N,Gt),e(Gt,Ze),e(Ze,os),e(N,ns),e(N,Xt),e(Xt,Ge),e(Ge,as),e(N,ss),e(N,Kt),e(Kt,Xe),e(Xe,rs),e(N,is),e(N,Qt),e(Qt,Ke),e(Ke,ls),e(j,ds),e(j,q),E(Qe,q,null),e(q,cs),e(q,Q),e(Q,ms),e(Q,jt),e(jt,ps),e(Q,fs),e(Q,Yt),e(Yt,hs),e(Q,us),e(q,gs),E(pe,q,null),e(q,_s),E(fe,q,null),uo=!0},p(o,[u]){const Ye={};u&2&&(Ye.$$scope={dirty:u,ctx:o}),oe.$set(Ye);const eo={};u&2&&(eo.$$scope={dirty:u,ctx:o}),de.$set(eo);const to={};u&2&&(to.$$scope={dirty:u,ctx:o}),ce.$set(to);const oo={};u&2&&(oo.$$scope={dirty:u,ctx:o}),pe.$set(oo);const et={};u&2&&(et.$$scope={dirty:u,ctx:o}),fe.$set(et)},i(o){uo||($(d.$$.fragment,o),$(_e.$$.fragment,o),$(ve.$$.fragment,o),$(Te.$$.fragment,o),$(oe.$$.fragment,o),$(be.$$.fragment,o),$($e.$$.fragment,o),$(we.$$.fragment,o),$(je.$$.fragment,o),$(ke.$$.fragment,o),$(De.$$.fragment,o),$(Me.$$.fragment,o),$(ze.$$.fragment,o),$(Se.$$.fragment,o),$(de.$$.fragment,o),$(ce.$$.fragment,o),$(Ne.$$.fragment,o),$(Be.$$.fragment,o),$(Qe.$$.fragment,o),$(pe.$$.fragment,o),$(fe.$$.fragment,o),uo=!0)},o(o){y(d.$$.fragment,o),y(_e.$$.fragment,o),y(ve.$$.fragment,o),y(Te.$$.fragment,o),y(oe.$$.fragment,o),y(be.$$.fragment,o),y($e.$$.fragment,o),y(we.$$.fragment,o),y(je.$$.fragment,o),y(ke.$$.fragment,o),y(De.$$.fragment,o),y(Me.$$.fragment,o),y(ze.$$.fragment,o),y(Se.$$.fragment,o),y(de.$$.fragment,o),y(ce.$$.fragment,o),y(Ne.$$.fragment,o),y(Be.$$.fragment,o),y(Qe.$$.fragment,o),y(pe.$$.fragment,o),y(fe.$$.fragment,o),uo=!1},d(o){t(p),o&&t(v),o&&t(g),w(d),o&&t(no),o&&t(U),w(_e),o&&t(ao),o&&t(k),o&&t(so),o&&t(ee),o&&t(ro),o&&t(J),w(ve),o&&t(io),o&&t(M),w(Te),w(oe),w(be),w($e),o&&t(lo),o&&t(Z),w(we),o&&t(co),o&&t(z),w(je),w(ke),w(De),o&&t(mo),o&&t(G),w(Me),o&&t(po),o&&t(V),w(ze),w(Se),w(de),w(ce),o&&t(fo),o&&t(K),w(Ne),o&&t(ho),o&&t(j),w(Be),w(Qe),w(pe),w(fe)}}}const Br={local:"visiontextdualencoder",sections:[{local:"overview",title:"Overview"},{local:"transformers.VisionTextDualEncoderConfig",title:"VisionTextDualEncoderConfig"},{local:"transformers.VisionTextDualEncoderProcessor",title:"VisionTextDualEncoderProcessor"},{local:"transformers.VisionTextDualEncoderModel",title:"VisionTextDualEncoderModel"},{local:"transformers.FlaxVisionTextDualEncoderModel",title:"FlaxVisionTextDualEncoderModel"}],title:"VisionTextDualEncoder"};function Or(F){return Ir(()=>{new URLSearchParams(window.location.search).get("fw")}),[]}class Gr extends Pr{constructor(p){super();Mr(this,p,Or,Nr,zr,{})}}export{Gr as default,Br as metadata};
