...
<span class="hljs-meta">&gt;&gt;&gt; </span>outputs = model(**inputs)
<span class="hljs-meta">&gt;&gt;&gt; </span>logits_per_image = outputs.logits_per_image  <span class="hljs-comment"># this is the image-text similarity score</span>
<span class="hljs-meta">&gt;&gt;&gt; </span>probs = jax.nn.softmax(logits_per_image, axis=<span class="hljs-number">1</span>)  <span class="hljs-comment"># we can take the softmax to get the label probabilities</span>`}}),{c(){p=n("p"),v=r("Examples:"),g=c(),T(f.$$.fragment)},l(d){p=a(d,"P",{});var h=s(p);v=i(h,"Examples:"),h.forEach(t),g=m(d),b(f.$$.fragment,d)},m(d,h){_(d,p,h),e(p,v),_(d,g,h),E(f,d,h),x=!0},p:vs,i(d){x||($(f.$$.fragment,d),x=!0)},o(d){w(f.$$.fragment,d),x=!1},d(d){d&&t(p),d&&t(g),j(f,d)}}}function Nr(I){let p,v,g,f,x,d,h,S,qo,no,U,Y,Mt,_e,Lo,zt,So,ao,k,No,ot,Bo,Oo,Ct,Wo,Ro,nt,Uo,Jo,at,Ho,Zo,st,Go,Xo,Ft,Ko,Qo,rt,Yo,en,it,tn,on,so,ee,nn,xe,an,sn,ro,J,te,It,ve,rn,At,ln,io,M,Te,dn,O,lt,cn,mn,dt,pn,fn,ct,hn,un,gn,H,_n,mt,xn,vn,pt,Tn,bn,En,oe,$n,ne,be,wn,Ee,jn,ft,yn,kn,Vn,ae,$e,Dn,we,Pn,ht,Mn,zn,lo,Z,se,qt,je,Cn,Lt,Fn,co,z,ye,In,St,An,qn,C,ut,Ln,Sn,gt,Nn,Bn,_t,On,Wn,Nt,Rn,Un,xt,Jn,Hn,Zn,re,ke,Gn,Ve,Xn,vt,Kn,Qn,Yn,ie,De,ea,Pe,ta,Tt,oa,na,mo,G,le,Bt,Me,aa,Ot,sa,po,V,ze,ra,Ce,ia,bt,la,da,ca,Fe,ma,Ie,pa,fa,ha,Wt,ua,ga,Ae,_a,Et,xa,va,Ta,qe,ba,Le,Ea,$a,wa,A,Se,ja,X,ya,$t,ka,Va,Rt,Da,Pa,Ma,de,za,ce,fo,K,me,Ut,Ne,Ca,Jt,Fa,ho,y,Be,Ia,Oe,Aa,wt,qa,La,Sa,We,Na,Re,Ba,Oa,Wa,Ht,Ra,Ua,Ue,Ja,jt,Ha,Za,Ga,Je,Xa,He,Ka,Qa,Ya,Zt,es,ts,N,Gt,Ze,os,ns,Xt,Ge,as,ss,Kt,Xe,rs,is,Qt,Ke,ls,ds,q,Qe,cs,Q,ms,yt,ps,fs,Yt,hs,us,gs,pe,_s,fe,uo;return d=new Pt({}),_e=new Pt({}),ve=new Pt({}),Te=new R({props:{name:"class transformers.VisionTextDualEncoderConfig",anchor:"transformers.VisionTextDualEncoderConfig",parameters:[{name:"projection_dim",val:" = 512"},{name:"logit_scale_init_value",val:" = 2.6592"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.VisionTextDualEncoderConfig.text_config",description:`<strong>text_config</strong> (<code>dict</code>) &#x2014;
...
`}}),de=new Dr({props:{$$slots:{default:[Ar]},$$scope:{ctx:I}}}),ce=new xs({props:{anchor:"transformers.VisionTextDualEncoderModel.forward.example",$$slots:{default:[qr]},$$scope:{ctx:I}}}),Ne=new Pt({}),Be=new R({props:{name:"class transformers.FlaxVisionTextDualEncoderModel",anchor:"transformers.FlaxVisionTextDualEncoderModel",parameters:[{name:"config",val:": VisionTextDualEncoderConfig"},{name:"input_shape",val:": typing.Optional[typing.Tuple] = None"},{name:"seed",val:": int = 0"},{name:"dtype",val:": dtype = <class 'jax.numpy.float32'>"},{name:"_do_init",val:": bool = True"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.FlaxVisionTextDualEncoderModel.config",description:`<strong>config</strong> (<a href="/docs/transformers/main/en/model_doc/vision-text-dual-encoder#transformers.VisionTextDualEncoderConfig">VisionTextDualEncoderConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
...
model configuration.`),Vn=c(),ae=n("div"),T($e.$$.fragment),Dn=c(),we=n("p"),Pn=r("Serializes this instance to a Python dictionary. Override the default "),ht=n("a"),Mn=r("to_dict()"),zn=r("."),lo=c(),Z=n("h2"),se=n("a"),qt=n("span"),T(je.$$.fragment),Cn=c(),Lt=n("span"),Fn=r("VisionTextDualEncoderProcessor"),co=c(),z=n("div"),T(ye.$$.fragment),In=c(),St=n("p"),An=r(`Constructs a VisionTextDualEncoder processor which wraps a vision feature extractor and a tokenizer into a single
...
and behavior.`),wa=c(),A=n("div"),T(Se.$$.fragment),ja=c(),X=n("p"),ya=r("The "),$t=n("a"),ka=r("VisionTextDualEncoderModel"),Va=r(" forward method, overrides the "),Rt=n("code"),Da=r("__call__"),Pa=r(" special method."),Ma=c(),T(de.$$.fragment),za=c(),T(ce.$$.fragment),fo=c(),K=n("h2"),me=n("a"),Ut=n("span"),T(Ne.$$.fragment),Ca=c(),Jt=n("span"),Fa=r("FlaxVisionTextDualEncoderModel"),ho=c(),y=n("div"),T(Be.$$.fragment),Ia=c(),Oe=n("p"),Aa=r(`This class can be used to initialize a vision-text dual encoder model with any pretrained vision autoencoding model
as the vision encoder and any pretrained text model as the text encoder. The vision and text encoders are loaded
...
model configuration.`),vo.forEach(t),xo.forEach(t),Vn=m(L),ae=a(L,"DIV",{class:!0});var To=s(ae);b($e.$$.fragment,To),Dn=m(To),we=a(To,"P",{});var bo=s(we);Pn=i(bo,"Serializes this instance to a Python dictionary. Override the default "),ht=a(bo,"A",{href:!0});var Os=s(ht);Mn=i(Os,"to_dict()"),Os.forEach(t),zn=i(bo,"."),bo.forEach(t),To.forEach(t),L.forEach(t),lo=m(o),Z=a(o,"H2",{class:!0});var Eo=s(Z);se=a(Eo,"A",{id:!0,class:!0,href:!0});var Ws=s(se);qt=a(Ws,"SPAN",{});var Rs=s(qt);b(je.$$.fragment,Rs),Rs.forEach(t),Ws.forEach(t),Cn=m(Eo),Lt=a(Eo,"SPAN",{});var Us=s(Lt);Fn=i(Us,"VisionTextDualEncoderProcessor"),Us.forEach(t),Eo.forEach(t),co=m(o),z=a(o,"DIV",{class:!0});var W=s(z);b(ye.$$.fragment,W),In=m(W),St=a(W,"P",{});var Js=s(St);An=i(Js,`Constructs a VisionTextDualEncoder processor which wraps a vision feature extractor and a tokenizer into a single
...
should be fine-tuned on a downstream task, like contrastive image-text modeling.`),Co.forEach(t),Sa=m(P),We=a(P,"P",{});var Fo=s(We);Na=i(Fo,"In "),Re=a(Fo,"A",{href:!0,rel:!0});var hr=s(Re);Ba=i(hr,"LiT: Zero-Shot Transfer with Locked-image Text Tuning"),hr.forEach(t),Oa=i(Fo,` it is shown how
leveraging pre-trained (locked/frozen) image and text model for contrastive learning yields significant improvment
...
models (see the examples for more information).`),ur.forEach(t),Ua=m(P),Ue=a(P,"P",{});var Io=s(Ue);Ja=i(Io,"This model inherits from "),jt=a(Io,"A",{href:!0});var gr=s(jt);Ha=i(gr,"PreTrainedModel"),gr.forEach(t),Za=i(Io,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
