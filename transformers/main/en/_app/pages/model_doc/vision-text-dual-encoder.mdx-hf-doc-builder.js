...
<span class="hljs-meta">&gt;&gt;&gt; </span>outputs = model(**inputs)
<span class="hljs-meta">&gt;&gt;&gt; </span>logits_per_image = outputs.logits_per_image  <span class="hljs-comment"># this is the image-text similarity score</span>
<span class="hljs-meta">&gt;&gt;&gt; </span>probs = jax.nn.softmax(logits_per_image, axis=<span class="hljs-number">1</span>)  <span class="hljs-comment"># we can take the softmax to get the label probabilities</span>`}}),{c(){p=n("p"),v=r("Examples:"),g=c(),T(f.$$.fragment)},l(d){p=a(d,"P",{});var h=s(p);v=i(h,"Examples:"),h.forEach(t),g=m(d),b(f.$$.fragment,d)},m(d,h){_(d,p,h),e(p,v),_(d,g,h),E(f,d,h),x=!0},p:vs,i(d){x||($(f.$$.fragment,d),x=!0)},o(d){w(f.$$.fragment,d),x=!1},d(d){d&&t(p),d&&t(g),j(f,d)}}}function Nr(F){let p,v,g,f,x,d,h,S,qo,no,U,Y,Mt,_e,Lo,zt,So,ao,k,No,ot,Bo,Oo,Ct,Wo,Ro,nt,Uo,Jo,at,Ho,Zo,st,Go,Xo,It,Ko,Qo,rt,Yo,en,it,tn,on,so,ee,nn,xe,an,sn,ro,J,te,Ft,ve,rn,At,ln,io,M,Te,dn,O,lt,cn,mn,dt,pn,fn,ct,hn,un,gn,H,_n,mt,xn,vn,pt,Tn,bn,En,oe,$n,ne,be,wn,Ee,jn,ft,yn,kn,Vn,ae,$e,Dn,we,Pn,ht,Mn,zn,lo,Z,se,qt,je,Cn,Lt,In,co,z,ye,Fn,St,An,qn,C,ut,Ln,Sn,gt,Nn,Bn,_t,On,Wn,Nt,Rn,Un,xt,Jn,Hn,Zn,re,ke,Gn,Ve,Xn,vt,Kn,Qn,Yn,ie,De,ea,Pe,ta,Tt,oa,na,mo,G,le,Bt,Me,aa,Ot,sa,po,V,ze,ra,Ce,ia,bt,la,da,ca,Ie,ma,Fe,pa,fa,ha,Wt,ua,ga,Ae,_a,Et,xa,va,Ta,qe,ba,Le,Ea,$a,wa,A,Se,ja,X,ya,$t,ka,Va,Rt,Da,Pa,Ma,de,za,ce,fo,K,me,Ut,Ne,Ca,Jt,Ia,ho,y,Be,Fa,Oe,Aa,wt,qa,La,Sa,We,Na,Re,Ba,Oa,Wa,Ht,Ra,Ua,Ue,Ja,jt,Ha,Za,Ga,Je,Xa,He,Ka,Qa,Ya,Zt,es,ts,N,Gt,Ze,os,ns,Xt,Ge,as,ss,Kt,Xe,rs,is,Qt,Ke,ls,ds,q,Qe,cs,Q,ms,yt,ps,fs,Yt,hs,us,gs,pe,_s,fe,uo;return d=new Pt({}),_e=new Pt({}),ve=new Pt({}),Te=new R({props:{name:"class transformers.VisionTextDualEncoderConfig",anchor:"transformers.VisionTextDualEncoderConfig",parameters:[{name:"projection_dim",val:" = 512"},{name:"logit_scale_init_value",val:" = 2.6592"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.VisionTextDualEncoderConfig.text_config",description:`<strong>text_config</strong> (<code>dict</code>) &#x2014;
...
`}}),je=new Pt({}),ye=new R({props:{name:"class transformers.VisionTextDualEncoderProcessor",anchor:"transformers.VisionTextDualEncoderProcessor",parameters:[{name:"feature_extractor",val:""},{name:"tokenizer",val:""}],parametersDescription:[{anchor:"transformers.VisionTextDualEncoderProcessor.feature_extractor",description:`<strong>feature_extractor</strong> (<a href="/docs/transformers/main/en/model_doc/auto#transformers.AutoFeatureExtractor">AutoFeatureExtractor</a>) &#x2014;
...
model configuration.`),Vn=c(),ae=n("div"),T($e.$$.fragment),Dn=c(),we=n("p"),Pn=r("Serializes this instance to a Python dictionary. Override the default "),ht=n("a"),Mn=r("to_dict()"),zn=r("."),lo=c(),Z=n("h2"),se=n("a"),qt=n("span"),T(je.$$.fragment),Cn=c(),Lt=n("span"),In=r("VisionTextDualEncoderProcessor"),co=c(),z=n("div"),T(ye.$$.fragment),Fn=c(),St=n("p"),An=r(`Constructs a VisionTextDualEncoder processor which wraps a vision feature extractor and a tokenizer into a single
...
and behavior.`),wa=c(),A=n("div"),T(Se.$$.fragment),ja=c(),X=n("p"),ya=r("The "),$t=n("a"),ka=r("VisionTextDualEncoderModel"),Va=r(" forward method, overrides the "),Rt=n("code"),Da=r("__call__"),Pa=r(" special method."),Ma=c(),T(de.$$.fragment),za=c(),T(ce.$$.fragment),fo=c(),K=n("h2"),me=n("a"),Ut=n("span"),T(Ne.$$.fragment),Ca=c(),Jt=n("span"),Ia=r("FlaxVisionTextDualEncoderModel"),ho=c(),y=n("div"),T(Be.$$.fragment),Fa=c(),Oe=n("p"),Aa=r(`This class can be used to initialize a vision-text dual encoder model with any pretrained vision autoencoding model
as the vision encoder and any pretrained text model as the text encoder. The vision and text encoders are loaded
via the `),wt=n("a"),qa=r("from_pretrained()"),La=r(` method. The projection layers are automatically added to the model and
...
models (see the examples for more information).`),Ua=c(),Ue=n("p"),Ja=r("This model inherits from "),jt=n("a"),Ha=r("PreTrainedModel"),Za=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Ga=c(),Je=n("p"),Xa=r("This model is also a Flax Linen "),He=n("a"),Ka=r("flax.linen.Module"),Qa=r(`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),Ya=c(),Zt=n("p"),es=r("Finally, this model supports inherent JAX features such as:"),ts=c(),N=n("ul"),Gt=n("li"),Ze=n("a"),os=r("Just-In-Time (JIT) compilation"),ns=c(),Xt=n("li"),Ge=n("a"),as=r("Automatic Differentiation"),ss=c(),Kt=n("li"),Xe=n("a"),rs=r("Vectorization"),is=c(),Qt=n("li"),Ke=n("a"),ls=r("Parallelization"),ds=c(),q=n("div"),T(Qe.$$.fragment),cs=c(),Q=n("p"),ms=r("The "),yt=n("a"),ps=r("FlaxVisionTextDualEncoderModel"),fs=r(" forward method, overrides the "),Yt=n("code"),hs=r("__call__"),us=r(" special method."),gs=c(),T(pe.$$.fragment),_s=c(),T(fe.$$.fragment),this.h()},l(o){const u=Cr('[data-svelte="svelte-1phssyn"]',document.head);p=a(u,"META",{name:!0,content:!0}),u.forEach(t),v=m(o),g=a(o,"H1",{class:!0});var Ye=s(g);f=a(Ye,"A",{id:!0,class:!0,href:!0});var eo=s(f);x=a(eo,"SPAN",{});var to=s(x);b(d.$$.fragment,to),to.forEach(t),eo.forEach(t),h=m(Ye),S=a(Ye,"SPAN",{});var oo=s(S);qo=i(oo,"VisionTextDualEncoder"),oo.forEach(t),Ye.forEach(t),no=m(o),U=a(o,"H2",{class:!0});var et=s(U);Y=a(et,"A",{id:!0,class:!0,href:!0});var bs=s(Y);Mt=a(bs,"SPAN",{});var Es=s(Mt);b(_e.$$.fragment,Es),Es.forEach(t),bs.forEach(t),Lo=m(et),zt=a(et,"SPAN",{});var $s=s(zt);So=i($s,"Overview"),$s.forEach(t),et.forEach(t),ao=m(o),k=a(o,"P",{});var D=s(k);No=i(D,"The "),ot=a(D,"A",{href:!0});var ws=s(ot);Bo=i(ws,"VisionTextDualEncoderModel"),ws.forEach(t),Oo=i(D,` can be used to initialize a vision-text dual encoder model with
any pretrained vision autoencoding model as the vision encoder (`),Ct=a(D,"EM",{});var js=s(Ct);Wo=i(js,"e.g."),js.forEach(t),Ro=m(D),nt=a(D,"A",{href:!0});var ys=s(nt);Uo=i(ys,"ViT"),ys.forEach(t),Jo=i(D,", "),at=a(D,"A",{href:!0});var ks=s(at);Ho=i(ks,"BEiT"),ks.forEach(t),Zo=i(D,", "),st=a(D,"A",{href:!0});var Vs=s(st);Go=i(Vs,"DeiT"),Vs.forEach(t),Xo=i(D,") and any pretrained text autoencoding model as the text encoder ("),It=a(D,"EM",{});var Ds=s(It);Ko=i(Ds,"e.g."),Ds.forEach(t),Qo=m(D),rt=a(D,"A",{href:!0});var Ps=s(rt);Yo=i(Ps,"RoBERTa"),Ps.forEach(t),en=i(D,", "),it=a(D,"A",{href:!0});var Ms=s(it);tn=i(Ms,"BERT"),Ms.forEach(t),on=i(D,`). Two projection layers are added on top of both the vision and text encoder to project the output embeddings
to a shared latent space. The projection layers are randomly initialized so the model should be fine-tuned on a
downstream task. This model can be used to align the vision-text embeddings using CLIP like contrastive image-text
...
documentation from `),pt=a(kt,"A",{href:!0});var Ns=s(pt);Tn=i(Ns,"PretrainedConfig"),Ns.forEach(t),bn=i(kt," for more information."),kt.forEach(t),En=m(L),b(oe.$$.fragment,L),$n=m(L),ne=a(L,"DIV",{class:!0});var xo=s(ne);b(be.$$.fragment,xo),wn=m(xo),Ee=a(xo,"P",{});var vo=s(Ee);jn=i(vo,"Instantiate a "),ft=a(vo,"A",{href:!0});var Bs=s(ft);yn=i(Bs,"VisionTextDualEncoderConfig"),Bs.forEach(t),kn=i(vo,` (or a derived class) from text model configuration and vision
model configuration.`),vo.forEach(t),xo.forEach(t),Vn=m(L),ae=a(L,"DIV",{class:!0});var To=s(ae);b($e.$$.fragment,To),Dn=m(To),we=a(To,"P",{});var bo=s(we);Pn=i(bo,"Serializes this instance to a Python dictionary. Override the default "),ht=a(bo,"A",{href:!0});var Os=s(ht);Mn=i(Os,"to_dict()"),Os.forEach(t),zn=i(bo,"."),bo.forEach(t),To.forEach(t),L.forEach(t),lo=m(o),Z=a(o,"H2",{class:!0});var Eo=s(Z);se=a(Eo,"A",{id:!0,class:!0,href:!0});var Ws=s(se);qt=a(Ws,"SPAN",{});var Rs=s(qt);b(je.$$.fragment,Rs),Rs.forEach(t),Ws.forEach(t),Cn=m(Eo),Lt=a(Eo,"SPAN",{});var Us=s(Lt);In=i(Us,"VisionTextDualEncoderProcessor"),Us.forEach(t),Eo.forEach(t),co=m(o),z=a(o,"DIV",{class:!0});var W=s(z);b(ye.$$.fragment,W),Fn=m(W),St=a(W,"P",{});var Js=s(St);An=i(Js,`Constructs a VisionTextDualEncoder processor which wraps a vision feature extractor and a tokenizer into a single
...
`),xt=a(B,"A",{href:!0});var Ks=s(xt);Jn=i(Ks,"decode()"),Ks.forEach(t),Hn=i(B," for more information."),B.forEach(t),Zn=m(W),re=a(W,"DIV",{class:!0});var $o=s(re);b(ke.$$.fragment,$o),Gn=m($o),Ve=a($o,"P",{});var wo=s(Ve);Xn=i(wo,`This method forwards all its arguments to VisionTextDualEncoderTokenizer\u2019s
`),vt=a(wo,"A",{href:!0});var Qs=s(vt);Kn=i(Qs,"batch_decode()"),Qs.forEach(t),Qn=i(wo,". Please refer to the docstring of this method for more information."),wo.forEach(t),$o.forEach(t),Yn=m(W),ie=a(W,"DIV",{class:!0});var jo=s(ie);b(De.$$.fragment,jo),ea=m(jo),Pe=a(jo,"P",{});var yo=s(Pe);ta=i(yo,"This method forwards all its arguments to VisionTextDualEncoderTokenizer\u2019s "),Tt=a(yo,"A",{href:!0});var Ys=s(Tt);oa=i(Ys,"decode()"),Ys.forEach(t),na=i(yo,`.
Please refer to the docstring of this method for more information.`),yo.forEach(t),jo.forEach(t),W.forEach(t),mo=m(o),G=a(o,"H2",{class:!0});var ko=s(G);le=a(ko,"A",{id:!0,class:!0,href:!0});var er=s(le);Bt=a(er,"SPAN",{});var tr=s(Bt);b(Me.$$.fragment,tr),tr.forEach(t),er.forEach(t),aa=m(ko),Ot=a(ko,"SPAN",{});var or=s(Ot);sa=i(or,"VisionTextDualEncoderModel"),or.forEach(t),ko.forEach(t),po=m(o),V=a(o,"DIV",{class:!0});var I=s(V);b(ze.$$.fragment,I),ra=m(I),Ce=a(I,"P",{});var Vo=s(Ce);ia=i(Vo,`This class can be used to initialize a vision-text dual encoder model with any pretrained vision autoencoding model
as the vision encoder and any pretrained text model as the text encoder. The vision and text encoders are loaded
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Mo.forEach(t),wa=m(I),A=a(I,"DIV",{class:!0});var he=s(A);b(Se.$$.fragment,he),ja=m(he),X=a(he,"P",{});var Vt=s(X);ya=i(Vt,"The "),$t=a(Vt,"A",{href:!0});var lr=s($t);ka=i(lr,"VisionTextDualEncoderModel"),lr.forEach(t),Va=i(Vt," forward method, overrides the "),Rt=a(Vt,"CODE",{});var dr=s(Rt);Da=i(dr,"__call__"),dr.forEach(t),Pa=i(Vt," special method."),Vt.forEach(t),Ma=m(he),b(de.$$.fragment,he),za=m(he),b(ce.$$.fragment,he),he.forEach(t),I.forEach(t),fo=m(o),K=a(o,"H2",{class:!0});var zo=s(K);me=a(zo,"A",{id:!0,class:!0,href:!0});var cr=s(me);Ut=a(cr,"SPAN",{});var mr=s(Ut);b(Ne.$$.fragment,mr),mr.forEach(t),cr.forEach(t),Ca=m(zo),Jt=a(zo,"SPAN",{});var pr=s(Jt);Ia=i(pr,"FlaxVisionTextDualEncoderModel"),pr.forEach(t),zo.forEach(t),ho=m(o),y=a(o,"DIV",{class:!0});var P=s(y);b(Be.$$.fragment,P),Fa=m(P),Oe=a(P,"P",{});var Co=s(Oe);Aa=i(Co,`This class can be used to initialize a vision-text dual encoder model with any pretrained vision autoencoding model
as the vision encoder and any pretrained text model as the text encoder. The vision and text encoders are loaded
via the `),wt=a(Co,"A",{href:!0});var fr=s(wt);qa=i(fr,"from_pretrained()"),fr.forEach(t),La=i(Co,` method. The projection layers are automatically added to the model and
...
models (see the examples for more information).`),ur.forEach(t),Ua=m(P),Ue=a(P,"P",{});var Fo=s(Ue);Ja=i(Fo,"This model inherits from "),jt=a(Fo,"A",{href:!0});var gr=s(jt);Ha=i(gr,"PreTrainedModel"),gr.forEach(t),Za=i(Fo,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
