...
<span class="hljs-meta">&gt;&gt;&gt; </span>outputs = model(**inputs)
<span class="hljs-meta">&gt;&gt;&gt; </span>logits_per_image = outputs.logits_per_image  <span class="hljs-comment"># this is the image-text similarity score</span>
<span class="hljs-meta">&gt;&gt;&gt; </span>probs = jax.nn.softmax(logits_per_image, axis=<span class="hljs-number">1</span>)  <span class="hljs-comment"># we can take the softmax to get the label probabilities</span>`}}),{c(){p=n("p"),x=r("Examples:"),g=c(),T(f.$$.fragment)},l(d){p=s(d,"P",{});var h=a(p);x=i(h,"Examples:"),h.forEach(t),g=m(d),b(f.$$.fragment,d)},m(d,h){_(d,p,h),e(p,x),_(d,g,h),E(f,d,h),v=!0},p:xa,i(d){v||($(f.$$.fragment,d),v=!0)},o(d){y(f.$$.fragment,d),v=!1},d(d){d&&t(p),d&&t(g),w(f,d)}}}function Or(A){let p,x,g,f,v,d,h,S,qo,no,U,Y,Mt,_e,Lo,zt,So,so,k,Oo,ot,No,Bo,Ct,Wo,Ro,nt,Uo,Jo,st,Ho,Zo,at,Go,Xo,It,Ko,Qo,rt,Yo,en,it,tn,on,ao,ee,nn,ve,sn,an,ro,J,te,At,xe,rn,Ft,ln,io,M,Te,dn,B,lt,cn,mn,dt,pn,fn,ct,hn,un,gn,H,_n,mt,vn,xn,pt,Tn,bn,En,oe,$n,ne,be,yn,Ee,wn,ft,jn,kn,Vn,se,$e,Dn,ye,Pn,ht,Mn,zn,lo,Z,ae,qt,we,Cn,Lt,In,co,z,je,An,St,Fn,qn,C,ut,Ln,Sn,gt,On,Nn,_t,Bn,Wn,Ot,Rn,Un,vt,Jn,Hn,Zn,re,ke,Gn,Ve,Xn,xt,Kn,Qn,Yn,ie,De,es,Pe,ts,Tt,os,ns,mo,G,le,Nt,Me,ss,Bt,as,po,V,ze,rs,Ce,is,bt,ls,ds,cs,Ie,ms,Ae,ps,fs,hs,Wt,us,gs,Fe,_s,Et,vs,xs,Ts,qe,bs,Le,Es,$s,ys,F,Se,ws,X,js,$t,ks,Vs,Rt,Ds,Ps,Ms,de,zs,ce,fo,K,me,Ut,Oe,Cs,Jt,Is,ho,j,Ne,As,Be,Fs,yt,qs,Ls,Ss,We,Os,Re,Ns,Bs,Ws,Ht,Rs,Us,Ue,Js,wt,Hs,Zs,Gs,Je,Xs,He,Ks,Qs,Ys,Zt,ea,ta,O,Gt,Ze,oa,na,Xt,Ge,sa,aa,Kt,Xe,ra,ia,Qt,Ke,la,da,q,Qe,ca,Q,ma,jt,pa,fa,Yt,ha,ua,ga,pe,_a,fe,uo;return d=new Pt({}),_e=new Pt({}),xe=new Pt({}),Te=new R({props:{name:"class transformers.VisionTextDualEncoderConfig",anchor:"transformers.VisionTextDualEncoderConfig",parameters:[{name:"projection_dim",val:" = 512"},{name:"logit_scale_init_value",val:" = 2.6592"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.VisionTextDualEncoderConfig.text_config",description:`<strong>text_config</strong> (<code>dict</code>) &#x2014;
...
`}}),we=new Pt({}),je=new R({props:{name:"class transformers.VisionTextDualEncoderProcessor",anchor:"transformers.VisionTextDualEncoderProcessor",parameters:[{name:"image_processor",val:" = None"},{name:"tokenizer",val:" = None"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.VisionTextDualEncoderProcessor.image_processor",description:`<strong>image_processor</strong> (<a href="/docs/transformers/main/en/model_doc/auto#transformers.AutoImageProcessor">AutoImageProcessor</a>) &#x2014;
...
`}}),de=new Dr({props:{$$slots:{default:[Fr]},$$scope:{ctx:A}}}),ce=new va({props:{anchor:"transformers.VisionTextDualEncoderModel.forward.example",$$slots:{default:[qr]},$$scope:{ctx:A}}}),Oe=new Pt({}),Ne=new R({props:{name:"class transformers.FlaxVisionTextDualEncoderModel",anchor:"transformers.FlaxVisionTextDualEncoderModel",parameters:[{name:"config",val:": VisionTextDualEncoderConfig"},{name:"input_shape",val:": typing.Optional[typing.Tuple] = None"},{name:"seed",val:": int = 0"},{name:"dtype",val:": dtype = <class 'jax.numpy.float32'>"},{name:"_do_init",val:": bool = True"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.FlaxVisionTextDualEncoderModel.config",description:`<strong>config</strong> (<a href="/docs/transformers/main/en/model_doc/vision-text-dual-encoder#transformers.VisionTextDualEncoderConfig">VisionTextDualEncoderConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
...
model configuration.`),Vn=c(),se=n("div"),T($e.$$.fragment),Dn=c(),ye=n("p"),Pn=r("Serializes this instance to a Python dictionary. Override the default "),ht=n("a"),Mn=r("to_dict()"),zn=r("."),lo=c(),Z=n("h2"),ae=n("a"),qt=n("span"),T(we.$$.fragment),Cn=c(),Lt=n("span"),In=r("VisionTextDualEncoderProcessor"),co=c(),z=n("div"),T(je.$$.fragment),An=c(),St=n("p"),Fn=r(`Constructs a VisionTextDualEncoder processor which wraps an image processor and a tokenizer into a single
processor.`),qn=c(),C=n("p"),ut=n("a"),Ln=r("VisionTextDualEncoderProcessor"),Sn=r(" offers all the functionalities of "),gt=n("a"),On=r("AutoImageProcessor"),Nn=r(" and "),_t=n("a"),Bn=r("AutoTokenizer"),Wn=r(`.
See the `),Ot=n("code"),Rn=r("__call__()"),Un=r(" and "),vt=n("a"),Jn=r("decode()"),Hn=r(` for more
...
and behavior.`),ys=c(),F=n("div"),T(Se.$$.fragment),ws=c(),X=n("p"),js=r("The "),$t=n("a"),ks=r("VisionTextDualEncoderModel"),Vs=r(" forward method, overrides the "),Rt=n("code"),Ds=r("__call__"),Ps=r(" special method."),Ms=c(),T(de.$$.fragment),zs=c(),T(ce.$$.fragment),fo=c(),K=n("h2"),me=n("a"),Ut=n("span"),T(Oe.$$.fragment),Cs=c(),Jt=n("span"),Is=r("FlaxVisionTextDualEncoderModel"),ho=c(),j=n("div"),T(Ne.$$.fragment),As=c(),Be=n("p"),Fs=r(`This class can be used to initialize a vision-text dual encoder model with any pretrained vision autoencoding model
as the vision encoder and any pretrained text model as the text encoder. The vision and text encoders are loaded
via the `),yt=n("a"),qs=r("from_pretrained()"),Ls=r(` method. The projection layers are automatically added to the model and
should be fine-tuned on a downstream task, like contrastive image-text modeling.`),Ss=c(),We=n("p"),Os=r("In "),Re=n("a"),Ns=r("LiT: Zero-Shot Transfer with Locked-image Text Tuning"),Bs=r(` it is shown how
leveraging pre-trained (locked/frozen) image and text model for contrastive learning yields significant improvment
...
general usage and behavior.`),Ys=c(),Zt=n("p"),ea=r("Finally, this model supports inherent JAX features such as:"),ta=c(),O=n("ul"),Gt=n("li"),Ze=n("a"),oa=r("Just-In-Time (JIT) compilation"),na=c(),Xt=n("li"),Ge=n("a"),sa=r("Automatic Differentiation"),aa=c(),Kt=n("li"),Xe=n("a"),ra=r("Vectorization"),ia=c(),Qt=n("li"),Ke=n("a"),la=r("Parallelization"),da=c(),q=n("div"),T(Qe.$$.fragment),ca=c(),Q=n("p"),ma=r("The "),jt=n("a"),pa=r("FlaxVisionTextDualEncoderModel"),fa=r(" forward method, overrides the "),Yt=n("code"),ha=r("__call__"),ua=r(" special method."),ga=c(),T(pe.$$.fragment),_a=c(),T(fe.$$.fragment),this.h()},l(o){const u=Cr('[data-svelte="svelte-1phssyn"]',document.head);p=s(u,"META",{name:!0,content:!0}),u.forEach(t),x=m(o),g=s(o,"H1",{class:!0});var Ye=a(g);f=s(Ye,"A",{id:!0,class:!0,href:!0});var eo=a(f);v=s(eo,"SPAN",{});var to=a(v);b(d.$$.fragment,to),to.forEach(t),eo.forEach(t),h=m(Ye),S=s(Ye,"SPAN",{});var oo=a(S);qo=i(oo,"VisionTextDualEncoder"),oo.forEach(t),Ye.forEach(t),no=m(o),U=s(o,"H2",{class:!0});var et=a(U);Y=s(et,"A",{id:!0,class:!0,href:!0});var ba=a(Y);Mt=s(ba,"SPAN",{});var Ea=a(Mt);b(_e.$$.fragment,Ea),Ea.forEach(t),ba.forEach(t),Lo=m(et),zt=s(et,"SPAN",{});var $a=a(zt);So=i($a,"Overview"),$a.forEach(t),et.forEach(t),so=m(o),k=s(o,"P",{});var D=a(k);Oo=i(D,"The "),ot=s(D,"A",{href:!0});var ya=a(ot);No=i(ya,"VisionTextDualEncoderModel"),ya.forEach(t),Bo=i(D,` can be used to initialize a vision-text dual encoder model with
any pretrained vision autoencoding model as the vision encoder (`),Ct=s(D,"EM",{});var wa=a(Ct);Wo=i(wa,"e.g."),wa.forEach(t),Ro=m(D),nt=s(D,"A",{href:!0});var ja=a(nt);Uo=i(ja,"ViT"),ja.forEach(t),Jo=i(D,", "),st=s(D,"A",{href:!0});var ka=a(st);Ho=i(ka,"BEiT"),ka.forEach(t),Zo=i(D,", "),at=s(D,"A",{href:!0});var Va=a(at);Go=i(Va,"DeiT"),Va.forEach(t),Xo=i(D,") and any pretrained text autoencoding model as the text encoder ("),It=s(D,"EM",{});var Da=a(It);Ko=i(Da,"e.g."),Da.forEach(t),Qo=m(D),rt=s(D,"A",{href:!0});var Pa=a(rt);Yo=i(Pa,"RoBERTa"),Pa.forEach(t),en=i(D,", "),it=s(D,"A",{href:!0});var Ma=a(it);tn=i(Ma,"BERT"),Ma.forEach(t),on=i(D,`). Two projection layers are added on top of both the vision and text encoder to project the output embeddings
to a shared latent space. The projection layers are randomly initialized so the model should be fine-tuned on a
downstream task. This model can be used to align the vision-text embeddings using CLIP like contrastive image-text
...
documentation from `),pt=s(kt,"A",{href:!0});var Oa=a(pt);Tn=i(Oa,"PretrainedConfig"),Oa.forEach(t),bn=i(kt," for more information."),kt.forEach(t),En=m(L),b(oe.$$.fragment,L),$n=m(L),ne=s(L,"DIV",{class:!0});var vo=a(ne);b(be.$$.fragment,vo),yn=m(vo),Ee=s(vo,"P",{});var xo=a(Ee);wn=i(xo,"Instantiate a "),ft=s(xo,"A",{href:!0});var Na=a(ft);jn=i(Na,"VisionTextDualEncoderConfig"),Na.forEach(t),kn=i(xo,` (or a derived class) from text model configuration and vision
model configuration.`),xo.forEach(t),vo.forEach(t),Vn=m(L),se=s(L,"DIV",{class:!0});var To=a(se);b($e.$$.fragment,To),Dn=m(To),ye=s(To,"P",{});var bo=a(ye);Pn=i(bo,"Serializes this instance to a Python dictionary. Override the default "),ht=s(bo,"A",{href:!0});var Ba=a(ht);Mn=i(Ba,"to_dict()"),Ba.forEach(t),zn=i(bo,"."),bo.forEach(t),To.forEach(t),L.forEach(t),lo=m(o),Z=s(o,"H2",{class:!0});var Eo=a(Z);ae=s(Eo,"A",{id:!0,class:!0,href:!0});var Wa=a(ae);qt=s(Wa,"SPAN",{});var Ra=a(qt);b(we.$$.fragment,Ra),Ra.forEach(t),Wa.forEach(t),Cn=m(Eo),Lt=s(Eo,"SPAN",{});var Ua=a(Lt);In=i(Ua,"VisionTextDualEncoderProcessor"),Ua.forEach(t),Eo.forEach(t),co=m(o),z=s(o,"DIV",{class:!0});var W=a(z);b(je.$$.fragment,W),An=m(W),St=s(W,"P",{});var Ja=a(St);Fn=i(Ja,`Constructs a VisionTextDualEncoder processor which wraps an image processor and a tokenizer into a single
processor.`),Ja.forEach(t),qn=m(W),C=s(W,"P",{});var N=a(C);ut=s(N,"A",{href:!0});var Ha=a(ut);Ln=i(Ha,"VisionTextDualEncoderProcessor"),Ha.forEach(t),Sn=i(N," offers all the functionalities of "),gt=s(N,"A",{href:!0});var Za=a(gt);On=i(Za,"AutoImageProcessor"),Za.forEach(t),Nn=i(N," and "),_t=s(N,"A",{href:!0});var Ga=a(_t);Bn=i(Ga,"AutoTokenizer"),Ga.forEach(t),Wn=i(N,`.
See the `),Ot=s(N,"CODE",{});var Xa=a(Ot);Rn=i(Xa,"__call__()"),Xa.forEach(t),Un=i(N," and "),vt=s(N,"A",{href:!0});var Ka=a(vt);Jn=i(Ka,"decode()"),Ka.forEach(t),Hn=i(N,` for more
information.`),N.forEach(t),Zn=m(W),re=s(W,"DIV",{class:!0});var $o=a(re);b(ke.$$.fragment,$o),Gn=m($o),Ve=s($o,"P",{});var yo=a(Ve);Xn=i(yo,`This method forwards all its arguments to VisionTextDualEncoderTokenizer\u2019s
`),xt=s(yo,"A",{href:!0});var Qa=a(xt);Kn=i(Qa,"batch_decode()"),Qa.forEach(t),Qn=i(yo,". Please refer to the docstring of this method for more information."),yo.forEach(t),$o.forEach(t),Yn=m(W),ie=s(W,"DIV",{class:!0});var wo=a(ie);b(De.$$.fragment,wo),es=m(wo),Pe=s(wo,"P",{});var jo=a(Pe);ts=i(jo,"This method forwards all its arguments to VisionTextDualEncoderTokenizer\u2019s "),Tt=s(jo,"A",{href:!0});var Ya=a(Tt);os=i(Ya,"decode()"),Ya.forEach(t),ns=i(jo,`.
Please refer to the docstring of this method for more information.`),jo.forEach(t),wo.forEach(t),W.forEach(t),mo=m(o),G=s(o,"H2",{class:!0});var ko=a(G);le=s(ko,"A",{id:!0,class:!0,href:!0});var er=a(le);Nt=s(er,"SPAN",{});var tr=a(Nt);b(Me.$$.fragment,tr),tr.forEach(t),er.forEach(t),ss=m(ko),Bt=s(ko,"SPAN",{});var or=a(Bt);as=i(or,"VisionTextDualEncoderModel"),or.forEach(t),ko.forEach(t),po=m(o),V=s(o,"DIV",{class:!0});var I=a(V);b(ze.$$.fragment,I),rs=m(I),Ce=s(I,"P",{});var Vo=a(Ce);is=i(Vo,`This class can be used to initialize a vision-text dual encoder model with any pretrained vision autoencoding model
as the vision encoder and any pretrained text model as the text encoder. The vision and text encoders are loaded
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Mo.forEach(t),ys=m(I),F=s(I,"DIV",{class:!0});var he=a(F);b(Se.$$.fragment,he),ws=m(he),X=s(he,"P",{});var Vt=a(X);js=i(Vt,"The "),$t=s(Vt,"A",{href:!0});var lr=a($t);ks=i(lr,"VisionTextDualEncoderModel"),lr.forEach(t),Vs=i(Vt," forward method, overrides the "),Rt=s(Vt,"CODE",{});var dr=a(Rt);Ds=i(dr,"__call__"),dr.forEach(t),Ps=i(Vt," special method."),Vt.forEach(t),Ms=m(he),b(de.$$.fragment,he),zs=m(he),b(ce.$$.fragment,he),he.forEach(t),I.forEach(t),fo=m(o),K=s(o,"H2",{class:!0});var zo=a(K);me=s(zo,"A",{id:!0,class:!0,href:!0});var cr=a(me);Ut=s(cr,"SPAN",{});var mr=a(Ut);b(Oe.$$.fragment,mr),mr.forEach(t),cr.forEach(t),Cs=m(zo),Jt=s(zo,"SPAN",{});var pr=a(Jt);Is=i(pr,"FlaxVisionTextDualEncoderModel"),pr.forEach(t),zo.forEach(t),ho=m(o),j=s(o,"DIV",{class:!0});var P=a(j);b(Ne.$$.fragment,P),As=m(P),Be=s(P,"P",{});var Co=a(Be);Fs=i(Co,`This class can be used to initialize a vision-text dual encoder model with any pretrained vision autoencoding model
as the vision encoder and any pretrained text model as the text encoder. The vision and text encoders are loaded
via the `),yt=s(Co,"A",{href:!0});var fr=a(yt);qs=i(fr,"from_pretrained()"),fr.forEach(t),Ls=i(Co,` method. The projection layers are automatically added to the model and
should be fine-tuned on a downstream task, like contrastive image-text modeling.`),Co.forEach(t),Ss=m(P),We=s(P,"P",{});var Io=a(We);Os=i(Io,"In "),Re=s(Io,"A",{href:!0,rel:!0});var hr=a(Re);Ns=i(hr,"LiT: Zero-Shot Transfer with Locked-image Text Tuning"),hr.forEach(t),Bs=i(Io,` it is shown how
leveraging pre-trained (locked/frozen) image and text model for contrastive learning yields significant improvment
...
models (see the examples for more information).`),ur.forEach(t),Us=m(P),Ue=s(P,"P",{});var Ao=a(Ue);Js=i(Ao,"This model inherits from "),wt=s(Ao,"A",{href:!0});var gr=a(wt);Hs=i(gr,"PreTrainedModel"),gr.forEach(t),Zs=i(Ao,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
