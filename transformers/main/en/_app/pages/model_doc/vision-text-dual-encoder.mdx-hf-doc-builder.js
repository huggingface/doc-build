...
and behavior.`),wa=c(),A=n("div"),T(Se.$$.fragment),ja=c(),X=n("p"),ya=r("The "),$t=n("a"),ka=r("VisionTextDualEncoderModel"),Va=r(" forward method, overrides the "),Rt=n("code"),Da=r("__call__"),Pa=r(" special method."),Ma=c(),T(de.$$.fragment),za=c(),T(ce.$$.fragment),fo=c(),K=n("h2"),me=n("a"),Ut=n("span"),T(Ne.$$.fragment),Ca=c(),Jt=n("span"),Fa=r("FlaxVisionTextDualEncoderModel"),ho=c(),y=n("div"),T(Oe.$$.fragment),Ia=c(),Be=n("p"),Aa=r(`This class can be used to initialize a vision-text dual encoder model with any pretrained vision autoencoding model
as the vision encoder and any pretrained text model as the text encoder. The vision and text encoders are loaded
...
general usage and behavior.`),Ya=c(),Zt=n("p"),es=r("Finally, this model supports inherent JAX features such as:"),ts=c(),N=n("ul"),Gt=n("li"),Ze=n("a"),os=r("Just-In-Time (JIT) compilation"),ns=c(),Xt=n("li"),Ge=n("a"),as=r("Automatic Differentiation"),ss=c(),Kt=n("li"),Xe=n("a"),rs=r("Vectorization"),is=c(),Qt=n("li"),Ke=n("a"),ls=r("Parallelization"),ds=c(),q=n("div"),T(Qe.$$.fragment),cs=c(),Q=n("p"),ms=r("The "),yt=n("a"),ps=r("FlaxVisionTextDualEncoderModel"),fs=r(" forward method, overrides the "),Yt=n("code"),hs=r("__call__"),us=r(" special method."),gs=c(),T(pe.$$.fragment),_s=c(),T(fe.$$.fragment),this.h()},l(o){const u=Cr('[data-svelte="svelte-1phssyn"]',document.head);p=a(u,"META",{name:!0,content:!0}),u.forEach(t),v=m(o),g=a(o,"H1",{class:!0});var Ye=s(g);f=a(Ye,"A",{id:!0,class:!0,href:!0});var eo=s(f);x=a(eo,"SPAN",{});var to=s(x);b(d.$$.fragment,to),to.forEach(t),eo.forEach(t),h=m(Ye),S=a(Ye,"SPAN",{});var oo=s(S);qo=i(oo,"VisionTextDualEncoder"),oo.forEach(t),Ye.forEach(t),no=m(o),U=a(o,"H2",{class:!0});var et=s(U);Y=a(et,"A",{id:!0,class:!0,href:!0});var bs=s(Y);Mt=a(bs,"SPAN",{});var Es=s(Mt);b(_e.$$.fragment,Es),Es.forEach(t),bs.forEach(t),Lo=m(et),zt=a(et,"SPAN",{});var $s=s(zt);So=i($s,"Overview"),$s.forEach(t),et.forEach(t),ao=m(o),k=a(o,"P",{});var D=s(k);No=i(D,"The "),ot=a(D,"A",{href:!0});var ws=s(ot);Oo=i(ws,"VisionTextDualEncoderModel"),ws.forEach(t),Bo=i(D,` can be used to initialize a vision-text dual encoder model with
...
documentation from `),pt=a(kt,"A",{href:!0});var Ns=s(pt);Tn=i(Ns,"PretrainedConfig"),Ns.forEach(t),bn=i(kt," for more information."),kt.forEach(t),En=m(L),b(oe.$$.fragment,L),$n=m(L),ne=a(L,"DIV",{class:!0});var xo=s(ne);b(be.$$.fragment,xo),wn=m(xo),Ee=a(xo,"P",{});var vo=s(Ee);jn=i(vo,"Instantiate a "),ft=a(vo,"A",{href:!0});var Os=s(ft);yn=i(Os,"VisionTextDualEncoderConfig"),Os.forEach(t),kn=i(vo,` (or a derived class) from text model configuration and vision
model configuration.`),vo.forEach(t),xo.forEach(t),Vn=m(L),ae=a(L,"DIV",{class:!0});var To=s(ae);b($e.$$.fragment,To),Dn=m(To),we=a(To,"P",{});var bo=s(we);Pn=i(bo,"Serializes this instance to a Python dictionary. Override the default "),ht=a(bo,"A",{href:!0});var Bs=s(ht);Mn=i(Bs,"to_dict()"),Bs.forEach(t),zn=i(bo,"."),bo.forEach(t),To.forEach(t),L.forEach(t),lo=m(o),Z=a(o,"H2",{class:!0});var Eo=s(Z);se=a(Eo,"A",{id:!0,class:!0,href:!0});var Ws=s(se);qt=a(Ws,"SPAN",{});var Rs=s(qt);b(je.$$.fragment,Rs),Rs.forEach(t),Ws.forEach(t),Cn=m(Eo),Lt=a(Eo,"SPAN",{});var Us=s(Lt);Fn=i(Us,"VisionTextDualEncoderProcessor"),Us.forEach(t),Eo.forEach(t),co=m(o),z=a(o,"DIV",{class:!0});var W=s(z);b(ye.$$.fragment,W),In=m(W),St=a(W,"P",{});var Js=s(St);An=i(Js,`Constructs a VisionTextDualEncoder processor which wraps a vision feature extractor and a tokenizer into a single
...
`),xt=a(O,"A",{href:!0});var Ks=s(xt);Jn=i(Ks,"decode()"),Ks.forEach(t),Hn=i(O," for more information."),O.forEach(t),Zn=m(W),re=a(W,"DIV",{class:!0});var $o=s(re);b(ke.$$.fragment,$o),Gn=m($o),Ve=a($o,"P",{});var wo=s(Ve);Xn=i(wo,`This method forwards all its arguments to VisionTextDualEncoderTokenizer\u2019s
