import{S as E2,i as C2,s as P2,e as o,k as d,w as u,t as r,M as S2,c as a,d as t,m as l,a as s,x as m,h as i,b as c,F as e,g as h,y as f,q as g,o as _,B as k,v as A2}from"../../chunks/vendor-6b77c823.js";import{T as st}from"../../chunks/Tip-39098574.js";import{D as F}from"../../chunks/Docstring-abef54e3.js";import{C as $}from"../../chunks/CodeBlock-3a8b25a8.js";import{I as X}from"../../chunks/IconCopyLink-7a11ce68.js";function O2(E){let b,z,v,M,x;return{c(){b=o("p"),z=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),v=o("code"),M=r("Module"),x=r(`
...
first positional argument :`),se=d(),C=o("ul"),A=o("li"),lt=r("a single Tensor with "),pe=o("code"),he=r("input_ids"),ct=r(" only and nothing else: "),K=o("code"),pt=r("model(input_ids)"),ht=d(),D=o("li"),Pe=r(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
...
the latter silently ignores them.`)},l(T){b=a(T,"P",{});var y=s(b);z=i(y,"Although the recipe for forward pass needs to be defined within this function, one should call the "),v=a(y,"CODE",{});var q=s(v);M=i(q,"Module"),q.forEach(t),x=i(y,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),y.forEach(t)},m(T,y){h(T,b,y),e(b,z),e(b,v),e(v,M),e(b,x)},d(T){T&&t(b)}}}function V2(E){let b,z,v,M,x,T,y,q,rt,Ce,j,Re,ke,it,be,ye,dt,Ke,J,N,Xe,se,C,A,lt,pe,he,ct,K,pt,ht,D,Pe,ve,Ze,re,Te,we,ut,ie,Me,xe,Ye,w,B,ze,Qe,Ut,Z,Rt,bt,Q,de,le,Xt,Qt,ce,Ht,Vt,He,Jt,Cu,rd,Pu,Su,gp,yt,Au,Co,id,Ou,Iu,Nu,ei,Du,Lu,_p,ti,dd,Gu,kp,Po,bp,ni,So,ld,Wu,Uu,Kt,Ru,cd,Xu,Qu,pd,Hu,Vu,yp,Ao,vp,Zt,Pn,hd,Oo,Ju,ud,Ku,Tp,vt,Zu,Io,Yu,em,md,tm,nm,wp,oi,om,Mp,ai,fd,am,xp,Yt,Sn,gd,No,sm,_d,rm,zp,et,im,kd,dm,lm,bd,cm,pm,yd,hm,um,Fp,An,mm,si,fm,gm,qp,ri,vd,_m,$p,Do,Bp,ii,Lo,Td,km,bm,Fe,ym,wd,vm,Tm,Md,wm,Mm,xd,xm,zm,zd,Fm,qm,Fd,$m,Bm,jp,Go,Ep,en,On,qd,Wo,jm,$d,Em,Cp,qe,Uo,Cm,tn,Pm,di,Sm,Am,Ro,Om,Im,Nm,nn,Dm,li,Lm,Gm,ci,Wm,Um,Rm,Bd,Xm,Qm,Xo,Pp,on,In,jd,Qo,Hm,Ed,Vm,Sp,G,Ho,Jm,Cd,Km,Zm,mt,Ym,pi,ef,tf,hi,nf,of,Vo,af,sf,rf,Jo,df,Pd,lf,cf,pf,Sd,hf,uf,Ko,mf,Nn,Zo,ff,Ad,gf,_f,tt,Yo,kf,ea,bf,Od,yf,vf,Tf,ta,na,Id,wf,Mf,Nd,xf,zf,oa,Dd,Ff,qf,Ld,$f,Bf,Gd,jf,Ap,an,Dn,Wd,aa,Ef,Ud,Cf,Op,P,sa,Pf,sn,Sf,Rd,Af,Of,ra,If,Nf,Df,ia,Lf,ui,Gf,Wf,Uf,da,Rf,Xd,Xf,Qf,Hf,Qd,Vf,Jf,la,Kf,Se,ca,Zf,Hd,Yf,eg,pa,tg,Vd,ng,og,ag,ha,ua,Jd,sg,rg,Kd,ig,dg,ma,Zd,lg,cg,Yd,pg,hg,el,ug,mg,Ln,fa,fg,tl,gg,_g,Gn,ga,kg,nl,bg,yg,Wn,_a,vg,ol,Tg,Ip,rn,Un,al,ka,wg,sl,Mg,Np,S,ba,xg,ya,zg,va,Fg,qg,$g,Ta,Bg,mi,jg,Eg,Cg,rl,Pg,Sg,wa,Ag,nt,Ma,Og,xa,Ig,il,Ng,Dg,Lg,za,Fa,dl,Gg,Wg,ll,Ug,Rg,qa,cl,Xg,Qg,pl,Hg,Vg,hl,Jg,Kg,Rn,$a,Zg,ul,Yg,e_,Xn,Ba,t_,ja,n_,ml,o_,a_,s_,Qn,Ea,r_,fl,i_,d_,Hn,Ca,l_,gl,c_,Dp,dn,Vn,_l,Pa,p_,kl,h_,Lp,W,Sa,u_,ln,m_,bl,f_,g_,Aa,__,k_,b_,Oa,y_,fi,v_,T_,w_,yl,M_,x_,Ia,z_,Ae,Na,F_,vl,q_,$_,Da,B_,Tl,j_,E_,C_,La,Ga,wl,P_,S_,Ml,A_,O_,Wa,xl,I_,N_,zl,D_,L_,Fl,G_,W_,Jn,Ua,U_,ql,R_,X_,Kn,Ra,Q_,$l,H_,Gp,cn,Zn,Bl,Xa,V_,jl,J_,Wp,Ve,Qa,K_,Ha,Z_,gi,Y_,ek,tk,Va,nk,Ja,ok,ak,sk,Oe,Ka,rk,pn,ik,_i,dk,lk,El,ck,pk,hk,Yn,uk,Cl,mk,fk,Za,Up,hn,eo,Pl,Ya,gk,Sl,_k,Rp,Je,es,kk,ts,bk,ki,yk,vk,Tk,ns,wk,os,Mk,xk,zk,Y,as,Fk,un,qk,bi,$k,Bk,Al,jk,Ek,Ck,to,Pk,Ol,Sk,Ak,ss,Ok,Il,Ik,Nk,rs,Xp,mn,no,Nl,is,Dk,Dl,Lk,Qp,$e,ds,Gk,fn,Wk,Ll,Uk,Rk,Gl,Xk,Qk,Hk,ls,Vk,yi,Jk,Kk,Zk,cs,Yk,ps,eb,tb,nb,ue,hs,ob,gn,ab,vi,sb,rb,Wl,ib,db,lb,oo,cb,Ul,pb,hb,us,ub,ms,Hp,_n,ao,Rl,fs,mb,Xl,fb,Vp,Be,gs,gb,Ql,_b,kb,_s,bb,Ti,yb,vb,Tb,ks,wb,bs,Mb,xb,zb,L,ys,Fb,kn,qb,wi,$b,Bb,Hl,jb,Eb,Cb,so,Pb,Vl,Sb,Ab,vs,Ob,Ts,Ib,Jl,Nb,Db,ws,Lb,Ms,Jp,bn,ro,Kl,xs,Gb,Zl,Wb,Kp,yn,zs,Ub,Tt,Fs,Rb,Yl,Xb,Qb,qs,Zp,vn,io,ec,$s,Hb,tc,Vb,Yp,je,Bs,Jb,js,Kb,Mi,Zb,Yb,ey,Es,ty,Cs,ny,oy,ay,lo,sy,Ie,Ps,ry,Tn,iy,xi,dy,ly,nc,cy,py,hy,co,uy,oc,my,fy,Ss,eh,wn,po,ac,As,gy,sc,_y,th,Ee,Os,ky,Is,by,zi,yy,vy,Ty,Ns,wy,Ds,My,xy,zy,ho,Fy,ee,Ls,qy,Mn,$y,Fi,By,jy,rc,Ey,Cy,Py,uo,Sy,ic,Ay,Oy,Gs,Iy,dc,Ny,Dy,Ws,nh,xn,mo,lc,Us,Ly,cc,Gy,oh,U,Rs,Wy,Xs,Uy,qi,Ry,Xy,Qy,Qs,Hy,Hs,Vy,Jy,Ky,pc,Zy,Yy,ft,hc,Vs,ev,tv,uc,Js,nv,ov,mc,Ks,av,sv,fc,Zs,rv,iv,Ne,Ys,dv,zn,lv,gc,cv,pv,_c,hv,uv,mv,fo,fv,kc,gv,_v,er,kv,wt,tr,bv,bc,yv,vv,nr,Tv,Mt,or,wv,yc,Mv,xv,ar,ah,Fn,go,vc,sr,zv,Tc,Fv,sh,R,rr,qv,ir,$v,$i,Bv,jv,Ev,dr,Cv,lr,Pv,Sv,Av,wc,Ov,Iv,gt,Mc,cr,Nv,Dv,xc,pr,Lv,Gv,zc,hr,Wv,Uv,Fc,ur,Rv,Xv,te,mr,Qv,qn,Hv,qc,Vv,Jv,$c,Kv,Zv,Yv,_o,eT,Bc,tT,nT,fr,oT,jc,aT,sT,gr,rT,xt,_r,iT,Ec,dT,lT,kr,cT,zt,br,pT,Cc,hT,uT,yr,rh,$n,ko,Pc,vr,mT,Sc,fT,ih,O,Tr,gT,Ac,_T,kT,wr,bT,Bi,yT,vT,TT,Mr,wT,xr,MT,xT,zT,Oc,FT,qT,_t,Ic,zr,$T,BT,Nc,Fr,jT,ET,Dc,qr,CT,PT,Lc,$r,ST,AT,De,Br,OT,Bn,IT,Gc,NT,DT,Wc,LT,GT,WT,bo,UT,Uc,RT,XT,jr,QT,Ft,Er,HT,Rc,VT,JT,Cr,KT,qt,Pr,ZT,Xc,YT,ew,Sr,dh,jn,yo,Qc,Ar,tw,Hc,nw,lh,I,Or,ow,En,aw,Vc,sw,rw,Jc,iw,dw,lw,Ir,cw,ji,pw,hw,uw,Nr,mw,Dr,fw,gw,_w,Kc,kw,bw,kt,Zc,Lr,yw,vw,Yc,Gr,Tw,ww,ep,Wr,Mw,xw,tp,Ur,zw,Fw,Le,Rr,qw,Cn,$w,np,Bw,jw,op,Ew,Cw,Pw,vo,Sw,ap,Aw,Ow,Xr,Iw,$t,Qr,Nw,sp,Dw,Lw,Hr,Gw,Bt,Vr,Ww,rp,Uw,Rw,Jr,ch;return T=new X({}),se=new X({}),Qe=new X({}),Po=new $({props:{code:`from transformers import MBartForConditionalGeneration, MBartTokenizer
...
`}}),Yn=new st({props:{$$slots:{default:[O2]},$$scope:{ctx:E}}}),Za=new $({props:{code:`from transformers import MBartTokenizer, MBartModel
import torch
...
@patrickvonplaten`),Ke=d(),J=o("h2"),N=o("a"),Xe=o("span"),u(se.$$.fragment),C=d(),A=o("span"),lt=r("Overview of MBart"),pe=d(),he=o("p"),ct=r("The MBart model was presented in "),K=o("a"),pt=r("Multilingual Denoising Pre-training for Neural Machine Translation"),ht=r(` by Yinhan Liu, Jiatao Gu, Naman Goyal, Xian Li, Sergey Edunov Marjan
...
target text format is `),He=o("code"),Jt=r("[tgt_lang_code] X [eos]"),Cu=r(". "),rd=o("code"),Pu=r("bos"),Su=r(" is never used."),gp=d(),yt=o("p"),Au=r("The regular "),Co=o("a"),id=o("strong"),Ou=r("call"),Iu=r("()"),Nu=r(` will encode source text format, and it should be wrapped
...
respectively.`),Fp=d(),An=o("p"),mm=r("MBart-50 has its own tokenizer "),si=o("a"),fm=r("MBart50Tokenizer"),gm=r("."),qp=d(),ri=o("ul"),vd=o("li"),_m=r("Supervised training"),$p=d(),u(Do.$$.fragment),Bp=d(),ii=o("ul"),Lo=o("li"),Td=o("p"),km=r("Generation"),bm=d(),Fe=o("p"),ym=r("To generate using the mBART-50 multilingual translation models, "),wd=o("code"),vm=r("eos_token_id"),Tm=r(` is used as the
...
`),Fd=o("em"),$m=r("facebook/mbart-50-large-many-to-many"),Bm=r(" checkpoint."),jp=d(),u(Go.$$.fragment),Ep=d(),en=o("h2"),On=o("a"),qd=o("span"),u(Wo.$$.fragment),jm=d(),$d=o("span"),Em=r("MBartConfig"),Cp=d(),qe=o("div"),u(Uo.$$.fragment),Cm=d(),tn=o("p"),Pm=r("This is the configuration class to store the configuration of a "),di=o("a"),Sm=r("MBartModel"),Am=r(`. It is used to instantiate an MBART
...
`),Vo=o("a"),af=r("SentencePiece"),sf=r("."),rf=d(),Jo=o("p"),df=r("The tokenization method is "),Pd=o("code"),lf=r("<tokens> <eos> <language code>"),cf=r(" for source language documents, and \u201C<language code>\n<tokens> <eos>``` for target language documents."),pf=d(),Sd=o("p"),hf=r("Examples:"),uf=d(),u(Ko.$$.fragment),mf=d(),Nn=o("div"),u(Zo.$$.fragment),ff=d(),Ad=o("p"),gf=r(`Temporarily sets the tokenizer for encoding the targets. Useful for tokenizer associated to
...
separator.`),Ap=d(),an=o("h2"),Dn=o("a"),Wd=o("span"),u(aa.$$.fragment),Ef=d(),Ud=o("span"),Cf=r("MBartTokenizerFast"),Op=d(),P=o("div"),u(sa.$$.fragment),Pf=d(),sn=o("p"),Sf=r("Construct a \u201Cfast\u201D MBART tokenizer (backed by HuggingFace\u2019s "),Rd=o("em"),Af=r("tokenizers"),Of=r(` library). Based on
...
this superclass for more information regarding those methods.`),Cg=d(),rl=o("p"),Pg=r("Examples:"),Sg=d(),u(wa.$$.fragment),Ag=d(),nt=o("div"),u(Ma.$$.fragment),Og=d(),xa=o("p"),Ig=r(`Build model inputs from a sequence or a pair of sequence for sequence classification tasks by concatenating and
...
`),Aa=o("a"),__=r("BPE"),k_=r("."),b_=d(),Oa=o("p"),y_=r("This tokenizer inherits from "),fi=o("a"),v_=r("PreTrainedTokenizerFast"),T_=r(` which contains most of the main methods. Users should
refer to this superclass for more information regarding those methods.`),w_=d(),yl=o("p"),M_=r("Examples:"),x_=d(),u(Ia.$$.fragment),z_=d(),Ae=o("div"),u(Na.$$.fragment),F_=d(),vl=o("p"),q_=r(`Build model inputs from a sequence or a pair of sequence for sequence classification tasks by concatenating and
adding special tokens. The special tokens depend on calling set_lang.`),$_=d(),Da=o("p"),B_=r("An MBART-50 sequence has the following format, where "),Tl=o("code"),j_=r("X"),E_=r(" represents the sequence:"),C_=d(),La=o("ul"),Ga=o("li"),wl=o("code"),P_=r("input_ids"),S_=r(" (for encoder) "),Ml=o("code"),A_=r("[src_lang_code] X [eos]"),O_=d(),Wa=o("li"),xl=o("code"),I_=r("labels"),N_=r(": (for decoder) "),zl=o("code"),D_=r("[tgt_lang_code] X [eos]"),L_=d(),Fl=o("p"),G_=r(`BOS is never used. Pairs of sequences are not the expected use case, but they will be handled without a
...
and behavior.`),sk=d(),Oe=o("div"),u(Ka.$$.fragment),rk=d(),pn=o("p"),ik=r("The "),_i=o("a"),dk=r("MBartModel"),lk=r(" forward method, overrides the "),El=o("code"),ck=r("__call__"),pk=r(" special method."),hk=d(),u(Yn.$$.fragment),uk=d(),Cl=o("p"),mk=r("Example:"),fk=d(),u(Za.$$.fragment),Up=d(),hn=o("h2"),eo=o("a"),Pl=o("span"),u(Ya.$$.fragment),gk=d(),Sl=o("span"),_k=r("MBartForConditionalGeneration"),Rp=d(),Je=o("div"),u(es.$$.fragment),kk=d(),ts=o("p"),bk=r(`The MBART Model with a language modeling head. Can be used for summarization.
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),zk=d(),Y=o("div"),u(as.$$.fragment),Fk=d(),un=o("p"),qk=r("The "),bi=o("a"),$k=r("MBartForConditionalGeneration"),Bk=r(" forward method, overrides the "),Al=o("code"),jk=r("__call__"),Ek=r(" special method."),Ck=d(),u(to.$$.fragment),Pk=d(),Ol=o("p"),Sk=r("Translation example:"),Ak=d(),u(ss.$$.fragment),Ok=d(),Il=o("p"),Ik=r("Mask filling example:"),Nk=d(),u(rs.$$.fragment),Xp=d(),mn=o("h2"),no=o("a"),Nl=o("span"),u(is.$$.fragment),Dk=d(),Dl=o("span"),Lk=r("MBartForQuestionAnswering"),Qp=d(),$e=o("div"),u(ds.$$.fragment),Gk=d(),fn=o("p"),Wk=r(`MBART Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
...
behavior.`),ay=d(),u(lo.$$.fragment),sy=d(),Ie=o("div"),u(Ps.$$.fragment),ry=d(),Tn=o("p"),iy=r("The "),xi=o("a"),dy=r("TFMBartModel"),ly=r(" forward method, overrides the "),nc=o("code"),cy=r("__call__"),py=r(" special method."),hy=d(),u(co.$$.fragment),uy=d(),oc=o("p"),my=r("Example:"),fy=d(),u(Ss.$$.fragment),eh=d(),wn=o("h2"),po=o("a"),ac=o("span"),u(As.$$.fragment),gy=d(),sc=o("span"),_y=r("TFMBartForConditionalGeneration"),th=d(),Ee=o("div"),u(Os.$$.fragment),ky=d(),Is=o("p"),by=r(`The MBART Model with a language modeling head. Can be used for summarization.
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),zy=d(),u(ho.$$.fragment),Fy=d(),ee=o("div"),u(Ls.$$.fragment),qy=d(),Mn=o("p"),$y=r("The "),Fi=o("a"),By=r("TFMBartForConditionalGeneration"),jy=r(" forward method, overrides the "),rc=o("code"),Ey=r("__call__"),Cy=r(" special method."),Py=d(),u(uo.$$.fragment),Sy=d(),ic=o("p"),Ay=r("Summarization example:"),Oy=d(),u(Gs.$$.fragment),Iy=d(),dc=o("p"),Ny=r("Mask filling example:"),Dy=d(),u(Ws.$$.fragment),nh=d(),xn=o("h2"),mo=o("a"),lc=o("span"),u(Us.$$.fragment),Ly=d(),cc=o("span"),Gy=r("FlaxMBartModel"),oh=d(),U=o("div"),u(Rs.$$.fragment),Wy=d(),Xs=o("p"),Uy=r(`The bare MBart Model transformer outputting raw hidden-states without any specific head on top.
...
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),zT=d(),Oc=o("p"),FT=r("Finally, this model supports inherent JAX features such as:"),qT=d(),_t=o("ul"),Ic=o("li"),zr=o("a"),$T=r("Just-In-Time (JIT) compilation"),BT=d(),Nc=o("li"),Fr=o("a"),jT=r("Automatic Differentiation"),ET=d(),Dc=o("li"),qr=o("a"),CT=r("Vectorization"),PT=d(),Lc=o("li"),$r=o("a"),ST=r("Parallelization"),AT=d(),De=o("div"),u(Br.$$.fragment),OT=d(),Bn=o("p"),IT=r("The "),Gc=o("code"),NT=r("FlaxMBartPreTrainedModel"),DT=r(" forward method, overrides the "),Wc=o("code"),LT=r("__call__"),GT=r(" special method."),WT=d(),u(bo.$$.fragment),UT=d(),Uc=o("p"),RT=r("Example:"),XT=d(),u(jr.$$.fragment),QT=d(),Ft=o("div"),u(Er.$$.fragment),HT=d(),Rc=o("p"),VT=r("Example:"),JT=d(),u(Cr.$$.fragment),KT=d(),qt=o("div"),u(Pr.$$.fragment),ZT=d(),Xc=o("p"),YT=r("Example:"),ew=d(),u(Sr.$$.fragment),dh=d(),jn=o("h2"),yo=o("a"),Qc=o("span"),u(Ar.$$.fragment),tw=d(),Hc=o("span"),nw=r("FlaxMBartForQuestionAnswering"),lh=d(),I=o("div"),u(Or.$$.fragment),ow=d(),En=o("p"),aw=r(`MBart Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
...
example shows how to translate English to Romanian using the `),pd=a(Ci,"EM",{});var pM=s(pd);Hu=i(pM,"facebook/mbart-large-en-ro"),pM.forEach(t),Vu=i(Ci," model."),Ci.forEach(t),hh.forEach(t),dM.forEach(t),yp=l(n),m(Ao.$$.fragment,n),vp=l(n),Zt=a(n,"H2",{class:!0});var uh=s(Zt);Pn=a(uh,"A",{id:!0,class:!0,href:!0});var hM=s(Pn);hd=a(hM,"SPAN",{});var uM=s(hd);m(Oo.$$.fragment,uM),uM.forEach(t),hM.forEach(t),Ju=l(uh),ud=a(uh,"SPAN",{});var mM=s(ud);Ku=i(mM,"Overview of MBart-50"),mM.forEach(t),uh.forEach(t),Tp=l(n),vt=a(n,"P",{});var Pi=s(vt);Zu=i(Pi,"MBart-50 was introduced in the "),Io=a(Pi,"A",{href:!0,rel:!0});var fM=s(Io);Yu=i(fM,"Multilingual Translation with Extensible Multilingual Pretraining and Finetuning"),fM.forEach(t),em=i(Pi,` paper by Yuqing Tang, Chau Tran, Xian Li, Peng-Jen Chen, Naman Goyal, Vishrav
...
respectively.`),wo.forEach(t),Fp=l(n),An=a(n,"P",{});var fh=s(An);mm=i(fh,"MBart-50 has its own tokenizer "),si=a(fh,"A",{href:!0});var zM=s(si);fm=i(zM,"MBart50Tokenizer"),zM.forEach(t),gm=i(fh,"."),fh.forEach(t),qp=l(n),ri=a(n,"UL",{});var FM=s(ri);vd=a(FM,"LI",{});var qM=s(vd);_m=i(qM,"Supervised training"),qM.forEach(t),FM.forEach(t),$p=l(n),m(Do.$$.fragment,n),Bp=l(n),ii=a(n,"UL",{});var $M=s(ii);Lo=a($M,"LI",{});var gh=s(Lo);Td=a(gh,"P",{});var BM=s(Td);km=i(BM,"Generation"),BM.forEach(t),bm=l(gh),Fe=a(gh,"P",{});var ot=s(Fe);ym=i(ot,"To generate using the mBART-50 multilingual translation models, "),wd=a(ot,"CODE",{});var jM=s(wd);vm=i(jM,"eos_token_id"),jM.forEach(t),Tm=i(ot,` is used as the
...
The following example shows how to translate between Hindi to French and Arabic to English using the
`),Fd=a(ot,"EM",{});var SM=s(Fd);$m=i(SM,"facebook/mbart-50-large-many-to-many"),SM.forEach(t),Bm=i(ot," checkpoint."),ot.forEach(t),gh.forEach(t),$M.forEach(t),jp=l(n),m(Go.$$.fragment,n),Ep=l(n),en=a(n,"H2",{class:!0});var _h=s(en);On=a(_h,"A",{id:!0,class:!0,href:!0});var AM=s(On);qd=a(AM,"SPAN",{});var OM=s(qd);m(Wo.$$.fragment,OM),OM.forEach(t),AM.forEach(t),jm=l(_h),$d=a(_h,"SPAN",{});var IM=s($d);Em=i(IM,"MBartConfig"),IM.forEach(t),_h.forEach(t),Cp=l(n),qe=a(n,"DIV",{class:!0});var Et=s(qe);m(Uo.$$.fragment,Et),Cm=l(Et),tn=a(Et,"P",{});var Si=s(tn);Pm=i(Si,"This is the configuration class to store the configuration of a "),di=a(Si,"A",{href:!0});var NM=s(di);Sm=i(NM,"MBartModel"),NM.forEach(t),Am=i(Si,`. It is used to instantiate an MBART
model according to the specified arguments, defining the model architecture. Instantiating a configuration with the
defaults will yield a similar configuration to that of the MBART
`),Ro=a(Si,"A",{href:!0,rel:!0});var DM=s(Ro);Om=i(DM,"facebook/mbart-large-cc25"),DM.forEach(t),Im=i(Si," architecture."),Si.forEach(t),Nm=l(Et),nn=a(Et,"P",{});var Ai=s(nn);Dm=i(Ai,"Configuration objects inherit from "),li=a(Ai,"A",{href:!0});var LM=s(li);Lm=i(LM,"PretrainedConfig"),LM.forEach(t),Gm=i(Ai,` and can be used to control the model outputs. Read the
documentation from `),ci=a(Ai,"A",{href:!0});var GM=s(ci);Wm=i(GM,"PretrainedConfig"),GM.forEach(t),Um=i(Ai," for more information."),Ai.forEach(t),Rm=l(Et),Bd=a(Et,"P",{});var WM=s(Bd);Xm=i(WM,"Example:"),WM.forEach(t),Qm=l(Et),m(Xo.$$.fragment,Et),Et.forEach(t),Pp=l(n),on=a(n,"H2",{class:!0});var kh=s(on);In=a(kh,"A",{id:!0,class:!0,href:!0});var UM=s(In);jd=a(UM,"SPAN",{});var RM=s(jd);m(Qo.$$.fragment,RM),RM.forEach(t),UM.forEach(t),Hm=l(kh),Ed=a(kh,"SPAN",{});var XM=s(Ed);Vm=i(XM,"MBartTokenizer"),XM.forEach(t),kh.forEach(t),Sp=l(n),G=a(n,"DIV",{class:!0});var me=s(G);m(Ho.$$.fragment,me),Jm=l(me),Cd=a(me,"P",{});var QM=s(Cd);Km=i(QM,"Construct an MBART tokenizer."),QM.forEach(t),Zm=l(me),mt=a(me,"P",{});var Mo=s(mt);Ym=i(Mo,"Adapted from "),pi=a(Mo,"A",{href:!0});var HM=s(pi);ef=i(HM,"RobertaTokenizer"),HM.forEach(t),tf=i(Mo," and "),hi=a(Mo,"A",{href:!0});var VM=s(hi);nf=i(VM,"XLNetTokenizer"),VM.forEach(t),of=i(Mo,`. Based on
...
separator.`),s1.forEach(t),xo.forEach(t),me.forEach(t),Ap=l(n),an=a(n,"H2",{class:!0});var xh=s(an);Dn=a(xh,"A",{id:!0,class:!0,href:!0});var r1=s(Dn);Wd=a(r1,"SPAN",{});var i1=s(Wd);m(aa.$$.fragment,i1),i1.forEach(t),r1.forEach(t),Ef=l(xh),Ud=a(xh,"SPAN",{});var d1=s(Ud);Cf=i(d1,"MBartTokenizerFast"),d1.forEach(t),xh.forEach(t),Op=l(n),P=a(n,"DIV",{class:!0});var H=s(P);m(sa.$$.fragment,H),Pf=l(H),sn=a(H,"P",{});var Oi=s(sn);Sf=i(Oi,"Construct a \u201Cfast\u201D MBART tokenizer (backed by HuggingFace\u2019s "),Rd=a(Oi,"EM",{});var l1=s(Rd);Af=i(l1,"tokenizers"),l1.forEach(t),Of=i(Oi,` library). Based on
`),ra=a(Oi,"A",{href:!0,rel:!0});var c1=s(ra);If=i(c1,"BPE"),c1.forEach(t),Nf=i(Oi,"."),Oi.forEach(t),Df=l(H),ia=a(H,"P",{});var zh=s(ia);Lf=i(zh,"This tokenizer inherits from "),ui=a(zh,"A",{href:!0});var p1=s(ui);Gf=i(p1,"PreTrainedTokenizerFast"),p1.forEach(t),Wf=i(zh,` which contains most of the main methods. Users should
...
make use of token type ids, therefore a list of zeros is returned.`),v1.forEach(t),Eh.forEach(t),_g=l(H),Gn=a(H,"DIV",{class:!0});var Ch=s(Gn);m(ga.$$.fragment,Ch),kg=l(Ch),nl=a(Ch,"P",{});var T1=s(nl);bg=i(T1,"Reset the special tokens to the source lang setting. No prefix and suffix=[eos, src_lang_code]."),T1.forEach(t),Ch.forEach(t),yg=l(H),Wn=a(H,"DIV",{class:!0});var Ph=s(Wn);m(_a.$$.fragment,Ph),vg=l(Ph),ol=a(Ph,"P",{});var w1=s(ol);Tg=i(w1,"Reset the special tokens to the target language setting. No prefix and suffix=[eos, tgt_lang_code]."),w1.forEach(t),Ph.forEach(t),H.forEach(t),Ip=l(n),rn=a(n,"H2",{class:!0});var Sh=s(rn);Un=a(Sh,"A",{id:!0,class:!0,href:!0});var M1=s(Un);al=a(M1,"SPAN",{});var x1=s(al);m(ka.$$.fragment,x1),x1.forEach(t),M1.forEach(t),wg=l(Sh),sl=a(Sh,"SPAN",{});var z1=s(sl);Mg=i(z1,"MBart50Tokenizer"),z1.forEach(t),Sh.forEach(t),Np=l(n),S=a(n,"DIV",{class:!0});var V=s(S);m(ba.$$.fragment,V),xg=l(V),ya=a(V,"P",{});var Ah=s(ya);zg=i(Ah,"Construct a MBart50 tokenizer. Based on "),va=a(Ah,"A",{href:!0,rel:!0});var F1=s(va);Fg=i(F1,"SentencePiece"),F1.forEach(t),qg=i(Ah,"."),Ah.forEach(t),$g=l(V),Ta=a(V,"P",{});var Oh=s(Ta);Bg=i(Oh,"This tokenizer inherits from "),mi=a(Oh,"A",{href:!0});var q1=s(mi);jg=i(q1,"PreTrainedTokenizer"),q1.forEach(t),Eg=i(Oh,` which contains most of the main methods. Users should refer to
this superclass for more information regarding those methods.`),Oh.forEach(t),Cg=l(V),rl=a(V,"P",{});var $1=s(rl);Pg=i($1,"Examples:"),$1.forEach(t),Sg=l(V),m(wa.$$.fragment,V),Ag=l(V),nt=a(V,"DIV",{class:!0});var zo=s(nt);m(Ma.$$.fragment,zo),Og=l(zo),xa=a(zo,"P",{});var Ih=s(xa);Ig=i(Ih,`Build model inputs from a sequence or a pair of sequence for sequence classification tasks by concatenating and
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),lu.forEach(t),nb=l(At),ue=a(At,"DIV",{class:!0});var at=s(ue);m(hs.$$.fragment,at),ob=l(at),gn=a(at,"P",{});var Gi=s(gn);ab=i(Gi,"The "),vi=a(Gi,"A",{href:!0});var zx=s(vi);sb=i(zx,"MBartForQuestionAnswering"),zx.forEach(t),rb=i(Gi," forward method, overrides the "),Wl=a(Gi,"CODE",{});var Fx=s(Wl);ib=i(Fx,"__call__"),Fx.forEach(t),db=i(Gi," special method."),Gi.forEach(t),lb=l(at),m(oo.$$.fragment,at),cb=l(at),Ul=a(at,"P",{});var qx=s(Ul);pb=i(qx,"Example:"),qx.forEach(t),hb=l(at),m(us.$$.fragment,at),ub=l(at),m(ms.$$.fragment,at),at.forEach(t),At.forEach(t),Hp=l(n),_n=a(n,"H2",{class:!0});var cu=s(_n);ao=a(cu,"A",{id:!0,class:!0,href:!0});var $x=s(ao);Rl=a($x,"SPAN",{});var Bx=s(Rl);m(fs.$$.fragment,Bx),Bx.forEach(t),$x.forEach(t),mb=l(cu),Xl=a(cu,"SPAN",{});var jx=s(Xl);fb=i(jx,"MBartForSequenceClassification"),jx.forEach(t),cu.forEach(t),Vp=l(n),Be=a(n,"DIV",{class:!0});var Ot=s(Be);m(gs.$$.fragment,Ot),gb=l(Ot),Ql=a(Ot,"P",{});var Ex=s(Ql);_b=i(Ex,`MBart model with a sequence classification/head on top (a linear layer on top of the pooled output) e.g. for GLUE
tasks.`),Ex.forEach(t),kb=l(Ot),_s=a(Ot,"P",{});var pu=s(_s);bb=i(pu,"This model inherits from "),Ti=a(pu,"A",{href:!0});var Cx=s(Ti);yb=i(Cx,"PreTrainedModel"),Cx.forEach(t),vb=i(pu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),_u.forEach(t),ay=l(It),m(lo.$$.fragment,It),sy=l(It),Ie=a(It,"DIV",{class:!0});var Nt=s(Ie);m(Ps.$$.fragment,Nt),ry=l(Nt),Tn=a(Nt,"P",{});var Ri=s(Tn);iy=i(Ri,"The "),xi=a(Ri,"A",{href:!0});var Hx=s(xi);dy=i(Hx,"TFMBartModel"),Hx.forEach(t),ly=i(Ri," forward method, overrides the "),nc=a(Ri,"CODE",{});var Vx=s(nc);cy=i(Vx,"__call__"),Vx.forEach(t),py=i(Ri," special method."),Ri.forEach(t),hy=l(Nt),m(co.$$.fragment,Nt),uy=l(Nt),oc=a(Nt,"P",{});var Jx=s(oc);my=i(Jx,"Example:"),Jx.forEach(t),fy=l(Nt),m(Ss.$$.fragment,Nt),Nt.forEach(t),It.forEach(t),eh=l(n),wn=a(n,"H2",{class:!0});var ku=s(wn);po=a(ku,"A",{id:!0,class:!0,href:!0});var Kx=s(po);ac=a(Kx,"SPAN",{});var Zx=s(ac);m(As.$$.fragment,Zx),Zx.forEach(t),Kx.forEach(t),gy=l(ku),sc=a(ku,"SPAN",{});var Yx=s(sc);_y=i(Yx,"TFMBartForConditionalGeneration"),Yx.forEach(t),ku.forEach(t),th=l(n),Ee=a(n,"DIV",{class:!0});var Dt=s(Ee);m(Os.$$.fragment,Dt),ky=l(Dt),Is=a(Dt,"P",{});var bu=s(Is);by=i(bu,`The MBART Model with a language modeling head. Can be used for summarization.
