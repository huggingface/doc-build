import{S as ql,i as Nl,s as Sl,e as n,k as m,w as x,t as r,M as Ol,c as s,d as o,m as p,a,x as w,h as i,b as c,N as Dl,G as e,g as _,y as k,q as T,o as y,B as $,v as Wl,L as vo}from"../../chunks/vendor-hf-doc-builder.js";import{T as go}from"../../chunks/Tip-hf-doc-builder.js";import{D as j}from"../../chunks/Docstring-hf-doc-builder.js";import{C as bo}from"../../chunks/CodeBlock-hf-doc-builder.js";import{I as G}from"../../chunks/IconCopyLink-hf-doc-builder.js";import{E as _o}from"../../chunks/ExampleCodeBlock-hf-doc-builder.js";function Rl(V){let d,b,g,h,v;return h=new bo({props:{code:`from transformers import ViLTModel, ViLTConfig
...
<span class="hljs-meta">... </span>    encoding = processor(image, text, return_tensors=<span class="hljs-string">&quot;pt&quot;</span>)
<span class="hljs-meta">... </span>    outputs = model(**encoding)
<span class="hljs-meta">... </span>    scores[text] = outputs.logits[<span class="hljs-number">0</span>, :].item()`}}),{c(){d=n("p"),b=r("Examples:"),g=m(),x(h.$$.fragment)},l(l){d=s(l,"P",{});var f=a(d);b=i(f,"Examples:"),f.forEach(o),g=p(l),w(h.$$.fragment,l)},m(l,f){_(l,d,f),e(d,b),_(l,g,f),k(h,l,f),v=!0},p:vo,i(l){v||(T(h.$$.fragment,l),v=!0)},o(l){y(h.$$.fragment,l),v=!1},d(l){l&&o(d),l&&o(g),$(h,l)}}}function td(V){let d,b,g,h,v,l,f,F,cs,wn,J,fe,xo,Ye,ms,wo,ps,kn,ue,hs,et,fs,us,Tn,Nt,gs,yn,St,ko,_s,$n,Ot,vs,Vn,C,tt,bs,ot,xs,ws,ks,W,Ts,To,ys,$s,yo,Vs,Fs,Dt,js,Es,Ms,X,Ps,$o,Is,zs,Wt,As,Ls,Cs,Vo,qs,Fn,ge,xi,jn,_e,Ns,Rt,Ss,Os,En,U,Ds,nt,Ws,Rs,st,Bs,Qs,Mn,Z,ve,Fo,at,Us,jo,Hs,Pn,M,rt,Ks,Y,Gs,Eo,Js,Xs,it,Zs,Ys,ea,ee,ta,Bt,oa,na,Qt,sa,aa,ra,be,In,te,xe,Mo,lt,ia,Po,la,zn,P,dt,da,Io,ca,ma,ct,pa,Ut,ha,fa,ua,H,mt,ga,zo,_a,va,we,An,oe,ke,Ao,pt,ba,Lo,xa,Ln,I,ht,wa,Co,ka,Ta,E,Ht,ya,$a,Kt,Va,Fa,Gt,ja,Ea,ft,qo,Ma,Pa,Ia,No,za,Aa,La,K,ut,Ca,ne,qa,Te,Na,So,Sa,Oa,Da,ye,Wa,Oo,Ra,Ba,Qa,Ua,Do,Ha,Cn,se,$e,Wo,gt,Ka,Ro,Ga,qn,R,_t,Ja,vt,Xa,Bo,Za,Ya,er,q,bt,tr,ae,or,Jt,nr,sr,Qo,ar,rr,ir,Ve,lr,Fe,Nn,re,je,Uo,xt,dr,Ho,cr,Sn,z,wt,mr,Ko,pr,hr,kt,fr,Go,ur,gr,_r,N,Tt,vr,ie,br,Xt,xr,wr,Jo,kr,Tr,yr,Ee,$r,Me,On,le,Pe,Xo,yt,Vr,Zo,Fr,Dn,A,$t,jr,Yo,Er,Mr,Vt,Pr,en,Ir,zr,Ar,S,Ft,Lr,de,Cr,Zt,qr,Nr,tn,Sr,Or,Dr,Ie,Wr,ze,Wn,ce,Ae,on,jt,Rr,nn,Br,Rn,B,Et,Qr,sn,Ur,Hr,O,Mt,Kr,me,Gr,Yt,Jr,Xr,an,Zr,Yr,ei,Le,ti,Ce,Bn,pe,qe,rn,Pt,oi,ln,ni,Qn,L,It,si,dn,ai,ri,zt,ii,cn,li,di,ci,D,At,mi,he,pi,eo,hi,fi,mn,ui,gi,_i,Ne,vi,Se,Un;return l=new G({}),Ye=new G({}),at=new G({}),rt=new j({props:{name:"class transformers.ViltConfig",anchor:"transformers.ViltConfig",parameters:[{name:"vocab_size",val:" = 30522"},{name:"type_vocab_size",val:" = 2"},{name:"modality_type_vocab_size",val:" = 2"},{name:"max_position_embeddings",val:" = 40"},{name:"hidden_size",val:" = 768"},{name:"num_hidden_layers",val:" = 12"},{name:"num_attention_heads",val:" = 12"},{name:"intermediate_size",val:" = 3072"},{name:"hidden_act",val:" = 'gelu'"},{name:"hidden_dropout_prob",val:" = 0.0"},{name:"attention_probs_dropout_prob",val:" = 0.0"},{name:"initializer_range",val:" = 0.02"},{name:"layer_norm_eps",val:" = 1e-12"},{name:"is_encoder_decoder",val:" = False"},{name:"image_size",val:" = 384"},{name:"patch_size",val:" = 32"},{name:"num_channels",val:" = 3"},{name:"qkv_bias",val:" = True"},{name:"max_image_length",val:" = -1"},{name:"tie_word_embeddings",val:" = False"},{name:"num_images",val:" = -1"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.ViltConfig.vocab_size",description:`<strong>vocab_size</strong> (<code>int</code>, <em>optional</em>, defaults to 30522) &#x2014;
...
configuration. Check out the <a href="/docs/transformers/main/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/vilt/modeling_vilt.py#L733"}}),bt=new j({props:{name:"forward",anchor:"transformers.ViltModel.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"pixel_values",val:" = None"},{name:"pixel_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"image_embeds",val:" = None"},{name:"image_token_type_idx",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],parametersDescription:[{anchor:"transformers.ViltModel.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>({0})</code>) &#x2014;
...
Whether or not to return a <a href="/docs/transformers/main/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/vilt/modeling_vilt.py#L761",returnDescription:`
<p>A <a
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/main/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/vilt/modeling_vilt.py#L898"}}),Tt=new j({props:{name:"forward",anchor:"transformers.ViltForMaskedLM.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"pixel_values",val:" = None"},{name:"pixel_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"image_embeds",val:" = None"},{name:"labels",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],parametersDescription:[{anchor:"transformers.ViltForMaskedLM.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. Indices can be obtained using <a href="/docs/transformers/main/en/model_doc/bert#transformers.BertTokenizer">BertTokenizer</a>. See
<a href="/docs/transformers/main/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and <a href="/docs/transformers/main/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details. <a href="../glossary#input-ids">What are input
...
loss is only computed for the tokens with labels in <em>[0, &#x2026;, config.vocab_size]</em>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/vilt/modeling_vilt.py#L914",returnDescription:`
<p>A <a
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/main/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/vilt/modeling_vilt.py#L1070"}}),Ft=new j({props:{name:"forward",anchor:"transformers.ViltForQuestionAnswering.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"pixel_values",val:" = None"},{name:"pixel_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"image_embeds",val:" = None"},{name:"labels",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],parametersDescription:[{anchor:"transformers.ViltForQuestionAnswering.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>({0})</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. Indices can be obtained using <a href="/docs/transformers/main/en/model_doc/bert#transformers.BertTokenizer">BertTokenizer</a>. See
<a href="/docs/transformers/main/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and <a href="/docs/transformers/main/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details. <a href="../glossary#input-ids">What are input
...
answers are applicable, where 1.0 is the highest score.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/vilt/modeling_vilt.py#L1088",returnDescription:`
<p>A <a
...
Whether or not to return a <a href="/docs/transformers/main/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/vilt/modeling_vilt.py#L1280"}}),Mt=new j({props:{name:"forward",anchor:"transformers.ViltForImagesAndTextClassification.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"pixel_values",val:" = None"},{name:"pixel_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"image_embeds",val:" = None"},{name:"labels",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],parametersDescription:[{anchor:"transformers.ViltForImagesAndTextClassification.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>({0})</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. Indices can be obtained using <a href="/docs/transformers/main/en/model_doc/bert#transformers.BertTokenizer">BertTokenizer</a>. See
<a href="/docs/transformers/main/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and <a href="/docs/transformers/main/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details. <a href="../glossary#input-ids">What are input
...
Binary classification labels.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/vilt/modeling_vilt.py#L1299",returnDescription:`
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/main/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/vilt/modeling_vilt.py#L1181"}}),At=new j({props:{name:"forward",anchor:"transformers.ViltForImageAndTextRetrieval.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"pixel_values",val:" = None"},{name:"pixel_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"image_embeds",val:" = None"},{name:"labels",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],parametersDescription:[{anchor:"transformers.ViltForImageAndTextRetrieval.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>({0})</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. Indices can be obtained using <a href="/docs/transformers/main/en/model_doc/bert#transformers.BertTokenizer">BertTokenizer</a>. See
<a href="/docs/transformers/main/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and <a href="/docs/transformers/main/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details. <a href="../glossary#input-ids">What are input
...
Labels are currently not supported.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/vilt/modeling_vilt.py#L1193",returnDescription:`
<p>A <a
  href="/docs/transformers/main/en/main_classes/output#transformers.modeling_outputs.SequenceClassifierOutput"
>transformers.modeling_outputs.SequenceClassifierOutput</a> or a tuple of
<code>torch.FloatTensor</code> (if <code>return_dict=False</code> is passed or when <code>config.return_dict=False</code>) comprising various
...
additional embedding layers for the language modality.`),Fn=m(),ge=n("img"),jn=m(),_e=n("small"),Ns=r("ViLT architecture. Taken from the "),Rt=n("a"),Ss=r("original paper"),Os=r("."),En=m(),U=n("p"),Ds=r("This model was contributed by "),nt=n("a"),Ws=r("nielsr"),Rs=r(". The original code can be found "),st=n("a"),Bs=r("here"),Qs=r("."),Mn=m(),Z=n("h2"),ve=n("a"),Fo=n("span"),x(at.$$.fragment),Us=m(),jo=n("span"),Hs=r("ViltConfig"),Pn=m(),M=n("div"),x(rt.$$.fragment),Ks=m(),Y=n("p"),Gs=r("This is the configuration class to store the configuration of a "),Eo=n("code"),Js=r("ViLTModel"),Xs=r(`. It is used to instantiate an ViLT
model according to the specified arguments, defining the model architecture. Instantiating a configuration with the
defaults will yield a similar configuration to that of the ViLT
`),it=n("a"),Zs=r("dandelin/vilt-b32-mlm"),Ys=r(" architecture."),ea=m(),ee=n("p"),ta=r("Configuration objects inherit from "),Bt=n("a"),oa=r("PretrainedConfig"),na=r(` and can be used to control the model outputs. Read the
...
`),ye=n("a"),Wa=r("BertTokenizerFast."),Oo=n("strong"),Ra=r("call"),Ba=r("()"),Qa=r(" to prepare text for the model."),Ua=m(),Do=n("p"),Ha=r("Please refer to the docstring of the above two methods for more information."),Cn=m(),se=n("h2"),$e=n("a"),Wo=n("span"),x(gt.$$.fragment),Ka=m(),Ro=n("span"),Ga=r("ViltModel"),qn=m(),R=n("div"),x(_t.$$.fragment),Ja=m(),vt=n("p"),Xa=r(`The bare ViLT Model transformer outputting raw hidden-states without any specific head on top.
This model is a PyTorch `),Bo=n("code"),Za=r("torch.nn.Module <https://pytorch.org/docs/stable/nn.html#torch.nn.Module>"),Ya=r(`_ subclass. Use
...
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),Ar=m(),S=n("div"),x(Ft.$$.fragment),Lr=m(),de=n("p"),Cr=r("The "),Zt=n("a"),qr=r("ViltForQuestionAnswering"),Nr=r(" forward method, overrides the "),tn=n("code"),Sr=r("__call__"),Or=r(" special method."),Dr=m(),x(Ie.$$.fragment),Wr=m(),x(ze.$$.fragment),Wn=m(),ce=n("h2"),Ae=n("a"),on=n("span"),x(jt.$$.fragment),Rr=m(),nn=n("span"),Br=r("ViltForImagesAndTextClassification"),Rn=m(),B=n("div"),x(Et.$$.fragment),Qr=m(),sn=n("p"),Ur=r("Vilt Model transformer with a classifier head on top for natural language visual reasoning, e.g. NLVR2."),Hr=m(),O=n("div"),x(Mt.$$.fragment),Kr=m(),me=n("p"),Gr=r("The "),Yt=n("a"),Jr=r("ViltForImagesAndTextClassification"),Xr=r(" forward method, overrides the "),an=n("code"),Zr=r("__call__"),Yr=r(" special method."),ei=m(),x(Le.$$.fragment),ti=m(),x(Ce.$$.fragment),Bn=m(),pe=n("h2"),qe=n("a"),rn=n("span"),x(Pt.$$.fragment),oi=m(),ln=n("span"),ni=r("ViltForImageAndTextRetrieval"),Qn=m(),L=n("div"),x(It.$$.fragment),si=m(),dn=n("p"),ai=r(`Vilt Model transformer with a classifier head on top (a linear layer on top of the final hidden state of the [CLS]
...
additional embedding layers for the language modality.`),Ei.forEach(o),Oe.forEach(o),Fn=p(t),ge=s(t,"IMG",{src:!0,alt:!0,width:!0}),jn=p(t),_e=s(t,"SMALL",{});var Kn=a(_e);Ns=i(Kn,"ViLT architecture. Taken from the "),Rt=s(Kn,"A",{href:!0});var Mi=a(Rt);Ss=i(Mi,"original paper"),Mi.forEach(o),Os=i(Kn,"."),Kn.forEach(o),En=p(t),U=s(t,"P",{});var oo=a(U);Ds=i(oo,"This model was contributed by "),nt=s(oo,"A",{href:!0,rel:!0});var Pi=a(nt);Ws=i(Pi,"nielsr"),Pi.forEach(o),Rs=i(oo,". The original code can be found "),st=s(oo,"A",{href:!0,rel:!0});var Ii=a(st);Bs=i(Ii,"here"),Ii.forEach(o),Qs=i(oo,"."),oo.forEach(o),Mn=p(t),Z=s(t,"H2",{class:!0});var Gn=a(Z);ve=s(Gn,"A",{id:!0,class:!0,href:!0});var zi=a(ve);Fo=s(zi,"SPAN",{});var Ai=a(Fo);w(at.$$.fragment,Ai),Ai.forEach(o),zi.forEach(o),Us=p(Gn),jo=s(Gn,"SPAN",{});var Li=a(jo);Hs=i(Li,"ViltConfig"),Li.forEach(o),Gn.forEach(o),Pn=p(t),M=s(t,"DIV",{class:!0});var We=a(M);w(rt.$$.fragment,We),Ks=p(We),Y=s(We,"P",{});var no=a(Y);Gs=i(no,"This is the configuration class to store the configuration of a "),Eo=s(no,"CODE",{});var Ci=a(Eo);Js=i(Ci,"ViLTModel"),Ci.forEach(o),Xs=i(no,`. It is used to instantiate an ViLT
model according to the specified arguments, defining the model architecture. Instantiating a configuration with the
defaults will yield a similar configuration to that of the ViLT
`),it=s(no,"A",{href:!0,rel:!0});var qi=a(it);Zs=i(qi,"dandelin/vilt-b32-mlm"),qi.forEach(o),Ys=i(no," architecture."),no.forEach(o),ea=p(We),ee=s(We,"P",{});var so=a(ee);ta=i(so,"Configuration objects inherit from "),Bt=s(so,"A",{href:!0});var Ni=a(Bt);oa=i(Ni,"PretrainedConfig"),Ni.forEach(o),na=i(so,` and can be used to control the model outputs. Read the
documentation from `),Qt=s(so,"A",{href:!0});var Si=a(Qt);sa=i(Si,"PretrainedConfig"),Si.forEach(o),aa=i(so," for more information."),so.forEach(o),ra=p(We),w(be.$$.fragment,We),We.forEach(o),In=p(t),te=s(t,"H2",{class:!0});var Jn=a(te);xe=s(Jn,"A",{id:!0,class:!0,href:!0});var Oi=a(xe);Mo=s(Oi,"SPAN",{});var Di=a(Mo);w(lt.$$.fragment,Di),Di.forEach(o),Oi.forEach(o),ia=p(Jn),Po=s(Jn,"SPAN",{});var Wi=a(Po);la=i(Wi,"ViltFeatureExtractor"),Wi.forEach(o),Jn.forEach(o),zn=p(t),P=s(t,"DIV",{class:!0});var Re=a(P);w(dt.$$.fragment,Re),da=p(Re),Io=s(Re,"P",{});var Ri=a(Io);ca=i(Ri,"Constructs a ViLT feature extractor."),Ri.forEach(o),ma=p(Re),ct=s(Re,"P",{});var Xn=a(ct);pa=i(Xn,"This feature extractor inherits from "),Ut=s(Xn,"A",{href:!0});var Bi=a(Ut);ha=i(Bi,"FeatureExtractionMixin"),Bi.forEach(o),fa=i(Xn,` which contains most of the main methods. Users
should refer to this superclass for more information regarding those methods.`),Xn.forEach(o),ua=p(Re),H=s(Re,"DIV",{class:!0});var ao=a(H);w(mt.$$.fragment,ao),ga=p(ao),zo=s(ao,"P",{});var Qi=a(zo);_a=i(Qi,"Main method to prepare for the model one or several image(s)."),Qi.forEach(o),va=p(ao),w(we.$$.fragment,ao),ao.forEach(o),Re.forEach(o),An=p(t),oe=s(t,"H2",{class:!0});var Zn=a(oe);ke=s(Zn,"A",{id:!0,class:!0,href:!0});var Ui=a(ke);Ao=s(Ui,"SPAN",{});var Hi=a(Ao);w(pt.$$.fragment,Hi),Hi.forEach(o),Ui.forEach(o),ba=p(Zn),Lo=s(Zn,"SPAN",{});var Ki=a(Lo);xa=i(Ki,"ViltProcessor"),Ki.forEach(o),Zn.forEach(o),Ln=p(t),I=s(t,"DIV",{class:!0});var Be=a(I);w(ht.$$.fragment,Be),wa=p(Be),Co=s(Be,"P",{});var Gi=a(Co);ka=i(Gi,"Constructs a ViLT processor which wraps a BERT tokenizer and ViLT feature extractor into a single processor."),Gi.forEach(o),Ta=p(Be),E=s(Be,"P",{});var Q=a(E);Ht=s(Q,"A",{href:!0});var Ji=a(Ht);ya=i(Ji,"ViltProcessor"),Ji.forEach(o),$a=i(Q," offers all the functionalities of "),Kt=s(Q,"A",{href:!0});var Xi=a(Kt);Va=i(Xi,"ViltFeatureExtractor"),Xi.forEach(o),Fa=i(Q," and "),Gt=s(Q,"A",{href:!0});var Zi=a(Gt);ja=i(Zi,"BertTokenizerFast"),Zi.forEach(o),Ea=i(Q,`. See the
docstring of `),ft=s(Q,"A",{href:!0});var bi=a(ft);qo=s(bi,"STRONG",{});var Yi=a(qo);Ma=i(Yi,"call"),Yi.forEach(o),Pa=i(bi,"()"),bi.forEach(o),Ia=i(Q," and "),No=s(Q,"CODE",{});var el=a(No);za=i(el,"decode()"),el.forEach(o),Aa=i(Q," for more information."),Q.forEach(o),La=p(Be),K=s(Be,"DIV",{class:!0});var ro=a(K);w(ut.$$.fragment,ro),Ca=p(ro),ne=s(ro,"P",{});var io=a(ne);qa=i(io,"This method uses "),Te=s(io,"A",{href:!0});var Yn=a(Te);Na=i(Yn,"ViltFeatureExtractor."),So=s(Yn,"STRONG",{});var tl=a(So);Sa=i(tl,"call"),tl.forEach(o),Oa=i(Yn,"()"),Yn.forEach(o),Da=i(io,` method to prepare image(s) for the model, and
`),ye=s(io,"A",{href:!0});var es=a(ye);Wa=i(es,"BertTokenizerFast."),Oo=s(es,"STRONG",{});var ol=a(Oo);Ra=i(ol,"call"),ol.forEach(o),Ba=i(es,"()"),es.forEach(o),Qa=i(io," to prepare text for the model."),io.forEach(o),Ua=p(ro),Do=s(ro,"P",{});var nl=a(Do);Ha=i(nl,"Please refer to the docstring of the above two methods for more information."),nl.forEach(o),ro.forEach(o),Be.forEach(o),Cn=p(t),se=s(t,"H2",{class:!0});var ts=a(se);$e=s(ts,"A",{id:!0,class:!0,href:!0});var sl=a($e);Wo=s(sl,"SPAN",{});var al=a(Wo);w(gt.$$.fragment,al),al.forEach(o),sl.forEach(o),Ka=p(ts),Ro=s(ts,"SPAN",{});var rl=a(Ro);Ga=i(rl,"ViltModel"),rl.forEach(o),ts.forEach(o),qn=p(t),R=s(t,"DIV",{class:!0});var lo=a(R);w(_t.$$.fragment,lo),Ja=p(lo),vt=s(lo,"P",{});var os=a(vt);Xa=i(os,`The bare ViLT Model transformer outputting raw hidden-states without any specific head on top.
This model is a PyTorch `),Bo=s(os,"CODE",{});var il=a(Bo);Za=i(il,"torch.nn.Module <https://pytorch.org/docs/stable/nn.html#torch.nn.Module>"),il.forEach(o),Ya=i(os,`_ subclass. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
