...
`}}),Ne=new Gt({props:{$$slots:{default:[Wd]},$$scope:{ctx:V}}}),Se=new jo({props:{anchor:"transformers.ViltForImagesAndTextClassification.forward.example",$$slots:{default:[Bd]},$$scope:{ctx:V}}}),Ot=new H({}),Nt=new E({props:{name:"class transformers.ViltForImageAndTextRetrieval",anchor:"transformers.ViltForImageAndTextRetrieval",parameters:[{name:"config",val:""}],parametersDescription:[{anchor:"transformers.ViltForImageAndTextRetrieval.config",description:`<strong>config</strong> (<a href="/docs/transformers/main/en/model_doc/vilt#transformers.ViltConfig">ViltConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
...
<p><a
  href="/docs/transformers/main/en/main_classes/output#transformers.modeling_outputs.SequenceClassifierOutput"
>transformers.modeling_outputs.SequenceClassifierOutput</a> or <code>tuple(torch.FloatTensor)</code></p>
`}}),Re=new Gt({props:{$$slots:{default:[Qd]},$$scope:{ctx:V}}}),We=new jo({props:{anchor:"transformers.ViltForImageAndTextRetrieval.forward.example",$$slots:{default:[Ud]},$$scope:{ctx:V}}}),Rt=new H({}),Wt=new E({props:{name:"class transformers.ViltForTokenClassification",anchor:"transformers.ViltForTokenClassification",parameters:[{name:"config",val:""}],parametersDescription:[{anchor:"transformers.ViltForTokenClassification.config",description:`<strong>config</strong> (<a href="/docs/transformers/main/en/model_doc/vilt#transformers.ViltConfig">ViltConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
...
for Vision-and-Language Pre-training (VLP).`),Wn=m(),Jt=n("p"),Ss=r("The abstract from the paper is the following:"),Bn=m(),Xt=n("p"),Co=n("em"),Ds=r(`Vision-and-Language Pre-training (VLP) has improved performance on various joint vision-and-language downstream tasks.
...
times faster than previous VLP models, yet with competitive or better downstream task performance.`),Qn=m(),Zt=n("p"),Rs=r("Tips:"),Un=m(),q=n("ul"),lt=n("li"),Ws=r("The quickest way to get started with ViLT is by checking the "),dt=n("a"),Bs=r("example notebooks"),Qs=r(`
...
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),Dr=m(),N=n("div"),T(Pt.$$.fragment),Rr=m(),de=n("p"),Wr=r("The "),co=n("a"),Br=r("ViltForMaskedLM"),Qr=r(" forward method, overrides the "),mn=n("code"),Ur=r("__call__"),Hr=r(" special method."),Kr=m(),T(Le.$$.fragment),Gr=m(),T(Ie.$$.fragment),rs=m(),ce=n("h2"),Ae=n("a"),pn=n("span"),T(jt.$$.fragment),Jr=m(),hn=n("span"),Xr=r("ViltForQuestionAnswering"),is=m(),I=n("div"),T(zt.$$.fragment),Zr=m(),fn=n("p"),Yr=r(`Vilt Model transformer with a classifier head on top (a linear layer on top of the final hidden state of the [CLS]
...
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),Ii=m(),R=n("div"),T(Dt.$$.fragment),Ai=m(),ue=n("p"),Ci=r("The "),ho=n("a"),qi=r("ViltForImageAndTextRetrieval"),Oi=r(" forward method, overrides the "),$n=n("code"),Ni=r("__call__"),Si=r(" special method."),Di=m(),T(Re.$$.fragment),Ri=m(),T(We.$$.fragment),ps=m(),ge=n("h2"),Be=n("a"),Vn=n("span"),T(Rt.$$.fragment),Wi=m(),Fn=n("span"),Bi=r("ViltForTokenClassification"),hs=m(),C=n("div"),T(Wt.$$.fragment),Qi=m(),En=n("p"),Ui=r(`ViLT Model with a token classification head on top (a linear layer on top of the final hidden-states of the text
