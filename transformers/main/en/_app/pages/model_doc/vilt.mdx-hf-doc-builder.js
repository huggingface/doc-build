...
the latter silently ignores them.`)},l(l){d=s(l,"P",{});var h=a(d);b=i(h,"Although the recipe for forward pass needs to be defined within this function, one should call the "),g=s(h,"CODE",{});var F=a(g);u=i(F,"Module"),F.forEach(o),v=i(h,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),h.forEach(o)},m(l,h){_(l,d,h),e(d,b),e(d,g),e(g,u),e(d,v)},d(l){l&&o(d)}}}function Rd(V){let d,b,g,u,v;return u=new Lo({props:{code:`from transformers import ViltProcessor, ViltForQuestionAnswering
import requests
from PIL import Image
...
Predicted answer: <span class="hljs-number">2</span>`}}),{c(){d=n("p"),b=r("Examples:"),g=m(),T(u.$$.fragment)},l(l){d=s(l,"P",{});var h=a(d);b=i(h,"Examples:"),h.forEach(o),g=p(l),k(u.$$.fragment,l)},m(l,h){_(l,d,h),e(d,b),_(l,g,h),w(u,l,h),v=!0},p:zo,i(l){v||(x(u.$$.fragment,l),v=!0)},o(l){y(u.$$.fragment,l),v=!1},d(l){l&&o(d),l&&o(g),$(u,l)}}}function Bd(V){let d,b,g,u,v;return{c(){d=n("p"),b=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),g=n("code"),u=r("Module"),v=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(l){d=s(l,"P",{});var h=a(d);b=i(h,"Although the recipe for forward pass needs to be defined within this function, one should call the "),g=s(h,"CODE",{});var F=a(g);u=i(F,"Module"),F.forEach(o),v=i(h,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),h.forEach(o)},m(l,h){_(l,d,h),e(d,b),e(d,g),e(g,u),e(d,v)},d(l){l&&o(d)}}}function Wd(V){let d,b,g,u,v;return u=new Lo({props:{code:`from transformers import ViltProcessor, ViltForImagesAndTextClassification
import requests
from PIL import Image
...
the latter silently ignores them.`)},l(l){d=s(l,"P",{});var h=a(d);b=i(h,"Although the recipe for forward pass needs to be defined within this function, one should call the "),g=s(h,"CODE",{});var F=a(g);u=i(F,"Module"),F.forEach(o),v=i(h,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),h.forEach(o)},m(l,h){_(l,d,h),e(d,b),e(d,g),e(g,u),e(d,v)},d(l){l&&o(d)}}}function Kd(V){let d,b,g,u,v,l,h,F,Is,Dn,Z,ve,Io,rt,As,Ao,Cs,Rn,be,qs,it,Os,Ns,Bn,Jt,Ss,Wn,Xt,Co,Ds,Qn,Zt,Rs,Un,q,lt,Bs,dt,Ws,Qs,Us,B,Hs,qo,Ks,Gs,Oo,Js,Xs,Yt,Zs,Ys,ea,Y,ta,No,oa,na,eo,sa,aa,ra,So,ia,Hn,Te,rl,Kn,ke,la,to,da,ca,Gn,K,ma,ct,pa,ha,mt,fa,ua,Jn,ee,we,Do,pt,ga,Ro,_a,Xn,P,ht,va,te,ba,Bo,Ta,ka,ft,wa,xa,ya,oe,$a,oo,Va,Fa,no,Ea,Ma,Pa,xe,Zn,ne,ye,Wo,ut,ja,Qo,za,Yn,j,gt,La,Uo,Ia,Aa,_t,Ca,so,qa,Oa,Na,G,vt,Sa,Ho,Da,Ra,$e,es,se,Ve,Ko,bt,Ba,Go,Wa,ts,z,Tt,Qa,Jo,Ua,Ha,M,ao,Ka,Ga,ro,Ja,Xa,io,Za,Ya,kt,Xo,er,tr,or,Zo,nr,sr,ar,J,wt,rr,ae,ir,Fe,lr,Yo,dr,cr,mr,Ee,pr,en,hr,fr,ur,gr,tn,_r,os,re,Me,on,xt,vr,nn,br,ns,W,yt,Tr,$t,kr,sn,wr,xr,yr,O,Vt,$r,ie,Vr,lo,Fr,Er,an,Mr,Pr,jr,Pe,zr,je,ss,le,ze,rn,Ft,Lr,ln,Ir,as,L,Et,Ar,dn,Cr,qr,Mt,Or,cn,Nr,Sr,Dr,N,Pt,Rr,de,Br,co,Wr,Qr,mn,Ur,Hr,Kr,Le,Gr,Ie,rs,ce,Ae,pn,jt,Jr,hn,Xr,is,I,zt,Zr,fn,Yr,ei,Lt,ti,un,oi,ni,si,S,It,ai,me,ri,mo,ii,li,gn,di,ci,mi,Ce,pi,qe,ls,pe,Oe,_n,At,hi,vn,fi,ds,Q,Ct,ui,bn,gi,_i,D,qt,vi,he,bi,po,Ti,ki,Tn,wi,xi,yi,Ne,$i,Se,cs,fe,De,kn,Ot,Vi,wn,Fi,ms,A,Nt,Ei,xn,Mi,Pi,St,ji,yn,zi,Li,Ii,R,Dt,Ai,ue,Ci,ho,qi,Oi,$n,Ni,Si,Di,Re,Ri,Be,ps,ge,We,Vn,Rt,Bi,Fn,Wi,hs,C,Bt,Qi,En,Ui,Hi,Wt,Ki,Mn,Gi,Ji,Xi,X,Qt,Zi,_e,Yi,fo,el,tl,Pn,ol,nl,sl,Qe,fs;return l=new H({}),rt=new H({}),pt=new H({}),ht=new E({props:{name:"class transformers.ViltConfig",anchor:"transformers.ViltConfig",parameters:[{name:"vocab_size",val:" = 30522"},{name:"type_vocab_size",val:" = 2"},{name:"modality_type_vocab_size",val:" = 2"},{name:"max_position_embeddings",val:" = 40"},{name:"hidden_size",val:" = 768"},{name:"num_hidden_layers",val:" = 12"},{name:"num_attention_heads",val:" = 12"},{name:"intermediate_size",val:" = 3072"},{name:"hidden_act",val:" = 'gelu'"},{name:"hidden_dropout_prob",val:" = 0.0"},{name:"attention_probs_dropout_prob",val:" = 0.0"},{name:"initializer_range",val:" = 0.02"},{name:"layer_norm_eps",val:" = 1e-12"},{name:"is_encoder_decoder",val:" = False"},{name:"image_size",val:" = 384"},{name:"patch_size",val:" = 32"},{name:"num_channels",val:" = 3"},{name:"qkv_bias",val:" = True"},{name:"max_image_length",val:" = -1"},{name:"tie_word_embeddings",val:" = False"},{name:"num_images",val:" = -1"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.ViltConfig.vocab_size",description:`<strong>vocab_size</strong> (<code>int</code>, <em>optional</em>, defaults to 30522) &#x2014;
...
`}}),Ce=new Gt({props:{$$slots:{default:[Dd]},$$scope:{ctx:V}}}),qe=new jo({props:{anchor:"transformers.ViltForQuestionAnswering.forward.example",$$slots:{default:[Rd]},$$scope:{ctx:V}}}),At=new H({}),Ct=new E({props:{name:"class transformers.ViltForImagesAndTextClassification",anchor:"transformers.ViltForImagesAndTextClassification",parameters:[{name:"config",val:""}],parametersDescription:[{anchor:"transformers.ViltForImagesAndTextClassification.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>({0})</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. Indices can be obtained using <a href="/docs/transformers/main/en/model_doc/bert#transformers.BertTokenizer">BertTokenizer</a>. See
<a href="/docs/transformers/main/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and <a href="/docs/transformers/main/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details. <a href="../glossary#input-ids">What are input
...
`}}),Ne=new Gt({props:{$$slots:{default:[Bd]},$$scope:{ctx:V}}}),Se=new jo({props:{anchor:"transformers.ViltForImagesAndTextClassification.forward.example",$$slots:{default:[Wd]},$$scope:{ctx:V}}}),Ot=new H({}),Nt=new E({props:{name:"class transformers.ViltForImageAndTextRetrieval",anchor:"transformers.ViltForImageAndTextRetrieval",parameters:[{name:"config",val:""}],parametersDescription:[{anchor:"transformers.ViltForImageAndTextRetrieval.config",description:`<strong>config</strong> (<a href="/docs/transformers/main/en/model_doc/vilt#transformers.ViltConfig">ViltConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
...
<p><a
  href="/docs/transformers/main/en/main_classes/output#transformers.modeling_outputs.SequenceClassifierOutput"
>transformers.modeling_outputs.SequenceClassifierOutput</a> or <code>tuple(torch.FloatTensor)</code></p>
`}}),Re=new Gt({props:{$$slots:{default:[Qd]},$$scope:{ctx:V}}}),Be=new jo({props:{anchor:"transformers.ViltForImageAndTextRetrieval.forward.example",$$slots:{default:[Ud]},$$scope:{ctx:V}}}),Rt=new H({}),Bt=new E({props:{name:"class transformers.ViltForTokenClassification",anchor:"transformers.ViltForTokenClassification",parameters:[{name:"config",val:""}],parametersDescription:[{anchor:"transformers.ViltForTokenClassification.config",description:`<strong>config</strong> (<a href="/docs/transformers/main/en/model_doc/vilt#transformers.ViltConfig">ViltConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
...
for Vision-and-Language Pre-training (VLP).`),Bn=m(),Jt=n("p"),Ss=r("The abstract from the paper is the following:"),Wn=m(),Xt=n("p"),Co=n("em"),Ds=r(`Vision-and-Language Pre-training (VLP) has improved performance on various joint vision-and-language downstream tasks.
...
times faster than previous VLP models, yet with competitive or better downstream task performance.`),Qn=m(),Zt=n("p"),Rs=r("Tips:"),Un=m(),q=n("ul"),lt=n("li"),Bs=r("The quickest way to get started with ViLT is by checking the "),dt=n("a"),Ws=r("example notebooks"),Qs=r(`
(which showcase both inference and fine-tuning on custom data).`),Us=m(),B=n("li"),Hs=r("ViLT is a model that takes both "),qo=n("code"),Ks=r("pixel_values"),Gs=r(" and "),Oo=n("code"),Js=r("input_ids"),Xs=r(" as input. One can use "),Yt=n("a"),Zs=r("ViltProcessor"),Ys=r(` to prepare data for the model.
...
additional embedding layers for the language modality.`),Hn=m(),Te=n("img"),Kn=m(),ke=n("small"),la=r("ViLT architecture. Taken from the "),to=n("a"),da=r("original paper"),ca=r("."),Gn=m(),K=n("p"),ma=r("This model was contributed by "),ct=n("a"),pa=r("nielsr"),ha=r(". The original code can be found "),mt=n("a"),fa=r("here"),ua=r("."),Jn=m(),ee=n("h2"),we=n("a"),Do=n("span"),T(pt.$$.fragment),ga=m(),Ro=n("span"),_a=r("ViltConfig"),Xn=m(),P=n("div"),T(ht.$$.fragment),va=m(),te=n("p"),ba=r("This is the configuration class to store the configuration of a "),Bo=n("code"),Ta=r("ViLTModel"),ka=r(`. It is used to instantiate an ViLT
...
`),Ee=n("a"),pr=r("BertTokenizerFast."),en=n("strong"),hr=r("call"),fr=r("()"),ur=r(" to prepare text for the model."),gr=m(),tn=n("p"),_r=r("Please refer to the docstring of the above two methods for more information."),os=m(),re=n("h2"),Me=n("a"),on=n("span"),T(xt.$$.fragment),vr=m(),nn=n("span"),br=r("ViltModel"),ns=m(),W=n("div"),T(yt.$$.fragment),Tr=m(),$t=n("p"),kr=r(`The bare ViLT Model transformer outputting raw hidden-states without any specific head on top.
...
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),Dr=m(),N=n("div"),T(Pt.$$.fragment),Rr=m(),de=n("p"),Br=r("The "),co=n("a"),Wr=r("ViltForMaskedLM"),Qr=r(" forward method, overrides the "),mn=n("code"),Ur=r("__call__"),Hr=r(" special method."),Kr=m(),T(Le.$$.fragment),Gr=m(),T(Ie.$$.fragment),rs=m(),ce=n("h2"),Ae=n("a"),pn=n("span"),T(jt.$$.fragment),Jr=m(),hn=n("span"),Xr=r("ViltForQuestionAnswering"),is=m(),I=n("div"),T(zt.$$.fragment),Zr=m(),fn=n("p"),Yr=r(`Vilt Model transformer with a classifier head on top (a linear layer on top of the final hidden state of the [CLS]
...
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),Ii=m(),R=n("div"),T(Dt.$$.fragment),Ai=m(),ue=n("p"),Ci=r("The "),ho=n("a"),qi=r("ViltForImageAndTextRetrieval"),Oi=r(" forward method, overrides the "),$n=n("code"),Ni=r("__call__"),Si=r(" special method."),Di=m(),T(Re.$$.fragment),Ri=m(),T(Be.$$.fragment),ps=m(),ge=n("h2"),We=n("a"),Vn=n("span"),T(Rt.$$.fragment),Bi=m(),Fn=n("span"),Wi=r("ViltForTokenClassification"),hs=m(),C=n("div"),T(Bt.$$.fragment),Qi=m(),En=n("p"),Ui=r(`ViLT Model with a token classification head on top (a linear layer on top of the final hidden-states of the text
tokens) e.g. for Named-Entity-Recognition (NER) tasks.`),Hi=m(),Wt=n("p"),Ki=r("This model is a PyTorch "),Mn=n("code"),Gi=r("torch.nn.Module <https://pytorch.org/docs/stable/nn.html#torch.nn.Module>"),Ji=r(`_ subclass. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),Xi=m(),X=n("div"),T(Qt.$$.fragment),Zi=m(),_e=n("p"),Yi=r("The "),fo=n("a"),el=r("ViltForTokenClassification"),tl=r(" forward method, overrides the "),Pn=n("code"),ol=r("__call__"),nl=r(" special method."),sl=m(),T(Qe.$$.fragment),this.h()},l(t){const f=zd('[data-svelte="svelte-1phssyn"]',document.head);d=s(f,"META",{name:!0,content:!0}),f.forEach(o),b=p(t),g=s(t,"H1",{class:!0});var Ut=a(g);u=s(Ut,"A",{id:!0,class:!0,href:!0});var jn=a(u);v=s(jn,"SPAN",{});var zn=a(v);k(l.$$.fragment,zn),zn.forEach(o),jn.forEach(o),h=p(Ut),F=s(Ut,"SPAN",{});var Ln=a(F);Is=i(Ln,"ViLT"),Ln.forEach(o),Ut.forEach(o),Dn=p(t),Z=s(t,"H2",{class:!0});var Ht=a(Z);ve=s(Ht,"A",{id:!0,class:!0,href:!0});var In=a(ve);Io=s(In,"SPAN",{});var An=a(Io);k(rt.$$.fragment,An),An.forEach(o),In.forEach(o),As=p(Ht),Ao=s(Ht,"SPAN",{});var Cn=a(Ao);Cs=i(Cn,"Overview"),Cn.forEach(o),Ht.forEach(o),Rn=p(t),be=s(t,"P",{});var Kt=a(be);qs=i(Kt,"The ViLT model was proposed in "),it=s(Kt,"A",{href:!0,rel:!0});var qn=a(it);Os=i(qn,"ViLT: Vision-and-Language Transformer Without Convolution or Region Supervision"),qn.forEach(o),Ns=i(Kt,`
by Wonjae Kim, Bokyung Son, Ildoo Kim. ViLT incorporates text embeddings into a Vision Transformer (ViT), allowing it to have a minimal design
for Vision-and-Language Pre-training (VLP).`),Kt.forEach(o),Bn=p(t),Jt=s(t,"P",{});var On=a(Jt);Ss=i(On,"The abstract from the paper is the following:"),On.forEach(o),Wn=p(t),Xt=s(t,"P",{});var Nn=a(Xt);Co=s(Nn,"EM",{});var Sn=a(Co);Ds=i(Sn,`Vision-and-Language Pre-training (VLP) has improved performance on various joint vision-and-language downstream tasks.
Current approaches to VLP heavily rely on image feature extraction processes, most of which involve region supervision
(e.g., object detection) and the convolutional architecture (e.g., ResNet). Although disregarded in the literature, we
find it problematic in terms of both (1) efficiency/speed, that simply extracting input features requires much more
computation than the multimodal interaction steps; and (2) expressive power, as it is upper bounded to the expressive
...
Vision-and-Language Transformer (ViLT), monolithic in the sense that the processing of visual inputs is drastically
simplified to just the same convolution-free manner that we process textual inputs. We show that ViLT is up to tens of
times faster than previous VLP models, yet with competitive or better downstream task performance.`),Sn.forEach(o),Nn.forEach(o),Qn=p(t),Zt=s(t,"P",{});var il=a(Zt);Rs=i(il,"Tips:"),il.forEach(o),Un=p(t),q=s(t,"UL",{});var Ue=a(q);lt=s(Ue,"LI",{});var us=a(lt);Bs=i(us,"The quickest way to get started with ViLT is by checking the "),dt=s(us,"A",{href:!0,rel:!0});var ll=a(dt);Ws=i(ll,"example notebooks"),ll.forEach(o),Qs=i(us,`
(which showcase both inference and fine-tuning on custom data).`),us.forEach(o),Us=p(Ue),B=s(Ue,"LI",{});var He=a(B);Hs=i(He,"ViLT is a model that takes both "),qo=s(He,"CODE",{});var dl=a(qo);Ks=i(dl,"pixel_values"),dl.forEach(o),Gs=i(He," and "),Oo=s(He,"CODE",{});var cl=a(Oo);Js=i(cl,"input_ids"),cl.forEach(o),Xs=i(He," as input. One can use "),Yt=s(He,"A",{href:!0});var ml=a(Yt);Zs=i(ml,"ViltProcessor"),ml.forEach(o),Ys=i(He,` to prepare data for the model.
...
`),Ee=s(ko,"A",{href:!0});var ws=a(Ee);pr=i(ws,"BertTokenizerFast."),en=s(ws,"STRONG",{});var Dl=a(en);hr=i(Dl,"call"),Dl.forEach(o),fr=i(ws,"()"),ws.forEach(o),ur=i(ko," to prepare text for the model."),ko.forEach(o),gr=p(To),tn=s(To,"P",{});var Rl=a(tn);_r=i(Rl,"Please refer to the docstring of the above two methods for more information."),Rl.forEach(o),To.forEach(o),Je.forEach(o),os=p(t),re=s(t,"H2",{class:!0});var xs=a(re);Me=s(xs,"A",{id:!0,class:!0,href:!0});var Bl=a(Me);on=s(Bl,"SPAN",{});var Wl=a(on);k(xt.$$.fragment,Wl),Wl.forEach(o),Bl.forEach(o),vr=p(xs),nn=s(xs,"SPAN",{});var Ql=a(nn);br=i(Ql,"ViltModel"),Ql.forEach(o),xs.forEach(o),ns=p(t),W=s(t,"DIV",{class:!0});var wo=a(W);k(yt.$$.fragment,wo),Tr=p(wo),$t=s(wo,"P",{});var ys=a($t);kr=i(ys,`The bare ViLT Model transformer outputting raw hidden-states without any specific head on top.
