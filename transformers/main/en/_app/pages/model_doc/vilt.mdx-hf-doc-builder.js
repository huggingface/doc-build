import{S as Nd,i as Sd,s as Dd,e as n,k as c,w as T,t as r,M as Rd,c as s,d as o,m,a,x as k,h as i,b as p,N as Bd,G as e,g as _,y as w,q as x,o as y,B as $,v as Wd,L as Io}from"../../chunks/vendor-hf-doc-builder.js";import{T as Gt}from"../../chunks/Tip-hf-doc-builder.js";import{D as E}from"../../chunks/Docstring-hf-doc-builder.js";import{C as Ao}from"../../chunks/CodeBlock-hf-doc-builder.js";import{I as H}from"../../chunks/IconCopyLink-hf-doc-builder.js";import{E as Lo}from"../../chunks/ExampleCodeBlock-hf-doc-builder.js";function Qd(V){let d,b,g,u,v;return u=new Ao({props:{code:`from transformers import ViLTModel, ViLTConfig
...
the latter silently ignores them.`)},l(l){d=s(l,"P",{});var f=a(d);b=i(f,"Although the recipe for forward pass needs to be defined within this function, one should call the "),g=s(f,"CODE",{});var F=a(g);u=i(F,"Module"),F.forEach(o),v=i(f,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),f.forEach(o)},m(l,f){_(l,d,f),e(d,b),e(d,g),e(g,u),e(d,v)},d(l){l&&o(d)}}}function sc(V){let d,b,g,u,v,l,f,F,Ns,Wn,Z,ve,Co,rt,Ss,qo,Ds,Qn,be,Rs,it,Bs,Ws,Un,Jt,Qs,Hn,Xt,Oo,Us,Kn,Zt,Hs,Gn,q,lt,Ks,dt,Gs,Js,Xs,B,Zs,No,Ys,ea,So,ta,oa,Yt,na,sa,aa,Y,ra,Do,ia,la,eo,da,ca,ma,Ro,pa,Jn,Te,hl,Xn,ke,ha,to,fa,ua,Zn,K,ga,ct,_a,va,mt,ba,Ta,Yn,oo,ka,es,no,Bo,wa,ts,ee,we,Wo,pt,xa,Qo,ya,os,P,ht,$a,te,Va,Uo,Fa,Ea,ft,Ma,Pa,ja,oe,za,so,La,Ia,ao,Aa,Ca,qa,xe,ns,ne,ye,Ho,ut,Oa,Ko,Na,ss,j,gt,Sa,Go,Da,Ra,_t,Ba,ro,Wa,Qa,Ua,G,vt,Ha,Jo,Ka,Ga,$e,as,se,Ve,Xo,bt,Ja,Zo,Xa,rs,z,Tt,Za,Yo,Ya,er,M,io,tr,or,lo,nr,sr,co,ar,rr,kt,en,ir,lr,dr,tn,cr,mr,pr,J,wt,hr,ae,fr,Fe,ur,on,gr,_r,vr,Ee,br,nn,Tr,kr,wr,xr,sn,yr,is,re,Me,an,xt,$r,rn,Vr,ls,W,yt,Fr,$t,Er,ln,Mr,Pr,jr,O,Vt,zr,ie,Lr,mo,Ir,Ar,dn,Cr,qr,Or,Pe,Nr,je,ds,le,ze,cn,Ft,Sr,mn,Dr,cs,L,Et,Rr,pn,Br,Wr,Mt,Qr,hn,Ur,Hr,Kr,N,Pt,Gr,de,Jr,po,Xr,Zr,fn,Yr,ei,ti,Le,oi,Ie,ms,ce,Ae,un,jt,ni,gn,si,ps,I,zt,ai,_n,ri,ii,Lt,li,vn,di,ci,mi,S,It,pi,me,hi,ho,fi,ui,bn,gi,_i,vi,Ce,bi,qe,hs,pe,Oe,Tn,At,Ti,kn,ki,fs,Q,Ct,wi,wn,xi,yi,D,qt,$i,he,Vi,fo,Fi,Ei,xn,Mi,Pi,ji,Ne,zi,Se,us,fe,De,yn,Ot,Li,$n,Ii,gs,A,Nt,Ai,Vn,Ci,qi,St,Oi,Fn,Ni,Si,Di,R,Dt,Ri,ue,Bi,uo,Wi,Qi,En,Ui,Hi,Ki,Re,Gi,Be,_s,ge,We,Mn,Rt,Ji,Pn,Xi,vs,C,Bt,Zi,jn,Yi,el,Wt,tl,zn,ol,nl,sl,X,Qt,al,_e,rl,go,il,ll,Ln,dl,cl,ml,Qe,bs;return l=new H({}),rt=new H({}),pt=new H({}),ht=new E({props:{name:"class transformers.ViltConfig",anchor:"transformers.ViltConfig",parameters:[{name:"vocab_size",val:" = 30522"},{name:"type_vocab_size",val:" = 2"},{name:"modality_type_vocab_size",val:" = 2"},{name:"max_position_embeddings",val:" = 40"},{name:"hidden_size",val:" = 768"},{name:"num_hidden_layers",val:" = 12"},{name:"num_attention_heads",val:" = 12"},{name:"intermediate_size",val:" = 3072"},{name:"hidden_act",val:" = 'gelu'"},{name:"hidden_dropout_prob",val:" = 0.0"},{name:"attention_probs_dropout_prob",val:" = 0.0"},{name:"initializer_range",val:" = 0.02"},{name:"layer_norm_eps",val:" = 1e-12"},{name:"is_encoder_decoder",val:" = False"},{name:"image_size",val:" = 384"},{name:"patch_size",val:" = 32"},{name:"num_channels",val:" = 3"},{name:"qkv_bias",val:" = True"},{name:"max_image_length",val:" = -1"},{name:"tie_word_embeddings",val:" = False"},{name:"num_images",val:" = -1"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.ViltConfig.vocab_size",description:`<strong>vocab_size</strong> (<code>int</code>, <em>optional</em>, defaults to 30522) &#x2014;
...
</ul>`,name:"return_tensors"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/vilt/feature_extraction_vilt.py#L184",returnDescription:`
<p>A <a
...
configuration. Check out the <a href="/docs/transformers/main/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/vilt/modeling_vilt.py#L727"}}),Vt=new E({props:{name:"forward",anchor:"transformers.ViltModel.forward",parameters:[{name:"input_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"attention_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"token_type_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"pixel_values",val:": typing.Optional[torch.FloatTensor] = None"},{name:"pixel_mask",val:": typing.Optional[torch.LongTensor] = None"},{name:"head_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"image_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"image_token_type_idx",val:": typing.Optional[int] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.ViltModel.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>({0})</code>) &#x2014;
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/main/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/vilt/modeling_vilt.py#L892"}}),Pt=new E({props:{name:"forward",anchor:"transformers.ViltForMaskedLM.forward",parameters:[{name:"input_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"attention_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"token_type_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"pixel_values",val:": typing.Optional[torch.FloatTensor] = None"},{name:"pixel_mask",val:": typing.Optional[torch.LongTensor] = None"},{name:"head_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"image_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"labels",val:": typing.Optional[torch.LongTensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.ViltForMaskedLM.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. Indices can be obtained using <a href="/docs/transformers/main/en/model_doc/bert#transformers.BertTokenizer">BertTokenizer</a>. See
<a href="/docs/transformers/main/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and <a href="/docs/transformers/main/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details. <a href="../glossary#input-ids">What are input
...
Whether or not to return a <a href="/docs/transformers/main/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/vilt/modeling_vilt.py#L1274"}}),qt=new E({props:{name:"forward",anchor:"transformers.ViltForImagesAndTextClassification.forward",parameters:[{name:"input_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"attention_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"token_type_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"pixel_values",val:": typing.Optional[torch.FloatTensor] = None"},{name:"pixel_mask",val:": typing.Optional[torch.LongTensor] = None"},{name:"head_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"image_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"labels",val:": typing.Optional[torch.LongTensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.ViltForImagesAndTextClassification.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>({0})</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. Indices can be obtained using <a href="/docs/transformers/main/en/model_doc/bert#transformers.BertTokenizer">BertTokenizer</a>. See
<a href="/docs/transformers/main/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and <a href="/docs/transformers/main/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details. <a href="../glossary#input-ids">What are input
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/main/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/vilt/modeling_vilt.py#L1175"}}),Dt=new E({props:{name:"forward",anchor:"transformers.ViltForImageAndTextRetrieval.forward",parameters:[{name:"input_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"attention_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"token_type_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"pixel_values",val:": typing.Optional[torch.FloatTensor] = None"},{name:"pixel_mask",val:": typing.Optional[torch.LongTensor] = None"},{name:"head_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"image_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"labels",val:": typing.Optional[torch.LongTensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.ViltForImageAndTextRetrieval.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>({0})</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. Indices can be obtained using <a href="/docs/transformers/main/en/model_doc/bert#transformers.BertTokenizer">BertTokenizer</a>. See
<a href="/docs/transformers/main/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and <a href="/docs/transformers/main/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details. <a href="../glossary#input-ids">What are input
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/main/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/vilt/modeling_vilt.py#L1414"}}),Qt=new E({props:{name:"forward",anchor:"transformers.ViltForTokenClassification.forward",parameters:[{name:"input_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"attention_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"token_type_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"pixel_values",val:": typing.Optional[torch.FloatTensor] = None"},{name:"pixel_mask",val:": typing.Optional[torch.LongTensor] = None"},{name:"head_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"image_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"labels",val:": typing.Optional[torch.LongTensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.ViltForTokenClassification.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>({0})</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. Indices can be obtained using <a href="/docs/transformers/main/en/model_doc/bert#transformers.BertTokenizer">BertTokenizer</a>. See
<a href="/docs/transformers/main/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and <a href="/docs/transformers/main/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details. <a href="../glossary#input-ids">What are input
...
which pixel values are real and which are padding. `),eo=n("a"),da=r("ViltProcessor"),ca=r(" automatically creates this for you."),ma=c(),Ro=n("li"),pa=r(`The design of ViLT is very similar to that of a standard Vision Transformer (ViT). The only difference is that the model includes
additional embedding layers for the language modality.`),Jn=c(),Te=n("img"),Xn=c(),ke=n("small"),ha=r("ViLT architecture. Taken from the "),to=n("a"),fa=r("original paper"),ua=r("."),Zn=c(),K=n("p"),ga=r("This model was contributed by "),ct=n("a"),_a=r("nielsr"),va=r(". The original code can be found "),mt=n("a"),ba=r("here"),Ta=r("."),Yn=c(),oo=n("p"),ka=r("Tips:"),es=c(),no=n("ul"),Bo=n("li"),wa=r("The PyTorch version of this model is only available in torch 1.10 and higher."),ts=c(),ee=n("h2"),we=n("a"),Wo=n("span"),T(pt.$$.fragment),xa=c(),Qo=n("span"),ya=r("ViltConfig"),os=c(),P=n("div"),T(ht.$$.fragment),$a=c(),te=n("p"),Va=r("This is the configuration class to store the configuration of a "),Uo=n("code"),Fa=r("ViLTModel"),Ea=r(`. It is used to instantiate an ViLT
...
docstring of `),kt=n("a"),en=n("strong"),ir=r("call"),lr=r("()"),dr=r(" and "),tn=n("code"),cr=r("decode()"),mr=r(" for more information."),pr=c(),J=n("div"),T(wt.$$.fragment),hr=c(),ae=n("p"),fr=r("This method uses "),Fe=n("a"),ur=r("ViltFeatureExtractor."),on=n("strong"),gr=r("call"),_r=r("()"),vr=r(` method to prepare image(s) for the model, and
...
behavior.`),jr=c(),O=n("div"),T(Vt.$$.fragment),zr=c(),ie=n("p"),Lr=r("The "),mo=n("a"),Ir=r("ViltModel"),Ar=r(" forward method, overrides the "),dn=n("code"),Cr=r("__call__"),qr=r(" special method."),Or=c(),T(Pe.$$.fragment),Nr=c(),T(je.$$.fragment),ds=c(),le=n("h2"),ze=n("a"),cn=n("span"),T(Ft.$$.fragment),Sr=c(),mn=n("span"),Dr=r("ViltForMaskedLM"),cs=c(),L=n("div"),T(Et.$$.fragment),Rr=c(),pn=n("p"),Br=r("ViLT Model with a language modeling head on top as done during pretraining."),Wr=c(),Mt=n("p"),Qr=r("This model is a PyTorch "),hn=n("code"),Ur=r("torch.nn.Module <https://pytorch.org/docs/stable/nn.html#torch.nn.Module>"),Hr=r(`_ subclass. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),Kr=c(),N=n("div"),T(Pt.$$.fragment),Gr=c(),de=n("p"),Jr=r("The "),po=n("a"),Xr=r("ViltForMaskedLM"),Zr=r(" forward method, overrides the "),fn=n("code"),Yr=r("__call__"),ei=r(" special method."),ti=c(),T(Le.$$.fragment),oi=c(),T(Ie.$$.fragment),ms=c(),ce=n("h2"),Ae=n("a"),un=n("span"),T(jt.$$.fragment),ni=c(),gn=n("span"),si=r("ViltForQuestionAnswering"),ps=c(),I=n("div"),T(zt.$$.fragment),ai=c(),_n=n("p"),ri=r(`Vilt Model transformer with a classifier head on top (a linear layer on top of the final hidden state of the [CLS]
...
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),sl=c(),X=n("div"),T(Qt.$$.fragment),al=c(),_e=n("p"),rl=r("The "),go=n("a"),il=r("ViltForTokenClassification"),ll=r(" forward method, overrides the "),Ln=n("code"),dl=r("__call__"),cl=r(" special method."),ml=c(),T(Qe.$$.fragment),this.h()},l(t){const h=Rd('[data-svelte="svelte-1phssyn"]',document.head);d=s(h,"META",{name:!0,content:!0}),h.forEach(o),b=m(t),g=s(t,"H1",{class:!0});var Ut=a(g);u=s(Ut,"A",{id:!0,class:!0,href:!0});var In=a(u);v=s(In,"SPAN",{});var An=a(v);k(l.$$.fragment,An),An.forEach(o),In.forEach(o),f=m(Ut),F=s(Ut,"SPAN",{});var Cn=a(F);Ns=i(Cn,"ViLT"),Cn.forEach(o),Ut.forEach(o),Wn=m(t),Z=s(t,"H2",{class:!0});var Ht=a(Z);ve=s(Ht,"A",{id:!0,class:!0,href:!0});var qn=a(ve);Co=s(qn,"SPAN",{});var On=a(Co);k(rt.$$.fragment,On),On.forEach(o),qn.forEach(o),Ss=m(Ht),qo=s(Ht,"SPAN",{});var Nn=a(qo);Ds=i(Nn,"Overview"),Nn.forEach(o),Ht.forEach(o),Qn=m(t),be=s(t,"P",{});var Kt=a(be);Rs=i(Kt,"The ViLT model was proposed in "),it=s(Kt,"A",{href:!0,rel:!0});var Sn=a(it);Bs=i(Sn,"ViLT: Vision-and-Language Transformer Without Convolution or Region Supervision"),Sn.forEach(o),Ws=i(Kt,`
by Wonjae Kim, Bokyung Son, Ildoo Kim. ViLT incorporates text embeddings into a Vision Transformer (ViT), allowing it to have a minimal design
for Vision-and-Language Pre-training (VLP).`),Kt.forEach(o),Un=m(t),Jt=s(t,"P",{});var Dn=a(Jt);Qs=i(Dn,"The abstract from the paper is the following:"),Dn.forEach(o),Hn=m(t),Xt=s(t,"P",{});var Rn=a(Xt);Oo=s(Rn,"EM",{});var Bn=a(Oo);Us=i(Bn,`Vision-and-Language Pre-training (VLP) has improved performance on various joint vision-and-language downstream tasks.
Current approaches to VLP heavily rely on image feature extraction processes, most of which involve region supervision
(e.g., object detection) and the convolutional architecture (e.g., ResNet). Although disregarded in the literature, we
find it problematic in terms of both (1) efficiency/speed, that simply extracting input features requires much more
computation than the multimodal interaction steps; and (2) expressive power, as it is upper bounded to the expressive
...
Vision-and-Language Transformer (ViLT), monolithic in the sense that the processing of visual inputs is drastically
simplified to just the same convolution-free manner that we process textual inputs. We show that ViLT is up to tens of
times faster than previous VLP models, yet with competitive or better downstream task performance.`),Bn.forEach(o),Rn.forEach(o),Kn=m(t),Zt=s(t,"P",{});var fl=a(Zt);Hs=i(fl,"Tips:"),fl.forEach(o),Gn=m(t),q=s(t,"UL",{});var Ue=a(q);lt=s(Ue,"LI",{});var Ts=a(lt);Ks=i(Ts,"The quickest way to get started with ViLT is by checking the "),dt=s(Ts,"A",{href:!0,rel:!0});var ul=a(dt);Gs=i(ul,"example notebooks"),ul.forEach(o),Js=i(Ts,`
(which showcase both inference and fine-tuning on custom data).`),Ts.forEach(o),Xs=m(Ue),B=s(Ue,"LI",{});var He=a(B);Zs=i(He,"ViLT is a model that takes both "),No=s(He,"CODE",{});var gl=a(No);Ys=i(gl,"pixel_values"),gl.forEach(o),ea=i(He," and "),So=s(He,"CODE",{});var _l=a(So);ta=i(_l,"input_ids"),_l.forEach(o),oa=i(He," as input. One can use "),Yt=s(He,"A",{href:!0});var vl=a(Yt);na=i(vl,"ViltProcessor"),vl.forEach(o),sa=i(He,` to prepare data for the model.
This processor wraps a feature extractor (for the image modality) and a tokenizer (for the language modality) into one.`),He.forEach(o),aa=m(Ue),Y=s(Ue,"LI",{});var _o=a(Y);ra=i(_o,`ViLT is trained with images of various sizes: the authors resize the shorter edge of input images to 384 and limit the longer edge to
...
which pixel values are real and which are padding. `),eo=s(_o,"A",{href:!0});var Tl=a(eo);da=i(Tl,"ViltProcessor"),Tl.forEach(o),ca=i(_o," automatically creates this for you."),_o.forEach(o),ma=m(Ue),Ro=s(Ue,"LI",{});var kl=a(Ro);pa=i(kl,`The design of ViLT is very similar to that of a standard Vision Transformer (ViT). The only difference is that the model includes
additional embedding layers for the language modality.`),kl.forEach(o),Ue.forEach(o),Jn=m(t),Te=s(t,"IMG",{src:!0,alt:!0,width:!0}),Xn=m(t),ke=s(t,"SMALL",{});var ks=a(ke);ha=i(ks,"ViLT architecture. Taken from the "),to=s(ks,"A",{href:!0});var wl=a(to);fa=i(wl,"original paper"),wl.forEach(o),ua=i(ks,"."),ks.forEach(o),Zn=m(t),K=s(t,"P",{});var vo=a(K);ga=i(vo,"This model was contributed by "),ct=s(vo,"A",{href:!0,rel:!0});var xl=a(ct);_a=i(xl,"nielsr"),xl.forEach(o),va=i(vo,". The original code can be found "),mt=s(vo,"A",{href:!0,rel:!0});var yl=a(mt);ba=i(yl,"here"),yl.forEach(o),Ta=i(vo,"."),vo.forEach(o),Yn=m(t),oo=s(t,"P",{});var $l=a(oo);ka=i($l,"Tips:"),$l.forEach(o),es=m(t),no=s(t,"UL",{});var Vl=a(no);Bo=s(Vl,"LI",{});var Fl=a(Bo);wa=i(Fl,"The PyTorch version of this model is only available in torch 1.10 and higher."),Fl.forEach(o),Vl.forEach(o),ts=m(t),ee=s(t,"H2",{class:!0});var ws=a(ee);we=s(ws,"A",{id:!0,class:!0,href:!0});var El=a(we);Wo=s(El,"SPAN",{});var Ml=a(Wo);k(pt.$$.fragment,Ml),Ml.forEach(o),El.forEach(o),xa=m(ws),Qo=s(ws,"SPAN",{});var Pl=a(Qo);ya=i(Pl,"ViltConfig"),Pl.forEach(o),ws.forEach(o),os=m(t),P=s(t,"DIV",{class:!0});var Ke=a(P);k(ht.$$.fragment,Ke),$a=m(Ke),te=s(Ke,"P",{});var bo=a(te);Va=i(bo,"This is the configuration class to store the configuration of a "),Uo=s(bo,"CODE",{});var jl=a(Uo);Fa=i(jl,"ViLTModel"),jl.forEach(o),Ea=i(bo,`. It is used to instantiate an ViLT
model according to the specified arguments, defining the model architecture. Instantiating a configuration with the
defaults will yield a similar configuration to that of the ViLT
`),ft=s(bo,"A",{href:!0,rel:!0});var zl=a(ft);Ma=i(zl,"dandelin/vilt-b32-mlm"),zl.forEach(o),Pa=i(bo," architecture."),bo.forEach(o),ja=m(Ke),oe=s(Ke,"P",{});var To=a(oe);za=i(To,"Configuration objects inherit from "),so=s(To,"A",{href:!0});var Ll=a(so);La=i(Ll,"PretrainedConfig"),Ll.forEach(o),Ia=i(To,` and can be used to control the model outputs. Read the
documentation from `),ao=s(To,"A",{href:!0});var Il=a(ao);Aa=i(Il,"PretrainedConfig"),Il.forEach(o),Ca=i(To," for more information."),To.forEach(o),qa=m(Ke),k(xe.$$.fragment,Ke),Ke.forEach(o),ns=m(t),ne=s(t,"H2",{class:!0});var xs=a(ne);ye=s(xs,"A",{id:!0,class:!0,href:!0});var Al=a(ye);Ho=s(Al,"SPAN",{});var Cl=a(Ho);k(ut.$$.fragment,Cl),Cl.forEach(o),Al.forEach(o),Oa=m(xs),Ko=s(xs,"SPAN",{});var ql=a(Ko);Na=i(ql,"ViltFeatureExtractor"),ql.forEach(o),xs.forEach(o),ss=m(t),j=s(t,"DIV",{class:!0});var Ge=a(j);k(gt.$$.fragment,Ge),Sa=m(Ge),Go=s(Ge,"P",{});var Ol=a(Go);Da=i(Ol,"Constructs a ViLT feature extractor."),Ol.forEach(o),Ra=m(Ge),_t=s(Ge,"P",{});var ys=a(_t);Ba=i(ys,"This feature extractor inherits from "),ro=s(ys,"A",{href:!0});var Nl=a(ro);Wa=i(Nl,"FeatureExtractionMixin"),Nl.forEach(o),Qa=i(ys,` which contains most of the main methods. Users
should refer to this superclass for more information regarding those methods.`),ys.forEach(o),Ua=m(Ge),G=s(Ge,"DIV",{class:!0});var ko=a(G);k(vt.$$.fragment,ko),Ha=m(ko),Jo=s(ko,"P",{});var Sl=a(Jo);Ka=i(Sl,"Main method to prepare for the model one or several image(s)."),Sl.forEach(o),Ga=m(ko),k($e.$$.fragment,ko),ko.forEach(o),Ge.forEach(o),as=m(t),se=s(t,"H2",{class:!0});var $s=a(se);Ve=s($s,"A",{id:!0,class:!0,href:!0});var Dl=a(Ve);Xo=s(Dl,"SPAN",{});var Rl=a(Xo);k(bt.$$.fragment,Rl),Rl.forEach(o),Dl.forEach(o),Ja=m($s),Zo=s($s,"SPAN",{});var Bl=a(Zo);Xa=i(Bl,"ViltProcessor"),Bl.forEach(o),$s.forEach(o),rs=m(t),z=s(t,"DIV",{class:!0});var Je=a(z);k(Tt.$$.fragment,Je),Za=m(Je),Yo=s(Je,"P",{});var Wl=a(Yo);Ya=i(Wl,"Constructs a ViLT processor which wraps a BERT tokenizer and ViLT feature extractor into a single processor."),Wl.forEach(o),er=m(Je),M=s(Je,"P",{});var U=a(M);io=s(U,"A",{href:!0});var Ql=a(io);tr=i(Ql,"ViltProcessor"),Ql.forEach(o),or=i(U," offers all the functionalities of "),lo=s(U,"A",{href:!0});var Ul=a(lo);nr=i(Ul,"ViltFeatureExtractor"),Ul.forEach(o),sr=i(U," and "),co=s(U,"A",{href:!0});var Hl=a(co);ar=i(Hl,"BertTokenizerFast"),Hl.forEach(o),rr=i(U,`. See the
docstring of `),kt=s(U,"A",{href:!0});var pl=a(kt);en=s(pl,"STRONG",{});var Kl=a(en);ir=i(Kl,"call"),Kl.forEach(o),lr=i(pl,"()"),pl.forEach(o),dr=i(U," and "),tn=s(U,"CODE",{});var Gl=a(tn);cr=i(Gl,"decode()"),Gl.forEach(o),mr=i(U," for more information."),U.forEach(o),pr=m(Je),J=s(Je,"DIV",{class:!0});var wo=a(J);k(wt.$$.fragment,wo),hr=m(wo),ae=s(wo,"P",{});var xo=a(ae);fr=i(xo,"This method uses "),Fe=s(xo,"A",{href:!0});var Vs=a(Fe);ur=i(Vs,"ViltFeatureExtractor."),on=s(Vs,"STRONG",{});var Jl=a(on);gr=i(Jl,"call"),Jl.forEach(o),_r=i(Vs,"()"),Vs.forEach(o),vr=i(xo,` method to prepare image(s) for the model, and
`),Ee=s(xo,"A",{href:!0});var Fs=a(Ee);br=i(Fs,"BertTokenizerFast."),nn=s(Fs,"STRONG",{});var Xl=a(nn);Tr=i(Xl,"call"),Xl.forEach(o),kr=i(Fs,"()"),Fs.forEach(o),wr=i(xo," to prepare text for the model."),xo.forEach(o),xr=m(wo),sn=s(wo,"P",{});var Zl=a(sn);yr=i(Zl,"Please refer to the docstring of the above two methods for more information."),Zl.forEach(o),wo.forEach(o),Je.forEach(o),is=m(t),re=s(t,"H2",{class:!0});var Es=a(re);Me=s(Es,"A",{id:!0,class:!0,href:!0});var Yl=a(Me);an=s(Yl,"SPAN",{});var ed=a(an);k(xt.$$.fragment,ed),ed.forEach(o),Yl.forEach(o),$r=m(Es),rn=s(Es,"SPAN",{});var td=a(rn);Vr=i(td,"ViltModel"),td.forEach(o),Es.forEach(o),ls=m(t),W=s(t,"DIV",{class:!0});var yo=a(W);k(yt.$$.fragment,yo),Fr=m(yo),$t=s(yo,"P",{});var Ms=a($t);Er=i(Ms,`The bare ViLT Model transformer outputting raw hidden-states without any specific head on top.
...
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),Ms.forEach(o),jr=m(yo),O=s(yo,"DIV",{class:!0});var Xe=a(O);k(Vt.$$.fragment,Xe),zr=m(Xe),ie=s(Xe,"P",{});var $o=a(ie);Lr=i($o,"The "),mo=s($o,"A",{href:!0});var nd=a(mo);Ir=i(nd,"ViltModel"),nd.forEach(o),Ar=i($o," forward method, overrides the "),dn=s($o,"CODE",{});var sd=a(dn);Cr=i(sd,"__call__"),sd.forEach(o),qr=i($o," special method."),$o.forEach(o),Or=m(Xe),k(Pe.$$.fragment,Xe),Nr=m(Xe),k(je.$$.fragment,Xe),Xe.forEach(o),yo.forEach(o),ds=m(t),le=s(t,"H2",{class:!0});var Ps=a(le);ze=s(Ps,"A",{id:!0,class:!0,href:!0});var ad=a(ze);cn=s(ad,"SPAN",{});var rd=a(cn);k(Ft.$$.fragment,rd),rd.forEach(o),ad.forEach(o),Sr=m(Ps),mn=s(Ps,"SPAN",{});var id=a(mn);Dr=i(id,"ViltForMaskedLM"),id.forEach(o),Ps.forEach(o),cs=m(t),L=s(t,"DIV",{class:!0});var Ze=a(L);k(Et.$$.fragment,Ze),Rr=m(Ze),pn=s(Ze,"P",{});var ld=a(pn);Br=i(ld,"ViLT Model with a language modeling head on top as done during pretraining."),ld.forEach(o),Wr=m(Ze),Mt=s(Ze,"P",{});var js=a(Mt);Qr=i(js,"This model is a PyTorch "),hn=s(js,"CODE",{});var dd=a(hn);Ur=i(dd,"torch.nn.Module <https://pytorch.org/docs/stable/nn.html#torch.nn.Module>"),dd.forEach(o),Hr=i(js,`_ subclass. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),js.forEach(o),Kr=m(Ze),N=s(Ze,"DIV",{class:!0});var Ye=a(N);k(Pt.$$.fragment,Ye),Gr=m(Ye),de=s(Ye,"P",{});var Vo=a(de);Jr=i(Vo,"The "),po=s(Vo,"A",{href:!0});var cd=a(po);Xr=i(cd,"ViltForMaskedLM"),cd.forEach(o),Zr=i(Vo," forward method, overrides the "),fn=s(Vo,"CODE",{});var md=a(fn);Yr=i(md,"__call__"),md.forEach(o),ei=i(Vo," special method."),Vo.forEach(o),ti=m(Ye),k(Le.$$.fragment,Ye),oi=m(Ye),k(Ie.$$.fragment,Ye),Ye.forEach(o),Ze.forEach(o),ms=m(t),ce=s(t,"H2",{class:!0});var zs=a(ce);Ae=s(zs,"A",{id:!0,class:!0,href:!0});var pd=a(Ae);un=s(pd,"SPAN",{});var hd=a(un);k(jt.$$.fragment,hd),hd.forEach(o),pd.forEach(o),ni=m(zs),gn=s(zs,"SPAN",{});var fd=a(gn);si=i(fd,"ViltForQuestionAnswering"),fd.forEach(o),zs.forEach(o),ps=m(t),I=s(t,"DIV",{class:!0});var et=a(I);k(zt.$$.fragment,et),ai=m(et),_n=s(et,"P",{});var ud=a(_n);ri=i(ud,`Vilt Model transformer with a classifier head on top (a linear layer on top of the final hidden state of the [CLS]
token) for visual question answering, e.g. for VQAv2.`),ud.forEach(o),ii=m(et),Lt=s(et,"P",{});var Ls=a(Lt);li=i(Ls,"This model is a PyTorch "),vn=s(Ls,"CODE",{});var gd=a(vn);di=i(gd,"torch.nn.Module <https://pytorch.org/docs/stable/nn.html#torch.nn.Module>"),gd.forEach(o),ci=i(Ls,`_ subclass. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),Ls.forEach(o),mi=m(et),S=s(et,"DIV",{class:!0});var tt=a(S);k(It.$$.fragment,tt),pi=m(tt),me=s(tt,"P",{});var Fo=a(me);hi=i(Fo,"The "),ho=s(Fo,"A",{href:!0});var _d=a(ho);fi=i(_d,"ViltForQuestionAnswering"),_d.forEach(o),ui=i(Fo," forward method, overrides the "),bn=s(Fo,"CODE",{});var vd=a(bn);gi=i(vd,"__call__"),vd.forEach(o),_i=i(Fo," special method."),Fo.forEach(o),vi=m(tt),k(Ce.$$.fragment,tt),bi=m(tt),k(qe.$$.fragment,tt),tt.forEach(o),et.forEach(o),hs=m(t),pe=s(t,"H2",{class:!0});var Is=a(pe);Oe=s(Is,"A",{id:!0,class:!0,href:!0});var bd=a(Oe);Tn=s(bd,"SPAN",{});var Td=a(Tn);k(At.$$.fragment,Td),Td.forEach(o),bd.forEach(o),Ti=m(Is),kn=s(Is,"SPAN",{});var kd=a(kn);ki=i(kd,"ViltForImagesAndTextClassification"),kd.forEach(o),Is.forEach(o),fs=m(t),Q=s(t,"DIV",{class:!0});var Eo=a(Q);k(Ct.$$.fragment,Eo),wi=m(Eo),wn=s(Eo,"P",{});var wd=a(wn);xi=i(wd,"Vilt Model transformer with a classifier head on top for natural language visual reasoning, e.g. NLVR2."),wd.forEach(o),yi=m(Eo),D=s(Eo,"DIV",{class:!0});var ot=a(D);k(qt.$$.fragment,ot),$i=m(ot),he=s(ot,"P",{});var Mo=a(he);Vi=i(Mo,"The "),fo=s(Mo,"A",{href:!0});var xd=a(fo);Fi=i(xd,"ViltForImagesAndTextClassification"),xd.forEach(o),Ei=i(Mo," forward method, overrides the "),xn=s(Mo,"CODE",{});var yd=a(xn);Mi=i(yd,"__call__"),yd.forEach(o),Pi=i(Mo," special method."),Mo.forEach(o),ji=m(ot),k(Ne.$$.fragment,ot),zi=m(ot),k(Se.$$.fragment,ot),ot.forEach(o),Eo.forEach(o),us=m(t),fe=s(t,"H2",{class:!0});var As=a(fe);De=s(As,"A",{id:!0,class:!0,href:!0});var $d=a(De);yn=s($d,"SPAN",{});var Vd=a(yn);k(Ot.$$.fragment,Vd),Vd.forEach(o),$d.forEach(o),Li=m(As),$n=s(As,"SPAN",{});var Fd=a($n);Ii=i(Fd,"ViltForImageAndTextRetrieval"),Fd.forEach(o),As.forEach(o),gs=m(t),A=s(t,"DIV",{class:!0});var nt=a(A);k(Nt.$$.fragment,nt),Ai=m(nt),Vn=s(nt,"P",{});var Ed=a(Vn);Ci=i(Ed,`Vilt Model transformer with a classifier head on top (a linear layer on top of the final hidden state of the [CLS]
token) for image-to-text or text-to-image retrieval, e.g. MSCOCO and F30K.`),Ed.forEach(o),qi=m(nt),St=s(nt,"P",{});var Cs=a(St);Oi=i(Cs,"This model is a PyTorch "),Fn=s(Cs,"CODE",{});var Md=a(Fn);Ni=i(Md,"torch.nn.Module <https://pytorch.org/docs/stable/nn.html#torch.nn.Module>"),Md.forEach(o),Si=i(Cs,`_ subclass. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),Cs.forEach(o),Di=m(nt),R=s(nt,"DIV",{class:!0});var st=a(R);k(Dt.$$.fragment,st),Ri=m(st),ue=s(st,"P",{});var Po=a(ue);Bi=i(Po,"The "),uo=s(Po,"A",{href:!0});var Pd=a(uo);Wi=i(Pd,"ViltForImageAndTextRetrieval"),Pd.forEach(o),Qi=i(Po," forward method, overrides the "),En=s(Po,"CODE",{});var jd=a(En);Ui=i(jd,"__call__"),jd.forEach(o),Hi=i(Po," special method."),Po.forEach(o),Ki=m(st),k(Re.$$.fragment,st),Gi=m(st),k(Be.$$.fragment,st),st.forEach(o),nt.forEach(o),_s=m(t),ge=s(t,"H2",{class:!0});var qs=a(ge);We=s(qs,"A",{id:!0,class:!0,href:!0});var zd=a(We);Mn=s(zd,"SPAN",{});var Ld=a(Mn);k(Rt.$$.fragment,Ld),Ld.forEach(o),zd.forEach(o),Ji=m(qs),Pn=s(qs,"SPAN",{});var Id=a(Pn);Xi=i(Id,"ViltForTokenClassification"),Id.forEach(o),qs.forEach(o),vs=m(t),C=s(t,"DIV",{class:!0});var at=a(C);k(Bt.$$.fragment,at),Zi=m(at),jn=s(at,"P",{});var Ad=a(jn);Yi=i(Ad,`ViLT Model with a token classification head on top (a linear layer on top of the final hidden-states of the text
tokens) e.g. for Named-Entity-Recognition (NER) tasks.`),Ad.forEach(o),el=m(at),Wt=s(at,"P",{});var Os=a(Wt);tl=i(Os,"This model is a PyTorch "),zn=s(Os,"CODE",{});var Cd=a(zn);ol=i(Cd,"torch.nn.Module <https://pytorch.org/docs/stable/nn.html#torch.nn.Module>"),Cd.forEach(o),nl=i(Os,`_ subclass. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),Os.forEach(o),sl=m(at),X=s(at,"DIV",{class:!0});var jo=a(X);k(Qt.$$.fragment,jo),al=m(jo),_e=s(jo,"P",{});var zo=a(_e);rl=i(zo,"The "),go=s(zo,"A",{href:!0});var qd=a(go);il=i(qd,"ViltForTokenClassification"),qd.forEach(o),ll=i(zo," forward method, overrides the "),Ln=s(zo,"CODE",{});var Od=a(Ln);dl=i(Od,"__call__"),Od.forEach(o),cl=i(zo," special method."),zo.forEach(o),ml=m(jo),k(Qe.$$.fragment,jo),jo.forEach(o),at.forEach(o),this.h()},h(){p(d,"name","hf:doc:metadata"),p(d,"content",JSON.stringify(ac)),p(u,"id","vilt"),p(u,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),p(u,"href","#vilt"),p(g,"class","relative group"),p(ve,"id","overview"),p(ve,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),p(ve,"href","#overview"),p(Z,"class","relative group"),p(it,"href","https://arxiv.org/abs/2102.03334"),p(it,"rel","nofollow"),p(dt,"href","https://github.com/NielsRogge/Transformers-Tutorials/tree/master/ViLT"),p(dt,"rel","nofollow"),p(Yt,"href","/docs/transformers/main/en/model_doc/vilt#transformers.ViltProcessor"),p(eo,"href","/docs/transformers/main/en/model_doc/vilt#transformers.ViltProcessor"),Bd(Te.src,hl="https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/vilt_architecture.jpg")||p(Te,"src",hl),p(Te,"alt","drawing"),p(Te,"width","600"),p(to,"href","https://arxiv.org/abs/2102.03334"),p(ct,"href","https://huggingface.co/nielsr"),p(ct,"rel","nofollow"),p(mt,"href","https://github.com/dandelin/ViLT"),p(mt,"rel","nofollow"),p(we,"id","transformers.ViltConfig"),p(we,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),p(we,"href","#transformers.ViltConfig"),p(ee,"class","relative group"),p(ft,"href","https://huggingface.co/dandelin/vilt-b32-mlm"),p(ft,"rel","nofollow"),p(so,"href","/docs/transformers/main/en/main_classes/configuration#transformers.PretrainedConfig"),p(ao,"href","/docs/transformers/main/en/main_classes/configuration#transformers.PretrainedConfig"),p(P,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),p(ye,"id","transformers.ViltFeatureExtractor"),p(ye,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),p(ye,"href","#transformers.ViltFeatureExtractor"),p(ne,"class","relative group"),p(ro,"href","/docs/transformers/main/en/internal/image_processing_utils#transformers.FeatureExtractionMixin"),p(G,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),p(j,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),p(Ve,"id","transformers.ViltProcessor"),p(Ve,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),p(Ve,"href","#transformers.ViltProcessor"),p(se,"class","relative group"),p(io,"href","/docs/transformers/main/en/model_doc/vilt#transformers.ViltProcessor"),p(lo,"href","/docs/transformers/main/en/model_doc/vilt#transformers.ViltFeatureExtractor"),p(co,"href","/docs/transformers/main/en/model_doc/bert#transformers.BertTokenizerFast"),p(kt,"href","/docs/transformers/main/en/model_doc/vilt#transformers.ViltProcessor.__call__"),p(Fe,"href","/docs/transformers/main/en/model_doc/vilt#transformers.ViltFeatureExtractor.__call__"),p(Ee,"href","/docs/transformers/main/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__"),p(J,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),p(z,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),p(Me,"id","transformers.ViltModel"),p(Me,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),p(Me,"href","#transformers.ViltModel"),p(re,"class","relative group"),p(mo,"href","/docs/transformers/main/en/model_doc/vilt#transformers.ViltModel"),p(O,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),p(W,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),p(ze,"id","transformers.ViltForMaskedLM"),p(ze,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),p(ze,"href","#transformers.ViltForMaskedLM"),p(le,"class","relative group"),p(po,"href","/docs/transformers/main/en/model_doc/vilt#transformers.ViltForMaskedLM"),p(N,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),p(L,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),p(Ae,"id","transformers.ViltForQuestionAnswering"),p(Ae,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),p(Ae,"href","#transformers.ViltForQuestionAnswering"),p(ce,"class","relative group"),p(ho,"href","/docs/transformers/main/en/model_doc/vilt#transformers.ViltForQuestionAnswering"),p(S,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),p(I,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),p(Oe,"id","transformers.ViltForImagesAndTextClassification"),p(Oe,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),p(Oe,"href","#transformers.ViltForImagesAndTextClassification"),p(pe,"class","relative group"),p(fo,"href","/docs/transformers/main/en/model_doc/vilt#transformers.ViltForImagesAndTextClassification"),p(D,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),p(Q,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),p(De,"id","transformers.ViltForImageAndTextRetrieval"),p(De,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),p(De,"href","#transformers.ViltForImageAndTextRetrieval"),p(fe,"class","relative group"),p(uo,"href","/docs/transformers/main/en/model_doc/vilt#transformers.ViltForImageAndTextRetrieval"),p(R,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),p(A,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),p(We,"id","transformers.ViltForTokenClassification"),p(We,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),p(We,"href","#transformers.ViltForTokenClassification"),p(ge,"class","relative group"),p(go,"href","/docs/transformers/main/en/model_doc/vilt#transformers.ViltForTokenClassification"),p(X,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),p(C,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8")},m(t,h){e(document.head,d),_(t,b,h),_(t,g,h),e(g,u),e(u,v),w(l,v,null),e(g,f),e(g,F),e(F,Ns),_(t,Wn,h),_(t,Z,h),e(Z,ve),e(ve,Co),w(rt,Co,null),e(Z,Ss),e(Z,qo),e(qo,Ds),_(t,Qn,h),_(t,be,h),e(be,Rs),e(be,it),e(it,Bs),e(be,Ws),_(t,Un,h),_(t,Jt,h),e(Jt,Qs),_(t,Hn,h),_(t,Xt,h),e(Xt,Oo),e(Oo,Us),_(t,Kn,h),_(t,Zt,h),e(Zt,Hs),_(t,Gn,h),_(t,q,h),e(q,lt),e(lt,Ks),e(lt,dt),e(dt,Gs),e(lt,Js),e(q,Xs),e(q,B),e(B,Zs),e(B,No),e(No,Ys),e(B,ea),e(B,So),e(So,ta),e(B,oa),e(B,Yt),e(Yt,na),e(B,sa),e(q,aa),e(q,Y),e(Y,ra),e(Y,Do),e(Do,ia),e(Y,la),e(Y,eo),e(eo,da),e(Y,ca),e(q,ma),e(q,Ro),e(Ro,pa),_(t,Jn,h),_(t,Te,h),_(t,Xn,h),_(t,ke,h),e(ke,ha),e(ke,to),e(to,fa),e(ke,ua),_(t,Zn,h),_(t,K,h),e(K,ga),e(K,ct),e(ct,_a),e(K,va),e(K,mt),e(mt,ba),e(K,Ta),_(t,Yn,h),_(t,oo,h),e(oo,ka),_(t,es,h),_(t,no,h),e(no,Bo),e(Bo,wa),_(t,ts,h),_(t,ee,h),e(ee,we),e(we,Wo),w(pt,Wo,null),e(ee,xa),e(ee,Qo),e(Qo,ya),_(t,os,h),_(t,P,h),w(ht,P,null),e(P,$a),e(P,te),e(te,Va),e(te,Uo),e(Uo,Fa),e(te,Ea),e(te,ft),e(ft,Ma),e(te,Pa),e(P,ja),e(P,oe),e(oe,za),e(oe,so),e(so,La),e(oe,Ia),e(oe,ao),e(ao,Aa),e(oe,Ca),e(P,qa),w(xe,P,null),_(t,ns,h),_(t,ne,h),e(ne,ye),e(ye,Ho),w(ut,Ho,null),e(ne,Oa),e(ne,Ko),e(Ko,Na),_(t,ss,h),_(t,j,h),w(gt,j,null),e(j,Sa),e(j,Go),e(Go,Da),e(j,Ra),e(j,_t),e(_t,Ba),e(_t,ro),e(ro,Wa),e(_t,Qa),e(j,Ua),e(j,G),w(vt,G,null),e(G,Ha),e(G,Jo),e(Jo,Ka),e(G,Ga),w($e,G,null),_(t,as,h),_(t,se,h),e(se,Ve),e(Ve,Xo),w(bt,Xo,null),e(se,Ja),e(se,Zo),e(Zo,Xa),_(t,rs,h),_(t,z,h),w(Tt,z,null),e(z,Za),e(z,Yo),e(Yo,Ya),e(z,er),e(z,M),e(M,io),e(io,tr),e(M,or),e(M,lo),e(lo,nr),e(M,sr),e(M,co),e(co,ar),e(M,rr),e(M,kt),e(kt,en),e(en,ir),e(kt,lr),e(M,dr),e(M,tn),e(tn,cr),e(M,mr),e(z,pr),e(z,J),w(wt,J,null),e(J,hr),e(J,ae),e(ae,fr),e(ae,Fe),e(Fe,ur),e(Fe,on),e(on,gr),e(Fe,_r),e(ae,vr),e(ae,Ee),e(Ee,br),e(Ee,nn),e(nn,Tr),e(Ee,kr),e(ae,wr),e(J,xr),e(J,sn),e(sn,yr),_(t,is,h),_(t,re,h),e(re,Me),e(Me,an),w(xt,an,null),e(re,$r),e(re,rn),e(rn,Vr),_(t,ls,h),_(t,W,h),w(yt,W,null),e(W,Fr),e(W,$t),e($t,Er),e($t,ln),e(ln,Mr),e($t,Pr),e(W,jr),e(W,O),w(Vt,O,null),e(O,zr),e(O,ie),e(ie,Lr),e(ie,mo),e(mo,Ir),e(ie,Ar),e(ie,dn),e(dn,Cr),e(ie,qr),e(O,Or),w(Pe,O,null),e(O,Nr),w(je,O,null),_(t,ds,h),_(t,le,h),e(le,ze),e(ze,cn),w(Ft,cn,null),e(le,Sr),e(le,mn),e(mn,Dr),_(t,cs,h),_(t,L,h),w(Et,L,null),e(L,Rr),e(L,pn),e(pn,Br),e(L,Wr),e(L,Mt),e(Mt,Qr),e(Mt,hn),e(hn,Ur),e(Mt,Hr),e(L,Kr),e(L,N),w(Pt,N,null),e(N,Gr),e(N,de),e(de,Jr),e(de,po),e(po,Xr),e(de,Zr),e(de,fn),e(fn,Yr),e(de,ei),e(N,ti),w(Le,N,null),e(N,oi),w(Ie,N,null),_(t,ms,h),_(t,ce,h),e(ce,Ae),e(Ae,un),w(jt,un,null),e(ce,ni),e(ce,gn),e(gn,si),_(t,ps,h),_(t,I,h),w(zt,I,null),e(I,ai),e(I,_n),e(_n,ri),e(I,ii),e(I,Lt),e(Lt,li),e(Lt,vn),e(vn,di),e(Lt,ci),e(I,mi),e(I,S),w(It,S,null),e(S,pi),e(S,me),e(me,hi),e(me,ho),e(ho,fi),e(me,ui),e(me,bn),e(bn,gi),e(me,_i),e(S,vi),w(Ce,S,null),e(S,bi),w(qe,S,null),_(t,hs,h),_(t,pe,h),e(pe,Oe),e(Oe,Tn),w(At,Tn,null),e(pe,Ti),e(pe,kn),e(kn,ki),_(t,fs,h),_(t,Q,h),w(Ct,Q,null),e(Q,wi),e(Q,wn),e(wn,xi),e(Q,yi),e(Q,D),w(qt,D,null),e(D,$i),e(D,he),e(he,Vi),e(he,fo),e(fo,Fi),e(he,Ei),e(he,xn),e(xn,Mi),e(he,Pi),e(D,ji),w(Ne,D,null),e(D,zi),w(Se,D,null),_(t,us,h),_(t,fe,h),e(fe,De),e(De,yn),w(Ot,yn,null),e(fe,Li),e(fe,$n),e($n,Ii),_(t,gs,h),_(t,A,h),w(Nt,A,null),e(A,Ai),e(A,Vn),e(Vn,Ci),e(A,qi),e(A,St),e(St,Oi),e(St,Fn),e(Fn,Ni),e(St,Si),e(A,Di),e(A,R),w(Dt,R,null),e(R,Ri),e(R,ue),e(ue,Bi),e(ue,uo),e(uo,Wi),e(ue,Qi),e(ue,En),e(En,Ui),e(ue,Hi),e(R,Ki),w(Re,R,null),e(R,Gi),w(Be,R,null),_(t,_s,h),_(t,ge,h),e(ge,We),e(We,Mn),w(Rt,Mn,null),e(ge,Ji),e(ge,Pn),e(Pn,Xi),_(t,vs,h),_(t,C,h),w(Bt,C,null),e(C,Zi),e(C,jn),e(jn,Yi),e(C,el),e(C,Wt),e(Wt,tl),e(Wt,zn),e(zn,ol),e(Wt,nl),e(C,sl),e(C,X),w(Qt,X,null),e(X,al),e(X,_e),e(_e,rl),e(_e,go),e(go,il),e(_e,ll),e(_e,Ln),e(Ln,dl),e(_e,cl),e(X,ml),w(Qe,X,null),bs=!0},p(t,[h]){const Ut={};h&2&&(Ut.$$scope={dirty:h,ctx:t}),xe.$set(Ut);const In={};h&2&&(In.$$scope={dirty:h,ctx:t}),$e.$set(In);const An={};h&2&&(An.$$scope={dirty:h,ctx:t}),Pe.$set(An);const Cn={};h&2&&(Cn.$$scope={dirty:h,ctx:t}),je.$set(Cn);const Ht={};h&2&&(Ht.$$scope={dirty:h,ctx:t}),Le.$set(Ht);const qn={};h&2&&(qn.$$scope={dirty:h,ctx:t}),Ie.$set(qn);const On={};h&2&&(On.$$scope={dirty:h,ctx:t}),Ce.$set(On);const Nn={};h&2&&(Nn.$$scope={dirty:h,ctx:t}),qe.$set(Nn);const Kt={};h&2&&(Kt.$$scope={dirty:h,ctx:t}),Ne.$set(Kt);const Sn={};h&2&&(Sn.$$scope={dirty:h,ctx:t}),Se.$set(Sn);const Dn={};h&2&&(Dn.$$scope={dirty:h,ctx:t}),Re.$set(Dn);const Rn={};h&2&&(Rn.$$scope={dirty:h,ctx:t}),Be.$set(Rn);const Bn={};h&2&&(Bn.$$scope={dirty:h,ctx:t}),Qe.$set(Bn)},i(t){bs||(x(l.$$.fragment,t),x(rt.$$.fragment,t),x(pt.$$.fragment,t),x(ht.$$.fragment,t),x(xe.$$.fragment,t),x(ut.$$.fragment,t),x(gt.$$.fragment,t),x(vt.$$.fragment,t),x($e.$$.fragment,t),x(bt.$$.fragment,t),x(Tt.$$.fragment,t),x(wt.$$.fragment,t),x(xt.$$.fragment,t),x(yt.$$.fragment,t),x(Vt.$$.fragment,t),x(Pe.$$.fragment,t),x(je.$$.fragment,t),x(Ft.$$.fragment,t),x(Et.$$.fragment,t),x(Pt.$$.fragment,t),x(Le.$$.fragment,t),x(Ie.$$.fragment,t),x(jt.$$.fragment,t),x(zt.$$.fragment,t),x(It.$$.fragment,t),x(Ce.$$.fragment,t),x(qe.$$.fragment,t),x(At.$$.fragment,t),x(Ct.$$.fragment,t),x(qt.$$.fragment,t),x(Ne.$$.fragment,t),x(Se.$$.fragment,t),x(Ot.$$.fragment,t),x(Nt.$$.fragment,t),x(Dt.$$.fragment,t),x(Re.$$.fragment,t),x(Be.$$.fragment,t),x(Rt.$$.fragment,t),x(Bt.$$.fragment,t),x(Qt.$$.fragment,t),x(Qe.$$.fragment,t),bs=!0)},o(t){y(l.$$.fragment,t),y(rt.$$.fragment,t),y(pt.$$.fragment,t),y(ht.$$.fragment,t),y(xe.$$.fragment,t),y(ut.$$.fragment,t),y(gt.$$.fragment,t),y(vt.$$.fragment,t),y($e.$$.fragment,t),y(bt.$$.fragment,t),y(Tt.$$.fragment,t),y(wt.$$.fragment,t),y(xt.$$.fragment,t),y(yt.$$.fragment,t),y(Vt.$$.fragment,t),y(Pe.$$.fragment,t),y(je.$$.fragment,t),y(Ft.$$.fragment,t),y(Et.$$.fragment,t),y(Pt.$$.fragment,t),y(Le.$$.fragment,t),y(Ie.$$.fragment,t),y(jt.$$.fragment,t),y(zt.$$.fragment,t),y(It.$$.fragment,t),y(Ce.$$.fragment,t),y(qe.$$.fragment,t),y(At.$$.fragment,t),y(Ct.$$.fragment,t),y(qt.$$.fragment,t),y(Ne.$$.fragment,t),y(Se.$$.fragment,t),y(Ot.$$.fragment,t),y(Nt.$$.fragment,t),y(Dt.$$.fragment,t),y(Re.$$.fragment,t),y(Be.$$.fragment,t),y(Rt.$$.fragment,t),y(Bt.$$.fragment,t),y(Qt.$$.fragment,t),y(Qe.$$.fragment,t),bs=!1},d(t){o(d),t&&o(b),t&&o(g),$(l),t&&o(Wn),t&&o(Z),$(rt),t&&o(Qn),t&&o(be),t&&o(Un),t&&o(Jt),t&&o(Hn),t&&o(Xt),t&&o(Kn),t&&o(Zt),t&&o(Gn),t&&o(q),t&&o(Jn),t&&o(Te),t&&o(Xn),t&&o(ke),t&&o(Zn),t&&o(K),t&&o(Yn),t&&o(oo),t&&o(es),t&&o(no),t&&o(ts),t&&o(ee),$(pt),t&&o(os),t&&o(P),$(ht),$(xe),t&&o(ns),t&&o(ne),$(ut),t&&o(ss),t&&o(j),$(gt),$(vt),$($e),t&&o(as),t&&o(se),$(bt),t&&o(rs),t&&o(z),$(Tt),$(wt),t&&o(is),t&&o(re),$(xt),t&&o(ls),t&&o(W),$(yt),$(Vt),$(Pe),$(je),t&&o(ds),t&&o(le),$(Ft),t&&o(cs),t&&o(L),$(Et),$(Pt),$(Le),$(Ie),t&&o(ms),t&&o(ce),$(jt),t&&o(ps),t&&o(I),$(zt),$(It),$(Ce),$(qe),t&&o(hs),t&&o(pe),$(At),t&&o(fs),t&&o(Q),$(Ct),$(qt),$(Ne),$(Se),t&&o(us),t&&o(fe),$(Ot),t&&o(gs),t&&o(A),$(Nt),$(Dt),$(Re),$(Be),t&&o(_s),t&&o(ge),$(Rt),t&&o(vs),t&&o(C),$(Bt),$(Qt),$(Qe)}}}const ac={local:"vilt",sections:[{local:"overview",title:"Overview"},{local:"transformers.ViltConfig",title:"ViltConfig"},{local:"transformers.ViltFeatureExtractor",title:"ViltFeatureExtractor"},{local:"transformers.ViltProcessor",title:"ViltProcessor"},{local:"transformers.ViltModel",title:"ViltModel"},{local:"transformers.ViltForMaskedLM",title:"ViltForMaskedLM"},{local:"transformers.ViltForQuestionAnswering",title:"ViltForQuestionAnswering"},{local:"transformers.ViltForImagesAndTextClassification",title:"ViltForImagesAndTextClassification"},{local:"transformers.ViltForImageAndTextRetrieval",title:"ViltForImageAndTextRetrieval"},{local:"transformers.ViltForTokenClassification",title:"ViltForTokenClassification"}],title:"ViLT"};function rc(V){return Wd(()=>{new URLSearchParams(window.location.search).get("fw")}),[]}class hc extends Nd{constructor(d){super();Sd(this,d,rc,sc,Dd,{})}}export{hc as default,ac as metadata};
