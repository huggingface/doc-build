import{S as Po,i as Do,s as So,e as n,k as c,w as v,t as r,M as Mo,c as s,d as o,m as d,a,x as T,h as i,b as p,F as t,g as h,y as w,L as Io,q as y,o as q,B}from"../../chunks/vendor-4833417e.js";import{D as $e}from"../../chunks/Docstring-4f315ed9.js";import{C as Lo}from"../../chunks/CodeBlock-6a3d1b46.js";import{I as to}from"../../chunks/IconCopyLink-4b81c553.js";import"../../chunks/CopyButton-dacfbfaf.js";function No(et){let _,Z,f,g,ue,D,tt,fe,ot,Ee,z,E,ge,S,nt,_e,st,xe,x,at,M,rt,it,Re,ee,lt,je,te,ke,pt,Le,oe,ct,Pe,I,De,ne,dt,Se,se,N,ht,ae,mt,ut,Me,C,Ie,re,be,ft,Ne,k,gt,O,_t,kt,F,bt,vt,Ce,A,R,ve,V,Tt,Te,wt,Oe,m,X,yt,$,qt,ie,Bt,zt,W,At,$t,Et,U,xt,le,Rt,jt,Lt,b,G,Pt,we,Dt,St,H,pe,Mt,ye,It,Nt,ce,Ct,qe,Ot,Ft,j,K,Vt,Be,Xt,Wt,L,Q,Ut,ze,Gt,Ht,P,J,Kt,Y,Qt,Ae,Jt,Yt,Fe;return D=new to({}),S=new to({}),I=new Lo({props:{code:`import torch
...
`}}),K=new $e({props:{name:"convert_tokens_to_string",anchor:"transformers.BartphoTokenizer.convert_tokens_to_string",parameters:[{name:"tokens",val:""}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/bartpho/tokenization_bartpho.py#L295"}}),Q=new $e({props:{name:"create_token_type_ids_from_sequences",anchor:"transformers.BartphoTokenizer.create_token_type_ids_from_sequences",parameters:[{name:"token_ids_0",val:": typing.List[int]"},{name:"token_ids_1",val:": typing.Optional[typing.List[int]] = None"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/bartpho/tokenization_bartpho.py#L247",parametersDescription:[{anchor:"transformers.BartphoTokenizer.create_token_type_ids_from_sequences.token_ids_0",description:`<strong>token_ids_0</strong> (<code>List[int]</code>) &#x2014;
...
`,returnType:`
<p><code>List[int]</code></p>
`}}),{c(){_=n("meta"),Z=c(),f=n("h1"),g=n("a"),ue=n("span"),v(D.$$.fragment),tt=c(),fe=n("span"),ot=r("BARTpho"),Ee=c(),z=n("h2"),E=n("a"),ge=n("span"),v(S.$$.fragment),nt=c(),_e=n("span"),st=r("Overview"),xe=c(),x=n("p"),at=r("The BARTpho model was proposed in "),M=n("a"),rt=r("BARTpho: Pre-trained Sequence-to-Sequence Models for Vietnamese"),it=r(" by Nguyen Luong Tran, Duong Minh Le and Dat Quoc Nguyen."),Re=c(),ee=n("p"),lt=r("The abstract from the paper is the following:"),je=c(),te=n("p"),ke=n("em"),pt=r(`We present BARTpho with two versions \u2014 BARTpho_word and BARTpho_syllable \u2014 the first public large-scale monolingual
sequence-to-sequence models pre-trained for Vietnamese. Our BARTpho uses the \u201Clarge\u201D architecture and pre-training
scheme of the sequence-to-sequence denoising model BART, thus especially suitable for generative NLP tasks. Experiments
on a downstream task of Vietnamese text summarization show that in both automatic and human evaluations, our BARTpho
outperforms the strong baseline mBART and improves the state-of-the-art. We release BARTpho to facilitate future
research and applications of generative Vietnamese NLP tasks.`),Le=c(),oe=n("p"),ct=r("Example of use:"),Pe=c(),v(I.$$.fragment),De=c(),ne=n("p"),dt=r("Tips:"),Se=c(),se=n("ul"),N=n("li"),ht=r(`Following mBART, BARTpho uses the \u201Clarge\u201D architecture of BART with an additional layer-normalization layer on top of
both the encoder and decoder. Thus, usage examples in the `),ae=n("a"),mt=r("documentation of BART"),ut=r(`, when adapting to use
with BARTpho, should be adjusted by replacing the BART-specialized classes with the mBART-specialized counterparts.
For example:`),Me=c(),v(C.$$.fragment),Ie=c(),re=n("ul"),be=n("li"),ft=r(`This implementation is only for tokenization: \u201Cmonolingual_vocab_file\u201D consists of Vietnamese-specialized types
extracted from the pre-trained SentencePiece model \u201Cvocab_file\u201D that is available from the multilingual XLM-RoBERTa.
Other languages, if employing this pre-trained multilingual SentencePiece model \u201Cvocab_file\u201D for subword
segmentation, can reuse BartphoTokenizer with their own language-specialized \u201Cmonolingual_vocab_file\u201D.`),Ne=c(),k=n("p"),gt=r("This model was contributed by "),O=n("a"),_t=r("dqnguyen"),kt=r(". The original code can be found "),F=n("a"),bt=r("here"),vt=r("."),Ce=c(),A=n("h2"),R=n("a"),ve=n("span"),v(V.$$.fragment),Tt=c(),Te=n("span"),wt=r("BartphoTokenizer"),Oe=c(),m=n("div"),v(X.$$.fragment),yt=c(),$=n("p"),qt=r("Adapted from "),ie=n("a"),Bt=r("XLMRobertaTokenizer"),zt=r(". Based on "),W=n("a"),At=r("SentencePiece"),$t=r("."),Et=c(),U=n("p"),xt=r("This tokenizer inherits from "),le=n("a"),Rt=r("PreTrainedTokenizer"),jt=r(` which contains most of the main methods. Users should refer to
this superclass for more information regarding those methods.`),Lt=c(),b=n("div"),v(G.$$.fragment),Pt=c(),we=n("p"),Dt=r(`Build model inputs from a sequence or a pair of sequence for sequence classification tasks by concatenating and
adding special tokens. An BARTPho sequence has the following format:`),St=c(),H=n("ul"),pe=n("li"),Mt=r("single sequence: "),ye=n("code"),It=r("<s> X </s>"),Nt=c(),ce=n("li"),Ct=r("pair of sequences: "),qe=n("code"),Ot=r("<s> A </s></s> B </s>"),Ft=c(),j=n("div"),v(K.$$.fragment),Vt=c(),Be=n("p"),Xt=r("Converts a sequence of tokens (strings for sub-words) in a single string."),Wt=c(),L=n("div"),v(Q.$$.fragment),Ut=c(),ze=n("p"),Gt=r(`Create a mask from the two sequences passed to be used in a sequence-pair classification task. BARTPho does not
make use of token type ids, therefore a list of zeros is returned.`),Ht=c(),P=n("div"),v(J.$$.fragment),Kt=c(),Y=n("p"),Qt=r(`Retrieve sequence ids from a token list that has no special tokens added. This method is called when adding
special tokens using the tokenizer `),Ae=n("code"),Jt=r("prepare_for_model"),Yt=r(" method."),this.h()},l(e){const l=Mo('[data-svelte="svelte-1phssyn"]',document.head);_=s(l,"META",{name:!0,content:!0}),l.forEach(o),Z=d(e),f=s(e,"H1",{class:!0});var Ve=a(f);g=s(Ve,"A",{id:!0,class:!0,href:!0});var oo=a(g);ue=s(oo,"SPAN",{});var no=a(ue);T(D.$$.fragment,no),no.forEach(o),oo.forEach(o),tt=d(Ve),fe=s(Ve,"SPAN",{});var so=a(fe);ot=i(so,"BARTpho"),so.forEach(o),Ve.forEach(o),Ee=d(e),z=s(e,"H2",{class:!0});var Xe=a(z);E=s(Xe,"A",{id:!0,class:!0,href:!0});var ao=a(E);ge=s(ao,"SPAN",{});var ro=a(ge);T(S.$$.fragment,ro),ro.forEach(o),ao.forEach(o),nt=d(Xe),_e=s(Xe,"SPAN",{});var io=a(_e);st=i(io,"Overview"),io.forEach(o),Xe.forEach(o),xe=d(e),x=s(e,"P",{});var We=a(x);at=i(We,"The BARTpho model was proposed in "),M=s(We,"A",{href:!0,rel:!0});var lo=a(M);rt=i(lo,"BARTpho: Pre-trained Sequence-to-Sequence Models for Vietnamese"),lo.forEach(o),it=i(We," by Nguyen Luong Tran, Duong Minh Le and Dat Quoc Nguyen."),We.forEach(o),Re=d(e),ee=s(e,"P",{});var po=a(ee);lt=i(po,"The abstract from the paper is the following:"),po.forEach(o),je=d(e),te=s(e,"P",{});var co=a(te);ke=s(co,"EM",{});var ho=a(ke);pt=i(ho,`We present BARTpho with two versions \u2014 BARTpho_word and BARTpho_syllable \u2014 the first public large-scale monolingual
sequence-to-sequence models pre-trained for Vietnamese. Our BARTpho uses the \u201Clarge\u201D architecture and pre-training
scheme of the sequence-to-sequence denoising model BART, thus especially suitable for generative NLP tasks. Experiments
on a downstream task of Vietnamese text summarization show that in both automatic and human evaluations, our BARTpho
outperforms the strong baseline mBART and improves the state-of-the-art. We release BARTpho to facilitate future
research and applications of generative Vietnamese NLP tasks.`),ho.forEach(o),co.forEach(o),Le=d(e),oe=s(e,"P",{});var mo=a(oe);ct=i(mo,"Example of use:"),mo.forEach(o),Pe=d(e),T(I.$$.fragment,e),De=d(e),ne=s(e,"P",{});var uo=a(ne);dt=i(uo,"Tips:"),uo.forEach(o),Se=d(e),se=s(e,"UL",{});var fo=a(se);N=s(fo,"LI",{});var Ue=a(N);ht=i(Ue,`Following mBART, BARTpho uses the \u201Clarge\u201D architecture of BART with an additional layer-normalization layer on top of
both the encoder and decoder. Thus, usage examples in the `),ae=s(Ue,"A",{href:!0});var go=a(ae);mt=i(go,"documentation of BART"),go.forEach(o),ut=i(Ue,`, when adapting to use
with BARTpho, should be adjusted by replacing the BART-specialized classes with the mBART-specialized counterparts.
For example:`),Ue.forEach(o),fo.forEach(o),Me=d(e),T(C.$$.fragment,e),Ie=d(e),re=s(e,"UL",{});var _o=a(re);be=s(_o,"LI",{});var ko=a(be);ft=i(ko,`This implementation is only for tokenization: \u201Cmonolingual_vocab_file\u201D consists of Vietnamese-specialized types
extracted from the pre-trained SentencePiece model \u201Cvocab_file\u201D that is available from the multilingual XLM-RoBERTa.
Other languages, if employing this pre-trained multilingual SentencePiece model \u201Cvocab_file\u201D for subword
segmentation, can reuse BartphoTokenizer with their own language-specialized \u201Cmonolingual_vocab_file\u201D.`),ko.forEach(o),_o.forEach(o),Ne=d(e),k=s(e,"P",{});var de=a(k);gt=i(de,"This model was contributed by "),O=s(de,"A",{href:!0,rel:!0});var bo=a(O);_t=i(bo,"dqnguyen"),bo.forEach(o),kt=i(de,". The original code can be found "),F=s(de,"A",{href:!0,rel:!0});var vo=a(F);bt=i(vo,"here"),vo.forEach(o),vt=i(de,"."),de.forEach(o),Ce=d(e),A=s(e,"H2",{class:!0});var Ge=a(A);R=s(Ge,"A",{id:!0,class:!0,href:!0});var To=a(R);ve=s(To,"SPAN",{});var wo=a(ve);T(V.$$.fragment,wo),wo.forEach(o),To.forEach(o),Tt=d(Ge),Te=s(Ge,"SPAN",{});var yo=a(Te);wt=i(yo,"BartphoTokenizer"),yo.forEach(o),Ge.forEach(o),Oe=d(e),m=s(e,"DIV",{class:!0});var u=a(m);T(X.$$.fragment,u),yt=d(u),$=s(u,"P",{});var he=a($);qt=i(he,"Adapted from "),ie=s(he,"A",{href:!0});var qo=a(ie);Bt=i(qo,"XLMRobertaTokenizer"),qo.forEach(o),zt=i(he,". Based on "),W=s(he,"A",{href:!0,rel:!0});var Bo=a(W);At=i(Bo,"SentencePiece"),Bo.forEach(o),$t=i(he,"."),he.forEach(o),Et=d(u),U=s(u,"P",{});var He=a(U);xt=i(He,"This tokenizer inherits from "),le=s(He,"A",{href:!0});var zo=a(le);Rt=i(zo,"PreTrainedTokenizer"),zo.forEach(o),jt=i(He,` which contains most of the main methods. Users should refer to
this superclass for more information regarding those methods.`),He.forEach(o),Lt=d(u),b=s(u,"DIV",{class:!0});var me=a(b);T(G.$$.fragment,me),Pt=d(me),we=s(me,"P",{});var Ao=a(we);Dt=i(Ao,`Build model inputs from a sequence or a pair of sequence for sequence classification tasks by concatenating and
adding special tokens. An BARTPho sequence has the following format:`),Ao.forEach(o),St=d(me),H=s(me,"UL",{});var Ke=a(H);pe=s(Ke,"LI",{});var Zt=a(pe);Mt=i(Zt,"single sequence: "),ye=s(Zt,"CODE",{});var $o=a(ye);It=i($o,"<s> X </s>"),$o.forEach(o),Zt.forEach(o),Nt=d(Ke),ce=s(Ke,"LI",{});var eo=a(ce);Ct=i(eo,"pair of sequences: "),qe=s(eo,"CODE",{});var Eo=a(qe);Ot=i(Eo,"<s> A </s></s> B </s>"),Eo.forEach(o),eo.forEach(o),Ke.forEach(o),me.forEach(o),Ft=d(u),j=s(u,"DIV",{class:!0});var Qe=a(j);T(K.$$.fragment,Qe),Vt=d(Qe),Be=s(Qe,"P",{});var xo=a(Be);Xt=i(xo,"Converts a sequence of tokens (strings for sub-words) in a single string."),xo.forEach(o),Qe.forEach(o),Wt=d(u),L=s(u,"DIV",{class:!0});var Je=a(L);T(Q.$$.fragment,Je),Ut=d(Je),ze=s(Je,"P",{});var Ro=a(ze);Gt=i(Ro,`Create a mask from the two sequences passed to be used in a sequence-pair classification task. BARTPho does not
make use of token type ids, therefore a list of zeros is returned.`),Ro.forEach(o),Je.forEach(o),Ht=d(u),P=s(u,"DIV",{class:!0});var Ye=a(P);T(J.$$.fragment,Ye),Kt=d(Ye),Y=s(Ye,"P",{});var Ze=a(Y);Qt=i(Ze,`Retrieve sequence ids from a token list that has no special tokens added. This method is called when adding
special tokens using the tokenizer `),Ae=s(Ze,"CODE",{});var jo=a(Ae);Jt=i(jo,"prepare_for_model"),jo.forEach(o),Yt=i(Ze," method."),Ze.forEach(o),Ye.forEach(o),u.forEach(o),this.h()},h(){p(_,"name","hf:doc:metadata"),p(_,"content",JSON.stringify(Co)),p(g,"id","bartpho"),p(g,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),p(g,"href","#bartpho"),p(f,"class","relative group"),p(E,"id","overview"),p(E,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),p(E,"href","#overview"),p(z,"class","relative group"),p(M,"href","https://arxiv.org/abs/2109.09701"),p(M,"rel","nofollow"),p(ae,"href","bart"),p(O,"href","https://huggingface.co/dqnguyen"),p(O,"rel","nofollow"),p(F,"href","https://github.com/VinAIResearch/BARTpho"),p(F,"rel","nofollow"),p(R,"id","transformers.BartphoTokenizer"),p(R,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),p(R,"href","#transformers.BartphoTokenizer"),p(A,"class","relative group"),p(ie,"href","/docs/transformers/main/en/model_doc/xlm-roberta#transformers.XLMRobertaTokenizer"),p(W,"href","https://github.com/google/sentencepiece"),p(W,"rel","nofollow"),p(le,"href","/docs/transformers/main/en/main_classes/tokenizer#transformers.PreTrainedTokenizer"),p(b,"class","docstring"),p(j,"class","docstring"),p(L,"class","docstring"),p(P,"class","docstring"),p(m,"class","docstring")},m(e,l){t(document.head,_),h(e,Z,l),h(e,f,l),t(f,g),t(g,ue),w(D,ue,null),t(f,tt),t(f,fe),t(fe,ot),h(e,Ee,l),h(e,z,l),t(z,E),t(E,ge),w(S,ge,null),t(z,nt),t(z,_e),t(_e,st),h(e,xe,l),h(e,x,l),t(x,at),t(x,M),t(M,rt),t(x,it),h(e,Re,l),h(e,ee,l),t(ee,lt),h(e,je,l),h(e,te,l),t(te,ke),t(ke,pt),h(e,Le,l),h(e,oe,l),t(oe,ct),h(e,Pe,l),w(I,e,l),h(e,De,l),h(e,ne,l),t(ne,dt),h(e,Se,l),h(e,se,l),t(se,N),t(N,ht),t(N,ae),t(ae,mt),t(N,ut),h(e,Me,l),w(C,e,l),h(e,Ie,l),h(e,re,l),t(re,be),t(be,ft),h(e,Ne,l),h(e,k,l),t(k,gt),t(k,O),t(O,_t),t(k,kt),t(k,F),t(F,bt),t(k,vt),h(e,Ce,l),h(e,A,l),t(A,R),t(R,ve),w(V,ve,null),t(A,Tt),t(A,Te),t(Te,wt),h(e,Oe,l),h(e,m,l),w(X,m,null),t(m,yt),t(m,$),t($,qt),t($,ie),t(ie,Bt),t($,zt),t($,W),t(W,At),t($,$t),t(m,Et),t(m,U),t(U,xt),t(U,le),t(le,Rt),t(U,jt),t(m,Lt),t(m,b),w(G,b,null),t(b,Pt),t(b,we),t(we,Dt),t(b,St),t(b,H),t(H,pe),t(pe,Mt),t(pe,ye),t(ye,It),t(H,Nt),t(H,ce),t(ce,Ct),t(ce,qe),t(qe,Ot),t(m,Ft),t(m,j),w(K,j,null),t(j,Vt),t(j,Be),t(Be,Xt),t(m,Wt),t(m,L),w(Q,L,null),t(L,Ut),t(L,ze),t(ze,Gt),t(m,Ht),t(m,P),w(J,P,null),t(P,Kt),t(P,Y),t(Y,Qt),t(Y,Ae),t(Ae,Jt),t(Y,Yt),Fe=!0},p:Io,i(e){Fe||(y(D.$$.fragment,e),y(S.$$.fragment,e),y(I.$$.fragment,e),y(C.$$.fragment,e),y(V.$$.fragment,e),y(X.$$.fragment,e),y(G.$$.fragment,e),y(K.$$.fragment,e),y(Q.$$.fragment,e),y(J.$$.fragment,e),Fe=!0)},o(e){q(D.$$.fragment,e),q(S.$$.fragment,e),q(I.$$.fragment,e),q(C.$$.fragment,e),q(V.$$.fragment,e),q(X.$$.fragment,e),q(G.$$.fragment,e),q(K.$$.fragment,e),q(Q.$$.fragment,e),q(J.$$.fragment,e),Fe=!1},d(e){o(_),e&&o(Z),e&&o(f),B(D),e&&o(Ee),e&&o(z),B(S),e&&o(xe),e&&o(x),e&&o(Re),e&&o(ee),e&&o(je),e&&o(te),e&&o(Le),e&&o(oe),e&&o(Pe),B(I,e),e&&o(De),e&&o(ne),e&&o(Se),e&&o(se),e&&o(Me),B(C,e),e&&o(Ie),e&&o(re),e&&o(Ne),e&&o(k),e&&o(Ce),e&&o(A),B(V),e&&o(Oe),e&&o(m),B(X),B(G),B(K),B(Q),B(J)}}}const Co={local:"bartpho",sections:[{local:"overview",title:"Overview"},{local:"transformers.BartphoTokenizer",title:"BartphoTokenizer"}],title:"BARTpho"};function Oo(et,_,Z){let{fw:f}=_;return et.$$set=g=>{"fw"in g&&Z(0,f=g.fw)},[f]}class Go extends Po{constructor(_){super();Do(this,_,Oo,No,So,{fw:0})}}export{Go as default,Co as metadata};
