import{S as pT,i as fT,s as gT,e as a,k as c,w as v,t as n,Y as Ot,M as uT,c as r,d as o,m,a as i,x as T,h as s,Z as Pt,b as _,F as e,g as f,y,q as $,o as L,B as x,v as _T,L as je}from"../../chunks/vendor-6b77c823.js";import{T as Ae}from"../../chunks/Tip-39098574.js";import{D as B}from"../../chunks/Docstring-1088f2fb.js";import{C as Le}from"../../chunks/CodeBlock-3a8b25a8.js";import{I as Oe}from"../../chunks/IconCopyLink-7a11ce68.js";import{E as Ce}from"../../chunks/ExampleCodeBlock-5212b321.js";function wT(M){let l,k,h,p,b;return p=new Le({props:{code:`from transformers import LongformerConfig, LongformerModel
...
first positional argument :`),Fe.forEach(o),X=m(w),z=r(w,"UL",{});var O=i(z);j=r(O,"LI",{});var V=i(j);ne=s(V,"a single Tensor with "),U=r(V,"CODE",{});var Me=i(U);de=s(Me,"input_ids"),Me.forEach(o),se=s(V," only and nothing else: "),W=r(V,"CODE",{});var ye=i(W);ge=s(ye,"model(inputs_ids)"),ye.forEach(o),V.forEach(o),ce=m(O),C=r(O,"LI",{});var I=i(C);ue=s(I,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),Q=r(I,"CODE",{});var ke=i(Q);ae=s(ke,"model([input_ids, attention_mask])"),ke.forEach(o),K=s(I," or "),H=r(I,"CODE",{});var ve=i(H);re=s(ve,"model([input_ids, attention_mask, token_type_ids])"),ve.forEach(o),I.forEach(o),_e=m(O),N=r(O,"LI",{});var te=i(N);ie=s(te,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),R=r(te,"CODE",{});var Ee=i(R);we=s(Ee,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),Ee.forEach(o),te.forEach(o),O.forEach(o)},m(w,F){f(w,l,F),e(l,k),f(w,h,F),f(w,p,F),e(p,b),e(b,d),e(p,u),e(p,E),e(E,he),f(w,J,F),f(w,q,F),e(q,Z),e(q,S),e(S,ee),e(q,pe),e(q,D),e(D,fe),e(q,le),f(w,G,F),f(w,P,F),e(P,oe),f(w,X,F),f(w,z,F),e(z,j),e(j,ne),e(j,U),e(U,de),e(j,se),e(j,W),e(W,ge),e(z,ce),e(z,C),e(C,ue),e(C,Q),e(Q,ae),e(C,K),e(C,H),e(H,re),e(z,_e),e(z,N),e(N,ie),e(N,R),e(R,we)},d(w){w&&o(l),w&&o(h),w&&o(p),w&&o(J),w&&o(q),w&&o(G),w&&o(P),w&&o(X),w&&o(z)}}}function QT(M){let l,k,h,p,b;return{c(){l=a("p"),k=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),h=a("code"),p=n("Module"),b=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(d){l=r(d,"P",{});var u=i(l);k=s(u,"Although the recipe for forward pass needs to be defined within this function, one should call the "),h=r(u,"CODE",{});var E=i(h);p=s(E,"Module"),E.forEach(o),b=s(u,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
parent class for more information.`),Bh=c(),v(Wt.$$.fragment),Ud=c(),Do=a("h2"),Bt=a("a"),gi=a("span"),v(es.$$.fragment),Qh=c(),ui=a("span"),Uh=n("LongformerTokenizer"),Hd=c(),uo=a("div"),v(os.$$.fragment),Hh=c(),_i=a("p"),Rh=n("Construct a Longformer tokenizer."),Vh=c(),Qt=a("p"),nr=a("a"),Gh=n("LongformerTokenizer"),Kh=n(" is identical to "),sr=a("a"),Jh=n("RobertaTokenizer"),Xh=n(`. Refer to the superclass for usage examples and
...
kernel to be memory and compute efficient.`),lf=c(),ao=a("div"),v(Fs.$$.fragment),df=c(),at=a("p"),cf=n("The "),dr=a("a"),mf=n("LongformerModel"),hf=n(" forward method, overrides the "),Wi=a("code"),pf=n("__call__"),ff=n(" special method."),gf=c(),v(Gt.$$.fragment),uf=c(),v(Kt.$$.fragment),mc=c(),rt=a("h2"),Jt=a("a"),Bi=a("span"),v(Ms.$$.fragment),_f=c(),Qi=a("span"),wf=n("LongformerForMaskedLM"),hc=c(),Re=a("div"),v(Es.$$.fragment),kf=c(),qs=a("p"),bf=n("Longformer Model with a "),Ui=a("code"),vf=n("language modeling"),Tf=n(" head on top."),yf=c(),zs=a("p"),$f=n("This model inherits from "),cr=a("a"),Lf=n("PreTrainedModel"),xf=n(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Ff=c(),Cs=a("p"),Mf=n("This model is also a PyTorch "),js=a("a"),Ef=n("torch.nn.Module"),qf=n(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),zf=c(),Qe=a("div"),v(Os.$$.fragment),Cf=c(),it=a("p"),jf=n("The "),mr=a("a"),Of=n("LongformerForMaskedLM"),Pf=n(" forward method, overrides the "),Hi=a("code"),Nf=n("__call__"),Af=n(" special method."),If=c(),v(Xt.$$.fragment),Sf=c(),v(Yt.$$.fragment),Df=c(),Ri=a("p"),Wf=n("Let\u2019s try a very long input."),Bf=c(),v(Zt.$$.fragment),pc=c(),lt=a("h2"),en=a("a"),Vi=a("span"),v(Ps.$$.fragment),Qf=c(),Gi=a("span"),Uf=n("LongformerForSequenceClassification"),fc=c(),Ve=a("div"),v(Ns.$$.fragment),Hf=c(),Ki=a("p"),Rf=n(`Longformer Model transformer with a sequence classification/regression head on top (a linear layer on top of the
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),og=c(),Ne=a("div"),v(Ds.$$.fragment),tg=c(),dt=a("p"),ng=n("The "),pr=a("a"),sg=n("LongformerForSequenceClassification"),ag=n(" forward method, overrides the "),Ji=a("code"),rg=n("__call__"),ig=n(" special method."),lg=c(),v(on.$$.fragment),dg=c(),v(tn.$$.fragment),cg=c(),v(nn.$$.fragment),mg=c(),v(sn.$$.fragment),hg=c(),v(an.$$.fragment),gc=c(),ct=a("h2"),rn=a("a"),Xi=a("span"),v(Ws.$$.fragment),pg=c(),Yi=a("span"),fg=n("LongformerForMultipleChoice"),uc=c(),Ge=a("div"),v(Bs.$$.fragment),gg=c(),Zi=a("p"),ug=n(`Longformer Model with a multiple choice classification head on top (a linear layer on top of the pooled output and
...
behavior.`),Su=c(),v(wn.$$.fragment),Du=c(),wt=a("p"),Wu=n("This class copies code from "),vr=a("a"),Bu=n("TFRobertaModel"),Qu=n(` and overwrites standard self-attention with longformer
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Aw=c(),v(Nn.$$.fragment),Iw=c(),to=a("div"),v(Aa.$$.fragment),Sw=c(),Mt=a("p"),Dw=n("The "),qr=a("a"),Ww=n("TFLongformerForTokenClassification"),Bw=n(" forward method, overrides the "),zl=a("code"),Qw=n("__call__"),Uw=n(" special method."),Hw=c(),v(An.$$.fragment),Rw=c(),v(In.$$.fragment),Vw=c(),v(Sn.$$.fragment),zc=c(),Et=a("h2"),Dn=a("a"),Cl=a("span"),v(Ia.$$.fragment),Gw=c(),jl=a("span"),Kw=n("TFLongformerForMultipleChoice"),Cc=c(),Be=a("div"),v(Sa.$$.fragment),Jw=c(),Ol=a("p"),Xw=n(`Longformer Model with a multiple choice classification head on top (a linear layer on top of the pooled output and
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),tk=c(),Wa=a("p"),nk=n("This model is also a "),Ba=a("a"),sk=n("tf.keras.Model"),ak=n(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),rk=c(),v(Wn.$$.fragment),ik=c(),lo=a("div"),v(Qa.$$.fragment),lk=c(),qt=a("p"),dk=n("The "),Cr=a("a"),ck=n("TFLongformerForMultipleChoice"),mk=n(" forward method, overrides the "),Pl=a("code"),hk=n("__call__"),pk=n(" special method."),fk=c(),v(Bn.$$.fragment),gk=c(),v(Qn.$$.fragment),this.h()},l(t){const g=uT('[data-svelte="svelte-1phssyn"]',document.head);l=r(g,"META",{name:!0,content:!0}),g.forEach(o),k=m(t),h=r(t,"H1",{class:!0});var Ua=i(h);p=r(Ua,"A",{id:!0,class:!0,href:!0});var Nl=i(p);b=r(Nl,"SPAN",{});var Al=i(b);T(d.$$.fragment,Al),Al.forEach(o),Nl.forEach(o),u=m(Ua),E=r(Ua,"SPAN",{});var Il=i(E);he=s(Il,"Longformer"),Il.forEach(o),Ua.forEach(o),J=m(t),q=r(t,"H2",{class:!0});var Ha=i(q);Z=r(Ha,"A",{id:!0,class:!0,href:!0});var Sl=i(Z);S=r(Sl,"SPAN",{});var Dl=i(S);T(ee.$$.fragment,Dl),Dl.forEach(o),Sl.forEach(o),pe=m(Ha),D=r(Ha,"SPAN",{});var Wl=i(D);fe=s(Wl,"Overview"),Wl.forEach(o),Ha.forEach(o),le=m(t),G=r(t,"P",{});var Ra=i(G);P=s(Ra,"The Longformer model was presented in "),oe=r(Ra,"A",{href:!0,rel:!0});var Bl=i(oe);X=s(Bl,"Longformer: The Long-Document Transformer"),Bl.forEach(o),z=s(Ra," by Iz Beltagy, Matthew E. Peters, Arman Cohan."),Ra.forEach(o),j=m(t),ne=r(t,"P",{});var Ql=i(ne);U=s(Ql,"The abstract from the paper is the following:"),Ql.forEach(o),de=m(t),se=r(t,"P",{});var Ul=i(se);W=r(Ul,"EM",{});var Hl=i(W);ge=s(Hl,`Transformer-based models are unable to process long sequences due to their self-attention operation, which scales
quadratically with the sequence length. To address this limitation, we introduce the Longformer with an attention
mechanism that scales linearly with sequence length, making it easy to process documents of thousands of tokens or
longer. Longformer\u2019s attention mechanism is a drop-in replacement for the standard self-attention and combines a local
windowed attention with a task motivated global attention. Following prior work on long-sequence transformers, we
...
trained and should be used as follows:`),md.forEach(o),Wd=m(t),T(Jn.$$.fragment,t),Bd=m(t),No=r(t,"H2",{class:!0});var Ac=i(No);Dt=r(Ac,"A",{id:!0,class:!0,href:!0});var yk=i(Dt);pi=r(yk,"SPAN",{});var $k=i(pi);T(Xn.$$.fragment,$k),$k.forEach(o),yk.forEach(o),Th=m(Ac),fi=r(Ac,"SPAN",{});var Lk=i(fi);yh=s(Lk,"LongformerConfig"),Lk.forEach(o),Ac.forEach(o),Qd=m(t),He=r(t,"DIV",{class:!0});var yo=i(He);T(Yn.$$.fragment,yo),$h=m(yo),Ao=r(yo,"P",{});var jr=i(Ao);Lh=s(jr,"This is the configuration class to store the configuration of a "),Ya=r(jr,"A",{href:!0});var xk=i(Ya);xh=s(xk,"LongformerModel"),xk.forEach(o),Fh=s(jr," or a "),Za=r(jr,"A",{href:!0});var Fk=i(Za);Mh=s(Fk,"TFLongformerModel"),Fk.forEach(o),Eh=s(jr,`. It
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),dm.forEach(o),zf=m($o),Qe=r($o,"DIV",{class:!0});var co=i(Qe);T(Os.$$.fragment,co),Cf=m(co),it=r(co,"P",{});var Dr=i(it);jf=s(Dr,"The "),mr=r(Dr,"A",{href:!0});var $b=i(mr);Of=s($b,"LongformerForMaskedLM"),$b.forEach(o),Pf=s(Dr," forward method, overrides the "),Hi=r(Dr,"CODE",{});var Lb=i(Hi);Nf=s(Lb,"__call__"),Lb.forEach(o),Af=s(Dr," special method."),Dr.forEach(o),If=m(co),T(Xt.$$.fragment,co),Sf=m(co),T(Yt.$$.fragment,co),Df=m(co),Ri=r(co,"P",{});var xb=i(Ri);Wf=s(xb,"Let\u2019s try a very long input."),xb.forEach(o),Bf=m(co),T(Zt.$$.fragment,co),co.forEach(o),$o.forEach(o),pc=m(t),lt=r(t,"H2",{class:!0});var cm=i(lt);en=r(cm,"A",{id:!0,class:!0,href:!0});var Fb=i(en);Vi=r(Fb,"SPAN",{});var Mb=i(Vi);T(Ps.$$.fragment,Mb),Mb.forEach(o),Fb.forEach(o),Qf=m(cm),Gi=r(cm,"SPAN",{});var Eb=i(Gi);Uf=s(Eb,"LongformerForSequenceClassification"),Eb.forEach(o),cm.forEach(o),fc=m(t),Ve=r(t,"DIV",{class:!0});var Lo=i(Ve);T(Ns.$$.fragment,Lo),Hf=m(Lo),Ki=r(Lo,"P",{});var qb=i(Ki);Rf=s(qb,`Longformer Model transformer with a sequence classification/regression head on top (a linear layer on top of the
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),hm.forEach(o),og=m(Lo),Ne=r(Lo,"DIV",{class:!0});var so=i(Ne);T(Ds.$$.fragment,so),tg=m(so),dt=r(so,"P",{});var Wr=i(dt);ng=s(Wr,"The "),pr=r(Wr,"A",{href:!0});var jb=i(pr);sg=s(jb,"LongformerForSequenceClassification"),jb.forEach(o),ag=s(Wr," forward method, overrides the "),Ji=r(Wr,"CODE",{});var Ob=i(Ji);rg=s(Ob,"__call__"),Ob.forEach(o),ig=s(Wr," special method."),Wr.forEach(o),lg=m(so),T(on.$$.fragment,so),dg=m(so),T(tn.$$.fragment,so),cg=m(so),T(nn.$$.fragment,so),mg=m(so),T(sn.$$.fragment,so),hg=m(so),T(an.$$.fragment,so),so.forEach(o),Lo.forEach(o),gc=m(t),ct=r(t,"H2",{class:!0});var pm=i(ct);rn=r(pm,"A",{id:!0,class:!0,href:!0});var Pb=i(rn);Xi=r(Pb,"SPAN",{});var Nb=i(Xi);T(Ws.$$.fragment,Nb),Nb.forEach(o),Pb.forEach(o),pg=m(pm),Yi=r(pm,"SPAN",{});var Ab=i(Yi);fg=s(Ab,"LongformerForMultipleChoice"),Ab.forEach(o),pm.forEach(o),uc=m(t),Ge=r(t,"DIV",{class:!0});var xo=i(Ge);T(Bs.$$.fragment,xo),gg=m(xo),Zi=r(xo,"P",{});var Ib=i(Zi);ug=s(Ib,`Longformer Model with a multiple choice classification head on top (a linear layer on top of the pooled output and
a softmax) e.g. for RocStories/SWAG tasks.`),Ib.forEach(o),_g=m(xo),Qs=r(xo,"P",{});var fm=i(Qs);wg=s(fm,"This model inherits from "),fr=r(fm,"A",{href:!0});var Sb=i(fr);kg=s(Sb,"PreTrainedModel"),Sb.forEach(o),bg=s(fm,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),gm.forEach(o),Lg=m(xo),ro=r(xo,"DIV",{class:!0});var Hn=i(ro);T(Rs.$$.fragment,Hn),xg=m(Hn),mt=r(Hn,"P",{});var Br=i(mt);Fg=s(Br,"The "),gr=r(Br,"A",{href:!0});var Wb=i(gr);Mg=s(Wb,"LongformerForMultipleChoice"),Wb.forEach(o),Eg=s(Br," forward method, overrides the "),el=r(Br,"CODE",{});var Bb=i(el);qg=s(Bb,"__call__"),Bb.forEach(o),zg=s(Br," special method."),Br.forEach(o),Cg=m(Hn),T(ln.$$.fragment,Hn),jg=m(Hn),T(dn.$$.fragment,Hn),Hn.forEach(o),xo.forEach(o),_c=m(t),ht=r(t,"H2",{class:!0});var um=i(ht);cn=r(um,"A",{id:!0,class:!0,href:!0});var Qb=i(cn);ol=r(Qb,"SPAN",{});var Ub=i(ol);T(Vs.$$.fragment,Ub),Ub.forEach(o),Qb.forEach(o),Og=m(um),tl=r(um,"SPAN",{});var Hb=i(tl);Pg=s(Hb,"LongformerForTokenClassification"),Hb.forEach(o),um.forEach(o),wc=m(t),Ke=r(t,"DIV",{class:!0});var Fo=i(Ke);T(Gs.$$.fragment,Fo),Ng=m(Fo),nl=r(Fo,"P",{});var Rb=i(nl);Ag=s(Rb,`Longformer Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g.
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),$m.forEach(o),Su=m(Ue),T(wn.$$.fragment,Ue),Du=m(Ue),wt=r(Ue,"P",{});var Rr=i(wt);Wu=s(Rr,"This class copies code from "),vr=r(Rr,"A",{href:!0});var hv=i(vr);Bu=s(hv,"TFRobertaModel"),hv.forEach(o),Qu=s(Rr,` and overwrites standard self-attention with longformer
self-attention to provide the ability to process long sequences following the self-attention approach described in
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),zm.forEach(o),W_=m(ho),ya=r(ho,"P",{});var Cm=i(ya);B_=s(Cm,"This model is also a "),$a=r(Cm,"A",{href:!0,rel:!0});var zv=i($a);Q_=s(zv,"tf.keras.Model"),zv.forEach(o),U_=s(Cm,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Pm.forEach(o),fw=m(po),T(zn.$$.fragment,po),gw=m(po),oo=r(po,"DIV",{class:!0});var Co=i(oo);T(za.$$.fragment,Co),uw=m(Co),xt=r(Co,"P",{});var Yr=i(xt);_w=s(Yr,"The "),Mr=r(Yr,"A",{href:!0});var Dv=i(Mr);ww=s(Dv,"TFLongformerForSequenceClassification"),Dv.forEach(o),kw=s(Yr," forward method, overrides the "),Fl=r(Yr,"CODE",{});var Wv=i(Fl);bw=s(Wv,"__call__"),Wv.forEach(o),vw=s(Yr," special method."),Yr.forEach(o),Tw=m(Co),T(Cn.$$.fragment,Co),yw=m(Co),T(jn.$$.fragment,Co),$w=m(Co),T(On.$$.fragment,Co),Co.forEach(o),po.forEach(o),Ec=m(t),Ft=r(t,"H2",{class:!0});var Nm=i(Ft);Pn=r(Nm,"A",{id:!0,class:!0,href:!0});var Bv=i(Pn);Ml=r(Bv,"SPAN",{});var Qv=i(Ml);T(Ca.$$.fragment,Qv),Qv.forEach(o),Bv.forEach(o),Lw=m(Nm),El=r(Nm,"SPAN",{});var Uv=i(El);xw=s(Uv,"TFLongformerForTokenClassification"),Uv.forEach(o),Nm.forEach(o),qc=m(t),We=r(t,"DIV",{class:!0});var fo=i(We);T(ja.$$.fragment,fo),Fw=m(fo),ql=r(fo,"P",{});var Hv=i(ql);Mw=s(Hv,`Longformer Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g.
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Im.forEach(o),Aw=m(fo),T(Nn.$$.fragment,fo),Iw=m(fo),to=r(fo,"DIV",{class:!0});var jo=i(to);T(Aa.$$.fragment,jo),Sw=m(jo),Mt=r(jo,"P",{});var Zr=i(Mt);Dw=s(Zr,"The "),qr=r(Zr,"A",{href:!0});var Gv=i(qr);Ww=s(Gv,"TFLongformerForTokenClassification"),Gv.forEach(o),Bw=s(Zr," forward method, overrides the "),zl=r(Zr,"CODE",{});var Kv=i(zl);Qw=s(Kv,"__call__"),Kv.forEach(o),Uw=s(Zr," special method."),Zr.forEach(o),Hw=m(jo),T(An.$$.fragment,jo),Rw=m(jo),T(In.$$.fragment,jo),Vw=m(jo),T(Sn.$$.fragment,jo),jo.forEach(o),fo.forEach(o),zc=m(t),Et=r(t,"H2",{class:!0});var Sm=i(Et);Dn=r(Sm,"A",{id:!0,class:!0,href:!0});var Jv=i(Dn);Cl=r(Jv,"SPAN",{});var Xv=i(Cl);T(Ia.$$.fragment,Xv),Xv.forEach(o),Jv.forEach(o),Gw=m(Sm),jl=r(Sm,"SPAN",{});var Yv=i(jl);Kw=s(Yv,"TFLongformerForMultipleChoice"),Yv.forEach(o),Sm.forEach(o),Cc=m(t),Be=r(t,"DIV",{class:!0});var go=i(Be);T(Sa.$$.fragment,go),Jw=m(go),Ol=r(go,"P",{});var Zv=i(Ol);Xw=s(Zv,`Longformer Model with a multiple choice classification head on top (a linear layer on top of the pooled output and
