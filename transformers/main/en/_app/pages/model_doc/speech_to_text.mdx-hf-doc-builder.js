...
methods above for more information.`),this.h()},l(D){c=r(D,"P",{});var C=i(c);b=s(C,"This class method is simply calling "),_=r(C,"A",{href:!0});var M=i(_);g=s(M,"save_pretrained()"),M.forEach(t),v=s(C,` and
`),d=r(C,"A",{href:!0});var I=i(d);m=s(I,"save_pretrained()"),I.forEach(t),q=s(C,`. Please refer to the docstrings of the
...
<span class="hljs-meta">&gt;&gt;&gt; </span>transcription = processor.batch_decode(generated_ids)`}}),{c(){c=a("p"),b=n("Example:"),_=p(),y(g.$$.fragment)},l(d){c=r(d,"P",{});var m=i(c);b=s(m,"Example:"),m.forEach(t),_=h(d),x(g.$$.fragment,d)},m(d,m){u(d,c,m),e(c,b),u(d,_,m),k(g,d,m),v=!0},p:la,i(d){v||(w(g.$$.fragment,d),v=!0)},o(d){S(g.$$.fragment,d),v=!1},d(d){d&&t(c),d&&t(_),$(g,d)}}}function sh(j){let c,b,_,g,v,d,m,q,D,C,M,I,ne,E,Ge,Q,Ue,Ce,A,We,se,ae,Re,re,ie,Ve,de,le,He,ce,Se,N,L,Y,pe,he,Be,me,ue,Ke,U,je,W,ee,$e,K,Je,Ee,Z,Me,H,Ye,fe,R,Xe,B,O,Qe,T,F,ht,te,mt,ut,z,ft,_t,Ae,gt,Tt,X,P,vt,Ze,_e,bt,et,tt,yt,ge,xt,cr,ls,pr,hr,cs,mr,ur,yo,fr,_r,ps,gr,ca,qn,hs,Tr,pa,xo,ha,Fn,ko,ms,vr,br,Te,yr,us,xr,kr,fs,wr,Sr,_s,$r,Er,gs,qr,Fr,Ts,zr,Pr,ma,wo,ua,Dt,Cr,So,jr,Mr,fa,kt,It,vs,$o,Ar,bs,Nr,_a,qe,Eo,Dr,wt,Ir,zn,Lr,Or,qo,Gr,Ur,Wr,St,Rr,Pn,Vr,Hr,Cn,Br,Kr,Jr,Lt,ga,$t,Ot,ys,Fo,Yr,xs,Xr,Ta,J,zo,Qr,ks,Zr,ei,Po,ti,jn,oi,ni,si,Gt,Co,ai,ws,ri,ii,Ut,jo,di,Mo,li,Ss,ci,pi,hi,at,Ao,mi,Mn,ui,An,fi,_i,$s,gi,Ti,Nn,No,va,Et,Wt,Es,Do,vi,qs,bi,ba,ve,Io,yi,Fs,xi,ki,Lo,wi,Dn,Si,$i,Ei,zs,qi,Fi,Rt,Oo,zi,Ps,Pi,ya,qt,Vt,Cs,Go,Ci,js,ji,xa,V,Uo,Mi,Ms,Ai,Ni,ke,In,Di,Ii,Ln,Li,Oi,On,Gi,Ui,Wo,As,Wi,Ri,Vi,Gn,Hi,Bi,Ki,Ht,Ro,Ji,ot,Yi,Vo,Ns,Xi,Qi,Zi,Ds,ed,td,Ho,Is,od,nd,sd,ad,rt,Bo,rd,Ls,id,dd,Bt,ld,it,Ko,cd,Jo,pd,Un,hd,md,ud,Kt,fd,Jt,Yo,_d,Xo,gd,Wn,Td,vd,bd,Yt,Qo,yd,Zo,xd,Rn,kd,wd,ka,Ft,Xt,Os,en,Sd,Gs,$d,wa,Fe,tn,Ed,on,qd,Vn,Fd,zd,Pd,nn,Cd,sn,jd,Md,Ad,Ne,an,Nd,zt,Dd,Hn,Id,Ld,Us,Od,Gd,Ud,Qt,Wd,Zt,Sa,Pt,eo,Ws,rn,Rd,Rs,Vd,$a,ze,dn,Hd,ln,Bd,Bn,Kd,Jd,Yd,cn,Xd,pn,Qd,Zd,el,De,hn,tl,Ct,ol,Kn,nl,sl,Vs,al,rl,il,to,dl,oo,Ea,jt,no,Hs,mn,ll,Bs,cl,qa,be,un,pl,fn,hl,Jn,ml,ul,fl,_n,_l,gn,gl,Tl,vl,so,bl,Ie,Tn,yl,Mt,xl,Yn,kl,wl,Ks,Sl,$l,El,ao,ql,ro,Fa,At,io,Js,vn,Fl,Ys,zl,za,ye,bn,Pl,yn,Cl,Xn,jl,Ml,Al,xn,Nl,kn,Dl,Il,Ll,lo,Ol,Le,wn,Gl,Nt,Ul,Qn,Wl,Rl,Xs,Vl,Hl,Bl,co,Kl,po,Pa;return d=new st({}),E=new st({}),K=new st({}),xo=new En({props:{code:`import torch
from transformers import Speech2TextProcessor, Speech2TextForConditionalGeneration
from datasets import load_dataset
...
documentation from `),Cn=a("a"),Br=n("PretrainedConfig"),Kr=n(" for more information."),Jr=p(),y(Lt.$$.fragment),ga=p(),$t=a("h2"),Ot=a("a"),ys=a("span"),y(Fo.$$.fragment),Yr=p(),xs=a("span"),Xr=n("Speech2TextTokenizer"),Ta=p(),J=a("div"),y(zo.$$.fragment),Qr=p(),ks=a("p"),Zr=n("Construct an Speech2Text tokenizer."),ei=p(),Po=a("p"),ti=n("This tokenizer inherits from "),jn=a("a"),oi=n("PreTrainedTokenizer"),ni=n(` which contains some of the main methods. Users should refer to
...
behavior.`),vl=p(),y(so.$$.fragment),bl=p(),Ie=a("div"),y(Tn.$$.fragment),yl=p(),Mt=a("p"),xl=n("The "),Yn=a("a"),kl=n("TFSpeech2TextModel"),wl=n(" forward method, overrides the "),Ks=a("code"),Sl=n("__call__"),$l=n(" special method."),El=p(),y(ao.$$.fragment),ql=p(),y(ro.$$.fragment),Fa=p(),At=a("h2"),io=a("a"),Js=a("span"),y(vn.$$.fragment),Fl=p(),Ys=a("span"),zl=n("TFSpeech2TextForConditionalGeneration"),za=p(),ye=a("div"),y(bn.$$.fragment),Pl=p(),yn=a("p"),Cl=n(`The Speech2Text Model with a language modeling head. Can be used for summarization.
...
signal. It\u2019s a transformer-based seq2seq model, so the transcripts/translations are generated autoregressively. The
`),fe=r(ja,"CODE",{});var sc=i(fe);R=s(sc,"generate()"),sc.forEach(t),Xe=s(ja," method can be used for inference."),ja.forEach(t),B=h(o),O=r(o,"P",{});var dt=i(O);Qe=s(dt,"The "),T=r(dt,"A",{href:!0});var ac=i(T);F=s(ac,"Speech2TextFeatureExtractor"),ac.forEach(t),ht=s(dt,` class is responsible for extracting the log-mel filter-bank
...
documentation from `),Cn=r(ts,"A",{href:!0});var Cc=i(Cn);Br=s(Cc,"PretrainedConfig"),Cc.forEach(t),Kr=s(ts," for more information."),ts.forEach(t),Jr=h(ho),x(Lt.$$.fragment,ho),ho.forEach(t),ga=h(o),$t=r(o,"H2",{class:!0});var Da=i($t);Ot=r(Da,"A",{id:!0,class:!0,href:!0});var jc=i(Ot);ys=r(jc,"SPAN",{});var Mc=i(ys);x(Fo.$$.fragment,Mc),Mc.forEach(t),jc.forEach(t),Yr=h(Da),xs=r(Da,"SPAN",{});var Ac=i(xs);Xr=s(Ac,"Speech2TextTokenizer"),Ac.forEach(t),Da.forEach(t),Ta=h(o),J=r(o,"DIV",{class:!0});var we=i(J);x(zo.$$.fragment,we),Qr=h(we),ks=r(we,"P",{});var Nc=i(ks);Zr=s(Nc,"Construct an Speech2Text tokenizer."),Nc.forEach(t),ei=h(we),Po=r(we,"P",{});var Ia=i(Po);ti=s(Ia,"This tokenizer inherits from "),jn=r(Ia,"A",{href:!0});var Dc=i(jn);oi=s(Dc,"PreTrainedTokenizer"),Dc.forEach(t),ni=s(Ia,` which contains some of the main methods. Users should refer to
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),rr.forEach(t),vl=h(ct),x(so.$$.fragment,ct),bl=h(ct),Ie=r(ct,"DIV",{class:!0});var To=i(Ie);x(Tn.$$.fragment,To),yl=h(To),Mt=r(To,"P",{});var is=i(Mt);xl=s(is,"The "),Yn=r(is,"A",{href:!0});var Pp=i(Yn);kl=s(Pp,"TFSpeech2TextModel"),Pp.forEach(t),wl=s(is," forward method, overrides the "),Ks=r(is,"CODE",{});var Cp=i(Ks);Sl=s(Cp,"__call__"),Cp.forEach(t),$l=s(is," special method."),is.forEach(t),El=h(To),x(ao.$$.fragment,To),ql=h(To),x(ro.$$.fragment,To),To.forEach(t),ct.forEach(t),Fa=h(o),At=r(o,"H2",{class:!0});var ir=i(At);io=r(ir,"A",{id:!0,class:!0,href:!0});var jp=i(io);Js=r(jp,"SPAN",{});var Mp=i(Js);x(vn.$$.fragment,Mp),Mp.forEach(t),jp.forEach(t),Fl=h(ir),Ys=r(ir,"SPAN",{});var Ap=i(Ys);zl=s(Ap,"TFSpeech2TextForConditionalGeneration"),Ap.forEach(t),ir.forEach(t),za=h(o),ye=r(o,"DIV",{class:!0});var pt=i(ye);x(bn.$$.fragment,pt),Pl=h(pt),yn=r(pt,"P",{});var dr=i(yn);Cl=s(dr,`The Speech2Text Model with a language modeling head. Can be used for summarization.
