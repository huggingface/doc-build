...
<span class="hljs-meta">&gt;&gt;&gt; </span>transcription = processor.batch_decode(generated_ids)`}}),{c(){c=a("p"),b=n("Example:"),_=p(),y(g.$$.fragment)},l(d){c=r(d,"P",{});var m=i(c);b=s(m,"Example:"),m.forEach(t),_=h(d),x(g.$$.fragment,d)},m(d,m){u(d,c,m),e(c,b),u(d,_,m),k(g,d,m),v=!0},p:la,i(d){v||(w(g.$$.fragment,d),v=!0)},o(d){S(g.$$.fragment,d),v=!1},d(d){d&&t(c),d&&t(_),$(g,d)}}}function sh(C){let c,b,_,g,v,d,m,q,D,j,M,I,ne,E,Ge,Q,Ue,je,A,We,se,ae,Re,re,ie,Ve,de,le,He,ce,Se,N,L,Y,pe,he,Be,me,ue,Ke,U,Ce,W,ee,$e,K,Je,Ee,Z,Me,H,Ye,fe,R,Xe,B,O,Qe,T,F,ht,te,mt,ut,z,ft,_t,Ae,gt,Tt,X,P,vt,Ze,_e,bt,et,tt,yt,ge,xt,cr,ls,pr,hr,cs,mr,ur,yo,fr,_r,ps,gr,ca,qn,hs,Tr,pa,xo,ha,Fn,ko,ms,vr,br,Te,yr,us,xr,kr,fs,wr,Sr,_s,$r,Er,gs,qr,Fr,Ts,zr,Pr,ma,wo,ua,Dt,jr,So,Cr,Mr,fa,kt,It,vs,$o,Ar,bs,Nr,_a,qe,Eo,Dr,wt,Ir,zn,Lr,Or,qo,Gr,Ur,Wr,St,Rr,Pn,Vr,Hr,jn,Br,Kr,Jr,Lt,ga,$t,Ot,ys,Fo,Yr,xs,Xr,Ta,J,zo,Qr,ks,Zr,ei,Po,ti,Cn,oi,ni,si,Gt,jo,ai,ws,ri,ii,Ut,Co,di,Mo,li,Ss,ci,pi,hi,at,Ao,mi,Mn,ui,An,fi,_i,$s,gi,Ti,Nn,No,va,Et,Wt,Es,Do,vi,qs,bi,ba,ve,Io,yi,Fs,xi,ki,Lo,wi,Dn,Si,$i,Ei,zs,qi,Fi,Rt,Oo,zi,Ps,Pi,ya,qt,Vt,js,Go,ji,Cs,Ci,xa,V,Uo,Mi,Ms,Ai,Ni,ke,In,Di,Ii,Ln,Li,Oi,On,Gi,Ui,Wo,As,Wi,Ri,Vi,Gn,Hi,Bi,Ki,Ht,Ro,Ji,ot,Yi,Vo,Ns,Xi,Qi,Zi,Ds,ed,td,Ho,Is,od,nd,sd,ad,rt,Bo,rd,Ls,id,dd,Bt,ld,it,Ko,cd,Jo,pd,Un,hd,md,ud,Kt,fd,Jt,Yo,_d,Xo,gd,Wn,Td,vd,bd,Yt,Qo,yd,Zo,xd,Rn,kd,wd,ka,Ft,Xt,Os,en,Sd,Gs,$d,wa,Fe,tn,Ed,on,qd,Vn,Fd,zd,Pd,nn,jd,sn,Cd,Md,Ad,Ne,an,Nd,zt,Dd,Hn,Id,Ld,Us,Od,Gd,Ud,Qt,Wd,Zt,Sa,Pt,eo,Ws,rn,Rd,Rs,Vd,$a,ze,dn,Hd,ln,Bd,Bn,Kd,Jd,Yd,cn,Xd,pn,Qd,Zd,el,De,hn,tl,jt,ol,Kn,nl,sl,Vs,al,rl,il,to,dl,oo,Ea,Ct,no,Hs,mn,ll,Bs,cl,qa,be,un,pl,fn,hl,Jn,ml,ul,fl,_n,_l,gn,gl,Tl,vl,so,bl,Ie,Tn,yl,Mt,xl,Yn,kl,wl,Ks,Sl,$l,El,ao,ql,ro,Fa,At,io,Js,vn,Fl,Ys,zl,za,ye,bn,Pl,yn,jl,Xn,Cl,Ml,Al,xn,Nl,kn,Dl,Il,Ll,lo,Ol,Le,wn,Gl,Nt,Ul,Qn,Wl,Rl,Xs,Vl,Hl,Bl,co,Kl,po,Pa;return d=new st({}),E=new st({}),K=new st({}),xo=new En({props:{code:`import torch
from transformers import Speech2TextProcessor, Speech2TextForConditionalGeneration
from datasets import load_dataset
...
checkpoint.`),ma=p(),y(wo.$$.fragment),ua=p(),Dt=a("p"),jr=n("See the "),So=a("a"),Cr=n("model hub"),Mr=n(" to look for Speech2Text checkpoints."),fa=p(),kt=a("h2"),It=a("a"),vs=a("span"),y($o.$$.fragment),Ar=p(),bs=a("span"),Nr=n("Speech2TextConfig"),_a=p(),qe=a("div"),y(Eo.$$.fragment),Dr=p(),wt=a("p"),Ir=n("This is the configuration class to store the configuration of a "),zn=a("a"),Lr=n("Speech2TextModel"),Or=n(`. It is used to instantiate an
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),el=p(),De=a("div"),y(hn.$$.fragment),tl=p(),jt=a("p"),ol=n("The "),Kn=a("a"),nl=n("Speech2TextForConditionalGeneration"),sl=n(" forward method, overrides the "),Vs=a("code"),al=n("__call__"),rl=n(" special method."),il=p(),y(to.$$.fragment),dl=p(),y(oo.$$.fragment),Ea=p(),Ct=a("h2"),no=a("a"),Hs=a("span"),y(mn.$$.fragment),ll=p(),Bs=a("span"),cl=n("TFSpeech2TextModel"),qa=p(),be=a("div"),y(un.$$.fragment),pl=p(),fn=a("p"),hl=n(`The bare Speech2Text Model outputting raw hidden-states without any specific head on top.
...
fed into the encoder. The model is trained with standard autoregressive cross-entropy loss and generates the
transcripts/translations autoregressively. Speech2Text has been fine-tuned on several datasets for ASR and ST:
`),re=r(Pe,"A",{href:!0,rel:!0});var aa=i(re);ie=s(aa,"LibriSpeech"),aa.forEach(t),Ve=s(Pe,", "),de=r(Pe,"A",{href:!0,rel:!0});var ra=i(de);le=s(ra,"CoVoST 2"),ra.forEach(t),He=s(Pe,", "),ce=r(Pe,"A",{href:!0,rel:!0});var ia=i(ce);Se=s(ia,"MuST-C"),ia.forEach(t),N=s(Pe,"."),Pe.forEach(t),L=h(o),Y=r(o,"P",{});var Zn=i(Y);pe=s(Zn,"This model was contributed by "),he=r(Zn,"A",{href:!0,rel:!0});var Zl=i(he);Be=s(Zl,"valhalla"),Zl.forEach(t),me=s(Zn,". The original code can be found "),ue=r(Zn,"A",{href:!0,rel:!0});var ec=i(ue);Ke=s(ec,"here"),ec.forEach(t),U=s(Zn,"."),Zn.forEach(t),Ce=h(o),W=r(o,"H2",{class:!0});var ja=i(W);ee=r(ja,"A",{id:!0,class:!0,href:!0});var tc=i(ee);$e=r(tc,"SPAN",{});var oc=i($e);x(K.$$.fragment,oc),oc.forEach(t),tc.forEach(t),Je=h(ja),Ee=r(ja,"SPAN",{});var nc=i(Ee);Z=s(nc,"Inference"),nc.forEach(t),ja.forEach(t),Me=h(o),H=r(o,"P",{});var Ca=i(H);Ye=s(Ca,`Speech2Text is a speech model that accepts a float tensor of log-mel filter-bank features extracted from the speech
signal. It\u2019s a transformer-based seq2seq model, so the transcripts/translations are generated autoregressively. The
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),er.forEach(t),Ad=h(uo),Ne=r(uo,"DIV",{class:!0});var fo=i(Ne);x(an.$$.fragment,fo),Nd=h(fo),zt=r(fo,"P",{});var as=i(zt);Dd=s(as,"The "),Hn=r(as,"A",{href:!0});var gp=i(Hn);Id=s(gp,"Speech2TextModel"),gp.forEach(t),Ld=s(as," forward method, overrides the "),Us=r(as,"CODE",{});var Tp=i(Us);Od=s(Tp,"__call__"),Tp.forEach(t),Gd=s(as," special method."),as.forEach(t),Ud=h(fo),x(Qt.$$.fragment,fo),Wd=h(fo),x(Zt.$$.fragment,fo),fo.forEach(t),uo.forEach(t),Sa=h(o),Pt=r(o,"H2",{class:!0});var tr=i(Pt);eo=r(tr,"A",{id:!0,class:!0,href:!0});var vp=i(eo);Ws=r(vp,"SPAN",{});var bp=i(Ws);x(rn.$$.fragment,bp),bp.forEach(t),vp.forEach(t),Rd=h(tr),Rs=r(tr,"SPAN",{});var yp=i(Rs);Vd=s(yp,"Speech2TextForConditionalGeneration"),yp.forEach(t),tr.forEach(t),$a=h(o),ze=r(o,"DIV",{class:!0});var _o=i(ze);x(dn.$$.fragment,_o),Hd=h(_o),ln=r(_o,"P",{});var or=i(ln);Bd=s(or,`The Speech2Text Model with a language modeling head. Can be used for summarization.
