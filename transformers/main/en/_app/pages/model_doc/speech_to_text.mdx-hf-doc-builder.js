...
methods above for more information.`),F.forEach(t),this.h()},h(){c(_,"href","/docs/transformers/main/en/main_classes/feature_extractor#transformers.FeatureExtractionMixin.from_pretrained")},m(A,F){f(A,h,F),e(h,x),e(h,_),e(_,m),e(h,v),e(h,d),e(d,g),e(h,E)},d(A){A&&t(h)}}}function Bp(C){let h,x,_,m,v,d,g,E;return{c(){h=a("p"),x=n("This class method is simply calling "),_=a("a"),m=n("save_pretrained()"),v=n(` and
...
<span class="hljs-string">&#x27;mister quilter is the apostle of the middle classes and we are glad to welcome his gospel&#x27;</span>`}}),{c(){h=a("p"),x=n("Example:"),_=l(),b(m.$$.fragment)},l(d){h=r(d,"P",{});var g=i(h);x=s(g,"Example:"),g.forEach(t),_=p(d),k(m.$$.fragment,d)},m(d,g){f(d,h,g),e(h,x),f(d,_,g),y(m,d,g),v=!0},p:Ys,i(d){v||(w(m.$$.fragment,d),v=!0)},o(d){S(m.$$.fragment,d),v=!1},d(d){d&&t(h),d&&t(_),$(m,d)}}}function Qp(C){let h,x,_,m,v,d,g,E,A,F,q,D,R,ee,Ce,H,Pe,ye,N,B,te,Te,j,M,je,oe,ne,Me,se,ae,Ne,O,we,I,Ae,re,ie,De,de,K,Ie,Q,J;return{c(){h=a("p"),x=n("TF 2.0 models accepts two formats as inputs:"),_=l(),m=a("ul"),v=a("li"),d=n("having all inputs as keyword arguments (like PyTorch models), or"),g=l(),E=a("li"),A=n("having all inputs as a list, tuple or dict in the first positional arguments."),F=l(),q=a("p"),D=n("This second option is useful when using "),R=a("code"),ee=n("tf.keras.Model.fit"),Ce=n(` method which currently requires having all the
tensors in the first argument of the model call function: `),H=a("code"),Pe=n("model(inputs)"),ye=n("."),N=l(),B=a("p"),te=n(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
...
`),Q=a("code"),J=n('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(T){h=r(T,"P",{});var z=i(h);x=s(z,"TF 2.0 models accepts two formats as inputs:"),z.forEach(t),_=p(T),m=r(T,"UL",{});var Y=i(m);v=r(Y,"LI",{});var Ze=i(v);d=s(Ze,"having all inputs as keyword arguments (like PyTorch models), or"),Ze.forEach(t),g=p(Y),E=r(Y,"LI",{});var Le=i(E);A=s(Le,"having all inputs as a list, tuple or dict in the first positional arguments."),Le.forEach(t),Y.forEach(t),F=p(T),q=r(T,"P",{});var X=i(q);D=s(X,"This second option is useful when using "),R=r(X,"CODE",{});var Ve=i(R);ee=s(Ve,"tf.keras.Model.fit"),Ve.forEach(t),Ce=s(X,` method which currently requires having all the
tensors in the first argument of the model call function: `),H=r(X,"CODE",{});var ue=i(H);Pe=s(ue,"model(inputs)"),ue.forEach(t),ye=s(X,"."),X.forEach(t),N=p(T),B=r(T,"P",{});var et=i(B);te=s(et,`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),et.forEach(t),Te=p(T),j=r(T,"UL",{});var U=i(j);M=r(U,"LI",{});var ce=i(M);je=s(ce,"a single Tensor with "),oe=r(ce,"CODE",{});var tt=i(oe);ne=s(tt,"input_ids"),tt.forEach(t),Me=s(ce," only and nothing else: "),se=r(ce,"CODE",{});var Re=i(se);ae=s(Re,"model(input_ids)"),Re.forEach(t),ce.forEach(t),Ne=p(U),O=r(U,"LI",{});var P=i(O);we=s(P,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),I=r(P,"CODE",{});var ot=i(I);Ae=s(ot,"model([input_ids, attention_mask])"),ot.forEach(t),re=s(P," or "),ie=r(P,"CODE",{});var Se=i(ie);De=s(Se,"model([input_ids, attention_mask, token_type_ids])"),Se.forEach(t),P.forEach(t),de=p(U),K=r(U,"LI",{});var Oe=i(K);Ie=s(Oe,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),Q=r(Oe,"CODE",{});var nt=i(Q);J=s(nt,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),nt.forEach(t),Oe.forEach(t),U.forEach(t)},m(T,z){f(T,h,z),e(h,x),f(T,_,z),f(T,m,z),e(m,v),e(v,d),e(m,g),e(m,E),e(E,A),f(T,F,z),f(T,q,z),e(q,D),e(q,R),e(R,ee),e(q,Ce),e(q,H),e(H,Pe),e(q,ye),f(T,N,z),f(T,B,z),e(B,te),f(T,Te,z),f(T,j,z),e(j,M),e(M,je),e(M,oe),e(oe,ne),e(M,Me),e(M,se),e(se,ae),e(j,Ne),e(j,O),e(O,we),e(O,I),e(I,Ae),e(O,re),e(O,ie),e(ie,De),e(j,de),e(j,K),e(K,Ie),e(K,Q),e(Q,J)},d(T){T&&t(h),T&&t(_),T&&t(m),T&&t(F),T&&t(q),T&&t(N),T&&t(B),T&&t(Te),T&&t(j)}}}function Zp(C){let h,x,_,m,v;return{c(){h=a("p"),x=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),_=a("code"),m=n("Module"),v=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(d){h=r(d,"P",{});var g=i(h);x=s(g,"Although the recipe for forward pass needs to be defined within this function, one should call the "),_=r(g,"CODE",{});var E=i(_);m=s(E,"Module"),E.forEach(t),v=s(g,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),{c(){h=a("p"),x=n("Example:"),_=l(),b(m.$$.fragment)},l(d){h=r(d,"P",{});var g=i(h);x=s(g,"Example:"),g.forEach(t),_=p(d),k(m.$$.fragment,d)},m(d,g){f(d,h,g),e(h,x),f(d,_,g),y(m,d,g),v=!0},p:Ys,i(d){v||(w(m.$$.fragment,d),v=!0)},o(d){S(m.$$.fragment,d),v=!1},d(d){d&&t(h),d&&t(_),$(m,d)}}}function th(C){let h,x,_,m,v,d,g,E,A,F,q,D,R,ee,Ce,H,Pe,ye,N,B,te,Te,j,M,je,oe,ne,Me,se,ae,Ne,O,we,I,Ae,re,ie,De,de,K,Ie,Q,J;return{c(){h=a("p"),x=n("TF 2.0 models accepts two formats as inputs:"),_=l(),m=a("ul"),v=a("li"),d=n("having all inputs as keyword arguments (like PyTorch models), or"),g=l(),E=a("li"),A=n("having all inputs as a list, tuple or dict in the first positional arguments."),F=l(),q=a("p"),D=n("This second option is useful when using "),R=a("code"),ee=n("tf.keras.Model.fit"),Ce=n(` method which currently requires having all the
tensors in the first argument of the model call function: `),H=a("code"),Pe=n("model(inputs)"),ye=n("."),N=l(),B=a("p"),te=n(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),Te=l(),j=a("ul"),M=a("li"),je=n("a single Tensor with "),oe=a("code"),ne=n("input_ids"),Me=n(" only and nothing else: "),se=a("code"),ae=n("model(input_ids)"),Ne=l(),O=a("li"),we=n(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),I=a("code"),Ae=n("model([input_ids, attention_mask])"),re=n(" or "),ie=a("code"),De=n("model([input_ids, attention_mask, token_type_ids])"),de=l(),K=a("li"),Ie=n(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),Q=a("code"),J=n('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(T){h=r(T,"P",{});var z=i(h);x=s(z,"TF 2.0 models accepts two formats as inputs:"),z.forEach(t),_=p(T),m=r(T,"UL",{});var Y=i(m);v=r(Y,"LI",{});var Ze=i(v);d=s(Ze,"having all inputs as keyword arguments (like PyTorch models), or"),Ze.forEach(t),g=p(Y),E=r(Y,"LI",{});var Le=i(E);A=s(Le,"having all inputs as a list, tuple or dict in the first positional arguments."),Le.forEach(t),Y.forEach(t),F=p(T),q=r(T,"P",{});var X=i(q);D=s(X,"This second option is useful when using "),R=r(X,"CODE",{});var Ve=i(R);ee=s(Ve,"tf.keras.Model.fit"),Ve.forEach(t),Ce=s(X,` method which currently requires having all the
...
first positional argument :`),et.forEach(t),Te=p(T),j=r(T,"UL",{});var U=i(j);M=r(U,"LI",{});var ce=i(M);je=s(ce,"a single Tensor with "),oe=r(ce,"CODE",{});var tt=i(oe);ne=s(tt,"input_ids"),tt.forEach(t),Me=s(ce," only and nothing else: "),se=r(ce,"CODE",{});var Re=i(se);ae=s(Re,"model(input_ids)"),Re.forEach(t),ce.forEach(t),Ne=p(U),O=r(U,"LI",{});var P=i(O);we=s(P,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),I=r(P,"CODE",{});var ot=i(I);Ae=s(ot,"model([input_ids, attention_mask])"),ot.forEach(t),re=s(P," or "),ie=r(P,"CODE",{});var Se=i(ie);De=s(Se,"model([input_ids, attention_mask, token_type_ids])"),Se.forEach(t),P.forEach(t),de=p(U),K=r(U,"LI",{});var Oe=i(K);Ie=s(Oe,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),Q=r(Oe,"CODE",{});var nt=i(Q);J=s(nt,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),nt.forEach(t),Oe.forEach(t),U.forEach(t)},m(T,z){f(T,h,z),e(h,x),f(T,_,z),f(T,m,z),e(m,v),e(v,d),e(m,g),e(m,E),e(E,A),f(T,F,z),f(T,q,z),e(q,D),e(q,R),e(R,ee),e(q,Ce),e(q,H),e(H,Pe),e(q,ye),f(T,N,z),f(T,B,z),e(B,te),f(T,Te,z),f(T,j,z),e(j,M),e(M,je),e(M,oe),e(oe,ne),e(M,Me),e(M,se),e(se,ae),e(j,Ne),e(j,O),e(O,we),e(O,I),e(I,Ae),e(O,re),e(O,ie),e(ie,De),e(j,de),e(j,K),e(K,Ie),e(K,Q),e(Q,J)},d(T){T&&t(h),T&&t(_),T&&t(m),T&&t(F),T&&t(q),T&&t(N),T&&t(B),T&&t(Te),T&&t(j)}}}function oh(C){let h,x,_,m,v;return{c(){h=a("p"),x=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),_=a("code"),m=n("Module"),v=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(d){h=r(d,"P",{});var g=i(h);x=s(g,"Although the recipe for forward pass needs to be defined within this function, one should call the "),_=r(g,"CODE",{});var E=i(_);m=s(E,"Module"),E.forEach(t),v=s(g,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
<span class="hljs-meta">&gt;&gt;&gt; </span>transcription = processor.batch_decode(generated_ids)`}}),{c(){h=a("p"),x=n("Example:"),_=l(),b(m.$$.fragment)},l(d){h=r(d,"P",{});var g=i(h);x=s(g,"Example:"),g.forEach(t),_=p(d),k(m.$$.fragment,d)},m(d,g){f(d,h,g),e(h,x),f(d,_,g),y(m,d,g),v=!0},p:Ys,i(d){v||(w(m.$$.fragment,d),v=!0)},o(d){S(m.$$.fragment,d),v=!1},d(d){d&&t(h),d&&t(_),$(m,d)}}}function sh(C){let h,x,_,m,v,d,g,E,A,F,q,D,R,ee,Ce,H,Pe,ye,N,B,te,Te,j,M,je,oe,ne,Me,se,ae,Ne,O,we,I,Ae,re,ie,De,de,K,Ie,Q,J,T,z,Y,Ze,Le,X,Ve,ue,et,U,ce,tt,Re,P,ot,Se,Oe,nt,cn,Qa,Za,ln,er,tr,pn,or,nr,Xs,W,sr,Bn,ar,rr,Kn,ir,dr,Jn,cr,lr,Yn,pr,hr,Xn,mr,fr,to,ur,_r,Qn,gr,Qs,hn,Zn,Tr,Zs,oo,ea,mn,no,es,vr,xr,le,br,ts,kr,yr,os,wr,Sr,ns,$r,Er,ss,qr,Fr,as,zr,Cr,ta,so,oa,Tt,Pr,ao,jr,Mr,na,st,vt,rs,ro,Nr,is,Ar,sa,ve,io,Dr,at,Ir,fn,Lr,Or,co,Gr,Ur,Wr,rt,Vr,un,Rr,Hr,_n,Br,Kr,Jr,xt,aa,it,bt,ds,lo,Yr,cs,Xr,ra,V,po,Qr,ls,Zr,ei,ho,ti,gn,oi,ni,si,kt,mo,ai,ps,ri,ii,yt,fo,di,uo,ci,hs,li,pi,hi,He,_o,mi,Tn,fi,vn,ui,_i,ms,gi,Ti,xn,go,ia,dt,wt,fs,To,vi,us,xi,da,pe,vo,bi,_s,ki,yi,xo,wi,bn,Si,$i,Ei,gs,qi,Fi,St,bo,zi,Ts,Ci,ca,ct,$t,vs,ko,Pi,xs,ji,la,G,yo,Mi,bs,Ni,Ai,_e,kn,Di,Ii,yn,Li,Oi,wn,Gi,Ui,wo,ks,Wi,Vi,Ri,Sn,Hi,Bi,Ki,Et,So,Ji,Ge,Yi,$o,ys,Xi,Qi,Zi,ws,ed,td,Eo,Ss,od,nd,sd,ad,Be,qo,rd,$s,id,dd,qt,cd,Ke,Fo,ld,zo,pd,$n,hd,md,fd,Ft,ud,zt,Co,_d,Po,gd,En,Td,vd,xd,Ct,jo,bd,Mo,kd,qn,yd,wd,pa,lt,Pt,Es,No,Sd,qs,$d,ha,xe,Ao,Ed,Do,qd,Fn,Fd,zd,Cd,Io,Pd,Lo,jd,Md,Nd,$e,Oo,Ad,pt,Dd,zn,Id,Ld,Fs,Od,Gd,Ud,jt,Wd,Mt,ma,ht,Nt,zs,Go,Vd,Cs,Rd,fa,be,Uo,Hd,Wo,Bd,Cn,Kd,Jd,Yd,Vo,Xd,Ro,Qd,Zd,ec,Ee,Ho,tc,mt,oc,Pn,nc,sc,Ps,ac,rc,ic,At,dc,Dt,ua,ft,It,js,Bo,cc,Ms,lc,_a,he,Ko,pc,Jo,hc,jn,mc,fc,uc,Yo,_c,Xo,gc,Tc,vc,Lt,xc,qe,Qo,bc,ut,kc,Mn,yc,wc,Ns,Sc,$c,Ec,Ot,qc,Gt,ga,_t,Ut,As,Zo,Fc,Ds,zc,Ta,me,en,Cc,tn,Pc,Nn,jc,Mc,Nc,on,Ac,nn,Dc,Ic,Lc,Wt,Oc,Fe,sn,Gc,gt,Uc,An,Wc,Vc,Is,Rc,Hc,Bc,Vt,Kc,Rt,va;return d=new We({}),ee=new We({}),Y=new We({}),oo=new dn({props:{code:`import torch
from transformers import Speech2TextProcessor, Speech2TextForConditionalGeneration
from datasets import load_dataset
...
`}}),Vt=new eo({props:{$$slots:{default:[oh]},$$scope:{ctx:C}}}),Rt=new Js({props:{anchor:"transformers.TFSpeech2TextForConditionalGeneration.call.example",$$slots:{default:[nh]},$$scope:{ctx:C}}}),{c(){h=a("meta"),x=l(),_=a("h1"),m=a("a"),v=a("span"),b(d.$$.fragment),g=l(),E=a("span"),A=n("Speech2Text"),F=l(),q=a("h2"),D=a("a"),R=a("span"),b(ee.$$.fragment),Ce=l(),H=a("span"),Pe=n("Overview"),ye=l(),N=a("p"),B=n("The Speech2Text model was proposed in "),te=a("a"),Te=n("fairseq S2T: Fast Speech-to-Text Modeling with fairseq"),j=n(` by Changhan Wang, Yun Tang, Xutai Ma, Anne Wu, Dmytro Okhonko, Juan Pino. It\u2019s a
transformer-based seq2seq (encoder-decoder) model designed for end-to-end Automatic Speech Recognition (ASR) and Speech
Translation (ST). It uses a convolutional downsampler to reduce the length of speech inputs by 3/4th before they are
fed into the encoder. The model is trained with standard autoregressive cross-entropy loss and generates the
transcripts/translations autoregressively. Speech2Text has been fine-tuned on several datasets for ASR and ST:
`),M=a("a"),je=n("LibriSpeech"),oe=n(", "),ne=a("a"),Me=n("CoVoST 2"),se=n(", "),ae=a("a"),Ne=n("MuST-C"),O=n("."),we=l(),I=a("p"),Ae=n("This model was contributed by "),re=a("a"),ie=n("valhalla"),De=n(". The original code can be found "),de=a("a"),K=n("here"),Ie=n("."),Q=l(),J=a("h2"),T=a("a"),z=a("span"),b(Y.$$.fragment),Ze=l(),Le=a("span"),X=n("Inference"),Ve=l(),ue=a("p"),et=n(`Speech2Text is a speech model that accepts a float tensor of log-mel filter-bank features extracted from the speech
signal. It\u2019s a transformer-based seq2seq model, so the transcripts/translations are generated autoregressively. The
`),U=a("code"),ce=n("generate()"),tt=n(" method can be used for inference."),Re=l(),P=a("p"),ot=n("The "),Se=a("a"),Oe=n("Speech2TextFeatureExtractor"),nt=n(` class is responsible for extracting the log-mel filter-bank
...
example shows how to transate English speech to French text using the `),as=a("em"),zr=n("facebook/s2t-medium-mustc-multilingual-st"),Cr=n(`
checkpoint.`),ta=l(),b(so.$$.fragment),oa=l(),Tt=a("p"),Pr=n("See the "),ao=a("a"),jr=n("model hub"),Mr=n(" to look for Speech2Text checkpoints."),na=l(),st=a("h2"),vt=a("a"),rs=a("span"),b(ro.$$.fragment),Nr=l(),is=a("span"),Ar=n("Speech2TextConfig"),sa=l(),ve=a("div"),b(io.$$.fragment),Dr=l(),at=a("p"),Ir=n("This is the configuration class to store the configuration of a "),fn=a("a"),Lr=n("Speech2TextModel"),Or=n(`. It is used to instantiate an
Speech2Text model according to the specified arguments, defining the model architecture. Instantiating a
configuration with the defaults will yield a similar configuration to that of the Speech2Text
`),co=a("a"),Gr=n("facebook/s2t-small-librispeech-asr"),Ur=n(" architecture."),Wr=l(),rt=a("p"),Vr=n("Configuration objects inherit from "),un=a("a"),Rr=n("PretrainedConfig"),Hr=n(` and can be used to control the model outputs. Read the
documentation from `),_n=a("a"),Br=n("PretrainedConfig"),Kr=n(" for more information."),Jr=l(),b(xt.$$.fragment),aa=l(),it=a("h2"),bt=a("a"),ds=a("span"),b(lo.$$.fragment),Yr=l(),cs=a("span"),Xr=n("Speech2TextTokenizer"),ra=l(),V=a("div"),b(po.$$.fragment),Qr=l(),ls=a("p"),Zr=n("Construct an Speech2Text tokenizer."),ei=l(),ho=a("p"),ti=n("This tokenizer inherits from "),gn=a("a"),oi=n("PreTrainedTokenizer"),ni=n(` which contains some of the main methods. Users should refer to
...
mean and variance normalization to the extracted features.`),Fi=l(),St=a("div"),b(bo.$$.fragment),zi=l(),Ts=a("p"),Ci=n("Main method to featurize and prepare for the model one or several sequence(s). sequences."),ca=l(),ct=a("h2"),$t=a("a"),vs=a("span"),b(ko.$$.fragment),Pi=l(),xs=a("span"),ji=n("Speech2TextProcessor"),la=l(),G=a("div"),b(yo.$$.fragment),Mi=l(),bs=a("p"),Ni=n(`Constructs a Speech2Text processor which wraps a Speech2Text feature extractor and a Speech2Text tokenizer into a
...
`),wn=a("a"),Gi=n("Speech2TextTokenizer"),Ui=n(". See the "),wo=a("a"),ks=a("strong"),Wi=n("call"),Vi=n("()"),Ri=n(" and "),Sn=a("a"),Hi=n("decode()"),Bi=n(` for more
...
can be reloaded using the `),$n=a("a"),hd=n("from_pretrained()"),md=n(" method."),fd=l(),b(Ft.$$.fragment),ud=l(),zt=a("div"),b(Co.$$.fragment),_d=l(),Po=a("p"),gd=n("This method forwards all its arguments to Speech2TextTokenizer\u2019s "),En=a("a"),Td=n("batch_decode()"),vd=n(`. Please
refer to the docstring of this method for more information.`),xd=l(),Ct=a("div"),b(jo.$$.fragment),bd=l(),Mo=a("p"),kd=n("This method forwards all its arguments to Speech2TextTokenizer\u2019s "),qn=a("a"),yd=n("decode()"),wd=n(`. Please refer
to the docstring of this method for more information.`),pa=l(),lt=a("h2"),Pt=a("a"),Es=a("span"),b(No.$$.fragment),Sd=l(),qs=a("span"),$d=n("Speech2TextModel"),ha=l(),xe=a("div"),b(Ao.$$.fragment),Ed=l(),Do=a("p"),qd=n(`The bare Speech2Text Model outputting raw hidden-states without any specific head on top.
...
etc.)`),Cd=l(),Io=a("p"),Pd=n("This model is also a PyTorch "),Lo=a("a"),jd=n("torch.nn.Module"),Md=n(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Nd=l(),$e=a("div"),b(Oo.$$.fragment),Ad=l(),pt=a("p"),Dd=n("The "),zn=a("a"),Id=n("Speech2TextModel"),Ld=n(" forward method, overrides the "),Fs=a("code"),Od=n("__call__"),Gd=n(" special method."),Ud=l(),b(jt.$$.fragment),Wd=l(),b(Mt.$$.fragment),ma=l(),ht=a("h2"),Nt=a("a"),zs=a("span"),b(Go.$$.fragment),Vd=l(),Cs=a("span"),Rd=n("Speech2TextForConditionalGeneration"),fa=l(),be=a("div"),b(Uo.$$.fragment),Hd=l(),Wo=a("p"),Bd=n(`The Speech2Text Model with a language modeling head. Can be used for summarization.
This model inherits from `),Cn=a("a"),Kd=n("PreTrainedModel"),Jd=n(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Yd=l(),Vo=a("p"),Xd=n("This model is also a PyTorch "),Ro=a("a"),Qd=n("torch.nn.Module"),Zd=n(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),ec=l(),Ee=a("div"),b(Ho.$$.fragment),tc=l(),mt=a("p"),oc=n("The "),Pn=a("a"),nc=n("Speech2TextForConditionalGeneration"),sc=n(" forward method, overrides the "),Ps=a("code"),ac=n("__call__"),rc=n(" special method."),ic=l(),b(At.$$.fragment),dc=l(),b(Dt.$$.fragment),ua=l(),ft=a("h2"),It=a("a"),js=a("span"),b(Bo.$$.fragment),cc=l(),Ms=a("span"),lc=n("TFSpeech2TextModel"),_a=l(),he=a("div"),b(Ko.$$.fragment),pc=l(),Jo=a("p"),hc=n(`The bare Speech2Text Model outputting raw hidden-states without any specific head on top.
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Lc=l(),b(Wt.$$.fragment),Oc=l(),Fe=a("div"),b(sn.$$.fragment),Gc=l(),gt=a("p"),Uc=n("The "),An=a("a"),Wc=n("TFSpeech2TextForConditionalGeneration"),Vc=n(" forward method, overrides the "),Is=a("code"),Rc=n("__call__"),Hc=n(" special method."),Bc=l(),b(Vt.$$.fragment),Kc=l(),b(Rt.$$.fragment),this.h()},l(o){const u=Wp('[data-svelte="svelte-1phssyn"]',document.head);h=r(u,"META",{name:!0,content:!0}),u.forEach(t),x=p(o),_=r(o,"H1",{class:!0});var an=i(_);m=r(an,"A",{id:!0,class:!0,href:!0});var Ls=i(m);v=r(Ls,"SPAN",{});var Os=i(v);k(d.$$.fragment,Os),Os.forEach(t),Ls.forEach(t),g=p(an),E=r(an,"SPAN",{});var Gs=i(E);A=s(Gs,"Speech2Text"),Gs.forEach(t),an.forEach(t),F=p(o),q=r(o,"H2",{class:!0});var rn=i(q);D=r(rn,"A",{id:!0,class:!0,href:!0});var Us=i(D);R=r(Us,"SPAN",{});var Ws=i(R);k(ee.$$.fragment,Ws),Ws.forEach(t),Us.forEach(t),Ce=p(rn),H=r(rn,"SPAN",{});var Vs=i(H);Pe=s(Vs,"Overview"),Vs.forEach(t),rn.forEach(t),ye=p(o),N=r(o,"P",{});var ke=i(N);B=s(ke,"The Speech2Text model was proposed in "),te=r(ke,"A",{href:!0,rel:!0});var Rs=i(te);Te=s(Rs,"fairseq S2T: Fast Speech-to-Text Modeling with fairseq"),Rs.forEach(t),j=s(ke,` by Changhan Wang, Yun Tang, Xutai Ma, Anne Wu, Dmytro Okhonko, Juan Pino. It\u2019s a
transformer-based seq2seq (encoder-decoder) model designed for end-to-end Automatic Speech Recognition (ASR) and Speech
Translation (ST). It uses a convolutional downsampler to reduce the length of speech inputs by 3/4th before they are
fed into the encoder. The model is trained with standard autoregressive cross-entropy loss and generates the
transcripts/translations autoregressively. Speech2Text has been fine-tuned on several datasets for ASR and ST:
`),M=r(ke,"A",{href:!0,rel:!0});var Hs=i(M);je=s(Hs,"LibriSpeech"),Hs.forEach(t),oe=s(ke,", "),ne=r(ke,"A",{href:!0,rel:!0});var Bs=i(ne);Me=s(Bs,"CoVoST 2"),Bs.forEach(t),se=s(ke,", "),ae=r(ke,"A",{href:!0,rel:!0});var Ks=i(ae);Ne=s(Ks,"MuST-C"),Ks.forEach(t),O=s(ke,"."),ke.forEach(t),we=p(o),I=r(o,"P",{});var Dn=i(I);Ae=s(Dn,"This model was contributed by "),re=r(Dn,"A",{href:!0,rel:!0});var Zc=i(re);ie=s(Zc,"valhalla"),Zc.forEach(t),De=s(Dn,". The original code can be found "),de=r(Dn,"A",{href:!0,rel:!0});var el=i(de);K=s(el,"here"),el.forEach(t),Ie=s(Dn,"."),Dn.forEach(t),Q=p(o),J=r(o,"H2",{class:!0});var xa=i(J);T=r(xa,"A",{id:!0,class:!0,href:!0});var tl=i(T);z=r(tl,"SPAN",{});var ol=i(z);k(Y.$$.fragment,ol),ol.forEach(t),tl.forEach(t),Ze=p(xa),Le=r(xa,"SPAN",{});var nl=i(Le);X=s(nl,"Inference"),nl.forEach(t),xa.forEach(t),Ve=p(o),ue=r(o,"P",{});var ba=i(ue);et=s(ba,`Speech2Text is a speech model that accepts a float tensor of log-mel filter-bank features extracted from the speech
signal. It\u2019s a transformer-based seq2seq model, so the transcripts/translations are generated autoregressively. The
`),U=r(ba,"CODE",{});var sl=i(U);ce=s(sl,"generate()"),sl.forEach(t),tt=s(ba," method can be used for inference."),ba.forEach(t),Re=p(o),P=r(o,"P",{});var Je=i(P);ot=s(Je,"The "),Se=r(Je,"A",{href:!0});var al=i(Se);Oe=s(al,"Speech2TextFeatureExtractor"),al.forEach(t),nt=s(Je,` class is responsible for extracting the log-mel filter-bank
...
example shows how to transate English speech to French text using the `),as=r(ze,"EM",{});var wl=i(as);zr=s(wl,"facebook/s2t-medium-mustc-multilingual-st"),wl.forEach(t),Cr=s(ze,`
checkpoint.`),ze.forEach(t),ka.forEach(t),Tl.forEach(t),ta=p(o),k(so.$$.fragment,o),oa=p(o),Tt=r(o,"P",{});var ya=i(Tt);Pr=s(ya,"See the "),ao=r(ya,"A",{href:!0,rel:!0});var Sl=i(ao);jr=s(Sl,"model hub"),Sl.forEach(t),Mr=s(ya," to look for Speech2Text checkpoints."),ya.forEach(t),na=p(o),st=r(o,"H2",{class:!0});var wa=i(st);vt=r(wa,"A",{id:!0,class:!0,href:!0});var $l=i(vt);rs=r($l,"SPAN",{});var El=i(rs);k(ro.$$.fragment,El),El.forEach(t),$l.forEach(t),Nr=p(wa),is=r(wa,"SPAN",{});var ql=i(is);Ar=s(ql,"Speech2TextConfig"),ql.forEach(t),wa.forEach(t),sa=p(o),ve=r(o,"DIV",{class:!0});var Ht=i(ve);k(io.$$.fragment,Ht),Dr=p(Ht),at=r(Ht,"P",{});var In=i(at);Ir=s(In,"This is the configuration class to store the configuration of a "),fn=r(In,"A",{href:!0});var Fl=i(fn);Lr=s(Fl,"Speech2TextModel"),Fl.forEach(t),Or=s(In,`. It is used to instantiate an
Speech2Text model according to the specified arguments, defining the model architecture. Instantiating a
configuration with the defaults will yield a similar configuration to that of the Speech2Text
`),co=r(In,"A",{href:!0,rel:!0});var zl=i(co);Gr=s(zl,"facebook/s2t-small-librispeech-asr"),zl.forEach(t),Ur=s(In," architecture."),In.forEach(t),Wr=p(Ht),rt=r(Ht,"P",{});var Ln=i(rt);Vr=s(Ln,"Configuration objects inherit from "),un=r(Ln,"A",{href:!0});var Cl=i(un);Rr=s(Cl,"PretrainedConfig"),Cl.forEach(t),Hr=s(Ln,` and can be used to control the model outputs. Read the
documentation from `),_n=r(Ln,"A",{href:!0});var Pl=i(_n);Br=s(Pl,"PretrainedConfig"),Pl.forEach(t),Kr=s(Ln," for more information."),Ln.forEach(t),Jr=p(Ht),k(xt.$$.fragment,Ht),Ht.forEach(t),aa=p(o),it=r(o,"H2",{class:!0});var Sa=i(it);bt=r(Sa,"A",{id:!0,class:!0,href:!0});var jl=i(bt);ds=r(jl,"SPAN",{});var Ml=i(ds);k(lo.$$.fragment,Ml),Ml.forEach(t),jl.forEach(t),Yr=p(Sa),cs=r(Sa,"SPAN",{});var Nl=i(cs);Xr=s(Nl,"Speech2TextTokenizer"),Nl.forEach(t),Sa.forEach(t),ra=p(o),V=r(o,"DIV",{class:!0});var ge=i(V);k(po.$$.fragment,ge),Qr=p(ge),ls=r(ge,"P",{});var Al=i(ls);Zr=s(Al,"Construct an Speech2Text tokenizer."),Al.forEach(t),ei=p(ge),ho=r(ge,"P",{});var $a=i(ho);ti=s($a,"This tokenizer inherits from "),gn=r($a,"A",{href:!0});var Dl=i(gn);oi=s(Dl,"PreTrainedTokenizer"),Dl.forEach(t),ni=s($a,` which contains some of the main methods. Users should refer to
...
IDs?`),Ol.forEach(t),Jc.forEach(t),_i=p(On),ms=r(On,"P",{});var Gl=i(ms);gi=s(Gl,"Should be overridden in a subclass if the model has a special way of building those."),Gl.forEach(t),On.forEach(t),Ti=p(ge),xn=r(ge,"DIV",{class:!0});var Ul=i(xn);k(go.$$.fragment,Ul),Ul.forEach(t),ge.forEach(t),ia=p(o),dt=r(o,"H2",{class:!0});var za=i(dt);wt=r(za,"A",{id:!0,class:!0,href:!0});var Wl=i(wt);fs=r(Wl,"SPAN",{});var Vl=i(fs);k(To.$$.fragment,Vl),Vl.forEach(t),Wl.forEach(t),vi=p(za),us=r(za,"SPAN",{});var Rl=i(us);xi=s(Rl,"Speech2TextFeatureExtractor"),Rl.forEach(t),za.forEach(t),da=p(o),pe=r(o,"DIV",{class:!0});var Ye=i(pe);k(vo.$$.fragment,Ye),bi=p(Ye),_s=r(Ye,"P",{});var Hl=i(_s);ki=s(Hl,"Constructs a Speech2Text feature extractor."),Hl.forEach(t),yi=p(Ye),xo=r(Ye,"P",{});var Ca=i(xo);wi=s(Ca,"This feature extractor inherits from "),bn=r(Ca,"A",{href:!0});var Bl=i(bn);Si=s(Bl,"Speech2TextFeatureExtractor"),Bl.forEach(t),$i=s(Ca,` which contains most of the main methods. Users
should refer to this superclass for more information regarding those methods.`),Ca.forEach(t),Ei=p(Ye),gs=r(Ye,"P",{});var Kl=i(gs);qi=s(Kl,`This class extracts mel-filter bank features from raw speech using TorchAudio and applies utterance-level cepstral
mean and variance normalization to the extracted features.`),Kl.forEach(t),Fi=p(Ye),St=r(Ye,"DIV",{class:!0});var Pa=i(St);k(bo.$$.fragment,Pa),zi=p(Pa),Ts=r(Pa,"P",{});var Jl=i(Ts);Ci=s(Jl,"Main method to featurize and prepare for the model one or several sequence(s). sequences."),Jl.forEach(t),Pa.forEach(t),Ye.forEach(t),ca=p(o),ct=r(o,"H2",{class:!0});var ja=i(ct);$t=r(ja,"A",{id:!0,class:!0,href:!0});var Yl=i($t);vs=r(Yl,"SPAN",{});var Xl=i(vs);k(ko.$$.fragment,Xl),Xl.forEach(t),Yl.forEach(t),Pi=p(ja),xs=r(ja,"SPAN",{});var Ql=i(xs);ji=s(Ql,"Speech2TextProcessor"),Ql.forEach(t),ja.forEach(t),la=p(o),G=r(o,"DIV",{class:!0});var Z=i(G);k(yo.$$.fragment,Z),Mi=p(Z),bs=r(Z,"P",{});var Zl=i(bs);Ni=s(Zl,`Constructs a Speech2Text processor which wraps a Speech2Text feature extractor and a Speech2Text tokenizer into a
...
`),wn=r(Ue,"A",{href:!0});var op=i(wn);Gi=s(op,"Speech2TextTokenizer"),op.forEach(t),Ui=s(Ue,". See the "),wo=r(Ue,"A",{href:!0});var Yc=i(wo);ks=r(Yc,"STRONG",{});var np=i(ks);Wi=s(np,"call"),np.forEach(t),Vi=s(Yc,"()"),Yc.forEach(t),Ri=s(Ue," and "),Sn=r(Ue,"A",{href:!0});var sp=i(Sn);Hi=s(sp,"decode()"),sp.forEach(t),Bi=s(Ue,` for more
...
can be reloaded using the `),$n=r(Na,"A",{href:!0});var cp=i($n);hd=s(cp,"from_pretrained()"),cp.forEach(t),md=s(Na," method."),Na.forEach(t),fd=p(Un),k(Ft.$$.fragment,Un),Un.forEach(t),ud=p(Z),zt=r(Z,"DIV",{class:!0});var Aa=i(zt);k(Co.$$.fragment,Aa),_d=p(Aa),Po=r(Aa,"P",{});var Da=i(Po);gd=s(Da,"This method forwards all its arguments to Speech2TextTokenizer\u2019s "),En=r(Da,"A",{href:!0});var lp=i(En);Td=s(lp,"batch_decode()"),lp.forEach(t),vd=s(Da,`. Please
refer to the docstring of this method for more information.`),Da.forEach(t),Aa.forEach(t),xd=p(Z),Ct=r(Z,"DIV",{class:!0});var Ia=i(Ct);k(jo.$$.fragment,Ia),bd=p(Ia),Mo=r(Ia,"P",{});var La=i(Mo);kd=s(La,"This method forwards all its arguments to Speech2TextTokenizer\u2019s "),qn=r(La,"A",{href:!0});var pp=i(qn);yd=s(pp,"decode()"),pp.forEach(t),wd=s(La,`. Please refer
to the docstring of this method for more information.`),La.forEach(t),Ia.forEach(t),Z.forEach(t),pa=p(o),lt=r(o,"H2",{class:!0});var Oa=i(lt);Pt=r(Oa,"A",{id:!0,class:!0,href:!0});var hp=i(Pt);Es=r(hp,"SPAN",{});var mp=i(Es);k(No.$$.fragment,mp),mp.forEach(t),hp.forEach(t),Sd=p(Oa),qs=r(Oa,"SPAN",{});var fp=i(qs);$d=s(fp,"Speech2TextModel"),fp.forEach(t),Oa.forEach(t),ha=p(o),xe=r(o,"DIV",{class:!0});var Kt=i(xe);k(Ao.$$.fragment,Kt),Ed=p(Kt),Do=r(Kt,"P",{});var Ga=i(Do);qd=s(Ga,`The bare Speech2Text Model outputting raw hidden-states without any specific head on top.
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Ga.forEach(t),Cd=p(Kt),Io=r(Kt,"P",{});var Ua=i(Io);Pd=s(Ua,"This model is also a PyTorch "),Lo=r(Ua,"A",{href:!0,rel:!0});var _p=i(Lo);jd=s(_p,"torch.nn.Module"),_p.forEach(t),Md=s(Ua,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Ua.forEach(t),Nd=p(Kt),$e=r(Kt,"DIV",{class:!0});var Jt=i($e);k(Oo.$$.fragment,Jt),Ad=p(Jt),pt=r(Jt,"P",{});var Wn=i(pt);Dd=s(Wn,"The "),zn=r(Wn,"A",{href:!0});var gp=i(zn);Id=s(gp,"Speech2TextModel"),gp.forEach(t),Ld=s(Wn," forward method, overrides the "),Fs=r(Wn,"CODE",{});var Tp=i(Fs);Od=s(Tp,"__call__"),Tp.forEach(t),Gd=s(Wn," special method."),Wn.forEach(t),Ud=p(Jt),k(jt.$$.fragment,Jt),Wd=p(Jt),k(Mt.$$.fragment,Jt),Jt.forEach(t),Kt.forEach(t),ma=p(o),ht=r(o,"H2",{class:!0});var Wa=i(ht);Nt=r(Wa,"A",{id:!0,class:!0,href:!0});var vp=i(Nt);zs=r(vp,"SPAN",{});var xp=i(zs);k(Go.$$.fragment,xp),xp.forEach(t),vp.forEach(t),Vd=p(Wa),Cs=r(Wa,"SPAN",{});var bp=i(Cs);Rd=s(bp,"Speech2TextForConditionalGeneration"),bp.forEach(t),Wa.forEach(t),fa=p(o),be=r(o,"DIV",{class:!0});var Yt=i(be);k(Uo.$$.fragment,Yt),Hd=p(Yt),Wo=r(Yt,"P",{});var Va=i(Wo);Bd=s(Va,`The Speech2Text Model with a language modeling head. Can be used for summarization.
This model inherits from `),Cn=r(Va,"A",{href:!0});var kp=i(Cn);Kd=s(kp,"PreTrainedModel"),kp.forEach(t),Jd=s(Va,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Va.forEach(t),Yd=p(Yt),Vo=r(Yt,"P",{});var Ra=i(Vo);Xd=s(Ra,"This model is also a PyTorch "),Ro=r(Ra,"A",{href:!0,rel:!0});var yp=i(Ro);Qd=s(yp,"torch.nn.Module"),yp.forEach(t),Zd=s(Ra,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Ra.forEach(t),ec=p(Yt),Ee=r(Yt,"DIV",{class:!0});var Xt=i(Ee);k(Ho.$$.fragment,Xt),tc=p(Xt),mt=r(Xt,"P",{});var Vn=i(mt);oc=s(Vn,"The "),Pn=r(Vn,"A",{href:!0});var wp=i(Pn);nc=s(wp,"Speech2TextForConditionalGeneration"),wp.forEach(t),sc=s(Vn," forward method, overrides the "),Ps=r(Vn,"CODE",{});var Sp=i(Ps);ac=s(Sp,"__call__"),Sp.forEach(t),rc=s(Vn," special method."),Vn.forEach(t),ic=p(Xt),k(At.$$.fragment,Xt),dc=p(Xt),k(Dt.$$.fragment,Xt),Xt.forEach(t),Yt.forEach(t),ua=p(o),ft=r(o,"H2",{class:!0});var Ha=i(ft);It=r(Ha,"A",{id:!0,class:!0,href:!0});var $p=i(It);js=r($p,"SPAN",{});var Ep=i(js);k(Bo.$$.fragment,Ep),Ep.forEach(t),$p.forEach(t),cc=p(Ha),Ms=r(Ha,"SPAN",{});var qp=i(Ms);lc=s(qp,"TFSpeech2TextModel"),qp.forEach(t),Ha.forEach(t),_a=p(o),he=r(o,"DIV",{class:!0});var Xe=i(he);k(Ko.$$.fragment,Xe),pc=p(Xe),Jo=r(Xe,"P",{});var Ba=i(Jo);hc=s(Ba,`The bare Speech2Text Model outputting raw hidden-states without any specific head on top.
