...
`),Z=a("code"),Y=n('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(T){h=r(T,"P",{});var F=i(h);b=s(F,"TF 2.0 models accepts two formats as inputs:"),F.forEach(t),_=p(T),m=r(T,"UL",{});var X=i(m);v=r(X,"LI",{});var Ze=i(v);d=s(Ze,"having all inputs as keyword arguments (like PyTorch models), or"),Ze.forEach(t),g=p(X),E=r(X,"LI",{});var Le=i(E);A=s(Le,"having all inputs as a list, tuple or dict in the first positional arguments."),Le.forEach(t),X.forEach(t),z=p(T),q=r(T,"P",{});var Q=i(q);L=s(Q,"This second option is useful when using "),H=r(Q,"CODE",{});var Re=i(H);ee=s(Re,"tf.keras.Model.fit"),Re.forEach(t),Pe=s(Q,` method which currently requires having all the
...
`),Z=r(Oe,"CODE",{});var nt=i(Z);Y=s(nt,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),nt.forEach(t),Oe.forEach(t),U.forEach(t)},m(T,F){f(T,h,F),e(h,b),f(T,_,F),f(T,m,F),e(m,v),e(v,d),e(m,g),e(m,E),e(E,A),f(T,z,F),f(T,q,F),e(q,L),e(q,H),e(H,ee),e(q,Pe),e(q,B),e(B,Ce),e(q,ye),f(T,N,F),f(T,K,F),e(K,te),f(T,Te,F),f(T,j,F),e(j,M),e(M,je),e(M,oe),e(oe,ne),e(M,Me),e(M,se),e(se,ae),e(j,Ne),e(j,G),e(G,we),e(G,O),e(O,Ae),e(G,re),e(G,ie),e(ie,De),e(j,de),e(j,J),e(J,Ie),e(J,Z),e(Z,Y)},d(T){T&&t(h),T&&t(_),T&&t(m),T&&t(z),T&&t(q),T&&t(N),T&&t(K),T&&t(Te),T&&t(j)}}}function ih(P){let h,b,_,m,v;return{c(){h=a("p"),b=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),_=a("code"),m=n("Module"),v=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(d){h=r(d,"P",{});var g=i(h);b=s(g,"Although the recipe for forward pass needs to be defined within this function, one should call the "),_=r(g,"CODE",{});var E=i(_);m=s(E,"Module"),E.forEach(t),v=s(g,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),{c(){h=a("p"),b=n("Example:"),_=l(),x(m.$$.fragment)},l(d){h=r(d,"P",{});var g=i(h);b=s(g,"Example:"),g.forEach(t),_=p(d),k(m.$$.fragment,d)},m(d,g){f(d,h,g),e(h,b),f(d,_,g),y(m,d,g),v=!0},p:Zs,i(d){v||(w(m.$$.fragment,d),v=!0)},o(d){S(m.$$.fragment,d),v=!1},d(d){d&&t(h),d&&t(_),$(m,d)}}}function ch(P){let h,b,_,m,v,d,g,E,A,z,q,L,H,ee,Pe,B,Ce,ye,N,K,te,Te,j,M,je,oe,ne,Me,se,ae,Ne,G,we,O,Ae,re,ie,De,de,J,Ie,Z,Y;return{c(){h=a("p"),b=n("TF 2.0 models accepts two formats as inputs:"),_=l(),m=a("ul"),v=a("li"),d=n("having all inputs as keyword arguments (like PyTorch models), or"),g=l(),E=a("li"),A=n("having all inputs as a list, tuple or dict in the first positional arguments."),z=l(),q=a("p"),L=n("This second option is useful when using "),H=a("code"),ee=n("tf.keras.Model.fit"),Pe=n(` method which currently requires having all the
tensors in the first argument of the model call function: `),B=a("code"),Ce=n("model(inputs)"),ye=n("."),N=l(),K=a("p"),te=n(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),Te=l(),j=a("ul"),M=a("li"),je=n("a single Tensor with "),oe=a("code"),ne=n("input_ids"),Me=n(" only and nothing else: "),se=a("code"),ae=n("model(input_ids)"),Ne=l(),G=a("li"),we=n(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),O=a("code"),Ae=n("model([input_ids, attention_mask])"),re=n(" or "),ie=a("code"),De=n("model([input_ids, attention_mask, token_type_ids])"),de=l(),J=a("li"),Ie=n(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),Z=a("code"),Y=n('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(T){h=r(T,"P",{});var F=i(h);b=s(F,"TF 2.0 models accepts two formats as inputs:"),F.forEach(t),_=p(T),m=r(T,"UL",{});var X=i(m);v=r(X,"LI",{});var Ze=i(v);d=s(Ze,"having all inputs as keyword arguments (like PyTorch models), or"),Ze.forEach(t),g=p(X),E=r(X,"LI",{});var Le=i(E);A=s(Le,"having all inputs as a list, tuple or dict in the first positional arguments."),Le.forEach(t),X.forEach(t),z=p(T),q=r(T,"P",{});var Q=i(q);L=s(Q,"This second option is useful when using "),H=r(Q,"CODE",{});var Re=i(H);ee=s(Re,"tf.keras.Model.fit"),Re.forEach(t),Pe=s(Q,` method which currently requires having all the
...
<span class="hljs-meta">&gt;&gt;&gt; </span>transcription = processor.batch_decode(generated_ids)`}}),{c(){h=a("p"),b=n("Example:"),_=l(),x(m.$$.fragment)},l(d){h=r(d,"P",{});var g=i(h);b=s(g,"Example:"),g.forEach(t),_=p(d),k(m.$$.fragment,d)},m(d,g){f(d,h,g),e(h,b),f(d,_,g),y(m,d,g),v=!0},p:Zs,i(d){v||(w(m.$$.fragment,d),v=!0)},o(d){S(m.$$.fragment,d),v=!1},d(d){d&&t(h),d&&t(_),$(m,d)}}}function hh(P){let h,b,_,m,v,d,g,E,A,z,q,L,H,ee,Pe,B,Ce,ye,N,K,te,Te,j,M,je,oe,ne,Me,se,ae,Ne,G,we,O,Ae,re,ie,De,de,J,Ie,Z,Y,T,F,X,Ze,Le,Q,Re,ue,et,U,ce,tt,Ve,C,ot,Se,Oe,nt,pn,or,nr,hn,sr,ar,mn,rr,ir,ea,W,dr,Yn,cr,lr,Xn,pr,hr,Qn,mr,fr,Zn,ur,_r,es,gr,Tr,oo,vr,br,ts,xr,ta,fn,os,kr,oa,no,na,un,so,ns,yr,wr,le,Sr,ss,$r,Er,as,qr,zr,rs,Fr,Pr,is,Cr,jr,ds,Mr,Nr,sa,ao,aa,Tt,Ar,ro,Dr,Ir,ra,st,vt,cs,io,Lr,ls,Or,ia,ve,co,Gr,at,Ur,_n,Wr,Rr,lo,Vr,Hr,Br,rt,Kr,gn,Jr,Yr,Tn,Xr,Qr,Zr,bt,da,it,xt,ps,po,ei,hs,ti,ca,R,ho,oi,ms,ni,si,mo,ai,vn,ri,ii,di,kt,fo,ci,fs,li,pi,yt,uo,hi,_o,mi,us,fi,ui,_i,He,go,gi,bn,Ti,xn,vi,bi,_s,xi,ki,kn,To,la,dt,wt,gs,vo,yi,Ts,wi,pa,pe,bo,Si,vs,$i,Ei,xo,qi,yn,zi,Fi,Pi,bs,Ci,ji,St,ko,Mi,xs,Ni,ha,ct,$t,ks,yo,Ai,ys,Di,ma,D,wo,Ii,ws,Li,Oi,_e,wn,Gi,Ui,Sn,Wi,Ri,$n,Vi,Hi,So,Ss,Bi,Ki,Ji,En,Yi,Xi,Qi,Et,$o,Zi,Ge,ed,Eo,$s,td,od,nd,qn,sd,ad,qo,Es,rd,id,dd,cd,Be,zo,ld,qs,pd,hd,qt,md,Ke,Fo,fd,Po,ud,zn,_d,gd,Td,zt,vd,Ft,Co,bd,jo,xd,Fn,kd,yd,wd,Pt,Mo,Sd,No,$d,Pn,Ed,qd,zd,Ct,Ao,Fd,zs,Pd,fa,lt,jt,Fs,Do,Cd,Ps,jd,ua,be,Io,Md,Lo,Nd,Cn,Ad,Dd,Id,Oo,Ld,Go,Od,Gd,Ud,$e,Uo,Wd,pt,Rd,jn,Vd,Hd,Cs,Bd,Kd,Jd,Mt,Yd,Nt,_a,ht,At,js,Wo,Xd,Ms,Qd,ga,xe,Ro,Zd,Vo,ec,Mn,tc,oc,nc,Ho,sc,Bo,ac,rc,ic,Ee,Ko,dc,mt,cc,Nn,lc,pc,Ns,hc,mc,fc,Dt,uc,It,Ta,ft,Lt,As,Jo,_c,Ds,gc,va,he,Yo,Tc,Xo,vc,An,bc,xc,kc,Qo,yc,Zo,wc,Sc,$c,Ot,Ec,qe,en,qc,ut,zc,Dn,Fc,Pc,Is,Cc,jc,Mc,Gt,Nc,Ut,ba,_t,Wt,Ls,tn,Ac,Os,Dc,xa,me,on,Ic,nn,Lc,In,Oc,Gc,Uc,sn,Wc,an,Rc,Vc,Hc,Rt,Bc,ze,rn,Kc,gt,Jc,Ln,Yc,Xc,Gs,Qc,Zc,el,Vt,tl,Ht,ka;return d=new We({}),ee=new We({}),X=new We({}),no=new ln({props:{code:`import torch
from transformers import Speech2TextProcessor, Speech2TextForConditionalGeneration
from datasets import load_dataset
...
behaviors between training and evaluation).`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/speech_to_text/modeling_tf_speech_to_text.py#L1259",returnDescription:`
<p>A <a
...
(masked), the loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/speech_to_text/modeling_tf_speech_to_text.py#L1354",returnDescription:`
<p>A <a
...
`}}),Vt=new to({props:{$$slots:{default:[lh]},$$scope:{ctx:P}}}),Ht=new Qs({props:{anchor:"transformers.TFSpeech2TextForConditionalGeneration.call.example",$$slots:{default:[ph]},$$scope:{ctx:P}}}),{c(){h=a("meta"),b=l(),_=a("h1"),m=a("a"),v=a("span"),x(d.$$.fragment),g=l(),E=a("span"),A=n("Speech2Text"),z=l(),q=a("h2"),L=a("a"),H=a("span"),x(ee.$$.fragment),Pe=l(),B=a("span"),Ce=n("Overview"),ye=l(),N=a("p"),K=n("The Speech2Text model was proposed in "),te=a("a"),Te=n("fairseq S2T: Fast Speech-to-Text Modeling with fairseq"),j=n(` by Changhan Wang, Yun Tang, Xutai Ma, Anne Wu, Dmytro Okhonko, Juan Pino. It\u2019s a
transformer-based seq2seq (encoder-decoder) model designed for end-to-end Automatic Speech Recognition (ASR) and Speech
Translation (ST). It uses a convolutional downsampler to reduce the length of speech inputs by 3/4th before they are
fed into the encoder. The model is trained with standard autoregressive cross-entropy loss and generates the
transcripts/translations autoregressively. Speech2Text has been fine-tuned on several datasets for ASR and ST:
`),M=a("a"),je=n("LibriSpeech"),oe=n(", "),ne=a("a"),Me=n("CoVoST 2"),se=n(", "),ae=a("a"),Ne=n("MuST-C"),G=n("."),we=l(),O=a("p"),Ae=n("This model was contributed by "),re=a("a"),ie=n("valhalla"),De=n(". The original code can be found "),de=a("a"),J=n("here"),Ie=n("."),Z=l(),Y=a("h2"),T=a("a"),F=a("span"),x(X.$$.fragment),Ze=l(),Le=a("span"),Q=n("Inference"),Re=l(),ue=a("p"),et=n(`Speech2Text is a speech model that accepts a float tensor of log-mel filter-bank features extracted from the speech
...
`),Qn=a("code"),mr=n('pip install transformers"[speech, sentencepiece]"'),fr=n(" or install the packages separately with "),Zn=a("code"),ur=n("pip install torchaudio sentencepiece"),_r=n(". Also "),es=a("code"),gr=n("torchaudio"),Tr=n(" requires the development version of the "),oo=a("a"),vr=n("libsndfile"),br=n(` package which can be installed via a system package manager. On Ubuntu it can
...
generated token, pass the `),rs=a("code"),Fr=n("forced_bos_token_id"),Pr=n(" parameter to the "),is=a("code"),Cr=n("generate()"),jr=n(` method. The following
...
information.`),cd=l(),Be=a("div"),x(zo.$$.fragment),ld=l(),qs=a("p"),pd=n("Instantiate a processor associated with a pretrained model."),hd=l(),x(qt.$$.fragment),md=l(),Ke=a("div"),x(Fo.$$.fragment),fd=l(),Po=a("p"),ud=n(`Saves the attributes of this processor (feature extractor, tokenizer\u2026) in the specified directory so that it
can be reloaded using the `),zn=a("a"),_d=n("from_pretrained()"),gd=n(" method."),Td=l(),x(zt.$$.fragment),vd=l(),Ft=a("div"),x(Co.$$.fragment),bd=l(),jo=a("p"),xd=n("This method forwards all its arguments to Speech2TextTokenizer\u2019s "),Fn=a("a"),kd=n("batch_decode()"),yd=n(`. Please
...
to the docstring of this method for more information.`),zd=l(),Ct=a("div"),x(Ao.$$.fragment),Fd=l(),zs=a("p"),Pd=n(`Temporarily sets the tokenizer for processing the input. Useful for encoding the labels when fine-tuning
Speech2Text.`),fa=l(),lt=a("h2"),jt=a("a"),Fs=a("span"),x(Do.$$.fragment),Cd=l(),Ps=a("span"),jd=n("Speech2TextModel"),ua=l(),be=a("div"),x(Io.$$.fragment),Md=l(),Lo=a("p"),Nd=n(`The bare Speech2Text Model outputting raw hidden-states without any specific head on top.
...
behavior.`),$c=l(),x(Ot.$$.fragment),Ec=l(),qe=a("div"),x(en.$$.fragment),qc=l(),ut=a("p"),zc=n("The "),Dn=a("a"),Fc=n("TFSpeech2TextModel"),Pc=n(" forward method, overrides the "),Is=a("code"),Cc=n("__call__"),jc=n(" special method."),Mc=l(),x(Gt.$$.fragment),Nc=l(),x(Ut.$$.fragment),ba=l(),_t=a("h2"),Wt=a("a"),Ls=a("span"),x(tn.$$.fragment),Ac=l(),Os=a("span"),Dc=n("TFSpeech2TextForConditionalGeneration"),xa=l(),me=a("div"),x(on.$$.fragment),Ic=l(),nn=a("p"),Lc=n(`The Speech2Text Model with a language modeling head. Can be used for summarization.
...
install those packages before running the examples. You could either install those as extra speech dependencies with
`),Qn=r(fe,"CODE",{});var Tl=i(Qn);mr=s(Tl,'pip install transformers"[speech, sentencepiece]"'),Tl.forEach(t),fr=s(fe," or install the packages separately with "),Zn=r(fe,"CODE",{});var vl=i(Zn);ur=s(vl,"pip install torchaudio sentencepiece"),vl.forEach(t),_r=s(fe,". Also "),es=r(fe,"CODE",{});var bl=i(es);gr=s(bl,"torchaudio"),bl.forEach(t),Tr=s(fe," requires the development version of the "),oo=r(fe,"A",{href:!0,rel:!0});var xl=i(oo);vr=s(xl,"libsndfile"),xl.forEach(t),br=s(fe,` package which can be installed via a system package manager. On Ubuntu it can
be installed as follows: `),ts=r(fe,"CODE",{});var kl=i(ts);xr=s(kl,"apt install libsndfile1-dev"),kl.forEach(t),fe.forEach(t),ta=p(o),fn=r(o,"UL",{});var yl=i(fn);os=r(yl,"LI",{});var wl=i(os);kr=s(wl,"ASR and Speech Translation"),wl.forEach(t),yl.forEach(t),oa=p(o),k(no.$$.fragment,o),na=p(o),un=r(o,"UL",{});var Sl=i(un);so=r(Sl,"LI",{});var Sa=i(so);ns=r(Sa,"P",{});var $l=i(ns);yr=s($l,"Multilingual speech translation"),$l.forEach(t),wr=p(Sa),le=r(Sa,"P",{});var Fe=i(le);Sr=s(Fe,"For multilingual speech translation models, "),ss=r(Fe,"CODE",{});var El=i(ss);$r=s(El,"eos_token_id"),El.forEach(t),Er=s(Fe," is used as the "),as=r(Fe,"CODE",{});var ql=i(as);qr=s(ql,"decoder_start_token_id"),ql.forEach(t),zr=s(Fe,` and
the target language id is forced as the first generated token. To force the target language id as the first
generated token, pass the `),rs=r(Fe,"CODE",{});var zl=i(rs);Fr=s(zl,"forced_bos_token_id"),zl.forEach(t),Pr=s(Fe," parameter to the "),is=r(Fe,"CODE",{});var Fl=i(is);Cr=s(Fl,"generate()"),Fl.forEach(t),jr=s(Fe,` method. The following
example shows how to transate English speech to French text using the `),ds=r(Fe,"EM",{});var Pl=i(ds);Mr=s(Pl,"facebook/s2t-medium-mustc-multilingual-st"),Pl.forEach(t),Nr=s(Fe,`
checkpoint.`),Fe.forEach(t),Sa.forEach(t),Sl.forEach(t),sa=p(o),k(ao.$$.fragment,o),aa=p(o),Tt=r(o,"P",{});var $a=i(Tt);Ar=s($a,"See the "),ro=r($a,"A",{href:!0,rel:!0});var Cl=i(ro);Dr=s(Cl,"model hub"),Cl.forEach(t),Ir=s($a," to look for Speech2Text checkpoints."),$a.forEach(t),ra=p(o),st=r(o,"H2",{class:!0});var Ea=i(st);vt=r(Ea,"A",{id:!0,class:!0,href:!0});var jl=i(vt);cs=r(jl,"SPAN",{});var Ml=i(cs);k(io.$$.fragment,Ml),Ml.forEach(t),jl.forEach(t),Lr=p(Ea),ls=r(Ea,"SPAN",{});var Nl=i(ls);Or=s(Nl,"Speech2TextConfig"),Nl.forEach(t),Ea.forEach(t),ia=p(o),ve=r(o,"DIV",{class:!0});var Bt=i(ve);k(co.$$.fragment,Bt),Gr=p(Bt),at=r(Bt,"P",{});var Gn=i(at);Ur=s(Gn,"This is the configuration class to store the configuration of a "),_n=r(Gn,"A",{href:!0});var Al=i(_n);Wr=s(Al,"Speech2TextModel"),Al.forEach(t),Rr=s(Gn,`. It is used to instantiate an
Speech2Text model according to the specified arguments, defining the model architecture. Instantiating a
configuration with the defaults will yield a similar configuration to that of the Speech2Text
...
information.`),Kt.forEach(t),Da.forEach(t),cd=p(V),Be=r(V,"DIV",{class:!0});var Rn=i(Be);k(zo.$$.fragment,Rn),ld=p(Rn),qs=r(Rn,"P",{});var up=i(qs);pd=s(up,"Instantiate a processor associated with a pretrained model."),up.forEach(t),hd=p(Rn),k(qt.$$.fragment,Rn),Rn.forEach(t),md=p(V),Ke=r(V,"DIV",{class:!0});var Vn=i(Ke);k(Fo.$$.fragment,Vn),fd=p(Vn),Po=r(Vn,"P",{});var Ia=i(Po);ud=s(Ia,`Saves the attributes of this processor (feature extractor, tokenizer\u2026) in the specified directory so that it
can be reloaded using the `),zn=r(Ia,"A",{href:!0});var _p=i(zn);_d=s(_p,"from_pretrained()"),_p.forEach(t),gd=s(Ia," method."),Ia.forEach(t),Td=p(Vn),k(zt.$$.fragment,Vn),Vn.forEach(t),vd=p(V),Ft=r(V,"DIV",{class:!0});var La=i(Ft);k(Co.$$.fragment,La),bd=p(La),jo=r(La,"P",{});var Oa=i(jo);xd=s(Oa,"This method forwards all its arguments to Speech2TextTokenizer\u2019s "),Fn=r(Oa,"A",{href:!0});var gp=i(Fn);kd=s(gp,"batch_decode()"),gp.forEach(t),yd=s(Oa,`. Please
...
to the docstring of this method for more information.`),Ua.forEach(t),Ga.forEach(t),zd=p(V),Ct=r(V,"DIV",{class:!0});var Wa=i(Ct);k(Ao.$$.fragment,Wa),Fd=p(Wa),zs=r(Wa,"P",{});var vp=i(zs);Pd=s(vp,`Temporarily sets the tokenizer for processing the input. Useful for encoding the labels when fine-tuning
Speech2Text.`),vp.forEach(t),Wa.forEach(t),V.forEach(t),fa=p(o),lt=r(o,"H2",{class:!0});var Ra=i(lt);jt=r(Ra,"A",{id:!0,class:!0,href:!0});var bp=i(jt);Fs=r(bp,"SPAN",{});var xp=i(Fs);k(Do.$$.fragment,xp),xp.forEach(t),bp.forEach(t),Cd=p(Ra),Ps=r(Ra,"SPAN",{});var kp=i(Ps);jd=s(kp,"Speech2TextModel"),kp.forEach(t),Ra.forEach(t),ua=p(o),be=r(o,"DIV",{class:!0});var Jt=i(be);k(Io.$$.fragment,Jt),Md=p(Jt),Lo=r(Jt,"P",{});var Va=i(Lo);Nd=s(Va,`The bare Speech2Text Model outputting raw hidden-states without any specific head on top.
