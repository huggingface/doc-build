...
`),d=r(j,"CODE",{});var I=i(d);m=s(I,"from_pretrained"),I.forEach(t),F=s(j,` methods. Please refer to the docstrings of the
methods above for more information.`),j.forEach(t),this.h()},h(){l(_,"href","/docs/transformers/main/en/main_classes/feature_extractor#transformers.FeatureExtractionMixin.from_pretrained")},m(D,j){u(D,c,j),e(c,b),e(c,_),e(_,g),e(c,v),e(c,d),e(d,m),e(c,F)},d(D){D&&t(c)}}}function Kp(P){let c,b,_,g,v,d,m,F;return{c(){c=a("p"),b=n("This class method is simply calling "),_=a("a"),g=n("save_pretrained()"),v=n(` and
`),d=a("code"),m=n("save_pretrained"),F=n(`. Please refer to the docstrings of the methods
...
<span class="hljs-string">&#x27;mister quilter is the apostle of the middle classes and we are glad to welcome his gospel&#x27;</span>`}}),{c(){c=a("p"),b=n("Example:"),_=p(),x(g.$$.fragment)},l(d){c=r(d,"P",{});var m=i(c);b=s(m,"Example:"),m.forEach(t),_=h(d),y(g.$$.fragment,d)},m(d,m){u(d,c,m),e(c,b),u(d,_,m),k(g,d,m),v=!0},p:la,i(d){v||(w(g.$$.fragment,d),v=!0)},o(d){S(g.$$.fragment,d),v=!1},d(d){d&&t(c),d&&t(_),$(g,d)}}}function Qp(P){let c,b,_,g,v,d,m,F,D,j,M,I,ne,E,Ge,Q,Ue,je,A,We,se,ae,Re,re,ie,Ve,de,le,He,ce,Se,N,L,Y,pe,he,Ke,me,ue,Be,U,Pe,W,ee,$e,B,Je,Ee,Z,Me,H,Ye,fe,R,Xe,K,O,Qe;return{c(){c=a("p"),b=n("TensorFlow models and layers in "),_=a("code"),g=n("transformers"),v=n(" accept two formats as input:"),d=p(),m=a("ul"),F=a("li"),D=n("having all inputs as keyword arguments (like PyTorch models), or"),j=p(),M=a("li"),I=n("having all inputs as a list, tuple or dict in the first positional argument."),ne=p(),E=a("p"),Ge=n(`The reason the second format is supported is that Keras methods prefer this format when passing inputs to models
...
positional argument:`),Se=p(),N=a("ul"),L=a("li"),Y=n("a single Tensor with "),pe=a("code"),he=n("input_ids"),Ke=n(" only and nothing else: "),me=a("code"),ue=n("model(input_ids)"),Be=p(),U=a("li"),Pe=n(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
...
positional argument:`),z.forEach(t),Se=h(T),N=r(T,"UL",{});var X=i(N);L=r(X,"LI",{});var C=i(L);Y=s(C,"a single Tensor with "),pe=r(C,"CODE",{});var vt=i(pe);he=s(vt,"input_ids"),vt.forEach(t),Ke=s(C," only and nothing else: "),me=r(C,"CODE",{});var Ze=i(me);ue=s(Ze,"model(input_ids)"),Ze.forEach(t),C.forEach(t),Be=h(X),U=r(X,"LI",{});var _e=i(U);Pe=s(_e,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
...
`),H=r(tt,"CODE",{});var xt=i(H);Ye=s(xt,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),xt.forEach(t),tt.forEach(t),X.forEach(t),fe=h(T),R=r(T,"P",{});var ge=i(R);Xe=s(ge,`Note that when creating models and layers with
`),K=r(ge,"A",{href:!0,rel:!0});var yt=i(K);O=s(yt,"subclassing"),yt.forEach(t),Qe=s(ge,` then you don\u2019t need to worry
about any of this, as you can just pass inputs like you would to any other Python function!`),ge.forEach(t),this.h()},h(){l(K,"href","https://keras.io/guides/making_new_layers_and_models_via_subclassing/"),l(K,"rel","nofollow")},m(T,q){u(T,c,q),e(c,b),e(c,_),e(_,g),e(c,v),u(T,d,q),u(T,m,q),e(m,F),e(F,D),e(m,j),e(m,M),e(M,I),u(T,ne,q),u(T,E,q),e(E,Ge),e(E,Q),e(Q,Ue),e(E,je),e(E,A),e(A,We),e(E,se),e(E,ae),e(ae,Re),e(E,re),e(E,ie),e(ie,Ve),e(E,de),e(E,le),e(le,He),e(E,ce),u(T,Se,q),u(T,N,q),e(N,L),e(L,Y),e(L,pe),e(pe,he),e(L,Ke),e(L,me),e(me,ue),e(N,Be),e(N,U),e(U,Pe),e(U,W),e(W,ee),e(U,$e),e(U,B),e(B,Je),e(N,Ee),e(N,Z),e(Z,Me),e(Z,H),e(H,Ye),u(T,fe,q),u(T,R,q),e(R,Xe),e(R,K),e(K,O),e(R,Qe)},d(T){T&&t(c),T&&t(d),T&&t(m),T&&t(ne),T&&t(E),T&&t(Se),T&&t(N),T&&t(fe),T&&t(R)}}}function Zp(P){let c,b,_,g,v;return{c(){c=a("p"),b=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),_=a("code"),g=n("Module"),v=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(d){c=r(d,"P",{});var m=i(c);b=s(m,"Although the recipe for forward pass needs to be defined within this function, one should call the "),_=r(m,"CODE",{});var F=i(_);g=s(F,"Module"),F.forEach(t),v=s(m,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),{c(){c=a("p"),b=n("Example:"),_=p(),x(g.$$.fragment)},l(d){c=r(d,"P",{});var m=i(c);b=s(m,"Example:"),m.forEach(t),_=h(d),y(g.$$.fragment,d)},m(d,m){u(d,c,m),e(c,b),u(d,_,m),k(g,d,m),v=!0},p:la,i(d){v||(w(g.$$.fragment,d),v=!0)},o(d){S(g.$$.fragment,d),v=!1},d(d){d&&t(c),d&&t(_),$(g,d)}}}function th(P){let c,b,_,g,v,d,m,F,D,j,M,I,ne,E,Ge,Q,Ue,je,A,We,se,ae,Re,re,ie,Ve,de,le,He,ce,Se,N,L,Y,pe,he,Ke,me,ue,Be,U,Pe,W,ee,$e,B,Je,Ee,Z,Me,H,Ye,fe,R,Xe,K,O,Qe;return{c(){c=a("p"),b=n("TensorFlow models and layers in "),_=a("code"),g=n("transformers"),v=n(" accept two formats as input:"),d=p(),m=a("ul"),F=a("li"),D=n("having all inputs as keyword arguments (like PyTorch models), or"),j=p(),M=a("li"),I=n("having all inputs as a list, tuple or dict in the first positional argument."),ne=p(),E=a("p"),Ge=n(`The reason the second format is supported is that Keras methods prefer this format when passing inputs to models
and layers. Because of this support, when using methods like `),Q=a("code"),Ue=n("model.fit()"),je=n(` things should \u201Cjust work\u201D for you - just
pass your inputs and labels in any format that `),A=a("code"),We=n("model.fit()"),se=n(` supports! If, however, you want to use the second
format outside of Keras methods like `),ae=a("code"),Re=n("fit()"),re=n(" and "),ie=a("code"),Ve=n("predict()"),de=n(`, such as when creating your own layers or models with
the Keras `),le=a("code"),He=n("Functional"),ce=n(` API, there are three possibilities you can use to gather all the input Tensors in the first
...
<span class="hljs-meta">&gt;&gt;&gt; </span>transcription = processor.batch_decode(generated_ids)`}}),{c(){c=a("p"),b=n("Example:"),_=p(),x(g.$$.fragment)},l(d){c=r(d,"P",{});var m=i(c);b=s(m,"Example:"),m.forEach(t),_=h(d),y(g.$$.fragment,d)},m(d,m){u(d,c,m),e(c,b),u(d,_,m),k(g,d,m),v=!0},p:la,i(d){v||(w(g.$$.fragment,d),v=!0)},o(d){S(g.$$.fragment,d),v=!1},d(d){d&&t(c),d&&t(_),$(g,d)}}}function sh(P){let c,b,_,g,v,d,m,F,D,j,M,I,ne,E,Ge,Q,Ue,je,A,We,se,ae,Re,re,ie,Ve,de,le,He,ce,Se,N,L,Y,pe,he,Ke,me,ue,Be,U,Pe,W,ee,$e,B,Je,Ee,Z,Me,H,Ye,fe,R,Xe,K,O,Qe,T,q,ht,te,mt,ut,z,ft,_t,Ae,gt,Tt,X,C,vt,Ze,_e,bt,et,tt,xt,ge,yt,cr,ls,pr,hr,cs,mr,ur,xo,fr,_r,ps,gr,ca,Fn,hs,Tr,pa,yo,ha,qn,ko,ms,vr,br,Te,xr,us,yr,kr,fs,wr,Sr,_s,$r,Er,gs,Fr,qr,Ts,zr,Cr,ma,wo,ua,Dt,jr,So,Pr,Mr,fa,kt,It,vs,$o,Ar,bs,Nr,_a,Fe,Eo,Dr,wt,Ir,zn,Lr,Or,Fo,Gr,Ur,Wr,St,Rr,Cn,Vr,Hr,jn,Kr,Br,Jr,Lt,ga,$t,Ot,xs,qo,Yr,ys,Xr,Ta,J,zo,Qr,ks,Zr,ei,Co,ti,Pn,oi,ni,si,Gt,jo,ai,ws,ri,ii,Ut,Po,di,Mo,li,Ss,ci,pi,hi,at,Ao,mi,Mn,ui,An,fi,_i,$s,gi,Ti,Nn,No,va,Et,Wt,Es,Do,vi,Fs,bi,ba,ve,Io,xi,qs,yi,ki,Lo,wi,Dn,Si,$i,Ei,zs,Fi,qi,Rt,Oo,zi,Cs,Ci,xa,Ft,Vt,js,Go,ji,Ps,Pi,ya,V,Uo,Mi,Ms,Ai,Ni,ke,In,Di,Ii,Ln,Li,Oi,On,Gi,Ui,Wo,As,Wi,Ri,Vi,Gn,Hi,Ki,Bi,Ht,Ro,Ji,ot,Yi,Vo,Ns,Xi,Qi,Zi,Ds,ed,td,Ho,Is,od,nd,sd,ad,rt,Ko,rd,Ls,id,dd,Kt,ld,it,Bo,cd,Jo,pd,Un,hd,md,ud,Bt,fd,Jt,Yo,_d,Xo,gd,Wn,Td,vd,bd,Yt,Qo,xd,Zo,yd,Rn,kd,wd,ka,qt,Xt,Os,en,Sd,Gs,$d,wa,qe,tn,Ed,on,Fd,Vn,qd,zd,Cd,nn,jd,sn,Pd,Md,Ad,Ne,an,Nd,zt,Dd,Hn,Id,Ld,Us,Od,Gd,Ud,Qt,Wd,Zt,Sa,Ct,eo,Ws,rn,Rd,Rs,Vd,$a,ze,dn,Hd,ln,Kd,Kn,Bd,Jd,Yd,cn,Xd,pn,Qd,Zd,el,De,hn,tl,jt,ol,Bn,nl,sl,Vs,al,rl,il,to,dl,oo,Ea,Pt,no,Hs,mn,ll,Ks,cl,Fa,be,un,pl,fn,hl,Jn,ml,ul,fl,_n,_l,gn,gl,Tl,vl,so,bl,Ie,Tn,xl,Mt,yl,Yn,kl,wl,Bs,Sl,$l,El,ao,Fl,ro,qa,At,io,Js,vn,ql,Ys,zl,za,xe,bn,Cl,xn,jl,Xn,Pl,Ml,Al,yn,Nl,kn,Dl,Il,Ll,lo,Ol,Le,wn,Gl,Nt,Ul,Qn,Wl,Rl,Xs,Vl,Hl,Kl,co,Bl,po,Ca;return d=new st({}),E=new st({}),B=new st({}),yo=new En({props:{code:`import torch
from transformers import Speech2TextProcessor, Speech2TextForConditionalGeneration
from datasets import load_dataset
...
`}}),co=new bo({props:{$$slots:{default:[oh]},$$scope:{ctx:P}}}),po=new da({props:{anchor:"transformers.TFSpeech2TextForConditionalGeneration.call.example",$$slots:{default:[nh]},$$scope:{ctx:P}}}),{c(){c=a("meta"),b=p(),_=a("h1"),g=a("a"),v=a("span"),x(d.$$.fragment),m=p(),F=a("span"),D=n("Speech2Text"),j=p(),M=a("h2"),I=a("a"),ne=a("span"),x(E.$$.fragment),Ge=p(),Q=a("span"),Ue=n("Overview"),je=p(),A=a("p"),We=n("The Speech2Text model was proposed in "),se=a("a"),ae=n("fairseq S2T: Fast Speech-to-Text Modeling with fairseq"),Re=n(` by Changhan Wang, Yun Tang, Xutai Ma, Anne Wu, Dmytro Okhonko, Juan Pino. It\u2019s a
transformer-based seq2seq (encoder-decoder) model designed for end-to-end Automatic Speech Recognition (ASR) and Speech
Translation (ST). It uses a convolutional downsampler to reduce the length of speech inputs by 3/4th before they are
fed into the encoder. The model is trained with standard autoregressive cross-entropy loss and generates the
transcripts/translations autoregressively. Speech2Text has been fine-tuned on several datasets for ASR and ST:
`),re=a("a"),ie=n("LibriSpeech"),Ve=n(", "),de=a("a"),le=n("CoVoST 2"),He=n(", "),ce=a("a"),Se=n("MuST-C"),N=n("."),L=p(),Y=a("p"),pe=n("This model was contributed by "),he=a("a"),Ke=n("valhalla"),me=n(". The original code can be found "),ue=a("a"),Be=n("here"),U=n("."),Pe=p(),W=a("h2"),ee=a("a"),$e=a("span"),x(B.$$.fragment),Je=p(),Ee=a("span"),Z=n("Inference"),Me=p(),H=a("p"),Ye=n(`Speech2Text is a speech model that accepts a float tensor of log-mel filter-bank features extracted from the speech
...
predicted token ids.`),X=p(),C=a("p"),vt=n("The feature extractor depends on "),Ze=a("code"),_e=n("torchaudio"),bt=n(" and the tokenizer depends on "),et=a("code"),tt=n("sentencepiece"),xt=n(` so be sure to
...
checkpoint.`),ma=p(),x(wo.$$.fragment),ua=p(),Dt=a("p"),jr=n("See the "),So=a("a"),Pr=n("model hub"),Mr=n(" to look for Speech2Text checkpoints."),fa=p(),kt=a("h2"),It=a("a"),vs=a("span"),x($o.$$.fragment),Ar=p(),bs=a("span"),Nr=n("Speech2TextConfig"),_a=p(),Fe=a("div"),x(Eo.$$.fragment),Dr=p(),wt=a("p"),Ir=n("This is the configuration class to store the configuration of a "),zn=a("a"),Lr=n("Speech2TextModel"),Or=n(`. It is used to instantiate an
Speech2Text model according to the specified arguments, defining the model architecture. Instantiating a
configuration with the defaults will yield a similar configuration to that of the Speech2Text
`),Fo=a("a"),Gr=n("facebook/s2t-small-librispeech-asr"),Ur=n(" architecture."),Wr=p(),St=a("p"),Rr=n("Configuration objects inherit from "),Cn=a("a"),Vr=n("PretrainedConfig"),Hr=n(` and can be used to control the model outputs. Read the
documentation from `),jn=a("a"),Kr=n("PretrainedConfig"),Br=n(" for more information."),Jr=p(),x(Lt.$$.fragment),ga=p(),$t=a("h2"),Ot=a("a"),xs=a("span"),x(qo.$$.fragment),Yr=p(),ys=a("span"),Xr=n("Speech2TextTokenizer"),Ta=p(),J=a("div"),x(zo.$$.fragment),Qr=p(),ks=a("p"),Zr=n("Construct an Speech2Text tokenizer."),ei=p(),Co=a("p"),ti=n("This tokenizer inherits from "),Pn=a("a"),oi=n("PreTrainedTokenizer"),ni=n(` which contains some of the main methods. Users should refer to
the superclass for more information regarding such methods.`),si=p(),Gt=a("div"),x(jo.$$.fragment),ai=p(),ws=a("p"),ri=n("Build model inputs from a sequence by appending eos_token_id."),ii=p(),Ut=a("div"),x(Po.$$.fragment),di=p(),Mo=a("p"),li=n(`Retrieve sequence ids from a token list that has no special tokens added. This method is called when adding
...
mean and variance normalization to the extracted features.`),qi=p(),Rt=a("div"),x(Oo.$$.fragment),zi=p(),Cs=a("p"),Ci=n("Main method to featurize and prepare for the model one or several sequence(s). sequences."),xa=p(),Ft=a("h2"),Vt=a("a"),js=a("span"),x(Go.$$.fragment),ji=p(),Ps=a("span"),Pi=n("Speech2TextProcessor"),ya=p(),V=a("div"),x(Uo.$$.fragment),Mi=p(),Ms=a("p"),Ai=n(`Constructs a Speech2Text processor which wraps a Speech2Text feature extractor and a Speech2Text tokenizer into a
...
`),On=a("a"),Gi=n("Speech2TextTokenizer"),Ui=n(". See the "),Wo=a("a"),As=a("strong"),Wi=n("call"),Ri=n("()"),Vi=n(" and "),Gn=a("a"),Hi=n("decode()"),Ki=n(` for more
information.`),Bi=p(),Ht=a("div"),x(Ro.$$.fragment),Ji=p(),ot=a("p"),Yi=n(`When used in normal mode, this method forwards all its arguments to Speech2TextFeatureExtractor\u2019s
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),el=p(),De=a("div"),x(hn.$$.fragment),tl=p(),jt=a("p"),ol=n("The "),Bn=a("a"),nl=n("Speech2TextForConditionalGeneration"),sl=n(" forward method, overrides the "),Vs=a("code"),al=n("__call__"),rl=n(" special method."),il=p(),x(to.$$.fragment),dl=p(),x(oo.$$.fragment),Ea=p(),Pt=a("h2"),no=a("a"),Hs=a("span"),x(mn.$$.fragment),ll=p(),Ks=a("span"),cl=n("TFSpeech2TextModel"),Fa=p(),be=a("div"),x(un.$$.fragment),pl=p(),fn=a("p"),hl=n(`The bare Speech2Text Model outputting raw hidden-states without any specific head on top.
...
behavior.`),vl=p(),x(so.$$.fragment),bl=p(),Ie=a("div"),x(Tn.$$.fragment),xl=p(),Mt=a("p"),yl=n("The "),Yn=a("a"),kl=n("TFSpeech2TextModel"),wl=n(" forward method, overrides the "),Bs=a("code"),Sl=n("__call__"),$l=n(" special method."),El=p(),x(ao.$$.fragment),Fl=p(),x(ro.$$.fragment),qa=p(),At=a("h2"),io=a("a"),Js=a("span"),x(vn.$$.fragment),ql=p(),Ys=a("span"),zl=n("TFSpeech2TextForConditionalGeneration"),za=p(),xe=a("div"),x(bn.$$.fragment),Cl=p(),xn=a("p"),jl=n(`The Speech2Text Model with a language modeling head. Can be used for summarization.
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Ll=p(),x(lo.$$.fragment),Ol=p(),Le=a("div"),x(wn.$$.fragment),Gl=p(),Nt=a("p"),Ul=n("The "),Qn=a("a"),Wl=n("TFSpeech2TextForConditionalGeneration"),Rl=n(" forward method, overrides the "),Xs=a("code"),Vl=n("__call__"),Hl=n(" special method."),Kl=p(),x(co.$$.fragment),Bl=p(),x(po.$$.fragment),this.h()},l(o){const f=Wp('[data-svelte="svelte-1phssyn"]',document.head);c=r(f,"META",{name:!0,content:!0}),f.forEach(t),b=h(o),_=r(o,"H1",{class:!0});var Sn=i(_);g=r(Sn,"A",{id:!0,class:!0,href:!0});var Qs=i(g);v=r(Qs,"SPAN",{});var Zs=i(v);y(d.$$.fragment,Zs),Zs.forEach(t),Qs.forEach(t),m=h(Sn),F=r(Sn,"SPAN",{});var ea=i(F);D=s(ea,"Speech2Text"),ea.forEach(t),Sn.forEach(t),j=h(o),M=r(o,"H2",{class:!0});var $n=i(M);I=r($n,"A",{id:!0,class:!0,href:!0});var ta=i(I);ne=r(ta,"SPAN",{});var oa=i(ne);y(E.$$.fragment,oa),oa.forEach(t),ta.forEach(t),Ge=h($n),Q=r($n,"SPAN",{});var na=i(Q);Ue=s(na,"Overview"),na.forEach(t),$n.forEach(t),je=h(o),A=r(o,"P",{});var Ce=i(A);We=s(Ce,"The Speech2Text model was proposed in "),se=r(Ce,"A",{href:!0,rel:!0});var sa=i(se);ae=s(sa,"fairseq S2T: Fast Speech-to-Text Modeling with fairseq"),sa.forEach(t),Re=s(Ce,` by Changhan Wang, Yun Tang, Xutai Ma, Anne Wu, Dmytro Okhonko, Juan Pino. It\u2019s a
transformer-based seq2seq (encoder-decoder) model designed for end-to-end Automatic Speech Recognition (ASR) and Speech
Translation (ST). It uses a convolutional downsampler to reduce the length of speech inputs by 3/4th before they are
fed into the encoder. The model is trained with standard autoregressive cross-entropy loss and generates the
transcripts/translations autoregressively. Speech2Text has been fine-tuned on several datasets for ASR and ST:
`),re=r(Ce,"A",{href:!0,rel:!0});var aa=i(re);ie=s(aa,"LibriSpeech"),aa.forEach(t),Ve=s(Ce,", "),de=r(Ce,"A",{href:!0,rel:!0});var ra=i(de);le=s(ra,"CoVoST 2"),ra.forEach(t),He=s(Ce,", "),ce=r(Ce,"A",{href:!0,rel:!0});var ia=i(ce);Se=s(ia,"MuST-C"),ia.forEach(t),N=s(Ce,"."),Ce.forEach(t),L=h(o),Y=r(o,"P",{});var Zn=i(Y);pe=s(Zn,"This model was contributed by "),he=r(Zn,"A",{href:!0,rel:!0});var Zl=i(he);Ke=s(Zl,"valhalla"),Zl.forEach(t),me=s(Zn,". The original code can be found "),ue=r(Zn,"A",{href:!0,rel:!0});var ec=i(ue);Be=s(ec,"here"),ec.forEach(t),U=s(Zn,"."),Zn.forEach(t),Pe=h(o),W=r(o,"H2",{class:!0});var ja=i(W);ee=r(ja,"A",{id:!0,class:!0,href:!0});var tc=i(ee);$e=r(tc,"SPAN",{});var oc=i($e);y(B.$$.fragment,oc),oc.forEach(t),tc.forEach(t),Je=h(ja),Ee=r(ja,"SPAN",{});var nc=i(Ee);Z=s(nc,"Inference"),nc.forEach(t),ja.forEach(t),Me=h(o),H=r(o,"P",{});var Pa=i(H);Ye=s(Pa,`Speech2Text is a speech model that accepts a float tensor of log-mel filter-bank features extracted from the speech
signal. It\u2019s a transformer-based seq2seq model, so the transcripts/translations are generated autoregressively. The
`),fe=r(Pa,"CODE",{});var sc=i(fe);R=s(sc,"generate()"),sc.forEach(t),Xe=s(Pa," method can be used for inference."),Pa.forEach(t),K=h(o),O=r(o,"P",{});var dt=i(O);Qe=s(dt,"The "),T=r(dt,"A",{href:!0});var ac=i(T);q=s(ac,"Speech2TextFeatureExtractor"),ac.forEach(t),ht=s(dt,` class is responsible for extracting the log-mel filter-bank
...
predicted token ids.`),dt.forEach(t),X=h(o),C=r(o,"P",{});var ye=i(C);vt=s(ye,"The feature extractor depends on "),Ze=r(ye,"CODE",{});var lc=i(Ze);_e=s(lc,"torchaudio"),lc.forEach(t),bt=s(ye," and the tokenizer depends on "),et=r(ye,"CODE",{});var cc=i(et);tt=s(cc,"sentencepiece"),cc.forEach(t),xt=s(ye,` so be sure to
install those packages before running the examples. You could either install those as extra speech dependencies with
...
documentation from `),jn=r(ts,"A",{href:!0});var jc=i(jn);Kr=s(jc,"PretrainedConfig"),jc.forEach(t),Br=s(ts," for more information."),ts.forEach(t),Jr=h(ho),y(Lt.$$.fragment,ho),ho.forEach(t),ga=h(o),$t=r(o,"H2",{class:!0});var Da=i($t);Ot=r(Da,"A",{id:!0,class:!0,href:!0});var Pc=i(Ot);xs=r(Pc,"SPAN",{});var Mc=i(xs);y(qo.$$.fragment,Mc),Mc.forEach(t),Pc.forEach(t),Yr=h(Da),ys=r(Da,"SPAN",{});var Ac=i(ys);Xr=s(Ac,"Speech2TextTokenizer"),Ac.forEach(t),Da.forEach(t),Ta=h(o),J=r(o,"DIV",{class:!0});var we=i(J);y(zo.$$.fragment,we),Qr=h(we),ks=r(we,"P",{});var Nc=i(ks);Zr=s(Nc,"Construct an Speech2Text tokenizer."),Nc.forEach(t),ei=h(we),Co=r(we,"P",{});var Ia=i(Co);ti=s(Ia,"This tokenizer inherits from "),Pn=r(Ia,"A",{href:!0});var Dc=i(Pn);oi=s(Dc,"PreTrainedTokenizer"),Dc.forEach(t),ni=s(Ia,` which contains some of the main methods. Users should refer to
the superclass for more information regarding such methods.`),Ia.forEach(t),si=h(we),Gt=r(we,"DIV",{class:!0});var La=i(Gt);y(jo.$$.fragment,La),ai=h(La),ws=r(La,"P",{});var Ic=i(ws);ri=s(Ic,"Build model inputs from a sequence by appending eos_token_id."),Ic.forEach(t),La.forEach(t),ii=h(we),Ut=r(we,"DIV",{class:!0});var Oa=i(Ut);y(Po.$$.fragment,Oa),di=h(Oa),Mo=r(Oa,"P",{});var Ga=i(Mo);li=s(Ga,`Retrieve sequence ids from a token list that has no special tokens added. This method is called when adding
...
mean and variance normalization to the extracted features.`),Bc.forEach(t),qi=h(lt),Rt=r(lt,"DIV",{class:!0});var Ra=i(Rt);y(Oo.$$.fragment,Ra),zi=h(Ra),Cs=r(Ra,"P",{});var Jc=i(Cs);Ci=s(Jc,"Main method to featurize and prepare for the model one or several sequence(s). sequences."),Jc.forEach(t),Ra.forEach(t),lt.forEach(t),xa=h(o),Ft=r(o,"H2",{class:!0});var Va=i(Ft);Vt=r(Va,"A",{id:!0,class:!0,href:!0});var Yc=i(Vt);js=r(Yc,"SPAN",{});var Xc=i(js);y(Go.$$.fragment,Xc),Xc.forEach(t),Yc.forEach(t),ji=h(Va),Ps=r(Va,"SPAN",{});var Qc=i(Ps);Pi=s(Qc,"Speech2TextProcessor"),Qc.forEach(t),Va.forEach(t),ya=h(o),V=r(o,"DIV",{class:!0});var oe=i(V);y(Uo.$$.fragment,oe),Mi=h(oe),Ms=r(oe,"P",{});var Zc=i(Ms);Ai=s(Zc,`Constructs a Speech2Text processor which wraps a Speech2Text feature extractor and a Speech2Text tokenizer into a
...
`),On=r(nt,"A",{href:!0});var op=i(On);Gi=s(op,"Speech2TextTokenizer"),op.forEach(t),Ui=s(nt,". See the "),Wo=r(nt,"A",{href:!0});var Yl=i(Wo);As=r(Yl,"STRONG",{});var np=i(As);Wi=s(np,"call"),np.forEach(t),Ri=s(Yl,"()"),Yl.forEach(t),Vi=s(nt," and "),Gn=r(nt,"A",{href:!0});var sp=i(Gn);Hi=s(sp,"decode()"),sp.forEach(t),Ki=s(nt,` for more
information.`),nt.forEach(t),Bi=h(oe),Ht=r(oe,"DIV",{class:!0});var Ha=i(Ht);y(Ro.$$.fragment,Ha),Ji=h(Ha),ot=r(Ha,"P",{});var mo=i(ot);Yi=s(mo,`When used in normal mode, this method forwards all its arguments to Speech2TextFeatureExtractor\u2019s
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),er.forEach(t),Ad=h(uo),Ne=r(uo,"DIV",{class:!0});var fo=i(Ne);y(an.$$.fragment,fo),Nd=h(fo),zt=r(fo,"P",{});var as=i(zt);Dd=s(as,"The "),Hn=r(as,"A",{href:!0});var gp=i(Hn);Id=s(gp,"Speech2TextModel"),gp.forEach(t),Ld=s(as," forward method, overrides the "),Us=r(as,"CODE",{});var Tp=i(Us);Od=s(Tp,"__call__"),Tp.forEach(t),Gd=s(as," special method."),as.forEach(t),Ud=h(fo),y(Qt.$$.fragment,fo),Wd=h(fo),y(Zt.$$.fragment,fo),fo.forEach(t),uo.forEach(t),Sa=h(o),Ct=r(o,"H2",{class:!0});var tr=i(Ct);eo=r(tr,"A",{id:!0,class:!0,href:!0});var vp=i(eo);Ws=r(vp,"SPAN",{});var bp=i(Ws);y(rn.$$.fragment,bp),bp.forEach(t),vp.forEach(t),Rd=h(tr),Rs=r(tr,"SPAN",{});var xp=i(Rs);Vd=s(xp,"Speech2TextForConditionalGeneration"),xp.forEach(t),tr.forEach(t),$a=h(o),ze=r(o,"DIV",{class:!0});var _o=i(ze);y(dn.$$.fragment,_o),Hd=h(_o),ln=r(_o,"P",{});var or=i(ln);Kd=s(or,`The Speech2Text Model with a language modeling head. Can be used for summarization.
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),nr.forEach(t),el=h(_o),De=r(_o,"DIV",{class:!0});var go=i(De);y(hn.$$.fragment,go),tl=h(go),jt=r(go,"P",{});var rs=i(jt);ol=s(rs,"The "),Bn=r(rs,"A",{href:!0});var wp=i(Bn);nl=s(wp,"Speech2TextForConditionalGeneration"),wp.forEach(t),sl=s(rs," forward method, overrides the "),Vs=r(rs,"CODE",{});var Sp=i(Vs);al=s(Sp,"__call__"),Sp.forEach(t),rl=s(rs," special method."),rs.forEach(t),il=h(go),y(to.$$.fragment,go),dl=h(go),y(oo.$$.fragment,go),go.forEach(t),_o.forEach(t),Ea=h(o),Pt=r(o,"H2",{class:!0});var sr=i(Pt);no=r(sr,"A",{id:!0,class:!0,href:!0});var $p=i(no);Hs=r($p,"SPAN",{});var Ep=i(Hs);y(mn.$$.fragment,Ep),Ep.forEach(t),$p.forEach(t),ll=h(sr),Ks=r(sr,"SPAN",{});var Fp=i(Ks);cl=s(Fp,"TFSpeech2TextModel"),Fp.forEach(t),sr.forEach(t),Fa=h(o),be=r(o,"DIV",{class:!0});var ct=i(be);y(un.$$.fragment,ct),pl=h(ct),fn=r(ct,"P",{});var ar=i(fn);hl=s(ar,`The bare Speech2Text Model outputting raw hidden-states without any specific head on top.
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),rr.forEach(t),vl=h(ct),y(so.$$.fragment,ct),bl=h(ct),Ie=r(ct,"DIV",{class:!0});var To=i(Ie);y(Tn.$$.fragment,To),xl=h(To),Mt=r(To,"P",{});var is=i(Mt);yl=s(is,"The "),Yn=r(is,"A",{href:!0});var Cp=i(Yn);kl=s(Cp,"TFSpeech2TextModel"),Cp.forEach(t),wl=s(is," forward method, overrides the "),Bs=r(is,"CODE",{});var jp=i(Bs);Sl=s(jp,"__call__"),jp.forEach(t),$l=s(is," special method."),is.forEach(t),El=h(To),y(ao.$$.fragment,To),Fl=h(To),y(ro.$$.fragment,To),To.forEach(t),ct.forEach(t),qa=h(o),At=r(o,"H2",{class:!0});var ir=i(At);io=r(ir,"A",{id:!0,class:!0,href:!0});var Pp=i(io);Js=r(Pp,"SPAN",{});var Mp=i(Js);y(vn.$$.fragment,Mp),Mp.forEach(t),Pp.forEach(t),ql=h(ir),Ys=r(ir,"SPAN",{});var Ap=i(Ys);zl=s(Ap,"TFSpeech2TextForConditionalGeneration"),Ap.forEach(t),ir.forEach(t),za=h(o),xe=r(o,"DIV",{class:!0});var pt=i(xe);y(bn.$$.fragment,pt),Cl=h(pt),xn=r(pt,"P",{});var dr=i(xn);jl=s(dr,`The Speech2Text Model with a language modeling head. Can be used for summarization.
