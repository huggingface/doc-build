import{S as _i,i as vi,s as Ti,e as s,k as l,w as v,t as r,M as bi,c as n,d as o,m as c,a as i,x as T,h as a,b as d,N as Ci,F as e,g as m,y as b,q as C,o as w,B as k,v as wi}from"../../chunks/vendor-6b77c823.js";import{T as gi}from"../../chunks/Tip-39098574.js";import{D as J}from"../../chunks/Docstring-90e3aa51.js";import{C as Zs}from"../../chunks/CodeBlock-3a8b25a8.js";import{I as zt}from"../../chunks/IconCopyLink-7a11ce68.js";function ki(at){let f,q,u,x,L,y,A,F;return{c(){f=s("p"),q=r(`This class method is simply calling the feature extractor
...
methods above for more information.`),this.h()},l($){f=n($,"P",{});var _=i(f);q=a(_,`This class method is simply calling the feature extractor
...
methods above for more information.`),_.forEach(o),this.h()},h(){d(u,"href","/docs/transformers/main/en/main_classes/feature_extractor#transformers.FeatureExtractionMixin.from_pretrained")},m($,_){m($,f,_),e(f,q),e(f,u),e(u,x),e(f,L),e(f,y),e(y,A),e(f,F)},d($){$&&o(f)}}}function Oi(at){let f,q,u,x,L,y,A,F;return{c(){f=s("p"),q=r("This class method is simply calling "),u=s("a"),x=r("save_pretrained()"),L=r(` and
`),y=s("code"),A=r("save_pretrained"),F=r(`. Please refer to the docstrings of the methods
above for more information.`),this.h()},l($){f=n($,"P",{});var _=i(f);q=a(_,"This class method is simply calling "),u=n(_,"A",{href:!0});var P=i(u);x=a(P,"save_pretrained()"),P.forEach(o),L=a(_,` and
`),y=n(_,"CODE",{});var z=i(y);A=a(z,"save_pretrained"),z.forEach(o),F=a(_,`. Please refer to the docstrings of the methods
above for more information.`),_.forEach(o),this.h()},h(){d(u,"href","/docs/transformers/main/en/main_classes/feature_extractor#transformers.FeatureExtractionMixin.save_pretrained")},m($,_){m($,f,_),e(f,q),e(f,u),e(u,x),e(f,L),e(f,y),e(y,A),e(f,F)},d($){$&&o(f)}}}function yi(at){let f,q,u,x,L,y,A,F,$,_,P,z,Lt,Ce,rr,Ft,ar,_o,S,sr,we,nr,ir,ke,dr,lr,vo,st,cr,To,nt,Dt,hr,bo,re,Js,Co,ae,mr,it,fr,pr,wo,se,ur,qt,gr,_r,ko,W,vr,Oe,Tr,br,ye,Cr,wr,Oo,dt,kr,yo,H,Re,Or,Ee,yr,Rr,Er,I,xr,xe,$r,Pr,$e,Mr,jr,Pe,zr,Lr,Fr,Me,Dr,lt,qr,Ar,Ro,Y,ne,At,je,Ir,It,Vr,Eo,B,Nr,Vt,Sr,Wr,ct,Hr,Br,xo,p,Ur,Nt,Xr,Gr,St,Zr,Jr,Wt,Yr,Kr,Ht,Qr,ea,ht,ta,oa,Bt,ra,aa,Ut,sa,na,Xt,ia,da,Gt,la,ca,$o,mt,Zt,ha,Po,ze,Mo,ie,ma,Le,fa,pa,jo,K,de,Jt,Fe,ua,Yt,ga,zo,M,De,_a,Q,va,ft,Ta,ba,qe,Ca,wa,ka,ee,Oa,pt,ya,Ra,ut,Ea,xa,$a,Kt,Pa,Ma,Ae,Lo,te,le,Qt,Ie,ja,eo,za,Fo,g,Ve,La,to,Fa,Da,R,gt,qa,Aa,oo,Ia,Va,ro,Na,Sa,ao,Wa,Ha,so,Ba,Ua,Ne,no,Xa,Ga,Za,_t,Ja,Ya,Ka,ce,Se,Qa,V,es,io,ts,os,vt,rs,as,lo,ss,ns,is,U,We,ds,co,ls,cs,he,hs,X,He,ms,Be,fs,Tt,ps,us,gs,me,_s,fe,Ue,vs,Xe,Ts,bt,bs,Cs,ws,pe,Ge,ks,Ze,Os,Ct,ys,Rs,Es,ue,Je,xs,ho,$s,Do,oe,ge,mo,Ye,Ps,fo,Ms,qo,D,Ke,js,N,zs,wt,Ls,Fs,po,Ds,qs,kt,As,Is,Vs,Qe,Ns,et,Ss,Ws,Hs,G,tt,Bs,uo,Us,Xs,ot,Ao;return y=new zt({}),Ce=new zt({}),je=new zt({}),ze=new Zs({props:{code:`from transformers import TrOCRProcessor, VisionEncoderDecoderModel
import requests 
...
Whether or not to use a layernorm after the word + position embeddings.`,name:"layernorm_embedding"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/trocr/configuration_trocr.py#L29"}}),Ae=new Zs({props:{code:`from transformers import TrOCRForCausalLM, TrOCRConfig
...
An instance of [<code>RobertaTokenizer</code>/<code>XLMRobertaTokenizer</code>]. The tokenizer is a required input.`,name:"tokenizer"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/trocr/processing_trocr.py#L23"}}),Se=new J({props:{name:"__call__",anchor:"transformers.TrOCRProcessor.__call__",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/trocr/processing_trocr.py#L44"}}),We=new J({props:{name:"from_pretrained",anchor:"transformers.TrOCRProcessor.from_pretrained",parameters:[{name:"pretrained_model_name_or_path",val:""},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.TrOCRProcessor.from_pretrained.pretrained_model_name_or_path",description:`<strong>pretrained_model_name_or_path</strong> (<code>str</code> or <code>os.PathLike</code>) &#x2014;
...
Whether or not to return a <a href="/docs/transformers/main/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/trocr/modeling_trocr.py#L806",returnDescription:`
<p>A <a
...
<span class="hljs-string">&#x27;industry, &quot; Mr. Brown commented icily. &quot; Let us have a&#x27;</span>`}}),{c(){f=s("meta"),q=l(),u=s("h1"),x=s("a"),L=s("span"),v(y.$$.fragment),A=l(),F=s("span"),$=r("TrOCR"),_=l(),P=s("h2"),z=s("a"),Lt=s("span"),v(Ce.$$.fragment),rr=l(),Ft=s("span"),ar=r("Overview"),_o=l(),S=s("p"),sr=r("The TrOCR model was proposed in "),we=s("a"),nr=r(`TrOCR: Transformer-based Optical Character Recognition with Pre-trained
...
`),ct=s("a"),Hr=r("generate()"),Br=r(" to autoregressively generate text given the input image."),xo=l(),p=s("p"),Ur=r("The ["),Nt=s("code"),Xr=r("ViTFeatureExtractor"),Gr=r("/"),St=s("code"),Zr=r("DeiTFeatureExtractor"),Jr=r(`] class is responsible for preprocessing the input image and
...
`),lo=s("code"),ss=r("__call__"),ns=r(". Please refer to the doctsring of the above two methods for more information."),is=l(),U=s("div"),v(We.$$.fragment),ds=l(),co=s("p"),ls=r("Instantiate a processor associated with a pretrained model."),cs=l(),v(he.$$.fragment),hs=l(),X=s("div"),v(He.$$.fragment),ms=l(),Be=s("p"),fs=r(`Saves the attributes of this processor (feature extractor, tokenizer\u2026) in the specified directory so that it
...
on both printed (e.g. the `),xe=n(_e,"A",{href:!0,rel:!0});var pn=i(xe);$r=a(pn,"SROIE dataset"),pn.forEach(o),Pr=a(_e," and handwritten (e.g. the "),$e=n(_e,"A",{href:!0,rel:!0});var un=i($e);Mr=a(un,`IAM
...
into a single instance to both extract the input features and decode the predicted token ids.`),O.forEach(o),$o=c(t),mt=n(t,"UL",{});var jn=i(mt);Zt=n(jn,"LI",{});var zn=i(Zt);ha=a(zn,"Step-by-step Optical Character Recognition (OCR)"),zn.forEach(o),jn.forEach(o),Po=c(t),T(ze.$$.fragment,t),Mo=c(t),ie=n(t,"P",{});var Bo=i(ie);ma=a(Bo,"See the "),Le=n(Bo,"A",{href:!0,rel:!0});var Ln=i(Le);fa=a(Ln,"model hub"),Ln.forEach(o),pa=a(Bo," to look for TrOCR checkpoints."),Bo.forEach(o),jo=c(t),K=n(t,"H2",{class:!0});var Uo=i(K);de=n(Uo,"A",{id:!0,class:!0,href:!0});var Fn=i(de);Jt=n(Fn,"SPAN",{});var Dn=i(Jt);T(Fe.$$.fragment,Dn),Dn.forEach(o),Fn.forEach(o),ua=c(Uo),Yt=n(Uo,"SPAN",{});var qn=i(Yt);ga=a(qn,"TrOCRConfig"),qn.forEach(o),Uo.forEach(o),zo=c(t),M=n(t,"DIV",{class:!0});var Z=i(M);T(De.$$.fragment,Z),_a=c(Z),Q=n(Z,"P",{});var xt=i(Q);va=a(xt,"This is the configuration class to store the configuration of a "),ft=n(xt,"A",{href:!0});var An=i(ft);Ta=a(An,"TrOCRForCausalLM"),An.forEach(o),ba=a(xt,`. It is used to instantiate an
TrOCR model according to the specified arguments, defining the model architecture. Instantiating a configuration
with the defaults will yield a similar configuration to that of the TrOCR
`),qe=n(xt,"A",{href:!0,rel:!0});var In=i(qe);Ca=a(In,"microsoft/trocr-base"),In.forEach(o),wa=a(xt," architecture."),xt.forEach(o),ka=c(Z),ee=n(Z,"P",{});var $t=i(ee);Oa=a($t,"Configuration objects inherit from "),pt=n($t,"A",{href:!0});var Vn=i(pt);ya=a(Vn,"PretrainedConfig"),Vn.forEach(o),Ra=a($t,` and can be used to control the model outputs. Read the
