...
relevant if <code>config.is_decoder=True</code>.`,name:"use_cache"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/gpt_neo/configuration_gpt_neo.py#L34"}}),Ve=new oe({props:{code:`from transformers import GPTNeoModel, GPTNeoConfig
