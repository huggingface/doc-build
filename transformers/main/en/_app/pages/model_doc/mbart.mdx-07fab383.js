import{S as Nz,i as Dz,s as Lz,e as o,k as d,w as u,t as r,M as Gz,c as a,d as t,m as l,a as s,x as m,h as i,b as c,F as e,g as h,y as f,q as _,o as g,B as k,v as Wz}from"../../chunks/vendor-6b77c823.js";import{T as st}from"../../chunks/Tip-39098574.js";import{D as q}from"../../chunks/Docstring-abef54e3.js";import{C as $}from"../../chunks/CodeBlock-3a8b25a8.js";import{I as X}from"../../chunks/IconCopyLink-7a11ce68.js";function Rz(C){let b,z,v,M,x;return{c(){b=o("p"),z=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),v=o("code"),M=r("Module"),x=r(`
...
the latter silently ignores them.`)},l(T){b=a(T,"P",{});var y=s(b);z=i(y,"Although the recipe for forward pass needs to be defined within this function, one should call the "),v=a(y,"CODE",{});var F=s(v);M=i(F,"Module"),F.forEach(t),x=i(y,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),y.forEach(t)},m(T,y){h(T,b,y),e(b,z),e(b,v),e(v,M),e(b,x)},d(T){T&&t(b)}}}function nq(C){let b,z,v,M,x,T,y,F,rt,Ee,j,Ue,ke,it,be,ye,dt,Ke,J,N,Xe,se,E,A,lt,pe,he,ct,K,pt,ht,D,Pe,ve,Ze,re,Te,we,ut,ie,Me,xe,Ye,w,B,ze,Ve,Ut,Z,Xt,bt,V,de,le,Vt,Qt,ce,Ht,Jt,Qe,Kt,Su,ld,Au,Ou,bp,yt,Iu,Po,cd,Nu,Du,Lu,ti,Gu,Wu,yp,ni,pd,Ru,vp,So,Tp,oi,Ao,hd,Uu,Xu,Zt,Vu,ud,Qu,Hu,md,Ju,Ku,wp,Oo,Mp,Yt,Sn,fd,Io,Zu,_d,Yu,xp,vt,em,No,tm,nm,gd,om,am,zp,ai,sm,qp,si,kd,rm,Fp,en,An,bd,Do,im,yd,dm,$p,et,lm,vd,cm,pm,Td,hm,um,wd,mm,fm,Bp,On,_m,ri,gm,km,jp,ii,Md,bm,Cp,Lo,Ep,di,Go,xd,ym,vm,qe,Tm,zd,wm,Mm,qd,xm,zm,Fd,qm,Fm,$d,$m,Bm,Bd,jm,Cm,Pp,Wo,Sp,tn,In,jd,Ro,Em,Cd,Pm,Ap,Fe,Uo,Sm,nn,Am,li,Om,Im,Xo,Nm,Dm,Lm,on,Gm,ci,Wm,Rm,pi,Um,Xm,Vm,Ed,Qm,Hm,Vo,Op,an,Nn,Pd,Qo,Jm,Sd,Km,Ip,G,Ho,Zm,Ad,Ym,ef,mt,tf,hi,nf,of,ui,af,sf,Jo,rf,df,lf,Ko,cf,Od,pf,hf,uf,Id,mf,ff,Zo,_f,Dn,Yo,gf,Nd,kf,bf,tt,ea,yf,ta,vf,Dd,Tf,wf,Mf,na,oa,Ld,xf,zf,Gd,qf,Ff,aa,Wd,$f,Bf,Rd,jf,Cf,Ud,Ef,Np,sn,Ln,Xd,sa,Pf,Vd,Sf,Dp,P,ra,Af,rn,Of,Qd,If,Nf,ia,Df,Lf,Gf,Tt,mi,Wf,Rf,fi,Uf,Xf,_i,Vf,Qf,Hf,da,Jf,Hd,Kf,Zf,Yf,Jd,e_,t_,la,n_,Se,ca,o_,Kd,a_,s_,pa,r_,Zd,i_,d_,l_,ha,ua,Yd,c_,p_,el,h_,u_,ma,tl,m_,f_,nl,__,g_,ol,k_,b_,Gn,fa,y_,al,v_,T_,Wn,_a,w_,sl,M_,x_,Rn,ga,z_,rl,q_,Lp,dn,Un,il,ka,F_,dl,$_,Gp,S,ba,B_,ya,j_,va,C_,E_,P_,Ta,S_,gi,A_,O_,I_,ll,N_,D_,wa,L_,nt,Ma,G_,xa,W_,cl,R_,U_,X_,za,qa,pl,V_,Q_,hl,H_,J_,Fa,ul,K_,Z_,ml,Y_,eg,fl,tg,ng,Xn,$a,og,_l,ag,sg,Vn,Ba,rg,ja,ig,gl,dg,lg,cg,Qn,Ca,pg,kl,hg,ug,Hn,Ea,mg,bl,fg,Wp,ln,Jn,yl,Pa,_g,vl,gg,Rp,W,Sa,kg,cn,bg,Tl,yg,vg,Aa,Tg,wg,Mg,Oa,xg,ki,zg,qg,Fg,wl,$g,Bg,Ia,jg,Ae,Na,Cg,Ml,Eg,Pg,Da,Sg,xl,Ag,Og,Ig,La,Ga,zl,Ng,Dg,ql,Lg,Gg,Wa,Fl,Wg,Rg,$l,Ug,Xg,Bl,Vg,Qg,Kn,Ra,Hg,jl,Jg,Kg,Zn,Ua,Zg,Cl,Yg,Up,pn,Yn,El,Xa,ek,Pl,tk,Xp,He,Va,nk,Qa,ok,bi,ak,sk,rk,Ha,ik,Ja,dk,lk,ck,Oe,Ka,pk,hn,hk,yi,uk,mk,Sl,fk,_k,gk,eo,kk,Al,bk,yk,Za,Vp,un,to,Ol,Ya,vk,Il,Tk,Qp,Je,es,wk,ts,Mk,vi,xk,zk,qk,ns,Fk,os,$k,Bk,jk,Y,as,Ck,mn,Ek,Ti,Pk,Sk,Nl,Ak,Ok,Ik,no,Nk,Dl,Dk,Lk,ss,Gk,Ll,Wk,Rk,rs,Hp,fn,oo,Gl,is,Uk,Wl,Xk,Jp,$e,ds,Vk,_n,Qk,Rl,Hk,Jk,Ul,Kk,Zk,Yk,ls,eb,wi,tb,nb,ob,cs,ab,ps,sb,rb,ib,ue,hs,db,gn,lb,Mi,cb,pb,Xl,hb,ub,mb,ao,fb,Vl,_b,gb,us,kb,ms,Kp,kn,so,Ql,fs,bb,Hl,yb,Zp,Be,_s,vb,Jl,Tb,wb,gs,Mb,xi,xb,zb,qb,ks,Fb,bs,$b,Bb,jb,L,ys,Cb,bn,Eb,zi,Pb,Sb,Kl,Ab,Ob,Ib,ro,Nb,Zl,Db,Lb,vs,Gb,Ts,Wb,Yl,Rb,Ub,ws,Xb,Ms,Yp,yn,io,ec,xs,Vb,tc,Qb,eh,vn,zs,Hb,wt,qs,Jb,nc,Kb,Zb,Fs,th,Tn,lo,oc,$s,Yb,ac,ey,nh,je,Bs,ty,js,ny,qi,oy,ay,sy,Cs,ry,Es,iy,dy,ly,co,cy,Ie,Ps,py,wn,hy,Fi,uy,my,sc,fy,_y,gy,po,ky,rc,by,yy,Ss,oh,Mn,ho,ic,As,vy,dc,Ty,ah,Ce,Os,wy,Is,My,$i,xy,zy,qy,Ns,Fy,Ds,$y,By,jy,uo,Cy,ee,Ls,Ey,xn,Py,Bi,Sy,Ay,lc,Oy,Iy,Ny,mo,Dy,cc,Ly,Gy,Gs,Wy,pc,Ry,Uy,Ws,sh,zn,fo,hc,Rs,Xy,uc,Vy,rh,R,Us,Qy,Xs,Hy,ji,Jy,Ky,Zy,Vs,Yy,Qs,ev,tv,nv,mc,ov,av,ft,fc,Hs,sv,rv,_c,Js,iv,dv,gc,Ks,lv,cv,kc,Zs,pv,hv,Ne,Ys,uv,qn,mv,bc,fv,_v,yc,gv,kv,bv,_o,yv,vc,vv,Tv,er,wv,Mt,tr,Mv,Tc,xv,zv,nr,qv,xt,or,Fv,wc,$v,Bv,ar,ih,Fn,go,Mc,sr,jv,xc,Cv,dh,U,rr,Ev,ir,Pv,Ci,Sv,Av,Ov,dr,Iv,lr,Nv,Dv,Lv,zc,Gv,Wv,_t,qc,cr,Rv,Uv,Fc,pr,Xv,Vv,$c,hr,Qv,Hv,Bc,ur,Jv,Kv,te,mr,Zv,$n,Yv,jc,eT,tT,Cc,nT,oT,aT,ko,sT,Ec,rT,iT,fr,dT,Pc,lT,cT,_r,pT,zt,gr,hT,Sc,uT,mT,kr,fT,qt,br,_T,Ac,gT,kT,yr,lh,Bn,bo,Oc,vr,bT,Ic,yT,ch,O,Tr,vT,Nc,TT,wT,wr,MT,Ei,xT,zT,qT,Mr,FT,xr,$T,BT,jT,Dc,CT,ET,gt,Lc,zr,PT,ST,Gc,qr,AT,OT,Wc,Fr,IT,NT,Rc,$r,DT,LT,De,Br,GT,jn,WT,Uc,RT,UT,Xc,XT,VT,QT,yo,HT,Vc,JT,KT,jr,ZT,Ft,Cr,YT,Qc,ew,tw,Er,nw,$t,Pr,ow,Hc,aw,sw,Sr,ph,Cn,vo,Jc,Ar,rw,Kc,iw,hh,I,Or,dw,En,lw,Zc,cw,pw,Yc,hw,uw,mw,Ir,fw,Pi,_w,gw,kw,Nr,bw,Dr,yw,vw,Tw,ep,ww,Mw,kt,tp,Lr,xw,zw,np,Gr,qw,Fw,op,Wr,$w,Bw,ap,Rr,jw,Cw,Le,Ur,Ew,Pn,Pw,sp,Sw,Aw,rp,Ow,Iw,Nw,To,Dw,ip,Lw,Gw,Xr,Ww,Bt,Vr,Rw,dp,Uw,Xw,Qr,Vw,jt,Hr,Qw,lp,Hw,Jw,Jr,uh;return T=new X({}),se=new X({}),Ve=new X({}),So=new $({props:{code:`from transformers import MBartForConditionalGeneration, MBartTokenizer
...
`}}),_o=new st({props:{$$slots:{default:[Zz]},$$scope:{ctx:C}}}),er=new $({props:{code:`from transformers import MBartTokenizer, FlaxMBartModel
...
example shows how to translate English to Romanian using the `),md=o("em"),Ju=r("facebook/mbart-large-en-ro"),Ku=r(" model."),wp=d(),u(Oo.$$.fragment),Mp=d(),Yt=o("h2"),Sn=o("a"),fd=o("span"),u(Io.$$.fragment),Zu=d(),_d=o("span"),Yu=r("Overview of MBart-50"),xp=d(),vt=o("p"),em=r("MBart-50 was introduced in the "),No=o("a"),tm=r("Multilingual Translation with Extensible Multilingual Pretraining and Finetuning"),nm=r(` paper by Yuqing Tang, Chau Tran, Xian Li, Peng-Jen Chen, Naman Goyal, Vishrav
...
respectively.`),Bp=d(),On=o("p"),_m=r("MBart-50 has its own tokenizer "),ri=o("a"),gm=r("MBart50Tokenizer"),km=r("."),jp=d(),ii=o("ul"),Md=o("li"),bm=r("Supervised training"),Cp=d(),u(Lo.$$.fragment),Ep=d(),di=o("ul"),Go=o("li"),xd=o("p"),ym=r("Generation"),vm=d(),qe=o("p"),Tm=r("To generate using the mBART-50 multilingual translation models, "),zd=o("code"),wm=r("eos_token_id"),Mm=r(` is used as the
...
`),_i=o("a"),Vf=r("XLMRobertaTokenizerFast"),Qf=r(` for usage examples and documentation concerning the initialization parameters and other
...
make use of token type ids, therefore a list of zeros is returned.`),T_=d(),Wn=o("div"),u(_a.$$.fragment),w_=d(),sl=o("p"),M_=r("Reset the special tokens to the source lang setting. No prefix and suffix=[eos, src_lang_code]."),x_=d(),Rn=o("div"),u(ga.$$.fragment),z_=d(),rl=o("p"),q_=r("Reset the special tokens to the target language setting. No prefix and suffix=[eos, tgt_lang_code]."),Lp=d(),dn=o("h2"),Un=o("a"),il=o("span"),u(ka.$$.fragment),F_=d(),dl=o("span"),$_=r("MBart50Tokenizer"),Gp=d(),S=o("div"),u(ba.$$.fragment),B_=d(),ya=o("p"),j_=r("Construct a MBart50 tokenizer. Based on "),va=o("a"),C_=r("SentencePiece"),E_=r("."),P_=d(),Ta=o("p"),S_=r("This tokenizer inherits from "),gi=o("a"),A_=r("PreTrainedTokenizer"),O_=r(` which contains most of the main methods. Users should refer to
this superclass for more information regarding those methods.`),I_=d(),ll=o("p"),N_=r("Examples:"),D_=d(),u(wa.$$.fragment),L_=d(),nt=o("div"),u(Ma.$$.fragment),G_=d(),xa=o("p"),W_=r(`Build model inputs from a sequence or a pair of sequence for sequence classification tasks by concatenating and
adding special tokens. An MBART-50 sequence has the following format, where `),cl=o("code"),R_=r("X"),U_=r(" represents the sequence:"),X_=d(),za=o("ul"),qa=o("li"),pl=o("code"),V_=r("input_ids"),Q_=r(" (for encoder) "),hl=o("code"),H_=r("[src_lang_code] X [eos]"),J_=d(),Fa=o("li"),ul=o("code"),K_=r("labels"),Z_=r(": (for decoder) "),ml=o("code"),Y_=r("[tgt_lang_code] X [eos]"),eg=d(),fl=o("p"),tg=r(`BOS is never used. Pairs of sequences are not the expected use case, but they will be handled without a
separator.`),ng=d(),Xn=o("div"),u($a.$$.fragment),og=d(),_l=o("p"),ag=r("Converts a sequence of tokens (strings for sub-words) in a single string."),sg=d(),Vn=o("div"),u(Ba.$$.fragment),rg=d(),ja=o("p"),ig=r(`Retrieve sequence ids from a token list that has no special tokens added. This method is called when adding
special tokens using the tokenizer `),gl=o("code"),dg=r("prepare_for_model"),lg=r(" method."),cg=d(),Qn=o("div"),u(Ca.$$.fragment),pg=d(),kl=o("p"),hg=r("Reset the special tokens to the source lang setting. prefix=[src_lang_code] and suffix=[eos]."),ug=d(),Hn=o("div"),u(Ea.$$.fragment),mg=d(),bl=o("p"),fg=r("Reset the special tokens to the target language setting. prefix=[tgt_lang_code] and suffix=[eos]."),Wp=d(),ln=o("h2"),Jn=o("a"),yl=o("span"),u(Pa.$$.fragment),_g=d(),vl=o("span"),gg=r("MBart50TokenizerFast"),Rp=d(),W=o("div"),u(Sa.$$.fragment),kg=d(),cn=o("p"),bg=r("Construct a \u201Cfast\u201D MBART tokenizer for mBART-50 (backed by HuggingFace\u2019s "),Tl=o("em"),yg=r("tokenizers"),vg=r(` library). Based on
`),Aa=o("a"),Tg=r("BPE"),wg=r("."),Mg=d(),Oa=o("p"),xg=r("This tokenizer inherits from "),ki=o("a"),zg=r("PreTrainedTokenizerFast"),qg=r(` which contains most of the main methods. Users should
refer to this superclass for more information regarding those methods.`),Fg=d(),wl=o("p"),$g=r("Examples:"),Bg=d(),u(Ia.$$.fragment),jg=d(),Ae=o("div"),u(Na.$$.fragment),Cg=d(),Ml=o("p"),Eg=r(`Build model inputs from a sequence or a pair of sequence for sequence classification tasks by concatenating and
adding special tokens. The special tokens depend on calling set_lang.`),Pg=d(),Da=o("p"),Sg=r("An MBART-50 sequence has the following format, where "),xl=o("code"),Ag=r("X"),Og=r(" represents the sequence:"),Ig=d(),La=o("ul"),Ga=o("li"),zl=o("code"),Ng=r("input_ids"),Dg=r(" (for encoder) "),ql=o("code"),Lg=r("[src_lang_code] X [eos]"),Gg=d(),Wa=o("li"),Fl=o("code"),Wg=r("labels"),Rg=r(": (for decoder) "),$l=o("code"),Ug=r("[tgt_lang_code] X [eos]"),Xg=d(),Bl=o("p"),Vg=r(`BOS is never used. Pairs of sequences are not the expected use case, but they will be handled without a
separator.`),Qg=d(),Kn=o("div"),u(Ra.$$.fragment),Hg=d(),jl=o("p"),Jg=r("Reset the special tokens to the source lang setting. prefix=[src_lang_code] and suffix=[eos]."),Kg=d(),Zn=o("div"),u(Ua.$$.fragment),Zg=d(),Cl=o("p"),Yg=r("Reset the special tokens to the target language setting. prefix=[src_lang_code] and suffix=[eos]."),Up=d(),pn=o("h2"),Yn=o("a"),El=o("span"),u(Xa.$$.fragment),ek=d(),Pl=o("span"),tk=r("MBartModel"),Xp=d(),He=o("div"),u(Va.$$.fragment),nk=d(),Qa=o("p"),ok=r(`The bare MBART Model outputting raw hidden-states without any specific head on top.
...
and behavior.`),ck=d(),Oe=o("div"),u(Ka.$$.fragment),pk=d(),hn=o("p"),hk=r("The "),yi=o("a"),uk=r("MBartModel"),mk=r(" forward method, overrides the "),Sl=o("code"),fk=r("__call__"),_k=r(" special method."),gk=d(),u(eo.$$.fragment),kk=d(),Al=o("p"),bk=r("Example:"),yk=d(),u(Za.$$.fragment),Vp=d(),un=o("h2"),to=o("a"),Ol=o("span"),u(Ya.$$.fragment),vk=d(),Il=o("span"),Tk=r("MBartForConditionalGeneration"),Qp=d(),Je=o("div"),u(es.$$.fragment),wk=d(),ts=o("p"),Mk=r(`The MBART Model with a language modeling head. Can be used for summarization.
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),ib=d(),ue=o("div"),u(hs.$$.fragment),db=d(),gn=o("p"),lb=r("The "),Mi=o("a"),cb=r("MBartForQuestionAnswering"),pb=r(" forward method, overrides the "),Xl=o("code"),hb=r("__call__"),ub=r(" special method."),mb=d(),u(ao.$$.fragment),fb=d(),Vl=o("p"),_b=r("Example:"),gb=d(),u(us.$$.fragment),kb=d(),u(ms.$$.fragment),Kp=d(),kn=o("h2"),so=o("a"),Ql=o("span"),u(fs.$$.fragment),bb=d(),Hl=o("span"),yb=r("MBartForSequenceClassification"),Zp=d(),Be=o("div"),u(_s.$$.fragment),vb=d(),Jl=o("p"),Tb=r(`MBart model with a sequence classification/head on top (a linear layer on top of the pooled output) e.g. for GLUE
tasks.`),wb=d(),gs=o("p"),Mb=r("This model inherits from "),xi=o("a"),xb=r("PreTrainedModel"),zb=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
behavior.`),ly=d(),u(co.$$.fragment),cy=d(),Ie=o("div"),u(Ps.$$.fragment),py=d(),wn=o("p"),hy=r("The "),Fi=o("a"),uy=r("TFMBartModel"),my=r(" forward method, overrides the "),sc=o("code"),fy=r("__call__"),_y=r(" special method."),gy=d(),u(po.$$.fragment),ky=d(),rc=o("p"),by=r("Example:"),yy=d(),u(Ss.$$.fragment),oh=d(),Mn=o("h2"),ho=o("a"),ic=o("span"),u(As.$$.fragment),vy=d(),dc=o("span"),Ty=r("TFMBartForConditionalGeneration"),ah=d(),Ce=o("div"),u(Os.$$.fragment),wy=d(),Is=o("p"),My=r(`The MBART Model with a language modeling head. Can be used for summarization.
...
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),nv=d(),mc=o("p"),ov=r("Finally, this model supports inherent JAX features such as:"),av=d(),ft=o("ul"),fc=o("li"),Hs=o("a"),sv=r("Just-In-Time (JIT) compilation"),rv=d(),_c=o("li"),Js=o("a"),iv=r("Automatic Differentiation"),dv=d(),gc=o("li"),Ks=o("a"),lv=r("Vectorization"),cv=d(),kc=o("li"),Zs=o("a"),pv=r("Parallelization"),hv=d(),Ne=o("div"),u(Ys.$$.fragment),uv=d(),qn=o("p"),mv=r("The "),bc=o("code"),fv=r("FlaxMBartPreTrainedModel"),_v=r("forward method, overrides the "),yc=o("code"),gv=r("__call__"),kv=r(" special method."),bv=d(),u(_o.$$.fragment),yv=d(),vc=o("p"),vv=r("Example:"),Tv=d(),u(er.$$.fragment),wv=d(),Mt=o("div"),u(tr.$$.fragment),Mv=d(),Tc=o("p"),xv=r("Example:"),zv=d(),u(nr.$$.fragment),qv=d(),xt=o("div"),u(or.$$.fragment),Fv=d(),wc=o("p"),$v=r("Example:"),Bv=d(),u(ar.$$.fragment),ih=d(),Fn=o("h2"),go=o("a"),Mc=o("span"),u(sr.$$.fragment),jv=d(),xc=o("span"),Cv=r("FlaxMBartForConditionalGeneration"),dh=d(),U=o("div"),u(rr.$$.fragment),Ev=d(),ir=o("p"),Pv=r(`The MMBart Model with a language modeling head. Can be used for summarization.
...
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),Lv=d(),zc=o("p"),Gv=r("Finally, this model supports inherent JAX features such as:"),Wv=d(),_t=o("ul"),qc=o("li"),cr=o("a"),Rv=r("Just-In-Time (JIT) compilation"),Uv=d(),Fc=o("li"),pr=o("a"),Xv=r("Automatic Differentiation"),Vv=d(),$c=o("li"),hr=o("a"),Qv=r("Vectorization"),Hv=d(),Bc=o("li"),ur=o("a"),Jv=r("Parallelization"),Kv=d(),te=o("div"),u(mr.$$.fragment),Zv=d(),$n=o("p"),Yv=r("The "),jc=o("code"),eT=r("FlaxMBartPreTrainedModel"),tT=r("forward method, overrides the "),Cc=o("code"),nT=r("__call__"),oT=r(" special method."),aT=d(),u(ko.$$.fragment),sT=d(),Ec=o("p"),rT=r("Summarization example:"),iT=d(),u(fr.$$.fragment),dT=d(),Pc=o("p"),lT=r("Mask filling example:"),cT=d(),u(_r.$$.fragment),pT=d(),zt=o("div"),u(gr.$$.fragment),hT=d(),Sc=o("p"),uT=r("Example:"),mT=d(),u(kr.$$.fragment),fT=d(),qt=o("div"),u(br.$$.fragment),_T=d(),Ac=o("p"),gT=r("Example:"),kT=d(),u(yr.$$.fragment),lh=d(),Bn=o("h2"),bo=o("a"),Oc=o("span"),u(vr.$$.fragment),bT=d(),Ic=o("span"),yT=r("FlaxMBartForSequenceClassification"),ch=d(),O=o("div"),u(Tr.$$.fragment),vT=d(),Nc=o("p"),TT=r(`MBart model with a sequence classification/head on top (a linear layer on top of the pooled output) e.g. for GLUE
...
@patrickvonplaten`),wo.forEach(t),Ke=l(n),J=a(n,"H2",{class:!0});var Zr=s(J);N=a(Zr,"A",{id:!0,class:!0,href:!0});var fp=s(N);Xe=a(fp,"SPAN",{});var _p=s(Xe);m(se.$$.fragment,_p),_p.forEach(t),fp.forEach(t),E=l(Zr),A=a(Zr,"SPAN",{});var gp=s(A);lt=i(gp,"Overview of MBart"),gp.forEach(t),Zr.forEach(t),pe=l(n),he=a(n,"P",{});var Yr=s(he);ct=i(Yr,"The MBart model was presented in "),K=a(Yr,"A",{href:!0,rel:!0});var Zw=s(K);pt=i(Zw,"Multilingual Denoising Pre-training for Neural Machine Translation"),Zw.forEach(t),ht=i(Yr,` by Yinhan Liu, Jiatao Gu, Naman Goyal, Xian Li, Sergey Edunov Marjan
...
example shows how to translate English to Romanian using the `),md=a(Ai,"EM",{});var _M=s(md);Ju=i(_M,"facebook/mbart-large-en-ro"),_M.forEach(t),Ku=i(Ai," model."),Ai.forEach(t),fh.forEach(t),uM.forEach(t),wp=l(n),m(Oo.$$.fragment,n),Mp=l(n),Yt=a(n,"H2",{class:!0});var _h=s(Yt);Sn=a(_h,"A",{id:!0,class:!0,href:!0});var gM=s(Sn);fd=a(gM,"SPAN",{});var kM=s(fd);m(Io.$$.fragment,kM),kM.forEach(t),gM.forEach(t),Zu=l(_h),_d=a(_h,"SPAN",{});var bM=s(_d);Yu=i(bM,"Overview of MBart-50"),bM.forEach(t),_h.forEach(t),xp=l(n),vt=a(n,"P",{});var Oi=s(vt);em=i(Oi,"MBart-50 was introduced in the "),No=a(Oi,"A",{href:!0,rel:!0});var yM=s(No);tm=i(yM,"Multilingual Translation with Extensible Multilingual Pretraining and Finetuning"),yM.forEach(t),nm=i(Oi,` paper by Yuqing Tang, Chau Tran, Xian Li, Peng-Jen Chen, Naman Goyal, Vishrav
Chaudhary, Jiatao Gu, Angela Fan. MBart-50 is created using the original `),gd=a(Oi,"EM",{});var vM=s(gd);om=i(vM,"mbart-large-cc25"),vM.forEach(t),am=i(Oi,` checkpoint by extendeding
its embedding layers with randomly initialized vectors for an extra set of 25 language tokens and then pretrained on 50
...
can be extended to incorporate additional languages without loss of performance. Multilingual finetuning improves on
average 1 BLEU over the strongest baselines (being either multilingual from scratch or bilingual finetuning) while
improving 9.3 BLEU on average over bilingual baselines from scratch.`),MM.forEach(t),wM.forEach(t),Fp=l(n),en=a(n,"H3",{class:!0});var gh=s(en);An=a(gh,"A",{id:!0,class:!0,href:!0});var xM=s(An);bd=a(xM,"SPAN",{});var zM=s(bd);m(Do.$$.fragment,zM),zM.forEach(t),xM.forEach(t),im=l(gh),yd=a(gh,"SPAN",{});var qM=s(yd);dm=i(qM,"Training of MBart-50"),qM.forEach(t),gh.forEach(t),$p=l(n),et=a(n,"P",{});var Mo=s(et);lm=i(Mo,`The text format for MBart-50 is slightly different from mBART. For MBart-50 the language id token is used as a prefix
...
`),ia=a(Di,"A",{href:!0,rel:!0});var f2=s(ia);Df=i(f2,"BPE"),f2.forEach(t),Lf=i(Di,"."),Di.forEach(t),Gf=l(Q),Tt=a(Q,"P",{});var ei=s(Tt);mi=a(ei,"A",{href:!0});var _2=s(mi);Wf=i(_2,"MBartTokenizerFast"),_2.forEach(t),Rf=i(ei," is a subclass of "),fi=a(ei,"A",{href:!0});var g2=s(fi);Uf=i(g2,"XLMRobertaTokenizerFast"),g2.forEach(t),Xf=i(ei,`. Refer to superclass
`),_i=a(ei,"A",{href:!0});var k2=s(_i);Vf=i(k2,"XLMRobertaTokenizerFast"),k2.forEach(t),Qf=i(ei,` for usage examples and documentation concerning the initialization parameters and other
methods.`),ei.forEach(t),Hf=l(Q),da=a(Q,"P",{});var $h=s(da);Jf=i($h,"The tokenization method is "),Hd=a($h,"CODE",{});var b2=s(Hd);Kf=i(b2,"<tokens> <eos> <language code>"),b2.forEach(t),Zf=i($h," for source language documents, and \u201C<language code>\n<tokens> <eos>``` for target language documents."),$h.forEach(t),Yf=l(Q),Jd=a(Q,"P",{});var y2=s(Jd);e_=i(y2,"Examples:"),y2.forEach(t),t_=l(Q),m(la.$$.fragment,Q),n_=l(Q),Se=a(Q,"DIV",{class:!0});var Pt=s(Se);m(ca.$$.fragment,Pt),o_=l(Pt),Kd=a(Pt,"P",{});var v2=s(Kd);a_=i(v2,`Build model inputs from a sequence or a pair of sequence for sequence classification tasks by concatenating and
adding special tokens. The special tokens depend on calling set_lang.`),v2.forEach(t),s_=l(Pt),pa=a(Pt,"P",{});var Bh=s(pa);r_=i(Bh,"An MBART sequence has the following format, where "),Zd=a(Bh,"CODE",{});var T2=s(Zd);i_=i(T2,"X"),T2.forEach(t),d_=i(Bh," represents the sequence:"),Bh.forEach(t),l_=l(Pt),ha=a(Pt,"UL",{});var jh=s(ha);ua=a(jh,"LI",{});var Ch=s(ua);Yd=a(Ch,"CODE",{});var w2=s(Yd);c_=i(w2,"input_ids"),w2.forEach(t),p_=i(Ch," (for encoder) "),el=a(Ch,"CODE",{});var M2=s(el);h_=i(M2,"X [eos, src_lang_code]"),M2.forEach(t),Ch.forEach(t),u_=l(jh),ma=a(jh,"LI",{});var Eh=s(ma);tl=a(Eh,"CODE",{});var x2=s(tl);m_=i(x2,"decoder_input_ids"),x2.forEach(t),f_=i(Eh,": (for decoder) "),nl=a(Eh,"CODE",{});var z2=s(nl);__=i(z2,"X [eos, tgt_lang_code]"),z2.forEach(t),Eh.forEach(t),jh.forEach(t),g_=l(Pt),ol=a(Pt,"P",{});var q2=s(ol);k_=i(q2,`BOS is never used. Pairs of sequences are not the expected use case, but they will be handled without a
separator.`),q2.forEach(t),Pt.forEach(t),b_=l(Q),Gn=a(Q,"DIV",{class:!0});var Ph=s(Gn);m(fa.$$.fragment,Ph),y_=l(Ph),al=a(Ph,"P",{});var F2=s(al);v_=i(F2,`Create a mask from the two sequences passed to be used in a sequence-pair classification task. mBART does not
make use of token type ids, therefore a list of zeros is returned.`),F2.forEach(t),Ph.forEach(t),T_=l(Q),Wn=a(Q,"DIV",{class:!0});var Sh=s(Wn);m(_a.$$.fragment,Sh),w_=l(Sh),sl=a(Sh,"P",{});var $2=s(sl);M_=i($2,"Reset the special tokens to the source lang setting. No prefix and suffix=[eos, src_lang_code]."),$2.forEach(t),Sh.forEach(t),x_=l(Q),Rn=a(Q,"DIV",{class:!0});var Ah=s(Rn);m(ga.$$.fragment,Ah),z_=l(Ah),rl=a(Ah,"P",{});var B2=s(rl);q_=i(B2,"Reset the special tokens to the target language setting. No prefix and suffix=[eos, tgt_lang_code]."),B2.forEach(t),Ah.forEach(t),Q.forEach(t),Lp=l(n),dn=a(n,"H2",{class:!0});var Oh=s(dn);Un=a(Oh,"A",{id:!0,class:!0,href:!0});var j2=s(Un);il=a(j2,"SPAN",{});var C2=s(il);m(ka.$$.fragment,C2),C2.forEach(t),j2.forEach(t),F_=l(Oh),dl=a(Oh,"SPAN",{});var E2=s(dl);$_=i(E2,"MBart50Tokenizer"),E2.forEach(t),Oh.forEach(t),Gp=l(n),S=a(n,"DIV",{class:!0});var H=s(S);m(ba.$$.fragment,H),B_=l(H),ya=a(H,"P",{});var Ih=s(ya);j_=i(Ih,"Construct a MBart50 tokenizer. Based on "),va=a(Ih,"A",{href:!0,rel:!0});var P2=s(va);C_=i(P2,"SentencePiece"),P2.forEach(t),E_=i(Ih,"."),Ih.forEach(t),P_=l(H),Ta=a(H,"P",{});var Nh=s(Ta);S_=i(Nh,"This tokenizer inherits from "),gi=a(Nh,"A",{href:!0});var S2=s(gi);A_=i(S2,"PreTrainedTokenizer"),S2.forEach(t),O_=i(Nh,` which contains most of the main methods. Users should refer to
this superclass for more information regarding those methods.`),Nh.forEach(t),I_=l(H),ll=a(H,"P",{});var A2=s(ll);N_=i(A2,"Examples:"),A2.forEach(t),D_=l(H),m(wa.$$.fragment,H),L_=l(H),nt=a(H,"DIV",{class:!0});var qo=s(nt);m(Ma.$$.fragment,qo),G_=l(qo),xa=a(qo,"P",{});var Dh=s(xa);W_=i(Dh,`Build model inputs from a sequence or a pair of sequence for sequence classification tasks by concatenating and
adding special tokens. An MBART-50 sequence has the following format, where `),cl=a(Dh,"CODE",{});var O2=s(cl);R_=i(O2,"X"),O2.forEach(t),U_=i(Dh," represents the sequence:"),Dh.forEach(t),X_=l(qo),za=a(qo,"UL",{});var Lh=s(za);qa=a(Lh,"LI",{});var Gh=s(qa);pl=a(Gh,"CODE",{});var I2=s(pl);V_=i(I2,"input_ids"),I2.forEach(t),Q_=i(Gh," (for encoder) "),hl=a(Gh,"CODE",{});var N2=s(hl);H_=i(N2,"[src_lang_code] X [eos]"),N2.forEach(t),Gh.forEach(t),J_=l(Lh),Fa=a(Lh,"LI",{});var Wh=s(Fa);ul=a(Wh,"CODE",{});var D2=s(ul);K_=i(D2,"labels"),D2.forEach(t),Z_=i(Wh,": (for decoder) "),ml=a(Wh,"CODE",{});var L2=s(ml);Y_=i(L2,"[tgt_lang_code] X [eos]"),L2.forEach(t),Wh.forEach(t),Lh.forEach(t),eg=l(qo),fl=a(qo,"P",{});var G2=s(fl);tg=i(G2,`BOS is never used. Pairs of sequences are not the expected use case, but they will be handled without a
separator.`),G2.forEach(t),qo.forEach(t),ng=l(H),Xn=a(H,"DIV",{class:!0});var Rh=s(Xn);m($a.$$.fragment,Rh),og=l(Rh),_l=a(Rh,"P",{});var W2=s(_l);ag=i(W2,"Converts a sequence of tokens (strings for sub-words) in a single string."),W2.forEach(t),Rh.forEach(t),sg=l(H),Vn=a(H,"DIV",{class:!0});var Uh=s(Vn);m(Ba.$$.fragment,Uh),rg=l(Uh),ja=a(Uh,"P",{});var Xh=s(ja);ig=i(Xh,`Retrieve sequence ids from a token list that has no special tokens added. This method is called when adding
special tokens using the tokenizer `),gl=a(Xh,"CODE",{});var R2=s(gl);dg=i(R2,"prepare_for_model"),R2.forEach(t),lg=i(Xh," method."),Xh.forEach(t),Uh.forEach(t),cg=l(H),Qn=a(H,"DIV",{class:!0});var Vh=s(Qn);m(Ca.$$.fragment,Vh),pg=l(Vh),kl=a(Vh,"P",{});var U2=s(kl);hg=i(U2,"Reset the special tokens to the source lang setting. prefix=[src_lang_code] and suffix=[eos]."),U2.forEach(t),Vh.forEach(t),ug=l(H),Hn=a(H,"DIV",{class:!0});var Qh=s(Hn);m(Ea.$$.fragment,Qh),mg=l(Qh),bl=a(Qh,"P",{});var X2=s(bl);fg=i(X2,"Reset the special tokens to the target language setting. prefix=[tgt_lang_code] and suffix=[eos]."),X2.forEach(t),Qh.forEach(t),H.forEach(t),Wp=l(n),ln=a(n,"H2",{class:!0});var Hh=s(ln);Jn=a(Hh,"A",{id:!0,class:!0,href:!0});var V2=s(Jn);yl=a(V2,"SPAN",{});var Q2=s(yl);m(Pa.$$.fragment,Q2),Q2.forEach(t),V2.forEach(t),_g=l(Hh),vl=a(Hh,"SPAN",{});var H2=s(vl);gg=i(H2,"MBart50TokenizerFast"),H2.forEach(t),Hh.forEach(t),Rp=l(n),W=a(n,"DIV",{class:!0});var fe=s(W);m(Sa.$$.fragment,fe),kg=l(fe),cn=a(fe,"P",{});var Li=s(cn);bg=i(Li,"Construct a \u201Cfast\u201D MBART tokenizer for mBART-50 (backed by HuggingFace\u2019s "),Tl=a(Li,"EM",{});var J2=s(Tl);yg=i(J2,"tokenizers"),J2.forEach(t),vg=i(Li,` library). Based on
`),Aa=a(Li,"A",{href:!0,rel:!0});var K2=s(Aa);Tg=i(K2,"BPE"),K2.forEach(t),wg=i(Li,"."),Li.forEach(t),Mg=l(fe),Oa=a(fe,"P",{});var Jh=s(Oa);xg=i(Jh,"This tokenizer inherits from "),ki=a(Jh,"A",{href:!0});var Z2=s(ki);zg=i(Z2,"PreTrainedTokenizerFast"),Z2.forEach(t),qg=i(Jh,` which contains most of the main methods. Users should
refer to this superclass for more information regarding those methods.`),Jh.forEach(t),Fg=l(fe),wl=a(fe,"P",{});var Y2=s(wl);$g=i(Y2,"Examples:"),Y2.forEach(t),Bg=l(fe),m(Ia.$$.fragment,fe),jg=l(fe),Ae=a(fe,"DIV",{class:!0});var St=s(Ae);m(Na.$$.fragment,St),Cg=l(St),Ml=a(St,"P",{});var e1=s(Ml);Eg=i(e1,`Build model inputs from a sequence or a pair of sequence for sequence classification tasks by concatenating and
adding special tokens. The special tokens depend on calling set_lang.`),e1.forEach(t),Pg=l(St),Da=a(St,"P",{});var Kh=s(Da);Sg=i(Kh,"An MBART-50 sequence has the following format, where "),xl=a(Kh,"CODE",{});var t1=s(xl);Ag=i(t1,"X"),t1.forEach(t),Og=i(Kh," represents the sequence:"),Kh.forEach(t),Ig=l(St),La=a(St,"UL",{});var Zh=s(La);Ga=a(Zh,"LI",{});var Yh=s(Ga);zl=a(Yh,"CODE",{});var n1=s(zl);Ng=i(n1,"input_ids"),n1.forEach(t),Dg=i(Yh," (for encoder) "),ql=a(Yh,"CODE",{});var o1=s(ql);Lg=i(o1,"[src_lang_code] X [eos]"),o1.forEach(t),Yh.forEach(t),Gg=l(Zh),Wa=a(Zh,"LI",{});var eu=s(Wa);Fl=a(eu,"CODE",{});var a1=s(Fl);Wg=i(a1,"labels"),a1.forEach(t),Rg=i(eu,": (for decoder) "),$l=a(eu,"CODE",{});var s1=s($l);Ug=i(s1,"[tgt_lang_code] X [eos]"),s1.forEach(t),eu.forEach(t),Zh.forEach(t),Xg=l(St),Bl=a(St,"P",{});var r1=s(Bl);Vg=i(r1,`BOS is never used. Pairs of sequences are not the expected use case, but they will be handled without a
separator.`),r1.forEach(t),St.forEach(t),Qg=l(fe),Kn=a(fe,"DIV",{class:!0});var tu=s(Kn);m(Ra.$$.fragment,tu),Hg=l(tu),jl=a(tu,"P",{});var i1=s(jl);Jg=i(i1,"Reset the special tokens to the source lang setting. prefix=[src_lang_code] and suffix=[eos]."),i1.forEach(t),tu.forEach(t),Kg=l(fe),Zn=a(fe,"DIV",{class:!0});var nu=s(Zn);m(Ua.$$.fragment,nu),Zg=l(nu),Cl=a(nu,"P",{});var d1=s(Cl);Yg=i(d1,"Reset the special tokens to the target language setting. prefix=[src_lang_code] and suffix=[eos]."),d1.forEach(t),nu.forEach(t),fe.forEach(t),Up=l(n),pn=a(n,"H2",{class:!0});var ou=s(pn);Yn=a(ou,"A",{id:!0,class:!0,href:!0});var l1=s(Yn);El=a(l1,"SPAN",{});var c1=s(El);m(Xa.$$.fragment,c1),c1.forEach(t),l1.forEach(t),ek=l(ou),Pl=a(ou,"SPAN",{});var p1=s(Pl);tk=i(p1,"MBartModel"),p1.forEach(t),ou.forEach(t),Xp=l(n),He=a(n,"DIV",{class:!0});var Fo=s(He);m(Va.$$.fragment,Fo),nk=l(Fo),Qa=a(Fo,"P",{});var au=s(Qa);ok=i(au,`The bare MBART Model outputting raw hidden-states without any specific head on top.
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),su.forEach(t),ck=l(Fo),Oe=a(Fo,"DIV",{class:!0});var At=s(Oe);m(Ka.$$.fragment,At),pk=l(At),hn=a(At,"P",{});var Gi=s(hn);hk=i(Gi,"The "),yi=a(Gi,"A",{href:!0});var m1=s(yi);uk=i(m1,"MBartModel"),m1.forEach(t),mk=i(Gi," forward method, overrides the "),Sl=a(Gi,"CODE",{});var f1=s(Sl);fk=i(f1,"__call__"),f1.forEach(t),_k=i(Gi," special method."),Gi.forEach(t),gk=l(At),m(eo.$$.fragment,At),kk=l(At),Al=a(At,"P",{});var _1=s(Al);bk=i(_1,"Example:"),_1.forEach(t),yk=l(At),m(Za.$$.fragment,At),At.forEach(t),Fo.forEach(t),Vp=l(n),un=a(n,"H2",{class:!0});var ru=s(un);to=a(ru,"A",{id:!0,class:!0,href:!0});var g1=s(to);Ol=a(g1,"SPAN",{});var k1=s(Ol);m(Ya.$$.fragment,k1),k1.forEach(t),g1.forEach(t),vk=l(ru),Il=a(ru,"SPAN",{});var b1=s(Il);Tk=i(b1,"MBartForConditionalGeneration"),b1.forEach(t),ru.forEach(t),Qp=l(n),Je=a(n,"DIV",{class:!0});var $o=s(Je);m(es.$$.fragment,$o),wk=l($o),ts=a($o,"P",{});var iu=s(ts);Mk=i(iu,`The MBART Model with a language modeling head. Can be used for summarization.
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),pu.forEach(t),ib=l(Ot),ue=a(Ot,"DIV",{class:!0});var at=s(ue);m(hs.$$.fragment,at),db=l(at),gn=a(at,"P",{});var Ui=s(gn);lb=i(Ui,"The "),Mi=a(Ui,"A",{href:!0});var E1=s(Mi);cb=i(E1,"MBartForQuestionAnswering"),E1.forEach(t),pb=i(Ui," forward method, overrides the "),Xl=a(Ui,"CODE",{});var P1=s(Xl);hb=i(P1,"__call__"),P1.forEach(t),ub=i(Ui," special method."),Ui.forEach(t),mb=l(at),m(ao.$$.fragment,at),fb=l(at),Vl=a(at,"P",{});var S1=s(Vl);_b=i(S1,"Example:"),S1.forEach(t),gb=l(at),m(us.$$.fragment,at),kb=l(at),m(ms.$$.fragment,at),at.forEach(t),Ot.forEach(t),Kp=l(n),kn=a(n,"H2",{class:!0});var hu=s(kn);so=a(hu,"A",{id:!0,class:!0,href:!0});var A1=s(so);Ql=a(A1,"SPAN",{});var O1=s(Ql);m(fs.$$.fragment,O1),O1.forEach(t),A1.forEach(t),bb=l(hu),Hl=a(hu,"SPAN",{});var I1=s(Hl);yb=i(I1,"MBartForSequenceClassification"),I1.forEach(t),hu.forEach(t),Zp=l(n),Be=a(n,"DIV",{class:!0});var It=s(Be);m(_s.$$.fragment,It),vb=l(It),Jl=a(It,"P",{});var N1=s(Jl);Tb=i(N1,`MBart model with a sequence classification/head on top (a linear layer on top of the pooled output) e.g. for GLUE
tasks.`),N1.forEach(t),wb=l(It),gs=a(It,"P",{});var uu=s(gs);Mb=i(uu,"This model inherits from "),xi=a(uu,"A",{href:!0});var D1=s(xi);xb=i(D1,"PreTrainedModel"),D1.forEach(t),zb=i(uu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),xu.forEach(t),nv=l(_e),mc=a(_e,"P",{});var kx=s(mc);ov=i(kx,"Finally, this model supports inherent JAX features such as:"),kx.forEach(t),av=l(_e),ft=a(_e,"UL",{});var Bo=s(ft);fc=a(Bo,"LI",{});var bx=s(fc);Hs=a(bx,"A",{href:!0,rel:!0});var yx=s(Hs);sv=i(yx,"Just-In-Time (JIT) compilation"),yx.forEach(t),bx.forEach(t),rv=l(Bo),_c=a(Bo,"LI",{});var vx=s(_c);Js=a(vx,"A",{href:!0,rel:!0});var Tx=s(Js);iv=i(Tx,"Automatic Differentiation"),Tx.forEach(t),vx.forEach(t),dv=l(Bo),gc=a(Bo,"LI",{});var wx=s(gc);Ks=a(wx,"A",{href:!0,rel:!0});var Mx=s(Ks);lv=i(Mx,"Vectorization"),Mx.forEach(t),wx.forEach(t),cv=l(Bo),kc=a(Bo,"LI",{});var xx=s(kc);Zs=a(xx,"A",{href:!0,rel:!0});var zx=s(Zs);pv=i(zx,"Parallelization"),zx.forEach(t),xx.forEach(t),Bo.forEach(t),hv=l(_e),Ne=a(_e,"DIV",{class:!0});var Gt=s(Ne);m(Ys.$$.fragment,Gt),uv=l(Gt),qn=a(Gt,"P",{});var Ji=s(qn);mv=i(Ji,"The "),bc=a(Ji,"CODE",{});var qx=s(bc);fv=i(qx,"FlaxMBartPreTrainedModel"),qx.forEach(t),_v=i(Ji,"forward method, overrides the "),yc=a(Ji,"CODE",{});var Fx=s(yc);gv=i(Fx,"__call__"),Fx.forEach(t),kv=i(Ji," special method."),Ji.forEach(t),bv=l(Gt),m(_o.$$.fragment,Gt),yv=l(Gt),vc=a(Gt,"P",{});var $x=s(vc);vv=i($x,"Example:"),$x.forEach(t),Tv=l(Gt),m(er.$$.fragment,Gt),Gt.forEach(t),wv=l(_e),Mt=a(_e,"DIV",{class:!0});var Ki=s(Mt);m(tr.$$.fragment,Ki),Mv=l(Ki),Tc=a(Ki,"P",{});var Bx=s(Tc);xv=i(Bx,"Example:"),Bx.forEach(t),zv=l(Ki),m(nr.$$.fragment,Ki),Ki.forEach(t),qv=l(_e),xt=a(_e,"DIV",{class:!0});var Zi=s(xt);m(or.$$.fragment,Zi),Fv=l(Zi),wc=a(Zi,"P",{});var jx=s(wc);$v=i(jx,"Example:"),jx.forEach(t),Bv=l(Zi),m(ar.$$.fragment,Zi),Zi.forEach(t),_e.forEach(t),ih=l(n),Fn=a(n,"H2",{class:!0});var zu=s(Fn);go=a(zu,"A",{id:!0,class:!0,href:!0});var Cx=s(go);Mc=a(Cx,"SPAN",{});var Ex=s(Mc);m(sr.$$.fragment,Ex),Ex.forEach(t),Cx.forEach(t),jv=l(zu),xc=a(zu,"SPAN",{});var Px=s(xc);Cv=i(Px,"FlaxMBartForConditionalGeneration"),Px.forEach(t),zu.forEach(t),dh=l(n),U=a(n,"DIV",{class:!0});var ge=s(U);m(rr.$$.fragment,ge),Ev=l(ge),ir=a(ge,"P",{});var qu=s(ir);Pv=i(qu,`The MMBart Model with a language modeling head. Can be used for summarization.
...
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),ju.forEach(t),jT=l(oe),Dc=a(oe,"P",{});var az=s(Dc);CT=i(az,"Finally, this model supports inherent JAX features such as:"),az.forEach(t),ET=l(oe),gt=a(oe,"UL",{});var Co=s(gt);Lc=a(Co,"LI",{});var sz=s(Lc);zr=a(sz,"A",{href:!0,rel:!0});var rz=s(zr);PT=i(rz,"Just-In-Time (JIT) compilation"),rz.forEach(t),sz.forEach(t),ST=l(Co),Gc=a(Co,"LI",{});var iz=s(Gc);qr=a(iz,"A",{href:!0,rel:!0});var dz=s(qr);AT=i(dz,"Automatic Differentiation"),dz.forEach(t),iz.forEach(t),OT=l(Co),Wc=a(Co,"LI",{});var lz=s(Wc);Fr=a(lz,"A",{href:!0,rel:!0});var cz=s(Fr);IT=i(cz,"Vectorization"),cz.forEach(t),lz.forEach(t),NT=l(Co),Rc=a(Co,"LI",{});var pz=s(Rc);$r=a(pz,"A",{href:!0,rel:!0});var hz=s($r);DT=i(hz,"Parallelization"),hz.forEach(t),pz.forEach(t),Co.forEach(t),LT=l(oe),De=a(oe,"DIV",{class:!0});var Wt=s(De);m(Br.$$.fragment,Wt),GT=l(Wt),jn=a(Wt,"P",{});var nd=s(jn);WT=i(nd,"The "),Uc=a(nd,"CODE",{});var uz=s(Uc);RT=i(uz,"FlaxMBartPreTrainedModel"),uz.forEach(t),UT=i(nd,"forward method, overrides the "),Xc=a(nd,"CODE",{});var mz=s(Xc);XT=i(mz,"__call__"),mz.forEach(t),VT=i(nd," special method."),nd.forEach(t),QT=l(Wt),m(yo.$$.fragment,Wt),HT=l(Wt),Vc=a(Wt,"P",{});var fz=s(Vc);JT=i(fz,"Example:"),fz.forEach(t),KT=l(Wt),m(jr.$$.fragment,Wt),Wt.forEach(t),ZT=l(oe),Ft=a(oe,"DIV",{class:!0});var od=s(Ft);m(Cr.$$.fragment,od),YT=l(od),Qc=a(od,"P",{});var _z=s(Qc);ew=i(_z,"Example:"),_z.forEach(t),tw=l(od),m(Er.$$.fragment,od),od.forEach(t),nw=l(oe),$t=a(oe,"DIV",{class:!0});var ad=s($t);m(Pr.$$.fragment,ad),ow=l(ad),Hc=a(ad,"P",{});var gz=s(Hc);aw=i(gz,"Example:"),gz.forEach(t),sw=l(ad),m(Sr.$$.fragment,ad),ad.forEach(t),oe.forEach(t),ph=l(n),Cn=a(n,"H2",{class:!0});var Cu=s(Cn);vo=a(Cu,"A",{id:!0,class:!0,href:!0});var kz=s(vo);Jc=a(kz,"SPAN",{});var bz=s(Jc);m(Ar.$$.fragment,bz),bz.forEach(t),kz.forEach(t),rw=l(Cu),Kc=a(Cu,"SPAN",{});var yz=s(Kc);iw=i(yz,"FlaxMBartForQuestionAnswering"),yz.forEach(t),Cu.forEach(t),hh=l(n),I=a(n,"DIV",{class:!0});var ae=s(I);m(Or.$$.fragment,ae),dw=l(ae),En=a(ae,"P",{});var sd=s(En);lw=i(sd,`MBart Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
layer on top of the hidden-states output to compute `),Zc=a(sd,"CODE",{});var vz=s(Zc);cw=i(vz,"span start logits"),vz.forEach(t),pw=i(sd," and "),Yc=a(sd,"CODE",{});var Tz=s(Yc);hw=i(Tz,"span end logits"),Tz.forEach(t),uw=i(sd,")."),sd.forEach(t),mw=l(ae),Ir=a(ae,"P",{});var Eu=s(Ir);fw=i(Eu,"This model inherits from "),Pi=a(Eu,"A",{href:!0});var wz=s(Pi);_w=i(wz,"FlaxPreTrainedModel"),wz.forEach(t),gw=i(Eu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
