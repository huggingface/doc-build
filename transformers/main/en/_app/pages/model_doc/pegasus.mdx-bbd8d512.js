import{S as V_,i as R_,s as H_,e as n,k as l,w as b,t as r,M as K_,c as s,d as t,m as c,a,x as y,h as i,b as u,F as e,g as f,y as T,q as w,o as P,B as $,v as Q_,L as Qe}from"../../chunks/vendor-6b77c823.js";import{T as Uo}from"../../chunks/Tip-39098574.js";import{D as M}from"../../chunks/Docstring-1088f2fb.js";import{C as Se}from"../../chunks/CodeBlock-3a8b25a8.js";import{I as Z}from"../../chunks/IconCopyLink-7a11ce68.js";import{E as Ke}from"../../chunks/ExampleCodeBlock-5212b321.js";function J_(z){let p,v,_,h,k;return h=new Se({props:{code:`from transformers import PegasusModel, PegasusConfig
...
`),oe=s(R,"CODE",{});var lt=a(oe);V=i(lt,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),lt.forEach(t),R.forEach(t),L.forEach(t)},m(x,q){f(x,p,q),e(p,v),f(x,_,q),f(x,h,q),e(h,k),e(k,d),e(h,m),e(h,F),e(F,Oe),f(x,he,q),f(x,E,q),e(E,ke),e(E,ae),e(ae,Ae),e(E,re),e(E,ie),e(ie,Ie),e(E,xe),f(x,D,q),f(x,A,q),e(A,ve),f(x,H,q),f(x,S,q),e(S,O),e(O,Le),e(O,Y),e(Y,ee),e(O,Ge),e(O,U),e(U,Ne),e(S,De),e(S,I),e(I,me),e(I,de),e(de,ze),e(I,te),e(I,K),e(K,Ue),e(S,We),e(S,W),e(W,Be),e(W,oe),e(oe,V)},d(x){x&&t(p),x&&t(_),x&&t(h),x&&t(he),x&&t(E),x&&t(D),x&&t(A),x&&t(H),x&&t(S)}}}function nk(z){let p,v,_,h,k;return{c(){p=n("p"),v=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),_=n("code"),h=r("Module"),k=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(d){p=s(d,"P",{});var m=a(p);v=i(m,"Although the recipe for forward pass needs to be defined within this function, one should call the "),_=s(m,"CODE",{});var F=a(_);h=i(F,"Module"),F.forEach(t),k=i(m,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),{c(){p=n("p"),v=r("Example:"),_=l(),b(h.$$.fragment)},l(d){p=s(d,"P",{});var m=a(p);v=i(m,"Example:"),m.forEach(t),_=c(d),y(h.$$.fragment,d)},m(d,m){f(d,p,m),e(p,v),f(d,_,m),T(h,d,m),k=!0},p:Qe,i(d){k||(w(h.$$.fragment,d),k=!0)},o(d){P(h.$$.fragment,d),k=!1},d(d){d&&t(p),d&&t(_),$(h,d)}}}function ak(z){let p,v,_,h,k,d,m,F,Oe,he,E,ke,ae,Ae,re,ie,Ie,xe,D,A,ve,H,S,O,Le,Y,ee,Ge,U,Ne,De,I,me,de,ze,te,K,Ue,We,W,Be,oe,V;return{c(){p=n("p"),v=r("TF 2.0 models accepts two formats as inputs:"),_=l(),h=n("ul"),k=n("li"),d=r("having all inputs as keyword arguments (like PyTorch models), or"),m=l(),F=n("li"),Oe=r("having all inputs as a list, tuple or dict in the first positional arguments."),he=l(),E=n("p"),ke=r("This second option is useful when using "),ae=n("code"),Ae=r("tf.keras.Model.fit"),re=r(` method which currently requires having all the
tensors in the first argument of the model call function: `),ie=n("code"),Ie=r("model(inputs)"),xe=r("."),D=l(),A=n("p"),ve=r(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),H=l(),S=n("ul"),O=n("li"),Le=r("a single Tensor with "),Y=n("code"),ee=r("input_ids"),Ge=r(" only and nothing else: "),U=n("code"),Ne=r("model(input_ids)"),De=l(),I=n("li"),me=r(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),de=n("code"),ze=r("model([input_ids, attention_mask])"),te=r(" or "),K=n("code"),Ue=r("model([input_ids, attention_mask, token_type_ids])"),We=l(),W=n("li"),Be=r(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),oe=n("code"),V=r('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(x){p=s(x,"P",{});var q=a(p);v=i(q,"TF 2.0 models accepts two formats as inputs:"),q.forEach(t),_=c(x),h=s(x,"UL",{});var be=a(h);k=s(be,"LI",{});var at=a(k);d=i(at,"having all inputs as keyword arguments (like PyTorch models), or"),at.forEach(t),m=c(be),F=s(be,"LI",{});var ye=a(F);Oe=i(ye,"having all inputs as a list, tuple or dict in the first positional arguments."),ye.forEach(t),be.forEach(t),he=c(x),E=s(x,"P",{});var Q=a(E);ke=i(Q,"This second option is useful when using "),ae=s(Q,"CODE",{});var rt=a(ae);Ae=i(rt,"tf.keras.Model.fit"),rt.forEach(t),re=i(Q,` method which currently requires having all the
...
first positional argument :`),le.forEach(t),H=c(x),S=s(x,"UL",{});var L=a(S);O=s(L,"LI",{});var J=a(O);Le=i(J,"a single Tensor with "),Y=s(J,"CODE",{});var Te=a(Y);ee=i(Te,"input_ids"),Te.forEach(t),Ge=i(J," only and nothing else: "),U=s(J,"CODE",{});var it=a(U);Ne=i(it,"model(input_ids)"),it.forEach(t),J.forEach(t),De=c(L),I=s(L,"LI",{});var X=a(I);me=i(X,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),de=s(X,"CODE",{});var dt=a(de);ze=i(dt,"model([input_ids, attention_mask])"),dt.forEach(t),te=i(X," or "),K=s(X,"CODE",{});var Xe=a(K);Ue=i(Xe,"model([input_ids, attention_mask, token_type_ids])"),Xe.forEach(t),X.forEach(t),We=c(L),W=s(L,"LI",{});var R=a(W);Be=i(R,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),oe=s(R,"CODE",{});var lt=a(oe);V=i(lt,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),lt.forEach(t),R.forEach(t),L.forEach(t)},m(x,q){f(x,p,q),e(p,v),f(x,_,q),f(x,h,q),e(h,k),e(k,d),e(h,m),e(h,F),e(F,Oe),f(x,he,q),f(x,E,q),e(E,ke),e(E,ae),e(ae,Ae),e(E,re),e(E,ie),e(ie,Ie),e(E,xe),f(x,D,q),f(x,A,q),e(A,ve),f(x,H,q),f(x,S,q),e(S,O),e(O,Le),e(O,Y),e(Y,ee),e(O,Ge),e(O,U),e(U,Ne),e(S,De),e(S,I),e(I,me),e(I,de),e(de,ze),e(I,te),e(I,K),e(K,Ue),e(S,We),e(S,W),e(W,Be),e(W,oe),e(oe,V)},d(x){x&&t(p),x&&t(_),x&&t(h),x&&t(he),x&&t(E),x&&t(D),x&&t(A),x&&t(H),x&&t(S)}}}function rk(z){let p,v,_,h,k;return{c(){p=n("p"),v=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),_=n("code"),h=r("Module"),k=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(d){p=s(d,"P",{});var m=a(p);v=i(m,"Although the recipe for forward pass needs to be defined within this function, one should call the "),_=s(m,"CODE",{});var F=a(_);h=i(F,"Module"),F.forEach(t),k=i(m,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
<span class="hljs-meta">&gt;&gt;&gt; </span>outputs = model.decode(decoder_input_ids, encoder_outputs)
<span class="hljs-meta">&gt;&gt;&gt; </span>logits = outputs.logits`}}),{c(){p=n("p"),v=r("Example:"),_=l(),b(h.$$.fragment)},l(d){p=s(d,"P",{});var m=a(p);v=i(m,"Example:"),m.forEach(t),_=c(d),y(h.$$.fragment,d)},m(d,m){f(d,p,m),e(p,v),f(d,_,m),T(h,d,m),k=!0},p:Qe,i(d){k||(w(h.$$.fragment,d),k=!0)},o(d){P(h.$$.fragment,d),k=!1},d(d){d&&t(p),d&&t(_),$(h,d)}}}function fk(z){let p,v,_,h,k,d,m,F,Oe,he,E,ke,ae,Ae,re,ie,Ie,xe,D,A,ve,H,S,O,Le,Y,ee,Ge,U,Ne,De,I,me,de,ze,te,K,Ue,We,W,Be,oe,V,x,q,be,at,ye,Q,rt,Je,le,L,J,Te,it,X,dt,Xe,R,lt,Wo,Zd,Yd,la,el,tl,zi,fe,ca,ol,nl,ua,sl,al,pa,rl,il,Bo,dl,Vo,ll,cl,ul,At,Ro,pl,hl,Ho,ml,fl,Fi,ct,It,ha,Ko,gl,ma,_l,qi,Ze,Lt,Qo,kl,vl,Jo,bl,yl,Tl,fa,wl,Pl,ga,$l,Ei,ut,Gt,_a,Xo,xl,ka,zl,Ci,ge,va,ba,Fl,ql,ya,Es,El,Cs,Cl,Ml,Zo,Ta,jl,Sl,pt,wa,Ol,Al,Pa,Il,Ll,Yo,Gl,$a,Nl,Dl,Ul,xa,Ve,Wl,za,Bl,Vl,Fa,Rl,Hl,qa,Kl,Ql,Jl,Ea,ht,Xl,en,Zl,Yl,Ca,ec,tc,Mi,mt,Nt,Ma,tn,oc,ja,nc,ji,on,Si,ft,Dt,Sa,nn,sc,Oa,ac,Oi,we,sn,rc,gt,ic,Ms,dc,lc,an,cc,uc,pc,_t,hc,js,mc,fc,Ss,gc,_c,kc,Ut,Ai,kt,Wt,Aa,rn,vc,Ia,bc,Ii,Bt,yc,La,Tc,wc,Li,B,dn,Pc,ln,$c,cn,xc,zc,Fc,un,qc,Os,Ec,Cc,Mc,Fe,pn,jc,hn,Sc,Ga,Oc,Ac,Ic,mn,As,Lc,Na,Gc,Nc,fn,Dc,Da,Uc,Wc,Bc,Ua,Vc,Rc,Vt,gn,Hc,Wa,Kc,Qc,Rt,_n,Jc,Ba,Xc,Zc,Ht,kn,Yc,Va,eu,Gi,vt,Kt,Ra,vn,tu,Ha,ou,Ni,ce,bn,nu,bt,su,Ka,au,ru,yn,iu,du,lu,Tn,cu,Is,uu,pu,hu,Ye,wn,mu,Qa,fu,gu,Pn,Ls,_u,Ja,ku,vu,$n,bu,Xa,yu,Tu,wu,Qt,xn,Pu,Za,$u,Di,yt,Jt,Ya,zn,xu,er,zu,Ui,Pe,Fn,Fu,qn,qu,Gs,Eu,Cu,Mu,En,ju,Cn,Su,Ou,Au,qe,Mn,Iu,Tt,Lu,Ns,Gu,Nu,tr,Du,Uu,Wu,Xt,Bu,Zt,Wi,wt,Yt,or,jn,Vu,nr,Ru,Bi,$e,Sn,Hu,On,Ku,Ds,Qu,Ju,Xu,An,Zu,In,Yu,ep,tp,Ee,Ln,op,Pt,np,Us,sp,ap,sr,rp,ip,dp,eo,lp,to,Vi,$t,oo,ar,Gn,cp,rr,up,Ri,xt,Nn,pp,no,Dn,hp,so,Hi,zt,ao,ir,Un,mp,dr,fp,Ki,ue,Wn,gp,Bn,_p,Ws,kp,vp,bp,Vn,yp,Rn,Tp,wp,Pp,ro,$p,Ce,Hn,xp,Ft,zp,Bs,Fp,qp,lr,Ep,Cp,Mp,io,jp,lo,Qi,qt,co,cr,Kn,Sp,ur,Op,Ji,pe,Qn,Ap,Jn,Ip,Vs,Lp,Gp,Np,Xn,Dp,Zn,Up,Wp,Bp,uo,Vp,Me,Yn,Rp,Et,Hp,Rs,Kp,Qp,pr,Jp,Xp,Zp,po,Yp,ho,Xi,Ct,mo,hr,es,eh,mr,th,Zi,G,ts,oh,os,nh,Hs,sh,ah,rh,ns,ih,ss,dh,lh,ch,fr,uh,ph,Re,gr,as,hh,mh,_r,rs,fh,gh,kr,is,_h,kh,vr,ds,vh,bh,je,ls,yh,Mt,Th,br,wh,Ph,yr,$h,xh,zh,fo,Fh,go,qh,_o,cs,Eh,ko,Ch,vo,us,Mh,bo,Yi,jt,yo,Tr,ps,jh,wr,Sh,ed,N,hs,Oh,ms,Ah,Ks,Ih,Lh,Gh,fs,Nh,gs,Dh,Uh,Wh,Pr,Bh,Vh,He,$r,_s,Rh,Hh,xr,ks,Kh,Qh,zr,vs,Jh,Xh,Fr,bs,Zh,Yh,C,ys,em,St,tm,qr,om,nm,Er,sm,am,rm,To,im,Cr,dm,lm,Mr,jr,Sr,Or,cm,um,Ar,Ir,Lr,Gr,pm,hm,Nr,Dr,Ur,Wr,mm,fm,Br,Vr,Ts,wo,Po,Rr,ws,gm,Hr,_m,km,Kr,vm,bm,Qr,ym,Tm,Jr,Xr,Zr,Yr,wm,Pm,ei,ti,oi,ni,$m,xm,si,ai,ri,ii,zm,Fm,di,li,ci,ui,qm,Em,$o,Ps,Cm,xo,Mm,zo,$s,jm,Fo,td;return d=new Z({}),H=new Z({}),Te=new Z({}),Ko=new Z({}),Xo=new Z({}),tn=new Z({}),on=new Se({props:{code:`from transformers import PegasusForConditionalGeneration, PegasusTokenizer
import torch
...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/vmain/src/transformers/models/pegasus/tokenization_pegasus.py#L256",returnDescription:`
...
Whether or not to return a <a href="/docs/transformers/main/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vmain/src/transformers/models/pegasus/modeling_pegasus.py#L1185",returnDescription:`
<p>A <a
...
(masked), the loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vmain/src/transformers/models/pegasus/modeling_pegasus.py#L1352",returnDescription:`
<p>A <a
...
Whether or not to return a <a href="/docs/transformers/main/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vmain/src/transformers/models/pegasus/modeling_pegasus.py#L1544",returnDescription:`
<p>A <a
...
behaviors between training and evaluation).`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/vmain/src/transformers/models/pegasus/modeling_tf_pegasus.py#L1175",returnDescription:`
<p>A <a
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/main/en/main_classes/model#transformers.TFPreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/vmain/src/transformers/models/pegasus/modeling_tf_pegasus.py#L1250"}}),uo=new Uo({props:{$$slots:{default:[ak]},$$scope:{ctx:z}}}),Yn=new M({props:{name:"call",anchor:"transformers.TFPegasusForConditionalGeneration.call",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"decoder_input_ids",val:" = None"},{name:"decoder_attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"decoder_head_mask",val:" = None"},{name:"cross_attn_head_mask",val:" = None"},{name:"encoder_outputs",val:": typing.Optional[transformers.modeling_tf_outputs.TFBaseModelOutput] = None"},{name:"past_key_values",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"decoder_inputs_embeds",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"},{name:"labels",val:" = None"},{name:"training",val:" = False"}],parametersDescription:[{anchor:"transformers.TFPegasusForConditionalGeneration.call.input_ids",description:`<strong>input_ids</strong> (<code>tf.Tensor</code> of shape <code>({0})</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/main/en/model_doc/pegasus#transformers.PegasusTokenizer">PegasusTokenizer</a>. See <a href="/docs/transformers/main/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/main/en/model_doc/wav2vec2_phoneme#transformers.Wav2Vec2PhonemeCTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
Labels for computing the masked language modeling loss. Indices should either be in <code>[0, ..., config.vocab_size]</code> or -100 (see <code>input_ids</code> docstring). Tokens with indices set to <code>-100</code> are ignored
(masked), the loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vmain/src/transformers/models/pegasus/modeling_tf_pegasus.py#L1283",returnDescription:`
<p>A <a
...
Whether or not to return a <a href="/docs/transformers/main/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vmain/src/transformers/models/pegasus/modeling_flax_pegasus.py#L1163",returnDescription:`
<p>A <a
...
Whether or not to return a <a href="/docs/transformers/main/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vmain/src/transformers/models/pegasus/modeling_flax_pegasus.py#L986",returnDescription:`
<p>A <a
...
Whether or not to return a <a href="/docs/transformers/main/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vmain/src/transformers/models/pegasus/modeling_flax_pegasus.py#L1049",returnDescription:`
<p>A <a
...
`}}),bo=new Ke({props:{anchor:"transformers.FlaxPegasusModel.decode.example",$$slots:{default:[uk]},$$scope:{ctx:z}}}),ps=new Z({}),hs=new M({props:{name:"class transformers.FlaxPegasusForConditionalGeneration",anchor:"transformers.FlaxPegasusForConditionalGeneration",parameters:[{name:"config",val:": PegasusConfig"},{name:"input_shape",val:": typing.Tuple[int] = (1, 1)"},{name:"seed",val:": int = 0"},{name:"dtype",val:": dtype = <class 'jax._src.numpy.lax_numpy.float32'>"},{name:"_do_init",val:": bool = True"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.FlaxPegasusForConditionalGeneration.config",description:`<strong>config</strong> (<a href="/docs/transformers/main/en/model_doc/pegasus#transformers.PegasusConfig">PegasusConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
...
Whether or not to return a <a href="/docs/transformers/main/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vmain/src/transformers/models/pegasus/modeling_flax_pegasus.py#L1319",returnDescription:`
<p>A <a
...
`}}),Fo=new Ke({props:{anchor:"transformers.FlaxPegasusForConditionalGeneration.decode.example",$$slots:{default:[mk]},$$scope:{ctx:z}}}),{c(){p=n("meta"),v=l(),_=n("h1"),h=n("a"),k=n("span"),b(d.$$.fragment),m=l(),F=n("span"),Oe=r("Pegasus"),he=l(),E=n("p"),ke=n("strong"),ae=r("DISCLAIMER:"),Ae=r(" If you see something strange, file a "),re=n("a"),ie=r("Github Issue"),Ie=r(`
...
on the XSUM dataset. Data download instructions at `),Jo=n("a"),bl=r("examples/pytorch/summarization/"),yl=r("."),Tl=l(),fa=n("li"),wl=r("FP16 is not supported (help/ideas on this appreciated!)."),Pl=l(),ga=n("li"),$l=r("The adafactor optimizer is recommended for pegasus fine-tuning."),Ei=l(),ut=n("h2"),Gt=n("a"),_a=n("span"),b(Xo.$$.fragment),xl=l(),ka=n("span"),zl=r("Implementation Notes"),Ci=l(),ge=n("ul"),va=n("li"),ba=n("p"),Fl=r("All models are transformer encoder-decoders with 16 layers in each component."),ql=l(),ya=n("li"),Es=n("p"),El=r("The implementation is completely inherited from "),Cs=n("a"),Cl=r("BartForConditionalGeneration"),Ml=l(),Zo=n("li"),Ta=n("p"),jl=r("Some key configuration differences:"),Sl=l(),pt=n("ul"),wa=n("li"),Ol=r("static, sinusoidal position embeddings"),Al=l(),Pa=n("li"),Il=r("the model starts generating with pad_token_id (which has 0 token_embedding) as the prefix."),Ll=l(),Yo=n("li"),Gl=r("more beams are used ("),$a=n("code"),Nl=r("num_beams=8"),Dl=r(")"),Ul=l(),xa=n("li"),Ve=n("p"),Wl=r("All pretrained pegasus checkpoints are the same besides three attributes: "),za=n("code"),Bl=r("tokenizer.model_max_length"),Vl=r(` (maximum
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Ed.forEach(t),tp=c(Oo),Ee=s(Oo,"DIV",{class:!0});var Ao=a(Ee);y(Ln.$$.fragment,Ao),op=c(Ao),Pt=s(Ao,"P",{});var sa=a(Pt);np=i(sa,"The "),Us=s(sa,"A",{href:!0});var pg=a(Us);sp=i(pg,"PegasusForConditionalGeneration"),pg.forEach(t),ap=i(sa," forward method, overrides the "),sr=s(sa,"CODE",{});var hg=a(sr);rp=i(hg,"__call__"),hg.forEach(t),ip=i(sa," special method."),sa.forEach(t),dp=c(Ao),y(eo.$$.fragment,Ao),lp=c(Ao),y(to.$$.fragment,Ao),Ao.forEach(t),Oo.forEach(t),Vi=c(o),$t=s(o,"H2",{class:!0});var Cd=a($t);oo=s(Cd,"A",{id:!0,class:!0,href:!0});var mg=a(oo);ar=s(mg,"SPAN",{});var fg=a(ar);y(Gn.$$.fragment,fg),fg.forEach(t),mg.forEach(t),cp=c(Cd),rr=s(Cd,"SPAN",{});var gg=a(rr);up=i(gg,"PegasusForCausalLM"),gg.forEach(t),Cd.forEach(t),Ri=c(o),xt=s(o,"DIV",{class:!0});var Md=a(xt);y(Nn.$$.fragment,Md),pp=c(Md),no=s(Md,"DIV",{class:!0});var jd=a(no);y(Dn.$$.fragment,jd),hp=c(jd),y(so.$$.fragment,jd),jd.forEach(t),Md.forEach(t),Hi=c(o),zt=s(o,"H2",{class:!0});var Sd=a(zt);ao=s(Sd,"A",{id:!0,class:!0,href:!0});var _g=a(ao);ir=s(_g,"SPAN",{});var kg=a(ir);y(Un.$$.fragment,kg),kg.forEach(t),_g.forEach(t),mp=c(Sd),dr=s(Sd,"SPAN",{});var vg=a(dr);fp=i(vg,"TFPegasusModel"),vg.forEach(t),Sd.forEach(t),Ki=c(o),ue=s(o,"DIV",{class:!0});var nt=a(ue);y(Wn.$$.fragment,nt),gp=c(nt),Bn=s(nt,"P",{});var Od=a(Bn);_p=i(Od,`The bare PEGASUS Model outputting raw hidden-states without any specific head on top.
