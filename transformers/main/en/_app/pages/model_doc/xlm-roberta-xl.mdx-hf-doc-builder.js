import{S as Rd,i as Fd,s as Cd,e as i,k as g,w as k,t as a,M as zd,c as l,d as t,m as _,a as d,x as M,h as r,b as m,G as e,g as L,y as w,q as X,o as v,B as $,v as qd,L as O}from"../../chunks/vendor-hf-doc-builder.js";import{T as lt}from"../../chunks/Tip-hf-doc-builder.js";import{D as F}from"../../chunks/Docstring-hf-doc-builder.js";import{C as A}from"../../chunks/CodeBlock-hf-doc-builder.js";import{I as ae}from"../../chunks/IconCopyLink-hf-doc-builder.js";import{E as P}from"../../chunks/ExampleCodeBlock-hf-doc-builder.js";function Ed(T){let s,f,c,p,b;return p=new A({props:{code:`from transformers import XLMRobertaXLModel, XLMRobertaXLConfig
...
<span class="hljs-meta">&gt;&gt;&gt; </span>configuration = model.config`}}),{c(){s=i("p"),f=a("Examples:"),c=g(),k(p.$$.fragment)},l(n){s=l(n,"P",{});var h=d(s);f=r(h,"Examples:"),h.forEach(t),c=_(n),M(p.$$.fragment,n)},m(n,h){L(n,s,h),e(s,f),L(n,c,h),w(p,n,h),b=!0},p:O,i(n){b||(X(p.$$.fragment,n),b=!0)},o(n){v(p.$$.fragment,n),b=!1},d(n){n&&t(s),n&&t(c),$(p,n)}}}function jd(T){let s,f,c,p,b;return{c(){s=i("p"),f=a("Although the recipe for forward pass needs to be defined within this function, one should call the "),c=i("code"),p=a("Module"),b=a(`
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),{c(){s=i("p"),f=a("Example:"),c=g(),k(p.$$.fragment)},l(n){s=l(n,"P",{});var h=d(s);f=r(h,"Example:"),h.forEach(t),c=_(n),M(p.$$.fragment,n)},m(n,h){L(n,s,h),e(s,f),L(n,c,h),w(p,n,h),b=!0},p:O,i(n){b||(X(p.$$.fragment,n),b=!0)},o(n){v(p.$$.fragment,n),b=!1},d(n){n&&t(s),n&&t(c),$(p,n)}}}function Od(T){let s,f,c,p,b;return{c(){s=i("p"),f=a("Although the recipe for forward pass needs to be defined within this function, one should call the "),c=i("code"),p=a("Module"),b=a(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(n){s=l(n,"P",{});var h=d(s);f=r(h,"Although the recipe for forward pass needs to be defined within this function, one should call the "),c=l(h,"CODE",{});var y=d(c);p=r(y,"Module"),y.forEach(t),b=r(h,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
<span class="hljs-meta">&gt;&gt;&gt; </span>inputs = tokenizer(<span class="hljs-string">&quot;Hello, my dog is cute&quot;</span>, return_tensors=<span class="hljs-string">&quot;pt&quot;</span>)
<span class="hljs-meta">&gt;&gt;&gt; </span>outputs = model(**inputs)
<span class="hljs-meta">&gt;&gt;&gt; </span>prediction_logits = outputs.logits`}}),{c(){s=i("p"),f=a("Example:"),c=g(),k(p.$$.fragment)},l(n){s=l(n,"P",{});var h=d(s);f=r(h,"Example:"),h.forEach(t),c=_(n),M(p.$$.fragment,n)},m(n,h){L(n,s,h),e(s,f),L(n,c,h),w(p,n,h),b=!0},p:O,i(n){b||(X(p.$$.fragment,n),b=!0)},o(n){v(p.$$.fragment,n),b=!1},d(n){n&&t(s),n&&t(c),$(p,n)}}}function Sd(T){let s,f,c,p,b;return{c(){s=i("p"),f=a("Although the recipe for forward pass needs to be defined within this function, one should call the "),c=i("code"),p=a("Module"),b=a(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(n){s=l(n,"P",{});var h=d(s);f=r(h,"Although the recipe for forward pass needs to be defined within this function, one should call the "),c=l(h,"CODE",{});var y=d(c);p=r(y,"Module"),y.forEach(t),b=r(h,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
`}}),{c(){s=i("p"),f=a("Example:"),c=g(),k(p.$$.fragment)},l(n){s=l(n,"P",{});var h=d(s);f=r(h,"Example:"),h.forEach(t),c=_(n),M(p.$$.fragment,n)},m(n,h){L(n,s,h),e(s,f),L(n,c,h),w(p,n,h),b=!0},p:O,i(n){b||(X(p.$$.fragment,n),b=!0)},o(n){v(p.$$.fragment,n),b=!1},d(n){n&&t(s),n&&t(c),$(p,n)}}}function Id(T){let s,f;return s=new A({props:{code:`labels = tokenizer("The capital of France is Paris.", return_tensors="pt")["input_ids"]
...
`}}),{c(){k(s.$$.fragment)},l(c){M(s.$$.fragment,c)},m(c,p){w(s,c,p),f=!0},p:O,i(c){f||(X(s.$$.fragment,c),f=!0)},o(c){v(s.$$.fragment,c),f=!1},d(c){$(s,c)}}}function Dd(T){let s,f,c,p,b;return{c(){s=i("p"),f=a("Although the recipe for forward pass needs to be defined within this function, one should call the "),c=i("code"),p=a("Module"),b=a(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(n){s=l(n,"P",{});var h=d(s);f=r(h,"Although the recipe for forward pass needs to be defined within this function, one should call the "),c=l(h,"CODE",{});var y=d(c);p=r(y,"Module"),y.forEach(t),b=r(h,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
`}}),{c(){s=i("p"),f=a("Example of single-label classification:"),c=g(),k(p.$$.fragment)},l(n){s=l(n,"P",{});var h=d(s);f=r(h,"Example of single-label classification:"),h.forEach(t),c=_(n),M(p.$$.fragment,n)},m(n,h){L(n,s,h),e(s,f),L(n,c,h),w(p,n,h),b=!0},p:O,i(n){b||(X(p.$$.fragment,n),b=!0)},o(n){v(p.$$.fragment,n),b=!1},d(n){n&&t(s),n&&t(c),$(p,n)}}}function Bd(T){let s,f;return s=new A({props:{code:`# To train a model on \`num_labels\` classes, you can pass \`num_labels=num_labels\` to \`.from_pretrained(...)\`
...
`}}),{c(){k(s.$$.fragment)},l(c){M(s.$$.fragment,c)},m(c,p){w(s,c,p),f=!0},p:O,i(c){f||(X(s.$$.fragment,c),f=!0)},o(c){v(s.$$.fragment,c),f=!1},d(c){$(s,c)}}}function Qd(T){let s,f,c,p,b;return p=new A({props:{code:`import torch
from transformers import XLMRobertaTokenizer, XLMRobertaXLForSequenceClassification
...
<span class="hljs-meta">&gt;&gt;&gt; </span>predicted_class_id = logits.argmax().item()
<span class="hljs-meta">&gt;&gt;&gt; </span>model.config.id2label[predicted_class_id]
`}}),{c(){s=i("p"),f=a("Example of multi-label classification:"),c=g(),k(p.$$.fragment)},l(n){s=l(n,"P",{});var h=d(s);f=r(h,"Example of multi-label classification:"),h.forEach(t),c=_(n),M(p.$$.fragment,n)},m(n,h){L(n,s,h),e(s,f),L(n,c,h),w(p,n,h),b=!0},p:O,i(n){b||(X(p.$$.fragment,n),b=!0)},o(n){v(p.$$.fragment,n),b=!1},d(n){n&&t(s),n&&t(c),$(p,n)}}}function Hd(T){let s,f;return s=new A({props:{code:`# To train a model on \`num_labels\` classes, you can pass \`num_labels=num_labels\` to \`.from_pretrained(...)\`
num_labels = len(model.config.id2label)
...
<span class="hljs-meta">... </span>)
<span class="hljs-meta">&gt;&gt;&gt; </span>loss = model(**inputs, labels=labels).loss
<span class="hljs-meta">&gt;&gt;&gt; </span>loss.backward()`}}),{c(){k(s.$$.fragment)},l(c){M(s.$$.fragment,c)},m(c,p){w(s,c,p),f=!0},p:O,i(c){f||(X(s.$$.fragment,c),f=!0)},o(c){v(s.$$.fragment,c),f=!1},d(c){$(s,c)}}}function Ud(T){let s,f,c,p,b;return{c(){s=i("p"),f=a("Although the recipe for forward pass needs to be defined within this function, one should call the "),c=i("code"),p=a("Module"),b=a(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(n){s=l(n,"P",{});var h=d(s);f=r(h,"Although the recipe for forward pass needs to be defined within this function, one should call the "),c=l(h,"CODE",{});var y=d(c);p=r(y,"Module"),y.forEach(t),b=r(h,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
<span class="hljs-meta">&gt;&gt;&gt; </span>logits = outputs.logits`}}),{c(){s=i("p"),f=a("Example:"),c=g(),k(p.$$.fragment)},l(n){s=l(n,"P",{});var h=d(s);f=r(h,"Example:"),h.forEach(t),c=_(n),M(p.$$.fragment,n)},m(n,h){L(n,s,h),e(s,f),L(n,c,h),w(p,n,h),b=!0},p:O,i(n){b||(X(p.$$.fragment,n),b=!0)},o(n){v(p.$$.fragment,n),b=!1},d(n){n&&t(s),n&&t(c),$(p,n)}}}function Gd(T){let s,f,c,p,b;return{c(){s=i("p"),f=a("Although the recipe for forward pass needs to be defined within this function, one should call the "),c=i("code"),p=a("Module"),b=a(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(n){s=l(n,"P",{});var h=d(s);f=r(h,"Although the recipe for forward pass needs to be defined within this function, one should call the "),c=l(h,"CODE",{});var y=d(c);p=r(y,"Module"),y.forEach(t),b=r(h,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
`}}),{c(){s=i("p"),f=a("Example:"),c=g(),k(p.$$.fragment)},l(n){s=l(n,"P",{});var h=d(s);f=r(h,"Example:"),h.forEach(t),c=_(n),M(p.$$.fragment,n)},m(n,h){L(n,s,h),e(s,f),L(n,c,h),w(p,n,h),b=!0},p:O,i(n){b||(X(p.$$.fragment,n),b=!0)},o(n){v(p.$$.fragment,n),b=!1},d(n){n&&t(s),n&&t(c),$(p,n)}}}function Kd(T){let s,f;return s=new A({props:{code:`labels = predicted_token_class_ids
loss = model(**inputs, labels=labels).loss
round(loss.item(), 2)
`,highlighted:`<span class="hljs-meta">&gt;&gt;&gt; </span>labels = predicted_token_class_ids
<span class="hljs-meta">&gt;&gt;&gt; </span>loss = model(**inputs, labels=labels).loss
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-built_in">round</span>(loss.item(), <span class="hljs-number">2</span>)
`}}),{c(){k(s.$$.fragment)},l(c){M(s.$$.fragment,c)},m(c,p){w(s,c,p),f=!0},p:O,i(c){f||(X(s.$$.fragment,c),f=!0)},o(c){v(s.$$.fragment,c),f=!1},d(c){$(s,c)}}}function Yd(T){let s,f,c,p,b;return{c(){s=i("p"),f=a("Although the recipe for forward pass needs to be defined within this function, one should call the "),c=i("code"),p=a("Module"),b=a(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(n){s=l(n,"P",{});var h=d(s);f=r(h,"Although the recipe for forward pass needs to be defined within this function, one should call the "),c=l(h,"CODE",{});var y=d(c);p=r(y,"Module"),y.forEach(t),b=r(h,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
`}}),{c(){s=i("p"),f=a("Example:"),c=g(),k(p.$$.fragment)},l(n){s=l(n,"P",{});var h=d(s);f=r(h,"Example:"),h.forEach(t),c=_(n),M(p.$$.fragment,n)},m(n,h){L(n,s,h),e(s,f),L(n,c,h),w(p,n,h),b=!0},p:O,i(n){b||(X(p.$$.fragment,n),b=!0)},o(n){v(p.$$.fragment,n),b=!1},d(n){n&&t(s),n&&t(c),$(p,n)}}}function ec(T){let s,f;return s=new A({props:{code:`# target is "nice puppet"
...
<span class="hljs-meta">&gt;&gt;&gt; </span>loss = outputs.loss
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-built_in">round</span>(loss.item(), <span class="hljs-number">2</span>)
`}}),{c(){k(s.$$.fragment)},l(c){M(s.$$.fragment,c)},m(c,p){w(s,c,p),f=!0},p:O,i(c){f||(X(s.$$.fragment,c),f=!0)},o(c){v(s.$$.fragment,c),f=!1},d(c){$(s,c)}}}function oc(T){let s,f,c,p,b,n,h,y,Fs,Yn,re,Re,Ht,Lo,Cs,Ut,zs,Zn,Fe,qs,ko,Es,js,es,dt,Ps,os,ct,Vt,Os,ts,pt,As,ns,ht,Mo,Ss,Gt,Ns,Is,ss,Q,Ds,wo,Ws,Bs,Xo,Qs,Hs,vo,Us,Vs,as,ie,Ce,Jt,$o,Gs,Kt,Js,rs,S,To,Ks,G,Ys,mt,Zs,ea,Yt,oa,ta,yo,na,sa,aa,le,ra,ut,ia,la,ft,da,ca,pa,ze,is,de,qe,Zt,xo,ha,en,ma,ls,N,Ro,ua,ce,fa,gt,ga,_a,Fo,ba,La,ka,oe,Ma,on,wa,R,Xa,tn,va,$a,nn,Ta,ya,sn,xa,Ra,an,Fa,Ca,rn,za,qa,ln,Ea,ja,dn,Pa,Oa,Co,Aa,Sa,H,zo,Na,pe,Ia,_t,Da,Wa,cn,Ba,Qa,Ha,Ee,Ua,je,ds,he,Pe,pn,qo,Va,hn,Ga,cs,J,Eo,Ja,K,Ka,mn,Ya,Za,bt,er,or,jo,tr,nr,sr,U,Po,ar,me,rr,Lt,ir,lr,un,dr,cr,pr,Oe,hr,Ae,ps,ue,Se,fn,Oo,mr,gn,ur,hs,Y,Ao,fr,Z,gr,_n,_r,br,kt,Lr,kr,So,Mr,wr,Xr,C,No,vr,fe,$r,Mt,Tr,yr,bn,xr,Rr,Fr,Ne,Cr,Ie,zr,De,ms,ge,We,Ln,Io,qr,kn,Er,us,I,Do,jr,Mn,Pr,Or,_e,Ar,wt,Sr,Nr,Wo,Ir,Dr,Wr,x,Bo,Br,be,Qr,Xt,Hr,Ur,wn,Vr,Gr,Jr,Be,Kr,Qe,Yr,He,Zr,Ue,ei,Ve,fs,Le,Ge,Xn,Qo,oi,vn,ti,gs,D,Ho,ni,$n,si,ai,ke,ri,vt,ii,li,Uo,di,ci,pi,V,Vo,hi,Me,mi,$t,ui,fi,Tn,gi,_i,bi,Je,Li,Ke,_s,we,Ye,yn,Go,ki,xn,Mi,bs,W,Jo,wi,Rn,Xi,vi,Xe,$i,Tt,Ti,yi,Ko,xi,Ri,Fi,z,Yo,Ci,ve,zi,yt,qi,Ei,Fn,ji,Pi,Oi,Ze,Ai,eo,Si,oo,Ls,$e,to,Cn,Zo,Ni,zn,Ii,ks,B,et,Di,Te,Wi,qn,Bi,Qi,En,Hi,Ui,Vi,ye,Gi,xt,Ji,Ki,ot,Yi,Zi,el,q,tt,ol,xe,tl,Rt,nl,sl,jn,al,rl,il,no,ll,so,dl,ao,Ms;return n=new ae({}),Lo=new ae({}),$o=new ae({}),To=new F({props:{name:"class transformers.XLMRobertaXLConfig",anchor:"transformers.XLMRobertaXLConfig",parameters:[{name:"vocab_size",val:" = 250880"},{name:"hidden_size",val:" = 2560"},{name:"num_hidden_layers",val:" = 36"},{name:"num_attention_heads",val:" = 32"},{name:"intermediate_size",val:" = 10240"},{name:"hidden_act",val:" = 'gelu'"},{name:"hidden_dropout_prob",val:" = 0.1"},{name:"attention_probs_dropout_prob",val:" = 0.1"},{name:"max_position_embeddings",val:" = 514"},{name:"type_vocab_size",val:" = 1"},{name:"initializer_range",val:" = 0.02"},{name:"layer_norm_eps",val:" = 1e-05"},{name:"pad_token_id",val:" = 1"},{name:"bos_token_id",val:" = 0"},{name:"eos_token_id",val:" = 2"},{name:"position_embedding_type",val:" = 'absolute'"},{name:"use_cache",val:" = True"},{name:"classifier_dropout",val:" = None"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.XLMRobertaXLConfig.vocab_size",description:`<strong>vocab_size</strong> (<code>int</code>, <em>optional</em>, defaults to 250880) &#x2014;
...
<code>past_key_values</code>).`,name:"use_cache"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/xlm_roberta_xl/modeling_xlm_roberta_xl.py#L713",returnDescription:`
<p>A <a
...
model. Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/main/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/xlm_roberta_xl/modeling_xlm_roberta_xl.py#L855"}}),Po=new F({props:{name:"forward",anchor:"transformers.XLMRobertaXLForCausalLM.forward",parameters:[{name:"input_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"attention_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"token_type_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"position_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"head_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"encoder_hidden_states",val:": typing.Optional[torch.FloatTensor] = None"},{name:"encoder_attention_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"labels",val:": typing.Optional[torch.LongTensor] = None"},{name:"past_key_values",val:": typing.Optional[typing.Tuple[typing.Tuple[torch.FloatTensor]]] = None"},{name:"use_cache",val:": typing.Optional[bool] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.XLMRobertaXLForCausalLM.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. Indices can be obtained using <a href="/docs/transformers/main/en/model_doc/roberta#transformers.RobertaTokenizer">RobertaTokenizer</a>. See
<a href="/docs/transformers/main/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and <a href="/docs/transformers/main/en/model_doc/wav2vec2_phoneme#transformers.Wav2Vec2PhonemeCTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details. <a href="../glossary#input-ids">What are input
...
If set to <code>True</code>, <code>past_key_values</code> key value states are returned and can be used to speed up decoding (see
<code>past_key_values</code>).`,name:"use_cache"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/xlm_roberta_xl/modeling_xlm_roberta_xl.py#L880",returnDescription:`
<p>A <a
...
model. Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/main/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/xlm_roberta_xl/modeling_xlm_roberta_xl.py#L1005"}}),No=new F({props:{name:"forward",anchor:"transformers.XLMRobertaXLForMaskedLM.forward",parameters:[{name:"input_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"attention_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"token_type_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"position_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"head_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"encoder_hidden_states",val:": typing.Optional[torch.Tensor] = None"},{name:"encoder_attention_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"labels",val:": typing.Optional[torch.LongTensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.XLMRobertaXLForMaskedLM.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. Indices can be obtained using <a href="/docs/transformers/main/en/model_doc/roberta#transformers.RobertaTokenizer">RobertaTokenizer</a>. See
<a href="/docs/transformers/main/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and <a href="/docs/transformers/main/en/model_doc/wav2vec2_phoneme#transformers.Wav2Vec2PhonemeCTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details. <a href="../glossary#input-ids">What are input
...
Used to hide legacy arguments that have been deprecated.`,name:"kwargs"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/xlm_roberta_xl/modeling_xlm_roberta_xl.py#L1033",returnDescription:`
<p>A <a
...
model. Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/main/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/xlm_roberta_xl/modeling_xlm_roberta_xl.py#L1133"}}),Bo=new F({props:{name:"forward",anchor:"transformers.XLMRobertaXLForSequenceClassification.forward",parameters:[{name:"input_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"attention_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"token_type_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"position_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"head_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"labels",val:": typing.Optional[torch.LongTensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.XLMRobertaXLForSequenceClassification.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. Indices can be obtained using <a href="/docs/transformers/main/en/model_doc/roberta#transformers.RobertaTokenizer">RobertaTokenizer</a>. See
<a href="/docs/transformers/main/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and <a href="/docs/transformers/main/en/model_doc/wav2vec2_phoneme#transformers.Wav2Vec2PhonemeCTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details. <a href="../glossary#input-ids">What are input
...
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/xlm_roberta_xl/modeling_xlm_roberta_xl.py#L1146",returnDescription:`
<p>A <a
...
<code>input_ids</code> above)`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/xlm_roberta_xl/modeling_xlm_roberta_xl.py#L1242",returnDescription:`
<p>A <a
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/xlm_roberta_xl/modeling_xlm_roberta_xl.py#L1341",returnDescription:`
<p>A <a
...
model. Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/main/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/xlm_roberta_xl/modeling_xlm_roberta_xl.py#L1439"}}),tt=new F({props:{name:"forward",anchor:"transformers.XLMRobertaXLForQuestionAnswering.forward",parameters:[{name:"input_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"attention_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"token_type_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"position_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"head_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"start_positions",val:": typing.Optional[torch.LongTensor] = None"},{name:"end_positions",val:": typing.Optional[torch.LongTensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.XLMRobertaXLForQuestionAnswering.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. Indices can be obtained using <a href="/docs/transformers/main/en/model_doc/roberta#transformers.RobertaTokenizer">RobertaTokenizer</a>. See
<a href="/docs/transformers/main/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and <a href="/docs/transformers/main/en/model_doc/wav2vec2_phoneme#transformers.Wav2Vec2PhonemeCTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details. <a href="../glossary#input-ids">What are input
...
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/xlm_roberta_xl/modeling_xlm_roberta_xl.py#L1452",returnDescription:`
<p>A <a
...
general usage and behavior.`),ka=g(),oe=i("p"),Ma=a(`The model can behave as an encoder (with only self-attention) as well as a decoder, in which case a layer of
cross-attention is added between the self-attention layers, following the architecture described in `),on=i("em"),wa=a(`Attention is
all you need`),R=i("em"),Xa=a(`by Ashish Vaswani, Noam Shazeer, Niki Parmar, Jakob Uszkoreit, Llion Jones, Aidan N. Gomez, Lukasz
Kaiser and Illia Polosukhin. To behave as an decoder the model needs to be initialized with the `),tn=i("code"),va=a("is_decoder"),$a=a(`
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.) This model is also a PyTorch `),So=i("a"),Mr=a("torch.nn.Module"),wr=a(`
subclass. Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to
general usage and behavior.`),Xr=g(),C=i("div"),k(No.$$.fragment),vr=g(),fe=i("p"),$r=a("The "),Mt=i("a"),Tr=a("XLMRobertaXLForMaskedLM"),yr=a(" forward method, overrides the "),bn=i("code"),xr=a("__call__"),Rr=a(" special method."),Fr=g(),k(Ne.$$.fragment),Cr=g(),k(Ie.$$.fragment),zr=g(),k(De.$$.fragment),ms=g(),ge=i("h2"),We=i("a"),Ln=i("span"),k(Io.$$.fragment),qr=g(),kn=i("span"),Er=a("XLMRobertaXLForSequenceClassification"),us=g(),I=i("div"),k(Do.$$.fragment),jr=g(),Mn=i("p"),Pr=a(`XLM-RoBERTa-xlarge Model transformer with a sequence classification/regression head on top (a linear layer on top
of the pooled output) e.g. for GLUE tasks.`),Or=g(),_e=i("p"),Ar=a("This model inherits from "),wt=i("a"),Sr=a("PreTrainedModel"),Nr=a(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.) This model is also a PyTorch `),Wo=i("a"),Ir=a("torch.nn.Module"),Dr=a(`
subclass. Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to
general usage and behavior.`),Wr=g(),x=i("div"),k(Bo.$$.fragment),Br=g(),be=i("p"),Qr=a("The "),Xt=i("a"),Hr=a("XLMRobertaXLForSequenceClassification"),Ur=a(" forward method, overrides the "),wn=i("code"),Vr=a("__call__"),Gr=a(" special method."),Jr=g(),k(Be.$$.fragment),Kr=g(),k(Qe.$$.fragment),Yr=g(),k(He.$$.fragment),Zr=g(),k(Ue.$$.fragment),ei=g(),k(Ve.$$.fragment),fs=g(),Le=i("h2"),Ge=i("a"),Xn=i("span"),k(Qo.$$.fragment),oi=g(),vn=i("span"),ti=a("XLMRobertaXLForMultipleChoice"),gs=g(),D=i("div"),k(Ho.$$.fragment),ni=g(),$n=i("p"),si=a(`XLM-Roberta-xlarge Model with a multiple choice classification head on top (a linear layer on top of the pooled
output and a softmax) e.g. for RocStories/SWAG tasks.`),ai=g(),ke=i("p"),ri=a("This model inherits from "),vt=i("a"),ii=a("PreTrainedModel"),li=a(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.) This model is also a PyTorch `),Uo=i("a"),di=a("torch.nn.Module"),ci=a(`
subclass. Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to
general usage and behavior.`),pi=g(),V=i("div"),k(Vo.$$.fragment),hi=g(),Me=i("p"),mi=a("The "),$t=i("a"),ui=a("XLMRobertaXLForMultipleChoice"),fi=a(" forward method, overrides the "),Tn=i("code"),gi=a("__call__"),_i=a(" special method."),bi=g(),k(Je.$$.fragment),Li=g(),k(Ke.$$.fragment),_s=g(),we=i("h2"),Ye=i("a"),yn=i("span"),k(Go.$$.fragment),ki=g(),xn=i("span"),Mi=a("XLMRobertaXLForTokenClassification"),bs=g(),W=i("div"),k(Jo.$$.fragment),wi=g(),Rn=i("p"),Xi=a(`XLM-Roberta-xlarge Model with a token classification head on top (a linear layer on top of the hidden-states
output) e.g. for Named-Entity-Recognition (NER) tasks.`),vi=g(),Xe=i("p"),$i=a("This model inherits from "),Tt=i("a"),Ti=a("PreTrainedModel"),yi=a(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.) This model is also a PyTorch `),Ko=i("a"),xi=a("torch.nn.Module"),Ri=a(`
subclass. Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to
general usage and behavior.`),Fi=g(),z=i("div"),k(Yo.$$.fragment),Ci=g(),ve=i("p"),zi=a("The "),yt=i("a"),qi=a("XLMRobertaXLForTokenClassification"),Ei=a(" forward method, overrides the "),Fn=i("code"),ji=a("__call__"),Pi=a(" special method."),Oi=g(),k(Ze.$$.fragment),Ai=g(),k(eo.$$.fragment),Si=g(),k(oo.$$.fragment),Ls=g(),$e=i("h2"),to=i("a"),Cn=i("span"),k(Zo.$$.fragment),Ni=g(),zn=i("span"),Ii=a("XLMRobertaXLForQuestionAnswering"),ks=g(),B=i("div"),k(et.$$.fragment),Di=g(),Te=i("p"),Wi=a(`XLM-Roberta-xlarge Model with a span classification head on top for extractive question-answering tasks like SQuAD
...
language from the input ids.`),rt.forEach(t),Un.forEach(t),ss=_(o),Q=l(o,"P",{});var ee=d(Q);Ds=r(ee,"This model was contributed by "),wo=l(ee,"A",{href:!0,rel:!0});var Gn=d(wo);Ws=r(Gn,"Soonhwan-Kwon"),Gn.forEach(t),Bs=r(ee," and "),Xo=l(ee,"A",{href:!0,rel:!0});var Jn=d(Xo);Qs=r(Jn,"stefan-it"),Jn.forEach(t),Hs=r(ee,". The original code can be found "),vo=l(ee,"A",{href:!0,rel:!0});var Kn=d(vo);Us=r(Kn,"here"),Kn.forEach(t),Vs=r(ee,"."),ee.forEach(t),as=_(o),ie=l(o,"H2",{class:!0});var ws=d(ie);Ce=l(ws,"A",{id:!0,class:!0,href:!0});var cl=d(Ce);Jt=l(cl,"SPAN",{});var pl=d(Jt);M($o.$$.fragment,pl),pl.forEach(t),cl.forEach(t),Gs=_(ws),Kt=l(ws,"SPAN",{});var hl=d(Kt);Js=r(hl,"XLMRobertaXLConfig"),hl.forEach(t),ws.forEach(t),rs=_(o),S=l(o,"DIV",{class:!0});var ro=d(S);M(To.$$.fragment,ro),Ks=_(ro),G=l(ro,"P",{});var io=d(G);Ys=r(io,"This is the configuration class to store the configuration of a "),mt=l(io,"A",{href:!0});var ml=d(mt);Zs=r(ml,"XLMRobertaXLModel"),ml.forEach(t),ea=r(io," or a "),Yt=l(io,"CODE",{});var ul=d(Yt);oa=r(ul,"TFXLMRobertaXLModel"),ul.forEach(t),ta=r(io,`.
It is used to instantiate a XLM_ROBERTA_XL model according to the specified arguments, defining the model
architecture. Instantiating a configuration with the defaults will yield a similar configuration to that of the
...
documentation from `),ft=l(Ft,"A",{href:!0});var _l=d(ft);da=r(_l,"PretrainedConfig"),_l.forEach(t),ca=r(Ft," for more information."),Ft.forEach(t),pa=_(ro),M(ze.$$.fragment,ro),ro.forEach(t),is=_(o),de=l(o,"H2",{class:!0});var Xs=d(de);qe=l(Xs,"A",{id:!0,class:!0,href:!0});var bl=d(qe);Zt=l(bl,"SPAN",{});var Ll=d(Zt);M(xo.$$.fragment,Ll),Ll.forEach(t),bl.forEach(t),ha=_(Xs),en=l(Xs,"SPAN",{});var kl=d(en);ma=r(kl,"XLMRobertaXLModel"),kl.forEach(t),Xs.forEach(t),ls=_(o),N=l(o,"DIV",{class:!0});var lo=d(N);M(Ro.$$.fragment,lo),ua=_(lo),ce=l(lo,"P",{});var Ct=d(ce);fa=r(Ct,`The bare XLM-RoBERTa-xlarge Model transformer outputting raw hidden-states without any specific head on top.
This model inherits from `),gt=l(Ct,"A",{href:!0});var Ml=d(gt);ga=r(Ml,"PreTrainedModel"),Ml.forEach(t),_a=r(Ct,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.) This model is also a PyTorch `),Fo=l(Ct,"A",{href:!0,rel:!0});var wl=d(Fo);ba=r(wl,"torch.nn.Module"),wl.forEach(t),La=r(Ct,`
subclass. Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to
general usage and behavior.`),Ct.forEach(t),ka=_(lo),oe=l(lo,"P",{});var it=d(oe);Ma=r(it,`The model can behave as an encoder (with only self-attention) as well as a decoder, in which case a layer of
cross-attention is added between the self-attention layers, following the architecture described in `),on=l(it,"EM",{});var Xl=d(on);wa=r(Xl,`Attention is
all you need`),Xl.forEach(t),R=l(it,"EM",{});var E=d(R);Xa=r(E,`by Ashish Vaswani, Noam Shazeer, Niki Parmar, Jakob Uszkoreit, Llion Jones, Aidan N. Gomez, Lukasz
Kaiser and Illia Polosukhin. To behave as an decoder the model needs to be initialized with the `),tn=l(E,"CODE",{});var vl=d(tn);va=r(vl,"is_decoder"),vl.forEach(t),$a=r(E,`
...
an input to the forward pass. .. `),E.forEach(t),dn=l(it,"EM",{});var Fl=d(dn);Pa=r(Fl,"Attention is all you need"),Fl.forEach(t),Oa=r(it,": "),Co=l(it,"A",{href:!0,rel:!0});var Cl=d(Co);Aa=r(Cl,"https://arxiv.org/abs/1706.03762"),Cl.forEach(t),it.forEach(t),Sa=_(lo),H=l(lo,"DIV",{class:!0});var co=d(H);M(zo.$$.fragment,co),Na=_(co),pe=l(co,"P",{});var zt=d(pe);Ia=r(zt,"The "),_t=l(zt,"A",{href:!0});var zl=d(_t);Da=r(zl,"XLMRobertaXLModel"),zl.forEach(t),Wa=r(zt," forward method, overrides the "),cn=l(zt,"CODE",{});var ql=d(cn);Ba=r(ql,"__call__"),ql.forEach(t),Qa=r(zt," special method."),zt.forEach(t),Ha=_(co),M(Ee.$$.fragment,co),Ua=_(co),M(je.$$.fragment,co),co.forEach(t),lo.forEach(t),ds=_(o),he=l(o,"H2",{class:!0});var vs=d(he);Pe=l(vs,"A",{id:!0,class:!0,href:!0});var El=d(Pe);pn=l(El,"SPAN",{});var jl=d(pn);M(qo.$$.fragment,jl),jl.forEach(t),El.forEach(t),Va=_(vs),hn=l(vs,"SPAN",{});var Pl=d(hn);Ga=r(Pl,"XLMRobertaXLForCausalLM"),Pl.forEach(t),vs.forEach(t),cs=_(o),J=l(o,"DIV",{class:!0});var qt=d(J);M(Eo.$$.fragment,qt),Ja=_(qt),K=l(qt,"P",{});var po=d(K);Ka=r(po,"XLM-RoBERTa-xlarge Model with a "),mn=l(po,"CODE",{});var Ol=d(mn);Ya=r(Ol,"language modeling"),Ol.forEach(t),Za=r(po,` head on top for CLM fine-tuning.
...
subclass. Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to
general usage and behavior.`),po.forEach(t),sr=_(qt),U=l(qt,"DIV",{class:!0});var ho=d(U);M(Po.$$.fragment,ho),ar=_(ho),me=l(ho,"P",{});var Et=d(me);rr=r(Et,"The "),Lt=l(Et,"A",{href:!0});var Nl=d(Lt);ir=r(Nl,"XLMRobertaXLForCausalLM"),Nl.forEach(t),lr=r(Et," forward method, overrides the "),un=l(Et,"CODE",{});var Il=d(un);dr=r(Il,"__call__"),Il.forEach(t),cr=r(Et," special method."),Et.forEach(t),pr=_(ho),M(Oe.$$.fragment,ho),hr=_(ho),M(Ae.$$.fragment,ho),ho.forEach(t),qt.forEach(t),ps=_(o),ue=l(o,"H2",{class:!0});var $s=d(ue);Se=l($s,"A",{id:!0,class:!0,href:!0});var Dl=d(Se);fn=l(Dl,"SPAN",{});var Wl=d(fn);M(Oo.$$.fragment,Wl),Wl.forEach(t),Dl.forEach(t),mr=_($s),gn=l($s,"SPAN",{});var Bl=d(gn);ur=r(Bl,"XLMRobertaXLForMaskedLM"),Bl.forEach(t),$s.forEach(t),hs=_(o),Y=l(o,"DIV",{class:!0});var jt=d(Y);M(Ao.$$.fragment,jt),fr=_(jt),Z=l(jt,"P",{});var mo=d(Z);gr=r(mo,"XLM-RoBERTa-xlarge Model with a "),_n=l(mo,"CODE",{});var Ql=d(_n);_r=r(Ql,"language modeling"),Ql.forEach(t),br=r(mo,` head on top.
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.) This model is also a PyTorch `),So=l(mo,"A",{href:!0,rel:!0});var Ul=d(So);Mr=r(Ul,"torch.nn.Module"),Ul.forEach(t),wr=r(mo,`
subclass. Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to
general usage and behavior.`),mo.forEach(t),Xr=_(jt),C=l(jt,"DIV",{class:!0});var te=d(C);M(No.$$.fragment,te),vr=_(te),fe=l(te,"P",{});var Pt=d(fe);$r=r(Pt,"The "),Mt=l(Pt,"A",{href:!0});var Vl=d(Mt);Tr=r(Vl,"XLMRobertaXLForMaskedLM"),Vl.forEach(t),yr=r(Pt," forward method, overrides the "),bn=l(Pt,"CODE",{});var Gl=d(bn);xr=r(Gl,"__call__"),Gl.forEach(t),Rr=r(Pt," special method."),Pt.forEach(t),Fr=_(te),M(Ne.$$.fragment,te),Cr=_(te),M(Ie.$$.fragment,te),zr=_(te),M(De.$$.fragment,te),te.forEach(t),jt.forEach(t),ms=_(o),ge=l(o,"H2",{class:!0});var Ts=d(ge);We=l(Ts,"A",{id:!0,class:!0,href:!0});var Jl=d(We);Ln=l(Jl,"SPAN",{});var Kl=d(Ln);M(Io.$$.fragment,Kl),Kl.forEach(t),Jl.forEach(t),qr=_(Ts),kn=l(Ts,"SPAN",{});var Yl=d(kn);Er=r(Yl,"XLMRobertaXLForSequenceClassification"),Yl.forEach(t),Ts.forEach(t),us=_(o),I=l(o,"DIV",{class:!0});var uo=d(I);M(Do.$$.fragment,uo),jr=_(uo),Mn=l(uo,"P",{});var Zl=d(Mn);Pr=r(Zl,`XLM-RoBERTa-xlarge Model transformer with a sequence classification/regression head on top (a linear layer on top
of the pooled output) e.g. for GLUE tasks.`),Zl.forEach(t),Or=_(uo),_e=l(uo,"P",{});var Ot=d(_e);Ar=r(Ot,"This model inherits from "),wt=l(Ot,"A",{href:!0});var ed=d(wt);Sr=r(ed,"PreTrainedModel"),ed.forEach(t),Nr=r(Ot,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.) This model is also a PyTorch `),Wo=l(Ot,"A",{href:!0,rel:!0});var od=d(Wo);Ir=r(od,"torch.nn.Module"),od.forEach(t),Dr=r(Ot,`
subclass. Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to
general usage and behavior.`),Ot.forEach(t),Wr=_(uo),x=l(uo,"DIV",{class:!0});var j=d(x);M(Bo.$$.fragment,j),Br=_(j),be=l(j,"P",{});var At=d(be);Qr=r(At,"The "),Xt=l(At,"A",{href:!0});var td=d(Xt);Hr=r(td,"XLMRobertaXLForSequenceClassification"),td.forEach(t),Ur=r(At," forward method, overrides the "),wn=l(At,"CODE",{});var nd=d(wn);Vr=r(nd,"__call__"),nd.forEach(t),Gr=r(At," special method."),At.forEach(t),Jr=_(j),M(Be.$$.fragment,j),Kr=_(j),M(Qe.$$.fragment,j),Yr=_(j),M(He.$$.fragment,j),Zr=_(j),M(Ue.$$.fragment,j),ei=_(j),M(Ve.$$.fragment,j),j.forEach(t),uo.forEach(t),fs=_(o),Le=l(o,"H2",{class:!0});var ys=d(Le);Ge=l(ys,"A",{id:!0,class:!0,href:!0});var sd=d(Ge);Xn=l(sd,"SPAN",{});var ad=d(Xn);M(Qo.$$.fragment,ad),ad.forEach(t),sd.forEach(t),oi=_(ys),vn=l(ys,"SPAN",{});var rd=d(vn);ti=r(rd,"XLMRobertaXLForMultipleChoice"),rd.forEach(t),ys.forEach(t),gs=_(o),D=l(o,"DIV",{class:!0});var fo=d(D);M(Ho.$$.fragment,fo),ni=_(fo),$n=l(fo,"P",{});var id=d($n);si=r(id,`XLM-Roberta-xlarge Model with a multiple choice classification head on top (a linear layer on top of the pooled
output and a softmax) e.g. for RocStories/SWAG tasks.`),id.forEach(t),ai=_(fo),ke=l(fo,"P",{});var St=d(ke);ri=r(St,"This model inherits from "),vt=l(St,"A",{href:!0});var ld=d(vt);ii=r(ld,"PreTrainedModel"),ld.forEach(t),li=r(St,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.) This model is also a PyTorch `),Uo=l(St,"A",{href:!0,rel:!0});var dd=d(Uo);di=r(dd,"torch.nn.Module"),dd.forEach(t),ci=r(St,`
subclass. Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to
general usage and behavior.`),St.forEach(t),pi=_(fo),V=l(fo,"DIV",{class:!0});var go=d(V);M(Vo.$$.fragment,go),hi=_(go),Me=l(go,"P",{});var Nt=d(Me);mi=r(Nt,"The "),$t=l(Nt,"A",{href:!0});var cd=d($t);ui=r(cd,"XLMRobertaXLForMultipleChoice"),cd.forEach(t),fi=r(Nt," forward method, overrides the "),Tn=l(Nt,"CODE",{});var pd=d(Tn);gi=r(pd,"__call__"),pd.forEach(t),_i=r(Nt," special method."),Nt.forEach(t),bi=_(go),M(Je.$$.fragment,go),Li=_(go),M(Ke.$$.fragment,go),go.forEach(t),fo.forEach(t),_s=_(o),we=l(o,"H2",{class:!0});var xs=d(we);Ye=l(xs,"A",{id:!0,class:!0,href:!0});var hd=d(Ye);yn=l(hd,"SPAN",{});var md=d(yn);M(Go.$$.fragment,md),md.forEach(t),hd.forEach(t),ki=_(xs),xn=l(xs,"SPAN",{});var ud=d(xn);Mi=r(ud,"XLMRobertaXLForTokenClassification"),ud.forEach(t),xs.forEach(t),bs=_(o),W=l(o,"DIV",{class:!0});var _o=d(W);M(Jo.$$.fragment,_o),wi=_(_o),Rn=l(_o,"P",{});var fd=d(Rn);Xi=r(fd,`XLM-Roberta-xlarge Model with a token classification head on top (a linear layer on top of the hidden-states
output) e.g. for Named-Entity-Recognition (NER) tasks.`),fd.forEach(t),vi=_(_o),Xe=l(_o,"P",{});var It=d(Xe);$i=r(It,"This model inherits from "),Tt=l(It,"A",{href:!0});var gd=d(Tt);Ti=r(gd,"PreTrainedModel"),gd.forEach(t),yi=r(It,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.) This model is also a PyTorch `),Ko=l(It,"A",{href:!0,rel:!0});var _d=d(Ko);xi=r(_d,"torch.nn.Module"),_d.forEach(t),Ri=r(It,`
subclass. Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to
general usage and behavior.`),It.forEach(t),Fi=_(_o),z=l(_o,"DIV",{class:!0});var ne=d(z);M(Yo.$$.fragment,ne),Ci=_(ne),ve=l(ne,"P",{});var Dt=d(ve);zi=r(Dt,"The "),yt=l(Dt,"A",{href:!0});var bd=d(yt);qi=r(bd,"XLMRobertaXLForTokenClassification"),bd.forEach(t),Ei=r(Dt," forward method, overrides the "),Fn=l(Dt,"CODE",{});var Ld=d(Fn);ji=r(Ld,"__call__"),Ld.forEach(t),Pi=r(Dt," special method."),Dt.forEach(t),Oi=_(ne),M(Ze.$$.fragment,ne),Ai=_(ne),M(eo.$$.fragment,ne),Si=_(ne),M(oo.$$.fragment,ne),ne.forEach(t),_o.forEach(t),Ls=_(o),$e=l(o,"H2",{class:!0});var Rs=d($e);to=l(Rs,"A",{id:!0,class:!0,href:!0});var kd=d(to);Cn=l(kd,"SPAN",{});var Md=d(Cn);M(Zo.$$.fragment,Md),Md.forEach(t),kd.forEach(t),Ni=_(Rs),zn=l(Rs,"SPAN",{});var wd=d(zn);Ii=r(wd,"XLMRobertaXLForQuestionAnswering"),wd.forEach(t),Rs.forEach(t),ks=_(o),B=l(o,"DIV",{class:!0});var bo=d(B);M(et.$$.fragment,bo),Di=_(bo),Te=l(bo,"P",{});var Wt=d(Te);Wi=r(Wt,`XLM-Roberta-xlarge Model with a span classification head on top for extractive question-answering tasks like SQuAD
(a linear layers on top of the hidden-states output to compute `),qn=l(Wt,"CODE",{});var Xd=d(qn);Bi=r(Xd,"span start logits"),Xd.forEach(t),Qi=r(Wt," and "),En=l(Wt,"CODE",{});var vd=d(En);Hi=r(vd,"span end logits"),vd.forEach(t),Ui=r(Wt,")."),Wt.forEach(t),Vi=_(bo),ye=l(bo,"P",{});var Bt=d(ye);Gi=r(Bt,"This model inherits from "),xt=l(Bt,"A",{href:!0});var $d=d(xt);Ji=r($d,"PreTrainedModel"),$d.forEach(t),Ki=r(Bt,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.) This model is also a PyTorch `),ot=l(Bt,"A",{href:!0,rel:!0});var Td=d(ot);Yi=r(Td,"torch.nn.Module"),Td.forEach(t),Zi=r(Bt,`
subclass. Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to
general usage and behavior.`),Bt.forEach(t),el=_(bo),q=l(bo,"DIV",{class:!0});var se=d(q);M(tt.$$.fragment,se),ol=_(se),xe=l(se,"P",{});var Qt=d(xe);tl=r(Qt,"The "),Rt=l(Qt,"A",{href:!0});var yd=d(Rt);nl=r(yd,"XLMRobertaXLForQuestionAnswering"),yd.forEach(t),sl=r(Qt," forward method, overrides the "),jn=l(Qt,"CODE",{});var xd=d(jn);al=r(xd,"__call__"),xd.forEach(t),rl=r(Qt," special method."),Qt.forEach(t),il=_(se),M(no.$$.fragment,se),ll=_(se),M(so.$$.fragment,se),dl=_(se),M(ao.$$.fragment,se),se.forEach(t),bo.forEach(t),this.h()},h(){m(s,"name","hf:doc:metadata"),m(s,"content",JSON.stringify(tc)),m(p,"id","xlmrobertaxl"),m(p,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),m(p,"href","#xlmrobertaxl"),m(c,"class","relative group"),m(Re,"id","overview"),m(Re,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),m(Re,"href","#overview"),m(re,"class","relative group"),m(ko,"href","https://arxiv.org/abs/2105.00572"),m(ko,"rel","nofollow"),m(wo,"href","https://github.com/Soonhwan-Kwon"),m(wo,"rel","nofollow"),m(Xo,"href","https://huggingface.co/stefan-it"),m(Xo,"rel","nofollow"),m(vo,"href","https://github.com/pytorch/fairseq/tree/master/examples/xlmr"),m(vo,"rel","nofollow"),m(Ce,"id","transformers.XLMRobertaXLConfig"),m(Ce,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),m(Ce,"href","#transformers.XLMRobertaXLConfig"),m(ie,"class","relative group"),m(mt,"href","/docs/transformers/main/en/model_doc/xlm-roberta-xl#transformers.XLMRobertaXLModel"),m(yo,"href","https://huggingface.co/facebook/xlm-roberta-xl"),m(yo,"rel","nofollow"),m(ut,"href","/docs/transformers/main/en/main_classes/configuration#transformers.PretrainedConfig"),m(ft,"href","/docs/transformers/main/en/main_classes/configuration#transformers.PretrainedConfig"),m(S,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),m(qe,"id","transformers.XLMRobertaXLModel"),m(qe,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),m(qe,"href","#transformers.XLMRobertaXLModel"),m(de,"class","relative group"),m(gt,"href","/docs/transformers/main/en/main_classes/model#transformers.PreTrainedModel"),m(Fo,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),m(Fo,"rel","nofollow"),m(Co,"href","https://arxiv.org/abs/1706.03762"),m(Co,"rel","nofollow"),m(_t,"href","/docs/transformers/main/en/model_doc/xlm-roberta-xl#transformers.XLMRobertaXLModel"),m(H,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),m(N,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),m(Pe,"id","transformers.XLMRobertaXLForCausalLM"),m(Pe,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),m(Pe,"href","#transformers.XLMRobertaXLForCausalLM"),m(he,"class","relative group"),m(bt,"href","/docs/transformers/main/en/main_classes/model#transformers.PreTrainedModel"),m(jo,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),m(jo,"rel","nofollow"),m(Lt,"href","/docs/transformers/main/en/model_doc/xlm-roberta-xl#transformers.XLMRobertaXLForCausalLM"),m(U,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),m(J,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),m(Se,"id","transformers.XLMRobertaXLForMaskedLM"),m(Se,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),m(Se,"href","#transformers.XLMRobertaXLForMaskedLM"),m(ue,"class","relative group"),m(kt,"href","/docs/transformers/main/en/main_classes/model#transformers.PreTrainedModel"),m(So,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),m(So,"rel","nofollow"),m(Mt,"href","/docs/transformers/main/en/model_doc/xlm-roberta-xl#transformers.XLMRobertaXLForMaskedLM"),m(C,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),m(Y,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),m(We,"id","transformers.XLMRobertaXLForSequenceClassification"),m(We,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),m(We,"href","#transformers.XLMRobertaXLForSequenceClassification"),m(ge,"class","relative group"),m(wt,"href","/docs/transformers/main/en/main_classes/model#transformers.PreTrainedModel"),m(Wo,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),m(Wo,"rel","nofollow"),m(Xt,"href","/docs/transformers/main/en/model_doc/xlm-roberta-xl#transformers.XLMRobertaXLForSequenceClassification"),m(x,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),m(I,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),m(Ge,"id","transformers.XLMRobertaXLForMultipleChoice"),m(Ge,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),m(Ge,"href","#transformers.XLMRobertaXLForMultipleChoice"),m(Le,"class","relative group"),m(vt,"href","/docs/transformers/main/en/main_classes/model#transformers.PreTrainedModel"),m(Uo,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),m(Uo,"rel","nofollow"),m($t,"href","/docs/transformers/main/en/model_doc/xlm-roberta-xl#transformers.XLMRobertaXLForMultipleChoice"),m(V,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),m(D,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),m(Ye,"id","transformers.XLMRobertaXLForTokenClassification"),m(Ye,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),m(Ye,"href","#transformers.XLMRobertaXLForTokenClassification"),m(we,"class","relative group"),m(Tt,"href","/docs/transformers/main/en/main_classes/model#transformers.PreTrainedModel"),m(Ko,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),m(Ko,"rel","nofollow"),m(yt,"href","/docs/transformers/main/en/model_doc/xlm-roberta-xl#transformers.XLMRobertaXLForTokenClassification"),m(z,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),m(W,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),m(to,"id","transformers.XLMRobertaXLForQuestionAnswering"),m(to,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),m(to,"href","#transformers.XLMRobertaXLForQuestionAnswering"),m($e,"class","relative group"),m(xt,"href","/docs/transformers/main/en/main_classes/model#transformers.PreTrainedModel"),m(ot,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),m(ot,"rel","nofollow"),m(Rt,"href","/docs/transformers/main/en/model_doc/xlm-roberta-xl#transformers.XLMRobertaXLForQuestionAnswering"),m(q,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),m(B,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8")},m(o,u){e(document.head,s),L(o,f,u),L(o,c,u),e(c,p),e(p,b),w(n,b,null),e(c,h),e(c,y),e(y,Fs),L(o,Yn,u),L(o,re,u),e(re,Re),e(Re,Ht),w(Lo,Ht,null),e(re,Cs),e(re,Ut),e(Ut,zs),L(o,Zn,u),L(o,Fe,u),e(Fe,qs),e(Fe,ko),e(ko,Es),e(Fe,js),L(o,es,u),L(o,dt,u),e(dt,Ps),L(o,os,u),L(o,ct,u),e(ct,Vt),e(Vt,Os),L(o,ts,u),L(o,pt,u),e(pt,As),L(o,ns,u),L(o,ht,u),e(ht,Mo),e(Mo,Ss),e(Mo,Gt),e(Gt,Ns),e(Mo,Is),L(o,ss,u),L(o,Q,u),e(Q,Ds),e(Q,wo),e(wo,Ws),e(Q,Bs),e(Q,Xo),e(Xo,Qs),e(Q,Hs),e(Q,vo),e(vo,Us),e(Q,Vs),L(o,as,u),L(o,ie,u),e(ie,Ce),e(Ce,Jt),w($o,Jt,null),e(ie,Gs),e(ie,Kt),e(Kt,Js),L(o,rs,u),L(o,S,u),w(To,S,null),e(S,Ks),e(S,G),e(G,Ys),e(G,mt),e(mt,Zs),e(G,ea),e(G,Yt),e(Yt,oa),e(G,ta),e(G,yo),e(yo,na),e(G,sa),e(S,aa),e(S,le),e(le,ra),e(le,ut),e(ut,ia),e(le,la),e(le,ft),e(ft,da),e(le,ca),e(S,pa),w(ze,S,null),L(o,is,u),L(o,de,u),e(de,qe),e(qe,Zt),w(xo,Zt,null),e(de,ha),e(de,en),e(en,ma),L(o,ls,u),L(o,N,u),w(Ro,N,null),e(N,ua),e(N,ce),e(ce,fa),e(ce,gt),e(gt,ga),e(ce,_a),e(ce,Fo),e(Fo,ba),e(ce,La),e(N,ka),e(N,oe),e(oe,Ma),e(oe,on),e(on,wa),e(oe,R),e(R,Xa),e(R,tn),e(tn,va),e(R,$a),e(R,nn),e(nn,Ta),e(R,ya),e(R,sn),e(sn,xa),e(R,Ra),e(R,an),e(an,Fa),e(R,Ca),e(R,rn),e(rn,za),e(R,qa),e(R,ln),e(ln,Ea),e(R,ja),e(oe,dn),e(dn,Pa),e(oe,Oa),e(oe,Co),e(Co,Aa),e(N,Sa),e(N,H),w(zo,H,null),e(H,Na),e(H,pe),e(pe,Ia),e(pe,_t),e(_t,Da),e(pe,Wa),e(pe,cn),e(cn,Ba),e(pe,Qa),e(H,Ha),w(Ee,H,null),e(H,Ua),w(je,H,null),L(o,ds,u),L(o,he,u),e(he,Pe),e(Pe,pn),w(qo,pn,null),e(he,Va),e(he,hn),e(hn,Ga),L(o,cs,u),L(o,J,u),w(Eo,J,null),e(J,Ja),e(J,K),e(K,Ka),e(K,mn),e(mn,Ya),e(K,Za),e(K,bt),e(bt,er),e(K,or),e(K,jo),e(jo,tr),e(K,nr),e(J,sr),e(J,U),w(Po,U,null),e(U,ar),e(U,me),e(me,rr),e(me,Lt),e(Lt,ir),e(me,lr),e(me,un),e(un,dr),e(me,cr),e(U,pr),w(Oe,U,null),e(U,hr),w(Ae,U,null),L(o,ps,u),L(o,ue,u),e(ue,Se),e(Se,fn),w(Oo,fn,null),e(ue,mr),e(ue,gn),e(gn,ur),L(o,hs,u),L(o,Y,u),w(Ao,Y,null),e(Y,fr),e(Y,Z),e(Z,gr),e(Z,_n),e(_n,_r),e(Z,br),e(Z,kt),e(kt,Lr),e(Z,kr),e(Z,So),e(So,Mr),e(Z,wr),e(Y,Xr),e(Y,C),w(No,C,null),e(C,vr),e(C,fe),e(fe,$r),e(fe,Mt),e(Mt,Tr),e(fe,yr),e(fe,bn),e(bn,xr),e(fe,Rr),e(C,Fr),w(Ne,C,null),e(C,Cr),w(Ie,C,null),e(C,zr),w(De,C,null),L(o,ms,u),L(o,ge,u),e(ge,We),e(We,Ln),w(Io,Ln,null),e(ge,qr),e(ge,kn),e(kn,Er),L(o,us,u),L(o,I,u),w(Do,I,null),e(I,jr),e(I,Mn),e(Mn,Pr),e(I,Or),e(I,_e),e(_e,Ar),e(_e,wt),e(wt,Sr),e(_e,Nr),e(_e,Wo),e(Wo,Ir),e(_e,Dr),e(I,Wr),e(I,x),w(Bo,x,null),e(x,Br),e(x,be),e(be,Qr),e(be,Xt),e(Xt,Hr),e(be,Ur),e(be,wn),e(wn,Vr),e(be,Gr),e(x,Jr),w(Be,x,null),e(x,Kr),w(Qe,x,null),e(x,Yr),w(He,x,null),e(x,Zr),w(Ue,x,null),e(x,ei),w(Ve,x,null),L(o,fs,u),L(o,Le,u),e(Le,Ge),e(Ge,Xn),w(Qo,Xn,null),e(Le,oi),e(Le,vn),e(vn,ti),L(o,gs,u),L(o,D,u),w(Ho,D,null),e(D,ni),e(D,$n),e($n,si),e(D,ai),e(D,ke),e(ke,ri),e(ke,vt),e(vt,ii),e(ke,li),e(ke,Uo),e(Uo,di),e(ke,ci),e(D,pi),e(D,V),w(Vo,V,null),e(V,hi),e(V,Me),e(Me,mi),e(Me,$t),e($t,ui),e(Me,fi),e(Me,Tn),e(Tn,gi),e(Me,_i),e(V,bi),w(Je,V,null),e(V,Li),w(Ke,V,null),L(o,_s,u),L(o,we,u),e(we,Ye),e(Ye,yn),w(Go,yn,null),e(we,ki),e(we,xn),e(xn,Mi),L(o,bs,u),L(o,W,u),w(Jo,W,null),e(W,wi),e(W,Rn),e(Rn,Xi),e(W,vi),e(W,Xe),e(Xe,$i),e(Xe,Tt),e(Tt,Ti),e(Xe,yi),e(Xe,Ko),e(Ko,xi),e(Xe,Ri),e(W,Fi),e(W,z),w(Yo,z,null),e(z,Ci),e(z,ve),e(ve,zi),e(ve,yt),e(yt,qi),e(ve,Ei),e(ve,Fn),e(Fn,ji),e(ve,Pi),e(z,Oi),w(Ze,z,null),e(z,Ai),w(eo,z,null),e(z,Si),w(oo,z,null),L(o,Ls,u),L(o,$e,u),e($e,to),e(to,Cn),w(Zo,Cn,null),e($e,Ni),e($e,zn),e(zn,Ii),L(o,ks,u),L(o,B,u),w(et,B,null),e(B,Di),e(B,Te),e(Te,Wi),e(Te,qn),e(qn,Bi),e(Te,Qi),e(Te,En),e(En,Hi),e(Te,Ui),e(B,Vi),e(B,ye),e(ye,Gi),e(ye,xt),e(xt,Ji),e(ye,Ki),e(ye,ot),e(ot,Yi),e(ye,Zi),e(B,el),e(B,q),w(tt,q,null),e(q,ol),e(q,xe),e(xe,tl),e(xe,Rt),e(Rt,nl),e(xe,sl),e(xe,jn),e(jn,al),e(xe,rl),e(q,il),w(no,q,null),e(q,ll),w(so,q,null),e(q,dl),w(ao,q,null),Ms=!0},p(o,[u]){const nt={};u&2&&(nt.$$scope={dirty:u,ctx:o}),ze.$set(nt);const Pn={};u&2&&(Pn.$$scope={dirty:u,ctx:o}),Ee.$set(Pn);const On={};u&2&&(On.$$scope={dirty:u,ctx:o}),je.$set(On);const An={};u&2&&(An.$$scope={dirty:u,ctx:o}),Oe.$set(An);const st={};u&2&&(st.$$scope={dirty:u,ctx:o}),Ae.$set(st);const Sn={};u&2&&(Sn.$$scope={dirty:u,ctx:o}),Ne.$set(Sn);const Nn={};u&2&&(Nn.$$scope={dirty:u,ctx:o}),Ie.$set(Nn);const In={};u&2&&(In.$$scope={dirty:u,ctx:o}),De.$set(In);const at={};u&2&&(at.$$scope={dirty:u,ctx:o}),Be.$set(at);const Dn={};u&2&&(Dn.$$scope={dirty:u,ctx:o}),Qe.$set(Dn);const Wn={};u&2&&(Wn.$$scope={dirty:u,ctx:o}),He.$set(Wn);const Bn={};u&2&&(Bn.$$scope={dirty:u,ctx:o}),Ue.$set(Bn);const Qn={};u&2&&(Qn.$$scope={dirty:u,ctx:o}),Ve.$set(Qn);const Hn={};u&2&&(Hn.$$scope={dirty:u,ctx:o}),Je.$set(Hn);const Un={};u&2&&(Un.$$scope={dirty:u,ctx:o}),Ke.$set(Un);const rt={};u&2&&(rt.$$scope={dirty:u,ctx:o}),Ze.$set(rt);const Vn={};u&2&&(Vn.$$scope={dirty:u,ctx:o}),eo.$set(Vn);const ee={};u&2&&(ee.$$scope={dirty:u,ctx:o}),oo.$set(ee);const Gn={};u&2&&(Gn.$$scope={dirty:u,ctx:o}),no.$set(Gn);const Jn={};u&2&&(Jn.$$scope={dirty:u,ctx:o}),so.$set(Jn);const Kn={};u&2&&(Kn.$$scope={dirty:u,ctx:o}),ao.$set(Kn)},i(o){Ms||(X(n.$$.fragment,o),X(Lo.$$.fragment,o),X($o.$$.fragment,o),X(To.$$.fragment,o),X(ze.$$.fragment,o),X(xo.$$.fragment,o),X(Ro.$$.fragment,o),X(zo.$$.fragment,o),X(Ee.$$.fragment,o),X(je.$$.fragment,o),X(qo.$$.fragment,o),X(Eo.$$.fragment,o),X(Po.$$.fragment,o),X(Oe.$$.fragment,o),X(Ae.$$.fragment,o),X(Oo.$$.fragment,o),X(Ao.$$.fragment,o),X(No.$$.fragment,o),X(Ne.$$.fragment,o),X(Ie.$$.fragment,o),X(De.$$.fragment,o),X(Io.$$.fragment,o),X(Do.$$.fragment,o),X(Bo.$$.fragment,o),X(Be.$$.fragment,o),X(Qe.$$.fragment,o),X(He.$$.fragment,o),X(Ue.$$.fragment,o),X(Ve.$$.fragment,o),X(Qo.$$.fragment,o),X(Ho.$$.fragment,o),X(Vo.$$.fragment,o),X(Je.$$.fragment,o),X(Ke.$$.fragment,o),X(Go.$$.fragment,o),X(Jo.$$.fragment,o),X(Yo.$$.fragment,o),X(Ze.$$.fragment,o),X(eo.$$.fragment,o),X(oo.$$.fragment,o),X(Zo.$$.fragment,o),X(et.$$.fragment,o),X(tt.$$.fragment,o),X(no.$$.fragment,o),X(so.$$.fragment,o),X(ao.$$.fragment,o),Ms=!0)},o(o){v(n.$$.fragment,o),v(Lo.$$.fragment,o),v($o.$$.fragment,o),v(To.$$.fragment,o),v(ze.$$.fragment,o),v(xo.$$.fragment,o),v(Ro.$$.fragment,o),v(zo.$$.fragment,o),v(Ee.$$.fragment,o),v(je.$$.fragment,o),v(qo.$$.fragment,o),v(Eo.$$.fragment,o),v(Po.$$.fragment,o),v(Oe.$$.fragment,o),v(Ae.$$.fragment,o),v(Oo.$$.fragment,o),v(Ao.$$.fragment,o),v(No.$$.fragment,o),v(Ne.$$.fragment,o),v(Ie.$$.fragment,o),v(De.$$.fragment,o),v(Io.$$.fragment,o),v(Do.$$.fragment,o),v(Bo.$$.fragment,o),v(Be.$$.fragment,o),v(Qe.$$.fragment,o),v(He.$$.fragment,o),v(Ue.$$.fragment,o),v(Ve.$$.fragment,o),v(Qo.$$.fragment,o),v(Ho.$$.fragment,o),v(Vo.$$.fragment,o),v(Je.$$.fragment,o),v(Ke.$$.fragment,o),v(Go.$$.fragment,o),v(Jo.$$.fragment,o),v(Yo.$$.fragment,o),v(Ze.$$.fragment,o),v(eo.$$.fragment,o),v(oo.$$.fragment,o),v(Zo.$$.fragment,o),v(et.$$.fragment,o),v(tt.$$.fragment,o),v(no.$$.fragment,o),v(so.$$.fragment,o),v(ao.$$.fragment,o),Ms=!1},d(o){t(s),o&&t(f),o&&t(c),$(n),o&&t(Yn),o&&t(re),$(Lo),o&&t(Zn),o&&t(Fe),o&&t(es),o&&t(dt),o&&t(os),o&&t(ct),o&&t(ts),o&&t(pt),o&&t(ns),o&&t(ht),o&&t(ss),o&&t(Q),o&&t(as),o&&t(ie),$($o),o&&t(rs),o&&t(S),$(To),$(ze),o&&t(is),o&&t(de),$(xo),o&&t(ls),o&&t(N),$(Ro),$(zo),$(Ee),$(je),o&&t(ds),o&&t(he),$(qo),o&&t(cs),o&&t(J),$(Eo),$(Po),$(Oe),$(Ae),o&&t(ps),o&&t(ue),$(Oo),o&&t(hs),o&&t(Y),$(Ao),$(No),$(Ne),$(Ie),$(De),o&&t(ms),o&&t(ge),$(Io),o&&t(us),o&&t(I),$(Do),$(Bo),$(Be),$(Qe),$(He),$(Ue),$(Ve),o&&t(fs),o&&t(Le),$(Qo),o&&t(gs),o&&t(D),$(Ho),$(Vo),$(Je),$(Ke),o&&t(_s),o&&t(we),$(Go),o&&t(bs),o&&t(W),$(Jo),$(Yo),$(Ze),$(eo),$(oo),o&&t(Ls),o&&t($e),$(Zo),o&&t(ks),o&&t(B),$(et),$(tt),$(no),$(so),$(ao)}}}const tc={local:"xlmrobertaxl",sections:[{local:"overview",title:"Overview"},{local:"transformers.XLMRobertaXLConfig",title:"XLMRobertaXLConfig"},{local:"transformers.XLMRobertaXLModel",title:"XLMRobertaXLModel"},{local:"transformers.XLMRobertaXLForCausalLM",title:"XLMRobertaXLForCausalLM"},{local:"transformers.XLMRobertaXLForMaskedLM",title:"XLMRobertaXLForMaskedLM"},{local:"transformers.XLMRobertaXLForSequenceClassification",title:"XLMRobertaXLForSequenceClassification"},{local:"transformers.XLMRobertaXLForMultipleChoice",title:"XLMRobertaXLForMultipleChoice"},{local:"transformers.XLMRobertaXLForTokenClassification",title:"XLMRobertaXLForTokenClassification"},{local:"transformers.XLMRobertaXLForQuestionAnswering",title:"XLMRobertaXLForQuestionAnswering"}],title:"XLM-RoBERTa-XL"};function nc(T){return qd(()=>{new URLSearchParams(window.location.search).get("fw")}),[]}class cc extends Rd{constructor(s){super();Fd(this,s,nc,oc,Cd,{})}}export{cc as default,tc as metadata};
