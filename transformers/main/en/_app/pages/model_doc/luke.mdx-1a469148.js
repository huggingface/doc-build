...
the latter silently ignores them.`)},l(g){h=i(g,"P",{});var f=r(h);L=s(f,"Although the recipe for forward pass needs to be defined within this function, one should call the "),m=i(f,"CODE",{});var z=r(m);w=s(z,"Module"),z.forEach(t),E=s(f,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),f.forEach(t)},m(g,f){u(g,h,f),e(h,L),e(h,m),e(m,w),e(h,E)},d(g){g&&t(h)}}}function hp(U){let h,L,m,w,E,g,f,z,Bs,Ho,le,xe,Dn,He,Ws,Bn,Os,Vo,$e,Us,Ve,Ks,Rs,Yo,Jt,Hs,Qo,Xt,Wn,Vs,Jo,Gt,Ys,Xo,R,On,Ye,Qs,Zt,Js,Xs,Gs,Un,q,Zs,Kn,ea,ta,Rn,na,oa,Hn,sa,aa,Vn,ia,ra,en,da,la,ca,Qe,H,tn,pa,ha,Yn,ua,ma,Qn,fa,ga,Jn,_a,ka,ya,Je,nn,Xn,ba,va,Ta,on,Gn,wa,La,Ea,K,Zn,za,xa,ce,qe,sn,$a,qa,Xe,Ma,Ca,Fa,Me,an,Pa,ja,Ge,Aa,Ia,Sa,rn,dn,Na,Da,Ba,S,ln,Wa,Oa,eo,Ua,Ka,to,Ra,Ha,no,Va,Ya,oo,Qa,Ja,Xa,pe,Ga,cn,Za,ei,Ze,ti,ni,oi,et,si,tt,ai,ii,Go,pn,ri,Zo,nt,es,V,di,ot,li,ci,st,pi,hi,at,ui,mi,ts,he,Ce,so,it,fi,ao,gi,ns,M,rt,_i,dt,ki,hn,yi,bi,vi,ue,Ti,un,wi,Li,mn,Ei,zi,xi,io,$i,qi,lt,os,me,Fe,ro,ct,Mi,lo,Ci,ss,C,pt,Fi,co,Pi,ji,x,Ai,fn,Ii,Si,gn,Ni,Di,_n,Bi,Wi,po,Oi,Ui,ho,Ki,Ri,uo,Hi,Vi,mo,Yi,Qi,Ji,Pe,ht,Xi,fo,Gi,Zi,kn,ut,as,fe,je,go,mt,er,_o,tr,is,F,ft,nr,ko,or,sr,gt,ar,yn,ir,rr,dr,_t,lr,kt,cr,pr,hr,N,yt,ur,ge,mr,bn,fr,gr,yo,_r,kr,yr,Ae,br,bo,vr,Tr,bt,rs,_e,Ie,vo,vt,wr,To,Lr,ds,P,Tt,Er,wo,zr,xr,wt,$r,vn,qr,Mr,Cr,Lt,Fr,Et,Pr,jr,Ar,J,zt,Ir,ke,Sr,Tn,Nr,Dr,Lo,Br,Wr,Or,Se,ls,ye,Ne,Eo,xt,Ur,zo,Kr,cs,j,$t,Rr,xo,Hr,Vr,qt,Yr,wn,Qr,Jr,Xr,Mt,Gr,Ct,Zr,ed,td,D,Ft,nd,be,od,Ln,sd,ad,$o,id,rd,dd,De,ld,qo,cd,pd,Pt,ps,ve,Be,Mo,jt,hd,Co,ud,hs,A,At,md,Fo,fd,gd,It,_d,En,kd,yd,bd,St,vd,Nt,Td,wd,Ld,B,Dt,Ed,Te,zd,zn,xd,$d,Po,qd,Md,Cd,We,Fd,jo,Pd,jd,Bt,us,we,Oe,Ao,Wt,Ad,Io,Id,ms,I,Ot,Sd,So,Nd,Dd,Ut,Bd,xn,Wd,Od,Ud,Kt,Kd,Rt,Rd,Hd,Vd,W,Ht,Yd,Le,Qd,$n,Jd,Xd,No,Gd,Zd,el,Ue,tl,Do,nl,ol,Vt,fs;return g=new ze({}),He=new ze({}),nt=new Nn({props:{code:`from transformers import LukeTokenizer, LukeModel, LukeForEntityPairClassification
...
<p><a
  href="/docs/transformers/main/en/main_classes/tokenizer#transformers.BatchEncoding"
>BatchEncoding</a></p>
`}}),ut=new O({props:{name:"save_vocabulary",anchor:"transformers.LukeTokenizer.save_vocabulary",parameters:[{name:"save_directory",val:": str"},{name:"filename_prefix",val:": typing.Optional[str] = None"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/luke/tokenization_luke.py#L1379"}}),mt=new ze({}),ft=new O({props:{name:"class transformers.LukeModel",anchor:"transformers.LukeModel",parameters:[{name:"config",val:""},{name:"add_pooling_layer",val:" = True"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/luke/modeling_luke.py#L879",parametersDescription:[{anchor:"transformers.LukeModel.config",description:`<strong>config</strong> (<a href="/docs/transformers/main/en/model_doc/luke#transformers.LukeConfig">LukeConfig</a>) &#x2014; Model configuration class with all the parameters of the
model. Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/main/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),yt=new O({props:{name:"forward",anchor:"transformers.LukeModel.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"entity_ids",val:" = None"},{name:"entity_attention_mask",val:" = None"},{name:"entity_token_type_ids",val:" = None"},{name:"entity_position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/luke/modeling_luke.py#L911",parametersDescription:[{anchor:"transformers.LukeModel.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
...
`}}),Ae=new Ro({props:{$$slots:{default:[rp]},$$scope:{ctx:U}}}),bt=new Nn({props:{code:`from transformers import LukeTokenizer, LukeModel
...
<span class="hljs-meta">&gt;&gt;&gt; </span>outputs = model(**encoding)
<span class="hljs-meta">&gt;&gt;&gt; </span>word_last_hidden_state = outputs.last_hidden_state
<span class="hljs-meta">&gt;&gt;&gt; </span>entity_last_hidden_state = outputs.entity_last_hidden_state`}}),vt=new ze({}),Tt=new O({props:{name:"class transformers.LukeForMaskedLM",anchor:"transformers.LukeForMaskedLM",parameters:[{name:"config",val:""}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/luke/modeling_luke.py#L1132",parametersDescription:[{anchor:"transformers.LukeForMaskedLM.config",description:`<strong>config</strong> (<a href="/docs/transformers/main/en/model_doc/luke#transformers.LukeConfig">LukeConfig</a>) &#x2014; Model configuration class with all the parameters of the
model. Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/main/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),zt=new O({props:{name:"forward",anchor:"transformers.LukeForMaskedLM.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"entity_ids",val:" = None"},{name:"entity_attention_mask",val:" = None"},{name:"entity_token_type_ids",val:" = None"},{name:"entity_position_ids",val:" = None"},{name:"labels",val:" = None"},{name:"entity_labels",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/luke/modeling_luke.py#L1168",parametersDescription:[{anchor:"transformers.LukeForMaskedLM.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/main/en/model_doc/luke#transformers.LukeTokenizer">LukeTokenizer</a>. See <a href="/docs/transformers/main/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/main/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
Predicted <span class="hljs-keyword">class</span>: person`}}),jt=new ze({}),At=new O({props:{name:"class transformers.LukeForEntityPairClassification",anchor:"transformers.LukeForEntityPairClassification",parameters:[{name:"config",val:""}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/luke/modeling_luke.py#L1383",parametersDescription:[{anchor:"transformers.LukeForEntityPairClassification.config",description:`<strong>config</strong> (<a href="/docs/transformers/main/en/model_doc/luke#transformers.LukeConfig">LukeConfig</a>) &#x2014; Model configuration class with all the parameters of the
model. Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/main/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),Dt=new O({props:{name:"forward",anchor:"transformers.LukeForEntityPairClassification.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"entity_ids",val:" = None"},{name:"entity_attention_mask",val:" = None"},{name:"entity_token_type_ids",val:" = None"},{name:"entity_position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"labels",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/luke/modeling_luke.py#L1396",parametersDescription:[{anchor:"transformers.LukeForEntityPairClassification.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/main/en/model_doc/luke#transformers.LukeTokenizer">LukeTokenizer</a>. See <a href="/docs/transformers/main/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/main/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
<span class="hljs-meta">&gt;&gt;&gt; </span>predicted_class_idx = logits.argmax(-<span class="hljs-number">1</span>).item()
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-built_in">print</span>(<span class="hljs-string">&quot;Predicted class:&quot;</span>, model.config.id2label[predicted_class_idx])
Predicted <span class="hljs-keyword">class</span>: per:cities_of_residence`}}),Wt=new ze({}),Ot=new O({props:{name:"class transformers.LukeForEntitySpanClassification",anchor:"transformers.LukeForEntitySpanClassification",parameters:[{name:"config",val:""}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/luke/modeling_luke.py#L1503",parametersDescription:[{anchor:"transformers.LukeForEntitySpanClassification.config",description:`<strong>config</strong> (<a href="/docs/transformers/main/en/model_doc/luke#transformers.LukeConfig">LukeConfig</a>) &#x2014; Model configuration class with all the parameters of the
model. Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/main/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),Ht=new O({props:{name:"forward",anchor:"transformers.LukeForEntitySpanClassification.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"entity_ids",val:" = None"},{name:"entity_attention_mask",val:" = None"},{name:"entity_token_type_ids",val:" = None"},{name:"entity_position_ids",val:" = None"},{name:"entity_start_positions",val:" = None"},{name:"entity_end_positions",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"labels",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/luke/modeling_luke.py#L1516",parametersDescription:[{anchor:"transformers.LukeForEntitySpanClassification.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/main/en/model_doc/luke#transformers.LukeTokenizer">LukeTokenizer</a>. See <a href="/docs/transformers/main/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/main/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
and behavior.`),hr=l(),N=a("div"),_(yt.$$.fragment),ur=l(),ge=a("p"),mr=o("The "),bn=a("a"),fr=o("LukeModel"),gr=o(" forward method, overrides the "),yo=a("code"),_r=o("__call__"),kr=o(" special method."),yr=l(),_(Ae.$$.fragment),br=l(),bo=a("p"),vr=o("Examples:"),Tr=l(),_(bt.$$.fragment),rs=l(),_e=a("h2"),Ie=a("a"),vo=a("span"),_(vt.$$.fragment),wr=l(),To=a("span"),Lr=o("LukeForMaskedLM"),ds=l(),P=a("div"),_(Tt.$$.fragment),Er=l(),wo=a("p"),zr=o(`The LUKE model with a language modeling head and entity prediction head on top for masked language modeling and
masked entity prediction.`),xr=l(),wt=a("p"),$r=o("This model inherits from "),vn=a("a"),qr=o("PreTrainedModel"),Mr=o(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),td=l(),D=a("div"),_(Ft.$$.fragment),nd=l(),be=a("p"),od=o("The "),Ln=a("a"),sd=o("LukeForEntityClassification"),ad=o(" forward method, overrides the "),$o=a("code"),id=o("__call__"),rd=o(" special method."),dd=l(),_(De.$$.fragment),ld=l(),qo=a("p"),cd=o("Examples:"),pd=l(),_(Pt.$$.fragment),ps=l(),ve=a("h2"),Be=a("a"),Mo=a("span"),_(jt.$$.fragment),hd=l(),Co=a("span"),ud=o("LukeForEntityPairClassification"),hs=l(),A=a("div"),_(At.$$.fragment),md=l(),Fo=a("p"),fd=o(`The LUKE model with a classification head on top (a linear layer on top of the hidden states of the two entity
...
`),Hn=i(Y,"CODE",{});var bl=r(Hn);sa=s(bl,"entity_token_type_ids"),bl.forEach(t),aa=s(Y," and "),Vn=i(Y,"CODE",{});var vl=r(Vn);ia=s(vl,"entity_position_ids"),vl.forEach(t),ra=s(Y,` as extra input. You can obtain those using
...
Wikipedia entities. The brief description when inputting these entities are as follows:`),Ee.forEach(t),ya=c(ks),Je=i(ks,"UL",{});var ys=r(Je);nn=i(ys,"LI",{});var sl=r(nn);Xn=i(sl,"EM",{});var xl=r(Xn);ba=s(xl,"Inputting [MASK] entities to compute entity representations"),xl.forEach(t),va=s(sl,`: The [MASK] entity is used to mask entities to be
predicted during pretraining. When LUKE receives the [MASK] entity, it tries to predict the original entity by
gathering the information about the entity from the input text. Therefore, the [MASK] entity can be used to address
downstream tasks requiring the information of entities in text such as entity typing, relation classification, and
...
classification can be found `),Ze=i(Mn,"A",{href:!0,rel:!0});var Wl=r(Ze);ti=s(Wl,"here"),Wl.forEach(t),ni=s(Mn,"."),Mn.forEach(t),oi=c(X),et=i(X,"P",{});var bs=r(et);si=s(bs,`There are also 3 notebooks available, which showcase how you can reproduce the results as reported in the paper with
the HuggingFace implementation of LUKE. They can be found `),tt=i(bs,"A",{href:!0,rel:!0});var Ol=r(tt);ai=s(Ol,"here"),Ol.forEach(t),ii=s(bs,"."),bs.forEach(t),X.forEach(t),Ke.forEach(t),Go=c(n),pn=i(n,"P",{});var Ul=r(pn);ri=s(Ul,"Example:"),Ul.forEach(t),Zo=c(n),k(nt.$$.fragment,n),es=c(n),V=i(n,"P",{});var Re=r(V);di=s(Re,"This model was contributed by "),ot=i(Re,"A",{href:!0,rel:!0});var Kl=r(ot);li=s(Kl,"ikuyamada"),Kl.forEach(t),ci=s(Re," and "),st=i(Re,"A",{href:!0,rel:!0});var Rl=r(st);pi=s(Rl,"nielsr"),Rl.forEach(t),hi=s(Re,". The original code can be found "),at=i(Re,"A",{href:!0,rel:!0});var Hl=r(at);ui=s(Hl,"here"),Hl.forEach(t),mi=s(Re,"."),Re.forEach(t),ts=c(n),he=i(n,"H2",{class:!0});var vs=r(he);Ce=i(vs,"A",{id:!0,class:!0,href:!0});var Vl=r(Ce);so=i(Vl,"SPAN",{});var Yl=r(so);k(it.$$.fragment,Yl),Yl.forEach(t),Vl.forEach(t),fi=c(vs),ao=i(vs,"SPAN",{});var Ql=r(ao);gi=s(Ql,"LukeConfig"),Ql.forEach(t),vs.forEach(t),ns=c(n),M=i(n,"DIV",{class:!0});var G=r(M);k(rt.$$.fragment,G),_i=c(G),dt=i(G,"P",{});var Ts=r(dt);ki=s(Ts,"This is the configuration class to store the configuration of a "),hn=i(Ts,"A",{href:!0});var Jl=r(hn);yi=s(Jl,"LukeModel"),Jl.forEach(t),bi=s(Ts,`. It is used to instantiate a LUKE
model according to the specified arguments, defining the model architecture.`),Ts.forEach(t),vi=c(G),ue=i(G,"P",{});var Cn=r(ue);Ti=s(Cn,"Configuration objects inherit from "),un=i(Cn,"A",{href:!0});var Xl=r(un);wi=s(Xl,"PretrainedConfig"),Xl.forEach(t),Li=s(Cn,` and can be used to control the model outputs. Read the
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),xs.forEach(t),hr=c(ee),N=i(ee,"DIV",{class:!0});var te=r(N);k(yt.$$.fragment,te),ur=c(te),ge=i(te,"P",{});var Fn=r(ge);mr=s(Fn,"The "),bn=i(Fn,"A",{href:!0});var yc=r(bn);fr=s(yc,"LukeModel"),yc.forEach(t),gr=s(Fn," forward method, overrides the "),yo=i(Fn,"CODE",{});var bc=r(yo);_r=s(bc,"__call__"),bc.forEach(t),kr=s(Fn," special method."),Fn.forEach(t),yr=c(te),k(Ae.$$.fragment,te),br=c(te),bo=i(te,"P",{});var vc=r(bo);vr=s(vc,"Examples:"),vc.forEach(t),Tr=c(te),k(bt.$$.fragment,te),te.forEach(t),ee.forEach(t),rs=c(n),_e=i(n,"H2",{class:!0});var $s=r(_e);Ie=i($s,"A",{id:!0,class:!0,href:!0});var Tc=r(Ie);vo=i(Tc,"SPAN",{});var wc=r(vo);k(vt.$$.fragment,wc),wc.forEach(t),Tc.forEach(t),wr=c($s),To=i($s,"SPAN",{});var Lc=r(To);Lr=s(Lc,"LukeForMaskedLM"),Lc.forEach(t),$s.forEach(t),ds=c(n),P=i(n,"DIV",{class:!0});var ne=r(P);k(Tt.$$.fragment,ne),Er=c(ne),wo=i(ne,"P",{});var Ec=r(wo);zr=s(Ec,`The LUKE model with a language modeling head and entity prediction head on top for masked language modeling and
masked entity prediction.`),Ec.forEach(t),xr=c(ne),wt=i(ne,"P",{});var qs=r(wt);$r=s(qs,"This model inherits from "),vn=i(qs,"A",{href:!0});var zc=r(vn);qr=s(zc,"PreTrainedModel"),zc.forEach(t),Mr=s(qs,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),As.forEach(t),bd=c(ae),St=i(ae,"P",{});var Is=r(St);vd=s(Is,"This model is also a PyTorch "),Nt=i(Is,"A",{href:!0,rel:!0});var Kc=r(Nt);Td=s(Kc,"torch.nn.Module"),Kc.forEach(t),wd=s(Is,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
