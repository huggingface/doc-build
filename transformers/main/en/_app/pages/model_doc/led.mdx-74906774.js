import{S as zf,i as Ff,s as $f,e as n,k as d,w as f,t as r,M as xf,c as s,d as t,m as l,a,x as _,h as i,b as c,F as e,g as h,y as g,q as v,o as T,B as k,v as Mf}from"../../chunks/vendor-6b77c823.js";import{T as go}from"../../chunks/Tip-39098574.js";import{D as $}from"../../chunks/Docstring-abef54e3.js";import{C as At}from"../../chunks/CodeBlock-3a8b25a8.js";import{I as me}from"../../chunks/IconCopyLink-7a11ce68.js";function Sf(I){let u,L,b,E,q;return{c(){u=n("p"),L=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),b=n("code"),E=r("Module"),q=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(y){u=s(y,"P",{});var w=a(u);L=i(w,"Although the recipe for forward pass needs to be defined within this function, one should call the "),b=s(w,"CODE",{});var D=a(b);E=i(D,"Module"),D.forEach(t),q=i(w,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),w.forEach(t)},m(y,w){h(y,u,w),e(u,L),e(u,b),e(b,E),e(u,q)},d(y){y&&t(u)}}}function Cf(I){let u,L,b,E,q;return{c(){u=n("p"),L=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),b=n("code"),E=r("Module"),q=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(y){u=s(y,"P",{});var w=a(u);L=i(w,"Although the recipe for forward pass needs to be defined within this function, one should call the "),b=s(w,"CODE",{});var D=a(b);E=i(D,"Module"),D.forEach(t),q=i(w,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),w.forEach(t)},m(y,w){h(y,u,w),e(u,L),e(u,b),e(b,E),e(u,q)},d(y){y&&t(u)}}}function Of(I){let u,L,b,E,q;return{c(){u=n("p"),L=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),b=n("code"),E=r("Module"),q=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(y){u=s(y,"P",{});var w=a(u);L=i(w,"Although the recipe for forward pass needs to be defined within this function, one should call the "),b=s(w,"CODE",{});var D=a(b);E=i(D,"Module"),D.forEach(t),q=i(w,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),w.forEach(t)},m(y,w){h(y,u,w),e(u,L),e(u,b),e(b,E),e(u,q)},d(y){y&&t(u)}}}function Pf(I){let u,L,b,E,q;return{c(){u=n("p"),L=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),b=n("code"),E=r("Module"),q=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(y){u=s(y,"P",{});var w=a(u);L=i(w,"Although the recipe for forward pass needs to be defined within this function, one should call the "),b=s(w,"CODE",{});var D=a(b);E=i(D,"Module"),D.forEach(t),q=i(w,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),w.forEach(t)},m(y,w){h(y,u,w),e(u,L),e(u,b),e(b,E),e(u,q)},d(y){y&&t(u)}}}function Af(I){let u,L,b,E,q,y,w,D,Ae,fe,z,Z,U,te,Ne,R,je,Me,B,V,oe,Le,S,P,_e,ne,Se,ge,K,Ie,Ce,C,Be,Y,x,M,G,Ge,Qe,N,He,se,De;return{c(){u=n("p"),L=r("TF 2.0 models accepts two formats as inputs:"),b=d(),E=n("ul"),q=n("li"),y=r("having all inputs as keyword arguments (like PyTorch models), or"),w=d(),D=n("li"),Ae=r("having all inputs as a list, tuple or dict in the first positional arguments."),fe=d(),z=n("p"),Z=r("This second option is useful when using "),U=n("code"),te=r("tf.keras.Model.fit"),Ne=r(` method which currently requires having all the
tensors in the first argument of the model call function: `),R=n("code"),je=r("model(inputs)"),Me=r("."),B=d(),V=n("p"),oe=r(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),Le=d(),S=n("ul"),P=n("li"),_e=r("a single Tensor with "),ne=n("code"),Se=r("input_ids"),ge=r(" only and nothing else: "),K=n("code"),Ie=r("model(input_ids)"),Ce=d(),C=n("li"),Be=r(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),Y=n("code"),x=r("model([input_ids, attention_mask])"),M=r(" or "),G=n("code"),Ge=r("model([input_ids, attention_mask, token_type_ids])"),Qe=d(),N=n("li"),He=r(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),se=n("code"),De=r('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(m){u=s(m,"P",{});var F=a(u);L=i(F,"TF 2.0 models accepts two formats as inputs:"),F.forEach(t),b=l(m),E=s(m,"UL",{});var ae=a(E);q=s(ae,"LI",{});var nt=a(q);y=i(nt,"having all inputs as keyword arguments (like PyTorch models), or"),nt.forEach(t),w=l(ae),D=s(ae,"LI",{});var st=a(D);Ae=i(st,"having all inputs as a list, tuple or dict in the first positional arguments."),st.forEach(t),ae.forEach(t),fe=l(m),z=s(m,"P",{});var j=a(z);Z=i(j,"This second option is useful when using "),U=s(j,"CODE",{});var at=a(U);te=i(at,"tf.keras.Model.fit"),at.forEach(t),Ne=i(j,` method which currently requires having all the
tensors in the first argument of the model call function: `),R=s(j,"CODE",{});var rt=a(R);je=i(rt,"model(inputs)"),rt.forEach(t),Me=i(j,"."),j.forEach(t),B=l(m),V=s(m,"P",{});var Oe=a(V);oe=i(Oe,`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),Oe.forEach(t),Le=l(m),S=s(m,"UL",{});var X=a(S);P=s(X,"LI",{});var re=a(P);_e=i(re,"a single Tensor with "),ne=s(re,"CODE",{});var Pe=a(ne);Se=i(Pe,"input_ids"),Pe.forEach(t),ge=i(re," only and nothing else: "),K=s(re,"CODE",{});var it=a(K);Ie=i(it,"model(input_ids)"),it.forEach(t),re.forEach(t),Ce=l(X),C=s(X,"LI",{});var ie=a(C);Be=i(ie,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),Y=s(ie,"CODE",{});var dt=a(Y);x=i(dt,"model([input_ids, attention_mask])"),dt.forEach(t),M=i(ie," or "),G=s(ie,"CODE",{});var de=a(G);Ge=i(de,"model([input_ids, attention_mask, token_type_ids])"),de.forEach(t),ie.forEach(t),Qe=l(X),N=s(X,"LI",{});var We=a(N);He=i(We,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),se=s(We,"CODE",{});var Ue=a(se);De=i(Ue,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),Ue.forEach(t),We.forEach(t),X.forEach(t)},m(m,F){h(m,u,F),e(u,L),h(m,b,F),h(m,E,F),e(E,q),e(q,y),e(E,w),e(E,D),e(D,Ae),h(m,fe,F),h(m,z,F),e(z,Z),e(z,U),e(U,te),e(z,Ne),e(z,R),e(R,je),e(z,Me),h(m,B,F),h(m,V,F),e(V,oe),h(m,Le,F),h(m,S,F),e(S,P),e(P,_e),e(P,ne),e(ne,Se),e(P,ge),e(P,K),e(K,Ie),e(S,Ce),e(S,C),e(C,Be),e(C,Y),e(Y,x),e(C,M),e(C,G),e(G,Ge),e(S,Qe),e(S,N),e(N,He),e(N,se),e(se,De)},d(m){m&&t(u),m&&t(b),m&&t(E),m&&t(fe),m&&t(z),m&&t(B),m&&t(V),m&&t(Le),m&&t(S)}}}function Nf(I){let u,L,b,E,q;return{c(){u=n("p"),L=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),b=n("code"),E=r("Module"),q=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(y){u=s(y,"P",{});var w=a(u);L=i(w,"Although the recipe for forward pass needs to be defined within this function, one should call the "),b=s(w,"CODE",{});var D=a(b);E=i(D,"Module"),D.forEach(t),q=i(w,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),w.forEach(t)},m(y,w){h(y,u,w),e(u,L),e(u,b),e(b,E),e(u,q)},d(y){y&&t(u)}}}function jf(I){let u,L,b,E,q,y,w,D,Ae,fe,z,Z,U,te,Ne,R,je,Me,B,V,oe,Le,S,P,_e,ne,Se,ge,K,Ie,Ce,C,Be,Y,x,M,G,Ge,Qe,N,He,se,De;return{c(){u=n("p"),L=r("TF 2.0 models accepts two formats as inputs:"),b=d(),E=n("ul"),q=n("li"),y=r("having all inputs as keyword arguments (like PyTorch models), or"),w=d(),D=n("li"),Ae=r("having all inputs as a list, tuple or dict in the first positional arguments."),fe=d(),z=n("p"),Z=r("This second option is useful when using "),U=n("code"),te=r("tf.keras.Model.fit"),Ne=r(` method which currently requires having all the
tensors in the first argument of the model call function: `),R=n("code"),je=r("model(inputs)"),Me=r("."),B=d(),V=n("p"),oe=r(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),Le=d(),S=n("ul"),P=n("li"),_e=r("a single Tensor with "),ne=n("code"),Se=r("input_ids"),ge=r(" only and nothing else: "),K=n("code"),Ie=r("model(input_ids)"),Ce=d(),C=n("li"),Be=r(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),Y=n("code"),x=r("model([input_ids, attention_mask])"),M=r(" or "),G=n("code"),Ge=r("model([input_ids, attention_mask, token_type_ids])"),Qe=d(),N=n("li"),He=r(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),se=n("code"),De=r('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(m){u=s(m,"P",{});var F=a(u);L=i(F,"TF 2.0 models accepts two formats as inputs:"),F.forEach(t),b=l(m),E=s(m,"UL",{});var ae=a(E);q=s(ae,"LI",{});var nt=a(q);y=i(nt,"having all inputs as keyword arguments (like PyTorch models), or"),nt.forEach(t),w=l(ae),D=s(ae,"LI",{});var st=a(D);Ae=i(st,"having all inputs as a list, tuple or dict in the first positional arguments."),st.forEach(t),ae.forEach(t),fe=l(m),z=s(m,"P",{});var j=a(z);Z=i(j,"This second option is useful when using "),U=s(j,"CODE",{});var at=a(U);te=i(at,"tf.keras.Model.fit"),at.forEach(t),Ne=i(j,` method which currently requires having all the
...
first positional argument :`),Oe.forEach(t),Le=l(m),S=s(m,"UL",{});var X=a(S);P=s(X,"LI",{});var re=a(P);_e=i(re,"a single Tensor with "),ne=s(re,"CODE",{});var Pe=a(ne);Se=i(Pe,"input_ids"),Pe.forEach(t),ge=i(re," only and nothing else: "),K=s(re,"CODE",{});var it=a(K);Ie=i(it,"model(input_ids)"),it.forEach(t),re.forEach(t),Ce=l(X),C=s(X,"LI",{});var ie=a(C);Be=i(ie,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),Y=s(ie,"CODE",{});var dt=a(Y);x=i(dt,"model([input_ids, attention_mask])"),dt.forEach(t),M=i(ie," or "),G=s(ie,"CODE",{});var de=a(G);Ge=i(de,"model([input_ids, attention_mask, token_type_ids])"),de.forEach(t),ie.forEach(t),Qe=l(X),N=s(X,"LI",{});var We=a(N);He=i(We,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),se=s(We,"CODE",{});var Ue=a(se);De=i(Ue,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),Ue.forEach(t),We.forEach(t),X.forEach(t)},m(m,F){h(m,u,F),e(u,L),h(m,b,F),h(m,E,F),e(E,q),e(q,y),e(E,w),e(E,D),e(D,Ae),h(m,fe,F),h(m,z,F),e(z,Z),e(z,U),e(U,te),e(z,Ne),e(z,R),e(R,je),e(z,Me),h(m,B,F),h(m,V,F),e(V,oe),h(m,Le,F),h(m,S,F),e(S,P),e(P,_e),e(P,ne),e(ne,Se),e(P,ge),e(P,K),e(K,Ie),e(S,Ce),e(S,C),e(C,Be),e(C,Y),e(Y,x),e(C,M),e(C,G),e(G,Ge),e(S,Qe),e(S,N),e(N,He),e(N,se),e(se,De)},d(m){m&&t(u),m&&t(b),m&&t(E),m&&t(fe),m&&t(z),m&&t(B),m&&t(V),m&&t(Le),m&&t(S)}}}function If(I){let u,L,b,E,q;return{c(){u=n("p"),L=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),b=n("code"),E=r("Module"),q=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(y){u=s(y,"P",{});var w=a(u);L=i(w,"Although the recipe for forward pass needs to be defined within this function, one should call the "),b=s(w,"CODE",{});var D=a(b);E=i(D,"Module"),D.forEach(t),q=i(w,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),w.forEach(t)},m(y,w){h(y,u,w),e(u,L),e(u,b),e(b,E),e(u,q)},d(y){y&&t(u)}}}function Bf(I){let u,L,b,E,q,y,w,D,Ae,fe,z,Z,U,te,Ne,R,je,Me,B,V,oe,Le,S,P,_e,ne,Se,ge,K,Ie,Ce,C,Be,Y,x,M,G,Ge,Qe,N,He,se,De,m,F,ae,nt,st,j,at,rt,Oe,X,re,Pe,it,ie,dt,de,We,Ue,Si,Ci,$s,Oi,Pi,Ai,ze,Ni,xs,ji,Ii,Ms,Bi,Gi,Un,Qi,Hi,Ss,Wi,Ui,Ri,J,Vi,Cs,Ki,Xi,Os,Ji,Zi,Rn,Yi,ed,Ps,td,od,As,nd,sd,Ns,ad,rd,id,lt,dd,js,ld,cd,Is,hd,pd,ud,vo,md,To,fd,_d,gd,ko,vd,bo,Td,kd,ur,Nt,bd,wo,wd,yd,mr,ct,jt,Bs,yo,Ed,Gs,qd,fr,O,Eo,Ld,ht,Dd,Vn,zd,Fd,qo,$d,xd,Md,pt,Sd,Kn,Cd,Od,Xn,Pd,Ad,Nd,Qs,jd,Id,Lo,Bd,Hs,Ws,Us,Rs,Gd,Qd,Vs,Ks,Xs,It,Bt,Js,Do,Hd,Zs,Wd,Ud,Ys,ea,zo,Gt,Qt,ta,Fo,Rd,oa,Vd,Kd,na,Xd,Jd,sa,aa,ra,Ht,Wt,ia,$o,Zd,da,Yd,_r,ut,Ut,la,xo,el,ca,tl,gr,A,Mo,ol,ha,nl,sl,Rt,Jn,al,rl,Zn,il,dl,ll,So,cl,Yn,hl,pl,ul,Re,Co,ml,pa,fl,_l,Oo,es,gl,ua,vl,Tl,ts,kl,ma,bl,wl,Vt,Po,yl,Ao,El,fa,ql,Ll,Dl,Kt,No,zl,_a,Fl,$l,os,jo,vr,mt,Xt,ga,Io,xl,va,Ml,Tr,Fe,Bo,Sl,Go,Cl,Ta,Ol,Pl,Al,Jt,ns,Nl,jl,ss,Il,Bl,Gl,Qo,Ql,as,Hl,Wl,kr,ft,Zt,ka,Ho,Ul,ba,Rl,br,_t,Wo,Vl,wa,Kl,wr,gt,Uo,Xl,ya,Jl,yr,vt,Ro,Zl,Ea,Yl,Er,Tt,Vo,ec,qa,tc,qr,kt,Ko,oc,La,nc,Lr,bt,Xo,sc,Da,ac,Dr,wt,Jo,rc,za,ic,zr,yt,Zo,dc,Fa,lc,Fr,Et,Yt,$a,Yo,cc,xa,hc,$r,$e,en,pc,tn,uc,rs,mc,fc,_c,on,gc,nn,vc,Tc,kc,ve,sn,bc,qt,wc,is,yc,Ec,Ma,qc,Lc,Dc,eo,zc,Sa,Fc,$c,an,xr,Lt,to,Ca,rn,xc,Oa,Mc,Mr,xe,dn,Sc,ln,Cc,ds,Oc,Pc,Ac,cn,Nc,hn,jc,Ic,Bc,Q,pn,Gc,Dt,Qc,ls,Hc,Wc,Pa,Uc,Rc,Vc,oo,Kc,Aa,Xc,Jc,un,Zc,Na,Yc,eh,mn,Sr,zt,no,ja,fn,th,Ia,oh,Cr,le,_n,nh,Ba,sh,ah,gn,rh,cs,ih,dh,lh,vn,ch,Tn,hh,ph,uh,H,kn,mh,Ft,fh,hs,_h,gh,Ga,vh,Th,kh,so,bh,Qa,wh,yh,bn,Eh,Ha,qh,Lh,wn,Or,$t,ao,Wa,yn,Dh,Ua,zh,Pr,ce,En,Fh,xt,$h,Ra,xh,Mh,Va,Sh,Ch,Oh,qn,Ph,ps,Ah,Nh,jh,Ln,Ih,Dn,Bh,Gh,Qh,Te,zn,Hh,Mt,Wh,us,Uh,Rh,Ka,Vh,Kh,Xh,ro,Jh,Xa,Zh,Yh,Fn,Ar,St,io,Ja,$n,ep,Za,tp,Nr,he,xn,op,Mn,np,ms,sp,ap,rp,Sn,ip,Cn,dp,lp,cp,lo,hp,ke,On,pp,Ct,up,fs,mp,fp,Ya,_p,gp,vp,co,Tp,er,kp,bp,Pn,jr,Ot,ho,tr,An,wp,or,yp,Ir,pe,Nn,Ep,jn,qp,_s,Lp,Dp,zp,In,Fp,Bn,$p,xp,Mp,po,Sp,be,Gn,Cp,Pt,Op,gs,Pp,Ap,nr,Np,jp,Ip,uo,Bp,sr,Gp,Qp,Qn,Br;return y=new me({}),te=new me({}),yo=new me({}),Eo=new $({props:{name:"class transformers.LEDConfig",anchor:"transformers.LEDConfig",parameters:[{name:"vocab_size",val:" = 50265"},{name:"max_encoder_position_embeddings",val:" = 16384"},{name:"max_decoder_position_embeddings",val:" = 1024"},{name:"encoder_layers",val:" = 12"},{name:"encoder_ffn_dim",val:" = 4096"},{name:"encoder_attention_heads",val:" = 16"},{name:"decoder_layers",val:" = 12"},{name:"decoder_ffn_dim",val:" = 4096"},{name:"decoder_attention_heads",val:" = 16"},{name:"encoder_layerdrop",val:" = 0.0"},{name:"decoder_layerdrop",val:" = 0.0"},{name:"use_cache",val:" = True"},{name:"is_encoder_decoder",val:" = True"},{name:"activation_function",val:" = 'gelu'"},{name:"d_model",val:" = 1024"},{name:"dropout",val:" = 0.1"},{name:"attention_dropout",val:" = 0.0"},{name:"activation_dropout",val:" = 0.0"},{name:"init_std",val:" = 0.02"},{name:"decoder_start_token_id",val:" = 2"},{name:"classifier_dropout",val:" = 0.0"},{name:"pad_token_id",val:" = 1"},{name:"bos_token_id",val:" = 0"},{name:"eos_token_id",val:" = 2"},{name:"attention_window",val:": typing.Union[typing.List[int], int] = 512"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/led/configuration_led.py#L31",parametersDescription:[{anchor:"transformers.LEDConfig.vocab_size",description:`<strong>vocab_size</strong> (<code>int</code>, <em>optional</em>, defaults to 50265) &#x2014;
...
Whether or not the model should return the last key/values attentions (not used by all models)`,name:"use_cache"}]}}),Lo=new At({props:{code:"",highlighted:""}}),Do=new me({}),Fo=new me({}),$o=new me({}),xo=new me({}),Mo=new $({props:{name:"class transformers.LEDTokenizer",anchor:"transformers.LEDTokenizer",parameters:[{name:"vocab_file",val:""},{name:"merges_file",val:""},{name:"errors",val:" = 'replace'"},{name:"bos_token",val:" = '<s>'"},{name:"eos_token",val:" = '</s>'"},{name:"sep_token",val:" = '</s>'"},{name:"cls_token",val:" = '<s>'"},{name:"unk_token",val:" = '<unk>'"},{name:"pad_token",val:" = '<pad>'"},{name:"mask_token",val:" = '<mask>'"},{name:"add_prefix_space",val:" = False"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/led/tokenization_led.py#L44"}}),Co=new $({props:{name:"build_inputs_with_special_tokens",anchor:"transformers.BartTokenizer.build_inputs_with_special_tokens",parameters:[{name:"token_ids_0",val:": typing.List[int]"},{name:"token_ids_1",val:": typing.Optional[typing.List[int]] = None"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/bart/tokenization_bart.py#L338",parametersDescription:[{anchor:"transformers.BartTokenizer.build_inputs_with_special_tokens.token_ids_0",description:`<strong>token_ids_0</strong> (<code>List[int]</code>) &#x2014;
...
<a href="/docs/transformers/main/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),sn=new $({props:{name:"forward",anchor:"transformers.LEDModel.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"decoder_input_ids",val:" = None"},{name:"decoder_attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"decoder_head_mask",val:" = None"},{name:"cross_attn_head_mask",val:" = None"},{name:"encoder_outputs",val:" = None"},{name:"global_attention_mask",val:" = None"},{name:"past_key_values",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"decoder_inputs_embeds",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/led/modeling_led.py#L2181",parametersDescription:[{anchor:"transformers.LEDModel.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
...
`}}),eo=new go({props:{$$slots:{default:[Sf]},$$scope:{ctx:I}}}),an=new At({props:{code:`from transformers import LEDTokenizer, LEDModel
import torch
...
Model configuration class with all the parameters of the model. Initializing with a config file does not
load the weights associated with the model, only the configuration. Check out the
<a href="/docs/transformers/main/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),pn=new $({props:{name:"forward",anchor:"transformers.LEDForConditionalGeneration.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"decoder_input_ids",val:" = None"},{name:"decoder_attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"decoder_head_mask",val:" = None"},{name:"cross_attn_head_mask",val:" = None"},{name:"encoder_outputs",val:" = None"},{name:"global_attention_mask",val:" = None"},{name:"past_key_values",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"decoder_inputs_embeds",val:" = None"},{name:"labels",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/led/modeling_led.py#L2321",parametersDescription:[{anchor:"transformers.LEDForConditionalGeneration.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. Padding will be ignored by default should you provide
it.</p>
<p>Indices can be obtained using <a href="/docs/transformers/main/en/model_doc/led#transformers.LEDTokenizer">LEDTokenizer</a>. See <a href="/docs/transformers/main/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/main/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
`}}),oo=new go({props:{$$slots:{default:[Cf]},$$scope:{ctx:I}}}),un=new At({props:{code:`from transformers import LEDTokenizer, LEDForConditionalGeneration
...
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-built_in">print</span>(tokenizer.decode(prediction, skip_special_tokens=<span class="hljs-literal">True</span>))`}}),mn=new At({props:{code:`import torch
...
Model configuration class with all the parameters of the model. Initializing with a config file does not
load the weights associated with the model, only the configuration. Check out the
<a href="/docs/transformers/main/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),kn=new $({props:{name:"forward",anchor:"transformers.LEDForSequenceClassification.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"decoder_input_ids",val:" = None"},{name:"decoder_attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"decoder_head_mask",val:" = None"},{name:"cross_attn_head_mask",val:" = None"},{name:"encoder_outputs",val:" = None"},{name:"global_attention_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"decoder_inputs_embeds",val:" = None"},{name:"labels",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/led/modeling_led.py#L2481",parametersDescription:[{anchor:"transformers.LEDForSequenceClassification.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. Padding will be ignored by default should you provide
it.</p>
<p>Indices can be obtained using <a href="/docs/transformers/main/en/model_doc/led#transformers.LEDTokenizer">LEDTokenizer</a>. See <a href="/docs/transformers/main/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/main/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
`}}),so=new go({props:{$$slots:{default:[Of]},$$scope:{ctx:I}}}),bn=new At({props:{code:`import torch
...
<span class="hljs-meta">&gt;&gt;&gt; </span>loss = outputs.loss
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-built_in">list</span>(logits.shape)
`}}),yn=new me({}),En=new $({props:{name:"class transformers.LEDForQuestionAnswering",anchor:"transformers.LEDForQuestionAnswering",parameters:[{name:"config",val:""}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/led/modeling_led.py#L2596",parametersDescription:[{anchor:"transformers.LEDForQuestionAnswering.config",description:`<strong>config</strong> (<a href="/docs/transformers/main/en/model_doc/led#transformers.LEDConfig">LEDConfig</a>) &#x2014;
Model configuration class with all the parameters of the model. Initializing with a config file does not
load the weights associated with the model, only the configuration. Check out the
<a href="/docs/transformers/main/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),zn=new $({props:{name:"forward",anchor:"transformers.LEDForQuestionAnswering.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"decoder_input_ids",val:" = None"},{name:"decoder_attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"decoder_head_mask",val:" = None"},{name:"cross_attn_head_mask",val:" = None"},{name:"encoder_outputs",val:" = None"},{name:"global_attention_mask",val:" = None"},{name:"start_positions",val:" = None"},{name:"end_positions",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"decoder_inputs_embeds",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/led/modeling_led.py#L2608",parametersDescription:[{anchor:"transformers.LEDForQuestionAnswering.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. Padding will be ignored by default should you provide
it.</p>
<p>Indices can be obtained using <a href="/docs/transformers/main/en/model_doc/led#transformers.LEDTokenizer">LEDTokenizer</a>. See <a href="/docs/transformers/main/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/main/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
`}}),ro=new go({props:{$$slots:{default:[Pf]},$$scope:{ctx:I}}}),Fn=new At({props:{code:`from transformers import LEDTokenizer, LEDForQuestionAnswering
import torch
...
`}}),$n=new me({}),xn=new $({props:{name:"class transformers.TFLEDModel",anchor:"transformers.TFLEDModel",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/led/modeling_tf_led.py#L2256",parametersDescription:[{anchor:"transformers.TFLEDModel.config",description:`<strong>config</strong> (<a href="/docs/transformers/main/en/model_doc/led#transformers.LEDConfig">LEDConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/main/en/main_classes/model#transformers.TFPreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),lo=new go({props:{$$slots:{default:[Af]},$$scope:{ctx:I}}}),On=new $({props:{name:"call",anchor:"transformers.TFLEDModel.call",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"decoder_input_ids",val:" = None"},{name:"decoder_attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"decoder_head_mask",val:" = None"},{name:"encoder_outputs",val:": typing.Union[typing.Tuple, transformers.models.led.modeling_tf_led.TFLEDEncoderBaseModelOutput, NoneType] = None"},{name:"global_attention_mask",val:" = None"},{name:"past_key_values",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"decoder_inputs_embeds",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"},{name:"training",val:" = False"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/led/modeling_tf_led.py#L2268",parametersDescription:[{anchor:"transformers.TFLEDModel.call.input_ids",description:`<strong>input_ids</strong> (<code>tf.Tensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
...
`}}),co=new go({props:{$$slots:{default:[Nf]},$$scope:{ctx:I}}}),Pn=new At({props:{code:`from transformers import LEDTokenizer, TFLEDModel
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),An=new me({}),Nn=new $({props:{name:"class transformers.TFLEDForConditionalGeneration",anchor:"transformers.TFLEDForConditionalGeneration",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/led/modeling_tf_led.py#L2363",parametersDescription:[{anchor:"transformers.TFLEDForConditionalGeneration.config",description:`<strong>config</strong> (<a href="/docs/transformers/main/en/model_doc/led#transformers.LEDConfig">LEDConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/main/en/main_classes/model#transformers.TFPreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),po=new go({props:{$$slots:{default:[jf]},$$scope:{ctx:I}}}),Gn=new $({props:{name:"call",anchor:"transformers.TFLEDForConditionalGeneration.call",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"decoder_input_ids",val:" = None"},{name:"decoder_attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"decoder_head_mask",val:" = None"},{name:"encoder_outputs",val:": typing.Optional[transformers.models.led.modeling_tf_led.TFLEDEncoderBaseModelOutput] = None"},{name:"global_attention_mask",val:" = None"},{name:"past_key_values",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"decoder_inputs_embeds",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"},{name:"labels",val:" = None"},{name:"training",val:" = False"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/led/modeling_tf_led.py#L2396",parametersDescription:[{anchor:"transformers.TFLEDForConditionalGeneration.call.input_ids",description:`<strong>input_ids</strong> (<code>tf.Tensor</code> of shape <code>({0})</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/main/en/model_doc/bert#transformers.BertTokenizer">BertTokenizer</a>. See <a href="/docs/transformers/main/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/main/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
`}}),uo=new go({props:{$$slots:{default:[If]},$$scope:{ctx:I}}}),Qn=new At({props:{code:`from transformers import LEDTokenizer, TFLEDForConditionalGeneration
import tensorflow as tf
...
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-comment"># probs[5] is associated with the mask token</span>`}}),{c(){u=n("meta"),L=d(),b=n("h1"),E=n("a"),q=n("span"),f(y.$$.fragment),w=d(),D=n("span"),Ae=r("LED"),fe=d(),z=n("h2"),Z=n("a"),U=n("span"),f(te.$$.fragment),Ne=d(),R=n("span"),je=r("Overview"),Me=d(),B=n("p"),V=r("The LED model was proposed in "),oe=n("a"),Le=r("Longformer: The Long-Document Transformer"),S=r(` by Iz
Beltagy, Matthew E. Peters, Arman Cohan.`),P=d(),_e=n("p"),ne=r("The abstract from the paper is the following:"),Se=d(),ge=n("p"),K=n("em"),Ie=r(`Transformer-based models are unable to process long sequences due to their self-attention operation, which scales
...
dataset.`),Ce=d(),C=n("p"),Be=r("Tips:"),Y=d(),x=n("ul"),M=n("li"),G=n("a"),Ge=r("LEDForConditionalGeneration"),Qe=r(` is an extension of
...
`),Pe=n("a"),it=r("BartTokenizer"),ie=r("."),dt=d(),de=n("li"),We=r("LED works very well on long-range "),Ue=n("em"),Si=r("sequence-to-sequence"),Ci=r(" tasks where the "),$s=n("code"),Oi=r("input_ids"),Pi=r(` largely exceed a length of
1024 tokens.`),Ai=d(),ze=n("li"),Ni=r("LED pads the "),xs=n("code"),ji=r("input_ids"),Ii=r(" to be a multiple of "),Ms=n("code"),Bi=r("config.attention_window"),Gi=r(` if required. Therefore a small speed-up is
gained, when `),Un=n("a"),Qi=r("LEDTokenizer"),Hi=r(" is used with the "),Ss=n("code"),Wi=r("pad_to_multiple_of"),Ui=r(" argument."),Ri=d(),J=n("li"),Vi=r("LED makes use of "),Cs=n("em"),Ki=r("global attention"),Xi=r(" by means of the "),Os=n("code"),Ji=r("global_attention_mask"),Zi=r(` (see
`),Rn=n("a"),Yi=r("LongformerModel"),ed=r("). For summarization, it is advised to put "),Ps=n("em"),td=r("global attention"),od=r(` only on the first
`),As=n("code"),nd=r("<s>"),sd=r(" token. For question answering, it is advised to put "),Ns=n("em"),ad=r("global attention"),rd=r(" on all tokens of the question."),id=d(),lt=n("li"),dd=r("To fine-tune LED on all 16384, it is necessary to enable "),js=n("em"),ld=r("gradient checkpointing"),cd=r(` by executing
`),Is=n("code"),hd=r("model.gradient_checkpointing_enable()"),pd=r("."),ud=d(),vo=n("li"),md=r("A notebook showing how to evaluate LED, can be accessed "),To=n("a"),fd=r("here"),_d=r("."),gd=d(),ko=n("li"),vd=r("A notebook showing how to fine-tune LED, can be accessed "),bo=n("a"),Td=r("here"),kd=r("."),ur=d(),Nt=n("p"),bd=r("This model was contributed by "),wo=n("a"),wd=r("patrickvonplaten"),yd=r("."),mr=d(),ct=n("h2"),jt=n("a"),Bs=n("span"),f(yo.$$.fragment),Ed=d(),Gs=n("span"),qd=r("LEDConfig"),fr=d(),O=n("div"),f(Eo.$$.fragment),Ld=d(),ht=n("p"),Dd=r("This is the configuration class to store the configuration of a "),Vn=n("a"),zd=r("LEDModel"),Fd=r(`. It is used to instantiate an LED
model according to the specified arguments, defining the model architecture. Instantiating a configuration with the
defaults will yield a similar configuration to that of the LED
`),qo=n("a"),$d=r("allenai/led-base-16384"),xd=r(" architecture."),Md=d(),pt=n("p"),Sd=r("Configuration objects inherit from "),Kn=n("a"),Cd=r("PretrainedConfig"),Od=r(` and can be used to control the model outputs. Read the
documentation from `),Xn=n("a"),Pd=r("PretrainedConfig"),Ad=r(" for more information."),Nd=d(),Qs=n("p"),jd=r("Example:"),Id=d(),f(Lo.$$.fragment),Bd=d(),Hs=n("blockquote"),Ws=n("blockquote"),Us=n("blockquote"),Rs=n("p"),Gd=r("from transformers import LEDModel, LEDConfig"),Qd=d(),Vs=n("blockquote"),Ks=n("blockquote"),Xs=n("blockquote"),It=n("h1"),Bt=n("a"),Js=n("span"),f(Do.$$.fragment),Hd=d(),Zs=n("span"),Wd=r("Initializing a LED allenai/led-base-16384 style configuration >>> configuration = LEDConfig()"),Ud=d(),Ys=n("blockquote"),ea=n("blockquote"),zo=n("blockquote"),Gt=n("h1"),Qt=n("a"),ta=n("span"),f(Fo.$$.fragment),Rd=d(),oa=n("span"),Vd=r("Initializing a model from the allenai/led-base-16384 style configuration >>> model ="),Kd=d(),na=n("p"),Xd=r("LEDModel(configuration)"),Jd=d(),sa=n("blockquote"),aa=n("blockquote"),ra=n("blockquote"),Ht=n("h1"),Wt=n("a"),ia=n("span"),f($o.$$.fragment),Zd=d(),da=n("span"),Yd=r("Accessing the model configuration >>> configuration = model.config"),_r=d(),ut=n("h2"),Ut=n("a"),la=n("span"),f(xo.$$.fragment),el=d(),ca=n("span"),tl=r("LEDTokenizer"),gr=d(),A=n("div"),f(Mo.$$.fragment),ol=d(),ha=n("p"),nl=r("Construct a LED tokenizer."),sl=d(),Rt=n("p"),Jn=n("a"),al=r("LEDTokenizer"),rl=r(" is identical to "),Zn=n("a"),il=r("BartTokenizer"),dl=r(` and runs end-to-end tokenization: punctuation splitting and
wordpiece.`),ll=d(),So=n("p"),cl=r("Refer to superclass "),Yn=n("a"),hl=r("BartTokenizer"),pl=r(" for usage examples and documentation concerning parameters."),ul=d(),Re=n("div"),f(Co.$$.fragment),ml=d(),pa=n("p"),fl=r(`Build model inputs from a sequence or a pair of sequence for sequence classification tasks by concatenating and
adding special tokens. A BART sequence has the following format:`),_l=d(),Oo=n("ul"),es=n("li"),gl=r("single sequence: "),ua=n("code"),vl=r("<s> X </s>"),Tl=d(),ts=n("li"),kl=r("pair of sequences: "),ma=n("code"),bl=r("<s> A </s></s> B </s>"),wl=d(),Vt=n("div"),f(Po.$$.fragment),yl=d(),Ao=n("p"),El=r(`Retrieve sequence ids from a token list that has no special tokens added. This method is called when adding
special tokens using the tokenizer `),fa=n("code"),ql=r("prepare_for_model"),Ll=r(" method."),Dl=d(),Kt=n("div"),f(No.$$.fragment),zl=d(),_a=n("p"),Fl=r(`Create a mask from the two sequences passed to be used in a sequence-pair classification task. BART does not
make use of token type ids, therefore a list of zeros is returned.`),$l=d(),os=n("div"),f(jo.$$.fragment),vr=d(),mt=n("h2"),Xt=n("a"),ga=n("span"),f(Io.$$.fragment),xl=d(),va=n("span"),Ml=r("LEDTokenizerFast"),Tr=d(),Fe=n("div"),f(Bo.$$.fragment),Sl=d(),Go=n("p"),Cl=r("Construct a \u201Cfast\u201D LED tokenizer (backed by HuggingFace\u2019s "),Ta=n("em"),Ol=r("tokenizers"),Pl=r(" library)."),Al=d(),Jt=n("p"),ns=n("a"),Nl=r("LEDTokenizerFast"),jl=r(" is identical to "),ss=n("a"),Il=r("BartTokenizerFast"),Bl=r(` and runs end-to-end tokenization: punctuation splitting
and wordpiece.`),Gl=d(),Qo=n("p"),Ql=r("Refer to superclass "),as=n("a"),Hl=r("BartTokenizerFast"),Wl=r(" for usage examples and documentation concerning parameters."),kr=d(),ft=n("h2"),Zt=n("a"),ka=n("span"),f(Ho.$$.fragment),Ul=d(),ba=n("span"),Rl=r("LED specific outputs"),br=d(),_t=n("div"),f(Wo.$$.fragment),Vl=d(),wa=n("p"),Kl=r("Base class for LEDEncoder\u2019s outputs, with potential hidden states, local and global attentions."),wr=d(),gt=n("div"),f(Uo.$$.fragment),Xl=d(),ya=n("p"),Jl=r(`Base class for model encoder\u2019s outputs that also contains : pre-computed hidden states that can speed up sequential
decoding.`),yr=d(),vt=n("div"),f(Ro.$$.fragment),Zl=d(),Ea=n("p"),Yl=r("Base class for sequence-to-sequence language models outputs."),Er=d(),Tt=n("div"),f(Vo.$$.fragment),ec=d(),qa=n("p"),tc=r("Base class for outputs of sequence-to-sequence sentence classification models."),qr=d(),kt=n("div"),f(Ko.$$.fragment),oc=d(),La=n("p"),nc=r("Base class for outputs of sequence-to-sequence question answering models."),Lr=d(),bt=n("div"),f(Xo.$$.fragment),sc=d(),Da=n("p"),ac=r("Base class for Longformer\u2019s outputs, with potential hidden states, local and global attentions."),Dr=d(),wt=n("div"),f(Jo.$$.fragment),rc=d(),za=n("p"),ic=r(`Base class for model encoder\u2019s outputs that also contains : pre-computed hidden states that can speed up sequential
decoding.`),zr=d(),yt=n("div"),f(Zo.$$.fragment),dc=d(),Fa=n("p"),lc=r("Base class for sequence-to-sequence language models outputs."),Fr=d(),Et=n("h2"),Yt=n("a"),$a=n("span"),f(Yo.$$.fragment),cc=d(),xa=n("span"),hc=r("LEDModel"),$r=d(),$e=n("div"),f(en.$$.fragment),pc=d(),tn=n("p"),uc=r(`The bare LED Model outputting raw hidden-states without any specific head on top.
...
etc.)`),_c=d(),on=n("p"),gc=r("This model is also a PyTorch "),nn=n("a"),vc=r("torch.nn.Module"),Tc=r(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),kc=d(),ve=n("div"),f(sn.$$.fragment),bc=d(),qt=n("p"),wc=r("The "),is=n("a"),yc=r("LEDModel"),Ec=r(" forward method, overrides the "),Ma=n("code"),qc=r("__call__"),Lc=r(" special method."),Dc=d(),f(eo.$$.fragment),zc=d(),Sa=n("p"),Fc=r("Example:"),$c=d(),f(an.$$.fragment),xr=d(),Lt=n("h2"),to=n("a"),Ca=n("span"),f(rn.$$.fragment),xc=d(),Oa=n("span"),Mc=r("LEDForConditionalGeneration"),Mr=d(),xe=n("div"),f(dn.$$.fragment),Sc=d(),ln=n("p"),Cc=r(`The LED Model with a language modeling head. Can be used for summarization.
This model inherits from `),ds=n("a"),Oc=r("PreTrainedModel"),Pc=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Ac=d(),cn=n("p"),Nc=r("This model is also a PyTorch "),hn=n("a"),jc=r("torch.nn.Module"),Ic=r(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Bc=d(),Q=n("div"),f(pn.$$.fragment),Gc=d(),Dt=n("p"),Qc=r("The "),ls=n("a"),Hc=r("LEDForConditionalGeneration"),Wc=r(" forward method, overrides the "),Pa=n("code"),Uc=r("__call__"),Rc=r(" special method."),Vc=d(),f(oo.$$.fragment),Kc=d(),Aa=n("p"),Xc=r("Conditional generation example:"),Jc=d(),f(un.$$.fragment),Zc=d(),Na=n("p"),Yc=r("Summarization example:"),eh=d(),f(mn.$$.fragment),Sr=d(),zt=n("h2"),no=n("a"),ja=n("span"),f(fn.$$.fragment),th=d(),Ia=n("span"),oh=r("LEDForSequenceClassification"),Cr=d(),le=n("div"),f(_n.$$.fragment),nh=d(),Ba=n("p"),sh=r(`LED model with a sequence classification/head on top (a linear layer on top of the pooled output) e.g. for GLUE
tasks.`),ah=d(),gn=n("p"),rh=r("This model inherits from "),cs=n("a"),ih=r("PreTrainedModel"),dh=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),lh=d(),vn=n("p"),ch=r("This model is also a PyTorch "),Tn=n("a"),hh=r("torch.nn.Module"),ph=r(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),uh=d(),H=n("div"),f(kn.$$.fragment),mh=d(),Ft=n("p"),fh=r("The "),hs=n("a"),_h=r("LEDForSequenceClassification"),gh=r(" forward method, overrides the "),Ga=n("code"),vh=r("__call__"),Th=r(" special method."),kh=d(),f(so.$$.fragment),bh=d(),Qa=n("p"),wh=r("Example of single-label classification:"),yh=d(),f(bn.$$.fragment),Eh=d(),Ha=n("p"),qh=r("Example of multi-label classification:"),Lh=d(),f(wn.$$.fragment),Or=d(),$t=n("h2"),ao=n("a"),Wa=n("span"),f(yn.$$.fragment),Dh=d(),Ua=n("span"),zh=r("LEDForQuestionAnswering"),Pr=d(),ce=n("div"),f(En.$$.fragment),Fh=d(),xt=n("p"),$h=r(`LED Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear layer
on top of the hidden-states output to compute `),Ra=n("code"),xh=r("span start logits"),Mh=r(" and "),Va=n("code"),Sh=r("span end logits"),Ch=r(")."),Oh=d(),qn=n("p"),Ph=r("This model inherits from "),ps=n("a"),Ah=r("PreTrainedModel"),Nh=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),jh=d(),Ln=n("p"),Ih=r("This model is also a PyTorch "),Dn=n("a"),Bh=r("torch.nn.Module"),Gh=r(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Qh=d(),Te=n("div"),f(zn.$$.fragment),Hh=d(),Mt=n("p"),Wh=r("The "),us=n("a"),Uh=r("LEDForQuestionAnswering"),Rh=r(" forward method, overrides the "),Ka=n("code"),Vh=r("__call__"),Kh=r(" special method."),Xh=d(),f(ro.$$.fragment),Jh=d(),Xa=n("p"),Zh=r("Example:"),Yh=d(),f(Fn.$$.fragment),Ar=d(),St=n("h2"),io=n("a"),Ja=n("span"),f($n.$$.fragment),ep=d(),Za=n("span"),tp=r("TFLEDModel"),Nr=d(),he=n("div"),f(xn.$$.fragment),op=d(),Mn=n("p"),np=r(`The bare LED Model outputting raw hidden-states without any specific head on top.
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),rp=d(),Sn=n("p"),ip=r("This model is also a "),Cn=n("a"),dp=r("tf.keras.Model"),lp=r(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),cp=d(),f(lo.$$.fragment),hp=d(),ke=n("div"),f(On.$$.fragment),pp=d(),Ct=n("p"),up=r("The "),fs=n("a"),mp=r("TFLEDModel"),fp=r(" forward method, overrides the "),Ya=n("code"),_p=r("__call__"),gp=r(" special method."),vp=d(),f(co.$$.fragment),Tp=d(),er=n("p"),kp=r("Example:"),bp=d(),f(Pn.$$.fragment),jr=d(),Ot=n("h2"),ho=n("a"),tr=n("span"),f(An.$$.fragment),wp=d(),or=n("span"),yp=r("TFLEDForConditionalGeneration"),Ir=d(),pe=n("div"),f(Nn.$$.fragment),Ep=d(),jn=n("p"),qp=r(`The LED Model with a language modeling head. Can be used for summarization.
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),zp=d(),In=n("p"),Fp=r("This model is also a "),Bn=n("a"),$p=r("tf.keras.Model"),xp=r(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Mp=d(),f(po.$$.fragment),Sp=d(),be=n("div"),f(Gn.$$.fragment),Cp=d(),Pt=n("p"),Op=r("The "),gs=n("a"),Pp=r("TFLEDForConditionalGeneration"),Ap=r(" forward method, overrides the "),nr=n("code"),Np=r("__call__"),jp=r(" special method."),Ip=d(),f(uo.$$.fragment),Bp=d(),sr=n("p"),Gp=r("Examples:"),Qp=d(),f(Qn.$$.fragment),this.h()},l(o){const p=xf('[data-svelte="svelte-1phssyn"]',document.head);u=s(p,"META",{name:!0,content:!0}),p.forEach(t),L=l(o),b=s(o,"H1",{class:!0});var Hn=a(b);E=s(Hn,"A",{id:!0,class:!0,href:!0});var ar=a(E);q=s(ar,"SPAN",{});var rr=a(q);_(y.$$.fragment,rr),rr.forEach(t),ar.forEach(t),w=l(Hn),D=s(Hn,"SPAN",{});var ir=a(D);Ae=i(ir,"LED"),ir.forEach(t),Hn.forEach(t),fe=l(o),z=s(o,"H2",{class:!0});var Wn=a(z);Z=s(Wn,"A",{id:!0,class:!0,href:!0});var dr=a(Z);U=s(dr,"SPAN",{});var lr=a(U);_(te.$$.fragment,lr),lr.forEach(t),dr.forEach(t),Ne=l(Wn),R=s(Wn,"SPAN",{});var cr=a(R);je=i(cr,"Overview"),cr.forEach(t),Wn.forEach(t),Me=l(o),B=s(o,"P",{});var Gr=a(B);V=i(Gr,"The LED model was proposed in "),oe=s(Gr,"A",{href:!0,rel:!0});var Up=a(oe);Le=i(Up,"Longformer: The Long-Document Transformer"),Up.forEach(t),S=i(Gr,` by Iz
Beltagy, Matthew E. Peters, Arman Cohan.`),Gr.forEach(t),P=l(o),_e=s(o,"P",{});var Rp=a(_e);ne=i(Rp,"The abstract from the paper is the following:"),Rp.forEach(t),Se=l(o),ge=s(o,"P",{});var Vp=a(ge);K=s(Vp,"EM",{});var Kp=a(K);Ie=i(Kp,`Transformer-based models are unable to process long sequences due to their self-attention operation, which scales
quadratically with the sequence length. To address this limitation, we introduce the Longformer with an attention
mechanism that scales linearly with sequence length, making it easy to process documents of thousands of tokens or
longer. Longformer\u2019s attention mechanism is a drop-in replacement for the standard self-attention and combines a local
windowed attention with a task motivated global attention. Following prior work on long-sequence transformers, we
...
WikiHop and TriviaQA. We finally introduce the Longformer-Encoder-Decoder (LED), a Longformer variant for supporting
long document generative sequence-to-sequence tasks, and demonstrate its effectiveness on the arXiv summarization
dataset.`),Kp.forEach(t),Vp.forEach(t),Ce=l(o),C=s(o,"P",{});var Xp=a(C);Be=i(Xp,"Tips:"),Xp.forEach(t),Y=l(o),x=s(o,"UL",{});var we=a(x);M=s(we,"LI",{});var ue=a(M);G=s(ue,"A",{href:!0});var Jp=a(G);Ge=i(Jp,"LEDForConditionalGeneration"),Jp.forEach(t),Qe=i(ue,` is an extension of
`),N=s(ue,"A",{href:!0});var Zp=a(N);He=i(Zp,"BartForConditionalGeneration"),Zp.forEach(t),se=i(ue," exchanging the traditional "),De=s(ue,"EM",{});var Yp=a(De);m=i(Yp,"self-attention"),Yp.forEach(t),F=i(ue,` layer with
`),ae=s(ue,"EM",{});var eu=a(ae);nt=i(eu,"Longformer"),eu.forEach(t),st=i(ue,"\u2019s "),j=s(ue,"EM",{});var tu=a(j);at=i(tu,"chunked self-attention"),tu.forEach(t),rt=i(ue," layer. "),Oe=s(ue,"A",{href:!0});var ou=a(Oe);X=i(ou,"LEDTokenizer"),ou.forEach(t),re=i(ue,` is an alias of
`),Pe=s(ue,"A",{href:!0});var nu=a(Pe);it=i(nu,"BartTokenizer"),nu.forEach(t),ie=i(ue,"."),ue.forEach(t),dt=l(we),de=s(we,"LI",{});var vs=a(de);We=i(vs,"LED works very well on long-range "),Ue=s(vs,"EM",{});var su=a(Ue);Si=i(su,"sequence-to-sequence"),su.forEach(t),Ci=i(vs," tasks where the "),$s=s(vs,"CODE",{});var au=a($s);Oi=i(au,"input_ids"),au.forEach(t),Pi=i(vs,` largely exceed a length of
1024 tokens.`),vs.forEach(t),Ai=l(we),ze=s(we,"LI",{});var Ve=a(ze);Ni=i(Ve,"LED pads the "),xs=s(Ve,"CODE",{});var ru=a(xs);ji=i(ru,"input_ids"),ru.forEach(t),Ii=i(Ve," to be a multiple of "),Ms=s(Ve,"CODE",{});var iu=a(Ms);Bi=i(iu,"config.attention_window"),iu.forEach(t),Gi=i(Ve,` if required. Therefore a small speed-up is
gained, when `),Un=s(Ve,"A",{href:!0});var du=a(Un);Qi=i(du,"LEDTokenizer"),du.forEach(t),Hi=i(Ve," is used with the "),Ss=s(Ve,"CODE",{});var lu=a(Ss);Wi=i(lu,"pad_to_multiple_of"),lu.forEach(t),Ui=i(Ve," argument."),Ve.forEach(t),Ri=l(we),J=s(we,"LI",{});var ye=a(J);Vi=i(ye,"LED makes use of "),Cs=s(ye,"EM",{});var cu=a(Cs);Ki=i(cu,"global attention"),cu.forEach(t),Xi=i(ye," by means of the "),Os=s(ye,"CODE",{});var hu=a(Os);Ji=i(hu,"global_attention_mask"),hu.forEach(t),Zi=i(ye,` (see
`),Rn=s(ye,"A",{href:!0});var pu=a(Rn);Yi=i(pu,"LongformerModel"),pu.forEach(t),ed=i(ye,"). For summarization, it is advised to put "),Ps=s(ye,"EM",{});var uu=a(Ps);td=i(uu,"global attention"),uu.forEach(t),od=i(ye,` only on the first
`),As=s(ye,"CODE",{});var mu=a(As);nd=i(mu,"<s>"),mu.forEach(t),sd=i(ye," token. For question answering, it is advised to put "),Ns=s(ye,"EM",{});var fu=a(Ns);ad=i(fu,"global attention"),fu.forEach(t),rd=i(ye," on all tokens of the question."),ye.forEach(t),id=l(we),lt=s(we,"LI",{});var Ts=a(lt);dd=i(Ts,"To fine-tune LED on all 16384, it is necessary to enable "),js=s(Ts,"EM",{});var _u=a(js);ld=i(_u,"gradient checkpointing"),_u.forEach(t),cd=i(Ts,` by executing
`),Is=s(Ts,"CODE",{});var gu=a(Is);hd=i(gu,"model.gradient_checkpointing_enable()"),gu.forEach(t),pd=i(Ts,"."),Ts.forEach(t),ud=l(we),vo=s(we,"LI",{});var Qr=a(vo);md=i(Qr,"A notebook showing how to evaluate LED, can be accessed "),To=s(Qr,"A",{href:!0,rel:!0});var vu=a(To);fd=i(vu,"here"),vu.forEach(t),_d=i(Qr,"."),Qr.forEach(t),gd=l(we),ko=s(we,"LI",{});var Hr=a(ko);vd=i(Hr,"A notebook showing how to fine-tune LED, can be accessed "),bo=s(Hr,"A",{href:!0,rel:!0});var Tu=a(bo);Td=i(Tu,"here"),Tu.forEach(t),kd=i(Hr,"."),Hr.forEach(t),we.forEach(t),ur=l(o),Nt=s(o,"P",{});var Wr=a(Nt);bd=i(Wr,"This model was contributed by "),wo=s(Wr,"A",{href:!0,rel:!0});var ku=a(wo);wd=i(ku,"patrickvonplaten"),ku.forEach(t),yd=i(Wr,"."),Wr.forEach(t),mr=l(o),ct=s(o,"H2",{class:!0});var Ur=a(ct);jt=s(Ur,"A",{id:!0,class:!0,href:!0});var bu=a(jt);Bs=s(bu,"SPAN",{});var wu=a(Bs);_(yo.$$.fragment,wu),wu.forEach(t),bu.forEach(t),Ed=l(Ur),Gs=s(Ur,"SPAN",{});var yu=a(Gs);qd=i(yu,"LEDConfig"),yu.forEach(t),Ur.forEach(t),fr=l(o),O=s(o,"DIV",{class:!0});var W=a(O);_(Eo.$$.fragment,W),Ld=l(W),ht=s(W,"P",{});var ks=a(ht);Dd=i(ks,"This is the configuration class to store the configuration of a "),Vn=s(ks,"A",{href:!0});var Eu=a(Vn);zd=i(Eu,"LEDModel"),Eu.forEach(t),Fd=i(ks,`. It is used to instantiate an LED
model according to the specified arguments, defining the model architecture. Instantiating a configuration with the
defaults will yield a similar configuration to that of the LED
`),qo=s(ks,"A",{href:!0,rel:!0});var qu=a(qo);$d=i(qu,"allenai/led-base-16384"),qu.forEach(t),xd=i(ks," architecture."),ks.forEach(t),Md=l(W),pt=s(W,"P",{});var bs=a(pt);Sd=i(bs,"Configuration objects inherit from "),Kn=s(bs,"A",{href:!0});var Lu=a(Kn);Cd=i(Lu,"PretrainedConfig"),Lu.forEach(t),Od=i(bs,` and can be used to control the model outputs. Read the
documentation from `),Xn=s(bs,"A",{href:!0});var Du=a(Xn);Pd=i(Du,"PretrainedConfig"),Du.forEach(t),Ad=i(bs," for more information."),bs.forEach(t),Nd=l(W),Qs=s(W,"P",{});var zu=a(Qs);jd=i(zu,"Example:"),zu.forEach(t),Id=l(W),_(Lo.$$.fragment,W),Bd=l(W),Hs=s(W,"BLOCKQUOTE",{});var Fu=a(Hs);Ws=s(Fu,"BLOCKQUOTE",{});var $u=a(Ws);Us=s($u,"BLOCKQUOTE",{});var xu=a(Us);Rs=s(xu,"P",{});var Mu=a(Rs);Gd=i(Mu,"from transformers import LEDModel, LEDConfig"),Mu.forEach(t),xu.forEach(t),$u.forEach(t),Fu.forEach(t),Qd=l(W),Vs=s(W,"BLOCKQUOTE",{});var Su=a(Vs);Ks=s(Su,"BLOCKQUOTE",{});var Cu=a(Ks);Xs=s(Cu,"BLOCKQUOTE",{});var Ou=a(Xs);It=s(Ou,"H1",{class:!0});var Rr=a(It);Bt=s(Rr,"A",{id:!0,class:!0,href:!0});var Pu=a(Bt);Js=s(Pu,"SPAN",{});var Au=a(Js);_(Do.$$.fragment,Au),Au.forEach(t),Pu.forEach(t),Hd=l(Rr),Zs=s(Rr,"SPAN",{});var Nu=a(Zs);Wd=i(Nu,"Initializing a LED allenai/led-base-16384 style configuration >>> configuration = LEDConfig()"),Nu.forEach(t),Rr.forEach(t),Ou.forEach(t),Cu.forEach(t),Su.forEach(t),Ud=l(W),Ys=s(W,"BLOCKQUOTE",{});var ju=a(Ys);ea=s(ju,"BLOCKQUOTE",{});var Iu=a(ea);zo=s(Iu,"BLOCKQUOTE",{});var Vr=a(zo);Gt=s(Vr,"H1",{class:!0});var Kr=a(Gt);Qt=s(Kr,"A",{id:!0,class:!0,href:!0});var Bu=a(Qt);ta=s(Bu,"SPAN",{});var Gu=a(ta);_(Fo.$$.fragment,Gu),Gu.forEach(t),Bu.forEach(t),Rd=l(Kr),oa=s(Kr,"SPAN",{});var Qu=a(oa);Vd=i(Qu,"Initializing a model from the allenai/led-base-16384 style configuration >>> model ="),Qu.forEach(t),Kr.forEach(t),Kd=l(Vr),na=s(Vr,"P",{});var Hu=a(na);Xd=i(Hu,"LEDModel(configuration)"),Hu.forEach(t),Vr.forEach(t),Iu.forEach(t),ju.forEach(t),Jd=l(W),sa=s(W,"BLOCKQUOTE",{});var Wu=a(sa);aa=s(Wu,"BLOCKQUOTE",{});var Uu=a(aa);ra=s(Uu,"BLOCKQUOTE",{});var Ru=a(ra);Ht=s(Ru,"H1",{class:!0});var Xr=a(Ht);Wt=s(Xr,"A",{id:!0,class:!0,href:!0});var Vu=a(Wt);ia=s(Vu,"SPAN",{});var Ku=a(ia);_($o.$$.fragment,Ku),Ku.forEach(t),Vu.forEach(t),Zd=l(Xr),da=s(Xr,"SPAN",{});var Xu=a(da);Yd=i(Xu,"Accessing the model configuration >>> configuration = model.config"),Xu.forEach(t),Xr.forEach(t),Ru.forEach(t),Uu.forEach(t),Wu.forEach(t),W.forEach(t),_r=l(o),ut=s(o,"H2",{class:!0});var Jr=a(ut);Ut=s(Jr,"A",{id:!0,class:!0,href:!0});var Ju=a(Ut);la=s(Ju,"SPAN",{});var Zu=a(la);_(xo.$$.fragment,Zu),Zu.forEach(t),Ju.forEach(t),el=l(Jr),ca=s(Jr,"SPAN",{});var Yu=a(ca);tl=i(Yu,"LEDTokenizer"),Yu.forEach(t),Jr.forEach(t),gr=l(o),A=s(o,"DIV",{class:!0});var ee=a(A);_(Mo.$$.fragment,ee),ol=l(ee),ha=s(ee,"P",{});var em=a(ha);nl=i(em,"Construct a LED tokenizer."),em.forEach(t),sl=l(ee),Rt=s(ee,"P",{});var hr=a(Rt);Jn=s(hr,"A",{href:!0});var tm=a(Jn);al=i(tm,"LEDTokenizer"),tm.forEach(t),rl=i(hr," is identical to "),Zn=s(hr,"A",{href:!0});var om=a(Zn);il=i(om,"BartTokenizer"),om.forEach(t),dl=i(hr,` and runs end-to-end tokenization: punctuation splitting and
wordpiece.`),hr.forEach(t),ll=l(ee),So=s(ee,"P",{});var Zr=a(So);cl=i(Zr,"Refer to superclass "),Yn=s(Zr,"A",{href:!0});var nm=a(Yn);hl=i(nm,"BartTokenizer"),nm.forEach(t),pl=i(Zr," for usage examples and documentation concerning parameters."),Zr.forEach(t),ul=l(ee),Re=s(ee,"DIV",{class:!0});var ws=a(Re);_(Co.$$.fragment,ws),ml=l(ws),pa=s(ws,"P",{});var sm=a(pa);fl=i(sm,`Build model inputs from a sequence or a pair of sequence for sequence classification tasks by concatenating and
adding special tokens. A BART sequence has the following format:`),sm.forEach(t),_l=l(ws),Oo=s(ws,"UL",{});var Yr=a(Oo);es=s(Yr,"LI",{});var Hp=a(es);gl=i(Hp,"single sequence: "),ua=s(Hp,"CODE",{});var am=a(ua);vl=i(am,"<s> X </s>"),am.forEach(t),Hp.forEach(t),Tl=l(Yr),ts=s(Yr,"LI",{});var Wp=a(ts);kl=i(Wp,"pair of sequences: "),ma=s(Wp,"CODE",{});var rm=a(ma);bl=i(rm,"<s> A </s></s> B </s>"),rm.forEach(t),Wp.forEach(t),Yr.forEach(t),ws.forEach(t),wl=l(ee),Vt=s(ee,"DIV",{class:!0});var ei=a(Vt);_(Po.$$.fragment,ei),yl=l(ei),Ao=s(ei,"P",{});var ti=a(Ao);El=i(ti,`Retrieve sequence ids from a token list that has no special tokens added. This method is called when adding
special tokens using the tokenizer `),fa=s(ti,"CODE",{});var im=a(fa);ql=i(im,"prepare_for_model"),im.forEach(t),Ll=i(ti," method."),ti.forEach(t),ei.forEach(t),Dl=l(ee),Kt=s(ee,"DIV",{class:!0});var oi=a(Kt);_(No.$$.fragment,oi),zl=l(oi),_a=s(oi,"P",{});var dm=a(_a);Fl=i(dm,`Create a mask from the two sequences passed to be used in a sequence-pair classification task. BART does not
make use of token type ids, therefore a list of zeros is returned.`),dm.forEach(t),oi.forEach(t),$l=l(ee),os=s(ee,"DIV",{class:!0});var lm=a(os);_(jo.$$.fragment,lm),lm.forEach(t),ee.forEach(t),vr=l(o),mt=s(o,"H2",{class:!0});var ni=a(mt);Xt=s(ni,"A",{id:!0,class:!0,href:!0});var cm=a(Xt);ga=s(cm,"SPAN",{});var hm=a(ga);_(Io.$$.fragment,hm),hm.forEach(t),cm.forEach(t),xl=l(ni),va=s(ni,"SPAN",{});var pm=a(va);Ml=i(pm,"LEDTokenizerFast"),pm.forEach(t),ni.forEach(t),Tr=l(o),Fe=s(o,"DIV",{class:!0});var mo=a(Fe);_(Bo.$$.fragment,mo),Sl=l(mo),Go=s(mo,"P",{});var si=a(Go);Cl=i(si,"Construct a \u201Cfast\u201D LED tokenizer (backed by HuggingFace\u2019s "),Ta=s(si,"EM",{});var um=a(Ta);Ol=i(um,"tokenizers"),um.forEach(t),Pl=i(si," library)."),si.forEach(t),Al=l(mo),Jt=s(mo,"P",{});var pr=a(Jt);ns=s(pr,"A",{href:!0});var mm=a(ns);Nl=i(mm,"LEDTokenizerFast"),mm.forEach(t),jl=i(pr," is identical to "),ss=s(pr,"A",{href:!0});var fm=a(ss);Il=i(fm,"BartTokenizerFast"),fm.forEach(t),Bl=i(pr,` and runs end-to-end tokenization: punctuation splitting
and wordpiece.`),pr.forEach(t),Gl=l(mo),Qo=s(mo,"P",{});var ai=a(Qo);Ql=i(ai,"Refer to superclass "),as=s(ai,"A",{href:!0});var _m=a(as);Hl=i(_m,"BartTokenizerFast"),_m.forEach(t),Wl=i(ai," for usage examples and documentation concerning parameters."),ai.forEach(t),mo.forEach(t),kr=l(o),ft=s(o,"H2",{class:!0});var ri=a(ft);Zt=s(ri,"A",{id:!0,class:!0,href:!0});var gm=a(Zt);ka=s(gm,"SPAN",{});var vm=a(ka);_(Ho.$$.fragment,vm),vm.forEach(t),gm.forEach(t),Ul=l(ri),ba=s(ri,"SPAN",{});var Tm=a(ba);Rl=i(Tm,"LED specific outputs"),Tm.forEach(t),ri.forEach(t),br=l(o),_t=s(o,"DIV",{class:!0});var ii=a(_t);_(Wo.$$.fragment,ii),Vl=l(ii),wa=s(ii,"P",{});var km=a(wa);Kl=i(km,"Base class for LEDEncoder\u2019s outputs, with potential hidden states, local and global attentions."),km.forEach(t),ii.forEach(t),wr=l(o),gt=s(o,"DIV",{class:!0});var di=a(gt);_(Uo.$$.fragment,di),Xl=l(di),ya=s(di,"P",{});var bm=a(ya);Jl=i(bm,`Base class for model encoder\u2019s outputs that also contains : pre-computed hidden states that can speed up sequential
decoding.`),bm.forEach(t),di.forEach(t),yr=l(o),vt=s(o,"DIV",{class:!0});var li=a(vt);_(Ro.$$.fragment,li),Zl=l(li),Ea=s(li,"P",{});var wm=a(Ea);Yl=i(wm,"Base class for sequence-to-sequence language models outputs."),wm.forEach(t),li.forEach(t),Er=l(o),Tt=s(o,"DIV",{class:!0});var ci=a(Tt);_(Vo.$$.fragment,ci),ec=l(ci),qa=s(ci,"P",{});var ym=a(qa);tc=i(ym,"Base class for outputs of sequence-to-sequence sentence classification models."),ym.forEach(t),ci.forEach(t),qr=l(o),kt=s(o,"DIV",{class:!0});var hi=a(kt);_(Ko.$$.fragment,hi),oc=l(hi),La=s(hi,"P",{});var Em=a(La);nc=i(Em,"Base class for outputs of sequence-to-sequence question answering models."),Em.forEach(t),hi.forEach(t),Lr=l(o),bt=s(o,"DIV",{class:!0});var pi=a(bt);_(Xo.$$.fragment,pi),sc=l(pi),Da=s(pi,"P",{});var qm=a(Da);ac=i(qm,"Base class for Longformer\u2019s outputs, with potential hidden states, local and global attentions."),qm.forEach(t),pi.forEach(t),Dr=l(o),wt=s(o,"DIV",{class:!0});var ui=a(wt);_(Jo.$$.fragment,ui),rc=l(ui),za=s(ui,"P",{});var Lm=a(za);ic=i(Lm,`Base class for model encoder\u2019s outputs that also contains : pre-computed hidden states that can speed up sequential
decoding.`),Lm.forEach(t),ui.forEach(t),zr=l(o),yt=s(o,"DIV",{class:!0});var mi=a(yt);_(Zo.$$.fragment,mi),dc=l(mi),Fa=s(mi,"P",{});var Dm=a(Fa);lc=i(Dm,"Base class for sequence-to-sequence language models outputs."),Dm.forEach(t),mi.forEach(t),Fr=l(o),Et=s(o,"H2",{class:!0});var fi=a(Et);Yt=s(fi,"A",{id:!0,class:!0,href:!0});var zm=a(Yt);$a=s(zm,"SPAN",{});var Fm=a($a);_(Yo.$$.fragment,Fm),Fm.forEach(t),zm.forEach(t),cc=l(fi),xa=s(fi,"SPAN",{});var $m=a(xa);hc=i($m,"LEDModel"),$m.forEach(t),fi.forEach(t),$r=l(o),$e=s(o,"DIV",{class:!0});var fo=a($e);_(en.$$.fragment,fo),pc=l(fo),tn=s(fo,"P",{});var _i=a(tn);uc=i(_i,`The bare LED Model outputting raw hidden-states without any specific head on top.
This model inherits from `),rs=s(_i,"A",{href:!0});var xm=a(rs);mc=i(xm,"PreTrainedModel"),xm.forEach(t),fc=i(_i,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),_i.forEach(t),_c=l(fo),on=s(fo,"P",{});var gi=a(on);gc=i(gi,"This model is also a PyTorch "),nn=s(gi,"A",{href:!0,rel:!0});var Mm=a(nn);vc=i(Mm,"torch.nn.Module"),Mm.forEach(t),Tc=i(gi,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),gi.forEach(t),kc=l(fo),ve=s(fo,"DIV",{class:!0});var Ke=a(ve);_(sn.$$.fragment,Ke),bc=l(Ke),qt=s(Ke,"P",{});var ys=a(qt);wc=i(ys,"The "),is=s(ys,"A",{href:!0});var Sm=a(is);yc=i(Sm,"LEDModel"),Sm.forEach(t),Ec=i(ys," forward method, overrides the "),Ma=s(ys,"CODE",{});var Cm=a(Ma);qc=i(Cm,"__call__"),Cm.forEach(t),Lc=i(ys," special method."),ys.forEach(t),Dc=l(Ke),_(eo.$$.fragment,Ke),zc=l(Ke),Sa=s(Ke,"P",{});var Om=a(Sa);Fc=i(Om,"Example:"),Om.forEach(t),$c=l(Ke),_(an.$$.fragment,Ke),Ke.forEach(t),fo.forEach(t),xr=l(o),Lt=s(o,"H2",{class:!0});var vi=a(Lt);to=s(vi,"A",{id:!0,class:!0,href:!0});var Pm=a(to);Ca=s(Pm,"SPAN",{});var Am=a(Ca);_(rn.$$.fragment,Am),Am.forEach(t),Pm.forEach(t),xc=l(vi),Oa=s(vi,"SPAN",{});var Nm=a(Oa);Mc=i(Nm,"LEDForConditionalGeneration"),Nm.forEach(t),vi.forEach(t),Mr=l(o),xe=s(o,"DIV",{class:!0});var _o=a(xe);_(dn.$$.fragment,_o),Sc=l(_o),ln=s(_o,"P",{});var Ti=a(ln);Cc=i(Ti,`The LED Model with a language modeling head. Can be used for summarization.
This model inherits from `),ds=s(Ti,"A",{href:!0});var jm=a(ds);Oc=i(jm,"PreTrainedModel"),jm.forEach(t),Pc=i(Ti,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Ti.forEach(t),Ac=l(_o),cn=s(_o,"P",{});var ki=a(cn);Nc=i(ki,"This model is also a PyTorch "),hn=s(ki,"A",{href:!0,rel:!0});var Im=a(hn);jc=i(Im,"torch.nn.Module"),Im.forEach(t),Ic=i(ki,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),ki.forEach(t),Bc=l(_o),Q=s(_o,"DIV",{class:!0});var Ee=a(Q);_(pn.$$.fragment,Ee),Gc=l(Ee),Dt=s(Ee,"P",{});var Es=a(Dt);Qc=i(Es,"The "),ls=s(Es,"A",{href:!0});var Bm=a(ls);Hc=i(Bm,"LEDForConditionalGeneration"),Bm.forEach(t),Wc=i(Es," forward method, overrides the "),Pa=s(Es,"CODE",{});var Gm=a(Pa);Uc=i(Gm,"__call__"),Gm.forEach(t),Rc=i(Es," special method."),Es.forEach(t),Vc=l(Ee),_(oo.$$.fragment,Ee),Kc=l(Ee),Aa=s(Ee,"P",{});var Qm=a(Aa);Xc=i(Qm,"Conditional generation example:"),Qm.forEach(t),Jc=l(Ee),_(un.$$.fragment,Ee),Zc=l(Ee),Na=s(Ee,"P",{});var Hm=a(Na);Yc=i(Hm,"Summarization example:"),Hm.forEach(t),eh=l(Ee),_(mn.$$.fragment,Ee),Ee.forEach(t),_o.forEach(t),Sr=l(o),zt=s(o,"H2",{class:!0});var bi=a(zt);no=s(bi,"A",{id:!0,class:!0,href:!0});var Wm=a(no);ja=s(Wm,"SPAN",{});var Um=a(ja);_(fn.$$.fragment,Um),Um.forEach(t),Wm.forEach(t),th=l(bi),Ia=s(bi,"SPAN",{});var Rm=a(Ia);oh=i(Rm,"LEDForSequenceClassification"),Rm.forEach(t),bi.forEach(t),Cr=l(o),le=s(o,"DIV",{class:!0});var Xe=a(le);_(_n.$$.fragment,Xe),nh=l(Xe),Ba=s(Xe,"P",{});var Vm=a(Ba);sh=i(Vm,`LED model with a sequence classification/head on top (a linear layer on top of the pooled output) e.g. for GLUE
tasks.`),Vm.forEach(t),ah=l(Xe),gn=s(Xe,"P",{});var wi=a(gn);rh=i(wi,"This model inherits from "),cs=s(wi,"A",{href:!0});var Km=a(cs);ih=i(Km,"PreTrainedModel"),Km.forEach(t),dh=i(wi,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),wi.forEach(t),lh=l(Xe),vn=s(Xe,"P",{});var yi=a(vn);ch=i(yi,"This model is also a PyTorch "),Tn=s(yi,"A",{href:!0,rel:!0});var Xm=a(Tn);hh=i(Xm,"torch.nn.Module"),Xm.forEach(t),ph=i(yi,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),yi.forEach(t),uh=l(Xe),H=s(Xe,"DIV",{class:!0});var qe=a(H);_(kn.$$.fragment,qe),mh=l(qe),Ft=s(qe,"P",{});var qs=a(Ft);fh=i(qs,"The "),hs=s(qs,"A",{href:!0});var Jm=a(hs);_h=i(Jm,"LEDForSequenceClassification"),Jm.forEach(t),gh=i(qs," forward method, overrides the "),Ga=s(qs,"CODE",{});var Zm=a(Ga);vh=i(Zm,"__call__"),Zm.forEach(t),Th=i(qs," special method."),qs.forEach(t),kh=l(qe),_(so.$$.fragment,qe),bh=l(qe),Qa=s(qe,"P",{});var Ym=a(Qa);wh=i(Ym,"Example of single-label classification:"),Ym.forEach(t),yh=l(qe),_(bn.$$.fragment,qe),Eh=l(qe),Ha=s(qe,"P",{});var ef=a(Ha);qh=i(ef,"Example of multi-label classification:"),ef.forEach(t),Lh=l(qe),_(wn.$$.fragment,qe),qe.forEach(t),Xe.forEach(t),Or=l(o),$t=s(o,"H2",{class:!0});var Ei=a($t);ao=s(Ei,"A",{id:!0,class:!0,href:!0});var tf=a(ao);Wa=s(tf,"SPAN",{});var of=a(Wa);_(yn.$$.fragment,of),of.forEach(t),tf.forEach(t),Dh=l(Ei),Ua=s(Ei,"SPAN",{});var nf=a(Ua);zh=i(nf,"LEDForQuestionAnswering"),nf.forEach(t),Ei.forEach(t),Pr=l(o),ce=s(o,"DIV",{class:!0});var Je=a(ce);_(En.$$.fragment,Je),Fh=l(Je),xt=s(Je,"P",{});var Ls=a(xt);$h=i(Ls,`LED Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear layer
on top of the hidden-states output to compute `),Ra=s(Ls,"CODE",{});var sf=a(Ra);xh=i(sf,"span start logits"),sf.forEach(t),Mh=i(Ls," and "),Va=s(Ls,"CODE",{});var af=a(Va);Sh=i(af,"span end logits"),af.forEach(t),Ch=i(Ls,")."),Ls.forEach(t),Oh=l(Je),qn=s(Je,"P",{});var qi=a(qn);Ph=i(qi,"This model inherits from "),ps=s(qi,"A",{href:!0});var rf=a(ps);Ah=i(rf,"PreTrainedModel"),rf.forEach(t),Nh=i(qi,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),qi.forEach(t),jh=l(Je),Ln=s(Je,"P",{});var Li=a(Ln);Ih=i(Li,"This model is also a PyTorch "),Dn=s(Li,"A",{href:!0,rel:!0});var df=a(Dn);Bh=i(df,"torch.nn.Module"),df.forEach(t),Gh=i(Li,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Li.forEach(t),Qh=l(Je),Te=s(Je,"DIV",{class:!0});var Ze=a(Te);_(zn.$$.fragment,Ze),Hh=l(Ze),Mt=s(Ze,"P",{});var Ds=a(Mt);Wh=i(Ds,"The "),us=s(Ds,"A",{href:!0});var lf=a(us);Uh=i(lf,"LEDForQuestionAnswering"),lf.forEach(t),Rh=i(Ds," forward method, overrides the "),Ka=s(Ds,"CODE",{});var cf=a(Ka);Vh=i(cf,"__call__"),cf.forEach(t),Kh=i(Ds," special method."),Ds.forEach(t),Xh=l(Ze),_(ro.$$.fragment,Ze),Jh=l(Ze),Xa=s(Ze,"P",{});var hf=a(Xa);Zh=i(hf,"Example:"),hf.forEach(t),Yh=l(Ze),_(Fn.$$.fragment,Ze),Ze.forEach(t),Je.forEach(t),Ar=l(o),St=s(o,"H2",{class:!0});var Di=a(St);io=s(Di,"A",{id:!0,class:!0,href:!0});var pf=a(io);Ja=s(pf,"SPAN",{});var uf=a(Ja);_($n.$$.fragment,uf),uf.forEach(t),pf.forEach(t),ep=l(Di),Za=s(Di,"SPAN",{});var mf=a(Za);tp=i(mf,"TFLEDModel"),mf.forEach(t),Di.forEach(t),Nr=l(o),he=s(o,"DIV",{class:!0});var Ye=a(he);_(xn.$$.fragment,Ye),op=l(Ye),Mn=s(Ye,"P",{});var zi=a(Mn);np=i(zi,`The bare LED Model outputting raw hidden-states without any specific head on top.
This model inherits from `),ms=s(zi,"A",{href:!0});var ff=a(ms);sp=i(ff,"TFPreTrainedModel"),ff.forEach(t),ap=i(zi,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),zi.forEach(t),rp=l(Ye),Sn=s(Ye,"P",{});var Fi=a(Sn);ip=i(Fi,"This model is also a "),Cn=s(Fi,"A",{href:!0,rel:!0});var _f=a(Cn);dp=i(_f,"tf.keras.Model"),_f.forEach(t),lp=i(Fi,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Fi.forEach(t),cp=l(Ye),_(lo.$$.fragment,Ye),hp=l(Ye),ke=s(Ye,"DIV",{class:!0});var et=a(ke);_(On.$$.fragment,et),pp=l(et),Ct=s(et,"P",{});var zs=a(Ct);up=i(zs,"The "),fs=s(zs,"A",{href:!0});var gf=a(fs);mp=i(gf,"TFLEDModel"),gf.forEach(t),fp=i(zs," forward method, overrides the "),Ya=s(zs,"CODE",{});var vf=a(Ya);_p=i(vf,"__call__"),vf.forEach(t),gp=i(zs," special method."),zs.forEach(t),vp=l(et),_(co.$$.fragment,et),Tp=l(et),er=s(et,"P",{});var Tf=a(er);kp=i(Tf,"Example:"),Tf.forEach(t),bp=l(et),_(Pn.$$.fragment,et),et.forEach(t),Ye.forEach(t),jr=l(o),Ot=s(o,"H2",{class:!0});var $i=a(Ot);ho=s($i,"A",{id:!0,class:!0,href:!0});var kf=a(ho);tr=s(kf,"SPAN",{});var bf=a(tr);_(An.$$.fragment,bf),bf.forEach(t),kf.forEach(t),wp=l($i),or=s($i,"SPAN",{});var wf=a(or);yp=i(wf,"TFLEDForConditionalGeneration"),wf.forEach(t),$i.forEach(t),Ir=l(o),pe=s(o,"DIV",{class:!0});var tt=a(pe);_(Nn.$$.fragment,tt),Ep=l(tt),jn=s(tt,"P",{});var xi=a(jn);qp=i(xi,`The LED Model with a language modeling head. Can be used for summarization.
This model inherits from `),_s=s(xi,"A",{href:!0});var yf=a(_s);Lp=i(yf,"TFPreTrainedModel"),yf.forEach(t),Dp=i(xi,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),xi.forEach(t),zp=l(tt),In=s(tt,"P",{});var Mi=a(In);Fp=i(Mi,"This model is also a "),Bn=s(Mi,"A",{href:!0,rel:!0});var Ef=a(Bn);$p=i(Ef,"tf.keras.Model"),Ef.forEach(t),xp=i(Mi,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Mi.forEach(t),Mp=l(tt),_(po.$$.fragment,tt),Sp=l(tt),be=s(tt,"DIV",{class:!0});var ot=a(be);_(Gn.$$.fragment,ot),Cp=l(ot),Pt=s(ot,"P",{});var Fs=a(Pt);Op=i(Fs,"The "),gs=s(Fs,"A",{href:!0});var qf=a(gs);Pp=i(qf,"TFLEDForConditionalGeneration"),qf.forEach(t),Ap=i(Fs," forward method, overrides the "),nr=s(Fs,"CODE",{});var Lf=a(nr);Np=i(Lf,"__call__"),Lf.forEach(t),jp=i(Fs," special method."),Fs.forEach(t),Ip=l(ot),_(uo.$$.fragment,ot),Bp=l(ot),sr=s(ot,"P",{});var Df=a(sr);Gp=i(Df,"Examples:"),Df.forEach(t),Qp=l(ot),_(Qn.$$.fragment,ot),ot.forEach(t),tt.forEach(t),this.h()},h(){c(u,"name","hf:doc:metadata"),c(u,"content",JSON.stringify(Gf)),c(E,"id","led"),c(E,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(E,"href","#led"),c(b,"class","relative group"),c(Z,"id","overview"),c(Z,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(Z,"href","#overview"),c(z,"class","relative group"),c(oe,"href","https://arxiv.org/abs/2004.05150"),c(oe,"rel","nofollow"),c(G,"href","/docs/transformers/main/en/model_doc/led#transformers.LEDForConditionalGeneration"),c(N,"href","/docs/transformers/main/en/model_doc/bart#transformers.BartForConditionalGeneration"),c(Oe,"href","/docs/transformers/main/en/model_doc/led#transformers.LEDTokenizer"),c(Pe,"href","/docs/transformers/main/en/model_doc/bart#transformers.BartTokenizer"),c(Un,"href","/docs/transformers/main/en/model_doc/led#transformers.LEDTokenizer"),c(Rn,"href","/docs/transformers/main/en/model_doc/longformer#transformers.LongformerModel"),c(To,"href","https://colab.research.google.com/drive/12INTTR6n64TzS4RrXZxMSXfrOd9Xzamo?usp=sharing"),c(To,"rel","nofollow"),c(bo,"href","https://colab.research.google.com/drive/12LjJazBl7Gam0XBPy_y0CTOJZeZ34c2v?usp=sharing"),c(bo,"rel","nofollow"),c(wo,"href","https://huggingface.co/patrickvonplaten"),c(wo,"rel","nofollow"),c(jt,"id","transformers.LEDConfig"),c(jt,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(jt,"href","#transformers.LEDConfig"),c(ct,"class","relative group"),c(Vn,"href","/docs/transformers/main/en/model_doc/led#transformers.LEDModel"),c(qo,"href","https://huggingface.co/allenai/led-base-16384"),c(qo,"rel","nofollow"),c(Kn,"href","/docs/transformers/main/en/main_classes/configuration#transformers.PretrainedConfig"),c(Xn,"href","/docs/transformers/main/en/main_classes/configuration#transformers.PretrainedConfig"),c(Bt,"id","initializing-a-led-allenai/led-base-16384-style-configuration->>>-configuration-=-ledconfig()"),c(Bt,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(Bt,"href","#initializing-a-led-allenai/led-base-16384-style-configuration->>>-configuration-=-ledconfig()"),c(It,"class","relative group"),c(Qt,"id","initializing-a-model-from-the-allenai/led-base-16384-style-configuration->>>-model-="),c(Qt,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(Qt,"href","#initializing-a-model-from-the-allenai/led-base-16384-style-configuration->>>-model-="),c(Gt,"class","relative group"),c(Wt,"id","accessing-the-model-configuration->>>-configuration-=-model.config"),c(Wt,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(Wt,"href","#accessing-the-model-configuration->>>-configuration-=-model.config"),c(Ht,"class","relative group"),c(O,"class","docstring"),c(Ut,"id","transformers.LEDTokenizer"),c(Ut,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(Ut,"href","#transformers.LEDTokenizer"),c(ut,"class","relative group"),c(Jn,"href","/docs/transformers/main/en/model_doc/led#transformers.LEDTokenizer"),c(Zn,"href","/docs/transformers/main/en/model_doc/bart#transformers.BartTokenizer"),c(Yn,"href","/docs/transformers/main/en/model_doc/bart#transformers.BartTokenizer"),c(Re,"class","docstring"),c(Vt,"class","docstring"),c(Kt,"class","docstring"),c(os,"class","docstring"),c(A,"class","docstring"),c(Xt,"id","transformers.LEDTokenizerFast"),c(Xt,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(Xt,"href","#transformers.LEDTokenizerFast"),c(mt,"class","relative group"),c(ns,"href","/docs/transformers/main/en/model_doc/led#transformers.LEDTokenizerFast"),c(ss,"href","/docs/transformers/main/en/model_doc/bart#transformers.BartTokenizerFast"),c(as,"href","/docs/transformers/main/en/model_doc/bart#transformers.BartTokenizerFast"),c(Fe,"class","docstring"),c(Zt,"id","transformers.models.led.modeling_led.LEDEncoderBaseModelOutput"),c(Zt,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(Zt,"href","#transformers.models.led.modeling_led.LEDEncoderBaseModelOutput"),c(ft,"class","relative group"),c(_t,"class","docstring"),c(gt,"class","docstring"),c(vt,"class","docstring"),c(Tt,"class","docstring"),c(kt,"class","docstring"),c(bt,"class","docstring"),c(wt,"class","docstring"),c(yt,"class","docstring"),c(Yt,"id","transformers.LEDModel"),c(Yt,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(Yt,"href","#transformers.LEDModel"),c(Et,"class","relative group"),c(rs,"href","/docs/transformers/main/en/main_classes/model#transformers.PreTrainedModel"),c(nn,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),c(nn,"rel","nofollow"),c(is,"href","/docs/transformers/main/en/model_doc/led#transformers.LEDModel"),c(ve,"class","docstring"),c($e,"class","docstring"),c(to,"id","transformers.LEDForConditionalGeneration"),c(to,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(to,"href","#transformers.LEDForConditionalGeneration"),c(Lt,"class","relative group"),c(ds,"href","/docs/transformers/main/en/main_classes/model#transformers.PreTrainedModel"),c(hn,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),c(hn,"rel","nofollow"),c(ls,"href","/docs/transformers/main/en/model_doc/led#transformers.LEDForConditionalGeneration"),c(Q,"class","docstring"),c(xe,"class","docstring"),c(no,"id","transformers.LEDForSequenceClassification"),c(no,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(no,"href","#transformers.LEDForSequenceClassification"),c(zt,"class","relative group"),c(cs,"href","/docs/transformers/main/en/main_classes/model#transformers.PreTrainedModel"),c(Tn,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),c(Tn,"rel","nofollow"),c(hs,"href","/docs/transformers/main/en/model_doc/led#transformers.LEDForSequenceClassification"),c(H,"class","docstring"),c(le,"class","docstring"),c(ao,"id","transformers.LEDForQuestionAnswering"),c(ao,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(ao,"href","#transformers.LEDForQuestionAnswering"),c($t,"class","relative group"),c(ps,"href","/docs/transformers/main/en/main_classes/model#transformers.PreTrainedModel"),c(Dn,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),c(Dn,"rel","nofollow"),c(us,"href","/docs/transformers/main/en/model_doc/led#transformers.LEDForQuestionAnswering"),c(Te,"class","docstring"),c(ce,"class","docstring"),c(io,"id","transformers.TFLEDModel"),c(io,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(io,"href","#transformers.TFLEDModel"),c(St,"class","relative group"),c(ms,"href","/docs/transformers/main/en/main_classes/model#transformers.TFPreTrainedModel"),c(Cn,"href","https://www.tensorflow.org/api_docs/python/tf/keras/Model"),c(Cn,"rel","nofollow"),c(fs,"href","/docs/transformers/main/en/model_doc/led#transformers.TFLEDModel"),c(ke,"class","docstring"),c(he,"class","docstring"),c(ho,"id","transformers.TFLEDForConditionalGeneration"),c(ho,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(ho,"href","#transformers.TFLEDForConditionalGeneration"),c(Ot,"class","relative group"),c(_s,"href","/docs/transformers/main/en/main_classes/model#transformers.TFPreTrainedModel"),c(Bn,"href","https://www.tensorflow.org/api_docs/python/tf/keras/Model"),c(Bn,"rel","nofollow"),c(gs,"href","/docs/transformers/main/en/model_doc/led#transformers.TFLEDForConditionalGeneration"),c(be,"class","docstring"),c(pe,"class","docstring")},m(o,p){e(document.head,u),h(o,L,p),h(o,b,p),e(b,E),e(E,q),g(y,q,null),e(b,w),e(b,D),e(D,Ae),h(o,fe,p),h(o,z,p),e(z,Z),e(Z,U),g(te,U,null),e(z,Ne),e(z,R),e(R,je),h(o,Me,p),h(o,B,p),e(B,V),e(B,oe),e(oe,Le),e(B,S),h(o,P,p),h(o,_e,p),e(_e,ne),h(o,Se,p),h(o,ge,p),e(ge,K),e(K,Ie),h(o,Ce,p),h(o,C,p),e(C,Be),h(o,Y,p),h(o,x,p),e(x,M),e(M,G),e(G,Ge),e(M,Qe),e(M,N),e(N,He),e(M,se),e(M,De),e(De,m),e(M,F),e(M,ae),e(ae,nt),e(M,st),e(M,j),e(j,at),e(M,rt),e(M,Oe),e(Oe,X),e(M,re),e(M,Pe),e(Pe,it),e(M,ie),e(x,dt),e(x,de),e(de,We),e(de,Ue),e(Ue,Si),e(de,Ci),e(de,$s),e($s,Oi),e(de,Pi),e(x,Ai),e(x,ze),e(ze,Ni),e(ze,xs),e(xs,ji),e(ze,Ii),e(ze,Ms),e(Ms,Bi),e(ze,Gi),e(ze,Un),e(Un,Qi),e(ze,Hi),e(ze,Ss),e(Ss,Wi),e(ze,Ui),e(x,Ri),e(x,J),e(J,Vi),e(J,Cs),e(Cs,Ki),e(J,Xi),e(J,Os),e(Os,Ji),e(J,Zi),e(J,Rn),e(Rn,Yi),e(J,ed),e(J,Ps),e(Ps,td),e(J,od),e(J,As),e(As,nd),e(J,sd),e(J,Ns),e(Ns,ad),e(J,rd),e(x,id),e(x,lt),e(lt,dd),e(lt,js),e(js,ld),e(lt,cd),e(lt,Is),e(Is,hd),e(lt,pd),e(x,ud),e(x,vo),e(vo,md),e(vo,To),e(To,fd),e(vo,_d),e(x,gd),e(x,ko),e(ko,vd),e(ko,bo),e(bo,Td),e(ko,kd),h(o,ur,p),h(o,Nt,p),e(Nt,bd),e(Nt,wo),e(wo,wd),e(Nt,yd),h(o,mr,p),h(o,ct,p),e(ct,jt),e(jt,Bs),g(yo,Bs,null),e(ct,Ed),e(ct,Gs),e(Gs,qd),h(o,fr,p),h(o,O,p),g(Eo,O,null),e(O,Ld),e(O,ht),e(ht,Dd),e(ht,Vn),e(Vn,zd),e(ht,Fd),e(ht,qo),e(qo,$d),e(ht,xd),e(O,Md),e(O,pt),e(pt,Sd),e(pt,Kn),e(Kn,Cd),e(pt,Od),e(pt,Xn),e(Xn,Pd),e(pt,Ad),e(O,Nd),e(O,Qs),e(Qs,jd),e(O,Id),g(Lo,O,null),e(O,Bd),e(O,Hs),e(Hs,Ws),e(Ws,Us),e(Us,Rs),e(Rs,Gd),e(O,Qd),e(O,Vs),e(Vs,Ks),e(Ks,Xs),e(Xs,It),e(It,Bt),e(Bt,Js),g(Do,Js,null),e(It,Hd),e(It,Zs),e(Zs,Wd),e(O,Ud),e(O,Ys),e(Ys,ea),e(ea,zo),e(zo,Gt),e(Gt,Qt),e(Qt,ta),g(Fo,ta,null),e(Gt,Rd),e(Gt,oa),e(oa,Vd),e(zo,Kd),e(zo,na),e(na,Xd),e(O,Jd),e(O,sa),e(sa,aa),e(aa,ra),e(ra,Ht),e(Ht,Wt),e(Wt,ia),g($o,ia,null),e(Ht,Zd),e(Ht,da),e(da,Yd),h(o,_r,p),h(o,ut,p),e(ut,Ut),e(Ut,la),g(xo,la,null),e(ut,el),e(ut,ca),e(ca,tl),h(o,gr,p),h(o,A,p),g(Mo,A,null),e(A,ol),e(A,ha),e(ha,nl),e(A,sl),e(A,Rt),e(Rt,Jn),e(Jn,al),e(Rt,rl),e(Rt,Zn),e(Zn,il),e(Rt,dl),e(A,ll),e(A,So),e(So,cl),e(So,Yn),e(Yn,hl),e(So,pl),e(A,ul),e(A,Re),g(Co,Re,null),e(Re,ml),e(Re,pa),e(pa,fl),e(Re,_l),e(Re,Oo),e(Oo,es),e(es,gl),e(es,ua),e(ua,vl),e(Oo,Tl),e(Oo,ts),e(ts,kl),e(ts,ma),e(ma,bl),e(A,wl),e(A,Vt),g(Po,Vt,null),e(Vt,yl),e(Vt,Ao),e(Ao,El),e(Ao,fa),e(fa,ql),e(Ao,Ll),e(A,Dl),e(A,Kt),g(No,Kt,null),e(Kt,zl),e(Kt,_a),e(_a,Fl),e(A,$l),e(A,os),g(jo,os,null),h(o,vr,p),h(o,mt,p),e(mt,Xt),e(Xt,ga),g(Io,ga,null),e(mt,xl),e(mt,va),e(va,Ml),h(o,Tr,p),h(o,Fe,p),g(Bo,Fe,null),e(Fe,Sl),e(Fe,Go),e(Go,Cl),e(Go,Ta),e(Ta,Ol),e(Go,Pl),e(Fe,Al),e(Fe,Jt),e(Jt,ns),e(ns,Nl),e(Jt,jl),e(Jt,ss),e(ss,Il),e(Jt,Bl),e(Fe,Gl),e(Fe,Qo),e(Qo,Ql),e(Qo,as),e(as,Hl),e(Qo,Wl),h(o,kr,p),h(o,ft,p),e(ft,Zt),e(Zt,ka),g(Ho,ka,null),e(ft,Ul),e(ft,ba),e(ba,Rl),h(o,br,p),h(o,_t,p),g(Wo,_t,null),e(_t,Vl),e(_t,wa),e(wa,Kl),h(o,wr,p),h(o,gt,p),g(Uo,gt,null),e(gt,Xl),e(gt,ya),e(ya,Jl),h(o,yr,p),h(o,vt,p),g(Ro,vt,null),e(vt,Zl),e(vt,Ea),e(Ea,Yl),h(o,Er,p),h(o,Tt,p),g(Vo,Tt,null),e(Tt,ec),e(Tt,qa),e(qa,tc),h(o,qr,p),h(o,kt,p),g(Ko,kt,null),e(kt,oc),e(kt,La),e(La,nc),h(o,Lr,p),h(o,bt,p),g(Xo,bt,null),e(bt,sc),e(bt,Da),e(Da,ac),h(o,Dr,p),h(o,wt,p),g(Jo,wt,null),e(wt,rc),e(wt,za),e(za,ic),h(o,zr,p),h(o,yt,p),g(Zo,yt,null),e(yt,dc),e(yt,Fa),e(Fa,lc),h(o,Fr,p),h(o,Et,p),e(Et,Yt),e(Yt,$a),g(Yo,$a,null),e(Et,cc),e(Et,xa),e(xa,hc),h(o,$r,p),h(o,$e,p),g(en,$e,null),e($e,pc),e($e,tn),e(tn,uc),e(tn,rs),e(rs,mc),e(tn,fc),e($e,_c),e($e,on),e(on,gc),e(on,nn),e(nn,vc),e(on,Tc),e($e,kc),e($e,ve),g(sn,ve,null),e(ve,bc),e(ve,qt),e(qt,wc),e(qt,is),e(is,yc),e(qt,Ec),e(qt,Ma),e(Ma,qc),e(qt,Lc),e(ve,Dc),g(eo,ve,null),e(ve,zc),e(ve,Sa),e(Sa,Fc),e(ve,$c),g(an,ve,null),h(o,xr,p),h(o,Lt,p),e(Lt,to),e(to,Ca),g(rn,Ca,null),e(Lt,xc),e(Lt,Oa),e(Oa,Mc),h(o,Mr,p),h(o,xe,p),g(dn,xe,null),e(xe,Sc),e(xe,ln),e(ln,Cc),e(ln,ds),e(ds,Oc),e(ln,Pc),e(xe,Ac),e(xe,cn),e(cn,Nc),e(cn,hn),e(hn,jc),e(cn,Ic),e(xe,Bc),e(xe,Q),g(pn,Q,null),e(Q,Gc),e(Q,Dt),e(Dt,Qc),e(Dt,ls),e(ls,Hc),e(Dt,Wc),e(Dt,Pa),e(Pa,Uc),e(Dt,Rc),e(Q,Vc),g(oo,Q,null),e(Q,Kc),e(Q,Aa),e(Aa,Xc),e(Q,Jc),g(un,Q,null),e(Q,Zc),e(Q,Na),e(Na,Yc),e(Q,eh),g(mn,Q,null),h(o,Sr,p),h(o,zt,p),e(zt,no),e(no,ja),g(fn,ja,null),e(zt,th),e(zt,Ia),e(Ia,oh),h(o,Cr,p),h(o,le,p),g(_n,le,null),e(le,nh),e(le,Ba),e(Ba,sh),e(le,ah),e(le,gn),e(gn,rh),e(gn,cs),e(cs,ih),e(gn,dh),e(le,lh),e(le,vn),e(vn,ch),e(vn,Tn),e(Tn,hh),e(vn,ph),e(le,uh),e(le,H),g(kn,H,null),e(H,mh),e(H,Ft),e(Ft,fh),e(Ft,hs),e(hs,_h),e(Ft,gh),e(Ft,Ga),e(Ga,vh),e(Ft,Th),e(H,kh),g(so,H,null),e(H,bh),e(H,Qa),e(Qa,wh),e(H,yh),g(bn,H,null),e(H,Eh),e(H,Ha),e(Ha,qh),e(H,Lh),g(wn,H,null),h(o,Or,p),h(o,$t,p),e($t,ao),e(ao,Wa),g(yn,Wa,null),e($t,Dh),e($t,Ua),e(Ua,zh),h(o,Pr,p),h(o,ce,p),g(En,ce,null),e(ce,Fh),e(ce,xt),e(xt,$h),e(xt,Ra),e(Ra,xh),e(xt,Mh),e(xt,Va),e(Va,Sh),e(xt,Ch),e(ce,Oh),e(ce,qn),e(qn,Ph),e(qn,ps),e(ps,Ah),e(qn,Nh),e(ce,jh),e(ce,Ln),e(Ln,Ih),e(Ln,Dn),e(Dn,Bh),e(Ln,Gh),e(ce,Qh),e(ce,Te),g(zn,Te,null),e(Te,Hh),e(Te,Mt),e(Mt,Wh),e(Mt,us),e(us,Uh),e(Mt,Rh),e(Mt,Ka),e(Ka,Vh),e(Mt,Kh),e(Te,Xh),g(ro,Te,null),e(Te,Jh),e(Te,Xa),e(Xa,Zh),e(Te,Yh),g(Fn,Te,null),h(o,Ar,p),h(o,St,p),e(St,io),e(io,Ja),g($n,Ja,null),e(St,ep),e(St,Za),e(Za,tp),h(o,Nr,p),h(o,he,p),g(xn,he,null),e(he,op),e(he,Mn),e(Mn,np),e(Mn,ms),e(ms,sp),e(Mn,ap),e(he,rp),e(he,Sn),e(Sn,ip),e(Sn,Cn),e(Cn,dp),e(Sn,lp),e(he,cp),g(lo,he,null),e(he,hp),e(he,ke),g(On,ke,null),e(ke,pp),e(ke,Ct),e(Ct,up),e(Ct,fs),e(fs,mp),e(Ct,fp),e(Ct,Ya),e(Ya,_p),e(Ct,gp),e(ke,vp),g(co,ke,null),e(ke,Tp),e(ke,er),e(er,kp),e(ke,bp),g(Pn,ke,null),h(o,jr,p),h(o,Ot,p),e(Ot,ho),e(ho,tr),g(An,tr,null),e(Ot,wp),e(Ot,or),e(or,yp),h(o,Ir,p),h(o,pe,p),g(Nn,pe,null),e(pe,Ep),e(pe,jn),e(jn,qp),e(jn,_s),e(_s,Lp),e(jn,Dp),e(pe,zp),e(pe,In),e(In,Fp),e(In,Bn),e(Bn,$p),e(In,xp),e(pe,Mp),g(po,pe,null),e(pe,Sp),e(pe,be),g(Gn,be,null),e(be,Cp),e(be,Pt),e(Pt,Op),e(Pt,gs),e(gs,Pp),e(Pt,Ap),e(Pt,nr),e(nr,Np),e(Pt,jp),e(be,Ip),g(uo,be,null),e(be,Bp),e(be,sr),e(sr,Gp),e(be,Qp),g(Qn,be,null),Br=!0},p(o,[p]){const Hn={};p&2&&(Hn.$$scope={dirty:p,ctx:o}),eo.$set(Hn);const ar={};p&2&&(ar.$$scope={dirty:p,ctx:o}),oo.$set(ar);const rr={};p&2&&(rr.$$scope={dirty:p,ctx:o}),so.$set(rr);const ir={};p&2&&(ir.$$scope={dirty:p,ctx:o}),ro.$set(ir);const Wn={};p&2&&(Wn.$$scope={dirty:p,ctx:o}),lo.$set(Wn);const dr={};p&2&&(dr.$$scope={dirty:p,ctx:o}),co.$set(dr);const lr={};p&2&&(lr.$$scope={dirty:p,ctx:o}),po.$set(lr);const cr={};p&2&&(cr.$$scope={dirty:p,ctx:o}),uo.$set(cr)},i(o){Br||(v(y.$$.fragment,o),v(te.$$.fragment,o),v(yo.$$.fragment,o),v(Eo.$$.fragment,o),v(Lo.$$.fragment,o),v(Do.$$.fragment,o),v(Fo.$$.fragment,o),v($o.$$.fragment,o),v(xo.$$.fragment,o),v(Mo.$$.fragment,o),v(Co.$$.fragment,o),v(Po.$$.fragment,o),v(No.$$.fragment,o),v(jo.$$.fragment,o),v(Io.$$.fragment,o),v(Bo.$$.fragment,o),v(Ho.$$.fragment,o),v(Wo.$$.fragment,o),v(Uo.$$.fragment,o),v(Ro.$$.fragment,o),v(Vo.$$.fragment,o),v(Ko.$$.fragment,o),v(Xo.$$.fragment,o),v(Jo.$$.fragment,o),v(Zo.$$.fragment,o),v(Yo.$$.fragment,o),v(en.$$.fragment,o),v(sn.$$.fragment,o),v(eo.$$.fragment,o),v(an.$$.fragment,o),v(rn.$$.fragment,o),v(dn.$$.fragment,o),v(pn.$$.fragment,o),v(oo.$$.fragment,o),v(un.$$.fragment,o),v(mn.$$.fragment,o),v(fn.$$.fragment,o),v(_n.$$.fragment,o),v(kn.$$.fragment,o),v(so.$$.fragment,o),v(bn.$$.fragment,o),v(wn.$$.fragment,o),v(yn.$$.fragment,o),v(En.$$.fragment,o),v(zn.$$.fragment,o),v(ro.$$.fragment,o),v(Fn.$$.fragment,o),v($n.$$.fragment,o),v(xn.$$.fragment,o),v(lo.$$.fragment,o),v(On.$$.fragment,o),v(co.$$.fragment,o),v(Pn.$$.fragment,o),v(An.$$.fragment,o),v(Nn.$$.fragment,o),v(po.$$.fragment,o),v(Gn.$$.fragment,o),v(uo.$$.fragment,o),v(Qn.$$.fragment,o),Br=!0)},o(o){T(y.$$.fragment,o),T(te.$$.fragment,o),T(yo.$$.fragment,o),T(Eo.$$.fragment,o),T(Lo.$$.fragment,o),T(Do.$$.fragment,o),T(Fo.$$.fragment,o),T($o.$$.fragment,o),T(xo.$$.fragment,o),T(Mo.$$.fragment,o),T(Co.$$.fragment,o),T(Po.$$.fragment,o),T(No.$$.fragment,o),T(jo.$$.fragment,o),T(Io.$$.fragment,o),T(Bo.$$.fragment,o),T(Ho.$$.fragment,o),T(Wo.$$.fragment,o),T(Uo.$$.fragment,o),T(Ro.$$.fragment,o),T(Vo.$$.fragment,o),T(Ko.$$.fragment,o),T(Xo.$$.fragment,o),T(Jo.$$.fragment,o),T(Zo.$$.fragment,o),T(Yo.$$.fragment,o),T(en.$$.fragment,o),T(sn.$$.fragment,o),T(eo.$$.fragment,o),T(an.$$.fragment,o),T(rn.$$.fragment,o),T(dn.$$.fragment,o),T(pn.$$.fragment,o),T(oo.$$.fragment,o),T(un.$$.fragment,o),T(mn.$$.fragment,o),T(fn.$$.fragment,o),T(_n.$$.fragment,o),T(kn.$$.fragment,o),T(so.$$.fragment,o),T(bn.$$.fragment,o),T(wn.$$.fragment,o),T(yn.$$.fragment,o),T(En.$$.fragment,o),T(zn.$$.fragment,o),T(ro.$$.fragment,o),T(Fn.$$.fragment,o),T($n.$$.fragment,o),T(xn.$$.fragment,o),T(lo.$$.fragment,o),T(On.$$.fragment,o),T(co.$$.fragment,o),T(Pn.$$.fragment,o),T(An.$$.fragment,o),T(Nn.$$.fragment,o),T(po.$$.fragment,o),T(Gn.$$.fragment,o),T(uo.$$.fragment,o),T(Qn.$$.fragment,o),Br=!1},d(o){t(u),o&&t(L),o&&t(b),k(y),o&&t(fe),o&&t(z),k(te),o&&t(Me),o&&t(B),o&&t(P),o&&t(_e),o&&t(Se),o&&t(ge),o&&t(Ce),o&&t(C),o&&t(Y),o&&t(x),o&&t(ur),o&&t(Nt),o&&t(mr),o&&t(ct),k(yo),o&&t(fr),o&&t(O),k(Eo),k(Lo),k(Do),k(Fo),k($o),o&&t(_r),o&&t(ut),k(xo),o&&t(gr),o&&t(A),k(Mo),k(Co),k(Po),k(No),k(jo),o&&t(vr),o&&t(mt),k(Io),o&&t(Tr),o&&t(Fe),k(Bo),o&&t(kr),o&&t(ft),k(Ho),o&&t(br),o&&t(_t),k(Wo),o&&t(wr),o&&t(gt),k(Uo),o&&t(yr),o&&t(vt),k(Ro),o&&t(Er),o&&t(Tt),k(Vo),o&&t(qr),o&&t(kt),k(Ko),o&&t(Lr),o&&t(bt),k(Xo),o&&t(Dr),o&&t(wt),k(Jo),o&&t(zr),o&&t(yt),k(Zo),o&&t(Fr),o&&t(Et),k(Yo),o&&t($r),o&&t($e),k(en),k(sn),k(eo),k(an),o&&t(xr),o&&t(Lt),k(rn),o&&t(Mr),o&&t(xe),k(dn),k(pn),k(oo),k(un),k(mn),o&&t(Sr),o&&t(zt),k(fn),o&&t(Cr),o&&t(le),k(_n),k(kn),k(so),k(bn),k(wn),o&&t(Or),o&&t($t),k(yn),o&&t(Pr),o&&t(ce),k(En),k(zn),k(ro),k(Fn),o&&t(Ar),o&&t(St),k($n),o&&t(Nr),o&&t(he),k(xn),k(lo),k(On),k(co),k(Pn),o&&t(jr),o&&t(Ot),k(An),o&&t(Ir),o&&t(pe),k(Nn),k(po),k(Gn),k(uo),k(Qn)}}}const Gf={local:"led",sections:[{local:"overview",title:"Overview"},{local:"transformers.LEDConfig",title:"LEDConfig"},{local:"transformers.LEDTokenizer",title:"LEDTokenizer"},{local:"transformers.LEDTokenizerFast",title:"LEDTokenizerFast"},{local:"transformers.models.led.modeling_led.LEDEncoderBaseModelOutput",title:"LED specific outputs"},{local:"transformers.LEDModel",title:"LEDModel"},{local:"transformers.LEDForConditionalGeneration",title:"LEDForConditionalGeneration"},{local:"transformers.LEDForSequenceClassification",title:"LEDForSequenceClassification"},{local:"transformers.LEDForQuestionAnswering",title:"LEDForQuestionAnswering"},{local:"transformers.TFLEDModel",title:"TFLEDModel"},{local:"transformers.TFLEDForConditionalGeneration",title:"TFLEDForConditionalGeneration"}],title:"LED"};function Qf(I){return Mf(()=>{new URLSearchParams(window.location.search).get("fw")}),[]}class Kf extends zf{constructor(u){super();Ff(this,u,Qf,Bf,$f,{})}}export{Kf as default,Gf as metadata};
