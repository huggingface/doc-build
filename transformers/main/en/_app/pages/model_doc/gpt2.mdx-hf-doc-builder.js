...
<span class="hljs-meta">&gt;&gt;&gt; </span>configuration = model.config`}}),{c(){d=s("p"),T=r("Example:"),m=p(),v(c.$$.fragment)},l(n){d=a(n,"P",{});var u=l(d);T=i(u,"Example:"),u.forEach(t),m=h(n),k(c.$$.fragment,n)},m(n,u){_(n,d,u),e(d,T),_(n,m,u),w(c,n,u),g=!0},p:ae,i(n){g||($(c.$$.fragment,n),g=!0)},o(n){P(c.$$.fragment,n),g=!1},d(n){n&&t(d),n&&t(m),M(c,n)}}}function $b(G){let d,T,m,c,g;return c=new re({props:{code:`from transformers import GPT2Tokenizer
...
[15496, 995]
<span class="hljs-meta">&gt;&gt;&gt;</span> <span class="language-python">tokenizer(<span class="hljs-string">&quot; Hello world&quot;</span>)[<span class="hljs-string">&#x27;input_ids&#x27;</span>]</span>
[18435, 995]`}}),{c(){d=s("p"),T=r("be encoded differently whether it is at the beginning of the sentence (without space) or not:"),m=p(),v(c.$$.fragment)},l(n){d=a(n,"P",{});var u=l(d);T=i(u,"be encoded differently whether it is at the beginning of the sentence (without space) or not:"),u.forEach(t),m=h(n),k(c.$$.fragment,n)},m(n,u){_(n,d,u),e(d,T),_(n,m,u),w(c,n,u),g=!0},p:ae,i(n){g||($(c.$$.fragment,n),g=!0)},o(n){P(c.$$.fragment,n),g=!1},d(n){n&&t(d),n&&t(m),M(c,n)}}}function Pb(G){let d,T,m,c,g;return{c(){d=s("p"),T=r("When used with "),m=s("code"),c=r("is_split_into_words=True"),g=r(", this tokenizer will add a space before each word (even the first one).")},l(n){d=a(n,"P",{});var u=l(d);T=i(u,"When used with "),m=a(u,"CODE",{});var j=l(m);c=i(j,"is_split_into_words=True"),j.forEach(t),g=i(u,", this tokenizer will add a space before each word (even the first one)."),u.forEach(t)},m(n,u){_(n,d,u),e(d,T),e(d,m),e(m,c),e(d,g)},d(n){n&&t(d)}}}function Mb(G){let d,T,m,c,g;return c=new re({props:{code:`from transformers import GPT2TokenizerFast
...
[15496, 995]
<span class="hljs-meta">&gt;&gt;&gt;</span> <span class="language-python">tokenizer(<span class="hljs-string">&quot; Hello world&quot;</span>)[<span class="hljs-string">&#x27;input_ids&#x27;</span>]</span>
[18435, 995]`}}),{c(){d=s("p"),T=r("be encoded differently whether it is at the beginning of the sentence (without space) or not:"),m=p(),v(c.$$.fragment)},l(n){d=a(n,"P",{});var u=l(d);T=i(u,"be encoded differently whether it is at the beginning of the sentence (without space) or not:"),u.forEach(t),m=h(n),k(c.$$.fragment,n)},m(n,u){_(n,d,u),e(d,T),_(n,m,u),w(c,n,u),g=!0},p:ae,i(n){g||($(c.$$.fragment,n),g=!0)},o(n){P(c.$$.fragment,n),g=!1},d(n){n&&t(d),n&&t(m),M(c,n)}}}function Gb(G){let d,T,m,c,g,n,u,j;return{c(){d=s("p"),T=r("When used with "),m=s("code"),c=r("is_split_into_words=True"),g=r(", this tokenizer needs to be instantiated with "),n=s("code"),u=r("add_prefix_space=True"),j=r(".")},l(Q){d=a(Q,"P",{});var C=l(d);T=i(C,"When used with "),m=a(C,"CODE",{});var F=l(m);c=i(F,"is_split_into_words=True"),F.forEach(t),g=i(C,", this tokenizer needs to be instantiated with "),n=a(C,"CODE",{});var R=l(n);u=i(R,"add_prefix_space=True"),R.forEach(t),j=i(C,"."),C.forEach(t)},m(Q,C){_(Q,d,C),e(d,T),e(d,m),e(m,c),e(d,g),e(d,n),e(n,u),e(d,j)},d(Q){Q&&t(d)}}}function xb(G){let d,T,m,c,g;return{c(){d=s("p"),T=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),m=s("code"),c=r("Module"),g=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(n){d=a(n,"P",{});var u=l(d);T=i(u,"Although the recipe for forward pass needs to be defined within this function, one should call the "),m=a(u,"CODE",{});var j=l(m);c=i(j,"Module"),j.forEach(t),g=i(u,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),u.forEach(t)},m(n,u){_(n,d,u),e(d,T),e(d,m),e(m,c),e(d,g)},d(n){n&&t(d)}}}function jb(G){let d,T,m,c,g;return c=new re({props:{code:`from transformers import GPT2Tokenizer, GPT2Model
import torch
...
<span class="hljs-number">5.28</span>`}}),{c(){v(d.$$.fragment)},l(m){k(d.$$.fragment,m)},m(m,c){w(d,m,c),T=!0},p:ae,i(m){T||($(d.$$.fragment,m),T=!0)},o(m){P(d.$$.fragment,m),T=!1},d(m){M(d,m)}}}function Sb(G){let d,T,m,c,g;return c=new re({props:{code:`import torch
from transformers import GPT2Tokenizer, GPT2ForSequenceClassification
...
<span class="hljs-meta">&gt;&gt;&gt; </span>predicted_class_id = logits.argmax().item()
<span class="hljs-meta">&gt;&gt;&gt; </span>model.config.id2label[predicted_class_id]
<span class="hljs-string">&#x27;LABEL_0&#x27;</span>`}}),{c(){d=s("p"),T=r("Example of multi-label classification:"),m=p(),v(c.$$.fragment)},l(n){d=a(n,"P",{});var u=l(d);T=i(u,"Example of multi-label classification:"),u.forEach(t),m=h(n),k(c.$$.fragment,n)},m(n,u){_(n,d,u),e(d,T),_(n,m,u),w(c,n,u),g=!0},p:ae,i(n){g||($(c.$$.fragment,n),g=!0)},o(n){P(c.$$.fragment,n),g=!1},d(n){n&&t(d),n&&t(m),M(c,n)}}}function Ab(G){let d,T;return d=new re({props:{code:`# To train a model on \`num_labels\` classes, you can pass \`num_labels=num_labels\` to \`.from_pretrained(...)\`
num_labels = len(model.config.id2label)
...
<span class="hljs-meta">... </span>)
<span class="hljs-meta">&gt;&gt;&gt; </span>loss = model(**inputs, labels=labels).loss
<span class="hljs-meta">&gt;&gt;&gt; </span>loss.backward()`}}),{c(){v(d.$$.fragment)},l(m){k(d.$$.fragment,m)},m(m,c){w(d,m,c),T=!0},p:ae,i(m){T||($(d.$$.fragment,m),T=!0)},o(m){P(d.$$.fragment,m),T=!1},d(m){M(d,m)}}}function Wb(G){let d,T,m,c,g;return{c(){d=s("p"),T=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),m=s("code"),c=r("Module"),g=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(n){d=a(n,"P",{});var u=l(d);T=i(u,"Although the recipe for forward pass needs to be defined within this function, one should call the "),m=a(u,"CODE",{});var j=l(m);c=i(j,"Module"),j.forEach(t),g=i(u,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
first positional argument :`),te=p(),z=s("ul"),q=s("li"),ie=r("a single Tensor with "),V=s("code"),fe=r("input_ids"),le=r(" only and nothing else: "),A=s("code"),be=r("model(inputs_ids)"),ge=p(),E=s("li"),ye=r(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),U=s("code"),B=r("model([input_ids, attention_mask])"),de=r(" or "),K=s("code"),ve=r("model([input_ids, attention_mask, token_type_ids])"),oe=p(),N=s("li"),ce=r(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),J=s("code"),ke=r('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(y){d=a(y,"P",{});var x=l(d);T=i(x,"TF 2.0 models accepts two formats as inputs:"),x.forEach(t),m=h(y),c=a(y,"UL",{});var ne=l(c);g=a(ne,"LI",{});var Ee=l(g);n=i(Ee,"having all inputs as keyword arguments (like PyTorch models), or"),Ee.forEach(t),u=h(ne),j=a(ne,"LI",{});var Ae=l(j);Q=i(Ae,"having all inputs as a list, tuple or dict in the first positional arguments."),Ae.forEach(t),ne.forEach(t),C=h(y),F=a(y,"P",{});var H=l(F);R=i(H,"This second option is useful when using "),I=a(H,"CODE",{});var qe=l(I);Z=i(qe,"tf.keras.Model.fit"),qe.forEach(t),_e=i(H,` method which currently requires having all the
tensors in the first argument of the model call function: `),S=a(H,"CODE",{});var We=l(S);Te=i(We,"model(inputs)"),We.forEach(t),ue=i(H,"."),H.forEach(t),W=h(y),O=a(y,"P",{});var Ue=l(O);ee=i(Ue,`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),Ue.forEach(t),te=h(y),z=a(y,"UL",{});var D=l(z);q=a(D,"LI",{});var X=l(q);ie=i(X,"a single Tensor with "),V=a(X,"CODE",{});var Be=l(V);fe=i(Be,"input_ids"),Be.forEach(t),le=i(X," only and nothing else: "),A=a(X,"CODE",{});var Ce=l(A);be=i(Ce,"model(inputs_ids)"),Ce.forEach(t),X.forEach(t),ge=h(D),E=a(D,"LI",{});var Y=l(E);ye=i(Y,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),U=a(Y,"CODE",{});var Re=l(U);B=i(Re,"model([input_ids, attention_mask])"),Re.forEach(t),de=i(Y," or "),K=a(Y,"CODE",{});var De=l(K);ve=i(De,"model([input_ids, attention_mask, token_type_ids])"),De.forEach(t),Y.forEach(t),oe=h(D),N=a(D,"LI",{});var we=l(N);ce=i(we,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),J=a(we,"CODE",{});var Ve=l(J);ke=i(Ve,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),Ve.forEach(t),we.forEach(t),D.forEach(t)},m(y,x){_(y,d,x),e(d,T),_(y,m,x),_(y,c,x),e(c,g),e(g,n),e(c,u),e(c,j),e(j,Q),_(y,C,x),_(y,F,x),e(F,R),e(F,I),e(I,Z),e(F,_e),e(F,S),e(S,Te),e(F,ue),_(y,W,x),_(y,O,x),e(O,ee),_(y,te,x),_(y,z,x),e(z,q),e(q,ie),e(q,V),e(V,fe),e(q,le),e(q,A),e(A,be),e(z,ge),e(z,E),e(E,ye),e(E,U),e(U,B),e(E,de),e(E,K),e(K,ve),e(z,oe),e(z,N),e(N,ce),e(N,J),e(J,ke)},d(y){y&&t(d),y&&t(m),y&&t(c),y&&t(C),y&&t(F),y&&t(W),y&&t(O),y&&t(te),y&&t(z)}}}function Vb(G){let d,T,m,c,g;return{c(){d=s("p"),T=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),m=s("code"),c=r("Module"),g=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(n){d=a(n,"P",{});var u=l(d);T=i(u,"Although the recipe for forward pass needs to be defined within this function, one should call the "),m=a(u,"CODE",{});var j=l(m);c=i(j,"Module"),j.forEach(t),g=i(u,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),{c(){d=s("p"),T=r("Example:"),m=p(),v(c.$$.fragment)},l(n){d=a(n,"P",{});var u=l(d);T=i(u,"Example:"),u.forEach(t),m=h(n),k(c.$$.fragment,n)},m(n,u){_(n,d,u),e(d,T),_(n,m,u),w(c,n,u),g=!0},p:ae,i(n){g||($(c.$$.fragment,n),g=!0)},o(n){P(c.$$.fragment,n),g=!1},d(n){n&&t(d),n&&t(m),M(c,n)}}}function Jb(G){let d,T,m,c,g,n,u,j,Q,C,F,R,I,Z,_e,S,Te,ue,W,O,ee,te,z,q,ie,V,fe,le,A,be,ge,E,ye,U,B,de,K,ve,oe,N,ce,J,ke;return{c(){d=s("p"),T=r("TF 2.0 models accepts two formats as inputs:"),m=p(),c=s("ul"),g=s("li"),n=r("having all inputs as keyword arguments (like PyTorch models), or"),u=p(),j=s("li"),Q=r("having all inputs as a list, tuple or dict in the first positional arguments."),C=p(),F=s("p"),R=r("This second option is useful when using "),I=s("code"),Z=r("tf.keras.Model.fit"),_e=r(` method which currently requires having all the
tensors in the first argument of the model call function: `),S=s("code"),Te=r("model(inputs)"),ue=r("."),W=p(),O=s("p"),ee=r(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),te=p(),z=s("ul"),q=s("li"),ie=r("a single Tensor with "),V=s("code"),fe=r("input_ids"),le=r(" only and nothing else: "),A=s("code"),be=r("model(inputs_ids)"),ge=p(),E=s("li"),ye=r(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),U=s("code"),B=r("model([input_ids, attention_mask])"),de=r(" or "),K=s("code"),ve=r("model([input_ids, attention_mask, token_type_ids])"),oe=p(),N=s("li"),ce=r(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),J=s("code"),ke=r('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(y){d=a(y,"P",{});var x=l(d);T=i(x,"TF 2.0 models accepts two formats as inputs:"),x.forEach(t),m=h(y),c=a(y,"UL",{});var ne=l(c);g=a(ne,"LI",{});var Ee=l(g);n=i(Ee,"having all inputs as keyword arguments (like PyTorch models), or"),Ee.forEach(t),u=h(ne),j=a(ne,"LI",{});var Ae=l(j);Q=i(Ae,"having all inputs as a list, tuple or dict in the first positional arguments."),Ae.forEach(t),ne.forEach(t),C=h(y),F=a(y,"P",{});var H=l(F);R=i(H,"This second option is useful when using "),I=a(H,"CODE",{});var qe=l(I);Z=i(qe,"tf.keras.Model.fit"),qe.forEach(t),_e=i(H,` method which currently requires having all the
...
first positional argument :`),Ue.forEach(t),te=h(y),z=a(y,"UL",{});var D=l(z);q=a(D,"LI",{});var X=l(q);ie=i(X,"a single Tensor with "),V=a(X,"CODE",{});var Be=l(V);fe=i(Be,"input_ids"),Be.forEach(t),le=i(X," only and nothing else: "),A=a(X,"CODE",{});var Ce=l(A);be=i(Ce,"model(inputs_ids)"),Ce.forEach(t),X.forEach(t),ge=h(D),E=a(D,"LI",{});var Y=l(E);ye=i(Y,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),U=a(Y,"CODE",{});var Re=l(U);B=i(Re,"model([input_ids, attention_mask])"),Re.forEach(t),de=i(Y," or "),K=a(Y,"CODE",{});var De=l(K);ve=i(De,"model([input_ids, attention_mask, token_type_ids])"),De.forEach(t),Y.forEach(t),oe=h(D),N=a(D,"LI",{});var we=l(N);ce=i(we,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),J=a(we,"CODE",{});var Ve=l(J);ke=i(Ve,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),Ve.forEach(t),we.forEach(t),D.forEach(t)},m(y,x){_(y,d,x),e(d,T),_(y,m,x),_(y,c,x),e(c,g),e(g,n),e(c,u),e(c,j),e(j,Q),_(y,C,x),_(y,F,x),e(F,R),e(F,I),e(I,Z),e(F,_e),e(F,S),e(S,Te),e(F,ue),_(y,W,x),_(y,O,x),e(O,ee),_(y,te,x),_(y,z,x),e(z,q),e(q,ie),e(q,V),e(V,fe),e(q,le),e(q,A),e(A,be),e(z,ge),e(z,E),e(E,ye),e(E,U),e(U,B),e(E,de),e(E,K),e(K,ve),e(z,oe),e(z,N),e(N,ce),e(N,J),e(J,ke)},d(y){y&&t(d),y&&t(m),y&&t(c),y&&t(C),y&&t(F),y&&t(W),y&&t(O),y&&t(te),y&&t(z)}}}function Xb(G){let d,T,m,c,g;return{c(){d=s("p"),T=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),m=s("code"),c=r("Module"),g=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(n){d=a(n,"P",{});var u=l(d);T=i(u,"Although the recipe for forward pass needs to be defined within this function, one should call the "),m=a(u,"CODE",{});var j=l(m);c=i(j,"Module"),j.forEach(t),g=i(u,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
<span class="hljs-meta">&gt;&gt;&gt; </span>inputs = tokenizer(<span class="hljs-string">&quot;Hello, my dog is cute&quot;</span>, return_tensors=<span class="hljs-string">&quot;tf&quot;</span>)
<span class="hljs-meta">&gt;&gt;&gt; </span>outputs = model(inputs)
<span class="hljs-meta">&gt;&gt;&gt; </span>logits = outputs.logits`}}),{c(){d=s("p"),T=r("Example:"),m=p(),v(c.$$.fragment)},l(n){d=a(n,"P",{});var u=l(d);T=i(u,"Example:"),u.forEach(t),m=h(n),k(c.$$.fragment,n)},m(n,u){_(n,d,u),e(d,T),_(n,m,u),w(c,n,u),g=!0},p:ae,i(n){g||($(c.$$.fragment,n),g=!0)},o(n){P(c.$$.fragment,n),g=!1},d(n){n&&t(d),n&&t(m),M(c,n)}}}function Qb(G){let d,T,m,c,g,n,u,j,Q,C,F,R,I,Z,_e,S,Te,ue,W,O,ee,te,z,q,ie,V,fe,le,A,be,ge,E,ye,U,B,de,K,ve,oe,N,ce,J,ke;return{c(){d=s("p"),T=r("TF 2.0 models accepts two formats as inputs:"),m=p(),c=s("ul"),g=s("li"),n=r("having all inputs as keyword arguments (like PyTorch models), or"),u=p(),j=s("li"),Q=r("having all inputs as a list, tuple or dict in the first positional arguments."),C=p(),F=s("p"),R=r("This second option is useful when using "),I=s("code"),Z=r("tf.keras.Model.fit"),_e=r(` method which currently requires having all the
tensors in the first argument of the model call function: `),S=s("code"),Te=r("model(inputs)"),ue=r("."),W=p(),O=s("p"),ee=r(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),te=p(),z=s("ul"),q=s("li"),ie=r("a single Tensor with "),V=s("code"),fe=r("input_ids"),le=r(" only and nothing else: "),A=s("code"),be=r("model(inputs_ids)"),ge=p(),E=s("li"),ye=r(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),U=s("code"),B=r("model([input_ids, attention_mask])"),de=r(" or "),K=s("code"),ve=r("model([input_ids, attention_mask, token_type_ids])"),oe=p(),N=s("li"),ce=r(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),J=s("code"),ke=r('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(y){d=a(y,"P",{});var x=l(d);T=i(x,"TF 2.0 models accepts two formats as inputs:"),x.forEach(t),m=h(y),c=a(y,"UL",{});var ne=l(c);g=a(ne,"LI",{});var Ee=l(g);n=i(Ee,"having all inputs as keyword arguments (like PyTorch models), or"),Ee.forEach(t),u=h(ne),j=a(ne,"LI",{});var Ae=l(j);Q=i(Ae,"having all inputs as a list, tuple or dict in the first positional arguments."),Ae.forEach(t),ne.forEach(t),C=h(y),F=a(y,"P",{});var H=l(F);R=i(H,"This second option is useful when using "),I=a(H,"CODE",{});var qe=l(I);Z=i(qe,"tf.keras.Model.fit"),qe.forEach(t),_e=i(H,` method which currently requires having all the
...
first positional argument :`),Ue.forEach(t),te=h(y),z=a(y,"UL",{});var D=l(z);q=a(D,"LI",{});var X=l(q);ie=i(X,"a single Tensor with "),V=a(X,"CODE",{});var Be=l(V);fe=i(Be,"input_ids"),Be.forEach(t),le=i(X," only and nothing else: "),A=a(X,"CODE",{});var Ce=l(A);be=i(Ce,"model(inputs_ids)"),Ce.forEach(t),X.forEach(t),ge=h(D),E=a(D,"LI",{});var Y=l(E);ye=i(Y,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),U=a(Y,"CODE",{});var Re=l(U);B=i(Re,"model([input_ids, attention_mask])"),Re.forEach(t),de=i(Y," or "),K=a(Y,"CODE",{});var De=l(K);ve=i(De,"model([input_ids, attention_mask, token_type_ids])"),De.forEach(t),Y.forEach(t),oe=h(D),N=a(D,"LI",{});var we=l(N);ce=i(we,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),J=a(we,"CODE",{});var Ve=l(J);ke=i(Ve,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),Ve.forEach(t),we.forEach(t),D.forEach(t)},m(y,x){_(y,d,x),e(d,T),_(y,m,x),_(y,c,x),e(c,g),e(g,n),e(c,u),e(c,j),e(j,Q),_(y,C,x),_(y,F,x),e(F,R),e(F,I),e(I,Z),e(F,_e),e(F,S),e(S,Te),e(F,ue),_(y,W,x),_(y,O,x),e(O,ee),_(y,te,x),_(y,z,x),e(z,q),e(q,ie),e(q,V),e(V,fe),e(q,le),e(q,A),e(A,be),e(z,ge),e(z,E),e(E,ye),e(E,U),e(U,B),e(E,de),e(E,K),e(K,ve),e(z,oe),e(z,N),e(N,ce),e(N,J),e(J,ke)},d(y){y&&t(d),y&&t(m),y&&t(c),y&&t(C),y&&t(F),y&&t(W),y&&t(O),y&&t(te),y&&t(z)}}}function Zb(G){let d,T,m,c,g;return{c(){d=s("p"),T=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),m=s("code"),c=r("Module"),g=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(n){d=a(n,"P",{});var u=l(d);T=i(u,"Although the recipe for forward pass needs to be defined within this function, one should call the "),m=a(u,"CODE",{});var j=l(m);c=i(j,"Module"),j.forEach(t),g=i(u,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),u.forEach(t)},m(n,u){_(n,d,u),e(d,T),e(d,m),e(m,c),e(d,g)},d(n){n&&t(d)}}}function ey(G){let d,T,m,c,g;return c=new re({props:{code:`import tensorflow as tf
...
<span class="hljs-meta">&gt;&gt;&gt; </span>outputs = model(input_ids, mc_token_ids=mc_token_ids)
<span class="hljs-meta">&gt;&gt;&gt; </span>lm_prediction_scores, mc_prediction_scores = outputs[:<span class="hljs-number">2</span>]`}}),{c(){d=s("p"),T=r("Examples:"),m=p(),v(c.$$.fragment)},l(n){d=a(n,"P",{});var u=l(d);T=i(u,"Examples:"),u.forEach(t),m=h(n),k(c.$$.fragment,n)},m(n,u){_(n,d,u),e(d,T),_(n,m,u),w(c,n,u),g=!0},p:ae,i(n){g||($(c.$$.fragment,n),g=!0)},o(n){P(c.$$.fragment,n),g=!1},d(n){n&&t(d),n&&t(m),M(c,n)}}}function ty(G){let d,T,m,c,g,n,u,j,Q,C,F,R,I,Z,_e,S,Te,ue,W,O,ee,te,z,q,ie,V,fe,le,A,be,ge,E,ye,U,B,de,K,ve,oe,N,ce,J,ke;return{c(){d=s("p"),T=r("TF 2.0 models accepts two formats as inputs:"),m=p(),c=s("ul"),g=s("li"),n=r("having all inputs as keyword arguments (like PyTorch models), or"),u=p(),j=s("li"),Q=r("having all inputs as a list, tuple or dict in the first positional arguments."),C=p(),F=s("p"),R=r("This second option is useful when using "),I=s("code"),Z=r("tf.keras.Model.fit"),_e=r(` method which currently requires having all the
tensors in the first argument of the model call function: `),S=s("code"),Te=r("model(inputs)"),ue=r("."),W=p(),O=s("p"),ee=r(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),te=p(),z=s("ul"),q=s("li"),ie=r("a single Tensor with "),V=s("code"),fe=r("input_ids"),le=r(" only and nothing else: "),A=s("code"),be=r("model(inputs_ids)"),ge=p(),E=s("li"),ye=r(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),U=s("code"),B=r("model([input_ids, attention_mask])"),de=r(" or "),K=s("code"),ve=r("model([input_ids, attention_mask, token_type_ids])"),oe=p(),N=s("li"),ce=r(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),J=s("code"),ke=r('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(y){d=a(y,"P",{});var x=l(d);T=i(x,"TF 2.0 models accepts two formats as inputs:"),x.forEach(t),m=h(y),c=a(y,"UL",{});var ne=l(c);g=a(ne,"LI",{});var Ee=l(g);n=i(Ee,"having all inputs as keyword arguments (like PyTorch models), or"),Ee.forEach(t),u=h(ne),j=a(ne,"LI",{});var Ae=l(j);Q=i(Ae,"having all inputs as a list, tuple or dict in the first positional arguments."),Ae.forEach(t),ne.forEach(t),C=h(y),F=a(y,"P",{});var H=l(F);R=i(H,"This second option is useful when using "),I=a(H,"CODE",{});var qe=l(I);Z=i(qe,"tf.keras.Model.fit"),qe.forEach(t),_e=i(H,` method which currently requires having all the
...
first positional argument :`),Ue.forEach(t),te=h(y),z=a(y,"UL",{});var D=l(z);q=a(D,"LI",{});var X=l(q);ie=i(X,"a single Tensor with "),V=a(X,"CODE",{});var Be=l(V);fe=i(Be,"input_ids"),Be.forEach(t),le=i(X," only and nothing else: "),A=a(X,"CODE",{});var Ce=l(A);be=i(Ce,"model(inputs_ids)"),Ce.forEach(t),X.forEach(t),ge=h(D),E=a(D,"LI",{});var Y=l(E);ye=i(Y,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),U=a(Y,"CODE",{});var Re=l(U);B=i(Re,"model([input_ids, attention_mask])"),Re.forEach(t),de=i(Y," or "),K=a(Y,"CODE",{});var De=l(K);ve=i(De,"model([input_ids, attention_mask, token_type_ids])"),De.forEach(t),Y.forEach(t),oe=h(D),N=a(D,"LI",{});var we=l(N);ce=i(we,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),J=a(we,"CODE",{});var Ve=l(J);ke=i(Ve,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),Ve.forEach(t),we.forEach(t),D.forEach(t)},m(y,x){_(y,d,x),e(d,T),_(y,m,x),_(y,c,x),e(c,g),e(g,n),e(c,u),e(c,j),e(j,Q),_(y,C,x),_(y,F,x),e(F,R),e(F,I),e(I,Z),e(F,_e),e(F,S),e(S,Te),e(F,ue),_(y,W,x),_(y,O,x),e(O,ee),_(y,te,x),_(y,z,x),e(z,q),e(q,ie),e(q,V),e(V,fe),e(q,le),e(q,A),e(A,be),e(z,ge),e(z,E),e(E,ye),e(E,U),e(U,B),e(E,de),e(E,K),e(K,ve),e(z,oe),e(z,N),e(N,ce),e(N,J),e(J,ke)},d(y){y&&t(d),y&&t(m),y&&t(c),y&&t(C),y&&t(F),y&&t(W),y&&t(O),y&&t(te),y&&t(z)}}}function oy(G){let d,T,m,c,g;return{c(){d=s("p"),T=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),m=s("code"),c=r("Module"),g=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(n){d=a(n,"P",{});var u=l(d);T=i(u,"Although the recipe for forward pass needs to be defined within this function, one should call the "),m=a(u,"CODE",{});var j=l(m);c=i(j,"Module"),j.forEach(t),g=i(u,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),u.forEach(t)},m(n,u){_(n,d,u),e(d,T),e(d,m),e(m,c),e(d,g)},d(n){n&&t(d)}}}function ny(G){let d,T,m,c,g;return c=new re({props:{code:`from transformers import GPT2Tokenizer, TFGPT2ForSequenceClassification
import tensorflow as tf
...
<span class="hljs-meta">&gt;&gt;&gt; </span>model.config.id2label[predicted_class_id]
`}}),{c(){d=s("p"),T=r("Example:"),m=p(),v(c.$$.fragment)},l(n){d=a(n,"P",{});var u=l(d);T=i(u,"Example:"),u.forEach(t),m=h(n),k(c.$$.fragment,n)},m(n,u){_(n,d,u),e(d,T),_(n,m,u),w(c,n,u),g=!0},p:ae,i(n){g||($(c.$$.fragment,n),g=!0)},o(n){P(c.$$.fragment,n),g=!1},d(n){n&&t(d),n&&t(m),M(c,n)}}}function sy(G){let d,T;return d=new re({props:{code:`# To train a model on \`num_labels\` classes, you can pass \`num_labels=num_labels\` to \`.from_pretrained(...)\`
num_labels = len(model.config.id2label)
...
`}}),{c(){v(d.$$.fragment)},l(m){k(d.$$.fragment,m)},m(m,c){w(d,m,c),T=!0},p:ae,i(m){T||($(d.$$.fragment,m),T=!0)},o(m){P(d.$$.fragment,m),T=!1},d(m){M(d,m)}}}function ay(G){let d,T,m,c,g;return{c(){d=s("p"),T=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),m=s("code"),c=r("Module"),g=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(n){d=a(n,"P",{});var u=l(d);T=i(u,"Although the recipe for forward pass needs to be defined within this function, one should call the "),m=a(u,"CODE",{});var j=l(m);c=i(j,"Module"),j.forEach(t),g=i(u,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),u.forEach(t)},m(n,u){_(n,d,u),e(d,T),e(d,m),e(m,c),e(d,g)},d(n){n&&t(d)}}}function ry(G){let d,T,m,c,g;return c=new re({props:{code:`from transformers import GPT2Tokenizer, FlaxGPT2Model
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),{c(){d=s("p"),T=r("Example:"),m=p(),v(c.$$.fragment)},l(n){d=a(n,"P",{});var u=l(d);T=i(u,"Example:"),u.forEach(t),m=h(n),k(c.$$.fragment,n)},m(n,u){_(n,d,u),e(d,T),_(n,m,u),w(c,n,u),g=!0},p:ae,i(n){g||($(c.$$.fragment,n),g=!0)},o(n){P(c.$$.fragment,n),g=!1},d(n){n&&t(d),n&&t(m),M(c,n)}}}function iy(G){let d,T,m,c,g;return{c(){d=s("p"),T=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),m=s("code"),c=r("Module"),g=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(n){d=a(n,"P",{});var u=l(d);T=i(u,"Although the recipe for forward pass needs to be defined within this function, one should call the "),m=a(u,"CODE",{});var j=l(m);c=i(j,"Module"),j.forEach(t),g=i(u,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),u.forEach(t)},m(n,u){_(n,d,u),e(d,T),e(d,m),e(m,c),e(d,g)},d(n){n&&t(d)}}}function ly(G){let d,T,m,c,g;return c=new re({props:{code:`from transformers import GPT2Tokenizer, FlaxGPT2LMHeadModel
...
<span class="hljs-meta">&gt;&gt;&gt; </span>next_token_logits = outputs.logits[:, -<span class="hljs-number">1</span>]`}}),{c(){d=s("p"),T=r("Example:"),m=p(),v(c.$$.fragment)},l(n){d=a(n,"P",{});var u=l(d);T=i(u,"Example:"),u.forEach(t),m=h(n),k(c.$$.fragment,n)},m(n,u){_(n,d,u),e(d,T),_(n,m,u),w(c,n,u),g=!0},p:ae,i(n){g||($(c.$$.fragment,n),g=!0)},o(n){P(c.$$.fragment,n),g=!1},d(n){n&&t(d),n&&t(m),M(c,n)}}}function dy(G){let d,T,m,c,g,n,u,j,Q,C,F,R,I,Z,_e,S,Te,ue,W,O,ee,te,z,q,ie,V,fe,le,A,be,ge,E,ye,U,B,de,K,ve,oe,N,ce,J,ke,y,x,ne,Ee,Ae,H,qe,We,Ue,D,X,Be,Ce,Y,Re,De,we,Ve,za,hc,mc,$r,uc,fc,Ea,gc,_c,Tc,vt,bc,Pr,yc,vc,Mr,kc,wc,Cn,$c,Pc,Hl,Lt,Dn,Mc,Gc,Gr,xc,jc,Il,Gt,Fc,Ln,zc,Ec,On,qc,Cc,Sl,Ot,go,xr,Nn,Dc,jr,Lc,Al,at,Hn,Oc,kt,Nc,qa,Hc,Ic,Ca,Sc,Ac,In,Wc,Uc,Bc,Nt,Rc,Da,Vc,Kc,La,Jc,Xc,Yc,_o,Wl,Ht,To,Fr,Sn,Qc,zr,Zc,Ul,pe,An,ep,Er,tp,op,qr,np,sp,bo,ap,Wn,rp,Cr,ip,lp,dp,yo,cp,Un,pp,Oa,hp,mp,up,Na,Bn,Bl,It,vo,Dr,Rn,fp,Lr,gp,Rl,$e,Vn,_p,Kn,Tp,Or,bp,yp,vp,Nr,kp,wp,ko,$p,Jn,Pp,Hr,Mp,Gp,xp,wo,jp,Xn,Fp,Ha,zp,Ep,Vl,St,$o,Ir,Yn,qp,Sr,Cp,Kl,At,Qn,Dp,Ar,Lp,Jl,Wt,Zn,Op,Wr,Np,Xl,Ut,Po,Ur,es,Hp,Br,Ip,Yl,Pe,ts,Sp,Rr,Ap,Wp,os,Up,Ia,Bp,Rp,Vp,ns,Kp,ss,Jp,Xp,Yp,lt,as,Qp,Bt,Zp,Sa,eh,th,Vr,oh,nh,sh,Mo,ah,Go,rh,dt,rs,ih,Kr,lh,dh,Jr,ch,ph,xo,hh,xt,is,mh,Xr,uh,fh,jo,Ql,Rt,Fo,Yr,ls,gh,Qr,_h,Zl,Me,ds,Th,Zr,bh,yh,cs,vh,Aa,kh,wh,$h,ps,Ph,hs,Mh,Gh,xh,ct,ms,jh,Vt,Fh,Wa,zh,Eh,ei,qh,Ch,Dh,zo,Lh,Eo,Oh,pt,us,Nh,ti,Hh,Ih,oi,Sh,Ah,qo,Wh,jt,fs,Uh,ni,Bh,Rh,Co,ed,Kt,Do,si,gs,Vh,ai,Kh,td,Ke,_s,Jh,ri,Xh,Yh,Ts,Qh,Ua,Zh,em,tm,bs,om,ys,nm,sm,am,ht,vs,rm,Jt,im,Ba,lm,dm,ii,cm,pm,hm,Lo,mm,Oo,od,Xt,No,li,ks,um,di,fm,nd,Ge,ws,gm,ci,_m,Tm,Ra,Va,bm,ym,vm,rt,km,pi,wm,$m,hi,Pm,Mm,mi,Gm,xm,ui,jm,Fm,zm,$s,Em,Ka,qm,Cm,Dm,Ps,Lm,Ms,Om,Nm,Hm,Fe,Gs,Im,Yt,Sm,Ja,Am,Wm,fi,Um,Bm,Rm,Ho,Vm,Io,Km,So,Jm,Ao,Xm,Wo,sd,Qt,Uo,gi,xs,Ym,_i,Qm,ad,Je,js,Zm,Ti,eu,tu,Fs,ou,Xa,nu,su,au,zs,ru,Es,iu,lu,du,Xe,qs,cu,Zt,pu,Ya,hu,mu,bi,uu,fu,gu,Bo,_u,Ro,Tu,Vo,rd,eo,Ko,yi,Cs,bu,vi,yu,id,Le,Ds,vu,ki,ku,wu,Ls,$u,Qa,Pu,Mu,Gu,Os,xu,Ns,ju,Fu,zu,Jo,Eu,mt,Hs,qu,to,Cu,Za,Du,Lu,wi,Ou,Nu,Hu,Xo,Iu,Yo,ld,oo,Qo,$i,Is,Su,Pi,Au,dd,Oe,Ss,Wu,Mi,Uu,Bu,As,Ru,er,Vu,Ku,Ju,Ws,Xu,Us,Yu,Qu,Zu,Zo,ef,ut,Bs,tf,no,of,tr,nf,sf,Gi,af,rf,lf,en,df,tn,cd,so,on,xi,Rs,cf,ji,pf,pd,Ne,Vs,hf,Fi,mf,uf,Ks,ff,or,gf,_f,Tf,Js,bf,Xs,yf,vf,kf,nn,wf,ft,Ys,$f,ao,Pf,nr,Mf,Gf,zi,xf,jf,Ff,sn,zf,an,hd,ro,rn,Ei,Qs,Ef,qi,qf,md,he,Zs,Cf,Ci,Df,Lf,sr,ar,Of,Nf,Hf,it,If,Di,Sf,Af,Li,Wf,Uf,Oi,Bf,Rf,Ni,Vf,Kf,Jf,ea,Xf,rr,Yf,Qf,Zf,ta,eg,oa,tg,og,ng,ln,sg,Ye,na,ag,io,rg,ir,ig,lg,Hi,dg,cg,pg,dn,hg,cn,mg,pn,ud,lo,hn,Ii,sa,ug,Si,fg,fd,co,aa,gg,Ai,_g,gd,po,mn,Wi,ra,Tg,Ui,bg,_d,xe,ia,yg,Bi,vg,kg,la,wg,lr,$g,Pg,Mg,da,Gg,ca,xg,jg,Fg,Ri,zg,Eg,wt,Vi,pa,qg,Cg,Ki,ha,Dg,Lg,Ji,ma,Og,Ng,Xi,ua,Hg,Ig,gt,fa,Sg,ho,Ag,Yi,Wg,Ug,Qi,Bg,Rg,Vg,un,Kg,fn,Td,mo,gn,Zi,ga,Jg,el,Xg,bd,je,_a,Yg,tl,Qg,Zg,Ta,e_,dr,t_,o_,n_,ba,s_,ya,a_,r_,i_,ol,l_,d_,$t,nl,va,c_,p_,sl,ka,h_,m_,al,wa,u_,f_,rl,$a,g_,__,_t,Pa,T_,uo,b_,il,y_,v_,ll,k_,w_,$_,_n,P_,Tn,yd;return n=new ze({}),Z=new ze({}),Nn=new ze({}),Hn=new L({props:{name:"class transformers.GPT2Config",anchor:"transformers.GPT2Config",parameters:[{name:"vocab_size",val:" = 50257"},{name:"n_positions",val:" = 1024"},{name:"n_embd",val:" = 768"},{name:"n_layer",val:" = 12"},{name:"n_head",val:" = 12"},{name:"n_inner",val:" = None"},{name:"activation_function",val:" = 'gelu_new'"},{name:"resid_pdrop",val:" = 0.1"},{name:"embd_pdrop",val:" = 0.1"},{name:"attn_pdrop",val:" = 0.1"},{name:"layer_norm_epsilon",val:" = 1e-05"},{name:"initializer_range",val:" = 0.02"},{name:"summary_type",val:" = 'cls_index'"},{name:"summary_use_proj",val:" = True"},{name:"summary_activation",val:" = None"},{name:"summary_proj_to_labels",val:" = True"},{name:"summary_first_dropout",val:" = 0.1"},{name:"scale_attn_weights",val:" = True"},{name:"use_cache",val:" = True"},{name:"bos_token_id",val:" = 50256"},{name:"eos_token_id",val:" = 50256"},{name:"scale_attn_by_inverse_layer_idx",val:" = False"},{name:"reorder_and_upcast_attn",val:" = False"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.GPT2Config.vocab_size",description:`<strong>vocab_size</strong> (<code>int</code>, <em>optional</em>, defaults to 50257) &#x2014;
...
other word. (GPT2 tokenizer detect beginning of words by the preceding space).`,name:"add_prefix_space"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/gpt2/tokenization_gpt2.py#L104"}}),bo=new se({props:{anchor:"transformers.GPT2Tokenizer.example",$$slots:{default:[$b]},$$scope:{ctx:G}}}),yo=new He({props:{$$slots:{default:[Pb]},$$scope:{ctx:G}}}),Bn=new L({props:{name:"save_vocabulary",anchor:"transformers.GPT2Tokenizer.save_vocabulary",parameters:[{name:"save_directory",val:": str"},{name:"filename_prefix",val:": typing.Optional[str] = None"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/gpt2/tokenization_gpt2.py#L288"}}),Rn=new ze({}),Vn=new L({props:{name:"class transformers.GPT2TokenizerFast",anchor:"transformers.GPT2TokenizerFast",parameters:[{name:"vocab_file",val:" = None"},{name:"merges_file",val:" = None"},{name:"tokenizer_file",val:" = None"},{name:"unk_token",val:" = '<|endoftext|>'"},{name:"bos_token",val:" = '<|endoftext|>'"},{name:"eos_token",val:" = '<|endoftext|>'"},{name:"add_prefix_space",val:" = False"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.GPT2TokenizerFast.vocab_file",description:`<strong>vocab_file</strong> (<code>str</code>) &#x2014;
...
Whether or not to return a <a href="/docs/transformers/main/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/gpt2/modeling_gpt2.py#L746",returnDescription:`
<p>A <a
...
are ignored (masked), the loss is only computed for labels in <code>[0, ..., config.vocab_size]</code>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/gpt2/modeling_gpt2.py#L1024",returnDescription:`
<p>A <a
...
<li>gpt2-large: 36</li>
<li>gpt2-xl: 48</li>
</ul>`,name:"device_map"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/gpt2/modeling_gpt2.py#L970"}}),qo=new se({props:{anchor:"transformers.GPT2LMHeadModel.parallelize.example",$$slots:{default:[Cb]},$$scope:{ctx:G}}}),fs=new L({props:{name:"deparallelize",anchor:"transformers.GPT2LMHeadModel.deparallelize",parameters:[],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/gpt2/modeling_gpt2.py#L982"}}),Co=new se({props:{anchor:"transformers.GPT2LMHeadModel.deparallelize.example",$$slots:{default:[Db]},$$scope:{ctx:G}}}),gs=new ze({}),_s=new L({props:{name:"class transformers.GPT2DoubleHeadsModel",anchor:"transformers.GPT2DoubleHeadsModel",parameters:[{name:"config",val:""}],parametersDescription:[{anchor:"transformers.GPT2DoubleHeadsModel.config",description:`<strong>config</strong> (<a href="/docs/transformers/main/en/model_doc/gpt2#transformers.GPT2Config">GPT2Config</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/main/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/gpt2/modeling_gpt2.py#L1124"}}),vs=new L({props:{name:"forward",anchor:"transformers.GPT2DoubleHeadsModel.forward",parameters:[{name:"input_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"past_key_values",val:": typing.Optional[typing.Tuple[typing.Tuple[torch.Tensor]]] = None"},{name:"attention_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"token_type_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"position_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"head_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"mc_token_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"labels",val:": typing.Optional[torch.LongTensor] = None"},{name:"mc_labels",val:": typing.Optional[torch.LongTensor] = None"},{name:"use_cache",val:": typing.Optional[bool] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.GPT2DoubleHeadsModel.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, input_ids_length)</code>) &#x2014;
<code>input_ids_length</code> = <code>sequence_length</code> if <code>past_key_values</code> is <code>None</code> else
<code>past_key_values[0][0].shape[-2]</code> (<code>sequence_length</code> of input past key value states). Indices of input
sequence tokens in the vocabulary.</p>
<p>If <code>past_key_values</code> is used, only <code>input_ids</code> that do not have their past calculated should be passed as
...
where <em>num_choices</em> is the size of the second dimension of the input tensors. (see <em>input_ids</em> above)`,name:"mc_labels"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/gpt2/modeling_gpt2.py#L1198",returnDescription:`
<p>A <a
...
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/gpt2/modeling_gpt2.py#L1354",returnDescription:`
...
Labels for computing the sequence classification/regression loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>. If <code>config.num_labels == 1</code> a regression loss is computed (Mean-Square loss), If
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/gpt2/modeling_gpt2.py#L1488",returnDescription:`
<p>A <a
...
If set to <code>True</code>, <code>past_key_values</code> key value states are returned and can be used to speed up decoding (see
<code>past</code>). Set to <code>False</code> during training, <code>True</code> during generation`,name:"use_cache"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/gpt2/modeling_tf_gpt2.py#L712",returnDescription:`
<p>A <a
...
Labels for computing the cross entropy classification loss. Indices should be in <code>[0, ..., config.vocab_size - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/gpt2/modeling_tf_gpt2.py#L897",returnDescription:`
<p>A <a
...
Index of the classification token in each input sequence. Selected in the range <code>[0, input_ids.size(-1) - 1[</code>.`,name:"mc_token_ids"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/gpt2/modeling_tf_gpt2.py#L1021",returnDescription:`
<p>A <a
...
Labels for computing the cross entropy classification loss. Indices should be in <code>[0, ..., config.vocab_size - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/gpt2/modeling_tf_gpt2.py#L1172",returnDescription:`
<p>A <a
...
`}}),dn=new He({props:{$$slots:{default:[oy]},$$scope:{ctx:G}}}),cn=new se({props:{anchor:"transformers.TFGPT2ForSequenceClassification.call.example",$$slots:{default:[ny]},$$scope:{ctx:G}}}),pn=new se({props:{anchor:"transformers.TFGPT2ForSequenceClassification.call.example-2",$$slots:{default:[sy]},$$scope:{ctx:G}}}),sa=new ze({}),aa=new L({props:{name:"class transformers.modeling_tf_outputs.TFSequenceClassifierOutputWithPast",anchor:"transformers.modeling_tf_outputs.TFSequenceClassifierOutputWithPast",parameters:[{name:"loss",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"logits",val:": Tensor = None"},{name:"past_key_values",val:": typing.Optional[typing.List[tensorflow.python.framework.ops.Tensor]] = None"},{name:"hidden_states",val:": typing.Optional[typing.Tuple[tensorflow.python.framework.ops.Tensor]] = None"},{name:"attentions",val:": typing.Optional[typing.Tuple[tensorflow.python.framework.ops.Tensor]] = None"}],parametersDescription:[{anchor:"transformers.modeling_tf_outputs.TFSequenceClassifierOutputWithPast.loss",description:`<strong>loss</strong> (<code>tf.Tensor</code> of shape <code>(batch_size, )</code>, <em>optional</em>, returned when <code>labels</code> is provided) &#x2014;
...
`}}),_n=new He({props:{$$slots:{default:[iy]},$$scope:{ctx:G}}}),Tn=new se({props:{anchor:"transformers.FlaxGPT2LMHeadModel.__call__.example",$$slots:{default:[ly]},$$scope:{ctx:G}}}),{c(){d=s("meta"),T=p(),m=s("h1"),c=s("a"),g=s("span"),v(n.$$.fragment),u=p(),j=s("span"),Q=r("OpenAI GPT2"),C=p(),F=s("h2"),R=s("a"),I=s("span"),v(Z.$$.fragment),_e=p(),S=s("span"),Te=r("Overview"),ue=p(),W=s("p"),O=r("OpenAI GPT-2 model was proposed in "),ee=s("a"),te=r("Language Models are Unsupervised Multitask Learners"),z=r(` by Alec
...
10X the amount of data.`),ge=p(),E=s("p"),ye=r("Tips:"),U=p(),B=s("ul"),de=s("li"),K=r(`GPT-2 is a model with absolute position embeddings so it\u2019s usually advised to pad the inputs on the right rather than
the left.`),ve=p(),oe=s("li"),N=r(`GPT-2 was trained with a causal language modeling (CLM) objective and is therefore powerful at predicting the next
token in a sequence. Leveraging this feature allows GPT-2 to generate syntactically coherent text as it can be
observed in the `),ce=s("em"),J=r("run_generation.py"),ke=r(" example script."),y=p(),x=s("li"),ne=r("The model can take the "),Ee=s("em"),Ae=r("past_key_values"),H=r(" (for PyTorch) or "),qe=s("em"),We=r("past"),Ue=r(` (for TF) as input, which is the previously computed
...
`),Ea=s("a"),gc=r("TFGPT2Model.call()"),_c=r(" method for more information on its usage."),Tc=p(),vt=s("li"),bc=r("Enabling the "),Pr=s("em"),yc=r("scale_attn_by_inverse_layer_idx"),vc=r(" and "),Mr=s("em"),kc=r("reorder_and_upcast_attn"),wc=r(` flags will apply the training stability
...
documentation from `),La=s("a"),Jc=r("PretrainedConfig"),Xc=r(" for more information."),Yc=p(),v(_o.$$.fragment),Wl=p(),Ht=s("h2"),To=s("a"),Fr=s("span"),v(Sn.$$.fragment),Qc=p(),zr=s("span"),Zc=r("GPT2Tokenizer"),Ul=p(),pe=s("div"),v(An.$$.fragment),ep=p(),Er=s("p"),tp=r("Construct a GPT-2 tokenizer. Based on byte-level Byte-Pair-Encoding."),op=p(),qr=s("p"),np=r("This tokenizer has been trained to treat spaces like parts of the tokens (a bit like sentencepiece) so a word will"),sp=p(),v(bo.$$.fragment),ap=p(),Wn=s("p"),rp=r("You can get around that behavior by passing "),Cr=s("code"),ip=r("add_prefix_space=True"),lp=r(` when instantiating this tokenizer or when you
call it on some text, but since the model was not pretrained this way, it might yield a decrease in performance.`),dp=p(),v(yo.$$.fragment),cp=p(),Un=s("p"),pp=r("This tokenizer inherits from "),Oa=s("a"),hp=r("PreTrainedTokenizer"),mp=r(` which contains most of the main methods. Users should refer to
this superclass for more information regarding those methods.`),up=p(),Na=s("div"),v(Bn.$$.fragment),Bl=p(),It=s("h2"),vo=s("a"),Dr=s("span"),v(Rn.$$.fragment),fp=p(),Lr=s("span"),gp=r("GPT2TokenizerFast"),Rl=p(),$e=s("div"),v(Vn.$$.fragment),_p=p(),Kn=s("p"),Tp=r("Construct a \u201Cfast\u201D GPT-2 tokenizer (backed by HuggingFace\u2019s "),Or=s("em"),bp=r("tokenizers"),yp=r(` library). Based on byte-level
Byte-Pair-Encoding.`),vp=p(),Nr=s("p"),kp=r("This tokenizer has been trained to treat spaces like parts of the tokens (a bit like sentencepiece) so a word will"),wp=p(),v(ko.$$.fragment),$p=p(),Jn=s("p"),Pp=r("You can get around that behavior by passing "),Hr=s("code"),Mp=r("add_prefix_space=True"),Gp=r(` when instantiating this tokenizer, but since
the model was not pretrained this way, it might yield a decrease in performance.`),xp=p(),v(wo.$$.fragment),jp=p(),Xn=s("p"),Fp=r("This tokenizer inherits from "),Ha=s("a"),zp=r("PreTrainedTokenizerFast"),Ep=r(` which contains most of the main methods. Users should
refer to this superclass for more information regarding those methods.`),Vl=p(),St=s("h2"),$o=s("a"),Ir=s("span"),v(Yn.$$.fragment),qp=p(),Sr=s("span"),Cp=r("GPT2 specific outputs"),Kl=p(),At=s("div"),v(Qn.$$.fragment),Dp=p(),Ar=s("p"),Lp=r("Base class for outputs of models predicting if two sentences are consecutive or not."),Jl=p(),Wt=s("div"),v(Zn.$$.fragment),Op=p(),Wr=s("p"),Np=r("Base class for outputs of models predicting if two sentences are consecutive or not."),Xl=p(),Ut=s("h2"),Po=s("a"),Ur=s("span"),v(es.$$.fragment),Hp=p(),Br=s("span"),Ip=r("GPT2Model"),Yl=p(),Pe=s("div"),v(ts.$$.fragment),Sp=p(),Rr=s("p"),Ap=r("The bare GPT2 Model transformer outputting raw hidden-states without any specific head on top."),Wp=p(),os=s("p"),Up=r("This model inherits from "),Ia=s("a"),Bp=r("PreTrainedModel"),Rp=r(`. Check the superclass documentation for the generic methods the
...
and behavior.`),Yp=p(),lt=s("div"),v(as.$$.fragment),Qp=p(),Bt=s("p"),Zp=r("The "),Sa=s("a"),eh=r("GPT2Model"),th=r(" forward method, overrides the "),Vr=s("code"),oh=r("__call__"),nh=r(" special method."),sh=p(),v(Mo.$$.fragment),ah=p(),v(Go.$$.fragment),rh=p(),dt=s("div"),v(rs.$$.fragment),ih=p(),Kr=s("p"),lh=r("This is an experimental feature and is a subject to change at a moment\u2019s notice."),dh=p(),Jr=s("p"),ch=r(`Uses a device map to distribute attention modules of the model across several devices. If no device map is given,
it will evenly distribute blocks across all devices.`),ph=p(),v(xo.$$.fragment),hh=p(),xt=s("div"),v(is.$$.fragment),mh=p(),Xr=s("p"),uh=r("Moves the model to cpu from a model parallel state."),fh=p(),v(jo.$$.fragment),Ql=p(),Rt=s("h2"),Fo=s("a"),Yr=s("span"),v(ls.$$.fragment),gh=p(),Qr=s("span"),_h=r("GPT2LMHeadModel"),Zl=p(),Me=s("div"),v(ds.$$.fragment),Th=p(),Zr=s("p"),bh=r(`The GPT2 Model transformer with a language modeling head on top (linear layer with weights tied to the input
embeddings).`),yh=p(),cs=s("p"),vh=r("This model inherits from "),Aa=s("a"),kh=r("PreTrainedModel"),wh=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),$h=p(),ps=s("p"),Ph=r("This model is also a PyTorch "),hs=s("a"),Mh=r("torch.nn.Module"),Gh=r(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),xh=p(),ct=s("div"),v(ms.$$.fragment),jh=p(),Vt=s("p"),Fh=r("The "),Wa=s("a"),zh=r("GPT2LMHeadModel"),Eh=r(" forward method, overrides the "),ei=s("code"),qh=r("__call__"),Ch=r(" special method."),Dh=p(),v(zo.$$.fragment),Lh=p(),v(Eo.$$.fragment),Oh=p(),pt=s("div"),v(us.$$.fragment),Nh=p(),ti=s("p"),Hh=r("This is an experimental feature and is a subject to change at a moment\u2019s notice."),Ih=p(),oi=s("p"),Sh=r(`Uses a device map to distribute attention modules of the model across several devices. If no device map is given,
it will evenly distribute blocks across all devices.`),Ah=p(),v(qo.$$.fragment),Wh=p(),jt=s("div"),v(fs.$$.fragment),Uh=p(),ni=s("p"),Bh=r("Moves the model to cpu from a model parallel state."),Rh=p(),v(Co.$$.fragment),ed=p(),Kt=s("h2"),Do=s("a"),si=s("span"),v(gs.$$.fragment),Vh=p(),ai=s("span"),Kh=r("GPT2DoubleHeadsModel"),td=p(),Ke=s("div"),v(_s.$$.fragment),Jh=p(),ri=s("p"),Xh=r(`The GPT2 Model transformer with a language modeling and a multiple-choice classification head on top e.g. for
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),tm=p(),bs=s("p"),om=r("This model is also a PyTorch "),ys=s("a"),nm=r("torch.nn.Module"),sm=r(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),am=p(),ht=s("div"),v(vs.$$.fragment),rm=p(),Jt=s("p"),im=r("The "),Ba=s("a"),lm=r("GPT2DoubleHeadsModel"),dm=r(" forward method, overrides the "),ii=s("code"),cm=r("__call__"),pm=r(" special method."),hm=p(),v(Lo.$$.fragment),mm=p(),v(Oo.$$.fragment),od=p(),Xt=s("h2"),No=s("a"),li=s("span"),v(ks.$$.fragment),um=p(),di=s("span"),fm=r("GPT2ForSequenceClassification"),nd=p(),Ge=s("div"),v(ws.$$.fragment),gm=p(),ci=s("p"),_m=r("The GPT2 Model transformer with a sequence classification head on top (linear layer)."),Tm=p(),Ra=s("p"),Va=s("a"),bm=r("GPT2ForSequenceClassification"),ym=r(` uses the last token in order to do the classification, as other causal models
(e.g. GPT-1) do.`),vm=p(),rt=s("p"),km=r(`Since it does classification on the last token, it requires to know the position of the last token. If a
...
padding tokens when `),mi=s("code"),Gm=r("inputs_embeds"),xm=r(" are passed instead of "),ui=s("code"),jm=r("input_ids"),Fm=r(`, it does the same (take the last value in
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Hm=p(),Fe=s("div"),v(Gs.$$.fragment),Im=p(),Yt=s("p"),Sm=r("The "),Ja=s("a"),Am=r("GPT2ForSequenceClassification"),Wm=r(" forward method, overrides the "),fi=s("code"),Um=r("__call__"),Bm=r(" special method."),Rm=p(),v(Ho.$$.fragment),Vm=p(),v(Io.$$.fragment),Km=p(),v(So.$$.fragment),Jm=p(),v(Ao.$$.fragment),Xm=p(),v(Wo.$$.fragment),sd=p(),Qt=s("h2"),Uo=s("a"),gi=s("span"),v(xs.$$.fragment),Ym=p(),_i=s("span"),Qm=r("GPT2ForTokenClassification"),ad=p(),Je=s("div"),v(js.$$.fragment),Zm=p(),Ti=s("p"),eu=r(`GPT2 Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g. for
Named-Entity-Recognition (NER) tasks.`),tu=p(),Fs=s("p"),ou=r("This model inherits from "),Xa=s("a"),nu=r("PreTrainedModel"),su=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),au=p(),zs=s("p"),ru=r("This model is also a PyTorch "),Es=s("a"),iu=r("torch.nn.Module"),lu=r(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),du=p(),Xe=s("div"),v(qs.$$.fragment),cu=p(),Zt=s("p"),pu=r("The "),Ya=s("a"),hu=r("GPT2ForTokenClassification"),mu=r(" forward method, overrides the "),bi=s("code"),uu=r("__call__"),fu=r(" special method."),gu=p(),v(Bo.$$.fragment),_u=p(),v(Ro.$$.fragment),Tu=p(),v(Vo.$$.fragment),rd=p(),eo=s("h2"),Ko=s("a"),yi=s("span"),v(Cs.$$.fragment),bu=p(),vi=s("span"),yu=r("TFGPT2Model"),id=p(),Le=s("div"),v(Ds.$$.fragment),vu=p(),ki=s("p"),ku=r("The bare GPT2 Model transformer outputting raw hidden-states without any specific head on top."),wu=p(),Ls=s("p"),$u=r("This model inherits from "),Qa=s("a"),Pu=r("TFPreTrainedModel"),Mu=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Gu=p(),Os=s("p"),xu=r("This model is also a "),Ns=s("a"),ju=r("tf.keras.Model"),Fu=r(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),zu=p(),v(Jo.$$.fragment),Eu=p(),mt=s("div"),v(Hs.$$.fragment),qu=p(),to=s("p"),Cu=r("The "),Za=s("a"),Du=r("TFGPT2Model"),Lu=r(" forward method, overrides the "),wi=s("code"),Ou=r("__call__"),Nu=r(" special method."),Hu=p(),v(Xo.$$.fragment),Iu=p(),v(Yo.$$.fragment),ld=p(),oo=s("h2"),Qo=s("a"),$i=s("span"),v(Is.$$.fragment),Su=p(),Pi=s("span"),Au=r("TFGPT2LMHeadModel"),dd=p(),Oe=s("div"),v(Ss.$$.fragment),Wu=p(),Mi=s("p"),Uu=r(`The GPT2 Model transformer with a language modeling head on top (linear layer with weights tied to the input
embeddings).`),Bu=p(),As=s("p"),Ru=r("This model inherits from "),er=s("a"),Vu=r("TFPreTrainedModel"),Ku=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Ju=p(),Ws=s("p"),Xu=r("This model is also a "),Us=s("a"),Yu=r("tf.keras.Model"),Qu=r(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Zu=p(),v(Zo.$$.fragment),ef=p(),ut=s("div"),v(Bs.$$.fragment),tf=p(),no=s("p"),of=r("The "),tr=s("a"),nf=r("TFGPT2LMHeadModel"),sf=r(" forward method, overrides the "),Gi=s("code"),af=r("__call__"),rf=r(" special method."),lf=p(),v(en.$$.fragment),df=p(),v(tn.$$.fragment),cd=p(),so=s("h2"),on=s("a"),xi=s("span"),v(Rs.$$.fragment),cf=p(),ji=s("span"),pf=r("TFGPT2DoubleHeadsModel"),pd=p(),Ne=s("div"),v(Vs.$$.fragment),hf=p(),Fi=s("p"),mf=r(`The GPT2 Model transformer with a language modeling and a multiple-choice classification head on top e.g. for
RocStories/SWAG tasks. The two heads are two linear layers. The language modeling head has its weights tied to the
input embeddings, the classification head takes as input the input of a specified classification token index in the
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Tf=p(),Js=s("p"),bf=r("This model is also a "),Xs=s("a"),yf=r("tf.keras.Model"),vf=r(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),kf=p(),v(nn.$$.fragment),wf=p(),ft=s("div"),v(Ys.$$.fragment),$f=p(),ao=s("p"),Pf=r("The "),nr=s("a"),Mf=r("TFGPT2DoubleHeadsModel"),Gf=r(" forward method, overrides the "),zi=s("code"),xf=r("__call__"),jf=r(" special method."),Ff=p(),v(sn.$$.fragment),zf=p(),v(an.$$.fragment),hd=p(),ro=s("h2"),rn=s("a"),Ei=s("span"),v(Qs.$$.fragment),Ef=p(),qi=s("span"),qf=r("TFGPT2ForSequenceClassification"),md=p(),he=s("div"),v(Zs.$$.fragment),Cf=p(),Ci=s("p"),Df=r("The GPT2 Model transformer with a sequence classification head on top (linear layer)."),Lf=p(),sr=s("p"),ar=s("a"),Of=r("TFGPT2ForSequenceClassification"),Nf=r(` uses the last token in order to do the classification, as other causal models
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),ng=p(),v(ln.$$.fragment),sg=p(),Ye=s("div"),v(na.$$.fragment),ag=p(),io=s("p"),rg=r("The "),ir=s("a"),ig=r("TFGPT2ForSequenceClassification"),lg=r(" forward method, overrides the "),Hi=s("code"),dg=r("__call__"),cg=r(" special method."),pg=p(),v(dn.$$.fragment),hg=p(),v(cn.$$.fragment),mg=p(),v(pn.$$.fragment),ud=p(),lo=s("h2"),hn=s("a"),Ii=s("span"),v(sa.$$.fragment),ug=p(),Si=s("span"),fg=r("TFSequenceClassifierOutputWithPast"),fd=p(),co=s("div"),v(aa.$$.fragment),gg=p(),Ai=s("p"),_g=r("Base class for outputs of sentence classification models."),gd=p(),po=s("h2"),mn=s("a"),Wi=s("span"),v(ra.$$.fragment),Tg=p(),Ui=s("span"),bg=r("FlaxGPT2Model"),_d=p(),xe=s("div"),v(ia.$$.fragment),yg=p(),Bi=s("p"),vg=r("The bare GPT2 Model transformer outputting raw hidden-states without any specific head on top."),kg=p(),la=s("p"),wg=r("This model inherits from "),lr=s("a"),$g=r("FlaxPreTrainedModel"),Pg=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Mg=p(),da=s("p"),Gg=r(`This model is also a Flax Linen
`),ca=s("a"),xg=r("flax.nn.Module"),jg=r(` subclass. Use it as a
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),Fg=p(),Ri=s("p"),zg=r("Finally, this model supports inherent JAX features such as:"),Eg=p(),wt=s("ul"),Vi=s("li"),pa=s("a"),qg=r("Just-In-Time (JIT) compilation"),Cg=p(),Ki=s("li"),ha=s("a"),Dg=r("Automatic Differentiation"),Lg=p(),Ji=s("li"),ma=s("a"),Og=r("Vectorization"),Ng=p(),Xi=s("li"),ua=s("a"),Hg=r("Parallelization"),Ig=p(),gt=s("div"),v(fa.$$.fragment),Sg=p(),ho=s("p"),Ag=r("The "),Yi=s("code"),Wg=r("FlaxGPT2PreTrainedModel"),Ug=r(" forward method, overrides the "),Qi=s("code"),Bg=r("__call__"),Rg=r(" special method."),Vg=p(),v(un.$$.fragment),Kg=p(),v(fn.$$.fragment),Td=p(),mo=s("h2"),gn=s("a"),Zi=s("span"),v(ga.$$.fragment),Jg=p(),el=s("span"),Xg=r("FlaxGPT2LMHeadModel"),bd=p(),je=s("div"),v(_a.$$.fragment),Yg=p(),tl=s("p"),Qg=r(`The GPT2 Model transformer with a language modeling head on top (linear layer with weights tied to the input
...
`),ya=s("a"),a_=r("flax.nn.Module"),r_=r(` subclass. Use it as a
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),i_=p(),ol=s("p"),l_=r("Finally, this model supports inherent JAX features such as:"),d_=p(),$t=s("ul"),nl=s("li"),va=s("a"),c_=r("Just-In-Time (JIT) compilation"),p_=p(),sl=s("li"),ka=s("a"),h_=r("Automatic Differentiation"),m_=p(),al=s("li"),wa=s("a"),u_=r("Vectorization"),f_=p(),rl=s("li"),$a=s("a"),g_=r("Parallelization"),__=p(),_t=s("div"),v(Pa.$$.fragment),T_=p(),uo=s("p"),b_=r("The "),il=s("code"),y_=r("FlaxGPT2PreTrainedModel"),v_=r(" forward method, overrides the "),ll=s("code"),k_=r("__call__"),w_=r(" special method."),$_=p(),v(_n.$$.fragment),P_=p(),v(Tn.$$.fragment),this.h()},l(o){const b=vb('[data-svelte="svelte-1phssyn"]',document.head);d=a(b,"META",{name:!0,content:!0}),b.forEach(t),T=h(o),m=a(o,"H1",{class:!0});var Ma=l(m);c=a(Ma,"A",{id:!0,class:!0,href:!0});var dl=l(c);g=a(dl,"SPAN",{});var cl=l(g);k(n.$$.fragment,cl),cl.forEach(t),dl.forEach(t),u=h(Ma),j=a(Ma,"SPAN",{});var pl=l(j);Q=i(pl,"OpenAI GPT2"),pl.forEach(t),Ma.forEach(t),C=h(o),F=a(o,"H2",{class:!0});var Ga=l(F);R=a(Ga,"A",{id:!0,class:!0,href:!0});var hl=l(R);I=a(hl,"SPAN",{});var ml=l(I);k(Z.$$.fragment,ml),ml.forEach(t),hl.forEach(t),_e=h(Ga),S=a(Ga,"SPAN",{});var ul=l(S);Te=i(ul,"Overview"),ul.forEach(t),Ga.forEach(t),ue=h(o),W=a(o,"P",{});var xa=l(W);O=i(xa,"OpenAI GPT-2 model was proposed in "),ee=a(xa,"A",{href:!0,rel:!0});var fl=l(ee);te=i(fl,"Language Models are Unsupervised Multitask Learners"),fl.forEach(t),z=i(xa,` by Alec
Radford, Jeffrey Wu, Rewon Child, David Luan, Dario Amodei and Ilya Sutskever. It\u2019s a causal (unidirectional)
...
text. The diversity of the dataset causes this simple goal to contain naturally occurring demonstrations of many tasks
across diverse domains. GPT-2 is a direct scale-up of GPT, with more than 10X the parameters and trained on more than
10X the amount of data.`),Tl.forEach(t),_l.forEach(t),ge=h(o),E=a(o,"P",{});var bl=l(E);ye=i(bl,"Tips:"),bl.forEach(t),U=h(o),B=a(o,"UL",{});var Pt=l(B);de=a(Pt,"LI",{});var yl=l(de);K=i(yl,`GPT-2 is a model with absolute position embeddings so it\u2019s usually advised to pad the inputs on the right rather than
the left.`),yl.forEach(t),ve=h(Pt),oe=a(Pt,"LI",{});var ja=l(oe);N=i(ja,`GPT-2 was trained with a causal language modeling (CLM) objective and is therefore powerful at predicting the next
token in a sequence. Leveraging this feature allows GPT-2 to generate syntactically coherent text as it can be
observed in the `),ce=a(ja,"EM",{});var vl=l(ce);J=i(vl,"run_generation.py"),vl.forEach(t),ke=i(ja," example script."),ja.forEach(t),y=h(Pt),x=a(Pt,"LI",{});var me=l(x);ne=i(me,"The model can take the "),Ee=a(me,"EM",{});var kl=l(Ee);Ae=i(kl,"past_key_values"),kl.forEach(t),H=i(me," (for PyTorch) or "),qe=a(me,"EM",{});var wl=l(qe);We=i(wl,"past"),wl.forEach(t),Ue=i(me,` (for TF) as input, which is the previously computed
key/value attention pairs. Using this (`),D=a(me,"EM",{});var $l=l(D);X=i($l,"past_key_values"),$l.forEach(t),Be=i(me," or "),Ce=a(me,"EM",{});var Pl=l(Ce);Y=i(Pl,"past"),Pl.forEach(t),Re=i(me,`) value prevents the model from re-computing
...
`),Ea=a(me,"A",{href:!0});var jl=l(Ea);gc=i(jl,"TFGPT2Model.call()"),jl.forEach(t),_c=i(me," method for more information on its usage."),me.forEach(t),Tc=h(Pt),vt=a(Pt,"LI",{});var Mt=l(vt);bc=i(Mt,"Enabling the "),Pr=a(Mt,"EM",{});var Fl=l(Pr);yc=i(Fl,"scale_attn_by_inverse_layer_idx"),Fl.forEach(t),vc=i(Mt," and "),Mr=a(Mt,"EM",{});var zl=l(Mr);kc=i(zl,"reorder_and_upcast_attn"),zl.forEach(t),wc=i(Mt,` flags will apply the training stability
...
Hugging Face showcasing the generative capabilities of several models. GPT-2 is one of them and is available in five
different sizes: small, medium, large, xl and a distilled version of the small checkpoint: `),Gr=a(bn,"EM",{});var Cl=l(Gr);xc=i(Cl,"distilgpt-2"),Cl.forEach(t),jc=i(bn,"."),bn.forEach(t),Il=h(o),Gt=a(o,"P",{});var fo=l(Gt);Fc=i(fo,"This model was contributed by "),Ln=a(fo,"A",{href:!0,rel:!0});var Dl=l(Ln);zc=i(Dl,"thomwolf"),Dl.forEach(t),Ec=i(fo,". The original code can be found "),On=a(fo,"A",{href:!0,rel:!0});var Ll=l(On);qc=i(Ll,"here"),Ll.forEach(t),Cc=i(fo,"."),fo.forEach(t),Sl=h(o),Ot=a(o,"H2",{class:!0});var Fa=l(Ot);go=a(Fa,"A",{id:!0,class:!0,href:!0});var Ol=l(go);xr=a(Ol,"SPAN",{});var Nl=l(xr);k(Nn.$$.fragment,Nl),Nl.forEach(t),Ol.forEach(t),Dc=h(Fa),jr=a(Fa,"SPAN",{});var x_=l(jr);Lc=i(x_,"GPT2Config"),x_.forEach(t),Fa.forEach(t),Al=h(o),at=a(o,"DIV",{class:!0});var yn=l(at);k(Hn.$$.fragment,yn),Oc=h(yn),kt=a(yn,"P",{});var vn=l(kt);Nc=i(vn,"This is the configuration class to store the configuration of a "),qa=a(vn,"A",{href:!0});var j_=l(qa);Hc=i(j_,"GPT2Model"),j_.forEach(t),Ic=i(vn," or a "),Ca=a(vn,"A",{href:!0});var F_=l(Ca);Sc=i(F_,"TFGPT2Model"),F_.forEach(t),Ac=i(vn,`. It is used to
instantiate a GPT-2 model according to the specified arguments, defining the model architecture. Instantiating a
configuration with the defaults will yield a similar configuration to that of the GPT-2
`),In=a(vn,"A",{href:!0,rel:!0});var z_=l(In);Wc=i(z_,"gpt2"),z_.forEach(t),Uc=i(vn," architecture."),vn.forEach(t),Bc=h(yn),Nt=a(yn,"P",{});var cr=l(Nt);Rc=i(cr,"Configuration objects inherit from "),Da=a(cr,"A",{href:!0});var E_=l(Da);Vc=i(E_,"PretrainedConfig"),E_.forEach(t),Kc=i(cr,` and can be used to control the model outputs. Read the
documentation from `),La=a(cr,"A",{href:!0});var q_=l(La);Jc=i(q_,"PretrainedConfig"),q_.forEach(t),Xc=i(cr," for more information."),cr.forEach(t),Yc=h(yn),k(_o.$$.fragment,yn),yn.forEach(t),Wl=h(o),Ht=a(o,"H2",{class:!0});var vd=l(Ht);To=a(vd,"A",{id:!0,class:!0,href:!0});var C_=l(To);Fr=a(C_,"SPAN",{});var D_=l(Fr);k(Sn.$$.fragment,D_),D_.forEach(t),C_.forEach(t),Qc=h(vd),zr=a(vd,"SPAN",{});var L_=l(zr);Zc=i(L_,"GPT2Tokenizer"),L_.forEach(t),vd.forEach(t),Ul=h(o),pe=a(o,"DIV",{class:!0});var Ie=l(pe);k(An.$$.fragment,Ie),ep=h(Ie),Er=a(Ie,"P",{});var O_=l(Er);tp=i(O_,"Construct a GPT-2 tokenizer. Based on byte-level Byte-Pair-Encoding."),O_.forEach(t),op=h(Ie),qr=a(Ie,"P",{});var N_=l(qr);np=i(N_,"This tokenizer has been trained to treat spaces like parts of the tokens (a bit like sentencepiece) so a word will"),N_.forEach(t),sp=h(Ie),k(bo.$$.fragment,Ie),ap=h(Ie),Wn=a(Ie,"P",{});var kd=l(Wn);rp=i(kd,"You can get around that behavior by passing "),Cr=a(kd,"CODE",{});var H_=l(Cr);ip=i(H_,"add_prefix_space=True"),H_.forEach(t),lp=i(kd,` when instantiating this tokenizer or when you
call it on some text, but since the model was not pretrained this way, it might yield a decrease in performance.`),kd.forEach(t),dp=h(Ie),k(yo.$$.fragment,Ie),cp=h(Ie),Un=a(Ie,"P",{});var wd=l(Un);pp=i(wd,"This tokenizer inherits from "),Oa=a(wd,"A",{href:!0});var I_=l(Oa);hp=i(I_,"PreTrainedTokenizer"),I_.forEach(t),mp=i(wd,` which contains most of the main methods. Users should refer to
this superclass for more information regarding those methods.`),wd.forEach(t),up=h(Ie),Na=a(Ie,"DIV",{class:!0});var S_=l(Na);k(Bn.$$.fragment,S_),S_.forEach(t),Ie.forEach(t),Bl=h(o),It=a(o,"H2",{class:!0});var $d=l(It);vo=a($d,"A",{id:!0,class:!0,href:!0});var A_=l(vo);Dr=a(A_,"SPAN",{});var W_=l(Dr);k(Rn.$$.fragment,W_),W_.forEach(t),A_.forEach(t),fp=h($d),Lr=a($d,"SPAN",{});var U_=l(Lr);gp=i(U_,"GPT2TokenizerFast"),U_.forEach(t),$d.forEach(t),Rl=h(o),$e=a(o,"DIV",{class:!0});var Qe=l($e);k(Vn.$$.fragment,Qe),_p=h(Qe),Kn=a(Qe,"P",{});var Pd=l(Kn);Tp=i(Pd,"Construct a \u201Cfast\u201D GPT-2 tokenizer (backed by HuggingFace\u2019s "),Or=a(Pd,"EM",{});var B_=l(Or);bp=i(B_,"tokenizers"),B_.forEach(t),yp=i(Pd,` library). Based on byte-level
Byte-Pair-Encoding.`),Pd.forEach(t),vp=h(Qe),Nr=a(Qe,"P",{});var R_=l(Nr);kp=i(R_,"This tokenizer has been trained to treat spaces like parts of the tokens (a bit like sentencepiece) so a word will"),R_.forEach(t),wp=h(Qe),k(ko.$$.fragment,Qe),$p=h(Qe),Jn=a(Qe,"P",{});var Md=l(Jn);Pp=i(Md,"You can get around that behavior by passing "),Hr=a(Md,"CODE",{});var V_=l(Hr);Mp=i(V_,"add_prefix_space=True"),V_.forEach(t),Gp=i(Md,` when instantiating this tokenizer, but since
...
it will evenly distribute blocks across all devices.`),dT.forEach(t),ph=h(wn),k(xo.$$.fragment,wn),wn.forEach(t),hh=h(Ze),xt=a(Ze,"DIV",{class:!0});var hr=l(xt);k(is.$$.fragment,hr),mh=h(hr),Xr=a(hr,"P",{});var cT=l(Xr);uh=i(cT,"Moves the model to cpu from a model parallel state."),cT.forEach(t),fh=h(hr),k(jo.$$.fragment,hr),hr.forEach(t),Ze.forEach(t),Ql=h(o),Rt=a(o,"H2",{class:!0});var Cd=l(Rt);Fo=a(Cd,"A",{id:!0,class:!0,href:!0});var pT=l(Fo);Yr=a(pT,"SPAN",{});var hT=l(Yr);k(ls.$$.fragment,hT),hT.forEach(t),pT.forEach(t),gh=h(Cd),Qr=a(Cd,"SPAN",{});var mT=l(Qr);_h=i(mT,"GPT2LMHeadModel"),mT.forEach(t),Cd.forEach(t),Zl=h(o),Me=a(o,"DIV",{class:!0});var et=l(Me);k(ds.$$.fragment,et),Th=h(et),Zr=a(et,"P",{});var uT=l(Zr);bh=i(uT,`The GPT2 Model transformer with a language modeling head on top (linear layer with weights tied to the input
embeddings).`),uT.forEach(t),yh=h(et),cs=a(et,"P",{});var Dd=l(cs);vh=i(Dd,"This model inherits from "),Aa=a(Dd,"A",{href:!0});var fT=l(Aa);kh=i(fT,"PreTrainedModel"),fT.forEach(t),wh=i(Dd,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Ld.forEach(t),xh=h(et),ct=a(et,"DIV",{class:!0});var $n=l(ct);k(ms.$$.fragment,$n),jh=h($n),Vt=a($n,"P",{});var mr=l(Vt);Fh=i(mr,"The "),Wa=a(mr,"A",{href:!0});var _T=l(Wa);zh=i(_T,"GPT2LMHeadModel"),_T.forEach(t),Eh=i(mr," forward method, overrides the "),ei=a(mr,"CODE",{});var TT=l(ei);qh=i(TT,"__call__"),TT.forEach(t),Ch=i(mr," special method."),mr.forEach(t),Dh=h($n),k(zo.$$.fragment,$n),Lh=h($n),k(Eo.$$.fragment,$n),$n.forEach(t),Oh=h(et),pt=a(et,"DIV",{class:!0});var Pn=l(pt);k(us.$$.fragment,Pn),Nh=h(Pn),ti=a(Pn,"P",{});var bT=l(ti);Hh=i(bT,"This is an experimental feature and is a subject to change at a moment\u2019s notice."),bT.forEach(t),Ih=h(Pn),oi=a(Pn,"P",{});var yT=l(oi);Sh=i(yT,`Uses a device map to distribute attention modules of the model across several devices. If no device map is given,
it will evenly distribute blocks across all devices.`),yT.forEach(t),Ah=h(Pn),k(qo.$$.fragment,Pn),Pn.forEach(t),Wh=h(et),jt=a(et,"DIV",{class:!0});var ur=l(jt);k(fs.$$.fragment,ur),Uh=h(ur),ni=a(ur,"P",{});var vT=l(ni);Bh=i(vT,"Moves the model to cpu from a model parallel state."),vT.forEach(t),Rh=h(ur),k(Co.$$.fragment,ur),ur.forEach(t),et.forEach(t),ed=h(o),Kt=a(o,"H2",{class:!0});var Od=l(Kt);Do=a(Od,"A",{id:!0,class:!0,href:!0});var kT=l(Do);si=a(kT,"SPAN",{});var wT=l(si);k(gs.$$.fragment,wT),wT.forEach(t),kT.forEach(t),Vh=h(Od),ai=a(Od,"SPAN",{});var $T=l(ai);Kh=i($T,"GPT2DoubleHeadsModel"),$T.forEach(t),Od.forEach(t),td=h(o),Ke=a(o,"DIV",{class:!0});var Ft=l(Ke);k(_s.$$.fragment,Ft),Jh=h(Ft),ri=a(Ft,"P",{});var PT=l(ri);Xh=i(PT,`The GPT2 Model transformer with a language modeling and a multiple-choice classification head on top e.g. for
RocStories/SWAG tasks. The two heads are two linear layers. The language modeling head has its weights tied to the
input embeddings, the classification head takes as input the input of a specified classification token index in the
input sequence).`),PT.forEach(t),Yh=h(Ft),Ts=a(Ft,"P",{});var Nd=l(Ts);Qh=i(Nd,"This model inherits from "),Ua=a(Nd,"A",{href:!0});var MT=l(Ua);Zh=i(MT,"PreTrainedModel"),MT.forEach(t),em=i(Nd,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Nd.forEach(t),tm=h(Ft),bs=a(Ft,"P",{});var Hd=l(bs);om=i(Hd,"This model is also a PyTorch "),ys=a(Hd,"A",{href:!0,rel:!0});var GT=l(ys);nm=i(GT,"torch.nn.Module"),GT.forEach(t),sm=i(Hd,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Hd.forEach(t),am=h(Ft),ht=a(Ft,"DIV",{class:!0});var Mn=l(ht);k(vs.$$.fragment,Mn),rm=h(Mn),Jt=a(Mn,"P",{});var fr=l(Jt);im=i(fr,"The "),Ba=a(fr,"A",{href:!0});var xT=l(Ba);lm=i(xT,"GPT2DoubleHeadsModel"),xT.forEach(t),dm=i(fr," forward method, overrides the "),ii=a(fr,"CODE",{});var jT=l(ii);cm=i(jT,"__call__"),jT.forEach(t),pm=i(fr," special method."),fr.forEach(t),hm=h(Mn),k(Lo.$$.fragment,Mn),mm=h(Mn),k(Oo.$$.fragment,Mn),Mn.forEach(t),Ft.forEach(t),od=h(o),Xt=a(o,"H2",{class:!0});var Id=l(Xt);No=a(Id,"A",{id:!0,class:!0,href:!0});var FT=l(No);li=a(FT,"SPAN",{});var zT=l(li);k(ks.$$.fragment,zT),zT.forEach(t),FT.forEach(t),um=h(Id),di=a(Id,"SPAN",{});var ET=l(di);fm=i(ET,"GPT2ForSequenceClassification"),ET.forEach(t),Id.forEach(t),nd=h(o),Ge=a(o,"DIV",{class:!0});var tt=l(Ge);k(ws.$$.fragment,tt),gm=h(tt),ci=a(tt,"P",{});var qT=l(ci);_m=i(qT,"The GPT2 Model transformer with a sequence classification head on top (linear layer)."),qT.forEach(t),Tm=h(tt),Ra=a(tt,"P",{});var M_=l(Ra);Va=a(M_,"A",{href:!0});var CT=l(Va);bm=i(CT,"GPT2ForSequenceClassification"),CT.forEach(t),ym=i(M_,` uses the last token in order to do the classification, as other causal models
(e.g. GPT-1) do.`),M_.forEach(t),vm=h(tt),rt=a(tt,"P",{});var zt=l(rt);km=i(zt,`Since it does classification on the last token, it requires to know the position of the last token. If a
...
padding tokens when `),mi=a(zt,"CODE",{});var OT=l(mi);Gm=i(OT,"inputs_embeds"),OT.forEach(t),xm=i(zt," are passed instead of "),ui=a(zt,"CODE",{});var NT=l(ui);jm=i(NT,"input_ids"),NT.forEach(t),Fm=i(zt,`, it does the same (take the last value in
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Ad.forEach(t),Hm=h(tt),Fe=a(tt,"DIV",{class:!0});var ot=l(Fe);k(Gs.$$.fragment,ot),Im=h(ot),Yt=a(ot,"P",{});var gr=l(Yt);Sm=i(gr,"The "),Ja=a(gr,"A",{href:!0});var ST=l(Ja);Am=i(ST,"GPT2ForSequenceClassification"),ST.forEach(t),Wm=i(gr," forward method, overrides the "),fi=a(gr,"CODE",{});var AT=l(fi);Um=i(AT,"__call__"),AT.forEach(t),Bm=i(gr," special method."),gr.forEach(t),Rm=h(ot),k(Ho.$$.fragment,ot),Vm=h(ot),k(Io.$$.fragment,ot),Km=h(ot),k(So.$$.fragment,ot),Jm=h(ot),k(Ao.$$.fragment,ot),Xm=h(ot),k(Wo.$$.fragment,ot),ot.forEach(t),tt.forEach(t),sd=h(o),Qt=a(o,"H2",{class:!0});var Wd=l(Qt);Uo=a(Wd,"A",{id:!0,class:!0,href:!0});var WT=l(Uo);gi=a(WT,"SPAN",{});var UT=l(gi);k(xs.$$.fragment,UT),UT.forEach(t),WT.forEach(t),Ym=h(Wd),_i=a(Wd,"SPAN",{});var BT=l(_i);Qm=i(BT,"GPT2ForTokenClassification"),BT.forEach(t),Wd.forEach(t),ad=h(o),Je=a(o,"DIV",{class:!0});var Et=l(Je);k(js.$$.fragment,Et),Zm=h(Et),Ti=a(Et,"P",{});var RT=l(Ti);eu=i(RT,`GPT2 Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g. for
Named-Entity-Recognition (NER) tasks.`),RT.forEach(t),tu=h(Et),Fs=a(Et,"P",{});var Ud=l(Fs);ou=i(Ud,"This model inherits from "),Xa=a(Ud,"A",{href:!0});var VT=l(Xa);nu=i(VT,"PreTrainedModel"),VT.forEach(t),su=i(Ud,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Ud.forEach(t),au=h(Et),zs=a(Et,"P",{});var Bd=l(zs);ru=i(Bd,"This model is also a PyTorch "),Es=a(Bd,"A",{href:!0,rel:!0});var KT=l(Es);iu=i(KT,"torch.nn.Module"),KT.forEach(t),lu=i(Bd,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Bd.forEach(t),du=h(Et),Xe=a(Et,"DIV",{class:!0});var qt=l(Xe);k(qs.$$.fragment,qt),cu=h(qt),Zt=a(qt,"P",{});var _r=l(Zt);pu=i(_r,"The "),Ya=a(_r,"A",{href:!0});var JT=l(Ya);hu=i(JT,"GPT2ForTokenClassification"),JT.forEach(t),mu=i(_r," forward method, overrides the "),bi=a(_r,"CODE",{});var XT=l(bi);uu=i(XT,"__call__"),XT.forEach(t),fu=i(_r," special method."),_r.forEach(t),gu=h(qt),k(Bo.$$.fragment,qt),_u=h(qt),k(Ro.$$.fragment,qt),Tu=h(qt),k(Vo.$$.fragment,qt),qt.forEach(t),Et.forEach(t),rd=h(o),eo=a(o,"H2",{class:!0});var Rd=l(eo);Ko=a(Rd,"A",{id:!0,class:!0,href:!0});var YT=l(Ko);yi=a(YT,"SPAN",{});var QT=l(yi);k(Cs.$$.fragment,QT),QT.forEach(t),YT.forEach(t),bu=h(Rd),vi=a(Rd,"SPAN",{});var ZT=l(vi);yu=i(ZT,"TFGPT2Model"),ZT.forEach(t),Rd.forEach(t),id=h(o),Le=a(o,"DIV",{class:!0});var Tt=l(Le);k(Ds.$$.fragment,Tt),vu=h(Tt),ki=a(Tt,"P",{});var e2=l(ki);ku=i(e2,"The bare GPT2 Model transformer outputting raw hidden-states without any specific head on top."),e2.forEach(t),wu=h(Tt),Ls=a(Tt,"P",{});var Vd=l(Ls);$u=i(Vd,"This model inherits from "),Qa=a(Vd,"A",{href:!0});var t2=l(Qa);Pu=i(t2,"TFPreTrainedModel"),t2.forEach(t),Mu=i(Vd,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Vd.forEach(t),Gu=h(Tt),Os=a(Tt,"P",{});var Kd=l(Os);xu=i(Kd,"This model is also a "),Ns=a(Kd,"A",{href:!0,rel:!0});var o2=l(Ns);ju=i(o2,"tf.keras.Model"),o2.forEach(t),Fu=i(Kd,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
...
embeddings).`),l2.forEach(t),Bu=h(bt),As=a(bt,"P",{});var Xd=l(As);Ru=i(Xd,"This model inherits from "),er=a(Xd,"A",{href:!0});var d2=l(er);Vu=i(d2,"TFPreTrainedModel"),d2.forEach(t),Ku=i(Xd,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Yd.forEach(t),Zu=h(bt),k(Zo.$$.fragment,bt),ef=h(bt),ut=a(bt,"DIV",{class:!0});var xn=l(ut);k(Bs.$$.fragment,xn),tf=h(xn),no=a(xn,"P",{});var br=l(no);of=i(br,"The "),tr=a(br,"A",{href:!0});var p2=l(tr);nf=i(p2,"TFGPT2LMHeadModel"),p2.forEach(t),sf=i(br," forward method, overrides the "),Gi=a(br,"CODE",{});var h2=l(Gi);af=i(h2,"__call__"),h2.forEach(t),rf=i(br," special method."),br.forEach(t),lf=h(xn),k(en.$$.fragment,xn),df=h(xn),k(tn.$$.fragment,xn),xn.forEach(t),bt.forEach(t),cd=h(o),so=a(o,"H2",{class:!0});var Qd=l(so);on=a(Qd,"A",{id:!0,class:!0,href:!0});var m2=l(on);xi=a(m2,"SPAN",{});var u2=l(xi);k(Rs.$$.fragment,u2),u2.forEach(t),m2.forEach(t),cf=h(Qd),ji=a(Qd,"SPAN",{});var f2=l(ji);pf=i(f2,"TFGPT2DoubleHeadsModel"),f2.forEach(t),Qd.forEach(t),pd=h(o),Ne=a(o,"DIV",{class:!0});var yt=l(Ne);k(Vs.$$.fragment,yt),hf=h(yt),Fi=a(yt,"P",{});var g2=l(Fi);mf=i(g2,`The GPT2 Model transformer with a language modeling and a multiple-choice classification head on top e.g. for
RocStories/SWAG tasks. The two heads are two linear layers. The language modeling head has its weights tied to the
input embeddings, the classification head takes as input the input of a specified classification token index in the
input sequence).`),g2.forEach(t),uf=h(yt),Ks=a(yt,"P",{});var Zd=l(Ks);ff=i(Zd,"This model inherits from "),or=a(Zd,"A",{href:!0});var _2=l(or);gf=i(_2,"TFPreTrainedModel"),_2.forEach(t),_f=i(Zd,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Zd.forEach(t),Tf=h(yt),Js=a(yt,"P",{});var ec=l(Js);bf=i(ec,"This model is also a "),Xs=a(ec,"A",{href:!0,rel:!0});var T2=l(Xs);yf=i(T2,"tf.keras.Model"),T2.forEach(t),vf=i(ec,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),ec.forEach(t),kf=h(yt),k(nn.$$.fragment,yt),wf=h(yt),ft=a(yt,"DIV",{class:!0});var jn=l(ft);k(Ys.$$.fragment,jn),$f=h(jn),ao=a(jn,"P",{});var yr=l(ao);Pf=i(yr,"The "),nr=a(yr,"A",{href:!0});var b2=l(nr);Mf=i(b2,"TFGPT2DoubleHeadsModel"),b2.forEach(t),Gf=i(yr," forward method, overrides the "),zi=a(yr,"CODE",{});var y2=l(zi);xf=i(y2,"__call__"),y2.forEach(t),jf=i(yr," special method."),yr.forEach(t),Ff=h(jn),k(sn.$$.fragment,jn),zf=h(jn),k(an.$$.fragment,jn),jn.forEach(t),yt.forEach(t),hd=h(o),ro=a(o,"H2",{class:!0});var tc=l(ro);rn=a(tc,"A",{id:!0,class:!0,href:!0});var v2=l(rn);Ei=a(v2,"SPAN",{});var k2=l(Ei);k(Qs.$$.fragment,k2),k2.forEach(t),v2.forEach(t),Ef=h(tc),qi=a(tc,"SPAN",{});var w2=l(qi);qf=i(w2,"TFGPT2ForSequenceClassification"),w2.forEach(t),tc.forEach(t),md=h(o),he=a(o,"DIV",{class:!0});var Se=l(he);k(Zs.$$.fragment,Se),Cf=h(Se),Ci=a(Se,"P",{});var $2=l(Ci);Df=i($2,"The GPT2 Model transformer with a sequence classification head on top (linear layer)."),$2.forEach(t),Lf=h(Se),sr=a(Se,"P",{});var G_=l(sr);ar=a(G_,"A",{href:!0});var P2=l(ar);Of=i(P2,"TFGPT2ForSequenceClassification"),P2.forEach(t),Nf=i(G_,` uses the last token in order to do the classification, as other causal models
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),nc.forEach(t),ng=h(Se),k(ln.$$.fragment,Se),sg=h(Se),Ye=a(Se,"DIV",{class:!0});var Dt=l(Ye);k(na.$$.fragment,Dt),ag=h(Dt),io=a(Dt,"P",{});var vr=l(io);rg=i(vr,"The "),ir=a(vr,"A",{href:!0});var E2=l(ir);ig=i(E2,"TFGPT2ForSequenceClassification"),E2.forEach(t),lg=i(vr," forward method, overrides the "),Hi=a(vr,"CODE",{});var q2=l(Hi);dg=i(q2,"__call__"),q2.forEach(t),cg=i(vr," special method."),vr.forEach(t),pg=h(Dt),k(dn.$$.fragment,Dt),hg=h(Dt),k(cn.$$.fragment,Dt),mg=h(Dt),k(pn.$$.fragment,Dt),Dt.forEach(t),Se.forEach(t),ud=h(o),lo=a(o,"H2",{class:!0});var sc=l(lo);hn=a(sc,"A",{id:!0,class:!0,href:!0});var C2=l(hn);Ii=a(C2,"SPAN",{});var D2=l(Ii);k(sa.$$.fragment,D2),D2.forEach(t),C2.forEach(t),ug=h(sc),Si=a(sc,"SPAN",{});var L2=l(Si);fg=i(L2,"TFSequenceClassifierOutputWithPast"),L2.forEach(t),sc.forEach(t),fd=h(o),co=a(o,"DIV",{class:!0});var ac=l(co);k(aa.$$.fragment,ac),gg=h(ac),Ai=a(ac,"P",{});var O2=l(Ai);_g=i(O2,"Base class for outputs of sentence classification models."),O2.forEach(t),ac.forEach(t),gd=h(o),po=a(o,"H2",{class:!0});var rc=l(po);mn=a(rc,"A",{id:!0,class:!0,href:!0});var N2=l(mn);Wi=a(N2,"SPAN",{});var H2=l(Wi);k(ra.$$.fragment,H2),H2.forEach(t),N2.forEach(t),Tg=h(rc),Ui=a(rc,"SPAN",{});var I2=l(Ui);bg=i(I2,"FlaxGPT2Model"),I2.forEach(t),rc.forEach(t),_d=h(o),xe=a(o,"DIV",{class:!0});var nt=l(xe);k(ia.$$.fragment,nt),yg=h(nt),Bi=a(nt,"P",{});var S2=l(Bi);vg=i(S2,"The bare GPT2 Model transformer outputting raw hidden-states without any specific head on top."),S2.forEach(t),kg=h(nt),la=a(nt,"P",{});var ic=l(la);wg=i(ic,"This model inherits from "),lr=a(ic,"A",{href:!0});var A2=l(lr);$g=i(A2,"FlaxPreTrainedModel"),A2.forEach(t),Pg=i(ic,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
