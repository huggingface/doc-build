...
`),J=a(we,"CODE",{});var Ve=l(J);ke=i(Ve,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),Ve.forEach(t),we.forEach(t),D.forEach(t)},m(v,x){_(v,d,x),e(d,T),_(v,m,x),_(v,c,x),e(c,g),e(g,n),e(c,u),e(c,j),e(j,Q),_(v,C,x),_(v,F,x),e(F,R),e(F,I),e(I,Z),e(F,_e),e(F,S),e(S,Te),e(F,ue),_(v,W,x),_(v,O,x),e(O,ee),_(v,te,x),_(v,z,x),e(z,q),e(q,ie),e(q,V),e(V,fe),e(q,le),e(q,A),e(A,be),e(z,ge),e(z,E),e(E,ve),e(E,U),e(U,B),e(E,de),e(E,K),e(K,ye),e(z,oe),e(z,N),e(N,ce),e(N,J),e(J,ke)},d(v){v&&t(d),v&&t(m),v&&t(c),v&&t(C),v&&t(F),v&&t(W),v&&t(O),v&&t(te),v&&t(z)}}}function Vb(G){let d,T,m,c,g;return{c(){d=s("p"),T=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),m=s("code"),c=r("Module"),g=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(n){d=a(n,"P",{});var u=l(d);T=i(u,"Although the recipe for forward pass needs to be defined within this function, one should call the "),m=a(u,"CODE",{});var j=l(m);c=i(j,"Module"),j.forEach(t),g=i(u,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
first positional argument :`),Ue.forEach(t),te=h(v),z=a(v,"UL",{});var D=l(z);q=a(D,"LI",{});var X=l(q);ie=i(X,"a single Tensor with "),V=a(X,"CODE",{});var Be=l(V);fe=i(Be,"input_ids"),Be.forEach(t),le=i(X," only and nothing else: "),A=a(X,"CODE",{});var Ce=l(A);be=i(Ce,"model(inputs_ids)"),Ce.forEach(t),X.forEach(t),ge=h(D),E=a(D,"LI",{});var Y=l(E);ve=i(Y,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),U=a(Y,"CODE",{});var Re=l(U);B=i(Re,"model([input_ids, attention_mask])"),Re.forEach(t),de=i(Y," or "),K=a(Y,"CODE",{});var De=l(K);ye=i(De,"model([input_ids, attention_mask, token_type_ids])"),De.forEach(t),Y.forEach(t),oe=h(D),N=a(D,"LI",{});var we=l(N);ce=i(we,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),J=a(we,"CODE",{});var Ve=l(J);ke=i(Ve,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),Ve.forEach(t),we.forEach(t),D.forEach(t)},m(v,x){_(v,d,x),e(d,T),_(v,m,x),_(v,c,x),e(c,g),e(g,n),e(c,u),e(c,j),e(j,Q),_(v,C,x),_(v,F,x),e(F,R),e(F,I),e(I,Z),e(F,_e),e(F,S),e(S,Te),e(F,ue),_(v,W,x),_(v,O,x),e(O,ee),_(v,te,x),_(v,z,x),e(z,q),e(q,ie),e(q,V),e(V,fe),e(q,le),e(q,A),e(A,be),e(z,ge),e(z,E),e(E,ve),e(E,U),e(U,B),e(E,de),e(E,K),e(K,ye),e(z,oe),e(z,N),e(N,ce),e(N,J),e(J,ke)},d(v){v&&t(d),v&&t(m),v&&t(c),v&&t(C),v&&t(F),v&&t(W),v&&t(O),v&&t(te),v&&t(z)}}}function Xb(G){let d,T,m,c,g;return{c(){d=s("p"),T=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),m=s("code"),c=r("Module"),g=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(n){d=a(n,"P",{});var u=l(d);T=i(u,"Although the recipe for forward pass needs to be defined within this function, one should call the "),m=a(u,"CODE",{});var j=l(m);c=i(j,"Module"),j.forEach(t),g=i(u,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
first positional argument :`),Ue.forEach(t),te=h(v),z=a(v,"UL",{});var D=l(z);q=a(D,"LI",{});var X=l(q);ie=i(X,"a single Tensor with "),V=a(X,"CODE",{});var Be=l(V);fe=i(Be,"input_ids"),Be.forEach(t),le=i(X," only and nothing else: "),A=a(X,"CODE",{});var Ce=l(A);be=i(Ce,"model(inputs_ids)"),Ce.forEach(t),X.forEach(t),ge=h(D),E=a(D,"LI",{});var Y=l(E);ve=i(Y,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),U=a(Y,"CODE",{});var Re=l(U);B=i(Re,"model([input_ids, attention_mask])"),Re.forEach(t),de=i(Y," or "),K=a(Y,"CODE",{});var De=l(K);ye=i(De,"model([input_ids, attention_mask, token_type_ids])"),De.forEach(t),Y.forEach(t),oe=h(D),N=a(D,"LI",{});var we=l(N);ce=i(we,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),J=a(we,"CODE",{});var Ve=l(J);ke=i(Ve,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),Ve.forEach(t),we.forEach(t),D.forEach(t)},m(v,x){_(v,d,x),e(d,T),_(v,m,x),_(v,c,x),e(c,g),e(g,n),e(c,u),e(c,j),e(j,Q),_(v,C,x),_(v,F,x),e(F,R),e(F,I),e(I,Z),e(F,_e),e(F,S),e(S,Te),e(F,ue),_(v,W,x),_(v,O,x),e(O,ee),_(v,te,x),_(v,z,x),e(z,q),e(q,ie),e(q,V),e(V,fe),e(q,le),e(q,A),e(A,be),e(z,ge),e(z,E),e(E,ve),e(E,U),e(U,B),e(E,de),e(E,K),e(K,ye),e(z,oe),e(z,N),e(N,ce),e(N,J),e(J,ke)},d(v){v&&t(d),v&&t(m),v&&t(c),v&&t(C),v&&t(F),v&&t(W),v&&t(O),v&&t(te),v&&t(z)}}}function Zb(G){let d,T,m,c,g;return{c(){d=s("p"),T=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),m=s("code"),c=r("Module"),g=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(n){d=a(n,"P",{});var u=l(d);T=i(u,"Although the recipe for forward pass needs to be defined within this function, one should call the "),m=a(u,"CODE",{});var j=l(m);c=i(j,"Module"),j.forEach(t),g=i(u,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
first positional argument :`),Ue.forEach(t),te=h(v),z=a(v,"UL",{});var D=l(z);q=a(D,"LI",{});var X=l(q);ie=i(X,"a single Tensor with "),V=a(X,"CODE",{});var Be=l(V);fe=i(Be,"input_ids"),Be.forEach(t),le=i(X," only and nothing else: "),A=a(X,"CODE",{});var Ce=l(A);be=i(Ce,"model(inputs_ids)"),Ce.forEach(t),X.forEach(t),ge=h(D),E=a(D,"LI",{});var Y=l(E);ve=i(Y,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),U=a(Y,"CODE",{});var Re=l(U);B=i(Re,"model([input_ids, attention_mask])"),Re.forEach(t),de=i(Y," or "),K=a(Y,"CODE",{});var De=l(K);ye=i(De,"model([input_ids, attention_mask, token_type_ids])"),De.forEach(t),Y.forEach(t),oe=h(D),N=a(D,"LI",{});var we=l(N);ce=i(we,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),J=a(we,"CODE",{});var Ve=l(J);ke=i(Ve,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),Ve.forEach(t),we.forEach(t),D.forEach(t)},m(v,x){_(v,d,x),e(d,T),_(v,m,x),_(v,c,x),e(c,g),e(g,n),e(c,u),e(c,j),e(j,Q),_(v,C,x),_(v,F,x),e(F,R),e(F,I),e(I,Z),e(F,_e),e(F,S),e(S,Te),e(F,ue),_(v,W,x),_(v,O,x),e(O,ee),_(v,te,x),_(v,z,x),e(z,q),e(q,ie),e(q,V),e(V,fe),e(q,le),e(q,A),e(A,be),e(z,ge),e(z,E),e(E,ve),e(E,U),e(U,B),e(E,de),e(E,K),e(K,ye),e(z,oe),e(z,N),e(N,ce),e(N,J),e(J,ke)},d(v){v&&t(d),v&&t(m),v&&t(c),v&&t(C),v&&t(F),v&&t(W),v&&t(O),v&&t(te),v&&t(z)}}}function ov(G){let d,T,m,c,g;return{c(){d=s("p"),T=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),m=s("code"),c=r("Module"),g=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(n){d=a(n,"P",{});var u=l(d);T=i(u,"Although the recipe for forward pass needs to be defined within this function, one should call the "),m=a(u,"CODE",{});var j=l(m);c=i(j,"Module"),j.forEach(t),g=i(u,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
<span class="hljs-meta">&gt;&gt;&gt; </span>next_token_logits = outputs.logits[:, -<span class="hljs-number">1</span>]`}}),{c(){d=s("p"),T=r("Example:"),m=p(),y(c.$$.fragment)},l(n){d=a(n,"P",{});var u=l(d);T=i(u,"Example:"),u.forEach(t),m=h(n),k(c.$$.fragment,n)},m(n,u){_(n,d,u),e(d,T),_(n,m,u),w(c,n,u),g=!0},p:ae,i(n){g||($(c.$$.fragment,n),g=!0)},o(n){P(c.$$.fragment,n),g=!1},d(n){n&&t(d),n&&t(m),M(c,n)}}}function dv(G){let d,T,m,c,g,n,u,j,Q,C,F,R,I,Z,_e,S,Te,ue,W,O,ee,te,z,q,ie,V,fe,le,A,be,ge,E,ve,U,B,de,K,ye,oe,N,ce,J,ke,v,x,ne,Ee,Ae,H,qe,We,Ue,D,X,Be,Ce,Y,Re,De,we,Ve,za,hc,mc,$r,uc,fc,Ea,gc,_c,Tc,yt,bc,Pr,vc,yc,Mr,kc,wc,Cn,$c,Pc,Hl,Lt,Dn,Mc,Gc,Gr,xc,jc,Il,Gt,Fc,Ln,zc,Ec,On,qc,Cc,Sl,Ot,go,xr,Nn,Dc,jr,Lc,Al,at,Hn,Oc,kt,Nc,qa,Hc,Ic,Ca,Sc,Ac,In,Wc,Uc,Bc,Nt,Rc,Da,Vc,Kc,La,Jc,Xc,Yc,_o,Wl,Ht,To,Fr,Sn,Qc,zr,Zc,Ul,pe,An,ep,Er,tp,op,qr,np,sp,bo,ap,Wn,rp,Cr,ip,lp,dp,vo,cp,Un,pp,Oa,hp,mp,up,Na,Bn,Bl,It,yo,Dr,Rn,fp,Lr,gp,Rl,$e,Vn,_p,Kn,Tp,Or,bp,vp,yp,Nr,kp,wp,ko,$p,Jn,Pp,Hr,Mp,Gp,xp,wo,jp,Xn,Fp,Ha,zp,Ep,Vl,St,$o,Ir,Yn,qp,Sr,Cp,Kl,At,Qn,Dp,Ar,Lp,Jl,Wt,Zn,Op,Wr,Np,Xl,Ut,Po,Ur,es,Hp,Br,Ip,Yl,Pe,ts,Sp,Rr,Ap,Wp,os,Up,Ia,Bp,Rp,Vp,ns,Kp,ss,Jp,Xp,Yp,lt,as,Qp,Bt,Zp,Sa,eh,th,Vr,oh,nh,sh,Mo,ah,Go,rh,dt,rs,ih,Kr,lh,dh,Jr,ch,ph,xo,hh,xt,is,mh,Xr,uh,fh,jo,Ql,Rt,Fo,Yr,ls,gh,Qr,_h,Zl,Me,ds,Th,Zr,bh,vh,cs,yh,Aa,kh,wh,$h,ps,Ph,hs,Mh,Gh,xh,ct,ms,jh,Vt,Fh,Wa,zh,Eh,ei,qh,Ch,Dh,zo,Lh,Eo,Oh,pt,us,Nh,ti,Hh,Ih,oi,Sh,Ah,qo,Wh,jt,fs,Uh,ni,Bh,Rh,Co,ed,Kt,Do,si,gs,Vh,ai,Kh,td,Ke,_s,Jh,ri,Xh,Yh,Ts,Qh,Ua,Zh,em,tm,bs,om,vs,nm,sm,am,ht,ys,rm,Jt,im,Ba,lm,dm,ii,cm,pm,hm,Lo,mm,Oo,od,Xt,No,li,ks,um,di,fm,nd,Ge,ws,gm,ci,_m,Tm,Ra,Va,bm,vm,ym,rt,km,pi,wm,$m,hi,Pm,Mm,mi,Gm,xm,ui,jm,Fm,zm,$s,Em,Ka,qm,Cm,Dm,Ps,Lm,Ms,Om,Nm,Hm,Fe,Gs,Im,Yt,Sm,Ja,Am,Wm,fi,Um,Bm,Rm,Ho,Vm,Io,Km,So,Jm,Ao,Xm,Wo,sd,Qt,Uo,gi,xs,Ym,_i,Qm,ad,Je,js,Zm,Ti,eu,tu,Fs,ou,Xa,nu,su,au,zs,ru,Es,iu,lu,du,Xe,qs,cu,Zt,pu,Ya,hu,mu,bi,uu,fu,gu,Bo,_u,Ro,Tu,Vo,rd,eo,Ko,vi,Cs,bu,yi,vu,id,Le,Ds,yu,ki,ku,wu,Ls,$u,Qa,Pu,Mu,Gu,Os,xu,Ns,ju,Fu,zu,Jo,Eu,mt,Hs,qu,to,Cu,Za,Du,Lu,wi,Ou,Nu,Hu,Xo,Iu,Yo,ld,oo,Qo,$i,Is,Su,Pi,Au,dd,Oe,Ss,Wu,Mi,Uu,Bu,As,Ru,er,Vu,Ku,Ju,Ws,Xu,Us,Yu,Qu,Zu,Zo,ef,ut,Bs,tf,no,of,tr,nf,sf,Gi,af,rf,lf,en,df,tn,cd,so,on,xi,Rs,cf,ji,pf,pd,Ne,Vs,hf,Fi,mf,uf,Ks,ff,or,gf,_f,Tf,Js,bf,Xs,vf,yf,kf,nn,wf,ft,Ys,$f,ao,Pf,nr,Mf,Gf,zi,xf,jf,Ff,sn,zf,an,hd,ro,rn,Ei,Qs,Ef,qi,qf,md,he,Zs,Cf,Ci,Df,Lf,sr,ar,Of,Nf,Hf,it,If,Di,Sf,Af,Li,Wf,Uf,Oi,Bf,Rf,Ni,Vf,Kf,Jf,ea,Xf,rr,Yf,Qf,Zf,ta,eg,oa,tg,og,ng,ln,sg,Ye,na,ag,io,rg,ir,ig,lg,Hi,dg,cg,pg,dn,hg,cn,mg,pn,ud,lo,hn,Ii,sa,ug,Si,fg,fd,co,aa,gg,Ai,_g,gd,po,mn,Wi,ra,Tg,Ui,bg,_d,xe,ia,vg,Bi,yg,kg,la,wg,lr,$g,Pg,Mg,da,Gg,ca,xg,jg,Fg,Ri,zg,Eg,wt,Vi,pa,qg,Cg,Ki,ha,Dg,Lg,Ji,ma,Og,Ng,Xi,ua,Hg,Ig,gt,fa,Sg,ho,Ag,Yi,Wg,Ug,Qi,Bg,Rg,Vg,un,Kg,fn,Td,mo,gn,Zi,ga,Jg,el,Xg,bd,je,_a,Yg,tl,Qg,Zg,Ta,e_,dr,t_,o_,n_,ba,s_,va,a_,r_,i_,ol,l_,d_,$t,nl,ya,c_,p_,sl,ka,h_,m_,al,wa,u_,f_,rl,$a,g_,__,_t,Pa,T_,uo,b_,il,v_,y_,ll,k_,w_,$_,_n,P_,Tn,vd;return n=new ze({}),Z=new ze({}),Nn=new ze({}),Hn=new L({props:{name:"class transformers.GPT2Config",anchor:"transformers.GPT2Config",parameters:[{name:"vocab_size",val:" = 50257"},{name:"n_positions",val:" = 1024"},{name:"n_embd",val:" = 768"},{name:"n_layer",val:" = 12"},{name:"n_head",val:" = 12"},{name:"n_inner",val:" = None"},{name:"activation_function",val:" = 'gelu_new'"},{name:"resid_pdrop",val:" = 0.1"},{name:"embd_pdrop",val:" = 0.1"},{name:"attn_pdrop",val:" = 0.1"},{name:"layer_norm_epsilon",val:" = 1e-05"},{name:"initializer_range",val:" = 0.02"},{name:"summary_type",val:" = 'cls_index'"},{name:"summary_use_proj",val:" = True"},{name:"summary_activation",val:" = None"},{name:"summary_proj_to_labels",val:" = True"},{name:"summary_first_dropout",val:" = 0.1"},{name:"scale_attn_weights",val:" = True"},{name:"use_cache",val:" = True"},{name:"bos_token_id",val:" = 50256"},{name:"eos_token_id",val:" = 50256"},{name:"scale_attn_by_inverse_layer_idx",val:" = False"},{name:"reorder_and_upcast_attn",val:" = False"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.GPT2Config.vocab_size",description:`<strong>vocab_size</strong> (<code>int</code>, <em>optional</em>, defaults to 50257) &#x2014;
...
<li>gpt2-large: 36</li>
<li>gpt2-xl: 48</li>
</ul>`,name:"device_map"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/gpt2/modeling_gpt2.py#L692"}}),xo=new se({props:{anchor:"transformers.GPT2Model.parallelize.example",$$slots:{default:[Fb]},$$scope:{ctx:G}}}),is=new L({props:{name:"deparallelize",anchor:"transformers.GPT2Model.deparallelize",parameters:[],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/gpt2/modeling_gpt2.py#L712"}}),jo=new se({props:{anchor:"transformers.GPT2Model.deparallelize.example",$$slots:{default:[zb]},$$scope:{ctx:G}}}),ls=new ze({}),ds=new L({props:{name:"class transformers.GPT2LMHeadModel",anchor:"transformers.GPT2LMHeadModel",parameters:[{name:"config",val:""}],parametersDescription:[{anchor:"transformers.GPT2LMHeadModel.config",description:`<strong>config</strong> (<a href="/docs/transformers/main/en/model_doc/gpt2#transformers.GPT2Config">GPT2Config</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
...
this superclass for more information regarding those methods.`),up=p(),Na=s("div"),y(Bn.$$.fragment),Bl=p(),It=s("h2"),yo=s("a"),Dr=s("span"),y(Rn.$$.fragment),fp=p(),Lr=s("span"),gp=r("GPT2TokenizerFast"),Rl=p(),$e=s("div"),y(Vn.$$.fragment),_p=p(),Kn=s("p"),Tp=r("Construct a \u201Cfast\u201D GPT-2 tokenizer (backed by HuggingFace\u2019s "),Or=s("em"),bp=r("tokenizers"),vp=r(` library). Based on byte-level
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),am=p(),ht=s("div"),y(ys.$$.fragment),rm=p(),Jt=s("p"),im=r("The "),Ba=s("a"),lm=r("GPT2DoubleHeadsModel"),dm=r(" forward method, overrides the "),ii=s("code"),cm=r("__call__"),pm=r(" special method."),hm=p(),y(Lo.$$.fragment),mm=p(),y(Oo.$$.fragment),od=p(),Xt=s("h2"),No=s("a"),li=s("span"),y(ks.$$.fragment),um=p(),di=s("span"),fm=r("GPT2ForSequenceClassification"),nd=p(),Ge=s("div"),y(ws.$$.fragment),gm=p(),ci=s("p"),_m=r("The GPT2 Model transformer with a sequence classification head on top (linear layer)."),Tm=p(),Ra=s("p"),Va=s("a"),bm=r("GPT2ForSequenceClassification"),vm=r(` uses the last token in order to do the classification, as other causal models
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Hm=p(),Fe=s("div"),y(Gs.$$.fragment),Im=p(),Yt=s("p"),Sm=r("The "),Ja=s("a"),Am=r("GPT2ForSequenceClassification"),Wm=r(" forward method, overrides the "),fi=s("code"),Um=r("__call__"),Bm=r(" special method."),Rm=p(),y(Ho.$$.fragment),Vm=p(),y(Io.$$.fragment),Km=p(),y(So.$$.fragment),Jm=p(),y(Ao.$$.fragment),Xm=p(),y(Wo.$$.fragment),sd=p(),Qt=s("h2"),Uo=s("a"),gi=s("span"),y(xs.$$.fragment),Ym=p(),_i=s("span"),Qm=r("GPT2ForTokenClassification"),ad=p(),Je=s("div"),y(js.$$.fragment),Zm=p(),Ti=s("p"),eu=r(`GPT2 Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g. for
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),kf=p(),y(nn.$$.fragment),wf=p(),ft=s("div"),y(Ys.$$.fragment),$f=p(),ao=s("p"),Pf=r("The "),nr=s("a"),Mf=r("TFGPT2DoubleHeadsModel"),Gf=r(" forward method, overrides the "),zi=s("code"),xf=r("__call__"),jf=r(" special method."),Ff=p(),y(sn.$$.fragment),zf=p(),y(an.$$.fragment),hd=p(),ro=s("h2"),rn=s("a"),Ei=s("span"),y(Qs.$$.fragment),Ef=p(),qi=s("span"),qf=r("TFGPT2ForSequenceClassification"),md=p(),he=s("div"),y(Zs.$$.fragment),Cf=p(),Ci=s("p"),Df=r("The GPT2 Model transformer with a sequence classification head on top (linear layer)."),Lf=p(),sr=s("p"),ar=s("a"),Of=r("TFGPT2ForSequenceClassification"),Nf=r(` uses the last token in order to do the classification, as other causal models
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Nd.forEach(t),tm=h(Ft),bs=a(Ft,"P",{});var Hd=l(bs);om=i(Hd,"This model is also a PyTorch "),vs=a(Hd,"A",{href:!0,rel:!0});var GT=l(vs);nm=i(GT,"torch.nn.Module"),GT.forEach(t),sm=i(Hd,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
