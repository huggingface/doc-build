...
`),U=s("code"),R=r("model([input_ids, attention_mask])"),de=r(" or "),K=s("code"),ve=r("model([input_ids, attention_mask, token_type_ids])"),oe=p(),N=s("li"),ce=r(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),J=s("code"),ke=r('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(y){d=a(y,"P",{});var x=l(d);T=i(x,"TF 2.0 models accepts two formats as inputs:"),x.forEach(t),m=h(y),c=a(y,"UL",{});var ne=l(c);g=a(ne,"LI",{});var Ee=l(g);n=i(Ee,"having all inputs as keyword arguments (like PyTorch models), or"),Ee.forEach(t),u=h(ne),F=a(ne,"LI",{});var Ae=l(F);Q=i(Ae,"having all inputs as a list, tuple or dict in the first positional arguments."),Ae.forEach(t),ne.forEach(t),C=h(y),j=a(y,"P",{});var H=l(j);B=i(H,"This second option is useful when using "),I=a(H,"CODE",{});var qe=l(I);Z=i(qe,"tf.keras.Model.fit"),qe.forEach(t),_e=i(H,` method which currently requires having all the
...
`),J=a(we,"CODE",{});var Ve=l(J);ke=i(Ve,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),Ve.forEach(t),we.forEach(t),D.forEach(t)},m(y,x){_(y,d,x),e(d,T),_(y,m,x),_(y,c,x),e(c,g),e(g,n),e(c,u),e(c,F),e(F,Q),_(y,C,x),_(y,j,x),e(j,B),e(j,I),e(I,Z),e(j,_e),e(j,S),e(S,Te),e(j,ue),_(y,W,x),_(y,O,x),e(O,ee),_(y,te,x),_(y,z,x),e(z,q),e(q,ie),e(q,V),e(V,fe),e(q,le),e(q,A),e(A,be),e(z,ge),e(z,E),e(E,ye),e(E,U),e(U,R),e(E,de),e(E,K),e(K,ve),e(z,oe),e(z,N),e(N,ce),e(N,J),e(J,ke)},d(y){y&&t(d),y&&t(m),y&&t(c),y&&t(C),y&&t(j),y&&t(W),y&&t(O),y&&t(te),y&&t(z)}}}function Vb(G){let d,T,m,c,g;return{c(){d=s("p"),T=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),m=s("code"),c=r("Module"),g=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(n){d=a(n,"P",{});var u=l(d);T=i(u,"Although the recipe for forward pass needs to be defined within this function, one should call the "),m=a(u,"CODE",{});var F=l(m);c=i(F,"Module"),F.forEach(t),g=i(u,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
first positional argument :`),Ue.forEach(t),te=h(y),z=a(y,"UL",{});var D=l(z);q=a(D,"LI",{});var X=l(q);ie=i(X,"a single Tensor with "),V=a(X,"CODE",{});var Re=l(V);fe=i(Re,"input_ids"),Re.forEach(t),le=i(X," only and nothing else: "),A=a(X,"CODE",{});var Ce=l(A);be=i(Ce,"model(inputs_ids)"),Ce.forEach(t),X.forEach(t),ge=h(D),E=a(D,"LI",{});var Y=l(E);ye=i(Y,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),U=a(Y,"CODE",{});var Be=l(U);R=i(Be,"model([input_ids, attention_mask])"),Be.forEach(t),de=i(Y," or "),K=a(Y,"CODE",{});var De=l(K);ve=i(De,"model([input_ids, attention_mask, token_type_ids])"),De.forEach(t),Y.forEach(t),oe=h(D),N=a(D,"LI",{});var we=l(N);ce=i(we,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),J=a(we,"CODE",{});var Ve=l(J);ke=i(Ve,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),Ve.forEach(t),we.forEach(t),D.forEach(t)},m(y,x){_(y,d,x),e(d,T),_(y,m,x),_(y,c,x),e(c,g),e(g,n),e(c,u),e(c,F),e(F,Q),_(y,C,x),_(y,j,x),e(j,B),e(j,I),e(I,Z),e(j,_e),e(j,S),e(S,Te),e(j,ue),_(y,W,x),_(y,O,x),e(O,ee),_(y,te,x),_(y,z,x),e(z,q),e(q,ie),e(q,V),e(V,fe),e(q,le),e(q,A),e(A,be),e(z,ge),e(z,E),e(E,ye),e(E,U),e(U,R),e(E,de),e(E,K),e(K,ve),e(z,oe),e(z,N),e(N,ce),e(N,J),e(J,ke)},d(y){y&&t(d),y&&t(m),y&&t(c),y&&t(C),y&&t(j),y&&t(W),y&&t(O),y&&t(te),y&&t(z)}}}function Xb(G){let d,T,m,c,g;return{c(){d=s("p"),T=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),m=s("code"),c=r("Module"),g=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(n){d=a(n,"P",{});var u=l(d);T=i(u,"Although the recipe for forward pass needs to be defined within this function, one should call the "),m=a(u,"CODE",{});var F=l(m);c=i(F,"Module"),F.forEach(t),g=i(u,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
first positional argument :`),Ue.forEach(t),te=h(y),z=a(y,"UL",{});var D=l(z);q=a(D,"LI",{});var X=l(q);ie=i(X,"a single Tensor with "),V=a(X,"CODE",{});var Re=l(V);fe=i(Re,"input_ids"),Re.forEach(t),le=i(X," only and nothing else: "),A=a(X,"CODE",{});var Ce=l(A);be=i(Ce,"model(inputs_ids)"),Ce.forEach(t),X.forEach(t),ge=h(D),E=a(D,"LI",{});var Y=l(E);ye=i(Y,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),U=a(Y,"CODE",{});var Be=l(U);R=i(Be,"model([input_ids, attention_mask])"),Be.forEach(t),de=i(Y," or "),K=a(Y,"CODE",{});var De=l(K);ve=i(De,"model([input_ids, attention_mask, token_type_ids])"),De.forEach(t),Y.forEach(t),oe=h(D),N=a(D,"LI",{});var we=l(N);ce=i(we,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),J=a(we,"CODE",{});var Ve=l(J);ke=i(Ve,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),Ve.forEach(t),we.forEach(t),D.forEach(t)},m(y,x){_(y,d,x),e(d,T),_(y,m,x),_(y,c,x),e(c,g),e(g,n),e(c,u),e(c,F),e(F,Q),_(y,C,x),_(y,j,x),e(j,B),e(j,I),e(I,Z),e(j,_e),e(j,S),e(S,Te),e(j,ue),_(y,W,x),_(y,O,x),e(O,ee),_(y,te,x),_(y,z,x),e(z,q),e(q,ie),e(q,V),e(V,fe),e(q,le),e(q,A),e(A,be),e(z,ge),e(z,E),e(E,ye),e(E,U),e(U,R),e(E,de),e(E,K),e(K,ve),e(z,oe),e(z,N),e(N,ce),e(N,J),e(J,ke)},d(y){y&&t(d),y&&t(m),y&&t(c),y&&t(C),y&&t(j),y&&t(W),y&&t(O),y&&t(te),y&&t(z)}}}function Zb(G){let d,T,m,c,g;return{c(){d=s("p"),T=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),m=s("code"),c=r("Module"),g=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(n){d=a(n,"P",{});var u=l(d);T=i(u,"Although the recipe for forward pass needs to be defined within this function, one should call the "),m=a(u,"CODE",{});var F=l(m);c=i(F,"Module"),F.forEach(t),g=i(u,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
first positional argument :`),Ue.forEach(t),te=h(y),z=a(y,"UL",{});var D=l(z);q=a(D,"LI",{});var X=l(q);ie=i(X,"a single Tensor with "),V=a(X,"CODE",{});var Re=l(V);fe=i(Re,"input_ids"),Re.forEach(t),le=i(X," only and nothing else: "),A=a(X,"CODE",{});var Ce=l(A);be=i(Ce,"model(inputs_ids)"),Ce.forEach(t),X.forEach(t),ge=h(D),E=a(D,"LI",{});var Y=l(E);ye=i(Y,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),U=a(Y,"CODE",{});var Be=l(U);R=i(Be,"model([input_ids, attention_mask])"),Be.forEach(t),de=i(Y," or "),K=a(Y,"CODE",{});var De=l(K);ve=i(De,"model([input_ids, attention_mask, token_type_ids])"),De.forEach(t),Y.forEach(t),oe=h(D),N=a(D,"LI",{});var we=l(N);ce=i(we,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),J=a(we,"CODE",{});var Ve=l(J);ke=i(Ve,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),Ve.forEach(t),we.forEach(t),D.forEach(t)},m(y,x){_(y,d,x),e(d,T),_(y,m,x),_(y,c,x),e(c,g),e(g,n),e(c,u),e(c,F),e(F,Q),_(y,C,x),_(y,j,x),e(j,B),e(j,I),e(I,Z),e(j,_e),e(j,S),e(S,Te),e(j,ue),_(y,W,x),_(y,O,x),e(O,ee),_(y,te,x),_(y,z,x),e(z,q),e(q,ie),e(q,V),e(V,fe),e(q,le),e(q,A),e(A,be),e(z,ge),e(z,E),e(E,ye),e(E,U),e(U,R),e(E,de),e(E,K),e(K,ve),e(z,oe),e(z,N),e(N,ce),e(N,J),e(J,ke)},d(y){y&&t(d),y&&t(m),y&&t(c),y&&t(C),y&&t(j),y&&t(W),y&&t(O),y&&t(te),y&&t(z)}}}function oy(G){let d,T,m,c,g;return{c(){d=s("p"),T=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),m=s("code"),c=r("Module"),g=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(n){d=a(n,"P",{});var u=l(d);T=i(u,"Although the recipe for forward pass needs to be defined within this function, one should call the "),m=a(u,"CODE",{});var F=l(m);c=i(F,"Module"),F.forEach(t),g=i(u,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
<span class="hljs-meta">&gt;&gt;&gt; </span>next_token_logits = outputs.logits[:, -<span class="hljs-number">1</span>]`}}),{c(){d=s("p"),T=r("Example:"),m=p(),v(c.$$.fragment)},l(n){d=a(n,"P",{});var u=l(d);T=i(u,"Example:"),u.forEach(t),m=h(n),k(c.$$.fragment,n)},m(n,u){_(n,d,u),e(d,T),_(n,m,u),w(c,n,u),g=!0},p:ae,i(n){g||($(c.$$.fragment,n),g=!0)},o(n){P(c.$$.fragment,n),g=!1},d(n){n&&t(d),n&&t(m),M(c,n)}}}function dy(G){let d,T,m,c,g,n,u,F,Q,C,j,B,I,Z,_e,S,Te,ue,W,O,ee,te,z,q,ie,V,fe,le,A,be,ge,E,ye,U,R,de,K,ve,oe,N,ce,J,ke,y,x,ne,Ee,Ae,H,qe,We,Ue,D,X,Re,Ce,Y,Be,De,we,Ve,za,hc,mc,$r,uc,fc,Ea,gc,_c,Tc,vt,bc,Pr,yc,vc,Mr,kc,wc,Cn,$c,Pc,Hl,Lt,Dn,Mc,Gc,Gr,xc,Fc,Il,Gt,jc,Ln,zc,Ec,On,qc,Cc,Sl,Ot,go,xr,Nn,Dc,Fr,Lc,Al,at,Hn,Oc,kt,Nc,qa,Hc,Ic,Ca,Sc,Ac,In,Wc,Uc,Rc,Nt,Bc,Da,Vc,Kc,La,Jc,Xc,Yc,_o,Wl,Ht,To,jr,Sn,Qc,zr,Zc,Ul,pe,An,ep,Er,tp,op,qr,np,sp,bo,ap,Wn,rp,Cr,ip,lp,dp,yo,cp,Un,pp,Oa,hp,mp,up,Na,Rn,Rl,It,vo,Dr,Bn,fp,Lr,gp,Bl,$e,Vn,_p,Kn,Tp,Or,bp,yp,vp,Nr,kp,wp,ko,$p,Jn,Pp,Hr,Mp,Gp,xp,wo,Fp,Xn,jp,Ha,zp,Ep,Vl,St,$o,Ir,Yn,qp,Sr,Cp,Kl,At,Qn,Dp,Ar,Lp,Jl,Wt,Zn,Op,Wr,Np,Xl,Ut,Po,Ur,es,Hp,Rr,Ip,Yl,Pe,ts,Sp,Br,Ap,Wp,os,Up,Ia,Rp,Bp,Vp,ns,Kp,ss,Jp,Xp,Yp,lt,as,Qp,Rt,Zp,Sa,eh,th,Vr,oh,nh,sh,Mo,ah,Go,rh,dt,rs,ih,Kr,lh,dh,Jr,ch,ph,xo,hh,xt,is,mh,Xr,uh,fh,Fo,Ql,Bt,jo,Yr,ls,gh,Qr,_h,Zl,Me,ds,Th,Zr,bh,yh,cs,vh,Aa,kh,wh,$h,ps,Ph,hs,Mh,Gh,xh,ct,ms,Fh,Vt,jh,Wa,zh,Eh,ei,qh,Ch,Dh,zo,Lh,Eo,Oh,pt,us,Nh,ti,Hh,Ih,oi,Sh,Ah,qo,Wh,Ft,fs,Uh,ni,Rh,Bh,Co,ed,Kt,Do,si,gs,Vh,ai,Kh,td,Ke,_s,Jh,ri,Xh,Yh,Ts,Qh,Ua,Zh,em,tm,bs,om,ys,nm,sm,am,ht,vs,rm,Jt,im,Ra,lm,dm,ii,cm,pm,hm,Lo,mm,Oo,od,Xt,No,li,ks,um,di,fm,nd,Ge,ws,gm,ci,_m,Tm,Ba,Va,bm,ym,vm,rt,km,pi,wm,$m,hi,Pm,Mm,mi,Gm,xm,ui,Fm,jm,zm,$s,Em,Ka,qm,Cm,Dm,Ps,Lm,Ms,Om,Nm,Hm,je,Gs,Im,Yt,Sm,Ja,Am,Wm,fi,Um,Rm,Bm,Ho,Vm,Io,Km,So,Jm,Ao,Xm,Wo,sd,Qt,Uo,gi,xs,Ym,_i,Qm,ad,Je,Fs,Zm,Ti,eu,tu,js,ou,Xa,nu,su,au,zs,ru,Es,iu,lu,du,Xe,qs,cu,Zt,pu,Ya,hu,mu,bi,uu,fu,gu,Ro,_u,Bo,Tu,Vo,rd,eo,Ko,yi,Cs,bu,vi,yu,id,Le,Ds,vu,ki,ku,wu,Ls,$u,Qa,Pu,Mu,Gu,Os,xu,Ns,Fu,ju,zu,Jo,Eu,mt,Hs,qu,to,Cu,Za,Du,Lu,wi,Ou,Nu,Hu,Xo,Iu,Yo,ld,oo,Qo,$i,Is,Su,Pi,Au,dd,Oe,Ss,Wu,Mi,Uu,Ru,As,Bu,er,Vu,Ku,Ju,Ws,Xu,Us,Yu,Qu,Zu,Zo,ef,ut,Rs,tf,no,of,tr,nf,sf,Gi,af,rf,lf,en,df,tn,cd,so,on,xi,Bs,cf,Fi,pf,pd,Ne,Vs,hf,ji,mf,uf,Ks,ff,or,gf,_f,Tf,Js,bf,Xs,yf,vf,kf,nn,wf,ft,Ys,$f,ao,Pf,nr,Mf,Gf,zi,xf,Ff,jf,sn,zf,an,hd,ro,rn,Ei,Qs,Ef,qi,qf,md,he,Zs,Cf,Ci,Df,Lf,sr,ar,Of,Nf,Hf,it,If,Di,Sf,Af,Li,Wf,Uf,Oi,Rf,Bf,Ni,Vf,Kf,Jf,ea,Xf,rr,Yf,Qf,Zf,ta,eg,oa,tg,og,ng,ln,sg,Ye,na,ag,io,rg,ir,ig,lg,Hi,dg,cg,pg,dn,hg,cn,mg,pn,ud,lo,hn,Ii,sa,ug,Si,fg,fd,co,aa,gg,Ai,_g,gd,po,mn,Wi,ra,Tg,Ui,bg,_d,xe,ia,yg,Ri,vg,kg,la,wg,lr,$g,Pg,Mg,da,Gg,ca,xg,Fg,jg,Bi,zg,Eg,wt,Vi,pa,qg,Cg,Ki,ha,Dg,Lg,Ji,ma,Og,Ng,Xi,ua,Hg,Ig,gt,fa,Sg,ho,Ag,Yi,Wg,Ug,Qi,Rg,Bg,Vg,un,Kg,fn,Td,mo,gn,Zi,ga,Jg,el,Xg,bd,Fe,_a,Yg,tl,Qg,Zg,Ta,e_,dr,t_,o_,n_,ba,s_,ya,a_,r_,i_,ol,l_,d_,$t,nl,va,c_,p_,sl,ka,h_,m_,al,wa,u_,f_,rl,$a,g_,__,_t,Pa,T_,uo,b_,il,y_,v_,ll,k_,w_,$_,_n,P_,Tn,yd;return n=new ze({}),Z=new ze({}),Nn=new ze({}),Hn=new L({props:{name:"class transformers.GPT2Config",anchor:"transformers.GPT2Config",parameters:[{name:"vocab_size",val:" = 50257"},{name:"n_positions",val:" = 1024"},{name:"n_embd",val:" = 768"},{name:"n_layer",val:" = 12"},{name:"n_head",val:" = 12"},{name:"n_inner",val:" = None"},{name:"activation_function",val:" = 'gelu_new'"},{name:"resid_pdrop",val:" = 0.1"},{name:"embd_pdrop",val:" = 0.1"},{name:"attn_pdrop",val:" = 0.1"},{name:"layer_norm_epsilon",val:" = 1e-05"},{name:"initializer_range",val:" = 0.02"},{name:"summary_type",val:" = 'cls_index'"},{name:"summary_use_proj",val:" = True"},{name:"summary_activation",val:" = None"},{name:"summary_proj_to_labels",val:" = True"},{name:"summary_first_dropout",val:" = 0.1"},{name:"scale_attn_weights",val:" = True"},{name:"use_cache",val:" = True"},{name:"bos_token_id",val:" = 50256"},{name:"eos_token_id",val:" = 50256"},{name:"scale_attn_by_inverse_layer_idx",val:" = False"},{name:"reorder_and_upcast_attn",val:" = False"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.GPT2Config.vocab_size",description:`<strong>vocab_size</strong> (<code>int</code>, <em>optional</em>, defaults to 50257) &#x2014;
...
Whether or not to return a <a href="/docs/transformers/main/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/gpt2/modeling_gpt2.py#L738",returnDescription:`
<p>A <a
...
<li>gpt2-large: 36</li>
<li>gpt2-xl: 48</li>
</ul>`,name:"device_map"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/gpt2/modeling_gpt2.py#L692"}}),xo=new se({props:{anchor:"transformers.GPT2Model.parallelize.example",$$slots:{default:[jb]},$$scope:{ctx:G}}}),is=new L({props:{name:"deparallelize",anchor:"transformers.GPT2Model.deparallelize",parameters:[],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/gpt2/modeling_gpt2.py#L712"}}),Fo=new se({props:{anchor:"transformers.GPT2Model.deparallelize.example",$$slots:{default:[zb]},$$scope:{ctx:G}}}),ls=new ze({}),ds=new L({props:{name:"class transformers.GPT2LMHeadModel",anchor:"transformers.GPT2LMHeadModel",parameters:[{name:"config",val:""}],parametersDescription:[{anchor:"transformers.GPT2LMHeadModel.config",description:`<strong>config</strong> (<a href="/docs/transformers/main/en/model_doc/gpt2#transformers.GPT2Config">GPT2Config</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/main/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/gpt2/modeling_gpt2.py#L947"}}),ms=new L({props:{name:"forward",anchor:"transformers.GPT2LMHeadModel.forward",parameters:[{name:"input_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"past_key_values",val:": typing.Optional[typing.Tuple[typing.Tuple[torch.Tensor]]] = None"},{name:"attention_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"token_type_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"position_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"head_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"encoder_hidden_states",val:": typing.Optional[torch.Tensor] = None"},{name:"encoder_attention_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"labels",val:": typing.Optional[torch.LongTensor] = None"},{name:"use_cache",val:": typing.Optional[bool] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.GPT2LMHeadModel.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, input_ids_length)</code>) &#x2014;
<code>input_ids_length</code> = <code>sequence_length</code> if <code>past_key_values</code> is <code>None</code> else
<code>past_key_values[0][0].shape[-2]</code> (<code>sequence_length</code> of input past key value states). Indices of input
sequence tokens in the vocabulary.</p>
<p>If <code>past_key_values</code> is used, only <code>input_ids</code> that do not have their past calculated should be passed as
...
are ignored (masked), the loss is only computed for labels in <code>[0, ..., config.vocab_size]</code>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/gpt2/modeling_gpt2.py#L1016",returnDescription:`
<p>A <a
...
<li>gpt2-large: 36</li>
<li>gpt2-xl: 48</li>
</ul>`,name:"device_map"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/gpt2/modeling_gpt2.py#L962"}}),qo=new se({props:{anchor:"transformers.GPT2LMHeadModel.parallelize.example",$$slots:{default:[Cb]},$$scope:{ctx:G}}}),fs=new L({props:{name:"deparallelize",anchor:"transformers.GPT2LMHeadModel.deparallelize",parameters:[],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/gpt2/modeling_gpt2.py#L974"}}),Co=new se({props:{anchor:"transformers.GPT2LMHeadModel.deparallelize.example",$$slots:{default:[Db]},$$scope:{ctx:G}}}),gs=new ze({}),_s=new L({props:{name:"class transformers.GPT2DoubleHeadsModel",anchor:"transformers.GPT2DoubleHeadsModel",parameters:[{name:"config",val:""}],parametersDescription:[{anchor:"transformers.GPT2DoubleHeadsModel.config",description:`<strong>config</strong> (<a href="/docs/transformers/main/en/model_doc/gpt2#transformers.GPT2Config">GPT2Config</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/main/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/gpt2/modeling_gpt2.py#L1116"}}),vs=new L({props:{name:"forward",anchor:"transformers.GPT2DoubleHeadsModel.forward",parameters:[{name:"input_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"past_key_values",val:": typing.Optional[typing.Tuple[typing.Tuple[torch.Tensor]]] = None"},{name:"attention_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"token_type_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"position_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"head_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"mc_token_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"labels",val:": typing.Optional[torch.LongTensor] = None"},{name:"mc_labels",val:": typing.Optional[torch.LongTensor] = None"},{name:"use_cache",val:": typing.Optional[bool] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.GPT2DoubleHeadsModel.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, input_ids_length)</code>) &#x2014;
<code>input_ids_length</code> = <code>sequence_length</code> if <code>past_key_values</code> is <code>None</code> else
<code>past_key_values[0][0].shape[-2]</code> (<code>sequence_length</code> of input past key value states). Indices of input
sequence tokens in the vocabulary.</p>
<p>If <code>past_key_values</code> is used, only <code>input_ids</code> that do not have their past calculated should be passed as
...
where <em>num_choices</em> is the size of the second dimension of the input tensors. (see <em>input_ids</em> above)`,name:"mc_labels"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/gpt2/modeling_gpt2.py#L1190",returnDescription:`
<p>A <a
...
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/gpt2/modeling_gpt2.py#L1346",returnDescription:`
...
Labels for computing the sequence classification/regression loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>. If <code>config.num_labels == 1</code> a regression loss is computed (Mean-Square loss), If
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/gpt2/modeling_gpt2.py#L1480",returnDescription:`
<p>A <a
...
10X the amount of data.`),ge=p(),E=s("p"),ye=r("Tips:"),U=p(),R=s("ul"),de=s("li"),K=r(`GPT-2 is a model with absolute position embeddings so it\u2019s usually advised to pad the inputs on the right rather than
...
this superclass for more information regarding those methods.`),up=p(),Na=s("div"),v(Rn.$$.fragment),Rl=p(),It=s("h2"),vo=s("a"),Dr=s("span"),v(Bn.$$.fragment),fp=p(),Lr=s("span"),gp=r("GPT2TokenizerFast"),Bl=p(),$e=s("div"),v(Vn.$$.fragment),_p=p(),Kn=s("p"),Tp=r("Construct a \u201Cfast\u201D GPT-2 tokenizer (backed by HuggingFace\u2019s "),Or=s("em"),bp=r("tokenizers"),yp=r(` library). Based on byte-level
...
the model was not pretrained this way, it might yield a decrease in performance.`),xp=p(),v(wo.$$.fragment),Fp=p(),Xn=s("p"),jp=r("This tokenizer inherits from "),Ha=s("a"),zp=r("PreTrainedTokenizerFast"),Ep=r(` which contains most of the main methods. Users should
refer to this superclass for more information regarding those methods.`),Vl=p(),St=s("h2"),$o=s("a"),Ir=s("span"),v(Yn.$$.fragment),qp=p(),Sr=s("span"),Cp=r("GPT2 specific outputs"),Kl=p(),At=s("div"),v(Qn.$$.fragment),Dp=p(),Ar=s("p"),Lp=r("Base class for outputs of models predicting if two sentences are consecutive or not."),Jl=p(),Wt=s("div"),v(Zn.$$.fragment),Op=p(),Wr=s("p"),Np=r("Base class for outputs of models predicting if two sentences are consecutive or not."),Xl=p(),Ut=s("h2"),Po=s("a"),Ur=s("span"),v(es.$$.fragment),Hp=p(),Rr=s("span"),Ip=r("GPT2Model"),Yl=p(),Pe=s("div"),v(ts.$$.fragment),Sp=p(),Br=s("p"),Ap=r("The bare GPT2 Model transformer outputting raw hidden-states without any specific head on top."),Wp=p(),os=s("p"),Up=r("This model inherits from "),Ia=s("a"),Rp=r("PreTrainedModel"),Bp=r(`. Check the superclass documentation for the generic methods the
...
and behavior.`),Yp=p(),lt=s("div"),v(as.$$.fragment),Qp=p(),Rt=s("p"),Zp=r("The "),Sa=s("a"),eh=r("GPT2Model"),th=r(" forward method, overrides the "),Vr=s("code"),oh=r("__call__"),nh=r(" special method."),sh=p(),v(Mo.$$.fragment),ah=p(),v(Go.$$.fragment),rh=p(),dt=s("div"),v(rs.$$.fragment),ih=p(),Kr=s("p"),lh=r("This is an experimental feature and is a subject to change at a moment\u2019s notice."),dh=p(),Jr=s("p"),ch=r(`Uses a device map to distribute attention modules of the model across several devices. If no device map is given,
it will evenly distribute blocks across all devices.`),ph=p(),v(xo.$$.fragment),hh=p(),xt=s("div"),v(is.$$.fragment),mh=p(),Xr=s("p"),uh=r("Moves the model to cpu from a model parallel state."),fh=p(),v(Fo.$$.fragment),Ql=p(),Bt=s("h2"),jo=s("a"),Yr=s("span"),v(ls.$$.fragment),gh=p(),Qr=s("span"),_h=r("GPT2LMHeadModel"),Zl=p(),Me=s("div"),v(ds.$$.fragment),Th=p(),Zr=s("p"),bh=r(`The GPT2 Model transformer with a language modeling head on top (linear layer with weights tied to the input
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),xh=p(),ct=s("div"),v(ms.$$.fragment),Fh=p(),Vt=s("p"),jh=r("The "),Wa=s("a"),zh=r("GPT2LMHeadModel"),Eh=r(" forward method, overrides the "),ei=s("code"),qh=r("__call__"),Ch=r(" special method."),Dh=p(),v(zo.$$.fragment),Lh=p(),v(Eo.$$.fragment),Oh=p(),pt=s("div"),v(us.$$.fragment),Nh=p(),ti=s("p"),Hh=r("This is an experimental feature and is a subject to change at a moment\u2019s notice."),Ih=p(),oi=s("p"),Sh=r(`Uses a device map to distribute attention modules of the model across several devices. If no device map is given,
it will evenly distribute blocks across all devices.`),Ah=p(),v(qo.$$.fragment),Wh=p(),Ft=s("div"),v(fs.$$.fragment),Uh=p(),ni=s("p"),Rh=r("Moves the model to cpu from a model parallel state."),Bh=p(),v(Co.$$.fragment),ed=p(),Kt=s("h2"),Do=s("a"),si=s("span"),v(gs.$$.fragment),Vh=p(),ai=s("span"),Kh=r("GPT2DoubleHeadsModel"),td=p(),Ke=s("div"),v(_s.$$.fragment),Jh=p(),ri=s("p"),Xh=r(`The GPT2 Model transformer with a language modeling and a multiple-choice classification head on top e.g. for
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),am=p(),ht=s("div"),v(vs.$$.fragment),rm=p(),Jt=s("p"),im=r("The "),Ra=s("a"),lm=r("GPT2DoubleHeadsModel"),dm=r(" forward method, overrides the "),ii=s("code"),cm=r("__call__"),pm=r(" special method."),hm=p(),v(Lo.$$.fragment),mm=p(),v(Oo.$$.fragment),od=p(),Xt=s("h2"),No=s("a"),li=s("span"),v(ks.$$.fragment),um=p(),di=s("span"),fm=r("GPT2ForSequenceClassification"),nd=p(),Ge=s("div"),v(ws.$$.fragment),gm=p(),ci=s("p"),_m=r("The GPT2 Model transformer with a sequence classification head on top (linear layer)."),Tm=p(),Ba=s("p"),Va=s("a"),bm=r("GPT2ForSequenceClassification"),ym=r(` uses the last token in order to do the classification, as other causal models
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Hm=p(),je=s("div"),v(Gs.$$.fragment),Im=p(),Yt=s("p"),Sm=r("The "),Ja=s("a"),Am=r("GPT2ForSequenceClassification"),Wm=r(" forward method, overrides the "),fi=s("code"),Um=r("__call__"),Rm=r(" special method."),Bm=p(),v(Ho.$$.fragment),Vm=p(),v(Io.$$.fragment),Km=p(),v(So.$$.fragment),Jm=p(),v(Ao.$$.fragment),Xm=p(),v(Wo.$$.fragment),sd=p(),Qt=s("h2"),Uo=s("a"),gi=s("span"),v(xs.$$.fragment),Ym=p(),_i=s("span"),Qm=r("GPT2ForTokenClassification"),ad=p(),Je=s("div"),v(Fs.$$.fragment),Zm=p(),Ti=s("p"),eu=r(`GPT2 Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g. for
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Zu=p(),v(Zo.$$.fragment),ef=p(),ut=s("div"),v(Rs.$$.fragment),tf=p(),no=s("p"),of=r("The "),tr=s("a"),nf=r("TFGPT2LMHeadModel"),sf=r(" forward method, overrides the "),Gi=s("code"),af=r("__call__"),rf=r(" special method."),lf=p(),v(en.$$.fragment),df=p(),v(tn.$$.fragment),cd=p(),so=s("h2"),on=s("a"),xi=s("span"),v(Bs.$$.fragment),cf=p(),Fi=s("span"),pf=r("TFGPT2DoubleHeadsModel"),pd=p(),Ne=s("div"),v(Vs.$$.fragment),hf=p(),ji=s("p"),mf=r(`The GPT2 Model transformer with a language modeling and a multiple-choice classification head on top e.g. for
RocStories/SWAG tasks. The two heads are two linear layers. The language modeling head has its weights tied to the
input embeddings, the classification head takes as input the input of a specified classification token index in the
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),kf=p(),v(nn.$$.fragment),wf=p(),ft=s("div"),v(Ys.$$.fragment),$f=p(),ao=s("p"),Pf=r("The "),nr=s("a"),Mf=r("TFGPT2DoubleHeadsModel"),Gf=r(" forward method, overrides the "),zi=s("code"),xf=r("__call__"),Ff=r(" special method."),jf=p(),v(sn.$$.fragment),zf=p(),v(an.$$.fragment),hd=p(),ro=s("h2"),rn=s("a"),Ei=s("span"),v(Qs.$$.fragment),Ef=p(),qi=s("span"),qf=r("TFGPT2ForSequenceClassification"),md=p(),he=s("div"),v(Zs.$$.fragment),Cf=p(),Ci=s("p"),Df=r("The GPT2 Model transformer with a sequence classification head on top (linear layer)."),Lf=p(),sr=s("p"),ar=s("a"),Of=r("TFGPT2ForSequenceClassification"),Nf=r(` uses the last token in order to do the classification, as other causal models
...
text. The diversity of the dataset causes this simple goal to contain naturally occurring demonstrations of many tasks
across diverse domains. GPT-2 is a direct scale-up of GPT, with more than 10X the parameters and trained on more than
10X the amount of data.`),Tl.forEach(t),_l.forEach(t),ge=h(o),E=a(o,"P",{});var bl=l(E);ye=i(bl,"Tips:"),bl.forEach(t),U=h(o),R=a(o,"UL",{});var Pt=l(R);de=a(Pt,"LI",{});var yl=l(de);K=i(yl,`GPT-2 is a model with absolute position embeddings so it\u2019s usually advised to pad the inputs on the right rather than
the left.`),yl.forEach(t),ve=h(Pt),oe=a(Pt,"LI",{});var Fa=l(oe);N=i(Fa,`GPT-2 was trained with a causal language modeling (CLM) objective and is therefore powerful at predicting the next
token in a sequence. Leveraging this feature allows GPT-2 to generate syntactically coherent text as it can be
observed in the `),ce=a(Fa,"EM",{});var vl=l(ce);J=i(vl,"run_generation.py"),vl.forEach(t),ke=i(Fa," example script."),Fa.forEach(t),y=h(Pt),x=a(Pt,"LI",{});var me=l(x);ne=i(me,"The model can take the "),Ee=a(me,"EM",{});var kl=l(Ee);Ae=i(kl,"past_key_values"),kl.forEach(t),H=i(me," (for PyTorch) or "),qe=a(me,"EM",{});var wl=l(qe);We=i(wl,"past"),wl.forEach(t),Ue=i(me,` (for TF) as input, which is the previously computed
...
this superclass for more information regarding those methods.`),wd.forEach(t),up=h(Ie),Na=a(Ie,"DIV",{class:!0});var S_=l(Na);k(Rn.$$.fragment,S_),S_.forEach(t),Ie.forEach(t),Rl=h(o),It=a(o,"H2",{class:!0});var $d=l(It);vo=a($d,"A",{id:!0,class:!0,href:!0});var A_=l(vo);Dr=a(A_,"SPAN",{});var W_=l(Dr);k(Bn.$$.fragment,W_),W_.forEach(t),A_.forEach(t),fp=h($d),Lr=a($d,"SPAN",{});var U_=l(Lr);gp=i(U_,"GPT2TokenizerFast"),U_.forEach(t),$d.forEach(t),Bl=h(o),$e=a(o,"DIV",{class:!0});var Qe=l($e);k(Vn.$$.fragment,Qe),_p=h(Qe),Kn=a(Qe,"P",{});var Pd=l(Kn);Tp=i(Pd,"Construct a \u201Cfast\u201D GPT-2 tokenizer (backed by HuggingFace\u2019s "),Or=a(Pd,"EM",{});var R_=l(Or);bp=i(R_,"tokenizers"),R_.forEach(t),yp=i(Pd,` library). Based on byte-level
Byte-Pair-Encoding.`),Pd.forEach(t),vp=h(Qe),Nr=a(Qe,"P",{});var B_=l(Nr);kp=i(B_,"This tokenizer has been trained to treat spaces like parts of the tokens (a bit like sentencepiece) so a word will"),B_.forEach(t),wp=h(Qe),k(ko.$$.fragment,Qe),$p=h(Qe),Jn=a(Qe,"P",{});var Md=l(Jn);Pp=i(Md,"You can get around that behavior by passing "),Hr=a(Md,"CODE",{});var V_=l(Hr);Mp=i(V_,"add_prefix_space=True"),V_.forEach(t),Gp=i(Md,` when instantiating this tokenizer, but since
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Nd.forEach(t),tm=h(jt),bs=a(jt,"P",{});var Hd=l(bs);om=i(Hd,"This model is also a PyTorch "),ys=a(Hd,"A",{href:!0,rel:!0});var GT=l(ys);nm=i(GT,"torch.nn.Module"),GT.forEach(t),sm=i(Hd,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Yd.forEach(t),Zu=h(bt),k(Zo.$$.fragment,bt),ef=h(bt),ut=a(bt,"DIV",{class:!0});var xn=l(ut);k(Rs.$$.fragment,xn),tf=h(xn),no=a(xn,"P",{});var br=l(no);of=i(br,"The "),tr=a(br,"A",{href:!0});var p2=l(tr);nf=i(p2,"TFGPT2LMHeadModel"),p2.forEach(t),sf=i(br," forward method, overrides the "),Gi=a(br,"CODE",{});var h2=l(Gi);af=i(h2,"__call__"),h2.forEach(t),rf=i(br," special method."),br.forEach(t),lf=h(xn),k(en.$$.fragment,xn),df=h(xn),k(tn.$$.fragment,xn),xn.forEach(t),bt.forEach(t),cd=h(o),so=a(o,"H2",{class:!0});var Qd=l(so);on=a(Qd,"A",{id:!0,class:!0,href:!0});var m2=l(on);xi=a(m2,"SPAN",{});var u2=l(xi);k(Bs.$$.fragment,u2),u2.forEach(t),m2.forEach(t),cf=h(Qd),Fi=a(Qd,"SPAN",{});var f2=l(Fi);pf=i(f2,"TFGPT2DoubleHeadsModel"),f2.forEach(t),Qd.forEach(t),pd=h(o),Ne=a(o,"DIV",{class:!0});var yt=l(Ne);k(Vs.$$.fragment,yt),hf=h(yt),ji=a(yt,"P",{});var g2=l(ji);mf=i(g2,`The GPT2 Model transformer with a language modeling and a multiple-choice classification head on top e.g. for
RocStories/SWAG tasks. The two heads are two linear layers. The language modeling head has its weights tied to the
input embeddings, the classification head takes as input the input of a specified classification token index in the
