...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),{c(){d=n("p"),g=r("Example:"),h=c(),b(m.$$.fragment)},l(l){d=s(l,"P",{});var u=a(d);g=i(u,"Example:"),u.forEach(t),h=p(l),y(m.$$.fragment,l)},m(l,u){k(l,d,u),e(d,g),k(l,h,u),E(m,l,u),_=!0},p:le,i(l){_||(w(m.$$.fragment,l),_=!0)},o(l){$(m.$$.fragment,l),_=!1},d(l){l&&t(d),l&&t(h),F(m,l)}}}function Uj(x){let d,g,h,m,_,l,u,M,ue,J,j,ee,D,oe,fe,S,ge,pe,K,O,ne,X,C,P,ae,B,he,re,W,_e,me,q,ke,U,te,ce,R,Te,G,L,se,H,ve;return{c(){d=n("p"),g=r("TF 2.0 models accepts two formats as inputs:"),h=c(),m=n("ul"),_=n("li"),l=r("having all inputs as keyword arguments (like PyTorch models), or"),u=c(),M=n("li"),ue=r("having all inputs as a list, tuple or dict in the first positional arguments."),J=c(),j=n("p"),ee=r("This second option is useful when using "),D=n("code"),oe=r("tf.keras.Model.fit"),fe=r(` method which currently requires having all the
tensors in the first argument of the model call function: `),S=n("code"),ge=r("model(inputs)"),pe=r("."),K=c(),O=n("p"),ne=r(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),X=c(),C=n("ul"),P=n("li"),ae=r("a single Tensor with "),B=n("code"),he=r("input_ids"),re=r(" only and nothing else: "),W=n("code"),_e=r("model(inputs_ids)"),me=c(),q=n("li"),ke=r(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),U=n("code"),te=r("model([input_ids, attention_mask])"),ce=r(" or "),R=n("code"),Te=r("model([input_ids, attention_mask, token_type_ids])"),G=c(),L=n("li"),se=r(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),H=n("code"),ve=r('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(v){d=s(v,"P",{});var z=a(d);g=i(z,"TF 2.0 models accepts two formats as inputs:"),z.forEach(t),h=p(v),m=s(v,"UL",{});var Y=a(m);_=s(Y,"LI",{});var Fe=a(_);l=i(Fe,"having all inputs as keyword arguments (like PyTorch models), or"),Fe.forEach(t),u=p(Y),M=s(Y,"LI",{});var ze=a(M);ue=i(ze,"having all inputs as a list, tuple or dict in the first positional arguments."),ze.forEach(t),Y.forEach(t),J=p(v),j=s(v,"P",{});var N=a(j);ee=i(N,"This second option is useful when using "),D=s(N,"CODE",{});var xe=a(D);oe=i(xe,"tf.keras.Model.fit"),xe.forEach(t),fe=i(N,` method which currently requires having all the
...
<span class="hljs-meta">&gt;&gt;&gt; </span>scores = outputs[<span class="hljs-number">0</span>]`}}),{c(){d=n("p"),g=r("Examples:"),h=c(),b(m.$$.fragment)},l(l){d=s(l,"P",{});var u=a(d);g=i(u,"Examples:"),u.forEach(t),h=p(l),y(m.$$.fragment,l)},m(l,u){k(l,d,u),e(d,g),k(l,h,u),E(m,l,u),_=!0},p:le,i(l){_||(w(m.$$.fragment,l),_=!0)},o(l){$(m.$$.fragment,l),_=!1},d(l){l&&t(d),l&&t(h),F(m,l)}}}function Hj(x){let d,g,h,m,_,l,u,M,ue,J,j,ee,D,oe,fe,S,ge,pe,K,O,ne,X,C,P,ae,B,he,re,W,_e,me,q,ke,U,te,ce,R,Te,G,L,se,H,ve;return{c(){d=n("p"),g=r("TF 2.0 models accepts two formats as inputs:"),h=c(),m=n("ul"),_=n("li"),l=r("having all inputs as keyword arguments (like PyTorch models), or"),u=c(),M=n("li"),ue=r("having all inputs as a list, tuple or dict in the first positional arguments."),J=c(),j=n("p"),ee=r("This second option is useful when using "),D=n("code"),oe=r("tf.keras.Model.fit"),fe=r(` method which currently requires having all the
tensors in the first argument of the model call function: `),S=n("code"),ge=r("model(inputs)"),pe=r("."),K=c(),O=n("p"),ne=r(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),X=c(),C=n("ul"),P=n("li"),ae=r("a single Tensor with "),B=n("code"),he=r("input_ids"),re=r(" only and nothing else: "),W=n("code"),_e=r("model(inputs_ids)"),me=c(),q=n("li"),ke=r(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),U=n("code"),te=r("model([input_ids, attention_mask])"),ce=r(" or "),R=n("code"),Te=r("model([input_ids, attention_mask, token_type_ids])"),G=c(),L=n("li"),se=r(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),H=n("code"),ve=r('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(v){d=s(v,"P",{});var z=a(d);g=i(z,"TF 2.0 models accepts two formats as inputs:"),z.forEach(t),h=p(v),m=s(v,"UL",{});var Y=a(m);_=s(Y,"LI",{});var Fe=a(_);l=i(Fe,"having all inputs as keyword arguments (like PyTorch models), or"),Fe.forEach(t),u=p(Y),M=s(Y,"LI",{});var ze=a(M);ue=i(ze,"having all inputs as a list, tuple or dict in the first positional arguments."),ze.forEach(t),Y.forEach(t),J=p(v),j=s(v,"P",{});var N=a(j);ee=i(N,"This second option is useful when using "),D=s(N,"CODE",{});var xe=a(D);oe=i(xe,"tf.keras.Model.fit"),xe.forEach(t),fe=i(N,` method which currently requires having all the
...
first positional argument :`),je.forEach(t),X=p(v),C=s(v,"UL",{});var A=a(C);P=s(A,"LI",{});var Q=a(P);ae=i(Q,"a single Tensor with "),B=s(Q,"CODE",{});var Ce=a(B);he=i(Ce,"input_ids"),Ce.forEach(t),re=i(Q," only and nothing else: "),W=s(Q,"CODE",{});var $e=a(W);_e=i($e,"model(inputs_ids)"),$e.forEach(t),Q.forEach(t),me=p(A),q=s(A,"LI",{});var V=a(q);ke=i(V,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),U=s(V,"CODE",{});var qe=a(U);te=i(qe,"model([input_ids, attention_mask])"),qe.forEach(t),ce=i(V," or "),R=s(V,"CODE",{});var Me=a(R);Te=i(Me,"model([input_ids, attention_mask, token_type_ids])"),Me.forEach(t),V.forEach(t),G=p(A),L=s(A,"LI",{});var Z=a(L);se=i(Z,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),H=s(Z,"CODE",{});var Ee=a(H);ve=i(Ee,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),Ee.forEach(t),Z.forEach(t),A.forEach(t)},m(v,z){k(v,d,z),e(d,g),k(v,h,z),k(v,m,z),e(m,_),e(_,l),e(m,u),e(m,M),e(M,ue),k(v,J,z),k(v,j,z),e(j,ee),e(j,D),e(D,oe),e(j,fe),e(j,S),e(S,ge),e(j,pe),k(v,K,z),k(v,O,z),e(O,ne),k(v,X,z),k(v,C,z),e(C,P),e(P,ae),e(P,B),e(B,he),e(P,re),e(P,W),e(W,_e),e(C,me),e(C,q),e(q,ke),e(q,U),e(U,te),e(q,ce),e(q,R),e(R,Te),e(C,G),e(C,L),e(L,se),e(L,H),e(H,ve)},d(v){v&&t(d),v&&t(h),v&&t(m),v&&t(J),v&&t(j),v&&t(K),v&&t(O),v&&t(X),v&&t(C)}}}function Qj(x){let d,g,h,m,_;return{c(){d=n("p"),g=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),h=n("code"),m=r("Module"),_=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(l){d=s(l,"P",{});var u=a(d);g=i(u,"Although the recipe for forward pass needs to be defined within this function, one should call the "),h=s(u,"CODE",{});var M=a(h);m=i(M,"Module"),M.forEach(t),_=i(u,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
<span class="hljs-number">1.22</span>`}}),{c(){b(d.$$.fragment)},l(h){y(d.$$.fragment,h)},m(h,m){E(d,h,m),g=!0},p:le,i(h){g||(w(d.$$.fragment,h),g=!0)},o(h){$(d.$$.fragment,h),g=!1},d(h){F(d,h)}}}function Jj(x){let d,g,h,m,_,l,u,M,ue,J,j,ee,D,oe,fe,S,ge,pe,K,O,ne,X,C,P,ae,B,he,re,W,_e,me,q,ke,U,te,ce,R,Te,G,L,se,H,ve;return{c(){d=n("p"),g=r("TF 2.0 models accepts two formats as inputs:"),h=c(),m=n("ul"),_=n("li"),l=r("having all inputs as keyword arguments (like PyTorch models), or"),u=c(),M=n("li"),ue=r("having all inputs as a list, tuple or dict in the first positional arguments."),J=c(),j=n("p"),ee=r("This second option is useful when using "),D=n("code"),oe=r("tf.keras.Model.fit"),fe=r(` method which currently requires having all the
tensors in the first argument of the model call function: `),S=n("code"),ge=r("model(inputs)"),pe=r("."),K=c(),O=n("p"),ne=r(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),X=c(),C=n("ul"),P=n("li"),ae=r("a single Tensor with "),B=n("code"),he=r("input_ids"),re=r(" only and nothing else: "),W=n("code"),_e=r("model(inputs_ids)"),me=c(),q=n("li"),ke=r(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),U=n("code"),te=r("model([input_ids, attention_mask])"),ce=r(" or "),R=n("code"),Te=r("model([input_ids, attention_mask, token_type_ids])"),G=c(),L=n("li"),se=r(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),H=n("code"),ve=r('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(v){d=s(v,"P",{});var z=a(d);g=i(z,"TF 2.0 models accepts two formats as inputs:"),z.forEach(t),h=p(v),m=s(v,"UL",{});var Y=a(m);_=s(Y,"LI",{});var Fe=a(_);l=i(Fe,"having all inputs as keyword arguments (like PyTorch models), or"),Fe.forEach(t),u=p(Y),M=s(Y,"LI",{});var ze=a(M);ue=i(ze,"having all inputs as a list, tuple or dict in the first positional arguments."),ze.forEach(t),Y.forEach(t),J=p(v),j=s(v,"P",{});var N=a(j);ee=i(N,"This second option is useful when using "),D=s(N,"CODE",{});var xe=a(D);oe=i(xe,"tf.keras.Model.fit"),xe.forEach(t),fe=i(N,` method which currently requires having all the
...
<span class="hljs-number">0.06</span>`}}),{c(){b(d.$$.fragment)},l(h){y(d.$$.fragment,h)},m(h,m){E(d,h,m),g=!0},p:le,i(h){g||(w(d.$$.fragment,h),g=!0)},o(h){$(d.$$.fragment,h),g=!1},d(h){F(d,h)}}}function Zj(x){let d,g,h,m,_,l,u,M,ue,J,j,ee,D,oe,fe,S,ge,pe,K,O,ne,X,C,P,ae,B,he,re,W,_e,me,q,ke,U,te,ce,R,Te,G,L,se,H,ve;return{c(){d=n("p"),g=r("TF 2.0 models accepts two formats as inputs:"),h=c(),m=n("ul"),_=n("li"),l=r("having all inputs as keyword arguments (like PyTorch models), or"),u=c(),M=n("li"),ue=r("having all inputs as a list, tuple or dict in the first positional arguments."),J=c(),j=n("p"),ee=r("This second option is useful when using "),D=n("code"),oe=r("tf.keras.Model.fit"),fe=r(` method which currently requires having all the
tensors in the first argument of the model call function: `),S=n("code"),ge=r("model(inputs)"),pe=r("."),K=c(),O=n("p"),ne=r(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),X=c(),C=n("ul"),P=n("li"),ae=r("a single Tensor with "),B=n("code"),he=r("input_ids"),re=r(" only and nothing else: "),W=n("code"),_e=r("model(inputs_ids)"),me=c(),q=n("li"),ke=r(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),U=n("code"),te=r("model([input_ids, attention_mask])"),ce=r(" or "),R=n("code"),Te=r("model([input_ids, attention_mask, token_type_ids])"),G=c(),L=n("li"),se=r(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),H=n("code"),ve=r('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(v){d=s(v,"P",{});var z=a(d);g=i(z,"TF 2.0 models accepts two formats as inputs:"),z.forEach(t),h=p(v),m=s(v,"UL",{});var Y=a(m);_=s(Y,"LI",{});var Fe=a(_);l=i(Fe,"having all inputs as keyword arguments (like PyTorch models), or"),Fe.forEach(t),u=p(Y),M=s(Y,"LI",{});var ze=a(M);ue=i(ze,"having all inputs as a list, tuple or dict in the first positional arguments."),ze.forEach(t),Y.forEach(t),J=p(v),j=s(v,"P",{});var N=a(j);ee=i(N,"This second option is useful when using "),D=s(N,"CODE",{});var xe=a(D);oe=i(xe,"tf.keras.Model.fit"),xe.forEach(t),fe=i(N,` method which currently requires having all the
...
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-comment"># the linear classifier still needs to be trained</span>
<span class="hljs-meta">&gt;&gt;&gt; </span>logits = outputs.logits`}}),{c(){d=n("p"),g=r("Example:"),h=c(),b(m.$$.fragment)},l(l){d=s(l,"P",{});var u=a(d);g=i(u,"Example:"),u.forEach(t),h=p(l),y(m.$$.fragment,l)},m(l,u){k(l,d,u),e(d,g),k(l,h,u),E(m,l,u),_=!0},p:le,i(l){_||(w(m.$$.fragment,l),_=!0)},o(l){$(m.$$.fragment,l),_=!1},d(l){l&&t(d),l&&t(h),F(m,l)}}}function oC(x){let d,g,h,m,_,l,u,M,ue,J,j,ee,D,oe,fe,S,ge,pe,K,O,ne,X,C,P,ae,B,he,re,W,_e,me,q,ke,U,te,ce,R,Te,G,L,se,H,ve;return{c(){d=n("p"),g=r("TF 2.0 models accepts two formats as inputs:"),h=c(),m=n("ul"),_=n("li"),l=r("having all inputs as keyword arguments (like PyTorch models), or"),u=c(),M=n("li"),ue=r("having all inputs as a list, tuple or dict in the first positional arguments."),J=c(),j=n("p"),ee=r("This second option is useful when using "),D=n("code"),oe=r("tf.keras.Model.fit"),fe=r(` method which currently requires having all the
tensors in the first argument of the model call function: `),S=n("code"),ge=r("model(inputs)"),pe=r("."),K=c(),O=n("p"),ne=r(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),X=c(),C=n("ul"),P=n("li"),ae=r("a single Tensor with "),B=n("code"),he=r("input_ids"),re=r(" only and nothing else: "),W=n("code"),_e=r("model(inputs_ids)"),me=c(),q=n("li"),ke=r(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),U=n("code"),te=r("model([input_ids, attention_mask])"),ce=r(" or "),R=n("code"),Te=r("model([input_ids, attention_mask, token_type_ids])"),G=c(),L=n("li"),se=r(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),H=n("code"),ve=r('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(v){d=s(v,"P",{});var z=a(d);g=i(z,"TF 2.0 models accepts two formats as inputs:"),z.forEach(t),h=p(v),m=s(v,"UL",{});var Y=a(m);_=s(Y,"LI",{});var Fe=a(_);l=i(Fe,"having all inputs as keyword arguments (like PyTorch models), or"),Fe.forEach(t),u=p(Y),M=s(Y,"LI",{});var ze=a(M);ue=i(ze,"having all inputs as a list, tuple or dict in the first positional arguments."),ze.forEach(t),Y.forEach(t),J=p(v),j=s(v,"P",{});var N=a(j);ee=i(N,"This second option is useful when using "),D=s(N,"CODE",{});var xe=a(D);oe=i(xe,"tf.keras.Model.fit"),xe.forEach(t),fe=i(N,` method which currently requires having all the
...
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-built_in">round</span>(<span class="hljs-built_in">float</span>(loss), <span class="hljs-number">2</span>)
<span class="hljs-number">0.11</span>`}}),{c(){b(d.$$.fragment)},l(h){y(d.$$.fragment,h)},m(h,m){E(d,h,m),g=!0},p:le,i(h){g||(w(d.$$.fragment,h),g=!0)},o(h){$(d.$$.fragment,h),g=!1},d(h){F(d,h)}}}function rC(x){let d,g,h,m,_,l,u,M,ue,J,j,ee,D,oe,fe,S,ge,pe,K,O,ne,X,C,P,ae,B,he,re,W,_e,me,q,ke,U,te,ce,R,Te,G,L,se,H,ve;return{c(){d=n("p"),g=r("TF 2.0 models accepts two formats as inputs:"),h=c(),m=n("ul"),_=n("li"),l=r("having all inputs as keyword arguments (like PyTorch models), or"),u=c(),M=n("li"),ue=r("having all inputs as a list, tuple or dict in the first positional arguments."),J=c(),j=n("p"),ee=r("This second option is useful when using "),D=n("code"),oe=r("tf.keras.Model.fit"),fe=r(` method which currently requires having all the
tensors in the first argument of the model call function: `),S=n("code"),ge=r("model(inputs)"),pe=r("."),K=c(),O=n("p"),ne=r(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),X=c(),C=n("ul"),P=n("li"),ae=r("a single Tensor with "),B=n("code"),he=r("input_ids"),re=r(" only and nothing else: "),W=n("code"),_e=r("model(inputs_ids)"),me=c(),q=n("li"),ke=r(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),U=n("code"),te=r("model([input_ids, attention_mask])"),ce=r(" or "),R=n("code"),Te=r("model([input_ids, attention_mask, token_type_ids])"),G=c(),L=n("li"),se=r(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),H=n("code"),ve=r('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(v){d=s(v,"P",{});var z=a(d);g=i(z,"TF 2.0 models accepts two formats as inputs:"),z.forEach(t),h=p(v),m=s(v,"UL",{});var Y=a(m);_=s(Y,"LI",{});var Fe=a(_);l=i(Fe,"having all inputs as keyword arguments (like PyTorch models), or"),Fe.forEach(t),u=p(Y),M=s(Y,"LI",{});var ze=a(M);ue=i(ze,"having all inputs as a list, tuple or dict in the first positional arguments."),ze.forEach(t),Y.forEach(t),J=p(v),j=s(v,"P",{});var N=a(j);ee=i(N,"This second option is useful when using "),D=s(N,"CODE",{});var xe=a(D);oe=i(xe,"tf.keras.Model.fit"),xe.forEach(t),fe=i(N,` method which currently requires having all the
...
<span class="hljs-meta">&gt;&gt;&gt; </span>end_scores = outputs.end_logits`}}),{c(){d=n("p"),g=r("Example:"),h=c(),b(m.$$.fragment)},l(l){d=s(l,"P",{});var u=a(d);g=i(u,"Example:"),u.forEach(t),h=p(l),y(m.$$.fragment,l)},m(l,u){k(l,d,u),e(d,g),k(l,h,u),E(m,l,u),_=!0},p:le,i(l){_||(w(m.$$.fragment,l),_=!0)},o(l){$(m.$$.fragment,l),_=!1},d(l){l&&t(d),l&&t(h),F(m,l)}}}function FC(x){let d,g,h,m,_,l,u,M,ue,J,j,ee,D,oe,fe,S,ge,pe,K,O,ne,X,C,P,ae,B,he,re,W,_e,me,q,ke,U,te,ce,R,Te,G,L,se,H,ve,v,z,Y,Fe,ze,N,xe,be,je,A,Q,Ce,$e,V,qe,Me,Z,Ee,Dc,Pa,Vg,Sc,Kg,Fu,yt,Aa,Jg,Vt,Gg,_d,Xg,Yg,kd,Zg,e_,Oa,t_,o_,n_,vo,s_,Td,a_,r_,vd,i_,l_,d_,wn,xu,bo,$n,Wc,La,c_,Uc,p_,Mu,Et,Na,h_,Bc,m_,u_,Fn,bd,f_,g_,yd,__,k_,T_,Ia,v_,Ed,b_,y_,zu,yo,xn,Rc,Da,E_,Hc,w_,ju,wt,Sa,$_,Wa,F_,Qc,x_,M_,z_,Mn,wd,j_,C_,$d,q_,P_,A_,Ua,O_,Fd,L_,N_,Cu,Eo,zn,Vc,Ba,I_,Kc,D_,qu,wo,Ra,S_,Ha,W_,xd,U_,B_,Pu,$o,Qa,R_,Va,H_,Md,Q_,V_,Au,Fo,jn,Jc,Ka,K_,Gc,J_,Ou,et,Ja,G_,Xc,X_,Y_,Ga,Z_,zd,ek,tk,ok,Xa,nk,Ya,sk,ak,rk,$t,Za,ik,xo,lk,jd,dk,ck,Yc,pk,hk,mk,Cn,uk,qn,Lu,Mo,Pn,Zc,er,fk,ep,gk,Nu,He,tr,_k,tp,kk,Tk,op,vk,bk,or,yk,Cd,Ek,wk,$k,nr,Fk,sr,xk,Mk,zk,Ft,ar,jk,zo,Ck,qd,qk,Pk,np,Ak,Ok,Lk,An,Nk,On,Iu,jo,Ln,sp,rr,Ik,ap,Dk,Du,tt,ir,Sk,lr,Wk,rp,Uk,Bk,Rk,dr,Hk,Pd,Qk,Vk,Kk,cr,Jk,pr,Gk,Xk,Yk,xt,hr,Zk,Co,eT,Ad,tT,oT,ip,nT,sT,aT,Nn,rT,In,Su,qo,Dn,lp,mr,iT,dp,lT,Wu,Qe,ur,dT,cp,cT,pT,pp,hT,mT,fr,uT,Od,fT,gT,_T,gr,kT,_r,TT,vT,bT,at,kr,yT,Po,ET,Ld,wT,$T,hp,FT,xT,MT,Sn,zT,Wn,jT,Un,Uu,Ao,Bn,mp,Tr,CT,up,qT,Bu,ot,vr,PT,fp,AT,OT,br,LT,Nd,NT,IT,DT,yr,ST,Er,WT,UT,BT,Re,wr,RT,Oo,HT,Id,QT,VT,gp,KT,JT,GT,Rn,XT,Hn,YT,Qn,ZT,Vn,ev,Kn,Ru,Lo,Jn,_p,$r,tv,kp,ov,Hu,nt,Fr,nv,Tp,sv,av,xr,rv,Dd,iv,lv,dv,Mr,cv,zr,pv,hv,mv,Mt,jr,uv,No,fv,Sd,gv,_v,vp,kv,Tv,vv,Gn,bv,Xn,Qu,Io,Yn,bp,Cr,yv,yp,Ev,Vu,Ve,qr,wv,Ep,$v,Fv,wp,xv,Mv,Pr,zv,Wd,jv,Cv,qv,Ar,Pv,Or,Av,Ov,Lv,rt,Lr,Nv,Do,Iv,Ud,Dv,Sv,$p,Wv,Uv,Bv,Zn,Rv,es,Hv,ts,Ku,So,os,Fp,Nr,Qv,xp,Vv,Ju,st,Ir,Kv,Wo,Jv,Mp,Gv,Xv,zp,Yv,Zv,eb,Dr,tb,Bd,ob,nb,sb,Sr,ab,Wr,rb,ib,lb,it,Ur,db,Uo,cb,Rd,pb,hb,jp,mb,ub,fb,ns,gb,ss,_b,as,Gu,Bo,rs,Cp,Br,kb,qp,Tb,Xu,Ke,Rr,vb,Pp,bb,yb,Hr,Eb,Hd,wb,$b,Fb,Qr,xb,Vr,Mb,zb,jb,is,Cb,zt,Kr,qb,Ro,Pb,Qd,Ab,Ob,Ap,Lb,Nb,Ib,ls,Db,ds,Yu,Ho,cs,Op,Jr,Sb,Lp,Wb,Zu,Oe,Gr,Ub,Np,Bb,Rb,Ip,Hb,Qb,Xr,Vb,Vd,Kb,Jb,Gb,Yr,Xb,Zr,Yb,Zb,ey,ps,ty,jt,ei,oy,Qo,ny,Kd,sy,ay,Dp,ry,iy,ly,hs,dy,ms,ef,Vo,us,Sp,ti,cy,Wp,py,tf,Le,oi,hy,Up,my,uy,Bp,fy,gy,ni,_y,Jd,ky,Ty,vy,si,by,ai,yy,Ey,wy,fs,$y,lt,ri,Fy,Ko,xy,Gd,My,zy,Rp,jy,Cy,qy,gs,Py,_s,Ay,ks,of,Jo,Ts,Hp,ii,Oy,Qp,Ly,nf,Je,li,Ny,Vp,Iy,Dy,di,Sy,Xd,Wy,Uy,By,ci,Ry,pi,Hy,Qy,Vy,vs,Ky,dt,hi,Jy,Go,Gy,Yd,Xy,Yy,Kp,Zy,eE,tE,bs,oE,ys,nE,Es,sf,Xo,ws,Jp,mi,sE,Gp,aE,af,Ge,ui,rE,Xp,iE,lE,fi,dE,Zd,cE,pE,hE,gi,mE,_i,uE,fE,gE,$s,_E,Ct,ki,kE,Yo,TE,ec,vE,bE,Yp,yE,EE,wE,Fs,$E,xs,rf,Zo,Ms,Zp,Ti,FE,eh,xE,lf,Ne,vi,ME,th,zE,jE,oh,CE,qE,bi,PE,tc,AE,OE,LE,yi,NE,Ei,IE,DE,SE,zs,WE,ct,wi,UE,en,BE,oc,RE,HE,nh,QE,VE,KE,js,JE,Cs,GE,qs,df,tn,Ps,sh,$i,XE,ah,YE,cf,Xe,Fi,ZE,on,ew,rh,tw,ow,ih,nw,sw,aw,xi,rw,nc,iw,lw,dw,Mi,cw,zi,pw,hw,mw,As,uw,pt,ji,fw,nn,gw,sc,_w,kw,lh,Tw,vw,bw,Os,yw,Ls,Ew,Ns,pf,sn,Is,dh,Ci,ww,ch,$w,hf,Ie,qi,Fw,ph,xw,Mw,Pi,zw,ac,jw,Cw,qw,Ai,Pw,Oi,Aw,Ow,Lw,hh,Nw,Iw,Kt,mh,Li,Dw,Sw,uh,Ni,Ww,Uw,fh,Ii,Bw,Rw,gh,Di,Hw,Qw,qt,Si,Vw,an,Kw,_h,Jw,Gw,kh,Xw,Yw,Zw,Ds,e$,Ss,mf,rn,Ws,Th,Wi,t$,vh,o$,uf,Pe,Ui,n$,bh,s$,a$,yh,r$,i$,Bi,l$,rc,d$,c$,p$,Ri,h$,Hi,m$,u$,f$,Eh,g$,_$,Jt,wh,Qi,k$,T$,$h,Vi,v$,b$,Fh,Ki,y$,E$,xh,Ji,w$,$$,Pt,Gi,F$,ln,x$,Mh,M$,z$,zh,j$,C$,q$,Us,P$,Bs,ff,dn,Rs,jh,Xi,A$,Ch,O$,gf,De,Yi,L$,qh,N$,I$,Zi,D$,ic,S$,W$,U$,el,B$,tl,R$,H$,Q$,Ph,V$,K$,Gt,Ah,ol,J$,G$,Oh,nl,X$,Y$,Lh,sl,Z$,e1,Nh,al,t1,o1,At,rl,n1,cn,s1,Ih,a1,r1,Dh,i1,l1,d1,Hs,c1,Qs,_f,pn,Vs,Sh,il,p1,Wh,h1,kf,Se,ll,m1,dl,u1,Uh,f1,g1,_1,cl,k1,lc,T1,v1,b1,pl,y1,hl,E1,w1,$1,Bh,F1,x1,Xt,Rh,ml,M1,z1,Hh,ul,j1,C1,Qh,fl,q1,P1,Vh,gl,A1,O1,Ot,_l,L1,hn,N1,Kh,I1,D1,Jh,S1,W1,U1,Ks,B1,Js,Tf,mn,Gs,Gh,kl,R1,Xh,H1,vf,We,Tl,Q1,Yh,V1,K1,vl,J1,dc,G1,X1,Y1,bl,Z1,yl,e2,t2,o2,Zh,n2,s2,Yt,em,El,a2,r2,tm,wl,i2,l2,om,$l,d2,c2,nm,Fl,p2,h2,Lt,xl,m2,un,u2,sm,f2,g2,am,_2,k2,T2,Xs,v2,Ys,bf,fn,Zs,rm,Ml,b2,im,y2,yf,Ue,zl,E2,lm,w2,$2,jl,F2,cc,x2,M2,z2,Cl,j2,ql,C2,q2,P2,dm,A2,O2,Zt,cm,Pl,L2,N2,pm,Al,I2,D2,hm,Ol,S2,W2,mm,Ll,U2,B2,Nt,Nl,R2,gn,H2,um,Q2,V2,fm,K2,J2,G2,ea,X2,ta,Ef,_n,oa,gm,Il,Y2,_m,Z2,wf,Ae,Dl,eF,km,tF,oF,Tm,nF,sF,Sl,aF,pc,rF,iF,lF,Wl,dF,Ul,cF,pF,hF,vm,mF,uF,eo,bm,Bl,fF,gF,ym,Rl,_F,kF,Em,Hl,TF,vF,wm,Ql,bF,yF,It,Vl,EF,kn,wF,$m,$F,FF,Fm,xF,MF,zF,na,jF,sa,$f,Tn,aa,xm,Kl,CF,Mm,qF,Ff,Be,Jl,PF,vn,AF,zm,OF,LF,jm,NF,IF,DF,Gl,SF,hc,WF,UF,BF,Xl,RF,Yl,HF,QF,VF,Cm,KF,JF,to,qm,Zl,GF,XF,Pm,ed,YF,ZF,Am,td,e0,t0,Om,od,o0,n0,Dt,nd,s0,bn,a0,Lm,r0,i0,Nm,l0,d0,c0,ra,p0,ia,xf;return l=new we({}),oe=new we({}),Pa=new we({}),Aa=new I({props:{name:"class transformers.ElectraConfig",anchor:"transformers.ElectraConfig",parameters:[{name:"vocab_size",val:" = 30522"},{name:"embedding_size",val:" = 128"},{name:"hidden_size",val:" = 256"},{name:"num_hidden_layers",val:" = 12"},{name:"num_attention_heads",val:" = 4"},{name:"intermediate_size",val:" = 1024"},{name:"hidden_act",val:" = 'gelu'"},{name:"hidden_dropout_prob",val:" = 0.1"},{name:"attention_probs_dropout_prob",val:" = 0.1"},{name:"max_position_embeddings",val:" = 512"},{name:"type_vocab_size",val:" = 2"},{name:"initializer_range",val:" = 0.02"},{name:"layer_norm_eps",val:" = 1e-12"},{name:"summary_type",val:" = 'first'"},{name:"summary_use_proj",val:" = True"},{name:"summary_activation",val:" = 'gelu'"},{name:"summary_last_dropout",val:" = 0.1"},{name:"pad_token_id",val:" = 0"},{name:"position_embedding_type",val:" = 'absolute'"},{name:"use_cache",val:" = True"},{name:"classifier_dropout",val:" = None"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.ElectraConfig.vocab_size",description:`<strong>vocab_size</strong> (<code>int</code>, <em>optional</em>, defaults to 30522) &#x2014;
...
Whether or not to return a <a href="/docs/transformers/main/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/electra/modeling_electra.py#L837",returnDescription:`
<p>A <a
...
</ul>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/electra/modeling_electra.py#L1070",returnDescription:`
<p>A <a
...
<code>past_key_values</code>).`,name:"use_cache"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/electra/modeling_electra.py#L1555",returnDescription:`
<p>A <a
...
loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/electra/modeling_electra.py#L1184",returnDescription:`
<p>A <a
...
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/electra/modeling_electra.py#L973",returnDescription:`
<p>A <a
...
<code>input_ids</code> above)`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/electra/modeling_electra.py#L1459",returnDescription:`
<p>A <a
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/electra/modeling_electra.py#L1271",returnDescription:`
<p>A <a
...
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/electra/modeling_electra.py#L1353",returnDescription:`
<p>A <a
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/main/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/electra/modeling_flax_electra.py#L894"}}),Si=new I({props:{name:"__call__",anchor:"transformers.FlaxElectraModel.__call__",parameters:[{name:"input_ids",val:""},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"encoder_hidden_states",val:" = None"},{name:"encoder_attention_mask",val:" = None"},{name:"params",val:": dict = None"},{name:"dropout_rng",val:": PRNGKey = None"},{name:"train",val:": bool = False"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"past_key_values",val:": dict = None"}],parametersDescription:[{anchor:"transformers.FlaxElectraModel.__call__.input_ids",description:`<strong>input_ids</strong> (<code>numpy.ndarray</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/main/en/model_doc/electra#transformers.ElectraTokenizer">ElectraTokenizer</a>. See <a href="/docs/transformers/main/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/main/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
Whether or not to return a <a href="/docs/transformers/main/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/electra/modeling_flax_electra.py#L746",returnDescription:`
<p>A <a
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/main/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/electra/modeling_flax_electra.py#L1043"}}),Gi=new I({props:{name:"__call__",anchor:"transformers.FlaxElectraForPreTraining.__call__",parameters:[{name:"input_ids",val:""},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"encoder_hidden_states",val:" = None"},{name:"encoder_attention_mask",val:" = None"},{name:"params",val:": dict = None"},{name:"dropout_rng",val:": PRNGKey = None"},{name:"train",val:": bool = False"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"past_key_values",val:": dict = None"}],parametersDescription:[{anchor:"transformers.FlaxElectraForPreTraining.__call__.input_ids",description:`<strong>input_ids</strong> (<code>numpy.ndarray</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/main/en/model_doc/electra#transformers.ElectraTokenizer">ElectraTokenizer</a>. See <a href="/docs/transformers/main/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/main/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/main/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/electra/modeling_flax_electra.py#L1526"}}),rl=new I({props:{name:"__call__",anchor:"transformers.FlaxElectraForCausalLM.__call__",parameters:[{name:"input_ids",val:""},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"encoder_hidden_states",val:" = None"},{name:"encoder_attention_mask",val:" = None"},{name:"params",val:": dict = None"},{name:"dropout_rng",val:": PRNGKey = None"},{name:"train",val:": bool = False"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"past_key_values",val:": dict = None"}],parametersDescription:[{anchor:"transformers.FlaxElectraForCausalLM.__call__.input_ids",description:`<strong>input_ids</strong> (<code>numpy.ndarray</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/main/en/model_doc/electra#transformers.ElectraTokenizer">ElectraTokenizer</a>. See <a href="/docs/transformers/main/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/main/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/main/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/electra/modeling_flax_electra.py#L980"}}),_l=new I({props:{name:"__call__",anchor:"transformers.FlaxElectraForMaskedLM.__call__",parameters:[{name:"input_ids",val:""},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"encoder_hidden_states",val:" = None"},{name:"encoder_attention_mask",val:" = None"},{name:"params",val:": dict = None"},{name:"dropout_rng",val:": PRNGKey = None"},{name:"train",val:": bool = False"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"past_key_values",val:": dict = None"}],parametersDescription:[{anchor:"transformers.FlaxElectraForMaskedLM.__call__.input_ids",description:`<strong>input_ids</strong> (<code>numpy.ndarray</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/main/en/model_doc/electra#transformers.ElectraTokenizer">ElectraTokenizer</a>. See <a href="/docs/transformers/main/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/main/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/main/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/electra/modeling_flax_electra.py#L1353"}}),nd=new I({props:{name:"__call__",anchor:"transformers.FlaxElectraForQuestionAnswering.__call__",parameters:[{name:"input_ids",val:""},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"encoder_hidden_states",val:" = None"},{name:"encoder_attention_mask",val:" = None"},{name:"params",val:": dict = None"},{name:"dropout_rng",val:": PRNGKey = None"},{name:"train",val:": bool = False"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"past_key_values",val:": dict = None"}],parametersDescription:[{anchor:"transformers.FlaxElectraForQuestionAnswering.__call__.input_ids",description:`<strong>input_ids</strong> (<code>numpy.ndarray</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/main/en/model_doc/electra#transformers.ElectraTokenizer">ElectraTokenizer</a>. See <a href="/docs/transformers/main/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/main/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
layer is used.`),Te=c(),G=n("li"),L=r("The ELECTRA checkpoints saved using "),se=n("a"),H=r("Google Research\u2019s implementation"),ve=r(`
...
wordpiece.`),T_=c(),Ia=n("p"),v_=r("Refer to superclass "),Ed=n("a"),b_=r("BertTokenizer"),y_=r(" for usage examples and documentation concerning parameters."),zu=c(),yo=n("h2"),xn=n("a"),Rc=n("span"),b(Da.$$.fragment),E_=c(),Hc=n("span"),w_=r("ElectraTokenizerFast"),ju=c(),wt=n("div"),b(Sa.$$.fragment),$_=c(),Wa=n("p"),F_=r("Construct a \u201Cfast\u201D ELECTRA tokenizer (backed by HuggingFace\u2019s "),Qc=n("em"),x_=r("tokenizers"),M_=r(" library)."),z_=c(),Mn=n("p"),wd=n("a"),j_=r("ElectraTokenizerFast"),C_=r(" is identical to "),$d=n("a"),q_=r("BertTokenizerFast"),P_=r(` and runs end-to-end tokenization: punctuation
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Yk=c(),xt=n("div"),b(hr.$$.fragment),Zk=c(),Co=n("p"),eT=r("The "),Ad=n("a"),tT=r("ElectraForCausalLM"),oT=r(" forward method, overrides the "),ip=n("code"),nT=r("__call__"),sT=r(" special method."),aT=c(),b(Nn.$$.fragment),rT=c(),b(In.$$.fragment),Su=c(),qo=n("h2"),Dn=n("a"),lp=n("span"),b(mr.$$.fragment),iT=c(),dp=n("span"),lT=r("ElectraForMaskedLM"),Wu=c(),Qe=n("div"),b(ur.$$.fragment),dT=c(),cp=n("p"),cT=r("Electra model with a language modeling head on top."),pT=c(),pp=n("p"),hT=r(`Even though both the discriminator and generator may be loaded into this model, the generator is the only model of
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),bT=c(),at=n("div"),b(kr.$$.fragment),yT=c(),Po=n("p"),ET=r("The "),Ld=n("a"),wT=r("ElectraForMaskedLM"),$T=r(" forward method, overrides the "),hp=n("code"),FT=r("__call__"),xT=r(" special method."),MT=c(),b(Sn.$$.fragment),zT=c(),b(Wn.$$.fragment),jT=c(),b(Un.$$.fragment),Uu=c(),Ao=n("h2"),Bn=n("a"),mp=n("span"),b(Tr.$$.fragment),CT=c(),up=n("span"),qT=r("ElectraForSequenceClassification"),Bu=c(),ot=n("div"),b(vr.$$.fragment),PT=c(),fp=n("p"),AT=r(`ELECTRA Model transformer with a sequence classification/regression head on top (a linear layer on top of the
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),BT=c(),Re=n("div"),b(wr.$$.fragment),RT=c(),Oo=n("p"),HT=r("The "),Id=n("a"),QT=r("ElectraForSequenceClassification"),VT=r(" forward method, overrides the "),gp=n("code"),KT=r("__call__"),JT=r(" special method."),GT=c(),b(Rn.$$.fragment),XT=c(),b(Hn.$$.fragment),YT=c(),b(Qn.$$.fragment),ZT=c(),b(Vn.$$.fragment),ev=c(),b(Kn.$$.fragment),Ru=c(),Lo=n("h2"),Jn=n("a"),_p=n("span"),b($r.$$.fragment),tv=c(),kp=n("span"),ov=r("ElectraForMultipleChoice"),Hu=c(),nt=n("div"),b(Fr.$$.fragment),nv=c(),Tp=n("p"),sv=r(`ELECTRA Model with a multiple choice classification head on top (a linear layer on top of the pooled output and a
...
layers on top of the hidden-states output to compute `),Mp=n("code"),Gv=r("span start logits"),Xv=r(" and "),zp=n("code"),Yv=r("span end logits"),Zv=r(")."),eb=c(),Dr=n("p"),tb=r("This model inherits from "),Bd=n("a"),ob=r("PreTrainedModel"),nb=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),sb=c(),Sr=n("p"),ab=r("This model is also a PyTorch "),Wr=n("a"),rb=r("torch.nn.Module"),ib=r(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),lb=c(),it=n("div"),b(Ur.$$.fragment),db=c(),Uo=n("p"),cb=r("The "),Rd=n("a"),pb=r("ElectraForQuestionAnswering"),hb=r(" forward method, overrides the "),jp=n("code"),mb=r("__call__"),ub=r(" special method."),fb=c(),b(ns.$$.fragment),gb=c(),b(ss.$$.fragment),_b=c(),b(as.$$.fragment),Gu=c(),Bo=n("h2"),rs=n("a"),Cp=n("span"),b(Br.$$.fragment),kb=c(),qp=n("span"),Tb=r("TFElectraModel"),Xu=c(),Ke=n("div"),b(Rr.$$.fragment),vb=c(),Pp=n("p"),bb=r("The bare Electra Model transformer outputting raw hidden-states without any specific head on top. Identical to the BERT model except that it uses an additional linear layer between the embedding layer and the encoder if the hidden size and embedding size are different. Both the generator and discriminator checkpoints may be loaded into this model."),yb=c(),Hr=n("p"),Eb=r("This model inherits from "),Hd=n("a"),wb=r("TFPreTrainedModel"),$b=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),wy=c(),b(fs.$$.fragment),$y=c(),lt=n("div"),b(ri.$$.fragment),Fy=c(),Ko=n("p"),xy=r("The "),Gd=n("a"),My=r("TFElectraForMaskedLM"),zy=r(" forward method, overrides the "),Rp=n("code"),jy=r("__call__"),Cy=r(" special method."),qy=c(),b(gs.$$.fragment),Py=c(),b(_s.$$.fragment),Ay=c(),b(ks.$$.fragment),of=c(),Jo=n("h2"),Ts=n("a"),Hp=n("span"),b(ii.$$.fragment),Oy=c(),Qp=n("span"),Ly=r("TFElectraForSequenceClassification"),nf=c(),Je=n("div"),b(li.$$.fragment),Ny=c(),Vp=n("p"),Iy=r(`ELECTRA Model transformer with a sequence classification/regression head on top (a linear layer on top of the
...
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),$1=c(),Bh=n("p"),F1=r("Finally, this model supports inherent JAX features such as:"),x1=c(),Xt=n("ul"),Rh=n("li"),ml=n("a"),M1=r("Just-In-Time (JIT) compilation"),z1=c(),Hh=n("li"),ul=n("a"),j1=r("Automatic Differentiation"),C1=c(),Qh=n("li"),fl=n("a"),q1=r("Vectorization"),P1=c(),Vh=n("li"),gl=n("a"),A1=r("Parallelization"),O1=c(),Ot=n("div"),b(_l.$$.fragment),L1=c(),hn=n("p"),N1=r("The "),Kh=n("code"),I1=r("FlaxElectraPreTrainedModel"),D1=r(" forward method, overrides the "),Jh=n("code"),S1=r("__call__"),W1=r(" special method."),U1=c(),b(Ks.$$.fragment),B1=c(),b(Js.$$.fragment),Tf=c(),mn=n("h2"),Gs=n("a"),Gh=n("span"),b(kl.$$.fragment),R1=c(),Xh=n("span"),H1=r("FlaxElectraForSequenceClassification"),vf=c(),We=n("div"),b(Tl.$$.fragment),Q1=c(),Yh=n("p"),V1=r(`Electra Model transformer with a sequence classification/regression head on top (a linear layer on top of the
...
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),hF=c(),vm=n("p"),mF=r("Finally, this model supports inherent JAX features such as:"),uF=c(),eo=n("ul"),bm=n("li"),Bl=n("a"),fF=r("Just-In-Time (JIT) compilation"),gF=c(),ym=n("li"),Rl=n("a"),_F=r("Automatic Differentiation"),kF=c(),Em=n("li"),Hl=n("a"),TF=r("Vectorization"),vF=c(),wm=n("li"),Ql=n("a"),bF=r("Parallelization"),yF=c(),It=n("div"),b(Vl.$$.fragment),EF=c(),kn=n("p"),wF=r("The "),$m=n("code"),$F=r("FlaxElectraPreTrainedModel"),FF=r(" forward method, overrides the "),Fm=n("code"),xF=r("__call__"),MF=r(" special method."),zF=c(),b(na.$$.fragment),jF=c(),b(sa.$$.fragment),$f=c(),Tn=n("h2"),aa=n("a"),xm=n("span"),b(Kl.$$.fragment),CF=c(),Mm=n("span"),qF=r("FlaxElectraForQuestionAnswering"),Ff=c(),Be=n("div"),b(Jl.$$.fragment),PF=c(),vn=n("p"),AF=r(`ELECTRA Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
...
while the hidden size is larger. An additional projection layer (linear) is used to project the embeddings from their
embedding size to the hidden size. In the case where the embedding size is the same as the hidden size, no projection
layer is used.`),Jm.forEach(t),Te=p(id),G=s(id,"LI",{});var oo=a(G);L=i(oo,"The ELECTRA checkpoints saved using "),se=s(oo,"A",{href:!0,rel:!0});var Gm=a(se);H=i(Gm,"Google Research\u2019s implementation"),Gm.forEach(t),ve=i(oo,`
contain both the generator and discriminator. The conversion script requires the user to name which model to export
into the correct architecture. Once converted to the HuggingFace format, these checkpoints may be loaded into all
available ELECTRA models, however. This means that the discriminator may be loaded in the
...
wordpiece.`),la.forEach(t),T_=p(ao),Ia=s(ao,"P",{});var cd=a(Ia);v_=i(cd,"Refer to superclass "),Ed=s(cd,"A",{href:!0});var fu=a(Ed);b_=i(fu,"BertTokenizer"),fu.forEach(t),y_=i(cd," for usage examples and documentation concerning parameters."),cd.forEach(t),ao.forEach(t),zu=p(o),yo=s(o,"H2",{class:!0});var pd=a(yo);xn=s(pd,"A",{id:!0,class:!0,href:!0});var gu=a(xn);Rc=s(gu,"SPAN",{});var _u=a(Rc);y(Da.$$.fragment,_u),_u.forEach(t),gu.forEach(t),E_=p(pd),Hc=s(pd,"SPAN",{});var ku=a(Hc);w_=i(ku,"ElectraTokenizerFast"),ku.forEach(t),pd.forEach(t),ju=p(o),wt=s(o,"DIV",{class:!0});var ro=a(wt);y(Sa.$$.fragment,ro),$_=p(ro),Wa=s(ro,"P",{});var hd=a(Wa);F_=i(hd,"Construct a \u201Cfast\u201D ELECTRA tokenizer (backed by HuggingFace\u2019s "),Qc=s(hd,"EM",{});var Tu=a(Qc);x_=i(Tu,"tokenizers"),Tu.forEach(t),M_=i(hd," library)."),hd.forEach(t),z_=p(ro),Mn=s(ro,"P",{});var da=a(Mn);wd=s(da,"A",{href:!0});var vu=a(wd);j_=i(vu,"ElectraTokenizerFast"),vu.forEach(t),C_=i(da," is identical to "),$d=s(da,"A",{href:!0});var bu=a($d);q_=i(bu,"BertTokenizerFast"),bu.forEach(t),P_=i(da,` and runs end-to-end tokenization: punctuation
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Df.forEach(t),Yk=p(lo),xt=s(lo,"DIV",{class:!0});var ha=a(xt);y(hr.$$.fragment,ha),Zk=p(ha),Co=s(ha,"P",{});var fc=a(Co);eT=i(fc,"The "),Ad=s(fc,"A",{href:!0});var N0=a(Ad);tT=i(N0,"ElectraForCausalLM"),N0.forEach(t),oT=i(fc," forward method, overrides the "),ip=s(fc,"CODE",{});var I0=a(ip);nT=i(I0,"__call__"),I0.forEach(t),sT=i(fc," special method."),fc.forEach(t),aT=p(ha),y(Nn.$$.fragment,ha),rT=p(ha),y(In.$$.fragment,ha),ha.forEach(t),lo.forEach(t),Su=p(o),qo=s(o,"H2",{class:!0});var Sf=a(qo);Dn=s(Sf,"A",{id:!0,class:!0,href:!0});var D0=a(Dn);lp=s(D0,"SPAN",{});var S0=a(lp);y(mr.$$.fragment,S0),S0.forEach(t),D0.forEach(t),iT=p(Sf),dp=s(Sf,"SPAN",{});var W0=a(dp);lT=i(W0,"ElectraForMaskedLM"),W0.forEach(t),Sf.forEach(t),Wu=p(o),Qe=s(o,"DIV",{class:!0});var Wt=a(Qe);y(ur.$$.fragment,Wt),dT=p(Wt),cp=s(Wt,"P",{});var U0=a(cp);cT=i(U0,"Electra model with a language modeling head on top."),U0.forEach(t),pT=p(Wt),pp=s(Wt,"P",{});var B0=a(pp);hT=i(B0,`Even though both the discriminator and generator may be loaded into this model, the generator is the only model of
the two to have been trained for the masked language modeling task.`),B0.forEach(t),mT=p(Wt),fr=s(Wt,"P",{});var Wf=a(fr);uT=i(Wf,"This model inherits from "),Od=s(Wf,"A",{href:!0});var R0=a(Od);fT=i(R0,"PreTrainedModel"),R0.forEach(t),gT=i(Wf,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Wf.forEach(t),_T=p(Wt),gr=s(Wt,"P",{});var Uf=a(gr);kT=i(Uf,"This model is also a PyTorch "),_r=s(Uf,"A",{href:!0,rel:!0});var H0=a(_r);TT=i(H0,"torch.nn.Module"),H0.forEach(t),vT=i(Uf,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Uf.forEach(t),bT=p(Wt),at=s(Wt,"DIV",{class:!0});var co=a(at);y(kr.$$.fragment,co),yT=p(co),Po=s(co,"P",{});var gc=a(Po);ET=i(gc,"The "),Ld=s(gc,"A",{href:!0});var Q0=a(Ld);wT=i(Q0,"ElectraForMaskedLM"),Q0.forEach(t),$T=i(gc," forward method, overrides the "),hp=s(gc,"CODE",{});var V0=a(hp);FT=i(V0,"__call__"),V0.forEach(t),xT=i(gc," special method."),gc.forEach(t),MT=p(co),y(Sn.$$.fragment,co),zT=p(co),y(Wn.$$.fragment,co),jT=p(co),y(Un.$$.fragment,co),co.forEach(t),Wt.forEach(t),Uu=p(o),Ao=s(o,"H2",{class:!0});var Bf=a(Ao);Bn=s(Bf,"A",{id:!0,class:!0,href:!0});var K0=a(Bn);mp=s(K0,"SPAN",{});var J0=a(mp);y(Tr.$$.fragment,J0),J0.forEach(t),K0.forEach(t),CT=p(Bf),up=s(Bf,"SPAN",{});var G0=a(up);qT=i(G0,"ElectraForSequenceClassification"),G0.forEach(t),Bf.forEach(t),Bu=p(o),ot=s(o,"DIV",{class:!0});var po=a(ot);y(vr.$$.fragment,po),PT=p(po),fp=s(po,"P",{});var X0=a(fp);AT=i(X0,`ELECTRA Model transformer with a sequence classification/regression head on top (a linear layer on top of the
pooled output) e.g. for GLUE tasks.`),X0.forEach(t),OT=p(po),br=s(po,"P",{});var Rf=a(br);LT=i(Rf,"This model inherits from "),Nd=s(Rf,"A",{href:!0});var Y0=a(Nd);NT=i(Y0,"PreTrainedModel"),Y0.forEach(t),IT=i(Rf,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Rf.forEach(t),DT=p(po),yr=s(po,"P",{});var Hf=a(yr);ST=i(Hf,"This model is also a PyTorch "),Er=s(Hf,"A",{href:!0,rel:!0});var Z0=a(Er);WT=i(Z0,"torch.nn.Module"),Z0.forEach(t),UT=i(Hf,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Hf.forEach(t),BT=p(po),Re=s(po,"DIV",{class:!0});var ht=a(Re);y(wr.$$.fragment,ht),RT=p(ht),Oo=s(ht,"P",{});var _c=a(Oo);HT=i(_c,"The "),Id=s(_c,"A",{href:!0});var ex=a(Id);QT=i(ex,"ElectraForSequenceClassification"),ex.forEach(t),VT=i(_c," forward method, overrides the "),gp=s(_c,"CODE",{});var tx=a(gp);KT=i(tx,"__call__"),tx.forEach(t),JT=i(_c," special method."),_c.forEach(t),GT=p(ht),y(Rn.$$.fragment,ht),XT=p(ht),y(Hn.$$.fragment,ht),YT=p(ht),y(Qn.$$.fragment,ht),ZT=p(ht),y(Vn.$$.fragment,ht),ev=p(ht),y(Kn.$$.fragment,ht),ht.forEach(t),po.forEach(t),Ru=p(o),Lo=s(o,"H2",{class:!0});var Qf=a(Lo);Jn=s(Qf,"A",{id:!0,class:!0,href:!0});var ox=a(Jn);_p=s(ox,"SPAN",{});var nx=a(_p);y($r.$$.fragment,nx),nx.forEach(t),ox.forEach(t),tv=p(Qf),kp=s(Qf,"SPAN",{});var sx=a(kp);ov=i(sx,"ElectraForMultipleChoice"),sx.forEach(t),Qf.forEach(t),Hu=p(o),nt=s(o,"DIV",{class:!0});var ho=a(nt);y(Fr.$$.fragment,ho),nv=p(ho),Tp=s(ho,"P",{});var ax=a(Tp);sv=i(ax,`ELECTRA Model with a multiple choice classification head on top (a linear layer on top of the pooled output and a
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Xf.forEach(t),Lv=p(Ut),rt=s(Ut,"DIV",{class:!0});var mo=a(rt);y(Lr.$$.fragment,mo),Nv=p(mo),Do=s(mo,"P",{});var Tc=a(Do);Iv=i(Tc,"The "),Ud=s(Tc,"A",{href:!0});var _x=a(Ud);Dv=i(_x,"ElectraForTokenClassification"),_x.forEach(t),Sv=i(Tc," forward method, overrides the "),$p=s(Tc,"CODE",{});var kx=a($p);Wv=i(kx,"__call__"),kx.forEach(t),Uv=i(Tc," special method."),Tc.forEach(t),Bv=p(mo),y(Zn.$$.fragment,mo),Rv=p(mo),y(es.$$.fragment,mo),Hv=p(mo),y(ts.$$.fragment,mo),mo.forEach(t),Ut.forEach(t),Ku=p(o),So=s(o,"H2",{class:!0});var Yf=a(So);os=s(Yf,"A",{id:!0,class:!0,href:!0});var Tx=a(os);Fp=s(Tx,"SPAN",{});var vx=a(Fp);y(Nr.$$.fragment,vx),vx.forEach(t),Tx.forEach(t),Qv=p(Yf),xp=s(Yf,"SPAN",{});var bx=a(xp);Vv=i(bx,"ElectraForQuestionAnswering"),bx.forEach(t),Yf.forEach(t),Ju=p(o),st=s(o,"DIV",{class:!0});var uo=a(st);y(Ir.$$.fragment,uo),Kv=p(uo),Wo=s(uo,"P",{});var vc=a(Wo);Jv=i(vc,`ELECTRA Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
layers on top of the hidden-states output to compute `),Mp=s(vc,"CODE",{});var yx=a(Mp);Gv=i(yx,"span start logits"),yx.forEach(t),Xv=i(vc," and "),zp=s(vc,"CODE",{});var Ex=a(zp);Yv=i(Ex,"span end logits"),Ex.forEach(t),Zv=i(vc,")."),vc.forEach(t),eb=p(uo),Dr=s(uo,"P",{});var Zf=a(Dr);tb=i(Zf,"This model inherits from "),Bd=s(Zf,"A",{href:!0});var wx=a(Bd);ob=i(wx,"PreTrainedModel"),wx.forEach(t),nb=i(Zf,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),xg.forEach(t),f$=p(Ye),Eh=s(Ye,"P",{});var sz=a(Eh);g$=i(sz,"Finally, this model supports inherent JAX features such as:"),sz.forEach(t),_$=p(Ye),Jt=s(Ye,"UL",{});var Ta=a(Jt);wh=s(Ta,"LI",{});var az=a(wh);Qi=s(az,"A",{href:!0,rel:!0});var rz=a(Qi);k$=i(rz,"Just-In-Time (JIT) compilation"),rz.forEach(t),az.forEach(t),T$=p(Ta),$h=s(Ta,"LI",{});var iz=a($h);Vi=s(iz,"A",{href:!0,rel:!0});var lz=a(Vi);v$=i(lz,"Automatic Differentiation"),lz.forEach(t),iz.forEach(t),b$=p(Ta),Fh=s(Ta,"LI",{});var dz=a(Fh);Ki=s(dz,"A",{href:!0,rel:!0});var cz=a(Ki);y$=i(cz,"Vectorization"),cz.forEach(t),dz.forEach(t),E$=p(Ta),xh=s(Ta,"LI",{});var pz=a(xh);Ji=s(pz,"A",{href:!0,rel:!0});var hz=a(Ji);w$=i(hz,"Parallelization"),hz.forEach(t),pz.forEach(t),Ta.forEach(t),$$=p(Ye),Pt=s(Ye,"DIV",{class:!0});var va=a(Pt);y(Gi.$$.fragment,va),F$=p(va),ln=s(va,"P",{});var Cc=a(ln);x$=i(Cc,"The "),Mh=s(Cc,"CODE",{});var mz=a(Mh);M$=i(mz,"FlaxElectraPreTrainedModel"),mz.forEach(t),z$=i(Cc," forward method, overrides the "),zh=s(Cc,"CODE",{});var uz=a(zh);j$=i(uz,"__call__"),uz.forEach(t),C$=i(Cc," special method."),Cc.forEach(t),q$=p(va),y(Us.$$.fragment,va),P$=p(va),y(Bs.$$.fragment,va),va.forEach(t),Ye.forEach(t),ff=p(o),dn=s(o,"H2",{class:!0});var Mg=a(dn);Rs=s(Mg,"A",{id:!0,class:!0,href:!0});var fz=a(Rs);jh=s(fz,"SPAN",{});var gz=a(jh);y(Xi.$$.fragment,gz),gz.forEach(t),fz.forEach(t),A$=p(Mg),Ch=s(Mg,"SPAN",{});var _z=a(Ch);O$=i(_z,"FlaxElectraForCausalLM"),_z.forEach(t),Mg.forEach(t),gf=p(o),De=s(o,"DIV",{class:!0});var _t=a(De);y(Yi.$$.fragment,_t),L$=p(_t),qh=s(_t,"P",{});var kz=a(qh);N$=i(kz,`Electra Model with a language modeling head on top (a linear layer on top of the hidden-states output) e.g for
...
`),tl=s(jg,"A",{href:!0,rel:!0});var vz=a(tl);R$=i(vz,"flax.nn.Module"),vz.forEach(t),H$=i(jg,` subclass. Use it as a
...
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),Bg.forEach(t),hF=p(Ze),vm=s(Ze,"P",{});var L4=a(vm);mF=i(L4,"Finally, this model supports inherent JAX features such as:"),L4.forEach(t),uF=p(Ze),eo=s(Ze,"UL",{});var za=a(eo);bm=s(za,"LI",{});var N4=a(bm);Bl=s(N4,"A",{href:!0,rel:!0});var I4=a(Bl);fF=i(I4,"Just-In-Time (JIT) compilation"),I4.forEach(t),N4.forEach(t),gF=p(za),ym=s(za,"LI",{});var D4=a(ym);Rl=s(D4,"A",{href:!0,rel:!0});var S4=a(Rl);_F=i(S4,"Automatic Differentiation"),S4.forEach(t),D4.forEach(t),kF=p(za),Em=s(za,"LI",{});var W4=a(Em);Hl=s(W4,"A",{href:!0,rel:!0});var U4=a(Hl);TF=i(U4,"Vectorization"),U4.forEach(t),W4.forEach(t),vF=p(za),wm=s(za,"LI",{});var B4=a(wm);Ql=s(B4,"A",{href:!0,rel:!0});var R4=a(Ql);bF=i(R4,"Parallelization"),R4.forEach(t),B4.forEach(t),za.forEach(t),yF=p(Ze),It=s(Ze,"DIV",{class:!0});var ja=a(It);y(Vl.$$.fragment,ja),EF=p(ja),kn=s(ja,"P",{});var Lc=a(kn);wF=i(Lc,"The "),$m=s(Lc,"CODE",{});var H4=a($m);$F=i(H4,"FlaxElectraPreTrainedModel"),H4.forEach(t),FF=i(Lc," forward method, overrides the "),Fm=s(Lc,"CODE",{});var Q4=a(Fm);xF=i(Q4,"__call__"),Q4.forEach(t),MF=i(Lc," special method."),Lc.forEach(t),zF=p(ja),y(na.$$.fragment,ja),jF=p(ja),y(sa.$$.fragment,ja),ja.forEach(t),Ze.forEach(t),$f=p(o),Tn=s(o,"H2",{class:!0});var Rg=a(Tn);aa=s(Rg,"A",{id:!0,class:!0,href:!0});var V4=a(aa);xm=s(V4,"SPAN",{});var K4=a(xm);y(Kl.$$.fragment,K4),K4.forEach(t),V4.forEach(t),CF=p(Rg),Mm=s(Rg,"SPAN",{});var J4=a(Mm);qF=i(J4,"FlaxElectraForQuestionAnswering"),J4.forEach(t),Rg.forEach(t),Ff=p(o),Be=s(o,"DIV",{class:!0});var bt=a(Be);y(Jl.$$.fragment,bt),PF=p(bt),vn=s(bt,"P",{});var Nc=a(vn);AF=i(Nc,`ELECTRA Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
