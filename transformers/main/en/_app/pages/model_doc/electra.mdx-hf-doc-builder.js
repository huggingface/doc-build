...
positional argument:`),oe=p(),q=a("ul"),A=a("li"),ve=n("a single Tensor with "),R=a("code"),ue=n("input_ids"),Me=n(" only and nothing else: "),V=a("code"),ne=n("model(input_ids)"),ze=p(),P=a("li"),je=n(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
...
about any of this, as you can just pass inputs like you would to any other Python function!`),this.h()},l(y){d=r(y,"P",{});var j=i(d);g=s(j,"TensorFlow models and layers in "),c=r(j,"CODE",{});var De=i(c);f=s(De,"transformers"),De.forEach(t),v=s(j," accept two formats as input:"),j.forEach(t),l=h(y),m=r(y,"UL",{});var te=i(m);z=r(te,"LI",{});var We=i(z);Te=s(We,"having all inputs as keyword arguments (like PyTorch models), or"),We.forEach(t),fe=h(te),S=r(te,"LI",{});var Be=i(S);ae=s(Be,"having all inputs as a list, tuple or dict in the first positional argument."),Be.forEach(t),te.forEach(t),ee=h(y),M=r(y,"P",{});var C=i(M);be=s(C,`The reason the second format is supported is that Keras methods prefer this format when passing inputs to models
and layers. Because of this support, when using methods like `),Q=r(C,"CODE",{});var Ve=i(Q);we=s(Ve,"model.fit()"),Ve.forEach(t),ge=s(C,` things should \u201Cjust work\u201D for you - just
pass your inputs and labels in any format that `),U=r(C,"CODE",{});var Qe=i(U);Ee=s(Qe,"model.fit()"),Qe.forEach(t),re=s(C,` supports! If, however, you want to use the second
format outside of Keras methods like `),B=r(C,"CODE",{});var de=i(B);$e=s(de,"fit()"),de.forEach(t),_e=s(C," and "),H=r(C,"CODE",{});var Ue=i(H);Fe=s(Ue,"predict()"),Ue.forEach(t),ke=s(C,`, such as when creating your own layers or models with
the Keras `),K=r(C,"CODE",{});var Je=i(K);me=s(Je,"Functional"),Je.forEach(t),xe=s(C,` API, there are three possibilities you can use to gather all the input Tensors in the first
positional argument:`),C.forEach(t),oe=h(y),q=r(y,"UL",{});var N=i(q);A=r(N,"LI",{});var X=i(A);ve=s(X,"a single Tensor with "),R=r(X,"CODE",{});var He=i(R);ue=s(He,"input_ids"),He.forEach(t),Me=s(X," only and nothing else: "),V=r(X,"CODE",{});var Ge=i(V);ne=s(Ge,"model(input_ids)"),Ge.forEach(t),X.forEach(t),ze=h(N),P=r(N,"LI",{});var Y=i(P);je=s(Y,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),J=r(Y,"CODE",{});var Ke=i(J);ie=s(Ke,"model([input_ids, attention_mask])"),Ke.forEach(t),Ce=s(Y," or "),G=r(Y,"CODE",{});var Xe=i(G);le=s(Xe,"model([input_ids, attention_mask, token_type_ids])"),Xe.forEach(t),Y.forEach(t),qe=h(N),I=r(N,"LI",{});var Ne=i(I);ye=s(Ne,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),{c(){d=a("p"),g=n("Example:"),c=p(),T(f.$$.fragment)},l(l){d=r(l,"P",{});var m=i(d);g=s(m,"Example:"),m.forEach(t),c=h(l),b(f.$$.fragment,l)},m(l,m){_(l,d,m),e(d,g),_(l,c,m),w(f,l,m),v=!0},p:pe,i(l){v||(E(f.$$.fragment,l),v=!0)},o(l){$(f.$$.fragment,l),v=!1},d(l){l&&t(d),l&&t(c),F(f,l)}}}function Uj(x){let d,g,c,f,v,l,m,z,Te,fe,S,ae,ee,M,be,Q,we,ge,U,Ee,re,B,$e,_e,H,Fe,ke,K,me,xe,oe,q,A,ve,R,ue,Me,V,ne,ze,P,je,J,ie,Ce,G,le,qe,I,ye,D,Pe,Z,O,Ae,L,Oe,Le;return{c(){d=a("p"),g=n("TensorFlow models and layers in "),c=a("code"),f=n("transformers"),v=n(" accept two formats as input:"),l=p(),m=a("ul"),z=a("li"),Te=n("having all inputs as keyword arguments (like PyTorch models), or"),fe=p(),S=a("li"),ae=n("having all inputs as a list, tuple or dict in the first positional argument."),ee=p(),M=a("p"),be=n(`The reason the second format is supported is that Keras methods prefer this format when passing inputs to models
and layers. Because of this support, when using methods like `),Q=a("code"),we=n("model.fit()"),ge=n(` things should \u201Cjust work\u201D for you - just
pass your inputs and labels in any format that `),U=a("code"),Ee=n("model.fit()"),re=n(` supports! If, however, you want to use the second
format outside of Keras methods like `),B=a("code"),$e=n("fit()"),_e=n(" and "),H=a("code"),Fe=n("predict()"),ke=n(`, such as when creating your own layers or models with
the Keras `),K=a("code"),me=n("Functional"),xe=n(` API, there are three possibilities you can use to gather all the input Tensors in the first
...
`),D=r(Ne,"CODE",{});var Re=i(D);Pe=s(Re,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),Re.forEach(t),Ne.forEach(t),N.forEach(t),Z=h(y),O=r(y,"P",{});var se=i(O);Ae=s(se,`Note that when creating models and layers with
`),L=r(se,"A",{href:!0,rel:!0});var Ye=i(L);Oe=s(Ye,"subclassing"),Ye.forEach(t),Le=s(se,` then you don\u2019t need to worry
about any of this, as you can just pass inputs like you would to any other Python function!`),se.forEach(t),this.h()},h(){u(L,"href","https://keras.io/guides/making_new_layers_and_models_via_subclassing/"),u(L,"rel","nofollow")},m(y,j){_(y,d,j),e(d,g),e(d,c),e(c,f),e(d,v),_(y,l,j),_(y,m,j),e(m,z),e(z,Te),e(m,fe),e(m,S),e(S,ae),_(y,ee,j),_(y,M,j),e(M,be),e(M,Q),e(Q,we),e(M,ge),e(M,U),e(U,Ee),e(M,re),e(M,B),e(B,$e),e(M,_e),e(M,H),e(H,Fe),e(M,ke),e(M,K),e(K,me),e(M,xe),_(y,oe,j),_(y,q,j),e(q,A),e(A,ve),e(A,R),e(R,ue),e(A,Me),e(A,V),e(V,ne),e(q,ze),e(q,P),e(P,je),e(P,J),e(J,ie),e(P,Ce),e(P,G),e(G,le),e(q,qe),e(q,I),e(I,ye),e(I,D),e(D,Pe),_(y,Z,j),_(y,O,j),e(O,Ae),e(O,L),e(L,Oe),e(O,Le)},d(y){y&&t(d),y&&t(l),y&&t(m),y&&t(ee),y&&t(M),y&&t(oe),y&&t(q),y&&t(Z),y&&t(O)}}}function Rj(x){let d,g,c,f,v;return{c(){d=a("p"),g=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),c=a("code"),f=n("Module"),v=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(l){d=r(l,"P",{});var m=i(d);g=s(m,"Although the recipe for forward pass needs to be defined within this function, one should call the "),c=r(m,"CODE",{});var z=i(c);f=s(z,"Module"),z.forEach(t),v=s(m,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),m.forEach(t)},m(l,m){_(l,d,m),e(d,g),e(d,c),e(c,f),e(d,v)},d(l){l&&t(d)}}}function Hj(x){let d,g,c,f,v;return f=new he({props:{code:`import tensorflow as tf
...
`),D=r(Ne,"CODE",{});var Re=i(D);Pe=s(Re,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),Re.forEach(t),Ne.forEach(t),N.forEach(t),Z=h(y),O=r(y,"P",{});var se=i(O);Ae=s(se,`Note that when creating models and layers with
`),L=r(se,"A",{href:!0,rel:!0});var Ye=i(L);Oe=s(Ye,"subclassing"),Ye.forEach(t),Le=s(se,` then you don\u2019t need to worry
about any of this, as you can just pass inputs like you would to any other Python function!`),se.forEach(t),this.h()},h(){u(L,"href","https://keras.io/guides/making_new_layers_and_models_via_subclassing/"),u(L,"rel","nofollow")},m(y,j){_(y,d,j),e(d,g),e(d,c),e(c,f),e(d,v),_(y,l,j),_(y,m,j),e(m,z),e(z,Te),e(m,fe),e(m,S),e(S,ae),_(y,ee,j),_(y,M,j),e(M,be),e(M,Q),e(Q,we),e(M,ge),e(M,U),e(U,Ee),e(M,re),e(M,B),e(B,$e),e(M,_e),e(M,H),e(H,Fe),e(M,ke),e(M,K),e(K,me),e(M,xe),_(y,oe,j),_(y,q,j),e(q,A),e(A,ve),e(A,R),e(R,ue),e(A,Me),e(A,V),e(V,ne),e(q,ze),e(q,P),e(P,je),e(P,J),e(J,ie),e(P,Ce),e(P,G),e(G,le),e(q,qe),e(q,I),e(I,ye),e(I,D),e(D,Pe),_(y,Z,j),_(y,O,j),e(O,Ae),e(O,L),e(L,Oe),e(O,Le)},d(y){y&&t(d),y&&t(l),y&&t(m),y&&t(ee),y&&t(M),y&&t(oe),y&&t(q),y&&t(Z),y&&t(O)}}}function Qj(x){let d,g,c,f,v;return{c(){d=a("p"),g=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),c=a("code"),f=n("Module"),v=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(l){d=r(l,"P",{});var m=i(d);g=s(m,"Although the recipe for forward pass needs to be defined within this function, one should call the "),c=r(m,"CODE",{});var z=i(c);f=s(z,"Module"),z.forEach(t),v=s(m,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),m.forEach(t)},m(l,m){_(l,d,m),e(d,g),e(d,c),e(c,f),e(d,v)},d(l){l&&t(d)}}}function Bj(x){let d,g,c,f,v;return f=new he({props:{code:`from transformers import ElectraTokenizer, TFElectraForMaskedLM
import tensorflow as tf
...
<span class="hljs-number">1.22</span>`}}),{c(){T(d.$$.fragment)},l(c){b(d.$$.fragment,c)},m(c,f){w(d,c,f),g=!0},p:pe,i(c){g||(E(d.$$.fragment,c),g=!0)},o(c){$(d.$$.fragment,c),g=!1},d(c){F(d,c)}}}function Jj(x){let d,g,c,f,v,l,m,z,Te,fe,S,ae,ee,M,be,Q,we,ge,U,Ee,re,B,$e,_e,H,Fe,ke,K,me,xe,oe,q,A,ve,R,ue,Me,V,ne,ze,P,je,J,ie,Ce,G,le,qe,I,ye,D,Pe,Z,O,Ae,L,Oe,Le;return{c(){d=a("p"),g=n("TensorFlow models and layers in "),c=a("code"),f=n("transformers"),v=n(" accept two formats as input:"),l=p(),m=a("ul"),z=a("li"),Te=n("having all inputs as keyword arguments (like PyTorch models), or"),fe=p(),S=a("li"),ae=n("having all inputs as a list, tuple or dict in the first positional argument."),ee=p(),M=a("p"),be=n(`The reason the second format is supported is that Keras methods prefer this format when passing inputs to models
and layers. Because of this support, when using methods like `),Q=a("code"),we=n("model.fit()"),ge=n(` things should \u201Cjust work\u201D for you - just
pass your inputs and labels in any format that `),U=a("code"),Ee=n("model.fit()"),re=n(` supports! If, however, you want to use the second
format outside of Keras methods like `),B=a("code"),$e=n("fit()"),_e=n(" and "),H=a("code"),Fe=n("predict()"),ke=n(`, such as when creating your own layers or models with
the Keras `),K=a("code"),me=n("Functional"),xe=n(` API, there are three possibilities you can use to gather all the input Tensors in the first
...
<span class="hljs-number">0.06</span>`}}),{c(){T(d.$$.fragment)},l(c){b(d.$$.fragment,c)},m(c,f){w(d,c,f),g=!0},p:pe,i(c){g||(E(d.$$.fragment,c),g=!0)},o(c){$(d.$$.fragment,c),g=!1},d(c){F(d,c)}}}function Zj(x){let d,g,c,f,v,l,m,z,Te,fe,S,ae,ee,M,be,Q,we,ge,U,Ee,re,B,$e,_e,H,Fe,ke,K,me,xe,oe,q,A,ve,R,ue,Me,V,ne,ze,P,je,J,ie,Ce,G,le,qe,I,ye,D,Pe,Z,O,Ae,L,Oe,Le;return{c(){d=a("p"),g=n("TensorFlow models and layers in "),c=a("code"),f=n("transformers"),v=n(" accept two formats as input:"),l=p(),m=a("ul"),z=a("li"),Te=n("having all inputs as keyword arguments (like PyTorch models), or"),fe=p(),S=a("li"),ae=n("having all inputs as a list, tuple or dict in the first positional argument."),ee=p(),M=a("p"),be=n(`The reason the second format is supported is that Keras methods prefer this format when passing inputs to models
and layers. Because of this support, when using methods like `),Q=a("code"),we=n("model.fit()"),ge=n(` things should \u201Cjust work\u201D for you - just
pass your inputs and labels in any format that `),U=a("code"),Ee=n("model.fit()"),re=n(` supports! If, however, you want to use the second
format outside of Keras methods like `),B=a("code"),$e=n("fit()"),_e=n(" and "),H=a("code"),Fe=n("predict()"),ke=n(`, such as when creating your own layers or models with
the Keras `),K=a("code"),me=n("Functional"),xe=n(` API, there are three possibilities you can use to gather all the input Tensors in the first
...
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-comment"># the linear classifier still needs to be trained</span>
<span class="hljs-meta">&gt;&gt;&gt; </span>logits = outputs.logits`}}),{c(){d=a("p"),g=n("Example:"),c=p(),T(f.$$.fragment)},l(l){d=r(l,"P",{});var m=i(d);g=s(m,"Example:"),m.forEach(t),c=h(l),b(f.$$.fragment,l)},m(l,m){_(l,d,m),e(d,g),_(l,c,m),w(f,l,m),v=!0},p:pe,i(l){v||(E(f.$$.fragment,l),v=!0)},o(l){$(f.$$.fragment,l),v=!1},d(l){l&&t(d),l&&t(c),F(f,l)}}}function oC(x){let d,g,c,f,v,l,m,z,Te,fe,S,ae,ee,M,be,Q,we,ge,U,Ee,re,B,$e,_e,H,Fe,ke,K,me,xe,oe,q,A,ve,R,ue,Me,V,ne,ze,P,je,J,ie,Ce,G,le,qe,I,ye,D,Pe,Z,O,Ae,L,Oe,Le;return{c(){d=a("p"),g=n("TensorFlow models and layers in "),c=a("code"),f=n("transformers"),v=n(" accept two formats as input:"),l=p(),m=a("ul"),z=a("li"),Te=n("having all inputs as keyword arguments (like PyTorch models), or"),fe=p(),S=a("li"),ae=n("having all inputs as a list, tuple or dict in the first positional argument."),ee=p(),M=a("p"),be=n(`The reason the second format is supported is that Keras methods prefer this format when passing inputs to models
and layers. Because of this support, when using methods like `),Q=a("code"),we=n("model.fit()"),ge=n(` things should \u201Cjust work\u201D for you - just
pass your inputs and labels in any format that `),U=a("code"),Ee=n("model.fit()"),re=n(` supports! If, however, you want to use the second
format outside of Keras methods like `),B=a("code"),$e=n("fit()"),_e=n(" and "),H=a("code"),Fe=n("predict()"),ke=n(`, such as when creating your own layers or models with
the Keras `),K=a("code"),me=n("Functional"),xe=n(` API, there are three possibilities you can use to gather all the input Tensors in the first
...
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-built_in">round</span>(<span class="hljs-built_in">float</span>(loss), <span class="hljs-number">2</span>)
<span class="hljs-number">0.11</span>`}}),{c(){T(d.$$.fragment)},l(c){b(d.$$.fragment,c)},m(c,f){w(d,c,f),g=!0},p:pe,i(c){g||(E(d.$$.fragment,c),g=!0)},o(c){$(d.$$.fragment,c),g=!1},d(c){F(d,c)}}}function rC(x){let d,g,c,f,v,l,m,z,Te,fe,S,ae,ee,M,be,Q,we,ge,U,Ee,re,B,$e,_e,H,Fe,ke,K,me,xe,oe,q,A,ve,R,ue,Me,V,ne,ze,P,je,J,ie,Ce,G,le,qe,I,ye,D,Pe,Z,O,Ae,L,Oe,Le;return{c(){d=a("p"),g=n("TensorFlow models and layers in "),c=a("code"),f=n("transformers"),v=n(" accept two formats as input:"),l=p(),m=a("ul"),z=a("li"),Te=n("having all inputs as keyword arguments (like PyTorch models), or"),fe=p(),S=a("li"),ae=n("having all inputs as a list, tuple or dict in the first positional argument."),ee=p(),M=a("p"),be=n(`The reason the second format is supported is that Keras methods prefer this format when passing inputs to models
and layers. Because of this support, when using methods like `),Q=a("code"),we=n("model.fit()"),ge=n(` things should \u201Cjust work\u201D for you - just
pass your inputs and labels in any format that `),U=a("code"),Ee=n("model.fit()"),re=n(` supports! If, however, you want to use the second
format outside of Keras methods like `),B=a("code"),$e=n("fit()"),_e=n(" and "),H=a("code"),Fe=n("predict()"),ke=n(`, such as when creating your own layers or models with
the Keras `),K=a("code"),me=n("Functional"),xe=n(` API, there are three possibilities you can use to gather all the input Tensors in the first
...
<span class="hljs-meta">&gt;&gt;&gt; </span>end_scores = outputs.end_logits`}}),{c(){d=a("p"),g=n("Example:"),c=p(),T(f.$$.fragment)},l(l){d=r(l,"P",{});var m=i(d);g=s(m,"Example:"),m.forEach(t),c=h(l),b(f.$$.fragment,l)},m(l,m){_(l,d,m),e(d,g),_(l,c,m),w(f,l,m),v=!0},p:pe,i(l){v||(E(f.$$.fragment,l),v=!0)},o(l){$(f.$$.fragment,l),v=!1},d(l){l&&t(d),l&&t(c),F(f,l)}}}function FC(x){let d,g,c,f,v,l,m,z,Te,fe,S,ae,ee,M,be,Q,we,ge,U,Ee,re,B,$e,_e,H,Fe,ke,K,me,xe,oe,q,A,ve,R,ue,Me,V,ne,ze,P,je,J,ie,Ce,G,le,qe,I,ye,D,Pe,Z,O,Ae,L,Oe,Le,y,j,De,te,We,Be,C,Ve,Qe,de,Ue,Je,N,X,He,Ge,Y,Ke,Xe,Ne,Re,se,Ye,n_,Io,s_,qd,a_,r_,Pd,i_,l_,d_,Un,Nu,Do,Rn,Yc,Xa,c_,Zc,p_,Iu,Ut,Ya,h_,ep,m_,u_,Hn,Ad,f_,g_,Od,__,k_,v_,Za,y_,Ld,T_,b_,Du,So,Kn,tp,er,w_,op,E_,Su,Rt,tr,$_,or,F_,np,x_,M_,z_,Qn,Nd,j_,C_,Id,q_,P_,A_,nr,O_,Dd,L_,N_,Wu,Wo,Bn,sp,sr,I_,ap,D_,Uu,Uo,ar,S_,rr,W_,Sd,U_,R_,Ru,Ro,ir,H_,lr,K_,Wd,Q_,B_,Hu,Ho,Vn,rp,dr,V_,ip,J_,Ku,yt,cr,G_,lp,X_,Y_,pr,Z_,Ud,ek,tk,ok,hr,nk,mr,sk,ak,rk,Ht,ur,ik,Ko,lk,Rd,dk,ck,dp,pk,hk,mk,Jn,uk,Gn,Qu,Qo,Xn,cp,fr,fk,pp,gk,Bu,pt,gr,_k,hp,kk,vk,mp,yk,Tk,_r,bk,Hd,wk,Ek,$k,kr,Fk,vr,xk,Mk,zk,Kt,yr,jk,Bo,Ck,Kd,qk,Pk,up,Ak,Ok,Lk,Yn,Nk,Zn,Vu,Vo,es,fp,Tr,Ik,gp,Dk,Ju,Tt,br,Sk,wr,Wk,_p,Uk,Rk,Hk,Er,Kk,Qd,Qk,Bk,Vk,$r,Jk,Fr,Gk,Xk,Yk,Qt,xr,Zk,Jo,ev,Bd,tv,ov,kp,nv,sv,av,ts,rv,os,Gu,Go,ns,vp,Mr,iv,yp,lv,Xu,ht,zr,dv,Tp,cv,pv,bp,hv,mv,jr,uv,Vd,fv,gv,_v,Cr,kv,qr,vv,yv,Tv,$t,Pr,bv,Xo,wv,Jd,Ev,$v,wp,Fv,xv,Mv,ss,zv,as,jv,rs,Yu,Yo,is,Ep,Ar,Cv,$p,qv,Zu,bt,Or,Pv,Fp,Av,Ov,Lr,Lv,Gd,Nv,Iv,Dv,Nr,Sv,Ir,Wv,Uv,Rv,ct,Dr,Hv,Zo,Kv,Xd,Qv,Bv,xp,Vv,Jv,Gv,ls,Xv,ds,Yv,cs,Zv,ps,ey,hs,ef,en,ms,Mp,Sr,ty,zp,oy,tf,wt,Wr,ny,jp,sy,ay,Ur,ry,Yd,iy,ly,dy,Rr,cy,Hr,py,hy,my,Bt,Kr,uy,tn,fy,Zd,gy,_y,Cp,ky,vy,yy,us,Ty,fs,of,on,gs,qp,Qr,by,Pp,wy,nf,mt,Br,Ey,Ap,$y,Fy,Op,xy,My,Vr,zy,ec,jy,Cy,qy,Jr,Py,Gr,Ay,Oy,Ly,Ft,Xr,Ny,nn,Iy,tc,Dy,Sy,Lp,Wy,Uy,Ry,_s,Hy,ks,Ky,vs,sf,sn,ys,Np,Yr,Qy,Ip,By,af,Et,Zr,Vy,an,Jy,Dp,Gy,Xy,Sp,Yy,Zy,eT,ei,tT,oc,oT,nT,sT,ti,aT,oi,rT,iT,lT,xt,ni,dT,rn,cT,nc,pT,hT,Wp,mT,uT,fT,Ts,gT,bs,_T,ws,rf,ln,Es,Up,si,kT,Rp,vT,lf,ut,ai,yT,Hp,TT,bT,ri,wT,sc,ET,$T,FT,ii,xT,li,MT,zT,jT,$s,CT,Vt,di,qT,dn,PT,ac,AT,OT,Kp,LT,NT,IT,Fs,DT,xs,df,cn,Ms,Qp,ci,ST,Bp,WT,cf,tt,pi,UT,Vp,RT,HT,Jp,KT,QT,hi,BT,rc,VT,JT,GT,mi,XT,ui,YT,ZT,eb,zs,tb,Jt,fi,ob,pn,nb,ic,sb,ab,Gp,rb,ib,lb,js,db,Cs,pf,hn,qs,Xp,gi,cb,Yp,pb,hf,ot,_i,hb,Zp,mb,ub,eh,fb,gb,ki,_b,lc,kb,vb,yb,vi,Tb,yi,bb,wb,Eb,Ps,$b,Mt,Ti,Fb,mn,xb,dc,Mb,zb,th,jb,Cb,qb,As,Pb,Os,Ab,Ls,mf,un,Ns,oh,bi,Ob,nh,Lb,uf,ft,wi,Nb,sh,Ib,Db,Ei,Sb,cc,Wb,Ub,Rb,$i,Hb,Fi,Kb,Qb,Bb,Is,Vb,zt,xi,Jb,fn,Gb,pc,Xb,Yb,ah,Zb,ew,tw,Ds,ow,Ss,nw,Ws,ff,gn,Us,rh,Mi,sw,ih,aw,gf,gt,zi,rw,lh,iw,lw,ji,dw,hc,cw,pw,hw,Ci,mw,qi,uw,fw,gw,Rs,_w,Gt,Pi,kw,_n,vw,mc,yw,Tw,dh,bw,ww,Ew,Hs,$w,Ks,_f,kn,Qs,ch,Ai,Fw,ph,xw,kf,nt,Oi,Mw,hh,zw,jw,mh,Cw,qw,Li,Pw,uc,Aw,Ow,Lw,Ni,Nw,Ii,Iw,Dw,Sw,Bs,Ww,jt,Di,Uw,vn,Rw,fc,Hw,Kw,uh,Qw,Bw,Vw,Vs,Jw,Js,Gw,Gs,vf,yn,Xs,fh,Si,Xw,gh,Yw,yf,_t,Wi,Zw,Tn,eE,_h,tE,oE,kh,nE,sE,aE,Ui,rE,gc,iE,lE,dE,Ri,cE,Hi,pE,hE,mE,Ys,uE,Ct,Ki,fE,bn,gE,_c,_E,kE,vh,vE,yE,TE,Zs,bE,ea,wE,ta,Tf,wn,oa,yh,Qi,EE,Th,$E,bf,st,Bi,FE,bh,xE,ME,Vi,zE,kc,jE,CE,qE,Ji,PE,Gi,AE,OE,LE,wh,NE,IE,mo,Eh,Xi,DE,SE,$h,Yi,WE,UE,Fh,Zi,RE,HE,xh,el,KE,QE,Xt,tl,BE,En,VE,Mh,JE,GE,zh,XE,YE,ZE,na,e$,sa,wf,$n,aa,jh,ol,t$,Ch,o$,Ef,Ze,nl,n$,qh,s$,a$,Ph,r$,i$,sl,l$,vc,d$,c$,p$,al,h$,rl,m$,u$,f$,Ah,g$,_$,uo,Oh,il,k$,v$,Lh,ll,y$,T$,Nh,dl,b$,w$,Ih,cl,E$,$$,Yt,pl,F$,Fn,x$,Dh,M$,z$,Sh,j$,C$,q$,ra,P$,ia,$f,xn,la,Wh,hl,A$,Uh,O$,Ff,at,ml,L$,Rh,N$,I$,ul,D$,yc,S$,W$,U$,fl,R$,gl,H$,K$,Q$,Hh,B$,V$,fo,Kh,_l,J$,G$,Qh,kl,X$,Y$,Bh,vl,Z$,e1,Vh,yl,t1,o1,Zt,Tl,n1,Mn,s1,Jh,a1,r1,Gh,i1,l1,d1,da,c1,ca,xf,zn,pa,Xh,bl,p1,Yh,h1,Mf,rt,wl,m1,El,u1,Zh,f1,g1,_1,$l,k1,Tc,v1,y1,T1,Fl,b1,xl,w1,E1,$1,em,F1,x1,go,tm,Ml,M1,z1,om,zl,j1,C1,nm,jl,q1,P1,sm,Cl,A1,O1,eo,ql,L1,jn,N1,am,I1,D1,rm,S1,W1,U1,ha,R1,ma,zf,Cn,ua,im,Pl,H1,lm,K1,jf,it,Al,Q1,dm,B1,V1,Ol,J1,bc,G1,X1,Y1,Ll,Z1,Nl,e2,t2,o2,cm,n2,s2,_o,pm,Il,a2,r2,hm,Dl,i2,l2,mm,Sl,d2,c2,um,Wl,p2,h2,to,Ul,m2,qn,u2,fm,f2,g2,gm,_2,k2,v2,fa,y2,ga,Cf,Pn,_a,_m,Rl,T2,km,b2,qf,lt,Hl,w2,vm,E2,$2,Kl,F2,wc,x2,M2,z2,Ql,j2,Bl,C2,q2,P2,ym,A2,O2,ko,Tm,Vl,L2,N2,bm,Jl,I2,D2,wm,Gl,S2,W2,Em,Xl,U2,R2,oo,Yl,H2,An,K2,$m,Q2,B2,Fm,V2,J2,G2,ka,X2,va,Pf,On,ya,xm,Zl,Y2,Mm,Z2,Af,et,ed,eF,zm,tF,oF,jm,nF,sF,td,aF,Ec,rF,iF,lF,od,dF,nd,cF,pF,hF,Cm,mF,uF,vo,qm,sd,fF,gF,Pm,ad,_F,kF,Am,rd,vF,yF,Om,id,TF,bF,no,ld,wF,Ln,EF,Lm,$F,FF,Nm,xF,MF,zF,Ta,jF,ba,Of,Nn,wa,Im,dd,CF,Dm,qF,Lf,dt,cd,PF,In,AF,Sm,OF,LF,Wm,NF,IF,DF,pd,SF,$c,WF,UF,RF,hd,HF,md,KF,QF,BF,Um,VF,JF,yo,Rm,ud,GF,XF,Hm,fd,YF,ZF,Km,gd,e0,t0,Qm,_d,o0,n0,so,kd,s0,Dn,a0,Bm,r0,i0,Vm,l0,d0,c0,Ea,p0,$a,Nf;return l=new Se({}),M=new Se({}),We=new Se({}),Ue=new W({props:{name:"class transformers.ElectraConfig",anchor:"transformers.ElectraConfig",parameters:[{name:"vocab_size",val:" = 30522"},{name:"embedding_size",val:" = 128"},{name:"hidden_size",val:" = 256"},{name:"num_hidden_layers",val:" = 12"},{name:"num_attention_heads",val:" = 4"},{name:"intermediate_size",val:" = 1024"},{name:"hidden_act",val:" = 'gelu'"},{name:"hidden_dropout_prob",val:" = 0.1"},{name:"attention_probs_dropout_prob",val:" = 0.1"},{name:"max_position_embeddings",val:" = 512"},{name:"type_vocab_size",val:" = 2"},{name:"initializer_range",val:" = 0.02"},{name:"layer_norm_eps",val:" = 1e-12"},{name:"summary_type",val:" = 'first'"},{name:"summary_use_proj",val:" = True"},{name:"summary_activation",val:" = 'gelu'"},{name:"summary_last_dropout",val:" = 0.1"},{name:"pad_token_id",val:" = 0"},{name:"position_embedding_type",val:" = 'absolute'"},{name:"use_cache",val:" = True"},{name:"classifier_dropout",val:" = None"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.ElectraConfig.vocab_size",description:`<strong>vocab_size</strong> (<code>int</code>, <em>optional</em>, defaults to 30522) &#x2014;
...
`}}),us=new Ie({props:{$$slots:{default:[Cj]},$$scope:{ctx:x}}}),fs=new ce({props:{anchor:"transformers.ElectraForMultipleChoice.forward.example",$$slots:{default:[qj]},$$scope:{ctx:x}}}),Qr=new Se({}),Br=new W({props:{name:"class transformers.ElectraForTokenClassification",anchor:"transformers.ElectraForTokenClassification",parameters:[{name:"config",val:""}],parametersDescription:[{anchor:"transformers.ElectraForTokenClassification.config",description:`<strong>config</strong> (<a href="/docs/transformers/main/en/model_doc/electra#transformers.ElectraConfig">ElectraConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
...
`}}),Hs=new Ie({props:{$$slots:{default:[eC]},$$scope:{ctx:x}}}),Ks=new ce({props:{anchor:"transformers.TFElectraForMultipleChoice.call.example",$$slots:{default:[tC]},$$scope:{ctx:x}}}),Ai=new Se({}),Oi=new W({props:{name:"class transformers.TFElectraForTokenClassification",anchor:"transformers.TFElectraForTokenClassification",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.TFElectraForTokenClassification.config",description:`<strong>config</strong> (<a href="/docs/transformers/main/en/model_doc/electra#transformers.ElectraConfig">ElectraConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/main/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/electra/modeling_tf_electra.py#L1474"}}),Bs=new Ie({props:{$$slots:{default:[oC]},$$scope:{ctx:x}}}),Di=new W({props:{name:"call",anchor:"transformers.TFElectraForTokenClassification.call",parameters:[{name:"input_ids",val:": typing.Union[typing.List[tensorflow.python.framework.ops.Tensor], typing.List[numpy.ndarray], typing.List[tensorflow.python.keras.engine.keras_tensor.KerasTensor], typing.Dict[str, tensorflow.python.framework.ops.Tensor], typing.Dict[str, numpy.ndarray], typing.Dict[str, tensorflow.python.keras.engine.keras_tensor.KerasTensor], tensorflow.python.framework.ops.Tensor, numpy.ndarray, tensorflow.python.keras.engine.keras_tensor.KerasTensor, NoneType] = None"},{name:"attention_mask",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"token_type_ids",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"position_ids",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"head_mask",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"inputs_embeds",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"labels",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"training",val:": typing.Optional[bool] = False"}],parametersDescription:[{anchor:"transformers.TFElectraForTokenClassification.call.input_ids",description:`<strong>input_ids</strong> (<code>Numpy array</code> or <code>tf.Tensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/main/en/model_doc/electra#transformers.ElectraTokenizer">ElectraTokenizer</a>. See <a href="/docs/transformers/main/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
<a href="/docs/transformers/main/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> for details.</p>
...
`}}),Zs=new Ie({props:{$$slots:{default:[iC]},$$scope:{ctx:x}}}),ea=new ce({props:{anchor:"transformers.TFElectraForQuestionAnswering.call.example",$$slots:{default:[lC]},$$scope:{ctx:x}}}),ta=new ce({props:{anchor:"transformers.TFElectraForQuestionAnswering.call.example-2",$$slots:{default:[dC]},$$scope:{ctx:x}}}),Qi=new Se({}),Bi=new W({props:{name:"class transformers.FlaxElectraModel",anchor:"transformers.FlaxElectraModel",parameters:[{name:"config",val:": ElectraConfig"},{name:"input_shape",val:": typing.Tuple = (1, 1)"},{name:"seed",val:": int = 0"},{name:"dtype",val:": dtype = <class 'jax.numpy.float32'>"},{name:"_do_init",val:": bool = True"},{name:"gradient_checkpointing",val:": bool = False"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.FlaxElectraModel.config",description:`<strong>config</strong> (<a href="/docs/transformers/main/en/model_doc/electra#transformers.ElectraConfig">ElectraConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
...
doesn\u2019t exist in the generator).`),ye=p(),D=a("p"),Pe=n("This model was contributed by "),Z=a("a"),O=n("lysandre"),Ae=n(". The original code can be found "),L=a("a"),Oe=n("here"),Le=n("."),y=p(),j=a("h2"),De=a("a"),te=a("span"),T(We.$$.fragment),Be=p(),C=a("span"),Ve=n("ElectraConfig"),Qe=p(),de=a("div"),T(Ue.$$.fragment),Je=p(),N=a("p"),X=n("This is the configuration class to store the configuration of a "),He=a("a"),Ge=n("ElectraModel"),Y=n(" or a "),Ke=a("a"),Xe=n("TFElectraModel"),Ne=n(`. It is
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),my=p(),Bt=a("div"),T(Kr.$$.fragment),uy=p(),tn=a("p"),fy=n("The "),Zd=a("a"),gy=n("ElectraForMultipleChoice"),_y=n(" forward method, overrides the "),Cp=a("code"),ky=n("__call__"),vy=n(" special method."),yy=p(),T(us.$$.fragment),Ty=p(),T(fs.$$.fragment),of=p(),on=a("h2"),gs=a("a"),qp=a("span"),T(Qr.$$.fragment),by=p(),Pp=a("span"),wy=n("ElectraForTokenClassification"),nf=p(),mt=a("div"),T(Br.$$.fragment),Ey=p(),Ap=a("p"),$y=n("Electra model with a token classification head on top."),Fy=p(),Op=a("p"),xy=n("Both the discriminator and generator may be loaded into this model."),My=p(),Vr=a("p"),zy=n("This model inherits from "),ec=a("a"),jy=n("PreTrainedModel"),Cy=n(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),mE=p(),T(Ys.$$.fragment),uE=p(),Ct=a("div"),T(Ki.$$.fragment),fE=p(),bn=a("p"),gE=n("The "),_c=a("a"),_E=n("TFElectraForQuestionAnswering"),kE=n(" forward method, overrides the "),vh=a("code"),vE=n("__call__"),yE=n(" special method."),TE=p(),T(Zs.$$.fragment),bE=p(),T(ea.$$.fragment),wE=p(),T(ta.$$.fragment),Tf=p(),wn=a("h2"),oa=a("a"),yh=a("span"),T(Qi.$$.fragment),EE=p(),Th=a("span"),$E=n("FlaxElectraModel"),bf=p(),st=a("div"),T(Bi.$$.fragment),FE=p(),bh=a("p"),xE=n("The bare Electra Model transformer outputting raw hidden-states without any specific head on top."),ME=p(),Vi=a("p"),zE=n("This model inherits from "),kc=a("a"),jE=n("FlaxPreTrainedModel"),CE=n(`. Check the superclass documentation for the generic methods the
...
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),LE=p(),wh=a("p"),NE=n("Finally, this model supports inherent JAX features such as:"),IE=p(),mo=a("ul"),Eh=a("li"),Xi=a("a"),DE=n("Just-In-Time (JIT) compilation"),SE=p(),$h=a("li"),Yi=a("a"),WE=n("Automatic Differentiation"),UE=p(),Fh=a("li"),Zi=a("a"),RE=n("Vectorization"),HE=p(),xh=a("li"),el=a("a"),KE=n("Parallelization"),QE=p(),Xt=a("div"),T(tl.$$.fragment),BE=p(),En=a("p"),VE=n("The "),Mh=a("code"),JE=n("FlaxElectraPreTrainedModel"),GE=n(" forward method, overrides the "),zh=a("code"),XE=n("__call__"),YE=n(" special method."),ZE=p(),T(na.$$.fragment),e$=p(),T(sa.$$.fragment),wf=p(),$n=a("h2"),aa=a("a"),jh=a("span"),T(ol.$$.fragment),t$=p(),Ch=a("span"),o$=n("FlaxElectraForPreTraining"),Ef=p(),Ze=a("div"),T(nl.$$.fragment),n$=p(),qh=a("p"),s$=n("Electra model with a binary classification head on top as used during pretraining for identifying generated tokens."),a$=p(),Ph=a("p"),r$=n("It is recommended to load the discriminator checkpoint into that model."),i$=p(),sl=a("p"),l$=n("This model inherits from "),vc=a("a"),d$=n("FlaxPreTrainedModel"),c$=n(`. Check the superclass documentation for the generic methods the
...
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),$1=p(),em=a("p"),F1=n("Finally, this model supports inherent JAX features such as:"),x1=p(),go=a("ul"),tm=a("li"),Ml=a("a"),M1=n("Just-In-Time (JIT) compilation"),z1=p(),om=a("li"),zl=a("a"),j1=n("Automatic Differentiation"),C1=p(),nm=a("li"),jl=a("a"),q1=n("Vectorization"),P1=p(),sm=a("li"),Cl=a("a"),A1=n("Parallelization"),O1=p(),eo=a("div"),T(ql.$$.fragment),L1=p(),jn=a("p"),N1=n("The "),am=a("code"),I1=n("FlaxElectraPreTrainedModel"),D1=n(" forward method, overrides the "),rm=a("code"),S1=n("__call__"),W1=n(" special method."),U1=p(),T(ha.$$.fragment),R1=p(),T(ma.$$.fragment),zf=p(),Cn=a("h2"),ua=a("a"),im=a("span"),T(Pl.$$.fragment),H1=p(),lm=a("span"),K1=n("FlaxElectraForSequenceClassification"),jf=p(),it=a("div"),T(Al.$$.fragment),Q1=p(),dm=a("p"),B1=n(`Electra Model transformer with a sequence classification/regression head on top (a linear layer on top of the
...
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),z2=p(),Ql=a("p"),j2=n(`This model is also a Flax Linen
`),Bl=a("a"),C2=n("flax.nn.Module"),q2=n(` subclass. Use it as a
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),P2=p(),ym=a("p"),A2=n("Finally, this model supports inherent JAX features such as:"),O2=p(),ko=a("ul"),Tm=a("li"),Vl=a("a"),L2=n("Just-In-Time (JIT) compilation"),N2=p(),bm=a("li"),Jl=a("a"),I2=n("Automatic Differentiation"),D2=p(),wm=a("li"),Gl=a("a"),S2=n("Vectorization"),W2=p(),Em=a("li"),Xl=a("a"),U2=n("Parallelization"),R2=p(),oo=a("div"),T(Yl.$$.fragment),H2=p(),An=a("p"),K2=n("The "),$m=a("code"),Q2=n("FlaxElectraPreTrainedModel"),B2=n(" forward method, overrides the "),Fm=a("code"),V2=n("__call__"),J2=n(" special method."),G2=p(),T(ka.$$.fragment),X2=p(),T(va.$$.fragment),Pf=p(),On=a("h2"),ya=a("a"),xm=a("span"),T(Zl.$$.fragment),Y2=p(),Mm=a("span"),Z2=n("FlaxElectraForTokenClassification"),Af=p(),et=a("div"),T(ed.$$.fragment),eF=p(),zm=a("p"),tF=n("Electra model with a token classification head on top."),oF=p(),jm=a("p"),nF=n("Both the discriminator and generator may be loaded into this model."),sF=p(),td=a("p"),aF=n("This model inherits from "),Ec=a("a"),rF=n("FlaxPreTrainedModel"),iF=n(`. Check the superclass documentation for the generic methods the
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Kf.forEach(t),zk=h(ao),Kt=r(ao,"DIV",{class:!0});var za=i(Kt);b(yr.$$.fragment,za),jk=h(za),Bo=r(za,"P",{});var xc=i(Bo);Ck=s(xc,"The "),Kd=r(xc,"A",{href:!0});var z0=i(Kd);qk=s(z0,"ElectraForPreTraining"),z0.forEach(t),Pk=s(xc," forward method, overrides the "),up=r(xc,"CODE",{});var j0=i(up);Ak=s(j0,"__call__"),j0.forEach(t),Ok=s(xc," special method."),xc.forEach(t),Lk=h(za),b(Yn.$$.fragment,za),Nk=h(za),b(Zn.$$.fragment,za),za.forEach(t),ao.forEach(t),Vu=h(o),Vo=r(o,"H2",{class:!0});var Qf=i(Vo);es=r(Qf,"A",{id:!0,class:!0,href:!0});var C0=i(es);fp=r(C0,"SPAN",{});var q0=i(fp);b(Tr.$$.fragment,q0),q0.forEach(t),C0.forEach(t),Ik=h(Qf),gp=r(Qf,"SPAN",{});var P0=i(gp);Dk=s(P0,"ElectraForCausalLM"),P0.forEach(t),Qf.forEach(t),Ju=h(o),Tt=r(o,"DIV",{class:!0});var xo=i(Tt);b(br.$$.fragment,xo),Sk=h(xo),wr=r(xo,"P",{});var Bf=i(wr);Wk=s(Bf,"ELECTRA Model with a "),_p=r(Bf,"CODE",{});var A0=i(_p);Uk=s(A0,"language modeling"),A0.forEach(t),Rk=s(Bf," head on top for CLM fine-tuning."),Bf.forEach(t),Hk=h(xo),Er=r(xo,"P",{});var Vf=i(Er);Kk=s(Vf,"This model inherits from "),Qd=r(Vf,"A",{href:!0});var O0=i(Qd);Qk=s(O0,"PreTrainedModel"),O0.forEach(t),Bk=s(Vf,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),ng.forEach(t),dy=h(jo),Rr=r(jo,"P",{});var sg=i(Rr);cy=s(sg,"This model is also a PyTorch "),Hr=r(sg,"A",{href:!0,rel:!0});var ix=i(Hr);py=s(ix,"torch.nn.Module"),ix.forEach(t),hy=s(sg,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),sg.forEach(t),my=h(jo),Bt=r(jo,"DIV",{class:!0});var Ca=i(Bt);b(Kr.$$.fragment,Ca),uy=h(Ca),tn=r(Ca,"P",{});var Cc=i(tn);fy=s(Cc,"The "),Zd=r(Cc,"A",{href:!0});var lx=i(Zd);gy=s(lx,"ElectraForMultipleChoice"),lx.forEach(t),_y=s(Cc," forward method, overrides the "),Cp=r(Cc,"CODE",{});var dx=i(Cp);ky=s(dx,"__call__"),dx.forEach(t),vy=s(Cc," special method."),Cc.forEach(t),yy=h(Ca),b(us.$$.fragment,Ca),Ty=h(Ca),b(fs.$$.fragment,Ca),Ca.forEach(t),jo.forEach(t),of=h(o),on=r(o,"H2",{class:!0});var ag=i(on);gs=r(ag,"A",{id:!0,class:!0,href:!0});var cx=i(gs);qp=r(cx,"SPAN",{});var px=i(qp);b(Qr.$$.fragment,px),px.forEach(t),cx.forEach(t),by=h(ag),Pp=r(ag,"SPAN",{});var hx=i(Pp);wy=s(hx,"ElectraForTokenClassification"),hx.forEach(t),ag.forEach(t),nf=h(o),mt=r(o,"DIV",{class:!0});var io=i(mt);b(Br.$$.fragment,io),Ey=h(io),Ap=r(io,"P",{});var mx=i(Ap);$y=s(mx,"Electra model with a token classification head on top."),mx.forEach(t),Fy=h(io),Op=r(io,"P",{});var ux=i(Op);xy=s(ux,"Both the discriminator and generator may be loaded into this model."),ux.forEach(t),My=h(io),Vr=r(io,"P",{});var rg=i(Vr);zy=s(rg,"This model inherits from "),ec=r(rg,"A",{href:!0});var fx=i(ec);jy=s(fx,"PreTrainedModel"),fx.forEach(t),Cy=s(rg,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),ig.forEach(t),Ly=h(io),Ft=r(io,"DIV",{class:!0});var Co=i(Ft);b(Xr.$$.fragment,Co),Ny=h(Co),nn=r(Co,"P",{});var qc=i(nn);Iy=s(qc,"The "),tc=r(qc,"A",{href:!0});var _x=i(tc);Dy=s(_x,"ElectraForTokenClassification"),_x.forEach(t),Sy=s(qc," forward method, overrides the "),Lp=r(qc,"CODE",{});var kx=i(Lp);Wy=s(kx,"__call__"),kx.forEach(t),Uy=s(qc," special method."),qc.forEach(t),Ry=h(Co),b(_s.$$.fragment,Co),Hy=h(Co),b(ks.$$.fragment,Co),Ky=h(Co),b(vs.$$.fragment,Co),Co.forEach(t),io.forEach(t),sf=h(o),sn=r(o,"H2",{class:!0});var lg=i(sn);ys=r(lg,"A",{id:!0,class:!0,href:!0});var vx=i(ys);Np=r(vx,"SPAN",{});var yx=i(Np);b(Yr.$$.fragment,yx),yx.forEach(t),vx.forEach(t),Qy=h(lg),Ip=r(lg,"SPAN",{});var Tx=i(Ip);By=s(Tx,"ElectraForQuestionAnswering"),Tx.forEach(t),lg.forEach(t),af=h(o),Et=r(o,"DIV",{class:!0});var qo=i(Et);b(Zr.$$.fragment,qo),Vy=h(qo),an=r(qo,"P",{});var Pc=i(an);Jy=s(Pc,`ELECTRA Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),jg.forEach(t),dE=h(ho),Ri=r(ho,"P",{});var Cg=i(Ri);cE=s(Cg,"This model is also a "),Hi=r(Cg,"A",{href:!0,rel:!0});var CM=i(Hi);pE=s(CM,"tf.keras.Model"),CM.forEach(t),hE=s(Cg,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Cg.forEach(t),mE=h(ho),b(Ys.$$.fragment,ho),uE=h(ho),Ct=r(ho,"DIV",{class:!0});var No=i(Ct);b(Ki.$$.fragment,No),fE=h(No),bn=r(No,"P",{});var Uc=i(bn);gE=s(Uc,"The "),_c=r(Uc,"A",{href:!0});var qM=i(_c);_E=s(qM,"TFElectraForQuestionAnswering"),qM.forEach(t),kE=s(Uc," forward method, overrides the "),vh=r(Uc,"CODE",{});var PM=i(vh);vE=s(PM,"__call__"),PM.forEach(t),yE=s(Uc," special method."),Uc.forEach(t),TE=h(No),b(Zs.$$.fragment,No),bE=h(No),b(ea.$$.fragment,No),wE=h(No),b(ta.$$.fragment,No),No.forEach(t),ho.forEach(t),Tf=h(o),wn=r(o,"H2",{class:!0});var qg=i(wn);oa=r(qg,"A",{id:!0,class:!0,href:!0});var AM=i(oa);yh=r(AM,"SPAN",{});var OM=i(yh);b(Qi.$$.fragment,OM),OM.forEach(t),AM.forEach(t),EE=h(qg),Th=r(qg,"SPAN",{});var LM=i(Th);$E=s(LM,"FlaxElectraModel"),LM.forEach(t),qg.forEach(t),bf=h(o),st=r(o,"DIV",{class:!0});var Lt=i(st);b(Bi.$$.fragment,Lt),FE=h(Lt),bh=r(Lt,"P",{});var NM=i(bh);xE=s(NM,"The bare Electra Model transformer outputting raw hidden-states without any specific head on top."),NM.forEach(t),ME=h(Lt),Vi=r(Lt,"P",{});var Pg=i(Vi);zE=s(Pg,"This model inherits from "),kc=r(Pg,"A",{href:!0});var IM=i(kc);jE=s(IM,"FlaxPreTrainedModel"),IM.forEach(t),CE=s(Pg,`. Check the superclass documentation for the generic methods the
...
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),Hg.forEach(t),$1=h(It),em=r(It,"P",{});var Iz=i(em);F1=s(Iz,"Finally, this model supports inherent JAX features such as:"),Iz.forEach(t),x1=h(It),go=r(It,"UL",{});var Wa=i(go);tm=r(Wa,"LI",{});var Dz=i(tm);Ml=r(Dz,"A",{href:!0,rel:!0});var Sz=i(Ml);M1=s(Sz,"Just-In-Time (JIT) compilation"),Sz.forEach(t),Dz.forEach(t),z1=h(Wa),om=r(Wa,"LI",{});var Wz=i(om);zl=r(Wz,"A",{href:!0,rel:!0});var Uz=i(zl);j1=s(Uz,"Automatic Differentiation"),Uz.forEach(t),Wz.forEach(t),C1=h(Wa),nm=r(Wa,"LI",{});var Rz=i(nm);jl=r(Rz,"A",{href:!0,rel:!0});var Hz=i(jl);q1=s(Hz,"Vectorization"),Hz.forEach(t),Rz.forEach(t),P1=h(Wa),sm=r(Wa,"LI",{});var Kz=i(sm);Cl=r(Kz,"A",{href:!0,rel:!0});var Qz=i(Cl);A1=s(Qz,"Parallelization"),Qz.forEach(t),Kz.forEach(t),Wa.forEach(t),O1=h(It),eo=r(It,"DIV",{class:!0});var Ua=i(eo);b(ql.$$.fragment,Ua),L1=h(Ua),jn=r(Ua,"P",{});var Qc=i(jn);N1=s(Qc,"The "),am=r(Qc,"CODE",{});var Bz=i(am);I1=s(Bz,"FlaxElectraPreTrainedModel"),Bz.forEach(t),D1=s(Qc," forward method, overrides the "),rm=r(Qc,"CODE",{});var Vz=i(rm);S1=s(Vz,"__call__"),Vz.forEach(t),W1=s(Qc," special method."),Qc.forEach(t),U1=h(Ua),b(ha.$$.fragment,Ua),R1=h(Ua),b(ma.$$.fragment,Ua),Ua.forEach(t),It.forEach(t),zf=h(o),Cn=r(o,"H2",{class:!0});var Kg=i(Cn);ua=r(Kg,"A",{id:!0,class:!0,href:!0});var Jz=i(ua);im=r(Jz,"SPAN",{});var Gz=i(im);b(Pl.$$.fragment,Gz),Gz.forEach(t),Jz.forEach(t),H1=h(Kg),lm=r(Kg,"SPAN",{});var Xz=i(lm);K1=s(Xz,"FlaxElectraForSequenceClassification"),Xz.forEach(t),Kg.forEach(t),jf=h(o),it=r(o,"DIV",{class:!0});var Dt=i(it);b(Al.$$.fragment,Dt),Q1=h(Dt),dm=r(Dt,"P",{});var Yz=i(dm);B1=s(Yz,`Electra Model transformer with a sequence classification/regression head on top (a linear layer on top of the
