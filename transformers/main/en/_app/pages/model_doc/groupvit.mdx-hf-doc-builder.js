import{S as tp,i as op,s as np,e as a,k as h,w as $,t as r,M as rp,c as i,d as o,m as g,a as l,x as y,h as s,b as m,G as e,g as v,y as b,q as w,o as V,B as x,v as sp,L as ae}from"../../chunks/vendor-hf-doc-builder.js";import{T as ue}from"../../chunks/Tip-hf-doc-builder.js";import{D as P}from"../../chunks/Docstring-hf-doc-builder.js";import{C as ie}from"../../chunks/CodeBlock-hf-doc-builder.js";import{I as me}from"../../chunks/IconCopyLink-hf-doc-builder.js";import{E as se}from"../../chunks/ExampleCodeBlock-hf-doc-builder.js";function ap(k){let d,T,u,c,f;return c=new ie({props:{code:`from transformers import GroupViTTextConfig, GroupViTTextModel
...
<span class="hljs-meta">&gt;&gt;&gt; </span>configuration = model.config`}}),{c(){d=a("p"),T=r("Example:"),u=h(),$(c.$$.fragment)},l(n){d=i(n,"P",{});var p=l(d);T=s(p,"Example:"),p.forEach(o),u=g(n),y(c.$$.fragment,n)},m(n,p){v(n,d,p),e(d,T),v(n,u,p),b(c,n,p),f=!0},p:ae,i(n){f||(w(c.$$.fragment,n),f=!0)},o(n){V(c.$$.fragment,n),f=!1},d(n){n&&o(d),n&&o(u),x(c,n)}}}function ip(k){let d,T,u,c,f;return c=new ie({props:{code:`from transformers import GroupViTVisionConfig, GroupViTVisionModel
...
`),je=a("code"),mo=r('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(M){d=i(M,"P",{});var q=l(d);T=s(q,"TF 2.0 models accepts two formats as inputs:"),q.forEach(o),u=g(M),c=i(M,"UL",{});var mt=l(c);f=i(mt,"LI",{});var pn=l(f);n=s(pn,"having all inputs as keyword arguments (like PyTorch models), or"),pn.forEach(o),p=g(mt),G=i(mt,"LI",{});var R=l(G);ao=s(R,"having all inputs as a list, tuple or dict in the first positional arguments."),R.forEach(o),mt.forEach(o),ke=g(M),j=i(M,"P",{});var ye=l(j);H=s(ye,"This second option is useful when using "),le=i(ye,"CODE",{});var be=l(le);de=s(be,"tf.keras.Model.fit"),be.forEach(o),io=s(ye,` method which currently requires having all the
tensors in the first argument of the model call function: `),pe=i(ye,"CODE",{});var cn=l(pe);lo=s(cn,"model(inputs)"),cn.forEach(o),dt=s(ye,"."),ye.forEach(o),F=g(M),fe=i(M,"P",{});var un=l(fe);ce=s(un,`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
...
`),_e=i(E,"CODE",{});var fn=l(_e);Te=s(fn,"model([input_ids, attention_mask])"),fn.forEach(o),uo=s(E," or "),ve=i(E,"CODE",{});var we=l(ve);K=s(we,"model([input_ids, attention_mask, token_type_ids])"),we.forEach(o),E.forEach(o),S=g(O),$e=i(O,"LI",{});var ho=l($e);Ee=s(ho,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),je=i(ho,"CODE",{});var hn=l(je);mo=s(hn,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),hn.forEach(o),ho.forEach(o),O.forEach(o)},m(M,q){v(M,d,q),e(d,T),v(M,u,q),v(M,c,q),e(c,f),e(f,n),e(c,p),e(c,G),e(G,ao),v(M,ke,q),v(M,j,q),e(j,H),e(j,le),e(le,de),e(j,io),e(j,pe),e(pe,lo),e(j,dt),v(M,F,q),v(M,fe,q),e(fe,ce),v(M,pt,q),v(M,L,q),e(L,I),e(I,po),e(I,Ge),e(Ge,ct),e(I,he),e(I,Me),e(Me,ut),e(L,ge),e(L,D),e(D,co),e(D,_e),e(_e,Te),e(D,uo),e(D,ve),e(ve,K),e(L,S),e(L,$e),e($e,Ee),e($e,je),e(je,mo)},d(M){M&&o(d),M&&o(u),M&&o(c),M&&o(ke),M&&o(j),M&&o(F),M&&o(fe),M&&o(pt),M&&o(L)}}}function vp(k){let d,T,u,c,f;return{c(){d=a("p"),T=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),u=a("code"),c=r("Module"),f=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(n){d=i(n,"P",{});var p=l(d);T=s(p,"Although the recipe for forward pass needs to be defined within this function, one should call the "),u=i(p,"CODE",{});var G=l(u);c=s(G,"Module"),G.forEach(o),f=s(p,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),p.forEach(o)},m(n,p){v(n,d,p),e(d,T),e(d,u),e(u,c),e(d,f)},d(n){n&&o(d)}}}function $p(k){let d,T,u,c,f;return c=new ie({props:{code:`from PIL import Image
import requests
...
<span class="hljs-meta">&gt;&gt;&gt; </span>outputs = model(**inputs)
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_state = outputs.last_hidden_state
<span class="hljs-meta">&gt;&gt;&gt; </span>pooled_output = outputs.pooler_output  <span class="hljs-comment"># pooled CLS states</span>`}}),{c(){d=a("p"),T=r("Examples:"),u=h(),$(c.$$.fragment)},l(n){d=i(n,"P",{});var p=l(d);T=s(p,"Examples:"),p.forEach(o),u=g(n),y(c.$$.fragment,n)},m(n,p){v(n,d,p),e(d,T),v(n,u,p),b(c,n,p),f=!0},p:ae,i(n){f||(w(c.$$.fragment,n),f=!0)},o(n){V(c.$$.fragment,n),f=!1},d(n){n&&o(d),n&&o(u),x(c,n)}}}function Ep(k){let d,T,u,c,f,n,p,G,ao,ke,j,H,le,de,io,pe,lo,dt,F,fe,ce,pt,L,I,po,Ge,ct,he,Me,ut,ge,D,co,_e,Te,uo,ve,K,S,$e,Ee,je,mo,M,q,mt,pn,R,ye,be,cn,un,O,Pe,mn,fo,E,fn,we,ho,hn,go,ks,Gs,_o,Ms,Es,To,js,Ps,vo,zs,Cs,$o,qs,Fs,Wr,ze,ft,Zn,yo,Is,er,As,Br,W,bo,Ls,Ve,gn,Ds,Os,_n,Ns,Ss,wo,Ws,Bs,Us,Ce,Hs,Tn,Ks,Rs,vn,Js,Ys,Xs,ht,Vo,Qs,xo,Zs,$n,ea,ta,Ur,qe,gt,tr,ko,oa,or,na,Hr,B,Go,ra,Fe,sa,yn,aa,ia,Mo,la,da,pa,Ie,ca,bn,ua,ma,wn,fa,ha,ga,_t,Kr,Ae,Tt,nr,Eo,_a,rr,Ta,Rr,U,jo,va,Le,$a,Vn,ya,ba,Po,wa,Va,xa,De,ka,xn,Ga,Ma,kn,Ea,ja,Pa,vt,Jr,Oe,$t,sr,zo,za,ar,Ca,Yr,A,Co,qa,qo,Fa,Fo,Ia,Aa,La,J,Io,Da,Ne,Oa,Gn,Na,Sa,ir,Wa,Ba,Ua,yt,Ha,bt,Ka,Y,Ao,Ra,Se,Ja,Mn,Ya,Xa,lr,Qa,Za,ei,wt,ti,Vt,oi,X,Lo,ni,We,ri,En,si,ai,dr,ii,li,di,xt,pi,kt,Xr,Be,Gt,pr,Do,ci,cr,ui,Qr,Ue,Oo,mi,Q,No,fi,He,hi,jn,gi,_i,ur,Ti,vi,$i,Mt,yi,Et,Zr,Ke,jt,mr,So,bi,fr,wi,es,Re,Wo,Vi,Z,Bo,xi,Je,ki,Pn,Gi,Mi,hr,Ei,ji,Pi,Pt,zi,zt,ts,Ye,Ct,gr,Uo,Ci,_r,qi,os,z,Ho,Fi,Ko,Ii,zn,Ai,Li,Di,Ro,Oi,Jo,Ni,Si,Wi,qt,Bi,ee,Yo,Ui,Xe,Hi,Cn,Ki,Ri,Tr,Ji,Yi,Xi,Ft,Qi,It,Zi,te,Xo,el,Qe,tl,qn,ol,nl,vr,rl,sl,al,At,il,Lt,ll,oe,Qo,dl,Ze,pl,Fn,cl,ul,$r,ml,fl,hl,Dt,gl,Ot,ns,et,Nt,yr,Zo,_l,br,Tl,rs,tt,en,vl,ne,tn,$l,ot,yl,In,bl,wl,wr,Vl,xl,kl,St,Gl,Wt,ss,nt,Bt,Vr,on,Ml,xr,El,as,rt,nn,jl,re,rn,Pl,st,zl,An,Cl,ql,kr,Fl,Il,Al,Ut,Ll,Ht,is;return n=new me({}),de=new me({}),yo=new me({}),bo=new P({props:{name:"class transformers.GroupViTConfig",anchor:"transformers.GroupViTConfig",parameters:[{name:"text_config_dict",val:" = None"},{name:"vision_config_dict",val:" = None"},{name:"projection_dim",val:" = 256"},{name:"projection_intermediate_dim",val:" = 4096"},{name:"logit_scale_init_value",val:" = 2.6592"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.GroupViTConfig.text_config_dict",description:`<strong>text_config_dict</strong> (<code>dict</code>, <em>optional</em>) &#x2014;
...
<p><a
  href="/docs/transformers/main/en/main_classes/output#transformers.modeling_tf_outputs.TFBaseModelOutputWithPooling"
>transformers.modeling_tf_outputs.TFBaseModelOutputWithPooling</a> or <code>tuple(tf.Tensor)</code></p>
`}}),Ut=new ue({props:{$$slots:{default:[Gp]},$$scope:{ctx:k}}}),Ht=new se({props:{anchor:"transformers.TFGroupViTVisionModel.call.example",$$slots:{default:[Mp]},$$scope:{ctx:k}}}),{c(){d=a("meta"),T=h(),u=a("h1"),c=a("a"),f=a("span"),$(n.$$.fragment),p=h(),G=a("span"),ao=r("GroupViT"),ke=h(),j=a("h2"),H=a("a"),le=a("span"),$(de.$$.fragment),io=h(),pe=a("span"),lo=r("Overview"),dt=h(),F=a("p"),fe=r("The GroupViT model was proposed in "),ce=a("a"),pt=r("GroupViT: Semantic Segmentation Emerges from Text Supervision"),L=r(` by Jiarui Xu, Shalini De Mello, Sifei Liu, Wonmin Byeon, Thomas Breuel, Jan Kautz, Xiaolong Wang.
Inspired by `),I=a("a"),po=r("CLIP"),Ge=r(", GroupViT is a vision-language model that can perform zero-shot semantic segmentation on any given vocabulary categories."),ct=h(),he=a("p"),Me=r("The abstract from the paper is the following:"),ut=h(),ge=a("p"),D=a("em"),co=r("Grouping and recognition are important components of visual scene understanding, e.g., for object detection and semantic segmentation. With end-to-end deep learning systems, grouping of image regions usually happens implicitly via top-down supervision from pixel-level recognition labels. Instead, in this paper, we propose to bring back the grouping mechanism into deep networks, which allows semantic segments to emerge automatically with only text supervision. We propose a hierarchical Grouping Vision Transformer (GroupViT), which goes beyond the regular grid structure representation and learns to group image regions into progressively larger arbitrary-shaped segments. We train GroupViT jointly with a text encoder on a large-scale image-text dataset via contrastive losses. With only text supervision and without any pixel-level annotations, GroupViT learns to group together semantic regions and successfully transfers to the task of semantic segmentation in a zero-shot manner, i.e., without any further fine-tuning. It achieves a zero-shot accuracy of 52.3% mIoU on the PASCAL VOC 2012 and 22.4% mIoU on PASCAL Context datasets, and performs competitively to state-of-the-art transfer-learning methods requiring greater levels of supervision."),_e=h(),Te=a("p"),uo=r("Tips:"),ve=h(),K=a("ul"),S=a("li"),$e=r("You may specify "),Ee=a("code"),je=r("output_segmentation=True"),mo=r(" in the forward of "),M=a("code"),q=r("GroupViTModel"),mt=r(" to get the segmentation logits of input texts."),pn=h(),R=a("li"),ye=r("The quickest way to get started with GroupViT is by checking the "),be=a("a"),cn=r("example notebooks"),un=r(" (which showcase zero-shot segmentation inference). One can also check out the "),O=a("a"),Pe=r("HuggingFace Spaces demo"),mn=r(" to play with GroupViT."),fo=h(),E=a("p"),fn=r("This model was contributed by "),we=a("a"),ho=r("xvjiarui"),hn=r(". The TensorFlow version was contributed by "),go=a("a"),ks=r("ariG23498"),Gs=r(" with the help of "),_o=a("a"),Ms=r("Yih-Dar SHIEH"),Es=r(", "),To=a("a"),js=r("Amy Roberts"),Ps=r(", and "),vo=a("a"),zs=r("Joao Gante"),Cs=r(`.
The original code can be found `),$o=a("a"),qs=r("here"),Fs=r("."),Wr=h(),ze=a("h2"),ft=a("a"),Zn=a("span"),$(yo.$$.fragment),Is=h(),er=a("span"),As=r("GroupViTConfig"),Br=h(),W=a("div"),$(bo.$$.fragment),Ls=h(),Ve=a("p"),gn=a("a"),Ds=r("GroupViTConfig"),Os=r(" is the configuration class to store the configuration of a "),_n=a("a"),Ns=r("GroupViTModel"),Ss=r(`. It is used to
...
documentation from `),wn=a("a"),fa=r("PretrainedConfig"),ha=r(" for more information."),ga=h(),$(_t.$$.fragment),Kr=h(),Ae=a("h2"),Tt=a("a"),nr=a("span"),$(Eo.$$.fragment),_a=h(),rr=a("span"),Ta=r("GroupViTVisionConfig"),Rr=h(),U=a("div"),$(jo.$$.fragment),va=h(),Le=a("p"),$a=r("This is the configuration class to store the configuration of a "),Vn=a("a"),ya=r("GroupViTVisionModel"),ba=r(`. It is used to instantiate
