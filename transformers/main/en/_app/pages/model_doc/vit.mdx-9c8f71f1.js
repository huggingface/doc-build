import{S as mm,i as fm,s as um,e as a,k as d,w,t as r,M as gm,c as n,d as t,m as c,a as s,x as b,h as i,b as l,F as e,g as f,y,q as $,o as x,B as F}from"../../chunks/vendor-6b77c823.js";import{T as _e}from"../../chunks/Tip-39098574.js";import{D as W}from"../../chunks/Docstring-abef54e3.js";import{C as Ft}from"../../chunks/CodeBlock-3a8b25a8.js";import{I as ve}from"../../chunks/IconCopyLink-7a11ce68.js";function _m(I){let h,v,m,g,T;return{c(){h=a("p"),v=r(`This is a recently introduced model so the API hasn\u2019t been tested extensively. There may be some bugs or slight
breaking changes to fix it in the future. If you see something strange, file a `),m=a("a"),g=r("Github Issue"),T=r("."),this.h()},l(_){h=n(_,"P",{});var u=s(h);v=i(u,`This is a recently introduced model so the API hasn\u2019t been tested extensively. There may be some bugs or slight
breaking changes to fix it in the future. If you see something strange, file a `),m=n(u,"A",{href:!0,rel:!0});var V=s(m);g=i(V,"Github Issue"),V.forEach(t),T=i(u,"."),u.forEach(t),this.h()},h(){l(m,"href","https://github.com/huggingface/transformers/issues/new?assignees=&labels=&template=bug-report.md&title"),l(m,"rel","nofollow")},m(_,u){f(_,h,u),e(h,v),e(h,m),e(m,g),e(h,T)},d(_){_&&t(h)}}}function vm(I){let h,v;return{c(){h=a("p"),v=r(`NumPy arrays and PyTorch tensors are converted to PIL images when resizing, so the most efficient is to pass
PIL images.`)},l(m){h=n(m,"P",{});var g=s(h);v=i(g,`NumPy arrays and PyTorch tensors are converted to PIL images when resizing, so the most efficient is to pass
...
the latter silently ignores them.`)},l(_){h=n(_,"P",{});var u=s(h);v=i(u,"Although the recipe for forward pass needs to be defined within this function, one should call the "),m=n(u,"CODE",{});var V=s(m);g=i(V,"Module"),V.forEach(t),T=i(u,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
`}}),st=new _e({props:{$$slots:{default:[Tm]},$$scope:{ctx:I}}}),Qt=new Ft({props:{code:`from transformers import ViTFeatureExtractor, ViTModel
import torch
...
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-built_in">print</span>(<span class="hljs-string">&quot;Predicted class:&quot;</span>, model.config.id2label[predicted_class_idx.item()])`}}),{c(){h=a("meta"),v=d(),m=a("h1"),g=a("a"),T=a("span"),w(_.$$.fragment),u=d(),V=a("span"),he=r("Vision Transformer (ViT)"),R=d(),w(k.$$.fragment),ie=d(),j=a("h2"),B=a("a"),oe=a("span"),w(C.$$.fragment),pe=d(),ae=a("span"),E=r("Overview"),M=d(),z=a("p"),Me=r("The Vision Transformer (ViT) model was proposed in "),ne=a("a"),L=r(`An Image is Worth 16x16 Words: Transformers for Image Recognition
