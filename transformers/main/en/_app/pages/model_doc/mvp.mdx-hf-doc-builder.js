...
Labels for computing the sequence classification/regression loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>. If <code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/mvp/modeling_mvp.py#L1621"}}),Qe=new Jo({props:{$$slots:{default:[qp]},$$scope:{ctx:z}}}),He=new K({props:{anchor:"transformers.MvpForSequenceClassification.forward.example",$$slots:{default:[Fp]},$$scope:{ctx:z}}}),Je=new K({props:{anchor:"transformers.MvpForSequenceClassification.forward.example-2",$$slots:{default:[Cp]},$$scope:{ctx:z}}}),ro=new Z({}),io=new I({props:{name:"class transformers.MvpForQuestionAnswering",anchor:"transformers.MvpForQuestionAnswering",parameters:[{name:"config",val:""}],parametersDescription:[{anchor:"transformers.MvpForQuestionAnswering.config",description:`<strong>config</strong> (<a href="/docs/transformers/main/en/model_doc/mvp#transformers.MvpConfig">MvpConfig</a>) &#x2014;
Model configuration class with all the parameters of the model. Initializing with a config file does not
load the weights associated with the model, only the configuration. Check out the
