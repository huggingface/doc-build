import{S as Ia,i as Aa,s as Pa,e as n,k as c,w,t as r,M as qa,c as a,d as o,m as h,a as s,x as v,h as i,b as l,N as za,F as e,g as m,y as b,q as S,o as $,B as y}from"../../chunks/vendor-4833417e.js";import{T as Dn}from"../../chunks/Tip-fffd6df1.js";import{D as ze}from"../../chunks/Docstring-4f315ed9.js";import{C as eo}from"../../chunks/CodeBlock-6a3d1b46.js";import{I as at}from"../../chunks/IconCopyLink-4b81c553.js";import"../../chunks/CopyButton-dacfbfaf.js";function Na(O){let p,T,f,_,k;return{c(){p=n("p"),T=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=n("code"),_=r("Module"),k=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(u){p=a(u,"P",{});var g=s(p);T=i(g,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=a(g,"CODE",{});var M=s(f);_=i(M,"Module"),M.forEach(o),k=i(g,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),g.forEach(o)},m(u,g){m(u,p,g),e(p,T),e(p,f),e(f,_),e(p,k)},d(u){u&&o(p)}}}function Oa(O){let p,T,f,_,k;return{c(){p=n("p"),T=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=n("code"),_=r("Module"),k=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(u){p=a(u,"P",{});var g=s(p);T=i(g,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=a(g,"CODE",{});var M=s(f);_=i(M,"Module"),M.forEach(o),k=i(g,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),g.forEach(o)},m(u,g){m(u,p,g),e(p,T),e(p,f),e(f,_),e(p,k)},d(u){u&&o(p)}}}function La(O){let p,T,f,_,k;return{c(){p=n("p"),T=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=n("code"),_=r("Module"),k=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(u){p=a(u,"P",{});var g=s(p);T=i(g,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=a(g,"CODE",{});var M=s(f);_=i(M,"Module"),M.forEach(o),k=i(g,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),g.forEach(o)},m(u,g){m(u,p,g),e(p,T),e(p,f),e(f,_),e(p,k)},d(u){u&&o(p)}}}function Da(O){let p,T,f,_,k,u,g,M,to,xt,L,J,st,de,oo,rt,no,Et,D,ao,ce,so,ro,io,jt,Ne,lo,Ft,Oe,it,co,Ct,Le,ho,It,De,he,mo,We,po,fo,At,Q,Wn,Pt,X,uo,He,go,_o,qt,P,wo,me,vo,bo,pe,So,$o,zt,W,ee,lt,fe,yo,dt,To,Nt,F,ue,ko,H,Mo,Be,xo,Eo,ge,jo,Fo,Co,B,Io,Ue,Ao,Po,Ve,qo,zo,No,_e,Ot,U,te,ct,we,Oo,ht,Lo,Lt,I,ve,Do,be,Wo,Se,Ho,Bo,Uo,x,$e,Vo,V,Ko,Ke,Yo,Zo,mt,Ro,Go,Jo,oe,Qo,pt,Xo,en,ye,Dt,K,ne,ft,Te,tn,ut,on,Wt,A,ke,nn,Y,an,gt,sn,rn,Me,ln,dn,cn,E,xe,hn,Z,mn,Ye,pn,fn,_t,un,gn,_n,ae,wn,wt,vn,bn,Ee,Ht,R,se,vt,je,Sn,bt,$n,Bt,C,Fe,yn,St,Tn,kn,Ce,Mn,Ie,xn,En,jn,j,Ae,Fn,G,Cn,Ze,In,An,$t,Pn,qn,zn,re,Nn,yt,On,Ln,Pe,Ut;return u=new at({}),de=new at({}),fe=new at({}),ue=new ze({props:{name:"class transformers.SwinConfig",anchor:"transformers.SwinConfig",parameters:[{name:"image_size",val:" = 224"},{name:"patch_size",val:" = 4"},{name:"num_channels",val:" = 3"},{name:"embed_dim",val:" = 96"},{name:"depths",val:" = [2, 2, 6, 2]"},{name:"num_heads",val:" = [3, 6, 12, 24]"},{name:"window_size",val:" = 7"},{name:"mlp_ratio",val:" = 4.0"},{name:"qkv_bias",val:" = True"},{name:"hidden_dropout_prob",val:" = 0.0"},{name:"attention_probs_dropout_prob",val:" = 0.0"},{name:"drop_path_rate",val:" = 0.1"},{name:"hidden_act",val:" = 'gelu'"},{name:"use_absolute_embeddings",val:" = False"},{name:"patch_norm",val:" = True"},{name:"initializer_range",val:" = 0.02"},{name:"layer_norm_eps",val:" = 1e-05"},{name:"encoder_stride",val:" = 32"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/swin/configuration_swin.py#L29",parametersDescription:[{anchor:"transformers.SwinConfig.image_size",description:`<strong>image_size</strong> (<code>int</code>, <em>optional</em>, defaults to 224) &#x2014;
...
<span class="hljs-meta">&gt;&gt;&gt; </span>configuration = model.config`}}),we=new at({}),ve=new ze({props:{name:"class transformers.SwinModel",anchor:"transformers.SwinModel",parameters:[{name:"config",val:""},{name:"add_pooling_layer",val:" = True"},{name:"use_mask_token",val:" = False"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/swin/modeling_swin.py#L684",parametersDescription:[{anchor:"transformers.SwinModel.config",description:`<strong>config</strong> (<a href="/docs/transformers/main/en/model_doc/swin#transformers.SwinConfig">SwinConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/main/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),$e=new ze({props:{name:"forward",anchor:"transformers.SwinModel.forward",parameters:[{name:"pixel_values",val:" = None"},{name:"bool_masked_pos",val:" = None"},{name:"head_mask",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/swin/modeling_swin.py#L711",parametersDescription:[{anchor:"transformers.SwinModel.forward.pixel_values",description:`<strong>pixel_values</strong> (<code>torch.FloatTensor</code> of shape <code>(batch_size, num_channels, height, width)</code>) &#x2014;
...
[<span class="hljs-number">1</span>, <span class="hljs-number">49</span>, <span class="hljs-number">768</span>]`}}),Te=new at({}),ke=new ze({props:{name:"class transformers.SwinForMaskedImageModeling",anchor:"transformers.SwinForMaskedImageModeling",parameters:[{name:"config",val:""}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/swin/modeling_swin.py#L778",parametersDescription:[{anchor:"transformers.SwinForMaskedImageModeling.config",description:`<strong>config</strong> (<a href="/docs/transformers/main/en/model_doc/swin#transformers.SwinConfig">SwinConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/main/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),xe=new ze({props:{name:"forward",anchor:"transformers.SwinForMaskedImageModeling.forward",parameters:[{name:"pixel_values",val:" = None"},{name:"bool_masked_pos",val:" = None"},{name:"head_mask",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/swin/modeling_swin.py#L793",parametersDescription:[{anchor:"transformers.SwinForMaskedImageModeling.forward.pixel_values",description:`<strong>pixel_values</strong> (<code>torch.FloatTensor</code> of shape <code>(batch_size, num_channels, height, width)</code>) &#x2014;
Pixel values. Pixel values can be obtained using <a href="/docs/transformers/main/en/model_doc/auto#transformers.AutoFeatureExtractor">AutoFeatureExtractor</a>. See
...
[<span class="hljs-number">1</span>, <span class="hljs-number">3</span>, <span class="hljs-number">224</span>, <span class="hljs-number">224</span>]`}}),je=new at({}),Fe=new ze({props:{name:"class transformers.SwinForImageClassification",anchor:"transformers.SwinForImageClassification",parameters:[{name:"config",val:""}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/swin/modeling_swin.py#L887",parametersDescription:[{anchor:"transformers.SwinForImageClassification.config",description:`<strong>config</strong> (<a href="/docs/transformers/main/en/model_doc/swin#transformers.SwinConfig">SwinConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/main/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),Ae=new ze({props:{name:"forward",anchor:"transformers.SwinForImageClassification.forward",parameters:[{name:"pixel_values",val:" = None"},{name:"head_mask",val:" = None"},{name:"labels",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/swin/modeling_swin.py#L902",parametersDescription:[{anchor:"transformers.SwinForImageClassification.forward.pixel_values",description:`<strong>pixel_values</strong> (<code>torch.FloatTensor</code> of shape <code>(batch_size, num_channels, height, width)</code>) &#x2014;
Pixel values. Pixel values can be obtained using <a href="/docs/transformers/main/en/model_doc/auto#transformers.AutoFeatureExtractor">AutoFeatureExtractor</a>. See
...
tabby, tabby cat`}}),{c(){p=n("meta"),T=c(),f=n("h1"),_=n("a"),k=n("span"),w(u.$$.fragment),g=c(),M=n("span"),to=r("Swin Transformer"),xt=c(),L=n("h2"),J=n("a"),st=n("span"),w(de.$$.fragment),oo=c(),rt=n("span"),no=r("Overview"),Et=c(),D=n("p"),ao=r("The Swin Transformer was proposed in "),ce=n("a"),so=r("Swin Transformer: Hierarchical Vision Transformer using Shifted Windows"),ro=n("br"),io=r(`
...
The hierarchical design and the shifted window approach also prove beneficial for all-MLP architectures.`),Ct=c(),Le=n("p"),ho=r("Tips:"),It=c(),De=n("ul"),he=n("li"),mo=r("One can use the "),We=n("a"),po=r("AutoFeatureExtractor"),fo=r(" API to prepare images for the model."),At=c(),Q=n("img"),Pt=c(),X=n("small"),uo=r("Swin Transformer architecture. Taken from the "),He=n("a"),go=r("original paper"),_o=r("."),qt=c(),P=n("p"),wo=r("This model was contributed by "),me=n("a"),vo=r("novice03"),bo=r(". The original code can be found "),pe=n("a"),So=r("here"),$o=r("."),zt=c(),W=n("h2"),ee=n("a"),lt=n("span"),w(fe.$$.fragment),yo=c(),dt=n("span"),To=r("SwinConfig"),Nt=c(),F=n("div"),w(ue.$$.fragment),ko=c(),H=n("p"),Mo=r("This is the configuration class to store the configuration of a "),Be=n("a"),xo=r("SwinModel"),Eo=r(`. It is used to instantiate a Swin
...
(53.5 mIoU on ADE20K val). Its performance surpasses the previous state-of-the-art by a large margin of +2.7 box AP and
+2.6 mask AP on COCO, and +3.2 mIoU on ADE20K, demonstrating the potential of Transformer-based models as vision backbones.
The hierarchical design and the shifted window approach also prove beneficial for all-MLP architectures.`),Rn.forEach(o),Zn.forEach(o),Ct=h(t),Le=a(t,"P",{});var Gn=s(Le);ho=i(Gn,"Tips:"),Gn.forEach(o),It=h(t),De=a(t,"UL",{});var Jn=s(De);he=a(Jn,"LI",{});var Kt=s(he);mo=i(Kt,"One can use the "),We=a(Kt,"A",{href:!0});var Qn=s(We);po=i(Qn,"AutoFeatureExtractor"),Qn.forEach(o),fo=i(Kt," API to prepare images for the model."),Kt.forEach(o),Jn.forEach(o),At=h(t),Q=a(t,"IMG",{src:!0,alt:!0,width:!0}),Pt=h(t),X=a(t,"SMALL",{});var Yt=s(X);uo=i(Yt,"Swin Transformer architecture. Taken from the "),He=a(Yt,"A",{href:!0});var Xn=s(He);go=i(Xn,"original paper"),Xn.forEach(o),_o=i(Yt,"."),Yt.forEach(o),qt=h(t),P=a(t,"P",{});var Re=s(P);wo=i(Re,"This model was contributed by "),me=a(Re,"A",{href:!0,rel:!0});var ea=s(me);vo=i(ea,"novice03"),ea.forEach(o),bo=i(Re,". The original code can be found "),pe=a(Re,"A",{href:!0,rel:!0});var ta=s(pe);So=i(ta,"here"),ta.forEach(o),$o=i(Re,"."),Re.forEach(o),zt=h(t),W=a(t,"H2",{class:!0});var Zt=s(W);ee=a(Zt,"A",{id:!0,class:!0,href:!0});var oa=s(ee);lt=a(oa,"SPAN",{});var na=s(lt);v(fe.$$.fragment,na),na.forEach(o),oa.forEach(o),yo=h(Zt),dt=a(Zt,"SPAN",{});var aa=s(dt);To=i(aa,"SwinConfig"),aa.forEach(o),Zt.forEach(o),Nt=h(t),F=a(t,"DIV",{class:!0});var ie=s(F);v(ue.$$.fragment,ie),ko=h(ie),H=a(ie,"P",{});var Ge=s(H);Mo=i(Ge,"This is the configuration class to store the configuration of a "),Be=a(Ge,"A",{href:!0});var sa=s(Be);xo=i(sa,"SwinModel"),sa.forEach(o),Eo=i(Ge,`. It is used to instantiate a Swin
model according to the specified arguments, defining the model architecture. Instantiating a configuration with the
defaults will yield a similar configuration to that of the Swin
`),ge=a(Ge,"A",{href:!0,rel:!0});var ra=s(ge);jo=i(ra,"microsoft/swin-tiny-patch4-window7-224"),ra.forEach(o),Fo=i(Ge,`
architecture.`),Ge.forEach(o),Co=h(ie),B=a(ie,"P",{});var Je=s(B);Io=i(Je,"Configuration objects inherit from "),Ue=a(Je,"A",{href:!0});var ia=s(Ue);Ao=i(ia,"PretrainedConfig"),ia.forEach(o),Po=i(Je,` and can be used to control the model outputs. Read the
