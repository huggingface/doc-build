...
the latter silently ignores them.`)},l(T){h=s(T,"P",{});var M=d(h);C=t(M,"Although the recipe for forward pass needs to be defined within this function, one should call the "),g=s(M,"CODE",{});var L=d(g);D=t(L,"Module"),L.forEach(o),F=t(M,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),M.forEach(o)},m(T,M){u(T,h,M),e(h,C),e(h,g),e(g,D),e(h,F)},d(T){T&&o(h)}}}function Ps(Je){let h,C,g,D,F,T,M,L,Mn,on,$,Dn,Ye,$n,jn,wo,qn,Pn,Ze,zn,Fn,Ke,Cn,An,nn,N,Ln,Eo,Nn,In,he,Wn,Vn,tn,I,On,Qe,Bn,Rn,Xe,Un,Hn,an,H,te,ko,me,Gn,So,Jn,rn,x,fe,Yn,ae,eo,Zn,Kn,oo,Qn,Xn,et,G,ot,no,nt,tt,to,at,rt,st,To,dt,ct,ue,it,re,ge,lt,_e,pt,ao,ht,mt,ft,se,ve,ut,J,gt,xo,_t,vt,Mo,bt,yt,sn,Y,de,Do,be,wt,$o,Et,dn,m,ye,kt,Z,St,jo,Tt,xt,qo,Mt,Dt,$t,we,jt,Ee,qt,Pt,zt,ke,Ft,Se,Ct,At,Lt,Po,Nt,It,Te,Wt,ro,Vt,Ot,Bt,xe,Rt,Me,Ut,Ht,Gt,W,so,Jt,Yt,zo,Zt,Kt,Fo,Qt,Xt,ea,j,De,oa,K,na,co,ta,aa,Co,ra,sa,da,ce,ca,Ao,ia,la,$e,pa,q,je,ha,Lo,ma,fa,Q,ua,No,ga,_a,Io,va,ba,ya,Wo,wa,Ea,qe,cn,X,ie,Vo,Pe,ka,Oo,Sa,ln,f,ze,Ta,ee,xa,Bo,Ma,Da,Ro,$a,ja,qa,Fe,Pa,Ce,za,Fa,Ca,Ae,Aa,Le,La,Na,Ia,Uo,Wa,Va,Ne,Oa,io,Ba,Ra,Ua,Ie,Ha,We,Ga,Ja,Ya,V,lo,Za,Ka,Ho,Qa,Xa,Go,er,or,nr,P,Ve,tr,oe,ar,po,rr,sr,Jo,dr,cr,ir,le,lr,Yo,pr,hr,Oe,mr,A,Be,fr,Zo,ur,gr,Ko,_r,vr,Re,pn;return T=new xn({}),me=new xn({}),fe=new ne({props:{name:"class transformers.SpeechEncoderDecoderConfig",anchor:"transformers.SpeechEncoderDecoderConfig",parameters:[{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/speech_encoder_decoder/configuration_speech_encoder_decoder.py#L27",parametersDescription:[{anchor:"transformers.SpeechEncoderDecoderConfig.kwargs",description:`<strong>kwargs</strong> (<em>optional</em>) &#x2014;
...
with any pretrained speech autoencoding model as the encoder (`),wo=r("em"),qn=n("e.g."),Pn=i(),Ze=r("a"),zn=n("Wav2Vec2"),Fn=n(", "),Ke=r("a"),Cn=n("Hubert"),An=n(") and any pretrained autoregressive model as the decoder."),nn=i(),N=r("p"),Ln=n(`The effectiveness of initializing speech-sequence-to-text-sequence models with pretrained checkpoints for speech
recognition and speech translation has `),Eo=r("em"),Nn=n("e.g."),In=n(" been shown in "),he=r("a"),Wn=n(`Large-Scale Self- and Semi-Supervised Learning for Speech
...
`),Xe=r("a"),Un=n("Speech2Text2"),Hn=n("."),an=i(),H=r("h2"),te=r("a"),ko=r("span"),b(me.$$.fragment),Gn=i(),So=r("span"),Jn=n("SpeechEncoderDecoderConfig"),rn=i(),x=r("div"),b(fe.$$.fragment),Yn=i(),ae=r("p"),eo=r("a"),Zn=n("SpeechEncoderDecoderConfig"),Kn=n(` is the configuration class to store the configuration of a
...
documentation from `),to=r("a"),at=n("PretrainedConfig"),rt=n(" for more information."),st=i(),To=r("p"),dt=n("Examples:"),ct=i(),b(ue.$$.fragment),it=i(),re=r("div"),b(ge.$$.fragment),lt=i(),_e=r("p"),pt=n("Instantiate a "),ao=r("a"),ht=n("SpeechEncoderDecoderConfig"),mt=n(` (or a derived class) from a pre-trained encoder model
configuration and decoder model configuration.`),ft=i(),se=r("div"),b(ve.$$.fragment),ut=i(),J=r("p"),gt=n("Serializes this instance to a Python dictionary. Override the default "),xo=r("em"),_t=n("to_dict()"),vt=n(" from "),Mo=r("em"),bt=n("PretrainedConfig"),yt=n("."),sn=i(),Y=r("h2"),de=r("a"),Do=r("span"),b(be.$$.fragment),wt=i(),$o=r("span"),Et=n("SpeechEncoderDecoderModel"),dn=i(),m=r("div"),b(ye.$$.fragment),kt=i(),Z=r("p"),St=n(`This class can be used to initialize a speech-sequence-to-text-sequence model with any pretrained speech
autoencoding model as the encoder and any pretrained text autoregressive model as the decoder. The encoder is
loaded via `),jo=r("code"),Tt=n("from_pretrained()"),xt=n(`function and the decoder is loaded via
`),qo=r("code"),Mt=n("from_pretrained()"),Dt=n(`function. Cross-attention layers are automatically added to the decoder
...
models (see the examples for more information).`),It=i(),Te=r("p"),Wt=n("This model inherits from "),ro=r("a"),Vt=n("PreTrainedModel"),Ot=n(`. Check the superclass documentation for the generic methods the
...
:meth`),Fo=r("em"),Qt=n("~transformers.AutoModelForCausalLM.from_pretrained"),Xt=n(" class method for the decoder."),ea=i(),j=r("div"),b(De.$$.fragment),oa=i(),K=r("p"),na=n("The "),co=r("a"),ta=n("SpeechEncoderDecoderModel"),aa=n(" forward method, overrides the "),Co=r("code"),ra=n("__call__"),sa=n(" special method."),da=i(),b(ce.$$.fragment),ca=i(),Ao=r("p"),ia=n("Examples:"),la=i(),b($e.$$.fragment),pa=i(),q=r("div"),b(je.$$.fragment),ha=i(),Lo=r("p"),ma=n(`Instantiate an encoder and a decoder from one or two base classes of the library from pretrained model
...
the model, you need to first set it back in training mode with `),Io=r("code"),va=n("model.train()"),ba=n("."),ya=i(),Wo=r("p"),wa=n("Example:"),Ea=i(),b(qe.$$.fragment),cn=i(),X=r("h2"),ie=r("a"),Vo=r("span"),b(Pe.$$.fragment),ka=i(),Oo=r("span"),Sa=n("FlaxSpeechEncoderDecoderModel"),ln=i(),f=r("div"),b(ze.$$.fragment),Ta=i(),ee=r("p"),xa=n(`This class can be used to initialize a speech-sequence-to-text-sequence model with any pretrained speech
autoencoding model as the encoder and any pretrained text autoregressive model as the decoder. The encoder is
loaded via `),Bo=r("code"),Ma=n("from_pretrained()"),Da=n(`function and the decoder is loaded via
...
models (see the examples for more information).`),Va=i(),Ne=r("p"),Oa=n("This model inherits from "),io=r("a"),Ba=n("FlaxPreTrainedModel"),Ra=n(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Ua=i(),Ie=r("p"),Ha=n(`This model is also a Flax Linen
`),We=r("a"),Ga=n("flax.nn.Module"),Ja=n(` subclass. Use it as a
...
encoder and :meth`),Go=r("em"),er=n("~transformers.FlaxAutoModelForCausalLM.from_pretrained"),or=n(" class method for the decoder."),nr=i(),P=r("div"),b(Ve.$$.fragment),tr=i(),oe=r("p"),ar=n("The "),po=r("a"),rr=n("FlaxSpeechEncoderDecoderModel"),sr=n(" forward method, overrides the "),Jo=r("code"),dr=n("__call__"),cr=n(" special method."),ir=i(),b(le.$$.fragment),lr=i(),Yo=r("p"),pr=n("Examples:"),hr=i(),b(Oe.$$.fragment),mr=i(),A=r("div"),b(Be.$$.fragment),fr=i(),Zo=r("p"),ur=n(`Instantiate an encoder and a decoder from one or two base classes of the library from pretrained model
...
with any pretrained speech autoencoding model as the encoder (`),wo=s(O,"EM",{});var Er=d(wo);qn=t(Er,"e.g."),Er.forEach(o),Pn=l(O),Ze=s(O,"A",{href:!0});var kr=d(Ze);zn=t(kr,"Wav2Vec2"),kr.forEach(o),Fn=t(O,", "),Ke=s(O,"A",{href:!0});var Sr=d(Ke);Cn=t(Sr,"Hubert"),Sr.forEach(o),An=t(O,") and any pretrained autoregressive model as the decoder."),O.forEach(o),nn=l(a),N=s(a,"P",{});var ho=d(N);Ln=t(ho,`The effectiveness of initializing speech-sequence-to-text-sequence models with pretrained checkpoints for speech
recognition and speech translation has `),Eo=s(ho,"EM",{});var Tr=d(Eo);Nn=t(Tr,"e.g."),Tr.forEach(o),In=t(ho," been shown in "),he=s(ho,"A",{href:!0,rel:!0});var xr=d(he);Wn=t(xr,`Large-Scale Self- and Semi-Supervised Learning for Speech
Translation`),xr.forEach(o),Vn=t(ho,` by Changhan Wang, Anne Wu, Juan Pino, Alexei Baevski, Michael Auli,
Alexis Conneau.`),ho.forEach(o),tn=l(a),I=s(a,"P",{});var mo=d(I);On=t(mo,"An example of how to use a "),Qe=s(mo,"A",{href:!0});var Mr=d(Qe);Bn=t(Mr,"SpeechEncoderDecoderModel"),Mr.forEach(o),Rn=t(mo,` for inference can be seen in
`),Xe=s(mo,"A",{href:!0});var Dr=d(Xe);Un=t(Dr,"Speech2Text2"),Dr.forEach(o),Hn=t(mo,"."),mo.forEach(o),an=l(a),H=s(a,"H2",{class:!0});var hn=d(H);te=s(hn,"A",{id:!0,class:!0,href:!0});var $r=d(te);ko=s($r,"SPAN",{});var jr=d(ko);y(me.$$.fragment,jr),jr.forEach(o),$r.forEach(o),Gn=l(hn),So=s(hn,"SPAN",{});var qr=d(So);Jn=t(qr,"SpeechEncoderDecoderConfig"),qr.forEach(o),hn.forEach(o),rn=l(a),x=s(a,"DIV",{class:!0});var z=d(x);y(fe.$$.fragment,z),Yn=l(z),ae=s(z,"P",{});var Xo=d(ae);eo=s(Xo,"A",{href:!0});var Pr=d(eo);Zn=t(Pr,"SpeechEncoderDecoderConfig"),Pr.forEach(o),Kn=t(Xo,` is the configuration class to store the configuration of a
...
arguments, defining the encoder and decoder configs.`),Xo.forEach(o),et=l(z),G=s(z,"P",{});var fo=d(G);ot=t(fo,"Configuration objects inherit from "),no=s(fo,"A",{href:!0});var Fr=d(no);nt=t(Fr,"PretrainedConfig"),Fr.forEach(o),tt=t(fo,` and can be used to control the model outputs. Read the
documentation from `),to=s(fo,"A",{href:!0});var Cr=d(to);at=t(Cr,"PretrainedConfig"),Cr.forEach(o),rt=t(fo," for more information."),fo.forEach(o),st=l(z),To=s(z,"P",{});var Ar=d(To);dt=t(Ar,"Examples:"),Ar.forEach(o),ct=l(z),y(ue.$$.fragment,z),it=l(z),re=s(z,"DIV",{class:!0});var mn=d(re);y(ge.$$.fragment,mn),lt=l(mn),_e=s(mn,"P",{});var fn=d(_e);pt=t(fn,"Instantiate a "),ao=s(fn,"A",{href:!0});var Lr=d(ao);ht=t(Lr,"SpeechEncoderDecoderConfig"),Lr.forEach(o),mt=t(fn,` (or a derived class) from a pre-trained encoder model
configuration and decoder model configuration.`),fn.forEach(o),mn.forEach(o),ft=l(z),se=s(z,"DIV",{class:!0});var un=d(se);y(ve.$$.fragment,un),ut=l(un),J=s(un,"P",{});var uo=d(J);gt=t(uo,"Serializes this instance to a Python dictionary. Override the default "),xo=s(uo,"EM",{});var Nr=d(xo);_t=t(Nr,"to_dict()"),Nr.forEach(o),vt=t(uo," from "),Mo=s(uo,"EM",{});var Ir=d(Mo);bt=t(Ir,"PretrainedConfig"),Ir.forEach(o),yt=t(uo,"."),uo.forEach(o),un.forEach(o),z.forEach(o),sn=l(a),Y=s(a,"H2",{class:!0});var gn=d(Y);de=s(gn,"A",{id:!0,class:!0,href:!0});var Wr=d(de);Do=s(Wr,"SPAN",{});var Vr=d(Do);y(be.$$.fragment,Vr),Vr.forEach(o),Wr.forEach(o),wt=l(gn),$o=s(gn,"SPAN",{});var Or=d($o);Et=t(Or,"SpeechEncoderDecoderModel"),Or.forEach(o),gn.forEach(o),dn=l(a),m=s(a,"DIV",{class:!0});var _=d(m);y(ye.$$.fragment,_),kt=l(_),Z=s(_,"P",{});var go=d(Z);St=t(go,`This class can be used to initialize a speech-sequence-to-text-sequence model with any pretrained speech
autoencoding model as the encoder and any pretrained text autoregressive model as the decoder. The encoder is
loaded via `),jo=s(go,"CODE",{});var Br=d(jo);Tt=t(Br,"from_pretrained()"),Br.forEach(o),xt=t(go,`function and the decoder is loaded via
`),qo=s(go,"CODE",{});var Rr=d(qo);Mt=t(Rr,"from_pretrained()"),Rr.forEach(o),Dt=t(go,`function. Cross-attention layers are automatically added to the decoder
...
models (see the examples for more information).`),Gr.forEach(o),It=l(_),Te=s(_,"P",{});var bn=d(Te);Wt=t(bn,"This model inherits from "),ro=s(bn,"A",{href:!0});var Jr=d(ro);Vt=t(Jr,"PreTrainedModel"),Jr.forEach(o),Ot=t(bn,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),yn.forEach(o),Gt=l(_),W=s(_,"P",{});var He=d(W);so=s(He,"A",{href:!0});var Zr=d(so);Jt=t(Zr,"SpeechEncoderDecoderModel"),Zr.forEach(o),Yt=t(He,` is a generic model class that will be instantiated as a transformer architecture with
one of the base model classes of the library as encoder and another one as decoder when created with the
:meth`),zo=s(He,"EM",{});var Kr=d(zo);Zt=t(Kr,"~transformers.AutoModel.from_pretrained"),Kr.forEach(o),Kt=t(He,` class method for the encoder and
:meth`),Fo=s(He,"EM",{});var Qr=d(Fo);Qt=t(Qr,"~transformers.AutoModelForCausalLM.from_pretrained"),Qr.forEach(o),Xt=t(He," class method for the decoder."),He.forEach(o),ea=l(_),j=s(_,"DIV",{class:!0});var B=d(j);y(De.$$.fragment,B),oa=l(B),K=s(B,"P",{});var _o=d(K);na=t(_o,"The "),co=s(_o,"A",{href:!0});var Xr=d(co);ta=t(Xr,"SpeechEncoderDecoderModel"),Xr.forEach(o),aa=t(_o," forward method, overrides the "),Co=s(_o,"CODE",{});var es=d(Co);ra=t(es,"__call__"),es.forEach(o),sa=t(_o," special method."),_o.forEach(o),da=l(B),y(ce.$$.fragment,B),ca=l(B),Ao=s(B,"P",{});var os=d(Ao);ia=t(os,"Examples:"),os.forEach(o),la=l(B),y($e.$$.fragment,B),B.forEach(o),pa=l(_),q=s(_,"DIV",{class:!0});var R=d(q);y(je.$$.fragment,R),ha=l(R),Lo=s(R,"P",{});var ns=d(Lo);ma=t(ns,`Instantiate an encoder and a decoder from one or two base classes of the library from pretrained model
...
the model, you need to first set it back in training mode with `),Io=s(vo,"CODE",{});var as=d(Io);va=t(as,"model.train()"),as.forEach(o),ba=t(vo,"."),vo.forEach(o),ya=l(R),Wo=s(R,"P",{});var rs=d(Wo);wa=t(rs,"Example:"),rs.forEach(o),Ea=l(R),y(qe.$$.fragment,R),R.forEach(o),_.forEach(o),cn=l(a),X=s(a,"H2",{class:!0});var wn=d(X);ie=s(wn,"A",{id:!0,class:!0,href:!0});var ss=d(ie);Vo=s(ss,"SPAN",{});var ds=d(Vo);y(Pe.$$.fragment,ds),ds.forEach(o),ss.forEach(o),ka=l(wn),Oo=s(wn,"SPAN",{});var cs=d(Oo);Sa=t(cs,"FlaxSpeechEncoderDecoderModel"),cs.forEach(o),wn.forEach(o),ln=l(a),f=s(a,"DIV",{class:!0});var v=d(f);y(ze.$$.fragment,v),Ta=l(v),ee=s(v,"P",{});var bo=d(ee);xa=t(bo,`This class can be used to initialize a speech-sequence-to-text-sequence model with any pretrained speech
autoencoding model as the encoder and any pretrained text autoregressive model as the decoder. The encoder is
loaded via `),Bo=s(bo,"CODE",{});var is=d(Bo);Ma=t(is,"from_pretrained()"),is.forEach(o),Da=t(bo,`function and the decoder is loaded via
...
models (see the examples for more information).`),ms.forEach(o),Va=l(v),Ne=s(v,"P",{});var Sn=d(Ne);Oa=t(Sn,"This model inherits from "),io=s(Sn,"A",{href:!0});var fs=d(io);Ba=t(fs,"FlaxPreTrainedModel"),fs.forEach(o),Ra=t(Sn,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Sn.forEach(o),Ua=l(v),Ie=s(v,"P",{});var Tn=d(Ie);Ha=t(Tn,`This model is also a Flax Linen
`),We=s(Tn,"A",{href:!0,rel:!0});var us=d(We);Ga=t(us,"flax.nn.Module"),us.forEach(o),Ja=t(Tn,` subclass. Use it as a
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),Tn.forEach(o),Ya=l(v),V=s(v,"P",{});var Ge=d(V);lo=s(Ge,"A",{href:!0});var gs=d(lo);Za=t(gs,"FlaxSpeechEncoderDecoderModel"),gs.forEach(o),Ka=t(Ge,` is a generic model class that will be instantiated as a transformer architecture
with the module (flax.nn.Module) of one of the base model classes of the library as encoder module and another one
