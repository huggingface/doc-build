import{S as py,i as my,s as hy,e as r,k as m,w as v,t as n,M as uy,c as a,d as t,m as h,a as i,x as y,h as s,b,G as e,g,y as w,q as M,o as $,B as F,v as fy,L as xe}from"../../chunks/vendor-hf-doc-builder.js";import{T as qe}from"../../chunks/Tip-hf-doc-builder.js";import{D as ie}from"../../chunks/Docstring-hf-doc-builder.js";import{C as ze}from"../../chunks/CodeBlock-hf-doc-builder.js";import{I as Pe}from"../../chunks/IconCopyLink-hf-doc-builder.js";import{E as Ee}from"../../chunks/ExampleCodeBlock-hf-doc-builder.js";function gy(E){let d,_,c,p,T;return p=new ze({props:{code:`from transformers import MobileBertModel, MobileBertConfig
...
<span class="hljs-meta">&gt;&gt;&gt; </span>configuration = model.config`}}),{c(){d=r("p"),_=n("Examples:"),c=m(),v(p.$$.fragment)},l(l){d=a(l,"P",{});var u=i(d);_=s(u,"Examples:"),u.forEach(t),c=h(l),y(p.$$.fragment,l)},m(l,u){g(l,d,u),e(d,_),g(l,c,u),w(p,l,u),T=!0},p:xe,i(l){T||(M(p.$$.fragment,l),T=!0)},o(l){$(p.$$.fragment,l),T=!1},d(l){l&&t(d),l&&t(c),F(p,l)}}}function _y(E){let d,_,c,p,T;return{c(){d=r("p"),_=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),c=r("code"),p=n("Module"),T=n(`
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),{c(){d=r("p"),_=n("Example:"),c=m(),v(p.$$.fragment)},l(l){d=a(l,"P",{});var u=i(d);_=s(u,"Example:"),u.forEach(t),c=h(l),y(p.$$.fragment,l)},m(l,u){g(l,d,u),e(d,_),g(l,c,u),w(p,l,u),T=!0},p:xe,i(l){T||(M(p.$$.fragment,l),T=!0)},o(l){$(p.$$.fragment,l),T=!1},d(l){l&&t(d),l&&t(c),F(p,l)}}}function Ty(E){let d,_,c,p,T;return{c(){d=r("p"),_=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),c=r("code"),p=n("Module"),T=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(l){d=a(l,"P",{});var u=i(d);_=s(u,"Although the recipe for forward pass needs to be defined within this function, one should call the "),c=a(u,"CODE",{});var x=i(c);p=s(x,"Module"),x.forEach(t),T=s(u,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
<span class="hljs-meta">&gt;&gt;&gt; </span>predicted_class_id = logits.argmax().item()
<span class="hljs-meta">&gt;&gt;&gt; </span>model.config.id2label[predicted_class_id]
<span class="hljs-string">&#x27;others&#x27;</span>`}}),{c(){d=r("p"),_=n("Example of multi-label classification:"),c=m(),v(p.$$.fragment)},l(l){d=a(l,"P",{});var u=i(d);_=s(u,"Example of multi-label classification:"),u.forEach(t),c=h(l),y(p.$$.fragment,l)},m(l,u){g(l,d,u),e(d,_),g(l,c,u),w(p,l,u),T=!0},p:xe,i(l){T||(M(p.$$.fragment,l),T=!0)},o(l){$(p.$$.fragment,l),T=!1},d(l){l&&t(d),l&&t(c),F(p,l)}}}function zy(E){let d,_;return d=new ze({props:{code:`# To train a model on \`num_labels\` classes, you can pass \`num_labels=num_labels\` to \`.from_pretrained(...)\`
num_labels = len(model.config.id2label)
...
<span class="hljs-meta">&gt;&gt;&gt; </span>loss = outputs.loss
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-built_in">round</span>(loss.item(), <span class="hljs-number">2</span>)
<span class="hljs-number">3.98</span>`}}),{c(){v(d.$$.fragment)},l(c){y(d.$$.fragment,c)},m(c,p){w(d,c,p),_=!0},p:xe,i(c){_||(M(d.$$.fragment,c),_=!0)},o(c){$(d.$$.fragment,c),_=!1},d(c){F(d,c)}}}function Iy(E){let d,_,c,p,T,l,u,x,me,V,z,J,L,X,he,D,ue,le,K,N,ee,G,q,C,ne,U,de,se,W,fe,ce,P,ge,R,Z,re,H,_e,ae,O,pe,A,be;return{c(){d=r("p"),_=n("TF 2.0 models accepts two formats as inputs:"),c=m(),p=r("ul"),T=r("li"),l=n("having all inputs as keyword arguments (like PyTorch models), or"),u=m(),x=r("li"),me=n("having all inputs as a list, tuple or dict in the first positional arguments."),V=m(),z=r("p"),J=n("This second option is useful when using "),L=r("code"),X=n("tf.keras.Model.fit"),he=n(` method which currently requires having all the
tensors in the first argument of the model call function: `),D=r("code"),ue=n("model(inputs)"),le=n("."),K=m(),N=r("p"),ee=n(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),G=m(),q=r("ul"),C=r("li"),ne=n("a single Tensor with "),U=r("code"),de=n("input_ids"),se=n(" only and nothing else: "),W=r("code"),fe=n("model(inputs_ids)"),ce=m(),P=r("li"),ge=n(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
...
`),A=r("code"),be=n('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(f){d=a(f,"P",{});var B=i(d);_=s(B,"TF 2.0 models accepts two formats as inputs:"),B.forEach(t),c=h(f),p=a(f,"UL",{});var Y=i(p);T=a(Y,"LI",{});var ve=i(T);l=s(ve,"having all inputs as keyword arguments (like PyTorch models), or"),ve.forEach(t),u=h(Y),x=a(Y,"LI",{});var $e=i(x);me=s($e,"having all inputs as a list, tuple or dict in the first positional arguments."),$e.forEach(t),Y.forEach(t),V=h(f),z=a(f,"P",{});var S=i(z);J=s(S,"This second option is useful when using "),L=a(S,"CODE",{});var we=i(L);X=s(we,"tf.keras.Model.fit"),we.forEach(t),he=s(S,` method which currently requires having all the
tensors in the first argument of the model call function: `),D=a(S,"CODE",{});var Te=i(D);ue=s(Te,"model(inputs)"),Te.forEach(t),le=s(S,"."),S.forEach(t),K=h(f),N=a(f,"P",{});var ke=i(N);ee=s(ke,`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),ke.forEach(t),G=h(f),q=a(f,"UL",{});var j=i(q);C=a(j,"LI",{});var I=i(C);ne=s(I,"a single Tensor with "),U=a(I,"CODE",{});var Fe=i(U);de=s(Fe,"input_ids"),Fe.forEach(t),se=s(I," only and nothing else: "),W=a(I,"CODE",{});var ye=i(W);fe=s(ye,"model(inputs_ids)"),ye.forEach(t),I.forEach(t),ce=h(j),P=a(j,"LI",{});var Q=i(P);ge=s(Q,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),{c(){d=r("p"),_=n("Example:"),c=m(),v(p.$$.fragment)},l(l){d=a(l,"P",{});var u=i(d);_=s(u,"Example:"),u.forEach(t),c=h(l),y(p.$$.fragment,l)},m(l,u){g(l,d,u),e(d,_),g(l,c,u),w(p,l,u),T=!0},p:xe,i(l){T||(M(p.$$.fragment,l),T=!0)},o(l){$(p.$$.fragment,l),T=!1},d(l){l&&t(d),l&&t(c),F(p,l)}}}function Wy(E){let d,_,c,p,T,l,u,x,me,V,z,J,L,X,he,D,ue,le,K,N,ee,G,q,C,ne,U,de,se,W,fe,ce,P,ge,R,Z,re,H,_e,ae,O,pe,A,be;return{c(){d=r("p"),_=n("TF 2.0 models accepts two formats as inputs:"),c=m(),p=r("ul"),T=r("li"),l=n("having all inputs as keyword arguments (like PyTorch models), or"),u=m(),x=r("li"),me=n("having all inputs as a list, tuple or dict in the first positional arguments."),V=m(),z=r("p"),J=n("This second option is useful when using "),L=r("code"),X=n("tf.keras.Model.fit"),he=n(` method which currently requires having all the
tensors in the first argument of the model call function: `),D=r("code"),ue=n("model(inputs)"),le=n("."),K=m(),N=r("p"),ee=n(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),G=m(),q=r("ul"),C=r("li"),ne=n("a single Tensor with "),U=r("code"),de=n("input_ids"),se=n(" only and nothing else: "),W=r("code"),fe=n("model(inputs_ids)"),ce=m(),P=r("li"),ge=n(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),R=r("code"),Z=n("model([input_ids, attention_mask])"),re=n(" or "),H=r("code"),_e=n("model([input_ids, attention_mask, token_type_ids])"),ae=m(),O=r("li"),pe=n(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),A=r("code"),be=n('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(f){d=a(f,"P",{});var B=i(d);_=s(B,"TF 2.0 models accepts two formats as inputs:"),B.forEach(t),c=h(f),p=a(f,"UL",{});var Y=i(p);T=a(Y,"LI",{});var ve=i(T);l=s(ve,"having all inputs as keyword arguments (like PyTorch models), or"),ve.forEach(t),u=h(Y),x=a(Y,"LI",{});var $e=i(x);me=s($e,"having all inputs as a list, tuple or dict in the first positional arguments."),$e.forEach(t),Y.forEach(t),V=h(f),z=a(f,"P",{});var S=i(z);J=s(S,"This second option is useful when using "),L=a(S,"CODE",{});var we=i(L);X=s(we,"tf.keras.Model.fit"),we.forEach(t),he=s(S,` method which currently requires having all the
...
<span class="hljs-number">0.57</span>`}}),{c(){v(d.$$.fragment)},l(c){y(d.$$.fragment,c)},m(c,p){w(d,c,p),_=!0},p:xe,i(c){_||(M(d.$$.fragment,c),_=!0)},o(c){$(d.$$.fragment,c),_=!1},d(c){F(d,c)}}}function Gy(E){let d,_,c,p,T,l,u,x,me,V,z,J,L,X,he,D,ue,le,K,N,ee,G,q,C,ne,U,de,se,W,fe,ce,P,ge,R,Z,re,H,_e,ae,O,pe,A,be;return{c(){d=r("p"),_=n("TF 2.0 models accepts two formats as inputs:"),c=m(),p=r("ul"),T=r("li"),l=n("having all inputs as keyword arguments (like PyTorch models), or"),u=m(),x=r("li"),me=n("having all inputs as a list, tuple or dict in the first positional arguments."),V=m(),z=r("p"),J=n("This second option is useful when using "),L=r("code"),X=n("tf.keras.Model.fit"),he=n(` method which currently requires having all the
tensors in the first argument of the model call function: `),D=r("code"),ue=n("model(inputs)"),le=n("."),K=m(),N=r("p"),ee=n(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),G=m(),q=r("ul"),C=r("li"),ne=n("a single Tensor with "),U=r("code"),de=n("input_ids"),se=n(" only and nothing else: "),W=r("code"),fe=n("model(inputs_ids)"),ce=m(),P=r("li"),ge=n(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),R=r("code"),Z=n("model([input_ids, attention_mask])"),re=n(" or "),H=r("code"),_e=n("model([input_ids, attention_mask, token_type_ids])"),ae=m(),O=r("li"),pe=n(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),A=r("code"),be=n('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(f){d=a(f,"P",{});var B=i(d);_=s(B,"TF 2.0 models accepts two formats as inputs:"),B.forEach(t),c=h(f),p=a(f,"UL",{});var Y=i(p);T=a(Y,"LI",{});var ve=i(T);l=s(ve,"having all inputs as keyword arguments (like PyTorch models), or"),ve.forEach(t),u=h(Y),x=a(Y,"LI",{});var $e=i(x);me=s($e,"having all inputs as a list, tuple or dict in the first positional arguments."),$e.forEach(t),Y.forEach(t),V=h(f),z=a(f,"P",{});var S=i(z);J=s(S,"This second option is useful when using "),L=a(S,"CODE",{});var we=i(L);X=s(we,"tf.keras.Model.fit"),we.forEach(t),he=s(S,` method which currently requires having all the
...
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-comment"># the linear classifier still needs to be trained</span>
<span class="hljs-meta">&gt;&gt;&gt; </span>logits = outputs.logits`}}),{c(){d=r("p"),_=n("Example:"),c=m(),v(p.$$.fragment)},l(l){d=a(l,"P",{});var u=i(d);_=s(u,"Example:"),u.forEach(t),c=h(l),y(p.$$.fragment,l)},m(l,u){g(l,d,u),e(d,_),g(l,c,u),w(p,l,u),T=!0},p:xe,i(l){T||(M(p.$$.fragment,l),T=!0)},o(l){$(p.$$.fragment,l),T=!1},d(l){l&&t(d),l&&t(c),F(p,l)}}}function rw(E){let d,_,c,p,T,l,u,x,me,V,z,J,L,X,he,D,ue,le,K,N,ee,G,q,C,ne,U,de,se,W,fe,ce,P,ge,R,Z,re,H,_e,ae,O,pe,A,be;return{c(){d=r("p"),_=n("TF 2.0 models accepts two formats as inputs:"),c=m(),p=r("ul"),T=r("li"),l=n("having all inputs as keyword arguments (like PyTorch models), or"),u=m(),x=r("li"),me=n("having all inputs as a list, tuple or dict in the first positional arguments."),V=m(),z=r("p"),J=n("This second option is useful when using "),L=r("code"),X=n("tf.keras.Model.fit"),he=n(` method which currently requires having all the
tensors in the first argument of the model call function: `),D=r("code"),ue=n("model(inputs)"),le=n("."),K=m(),N=r("p"),ee=n(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),G=m(),q=r("ul"),C=r("li"),ne=n("a single Tensor with "),U=r("code"),de=n("input_ids"),se=n(" only and nothing else: "),W=r("code"),fe=n("model(inputs_ids)"),ce=m(),P=r("li"),ge=n(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),R=r("code"),Z=n("model([input_ids, attention_mask])"),re=n(" or "),H=r("code"),_e=n("model([input_ids, attention_mask, token_type_ids])"),ae=m(),O=r("li"),pe=n(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),A=r("code"),be=n('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(f){d=a(f,"P",{});var B=i(d);_=s(B,"TF 2.0 models accepts two formats as inputs:"),B.forEach(t),c=h(f),p=a(f,"UL",{});var Y=i(p);T=a(Y,"LI",{});var ve=i(T);l=s(ve,"having all inputs as keyword arguments (like PyTorch models), or"),ve.forEach(t),u=h(Y),x=a(Y,"LI",{});var $e=i(x);me=s($e,"having all inputs as a list, tuple or dict in the first positional arguments."),$e.forEach(t),Y.forEach(t),V=h(f),z=a(f,"P",{});var S=i(z);J=s(S,"This second option is useful when using "),L=a(S,"CODE",{});var we=i(L);X=s(we,"tf.keras.Model.fit"),we.forEach(t),he=s(S,` method which currently requires having all the
...
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-built_in">round</span>(<span class="hljs-built_in">float</span>(loss), <span class="hljs-number">2</span>)
<span class="hljs-number">0.03</span>`}}),{c(){v(d.$$.fragment)},l(c){y(d.$$.fragment,c)},m(c,p){w(d,c,p),_=!0},p:xe,i(c){_||(M(d.$$.fragment,c),_=!0)},o(c){$(d.$$.fragment,c),_=!1},d(c){F(d,c)}}}function dw(E){let d,_,c,p,T,l,u,x,me,V,z,J,L,X,he,D,ue,le,K,N,ee,G,q,C,ne,U,de,se,W,fe,ce,P,ge,R,Z,re,H,_e,ae,O,pe,A,be;return{c(){d=r("p"),_=n("TF 2.0 models accepts two formats as inputs:"),c=m(),p=r("ul"),T=r("li"),l=n("having all inputs as keyword arguments (like PyTorch models), or"),u=m(),x=r("li"),me=n("having all inputs as a list, tuple or dict in the first positional arguments."),V=m(),z=r("p"),J=n("This second option is useful when using "),L=r("code"),X=n("tf.keras.Model.fit"),he=n(` method which currently requires having all the
tensors in the first argument of the model call function: `),D=r("code"),ue=n("model(inputs)"),le=n("."),K=m(),N=r("p"),ee=n(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),G=m(),q=r("ul"),C=r("li"),ne=n("a single Tensor with "),U=r("code"),de=n("input_ids"),se=n(" only and nothing else: "),W=r("code"),fe=n("model(inputs_ids)"),ce=m(),P=r("li"),ge=n(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),R=r("code"),Z=n("model([input_ids, attention_mask])"),re=n(" or "),H=r("code"),_e=n("model([input_ids, attention_mask, token_type_ids])"),ae=m(),O=r("li"),pe=n(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),A=r("code"),be=n('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(f){d=a(f,"P",{});var B=i(d);_=s(B,"TF 2.0 models accepts two formats as inputs:"),B.forEach(t),c=h(f),p=a(f,"UL",{});var Y=i(p);T=a(Y,"LI",{});var ve=i(T);l=s(ve,"having all inputs as keyword arguments (like PyTorch models), or"),ve.forEach(t),u=h(Y),x=a(Y,"LI",{});var $e=i(x);me=s($e,"having all inputs as a list, tuple or dict in the first positional arguments."),$e.forEach(t),Y.forEach(t),V=h(f),z=a(f,"P",{});var S=i(z);J=s(S,"This second option is useful when using "),L=a(S,"CODE",{});var we=i(L);X=s(we,"tf.keras.Model.fit"),we.forEach(t),he=s(S,` method which currently requires having all the
...
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-built_in">round</span>(<span class="hljs-built_in">float</span>(loss), <span class="hljs-number">2</span>)
<span class="hljs-number">3.98</span>`}}),{c(){v(d.$$.fragment)},l(c){y(d.$$.fragment,c)},m(c,p){w(d,c,p),_=!0},p:xe,i(c){_||(M(d.$$.fragment,c),_=!0)},o(c){$(d.$$.fragment,c),_=!1},d(c){F(d,c)}}}function hw(E){let d,_,c,p,T,l,u,x,me,V,z,J,L,X,he,D,ue,le,K,N,ee,G,q,C,ne,U,de,se,W,fe,ce,P,ge,R,Z,re,H,_e,ae,O,pe,A,be,f,B,Y,ve,$e,S,we,Te,ke,j,I,Fe,ye,Q,Me,te,oe,Be,Mt,Ep,ya,xp,zp,wa,qp,Pp,is,Cp,jp,Np,Wt,Op,Ma,Sp,Ap,$a,Ip,Lp,Dp,Co,Wp,Pi,Rp,Ad,Rt,jo,Ci,ls,Up,ji,Hp,Id,st,ds,Qp,Ni,Kp,Vp,No,Fa,Gp,Yp,Ba,Jp,Zp,Xp,cs,em,Ea,tm,om,Ld,Ut,Oo,Oi,ps,nm,Si,sm,Dd,rt,ms,rm,hs,am,Ai,im,lm,dm,So,xa,cm,pm,za,mm,hm,um,us,fm,qa,gm,_m,Wd,Ht,Ao,Ii,fs,bm,Li,Tm,Rd,Qt,gs,km,_s,vm,Pa,ym,wm,Ud,Kt,bs,Mm,Ts,$m,Ca,Fm,Bm,Hd,Vt,Io,Di,ks,Em,Wi,xm,Qd,je,vs,zm,Ri,qm,Pm,ys,Cm,ja,jm,Nm,Om,ws,Sm,Ms,Am,Im,Lm,Ui,$s,Dm,Wm,it,Fs,Rm,Gt,Um,Na,Hm,Qm,Hi,Km,Vm,Gm,Lo,Ym,Do,Kd,Yt,Wo,Qi,Bs,Jm,Ki,Zm,Vd,Re,Es,Xm,Jt,eh,Vi,th,oh,Gi,nh,sh,rh,xs,ah,Oa,ih,lh,dh,zs,ch,qs,ph,mh,hh,lt,Ps,uh,Zt,fh,Sa,gh,_h,Yi,bh,Th,kh,Ro,vh,Uo,Gd,Xt,Ho,Ji,Cs,yh,Zi,wh,Yd,Ue,js,Mh,Ns,$h,Xi,Fh,Bh,Eh,Os,xh,Aa,zh,qh,Ph,Ss,Ch,As,jh,Nh,Oh,Ye,Is,Sh,eo,Ah,Ia,Ih,Lh,el,Dh,Wh,Rh,Qo,Uh,Ko,Hh,Vo,Jd,to,Go,tl,Ls,Qh,ol,Kh,Zd,He,Ds,Vh,Ws,Gh,nl,Yh,Jh,Zh,Rs,Xh,La,eu,tu,ou,Us,nu,Hs,su,ru,au,dt,Qs,iu,oo,lu,Da,du,cu,sl,pu,mu,hu,Yo,uu,Jo,Xd,no,Zo,rl,Ks,fu,al,gu,ec,Qe,Vs,_u,il,bu,Tu,Gs,ku,Wa,vu,yu,wu,Ys,Mu,Js,$u,Fu,Bu,Ce,Zs,Eu,so,xu,Ra,zu,qu,ll,Pu,Cu,ju,Xo,Nu,en,Ou,tn,Su,on,Au,nn,tc,ro,sn,dl,Xs,Iu,cl,Lu,oc,Ke,er,Du,pl,Wu,Ru,tr,Uu,Ua,Hu,Qu,Ku,or,Vu,nr,Gu,Yu,Ju,ct,sr,Zu,ao,Xu,Ha,ef,tf,ml,of,nf,sf,rn,rf,an,nc,io,ln,hl,rr,af,ul,lf,sc,Ve,ar,df,fl,cf,pf,ir,mf,Qa,hf,uf,ff,lr,gf,dr,_f,bf,Tf,Je,cr,kf,lo,vf,Ka,yf,wf,gl,Mf,$f,Ff,dn,Bf,cn,Ef,pn,rc,co,mn,_l,pr,xf,bl,zf,ac,Ge,mr,qf,po,Pf,Tl,Cf,jf,kl,Nf,Of,Sf,hr,Af,Va,If,Lf,Df,ur,Wf,fr,Rf,Uf,Hf,Ze,gr,Qf,mo,Kf,Ga,Vf,Gf,vl,Yf,Jf,Zf,hn,Xf,un,eg,fn,ic,ho,gn,yl,_r,tg,wl,og,lc,Ne,br,ng,Ml,sg,rg,Tr,ag,Ya,ig,lg,dg,kr,cg,vr,pg,mg,hg,_n,ug,pt,yr,fg,uo,gg,Ja,_g,bg,$l,Tg,kg,vg,bn,yg,Tn,dc,fo,kn,Fl,wr,wg,Bl,Mg,cc,Oe,Mr,$g,go,Fg,El,Bg,Eg,xl,xg,zg,qg,$r,Pg,Za,Cg,jg,Ng,Fr,Og,Br,Sg,Ag,Ig,vn,Lg,mt,Er,Dg,_o,Wg,Xa,Rg,Ug,zl,Hg,Qg,Kg,yn,Vg,wn,pc,bo,Mn,ql,xr,Gg,Pl,Yg,mc,Se,zr,Jg,qr,Zg,Cl,Xg,e_,t_,Pr,o_,ei,n_,s_,r_,Cr,a_,jr,i_,l_,d_,$n,c_,Xe,Nr,p_,To,m_,ti,h_,u_,jl,f_,g_,__,Fn,b_,Bn,T_,En,hc,ko,xn,Nl,Or,k_,Ol,v_,uc,Ae,Sr,y_,Ar,w_,Sl,M_,$_,F_,Ir,B_,oi,E_,x_,z_,Lr,q_,Dr,P_,C_,j_,zn,N_,ht,Wr,O_,vo,S_,ni,A_,I_,Al,L_,D_,W_,qn,R_,Pn,fc,yo,Cn,Il,Rr,U_,Ll,H_,gc,Ie,Ur,Q_,Dl,K_,V_,Hr,G_,si,Y_,J_,Z_,Qr,X_,Kr,eb,tb,ob,jn,nb,et,Vr,sb,wo,rb,ri,ab,ib,Wl,lb,db,cb,Nn,pb,On,mb,Sn,_c,Mo,An,Rl,Gr,hb,Ul,ub,bc,Le,Yr,fb,Hl,gb,_b,Jr,bb,ai,Tb,kb,vb,Zr,yb,Xr,wb,Mb,$b,In,Fb,ut,ea,Bb,$o,Eb,ii,xb,zb,Ql,qb,Pb,Cb,Ln,jb,Dn,Tc,Fo,Wn,Kl,ta,Nb,Vl,Ob,kc,De,oa,Sb,Gl,Ab,Ib,na,Lb,li,Db,Wb,Rb,sa,Ub,ra,Hb,Qb,Kb,Rn,Vb,tt,aa,Gb,Bo,Yb,di,Jb,Zb,Yl,Xb,eT,tT,Un,oT,Hn,nT,Qn,vc,Eo,Kn,Jl,ia,sT,Zl,rT,yc,We,la,aT,xo,iT,Xl,lT,dT,ed,cT,pT,mT,da,hT,ci,uT,fT,gT,ca,_T,pa,bT,TT,kT,Vn,vT,ot,ma,yT,zo,wT,pi,MT,$T,td,FT,BT,ET,Gn,xT,Yn,zT,Jn,wc;return l=new Pe({}),X=new Pe({}),I=new Pe({}),oe=new ie({props:{name:"class transformers.MobileBertConfig",anchor:"transformers.MobileBertConfig",parameters:[{name:"vocab_size",val:" = 30522"},{name:"hidden_size",val:" = 512"},{name:"num_hidden_layers",val:" = 24"},{name:"num_attention_heads",val:" = 4"},{name:"intermediate_size",val:" = 512"},{name:"hidden_act",val:" = 'relu'"},{name:"hidden_dropout_prob",val:" = 0.0"},{name:"attention_probs_dropout_prob",val:" = 0.1"},{name:"max_position_embeddings",val:" = 512"},{name:"type_vocab_size",val:" = 2"},{name:"initializer_range",val:" = 0.02"},{name:"layer_norm_eps",val:" = 1e-12"},{name:"pad_token_id",val:" = 0"},{name:"embedding_size",val:" = 128"},{name:"trigram_input",val:" = True"},{name:"use_bottleneck",val:" = True"},{name:"intra_bottleneck_size",val:" = 128"},{name:"use_bottleneck_attention",val:" = False"},{name:"key_query_shared_bottleneck",val:" = True"},{name:"num_feedforward_networks",val:" = 4"},{name:"normalization_type",val:" = 'no_norm'"},{name:"classifier_activation",val:" = True"},{name:"classifier_dropout",val:" = None"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.MobileBertConfig.vocab_size",description:`<strong>vocab_size</strong> (<code>int</code>, <em>optional</em>, defaults to 30522) &#x2014;
...
`}}),dn=new qe({props:{$$slots:{default:[Cy]},$$scope:{ctx:E}}}),cn=new Ee({props:{anchor:"transformers.MobileBertForTokenClassification.forward.example",$$slots:{default:[jy]},$$scope:{ctx:E}}}),pn=new Ee({props:{anchor:"transformers.MobileBertForTokenClassification.forward.example-2",$$slots:{default:[Ny]},$$scope:{ctx:E}}}),pr=new Pe({}),mr=new ie({props:{name:"class transformers.MobileBertForQuestionAnswering",anchor:"transformers.MobileBertForQuestionAnswering",parameters:[{name:"config",val:""}],parametersDescription:[{anchor:"transformers.MobileBertForQuestionAnswering.config",description:`<strong>config</strong> (<a href="/docs/transformers/main/en/model_doc/mobilebert#transformers.MobileBertConfig">MobileBertConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
...
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/main/en/model_doc/mobilebert#transformers.MobileBertTokenizer">MobileBertTokenizer</a>. See <a href="/docs/transformers/main/en/model_doc/wav2vec2#transformers.Wav2Vec2CTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
...
`}}),Gn=new qe({props:{$$slots:{default:[cw]},$$scope:{ctx:E}}}),Yn=new Ee({props:{anchor:"transformers.TFMobileBertForQuestionAnswering.call.example",$$slots:{default:[pw]},$$scope:{ctx:E}}}),Jn=new Ee({props:{anchor:"transformers.TFMobileBertForQuestionAnswering.call.example-2",$$slots:{default:[mw]},$$scope:{ctx:E}}}),{c(){d=r("meta"),_=m(),c=r("h1"),p=r("a"),T=r("span"),v(l.$$.fragment),u=m(),x=r("span"),me=n("MobileBERT"),V=m(),z=r("h2"),J=r("a"),L=r("span"),v(X.$$.fragment),he=m(),D=r("span"),ue=n("Overview"),le=m(),K=r("p"),N=n("The MobileBERT model was proposed in "),ee=r("a"),G=n("MobileBERT: a Compact Task-Agnostic BERT for Resource-Limited Devices"),q=n(` by Zhiqing Sun, Hongkun Yu, Xiaodan Song, Renjie Liu, Yiming Yang, and Denny
Zhou. It\u2019s a bidirectional transformer based on the BERT model, which is compressed and accelerated using several
approaches.`),C=m(),ne=r("p"),U=n("The abstract from the paper is the following:"),de=m(),se=r("p"),W=r("em"),fe=n(`Natural Language Processing (NLP) has recently achieved great success by using huge pre-trained models with hundreds
...
90.0/79.2 (1.5/2.1 higher than BERT_BASE).`),ce=m(),P=r("p"),ge=n("Tips:"),R=m(),Z=r("ul"),re=r("li"),H=n(`MobileBERT is a model with absolute position embeddings so it\u2019s usually advised to pad the inputs on the right rather
...
documentation from `),$a=r("a"),Ip=n("PretrainedConfig"),Lp=n(" for more information."),Dp=m(),v(Co.$$.fragment),Wp=m(),Pi=r("p"),Rp=n(`Attributes: pretrained_config_archive_map (Dict[str, str]): A dictionary containing all the available pre-trained
...
splitting and wordpiece.`),um=m(),us=r("p"),fm=n("Refer to superclass "),qa=r("a"),gm=n("BertTokenizerFast"),_m=n(" for usage examples and documentation concerning parameters."),Wd=m(),Ht=r("h2"),Ao=r("a"),Ii=r("span"),v(fs.$$.fragment),bm=m(),Li=r("span"),Tm=n("MobileBert specific outputs"),Rd=m(),Qt=r("div"),v(gs.$$.fragment),km=m(),_s=r("p"),vm=n("Output type of "),Pa=r("a"),ym=n("MobileBertForPreTraining"),wm=n("."),Ud=m(),Kt=r("div"),v(bs.$$.fragment),Mm=m(),Ts=r("p"),$m=n("Output type of "),Ca=r("a"),Fm=n("TFMobileBertForPreTraining"),Bm=n("."),Hd=m(),Vt=r("h2"),Io=r("a"),Di=r("span"),v(ks.$$.fragment),Em=m(),Wi=r("span"),xm=n("MobileBertModel"),Qd=m(),je=r("div"),v(vs.$$.fragment),zm=m(),Ri=r("p"),qm=n("The bare MobileBert Model transformer outputting raw hidden-states without any specific head on top."),Pm=m(),ys=r("p"),Cm=n("This model inherits from "),ja=r("a"),jm=n("PreTrainedModel"),Nm=n(`. Check the superclass documentation for the generic methods the
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),dh=m(),zs=r("p"),ch=n("This model is also a PyTorch "),qs=r("a"),ph=n("torch.nn.Module"),mh=n(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),hh=m(),lt=r("div"),v(Ps.$$.fragment),uh=m(),Zt=r("p"),fh=n("The "),Sa=r("a"),gh=n("MobileBertForPreTraining"),_h=n(" forward method, overrides the "),Yi=r("code"),bh=n("__call__"),Th=n(" special method."),kh=m(),v(Ro.$$.fragment),vh=m(),v(Uo.$$.fragment),Gd=m(),Xt=r("h2"),Ho=r("a"),Ji=r("span"),v(Cs.$$.fragment),yh=m(),Zi=r("span"),wh=n("MobileBertForMaskedLM"),Yd=m(),Ue=r("div"),v(js.$$.fragment),Mh=m(),Ns=r("p"),$h=n("MobileBert Model with a "),Xi=r("code"),Fh=n("language modeling"),Bh=n(" head on top."),Eh=m(),Os=r("p"),xh=n("This model inherits from "),Aa=r("a"),zh=n("PreTrainedModel"),qh=n(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Ph=m(),Ss=r("p"),Ch=n("This model is also a PyTorch "),As=r("a"),jh=n("torch.nn.Module"),Nh=n(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Oh=m(),Ye=r("div"),v(Is.$$.fragment),Sh=m(),eo=r("p"),Ah=n("The "),Ia=r("a"),Ih=n("MobileBertForMaskedLM"),Lh=n(" forward method, overrides the "),el=r("code"),Dh=n("__call__"),Wh=n(" special method."),Rh=m(),v(Qo.$$.fragment),Uh=m(),v(Ko.$$.fragment),Hh=m(),v(Vo.$$.fragment),Jd=m(),to=r("h2"),Go=r("a"),tl=r("span"),v(Ls.$$.fragment),Qh=m(),ol=r("span"),Kh=n("MobileBertForNextSentencePrediction"),Zd=m(),He=r("div"),v(Ds.$$.fragment),Vh=m(),Ws=r("p"),Gh=n("MobileBert Model with a "),nl=r("code"),Yh=n("next sentence prediction (classification)"),Jh=n(" head on top."),Zh=m(),Rs=r("p"),Xh=n("This model inherits from "),La=r("a"),eu=n("PreTrainedModel"),tu=n(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),ou=m(),Us=r("p"),nu=n("This model is also a PyTorch "),Hs=r("a"),su=n("torch.nn.Module"),ru=n(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),au=m(),dt=r("div"),v(Qs.$$.fragment),iu=m(),oo=r("p"),lu=n("The "),Da=r("a"),du=n("MobileBertForNextSentencePrediction"),cu=n(" forward method, overrides the "),sl=r("code"),pu=n("__call__"),mu=n(" special method."),hu=m(),v(Yo.$$.fragment),uu=m(),v(Jo.$$.fragment),Xd=m(),no=r("h2"),Zo=r("a"),rl=r("span"),v(Ks.$$.fragment),fu=m(),al=r("span"),gu=n("MobileBertForSequenceClassification"),ec=m(),Qe=r("div"),v(Vs.$$.fragment),_u=m(),il=r("p"),bu=n(`MobileBert Model transformer with a sequence classification/regression head on top (a linear layer on top of the
pooled output) e.g. for GLUE tasks.`),Tu=m(),Gs=r("p"),ku=n("This model inherits from "),Wa=r("a"),vu=n("PreTrainedModel"),yu=n(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),wu=m(),Ys=r("p"),Mu=n("This model is also a PyTorch "),Js=r("a"),$u=n("torch.nn.Module"),Fu=n(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Bu=m(),Ce=r("div"),v(Zs.$$.fragment),Eu=m(),so=r("p"),xu=n("The "),Ra=r("a"),zu=n("MobileBertForSequenceClassification"),qu=n(" forward method, overrides the "),ll=r("code"),Pu=n("__call__"),Cu=n(" special method."),ju=m(),v(Xo.$$.fragment),Nu=m(),v(en.$$.fragment),Ou=m(),v(tn.$$.fragment),Su=m(),v(on.$$.fragment),Au=m(),v(nn.$$.fragment),tc=m(),ro=r("h2"),sn=r("a"),dl=r("span"),v(Xs.$$.fragment),Iu=m(),cl=r("span"),Lu=n("MobileBertForMultipleChoice"),oc=m(),Ke=r("div"),v(er.$$.fragment),Du=m(),pl=r("p"),Wu=n(`MobileBert Model with a multiple choice classification head on top (a linear layer on top of the pooled output and
a softmax) e.g. for RocStories/SWAG tasks.`),Ru=m(),tr=r("p"),Uu=n("This model inherits from "),Ua=r("a"),Hu=n("PreTrainedModel"),Qu=n(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Ku=m(),or=r("p"),Vu=n("This model is also a PyTorch "),nr=r("a"),Gu=n("torch.nn.Module"),Yu=n(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Ju=m(),ct=r("div"),v(sr.$$.fragment),Zu=m(),ao=r("p"),Xu=n("The "),Ha=r("a"),ef=n("MobileBertForMultipleChoice"),tf=n(" forward method, overrides the "),ml=r("code"),of=n("__call__"),nf=n(" special method."),sf=m(),v(rn.$$.fragment),rf=m(),v(an.$$.fragment),nc=m(),io=r("h2"),ln=r("a"),hl=r("span"),v(rr.$$.fragment),af=m(),ul=r("span"),lf=n("MobileBertForTokenClassification"),sc=m(),Ve=r("div"),v(ar.$$.fragment),df=m(),fl=r("p"),cf=n(`MobileBert Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g.
for Named-Entity-Recognition (NER) tasks.`),pf=m(),ir=r("p"),mf=n("This model inherits from "),Qa=r("a"),hf=n("PreTrainedModel"),uf=n(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),ff=m(),lr=r("p"),gf=n("This model is also a PyTorch "),dr=r("a"),_f=n("torch.nn.Module"),bf=n(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Tf=m(),Je=r("div"),v(cr.$$.fragment),kf=m(),lo=r("p"),vf=n("The "),Ka=r("a"),yf=n("MobileBertForTokenClassification"),wf=n(" forward method, overrides the "),gl=r("code"),Mf=n("__call__"),$f=n(" special method."),Ff=m(),v(dn.$$.fragment),Bf=m(),v(cn.$$.fragment),Ef=m(),v(pn.$$.fragment),rc=m(),co=r("h2"),mn=r("a"),_l=r("span"),v(pr.$$.fragment),xf=m(),bl=r("span"),zf=n("MobileBertForQuestionAnswering"),ac=m(),Ge=r("div"),v(mr.$$.fragment),qf=m(),po=r("p"),Pf=n(`MobileBert Model with a span classification head on top for extractive question-answering tasks like SQuAD (a
linear layers on top of the hidden-states output to compute `),Tl=r("code"),Cf=n("span start logits"),jf=n(" and "),kl=r("code"),Nf=n("span end logits"),Of=n(")."),Sf=m(),hr=r("p"),Af=n("This model inherits from "),Va=r("a"),If=n("PreTrainedModel"),Lf=n(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Df=m(),ur=r("p"),Wf=n("This model is also a PyTorch "),fr=r("a"),Rf=n("torch.nn.Module"),Uf=n(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Hf=m(),Ze=r("div"),v(gr.$$.fragment),Qf=m(),mo=r("p"),Kf=n("The "),Ga=r("a"),Vf=n("MobileBertForQuestionAnswering"),Gf=n(" forward method, overrides the "),vl=r("code"),Yf=n("__call__"),Jf=n(" special method."),Zf=m(),v(hn.$$.fragment),Xf=m(),v(un.$$.fragment),eg=m(),v(fn.$$.fragment),ic=m(),ho=r("h2"),gn=r("a"),yl=r("span"),v(_r.$$.fragment),tg=m(),wl=r("span"),og=n("TFMobileBertModel"),lc=m(),Ne=r("div"),v(br.$$.fragment),ng=m(),Ml=r("p"),sg=n("The bare MobileBert Model transformer outputting raw hidden-states without any specific head on top."),rg=m(),Tr=r("p"),ag=n("This model inherits from "),Ya=r("a"),ig=n("TFPreTrainedModel"),lg=n(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),dg=m(),kr=r("p"),cg=n("This model is also a "),vr=r("a"),pg=n("tf.keras.Model"),mg=n(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),hg=m(),v(_n.$$.fragment),ug=m(),pt=r("div"),v(yr.$$.fragment),fg=m(),uo=r("p"),gg=n("The "),Ja=r("a"),_g=n("TFMobileBertModel"),bg=n(" forward method, overrides the "),$l=r("code"),Tg=n("__call__"),kg=n(" special method."),vg=m(),v(bn.$$.fragment),yg=m(),v(Tn.$$.fragment),dc=m(),fo=r("h2"),kn=r("a"),Fl=r("span"),v(wr.$$.fragment),wg=m(),Bl=r("span"),Mg=n("TFMobileBertForPreTraining"),cc=m(),Oe=r("div"),v(Mr.$$.fragment),$g=m(),go=r("p"),Fg=n("MobileBert Model with two heads on top as done during the pretraining: a "),El=r("code"),Bg=n("masked language modeling"),Eg=n(` head and a
`),xl=r("code"),xg=n("next sentence prediction (classification)"),zg=n(" head."),qg=m(),$r=r("p"),Pg=n("This model inherits from "),Za=r("a"),Cg=n("TFPreTrainedModel"),jg=n(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Ng=m(),Fr=r("p"),Og=n("This model is also a "),Br=r("a"),Sg=n("tf.keras.Model"),Ag=n(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Ig=m(),v(vn.$$.fragment),Lg=m(),mt=r("div"),v(Er.$$.fragment),Dg=m(),_o=r("p"),Wg=n("The "),Xa=r("a"),Rg=n("TFMobileBertForPreTraining"),Ug=n(" forward method, overrides the "),zl=r("code"),Hg=n("__call__"),Qg=n(" special method."),Kg=m(),v(yn.$$.fragment),Vg=m(),v(wn.$$.fragment),pc=m(),bo=r("h2"),Mn=r("a"),ql=r("span"),v(xr.$$.fragment),Gg=m(),Pl=r("span"),Yg=n("TFMobileBertForMaskedLM"),mc=m(),Se=r("div"),v(zr.$$.fragment),Jg=m(),qr=r("p"),Zg=n("MobileBert Model with a "),Cl=r("code"),Xg=n("language modeling"),e_=n(" head on top."),t_=m(),Pr=r("p"),o_=n("This model inherits from "),ei=r("a"),n_=n("TFPreTrainedModel"),s_=n(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),r_=m(),Cr=r("p"),a_=n("This model is also a "),jr=r("a"),i_=n("tf.keras.Model"),l_=n(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),d_=m(),v($n.$$.fragment),c_=m(),Xe=r("div"),v(Nr.$$.fragment),p_=m(),To=r("p"),m_=n("The "),ti=r("a"),h_=n("TFMobileBertForMaskedLM"),u_=n(" forward method, overrides the "),jl=r("code"),f_=n("__call__"),g_=n(" special method."),__=m(),v(Fn.$$.fragment),b_=m(),v(Bn.$$.fragment),T_=m(),v(En.$$.fragment),hc=m(),ko=r("h2"),xn=r("a"),Nl=r("span"),v(Or.$$.fragment),k_=m(),Ol=r("span"),v_=n("TFMobileBertForNextSentencePrediction"),uc=m(),Ae=r("div"),v(Sr.$$.fragment),y_=m(),Ar=r("p"),w_=n("MobileBert Model with a "),Sl=r("code"),M_=n("next sentence prediction (classification)"),$_=n(" head on top."),F_=m(),Ir=r("p"),B_=n("This model inherits from "),oi=r("a"),E_=n("TFPreTrainedModel"),x_=n(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),z_=m(),Lr=r("p"),q_=n("This model is also a "),Dr=r("a"),P_=n("tf.keras.Model"),C_=n(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),j_=m(),v(zn.$$.fragment),N_=m(),ht=r("div"),v(Wr.$$.fragment),O_=m(),vo=r("p"),S_=n("The "),ni=r("a"),A_=n("TFMobileBertForNextSentencePrediction"),I_=n(" forward method, overrides the "),Al=r("code"),L_=n("__call__"),D_=n(" special method."),W_=m(),v(qn.$$.fragment),R_=m(),v(Pn.$$.fragment),fc=m(),yo=r("h2"),Cn=r("a"),Il=r("span"),v(Rr.$$.fragment),U_=m(),Ll=r("span"),H_=n("TFMobileBertForSequenceClassification"),gc=m(),Ie=r("div"),v(Ur.$$.fragment),Q_=m(),Dl=r("p"),K_=n(`MobileBert Model transformer with a sequence classification/regression head on top (a linear layer on top of the
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),$b=m(),v(In.$$.fragment),Fb=m(),ut=r("div"),v(ea.$$.fragment),Bb=m(),$o=r("p"),Eb=n("The "),ii=r("a"),xb=n("TFMobileBertForMultipleChoice"),zb=n(" forward method, overrides the "),Ql=r("code"),qb=n("__call__"),Pb=n(" special method."),Cb=m(),v(Ln.$$.fragment),jb=m(),v(Dn.$$.fragment),Tc=m(),Fo=r("h2"),Wn=r("a"),Kl=r("span"),v(ta.$$.fragment),Nb=m(),Vl=r("span"),Ob=n("TFMobileBertForTokenClassification"),kc=m(),De=r("div"),v(oa.$$.fragment),Sb=m(),Gl=r("p"),Ab=n(`MobileBert Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g.
...
linear layers on top of the hidden-states output to compute `),Xl=r("code"),lT=n("span start logits"),dT=n(" and "),ed=r("code"),cT=n("span end logits"),pT=n(")."),mT=m(),da=r("p"),hT=n("This model inherits from "),ci=r("a"),uT=n("TFPreTrainedModel"),fT=n(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),gT=m(),ca=r("p"),_T=n("This model is also a "),pa=r("a"),bT=n("tf.keras.Model"),TT=n(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),kT=m(),v(Vn.$$.fragment),vT=m(),ot=r("div"),v(ma.$$.fragment),yT=m(),zo=r("p"),wT=n("The "),pi=r("a"),MT=n("TFMobileBertForQuestionAnswering"),$T=n(" forward method, overrides the "),td=r("code"),FT=n("__call__"),BT=n(" special method."),ET=m(),v(Gn.$$.fragment),xT=m(),v(Yn.$$.fragment),zT=m(),v(Jn.$$.fragment),this.h()},l(o){const k=uy('[data-svelte="svelte-1phssyn"]',document.head);d=a(k,"META",{name:!0,content:!0}),k.forEach(t),_=h(o),c=a(o,"H1",{class:!0});var ha=i(c);p=a(ha,"A",{id:!0,class:!0,href:!0});var od=i(p);T=a(od,"SPAN",{});var nd=i(T);y(l.$$.fragment,nd),nd.forEach(t),od.forEach(t),u=h(ha),x=a(ha,"SPAN",{});var sd=i(x);me=s(sd,"MobileBERT"),sd.forEach(t),ha.forEach(t),V=h(o),z=a(o,"H2",{class:!0});var ua=i(z);J=a(ua,"A",{id:!0,class:!0,href:!0});var rd=i(J);L=a(rd,"SPAN",{});var ad=i(L);y(X.$$.fragment,ad),ad.forEach(t),rd.forEach(t),he=h(ua),D=a(ua,"SPAN",{});var id=i(D);ue=s(id,"Overview"),id.forEach(t),ua.forEach(t),le=h(o),K=a(o,"P",{});var fa=i(K);N=s(fa,"The MobileBERT model was proposed in "),ee=a(fa,"A",{href:!0,rel:!0});var ld=i(ee);G=s(ld,"MobileBERT: a Compact Task-Agnostic BERT for Resource-Limited Devices"),ld.forEach(t),q=s(fa,` by Zhiqing Sun, Hongkun Yu, Xiaodan Song, Renjie Liu, Yiming Yang, and Denny
Zhou. It\u2019s a bidirectional transformer based on the BERT model, which is compressed and accelerated using several
approaches.`),fa.forEach(t),C=h(o),ne=a(o,"P",{});var dd=i(ne);U=s(dd,"The abstract from the paper is the following:"),dd.forEach(t),de=h(o),se=a(o,"P",{});var cd=i(se);W=a(cd,"EM",{});var pd=i(W);fe=s(pd,`Natural Language Processing (NLP) has recently achieved great success by using huge pre-trained models with hundreds
of millions of parameters. However, these models suffer from heavy model sizes and high latency such that they cannot
be deployed to resource-limited mobile devices. In this paper, we propose MobileBERT for compressing and accelerating
the popular BERT model. Like the original BERT, MobileBERT is task-agnostic, that is, it can be generically applied to
various downstream NLP tasks via simple fine-tuning. Basically, MobileBERT is a thin version of BERT_LARGE, while
...
natural language inference tasks of GLUE, MobileBERT achieves a GLUEscore o 77.7 (0.6 lower than BERT_BASE), and 62 ms
latency on a Pixel 4 phone. On the SQuAD v1.1/v2.0 question answering task, MobileBERT achieves a dev F1 score of
90.0/79.2 (1.5/2.1 higher than BERT_BASE).`),pd.forEach(t),cd.forEach(t),ce=h(o),P=a(o,"P",{});var md=i(P);ge=s(md,"Tips:"),md.forEach(t),R=h(o),Z=a(o,"UL",{});var ga=i(Z);re=a(ga,"LI",{});var hd=i(re);H=s(hd,`MobileBERT is a model with absolute position embeddings so it\u2019s usually advised to pad the inputs on the right rather
than the left.`),hd.forEach(t),_e=h(ga),ae=a(ga,"LI",{});var ud=i(ae);O=s(ud,`MobileBERT is similar to BERT and therefore relies on the masked language modeling (MLM) objective. It is therefore
efficient at predicting masked tokens and at NLU in general, but is not optimal for text generation. Models trained
with a causal language modeling (CLM) objective are better in that regard.`),ud.forEach(t),ga.forEach(t),pe=h(o),A=a(o,"P",{});var qo=i(A);be=s(qo,"This model was contributed by "),f=a(qo,"A",{href:!0,rel:!0});var fd=i(f);B=s(fd,"vshampor"),fd.forEach(t),Y=s(qo,". The original code can be found "),ve=a(qo,"A",{href:!0,rel:!0});var gd=i(ve);$e=s(gd,"here"),gd.forEach(t),S=s(qo,"."),qo.forEach(t),we=h(o),Te=a(o,"H2",{class:!0});var _a=i(Te);ke=a(_a,"A",{id:!0,class:!0,href:!0});var _d=i(ke);j=a(_d,"SPAN",{});var bd=i(j);y(I.$$.fragment,bd),bd.forEach(t),_d.forEach(t),Fe=h(_a),ye=a(_a,"SPAN",{});var Td=i(ye);Q=s(Td,"MobileBertConfig"),Td.forEach(t),_a.forEach(t),Me=h(o),te=a(o,"DIV",{class:!0});var at=i(te);y(oe.$$.fragment,at),Be=h(at),Mt=a(at,"P",{});var $t=i(Mt);Ep=s($t,"This is the configuration class to store the configuration of a "),ya=a($t,"A",{href:!0});var kd=i(ya);xp=s(kd,"MobileBertModel"),kd.forEach(t),zp=s($t," or a "),wa=a($t,"A",{href:!0});var vd=i(wa);qp=s(vd,"TFMobileBertModel"),vd.forEach(t),Pp=s($t,`. It
is used to instantiate a MobileBERT model according to the specified arguments, defining the model architecture.
Instantiating a configuration with the defaults will yield a similar configuration to that of the MobileBERT
`),is=a($t,"A",{href:!0,rel:!0});var yd=i(is);Cp=s(yd,"google/mobilebert-uncased"),yd.forEach(t),jp=s($t," architecture."),$t.forEach(t),Np=h(at),Wt=a(at,"P",{});var Po=i(Wt);Op=s(Po,"Configuration objects inherit from "),Ma=a(Po,"A",{href:!0});var wd=i(Ma);Sp=s(wd,"PretrainedConfig"),wd.forEach(t),Ap=s(Po,` and can be used to control the model outputs. Read the
documentation from `),$a=a(Po,"A",{href:!0});var Md=i($a);Ip=s(Md,"PretrainedConfig"),Md.forEach(t),Lp=s(Po," for more information."),Po.forEach(t),Dp=h(at),y(Co.$$.fragment,at),Wp=h(at),Pi=a(at,"P",{});var $d=i(Pi);Rp=s($d,`Attributes: pretrained_config_archive_map (Dict[str, str]): A dictionary containing all the available pre-trained
checkpoints.`),$d.forEach(t),at.forEach(t),Ad=h(o),Rt=a(o,"H2",{class:!0});var ba=i(Rt);jo=a(ba,"A",{id:!0,class:!0,href:!0});var Fd=i(jo);Ci=a(Fd,"SPAN",{});var Bd=i(Ci);y(ls.$$.fragment,Bd),Bd.forEach(t),Fd.forEach(t),Up=h(ba),ji=a(ba,"SPAN",{});var Ed=i(ji);Hp=s(Ed,"MobileBertTokenizer"),Ed.forEach(t),ba.forEach(t),Id=h(o),st=a(o,"DIV",{class:!0});var Ft=i(st);y(ds.$$.fragment,Ft),Qp=h(Ft),Ni=a(Ft,"P",{});var xd=i(Ni);Kp=s(xd,"Construct a MobileBERT tokenizer."),xd.forEach(t),Vp=h(Ft),No=a(Ft,"P",{});var Zn=i(No);Fa=a(Zn,"A",{href:!0});var zd=i(Fa);Gp=s(zd,"MobileBertTokenizer"),zd.forEach(t),Yp=s(Zn," is identical to "),Ba=a(Zn,"A",{href:!0});var qd=i(Ba);Jp=s(qd,"BertTokenizer"),qd.forEach(t),Zp=s(Zn,` and runs end-to-end tokenization: punctuation splitting
and wordpiece.`),Zn.forEach(t),Xp=h(Ft),cs=a(Ft,"P",{});var Ta=i(cs);em=s(Ta,"Refer to superclass "),Ea=a(Ta,"A",{href:!0});var Pd=i(Ea);tm=s(Pd,"BertTokenizer"),Pd.forEach(t),om=s(Ta," for usage examples and documentation concerning parameters."),Ta.forEach(t),Ft.forEach(t),Ld=h(o),Ut=a(o,"H2",{class:!0});var ka=i(Ut);Oo=a(ka,"A",{id:!0,class:!0,href:!0});var Cd=i(Oo);Oi=a(Cd,"SPAN",{});var jd=i(Oi);y(ps.$$.fragment,jd),jd.forEach(t),Cd.forEach(t),nm=h(ka),Si=a(ka,"SPAN",{});var Nd=i(Si);sm=s(Nd,"MobileBertTokenizerFast"),Nd.forEach(t),ka.forEach(t),Dd=h(o),rt=a(o,"DIV",{class:!0});var Bt=i(rt);y(ms.$$.fragment,Bt),rm=h(Bt),hs=a(Bt,"P",{});var va=i(hs);am=s(va,"Construct a \u201Cfast\u201D MobileBERT tokenizer (backed by HuggingFace\u2019s "),Ai=a(va,"EM",{});var Od=i(Ai);im=s(Od,"tokenizers"),Od.forEach(t),lm=s(va," library)."),va.forEach(t),dm=h(Bt),So=a(Bt,"P",{});var Sd=i(So);xa=a(Sd,"A",{href:!0});var qT=i(xa);cm=s(qT,"MobileBertTokenizerFast"),qT.forEach(t),pm=s(Sd," is identical to "),za=a(Sd,"A",{href:!0});var PT=i(za);mm=s(PT,"BertTokenizerFast"),PT.forEach(t),hm=s(Sd,` and runs end-to-end tokenization: punctuation
splitting and wordpiece.`),Sd.forEach(t),um=h(Bt),us=a(Bt,"P",{});var Mc=i(us);fm=s(Mc,"Refer to superclass "),qa=a(Mc,"A",{href:!0});var CT=i(qa);gm=s(CT,"BertTokenizerFast"),CT.forEach(t),_m=s(Mc," for usage examples and documentation concerning parameters."),Mc.forEach(t),Bt.forEach(t),Wd=h(o),Ht=a(o,"H2",{class:!0});var $c=i(Ht);Ao=a($c,"A",{id:!0,class:!0,href:!0});var jT=i(Ao);Ii=a(jT,"SPAN",{});var NT=i(Ii);y(fs.$$.fragment,NT),NT.forEach(t),jT.forEach(t),bm=h($c),Li=a($c,"SPAN",{});var OT=i(Li);Tm=s(OT,"MobileBert specific outputs"),OT.forEach(t),$c.forEach(t),Rd=h(o),Qt=a(o,"DIV",{class:!0});var Fc=i(Qt);y(gs.$$.fragment,Fc),km=h(Fc),_s=a(Fc,"P",{});var Bc=i(_s);vm=s(Bc,"Output type of "),Pa=a(Bc,"A",{href:!0});var ST=i(Pa);ym=s(ST,"MobileBertForPreTraining"),ST.forEach(t),wm=s(Bc,"."),Bc.forEach(t),Fc.forEach(t),Ud=h(o),Kt=a(o,"DIV",{class:!0});var Ec=i(Kt);y(bs.$$.fragment,Ec),Mm=h(Ec),Ts=a(Ec,"P",{});var xc=i(Ts);$m=s(xc,"Output type of "),Ca=a(xc,"A",{href:!0});var AT=i(Ca);Fm=s(AT,"TFMobileBertForPreTraining"),AT.forEach(t),Bm=s(xc,"."),xc.forEach(t),Ec.forEach(t),Hd=h(o),Vt=a(o,"H2",{class:!0});var zc=i(Vt);Io=a(zc,"A",{id:!0,class:!0,href:!0});var IT=i(Io);Di=a(IT,"SPAN",{});var LT=i(Di);y(ks.$$.fragment,LT),LT.forEach(t),IT.forEach(t),Em=h(zc),Wi=a(zc,"SPAN",{});var DT=i(Wi);xm=s(DT,"MobileBertModel"),DT.forEach(t),zc.forEach(t),Qd=h(o),je=a(o,"DIV",{class:!0});var ft=i(je);y(vs.$$.fragment,ft),zm=h(ft),Ri=a(ft,"P",{});var WT=i(Ri);qm=s(WT,"The bare MobileBert Model transformer outputting raw hidden-states without any specific head on top."),WT.forEach(t),Pm=h(ft),ys=a(ft,"P",{});var qc=i(ys);Cm=s(qc,"This model inherits from "),ja=a(qc,"A",{href:!0});var RT=i(ja);jm=s(RT,"PreTrainedModel"),RT.forEach(t),Nm=s(qc,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),qc.forEach(t),Om=h(ft),ws=a(ft,"P",{});var Pc=i(ws);Sm=s(Pc,"This model is also a PyTorch "),Ms=a(Pc,"A",{href:!0,rel:!0});var UT=i(Ms);Am=s(UT,"torch.nn.Module"),UT.forEach(t),Im=s(Pc,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Pc.forEach(t),Lm=h(ft),Ui=a(ft,"P",{});var HT=i(Ui);$s=a(HT,"A",{href:!0,rel:!0});var QT=i($s);Dm=s(QT,"https://arxiv.org/pdf/2004.02984.pdf"),QT.forEach(t),HT.forEach(t),Wm=h(ft),it=a(ft,"DIV",{class:!0});var Xn=i(it);y(Fs.$$.fragment,Xn),Rm=h(Xn),Gt=a(Xn,"P",{});var mi=i(Gt);Um=s(mi,"The "),Na=a(mi,"A",{href:!0});var KT=i(Na);Hm=s(KT,"MobileBertModel"),KT.forEach(t),Qm=s(mi," forward method, overrides the "),Hi=a(mi,"CODE",{});var VT=i(Hi);Km=s(VT,"__call__"),VT.forEach(t),Vm=s(mi," special method."),mi.forEach(t),Gm=h(Xn),y(Lo.$$.fragment,Xn),Ym=h(Xn),y(Do.$$.fragment,Xn),Xn.forEach(t),ft.forEach(t),Kd=h(o),Yt=a(o,"H2",{class:!0});var Cc=i(Yt);Wo=a(Cc,"A",{id:!0,class:!0,href:!0});var GT=i(Wo);Qi=a(GT,"SPAN",{});var YT=i(Qi);y(Bs.$$.fragment,YT),YT.forEach(t),GT.forEach(t),Jm=h(Cc),Ki=a(Cc,"SPAN",{});var JT=i(Ki);Zm=s(JT,"MobileBertForPreTraining"),JT.forEach(t),Cc.forEach(t),Vd=h(o),Re=a(o,"DIV",{class:!0});var Et=i(Re);y(Es.$$.fragment,Et),Xm=h(Et),Jt=a(Et,"P",{});var hi=i(Jt);eh=s(hi,"MobileBert Model with two heads on top as done during the pretraining: a "),Vi=a(hi,"CODE",{});var ZT=i(Vi);th=s(ZT,"masked language modeling"),ZT.forEach(t),oh=s(hi,` head and a
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),jc.forEach(t),dh=h(Et),zs=a(Et,"P",{});var Nc=i(zs);ch=s(Nc,"This model is also a PyTorch "),qs=a(Nc,"A",{href:!0,rel:!0});var tk=i(qs);ph=s(tk,"torch.nn.Module"),tk.forEach(t),mh=s(Nc,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Nc.forEach(t),hh=h(Et),lt=a(Et,"DIV",{class:!0});var es=i(lt);y(Ps.$$.fragment,es),uh=h(es),Zt=a(es,"P",{});var ui=i(Zt);fh=s(ui,"The "),Sa=a(ui,"A",{href:!0});var ok=i(Sa);gh=s(ok,"MobileBertForPreTraining"),ok.forEach(t),_h=s(ui," forward method, overrides the "),Yi=a(ui,"CODE",{});var nk=i(Yi);bh=s(nk,"__call__"),nk.forEach(t),Th=s(ui," special method."),ui.forEach(t),kh=h(es),y(Ro.$$.fragment,es),vh=h(es),y(Uo.$$.fragment,es),es.forEach(t),Et.forEach(t),Gd=h(o),Xt=a(o,"H2",{class:!0});var Oc=i(Xt);Ho=a(Oc,"A",{id:!0,class:!0,href:!0});var sk=i(Ho);Ji=a(sk,"SPAN",{});var rk=i(Ji);y(Cs.$$.fragment,rk),rk.forEach(t),sk.forEach(t),yh=h(Oc),Zi=a(Oc,"SPAN",{});var ak=i(Zi);wh=s(ak,"MobileBertForMaskedLM"),ak.forEach(t),Oc.forEach(t),Yd=h(o),Ue=a(o,"DIV",{class:!0});var xt=i(Ue);y(js.$$.fragment,xt),Mh=h(xt),Ns=a(xt,"P",{});var Sc=i(Ns);$h=s(Sc,"MobileBert Model with a "),Xi=a(Sc,"CODE",{});var ik=i(Xi);Fh=s(ik,"language modeling"),ik.forEach(t),Bh=s(Sc," head on top."),Sc.forEach(t),Eh=h(xt),Os=a(xt,"P",{});var Ac=i(Os);xh=s(Ac,"This model inherits from "),Aa=a(Ac,"A",{href:!0});var lk=i(Aa);zh=s(lk,"PreTrainedModel"),lk.forEach(t),qh=s(Ac,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Ac.forEach(t),Ph=h(xt),Ss=a(xt,"P",{});var Ic=i(Ss);Ch=s(Ic,"This model is also a PyTorch "),As=a(Ic,"A",{href:!0,rel:!0});var dk=i(As);jh=s(dk,"torch.nn.Module"),dk.forEach(t),Nh=s(Ic,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Ic.forEach(t),Oh=h(xt),Ye=a(xt,"DIV",{class:!0});var zt=i(Ye);y(Is.$$.fragment,zt),Sh=h(zt),eo=a(zt,"P",{});var fi=i(eo);Ah=s(fi,"The "),Ia=a(fi,"A",{href:!0});var ck=i(Ia);Ih=s(ck,"MobileBertForMaskedLM"),ck.forEach(t),Lh=s(fi," forward method, overrides the "),el=a(fi,"CODE",{});var pk=i(el);Dh=s(pk,"__call__"),pk.forEach(t),Wh=s(fi," special method."),fi.forEach(t),Rh=h(zt),y(Qo.$$.fragment,zt),Uh=h(zt),y(Ko.$$.fragment,zt),Hh=h(zt),y(Vo.$$.fragment,zt),zt.forEach(t),xt.forEach(t),Jd=h(o),to=a(o,"H2",{class:!0});var Lc=i(to);Go=a(Lc,"A",{id:!0,class:!0,href:!0});var mk=i(Go);tl=a(mk,"SPAN",{});var hk=i(tl);y(Ls.$$.fragment,hk),hk.forEach(t),mk.forEach(t),Qh=h(Lc),ol=a(Lc,"SPAN",{});var uk=i(ol);Kh=s(uk,"MobileBertForNextSentencePrediction"),uk.forEach(t),Lc.forEach(t),Zd=h(o),He=a(o,"DIV",{class:!0});var qt=i(He);y(Ds.$$.fragment,qt),Vh=h(qt),Ws=a(qt,"P",{});var Dc=i(Ws);Gh=s(Dc,"MobileBert Model with a "),nl=a(Dc,"CODE",{});var fk=i(nl);Yh=s(fk,"next sentence prediction (classification)"),fk.forEach(t),Jh=s(Dc," head on top."),Dc.forEach(t),Zh=h(qt),Rs=a(qt,"P",{});var Wc=i(Rs);Xh=s(Wc,"This model inherits from "),La=a(Wc,"A",{href:!0});var gk=i(La);eu=s(gk,"PreTrainedModel"),gk.forEach(t),tu=s(Wc,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Wc.forEach(t),ou=h(qt),Us=a(qt,"P",{});var Rc=i(Us);nu=s(Rc,"This model is also a PyTorch "),Hs=a(Rc,"A",{href:!0,rel:!0});var _k=i(Hs);su=s(_k,"torch.nn.Module"),_k.forEach(t),ru=s(Rc,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Rc.forEach(t),au=h(qt),dt=a(qt,"DIV",{class:!0});var ts=i(dt);y(Qs.$$.fragment,ts),iu=h(ts),oo=a(ts,"P",{});var gi=i(oo);lu=s(gi,"The "),Da=a(gi,"A",{href:!0});var bk=i(Da);du=s(bk,"MobileBertForNextSentencePrediction"),bk.forEach(t),cu=s(gi," forward method, overrides the "),sl=a(gi,"CODE",{});var Tk=i(sl);pu=s(Tk,"__call__"),Tk.forEach(t),mu=s(gi," special method."),gi.forEach(t),hu=h(ts),y(Yo.$$.fragment,ts),uu=h(ts),y(Jo.$$.fragment,ts),ts.forEach(t),qt.forEach(t),Xd=h(o),no=a(o,"H2",{class:!0});var Uc=i(no);Zo=a(Uc,"A",{id:!0,class:!0,href:!0});var kk=i(Zo);rl=a(kk,"SPAN",{});var vk=i(rl);y(Ks.$$.fragment,vk),vk.forEach(t),kk.forEach(t),fu=h(Uc),al=a(Uc,"SPAN",{});var yk=i(al);gu=s(yk,"MobileBertForSequenceClassification"),yk.forEach(t),Uc.forEach(t),ec=h(o),Qe=a(o,"DIV",{class:!0});var Pt=i(Qe);y(Vs.$$.fragment,Pt),_u=h(Pt),il=a(Pt,"P",{});var wk=i(il);bu=s(wk,`MobileBert Model transformer with a sequence classification/regression head on top (a linear layer on top of the
pooled output) e.g. for GLUE tasks.`),wk.forEach(t),Tu=h(Pt),Gs=a(Pt,"P",{});var Hc=i(Gs);ku=s(Hc,"This model inherits from "),Wa=a(Hc,"A",{href:!0});var Mk=i(Wa);vu=s(Mk,"PreTrainedModel"),Mk.forEach(t),yu=s(Hc,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Hc.forEach(t),wu=h(Pt),Ys=a(Pt,"P",{});var Qc=i(Ys);Mu=s(Qc,"This model is also a PyTorch "),Js=a(Qc,"A",{href:!0,rel:!0});var $k=i(Js);$u=s($k,"torch.nn.Module"),$k.forEach(t),Fu=s(Qc,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Qc.forEach(t),Bu=h(Pt),Ce=a(Pt,"DIV",{class:!0});var nt=i(Ce);y(Zs.$$.fragment,nt),Eu=h(nt),so=a(nt,"P",{});var _i=i(so);xu=s(_i,"The "),Ra=a(_i,"A",{href:!0});var Fk=i(Ra);zu=s(Fk,"MobileBertForSequenceClassification"),Fk.forEach(t),qu=s(_i," forward method, overrides the "),ll=a(_i,"CODE",{});var Bk=i(ll);Pu=s(Bk,"__call__"),Bk.forEach(t),Cu=s(_i," special method."),_i.forEach(t),ju=h(nt),y(Xo.$$.fragment,nt),Nu=h(nt),y(en.$$.fragment,nt),Ou=h(nt),y(tn.$$.fragment,nt),Su=h(nt),y(on.$$.fragment,nt),Au=h(nt),y(nn.$$.fragment,nt),nt.forEach(t),Pt.forEach(t),tc=h(o),ro=a(o,"H2",{class:!0});var Kc=i(ro);sn=a(Kc,"A",{id:!0,class:!0,href:!0});var Ek=i(sn);dl=a(Ek,"SPAN",{});var xk=i(dl);y(Xs.$$.fragment,xk),xk.forEach(t),Ek.forEach(t),Iu=h(Kc),cl=a(Kc,"SPAN",{});var zk=i(cl);Lu=s(zk,"MobileBertForMultipleChoice"),zk.forEach(t),Kc.forEach(t),oc=h(o),Ke=a(o,"DIV",{class:!0});var Ct=i(Ke);y(er.$$.fragment,Ct),Du=h(Ct),pl=a(Ct,"P",{});var qk=i(pl);Wu=s(qk,`MobileBert Model with a multiple choice classification head on top (a linear layer on top of the pooled output and
a softmax) e.g. for RocStories/SWAG tasks.`),qk.forEach(t),Ru=h(Ct),tr=a(Ct,"P",{});var Vc=i(tr);Uu=s(Vc,"This model inherits from "),Ua=a(Vc,"A",{href:!0});var Pk=i(Ua);Hu=s(Pk,"PreTrainedModel"),Pk.forEach(t),Qu=s(Vc,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Vc.forEach(t),Ku=h(Ct),or=a(Ct,"P",{});var Gc=i(or);Vu=s(Gc,"This model is also a PyTorch "),nr=a(Gc,"A",{href:!0,rel:!0});var Ck=i(nr);Gu=s(Ck,"torch.nn.Module"),Ck.forEach(t),Yu=s(Gc,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Gc.forEach(t),Ju=h(Ct),ct=a(Ct,"DIV",{class:!0});var os=i(ct);y(sr.$$.fragment,os),Zu=h(os),ao=a(os,"P",{});var bi=i(ao);Xu=s(bi,"The "),Ha=a(bi,"A",{href:!0});var jk=i(Ha);ef=s(jk,"MobileBertForMultipleChoice"),jk.forEach(t),tf=s(bi," forward method, overrides the "),ml=a(bi,"CODE",{});var Nk=i(ml);of=s(Nk,"__call__"),Nk.forEach(t),nf=s(bi," special method."),bi.forEach(t),sf=h(os),y(rn.$$.fragment,os),rf=h(os),y(an.$$.fragment,os),os.forEach(t),Ct.forEach(t),nc=h(o),io=a(o,"H2",{class:!0});var Yc=i(io);ln=a(Yc,"A",{id:!0,class:!0,href:!0});var Ok=i(ln);hl=a(Ok,"SPAN",{});var Sk=i(hl);y(rr.$$.fragment,Sk),Sk.forEach(t),Ok.forEach(t),af=h(Yc),ul=a(Yc,"SPAN",{});var Ak=i(ul);lf=s(Ak,"MobileBertForTokenClassification"),Ak.forEach(t),Yc.forEach(t),sc=h(o),Ve=a(o,"DIV",{class:!0});var jt=i(Ve);y(ar.$$.fragment,jt),df=h(jt),fl=a(jt,"P",{});var Ik=i(fl);cf=s(Ik,`MobileBert Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g.
for Named-Entity-Recognition (NER) tasks.`),Ik.forEach(t),pf=h(jt),ir=a(jt,"P",{});var Jc=i(ir);mf=s(Jc,"This model inherits from "),Qa=a(Jc,"A",{href:!0});var Lk=i(Qa);hf=s(Lk,"PreTrainedModel"),Lk.forEach(t),uf=s(Jc,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Jc.forEach(t),ff=h(jt),lr=a(jt,"P",{});var Zc=i(lr);gf=s(Zc,"This model is also a PyTorch "),dr=a(Zc,"A",{href:!0,rel:!0});var Dk=i(dr);_f=s(Dk,"torch.nn.Module"),Dk.forEach(t),bf=s(Zc,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Zc.forEach(t),Tf=h(jt),Je=a(jt,"DIV",{class:!0});var Nt=i(Je);y(cr.$$.fragment,Nt),kf=h(Nt),lo=a(Nt,"P",{});var Ti=i(lo);vf=s(Ti,"The "),Ka=a(Ti,"A",{href:!0});var Wk=i(Ka);yf=s(Wk,"MobileBertForTokenClassification"),Wk.forEach(t),wf=s(Ti," forward method, overrides the "),gl=a(Ti,"CODE",{});var Rk=i(gl);Mf=s(Rk,"__call__"),Rk.forEach(t),$f=s(Ti," special method."),Ti.forEach(t),Ff=h(Nt),y(dn.$$.fragment,Nt),Bf=h(Nt),y(cn.$$.fragment,Nt),Ef=h(Nt),y(pn.$$.fragment,Nt),Nt.forEach(t),jt.forEach(t),rc=h(o),co=a(o,"H2",{class:!0});var Xc=i(co);mn=a(Xc,"A",{id:!0,class:!0,href:!0});var Uk=i(mn);_l=a(Uk,"SPAN",{});var Hk=i(_l);y(pr.$$.fragment,Hk),Hk.forEach(t),Uk.forEach(t),xf=h(Xc),bl=a(Xc,"SPAN",{});var Qk=i(bl);zf=s(Qk,"MobileBertForQuestionAnswering"),Qk.forEach(t),Xc.forEach(t),ac=h(o),Ge=a(o,"DIV",{class:!0});var Ot=i(Ge);y(mr.$$.fragment,Ot),qf=h(Ot),po=a(Ot,"P",{});var ki=i(po);Pf=s(ki,`MobileBert Model with a span classification head on top for extractive question-answering tasks like SQuAD (a
linear layers on top of the hidden-states output to compute `),Tl=a(ki,"CODE",{});var Kk=i(Tl);Cf=s(Kk,"span start logits"),Kk.forEach(t),jf=s(ki," and "),kl=a(ki,"CODE",{});var Vk=i(kl);Nf=s(Vk,"span end logits"),Vk.forEach(t),Of=s(ki,")."),ki.forEach(t),Sf=h(Ot),hr=a(Ot,"P",{});var ep=i(hr);Af=s(ep,"This model inherits from "),Va=a(ep,"A",{href:!0});var Gk=i(Va);If=s(Gk,"PreTrainedModel"),Gk.forEach(t),Lf=s(ep,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),ep.forEach(t),Df=h(Ot),ur=a(Ot,"P",{});var tp=i(ur);Wf=s(tp,"This model is also a PyTorch "),fr=a(tp,"A",{href:!0,rel:!0});var Yk=i(fr);Rf=s(Yk,"torch.nn.Module"),Yk.forEach(t),Uf=s(tp,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),tp.forEach(t),Hf=h(Ot),Ze=a(Ot,"DIV",{class:!0});var St=i(Ze);y(gr.$$.fragment,St),Qf=h(St),mo=a(St,"P",{});var vi=i(mo);Kf=s(vi,"The "),Ga=a(vi,"A",{href:!0});var Jk=i(Ga);Vf=s(Jk,"MobileBertForQuestionAnswering"),Jk.forEach(t),Gf=s(vi," forward method, overrides the "),vl=a(vi,"CODE",{});var Zk=i(vl);Yf=s(Zk,"__call__"),Zk.forEach(t),Jf=s(vi," special method."),vi.forEach(t),Zf=h(St),y(hn.$$.fragment,St),Xf=h(St),y(un.$$.fragment,St),eg=h(St),y(fn.$$.fragment,St),St.forEach(t),Ot.forEach(t),ic=h(o),ho=a(o,"H2",{class:!0});var op=i(ho);gn=a(op,"A",{id:!0,class:!0,href:!0});var Xk=i(gn);yl=a(Xk,"SPAN",{});var ev=i(yl);y(_r.$$.fragment,ev),ev.forEach(t),Xk.forEach(t),tg=h(op),wl=a(op,"SPAN",{});var tv=i(wl);og=s(tv,"TFMobileBertModel"),tv.forEach(t),op.forEach(t),lc=h(o),Ne=a(o,"DIV",{class:!0});var gt=i(Ne);y(br.$$.fragment,gt),ng=h(gt),Ml=a(gt,"P",{});var ov=i(Ml);sg=s(ov,"The bare MobileBert Model transformer outputting raw hidden-states without any specific head on top."),ov.forEach(t),rg=h(gt),Tr=a(gt,"P",{});var np=i(Tr);ag=s(np,"This model inherits from "),Ya=a(np,"A",{href:!0});var nv=i(Ya);ig=s(nv,"TFPreTrainedModel"),nv.forEach(t),lg=s(np,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),sp.forEach(t),hg=h(gt),y(_n.$$.fragment,gt),ug=h(gt),pt=a(gt,"DIV",{class:!0});var ns=i(pt);y(yr.$$.fragment,ns),fg=h(ns),uo=a(ns,"P",{});var yi=i(uo);gg=s(yi,"The "),Ja=a(yi,"A",{href:!0});var rv=i(Ja);_g=s(rv,"TFMobileBertModel"),rv.forEach(t),bg=s(yi," forward method, overrides the "),$l=a(yi,"CODE",{});var av=i($l);Tg=s(av,"__call__"),av.forEach(t),kg=s(yi," special method."),yi.forEach(t),vg=h(ns),y(bn.$$.fragment,ns),yg=h(ns),y(Tn.$$.fragment,ns),ns.forEach(t),gt.forEach(t),dc=h(o),fo=a(o,"H2",{class:!0});var rp=i(fo);kn=a(rp,"A",{id:!0,class:!0,href:!0});var iv=i(kn);Fl=a(iv,"SPAN",{});var lv=i(Fl);y(wr.$$.fragment,lv),lv.forEach(t),iv.forEach(t),wg=h(rp),Bl=a(rp,"SPAN",{});var dv=i(Bl);Mg=s(dv,"TFMobileBertForPreTraining"),dv.forEach(t),rp.forEach(t),cc=h(o),Oe=a(o,"DIV",{class:!0});var _t=i(Oe);y(Mr.$$.fragment,_t),$g=h(_t),go=a(_t,"P",{});var wi=i(go);Fg=s(wi,"MobileBert Model with two heads on top as done during the pretraining: a "),El=a(wi,"CODE",{});var cv=i(El);Bg=s(cv,"masked language modeling"),cv.forEach(t),Eg=s(wi,` head and a
`),xl=a(wi,"CODE",{});var pv=i(xl);xg=s(pv,"next sentence prediction (classification)"),pv.forEach(t),zg=s(wi," head."),wi.forEach(t),qg=h(_t),$r=a(_t,"P",{});var ap=i($r);Pg=s(ap,"This model inherits from "),Za=a(ap,"A",{href:!0});var mv=i(Za);Cg=s(mv,"TFPreTrainedModel"),mv.forEach(t),jg=s(ap,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),ip.forEach(t),Ig=h(_t),y(vn.$$.fragment,_t),Lg=h(_t),mt=a(_t,"DIV",{class:!0});var ss=i(mt);y(Er.$$.fragment,ss),Dg=h(ss),_o=a(ss,"P",{});var Mi=i(_o);Wg=s(Mi,"The "),Xa=a(Mi,"A",{href:!0});var uv=i(Xa);Rg=s(uv,"TFMobileBertForPreTraining"),uv.forEach(t),Ug=s(Mi," forward method, overrides the "),zl=a(Mi,"CODE",{});var fv=i(zl);Hg=s(fv,"__call__"),fv.forEach(t),Qg=s(Mi," special method."),Mi.forEach(t),Kg=h(ss),y(yn.$$.fragment,ss),Vg=h(ss),y(wn.$$.fragment,ss),ss.forEach(t),_t.forEach(t),pc=h(o),bo=a(o,"H2",{class:!0});var lp=i(bo);Mn=a(lp,"A",{id:!0,class:!0,href:!0});var gv=i(Mn);ql=a(gv,"SPAN",{});var _v=i(ql);y(xr.$$.fragment,_v),_v.forEach(t),gv.forEach(t),Gg=h(lp),Pl=a(lp,"SPAN",{});var bv=i(Pl);Yg=s(bv,"TFMobileBertForMaskedLM"),bv.forEach(t),lp.forEach(t),mc=h(o),Se=a(o,"DIV",{class:!0});var bt=i(Se);y(zr.$$.fragment,bt),Jg=h(bt),qr=a(bt,"P",{});var dp=i(qr);Zg=s(dp,"MobileBert Model with a "),Cl=a(dp,"CODE",{});var Tv=i(Cl);Xg=s(Tv,"language modeling"),Tv.forEach(t),e_=s(dp," head on top."),dp.forEach(t),t_=h(bt),Pr=a(bt,"P",{});var cp=i(Pr);o_=s(cp,"This model inherits from "),ei=a(cp,"A",{href:!0});var kv=i(ei);n_=s(kv,"TFPreTrainedModel"),kv.forEach(t),s_=s(cp,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),pp.forEach(t),d_=h(bt),y($n.$$.fragment,bt),c_=h(bt),Xe=a(bt,"DIV",{class:!0});var At=i(Xe);y(Nr.$$.fragment,At),p_=h(At),To=a(At,"P",{});var $i=i(To);m_=s($i,"The "),ti=a($i,"A",{href:!0});var yv=i(ti);h_=s(yv,"TFMobileBertForMaskedLM"),yv.forEach(t),u_=s($i," forward method, overrides the "),jl=a($i,"CODE",{});var wv=i(jl);f_=s(wv,"__call__"),wv.forEach(t),g_=s($i," special method."),$i.forEach(t),__=h(At),y(Fn.$$.fragment,At),b_=h(At),y(Bn.$$.fragment,At),T_=h(At),y(En.$$.fragment,At),At.forEach(t),bt.forEach(t),hc=h(o),ko=a(o,"H2",{class:!0});var mp=i(ko);xn=a(mp,"A",{id:!0,class:!0,href:!0});var Mv=i(xn);Nl=a(Mv,"SPAN",{});var $v=i(Nl);y(Or.$$.fragment,$v),$v.forEach(t),Mv.forEach(t),k_=h(mp),Ol=a(mp,"SPAN",{});var Fv=i(Ol);v_=s(Fv,"TFMobileBertForNextSentencePrediction"),Fv.forEach(t),mp.forEach(t),uc=h(o),Ae=a(o,"DIV",{class:!0});var Tt=i(Ae);y(Sr.$$.fragment,Tt),y_=h(Tt),Ar=a(Tt,"P",{});var hp=i(Ar);w_=s(hp,"MobileBert Model with a "),Sl=a(hp,"CODE",{});var Bv=i(Sl);M_=s(Bv,"next sentence prediction (classification)"),Bv.forEach(t),$_=s(hp," head on top."),hp.forEach(t),F_=h(Tt),Ir=a(Tt,"P",{});var up=i(Ir);B_=s(up,"This model inherits from "),oi=a(up,"A",{href:!0});var Ev=i(oi);E_=s(Ev,"TFPreTrainedModel"),Ev.forEach(t),x_=s(up,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),up.forEach(t),z_=h(Tt),Lr=a(Tt,"P",{});var fp=i(Lr);q_=s(fp,"This model is also a "),Dr=a(fp,"A",{href:!0,rel:!0});var xv=i(Dr);P_=s(xv,"tf.keras.Model"),xv.forEach(t),C_=s(fp,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),fp.forEach(t),j_=h(Tt),y(zn.$$.fragment,Tt),N_=h(Tt),ht=a(Tt,"DIV",{class:!0});var rs=i(ht);y(Wr.$$.fragment,rs),O_=h(rs),vo=a(rs,"P",{});var Fi=i(vo);S_=s(Fi,"The "),ni=a(Fi,"A",{href:!0});var zv=i(ni);A_=s(zv,"TFMobileBertForNextSentencePrediction"),zv.forEach(t),I_=s(Fi," forward method, overrides the "),Al=a(Fi,"CODE",{});var qv=i(Al);L_=s(qv,"__call__"),qv.forEach(t),D_=s(Fi," special method."),Fi.forEach(t),W_=h(rs),y(qn.$$.fragment,rs),R_=h(rs),y(Pn.$$.fragment,rs),rs.forEach(t),Tt.forEach(t),fc=h(o),yo=a(o,"H2",{class:!0});var gp=i(yo);Cn=a(gp,"A",{id:!0,class:!0,href:!0});var Pv=i(Cn);Il=a(Pv,"SPAN",{});var Cv=i(Il);y(Rr.$$.fragment,Cv),Cv.forEach(t),Pv.forEach(t),U_=h(gp),Ll=a(gp,"SPAN",{});var jv=i(Ll);H_=s(jv,"TFMobileBertForSequenceClassification"),jv.forEach(t),gp.forEach(t),gc=h(o),Ie=a(o,"DIV",{class:!0});var kt=i(Ie);y(Ur.$$.fragment,kt),Q_=h(kt),Dl=a(kt,"P",{});var Nv=i(Dl);K_=s(Nv,`MobileBert Model transformer with a sequence classification/regression head on top (a linear layer on top of the
