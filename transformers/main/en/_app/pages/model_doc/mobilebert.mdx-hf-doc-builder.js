import{S as pv,i as mv,s as hv,e as r,k as m,w as y,t as n,M as uv,c as a,d as t,m as h,a as i,x as v,h as s,b,G as e,g,y as w,q as M,o as $,B as F,v as fv,L as xe}from"../../chunks/vendor-hf-doc-builder.js";import{T as Pe}from"../../chunks/Tip-hf-doc-builder.js";import{D as ie}from"../../chunks/Docstring-hf-doc-builder.js";import{C as ze}from"../../chunks/CodeBlock-hf-doc-builder.js";import{I as qe}from"../../chunks/IconCopyLink-hf-doc-builder.js";import{E as Ee}from"../../chunks/ExampleCodeBlock-hf-doc-builder.js";function gv(E){let d,_,c,p,T;return p=new ze({props:{code:`from transformers import MobileBertModel, MobileBertConfig
...
<span class="hljs-meta">&gt;&gt;&gt; </span>configuration = model.config`}}),{c(){d=r("p"),_=n("Examples:"),c=m(),y(p.$$.fragment)},l(l){d=a(l,"P",{});var u=i(d);_=s(u,"Examples:"),u.forEach(t),c=h(l),v(p.$$.fragment,l)},m(l,u){g(l,d,u),e(d,_),g(l,c,u),w(p,l,u),T=!0},p:xe,i(l){T||(M(p.$$.fragment,l),T=!0)},o(l){$(p.$$.fragment,l),T=!1},d(l){l&&t(d),l&&t(c),F(p,l)}}}function _v(E){let d,_,c,p,T;return{c(){d=r("p"),_=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),c=r("code"),p=n("Module"),T=n(`
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),{c(){d=r("p"),_=n("Example:"),c=m(),y(p.$$.fragment)},l(l){d=a(l,"P",{});var u=i(d);_=s(u,"Example:"),u.forEach(t),c=h(l),v(p.$$.fragment,l)},m(l,u){g(l,d,u),e(d,_),g(l,c,u),w(p,l,u),T=!0},p:xe,i(l){T||(M(p.$$.fragment,l),T=!0)},o(l){$(p.$$.fragment,l),T=!1},d(l){l&&t(d),l&&t(c),F(p,l)}}}function Tv(E){let d,_,c,p,T;return{c(){d=r("p"),_=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),c=r("code"),p=n("Module"),T=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(l){d=a(l,"P",{});var u=i(d);_=s(u,"Although the recipe for forward pass needs to be defined within this function, one should call the "),c=a(u,"CODE",{});var x=i(c);p=s(x,"Module"),x.forEach(t),T=s(u,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
the latter silently ignores them.`)},l(l){d=a(l,"P",{});var u=i(d);_=s(u,"Although the recipe for forward pass needs to be defined within this function, one should call the "),c=a(u,"CODE",{});var x=i(c);p=s(x,"Module"),x.forEach(t),T=s(u,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),u.forEach(t)},m(l,u){g(l,d,u),e(d,_),e(d,c),e(c,p),e(d,T)},d(l){l&&t(d)}}}function vv(E){let d,_,c,p,T;return p=new ze({props:{code:`from transformers import MobileBertTokenizer, MobileBertForMaskedLM
import torch
...
<span class="hljs-meta">&gt;&gt;&gt; </span>predicted_class_id = logits.argmax().item()
<span class="hljs-meta">&gt;&gt;&gt; </span>model.config.id2label[predicted_class_id]
<span class="hljs-string">&#x27;others&#x27;</span>`}}),{c(){d=r("p"),_=n("Example of multi-label classification:"),c=m(),y(p.$$.fragment)},l(l){d=a(l,"P",{});var u=i(d);_=s(u,"Example of multi-label classification:"),u.forEach(t),c=h(l),v(p.$$.fragment,l)},m(l,u){g(l,d,u),e(d,_),g(l,c,u),w(p,l,u),T=!0},p:xe,i(l){T||(M(p.$$.fragment,l),T=!0)},o(l){$(p.$$.fragment,l),T=!1},d(l){l&&t(d),l&&t(c),F(p,l)}}}function zv(E){let d,_;return d=new ze({props:{code:`# To train a model on \`num_labels\` classes, you can pass \`num_labels=num_labels\` to \`.from_pretrained(...)\`
num_labels = len(model.config.id2label)
...
first positional argument :`),G=m(),P=r("ul"),j=r("li"),ne=n("a single Tensor with "),U=r("code"),de=n("input_ids"),se=n(" only and nothing else: "),W=r("code"),fe=n("model(inputs_ids)"),ce=m(),q=r("li"),ge=n(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
...
first positional argument :`),ke.forEach(t),G=h(f),P=a(f,"UL",{});var C=i(P);j=a(C,"LI",{});var I=i(j);ne=s(I,"a single Tensor with "),U=a(I,"CODE",{});var Fe=i(U);de=s(Fe,"input_ids"),Fe.forEach(t),se=s(I," only and nothing else: "),W=a(I,"CODE",{});var ve=i(W);fe=s(ve,"model(inputs_ids)"),ve.forEach(t),I.forEach(t),ce=h(C),q=a(C,"LI",{});var Q=i(q);ge=s(Q,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),{c(){d=r("p"),_=n("Example:"),c=m(),y(p.$$.fragment)},l(l){d=a(l,"P",{});var u=i(d);_=s(u,"Example:"),u.forEach(t),c=h(l),v(p.$$.fragment,l)},m(l,u){g(l,d,u),e(d,_),g(l,c,u),w(p,l,u),T=!0},p:xe,i(l){T||(M(p.$$.fragment,l),T=!0)},o(l){$(p.$$.fragment,l),T=!1},d(l){l&&t(d),l&&t(c),F(p,l)}}}function Wv(E){let d,_,c,p,T,l,u,x,me,V,z,J,L,X,he,D,ue,le,K,N,ee,G,P,j,ne,U,de,se,W,fe,ce,q,ge,R,Z,re,H,_e,ae,O,pe,A,be;return{c(){d=r("p"),_=n("TF 2.0 models accepts two formats as inputs:"),c=m(),p=r("ul"),T=r("li"),l=n("having all inputs as keyword arguments (like PyTorch models), or"),u=m(),x=r("li"),me=n("having all inputs as a list, tuple or dict in the first positional arguments."),V=m(),z=r("p"),J=n("This second option is useful when using "),L=r("code"),X=n("tf.keras.Model.fit"),he=n(` method which currently requires having all the
tensors in the first argument of the model call function: `),D=r("code"),ue=n("model(inputs)"),le=n("."),K=m(),N=r("p"),ee=n(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),G=m(),P=r("ul"),j=r("li"),ne=n("a single Tensor with "),U=r("code"),de=n("input_ids"),se=n(" only and nothing else: "),W=r("code"),fe=n("model(inputs_ids)"),ce=m(),q=r("li"),ge=n(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),R=r("code"),Z=n("model([input_ids, attention_mask])"),re=n(" or "),H=r("code"),_e=n("model([input_ids, attention_mask, token_type_ids])"),ae=m(),O=r("li"),pe=n(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),A=r("code"),be=n('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(f){d=a(f,"P",{});var B=i(d);_=s(B,"TF 2.0 models accepts two formats as inputs:"),B.forEach(t),c=h(f),p=a(f,"UL",{});var Y=i(p);T=a(Y,"LI",{});var ye=i(T);l=s(ye,"having all inputs as keyword arguments (like PyTorch models), or"),ye.forEach(t),u=h(Y),x=a(Y,"LI",{});var $e=i(x);me=s($e,"having all inputs as a list, tuple or dict in the first positional arguments."),$e.forEach(t),Y.forEach(t),V=h(f),z=a(f,"P",{});var S=i(z);J=s(S,"This second option is useful when using "),L=a(S,"CODE",{});var we=i(L);X=s(we,"tf.keras.Model.fit"),we.forEach(t),he=s(S,` method which currently requires having all the
...
<span class="hljs-number">0.57</span>`}}),{c(){y(d.$$.fragment)},l(c){v(d.$$.fragment,c)},m(c,p){w(d,c,p),_=!0},p:xe,i(c){_||(M(d.$$.fragment,c),_=!0)},o(c){$(d.$$.fragment,c),_=!1},d(c){F(d,c)}}}function Gv(E){let d,_,c,p,T,l,u,x,me,V,z,J,L,X,he,D,ue,le,K,N,ee,G,P,j,ne,U,de,se,W,fe,ce,q,ge,R,Z,re,H,_e,ae,O,pe,A,be;return{c(){d=r("p"),_=n("TF 2.0 models accepts two formats as inputs:"),c=m(),p=r("ul"),T=r("li"),l=n("having all inputs as keyword arguments (like PyTorch models), or"),u=m(),x=r("li"),me=n("having all inputs as a list, tuple or dict in the first positional arguments."),V=m(),z=r("p"),J=n("This second option is useful when using "),L=r("code"),X=n("tf.keras.Model.fit"),he=n(` method which currently requires having all the
tensors in the first argument of the model call function: `),D=r("code"),ue=n("model(inputs)"),le=n("."),K=m(),N=r("p"),ee=n(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),G=m(),P=r("ul"),j=r("li"),ne=n("a single Tensor with "),U=r("code"),de=n("input_ids"),se=n(" only and nothing else: "),W=r("code"),fe=n("model(inputs_ids)"),ce=m(),q=r("li"),ge=n(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),R=r("code"),Z=n("model([input_ids, attention_mask])"),re=n(" or "),H=r("code"),_e=n("model([input_ids, attention_mask, token_type_ids])"),ae=m(),O=r("li"),pe=n(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),A=r("code"),be=n('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(f){d=a(f,"P",{});var B=i(d);_=s(B,"TF 2.0 models accepts two formats as inputs:"),B.forEach(t),c=h(f),p=a(f,"UL",{});var Y=i(p);T=a(Y,"LI",{});var ye=i(T);l=s(ye,"having all inputs as keyword arguments (like PyTorch models), or"),ye.forEach(t),u=h(Y),x=a(Y,"LI",{});var $e=i(x);me=s($e,"having all inputs as a list, tuple or dict in the first positional arguments."),$e.forEach(t),Y.forEach(t),V=h(f),z=a(f,"P",{});var S=i(z);J=s(S,"This second option is useful when using "),L=a(S,"CODE",{});var we=i(L);X=s(we,"tf.keras.Model.fit"),we.forEach(t),he=s(S,` method which currently requires having all the
...
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-built_in">round</span>(<span class="hljs-built_in">float</span>(loss), <span class="hljs-number">2</span>)
<span class="hljs-number">3.98</span>`}}),{c(){y(d.$$.fragment)},l(c){v(d.$$.fragment,c)},m(c,p){w(d,c,p),_=!0},p:xe,i(c){_||(M(d.$$.fragment,c),_=!0)},o(c){$(d.$$.fragment,c),_=!1},d(c){F(d,c)}}}function hw(E){let d,_,c,p,T,l,u,x,me,V,z,J,L,X,he,D,ue,le,K,N,ee,G,P,j,ne,U,de,se,W,fe,ce,q,ge,R,Z,re,H,_e,ae,O,pe,A,be,f,B,Y,ye,$e,S,we,Te,ke,C,I,Fe,ve,Q,Me,te,oe,Be,Mt,Ep,va,xp,zp,wa,Pp,qp,is,jp,Cp,Np,Wt,Op,Ma,Sp,Ap,$a,Ip,Lp,Dp,jo,Wp,qi,Rp,Ad,Rt,Co,ji,ls,Up,Ci,Hp,Id,st,ds,Qp,Ni,Kp,Vp,No,Fa,Gp,Yp,Ba,Jp,Zp,Xp,cs,em,Ea,tm,om,Ld,Ut,Oo,Oi,ps,nm,Si,sm,Dd,rt,ms,rm,hs,am,Ai,im,lm,dm,So,xa,cm,pm,za,mm,hm,um,us,fm,Pa,gm,_m,Wd,Ht,Ao,Ii,fs,bm,Li,Tm,Rd,Qt,gs,km,_s,ym,qa,vm,wm,Ud,Kt,bs,Mm,Ts,$m,ja,Fm,Bm,Hd,Vt,Io,Di,ks,Em,Wi,xm,Qd,Ce,ys,zm,Ri,Pm,qm,vs,jm,Ca,Cm,Nm,Om,ws,Sm,Ms,Am,Im,Lm,Ui,$s,Dm,Wm,it,Fs,Rm,Gt,Um,Na,Hm,Qm,Hi,Km,Vm,Gm,Lo,Ym,Do,Kd,Yt,Wo,Qi,Bs,Jm,Ki,Zm,Vd,Re,Es,Xm,Jt,eh,Vi,th,oh,Gi,nh,sh,rh,xs,ah,Oa,ih,lh,dh,zs,ch,Ps,ph,mh,hh,lt,qs,uh,Zt,fh,Sa,gh,_h,Yi,bh,Th,kh,Ro,yh,Uo,Gd,Xt,Ho,Ji,js,vh,Zi,wh,Yd,Ue,Cs,Mh,Ns,$h,Xi,Fh,Bh,Eh,Os,xh,Aa,zh,Ph,qh,Ss,jh,As,Ch,Nh,Oh,Ye,Is,Sh,eo,Ah,Ia,Ih,Lh,el,Dh,Wh,Rh,Qo,Uh,Ko,Hh,Vo,Jd,to,Go,tl,Ls,Qh,ol,Kh,Zd,He,Ds,Vh,Ws,Gh,nl,Yh,Jh,Zh,Rs,Xh,La,eu,tu,ou,Us,nu,Hs,su,ru,au,dt,Qs,iu,oo,lu,Da,du,cu,sl,pu,mu,hu,Yo,uu,Jo,Xd,no,Zo,rl,Ks,fu,al,gu,ec,Qe,Vs,_u,il,bu,Tu,Gs,ku,Wa,yu,vu,wu,Ys,Mu,Js,$u,Fu,Bu,je,Zs,Eu,so,xu,Ra,zu,Pu,ll,qu,ju,Cu,Xo,Nu,en,Ou,tn,Su,on,Au,nn,tc,ro,sn,dl,Xs,Iu,cl,Lu,oc,Ke,er,Du,pl,Wu,Ru,tr,Uu,Ua,Hu,Qu,Ku,or,Vu,nr,Gu,Yu,Ju,ct,sr,Zu,ao,Xu,Ha,ef,tf,ml,of,nf,sf,rn,rf,an,nc,io,ln,hl,rr,af,ul,lf,sc,Ve,ar,df,fl,cf,pf,ir,mf,Qa,hf,uf,ff,lr,gf,dr,_f,bf,Tf,Je,cr,kf,lo,yf,Ka,vf,wf,gl,Mf,$f,Ff,dn,Bf,cn,Ef,pn,rc,co,mn,_l,pr,xf,bl,zf,ac,Ge,mr,Pf,po,qf,Tl,jf,Cf,kl,Nf,Of,Sf,hr,Af,Va,If,Lf,Df,ur,Wf,fr,Rf,Uf,Hf,Ze,gr,Qf,mo,Kf,Ga,Vf,Gf,yl,Yf,Jf,Zf,hn,Xf,un,eg,fn,ic,ho,gn,vl,_r,tg,wl,og,lc,Ne,br,ng,Ml,sg,rg,Tr,ag,Ya,ig,lg,dg,kr,cg,yr,pg,mg,hg,_n,ug,pt,vr,fg,uo,gg,Ja,_g,bg,$l,Tg,kg,yg,bn,vg,Tn,dc,fo,kn,Fl,wr,wg,Bl,Mg,cc,Oe,Mr,$g,go,Fg,El,Bg,Eg,xl,xg,zg,Pg,$r,qg,Za,jg,Cg,Ng,Fr,Og,Br,Sg,Ag,Ig,yn,Lg,mt,Er,Dg,_o,Wg,Xa,Rg,Ug,zl,Hg,Qg,Kg,vn,Vg,wn,pc,bo,Mn,Pl,xr,Gg,ql,Yg,mc,Se,zr,Jg,Pr,Zg,jl,Xg,e_,t_,qr,o_,ei,n_,s_,r_,jr,a_,Cr,i_,l_,d_,$n,c_,Xe,Nr,p_,To,m_,ti,h_,u_,Cl,f_,g_,__,Fn,b_,Bn,T_,En,hc,ko,xn,Nl,Or,k_,Ol,y_,uc,Ae,Sr,v_,Ar,w_,Sl,M_,$_,F_,Ir,B_,oi,E_,x_,z_,Lr,P_,Dr,q_,j_,C_,zn,N_,ht,Wr,O_,yo,S_,ni,A_,I_,Al,L_,D_,W_,Pn,R_,qn,fc,vo,jn,Il,Rr,U_,Ll,H_,gc,Ie,Ur,Q_,Dl,K_,V_,Hr,G_,si,Y_,J_,Z_,Qr,X_,Kr,eb,tb,ob,Cn,nb,et,Vr,sb,wo,rb,ri,ab,ib,Wl,lb,db,cb,Nn,pb,On,mb,Sn,_c,Mo,An,Rl,Gr,hb,Ul,ub,bc,Le,Yr,fb,Hl,gb,_b,Jr,bb,ai,Tb,kb,yb,Zr,vb,Xr,wb,Mb,$b,In,Fb,ut,ea,Bb,$o,Eb,ii,xb,zb,Ql,Pb,qb,jb,Ln,Cb,Dn,Tc,Fo,Wn,Kl,ta,Nb,Vl,Ob,kc,De,oa,Sb,Gl,Ab,Ib,na,Lb,li,Db,Wb,Rb,sa,Ub,ra,Hb,Qb,Kb,Rn,Vb,tt,aa,Gb,Bo,Yb,di,Jb,Zb,Yl,Xb,eT,tT,Un,oT,Hn,nT,Qn,yc,Eo,Kn,Jl,ia,sT,Zl,rT,vc,We,la,aT,xo,iT,Xl,lT,dT,ed,cT,pT,mT,da,hT,ci,uT,fT,gT,ca,_T,pa,bT,TT,kT,Vn,yT,ot,ma,vT,zo,wT,pi,MT,$T,td,FT,BT,ET,Gn,xT,Yn,zT,Jn,wc;return l=new qe({}),X=new qe({}),I=new qe({}),oe=new ie({props:{name:"class transformers.MobileBertConfig",anchor:"transformers.MobileBertConfig",parameters:[{name:"vocab_size",val:" = 30522"},{name:"hidden_size",val:" = 512"},{name:"num_hidden_layers",val:" = 24"},{name:"num_attention_heads",val:" = 4"},{name:"intermediate_size",val:" = 512"},{name:"hidden_act",val:" = 'relu'"},{name:"hidden_dropout_prob",val:" = 0.0"},{name:"attention_probs_dropout_prob",val:" = 0.1"},{name:"max_position_embeddings",val:" = 512"},{name:"type_vocab_size",val:" = 2"},{name:"initializer_range",val:" = 0.02"},{name:"layer_norm_eps",val:" = 1e-12"},{name:"pad_token_id",val:" = 0"},{name:"embedding_size",val:" = 128"},{name:"trigram_input",val:" = True"},{name:"use_bottleneck",val:" = True"},{name:"intra_bottleneck_size",val:" = 128"},{name:"use_bottleneck_attention",val:" = False"},{name:"key_query_shared_bottleneck",val:" = True"},{name:"num_feedforward_networks",val:" = 4"},{name:"normalization_type",val:" = 'no_norm'"},{name:"classifier_activation",val:" = True"},{name:"classifier_dropout",val:" = None"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.MobileBertConfig.vocab_size",description:`<strong>vocab_size</strong> (<code>int</code>, <em>optional</em>, defaults to 30522) &#x2014;
...
`}}),Gn=new Pe({props:{$$slots:{default:[cw]},$$scope:{ctx:E}}}),Yn=new Ee({props:{anchor:"transformers.TFMobileBertForQuestionAnswering.call.example",$$slots:{default:[pw]},$$scope:{ctx:E}}}),Jn=new Ee({props:{anchor:"transformers.TFMobileBertForQuestionAnswering.call.example-2",$$slots:{default:[mw]},$$scope:{ctx:E}}}),{c(){d=r("meta"),_=m(),c=r("h1"),p=r("a"),T=r("span"),y(l.$$.fragment),u=m(),x=r("span"),me=n("MobileBERT"),V=m(),z=r("h2"),J=r("a"),L=r("span"),y(X.$$.fragment),he=m(),D=r("span"),ue=n("Overview"),le=m(),K=r("p"),N=n("The MobileBERT model was proposed in "),ee=r("a"),G=n("MobileBERT: a Compact Task-Agnostic BERT for Resource-Limited Devices"),P=n(` by Zhiqing Sun, Hongkun Yu, Xiaodan Song, Renjie Liu, Yiming Yang, and Denny
Zhou. It\u2019s a bidirectional transformer based on the BERT model, which is compressed and accelerated using several
approaches.`),j=m(),ne=r("p"),U=n("The abstract from the paper is the following:"),de=m(),se=r("p"),W=r("em"),fe=n(`Natural Language Processing (NLP) has recently achieved great success by using huge pre-trained models with hundreds
...
with a causal language modeling (CLM) objective are better in that regard.`),pe=m(),A=r("p"),be=n("This model was contributed by "),f=r("a"),B=n("vshampor"),Y=n(". The original code can be found "),ye=r("a"),$e=n("here"),S=n("."),we=m(),Te=r("h2"),ke=r("a"),C=r("span"),y(I.$$.fragment),Fe=m(),ve=r("span"),Q=n("MobileBertConfig"),Me=m(),te=r("div"),y(oe.$$.fragment),Be=m(),Mt=r("p"),Ep=n("This is the configuration class to store the configuration of a "),va=r("a"),xp=n("MobileBertModel"),zp=n(" or a "),wa=r("a"),Pp=n("TFMobileBertModel"),qp=n(`. It
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),hh=m(),lt=r("div"),y(qs.$$.fragment),uh=m(),Zt=r("p"),fh=n("The "),Sa=r("a"),gh=n("MobileBertForPreTraining"),_h=n(" forward method, overrides the "),Yi=r("code"),bh=n("__call__"),Th=n(" special method."),kh=m(),y(Ro.$$.fragment),yh=m(),y(Uo.$$.fragment),Gd=m(),Xt=r("h2"),Ho=r("a"),Ji=r("span"),y(js.$$.fragment),vh=m(),Zi=r("span"),wh=n("MobileBertForMaskedLM"),Yd=m(),Ue=r("div"),y(Cs.$$.fragment),Mh=m(),Ns=r("p"),$h=n("MobileBert Model with a "),Xi=r("code"),Fh=n("language modeling"),Bh=n(" head on top."),Eh=m(),Os=r("p"),xh=n("This model inherits from "),Aa=r("a"),zh=n("PreTrainedModel"),Ph=n(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),qh=m(),Ss=r("p"),jh=n("This model is also a PyTorch "),As=r("a"),Ch=n("torch.nn.Module"),Nh=n(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Oh=m(),Ye=r("div"),y(Is.$$.fragment),Sh=m(),eo=r("p"),Ah=n("The "),Ia=r("a"),Ih=n("MobileBertForMaskedLM"),Lh=n(" forward method, overrides the "),el=r("code"),Dh=n("__call__"),Wh=n(" special method."),Rh=m(),y(Qo.$$.fragment),Uh=m(),y(Ko.$$.fragment),Hh=m(),y(Vo.$$.fragment),Jd=m(),to=r("h2"),Go=r("a"),tl=r("span"),y(Ls.$$.fragment),Qh=m(),ol=r("span"),Kh=n("MobileBertForNextSentencePrediction"),Zd=m(),He=r("div"),y(Ds.$$.fragment),Vh=m(),Ws=r("p"),Gh=n("MobileBert Model with a "),nl=r("code"),Yh=n("next sentence prediction (classification)"),Jh=n(" head on top."),Zh=m(),Rs=r("p"),Xh=n("This model inherits from "),La=r("a"),eu=n("PreTrainedModel"),tu=n(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),ou=m(),Us=r("p"),nu=n("This model is also a PyTorch "),Hs=r("a"),su=n("torch.nn.Module"),ru=n(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),au=m(),dt=r("div"),y(Qs.$$.fragment),iu=m(),oo=r("p"),lu=n("The "),Da=r("a"),du=n("MobileBertForNextSentencePrediction"),cu=n(" forward method, overrides the "),sl=r("code"),pu=n("__call__"),mu=n(" special method."),hu=m(),y(Yo.$$.fragment),uu=m(),y(Jo.$$.fragment),Xd=m(),no=r("h2"),Zo=r("a"),rl=r("span"),y(Ks.$$.fragment),fu=m(),al=r("span"),gu=n("MobileBertForSequenceClassification"),ec=m(),Qe=r("div"),y(Vs.$$.fragment),_u=m(),il=r("p"),bu=n(`MobileBert Model transformer with a sequence classification/regression head on top (a linear layer on top of the
pooled output) e.g. for GLUE tasks.`),Tu=m(),Gs=r("p"),ku=n("This model inherits from "),Wa=r("a"),yu=n("PreTrainedModel"),vu=n(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),wu=m(),Ys=r("p"),Mu=n("This model is also a PyTorch "),Js=r("a"),$u=n("torch.nn.Module"),Fu=n(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Bu=m(),je=r("div"),y(Zs.$$.fragment),Eu=m(),so=r("p"),xu=n("The "),Ra=r("a"),zu=n("MobileBertForSequenceClassification"),Pu=n(" forward method, overrides the "),ll=r("code"),qu=n("__call__"),ju=n(" special method."),Cu=m(),y(Xo.$$.fragment),Nu=m(),y(en.$$.fragment),Ou=m(),y(tn.$$.fragment),Su=m(),y(on.$$.fragment),Au=m(),y(nn.$$.fragment),tc=m(),ro=r("h2"),sn=r("a"),dl=r("span"),y(Xs.$$.fragment),Iu=m(),cl=r("span"),Lu=n("MobileBertForMultipleChoice"),oc=m(),Ke=r("div"),y(er.$$.fragment),Du=m(),pl=r("p"),Wu=n(`MobileBert Model with a multiple choice classification head on top (a linear layer on top of the pooled output and
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Ju=m(),ct=r("div"),y(sr.$$.fragment),Zu=m(),ao=r("p"),Xu=n("The "),Ha=r("a"),ef=n("MobileBertForMultipleChoice"),tf=n(" forward method, overrides the "),ml=r("code"),of=n("__call__"),nf=n(" special method."),sf=m(),y(rn.$$.fragment),rf=m(),y(an.$$.fragment),nc=m(),io=r("h2"),ln=r("a"),hl=r("span"),y(rr.$$.fragment),af=m(),ul=r("span"),lf=n("MobileBertForTokenClassification"),sc=m(),Ve=r("div"),y(ar.$$.fragment),df=m(),fl=r("p"),cf=n(`MobileBert Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g.
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Tf=m(),Je=r("div"),y(cr.$$.fragment),kf=m(),lo=r("p"),yf=n("The "),Ka=r("a"),vf=n("MobileBertForTokenClassification"),wf=n(" forward method, overrides the "),gl=r("code"),Mf=n("__call__"),$f=n(" special method."),Ff=m(),y(dn.$$.fragment),Bf=m(),y(cn.$$.fragment),Ef=m(),y(pn.$$.fragment),rc=m(),co=r("h2"),mn=r("a"),_l=r("span"),y(pr.$$.fragment),xf=m(),bl=r("span"),zf=n("MobileBertForQuestionAnswering"),ac=m(),Ge=r("div"),y(mr.$$.fragment),Pf=m(),po=r("p"),qf=n(`MobileBert Model with a span classification head on top for extractive question-answering tasks like SQuAD (a
linear layers on top of the hidden-states output to compute `),Tl=r("code"),jf=n("span start logits"),Cf=n(" and "),kl=r("code"),Nf=n("span end logits"),Of=n(")."),Sf=m(),hr=r("p"),Af=n("This model inherits from "),Va=r("a"),If=n("PreTrainedModel"),Lf=n(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Df=m(),ur=r("p"),Wf=n("This model is also a PyTorch "),fr=r("a"),Rf=n("torch.nn.Module"),Uf=n(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Hf=m(),Ze=r("div"),y(gr.$$.fragment),Qf=m(),mo=r("p"),Kf=n("The "),Ga=r("a"),Vf=n("MobileBertForQuestionAnswering"),Gf=n(" forward method, overrides the "),yl=r("code"),Yf=n("__call__"),Jf=n(" special method."),Zf=m(),y(hn.$$.fragment),Xf=m(),y(un.$$.fragment),eg=m(),y(fn.$$.fragment),ic=m(),ho=r("h2"),gn=r("a"),vl=r("span"),y(_r.$$.fragment),tg=m(),wl=r("span"),og=n("TFMobileBertModel"),lc=m(),Ne=r("div"),y(br.$$.fragment),ng=m(),Ml=r("p"),sg=n("The bare MobileBert Model transformer outputting raw hidden-states without any specific head on top."),rg=m(),Tr=r("p"),ag=n("This model inherits from "),Ya=r("a"),ig=n("TFPreTrainedModel"),lg=n(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),dg=m(),kr=r("p"),cg=n("This model is also a "),yr=r("a"),pg=n("tf.keras.Model"),mg=n(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),hg=m(),y(_n.$$.fragment),ug=m(),pt=r("div"),y(vr.$$.fragment),fg=m(),uo=r("p"),gg=n("The "),Ja=r("a"),_g=n("TFMobileBertModel"),bg=n(" forward method, overrides the "),$l=r("code"),Tg=n("__call__"),kg=n(" special method."),yg=m(),y(bn.$$.fragment),vg=m(),y(Tn.$$.fragment),dc=m(),fo=r("h2"),kn=r("a"),Fl=r("span"),y(wr.$$.fragment),wg=m(),Bl=r("span"),Mg=n("TFMobileBertForPreTraining"),cc=m(),Oe=r("div"),y(Mr.$$.fragment),$g=m(),go=r("p"),Fg=n("MobileBert Model with two heads on top as done during the pretraining: a "),El=r("code"),Bg=n("masked language modeling"),Eg=n(` head and a
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),d_=m(),y($n.$$.fragment),c_=m(),Xe=r("div"),y(Nr.$$.fragment),p_=m(),To=r("p"),m_=n("The "),ti=r("a"),h_=n("TFMobileBertForMaskedLM"),u_=n(" forward method, overrides the "),Cl=r("code"),f_=n("__call__"),g_=n(" special method."),__=m(),y(Fn.$$.fragment),b_=m(),y(Bn.$$.fragment),T_=m(),y(En.$$.fragment),hc=m(),ko=r("h2"),xn=r("a"),Nl=r("span"),y(Or.$$.fragment),k_=m(),Ol=r("span"),y_=n("TFMobileBertForNextSentencePrediction"),uc=m(),Ae=r("div"),y(Sr.$$.fragment),v_=m(),Ar=r("p"),w_=n("MobileBert Model with a "),Sl=r("code"),M_=n("next sentence prediction (classification)"),$_=n(" head on top."),F_=m(),Ir=r("p"),B_=n("This model inherits from "),oi=r("a"),E_=n("TFPreTrainedModel"),x_=n(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),z_=m(),Lr=r("p"),P_=n("This model is also a "),Dr=r("a"),q_=n("tf.keras.Model"),j_=n(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),C_=m(),y(zn.$$.fragment),N_=m(),ht=r("div"),y(Wr.$$.fragment),O_=m(),yo=r("p"),S_=n("The "),ni=r("a"),A_=n("TFMobileBertForNextSentencePrediction"),I_=n(" forward method, overrides the "),Al=r("code"),L_=n("__call__"),D_=n(" special method."),W_=m(),y(Pn.$$.fragment),R_=m(),y(qn.$$.fragment),fc=m(),vo=r("h2"),jn=r("a"),Il=r("span"),y(Rr.$$.fragment),U_=m(),Ll=r("span"),H_=n("TFMobileBertForSequenceClassification"),gc=m(),Ie=r("div"),y(Ur.$$.fragment),Q_=m(),Dl=r("p"),K_=n(`MobileBert Model transformer with a sequence classification/regression head on top (a linear layer on top of the
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),kT=m(),y(Vn.$$.fragment),yT=m(),ot=r("div"),y(ma.$$.fragment),vT=m(),zo=r("p"),wT=n("The "),pi=r("a"),MT=n("TFMobileBertForQuestionAnswering"),$T=n(" forward method, overrides the "),td=r("code"),FT=n("__call__"),BT=n(" special method."),ET=m(),y(Gn.$$.fragment),xT=m(),y(Yn.$$.fragment),zT=m(),y(Jn.$$.fragment),this.h()},l(o){const k=uv('[data-svelte="svelte-1phssyn"]',document.head);d=a(k,"META",{name:!0,content:!0}),k.forEach(t),_=h(o),c=a(o,"H1",{class:!0});var ha=i(c);p=a(ha,"A",{id:!0,class:!0,href:!0});var od=i(p);T=a(od,"SPAN",{});var nd=i(T);v(l.$$.fragment,nd),nd.forEach(t),od.forEach(t),u=h(ha),x=a(ha,"SPAN",{});var sd=i(x);me=s(sd,"MobileBERT"),sd.forEach(t),ha.forEach(t),V=h(o),z=a(o,"H2",{class:!0});var ua=i(z);J=a(ua,"A",{id:!0,class:!0,href:!0});var rd=i(J);L=a(rd,"SPAN",{});var ad=i(L);v(X.$$.fragment,ad),ad.forEach(t),rd.forEach(t),he=h(ua),D=a(ua,"SPAN",{});var id=i(D);ue=s(id,"Overview"),id.forEach(t),ua.forEach(t),le=h(o),K=a(o,"P",{});var fa=i(K);N=s(fa,"The MobileBERT model was proposed in "),ee=a(fa,"A",{href:!0,rel:!0});var ld=i(ee);G=s(ld,"MobileBERT: a Compact Task-Agnostic BERT for Resource-Limited Devices"),ld.forEach(t),P=s(fa,` by Zhiqing Sun, Hongkun Yu, Xiaodan Song, Renjie Liu, Yiming Yang, and Denny
Zhou. It\u2019s a bidirectional transformer based on the BERT model, which is compressed and accelerated using several
approaches.`),fa.forEach(t),j=h(o),ne=a(o,"P",{});var dd=i(ne);U=s(dd,"The abstract from the paper is the following:"),dd.forEach(t),de=h(o),se=a(o,"P",{});var cd=i(se);W=a(cd,"EM",{});var pd=i(W);fe=s(pd,`Natural Language Processing (NLP) has recently achieved great success by using huge pre-trained models with hundreds
of millions of parameters. However, these models suffer from heavy model sizes and high latency such that they cannot
be deployed to resource-limited mobile devices. In this paper, we propose MobileBERT for compressing and accelerating
the popular BERT model. Like the original BERT, MobileBERT is task-agnostic, that is, it can be generically applied to
various downstream NLP tasks via simple fine-tuning. Basically, MobileBERT is a thin version of BERT_LARGE, while
...
efficient at predicting masked tokens and at NLU in general, but is not optimal for text generation. Models trained
with a causal language modeling (CLM) objective are better in that regard.`),ud.forEach(t),ga.forEach(t),pe=h(o),A=a(o,"P",{});var Po=i(A);be=s(Po,"This model was contributed by "),f=a(Po,"A",{href:!0,rel:!0});var fd=i(f);B=s(fd,"vshampor"),fd.forEach(t),Y=s(Po,". The original code can be found "),ye=a(Po,"A",{href:!0,rel:!0});var gd=i(ye);$e=s(gd,"here"),gd.forEach(t),S=s(Po,"."),Po.forEach(t),we=h(o),Te=a(o,"H2",{class:!0});var _a=i(Te);ke=a(_a,"A",{id:!0,class:!0,href:!0});var _d=i(ke);C=a(_d,"SPAN",{});var bd=i(C);v(I.$$.fragment,bd),bd.forEach(t),_d.forEach(t),Fe=h(_a),ve=a(_a,"SPAN",{});var Td=i(ve);Q=s(Td,"MobileBertConfig"),Td.forEach(t),_a.forEach(t),Me=h(o),te=a(o,"DIV",{class:!0});var at=i(te);v(oe.$$.fragment,at),Be=h(at),Mt=a(at,"P",{});var $t=i(Mt);Ep=s($t,"This is the configuration class to store the configuration of a "),va=a($t,"A",{href:!0});var kd=i(va);xp=s(kd,"MobileBertModel"),kd.forEach(t),zp=s($t," or a "),wa=a($t,"A",{href:!0});var yd=i(wa);Pp=s(yd,"TFMobileBertModel"),yd.forEach(t),qp=s($t,`. It
is used to instantiate a MobileBERT model according to the specified arguments, defining the model architecture.
Instantiating a configuration with the defaults will yield a similar configuration to that of the MobileBERT
...
splitting and wordpiece.`),Sd.forEach(t),um=h(Bt),us=a(Bt,"P",{});var Mc=i(us);fm=s(Mc,"Refer to superclass "),Pa=a(Mc,"A",{href:!0});var jT=i(Pa);gm=s(jT,"BertTokenizerFast"),jT.forEach(t),_m=s(Mc," for usage examples and documentation concerning parameters."),Mc.forEach(t),Bt.forEach(t),Wd=h(o),Ht=a(o,"H2",{class:!0});var $c=i(Ht);Ao=a($c,"A",{id:!0,class:!0,href:!0});var CT=i(Ao);Ii=a(CT,"SPAN",{});var NT=i(Ii);v(fs.$$.fragment,NT),NT.forEach(t),CT.forEach(t),bm=h($c),Li=a($c,"SPAN",{});var OT=i(Li);Tm=s(OT,"MobileBert specific outputs"),OT.forEach(t),$c.forEach(t),Rd=h(o),Qt=a(o,"DIV",{class:!0});var Fc=i(Qt);v(gs.$$.fragment,Fc),km=h(Fc),_s=a(Fc,"P",{});var Bc=i(_s);ym=s(Bc,"Output type of "),qa=a(Bc,"A",{href:!0});var ST=i(qa);vm=s(ST,"MobileBertForPreTraining"),ST.forEach(t),wm=s(Bc,"."),Bc.forEach(t),Fc.forEach(t),Ud=h(o),Kt=a(o,"DIV",{class:!0});var Ec=i(Kt);v(bs.$$.fragment,Ec),Mm=h(Ec),Ts=a(Ec,"P",{});var xc=i(Ts);$m=s(xc,"Output type of "),ja=a(xc,"A",{href:!0});var AT=i(ja);Fm=s(AT,"TFMobileBertForPreTraining"),AT.forEach(t),Bm=s(xc,"."),xc.forEach(t),Ec.forEach(t),Hd=h(o),Vt=a(o,"H2",{class:!0});var zc=i(Vt);Io=a(zc,"A",{id:!0,class:!0,href:!0});var IT=i(Io);Di=a(IT,"SPAN",{});var LT=i(Di);v(ks.$$.fragment,LT),LT.forEach(t),IT.forEach(t),Em=h(zc),Wi=a(zc,"SPAN",{});var DT=i(Wi);xm=s(DT,"MobileBertModel"),DT.forEach(t),zc.forEach(t),Qd=h(o),Ce=a(o,"DIV",{class:!0});var ft=i(Ce);v(ys.$$.fragment,ft),zm=h(ft),Ri=a(ft,"P",{});var WT=i(Ri);Pm=s(WT,"The bare MobileBert Model transformer outputting raw hidden-states without any specific head on top."),WT.forEach(t),qm=h(ft),vs=a(ft,"P",{});var Pc=i(vs);jm=s(Pc,"This model inherits from "),Ca=a(Pc,"A",{href:!0});var RT=i(Ca);Cm=s(RT,"PreTrainedModel"),RT.forEach(t),Nm=s(Pc,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Nc.forEach(t),hh=h(Et),lt=a(Et,"DIV",{class:!0});var es=i(lt);v(qs.$$.fragment,es),uh=h(es),Zt=a(es,"P",{});var ui=i(Zt);fh=s(ui,"The "),Sa=a(ui,"A",{href:!0});var ok=i(Sa);gh=s(ok,"MobileBertForPreTraining"),ok.forEach(t),_h=s(ui," forward method, overrides the "),Yi=a(ui,"CODE",{});var nk=i(Yi);bh=s(nk,"__call__"),nk.forEach(t),Th=s(ui," special method."),ui.forEach(t),kh=h(es),v(Ro.$$.fragment,es),yh=h(es),v(Uo.$$.fragment,es),es.forEach(t),Et.forEach(t),Gd=h(o),Xt=a(o,"H2",{class:!0});var Oc=i(Xt);Ho=a(Oc,"A",{id:!0,class:!0,href:!0});var sk=i(Ho);Ji=a(sk,"SPAN",{});var rk=i(Ji);v(js.$$.fragment,rk),rk.forEach(t),sk.forEach(t),vh=h(Oc),Zi=a(Oc,"SPAN",{});var ak=i(Zi);wh=s(ak,"MobileBertForMaskedLM"),ak.forEach(t),Oc.forEach(t),Yd=h(o),Ue=a(o,"DIV",{class:!0});var xt=i(Ue);v(Cs.$$.fragment,xt),Mh=h(xt),Ns=a(xt,"P",{});var Sc=i(Ns);$h=s(Sc,"MobileBert Model with a "),Xi=a(Sc,"CODE",{});var ik=i(Xi);Fh=s(ik,"language modeling"),ik.forEach(t),Bh=s(Sc," head on top."),Sc.forEach(t),Eh=h(xt),Os=a(xt,"P",{});var Ac=i(Os);xh=s(Ac,"This model inherits from "),Aa=a(Ac,"A",{href:!0});var lk=i(Aa);zh=s(lk,"PreTrainedModel"),lk.forEach(t),Ph=s(Ac,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Ic.forEach(t),Oh=h(xt),Ye=a(xt,"DIV",{class:!0});var zt=i(Ye);v(Is.$$.fragment,zt),Sh=h(zt),eo=a(zt,"P",{});var fi=i(eo);Ah=s(fi,"The "),Ia=a(fi,"A",{href:!0});var ck=i(Ia);Ih=s(ck,"MobileBertForMaskedLM"),ck.forEach(t),Lh=s(fi," forward method, overrides the "),el=a(fi,"CODE",{});var pk=i(el);Dh=s(pk,"__call__"),pk.forEach(t),Wh=s(fi," special method."),fi.forEach(t),Rh=h(zt),v(Qo.$$.fragment,zt),Uh=h(zt),v(Ko.$$.fragment,zt),Hh=h(zt),v(Vo.$$.fragment,zt),zt.forEach(t),xt.forEach(t),Jd=h(o),to=a(o,"H2",{class:!0});var Lc=i(to);Go=a(Lc,"A",{id:!0,class:!0,href:!0});var mk=i(Go);tl=a(mk,"SPAN",{});var hk=i(tl);v(Ls.$$.fragment,hk),hk.forEach(t),mk.forEach(t),Qh=h(Lc),ol=a(Lc,"SPAN",{});var uk=i(ol);Kh=s(uk,"MobileBertForNextSentencePrediction"),uk.forEach(t),Lc.forEach(t),Zd=h(o),He=a(o,"DIV",{class:!0});var Pt=i(He);v(Ds.$$.fragment,Pt),Vh=h(Pt),Ws=a(Pt,"P",{});var Dc=i(Ws);Gh=s(Dc,"MobileBert Model with a "),nl=a(Dc,"CODE",{});var fk=i(nl);Yh=s(fk,"next sentence prediction (classification)"),fk.forEach(t),Jh=s(Dc," head on top."),Dc.forEach(t),Zh=h(Pt),Rs=a(Pt,"P",{});var Wc=i(Rs);Xh=s(Wc,"This model inherits from "),La=a(Wc,"A",{href:!0});var gk=i(La);eu=s(gk,"PreTrainedModel"),gk.forEach(t),tu=s(Wc,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Rc.forEach(t),au=h(Pt),dt=a(Pt,"DIV",{class:!0});var ts=i(dt);v(Qs.$$.fragment,ts),iu=h(ts),oo=a(ts,"P",{});var gi=i(oo);lu=s(gi,"The "),Da=a(gi,"A",{href:!0});var bk=i(Da);du=s(bk,"MobileBertForNextSentencePrediction"),bk.forEach(t),cu=s(gi," forward method, overrides the "),sl=a(gi,"CODE",{});var Tk=i(sl);pu=s(Tk,"__call__"),Tk.forEach(t),mu=s(gi," special method."),gi.forEach(t),hu=h(ts),v(Yo.$$.fragment,ts),uu=h(ts),v(Jo.$$.fragment,ts),ts.forEach(t),Pt.forEach(t),Xd=h(o),no=a(o,"H2",{class:!0});var Uc=i(no);Zo=a(Uc,"A",{id:!0,class:!0,href:!0});var kk=i(Zo);rl=a(kk,"SPAN",{});var yk=i(rl);v(Ks.$$.fragment,yk),yk.forEach(t),kk.forEach(t),fu=h(Uc),al=a(Uc,"SPAN",{});var vk=i(al);gu=s(vk,"MobileBertForSequenceClassification"),vk.forEach(t),Uc.forEach(t),ec=h(o),Qe=a(o,"DIV",{class:!0});var qt=i(Qe);v(Vs.$$.fragment,qt),_u=h(qt),il=a(qt,"P",{});var wk=i(il);bu=s(wk,`MobileBert Model transformer with a sequence classification/regression head on top (a linear layer on top of the
pooled output) e.g. for GLUE tasks.`),wk.forEach(t),Tu=h(qt),Gs=a(qt,"P",{});var Hc=i(Gs);ku=s(Hc,"This model inherits from "),Wa=a(Hc,"A",{href:!0});var Mk=i(Wa);yu=s(Mk,"PreTrainedModel"),Mk.forEach(t),vu=s(Hc,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Qc.forEach(t),Bu=h(qt),je=a(qt,"DIV",{class:!0});var nt=i(je);v(Zs.$$.fragment,nt),Eu=h(nt),so=a(nt,"P",{});var _i=i(so);xu=s(_i,"The "),Ra=a(_i,"A",{href:!0});var Fk=i(Ra);zu=s(Fk,"MobileBertForSequenceClassification"),Fk.forEach(t),Pu=s(_i," forward method, overrides the "),ll=a(_i,"CODE",{});var Bk=i(ll);qu=s(Bk,"__call__"),Bk.forEach(t),ju=s(_i," special method."),_i.forEach(t),Cu=h(nt),v(Xo.$$.fragment,nt),Nu=h(nt),v(en.$$.fragment,nt),Ou=h(nt),v(tn.$$.fragment,nt),Su=h(nt),v(on.$$.fragment,nt),Au=h(nt),v(nn.$$.fragment,nt),nt.forEach(t),qt.forEach(t),tc=h(o),ro=a(o,"H2",{class:!0});var Kc=i(ro);sn=a(Kc,"A",{id:!0,class:!0,href:!0});var Ek=i(sn);dl=a(Ek,"SPAN",{});var xk=i(dl);v(Xs.$$.fragment,xk),xk.forEach(t),Ek.forEach(t),Iu=h(Kc),cl=a(Kc,"SPAN",{});var zk=i(cl);Lu=s(zk,"MobileBertForMultipleChoice"),zk.forEach(t),Kc.forEach(t),oc=h(o),Ke=a(o,"DIV",{class:!0});var jt=i(Ke);v(er.$$.fragment,jt),Du=h(jt),pl=a(jt,"P",{});var Pk=i(pl);Wu=s(Pk,`MobileBert Model with a multiple choice classification head on top (a linear layer on top of the pooled output and
a softmax) e.g. for RocStories/SWAG tasks.`),Pk.forEach(t),Ru=h(jt),tr=a(jt,"P",{});var Vc=i(tr);Uu=s(Vc,"This model inherits from "),Ua=a(Vc,"A",{href:!0});var qk=i(Ua);Hu=s(qk,"PreTrainedModel"),qk.forEach(t),Qu=s(Vc,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Vc.forEach(t),Ku=h(jt),or=a(jt,"P",{});var Gc=i(or);Vu=s(Gc,"This model is also a PyTorch "),nr=a(Gc,"A",{href:!0,rel:!0});var jk=i(nr);Gu=s(jk,"torch.nn.Module"),jk.forEach(t),Yu=s(Gc,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Gc.forEach(t),Ju=h(jt),ct=a(jt,"DIV",{class:!0});var os=i(ct);v(sr.$$.fragment,os),Zu=h(os),ao=a(os,"P",{});var bi=i(ao);Xu=s(bi,"The "),Ha=a(bi,"A",{href:!0});var Ck=i(Ha);ef=s(Ck,"MobileBertForMultipleChoice"),Ck.forEach(t),tf=s(bi," forward method, overrides the "),ml=a(bi,"CODE",{});var Nk=i(ml);of=s(Nk,"__call__"),Nk.forEach(t),nf=s(bi," special method."),bi.forEach(t),sf=h(os),v(rn.$$.fragment,os),rf=h(os),v(an.$$.fragment,os),os.forEach(t),jt.forEach(t),nc=h(o),io=a(o,"H2",{class:!0});var Yc=i(io);ln=a(Yc,"A",{id:!0,class:!0,href:!0});var Ok=i(ln);hl=a(Ok,"SPAN",{});var Sk=i(hl);v(rr.$$.fragment,Sk),Sk.forEach(t),Ok.forEach(t),af=h(Yc),ul=a(Yc,"SPAN",{});var Ak=i(ul);lf=s(Ak,"MobileBertForTokenClassification"),Ak.forEach(t),Yc.forEach(t),sc=h(o),Ve=a(o,"DIV",{class:!0});var Ct=i(Ve);v(ar.$$.fragment,Ct),df=h(Ct),fl=a(Ct,"P",{});var Ik=i(fl);cf=s(Ik,`MobileBert Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g.
for Named-Entity-Recognition (NER) tasks.`),Ik.forEach(t),pf=h(Ct),ir=a(Ct,"P",{});var Jc=i(ir);mf=s(Jc,"This model inherits from "),Qa=a(Jc,"A",{href:!0});var Lk=i(Qa);hf=s(Lk,"PreTrainedModel"),Lk.forEach(t),uf=s(Jc,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Jc.forEach(t),ff=h(Ct),lr=a(Ct,"P",{});var Zc=i(lr);gf=s(Zc,"This model is also a PyTorch "),dr=a(Zc,"A",{href:!0,rel:!0});var Dk=i(dr);_f=s(Dk,"torch.nn.Module"),Dk.forEach(t),bf=s(Zc,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Zc.forEach(t),Tf=h(Ct),Je=a(Ct,"DIV",{class:!0});var Nt=i(Je);v(cr.$$.fragment,Nt),kf=h(Nt),lo=a(Nt,"P",{});var Ti=i(lo);yf=s(Ti,"The "),Ka=a(Ti,"A",{href:!0});var Wk=i(Ka);vf=s(Wk,"MobileBertForTokenClassification"),Wk.forEach(t),wf=s(Ti," forward method, overrides the "),gl=a(Ti,"CODE",{});var Rk=i(gl);Mf=s(Rk,"__call__"),Rk.forEach(t),$f=s(Ti," special method."),Ti.forEach(t),Ff=h(Nt),v(dn.$$.fragment,Nt),Bf=h(Nt),v(cn.$$.fragment,Nt),Ef=h(Nt),v(pn.$$.fragment,Nt),Nt.forEach(t),Ct.forEach(t),rc=h(o),co=a(o,"H2",{class:!0});var Xc=i(co);mn=a(Xc,"A",{id:!0,class:!0,href:!0});var Uk=i(mn);_l=a(Uk,"SPAN",{});var Hk=i(_l);v(pr.$$.fragment,Hk),Hk.forEach(t),Uk.forEach(t),xf=h(Xc),bl=a(Xc,"SPAN",{});var Qk=i(bl);zf=s(Qk,"MobileBertForQuestionAnswering"),Qk.forEach(t),Xc.forEach(t),ac=h(o),Ge=a(o,"DIV",{class:!0});var Ot=i(Ge);v(mr.$$.fragment,Ot),Pf=h(Ot),po=a(Ot,"P",{});var ki=i(po);qf=s(ki,`MobileBert Model with a span classification head on top for extractive question-answering tasks like SQuAD (a
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),tp.forEach(t),Hf=h(Ot),Ze=a(Ot,"DIV",{class:!0});var St=i(Ze);v(gr.$$.fragment,St),Qf=h(St),mo=a(St,"P",{});var yi=i(mo);Kf=s(yi,"The "),Ga=a(yi,"A",{href:!0});var Jk=i(Ga);Vf=s(Jk,"MobileBertForQuestionAnswering"),Jk.forEach(t),Gf=s(yi," forward method, overrides the "),yl=a(yi,"CODE",{});var Zk=i(yl);Yf=s(Zk,"__call__"),Zk.forEach(t),Jf=s(yi," special method."),yi.forEach(t),Zf=h(St),v(hn.$$.fragment,St),Xf=h(St),v(un.$$.fragment,St),eg=h(St),v(fn.$$.fragment,St),St.forEach(t),Ot.forEach(t),ic=h(o),ho=a(o,"H2",{class:!0});var op=i(ho);gn=a(op,"A",{id:!0,class:!0,href:!0});var Xk=i(gn);vl=a(Xk,"SPAN",{});var ey=i(vl);v(_r.$$.fragment,ey),ey.forEach(t),Xk.forEach(t),tg=h(op),wl=a(op,"SPAN",{});var ty=i(wl);og=s(ty,"TFMobileBertModel"),ty.forEach(t),op.forEach(t),lc=h(o),Ne=a(o,"DIV",{class:!0});var gt=i(Ne);v(br.$$.fragment,gt),ng=h(gt),Ml=a(gt,"P",{});var oy=i(Ml);sg=s(oy,"The bare MobileBert Model transformer outputting raw hidden-states without any specific head on top."),oy.forEach(t),rg=h(gt),Tr=a(gt,"P",{});var np=i(Tr);ag=s(np,"This model inherits from "),Ya=a(np,"A",{href:!0});var ny=i(Ya);ig=s(ny,"TFPreTrainedModel"),ny.forEach(t),lg=s(np,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),pp.forEach(t),d_=h(bt),v($n.$$.fragment,bt),c_=h(bt),Xe=a(bt,"DIV",{class:!0});var At=i(Xe);v(Nr.$$.fragment,At),p_=h(At),To=a(At,"P",{});var $i=i(To);m_=s($i,"The "),ti=a($i,"A",{href:!0});var vy=i(ti);h_=s(vy,"TFMobileBertForMaskedLM"),vy.forEach(t),u_=s($i," forward method, overrides the "),Cl=a($i,"CODE",{});var wy=i(Cl);f_=s(wy,"__call__"),wy.forEach(t),g_=s($i," special method."),$i.forEach(t),__=h(At),v(Fn.$$.fragment,At),b_=h(At),v(Bn.$$.fragment,At),T_=h(At),v(En.$$.fragment,At),At.forEach(t),bt.forEach(t),hc=h(o),ko=a(o,"H2",{class:!0});var mp=i(ko);xn=a(mp,"A",{id:!0,class:!0,href:!0});var My=i(xn);Nl=a(My,"SPAN",{});var $y=i(Nl);v(Or.$$.fragment,$y),$y.forEach(t),My.forEach(t),k_=h(mp),Ol=a(mp,"SPAN",{});var Fy=i(Ol);y_=s(Fy,"TFMobileBertForNextSentencePrediction"),Fy.forEach(t),mp.forEach(t),uc=h(o),Ae=a(o,"DIV",{class:!0});var Tt=i(Ae);v(Sr.$$.fragment,Tt),v_=h(Tt),Ar=a(Tt,"P",{});var hp=i(Ar);w_=s(hp,"MobileBert Model with a "),Sl=a(hp,"CODE",{});var By=i(Sl);M_=s(By,"next sentence prediction (classification)"),By.forEach(t),$_=s(hp," head on top."),hp.forEach(t),F_=h(Tt),Ir=a(Tt,"P",{});var up=i(Ir);B_=s(up,"This model inherits from "),oi=a(up,"A",{href:!0});var Ey=i(oi);E_=s(Ey,"TFPreTrainedModel"),Ey.forEach(t),x_=s(up,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),up.forEach(t),z_=h(Tt),Lr=a(Tt,"P",{});var fp=i(Lr);P_=s(fp,"This model is also a "),Dr=a(fp,"A",{href:!0,rel:!0});var xy=i(Dr);q_=s(xy,"tf.keras.Model"),xy.forEach(t),j_=s(fp,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),fp.forEach(t),C_=h(Tt),v(zn.$$.fragment,Tt),N_=h(Tt),ht=a(Tt,"DIV",{class:!0});var rs=i(ht);v(Wr.$$.fragment,rs),O_=h(rs),yo=a(rs,"P",{});var Fi=i(yo);S_=s(Fi,"The "),ni=a(Fi,"A",{href:!0});var zy=i(ni);A_=s(zy,"TFMobileBertForNextSentencePrediction"),zy.forEach(t),I_=s(Fi," forward method, overrides the "),Al=a(Fi,"CODE",{});var Py=i(Al);L_=s(Py,"__call__"),Py.forEach(t),D_=s(Fi," special method."),Fi.forEach(t),W_=h(rs),v(Pn.$$.fragment,rs),R_=h(rs),v(qn.$$.fragment,rs),rs.forEach(t),Tt.forEach(t),fc=h(o),vo=a(o,"H2",{class:!0});var gp=i(vo);jn=a(gp,"A",{id:!0,class:!0,href:!0});var qy=i(jn);Il=a(qy,"SPAN",{});var jy=i(Il);v(Rr.$$.fragment,jy),jy.forEach(t),qy.forEach(t),U_=h(gp),Ll=a(gp,"SPAN",{});var Cy=i(Ll);H_=s(Cy,"TFMobileBertForSequenceClassification"),Cy.forEach(t),gp.forEach(t),gc=h(o),Ie=a(o,"DIV",{class:!0});var kt=i(Ie);v(Ur.$$.fragment,kt),Q_=h(kt),Dl=a(kt,"P",{});var Ny=i(Dl);K_=s(Ny,`MobileBert Model transformer with a sequence classification/regression head on top (a linear layer on top of the
...
linear layers on top of the hidden-states output to compute `),Xl=a(zi,"CODE",{});var rv=i(Xl);lT=s(rv,"span start logits"),rv.forEach(t),dT=s(zi," and "),ed=a(zi,"CODE",{});var av=i(ed);cT=s(av,"span end logits"),av.forEach(t),pT=s(zi,")."),zi.forEach(t),mT=h(wt),da=a(wt,"P",{});var Fp=i(da);hT=s(Fp,"This model inherits from "),ci=a(Fp,"A",{href:!0});var iv=i(ci);uT=s(iv,"TFPreTrainedModel"),iv.forEach(t),fT=s(Fp,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
