...
<span class="hljs-meta">&gt;&gt;&gt; </span>outputs = model(**encoding)
<span class="hljs-meta">&gt;&gt;&gt; </span>word_last_hidden_state = outputs.last_hidden_state
<span class="hljs-meta">&gt;&gt;&gt; </span>entity_last_hidden_state = outputs.entity_last_hidden_state`}}),{c(){h=a("p"),y=o("Examples:"),g=c(),b(f.$$.fragment)},l(l){h=i(l,"P",{});var u=r(h);y=s(u,"Examples:"),u.forEach(t),g=p(l),v(f.$$.fragment,l)},m(l,u){_(l,h,u),e(h,y),_(l,g,u),T(f,l,u),k=!0},p:Qo,i(l){k||(w(f.$$.fragment,l),k=!0)},o(l){L(f.$$.fragment,l),k=!1},d(l){l&&t(h),l&&t(g),E(f,l)}}}function Xc(z){let h,y,g,f,k;return{c(){h=a("p"),y=o("Although the recipe for forward pass needs to be defined within this function, one should call the "),g=a("code"),f=o("Module"),k=o(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(l){h=i(l,"P",{});var u=r(h);y=s(u,"Although the recipe for forward pass needs to be defined within this function, one should call the "),g=i(u,"CODE",{});var $=r(g);f=s($,"Module"),$.forEach(t),k=s(u,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
Beyonc\xE9 PER
Los Angeles LOC`}}),{c(){h=a("p"),y=o("Examples:"),g=c(),b(f.$$.fragment)},l(l){h=i(l,"P",{});var u=r(h);y=s(u,"Examples:"),u.forEach(t),g=p(l),v(f.$$.fragment,l)},m(l,u){_(l,h,u),e(h,y),_(l,g,u),T(f,l,u),k=!0},p:Qo,i(l){k||(w(f.$$.fragment,l),k=!0)},o(l){L(f.$$.fragment,l),k=!1},d(l){l&&t(h),l&&t(g),E(f,l)}}}function sp(z){let h,y,g,f,k,l,u,$,Bs,Jo,se,we,Bn,Ge,Us,Un,Ks,Xo,Le,Rs,Ze,Vs,Hs,Go,Gt,Ys,Zo,Zt,Kn,Qs,es,en,Js,ts,W,Rn,et,Xs,tn,Gs,Zs,ea,Vn,q,ta,Hn,na,oa,Yn,sa,aa,Qn,ia,ra,Jn,la,da,nn,ca,pa,ha,tt,B,on,ua,ma,Xn,fa,ga,Gn,_a,ka,Zn,ya,ba,va,nt,sn,eo,Ta,wa,La,an,to,Ea,za,$a,N,no,xa,Ca,ae,Ee,rn,qa,Fa,ot,Ma,Pa,ja,ze,ln,Aa,Ia,st,Oa,Sa,Na,dn,cn,Da,Wa,Ba,O,pn,Ua,Ka,oo,Ra,Va,so,Ha,Ya,ao,Qa,Ja,io,Xa,Ga,Za,ie,ei,hn,ti,ni,at,oi,si,ai,it,ii,rt,ri,li,ns,un,di,os,lt,ss,U,ci,dt,pi,hi,ct,ui,mi,pt,fi,gi,as,re,$e,ro,ht,_i,lo,ki,is,D,ut,yi,le,bi,mn,vi,Ti,mt,wi,Li,Ei,de,zi,fn,$i,xi,gn,Ci,qi,Fi,xe,rs,ce,Ce,co,ft,Mi,po,Pi,ls,F,gt,ji,ho,Ai,Ii,x,Oi,_n,Si,Ni,kn,Di,Wi,yn,Bi,Ui,uo,Ki,Ri,mo,Vi,Hi,fo,Yi,Qi,go,Ji,Xi,Gi,qe,_t,Zi,_o,er,tr,bn,kt,ds,pe,Fe,ko,yt,nr,yo,or,cs,M,bt,sr,bo,ar,ir,vt,rr,vn,lr,dr,cr,Tt,pr,wt,hr,ur,mr,K,Lt,fr,he,gr,Tn,_r,kr,vo,yr,br,vr,Me,Tr,Pe,ps,ue,je,To,Et,wr,wo,Lr,hs,P,zt,Er,Lo,zr,$r,$t,xr,wn,Cr,qr,Fr,xt,Mr,Ct,Pr,jr,Ar,J,qt,Ir,me,Or,Ln,Sr,Nr,Eo,Dr,Wr,Br,Ae,us,fe,Ie,zo,Ft,Ur,$o,Kr,ms,j,Mt,Rr,xo,Vr,Hr,Pt,Yr,En,Qr,Jr,Xr,jt,Gr,At,Zr,el,tl,R,It,nl,ge,ol,zn,sl,al,Co,il,rl,ll,Oe,dl,Se,fs,_e,Ne,qo,Ot,cl,Fo,pl,gs,A,St,hl,Mo,ul,ml,Nt,fl,$n,gl,_l,kl,Dt,yl,Wt,bl,vl,Tl,V,Bt,wl,ke,Ll,xn,El,zl,Po,$l,xl,Cl,De,ql,We,_s,ye,Be,jo,Ut,Fl,Ao,Ml,ks,I,Kt,Pl,Io,jl,Al,Rt,Il,Cn,Ol,Sl,Nl,Vt,Dl,Ht,Wl,Bl,Ul,H,Yt,Kl,be,Rl,qn,Vl,Hl,Oo,Yl,Ql,Jl,Ue,Xl,Ke,ys;return l=new Te({}),Ge=new Te({}),lt=new Wn({props:{code:`from transformers import LukeTokenizer, LukeModel, LukeForEntityPairClassification
...
<p><a
  href="/docs/transformers/main/en/main_classes/tokenizer#transformers.BatchEncoding"
>BatchEncoding</a></p>
`}}),kt=new S({props:{name:"save_vocabulary",anchor:"transformers.LukeTokenizer.save_vocabulary",parameters:[{name:"save_directory",val:": str"},{name:"filename_prefix",val:": typing.Optional[str] = None"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/luke/tokenization_luke.py#L1378"}}),yt=new Te({}),bt=new S({props:{name:"class transformers.LukeModel",anchor:"transformers.LukeModel",parameters:[{name:"config",val:": LukeConfig"},{name:"add_pooling_layer",val:": bool = True"}],parametersDescription:[{anchor:"transformers.LukeModel.config",description:`<strong>config</strong> (<a href="/docs/transformers/main/en/model_doc/luke#transformers.LukeConfig">LukeConfig</a>) &#x2014; Model configuration class with all the parameters of the
model. Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/main/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/luke/modeling_luke.py#L880"}}),Lt=new S({props:{name:"forward",anchor:"transformers.LukeModel.forward",parameters:[{name:"input_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"attention_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"token_type_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"position_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"entity_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"entity_attention_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"entity_token_type_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"entity_position_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"head_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.LukeModel.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
...
model. Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/main/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/luke/modeling_luke.py#L1133"}}),qt=new S({props:{name:"forward",anchor:"transformers.LukeForMaskedLM.forward",parameters:[{name:"input_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"attention_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"token_type_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"position_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"entity_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"entity_attention_mask",val:": typing.Optional[torch.LongTensor] = None"},{name:"entity_token_type_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"entity_position_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"labels",val:": typing.Optional[torch.LongTensor] = None"},{name:"entity_labels",val:": typing.Optional[torch.LongTensor] = None"},{name:"head_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.LukeForMaskedLM.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/main/en/model_doc/luke#transformers.LukeTokenizer">LukeTokenizer</a>. See <a href="/docs/transformers/main/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/main/en/model_doc/wav2vec2_phoneme#transformers.Wav2Vec2PhonemeCTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
model. Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/main/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/luke/modeling_luke.py#L1384"}}),Bt=new S({props:{name:"forward",anchor:"transformers.LukeForEntityPairClassification.forward",parameters:[{name:"input_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"attention_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"token_type_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"position_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"entity_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"entity_attention_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"entity_token_type_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"entity_position_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"head_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"labels",val:": typing.Optional[torch.LongTensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.LukeForEntityPairClassification.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/main/en/model_doc/luke#transformers.LukeTokenizer">LukeTokenizer</a>. See <a href="/docs/transformers/main/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/main/en/model_doc/wav2vec2_phoneme#transformers.Wav2Vec2PhonemeCTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
model. Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/main/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/luke/modeling_luke.py#L1504"}}),Yt=new S({props:{name:"forward",anchor:"transformers.LukeForEntitySpanClassification.forward",parameters:[{name:"input_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"position_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"entity_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"entity_attention_mask",val:": typing.Optional[torch.LongTensor] = None"},{name:"entity_token_type_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"entity_position_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"entity_start_positions",val:": typing.Optional[torch.LongTensor] = None"},{name:"entity_end_positions",val:": typing.Optional[torch.LongTensor] = None"},{name:"head_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"labels",val:": typing.Optional[torch.LongTensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.LukeForEntitySpanClassification.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/main/en/model_doc/luke#transformers.LukeTokenizer">LukeTokenizer</a>. See <a href="/docs/transformers/main/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/main/en/model_doc/wav2vec2_phoneme#transformers.Wav2Vec2PhonemeCTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
`),Qn=a("code"),ia=o("entity_token_type_ids"),ra=o(" and "),Jn=a("code"),la=o("entity_position_ids"),da=o(` as extra input. You can obtain those using
...
`),io=a("code"),Xa=o('task="entity_span_classification"'),Ga=o(". Please refer to the example code of each head models."),Za=c(),ie=a("p"),ei=o("A demo notebook on how to fine-tune "),hn=a("a"),ti=o("LukeForEntityPairClassification"),ni=o(` for relation
...
`),go=a("code"),Ji=o("entity_position_ids"),Xi=o(" to be used by the LUKE model."),Gi=c(),qe=a("div"),b(_t.$$.fragment),Zi=c(),_o=a("p"),er=o(`Main method to tokenize and prepare for the model one or several sequence(s) or one or several pair(s) of
...
and behavior.`),mr=c(),K=a("div"),b(Lt.$$.fragment),fr=c(),he=a("p"),gr=o("The "),Tn=a("a"),_r=o("LukeModel"),kr=o(" forward method, overrides the "),vo=a("code"),yr=o("__call__"),br=o(" special method."),vr=c(),b(Me.$$.fragment),Tr=c(),b(Pe.$$.fragment),ps=c(),ue=a("h2"),je=a("a"),To=a("span"),b(Et.$$.fragment),wr=c(),wo=a("span"),Lr=o("LukeForMaskedLM"),hs=c(),P=a("div"),b(zt.$$.fragment),Er=c(),Lo=a("p"),zr=o(`The LUKE model with a language modeling head and entity prediction head on top for masked language modeling and
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Fr=c(),xt=a("p"),Mr=o("This model is also a PyTorch "),Ct=a("a"),Pr=o("torch.nn.Module"),jr=o(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Ar=c(),J=a("div"),b(qt.$$.fragment),Ir=c(),me=a("p"),Or=o("The "),Ln=a("a"),Sr=o("LukeForMaskedLM"),Nr=o(" forward method, overrides the "),Eo=a("code"),Dr=o("__call__"),Wr=o(" special method."),Br=c(),b(Ae.$$.fragment),us=c(),fe=a("h2"),Ie=a("a"),zo=a("span"),b(Ft.$$.fragment),Ur=c(),$o=a("span"),Kr=o("LukeForEntityClassification"),ms=c(),j=a("div"),b(Mt.$$.fragment),Rr=c(),xo=a("p"),Vr=o(`The LUKE model with a classification head on top (a linear layer on top of the hidden state of the first entity
token) for entity classification tasks, such as Open Entity.`),Hr=c(),Pt=a("p"),Yr=o("This model inherits from "),En=a("a"),Qr=o("PreTrainedModel"),Jr=o(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Xr=c(),jt=a("p"),Gr=o("This model is also a PyTorch "),At=a("a"),Zr=o("torch.nn.Module"),el=o(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Ul=c(),H=a("div"),b(Yt.$$.fragment),Kl=c(),be=a("p"),Rl=o("The "),qn=a("a"),Vl=o("LukeForEntitySpanClassification"),Hl=o(" forward method, overrides the "),Oo=a("code"),Yl=o("__call__"),Ql=o(" special method."),Jl=c(),b(Ue.$$.fragment),Xl=c(),b(Ke.$$.fragment),this.h()},l(n){const m=Vc('[data-svelte="svelte-1phssyn"]',document.head);h=i(m,"META",{name:!0,content:!0}),m.forEach(t),y=p(n),g=i(n,"H1",{class:!0});var Qt=r(g);f=i(Qt,"A",{id:!0,class:!0,href:!0});var So=r(f);k=i(So,"SPAN",{});var No=r(k);v(l.$$.fragment,No),No.forEach(t),So.forEach(t),u=p(Qt),$=i(Qt,"SPAN",{});var Do=r($);Bs=s(Do,"LUKE"),Do.forEach(t),Qt.forEach(t),Jo=p(n),se=i(n,"H2",{class:!0});var Jt=r(se);we=i(Jt,"A",{id:!0,class:!0,href:!0});var Wo=r(we);Bn=i(Wo,"SPAN",{});var Bo=r(Bn);v(Ge.$$.fragment,Bo),Bo.forEach(t),Wo.forEach(t),Us=p(Jt),Un=i(Jt,"SPAN",{});var Uo=r(Un);Ks=s(Uo,"Overview"),Uo.forEach(t),Jt.forEach(t),Xo=p(n),Le=i(n,"P",{});var Xt=r(Le);Rs=s(Xt,"The LUKE model was proposed in "),Ze=i(Xt,"A",{href:!0,rel:!0});var Ko=r(Ze);Vs=s(Ko,"LUKE: Deep Contextualized Entity Representations with Entity-aware Self-attention"),Ko.forEach(t),Hs=s(Xt,` by Ikuya Yamada, Akari Asai, Hiroyuki Shindo, Hideaki Takeda and Yuji Matsumoto.
It is based on RoBERTa and adds entity embeddings as well as an entity-aware self-attention mechanism, which helps
improve performance on various downstream tasks involving reasoning about entities such as named entity recognition,
extractive and cloze-style question answering, entity typing, and relation classification.`),Xt.forEach(t),Go=p(n),Gt=i(n,"P",{});var td=r(Gt);Ys=s(td,"The abstract from the paper is the following:"),td.forEach(t),Zo=p(n),Zt=i(n,"P",{});var nd=r(Zt);Kn=i(nd,"EM",{});var od=r(Kn);Qs=s(od,`Entity representations are useful in natural language tasks involving entities. In this paper, we propose new
pretrained contextualized representations of words and entities based on the bidirectional transformer. The proposed
model treats words and entities in a given text as independent tokens, and outputs contextualized representations of
them. Our model is trained using a new pretraining task based on the masked language model of BERT. The task involves
predicting randomly masked words and entities in a large entity-annotated corpus retrieved from Wikipedia. We also
...
state-of-the-art results on five well-known datasets: Open Entity (entity typing), TACRED (relation classification),
CoNLL-2003 (named entity recognition), ReCoRD (cloze-style question answering), and SQuAD 1.1 (extractive question
answering).`),od.forEach(t),nd.forEach(t),es=p(n),en=i(n,"P",{});var sd=r(en);Js=s(sd,"Tips:"),sd.forEach(t),ts=p(n),W=i(n,"UL",{});var Re=r(W);Rn=i(Re,"LI",{});var ad=r(Rn);et=i(ad,"P",{});var bs=r(et);Xs=s(bs,"This implementation is the same as "),tn=i(bs,"A",{href:!0});var id=r(tn);Gs=s(id,"RobertaModel"),id.forEach(t),Zs=s(bs,` with the addition of entity embeddings as well
...
`),Qn=i(Y,"CODE",{});var cd=r(Qn);ia=s(cd,"entity_token_type_ids"),cd.forEach(t),ra=s(Y," and "),Jn=i(Y,"CODE",{});var pd=r(Jn);la=s(pd,"entity_position_ids"),pd.forEach(t),da=s(Y,` as extra input. You can obtain those using
`),nn=i(Y,"A",{href:!0});var hd=r(nn);ca=s(hd,"LukeTokenizer"),hd.forEach(t),pa=s(Y,"."),Y.forEach(t),rd.forEach(t),ha=p(Re),tt=i(Re,"LI",{});var vs=r(tt);B=i(vs,"P",{});var ve=r(B);on=i(ve,"A",{href:!0});var ud=r(on);ua=s(ud,"LukeTokenizer"),ud.forEach(t),ma=s(ve," takes "),Xn=i(ve,"CODE",{});var md=r(Xn);fa=s(md,"entities"),md.forEach(t),ga=s(ve," and "),Gn=i(ve,"CODE",{});var fd=r(Gn);_a=s(fd,"entity_spans"),fd.forEach(t),ka=s(ve,` (character-based start and end
...
Wikipedia entities. The brief description when inputting these entities are as follows:`),ve.forEach(t),va=p(vs),nt=i(vs,"UL",{});var Ts=r(nt);sn=i(Ts,"LI",{});var Gl=r(sn);eo=i(Gl,"EM",{});var _d=r(eo);Ta=s(_d,"Inputting [MASK] entities to compute entity representations"),_d.forEach(t),wa=s(Gl,`: The [MASK] entity is used to mask entities to be
predicted during pretraining. When LUKE receives the [MASK] entity, it tries to predict the original entity by
gathering the information about the entity from the input text. Therefore, the [MASK] entity can be used to address
downstream tasks requiring the information of entities in text such as entity typing, relation classification, and
named entity recognition.`),Gl.forEach(t),La=p(Ts),an=i(Ts,"LI",{});var Zl=r(an);to=i(Zl,"EM",{});var kd=r(to);Ea=s(kd,"Inputting Wikipedia entities to compute knowledge-enhanced token representations"),kd.forEach(t),za=s(Zl,`: LUKE learns rich information
(or knowledge) about Wikipedia entities during pretraining and stores the information in its entity embedding. By
using Wikipedia entities as input tokens, LUKE outputs token representations enriched by the information stored in
the embeddings of these entities. This is particularly effective for tasks requiring real-world knowledge, such as
question answering.`),Zl.forEach(t),Ts.forEach(t),vs.forEach(t),$a=p(Re),N=i(Re,"LI",{});var X=r(N);no=i(X,"P",{});var yd=r(no);xa=s(yd,"There are three head models for the former use case:"),yd.forEach(t),Ca=p(X),ae=i(X,"UL",{});var Fn=r(ae);Ee=i(Fn,"LI",{});var Ro=r(Ee);rn=i(Ro,"A",{href:!0});var bd=r(rn);qa=s(bd,"LukeForEntityClassification"),bd.forEach(t),Fa=s(Ro,`, for tasks to classify a single entity in an input text such as
entity typing, e.g. the `),ot=i(Ro,"A",{href:!0,rel:!0});var vd=r(ot);Ma=s(vd,"Open Entity dataset"),vd.forEach(t),Pa=s(Ro,`.
This model places a linear head on top of the output entity representation.`),Ro.forEach(t),ja=p(Fn),ze=i(Fn,"LI",{});var Vo=r(ze);ln=i(Vo,"A",{href:!0});var Td=r(ln);Aa=s(Td,"LukeForEntityPairClassification"),Td.forEach(t),Ia=s(Vo,`, for tasks to classify the relationship between two entities
...
named entity recognition (NER). This model places a linear head on top of the output entity representations. You
can address NER using this model by inputting all possible entity spans in the text to the model.`),ed.forEach(t),Fn.forEach(t),Ba=p(X),O=i(X,"P",{});var Q=r(O);pn=i(Q,"A",{href:!0});var Ed=r(pn);Ua=s(Ed,"LukeTokenizer"),Ed.forEach(t),Ka=s(Q," has a "),oo=i(Q,"CODE",{});var zd=r(oo);Ra=s(zd,"task"),zd.forEach(t),Va=s(Q,` argument, which enables you to easily create an input to these
head models by specifying `),so=i(Q,"CODE",{});var $d=r(so);Ha=s($d,'task="entity_classification"'),$d.forEach(t),Ya=s(Q,", "),ao=i(Q,"CODE",{});var xd=r(ao);Qa=s(xd,'task="entity_pair_classification"'),xd.forEach(t),Ja=s(Q,`, or
`),io=i(Q,"CODE",{});var Cd=r(io);Xa=s(Cd,'task="entity_span_classification"'),Cd.forEach(t),Ga=s(Q,". Please refer to the example code of each head models."),Q.forEach(t),Za=p(X),ie=i(X,"P",{});var Mn=r(ie);ei=s(Mn,"A demo notebook on how to fine-tune "),hn=i(Mn,"A",{href:!0});var qd=r(hn);ti=s(qd,"LukeForEntityPairClassification"),qd.forEach(t),ni=s(Mn,` for relation
classification can be found `),at=i(Mn,"A",{href:!0,rel:!0});var Fd=r(at);oi=s(Fd,"here"),Fd.forEach(t),si=s(Mn,"."),Mn.forEach(t),ai=p(X),it=i(X,"P",{});var ws=r(it);ii=s(ws,`There are also 3 notebooks available, which showcase how you can reproduce the results as reported in the paper with
the HuggingFace implementation of LUKE. They can be found `),rt=i(ws,"A",{href:!0,rel:!0});var Md=r(rt);ri=s(Md,"here"),Md.forEach(t),li=s(ws,"."),ws.forEach(t),X.forEach(t),Re.forEach(t),ns=p(n),un=i(n,"P",{});var Pd=r(un);di=s(Pd,"Example:"),Pd.forEach(t),os=p(n),v(lt.$$.fragment,n),ss=p(n),U=i(n,"P",{});var Ve=r(U);ci=s(Ve,"This model was contributed by "),dt=i(Ve,"A",{href:!0,rel:!0});var jd=r(dt);pi=s(jd,"ikuyamada"),jd.forEach(t),hi=s(Ve," and "),ct=i(Ve,"A",{href:!0,rel:!0});var Ad=r(ct);ui=s(Ad,"nielsr"),Ad.forEach(t),mi=s(Ve,". The original code can be found "),pt=i(Ve,"A",{href:!0,rel:!0});var Id=r(pt);fi=s(Id,"here"),Id.forEach(t),gi=s(Ve,"."),Ve.forEach(t),as=p(n),re=i(n,"H2",{class:!0});var Ls=r(re);$e=i(Ls,"A",{id:!0,class:!0,href:!0});var Od=r($e);ro=i(Od,"SPAN",{});var Sd=r(ro);v(ht.$$.fragment,Sd),Sd.forEach(t),Od.forEach(t),_i=p(Ls),lo=i(Ls,"SPAN",{});var Nd=r(lo);ki=s(Nd,"LukeConfig"),Nd.forEach(t),Ls.forEach(t),is=p(n),D=i(n,"DIV",{class:!0});var He=r(D);v(ut.$$.fragment,He),yi=p(He),le=i(He,"P",{});var Pn=r(le);bi=s(Pn,"This is the configuration class to store the configuration of a "),mn=i(Pn,"A",{href:!0});var Dd=r(mn);vi=s(Dd,"LukeModel"),Dd.forEach(t),Ti=s(Pn,`. It is used to instantiate a LUKE
model according to the specified arguments, defining the model architecture. Instantiating a configuration with the
defaults will yield a similar configuration to that of the LUKE
`),mt=i(Pn,"A",{href:!0,rel:!0});var Wd=r(mt);wi=s(Wd,"studio-ousia/luke-base"),Wd.forEach(t),Li=s(Pn," architecture."),Pn.forEach(t),Ei=p(He),de=i(He,"P",{});var jn=r(de);zi=s(jn,"Configuration objects inherit from "),fn=i(jn,"A",{href:!0});var Bd=r(fn);$i=s(Bd,"PretrainedConfig"),Bd.forEach(t),xi=s(jn,` and can be used to control the model outputs. Read the
documentation from `),gn=i(jn,"A",{href:!0});var Ud=r(gn);Ci=s(Ud,"PretrainedConfig"),Ud.forEach(t),qi=s(jn," for more information."),jn.forEach(t),Fi=p(He),v(xe.$$.fragment,He),He.forEach(t),rs=p(n),ce=i(n,"H2",{class:!0});var Es=r(ce);Ce=i(Es,"A",{id:!0,class:!0,href:!0});var Kd=r(Ce);co=i(Kd,"SPAN",{});var Rd=r(co);v(ft.$$.fragment,Rd),Rd.forEach(t),Kd.forEach(t),Mi=p(Es),po=i(Es,"SPAN",{});var Vd=r(po);Pi=s(Vd,"LukeTokenizer"),Vd.forEach(t),Es.forEach(t),ls=p(n),F=i(n,"DIV",{class:!0});var G=r(F);v(gt.$$.fragment,G),ji=p(G),ho=i(G,"P",{});var Hd=r(ho);Ai=s(Hd,"Construct a LUKE tokenizer."),Hd.forEach(t),Ii=p(G),x=i(G,"P",{});var C=r(x);Oi=s(C,"This tokenizer inherits from "),_n=i(C,"A",{href:!0});var Yd=r(_n);Si=s(Yd,"RobertaTokenizer"),Yd.forEach(t),Ni=s(C,` which contains most of the main methods. Users should refer to
this superclass for more information regarding those methods. Compared to `),kn=i(C,"A",{href:!0});var Qd=r(kn);Di=s(Qd,"RobertaTokenizer"),Qd.forEach(t),Wi=s(C,", "),yn=i(C,"A",{href:!0});var Jd=r(yn);Bi=s(Jd,"LukeTokenizer"),Jd.forEach(t),Ui=s(C,`
also creates entity sequences, namely `),uo=i(C,"CODE",{});var Xd=r(uo);Ki=s(Xd,"entity_ids"),Xd.forEach(t),Ri=s(C,", "),mo=i(C,"CODE",{});var Gd=r(mo);Vi=s(Gd,"entity_attention_mask"),Gd.forEach(t),Hi=s(C,", "),fo=i(C,"CODE",{});var Zd=r(fo);Yi=s(Zd,"entity_token_type_ids"),Zd.forEach(t),Qi=s(C,`, and
`),go=i(C,"CODE",{});var ec=r(go);Ji=s(ec,"entity_position_ids"),ec.forEach(t),Xi=s(C," to be used by the LUKE model."),C.forEach(t),Gi=p(G),qe=i(G,"DIV",{class:!0});var zs=r(qe);v(_t.$$.fragment,zs),Zi=p(zs),_o=i(zs,"P",{});var tc=r(_o);er=s(tc,`Main method to tokenize and prepare for the model one or several sequence(s) or one or several pair(s) of
sequences, depending on the task you want to prepare them for.`),tc.forEach(t),zs.forEach(t),tr=p(G),bn=i(G,"DIV",{class:!0});var nc=r(bn);v(kt.$$.fragment,nc),nc.forEach(t),G.forEach(t),ds=p(n),pe=i(n,"H2",{class:!0});var $s=r(pe);Fe=i($s,"A",{id:!0,class:!0,href:!0});var oc=r(Fe);ko=i(oc,"SPAN",{});var sc=r(ko);v(yt.$$.fragment,sc),sc.forEach(t),oc.forEach(t),nr=p($s),yo=i($s,"SPAN",{});var ac=r(yo);or=s(ac,"LukeModel"),ac.forEach(t),$s.forEach(t),cs=p(n),M=i(n,"DIV",{class:!0});var Z=r(M);v(bt.$$.fragment,Z),sr=p(Z),bo=i(Z,"P",{});var ic=r(bo);ar=s(ic,"The bare LUKE model transformer outputting raw hidden-states for both word tokens and entities without any specific head on top."),ic.forEach(t),ir=p(Z),vt=i(Z,"P",{});var xs=r(vt);rr=s(xs,"This model inherits from "),vn=i(xs,"A",{href:!0});var rc=r(vn);lr=s(rc,"PreTrainedModel"),rc.forEach(t),dr=s(xs,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Cs.forEach(t),mr=p(Z),K=i(Z,"DIV",{class:!0});var Ye=r(K);v(Lt.$$.fragment,Ye),fr=p(Ye),he=i(Ye,"P",{});var An=r(he);gr=s(An,"The "),Tn=i(An,"A",{href:!0});var dc=r(Tn);_r=s(dc,"LukeModel"),dc.forEach(t),kr=s(An," forward method, overrides the "),vo=i(An,"CODE",{});var cc=r(vo);yr=s(cc,"__call__"),cc.forEach(t),br=s(An," special method."),An.forEach(t),vr=p(Ye),v(Me.$$.fragment,Ye),Tr=p(Ye),v(Pe.$$.fragment,Ye),Ye.forEach(t),Z.forEach(t),ps=p(n),ue=i(n,"H2",{class:!0});var qs=r(ue);je=i(qs,"A",{id:!0,class:!0,href:!0});var pc=r(je);To=i(pc,"SPAN",{});var hc=r(To);v(Et.$$.fragment,hc),hc.forEach(t),pc.forEach(t),wr=p(qs),wo=i(qs,"SPAN",{});var uc=r(wo);Lr=s(uc,"LukeForMaskedLM"),uc.forEach(t),qs.forEach(t),hs=p(n),P=i(n,"DIV",{class:!0});var ee=r(P);v(zt.$$.fragment,ee),Er=p(ee),Lo=i(ee,"P",{});var mc=r(Lo);zr=s(mc,`The LUKE model with a language modeling head and entity prediction head on top for masked language modeling and
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Fs.forEach(t),Fr=p(ee),xt=i(ee,"P",{});var Ms=r(xt);Mr=s(Ms,"This model is also a PyTorch "),Ct=i(Ms,"A",{href:!0,rel:!0});var gc=r(Ct);Pr=s(gc,"torch.nn.Module"),gc.forEach(t),jr=s(Ms,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Ms.forEach(t),Ar=p(ee),J=i(ee,"DIV",{class:!0});var In=r(J);v(qt.$$.fragment,In),Ir=p(In),me=i(In,"P",{});var On=r(me);Or=s(On,"The "),Ln=i(On,"A",{href:!0});var _c=r(Ln);Sr=s(_c,"LukeForMaskedLM"),_c.forEach(t),Nr=s(On," forward method, overrides the "),Eo=i(On,"CODE",{});var kc=r(Eo);Dr=s(kc,"__call__"),kc.forEach(t),Wr=s(On," special method."),On.forEach(t),Br=p(In),v(Ae.$$.fragment,In),In.forEach(t),ee.forEach(t),us=p(n),fe=i(n,"H2",{class:!0});var Ps=r(fe);Ie=i(Ps,"A",{id:!0,class:!0,href:!0});var yc=r(Ie);zo=i(yc,"SPAN",{});var bc=r(zo);v(Ft.$$.fragment,bc),bc.forEach(t),yc.forEach(t),Ur=p(Ps),$o=i(Ps,"SPAN",{});var vc=r($o);Kr=s(vc,"LukeForEntityClassification"),vc.forEach(t),Ps.forEach(t),ms=p(n),j=i(n,"DIV",{class:!0});var te=r(j);v(Mt.$$.fragment,te),Rr=p(te),xo=i(te,"P",{});var Tc=r(xo);Vr=s(Tc,`The LUKE model with a classification head on top (a linear layer on top of the hidden state of the first entity
token) for entity classification tasks, such as Open Entity.`),Tc.forEach(t),Hr=p(te),Pt=i(te,"P",{});var js=r(Pt);Yr=s(js,"This model inherits from "),En=i(js,"A",{href:!0});var wc=r(En);Qr=s(wc,"PreTrainedModel"),wc.forEach(t),Jr=s(js,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),js.forEach(t),Xr=p(te),jt=i(te,"P",{});var As=r(jt);Gr=s(As,"This model is also a PyTorch "),At=i(As,"A",{href:!0,rel:!0});var Lc=r(At);Zr=s(Lc,"torch.nn.Module"),Lc.forEach(t),el=s(As,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Ss.forEach(t),Tl=p(ne),V=i(ne,"DIV",{class:!0});var Je=r(V);v(Bt.$$.fragment,Je),wl=p(Je),ke=i(Je,"P",{});var Nn=r(ke);Ll=s(Nn,"The "),xn=i(Nn,"A",{href:!0});var Pc=r(xn);El=s(Pc,"LukeForEntityPairClassification"),Pc.forEach(t),zl=s(Nn," forward method, overrides the "),Po=i(Nn,"CODE",{});var jc=r(Po);$l=s(jc,"__call__"),jc.forEach(t),xl=s(Nn," special method."),Nn.forEach(t),Cl=p(Je),v(De.$$.fragment,Je),ql=p(Je),v(We.$$.fragment,Je),Je.forEach(t),ne.forEach(t),_s=p(n),ye=i(n,"H2",{class:!0});var Ns=r(ye);Be=i(Ns,"A",{id:!0,class:!0,href:!0});var Ac=r(Be);jo=i(Ac,"SPAN",{});var Ic=r(jo);v(Ut.$$.fragment,Ic),Ic.forEach(t),Ac.forEach(t),Fl=p(Ns),Ao=i(Ns,"SPAN",{});var Oc=r(Ao);Ml=s(Oc,"LukeForEntitySpanClassification"),Oc.forEach(t),Ns.forEach(t),ks=p(n),I=i(n,"DIV",{class:!0});var oe=r(I);v(Kt.$$.fragment,oe),Pl=p(oe),Io=i(oe,"P",{});var Sc=r(Io);jl=s(Sc,`The LUKE model with a span classification head on top (a linear layer on top of the hidden states output) for tasks
