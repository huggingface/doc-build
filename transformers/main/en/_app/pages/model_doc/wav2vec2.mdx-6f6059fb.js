...
the latter silently ignores them.`)},l(l){c=s(l,"P",{});var u=n(c);b=i(u,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=s(u,"CODE",{});var j=n(f);h=i(j,"Module"),j.forEach(t),v=i(u,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),u.forEach(t)},m(l,u){_(l,c,u),e(c,b),e(c,f),e(f,h),e(c,v)},d(l){l&&t(c)}}}function M0(W){let c,b,f,h,v;return h=new ue({props:{code:`from transformers import Wav2Vec2FeatureExtractor, Wav2Vec2ForSequenceClassification
from datasets import load_dataset
import torch
...
first positional argument :`),qe.forEach(t),Se=p(V),M=s(V,"UL",{});var X=n(M);I=s(X,"LI",{});var G=n(I);Fe=i(G,"a single Tensor with "),ve=s(G,"CODE",{});var At=n(ve);He=i(At,"input_values"),At.forEach(t),Ce=i(G," only and nothing else: "),oe=s(G,"CODE",{});var mt=n(oe);lt=i(mt,"model(inputs_ids)"),mt.forEach(t),G.forEach(t),Re=p(X),L=s(X,"LI",{});var Te=n(L);ct=i(Te,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),de=s(Te,"CODE",{});var xt=n(de);pe=i(xt,"model([input_values, attention_mask])"),xt.forEach(t),Ne=i(Te," or "),be=s(Te,"CODE",{});var J=n(be);dt=i(J,"model([input_values, attention_mask, token_type_ids])"),J.forEach(t),Te.forEach(t),we=p(X),ae=s(X,"LI",{});var $e=n(ae);Ee=i($e,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),ye=s($e,"CODE",{});var Ot=n(ye);pt=i(Ot,'model({"input_values": input_values, "token_type_ids": token_type_ids})'),Ot.forEach(t),$e.forEach(t),X.forEach(t)},m(V,E){_(V,c,E),e(c,b),_(V,f,E),_(V,h,E),e(h,v),e(v,l),e(h,u),e(h,j),e(j,D),_(V,P,E),_(V,C,E),e(C,A),e(C,O),e(O,R),e(C,S),e(C,q),e(q,je),e(C,ge),_(V,B,E),_(V,U,E),e(U,_e),_(V,Se,E),_(V,M,E),e(M,I),e(I,Fe),e(I,ve),e(ve,He),e(I,Ce),e(I,oe),e(oe,lt),e(M,Re),e(M,L),e(L,ct),e(L,de),e(de,pe),e(L,Ne),e(L,be),e(be,dt),e(M,we),e(M,ae),e(ae,Ee),e(ae,ye),e(ye,pt)},d(V){V&&t(c),V&&t(f),V&&t(h),V&&t(P),V&&t(C),V&&t(B),V&&t(U),V&&t(Se),V&&t(M)}}}function R0(W){let c,b,f,h,v;return{c(){c=a("p"),b=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=a("code"),h=r("Module"),v=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(l){c=s(l,"P",{});var u=n(c);b=i(u,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=s(u,"CODE",{});var j=n(f);h=i(j,"Module"),j.forEach(t),v=i(u,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
**kwargs &#x2014; passed to the <code>self.tokenize()</code> method`,name:"verbose"}],source:"https://github.com/huggingface/transformers/blob/vain/src/transformers/tokenization_utils_base.py#L2374",returnDescription:`
<p>A <a
...
Will be passed to the underlying model specific decode method.`,name:"kwargs"}],source:"https://github.com/huggingface/transformers/blob/vain/src/transformers/models/wav2vec2/tokenization_wav2vec2.py#L488",returnDescription:`
...
Will be passed to the underlying model specific decode method.`,name:"kwargs"}],source:"https://github.com/huggingface/transformers/blob/vain/src/transformers/models/wav2vec2/tokenization_wav2vec2.py#L418",returnDescription:`
<p>The list of decoded
sentences. Will be a <code>Wav2Vec2CTCTokenizerOutput</code> when
<code>output_char_offsets == True</code> or <code>output_word_offsets == True</code>.</p>
`,returnType:`
...
<code>sampling_rate</code> at the forward call to prevent silent errors.`,name:"sampling_rate"},{anchor:"transformers.Wav2Vec2FeatureExtractor.__call__.padding_value",description:"<strong>padding_value</strong> (<code>float</code>, defaults to 0.0) &#x2014;",name:"padding_value"}],source:"https://github.com/huggingface/transformers/blob/vain/src/transformers/models/wav2vec2/feature_extraction_wav2vec2.py#L102"}}),is=new ee({}),ls=new F({props:{name:"class transformers.Wav2Vec2Processor",anchor:"transformers.Wav2Vec2Processor",parameters:[{name:"feature_extractor",val:""},{name:"tokenizer",val:""}],parametersDescription:[{anchor:"transformers.Wav2Vec2Processor.feature_extractor",description:`<strong>feature_extractor</strong> (<code>Wav2Vec2FeatureExtractor</code>) &#x2014;
...
An instance of <a href="/docs/transformers/main/en/main_classes/tokenizer#transformers.PreTrainedTokenizer">PreTrainedTokenizer</a>. The tokenizer is a required input.`,name:"tokenizer"}],source:"https://github.com/huggingface/transformers/blob/vain/src/transformers/models/wav2vec2/processing_wav2vec2.py#L26"}}),ds=new F({props:{name:"__call__",anchor:"transformers.Wav2Vec2Processor.__call__",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/vain/src/transformers/models/wav2vec2/processing_wav2vec2.py#L66"}}),hs=new F({props:{name:"pad",anchor:"transformers.Wav2Vec2Processor.pad",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/vain/src/transformers/models/wav2vec2/processing_wav2vec2.py#L75"}}),fs=new F({props:{name:"from_pretrained",anchor:"transformers.Wav2Vec2Processor.from_pretrained",parameters:[{name:"pretrained_model_name_or_path",val:""},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/vain/src/transformers/models/wav2vec2/processing_wav2vec2.py#L47"}}),us=new F({props:{name:"save_pretrained",anchor:"transformers.Wav2Vec2Processor.save_pretrained",parameters:[{name:"save_directory",val:""},{name:"push_to_hub",val:": bool = False"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.Wav2Vec2Processor.save_pretrained.save_directory",description:`<strong>save_directory</strong> (<code>str</code> or <code>os.PathLike</code>) &#x2014;
...
output.</p>
					...
					</div>`,name:"output_word_offsets"}],source:"https://github.com/huggingface/transformers/blob/vain/src/transformers/models/wav2vec2_with_lm/processing_wav2vec2_with_lm.py#L229",returnDescription:`
...
better understand how to make use of <code>output_word_offsets</code>.</p>
					...
					</div>`,name:"output_word_offsets"}],source:"https://github.com/huggingface/transformers/blob/vain/src/transformers/models/wav2vec2_with_lm/processing_wav2vec2_with_lm.py#L346",returnDescription:`
<p><code>Wav2Vec2DecoderWithLMOutput</code> or <code>tuple</code>.</p>
...
Whether or not to return a <a href="/docs/transformers/main/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vain/src/transformers/models/wav2vec2/modeling_wav2vec2.py#L1323",returnDescription:`
<p>A <a
...
All labels set to <code>-100</code> are ignored (masked), the loss is only computed for labels in <code>[0, ..., config.vocab_size - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vain/src/transformers/models/wav2vec2/modeling_wav2vec2.py#L1688",returnDescription:`
<p>A <a
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/main/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/vain/src/transformers/models/wav2vec2/modeling_wav2vec2.py#L1777"}}),gn=new F({props:{name:"forward",anchor:"transformers.Wav2Vec2ForSequenceClassification.forward",parameters:[{name:"input_values",val:": typing.Optional[torch.Tensor]"},{name:"attention_mask",val:": typing.Optional[torch.Tensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"labels",val:": typing.Optional[torch.Tensor] = None"}],parametersDescription:[{anchor:"transformers.Wav2Vec2ForSequenceClassification.forward.input_values",description:`<strong>input_values</strong> (<code>torch.FloatTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Float values of input raw speech waveform. Values can be obtained by loading a <em>.flac</em> or <em>.wav</em> audio file
into an array of type <em>List[float]</em> or a <em>numpy.ndarray</em>, <em>e.g.</em> via the soundfile library (<em>pip install
soundfile</em>). To prepare the array into <em>input_values</em>, the <a href="/docs/transformers/main/en/model_doc/wav2vec2#transformers.Wav2Vec2Processor">Wav2Vec2Processor</a> should be used for padding
...
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vain/src/transformers/models/wav2vec2/modeling_wav2vec2.py#L1822",returnDescription:`
<p>A <a
...
`}}),ta=new me({props:{$$slots:{default:[P0]},$$scope:{ctx:W}}}),oa=new he({props:{anchor:"transformers.Wav2Vec2ForSequenceClassification.forward.example",$$slots:{default:[M0]},$$scope:{ctx:W}}}),aa=new he({props:{anchor:"transformers.Wav2Vec2ForSequenceClassification.forward.example-2",$$slots:{default:[z0]},$$scope:{ctx:W}}}),_n=new ee({}),vn=new F({props:{name:"class transformers.Wav2Vec2ForAudioFrameClassification",anchor:"transformers.Wav2Vec2ForAudioFrameClassification",parameters:[{name:"config",val:""}],parametersDescription:[{anchor:"transformers.Wav2Vec2ForAudioFrameClassification.config",description:`<strong>config</strong> (<a href="/docs/transformers/main/en/model_doc/wav2vec2#transformers.Wav2Vec2Config">Wav2Vec2Config</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/main/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/vain/src/transformers/models/wav2vec2/modeling_wav2vec2.py#L1900"}}),$n=new F({props:{name:"forward",anchor:"transformers.Wav2Vec2ForAudioFrameClassification.forward",parameters:[{name:"input_values",val:": typing.Optional[torch.Tensor]"},{name:"attention_mask",val:": typing.Optional[torch.Tensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.Wav2Vec2ForAudioFrameClassification.forward.input_values",description:`<strong>input_values</strong> (<code>torch.FloatTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Float values of input raw speech waveform. Values can be obtained by loading a <em>.flac</em> or <em>.wav</em> audio file
into an array of type <em>List[float]</em> or a <em>numpy.ndarray</em>, <em>e.g.</em> via the soundfile library (<em>pip install
soundfile</em>). To prepare the array into <em>input_values</em>, the <a href="/docs/transformers/main/en/model_doc/wav2vec2#transformers.Wav2Vec2Processor">Wav2Vec2Processor</a> should be used for padding
...
Labels for computing the sequence classification/regression loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>. If <code>config.num_labels == 1</code> a regression loss is computed (Mean-Square loss), If
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vain/src/transformers/models/wav2vec2/modeling_wav2vec2.py#L1943",returnDescription:`
<p>A <a
...
Labels for computing the sequence classification/regression loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>. If <code>config.num_labels == 1</code> a regression loss is computed (Mean-Square loss), If
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vain/src/transformers/models/wav2vec2/modeling_wav2vec2.py#L2117",returnDescription:`
...
`}}),la=new me({props:{$$slots:{default:[L0]},$$scope:{ctx:W}}}),ca=new he({props:{anchor:"transformers.Wav2Vec2ForXVector.forward.example",$$slots:{default:[D0]},$$scope:{ctx:W}}}),Pn=new ee({}),Mn=new F({props:{name:"class transformers.Wav2Vec2ForPreTraining",anchor:"transformers.Wav2Vec2ForPreTraining",parameters:[{name:"config",val:": Wav2Vec2Config"}],parametersDescription:[{anchor:"transformers.Wav2Vec2ForPreTraining.config",description:`<strong>config</strong> (<a href="/docs/transformers/main/en/model_doc/wav2vec2#transformers.Wav2Vec2Config">Wav2Vec2Config</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/main/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/vain/src/transformers/models/wav2vec2/modeling_wav2vec2.py#L1386"}}),Dn=new F({props:{name:"forward",anchor:"transformers.Wav2Vec2ForPreTraining.forward",parameters:[{name:"input_values",val:": typing.Optional[torch.Tensor]"},{name:"attention_mask",val:": typing.Optional[torch.Tensor] = None"},{name:"mask_time_indices",val:": typing.Optional[torch.BoolTensor] = None"},{name:"sampled_negative_indices",val:": typing.Optional[torch.BoolTensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.Wav2Vec2ForPreTraining.forward.input_values",description:`<strong>input_values</strong> (<code>torch.FloatTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Float values of input raw speech waveform. Values can be obtained by loading a <em>.flac</em> or <em>.wav</em> audio file
into an array of type <em>List[float]</em> or a <em>numpy.ndarray</em>, <em>e.g.</em> via the soundfile library (<em>pip install
soundfile</em>). To prepare the array into <em>input_values</em>, the <a href="/docs/transformers/main/en/model_doc/wav2vec2#transformers.Wav2Vec2Processor">Wav2Vec2Processor</a> should be used for padding
...
Required input for pre-training.`,name:"sampled_negative_indices"}],source:"https://github.com/huggingface/transformers/blob/vain/src/transformers/models/wav2vec2/modeling_wav2vec2.py#L1447",returnDescription:`
<p>A <a
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/main/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/vain/src/transformers/models/wav2vec2/modeling_tf_wav2vec2.py#L1428"}}),fa=new me({props:{$$slots:{default:[I0]},$$scope:{ctx:W}}}),Hn=new F({props:{name:"call",anchor:"transformers.TFWav2Vec2Model.call",parameters:[{name:"input_values",val:": Tensor"},{name:"attention_mask",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"token_type_ids",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"position_ids",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"head_mask",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"inputs_embeds",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"training",val:": bool = False"}],parametersDescription:[{anchor:"transformers.TFWav2Vec2Model.call.input_values",description:`<strong>input_values</strong> (<code>np.ndarray</code>, <code>tf.Tensor</code>, <code>List[tf.Tensor]</code> \`<code>Dict[str, tf.Tensor]</code> or <code>Dict[str, np.ndarray]</code> and each example must have the shape <code>({0})</code>) &#x2014;
...
behaviors between training and evaluation).`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/vain/src/transformers/models/wav2vec2/modeling_tf_wav2vec2.py#L1434",returnDescription:`
<p>A <a
...
`}}),ua=new me({props:{$$slots:{default:[B0]},$$scope:{ctx:W}}}),ga=new he({props:{anchor:"transformers.TFWav2Vec2Model.call.example",$$slots:{default:[U0]},$$scope:{ctx:W}}}),Rn=new ee({}),Xn=new F({props:{name:"class transformers.TFWav2Vec2ForCTC",anchor:"transformers.TFWav2Vec2ForCTC",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.TFWav2Vec2ForCTC.config",description:`<strong>config</strong> (<a href="/docs/transformers/main/en/model_doc/wav2vec2#transformers.Wav2Vec2Config">Wav2Vec2Config</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/main/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/vain/src/transformers/models/wav2vec2/modeling_tf_wav2vec2.py#L1531"}}),va=new me({props:{$$slots:{default:[H0]},$$scope:{ctx:W}}}),Qn=new F({props:{name:"call",anchor:"transformers.TFWav2Vec2ForCTC.call",parameters:[{name:"input_values",val:": Tensor"},{name:"attention_mask",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"token_type_ids",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"position_ids",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"head_mask",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"inputs_embeds",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"labels",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"training",val:": typing.Optional[bool] = False"}],parametersDescription:[{anchor:"transformers.TFWav2Vec2ForCTC.call.input_values",description:`<strong>input_values</strong> (<code>np.ndarray</code>, <code>tf.Tensor</code>, <code>List[tf.Tensor]</code> \`<code>Dict[str, tf.Tensor]</code> or <code>Dict[str, np.ndarray]</code> and each example must have the shape <code>({0})</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/main/en/model_doc/bert#transformers.BertTokenizer">BertTokenizer</a>. See <a href="/docs/transformers/main/en/model_doc/wav2vec2_phoneme#transformers.Wav2Vec2PhonemeCTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
<a href="/docs/transformers/main/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> for details.</p>
...
the loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vain/src/transformers/models/wav2vec2/modeling_tf_wav2vec2.py#L1558",returnDescription:`
<p>A <a
...
`}}),ba=new me({props:{$$slots:{default:[R0]},$$scope:{ctx:W}}}),wa=new he({props:{anchor:"transformers.TFWav2Vec2ForCTC.call.example",$$slots:{default:[X0]},$$scope:{ctx:W}}}),Yn=new ee({}),er=new F({props:{name:"class transformers.FlaxWav2Vec2Model",anchor:"transformers.FlaxWav2Vec2Model",parameters:[{name:"config",val:": Wav2Vec2Config"},{name:"input_shape",val:": typing.Tuple = (1, 1024)"},{name:"seed",val:": int = 0"},{name:"dtype",val:": dtype = <class 'jax._src.numpy.lax_numpy.float32'>"},{name:"_do_init",val:": bool = True"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.FlaxWav2Vec2Model.config",description:`<strong>config</strong> (<a href="/docs/transformers/main/en/model_doc/wav2vec2#transformers.Wav2Vec2Config">Wav2Vec2Config</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
...
<a href="/docs/transformers/main/en/main_classes/model#transformers.FlaxPreTrainedModel.to_bf16">to_bf16()</a>.`,name:"dtype"}],source:"https://github.com/huggingface/transformers/blob/vain/src/transformers/models/wav2vec2/modeling_flax_wav2vec2.py#L1055"}}),dr=new F({props:{name:"__call__",anchor:"transformers.FlaxWav2Vec2Model.__call__",parameters:[{name:"input_values",val:""},{name:"attention_mask",val:" = None"},{name:"mask_time_indices",val:" = None"},{name:"params",val:": dict = None"},{name:"dropout_rng",val:": PRNGKey = None"},{name:"train",val:": bool = False"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"freeze_feature_encoder",val:": bool = False"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.FlaxWav2Vec2Model.__call__.input_values",description:`<strong>input_values</strong> (<code>jnp.ndarray</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Float values of input raw speech waveform. Values can be obtained by loading a <em>.flac</em> or <em>.wav</em> audio file
into an array of type <em>List[float]</em> or a <em>numpy.ndarray</em>, <em>e.g.</em> via the soundfile library (<em>pip install
soundfile</em>). To prepare the array into <em>input_values</em>, the <a href="/docs/transformers/main/en/model_doc/wav2vec2#transformers.Wav2Vec2Processor">Wav2Vec2Processor</a> should be used for padding
...
Whether or not to return a <a href="/docs/transformers/main/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vain/src/transformers/models/wav2vec2/modeling_flax_wav2vec2.py#L887",returnDescription:`
<p>A <a
...
parameters.</strong></p>
<p>If you wish to change the dtype of the model parameters, see <a href="/docs/transformers/main/en/main_classes/model#transformers.FlaxPreTrainedModel.to_fp16">to_fp16()</a> and
<a href="/docs/transformers/main/en/main_classes/model#transformers.FlaxPreTrainedModel.to_bf16">to_bf16()</a>.`,name:"dtype"}],source:"https://github.com/huggingface/transformers/blob/vain/src/transformers/models/wav2vec2/modeling_flax_wav2vec2.py#L1319"}}),qr=new F({props:{name:"__call__",anchor:"transformers.FlaxWav2Vec2ForPreTraining.__call__",parameters:[{name:"input_values",val:""},{name:"attention_mask",val:" = None"},{name:"mask_time_indices",val:" = None"},{name:"gumbel_temperature",val:": int = 1"},{name:"params",val:": dict = None"},{name:"dropout_rng",val:": PRNGKey = None"},{name:"gumbel_rng",val:": PRNGKey = None"},{name:"train",val:": bool = False"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"freeze_feature_encoder",val:": bool = False"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.FlaxWav2Vec2ForPreTraining.__call__.input_values",description:`<strong>input_values</strong> (<code>jnp.ndarray</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Float values of input raw speech waveform. Values can be obtained by loading a <em>.flac</em> or <em>.wav</em> audio file
into an array of type <em>List[float]</em> or a <em>numpy.ndarray</em>, <em>e.g.</em> via the soundfile library (<em>pip install
soundfile</em>). To prepare the array into <em>input_values</em>, the <a href="/docs/transformers/main/en/model_doc/wav2vec2#transformers.Wav2Vec2Processor">Wav2Vec2Processor</a> should be used for padding
...
Whether or not to return a <a href="/docs/transformers/main/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vain/src/transformers/models/wav2vec2/modeling_flax_wav2vec2.py#L1322",returnDescription:`
<p>A <a
...
`}}),ja=new me({props:{$$slots:{default:[Q0]},$$scope:{ctx:W}}}),Fa=new he({props:{anchor:"transformers.FlaxWav2Vec2ForPreTraining.__call__.example",$$slots:{default:[Y0]},$$scope:{ctx:W}}}),{c(){c=a("meta"),b=d(),f=a("h1"),h=a("a"),v=a("span"),w(l.$$.fragment),u=d(),j=a("span"),D=r("Wav2Vec2"),P=d(),C=a("h2"),A=a("a"),O=a("span"),w(R.$$.fragment),S=d(),q=a("span"),je=r("Overview"),ge=d(),B=a("p"),U=r("The Wav2Vec2 model was proposed in "),_e=a("a"),Se=r("wav2vec 2.0: A Framework for Self-Supervised Learning of Speech Representations"),M=r(" by Alexei Baevski, Henry Zhou, Abdelrahman Mohamed, Michael Auli."),I=d(),Fe=a("p"),ve=r("The abstract from the paper is the following:"),He=d(),Ce=a("p"),oe=a("em"),lt=r(`We show for the first time that learning powerful representations from speech audio alone followed by fine-tuning on
...
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),Tp.forEach(t),Cu=p(Ct),Ge=s(Ct,"DIV",{class:!0});var Aa=n(Ge);y(en.$$.fragment,Aa),Eu=p(Aa),Jt=s(Aa,"P",{});var Li=n(Jt);qu=i(Li,"The "),hi=s(Li,"A",{href:!0});var cy=n(hi);Pu=i(cy,"Wav2Vec2Model"),cy.forEach(t),Mu=i(Li," forward method, overrides the "),zl=s(Li,"CODE",{});var dy=n(zl);zu=i(dy,"__call__"),dy.forEach(t),Au=i(Li," special method."),Li.forEach(t),Ou=p(Aa),y(Go.$$.fragment,Aa),Lu=p(Aa),y(Jo.$$.fragment,Aa),Aa.forEach(t),Ct.forEach(t),yd=p(o),Zt=s(o,"H2",{class:!0});var $p=n(Zt);Zo=s($p,"A",{id:!0,class:!0,href:!0});var py=n(Zo);Al=s(py,"SPAN",{});var my=n(Al);y(tn.$$.fragment,my),my.forEach(t),py.forEach(t),Du=p($p),Ol=s($p,"SPAN",{});var hy=n(Ol);Su=i(hy,"Wav2Vec2ForCTC"),hy.forEach(t),$p.forEach(t),kd=p(o),We=s(o,"DIV",{class:!0});var Et=n(We);y(on.$$.fragment,Et),Nu=p(Et),Kt=s(Et,"P",{});var Di=n(Kt);Iu=i(Di,"Wav2Vec2 Model with a "),Ll=s(Di,"CODE",{});var fy=n(Ll);Bu=i(fy,"language modeling"),fy.forEach(t),Uu=i(Di,` head on top for Connectionist Temporal Classification (CTC).
Wav2Vec2 was proposed in `),an=s(Di,"A",{href:!0,rel:!0});var uy=n(an);Hu=i(uy,`wav2vec 2.0: A Framework for Self-Supervised Learning of Speech
Representations`),uy.forEach(t),Ru=i(Di,` by Alexei Baevski, Henry Zhou, Abdelrahman Mohamed, Michael
...
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),Cp.forEach(t),Vg=p(at),ze=s(at,"DIV",{class:!0});var Pt=n(ze);y(gn.$$.fragment,Pt),jg=p(Pt),eo=s(Pt,"P",{});var Ni=n(eo);Fg=i(Ni,"The "),_i=s(Ni,"A",{href:!0});var Vy=n(_i);Cg=i(Vy,"Wav2Vec2ForSequenceClassification"),Vy.forEach(t),Eg=i(Ni," forward method, overrides the "),Bl=s(Ni,"CODE",{});var jy=n(Bl);qg=i(jy,"__call__"),jy.forEach(t),Pg=i(Ni," special method."),Ni.forEach(t),Mg=p(Pt),y(ta.$$.fragment,Pt),zg=p(Pt),y(oa.$$.fragment,Pt),Ag=p(Pt),y(aa.$$.fragment,Pt),Pt.forEach(t),at.forEach(t),xd=p(o),to=s(o,"H2",{class:!0});var Ep=n(to);sa=s(Ep,"A",{id:!0,class:!0,href:!0});var Fy=n(sa);Ul=s(Fy,"SPAN",{});var Cy=n(Ul);y(_n.$$.fragment,Cy),Cy.forEach(t),Fy.forEach(t),Og=p(Ep),Hl=s(Ep,"SPAN",{});var Ey=n(Hl);Lg=i(Ey,"Wav2Vec2ForAudioFrameClassification"),Ey.forEach(t),Ep.forEach(t),Wd=p(o),re=s(o,"DIV",{class:!0});var st=n(re);y(vn.$$.fragment,st),Dg=p(st),Rl=s(st,"P",{});var qy=n(Rl);Sg=i(qy,"Wav2Vec2 Model with a frame classification head on top for tasks like Speaker Diarization."),qy.forEach(t),Ng=p(st),bn=s(st,"P",{});var qp=n(bn);Ig=i(qp,"Wav2Vec2 was proposed in "),wn=s(qp,"A",{href:!0,rel:!0});var Py=n(wn);Bg=i(Py,`wav2vec 2.0: A Framework for Self-Supervised Learning of Speech
Representations`),Py.forEach(t),Ug=i(qp,` by Alexei Baevski, Henry Zhou, Abdelrahman Mohamed, Michael
Auli.`),qp.forEach(t),Hg=p(st),yn=s(st,"P",{});var Pp=n(yn);Rg=i(Pp,"This model inherits from "),vi=s(Pp,"A",{href:!0});var My=n(vi);Xg=i(My,"PreTrainedModel"),My.forEach(t),Gg=i(Pp,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving etc.).`),Pp.forEach(t),Jg=p(st),kn=s(st,"P",{});var Mp=n(kn);Zg=i(Mp,"This model is a PyTorch "),Tn=s(Mp,"A",{href:!0,rel:!0});var zy=n(Tn);Kg=i(zy,"torch.nn.Module"),zy.forEach(t),Qg=i(Mp,` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),Mp.forEach(t),Yg=p(st),Je=s(st,"DIV",{class:!0});var Oa=n(Je);y($n.$$.fragment,Oa),e_=p(Oa),oo=s(Oa,"P",{});var Ii=n(oo);t_=i(Ii,"The "),bi=s(Ii,"A",{href:!0});var Ay=n(bi);o_=i(Ay,"Wav2Vec2ForAudioFrameClassification"),Ay.forEach(t),a_=i(Ii," forward method, overrides the "),Xl=s(Ii,"CODE",{});var Oy=n(Xl);s_=i(Oy,"__call__"),Oy.forEach(t),n_=i(Ii," special method."),Ii.forEach(t),r_=p(Oa),y(na.$$.fragment,Oa),i_=p(Oa),y(ra.$$.fragment,Oa),Oa.forEach(t),st.forEach(t),Vd=p(o),ao=s(o,"H2",{class:!0});var zp=n(ao);ia=s(zp,"A",{id:!0,class:!0,href:!0});var Ly=n(ia);Gl=s(Ly,"SPAN",{});var Dy=n(Gl);y(xn.$$.fragment,Dy),Dy.forEach(t),Ly.forEach(t),l_=p(zp),Jl=s(zp,"SPAN",{});var Sy=n(Jl);c_=i(Sy,"Wav2Vec2ForXVector"),Sy.forEach(t),zp.forEach(t),jd=p(o),ie=s(o,"DIV",{class:!0});var nt=n(ie);y(Wn.$$.fragment,nt),d_=p(nt),Zl=s(nt,"P",{});var Ny=n(Zl);p_=i(Ny,"Wav2Vec2 Model with an XVector feature extraction head on top for tasks like Speaker Verification."),Ny.forEach(t),m_=p(nt),Vn=s(nt,"P",{});var Ap=n(Vn);h_=i(Ap,"Wav2Vec2 was proposed in "),jn=s(Ap,"A",{href:!0,rel:!0});var Iy=n(jn);f_=i(Iy,`wav2vec 2.0: A Framework for Self-Supervised Learning of Speech
...
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),Lp.forEach(t),$_=p(nt),Ze=s(nt,"DIV",{class:!0});var La=n(Ze);y(qn.$$.fragment,La),x_=p(La),so=s(La,"P",{});var Bi=n(so);W_=i(Bi,"The "),yi=s(Bi,"A",{href:!0});var Hy=n(yi);V_=i(Hy,"Wav2Vec2ForXVector"),Hy.forEach(t),j_=i(Bi," forward method, overrides the "),Kl=s(Bi,"CODE",{});var Ry=n(Kl);F_=i(Ry,"__call__"),Ry.forEach(t),C_=i(Bi," special method."),Bi.forEach(t),E_=p(La),y(la.$$.fragment,La),q_=p(La),y(ca.$$.fragment,La),La.forEach(t),nt.forEach(t),Fd=p(o),no=s(o,"H2",{class:!0});var Dp=n(no);da=s(Dp,"A",{id:!0,class:!0,href:!0});var Xy=n(da);Ql=s(Xy,"SPAN",{});var Gy=n(Ql);y(Pn.$$.fragment,Gy),Gy.forEach(t),Xy.forEach(t),P_=p(Dp),Yl=s(Dp,"SPAN",{});var Jy=n(Yl);M_=i(Jy,"Wav2Vec2ForPreTraining"),Jy.forEach(t),Dp.forEach(t),Cd=p(o),Ve=s(o,"DIV",{class:!0});var Mt=n(Ve);y(Mn.$$.fragment,Mt),z_=p(Mt),ro=s(Mt,"P",{});var Ui=n(ro);A_=i(Ui,"Wav2Vec2 Model with a quantizer and "),ec=s(Ui,"CODE",{});var Zy=n(ec);O_=i(Zy,"VQ"),Zy.forEach(t),L_=i(Ui,` head on top.
Wav2Vec2 was proposed in `),zn=s(Ui,"A",{href:!0,rel:!0});var Ky=n(zn);D_=i(Ky,`wav2vec 2.0: A Framework for Self-Supervised Learning of Speech
Representations`),Ky.forEach(t),S_=i(Ui,` by Alexei Baevski, Henry Zhou, Abdelrahman Mohamed, Michael
Auli.`),Ui.forEach(t),N_=p(Mt),An=s(Mt,"P",{});var Sp=n(An);I_=i(Sp,"This model inherits from "),ki=s(Sp,"A",{href:!0});var Qy=n(ki);B_=i(Qy,"PreTrainedModel"),Qy.forEach(t),U_=i(Sp,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving etc.).`),Sp.forEach(t),H_=p(Mt),On=s(Mt,"P",{});var Np=n(On);R_=i(Np,"This model is a PyTorch "),Ln=s(Np,"A",{href:!0,rel:!0});var Yy=n(Ln);X_=i(Yy,"torch.nn.Module"),Yy.forEach(t),G_=i(Np,` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),Np.forEach(t),J_=p(Mt),Ke=s(Mt,"DIV",{class:!0});var Da=n(Ke);y(Dn.$$.fragment,Da),Z_=p(Da),io=s(Da,"P",{});var Hi=n(io);K_=i(Hi,"The "),Ti=s(Hi,"A",{href:!0});var ek=n(Ti);Q_=i(ek,"Wav2Vec2ForPreTraining"),ek.forEach(t),Y_=i(Hi," forward method, overrides the "),tc=s(Hi,"CODE",{});var tk=n(tc);ev=i(tk,"__call__"),tk.forEach(t),tv=i(Hi," special method."),Hi.forEach(t),ov=p(Da),y(pa.$$.fragment,Da),av=p(Da),y(ma.$$.fragment,Da),Da.forEach(t),Mt.forEach(t),Ed=p(o),lo=s(o,"H2",{class:!0});var Ip=n(lo);ha=s(Ip,"A",{id:!0,class:!0,href:!0});var ok=n(ha);oc=s(ok,"SPAN",{});var ak=n(oc);y(Sn.$$.fragment,ak),ak.forEach(t),ok.forEach(t),sv=p(Ip),ac=s(Ip,"SPAN",{});var sk=n(ac);nv=i(sk,"TFWav2Vec2Model"),sk.forEach(t),Ip.forEach(t),qd=p(o),le=s(o,"DIV",{class:!0});var rt=n(le);y(Nn.$$.fragment,rt),rv=p(rt),sc=s(rt,"P",{});var nk=n(sc);iv=i(nk,"The bare TFWav2Vec2 Model transformer outputing raw hidden-states without any specific head on top."),nk.forEach(t),lv=p(rt),In=s(rt,"P",{});var Bp=n(In);cv=i(Bp,"This model inherits from "),$i=s(Bp,"A",{href:!0});var rk=n($i);dv=i(rk,"TFPreTrainedModel"),rk.forEach(t),pv=i(Bp,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Up.forEach(t),gv=p(rt),y(fa.$$.fragment,rt),_v=p(rt),Qe=s(rt,"DIV",{class:!0});var Sa=n(Qe);y(Hn.$$.fragment,Sa),vv=p(Sa),co=s(Sa,"P",{});var Ri=n(co);bv=i(Ri,"The "),xi=s(Ri,"A",{href:!0});var lk=n(xi);wv=i(lk,"TFWav2Vec2Model"),lk.forEach(t),yv=i(Ri," forward method, overrides the "),nc=s(Ri,"CODE",{});var ck=n(nc);kv=i(ck,"__call__"),ck.forEach(t),Tv=i(Ri," special method."),Ri.forEach(t),$v=p(Sa),y(ua.$$.fragment,Sa),xv=p(Sa),y(ga.$$.fragment,Sa),Sa.forEach(t),rt.forEach(t),Pd=p(o),po=s(o,"H2",{class:!0});var Hp=n(po);_a=s(Hp,"A",{id:!0,class:!0,href:!0});var dk=n(_a);rc=s(dk,"SPAN",{});var pk=n(rc);y(Rn.$$.fragment,pk),pk.forEach(t),dk.forEach(t),Wv=p(Hp),ic=s(Hp,"SPAN",{});var mk=n(ic);Vv=i(mk,"TFWav2Vec2ForCTC"),mk.forEach(t),Hp.forEach(t),Md=p(o),ce=s(o,"DIV",{class:!0});var it=n(ce);y(Xn.$$.fragment,it),jv=p(it),Gn=s(it,"P",{});var Rp=n(Gn);Fv=i(Rp,"TFWav2Vec2 Model with a "),lc=s(Rp,"CODE",{});var hk=n(lc);Cv=i(hk,"language modeling"),hk.forEach(t),Ev=i(Rp," head on top for Connectionist Temporal Classification (CTC)."),Rp.forEach(t),qv=p(it),Jn=s(it,"P",{});var Xp=n(Jn);Pv=i(Xp,"This model inherits from "),Wi=s(Xp,"A",{href:!0});var fk=n(Wi);Mv=i(fk,"TFPreTrainedModel"),fk.forEach(t),zv=i(Xp,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Gp.forEach(t),Sv=p(it),y(va.$$.fragment,it),Nv=p(it),Ye=s(it,"DIV",{class:!0});var Na=n(Ye);y(Qn.$$.fragment,Na),Iv=p(Na),mo=s(Na,"P",{});var Xi=n(mo);Bv=i(Xi,"The "),Vi=s(Xi,"A",{href:!0});var gk=n(Vi);Uv=i(gk,"TFWav2Vec2ForCTC"),gk.forEach(t),Hv=i(Xi," forward method, overrides the "),cc=s(Xi,"CODE",{});var _k=n(cc);Rv=i(_k,"__call__"),_k.forEach(t),Xv=i(Xi," special method."),Xi.forEach(t),Gv=p(Na),y(ba.$$.fragment,Na),Jv=p(Na),y(wa.$$.fragment,Na),Na.forEach(t),it.forEach(t),zd=p(o),ho=s(o,"H2",{class:!0});var Jp=n(ho);ya=s(Jp,"A",{id:!0,class:!0,href:!0});var vk=n(ya);dc=s(vk,"SPAN",{});var bk=n(dc);y(Yn.$$.fragment,bk),bk.forEach(t),vk.forEach(t),Zv=p(Jp),pc=s(Jp,"SPAN",{});var wk=n(pc);Kv=i(wk,"FlaxWav2Vec2Model"),wk.forEach(t),Jp.forEach(t),Ad=p(o),K=s(o,"DIV",{class:!0});var Oe=n(K);y(er.$$.fragment,Oe),Qv=p(Oe),tr=s(Oe,"P",{});var Zp=n(tr);Yv=i(Zp,`The bare Wav2Vec2 Model transformer outputting raw hidden-states without any specific head on top.
...
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),tm.forEach(t),H2=p(Le),kc=s(Le,"P",{});var Ik=n(kc);R2=i(Ik,"Finally, this model supports inherent JAX features such as:"),Ik.forEach(t),X2=p(Le),wt=s(Le,"UL",{});var Ua=n(wt);Tc=s(Ua,"LI",{});var Bk=n(Tc);_r=s(Bk,"A",{href:!0,rel:!0});var Uk=n(_r);G2=i(Uk,"Just-In-Time (JIT) compilation"),Uk.forEach(t),Bk.forEach(t),J2=p(Ua),$c=s(Ua,"LI",{});var Hk=n($c);vr=s(Hk,"A",{href:!0,rel:!0});var Rk=n(vr);Z2=i(Rk,"Automatic Differentiation"),Rk.forEach(t),Hk.forEach(t),K2=p(Ua),xc=s(Ua,"LI",{});var Xk=n(xc);br=s(Xk,"A",{href:!0,rel:!0});var Gk=n(br);Q2=i(Gk,"Vectorization"),Gk.forEach(t),Xk.forEach(t),Y2=p(Ua),Wc=s(Ua,"LI",{});var Jk=n(Wc);wr=s(Jk,"A",{href:!0,rel:!0});var Zk=n(wr);eb=i(Zk,"Parallelization"),Zk.forEach(t),Jk.forEach(t),Ua.forEach(t),tb=p(Le),tt=s(Le,"DIV",{class:!0});var Ha=n(tt);y(yr.$$.fragment,Ha),ob=p(Ha),_o=s(Ha,"P",{});var Zi=n(_o);ab=i(Zi,"The "),Vc=s(Zi,"CODE",{});var Kk=n(Vc);sb=i(Kk,"FlaxWav2Vec2PreTrainedModel"),Kk.forEach(t),nb=i(Zi," forward method, overrides the "),jc=s(Zi,"CODE",{});var Qk=n(jc);rb=i(Qk,"__call__"),Qk.forEach(t),ib=i(Zi," special method."),Zi.forEach(t),lb=p(Ha),y(xa.$$.fragment,Ha),cb=p(Ha),y(Wa.$$.fragment,Ha),Ha.forEach(t),Le.forEach(t),Dd=p(o),vo=s(o,"H2",{class:!0});var om=n(vo);Va=s(om,"A",{id:!0,class:!0,href:!0});var Yk=n(Va);Fc=s(Yk,"SPAN",{});var e0=n(Fc);y(kr.$$.fragment,e0),e0.forEach(t),Yk.forEach(t),db=p(om),Cc=s(om,"SPAN",{});var t0=n(Cc);pb=i(t0,"FlaxWav2Vec2ForPreTraining"),t0.forEach(t),om.forEach(t),Sd=p(o),Y=s(o,"DIV",{class:!0});var De=n(Y);y(Tr.$$.fragment,De),mb=p(De),bo=s(De,"P",{});var Ki=n(bo);hb=i(Ki,"Wav2Vec2 Model with a quantizer and "),Ec=s(Ki,"CODE",{});var o0=n(Ec);fb=i(o0,"VQ"),o0.forEach(t),ub=i(Ki,` head on top.
