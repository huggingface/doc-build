import{S as Rd,i as Fd,s as Cd,e as i,k as g,w as k,t as a,M as zd,c as l,d as o,m as _,a as d,x as M,h as r,b as m,F as e,g as L,y as v,q as w,o as X,B as $,v as qd,L as A}from"../../chunks/vendor-6b77c823.js";import{T as io}from"../../chunks/Tip-39098574.js";import{D as F}from"../../chunks/Docstring-1088f2fb.js";import{C as S}from"../../chunks/CodeBlock-3a8b25a8.js";import{I as ae}from"../../chunks/IconCopyLink-7a11ce68.js";import{E as P}from"../../chunks/ExampleCodeBlock-5212b321.js";function Ed(T){let s,f,c,h,b;return h=new S({props:{code:`from transformers import XLMRobertaXLModel, XLMRobertaXLConfig
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),{c(){s=i("p"),f=a("Example:"),c=g(),k(h.$$.fragment)},l(n){s=l(n,"P",{});var p=d(s);f=r(p,"Example:"),p.forEach(o),c=_(n),M(h.$$.fragment,n)},m(n,p){L(n,s,p),e(s,f),L(n,c,p),v(h,n,p),b=!0},p:A,i(n){b||(w(h.$$.fragment,n),b=!0)},o(n){X(h.$$.fragment,n),b=!1},d(n){n&&o(s),n&&o(c),$(h,n)}}}function Ad(T){let s,f,c,h,b;return{c(){s=i("p"),f=a("Although the recipe for forward pass needs to be defined within this function, one should call the "),c=i("code"),h=a("Module"),b=a(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(n){s=l(n,"P",{});var p=d(s);f=r(p,"Although the recipe for forward pass needs to be defined within this function, one should call the "),c=l(p,"CODE",{});var y=d(c);h=r(y,"Module"),y.forEach(o),b=r(p,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
`}}),{c(){k(s.$$.fragment)},l(c){M(s.$$.fragment,c)},m(c,h){v(s,c,h),f=!0},p:A,i(c){f||(w(s.$$.fragment,c),f=!0)},o(c){X(s.$$.fragment,c),f=!1},d(c){$(s,c)}}}function Dd(T){let s,f,c,h,b;return{c(){s=i("p"),f=a("Although the recipe for forward pass needs to be defined within this function, one should call the "),c=i("code"),h=a("Module"),b=a(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(n){s=l(n,"P",{});var p=d(s);f=r(p,"Although the recipe for forward pass needs to be defined within this function, one should call the "),c=l(p,"CODE",{});var y=d(c);h=r(y,"Module"),y.forEach(o),b=r(p,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
`}}),{c(){k(s.$$.fragment)},l(c){M(s.$$.fragment,c)},m(c,h){v(s,c,h),f=!0},p:A,i(c){f||(w(s.$$.fragment,c),f=!0)},o(c){X(s.$$.fragment,c),f=!1},d(c){$(s,c)}}}function Qd(T){let s,f,c,h,b;return h=new S({props:{code:`import torch
from transformers import RobertaTokenizer, XLMRobertaXLForSequenceClassification
...
<span class="hljs-meta">... </span>)
<span class="hljs-meta">&gt;&gt;&gt; </span>loss = model(**inputs, labels=labels).loss
<span class="hljs-meta">&gt;&gt;&gt; </span>loss.backward()`}}),{c(){k(s.$$.fragment)},l(c){M(s.$$.fragment,c)},m(c,h){v(s,c,h),f=!0},p:A,i(c){f||(w(s.$$.fragment,c),f=!0)},o(c){X(s.$$.fragment,c),f=!1},d(c){$(s,c)}}}function Ud(T){let s,f,c,h,b;return{c(){s=i("p"),f=a("Although the recipe for forward pass needs to be defined within this function, one should call the "),c=i("code"),h=a("Module"),b=a(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(n){s=l(n,"P",{});var p=d(s);f=r(p,"Although the recipe for forward pass needs to be defined within this function, one should call the "),c=l(p,"CODE",{});var y=d(c);h=r(y,"Module"),y.forEach(o),b=r(p,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
`}}),{c(){s=i("p"),f=a("Example:"),c=g(),k(h.$$.fragment)},l(n){s=l(n,"P",{});var p=d(s);f=r(p,"Example:"),p.forEach(o),c=_(n),M(h.$$.fragment,n)},m(n,p){L(n,s,p),e(s,f),L(n,c,p),v(h,n,p),b=!0},p:A,i(n){b||(w(h.$$.fragment,n),b=!0)},o(n){X(h.$$.fragment,n),b=!1},d(n){n&&o(s),n&&o(c),$(h,n)}}}function Kd(T){let s,f;return s=new S({props:{code:`labels = predicted_token_class_ids
loss = model(**inputs, labels=labels).loss
round(loss.item(), 2)
`,highlighted:`<span class="hljs-meta">&gt;&gt;&gt; </span>labels = predicted_token_class_ids
<span class="hljs-meta">&gt;&gt;&gt; </span>loss = model(**inputs, labels=labels).loss
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-built_in">round</span>(loss.item(), <span class="hljs-number">2</span>)
`}}),{c(){k(s.$$.fragment)},l(c){M(s.$$.fragment,c)},m(c,h){v(s,c,h),f=!0},p:A,i(c){f||(w(s.$$.fragment,c),f=!0)},o(c){X(s.$$.fragment,c),f=!1},d(c){$(s,c)}}}function Yd(T){let s,f,c,h,b;return{c(){s=i("p"),f=a("Although the recipe for forward pass needs to be defined within this function, one should call the "),c=i("code"),h=a("Module"),b=a(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(n){s=l(n,"P",{});var p=d(s);f=r(p,"Although the recipe for forward pass needs to be defined within this function, one should call the "),c=l(p,"CODE",{});var y=d(c);h=r(y,"Module"),y.forEach(o),b=r(p,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
`}}),{c(){s=i("p"),f=a("Example:"),c=g(),k(h.$$.fragment)},l(n){s=l(n,"P",{});var p=d(s);f=r(p,"Example:"),p.forEach(o),c=_(n),M(h.$$.fragment,n)},m(n,p){L(n,s,p),e(s,f),L(n,c,p),v(h,n,p),b=!0},p:A,i(n){b||(w(h.$$.fragment,n),b=!0)},o(n){X(h.$$.fragment,n),b=!1},d(n){n&&o(s),n&&o(c),$(h,n)}}}function ec(T){let s,f;return s=new S({props:{code:`# target is "nice puppet"
...
<code>past_key_values</code>).`,name:"use_cache"}],source:"https://github.com/huggingface/transformers/blob/vmain/src/transformers/models/xlm_roberta_xl/modeling_xlm_roberta_xl.py#L708",returnDescription:`
<p>A <a
...
model. Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/main/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/vmain/src/transformers/models/xlm_roberta_xl/modeling_xlm_roberta_xl.py#L850"}}),jt=new F({props:{name:"forward",anchor:"transformers.XLMRobertaXLForCausalLM.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"encoder_hidden_states",val:" = None"},{name:"encoder_attention_mask",val:" = None"},{name:"labels",val:" = None"},{name:"past_key_values",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],parametersDescription:[{anchor:"transformers.XLMRobertaXLForCausalLM.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. Indices can be obtained using <a href="/docs/transformers/main/en/model_doc/roberta#transformers.RobertaTokenizer">RobertaTokenizer</a>. See
<a href="/docs/transformers/main/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and <a href="/docs/transformers/main/en/model_doc/wav2vec2_phoneme#transformers.Wav2Vec2PhonemeCTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details. <a href="../glossary#input-ids">What are input
...
If set to <code>True</code>, <code>past_key_values</code> key value states are returned and can be used to speed up decoding (see
<code>past_key_values</code>).`,name:"use_cache"}],source:"https://github.com/huggingface/transformers/blob/vmain/src/transformers/models/xlm_roberta_xl/modeling_xlm_roberta_xl.py#L875",returnDescription:`
<p>A <a
...
model. Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/main/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/vmain/src/transformers/models/xlm_roberta_xl/modeling_xlm_roberta_xl.py#L1000"}}),Nt=new F({props:{name:"forward",anchor:"transformers.XLMRobertaXLForMaskedLM.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"encoder_hidden_states",val:" = None"},{name:"encoder_attention_mask",val:" = None"},{name:"labels",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],parametersDescription:[{anchor:"transformers.XLMRobertaXLForMaskedLM.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. Indices can be obtained using <a href="/docs/transformers/main/en/model_doc/roberta#transformers.RobertaTokenizer">RobertaTokenizer</a>. See
<a href="/docs/transformers/main/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and <a href="/docs/transformers/main/en/model_doc/wav2vec2_phoneme#transformers.Wav2Vec2PhonemeCTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details. <a href="../glossary#input-ids">What are input
...
Used to hide legacy arguments that have been deprecated.`,name:"kwargs"}],source:"https://github.com/huggingface/transformers/blob/vmain/src/transformers/models/xlm_roberta_xl/modeling_xlm_roberta_xl.py#L1028",returnDescription:`
<p>A <a
...
model. Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/main/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/vmain/src/transformers/models/xlm_roberta_xl/modeling_xlm_roberta_xl.py#L1128"}}),Wt=new F({props:{name:"forward",anchor:"transformers.XLMRobertaXLForSequenceClassification.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"labels",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],parametersDescription:[{anchor:"transformers.XLMRobertaXLForSequenceClassification.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. Indices can be obtained using <a href="/docs/transformers/main/en/model_doc/roberta#transformers.RobertaTokenizer">RobertaTokenizer</a>. See
<a href="/docs/transformers/main/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and <a href="/docs/transformers/main/en/model_doc/wav2vec2_phoneme#transformers.Wav2Vec2PhonemeCTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details. <a href="../glossary#input-ids">What are input
...
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vmain/src/transformers/models/xlm_roberta_xl/modeling_xlm_roberta_xl.py#L1141",returnDescription:`
<p>A <a
...
<code>input_ids</code> above)`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vmain/src/transformers/models/xlm_roberta_xl/modeling_xlm_roberta_xl.py#L1237",returnDescription:`
<p>A <a
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vmain/src/transformers/models/xlm_roberta_xl/modeling_xlm_roberta_xl.py#L1336",returnDescription:`
<p>A <a
...
model. Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/main/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/vmain/src/transformers/models/xlm_roberta_xl/modeling_xlm_roberta_xl.py#L1434"}}),to=new F({props:{name:"forward",anchor:"transformers.XLMRobertaXLForQuestionAnswering.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"start_positions",val:" = None"},{name:"end_positions",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],parametersDescription:[{anchor:"transformers.XLMRobertaXLForQuestionAnswering.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. Indices can be obtained using <a href="/docs/transformers/main/en/model_doc/roberta#transformers.RobertaTokenizer">RobertaTokenizer</a>. See
<a href="/docs/transformers/main/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and <a href="/docs/transformers/main/en/model_doc/wav2vec2_phoneme#transformers.Wav2Vec2PhonemeCTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details. <a href="../glossary#input-ids">What are input
...
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/vmain/src/transformers/models/xlm_roberta_xl/modeling_xlm_roberta_xl.py#L1447",returnDescription:`
<p>A <a
...
cross-attention is added between the self-attention layers, following the architecture described in `),tn=i("em"),va=a(`Attention is
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.) This model is also a PyTorch `),St=i("a"),Mr=a("torch.nn.Module"),vr=a(`
subclass. Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to
general usage and behavior.`),wr=g(),C=i("div"),k(Nt.$$.fragment),Xr=g(),fe=i("p"),$r=a("The "),Mo=i("a"),Tr=a("XLMRobertaXLForMaskedLM"),yr=a(" forward method, overrides the "),bn=i("code"),xr=a("__call__"),Rr=a(" special method."),Fr=g(),k(Ie.$$.fragment),Cr=g(),k(Oe.$$.fragment),zr=g(),k(De.$$.fragment),ms=g(),ge=i("h2"),We=i("a"),Ln=i("span"),k(It.$$.fragment),qr=g(),kn=i("span"),Er=a("XLMRobertaXLForSequenceClassification"),us=g(),O=i("div"),k(Ot.$$.fragment),jr=g(),Mn=i("p"),Pr=a(`XLM-RoBERTa-xlarge Model transformer with a sequence classification/regression head on top (a linear layer on top
of the pooled output) e.g. for GLUE tasks.`),Ar=g(),_e=i("p"),Sr=a("This model inherits from "),vo=i("a"),Nr=a("PreTrainedModel"),Ir=a(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.) This model is also a PyTorch `),Dt=i("a"),Or=a("torch.nn.Module"),Dr=a(`
subclass. Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to
general usage and behavior.`),Wr=g(),x=i("div"),k(Wt.$$.fragment),Br=g(),be=i("p"),Qr=a("The "),wo=i("a"),Hr=a("XLMRobertaXLForSequenceClassification"),Ur=a(" forward method, overrides the "),vn=i("code"),Vr=a("__call__"),Gr=a(" special method."),Jr=g(),k(Be.$$.fragment),Kr=g(),k(Qe.$$.fragment),Yr=g(),k(He.$$.fragment),Zr=g(),k(Ue.$$.fragment),ei=g(),k(Ve.$$.fragment),fs=g(),Le=i("h2"),Ge=i("a"),wn=i("span"),k(Bt.$$.fragment),ti=g(),Xn=i("span"),oi=a("XLMRobertaXLForMultipleChoice"),gs=g(),D=i("div"),k(Qt.$$.fragment),ni=g(),$n=i("p"),si=a(`XLM-Roberta-xlarge Model with a multiple choice classification head on top (a linear layer on top of the pooled
...
subclass. Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to
general usage and behavior.`),hi=g(),V=i("div"),k(Ut.$$.fragment),pi=g(),Me=i("p"),mi=a("The "),$o=i("a"),ui=a("XLMRobertaXLForMultipleChoice"),fi=a(" forward method, overrides the "),Tn=i("code"),gi=a("__call__"),_i=a(" special method."),bi=g(),k(Je.$$.fragment),Li=g(),k(Ke.$$.fragment),_s=g(),ve=i("h2"),Ye=i("a"),yn=i("span"),k(Vt.$$.fragment),ki=g(),xn=i("span"),Mi=a("XLMRobertaXLForTokenClassification"),bs=g(),W=i("div"),k(Gt.$$.fragment),vi=g(),Rn=i("p"),wi=a(`XLM-Roberta-xlarge Model with a token classification head on top (a linear layer on top of the hidden-states
...
language from the input ids.`),ao.forEach(o),Un.forEach(o),ss=_(t),Q=l(t,"P",{});var ee=d(Q);Ds=r(ee,"This model was contributed by "),Mt=l(ee,"A",{href:!0,rel:!0});var Gn=d(Mt);Ws=r(Gn,"Soonhwan-Kwon"),Gn.forEach(o),Bs=r(ee," and "),vt=l(ee,"A",{href:!0,rel:!0});var Jn=d(vt);Qs=r(Jn,"stefan-it"),Jn.forEach(o),Hs=r(ee,". The original code can be found "),wt=l(ee,"A",{href:!0,rel:!0});var Kn=d(wt);Us=r(Kn,"here"),Kn.forEach(o),Vs=r(ee,"."),ee.forEach(o),as=_(t),ie=l(t,"H2",{class:!0});var vs=d(ie);Ce=l(vs,"A",{id:!0,class:!0,href:!0});var cl=d(Ce);Jo=l(cl,"SPAN",{});var hl=d(Jo);M(Xt.$$.fragment,hl),hl.forEach(o),cl.forEach(o),Gs=_(vs),Ko=l(vs,"SPAN",{});var pl=d(Ko);Js=r(pl,"XLMRobertaXLConfig"),pl.forEach(o),vs.forEach(o),rs=_(t),N=l(t,"DIV",{class:!0});var rt=d(N);M($t.$$.fragment,rt),Ks=_(rt),G=l(rt,"P",{});var it=d(G);Ys=r(it,"This is the configuration class to store the configuration of a "),mo=l(it,"A",{href:!0});var ml=d(mo);Zs=r(ml,"XLMRobertaXLModel"),ml.forEach(o),ea=r(it," or a "),Yo=l(it,"CODE",{});var ul=d(Yo);ta=r(ul,"TFXLMRobertaXLModel"),ul.forEach(o),oa=r(it,`.
It is used to instantiate a XLM_ROBERTA_XL model according to the specified arguments, defining the model
architecture. Instantiating a configuration with the defaults will yield a similar configuration to that of the
...
documentation from `),fo=l(Fo,"A",{href:!0});var _l=d(fo);da=r(_l,"PretrainedConfig"),_l.forEach(o),ca=r(Fo," for more information."),Fo.forEach(o),ha=_(rt),M(ze.$$.fragment,rt),rt.forEach(o),is=_(t),de=l(t,"H2",{class:!0});var ws=d(de);qe=l(ws,"A",{id:!0,class:!0,href:!0});var bl=d(qe);Zo=l(bl,"SPAN",{});var Ll=d(Zo);M(yt.$$.fragment,Ll),Ll.forEach(o),bl.forEach(o),pa=_(ws),en=l(ws,"SPAN",{});var kl=d(en);ma=r(kl,"XLMRobertaXLModel"),kl.forEach(o),ws.forEach(o),ls=_(t),I=l(t,"DIV",{class:!0});var lt=d(I);M(xt.$$.fragment,lt),ua=_(lt),ce=l(lt,"P",{});var Co=d(ce);fa=r(Co,`The bare XLM-RoBERTa-xlarge Model transformer outputting raw hidden-states without any specific head on top.
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.) This model is also a PyTorch `),Rt=l(Co,"A",{href:!0,rel:!0});var vl=d(Rt);ba=r(vl,"torch.nn.Module"),vl.forEach(o),La=r(Co,`
subclass. Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to
...
cross-attention is added between the self-attention layers, following the architecture described in `),tn=l(ro,"EM",{});var wl=d(tn);va=r(wl,`Attention is
...
subclass. Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to
general usage and behavior.`),No.forEach(o),hi=_(ut),V=l(ut,"DIV",{class:!0});var ft=d(V);M(Ut.$$.fragment,ft),pi=_(ft),Me=l(ft,"P",{});var Io=d(Me);mi=r(Io,"The "),$o=l(Io,"A",{href:!0});var cd=d($o);ui=r(cd,"XLMRobertaXLForMultipleChoice"),cd.forEach(o),fi=r(Io," forward method, overrides the "),Tn=l(Io,"CODE",{});var hd=d(Tn);gi=r(hd,"__call__"),hd.forEach(o),_i=r(Io," special method."),Io.forEach(o),bi=_(ft),M(Je.$$.fragment,ft),Li=_(ft),M(Ke.$$.fragment,ft),ft.forEach(o),ut.forEach(o),_s=_(t),ve=l(t,"H2",{class:!0});var xs=d(ve);Ye=l(xs,"A",{id:!0,class:!0,href:!0});var pd=d(Ye);yn=l(pd,"SPAN",{});var md=d(yn);M(Vt.$$.fragment,md),md.forEach(o),pd.forEach(o),ki=_(xs),xn=l(xs,"SPAN",{});var ud=d(xn);Mi=r(ud,"XLMRobertaXLForTokenClassification"),ud.forEach(o),xs.forEach(o),bs=_(t),W=l(t,"DIV",{class:!0});var gt=d(W);M(Gt.$$.fragment,gt),vi=_(gt),Rn=l(gt,"P",{});var fd=d(Rn);wi=r(fd,`XLM-Roberta-xlarge Model with a token classification head on top (a linear layer on top of the hidden-states
