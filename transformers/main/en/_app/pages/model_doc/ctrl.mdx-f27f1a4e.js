...
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),_.forEach(t)},m(T,_){u(T,p,_),e(p,E),e(p,f),e(f,g),e(p,v)},d(T){T&&t(p)}}}function Zc(J){let p,E,f,g,v;return{c(){p=a("p"),E=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=a("code"),g=n("Module"),v=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(T){p=r(T,"P",{});var _=i(p);E=s(_,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=r(_,"CODE",{});var M=i(f);g=s(M,"Module"),M.forEach(t),v=s(_,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),_.forEach(t)},m(T,_){u(T,p,_),e(p,E),e(p,f),e(f,g),e(p,v)},d(T){T&&t(p)}}}function eh(J){let p,E,f,g,v;return{c(){p=a("p"),E=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=a("code"),g=n("Module"),v=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(T){p=r(T,"P",{});var _=i(p);E=s(_,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=r(_,"CODE",{});var M=i(f);g=s(M,"Module"),M.forEach(t),v=s(_,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),_.forEach(t)},m(T,_){u(T,p,_),e(p,E),e(p,f),e(f,g),e(p,v)},d(T){T&&t(p)}}}function th(J){let p,E,f,g,v,T,_,M,_e,Y,R,Q,A,Z,Te,O,ve,he,P,j,ee,ne,F,q,ke,U,pe,se,V,ue,ae,z,be,H,re,Ce,W,S,te,I,oe,G,ye;return{c(){p=a("p"),E=n("TF 2.0 models accepts two formats as inputs:"),f=l(),g=a("ul"),v=a("li"),T=n("having all inputs as keyword arguments (like PyTorch models), or"),_=l(),M=a("li"),_e=n("having all inputs as a list, tuple or dict in the first positional arguments."),Y=l(),R=a("p"),Q=n("This second option is useful when using "),A=a("code"),Z=n("tf.keras.Model.fit"),Te=n(` method which currently requires having all the
tensors in the first argument of the model call function: `),O=a("code"),ve=n("model(inputs)"),he=n("."),P=l(),j=a("p"),ee=n(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),ne=l(),F=a("ul"),q=a("li"),ke=n("a single Tensor with "),U=a("code"),pe=n("input_ids"),se=n(" only and nothing else: "),V=a("code"),ue=n("model(inputs_ids)"),ae=l(),z=a("li"),be=n(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
...
tensors in the first argument of the model call function: `),O=r(N,"CODE",{});var Oe=i(O);ve=s(Oe,"model(inputs)"),Oe.forEach(t),he=s(N,"."),N.forEach(t),P=d(h),j=r(h,"P",{});var He=i(j);ee=s(He,`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),He.forEach(t),ne=d(h),F=r(h,"UL",{});var D=i(F);q=r(D,"LI",{});var x=i(q);ke=s(x,"a single Tensor with "),U=r(x,"CODE",{});var We=i(U);pe=s(We,"input_ids"),We.forEach(t),se=s(x," only and nothing else: "),V=r(x,"CODE",{});var ze=i(V);ue=s(ze,"model(inputs_ids)"),ze.forEach(t),x.forEach(t),ae=d(D),z=r(D,"LI",{});var K=i(z);be=s(K,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
...
`),G=r(we,"CODE",{});var Ue=i(G);ye=s(Ue,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),Ue.forEach(t),we.forEach(t),D.forEach(t)},m(h,$){u(h,p,$),e(p,E),u(h,f,$),u(h,g,$),e(g,v),e(v,T),e(g,_),e(g,M),e(M,_e),u(h,Y,$),u(h,R,$),e(R,Q),e(R,A),e(A,Z),e(R,Te),e(R,O),e(O,ve),e(R,he),u(h,P,$),u(h,j,$),e(j,ee),u(h,ne,$),u(h,F,$),e(F,q),e(q,ke),e(q,U),e(U,pe),e(q,se),e(q,V),e(V,ue),e(F,ae),e(F,z),e(z,be),e(z,H),e(H,re),e(z,Ce),e(z,W),e(W,S),e(F,te),e(F,I),e(I,oe),e(I,G),e(G,ye)},d(h){h&&t(p),h&&t(f),h&&t(g),h&&t(Y),h&&t(R),h&&t(P),h&&t(j),h&&t(ne),h&&t(F)}}}function oh(J){let p,E,f,g,v;return{c(){p=a("p"),E=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=a("code"),g=n("Module"),v=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(T){p=r(T,"P",{});var _=i(p);E=s(_,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=r(_,"CODE",{});var M=i(f);g=s(M,"Module"),M.forEach(t),v=s(_,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),_.forEach(t)},m(T,_){u(T,p,_),e(p,E),e(p,f),e(f,g),e(p,v)},d(T){T&&t(p)}}}function nh(J){let p,E,f,g,v,T,_,M,_e,Y,R,Q,A,Z,Te,O,ve,he,P,j,ee,ne,F,q,ke,U,pe,se,V,ue,ae,z,be,H,re,Ce,W,S,te,I,oe,G,ye;return{c(){p=a("p"),E=n("TF 2.0 models accepts two formats as inputs:"),f=l(),g=a("ul"),v=a("li"),T=n("having all inputs as keyword arguments (like PyTorch models), or"),_=l(),M=a("li"),_e=n("having all inputs as a list, tuple or dict in the first positional arguments."),Y=l(),R=a("p"),Q=n("This second option is useful when using "),A=a("code"),Z=n("tf.keras.Model.fit"),Te=n(` method which currently requires having all the
tensors in the first argument of the model call function: `),O=a("code"),ve=n("model(inputs)"),he=n("."),P=l(),j=a("p"),ee=n(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),ne=l(),F=a("ul"),q=a("li"),ke=n("a single Tensor with "),U=a("code"),pe=n("input_ids"),se=n(" only and nothing else: "),V=a("code"),ue=n("model(inputs_ids)"),ae=l(),z=a("li"),be=n(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),H=a("code"),re=n("model([input_ids, attention_mask])"),Ce=n(" or "),W=a("code"),S=n("model([input_ids, attention_mask, token_type_ids])"),te=l(),I=a("li"),oe=n(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),G=a("code"),ye=n('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(h){p=r(h,"P",{});var $=i(p);E=s($,"TF 2.0 models accepts two formats as inputs:"),$.forEach(t),f=d(h),g=r(h,"UL",{});var ie=i(g);v=r(ie,"LI",{});var Ae=i(v);T=s(Ae,"having all inputs as keyword arguments (like PyTorch models), or"),Ae.forEach(t),_=d(ie),M=r(ie,"LI",{});var me=i(M);_e=s(me,"having all inputs as a list, tuple or dict in the first positional arguments."),me.forEach(t),ie.forEach(t),Y=d(h),R=r(h,"P",{});var N=i(R);Q=s(N,"This second option is useful when using "),A=r(N,"CODE",{});var qe=i(A);Z=s(qe,"tf.keras.Model.fit"),qe.forEach(t),Te=s(N,` method which currently requires having all the
...
first positional argument :`),He.forEach(t),ne=d(h),F=r(h,"UL",{});var D=i(F);q=r(D,"LI",{});var x=i(q);ke=s(x,"a single Tensor with "),U=r(x,"CODE",{});var We=i(U);pe=s(We,"input_ids"),We.forEach(t),se=s(x," only and nothing else: "),V=r(x,"CODE",{});var ze=i(V);ue=s(ze,"model(inputs_ids)"),ze.forEach(t),x.forEach(t),ae=d(D),z=r(D,"LI",{});var K=i(z);be=s(K,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),H=r(K,"CODE",{});var Be=i(H);re=s(Be,"model([input_ids, attention_mask])"),Be.forEach(t),Ce=s(K," or "),W=r(K,"CODE",{});var xe=i(W);S=s(xe,"model([input_ids, attention_mask, token_type_ids])"),xe.forEach(t),K.forEach(t),te=d(D),I=r(D,"LI",{});var we=i(I);oe=s(we,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),G=r(we,"CODE",{});var Ue=i(G);ye=s(Ue,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),Ue.forEach(t),we.forEach(t),D.forEach(t)},m(h,$){u(h,p,$),e(p,E),u(h,f,$),u(h,g,$),e(g,v),e(v,T),e(g,_),e(g,M),e(M,_e),u(h,Y,$),u(h,R,$),e(R,Q),e(R,A),e(A,Z),e(R,Te),e(R,O),e(O,ve),e(R,he),u(h,P,$),u(h,j,$),e(j,ee),u(h,ne,$),u(h,F,$),e(F,q),e(q,ke),e(q,U),e(U,pe),e(q,se),e(q,V),e(V,ue),e(F,ae),e(F,z),e(z,be),e(z,H),e(H,re),e(z,Ce),e(z,W),e(W,S),e(F,te),e(F,I),e(I,oe),e(I,G),e(G,ye)},d(h){h&&t(p),h&&t(f),h&&t(g),h&&t(Y),h&&t(R),h&&t(P),h&&t(j),h&&t(ne),h&&t(F)}}}function sh(J){let p,E,f,g,v;return{c(){p=a("p"),E=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=a("code"),g=n("Module"),v=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(T){p=r(T,"P",{});var _=i(p);E=s(_,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=r(_,"CODE",{});var M=i(f);g=s(M,"Module"),M.forEach(t),v=s(_,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),_.forEach(t)},m(T,_){u(T,p,_),e(p,E),e(p,f),e(f,g),e(p,v)},d(T){T&&t(p)}}}function ah(J){let p,E,f,g,v,T,_,M,_e,Y,R,Q,A,Z,Te,O,ve,he,P,j,ee,ne,F,q,ke,U,pe,se,V,ue,ae,z,be,H,re,Ce,W,S,te,I,oe,G,ye;return{c(){p=a("p"),E=n("TF 2.0 models accepts two formats as inputs:"),f=l(),g=a("ul"),v=a("li"),T=n("having all inputs as keyword arguments (like PyTorch models), or"),_=l(),M=a("li"),_e=n("having all inputs as a list, tuple or dict in the first positional arguments."),Y=l(),R=a("p"),Q=n("This second option is useful when using "),A=a("code"),Z=n("tf.keras.Model.fit"),Te=n(` method which currently requires having all the
tensors in the first argument of the model call function: `),O=a("code"),ve=n("model(inputs)"),he=n("."),P=l(),j=a("p"),ee=n(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),ne=l(),F=a("ul"),q=a("li"),ke=n("a single Tensor with "),U=a("code"),pe=n("input_ids"),se=n(" only and nothing else: "),V=a("code"),ue=n("model(inputs_ids)"),ae=l(),z=a("li"),be=n(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),H=a("code"),re=n("model([input_ids, attention_mask])"),Ce=n(" or "),W=a("code"),S=n("model([input_ids, attention_mask, token_type_ids])"),te=l(),I=a("li"),oe=n(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),G=a("code"),ye=n('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(h){p=r(h,"P",{});var $=i(p);E=s($,"TF 2.0 models accepts two formats as inputs:"),$.forEach(t),f=d(h),g=r(h,"UL",{});var ie=i(g);v=r(ie,"LI",{});var Ae=i(v);T=s(Ae,"having all inputs as keyword arguments (like PyTorch models), or"),Ae.forEach(t),_=d(ie),M=r(ie,"LI",{});var me=i(M);_e=s(me,"having all inputs as a list, tuple or dict in the first positional arguments."),me.forEach(t),ie.forEach(t),Y=d(h),R=r(h,"P",{});var N=i(R);Q=s(N,"This second option is useful when using "),A=r(N,"CODE",{});var qe=i(A);Z=s(qe,"tf.keras.Model.fit"),qe.forEach(t),Te=s(N,` method which currently requires having all the
...
first positional argument :`),He.forEach(t),ne=d(h),F=r(h,"UL",{});var D=i(F);q=r(D,"LI",{});var x=i(q);ke=s(x,"a single Tensor with "),U=r(x,"CODE",{});var We=i(U);pe=s(We,"input_ids"),We.forEach(t),se=s(x," only and nothing else: "),V=r(x,"CODE",{});var ze=i(V);ue=s(ze,"model(inputs_ids)"),ze.forEach(t),x.forEach(t),ae=d(D),z=r(D,"LI",{});var K=i(z);be=s(K,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),H=r(K,"CODE",{});var Be=i(H);re=s(Be,"model([input_ids, attention_mask])"),Be.forEach(t),Ce=s(K," or "),W=r(K,"CODE",{});var xe=i(W);S=s(xe,"model([input_ids, attention_mask, token_type_ids])"),xe.forEach(t),K.forEach(t),te=d(D),I=r(D,"LI",{});var we=i(I);oe=s(we,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),G=r(we,"CODE",{});var Ue=i(G);ye=s(Ue,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),Ue.forEach(t),we.forEach(t),D.forEach(t)},m(h,$){u(h,p,$),e(p,E),u(h,f,$),u(h,g,$),e(g,v),e(v,T),e(g,_),e(g,M),e(M,_e),u(h,Y,$),u(h,R,$),e(R,Q),e(R,A),e(A,Z),e(R,Te),e(R,O),e(O,ve),e(R,he),u(h,P,$),u(h,j,$),e(j,ee),u(h,ne,$),u(h,F,$),e(F,q),e(q,ke),e(q,U),e(U,pe),e(q,se),e(q,V),e(V,ue),e(F,ae),e(F,z),e(z,be),e(z,H),e(H,re),e(z,Ce),e(z,W),e(W,S),e(F,te),e(F,I),e(I,oe),e(I,G),e(G,ye)},d(h){h&&t(p),h&&t(f),h&&t(g),h&&t(Y),h&&t(R),h&&t(P),h&&t(j),h&&t(ne),h&&t(F)}}}function rh(J){let p,E,f,g,v;return{c(){p=a("p"),E=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=a("code"),g=n("Module"),v=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(T){p=r(T,"P",{});var _=i(p);E=s(_,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=r(_,"CODE",{});var M=i(f);g=s(M,"Module"),M.forEach(t),v=s(_,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),_.forEach(t)},m(T,_){u(T,p,_),e(p,E),e(p,f),e(f,g),e(p,v)},d(T){T&&t(p)}}}function ih(J){let p,E,f,g,v,T,_,M,_e,Y,R,Q,A,Z,Te,O,ve,he,P,j,ee,ne,F,q,ke,U,pe,se,V,ue,ae,z,be,H,re,Ce,W,S,te,I,oe,G,ye,h,$,ie,Ae,me,N,qe,Oe,He,D,x,We,ze,K,Be,xe,we,Ue,En,ma,fa,Yo,Fn,ga,_a,Rs,Ye,Ta,Gt,va,ka,Kt,ba,Ca,Ms,ct,Rt,qn,Xt,ya,zn,wa,Es,Le,Jt,La,Je,$a,Zo,Ra,Ma,en,Ea,Fa,Qt,qa,za,xa,ht,Pa,tn,ja,Sa,on,Ia,Na,Da,xn,Aa,Oa,Yt,Fs,pt,Mt,Pn,Zt,Ha,jn,Wa,qs,Ne,eo,Ba,Sn,Ua,Va,to,Ga,nn,Ka,Xa,Ja,sn,oo,zs,ut,Et,In,no,Qa,Nn,Ya,xs,$e,so,Za,Dn,er,tr,ao,or,an,nr,sr,ar,ro,rr,io,ir,lr,dr,Pe,lo,cr,mt,hr,rn,pr,ur,An,mr,fr,gr,Ft,_r,On,Tr,vr,co,Ps,ft,qt,Hn,ho,kr,Wn,br,js,Re,po,Cr,Bn,yr,wr,uo,Lr,ln,$r,Rr,Mr,mo,Er,fo,Fr,qr,zr,je,go,xr,gt,Pr,dn,jr,Sr,Un,Ir,Nr,Dr,zt,Ar,Vn,Or,Hr,_o,Ss,_t,xt,Gn,To,Wr,Kn,Br,Is,Me,vo,Ur,Ee,Vr,cn,Gr,Kr,Xn,Xr,Jr,Jn,Qr,Yr,Qn,Zr,ei,Yn,ti,oi,ni,ko,si,hn,ai,ri,ii,bo,li,Co,di,ci,hi,B,yo,pi,Tt,ui,pn,mi,fi,Zn,gi,_i,Ti,Pt,vi,es,ki,bi,wo,Ci,Lo,yi,ts,wi,Li,$o,$i,Ro,Ns,vt,jt,os,Mo,Ri,ns,Mi,Ds,de,Eo,Ei,ss,Fi,qi,Fo,zi,un,xi,Pi,ji,qo,Si,zo,Ii,Ni,Di,St,Ai,Se,xo,Oi,kt,Hi,mn,Wi,Bi,as,Ui,Vi,Gi,It,Ki,rs,Xi,Ji,Po,As,bt,Nt,is,jo,Qi,ls,Yi,Os,ce,So,Zi,ds,el,tl,Io,ol,fn,nl,sl,al,No,rl,Do,il,ll,dl,Dt,cl,Ie,Ao,hl,Ct,pl,gn,ul,ml,cs,fl,gl,_l,At,Tl,hs,vl,kl,Oo,Hs,yt,Ot,ps,Ho,bl,us,Cl,Ws,X,Wo,yl,ms,wl,Ll,_n,Tn,$l,Rl,Ml,De,El,fs,Fl,ql,gs,zl,xl,_s,Pl,jl,Ts,Sl,Il,Nl,Bo,Dl,vn,Al,Ol,Hl,Uo,Wl,Vo,Bl,Ul,Vl,Ht,Gl,fe,Go,Kl,wt,Xl,kn,Jl,Ql,vs,Yl,Zl,ed,Wt,td,ks,od,nd,Ko,sd,Xo,Bs;return T=new dt({}),Z=new dt({}),Xt=new dt({}),Jt=new Fe({props:{name:"class transformers.CTRLConfig",anchor:"transformers.CTRLConfig",parameters:[{name:"vocab_size",val:" = 246534"},{name:"n_positions",val:" = 256"},{name:"n_embd",val:" = 1280"},{name:"dff",val:" = 8192"},{name:"n_layer",val:" = 48"},{name:"n_head",val:" = 16"},{name:"resid_pdrop",val:" = 0.1"},{name:"embd_pdrop",val:" = 0.1"},{name:"attn_pdrop",val:" = 0.1"},{name:"layer_norm_epsilon",val:" = 1e-06"},{name:"initializer_range",val:" = 0.02"},{name:"summary_type",val:" = 'cls_index'"},{name:"summary_use_proj",val:" = True"},{name:"summary_activation",val:" = None"},{name:"summary_proj_to_labels",val:" = True"},{name:"summary_first_dropout",val:" = 0.1"},{name:"use_cache",val:" = True"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/ctrl/configuration_ctrl.py#L26",parametersDescription:[{anchor:"transformers.CTRLConfig.vocab_size",description:`<strong>vocab_size</strong> (<code>int</code>, <em>optional</em>, defaults to 246534) &#x2014;
...
<p>Indices can be obtained using <a href="/docs/transformers/main/en/model_doc/ctrl#transformers.CTRLTokenizer">CTRLTokenizer</a>. See <a href="/docs/transformers/main/en/model_doc/wav2vec2#transformers.Wav2Vec2CTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
...
`}}),Pt=new $t({props:{$$slots:{default:[eh]},$$scope:{ctx:J}}}),wo=new Qe({props:{code:`import torch
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/main/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),St=new $t({props:{$$slots:{default:[th]},$$scope:{ctx:J}}}),xo=new Fe({props:{name:"call",anchor:"transformers.TFCTRLModel.call",parameters:[{name:"input_ids",val:" = None"},{name:"past_key_values",val:" = None"},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"},{name:"training",val:" = False"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/ctrl/modeling_tf_ctrl.py#L522",parametersDescription:[{anchor:"transformers.TFCTRLModel.call.input_ids",description:`<strong>input_ids</strong> (<code>Numpy array</code> or <code>tf.Tensor</code> of shape <code>(batch_size, input_ids_length)</code>) &#x2014;
...
`}}),It=new $t({props:{$$slots:{default:[oh]},$$scope:{ctx:J}}}),Po=new Qe({props:{code:`from transformers import CTRLTokenizer, TFCTRLModel
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/main/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),Dt=new $t({props:{$$slots:{default:[nh]},$$scope:{ctx:J}}}),Ao=new Fe({props:{name:"call",anchor:"transformers.TFCTRLLMHeadModel.call",parameters:[{name:"input_ids",val:" = None"},{name:"past_key_values",val:" = None"},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"},{name:"labels",val:" = None"},{name:"training",val:" = False"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/ctrl/modeling_tf_ctrl.py#L633",parametersDescription:[{anchor:"transformers.TFCTRLLMHeadModel.call.input_ids",description:`<strong>input_ids</strong> (<code>Numpy array</code> or <code>tf.Tensor</code> of shape <code>(batch_size, input_ids_length)</code>) &#x2014;
<code>input_ids_length</code> = <code>sequence_length</code> if <code>past</code> is <code>None</code> else <code>past[0].shape[-2]</code> (<code>sequence_length</code> of
input past key value states).</p>
<p>Indices of input sequence tokens in the vocabulary.</p>
<p>If <code>past</code> is used, only input IDs that do not have their past calculated should be passed as <code>input_ids</code>.</p>
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/main/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),Ht=new $t({props:{$$slots:{default:[ah]},$$scope:{ctx:J}}}),Go=new Fe({props:{name:"call",anchor:"transformers.TFCTRLForSequenceClassification.call",parameters:[{name:"input_ids",val:" = None"},{name:"past_key_values",val:" = None"},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"},{name:"labels",val:" = None"},{name:"training",val:" = False"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/ctrl/modeling_tf_ctrl.py#L745",parametersDescription:[{anchor:"transformers.TFCTRLForSequenceClassification.call.input_ids",description:`<strong>input_ids</strong> (<code>Numpy array</code> or <code>tf.Tensor</code> of shape <code>(batch_size, input_ids_length)</code>) &#x2014;
<code>input_ids_length</code> = <code>sequence_length</code> if <code>past</code> is <code>None</code> else <code>past[0].shape[-2]</code> (<code>sequence_length</code> of
input past key value states).</p>
<p>Indices of input sequence tokens in the vocabulary.</p>
<p>If <code>past</code> is used, only input IDs that do not have their past calculated should be passed as <code>input_ids</code>.</p>
...
`}}),{c(){p=a("meta"),E=l(),f=a("h1"),g=a("a"),v=a("span"),k(T.$$.fragment),_=l(),M=a("span"),_e=n("CTRL"),Y=l(),R=a("h2"),Q=a("a"),A=a("span"),k(Z.$$.fragment),Te=l(),O=a("span"),ve=n("Overview"),he=l(),P=a("p"),j=n("CTRL model was proposed in "),ee=a("a"),ne=n("CTRL: A Conditional Transformer Language Model for Controllable Generation"),F=n(" by Nitish Shirish Keskar"),q=a("em"),ke=n(", Bryan McCann"),U=n(`, Lav R. Varshney, Caiming Xiong and
...
`),Qt=a("a"),qa=n("ctrl"),za=n(" architecture from SalesForce."),xa=l(),ht=a("p"),Pa=n("Configuration objects inherit from "),tn=a("a"),ja=n("PretrainedConfig"),Sa=n(` and can be used to control the model outputs. Read the
documentation from `),on=a("a"),Ia=n("PretrainedConfig"),Na=n(" for more information."),Da=l(),xn=a("p"),Aa=n("Examples:"),Oa=l(),k(Yt.$$.fragment),Fs=l(),pt=a("h2"),Mt=a("a"),Pn=a("span"),k(Zt.$$.fragment),Ha=l(),jn=a("span"),Wa=n("CTRLTokenizer"),qs=l(),Ne=a("div"),k(eo.$$.fragment),Ba=l(),Sn=a("p"),Ua=n("Construct a CTRL tokenizer. Based on Byte-Pair-Encoding."),Va=l(),to=a("p"),Ga=n("This tokenizer inherits from "),nn=a("a"),Ka=n("PreTrainedTokenizer"),Xa=n(` which contains most of the main methods. Users should refer to
...
and behavior.`),dr=l(),Pe=a("div"),k(lo.$$.fragment),cr=l(),mt=a("p"),hr=n("The "),rn=a("a"),pr=n("CTRLModel"),ur=n(" forward method, overrides the "),An=a("code"),mr=n("__call__"),fr=n(" special method."),gr=l(),k(Ft.$$.fragment),_r=l(),On=a("p"),Tr=n("Example:"),vr=l(),k(co.$$.fragment),Ps=l(),ft=a("h2"),qt=a("a"),Hn=a("span"),k(ho.$$.fragment),kr=l(),Wn=a("span"),br=n("CTRLLMHeadModel"),js=l(),Re=a("div"),k(po.$$.fragment),Cr=l(),Bn=a("p"),yr=n(`The CTRL Model transformer with a language modeling head on top (linear layer with weights tied to the input
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),hi=l(),B=a("div"),k(yo.$$.fragment),pi=l(),Tt=a("p"),ui=n("The "),pn=a("a"),mi=n("CTRLForSequenceClassification"),fi=n(" forward method, overrides the "),Zn=a("code"),gi=n("__call__"),_i=n(" special method."),Ti=l(),k(Pt.$$.fragment),vi=l(),es=a("p"),ki=n("Example of single-label classification:"),bi=l(),k(wo.$$.fragment),Ci=l(),k(Lo.$$.fragment),yi=l(),ts=a("p"),wi=n("Example of multi-label classification:"),Li=l(),k($o.$$.fragment),$i=l(),k(Ro.$$.fragment),Ns=l(),vt=a("h2"),jt=a("a"),os=a("span"),k(Mo.$$.fragment),Ri=l(),ns=a("span"),Mi=n("TFCTRLModel"),Ds=l(),de=a("div"),k(Eo.$$.fragment),Ei=l(),ss=a("p"),Fi=n("The bare CTRL Model transformer outputting raw hidden-states without any specific head on top."),qi=l(),Fo=a("p"),zi=n("This model inherits from "),un=a("a"),xi=n("TFPreTrainedModel"),Pi=n(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),dl=l(),k(Dt.$$.fragment),cl=l(),Ie=a("div"),k(Ao.$$.fragment),hl=l(),Ct=a("p"),pl=n("The "),gn=a("a"),ul=n("TFCTRLLMHeadModel"),ml=n(" forward method, overrides the "),cs=a("code"),fl=n("__call__"),gl=n(" special method."),_l=l(),k(At.$$.fragment),Tl=l(),hs=a("p"),vl=n("Example:"),kl=l(),k(Oo.$$.fragment),Hs=l(),yt=a("h2"),Ot=a("a"),ps=a("span"),k(Ho.$$.fragment),bl=l(),us=a("span"),Cl=n("TFCTRLForSequenceClassification"),Ws=l(),X=a("div"),k(Wo.$$.fragment),yl=l(),ms=a("p"),wl=n("The CTRL Model transformer with a sequence classification head on top (linear layer)."),Ll=l(),_n=a("p"),Tn=a("a"),$l=n("TFCTRLForSequenceClassification"),Rl=n(` uses the last token in order to do the classification, as other causal models
...
more information.`),Us.forEach(t),h=d(Bt),$=r(Bt,"LI",{});var ud=i($);ie=s(ud,`CTRL is a model with absolute position embeddings so it\u2019s usually advised to pad the inputs on the right rather than
...
instantiate a CTRL model according to the specified arguments, defining the model architecture. Instantiating a
configuration with the defaults will yield a similar configuration to that of the
`),Qt=r(Ut,"A",{href:!0,rel:!0});var Rd=i(Qt);qa=s(Rd,"ctrl"),Rd.forEach(t),za=s(Ut," architecture from SalesForce."),Ut.forEach(t),xa=d(et),ht=r(et,"P",{});var Cn=i(ht);Pa=s(Cn,"Configuration objects inherit from "),tn=r(Cn,"A",{href:!0});var Md=i(tn);ja=s(Md,"PretrainedConfig"),Md.forEach(t),Sa=s(Cn,` and can be used to control the model outputs. Read the
documentation from `),on=r(Cn,"A",{href:!0});var Ed=i(on);Ia=s(Ed,"PretrainedConfig"),Ed.forEach(t),Na=s(Cn," for more information."),Cn.forEach(t),Da=d(et),xn=r(et,"P",{});var Fd=i(xn);Aa=s(Fd,"Examples:"),Fd.forEach(t),Oa=d(et),b(Yt.$$.fragment,et),et.forEach(t),Fs=d(o),pt=r(o,"H2",{class:!0});var Ks=i(pt);Mt=r(Ks,"A",{id:!0,class:!0,href:!0});var qd=i(Mt);Pn=r(qd,"SPAN",{});var zd=i(Pn);b(Zt.$$.fragment,zd),zd.forEach(t),qd.forEach(t),Ha=d(Ks),jn=r(Ks,"SPAN",{});var xd=i(jn);Wa=s(xd,"CTRLTokenizer"),xd.forEach(t),Ks.forEach(t),qs=d(o),Ne=r(o,"DIV",{class:!0});var Vt=i(Ne);b(eo.$$.fragment,Vt),Ba=d(Vt),Sn=r(Vt,"P",{});var Pd=i(Sn);Ua=s(Pd,"Construct a CTRL tokenizer. Based on Byte-Pair-Encoding."),Pd.forEach(t),Va=d(Vt),to=r(Vt,"P",{});var Xs=i(to);Ga=s(Xs,"This tokenizer inherits from "),nn=r(Xs,"A",{href:!0});var jd=i(nn);Ka=s(jd,"PreTrainedTokenizer"),jd.forEach(t),Xa=s(Xs,` which contains most of the main methods. Users should refer to
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Ys.forEach(t),dr=d(tt),Pe=r(tt,"DIV",{class:!0});var ot=i(Pe);b(lo.$$.fragment,ot),cr=d(ot),mt=r(ot,"P",{});var yn=i(mt);hr=s(yn,"The "),rn=r(yn,"A",{href:!0});var Wd=i(rn);pr=s(Wd,"CTRLModel"),Wd.forEach(t),ur=s(yn," forward method, overrides the "),An=r(yn,"CODE",{});var Bd=i(An);mr=s(Bd,"__call__"),Bd.forEach(t),fr=s(yn," special method."),yn.forEach(t),gr=d(ot),b(Ft.$$.fragment,ot),_r=d(ot),On=r(ot,"P",{});var Ud=i(On);Tr=s(Ud,"Example:"),Ud.forEach(t),vr=d(ot),b(co.$$.fragment,ot),ot.forEach(t),tt.forEach(t),Ps=d(o),ft=r(o,"H2",{class:!0});var Zs=i(ft);qt=r(Zs,"A",{id:!0,class:!0,href:!0});var Vd=i(qt);Hn=r(Vd,"SPAN",{});var Gd=i(Hn);b(ho.$$.fragment,Gd),Gd.forEach(t),Vd.forEach(t),kr=d(Zs),Wn=r(Zs,"SPAN",{});var Kd=i(Wn);br=s(Kd,"CTRLLMHeadModel"),Kd.forEach(t),Zs.forEach(t),js=d(o),Re=r(o,"DIV",{class:!0});var nt=i(Re);b(po.$$.fragment,nt),Cr=d(nt),Bn=r(nt,"P",{});var Xd=i(Bn);yr=s(Xd,`The CTRL Model transformer with a language modeling head on top (linear layer with weights tied to the input
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),ca.forEach(t),dl=d(Ke),b(Dt.$$.fragment,Ke),cl=d(Ke),Ie=r(Ke,"DIV",{class:!0});var it=i(Ie);b(Ao.$$.fragment,it),hl=d(it),Ct=r(it,"P",{});var Rn=i(Ct);pl=s(Rn,"The "),gn=r(Rn,"A",{href:!0});var Fc=i(gn);ul=s(Fc,"TFCTRLLMHeadModel"),Fc.forEach(t),ml=s(Rn," forward method, overrides the "),cs=r(Rn,"CODE",{});var qc=i(cs);fl=s(qc,"__call__"),qc.forEach(t),gl=s(Rn," special method."),Rn.forEach(t),_l=d(it),b(At.$$.fragment,it),Tl=d(it),hs=r(it,"P",{});var zc=i(hs);vl=s(zc,"Example:"),zc.forEach(t),kl=d(it),b(Oo.$$.fragment,it),it.forEach(t),Ke.forEach(t),Hs=d(o),yt=r(o,"H2",{class:!0});var ha=i(yt);Ot=r(ha,"A",{id:!0,class:!0,href:!0});var xc=i(Ot);ps=r(xc,"SPAN",{});var Pc=i(ps);b(Ho.$$.fragment,Pc),Pc.forEach(t),xc.forEach(t),bl=d(ha),us=r(ha,"SPAN",{});var jc=i(us);Cl=s(jc,"TFCTRLForSequenceClassification"),jc.forEach(t),ha.forEach(t),Ws=d(o),X=r(o,"DIV",{class:!0});var ge=i(X);b(Wo.$$.fragment,ge),yl=d(ge),ms=r(ge,"P",{});var Sc=i(ms);wl=s(Sc,"The CTRL Model transformer with a sequence classification head on top (linear layer)."),Sc.forEach(t),Ll=d(ge),_n=r(ge,"P",{});var ad=i(_n);Tn=r(ad,"A",{href:!0});var Ic=i(Tn);$l=s(Ic,"TFCTRLForSequenceClassification"),Ic.forEach(t),Rl=s(ad,` uses the last token in order to do the classification, as other causal models
