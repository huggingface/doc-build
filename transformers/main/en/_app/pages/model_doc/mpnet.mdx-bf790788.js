...
the latter silently ignores them.`)},l(d){l=s(d,"P",{});var f=a(l);g=i(f,"Although the recipe for forward pass needs to be defined within this function, one should call the "),c=s(f,"CODE",{});var E=a(c);p=i(E,"Module"),E.forEach(t),b=i(f,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
<span class="hljs-meta">&gt;&gt;&gt; </span>loss = outputs.loss
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-built_in">round</span>(loss.item(), <span class="hljs-number">2</span>)
`}}),{c(){T(l.$$.fragment)},l(c){M(l.$$.fragment,c)},m(c,p){$(l,c,p),g=!0},p:ve,i(c){g||(w(l.$$.fragment,c),g=!0)},o(c){P(l.$$.fragment,c),g=!1},d(c){N(l,c)}}}function T_(y){let l,g,c,p,b,d,f,E,le,B,z,X,D,G,de,W,ce,se,U,O,Y,V,q,x,Z,H,ae,ee,R,re,te,C,pe,Q,oe,me,L,ne,j,he;return{c(){l=n("p"),g=r("TF 2.0 models accepts two formats as inputs:"),c=m(),p=n("ul"),b=n("li"),d=r("having all inputs as keyword arguments (like PyTorch models), or"),f=m(),E=n("li"),le=r("having all inputs as a list, tuple or dict in the first positional arguments."),B=m(),z=n("p"),X=r("This second option is useful when using "),D=n("code"),G=r("tf.keras.Model.fit"),de=r(` method which currently requires having all the
...
`),j=n("code"),he=r('model({"input_ids": input_ids, "attention_mask": attention_mask})')},l(u){l=s(u,"P",{});var F=a(l);g=i(F,"TF 2.0 models accepts two formats as inputs:"),F.forEach(t),c=h(u),p=s(u,"UL",{});var K=a(p);b=s(K,"LI",{});var _e=a(b);d=i(_e,"having all inputs as keyword arguments (like PyTorch models), or"),_e.forEach(t),f=h(K),E=s(K,"LI",{});var Me=a(E);le=i(Me,"having all inputs as a list, tuple or dict in the first positional arguments."),Me.forEach(t),K.forEach(t),B=h(u),z=s(u,"P",{});var I=a(z);X=i(I,"This second option is useful when using "),D=s(I,"CODE",{});var ke=a(D);G=i(ke,"tf.keras.Model.fit"),ke.forEach(t),de=i(I,` method which currently requires having all the
...
`),j=s(ie,"CODE",{});var ue=a(j);he=i(ue,'model({"input_ids": input_ids, "attention_mask": attention_mask})'),ue.forEach(t),ie.forEach(t),A.forEach(t)},m(u,F){_(u,l,F),e(l,g),_(u,c,F),_(u,p,F),e(p,b),e(b,d),e(p,f),e(p,E),e(E,le),_(u,B,F),_(u,z,F),e(z,X),e(z,D),e(D,G),e(z,de),e(z,W),e(W,ce),e(z,se),_(u,U,F),_(u,O,F),e(O,Y),_(u,V,F),_(u,q,F),e(q,x),e(x,Z),e(x,H),e(H,ae),e(x,ee),e(x,R),e(R,re),e(q,te),e(q,C),e(C,pe),e(C,Q),e(Q,oe),e(q,me),e(q,L),e(L,ne),e(L,j),e(j,he)},d(u){u&&t(l),u&&t(c),u&&t(p),u&&t(B),u&&t(z),u&&t(U),u&&t(O),u&&t(V),u&&t(q)}}}function M_(y){let l,g,c,p,b;return{c(){l=n("p"),g=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),c=n("code"),p=r("Module"),b=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(d){l=s(d,"P",{});var f=a(l);g=i(f,"Although the recipe for forward pass needs to be defined within this function, one should call the "),c=s(f,"CODE",{});var E=a(c);p=i(E,"Module"),E.forEach(t),b=i(f,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),{c(){l=n("p"),g=r("Example:"),c=m(),T(p.$$.fragment)},l(d){l=s(d,"P",{});var f=a(l);g=i(f,"Example:"),f.forEach(t),c=h(d),M(p.$$.fragment,d)},m(d,f){_(d,l,f),e(l,g),_(d,c,f),$(p,d,f),b=!0},p:ve,i(d){b||(w(p.$$.fragment,d),b=!0)},o(d){P(p.$$.fragment,d),b=!1},d(d){d&&t(l),d&&t(c),N(p,d)}}}function w_(y){let l,g,c,p,b,d,f,E,le,B,z,X,D,G,de,W,ce,se,U,O,Y,V,q,x,Z,H,ae,ee,R,re,te,C,pe,Q,oe,me,L,ne,j,he;return{c(){l=n("p"),g=r("TF 2.0 models accepts two formats as inputs:"),c=m(),p=n("ul"),b=n("li"),d=r("having all inputs as keyword arguments (like PyTorch models), or"),f=m(),E=n("li"),le=r("having all inputs as a list, tuple or dict in the first positional arguments."),B=m(),z=n("p"),X=r("This second option is useful when using "),D=n("code"),G=r("tf.keras.Model.fit"),de=r(` method which currently requires having all the
tensors in the first argument of the model call function: `),W=n("code"),ce=r("model(inputs)"),se=r("."),U=m(),O=n("p"),Y=r(`If you choose this second option, there are three possibilities you can use to gather all the input Tensor in the
first positional argument :`),V=m(),q=n("ul"),x=n("li"),Z=r("a single Tensor with "),H=n("code"),ae=r("input_ids"),ee=r(" only and nothing else: "),R=n("code"),re=r("model(inputs_ids)"),te=m(),C=n("li"),pe=r(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),Q=n("code"),oe=r("model([input_ids, attention_mask])"),me=m(),L=n("li"),ne=r(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),j=n("code"),he=r('model({"input_ids": input_ids, "attention_mask": attention_mask})')},l(u){l=s(u,"P",{});var F=a(l);g=i(F,"TF 2.0 models accepts two formats as inputs:"),F.forEach(t),c=h(u),p=s(u,"UL",{});var K=a(p);b=s(K,"LI",{});var _e=a(b);d=i(_e,"having all inputs as keyword arguments (like PyTorch models), or"),_e.forEach(t),f=h(K),E=s(K,"LI",{});var Me=a(E);le=i(Me,"having all inputs as a list, tuple or dict in the first positional arguments."),Me.forEach(t),K.forEach(t),B=h(u),z=s(u,"P",{});var I=a(z);X=i(I,"This second option is useful when using "),D=s(I,"CODE",{});var ke=a(D);G=i(ke,"tf.keras.Model.fit"),ke.forEach(t),de=i(I,` method which currently requires having all the
...
first positional argument :`),we.forEach(t),V=h(u),q=s(u,"UL",{});var A=a(q);x=s(A,"LI",{});var S=a(x);Z=i(S,"a single Tensor with "),H=s(S,"CODE",{});var Pe=a(H);ae=i(Pe,"input_ids"),Pe.forEach(t),ee=i(S," only and nothing else: "),R=s(S,"CODE",{});var ge=a(R);re=i(ge,"model(inputs_ids)"),ge.forEach(t),S.forEach(t),te=h(A),C=s(A,"LI",{});var fe=a(C);pe=i(fe,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),Q=s(fe,"CODE",{});var Ne=a(Q);oe=i(Ne,"model([input_ids, attention_mask])"),Ne.forEach(t),fe.forEach(t),me=h(A),L=s(A,"LI",{});var ie=a(L);ne=i(ie,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),j=s(ie,"CODE",{});var ue=a(j);he=i(ue,'model({"input_ids": input_ids, "attention_mask": attention_mask})'),ue.forEach(t),ie.forEach(t),A.forEach(t)},m(u,F){_(u,l,F),e(l,g),_(u,c,F),_(u,p,F),e(p,b),e(b,d),e(p,f),e(p,E),e(E,le),_(u,B,F),_(u,z,F),e(z,X),e(z,D),e(D,G),e(z,de),e(z,W),e(W,ce),e(z,se),_(u,U,F),_(u,O,F),e(O,Y),_(u,V,F),_(u,q,F),e(q,x),e(x,Z),e(x,H),e(H,ae),e(x,ee),e(x,R),e(R,re),e(q,te),e(q,C),e(C,pe),e(C,Q),e(Q,oe),e(q,me),e(q,L),e(L,ne),e(L,j),e(j,he)},d(u){u&&t(l),u&&t(c),u&&t(p),u&&t(B),u&&t(z),u&&t(U),u&&t(O),u&&t(V),u&&t(q)}}}function P_(y){let l,g,c,p,b;return{c(){l=n("p"),g=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),c=n("code"),p=r("Module"),b=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(d){l=s(d,"P",{});var f=a(l);g=i(f,"Although the recipe for forward pass needs to be defined within this function, one should call the "),c=s(f,"CODE",{});var E=a(c);p=i(E,"Module"),E.forEach(t),b=i(f,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
`}}),{c(){T(l.$$.fragment)},l(c){M(l.$$.fragment,c)},m(c,p){$(l,c,p),g=!0},p:ve,i(c){g||(w(l.$$.fragment,c),g=!0)},o(c){P(l.$$.fragment,c),g=!1},d(c){N(l,c)}}}function F_(y){let l,g,c,p,b,d,f,E,le,B,z,X,D,G,de,W,ce,se,U,O,Y,V,q,x,Z,H,ae,ee,R,re,te,C,pe,Q,oe,me,L,ne,j,he;return{c(){l=n("p"),g=r("TF 2.0 models accepts two formats as inputs:"),c=m(),p=n("ul"),b=n("li"),d=r("having all inputs as keyword arguments (like PyTorch models), or"),f=m(),E=n("li"),le=r("having all inputs as a list, tuple or dict in the first positional arguments."),B=m(),z=n("p"),X=r("This second option is useful when using "),D=n("code"),G=r("tf.keras.Model.fit"),de=r(` method which currently requires having all the
tensors in the first argument of the model call function: `),W=n("code"),ce=r("model(inputs)"),se=r("."),U=m(),O=n("p"),Y=r(`If you choose this second option, there are three possibilities you can use to gather all the input Tensor in the
first positional argument :`),V=m(),q=n("ul"),x=n("li"),Z=r("a single Tensor with "),H=n("code"),ae=r("input_ids"),ee=r(" only and nothing else: "),R=n("code"),re=r("model(inputs_ids)"),te=m(),C=n("li"),pe=r(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),Q=n("code"),oe=r("model([input_ids, attention_mask])"),me=m(),L=n("li"),ne=r(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),j=n("code"),he=r('model({"input_ids": input_ids, "attention_mask": attention_mask})')},l(u){l=s(u,"P",{});var F=a(l);g=i(F,"TF 2.0 models accepts two formats as inputs:"),F.forEach(t),c=h(u),p=s(u,"UL",{});var K=a(p);b=s(K,"LI",{});var _e=a(b);d=i(_e,"having all inputs as keyword arguments (like PyTorch models), or"),_e.forEach(t),f=h(K),E=s(K,"LI",{});var Me=a(E);le=i(Me,"having all inputs as a list, tuple or dict in the first positional arguments."),Me.forEach(t),K.forEach(t),B=h(u),z=s(u,"P",{});var I=a(z);X=i(I,"This second option is useful when using "),D=s(I,"CODE",{});var ke=a(D);G=i(ke,"tf.keras.Model.fit"),ke.forEach(t),de=i(I,` method which currently requires having all the
...
first positional argument :`),we.forEach(t),V=h(u),q=s(u,"UL",{});var A=a(q);x=s(A,"LI",{});var S=a(x);Z=i(S,"a single Tensor with "),H=s(S,"CODE",{});var Pe=a(H);ae=i(Pe,"input_ids"),Pe.forEach(t),ee=i(S," only and nothing else: "),R=s(S,"CODE",{});var ge=a(R);re=i(ge,"model(inputs_ids)"),ge.forEach(t),S.forEach(t),te=h(A),C=s(A,"LI",{});var fe=a(C);pe=i(fe,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),Q=s(fe,"CODE",{});var Ne=a(Q);oe=i(Ne,"model([input_ids, attention_mask])"),Ne.forEach(t),fe.forEach(t),me=h(A),L=s(A,"LI",{});var ie=a(L);ne=i(ie,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),j=s(ie,"CODE",{});var ue=a(j);he=i(ue,'model({"input_ids": input_ids, "attention_mask": attention_mask})'),ue.forEach(t),ie.forEach(t),A.forEach(t)},m(u,F){_(u,l,F),e(l,g),_(u,c,F),_(u,p,F),e(p,b),e(b,d),e(p,f),e(p,E),e(E,le),_(u,B,F),_(u,z,F),e(z,X),e(z,D),e(D,G),e(z,de),e(z,W),e(W,ce),e(z,se),_(u,U,F),_(u,O,F),e(O,Y),_(u,V,F),_(u,q,F),e(q,x),e(x,Z),e(x,H),e(H,ae),e(x,ee),e(x,R),e(R,re),e(q,te),e(q,C),e(C,pe),e(C,Q),e(Q,oe),e(q,me),e(q,L),e(L,ne),e(L,j),e(j,he)},d(u){u&&t(l),u&&t(c),u&&t(p),u&&t(B),u&&t(z),u&&t(U),u&&t(O),u&&t(V),u&&t(q)}}}function E_(y){let l,g,c,p,b;return{c(){l=n("p"),g=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),c=n("code"),p=r("Module"),b=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(d){l=s(d,"P",{});var f=a(l);g=i(f,"Although the recipe for forward pass needs to be defined within this function, one should call the "),c=s(f,"CODE",{});var E=a(c);p=i(E,"Module"),E.forEach(t),b=i(f,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
`}}),{c(){T(l.$$.fragment)},l(c){M(l.$$.fragment,c)},m(c,p){$(l,c,p),g=!0},p:ve,i(c){g||(w(l.$$.fragment,c),g=!0)},o(c){P(l.$$.fragment,c),g=!1},d(c){N(l,c)}}}function x_(y){let l,g,c,p,b,d,f,E,le,B,z,X,D,G,de,W,ce,se,U,O,Y,V,q,x,Z,H,ae,ee,R,re,te,C,pe,Q,oe,me,L,ne,j,he;return{c(){l=n("p"),g=r("TF 2.0 models accepts two formats as inputs:"),c=m(),p=n("ul"),b=n("li"),d=r("having all inputs as keyword arguments (like PyTorch models), or"),f=m(),E=n("li"),le=r("having all inputs as a list, tuple or dict in the first positional arguments."),B=m(),z=n("p"),X=r("This second option is useful when using "),D=n("code"),G=r("tf.keras.Model.fit"),de=r(` method which currently requires having all the
tensors in the first argument of the model call function: `),W=n("code"),ce=r("model(inputs)"),se=r("."),U=m(),O=n("p"),Y=r(`If you choose this second option, there are three possibilities you can use to gather all the input Tensor in the
first positional argument :`),V=m(),q=n("ul"),x=n("li"),Z=r("a single Tensor with "),H=n("code"),ae=r("input_ids"),ee=r(" only and nothing else: "),R=n("code"),re=r("model(inputs_ids)"),te=m(),C=n("li"),pe=r(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),Q=n("code"),oe=r("model([input_ids, attention_mask])"),me=m(),L=n("li"),ne=r(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),j=n("code"),he=r('model({"input_ids": input_ids, "attention_mask": attention_mask})')},l(u){l=s(u,"P",{});var F=a(l);g=i(F,"TF 2.0 models accepts two formats as inputs:"),F.forEach(t),c=h(u),p=s(u,"UL",{});var K=a(p);b=s(K,"LI",{});var _e=a(b);d=i(_e,"having all inputs as keyword arguments (like PyTorch models), or"),_e.forEach(t),f=h(K),E=s(K,"LI",{});var Me=a(E);le=i(Me,"having all inputs as a list, tuple or dict in the first positional arguments."),Me.forEach(t),K.forEach(t),B=h(u),z=s(u,"P",{});var I=a(z);X=i(I,"This second option is useful when using "),D=s(I,"CODE",{});var ke=a(D);G=i(ke,"tf.keras.Model.fit"),ke.forEach(t),de=i(I,` method which currently requires having all the
...
first positional argument :`),we.forEach(t),V=h(u),q=s(u,"UL",{});var A=a(q);x=s(A,"LI",{});var S=a(x);Z=i(S,"a single Tensor with "),H=s(S,"CODE",{});var Pe=a(H);ae=i(Pe,"input_ids"),Pe.forEach(t),ee=i(S," only and nothing else: "),R=s(S,"CODE",{});var ge=a(R);re=i(ge,"model(inputs_ids)"),ge.forEach(t),S.forEach(t),te=h(A),C=s(A,"LI",{});var fe=a(C);pe=i(fe,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),Q=s(fe,"CODE",{});var Ne=a(Q);oe=i(Ne,"model([input_ids, attention_mask])"),Ne.forEach(t),fe.forEach(t),me=h(A),L=s(A,"LI",{});var ie=a(L);ne=i(ie,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),j=s(ie,"CODE",{});var ue=a(j);he=i(ue,'model({"input_ids": input_ids, "attention_mask": attention_mask})'),ue.forEach(t),ie.forEach(t),A.forEach(t)},m(u,F){_(u,l,F),e(l,g),_(u,c,F),_(u,p,F),e(p,b),e(b,d),e(p,f),e(p,E),e(E,le),_(u,B,F),_(u,z,F),e(z,X),e(z,D),e(D,G),e(z,de),e(z,W),e(W,ce),e(z,se),_(u,U,F),_(u,O,F),e(O,Y),_(u,V,F),_(u,q,F),e(q,x),e(x,Z),e(x,H),e(H,ae),e(x,ee),e(x,R),e(R,re),e(q,te),e(q,C),e(C,pe),e(C,Q),e(Q,oe),e(q,me),e(q,L),e(L,ne),e(L,j),e(j,he)},d(u){u&&t(l),u&&t(c),u&&t(p),u&&t(B),u&&t(z),u&&t(U),u&&t(O),u&&t(V),u&&t(q)}}}function C_(y){let l,g,c,p,b;return{c(){l=n("p"),g=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),c=n("code"),p=r("Module"),b=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(d){l=s(d,"P",{});var f=a(l);g=i(f,"Although the recipe for forward pass needs to be defined within this function, one should call the "),c=s(f,"CODE",{});var E=a(c);p=i(E,"Module"),E.forEach(t),b=i(f,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-comment"># the linear classifier still needs to be trained</span>
<span class="hljs-meta">&gt;&gt;&gt; </span>logits = outputs.logits`}}),{c(){l=n("p"),g=r("Example:"),c=m(),T(p.$$.fragment)},l(d){l=s(d,"P",{});var f=a(l);g=i(f,"Example:"),f.forEach(t),c=h(d),M(p.$$.fragment,d)},m(d,f){_(d,l,f),e(l,g),_(d,c,f),$(p,d,f),b=!0},p:ve,i(d){b||(w(p.$$.fragment,d),b=!0)},o(d){P(p.$$.fragment,d),b=!1},d(d){d&&t(l),d&&t(c),N(p,d)}}}function L_(y){let l,g,c,p,b,d,f,E,le,B,z,X,D,G,de,W,ce,se,U,O,Y,V,q,x,Z,H,ae,ee,R,re,te,C,pe,Q,oe,me,L,ne,j,he;return{c(){l=n("p"),g=r("TF 2.0 models accepts two formats as inputs:"),c=m(),p=n("ul"),b=n("li"),d=r("having all inputs as keyword arguments (like PyTorch models), or"),f=m(),E=n("li"),le=r("having all inputs as a list, tuple or dict in the first positional arguments."),B=m(),z=n("p"),X=r("This second option is useful when using "),D=n("code"),G=r("tf.keras.Model.fit"),de=r(` method which currently requires having all the
tensors in the first argument of the model call function: `),W=n("code"),ce=r("model(inputs)"),se=r("."),U=m(),O=n("p"),Y=r(`If you choose this second option, there are three possibilities you can use to gather all the input Tensor in the
first positional argument :`),V=m(),q=n("ul"),x=n("li"),Z=r("a single Tensor with "),H=n("code"),ae=r("input_ids"),ee=r(" only and nothing else: "),R=n("code"),re=r("model(inputs_ids)"),te=m(),C=n("li"),pe=r(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),Q=n("code"),oe=r("model([input_ids, attention_mask])"),me=m(),L=n("li"),ne=r(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),j=n("code"),he=r('model({"input_ids": input_ids, "attention_mask": attention_mask})')},l(u){l=s(u,"P",{});var F=a(l);g=i(F,"TF 2.0 models accepts two formats as inputs:"),F.forEach(t),c=h(u),p=s(u,"UL",{});var K=a(p);b=s(K,"LI",{});var _e=a(b);d=i(_e,"having all inputs as keyword arguments (like PyTorch models), or"),_e.forEach(t),f=h(K),E=s(K,"LI",{});var Me=a(E);le=i(Me,"having all inputs as a list, tuple or dict in the first positional arguments."),Me.forEach(t),K.forEach(t),B=h(u),z=s(u,"P",{});var I=a(z);X=i(I,"This second option is useful when using "),D=s(I,"CODE",{});var ke=a(D);G=i(ke,"tf.keras.Model.fit"),ke.forEach(t),de=i(I,` method which currently requires having all the
...
first positional argument :`),we.forEach(t),V=h(u),q=s(u,"UL",{});var A=a(q);x=s(A,"LI",{});var S=a(x);Z=i(S,"a single Tensor with "),H=s(S,"CODE",{});var Pe=a(H);ae=i(Pe,"input_ids"),Pe.forEach(t),ee=i(S," only and nothing else: "),R=s(S,"CODE",{});var ge=a(R);re=i(ge,"model(inputs_ids)"),ge.forEach(t),S.forEach(t),te=h(A),C=s(A,"LI",{});var fe=a(C);pe=i(fe,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),Q=s(fe,"CODE",{});var Ne=a(Q);oe=i(Ne,"model([input_ids, attention_mask])"),Ne.forEach(t),fe.forEach(t),me=h(A),L=s(A,"LI",{});var ie=a(L);ne=i(ie,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),j=s(ie,"CODE",{});var ue=a(j);he=i(ue,'model({"input_ids": input_ids, "attention_mask": attention_mask})'),ue.forEach(t),ie.forEach(t),A.forEach(t)},m(u,F){_(u,l,F),e(l,g),_(u,c,F),_(u,p,F),e(p,b),e(b,d),e(p,f),e(p,E),e(E,le),_(u,B,F),_(u,z,F),e(z,X),e(z,D),e(D,G),e(z,de),e(z,W),e(W,ce),e(z,se),_(u,U,F),_(u,O,F),e(O,Y),_(u,V,F),_(u,q,F),e(q,x),e(x,Z),e(x,H),e(H,ae),e(x,ee),e(x,R),e(R,re),e(q,te),e(q,C),e(C,pe),e(C,Q),e(Q,oe),e(q,me),e(q,L),e(L,ne),e(L,j),e(j,he)},d(u){u&&t(l),u&&t(c),u&&t(p),u&&t(B),u&&t(z),u&&t(U),u&&t(O),u&&t(V),u&&t(q)}}}function A_(y){let l,g,c,p,b;return{c(){l=n("p"),g=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),c=n("code"),p=r("Module"),b=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(d){l=s(d,"P",{});var f=a(l);g=i(f,"Although the recipe for forward pass needs to be defined within this function, one should call the "),c=s(f,"CODE",{});var E=a(c);p=i(E,"Module"),E.forEach(t),b=i(f,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-built_in">round</span>(<span class="hljs-built_in">float</span>(loss), <span class="hljs-number">2</span>)
`}}),{c(){T(l.$$.fragment)},l(c){M(l.$$.fragment,c)},m(c,p){$(l,c,p),g=!0},p:ve,i(c){g||(w(l.$$.fragment,c),g=!0)},o(c){P(l.$$.fragment,c),g=!1},d(c){N(l,c)}}}function S_(y){let l,g,c,p,b,d,f,E,le,B,z,X,D,G,de,W,ce,se,U,O,Y,V,q,x,Z,H,ae,ee,R,re,te,C,pe,Q,oe,me,L,ne,j,he;return{c(){l=n("p"),g=r("TF 2.0 models accepts two formats as inputs:"),c=m(),p=n("ul"),b=n("li"),d=r("having all inputs as keyword arguments (like PyTorch models), or"),f=m(),E=n("li"),le=r("having all inputs as a list, tuple or dict in the first positional arguments."),B=m(),z=n("p"),X=r("This second option is useful when using "),D=n("code"),G=r("tf.keras.Model.fit"),de=r(` method which currently requires having all the
tensors in the first argument of the model call function: `),W=n("code"),ce=r("model(inputs)"),se=r("."),U=m(),O=n("p"),Y=r(`If you choose this second option, there are three possibilities you can use to gather all the input Tensor in the
first positional argument :`),V=m(),q=n("ul"),x=n("li"),Z=r("a single Tensor with "),H=n("code"),ae=r("input_ids"),ee=r(" only and nothing else: "),R=n("code"),re=r("model(inputs_ids)"),te=m(),C=n("li"),pe=r(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),Q=n("code"),oe=r("model([input_ids, attention_mask])"),me=m(),L=n("li"),ne=r(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),j=n("code"),he=r('model({"input_ids": input_ids, "attention_mask": attention_mask})')},l(u){l=s(u,"P",{});var F=a(l);g=i(F,"TF 2.0 models accepts two formats as inputs:"),F.forEach(t),c=h(u),p=s(u,"UL",{});var K=a(p);b=s(K,"LI",{});var _e=a(b);d=i(_e,"having all inputs as keyword arguments (like PyTorch models), or"),_e.forEach(t),f=h(K),E=s(K,"LI",{});var Me=a(E);le=i(Me,"having all inputs as a list, tuple or dict in the first positional arguments."),Me.forEach(t),K.forEach(t),B=h(u),z=s(u,"P",{});var I=a(z);X=i(I,"This second option is useful when using "),D=s(I,"CODE",{});var ke=a(D);G=i(ke,"tf.keras.Model.fit"),ke.forEach(t),de=i(I,` method which currently requires having all the
...
first positional argument :`),we.forEach(t),V=h(u),q=s(u,"UL",{});var A=a(q);x=s(A,"LI",{});var S=a(x);Z=i(S,"a single Tensor with "),H=s(S,"CODE",{});var Pe=a(H);ae=i(Pe,"input_ids"),Pe.forEach(t),ee=i(S," only and nothing else: "),R=s(S,"CODE",{});var ge=a(R);re=i(ge,"model(inputs_ids)"),ge.forEach(t),S.forEach(t),te=h(A),C=s(A,"LI",{});var fe=a(C);pe=i(fe,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),Q=s(fe,"CODE",{});var Ne=a(Q);oe=i(Ne,"model([input_ids, attention_mask])"),Ne.forEach(t),fe.forEach(t),me=h(A),L=s(A,"LI",{});var ie=a(L);ne=i(ie,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),j=s(ie,"CODE",{});var ue=a(j);he=i(ue,'model({"input_ids": input_ids, "attention_mask": attention_mask})'),ue.forEach(t),ie.forEach(t),A.forEach(t)},m(u,F){_(u,l,F),e(l,g),_(u,c,F),_(u,p,F),e(p,b),e(b,d),e(p,f),e(p,E),e(E,le),_(u,B,F),_(u,z,F),e(z,X),e(z,D),e(D,G),e(z,de),e(z,W),e(W,ce),e(z,se),_(u,U,F),_(u,O,F),e(O,Y),_(u,V,F),_(u,q,F),e(q,x),e(x,Z),e(x,H),e(H,ae),e(x,ee),e(x,R),e(R,re),e(q,te),e(q,C),e(C,pe),e(C,Q),e(Q,oe),e(q,me),e(q,L),e(L,ne),e(L,j),e(j,he)},d(u){u&&t(l),u&&t(c),u&&t(p),u&&t(B),u&&t(z),u&&t(U),u&&t(O),u&&t(V),u&&t(q)}}}function D_(y){let l,g,c,p,b;return{c(){l=n("p"),g=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),c=n("code"),p=r("Module"),b=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(d){l=s(d,"P",{});var f=a(l);g=i(f,"Although the recipe for forward pass needs to be defined within this function, one should call the "),c=s(f,"CODE",{});var E=a(c);p=i(E,"Module"),E.forEach(t),b=i(f,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-built_in">round</span>(<span class="hljs-built_in">float</span>(loss), <span class="hljs-number">2</span>)
`}}),{c(){T(l.$$.fragment)},l(c){M(l.$$.fragment,c)},m(c,p){$(l,c,p),g=!0},p:ve,i(c){g||(w(l.$$.fragment,c),g=!0)},o(c){P(l.$$.fragment,c),g=!1},d(c){N(l,c)}}}function H_(y){let l,g,c,p,b,d,f,E,le,B,z,X,D,G,de,W,ce,se,U,O,Y,V,q,x,Z,H,ae,ee,R,re,te,C,pe,Q,oe,me,L,ne,j,he,u,F,K,_e,Me,I,ke,$e,we,A,S,Pe,ge,fe,Ne,ie,ue,no,Ka,un,Gl,Xa,Yl,qi,Ge,gn,Zl,dt,ed,ta,td,od,oa,nd,sd,_n,ad,rd,id,Nt,ld,na,dd,cd,sa,pd,md,hd,so,xi,yt,ao,Ja,kn,fd,Ga,ud,Ci,Ee,bn,gd,vn,_d,aa,kd,bd,vd,ht,Tn,Td,Ya,Md,$d,Mn,ra,wd,Za,Pd,Nd,ia,yd,er,Fd,Ed,ro,$n,zd,wn,qd,tr,xd,Cd,jd,io,Pn,Ld,or,Ad,Od,la,Nn,ji,Ft,lo,nr,yn,Id,sr,Sd,Li,Ye,Fn,Dd,En,Wd,ar,Qd,Hd,Rd,zn,Ud,da,Bd,Vd,Kd,co,qn,Xd,rr,Jd,Ai,Et,po,ir,xn,Gd,lr,Yd,Oi,Oe,Cn,Zd,dr,ec,tc,jn,oc,ca,nc,sc,ac,Ln,rc,An,ic,lc,dc,Ze,On,cc,zt,pc,pa,mc,hc,cr,fc,uc,gc,mo,_c,ho,Ii,qt,fo,pr,In,kc,mr,bc,Si,xt,Sn,vc,He,Dn,Tc,Ct,Mc,ma,$c,wc,hr,Pc,Nc,yc,uo,Fc,go,Ec,_o,Di,jt,ko,fr,Wn,zc,ur,qc,Wi,Ie,Qn,xc,gr,Cc,jc,Hn,Lc,ha,Ac,Oc,Ic,Rn,Sc,Un,Dc,Wc,Qc,ye,Bn,Hc,Lt,Rc,fa,Uc,Bc,_r,Vc,Kc,Xc,bo,Jc,vo,Gc,To,Yc,Mo,Zc,$o,Qi,At,wo,kr,Vn,ep,br,tp,Hi,Se,Kn,op,vr,np,sp,Xn,ap,ua,rp,ip,lp,Jn,dp,Gn,cp,pp,mp,et,Yn,hp,Ot,fp,ga,up,gp,Tr,_p,kp,bp,Po,vp,No,Ri,It,yo,Mr,Zn,Tp,$r,Mp,Ui,De,es,$p,wr,wp,Pp,ts,Np,_a,yp,Fp,Ep,os,zp,ns,qp,xp,Cp,Re,ss,jp,St,Lp,ka,Ap,Op,Pr,Ip,Sp,Dp,Fo,Wp,Eo,Qp,zo,Bi,Dt,qo,Nr,as,Hp,yr,Rp,Vi,We,rs,Up,Wt,Bp,Fr,Vp,Kp,Er,Xp,Jp,Gp,is,Yp,ba,Zp,em,tm,ls,om,ds,nm,sm,am,Ue,cs,rm,Qt,im,va,lm,dm,zr,cm,pm,mm,xo,hm,Co,fm,jo,Ki,Ht,Lo,qr,ps,um,xr,gm,Xi,ze,ms,_m,Cr,km,bm,hs,vm,Ta,Tm,Mm,$m,fs,wm,us,Pm,Nm,ym,Ao,Fm,tt,gs,Em,Rt,zm,Ma,qm,xm,jr,Cm,jm,Lm,Oo,Am,Io,Ji,Ut,So,Lr,_s,Om,Ar,Im,Gi,qe,ks,Sm,bs,Dm,Or,Wm,Qm,Hm,vs,Rm,$a,Um,Bm,Vm,Ts,Km,Ms,Xm,Jm,Gm,Do,Ym,Be,$s,Zm,Bt,eh,wa,th,oh,Ir,nh,sh,ah,Wo,rh,Qo,ih,Ho,Yi,Vt,Ro,Sr,ws,lh,Dr,dh,Zi,xe,Ps,ch,Wr,ph,mh,Ns,hh,Pa,fh,uh,gh,ys,_h,Fs,kh,bh,vh,Uo,Th,Ve,Es,Mh,Kt,$h,Na,wh,Ph,Qr,Nh,yh,Fh,Bo,Eh,Vo,zh,Ko,el,Xt,Xo,Hr,zs,qh,Rr,xh,tl,Ce,qs,Ch,Ur,jh,Lh,xs,Ah,ya,Oh,Ih,Sh,Cs,Dh,js,Wh,Qh,Hh,Jo,Rh,ot,Ls,Uh,Jt,Bh,Fa,Vh,Kh,Br,Xh,Jh,Gh,Go,Yh,Yo,ol,Gt,Zo,Vr,As,Zh,Kr,ef,nl,je,Os,tf,Xr,of,nf,Is,sf,Ea,af,rf,lf,Ss,df,Ds,cf,pf,mf,en,hf,Ke,Ws,ff,Yt,uf,za,gf,_f,Jr,kf,bf,vf,tn,Tf,on,Mf,nn,sl,Zt,sn,Gr,Qs,$f,Yr,wf,al,Le,Hs,Pf,eo,Nf,Zr,yf,Ff,ei,Ef,zf,qf,Rs,xf,qa,Cf,jf,Lf,Us,Af,Bs,Of,If,Sf,an,Df,Xe,Vs,Wf,to,Qf,xa,Hf,Rf,ti,Uf,Bf,Vf,rn,Kf,ln,Xf,dn,rl;return d=new Ae({}),G=new Ae({}),un=new Ae({}),gn=new J({props:{name:"class transformers.MPNetConfig",anchor:"transformers.MPNetConfig",parameters:[{name:"vocab_size",val:" = 30527"},{name:"hidden_size",val:" = 768"},{name:"num_hidden_layers",val:" = 12"},{name:"num_attention_heads",val:" = 12"},{name:"intermediate_size",val:" = 3072"},{name:"hidden_act",val:" = 'gelu'"},{name:"hidden_dropout_prob",val:" = 0.1"},{name:"attention_probs_dropout_prob",val:" = 0.1"},{name:"max_position_embeddings",val:" = 512"},{name:"initializer_range",val:" = 0.02"},{name:"layer_norm_eps",val:" = 1e-12"},{name:"relative_attention_num_buckets",val:" = 32"},{name:"pad_token_id",val:" = 1"},{name:"bos_token_id",val:" = 0"},{name:"eos_token_id",val:" = 2"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.MPNetConfig.vocab_size",description:`<strong>vocab_size</strong> (<code>int</code>, <em>optional</em>, defaults to 30527) &#x2014;
...
`}}),Fo=new Fe({props:{$$slots:{default:[u_]},$$scope:{ctx:y}}}),Eo=new be({props:{anchor:"transformers.MPNetForTokenClassification.forward.example",$$slots:{default:[g_]},$$scope:{ctx:y}}}),zo=new be({props:{anchor:"transformers.MPNetForTokenClassification.forward.example-2",$$slots:{default:[__]},$$scope:{ctx:y}}}),as=new Ae({}),rs=new J({props:{name:"class transformers.MPNetForQuestionAnswering",anchor:"transformers.MPNetForQuestionAnswering",parameters:[{name:"config",val:""}],parametersDescription:[{anchor:"transformers.MPNetForQuestionAnswering.config",description:`<strong>config</strong> (<a href="/docs/transformers/main/en/model_doc/mpnet#transformers.MPNetConfig">MPNetConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
...
documentation from `),sa=n("a"),pd=r("PretrainedConfig"),md=r(" for more information."),hd=m(),T(so.$$.fragment),xi=m(),yt=n("h2"),ao=n("a"),Ja=n("span"),T(kn.$$.fragment),fd=m(),Ga=n("span"),ud=r("MPNetTokenizer"),Ci=m(),Ee=n("div"),T(bn.$$.fragment),gd=m(),vn=n("p"),_d=r("This tokenizer inherits from "),aa=n("a"),kd=r("BertTokenizer"),bd=r(` which contains most of the methods. Users should refer to the
...
make use of token type ids, therefore a list of zeros is returned`),Ai=m(),Et=n("h2"),po=n("a"),ir=n("span"),T(xn.$$.fragment),Gd=m(),lr=n("span"),Yd=r("MPNetModel"),Oi=m(),Oe=n("div"),T(Cn.$$.fragment),Zd=m(),dr=n("p"),ec=r("The bare MPNet Model transformer outputting raw hidden-states without any specific head on top."),tc=m(),jn=n("p"),oc=r("This model inherits from "),ca=n("a"),nc=r("PreTrainedModel"),sc=r(`. Check the superclass documentation for the generic methods the
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Cp=m(),Re=n("div"),T(ss.$$.fragment),jp=m(),St=n("p"),Lp=r("The "),ka=n("a"),Ap=r("MPNetForTokenClassification"),Op=r(" forward method, overrides the "),Pr=n("code"),Ip=r("__call__"),Sp=r(" special method."),Dp=m(),T(Fo.$$.fragment),Wp=m(),T(Eo.$$.fragment),Qp=m(),T(zo.$$.fragment),Bi=m(),Dt=n("h2"),qo=n("a"),Nr=n("span"),T(as.$$.fragment),Hp=m(),yr=n("span"),Rp=r("MPNetForQuestionAnswering"),Vi=m(),We=n("div"),T(rs.$$.fragment),Up=m(),Wt=n("p"),Bp=r(`MPNet Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
layers on top of the hidden-states output to compute `),Fr=n("code"),Vp=r("span start logits"),Kp=r(" and "),Er=n("code"),Xp=r("span end logits"),Jp=r(")."),Gp=m(),is=n("p"),Yp=r("This model inherits from "),ba=n("a"),Zp=r("PreTrainedModel"),em=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),tm=m(),ls=n("p"),om=r("This model is also a PyTorch "),ds=n("a"),nm=r("torch.nn.Module"),sm=r(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),am=m(),Ue=n("div"),T(cs.$$.fragment),rm=m(),Qt=n("p"),im=r("The "),va=n("a"),lm=r("MPNetForQuestionAnswering"),dm=r(" forward method, overrides the "),zr=n("code"),cm=r("__call__"),pm=r(" special method."),mm=m(),T(xo.$$.fragment),hm=m(),T(Co.$$.fragment),fm=m(),T(jo.$$.fragment),Ki=m(),Ht=n("h2"),Lo=n("a"),qr=n("span"),T(ps.$$.fragment),um=m(),xr=n("span"),gm=r("TFMPNetModel"),Xi=m(),ze=n("div"),T(ms.$$.fragment),_m=m(),Cr=n("p"),km=r("The bare MPNet Model transformer outputting raw hidden-states without any specific head on top."),bm=m(),hs=n("p"),vm=r("This model inherits from "),Ta=n("a"),Tm=r("TFPreTrainedModel"),Mm=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),vh=m(),T(Uo.$$.fragment),Th=m(),Ve=n("div"),T(Es.$$.fragment),Mh=m(),Kt=n("p"),$h=r("The "),Na=n("a"),wh=r("TFMPNetForSequenceClassification"),Ph=r(" forward method, overrides the "),Qr=n("code"),Nh=r("__call__"),yh=r(" special method."),Fh=m(),T(Bo.$$.fragment),Eh=m(),T(Vo.$$.fragment),zh=m(),T(Ko.$$.fragment),el=m(),Xt=n("h2"),Xo=n("a"),Hr=n("span"),T(zs.$$.fragment),qh=m(),Rr=n("span"),xh=r("TFMPNetForMultipleChoice"),tl=m(),Ce=n("div"),T(qs.$$.fragment),Ch=m(),Ur=n("p"),jh=r(`MPNet Model with a multiple choice classification head on top (a linear layer on top of the pooled output and a
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),mf=m(),T(en.$$.fragment),hf=m(),Ke=n("div"),T(Ws.$$.fragment),ff=m(),Yt=n("p"),uf=r("The "),za=n("a"),gf=r("TFMPNetForTokenClassification"),_f=r(" forward method, overrides the "),Jr=n("code"),kf=r("__call__"),bf=r(" special method."),vf=m(),T(tn.$$.fragment),Tf=m(),T(on.$$.fragment),Mf=m(),T(nn.$$.fragment),sl=m(),Zt=n("h2"),sn=n("a"),Gr=n("span"),T(Qs.$$.fragment),$f=m(),Yr=n("span"),wf=r("TFMPNetForQuestionAnswering"),al=m(),Le=n("div"),T(Hs.$$.fragment),Pf=m(),eo=n("p"),Nf=r(`MPNet Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
...
documentation from `),sa=s(oo,"A",{href:!0});var Ni=a(sa);pd=i(Ni,"PretrainedConfig"),Ni.forEach(t),md=i(oo," for more information."),oo.forEach(t),hd=h(pt),M(so.$$.fragment,pt),pt.forEach(t),xi=h(o),yt=s(o,"H2",{class:!0});var Zs=a(yt);ao=s(Zs,"A",{id:!0,class:!0,href:!0});var yi=a(ao);Ja=s(yi,"SPAN",{});var Fi=a(Ja);M(kn.$$.fragment,Fi),Fi.forEach(t),yi.forEach(t),fd=h(Zs),Ga=s(Zs,"SPAN",{});var Ei=a(Ga);ud=i(Ei,"MPNetTokenizer"),Ei.forEach(t),Zs.forEach(t),Ci=h(o),Ee=s(o,"DIV",{class:!0});var Qe=a(Ee);M(bn.$$.fragment,Qe),gd=h(Qe),vn=s(Qe,"P",{});var ea=a(vn);_d=i(ea,"This tokenizer inherits from "),aa=s(ea,"A",{href:!0});var zi=a(aa);kd=i(zi,"BertTokenizer"),zi.forEach(t),bd=i(ea,` which contains most of the methods. Users should refer to the
...
adding special tokens. A MPNet sequence has the following format:`),Yf.forEach(t),$d=h(Ca),Mn=s(Ca,"UL",{});var il=a(Mn);ra=s(il,"LI",{});var Jf=a(ra);wd=i(Jf,"single sequence: "),Za=s(Jf,"CODE",{});var Zf=a(Za);Pd=i(Zf,"<s> X </s>"),Zf.forEach(t),Jf.forEach(t),Nd=h(il),ia=s(il,"LI",{});var Gf=a(ia);yd=i(Gf,"pair of sequences: "),er=s(Gf,"CODE",{});var eu=a(er);Fd=i(eu,"<s> A </s></s> B </s>"),eu.forEach(t),Gf.forEach(t),il.forEach(t),Ca.forEach(t),Ed=h(Qe),ro=s(Qe,"DIV",{class:!0});var ll=a(ro);M($n.$$.fragment,ll),zd=h(ll),wn=s(ll,"P",{});var dl=a(wn);qd=i(dl,`Retrieves sequence ids from a token list that has no special tokens added. This method is called when adding
...
make use of token type ids, therefore a list of zeros is returned`),du.forEach(t),fl.forEach(t),cn.forEach(t),Ai=h(o),Et=s(o,"H2",{class:!0});var ul=a(Et);po=s(ul,"A",{id:!0,class:!0,href:!0});var cu=a(po);ir=s(cu,"SPAN",{});var pu=a(ir);M(xn.$$.fragment,pu),pu.forEach(t),cu.forEach(t),Gd=h(ul),lr=s(ul,"SPAN",{});var mu=a(lr);Yd=i(mu,"MPNetModel"),mu.forEach(t),ul.forEach(t),Oi=h(o),Oe=s(o,"DIV",{class:!0});var ft=a(Oe);M(Cn.$$.fragment,ft),Zd=h(ft),dr=s(ft,"P",{});var hu=a(dr);ec=i(hu,"The bare MPNet Model transformer outputting raw hidden-states without any specific head on top."),hu.forEach(t),tc=h(ft),jn=s(ft,"P",{});var gl=a(jn);oc=i(gl,"This model inherits from "),ca=s(gl,"A",{href:!0});var fu=a(ca);nc=i(fu,"PreTrainedModel"),fu.forEach(t),sc=i(gl,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Wl.forEach(t),vh=h(at),M(Uo.$$.fragment,at),Th=h(at),Ve=s(at,"DIV",{class:!0});var $t=a(Ve);M(Es.$$.fragment,$t),Mh=h($t),Kt=s($t,"P",{});var Ha=a(Kt);$h=i(Ha,"The "),Na=s(Ha,"A",{href:!0});var wg=a(Na);wh=i(wg,"TFMPNetForSequenceClassification"),wg.forEach(t),Ph=i(Ha," forward method, overrides the "),Qr=s(Ha,"CODE",{});var Pg=a(Qr);Nh=i(Pg,"__call__"),Pg.forEach(t),yh=i(Ha," special method."),Ha.forEach(t),Fh=h($t),M(Bo.$$.fragment,$t),Eh=h($t),M(Vo.$$.fragment,$t),zh=h($t),M(Ko.$$.fragment,$t),$t.forEach(t),at.forEach(t),el=h(o),Xt=s(o,"H2",{class:!0});var Ql=a(Xt);Xo=s(Ql,"A",{id:!0,class:!0,href:!0});var Ng=a(Xo);Hr=s(Ng,"SPAN",{});var yg=a(Hr);M(zs.$$.fragment,yg),yg.forEach(t),Ng.forEach(t),qh=h(Ql),Rr=s(Ql,"SPAN",{});var Fg=a(Rr);xh=i(Fg,"TFMPNetForMultipleChoice"),Fg.forEach(t),Ql.forEach(t),tl=h(o),Ce=s(o,"DIV",{class:!0});var rt=a(Ce);M(qs.$$.fragment,rt),Ch=h(rt),Ur=s(rt,"P",{});var Eg=a(Ur);jh=i(Eg,`MPNet Model with a multiple choice classification head on top (a linear layer on top of the pooled output and a
...
Named-Entity-Recognition (NER) tasks.`),Og.forEach(t),nf=h(it),Is=s(it,"P",{});var Bl=a(Is);sf=i(Bl,"This model inherits from "),Ea=s(Bl,"A",{href:!0});var Ig=a(Ea);af=i(Ig,"TFPreTrainedModel"),Ig.forEach(t),rf=i(Bl,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
