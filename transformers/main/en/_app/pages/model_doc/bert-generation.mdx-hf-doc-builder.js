...
<span class="hljs-meta">&gt;&gt;&gt; </span>prediction_logits = outputs.logits`}}),{c(){m=a("p"),v=n("Example:"),_=h(),k(f.$$.fragment)},l(d){m=s(d,"P",{});var g=i(m);v=r(g,"Example:"),g.forEach(o),_=p(d),y(f.$$.fragment,d)},m(d,g){u(d,m,g),e(m,v),u(d,_,g),T(f,d,g),b=!0},p:Zr,i(d){b||(w(f.$$.fragment,d),b=!0)},o(d){$(f.$$.fragment,d),b=!1},d(d){d&&o(m),d&&o(_),E(f,d)}}}function fs(j){let m,v,_,f,b,d,g,A,Do,Xt,F,X,wt,pe,So,$t,Ao,Yt,M,Mo,Ke,Oo,Lo,me,No,Fo,Zt,Qe,Io,eo,Xe,Et,Ro,to,Ye,Wo,oo,Ze,ue,Uo,et,Ho,Vo,no,fe,ro,tt,ge,Jo,ot,Ko,Qo,ao,_e,so,nt,Xo,io,Y,O,rt,Yo,Zo,at,en,tn,Bt,on,nn,rn,zt,an,lo,L,sn,be,dn,ln,ve,cn,hn,co,I,Z,Gt,ke,pn,qt,mn,ho,P,ye,un,R,fn,xt,gn,_n,Te,bn,vn,kn,W,yn,st,Tn,wn,it,$n,En,Bn,ee,po,U,te,Pt,we,zn,Ct,Gn,mo,C,$e,qn,Ee,xn,Be,Pn,Cn,jn,ze,Dn,dt,Sn,An,Mn,lt,Ge,uo,H,oe,jt,qe,On,Dt,Ln,fo,B,xe,Nn,St,Fn,In,Pe,Rn,ct,Wn,Un,Hn,Ce,Vn,je,Jn,Kn,Qn,De,Xn,Se,Yn,Zn,er,V,tr,ht,or,nr,Ae,rr,ar,sr,z,ir,At,dr,lr,Mt,cr,hr,Ot,pr,mr,Lt,ur,fr,Nt,gr,_r,Ft,br,vr,kr,D,Me,yr,J,Tr,pt,wr,$r,It,Er,Br,zr,ne,Gr,re,go,K,ae,Rt,Oe,qr,Wt,xr,_o,q,Le,Pr,Ne,Cr,Ut,jr,Dr,Sr,Fe,Ar,mt,Mr,Or,Lr,Ie,Nr,Re,Fr,Ir,Rr,S,We,Wr,Q,Ur,ut,Hr,Vr,Ht,Jr,Kr,Qr,se,Xr,ie,bo;return d=new Tt({}),pe=new Tt({}),fe=new Qt({props:{code:`# leverage checkpoints for Bert2Bert model...
...
documentation from `),it=a("a"),$n=n("PretrainedConfig"),En=n(" for more information."),Bn=h(),k(ee.$$.fragment),po=h(),U=a("h2"),te=a("a"),Pt=a("span"),k(we.$$.fragment),zn=h(),Ct=a("span"),Gn=n("BertGenerationTokenizer"),mo=h(),C=a("div"),k($e.$$.fragment),qn=h(),Ee=a("p"),xn=n("Construct a BertGeneration tokenizer. Based on "),Be=a("a"),Pn=n("SentencePiece"),Cn=n("."),jn=h(),ze=a("p"),Dn=n("This tokenizer inherits from "),dt=a("a"),Sn=n("PreTrainedTokenizer"),An=n(` which contains most of the main methods. Users should refer to
this superclass for more information regarding those methods.`),Mn=h(),lt=a("div"),k(Ge.$$.fragment),uo=h(),H=a("h2"),oe=a("a"),jt=a("span"),k(qe.$$.fragment),On=h(),Dt=a("span"),Ln=n("BertGenerationEncoder"),fo=h(),B=a("div"),k(xe.$$.fragment),Nn=h(),St=a("p"),Fn=n("The bare BertGeneration model transformer outputting raw hidden-states without any specific head on top."),In=h(),Pe=a("p"),Rn=n("This model inherits from "),ct=a("a"),Wn=n("PreTrainedModel"),Un=n(`. Check the superclass documentation for the generic methods the
...
`),Lt=a("code"),ur=n("add_cross_attention"),fr=n(" set to "),Nt=a("code"),gr=n("True"),_r=n("; an "),Ft=a("code"),br=n("encoder_hidden_states"),vr=n(" is then expected as an input to the forward pass."),kr=h(),D=a("div"),k(Me.$$.fragment),yr=h(),J=a("p"),Tr=n("The "),pt=a("a"),wr=n("BertGenerationEncoder"),$r=n(" forward method, overrides the "),It=a("code"),Er=n("__call__"),Br=n(" special method."),zr=h(),k(ne.$$.fragment),Gr=h(),k(re.$$.fragment),go=h(),K=a("h2"),ae=a("a"),Rt=a("span"),k(Oe.$$.fragment),qr=h(),Wt=a("span"),xr=n("BertGenerationDecoder"),_o=h(),q=a("div"),k(Le.$$.fragment),Pr=h(),Ne=a("p"),Cr=n("BertGeneration Model with a "),Ut=a("code"),jr=n("language modeling"),Dr=n(" head on top for CLM fine-tuning."),Sr=h(),Fe=a("p"),Ar=n("This model inherits from "),mt=a("a"),Mr=n("PreTrainedModel"),Or=n(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
