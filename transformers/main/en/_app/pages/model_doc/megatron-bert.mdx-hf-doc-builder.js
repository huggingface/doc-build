import{S as cm,i as pm,s as hm,e as a,k as m,w as v,t as r,M as mm,c as i,d as o,m as g,a as l,x as M,h as s,b as f,G as e,g as b,y as w,q as T,o as $,B as y,v as gm,L as j}from"../../chunks/vendor-hf-doc-builder.js";import{T as We}from"../../chunks/Tip-hf-doc-builder.js";import{D as q}from"../../chunks/Docstring-hf-doc-builder.js";import{C as z}from"../../chunks/CodeBlock-hf-doc-builder.js";import{I as te}from"../../chunks/IconCopyLink-hf-doc-builder.js";import{E}from"../../chunks/ExampleCodeBlock-hf-doc-builder.js";function um(B){let d,_,c,h,k;return h=new z({props:{code:`from transformers import MegatronBertModel, MegatronBertConfig
...
`}}),{c(){v(d.$$.fragment)},l(c){M(d.$$.fragment,c)},m(c,h){w(d,c,h),_=!0},p:j,i(c){_||(T(d.$$.fragment,c),_=!0)},o(c){$(d.$$.fragment,c),_=!1},d(c){y(d,c)}}}function qm(B){let d,_,c,h,k;return h=new z({props:{code:`import torch
from transformers import BertTokenizer, MegatronBertForSequenceClassification
...
<span class="hljs-meta">&gt;&gt;&gt; </span>loss = outputs.loss
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-built_in">round</span>(loss.item(), <span class="hljs-number">2</span>)
`}}),{c(){v(d.$$.fragment)},l(c){M(d.$$.fragment,c)},m(c,h){w(d,c,h),_=!0},p:j,i(c){_||(T(d.$$.fragment,c),_=!0)},o(c){$(d.$$.fragment,c),_=!1},d(c){y(d,c)}}}function Im(B){let d,_,c,h,k,n,p,F,$a,ls,fe,Re,Gn,Et,ya,Qn,Ba,ds,He,Fa,jt,za,xa,cs,nn,qa,ps,rn,Vn,Pa,hs,sn,Ca,ms,Ue,Ea,Ot,ja,Oa,gs,oe,Aa,At,La,Sa,Lt,Na,Ia,us,an,Da,fs,ln,Wa,_s,St,bs,dn,Ra,ks,Nt,vs,cn,Ha,Ms,ne,Ua,Jn,Ga,Qa,Kn,Va,Ja,ws,It,Ts,Dt,$s,re,Ka,Wt,Ya,Xa,Rt,Za,ei,ys,_e,Ge,Yn,Ht,ti,Xn,oi,Bs,J,Ut,ni,be,ri,pn,si,ai,Gt,ii,li,di,ke,ci,hn,pi,hi,mn,mi,gi,ui,Qe,Fs,ve,Ve,Zn,Qt,fi,er,_i,zs,x,Vt,bi,tr,ki,vi,Jt,Mi,gn,wi,Ti,$i,Kt,yi,Yt,Bi,Fi,zi,Xt,xi,Zt,qi,Pi,Ci,C,Ei,or,ji,Oi,nr,Ai,Li,rr,Si,Ni,sr,Ii,Di,ar,Wi,Ri,ir,Hi,Ui,Gi,K,eo,Qi,Me,Vi,un,Ji,Ki,lr,Yi,Xi,Zi,Je,el,Ke,xs,we,Ye,dr,to,tl,cr,ol,qs,O,oo,nl,no,rl,pr,sl,al,il,ro,ll,fn,dl,cl,pl,so,hl,ao,ml,gl,ul,R,io,fl,Te,_l,_n,bl,kl,hr,vl,Ml,wl,Xe,Tl,Ze,$l,et,Ps,$e,tt,mr,lo,yl,gr,Bl,Cs,A,co,Fl,po,zl,ur,xl,ql,Pl,ho,Cl,bn,El,jl,Ol,mo,Al,go,Ll,Sl,Nl,Y,uo,Il,ye,Dl,kn,Wl,Rl,fr,Hl,Ul,Gl,ot,Ql,nt,Es,Be,rt,_r,fo,Vl,br,Jl,js,L,_o,Kl,bo,Yl,kr,Xl,Zl,ed,ko,td,vn,od,nd,rd,vo,sd,Mo,ad,id,ld,X,wo,dd,Fe,cd,Mn,pd,hd,vr,md,gd,ud,st,fd,at,Os,ze,it,Mr,To,_d,wr,bd,As,S,$o,kd,xe,vd,Tr,Md,wd,$r,Td,$d,yd,yo,Bd,wn,Fd,zd,xd,Bo,qd,Fo,Pd,Cd,Ed,Z,zo,jd,qe,Od,Tn,Ad,Ld,yr,Sd,Nd,Id,lt,Dd,dt,Ls,Pe,ct,Br,xo,Wd,Fr,Rd,Ss,N,qo,Hd,zr,Ud,Gd,Po,Qd,$n,Vd,Jd,Kd,Co,Yd,Eo,Xd,Zd,ec,P,jo,tc,Ce,oc,yn,nc,rc,xr,sc,ac,ic,pt,lc,ht,dc,mt,cc,gt,pc,ut,Ns,Ee,ft,qr,Oo,hc,Pr,mc,Is,I,Ao,gc,Cr,uc,fc,Lo,_c,Bn,bc,kc,vc,So,Mc,No,wc,Tc,$c,ee,Io,yc,je,Bc,Fn,Fc,zc,Er,xc,qc,Pc,_t,Cc,bt,Ds,Oe,kt,jr,Do,Ec,Or,jc,Ws,D,Wo,Oc,Ar,Ac,Lc,Ro,Sc,zn,Nc,Ic,Dc,Ho,Wc,Uo,Rc,Hc,Uc,H,Go,Gc,Ae,Qc,xn,Vc,Jc,Lr,Kc,Yc,Xc,vt,Zc,Mt,ep,wt,Rs,Le,Tt,Sr,Qo,tp,Nr,op,Hs,W,Vo,np,Se,rp,Ir,sp,ap,Dr,ip,lp,dp,Jo,cp,qn,pp,hp,mp,Ko,gp,Yo,up,fp,_p,U,Xo,bp,Ne,kp,Pn,vp,Mp,Wr,wp,Tp,$p,$t,yp,yt,Bp,Bt,Us;return n=new te({}),Et=new te({}),St=new z({props:{code:`wget --content-disposition https://api.ngc.nvidia.com/v2/models/nvidia/megatron_bert_345m/versions/v0.1_uncased/zip
...
`),sr=a("code"),Ii=r("add_cross_attention"),Di=r(" set to "),ar=a("code"),Wi=r("True"),Ri=r("; an "),ir=a("code"),Hi=r("encoder_hidden_states"),Ui=r(" is then expected as an input to the forward pass."),Gi=m(),K=a("div"),v(eo.$$.fragment),Qi=m(),Me=a("p"),Vi=r("The "),un=a("a"),Ji=r("MegatronBertModel"),Ki=r(" forward method, overrides the "),lr=a("code"),Yi=r("__call__"),Xi=r(" special method."),Zi=m(),v(Je.$$.fragment),el=m(),v(Ke.$$.fragment),xs=m(),we=a("h2"),Ye=a("a"),dr=a("span"),v(to.$$.fragment),tl=m(),cr=a("span"),ol=r("MegatronBertForMaskedLM"),qs=m(),O=a("div"),v(oo.$$.fragment),nl=m(),no=a("p"),rl=r("MegatronBert Model with a "),pr=a("code"),sl=r("language modeling"),al=r(" head on top."),il=m(),ro=a("p"),ll=r("This model inherits from "),fn=a("a"),dl=r("PreTrainedModel"),cl=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),pl=m(),so=a("p"),hl=r("This model is also a PyTorch "),ao=a("a"),ml=r("torch.nn.Module"),gl=r(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),ul=m(),R=a("div"),v(io.$$.fragment),fl=m(),Te=a("p"),_l=r("The "),_n=a("a"),bl=r("MegatronBertForMaskedLM"),kl=r(" forward method, overrides the "),hr=a("code"),vl=r("__call__"),Ml=r(" special method."),wl=m(),v(Xe.$$.fragment),Tl=m(),v(Ze.$$.fragment),$l=m(),v(et.$$.fragment),Ps=m(),$e=a("h2"),tt=a("a"),mr=a("span"),v(lo.$$.fragment),yl=m(),gr=a("span"),Bl=r("MegatronBertForCausalLM"),Cs=m(),A=a("div"),v(co.$$.fragment),Fl=m(),po=a("p"),zl=r("MegatronBert Model with a "),ur=a("code"),xl=r("language modeling"),ql=r(" head on top for CLM fine-tuning."),Pl=m(),ho=a("p"),Cl=r("This model inherits from "),bn=a("a"),El=r("PreTrainedModel"),jl=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Ed=m(),Z=a("div"),v(zo.$$.fragment),jd=m(),qe=a("p"),Od=r("The "),Tn=a("a"),Ad=r("MegatronBertForPreTraining"),Ld=r(" forward method, overrides the "),yr=a("code"),Sd=r("__call__"),Nd=r(" special method."),Id=m(),v(lt.$$.fragment),Dd=m(),v(dt.$$.fragment),Ls=m(),Pe=a("h2"),ct=a("a"),Br=a("span"),v(xo.$$.fragment),Wd=m(),Fr=a("span"),Rd=r("MegatronBertForSequenceClassification"),Ss=m(),N=a("div"),v(qo.$$.fragment),Hd=m(),zr=a("p"),Ud=r(`MegatronBert Model transformer with a sequence classification/regression head on top (a linear layer on top of the
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),ec=m(),P=a("div"),v(jo.$$.fragment),tc=m(),Ce=a("p"),oc=r("The "),yn=a("a"),nc=r("MegatronBertForSequenceClassification"),rc=r(" forward method, overrides the "),xr=a("code"),sc=r("__call__"),ac=r(" special method."),ic=m(),v(pt.$$.fragment),lc=m(),v(ht.$$.fragment),dc=m(),v(mt.$$.fragment),cc=m(),v(gt.$$.fragment),pc=m(),v(ut.$$.fragment),Ns=m(),Ee=a("h2"),ft=a("a"),qr=a("span"),v(Oo.$$.fragment),hc=m(),Pr=a("span"),mc=r("MegatronBertForMultipleChoice"),Is=m(),I=a("div"),v(Ao.$$.fragment),gc=m(),Cr=a("p"),uc=r(`MegatronBert Model with a multiple choice classification head on top (a linear layer on top of the pooled output
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Uc=m(),H=a("div"),v(Go.$$.fragment),Gc=m(),Ae=a("p"),Qc=r("The "),xn=a("a"),Vc=r("MegatronBertForTokenClassification"),Jc=r(" forward method, overrides the "),Lr=a("code"),Kc=r("__call__"),Yc=r(" special method."),Xc=m(),v(vt.$$.fragment),Zc=m(),v(Mt.$$.fragment),ep=m(),v(wt.$$.fragment),Rs=m(),Le=a("h2"),Tt=a("a"),Sr=a("span"),v(Qo.$$.fragment),tp=m(),Nr=a("span"),op=r("MegatronBertForQuestionAnswering"),Hs=m(),W=a("div"),v(Vo.$$.fragment),np=m(),Se=a("p"),rp=r(`MegatronBert Model with a span classification head on top for extractive question-answering tasks like SQuAD (a
