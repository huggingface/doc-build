import{S as Xn,i as Zn,s as Qn,e as a,k as f,w as v,t as n,M as Yn,c as s,d as o,m as u,a as r,x as w,h as i,b as c,F as e,g as _,y as $,q as y,o as D,B as k,v as ei,L as Co}from"../../chunks/vendor-6b77c823.js";import{T as St}from"../../chunks/Tip-39098574.js";import{D as H}from"../../chunks/Docstring-1088f2fb.js";import{C as jo}from"../../chunks/CodeBlock-3a8b25a8.js";import{I as ze}from"../../chunks/IconCopyLink-7a11ce68.js";import{E as Mo}from"../../chunks/ExampleCodeBlock-5212b321.js";function ti(x){let d,b,p,h,T;return{c(){d=a("p"),b=n(`This is a recently introduced model so the API hasn\u2019t been tested extensively. There may be some bugs or slight
...
tabby, tabby cat`}}),{c(){d=a("p"),b=n("Example:"),p=f(),v(h.$$.fragment)},l(l){d=s(l,"P",{});var m=r(d);b=i(m,"Example:"),m.forEach(o),p=u(l),w(h.$$.fragment,l)},m(l,m){_(l,d,m),e(d,b),_(l,p,m),$(h,l,m),T=!0},p:Co,i(l){T||(y(h.$$.fragment,l),T=!0)},o(l){D(h.$$.fragment,l),T=!1},d(l){l&&o(d),l&&o(p),k(h,l)}}}function mi(x){let d,b,p,h,T,l,m,I,ha,Po,le,zo,J,de,Vt,qe,ma,Bt,pa,qo,q,fa,Ae,ua,ga,pt,_a,Ta,Ne,ba,va,Ao,ft,wa,No,ut,Ht,$a,Lo,gt,ya,Oo,C,Rt,Da,ka,G,xa,_t,Ia,Ea,Tt,Fa,Ma,Ca,Ut,ja,Pa,Jt,za,qa,E,Aa,bt,Na,La,vt,Oa,Wa,Gt,Sa,Va,Kt,Ba,Ha,Xt,Ra,Ua,Zt,Ja,Ga,wt,Ka,Xa,Wo,ce,Za,Le,Qa,Ya,So,K,he,Qt,Oe,es,Yt,ts,Vo,j,We,os,X,as,$t,ss,rs,Se,ns,is,ls,Z,ds,yt,cs,hs,Dt,ms,ps,fs,me,Bo,Q,pe,eo,Ve,us,to,gs,Ho,P,Be,_s,oo,Ts,bs,He,vs,kt,ws,$s,ys,R,Re,Ds,ao,ks,xs,fe,Ro,Y,ue,so,Ue,Is,ro,Es,Uo,S,Je,Fs,Ge,Ms,Ke,Cs,js,Ps,A,Xe,zs,ee,qs,xt,As,Ns,no,Ls,Os,Ws,ge,Ss,_e,Jo,te,Te,io,Ze,Vs,lo,Bs,Go,V,Qe,Hs,oe,Rs,co,Us,Js,Ye,Gs,Ks,Xs,N,et,Zs,ae,Qs,It,Ys,er,ho,tr,or,ar,be,sr,ve,Ko,se,we,mo,tt,rr,po,nr,Xo,z,ot,ir,fo,lr,dr,at,cr,st,hr,mr,pr,L,rt,fr,re,ur,Et,gr,_r,uo,Tr,br,vr,$e,wr,ye,Zo,ne,De,go,nt,$r,_o,yr,Qo,F,it,Dr,To,kr,xr,bo,Ir,Er,vo,Fr,Mr,lt,Cr,dt,jr,Pr,zr,O,ct,qr,ie,Ar,Ft,Nr,Lr,wo,Or,Wr,Sr,ke,Vr,xe,Yo;return l=new ze({}),le=new St({props:{$$slots:{default:[ti]},$$scope:{ctx:x}}}),qe=new ze({}),Oe=new ze({}),We=new H({props:{name:"class transformers.DeiTConfig",anchor:"transformers.DeiTConfig",parameters:[{name:"hidden_size",val:" = 768"},{name:"num_hidden_layers",val:" = 12"},{name:"num_attention_heads",val:" = 12"},{name:"intermediate_size",val:" = 3072"},{name:"hidden_act",val:" = 'gelu'"},{name:"hidden_dropout_prob",val:" = 0.0"},{name:"attention_probs_dropout_prob",val:" = 0.0"},{name:"initializer_range",val:" = 0.02"},{name:"layer_norm_eps",val:" = 1e-12"},{name:"is_encoder_decoder",val:" = False"},{name:"image_size",val:" = 224"},{name:"patch_size",val:" = 16"},{name:"num_channels",val:" = 3"},{name:"qkv_bias",val:" = True"},{name:"encoder_stride",val:" = 16"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.DeiTConfig.hidden_size",description:`<strong>hidden_size</strong> (<code>int</code>, <em>optional</em>, defaults to 768) &#x2014;
...
</ul>`,name:"return_tensors"}],source:"https://github.com/huggingface/transformers/blob/vmain/src/transformers/models/deit/feature_extraction_deit.py#L91",returnDescription:`
<p>A <a
...
Whether or not to return a <a href="/docs/transformers/main/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vmain/src/transformers/models/deit/modeling_deit.py#L497",returnDescription:`
<p>A <a
...
Boolean masked positions. Indicates which patches are masked (1) and which aren&#x2019;t (0).`,name:"bool_masked_pos"}],source:"https://github.com/huggingface/transformers/blob/vmain/src/transformers/models/deit/modeling_deit.py#L590",returnDescription:`
<p>A <a
...
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vmain/src/transformers/models/deit/modeling_deit.py#L697",returnDescription:`
...
Whether or not to return a <a href="/docs/transformers/main/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vmain/src/transformers/models/deit/modeling_deit.py#L851",returnDescription:`
...
prepare images for the model.`),Wo=f(),ce=a("p"),Za=n("This model was contributed by "),Le=a("a"),Qa=n("nielsr"),Ya=n("."),So=f(),K=a("h2"),he=a("a"),Qt=a("span"),v(Oe.$$.fragment),es=f(),Yt=a("span"),ts=n("DeiTConfig"),Vo=f(),j=a("div"),v(We.$$.fragment),os=f(),X=a("p"),as=n("This is the configuration class to store the configuration of a "),$t=a("a"),ss=n("DeiTModel"),rs=n(`. It is used to instantiate an DeiT
...
documentation from `),Dt=a("a"),ms=n("PretrainedConfig"),ps=n(" for more information."),fs=f(),v(me.$$.fragment),Bo=f(),Q=a("h2"),pe=a("a"),eo=a("span"),v(Ve.$$.fragment),us=f(),to=a("span"),gs=n("DeiTFeatureExtractor"),Ho=f(),P=a("div"),v(Be.$$.fragment),_s=f(),oo=a("p"),Ts=n("Constructs a DeiT feature extractor."),bs=f(),He=a("p"),vs=n("This feature extractor inherits from "),kt=a("a"),ws=n("FeatureExtractionMixin"),$s=n(` which contains most of the main methods. Users
should refer to this superclass for more information regarding those methods.`),ys=f(),R=a("div"),v(Re.$$.fragment),Ds=f(),ao=a("p"),ks=n("Main method to prepare for the model one or several image(s)."),xs=f(),v(fe.$$.fragment),Ro=f(),Y=a("h2"),ue=a("a"),so=a("span"),v(Ue.$$.fragment),Is=f(),ro=a("span"),Es=n("DeiTModel"),Uo=f(),S=a("div"),v(Je.$$.fragment),Fs=f(),Ge=a("p"),Ms=n(`The bare DeiT Model transformer outputting raw hidden-states without any specific head on top.
This model is a PyTorch `),Ke=a("a"),Cs=n("torch.nn.Module"),js=n(` subclass. Use it
as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),Ps=f(),A=a("div"),v(Xe.$$.fragment),zs=f(),ee=a("p"),qs=n("The "),xt=a("a"),As=n("DeiTModel"),Ns=n(" forward method, overrides the "),no=a("code"),Ls=n("__call__"),Os=n(" special method."),Ws=f(),v(ge.$$.fragment),Ss=f(),v(_e.$$.fragment),Jo=f(),te=a("h2"),Te=a("a"),io=a("span"),v(Ze.$$.fragment),Vs=f(),lo=a("span"),Bs=n("DeiTForMaskedImageModeling"),Go=f(),V=a("div"),v(Qe.$$.fragment),Hs=f(),oe=a("p"),Rs=n("DeiT Model with a decoder on top for masked image modeling, as proposed in "),co=a("code"),Us=n("SimMIM <https://arxiv.org/abs/2111.09886>"),Js=n(`__.
This model is a PyTorch `),Ye=a("a"),Gs=n("torch.nn.Module"),Ks=n(` subclass. Use it
as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),Xs=f(),N=a("div"),v(et.$$.fragment),Zs=f(),ae=a("p"),Qs=n("The "),It=a("a"),Ys=n("DeiTForMaskedImageModeling"),er=n(" forward method, overrides the "),ho=a("code"),tr=n("__call__"),or=n(" special method."),ar=f(),v(be.$$.fragment),sr=f(),v(ve.$$.fragment),Ko=f(),se=a("h2"),we=a("a"),mo=a("span"),v(tt.$$.fragment),rr=f(),po=a("span"),nr=n("DeiTForImageClassification"),Xo=f(),z=a("div"),v(ot.$$.fragment),ir=f(),fo=a("p"),lr=n(`DeiT Model transformer with an image classification head on top (a linear layer on top of the final hidden state of
the [CLS] token) e.g. for ImageNet.`),dr=f(),at=a("p"),cr=n("This model is a PyTorch "),st=a("a"),hr=n("torch.nn.Module"),mr=n(` subclass. Use it
as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),pr=f(),L=a("div"),v(rt.$$.fragment),fr=f(),re=a("p"),ur=n("The "),Et=a("a"),gr=n("DeiTForImageClassification"),_r=n(" forward method, overrides the "),uo=a("code"),Tr=n("__call__"),br=n(" special method."),vr=f(),v($e.$$.fragment),wr=f(),v(ye.$$.fragment),Zo=f(),ne=a("h2"),De=a("a"),go=a("span"),v(nt.$$.fragment),$r=f(),_o=a("span"),yr=n("DeiTForImageClassificationWithTeacher"),Qo=f(),F=a("div"),v(it.$$.fragment),Dr=f(),To=a("p"),kr=n(`DeiT Model transformer with image classification heads on top (a linear layer on top of the final hidden state of
...
as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),zr=f(),O=a("div"),v(ct.$$.fragment),qr=f(),ie=a("p"),Ar=n("The "),Ft=a("a"),Nr=n("DeiTForImageClassificationWithTeacher"),Lr=n(" forward method, overrides the "),wo=a("code"),Or=n("__call__"),Wr=n(" special method."),Sr=f(),v(ke.$$.fragment),Vr=f(),v(xe.$$.fragment),this.h()},l(t){const g=Yn('[data-svelte="svelte-1phssyn"]',document.head);d=s(g,"META",{name:!0,content:!0}),g.forEach(o),b=u(t),p=s(t,"H1",{class:!0});var ht=r(p);h=s(ht,"A",{id:!0,class:!0,href:!0});var $o=r(h);T=s($o,"SPAN",{});var yo=r(T);w(l.$$.fragment,yo),yo.forEach(o),$o.forEach(o),m=u(ht),I=s(ht,"SPAN",{});var Do=r(I);ha=i(Do,"DeiT"),Do.forEach(o),ht.forEach(o),Po=u(t),w(le.$$.fragment,t),zo=u(t),J=s(t,"H2",{class:!0});var mt=r(J);de=s(mt,"A",{id:!0,class:!0,href:!0});var ko=r(de);Vt=s(ko,"SPAN",{});var xo=r(Vt);w(qe.$$.fragment,xo),xo.forEach(o),ko.forEach(o),ma=u(mt),Bt=s(mt,"SPAN",{});var Io=r(Bt);pa=i(Io,"Overview"),Io.forEach(o),mt.forEach(o),qo=u(t),q=s(t,"P",{});var B=r(q);fa=i(B,"The DeiT model was proposed in "),Ae=s(B,"A",{href:!0,rel:!0});var Eo=r(Ae);ua=i(Eo,"Training data-efficient image transformers & distillation through attention"),Eo.forEach(o),ga=i(B,` by Hugo Touvron, Matthieu Cord, Matthijs Douze, Francisco Massa, Alexandre
Sablayrolles, Herv\xE9 J\xE9gou. The `),pt=s(B,"A",{href:!0});var Fo=r(pt);_a=i(Fo,"Vision Transformer (ViT)"),Fo.forEach(o),Ta=i(B," introduced in "),Ne=s(B,"A",{href:!0,rel:!0});var Br=r(Ne);ba=i(Br,"Dosovitskiy et al., 2020"),Br.forEach(o),va=i(B,` has shown that one can match or even outperform existing convolutional neural
networks using a Transformer encoder (BERT-like). However, the ViT models introduced in that paper required training on
expensive infrastructure for multiple weeks, using external data. DeiT (data-efficient image transformers) are more
efficiently trained transformers for image classification, requiring far less data and far less computing resources
...
`),bt=s(M,"A",{href:!0});var Yr=r(bt);Na=i(Yr,"ViTModel"),Yr.forEach(o),La=i(M," or "),vt=s(M,"A",{href:!0});var en=r(vt);Oa=i(en,"ViTForImageClassification"),en.forEach(o),Wa=i(M,`. Techniques like data
augmentation, optimization, and regularization were used in order to simulate training on a much larger dataset
(while only using ImageNet-1k for pre-training). There are 4 variants available (in 3 different sizes):
...
model according to the specified arguments, defining the model architecture. Instantiating a configuration with the
defaults will yield a similar configuration to that of the DeiT
`),Se=s(Ct,"A",{href:!0,rel:!0});var mn=r(Se);ns=i(mn,"facebook/deit-base-distilled-patch16-224"),mn.forEach(o),is=i(Ct,`
architecture.`),Ct.forEach(o),ls=u(Ie),Z=s(Ie,"P",{});var jt=r(Z);ds=i(jt,"Configuration objects inherit from "),yt=s(jt,"A",{href:!0});var pn=r(yt);cs=i(pn,"PretrainedConfig"),pn.forEach(o),hs=i(jt,` and can be used to control the model outputs. Read the
documentation from `),Dt=s(jt,"A",{href:!0});var fn=r(Dt);ms=i(fn,"PretrainedConfig"),fn.forEach(o),ps=i(jt," for more information."),jt.forEach(o),fs=u(Ie),w(me.$$.fragment,Ie),Ie.forEach(o),Bo=u(t),Q=s(t,"H2",{class:!0});var oa=r(Q);pe=s(oa,"A",{id:!0,class:!0,href:!0});var un=r(pe);eo=s(un,"SPAN",{});var gn=r(eo);w(Ve.$$.fragment,gn),gn.forEach(o),un.forEach(o),us=u(oa),to=s(oa,"SPAN",{});var _n=r(to);gs=i(_n,"DeiTFeatureExtractor"),_n.forEach(o),oa.forEach(o),Ho=u(t),P=s(t,"DIV",{class:!0});var Ee=r(P);w(Be.$$.fragment,Ee),_s=u(Ee),oo=s(Ee,"P",{});var Tn=r(oo);Ts=i(Tn,"Constructs a DeiT feature extractor."),Tn.forEach(o),bs=u(Ee),He=s(Ee,"P",{});var aa=r(He);vs=i(aa,"This feature extractor inherits from "),kt=s(aa,"A",{href:!0});var bn=r(kt);ws=i(bn,"FeatureExtractionMixin"),bn.forEach(o),$s=i(aa,` which contains most of the main methods. Users
should refer to this superclass for more information regarding those methods.`),aa.forEach(o),ys=u(Ee),R=s(Ee,"DIV",{class:!0});var Pt=r(R);w(Re.$$.fragment,Pt),Ds=u(Pt),ao=s(Pt,"P",{});var vn=r(ao);ks=i(vn,"Main method to prepare for the model one or several image(s)."),vn.forEach(o),xs=u(Pt),w(fe.$$.fragment,Pt),Pt.forEach(o),Ee.forEach(o),Ro=u(t),Y=s(t,"H2",{class:!0});var sa=r(Y);ue=s(sa,"A",{id:!0,class:!0,href:!0});var wn=r(ue);so=s(wn,"SPAN",{});var $n=r(so);w(Ue.$$.fragment,$n),$n.forEach(o),wn.forEach(o),Is=u(sa),ro=s(sa,"SPAN",{});var yn=r(ro);Es=i(yn,"DeiTModel"),yn.forEach(o),sa.forEach(o),Uo=u(t),S=s(t,"DIV",{class:!0});var zt=r(S);w(Je.$$.fragment,zt),Fs=u(zt),Ge=s(zt,"P",{});var ra=r(Ge);Ms=i(ra,`The bare DeiT Model transformer outputting raw hidden-states without any specific head on top.
...
as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),Nt.forEach(o),Xs=u(At),N=s(At,"DIV",{class:!0});var Me=r(N);w(et.$$.fragment,Me),Zs=u(Me),ae=s(Me,"P",{});var Lt=r(ae);Qs=i(Lt,"The "),It=s(Lt,"A",{href:!0});var jn=r(It);Ys=i(jn,"DeiTForMaskedImageModeling"),jn.forEach(o),er=i(Lt," forward method, overrides the "),ho=s(Lt,"CODE",{});var Pn=r(ho);tr=i(Pn,"__call__"),Pn.forEach(o),or=i(Lt," special method."),Lt.forEach(o),ar=u(Me),w(be.$$.fragment,Me),sr=u(Me),w(ve.$$.fragment,Me),Me.forEach(o),At.forEach(o),Ko=u(t),se=s(t,"H2",{class:!0});var ia=r(se);we=s(ia,"A",{id:!0,class:!0,href:!0});var zn=r(we);mo=s(zn,"SPAN",{});var qn=r(mo);w(tt.$$.fragment,qn),qn.forEach(o),zn.forEach(o),rr=u(ia),po=s(ia,"SPAN",{});var An=r(po);nr=i(An,"DeiTForImageClassification"),An.forEach(o),ia.forEach(o),Xo=u(t),z=s(t,"DIV",{class:!0});var Ce=r(z);w(ot.$$.fragment,Ce),ir=u(Ce),fo=s(Ce,"P",{});var Nn=r(fo);lr=i(Nn,`DeiT Model transformer with an image classification head on top (a linear layer on top of the final hidden state of
the [CLS] token) e.g. for ImageNet.`),Nn.forEach(o),dr=u(Ce),at=s(Ce,"P",{});var la=r(at);cr=i(la,"This model is a PyTorch "),st=s(la,"A",{href:!0,rel:!0});var Ln=r(st);hr=i(Ln,"torch.nn.Module"),Ln.forEach(o),mr=i(la,` subclass. Use it
as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),la.forEach(o),pr=u(Ce),L=s(Ce,"DIV",{class:!0});var je=r(L);w(rt.$$.fragment,je),fr=u(je),re=s(je,"P",{});var Ot=r(re);ur=i(Ot,"The "),Et=s(Ot,"A",{href:!0});var On=r(Et);gr=i(On,"DeiTForImageClassification"),On.forEach(o),_r=i(Ot," forward method, overrides the "),uo=s(Ot,"CODE",{});var Wn=r(uo);Tr=i(Wn,"__call__"),Wn.forEach(o),br=i(Ot," special method."),Ot.forEach(o),vr=u(je),w($e.$$.fragment,je),wr=u(je),w(ye.$$.fragment,je),je.forEach(o),Ce.forEach(o),Zo=u(t),ne=s(t,"H2",{class:!0});var da=r(ne);De=s(da,"A",{id:!0,class:!0,href:!0});var Sn=r(De);go=s(Sn,"SPAN",{});var Vn=r(go);w(nt.$$.fragment,Vn),Vn.forEach(o),Sn.forEach(o),$r=u(da),_o=s(da,"SPAN",{});var Bn=r(_o);yr=i(Bn,"DeiTForImageClassificationWithTeacher"),Bn.forEach(o),da.forEach(o),Qo=u(t),F=s(t,"DIV",{class:!0});var W=r(F);w(it.$$.fragment,W),Dr=u(W),To=s(W,"P",{});var Hn=r(To);kr=i(Hn,`DeiT Model transformer with image classification heads on top (a linear layer on top of the final hidden state of
