...
the latter silently ignores them.`)},l(T){u=a(T,"P",{});var y=s(u);L=i(y,"Although the recipe for forward pass needs to be defined within this function, one should call the "),v=a(y,"CODE",{});var C=s(v);w=i(C,"Module"),C.forEach(o),q=i(y,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),y.forEach(o)},m(T,y){h(T,u,y),e(u,L),e(u,v),e(v,w),e(u,q)},d(T){T&&o(u)}}}function Zd(Q){let u,L,v,w,q,T,y,C,Zn,on,D,so,ea,ta,je,oa,na,Ee,aa,sa,nn,Y,fe,ro,Fe,ra,io,ia,an,O,da,Me,la,ca,lo,pa,ha,sn,Et,ua,rn,Ft,co,ma,dn,G,fa,Se,ga,_a,Ae,ba,ka,ln,Z,ge,po,Ne,va,ho,Ta,cn,j,ya,uo,wa,Pa,mo,La,za,fo,qa,Ba,go,$a,xa,pn,_e,Ca,Ie,ja,Ea,hn,R,Fa,De,_o,Ma,Sa,Aa,Mt,Na,Ia,un,St,bo,Da,mn,Xe,fn,At,Oe,ko,Xa,Oa,ee,Ga,vo,Ra,Wa,To,Ha,Ua,gn,Ge,_n,te,be,yo,Re,Va,wo,Ja,bn,$,We,Ka,oe,Qa,Nt,Ya,Za,He,es,ts,os,ne,ns,It,as,ss,Dt,rs,is,ds,Po,ls,cs,Ue,kn,ae,ke,Lo,Ve,ps,zo,hs,vn,P,Je,us,qo,ms,fs,X,gs,Xt,_s,bs,Ot,ks,vs,Ke,Ts,ys,ws,Qe,Ps,Bo,Ls,zs,qs,$o,Bs,$s,Ye,xs,ve,Ze,Cs,xo,js,Es,N,et,Fs,tt,Ms,Co,Ss,As,Ns,ot,nt,jo,Is,Ds,Eo,Xs,Os,at,Fo,Gs,Rs,Mo,Ws,Hs,So,Us,Tn,se,Te,Ao,st,Vs,No,Js,yn,S,rt,Ks,it,Qs,Gt,Ys,Zs,er,dt,tr,lt,or,nr,ar,E,ct,sr,re,rr,Rt,ir,dr,Io,lr,cr,pr,ye,hr,Do,ur,mr,pt,wn,ie,we,Xo,ht,fr,Oo,gr,Pn,A,ut,_r,mt,br,Wt,kr,vr,Tr,ft,yr,gt,wr,Pr,Lr,F,_t,zr,de,qr,Ht,Br,$r,Go,xr,Cr,jr,Pe,Er,Ro,Fr,Mr,bt,Ln,le,Le,Wo,kt,Sr,Ho,Ar,zn,x,vt,Nr,Uo,Ir,Dr,Tt,Xr,Ut,Or,Gr,Rr,yt,Wr,wt,Hr,Ur,Vr,z,Pt,Jr,ce,Kr,Vt,Qr,Yr,Vo,Zr,ei,ti,ze,oi,Jo,ni,ai,Lt,si,Ko,ri,ii,zt,qn,pe,qe,Qo,qt,di,Yo,li,Bn,he,Bt,ci,W,$t,pi,Zo,hi,ui,xt,$n;return T=new me({}),Fe=new me({}),Ne=new me({}),Xe=new ue({props:{code:`from transformers import PLBartForConditionalGeneration, PLBartTokenizer
...
<span class="hljs-literal">True</span>`}}),{c(){u=n("meta"),L=l(),v=n("h1"),w=n("a"),q=n("span"),m(T.$$.fragment),y=l(),C=n("span"),Zn=r("PLBart"),on=l(),D=n("p"),so=n("strong"),ea=r("DISCLAIMER:"),ta=r(" If you see something strange, file a "),je=n("a"),oa=r("Github Issue"),na=r(` and assign
...
target text format is `),fo=n("code"),qa=r("[tgt_lang_code] X [eos]"),Ba=r(". "),go=n("code"),$a=r("bos"),xa=r(" is never used."),pn=l(),_e=n("p"),Ca=r("However, for fine-tuning, in some cases no language token is provided in cases where a single language is used. Please refer to "),Ie=n("a"),ja=r("the paper"),Ea=r(" to learn more about this."),hn=l(),R=n("p"),Fa=r("In cases where the language code is needed, The regular "),De=n("a"),_o=n("strong"),Ma=r("call"),Sa=r("()"),Aa=r(` will encode source text format, and it should be wrapped
inside the context manager `),Mt=n("a"),Na=r("as_target_tokenizer()"),Ia=r(" to encode target text format."),un=l(),St=n("ul"),bo=n("li"),Da=r("Supervised training"),mn=l(),m(Xe.$$.fragment),fn=l(),At=n("ul"),Oe=n("li"),ko=n("p"),Xa=r("Generation"),Oa=l(),ee=n("p"),Ga=r("While generating the target text set the "),vo=n("code"),Ra=r("decoder_start_token_id"),Wa=r(` to the target language id. The following
...
documentation from `),Dt=n("a"),rs=r("PretrainedConfig"),is=r(" for more information."),ds=l(),Po=n("p"),ls=r("Example:"),cs=l(),m(Ue.$$.fragment),kn=l(),ae=n("h2"),ke=n("a"),Lo=n("span"),m(Ve.$$.fragment),ps=l(),zo=n("span"),hs=r("PLBartTokenizer"),vn=l(),P=n("div"),m(Je.$$.fragment),us=l(),qo=n("p"),ms=r("Construct an PLBART tokenizer."),fs=l(),X=n("p"),gs=r("Adapted from "),Xt=n("a"),_s=r("RobertaTokenizer"),bs=r(" and "),Ot=n("a"),ks=r("XLNetTokenizer"),vs=r(`. Based on
...
sequence-to-sequence models that need a slightly different processing for the labels.`),Es=l(),N=n("div"),m(et.$$.fragment),Fs=l(),tt=n("p"),Ms=r(`Build model inputs from a sequence or a pair of sequence for sequence classification tasks by concatenating and
adding special tokens. An PLBART sequence has the following format, where `),Co=n("code"),Ss=r("X"),As=r(" represents the sequence:"),Ns=l(),ot=n("ul"),nt=n("li"),jo=n("code"),Is=r("input_ids"),Ds=r(" (for encoder) "),Eo=n("code"),Xs=r("X [eos, src_lang_code]"),Os=l(),at=n("li"),Fo=n("code"),Gs=r("decoder_input_ids"),Rs=r(": (for decoder) "),Mo=n("code"),Ws=r("X [eos, tgt_lang_code]"),Hs=l(),So=n("p"),Us=r(`BOS is never used. Pairs of sequences are not the expected use case, but they will be handled without a
...
on Java, Python and English.`),Jt.forEach(o),sn=c(t),Et=a(t,"P",{});var Li=s(Et);ua=i(Li,"According to the abstract"),Li.forEach(o),rn=c(t),Ft=a(t,"P",{});var zi=s(Ft);co=a(zi,"EM",{});var qi=s(co);ma=i(qi,`Code summarization and generation empower conversion between programming language (PL) and natural language (NL),
while code translation avails the migration of legacy code from one PL to another. This paper introduces PLBART,
a sequence-to-sequence model capable of performing a broad spectrum of program and language understanding and generation tasks.
PLBART is pre-trained on an extensive collection of Java and Python functions and associated NL text via denoising autoencoding.
Experiments on code summarization in the English language, code generation, and code translation in seven programming languages
...
target text format is `),fo=a(H,"CODE",{});var Mi=s(fo);qa=i(Mi,"[tgt_lang_code] X [eos]"),Mi.forEach(o),Ba=i(H,". "),go=a(H,"CODE",{});var Si=s(go);$a=i(Si,"bos"),Si.forEach(o),xa=i(H," is never used."),H.forEach(o),pn=c(t),_e=a(t,"P",{});var jn=s(_e);Ca=i(jn,"However, for fine-tuning, in some cases no language token is provided in cases where a single language is used. Please refer to "),Ie=a(jn,"A",{href:!0,rel:!0});var Ai=s(Ie);ja=i(Ai,"the paper"),Ai.forEach(o),Ea=i(jn," to learn more about this."),jn.forEach(o),hn=c(t),R=a(t,"P",{});var Qt=s(R);Fa=i(Qt,"In cases where the language code is needed, The regular "),De=a(Qt,"A",{href:!0});var mi=s(De);_o=a(mi,"STRONG",{});var Ni=s(_o);Ma=i(Ni,"call"),Ni.forEach(o),Sa=i(mi,"()"),mi.forEach(o),Aa=i(Qt,` will encode source text format, and it should be wrapped
inside the context manager `),Mt=a(Qt,"A",{href:!0});var Ii=s(Mt);Na=i(Ii,"as_target_tokenizer()"),Ii.forEach(o),Ia=i(Qt," to encode target text format."),Qt.forEach(o),un=c(t),St=a(t,"UL",{});var Di=s(St);bo=a(Di,"LI",{});var Xi=s(bo);Da=i(Xi,"Supervised training"),Xi.forEach(o),Di.forEach(o),mn=c(t),f(Xe.$$.fragment,t),fn=c(t),At=a(t,"UL",{});var Oi=s(At);Oe=a(Oi,"LI",{});var En=s(Oe);ko=a(En,"P",{});var Gi=s(ko);Xa=i(Gi,"Generation"),Gi.forEach(o),Oa=c(En),ee=a(En,"P",{});var Yt=s(ee);Ga=i(Yt,"While generating the target text set the "),vo=a(Yt,"CODE",{});var Ri=s(vo);Ra=i(Ri,"decoder_start_token_id"),Ri.forEach(o),Wa=i(Yt,` to the target language id. The following
...
sequence-to-sequence models that need a slightly different processing for the labels.`),ld.forEach(o),An.forEach(o),Es=c(B),N=a(B,"DIV",{class:!0});var $e=s(N);f(et.$$.fragment,$e),Fs=c($e),tt=a($e,"P",{});var Nn=s(tt);Ms=i(Nn,`Build model inputs from a sequence or a pair of sequence for sequence classification tasks by concatenating and
...
separator.`),fd.forEach(o),$e.forEach(o),B.forEach(o),Tn=c(t),se=a(t,"H2",{class:!0});var On=s(se);Te=a(On,"A",{id:!0,class:!0,href:!0});var gd=s(Te);Ao=a(gd,"SPAN",{});var _d=s(Ao);f(st.$$.fragment,_d),_d.forEach(o),gd.forEach(o),Vs=c(On),No=a(On,"SPAN",{});var bd=s(No);Js=i(bd,"PLBartModel"),bd.forEach(o),On.forEach(o),yn=c(t),S=a(t,"DIV",{class:!0});var xe=s(S);f(rt.$$.fragment,xe),Ks=c(xe),it=a(xe,"P",{});var Gn=s(it);Qs=i(Gn,`The bare PLBART Model outputting raw hidden-states without any specific head on top.
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Un.forEach(o),Lr=c(Ce),F=a(Ce,"DIV",{class:!0});var J=s(F);f(_t.$$.fragment,J),zr=c(J),de=a(J,"P",{});var oo=s(de);qr=i(oo,"The "),Ht=a(oo,"A",{href:!0});var $d=s(Ht);Br=i($d,"PLBartForConditionalGeneration"),$d.forEach(o),$r=i(oo," forward method, overrides the "),Go=a(oo,"CODE",{});var xd=s(Go);xr=i(xd,"__call__"),xd.forEach(o),Cr=i(oo," special method."),oo.forEach(o),jr=c(J),f(Pe.$$.fragment,J),Er=c(J),Ro=a(J,"P",{});var Cd=s(Ro);Fr=i(Cd,"Mask-filling example:"),Cd.forEach(o),Mr=c(J),f(bt.$$.fragment,J),J.forEach(o),Ce.forEach(o),Ln=c(t),le=a(t,"H2",{class:!0});var Vn=s(le);Le=a(Vn,"A",{id:!0,class:!0,href:!0});var jd=s(Le);Wo=a(jd,"SPAN",{});var Ed=s(Wo);f(kt.$$.fragment,Ed),Ed.forEach(o),jd.forEach(o),Sr=c(Vn),Ho=a(Vn,"SPAN",{});var Fd=s(Ho);Ar=i(Fd,"PLBartForSequenceClassification"),Fd.forEach(o),Vn.forEach(o),zn=c(t),x=a(t,"DIV",{class:!0});var K=s(x);f(vt.$$.fragment,K),Nr=c(K),Uo=a(K,"P",{});var Md=s(Uo);Ir=i(Md,`PLBart model with a sequence classification/head on top (a linear layer on top of the pooled output) e.g. for code
classification.`),Md.forEach(o),Dr=c(K),Tt=a(K,"P",{});var Jn=s(Tt);Xr=i(Jn,"This model inherits from "),Ut=a(Jn,"A",{href:!0});var Sd=s(Ut);Or=i(Sd,"PreTrainedModel"),Sd.forEach(o),Gr=i(Jn,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
