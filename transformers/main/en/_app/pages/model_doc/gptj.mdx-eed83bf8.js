...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),{c(){d=a("p"),T=n("Example:"),c=h(),k(p.$$.fragment)},l(l){d=r(l,"P",{});var m=i(d);T=s(m,"Example:"),m.forEach(t),c=u(l),w(p.$$.fragment,l)},m(l,m){g(l,d,m),e(d,T),g(l,c,m),b(p,l,m),y=!0},p:Ee,i(l){y||($(p.$$.fragment,l),y=!0)},o(l){P(p.$$.fragment,l),y=!1},d(l){l&&t(d),l&&t(c),F(p,l)}}}function Gf(j){let d,T,c,p,y,l,m,x,he,K,J,X,O,Z,ue,W,me,re,L,I,ee,te,E,M,fe,Q,ie,Y,H,oe,ge,q,le,N,_e,de,S,U,Te,C,ye,R,ne;return{c(){d=a("p"),T=n("TF 2.0 models accepts two formats as inputs:"),c=h(),p=a("ul"),y=a("li"),l=n("having all inputs as keyword arguments (like PyTorch models), or"),m=h(),x=a("li"),he=n("having all inputs as a list, tuple or dict in the first positional arguments."),K=h(),J=a("p"),X=n("This second option is useful when using "),O=a("code"),Z=n("tf.keras.Model.fit"),ue=n(` method which currently requires having all the
tensors in the first argument of the model call function: `),W=a("code"),me=n("model(inputs)"),re=n("."),L=h(),I=a("p"),ee=n(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),te=h(),E=a("ul"),M=a("li"),fe=n("a single Tensor with "),Q=a("code"),ie=n("input_ids"),Y=n(" only and nothing else: "),H=a("code"),oe=n("model(inputs_ids)"),ge=h(),q=a("li"),le=n(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),N=a("code"),_e=n("model([input_ids, attention_mask])"),de=n(" or "),S=a("code"),U=n("model([input_ids, attention_mask, token_type_ids])"),Te=h(),C=a("li"),ye=n(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),R=a("code"),ne=n('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(v){d=r(v,"P",{});var G=i(d);T=s(G,"TF 2.0 models accepts two formats as inputs:"),G.forEach(t),c=u(v),p=r(v,"UL",{});var V=i(p);y=r(V,"LI",{});var Ce=i(y);l=s(Ce,"having all inputs as keyword arguments (like PyTorch models), or"),Ce.forEach(t),m=u(V),x=r(V,"LI",{});var ze=i(x);he=s(ze,"having all inputs as a list, tuple or dict in the first positional arguments."),ze.forEach(t),V.forEach(t),K=u(v),J=r(v,"P",{});var z=i(J);X=s(z,"This second option is useful when using "),O=r(z,"CODE",{});var Ae=i(O);Z=s(Ae,"tf.keras.Model.fit"),Ae.forEach(t),ue=s(z,` method which currently requires having all the
...
<span class="hljs-meta">&gt;&gt;&gt; </span>inputs = tokenizer(<span class="hljs-string">&quot;Hello, my dog is cute&quot;</span>, return_tensors=<span class="hljs-string">&quot;tf&quot;</span>)
<span class="hljs-meta">&gt;&gt;&gt; </span>outputs = model(inputs)
<span class="hljs-meta">&gt;&gt;&gt; </span>logits = outputs.logits`}}),{c(){d=a("p"),T=n("Example:"),c=h(),k(p.$$.fragment)},l(l){d=r(l,"P",{});var m=i(d);T=s(m,"Example:"),m.forEach(t),c=u(l),w(p.$$.fragment,l)},m(l,m){g(l,d,m),e(d,T),g(l,c,m),b(p,l,m),y=!0},p:Ee,i(l){y||($(p.$$.fragment,l),y=!0)},o(l){P(p.$$.fragment,l),y=!1},d(l){l&&t(d),l&&t(c),F(p,l)}}}function Mf(j){let d,T,c,p,y,l,m,x,he,K,J,X,O,Z,ue,W,me,re,L,I,ee,te,E,M,fe,Q,ie,Y,H,oe,ge,q,le,N,_e,de,S,U,Te,C,ye,R,ne;return{c(){d=a("p"),T=n("TF 2.0 models accepts two formats as inputs:"),c=h(),p=a("ul"),y=a("li"),l=n("having all inputs as keyword arguments (like PyTorch models), or"),m=h(),x=a("li"),he=n("having all inputs as a list, tuple or dict in the first positional arguments."),K=h(),J=a("p"),X=n("This second option is useful when using "),O=a("code"),Z=n("tf.keras.Model.fit"),ue=n(` method which currently requires having all the
tensors in the first argument of the model call function: `),W=a("code"),me=n("model(inputs)"),re=n("."),L=h(),I=a("p"),ee=n(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),te=h(),E=a("ul"),M=a("li"),fe=n("a single Tensor with "),Q=a("code"),ie=n("input_ids"),Y=n(" only and nothing else: "),H=a("code"),oe=n("model(inputs_ids)"),ge=h(),q=a("li"),le=n(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),N=a("code"),_e=n("model([input_ids, attention_mask])"),de=n(" or "),S=a("code"),U=n("model([input_ids, attention_mask, token_type_ids])"),Te=h(),C=a("li"),ye=n(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),R=a("code"),ne=n('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(v){d=r(v,"P",{});var G=i(d);T=s(G,"TF 2.0 models accepts two formats as inputs:"),G.forEach(t),c=u(v),p=r(v,"UL",{});var V=i(p);y=r(V,"LI",{});var Ce=i(y);l=s(Ce,"having all inputs as keyword arguments (like PyTorch models), or"),Ce.forEach(t),m=u(V),x=r(V,"LI",{});var ze=i(x);he=s(ze,"having all inputs as a list, tuple or dict in the first positional arguments."),ze.forEach(t),V.forEach(t),K=u(v),J=r(v,"P",{});var z=i(J);X=s(z,"This second option is useful when using "),O=r(z,"CODE",{});var Ae=i(O);Z=s(Ae,"tf.keras.Model.fit"),Ae.forEach(t),ue=s(z,` method which currently requires having all the
...
`}}),{c(){k(d.$$.fragment)},l(c){w(d.$$.fragment,c)},m(c,p){b(d,c,p),T=!0},p:Ee,i(c){T||($(d.$$.fragment,c),T=!0)},o(c){P(d.$$.fragment,c),T=!1},d(c){F(d,c)}}}function Af(j){let d,T,c,p,y,l,m,x,he,K,J,X,O,Z,ue,W,me,re,L,I,ee,te,E,M,fe,Q,ie,Y,H,oe,ge,q,le,N,_e,de,S,U,Te,C,ye,R,ne;return{c(){d=a("p"),T=n("TF 2.0 models accepts two formats as inputs:"),c=h(),p=a("ul"),y=a("li"),l=n("having all inputs as keyword arguments (like PyTorch models), or"),m=h(),x=a("li"),he=n("having all inputs as a list, tuple or dict in the first positional arguments."),K=h(),J=a("p"),X=n("This second option is useful when using "),O=a("code"),Z=n("tf.keras.Model.fit"),ue=n(` method which currently requires having all the
tensors in the first argument of the model call function: `),W=a("code"),me=n("model(inputs)"),re=n("."),L=h(),I=a("p"),ee=n(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),te=h(),E=a("ul"),M=a("li"),fe=n("a single Tensor with "),Q=a("code"),ie=n("input_ids"),Y=n(" only and nothing else: "),H=a("code"),oe=n("model(inputs_ids)"),ge=h(),q=a("li"),le=n(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),N=a("code"),_e=n("model([input_ids, attention_mask])"),de=n(" or "),S=a("code"),U=n("model([input_ids, attention_mask, token_type_ids])"),Te=h(),C=a("li"),ye=n(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),R=a("code"),ne=n('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(v){d=r(v,"P",{});var G=i(d);T=s(G,"TF 2.0 models accepts two formats as inputs:"),G.forEach(t),c=u(v),p=r(v,"UL",{});var V=i(p);y=r(V,"LI",{});var Ce=i(y);l=s(Ce,"having all inputs as keyword arguments (like PyTorch models), or"),Ce.forEach(t),m=u(V),x=r(V,"LI",{});var ze=i(x);he=s(ze,"having all inputs as a list, tuple or dict in the first positional arguments."),ze.forEach(t),V.forEach(t),K=u(v),J=r(v,"P",{});var z=i(J);X=s(z,"This second option is useful when using "),O=r(z,"CODE",{});var Ae=i(O);Z=s(Ae,"tf.keras.Model.fit"),Ae.forEach(t),ue=s(z,` method which currently requires having all the
...
<span class="hljs-meta">&gt;&gt;&gt; </span>next_token_logits = outputs.logits[:, -<span class="hljs-number">1</span>]`}}),{c(){d=a("p"),T=n("Example:"),c=h(),k(p.$$.fragment)},l(l){d=r(l,"P",{});var m=i(d);T=s(m,"Example:"),m.forEach(t),c=u(l),w(p.$$.fragment,l)},m(l,m){g(l,d,m),e(d,T),g(l,c,m),b(p,l,m),y=!0},p:Ee,i(l){y||($(p.$$.fragment,l),y=!0)},o(l){P(p.$$.fragment,l),y=!1},d(l){l&&t(d),l&&t(c),F(p,l)}}}function Uf(j){let d,T,c,p,y,l,m,x,he,K,J,X,O,Z,ue,W,me,re,L,I,ee,te,E,M,fe,Q,ie,Y,H,oe,ge,q,le,N,_e,de,S,U,Te,C,ye,R,ne,v,G,V,Ce,ze,z,Ae,Ie,Me,A,B,ce,Pe,D,Le,ve,ke,Ne,ta,ct,Ni,Ro,Si,Di,oa,Oi,Wi,na,Ui,Bi,Ir,wt,Ht,sa,Vo,Qi,aa,Hi,Lr,Rt,Ri,_s,Vi,Ki,Nr,Ko,Sr,Ts,Xi,Dr,Xo,Or,bt,Vt,ra,Yo,Yi,ia,Zi,Wr,pt,Zo,el,Re,tl,ys,ol,nl,en,sl,al,vs,rl,il,ks,ll,dl,cl,Kt,Ur,$t,Xt,la,tn,pl,da,hl,Br,ht,on,ul,nn,ml,sn,fl,gl,_l,et,an,Tl,Pt,yl,ws,vl,kl,ca,wl,bl,$l,Yt,Pl,Zt,Qr,Ft,eo,pa,rn,Fl,ha,jl,Hr,Ve,ln,xl,ua,Gl,Jl,dn,El,cn,Ml,ql,Cl,tt,pn,zl,jt,Al,bs,Il,Ll,ma,Nl,Sl,Dl,to,Ol,oo,Rr,xt,no,fa,hn,Wl,ga,Ul,Vr,Fe,un,Bl,_a,Ql,Hl,$s,Ps,Rl,Vl,Kl,Ke,Xl,Ta,Yl,Zl,ya,ed,td,va,od,nd,ka,sd,ad,rd,mn,id,fn,ld,dd,cd,$e,gn,pd,Gt,hd,Fs,ud,md,wa,fd,gd,_d,so,Td,ao,yd,ro,vd,io,kd,lo,Kr,Jt,co,ba,_n,wd,$a,bd,Xr,Xe,Tn,$d,Et,Pd,Pa,Fd,jd,Fa,xd,Gd,Jd,yn,Ed,vn,Md,qd,Cd,Se,kn,zd,Mt,Ad,js,Id,Ld,ja,Nd,Sd,Dd,po,Od,ho,Wd,uo,Yr,qt,mo,xa,wn,Ud,Ga,Bd,Zr,je,bn,Qd,Ja,Hd,Rd,$n,Vd,xs,Kd,Xd,Yd,Pn,Zd,Fn,ec,tc,oc,fo,nc,ot,jn,sc,Ct,ac,Gs,rc,ic,Ea,lc,dc,cc,go,pc,_o,ei,zt,To,Ma,xn,hc,qa,uc,ti,xe,Gn,mc,Ca,fc,gc,Jn,_c,Js,Tc,yc,vc,En,kc,Mn,wc,bc,$c,yo,Pc,nt,qn,Fc,At,jc,Es,xc,Gc,za,Jc,Ec,Mc,vo,qc,ko,oi,It,wo,Aa,Cn,Cc,Ia,zc,ni,se,zn,Ac,La,Ic,Lc,Ms,qs,Nc,Sc,Dc,Ye,Oc,Na,Wc,Uc,Sa,Bc,Qc,Da,Hc,Rc,Oa,Vc,Kc,Xc,An,Yc,Cs,Zc,ep,tp,In,op,Ln,np,sp,ap,bo,rp,De,Nn,ip,Lt,lp,zs,dp,cp,Wa,pp,hp,up,$o,mp,Po,fp,Fo,si,Nt,jo,Ua,Sn,gp,Ba,_p,ai,Ge,Dn,Tp,St,yp,Qa,vp,kp,Ha,wp,bp,$p,On,Pp,As,Fp,jp,xp,Wn,Gp,Un,Jp,Ep,Mp,xo,qp,Oe,Bn,Cp,Dt,zp,Is,Ap,Ip,Ra,Lp,Np,Sp,Go,Dp,Jo,Op,Eo,ri,Ot,Mo,Va,Qn,Wp,Ka,Up,ii,we,Hn,Bp,Xa,Qp,Hp,Rn,Rp,Ls,Vp,Kp,Xp,Vn,Yp,Kn,Zp,eh,th,Ya,oh,nh,ut,Za,Xn,sh,ah,er,Yn,rh,ih,tr,Zn,lh,dh,or,es,ch,ph,st,ts,hh,Wt,uh,nr,mh,fh,sr,gh,_h,Th,qo,yh,Co,li,Ut,zo,ar,os,vh,rr,kh,di,be,ns,wh,ir,bh,$h,ss,Ph,Ns,Fh,jh,xh,as,Gh,rs,Jh,Eh,Mh,lr,qh,Ch,mt,dr,is,zh,Ah,cr,ls,Ih,Lh,pr,ds,Nh,Sh,hr,cs,Dh,Oh,at,ps,Wh,Bt,Uh,ur,Bh,Qh,mr,Hh,Rh,Vh,Ao,Kh,Io,ci;return l=new He({}),Z=new He({}),A=new pe({props:{code:`from transformers import GPTJForCausalLM
import torch
...
Whether or not the model should return the last key/values attentions (not used by all models).`,name:"use_cache"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/gptj/configuration_gptj.py#L33"}}),Kt=new Je({props:{anchor:"transformers.GPTJConfig.example",$$slots:{default:[uf]},$$scope:{ctx:j}}}),tn=new He({}),on=new ae({props:{name:"class transformers.GPTJModel",anchor:"transformers.GPTJModel",parameters:[{name:"config",val:""}],parametersDescription:[{anchor:"transformers.GPTJModel.config",description:`<strong>config</strong> (<a href="/docs/transformers/main/en/model_doc/gptj#transformers.GPTJConfig">GPTJConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/main/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/gptj/modeling_gptj.py#L471"}}),an=new ae({props:{name:"forward",anchor:"transformers.GPTJModel.forward",parameters:[{name:"input_ids",val:" = None"},{name:"past_key_values",val:" = None"},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],parametersDescription:[{anchor:"transformers.GPTJModel.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
...
Whether or not to return a <a href="/docs/transformers/main/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/gptj/modeling_gptj.py#L527",returnDescription:`
<p>A <a
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/main/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/gptj/modeling_gptj.py#L712"}}),pn=new ae({props:{name:"forward",anchor:"transformers.GPTJForCausalLM.forward",parameters:[{name:"input_ids",val:" = None"},{name:"past_key_values",val:" = None"},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"labels",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],parametersDescription:[{anchor:"transformers.GPTJForCausalLM.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <code>GPTJTokenizer</code>. See <a href="/docs/transformers/main/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/main/en/model_doc/wav2vec2_phoneme#transformers.Wav2Vec2PhonemeCTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
are ignored (masked), the loss is only computed for labels in <code>[0, ..., config.vocab_size]</code>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/gptj/modeling_gptj.py#L781",returnDescription:`
<p>A <a
...
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/gptj/modeling_gptj.py#L903",returnDescription:`
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/main/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/gptj/modeling_gptj.py#L1014"}}),kn=new ae({props:{name:"forward",anchor:"transformers.GPTJForQuestionAnswering.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"start_positions",val:" = None"},{name:"end_positions",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],parametersDescription:[{anchor:"transformers.GPTJForQuestionAnswering.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <code>GPTJTokenizer</code>. See <a href="/docs/transformers/main/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/main/en/model_doc/wav2vec2_phoneme#transformers.Wav2Vec2PhonemeCTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/gptj/modeling_gptj.py#L1030",returnDescription:`
<p>A <a
...
causal language model trained on `),M=a("a"),fe=n("the Pile"),Q=n(" dataset."),ie=h(),Y=a("p"),H=n("This model was contributed by "),oe=a("a"),ge=n("Stella Biderman"),q=n("."),le=h(),N=a("p"),_e=n("Tips:"),de=h(),S=a("ul"),U=a("li"),Te=n("To load "),C=a("a"),ye=n("GPT-J"),R=n(` in float32 one would need at least 2x model size CPU
...
behavior.`),_l=h(),et=a("div"),k(an.$$.fragment),Tl=h(),Pt=a("p"),yl=n("The "),ws=a("a"),vl=n("GPTJModel"),kl=n(" forward method, overrides the "),ca=a("code"),wl=n("__call__"),bl=n(" special method."),$l=h(),k(Yt.$$.fragment),Pl=h(),k(Zt.$$.fragment),Qr=h(),Ft=a("h2"),eo=a("a"),pa=a("span"),k(rn.$$.fragment),Fl=h(),ha=a("span"),jl=n("GPTJForCausalLM"),Hr=h(),Ve=a("div"),k(ln.$$.fragment),xl=h(),ua=a("p"),Gl=n("The GPT-J Model transformer with a language modeling head on top."),Jl=h(),dn=a("p"),El=n("This model is a PyTorch "),cn=a("a"),Ml=n("torch.nn.Module"),ql=n(` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),ap=h(),k(bo.$$.fragment),rp=h(),De=a("div"),k(Nn.$$.fragment),ip=h(),Lt=a("p"),lp=n("The "),zs=a("a"),dp=n("TFGPTJForSequenceClassification"),cp=n(" forward method, overrides the "),Wa=a("code"),pp=n("__call__"),hp=n(" special method."),up=h(),k($o.$$.fragment),mp=h(),k(Po.$$.fragment),fp=h(),k(Fo.$$.fragment),si=h(),Nt=a("h2"),jo=a("a"),Ua=a("span"),k(Sn.$$.fragment),gp=h(),Ba=a("span"),_p=n("TFGPTJForQuestionAnswering"),ai=h(),Ge=a("div"),k(Dn.$$.fragment),Tp=h(),St=a("p"),yp=n(`The GPT-J Model transformer with a span classification head on top for extractive question-answering tasks like
SQuAD (a linear layers on top of the hidden-states output to compute `),Qa=a("code"),vp=n("span start logits"),kp=n(" and "),Ha=a("code"),wp=n("span end logits"),bp=n(")."),$p=h(),On=a("p"),Pp=n("This model inherits from "),As=a("a"),Fp=n("TFPreTrainedModel"),jp=n(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),Ti.forEach(t),cd=u(rt),$e=r(rt,"DIV",{class:!0});var We=i($e);w(gn.$$.fragment,We),pd=u(We),Gt=r(We,"P",{});var Bs=i(Gt);hd=s(Bs,"The "),Fs=r(Bs,"A",{href:!0});var qu=i(Fs);ud=s(qu,"GPTJForSequenceClassification"),qu.forEach(t),md=s(Bs," forward method, overrides the "),wa=r(Bs,"CODE",{});var Cu=i(wa);fd=s(Cu,"__call__"),Cu.forEach(t),gd=s(Bs," special method."),Bs.forEach(t),_d=u(We),w(so.$$.fragment,We),Td=u(We),w(ao.$$.fragment,We),yd=u(We),w(ro.$$.fragment,We),vd=u(We),w(io.$$.fragment,We),kd=u(We),w(lo.$$.fragment,We),We.forEach(t),rt.forEach(t),Kr=u(o),Jt=r(o,"H2",{class:!0});var yi=i(Jt);co=r(yi,"A",{id:!0,class:!0,href:!0});var zu=i(co);ba=r(zu,"SPAN",{});var Au=i(ba);w(_n.$$.fragment,Au),Au.forEach(t),zu.forEach(t),wd=u(yi),$a=r(yi,"SPAN",{});var Iu=i($a);bd=s(Iu,"GPTJForQuestionAnswering"),Iu.forEach(t),yi.forEach(t),Xr=u(o),Xe=r(o,"DIV",{class:!0});var Do=i(Xe);w(Tn.$$.fragment,Do),$d=u(Do),Et=r(Do,"P",{});var Qs=i(Et);Pd=s(Qs,`The GPT-J Model transformer with a span classification head on top for extractive question-answering tasks like
...
no `),Sa=r(yt,"CODE",{});var pm=i(Sa);Bc=s(pm,"pad_token_id"),pm.forEach(t),Qc=s(yt,` is defined, it simply takes the last value in each row of the batch. Since it cannot guess the
