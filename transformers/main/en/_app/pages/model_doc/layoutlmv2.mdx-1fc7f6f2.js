import{S as H_,i as K_,s as X_,e as s,k as u,w as v,t as n,M as Y_,c as r,d as t,m,a as i,x as y,h as a,b as l,F as e,g as p,y as b,q as L,o as w,B as k,v as Z_,L as ua}from"../../chunks/vendor-6b77c823.js";import{T as ji}from"../../chunks/Tip-39098574.js";import{D as A}from"../../chunks/Docstring-1088f2fb.js";import{C as G}from"../../chunks/CodeBlock-3a8b25a8.js";import{I as ie}from"../../chunks/IconCopyLink-7a11ce68.js";import{E as da}from"../../chunks/ExampleCodeBlock-5212b321.js";function J_(P){let h,T,_,g,x;return g=new G({props:{code:`from transformers import LayoutLMv2Model, LayoutLMv2Config
...
<span class="hljs-meta">&gt;&gt;&gt; </span>end_scores = outputs.end_logits`}}),{c(){h=s("p"),T=n("Examples:"),_=u(),v(g.$$.fragment)},l(d){h=r(d,"P",{});var f=i(h);T=a(f,"Examples:"),f.forEach(t),_=m(d),y(g.$$.fragment,d)},m(d,f){p(d,h,f),e(h,T),p(d,_,f),b(g,d,f),x=!0},p:ua,i(d){x||(L(g.$$.fragment,d),x=!0)},o(d){w(g.$$.fragment,d),x=!1},d(d){d&&t(h),d&&t(_),k(g,d)}}}function cv(P){let h,T,_,g,x,d,f,D,Ci,sr,xe,We,ma,Mo,Ii,pa,Ai,rr,ue,Di,$o,Oi,Ni,Jt,Si,Ri,ir,me,H,Ui,Eo,Wi,Bi,zo,Vi,Qi,Fo,Gi,Hi,qo,Ki,Xi,Yi,Po,Zi,jo,Ji,el,ol,Co,tl,Io,nl,al,lr,en,sl,cr,on,ha,rl,dr,tn,il,ur,W,fa,ll,cl,Ao,dl,Do,ul,ml,pl,Oo,hl,No,fl,gl,_l,Te,vl,So,yl,bl,Ro,Ll,wl,kl,M,xl,ga,Tl,Ml,nn,$l,El,_a,zl,Fl,va,ql,Pl,ya,jl,Cl,ba,Il,Al,La,Dl,Ol,wa,Nl,Sl,ka,Rl,Ul,an,Wl,Bl,Uo,Vl,Ql,Wo,Gl,Hl,mr,Bo,pr,pe,Kl,xa,Xl,Yl,Ta,Zl,Jl,hr,Vo,fr,Be,ec,sn,oc,tc,gr,he,I,nc,rn,ac,sc,Ma,rc,ic,$a,lc,cc,ln,dc,uc,Ea,mc,pc,za,hc,fc,Fa,gc,_c,vc,Qo,yc,cn,bc,Lc,wc,Go,kc,qa,xc,Tc,_r,Ve,Mc,dn,$c,Ec,vr,Me,Qe,Pa,Ho,zc,ja,Fc,yr,B,qc,un,Pc,jc,mn,Cc,Ic,pn,Ac,Dc,hn,Oc,Nc,br,Ko,Lr,E,Sc,fn,Rc,Uc,gn,Wc,Bc,Ca,Vc,Qc,_n,Gc,Hc,vn,Kc,Xc,Ia,Yc,Zc,Aa,Jc,ed,Da,od,td,Oa,nd,ad,Na,sd,rd,wr,R,yn,id,ld,Xo,cd,dd,bn,ud,md,Sa,pd,hd,Ra,fd,gd,kr,Ln,_d,xr,wn,Ua,vd,Tr,kn,yd,Mr,Yo,$r,xn,Wa,bd,Er,fe,Ld,Ba,wd,kd,Va,xd,Td,zr,Zo,Fr,Tn,Qa,Md,qr,V,$d,Ga,Ed,zd,Ha,Fd,qd,Ka,Pd,jd,Xa,Cd,Id,Pr,Jo,jr,Mn,Ya,Ad,Cr,$n,Dd,Ir,et,Ar,En,Za,Od,Dr,zn,Nd,Or,ot,Nr,$e,Ge,Ja,tt,Sd,es,Rd,Sr,K,nt,Ud,Ee,Wd,Fn,Bd,Vd,at,Qd,Gd,Hd,ze,Kd,qn,Xd,Yd,Pn,Zd,Jd,eu,He,Rr,Fe,Ke,os,st,ou,ts,tu,Ur,X,rt,nu,ns,au,su,it,ru,as,iu,lu,cu,ge,lt,du,ss,uu,mu,Xe,Wr,qe,Ye,rs,ct,pu,is,hu,Br,O,dt,fu,N,gu,jn,_u,vu,ls,yu,bu,cs,Lu,wu,ds,ku,xu,us,Tu,Mu,ms,$u,Eu,zu,ut,Fu,Cn,qu,Pu,ju,In,An,Cu,Iu,Au,Ze,mt,Du,ps,Ou,Nu,Dn,pt,Vr,Pe,Je,hs,ht,Su,fs,Ru,Qr,Y,ft,Uu,gt,Wu,gs,Bu,Vu,Qu,_t,Gu,On,Hu,Ku,Xu,eo,vt,Yu,_s,Zu,Gr,je,oo,vs,yt,Ju,ys,em,Hr,U,bt,om,bs,tm,nm,Nn,Sn,am,sm,rm,q,im,Rn,lm,cm,Un,dm,um,Wn,mm,pm,Ls,hm,fm,ws,gm,_m,ks,vm,ym,xs,bm,Lm,Ts,wm,km,Ms,xm,Tm,Mm,_e,Lt,$m,$,Em,$s,zm,Fm,wt,Es,qm,Pm,jm,Bn,Cm,Im,zs,Am,Dm,Fs,Om,Nm,kt,qs,Sm,Rm,Um,Ps,Wm,Bm,Vn,Vm,Qm,js,Gm,Hm,Cs,Km,Xm,Is,Ym,Zm,As,Jm,ep,op,Ds,tp,Kr,Ce,to,Os,xt,np,Ns,ap,Xr,le,Tt,sp,Mt,rp,$t,ip,lp,cp,te,Et,dp,Ie,up,Qn,mp,pp,Ss,hp,fp,gp,no,_p,ao,Yr,Ae,so,Rs,zt,vp,Us,yp,Zr,Z,Ft,bp,qt,Lp,Pt,wp,kp,xp,jt,Tp,Ct,Mp,$p,Ep,ne,It,zp,De,Fp,Gn,qp,Pp,Ws,jp,Cp,Ip,ro,Ap,io,Jr,Oe,lo,Bs,At,Dp,Vs,Op,ei,J,Dt,Np,ee,Sp,Ot,Rp,Up,Nt,Wp,Bp,St,Vp,Qp,Rt,Gp,Hp,Kp,Ut,Xp,Wt,Yp,Zp,Jp,ae,Bt,eh,Ne,oh,Hn,th,nh,Qs,ah,sh,rh,co,ih,uo,oi,Se,mo,Gs,Vt,lh,Hs,ch,ti,oe,Qt,dh,ce,uh,Gt,mh,ph,Ks,hh,fh,Xs,gh,_h,vh,Ht,yh,Kt,bh,Lh,wh,se,Xt,kh,Re,xh,Kn,Th,Mh,Ys,$h,Eh,zh,po,Fh,ho,ni;return d=new ie({}),Mo=new ie({}),Bo=new G({props:{code:`def normalize_bbox(bbox, width, height):
    return [
...
</ul>`,name:"return_tensors"}],source:"https://github.com/huggingface/transformers/blob/vmain/src/transformers/models/layoutlmv2/feature_extraction_layoutlmv2.py#L123",returnDescription:`
<p>A <a
...
<li><code>&apos;pt&apos;</code>: Return PyTorch <code>torch.Tensor</code> objects.</li>
<li><code>&apos;np&apos;</code>: Return Numpy <code>np.ndarray</code> objects.</li>
</ul>`,name:"return_tensors"}],source:"https://github.com/huggingface/transformers/blob/vmain/src/transformers/models/layoutlmv2/tokenization_layoutlmv2.py#L414"}}),pt=new A({props:{name:"save_vocabulary",anchor:"transformers.LayoutLMv2Tokenizer.save_vocabulary",parameters:[{name:"save_directory",val:": str"},{name:"filename_prefix",val:": typing.Optional[str] = None"}],source:"https://github.com/huggingface/transformers/blob/vmain/src/transformers/models/layoutlmv2/tokenization_layoutlmv2.py#L394"}}),ht=new ie({}),ft=new A({props:{name:"class transformers.LayoutLMv2TokenizerFast",anchor:"transformers.LayoutLMv2TokenizerFast",parameters:[{name:"vocab_file",val:" = None"},{name:"tokenizer_file",val:" = None"},{name:"do_lower_case",val:" = True"},{name:"unk_token",val:" = '[UNK]'"},{name:"sep_token",val:" = '[SEP]'"},{name:"pad_token",val:" = '[PAD]'"},{name:"cls_token",val:" = '[CLS]'"},{name:"mask_token",val:" = '[MASK]'"},{name:"cls_token_box",val:" = [0, 0, 0, 0]"},{name:"sep_token_box",val:" = [1000, 1000, 1000, 1000]"},{name:"pad_token_box",val:" = [0, 0, 0, 0]"},{name:"pad_token_label",val:" = -100"},{name:"only_label_first_subword",val:" = True"},{name:"tokenize_chinese_chars",val:" = True"},{name:"strip_accents",val:" = None"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.LayoutLMv2TokenizerFast.vocab_file",description:`<strong>vocab_file</strong> (<code>str</code>) &#x2014;
...
An instance of <a href="/docs/transformers/main/en/model_doc/layoutlmv2#transformers.LayoutLMv2Tokenizer">LayoutLMv2Tokenizer</a> or <a href="/docs/transformers/main/en/model_doc/layoutlmv2#transformers.LayoutLMv2TokenizerFast">LayoutLMv2TokenizerFast</a>. The tokenizer is a required input.`,name:"tokenizer"}],source:"https://github.com/huggingface/transformers/blob/vmain/src/transformers/models/layoutlmv2/processing_layoutlmv2.py#L25"}}),Lt=new A({props:{name:"__call__",anchor:"transformers.LayoutLMv2Processor.__call__",parameters:[{name:"images",val:""},{name:"text",val:": typing.Union[str, typing.List[str], typing.List[typing.List[str]]] = None"},{name:"text_pair",val:": typing.Union[typing.List[str], typing.List[typing.List[str]], NoneType] = None"},{name:"boxes",val:": typing.Union[typing.List[typing.List[int]], typing.List[typing.List[typing.List[int]]]] = None"},{name:"word_labels",val:": typing.Union[typing.List[int], typing.List[typing.List[int]], NoneType] = None"},{name:"add_special_tokens",val:": bool = True"},{name:"padding",val:": typing.Union[bool, str, transformers.utils.generic.PaddingStrategy] = False"},{name:"truncation",val:": typing.Union[bool, str, transformers.tokenization_utils_base.TruncationStrategy] = False"},{name:"max_length",val:": typing.Optional[int] = None"},{name:"stride",val:": int = 0"},{name:"pad_to_multiple_of",val:": typing.Optional[int] = None"},{name:"return_token_type_ids",val:": typing.Optional[bool] = None"},{name:"return_attention_mask",val:": typing.Optional[bool] = None"},{name:"return_overflowing_tokens",val:": bool = False"},{name:"return_special_tokens_mask",val:": bool = False"},{name:"return_offsets_mapping",val:": bool = False"},{name:"return_length",val:": bool = False"},{name:"verbose",val:": bool = True"},{name:"return_tensors",val:": typing.Union[str, transformers.utils.generic.TensorType, NoneType] = None"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/vmain/src/transformers/models/layoutlmv2/processing_layoutlmv2.py#L47"}}),xt=new ie({}),Tt=new A({props:{name:"class transformers.LayoutLMv2Model",anchor:"transformers.LayoutLMv2Model",parameters:[{name:"config",val:""}],parametersDescription:[{anchor:"transformers.LayoutLMv2Model.config",description:`<strong>config</strong> (<a href="/docs/transformers/main/en/model_doc/layoutlmv2#transformers.LayoutLMv2Config">LayoutLMv2Config</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/main/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/vmain/src/transformers/models/layoutlmv2/modeling_layoutlmv2.py#L709"}}),Et=new A({props:{name:"forward",anchor:"transformers.LayoutLMv2Model.forward",parameters:[{name:"input_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"bbox",val:": typing.Optional[torch.LongTensor] = None"},{name:"image",val:": typing.Optional[torch.FloatTensor] = None"},{name:"attention_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"token_type_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"position_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"head_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.LayoutLMv2Model.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
...
Whether or not to return a <a href="/docs/transformers/main/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vmain/src/transformers/models/layoutlmv2/modeling_layoutlmv2.py#L807",returnDescription:`
<p>A <a
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/main/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/vmain/src/transformers/models/layoutlmv2/modeling_layoutlmv2.py#L954"}}),It=new A({props:{name:"forward",anchor:"transformers.LayoutLMv2ForSequenceClassification.forward",parameters:[{name:"input_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"bbox",val:": typing.Optional[torch.LongTensor] = None"},{name:"image",val:": typing.Optional[torch.FloatTensor] = None"},{name:"attention_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"token_type_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"position_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"head_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"labels",val:": typing.Optional[torch.LongTensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.LayoutLMv2ForSequenceClassification.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>batch_size, sequence_length</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/main/en/model_doc/layoutlmv2#transformers.LayoutLMv2Tokenizer">LayoutLMv2Tokenizer</a>. See <a href="/docs/transformers/main/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/main/en/model_doc/wav2vec2_phoneme#transformers.Wav2Vec2PhonemeCTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vmain/src/transformers/models/layoutlmv2/modeling_layoutlmv2.py#L968",returnDescription:`
<p>A <a
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/main/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/vmain/src/transformers/models/layoutlmv2/modeling_layoutlmv2.py#L1123"}}),Bt=new A({props:{name:"forward",anchor:"transformers.LayoutLMv2ForTokenClassification.forward",parameters:[{name:"input_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"bbox",val:": typing.Optional[torch.LongTensor] = None"},{name:"image",val:": typing.Optional[torch.FloatTensor] = None"},{name:"attention_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"token_type_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"position_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"head_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"labels",val:": typing.Optional[torch.LongTensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.LayoutLMv2ForTokenClassification.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>batch_size, sequence_length</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/main/en/model_doc/layoutlmv2#transformers.LayoutLMv2Tokenizer">LayoutLMv2Tokenizer</a>. See <a href="/docs/transformers/main/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/main/en/model_doc/wav2vec2_phoneme#transformers.Wav2Vec2PhonemeCTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vmain/src/transformers/models/layoutlmv2/modeling_layoutlmv2.py#L1137",returnDescription:`
<p>A <a
...
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/vmain/src/transformers/models/layoutlmv2/modeling_layoutlmv2.py#L1246",returnDescription:`
<p>A <a
...
`}}),po=new ji({props:{$$slots:{default:[iv]},$$scope:{ctx:P}}}),ho=new da({props:{anchor:"transformers.LayoutLMv2ForQuestionAnswering.forward.example",$$slots:{default:[lv]},$$scope:{ctx:P}}}),{c(){h=s("meta"),T=u(),_=s("h1"),g=s("a"),x=s("span"),v(d.$$.fragment),f=u(),D=s("span"),Ci=n("LayoutLMV2"),sr=u(),xe=s("h2"),We=s("a"),ma=s("span"),v(Mo.$$.fragment),Ii=u(),pa=s("span"),Ai=n("Overview"),rr=u(),ue=s("p"),Di=n("The LayoutLMV2 model was proposed in "),$o=s("a"),Oi=n("LayoutLMv2: Multi-modal Pre-training for Visually-Rich Document Understanding"),Ni=n(` by Yang Xu, Yiheng Xu, Tengchao Lv, Lei Cui, Furu Wei, Guoxin Wang, Yijuan Lu,
Dinei Florencio, Cha Zhang, Wanxiang Che, Min Zhang, Lidong Zhou. LayoutLMV2 improves `),Jt=s("a"),Si=n("LayoutLM"),Ri=n(` to obtain
state-of-the-art results across several document image understanding benchmarks:`),ir=u(),me=s("ul"),H=s("li"),Ui=n("information extraction from scanned documents: the "),Eo=s("a"),Wi=n("FUNSD"),Bi=n(` dataset (a
...
a 0-1000 scale. To normalize, you can use the following function:`),mr=u(),v(Bo.$$.fragment),pr=u(),pe=s("p"),Kl=n("Here, "),xa=s("code"),Xl=n("width"),Yl=n(" and "),Ta=s("code"),Zl=n("height"),Jl=n(` correspond to the width and height of the original document in which the token
...
`),Wn=s("a"),mm=n("LayoutLMv2TokenizerFast"),pm=n(", which turns the words and bounding boxes into token-level "),Ls=s("code"),hm=n("input_ids"),fm=n(`,
...
`),Bn=s("a"),Cm=n("LayoutLMv2FeatureExtractor"),Im=n(" was initialized with "),zs=s("code"),Am=n("apply_ocr"),Dm=n(" set to "),Fs=s("code"),Om=n("True"),Nm=n(`, it passes the obtained words and
bounding boxes along with the additional arguments to `),kt=s("a"),qs=s("strong"),Sm=n("call"),Rm=n("()"),Um=n(` and returns the output,
together with resized `),Ps=s("code"),Wm=n("images"),Bm=n(". In case "),Vn=s("a"),Vm=n("LayoutLMv2FeatureExtractor"),Qm=n(" was initialized with "),js=s("code"),Gm=n("apply_ocr"),Hm=n(` set to
...
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),Ep=u(),ne=s("div"),v(It.$$.fragment),zp=u(),De=s("p"),Fp=n("The "),Gn=s("a"),qp=n("LayoutLMv2ForSequenceClassification"),Pp=n(" forward method, overrides the "),Ws=s("code"),jp=n("__call__"),Cp=n(" special method."),Ip=u(),v(ro.$$.fragment),Ap=u(),v(io.$$.fragment),Jr=u(),Oe=s("h2"),lo=s("a"),Bs=s("span"),v(At.$$.fragment),Dp=u(),Vs=s("span"),Op=n("LayoutLMv2ForTokenClassification"),ei=u(),J=s("div"),v(Dt.$$.fragment),Np=u(),ee=s("p"),Sp=n(`LayoutLMv2 Model with a token classification head on top (a linear layer on top of the text part of the hidden
states) e.g. for sequence labeling (information extraction) tasks such as
`),Ot=s("a"),Rp=n("FUNSD"),Up=n(", "),Nt=s("a"),Wp=n("SROIE"),Bp=n(`,
`),St=s("a"),Vp=n("CORD"),Qp=n(" and "),Rt=s("a"),Gp=n("Kleister-NDA"),Hp=n("."),Kp=u(),Ut=s("p"),Xp=n("This model is a PyTorch "),Wt=s("a"),Yp=n("torch.nn.Module"),Zp=n(` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),Jp=u(),ae=s("div"),v(Bt.$$.fragment),eh=u(),Ne=s("p"),oh=n("The "),Hn=s("a"),th=n("LayoutLMv2ForTokenClassification"),nh=n(" forward method, overrides the "),Qs=s("code"),ah=n("__call__"),sh=n(" special method."),rh=u(),v(co.$$.fragment),ih=u(),v(uo.$$.fragment),oi=u(),Se=s("h2"),mo=s("a"),Gs=s("span"),v(Vt.$$.fragment),lh=u(),Hs=s("span"),ch=n("LayoutLMv2ForQuestionAnswering"),ti=u(),oe=s("div"),v(Qt.$$.fragment),dh=u(),ce=s("p"),uh=n(`LayoutLMv2 Model with a span classification head on top for extractive question-answering tasks such as
...
state-of-the-art results across several document image understanding benchmarks:`),Ue.forEach(t),ir=m(o),me=r(o,"UL",{});var Xn=i(me);H=r(Xn,"LI",{});var ve=i(H);Ui=a(ve,"information extraction from scanned documents: the "),Eo=r(ve,"A",{href:!0,rel:!0});var Ah=i(Eo);Wi=a(Ah,"FUNSD"),Ah.forEach(t),Bi=a(ve,` dataset (a
...
questions defined on 12,000+ document images).`),si.forEach(t),Xn.forEach(t),lr=m(o),en=r(o,"P",{});var Uh=i(en);sl=a(Uh,"The abstract from the paper is the following:"),Uh.forEach(t),cr=m(o),on=r(o,"P",{});var Wh=i(on);ha=r(Wh,"EM",{});var Bh=i(ha);rl=a(Bh,`Pre-training of text and layout has proved effective in a variety of visually-rich document understanding tasks due to
its effective model architecture and the advantage of large-scale unlabeled scanned/digital-born documents. In this
paper, we present LayoutLMv2 by pre-training text, layout and image in a multi-modal framework, where new model
architectures and pre-training tasks are leveraged. Specifically, LayoutLMv2 not only uses the existing masked
visual-language modeling task but also the new text-image alignment and text-image matching tasks in the pre-training
...
including FUNSD (0.7895 -> 0.8420), CORD (0.9493 -> 0.9601), SROIE (0.9524 -> 0.9781), Kleister-NDA (0.834 -> 0.852),
RVL-CDIP (0.9443 -> 0.9564), and DocVQA (0.7295 -> 0.8672). The pre-trained LayoutLMv2 model is publicly available at
this https URL.`),Bh.forEach(t),Wh.forEach(t),dr=m(o),tn=r(o,"P",{});var Vh=i(tn);il=a(Vh,"Tips:"),Vh.forEach(t),ur=m(o),W=r(o,"UL",{});var ye=i(W);fa=r(ye,"LI",{});var Qh=i(fa);ll=a(Qh,`The main difference between LayoutLMv1 and LayoutLMv2 is that the latter incorporates visual embeddings during
...
format, where (x0, y0) corresponds to the position of the upper left corner in the bounding box, and (x1, y1)
represents the position of the lower right corner. Note that one first needs to normalize the bounding boxes to be on
a 0-1000 scale. To normalize, you can use the following function:`),z.forEach(t),ye.forEach(t),mr=m(o),y(Bo.$$.fragment,o),pr=m(o),pe=r(o,"P",{});var Zn=i(pe);Kl=a(Zn,"Here, "),xa=r(Zn,"CODE",{});var df=i(xa);Xl=a(df,"width"),df.forEach(t),Yl=a(Zn," and "),Ta=r(Zn,"CODE",{});var uf=i(Ta);Zl=a(uf,"height"),uf.forEach(t),Jl=a(Zn,` correspond to the width and height of the original document in which the token
occurs (before resizing the image). Those can be obtained using the Python Image Library (PIL) library for example, as
follows:`),Zn.forEach(t),hr=m(o),y(Vo.$$.fragment,o),fr=m(o),Be=r(o,"P",{});var li=i(Be);ec=a(li,"However, this model includes a brand new "),sn=r(li,"A",{href:!0});var mf=i(sn);oc=a(mf,"LayoutLMv2Processor"),mf.forEach(t),tc=a(li,` which can be used to directly
prepare data for the model (including applying OCR under the hood). More information can be found in the \u201CUsage\u201D
...
wrapper around Google\u2019s Tesseract OCR engine, under the hood. Note that you can still use your own OCR engine of
choice, and provide the words and normalized boxes yourself. This requires initializing
`),bn=r(de,"A",{href:!0});var Uf=i(bn);ud=a(Uf,"LayoutLMv2FeatureExtractor"),Uf.forEach(t),md=a(de," with "),Sa=r(de,"CODE",{});var Wf=i(Sa);pd=a(Wf,"apply_ocr"),Wf.forEach(t),hd=a(de," set to "),Ra=r(de,"CODE",{});var Bf=i(Ra);fd=a(Bf,"False"),Bf.forEach(t),gd=a(de,"."),de.forEach(t),kr=m(o),Ln=r(o,"P",{});var Vf=i(Ln);_d=a(Vf,`In total, there are 5 use cases that are supported by the processor. Below, we list them all. Note that each of these
...
the words and normalized bounding boxes.`),Hf.forEach(t),Mr=m(o),y(Yo.$$.fragment,o),$r=m(o),xn=r(o,"P",{});var Kf=i(xn);Wa=r(Kf,"STRONG",{});var Xf=i(Wa);bd=a(Xf,"Use case 2: document image classification (training, inference) + token classification (inference), apply_ocr=False"),Xf.forEach(t),Kf.forEach(t),Er=m(o),fe=r(o,"P",{});var ea=i(fe);Ld=a(ea,"In case one wants to do OCR themselves, one can initialize the feature extractor with "),Ba=r(ea,"CODE",{});var Yf=i(Ba);wd=a(Yf,"apply_ocr"),Yf.forEach(t),kd=a(ea,` set to
...
perform OCR yourself, you can provide your own words and (normalized) bounding boxes to the processor.`),dg.forEach(t),Or=m(o),y(ot.$$.fragment,o),Nr=m(o),$e=r(o,"H2",{class:!0});var pi=i($e);Ge=r(pi,"A",{id:!0,class:!0,href:!0});var ug=i(Ge);Ja=r(ug,"SPAN",{});var mg=i(Ja);y(tt.$$.fragment,mg),mg.forEach(t),ug.forEach(t),Sd=m(pi),es=r(pi,"SPAN",{});var pg=i(es);Rd=a(pg,"LayoutLMv2Config"),pg.forEach(t),pi.forEach(t),Sr=m(o),K=r(o,"DIV",{class:!0});var fo=i(K);y(nt.$$.fragment,fo),Ud=m(fo),Ee=r(fo,"P",{});var oa=i(Ee);Wd=a(oa,"This is the configuration class to store the configuration of a "),Fn=r(oa,"A",{href:!0});var hg=i(Fn);Bd=a(hg,"LayoutLMv2Model"),hg.forEach(t),Vd=a(oa,`. It is used to instantiate an
LayoutLMv2 model according to the specified arguments, defining the model architecture. Instantiating a
configuration with the defaults will yield a similar configuration to that of the LayoutLMv2
...
of the main methods. Users should refer to this superclass for more information regarding those methods.`),fi.forEach(t),cu=m(go),ge=r(go,"DIV",{class:!0});var na=i(ge);y(lt.$$.fragment,na),du=m(na),ss=r(na,"P",{});var kg=i(ss);uu=a(kg,"Main method to prepare for the model one or several image(s)."),kg.forEach(t),mu=m(na),y(Xe.$$.fragment,na),na.forEach(t),go.forEach(t),Wr=m(o),qe=r(o,"H2",{class:!0});var gi=i(qe);Ye=r(gi,"A",{id:!0,class:!0,href:!0});var xg=i(Ye);rs=r(xg,"SPAN",{});var Tg=i(rs);y(ct.$$.fragment,Tg),Tg.forEach(t),xg.forEach(t),pu=m(gi),is=r(gi,"SPAN",{});var Mg=i(is);hu=a(Mg,"LayoutLMv2Tokenizer"),Mg.forEach(t),gi.forEach(t),Br=m(o),O=r(o,"DIV",{class:!0});var re=i(O);y(dt.$$.fragment,re),fu=m(re),N=r(re,"P",{});var Q=i(N);gu=a(Q,"Construct a LayoutLMv2 tokenizer. Based on WordPiece. "),jn=r(Q,"A",{href:!0});var $g=i(jn);_u=a($g,"LayoutLMv2Tokenizer"),$g.forEach(t),vu=a(Q,` can be used to turn words, word-level
...
sequences with word-level normalized bounding boxes and optional labels.`),Ug.forEach(t),wi.forEach(t),_o.forEach(t),Gr=m(o),je=r(o,"H2",{class:!0});var ki=i(je);oo=r(ki,"A",{id:!0,class:!0,href:!0});var Wg=i(oo);vs=r(Wg,"SPAN",{});var Bg=i(vs);y(yt.$$.fragment,Bg),Bg.forEach(t),Wg.forEach(t),Ju=m(ki),ys=r(ki,"SPAN",{});var Vg=i(ys);em=a(Vg,"LayoutLMv2Processor"),Vg.forEach(t),ki.forEach(t),Hr=m(o),U=r(o,"DIV",{class:!0});var we=i(U);y(bt.$$.fragment,we),om=m(we),bs=r(we,"P",{});var Qg=i(bs);tm=a(Qg,`Constructs a LayoutLMv2 processor which combines a LayoutLMv2 feature extractor and a LayoutLMv2 tokenizer into a
...
`),Wn=r(C,"A",{href:!0});var Xg=i(Wn);mm=a(Xg,"LayoutLMv2TokenizerFast"),Xg.forEach(t),pm=a(C,", which turns the words and bounding boxes into token-level "),Ls=r(C,"CODE",{});var Yg=i(Ls);hm=a(Yg,"input_ids"),Yg.forEach(t),fm=a(C,`,
...
`),Bn=r(F,"A",{href:!0});var s_=i(Bn);Cm=a(s_,"LayoutLMv2FeatureExtractor"),s_.forEach(t),Im=a(F," was initialized with "),zs=r(F,"CODE",{});var r_=i(zs);Am=a(r_,"apply_ocr"),r_.forEach(t),Dm=a(F," set to "),Fs=r(F,"CODE",{});var i_=i(Fs);Om=a(i_,"True"),i_.forEach(t),Nm=a(F,`, it passes the obtained words and
...
together with resized `),Ps=r(F,"CODE",{});var c_=i(Ps);Wm=a(c_,"images"),c_.forEach(t),Bm=a(F,". In case "),Vn=r(F,"A",{href:!0});var d_=i(Vn);Vm=a(d_,"LayoutLMv2FeatureExtractor"),d_.forEach(t),Qm=a(F," was initialized with "),js=r(F,"CODE",{});var u_=i(js);Gm=a(u_,"apply_ocr"),u_.forEach(t),Hm=a(F,` set to
