...
documentation from `),bt=n("a"),qn=s("PretrainedConfig"),Pn=s(" for more information."),On=h(),x(re.$$.fragment),vo=h(),G=n("h2"),se=n("a"),St=n("span"),x(Oe.$$.fragment),Mn=h(),Rt=n("span"),An=s("ConditionalDetrFeatureExtractor"),xo=h(),$=n("div"),x(Me.$$.fragment),In=h(),Wt=n("p"),Ln=s("Constructs a Conditional DETR feature extractor."),Nn=h(),Ae=n("p"),Sn=s("This feature extractor inherits from "),vt=n("a"),Rn=s("FeatureExtractionMixin"),Wn=s(` which contains most of the main methods. Users
should refer to this superclass for more information regarding those methods.`),Hn=h(),N=n("div"),x(Ie.$$.fragment),Un=h(),Ht=n("p"),Vn=s(`Main method to prepare for the model one or several image(s) and optional annotations. Images are by default
...
documentation from `),bt=a(zt,"A",{href:!0});var Ar=r(bt);qn=i(Ar,"PretrainedConfig"),Ar.forEach(o),Pn=i(zt," for more information."),zt.forEach(o),On=p(we),w(re.$$.fragment,we),we.forEach(o),vo=p(t),G=a(t,"H2",{class:!0});var qo=r(G);se=a(qo,"A",{id:!0,class:!0,href:!0});var Ir=r(se);St=a(Ir,"SPAN",{});var Lr=r(St);w(Oe.$$.fragment,Lr),Lr.forEach(o),Ir.forEach(o),Mn=p(qo),Rt=a(qo,"SPAN",{});var Nr=r(Rt);An=i(Nr,"ConditionalDetrFeatureExtractor"),Nr.forEach(o),qo.forEach(o),xo=p(t),$=a(t,"DIV",{class:!0});var E=r($);w(Me.$$.fragment,E),In=p(E),Wt=a(E,"P",{});var Sr=r(Wt);Ln=i(Sr,"Constructs a Conditional DETR feature extractor."),Sr.forEach(o),Nn=p(E),Ae=a(E,"P",{});var Po=r(Ae);Sn=i(Po,"This feature extractor inherits from "),vt=a(Po,"A",{href:!0});var Rr=r(vt);Rn=i(Rr,"FeatureExtractionMixin"),Rr.forEach(o),Wn=i(Po,` which contains most of the main methods. Users
should refer to this superclass for more information regarding those methods.`),Po.forEach(o),Hn=p(E),N=a(E,"DIV",{class:!0});var qt=r(N);w(Ie.$$.fragment,qt),Un=p(qt),Ht=a(qt,"P",{});var Wr=r(Ht);Vn=i(Wr,`Main method to prepare for the model one or several image(s) and optional annotations. Images are by default
padded up to the largest image in a batch, and a pixel mask is created that indicates which pixels are
real/which are padding.`),Wr.forEach(o),Bn=p(qt),w(ie.$$.fragment,qt),qt.forEach(o),Gn=p(E),de=a(E,"DIV",{class:!0});var Oo=r(de);w(Le.$$.fragment,Oo),Yn=p(Oo),Ne=a(Oo,"P",{});var Mo=r(Ne);Zn=i(Mo,"Pad images up to the largest image in a batch and create a corresponding "),Ut=a(Mo,"CODE",{});var Hr=r(Ut);Jn=i(Hr,"pixel_mask"),Hr.forEach(o),Xn=i(Mo,"."),Mo.forEach(o),Oo.forEach(o),Kn=p(E),le=a(E,"DIV",{class:!0});var Ao=r(le);w(Se.$$.fragment,Ao),Qn=p(Ao),Re=a(Ao,"P",{});var Io=r(Re);ea=i(Io,"Converts the output of "),xt=a(Io,"A",{href:!0});var Ur=r(xt);ta=i(Ur,"ConditionalDetrForObjectDetection"),Ur.forEach(o),oa=i(Io,` into the format expected by the COCO api. Only
supports PyTorch.`),Io.forEach(o),Ao.forEach(o),na=p(E),ce=a(E,"DIV",{class:!0});var Lo=r(ce);w(We.$$.fragment,Lo),aa=p(Lo),He=a(Lo,"P",{});var No=r(He);ra=i(No,"Converts the output of "),wt=a(No,"A",{href:!0});var Vr=r(wt);sa=i(Vr,"ConditionalDetrForSegmentation"),Vr.forEach(o),ia=i(No,` into image segmentation predictions. Only supports
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Uo.forEach(o),Ta=p(S),M=a(S,"DIV",{class:!0});var Ce=r(M);w(Xe.$$.fragment,Ce),$a=p(Ce),Z=a(Ce,"P",{});var Pt=r(Z);ja=i(Pt,"The "),yt=a(Pt,"A",{href:!0});var Qr=r(yt);Ea=i(Qr,"ConditionalDetrModel"),Qr.forEach(o),Fa=i(Pt," forward method, overrides the "),Yt=a(Pt,"CODE",{});var es=r(Yt);ka=i(es,"__call__"),es.forEach(o),za=i(Pt," special method."),Pt.forEach(o),qa=p(Ce),w(me.$$.fragment,Ce),Pa=p(Ce),w(fe.$$.fragment,Ce),Ce.forEach(o),S.forEach(o),Do=p(t),J=a(t,"H2",{class:!0});var Vo=r(J);ue=a(Vo,"A",{id:!0,class:!0,href:!0});var ts=r(ue);Zt=a(ts,"SPAN",{});var os=r(Zt);w(Ke.$$.fragment,os),os.forEach(o),ts.forEach(o),Oa=p(Vo),Jt=a(Vo,"SPAN",{});var ns=r(Jt);Ma=i(ns,"ConditionalDetrForObjectDetection"),ns.forEach(o),Vo.forEach(o),yo=p(t),k=a(t,"DIV",{class:!0});var R=r(k);w(Qe.$$.fragment,R),Aa=p(R),Xt=a(R,"P",{});var as=r(Xt);Ia=i(as,`CONDITIONAL_DETR Model (consisting of a backbone and encoder-decoder Transformer) with object detection heads on
