...
`),U=s(se,"CODE",{});var De=r(U);le=i(De,'model({"input_ids": input_ids})'),De.forEach(t),se.forEach(t),j.forEach(t)},m(h,M){u(h,p,M),e(p,F),u(h,g,M),u(h,v,M),e(v,T),e(T,_),e(v,m),e(v,B),e(B,de),u(h,V,M),u(h,E,M),e(E,G),e(E,I),e(I,X),e(E,ce),e(E,S),e(S,pe),e(E,re),u(h,N,M),u(h,q,M),e(q,Y),u(h,J,M),u(h,x,M),e(x,z),e(z,he),e(z,W),e(W,oe),e(z,ue),e(z,R),e(R,ae),e(x,ee),e(x,A),e(A,ie),e(A,L),e(L,ne),e(x,me),e(x,P),e(P,te),e(P,U),e(U,le)},d(h){h&&t(p),h&&t(g),h&&t(v),h&&t(V),h&&t(E),h&&t(N),h&&t(q),h&&t(J),h&&t(x)}}}function g2(C){let p,F,g,v,T;return{c(){p=n("p"),F=a("Although the recipe for forward pass needs to be defined within this function, one should call the "),g=n("code"),v=a("Module"),T=a(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(_){p=s(_,"P",{});var m=r(p);F=i(m,"Although the recipe for forward pass needs to be defined within this function, one should call the "),g=s(m,"CODE",{});var B=r(g);v=i(B,"Module"),B.forEach(t),T=i(m,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),m.forEach(t)},m(_,m){u(_,p,m),e(p,F),e(p,g),e(g,v),e(p,T)},d(_){_&&t(p)}}}function _2(C){let p,F,g,v,T,_,m,B,de,V,E,G,I,X,ce,S,pe,re,N,q,Y,J,x,z,he,W,oe,ue,R,ae,ee,A,ie,L,ne,me,P,te,U,le;return{c(){p=n("p"),F=a("TF 2.0 models accepts two formats as inputs:"),g=l(),v=n("ul"),T=n("li"),_=a("having all inputs as keyword arguments (like PyTorch models), or"),m=l(),B=n("li"),de=a("having all inputs as a list, tuple or dict in the first positional arguments."),V=l(),E=n("p"),G=a("This second option is useful when using "),I=n("code"),X=a("tf.keras.Model.fit"),ce=a(` method which currently requires having all the
tensors in the first argument of the model call function: `),S=n("code"),pe=a("model(inputs)"),re=a("."),N=l(),q=n("p"),Y=a(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),J=l(),x=n("ul"),z=n("li"),he=a("a single Tensor with "),W=n("code"),oe=a("input_ids"),ue=a(" only and nothing else: "),R=n("code"),ae=a("model(inputs_ids)"),ee=l(),A=n("li"),ie=a(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),L=n("code"),ne=a("model([input_ids, attention_mask])"),me=l(),P=n("li"),te=a(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),U=n("code"),le=a('model({"input_ids": input_ids})')},l(h){p=s(h,"P",{});var M=r(p);F=i(M,"TF 2.0 models accepts two formats as inputs:"),M.forEach(t),g=d(h),v=s(h,"UL",{});var K=r(v);T=s(K,"LI",{});var ge=r(T);_=i(ge,"having all inputs as keyword arguments (like PyTorch models), or"),ge.forEach(t),m=d(K),B=s(K,"LI",{});var Te=r(B);de=i(Te,"having all inputs as a list, tuple or dict in the first positional arguments."),Te.forEach(t),K.forEach(t),V=d(h),E=s(h,"P",{});var O=r(E);G=i(O,"This second option is useful when using "),I=s(O,"CODE",{});var _e=r(I);X=i(_e,"tf.keras.Model.fit"),_e.forEach(t),ce=i(O,` method which currently requires having all the
...
first positional argument :`),ke.forEach(t),J=d(h),x=s(h,"UL",{});var j=r(x);z=s(j,"LI",{});var H=r(z);he=i(H,"a single Tensor with "),W=s(H,"CODE",{});var we=r(W);oe=i(we,"input_ids"),we.forEach(t),ue=i(H," only and nothing else: "),R=s(H,"CODE",{});var ye=r(R);ae=i(ye,"model(inputs_ids)"),ye.forEach(t),H.forEach(t),ee=d(j),A=s(j,"LI",{});var Z=r(A);ie=i(Z,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),L=s(Z,"CODE",{});var $e=r(L);ne=i($e,"model([input_ids, attention_mask])"),$e.forEach(t),Z.forEach(t),me=d(j),P=s(j,"LI",{});var se=r(P);te=i(se,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),U=s(se,"CODE",{});var De=r(U);le=i(De,'model({"input_ids": input_ids})'),De.forEach(t),se.forEach(t),j.forEach(t)},m(h,M){u(h,p,M),e(p,F),u(h,g,M),u(h,v,M),e(v,T),e(T,_),e(v,m),e(v,B),e(B,de),u(h,V,M),u(h,E,M),e(E,G),e(E,I),e(I,X),e(E,ce),e(E,S),e(S,pe),e(E,re),u(h,N,M),u(h,q,M),e(q,Y),u(h,J,M),u(h,x,M),e(x,z),e(z,he),e(z,W),e(W,oe),e(z,ue),e(z,R),e(R,ae),e(x,ee),e(x,A),e(A,ie),e(A,L),e(L,ne),e(x,me),e(x,P),e(P,te),e(P,U),e(U,le)},d(h){h&&t(p),h&&t(g),h&&t(v),h&&t(V),h&&t(E),h&&t(N),h&&t(q),h&&t(J),h&&t(x)}}}function v2(C){let p,F,g,v,T;return{c(){p=n("p"),F=a("Although the recipe for forward pass needs to be defined within this function, one should call the "),g=n("code"),v=a("Module"),T=a(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(_){p=s(_,"P",{});var m=r(p);F=i(m,"Although the recipe for forward pass needs to be defined within this function, one should call the "),g=s(m,"CODE",{});var B=r(g);v=i(B,"Module"),B.forEach(t),T=i(m,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),m.forEach(t)},m(_,m){u(_,p,m),e(p,F),e(p,g),e(g,v),e(p,T)},d(_){_&&t(p)}}}function T2(C){let p,F,g,v,T,_,m,B,de,V,E,G,I,X,ce,S,pe,re,N,q,Y,J,x,z,he,W,oe,ue,R,ae,ee,A,ie,L,ne,me,P,te,U,le;return{c(){p=n("p"),F=a("TF 2.0 models accepts two formats as inputs:"),g=l(),v=n("ul"),T=n("li"),_=a("having all inputs as keyword arguments (like PyTorch models), or"),m=l(),B=n("li"),de=a("having all inputs as a list, tuple or dict in the first positional arguments."),V=l(),E=n("p"),G=a("This second option is useful when using "),I=n("code"),X=a("tf.keras.Model.fit"),ce=a(` method which currently requires having all the
tensors in the first argument of the model call function: `),S=n("code"),pe=a("model(inputs)"),re=a("."),N=l(),q=n("p"),Y=a(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),J=l(),x=n("ul"),z=n("li"),he=a("a single Tensor with "),W=n("code"),oe=a("input_ids"),ue=a(" only and nothing else: "),R=n("code"),ae=a("model(inputs_ids)"),ee=l(),A=n("li"),ie=a(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),L=n("code"),ne=a("model([input_ids, attention_mask])"),me=l(),P=n("li"),te=a(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),U=n("code"),le=a('model({"input_ids": input_ids})')},l(h){p=s(h,"P",{});var M=r(p);F=i(M,"TF 2.0 models accepts two formats as inputs:"),M.forEach(t),g=d(h),v=s(h,"UL",{});var K=r(v);T=s(K,"LI",{});var ge=r(T);_=i(ge,"having all inputs as keyword arguments (like PyTorch models), or"),ge.forEach(t),m=d(K),B=s(K,"LI",{});var Te=r(B);de=i(Te,"having all inputs as a list, tuple or dict in the first positional arguments."),Te.forEach(t),K.forEach(t),V=d(h),E=s(h,"P",{});var O=r(E);G=i(O,"This second option is useful when using "),I=s(O,"CODE",{});var _e=r(I);X=i(_e,"tf.keras.Model.fit"),_e.forEach(t),ce=i(O,` method which currently requires having all the
...
the latter silently ignores them.`)},l(_){p=s(_,"P",{});var m=r(p);F=i(m,"Although the recipe for forward pass needs to be defined within this function, one should call the "),g=s(m,"CODE",{});var B=r(g);v=i(B,"Module"),B.forEach(t),T=i(m,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),m.forEach(t)},m(_,m){u(_,p,m),e(p,F),e(p,g),e(g,v),e(p,T)},d(_){_&&t(p)}}}function k2(C){let p,F,g,v,T,_,m,B,de,V,E,G,I,X,ce,S,pe,re,N,q,Y,J,x,z,he,W,oe,ue,R,ae,ee,A,ie,L,ne,me,P,te,U,le;return{c(){p=n("p"),F=a("TF 2.0 models accepts two formats as inputs:"),g=l(),v=n("ul"),T=n("li"),_=a("having all inputs as keyword arguments (like PyTorch models), or"),m=l(),B=n("li"),de=a("having all inputs as a list, tuple or dict in the first positional arguments."),V=l(),E=n("p"),G=a("This second option is useful when using "),I=n("code"),X=a("tf.keras.Model.fit"),ce=a(` method which currently requires having all the
tensors in the first argument of the model call function: `),S=n("code"),pe=a("model(inputs)"),re=a("."),N=l(),q=n("p"),Y=a(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),J=l(),x=n("ul"),z=n("li"),he=a("a single Tensor with "),W=n("code"),oe=a("input_ids"),ue=a(" only and nothing else: "),R=n("code"),ae=a("model(inputs_ids)"),ee=l(),A=n("li"),ie=a(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),L=n("code"),ne=a("model([input_ids, attention_mask])"),me=l(),P=n("li"),te=a(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),U=n("code"),le=a('model({"input_ids": input_ids})')},l(h){p=s(h,"P",{});var M=r(p);F=i(M,"TF 2.0 models accepts two formats as inputs:"),M.forEach(t),g=d(h),v=s(h,"UL",{});var K=r(v);T=s(K,"LI",{});var ge=r(T);_=i(ge,"having all inputs as keyword arguments (like PyTorch models), or"),ge.forEach(t),m=d(K),B=s(K,"LI",{});var Te=r(B);de=i(Te,"having all inputs as a list, tuple or dict in the first positional arguments."),Te.forEach(t),K.forEach(t),V=d(h),E=s(h,"P",{});var O=r(E);G=i(O,"This second option is useful when using "),I=s(O,"CODE",{});var _e=r(I);X=i(_e,"tf.keras.Model.fit"),_e.forEach(t),ce=i(O,` method which currently requires having all the
...
first positional argument :`),ke.forEach(t),J=d(h),x=s(h,"UL",{});var j=r(x);z=s(j,"LI",{});var H=r(z);he=i(H,"a single Tensor with "),W=s(H,"CODE",{});var we=r(W);oe=i(we,"input_ids"),we.forEach(t),ue=i(H," only and nothing else: "),R=s(H,"CODE",{});var ye=r(R);ae=i(ye,"model(inputs_ids)"),ye.forEach(t),H.forEach(t),ee=d(j),A=s(j,"LI",{});var Z=r(A);ie=i(Z,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),L=s(Z,"CODE",{});var $e=r(L);ne=i($e,"model([input_ids, attention_mask])"),$e.forEach(t),Z.forEach(t),me=d(j),P=s(j,"LI",{});var se=r(P);te=i(se,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),U=s(se,"CODE",{});var De=r(U);le=i(De,'model({"input_ids": input_ids})'),De.forEach(t),se.forEach(t),j.forEach(t)},m(h,M){u(h,p,M),e(p,F),u(h,g,M),u(h,v,M),e(v,T),e(T,_),e(v,m),e(v,B),e(B,de),u(h,V,M),u(h,E,M),e(E,G),e(E,I),e(I,X),e(E,ce),e(E,S),e(S,pe),e(E,re),u(h,N,M),u(h,q,M),e(q,Y),u(h,J,M),u(h,x,M),e(x,z),e(z,he),e(z,W),e(W,oe),e(z,ue),e(z,R),e(R,ae),e(x,ee),e(x,A),e(A,ie),e(A,L),e(L,ne),e(x,me),e(x,P),e(P,te),e(P,U),e(U,le)},d(h){h&&t(p),h&&t(g),h&&t(v),h&&t(V),h&&t(E),h&&t(N),h&&t(q),h&&t(J),h&&t(x)}}}function w2(C){let p,F,g,v,T;return{c(){p=n("p"),F=a("Although the recipe for forward pass needs to be defined within this function, one should call the "),g=n("code"),v=a("Module"),T=a(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(_){p=s(_,"P",{});var m=r(p);F=i(m,"Although the recipe for forward pass needs to be defined within this function, one should call the "),g=s(m,"CODE",{});var B=r(g);v=i(B,"Module"),B.forEach(t),T=i(m,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),m.forEach(t)},m(_,m){u(_,p,m),e(p,F),e(p,g),e(g,v),e(p,T)},d(_){_&&t(p)}}}function y2(C){let p,F,g,v,T,_,m,B,de,V,E,G,I,X,ce,S,pe,re,N,q,Y,J,x,z,he,W,oe,ue,R,ae,ee,A,ie,L,ne,me,P,te,U,le;return{c(){p=n("p"),F=a("TF 2.0 models accepts two formats as inputs:"),g=l(),v=n("ul"),T=n("li"),_=a("having all inputs as keyword arguments (like PyTorch models), or"),m=l(),B=n("li"),de=a("having all inputs as a list, tuple or dict in the first positional arguments."),V=l(),E=n("p"),G=a("This second option is useful when using "),I=n("code"),X=a("tf.keras.Model.fit"),ce=a(` method which currently requires having all the
tensors in the first argument of the model call function: `),S=n("code"),pe=a("model(inputs)"),re=a("."),N=l(),q=n("p"),Y=a(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),J=l(),x=n("ul"),z=n("li"),he=a("a single Tensor with "),W=n("code"),oe=a("input_ids"),ue=a(" only and nothing else: "),R=n("code"),ae=a("model(inputs_ids)"),ee=l(),A=n("li"),ie=a(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),L=n("code"),ne=a("model([input_ids, attention_mask])"),me=l(),P=n("li"),te=a(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),U=n("code"),le=a('model({"input_ids": input_ids})')},l(h){p=s(h,"P",{});var M=r(p);F=i(M,"TF 2.0 models accepts two formats as inputs:"),M.forEach(t),g=d(h),v=s(h,"UL",{});var K=r(v);T=s(K,"LI",{});var ge=r(T);_=i(ge,"having all inputs as keyword arguments (like PyTorch models), or"),ge.forEach(t),m=d(K),B=s(K,"LI",{});var Te=r(B);de=i(Te,"having all inputs as a list, tuple or dict in the first positional arguments."),Te.forEach(t),K.forEach(t),V=d(h),E=s(h,"P",{});var O=r(E);G=i(O,"This second option is useful when using "),I=s(O,"CODE",{});var _e=r(I);X=i(_e,"tf.keras.Model.fit"),_e.forEach(t),ce=i(O,` method which currently requires having all the
...
first positional argument :`),ke.forEach(t),J=d(h),x=s(h,"UL",{});var j=r(x);z=s(j,"LI",{});var H=r(z);he=i(H,"a single Tensor with "),W=s(H,"CODE",{});var we=r(W);oe=i(we,"input_ids"),we.forEach(t),ue=i(H," only and nothing else: "),R=s(H,"CODE",{});var ye=r(R);ae=i(ye,"model(inputs_ids)"),ye.forEach(t),H.forEach(t),ee=d(j),A=s(j,"LI",{});var Z=r(A);ie=i(Z,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),L=s(Z,"CODE",{});var $e=r(L);ne=i($e,"model([input_ids, attention_mask])"),$e.forEach(t),Z.forEach(t),me=d(j),P=s(j,"LI",{});var se=r(P);te=i(se,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),U=s(se,"CODE",{});var De=r(U);le=i(De,'model({"input_ids": input_ids})'),De.forEach(t),se.forEach(t),j.forEach(t)},m(h,M){u(h,p,M),e(p,F),u(h,g,M),u(h,v,M),e(v,T),e(T,_),e(v,m),e(v,B),e(B,de),u(h,V,M),u(h,E,M),e(E,G),e(E,I),e(I,X),e(E,ce),e(E,S),e(S,pe),e(E,re),u(h,N,M),u(h,q,M),e(q,Y),u(h,J,M),u(h,x,M),e(x,z),e(z,he),e(z,W),e(W,oe),e(z,ue),e(z,R),e(R,ae),e(x,ee),e(x,A),e(A,ie),e(A,L),e(L,ne),e(x,me),e(x,P),e(P,te),e(P,U),e(U,le)},d(h){h&&t(p),h&&t(g),h&&t(v),h&&t(V),h&&t(E),h&&t(N),h&&t(q),h&&t(J),h&&t(x)}}}function $2(C){let p,F,g,v,T;return{c(){p=n("p"),F=a("Although the recipe for forward pass needs to be defined within this function, one should call the "),g=n("code"),v=a("Module"),T=a(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(_){p=s(_,"P",{});var m=r(p);F=i(m,"Although the recipe for forward pass needs to be defined within this function, one should call the "),g=s(m,"CODE",{});var B=r(g);v=i(B,"Module"),B.forEach(t),T=i(m,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),m.forEach(t)},m(_,m){u(_,p,m),e(p,F),e(p,g),e(g,v),e(p,T)},d(_){_&&t(p)}}}function D2(C){let p,F,g,v,T,_,m,B,de,V,E,G,I,X,ce,S,pe,re,N,q,Y,J,x,z,he,W,oe,ue,R,ae,ee,A,ie,L,ne,me,P,te,U,le;return{c(){p=n("p"),F=a("TF 2.0 models accepts two formats as inputs:"),g=l(),v=n("ul"),T=n("li"),_=a("having all inputs as keyword arguments (like PyTorch models), or"),m=l(),B=n("li"),de=a("having all inputs as a list, tuple or dict in the first positional arguments."),V=l(),E=n("p"),G=a("This second option is useful when using "),I=n("code"),X=a("tf.keras.Model.fit"),ce=a(` method which currently requires having all the
tensors in the first argument of the model call function: `),S=n("code"),pe=a("model(inputs)"),re=a("."),N=l(),q=n("p"),Y=a(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),J=l(),x=n("ul"),z=n("li"),he=a("a single Tensor with "),W=n("code"),oe=a("input_ids"),ue=a(" only and nothing else: "),R=n("code"),ae=a("model(inputs_ids)"),ee=l(),A=n("li"),ie=a(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),L=n("code"),ne=a("model([input_ids, attention_mask])"),me=l(),P=n("li"),te=a(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),U=n("code"),le=a('model({"input_ids": input_ids})')},l(h){p=s(h,"P",{});var M=r(p);F=i(M,"TF 2.0 models accepts two formats as inputs:"),M.forEach(t),g=d(h),v=s(h,"UL",{});var K=r(v);T=s(K,"LI",{});var ge=r(T);_=i(ge,"having all inputs as keyword arguments (like PyTorch models), or"),ge.forEach(t),m=d(K),B=s(K,"LI",{});var Te=r(B);de=i(Te,"having all inputs as a list, tuple or dict in the first positional arguments."),Te.forEach(t),K.forEach(t),V=d(h),E=s(h,"P",{});var O=r(E);G=i(O,"This second option is useful when using "),I=s(O,"CODE",{});var _e=r(I);X=i(_e,"tf.keras.Model.fit"),_e.forEach(t),ce=i(O,` method which currently requires having all the
...
first positional argument :`),ke.forEach(t),J=d(h),x=s(h,"UL",{});var j=r(x);z=s(j,"LI",{});var H=r(z);he=i(H,"a single Tensor with "),W=s(H,"CODE",{});var we=r(W);oe=i(we,"input_ids"),we.forEach(t),ue=i(H," only and nothing else: "),R=s(H,"CODE",{});var ye=r(R);ae=i(ye,"model(inputs_ids)"),ye.forEach(t),H.forEach(t),ee=d(j),A=s(j,"LI",{});var Z=r(A);ie=i(Z,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),L=s(Z,"CODE",{});var $e=r(L);ne=i($e,"model([input_ids, attention_mask])"),$e.forEach(t),Z.forEach(t),me=d(j),P=s(j,"LI",{});var se=r(P);te=i(se,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),U=s(se,"CODE",{});var De=r(U);le=i(De,'model({"input_ids": input_ids})'),De.forEach(t),se.forEach(t),j.forEach(t)},m(h,M){u(h,p,M),e(p,F),u(h,g,M),u(h,v,M),e(v,T),e(T,_),e(v,m),e(v,B),e(B,de),u(h,V,M),u(h,E,M),e(E,G),e(E,I),e(I,X),e(E,ce),e(E,S),e(S,pe),e(E,re),u(h,N,M),u(h,q,M),e(q,Y),u(h,J,M),u(h,x,M),e(x,z),e(z,he),e(z,W),e(W,oe),e(z,ue),e(z,R),e(R,ae),e(x,ee),e(x,A),e(A,ie),e(A,L),e(L,ne),e(x,me),e(x,P),e(P,te),e(P,U),e(U,le)},d(h){h&&t(p),h&&t(g),h&&t(v),h&&t(V),h&&t(E),h&&t(N),h&&t(q),h&&t(J),h&&t(x)}}}function F2(C){let p,F,g,v,T;return{c(){p=n("p"),F=a("Although the recipe for forward pass needs to be defined within this function, one should call the "),g=n("code"),v=a("Module"),T=a(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(_){p=s(_,"P",{});var m=r(p);F=i(m,"Although the recipe for forward pass needs to be defined within this function, one should call the "),g=s(m,"CODE",{});var B=r(g);v=i(B,"Module"),B.forEach(t),T=i(m,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),m.forEach(t)},m(_,m){u(_,p,m),e(p,F),e(p,g),e(g,v),e(p,T)},d(_){_&&t(p)}}}function B2(C){let p,F,g,v,T;return{c(){p=n("p"),F=a("Although the recipe for forward pass needs to be defined within this function, one should call the "),g=n("code"),v=a("Module"),T=a(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(_){p=s(_,"P",{});var m=r(p);F=i(m,"Although the recipe for forward pass needs to be defined within this function, one should call the "),g=s(m,"CODE",{});var B=r(g);v=i(B,"Module"),B.forEach(t),T=i(m,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),m.forEach(t)},m(_,m){u(_,p,m),e(p,F),e(p,g),e(g,v),e(p,T)},d(_){_&&t(p)}}}function M2(C){let p,F,g,v,T;return{c(){p=n("p"),F=a("Although the recipe for forward pass needs to be defined within this function, one should call the "),g=n("code"),v=a("Module"),T=a(`
...
`}}),on=new fe({props:{$$slots:{default:[d2]},$$scope:{ctx:C}}}),Ts=new Fe({props:{code:`from transformers import DistilBertTokenizer, DistilBertModel
import torch
...
`}}),sn=new fe({props:{$$slots:{default:[c2]},$$scope:{ctx:C}}}),Bs=new Fe({props:{code:`from transformers import DistilBertTokenizer, DistilBertForMaskedLM
import torch
...
`}}),an=new fe({props:{$$slots:{default:[p2]},$$scope:{ctx:C}}}),Ps=new Fe({props:{code:`import torch
...
`}}),dn=new fe({props:{$$slots:{default:[h2]},$$scope:{ctx:C}}}),Ws=new Fe({props:{code:`from transformers import DistilBertTokenizer, DistilBertForMultipleChoice
import torch
...
`}}),pn=new fe({props:{$$slots:{default:[u2]},$$scope:{ctx:C}}}),Ks=new Fe({props:{code:`from transformers import DistilBertTokenizer, DistilBertForTokenClassification
import torch
...
`}}),un=new fe({props:{$$slots:{default:[m2]},$$scope:{ctx:C}}}),or=new Fe({props:{code:`from transformers import DistilBertTokenizer, DistilBertForQuestionAnswering
import torch
...
`}}),gn=new fe({props:{$$slots:{default:[g2]},$$scope:{ctx:C}}}),dr=new Fe({props:{code:`from transformers import DistilBertTokenizer, TFDistilBertModel
...
`}}),Tn=new fe({props:{$$slots:{default:[v2]},$$scope:{ctx:C}}}),_r=new Fe({props:{code:`from transformers import DistilBertTokenizer, TFDistilBertForMaskedLM
import tensorflow as tf
...
`}}),wn=new fe({props:{$$slots:{default:[b2]},$$scope:{ctx:C}}}),$r=new Fe({props:{code:`from transformers import DistilBertTokenizer, TFDistilBertForSequenceClassification
import tensorflow as tf
...
`}}),Dn=new fe({props:{$$slots:{default:[w2]},$$scope:{ctx:C}}}),zr=new Fe({props:{code:`from transformers import DistilBertTokenizer, TFDistilBertForMultipleChoice
import tensorflow as tf
...
`}}),Mn=new fe({props:{$$slots:{default:[$2]},$$scope:{ctx:C}}}),Nr=new Fe({props:{code:`from transformers import DistilBertTokenizer, TFDistilBertForTokenClassification
import tensorflow as tf
...
`}}),zn=new fe({props:{$$slots:{default:[F2]},$$scope:{ctx:C}}}),Hr=new Fe({props:{code:`from transformers import DistilBertTokenizer, TFDistilBertForQuestionAnswering
import tensorflow as tf
...
Whether or not to return a <a href="/docs/transformers/main/en/main_classes/output#transformers.file_utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}]}}),jn=new fe({props:{$$slots:{default:[B2]},$$scope:{ctx:C}}}),oa=new Fe({props:{code:`from transformers import DistilBertTokenizer, FlaxDistilBertModel
...
`}}),qn=new fe({props:{$$slots:{default:[M2]},$$scope:{ctx:C}}}),ma=new Fe({props:{code:`from transformers import DistilBertTokenizer, FlaxDistilBertForMaskedLM
...
`}}),On=new fe({props:{$$slots:{default:[E2]},$$scope:{ctx:C}}}),Da=new Fe({props:{code:`from transformers import DistilBertTokenizer, FlaxDistilBertForSequenceClassification
...
`}}),Ln=new fe({props:{$$slots:{default:[x2]},$$scope:{ctx:C}}}),Aa=new Fe({props:{code:`from transformers import DistilBertTokenizer, FlaxDistilBertForMultipleChoice
...
`}}),Sn=new fe({props:{$$slots:{default:[z2]},$$scope:{ctx:C}}}),Va=new Fe({props:{code:`from transformers import DistilBertTokenizer, FlaxDistilBertForTokenClassification
...
`}}),Rn=new fe({props:{$$slots:{default:[C2]},$$scope:{ctx:C}}}),si=new Fe({props:{code:`from transformers import DistilBertTokenizer, FlaxDistilBertForQuestionAnswering
