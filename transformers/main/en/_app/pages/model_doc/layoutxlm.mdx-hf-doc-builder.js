...
data for the model.`),no=d(),G=a("p"),Qo=n("As LayoutXLM\u2019s architecture is equivalent to that of LayoutLMv2, one can refer to "),Ue=a("a"),en=n("LayoutLMv2\u2019s documentation page"),tn=n(" for all tips, code examples and notebooks."),ro=d(),F=a("p"),on=n("This model was contributed by "),de=a("a"),nn=n("nielsr"),rn=n(". The original code can be found "),ce=a("a"),an=n("here"),sn=n("."),ao=d(),W=a("h2"),H=a("a"),ft=a("span"),k(ue.$$.fragment),ln=d(),ht=a("span"),dn=n("LayoutXLMTokenizer"),so=d(),_=a("div"),k(me.$$.fragment),cn=d(),q=a("p"),un=n("Adapted from "),We=a("a"),mn=n("RobertaTokenizer"),pn=n(" and "),Re=a("a"),fn=n("XLNetTokenizer"),hn=n(`. Based on
...
adding special tokens. An XLM-RoBERTa sequence has the following format:`),Ga.forEach(o),Xn=c(it),ge=s(it,"UL",{});var yo=i(ge);je=s(yo,"LI",{});var ma=i(je);qn=r(ma,"single sequence: "),kt=s(ma,"CODE",{});var Ha=i(kt);En=r(Ha,"<s> X </s>"),Ha.forEach(o),ma.forEach(o),$n=c(yo),Ve=s(yo,"LI",{});var pa=i(Ve);Fn=r(pa,"pair of sequences: "),yt=s(pa,"CODE",{});var Ya=i(yt);Pn=r(Ya,"<s> A </s></s> B </s>"),Ya.forEach(o),pa.forEach(o),yo.forEach(o),it.forEach(o),Nn=c(x),J=s(x,"DIV",{class:!0});var Lo=i(J);y(ke.$$.fragment,Lo),Dn=c(Lo),ye=s(Lo,"P",{});var bo=i(ye);An=r(bo,`Retrieve sequence ids from a token list that has no special tokens added. This method is called when adding
