import{S as As,i as Is,s as Os,e as a,k as d,w as k,t as n,M as Ss,c as s,d as o,m as c,a as i,x as y,h as r,b as l,G as e,g as u,y as L,L as Cs,q as b,o as v,B as w,v as Us}from"../../chunks/vendor-hf-doc-builder.js";import{D as O}from"../../chunks/Docstring-hf-doc-builder.js";import{C as Ds}from"../../chunks/CodeBlock-hf-doc-builder.js";import{I as Vt}from"../../chunks/IconCopyLink-hf-doc-builder.js";function Ws(ga){let S,Gt,C,j,dt,ne,Mo,ct,Xo,Ht,U,V,mt,re,qo,ut,Eo,Yt,E,$o,ae,Fo,Po,se,No,Do,Jt,Fe,Ao,Zt,Pe,pt,Io,Kt,Ne,Oo,Qt,ie,eo,$,So,De,Co,Uo,Ae,Wo,Ro,to,le,oo,z,Bo,Ie,jo,Vo,Oe,Go,Ho,Se,Yo,Jo,Ce,Zo,Ko,no,G,Qo,Ue,en,tn,ro,F,on,de,nn,rn,ce,an,sn,ao,W,H,ft,me,ln,ht,dn,so,_,ue,cn,q,mn,We,un,pn,Re,fn,hn,pe,_n,gn,kn,fe,yn,Be,Ln,bn,vn,Y,he,wn,_t,xn,Tn,P,_e,zn,gt,Mn,Xn,ge,je,qn,kt,En,$n,Ve,Fn,yt,Pn,Nn,J,ke,Dn,ye,An,Lt,In,On,Sn,Z,Le,Cn,bt,Un,Wn,Ge,be,io,R,K,vt,ve,Rn,wt,Bn,lo,M,we,jn,X,Vn,xt,Gn,Hn,He,Yn,Jn,Ye,Zn,Kn,xe,Qn,er,tr,Te,or,Je,nr,rr,ar,Q,ze,sr,Tt,ir,co,B,ee,zt,Me,lr,Mt,dr,mo,T,Xe,cr,Xt,mr,ur,Ze,Ke,pr,fr,hr,h,_r,Qe,gr,kr,et,yr,Lr,tt,br,vr,qt,wr,xr,Et,Tr,zr,$t,Mr,Xr,Ft,qr,Er,Pt,$r,Fr,Nt,Pr,Nr,Dr,N,qe,Ar,p,Ir,Dt,Or,Sr,Ee,At,Cr,Ur,Wr,ot,Rr,Br,It,jr,Vr,Ot,Gr,Hr,$e,St,Yr,Jr,Zr,Ct,Kr,Qr,nt,ea,ta,Ut,oa,na,Wt,ra,aa,Rt,sa,ia,Bt,la,da,ca,jt,ma,uo;return ne=new Vt({}),re=new Vt({}),ie=new Ds({props:{code:`from transformers import LayoutLMv2Model
...
**kwargs &#x2014; passed to the <code>self.tokenize()</code> method`,name:"verbose"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/layoutxlm/tokenization_layoutxlm.py#L444",returnDescription:`
<p>A <a
...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/layoutxlm/tokenization_layoutxlm.py#L316",returnDescription:`
...
Whether or not the token list is already formatted with special tokens for the model.`,name:"already_has_special_tokens"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/layoutxlm/tokenization_layoutxlm.py#L342",returnDescription:`
...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/layoutxlm/tokenization_layoutxlm.py#L370",returnDescription:`
<p>List of zeros.</p>
`,returnType:`
<p><code>List[int]</code></p>
`}}),be=new O({props:{name:"save_vocabulary",anchor:"transformers.LayoutXLMTokenizer.save_vocabulary",parameters:[{name:"save_directory",val:": str"},{name:"filename_prefix",val:": typing.Optional[str] = None"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/layoutxlm/tokenization_layoutxlm.py#L427"}}),ve=new Vt({}),we=new O({props:{name:"class transformers.LayoutXLMTokenizerFast",anchor:"transformers.LayoutXLMTokenizerFast",parameters:[{name:"vocab_file",val:" = None"},{name:"tokenizer_file",val:" = None"},{name:"bos_token",val:" = '<s>'"},{name:"eos_token",val:" = '</s>'"},{name:"sep_token",val:" = '</s>'"},{name:"cls_token",val:" = '<s>'"},{name:"unk_token",val:" = '<unk>'"},{name:"pad_token",val:" = '<pad>'"},{name:"mask_token",val:" = '<mask>'"},{name:"cls_token_box",val:" = [0, 0, 0, 0]"},{name:"sep_token_box",val:" = [1000, 1000, 1000, 1000]"},{name:"pad_token_box",val:" = [0, 0, 0, 0]"},{name:"pad_token_label",val:" = -100"},{name:"only_label_first_subword",val:" = True"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.LayoutXLMTokenizerFast.vocab_file",description:`<strong>vocab_file</strong> (<code>str</code>) &#x2014;
...
Whether or not to print more information and warnings.
**kwargs &#x2014; passed to the <code>self.tokenize()</code> method`,name:"verbose"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/layoutxlm/tokenization_layoutxlm_fast.py#L269",returnDescription:`
<p>A <a
  href="/docs/transformers/main/en/main_classes/tokenizer#transformers.BatchEncoding"
>BatchEncoding</a> with the following fields:</p>
<ul>
...
data for the model.`),no=d(),G=a("p"),Qo=n("As LayoutXLM\u2019s architecture is equivalent to that of LayoutLMv2, one can refer to "),Ue=a("a"),en=n("LayoutLMv2\u2019s documentation page"),tn=n(" for all tips, code examples and notebooks."),ro=d(),F=a("p"),on=n("This model was contributed by "),de=a("a"),nn=n("nielsr"),rn=n(". The original code can be found "),ce=a("a"),an=n("here"),sn=n("."),ao=d(),W=a("h2"),H=a("a"),ft=a("span"),k(me.$$.fragment),ln=d(),ht=a("span"),dn=n("LayoutXLMTokenizer"),so=d(),_=a("div"),k(ue.$$.fragment),cn=d(),q=a("p"),mn=n("Adapted from "),We=a("a"),un=n("RobertaTokenizer"),pn=n(" and "),Re=a("a"),fn=n("XLNetTokenizer"),hn=n(`. Based on
...
adding special tokens. An XLM-RoBERTa sequence has the following format:`),Xn=d(),ge=a("ul"),je=a("li"),qn=n("single sequence: "),kt=a("code"),En=n("<s> X </s>"),$n=d(),Ve=a("li"),Fn=n("pair of sequences: "),yt=a("code"),Pn=n("<s> A </s></s> B </s>"),Nn=d(),J=a("div"),k(ke.$$.fragment),Dn=d(),ye=a("p"),An=n(`Retrieve sequence ids from a token list that has no special tokens added. This method is called when adding
...
sequences with word-level normalized bounding boxes and optional labels.`),co=d(),B=a("h2"),ee=a("a"),zt=a("span"),k(Me.$$.fragment),lr=d(),Mt=a("span"),dr=n("LayoutXLMProcessor"),mo=d(),T=a("div"),k(Xe.$$.fragment),cr=d(),Xt=a("p"),mr=n(`Constructs a LayoutXLM processor which combines a LayoutXLM feature extractor and a LayoutXLM tokenizer into a
single processor.`),ur=d(),Ze=a("p"),Ke=a("a"),pr=n("LayoutXLMProcessor"),fr=n(" offers all the functionalities you need to prepare data for the model."),hr=d(),h=a("p"),_r=n("It first uses "),Qe=a("a"),gr=n("LayoutLMv2FeatureExtractor"),kr=n(` to resize document images to a fixed size, and optionally applies OCR
to get words and normalized bounding boxes. These are then provided to `),et=a("a"),yr=n("LayoutXLMTokenizer"),Lr=n(` or
`),tt=a("a"),br=n("LayoutXLMTokenizerFast"),vr=n(", which turns the words and bounding boxes into token-level "),qt=a("code"),wr=n("input_ids"),xr=n(`,
`),Et=a("code"),Tr=n("attention_mask"),zr=n(", "),$t=a("code"),Mr=n("token_type_ids"),Xr=n(", "),Ft=a("code"),qr=n("bbox"),Er=n(". Optionally, one can provide integer "),Pt=a("code"),$r=n("word_labels"),Fr=n(`, which are turned
into token-level `),Nt=a("code"),Pr=n("labels"),Nr=n(" for token classification tasks (such as FUNSD, CORD)."),Dr=d(),N=a("div"),k(qe.$$.fragment),Ar=d(),p=a("p"),Ir=n("This method first forwards the "),Dt=a("code"),Or=n("images"),Sr=n(" argument to "),Ee=a("a"),At=a("strong"),Cr=n("call"),Ur=n("()"),Wr=n(`. In case
...
`),Wt=a("code"),ra=n("False"),aa=n(", it passes the words ("),Rt=a("code"),sa=n("text"),ia=n("/"),Bt=a("code"),la=n("text_pair`) and `boxes` specified by the user along with the additional arguments to [__call__()](/docs/transformers/main/en/model_doc/layoutxlm#transformers.LayoutXLMTokenizer.__call__) and returns the output, together with resized `images"),da=n("."),ca=d(),jt=a("p"),ma=n("Please refer to the docstring of the above two methods for more information."),this.h()},l(t){const m=Ss('[data-svelte="svelte-1phssyn"]',document.head);S=s(m,"META",{name:!0,content:!0}),m.forEach(o),Gt=c(t),C=s(t,"H1",{class:!0});var po=i(C);j=s(po,"A",{id:!0,class:!0,href:!0});var ka=i(j);dt=s(ka,"SPAN",{});var ya=i(dt);y(ne.$$.fragment,ya),ya.forEach(o),ka.forEach(o),Mo=c(po),ct=s(po,"SPAN",{});var La=i(ct);Xo=r(La,"LayoutXLM"),La.forEach(o),po.forEach(o),Ht=c(t),U=s(t,"H2",{class:!0});var fo=i(U);V=s(fo,"A",{id:!0,class:!0,href:!0});var ba=i(V);mt=s(ba,"SPAN",{});var va=i(mt);y(re.$$.fragment,va),va.forEach(o),ba.forEach(o),qo=c(fo),ut=s(fo,"SPAN",{});var wa=i(ut);Eo=r(wa,"Overview"),wa.forEach(o),fo.forEach(o),Yt=c(t),E=s(t,"P",{});var rt=i(E);$o=r(rt,"LayoutXLM was proposed in "),ae=s(rt,"A",{href:!0,rel:!0});var xa=i(ae);Fo=r(xa,"LayoutXLM: Multimodal Pre-training for Multilingual Visually-rich Document Understanding"),xa.forEach(o),Po=r(rt,` by Yiheng Xu, Tengchao Lv, Lei Cui, Guoxin Wang, Yijuan Lu, Dinei Florencio, Cha
...
7 languages (Chinese, Japanese, Spanish, French, Italian, German, Portuguese), and key-value pairs are manually labeled
for each language. Experiment results show that the LayoutXLM model has significantly outperformed the existing SOTA
cross-lingual pre-trained models on the XFUN dataset.`),Xa.forEach(o),Ma.forEach(o),Kt=c(t),Ne=s(t,"P",{});var qa=i(Ne);Oo=r(qa,"One can directly plug in the weights of LayoutXLM into a LayoutLMv2 model, like so:"),qa.forEach(o),Qt=c(t),y(ie.$$.fragment,t),eo=c(t),$=s(t,"P",{});var at=i($);So=r(at,`Note that LayoutXLM has its own tokenizer, based on
`),De=s(at,"A",{href:!0});var Ea=i(De);Co=r(Ea,"LayoutXLMTokenizer"),Ea.forEach(o),Uo=r(at,"/"),Ae=s(at,"A",{href:!0});var $a=i(Ae);Wo=r($a,"LayoutXLMTokenizerFast"),$a.forEach(o),Ro=r(at,`. You can initialize it as
...
adding special tokens. An XLM-RoBERTa sequence has the following format:`),Ga.forEach(o),Xn=c(it),ge=s(it,"UL",{});var yo=i(ge);je=s(yo,"LI",{});var ua=i(je);qn=r(ua,"single sequence: "),kt=s(ua,"CODE",{});var Ha=i(kt);En=r(Ha,"<s> X </s>"),Ha.forEach(o),ua.forEach(o),$n=c(yo),Ve=s(yo,"LI",{});var pa=i(Ve);Fn=r(pa,"pair of sequences: "),yt=s(pa,"CODE",{});var Ya=i(yt);Pn=r(Ya,"<s> A </s></s> B </s>"),Ya.forEach(o),pa.forEach(o),yo.forEach(o),it.forEach(o),Nn=c(x),J=s(x,"DIV",{class:!0});var Lo=i(J);y(ke.$$.fragment,Lo),Dn=c(Lo),ye=s(Lo,"P",{});var bo=i(ye);An=r(bo,`Retrieve sequence ids from a token list that has no special tokens added. This method is called when adding
...
sequences with word-level normalized bounding boxes and optional labels.`),is.forEach(o),To.forEach(o),oe.forEach(o),co=c(t),B=s(t,"H2",{class:!0});var zo=i(B);ee=s(zo,"A",{id:!0,class:!0,href:!0});var ls=i(ee);zt=s(ls,"SPAN",{});var ds=i(zt);y(Me.$$.fragment,ds),ds.forEach(o),ls.forEach(o),lr=c(zo),Mt=s(zo,"SPAN",{});var cs=i(Mt);dr=r(cs,"LayoutXLMProcessor"),cs.forEach(o),zo.forEach(o),mo=c(t),T=s(t,"DIV",{class:!0});var I=i(T);y(Xe.$$.fragment,I),cr=c(I),Xt=s(I,"P",{});var ms=i(Xt);mr=r(ms,`Constructs a LayoutXLM processor which combines a LayoutXLM feature extractor and a LayoutXLM tokenizer into a
single processor.`),ms.forEach(o),ur=c(I),Ze=s(I,"P",{});var fa=i(Ze);Ke=s(fa,"A",{href:!0});var us=i(Ke);pr=r(us,"LayoutXLMProcessor"),us.forEach(o),fr=r(fa," offers all the functionalities you need to prepare data for the model."),fa.forEach(o),hr=c(I),h=s(I,"P",{});var g=i(h);_r=r(g,"It first uses "),Qe=s(g,"A",{href:!0});var ps=i(Qe);gr=r(ps,"LayoutLMv2FeatureExtractor"),ps.forEach(o),kr=r(g,` to resize document images to a fixed size, and optionally applies OCR
...
`),tt=s(g,"A",{href:!0});var hs=i(tt);br=r(hs,"LayoutXLMTokenizerFast"),hs.forEach(o),vr=r(g,", which turns the words and bounding boxes into token-level "),qt=s(g,"CODE",{});var _s=i(qt);wr=r(_s,"input_ids"),_s.forEach(o),xr=r(g,`,
`),Et=s(g,"CODE",{});var gs=i(Et);Tr=r(gs,"attention_mask"),gs.forEach(o),zr=r(g,", "),$t=s(g,"CODE",{});var ks=i($t);Mr=r(ks,"token_type_ids"),ks.forEach(o),Xr=r(g,", "),Ft=s(g,"CODE",{});var ys=i(Ft);qr=r(ys,"bbox"),ys.forEach(o),Er=r(g,". Optionally, one can provide integer "),Pt=s(g,"CODE",{});var Ls=i(Pt);$r=r(Ls,"word_labels"),Ls.forEach(o),Fr=r(g,`, which are turned
into token-level `),Nt=s(g,"CODE",{});var bs=i(Nt);Pr=r(bs,"labels"),bs.forEach(o),Nr=r(g," for token classification tasks (such as FUNSD, CORD)."),g.forEach(o),Dr=c(I),N=s(I,"DIV",{class:!0});var lt=i(N);y(qe.$$.fragment,lt),Ar=c(lt),p=s(lt,"P",{});var f=i(p);Ir=r(f,"This method first forwards the "),Dt=s(f,"CODE",{});var vs=i(Dt);Or=r(vs,"images"),vs.forEach(o),Sr=r(f," argument to "),Ee=s(f,"A",{href:!0});var ha=i(Ee);At=s(ha,"STRONG",{});var ws=i(At);Cr=r(ws,"call"),ws.forEach(o),Ur=r(ha,"()"),ha.forEach(o),Wr=r(f,`. In case
...
together with resized `),Ct=s(f,"CODE",{});var Xs=i(Ct);Kr=r(Xs,"images"),Xs.forEach(o),Qr=r(f,". In case "),nt=s(f,"A",{href:!0});var qs=i(nt);ea=r(qs,"LayoutLMv2FeatureExtractor"),qs.forEach(o),ta=r(f," was initialized with "),Ut=s(f,"CODE",{});var Es=i(Ut);oa=r(Es,"apply_ocr"),Es.forEach(o),na=r(f,` set to
`),Wt=s(f,"CODE",{});var $s=i(Wt);ra=r($s,"False"),$s.forEach(o),aa=r(f,", it passes the words ("),Rt=s(f,"CODE",{});var Fs=i(Rt);sa=r(Fs,"text"),Fs.forEach(o),ia=r(f,"/"),Bt=s(f,"CODE",{});var Ps=i(Bt);la=r(Ps,"text_pair`) and `boxes` specified by the user along with the additional arguments to [__call__()](/docs/transformers/main/en/model_doc/layoutxlm#transformers.LayoutXLMTokenizer.__call__) and returns the output, together with resized `images"),Ps.forEach(o),da=r(f,"."),f.forEach(o),ca=c(lt),jt=s(lt,"P",{});var Ns=i(jt);ma=r(Ns,"Please refer to the docstring of the above two methods for more information."),Ns.forEach(o),lt.forEach(o),I.forEach(o),this.h()},h(){l(S,"name","hf:doc:metadata"),l(S,"content",JSON.stringify(Rs)),l(j,"id","layoutxlm"),l(j,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),l(j,"href","#layoutxlm"),l(C,"class","relative group"),l(V,"id","overview"),l(V,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),l(V,"href","#overview"),l(U,"class","relative group"),l(ae,"href","https://arxiv.org/abs/2104.08836"),l(ae,"rel","nofollow"),l(se,"href","https://arxiv.org/abs/2012.14740"),l(se,"rel","nofollow"),l(De,"href","/docs/transformers/main/en/model_doc/layoutxlm#transformers.LayoutXLMTokenizer"),l(Ae,"href","/docs/transformers/main/en/model_doc/layoutxlm#transformers.LayoutXLMTokenizerFast"),l(Ie,"href","/docs/transformers/main/en/model_doc/layoutxlm#transformers.LayoutXLMProcessor"),l(Oe,"href","/docs/transformers/main/en/model_doc/layoutlmv2#transformers.models.layoutlmv2.image_processing_layoutlmv2.LayoutLMv2ImageProcessor"),l(Se,"href","/docs/transformers/main/en/model_doc/layoutxlm#transformers.LayoutXLMTokenizer"),l(Ce,"href","/docs/transformers/main/en/model_doc/layoutxlm#transformers.LayoutXLMTokenizerFast"),l(Ue,"href","layoutlmv2"),l(de,"href","https://huggingface.co/nielsr"),l(de,"rel","nofollow"),l(ce,"href","https://github.com/microsoft/unilm"),l(ce,"rel","nofollow"),l(H,"id","transformers.LayoutXLMTokenizer"),l(H,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),l(H,"href","#transformers.LayoutXLMTokenizer"),l(W,"class","relative group"),l(We,"href","/docs/transformers/main/en/model_doc/roberta#transformers.RobertaTokenizer"),l(Re,"href","/docs/transformers/main/en/model_doc/xlnet#transformers.XLNetTokenizer"),l(pe,"href","https://github.com/google/sentencepiece"),l(pe,"rel","nofollow"),l(Be,"href","/docs/transformers/main/en/main_classes/tokenizer#transformers.PreTrainedTokenizer"),l(Y,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),l(P,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),l(J,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),l(Z,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),l(Ge,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),l(_,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),l(K,"id","transformers.LayoutXLMTokenizerFast"),l(K,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),l(K,"href","#transformers.LayoutXLMTokenizerFast"),l(R,"class","relative group"),l(He,"href","/docs/transformers/main/en/model_doc/roberta#transformers.RobertaTokenizer"),l(Ye,"href","/docs/transformers/main/en/model_doc/xlnet#transformers.XLNetTokenizer"),l(xe,"href","https://huggingface.co/docs/tokenizers/python/latest/components.html?highlight=BPE#models"),l(xe,"rel","nofollow"),l(Je,"href","/docs/transformers/main/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast"),l(Q,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),l(M,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),l(ee,"id","transformers.LayoutXLMProcessor"),l(ee,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),l(ee,"href","#transformers.LayoutXLMProcessor"),l(B,"class","relative group"),l(Ke,"href","/docs/transformers/main/en/model_doc/layoutxlm#transformers.LayoutXLMProcessor"),l(Qe,"href","/docs/transformers/main/en/model_doc/layoutlmv2#transformers.models.layoutlmv2.image_processing_layoutlmv2.LayoutLMv2ImageProcessor"),l(et,"href","/docs/transformers/main/en/model_doc/layoutxlm#transformers.LayoutXLMTokenizer"),l(tt,"href","/docs/transformers/main/en/model_doc/layoutxlm#transformers.LayoutXLMTokenizerFast"),l(Ee,"href","/docs/transformers/main/en/model_doc/layoutlmv2#transformers.models.layoutlmv2.image_processing_layoutlmv2.LayoutLMv2ImageProcessor.__call__"),l(ot,"href","/docs/transformers/main/en/model_doc/layoutlmv2#transformers.models.layoutlmv2.image_processing_layoutlmv2.LayoutLMv2ImageProcessor"),l($e,"href","/docs/transformers/main/en/model_doc/layoutxlm#transformers.LayoutXLMTokenizer.__call__"),l(nt,"href","/docs/transformers/main/en/model_doc/layoutlmv2#transformers.models.layoutlmv2.image_processing_layoutlmv2.LayoutLMv2ImageProcessor"),l(N,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),l(T,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8")},m(t,m){e(document.head,S),u(t,Gt,m),u(t,C,m),e(C,j),e(j,dt),L(ne,dt,null),e(C,Mo),e(C,ct),e(ct,Xo),u(t,Ht,m),u(t,U,m),e(U,V),e(V,mt),L(re,mt,null),e(U,qo),e(U,ut),e(ut,Eo),u(t,Yt,m),u(t,E,m),e(E,$o),e(E,ae),e(ae,Fo),e(E,Po),e(E,se),e(se,No),e(E,Do),u(t,Jt,m),u(t,Fe,m),e(Fe,Ao),u(t,Zt,m),u(t,Pe,m),e(Pe,pt),e(pt,Io),u(t,Kt,m),u(t,Ne,m),e(Ne,Oo),u(t,Qt,m),L(ie,t,m),u(t,eo,m),u(t,$,m),e($,So),e($,De),e(De,Co),e($,Uo),e($,Ae),e(Ae,Wo),e($,Ro),u(t,to,m),L(le,t,m),u(t,oo,m),u(t,z,m),e(z,Bo),e(z,Ie),e(Ie,jo),e(z,Vo),e(z,Oe),e(Oe,Go),e(z,Ho),e(z,Se),e(Se,Yo),e(z,Jo),e(z,Ce),e(Ce,Zo),e(z,Ko),u(t,no,m),u(t,G,m),e(G,Qo),e(G,Ue),e(Ue,en),e(G,tn),u(t,ro,m),u(t,F,m),e(F,on),e(F,de),e(de,nn),e(F,rn),e(F,ce),e(ce,an),e(F,sn),u(t,ao,m),u(t,W,m),e(W,H),e(H,ft),L(me,ft,null),e(W,ln),e(W,ht),e(ht,dn),u(t,so,m),u(t,_,m),L(ue,_,null),e(_,cn),e(_,q),e(q,mn),e(q,We),e(We,un),e(q,pn),e(q,Re),e(Re,fn),e(q,hn),e(q,pe),e(pe,_n),e(q,gn),e(_,kn),e(_,fe),e(fe,yn),e(fe,Be),e(Be,Ln),e(fe,bn),e(_,vn),e(_,Y),L(he,Y,null),e(Y,wn),e(Y,_t),e(_t,xn),e(_,Tn),e(_,P),L(_e,P,null),e(P,zn),e(P,gt),e(gt,Mn),e(P,Xn),e(P,ge),e(ge,je),e(je,qn),e(je,kt),e(kt,En),e(ge,$n),e(ge,Ve),e(Ve,Fn),e(Ve,yt),e(yt,Pn),e(_,Nn),e(_,J),L(ke,J,null),e(J,Dn),e(J,ye),e(ye,An),e(ye,Lt),e(Lt,In),e(ye,On),e(_,Sn),e(_,Z),L(Le,Z,null),e(Z,Cn),e(Z,bt),e(bt,Un),e(_,Wn),e(_,Ge),L(be,Ge,null),u(t,io,m),u(t,R,m),e(R,K),e(K,vt),L(ve,vt,null),e(R,Rn),e(R,wt),e(wt,Bn),u(t,lo,m),u(t,M,m),L(we,M,null),e(M,jn),e(M,X),e(X,Vn),e(X,xt),e(xt,Gn),e(X,Hn),e(X,He),e(He,Yn),e(X,Jn),e(X,Ye),e(Ye,Zn),e(X,Kn),e(X,xe),e(xe,Qn),e(X,er),e(M,tr),e(M,Te),e(Te,or),e(Te,Je),e(Je,nr),e(Te,rr),e(M,ar),e(M,Q),L(ze,Q,null),e(Q,sr),e(Q,Tt),e(Tt,ir),u(t,co,m),u(t,B,m),e(B,ee),e(ee,zt),L(Me,zt,null),e(B,lr),e(B,Mt),e(Mt,dr),u(t,mo,m),u(t,T,m),L(Xe,T,null),e(T,cr),e(T,Xt),e(Xt,mr),e(T,ur),e(T,Ze),e(Ze,Ke),e(Ke,pr),e(Ze,fr),e(T,hr),e(T,h),e(h,_r),e(h,Qe),e(Qe,gr),e(h,kr),e(h,et),e(et,yr),e(h,Lr),e(h,tt),e(tt,br),e(h,vr),e(h,qt),e(qt,wr),e(h,xr),e(h,Et),e(Et,Tr),e(h,zr),e(h,$t),e($t,Mr),e(h,Xr),e(h,Ft),e(Ft,qr),e(h,Er),e(h,Pt),e(Pt,$r),e(h,Fr),e(h,Nt),e(Nt,Pr),e(h,Nr),e(T,Dr),e(T,N),L(qe,N,null),e(N,Ar),e(N,p),e(p,Ir),e(p,Dt),e(Dt,Or),e(p,Sr),e(p,Ee),e(Ee,At),e(At,Cr),e(Ee,Ur),e(p,Wr),e(p,ot),e(ot,Rr),e(p,Br),e(p,It),e(It,jr),e(p,Vr),e(p,Ot),e(Ot,Gr),e(p,Hr),e(p,$e),e($e,St),e(St,Yr),e($e,Jr),e(p,Zr),e(p,Ct),e(Ct,Kr),e(p,Qr),e(p,nt),e(nt,ea),e(p,ta),e(p,Ut),e(Ut,oa),e(p,na),e(p,Wt),e(Wt,ra),e(p,aa),e(p,Rt),e(Rt,sa),e(p,ia),e(p,Bt),e(Bt,la),e(p,da),e(N,ca),e(N,jt),e(jt,ma),uo=!0},p:Cs,i(t){uo||(b(ne.$$.fragment,t),b(re.$$.fragment,t),b(ie.$$.fragment,t),b(le.$$.fragment,t),b(me.$$.fragment,t),b(ue.$$.fragment,t),b(he.$$.fragment,t),b(_e.$$.fragment,t),b(ke.$$.fragment,t),b(Le.$$.fragment,t),b(be.$$.fragment,t),b(ve.$$.fragment,t),b(we.$$.fragment,t),b(ze.$$.fragment,t),b(Me.$$.fragment,t),b(Xe.$$.fragment,t),b(qe.$$.fragment,t),uo=!0)},o(t){v(ne.$$.fragment,t),v(re.$$.fragment,t),v(ie.$$.fragment,t),v(le.$$.fragment,t),v(me.$$.fragment,t),v(ue.$$.fragment,t),v(he.$$.fragment,t),v(_e.$$.fragment,t),v(ke.$$.fragment,t),v(Le.$$.fragment,t),v(be.$$.fragment,t),v(ve.$$.fragment,t),v(we.$$.fragment,t),v(ze.$$.fragment,t),v(Me.$$.fragment,t),v(Xe.$$.fragment,t),v(qe.$$.fragment,t),uo=!1},d(t){o(S),t&&o(Gt),t&&o(C),w(ne),t&&o(Ht),t&&o(U),w(re),t&&o(Yt),t&&o(E),t&&o(Jt),t&&o(Fe),t&&o(Zt),t&&o(Pe),t&&o(Kt),t&&o(Ne),t&&o(Qt),w(ie,t),t&&o(eo),t&&o($),t&&o(to),w(le,t),t&&o(oo),t&&o(z),t&&o(no),t&&o(G),t&&o(ro),t&&o(F),t&&o(ao),t&&o(W),w(me),t&&o(so),t&&o(_),w(ue),w(he),w(_e),w(ke),w(Le),w(be),t&&o(io),t&&o(R),w(ve),t&&o(lo),t&&o(M),w(we),w(ze),t&&o(co),t&&o(B),w(Me),t&&o(mo),t&&o(T),w(Xe),w(qe)}}}const Rs={local:"layoutxlm",sections:[{local:"overview",title:"Overview"},{local:"transformers.LayoutXLMTokenizer",title:"LayoutXLMTokenizer"},{local:"transformers.LayoutXLMTokenizerFast",title:"LayoutXLMTokenizerFast"},{local:"transformers.LayoutXLMProcessor",title:"LayoutXLMProcessor"}],title:"LayoutXLM"};function Bs(ga){return Us(()=>{new URLSearchParams(window.location.search).get("fw")}),[]}class Ys extends As{constructor(S){super();Is(this,S,Bs,Ws,Os,{})}}export{Ys as default,Rs as metadata};
