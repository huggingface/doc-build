import{S as tc,i as oc,s as rc,e as a,k as l,w as g,t as r,M as sc,c as n,d as o,m as d,a as i,x as v,h as s,b as c,F as e,g as h,y as T,q as x,o as k,B as b,v as ac,L as ec}from"../../chunks/vendor-6b77c823.js";import{T as Yi}from"../../chunks/Tip-39098574.js";import{D}from"../../chunks/Docstring-1088f2fb.js";import{C as Pr}from"../../chunks/CodeBlock-3a8b25a8.js";import{I as gt}from"../../chunks/IconCopyLink-7a11ce68.js";import{E as Zi}from"../../chunks/ExampleCodeBlock-5212b321.js";function nc(H){let f,E,u,_,w;return _=new Pr({props:{code:`from transformers import Speech2Text2ForCausalLM, Speech2Text2Config
...
<span class="hljs-meta">&gt;&gt;&gt; </span>configuration = model.config`}}),{c(){f=a("p"),E=r("Example:"),u=l(),g(_.$$.fragment)},l(m){f=n(m,"P",{});var S=i(f);E=s(S,"Example:"),S.forEach(o),u=d(m),v(_.$$.fragment,m)},m(m,S){h(m,f,S),e(f,E),h(m,u,S),T(_,m,S),w=!0},p:ec,i(m){w||(x(_.$$.fragment,m),w=!0)},o(m){k(_.$$.fragment,m),w=!1},d(m){m&&o(f),m&&o(u),b(_,m)}}}function ic(H){let f,E,u,_,w,m,S,W;return{c(){f=a("p"),E=r(`This class method is simply calling the feature extractor
...
<span class="hljs-meta">&gt;&gt;&gt; </span>loss.backward()`}}),{c(){f=a("p"),E=r("Example:"),u=l(),g(_.$$.fragment)},l(m){f=n(m,"P",{});var S=i(f);E=s(S,"Example:"),S.forEach(o),u=d(m),v(_.$$.fragment,m)},m(m,S){h(m,f,S),e(f,E),h(m,u,S),T(_,m,S),w=!0},p:ec,i(m){w||(x(_.$$.fragment,m),w=!0)},o(m){k(_.$$.fragment,m),w=!1},d(m){m&&o(f),m&&o(u),b(_,m)}}}function dc(H){let f,E,u,_,w,m,S,W,q,y,F,M,oo,ze,jr,ro,Cr,Ao,J,qr,vt,Fr,Mr,Pe,Ar,Lr,Lo,z,Dr,so,Wr,Ir,ao,Vr,Nr,Tt,Or,Ur,xt,Rr,Br,kt,Hr,Jr,no,Gr,Kr,Do,ne,Qr,je,Xr,Yr,Wo,ie,Zr,Ce,es,ts,Io,bt,os,Vo,G,qe,rs,Fe,ss,as,ns,Me,is,St,cs,ls,ds,Ae,ps,Le,hs,ms,No,Z,ce,io,De,fs,co,us,Oo,K,_s,wt,gs,vs,$t,Ts,xs,Uo,C,ks,yt,bs,Ss,Et,ws,$s,zt,ys,Es,Pt,zs,Ps,jt,js,Cs,Ro,Ct,lo,qs,Bo,We,Ho,qt,Ie,po,Fs,Ms,ho,As,Jo,Ve,Go,le,Ls,Ne,Ds,Ws,Ko,ee,de,mo,Oe,Is,fo,Vs,Qo,I,Ue,Ns,te,Os,Ft,Us,Rs,Re,Bs,Hs,Js,oe,Gs,Mt,Ks,Qs,At,Xs,Ys,Zs,pe,Xo,re,he,uo,Be,ea,_o,ta,Yo,j,He,oa,go,ra,sa,Je,aa,Lt,na,ia,ca,me,Ge,la,vo,da,pa,Q,Ke,ha,To,ma,fa,Qe,ua,xo,_a,ga,va,Dt,Xe,Zo,se,fe,ko,Ye,Ta,bo,xa,er,$,Ze,ka,So,ba,Sa,A,Wt,wa,$a,It,ya,Ea,Vt,za,Pa,et,wo,ja,Ca,qa,Nt,Fa,Ma,Aa,ue,tt,La,U,Da,$o,Wa,Ia,Ot,Va,Na,ot,yo,Oa,Ua,Ra,Ba,X,rt,Ha,Eo,Ja,Ga,_e,Ka,Y,st,Qa,at,Xa,Ut,Ya,Za,en,ge,tn,ve,nt,on,it,rn,Rt,sn,an,nn,Te,ct,cn,lt,ln,Bt,dn,pn,hn,xe,dt,mn,zo,fn,tr,ae,ke,Po,pt,un,jo,_n,or,V,ht,gn,R,vn,Ht,Tn,xn,Co,kn,bn,Jt,Sn,wn,$n,mt,yn,ft,En,zn,Pn,be,ut,jn,Se,rr;return m=new gt({}),ze=new gt({}),De=new gt({}),We=new Pr({props:{code:`import torch
...
just in case (e.g., 512 or 1024 or 2048).`,name:"max_source_positions"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/speech_to_text_2/configuration_speech_to_text_2.py#L29"}}),pe=new Zi({props:{anchor:"transformers.Speech2Text2Config.example",$$slots:{default:[nc]},$$scope:{ctx:H}}}),Be=new gt({}),He=new D({props:{name:"class transformers.Speech2Text2Tokenizer",anchor:"transformers.Speech2Text2Tokenizer",parameters:[{name:"vocab_file",val:""},{name:"bos_token",val:" = '<s>'"},{name:"pad_token",val:" = '<pad>'"},{name:"eos_token",val:" = '</s>'"},{name:"unk_token",val:" = '<unk>'"},{name:"do_lower_case",val:" = False"},{name:"merges_file",val:" = None"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.Speech2Text2Tokenizer.vocab_file",description:`<strong>vocab_file</strong> (<code>str</code>) &#x2014;
...
Will be passed to the underlying model specific decode method.`,name:"kwargs"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/tokenization_utils_base.py#L3264",returnDescription:`
...
Will be passed to the underlying model specific decode method.`,name:"kwargs"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/tokenization_utils_base.py#L3297",returnDescription:`
<p>The decoded sentence.</p>
`,returnType:`
<p><code>str</code></p>
`}}),Xe=new D({props:{name:"save_vocabulary",anchor:"transformers.Speech2Text2Tokenizer.save_vocabulary",parameters:[{name:"save_directory",val:": str"},{name:"filename_prefix",val:": typing.Optional[str] = None"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/speech_to_text_2/tokenization_speech_to_text_2.py#L235"}}),Ye=new gt({}),Ze=new D({props:{name:"class transformers.Speech2Text2Processor",anchor:"transformers.Speech2Text2Processor",parameters:[{name:"feature_extractor",val:""},{name:"tokenizer",val:""}],parametersDescription:[{anchor:"transformers.Speech2Text2Processor.feature_extractor",description:`<strong>feature_extractor</strong> (<code>AutoFeatureExtractor</code>) &#x2014;
...
`}}),Se=new Zi({props:{anchor:"transformers.Speech2Text2ForCausalLM.forward.example",$$slots:{default:[lc]},$$scope:{ctx:H}}}),{c(){f=a("meta"),E=l(),u=a("h1"),_=a("a"),w=a("span"),g(m.$$.fragment),S=l(),W=a("span"),q=r("Speech2Text2"),y=l(),F=a("h2"),M=a("a"),oo=a("span"),g(ze.$$.fragment),jr=l(),ro=a("span"),Cr=r("Overview"),Ao=l(),J=a("p"),qr=r("The Speech2Text2 model is used together with "),vt=a("a"),Fr=r("Wav2Vec2"),Mr=r(` for Speech Translation models proposed in
...
the superclass for more information regarding such methods.`),ca=l(),me=a("div"),g(Ge.$$.fragment),la=l(),vo=a("p"),da=r("Convert a list of lists of token ids into a list of strings by calling decode."),pa=l(),Q=a("div"),g(Ke.$$.fragment),ha=l(),To=a("p"),ma=r(`Converts a sequence of ids in a string, using the tokenizer and vocabulary with options to remove special
tokens and clean up tokenization spaces.`),fa=l(),Qe=a("p"),ua=r("Similar to doing "),xo=a("code"),_a=r("self.convert_tokens_to_string(self.convert_ids_to_tokens(token_ids))"),ga=r("."),va=l(),Dt=a("div"),g(Xe.$$.fragment),Zo=l(),se=a("h2"),fe=a("a"),ko=a("span"),g(Ye.$$.fragment),Ta=l(),bo=a("span"),xa=r("Speech2Text2Processor"),er=l(),$=a("div"),g(Ze.$$.fragment),ka=l(),So=a("p"),ba=r(`Constructs a Speech2Text2 processor which wraps a Speech2Text2 feature extractor and a Speech2Text2 tokenizer into
...
refer to the docstring of this method for more information.`),nn=l(),Te=a("div"),g(ct.$$.fragment),cn=l(),lt=a("p"),ln=r("This method forwards all its arguments to Speech2Text2Tokenizer\u2019s "),Bt=a("a"),dn=r("decode()"),pn=r(`. Please refer
to the docstring of this method for more information.`),hn=l(),xe=a("div"),g(dt.$$.fragment),mn=l(),zo=a("p"),fn=r(`Temporarily sets the tokenizer for processing the input. Useful for encoding the labels when fine-tuning
...
`),Tt=n(L,"A",{href:!0});var Vn=i(Tt);Or=s(Vn,"Wav2Vec2"),Vn.forEach(o),Ur=s(L," or "),xt=n(L,"A",{href:!0});var Nn=i(xt);Rr=s(Nn,"HuBERT"),Nn.forEach(o),Br=s(L,` for Speech-to-Text tasks. Please refer to the
...
instantiate an Speech2Text2 model according to the specified arguments, defining the model architecture.
Instantiating a configuration with the defaults will yield a similar configuration to that of the Speech2Text2
`),Re=n(Xt,"A",{href:!0,rel:!0});var _i=i(Re);Bs=s(_i,"facebook/s2t-wav2vec2-large-en-de"),_i.forEach(o),Hs=s(Xt," architecture."),Xt.forEach(o),Js=d(we),oe=n(we,"P",{});var Yt=i(oe);Gs=s(Yt,"Configuration objects inherit from "),Mt=n(Yt,"A",{href:!0});var gi=i(Mt);Ks=s(gi,"PretrainedConfig"),gi.forEach(o),Qs=s(Yt,` and can be used to control the model outputs. Read the
documentation from `),At=n(Yt,"A",{href:!0});var vi=i(At);Xs=s(vi,"PretrainedConfig"),vi.forEach(o),Ys=s(Yt," for more information."),Yt.forEach(o),Zs=d(we),v(pe.$$.fragment,we),we.forEach(o),Xo=d(t),re=n(t,"H2",{class:!0});var fr=i(re);he=n(fr,"A",{id:!0,class:!0,href:!0});var Ti=i(he);uo=n(Ti,"SPAN",{});var xi=i(uo);v(Be.$$.fragment,xi),xi.forEach(o),Ti.forEach(o),ea=d(fr),_o=n(fr,"SPAN",{});var ki=i(_o);ta=s(ki,"Speech2TextTokenizer"),ki.forEach(o),fr.forEach(o),Yo=d(t),j=n(t,"DIV",{class:!0});var O=i(j);v(He.$$.fragment,O),oa=d(O),go=n(O,"P",{});var bi=i(go);ra=s(bi,"Constructs a Speech2Text2Tokenizer."),bi.forEach(o),sa=d(O),Je=n(O,"P",{});var ur=i(Je);aa=s(ur,"This tokenizer inherits from "),Lt=n(ur,"A",{href:!0});var Si=i(Lt);na=s(Si,"PreTrainedTokenizer"),Si.forEach(o),ia=s(ur,` which contains some of the main methods. Users should refer to
the superclass for more information regarding such methods.`),ur.forEach(o),ca=d(O),me=n(O,"DIV",{class:!0});var _r=i(me);v(Ge.$$.fragment,_r),la=d(_r),vo=n(_r,"P",{});var wi=i(vo);da=s(wi,"Convert a list of lists of token ids into a list of strings by calling decode."),wi.forEach(o),_r.forEach(o),pa=d(O),Q=n(O,"DIV",{class:!0});var Zt=i(Q);v(Ke.$$.fragment,Zt),ha=d(Zt),To=n(Zt,"P",{});var $i=i(To);ma=s($i,`Converts a sequence of ids in a string, using the tokenizer and vocabulary with options to remove special
tokens and clean up tokenization spaces.`),$i.forEach(o),fa=d(Zt),Qe=n(Zt,"P",{});var gr=i(Qe);ua=s(gr,"Similar to doing "),xo=n(gr,"CODE",{});var yi=i(xo);_a=s(yi,"self.convert_tokens_to_string(self.convert_ids_to_tokens(token_ids))"),yi.forEach(o),ga=s(gr,"."),gr.forEach(o),Zt.forEach(o),va=d(O),Dt=n(O,"DIV",{class:!0});var Ei=i(Dt);v(Xe.$$.fragment,Ei),Ei.forEach(o),O.forEach(o),Zo=d(t),se=n(t,"H2",{class:!0});var vr=i(se);fe=n(vr,"A",{id:!0,class:!0,href:!0});var zi=i(fe);ko=n(zi,"SPAN",{});var Pi=i(ko);v(Ye.$$.fragment,Pi),Pi.forEach(o),zi.forEach(o),Ta=d(vr),bo=n(vr,"SPAN",{});var ji=i(bo);xa=s(ji,"Speech2Text2Processor"),ji.forEach(o),vr.forEach(o),er=d(t),$=n(t,"DIV",{class:!0});var P=i($);v(Ze.$$.fragment,P),ka=d(P),So=n(P,"P",{});var Ci=i(So);ba=s(Ci,`Constructs a Speech2Text2 processor which wraps a Speech2Text2 feature extractor and a Speech2Text2 tokenizer into
a single processor.`),Ci.forEach(o),Sa=d(P),A=n(P,"P",{});var B=i(A);Wt=n(B,"A",{href:!0});var qi=i(Wt);wa=s(qi,"Speech2Text2Processor"),qi.forEach(o),$a=s(B," offers all the functionalities of "),It=n(B,"A",{href:!0});var Fi=i(It);ya=s(Fi,"AutoFeatureExtractor"),Fi.forEach(o),Ea=s(B," and "),Vt=n(B,"A",{href:!0});var Mi=i(Vt);za=s(Mi,"Speech2Text2Tokenizer"),Mi.forEach(o),Pa=s(B,`.
See the `),et=n(B,"A",{href:!0});var Cn=i(et);wo=n(Cn,"STRONG",{});var Ai=i(wo);ja=s(Ai,"call"),Ai.forEach(o),Ca=s(Cn,"()"),Cn.forEach(o),qa=s(B," and "),Nt=n(B,"A",{href:!0});var Li=i(Nt);Fa=s(Li,"decode()"),Li.forEach(o),Ma=s(B," for more information."),B.forEach(o),Aa=d(P),ue=n(P,"DIV",{class:!0});var Tr=i(ue);v(tt.$$.fragment,Tr),La=d(Tr),U=n(Tr,"P",{});var $e=i(U);Da=s($e,`When used in normal mode, this method forwards all its arguments to AutoFeatureExtractor\u2019s
...
methods for more information.`),$e.forEach(o),Tr.forEach(o),Ba=d(P),X=n(P,"DIV",{class:!0});var eo=i(X);v(rt.$$.fragment,eo),Ha=d(eo),Eo=n(eo,"P",{});var Vi=i(Eo);Ja=s(Vi,"Instantiate a processor associated with a pretrained model."),Vi.forEach(o),Ga=d(eo),v(_e.$$.fragment,eo),eo.forEach(o),Ka=d(P),Y=n(P,"DIV",{class:!0});var to=i(Y);v(st.$$.fragment,to),Qa=d(to),at=n(to,"P",{});var xr=i(at);Xa=s(xr,`Saves the attributes of this processor (feature extractor, tokenizer\u2026) in the specified directory so that it
can be reloaded using the `),Ut=n(xr,"A",{href:!0});var Ni=i(Ut);Ya=s(Ni,"from_pretrained()"),Ni.forEach(o),Za=s(xr," method."),xr.forEach(o),en=d(to),v(ge.$$.fragment,to),to.forEach(o),tn=d(P),ve=n(P,"DIV",{class:!0});var kr=i(ve);v(nt.$$.fragment,kr),on=d(kr),it=n(kr,"P",{});var br=i(it);rn=s(br,"This method forwards all its arguments to Speech2Text2Tokenizer\u2019s "),Rt=n(br,"A",{href:!0});var Oi=i(Rt);sn=s(Oi,"batch_decode()"),Oi.forEach(o),an=s(br,`. Please
refer to the docstring of this method for more information.`),br.forEach(o),kr.forEach(o),nn=d(P),Te=n(P,"DIV",{class:!0});var Sr=i(Te);v(ct.$$.fragment,Sr),cn=d(Sr),lt=n(Sr,"P",{});var wr=i(lt);ln=s(wr,"This method forwards all its arguments to Speech2Text2Tokenizer\u2019s "),Bt=n(wr,"A",{href:!0});var Ui=i(Bt);dn=s(Ui,"decode()"),Ui.forEach(o),pn=s(wr,`. Please refer
to the docstring of this method for more information.`),wr.forEach(o),Sr.forEach(o),hn=d(P),xe=n(P,"DIV",{class:!0});var $r=i(xe);v(dt.$$.fragment,$r),mn=d($r),zo=n($r,"P",{});var Ri=i(zo);fn=s(Ri,`Temporarily sets the tokenizer for processing the input. Useful for encoding the labels when fine-tuning
