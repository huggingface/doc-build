import{S as Kd,i as Qd,s as Yd,e as n,k as l,w as m,t as r,M as Zd,c as a,d as o,m as c,a as s,x as f,h as i,b as d,F as e,g as h,y as g,q as _,o as b,B as k,v as el}from"../../chunks/vendor-6b77c823.js";import{T as ki}from"../../chunks/Tip-39098574.js";import{D as O}from"../../chunks/Docstring-53452dc4.js";import{C as X}from"../../chunks/CodeBlock-3a8b25a8.js";import{I as ue}from"../../chunks/IconCopyLink-7a11ce68.js";function tl(me){let u,B,v,L,z;return{c(){u=n("p"),B=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),v=n("code"),L=r("Module"),z=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(y){u=a(y,"P",{});var T=s(u);B=i(T,"Although the recipe for forward pass needs to be defined within this function, one should call the "),v=a(T,"CODE",{});var F=s(v);L=i(F,"Module"),F.forEach(o),z=i(T,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
the latter silently ignores them.`)},l(y){u=a(y,"P",{});var T=s(u);B=i(T,"Although the recipe for forward pass needs to be defined within this function, one should call the "),v=a(T,"CODE",{});var F=s(v);L=i(F,"Module"),F.forEach(o),z=i(T,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),T.forEach(o)},m(y,T){h(y,u,T),e(u,B),e(u,v),e(v,L),e(u,z)},d(y){y&&o(u)}}}function al(me){let u,B,v,L,z,y,T,F,ta,an,I,io,oa,na,Fe,aa,sa,je,ra,ia,sn,Y,fe,lo,Ee,da,co,la,rn,W,ca,Me,pa,ha,po,ua,ma,dn,Mt,fa,ln,St,ho,ga,cn,G,_a,Se,ba,ka,Ae,va,ya,pn,Z,ge,uo,Ne,Ta,mo,wa,hn,j,Pa,fo,La,qa,go,za,Ba,_o,$a,xa,bo,Ca,Fa,un,_e,ja,Oe,Ea,Ma,mn,R,Sa,Ie,ko,Aa,Na,Oa,At,Ia,Da,fn,Nt,vo,Xa,gn,De,_n,Ot,Xe,yo,Wa,Ga,ee,Ra,To,Ha,Ua,wo,Va,Ja,bn,We,kn,te,be,Po,Ge,Ka,Lo,Qa,vn,x,Re,Ya,oe,Za,It,es,ts,He,os,ns,as,ne,ss,Dt,rs,is,Xt,ds,ls,cs,qo,ps,hs,Ue,yn,ae,ke,zo,Ve,us,Bo,ms,Tn,P,Je,fs,$o,gs,_s,D,bs,Wt,ks,vs,Gt,ys,Ts,Ke,ws,Ps,Ls,Qe,qs,xo,zs,Bs,$s,Co,xs,Cs,Ye,Fs,ve,Ze,js,Fo,Es,Ms,N,et,Ss,tt,As,jo,Ns,Os,Is,ot,nt,Eo,Ds,Xs,Mo,Ws,Gs,at,So,Rs,Hs,Ao,Us,Vs,No,Js,wn,se,ye,Oo,st,Ks,Io,Qs,Pn,S,rt,Ys,it,Zs,Rt,er,tr,or,dt,nr,lt,ar,sr,rr,E,ct,ir,re,dr,Ht,lr,cr,Do,pr,hr,ur,Te,mr,Xo,fr,gr,pt,Ln,ie,we,Wo,ht,_r,Go,br,qn,A,ut,kr,mt,vr,Ut,yr,Tr,wr,ft,Pr,gt,Lr,qr,zr,M,_t,Br,de,$r,Vt,xr,Cr,Ro,Fr,jr,Er,Pe,Mr,Ho,Sr,Ar,bt,zn,le,Le,Uo,kt,Nr,Vo,Or,Bn,C,vt,Ir,Jo,Dr,Xr,yt,Wr,Jt,Gr,Rr,Hr,Tt,Ur,wt,Vr,Jr,Kr,w,Pt,Qr,ce,Yr,Kt,Zr,ei,Ko,ti,oi,ni,qe,ai,Qo,si,ri,Lt,ii,qt,di,Yo,li,ci,zt,pi,Bt,$n,pe,ze,Zo,$t,hi,en,ui,xn,he,xt,mi,H,Ct,fi,tn,gi,_i,Ft,Cn;return y=new ue({}),Ee=new ue({}),Ne=new ue({}),De=new X({props:{code:`from transformers import PLBartForConditionalGeneration, PLBartTokenizer
...
<code>eos_token_id</code>.`,name:"forced_eos_token_id"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/plbart/configuration_plbart.py#L32"}}),Ue=new X({props:{code:`from transformers import PLBartModel, PLBartConfig
...
BPE-dropout.</li>
</ul>`,name:"sp_model_kwargs"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/plbart/tokenization_plbart.py#L75"}}),Ye=new X({props:{code:`from transformers import PLBartTokenizer
...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/plbart/tokenization_plbart.py#L302",returnDescription:`
...
Whether or not to return a <a href="/docs/transformers/main/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/plbart/modeling_plbart.py#L1139",returnDescription:`
<p>A <a
...
(masked), the loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/plbart/modeling_plbart.py#L1272",returnDescription:`
<p>A <a
...
Labels for computing the sequence classification/regression loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>. If <code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/plbart/modeling_plbart.py#L1411",returnDescription:`
<p>A <a
...
Whether or not to return a <a href="/docs/transformers/main/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/plbart/modeling_plbart.py#L1566",returnDescription:`
<p>A <a
...
<span class="hljs-literal">True</span>`}}),{c(){u=n("meta"),B=l(),v=n("h1"),L=n("a"),z=n("span"),m(y.$$.fragment),T=l(),F=n("span"),ta=r("PLBart"),an=l(),I=n("p"),io=n("strong"),oa=r("DISCLAIMER:"),na=r(" If you see something strange, file a "),Fe=n("a"),aa=r("Github Issue"),sa=r(` and assign
...
target text format is `),_o=n("code"),$a=r("[tgt_lang_code] X [eos]"),xa=r(". "),bo=n("code"),Ca=r("bos"),Fa=r(" is never used."),un=l(),_e=n("p"),ja=r("However, for fine-tuning, in some cases no language token is provided in cases where a single language is used. Please refer to "),Oe=n("a"),Ea=r("the paper"),Ma=r(" to learn more about this."),mn=l(),R=n("p"),Sa=r("In cases where the language code is needed, The regular "),Ie=n("a"),ko=n("strong"),Aa=r("call"),Na=r("()"),Oa=r(` will encode source text format, and it should be wrapped
inside the context manager `),At=n("a"),Ia=r("as_target_tokenizer()"),Da=r(" to encode target text format."),fn=l(),Nt=n("ul"),vo=n("li"),Xa=r("Supervised training"),gn=l(),m(De.$$.fragment),_n=l(),Ot=n("ul"),Xe=n("li"),yo=n("p"),Wa=r("Generation"),Ga=l(),ee=n("p"),Ra=r("While generating the target text set the "),To=n("code"),Ha=r("decoder_start_token_id"),Ua=r(` to the target language id. The following
...
documentation from `),Xt=n("a"),ds=r("PretrainedConfig"),ls=r(" for more information."),cs=l(),qo=n("p"),ps=r("Example:"),hs=l(),m(Ue.$$.fragment),yn=l(),ae=n("h2"),ke=n("a"),zo=n("span"),m(Ve.$$.fragment),us=l(),Bo=n("span"),ms=r("PLBartTokenizer"),Tn=l(),P=n("div"),m(Je.$$.fragment),fs=l(),$o=n("p"),gs=r("Construct an PLBART tokenizer."),_s=l(),D=n("p"),bs=r("Adapted from "),Wt=n("a"),ks=r("RobertaTokenizer"),vs=r(" and "),Gt=n("a"),ys=r("XLNetTokenizer"),Ts=r(`. Based on
`),Ke=n("a"),ws=r("SentencePiece"),Ps=r("."),Ls=l(),Qe=n("p"),qs=r("The tokenization method is "),xo=n("code"),zs=r("<tokens> <eos> <language code>"),Bs=r(" for source language documents, and \u201C<language code>\n<tokens> <eos>``` for target language documents."),$s=l(),Co=n("p"),xs=r("Examples:"),Cs=l(),m(Ye.$$.fragment),Fs=l(),ve=n("div"),m(Ze.$$.fragment),js=l(),Fo=n("p"),Es=r(`Temporarily sets the tokenizer for encoding the targets. Useful for tokenizer associated to
...
adding special tokens. An PLBART sequence has the following format, where `),jo=n("code"),Ns=r("X"),Os=r(" represents the sequence:"),Is=l(),ot=n("ul"),nt=n("li"),Eo=n("code"),Ds=r("input_ids"),Xs=r(" (for encoder) "),Mo=n("code"),Ws=r("X [eos, src_lang_code]"),Gs=l(),at=n("li"),So=n("code"),Rs=r("decoder_input_ids"),Hs=r(": (for decoder) "),Ao=n("code"),Us=r("X [eos, tgt_lang_code]"),Vs=l(),No=n("p"),Js=r(`BOS is never used. Pairs of sequences are not the expected use case, but they will be handled without a
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Kr=l(),w=n("div"),m(Pt.$$.fragment),Qr=l(),ce=n("p"),Yr=r("The "),Kt=n("a"),Zr=r("PLBartForSequenceClassification"),ei=r(" forward method, overrides the "),Ko=n("code"),ti=r("__call__"),oi=r(" special method."),ni=l(),m(qe.$$.fragment),ai=l(),Qo=n("p"),si=r("Example of single-label classification:"),ri=l(),m(Lt.$$.fragment),ii=l(),m(qt.$$.fragment),di=l(),Yo=n("p"),li=r("Example of multi-label classification:"),ci=l(),m(zt.$$.fragment),pi=l(),m(Bt.$$.fragment),$n=l(),pe=n("h2"),ze=n("a"),Zo=n("span"),m($t.$$.fragment),hi=l(),en=n("span"),ui=r("PLBartForCausalLM"),xn=l(),he=n("div"),m(xt.$$.fragment),mi=l(),H=n("div"),m(Ct.$$.fragment),fi=l(),tn=n("p"),gi=r("Example:"),_i=l(),m(Ft.$$.fragment),this.h()},l(t){const p=Zd('[data-svelte="svelte-1phssyn"]',document.head);u=a(p,"META",{name:!0,content:!0}),p.forEach(o),B=c(t),v=a(t,"H1",{class:!0});var jt=s(v);L=a(jt,"A",{id:!0,class:!0,href:!0});var on=s(L);z=a(on,"SPAN",{});var nn=s(z);f(y.$$.fragment,nn),nn.forEach(o),on.forEach(o),T=c(jt),F=a(jt,"SPAN",{});var vi=s(F);ta=i(vi,"PLBart"),vi.forEach(o),jt.forEach(o),an=c(t),I=a(t,"P",{});var Et=s(I);io=a(Et,"STRONG",{});var yi=s(io);oa=i(yi,"DISCLAIMER:"),yi.forEach(o),na=i(Et," If you see something strange, file a "),Fe=a(Et,"A",{href:!0,rel:!0});var Ti=s(Fe);aa=i(Ti,"Github Issue"),Ti.forEach(o),sa=i(Et,` and assign
`),je=a(Et,"A",{href:!0,rel:!0});var wi=s(je);ra=i(wi,"@gchhablani"),wi.forEach(o),ia=i(Et,"."),Et.forEach(o),sn=c(t),Y=a(t,"H2",{class:!0});var Fn=s(Y);fe=a(Fn,"A",{id:!0,class:!0,href:!0});var Pi=s(fe);lo=a(Pi,"SPAN",{});var Li=s(lo);f(Ee.$$.fragment,Li),Li.forEach(o),Pi.forEach(o),da=c(Fn),co=a(Fn,"SPAN",{});var qi=s(co);la=i(qi,"Overview of PLBart"),qi.forEach(o),Fn.forEach(o),rn=c(t),W=a(t,"P",{});var Qt=s(W);ca=i(Qt,"The PLBART model was proposed in "),Me=a(Qt,"A",{href:!0,rel:!0});var zi=s(Me);pa=i(zi,"Unified Pre-training for Program Understanding and Generation"),zi.forEach(o),ha=i(Qt,` by Wasi Uddin Ahmad, Saikat Chakraborty, Baishakhi Ray, Kai-Wei Chang.
...
target text format is `),_o=a(U,"CODE",{});var Oi=s(_o);$a=i(Oi,"[tgt_lang_code] X [eos]"),Oi.forEach(o),xa=i(U,". "),bo=a(U,"CODE",{});var Ii=s(bo);Ca=i(Ii,"bos"),Ii.forEach(o),Fa=i(U," is never used."),U.forEach(o),un=c(t),_e=a(t,"P",{});var En=s(_e);ja=i(En,"However, for fine-tuning, in some cases no language token is provided in cases where a single language is used. Please refer to "),Oe=a(En,"A",{href:!0,rel:!0});var Di=s(Oe);Ea=i(Di,"the paper"),Di.forEach(o),Ma=i(En," to learn more about this."),En.forEach(o),mn=c(t),R=a(t,"P",{});var Zt=s(R);Sa=i(Zt,"In cases where the language code is needed, The regular "),Ie=a(Zt,"A",{href:!0});var bi=s(Ie);ko=a(bi,"STRONG",{});var Xi=s(ko);Aa=i(Xi,"call"),Xi.forEach(o),Na=i(bi,"()"),bi.forEach(o),Oa=i(Zt,` will encode source text format, and it should be wrapped
inside the context manager `),At=a(Zt,"A",{href:!0});var Wi=s(At);Ia=i(Wi,"as_target_tokenizer()"),Wi.forEach(o),Da=i(Zt," to encode target text format."),Zt.forEach(o),fn=c(t),Nt=a(t,"UL",{});var Gi=s(Nt);vo=a(Gi,"LI",{});var Ri=s(vo);Xa=i(Ri,"Supervised training"),Ri.forEach(o),Gi.forEach(o),gn=c(t),f(De.$$.fragment,t),_n=c(t),Ot=a(t,"UL",{});var Hi=s(Ot);Xe=a(Hi,"LI",{});var Mn=s(Xe);yo=a(Mn,"P",{});var Ui=s(yo);Wa=i(Ui,"Generation"),Ui.forEach(o),Ga=c(Mn),ee=a(Mn,"P",{});var eo=s(ee);Ra=i(eo,"While generating the target text set the "),To=a(eo,"CODE",{});var Vi=s(To);Ha=i(Vi,"decoder_start_token_id"),Vi.forEach(o),Ua=i(eo,` to the target language id. The following
...
separator.`),kd.forEach(o),$e.forEach(o),$.forEach(o),wn=c(t),se=a(t,"H2",{class:!0});var Gn=s(se);ye=a(Gn,"A",{id:!0,class:!0,href:!0});var vd=s(ye);Oo=a(vd,"SPAN",{});var yd=s(Oo);f(st.$$.fragment,yd),yd.forEach(o),vd.forEach(o),Ks=c(Gn),Io=a(Gn,"SPAN",{});var Td=s(Io);Qs=i(Td,"PLBartModel"),Td.forEach(o),Gn.forEach(o),Pn=c(t),S=a(t,"DIV",{class:!0});var xe=s(S);f(rt.$$.fragment,xe),Ys=c(xe),it=a(xe,"P",{});var Rn=s(it);Zs=i(Rn,`The bare PLBART Model outputting raw hidden-states without any specific head on top.
...
This model inherits from `),Ut=a(Vn,"A",{href:!0});var Cd=s(Ut);yr=i(Cd,"PreTrainedModel"),Cd.forEach(o),Tr=i(Vn,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Vn.forEach(o),wr=c(Ce),ft=a(Ce,"P",{});var Jn=s(ft);Pr=i(Jn,"This model is also a PyTorch "),gt=a(Jn,"A",{href:!0,rel:!0});var Fd=s(gt);Lr=i(Fd,"torch.nn.Module"),Fd.forEach(o),qr=i(Jn,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Jn.forEach(o),zr=c(Ce),M=a(Ce,"DIV",{class:!0});var K=s(M);f(_t.$$.fragment,K),Br=c(K),de=a(K,"P",{});var ao=s(de);$r=i(ao,"The "),Vt=a(ao,"A",{href:!0});var jd=s(Vt);xr=i(jd,"PLBartForConditionalGeneration"),jd.forEach(o),Cr=i(ao," forward method, overrides the "),Ro=a(ao,"CODE",{});var Ed=s(Ro);Fr=i(Ed,"__call__"),Ed.forEach(o),jr=i(ao," special method."),ao.forEach(o),Er=c(K),f(Pe.$$.fragment,K),Mr=c(K),Ho=a(K,"P",{});var Md=s(Ho);Sr=i(Md,"Mask-filling example:"),Md.forEach(o),Ar=c(K),f(bt.$$.fragment,K),K.forEach(o),Ce.forEach(o),zn=c(t),le=a(t,"H2",{class:!0});var Kn=s(le);Le=a(Kn,"A",{id:!0,class:!0,href:!0});var Sd=s(Le);Uo=a(Sd,"SPAN",{});var Ad=s(Uo);f(kt.$$.fragment,Ad),Ad.forEach(o),Sd.forEach(o),Nr=c(Kn),Vo=a(Kn,"SPAN",{});var Nd=s(Vo);Or=i(Nd,"PLBartForSequenceClassification"),Nd.forEach(o),Kn.forEach(o),Bn=c(t),C=a(t,"DIV",{class:!0});var Q=s(C);f(vt.$$.fragment,Q),Ir=c(Q),Jo=a(Q,"P",{});var Od=s(Jo);Dr=i(Od,`PLBart model with a sequence classification/head on top (a linear layer on top of the pooled output) e.g. for code
classification.`),Od.forEach(o),Xr=c(Q),yt=a(Q,"P",{});var Qn=s(yt);Wr=i(Qn,"This model inherits from "),Jt=a(Qn,"A",{href:!0});var Id=s(Jt);Gr=i(Id,"PreTrainedModel"),Id.forEach(o),Rr=i(Qn,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
