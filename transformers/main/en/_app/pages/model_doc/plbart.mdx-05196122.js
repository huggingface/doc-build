import{S as Hd,i as Ud,s as Vd,e as n,k as l,w as m,t as r,M as Jd,c as a,d as o,m as c,a as s,x as f,h as i,b as d,F as e,g as h,y as g,q as _,o as b,B as k,v as Kd}from"../../chunks/vendor-6b77c823.js";import{T as fi}from"../../chunks/Tip-39098574.js";import{D as I}from"../../chunks/Docstring-abef54e3.js";import{C as he}from"../../chunks/CodeBlock-3a8b25a8.js";import{I as ue}from"../../chunks/IconCopyLink-7a11ce68.js";function Qd(me){let u,q,v,P,z;return{c(){u=n("p"),q=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),v=n("code"),P=r("Module"),z=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(T){u=a(T,"P",{});var y=s(u);q=i(y,"Although the recipe for forward pass needs to be defined within this function, one should call the "),v=a(y,"CODE",{});var C=s(v);P=i(C,"Module"),C.forEach(o),z=i(y,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
the latter silently ignores them.`)},l(T){u=a(T,"P",{});var y=s(u);q=i(y,"Although the recipe for forward pass needs to be defined within this function, one should call the "),v=a(y,"CODE",{});var C=s(v);P=i(C,"Module"),C.forEach(o),z=i(y,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),y.forEach(o)},m(T,y){h(T,u,y),e(u,q),e(u,v),e(v,P),e(u,z)},d(T){T&&o(u)}}}function el(me){let u,q,v,P,z,T,y,C,Zn,on,O,so,ea,ta,je,oa,na,Fe,aa,sa,nn,Q,fe,ro,Ee,ra,io,ia,an,X,da,Me,la,ca,lo,pa,ha,sn,Ft,ua,rn,Et,co,ma,dn,G,fa,Se,ga,_a,Ae,ba,ka,ln,Y,ge,po,Ne,va,ho,Ta,cn,j,ya,uo,wa,Pa,mo,La,za,fo,qa,Ba,go,$a,xa,pn,_e,Ca,Ie,ja,Fa,hn,R,Ea,Oe,_o,Ma,Sa,Aa,Mt,Na,Ia,un,St,bo,Oa,mn,De,fn,At,Xe,ko,Da,Xa,Z,Ga,vo,Ra,Wa,To,Ha,Ua,gn,Ge,_n,ee,be,yo,Re,Va,wo,Ja,bn,$,We,Ka,te,Qa,Nt,Ya,Za,He,es,ts,os,oe,ns,It,as,ss,Ot,rs,is,ds,Po,ls,cs,Ue,kn,ne,ke,Lo,Ve,ps,zo,hs,vn,w,Je,us,qo,ms,fs,D,gs,Dt,_s,bs,Xt,ks,vs,Ke,Ts,ys,ws,Qe,Ps,Bo,Ls,zs,qs,$o,Bs,$s,Ye,xs,ve,Ze,Cs,xo,js,Fs,N,et,Es,tt,Ms,Co,Ss,As,Ns,ot,nt,jo,Is,Os,Fo,Ds,Xs,at,Eo,Gs,Rs,Mo,Ws,Hs,So,Us,Tn,ae,Te,Ao,st,Vs,No,Js,yn,S,rt,Ks,it,Qs,Gt,Ys,Zs,er,dt,tr,lt,or,nr,ar,F,ct,sr,se,rr,Rt,ir,dr,Io,lr,cr,pr,ye,hr,Oo,ur,mr,pt,wn,re,we,Do,ht,fr,Xo,gr,Pn,A,ut,_r,mt,br,Wt,kr,vr,Tr,ft,yr,gt,wr,Pr,Lr,E,_t,zr,ie,qr,Ht,Br,$r,Go,xr,Cr,jr,Pe,Fr,Ro,Er,Mr,bt,Ln,de,Le,Wo,kt,Sr,Ho,Ar,zn,x,vt,Nr,Uo,Ir,Or,Tt,Dr,Ut,Xr,Gr,Rr,yt,Wr,wt,Hr,Ur,Vr,L,Pt,Jr,le,Kr,Vt,Qr,Yr,Vo,Zr,ei,ti,ze,oi,Jo,ni,ai,Lt,si,Ko,ri,ii,zt,qn,ce,qe,Qo,qt,di,Yo,li,Bn,pe,Bt,ci,W,$t,pi,Zo,hi,ui,xt,$n;return T=new ue({}),Ee=new ue({}),Ne=new ue({}),De=new he({props:{code:`from transformers import PLBartForConditionalGeneration, PLBartTokenizer
...
<span class="hljs-literal">True</span>`}}),{c(){u=n("meta"),q=l(),v=n("h1"),P=n("a"),z=n("span"),m(T.$$.fragment),y=l(),C=n("span"),Zn=r("PLBart"),on=l(),O=n("p"),so=n("strong"),ea=r("DISCLAIMER:"),ta=r(" If you see something strange, file a "),je=n("a"),oa=r("Github Issue"),na=r(` and assign
`),Fe=n("a"),aa=r("@gchhablani"),sa=r("."),nn=l(),Q=n("h2"),fe=n("a"),ro=n("span"),m(Ee.$$.fragment),ra=l(),io=n("span"),ia=r("Overview of PLBart"),an=l(),X=n("p"),da=r("The PLBART model was proposed in "),Me=n("a"),la=r("Unified Pre-training for Program Understanding and Generation"),ca=r(` by Wasi Uddin Ahmad, Saikat Chakraborty, Baishakhi Ray, Kai-Wei Chang.
...
inside the context manager `),Mt=n("a"),Na=r("as_target_tokenizer()"),Ia=r(" to encode target text format."),un=l(),St=n("ul"),bo=n("li"),Oa=r("Supervised training"),mn=l(),m(De.$$.fragment),fn=l(),At=n("ul"),Xe=n("li"),ko=n("p"),Da=r("Generation"),Xa=l(),Z=n("p"),Ga=r("While generating the target text set the "),vo=n("code"),Ra=r("decoder_start_token_id"),Wa=r(` to the target language id. The following
example shows how to translate Python to English using the `),To=n("code"),Ha=r("uclanlp/plbart-python-en_XX"),Ua=r(" model."),gn=l(),m(Ge.$$.fragment),_n=l(),ee=n("h2"),be=n("a"),yo=n("span"),m(Re.$$.fragment),Va=l(),wo=n("span"),Ja=r("PLBartConfig"),bn=l(),$=n("div"),m(We.$$.fragment),Ka=l(),te=n("p"),Qa=r("This is the configuration class to store the configuration of a "),Nt=n("a"),Ya=r("PLBartModel"),Za=r(`. It is used to instantiate an
...
`),He=n("a"),es=r("uclanlp/plbart-base"),ts=r(" architecture."),os=l(),oe=n("p"),ns=r("Configuration objects inherit from "),It=n("a"),as=r("PretrainedConfig"),ss=r(` and can be used to control the model outputs. Read the
documentation from `),Ot=n("a"),rs=r("PretrainedConfig"),is=r(" for more information."),ds=l(),Po=n("p"),ls=r("Example:"),cs=l(),m(Ue.$$.fragment),kn=l(),ne=n("h2"),ke=n("a"),Lo=n("span"),m(Ve.$$.fragment),ps=l(),zo=n("span"),hs=r("PLBartTokenizer"),vn=l(),w=n("div"),m(Je.$$.fragment),us=l(),qo=n("p"),ms=r("Construct an PLBART tokenizer."),fs=l(),D=n("p"),gs=r("Adapted from "),Dt=n("a"),_s=r("RobertaTokenizer"),bs=r(" and "),Xt=n("a"),ks=r("XLNetTokenizer"),vs=r(`. Based on
...
separator.`),Tn=l(),ae=n("h2"),Te=n("a"),Ao=n("span"),m(st.$$.fragment),Vs=l(),No=n("span"),Js=r("PLBartModel"),yn=l(),S=n("div"),m(rt.$$.fragment),Ks=l(),it=n("p"),Qs=r(`The bare PLBART Model outputting raw hidden-states without any specific head on top.
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Vr=l(),L=n("div"),m(Pt.$$.fragment),Jr=l(),le=n("p"),Kr=r("The "),Vt=n("a"),Qr=r("PLBartForSequenceClassification"),Yr=r(" forward method, overrides the "),Vo=n("code"),Zr=r("__call__"),ei=r(" special method."),ti=l(),m(ze.$$.fragment),oi=l(),Jo=n("p"),ni=r("Example of single-label classification:"),ai=l(),m(Lt.$$.fragment),si=l(),Ko=n("p"),ri=r("Example of multi-label classification:"),ii=l(),m(zt.$$.fragment),qn=l(),ce=n("h2"),qe=n("a"),Qo=n("span"),m(qt.$$.fragment),di=l(),Yo=n("span"),li=r("PLBartForCausalLM"),Bn=l(),pe=n("div"),m(Bt.$$.fragment),ci=l(),W=n("div"),m($t.$$.fragment),pi=l(),Zo=n("p"),hi=r("Example:"),ui=l(),m(xt.$$.fragment),this.h()},l(t){const p=Jd('[data-svelte="svelte-1phssyn"]',document.head);u=a(p,"META",{name:!0,content:!0}),p.forEach(o),q=c(t),v=a(t,"H1",{class:!0});var Ct=s(v);P=a(Ct,"A",{id:!0,class:!0,href:!0});var en=s(P);z=a(en,"SPAN",{});var tn=s(z);f(T.$$.fragment,tn),tn.forEach(o),en.forEach(o),y=c(Ct),C=a(Ct,"SPAN",{});var gi=s(C);Zn=i(gi,"PLBart"),gi.forEach(o),Ct.forEach(o),on=c(t),O=a(t,"P",{});var jt=s(O);so=a(jt,"STRONG",{});var _i=s(so);ea=i(_i,"DISCLAIMER:"),_i.forEach(o),ta=i(jt," If you see something strange, file a "),je=a(jt,"A",{href:!0,rel:!0});var bi=s(je);oa=i(bi,"Github Issue"),bi.forEach(o),na=i(jt,` and assign
`),Fe=a(jt,"A",{href:!0,rel:!0});var ki=s(Fe);aa=i(ki,"@gchhablani"),ki.forEach(o),sa=i(jt,"."),jt.forEach(o),nn=c(t),Q=a(t,"H2",{class:!0});var xn=s(Q);fe=a(xn,"A",{id:!0,class:!0,href:!0});var vi=s(fe);ro=a(vi,"SPAN",{});var Ti=s(ro);f(Ee.$$.fragment,Ti),Ti.forEach(o),vi.forEach(o),ra=c(xn),io=a(xn,"SPAN",{});var yi=s(io);ia=i(yi,"Overview of PLBart"),yi.forEach(o),xn.forEach(o),an=c(t),X=a(t,"P",{});var Jt=s(X);da=i(Jt,"The PLBART model was proposed in "),Me=a(Jt,"A",{href:!0,rel:!0});var wi=s(Me);la=i(wi,"Unified Pre-training for Program Understanding and Generation"),wi.forEach(o),ca=i(Jt,` by Wasi Uddin Ahmad, Saikat Chakraborty, Baishakhi Ray, Kai-Wei Chang.
...
Furthermore, analysis reveals that PLBART learns program syntax, style (e.g., identifier naming convention), logical flow
(e.g., if block inside an else block is equivalent to else if block) that are crucial to program semantics and thus excels
even with limited annotations.`),qi.forEach(o),zi.forEach(o),dn=c(t),G=a(t,"P",{});var Kt=s(G);fa=i(Kt,"This model was contributed by "),Se=a(Kt,"A",{href:!0,rel:!0});var Bi=s(Se);ga=i(Bi,"gchhablani"),Bi.forEach(o),_a=i(Kt,". The Authors\u2019 code can be found "),Ae=a(Kt,"A",{href:!0,rel:!0});var $i=s(Ae);ba=i($i,"here"),$i.forEach(o),ka=i(Kt,"."),Kt.forEach(o),ln=c(t),Y=a(t,"H3",{class:!0});var Cn=s(Y);ge=a(Cn,"A",{id:!0,class:!0,href:!0});var xi=s(ge);po=a(xi,"SPAN",{});var Ci=s(po);f(Ne.$$.fragment,Ci),Ci.forEach(o),xi.forEach(o),va=c(Cn),ho=a(Cn,"SPAN",{});var ji=s(ho);Ta=i(ji,"Training of PLBart"),ji.forEach(o),Cn.forEach(o),cn=c(t),j=a(t,"P",{});var H=s(j);ya=i(H,`PLBart is a multilingual encoder-decoder (sequence-to-sequence) model primarily intended for code-to-text, text-to-code, code-to-code tasks. As the
model is multilingual it expects the sequences in a different format. A special language id token is added in both the
...
inside the context manager `),Mt=a(Qt,"A",{href:!0});var Ii=s(Mt);Na=i(Ii,"as_target_tokenizer()"),Ii.forEach(o),Ia=i(Qt," to encode target text format."),Qt.forEach(o),un=c(t),St=a(t,"UL",{});var Oi=s(St);bo=a(Oi,"LI",{});var Di=s(bo);Oa=i(Di,"Supervised training"),Di.forEach(o),Oi.forEach(o),mn=c(t),f(De.$$.fragment,t),fn=c(t),At=a(t,"UL",{});var Xi=s(At);Xe=a(Xi,"LI",{});var Fn=s(Xe);ko=a(Fn,"P",{});var Gi=s(ko);Da=i(Gi,"Generation"),Gi.forEach(o),Xa=c(Fn),Z=a(Fn,"P",{});var Yt=s(Z);Ga=i(Yt,"While generating the target text set the "),vo=a(Yt,"CODE",{});var Ri=s(vo);Ra=i(Ri,"decoder_start_token_id"),Ri.forEach(o),Wa=i(Yt,` to the target language id. The following
example shows how to translate Python to English using the `),To=a(Yt,"CODE",{});var Wi=s(To);Ha=i(Wi,"uclanlp/plbart-python-en_XX"),Wi.forEach(o),Ua=i(Yt," model."),Yt.forEach(o),Fn.forEach(o),Xi.forEach(o),gn=c(t),f(Ge.$$.fragment,t),_n=c(t),ee=a(t,"H2",{class:!0});var En=s(ee);be=a(En,"A",{id:!0,class:!0,href:!0});var Hi=s(be);yo=a(Hi,"SPAN",{});var Ui=s(yo);f(Re.$$.fragment,Ui),Ui.forEach(o),Hi.forEach(o),Va=c(En),wo=a(En,"SPAN",{});var Vi=s(wo);Ja=i(Vi,"PLBartConfig"),Vi.forEach(o),En.forEach(o),bn=c(t),$=a(t,"DIV",{class:!0});var U=s($);f(We.$$.fragment,U),Ka=c(U),te=a(U,"P",{});var Zt=s(te);Qa=i(Zt,"This is the configuration class to store the configuration of a "),Nt=a(Zt,"A",{href:!0});var Ji=s(Nt);Ya=i(Ji,"PLBartModel"),Ji.forEach(o),Za=i(Zt,`. It is used to instantiate an
PLBART model according to the specified arguments, defining the model architecture. Instantiating a configuration
with the defaults will yield a similar configuration to that of the PLBART
`),He=a(Zt,"A",{href:!0,rel:!0});var Ki=s(He);es=i(Ki,"uclanlp/plbart-base"),Ki.forEach(o),ts=i(Zt," architecture."),Zt.forEach(o),os=c(U),oe=a(U,"P",{});var eo=s(oe);ns=i(eo,"Configuration objects inherit from "),It=a(eo,"A",{href:!0});var Qi=s(It);as=i(Qi,"PretrainedConfig"),Qi.forEach(o),ss=i(eo,` and can be used to control the model outputs. Read the
documentation from `),Ot=a(eo,"A",{href:!0});var Yi=s(Ot);rs=i(Yi,"PretrainedConfig"),Yi.forEach(o),is=i(eo," for more information."),eo.forEach(o),ds=c(U),Po=a(U,"P",{});var Zi=s(Po);ls=i(Zi,"Example:"),Zi.forEach(o),cs=c(U),f(Ue.$$.fragment,U),U.forEach(o),kn=c(t),ne=a(t,"H2",{class:!0});var Mn=s(ne);ke=a(Mn,"A",{id:!0,class:!0,href:!0});var ed=s(ke);Lo=a(ed,"SPAN",{});var td=s(Lo);f(Ve.$$.fragment,td),td.forEach(o),ed.forEach(o),ps=c(Mn),zo=a(Mn,"SPAN",{});var od=s(zo);hs=i(od,"PLBartTokenizer"),od.forEach(o),Mn.forEach(o),vn=c(t),w=a(t,"DIV",{class:!0});var B=s(w);f(Je.$$.fragment,B),us=c(B),qo=a(B,"P",{});var nd=s(qo);ms=i(nd,"Construct an PLBART tokenizer."),nd.forEach(o),fs=c(B),D=a(B,"P",{});var Be=s(D);gs=i(Be,"Adapted from "),Dt=a(Be,"A",{href:!0});var ad=s(Dt);_s=i(ad,"RobertaTokenizer"),ad.forEach(o),bs=i(Be," and "),Xt=a(Be,"A",{href:!0});var sd=s(Xt);ks=i(sd,"XLNetTokenizer"),sd.forEach(o),vs=i(Be,`. Based on
...
separator.`),fd.forEach(o),$e.forEach(o),B.forEach(o),Tn=c(t),ae=a(t,"H2",{class:!0});var Xn=s(ae);Te=a(Xn,"A",{id:!0,class:!0,href:!0});var gd=s(Te);Ao=a(gd,"SPAN",{});var _d=s(Ao);f(st.$$.fragment,_d),_d.forEach(o),gd.forEach(o),Vs=c(Xn),No=a(Xn,"SPAN",{});var bd=s(No);Js=i(bd,"PLBartModel"),bd.forEach(o),Xn.forEach(o),yn=c(t),S=a(t,"DIV",{class:!0});var xe=s(S);f(rt.$$.fragment,xe),Ks=c(xe),it=a(xe,"P",{});var Gn=s(it);Qs=i(Gn,`The bare PLBART Model outputting raw hidden-states without any specific head on top.
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Rn.forEach(o),ar=c(xe),F=a(xe,"DIV",{class:!0});var V=s(F);f(ct.$$.fragment,V),sr=c(V),se=a(V,"P",{});var to=s(se);rr=i(to,"The "),Rt=a(to,"A",{href:!0});var Td=s(Rt);ir=i(Td,"PLBartModel"),Td.forEach(o),dr=i(to," forward method, overrides the "),Io=a(to,"CODE",{});var yd=s(Io);lr=i(yd,"__call__"),yd.forEach(o),cr=i(to," special method."),to.forEach(o),pr=c(V),f(ye.$$.fragment,V),hr=c(V),Oo=a(V,"P",{});var wd=s(Oo);ur=i(wd,"Example:"),wd.forEach(o),mr=c(V),f(pt.$$.fragment,V),V.forEach(o),xe.forEach(o),wn=c(t),re=a(t,"H2",{class:!0});var Wn=s(re);we=a(Wn,"A",{id:!0,class:!0,href:!0});var Pd=s(we);Do=a(Pd,"SPAN",{});var Ld=s(Do);f(ht.$$.fragment,Ld),Ld.forEach(o),Pd.forEach(o),fr=c(Wn),Xo=a(Wn,"SPAN",{});var zd=s(Xo);gr=i(zd,"PLBartForConditionalGeneration"),zd.forEach(o),Wn.forEach(o),Pn=c(t),A=a(t,"DIV",{class:!0});var Ce=s(A);f(ut.$$.fragment,Ce),_r=c(Ce),mt=a(Ce,"P",{});var Hn=s(mt);br=i(Hn,`The PLBART Model with a language modeling head. Can be used for code-to-text, text-to-code and code-to-code.
