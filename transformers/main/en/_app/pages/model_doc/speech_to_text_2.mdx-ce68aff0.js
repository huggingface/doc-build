...
methods above for more information.`),b.forEach(o),this.h()},h(){c(k,"href","/docs/transformers/main/en/main_classes/feature_extractor#transformers.FeatureExtractionMixin.from_pretrained")},m(P,b){h(P,m,b),e(m,W),e(m,k),e(k,E),e(m,L),e(m,w),e(w,B),e(m,D)},d(P){P&&o(m)}}}function mc(gt){let m,W,k,E,L,w,B,D;return{c(){m=r("p"),W=s("This class method is simply calling "),k=r("a"),E=s("save_pretrained()"),L=s(` and
`),w=r("code"),B=s("save_pretrained"),D=s(`. Please refer to the docstrings of the methods
above for more information.`),this.h()},l(P){m=n(P,"P",{});var b=i(m);W=a(b,"This class method is simply calling "),k=n(b,"A",{href:!0});var j=i(k);E=a(j,"save_pretrained()"),j.forEach(o),L=a(b,` and
`),w=n(b,"CODE",{});var q=i(w);B=a(q,"save_pretrained"),q.forEach(o),D=a(b,`. Please refer to the docstrings of the methods
above for more information.`),b.forEach(o),this.h()},h(){c(k,"href","/docs/transformers/main/en/main_classes/feature_extractor#transformers.FeatureExtractionMixin.save_pretrained")},m(P,b){h(P,m,b),e(m,W),e(m,k),e(k,E),e(m,L),e(m,w),e(w,B),e(m,D)},d(P){P&&o(m)}}}function fc(gt){let m,W,k,E,L,w,B,D,P,b,j,q,so,ye,js,ao,Cs,Lo,H,qs,vt,Ms,Fs,$e,As,Ls,Do,S,Ds,ro,Is,Ws,no,Vs,Ns,Tt,Bs,Os,kt,Us,Rs,xt,Hs,Js,io,Gs,Ks,Io,ie,Qs,Ee,Xs,Ys,Wo,ce,Zs,ze,ea,ta,Vo,bt,oa,No,J,Pe,sa,je,aa,ra,na,Ce,ia,wt,ca,la,da,qe,pa,Me,ha,ma,Bo,ee,le,co,Fe,fa,lo,ua,Oo,G,_a,St,ga,va,yt,Ta,ka,Uo,z,xa,$t,ba,wa,Et,Sa,ya,zt,$a,Ea,Pt,za,Pa,jt,ja,Ca,Ro,Ct,po,qa,Ho,Ae,Jo,qt,Le,ho,Ma,Fa,mo,Aa,Go,De,Ko,de,La,Ie,Da,Ia,Qo,te,pe,fo,We,Wa,uo,Va,Xo,C,Ve,Na,oe,Ba,Mt,Oa,Ua,Ne,Ra,Ha,Ja,se,Ga,Ft,Ka,Qa,At,Xa,Ya,Za,_o,er,tr,Be,Yo,ae,he,go,Oe,or,vo,sr,Zo,$,Ue,ar,To,rr,nr,Re,ir,Lt,cr,lr,dr,me,He,pr,ko,hr,mr,K,Je,fr,xo,ur,_r,Ge,gr,bo,vr,Tr,kr,Dt,Ke,es,re,fe,wo,Qe,xr,So,br,ts,x,Xe,wr,yo,Sr,yr,M,It,$r,Er,Wt,zr,Pr,Vt,jr,Cr,Ye,$o,qr,Mr,Fr,Nt,Ar,Lr,Dr,ue,Ze,Ir,O,Wr,Eo,Vr,Nr,Bt,Br,Or,et,zo,Ur,Rr,Hr,Jr,Q,tt,Gr,Po,Kr,Qr,_e,Xr,X,ot,Yr,st,Zr,Ot,en,tn,on,ge,sn,ve,at,an,rt,rn,Ut,nn,cn,ln,Te,nt,dn,it,pn,Rt,hn,mn,fn,ke,ct,un,jo,_n,os,ne,xe,Co,lt,gn,qo,vn,ss,I,dt,Tn,U,kn,Ht,xn,bn,Mo,wn,Sn,Jt,yn,$n,En,pt,zn,ht,Pn,jn,Cn,Y,mt,qn,Fo,Mn,Fn,ft,as;return w=new _t({}),ye=new _t({}),Fe=new _t({}),Ae=new Ps({props:{code:`import torch
...
<span class="hljs-meta">&gt;&gt;&gt; </span>loss.backward()`}}),{c(){m=r("meta"),W=l(),k=r("h1"),E=r("a"),L=r("span"),f(w.$$.fragment),B=l(),D=r("span"),P=s("Speech2Text2"),b=l(),j=r("h2"),q=r("a"),so=r("span"),f(ye.$$.fragment),js=l(),ao=r("span"),Cs=s("Overview"),Lo=l(),H=r("p"),qs=s("The Speech2Text2 model is used together with "),vt=r("a"),Ms=s("Wav2Vec2"),Fs=s(` for Speech Translation models proposed in
...
the `),je=r("a"),aa=s("official models"),ra=s(" ."),na=l(),Ce=r("li"),ia=s("Speech2Text2 is always used within the "),wt=r("a"),ca=s("SpeechEncoderDecoder"),la=s(" framework."),da=l(),qe=r("li"),pa=s("Speech2Text2\u2019s tokenizer is based on "),Me=r("a"),ha=s("fastBPE"),ma=s("."),Bo=l(),ee=r("h2"),le=r("a"),co=r("span"),f(Fe.$$.fragment),fa=l(),lo=r("span"),ua=s("Inference"),Oo=l(),G=r("p"),_a=s("Speech2Text2\u2019s "),St=r("a"),ga=s("SpeechEncoderDecoderModel"),va=s(` model accepts raw waveform input values from speech and
...
documentation from `),At=r("a"),Xa=s("PretrainedConfig"),Ya=s(" for more information."),Za=l(),_o=r("p"),er=s("Example:"),tr=l(),f(Be.$$.fragment),Yo=l(),ae=r("h2"),he=r("a"),go=r("span"),f(Oe.$$.fragment),or=l(),vo=r("span"),sr=s("Speech2TextTokenizer"),Zo=l(),$=r("div"),f(Ue.$$.fragment),ar=l(),To=r("p"),rr=s("Constructs a Speech2Text2Tokenizer."),nr=l(),Re=r("p"),ir=s("This tokenizer inherits from "),Lt=r("a"),cr=s("PreTrainedTokenizer"),lr=s(` which contains some of the main methods. Users should refer to
the superclass for more information regarding such methods.`),dr=l(),me=r("div"),f(He.$$.fragment),pr=l(),ko=r("p"),hr=s("Convert a list of lists of token ids into a list of strings by calling decode."),mr=l(),K=r("div"),f(Je.$$.fragment),fr=l(),xo=r("p"),ur=s(`Converts a sequence of ids in a string, using the tokenizer and vocabulary with options to remove special
tokens and clean up tokenization spaces.`),_r=l(),Ge=r("p"),gr=s("Similar to doing "),bo=r("code"),vr=s("self.convert_tokens_to_string(self.convert_ids_to_tokens(token_ids))"),Tr=s("."),kr=l(),Dt=r("div"),f(Ke.$$.fragment),es=l(),re=r("h2"),fe=r("a"),wo=r("span"),f(Qe.$$.fragment),xr=l(),So=r("span"),br=s("Speech2Text2Processor"),ts=l(),x=r("div"),f(Xe.$$.fragment),wr=l(),yo=r("p"),Sr=s(`Constructs a Speech2Text2 processor which wraps a Speech2Text2 feature extractor and a Speech2Text2 tokenizer into
...
See the `),Ye=r("a"),$o=r("strong"),qr=s("call"),Mr=s("()"),Fr=s(" and "),Nt=r("a"),Ar=s("decode()"),Lr=s(" for more information."),Dr=l(),ue=r("div"),f(Ze.$$.fragment),Ir=l(),O=r("p"),Wr=s(`When used in normal mode, this method forwards all its arguments to AutoFeatureExtractor\u2019s
...
can be reloaded using the `),Ot=r("a"),en=s("from_pretrained()"),tn=s(" method."),on=l(),f(ge.$$.fragment),sn=l(),ve=r("div"),f(at.$$.fragment),an=l(),rt=r("p"),rn=s("This method forwards all its arguments to Speech2Text2Tokenizer\u2019s "),Ut=r("a"),nn=s("batch_decode()"),cn=s(`. Please
refer to the docstring of this method for more information.`),ln=l(),Te=r("div"),f(nt.$$.fragment),dn=l(),it=r("p"),pn=s("This method forwards all its arguments to Speech2Text2Tokenizer\u2019s "),Rt=r("a"),hn=s("decode()"),mn=s(`. Please refer
to the docstring of this method for more information.`),fn=l(),ke=r("div"),f(ct.$$.fragment),un=l(),jo=r("p"),_n=s(`Temporarily sets the tokenizer for processing the input. Useful for encoding the labels when fine-tuning
Speech2Text2.`),os=l(),ne=r("h2"),xe=r("a"),Co=r("span"),f(lt.$$.fragment),gn=l(),qo=r("span"),vn=s("Speech2Text2ForCausalLM"),ss=l(),I=r("div"),f(dt.$$.fragment),Tn=l(),U=r("p"),kn=s("The Speech2Text2 Decoder with a language modeling head. Can be used as the decoder part of "),Ht=r("a"),xn=s("EncoderDecoderModel"),bn=s(" and "),Mo=r("code"),wn=s("SpeechEncoderDecoder"),Sn=s(`.
...
the superclass for more information regarding such methods.`),_s.forEach(o),dr=d(N),me=n(N,"DIV",{class:!0});var gs=i(me);u(He.$$.fragment,gs),pr=d(gs),ko=n(gs,"P",{});var Ci=i(ko);hr=a(Ci,"Convert a list of lists of token ids into a list of strings by calling decode."),Ci.forEach(o),gs.forEach(o),mr=d(N),K=n(N,"DIV",{class:!0});var Zt=i(K);u(Je.$$.fragment,Zt),fr=d(Zt),xo=n(Zt,"P",{});var qi=i(xo);ur=a(qi,`Converts a sequence of ids in a string, using the tokenizer and vocabulary with options to remove special
tokens and clean up tokenization spaces.`),qi.forEach(o),_r=d(Zt),Ge=n(Zt,"P",{});var vs=i(Ge);gr=a(vs,"Similar to doing "),bo=n(vs,"CODE",{});var Mi=i(bo);vr=a(Mi,"self.convert_tokens_to_string(self.convert_ids_to_tokens(token_ids))"),Mi.forEach(o),Tr=a(vs,"."),vs.forEach(o),Zt.forEach(o),kr=d(N),Dt=n(N,"DIV",{class:!0});var Fi=i(Dt);u(Ke.$$.fragment,Fi),Fi.forEach(o),N.forEach(o),es=d(t),re=n(t,"H2",{class:!0});var Ts=i(re);fe=n(Ts,"A",{id:!0,class:!0,href:!0});var Ai=i(fe);wo=n(Ai,"SPAN",{});var Li=i(wo);u(Qe.$$.fragment,Li),Li.forEach(o),Ai.forEach(o),xr=d(Ts),So=n(Ts,"SPAN",{});var Di=i(So);br=a(Di,"Speech2Text2Processor"),Di.forEach(o),Ts.forEach(o),ts=d(t),x=n(t,"DIV",{class:!0});var y=i(x);u(Xe.$$.fragment,y),wr=d(y),yo=n(y,"P",{});var Ii=i(yo);Sr=a(Ii,`Constructs a Speech2Text2 processor which wraps a Speech2Text2 feature extractor and a Speech2Text2 tokenizer into
...
refer to the docstring of this method for more information.`),ws.forEach(o),bs.forEach(o),ln=d(y),Te=n(y,"DIV",{class:!0});var Ss=i(Te);u(nt.$$.fragment,Ss),dn=d(Ss),it=n(Ss,"P",{});var ys=i(it);pn=a(ys,"This method forwards all its arguments to Speech2Text2Tokenizer\u2019s "),Rt=n(ys,"A",{href:!0});var Qi=i(Rt);hn=a(Qi,"decode()"),Qi.forEach(o),mn=a(ys,`. Please refer
to the docstring of this method for more information.`),ys.forEach(o),Ss.forEach(o),fn=d(y),ke=n(y,"DIV",{class:!0});var $s=i(ke);u(ct.$$.fragment,$s),un=d($s),jo=n($s,"P",{});var Xi=i(jo);_n=a(Xi,`Temporarily sets the tokenizer for processing the input. Useful for encoding the labels when fine-tuning
