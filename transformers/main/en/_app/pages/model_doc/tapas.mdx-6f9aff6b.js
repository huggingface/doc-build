import{S as Uy,i as Ry,s as Gy,e as n,k as d,w as $,t as s,M as By,c as o,d as t,m as p,a as r,x as E,h as a,b as h,N as Vy,F as e,g as m,y as F,q as A,o as z,B as x,v as Ky,L as ro}from"../../chunks/vendor-6b77c823.js";import{T as Ms}from"../../chunks/Tip-39098574.js";import{D as He}from"../../chunks/Docstring-af1d0ae0.js";import{C as Ve}from"../../chunks/CodeBlock-3a8b25a8.js";import{I as Rt}from"../../chunks/IconCopyLink-7a11ce68.js";import{F as Cc,M as io}from"../../chunks/Markdown-4489c441.js";function Yy(U){let l,_,c,f,v,b,T,k,y,D,q,H,B,V,R,K,re,I,O;return T=new Ve({props:{code:`from transformers import TapasConfig, TapasForQuestionAnswering
...
<span class="hljs-meta">... </span>    tf.TensorSpec(shape=(<span class="hljs-number">512</span>,), dtype=tf.float32),
<span class="hljs-meta">... </span>)
<span class="hljs-meta">&gt;&gt;&gt; </span>train_dataloader = tf.data.Dataset.from_generator(train_dataset, output_signature=output_signature).batch(<span class="hljs-number">32</span>)`}}),{c(){l=n("p"),_=s("Third, given that you\u2019ve prepared your data in this TSV/CSV format (and corresponding CSV files containing the tabular data), you can then use "),c=n("a"),f=s("TapasTokenizer"),v=s(" to convert table-question pairs into "),b=n("code"),T=s("input_ids"),k=s(", "),y=n("code"),D=s("attention_mask"),q=s(", "),H=n("code"),B=s("token_type_ids"),V=s(" and so on. Again, based on which of the three cases you picked above, "),R=n("a"),K=s("TFTapasForQuestionAnswering"),re=s(` requires different
inputs to be fine-tuned:`),I=d(),O=n("table"),w=n("thead"),M=n("tr"),G=n("th"),C=n("strong"),N=s("Task"),ee=d(),te=n("th"),ce=n("strong"),ne=s("Required inputs"),se=d(),P=n("tbody"),L=n("tr"),W=n("td"),X=s("Conversational"),Q=d(),Y=n("td"),ge=n("code"),me=s("input_ids"),_e=s(", "),ue=n("code"),oe=s("attention_mask"),qe=s(", "),ie=n("code"),be=s("token_type_ids"),g=s(", "),S=n("code"),ve=s("labels"),ze=d(),we=n("tr"),le=n("td"),xe=s("Weak supervision for aggregation"),Me=d(),Z=n("td"),de=n("code"),pe=s("input_ids"),De=s(", "),je=n("code"),Te=s("attention_mask"),Ne=s(", "),ye=n("code"),Ae=s("token_type_ids"),Oe=s(", "),Ze=n("code"),Ps=s("labels"),Ss=s(", "),mt=n("code"),ut=s("numeric_values"),pa=s(", "),ft=n("code"),gt=s("numeric_values_scale"),Ds=s(", "),tt=n("code"),Ns=s("float_answer"),Os=d(),Ke=n("tr"),Pe=n("td"),Ls=s("Strong supervision for aggregation"),wt=d(),ke=n("td"),yt=n("code"),kt=s("input ids"),Qs=s(", "),qt=n("code"),jt=s("attention mask"),Is=s(", "),$t=n("code"),vs=s("token type ids"),Gt=s(", "),Et=n("code"),bs=s("labels"),Ye=s(", "),$e=n("code"),Ws=s("aggregation_labels"),Ft=d(),ae=n("p"),nt=n("a"),Bt=s("TapasTokenizer"),Hs=s(" creates the "),At=n("code"),ns=s("labels"),Us=s(", "),zt=n("code"),xt=s("numeric_values"),Rs=s(" and "),Ct=n("code"),os=s("numeric_values_scale"),Gs=s(" based on the "),Mt=n("code"),rs=s("answer_coordinates"),Bs=s(" and "),Pt=n("code"),Vs=s("answer_text"),Le=s(" columns of the TSV file. The "),St=n("code"),is=s("float_answer"),Ks=s(" and "),Dt=n("code"),ls=s("aggregation_labels"),Ys=s(" are already in the TSV file of step 2. Here\u2019s an example:"),ds=d(),$(Ue.$$.fragment),ps=d(),Ee=n("p"),cs=s("Note that "),ot=n("a"),Js=s("TapasTokenizer"),Nt=s(" expects the data of the table to be "),Ot=n("strong"),Xs=s("text-only"),Zs=s(". You can use "),Re=n("code"),ea=s(".astype(str)"),hs=s(` on a dataframe to turn it into text-only data.
...
`),ie=o(Ae,"CODE",{});var Oe=r(ie);be=a(Oe,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),Oe.forEach(t),Ae.forEach(t),de.forEach(t)},m(g,S){m(g,l,S),e(l,_),m(g,c,S),m(g,f,S),e(f,v),e(v,b),e(f,T),e(f,k),e(k,y),m(g,D,S),m(g,q,S),e(q,H),e(q,B),e(B,V),e(q,R),e(q,K),e(K,re),e(q,I),m(g,O,S),m(g,w,S),e(w,M),m(g,G,S),m(g,C,S),e(C,N),e(N,ee),e(N,te),e(te,ce),e(N,ne),e(N,se),e(se,P),e(C,L),e(C,W),e(W,X),e(W,Q),e(Q,Y),e(W,ge),e(W,me),e(me,_e),e(C,ue),e(C,oe),e(oe,qe),e(oe,ie),e(ie,be)},d(g){g&&t(l),g&&t(c),g&&t(f),g&&t(D),g&&t(q),g&&t(O),g&&t(w),g&&t(G),g&&t(C)}}}function _k(U){let l,_,c,f,v;return{c(){l=n("p"),_=s("Although the recipe for forward pass needs to be defined within this function, one should call the "),c=n("code"),f=s("Module"),v=s(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(b){l=o(b,"P",{});var T=r(l);_=a(T,"Although the recipe for forward pass needs to be defined within this function, one should call the "),c=o(T,"CODE",{});var k=r(c);f=a(k,"Module"),k.forEach(t),v=a(T,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
the latter silently ignores them.`)},l(b){l=o(b,"P",{});var T=r(l);_=a(T,"Although the recipe for forward pass needs to be defined within this function, one should call the "),c=o(T,"CODE",{});var k=r(c);f=a(k,"Module"),k.forEach(t),v=a(T,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),T.forEach(t)},m(b,T){m(b,l,T),e(l,_),e(l,c),e(c,f),e(l,v)},d(b){b&&t(l)}}}function qk(U){let l,_,c,f,v,b,T,k,y,D,q,H,B,V,R,K,re,I,O,w,M,G,C,N,ee,te,ce,ne,se,P,L,W,X,Q,Y,ge,me,_e,ue,oe,qe,ie,be,g,S,ve,ze,we,le,xe,Me,Z,de,pe,De,je,Te,Ne,ye,Ae,Oe,Ze,Ps,Ss,mt,ut,pa,ft,gt,Ds,tt,Ns,Os,Ke,Pe,Ls,wt,ke,yt,kt,Qs,qt,jt,Is,$t,vs,Gt,Et,bs,Ye,$e,Ws,Ft,ae,nt,Bt,Hs,At,ns,Us,zt,xt,Rs,Ct,os,Gs,Mt,rs,Bs,Pt,Vs,Le,St,is,Ks,Dt,ls,Ys,ds,Ue,ps,Ee,cs,ot,Js,Nt,Ot,Xs,Zs,Re,ea,hs,ms,et,Lt,j,J,xa,ta,Ca,ca,Qt,st,sa,rt,Ma,aa,Pa,ha,Ie,us,ws,Ge,Sa,ma,ys,na,fs,ua,fe,Da,ks,Na,Oa,fa,_t,oa,gs,La,Fe,Qa,ra,Ia,Wa,Ha,he,Ua,ia,Ra,Ga,ga,qs,Ba,_a,Ce,la,It,da,Ki,Mc,Pc,Yi,Ji,Sc,Dc,Xi,Zi,Nc,Oc,Va,Ka,el,Lc,Qc,tl,Ic,Wc,sl,Hc,Uc,Ya,al,Rc,Gc,nl,Bc,Vc,ol,Kc,Yc,Ja,rl,Jc,Xc,il,Zc,eh,ll,th,sp,qn,ap,jn,sh,lo,ah,nh,np,$n,oh,po,rh,ih,op,Hr,dl,lh,rp,En,dh,co,ph,ch,ip,We,Ur,pl,hh,mh,uh,Rr,cl,fh,gh,_h,Gr,hl,Th,vh,bh,Br,ml,wh,yh,kh,Vr,ul,qh,jh,$h,Kr,fl,Eh,Fh,Ah,Yr,gl,zh,xh,Ch,Jr,_l,Mh,Ph,Sh,Xr,Tl,Dh,Nh,lp,Tt,Oh,ho,Lh,Qh,mo,Ih,Wh,vl,Hh,Uh,bl,Rh,Gh,wl,Bh,Vh,dp,Zr,yl,Kh,pp,Fn,cp,Se,Yh,kl,Jh,Xh,ql,Zh,em,jl,tm,sm,$l,am,nm,El,om,rm,Fl,im,lm,ei,dm,pm,uo,cm,hm,fo,mm,um,hp,ti,fm,mp,An,up,Xa,zn,Al,go,gm,zl,_m,fp,xn,gp,vt,Tm,xl,vm,bm,Cl,wm,ym,Ml,km,qm,_o,jm,$m,To,Em,Fm,_p,Za,Cn,Pl,vo,Am,Sl,zm,Tp,en,bo,xm,wo,Cm,si,Mm,Pm,vp,tn,Mn,Dl,yo,Sm,Nl,Dm,bp,Wt,ko,Nm,_s,Om,ai,Lm,Qm,Ol,Im,Wm,Ll,Hm,Um,ni,Rm,Gm,Bm,qo,Vm,jo,Km,Ym,Jm,Ql,Xm,Zm,$o,wp,sn,Pn,Il,Eo,eu,Wl,tu,yp,Be,Fo,su,Hl,au,nu,Qe,ou,oi,ru,iu,ri,lu,du,Ul,pu,cu,Rl,hu,mu,Gl,uu,fu,Bl,gu,_u,Vl,Tu,vu,Kl,bu,wu,Yl,yu,ku,qu,it,Jl,ju,$u,Xl,Eu,Fu,Zl,Au,zu,ed,xu,Cu,td,Mu,Pu,sd,Su,Du,ad,Nu,Ou,ii,li,Lu,Qu,Iu,Sn,Ao,Wu,nd,Hu,Uu,Ta,zo,Ru,xo,Gu,di,Bu,Vu,Ku,Co,Yu,Mo,Ju,Xu,Zu,pi,Po,kp,an,Dn,od,So,ef,rd,tf,qp,lt,Do,sf,No,af,ci,nf,of,rf,Oo,lf,Lo,df,pf,cf,Qo,hf,hi,mf,uf,ff,Io,gf,Wo,_f,Tf,vf,Vt,Ho,bf,nn,wf,mi,yf,kf,id,qf,jf,$f,Nn,Ef,ld,Ff,Af,Uo,jp,on,On,dd,Ro,zf,pd,xf,$p,Ts,Go,Cf,rn,Mf,cd,Pf,Sf,ui,Df,Nf,Of,Bo,Lf,Vo,Qf,If,Wf,Kt,Ko,Hf,ln,Uf,fi,Rf,Gf,hd,Bf,Vf,Kf,Ln,Yf,md,Jf,Xf,Yo,Ep,dn,Qn,ud,Jo,Zf,fd,eg,Fp,Ht,Xo,tg,gd,sg,ag,Zo,ng,gi,og,rg,ig,er,lg,tr,dg,pg,cg,Yt,sr,hg,pn,mg,_i,ug,fg,_d,gg,_g,Tg,In,vg,Td,bg,wg,ar,Ap,cn,Wn,vd,nr,yg,bd,kg,zp,Ut,or,qg,hn,jg,wd,$g,Eg,yd,Fg,Ag,zg,rr,xg,Ti,Cg,Mg,Pg,ir,Sg,lr,Dg,Ng,Og,Jt,dr,Lg,mn,Qg,vi,Ig,Wg,kd,Hg,Ug,Rg,Hn,Gg,qd,Bg,Vg,pr,xp,un,Un,jd,cr,Kg,$d,Yg,Cp,dt,hr,Jg,Ed,Xg,Zg,mr,e_,bi,t_,s_,a_,ur,n_,fr,o_,r_,i_,Rn,l_,Xt,gr,d_,fn,p_,wi,c_,h_,Fd,m_,u_,f_,Gn,g_,Ad,__,T_,_r,Mp,gn,Bn,zd,Tr,v_,xd,b_,Pp,pt,vr,w_,br,y_,Cd,k_,q_,j_,wr,$_,yi,E_,F_,A_,yr,z_,kr,x_,C_,M_,Vn,P_,Zt,qr,S_,_n,D_,ki,N_,O_,Md,L_,Q_,I_,Kn,W_,Pd,H_,U_,jr,Sp,Tn,Yn,Sd,$r,R_,Dd,G_,Dp,ct,Er,B_,Nd,V_,K_,Fr,Y_,qi,J_,X_,Z_,Ar,eT,zr,tT,sT,aT,Jn,nT,es,xr,oT,vn,rT,ji,iT,lT,Od,dT,pT,cT,Xn,hT,Ld,mT,uT,Cr,Np,bn,Zn,Qd,Mr,fT,Id,gT,Op,ht,Pr,_T,wn,TT,Wd,vT,bT,Hd,wT,yT,kT,Sr,qT,$i,jT,$T,ET,Dr,FT,Nr,AT,zT,xT,eo,CT,ts,Or,MT,yn,PT,Ei,ST,DT,Ud,NT,OT,LT,to,QT,Rd,IT,WT,Lr,Lp;return b=new Rt({}),V=new Rt({}),rt=new Rt({}),qn=new Cc({props:{pytorch:!0,tensorflow:!0,jax:!1,$$slots:{tensorflow:[Zy],pytorch:[Jy]},$$scope:{ctx:U}}}),Fn=new Cc({props:{pytorch:!0,tensorflow:!0,jax:!1,$$slots:{tensorflow:[ak],pytorch:[tk]},$$scope:{ctx:U}}}),An=new Cc({props:{pytorch:!0,tensorflow:!0,jax:!1,$$slots:{tensorflow:[ik],pytorch:[ok]},$$scope:{ctx:U}}}),go=new Rt({}),xn=new Cc({props:{pytorch:!0,tensorflow:!0,jax:!1,$$slots:{tensorflow:[ck],pytorch:[dk]},$$scope:{ctx:U}}}),vo=new Rt({}),bo=new He({props:{name:"class transformers.models.tapas.modeling_tapas.TableQuestionAnsweringOutput",anchor:"transformers.models.tapas.modeling_tapas.TableQuestionAnsweringOutput",parameters:[{name:"loss",val:": typing.Optional[torch.FloatTensor] = None"},{name:"logits",val:": FloatTensor = None"},{name:"logits_aggregation",val:": FloatTensor = None"},{name:"hidden_states",val:": typing.Optional[typing.Tuple[torch.FloatTensor]] = None"},{name:"attentions",val:": typing.Optional[typing.Tuple[torch.FloatTensor]] = None"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/tapas/modeling_tapas.py#L102",parametersDescription:[{anchor:"transformers.models.tapas.modeling_tapas.TableQuestionAnsweringOutput.loss",description:`<strong>loss</strong> (<code>torch.FloatTensor</code> of shape <code>(1,)</code>, <em>optional</em>, returned when <code>labels</code> (and possibly <code>answer</code>, <code>aggregation_labels</code>, <code>numeric_values</code> and <code>numeric_values_scale</code> are provided)) &#x2014;
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),Tr=new Rt({}),vr=new He({props:{name:"class transformers.TFTapasForMaskedLM",anchor:"transformers.TFTapasForMaskedLM",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/tapas/modeling_tf_tapas.py#L1036",parametersDescription:[{anchor:"transformers.TFTapasForMaskedLM.config",description:`<strong>config</strong> (<a href="/docs/transformers/main/en/model_doc/tapas#transformers.TapasConfig">TapasConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/main/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),Vn=new Ms({props:{$$slots:{default:[Tk]},$$scope:{ctx:U}}}),qr=new He({props:{name:"call",anchor:"transformers.TFTapasForMaskedLM.call",parameters:[{name:"input_ids",val:": typing.Union[typing.List[tensorflow.python.framework.ops.Tensor], typing.List[numpy.ndarray], typing.List[tensorflow.python.keras.engine.keras_tensor.KerasTensor], typing.Dict[str, tensorflow.python.framework.ops.Tensor], typing.Dict[str, numpy.ndarray], typing.Dict[str, tensorflow.python.keras.engine.keras_tensor.KerasTensor], tensorflow.python.framework.ops.Tensor, numpy.ndarray, tensorflow.python.keras.engine.keras_tensor.KerasTensor, NoneType] = None"},{name:"attention_mask",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"token_type_ids",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"position_ids",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"head_mask",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"inputs_embeds",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"labels",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"training",val:": typing.Optional[bool] = False"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/tapas/modeling_tf_tapas.py#L1052",parametersDescription:[{anchor:"transformers.TFTapasForMaskedLM.call.input_ids",description:`<strong>input_ids</strong> (<code>np.ndarray</code>, <code>tf.Tensor</code>, <code>List[tf.Tensor]</code> \`<code>Dict[str, tf.Tensor]</code> or <code>Dict[str, np.ndarray]</code> and each example must have the shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/main/en/model_doc/tapas#transformers.TapasTokenizer">TapasTokenizer</a>. See <a href="/docs/transformers/main/en/model_doc/wav2vec2_phoneme#transformers.Wav2Vec2PhonemeCTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
<a href="/docs/transformers/main/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> for details.</p>
...
`}}),Kn=new Ms({props:{$$slots:{default:[vk]},$$scope:{ctx:U}}}),jr=new Ve({props:{code:`from transformers import TapasTokenizer, TapasForMaskedLM
import pandas as pd
...
<span class="hljs-meta">&gt;&gt;&gt; </span>outputs = model(**inputs, labels=labels)
<span class="hljs-meta">&gt;&gt;&gt; </span>logits = outputs.logits`}}),$r=new Rt({}),Er=new He({props:{name:"class transformers.TFTapasForSequenceClassification",anchor:"transformers.TFTapasForSequenceClassification",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/tapas/modeling_tf_tapas.py#L1574",parametersDescription:[{anchor:"transformers.TFTapasForSequenceClassification.config",description:`<strong>config</strong> (<a href="/docs/transformers/main/en/model_doc/tapas#transformers.TapasConfig">TapasConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/main/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),Jn=new Ms({props:{$$slots:{default:[bk]},$$scope:{ctx:U}}}),xr=new He({props:{name:"call",anchor:"transformers.TFTapasForSequenceClassification.call",parameters:[{name:"input_ids",val:": typing.Union[typing.List[tensorflow.python.framework.ops.Tensor], typing.List[numpy.ndarray], typing.List[tensorflow.python.keras.engine.keras_tensor.KerasTensor], typing.Dict[str, tensorflow.python.framework.ops.Tensor], typing.Dict[str, numpy.ndarray], typing.Dict[str, tensorflow.python.keras.engine.keras_tensor.KerasTensor], tensorflow.python.framework.ops.Tensor, numpy.ndarray, tensorflow.python.keras.engine.keras_tensor.KerasTensor, NoneType] = None"},{name:"attention_mask",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"token_type_ids",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"position_ids",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"head_mask",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"inputs_embeds",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"labels",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"training",val:": typing.Optional[bool] = False"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/tapas/modeling_tf_tapas.py#L1585",parametersDescription:[{anchor:"transformers.TFTapasForSequenceClassification.call.input_ids",description:`<strong>input_ids</strong> (<code>np.ndarray</code>, <code>tf.Tensor</code>, <code>List[tf.Tensor]</code> \`<code>Dict[str, tf.Tensor]</code> or <code>Dict[str, np.ndarray]</code> and each example must have the shape <code>(batch_size, num_choices, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/main/en/model_doc/tapas#transformers.TapasTokenizer">TapasTokenizer</a>. See <a href="/docs/transformers/main/en/model_doc/wav2vec2_phoneme#transformers.Wav2Vec2PhonemeCTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
<a href="/docs/transformers/main/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> for details.</p>
...
`),Rl=n("code"),hu=s("column_ids"),mu=s(", "),Gl=n("code"),uu=s("row_ids"),fu=s(", "),Bl=n("code"),gu=s("prev_labels"),_u=s(", "),Vl=n("code"),Tu=s("column_ranks"),vu=s(", "),Kl=n("code"),bu=s("inv_column_ranks"),wu=s(" and "),Yl=n("code"),yu=s("numeric_relations"),ku=s(":"),qu=d(),it=n("ul"),Jl=n("li"),ju=s(`segment_ids: indicate whether a token belongs to the question (0) or the table (1). 0 for special tokens and
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),cg=d(),Yt=n("div"),$(sr.$$.fragment),hg=d(),pn=n("p"),mg=s("The "),_i=n("a"),ug=s("TapasForSequenceClassification"),fg=s(" forward method, overrides the "),_d=n("code"),gg=s("__call__"),_g=s(" special method."),Tg=d(),$(In.$$.fragment),vg=d(),Td=n("p"),bg=s("Examples:"),wg=d(),$(ar.$$.fragment),Ap=d(),cn=n("h2"),Wn=n("a"),vd=n("span"),$(nr.$$.fragment),yg=d(),bd=n("span"),kg=s("TapasForQuestionAnswering"),zp=d(),Ut=n("div"),$(or.$$.fragment),qg=d(),hn=n("p"),jg=s(`Tapas Model with a cell selection head and optional aggregation head on top for question-answering tasks on tables
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Og=d(),Jt=n("div"),$(dr.$$.fragment),Lg=d(),mn=n("p"),Qg=s("The "),vi=n("a"),Ig=s("TapasForQuestionAnswering"),Wg=s(" forward method, overrides the "),kd=n("code"),Hg=s("__call__"),Ug=s(" special method."),Rg=d(),$(Hn.$$.fragment),Gg=d(),qd=n("p"),Bg=s("Examples:"),Vg=d(),$(pr.$$.fragment),xp=d(),un=n("h2"),Un=n("a"),jd=n("span"),$(cr.$$.fragment),Kg=d(),$d=n("span"),Yg=s("TFTapasModel"),Cp=d(),dt=n("div"),$(hr.$$.fragment),Jg=d(),Ed=n("p"),Xg=s("The bare Tapas Model transformer outputting raw hidden-states without any specific head on top."),Zg=d(),mr=n("p"),e_=s("This model inherits from "),bi=n("a"),t_=s("TFPreTrainedModel"),s_=s(`. Check the superclass documentation for the generic methods the
...
(linear layers on top of the hidden-states output to compute `),Wd=n("code"),vT=s("logits"),bT=s(" and optional "),Hd=n("code"),wT=s("logits_aggregation"),yT=s(`), e.g. for
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),xT=d(),$(eo.$$.fragment),CT=d(),ts=n("div"),$(Or.$$.fragment),MT=d(),yn=n("p"),PT=s("The "),Ei=n("a"),ST=s("TFTapasForQuestionAnswering"),DT=s(" forward method, overrides the "),Ud=n("code"),NT=s("__call__"),OT=s(" special method."),LT=d(),$(to.$$.fragment),QT=d(),Rd=n("p"),IT=s("Examples:"),WT=d(),$(Lr.$$.fragment),this.h()},l(i){const u=By('[data-svelte="svelte-1phssyn"]',document.head);l=o(u,"META",{name:!0,content:!0}),u.forEach(t),_=p(i),c=o(i,"H1",{class:!0});var Qr=r(c);f=o(Qr,"A",{id:!0,class:!0,href:!0});var Gd=r(f);v=o(Gd,"SPAN",{});var Bd=r(v);E(b.$$.fragment,Bd),Bd.forEach(t),Gd.forEach(t),T=p(Qr),k=o(Qr,"SPAN",{});var Vd=r(k);y=a(Vd,"TAPAS"),Vd.forEach(t),Qr.forEach(t),D=p(i),q=o(i,"H2",{class:!0});var Ir=r(q);H=o(Ir,"A",{id:!0,class:!0,href:!0});var Kd=r(H);B=o(Kd,"SPAN",{});var Yd=r(B);E(V.$$.fragment,Yd),Yd.forEach(t),Kd.forEach(t),R=p(Ir),K=o(Ir,"SPAN",{});var Jd=r(K);re=a(Jd,"Overview"),Jd.forEach(t),Ir.forEach(t),I=p(i),O=o(i,"P",{});var Wr=r(O);w=a(Wr,"The TAPAS model was proposed in "),M=o(Wr,"A",{href:!0,rel:!0});var Xd=r(M);G=a(Xd,"TAPAS: Weakly Supervised Table Parsing via Pre-training"),Xd.forEach(t),C=a(Wr,`
by Jonathan Herzig, Pawe\u0142 Krzysztof Nowak, Thomas M\xFCller, Francesco Piccinno and Julian Martin Eisenschlos. It\u2019s a BERT-based model specifically
designed (and pre-trained) for answering questions about tabular data. Compared to BERT, TAPAS uses relative position embeddings and has 7
token types that encode tabular structure. TAPAS is pre-trained on the masked language modeling (MLM) objective on a large dataset comprising
millions of tables from English Wikipedia and corresponding texts.`),Wr.forEach(t),N=p(i),ee=o(i,"P",{});var Zd=r(ee);te=a(Zd,"For question answering, TAPAS has 2 heads on top: a cell selection head and an aggregation head, for (optionally) performing aggregations (such as counting or summing) among selected cells. TAPAS has been fine-tuned on several datasets:"),Zd.forEach(t),ce=p(i),ne=o(i,"UL",{});var kn=r(ne);se=o(kn,"LI",{});var Fi=r(se);P=o(Fi,"A",{href:!0,rel:!0});var ep=r(P);L=a(ep,"SQA"),ep.forEach(t),W=a(Fi," (Sequential Question Answering by Microsoft)"),Fi.forEach(t),X=p(kn),Q=o(kn,"LI",{});var Ai=r(Q);Y=o(Ai,"A",{href:!0,rel:!0});var tp=r(Y);ge=a(tp,"WTQ"),tp.forEach(t),me=a(Ai," (Wiki Table Questions by Stanford University)"),Ai.forEach(t),_e=p(kn),ue=o(kn,"LI",{});var HT=r(ue);oe=o(HT,"A",{href:!0,rel:!0});var ev=r(oe);qe=a(ev,"WikiSQL"),ev.forEach(t),ie=a(HT," (by Salesforce)."),HT.forEach(t),kn.forEach(t),be=p(i),g=o(i,"P",{});var tv=r(g);S=a(tv,"It achieves state-of-the-art on both SQA and WTQ, while having comparable performance to SOTA on WikiSQL, with a much simpler architecture."),tv.forEach(t),ve=p(i),ze=o(i,"P",{});var sv=r(ze);we=a(sv,"The abstract from the paper is the following:"),sv.forEach(t),le=p(i),xe=o(i,"P",{});var av=r(xe);Me=o(av,"EM",{});var nv=r(Me);Z=a(nv,"Answering natural language questions over tables is usually seen as a semantic parsing task. To alleviate the collection cost of full logical forms, one popular approach focuses on weak supervision consisting of denotations instead of logical forms. However, training semantic parsers from weak supervision poses difficulties, and in addition, the generated logical forms are only used as an intermediate step prior to retrieving the denotation. In this paper, we present TAPAS, an approach to question answering over tables without generating logical forms. TAPAS trains from weak supervision, and predicts the denotation by selecting table cells and optionally applying a corresponding aggregation operator to such selection. TAPAS extends BERT\u2019s architecture to encode tables as input, initializes from an effective joint pre-training of text segments and tables crawled from Wikipedia, and is trained end-to-end. We experiment with three different semantic parsing datasets, and find that TAPAS outperforms or rivals semantic parsing models by improving state-of-the-art accuracy on SQA from 55.1 to 67.2 and performing on par with the state-of-the-art on WIKISQL and WIKITQ, but with a simpler model architecture. We additionally find that transfer learning, which is trivial in our setting, from WIKISQL to WIKITQ, yields 48.7 accuracy, 4.2 points above the state-of-the-art."),nv.forEach(t),av.forEach(t),de=p(i),pe=o(i,"P",{});var so=r(pe);De=a(so,"In addition, the authors have further pre-trained TAPAS to recognize "),je=o(so,"STRONG",{});var ov=r(je);Te=a(ov,"table entailment"),ov.forEach(t),Ne=a(so,", by creating a balanced dataset of millions of automatically created training examples which are learned in an intermediate step prior to fine-tuning. The authors of TAPAS call this further pre-training intermediate pre-training (since TAPAS is first pre-trained on MLM, and then on another dataset). They found that intermediate pre-training further improves performance on SQA, achieving a new state-of-the-art as well as state-of-the-art on "),ye=o(so,"A",{href:!0,rel:!0});var rv=r(ye);Ae=a(rv,"TabFact"),rv.forEach(t),Oe=a(so,", a large-scale dataset with 16k Wikipedia tables for table entailment (a binary classification task). For more details, see their follow-up paper: "),Ze=o(so,"A",{href:!0,rel:!0});var iv=r(Ze);Ps=a(iv,"Understanding tables with intermediate pre-training"),iv.forEach(t),Ss=a(so," by Julian Martin Eisenschlos, Syrine Krichene and Thomas M\xFCller."),so.forEach(t),mt=p(i),ut=o(i,"IMG",{src:!0,alt:!0,width:!0}),ft=p(i),gt=o(i,"SMALL",{});var Qp=r(gt);Ds=a(Qp,"TAPAS architecture. Taken from the "),tt=o(Qp,"A",{href:!0});var lv=r(tt);Ns=a(lv,"original blog post"),lv.forEach(t),Os=a(Qp,"."),Qp.forEach(t),Ke=p(i),Pe=o(i,"P",{});var ao=r(Pe);Ls=a(ao,"This model was contributed by "),wt=o(ao,"A",{href:!0,rel:!0});var dv=r(wt);ke=a(dv,"nielsr"),dv.forEach(t),yt=a(ao,". The Tensorflow version of this model was contributed by "),kt=o(ao,"A",{href:!0,rel:!0});var pv=r(kt);Qs=a(pv,"kamalkraj"),pv.forEach(t),qt=a(ao,". The original code can be found "),jt=o(ao,"A",{href:!0,rel:!0});var cv=r(jt);Is=a(cv,"here"),cv.forEach(t),$t=a(ao,"."),ao.forEach(t),vs=p(i),Gt=o(i,"P",{});var hv=r(Gt);Et=a(hv,"Tips:"),hv.forEach(t),bs=p(i),Ye=o(i,"UL",{});var no=r(Ye);$e=o(no,"LI",{});var ss=r($e);Ws=a(ss,"TAPAS is a model that uses relative position embeddings by default (restarting the position embeddings at every cell of the table). Note that this is something that was added after the publication of the original TAPAS paper. According to the authors, this usually results in a slightly better performance, and allows you to encode longer sequences without running out of embeddings. This is reflected in the "),Ft=o(ss,"CODE",{});var mv=r(Ft);ae=a(mv,"reset_position_index_per_cell"),mv.forEach(t),nt=a(ss," parameter of "),Bt=o(ss,"A",{href:!0});var uv=r(Bt);Hs=a(uv,"TapasConfig"),uv.forEach(t),At=a(ss,", which is set to "),ns=o(ss,"CODE",{});var fv=r(ns);Us=a(fv,"True"),fv.forEach(t),zt=a(ss," by default. The default versions of the models available on the "),xt=o(ss,"A",{href:!0,rel:!0});var gv=r(xt);Rs=a(gv,"hub"),gv.forEach(t),Ct=a(ss," all use relative position embeddings. You can still use the ones with absolute position embeddings by passing in an additional argument "),os=o(ss,"CODE",{});var _v=r(os);Gs=a(_v,'revision="no_reset"'),_v.forEach(t),Mt=a(ss," when calling the "),rs=o(ss,"CODE",{});var Tv=r(rs);Bs=a(Tv,"from_pretrained()"),Tv.forEach(t),Pt=a(ss," method. Note that it\u2019s usually advised to pad the inputs on the right rather than the left."),ss.forEach(t),Vs=p(no),Le=o(no,"LI",{});var js=r(Le);St=a(js,"TAPAS is based on BERT, so "),is=o(js,"CODE",{});var vv=r(is);Ks=a(vv,"TAPAS-base"),vv.forEach(t),Dt=a(js," for example corresponds to a "),ls=o(js,"CODE",{});var bv=r(ls);Ys=a(bv,"BERT-base"),bv.forEach(t),ds=a(js," architecture. Of course, "),Ue=o(js,"CODE",{});var wv=r(Ue);ps=a(wv,"TAPAS-large"),wv.forEach(t),Ee=a(js," will result in the best performance (the results reported in the paper are from "),cs=o(js,"CODE",{});var yv=r(cs);ot=a(yv,"TAPAS-large"),yv.forEach(t),Js=a(js,"). Results of the various sized models are shown on the "),Nt=o(js,"A",{href:!0,rel:!0});var kv=r(Nt);Ot=a(kv,"original Github repository"),kv.forEach(t),Xs=a(js,"."),js.forEach(t),Zs=p(no),Re=o(no,"LI",{});var zi=r(Re);ea=a(zi,"TAPAS has checkpoints fine-tuned on SQA, which are capable of answering questions related to a table in a conversational set-up. This means that you can ask follow-up questions such as \u201Cwhat is his age?\u201D related to the previous question. Note that the forward pass of TAPAS is a bit different in case of a conversational set-up: in that case, you have to feed every table-question pair one by one to the model, such that the "),hs=o(zi,"CODE",{});var qv=r(hs);ms=a(qv,"prev_labels"),qv.forEach(t),et=a(zi," token type ids can be overwritten by the predicted "),Lt=o(zi,"CODE",{});var jv=r(Lt);j=a(jv,"labels"),jv.forEach(t),J=a(zi," of the model to the previous question. See \u201CUsage\u201D section for more info."),zi.forEach(t),xa=p(no),ta=o(no,"LI",{});var $v=r(ta);Ca=a($v,"TAPAS is similar to BERT and therefore relies on the masked language modeling (MLM) objective. It is therefore efficient at predicting masked tokens and at NLU in general, but is not optimal for text generation. Models trained with a causal language modeling (CLM) objective are better in that regard. Note that TAPAS can be used as an encoder in the EncoderDecoderModel framework, to combine it with an autoregressive text decoder such as GPT-2."),$v.forEach(t),no.forEach(t),ca=p(i),Qt=o(i,"H2",{class:!0});var Ip=r(Qt);st=o(Ip,"A",{id:!0,class:!0,href:!0});var Ev=r(st);sa=o(Ev,"SPAN",{});var Fv=r(sa);E(rt.$$.fragment,Fv),Fv.forEach(t),Ev.forEach(t),Ma=p(Ip),aa=o(Ip,"SPAN",{});var Av=r(aa);Pa=a(Av,"Usage: fine-tuning"),Av.forEach(t),Ip.forEach(t),ha=p(i),Ie=o(i,"P",{});var Wp=r(Ie);us=a(Wp,"Here we explain how you can fine-tune "),ws=o(Wp,"A",{href:!0});var zv=r(ws);Ge=a(zv,"TapasForQuestionAnswering"),zv.forEach(t),Sa=a(Wp," on your own dataset."),Wp.forEach(t),ma=p(i),ys=o(i,"P",{});var xv=r(ys);na=o(xv,"STRONG",{});var Cv=r(na);fs=a(Cv,"STEP 1: Choose one of the 3 ways in which you can use TAPAS - or experiment"),Cv.forEach(t),xv.forEach(t),ua=p(i),fe=o(i,"P",{});var Hp=r(fe);Da=a(Hp,"Basically, there are 3 different ways in which one can fine-tune "),ks=o(Hp,"A",{href:!0});var Mv=r(ks);Na=a(Mv,"TapasForQuestionAnswering"),Mv.forEach(t),Oa=a(Hp,", corresponding to the different datasets on which Tapas was fine-tuned:"),Hp.forEach(t),fa=p(i),_t=o(i,"OL",{});var xi=r(_t);oa=o(xi,"LI",{});var Pv=r(oa);gs=a(Pv,"SQA: if you\u2019re interested in asking follow-up questions related to a table, in a conversational set-up. For example if you first ask \u201Cwhat\u2019s the name of the first actor?\u201D then you can ask a follow-up question such as \u201Chow old is he?\u201C. Here, questions do not involve any aggregation (all questions are cell selection questions)."),Pv.forEach(t),La=p(xi),Fe=o(xi,"LI",{});var Up=r(Fe);Qa=a(Up,"WTQ: if you\u2019re not interested in asking questions in a conversational set-up, but rather just asking questions related to a table, which might involve aggregation, such as counting a number of rows, summing up cell values or averaging cell values. You can then for example ask \u201Cwhat\u2019s the total number of goals Cristiano Ronaldo made in his career?\u201C. This case is also called "),ra=o(Up,"STRONG",{});var Sv=r(ra);Ia=a(Sv,"weak supervision"),Sv.forEach(t),Wa=a(Up,", since the model itself must learn the appropriate aggregation operator (SUM/COUNT/AVERAGE/NONE) given only the answer to the question as supervision."),Up.forEach(t),Ha=p(xi),he=o(xi,"LI",{});var Rp=r(he);Ua=a(Rp,"WikiSQL-supervised: this dataset is based on WikiSQL with the model being given the ground truth aggregation operator during training. This is also called "),ia=o(Rp,"STRONG",{});var Dv=r(ia);Ra=a(Dv,"strong supervision"),Dv.forEach(t),Ga=a(Rp,". Here, learning the appropriate aggregation operator is much easier."),Rp.forEach(t),xi.forEach(t),ga=p(i),qs=o(i,"P",{});var Nv=r(qs);Ba=a(Nv,"To summarize:"),Nv.forEach(t),_a=p(i),Ce=o(i,"TABLE",{});var Gp=r(Ce);la=o(Gp,"THEAD",{});var Ov=r(la);It=o(Ov,"TR",{});var Ci=r(It);da=o(Ci,"TH",{});var Lv=r(da);Ki=o(Lv,"STRONG",{});var Qv=r(Ki);Mc=a(Qv,"Task"),Qv.forEach(t),Lv.forEach(t),Pc=p(Ci),Yi=o(Ci,"TH",{});var Iv=r(Yi);Ji=o(Iv,"STRONG",{});var Wv=r(Ji);Sc=a(Wv,"Example dataset"),Wv.forEach(t),Iv.forEach(t),Dc=p(Ci),Xi=o(Ci,"TH",{});var Hv=r(Xi);Zi=o(Hv,"STRONG",{});var Uv=r(Zi);Nc=a(Uv,"Description"),Uv.forEach(t),Hv.forEach(t),Ci.forEach(t),Ov.forEach(t),Oc=p(Gp),Va=o(Gp,"TBODY",{});var Mi=r(Va);Ka=o(Mi,"TR",{});var Pi=r(Ka);el=o(Pi,"TD",{});var Rv=r(el);Lc=a(Rv,"Conversational"),Rv.forEach(t),Qc=p(Pi),tl=o(Pi,"TD",{});var Gv=r(tl);Ic=a(Gv,"SQA"),Gv.forEach(t),Wc=p(Pi),sl=o(Pi,"TD",{});var Bv=r(sl);Hc=a(Bv,"Conversational, only cell selection questions"),Bv.forEach(t),Pi.forEach(t),Uc=p(Mi),Ya=o(Mi,"TR",{});var Si=r(Ya);al=o(Si,"TD",{});var Vv=r(al);Rc=a(Vv,"Weak supervision for aggregation"),Vv.forEach(t),Gc=p(Si),nl=o(Si,"TD",{});var Kv=r(nl);Bc=a(Kv,"WTQ"),Kv.forEach(t),Vc=p(Si),ol=o(Si,"TD",{});var Yv=r(ol);Kc=a(Yv,"Questions might involve aggregation, and the model must learn this given only the answer as supervision"),Yv.forEach(t),Si.forEach(t),Yc=p(Mi),Ja=o(Mi,"TR",{});var Di=r(Ja);rl=o(Di,"TD",{});var Jv=r(rl);Jc=a(Jv,"Strong supervision for aggregation"),Jv.forEach(t),Xc=p(Di),il=o(Di,"TD",{});var Xv=r(il);Zc=a(Xv,"WikiSQL-supervised"),Xv.forEach(t),eh=p(Di),ll=o(Di,"TD",{});var Zv=r(ll);th=a(Zv,"Questions might involve aggregation, and the model must learn this given the gold aggregation operator"),Zv.forEach(t),Di.forEach(t),Mi.forEach(t),Gp.forEach(t),sp=p(i),E(qn.$$.fragment,i),ap=p(i),jn=o(i,"P",{});var Bp=r(jn);sh=a(Bp,"What you can also do is start from an already fine-tuned checkpoint. A note here is that the already fine-tuned checkpoint on WTQ has some issues due to the L2-loss which is somewhat brittle. See "),lo=o(Bp,"A",{href:!0,rel:!0});var eb=r(lo);ah=a(eb,"here"),eb.forEach(t),nh=a(Bp," for more info."),Bp.forEach(t),np=p(i),$n=o(i,"P",{});var Vp=r($n);oh=a(Vp,"For a list of all pre-trained and fine-tuned TAPAS checkpoints available on HuggingFace\u2019s  hub, see "),po=o(Vp,"A",{href:!0,rel:!0});var tb=r(po);rh=a(tb,"here"),tb.forEach(t),ih=a(Vp,"."),Vp.forEach(t),op=p(i),Hr=o(i,"P",{});var sb=r(Hr);dl=o(sb,"STRONG",{});var ab=r(dl);lh=a(ab,"STEP 2: Prepare your data in the SQA format"),ab.forEach(t),sb.forEach(t),rp=p(i),En=o(i,"P",{});var Kp=r(En);dh=a(Kp,"Second, no matter what you picked above, you should prepare your dataset in the "),co=o(Kp,"A",{href:!0,rel:!0});var nb=r(co);ph=a(nb,"SQA"),nb.forEach(t),ch=a(Kp," format. This format is a TSV/CSV file with the following columns:"),Kp.forEach(t),ip=p(i),We=o(i,"UL",{});var at=r(We);Ur=o(at,"LI",{});var UT=r(Ur);pl=o(UT,"CODE",{});var ob=r(pl);hh=a(ob,"id"),ob.forEach(t),mh=a(UT,": optional, id of the table-question pair, for bookkeeping purposes."),UT.forEach(t),uh=p(at),Rr=o(at,"LI",{});var RT=r(Rr);cl=o(RT,"CODE",{});var rb=r(cl);fh=a(rb,"annotator"),rb.forEach(t),gh=a(RT,": optional, id of the person who annotated the table-question pair, for bookkeeping purposes."),RT.forEach(t),_h=p(at),Gr=o(at,"LI",{});var GT=r(Gr);hl=o(GT,"CODE",{});var ib=r(hl);Th=a(ib,"position"),ib.forEach(t),vh=a(GT,": integer indicating if the question is the first, second, third,\u2026 related to the table. Only required in case of conversational setup (SQA). You don\u2019t need this column in case you\u2019re going for WTQ/WikiSQL-supervised."),GT.forEach(t),bh=p(at),Br=o(at,"LI",{});var BT=r(Br);ml=o(BT,"CODE",{});var lb=r(ml);wh=a(lb,"question"),lb.forEach(t),yh=a(BT,": string"),BT.forEach(t),kh=p(at),Vr=o(at,"LI",{});var VT=r(Vr);ul=o(VT,"CODE",{});var db=r(ul);qh=a(db,"table_file"),db.forEach(t),jh=a(VT,": string, name of a csv file containing the tabular data"),VT.forEach(t),$h=p(at),Kr=o(at,"LI",{});var KT=r(Kr);fl=o(KT,"CODE",{});var pb=r(fl);Eh=a(pb,"answer_coordinates"),pb.forEach(t),Fh=a(KT,": list of one or more tuples (each tuple being a cell coordinate, i.e. row, column pair that is part of the answer)"),KT.forEach(t),Ah=p(at),Yr=o(at,"LI",{});var YT=r(Yr);gl=o(YT,"CODE",{});var cb=r(gl);zh=a(cb,"answer_text"),cb.forEach(t),xh=a(YT,": list of one or more strings (each string being a cell value that is part of the answer)"),YT.forEach(t),Ch=p(at),Jr=o(at,"LI",{});var JT=r(Jr);_l=o(JT,"CODE",{});var hb=r(_l);Mh=a(hb,"aggregation_label"),hb.forEach(t),Ph=a(JT,": index of the aggregation operator. Only required in case of strong supervision for aggregation (the WikiSQL-supervised case)"),JT.forEach(t),Sh=p(at),Xr=o(at,"LI",{});var XT=r(Xr);Tl=o(XT,"CODE",{});var mb=r(Tl);Dh=a(mb,"float_answer"),mb.forEach(t),Nh=a(XT,": the float answer to the question, if there is one (np.nan if there isn\u2019t). Only required in case of weak supervision for aggregation (such as WTQ and WikiSQL)"),XT.forEach(t),at.forEach(t),lp=p(i),Tt=o(i,"P",{});var $s=r(Tt);Oh=a($s,"The tables themselves should be present in a folder, each table being a separate csv file. Note that the authors of the TAPAS algorithm used conversion scripts with some automated logic to convert the other datasets (WTQ, WikiSQL) into the SQA format. The author explains this "),ho=o($s,"A",{href:!0,rel:!0});var ub=r(ho);Lh=a(ub,"here"),ub.forEach(t),Qh=a($s,". A conversion of this script that works with HuggingFace\u2019s implementation can be found "),mo=o($s,"A",{href:!0,rel:!0});var fb=r(mo);Ih=a(fb,"here"),fb.forEach(t),Wh=a($s,". Interestingly, these conversion scripts are not perfect (the "),vl=o($s,"CODE",{});var gb=r(vl);Hh=a(gb,"answer_coordinates"),gb.forEach(t),Uh=a($s," and "),bl=o($s,"CODE",{});var _b=r(bl);Rh=a(_b,"float_answer"),_b.forEach(t),Gh=a($s," fields are populated based on the "),wl=o($s,"CODE",{});var Tb=r(wl);Bh=a(Tb,"answer_text"),Tb.forEach(t),Vh=a($s,"), meaning that WTQ and WikiSQL results could actually be improved."),$s.forEach(t),dp=p(i),Zr=o(i,"P",{});var vb=r(Zr);yl=o(vb,"STRONG",{});var bb=r(yl);Kh=a(bb,"STEP 3: Convert your data into tensors using TapasTokenizer"),bb.forEach(t),vb.forEach(t),pp=p(i),E(Fn.$$.fragment,i),cp=p(i),Se=o(i,"P",{});var Je=r(Se);Yh=a(Je,"Note that here, we encode each table-question pair independently. This is fine as long as your dataset is "),kl=o(Je,"STRONG",{});var wb=r(kl);Jh=a(wb,"not conversational"),wb.forEach(t),Xh=a(Je,". In case your dataset involves conversational questions (such as in SQA), then you should first group together the "),ql=o(Je,"CODE",{});var yb=r(ql);Zh=a(yb,"queries"),yb.forEach(t),em=a(Je,", "),jl=o(Je,"CODE",{});var kb=r(jl);tm=a(kb,"answer_coordinates"),kb.forEach(t),sm=a(Je," and "),$l=o(Je,"CODE",{});var qb=r($l);am=a(qb,"answer_text"),qb.forEach(t),nm=a(Je," per table (in the order of their "),El=o(Je,"CODE",{});var jb=r(El);om=a(jb,"position"),jb.forEach(t),rm=a(Je,`
index) and batch encode each table with its questions. This will make sure that the `),Fl=o(Je,"CODE",{});var $b=r(Fl);im=a($b,"prev_labels"),$b.forEach(t),lm=a(Je," token types (see docs of "),ei=o(Je,"A",{href:!0});var Eb=r(ei);dm=a(Eb,"TapasTokenizer"),Eb.forEach(t),pm=a(Je,") are set correctly. See "),uo=o(Je,"A",{href:!0,rel:!0});var Fb=r(uo);cm=a(Fb,"this notebook"),Fb.forEach(t),hm=a(Je," for more info. See "),fo=o(Je,"A",{href:!0,rel:!0});var Ab=r(fo);mm=a(Ab,"this notebook"),Ab.forEach(t),um=a(Je," for more info regarding using the TensorFlow model."),Je.forEach(t),hp=p(i),ti=o(i,"P",{});var zb=r(ti);fm=a(zb,"**STEP 4: Train (fine-tune) the model"),zb.forEach(t),mp=p(i),E(An.$$.fragment,i),up=p(i),Xa=o(i,"H2",{class:!0});var Yp=r(Xa);zn=o(Yp,"A",{id:!0,class:!0,href:!0});var xb=r(zn);Al=o(xb,"SPAN",{});var Cb=r(Al);E(go.$$.fragment,Cb),Cb.forEach(t),xb.forEach(t),gm=p(Yp),zl=o(Yp,"SPAN",{});var Mb=r(zl);_m=a(Mb,"Usage: inference"),Mb.forEach(t),Yp.forEach(t),fp=p(i),E(xn.$$.fragment,i),gp=p(i),vt=o(i,"P",{});var Es=r(vt);Tm=a(Es,"In case of a conversational set-up, then each table-question pair must be provided "),xl=o(Es,"STRONG",{});var Pb=r(xl);vm=a(Pb,"sequentially"),Pb.forEach(t),bm=a(Es," to the model, such that the "),Cl=o(Es,"CODE",{});var Sb=r(Cl);wm=a(Sb,"prev_labels"),Sb.forEach(t),ym=a(Es," token types can be overwritten by the predicted "),Ml=o(Es,"CODE",{});var Db=r(Ml);km=a(Db,"labels"),Db.forEach(t),qm=a(Es," of the previous table-question pair. Again, more info can be found in "),_o=o(Es,"A",{href:!0,rel:!0});var Nb=r(_o);jm=a(Nb,"this notebook"),Nb.forEach(t),$m=a(Es," (for PyTorch) and "),To=o(Es,"A",{href:!0,rel:!0});var Ob=r(To);Em=a(Ob,"this notebook"),Ob.forEach(t),Fm=a(Es," (for TensorFlow)."),Es.forEach(t),_p=p(i),Za=o(i,"H2",{class:!0});var Jp=r(Za);Cn=o(Jp,"A",{id:!0,class:!0,href:!0});var Lb=r(Cn);Pl=o(Lb,"SPAN",{});var Qb=r(Pl);E(vo.$$.fragment,Qb),Qb.forEach(t),Lb.forEach(t),Am=p(Jp),Sl=o(Jp,"SPAN",{});var Ib=r(Sl);zm=a(Ib,"TAPAS specific outputs"),Ib.forEach(t),Jp.forEach(t),Tp=p(i),en=o(i,"DIV",{class:!0});var Xp=r(en);E(bo.$$.fragment,Xp),xm=p(Xp),wo=o(Xp,"P",{});var Zp=r(wo);Cm=a(Zp,"Output type of "),si=o(Zp,"A",{href:!0});var Wb=r(si);Mm=a(Wb,"TapasForQuestionAnswering"),Wb.forEach(t),Pm=a(Zp,"."),Zp.forEach(t),Xp.forEach(t),vp=p(i),tn=o(i,"H2",{class:!0});var ec=r(tn);Mn=o(ec,"A",{id:!0,class:!0,href:!0});var Hb=r(Mn);Dl=o(Hb,"SPAN",{});var Ub=r(Dl);E(yo.$$.fragment,Ub),Ub.forEach(t),Hb.forEach(t),Sm=p(ec),Nl=o(ec,"SPAN",{});var Rb=r(Nl);Dm=a(Rb,"TapasConfig"),Rb.forEach(t),ec.forEach(t),bp=p(i),Wt=o(i,"DIV",{class:!0});var va=r(Wt);E(ko.$$.fragment,va),Nm=p(va),_s=o(va,"P",{});var ba=r(_s);Om=a(ba,"This is the configuration class to store the configuration of a "),ai=o(ba,"A",{href:!0});var Gb=r(ai);Lm=a(Gb,"TapasModel"),Gb.forEach(t),Qm=a(ba,`. It is used to instantiate a TAPAS
model according to the specified arguments, defining the model architecture. Instantiating a configuration with the
defaults will yield a similar configuration to that of the TAPAS `),Ol=o(ba,"EM",{});var Bb=r(Ol);Im=a(Bb,"tapas-base-finetuned-sqa"),Bb.forEach(t),Wm=a(ba,` architecture.
Configuration objects inherit from `),Ll=o(ba,"CODE",{});var Vb=r(Ll);Hm=a(Vb,"PreTrainedConfig"),Vb.forEach(t),Um=a(ba,` and can be used to control the model outputs. Read the
documentation from `),ni=o(ba,"A",{href:!0});var Kb=r(ni);Rm=a(Kb,"PretrainedConfig"),Kb.forEach(t),Gm=a(ba," for more information."),ba.forEach(t),Bm=p(va),qo=o(va,"P",{});var tc=r(qo);Vm=a(tc,`Hyperparameters additional to BERT are taken from run_task_main.py and hparam_utils.py of the original
implementation. Original implementation available at `),jo=o(tc,"A",{href:!0,rel:!0});var Yb=r(jo);Km=a(Yb,"https://github.com/google-research/tapas/tree/master"),Yb.forEach(t),Ym=a(tc,"."),tc.forEach(t),Jm=p(va),Ql=o(va,"P",{});var Jb=r(Ql);Xm=a(Jb,"Example:"),Jb.forEach(t),Zm=p(va),E($o.$$.fragment,va),va.forEach(t),wp=p(i),sn=o(i,"H2",{class:!0});var sc=r(sn);Pn=o(sc,"A",{id:!0,class:!0,href:!0});var Xb=r(Pn);Il=o(Xb,"SPAN",{});var Zb=r(Il);E(Eo.$$.fragment,Zb),Zb.forEach(t),Xb.forEach(t),eu=p(sc),Wl=o(sc,"SPAN",{});var ew=r(Wl);tu=a(ew,"TapasTokenizer"),ew.forEach(t),sc.forEach(t),yp=p(i),Be=o(i,"DIV",{class:!0});var bt=r(Be);E(Fo.$$.fragment,bt),su=p(bt),Hl=o(bt,"P",{});var tw=r(Hl);au=a(tw,`Construct a TAPAS tokenizer. Based on WordPiece. Flattens a table and one or more related sentences to be used by
TAPAS models.`),tw.forEach(t),nu=p(bt),Qe=o(bt,"P",{});var Xe=r(Qe);ou=a(Xe,"This tokenizer inherits from "),oi=o(Xe,"A",{href:!0});var sw=r(oi);ru=a(sw,"PreTrainedTokenizer"),sw.forEach(t),iu=a(Xe,` which contains most of the main methods. Users should refer to
...
question tokens, special tokens and padding.`),_w.forEach(t),as.forEach(t),Ou=p(bt),ii=o(bt,"P",{});var ZT=r(ii);li=o(ZT,"A",{href:!0});var Tw=r(li);Lu=a(Tw,"TapasTokenizer"),Tw.forEach(t),Qu=a(ZT,` runs end-to-end tokenization on a table and associated sentences: punctuation splitting and
wordpiece.`),ZT.forEach(t),Iu=p(bt),Sn=o(bt,"DIV",{class:!0});var ac=r(Sn);E(Ao.$$.fragment,ac),Wu=p(ac),nd=o(ac,"P",{});var vw=r(nd);Hu=a(vw,"Main method to tokenize and prepare for the model one or several sequence(s) related to a table."),vw.forEach(t),ac.forEach(t),Uu=p(bt),Ta=o(bt,"DIV",{class:!0});var Ni=r(Ta);E(zo.$$.fragment,Ni),Ru=p(Ni),xo=o(Ni,"P",{});var nc=r(xo);Gu=a(nc,"Converts logits of "),di=o(nc,"A",{href:!0});var bw=r(di);Bu=a(bw,"TapasForQuestionAnswering"),bw.forEach(t),Vu=a(nc,` to actual predicted answer coordinates and optional
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),fc.forEach(t),cg=p(ka),Yt=o(ka,"DIV",{class:!0});var qa=r(Yt);E(sr.$$.fragment,qa),hg=p(qa),pn=o(qa,"P",{});var Ii=r(pn);mg=a(Ii,"The "),_i=o(Ii,"A",{href:!0});var Vw=r(_i);ug=a(Vw,"TapasForSequenceClassification"),Vw.forEach(t),fg=a(Ii," forward method, overrides the "),_d=o(Ii,"CODE",{});var Kw=r(_d);gg=a(Kw,"__call__"),Kw.forEach(t),_g=a(Ii," special method."),Ii.forEach(t),Tg=p(qa),E(In.$$.fragment,qa),vg=p(qa),Td=o(qa,"P",{});var Yw=r(Td);bg=a(Yw,"Examples:"),Yw.forEach(t),wg=p(qa),E(ar.$$.fragment,qa),qa.forEach(t),ka.forEach(t),Ap=p(i),cn=o(i,"H2",{class:!0});var gc=r(cn);Wn=o(gc,"A",{id:!0,class:!0,href:!0});var Jw=r(Wn);vd=o(Jw,"SPAN",{});var Xw=r(vd);E(nr.$$.fragment,Xw),Xw.forEach(t),Jw.forEach(t),yg=p(gc),bd=o(gc,"SPAN",{});var Zw=r(bd);kg=a(Zw,"TapasForQuestionAnswering"),Zw.forEach(t),gc.forEach(t),zp=p(i),Ut=o(i,"DIV",{class:!0});var ja=r(Ut);E(or.$$.fragment,ja),qg=p(ja),hn=o(ja,"P",{});var Wi=r(hn);jg=a(Wi,`Tapas Model with a cell selection head and optional aggregation head on top for question-answering tasks on tables
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Tc.forEach(t),Og=p(ja),Jt=o(ja,"DIV",{class:!0});var $a=r(Jt);E(dr.$$.fragment,$a),Lg=p($a),mn=o($a,"P",{});var Hi=r(mn);Qg=a(Hi,"The "),vi=o(Hi,"A",{href:!0});var ny=r(vi);Ig=a(ny,"TapasForQuestionAnswering"),ny.forEach(t),Wg=a(Hi," forward method, overrides the "),kd=o(Hi,"CODE",{});var oy=r(kd);Hg=a(oy,"__call__"),oy.forEach(t),Ug=a(Hi," special method."),Hi.forEach(t),Rg=p($a),E(Hn.$$.fragment,$a),Gg=p($a),qd=o($a,"P",{});var ry=r(qd);Bg=a(ry,"Examples:"),ry.forEach(t),Vg=p($a),E(pr.$$.fragment,$a),$a.forEach(t),ja.forEach(t),xp=p(i),un=o(i,"H2",{class:!0});var vc=r(un);Un=o(vc,"A",{id:!0,class:!0,href:!0});var iy=r(Un);jd=o(iy,"SPAN",{});var ly=r(jd);E(cr.$$.fragment,ly),ly.forEach(t),iy.forEach(t),Kg=p(vc),$d=o(vc,"SPAN",{});var dy=r($d);Yg=a(dy,"TFTapasModel"),dy.forEach(t),vc.forEach(t),Cp=p(i),dt=o(i,"DIV",{class:!0});var As=r(dt);E(hr.$$.fragment,As),Jg=p(As),Ed=o(As,"P",{});var py=r(Ed);Xg=a(py,"The bare Tapas Model transformer outputting raw hidden-states without any specific head on top."),py.forEach(t),Zg=p(As),mr=o(As,"P",{});var bc=r(mr);e_=a(bc,"This model inherits from "),bi=o(bc,"A",{href:!0});var cy=r(bi);t_=a(cy,"TFPreTrainedModel"),cy.forEach(t),s_=a(bc,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),bc.forEach(t),a_=p(As),ur=o(As,"P",{});var wc=r(ur);n_=a(wc,"This model is also a "),fr=o(wc,"A",{href:!0,rel:!0});var hy=r(fr);o_=a(hy,"tf.keras.Model"),hy.forEach(t),r_=a(wc,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),wc.forEach(t),i_=p(As),E(Rn.$$.fragment,As),l_=p(As),Xt=o(As,"DIV",{class:!0});var Ea=r(Xt);E(gr.$$.fragment,Ea),d_=p(Ea),fn=o(Ea,"P",{});var Ui=r(fn);p_=a(Ui,"The "),wi=o(Ui,"A",{href:!0});var my=r(wi);c_=a(my,"TFTapasModel"),my.forEach(t),h_=a(Ui," forward method, overrides the "),Fd=o(Ui,"CODE",{});var uy=r(Fd);m_=a(uy,"__call__"),uy.forEach(t),u_=a(Ui," special method."),Ui.forEach(t),f_=p(Ea),E(Gn.$$.fragment,Ea),g_=p(Ea),Ad=o(Ea,"P",{});var fy=r(Ad);__=a(fy,"Examples:"),fy.forEach(t),T_=p(Ea),E(_r.$$.fragment,Ea),Ea.forEach(t),As.forEach(t),Mp=p(i),gn=o(i,"H2",{class:!0});var yc=r(gn);Bn=o(yc,"A",{id:!0,class:!0,href:!0});var gy=r(Bn);zd=o(gy,"SPAN",{});var _y=r(zd);E(Tr.$$.fragment,_y),_y.forEach(t),gy.forEach(t),v_=p(yc),xd=o(yc,"SPAN",{});var Ty=r(xd);b_=a(Ty,"TFTapasForMaskedLM"),Ty.forEach(t),yc.forEach(t),Pp=p(i),pt=o(i,"DIV",{class:!0});var zs=r(pt);E(vr.$$.fragment,zs),w_=p(zs),br=o(zs,"P",{});var kc=r(br);y_=a(kc,"Tapas Model with a "),Cd=o(kc,"CODE",{});var vy=r(Cd);k_=a(vy,"language modeling"),vy.forEach(t),q_=a(kc," head on top."),kc.forEach(t),j_=p(zs),wr=o(zs,"P",{});var qc=r(wr);$_=a(qc,"This model inherits from "),yi=o(qc,"A",{href:!0});var by=r(yi);E_=a(by,"TFPreTrainedModel"),by.forEach(t),F_=a(qc,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Fc.forEach(t),aT=p(xs),E(Jn.$$.fragment,xs),nT=p(xs),es=o(xs,"DIV",{class:!0});var Aa=r(es);E(xr.$$.fragment,Aa),oT=p(Aa),vn=o(Aa,"P",{});var Gi=r(vn);rT=a(Gi,"The "),ji=o(Gi,"A",{href:!0});var xy=r(ji);iT=a(xy,"TFTapasForSequenceClassification"),xy.forEach(t),lT=a(Gi," forward method, overrides the "),Od=o(Gi,"CODE",{});var Cy=r(Od);dT=a(Cy,"__call__"),Cy.forEach(t),pT=a(Gi," special method."),Gi.forEach(t),cT=p(Aa),E(Xn.$$.fragment,Aa),hT=p(Aa),Ld=o(Aa,"P",{});var My=r(Ld);mT=a(My,"Examples:"),My.forEach(t),uT=p(Aa),E(Cr.$$.fragment,Aa),Aa.forEach(t),xs.forEach(t),Np=p(i),bn=o(i,"H2",{class:!0});var Ac=r(bn);Zn=o(Ac,"A",{id:!0,class:!0,href:!0});var Py=r(Zn);Qd=o(Py,"SPAN",{});var Sy=r(Qd);E(Mr.$$.fragment,Sy),Sy.forEach(t),Py.forEach(t),fT=p(Ac),Id=o(Ac,"SPAN",{});var Dy=r(Id);gT=a(Dy,"TFTapasForQuestionAnswering"),Dy.forEach(t),Ac.forEach(t),Op=p(i),ht=o(i,"DIV",{class:!0});var Cs=r(ht);E(Pr.$$.fragment,Cs),_T=p(Cs),wn=o(Cs,"P",{});var Bi=r(wn);TT=a(Bi,`Tapas Model with a cell selection head and optional aggregation head on top for question-answering tasks on tables
(linear layers on top of the hidden-states output to compute `),Wd=o(Bi,"CODE",{});var Ny=r(Wd);vT=a(Ny,"logits"),Ny.forEach(t),bT=a(Bi," and optional "),Hd=o(Bi,"CODE",{});var Oy=r(Hd);wT=a(Oy,"logits_aggregation"),Oy.forEach(t),yT=a(Bi,`), e.g. for
