...
Will be ignored`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/vmain/src/transformers/models/blenderbot/tokenization_blenderbot_fast.py#L61",returnDescription:`
<p>list of <a href="../glossary#input-ids">input IDs</a> with the appropriate special tokens.</p>
`,returnType:`
<p><code>List[int]</code></p>
...
Whether or not to return a <a href="/docs/transformers/main/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vmain/src/transformers/models/blenderbot/modeling_blenderbot.py#L1120",returnDescription:`
<p>A <a
...
(masked), the loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vmain/src/transformers/models/blenderbot/modeling_blenderbot.py#L1275",returnDescription:`
<p>A <a
...
Whether or not to return a <a href="/docs/transformers/main/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vmain/src/transformers/models/blenderbot/modeling_blenderbot.py#L1442",returnDescription:`
<p>A <a
...
behaviors between training and evaluation).`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/vmain/src/transformers/models/blenderbot/modeling_tf_blenderbot.py#L1134",returnDescription:`
<p>A <a
...
Labels for computing the masked language modeling loss. Indices should either be in <code>[0, ..., config.vocab_size]</code> or -100 (see <code>input_ids</code> docstring). Tokens with indices set to <code>-100</code> are ignored
(masked), the loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vmain/src/transformers/models/blenderbot/modeling_tf_blenderbot.py#L1254",returnDescription:`
<p>A <a
...
adding special tokens. A Blenderbot sequence has the following format:`),Gi=l(),Ra=n("ul"),aa=n("li"),Wi=s("single sequence: "),Ha=n("code"),Ui=s("X </s>"),Fs=l(),mt=n("h2"),Nt=n("a"),Va=n("span"),v(Go.$$.fragment),Ri=l(),Ka=n("span"),Hi=s("BlenderbotModel"),zs=l(),We=n("p"),Vi=s("See "),Ja=n("code"),Ki=s("transformers.BartModel"),Ji=s(" for arguments to "),Qa=n("em"),Qi=s("forward"),Xi=s(" and "),Xa=n("em"),Yi=s("generate"),qs=l(),ye=n("div"),v(Wo.$$.fragment),Zi=l(),Uo=n("p"),el=s(`The bare Blenderbot Model outputting raw hidden-states without any specific head on top.
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),yc=l(),v(Qt.$$.fragment),Tc=l(),X=n("div"),v(fn.$$.fragment),wc=l(),wt=n("p"),$c=s("The "),ua=n("a"),xc=s("TFBlenderbotForConditionalGeneration"),Bc=s(" forward method, overrides the "),pr=n("code"),Fc=s("__call__"),zc=s(" special method."),qc=l(),v(Xt.$$.fragment),Ec=l(),hr=n("p"),Mc=s("Conversation example::"),Cc=l(),ur=n("blockquote"),mr=n("blockquote"),fr=n("blockquote"),_r=n("p"),jc=s(`from transformers import BlenderbotTokenizer, TFBlenderbotForConditionalGeneration >>> mname =
...
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),Kc=l(),wr=n("p"),Jc=s("Finally, this model supports inherent JAX features such as:"),Qc=l(),Re=n("ul"),$r=n("li"),Tn=n("a"),Xc=s("Just-In-Time (JIT) compilation"),Yc=l(),xr=n("li"),wn=n("a"),Zc=s("Automatic Differentiation"),ep=l(),Br=n("li"),$n=n("a"),tp=s("Vectorization"),op=l(),Fr=n("li"),xn=n("a"),np=s("Parallelization"),ap=l(),qe=n("div"),v(Bn.$$.fragment),rp=l(),xt=n("p"),sp=s("The "),zr=n("code"),dp=s("FlaxBlenderbotPreTrainedModel"),ip=s(" forward method, overrides the "),qr=n("code"),lp=s("__call__"),cp=s(" special method."),pp=l(),v(Zt.$$.fragment),hp=l(),v(eo.$$.fragment),up=l(),to=n("div"),v(Fn.$$.fragment),mp=l(),v(oo.$$.fragment),fp=l(),no=n("div"),v(zn.$$.fragment),_p=l(),v(ao.$$.fragment),Ds=l(),Bt=n("h2"),ro=n("a"),Er=n("span"),v(qn.$$.fragment),gp=l(),Mr=n("span"),bp=s("FlaxBlenderbotForConditionalGeneration"),Gs=l(),S=n("div"),v(En.$$.fragment),kp=l(),Mn=n("p"),vp=s(`The Blenderbot Model with a language modeling head. Can be used for summarization.
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),pd.forEach(t),tc=c(et),y(Ht.$$.fragment,et),oc=c(et),ze=a(et,"DIV",{class:!0});var yo=r(ze);y(ln.$$.fragment,yo),nc=c(yo),yt=a(yo,"P",{});var wa=r(yt);ac=d(wa,"The "),pa=a(wa,"A",{href:!0});var $u=r(pa);rc=d($u,"TFBlenderbotModel"),$u.forEach(t),sc=d(wa," forward method, overrides the "),ir=a(wa,"CODE",{});var xu=r(ir);dc=d(xu,"__call__"),xu.forEach(t),ic=d(wa," special method."),wa.forEach(t),lc=c(yo),y(Vt.$$.fragment,yo),cc=c(yo),y(Kt.$$.fragment,yo),yo.forEach(t),et.forEach(t),As=c(o),Tt=a(o,"H2",{class:!0});var hd=r(Tt);Jt=a(hd,"A",{id:!0,class:!0,href:!0});var Bu=r(Jt);lr=a(Bu,"SPAN",{});var Fu=r(lr);y(cn.$$.fragment,Fu),Fu.forEach(t),Bu.forEach(t),pc=c(hd),cr=a(hd,"SPAN",{});var zu=r(cr);hc=d(zu,"TFBlenderbotForConditionalGeneration"),zu.forEach(t),hd.forEach(t),Is=c(o),le=a(o,"DIV",{class:!0});var tt=r(le);y(pn.$$.fragment,tt),uc=c(tt),hn=a(tt,"P",{});var ud=r(hn);mc=d(ud,`The BLENDERBOT Model with a language modeling head. Can be used for summarization.
