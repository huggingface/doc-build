import{S as ic,i as cc,s as lc,e as r,k as l,w as m,t as s,M as dc,c as n,d as o,m as d,a as i,x as u,h as a,b as c,F as e,g as h,y as _,q as g,o as v,B as T}from"../../chunks/vendor-4833417e.js";import{T as nc}from"../../chunks/Tip-fffd6df1.js";import{D as L}from"../../chunks/Docstring-4f315ed9.js";import{C as Ps}from"../../chunks/CodeBlock-6a3d1b46.js";import{I as gt}from"../../chunks/IconCopyLink-4b81c553.js";import"../../chunks/CopyButton-dacfbfaf.js";function pc(ye){let f,q,k,w,D,S,O,I;return{c(){f=r("p"),q=s(`This class method is simply calling the feature extractor
`),k=r("a"),w=s("from_pretrained()"),D=s(` and the tokenizer
`),S=r("code"),O=s("from_pretrained"),I=s(` methods. Please refer to the docstrings of the
...
`),S=n(b,"CODE",{});var M=i(S);O=a(M,"from_pretrained"),M.forEach(o),I=a(b,` methods. Please refer to the docstrings of the
methods above for more information.`),b.forEach(o),this.h()},h(){c(k,"href","/docs/transformers/main/en/main_classes/feature_extractor#transformers.FeatureExtractionMixin.from_pretrained")},m(P,b){h(P,f,b),e(f,q),e(f,k),e(k,w),e(f,D),e(f,S),e(S,O),e(f,I)},d(P){P&&o(f)}}}function hc(ye){let f,q,k,w,D,S,O,I;return{c(){f=r("p"),q=s("This class method is simply calling "),k=r("a"),w=s("save_pretrained()"),D=s(` and
`),S=r("code"),O=s("save_pretrained"),I=s(`. Please refer to the docstrings of the methods
...
`),S=n(b,"CODE",{});var M=i(S);O=a(M,"save_pretrained"),M.forEach(o),I=a(b,`. Please refer to the docstrings of the methods
above for more information.`),b.forEach(o),this.h()},h(){c(k,"href","/docs/transformers/main/en/main_classes/feature_extractor#transformers.FeatureExtractionMixin.save_pretrained")},m(P,b){h(P,f,b),e(f,q),e(f,k),e(k,w),e(f,D),e(f,S),e(S,O),e(f,I)},d(P){P&&o(f)}}}function fc(ye){let f,q,k,w,D,S,O,I,P,b,j,M,so,$e,js,ao,Cs,Lo,R,qs,vt,Ms,Fs,Ee,As,Ls,Do,y,Ds,ro,Is,Ws,no,Vs,Ns,Tt,Os,Bs,kt,Us,Hs,xt,Rs,Js,io,Gs,Ks,Io,ie,Qs,ze,Xs,Ys,Wo,ce,Zs,Pe,ea,ta,Vo,bt,oa,No,J,je,sa,Ce,aa,ra,na,qe,ia,wt,ca,la,da,Me,pa,Fe,ha,fa,Oo,ee,le,co,Ae,ma,lo,ua,Bo,G,_a,St,ga,va,yt,Ta,ka,Uo,z,xa,$t,ba,wa,Et,Sa,ya,zt,$a,Ea,Pt,za,Pa,jt,ja,Ca,Ho,Ct,po,qa,Ro,Le,Jo,qt,De,ho,Ma,Fa,fo,Aa,Go,Ie,Ko,de,La,We,Da,Ia,Qo,te,pe,mo,Ve,Wa,uo,Va,Xo,C,Ne,Na,oe,Oa,Mt,Ba,Ua,Oe,Ha,Ra,Ja,se,Ga,Ft,Ka,Qa,At,Xa,Ya,Za,_o,er,tr,Be,Yo,ae,he,go,Ue,or,vo,sr,Zo,E,He,ar,To,rr,nr,Re,ir,Lt,cr,lr,dr,fe,Je,pr,ko,hr,fr,K,Ge,mr,xo,ur,_r,Ke,gr,bo,vr,Tr,kr,Dt,Qe,es,re,me,wo,Xe,xr,So,br,ts,x,Ye,wr,yo,Sr,yr,F,It,$r,Er,Wt,zr,Pr,Vt,jr,Cr,Ze,$o,qr,Mr,Fr,Nt,Ar,Lr,Dr,ue,et,Ir,B,Wr,Eo,Vr,Nr,Ot,Or,Br,tt,zo,Ur,Hr,Rr,Jr,Q,ot,Gr,Po,Kr,Qr,_e,Xr,X,st,Yr,at,Zr,Bt,en,tn,on,ge,sn,ve,rt,an,nt,rn,Ut,nn,cn,ln,Te,it,dn,ct,pn,Ht,hn,fn,mn,ke,lt,un,jo,_n,os,ne,xe,Co,dt,gn,qo,vn,ss,W,pt,Tn,U,kn,Rt,xn,bn,Mo,wn,Sn,Jt,yn,$n,En,ht,zn,ft,Pn,jn,Cn,Y,mt,qn,Fo,Mn,Fn,ut,as;return S=new gt({}),$e=new gt({}),Ae=new gt({}),Le=new Ps({props:{code:`import torch
...
<span class="hljs-meta">&gt;&gt;&gt; </span>loss.backward()`}}),{c(){f=r("meta"),q=l(),k=r("h1"),w=r("a"),D=r("span"),m(S.$$.fragment),O=l(),I=r("span"),P=s("Speech2Text2"),b=l(),j=r("h2"),M=r("a"),so=r("span"),m($e.$$.fragment),js=l(),ao=r("span"),Cs=s("Overview"),Lo=l(),R=r("p"),qs=s("The Speech2Text2 model is used together with "),vt=r("a"),Ms=s("Wav2Vec2"),Fs=s(` for Speech Translation models proposed in
...
`),Tt=r("a"),Os=s("Wav2Vec2"),Bs=s(" or "),kt=r("a"),Us=s("HuBERT"),Hs=s(` for Speech-to-Text tasks. Please refer to the
...
the `),Ce=r("a"),aa=s("official models"),ra=s(" ."),na=l(),qe=r("li"),ia=s("Speech2Text2 is always used within the "),wt=r("a"),ca=s("SpeechEncoderDecoder"),la=s(" framework."),da=l(),Me=r("li"),pa=s("Speech2Text2\u2019s tokenizer is based on "),Fe=r("a"),ha=s("fastBPE"),fa=s("."),Oo=l(),ee=r("h2"),le=r("a"),co=r("span"),m(Ae.$$.fragment),ma=l(),lo=r("span"),ua=s("Inference"),Bo=l(),G=r("p"),_a=s("Speech2Text2\u2019s "),St=r("a"),ga=s("SpeechEncoderDecoderModel"),va=s(` model accepts raw waveform input values from speech and
...
`),Oe=r("a"),Ha=s("facebook/s2t-small-librispeech-asr"),Ra=s(" architecture."),Ja=l(),se=r("p"),Ga=s("Configuration objects inherit from "),Ft=r("a"),Ka=s("PretrainedConfig"),Qa=s(` and can be used to control the model outputs. Read the
documentation from `),At=r("a"),Xa=s("PretrainedConfig"),Ya=s(" for more information."),Za=l(),_o=r("p"),er=s("Example:"),tr=l(),m(Be.$$.fragment),Yo=l(),ae=r("h2"),he=r("a"),go=r("span"),m(Ue.$$.fragment),or=l(),vo=r("span"),sr=s("Speech2TextTokenizer"),Zo=l(),E=r("div"),m(He.$$.fragment),ar=l(),To=r("p"),rr=s("Constructs a Speech2Text2Tokenizer."),nr=l(),Re=r("p"),ir=s("This tokenizer inherits from "),Lt=r("a"),cr=s("PreTrainedTokenizer"),lr=s(` which contains some of the main methods. Users should refer to
...
See the `),Ze=r("a"),$o=r("strong"),qr=s("call"),Mr=s("()"),Fr=s(" and "),Nt=r("a"),Ar=s("decode()"),Lr=s(" for more information."),Dr=l(),ue=r("div"),m(et.$$.fragment),Ir=l(),B=r("p"),Wr=s(`When used in normal mode, this method forwards all its arguments to AutoFeatureExtractor\u2019s
`),Eo=r("code"),Vr=s("__call__()"),Nr=s(`and returns its output. If used in the context
`),Ot=r("a"),Or=s("as_target_processor()"),Br=s(` this method forwards all its arguments to
...
can be reloaded using the `),Bt=r("a"),en=s("from_pretrained()"),tn=s(" method."),on=l(),m(ge.$$.fragment),sn=l(),ve=r("div"),m(rt.$$.fragment),an=l(),nt=r("p"),rn=s("This method forwards all its arguments to Speech2Text2Tokenizer\u2019s "),Ut=r("a"),nn=s("batch_decode()"),cn=s(`. Please
...
`),Tt=n(A,"A",{href:!0});var Rn=i(Tt);Os=a(Rn,"Wav2Vec2"),Rn.forEach(o),Bs=a(A," or "),kt=n(A,"A",{href:!0});var Jn=i(kt);Us=a(Jn,"HuBERT"),Jn.forEach(o),Hs=a(A,` for Speech-to-Text tasks. Please refer to the
...
See the `),Ze=n(H,"A",{href:!0});var An=i(Ze);$o=n(An,"STRONG",{});var Oi=i($o);qr=a(Oi,"call"),Oi.forEach(o),Mr=a(An,"()"),An.forEach(o),Fr=a(H," and "),Nt=n(H,"A",{href:!0});var Bi=i(Nt);Ar=a(Bi,"decode()"),Bi.forEach(o),Lr=a(H," for more information."),H.forEach(o),Dr=d($),ue=n($,"DIV",{class:!0});var ks=i(ue);u(et.$$.fragment,ks),Ir=d(ks),B=n(ks,"P",{});var be=i(B);Wr=a(be,`When used in normal mode, this method forwards all its arguments to AutoFeatureExtractor\u2019s
`),Eo=n(be,"CODE",{});var Ui=i(Eo);Vr=a(Ui,"__call__()"),Ui.forEach(o),Nr=a(be,`and returns its output. If used in the context
`),Ot=n(be,"A",{href:!0});var Hi=i(Ot);Or=a(Hi,"as_target_processor()"),Hi.forEach(o),Br=a(be,` this method forwards all its arguments to
