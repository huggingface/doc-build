...
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),_.forEach(t)},m(T,_){u(T,p,_),e(p,E),e(p,f),e(f,g),e(p,v)},d(T){T&&t(p)}}}function Gc(X){let p,E,f,g,v;return{c(){p=a("p"),E=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=a("code"),g=n("Module"),v=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(T){p=r(T,"P",{});var _=i(p);E=s(_,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=r(_,"CODE",{});var M=i(f);g=s(M,"Module"),M.forEach(t),v=s(_,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),_.forEach(t)},m(T,_){u(T,p,_),e(p,E),e(p,f),e(f,g),e(p,v)},d(T){T&&t(p)}}}function Kc(X){let p,E,f,g,v;return{c(){p=a("p"),E=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=a("code"),g=n("Module"),v=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(T){p=r(T,"P",{});var _=i(p);E=s(_,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=r(_,"CODE",{});var M=i(f);g=s(M,"Module"),M.forEach(t),v=s(_,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),_.forEach(t)},m(T,_){u(T,p,_),e(p,E),e(p,f),e(f,g),e(p,v)},d(T){T&&t(p)}}}function Xc(X){let p,E,f,g,v,T,_,M,fe,Q,b,J,A,Y,ge,O,_e,ce,x,S,Z,oe,F,q,Te,B,he,ne,U,pe,se,z,ve,H,ae,ke,W,j,ee,I,te,V,be;return{c(){p=a("p"),E=n("TF 2.0 models accepts two formats as inputs:"),f=l(),g=a("ul"),v=a("li"),T=n("having all inputs as keyword arguments (like PyTorch models), or"),_=l(),M=a("li"),fe=n("having all inputs as a list, tuple or dict in the first positional arguments."),Q=l(),b=a("p"),J=n("This second option is useful when using "),A=a("code"),Y=n("tf.keras.Model.fit"),ge=n(` method which currently requires having all the
...
first positional argument :`),oe=l(),F=a("ul"),q=a("li"),Te=n("a single Tensor with "),B=a("code"),he=n("input_ids"),ne=n(" only and nothing else: "),U=a("code"),pe=n("model(inputs_ids)"),se=l(),z=a("li"),ve=n(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
...
`),V=a("code"),be=n('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(h){p=r(h,"P",{});var k=i(p);E=s(k,"TF 2.0 models accepts two formats as inputs:"),k.forEach(t),f=d(h),g=r(h,"UL",{});var re=i(g);v=r(re,"LI",{});var Ae=i(v);T=s(Ae,"having all inputs as keyword arguments (like PyTorch models), or"),Ae.forEach(t),_=d(re),M=r(re,"LI",{});var ue=i(M);fe=s(ue,"having all inputs as a list, tuple or dict in the first positional arguments."),ue.forEach(t),re.forEach(t),Q=d(h),b=r(h,"P",{});var N=i(b);J=s(N,"This second option is useful when using "),A=r(N,"CODE",{});var Ee=i(A);Y=s(Ee,"tf.keras.Model.fit"),Ee.forEach(t),ge=s(N,` method which currently requires having all the
...
first positional argument :`),He.forEach(t),oe=d(h),F=r(h,"UL",{});var D=i(F);q=r(D,"LI",{});var P=i(q);Te=s(P,"a single Tensor with "),B=r(P,"CODE",{});var We=i(B);he=s(We,"input_ids"),We.forEach(t),ne=s(P," only and nothing else: "),U=r(P,"CODE",{});var Fe=i(U);pe=s(Fe,"model(inputs_ids)"),Fe.forEach(t),P.forEach(t),se=d(D),z=r(D,"LI",{});var G=i(z);ve=s(G,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
...
`),V=r(ye,"CODE",{});var Ue=i(V);be=s(Ue,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),Ue.forEach(t),ye.forEach(t),D.forEach(t)},m(h,k){u(h,p,k),e(p,E),u(h,f,k),u(h,g,k),e(g,v),e(v,T),e(g,_),e(g,M),e(M,fe),u(h,Q,k),u(h,b,k),e(b,J),e(b,A),e(A,Y),e(b,ge),e(b,O),e(O,_e),e(b,ce),u(h,x,k),u(h,S,k),e(S,Z),u(h,oe,k),u(h,F,k),e(F,q),e(q,Te),e(q,B),e(B,he),e(q,ne),e(q,U),e(U,pe),e(F,se),e(F,z),e(z,ve),e(z,H),e(H,ae),e(z,ke),e(z,W),e(W,j),e(F,ee),e(F,I),e(I,te),e(I,V),e(V,be)},d(h){h&&t(p),h&&t(f),h&&t(g),h&&t(Q),h&&t(b),h&&t(x),h&&t(S),h&&t(oe),h&&t(F)}}}function Jc(X){let p,E,f,g,v;return{c(){p=a("p"),E=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=a("code"),g=n("Module"),v=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(T){p=r(T,"P",{});var _=i(p);E=s(_,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=r(_,"CODE",{});var M=i(f);g=s(M,"Module"),M.forEach(t),v=s(_,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),_.forEach(t)},m(T,_){u(T,p,_),e(p,E),e(p,f),e(f,g),e(p,v)},d(T){T&&t(p)}}}function Qc(X){let p,E,f,g,v,T,_,M,fe,Q,b,J,A,Y,ge,O,_e,ce,x,S,Z,oe,F,q,Te,B,he,ne,U,pe,se,z,ve,H,ae,ke,W,j,ee,I,te,V,be;return{c(){p=a("p"),E=n("TF 2.0 models accepts two formats as inputs:"),f=l(),g=a("ul"),v=a("li"),T=n("having all inputs as keyword arguments (like PyTorch models), or"),_=l(),M=a("li"),fe=n("having all inputs as a list, tuple or dict in the first positional arguments."),Q=l(),b=a("p"),J=n("This second option is useful when using "),A=a("code"),Y=n("tf.keras.Model.fit"),ge=n(` method which currently requires having all the
tensors in the first argument of the model call function: `),O=a("code"),_e=n("model(inputs)"),ce=n("."),x=l(),S=a("p"),Z=n(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),oe=l(),F=a("ul"),q=a("li"),Te=n("a single Tensor with "),B=a("code"),he=n("input_ids"),ne=n(" only and nothing else: "),U=a("code"),pe=n("model(inputs_ids)"),se=l(),z=a("li"),ve=n(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),H=a("code"),ae=n("model([input_ids, attention_mask])"),ke=n(" or "),W=a("code"),j=n("model([input_ids, attention_mask, token_type_ids])"),ee=l(),I=a("li"),te=n(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),V=a("code"),be=n('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(h){p=r(h,"P",{});var k=i(p);E=s(k,"TF 2.0 models accepts two formats as inputs:"),k.forEach(t),f=d(h),g=r(h,"UL",{});var re=i(g);v=r(re,"LI",{});var Ae=i(v);T=s(Ae,"having all inputs as keyword arguments (like PyTorch models), or"),Ae.forEach(t),_=d(re),M=r(re,"LI",{});var ue=i(M);fe=s(ue,"having all inputs as a list, tuple or dict in the first positional arguments."),ue.forEach(t),re.forEach(t),Q=d(h),b=r(h,"P",{});var N=i(b);J=s(N,"This second option is useful when using "),A=r(N,"CODE",{});var Ee=i(A);Y=s(Ee,"tf.keras.Model.fit"),Ee.forEach(t),ge=s(N,` method which currently requires having all the
...
first positional argument :`),He.forEach(t),oe=d(h),F=r(h,"UL",{});var D=i(F);q=r(D,"LI",{});var P=i(q);Te=s(P,"a single Tensor with "),B=r(P,"CODE",{});var We=i(B);he=s(We,"input_ids"),We.forEach(t),ne=s(P," only and nothing else: "),U=r(P,"CODE",{});var Fe=i(U);pe=s(Fe,"model(inputs_ids)"),Fe.forEach(t),P.forEach(t),se=d(D),z=r(D,"LI",{});var G=i(z);ve=s(G,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),H=r(G,"CODE",{});var Be=i(H);ae=s(Be,"model([input_ids, attention_mask])"),Be.forEach(t),ke=s(G," or "),W=r(G,"CODE",{});var qe=i(W);j=s(qe,"model([input_ids, attention_mask, token_type_ids])"),qe.forEach(t),G.forEach(t),ee=d(D),I=r(D,"LI",{});var ye=i(I);te=s(ye,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),V=r(ye,"CODE",{});var Ue=i(V);be=s(Ue,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),Ue.forEach(t),ye.forEach(t),D.forEach(t)},m(h,k){u(h,p,k),e(p,E),u(h,f,k),u(h,g,k),e(g,v),e(v,T),e(g,_),e(g,M),e(M,fe),u(h,Q,k),u(h,b,k),e(b,J),e(b,A),e(A,Y),e(b,ge),e(b,O),e(O,_e),e(b,ce),u(h,x,k),u(h,S,k),e(S,Z),u(h,oe,k),u(h,F,k),e(F,q),e(q,Te),e(q,B),e(B,he),e(q,ne),e(q,U),e(U,pe),e(F,se),e(F,z),e(z,ve),e(z,H),e(H,ae),e(z,ke),e(z,W),e(W,j),e(F,ee),e(F,I),e(I,te),e(I,V),e(V,be)},d(h){h&&t(p),h&&t(f),h&&t(g),h&&t(Q),h&&t(b),h&&t(x),h&&t(S),h&&t(oe),h&&t(F)}}}function Yc(X){let p,E,f,g,v;return{c(){p=a("p"),E=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=a("code"),g=n("Module"),v=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(T){p=r(T,"P",{});var _=i(p);E=s(_,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=r(_,"CODE",{});var M=i(f);g=s(M,"Module"),M.forEach(t),v=s(_,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),_.forEach(t)},m(T,_){u(T,p,_),e(p,E),e(p,f),e(f,g),e(p,v)},d(T){T&&t(p)}}}function Zc(X){let p,E,f,g,v,T,_,M,fe,Q,b,J,A,Y,ge,O,_e,ce,x,S,Z,oe,F,q,Te,B,he,ne,U,pe,se,z,ve,H,ae,ke,W,j,ee,I,te,V,be;return{c(){p=a("p"),E=n("TF 2.0 models accepts two formats as inputs:"),f=l(),g=a("ul"),v=a("li"),T=n("having all inputs as keyword arguments (like PyTorch models), or"),_=l(),M=a("li"),fe=n("having all inputs as a list, tuple or dict in the first positional arguments."),Q=l(),b=a("p"),J=n("This second option is useful when using "),A=a("code"),Y=n("tf.keras.Model.fit"),ge=n(` method which currently requires having all the
tensors in the first argument of the model call function: `),O=a("code"),_e=n("model(inputs)"),ce=n("."),x=l(),S=a("p"),Z=n(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),oe=l(),F=a("ul"),q=a("li"),Te=n("a single Tensor with "),B=a("code"),he=n("input_ids"),ne=n(" only and nothing else: "),U=a("code"),pe=n("model(inputs_ids)"),se=l(),z=a("li"),ve=n(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),H=a("code"),ae=n("model([input_ids, attention_mask])"),ke=n(" or "),W=a("code"),j=n("model([input_ids, attention_mask, token_type_ids])"),ee=l(),I=a("li"),te=n(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),V=a("code"),be=n('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(h){p=r(h,"P",{});var k=i(p);E=s(k,"TF 2.0 models accepts two formats as inputs:"),k.forEach(t),f=d(h),g=r(h,"UL",{});var re=i(g);v=r(re,"LI",{});var Ae=i(v);T=s(Ae,"having all inputs as keyword arguments (like PyTorch models), or"),Ae.forEach(t),_=d(re),M=r(re,"LI",{});var ue=i(M);fe=s(ue,"having all inputs as a list, tuple or dict in the first positional arguments."),ue.forEach(t),re.forEach(t),Q=d(h),b=r(h,"P",{});var N=i(b);J=s(N,"This second option is useful when using "),A=r(N,"CODE",{});var Ee=i(A);Y=s(Ee,"tf.keras.Model.fit"),Ee.forEach(t),ge=s(N,` method which currently requires having all the
...
first positional argument :`),He.forEach(t),oe=d(h),F=r(h,"UL",{});var D=i(F);q=r(D,"LI",{});var P=i(q);Te=s(P,"a single Tensor with "),B=r(P,"CODE",{});var We=i(B);he=s(We,"input_ids"),We.forEach(t),ne=s(P," only and nothing else: "),U=r(P,"CODE",{});var Fe=i(U);pe=s(Fe,"model(inputs_ids)"),Fe.forEach(t),P.forEach(t),se=d(D),z=r(D,"LI",{});var G=i(z);ve=s(G,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),H=r(G,"CODE",{});var Be=i(H);ae=s(Be,"model([input_ids, attention_mask])"),Be.forEach(t),ke=s(G," or "),W=r(G,"CODE",{});var qe=i(W);j=s(qe,"model([input_ids, attention_mask, token_type_ids])"),qe.forEach(t),G.forEach(t),ee=d(D),I=r(D,"LI",{});var ye=i(I);te=s(ye,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),V=r(ye,"CODE",{});var Ue=i(V);be=s(Ue,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),Ue.forEach(t),ye.forEach(t),D.forEach(t)},m(h,k){u(h,p,k),e(p,E),u(h,f,k),u(h,g,k),e(g,v),e(v,T),e(g,_),e(g,M),e(M,fe),u(h,Q,k),u(h,b,k),e(b,J),e(b,A),e(A,Y),e(b,ge),e(b,O),e(O,_e),e(b,ce),u(h,x,k),u(h,S,k),e(S,Z),u(h,oe,k),u(h,F,k),e(F,q),e(q,Te),e(q,B),e(B,he),e(q,ne),e(q,U),e(U,pe),e(F,se),e(F,z),e(z,ve),e(z,H),e(H,ae),e(z,ke),e(z,W),e(W,j),e(F,ee),e(F,I),e(I,te),e(I,V),e(V,be)},d(h){h&&t(p),h&&t(f),h&&t(g),h&&t(Q),h&&t(b),h&&t(x),h&&t(S),h&&t(oe),h&&t(F)}}}function eh(X){let p,E,f,g,v;return{c(){p=a("p"),E=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=a("code"),g=n("Module"),v=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(T){p=r(T,"P",{});var _=i(p);E=s(_,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=r(_,"CODE",{});var M=i(f);g=s(M,"Module"),M.forEach(t),v=s(_,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),_.forEach(t)},m(T,_){u(T,p,_),e(p,E),e(p,f),e(f,g),e(p,v)},d(T){T&&t(p)}}}function th(X){let p,E,f,g,v,T,_,M,fe,Q,b,J,A,Y,ge,O,_e,ce,x,S,Z,oe,F,q,Te,B,he,ne,U,pe,se,z,ve,H,ae,ke,W,j,ee,I,te,V,be,h,k,re,Ae,ue,N,Ee,Oe,He,D,P,We,Fe,G,Be,qe,ye,Ue,$n,ha,pa,Xo,Rn,ua,ma,ws,Je,fa,Gt,ga,_a,Kt,Ta,va,Ls,dt,$t,Mn,Xt,ka,En,ba,$s,Ce,Jt,ya,Xe,Ca,Jo,wa,La,Qo,$a,Ra,Qt,Ma,Ea,Fa,ct,qa,Yo,za,Pa,Zo,xa,Sa,ja,Fn,Ia,Na,Yt,Rs,ht,Rt,qn,Zt,Da,zn,Aa,Ms,Ne,eo,Oa,Pn,Ha,Wa,to,Ba,en,Ua,Va,Ga,tn,oo,Es,pt,Mt,xn,no,Ka,Sn,Xa,Fs,we,so,Ja,jn,Qa,Ya,ao,Za,on,er,tr,or,ro,nr,io,sr,ar,rr,ze,lo,ir,ut,lr,nn,dr,cr,In,hr,pr,ur,Et,mr,Nn,fr,gr,co,qs,mt,Ft,Dn,ho,_r,An,Tr,zs,Le,po,vr,On,kr,br,uo,yr,sn,Cr,wr,Lr,mo,$r,fo,Rr,Mr,Er,Pe,go,Fr,ft,qr,an,zr,Pr,Hn,xr,Sr,jr,qt,Ir,Wn,Nr,Dr,_o,Ps,gt,zt,Bn,To,Ar,Un,Or,xs,$e,vo,Hr,Re,Wr,rn,Br,Ur,Vn,Vr,Gr,Gn,Kr,Xr,Kn,Jr,Qr,Xn,Yr,Zr,ei,ko,ti,ln,oi,ni,si,bo,ai,yo,ri,ii,li,ie,Co,di,_t,ci,dn,hi,pi,Jn,ui,mi,fi,Pt,gi,Qn,_i,Ti,wo,vi,Yn,ki,bi,Lo,Ss,Tt,xt,Zn,$o,yi,es,Ci,js,le,Ro,wi,ts,Li,$i,Mo,Ri,cn,Mi,Ei,Fi,Eo,qi,Fo,zi,Pi,xi,St,Si,xe,qo,ji,vt,Ii,hn,Ni,Di,os,Ai,Oi,Hi,jt,Wi,ns,Bi,Ui,zo,Is,kt,It,ss,Po,Vi,as,Gi,Ns,de,xo,Ki,rs,Xi,Ji,So,Qi,pn,Yi,Zi,el,jo,tl,Io,ol,nl,sl,Nt,al,Se,No,rl,bt,il,un,ll,dl,is,cl,hl,pl,Dt,ul,ls,ml,fl,Do,Ds,yt,At,ds,Ao,gl,cs,_l,As,K,Oo,Tl,hs,vl,kl,mn,fn,bl,yl,Cl,De,wl,ps,Ll,$l,us,Rl,Ml,ms,El,Fl,fs,ql,zl,Pl,Ho,xl,gn,Sl,jl,Il,Wo,Nl,Bo,Dl,Al,Ol,Ot,Hl,je,Uo,Wl,Ct,Bl,_n,Ul,Vl,gs,Gl,Kl,Xl,Ht,Jl,_s,Ql,Yl,Vo,Os;return T=new lt({}),Y=new lt({}),Xt=new lt({}),Jt=new Me({props:{name:"class transformers.CTRLConfig",anchor:"transformers.CTRLConfig",parameters:[{name:"vocab_size",val:" = 246534"},{name:"n_positions",val:" = 256"},{name:"n_embd",val:" = 1280"},{name:"dff",val:" = 8192"},{name:"n_layer",val:" = 48"},{name:"n_head",val:" = 16"},{name:"resid_pdrop",val:" = 0.1"},{name:"embd_pdrop",val:" = 0.1"},{name:"attn_pdrop",val:" = 0.1"},{name:"layer_norm_epsilon",val:" = 1e-06"},{name:"initializer_range",val:" = 0.02"},{name:"summary_type",val:" = 'cls_index'"},{name:"summary_use_proj",val:" = True"},{name:"summary_activation",val:" = None"},{name:"summary_proj_to_labels",val:" = True"},{name:"summary_first_dropout",val:" = 0.1"},{name:"use_cache",val:" = True"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/ctrl/configuration_ctrl.py#L26",parametersDescription:[{anchor:"transformers.CTRLConfig.vocab_size",description:`<strong>vocab_size</strong> (<code>int</code>, <em>optional</em>, defaults to 246534) &#x2014;
...
configuration. Check out the <a href="/docs/transformers/main/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),lo=new Me({props:{name:"forward",anchor:"transformers.CTRLModel.forward",parameters:[{name:"input_ids",val:" = None"},{name:"past_key_values",val:" = None"},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/ctrl/modeling_ctrl.py#L353",parametersDescription:[{anchor:"transformers.CTRLModel.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/main/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),go=new Me({props:{name:"forward",anchor:"transformers.CTRLLMHeadModel.forward",parameters:[{name:"input_ids",val:" = None"},{name:"past_key_values",val:" = None"},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"labels",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/ctrl/modeling_ctrl.py#L515",parametersDescription:[{anchor:"transformers.CTRLLMHeadModel.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
<code>input_ids_length</code> = <code>sequence_length</code> if <code>past_key_values</code> is <code>None</code> else <code>past_key_values[0].shape[-2]</code>
(<code>sequence_length</code> of input past key value states). Indices of input sequence tokens in the vocabulary.</p>
<p>If <code>past_key_values</code> is used, only input IDs that do not have their past calculated should be passed as
<code>input_ids</code>.</p>
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/main/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),St=new Lt({props:{$$slots:{default:[Xc]},$$scope:{ctx:X}}}),qo=new Me({props:{name:"call",anchor:"transformers.TFCTRLModel.call",parameters:[{name:"input_ids",val:" = None"},{name:"past_key_values",val:" = None"},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"},{name:"training",val:" = False"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/ctrl/modeling_tf_ctrl.py#L522",parametersDescription:[{anchor:"transformers.TFCTRLModel.call.input_ids",description:`<strong>input_ids</strong> (<code>Numpy array</code> or <code>tf.Tensor</code> of shape <code>(batch_size, input_ids_length)</code>) &#x2014;
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/main/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),Ot=new Lt({props:{$$slots:{default:[Zc]},$$scope:{ctx:X}}}),Uo=new Me({props:{name:"call",anchor:"transformers.TFCTRLForSequenceClassification.call",parameters:[{name:"input_ids",val:" = None"},{name:"past_key_values",val:" = None"},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"},{name:"labels",val:" = None"},{name:"training",val:" = False"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/ctrl/modeling_tf_ctrl.py#L745",parametersDescription:[{anchor:"transformers.TFCTRLForSequenceClassification.call.input_ids",description:`<strong>input_ids</strong> (<code>Numpy array</code> or <code>tf.Tensor</code> of shape <code>(batch_size, input_ids_length)</code>) &#x2014;
<code>input_ids_length</code> = <code>sequence_length</code> if <code>past</code> is <code>None</code> else <code>past[0].shape[-2]</code> (<code>sequence_length</code> of
input past key value states).</p>
<p>Indices of input sequence tokens in the vocabulary.</p>
<p>If <code>past</code> is used, only input IDs that do not have their past calculated should be passed as <code>input_ids</code>.</p>
...
`}}),Ht=new Lt({props:{$$slots:{default:[eh]},$$scope:{ctx:X}}}),Vo=new Vt({props:{code:`from transformers import CTRLTokenizer, TFCTRLForSequenceClassification
import tensorflow as tf
...
<span class="hljs-meta">&gt;&gt;&gt; </span>outputs = model(inputs)
<span class="hljs-meta">&gt;&gt;&gt; </span>loss = outputs.loss
<span class="hljs-meta">&gt;&gt;&gt; </span>logits = outputs.logits`}}),{c(){p=a("meta"),E=l(),f=a("h1"),g=a("a"),v=a("span"),y(T.$$.fragment),_=l(),M=a("span"),fe=n("CTRL"),Q=l(),b=a("h2"),J=a("a"),A=a("span"),y(Y.$$.fragment),ge=l(),O=a("span"),_e=n("Overview"),ce=l(),x=a("p"),S=n("CTRL model was proposed in "),Z=a("a"),oe=n("CTRL: A Conditional Transformer Language Model for Controllable Generation"),F=n(" by Nitish Shirish Keskar"),q=a("em"),Te=n(", Bryan McCann"),B=n(`, Lav R. Varshney, Caiming Xiong and
Richard Socher. It\u2019s a causal (unidirectional) transformer pre-trained using language modeling on a very large corpus
of ~140 GB of text data with the first token reserved as a control code (such as Links, Books, Wikipedia etc.).`),he=l(),ne=a("p"),U=n("The abstract from the paper is the following:"),pe=l(),se=a("p"),z=a("em"),ve=n(`Large-scale language models show promising text generation capabilities, but users cannot easily control particular
...
documentation from `),Zo=a("a"),xa=n("PretrainedConfig"),Sa=n(" for more information."),ja=l(),Fn=a("p"),Ia=n("Examples:"),Na=l(),y(Yt.$$.fragment),Rs=l(),ht=a("h2"),Rt=a("a"),qn=a("span"),y(Zt.$$.fragment),Da=l(),zn=a("span"),Aa=n("CTRLTokenizer"),Ms=l(),Ne=a("div"),y(eo.$$.fragment),Oa=l(),Pn=a("p"),Ha=n("Construct a CTRL tokenizer. Based on Byte-Pair-Encoding."),Wa=l(),to=a("p"),Ba=n("This tokenizer inherits from "),en=a("a"),Ua=n("PreTrainedTokenizer"),Va=n(` which contains most of the main methods. Users should refer to
this superclass for more information regarding those methods.`),Ga=l(),tn=a("div"),y(oo.$$.fragment),Es=l(),pt=a("h2"),Mt=a("a"),xn=a("span"),y(no.$$.fragment),Ka=l(),Sn=a("span"),Xa=n("CTRLModel"),Fs=l(),we=a("div"),y(so.$$.fragment),Ja=l(),jn=a("p"),Qa=n("The bare CTRL Model transformer outputting raw hidden-states without any specific head on top."),Ya=l(),ao=a("p"),Za=n("This model inherits from "),on=a("a"),er=n("PreTrainedModel"),tr=n(`. Check the superclass documentation for the generic methods the
...
and behavior.`),rr=l(),ze=a("div"),y(lo.$$.fragment),ir=l(),ut=a("p"),lr=n("The "),nn=a("a"),dr=n("CTRLModel"),cr=n(" forward method, overrides the "),In=a("code"),hr=n("__call__"),pr=n(" special method."),ur=l(),y(Et.$$.fragment),mr=l(),Nn=a("p"),fr=n("Example:"),gr=l(),y(co.$$.fragment),qs=l(),mt=a("h2"),Ft=a("a"),Dn=a("span"),y(ho.$$.fragment),_r=l(),An=a("span"),Tr=n("CTRLLMHeadModel"),zs=l(),Le=a("div"),y(po.$$.fragment),vr=l(),On=a("p"),kr=n(`The CTRL Model transformer with a language modeling head on top (linear layer with weights tied to the input
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),sl=l(),y(Nt.$$.fragment),al=l(),Se=a("div"),y(No.$$.fragment),rl=l(),bt=a("p"),il=n("The "),un=a("a"),ll=n("TFCTRLLMHeadModel"),dl=n(" forward method, overrides the "),is=a("code"),cl=n("__call__"),hl=n(" special method."),pl=l(),y(Dt.$$.fragment),ul=l(),ls=a("p"),ml=n("Example:"),fl=l(),y(Do.$$.fragment),Ds=l(),yt=a("h2"),At=a("a"),ds=a("span"),y(Ao.$$.fragment),gl=l(),cs=a("span"),_l=n("TFCTRLForSequenceClassification"),As=l(),K=a("div"),y(Oo.$$.fragment),Tl=l(),hs=a("p"),vl=n("The CTRL Model transformer with a sequence classification head on top (linear layer)."),kl=l(),mn=a("p"),fn=a("a"),bl=n("TFCTRLForSequenceClassification"),yl=n(` uses the last token in order to do the classification, as other causal models
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Ol=l(),y(Ot.$$.fragment),Hl=l(),je=a("div"),y(Uo.$$.fragment),Wl=l(),Ct=a("p"),Bl=n("The "),_n=a("a"),Ul=n("TFCTRLForSequenceClassification"),Vl=n(" forward method, overrides the "),gs=a("code"),Gl=n("__call__"),Kl=n(" special method."),Xl=l(),y(Ht.$$.fragment),Jl=l(),_s=a("p"),Ql=n("Example:"),Yl=l(),y(Vo.$$.fragment),this.h()},l(o){const m=Bc('[data-svelte="svelte-1phssyn"]',document.head);p=r(m,"META",{name:!0,content:!0}),m.forEach(t),E=d(o),f=r(o,"H1",{class:!0});var Go=i(f);g=r(Go,"A",{id:!0,class:!0,href:!0});var Ts=i(g);v=r(Ts,"SPAN",{});var vs=i(v);C(T.$$.fragment,vs),vs.forEach(t),Ts.forEach(t),_=d(Go),M=r(Go,"SPAN",{});var ks=i(M);fe=s(ks,"CTRL"),ks.forEach(t),Go.forEach(t),Q=d(o),b=r(o,"H2",{class:!0});var Ko=i(b);J=r(Ko,"A",{id:!0,class:!0,href:!0});var bs=i(J);A=r(bs,"SPAN",{});var ys=i(A);C(Y.$$.fragment,ys),ys.forEach(t),bs.forEach(t),ge=d(Ko),O=r(Ko,"SPAN",{});var Cs=i(O);_e=s(Cs,"Overview"),Cs.forEach(t),Ko.forEach(t),ce=d(o),x=r(o,"P",{});var wt=i(x);S=s(wt,"CTRL model was proposed in "),Z=r(wt,"A",{href:!0,rel:!0});var ed=i(Z);oe=s(ed,"CTRL: A Conditional Transformer Language Model for Controllable Generation"),ed.forEach(t),F=s(wt," by Nitish Shirish Keskar"),q=r(wt,"EM",{});var td=i(q);Te=s(td,", Bryan McCann"),td.forEach(t),B=s(wt,`, Lav R. Varshney, Caiming Xiong and
Richard Socher. It\u2019s a causal (unidirectional) transformer pre-trained using language modeling on a very large corpus
...
more information.`),Hs.forEach(t),h=d(Wt),k=r(Wt,"LI",{});var id=i(k);re=s(id,`CTRL is a model with absolute position embeddings so it\u2019s usually advised to pad the inputs on the right rather than
...
`),Kt=r(Tn,"A",{href:!0,rel:!0});var fd=i(Kt);Ta=s(fd,"here"),fd.forEach(t),va=s(Tn,"."),Tn.forEach(t),Ls=d(o),dt=r(o,"H2",{class:!0});var Bs=i(dt);$t=r(Bs,"A",{id:!0,class:!0,href:!0});var gd=i($t);Mn=r(gd,"SPAN",{});var _d=i(Mn);C(Xt.$$.fragment,_d),_d.forEach(t),gd.forEach(t),ka=d(Bs),En=r(Bs,"SPAN",{});var Td=i(En);ba=s(Td,"CTRLConfig"),Td.forEach(t),Bs.forEach(t),$s=d(o),Ce=r(o,"DIV",{class:!0});var Ye=i(Ce);C(Jt.$$.fragment,Ye),ya=d(Ye),Xe=r(Ye,"P",{});var Bt=i(Xe);Ca=s(Bt,"This is the configuration class to store the configuration of a "),Jo=r(Bt,"A",{href:!0});var vd=i(Jo);wa=s(vd,"CTRLModel"),vd.forEach(t),La=s(Bt," or a "),Qo=r(Bt,"A",{href:!0});var kd=i(Qo);$a=s(kd,"TFCTRLModel"),kd.forEach(t),Ra=s(Bt,`. It is used to
instantiate a CTRL model according to the specified arguments, defining the model architecture. Instantiating a
configuration with the defaults will yield a similar configuration to that of the
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Xs.forEach(t),rr=d(Ze),ze=r(Ze,"DIV",{class:!0});var et=i(ze);C(lo.$$.fragment,et),ir=d(et),ut=r(et,"P",{});var kn=i(ut);lr=s(kn,"The "),nn=r(kn,"A",{href:!0});var Id=i(nn);dr=s(Id,"CTRLModel"),Id.forEach(t),cr=s(kn," forward method, overrides the "),In=r(kn,"CODE",{});var Nd=i(In);hr=s(Nd,"__call__"),Nd.forEach(t),pr=s(kn," special method."),kn.forEach(t),ur=d(et),C(Et.$$.fragment,et),mr=d(et),Nn=r(et,"P",{});var Dd=i(Nn);fr=s(Dd,"Example:"),Dd.forEach(t),gr=d(et),C(co.$$.fragment,et),et.forEach(t),Ze.forEach(t),qs=d(o),mt=r(o,"H2",{class:!0});var Js=i(mt);Ft=r(Js,"A",{id:!0,class:!0,href:!0});var Ad=i(Ft);Dn=r(Ad,"SPAN",{});var Od=i(Dn);C(ho.$$.fragment,Od),Od.forEach(t),Ad.forEach(t),_r=d(Js),An=r(Js,"SPAN",{});var Hd=i(An);Tr=s(Hd,"CTRLLMHeadModel"),Hd.forEach(t),Js.forEach(t),zs=d(o),Le=r(o,"DIV",{class:!0});var tt=i(Le);C(po.$$.fragment,tt),vr=d(tt),On=r(tt,"P",{});var Wd=i(On);kr=s(Wd,`The CTRL Model transformer with a language modeling head on top (linear layer with weights tied to the input
...
padding tokens when `),ms=r(rt,"CODE",{});var xc=i(ms);El=s(xc,"inputs_embeds"),xc.forEach(t),Fl=s(rt," are passed instead of "),fs=r(rt,"CODE",{});var Sc=i(fs);ql=s(Sc,"input_ids"),Sc.forEach(t),zl=s(rt,`, it does the same (take the last value in
each row of the batch).`),rt.forEach(t),Pl=d(me),Ho=r(me,"P",{});var da=i(Ho);xl=s(da,"This model inherits from "),gn=r(da,"A",{href:!0});var jc=i(gn);Sl=s(jc,"TFPreTrainedModel"),jc.forEach(t),jl=s(da,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),ca.forEach(t),Ol=d(me),C(Ot.$$.fragment,me),Hl=d(me),je=r(me,"DIV",{class:!0});var it=i(je);C(Uo.$$.fragment,it),Wl=d(it),Ct=r(it,"P",{});var Ln=i(Ct);Bl=s(Ln,"The "),_n=r(Ln,"A",{href:!0});var Nc=i(_n);Ul=s(Nc,"TFCTRLForSequenceClassification"),Nc.forEach(t),Vl=s(Ln," forward method, overrides the "),gs=r(Ln,"CODE",{});var Dc=i(gs);Gl=s(Dc,"__call__"),Dc.forEach(t),Kl=s(Ln," special method."),Ln.forEach(t),Xl=d(it),C(Ht.$$.fragment,it),Jl=d(it),_s=r(it,"P",{});var Ac=i(_s);Ql=s(Ac,"Example:"),Ac.forEach(t),Yl=d(it),C(Vo.$$.fragment,it),it.forEach(t),me.forEach(t),this.h()},h(){c(p,"name","hf:doc:metadata"),c(p,"content",JSON.stringify(oh)),c(g,"id","ctrl"),c(g,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(g,"href","#ctrl"),c(f,"class","relative group"),c(J,"id","overview"),c(J,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(J,"href","#overview"),c(b,"class","relative group"),c(Z,"href","https://arxiv.org/abs/1909.05858"),c(Z,"rel","nofollow"),c(te,"href","https://github.com/salesforce/ctrl"),c(te,"rel","nofollow"),c(Xo,"href","model_doc/ctrl#transformers.CTRLModel.forward"),c(Gt,"href","https://huggingface.co/keskarnitishr"),c(Gt,"rel","nofollow"),c(Kt,"href","https://github.com/salesforce/ctrl"),c(Kt,"rel","nofollow"),c($t,"id","transformers.CTRLConfig"),c($t,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c($t,"href","#transformers.CTRLConfig"),c(dt,"class","relative group"),c(Jo,"href","/docs/transformers/main/en/model_doc/ctrl#transformers.CTRLModel"),c(Qo,"href","/docs/transformers/main/en/model_doc/ctrl#transformers.TFCTRLModel"),c(Qt,"href","https://huggingface.co/ctrl"),c(Qt,"rel","nofollow"),c(Yo,"href","/docs/transformers/main/en/main_classes/configuration#transformers.PretrainedConfig"),c(Zo,"href","/docs/transformers/main/en/main_classes/configuration#transformers.PretrainedConfig"),c(Ce,"class","docstring"),c(Rt,"id","transformers.CTRLTokenizer"),c(Rt,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(Rt,"href","#transformers.CTRLTokenizer"),c(ht,"class","relative group"),c(en,"href","/docs/transformers/main/en/main_classes/tokenizer#transformers.PreTrainedTokenizer"),c(tn,"class","docstring"),c(Ne,"class","docstring"),c(Mt,"id","transformers.CTRLModel"),c(Mt,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(Mt,"href","#transformers.CTRLModel"),c(pt,"class","relative group"),c(on,"href","/docs/transformers/main/en/main_classes/model#transformers.PreTrainedModel"),c(io,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),c(io,"rel","nofollow"),c(nn,"href","/docs/transformers/main/en/model_doc/ctrl#transformers.CTRLModel"),c(ze,"class","docstring"),c(we,"class","docstring"),c(Ft,"id","transformers.CTRLLMHeadModel"),c(Ft,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(Ft,"href","#transformers.CTRLLMHeadModel"),c(mt,"class","relative group"),c(sn,"href","/docs/transformers/main/en/main_classes/model#transformers.PreTrainedModel"),c(fo,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),c(fo,"rel","nofollow"),c(an,"href","/docs/transformers/main/en/model_doc/ctrl#transformers.CTRLLMHeadModel"),c(Pe,"class","docstring"),c(Le,"class","docstring"),c(zt,"id","transformers.CTRLForSequenceClassification"),c(zt,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(zt,"href","#transformers.CTRLForSequenceClassification"),c(gt,"class","relative group"),c(rn,"href","/docs/transformers/main/en/model_doc/ctrl#transformers.CTRLForSequenceClassification"),c(ln,"href","/docs/transformers/main/en/main_classes/model#transformers.PreTrainedModel"),c(yo,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),c(yo,"rel","nofollow"),c(dn,"href","/docs/transformers/main/en/model_doc/ctrl#transformers.CTRLForSequenceClassification"),c(ie,"class","docstring"),c($e,"class","docstring"),c(xt,"id","transformers.TFCTRLModel"),c(xt,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(xt,"href","#transformers.TFCTRLModel"),c(Tt,"class","relative group"),c(cn,"href","/docs/transformers/main/en/main_classes/model#transformers.TFPreTrainedModel"),c(Fo,"href","https://www.tensorflow.org/api_docs/python/tf/keras/Model"),c(Fo,"rel","nofollow"),c(hn,"href","/docs/transformers/main/en/model_doc/ctrl#transformers.TFCTRLModel"),c(xe,"class","docstring"),c(le,"class","docstring"),c(It,"id","transformers.TFCTRLLMHeadModel"),c(It,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(It,"href","#transformers.TFCTRLLMHeadModel"),c(kt,"class","relative group"),c(pn,"href","/docs/transformers/main/en/main_classes/model#transformers.TFPreTrainedModel"),c(Io,"href","https://www.tensorflow.org/api_docs/python/tf/keras/Model"),c(Io,"rel","nofollow"),c(un,"href","/docs/transformers/main/en/model_doc/ctrl#transformers.TFCTRLLMHeadModel"),c(Se,"class","docstring"),c(de,"class","docstring"),c(At,"id","transformers.TFCTRLForSequenceClassification"),c(At,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(At,"href","#transformers.TFCTRLForSequenceClassification"),c(yt,"class","relative group"),c(fn,"href","/docs/transformers/main/en/model_doc/ctrl#transformers.TFCTRLForSequenceClassification"),c(gn,"href","/docs/transformers/main/en/main_classes/model#transformers.TFPreTrainedModel"),c(Bo,"href","https://www.tensorflow.org/api_docs/python/tf/keras/Model"),c(Bo,"rel","nofollow"),c(_n,"href","/docs/transformers/main/en/model_doc/ctrl#transformers.TFCTRLForSequenceClassification"),c(je,"class","docstring"),c(K,"class","docstring")},m(o,m){e(document.head,p),u(o,E,m),u(o,f,m),e(f,g),e(g,v),w(T,v,null),e(f,_),e(f,M),e(M,fe),u(o,Q,m),u(o,b,m),e(b,J),e(J,A),w(Y,A,null),e(b,ge),e(b,O),e(O,_e),u(o,ce,m),u(o,x,m),e(x,S),e(x,Z),e(Z,oe),e(x,F),e(x,q),e(q,Te),e(x,B),u(o,he,m),u(o,ne,m),e(ne,U),u(o,pe,m),u(o,se,m),e(se,z),e(z,ve),u(o,H,m),u(o,ae,m),e(ae,ke),u(o,W,m),u(o,j,m),e(j,ee),e(ee,I),e(ee,te),e(te,V),e(ee,be),e(j,h),e(j,k),e(k,re),e(j,Ae),e(j,ue),e(ue,N),e(ue,Ee),e(Ee,Oe),e(ue,He),e(j,D),e(j,P),e(P,We),e(P,Fe),e(Fe,G),e(P,Be),e(P,qe),e(qe,ye),e(P,Ue),e(P,$n),e($n,ha),e(P,pa),e(P,Xo),e(Xo,Rn),e(Rn,ua),e(P,ma),u(o,ws,m),u(o,Je,m),e(Je,fa),e(Je,Gt),e(Gt,ga),e(Je,_a),e(Je,Kt),e(Kt,Ta),e(Je,va),u(o,Ls,m),u(o,dt,m),e(dt,$t),e($t,Mn),w(Xt,Mn,null),e(dt,ka),e(dt,En),e(En,ba),u(o,$s,m),u(o,Ce,m),w(Jt,Ce,null),e(Ce,ya),e(Ce,Xe),e(Xe,Ca),e(Xe,Jo),e(Jo,wa),e(Xe,La),e(Xe,Qo),e(Qo,$a),e(Xe,Ra),e(Xe,Qt),e(Qt,Ma),e(Xe,Ea),e(Ce,Fa),e(Ce,ct),e(ct,qa),e(ct,Yo),e(Yo,za),e(ct,Pa),e(ct,Zo),e(Zo,xa),e(ct,Sa),e(Ce,ja),e(Ce,Fn),e(Fn,Ia),e(Ce,Na),w(Yt,Ce,null),u(o,Rs,m),u(o,ht,m),e(ht,Rt),e(Rt,qn),w(Zt,qn,null),e(ht,Da),e(ht,zn),e(zn,Aa),u(o,Ms,m),u(o,Ne,m),w(eo,Ne,null),e(Ne,Oa),e(Ne,Pn),e(Pn,Ha),e(Ne,Wa),e(Ne,to),e(to,Ba),e(to,en),e(en,Ua),e(to,Va),e(Ne,Ga),e(Ne,tn),w(oo,tn,null),u(o,Es,m),u(o,pt,m),e(pt,Mt),e(Mt,xn),w(no,xn,null),e(pt,Ka),e(pt,Sn),e(Sn,Xa),u(o,Fs,m),u(o,we,m),w(so,we,null),e(we,Ja),e(we,jn),e(jn,Qa),e(we,Ya),e(we,ao),e(ao,Za),e(ao,on),e(on,er),e(ao,tr),e(we,or),e(we,ro),e(ro,nr),e(ro,io),e(io,sr),e(ro,ar),e(we,rr),e(we,ze),w(lo,ze,null),e(ze,ir),e(ze,ut),e(ut,lr),e(ut,nn),e(nn,dr),e(ut,cr),e(ut,In),e(In,hr),e(ut,pr),e(ze,ur),w(Et,ze,null),e(ze,mr),e(ze,Nn),e(Nn,fr),e(ze,gr),w(co,ze,null),u(o,qs,m),u(o,mt,m),e(mt,Ft),e(Ft,Dn),w(ho,Dn,null),e(mt,_r),e(mt,An),e(An,Tr),u(o,zs,m),u(o,Le,m),w(po,Le,null),e(Le,vr),e(Le,On),e(On,kr),e(Le,br),e(Le,uo),e(uo,yr),e(uo,sn),e(sn,Cr),e(uo,wr),e(Le,Lr),e(Le,mo),e(mo,$r),e(mo,fo),e(fo,Rr),e(mo,Mr),e(Le,Er),e(Le,Pe),w(go,Pe,null),e(Pe,Fr),e(Pe,ft),e(ft,qr),e(ft,an),e(an,zr),e(ft,Pr),e(ft,Hn),e(Hn,xr),e(ft,Sr),e(Pe,jr),w(qt,Pe,null),e(Pe,Ir),e(Pe,Wn),e(Wn,Nr),e(Pe,Dr),w(_o,Pe,null),u(o,Ps,m),u(o,gt,m),e(gt,zt),e(zt,Bn),w(To,Bn,null),e(gt,Ar),e(gt,Un),e(Un,Or),u(o,xs,m),u(o,$e,m),w(vo,$e,null),e($e,Hr),e($e,Re),e(Re,Wr),e(Re,rn),e(rn,Br),e(Re,Ur),e(Re,Vn),e(Vn,Vr),e(Re,Gr),e(Re,Gn),e(Gn,Kr),e(Re,Xr),e(Re,Kn),e(Kn,Jr),e(Re,Qr),e(Re,Xn),e(Xn,Yr),e(Re,Zr),e($e,ei),e($e,ko),e(ko,ti),e(ko,ln),e(ln,oi),e(ko,ni),e($e,si),e($e,bo),e(bo,ai),e(bo,yo),e(yo,ri),e(bo,ii),e($e,li),e($e,ie),w(Co,ie,null),e(ie,di),e(ie,_t),e(_t,ci),e(_t,dn),e(dn,hi),e(_t,pi),e(_t,Jn),e(Jn,ui),e(_t,mi),e(ie,fi),w(Pt,ie,null),e(ie,gi),e(ie,Qn),e(Qn,_i),e(ie,Ti),w(wo,ie,null),e(ie,vi),e(ie,Yn),e(Yn,ki),e(ie,bi),w(Lo,ie,null),u(o,Ss,m),u(o,Tt,m),e(Tt,xt),e(xt,Zn),w($o,Zn,null),e(Tt,yi),e(Tt,es),e(es,Ci),u(o,js,m),u(o,le,m),w(Ro,le,null),e(le,wi),e(le,ts),e(ts,Li),e(le,$i),e(le,Mo),e(Mo,Ri),e(Mo,cn),e(cn,Mi),e(Mo,Ei),e(le,Fi),e(le,Eo),e(Eo,qi),e(Eo,Fo),e(Fo,zi),e(Eo,Pi),e(le,xi),w(St,le,null),e(le,Si),e(le,xe),w(qo,xe,null),e(xe,ji),e(xe,vt),e(vt,Ii),e(vt,hn),e(hn,Ni),e(vt,Di),e(vt,os),e(os,Ai),e(vt,Oi),e(xe,Hi),w(jt,xe,null),e(xe,Wi),e(xe,ns),e(ns,Bi),e(xe,Ui),w(zo,xe,null),u(o,Is,m),u(o,kt,m),e(kt,It),e(It,ss),w(Po,ss,null),e(kt,Vi),e(kt,as),e(as,Gi),u(o,Ns,m),u(o,de,m),w(xo,de,null),e(de,Ki),e(de,rs),e(rs,Xi),e(de,Ji),e(de,So),e(So,Qi),e(So,pn),e(pn,Yi),e(So,Zi),e(de,el),e(de,jo),e(jo,tl),e(jo,Io),e(Io,ol),e(jo,nl),e(de,sl),w(Nt,de,null),e(de,al),e(de,Se),w(No,Se,null),e(Se,rl),e(Se,bt),e(bt,il),e(bt,un),e(un,ll),e(bt,dl),e(bt,is),e(is,cl),e(bt,hl),e(Se,pl),w(Dt,Se,null),e(Se,ul),e(Se,ls),e(ls,ml),e(Se,fl),w(Do,Se,null),u(o,Ds,m),u(o,yt,m),e(yt,At),e(At,ds),w(Ao,ds,null),e(yt,gl),e(yt,cs),e(cs,_l),u(o,As,m),u(o,K,m),w(Oo,K,null),e(K,Tl),e(K,hs),e(hs,vl),e(K,kl),e(K,mn),e(mn,fn),e(fn,bl),e(mn,yl),e(K,Cl),e(K,De),e(De,wl),e(De,ps),e(ps,Ll),e(De,$l),e(De,us),e(us,Rl),e(De,Ml),e(De,ms),e(ms,El),e(De,Fl),e(De,fs),e(fs,ql),e(De,zl),e(K,Pl),e(K,Ho),e(Ho,xl),e(Ho,gn),e(gn,Sl),e(Ho,jl),e(K,Il),e(K,Wo),e(Wo,Nl),e(Wo,Bo),e(Bo,Dl),e(Wo,Al),e(K,Ol),w(Ot,K,null),e(K,Hl),e(K,je),w(Uo,je,null),e(je,Wl),e(je,Ct),e(Ct,Bl),e(Ct,_n),e(_n,Ul),e(Ct,Vl),e(Ct,gs),e(gs,Gl),e(Ct,Kl),e(je,Xl),w(Ht,je,null),e(je,Jl),e(je,_s),e(_s,Ql),e(je,Yl),w(Vo,je,null),Os=!0},p(o,[m]){const Go={};m&2&&(Go.$$scope={dirty:m,ctx:o}),Et.$set(Go);const Ts={};m&2&&(Ts.$$scope={dirty:m,ctx:o}),qt.$set(Ts);const vs={};m&2&&(vs.$$scope={dirty:m,ctx:o}),Pt.$set(vs);const ks={};m&2&&(ks.$$scope={dirty:m,ctx:o}),St.$set(ks);const Ko={};m&2&&(Ko.$$scope={dirty:m,ctx:o}),jt.$set(Ko);const bs={};m&2&&(bs.$$scope={dirty:m,ctx:o}),Nt.$set(bs);const ys={};m&2&&(ys.$$scope={dirty:m,ctx:o}),Dt.$set(ys);const Cs={};m&2&&(Cs.$$scope={dirty:m,ctx:o}),Ot.$set(Cs);const wt={};m&2&&(wt.$$scope={dirty:m,ctx:o}),Ht.$set(wt)},i(o){Os||(L(T.$$.fragment,o),L(Y.$$.fragment,o),L(Xt.$$.fragment,o),L(Jt.$$.fragment,o),L(Yt.$$.fragment,o),L(Zt.$$.fragment,o),L(eo.$$.fragment,o),L(oo.$$.fragment,o),L(no.$$.fragment,o),L(so.$$.fragment,o),L(lo.$$.fragment,o),L(Et.$$.fragment,o),L(co.$$.fragment,o),L(ho.$$.fragment,o),L(po.$$.fragment,o),L(go.$$.fragment,o),L(qt.$$.fragment,o),L(_o.$$.fragment,o),L(To.$$.fragment,o),L(vo.$$.fragment,o),L(Co.$$.fragment,o),L(Pt.$$.fragment,o),L(wo.$$.fragment,o),L(Lo.$$.fragment,o),L($o.$$.fragment,o),L(Ro.$$.fragment,o),L(St.$$.fragment,o),L(qo.$$.fragment,o),L(jt.$$.fragment,o),L(zo.$$.fragment,o),L(Po.$$.fragment,o),L(xo.$$.fragment,o),L(Nt.$$.fragment,o),L(No.$$.fragment,o),L(Dt.$$.fragment,o),L(Do.$$.fragment,o),L(Ao.$$.fragment,o),L(Oo.$$.fragment,o),L(Ot.$$.fragment,o),L(Uo.$$.fragment,o),L(Ht.$$.fragment,o),L(Vo.$$.fragment,o),Os=!0)},o(o){$(T.$$.fragment,o),$(Y.$$.fragment,o),$(Xt.$$.fragment,o),$(Jt.$$.fragment,o),$(Yt.$$.fragment,o),$(Zt.$$.fragment,o),$(eo.$$.fragment,o),$(oo.$$.fragment,o),$(no.$$.fragment,o),$(so.$$.fragment,o),$(lo.$$.fragment,o),$(Et.$$.fragment,o),$(co.$$.fragment,o),$(ho.$$.fragment,o),$(po.$$.fragment,o),$(go.$$.fragment,o),$(qt.$$.fragment,o),$(_o.$$.fragment,o),$(To.$$.fragment,o),$(vo.$$.fragment,o),$(Co.$$.fragment,o),$(Pt.$$.fragment,o),$(wo.$$.fragment,o),$(Lo.$$.fragment,o),$($o.$$.fragment,o),$(Ro.$$.fragment,o),$(St.$$.fragment,o),$(qo.$$.fragment,o),$(jt.$$.fragment,o),$(zo.$$.fragment,o),$(Po.$$.fragment,o),$(xo.$$.fragment,o),$(Nt.$$.fragment,o),$(No.$$.fragment,o),$(Dt.$$.fragment,o),$(Do.$$.fragment,o),$(Ao.$$.fragment,o),$(Oo.$$.fragment,o),$(Ot.$$.fragment,o),$(Uo.$$.fragment,o),$(Ht.$$.fragment,o),$(Vo.$$.fragment,o),Os=!1},d(o){t(p),o&&t(E),o&&t(f),R(T),o&&t(Q),o&&t(b),R(Y),o&&t(ce),o&&t(x),o&&t(he),o&&t(ne),o&&t(pe),o&&t(se),o&&t(H),o&&t(ae),o&&t(W),o&&t(j),o&&t(ws),o&&t(Je),o&&t(Ls),o&&t(dt),R(Xt),o&&t($s),o&&t(Ce),R(Jt),R(Yt),o&&t(Rs),o&&t(ht),R(Zt),o&&t(Ms),o&&t(Ne),R(eo),R(oo),o&&t(Es),o&&t(pt),R(no),o&&t(Fs),o&&t(we),R(so),R(lo),R(Et),R(co),o&&t(qs),o&&t(mt),R(ho),o&&t(zs),o&&t(Le),R(po),R(go),R(qt),R(_o),o&&t(Ps),o&&t(gt),R(To),o&&t(xs),o&&t($e),R(vo),R(Co),R(Pt),R(wo),R(Lo),o&&t(Ss),o&&t(Tt),R($o),o&&t(js),o&&t(le),R(Ro),R(St),R(qo),R(jt),R(zo),o&&t(Is),o&&t(kt),R(Po),o&&t(Ns),o&&t(de),R(xo),R(Nt),R(No),R(Dt),R(Do),o&&t(Ds),o&&t(yt),R(Ao),o&&t(As),o&&t(K),R(Oo),R(Ot),R(Uo),R(Ht),R(Vo)}}}const oh={local:"ctrl",sections:[{local:"overview",title:"Overview"},{local:"transformers.CTRLConfig",title:"CTRLConfig"},{local:"transformers.CTRLTokenizer",title:"CTRLTokenizer"},{local:"transformers.CTRLModel",title:"CTRLModel"},{local:"transformers.CTRLLMHeadModel",title:"CTRLLMHeadModel"},{local:"transformers.CTRLForSequenceClassification",title:"CTRLForSequenceClassification"},{local:"transformers.TFCTRLModel",title:"TFCTRLModel"},{local:"transformers.TFCTRLLMHeadModel",title:"TFCTRLLMHeadModel"},{local:"transformers.TFCTRLForSequenceClassification",title:"TFCTRLForSequenceClassification"}],title:"CTRL"};function nh(X){return Uc(()=>{new URLSearchParams(window.location.search).get("fw")}),[]}class dh extends Oc{constructor(p){super();Hc(this,p,nh,th,Wc,{})}}export{dh as default,oh as metadata};
