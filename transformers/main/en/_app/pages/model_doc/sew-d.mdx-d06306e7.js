...
`}}),se=new ka({props:{$$slots:{default:[ks]},$$scope:{ctx:I}}}),ke=new ft({props:{code:`from transformers import Wav2Vec2Processor, SEWDModel
import torch
...
[<span class="hljs-number">1</span>, <span class="hljs-number">292</span>, <span class="hljs-number">384</span>]`}}),Ce=new ht({}),Te=new Je({props:{name:"class transformers.SEWDForCTC",anchor:"transformers.SEWDForCTC",parameters:[{name:"config",val:""}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/sew_d/modeling_sew_d.py#L1501",parametersDescription:[{anchor:"transformers.SEWDForCTC.config",description:`<strong>config</strong> (<a href="/docs/transformers/main/en/model_doc/sew-d#transformers.SEWDConfig">SEWDConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/main/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),Pe=new Je({props:{name:"forward",anchor:"transformers.SEWDForCTC.forward",parameters:[{name:"input_values",val:""},{name:"attention_mask",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"},{name:"labels",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/sew_d/modeling_sew_d.py#L1542",parametersDescription:[{anchor:"transformers.SEWDForCTC.forward.input_values",description:`<strong>input_values</strong> (<code>torch.FloatTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Float values of input raw speech waveform. Values can be obtained by loading a <em>.flac</em> or <em>.wav</em> audio file
into an array of type <em>List[float]</em> or a <em>numpy.ndarray</em>, <em>e.g.</em> via the soundfile library (<em>pip install
soundfile</em>). To prepare the array into <em>input_values</em>, the <a href="/docs/transformers/main/en/model_doc/wav2vec2#transformers.Wav2Vec2Processor">Wav2Vec2Processor</a> should be used for padding
...
`}}),ie=new ka({props:{$$slots:{default:[Cs]},$$scope:{ctx:I}}}),Fe=new ft({props:{code:`from transformers import Wav2Vec2Processor, SEWDForCTC
from datasets import load_dataset
import torch
...
`}}),de=new ka({props:{$$slots:{default:[Ts]},$$scope:{ctx:I}}}),He=new ft({props:{code:`from transformers import Wav2Vec2FeatureExtractor, SEWDForSequenceClassification
from datasets import load_dataset
import torch
...
<span class="hljs-meta">&gt;&gt;&gt; </span>loss = model(**inputs).loss
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-built_in">round</span>(loss.item(), <span class="hljs-number">2</span>)
<span class="hljs-number">3.16</span>`}}),{c(){p=n("meta"),W=d(),h=n("h1"),_=n("a"),D=n("span"),v(u.$$.fragment),g=d(),j=n("span"),vo=r("SEW-D"),Vt=d(),N=n("h2"),Z=n("a"),ut=n("span"),v(ce.$$.fragment),wo=d(),gt=n("span"),bo=r("Overview"),Ot=d(),ee=n("p"),yo=r("SEW-D (Squeezed and Efficient Wav2Vec with Disentangled attention) was proposed in "),me=n("a"),Eo=r(`Performance-Efficiency Trade-offs
...
documentation from `),et=n("a"),Jo=r("PretrainedConfig"),Qo=r(" for more information."),Bo=d(),yt=n("p"),Yo=r("Example:"),Go=d(),v(_e.$$.fragment),Jt=d(),U=n("h2"),ae=n("a"),Et=n("span"),v(ve.$$.fragment),Xo=d(),St=n("span"),Zo=r("SEWDModel"),Qt=d(),q=n("div"),v(we.$$.fragment),en=d(),be=n("p"),tn=r(`The bare SEW-D Model transformer outputting raw hidden-states without any specific head on top.
...
library implements for all its model (such as downloading or saving etc.).`),dn=d(),Se=n("p"),cn=r("This model is a PyTorch "),We=n("a"),mn=r("torch.nn.Module"),pn=r(` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),fn=d(),P=n("div"),v(De.$$.fragment),hn=d(),J=n("p"),un=r("The "),ot=n("a"),gn=r("SEWDModel"),_n=r(" forward method, overrides the "),Wt=n("code"),vn=r("__call__"),wn=r(" special method."),bn=d(),v(se.$$.fragment),yn=d(),Dt=n("p"),En=r("Example:"),Sn=d(),v(ke.$$.fragment),Bt=d(),Q=n("h2"),re=n("a"),kt=n("span"),v(Ce.$$.fragment),Wn=d(),Ct=n("span"),Dn=r("SEWDForCTC"),Yt=d(),x=n("div"),v(Te.$$.fragment),kn=d(),B=n("p"),Cn=r("SEW-D Model with a "),Tt=n("code"),Tn=r("language modeling"),$n=r(` head on top for Connectionist Temporal Classification (CTC).
...
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),Ln=d(),C=n("div"),v(Pe.$$.fragment),In=d(),Y=n("p"),Nn=r("The "),at=n("a"),Kn=r("SEWDForCTC"),Hn=r(" forward method, overrides the "),$t=n("code"),Rn=r("__call__"),Un=r(" special method."),Jn=d(),v(ie.$$.fragment),Qn=d(),qt=n("p"),Bn=r("Example:"),Yn=d(),v(Fe.$$.fragment),Gn=d(),v(Me.$$.fragment),Gt=d(),G=n("h2"),le=n("a"),xt=n("span"),v(ze.$$.fragment),Xn=d(),jt=n("span"),Zn=r("SEWDForSequenceClassification"),Xt=d(),k=n("div"),v(Ae.$$.fragment),ea=d(),Pt=n("p"),ta=r(`SEWD Model with a sequence classification head on top (a linear layer over the pooled output) for tasks like SUPERB
Keyword Spotting.`),oa=d(),Ve=n("p"),na=r("SEW-D was proposed in "),Oe=n("a"),aa=r(`Performance-Efficiency Trade-offs in Unsupervised Pre-training for Speech
...
library implements for all its model (such as downloading or saving etc.).`),ca=d(),Ie=n("p"),ma=r("This model is a PyTorch "),Ne=n("a"),pa=r("torch.nn.Module"),fa=r(` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),ha=d(),T=n("div"),v(Ke.$$.fragment),ua=d(),X=n("p"),ga=r("The "),rt=n("a"),_a=r("SEWDForSequenceClassification"),va=r(" forward method, overrides the "),Ft=n("code"),wa=r("__call__"),ba=r(" special method."),ya=d(),v(de.$$.fragment),Ea=d(),Mt=n("p"),Sa=r("Example:"),Wa=d(),v(He.$$.fragment),Da=d(),v(Re.$$.fragment),this.h()},l(t){const m=Ds('[data-svelte="svelte-1phssyn"]',document.head);p=a(m,"META",{name:!0,content:!0}),m.forEach(o),W=c(t),h=a(t,"H1",{class:!0});var Ue=s(h);_=a(Ue,"A",{id:!0,class:!0,href:!0});var zt=s(_);D=a(zt,"SPAN",{});var At=s(D);w(u.$$.fragment,At),At.forEach(o),zt.forEach(o),g=c(Ue),j=a(Ue,"SPAN",{});var Ca=s(j);vo=i(Ca,"SEW-D"),Ca.forEach(o),Ue.forEach(o),Vt=c(t),N=a(t,"H2",{class:!0});var eo=s(N);Z=a(eo,"A",{id:!0,class:!0,href:!0});var Ta=s(Z);ut=a(Ta,"SPAN",{});var $a=s(ut);w(ce.$$.fragment,$a),$a.forEach(o),Ta.forEach(o),wo=c(eo),gt=a(eo,"SPAN",{});var qa=s(gt);bo=i(qa,"Overview"),qa.forEach(o),eo.forEach(o),Ot=c(t),ee=a(t,"P",{});var to=s(ee);yo=i(to,"SEW-D (Squeezed and Efficient Wav2Vec with Disentangled attention) was proposed in "),me=a(to,"A",{href:!0,rel:!0});var xa=s(me);Eo=i(xa,`Performance-Efficiency Trade-offs
...
variety of training setups. For example, under the 100h-960h semi-supervised setup on LibriSpeech, SEW achieves a 1.9x
inference speedup compared to wav2vec 2.0, with a 13.5% relative reduction in word error rate. With a similar inference
time, SEW reduces word error rate by 25-50% across different model sizes.`),Fa.forEach(o),Pa.forEach(o),Nt=c(t),Ye=a(t,"P",{});var Ma=s(Ye);ko=i(Ma,"Tips:"),Ma.forEach(o),Kt=c(t),te=a(t,"UL",{});var oo=s(te);vt=a(oo,"LI",{});var za=s(vt);Co=i(za,"SEW-D is a speech model that accepts a float array corresponding to the raw waveform of the speech signal."),za.forEach(o),To=c(oo),pe=a(oo,"LI",{});var no=s(pe);$o=i(no,`SEWDForCTC is fine-tuned using connectionist temporal classification (CTC) so the model output has to be decoded
using `),Ge=a(no,"A",{href:!0});var Aa=s(Ge);qo=i(Aa,"Wav2Vec2CTCTokenizer"),Aa.forEach(o),xo=i(no,"."),no.forEach(o),oo.forEach(o),Ht=c(t),oe=a(t,"P",{});var ao=s(oe);jo=i(ao,"This model was contributed by "),fe=a(ao,"A",{href:!0,rel:!0});var Va=s(fe);Po=i(Va,"anton-l"),Va.forEach(o),Fo=i(ao,"."),ao.forEach(o),Rt=c(t),K=a(t,"H2",{class:!0});var so=s(K);ne=a(so,"A",{id:!0,class:!0,href:!0});var Oa=s(ne);wt=a(Oa,"SPAN",{});var La=s(wt);w(he.$$.fragment,La),La.forEach(o),Oa.forEach(o),Mo=c(so),bt=a(so,"SPAN",{});var Ia=s(bt);zo=i(Ia,"SEWDConfig"),Ia.forEach(o),so.forEach(o),Ut=c(t),$=a(t,"DIV",{class:!0});var A=s($);w(ue.$$.fragment,A),Ao=c(A),H=a(A,"P",{});var it=s(H);Vo=i(it,"This is the configuration class to store the configuration of a "),Xe=a(it,"A",{href:!0});var Na=s(Xe);Oo=i(Na,"SEWDModel"),Na.forEach(o),Lo=i(it,`. It is used to instantiate a SEW-D
model according to the specified arguments, defining the model architecture. Instantiating a configuration with the
defaults will yield a similar configuration to that of the SEW-D
`),ge=a(it,"A",{href:!0,rel:!0});var Ka=s(ge);Io=i(Ka,"asapp/sew-d-tiny-100k"),Ka.forEach(o),No=i(it," architecture."),it.forEach(o),Ko=c(A),R=a(A,"P",{});var lt=s(R);Ho=i(lt,"Configuration objects inherit from "),Ze=a(lt,"A",{href:!0});var Ha=s(Ze);Ro=i(Ha,"PretrainedConfig"),Ha.forEach(o),Uo=i(lt,` and can be used to control the model outputs. Read the
documentation from `),et=a(lt,"A",{href:!0});var Ra=s(et);Jo=i(Ra,"PretrainedConfig"),Ra.forEach(o),Qo=i(lt," for more information."),lt.forEach(o),Bo=c(A),yt=a(A,"P",{});var Ua=s(yt);Yo=i(Ua,"Example:"),Ua.forEach(o),Go=c(A),w(_e.$$.fragment,A),A.forEach(o),Jt=c(t),U=a(t,"H2",{class:!0});var ro=s(U);ae=a(ro,"A",{id:!0,class:!0,href:!0});var Ja=s(ae);Et=a(Ja,"SPAN",{});var Qa=s(Et);w(ve.$$.fragment,Qa),Qa.forEach(o),Ja.forEach(o),Xo=c(ro),St=a(ro,"SPAN",{});var Ba=s(St);Zo=i(Ba,"SEWDModel"),Ba.forEach(o),ro.forEach(o),Qt=c(t),q=a(t,"DIV",{class:!0});var V=s(q);w(we.$$.fragment,V),en=c(V),be=a(V,"P",{});var io=s(be);tn=i(io,`The bare SEW-D Model transformer outputting raw hidden-states without any specific head on top.
...
library implements for all its model (such as downloading or saving etc.).`),lo.forEach(o),dn=c(V),Se=a(V,"P",{});var co=s(Se);cn=i(co,"This model is a PyTorch "),We=a(co,"A",{href:!0,rel:!0});var Xa=s(We);mn=i(Xa,"torch.nn.Module"),Xa.forEach(o),pn=i(co,` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),co.forEach(o),fn=c(V),P=a(V,"DIV",{class:!0});var O=s(P);w(De.$$.fragment,O),hn=c(O),J=a(O,"P",{});var dt=s(J);un=i(dt,"The "),ot=a(dt,"A",{href:!0});var Za=s(ot);gn=i(Za,"SEWDModel"),Za.forEach(o),_n=i(dt," forward method, overrides the "),Wt=a(dt,"CODE",{});var es=s(Wt);vn=i(es,"__call__"),es.forEach(o),wn=i(dt," special method."),dt.forEach(o),bn=c(O),w(se.$$.fragment,O),yn=c(O),Dt=a(O,"P",{});var ts=s(Dt);En=i(ts,"Example:"),ts.forEach(o),Sn=c(O),w(ke.$$.fragment,O),O.forEach(o),V.forEach(o),Bt=c(t),Q=a(t,"H2",{class:!0});var mo=s(Q);re=a(mo,"A",{id:!0,class:!0,href:!0});var os=s(re);kt=a(os,"SPAN",{});var ns=s(kt);w(Ce.$$.fragment,ns),ns.forEach(o),os.forEach(o),Wn=c(mo),Ct=a(mo,"SPAN",{});var as=s(Ct);Dn=i(as,"SEWDForCTC"),as.forEach(o),mo.forEach(o),Yt=c(t),x=a(t,"DIV",{class:!0});var L=s(x);w(Te.$$.fragment,L),kn=c(L),B=a(L,"P",{});var ct=s(B);Cn=i(ct,"SEW-D Model with a "),Tt=a(ct,"CODE",{});var ss=s(Tt);Tn=i(ss,"language modeling"),ss.forEach(o),$n=i(ct,` head on top for Connectionist Temporal Classification (CTC).
...
Yoav Artzi.`),ct.forEach(o),jn=c(L),qe=a(L,"P",{});var po=s(qe);Pn=i(po,"This model inherits from "),nt=a(po,"A",{href:!0});var is=s(nt);Fn=i(is,"PreTrainedModel"),is.forEach(o),Mn=i(po,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving etc.).`),po.forEach(o),zn=c(L),xe=a(L,"P",{});var fo=s(xe);An=i(fo,"This model is a PyTorch "),je=a(fo,"A",{href:!0,rel:!0});var ls=s(je);Vn=i(ls,"torch.nn.Module"),ls.forEach(o),On=i(fo,` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),fo.forEach(o),Ln=c(L),C=a(L,"DIV",{class:!0});var F=s(C);w(Pe.$$.fragment,F),In=c(F),Y=a(F,"P",{});var mt=s(Y);Nn=i(mt,"The "),at=a(mt,"A",{href:!0});var ds=s(at);Kn=i(ds,"SEWDForCTC"),ds.forEach(o),Hn=i(mt," forward method, overrides the "),$t=a(mt,"CODE",{});var cs=s($t);Rn=i(cs,"__call__"),cs.forEach(o),Un=i(mt," special method."),mt.forEach(o),Jn=c(F),w(ie.$$.fragment,F),Qn=c(F),qt=a(F,"P",{});var ms=s(qt);Bn=i(ms,"Example:"),ms.forEach(o),Yn=c(F),w(Fe.$$.fragment,F),Gn=c(F),w(Me.$$.fragment,F),F.forEach(o),L.forEach(o),Gt=c(t),G=a(t,"H2",{class:!0});var ho=s(G);le=a(ho,"A",{id:!0,class:!0,href:!0});var ps=s(le);xt=a(ps,"SPAN",{});var fs=s(xt);w(ze.$$.fragment,fs),fs.forEach(o),ps.forEach(o),Xn=c(ho),jt=a(ho,"SPAN",{});var hs=s(jt);Zn=i(hs,"SEWDForSequenceClassification"),hs.forEach(o),ho.forEach(o),Xt=c(t),k=a(t,"DIV",{class:!0});var M=s(k);w(Ae.$$.fragment,M),ea=c(M),Pt=a(M,"P",{});var us=s(Pt);ta=i(us,`SEWD Model with a sequence classification head on top (a linear layer over the pooled output) for tasks like SUPERB
Keyword Spotting.`),us.forEach(o),oa=c(M),Ve=a(M,"P",{});var uo=s(Ve);na=i(uo,"SEW-D was proposed in "),Oe=a(uo,"A",{href:!0,rel:!0});var gs=s(Oe);aa=i(gs,`Performance-Efficiency Trade-offs in Unsupervised Pre-training for Speech
...
library implements for all its model (such as downloading or saving etc.).`),go.forEach(o),ca=c(M),Ie=a(M,"P",{});var _o=s(Ie);ma=i(_o,"This model is a PyTorch "),Ne=a(_o,"A",{href:!0,rel:!0});var vs=s(Ne);pa=i(vs,"torch.nn.Module"),vs.forEach(o),fa=i(_o,` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),_o.forEach(o),ha=c(M),T=a(M,"DIV",{class:!0});var z=s(T);w(Ke.$$.fragment,z),ua=c(z),X=a(z,"P",{});var pt=s(X);ga=i(pt,"The "),rt=a(pt,"A",{href:!0});var ws=s(rt);_a=i(ws,"SEWDForSequenceClassification"),ws.forEach(o),va=i(pt," forward method, overrides the "),Ft=a(pt,"CODE",{});var bs=s(Ft);wa=i(bs,"__call__"),bs.forEach(o),ba=i(pt," special method."),pt.forEach(o),ya=c(z),w(de.$$.fragment,z),Ea=c(z),Mt=a(z,"P",{});var ys=s(Mt);Sa=i(ys,"Example:"),ys.forEach(o),Wa=c(z),w(He.$$.fragment,z),Da=c(z),w(Re.$$.fragment,z),z.forEach(o),M.forEach(o),this.h()},h(){l(p,"name","hf:doc:metadata"),l(p,"content",JSON.stringify(qs)),l(_,"id","sewd"),l(_,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),l(_,"href","#sewd"),l(h,"class","relative group"),l(Z,"id","overview"),l(Z,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),l(Z,"href","#overview"),l(N,"class","relative group"),l(me,"href","https://arxiv.org/abs/2109.06870"),l(me,"rel","nofollow"),l(Ge,"href","/docs/transformers/main/en/model_doc/wav2vec2#transformers.Wav2Vec2CTCTokenizer"),l(fe,"href","https://huggingface.co/anton-l"),l(fe,"rel","nofollow"),l(ne,"id","transformers.SEWDConfig"),l(ne,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),l(ne,"href","#transformers.SEWDConfig"),l(K,"class","relative group"),l(Xe,"href","/docs/transformers/main/en/model_doc/sew-d#transformers.SEWDModel"),l(ge,"href","https://huggingface.co/asapp/sew-d-tiny-100k"),l(ge,"rel","nofollow"),l(Ze,"href","/docs/transformers/main/en/main_classes/configuration#transformers.PretrainedConfig"),l(et,"href","/docs/transformers/main/en/main_classes/configuration#transformers.PretrainedConfig"),l($,"class","docstring"),l(ae,"id","transformers.SEWDModel"),l(ae,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),l(ae,"href","#transformers.SEWDModel"),l(U,"class","relative group"),l(ye,"href","https://arxiv.org/abs/2109.06870"),l(ye,"rel","nofollow"),l(tt,"href","/docs/transformers/main/en/main_classes/model#transformers.PreTrainedModel"),l(We,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),l(We,"rel","nofollow"),l(ot,"href","/docs/transformers/main/en/model_doc/sew-d#transformers.SEWDModel"),l(P,"class","docstring"),l(q,"class","docstring"),l(re,"id","transformers.SEWDForCTC"),l(re,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),l(re,"href","#transformers.SEWDForCTC"),l(Q,"class","relative group"),l($e,"href","https://arxiv.org/abs/2109.06870"),l($e,"rel","nofollow"),l(nt,"href","/docs/transformers/main/en/main_classes/model#transformers.PreTrainedModel"),l(je,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),l(je,"rel","nofollow"),l(at,"href","/docs/transformers/main/en/model_doc/sew-d#transformers.SEWDForCTC"),l(C,"class","docstring"),l(x,"class","docstring"),l(le,"id","transformers.SEWDForSequenceClassification"),l(le,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),l(le,"href","#transformers.SEWDForSequenceClassification"),l(G,"class","relative group"),l(Oe,"href","https://arxiv.org/abs/2109.06870"),l(Oe,"rel","nofollow"),l(st,"href","/docs/transformers/main/en/main_classes/model#transformers.PreTrainedModel"),l(Ne,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),l(Ne,"rel","nofollow"),l(rt,"href","/docs/transformers/main/en/model_doc/sew-d#transformers.SEWDForSequenceClassification"),l(T,"class","docstring"),l(k,"class","docstring")},m(t,m){e(document.head,p),f(t,W,m),f(t,h,m),e(h,_),e(_,D),b(u,D,null),e(h,g),e(h,j),e(j,vo),f(t,Vt,m),f(t,N,m),e(N,Z),e(Z,ut),b(ce,ut,null),e(N,wo),e(N,gt),e(gt,bo),f(t,Ot,m),f(t,ee,m),e(ee,yo),e(ee,me),e(me,Eo),e(ee,So),f(t,Lt,m),f(t,Qe,m),e(Qe,Wo),f(t,It,m),f(t,Be,m),e(Be,_t),e(_t,Do),f(t,Nt,m),f(t,Ye,m),e(Ye,ko),f(t,Kt,m),f(t,te,m),e(te,vt),e(vt,Co),e(te,To),e(te,pe),e(pe,$o),e(pe,Ge),e(Ge,qo),e(pe,xo),f(t,Ht,m),f(t,oe,m),e(oe,jo),e(oe,fe),e(fe,Po),e(oe,Fo),f(t,Rt,m),f(t,K,m),e(K,ne),e(ne,wt),b(he,wt,null),e(K,Mo),e(K,bt),e(bt,zo),f(t,Ut,m),f(t,$,m),b(ue,$,null),e($,Ao),e($,H),e(H,Vo),e(H,Xe),e(Xe,Oo),e(H,Lo),e(H,ge),e(ge,Io),e(H,No),e($,Ko),e($,R),e(R,Ho),e(R,Ze),e(Ze,Ro),e(R,Uo),e(R,et),e(et,Jo),e(R,Qo),e($,Bo),e($,yt),e(yt,Yo),e($,Go),b(_e,$,null),f(t,Jt,m),f(t,U,m),e(U,ae),e(ae,Et),b(ve,Et,null),e(U,Xo),e(U,St),e(St,Zo),f(t,Qt,m),f(t,q,m),b(we,q,null),e(q,en),e(q,be),e(be,tn),e(be,ye),e(ye,on),e(be,nn),e(q,an),e(q,Ee),e(Ee,sn),e(Ee,tt),e(tt,rn),e(Ee,ln),e(q,dn),e(q,Se),e(Se,cn),e(Se,We),e(We,mn),e(Se,pn),e(q,fn),e(q,P),b(De,P,null),e(P,hn),e(P,J),e(J,un),e(J,ot),e(ot,gn),e(J,_n),e(J,Wt),e(Wt,vn),e(J,wn),e(P,bn),b(se,P,null),e(P,yn),e(P,Dt),e(Dt,En),e(P,Sn),b(ke,P,null),f(t,Bt,m),f(t,Q,m),e(Q,re),e(re,kt),b(Ce,kt,null),e(Q,Wn),e(Q,Ct),e(Ct,Dn),f(t,Yt,m),f(t,x,m),b(Te,x,null),e(x,kn),e(x,B),e(B,Cn),e(B,Tt),e(Tt,Tn),e(B,$n),e(B,$e),e($e,qn),e(B,xn),e(x,jn),e(x,qe),e(qe,Pn),e(qe,nt),e(nt,Fn),e(qe,Mn),e(x,zn),e(x,xe),e(xe,An),e(xe,je),e(je,Vn),e(xe,On),e(x,Ln),e(x,C),b(Pe,C,null),e(C,In),e(C,Y),e(Y,Nn),e(Y,at),e(at,Kn),e(Y,Hn),e(Y,$t),e($t,Rn),e(Y,Un),e(C,Jn),b(ie,C,null),e(C,Qn),e(C,qt),e(qt,Bn),e(C,Yn),b(Fe,C,null),e(C,Gn),b(Me,C,null),f(t,Gt,m),f(t,G,m),e(G,le),e(le,xt),b(ze,xt,null),e(G,Xn),e(G,jt),e(jt,Zn),f(t,Xt,m),f(t,k,m),b(Ae,k,null),e(k,ea),e(k,Pt),e(Pt,ta),e(k,oa),e(k,Ve),e(Ve,na),e(Ve,Oe),e(Oe,aa),e(Ve,sa),e(k,ra),e(k,Le),e(Le,ia),e(Le,st),e(st,la),e(Le,da),e(k,ca),e(k,Ie),e(Ie,ma),e(Ie,Ne),e(Ne,pa),e(Ie,fa),e(k,ha),e(k,T),b(Ke,T,null),e(T,ua),e(T,X),e(X,ga),e(X,rt),e(rt,_a),e(X,va),e(X,Ft),e(Ft,wa),e(X,ba),e(T,ya),b(de,T,null),e(T,Ea),e(T,Mt),e(Mt,Sa),e(T,Wa),b(He,T,null),e(T,Da),b(Re,T,null),Zt=!0},p(t,[m]){const Ue={};m&2&&(Ue.$$scope={dirty:m,ctx:t}),se.$set(Ue);const zt={};m&2&&(zt.$$scope={dirty:m,ctx:t}),ie.$set(zt);const At={};m&2&&(At.$$scope={dirty:m,ctx:t}),de.$set(At)},i(t){Zt||(y(u.$$.fragment,t),y(ce.$$.fragment,t),y(he.$$.fragment,t),y(ue.$$.fragment,t),y(_e.$$.fragment,t),y(ve.$$.fragment,t),y(we.$$.fragment,t),y(De.$$.fragment,t),y(se.$$.fragment,t),y(ke.$$.fragment,t),y(Ce.$$.fragment,t),y(Te.$$.fragment,t),y(Pe.$$.fragment,t),y(ie.$$.fragment,t),y(Fe.$$.fragment,t),y(Me.$$.fragment,t),y(ze.$$.fragment,t),y(Ae.$$.fragment,t),y(Ke.$$.fragment,t),y(de.$$.fragment,t),y(He.$$.fragment,t),y(Re.$$.fragment,t),Zt=!0)},o(t){E(u.$$.fragment,t),E(ce.$$.fragment,t),E(he.$$.fragment,t),E(ue.$$.fragment,t),E(_e.$$.fragment,t),E(ve.$$.fragment,t),E(we.$$.fragment,t),E(De.$$.fragment,t),E(se.$$.fragment,t),E(ke.$$.fragment,t),E(Ce.$$.fragment,t),E(Te.$$.fragment,t),E(Pe.$$.fragment,t),E(ie.$$.fragment,t),E(Fe.$$.fragment,t),E(Me.$$.fragment,t),E(ze.$$.fragment,t),E(Ae.$$.fragment,t),E(Ke.$$.fragment,t),E(de.$$.fragment,t),E(He.$$.fragment,t),E(Re.$$.fragment,t),Zt=!1},d(t){o(p),t&&o(W),t&&o(h),S(u),t&&o(Vt),t&&o(N),S(ce),t&&o(Ot),t&&o(ee),t&&o(Lt),t&&o(Qe),t&&o(It),t&&o(Be),t&&o(Nt),t&&o(Ye),t&&o(Kt),t&&o(te),t&&o(Ht),t&&o(oe),t&&o(Rt),t&&o(K),S(he),t&&o(Ut),t&&o($),S(ue),S(_e),t&&o(Jt),t&&o(U),S(ve),t&&o(Qt),t&&o(q),S(we),S(De),S(se),S(ke),t&&o(Bt),t&&o(Q),S(Ce),t&&o(Yt),t&&o(x),S(Te),S(Pe),S(ie),S(Fe),S(Me),t&&o(Gt),t&&o(G),S(ze),t&&o(Xt),t&&o(k),S(Ae),S(Ke),S(de),S(He),S(Re)}}}const qs={local:"sewd",sections:[{local:"overview",title:"Overview"},{local:"transformers.SEWDConfig",title:"SEWDConfig"},{local:"transformers.SEWDModel",title:"SEWDModel"},{local:"transformers.SEWDForCTC",title:"SEWDForCTC"},{local:"transformers.SEWDForSequenceClassification",title:"SEWDForSequenceClassification"}],title:"SEW-D"};function xs(I,p,W){let{fw:h}=p;return I.$$set=_=>{"fw"in _&&W(0,h=_.fw)},[h]}class Vs extends Es{constructor(p){super();Ss(this,p,xs,$s,Ws,{fw:0})}}export{Vs as default,qs as metadata};
