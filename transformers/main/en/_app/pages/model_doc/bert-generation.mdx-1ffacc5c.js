import{S as ha,i as pa,s as ua,e as s,k as l,w as g,t as o,M as ma,c as a,d as n,m as c,a as i,x as _,h as r,b as d,F as e,g as p,y as b,q as v,o as k,B as T,v as fa}from"../../chunks/vendor-6b77c823.js";import{T as ca}from"../../chunks/Tip-39098574.js";import{D as Ue}from"../../chunks/Docstring-abef54e3.js";import{C as Jt}from"../../chunks/CodeBlock-3a8b25a8.js";import{I as vt}from"../../chunks/IconCopyLink-7a11ce68.js";function ga(He){let u,D,m,B,x;return{c(){u=s("p"),D=o("Although the recipe for forward pass needs to be defined within this function, one should call the "),m=s("code"),B=o("Module"),x=o(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(y){u=a(y,"P",{});var w=i(u);D=r(w,"Although the recipe for forward pass needs to be defined within this function, one should call the "),m=a(w,"CODE",{});var S=i(m);B=r(S,"Module"),S.forEach(n),x=r(w,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),w.forEach(n)},m(y,w){p(y,u,w),e(u,D),e(u,m),e(m,B),e(u,x)},d(y){y&&n(u)}}}function _a(He){let u,D,m,B,x;return{c(){u=s("p"),D=o("Although the recipe for forward pass needs to be defined within this function, one should call the "),m=s("code"),B=o("Module"),x=o(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(y){u=a(y,"P",{});var w=i(u);D=r(w,"Although the recipe for forward pass needs to be defined within this function, one should call the "),m=a(w,"CODE",{});var S=i(m);B=r(S,"Module"),S.forEach(n),x=r(w,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),w.forEach(n)},m(y,w){p(y,u,w),e(u,D),e(u,m),e(m,B),e(u,x)},d(y){y&&n(u)}}}function ba(He){let u,D,m,B,x,y,w,S,Dn,Kt,R,Y,kt,ie,Sn,Tt,Mn,Qt,M,An,Ve,Nn,Ln,de,Fn,On,Xt,Je,In,Yt,Ke,yt,Rn,Zt,Qe,Wn,en,Xe,le,Un,Ye,Hn,Vn,tn,ce,nn,Ze,he,Jn,et,Kn,Qn,on,pe,rn,tt,Xn,sn,Z,A,nt,Yn,Zn,ot,eo,to,wt,no,oo,ro,Et,so,an,N,ao,ue,io,lo,me,co,ho,dn,W,ee,Bt,fe,po,zt,uo,ln,$,ge,mo,_e,fo,$t,go,_o,bo,U,vo,rt,ko,To,st,yo,wo,Eo,Gt,Bo,zo,be,cn,H,te,qt,ve,$o,Pt,Go,hn,C,ke,qo,Te,Po,ye,jo,xo,Co,we,Do,at,So,Mo,Ao,it,Ee,pn,V,ne,jt,Be,No,xt,Lo,un,f,ze,Fo,Ct,Oo,Io,$e,Ro,dt,Wo,Uo,Ho,Ge,Vo,qe,Jo,Ko,Qo,Pe,Xo,je,Yo,Zo,er,J,tr,lt,nr,or,xe,rr,sr,ar,E,ir,Dt,dr,lr,St,cr,hr,Mt,pr,ur,At,mr,fr,Nt,gr,_r,Lt,br,vr,kr,q,Ce,Tr,K,yr,ct,wr,Er,Ft,Br,zr,$r,oe,Gr,Ot,qr,Pr,De,mn,Q,re,It,Se,jr,Rt,xr,fn,G,Me,Cr,Ae,Dr,Wt,Sr,Mr,Ar,Ne,Nr,ht,Lr,Fr,Or,Le,Ir,Fe,Rr,Wr,Ur,P,Oe,Hr,X,Vr,pt,Jr,Kr,Ut,Qr,Xr,Yr,se,Zr,Ht,es,ts,Ie,gn;return y=new vt({}),ie=new vt({}),ce=new Jt({props:{code:`# leverage checkpoints for Bert2Bert model...
...
<span class="hljs-meta">&gt;&gt;&gt; </span>prediction_logits = outputs.logits`}}),{c(){u=s("meta"),D=l(),m=s("h1"),B=s("a"),x=s("span"),g(y.$$.fragment),w=l(),S=s("span"),Dn=o("BertGeneration"),Kt=l(),R=s("h2"),Y=s("a"),kt=s("span"),g(ie.$$.fragment),Sn=l(),Tt=s("span"),Mn=o("Overview"),Qt=l(),M=s("p"),An=o(`The BertGeneration model is a BERT model that can be leveraged for sequence-to-sequence tasks using
...
found `),me=s("a"),co=o("here"),ho=o("."),dn=l(),W=s("h2"),ee=s("a"),Bt=s("span"),g(fe.$$.fragment),po=l(),zt=s("span"),uo=o("BertGenerationConfig"),ln=l(),$=s("div"),g(ge.$$.fragment),mo=l(),_e=s("p"),fo=o("This is the configuration class to store the configuration of a "),$t=s("code"),go=o("BertGenerationPreTrainedModel"),_o=o(` It is used to
...
this superclass for more information regarding those methods.`),Ao=l(),it=s("div"),g(Ee.$$.fragment),pn=l(),V=s("h2"),ne=s("a"),jt=s("span"),g(Be.$$.fragment),No=l(),xt=s("span"),Lo=o("BertGenerationEncoder"),un=l(),f=s("div"),g(ze.$$.fragment),Fo=l(),Ct=s("p"),Oo=o("The bare BertGeneration model transformer outputting raw hidden-states without any specific head on top."),Io=l(),$e=s("p"),Ro=o("This model inherits from "),dt=s("a"),Wo=o("PreTrainedModel"),Uo=o(`. Check the superclass documentation for the generic methods the
...
to `),St=s("code"),cr=o("True"),hr=o(". To be used in a Seq2Seq model, the model needs to initialized with both "),Mt=s("code"),pr=o("is_decoder"),ur=o(` argument and
`),At=s("code"),mr=o("add_cross_attention"),fr=o(" set to "),Nt=s("code"),gr=o("True"),_r=o("; an "),Lt=s("code"),br=o("encoder_hidden_states"),vr=o(" is then expected as an input to the forward pass."),kr=l(),q=s("div"),g(Ce.$$.fragment),Tr=l(),K=s("p"),yr=o("The "),ct=s("a"),wr=o("BertGenerationEncoder"),Er=o(" forward method, overrides the "),Ft=s("code"),Br=o("__call__"),zr=o(" special method."),$r=l(),g(oe.$$.fragment),Gr=l(),Ot=s("p"),qr=o("Example:"),Pr=l(),g(De.$$.fragment),mn=l(),Q=s("h2"),re=s("a"),It=s("span"),g(Se.$$.fragment),jr=l(),Rt=s("span"),xr=o("BertGenerationDecoder"),fn=l(),G=s("div"),g(Me.$$.fragment),Cr=l(),Ae=s("p"),Dr=o("BertGeneration Model with a "),Wt=s("code"),Sr=o("language modeling"),Mr=o(" head on top for CLM fine-tuning."),Ar=l(),Ne=s("p"),Nr=o("This model inherits from "),ht=s("a"),Lr=o("PreTrainedModel"),Fr=o(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Or=l(),Le=s("p"),Ir=o("This model is also a PyTorch "),Fe=s("a"),Rr=o("torch.nn.Module"),Wr=o(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Ur=l(),P=s("div"),g(Oe.$$.fragment),Hr=l(),X=s("p"),Vr=o("The "),pt=s("a"),Jr=o("BertGenerationDecoder"),Kr=o(" forward method, overrides the "),Ut=s("code"),Qr=o("__call__"),Xr=o(" special method."),Yr=l(),g(se.$$.fragment),Zr=l(),Ht=s("p"),es=o("Example:"),ts=l(),g(Ie.$$.fragment),this.h()},l(t){const h=ma('[data-svelte="svelte-1phssyn"]',document.head);u=a(h,"META",{name:!0,content:!0}),h.forEach(n),D=c(t),m=a(t,"H1",{class:!0});var Re=i(m);B=a(Re,"A",{id:!0,class:!0,href:!0});var Vt=i(B);x=a(Vt,"SPAN",{});var ns=i(x);_(y.$$.fragment,ns),ns.forEach(n),Vt.forEach(n),w=c(Re),S=a(Re,"SPAN",{});var os=i(S);Dn=r(os,"BertGeneration"),os.forEach(n),Re.forEach(n),Kt=c(t),R=a(t,"H2",{class:!0});var _n=i(R);Y=a(_n,"A",{id:!0,class:!0,href:!0});var rs=i(Y);kt=a(rs,"SPAN",{});var ss=i(kt);_(ie.$$.fragment,ss),ss.forEach(n),rs.forEach(n),Sn=c(_n),Tt=a(_n,"SPAN",{});var as=i(Tt);Mn=r(as,"Overview"),as.forEach(n),_n.forEach(n),Qt=c(t),M=a(t,"P",{});var ut=i(M);An=r(ut,`The BertGeneration model is a BERT model that can be leveraged for sequence-to-sequence tasks using
`),Ve=a(ut,"A",{href:!0});var is=i(Ve);Nn=r(is,"EncoderDecoderModel"),is.forEach(n),Ln=r(ut," as proposed in "),de=a(ut,"A",{href:!0,rel:!0});var ds=i(de);Fn=r(ds,`Leveraging Pre-trained Checkpoints for Sequence Generation
...
Therefore, no EOS token should be added to the end of the input.`),Ts.forEach(n),kn.forEach(n),an=c(t),N=a(t,"P",{});var mt=i(N);ao=r(mt,"This model was contributed by "),ue=a(mt,"A",{href:!0,rel:!0});var ys=i(ue);io=r(ys,"patrickvonplaten"),ys.forEach(n),lo=r(mt,`. The original code can be
found `),me=a(mt,"A",{href:!0,rel:!0});var ws=i(me);co=r(ws,"here"),ws.forEach(n),ho=r(mt,"."),mt.forEach(n),dn=c(t),W=a(t,"H2",{class:!0});var Tn=i(W);ee=a(Tn,"A",{id:!0,class:!0,href:!0});var Es=i(ee);Bt=a(Es,"SPAN",{});var Bs=i(Bt);_(fe.$$.fragment,Bs),Bs.forEach(n),Es.forEach(n),po=c(Tn),zt=a(Tn,"SPAN",{});var zs=i(zt);uo=r(zs,"BertGenerationConfig"),zs.forEach(n),Tn.forEach(n),ln=c(t),$=a(t,"DIV",{class:!0});var L=i($);_(ge.$$.fragment,L),mo=c(L),_e=a(L,"P",{});var yn=i(_e);fo=r(yn,"This is the configuration class to store the configuration of a "),$t=a(yn,"CODE",{});var $s=i($t);go=r($s,"BertGenerationPreTrainedModel"),$s.forEach(n),_o=r(yn,` It is used to
