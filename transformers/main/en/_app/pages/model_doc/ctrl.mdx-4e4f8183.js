...
`),G=r(Ce,"CODE",{});var Ue=i(G);be=s(Ue,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),Ue.forEach(t),Ce.forEach(t),D.forEach(t)},m(h,k){u(h,p,k),e(p,b),u(h,f,k),u(h,g,k),e(g,v),e(v,T),e(g,_),e(g,E),e(E,fe),u(h,Q,k),u(h,C,k),e(C,J),e(C,A),e(A,Y),e(C,ge),e(C,O),e(O,_e),e(C,ce),u(h,x,k),u(h,S,k),e(S,Z),u(h,oe,k),u(h,F,k),e(F,q),e(q,Te),e(q,U),e(U,he),e(q,ne),e(q,V),e(V,pe),e(F,se),e(F,z),e(z,ve),e(z,H),e(H,ae),e(z,ke),e(z,W),e(W,j),e(F,ee),e(F,I),e(I,te),e(I,G),e(G,be)},d(h){h&&t(p),h&&t(f),h&&t(g),h&&t(Q),h&&t(C),h&&t(x),h&&t(S),h&&t(oe),h&&t(F)}}}function Xc(B){let p,b,f,g,v;return{c(){p=a("p"),b=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=a("code"),g=n("Module"),v=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(T){p=r(T,"P",{});var _=i(p);b=s(_,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=r(_,"CODE",{});var E=i(f);g=s(E,"Module"),E.forEach(t),v=s(_,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),_.forEach(t)},m(T,_){u(T,p,_),e(p,b),e(p,f),e(f,g),e(p,v)},d(T){T&&t(p)}}}function Jc(B){let p,b,f,g,v,T,_,E,fe,Q,C,J,A,Y,ge,O,_e,ce,x,S,Z,oe,F,q,Te,U,he,ne,V,pe,se,z,ve,H,ae,ke,W,j,ee,I,te,G,be;return{c(){p=a("p"),b=n("TF 2.0 models accepts two formats as inputs:"),f=l(),g=a("ul"),v=a("li"),T=n("having all inputs as keyword arguments (like PyTorch models), or"),_=l(),E=a("li"),fe=n("having all inputs as a list, tuple or dict in the first positional arguments."),Q=l(),C=a("p"),J=n("This second option is useful when using "),A=a("code"),Y=n("tf.keras.Model.fit"),ge=n(` method which currently requires having all the
tensors in the first argument of the model call function: `),O=a("code"),_e=n("model(inputs)"),ce=n("."),x=l(),S=a("p"),Z=n(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),oe=l(),F=a("ul"),q=a("li"),Te=n("a single Tensor with "),U=a("code"),he=n("input_ids"),ne=n(" only and nothing else: "),V=a("code"),pe=n("model(inputs_ids)"),se=l(),z=a("li"),ve=n(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),H=a("code"),ae=n("model([input_ids, attention_mask])"),ke=n(" or "),W=a("code"),j=n("model([input_ids, attention_mask, token_type_ids])"),ee=l(),I=a("li"),te=n(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),G=a("code"),be=n('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(h){p=r(h,"P",{});var k=i(p);b=s(k,"TF 2.0 models accepts two formats as inputs:"),k.forEach(t),f=d(h),g=r(h,"UL",{});var re=i(g);v=r(re,"LI",{});var Ae=i(v);T=s(Ae,"having all inputs as keyword arguments (like PyTorch models), or"),Ae.forEach(t),_=d(re),E=r(re,"LI",{});var ue=i(E);fe=s(ue,"having all inputs as a list, tuple or dict in the first positional arguments."),ue.forEach(t),re.forEach(t),Q=d(h),C=r(h,"P",{});var N=i(C);J=s(N,"This second option is useful when using "),A=r(N,"CODE",{});var Ee=i(A);Y=s(Ee,"tf.keras.Model.fit"),Ee.forEach(t),ge=s(N,` method which currently requires having all the
...
first positional argument :`),He.forEach(t),oe=d(h),F=r(h,"UL",{});var D=i(F);q=r(D,"LI",{});var P=i(q);Te=s(P,"a single Tensor with "),U=r(P,"CODE",{});var We=i(U);he=s(We,"input_ids"),We.forEach(t),ne=s(P," only and nothing else: "),V=r(P,"CODE",{});var Fe=i(V);pe=s(Fe,"model(inputs_ids)"),Fe.forEach(t),P.forEach(t),se=d(D),z=r(D,"LI",{});var K=i(z);ve=s(K,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),H=r(K,"CODE",{});var Be=i(H);ae=s(Be,"model([input_ids, attention_mask])"),Be.forEach(t),ke=s(K," or "),W=r(K,"CODE",{});var qe=i(W);j=s(qe,"model([input_ids, attention_mask, token_type_ids])"),qe.forEach(t),K.forEach(t),ee=d(D),I=r(D,"LI",{});var Ce=i(I);te=s(Ce,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),G=r(Ce,"CODE",{});var Ue=i(G);be=s(Ue,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),Ue.forEach(t),Ce.forEach(t),D.forEach(t)},m(h,k){u(h,p,k),e(p,b),u(h,f,k),u(h,g,k),e(g,v),e(v,T),e(g,_),e(g,E),e(E,fe),u(h,Q,k),u(h,C,k),e(C,J),e(C,A),e(A,Y),e(C,ge),e(C,O),e(O,_e),e(C,ce),u(h,x,k),u(h,S,k),e(S,Z),u(h,oe,k),u(h,F,k),e(F,q),e(q,Te),e(q,U),e(U,he),e(q,ne),e(q,V),e(V,pe),e(F,se),e(F,z),e(z,ve),e(z,H),e(H,ae),e(z,ke),e(z,W),e(W,j),e(F,ee),e(F,I),e(I,te),e(I,G),e(G,be)},d(h){h&&t(p),h&&t(f),h&&t(g),h&&t(Q),h&&t(C),h&&t(x),h&&t(S),h&&t(oe),h&&t(F)}}}function Qc(B){let p,b,f,g,v;return{c(){p=a("p"),b=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=a("code"),g=n("Module"),v=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(T){p=r(T,"P",{});var _=i(p);b=s(_,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=r(_,"CODE",{});var E=i(f);g=s(E,"Module"),E.forEach(t),v=s(_,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),_.forEach(t)},m(T,_){u(T,p,_),e(p,b),e(p,f),e(f,g),e(p,v)},d(T){T&&t(p)}}}function Yc(B){let p,b,f,g,v,T,_,E,fe,Q,C,J,A,Y,ge,O,_e,ce,x,S,Z,oe,F,q,Te,U,he,ne,V,pe,se,z,ve,H,ae,ke,W,j,ee,I,te,G,be;return{c(){p=a("p"),b=n("TF 2.0 models accepts two formats as inputs:"),f=l(),g=a("ul"),v=a("li"),T=n("having all inputs as keyword arguments (like PyTorch models), or"),_=l(),E=a("li"),fe=n("having all inputs as a list, tuple or dict in the first positional arguments."),Q=l(),C=a("p"),J=n("This second option is useful when using "),A=a("code"),Y=n("tf.keras.Model.fit"),ge=n(` method which currently requires having all the
tensors in the first argument of the model call function: `),O=a("code"),_e=n("model(inputs)"),ce=n("."),x=l(),S=a("p"),Z=n(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),oe=l(),F=a("ul"),q=a("li"),Te=n("a single Tensor with "),U=a("code"),he=n("input_ids"),ne=n(" only and nothing else: "),V=a("code"),pe=n("model(inputs_ids)"),se=l(),z=a("li"),ve=n(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),H=a("code"),ae=n("model([input_ids, attention_mask])"),ke=n(" or "),W=a("code"),j=n("model([input_ids, attention_mask, token_type_ids])"),ee=l(),I=a("li"),te=n(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),G=a("code"),be=n('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(h){p=r(h,"P",{});var k=i(p);b=s(k,"TF 2.0 models accepts two formats as inputs:"),k.forEach(t),f=d(h),g=r(h,"UL",{});var re=i(g);v=r(re,"LI",{});var Ae=i(v);T=s(Ae,"having all inputs as keyword arguments (like PyTorch models), or"),Ae.forEach(t),_=d(re),E=r(re,"LI",{});var ue=i(E);fe=s(ue,"having all inputs as a list, tuple or dict in the first positional arguments."),ue.forEach(t),re.forEach(t),Q=d(h),C=r(h,"P",{});var N=i(C);J=s(N,"This second option is useful when using "),A=r(N,"CODE",{});var Ee=i(A);Y=s(Ee,"tf.keras.Model.fit"),Ee.forEach(t),ge=s(N,` method which currently requires having all the
...
first positional argument :`),He.forEach(t),oe=d(h),F=r(h,"UL",{});var D=i(F);q=r(D,"LI",{});var P=i(q);Te=s(P,"a single Tensor with "),U=r(P,"CODE",{});var We=i(U);he=s(We,"input_ids"),We.forEach(t),ne=s(P," only and nothing else: "),V=r(P,"CODE",{});var Fe=i(V);pe=s(Fe,"model(inputs_ids)"),Fe.forEach(t),P.forEach(t),se=d(D),z=r(D,"LI",{});var K=i(z);ve=s(K,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),H=r(K,"CODE",{});var Be=i(H);ae=s(Be,"model([input_ids, attention_mask])"),Be.forEach(t),ke=s(K," or "),W=r(K,"CODE",{});var qe=i(W);j=s(qe,"model([input_ids, attention_mask, token_type_ids])"),qe.forEach(t),K.forEach(t),ee=d(D),I=r(D,"LI",{});var Ce=i(I);te=s(Ce,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),G=r(Ce,"CODE",{});var Ue=i(G);be=s(Ue,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),Ue.forEach(t),Ce.forEach(t),D.forEach(t)},m(h,k){u(h,p,k),e(p,b),u(h,f,k),u(h,g,k),e(g,v),e(v,T),e(g,_),e(g,E),e(E,fe),u(h,Q,k),u(h,C,k),e(C,J),e(C,A),e(A,Y),e(C,ge),e(C,O),e(O,_e),e(C,ce),u(h,x,k),u(h,S,k),e(S,Z),u(h,oe,k),u(h,F,k),e(F,q),e(q,Te),e(q,U),e(U,he),e(q,ne),e(q,V),e(V,pe),e(F,se),e(F,z),e(z,ve),e(z,H),e(H,ae),e(z,ke),e(z,W),e(W,j),e(F,ee),e(F,I),e(I,te),e(I,G),e(G,be)},d(h){h&&t(p),h&&t(f),h&&t(g),h&&t(Q),h&&t(C),h&&t(x),h&&t(S),h&&t(oe),h&&t(F)}}}function Zc(B){let p,b,f,g,v;return{c(){p=a("p"),b=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=a("code"),g=n("Module"),v=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(T){p=r(T,"P",{});var _=i(p);b=s(_,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=r(_,"CODE",{});var E=i(f);g=s(E,"Module"),E.forEach(t),v=s(_,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),_.forEach(t)},m(T,_){u(T,p,_),e(p,b),e(p,f),e(f,g),e(p,v)},d(T){T&&t(p)}}}function eh(B){let p,b,f,g,v,T,_,E,fe,Q,C,J,A,Y,ge,O,_e,ce,x,S,Z,oe,F,q,Te,U,he,ne,V,pe,se,z,ve,H,ae,ke,W,j,ee,I,te,G,be,h,k,re,Ae,ue,N,Ee,Oe,He,D,P,We,Fe,K,Be,qe,Ce,Ue,$n,ha,pa,Xo,Rn,ua,ma,ws,Je,fa,Gt,ga,_a,Kt,Ta,va,Ls,dt,$t,Mn,Xt,ka,En,ba,$s,ye,Jt,Ca,Xe,ya,Jo,wa,La,Qo,$a,Ra,Qt,Ma,Ea,Fa,ct,qa,Yo,za,Pa,Zo,xa,Sa,ja,Fn,Ia,Na,Yt,Rs,ht,Rt,qn,Zt,Da,zn,Aa,Ms,Ne,eo,Oa,Pn,Ha,Wa,to,Ba,en,Ua,Va,Ga,tn,oo,Es,pt,Mt,xn,no,Ka,Sn,Xa,Fs,we,so,Ja,jn,Qa,Ya,ao,Za,on,er,tr,or,ro,nr,io,sr,ar,rr,ze,lo,ir,ut,lr,nn,dr,cr,In,hr,pr,ur,Et,mr,Nn,fr,gr,co,qs,mt,Ft,Dn,ho,_r,An,Tr,zs,Le,po,vr,On,kr,br,uo,Cr,sn,yr,wr,Lr,mo,$r,fo,Rr,Mr,Er,Pe,go,Fr,ft,qr,an,zr,Pr,Hn,xr,Sr,jr,qt,Ir,Wn,Nr,Dr,_o,Ps,gt,zt,Bn,To,Ar,Un,Or,xs,$e,vo,Hr,Re,Wr,rn,Br,Ur,Vn,Vr,Gr,Gn,Kr,Xr,Kn,Jr,Qr,Xn,Yr,Zr,ei,ko,ti,ln,oi,ni,si,bo,ai,Co,ri,ii,li,ie,yo,di,_t,ci,dn,hi,pi,Jn,ui,mi,fi,Pt,gi,Qn,_i,Ti,wo,vi,Yn,ki,bi,Lo,Ss,Tt,xt,Zn,$o,Ci,es,yi,js,le,Ro,wi,ts,Li,$i,Mo,Ri,cn,Mi,Ei,Fi,Eo,qi,Fo,zi,Pi,xi,St,Si,xe,qo,ji,vt,Ii,hn,Ni,Di,os,Ai,Oi,Hi,jt,Wi,ns,Bi,Ui,zo,Is,kt,It,ss,Po,Vi,as,Gi,Ns,de,xo,Ki,rs,Xi,Ji,So,Qi,pn,Yi,Zi,el,jo,tl,Io,ol,nl,sl,Nt,al,Se,No,rl,bt,il,un,ll,dl,is,cl,hl,pl,Dt,ul,ls,ml,fl,Do,Ds,Ct,At,ds,Ao,gl,cs,_l,As,X,Oo,Tl,hs,vl,kl,mn,fn,bl,Cl,yl,De,wl,ps,Ll,$l,us,Rl,Ml,ms,El,Fl,fs,ql,zl,Pl,Ho,xl,gn,Sl,jl,Il,Wo,Nl,Bo,Dl,Al,Ol,Ot,Hl,je,Uo,Wl,yt,Bl,_n,Ul,Vl,gs,Gl,Kl,Xl,Ht,Jl,_s,Ql,Yl,Vo,Os;return T=new lt({}),Y=new lt({}),Xt=new lt({}),Jt=new Me({props:{name:"class transformers.CTRLConfig",anchor:"transformers.CTRLConfig",parameters:[{name:"vocab_size",val:" = 246534"},{name:"n_positions",val:" = 256"},{name:"n_embd",val:" = 1280"},{name:"dff",val:" = 8192"},{name:"n_layer",val:" = 48"},{name:"n_head",val:" = 16"},{name:"resid_pdrop",val:" = 0.1"},{name:"embd_pdrop",val:" = 0.1"},{name:"attn_pdrop",val:" = 0.1"},{name:"layer_norm_epsilon",val:" = 1e-06"},{name:"initializer_range",val:" = 0.02"},{name:"summary_type",val:" = 'cls_index'"},{name:"summary_use_proj",val:" = True"},{name:"summary_activation",val:" = None"},{name:"summary_proj_to_labels",val:" = True"},{name:"summary_first_dropout",val:" = 0.1"},{name:"use_cache",val:" = True"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/ctrl/configuration_ctrl.py#L26",parametersDescription:[{anchor:"transformers.CTRLConfig.vocab_size",description:`<strong>vocab_size</strong> (<code>int</code>, <em>optional</em>, defaults to 246534) &#x2014;
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/main/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),St=new Lt({props:{$$slots:{default:[Kc]},$$scope:{ctx:B}}}),qo=new Me({props:{name:"call",anchor:"transformers.TFCTRLModel.call",parameters:[{name:"input_ids",val:" = None"},{name:"past",val:" = None"},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"},{name:"training",val:" = False"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/ctrl/modeling_tf_ctrl.py#L543",parametersDescription:[{anchor:"transformers.TFCTRLModel.call.input_ids",description:`<strong>input_ids</strong> (<code>Numpy array</code> or <code>tf.Tensor</code> of shape <code>(batch_size, input_ids_length)</code>) &#x2014;
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/main/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),Nt=new Lt({props:{$$slots:{default:[Jc]},$$scope:{ctx:B}}}),No=new Me({props:{name:"call",anchor:"transformers.TFCTRLLMHeadModel.call",parameters:[{name:"input_ids",val:" = None"},{name:"past",val:" = None"},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"},{name:"labels",val:" = None"},{name:"training",val:" = False"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/ctrl/modeling_tf_ctrl.py#L670",parametersDescription:[{anchor:"transformers.TFCTRLLMHeadModel.call.input_ids",description:`<strong>input_ids</strong> (<code>Numpy array</code> or <code>tf.Tensor</code> of shape <code>(batch_size, input_ids_length)</code>) &#x2014;
<code>input_ids_length</code> = <code>sequence_length</code> if <code>past</code> is <code>None</code> else <code>past[0].shape[-2]</code> (<code>sequence_length</code> of
input past key value states).</p>
<p>Indices of input sequence tokens in the vocabulary.</p>
<p>If <code>past</code> is used, only input IDs that do not have their past calculated should be passed as <code>input_ids</code>.</p>
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/main/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),Ot=new Lt({props:{$$slots:{default:[Yc]},$$scope:{ctx:B}}}),Uo=new Me({props:{name:"call",anchor:"transformers.TFCTRLForSequenceClassification.call",parameters:[{name:"input_ids",val:" = None"},{name:"past",val:" = None"},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"},{name:"labels",val:" = None"},{name:"training",val:" = False"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/ctrl/modeling_tf_ctrl.py#L799",parametersDescription:[{anchor:"transformers.TFCTRLForSequenceClassification.call.input_ids",description:`<strong>input_ids</strong> (<code>Numpy array</code> or <code>tf.Tensor</code> of shape <code>(batch_size, input_ids_length)</code>) &#x2014;
<code>input_ids_length</code> = <code>sequence_length</code> if <code>past</code> is <code>None</code> else <code>past[0].shape[-2]</code> (<code>sequence_length</code> of
input past key value states).</p>
<p>Indices of input sequence tokens in the vocabulary.</p>
<p>If <code>past</code> is used, only input IDs that do not have their past calculated should be passed as <code>input_ids</code>.</p>
...
<span class="hljs-meta">&gt;&gt;&gt; </span>outputs = model(inputs)
<span class="hljs-meta">&gt;&gt;&gt; </span>loss = outputs.loss
<span class="hljs-meta">&gt;&gt;&gt; </span>logits = outputs.logits`}}),{c(){p=a("meta"),b=l(),f=a("h1"),g=a("a"),v=a("span"),y(T.$$.fragment),_=l(),E=a("span"),fe=n("CTRL"),Q=l(),C=a("h2"),J=a("a"),A=a("span"),y(Y.$$.fragment),ge=l(),O=a("span"),_e=n("Overview"),ce=l(),x=a("p"),S=n("CTRL model was proposed in "),Z=a("a"),oe=n("CTRL: A Conditional Transformer Language Model for Controllable Generation"),F=n(" by Nitish Shirish Keskar"),q=a("em"),Te=n(", Bryan McCann"),U=n(`, Lav R. Varshney, Caiming Xiong and
...
TensorFlow models accepts `),qe=a("code"),Ce=n("past"),Ue=n(" as input. Using the "),$n=a("code"),ha=n("past_key_values"),pa=n(` value prevents the model from re-computing
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),sl=l(),y(Nt.$$.fragment),al=l(),Se=a("div"),y(No.$$.fragment),rl=l(),bt=a("p"),il=n("The "),un=a("a"),ll=n("TFCTRLLMHeadModel"),dl=n(" forward method, overrides the "),is=a("code"),cl=n("__call__"),hl=n(" special method."),pl=l(),y(Dt.$$.fragment),ul=l(),ls=a("p"),ml=n("Example:"),fl=l(),y(Do.$$.fragment),Ds=l(),Ct=a("h2"),At=a("a"),ds=a("span"),y(Ao.$$.fragment),gl=l(),cs=a("span"),_l=n("TFCTRLForSequenceClassification"),As=l(),X=a("div"),y(Oo.$$.fragment),Tl=l(),hs=a("p"),vl=n("The CTRL Model transformer with a sequence classification head on top (linear layer)."),kl=l(),mn=a("p"),fn=a("a"),bl=n("TFCTRLForSequenceClassification"),Cl=n(` uses the last token in order to do the classification, as other causal models
...
TensorFlow models accepts `),qe=r(Qe,"CODE",{});var cd=i(qe);Ce=s(cd,"past"),cd.forEach(t),Ue=s(Qe," as input. Using the "),$n=r(Qe,"CODE",{});var hd=i($n);ha=s(hd,"past_key_values"),hd.forEach(t),pa=s(Qe,` value prevents the model from re-computing
...
`),Kt=r(Tn,"A",{href:!0,rel:!0});var fd=i(Kt);Ta=s(fd,"here"),fd.forEach(t),va=s(Tn,"."),Tn.forEach(t),Ls=d(o),dt=r(o,"H2",{class:!0});var Bs=i(dt);$t=r(Bs,"A",{id:!0,class:!0,href:!0});var gd=i($t);Mn=r(gd,"SPAN",{});var _d=i(Mn);w(Xt.$$.fragment,_d),_d.forEach(t),gd.forEach(t),ka=d(Bs),En=r(Bs,"SPAN",{});var Td=i(En);ba=s(Td,"CTRLConfig"),Td.forEach(t),Bs.forEach(t),$s=d(o),ye=r(o,"DIV",{class:!0});var Ye=i(ye);w(Jt.$$.fragment,Ye),Ca=d(Ye),Xe=r(Ye,"P",{});var Bt=i(Xe);ya=s(Bt,"This is the configuration class to store the configuration of a "),Jo=r(Bt,"A",{href:!0});var vd=i(Jo);wa=s(vd,"CTRLModel"),vd.forEach(t),La=s(Bt," or a "),Qo=r(Bt,"A",{href:!0});var kd=i(Qo);$a=s(kd,"TFCTRLModel"),kd.forEach(t),Ra=s(Bt,`. It is used to
instantiate a CTRL model according to the specified arguments, defining the model architecture. Instantiating a
configuration with the defaults will yield a similar configuration to that of the
