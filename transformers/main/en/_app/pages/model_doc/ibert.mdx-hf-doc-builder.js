...
<span class="hljs-meta">&gt;&gt;&gt; </span>loss = outputs.loss
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-built_in">round</span>(loss.item(), <span class="hljs-number">2</span>)
`}}),{c(){w(s.$$.fragment)},l(c){v(s.$$.fragment,c)},m(c,p){$(s,c,p),g=!0},p:Q,i(c){g||(T(s.$$.fragment,c),g=!0)},o(c){y(s.$$.fragment,c),g=!1},d(c){I(s,c)}}}function Fl(B){let s,g,c,p,b,n,h,q,Yn,pn,oe,ve,vo,Ke,Zn,$o,Xn,hn,$e,es,Ye,ts,os,mn,Ut,ns,un,Gt,To,ss,fn,G,rs,Ze,as,is,Xe,ls,ds,gn,ne,Te,yo,et,cs,Io,ps,_n,U,tt,hs,se,ms,Vt,us,fs,ot,gs,_s,bs,re,ks,Jt,ws,vs,Kt,$s,Ts,bn,ae,ye,Bo,nt,ys,qo,Is,kn,F,st,Bs,Mo,qs,Ms,rt,Fs,Yt,zs,xs,Es,at,Cs,it,js,Ps,As,lt,Ls,dt,Ss,Os,Rs,R,ct,Ns,ie,Ds,Zt,Ws,Qs,Fo,Hs,Us,Gs,Ie,Vs,Be,wn,le,qe,zo,pt,Js,xo,Ks,vn,z,ht,Ys,mt,Zs,Eo,Xs,er,tr,ut,or,Xt,nr,sr,rr,ft,ar,gt,ir,lr,dr,P,_t,cr,de,pr,eo,hr,mr,Co,ur,fr,gr,Me,_r,Fe,br,ze,$n,ce,xe,jo,bt,kr,Po,wr,Tn,x,kt,vr,Ao,$r,Tr,wt,yr,to,Ir,Br,qr,vt,Mr,$t,Fr,zr,xr,M,Tt,Er,pe,Cr,oo,jr,Pr,Lo,Ar,Lr,Sr,Ee,Or,Ce,Rr,je,Nr,Pe,Dr,Ae,yn,he,Le,So,yt,Wr,Oo,Qr,In,E,It,Hr,Ro,Ur,Gr,Bt,Vr,no,Jr,Kr,Yr,qt,Zr,Mt,Xr,ea,ta,N,Ft,oa,me,na,so,sa,ra,No,aa,ia,la,Se,da,Oe,Bn,ue,Re,Do,zt,ca,Wo,pa,qn,C,xt,ha,Qo,ma,ua,Et,fa,ro,ga,_a,ba,Ct,ka,jt,wa,va,$a,A,Pt,Ta,fe,ya,ao,Ia,Ba,Ho,qa,Ma,Fa,Ne,za,De,xa,We,Mn,ge,Qe,Uo,At,Ea,Go,Ca,Fn,j,Lt,ja,_e,Pa,Vo,Aa,La,Jo,Sa,Oa,Ra,St,Na,io,Da,Wa,Qa,Ot,Ha,Rt,Ua,Ga,Va,L,Nt,Ja,be,Ka,lo,Ya,Za,Ko,Xa,ei,ti,He,oi,Ue,ni,Ge,zn;return n=new we({}),Ke=new we({}),et=new we({}),tt=new O({props:{name:"class transformers.IBertConfig",anchor:"transformers.IBertConfig",parameters:[{name:"vocab_size",val:" = 30522"},{name:"hidden_size",val:" = 768"},{name:"num_hidden_layers",val:" = 12"},{name:"num_attention_heads",val:" = 12"},{name:"intermediate_size",val:" = 3072"},{name:"hidden_act",val:" = 'gelu'"},{name:"hidden_dropout_prob",val:" = 0.1"},{name:"attention_probs_dropout_prob",val:" = 0.1"},{name:"max_position_embeddings",val:" = 512"},{name:"type_vocab_size",val:" = 2"},{name:"initializer_range",val:" = 0.02"},{name:"layer_norm_eps",val:" = 1e-12"},{name:"pad_token_id",val:" = 1"},{name:"bos_token_id",val:" = 0"},{name:"eos_token_id",val:" = 2"},{name:"position_embedding_type",val:" = 'absolute'"},{name:"quant_mode",val:" = False"},{name:"force_dequant",val:" = 'none'"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.IBertConfig.vocab_size",description:`<strong>vocab_size</strong> (<code>int</code>, <em>optional</em>, defaults to 30522) &#x2014;
...
`}}),Me=new wo({props:{$$slots:{default:[ml]},$$scope:{ctx:B}}}),Fe=new W({props:{anchor:"transformers.IBertForMaskedLM.forward.example",$$slots:{default:[ul]},$$scope:{ctx:B}}}),ze=new W({props:{anchor:"transformers.IBertForMaskedLM.forward.example-2",$$slots:{default:[fl]},$$scope:{ctx:B}}}),bt=new we({}),kt=new O({props:{name:"class transformers.IBertForSequenceClassification",anchor:"transformers.IBertForSequenceClassification",parameters:[{name:"config",val:""}],parametersDescription:[{anchor:"transformers.IBertForSequenceClassification.config",description:`<strong>config</strong> (<a href="/docs/transformers/main/en/model_doc/ibert#transformers.IBertConfig">IBertConfig</a>) &#x2014; Model configuration class with all the parameters of the
model. Initializing with a config file does not load the weights associated with the model, only the
...
`}}),Se=new wo({props:{$$slots:{default:[vl]},$$scope:{ctx:B}}}),Oe=new W({props:{anchor:"transformers.IBertForMultipleChoice.forward.example",$$slots:{default:[$l]},$$scope:{ctx:B}}}),zt=new we({}),xt=new O({props:{name:"class transformers.IBertForTokenClassification",anchor:"transformers.IBertForTokenClassification",parameters:[{name:"config",val:""}],parametersDescription:[{anchor:"transformers.IBertForTokenClassification.config",description:`<strong>config</strong> (<a href="/docs/transformers/main/en/model_doc/ibert#transformers.IBertConfig">IBertConfig</a>) &#x2014; Model configuration class with all the parameters of the
model. Initializing with a config file does not load the weights associated with the model, only the
...
documentation from `),Kt=r("a"),$s=l("PretrainedConfig"),Ts=l(" for more information."),bn=u(),ae=r("h2"),ye=r("a"),Bo=r("span"),w(nt.$$.fragment),ys=u(),qo=r("span"),Is=l("IBertModel"),kn=u(),F=r("div"),w(st.$$.fragment),Bs=u(),Mo=r("p"),qs=l("The bare I-BERT Model transformer outputting raw hidden-states without any specific head on top."),Ms=u(),rt=r("p"),Fs=l("This model inherits from "),Yt=r("a"),zs=l("PreTrainedModel"),xs=l(`. Check the superclass documentation for the generic methods the
...
Llion Jones, Aidan N. Gomez, Lukasz Kaiser and Illia Polosukhin.`),Rs=u(),R=r("div"),w(ct.$$.fragment),Ns=u(),ie=r("p"),Ds=l("The "),Zt=r("a"),Ws=l("IBertModel"),Qs=l(" forward method, overrides the "),Fo=r("code"),Hs=l("__call__"),Us=l(" special method."),Gs=u(),w(Ie.$$.fragment),Vs=u(),w(Be.$$.fragment),wn=u(),le=r("h2"),qe=r("a"),zo=r("span"),w(pt.$$.fragment),Js=u(),xo=r("span"),Ks=l("IBertForMaskedLM"),vn=u(),z=r("div"),w(ht.$$.fragment),Ys=u(),mt=r("p"),Zs=l("I-BERT Model with a "),Eo=r("code"),Xs=l("language modeling"),er=l(" head on top."),tr=u(),ut=r("p"),or=l("This model inherits from "),Xt=r("a"),nr=l("PreTrainedModel"),sr=l(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),rr=u(),ft=r("p"),ar=l("This model is also a PyTorch "),gt=r("a"),ir=l("torch.nn.Module"),lr=l(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),dr=u(),P=r("div"),w(_t.$$.fragment),cr=u(),de=r("p"),pr=l("The "),eo=r("a"),hr=l("IBertForMaskedLM"),mr=l(" forward method, overrides the "),Co=r("code"),ur=l("__call__"),fr=l(" special method."),gr=u(),w(Me.$$.fragment),_r=u(),w(Fe.$$.fragment),br=u(),w(ze.$$.fragment),$n=u(),ce=r("h2"),xe=r("a"),jo=r("span"),w(bt.$$.fragment),kr=u(),Po=r("span"),wr=l("IBertForSequenceClassification"),Tn=u(),x=r("div"),w(kt.$$.fragment),vr=u(),Ao=r("p"),$r=l(`I-BERT Model transformer with a sequence classification/regression head on top (a linear layer on top of the pooled
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),qr=u(),vt=r("p"),Mr=l("This model is also a PyTorch "),$t=r("a"),Fr=l("torch.nn.Module"),zr=l(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),ta=u(),N=r("div"),w(Ft.$$.fragment),oa=u(),me=r("p"),na=l("The "),so=r("a"),sa=l("IBertForMultipleChoice"),ra=l(" forward method, overrides the "),No=r("code"),aa=l("__call__"),ia=l(" special method."),la=u(),w(Se.$$.fragment),da=u(),w(Oe.$$.fragment),Bn=u(),ue=r("h2"),Re=r("a"),Do=r("span"),w(zt.$$.fragment),ca=u(),Wo=r("span"),pa=l("IBertForTokenClassification"),qn=u(),C=r("div"),w(xt.$$.fragment),ha=u(),Qo=r("p"),ma=l(`I-BERT Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g. for
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),$a=u(),A=r("div"),w(Pt.$$.fragment),Ta=u(),fe=r("p"),ya=l("The "),ao=r("a"),Ia=l("IBertForTokenClassification"),Ba=l(" forward method, overrides the "),Ho=r("code"),qa=l("__call__"),Ma=l(" special method."),Fa=u(),w(Ne.$$.fragment),za=u(),w(De.$$.fragment),xa=u(),w(We.$$.fragment),Mn=u(),ge=r("h2"),Qe=r("a"),Uo=r("span"),w(At.$$.fragment),Ea=u(),Go=r("span"),Ca=l("IBertForQuestionAnswering"),Fn=u(),j=r("div"),w(Lt.$$.fragment),ja=u(),_e=r("p"),Pa=l(`I-BERT Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
...
documentation from `),Kt=a(ho,"A",{href:!0});var di=i(Kt);$s=d(di,"PretrainedConfig"),di.forEach(o),Ts=d(ho," for more information."),ho.forEach(o),co.forEach(o),bn=f(t),ae=a(t,"H2",{class:!0});var xn=i(ae);ye=a(xn,"A",{id:!0,class:!0,href:!0});var ci=i(ye);Bo=a(ci,"SPAN",{});var pi=i(Bo);v(nt.$$.fragment,pi),pi.forEach(o),ci.forEach(o),ys=f(xn),qo=a(xn,"SPAN",{});var hi=i(qo);Is=d(hi,"IBertModel"),hi.forEach(o),xn.forEach(o),kn=f(t),F=a(t,"DIV",{class:!0});var D=i(F);v(st.$$.fragment,D),Bs=f(D),Mo=a(D,"P",{});var mi=i(Mo);qs=d(mi,"The bare I-BERT Model transformer outputting raw hidden-states without any specific head on top."),mi.forEach(o),Ms=f(D),rt=a(D,"P",{});var En=i(rt);Fs=d(En,"This model inherits from "),Yt=a(En,"A",{href:!0});var ui=i(Yt);zs=d(ui,"PreTrainedModel"),ui.forEach(o),xs=d(En,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
Llion Jones, Aidan N. Gomez, Lukasz Kaiser and Illia Polosukhin.`),jn.forEach(o),Rs=f(D),R=a(D,"DIV",{class:!0});var Ve=i(R);v(ct.$$.fragment,Ve),Ns=f(Ve),ie=a(Ve,"P",{});var mo=i(ie);Ds=d(mo,"The "),Zt=a(mo,"A",{href:!0});var _i=i(Zt);Ws=d(_i,"IBertModel"),_i.forEach(o),Qs=d(mo," forward method, overrides the "),Fo=a(mo,"CODE",{});var bi=i(Fo);Hs=d(bi,"__call__"),bi.forEach(o),Us=d(mo," special method."),mo.forEach(o),Gs=f(Ve),v(Ie.$$.fragment,Ve),Vs=f(Ve),v(Be.$$.fragment,Ve),Ve.forEach(o),D.forEach(o),wn=f(t),le=a(t,"H2",{class:!0});var Pn=i(le);qe=a(Pn,"A",{id:!0,class:!0,href:!0});var ki=i(qe);zo=a(ki,"SPAN",{});var wi=i(zo);v(pt.$$.fragment,wi),wi.forEach(o),ki.forEach(o),Js=f(Pn),xo=a(Pn,"SPAN",{});var vi=i(xo);Ks=d(vi,"IBertForMaskedLM"),vi.forEach(o),Pn.forEach(o),vn=f(t),z=a(t,"DIV",{class:!0});var V=i(z);v(ht.$$.fragment,V),Ys=f(V),mt=a(V,"P",{});var An=i(mt);Zs=d(An,"I-BERT Model with a "),Eo=a(An,"CODE",{});var $i=i(Eo);Xs=d($i,"language modeling"),$i.forEach(o),er=d(An," head on top."),An.forEach(o),tr=f(V),ut=a(V,"P",{});var Ln=i(ut);or=d(Ln,"This model inherits from "),Xt=a(Ln,"A",{href:!0});var Ti=i(Xt);nr=d(Ti,"PreTrainedModel"),Ti.forEach(o),sr=d(Ln,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Sn.forEach(o),dr=f(V),P=a(V,"DIV",{class:!0});var J=i(P);v(_t.$$.fragment,J),cr=f(J),de=a(J,"P",{});var uo=i(de);pr=d(uo,"The "),eo=a(uo,"A",{href:!0});var Ii=i(eo);hr=d(Ii,"IBertForMaskedLM"),Ii.forEach(o),mr=d(uo," forward method, overrides the "),Co=a(uo,"CODE",{});var Bi=i(Co);ur=d(Bi,"__call__"),Bi.forEach(o),fr=d(uo," special method."),uo.forEach(o),gr=f(J),v(Me.$$.fragment,J),_r=f(J),v(Fe.$$.fragment,J),br=f(J),v(ze.$$.fragment,J),J.forEach(o),V.forEach(o),$n=f(t),ce=a(t,"H2",{class:!0});var On=i(ce);xe=a(On,"A",{id:!0,class:!0,href:!0});var qi=i(xe);jo=a(qi,"SPAN",{});var Mi=i(jo);v(bt.$$.fragment,Mi),Mi.forEach(o),qi.forEach(o),kr=f(On),Po=a(On,"SPAN",{});var Fi=i(Po);wr=d(Fi,"IBertForSequenceClassification"),Fi.forEach(o),On.forEach(o),Tn=f(t),x=a(t,"DIV",{class:!0});var K=i(x);v(kt.$$.fragment,K),vr=f(K),Ao=a(K,"P",{});var zi=i(Ao);$r=d(zi,`I-BERT Model transformer with a sequence classification/regression head on top (a linear layer on top of the pooled
output) e.g. for GLUE tasks.`),zi.forEach(o),Tr=f(K),wt=a(K,"P",{});var Rn=i(wt);yr=d(Rn,"This model inherits from "),to=a(Rn,"A",{href:!0});var xi=i(to);Ir=d(xi,"PreTrainedModel"),xi.forEach(o),Br=d(Rn,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Rn.forEach(o),qr=f(K),vt=a(K,"P",{});var Nn=i(vt);Mr=d(Nn,"This model is also a PyTorch "),$t=a(Nn,"A",{href:!0,rel:!0});var Ei=i($t);Fr=d(Ei,"torch.nn.Module"),Ei.forEach(o),zr=d(Nn,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Qn.forEach(o),ta=f(Y),N=a(Y,"DIV",{class:!0});var Je=i(N);v(Ft.$$.fragment,Je),oa=f(Je),me=a(Je,"P",{});var go=i(me);na=d(go,"The "),so=a(go,"A",{href:!0});var Ni=i(so);sa=d(Ni,"IBertForMultipleChoice"),Ni.forEach(o),ra=d(go," forward method, overrides the "),No=a(go,"CODE",{});var Di=i(No);aa=d(Di,"__call__"),Di.forEach(o),ia=d(go," special method."),go.forEach(o),la=f(Je),v(Se.$$.fragment,Je),da=f(Je),v(Oe.$$.fragment,Je),Je.forEach(o),Y.forEach(o),Bn=f(t),ue=a(t,"H2",{class:!0});var Hn=i(ue);Re=a(Hn,"A",{id:!0,class:!0,href:!0});var Wi=i(Re);Do=a(Wi,"SPAN",{});var Qi=i(Do);v(zt.$$.fragment,Qi),Qi.forEach(o),Wi.forEach(o),ca=f(Hn),Wo=a(Hn,"SPAN",{});var Hi=i(Wo);pa=d(Hi,"IBertForTokenClassification"),Hi.forEach(o),Hn.forEach(o),qn=f(t),C=a(t,"DIV",{class:!0});var Z=i(C);v(xt.$$.fragment,Z),ha=f(Z),Qo=a(Z,"P",{});var Ui=i(Qo);ma=d(Ui,`I-BERT Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g. for
