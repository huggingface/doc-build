...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),dr=u(),P=r("div"),w(_t.$$.fragment),cr=u(),de=r("p"),pr=l("The "),eo=r("a"),hr=l("IBertForMaskedLM"),mr=l(" forward method, overrides the "),Co=r("code"),ur=l("__call__"),fr=l(" special method."),gr=u(),w(Me.$$.fragment),_r=u(),w(ze.$$.fragment),br=u(),w(Fe.$$.fragment),$n=u(),ce=r("h2"),xe=r("a"),jo=r("span"),w(bt.$$.fragment),kr=u(),Po=r("span"),wr=l("IBertForSequenceClassification"),Tn=u(),x=r("div"),w(kt.$$.fragment),vr=u(),Ao=r("p"),$r=l(`I-BERT Model transformer with a sequence classification/regression head on top (a linear layer on top of the pooled
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),xr=u(),M=r("div"),w(Tt.$$.fragment),Er=u(),pe=r("p"),Cr=l("The "),oo=r("a"),jr=l("IBertForSequenceClassification"),Pr=l(" forward method, overrides the "),Lo=r("code"),Ar=l("__call__"),Lr=l(" special method."),Sr=u(),w(Ee.$$.fragment),Or=u(),w(Ce.$$.fragment),Rr=u(),w(je.$$.fragment),Nr=u(),w(Pe.$$.fragment),Dr=u(),w(Ae.$$.fragment),yn=u(),he=r("h2"),Le=r("a"),So=r("span"),w(yt.$$.fragment),Wr=u(),Oo=r("span"),Qr=l("IBertForMultipleChoice"),In=u(),E=r("div"),w(It.$$.fragment),Hr=u(),Ro=r("p"),Ur=l(`I-BERT Model with a multiple choice classification head on top (a linear layer on top of the pooled output and a
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),ta=u(),N=r("div"),w(zt.$$.fragment),oa=u(),me=r("p"),na=l("The "),so=r("a"),sa=l("IBertForMultipleChoice"),ra=l(" forward method, overrides the "),No=r("code"),aa=l("__call__"),ia=l(" special method."),la=u(),w(Se.$$.fragment),da=u(),w(Oe.$$.fragment),Bn=u(),ue=r("h2"),Re=r("a"),Do=r("span"),w(Ft.$$.fragment),ca=u(),Wo=r("span"),pa=l("IBertForTokenClassification"),qn=u(),C=r("div"),w(xt.$$.fragment),ha=u(),Qo=r("p"),ma=l(`I-BERT Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g. for
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),ba=u(),Ct=r("p"),ka=l("This model is also a PyTorch "),jt=r("a"),wa=l("torch.nn.Module"),va=l(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),$a=u(),A=r("div"),w(Pt.$$.fragment),Ta=u(),fe=r("p"),ya=l("The "),ao=r("a"),Ia=l("IBertForTokenClassification"),Ba=l(" forward method, overrides the "),Ho=r("code"),qa=l("__call__"),Ma=l(" special method."),za=u(),w(Ne.$$.fragment),Fa=u(),w(De.$$.fragment),xa=u(),w(We.$$.fragment),Mn=u(),ge=r("h2"),Qe=r("a"),Uo=r("span"),w(At.$$.fragment),Ea=u(),Go=r("span"),Ca=l("IBertForQuestionAnswering"),zn=u(),j=r("div"),w(Lt.$$.fragment),ja=u(),_e=r("p"),Pa=l(`I-BERT Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Sn.forEach(o),dr=f(V),P=a(V,"DIV",{class:!0});var J=i(P);v(_t.$$.fragment,J),cr=f(J),de=a(J,"P",{});var uo=i(de);pr=d(uo,"The "),eo=a(uo,"A",{href:!0});var Ii=i(eo);hr=d(Ii,"IBertForMaskedLM"),Ii.forEach(o),mr=d(uo," forward method, overrides the "),Co=a(uo,"CODE",{});var Bi=i(Co);ur=d(Bi,"__call__"),Bi.forEach(o),fr=d(uo," special method."),uo.forEach(o),gr=f(J),v(Me.$$.fragment,J),_r=f(J),v(ze.$$.fragment,J),br=f(J),v(Fe.$$.fragment,J),J.forEach(o),V.forEach(o),$n=f(t),ce=a(t,"H2",{class:!0});var On=i(ce);xe=a(On,"A",{id:!0,class:!0,href:!0});var qi=i(xe);jo=a(qi,"SPAN",{});var Mi=i(jo);v(bt.$$.fragment,Mi),Mi.forEach(o),qi.forEach(o),kr=f(On),Po=a(On,"SPAN",{});var zi=i(Po);wr=d(zi,"IBertForSequenceClassification"),zi.forEach(o),On.forEach(o),Tn=f(t),x=a(t,"DIV",{class:!0});var K=i(x);v(kt.$$.fragment,K),vr=f(K),Ao=a(K,"P",{});var Fi=i(Ao);$r=d(Fi,`I-BERT Model transformer with a sequence classification/regression head on top (a linear layer on top of the pooled
