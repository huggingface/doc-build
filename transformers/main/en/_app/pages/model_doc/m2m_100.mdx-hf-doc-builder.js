import{S as Gr,i as Wr,s as Br,e as n,k as c,w as k,t as r,M as Hr,c as s,d as o,m as h,a,x as b,h as i,b as l,G as e,g as u,y as v,q as y,o as T,B as w,v as Ur,L as nn}from"../../chunks/vendor-hf-doc-builder.js";import{T as Nr}from"../../chunks/Tip-hf-doc-builder.js";import{D as W}from"../../chunks/Docstring-hf-doc-builder.js";import{C as qt}from"../../chunks/CodeBlock-hf-doc-builder.js";import{I as at}from"../../chunks/IconCopyLink-hf-doc-builder.js";import{E as on}from"../../chunks/ExampleCodeBlock-hf-doc-builder.js";function Vr(E){let m,$,g,f,M;return f=new qt({props:{code:`from transformers import M2M100Model, M2M100Config
...
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-built_in">print</span>(tokenizer.batch_decode(gen_tokens, skip_special_tokens=<span class="hljs-literal">True</span>))`}}),{c(){m=n("p"),$=r("Translation example:"),g=c(),k(f.$$.fragment)},l(d){m=s(d,"P",{});var _=a(m);$=i(_,"Translation example:"),_.forEach(o),g=h(d),b(f.$$.fragment,d)},m(d,_){u(d,m,_),e(m,$),u(d,g,_),v(f,d,_),M=!0},p:nn,i(d){M||(y(f.$$.fragment,d),M=!0)},o(d){T(f.$$.fragment,d),M=!1},d(d){d&&o(m),d&&o(g),w(f,d)}}}function Qr(E){let m,$,g,f,M,d,_,I,sn,fo,B,Y,xt,ve,an,Et,rn,_o,ee,dn,ye,ln,cn,go,rt,hn,Mo,it,Ct,pn,ko,te,mn,Te,un,fn,bo,H,oe,Ft,we,_n,Pt,gn,vo,O,Mn,jt,kn,bn,Ot,vn,yn,St,Tn,wn,yo,C,$n,dt,zn,qn,Lt,xn,En,At,Cn,Fn,Dt,Pn,jn,To,lt,It,On,wo,$e,$o,ct,ze,Nt,Sn,Ln,x,An,Gt,Dn,In,Wt,Nn,Gn,Bt,Wn,Bn,Ht,Hn,Un,Ut,Vn,Xn,zo,qe,qo,U,ne,Vt,xe,Rn,Xt,Jn,xo,F,Ee,Kn,V,Zn,ht,Qn,Yn,Ce,es,ts,os,X,ns,pt,ss,as,mt,rs,is,ds,se,Eo,R,ae,Rt,Fe,ls,Jt,cs,Co,z,Pe,hs,je,ps,Oe,ms,us,fs,Se,_s,ut,gs,Ms,ks,re,bs,S,Le,vs,Ae,ys,Kt,Ts,ws,$s,De,Ie,Zt,zs,qs,Qt,xs,Es,Ne,Yt,Cs,Fs,eo,Ps,js,to,Os,Ss,ie,Ge,Ls,We,As,oo,Ds,Is,Ns,N,Be,Gs,ft,Ws,_t,Bs,Hs,no,Us,Vs,gt,He,Fo,J,de,so,Ue,Xs,ao,Rs,Po,P,Ve,Js,Xe,Ks,Mt,Zs,Qs,Ys,Re,ea,Je,ta,oa,na,L,Ke,sa,K,aa,kt,ra,ia,ro,da,la,ca,le,ha,ce,jo,Z,he,io,Ze,pa,lo,ma,Oo,j,Qe,ua,Ye,fa,bt,_a,ga,Ma,et,ka,tt,ba,va,ya,A,ot,Ta,Q,wa,vt,$a,za,co,qa,xa,Ea,pe,Ca,me,So;return d=new at({}),ve=new at({}),we=new at({}),$e=new qt({props:{code:`from transformers import M2M100Config, M2M100ForConditionalGeneration, M2M100Tokenizer
...
Whether or not to return a <a href="/docs/transformers/main/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/m2m_100/modeling_m2m_100.py#L1155",returnDescription:`
<p>A <a
...
(masked), the loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/m2m_100/modeling_m2m_100.py#L1277",returnDescription:`
<p>A <a
...
`}}),pe=new Nr({props:{$$slots:{default:[Kr]},$$scope:{ctx:E}}}),me=new on({props:{anchor:"transformers.M2M100ForConditionalGeneration.forward.example",$$slots:{default:[Zr]},$$scope:{ctx:E}}}),{c(){m=n("meta"),$=c(),g=n("h1"),f=n("a"),M=n("span"),k(d.$$.fragment),_=c(),I=n("span"),sn=r("M2M100"),fo=c(),B=n("h2"),Y=n("a"),xt=n("span"),k(ve.$$.fragment),an=c(),Et=n("span"),rn=r("Overview"),_o=c(),ee=n("p"),dn=r("The M2M100 model was proposed in "),ye=n("a"),ln=r("Beyond English-Centric Multilingual Machine Translation"),cn=r(` by Angela Fan, Shruti Bhosale, Holger Schwenk, Zhiyi Ma, Ahmed El-Kishky,
...
open-source our scripts so that others may reproduce the data, evaluation, and final M2M-100 model.`),ko=c(),te=n("p"),mn=r("This model was contributed by "),Te=n("a"),un=r("valhalla"),fn=r("."),bo=c(),H=n("h3"),oe=n("a"),Ft=n("span"),k(we.$$.fragment),_n=c(),Pt=n("span"),gn=r("Training and Generation"),vo=c(),O=n("p"),Mn=r(`M2M100 is a multilingual encoder-decoder (seq-to-seq) model primarily intended for translation tasks. As the model is
...
to create high quality models. Our focus on non-English-Centric models brings gains of more than 10 BLEU when directly
translating between non-English directions while performing competitively to the best single systems of WMT. We
open-source our scripts so that others may reproduce the data, evaluation, and final M2M-100 model.`),Aa.forEach(o),La.forEach(o),ko=h(t),te=s(t,"P",{});var Ao=a(te);mn=i(Ao,"This model was contributed by "),Te=s(Ao,"A",{href:!0,rel:!0});var Da=a(Te);un=i(Da,"valhalla"),Da.forEach(o),fn=i(Ao,"."),Ao.forEach(o),bo=h(t),H=s(t,"H3",{class:!0});var Do=a(H);oe=s(Do,"A",{id:!0,class:!0,href:!0});var Ia=a(oe);Ft=s(Ia,"SPAN",{});var Na=a(Ft);b(we.$$.fragment,Na),Na.forEach(o),Ia.forEach(o),_n=h(Do),Pt=s(Do,"SPAN",{});var Ga=a(Pt);gn=i(Ga,"Training and Generation"),Ga.forEach(o),Do.forEach(o),vo=h(t),O=s(t,"P",{});var ue=a(O);Mn=i(ue,`M2M100 is a multilingual encoder-decoder (seq-to-seq) model primarily intended for translation tasks. As the model is
multilingual it expects the sequences in a certain format: A special language id token is used as prefix in both the
source and target text. The source text format is `),jt=s(ue,"CODE",{});var Wa=a(jt);kn=i(Wa,"[lang_code] X [eos]"),Wa.forEach(o),bn=i(ue,", where "),Ot=s(ue,"CODE",{});var Ba=a(Ot);vn=i(Ba,"lang_code"),Ba.forEach(o),yn=i(ue,` is source language
...
documentation from `),mt=s(Tt,"A",{href:!0});var cr=a(mt);rs=i(cr,"PretrainedConfig"),cr.forEach(o),is=i(Tt," for more information."),Tt.forEach(o),ds=h(fe),b(se.$$.fragment,fe),fe.forEach(o),Eo=h(t),R=s(t,"H2",{class:!0});var Go=a(R);ae=s(Go,"A",{id:!0,class:!0,href:!0});var hr=a(ae);Rt=s(hr,"SPAN",{});var pr=a(Rt);b(Fe.$$.fragment,pr),pr.forEach(o),hr.forEach(o),ls=h(Go),Jt=s(Go,"SPAN",{});var mr=a(Jt);cs=i(mr,"M2M100Tokenizer"),mr.forEach(o),Go.forEach(o),Co=h(t),z=s(t,"DIV",{class:!0});var q=a(z);b(Pe.$$.fragment,q),hs=h(q),je=s(q,"P",{});var Wo=a(je);ps=i(Wo,"Construct an M2M100 tokenizer. Based on "),Oe=s(Wo,"A",{href:!0,rel:!0});var ur=a(Oe);ms=i(ur,"SentencePiece"),ur.forEach(o),us=i(Wo,"."),Wo.forEach(o),fs=h(q),Se=s(q,"P",{});var Bo=a(Se);_s=i(Bo,"This tokenizer inherits from "),ut=s(Bo,"A",{href:!0});var fr=a(ut);gs=i(fr,"PreTrainedTokenizer"),fr.forEach(o),Ms=i(Bo,` which contains most of the main methods. Users should refer to
this superclass for more information regarding those methods.`),Bo.forEach(o),ks=h(q),b(re.$$.fragment,q),bs=h(q),S=s(q,"DIV",{class:!0});var _e=a(S);b(Le.$$.fragment,_e),vs=h(_e),Ae=s(_e,"P",{});var Ho=a(Ae);ys=i(Ho,`Build model inputs from a sequence or a pair of sequence for sequence classification tasks by concatenating and
adding special tokens. An MBART sequence has the following format, where `),Kt=s(Ho,"CODE",{});var _r=a(Kt);Ts=i(_r,"X"),_r.forEach(o),ws=i(Ho," represents the sequence:"),Ho.forEach(o),$s=h(_e),De=s(_e,"UL",{});var Uo=a(De);Ie=s(Uo,"LI",{});var Vo=a(Ie);Zt=s(Vo,"CODE",{});var gr=a(Zt);zs=i(gr,"input_ids"),gr.forEach(o),qs=i(Vo," (for encoder) "),Qt=s(Vo,"CODE",{});var Mr=a(Qt);xs=i(Mr,"X [eos, src_lang_code]"),Mr.forEach(o),Vo.forEach(o),Es=h(Uo),Ne=s(Uo,"LI",{});var Xo=a(Ne);Yt=s(Xo,"CODE",{});var kr=a(Yt);Cs=i(kr,"decoder_input_ids"),kr.forEach(o),Fs=i(Xo,": (for decoder) "),eo=s(Xo,"CODE",{});var br=a(eo);Ps=i(br,"X [eos, tgt_lang_code]"),br.forEach(o),Xo.forEach(o),Uo.forEach(o),js=h(_e),to=s(_e,"P",{});var vr=a(to);Os=i(vr,`BOS is never used. Pairs of sequences are not the expected use case, but they will be handled without a
separator.`),vr.forEach(o),_e.forEach(o),Ss=h(q),ie=s(q,"DIV",{class:!0});var Ro=a(ie);b(Ge.$$.fragment,Ro),Ls=h(Ro),We=s(Ro,"P",{});var Jo=a(We);As=i(Jo,`Retrieve sequence ids from a token list that has no special tokens added. This method is called when adding
special tokens using the tokenizer `),oo=s(Jo,"CODE",{});var yr=a(oo);Ds=i(yr,"prepare_for_model"),yr.forEach(o),Is=i(Jo," method."),Jo.forEach(o),Ro.forEach(o),Ns=h(q),N=s(q,"DIV",{class:!0});var wt=a(N);b(Be.$$.fragment,wt),Gs=h(wt),ft=s(wt,"P",{});var Fa=a(ft);Ws=i(Fa,"Create the token type IDs corresponding to the sequences passed. "),_t=s(Fa,"A",{href:!0});var Tr=a(_t);Bs=i(Tr,`What are token type
IDs?`),Tr.forEach(o),Fa.forEach(o),Hs=h(wt),no=s(wt,"P",{});var wr=a(no);Us=i(wr,"Should be overridden in a subclass if the model has a special way of building those."),wr.forEach(o),wt.forEach(o),Vs=h(q),gt=s(q,"DIV",{class:!0});var $r=a(gt);b(He.$$.fragment,$r),$r.forEach(o),q.forEach(o),Fo=h(t),J=s(t,"H2",{class:!0});var Ko=a(J);de=s(Ko,"A",{id:!0,class:!0,href:!0});var zr=a(de);so=s(zr,"SPAN",{});var qr=a(so);b(Ue.$$.fragment,qr),qr.forEach(o),zr.forEach(o),Xs=h(Ko),ao=s(Ko,"SPAN",{});var xr=a(ao);Rs=i(xr,"M2M100Model"),xr.forEach(o),Ko.forEach(o),Po=h(t),P=s(t,"DIV",{class:!0});var ge=a(P);b(Ve.$$.fragment,ge),Js=h(ge),Xe=s(ge,"P",{});var Zo=a(Xe);Ks=i(Zo,`The bare M2M100 Model outputting raw hidden-states without any specific head on top.
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Qo.forEach(o),na=h(ge),L=s(ge,"DIV",{class:!0});var Me=a(L);b(Ke.$$.fragment,Me),sa=h(Me),K=s(Me,"P",{});var $t=a(K);aa=i($t,"The "),kt=s($t,"A",{href:!0});var Fr=a(kt);ra=i(Fr,"M2M100Model"),Fr.forEach(o),ia=i($t," forward method, overrides the "),ro=s($t,"CODE",{});var Pr=a(ro);da=i(Pr,"__call__"),Pr.forEach(o),la=i($t," special method."),$t.forEach(o),ca=h(Me),b(le.$$.fragment,Me),ha=h(Me),b(ce.$$.fragment,Me),Me.forEach(o),ge.forEach(o),jo=h(t),Z=s(t,"H2",{class:!0});var Yo=a(Z);he=s(Yo,"A",{id:!0,class:!0,href:!0});var jr=a(he);io=s(jr,"SPAN",{});var Or=a(io);b(Ze.$$.fragment,Or),Or.forEach(o),jr.forEach(o),pa=h(Yo),lo=s(Yo,"SPAN",{});var Sr=a(lo);ma=i(Sr,"M2M100ForConditionalGeneration"),Sr.forEach(o),Yo.forEach(o),Oo=h(t),j=s(t,"DIV",{class:!0});var ke=a(j);b(Qe.$$.fragment,ke),ua=h(ke),Ye=s(ke,"P",{});var en=a(Ye);fa=i(en,`The M2M100 Model with a language modeling head. Can be used for summarization.
