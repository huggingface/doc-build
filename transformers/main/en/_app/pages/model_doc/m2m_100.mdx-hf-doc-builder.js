...
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-built_in">print</span>(tokenizer.batch_decode(gen_tokens, skip_special_tokens=<span class="hljs-literal">True</span>))`}}),{c(){m=n("p"),$=r("Translation example:"),g=c(),M(f.$$.fragment)},l(d){m=s(d,"P",{});var _=a(m);$=i(_,"Translation example:"),_.forEach(o),g=h(d),b(f.$$.fragment,d)},m(d,_){u(d,m,_),e(m,$),u(d,g,_),v(f,d,_),k=!0},p:nn,i(d){k||(y(f.$$.fragment,d),k=!0)},o(d){T(f.$$.fragment,d),k=!1},d(d){d&&o(m),d&&o(g),w(f,d)}}}function Qr(E){let m,$,g,f,k,d,_,I,sn,fo,B,Y,xt,ve,an,Et,rn,_o,ee,dn,ye,ln,cn,go,rt,hn,ko,it,Ct,pn,Mo,te,mn,Te,un,fn,bo,H,oe,Ft,we,_n,jt,gn,vo,O,kn,Pt,Mn,bn,Ot,vn,yn,St,Tn,wn,yo,C,$n,dt,zn,qn,At,xn,En,Dt,Cn,Fn,Lt,jn,Pn,To,lt,It,On,wo,$e,$o,ct,ze,Nt,Sn,An,x,Dn,Gt,Ln,In,Wt,Nn,Gn,Bt,Wn,Bn,Ht,Hn,Un,Ut,Vn,Xn,zo,qe,qo,U,ne,Vt,xe,Rn,Xt,Jn,xo,F,Ee,Kn,V,Zn,ht,Qn,Yn,Ce,es,ts,os,X,ns,pt,ss,as,mt,rs,is,ds,se,Eo,R,ae,Rt,Fe,ls,Jt,cs,Co,z,je,hs,Pe,ps,Oe,ms,us,fs,Se,_s,ut,gs,ks,Ms,re,bs,S,Ae,vs,De,ys,Kt,Ts,ws,$s,Le,Ie,Zt,zs,qs,Qt,xs,Es,Ne,Yt,Cs,Fs,eo,js,Ps,to,Os,Ss,ie,Ge,As,We,Ds,oo,Ls,Is,Ns,N,Be,Gs,ft,Ws,_t,Bs,Hs,no,Us,Vs,gt,He,Fo,J,de,so,Ue,Xs,ao,Rs,jo,j,Ve,Js,Xe,Ks,kt,Zs,Qs,Ys,Re,ea,Je,ta,oa,na,A,Ke,sa,K,aa,Mt,ra,ia,ro,da,la,ca,le,ha,ce,Po,Z,he,io,Ze,pa,lo,ma,Oo,P,Qe,ua,Ye,fa,bt,_a,ga,ka,et,Ma,tt,ba,va,ya,D,ot,Ta,Q,wa,vt,$a,za,co,qa,xa,Ea,pe,Ca,me,So;return d=new at({}),ve=new at({}),we=new at({}),$e=new qt({props:{code:`
...
</ul>`,name:"sp_model_kwargs"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/m2m_100/tokenization_m2m_100.py#L65"}}),re=new on({props:{anchor:"transformers.M2M100Tokenizer.example",$$slots:{default:[Xr]},$$scope:{ctx:E}}}),Ae=new W({props:{name:"build_inputs_with_special_tokens",anchor:"transformers.M2M100Tokenizer.build_inputs_with_special_tokens",parameters:[{name:"token_ids_0",val:": typing.List[int]"},{name:"token_ids_1",val:": typing.Optional[typing.List[int]] = None"}],parametersDescription:[{anchor:"transformers.M2M100Tokenizer.build_inputs_with_special_tokens.token_ids_0",description:`<strong>token_ids_0</strong> (<code>List[int]</code>) &#x2014;
...
to create high quality models. Our focus on non-English-Centric models brings gains of more than 10 BLEU when directly
translating between non-English directions while performing competitively to the best single systems of WMT. We
open-source our scripts so that others may reproduce the data, evaluation, and final M2M-100 model.`),Da.forEach(o),Aa.forEach(o),Mo=h(t),te=s(t,"P",{});var Do=a(te);mn=i(Do,"This model was contributed by "),Te=s(Do,"A",{href:!0,rel:!0});var La=a(Te);un=i(La,"valhalla"),La.forEach(o),fn=i(Do,"."),Do.forEach(o),bo=h(t),H=s(t,"H3",{class:!0});var Lo=a(H);oe=s(Lo,"A",{id:!0,class:!0,href:!0});var Ia=a(oe);Ft=s(Ia,"SPAN",{});var Na=a(Ft);b(we.$$.fragment,Na),Na.forEach(o),Ia.forEach(o),_n=h(Lo),jt=s(Lo,"SPAN",{});var Ga=a(jt);gn=i(Ga,"Training and Generation"),Ga.forEach(o),Lo.forEach(o),vo=h(t),O=s(t,"P",{});var ue=a(O);kn=i(ue,`M2M100 is a multilingual encoder-decoder (seq-to-seq) model primarily intended for translation tasks. As the model is
multilingual it expects the sequences in a certain format: A special language id token is used as prefix in both the
...
this superclass for more information regarding those methods.`),Bo.forEach(o),Ms=h(q),b(re.$$.fragment,q),bs=h(q),S=s(q,"DIV",{class:!0});var _e=a(S);b(Ae.$$.fragment,_e),vs=h(_e),De=s(_e,"P",{});var Ho=a(De);ys=i(Ho,`Build model inputs from a sequence or a pair of sequence for sequence classification tasks by concatenating and
...
separator.`),vr.forEach(o),_e.forEach(o),Ss=h(q),ie=s(q,"DIV",{class:!0});var Ro=a(ie);b(Ge.$$.fragment,Ro),As=h(Ro),We=s(Ro,"P",{});var Jo=a(We);Ds=i(Jo,`Retrieve sequence ids from a token list that has no special tokens added. This method is called when adding
special tokens using the tokenizer `),oo=s(Jo,"CODE",{});var yr=a(oo);Ls=i(yr,"prepare_for_model"),yr.forEach(o),Is=i(Jo," method."),Jo.forEach(o),Ro.forEach(o),Ns=h(q),N=s(q,"DIV",{class:!0});var wt=a(N);b(Be.$$.fragment,wt),Gs=h(wt),ft=s(wt,"P",{});var Fa=a(ft);Ws=i(Fa,"Create the token type IDs corresponding to the sequences passed. "),_t=s(Fa,"A",{href:!0});var Tr=a(_t);Bs=i(Tr,`What are token type
