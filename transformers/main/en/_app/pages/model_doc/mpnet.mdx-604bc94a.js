...
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),g.forEach(t)},m(k,g){m(k,p,g),e(p,F),e(p,f),e(f,_),e(p,$)},d(k){k&&t(p)}}}function ok(R){let p,F,f,_,$;return{c(){p=o("p"),F=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=o("code"),_=r("Module"),$=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(k){p=s(k,"P",{});var g=a(p);F=i(g,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=s(g,"CODE",{});var y=a(f);_=i(y,"Module"),y.forEach(t),$=i(g,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),g.forEach(t)},m(k,g){m(k,p,g),e(p,F),e(p,f),e(f,_),e(p,$)},d(k){k&&t(p)}}}function sk(R){let p,F,f,_,$;return{c(){p=o("p"),F=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=o("code"),_=r("Module"),$=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(k){p=s(k,"P",{});var g=a(p);F=i(g,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=s(g,"CODE",{});var y=a(f);_=i(y,"Module"),y.forEach(t),$=i(g,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),g.forEach(t)},m(k,g){m(k,p,g),e(p,F),e(p,f),e(f,_),e(p,$)},d(k){k&&t(p)}}}function ak(R){let p,F,f,_,$;return{c(){p=o("p"),F=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=o("code"),_=r("Module"),$=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(k){p=s(k,"P",{});var g=a(p);F=i(g,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=s(g,"CODE",{});var y=a(f);_=i(y,"Module"),y.forEach(t),$=i(g,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),g.forEach(t)},m(k,g){m(k,p,g),e(p,F),e(p,f),e(f,_),e(p,$)},d(k){k&&t(p)}}}function rk(R){let p,F,f,_,$;return{c(){p=o("p"),F=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=o("code"),_=r("Module"),$=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(k){p=s(k,"P",{});var g=a(p);F=i(g,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=s(g,"CODE",{});var y=a(f);_=i(y,"Module"),y.forEach(t),$=i(g,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),g.forEach(t)},m(k,g){m(k,p,g),e(p,F),e(p,f),e(f,_),e(p,$)},d(k){k&&t(p)}}}function ik(R){let p,F,f,_,$;return{c(){p=o("p"),F=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=o("code"),_=r("Module"),$=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(k){p=s(k,"P",{});var g=a(p);F=i(g,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=s(g,"CODE",{});var y=a(f);_=i(y,"Module"),y.forEach(t),$=i(g,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),g.forEach(t)},m(k,g){m(k,p,g),e(p,F),e(p,f),e(f,_),e(p,$)},d(k){k&&t(p)}}}function lk(R){let p,F,f,_,$,k,g,y,le,B,z,X,D,G,de,O,ce,se,U,L,Y,V,E,q,Z,Q,ae,ee,H,re,te,j,pe,W,ne,he,x,oe,C,me;return{c(){p=o("p"),F=r("TF 2.0 models accepts two formats as inputs:"),f=l(),_=o("ul"),$=o("li"),k=r("having all inputs as keyword arguments (like PyTorch models), or"),g=l(),y=o("li"),le=r("having all inputs as a list, tuple or dict in the first positional arguments."),B=l(),z=o("p"),X=r("This second option is useful when using "),D=o("code"),G=r("tf.keras.Model.fit"),de=r(` method which currently requires having all the
tensors in the first argument of the model call function: `),O=o("code"),ce=r("model(inputs)"),se=r("."),U=l(),L=o("p"),Y=r(`If you choose this second option, there are three possibilities you can use to gather all the input Tensor in the
...
first positional argument :`),we.forEach(t),V=d(c),E=s(c,"UL",{});var A=a(E);q=s(A,"LI",{});var S=a(q);Z=i(S,"a single Tensor with "),Q=s(S,"CODE",{});var Pe=a(Q);ae=i(Pe,"input_ids"),Pe.forEach(t),ee=i(S," only and nothing else: "),H=s(S,"CODE",{});var ge=a(H);re=i(ge,"model(inputs_ids)"),ge.forEach(t),S.forEach(t),te=d(A),j=s(A,"LI",{});var ue=a(j);pe=i(ue,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),W=s(ue,"CODE",{});var $e=a(W);ne=i($e,"model([input_ids, attention_mask])"),$e.forEach(t),ue.forEach(t),he=d(A),x=s(A,"LI",{});var ie=a(x);oe=i(ie,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),C=s(ie,"CODE",{});var fe=a(C);me=i(fe,'model({"input_ids": input_ids, "attention_mask": attention_mask})'),fe.forEach(t),ie.forEach(t),A.forEach(t)},m(c,N){m(c,p,N),e(p,F),m(c,f,N),m(c,_,N),e(_,$),e($,k),e(_,g),e(_,y),e(y,le),m(c,B,N),m(c,z,N),e(z,X),e(z,D),e(D,G),e(z,de),e(z,O),e(O,ce),e(z,se),m(c,U,N),m(c,L,N),e(L,Y),m(c,V,N),m(c,E,N),e(E,q),e(q,Z),e(q,Q),e(Q,ae),e(q,ee),e(q,H),e(H,re),e(E,te),e(E,j),e(j,pe),e(j,W),e(W,ne),e(E,he),e(E,x),e(x,oe),e(x,C),e(C,me)},d(c){c&&t(p),c&&t(f),c&&t(_),c&&t(B),c&&t(z),c&&t(U),c&&t(L),c&&t(V),c&&t(E)}}}function pk(R){let p,F,f,_,$;return{c(){p=o("p"),F=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=o("code"),_=r("Module"),$=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(k){p=s(k,"P",{});var g=a(p);F=i(g,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=s(g,"CODE",{});var y=a(f);_=i(y,"Module"),y.forEach(t),$=i(g,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
first positional argument :`),we.forEach(t),V=d(c),E=s(c,"UL",{});var A=a(E);q=s(A,"LI",{});var S=a(q);Z=i(S,"a single Tensor with "),Q=s(S,"CODE",{});var Pe=a(Q);ae=i(Pe,"input_ids"),Pe.forEach(t),ee=i(S," only and nothing else: "),H=s(S,"CODE",{});var ge=a(H);re=i(ge,"model(inputs_ids)"),ge.forEach(t),S.forEach(t),te=d(A),j=s(A,"LI",{});var ue=a(j);pe=i(ue,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),W=s(ue,"CODE",{});var $e=a(W);ne=i($e,"model([input_ids, attention_mask])"),$e.forEach(t),ue.forEach(t),he=d(A),x=s(A,"LI",{});var ie=a(x);oe=i(ie,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),C=s(ie,"CODE",{});var fe=a(C);me=i(fe,'model({"input_ids": input_ids, "attention_mask": attention_mask})'),fe.forEach(t),ie.forEach(t),A.forEach(t)},m(c,N){m(c,p,N),e(p,F),m(c,f,N),m(c,_,N),e(_,$),e($,k),e(_,g),e(_,y),e(y,le),m(c,B,N),m(c,z,N),e(z,X),e(z,D),e(D,G),e(z,de),e(z,O),e(O,ce),e(z,se),m(c,U,N),m(c,L,N),e(L,Y),m(c,V,N),m(c,E,N),e(E,q),e(q,Z),e(q,Q),e(Q,ae),e(q,ee),e(q,H),e(H,re),e(E,te),e(E,j),e(j,pe),e(j,W),e(W,ne),e(E,he),e(E,x),e(x,oe),e(x,C),e(C,me)},d(c){c&&t(p),c&&t(f),c&&t(_),c&&t(B),c&&t(z),c&&t(U),c&&t(L),c&&t(V),c&&t(E)}}}function mk(R){let p,F,f,_,$;return{c(){p=o("p"),F=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=o("code"),_=r("Module"),$=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(k){p=s(k,"P",{});var g=a(p);F=i(g,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=s(g,"CODE",{});var y=a(f);_=i(y,"Module"),y.forEach(t),$=i(g,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
first positional argument :`),we.forEach(t),V=d(c),E=s(c,"UL",{});var A=a(E);q=s(A,"LI",{});var S=a(q);Z=i(S,"a single Tensor with "),Q=s(S,"CODE",{});var Pe=a(Q);ae=i(Pe,"input_ids"),Pe.forEach(t),ee=i(S," only and nothing else: "),H=s(S,"CODE",{});var ge=a(H);re=i(ge,"model(inputs_ids)"),ge.forEach(t),S.forEach(t),te=d(A),j=s(A,"LI",{});var ue=a(j);pe=i(ue,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),W=s(ue,"CODE",{});var $e=a(W);ne=i($e,"model([input_ids, attention_mask])"),$e.forEach(t),ue.forEach(t),he=d(A),x=s(A,"LI",{});var ie=a(x);oe=i(ie,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),C=s(ie,"CODE",{});var fe=a(C);me=i(fe,'model({"input_ids": input_ids, "attention_mask": attention_mask})'),fe.forEach(t),ie.forEach(t),A.forEach(t)},m(c,N){m(c,p,N),e(p,F),m(c,f,N),m(c,_,N),e(_,$),e($,k),e(_,g),e(_,y),e(y,le),m(c,B,N),m(c,z,N),e(z,X),e(z,D),e(D,G),e(z,de),e(z,O),e(O,ce),e(z,se),m(c,U,N),m(c,L,N),e(L,Y),m(c,V,N),m(c,E,N),e(E,q),e(q,Z),e(q,Q),e(Q,ae),e(q,ee),e(q,H),e(H,re),e(E,te),e(E,j),e(j,pe),e(j,W),e(W,ne),e(E,he),e(E,x),e(x,oe),e(x,C),e(C,me)},d(c){c&&t(p),c&&t(f),c&&t(_),c&&t(B),c&&t(z),c&&t(U),c&&t(L),c&&t(V),c&&t(E)}}}function fk(R){let p,F,f,_,$;return{c(){p=o("p"),F=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=o("code"),_=r("Module"),$=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(k){p=s(k,"P",{});var g=a(p);F=i(g,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=s(g,"CODE",{});var y=a(f);_=i(y,"Module"),y.forEach(t),$=i(g,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
first positional argument :`),we.forEach(t),V=d(c),E=s(c,"UL",{});var A=a(E);q=s(A,"LI",{});var S=a(q);Z=i(S,"a single Tensor with "),Q=s(S,"CODE",{});var Pe=a(Q);ae=i(Pe,"input_ids"),Pe.forEach(t),ee=i(S," only and nothing else: "),H=s(S,"CODE",{});var ge=a(H);re=i(ge,"model(inputs_ids)"),ge.forEach(t),S.forEach(t),te=d(A),j=s(A,"LI",{});var ue=a(j);pe=i(ue,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),W=s(ue,"CODE",{});var $e=a(W);ne=i($e,"model([input_ids, attention_mask])"),$e.forEach(t),ue.forEach(t),he=d(A),x=s(A,"LI",{});var ie=a(x);oe=i(ie,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),C=s(ie,"CODE",{});var fe=a(C);me=i(fe,'model({"input_ids": input_ids, "attention_mask": attention_mask})'),fe.forEach(t),ie.forEach(t),A.forEach(t)},m(c,N){m(c,p,N),e(p,F),m(c,f,N),m(c,_,N),e(_,$),e($,k),e(_,g),e(_,y),e(y,le),m(c,B,N),m(c,z,N),e(z,X),e(z,D),e(D,G),e(z,de),e(z,O),e(O,ce),e(z,se),m(c,U,N),m(c,L,N),e(L,Y),m(c,V,N),m(c,E,N),e(E,q),e(q,Z),e(q,Q),e(Q,ae),e(q,ee),e(q,H),e(H,re),e(E,te),e(E,j),e(j,pe),e(j,W),e(W,ne),e(E,he),e(E,x),e(x,oe),e(x,C),e(C,me)},d(c){c&&t(p),c&&t(f),c&&t(_),c&&t(B),c&&t(z),c&&t(U),c&&t(L),c&&t(V),c&&t(E)}}}function _k(R){let p,F,f,_,$;return{c(){p=o("p"),F=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=o("code"),_=r("Module"),$=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(k){p=s(k,"P",{});var g=a(p);F=i(g,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=s(g,"CODE",{});var y=a(f);_=i(y,"Module"),y.forEach(t),$=i(g,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
first positional argument :`),we.forEach(t),V=d(c),E=s(c,"UL",{});var A=a(E);q=s(A,"LI",{});var S=a(q);Z=i(S,"a single Tensor with "),Q=s(S,"CODE",{});var Pe=a(Q);ae=i(Pe,"input_ids"),Pe.forEach(t),ee=i(S," only and nothing else: "),H=s(S,"CODE",{});var ge=a(H);re=i(ge,"model(inputs_ids)"),ge.forEach(t),S.forEach(t),te=d(A),j=s(A,"LI",{});var ue=a(j);pe=i(ue,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),W=s(ue,"CODE",{});var $e=a(W);ne=i($e,"model([input_ids, attention_mask])"),$e.forEach(t),ue.forEach(t),he=d(A),x=s(A,"LI",{});var ie=a(x);oe=i(ie,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),C=s(ie,"CODE",{});var fe=a(C);me=i(fe,'model({"input_ids": input_ids, "attention_mask": attention_mask})'),fe.forEach(t),ie.forEach(t),A.forEach(t)},m(c,N){m(c,p,N),e(p,F),m(c,f,N),m(c,_,N),e(_,$),e($,k),e(_,g),e(_,y),e(y,le),m(c,B,N),m(c,z,N),e(z,X),e(z,D),e(D,G),e(z,de),e(z,O),e(O,ce),e(z,se),m(c,U,N),m(c,L,N),e(L,Y),m(c,V,N),m(c,E,N),e(E,q),e(q,Z),e(q,Q),e(Q,ae),e(q,ee),e(q,H),e(H,re),e(E,te),e(E,j),e(j,pe),e(j,W),e(W,ne),e(E,he),e(E,x),e(x,oe),e(x,C),e(C,me)},d(c){c&&t(p),c&&t(f),c&&t(_),c&&t(B),c&&t(z),c&&t(U),c&&t(L),c&&t(V),c&&t(E)}}}function vk(R){let p,F,f,_,$;return{c(){p=o("p"),F=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=o("code"),_=r("Module"),$=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(k){p=s(k,"P",{});var g=a(p);F=i(g,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=s(g,"CODE",{});var y=a(f);_=i(y,"Module"),y.forEach(t),$=i(g,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),g.forEach(t)},m(k,g){m(k,p,g),e(p,F),e(p,f),e(f,_),e(p,$)},d(k){k&&t(p)}}}function bk(R){let p,F,f,_,$,k,g,y,le,B,z,X,D,G,de,O,ce,se,U,L,Y,V,E,q,Z,Q,ae,ee,H,re,te,j,pe,W,ne,he,x,oe,C,me,c,N,K,_e,Te,I,ke,Me,we,A,S,Pe,ge,ue,$e,ie,fe,on,Qa,Qn,Kl,Ha,Xl,Pi,He,Hn,Jl,ut,Gl,Ks,Yl,Zl,Xs,ed,td,Rn,nd,od,sd,yt,ad,Js,rd,id,Gs,ld,dd,cd,Ra,pd,hd,Un,$i,Ft,sn,Ua,Bn,md,Ba,ud,Ni,Fe,Vn,fd,Kn,gd,Ys,_d,kd,vd,gt,Xn,bd,Va,Td,Md,Jn,Zs,wd,Ka,Pd,$d,ea,Nd,Xa,yd,Fd,an,Gn,zd,Yn,Ed,Ja,qd,jd,Cd,rn,Zn,xd,Ga,Ad,Ld,ta,eo,yi,zt,ln,Ya,to,Id,Za,Sd,Fi,Ze,no,Dd,oo,Od,er,Wd,Qd,Hd,so,Rd,na,Ud,Bd,Vd,dn,ao,Kd,tr,Xd,zi,Et,cn,nr,ro,Jd,or,Gd,Ei,Re,io,Yd,sr,Zd,ec,lo,tc,oa,nc,oc,sc,co,ac,po,rc,ic,lc,Xe,ho,dc,qt,cc,sa,pc,hc,ar,mc,uc,fc,pn,gc,rr,_c,kc,mo,qi,jt,hn,ir,uo,vc,lr,bc,ji,Ct,fo,Tc,Le,go,Mc,xt,wc,aa,Pc,$c,dr,Nc,yc,Fc,mn,zc,cr,Ec,qc,_o,jc,ko,Ci,At,un,pr,vo,Cc,hr,xc,xi,Ue,bo,Ac,mr,Lc,Ic,To,Sc,ra,Dc,Oc,Wc,Mo,Qc,wo,Hc,Rc,Uc,be,Po,Bc,Lt,Vc,ia,Kc,Xc,ur,Jc,Gc,Yc,fn,Zc,fr,ep,tp,$o,np,No,op,gr,sp,ap,yo,rp,Fo,Ai,It,gn,_r,zo,ip,kr,lp,Li,Be,Eo,dp,vr,cp,pp,qo,hp,la,mp,up,fp,jo,gp,Co,_p,kp,vp,Je,xo,bp,St,Tp,da,Mp,wp,br,Pp,$p,Np,_n,yp,Tr,Fp,zp,Ao,Ii,Dt,kn,Mr,Lo,Ep,wr,qp,Si,Ve,Io,jp,Pr,Cp,xp,So,Ap,ca,Lp,Ip,Sp,Do,Dp,Oo,Op,Wp,Qp,Ie,Wo,Hp,Ot,Rp,pa,Up,Bp,$r,Vp,Kp,Xp,vn,Jp,Nr,Gp,Yp,Qo,Zp,Ho,Di,Wt,bn,yr,Ro,eh,Fr,th,Oi,Ke,Uo,nh,Qt,oh,zr,sh,ah,Er,rh,ih,lh,Bo,dh,ha,ch,ph,hh,Vo,mh,Ko,uh,fh,gh,Se,Xo,_h,Ht,kh,ma,vh,bh,qr,Th,Mh,wh,Tn,Ph,jr,$h,Nh,Jo,yh,Go,Wi,Rt,Mn,Cr,Yo,Fh,xr,zh,Qi,ze,Zo,Eh,Ar,qh,jh,es,Ch,ua,xh,Ah,Lh,ts,Ih,ns,Sh,Dh,Oh,wn,Wh,Ge,os,Qh,Ut,Hh,fa,Rh,Uh,Lr,Bh,Vh,Kh,Pn,Xh,Ir,Jh,Gh,ss,Hi,Bt,$n,Sr,as,Yh,Dr,Zh,Ri,Ee,rs,em,is,tm,Or,nm,om,sm,ls,am,ga,rm,im,lm,ds,dm,cs,cm,pm,hm,Nn,mm,De,ps,um,Vt,fm,_a,gm,_m,Wr,km,vm,bm,yn,Tm,Qr,Mm,wm,hs,Pm,ms,Ui,Kt,Fn,Hr,us,$m,Rr,Nm,Bi,qe,fs,ym,Ur,Fm,zm,gs,Em,ka,qm,jm,Cm,_s,xm,ks,Am,Lm,Im,zn,Sm,Oe,vs,Dm,Xt,Om,va,Wm,Qm,Br,Hm,Rm,Um,En,Bm,Vr,Vm,Km,bs,Xm,Ts,Vi,Jt,qn,Kr,Ms,Jm,Xr,Gm,Ki,je,ws,Ym,Jr,Zm,eu,Ps,tu,ba,nu,ou,su,$s,au,Ns,ru,iu,lu,jn,du,Ye,ys,cu,Gt,pu,Ta,hu,mu,Gr,uu,fu,gu,Cn,_u,Yr,ku,vu,Fs,Xi,Yt,xn,Zr,zs,bu,ei,Tu,Ji,Ce,Es,Mu,ti,wu,Pu,qs,$u,Ma,Nu,yu,Fu,js,zu,Cs,Eu,qu,ju,An,Cu,We,xs,xu,Zt,Au,wa,Lu,Iu,ni,Su,Du,Ou,Ln,Wu,oi,Qu,Hu,As,Ru,Ls,Gi,en,In,si,Is,Uu,ai,Bu,Yi,xe,Ss,Vu,tn,Ku,ri,Xu,Ju,ii,Gu,Yu,Zu,Ds,ef,Pa,tf,nf,of,Os,sf,Ws,af,rf,lf,Sn,df,Qe,Qs,cf,nn,pf,$a,hf,mf,li,uf,ff,gf,Dn,_f,di,kf,vf,Hs,bf,Rs,Zi;return k=new Ae({}),G=new Ae({}),Qn=new Ae({}),Hn=new J({props:{name:"class transformers.MPNetConfig",anchor:"transformers.MPNetConfig",parameters:[{name:"vocab_size",val:" = 30527"},{name:"hidden_size",val:" = 768"},{name:"num_hidden_layers",val:" = 12"},{name:"num_attention_heads",val:" = 12"},{name:"intermediate_size",val:" = 3072"},{name:"hidden_act",val:" = 'gelu'"},{name:"hidden_dropout_prob",val:" = 0.1"},{name:"attention_probs_dropout_prob",val:" = 0.1"},{name:"max_position_embeddings",val:" = 512"},{name:"initializer_range",val:" = 0.02"},{name:"layer_norm_eps",val:" = 1e-12"},{name:"relative_attention_num_buckets",val:" = 32"},{name:"pad_token_id",val:" = 1"},{name:"bos_token_id",val:" = 0"},{name:"eos_token_id",val:" = 2"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/mpnet/configuration_mpnet.py#L29",parametersDescription:[{anchor:"transformers.MPNetConfig.vocab_size",description:`<strong>vocab_size</strong> (<code>int</code>, <em>optional</em>, defaults to 30527) &#x2014;
...
The number of buckets to use for each attention layer.`,name:"relative_attention_num_buckets"}]}}),Un=new ve({props:{code:`from transformers import MPNetModel, MPNetConfig
...
`}}),pn=new ye({props:{$$slots:{default:[nk]},$$scope:{ctx:R}}}),mo=new ve({props:{code:`from transformers import MPNetTokenizer, MPNetModel
import torch
...
`}}),mn=new ye({props:{$$slots:{default:[ok]},$$scope:{ctx:R}}}),_o=new ve({props:{code:`from transformers import MPNetTokenizer, MPNetForMaskedLM
import torch
...
`}}),fn=new ye({props:{$$slots:{default:[sk]},$$scope:{ctx:R}}}),$o=new ve({props:{code:`import torch
...
`}}),_n=new ye({props:{$$slots:{default:[ak]},$$scope:{ctx:R}}}),Ao=new ve({props:{code:`from transformers import MPNetTokenizer, MPNetForMultipleChoice
import torch
...
`}}),vn=new ye({props:{$$slots:{default:[rk]},$$scope:{ctx:R}}}),Qo=new ve({props:{code:`from transformers import MPNetTokenizer, MPNetForTokenClassification
import torch
...
`}}),Tn=new ye({props:{$$slots:{default:[ik]},$$scope:{ctx:R}}}),Jo=new ve({props:{code:`from transformers import MPNetTokenizer, MPNetForQuestionAnswering
import torch
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/main/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),wn=new ye({props:{$$slots:{default:[lk]},$$scope:{ctx:R}}}),os=new J({props:{name:"call",anchor:"transformers.TFMPNetModel.call",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"},{name:"training",val:" = False"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/mpnet/modeling_tf_mpnet.py#L670",parametersDescription:[{anchor:"transformers.TFMPNetModel.call.input_ids",description:`<strong>input_ids</strong> (<code>Numpy array</code> or <code>tf.Tensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
...
`}}),Pn=new ye({props:{$$slots:{default:[dk]},$$scope:{ctx:R}}}),ss=new ve({props:{code:`from transformers import MPNetTokenizer, TFMPNetModel
...
`}}),yn=new ye({props:{$$slots:{default:[pk]},$$scope:{ctx:R}}}),hs=new ve({props:{code:`from transformers import MPNetTokenizer, TFMPNetForMaskedLM
import tensorflow as tf
...
`}}),En=new ye({props:{$$slots:{default:[mk]},$$scope:{ctx:R}}}),bs=new ve({props:{code:`from transformers import MPNetTokenizer, TFMPNetForSequenceClassification
import tensorflow as tf
...
`}}),Cn=new ye({props:{$$slots:{default:[fk]},$$scope:{ctx:R}}}),Fs=new ve({props:{code:`from transformers import MPNetTokenizer, TFMPNetForMultipleChoice
import tensorflow as tf
...
`}}),Ln=new ye({props:{$$slots:{default:[_k]},$$scope:{ctx:R}}}),As=new ve({props:{code:`from transformers import MPNetTokenizer, TFMPNetForTokenClassification
import tensorflow as tf
...
`}}),Dn=new ye({props:{$$slots:{default:[vk]},$$scope:{ctx:R}}}),Hs=new ve({props:{code:`from transformers import MPNetTokenizer, TFMPNetForQuestionAnswering
import tensorflow as tf
...
`),Rn=o("a"),nd=r("mpnet-base"),od=r(" architecture."),sd=l(),yt=o("p"),ad=r("Configuration objects inherit from "),Js=o("a"),rd=r("PretrainedConfig"),id=r(` and can be used to control the model outputs. Read the
documentation from `),Gs=o("a"),ld=r("PretrainedConfig"),dd=r(" for more information."),cd=l(),Ra=o("p"),pd=r("Examples:"),hd=l(),v(Un.$$.fragment),$i=l(),Ft=o("h2"),sn=o("a"),Ua=o("span"),v(Bn.$$.fragment),md=l(),Ba=o("span"),ud=r("MPNetTokenizer"),Ni=l(),Fe=o("div"),v(Vn.$$.fragment),fd=l(),Kn=o("p"),gd=r("This tokenizer inherits from "),Ys=o("a"),_d=r("BertTokenizer"),kd=r(` which contains most of the methods. Users should refer to the
...
make use of token type ids, therefore a list of zeros is returned.`),Ld=l(),ta=o("div"),v(eo.$$.fragment),yi=l(),zt=o("h2"),ln=o("a"),Ya=o("span"),v(to.$$.fragment),Id=l(),Za=o("span"),Sd=r("MPNetTokenizerFast"),Fi=l(),Ze=o("div"),v(no.$$.fragment),Dd=l(),oo=o("p"),Od=r("Construct a \u201Cfast\u201D MPNet tokenizer (backed by HuggingFace\u2019s "),er=o("em"),Wd=r("tokenizers"),Qd=r(" library). Based on WordPiece."),Hd=l(),so=o("p"),Rd=r("This tokenizer inherits from "),na=o("a"),Ud=r("PreTrainedTokenizerFast"),Bd=r(` which contains most of the main methods. Users should
...
make use of token type ids, therefore a list of zeros is returned`),zi=l(),Et=o("h2"),cn=o("a"),nr=o("span"),v(ro.$$.fragment),Jd=l(),or=o("span"),Gd=r("MPNetModel"),Ei=l(),Re=o("div"),v(io.$$.fragment),Yd=l(),sr=o("p"),Zd=r("The bare MPNet Model transformer outputting raw hidden-states without any specific head on top."),ec=l(),lo=o("p"),tc=r("This model inherits from "),oa=o("a"),nc=r("PreTrainedModel"),oc=r(`. Check the superclass documentation for the generic methods the
...
and behavior.`),lc=l(),Xe=o("div"),v(ho.$$.fragment),dc=l(),qt=o("p"),cc=r("The "),sa=o("a"),pc=r("MPNetModel"),hc=r(" forward method, overrides the "),ar=o("code"),mc=r("__call__"),uc=r(" special method."),fc=l(),v(pn.$$.fragment),gc=l(),rr=o("p"),_c=r("Example:"),kc=l(),v(mo.$$.fragment),qi=l(),jt=o("h2"),hn=o("a"),ir=o("span"),v(uo.$$.fragment),vc=l(),lr=o("span"),bc=r("MPNetForMaskedLM"),ji=l(),Ct=o("div"),v(fo.$$.fragment),Tc=l(),Le=o("div"),v(go.$$.fragment),Mc=l(),xt=o("p"),wc=r("The "),aa=o("a"),Pc=r("MPNetForMaskedLM"),$c=r(" forward method, overrides the "),dr=o("code"),Nc=r("__call__"),yc=r(" special method."),Fc=l(),v(mn.$$.fragment),zc=l(),cr=o("p"),Ec=r("Example:"),qc=l(),v(_o.$$.fragment),jc=l(),v(ko.$$.fragment),Ci=l(),At=o("h2"),un=o("a"),pr=o("span"),v(vo.$$.fragment),Cc=l(),hr=o("span"),xc=r("MPNetForSequenceClassification"),xi=l(),Ue=o("div"),v(bo.$$.fragment),Ac=l(),mr=o("p"),Lc=r(`MPNet Model transformer with a sequence classification/regression head on top (a linear layer on top of the pooled
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Wc=l(),Mo=o("p"),Qc=r("This model is also a PyTorch "),wo=o("a"),Hc=r("torch.nn.Module"),Rc=r(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Uc=l(),be=o("div"),v(Po.$$.fragment),Bc=l(),Lt=o("p"),Vc=r("The "),ia=o("a"),Kc=r("MPNetForSequenceClassification"),Xc=r(" forward method, overrides the "),ur=o("code"),Jc=r("__call__"),Gc=r(" special method."),Yc=l(),v(fn.$$.fragment),Zc=l(),fr=o("p"),ep=r("Example of single-label classification:"),tp=l(),v($o.$$.fragment),np=l(),v(No.$$.fragment),op=l(),gr=o("p"),sp=r("Example of multi-label classification:"),ap=l(),v(yo.$$.fragment),rp=l(),v(Fo.$$.fragment),Ai=l(),It=o("h2"),gn=o("a"),_r=o("span"),v(zo.$$.fragment),ip=l(),kr=o("span"),lp=r("MPNetForMultipleChoice"),Li=l(),Be=o("div"),v(Eo.$$.fragment),dp=l(),vr=o("p"),cp=r(`MPNet Model with a multiple choice classification head on top (a linear layer on top of the pooled output and a
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Qp=l(),Ie=o("div"),v(Wo.$$.fragment),Hp=l(),Ot=o("p"),Rp=r("The "),pa=o("a"),Up=r("MPNetForTokenClassification"),Bp=r(" forward method, overrides the "),$r=o("code"),Vp=r("__call__"),Kp=r(" special method."),Xp=l(),v(vn.$$.fragment),Jp=l(),Nr=o("p"),Gp=r("Example:"),Yp=l(),v(Qo.$$.fragment),Zp=l(),v(Ho.$$.fragment),Di=l(),Wt=o("h2"),bn=o("a"),yr=o("span"),v(Ro.$$.fragment),eh=l(),Fr=o("span"),th=r("MPNetForQuestionAnswering"),Oi=l(),Ke=o("div"),v(Uo.$$.fragment),nh=l(),Qt=o("p"),oh=r(`MPNet Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
layers on top of the hidden-states output to compute `),zr=o("code"),sh=r("span start logits"),ah=r(" and "),Er=o("code"),rh=r("span end logits"),ih=r(")."),lh=l(),Bo=o("p"),dh=r("This model inherits from "),ha=o("a"),ch=r("PreTrainedModel"),ph=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),hh=l(),Vo=o("p"),mh=r("This model is also a PyTorch "),Ko=o("a"),uh=r("torch.nn.Module"),fh=r(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),gh=l(),Se=o("div"),v(Xo.$$.fragment),_h=l(),Ht=o("p"),kh=r("The "),ma=o("a"),vh=r("MPNetForQuestionAnswering"),bh=r(" forward method, overrides the "),qr=o("code"),Th=r("__call__"),Mh=r(" special method."),wh=l(),v(Tn.$$.fragment),Ph=l(),jr=o("p"),$h=r("Example:"),Nh=l(),v(Jo.$$.fragment),yh=l(),v(Go.$$.fragment),Wi=l(),Rt=o("h2"),Mn=o("a"),Cr=o("span"),v(Yo.$$.fragment),Fh=l(),xr=o("span"),zh=r("TFMPNetModel"),Qi=l(),ze=o("div"),v(Zo.$$.fragment),Eh=l(),Ar=o("p"),qh=r("The bare MPNet Model transformer outputting raw hidden-states without any specific head on top."),jh=l(),es=o("p"),Ch=r("This model inherits from "),ua=o("a"),xh=r("TFPreTrainedModel"),Ah=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Lh=l(),ts=o("p"),Ih=r("This model is also a "),ns=o("a"),Sh=r("tf.keras.Model"),Dh=r(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Oh=l(),v(wn.$$.fragment),Wh=l(),Ge=o("div"),v(os.$$.fragment),Qh=l(),Ut=o("p"),Hh=r("The "),fa=o("a"),Rh=r("TFMPNetModel"),Uh=r(" forward method, overrides the "),Lr=o("code"),Bh=r("__call__"),Vh=r(" special method."),Kh=l(),v(Pn.$$.fragment),Xh=l(),Ir=o("p"),Jh=r("Example:"),Gh=l(),v(ss.$$.fragment),Hi=l(),Bt=o("h2"),$n=o("a"),Sr=o("span"),v(as.$$.fragment),Yh=l(),Dr=o("span"),Zh=r("TFMPNetForMaskedLM"),Ri=l(),Ee=o("div"),v(rs.$$.fragment),em=l(),is=o("p"),tm=r("MPNet Model with a "),Or=o("code"),nm=r("language modeling"),om=r(" head on top."),sm=l(),ls=o("p"),am=r("This model inherits from "),ga=o("a"),rm=r("TFPreTrainedModel"),im=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),lm=l(),ds=o("p"),dm=r("This model is also a "),cs=o("a"),cm=r("tf.keras.Model"),pm=r(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),hm=l(),v(Nn.$$.fragment),mm=l(),De=o("div"),v(ps.$$.fragment),um=l(),Vt=o("p"),fm=r("The "),_a=o("a"),gm=r("TFMPNetForMaskedLM"),_m=r(" forward method, overrides the "),Wr=o("code"),km=r("__call__"),vm=r(" special method."),bm=l(),v(yn.$$.fragment),Tm=l(),Qr=o("p"),Mm=r("Example:"),wm=l(),v(hs.$$.fragment),Pm=l(),v(ms.$$.fragment),Ui=l(),Kt=o("h2"),Fn=o("a"),Hr=o("span"),v(us.$$.fragment),$m=l(),Rr=o("span"),Nm=r("TFMPNetForSequenceClassification"),Bi=l(),qe=o("div"),v(fs.$$.fragment),ym=l(),Ur=o("p"),Fm=r(`MPNet Model transformer with a sequence classification/regression head on top (a linear layer on top of the pooled
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Im=l(),v(zn.$$.fragment),Sm=l(),Oe=o("div"),v(vs.$$.fragment),Dm=l(),Xt=o("p"),Om=r("The "),va=o("a"),Wm=r("TFMPNetForSequenceClassification"),Qm=r(" forward method, overrides the "),Br=o("code"),Hm=r("__call__"),Rm=r(" special method."),Um=l(),v(En.$$.fragment),Bm=l(),Vr=o("p"),Vm=r("Example:"),Km=l(),v(bs.$$.fragment),Xm=l(),v(Ts.$$.fragment),Vi=l(),Jt=o("h2"),qn=o("a"),Kr=o("span"),v(Ms.$$.fragment),Jm=l(),Xr=o("span"),Gm=r("TFMPNetForMultipleChoice"),Ki=l(),je=o("div"),v(ws.$$.fragment),Ym=l(),Jr=o("p"),Zm=r(`MPNet Model with a multiple choice classification head on top (a linear layer on top of the pooled output and a
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),ju=l(),v(An.$$.fragment),Cu=l(),We=o("div"),v(xs.$$.fragment),xu=l(),Zt=o("p"),Au=r("The "),wa=o("a"),Lu=r("TFMPNetForTokenClassification"),Iu=r(" forward method, overrides the "),ni=o("code"),Su=r("__call__"),Du=r(" special method."),Ou=l(),v(Ln.$$.fragment),Wu=l(),oi=o("p"),Qu=r("Example:"),Hu=l(),v(As.$$.fragment),Ru=l(),v(Ls.$$.fragment),Gi=l(),en=o("h2"),In=o("a"),si=o("span"),v(Is.$$.fragment),Uu=l(),ai=o("span"),Bu=r("TFMPNetForQuestionAnswering"),Yi=l(),xe=o("div"),v(Ss.$$.fragment),Vu=l(),tn=o("p"),Ku=r(`MPNet Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),lf=l(),v(Sn.$$.fragment),df=l(),Qe=o("div"),v(Qs.$$.fragment),cf=l(),nn=o("p"),pf=r("The "),$a=o("a"),hf=r("TFMPNetForQuestionAnswering"),mf=r(" forward method, overrides the "),li=o("code"),uf=r("__call__"),ff=r(" special method."),gf=l(),v(Dn.$$.fragment),_f=l(),di=o("p"),kf=r("Example:"),vf=l(),v(Hs.$$.fragment),bf=l(),v(Rs.$$.fragment),this.h()},l(n){const u=ek('[data-svelte="svelte-1phssyn"]',document.head);p=s(u,"META",{name:!0,content:!0}),u.forEach(t),F=d(n),f=s(n,"H1",{class:!0});var Us=a(f);_=s(Us,"A",{id:!0,class:!0,href:!0});var ci=a(_);$=s(ci,"SPAN",{});var pi=a($);b(k.$$.fragment,pi),pi.forEach(t),ci.forEach(t),g=d(Us),y=s(Us,"SPAN",{});var hi=a(y);le=i(hi,"MPNet"),hi.forEach(t),Us.forEach(t),B=d(n),z=s(n,"H2",{class:!0});var Bs=a(z);X=s(Bs,"A",{id:!0,class:!0,href:!0});var mi=a(X);D=s(mi,"SPAN",{});var ui=a(D);b(G.$$.fragment,ui),ui.forEach(t),mi.forEach(t),de=d(Bs),O=s(Bs,"SPAN",{});var fi=a(O);ce=i(fi,"Overview"),fi.forEach(t),Bs.forEach(t),se=d(n),U=s(n,"P",{});var Vs=a(U);L=i(Vs,"The MPNet model was proposed in "),Y=s(Vs,"A",{href:!0,rel:!0});var gi=a(Y);V=i(gi,"MPNet: Masked and Permuted Pre-training for Language Understanding"),gi.forEach(t),E=i(Vs," by Kaitao Song, Xu Tan, Tao Qin, Jianfeng Lu, Tie-Yan Liu."),Vs.forEach(t),q=d(n),Z=s(n,"P",{});var _i=a(Z);Q=i(_i,`MPNet adopts a novel pre-training method, named masked and permuted language modeling, to inherit the advantages of
...
make use of token type ids, therefore a list of zeros is returned.`),Hf.forEach(t),il.forEach(t),Ld=d(et),ta=s(et,"DIV",{class:!0});var Rf=a(ta);b(eo.$$.fragment,Rf),Rf.forEach(t),et.forEach(t),yi=d(n),zt=s(n,"H2",{class:!0});var ll=a(zt);ln=s(ll,"A",{id:!0,class:!0,href:!0});var Uf=a(ln);Ya=s(Uf,"SPAN",{});var Bf=a(Ya);b(to.$$.fragment,Bf),Bf.forEach(t),Uf.forEach(t),Id=d(ll),Za=s(ll,"SPAN",{});var Vf=a(Za);Sd=i(Vf,"MPNetTokenizerFast"),Vf.forEach(t),ll.forEach(t),Fi=d(n),Ze=s(n,"DIV",{class:!0});var Wn=a(Ze);b(no.$$.fragment,Wn),Dd=d(Wn),oo=s(Wn,"P",{});var dl=a(oo);Od=i(dl,"Construct a \u201Cfast\u201D MPNet tokenizer (backed by HuggingFace\u2019s "),er=s(dl,"EM",{});var Kf=a(er);Wd=i(Kf,"tokenizers"),Kf.forEach(t),Qd=i(dl," library). Based on WordPiece."),dl.forEach(t),Hd=d(Wn),so=s(Wn,"P",{});var cl=a(so);Rd=i(cl,"This tokenizer inherits from "),na=s(cl,"A",{href:!0});var Xf=a(na);Ud=i(Xf,"PreTrainedTokenizerFast"),Xf.forEach(t),Bd=i(cl,` which contains most of the main methods. Users should
...
make use of token type ids, therefore a list of zeros is returned`),Jf.forEach(t),pl.forEach(t),Wn.forEach(t),zi=d(n),Et=s(n,"H2",{class:!0});var hl=a(Et);cn=s(hl,"A",{id:!0,class:!0,href:!0});var Gf=a(cn);nr=s(Gf,"SPAN",{});var Yf=a(nr);b(ro.$$.fragment,Yf),Yf.forEach(t),Gf.forEach(t),Jd=d(hl),or=s(hl,"SPAN",{});var Zf=a(or);Gd=i(Zf,"MPNetModel"),Zf.forEach(t),hl.forEach(t),Ei=d(n),Re=s(n,"DIV",{class:!0});var kt=a(Re);b(io.$$.fragment,kt),Yd=d(kt),sr=s(kt,"P",{});var eg=a(sr);Zd=i(eg,"The bare MPNet Model transformer outputting raw hidden-states without any specific head on top."),eg.forEach(t),ec=d(kt),lo=s(kt,"P",{});var ml=a(lo);tc=i(ml,"This model inherits from "),oa=s(ml,"A",{href:!0});var tg=a(oa);nc=i(tg,"PreTrainedModel"),tg.forEach(t),oc=i(ml,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),kl.forEach(t),Wc=d(bt),Mo=s(bt,"P",{});var vl=a(Mo);Qc=i(vl,"This model is also a PyTorch "),wo=s(vl,"A",{href:!0,rel:!0});var _g=a(wo);Hc=i(_g,"torch.nn.Module"),_g.forEach(t),Rc=i(vl,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),vl.forEach(t),Uc=d(bt),be=s(bt,"DIV",{class:!0});var Ne=a(be);b(Po.$$.fragment,Ne),Bc=d(Ne),Lt=s(Ne,"P",{});var Ea=a(Lt);Vc=i(Ea,"The "),ia=s(Ea,"A",{href:!0});var kg=a(ia);Kc=i(kg,"MPNetForSequenceClassification"),kg.forEach(t),Xc=i(Ea," forward method, overrides the "),ur=s(Ea,"CODE",{});var vg=a(ur);Jc=i(vg,"__call__"),vg.forEach(t),Gc=i(Ea," special method."),Ea.forEach(t),Yc=d(Ne),b(fn.$$.fragment,Ne),Zc=d(Ne),fr=s(Ne,"P",{});var bg=a(fr);ep=i(bg,"Example of single-label classification:"),bg.forEach(t),tp=d(Ne),b($o.$$.fragment,Ne),np=d(Ne),b(No.$$.fragment,Ne),op=d(Ne),gr=s(Ne,"P",{});var Tg=a(gr);sp=i(Tg,"Example of multi-label classification:"),Tg.forEach(t),ap=d(Ne),b(yo.$$.fragment,Ne),rp=d(Ne),b(Fo.$$.fragment,Ne),Ne.forEach(t),bt.forEach(t),Ai=d(n),It=s(n,"H2",{class:!0});var bl=a(It);gn=s(bl,"A",{id:!0,class:!0,href:!0});var Mg=a(gn);_r=s(Mg,"SPAN",{});var wg=a(_r);b(zo.$$.fragment,wg),wg.forEach(t),Mg.forEach(t),ip=d(bl),kr=s(bl,"SPAN",{});var Pg=a(kr);lp=i(Pg,"MPNetForMultipleChoice"),Pg.forEach(t),bl.forEach(t),Li=d(n),Be=s(n,"DIV",{class:!0});var Tt=a(Be);b(Eo.$$.fragment,Tt),dp=d(Tt),vr=s(Tt,"P",{});var $g=a(vr);cp=i($g,`MPNet Model with a multiple choice classification head on top (a linear layer on top of the pooled output and a
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),$l.forEach(t),Qp=d(wt),Ie=s(wt,"DIV",{class:!0});var nt=a(Ie);b(Wo.$$.fragment,nt),Hp=d(nt),Ot=s(nt,"P",{});var ja=a(Ot);Rp=i(ja,"The "),pa=s(ja,"A",{href:!0});var Ig=a(pa);Up=i(Ig,"MPNetForTokenClassification"),Ig.forEach(t),Bp=i(ja," forward method, overrides the "),$r=s(ja,"CODE",{});var Sg=a($r);Vp=i(Sg,"__call__"),Sg.forEach(t),Kp=i(ja," special method."),ja.forEach(t),Xp=d(nt),b(vn.$$.fragment,nt),Jp=d(nt),Nr=s(nt,"P",{});var Dg=a(Nr);Gp=i(Dg,"Example:"),Dg.forEach(t),Yp=d(nt),b(Qo.$$.fragment,nt),Zp=d(nt),b(Ho.$$.fragment,nt),nt.forEach(t),wt.forEach(t),Di=d(n),Wt=s(n,"H2",{class:!0});var Nl=a(Wt);bn=s(Nl,"A",{id:!0,class:!0,href:!0});var Og=a(bn);yr=s(Og,"SPAN",{});var Wg=a(yr);b(Ro.$$.fragment,Wg),Wg.forEach(t),Og.forEach(t),eh=d(Nl),Fr=s(Nl,"SPAN",{});var Qg=a(Fr);th=i(Qg,"MPNetForQuestionAnswering"),Qg.forEach(t),Nl.forEach(t),Oi=d(n),Ke=s(n,"DIV",{class:!0});var Pt=a(Ke);b(Uo.$$.fragment,Pt),nh=d(Pt),Qt=s(Pt,"P",{});var Ca=a(Qt);oh=i(Ca,`MPNet Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
layers on top of the hidden-states output to compute `),zr=s(Ca,"CODE",{});var Hg=a(zr);sh=i(Hg,"span start logits"),Hg.forEach(t),ah=i(Ca," and "),Er=s(Ca,"CODE",{});var Rg=a(Er);rh=i(Rg,"span end logits"),Rg.forEach(t),ih=i(Ca,")."),Ca.forEach(t),lh=d(Pt),Bo=s(Pt,"P",{});var yl=a(Bo);dh=i(yl,"This model inherits from "),ha=s(yl,"A",{href:!0});var Ug=a(ha);ch=i(Ug,"PreTrainedModel"),Ug.forEach(t),ph=i(yl,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),yl.forEach(t),hh=d(Pt),Vo=s(Pt,"P",{});var Fl=a(Vo);mh=i(Fl,"This model is also a PyTorch "),Ko=s(Fl,"A",{href:!0,rel:!0});var Bg=a(Ko);uh=i(Bg,"torch.nn.Module"),Bg.forEach(t),fh=i(Fl,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Fl.forEach(t),gh=d(Pt),Se=s(Pt,"DIV",{class:!0});var ot=a(Se);b(Xo.$$.fragment,ot),_h=d(ot),Ht=s(ot,"P",{});var xa=a(Ht);kh=i(xa,"The "),ma=s(xa,"A",{href:!0});var Vg=a(ma);vh=i(Vg,"MPNetForQuestionAnswering"),Vg.forEach(t),bh=i(xa," forward method, overrides the "),qr=s(xa,"CODE",{});var Kg=a(qr);Th=i(Kg,"__call__"),Kg.forEach(t),Mh=i(xa," special method."),xa.forEach(t),wh=d(ot),b(Tn.$$.fragment,ot),Ph=d(ot),jr=s(ot,"P",{});var Xg=a(jr);$h=i(Xg,"Example:"),Xg.forEach(t),Nh=d(ot),b(Jo.$$.fragment,ot),yh=d(ot),b(Go.$$.fragment,ot),ot.forEach(t),Pt.forEach(t),Wi=d(n),Rt=s(n,"H2",{class:!0});var zl=a(Rt);Mn=s(zl,"A",{id:!0,class:!0,href:!0});var Jg=a(Mn);Cr=s(Jg,"SPAN",{});var Gg=a(Cr);b(Yo.$$.fragment,Gg),Gg.forEach(t),Jg.forEach(t),Fh=d(zl),xr=s(zl,"SPAN",{});var Yg=a(xr);zh=i(Yg,"TFMPNetModel"),Yg.forEach(t),zl.forEach(t),Qi=d(n),ze=s(n,"DIV",{class:!0});var st=a(ze);b(Zo.$$.fragment,st),Eh=d(st),Ar=s(st,"P",{});var Zg=a(Ar);qh=i(Zg,"The bare MPNet Model transformer outputting raw hidden-states without any specific head on top."),Zg.forEach(t),jh=d(st),es=s(st,"P",{});var El=a(es);Ch=i(El,"This model inherits from "),ua=s(El,"A",{href:!0});var e_=a(ua);xh=i(e_,"TFPreTrainedModel"),e_.forEach(t),Ah=i(El,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),ql.forEach(t),Oh=d(st),b(wn.$$.fragment,st),Wh=d(st),Ge=s(st,"DIV",{class:!0});var $t=a(Ge);b(os.$$.fragment,$t),Qh=d($t),Ut=s($t,"P",{});var Aa=a(Ut);Hh=i(Aa,"The "),fa=s(Aa,"A",{href:!0});var n_=a(fa);Rh=i(n_,"TFMPNetModel"),n_.forEach(t),Uh=i(Aa," forward method, overrides the "),Lr=s(Aa,"CODE",{});var o_=a(Lr);Bh=i(o_,"__call__"),o_.forEach(t),Vh=i(Aa," special method."),Aa.forEach(t),Kh=d($t),b(Pn.$$.fragment,$t),Xh=d($t),Ir=s($t,"P",{});var s_=a(Ir);Jh=i(s_,"Example:"),s_.forEach(t),Gh=d($t),b(ss.$$.fragment,$t),$t.forEach(t),st.forEach(t),Hi=d(n),Bt=s(n,"H2",{class:!0});var jl=a(Bt);$n=s(jl,"A",{id:!0,class:!0,href:!0});var a_=a($n);Sr=s(a_,"SPAN",{});var r_=a(Sr);b(as.$$.fragment,r_),r_.forEach(t),a_.forEach(t),Yh=d(jl),Dr=s(jl,"SPAN",{});var i_=a(Dr);Zh=i(i_,"TFMPNetForMaskedLM"),i_.forEach(t),jl.forEach(t),Ri=d(n),Ee=s(n,"DIV",{class:!0});var at=a(Ee);b(rs.$$.fragment,at),em=d(at),is=s(at,"P",{});var Cl=a(is);tm=i(Cl,"MPNet Model with a "),Or=s(Cl,"CODE",{});var l_=a(Or);nm=i(l_,"language modeling"),l_.forEach(t),om=i(Cl," head on top."),Cl.forEach(t),sm=d(at),ls=s(at,"P",{});var xl=a(ls);am=i(xl,"This model inherits from "),ga=s(xl,"A",{href:!0});var d_=a(ga);rm=i(d_,"TFPreTrainedModel"),d_.forEach(t),im=i(xl,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Sl.forEach(t),Im=d(it),b(zn.$$.fragment,it),Sm=d(it),Oe=s(it,"DIV",{class:!0});var lt=a(Oe);b(vs.$$.fragment,lt),Dm=d(lt),Xt=s(lt,"P",{});var Ia=a(Xt);Om=i(Ia,"The "),va=s(Ia,"A",{href:!0});var b_=a(va);Wm=i(b_,"TFMPNetForSequenceClassification"),b_.forEach(t),Qm=i(Ia," forward method, overrides the "),Br=s(Ia,"CODE",{});var T_=a(Br);Hm=i(T_,"__call__"),T_.forEach(t),Rm=i(Ia," special method."),Ia.forEach(t),Um=d(lt),b(En.$$.fragment,lt),Bm=d(lt),Vr=s(lt,"P",{});var M_=a(Vr);Vm=i(M_,"Example:"),M_.forEach(t),Km=d(lt),b(bs.$$.fragment,lt),Xm=d(lt),b(Ts.$$.fragment,lt),lt.forEach(t),it.forEach(t),Vi=d(n),Jt=s(n,"H2",{class:!0});var Dl=a(Jt);qn=s(Dl,"A",{id:!0,class:!0,href:!0});var w_=a(qn);Kr=s(w_,"SPAN",{});var P_=a(Kr);b(Ms.$$.fragment,P_),P_.forEach(t),w_.forEach(t),Jm=d(Dl),Xr=s(Dl,"SPAN",{});var $_=a(Xr);Gm=i($_,"TFMPNetForMultipleChoice"),$_.forEach(t),Dl.forEach(t),Ki=d(n),je=s(n,"DIV",{class:!0});var dt=a(je);b(ws.$$.fragment,dt),Ym=d(dt),Jr=s(dt,"P",{});var N_=a(Jr);Zm=i(N_,`MPNet Model with a multiple choice classification head on top (a linear layer on top of the pooled output and a
