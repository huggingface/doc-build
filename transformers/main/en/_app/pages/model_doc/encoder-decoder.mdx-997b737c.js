import{S as Di,i as xi,s as $i,e as a,k as c,w as f,t,M as ji,c as s,d as o,m as l,a as d,x as u,h as r,b as i,F as e,g as h,y as g,q as _,o as b,B as v,v as Fi}from"../../chunks/vendor-6b77c823.js";import{T as dd}from"../../chunks/Tip-39098574.js";import{D as O}from"../../chunks/Docstring-abef54e3.js";import{C as qe}from"../../chunks/CodeBlock-3a8b25a8.js";import{I as Rn}from"../../chunks/IconCopyLink-7a11ce68.js";function Pi(pe){let m,F,y,z,j;return{c(){m=a("p"),F=t("Although the recipe for forward pass needs to be defined within this function, one should call the "),y=a("code"),z=t("Module"),j=t(`
...
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),T.forEach(o)},m(k,T){h(k,m,T),e(m,F),e(m,y),e(y,z),e(m,j)},d(k){k&&o(m)}}}function Ai(pe){let m,F,y,z,j;return{c(){m=a("p"),F=t("Although the recipe for forward pass needs to be defined within this function, one should call the "),y=a("code"),z=t("Module"),j=t(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(k){m=s(k,"P",{});var T=d(m);F=r(T,"Although the recipe for forward pass needs to be defined within this function, one should call the "),y=s(T,"CODE",{});var P=d(y);z=r(P,"Module"),P.forEach(o),j=r(T,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),T.forEach(o)},m(k,T){h(k,m,T),e(m,F),e(m,y),e(y,z),e(m,j)},d(k){k&&o(m)}}}function Ci(pe){let m,F,y,z,j;return{c(){m=a("p"),F=t("Although the recipe for forward pass needs to be defined within this function, one should call the "),y=a("code"),z=t("Module"),j=t(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(k){m=s(k,"P",{});var T=d(m);F=r(T,"Although the recipe for forward pass needs to be defined within this function, one should call the "),y=s(T,"CODE",{});var P=d(y);z=r(P,"Module"),P.forEach(o),j=r(T,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),T.forEach(o)},m(k,T){h(k,m,T),e(m,F),e(m,y),e(y,z),e(m,j)},d(k){k&&o(m)}}}function Si(pe){let m,F,y,z,j,k,T,P,zt,Gn,me,qt,wo,Dt,xt,Un,he,$t,De,jt,Ft,Hn,fe,Pt,Eo,At,Ct,Yn,V,St,Mo,Nt,It,xe,Lt,Bt,Jn,W,Ot,sn,Vt,Wt,dn,Rt,Gt,Zn,$e,Kn,R,Ut,je,Ht,Yt,Fe,Jt,Zt,Qn,Q,ue,cn,Pe,Kt,ln,Qt,Xn,q,Ae,Xt,ge,zo,er,or,qo,nr,tr,rr,X,ar,Do,sr,dr,xo,ir,cr,lr,pn,pr,mr,Ce,hr,_e,Se,fr,Ne,ur,$o,gr,_r,br,be,Ie,vr,ee,yr,mn,kr,Tr,hn,wr,Er,et,oe,ve,fn,Le,Mr,un,zr,ot,w,Be,qr,ne,Dr,jo,xr,$r,Fo,jr,Fr,Pr,Oe,Ar,Ve,Cr,Sr,Nr,gn,Ir,Lr,We,Br,Po,Or,Vr,Wr,Re,Rr,Ge,Gr,Ur,Hr,G,Ao,Yr,Jr,_n,Zr,Kr,bn,Qr,Xr,ea,A,Ue,oa,te,na,Co,ta,ra,vn,aa,sa,da,ye,ia,yn,ca,la,He,pa,C,Ye,ma,kn,ha,fa,re,ua,Tn,ga,_a,wn,ba,va,ya,En,ka,Ta,Je,nt,ae,ke,Mn,Ze,wa,zn,Ea,tt,E,Ke,Ma,se,za,So,qa,Da,No,xa,$a,ja,Qe,Fa,Xe,Pa,Aa,Ca,qn,Sa,Na,eo,Ia,Io,La,Ba,Oa,oo,Va,no,Wa,Ra,Ga,U,Lo,Ua,Ha,Bo,Ya,Ja,Oo,Za,Ka,Qa,S,to,Xa,de,es,Vo,os,ns,Dn,ts,rs,as,Te,ss,xn,ds,is,ro,cs,L,ao,ls,$n,ps,ms,jn,hs,fs,so,rt,ie,we,Fn,io,us,Pn,gs,at,M,co,_s,ce,bs,Wo,vs,ys,Ro,ks,Ts,ws,lo,Es,po,Ms,zs,qs,An,Ds,xs,mo,$s,Go,js,Fs,Ps,ho,As,fo,Cs,Ss,Ns,H,Uo,Is,Ls,Cn,Bs,Os,Sn,Vs,Ws,Rs,N,uo,Gs,le,Us,Ho,Hs,Ys,Nn,Js,Zs,Ks,Ee,Qs,In,Xs,ed,go,od,B,_o,nd,Ln,td,rd,Bn,ad,sd,bo,st;return k=new Rn({}),$e=new qe({props:{code:`# a workaround to load from pytorch checkpoint
...
<span class="hljs-meta">&gt;&gt;&gt; </span>model.save_pretrained(<span class="hljs-string">&quot;./bert2gpt2&quot;</span>)
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-comment"># load fine-tuned model</span>
<span class="hljs-meta">&gt;&gt;&gt; </span>model = FlaxEncoderDecoderModel.from_pretrained(<span class="hljs-string">&quot;./bert2gpt2&quot;</span>)`}}),{c(){m=a("meta"),F=c(),y=a("h1"),z=a("a"),j=a("span"),f(k.$$.fragment),T=c(),P=a("span"),zt=t("Encoder Decoder Models"),Gn=c(),me=a("p"),qt=t("The "),wo=a("a"),Dt=t("EncoderDecoderModel"),xt=t(` can be used to initialize a sequence-to-sequence model with any
...
decoder model configuration.`),br=c(),be=a("div"),f(Ie.$$.fragment),vr=c(),ee=a("p"),yr=t("Serializes this instance to a Python dictionary. Override the default "),mn=a("em"),kr=t("to_dict()"),Tr=t(" from "),hn=a("em"),wr=t("PretrainedConfig"),Er=t("."),et=c(),oe=a("h2"),ve=a("a"),fn=a("span"),f(Le.$$.fragment),Mr=c(),un=a("span"),zr=t("EncoderDecoderModel"),ot=c(),w=a("div"),f(Be.$$.fragment),qr=c(),ne=a("p"),Dr=t(`This class can be used to initialize a sequence-to-sequence model with any pretrained autoencoding model as the
...
the model, you need to first set it back in training mode with `),wn=a("code"),ba=t("model.train()"),va=t("."),ya=c(),En=a("p"),ka=t("Example:"),Ta=c(),f(Je.$$.fragment),nt=c(),ae=a("h2"),ke=a("a"),Mn=a("span"),f(Ze.$$.fragment),wa=c(),zn=a("span"),Ea=t("TFEncoderDecoderModel"),tt=c(),E=a("div"),f(Ke.$$.fragment),Ma=c(),se=a("p"),za=t(`This class can be used to initialize a sequence-to-sequence model with any pretrained autoencoding model as the
encoder and any pretrained autoregressive model as the decoder. The encoder is loaded via
`),So=a("a"),qa=t("from_pretrained()"),Da=t(" function and the decoder is loaded via "),No=a("a"),xa=t("from_pretrained()"),$a=t(`
function. Cross-attention layers are automatically added to the decoder and should be fine-tuned on a downstream
...
checkpoints.`),rd=c(),Bn=a("p"),ad=t("Example:"),sd=c(),f(bo.$$.fragment),this.h()},l(n){const p=ji('[data-svelte="svelte-1phssyn"]',document.head);m=s(p,"META",{name:!0,content:!0}),p.forEach(o),F=l(n),y=s(n,"H1",{class:!0});var vo=d(y);z=s(vo,"A",{id:!0,class:!0,href:!0});var On=d(z);j=s(On,"SPAN",{});var Vn=d(j);u(k.$$.fragment,Vn),Vn.forEach(o),On.forEach(o),T=l(vo),P=s(vo,"SPAN",{});var id=d(P);zt=r(id,"Encoder Decoder Models"),id.forEach(o),vo.forEach(o),Gn=l(n),me=s(n,"P",{});var dt=d(me);qt=r(dt,"The "),wo=s(dt,"A",{href:!0});var cd=d(wo);Dt=r(cd,"EncoderDecoderModel"),cd.forEach(o),xt=r(dt,` can be used to initialize a sequence-to-sequence model with any
...
the model, you need to first set it back in training mode with `),wn=s(on,"CODE",{});var Ud=d(wn);ba=r(Ud,"model.train()"),Ud.forEach(o),va=r(on,"."),on.forEach(o),ya=l(J),En=s(J,"P",{});var Hd=d(En);ka=r(Hd,"Example:"),Hd.forEach(o),Ta=l(J),u(Je.$$.fragment,J),J.forEach(o),D.forEach(o),nt=l(n),ae=s(n,"H2",{class:!0});var bt=d(ae);ke=s(bt,"A",{id:!0,class:!0,href:!0});var Yd=d(ke);Mn=s(Yd,"SPAN",{});var Jd=d(Mn);u(Ze.$$.fragment,Jd),Jd.forEach(o),Yd.forEach(o),wa=l(bt),zn=s(bt,"SPAN",{});var Zd=d(zn);Ea=r(Zd,"TFEncoderDecoderModel"),Zd.forEach(o),bt.forEach(o),tt=l(n),E=s(n,"DIV",{class:!0});var x=d(E);u(Ke.$$.fragment,x),Ma=l(x),se=s(x,"P",{});var nn=d(se);za=r(nn,`This class can be used to initialize a sequence-to-sequence model with any pretrained autoencoding model as the
encoder and any pretrained autoregressive model as the decoder. The encoder is loaded via
`),So=s(nn,"A",{href:!0});var Kd=d(So);qa=r(Kd,"from_pretrained()"),Kd.forEach(o),Da=r(nn," function and the decoder is loaded via "),No=s(nn,"A",{href:!0});var Qd=d(No);xa=r(Qd,"from_pretrained()"),Qd.forEach(o),$a=r(nn,`
function. Cross-attention layers are automatically added to the decoder and should be fine-tuned on a downstream
...
Zhou, Wei Li, Peter J. Liu.`),vt.forEach(o),Ca=l(x),qn=s(x,"P",{});var ei=d(qn);Sa=r(ei,`After such an Encoder Decoder model has been trained/fine-tuned, it can be saved/loaded just like any other models
