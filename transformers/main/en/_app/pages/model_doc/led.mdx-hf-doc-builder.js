...
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-built_in">round</span>(loss.item(), <span class="hljs-number">2</span>)
`}}),{c(){v(l.$$.fragment)},l(p){k(l.$$.fragment,p)},m(p,f){w(l,p,f),b=!0},p:Be,i(p){b||(y(l.$$.fragment,p),b=!0)},o(p){E(l.$$.fragment,p),b=!1},d(p){L(l,p)}}}function im($){let l,b,p,f,T,i,m,F,We,xe,j,te,ne,D,He,K,Ve,Se,G,Re,se,ae,Ue,Me,H,Ke,Ce,V,ye,Xe,me,M,P,Oe,x,O,fe,re,Je,_e,A,Ze,X,Ye,et,J,tt,ot,B,nt,de,ge,Ee,N,be,Q,st,at;return{c(){l=a("p"),b=n("TensorFlow models and layers in "),p=a("code"),f=n("transformers"),T=n(" accept two formats as input:"),i=c(),m=a("ul"),F=a("li"),We=n("having all inputs as keyword arguments (like PyTorch models), or"),xe=c(),j=a("li"),te=n("having all inputs as a list, tuple or dict in the first positional argument."),ne=c(),D=a("p"),He=n(`The reason the second format is supported is that Keras methods prefer this format when passing inputs to models
...
about any of this, as you can just pass inputs like you would to any other Python function!`),this.h()},l(q){l=r(q,"P",{});var z=d(l);b=s(z,"TensorFlow models and layers in "),p=r(z,"CODE",{});var rt=d(p);f=s(rt,"transformers"),rt.forEach(t),T=s(z," accept two formats as input:"),z.forEach(t),i=h(q),m=r(q,"UL",{});var Le=d(m);F=r(Le,"LI",{});var kt=d(F);We=s(kt,"having all inputs as keyword arguments (like PyTorch models), or"),kt.forEach(t),xe=h(Le),j=r(Le,"LI",{});var dt=d(j);te=s(dt,"having all inputs as a list, tuple or dict in the first positional argument."),dt.forEach(t),Le.forEach(t),ne=h(q),D=r(q,"P",{});var S=d(D);He=s(S,`The reason the second format is supported is that Keras methods prefer this format when passing inputs to models
...
about any of this, as you can just pass inputs like you would to any other Python function!`),qe.forEach(t),this.h()},h(){u(Q,"href","https://keras.io/guides/making_new_layers_and_models_via_subclassing/"),u(Q,"rel","nofollow")},m(q,z){g(q,l,z),e(l,b),e(l,p),e(p,f),e(l,T),g(q,i,z),g(q,m,z),e(m,F),e(F,We),e(m,xe),e(m,j),e(j,te),g(q,ne,z),g(q,D,z),e(D,He),e(D,K),e(K,Ve),e(D,Se),e(D,G),e(G,Re),e(D,se),e(D,ae),e(ae,Ue),e(D,Me),e(D,H),e(H,Ke),e(D,Ce),e(D,V),e(V,ye),e(D,Xe),g(q,me,z),g(q,M,z),e(M,P),e(P,Oe),e(P,x),e(x,O),e(P,fe),e(P,re),e(re,Je),e(M,_e),e(M,A),e(A,Ze),e(A,X),e(X,Ye),e(A,et),e(A,J),e(J,tt),e(M,ot),e(M,B),e(B,nt),e(B,de),e(de,ge),g(q,Ee,z),g(q,N,z),e(N,be),e(N,Q),e(Q,st),e(N,at)},d(q){q&&t(l),q&&t(i),q&&t(m),q&&t(ne),q&&t(D),q&&t(me),q&&t(M),q&&t(Ee),q&&t(N)}}}function lm($){let l,b,p,f,T;return{c(){l=a("p"),b=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),p=a("code"),f=n("Module"),T=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(i){l=r(i,"P",{});var m=d(l);b=s(m,"Although the recipe for forward pass needs to be defined within this function, one should call the "),p=r(m,"CODE",{});var F=d(p);f=s(F,"Module"),F.forEach(t),T=s(m,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),{c(){l=a("p"),b=n("Example:"),p=c(),v(f.$$.fragment)},l(i){l=r(i,"P",{});var m=d(l);b=s(m,"Example:"),m.forEach(t),p=h(i),k(f.$$.fragment,i)},m(i,m){g(i,l,m),e(l,b),g(i,p,m),w(f,i,m),T=!0},p:Be,i(i){T||(y(f.$$.fragment,i),T=!0)},o(i){E(f.$$.fragment,i),T=!1},d(i){i&&t(l),i&&t(p),L(f,i)}}}function hm($){let l,b,p,f,T,i,m,F,We,xe,j,te,ne,D,He,K,Ve,Se,G,Re,se,ae,Ue,Me,H,Ke,Ce,V,ye,Xe,me,M,P,Oe,x,O,fe,re,Je,_e,A,Ze,X,Ye,et,J,tt,ot,B,nt,de,ge,Ee,N,be,Q,st,at;return{c(){l=a("p"),b=n("TensorFlow models and layers in "),p=a("code"),f=n("transformers"),T=n(" accept two formats as input:"),i=c(),m=a("ul"),F=a("li"),We=n("having all inputs as keyword arguments (like PyTorch models), or"),xe=c(),j=a("li"),te=n("having all inputs as a list, tuple or dict in the first positional argument."),ne=c(),D=a("p"),He=n(`The reason the second format is supported is that Keras methods prefer this format when passing inputs to models
and layers. Because of this support, when using methods like `),K=a("code"),Ve=n("model.fit()"),Se=n(` things should \u201Cjust work\u201D for you - just
pass your inputs and labels in any format that `),G=a("code"),Re=n("model.fit()"),se=n(` supports! If, however, you want to use the second
format outside of Keras methods like `),ae=a("code"),Ue=n("fit()"),Me=n(" and "),H=a("code"),Ke=n("predict()"),Ce=n(`, such as when creating your own layers or models with
the Keras `),V=a("code"),ye=n("Functional"),Xe=n(` API, there are three possibilities you can use to gather all the input Tensors in the first
...
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-comment"># probs[5] is associated with the mask token</span>`}}),{c(){l=a("p"),b=n("Examples:"),p=c(),v(f.$$.fragment)},l(i){l=r(i,"P",{});var m=d(l);b=s(m,"Examples:"),m.forEach(t),p=h(i),k(f.$$.fragment,i)},m(i,m){g(i,l,m),e(l,b),g(i,p,m),w(f,i,m),T=!0},p:Be,i(i){T||(y(f.$$.fragment,i),T=!0)},o(i){E(f.$$.fragment,i),T=!1},d(i){i&&t(l),i&&t(p),L(f,i)}}}function mm($){let l,b,p,f,T,i,m,F,We,xe,j,te,ne,D,He,K,Ve,Se,G,Re,se,ae,Ue,Me,H,Ke,Ce,V,ye,Xe,me,M,P,Oe,x,O,fe,re,Je,_e,A,Ze,X,Ye,et,J,tt,ot,B,nt,de,ge,Ee,N,be,Q,st,at,q,z,rt,Le,kt,dt,S,wt,yt,W,Et,it,Z,ie,lt,Lt,le,je,qt,ct,ht,qe,$t,vd,Y,kd,Ws,wd,yd,Hs,Ed,Ld,is,qd,$d,Vs,Dd,Fd,Rs,zd,xd,Us,Sd,Md,Cd,pt,Od,Ks,jd,Pd,Xs,Ad,Nd,Js,Id,Gd,Bd,Vo,Qd,Ro,Wd,Hd,Vd,Uo,Rd,Ko,Ud,Kd,ar,to,Xd,Xo,Jd,Zd,rr,Dt,oo,Zs,Jo,Yd,Ys,ei,dr,$e,Zo,ti,Ft,oi,ls,ni,si,Yo,ai,ri,di,zt,ii,cs,li,ci,hs,hi,pi,ui,no,ir,xt,so,ea,en,mi,ta,fi,lr,I,tn,_i,oa,gi,bi,ao,ps,Ti,vi,us,ki,wi,yi,on,Ei,ms,Li,qi,$i,ut,nn,Di,na,Fi,zi,sn,fs,xi,sa,Si,Mi,_s,Ci,aa,Oi,ji,ro,an,Pi,rn,Ai,ra,Ni,Ii,Gi,io,dn,Bi,da,Qi,Wi,gs,ln,cr,St,lo,ia,cn,Hi,la,Vi,hr,De,hn,Ri,pn,Ui,ca,Ki,Xi,Ji,co,bs,Zi,Yi,Ts,el,tl,ol,un,nl,vs,sl,al,pr,Mt,ho,ha,mn,rl,pa,dl,ur,Ct,fn,il,ua,ll,mr,Ot,_n,cl,ma,hl,fr,jt,gn,pl,fa,ul,_r,Pt,bn,ml,_a,fl,gr,At,Tn,_l,ga,gl,br,Nt,vn,bl,ba,Tl,Tr,It,kn,vl,Ta,kl,vr,Gt,wn,wl,va,yl,kr,Bt,po,ka,yn,El,wa,Ll,wr,Fe,En,ql,Ln,$l,ks,Dl,Fl,zl,qn,xl,$n,Sl,Ml,Cl,Pe,Dn,Ol,Qt,jl,ws,Pl,Al,ya,Nl,Il,Gl,uo,Bl,mo,yr,Wt,fo,Ea,Fn,Ql,La,Wl,Er,ze,zn,Hl,xn,Vl,ys,Rl,Ul,Kl,Sn,Xl,Mn,Jl,Zl,Yl,Te,Cn,ec,Ht,tc,Es,oc,nc,qa,sc,ac,rc,_o,dc,go,ic,bo,Lr,Vt,To,$a,On,lc,Da,cc,qr,ce,jn,hc,Fa,pc,uc,Pn,mc,Ls,fc,_c,gc,An,bc,Nn,Tc,vc,kc,R,In,wc,Rt,yc,qs,Ec,Lc,za,qc,$c,Dc,vo,Fc,ko,zc,wo,xc,yo,Sc,Eo,$r,Ut,Lo,xa,Gn,Mc,Sa,Cc,Dr,he,Bn,Oc,Kt,jc,Ma,Pc,Ac,Ca,Nc,Ic,Gc,Qn,Bc,$s,Qc,Wc,Hc,Wn,Vc,Hn,Rc,Uc,Kc,ve,Vn,Xc,Xt,Jc,Ds,Zc,Yc,Oa,eh,th,oh,qo,nh,$o,sh,Do,Fr,Jt,Fo,ja,Rn,ah,Pa,rh,zr,pe,Un,dh,Kn,ih,Fs,lh,ch,hh,Xn,ph,Jn,uh,mh,fh,zo,_h,Ae,Zn,gh,Zt,bh,zs,Th,vh,Aa,kh,wh,yh,xo,Eh,So,xr,Yt,Mo,Na,Yn,Lh,Ia,qh,Sr,ue,es,$h,ts,Dh,xs,Fh,zh,xh,os,Sh,ns,Mh,Ch,Oh,Co,jh,Ne,ss,Ph,eo,Ah,Ss,Nh,Ih,Ga,Gh,Bh,Qh,Oo,Wh,jo,Mr;return i=new Ie({}),D=new Ie({}),Jo=new Ie({}),Zo=new C({props:{name:"class transformers.LEDConfig",anchor:"transformers.LEDConfig",parameters:[{name:"vocab_size",val:" = 50265"},{name:"max_encoder_position_embeddings",val:" = 16384"},{name:"max_decoder_position_embeddings",val:" = 1024"},{name:"encoder_layers",val:" = 12"},{name:"encoder_ffn_dim",val:" = 4096"},{name:"encoder_attention_heads",val:" = 16"},{name:"decoder_layers",val:" = 12"},{name:"decoder_ffn_dim",val:" = 4096"},{name:"decoder_attention_heads",val:" = 16"},{name:"encoder_layerdrop",val:" = 0.0"},{name:"decoder_layerdrop",val:" = 0.0"},{name:"use_cache",val:" = True"},{name:"is_encoder_decoder",val:" = True"},{name:"activation_function",val:" = 'gelu'"},{name:"d_model",val:" = 1024"},{name:"dropout",val:" = 0.1"},{name:"attention_dropout",val:" = 0.0"},{name:"activation_dropout",val:" = 0.0"},{name:"init_std",val:" = 0.02"},{name:"decoder_start_token_id",val:" = 2"},{name:"classifier_dropout",val:" = 0.0"},{name:"pad_token_id",val:" = 1"},{name:"bos_token_id",val:" = 0"},{name:"eos_token_id",val:" = 2"},{name:"attention_window",val:": typing.Union[typing.List[int], int] = 512"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.LEDConfig.vocab_size",description:`<strong>vocab_size</strong> (<code>int</code>, <em>optional</em>, defaults to 50265) &#x2014;
...
Whether or not the model should return the last key/values attentions (not used by all models)`,name:"use_cache"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/led/configuration_led.py#L31"}}),no=new Ge({props:{anchor:"transformers.LEDConfig.example",$$slots:{default:[Uu]},$$scope:{ctx:$}}}),en=new Ie({}),tn=new C({props:{name:"class transformers.LEDTokenizer",anchor:"transformers.LEDTokenizer",parameters:[{name:"vocab_file",val:""},{name:"merges_file",val:""},{name:"errors",val:" = 'replace'"},{name:"bos_token",val:" = '<s>'"},{name:"eos_token",val:" = '</s>'"},{name:"sep_token",val:" = '</s>'"},{name:"cls_token",val:" = '<s>'"},{name:"unk_token",val:" = '<unk>'"},{name:"pad_token",val:" = '<pad>'"},{name:"mask_token",val:" = '<mask>'"},{name:"add_prefix_space",val:" = False"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/led/tokenization_led.py#L43"}}),nn=new C({props:{name:"build_inputs_with_special_tokens",anchor:"transformers.LEDTokenizer.build_inputs_with_special_tokens",parameters:[{name:"token_ids_0",val:": typing.List[int]"},{name:"token_ids_1",val:": typing.Optional[typing.List[int]] = None"}],parametersDescription:[{anchor:"transformers.LEDTokenizer.build_inputs_with_special_tokens.token_ids_0",description:`<strong>token_ids_0</strong> (<code>List[int]</code>) &#x2014;
...
<p>Global attentions weights after the attention softmax, used to compute the weighted average in the
self-attention heads. Those are the attention weights from every token with global attention to every token
in the sequence.`,name:"encoder_global_attentions"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/led/modeling_tf_led.py#L1411"}}),wn=new C({props:{name:"class transformers.models.led.modeling_tf_led.TFLEDSeq2SeqLMOutput",anchor:"transformers.models.led.modeling_tf_led.TFLEDSeq2SeqLMOutput",parameters:[{name:"loss",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"logits",val:": Tensor = None"},{name:"past_key_values",val:": typing.Optional[typing.List[tensorflow.python.framework.ops.Tensor]] = None"},{name:"decoder_hidden_states",val:": typing.Optional[typing.Tuple[tensorflow.python.framework.ops.Tensor]] = None"},{name:"decoder_attentions",val:": typing.Optional[typing.Tuple[tensorflow.python.framework.ops.Tensor]] = None"},{name:"cross_attentions",val:": typing.Optional[typing.Tuple[tensorflow.python.framework.ops.Tensor]] = None"},{name:"encoder_last_hidden_state",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"encoder_hidden_states",val:": typing.Optional[typing.Tuple[tensorflow.python.framework.ops.Tensor]] = None"},{name:"encoder_attentions",val:": typing.Optional[typing.Tuple[tensorflow.python.framework.ops.Tensor]] = None"},{name:"encoder_global_attentions",val:": typing.Optional[typing.Tuple[tensorflow.python.framework.ops.Tensor]] = None"}],parametersDescription:[{anchor:"transformers.models.led.modeling_tf_led.TFLEDSeq2SeqLMOutput.loss",description:`<strong>loss</strong> (<code>tf.Tensor</code> of shape <code>(1,)</code>, <em>optional</em>, returned when <code>labels</code> is provided) &#x2014;
...
`}}),_o=new Ho({props:{$$slots:{default:[Ju]},$$scope:{ctx:$}}}),go=new Ge({props:{anchor:"transformers.LEDForConditionalGeneration.forward.example",$$slots:{default:[Zu]},$$scope:{ctx:$}}}),bo=new Ge({props:{anchor:"transformers.LEDForConditionalGeneration.forward.example-2",$$slots:{default:[Yu]},$$scope:{ctx:$}}}),On=new Ie({}),jn=new C({props:{name:"class transformers.LEDForSequenceClassification",anchor:"transformers.LEDForSequenceClassification",parameters:[{name:"config",val:": LEDConfig"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.LEDForSequenceClassification.config",description:`<strong>config</strong> (<a href="/docs/transformers/main/en/model_doc/led#transformers.LEDConfig">LEDConfig</a>) &#x2014;
Model configuration class with all the parameters of the model. Initializing with a config file does not
load the weights associated with the model, only the configuration. Check out the
<a href="/docs/transformers/main/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/led/modeling_led.py#L2529"}}),In=new C({props:{name:"forward",anchor:"transformers.LEDForSequenceClassification.forward",parameters:[{name:"input_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"attention_mask",val:": typing.Optional[torch.Tensor] = None"},{name:"decoder_input_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"decoder_attention_mask",val:": typing.Optional[torch.LongTensor] = None"},{name:"head_mask",val:": typing.Optional[torch.Tensor] = None"},{name:"decoder_head_mask",val:": typing.Optional[torch.Tensor] = None"},{name:"cross_attn_head_mask",val:": typing.Optional[torch.Tensor] = None"},{name:"encoder_outputs",val:": typing.Optional[typing.Tuple[typing.Tuple[torch.FloatTensor]]] = None"},{name:"global_attention_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"decoder_inputs_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"labels",val:": typing.Optional[torch.LongTensor] = None"},{name:"use_cache",val:": typing.Optional[bool] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.LEDForSequenceClassification.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. Padding will be ignored by default should you provide
it.</p>
<p>Indices can be obtained using <a href="/docs/transformers/main/en/model_doc/led#transformers.LEDTokenizer">LEDTokenizer</a>. See <a href="/docs/transformers/main/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/main/en/model_doc/wav2vec2_phoneme#transformers.Wav2Vec2PhonemeCTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
behaviors between training and evaluation).`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/led/modeling_tf_led.py#L2252",returnDescription:`
<p>A <a
...
Whether or not to use the model in training mode (some modules like dropout modules have different
behaviors between training and evaluation).`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/led/modeling_tf_led.py#L2382",returnDescription:`
<p>A <a
...
`}}),Oo=new Ho({props:{$$slots:{default:[pm]},$$scope:{ctx:$}}}),jo=new Ge({props:{anchor:"transformers.TFLEDForConditionalGeneration.call.example",$$slots:{default:[um]},$$scope:{ctx:$}}}),{c(){l=a("meta"),b=c(),p=a("h1"),f=a("a"),T=a("span"),v(i.$$.fragment),m=c(),F=a("span"),We=n("LED"),xe=c(),j=a("h2"),te=a("a"),ne=a("span"),v(D.$$.fragment),He=c(),K=a("span"),Ve=n("Overview"),Se=c(),G=a("p"),Re=n("The LED model was proposed in "),se=a("a"),ae=n("Longformer: The Long-Document Transformer"),Ue=n(` by Iz
...
gained, when `),je=a("a"),qt=n("LEDTokenizer"),ct=n(" is used with the "),ht=a("code"),qe=n("pad_to_multiple_of"),$t=n(" argument."),vd=c(),Y=a("li"),kd=n("LED makes use of "),Ws=a("em"),wd=n("global attention"),yd=n(" by means of the "),Hs=a("code"),Ed=n("global_attention_mask"),Ld=n(` (see
...
adding special tokens. A BART sequence has the following format:`),zi=c(),sn=a("ul"),fs=a("li"),xi=n("single sequence: "),sa=a("code"),Si=n("<s> X </s>"),Mi=c(),_s=a("li"),Ci=n("pair of sequences: "),aa=a("code"),Oi=n("<s> A </s></s> B </s>"),ji=c(),ro=a("div"),v(an.$$.fragment),Pi=c(),rn=a("p"),Ai=n(`Retrieve sequence ids from a token list that has no special tokens added. This method is called when adding
...
make use of token type ids, therefore a list of zeros is returned.`),Wi=c(),gs=a("div"),v(ln.$$.fragment),cr=c(),St=a("h2"),lo=a("a"),ia=a("span"),v(cn.$$.fragment),Hi=c(),la=a("span"),Vi=n("LEDTokenizerFast"),hr=c(),De=a("div"),v(hn.$$.fragment),Ri=c(),pn=a("p"),Ui=n("Construct a \u201Cfast\u201D LED tokenizer (backed by HuggingFace\u2019s "),ca=a("em"),Ki=n("tokenizers"),Xi=n(" library)."),Ji=c(),co=a("p"),bs=a("a"),Zi=n("LEDTokenizerFast"),Yi=n(" is identical to "),Ts=a("a"),el=n("BartTokenizerFast"),tl=n(` and runs end-to-end tokenization: punctuation splitting
and wordpiece.`),ol=c(),un=a("p"),nl=n("Refer to superclass "),vs=a("a"),sl=n("BartTokenizerFast"),al=n(" for usage examples and documentation concerning parameters."),pr=c(),Mt=a("h2"),ho=a("a"),ha=a("span"),v(mn.$$.fragment),rl=c(),pa=a("span"),dl=n("LED specific outputs"),ur=c(),Ct=a("div"),v(fn.$$.fragment),il=c(),ua=a("p"),ll=n("Base class for LEDEncoder\u2019s outputs, with potential hidden states, local and global attentions."),mr=c(),Ot=a("div"),v(_n.$$.fragment),cl=c(),ma=a("p"),hl=n(`Base class for model encoder\u2019s outputs that also contains : pre-computed hidden states that can speed up sequential
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for general usage and behavior.`),Cl=c(),Pe=a("div"),v(Dn.$$.fragment),Ol=c(),Qt=a("p"),jl=n("The "),ws=a("a"),Pl=n("LEDModel"),Al=n(" forward method, overrides the "),ya=a("code"),Nl=n("__call__"),Il=n(" special method."),Gl=c(),v(uo.$$.fragment),Bl=c(),v(mo.$$.fragment),yr=c(),Wt=a("h2"),fo=a("a"),Ea=a("span"),v(Fn.$$.fragment),Ql=c(),La=a("span"),Wl=n("LEDForConditionalGeneration"),Er=c(),ze=a("div"),v(zn.$$.fragment),Hl=c(),xn=a("p"),Vl=n(`The LED Model with a language modeling head. Can be used for summarization.
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for general usage and behavior.`),Yl=c(),Te=a("div"),v(Cn.$$.fragment),ec=c(),Ht=a("p"),tc=n("The "),Es=a("a"),oc=n("LEDForConditionalGeneration"),nc=n(" forward method, overrides the "),qa=a("code"),sc=n("__call__"),ac=n(" special method."),rc=c(),v(_o.$$.fragment),dc=c(),v(go.$$.fragment),ic=c(),v(bo.$$.fragment),Lr=c(),Vt=a("h2"),To=a("a"),$a=a("span"),v(On.$$.fragment),lc=c(),Da=a("span"),cc=n("LEDForSequenceClassification"),qr=c(),ce=a("div"),v(jn.$$.fragment),hc=c(),Fa=a("p"),pc=n(`LED model with a sequence classification/head on top (a linear layer on top of the pooled output) e.g. for GLUE
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for general usage and behavior.`),kc=c(),R=a("div"),v(In.$$.fragment),wc=c(),Rt=a("p"),yc=n("The "),qs=a("a"),Ec=n("LEDForSequenceClassification"),Lc=n(" forward method, overrides the "),za=a("code"),qc=n("__call__"),$c=n(" special method."),Dc=c(),v(vo.$$.fragment),Fc=c(),v(ko.$$.fragment),zc=c(),v(wo.$$.fragment),xc=c(),v(yo.$$.fragment),Sc=c(),v(Eo.$$.fragment),$r=c(),Ut=a("h2"),Lo=a("a"),xa=a("span"),v(Gn.$$.fragment),Mc=c(),Sa=a("span"),Cc=n("LEDForQuestionAnswering"),Dr=c(),he=a("div"),v(Bn.$$.fragment),Oc=c(),Kt=a("p"),jc=n(`LED Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear layer
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for general usage and behavior.`),Kc=c(),ve=a("div"),v(Vn.$$.fragment),Xc=c(),Xt=a("p"),Jc=n("The "),Ds=a("a"),Zc=n("LEDForQuestionAnswering"),Yc=n(" forward method, overrides the "),Oa=a("code"),eh=n("__call__"),th=n(" special method."),oh=c(),v(qo.$$.fragment),nh=c(),v($o.$$.fragment),sh=c(),v(Do.$$.fragment),Fr=c(),Jt=a("h2"),Fo=a("a"),ja=a("span"),v(Rn.$$.fragment),ah=c(),Pa=a("span"),rh=n("TFLEDModel"),zr=c(),pe=a("div"),v(Un.$$.fragment),dh=c(),Kn=a("p"),ih=n(`The bare LED Model outputting raw hidden-states without any specific head on top.
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Oh=c(),v(Co.$$.fragment),jh=c(),Ne=a("div"),v(ss.$$.fragment),Ph=c(),eo=a("p"),Ah=n("The "),Ss=a("a"),Nh=n("TFLEDForConditionalGeneration"),Ih=n(" forward method, overrides the "),Ga=a("code"),Gh=n("__call__"),Bh=n(" special method."),Qh=c(),v(Oo.$$.fragment),Wh=c(),v(jo.$$.fragment),this.h()},l(o){const _=Vu('[data-svelte="svelte-1phssyn"]',document.head);l=r(_,"META",{name:!0,content:!0}),_.forEach(t),b=h(o),p=r(o,"H1",{class:!0});var as=d(p);f=r(as,"A",{id:!0,class:!0,href:!0});var Ba=d(f);T=r(Ba,"SPAN",{});var Qa=d(T);k(i.$$.fragment,Qa),Qa.forEach(t),Ba.forEach(t),m=h(as),F=r(as,"SPAN",{});var Wa=d(F);We=s(Wa,"LED"),Wa.forEach(t),as.forEach(t),xe=h(o),j=r(o,"H2",{class:!0});var rs=d(j);te=r(rs,"A",{id:!0,class:!0,href:!0});var Ha=d(te);ne=r(Ha,"SPAN",{});var Va=d(ne);k(D.$$.fragment,Va),Va.forEach(t),Ha.forEach(t),He=h(rs),K=r(rs,"SPAN",{});var Ra=d(K);Ve=s(Ra,"Overview"),Ra.forEach(t),rs.forEach(t),Se=h(o),G=r(o,"P",{});var ds=d(G);Re=s(ds,"The LED model was proposed in "),se=r(ds,"A",{href:!0,rel:!0});var Ua=d(se);ae=s(Ua,"Longformer: The Long-Document Transformer"),Ua.forEach(t),Ue=s(ds,` by Iz
...
`),be=r(U,"A",{href:!0});var Kh=d(be);Q=s(Kh,"BartTokenizer"),Kh.forEach(t),st=s(U,"."),U.forEach(t),at=h(ee),q=r(ee,"LI",{});var Ms=d(q);z=s(Ms,"LED works very well on long-range "),rt=r(Ms,"EM",{});var Xh=d(rt);Le=s(Xh,"sequence-to-sequence"),Xh.forEach(t),kt=s(Ms," tasks where the "),dt=r(Ms,"CODE",{});var Jh=d(dt);S=s(Jh,"input_ids"),Jh.forEach(t),wt=s(Ms,` largely exceed a length of
...
gained, when `),je=r(mt,"A",{href:!0});var ep=d(je);qt=s(ep,"LEDTokenizer"),ep.forEach(t),ct=s(mt," is used with the "),ht=r(mt,"CODE",{});var tp=d(ht);qe=s(tp,"pad_to_multiple_of"),tp.forEach(t),$t=s(mt," argument."),mt.forEach(t),vd=h(ee),Y=r(ee,"LI",{});var ke=d(Y);kd=s(ke,"LED makes use of "),Ws=r(ke,"EM",{});var op=d(Ws);wd=s(op,"global attention"),op.forEach(t),yd=s(ke," by means of the "),Hs=r(ke,"CODE",{});var np=d(Hs);Ed=s(np,"global_attention_mask"),np.forEach(t),Ld=s(ke,` (see
...
make use of token type ids, therefore a list of zeros is returned.`),Sp.forEach(t),Qr.forEach(t),Wi=h(oe),gs=r(oe,"DIV",{class:!0});var Mp=d(gs);k(ln.$$.fragment,Mp),Mp.forEach(t),oe.forEach(t),cr=h(o),St=r(o,"H2",{class:!0});var Wr=d(St);lo=r(Wr,"A",{id:!0,class:!0,href:!0});var Cp=d(lo);ia=r(Cp,"SPAN",{});var Op=d(ia);k(cn.$$.fragment,Op),Op.forEach(t),Cp.forEach(t),Hi=h(Wr),la=r(Wr,"SPAN",{});var jp=d(la);Vi=s(jp,"LEDTokenizerFast"),jp.forEach(t),Wr.forEach(t),hr=h(o),De=r(o,"DIV",{class:!0});var No=d(De);k(hn.$$.fragment,No),Ri=h(No),pn=r(No,"P",{});var Hr=d(pn);Ui=s(Hr,"Construct a \u201Cfast\u201D LED tokenizer (backed by HuggingFace\u2019s "),ca=r(Hr,"EM",{});var Pp=d(ca);Ki=s(Pp,"tokenizers"),Pp.forEach(t),Xi=s(Hr," library)."),Hr.forEach(t),Ji=h(No),co=r(No,"P",{});var sr=d(co);bs=r(sr,"A",{href:!0});var Ap=d(bs);Zi=s(Ap,"LEDTokenizerFast"),Ap.forEach(t),Yi=s(sr," is identical to "),Ts=r(sr,"A",{href:!0});var Np=d(Ts);el=s(Np,"BartTokenizerFast"),Np.forEach(t),tl=s(sr,` and runs end-to-end tokenization: punctuation splitting
and wordpiece.`),sr.forEach(t),ol=h(No),un=r(No,"P",{});var Vr=d(un);nl=s(Vr,"Refer to superclass "),vs=r(Vr,"A",{href:!0});var Ip=d(vs);sl=s(Ip,"BartTokenizerFast"),Ip.forEach(t),al=s(Vr," for usage examples and documentation concerning parameters."),Vr.forEach(t),No.forEach(t),pr=h(o),Mt=r(o,"H2",{class:!0});var Rr=d(Mt);ho=r(Rr,"A",{id:!0,class:!0,href:!0});var Gp=d(ho);ha=r(Gp,"SPAN",{});var Bp=d(ha);k(mn.$$.fragment,Bp),Bp.forEach(t),Gp.forEach(t),rl=h(Rr),pa=r(Rr,"SPAN",{});var Qp=d(pa);dl=s(Qp,"LED specific outputs"),Qp.forEach(t),Rr.forEach(t),ur=h(o),Ct=r(o,"DIV",{class:!0});var Ur=d(Ct);k(fn.$$.fragment,Ur),il=h(Ur),ua=r(Ur,"P",{});var Wp=d(ua);ll=s(Wp,"Base class for LEDEncoder\u2019s outputs, with potential hidden states, local and global attentions."),Wp.forEach(t),Ur.forEach(t),mr=h(o),Ot=r(o,"DIV",{class:!0});var Kr=d(Ot);k(_n.$$.fragment,Kr),cl=h(Kr),ma=r(Kr,"P",{});var Hp=d(ma);hl=s(Hp,`Base class for model encoder\u2019s outputs that also contains : pre-computed hidden states that can speed up sequential
decoding.`),Hp.forEach(t),Kr.forEach(t),fr=h(o),jt=r(o,"DIV",{class:!0});var Xr=d(jt);k(gn.$$.fragment,Xr),pl=h(Xr),fa=r(Xr,"P",{});var Vp=d(fa);ul=s(Vp,"Base class for sequence-to-sequence language models outputs."),Vp.forEach(t),Xr.forEach(t),_r=h(o),Pt=r(o,"DIV",{class:!0});var Jr=d(Pt);k(bn.$$.fragment,Jr),ml=h(Jr),_a=r(Jr,"P",{});var Rp=d(_a);fl=s(Rp,"Base class for outputs of sequence-to-sequence sentence classification models."),Rp.forEach(t),Jr.forEach(t),gr=h(o),At=r(o,"DIV",{class:!0});var Zr=d(At);k(Tn.$$.fragment,Zr),_l=h(Zr),ga=r(Zr,"P",{});var Up=d(ga);gl=s(Up,"Base class for outputs of sequence-to-sequence question answering models."),Up.forEach(t),Zr.forEach(t),br=h(o),Nt=r(o,"DIV",{class:!0});var Yr=d(Nt);k(vn.$$.fragment,Yr),bl=h(Yr),ba=r(Yr,"P",{});var Kp=d(ba);Tl=s(Kp,"Base class for Longformer\u2019s outputs, with potential hidden states, local and global attentions."),Kp.forEach(t),Yr.forEach(t),Tr=h(o),It=r(o,"DIV",{class:!0});var ed=d(It);k(kn.$$.fragment,ed),vl=h(ed),Ta=r(ed,"P",{});var Xp=d(Ta);kl=s(Xp,`Base class for model encoder\u2019s outputs that also contains : pre-computed hidden states that can speed up sequential
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for general usage and behavior.`),dd.forEach(t),Yl=h(Bo),Te=r(Bo,"DIV",{class:!0});var ft=d(Te);k(Cn.$$.fragment,ft),ec=h(ft),Ht=r(ft,"P",{});var As=d(Ht);tc=s(As,"The "),Es=r(As,"A",{href:!0});var cu=d(Es);oc=s(cu,"LEDForConditionalGeneration"),cu.forEach(t),nc=s(As," forward method, overrides the "),qa=r(As,"CODE",{});var hu=d(qa);sc=s(hu,"__call__"),hu.forEach(t),ac=s(As," special method."),As.forEach(t),rc=h(ft),k(_o.$$.fragment,ft),dc=h(ft),k(go.$$.fragment,ft),ic=h(ft),k(bo.$$.fragment,ft),ft.forEach(t),Bo.forEach(t),Lr=h(o),Vt=r(o,"H2",{class:!0});var id=d(Vt);To=r(id,"A",{id:!0,class:!0,href:!0});var pu=d(To);$a=r(pu,"SPAN",{});var uu=d($a);k(On.$$.fragment,uu),uu.forEach(t),pu.forEach(t),lc=h(id),Da=r(id,"SPAN",{});var mu=d(Da);cc=s(mu,"LEDForSequenceClassification"),mu.forEach(t),id.forEach(t),qr=h(o),ce=r(o,"DIV",{class:!0});var _t=d(ce);k(jn.$$.fragment,_t),hc=h(_t),Fa=r(_t,"P",{});var fu=d(Fa);pc=s(fu,`LED model with a sequence classification/head on top (a linear layer on top of the pooled output) e.g. for GLUE
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for general usage and behavior.`),cd.forEach(t),kc=h(_t),R=r(_t,"DIV",{class:!0});var we=d(R);k(In.$$.fragment,we),wc=h(we),Rt=r(we,"P",{});var Ns=d(Rt);yc=s(Ns,"The "),qs=r(Ns,"A",{href:!0});var bu=d(qs);Ec=s(bu,"LEDForSequenceClassification"),bu.forEach(t),Lc=s(Ns," forward method, overrides the "),za=r(Ns,"CODE",{});var Tu=d(za);qc=s(Tu,"__call__"),Tu.forEach(t),$c=s(Ns," special method."),Ns.forEach(t),Dc=h(we),k(vo.$$.fragment,we),Fc=h(we),k(ko.$$.fragment,we),zc=h(we),k(wo.$$.fragment,we),xc=h(we),k(yo.$$.fragment,we),Sc=h(we),k(Eo.$$.fragment,we),we.forEach(t),_t.forEach(t),$r=h(o),Ut=r(o,"H2",{class:!0});var hd=d(Ut);Lo=r(hd,"A",{id:!0,class:!0,href:!0});var vu=d(Lo);xa=r(vu,"SPAN",{});var ku=d(xa);k(Gn.$$.fragment,ku),ku.forEach(t),vu.forEach(t),Mc=h(hd),Sa=r(hd,"SPAN",{});var wu=d(Sa);Cc=s(wu,"LEDForQuestionAnswering"),wu.forEach(t),hd.forEach(t),Dr=h(o),he=r(o,"DIV",{class:!0});var gt=d(he);k(Bn.$$.fragment,gt),Oc=h(gt),Kt=r(gt,"P",{});var Is=d(Kt);jc=s(Is,`LED Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear layer
