import{S as Qu,i as Hu,s as Wu,e as a,k as c,w as v,t as n,M as Ru,c as r,d as t,m as h,a as d,x as k,h as s,b as u,G as e,g,y as w,q as y,o as E,B as L,v as Uu,L as Ge}from"../../chunks/vendor-hf-doc-builder.js";import{T as Wo}from"../../chunks/Tip-hf-doc-builder.js";import{D as O}from"../../chunks/Docstring-hf-doc-builder.js";import{C as Qe}from"../../chunks/CodeBlock-hf-doc-builder.js";import{I as Ie}from"../../chunks/IconCopyLink-hf-doc-builder.js";import{E as Be}from"../../chunks/ExampleCodeBlock-hf-doc-builder.js";function Vu($){let l,b,p,f,T;return f=new Qe({props:{code:`from transformers import LEDModel, LEDConfig
...
<span class="hljs-meta">&gt;&gt;&gt; </span>configuration = model.config`}}),{c(){l=a("p"),b=n("Example:"),p=c(),v(f.$$.fragment)},l(i){l=r(i,"P",{});var m=d(l);b=s(m,"Example:"),m.forEach(t),p=h(i),k(f.$$.fragment,i)},m(i,m){g(i,l,m),e(l,b),g(i,p,m),w(f,i,m),T=!0},p:Ge,i(i){T||(y(f.$$.fragment,i),T=!0)},o(i){E(f.$$.fragment,i),T=!1},d(i){i&&t(l),i&&t(p),L(f,i)}}}function Ku($){let l,b,p,f,T;return{c(){l=a("p"),b=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),p=a("code"),f=n("Module"),T=n(`
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),{c(){l=a("p"),b=n("Example:"),p=c(),v(f.$$.fragment)},l(i){l=r(i,"P",{});var m=d(l);b=s(m,"Example:"),m.forEach(t),p=h(i),k(f.$$.fragment,i)},m(i,m){g(i,l,m),e(l,b),g(i,p,m),w(f,i,m),T=!0},p:Ge,i(i){T||(y(f.$$.fragment,i),T=!0)},o(i){E(f.$$.fragment,i),T=!1},d(i){i&&t(l),i&&t(p),L(f,i)}}}function Ju($){let l,b,p,f,T;return{c(){l=a("p"),b=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),p=a("code"),f=n("Module"),T=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(i){l=r(i,"P",{});var m=d(l);b=s(m,"Although the recipe for forward pass needs to be defined within this function, one should call the "),p=r(m,"CODE",{});var F=d(p);f=s(F,"Module"),F.forEach(t),T=s(m,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-built_in">print</span>(tokenizer.decode(prediction, skip_special_tokens=<span class="hljs-literal">True</span>))`}}),{c(){l=a("p"),b=n("Conditional generation example:"),p=c(),v(f.$$.fragment)},l(i){l=r(i,"P",{});var m=d(l);b=s(m,"Conditional generation example:"),m.forEach(t),p=h(i),k(f.$$.fragment,i)},m(i,m){g(i,l,m),e(l,b),g(i,p,m),w(f,i,m),T=!0},p:Ge,i(i){T||(y(f.$$.fragment,i),T=!0)},o(i){E(f.$$.fragment,i),T=!1},d(i){i&&t(l),i&&t(p),L(f,i)}}}function Yu($){let l,b,p,f,T;return f=new Qe({props:{code:`import torch
...
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-built_in">print</span>(tokenizer.decode(summary_ids[<span class="hljs-number">0</span>], skip_special_tokens=<span class="hljs-literal">True</span>, clean_up_tokenization_spaces=<span class="hljs-literal">True</span>))`}}),{c(){l=a("p"),b=n("Summarization example:"),p=c(),v(f.$$.fragment)},l(i){l=r(i,"P",{});var m=d(l);b=s(m,"Summarization example:"),m.forEach(t),p=h(i),k(f.$$.fragment,i)},m(i,m){g(i,l,m),e(l,b),g(i,p,m),w(f,i,m),T=!0},p:Ge,i(i){T||(y(f.$$.fragment,i),T=!0)},o(i){E(f.$$.fragment,i),T=!1},d(i){i&&t(l),i&&t(p),L(f,i)}}}function em($){let l,b,p,f,T;return{c(){l=a("p"),b=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),p=a("code"),f=n("Module"),T=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(i){l=r(i,"P",{});var m=d(l);b=s(m,"Although the recipe for forward pass needs to be defined within this function, one should call the "),p=r(m,"CODE",{});var F=d(p);f=s(F,"Module"),F.forEach(t),T=s(m,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
`}}),{c(){l=a("p"),b=n("Example of single-label classification:"),p=c(),v(f.$$.fragment)},l(i){l=r(i,"P",{});var m=d(l);b=s(m,"Example of single-label classification:"),m.forEach(t),p=h(i),k(f.$$.fragment,i)},m(i,m){g(i,l,m),e(l,b),g(i,p,m),w(f,i,m),T=!0},p:Ge,i(i){T||(y(f.$$.fragment,i),T=!0)},o(i){E(f.$$.fragment,i),T=!1},d(i){i&&t(l),i&&t(p),L(f,i)}}}function om($){let l,b;return l=new Qe({props:{code:`# To train a model on \`num_labels\` classes, you can pass \`num_labels=num_labels\` to \`.from_pretrained(...)\`
...
`}}),{c(){v(l.$$.fragment)},l(p){k(l.$$.fragment,p)},m(p,f){w(l,p,f),b=!0},p:Ge,i(p){b||(y(l.$$.fragment,p),b=!0)},o(p){E(l.$$.fragment,p),b=!1},d(p){L(l,p)}}}function nm($){let l,b,p,f,T;return f=new Qe({props:{code:`import torch
from transformers import LEDTokenizer, LEDForSequenceClassification
...
<span class="hljs-meta">&gt;&gt;&gt; </span>predicted_class_id = logits.argmax().item()
<span class="hljs-meta">&gt;&gt;&gt; </span>model.config.id2label[predicted_class_id]
`}}),{c(){l=a("p"),b=n("Example of multi-label classification:"),p=c(),v(f.$$.fragment)},l(i){l=r(i,"P",{});var m=d(l);b=s(m,"Example of multi-label classification:"),m.forEach(t),p=h(i),k(f.$$.fragment,i)},m(i,m){g(i,l,m),e(l,b),g(i,p,m),w(f,i,m),T=!0},p:Ge,i(i){T||(y(f.$$.fragment,i),T=!0)},o(i){E(f.$$.fragment,i),T=!1},d(i){i&&t(l),i&&t(p),L(f,i)}}}function sm($){let l,b;return l=new Qe({props:{code:`# To train a model on \`num_labels\` classes, you can pass \`num_labels=num_labels\` to \`.from_pretrained(...)\`
num_labels = len(model.config.id2label)
...
<span class="hljs-meta">... </span>)
<span class="hljs-meta">&gt;&gt;&gt; </span>loss = model(**inputs, labels=labels).loss
<span class="hljs-meta">&gt;&gt;&gt; </span>loss.backward()`}}),{c(){v(l.$$.fragment)},l(p){k(l.$$.fragment,p)},m(p,f){w(l,p,f),b=!0},p:Ge,i(p){b||(y(l.$$.fragment,p),b=!0)},o(p){E(l.$$.fragment,p),b=!1},d(p){L(l,p)}}}function am($){let l,b,p,f,T;return{c(){l=a("p"),b=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),p=a("code"),f=n("Module"),T=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(i){l=r(i,"P",{});var m=d(l);b=s(m,"Although the recipe for forward pass needs to be defined within this function, one should call the "),p=r(m,"CODE",{});var F=d(p);f=s(F,"Module"),F.forEach(t),T=s(m,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
`}}),{c(){l=a("p"),b=n("Example:"),p=c(),v(f.$$.fragment)},l(i){l=r(i,"P",{});var m=d(l);b=s(m,"Example:"),m.forEach(t),p=h(i),k(f.$$.fragment,i)},m(i,m){g(i,l,m),e(l,b),g(i,p,m),w(f,i,m),T=!0},p:Ge,i(i){T||(y(f.$$.fragment,i),T=!0)},o(i){E(f.$$.fragment,i),T=!1},d(i){i&&t(l),i&&t(p),L(f,i)}}}function dm($){let l,b;return l=new Qe({props:{code:`# target is "nice puppet"
...
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-built_in">round</span>(loss.item(), <span class="hljs-number">2</span>)
`}}),{c(){v(l.$$.fragment)},l(p){k(l.$$.fragment,p)},m(p,f){w(l,p,f),b=!0},p:Ge,i(p){b||(y(l.$$.fragment,p),b=!0)},o(p){E(l.$$.fragment,p),b=!1},d(p){L(l,p)}}}function im($){let l,b,p,f,T,i,m,F,He,xe,j,te,ne,D,We,K,Re,Se,B,Ue,se,ae,Ve,Me,W,Ke,Oe,R,ye,Xe,me,M,P,Ce,x,C,fe,re,Je,_e,A,Ze,X,Ye,et,J,tt,ot,G,nt,de,ge,Ee,N,be,Q,st,at;return{c(){l=a("p"),b=n("TensorFlow models and layers in "),p=a("code"),f=n("transformers"),T=n(" accept two formats as input:"),i=c(),m=a("ul"),F=a("li"),He=n("having all inputs as keyword arguments (like PyTorch models), or"),xe=c(),j=a("li"),te=n("having all inputs as a list, tuple or dict in the first positional argument."),ne=c(),D=a("p"),We=n(`The reason the second format is supported is that Keras methods prefer this format when passing inputs to models
and layers. Because of this support, when using methods like `),K=a("code"),Re=n("model.fit()"),Se=n(` things should \u201Cjust work\u201D for you - just
pass your inputs and labels in any format that `),B=a("code"),Ue=n("model.fit()"),se=n(` supports! If, however, you want to use the second
...
the Keras `),R=a("code"),ye=n("Functional"),Xe=n(` API, there are three possibilities you can use to gather all the input Tensors in the first
...
about any of this, as you can just pass inputs like you would to any other Python function!`),this.h()},l(q){l=r(q,"P",{});var z=d(l);b=s(z,"TensorFlow models and layers in "),p=r(z,"CODE",{});var rt=d(p);f=s(rt,"transformers"),rt.forEach(t),T=s(z," accept two formats as input:"),z.forEach(t),i=h(q),m=r(q,"UL",{});var Le=d(m);F=r(Le,"LI",{});var kt=d(F);He=s(kt,"having all inputs as keyword arguments (like PyTorch models), or"),kt.forEach(t),xe=h(Le),j=r(Le,"LI",{});var dt=d(j);te=s(dt,"having all inputs as a list, tuple or dict in the first positional argument."),dt.forEach(t),Le.forEach(t),ne=h(q),D=r(q,"P",{});var S=d(D);We=s(S,`The reason the second format is supported is that Keras methods prefer this format when passing inputs to models
and layers. Because of this support, when using methods like `),K=r(S,"CODE",{});var wt=d(K);Re=s(wt,"model.fit()"),wt.forEach(t),Se=s(S,` things should \u201Cjust work\u201D for you - just
pass your inputs and labels in any format that `),B=r(S,"CODE",{});var yt=d(B);Ue=s(yt,"model.fit()"),yt.forEach(t),se=s(S,` supports! If, however, you want to use the second
...
the Keras `),R=r(S,"CODE",{});var it=d(R);ye=s(it,"Functional"),it.forEach(t),Xe=s(S,` API, there are three possibilities you can use to gather all the input Tensors in the first
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),{c(){l=a("p"),b=n("Example:"),p=c(),v(f.$$.fragment)},l(i){l=r(i,"P",{});var m=d(l);b=s(m,"Example:"),m.forEach(t),p=h(i),k(f.$$.fragment,i)},m(i,m){g(i,l,m),e(l,b),g(i,p,m),w(f,i,m),T=!0},p:Ge,i(i){T||(y(f.$$.fragment,i),T=!0)},o(i){E(f.$$.fragment,i),T=!1},d(i){i&&t(l),i&&t(p),L(f,i)}}}function hm($){let l,b,p,f,T,i,m,F,He,xe,j,te,ne,D,We,K,Re,Se,B,Ue,se,ae,Ve,Me,W,Ke,Oe,R,ye,Xe,me,M,P,Ce,x,C,fe,re,Je,_e,A,Ze,X,Ye,et,J,tt,ot,G,nt,de,ge,Ee,N,be,Q,st,at;return{c(){l=a("p"),b=n("TensorFlow models and layers in "),p=a("code"),f=n("transformers"),T=n(" accept two formats as input:"),i=c(),m=a("ul"),F=a("li"),He=n("having all inputs as keyword arguments (like PyTorch models), or"),xe=c(),j=a("li"),te=n("having all inputs as a list, tuple or dict in the first positional argument."),ne=c(),D=a("p"),We=n(`The reason the second format is supported is that Keras methods prefer this format when passing inputs to models
and layers. Because of this support, when using methods like `),K=a("code"),Re=n("model.fit()"),Se=n(` things should \u201Cjust work\u201D for you - just
pass your inputs and labels in any format that `),B=a("code"),Ue=n("model.fit()"),se=n(` supports! If, however, you want to use the second
format outside of Keras methods like `),ae=a("code"),Ve=n("fit()"),Me=n(" and "),W=a("code"),Ke=n("predict()"),Oe=n(`, such as when creating your own layers or models with
the Keras `),R=a("code"),ye=n("Functional"),Xe=n(` API, there are three possibilities you can use to gather all the input Tensors in the first
...
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-comment"># probs[5] is associated with the mask token</span>`}}),{c(){l=a("p"),b=n("Examples:"),p=c(),v(f.$$.fragment)},l(i){l=r(i,"P",{});var m=d(l);b=s(m,"Examples:"),m.forEach(t),p=h(i),k(f.$$.fragment,i)},m(i,m){g(i,l,m),e(l,b),g(i,p,m),w(f,i,m),T=!0},p:Ge,i(i){T||(y(f.$$.fragment,i),T=!0)},o(i){E(f.$$.fragment,i),T=!1},d(i){i&&t(l),i&&t(p),L(f,i)}}}function mm($){let l,b,p,f,T,i,m,F,He,xe,j,te,ne,D,We,K,Re,Se,B,Ue,se,ae,Ve,Me,W,Ke,Oe,R,ye,Xe,me,M,P,Ce,x,C,fe,re,Je,_e,A,Ze,X,Ye,et,J,tt,ot,G,nt,de,ge,Ee,N,be,Q,st,at,q,z,rt,Le,kt,dt,S,wt,yt,H,Et,it,Z,ie,lt,Lt,le,je,qt,ct,ht,qe,$t,vd,Y,kd,Hs,wd,yd,Ws,Ed,Ld,is,qd,$d,Rs,Dd,Fd,Us,zd,xd,Vs,Sd,Md,Od,pt,Cd,Ks,jd,Pd,Xs,Ad,Nd,Js,Id,Bd,Gd,Ro,Qd,Uo,Hd,Wd,Rd,Vo,Ud,Ko,Vd,Kd,ar,to,Xd,Xo,Jd,Zd,rr,Dt,oo,Zs,Jo,Yd,Ys,ei,dr,$e,Zo,ti,Ft,oi,ls,ni,si,Yo,ai,ri,di,zt,ii,cs,li,ci,hs,hi,pi,ui,no,ir,xt,so,ea,en,mi,ta,fi,lr,I,tn,_i,oa,gi,bi,ao,ps,Ti,vi,us,ki,wi,yi,on,Ei,ms,Li,qi,$i,ut,nn,Di,na,Fi,zi,sn,fs,xi,sa,Si,Mi,_s,Oi,aa,Ci,ji,ro,an,Pi,rn,Ai,ra,Ni,Ii,Bi,io,dn,Gi,da,Qi,Hi,gs,ln,cr,St,lo,ia,cn,Wi,la,Ri,hr,De,hn,Ui,pn,Vi,ca,Ki,Xi,Ji,co,bs,Zi,Yi,Ts,el,tl,ol,un,nl,vs,sl,al,pr,Mt,ho,ha,mn,rl,pa,dl,ur,Ot,fn,il,ua,ll,mr,Ct,_n,cl,ma,hl,fr,jt,gn,pl,fa,ul,_r,Pt,bn,ml,_a,fl,gr,At,Tn,_l,ga,gl,br,Nt,vn,bl,ba,Tl,Tr,It,kn,vl,Ta,kl,vr,Bt,wn,wl,va,yl,kr,Gt,po,ka,yn,El,wa,Ll,wr,Fe,En,ql,Ln,$l,ks,Dl,Fl,zl,qn,xl,$n,Sl,Ml,Ol,Pe,Dn,Cl,Qt,jl,ws,Pl,Al,ya,Nl,Il,Bl,uo,Gl,mo,yr,Ht,fo,Ea,Fn,Ql,La,Hl,Er,ze,zn,Wl,xn,Rl,ys,Ul,Vl,Kl,Sn,Xl,Mn,Jl,Zl,Yl,Te,On,ec,Wt,tc,Es,oc,nc,qa,sc,ac,rc,_o,dc,go,ic,bo,Lr,Rt,To,$a,Cn,lc,Da,cc,qr,ce,jn,hc,Fa,pc,uc,Pn,mc,Ls,fc,_c,gc,An,bc,Nn,Tc,vc,kc,U,In,wc,Ut,yc,qs,Ec,Lc,za,qc,$c,Dc,vo,Fc,ko,zc,wo,xc,yo,Sc,Eo,$r,Vt,Lo,xa,Bn,Mc,Sa,Oc,Dr,he,Gn,Cc,Kt,jc,Ma,Pc,Ac,Oa,Nc,Ic,Bc,Qn,Gc,$s,Qc,Hc,Wc,Hn,Rc,Wn,Uc,Vc,Kc,ve,Rn,Xc,Xt,Jc,Ds,Zc,Yc,Ca,eh,th,oh,qo,nh,$o,sh,Do,Fr,Jt,Fo,ja,Un,ah,Pa,rh,zr,pe,Vn,dh,Kn,ih,Fs,lh,ch,hh,Xn,ph,Jn,uh,mh,fh,zo,_h,Ae,Zn,gh,Zt,bh,zs,Th,vh,Aa,kh,wh,yh,xo,Eh,So,xr,Yt,Mo,Na,Yn,Lh,Ia,qh,Sr,ue,es,$h,ts,Dh,xs,Fh,zh,xh,os,Sh,ns,Mh,Oh,Ch,Oo,jh,Ne,ss,Ph,eo,Ah,Ss,Nh,Ih,Ba,Bh,Gh,Qh,Co,Hh,jo,Mr;return i=new Ie({}),D=new Ie({}),Jo=new Ie({}),Zo=new O({props:{name:"class transformers.LEDConfig",anchor:"transformers.LEDConfig",parameters:[{name:"vocab_size",val:" = 50265"},{name:"max_encoder_position_embeddings",val:" = 16384"},{name:"max_decoder_position_embeddings",val:" = 1024"},{name:"encoder_layers",val:" = 12"},{name:"encoder_ffn_dim",val:" = 4096"},{name:"encoder_attention_heads",val:" = 16"},{name:"decoder_layers",val:" = 12"},{name:"decoder_ffn_dim",val:" = 4096"},{name:"decoder_attention_heads",val:" = 16"},{name:"encoder_layerdrop",val:" = 0.0"},{name:"decoder_layerdrop",val:" = 0.0"},{name:"use_cache",val:" = True"},{name:"is_encoder_decoder",val:" = True"},{name:"activation_function",val:" = 'gelu'"},{name:"d_model",val:" = 1024"},{name:"dropout",val:" = 0.1"},{name:"attention_dropout",val:" = 0.0"},{name:"activation_dropout",val:" = 0.0"},{name:"init_std",val:" = 0.02"},{name:"decoder_start_token_id",val:" = 2"},{name:"classifier_dropout",val:" = 0.0"},{name:"pad_token_id",val:" = 1"},{name:"bos_token_id",val:" = 0"},{name:"eos_token_id",val:" = 2"},{name:"attention_window",val:": typing.Union[typing.List[int], int] = 512"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.LEDConfig.vocab_size",description:`<strong>vocab_size</strong> (<code>int</code>, <em>optional</em>, defaults to 50265) &#x2014;
...
<p>Global attentions weights after the attention softmax, used to compute the weighted average in the
self-attention heads. Those are the attention weights from every token with global attention to every token
in the sequence.`,name:"encoder_global_attentions"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/led/modeling_tf_led.py#L1397"}}),wn=new O({props:{name:"class transformers.models.led.modeling_tf_led.TFLEDSeq2SeqLMOutput",anchor:"transformers.models.led.modeling_tf_led.TFLEDSeq2SeqLMOutput",parameters:[{name:"loss",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"logits",val:": Tensor = None"},{name:"past_key_values",val:": typing.Optional[typing.List[tensorflow.python.framework.ops.Tensor]] = None"},{name:"decoder_hidden_states",val:": typing.Optional[typing.Tuple[tensorflow.python.framework.ops.Tensor]] = None"},{name:"decoder_attentions",val:": typing.Optional[typing.Tuple[tensorflow.python.framework.ops.Tensor]] = None"},{name:"cross_attentions",val:": typing.Optional[typing.Tuple[tensorflow.python.framework.ops.Tensor]] = None"},{name:"encoder_last_hidden_state",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"encoder_hidden_states",val:": typing.Optional[typing.Tuple[tensorflow.python.framework.ops.Tensor]] = None"},{name:"encoder_attentions",val:": typing.Optional[typing.Tuple[tensorflow.python.framework.ops.Tensor]] = None"},{name:"encoder_global_attentions",val:": typing.Optional[typing.Tuple[tensorflow.python.framework.ops.Tensor]] = None"}],parametersDescription:[{anchor:"transformers.models.led.modeling_tf_led.TFLEDSeq2SeqLMOutput.loss",description:`<strong>loss</strong> (<code>tf.Tensor</code> of shape <code>(1,)</code>, <em>optional</em>, returned when <code>labels</code> is provided) &#x2014;
...
<p>Global attentions weights after the attention softmax, used to compute the weighted average in the
self-attention heads. Those are the attention weights from every token with global attention to every token
in the sequence.`,name:"encoder_global_attentions"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/led/modeling_tf_led.py#L1465"}}),yn=new Ie({}),En=new O({props:{name:"class transformers.LEDModel",anchor:"transformers.LEDModel",parameters:[{name:"config",val:": LEDConfig"}],parametersDescription:[{anchor:"transformers.LEDModel.config",description:`<strong>config</strong> (<a href="/docs/transformers/main/en/model_doc/led#transformers.LEDConfig">LEDConfig</a>) &#x2014;
...
behaviors between training and evaluation).`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/led/modeling_tf_led.py#L2258",returnDescription:`
<p>A <a
...
Whether or not to use the model in training mode (some modules like dropout modules have different
behaviors between training and evaluation).`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/led/modeling_tf_led.py#L2388",returnDescription:`
<p>A <a
...
`}}),Co=new Wo({props:{$$slots:{default:[pm]},$$scope:{ctx:$}}}),jo=new Be({props:{anchor:"transformers.TFLEDForConditionalGeneration.call.example",$$slots:{default:[um]},$$scope:{ctx:$}}}),{c(){l=a("meta"),b=c(),p=a("h1"),f=a("a"),T=a("span"),v(i.$$.fragment),m=c(),F=a("span"),He=n("LED"),xe=c(),j=a("h2"),te=a("a"),ne=a("span"),v(D.$$.fragment),We=c(),K=a("span"),Re=n("Overview"),Se=c(),B=a("p"),Ue=n("The LED model was proposed in "),se=a("a"),ae=n("Longformer: The Long-Document Transformer"),Ve=n(` by Iz
Beltagy, Matthew E. Peters, Arman Cohan.`),Me=c(),W=a("p"),Ke=n("The abstract from the paper is the following:"),Oe=c(),R=a("p"),ye=a("em"),Xe=n(`Transformer-based models are unable to process long sequences due to their self-attention operation, which scales
...
`),be=a("a"),Q=n("BartTokenizer"),st=n("."),at=c(),q=a("li"),z=n("LED works very well on long-range "),rt=a("em"),Le=n("sequence-to-sequence"),kt=n(" tasks where the "),dt=a("code"),S=n("input_ids"),wt=n(` largely exceed a length of
1024 tokens.`),yt=c(),H=a("li"),Et=n("LED pads the "),it=a("code"),Z=n("input_ids"),ie=n(" to be a multiple of "),lt=a("code"),Lt=n("config.attention_window"),le=n(` if required. Therefore a small speed-up is
gained, when `),je=a("a"),qt=n("LEDTokenizer"),ct=n(" is used with the "),ht=a("code"),qe=n("pad_to_multiple_of"),$t=n(" argument."),vd=c(),Y=a("li"),kd=n("LED makes use of "),Hs=a("em"),wd=n("global attention"),yd=n(" by means of the "),Ws=a("code"),Ed=n("global_attention_mask"),Ld=n(` (see
`),is=a("a"),qd=n("LongformerModel"),$d=n("). For summarization, it is advised to put "),Rs=a("em"),Dd=n("global attention"),Fd=n(` only on the first
`),Us=a("code"),zd=n("<s>"),xd=n(" token. For question answering, it is advised to put "),Vs=a("em"),Sd=n("global attention"),Md=n(" on all tokens of the question."),Od=c(),pt=a("li"),Cd=n("To fine-tune LED on all 16384, "),Ks=a("em"),jd=n("gradient checkpointing"),Pd=n(` can be enabled in case training leads to out-of-memory (OOM)
...
flag can be used to disable the caching mechanism to save memory.`),Gd=c(),Ro=a("li"),Qd=n("A notebook showing how to evaluate LED, can be accessed "),Uo=a("a"),Hd=n("here"),Wd=n("."),Rd=c(),Vo=a("li"),Ud=n("A notebook showing how to fine-tune LED, can be accessed "),Ko=a("a"),Vd=n("here"),Kd=n("."),ar=c(),to=a("p"),Xd=n("This model was contributed by "),Xo=a("a"),Jd=n("patrickvonplaten"),Zd=n("."),rr=c(),Dt=a("h2"),oo=a("a"),Zs=a("span"),v(Jo.$$.fragment),Yd=c(),Ys=a("span"),ei=n("LEDConfig"),dr=c(),$e=a("div"),v(Zo.$$.fragment),ti=c(),Ft=a("p"),oi=n("This is the configuration class to store the configuration of a "),ls=a("a"),ni=n("LEDModel"),si=n(`. It is used to instantiate an LED
...
documentation from `),hs=a("a"),hi=n("PretrainedConfig"),pi=n(" for more information."),ui=c(),v(no.$$.fragment),ir=c(),xt=a("h2"),so=a("a"),ea=a("span"),v(en.$$.fragment),mi=c(),ta=a("span"),fi=n("LEDTokenizer"),lr=c(),I=a("div"),v(tn.$$.fragment),_i=c(),oa=a("p"),gi=n("Construct a LED tokenizer."),bi=c(),ao=a("p"),ps=a("a"),Ti=n("LEDTokenizer"),vi=n(" is identical to "),us=a("a"),ki=n("BartTokenizer"),wi=n(` and runs end-to-end tokenization: punctuation splitting and
wordpiece.`),yi=c(),on=a("p"),Ei=n("Refer to superclass "),ms=a("a"),Li=n("BartTokenizer"),qi=n(" for usage examples and documentation concerning parameters."),$i=c(),ut=a("div"),v(nn.$$.fragment),Di=c(),na=a("p"),Fi=n(`Build model inputs from a sequence or a pair of sequence for sequence classification tasks by concatenating and
adding special tokens. A BART sequence has the following format:`),zi=c(),sn=a("ul"),fs=a("li"),xi=n("single sequence: "),sa=a("code"),Si=n("<s> X </s>"),Mi=c(),_s=a("li"),Oi=n("pair of sequences: "),aa=a("code"),Ci=n("<s> A </s></s> B </s>"),ji=c(),ro=a("div"),v(an.$$.fragment),Pi=c(),rn=a("p"),Ai=n(`Retrieve sequence ids from a token list that has no special tokens added. This method is called when adding
special tokens using the tokenizer `),ra=a("code"),Ni=n("prepare_for_model"),Ii=n(" method."),Bi=c(),io=a("div"),v(dn.$$.fragment),Gi=c(),da=a("p"),Qi=n(`Create a mask from the two sequences passed to be used in a sequence-pair classification task. BART does not
make use of token type ids, therefore a list of zeros is returned.`),Hi=c(),gs=a("div"),v(ln.$$.fragment),cr=c(),St=a("h2"),lo=a("a"),ia=a("span"),v(cn.$$.fragment),Wi=c(),la=a("span"),Ri=n("LEDTokenizerFast"),hr=c(),De=a("div"),v(hn.$$.fragment),Ui=c(),pn=a("p"),Vi=n("Construct a \u201Cfast\u201D LED tokenizer (backed by HuggingFace\u2019s "),ca=a("em"),Ki=n("tokenizers"),Xi=n(" library)."),Ji=c(),co=a("p"),bs=a("a"),Zi=n("LEDTokenizerFast"),Yi=n(" is identical to "),Ts=a("a"),el=n("BartTokenizerFast"),tl=n(` and runs end-to-end tokenization: punctuation splitting
and wordpiece.`),ol=c(),un=a("p"),nl=n("Refer to superclass "),vs=a("a"),sl=n("BartTokenizerFast"),al=n(" for usage examples and documentation concerning parameters."),pr=c(),Mt=a("h2"),ho=a("a"),ha=a("span"),v(mn.$$.fragment),rl=c(),pa=a("span"),dl=n("LED specific outputs"),ur=c(),Ot=a("div"),v(fn.$$.fragment),il=c(),ua=a("p"),ll=n("Base class for LEDEncoder\u2019s outputs, with potential hidden states, local and global attentions."),mr=c(),Ct=a("div"),v(_n.$$.fragment),cl=c(),ma=a("p"),hl=n(`Base class for model encoder\u2019s outputs that also contains : pre-computed hidden states that can speed up sequential
decoding.`),fr=c(),jt=a("div"),v(gn.$$.fragment),pl=c(),fa=a("p"),ul=n("Base class for sequence-to-sequence language models outputs."),_r=c(),Pt=a("div"),v(bn.$$.fragment),ml=c(),_a=a("p"),fl=n("Base class for outputs of sequence-to-sequence sentence classification models."),gr=c(),At=a("div"),v(Tn.$$.fragment),_l=c(),ga=a("p"),gl=n("Base class for outputs of sequence-to-sequence question answering models."),br=c(),Nt=a("div"),v(vn.$$.fragment),bl=c(),ba=a("p"),Tl=n("Base class for Longformer\u2019s outputs, with potential hidden states, local and global attentions."),Tr=c(),It=a("div"),v(kn.$$.fragment),vl=c(),Ta=a("p"),kl=n(`Base class for model encoder\u2019s outputs that also contains : pre-computed hidden states that can speed up sequential
decoding.`),vr=c(),Bt=a("div"),v(wn.$$.fragment),wl=c(),va=a("p"),yl=n("Base class for sequence-to-sequence language models outputs."),kr=c(),Gt=a("h2"),po=a("a"),ka=a("span"),v(yn.$$.fragment),El=c(),wa=a("span"),Ll=n("LEDModel"),wr=c(),Fe=a("div"),v(En.$$.fragment),ql=c(),Ln=a("p"),$l=n(`The bare LED Model outputting raw hidden-states without any specific head on top.
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for general usage and behavior.`),Ol=c(),Pe=a("div"),v(Dn.$$.fragment),Cl=c(),Qt=a("p"),jl=n("The "),ws=a("a"),Pl=n("LEDModel"),Al=n(" forward method, overrides the "),ya=a("code"),Nl=n("__call__"),Il=n(" special method."),Bl=c(),v(uo.$$.fragment),Gl=c(),v(mo.$$.fragment),yr=c(),Ht=a("h2"),fo=a("a"),Ea=a("span"),v(Fn.$$.fragment),Ql=c(),La=a("span"),Hl=n("LEDForConditionalGeneration"),Er=c(),ze=a("div"),v(zn.$$.fragment),Wl=c(),xn=a("p"),Rl=n(`The LED Model with a language modeling head. Can be used for summarization.
This model inherits from `),ys=a("a"),Ul=n("PreTrainedModel"),Vl=n(`. See the superclass documentation for the generic methods the library
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for general usage and behavior.`),Yl=c(),Te=a("div"),v(On.$$.fragment),ec=c(),Wt=a("p"),tc=n("The "),Es=a("a"),oc=n("LEDForConditionalGeneration"),nc=n(" forward method, overrides the "),qa=a("code"),sc=n("__call__"),ac=n(" special method."),rc=c(),v(_o.$$.fragment),dc=c(),v(go.$$.fragment),ic=c(),v(bo.$$.fragment),Lr=c(),Rt=a("h2"),To=a("a"),$a=a("span"),v(Cn.$$.fragment),lc=c(),Da=a("span"),cc=n("LEDForSequenceClassification"),qr=c(),ce=a("div"),v(jn.$$.fragment),hc=c(),Fa=a("p"),pc=n(`LED model with a sequence classification/head on top (a linear layer on top of the pooled output) e.g. for GLUE
...
implements for all its models (such as downloading or saving, resizing the input embeddings, pruning heads etc.)`),gc=c(),An=a("p"),bc=n("This model is also a PyTorch "),Nn=a("a"),Tc=n("torch.nn.Module"),vc=n(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for general usage and behavior.`),kc=c(),U=a("div"),v(In.$$.fragment),wc=c(),Ut=a("p"),yc=n("The "),qs=a("a"),Ec=n("LEDForSequenceClassification"),Lc=n(" forward method, overrides the "),za=a("code"),qc=n("__call__"),$c=n(" special method."),Dc=c(),v(vo.$$.fragment),Fc=c(),v(ko.$$.fragment),zc=c(),v(wo.$$.fragment),xc=c(),v(yo.$$.fragment),Sc=c(),v(Eo.$$.fragment),$r=c(),Vt=a("h2"),Lo=a("a"),xa=a("span"),v(Bn.$$.fragment),Mc=c(),Sa=a("span"),Oc=n("LEDForQuestionAnswering"),Dr=c(),he=a("div"),v(Gn.$$.fragment),Cc=c(),Kt=a("p"),jc=n(`LED Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear layer
...
implements for all its models (such as downloading or saving, resizing the input embeddings, pruning heads etc.)`),Wc=c(),Hn=a("p"),Rc=n("This model is also a PyTorch "),Wn=a("a"),Uc=n("torch.nn.Module"),Vc=n(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for general usage and behavior.`),Kc=c(),ve=a("div"),v(Rn.$$.fragment),Xc=c(),Xt=a("p"),Jc=n("The "),Ds=a("a"),Zc=n("LEDForQuestionAnswering"),Yc=n(" forward method, overrides the "),Ca=a("code"),eh=n("__call__"),th=n(" special method."),oh=c(),v(qo.$$.fragment),nh=c(),v($o.$$.fragment),sh=c(),v(Do.$$.fragment),Fr=c(),Jt=a("h2"),Fo=a("a"),ja=a("span"),v(Un.$$.fragment),ah=c(),Pa=a("span"),rh=n("TFLEDModel"),zr=c(),pe=a("div"),v(Vn.$$.fragment),dh=c(),Kn=a("p"),ih=n(`The bare LED Model outputting raw hidden-states without any specific head on top.
...
behavior.`),fh=c(),v(zo.$$.fragment),_h=c(),Ae=a("div"),v(Zn.$$.fragment),gh=c(),Zt=a("p"),bh=n("The "),zs=a("a"),Th=n("TFLEDModel"),vh=n(" forward method, overrides the "),Aa=a("code"),kh=n("__call__"),wh=n(" special method."),yh=c(),v(xo.$$.fragment),Eh=c(),v(So.$$.fragment),xr=c(),Yt=a("h2"),Mo=a("a"),Na=a("span"),v(Yn.$$.fragment),Lh=c(),Ia=a("span"),qh=n("TFLEDForConditionalGeneration"),Sr=c(),ue=a("div"),v(es.$$.fragment),$h=c(),ts=a("p"),Dh=n(`The LED Model with a language modeling head. Can be used for summarization.
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Ch=c(),v(Oo.$$.fragment),jh=c(),Ne=a("div"),v(ss.$$.fragment),Ph=c(),eo=a("p"),Ah=n("The "),Ss=a("a"),Nh=n("TFLEDForConditionalGeneration"),Ih=n(" forward method, overrides the "),Ba=a("code"),Bh=n("__call__"),Gh=n(" special method."),Qh=c(),v(Co.$$.fragment),Hh=c(),v(jo.$$.fragment),this.h()},l(o){const _=Ru('[data-svelte="svelte-1phssyn"]',document.head);l=r(_,"META",{name:!0,content:!0}),_.forEach(t),b=h(o),p=r(o,"H1",{class:!0});var as=d(p);f=r(as,"A",{id:!0,class:!0,href:!0});var Ga=d(f);T=r(Ga,"SPAN",{});var Qa=d(T);k(i.$$.fragment,Qa),Qa.forEach(t),Ga.forEach(t),m=h(as),F=r(as,"SPAN",{});var Ha=d(F);He=s(Ha,"LED"),Ha.forEach(t),as.forEach(t),xe=h(o),j=r(o,"H2",{class:!0});var rs=d(j);te=r(rs,"A",{id:!0,class:!0,href:!0});var Wa=d(te);ne=r(Wa,"SPAN",{});var Ra=d(ne);k(D.$$.fragment,Ra),Ra.forEach(t),Wa.forEach(t),We=h(rs),K=r(rs,"SPAN",{});var Ua=d(K);Re=s(Ua,"Overview"),Ua.forEach(t),rs.forEach(t),Se=h(o),B=r(o,"P",{});var ds=d(B);Ue=s(ds,"The LED model was proposed in "),se=r(ds,"A",{href:!0,rel:!0});var Va=d(se);ae=s(Va,"Longformer: The Long-Document Transformer"),Va.forEach(t),Ve=s(ds,` by Iz
Beltagy, Matthew E. Peters, Arman Cohan.`),ds.forEach(t),Me=h(o),W=r(o,"P",{});var Ka=d(W);Ke=s(Ka,"The abstract from the paper is the following:"),Ka.forEach(t),Oe=h(o),R=r(o,"P",{});var Xa=d(R);ye=r(Xa,"EM",{});var Ja=d(ye);Xe=s(Ja,`Transformer-based models are unable to process long sequences due to their self-attention operation, which scales
quadratically with the sequence length. To address this limitation, we introduce the Longformer with an attention
mechanism that scales linearly with sequence length, making it easy to process documents of thousands of tokens or
longer. Longformer\u2019s attention mechanism is a drop-in replacement for the standard self-attention and combines a local
windowed attention with a task motivated global attention. Following prior work on long-sequence transformers, we
...
`),J=r(V,"EM",{});var or=d(J);tt=s(or,"Longformer"),or.forEach(t),ot=s(V,"\u2019s "),G=r(V,"EM",{});var Uh=d(G);nt=s(Uh,"chunked self-attention"),Uh.forEach(t),de=s(V," layer. "),ge=r(V,"A",{href:!0});var Vh=d(ge);Ee=s(Vh,"LEDTokenizer"),Vh.forEach(t),N=s(V,` is an alias of
`),be=r(V,"A",{href:!0});var Kh=d(be);Q=s(Kh,"BartTokenizer"),Kh.forEach(t),st=s(V,"."),V.forEach(t),at=h(ee),q=r(ee,"LI",{});var Ms=d(q);z=s(Ms,"LED works very well on long-range "),rt=r(Ms,"EM",{});var Xh=d(rt);Le=s(Xh,"sequence-to-sequence"),Xh.forEach(t),kt=s(Ms," tasks where the "),dt=r(Ms,"CODE",{});var Jh=d(dt);S=s(Jh,"input_ids"),Jh.forEach(t),wt=s(Ms,` largely exceed a length of
1024 tokens.`),Ms.forEach(t),yt=h(ee),H=r(ee,"LI",{});var mt=d(H);Et=s(mt,"LED pads the "),it=r(mt,"CODE",{});var Zh=d(it);Z=s(Zh,"input_ids"),Zh.forEach(t),ie=s(mt," to be a multiple of "),lt=r(mt,"CODE",{});var Yh=d(lt);Lt=s(Yh,"config.attention_window"),Yh.forEach(t),le=s(mt,` if required. Therefore a small speed-up is
gained, when `),je=r(mt,"A",{href:!0});var ep=d(je);qt=s(ep,"LEDTokenizer"),ep.forEach(t),ct=s(mt," is used with the "),ht=r(mt,"CODE",{});var tp=d(ht);qe=s(tp,"pad_to_multiple_of"),tp.forEach(t),$t=s(mt," argument."),mt.forEach(t),vd=h(ee),Y=r(ee,"LI",{});var ke=d(Y);kd=s(ke,"LED makes use of "),Hs=r(ke,"EM",{});var op=d(Hs);wd=s(op,"global attention"),op.forEach(t),yd=s(ke," by means of the "),Ws=r(ke,"CODE",{});var np=d(Ws);Ed=s(np,"global_attention_mask"),np.forEach(t),Ld=s(ke,` (see
`),is=r(ke,"A",{href:!0});var sp=d(is);qd=s(sp,"LongformerModel"),sp.forEach(t),$d=s(ke,"). For summarization, it is advised to put "),Rs=r(ke,"EM",{});var ap=d(Rs);Dd=s(ap,"global attention"),ap.forEach(t),Fd=s(ke,` only on the first
`),Us=r(ke,"CODE",{});var rp=d(Us);zd=s(rp,"<s>"),rp.forEach(t),xd=s(ke," token. For question answering, it is advised to put "),Vs=r(ke,"EM",{});var dp=d(Vs);Sd=s(dp,"global attention"),dp.forEach(t),Md=s(ke," on all tokens of the question."),ke.forEach(t),Od=h(ee),pt=r(ee,"LI",{});var Po=d(pt);Cd=s(Po,"To fine-tune LED on all 16384, "),Ks=r(Po,"EM",{});var ip=d(Ks);jd=s(ip,"gradient checkpointing"),ip.forEach(t),Pd=s(Po,` can be enabled in case training leads to out-of-memory (OOM)
...
flag can be used to disable the caching mechanism to save memory.`),Po.forEach(t),Gd=h(ee),Ro=r(ee,"LI",{});var Or=d(Ro);Qd=s(Or,"A notebook showing how to evaluate LED, can be accessed "),Uo=r(Or,"A",{href:!0,rel:!0});var hp=d(Uo);Hd=s(hp,"here"),hp.forEach(t),Wd=s(Or,"."),Or.forEach(t),Rd=h(ee),Vo=r(ee,"LI",{});var Cr=d(Vo);Ud=s(Cr,"A notebook showing how to fine-tune LED, can be accessed "),Ko=r(Cr,"A",{href:!0,rel:!0});var pp=d(Ko);Vd=s(pp,"here"),pp.forEach(t),Kd=s(Cr,"."),Cr.forEach(t),ee.forEach(t),ar=h(o),to=r(o,"P",{});var jr=d(to);Xd=s(jr,"This model was contributed by "),Xo=r(jr,"A",{href:!0,rel:!0});var up=d(Xo);Jd=s(up,"patrickvonplaten"),up.forEach(t),Zd=s(jr,"."),jr.forEach(t),rr=h(o),Dt=r(o,"H2",{class:!0});var Pr=d(Dt);oo=r(Pr,"A",{id:!0,class:!0,href:!0});var mp=d(oo);Zs=r(mp,"SPAN",{});var fp=d(Zs);k(Jo.$$.fragment,fp),fp.forEach(t),mp.forEach(t),Yd=h(Pr),Ys=r(Pr,"SPAN",{});var _p=d(Ys);ei=s(_p,"LEDConfig"),_p.forEach(t),Pr.forEach(t),dr=h(o),$e=r(o,"DIV",{class:!0});var Ao=d($e);k(Zo.$$.fragment,Ao),ti=h(Ao),Ft=r(Ao,"P",{});var Os=d(Ft);oi=s(Os,"This is the configuration class to store the configuration of a "),ls=r(Os,"A",{href:!0});var gp=d(ls);ni=s(gp,"LEDModel"),gp.forEach(t),si=s(Os,`. It is used to instantiate an LED
model according to the specified arguments, defining the model architecture. Instantiating a configuration with the
defaults will yield a similar configuration to that of the LED
...
adding special tokens. A BART sequence has the following format:`),Dp.forEach(t),zi=h(js),sn=r(js,"UL",{});var Ir=d(sn);fs=r(Ir,"LI",{});var Wh=d(fs);xi=s(Wh,"single sequence: "),sa=r(Wh,"CODE",{});var Fp=d(sa);Si=s(Fp,"<s> X </s>"),Fp.forEach(t),Wh.forEach(t),Mi=h(Ir),_s=r(Ir,"LI",{});var Rh=d(_s);Oi=s(Rh,"pair of sequences: "),aa=r(Rh,"CODE",{});var zp=d(aa);Ci=s(zp,"<s> A </s></s> B </s>"),zp.forEach(t),Rh.forEach(t),Ir.forEach(t),js.forEach(t),ji=h(oe),ro=r(oe,"DIV",{class:!0});var Br=d(ro);k(an.$$.fragment,Br),Pi=h(Br),rn=r(Br,"P",{});var Gr=d(rn);Ai=s(Gr,`Retrieve sequence ids from a token list that has no special tokens added. This method is called when adding
special tokens using the tokenizer `),ra=r(Gr,"CODE",{});var xp=d(ra);Ni=s(xp,"prepare_for_model"),xp.forEach(t),Ii=s(Gr," method."),Gr.forEach(t),Br.forEach(t),Bi=h(oe),io=r(oe,"DIV",{class:!0});var Qr=d(io);k(dn.$$.fragment,Qr),Gi=h(Qr),da=r(Qr,"P",{});var Sp=d(da);Qi=s(Sp,`Create a mask from the two sequences passed to be used in a sequence-pair classification task. BART does not
make use of token type ids, therefore a list of zeros is returned.`),Sp.forEach(t),Qr.forEach(t),Hi=h(oe),gs=r(oe,"DIV",{class:!0});var Mp=d(gs);k(ln.$$.fragment,Mp),Mp.forEach(t),oe.forEach(t),cr=h(o),St=r(o,"H2",{class:!0});var Hr=d(St);lo=r(Hr,"A",{id:!0,class:!0,href:!0});var Op=d(lo);ia=r(Op,"SPAN",{});var Cp=d(ia);k(cn.$$.fragment,Cp),Cp.forEach(t),Op.forEach(t),Wi=h(Hr),la=r(Hr,"SPAN",{});var jp=d(la);Ri=s(jp,"LEDTokenizerFast"),jp.forEach(t),Hr.forEach(t),hr=h(o),De=r(o,"DIV",{class:!0});var No=d(De);k(hn.$$.fragment,No),Ui=h(No),pn=r(No,"P",{});var Wr=d(pn);Vi=s(Wr,"Construct a \u201Cfast\u201D LED tokenizer (backed by HuggingFace\u2019s "),ca=r(Wr,"EM",{});var Pp=d(ca);Ki=s(Pp,"tokenizers"),Pp.forEach(t),Xi=s(Wr," library)."),Wr.forEach(t),Ji=h(No),co=r(No,"P",{});var sr=d(co);bs=r(sr,"A",{href:!0});var Ap=d(bs);Zi=s(Ap,"LEDTokenizerFast"),Ap.forEach(t),Yi=s(sr," is identical to "),Ts=r(sr,"A",{href:!0});var Np=d(Ts);el=s(Np,"BartTokenizerFast"),Np.forEach(t),tl=s(sr,` and runs end-to-end tokenization: punctuation splitting
and wordpiece.`),sr.forEach(t),ol=h(No),un=r(No,"P",{});var Rr=d(un);nl=s(Rr,"Refer to superclass "),vs=r(Rr,"A",{href:!0});var Ip=d(vs);sl=s(Ip,"BartTokenizerFast"),Ip.forEach(t),al=s(Rr," for usage examples and documentation concerning parameters."),Rr.forEach(t),No.forEach(t),pr=h(o),Mt=r(o,"H2",{class:!0});var Ur=d(Mt);ho=r(Ur,"A",{id:!0,class:!0,href:!0});var Bp=d(ho);ha=r(Bp,"SPAN",{});var Gp=d(ha);k(mn.$$.fragment,Gp),Gp.forEach(t),Bp.forEach(t),rl=h(Ur),pa=r(Ur,"SPAN",{});var Qp=d(pa);dl=s(Qp,"LED specific outputs"),Qp.forEach(t),Ur.forEach(t),ur=h(o),Ot=r(o,"DIV",{class:!0});var Vr=d(Ot);k(fn.$$.fragment,Vr),il=h(Vr),ua=r(Vr,"P",{});var Hp=d(ua);ll=s(Hp,"Base class for LEDEncoder\u2019s outputs, with potential hidden states, local and global attentions."),Hp.forEach(t),Vr.forEach(t),mr=h(o),Ct=r(o,"DIV",{class:!0});var Kr=d(Ct);k(_n.$$.fragment,Kr),cl=h(Kr),ma=r(Kr,"P",{});var Wp=d(ma);hl=s(Wp,`Base class for model encoder\u2019s outputs that also contains : pre-computed hidden states that can speed up sequential
decoding.`),Wp.forEach(t),Kr.forEach(t),fr=h(o),jt=r(o,"DIV",{class:!0});var Xr=d(jt);k(gn.$$.fragment,Xr),pl=h(Xr),fa=r(Xr,"P",{});var Rp=d(fa);ul=s(Rp,"Base class for sequence-to-sequence language models outputs."),Rp.forEach(t),Xr.forEach(t),_r=h(o),Pt=r(o,"DIV",{class:!0});var Jr=d(Pt);k(bn.$$.fragment,Jr),ml=h(Jr),_a=r(Jr,"P",{});var Up=d(_a);fl=s(Up,"Base class for outputs of sequence-to-sequence sentence classification models."),Up.forEach(t),Jr.forEach(t),gr=h(o),At=r(o,"DIV",{class:!0});var Zr=d(At);k(Tn.$$.fragment,Zr),_l=h(Zr),ga=r(Zr,"P",{});var Vp=d(ga);gl=s(Vp,"Base class for outputs of sequence-to-sequence question answering models."),Vp.forEach(t),Zr.forEach(t),br=h(o),Nt=r(o,"DIV",{class:!0});var Yr=d(Nt);k(vn.$$.fragment,Yr),bl=h(Yr),ba=r(Yr,"P",{});var Kp=d(ba);Tl=s(Kp,"Base class for Longformer\u2019s outputs, with potential hidden states, local and global attentions."),Kp.forEach(t),Yr.forEach(t),Tr=h(o),It=r(o,"DIV",{class:!0});var ed=d(It);k(kn.$$.fragment,ed),vl=h(ed),Ta=r(ed,"P",{});var Xp=d(Ta);kl=s(Xp,`Base class for model encoder\u2019s outputs that also contains : pre-computed hidden states that can speed up sequential
decoding.`),Xp.forEach(t),ed.forEach(t),vr=h(o),Bt=r(o,"DIV",{class:!0});var td=d(Bt);k(wn.$$.fragment,td),wl=h(td),va=r(td,"P",{});var Jp=d(va);yl=s(Jp,"Base class for sequence-to-sequence language models outputs."),Jp.forEach(t),td.forEach(t),kr=h(o),Gt=r(o,"H2",{class:!0});var od=d(Gt);po=r(od,"A",{id:!0,class:!0,href:!0});var Zp=d(po);ka=r(Zp,"SPAN",{});var Yp=d(ka);k(yn.$$.fragment,Yp),Yp.forEach(t),Zp.forEach(t),El=h(od),wa=r(od,"SPAN",{});var eu=d(wa);Ll=s(eu,"LEDModel"),eu.forEach(t),od.forEach(t),wr=h(o),Fe=r(o,"DIV",{class:!0});var Io=d(Fe);k(En.$$.fragment,Io),ql=h(Io),Ln=r(Io,"P",{});var nd=d(Ln);$l=s(nd,`The bare LED Model outputting raw hidden-states without any specific head on top.
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for general usage and behavior.`),sd.forEach(t),Ol=h(Io),Pe=r(Io,"DIV",{class:!0});var Bo=d(Pe);k(Dn.$$.fragment,Bo),Cl=h(Bo),Qt=r(Bo,"P",{});var Ps=d(Qt);jl=s(Ps,"The "),ws=r(Ps,"A",{href:!0});var nu=d(ws);Pl=s(nu,"LEDModel"),nu.forEach(t),Al=s(Ps," forward method, overrides the "),ya=r(Ps,"CODE",{});var su=d(ya);Nl=s(su,"__call__"),su.forEach(t),Il=s(Ps," special method."),Ps.forEach(t),Bl=h(Bo),k(uo.$$.fragment,Bo),Gl=h(Bo),k(mo.$$.fragment,Bo),Bo.forEach(t),Io.forEach(t),yr=h(o),Ht=r(o,"H2",{class:!0});var ad=d(Ht);fo=r(ad,"A",{id:!0,class:!0,href:!0});var au=d(fo);Ea=r(au,"SPAN",{});var ru=d(Ea);k(Fn.$$.fragment,ru),ru.forEach(t),au.forEach(t),Ql=h(ad),La=r(ad,"SPAN",{});var du=d(La);Hl=s(du,"LEDForConditionalGeneration"),du.forEach(t),ad.forEach(t),Er=h(o),ze=r(o,"DIV",{class:!0});var Go=d(ze);k(zn.$$.fragment,Go),Wl=h(Go),xn=r(Go,"P",{});var rd=d(xn);Rl=s(rd,`The LED Model with a language modeling head. Can be used for summarization.
This model inherits from `),ys=r(rd,"A",{href:!0});var iu=d(ys);Ul=s(iu,"PreTrainedModel"),iu.forEach(t),Vl=s(rd,`. See the superclass documentation for the generic methods the library
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for general usage and behavior.`),dd.forEach(t),Yl=h(Go),Te=r(Go,"DIV",{class:!0});var ft=d(Te);k(On.$$.fragment,ft),ec=h(ft),Wt=r(ft,"P",{});var As=d(Wt);tc=s(As,"The "),Es=r(As,"A",{href:!0});var cu=d(Es);oc=s(cu,"LEDForConditionalGeneration"),cu.forEach(t),nc=s(As," forward method, overrides the "),qa=r(As,"CODE",{});var hu=d(qa);sc=s(hu,"__call__"),hu.forEach(t),ac=s(As," special method."),As.forEach(t),rc=h(ft),k(_o.$$.fragment,ft),dc=h(ft),k(go.$$.fragment,ft),ic=h(ft),k(bo.$$.fragment,ft),ft.forEach(t),Go.forEach(t),Lr=h(o),Rt=r(o,"H2",{class:!0});var id=d(Rt);To=r(id,"A",{id:!0,class:!0,href:!0});var pu=d(To);$a=r(pu,"SPAN",{});var uu=d($a);k(Cn.$$.fragment,uu),uu.forEach(t),pu.forEach(t),lc=h(id),Da=r(id,"SPAN",{});var mu=d(Da);cc=s(mu,"LEDForSequenceClassification"),mu.forEach(t),id.forEach(t),qr=h(o),ce=r(o,"DIV",{class:!0});var _t=d(ce);k(jn.$$.fragment,_t),hc=h(_t),Fa=r(_t,"P",{});var fu=d(Fa);pc=s(fu,`LED model with a sequence classification/head on top (a linear layer on top of the pooled output) e.g. for GLUE
...
implements for all its models (such as downloading or saving, resizing the input embeddings, pruning heads etc.)`),ld.forEach(t),gc=h(_t),An=r(_t,"P",{});var cd=d(An);bc=s(cd,"This model is also a PyTorch "),Nn=r(cd,"A",{href:!0,rel:!0});var gu=d(Nn);Tc=s(gu,"torch.nn.Module"),gu.forEach(t),vc=s(cd,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for general usage and behavior.`),cd.forEach(t),kc=h(_t),U=r(_t,"DIV",{class:!0});var we=d(U);k(In.$$.fragment,we),wc=h(we),Ut=r(we,"P",{});var Ns=d(Ut);yc=s(Ns,"The "),qs=r(Ns,"A",{href:!0});var bu=d(qs);Ec=s(bu,"LEDForSequenceClassification"),bu.forEach(t),Lc=s(Ns," forward method, overrides the "),za=r(Ns,"CODE",{});var Tu=d(za);qc=s(Tu,"__call__"),Tu.forEach(t),$c=s(Ns," special method."),Ns.forEach(t),Dc=h(we),k(vo.$$.fragment,we),Fc=h(we),k(ko.$$.fragment,we),zc=h(we),k(wo.$$.fragment,we),xc=h(we),k(yo.$$.fragment,we),Sc=h(we),k(Eo.$$.fragment,we),we.forEach(t),_t.forEach(t),$r=h(o),Vt=r(o,"H2",{class:!0});var hd=d(Vt);Lo=r(hd,"A",{id:!0,class:!0,href:!0});var vu=d(Lo);xa=r(vu,"SPAN",{});var ku=d(xa);k(Bn.$$.fragment,ku),ku.forEach(t),vu.forEach(t),Mc=h(hd),Sa=r(hd,"SPAN",{});var wu=d(Sa);Oc=s(wu,"LEDForQuestionAnswering"),wu.forEach(t),hd.forEach(t),Dr=h(o),he=r(o,"DIV",{class:!0});var gt=d(he);k(Gn.$$.fragment,gt),Cc=h(gt),Kt=r(gt,"P",{});var Is=d(Kt);jc=s(Is,`LED Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear layer
...
implements for all its models (such as downloading or saving, resizing the input embeddings, pruning heads etc.)`),pd.forEach(t),Wc=h(gt),Hn=r(gt,"P",{});var ud=d(Hn);Rc=s(ud,"This model is also a PyTorch "),Wn=r(ud,"A",{href:!0,rel:!0});var qu=d(Wn);Uc=s(qu,"torch.nn.Module"),qu.forEach(t),Vc=s(ud,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for general usage and behavior.`),ud.forEach(t),Kc=h(gt),ve=r(gt,"DIV",{class:!0});var bt=d(ve);k(Rn.$$.fragment,bt),Xc=h(bt),Xt=r(bt,"P",{});var Bs=d(Xt);Jc=s(Bs,"The "),Ds=r(Bs,"A",{href:!0});var $u=d(Ds);Zc=s($u,"LEDForQuestionAnswering"),$u.forEach(t),Yc=s(Bs," forward method, overrides the "),Ca=r(Bs,"CODE",{});var Du=d(Ca);eh=s(Du,"__call__"),Du.forEach(t),th=s(Bs," special method."),Bs.forEach(t),oh=h(bt),k(qo.$$.fragment,bt),nh=h(bt),k($o.$$.fragment,bt),sh=h(bt),k(Do.$$.fragment,bt),bt.forEach(t),gt.forEach(t),Fr=h(o),Jt=r(o,"H2",{class:!0});var md=d(Jt);Fo=r(md,"A",{id:!0,class:!0,href:!0});var Fu=d(Fo);ja=r(Fu,"SPAN",{});var zu=d(ja);k(Un.$$.fragment,zu),zu.forEach(t),Fu.forEach(t),ah=h(md),Pa=r(md,"SPAN",{});var xu=d(Pa);rh=s(xu,"TFLEDModel"),xu.forEach(t),md.forEach(t),zr=h(o),pe=r(o,"DIV",{class:!0});var Tt=d(pe);k(Vn.$$.fragment,Tt),dh=h(Tt),Kn=r(Tt,"P",{});var fd=d(Kn);ih=s(fd,`The bare LED Model outputting raw hidden-states without any specific head on top.
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),_d.forEach(t),fh=h(Tt),k(zo.$$.fragment,Tt),_h=h(Tt),Ae=r(Tt,"DIV",{class:!0});var Qo=d(Ae);k(Zn.$$.fragment,Qo),gh=h(Qo),Zt=r(Qo,"P",{});var Gs=d(Zt);bh=s(Gs,"The "),zs=r(Gs,"A",{href:!0});var Ou=d(zs);Th=s(Ou,"TFLEDModel"),Ou.forEach(t),vh=s(Gs," forward method, overrides the "),Aa=r(Gs,"CODE",{});var Cu=d(Aa);kh=s(Cu,"__call__"),Cu.forEach(t),wh=s(Gs," special method."),Gs.forEach(t),yh=h(Qo),k(xo.$$.fragment,Qo),Eh=h(Qo),k(So.$$.fragment,Qo),Qo.forEach(t),Tt.forEach(t),xr=h(o),Yt=r(o,"H2",{class:!0});var gd=d(Yt);Mo=r(gd,"A",{id:!0,class:!0,href:!0});var ju=d(Mo);Na=r(ju,"SPAN",{});var Pu=d(Na);k(Yn.$$.fragment,Pu),Pu.forEach(t),ju.forEach(t),Lh=h(gd),Ia=r(gd,"SPAN",{});var Au=d(Ia);qh=s(Au,"TFLEDForConditionalGeneration"),Au.forEach(t),gd.forEach(t),Sr=h(o),ue=r(o,"DIV",{class:!0});var vt=d(ue);k(es.$$.fragment,vt),$h=h(vt),ts=r(vt,"P",{});var bd=d(ts);Dh=s(bd,`The LED Model with a language modeling head. Can be used for summarization.
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),bd.forEach(t),xh=h(vt),os=r(vt,"P",{});var Td=d(os);Sh=s(Td,"This model is also a "),ns=r(Td,"A",{href:!0,rel:!0});var Iu=d(ns);Mh=s(Iu,"tf.keras.Model"),Iu.forEach(t),Oh=s(Td,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Td.forEach(t),Ch=h(vt),k(Oo.$$.fragment,vt),jh=h(vt),Ne=r(vt,"DIV",{class:!0});var Ho=d(Ne);k(ss.$$.fragment,Ho),Ph=h(Ho),eo=r(Ho,"P",{});var Qs=d(eo);Ah=s(Qs,"The "),Ss=r(Qs,"A",{href:!0});var Bu=d(Ss);Nh=s(Bu,"TFLEDForConditionalGeneration"),Bu.forEach(t),Ih=s(Qs," forward method, overrides the "),Ba=r(Qs,"CODE",{});var Gu=d(Ba);Bh=s(Gu,"__call__"),Gu.forEach(t),Gh=s(Qs," special method."),Qs.forEach(t),Qh=h(Ho),k(Co.$$.fragment,Ho),Hh=h(Ho),k(jo.$$.fragment,Ho),Ho.forEach(t),vt.forEach(t),this.h()},h(){u(l,"name","hf:doc:metadata"),u(l,"content",JSON.stringify(fm)),u(f,"id","led"),u(f,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),u(f,"href","#led"),u(p,"class","relative group"),u(te,"id","overview"),u(te,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),u(te,"href","#overview"),u(j,"class","relative group"),u(se,"href","https://arxiv.org/abs/2004.05150"),u(se,"rel","nofollow"),u(fe,"href","/docs/transformers/main/en/model_doc/led#transformers.LEDForConditionalGeneration"),u(_e,"href","/docs/transformers/main/en/model_doc/bart#transformers.BartForConditionalGeneration"),u(ge,"href","/docs/transformers/main/en/model_doc/led#transformers.LEDTokenizer"),u(be,"href","/docs/transformers/main/en/model_doc/bart#transformers.BartTokenizer"),u(je,"href","/docs/transformers/main/en/model_doc/led#transformers.LEDTokenizer"),u(is,"href","/docs/transformers/main/en/model_doc/longformer#transformers.LongformerModel"),u(Uo,"href","https://colab.research.google.com/drive/12INTTR6n64TzS4RrXZxMSXfrOd9Xzamo?usp=sharing"),u(Uo,"rel","nofollow"),u(Ko,"href","https://colab.research.google.com/drive/12LjJazBl7Gam0XBPy_y0CTOJZeZ34c2v?usp=sharing"),u(Ko,"rel","nofollow"),u(Xo,"href","https://huggingface.co/patrickvonplaten"),u(Xo,"rel","nofollow"),u(oo,"id","transformers.LEDConfig"),u(oo,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),u(oo,"href","#transformers.LEDConfig"),u(Dt,"class","relative group"),u(ls,"href","/docs/transformers/main/en/model_doc/led#transformers.LEDModel"),u(Yo,"href","https://huggingface.co/allenai/led-base-16384"),u(Yo,"rel","nofollow"),u(cs,"href","/docs/transformers/main/en/main_classes/configuration#transformers.PretrainedConfig"),u(hs,"href","/docs/transformers/main/en/main_classes/configuration#transformers.PretrainedConfig"),u($e,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),u(so,"id","transformers.LEDTokenizer"),u(so,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),u(so,"href","#transformers.LEDTokenizer"),u(xt,"class","relative group"),u(ps,"href","/docs/transformers/main/en/model_doc/led#transformers.LEDTokenizer"),u(us,"href","/docs/transformers/main/en/model_doc/bart#transformers.BartTokenizer"),u(ms,"href","/docs/transformers/main/en/model_doc/bart#transformers.BartTokenizer"),u(ut,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),u(ro,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),u(io,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),u(gs,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),u(I,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),u(lo,"id","transformers.LEDTokenizerFast"),u(lo,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),u(lo,"href","#transformers.LEDTokenizerFast"),u(St,"class","relative group"),u(bs,"href","/docs/transformers/main/en/model_doc/led#transformers.LEDTokenizerFast"),u(Ts,"href","/docs/transformers/main/en/model_doc/bart#transformers.BartTokenizerFast"),u(vs,"href","/docs/transformers/main/en/model_doc/bart#transformers.BartTokenizerFast"),u(De,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),u(ho,"id","transformers.models.led.modeling_led.LEDEncoderBaseModelOutput"),u(ho,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),u(ho,"href","#transformers.models.led.modeling_led.LEDEncoderBaseModelOutput"),u(Mt,"class","relative group"),u(Ot,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),u(Ct,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),u(jt,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),u(Pt,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),u(At,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),u(Nt,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),u(It,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),u(Bt,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),u(po,"id","transformers.LEDModel"),u(po,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),u(po,"href","#transformers.LEDModel"),u(Gt,"class","relative group"),u(ks,"href","/docs/transformers/main/en/main_classes/model#transformers.PreTrainedModel"),u($n,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),u($n,"rel","nofollow"),u(ws,"href","/docs/transformers/main/en/model_doc/led#transformers.LEDModel"),u(Pe,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),u(Fe,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),u(fo,"id","transformers.LEDForConditionalGeneration"),u(fo,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),u(fo,"href","#transformers.LEDForConditionalGeneration"),u(Ht,"class","relative group"),u(ys,"href","/docs/transformers/main/en/main_classes/model#transformers.PreTrainedModel"),u(Mn,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),u(Mn,"rel","nofollow"),u(Es,"href","/docs/transformers/main/en/model_doc/led#transformers.LEDForConditionalGeneration"),u(Te,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),u(ze,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),u(To,"id","transformers.LEDForSequenceClassification"),u(To,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),u(To,"href","#transformers.LEDForSequenceClassification"),u(Rt,"class","relative group"),u(Ls,"href","/docs/transformers/main/en/main_classes/model#transformers.PreTrainedModel"),u(Nn,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),u(Nn,"rel","nofollow"),u(qs,"href","/docs/transformers/main/en/model_doc/led#transformers.LEDForSequenceClassification"),u(U,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),u(ce,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),u(Lo,"id","transformers.LEDForQuestionAnswering"),u(Lo,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),u(Lo,"href","#transformers.LEDForQuestionAnswering"),u(Vt,"class","relative group"),u($s,"href","/docs/transformers/main/en/main_classes/model#transformers.PreTrainedModel"),u(Wn,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),u(Wn,"rel","nofollow"),u(Ds,"href","/docs/transformers/main/en/model_doc/led#transformers.LEDForQuestionAnswering"),u(ve,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),u(he,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),u(Fo,"id","transformers.TFLEDModel"),u(Fo,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),u(Fo,"href","#transformers.TFLEDModel"),u(Jt,"class","relative group"),u(Fs,"href","/docs/transformers/main/en/main_classes/model#transformers.TFPreTrainedModel"),u(Jn,"href","https://www.tensorflow.org/api_docs/python/tf/keras/Model"),u(Jn,"rel","nofollow"),u(zs,"href","/docs/transformers/main/en/model_doc/led#transformers.TFLEDModel"),u(Ae,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),u(pe,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),u(Mo,"id","transformers.TFLEDForConditionalGeneration"),u(Mo,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),u(Mo,"href","#transformers.TFLEDForConditionalGeneration"),u(Yt,"class","relative group"),u(xs,"href","/docs/transformers/main/en/main_classes/model#transformers.TFPreTrainedModel"),u(ns,"href","https://www.tensorflow.org/api_docs/python/tf/keras/Model"),u(ns,"rel","nofollow"),u(Ss,"href","/docs/transformers/main/en/model_doc/led#transformers.TFLEDForConditionalGeneration"),u(Ne,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),u(ue,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8")},m(o,_){e(document.head,l),g(o,b,_),g(o,p,_),e(p,f),e(f,T),w(i,T,null),e(p,m),e(p,F),e(F,He),g(o,xe,_),g(o,j,_),e(j,te),e(te,ne),w(D,ne,null),e(j,We),e(j,K),e(K,Re),g(o,Se,_),g(o,B,_),e(B,Ue),e(B,se),e(se,ae),e(B,Ve),g(o,Me,_),g(o,W,_),e(W,Ke),g(o,Oe,_),g(o,R,_),e(R,ye),e(ye,Xe),g(o,me,_),g(o,M,_),e(M,P),g(o,Ce,_),g(o,x,_),e(x,C),e(C,fe),e(fe,re),e(C,Je),e(C,_e),e(_e,A),e(C,Ze),e(C,X),e(X,Ye),e(C,et),e(C,J),e(J,tt),e(C,ot),e(C,G),e(G,nt),e(C,de),e(C,ge),e(ge,Ee),e(C,N),e(C,be),e(be,Q),e(C,st),e(x,at),e(x,q),e(q,z),e(q,rt),e(rt,Le),e(q,kt),e(q,dt),e(dt,S),e(q,wt),e(x,yt),e(x,H),e(H,Et),e(H,it),e(it,Z),e(H,ie),e(H,lt),e(lt,Lt),e(H,le),e(H,je),e(je,qt),e(H,ct),e(H,ht),e(ht,qe),e(H,$t),e(x,vd),e(x,Y),e(Y,kd),e(Y,Hs),e(Hs,wd),e(Y,yd),e(Y,Ws),e(Ws,Ed),e(Y,Ld),e(Y,is),e(is,qd),e(Y,$d),e(Y,Rs),e(Rs,Dd),e(Y,Fd),e(Y,Us),e(Us,zd),e(Y,xd),e(Y,Vs),e(Vs,Sd),e(Y,Md),e(x,Od),e(x,pt),e(pt,Cd),e(pt,Ks),e(Ks,jd),e(pt,Pd),e(pt,Xs),e(Xs,Ad),e(pt,Nd),e(pt,Js),e(Js,Id),e(pt,Bd),e(x,Gd),e(x,Ro),e(Ro,Qd),e(Ro,Uo),e(Uo,Hd),e(Ro,Wd),e(x,Rd),e(x,Vo),e(Vo,Ud),e(Vo,Ko),e(Ko,Vd),e(Vo,Kd),g(o,ar,_),g(o,to,_),e(to,Xd),e(to,Xo),e(Xo,Jd),e(to,Zd),g(o,rr,_),g(o,Dt,_),e(Dt,oo),e(oo,Zs),w(Jo,Zs,null),e(Dt,Yd),e(Dt,Ys),e(Ys,ei),g(o,dr,_),g(o,$e,_),w(Zo,$e,null),e($e,ti),e($e,Ft),e(Ft,oi),e(Ft,ls),e(ls,ni),e(Ft,si),e(Ft,Yo),e(Yo,ai),e(Ft,ri),e($e,di),e($e,zt),e(zt,ii),e(zt,cs),e(cs,li),e(zt,ci),e(zt,hs),e(hs,hi),e(zt,pi),e($e,ui),w(no,$e,null),g(o,ir,_),g(o,xt,_),e(xt,so),e(so,ea),w(en,ea,null),e(xt,mi),e(xt,ta),e(ta,fi),g(o,lr,_),g(o,I,_),w(tn,I,null),e(I,_i),e(I,oa),e(oa,gi),e(I,bi),e(I,ao),e(ao,ps),e(ps,Ti),e(ao,vi),e(ao,us),e(us,ki),e(ao,wi),e(I,yi),e(I,on),e(on,Ei),e(on,ms),e(ms,Li),e(on,qi),e(I,$i),e(I,ut),w(nn,ut,null),e(ut,Di),e(ut,na),e(na,Fi),e(ut,zi),e(ut,sn),e(sn,fs),e(fs,xi),e(fs,sa),e(sa,Si),e(sn,Mi),e(sn,_s),e(_s,Oi),e(_s,aa),e(aa,Ci),e(I,ji),e(I,ro),w(an,ro,null),e(ro,Pi),e(ro,rn),e(rn,Ai),e(rn,ra),e(ra,Ni),e(rn,Ii),e(I,Bi),e(I,io),w(dn,io,null),e(io,Gi),e(io,da),e(da,Qi),e(I,Hi),e(I,gs),w(ln,gs,null),g(o,cr,_),g(o,St,_),e(St,lo),e(lo,ia),w(cn,ia,null),e(St,Wi),e(St,la),e(la,Ri),g(o,hr,_),g(o,De,_),w(hn,De,null),e(De,Ui),e(De,pn),e(pn,Vi),e(pn,ca),e(ca,Ki),e(pn,Xi),e(De,Ji),e(De,co),e(co,bs),e(bs,Zi),e(co,Yi),e(co,Ts),e(Ts,el),e(co,tl),e(De,ol),e(De,un),e(un,nl),e(un,vs),e(vs,sl),e(un,al),g(o,pr,_),g(o,Mt,_),e(Mt,ho),e(ho,ha),w(mn,ha,null),e(Mt,rl),e(Mt,pa),e(pa,dl),g(o,ur,_),g(o,Ot,_),w(fn,Ot,null),e(Ot,il),e(Ot,ua),e(ua,ll),g(o,mr,_),g(o,Ct,_),w(_n,Ct,null),e(Ct,cl),e(Ct,ma),e(ma,hl),g(o,fr,_),g(o,jt,_),w(gn,jt,null),e(jt,pl),e(jt,fa),e(fa,ul),g(o,_r,_),g(o,Pt,_),w(bn,Pt,null),e(Pt,ml),e(Pt,_a),e(_a,fl),g(o,gr,_),g(o,At,_),w(Tn,At,null),e(At,_l),e(At,ga),e(ga,gl),g(o,br,_),g(o,Nt,_),w(vn,Nt,null),e(Nt,bl),e(Nt,ba),e(ba,Tl),g(o,Tr,_),g(o,It,_),w(kn,It,null),e(It,vl),e(It,Ta),e(Ta,kl),g(o,vr,_),g(o,Bt,_),w(wn,Bt,null),e(Bt,wl),e(Bt,va),e(va,yl),g(o,kr,_),g(o,Gt,_),e(Gt,po),e(po,ka),w(yn,ka,null),e(Gt,El),e(Gt,wa),e(wa,Ll),g(o,wr,_),g(o,Fe,_),w(En,Fe,null),e(Fe,ql),e(Fe,Ln),e(Ln,$l),e(Ln,ks),e(ks,Dl),e(Ln,Fl),e(Fe,zl),e(Fe,qn),e(qn,xl),e(qn,$n),e($n,Sl),e(qn,Ml),e(Fe,Ol),e(Fe,Pe),w(Dn,Pe,null),e(Pe,Cl),e(Pe,Qt),e(Qt,jl),e(Qt,ws),e(ws,Pl),e(Qt,Al),e(Qt,ya),e(ya,Nl),e(Qt,Il),e(Pe,Bl),w(uo,Pe,null),e(Pe,Gl),w(mo,Pe,null),g(o,yr,_),g(o,Ht,_),e(Ht,fo),e(fo,Ea),w(Fn,Ea,null),e(Ht,Ql),e(Ht,La),e(La,Hl),g(o,Er,_),g(o,ze,_),w(zn,ze,null),e(ze,Wl),e(ze,xn),e(xn,Rl),e(xn,ys),e(ys,Ul),e(xn,Vl),e(ze,Kl),e(ze,Sn),e(Sn,Xl),e(Sn,Mn),e(Mn,Jl),e(Sn,Zl),e(ze,Yl),e(ze,Te),w(On,Te,null),e(Te,ec),e(Te,Wt),e(Wt,tc),e(Wt,Es),e(Es,oc),e(Wt,nc),e(Wt,qa),e(qa,sc),e(Wt,ac),e(Te,rc),w(_o,Te,null),e(Te,dc),w(go,Te,null),e(Te,ic),w(bo,Te,null),g(o,Lr,_),g(o,Rt,_),e(Rt,To),e(To,$a),w(Cn,$a,null),e(Rt,lc),e(Rt,Da),e(Da,cc),g(o,qr,_),g(o,ce,_),w(jn,ce,null),e(ce,hc),e(ce,Fa),e(Fa,pc),e(ce,uc),e(ce,Pn),e(Pn,mc),e(Pn,Ls),e(Ls,fc),e(Pn,_c),e(ce,gc),e(ce,An),e(An,bc),e(An,Nn),e(Nn,Tc),e(An,vc),e(ce,kc),e(ce,U),w(In,U,null),e(U,wc),e(U,Ut),e(Ut,yc),e(Ut,qs),e(qs,Ec),e(Ut,Lc),e(Ut,za),e(za,qc),e(Ut,$c),e(U,Dc),w(vo,U,null),e(U,Fc),w(ko,U,null),e(U,zc),w(wo,U,null),e(U,xc),w(yo,U,null),e(U,Sc),w(Eo,U,null),g(o,$r,_),g(o,Vt,_),e(Vt,Lo),e(Lo,xa),w(Bn,xa,null),e(Vt,Mc),e(Vt,Sa),e(Sa,Oc),g(o,Dr,_),g(o,he,_),w(Gn,he,null),e(he,Cc),e(he,Kt),e(Kt,jc),e(Kt,Ma),e(Ma,Pc),e(Kt,Ac),e(Kt,Oa),e(Oa,Nc),e(Kt,Ic),e(he,Bc),e(he,Qn),e(Qn,Gc),e(Qn,$s),e($s,Qc),e(Qn,Hc),e(he,Wc),e(he,Hn),e(Hn,Rc),e(Hn,Wn),e(Wn,Uc),e(Hn,Vc),e(he,Kc),e(he,ve),w(Rn,ve,null),e(ve,Xc),e(ve,Xt),e(Xt,Jc),e(Xt,Ds),e(Ds,Zc),e(Xt,Yc),e(Xt,Ca),e(Ca,eh),e(Xt,th),e(ve,oh),w(qo,ve,null),e(ve,nh),w($o,ve,null),e(ve,sh),w(Do,ve,null),g(o,Fr,_),g(o,Jt,_),e(Jt,Fo),e(Fo,ja),w(Un,ja,null),e(Jt,ah),e(Jt,Pa),e(Pa,rh),g(o,zr,_),g(o,pe,_),w(Vn,pe,null),e(pe,dh),e(pe,Kn),e(Kn,ih),e(Kn,Fs),e(Fs,lh),e(Kn,ch),e(pe,hh),e(pe,Xn),e(Xn,ph),e(Xn,Jn),e(Jn,uh),e(Xn,mh),e(pe,fh),w(zo,pe,null),e(pe,_h),e(pe,Ae),w(Zn,Ae,null),e(Ae,gh),e(Ae,Zt),e(Zt,bh),e(Zt,zs),e(zs,Th),e(Zt,vh),e(Zt,Aa),e(Aa,kh),e(Zt,wh),e(Ae,yh),w(xo,Ae,null),e(Ae,Eh),w(So,Ae,null),g(o,xr,_),g(o,Yt,_),e(Yt,Mo),e(Mo,Na),w(Yn,Na,null),e(Yt,Lh),e(Yt,Ia),e(Ia,qh),g(o,Sr,_),g(o,ue,_),w(es,ue,null),e(ue,$h),e(ue,ts),e(ts,Dh),e(ts,xs),e(xs,Fh),e(ts,zh),e(ue,xh),e(ue,os),e(os,Sh),e(os,ns),e(ns,Mh),e(os,Oh),e(ue,Ch),w(Oo,ue,null),e(ue,jh),e(ue,Ne),w(ss,Ne,null),e(Ne,Ph),e(Ne,eo),e(eo,Ah),e(eo,Ss),e(Ss,Nh),e(eo,Ih),e(eo,Ba),e(Ba,Bh),e(eo,Gh),e(Ne,Qh),w(Co,Ne,null),e(Ne,Hh),w(jo,Ne,null),Mr=!0},p(o,[_]){const as={};_&2&&(as.$$scope={dirty:_,ctx:o}),no.$set(as);const Ga={};_&2&&(Ga.$$scope={dirty:_,ctx:o}),uo.$set(Ga);const Qa={};_&2&&(Qa.$$scope={dirty:_,ctx:o}),mo.$set(Qa);const Ha={};_&2&&(Ha.$$scope={dirty:_,ctx:o}),_o.$set(Ha);const rs={};_&2&&(rs.$$scope={dirty:_,ctx:o}),go.$set(rs);const Wa={};_&2&&(Wa.$$scope={dirty:_,ctx:o}),bo.$set(Wa);const Ra={};_&2&&(Ra.$$scope={dirty:_,ctx:o}),vo.$set(Ra);const Ua={};_&2&&(Ua.$$scope={dirty:_,ctx:o}),ko.$set(Ua);const ds={};_&2&&(ds.$$scope={dirty:_,ctx:o}),wo.$set(ds);const Va={};_&2&&(Va.$$scope={dirty:_,ctx:o}),yo.$set(Va);const Ka={};_&2&&(Ka.$$scope={dirty:_,ctx:o}),Eo.$set(Ka);const Xa={};_&2&&(Xa.$$scope={dirty:_,ctx:o}),qo.$set(Xa);const Ja={};_&2&&(Ja.$$scope={dirty:_,ctx:o}),$o.$set(Ja);const Za={};_&2&&(Za.$$scope={dirty:_,ctx:o}),Do.$set(Za);const ee={};_&2&&(ee.$$scope={dirty:_,ctx:o}),zo.$set(ee);const V={};_&2&&(V.$$scope={dirty:_,ctx:o}),xo.$set(V);const Ya={};_&2&&(Ya.$$scope={dirty:_,ctx:o}),So.$set(Ya);const er={};_&2&&(er.$$scope={dirty:_,ctx:o}),Oo.$set(er);const tr={};_&2&&(tr.$$scope={dirty:_,ctx:o}),Co.$set(tr);const or={};_&2&&(or.$$scope={dirty:_,ctx:o}),jo.$set(or)},i(o){Mr||(y(i.$$.fragment,o),y(D.$$.fragment,o),y(Jo.$$.fragment,o),y(Zo.$$.fragment,o),y(no.$$.fragment,o),y(en.$$.fragment,o),y(tn.$$.fragment,o),y(nn.$$.fragment,o),y(an.$$.fragment,o),y(dn.$$.fragment,o),y(ln.$$.fragment,o),y(cn.$$.fragment,o),y(hn.$$.fragment,o),y(mn.$$.fragment,o),y(fn.$$.fragment,o),y(_n.$$.fragment,o),y(gn.$$.fragment,o),y(bn.$$.fragment,o),y(Tn.$$.fragment,o),y(vn.$$.fragment,o),y(kn.$$.fragment,o),y(wn.$$.fragment,o),y(yn.$$.fragment,o),y(En.$$.fragment,o),y(Dn.$$.fragment,o),y(uo.$$.fragment,o),y(mo.$$.fragment,o),y(Fn.$$.fragment,o),y(zn.$$.fragment,o),y(On.$$.fragment,o),y(_o.$$.fragment,o),y(go.$$.fragment,o),y(bo.$$.fragment,o),y(Cn.$$.fragment,o),y(jn.$$.fragment,o),y(In.$$.fragment,o),y(vo.$$.fragment,o),y(ko.$$.fragment,o),y(wo.$$.fragment,o),y(yo.$$.fragment,o),y(Eo.$$.fragment,o),y(Bn.$$.fragment,o),y(Gn.$$.fragment,o),y(Rn.$$.fragment,o),y(qo.$$.fragment,o),y($o.$$.fragment,o),y(Do.$$.fragment,o),y(Un.$$.fragment,o),y(Vn.$$.fragment,o),y(zo.$$.fragment,o),y(Zn.$$.fragment,o),y(xo.$$.fragment,o),y(So.$$.fragment,o),y(Yn.$$.fragment,o),y(es.$$.fragment,o),y(Oo.$$.fragment,o),y(ss.$$.fragment,o),y(Co.$$.fragment,o),y(jo.$$.fragment,o),Mr=!0)},o(o){E(i.$$.fragment,o),E(D.$$.fragment,o),E(Jo.$$.fragment,o),E(Zo.$$.fragment,o),E(no.$$.fragment,o),E(en.$$.fragment,o),E(tn.$$.fragment,o),E(nn.$$.fragment,o),E(an.$$.fragment,o),E(dn.$$.fragment,o),E(ln.$$.fragment,o),E(cn.$$.fragment,o),E(hn.$$.fragment,o),E(mn.$$.fragment,o),E(fn.$$.fragment,o),E(_n.$$.fragment,o),E(gn.$$.fragment,o),E(bn.$$.fragment,o),E(Tn.$$.fragment,o),E(vn.$$.fragment,o),E(kn.$$.fragment,o),E(wn.$$.fragment,o),E(yn.$$.fragment,o),E(En.$$.fragment,o),E(Dn.$$.fragment,o),E(uo.$$.fragment,o),E(mo.$$.fragment,o),E(Fn.$$.fragment,o),E(zn.$$.fragment,o),E(On.$$.fragment,o),E(_o.$$.fragment,o),E(go.$$.fragment,o),E(bo.$$.fragment,o),E(Cn.$$.fragment,o),E(jn.$$.fragment,o),E(In.$$.fragment,o),E(vo.$$.fragment,o),E(ko.$$.fragment,o),E(wo.$$.fragment,o),E(yo.$$.fragment,o),E(Eo.$$.fragment,o),E(Bn.$$.fragment,o),E(Gn.$$.fragment,o),E(Rn.$$.fragment,o),E(qo.$$.fragment,o),E($o.$$.fragment,o),E(Do.$$.fragment,o),E(Un.$$.fragment,o),E(Vn.$$.fragment,o),E(zo.$$.fragment,o),E(Zn.$$.fragment,o),E(xo.$$.fragment,o),E(So.$$.fragment,o),E(Yn.$$.fragment,o),E(es.$$.fragment,o),E(Oo.$$.fragment,o),E(ss.$$.fragment,o),E(Co.$$.fragment,o),E(jo.$$.fragment,o),Mr=!1},d(o){t(l),o&&t(b),o&&t(p),L(i),o&&t(xe),o&&t(j),L(D),o&&t(Se),o&&t(B),o&&t(Me),o&&t(W),o&&t(Oe),o&&t(R),o&&t(me),o&&t(M),o&&t(Ce),o&&t(x),o&&t(ar),o&&t(to),o&&t(rr),o&&t(Dt),L(Jo),o&&t(dr),o&&t($e),L(Zo),L(no),o&&t(ir),o&&t(xt),L(en),o&&t(lr),o&&t(I),L(tn),L(nn),L(an),L(dn),L(ln),o&&t(cr),o&&t(St),L(cn),o&&t(hr),o&&t(De),L(hn),o&&t(pr),o&&t(Mt),L(mn),o&&t(ur),o&&t(Ot),L(fn),o&&t(mr),o&&t(Ct),L(_n),o&&t(fr),o&&t(jt),L(gn),o&&t(_r),o&&t(Pt),L(bn),o&&t(gr),o&&t(At),L(Tn),o&&t(br),o&&t(Nt),L(vn),o&&t(Tr),o&&t(It),L(kn),o&&t(vr),o&&t(Bt),L(wn),o&&t(kr),o&&t(Gt),L(yn),o&&t(wr),o&&t(Fe),L(En),L(Dn),L(uo),L(mo),o&&t(yr),o&&t(Ht),L(Fn),o&&t(Er),o&&t(ze),L(zn),L(On),L(_o),L(go),L(bo),o&&t(Lr),o&&t(Rt),L(Cn),o&&t(qr),o&&t(ce),L(jn),L(In),L(vo),L(ko),L(wo),L(yo),L(Eo),o&&t($r),o&&t(Vt),L(Bn),o&&t(Dr),o&&t(he),L(Gn),L(Rn),L(qo),L($o),L(Do),o&&t(Fr),o&&t(Jt),L(Un),o&&t(zr),o&&t(pe),L(Vn),L(zo),L(Zn),L(xo),L(So),o&&t(xr),o&&t(Yt),L(Yn),o&&t(Sr),o&&t(ue),L(es),L(Oo),L(ss),L(Co),L(jo)}}}const fm={local:"led",sections:[{local:"overview",title:"Overview"},{local:"transformers.LEDConfig",title:"LEDConfig"},{local:"transformers.LEDTokenizer",title:"LEDTokenizer"},{local:"transformers.LEDTokenizerFast",title:"LEDTokenizerFast"},{local:"transformers.models.led.modeling_led.LEDEncoderBaseModelOutput",title:"LED specific outputs"},{local:"transformers.LEDModel",title:"LEDModel"},{local:"transformers.LEDForConditionalGeneration",title:"LEDForConditionalGeneration"},{local:"transformers.LEDForSequenceClassification",title:"LEDForSequenceClassification"},{local:"transformers.LEDForQuestionAnswering",title:"LEDForQuestionAnswering"},{local:"transformers.TFLEDModel",title:"TFLEDModel"},{local:"transformers.TFLEDForConditionalGeneration",title:"TFLEDForConditionalGeneration"}],title:"LED"};function _m($){return Uu(()=>{new URLSearchParams(window.location.search).get("fw")}),[]}class ym extends Qu{constructor(l){super();Hu(this,l,_m,mm,Wu,{})}}export{ym as default,fm as metadata};
