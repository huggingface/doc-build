import{S as Qu,i as Hu,s as Wu,e as a,k as c,w as v,t as n,M as Ru,c as r,d as t,m as h,a as d,x as k,h as s,b as u,G as e,g,y as w,q as y,o as E,B as L,v as Uu,L as Be}from"../../chunks/vendor-hf-doc-builder.js";import{T as Wo}from"../../chunks/Tip-hf-doc-builder.js";import{D as O}from"../../chunks/Docstring-hf-doc-builder.js";import{C as Qe}from"../../chunks/CodeBlock-hf-doc-builder.js";import{I as Ie}from"../../chunks/IconCopyLink-hf-doc-builder.js";import{E as Ge}from"../../chunks/ExampleCodeBlock-hf-doc-builder.js";function Vu($){let l,b,p,f,T;return f=new Qe({props:{code:`from transformers import LEDModel, LEDConfig
...
<span class="hljs-meta">&gt;&gt;&gt; </span>configuration = model.config`}}),{c(){l=a("p"),b=n("Example:"),p=c(),v(f.$$.fragment)},l(i){l=r(i,"P",{});var m=d(l);b=s(m,"Example:"),m.forEach(t),p=h(i),k(f.$$.fragment,i)},m(i,m){g(i,l,m),e(l,b),g(i,p,m),w(f,i,m),T=!0},p:Be,i(i){T||(y(f.$$.fragment,i),T=!0)},o(i){E(f.$$.fragment,i),T=!1},d(i){i&&t(l),i&&t(p),L(f,i)}}}function Ku($){let l,b,p,f,T;return{c(){l=a("p"),b=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),p=a("code"),f=n("Module"),T=n(`
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),{c(){l=a("p"),b=n("Example:"),p=c(),v(f.$$.fragment)},l(i){l=r(i,"P",{});var m=d(l);b=s(m,"Example:"),m.forEach(t),p=h(i),k(f.$$.fragment,i)},m(i,m){g(i,l,m),e(l,b),g(i,p,m),w(f,i,m),T=!0},p:Be,i(i){T||(y(f.$$.fragment,i),T=!0)},o(i){E(f.$$.fragment,i),T=!1},d(i){i&&t(l),i&&t(p),L(f,i)}}}function Ju($){let l,b,p,f,T;return{c(){l=a("p"),b=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),p=a("code"),f=n("Module"),T=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(i){l=r(i,"P",{});var m=d(l);b=s(m,"Although the recipe for forward pass needs to be defined within this function, one should call the "),p=r(m,"CODE",{});var F=d(p);f=s(F,"Module"),F.forEach(t),T=s(m,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-built_in">print</span>(tokenizer.decode(prediction, skip_special_tokens=<span class="hljs-literal">True</span>))`}}),{c(){l=a("p"),b=n("Conditional generation example:"),p=c(),v(f.$$.fragment)},l(i){l=r(i,"P",{});var m=d(l);b=s(m,"Conditional generation example:"),m.forEach(t),p=h(i),k(f.$$.fragment,i)},m(i,m){g(i,l,m),e(l,b),g(i,p,m),w(f,i,m),T=!0},p:Be,i(i){T||(y(f.$$.fragment,i),T=!0)},o(i){E(f.$$.fragment,i),T=!1},d(i){i&&t(l),i&&t(p),L(f,i)}}}function Yu($){let l,b,p,f,T;return f=new Qe({props:{code:`import torch
...
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-built_in">print</span>(tokenizer.decode(summary_ids[<span class="hljs-number">0</span>], skip_special_tokens=<span class="hljs-literal">True</span>, clean_up_tokenization_spaces=<span class="hljs-literal">True</span>))`}}),{c(){l=a("p"),b=n("Summarization example:"),p=c(),v(f.$$.fragment)},l(i){l=r(i,"P",{});var m=d(l);b=s(m,"Summarization example:"),m.forEach(t),p=h(i),k(f.$$.fragment,i)},m(i,m){g(i,l,m),e(l,b),g(i,p,m),w(f,i,m),T=!0},p:Be,i(i){T||(y(f.$$.fragment,i),T=!0)},o(i){E(f.$$.fragment,i),T=!1},d(i){i&&t(l),i&&t(p),L(f,i)}}}function em($){let l,b,p,f,T;return{c(){l=a("p"),b=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),p=a("code"),f=n("Module"),T=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(i){l=r(i,"P",{});var m=d(l);b=s(m,"Although the recipe for forward pass needs to be defined within this function, one should call the "),p=r(m,"CODE",{});var F=d(p);f=s(F,"Module"),F.forEach(t),T=s(m,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
`}}),{c(){l=a("p"),b=n("Example of single-label classification:"),p=c(),v(f.$$.fragment)},l(i){l=r(i,"P",{});var m=d(l);b=s(m,"Example of single-label classification:"),m.forEach(t),p=h(i),k(f.$$.fragment,i)},m(i,m){g(i,l,m),e(l,b),g(i,p,m),w(f,i,m),T=!0},p:Be,i(i){T||(y(f.$$.fragment,i),T=!0)},o(i){E(f.$$.fragment,i),T=!1},d(i){i&&t(l),i&&t(p),L(f,i)}}}function om($){let l,b;return l=new Qe({props:{code:`# To train a model on \`num_labels\` classes, you can pass \`num_labels=num_labels\` to \`.from_pretrained(...)\`
...
`}}),{c(){v(l.$$.fragment)},l(p){k(l.$$.fragment,p)},m(p,f){w(l,p,f),b=!0},p:Be,i(p){b||(y(l.$$.fragment,p),b=!0)},o(p){E(l.$$.fragment,p),b=!1},d(p){L(l,p)}}}function nm($){let l,b,p,f,T;return f=new Qe({props:{code:`import torch
from transformers import LEDTokenizer, LEDForSequenceClassification
...
<span class="hljs-meta">&gt;&gt;&gt; </span>predicted_class_id = logits.argmax().item()
<span class="hljs-meta">&gt;&gt;&gt; </span>model.config.id2label[predicted_class_id]
`}}),{c(){l=a("p"),b=n("Example of multi-label classification:"),p=c(),v(f.$$.fragment)},l(i){l=r(i,"P",{});var m=d(l);b=s(m,"Example of multi-label classification:"),m.forEach(t),p=h(i),k(f.$$.fragment,i)},m(i,m){g(i,l,m),e(l,b),g(i,p,m),w(f,i,m),T=!0},p:Be,i(i){T||(y(f.$$.fragment,i),T=!0)},o(i){E(f.$$.fragment,i),T=!1},d(i){i&&t(l),i&&t(p),L(f,i)}}}function sm($){let l,b;return l=new Qe({props:{code:`# To train a model on \`num_labels\` classes, you can pass \`num_labels=num_labels\` to \`.from_pretrained(...)\`
num_labels = len(model.config.id2label)
...
<span class="hljs-meta">... </span>)
<span class="hljs-meta">&gt;&gt;&gt; </span>loss = model(**inputs, labels=labels).loss
<span class="hljs-meta">&gt;&gt;&gt; </span>loss.backward()`}}),{c(){v(l.$$.fragment)},l(p){k(l.$$.fragment,p)},m(p,f){w(l,p,f),b=!0},p:Be,i(p){b||(y(l.$$.fragment,p),b=!0)},o(p){E(l.$$.fragment,p),b=!1},d(p){L(l,p)}}}function am($){let l,b,p,f,T;return{c(){l=a("p"),b=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),p=a("code"),f=n("Module"),T=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(i){l=r(i,"P",{});var m=d(l);b=s(m,"Although the recipe for forward pass needs to be defined within this function, one should call the "),p=r(m,"CODE",{});var F=d(p);f=s(F,"Module"),F.forEach(t),T=s(m,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
`}}),{c(){l=a("p"),b=n("Example:"),p=c(),v(f.$$.fragment)},l(i){l=r(i,"P",{});var m=d(l);b=s(m,"Example:"),m.forEach(t),p=h(i),k(f.$$.fragment,i)},m(i,m){g(i,l,m),e(l,b),g(i,p,m),w(f,i,m),T=!0},p:Be,i(i){T||(y(f.$$.fragment,i),T=!0)},o(i){E(f.$$.fragment,i),T=!1},d(i){i&&t(l),i&&t(p),L(f,i)}}}function dm($){let l,b;return l=new Qe({props:{code:`# target is "nice puppet"
...
pass your inputs and labels in any format that `),G=a("code"),Ue=n("model.fit()"),se=n(` supports! If, however, you want to use the second
...
pass your inputs and labels in any format that `),G=r(S,"CODE",{});var yt=d(G);Ue=s(yt,"model.fit()"),yt.forEach(t),se=s(S,` supports! If, however, you want to use the second
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),{c(){l=a("p"),b=n("Example:"),p=c(),v(f.$$.fragment)},l(i){l=r(i,"P",{});var m=d(l);b=s(m,"Example:"),m.forEach(t),p=h(i),k(f.$$.fragment,i)},m(i,m){g(i,l,m),e(l,b),g(i,p,m),w(f,i,m),T=!0},p:Be,i(i){T||(y(f.$$.fragment,i),T=!0)},o(i){E(f.$$.fragment,i),T=!1},d(i){i&&t(l),i&&t(p),L(f,i)}}}function hm($){let l,b,p,f,T,i,m,F,He,xe,j,te,ne,D,We,K,Re,Se,G,Ue,se,ae,Ve,Me,W,Ke,Oe,R,ye,Xe,me,M,P,Ce,x,C,fe,re,Je,_e,A,Ze,X,Ye,et,J,tt,ot,B,nt,de,ge,Ee,N,be,Q,st,at;return{c(){l=a("p"),b=n("TensorFlow models and layers in "),p=a("code"),f=n("transformers"),T=n(" accept two formats as input:"),i=c(),m=a("ul"),F=a("li"),He=n("having all inputs as keyword arguments (like PyTorch models), or"),xe=c(),j=a("li"),te=n("having all inputs as a list, tuple or dict in the first positional argument."),ne=c(),D=a("p"),We=n(`The reason the second format is supported is that Keras methods prefer this format when passing inputs to models
and layers. Because of this support, when using methods like `),K=a("code"),Re=n("model.fit()"),Se=n(` things should \u201Cjust work\u201D for you - just
pass your inputs and labels in any format that `),G=a("code"),Ue=n("model.fit()"),se=n(` supports! If, however, you want to use the second
format outside of Keras methods like `),ae=a("code"),Ve=n("fit()"),Me=n(" and "),W=a("code"),Ke=n("predict()"),Oe=n(`, such as when creating your own layers or models with
the Keras `),R=a("code"),ye=n("Functional"),Xe=n(` API, there are three possibilities you can use to gather all the input Tensors in the first
...
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-comment"># probs[5] is associated with the mask token</span>`}}),{c(){l=a("p"),b=n("Examples:"),p=c(),v(f.$$.fragment)},l(i){l=r(i,"P",{});var m=d(l);b=s(m,"Examples:"),m.forEach(t),p=h(i),k(f.$$.fragment,i)},m(i,m){g(i,l,m),e(l,b),g(i,p,m),w(f,i,m),T=!0},p:Be,i(i){T||(y(f.$$.fragment,i),T=!0)},o(i){E(f.$$.fragment,i),T=!1},d(i){i&&t(l),i&&t(p),L(f,i)}}}function mm($){let l,b,p,f,T,i,m,F,He,xe,j,te,ne,D,We,K,Re,Se,G,Ue,se,ae,Ve,Me,W,Ke,Oe,R,ye,Xe,me,M,P,Ce,x,C,fe,re,Je,_e,A,Ze,X,Ye,et,J,tt,ot,B,nt,de,ge,Ee,N,be,Q,st,at,q,z,rt,Le,kt,dt,S,wt,yt,H,Et,it,Z,ie,lt,Lt,le,je,qt,ct,ht,qe,$t,vd,Y,kd,Hs,wd,yd,Ws,Ed,Ld,is,qd,$d,Rs,Dd,Fd,Us,zd,xd,Vs,Sd,Md,Od,pt,Cd,Ks,jd,Pd,Xs,Ad,Nd,Js,Id,Gd,Bd,Ro,Qd,Uo,Hd,Wd,Rd,Vo,Ud,Ko,Vd,Kd,ar,to,Xd,Xo,Jd,Zd,rr,Dt,oo,Zs,Jo,Yd,Ys,ei,dr,$e,Zo,ti,Ft,oi,ls,ni,si,Yo,ai,ri,di,zt,ii,cs,li,ci,hs,hi,pi,ui,no,ir,xt,so,ea,en,mi,ta,fi,lr,I,tn,_i,oa,gi,bi,ao,ps,Ti,vi,us,ki,wi,yi,on,Ei,ms,Li,qi,$i,ut,nn,Di,na,Fi,zi,sn,fs,xi,sa,Si,Mi,_s,Oi,aa,Ci,ji,ro,an,Pi,rn,Ai,ra,Ni,Ii,Gi,io,dn,Bi,da,Qi,Hi,gs,ln,cr,St,lo,ia,cn,Wi,la,Ri,hr,De,hn,Ui,pn,Vi,ca,Ki,Xi,Ji,co,bs,Zi,Yi,Ts,el,tl,ol,un,nl,vs,sl,al,pr,Mt,ho,ha,mn,rl,pa,dl,ur,Ot,fn,il,ua,ll,mr,Ct,_n,cl,ma,hl,fr,jt,gn,pl,fa,ul,_r,Pt,bn,ml,_a,fl,gr,At,Tn,_l,ga,gl,br,Nt,vn,bl,ba,Tl,Tr,It,kn,vl,Ta,kl,vr,Gt,wn,wl,va,yl,kr,Bt,po,ka,yn,El,wa,Ll,wr,Fe,En,ql,Ln,$l,ks,Dl,Fl,zl,qn,xl,$n,Sl,Ml,Ol,Pe,Dn,Cl,Qt,jl,ws,Pl,Al,ya,Nl,Il,Gl,uo,Bl,mo,yr,Ht,fo,Ea,Fn,Ql,La,Hl,Er,ze,zn,Wl,xn,Rl,ys,Ul,Vl,Kl,Sn,Xl,Mn,Jl,Zl,Yl,Te,On,ec,Wt,tc,Es,oc,nc,qa,sc,ac,rc,_o,dc,go,ic,bo,Lr,Rt,To,$a,Cn,lc,Da,cc,qr,ce,jn,hc,Fa,pc,uc,Pn,mc,Ls,fc,_c,gc,An,bc,Nn,Tc,vc,kc,U,In,wc,Ut,yc,qs,Ec,Lc,za,qc,$c,Dc,vo,Fc,ko,zc,wo,xc,yo,Sc,Eo,$r,Vt,Lo,xa,Gn,Mc,Sa,Oc,Dr,he,Bn,Cc,Kt,jc,Ma,Pc,Ac,Oa,Nc,Ic,Gc,Qn,Bc,$s,Qc,Hc,Wc,Hn,Rc,Wn,Uc,Vc,Kc,ve,Rn,Xc,Xt,Jc,Ds,Zc,Yc,Ca,eh,th,oh,qo,nh,$o,sh,Do,Fr,Jt,Fo,ja,Un,ah,Pa,rh,zr,pe,Vn,dh,Kn,ih,Fs,lh,ch,hh,Xn,ph,Jn,uh,mh,fh,zo,_h,Ae,Zn,gh,Zt,bh,zs,Th,vh,Aa,kh,wh,yh,xo,Eh,So,xr,Yt,Mo,Na,Yn,Lh,Ia,qh,Sr,ue,es,$h,ts,Dh,xs,Fh,zh,xh,os,Sh,ns,Mh,Oh,Ch,Oo,jh,Ne,ss,Ph,eo,Ah,Ss,Nh,Ih,Ga,Gh,Bh,Qh,Co,Hh,jo,Mr;return i=new Ie({}),D=new Ie({}),Jo=new Ie({}),Zo=new O({props:{name:"class transformers.LEDConfig",anchor:"transformers.LEDConfig",parameters:[{name:"vocab_size",val:" = 50265"},{name:"max_encoder_position_embeddings",val:" = 16384"},{name:"max_decoder_position_embeddings",val:" = 1024"},{name:"encoder_layers",val:" = 12"},{name:"encoder_ffn_dim",val:" = 4096"},{name:"encoder_attention_heads",val:" = 16"},{name:"decoder_layers",val:" = 12"},{name:"decoder_ffn_dim",val:" = 4096"},{name:"decoder_attention_heads",val:" = 16"},{name:"encoder_layerdrop",val:" = 0.0"},{name:"decoder_layerdrop",val:" = 0.0"},{name:"use_cache",val:" = True"},{name:"is_encoder_decoder",val:" = True"},{name:"activation_function",val:" = 'gelu'"},{name:"d_model",val:" = 1024"},{name:"dropout",val:" = 0.1"},{name:"attention_dropout",val:" = 0.0"},{name:"activation_dropout",val:" = 0.0"},{name:"init_std",val:" = 0.02"},{name:"decoder_start_token_id",val:" = 2"},{name:"classifier_dropout",val:" = 0.0"},{name:"pad_token_id",val:" = 1"},{name:"bos_token_id",val:" = 0"},{name:"eos_token_id",val:" = 2"},{name:"attention_window",val:": typing.Union[typing.List[int], int] = 512"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.LEDConfig.vocab_size",description:`<strong>vocab_size</strong> (<code>int</code>, <em>optional</em>, defaults to 50265) &#x2014;
...
Whether or not the model should return the last key/values attentions (not used by all models)`,name:"use_cache"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/led/configuration_led.py#L31"}}),no=new Ge({props:{anchor:"transformers.LEDConfig.example",$$slots:{default:[Vu]},$$scope:{ctx:$}}}),en=new Ie({}),tn=new O({props:{name:"class transformers.LEDTokenizer",anchor:"transformers.LEDTokenizer",parameters:[{name:"vocab_file",val:""},{name:"merges_file",val:""},{name:"errors",val:" = 'replace'"},{name:"bos_token",val:" = '<s>'"},{name:"eos_token",val:" = '</s>'"},{name:"sep_token",val:" = '</s>'"},{name:"cls_token",val:" = '<s>'"},{name:"unk_token",val:" = '<unk>'"},{name:"pad_token",val:" = '<pad>'"},{name:"mask_token",val:" = '<mask>'"},{name:"add_prefix_space",val:" = False"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/led/tokenization_led.py#L43"}}),nn=new O({props:{name:"build_inputs_with_special_tokens",anchor:"transformers.LEDTokenizer.build_inputs_with_special_tokens",parameters:[{name:"token_ids_0",val:": typing.List[int]"},{name:"token_ids_1",val:": typing.Optional[typing.List[int]] = None"}],parametersDescription:[{anchor:"transformers.LEDTokenizer.build_inputs_with_special_tokens.token_ids_0",description:`<strong>token_ids_0</strong> (<code>List[int]</code>) &#x2014;
...
`}}),_o=new Wo({props:{$$slots:{default:[Ju]},$$scope:{ctx:$}}}),go=new Ge({props:{anchor:"transformers.LEDForConditionalGeneration.forward.example",$$slots:{default:[Zu]},$$scope:{ctx:$}}}),bo=new Ge({props:{anchor:"transformers.LEDForConditionalGeneration.forward.example-2",$$slots:{default:[Yu]},$$scope:{ctx:$}}}),Cn=new Ie({}),jn=new O({props:{name:"class transformers.LEDForSequenceClassification",anchor:"transformers.LEDForSequenceClassification",parameters:[{name:"config",val:": LEDConfig"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.LEDForSequenceClassification.config",description:`<strong>config</strong> (<a href="/docs/transformers/main/en/model_doc/led#transformers.LEDConfig">LEDConfig</a>) &#x2014;
Model configuration class with all the parameters of the model. Initializing with a config file does not
load the weights associated with the model, only the configuration. Check out the
...
`}}),vo=new Wo({props:{$$slots:{default:[em]},$$scope:{ctx:$}}}),ko=new Ge({props:{anchor:"transformers.LEDForSequenceClassification.forward.example",$$slots:{default:[tm]},$$scope:{ctx:$}}}),wo=new Ge({props:{anchor:"transformers.LEDForSequenceClassification.forward.example-2",$$slots:{default:[om]},$$scope:{ctx:$}}}),yo=new Ge({props:{anchor:"transformers.LEDForSequenceClassification.forward.example-3",$$slots:{default:[nm]},$$scope:{ctx:$}}}),Eo=new Ge({props:{anchor:"transformers.LEDForSequenceClassification.forward.example-4",$$slots:{default:[sm]},$$scope:{ctx:$}}}),Gn=new Ie({}),Bn=new O({props:{name:"class transformers.LEDForQuestionAnswering",anchor:"transformers.LEDForQuestionAnswering",parameters:[{name:"config",val:""}],parametersDescription:[{anchor:"transformers.LEDForQuestionAnswering.config",description:`<strong>config</strong> (<a href="/docs/transformers/main/en/model_doc/led#transformers.LEDConfig">LEDConfig</a>) &#x2014;
Model configuration class with all the parameters of the model. Initializing with a config file does not
load the weights associated with the model, only the configuration. Check out the
...
behaviors between training and evaluation).`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/led/modeling_tf_led.py#L2238",returnDescription:`
<p>A <a
...
`}}),xo=new Wo({props:{$$slots:{default:[lm]},$$scope:{ctx:$}}}),So=new Ge({props:{anchor:"transformers.TFLEDModel.call.example",$$slots:{default:[cm]},$$scope:{ctx:$}}}),Yn=new Ie({}),es=new O({props:{name:"class transformers.TFLEDForConditionalGeneration",anchor:"transformers.TFLEDForConditionalGeneration",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.TFLEDForConditionalGeneration.config",description:`<strong>config</strong> (<a href="/docs/transformers/main/en/model_doc/led#transformers.LEDConfig">LEDConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/main/en/main_classes/model#transformers.TFPreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/led/modeling_tf_led.py#L2332"}}),Oo=new Wo({props:{$$slots:{default:[hm]},$$scope:{ctx:$}}}),ss=new O({props:{name:"call",anchor:"transformers.TFLEDForConditionalGeneration.call",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"decoder_input_ids",val:" = None"},{name:"decoder_attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"decoder_head_mask",val:" = None"},{name:"encoder_outputs",val:": typing.Optional[transformers.models.led.modeling_tf_led.TFLEDEncoderBaseModelOutput] = None"},{name:"global_attention_mask",val:" = None"},{name:"past_key_values",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"decoder_inputs_embeds",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"},{name:"labels",val:" = None"},{name:"training",val:" = False"}],parametersDescription:[{anchor:"transformers.TFLEDForConditionalGeneration.call.input_ids",description:`<strong>input_ids</strong> (<code>tf.Tensor</code> of shape <code>({0})</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/main/en/model_doc/bert#transformers.BertTokenizer">BertTokenizer</a>. See <a href="/docs/transformers/main/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/main/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
Whether or not to use the model in training mode (some modules like dropout modules have different
behaviors between training and evaluation).`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/led/modeling_tf_led.py#L2368",returnDescription:`
<p>A <a
...
`}}),Co=new Wo({props:{$$slots:{default:[pm]},$$scope:{ctx:$}}}),jo=new Ge({props:{anchor:"transformers.TFLEDForConditionalGeneration.call.example",$$slots:{default:[um]},$$scope:{ctx:$}}}),{c(){l=a("meta"),b=c(),p=a("h1"),f=a("a"),T=a("span"),v(i.$$.fragment),m=c(),F=a("span"),He=n("LED"),xe=c(),j=a("h2"),te=a("a"),ne=a("span"),v(D.$$.fragment),We=c(),K=a("span"),Re=n("Overview"),Se=c(),G=a("p"),Ue=n("The LED model was proposed in "),se=a("a"),ae=n("Longformer: The Long-Document Transformer"),Ve=n(` by Iz
...
flag can be used to disable the caching mechanism to save memory.`),Bd=c(),Ro=a("li"),Qd=n("A notebook showing how to evaluate LED, can be accessed "),Uo=a("a"),Hd=n("here"),Wd=n("."),Rd=c(),Vo=a("li"),Ud=n("A notebook showing how to fine-tune LED, can be accessed "),Ko=a("a"),Vd=n("here"),Kd=n("."),ar=c(),to=a("p"),Xd=n("This model was contributed by "),Xo=a("a"),Jd=n("patrickvonplaten"),Zd=n("."),rr=c(),Dt=a("h2"),oo=a("a"),Zs=a("span"),v(Jo.$$.fragment),Yd=c(),Ys=a("span"),ei=n("LEDConfig"),dr=c(),$e=a("div"),v(Zo.$$.fragment),ti=c(),Ft=a("p"),oi=n("This is the configuration class to store the configuration of a "),ls=a("a"),ni=n("LEDModel"),si=n(`. It is used to instantiate an LED
...
special tokens using the tokenizer `),ra=a("code"),Ni=n("prepare_for_model"),Ii=n(" method."),Gi=c(),io=a("div"),v(dn.$$.fragment),Bi=c(),da=a("p"),Qi=n(`Create a mask from the two sequences passed to be used in a sequence-pair classification task. BART does not
...
decoding.`),vr=c(),Gt=a("div"),v(wn.$$.fragment),wl=c(),va=a("p"),yl=n("Base class for sequence-to-sequence language models outputs."),kr=c(),Bt=a("h2"),po=a("a"),ka=a("span"),v(yn.$$.fragment),El=c(),wa=a("span"),Ll=n("LEDModel"),wr=c(),Fe=a("div"),v(En.$$.fragment),ql=c(),Ln=a("p"),$l=n(`The bare LED Model outputting raw hidden-states without any specific head on top.
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for general usage and behavior.`),Ol=c(),Pe=a("div"),v(Dn.$$.fragment),Cl=c(),Qt=a("p"),jl=n("The "),ws=a("a"),Pl=n("LEDModel"),Al=n(" forward method, overrides the "),ya=a("code"),Nl=n("__call__"),Il=n(" special method."),Gl=c(),v(uo.$$.fragment),Bl=c(),v(mo.$$.fragment),yr=c(),Ht=a("h2"),fo=a("a"),Ea=a("span"),v(Fn.$$.fragment),Ql=c(),La=a("span"),Hl=n("LEDForConditionalGeneration"),Er=c(),ze=a("div"),v(zn.$$.fragment),Wl=c(),xn=a("p"),Rl=n(`The LED Model with a language modeling head. Can be used for summarization.
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for general usage and behavior.`),kc=c(),U=a("div"),v(In.$$.fragment),wc=c(),Ut=a("p"),yc=n("The "),qs=a("a"),Ec=n("LEDForSequenceClassification"),Lc=n(" forward method, overrides the "),za=a("code"),qc=n("__call__"),$c=n(" special method."),Dc=c(),v(vo.$$.fragment),Fc=c(),v(ko.$$.fragment),zc=c(),v(wo.$$.fragment),xc=c(),v(yo.$$.fragment),Sc=c(),v(Eo.$$.fragment),$r=c(),Vt=a("h2"),Lo=a("a"),xa=a("span"),v(Gn.$$.fragment),Mc=c(),Sa=a("span"),Oc=n("LEDForQuestionAnswering"),Dr=c(),he=a("div"),v(Bn.$$.fragment),Cc=c(),Kt=a("p"),jc=n(`LED Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear layer
on top of the hidden-states output to compute `),Ma=a("code"),Pc=n("span start logits"),Ac=n(" and "),Oa=a("code"),Nc=n("span end logits"),Ic=n(")."),Gc=c(),Qn=a("p"),Bc=n("This model inherits from "),$s=a("a"),Qc=n("PreTrainedModel"),Hc=n(`. See the superclass documentation for the generic methods the library
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Ch=c(),v(Oo.$$.fragment),jh=c(),Ne=a("div"),v(ss.$$.fragment),Ph=c(),eo=a("p"),Ah=n("The "),Ss=a("a"),Nh=n("TFLEDForConditionalGeneration"),Ih=n(" forward method, overrides the "),Ga=a("code"),Gh=n("__call__"),Bh=n(" special method."),Qh=c(),v(Co.$$.fragment),Hh=c(),v(jo.$$.fragment),this.h()},l(o){const _=Ru('[data-svelte="svelte-1phssyn"]',document.head);l=r(_,"META",{name:!0,content:!0}),_.forEach(t),b=h(o),p=r(o,"H1",{class:!0});var as=d(p);f=r(as,"A",{id:!0,class:!0,href:!0});var Ba=d(f);T=r(Ba,"SPAN",{});var Qa=d(T);k(i.$$.fragment,Qa),Qa.forEach(t),Ba.forEach(t),m=h(as),F=r(as,"SPAN",{});var Ha=d(F);He=s(Ha,"LED"),Ha.forEach(t),as.forEach(t),xe=h(o),j=r(o,"H2",{class:!0});var rs=d(j);te=r(rs,"A",{id:!0,class:!0,href:!0});var Wa=d(te);ne=r(Wa,"SPAN",{});var Ra=d(ne);k(D.$$.fragment,Ra),Ra.forEach(t),Wa.forEach(t),We=h(rs),K=r(rs,"SPAN",{});var Ua=d(K);Re=s(Ua,"Overview"),Ua.forEach(t),rs.forEach(t),Se=h(o),G=r(o,"P",{});var ds=d(G);Ue=s(ds,"The LED model was proposed in "),se=r(ds,"A",{href:!0,rel:!0});var Va=d(se);ae=s(Va,"Longformer: The Long-Document Transformer"),Va.forEach(t),Ve=s(ds,` by Iz
...
`),J=r(V,"EM",{});var or=d(J);tt=s(or,"Longformer"),or.forEach(t),ot=s(V,"\u2019s "),B=r(V,"EM",{});var Uh=d(B);nt=s(Uh,"chunked self-attention"),Uh.forEach(t),de=s(V," layer. "),ge=r(V,"A",{href:!0});var Vh=d(ge);Ee=s(Vh,"LEDTokenizer"),Vh.forEach(t),N=s(V,` is an alias of
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for general usage and behavior.`),sd.forEach(t),Ol=h(Io),Pe=r(Io,"DIV",{class:!0});var Go=d(Pe);k(Dn.$$.fragment,Go),Cl=h(Go),Qt=r(Go,"P",{});var Ps=d(Qt);jl=s(Ps,"The "),ws=r(Ps,"A",{href:!0});var nu=d(ws);Pl=s(nu,"LEDModel"),nu.forEach(t),Al=s(Ps," forward method, overrides the "),ya=r(Ps,"CODE",{});var su=d(ya);Nl=s(su,"__call__"),su.forEach(t),Il=s(Ps," special method."),Ps.forEach(t),Gl=h(Go),k(uo.$$.fragment,Go),Bl=h(Go),k(mo.$$.fragment,Go),Go.forEach(t),Io.forEach(t),yr=h(o),Ht=r(o,"H2",{class:!0});var ad=d(Ht);fo=r(ad,"A",{id:!0,class:!0,href:!0});var au=d(fo);Ea=r(au,"SPAN",{});var ru=d(Ea);k(Fn.$$.fragment,ru),ru.forEach(t),au.forEach(t),Ql=h(ad),La=r(ad,"SPAN",{});var du=d(La);Hl=s(du,"LEDForConditionalGeneration"),du.forEach(t),ad.forEach(t),Er=h(o),ze=r(o,"DIV",{class:!0});var Bo=d(ze);k(zn.$$.fragment,Bo),Wl=h(Bo),xn=r(Bo,"P",{});var rd=d(xn);Rl=s(rd,`The LED Model with a language modeling head. Can be used for summarization.
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for general usage and behavior.`),dd.forEach(t),Yl=h(Bo),Te=r(Bo,"DIV",{class:!0});var ft=d(Te);k(On.$$.fragment,ft),ec=h(ft),Wt=r(ft,"P",{});var As=d(Wt);tc=s(As,"The "),Es=r(As,"A",{href:!0});var cu=d(Es);oc=s(cu,"LEDForConditionalGeneration"),cu.forEach(t),nc=s(As," forward method, overrides the "),qa=r(As,"CODE",{});var hu=d(qa);sc=s(hu,"__call__"),hu.forEach(t),ac=s(As," special method."),As.forEach(t),rc=h(ft),k(_o.$$.fragment,ft),dc=h(ft),k(go.$$.fragment,ft),ic=h(ft),k(bo.$$.fragment,ft),ft.forEach(t),Bo.forEach(t),Lr=h(o),Rt=r(o,"H2",{class:!0});var id=d(Rt);To=r(id,"A",{id:!0,class:!0,href:!0});var pu=d(To);$a=r(pu,"SPAN",{});var uu=d($a);k(Cn.$$.fragment,uu),uu.forEach(t),pu.forEach(t),lc=h(id),Da=r(id,"SPAN",{});var mu=d(Da);cc=s(mu,"LEDForSequenceClassification"),mu.forEach(t),id.forEach(t),qr=h(o),ce=r(o,"DIV",{class:!0});var _t=d(ce);k(jn.$$.fragment,_t),hc=h(_t),Fa=r(_t,"P",{});var fu=d(Fa);pc=s(fu,`LED model with a sequence classification/head on top (a linear layer on top of the pooled output) e.g. for GLUE
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for general usage and behavior.`),cd.forEach(t),kc=h(_t),U=r(_t,"DIV",{class:!0});var we=d(U);k(In.$$.fragment,we),wc=h(we),Ut=r(we,"P",{});var Ns=d(Ut);yc=s(Ns,"The "),qs=r(Ns,"A",{href:!0});var bu=d(qs);Ec=s(bu,"LEDForSequenceClassification"),bu.forEach(t),Lc=s(Ns," forward method, overrides the "),za=r(Ns,"CODE",{});var Tu=d(za);qc=s(Tu,"__call__"),Tu.forEach(t),$c=s(Ns," special method."),Ns.forEach(t),Dc=h(we),k(vo.$$.fragment,we),Fc=h(we),k(ko.$$.fragment,we),zc=h(we),k(wo.$$.fragment,we),xc=h(we),k(yo.$$.fragment,we),Sc=h(we),k(Eo.$$.fragment,we),we.forEach(t),_t.forEach(t),$r=h(o),Vt=r(o,"H2",{class:!0});var hd=d(Vt);Lo=r(hd,"A",{id:!0,class:!0,href:!0});var vu=d(Lo);xa=r(vu,"SPAN",{});var ku=d(xa);k(Gn.$$.fragment,ku),ku.forEach(t),vu.forEach(t),Mc=h(hd),Sa=r(hd,"SPAN",{});var wu=d(Sa);Oc=s(wu,"LEDForQuestionAnswering"),wu.forEach(t),hd.forEach(t),Dr=h(o),he=r(o,"DIV",{class:!0});var gt=d(he);k(Bn.$$.fragment,gt),Cc=h(gt),Kt=r(gt,"P",{});var Is=d(Kt);jc=s(Is,`LED Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear layer
on top of the hidden-states output to compute `),Ma=r(Is,"CODE",{});var yu=d(Ma);Pc=s(yu,"span start logits"),yu.forEach(t),Ac=s(Is," and "),Oa=r(Is,"CODE",{});var Eu=d(Oa);Nc=s(Eu,"span end logits"),Eu.forEach(t),Ic=s(Is,")."),Is.forEach(t),Gc=h(gt),Qn=r(gt,"P",{});var pd=d(Qn);Bc=s(pd,"This model inherits from "),$s=r(pd,"A",{href:!0});var Lu=d($s);Qc=s(Lu,"PreTrainedModel"),Lu.forEach(t),Hc=s(pd,`. See the superclass documentation for the generic methods the library
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),_d.forEach(t),fh=h(Tt),k(zo.$$.fragment,Tt),_h=h(Tt),Ae=r(Tt,"DIV",{class:!0});var Qo=d(Ae);k(Zn.$$.fragment,Qo),gh=h(Qo),Zt=r(Qo,"P",{});var Bs=d(Zt);bh=s(Bs,"The "),zs=r(Bs,"A",{href:!0});var Ou=d(zs);Th=s(Ou,"TFLEDModel"),Ou.forEach(t),vh=s(Bs," forward method, overrides the "),Aa=r(Bs,"CODE",{});var Cu=d(Aa);kh=s(Cu,"__call__"),Cu.forEach(t),wh=s(Bs," special method."),Bs.forEach(t),yh=h(Qo),k(xo.$$.fragment,Qo),Eh=h(Qo),k(So.$$.fragment,Qo),Qo.forEach(t),Tt.forEach(t),xr=h(o),Yt=r(o,"H2",{class:!0});var gd=d(Yt);Mo=r(gd,"A",{id:!0,class:!0,href:!0});var ju=d(Mo);Na=r(ju,"SPAN",{});var Pu=d(Na);k(Yn.$$.fragment,Pu),Pu.forEach(t),ju.forEach(t),Lh=h(gd),Ia=r(gd,"SPAN",{});var Au=d(Ia);qh=s(Au,"TFLEDForConditionalGeneration"),Au.forEach(t),gd.forEach(t),Sr=h(o),ue=r(o,"DIV",{class:!0});var vt=d(ue);k(es.$$.fragment,vt),$h=h(vt),ts=r(vt,"P",{});var bd=d(ts);Dh=s(bd,`The LED Model with a language modeling head. Can be used for summarization.
