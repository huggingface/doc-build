import{S as Qu,i as Hu,s as Wu,e as a,k as c,w as k,t as n,M as Uu,c as r,d as t,m as h,a as d,x as v,h as s,b as u,G as e,g,y,q as w,o as E,B as L,v as Ru,L as Ge}from"../../chunks/vendor-hf-doc-builder.js";import{T as Wo}from"../../chunks/Tip-hf-doc-builder.js";import{D as O}from"../../chunks/Docstring-hf-doc-builder.js";import{C as Qe}from"../../chunks/CodeBlock-hf-doc-builder.js";import{I as Ie}from"../../chunks/IconCopyLink-hf-doc-builder.js";import{E as Be}from"../../chunks/ExampleCodeBlock-hf-doc-builder.js";function Vu($){let l,b,p,f,T;return f=new Qe({props:{code:`from transformers import LEDModel, LEDConfig
...
<span class="hljs-meta">&gt;&gt;&gt; </span>configuration = model.config`}}),{c(){l=a("p"),b=n("Example:"),p=c(),k(f.$$.fragment)},l(i){l=r(i,"P",{});var m=d(l);b=s(m,"Example:"),m.forEach(t),p=h(i),v(f.$$.fragment,i)},m(i,m){g(i,l,m),e(l,b),g(i,p,m),y(f,i,m),T=!0},p:Ge,i(i){T||(w(f.$$.fragment,i),T=!0)},o(i){E(f.$$.fragment,i),T=!1},d(i){i&&t(l),i&&t(p),L(f,i)}}}function Ku($){let l,b,p,f,T;return{c(){l=a("p"),b=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),p=a("code"),f=n("Module"),T=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(i){l=r(i,"P",{});var m=d(l);b=s(m,"Although the recipe for forward pass needs to be defined within this function, one should call the "),p=r(m,"CODE",{});var F=d(p);f=s(F,"Module"),F.forEach(t),T=s(m,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),m.forEach(t)},m(i,m){g(i,l,m),e(l,b),e(l,p),e(p,f),e(l,T)},d(i){i&&t(l)}}}function Xu($){let l,b,p,f,T;return f=new Qe({props:{code:`from transformers import LEDTokenizer, LEDModel
import torch
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),{c(){l=a("p"),b=n("Example:"),p=c(),k(f.$$.fragment)},l(i){l=r(i,"P",{});var m=d(l);b=s(m,"Example:"),m.forEach(t),p=h(i),v(f.$$.fragment,i)},m(i,m){g(i,l,m),e(l,b),g(i,p,m),y(f,i,m),T=!0},p:Ge,i(i){T||(w(f.$$.fragment,i),T=!0)},o(i){E(f.$$.fragment,i),T=!1},d(i){i&&t(l),i&&t(p),L(f,i)}}}function Ju($){let l,b,p,f,T;return{c(){l=a("p"),b=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),p=a("code"),f=n("Module"),T=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(i){l=r(i,"P",{});var m=d(l);b=s(m,"Although the recipe for forward pass needs to be defined within this function, one should call the "),p=r(m,"CODE",{});var F=d(p);f=s(F,"Module"),F.forEach(t),T=s(m,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),m.forEach(t)},m(i,m){g(i,l,m),e(l,b),e(l,p),e(p,f),e(l,T)},d(i){i&&t(l)}}}function Zu($){let l,b,p,f,T;return f=new Qe({props:{code:`from transformers import LEDTokenizer, LEDForConditionalGeneration
...
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-built_in">print</span>(tokenizer.decode(prediction, skip_special_tokens=<span class="hljs-literal">True</span>))`}}),{c(){l=a("p"),b=n("Conditional generation example:"),p=c(),k(f.$$.fragment)},l(i){l=r(i,"P",{});var m=d(l);b=s(m,"Conditional generation example:"),m.forEach(t),p=h(i),v(f.$$.fragment,i)},m(i,m){g(i,l,m),e(l,b),g(i,p,m),y(f,i,m),T=!0},p:Ge,i(i){T||(w(f.$$.fragment,i),T=!0)},o(i){E(f.$$.fragment,i),T=!1},d(i){i&&t(l),i&&t(p),L(f,i)}}}function Yu($){let l,b,p,f,T;return f=new Qe({props:{code:`import torch
...
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-built_in">print</span>(tokenizer.decode(summary_ids[<span class="hljs-number">0</span>], skip_special_tokens=<span class="hljs-literal">True</span>, clean_up_tokenization_spaces=<span class="hljs-literal">True</span>))`}}),{c(){l=a("p"),b=n("Summarization example:"),p=c(),k(f.$$.fragment)},l(i){l=r(i,"P",{});var m=d(l);b=s(m,"Summarization example:"),m.forEach(t),p=h(i),v(f.$$.fragment,i)},m(i,m){g(i,l,m),e(l,b),g(i,p,m),y(f,i,m),T=!0},p:Ge,i(i){T||(w(f.$$.fragment,i),T=!0)},o(i){E(f.$$.fragment,i),T=!1},d(i){i&&t(l),i&&t(p),L(f,i)}}}function em($){let l,b,p,f,T;return{c(){l=a("p"),b=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),p=a("code"),f=n("Module"),T=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(i){l=r(i,"P",{});var m=d(l);b=s(m,"Although the recipe for forward pass needs to be defined within this function, one should call the "),p=r(m,"CODE",{});var F=d(p);f=s(F,"Module"),F.forEach(t),T=s(m,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),m.forEach(t)},m(i,m){g(i,l,m),e(l,b),e(l,p),e(p,f),e(l,T)},d(i){i&&t(l)}}}function tm($){let l,b,p,f,T;return f=new Qe({props:{code:`import torch
...
`}}),{c(){l=a("p"),b=n("Example of single-label classification:"),p=c(),k(f.$$.fragment)},l(i){l=r(i,"P",{});var m=d(l);b=s(m,"Example of single-label classification:"),m.forEach(t),p=h(i),v(f.$$.fragment,i)},m(i,m){g(i,l,m),e(l,b),g(i,p,m),y(f,i,m),T=!0},p:Ge,i(i){T||(w(f.$$.fragment,i),T=!0)},o(i){E(f.$$.fragment,i),T=!1},d(i){i&&t(l),i&&t(p),L(f,i)}}}function om($){let l,b;return l=new Qe({props:{code:`# To train a model on \`num_labels\` classes, you can pass \`num_labels=num_labels\` to \`.from_pretrained(...)\`
...
`}}),{c(){k(l.$$.fragment)},l(p){v(l.$$.fragment,p)},m(p,f){y(l,p,f),b=!0},p:Ge,i(p){b||(w(l.$$.fragment,p),b=!0)},o(p){E(l.$$.fragment,p),b=!1},d(p){L(l,p)}}}function nm($){let l,b,p,f,T;return f=new Qe({props:{code:`import torch
from transformers import LEDTokenizer, LEDForSequenceClassification
...
<span class="hljs-meta">&gt;&gt;&gt; </span>predicted_class_id = logits.argmax().item()
<span class="hljs-meta">&gt;&gt;&gt; </span>model.config.id2label[predicted_class_id]
`}}),{c(){l=a("p"),b=n("Example of multi-label classification:"),p=c(),k(f.$$.fragment)},l(i){l=r(i,"P",{});var m=d(l);b=s(m,"Example of multi-label classification:"),m.forEach(t),p=h(i),v(f.$$.fragment,i)},m(i,m){g(i,l,m),e(l,b),g(i,p,m),y(f,i,m),T=!0},p:Ge,i(i){T||(w(f.$$.fragment,i),T=!0)},o(i){E(f.$$.fragment,i),T=!1},d(i){i&&t(l),i&&t(p),L(f,i)}}}function sm($){let l,b;return l=new Qe({props:{code:`# To train a model on \`num_labels\` classes, you can pass \`num_labels=num_labels\` to \`.from_pretrained(...)\`
num_labels = len(model.config.id2label)
...
<span class="hljs-meta">... </span>)
<span class="hljs-meta">&gt;&gt;&gt; </span>loss = model(**inputs, labels=labels).loss
<span class="hljs-meta">&gt;&gt;&gt; </span>loss.backward()`}}),{c(){k(l.$$.fragment)},l(p){v(l.$$.fragment,p)},m(p,f){y(l,p,f),b=!0},p:Ge,i(p){b||(w(l.$$.fragment,p),b=!0)},o(p){E(l.$$.fragment,p),b=!1},d(p){L(l,p)}}}function am($){let l,b,p,f,T;return{c(){l=a("p"),b=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),p=a("code"),f=n("Module"),T=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(i){l=r(i,"P",{});var m=d(l);b=s(m,"Although the recipe for forward pass needs to be defined within this function, one should call the "),p=r(m,"CODE",{});var F=d(p);f=s(F,"Module"),F.forEach(t),T=s(m,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),m.forEach(t)},m(i,m){g(i,l,m),e(l,b),e(l,p),e(p,f),e(l,T)},d(i){i&&t(l)}}}function rm($){let l,b,p,f,T;return f=new Qe({props:{code:`from transformers import LEDTokenizer, LEDForQuestionAnswering
import torch
...
`}}),{c(){l=a("p"),b=n("Example:"),p=c(),k(f.$$.fragment)},l(i){l=r(i,"P",{});var m=d(l);b=s(m,"Example:"),m.forEach(t),p=h(i),v(f.$$.fragment,i)},m(i,m){g(i,l,m),e(l,b),g(i,p,m),y(f,i,m),T=!0},p:Ge,i(i){T||(w(f.$$.fragment,i),T=!0)},o(i){E(f.$$.fragment,i),T=!1},d(i){i&&t(l),i&&t(p),L(f,i)}}}function dm($){let l,b;return l=new Qe({props:{code:`# target is "nice puppet"
...
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-built_in">round</span>(loss.item(), <span class="hljs-number">2</span>)
`}}),{c(){k(l.$$.fragment)},l(p){v(l.$$.fragment,p)},m(p,f){y(l,p,f),b=!0},p:Ge,i(p){b||(w(l.$$.fragment,p),b=!0)},o(p){E(l.$$.fragment,p),b=!1},d(p){L(l,p)}}}function im($){let l,b,p,f,T,i,m,F,He,xe,j,te,ne,D,We,K,Ue,Se,B,Re,se,ae,Ve,Me,W,Ke,Oe,U,we,Xe,me,M,P,Ce,x,C,fe,re,Je,_e,A,Ze,X,Ye,et,J,tt,ot,G,nt,de,ge,Ee,N,be,Q,st,at;return{c(){l=a("p"),b=n("TensorFlow models and layers in "),p=a("code"),f=n("transformers"),T=n(" accept two formats as input:"),i=c(),m=a("ul"),F=a("li"),He=n("having all inputs as keyword arguments (like PyTorch models), or"),xe=c(),j=a("li"),te=n("having all inputs as a list, tuple or dict in the first positional argument."),ne=c(),D=a("p"),We=n(`The reason the second format is supported is that Keras methods prefer this format when passing inputs to models
and layers. Because of this support, when using methods like `),K=a("code"),Ue=n("model.fit()"),Se=n(` things should \u201Cjust work\u201D for you - just
pass your inputs and labels in any format that `),B=a("code"),Re=n("model.fit()"),se=n(` supports! If, however, you want to use the second
format outside of Keras methods like `),ae=a("code"),Ve=n("fit()"),Me=n(" and "),W=a("code"),Ke=n("predict()"),Oe=n(`, such as when creating your own layers or models with
the Keras `),U=a("code"),we=n("Functional"),Xe=n(` API, there are three possibilities you can use to gather all the input Tensors in the first
positional argument:`),me=c(),M=a("ul"),P=a("li"),Ce=n("a single Tensor with "),x=a("code"),C=n("input_ids"),fe=n(" only and nothing else: "),re=a("code"),Je=n("model(input_ids)"),_e=c(),A=a("li"),Ze=n(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),X=a("code"),Ye=n("model([input_ids, attention_mask])"),et=n(" or "),J=a("code"),tt=n("model([input_ids, attention_mask, token_type_ids])"),ot=c(),G=a("li"),nt=n(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),de=a("code"),ge=n('model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),Ee=c(),N=a("p"),be=n(`Note that when creating models and layers with
`),Q=a("a"),st=n("subclassing"),at=n(` then you don\u2019t need to worry
about any of this, as you can just pass inputs like you would to any other Python function!`),this.h()},l(q){l=r(q,"P",{});var z=d(l);b=s(z,"TensorFlow models and layers in "),p=r(z,"CODE",{});var rt=d(p);f=s(rt,"transformers"),rt.forEach(t),T=s(z," accept two formats as input:"),z.forEach(t),i=h(q),m=r(q,"UL",{});var Le=d(m);F=r(Le,"LI",{});var vt=d(F);He=s(vt,"having all inputs as keyword arguments (like PyTorch models), or"),vt.forEach(t),xe=h(Le),j=r(Le,"LI",{});var dt=d(j);te=s(dt,"having all inputs as a list, tuple or dict in the first positional argument."),dt.forEach(t),Le.forEach(t),ne=h(q),D=r(q,"P",{});var S=d(D);We=s(S,`The reason the second format is supported is that Keras methods prefer this format when passing inputs to models
and layers. Because of this support, when using methods like `),K=r(S,"CODE",{});var yt=d(K);Ue=s(yt,"model.fit()"),yt.forEach(t),Se=s(S,` things should \u201Cjust work\u201D for you - just
pass your inputs and labels in any format that `),B=r(S,"CODE",{});var wt=d(B);Re=s(wt,"model.fit()"),wt.forEach(t),se=s(S,` supports! If, however, you want to use the second
format outside of Keras methods like `),ae=r(S,"CODE",{});var H=d(ae);Ve=s(H,"fit()"),H.forEach(t),Me=s(S," and "),W=r(S,"CODE",{});var Et=d(W);Ke=s(Et,"predict()"),Et.forEach(t),Oe=s(S,`, such as when creating your own layers or models with
the Keras `),U=r(S,"CODE",{});var it=d(U);we=s(it,"Functional"),it.forEach(t),Xe=s(S,` API, there are three possibilities you can use to gather all the input Tensors in the first
positional argument:`),S.forEach(t),me=h(q),M=r(q,"UL",{});var Z=d(M);P=r(Z,"LI",{});var ie=d(P);Ce=s(ie,"a single Tensor with "),x=r(ie,"CODE",{});var lt=d(x);C=s(lt,"input_ids"),lt.forEach(t),fe=s(ie," only and nothing else: "),re=r(ie,"CODE",{});var Lt=d(re);Je=s(Lt,"model(input_ids)"),Lt.forEach(t),ie.forEach(t),_e=h(Z),A=r(Z,"LI",{});var le=d(A);Ze=s(le,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),X=r(le,"CODE",{});var je=d(X);Ye=s(je,"model([input_ids, attention_mask])"),je.forEach(t),et=s(le," or "),J=r(le,"CODE",{});var qt=d(J);tt=s(qt,"model([input_ids, attention_mask, token_type_ids])"),qt.forEach(t),le.forEach(t),ot=h(Z),G=r(Z,"LI",{});var ct=d(G);nt=s(ct,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),de=r(ct,"CODE",{});var ht=d(de);ge=s(ht,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),ht.forEach(t),ct.forEach(t),Z.forEach(t),Ee=h(q),N=r(q,"P",{});var qe=d(N);be=s(qe,`Note that when creating models and layers with
`),Q=r(qe,"A",{href:!0,rel:!0});var $t=d(Q);st=s($t,"subclassing"),$t.forEach(t),at=s(qe,` then you don\u2019t need to worry
about any of this, as you can just pass inputs like you would to any other Python function!`),qe.forEach(t),this.h()},h(){u(Q,"href","https://keras.io/guides/making_new_layers_and_models_via_subclassing/"),u(Q,"rel","nofollow")},m(q,z){g(q,l,z),e(l,b),e(l,p),e(p,f),e(l,T),g(q,i,z),g(q,m,z),e(m,F),e(F,He),e(m,xe),e(m,j),e(j,te),g(q,ne,z),g(q,D,z),e(D,We),e(D,K),e(K,Ue),e(D,Se),e(D,B),e(B,Re),e(D,se),e(D,ae),e(ae,Ve),e(D,Me),e(D,W),e(W,Ke),e(D,Oe),e(D,U),e(U,we),e(D,Xe),g(q,me,z),g(q,M,z),e(M,P),e(P,Ce),e(P,x),e(x,C),e(P,fe),e(P,re),e(re,Je),e(M,_e),e(M,A),e(A,Ze),e(A,X),e(X,Ye),e(A,et),e(A,J),e(J,tt),e(M,ot),e(M,G),e(G,nt),e(G,de),e(de,ge),g(q,Ee,z),g(q,N,z),e(N,be),e(N,Q),e(Q,st),e(N,at)},d(q){q&&t(l),q&&t(i),q&&t(m),q&&t(ne),q&&t(D),q&&t(me),q&&t(M),q&&t(Ee),q&&t(N)}}}function lm($){let l,b,p,f,T;return{c(){l=a("p"),b=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),p=a("code"),f=n("Module"),T=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(i){l=r(i,"P",{});var m=d(l);b=s(m,"Although the recipe for forward pass needs to be defined within this function, one should call the "),p=r(m,"CODE",{});var F=d(p);f=s(F,"Module"),F.forEach(t),T=s(m,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),m.forEach(t)},m(i,m){g(i,l,m),e(l,b),e(l,p),e(p,f),e(l,T)},d(i){i&&t(l)}}}function cm($){let l,b,p,f,T;return f=new Qe({props:{code:`from transformers import LEDTokenizer, TFLEDModel
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),{c(){l=a("p"),b=n("Example:"),p=c(),k(f.$$.fragment)},l(i){l=r(i,"P",{});var m=d(l);b=s(m,"Example:"),m.forEach(t),p=h(i),v(f.$$.fragment,i)},m(i,m){g(i,l,m),e(l,b),g(i,p,m),y(f,i,m),T=!0},p:Ge,i(i){T||(w(f.$$.fragment,i),T=!0)},o(i){E(f.$$.fragment,i),T=!1},d(i){i&&t(l),i&&t(p),L(f,i)}}}function hm($){let l,b,p,f,T,i,m,F,He,xe,j,te,ne,D,We,K,Ue,Se,B,Re,se,ae,Ve,Me,W,Ke,Oe,U,we,Xe,me,M,P,Ce,x,C,fe,re,Je,_e,A,Ze,X,Ye,et,J,tt,ot,G,nt,de,ge,Ee,N,be,Q,st,at;return{c(){l=a("p"),b=n("TensorFlow models and layers in "),p=a("code"),f=n("transformers"),T=n(" accept two formats as input:"),i=c(),m=a("ul"),F=a("li"),He=n("having all inputs as keyword arguments (like PyTorch models), or"),xe=c(),j=a("li"),te=n("having all inputs as a list, tuple or dict in the first positional argument."),ne=c(),D=a("p"),We=n(`The reason the second format is supported is that Keras methods prefer this format when passing inputs to models
and layers. Because of this support, when using methods like `),K=a("code"),Ue=n("model.fit()"),Se=n(` things should \u201Cjust work\u201D for you - just
pass your inputs and labels in any format that `),B=a("code"),Re=n("model.fit()"),se=n(` supports! If, however, you want to use the second
format outside of Keras methods like `),ae=a("code"),Ve=n("fit()"),Me=n(" and "),W=a("code"),Ke=n("predict()"),Oe=n(`, such as when creating your own layers or models with
the Keras `),U=a("code"),we=n("Functional"),Xe=n(` API, there are three possibilities you can use to gather all the input Tensors in the first
...
`),de=r(ct,"CODE",{});var ht=d(de);ge=s(ht,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),ht.forEach(t),ct.forEach(t),Z.forEach(t),Ee=h(q),N=r(q,"P",{});var qe=d(N);be=s(qe,`Note that when creating models and layers with
`),Q=r(qe,"A",{href:!0,rel:!0});var $t=d(Q);st=s($t,"subclassing"),$t.forEach(t),at=s(qe,` then you don\u2019t need to worry
about any of this, as you can just pass inputs like you would to any other Python function!`),qe.forEach(t),this.h()},h(){u(Q,"href","https://keras.io/guides/making_new_layers_and_models_via_subclassing/"),u(Q,"rel","nofollow")},m(q,z){g(q,l,z),e(l,b),e(l,p),e(p,f),e(l,T),g(q,i,z),g(q,m,z),e(m,F),e(F,He),e(m,xe),e(m,j),e(j,te),g(q,ne,z),g(q,D,z),e(D,We),e(D,K),e(K,Ue),e(D,Se),e(D,B),e(B,Re),e(D,se),e(D,ae),e(ae,Ve),e(D,Me),e(D,W),e(W,Ke),e(D,Oe),e(D,U),e(U,we),e(D,Xe),g(q,me,z),g(q,M,z),e(M,P),e(P,Ce),e(P,x),e(x,C),e(P,fe),e(P,re),e(re,Je),e(M,_e),e(M,A),e(A,Ze),e(A,X),e(X,Ye),e(A,et),e(A,J),e(J,tt),e(M,ot),e(M,G),e(G,nt),e(G,de),e(de,ge),g(q,Ee,z),g(q,N,z),e(N,be),e(N,Q),e(Q,st),e(N,at)},d(q){q&&t(l),q&&t(i),q&&t(m),q&&t(ne),q&&t(D),q&&t(me),q&&t(M),q&&t(Ee),q&&t(N)}}}function pm($){let l,b,p,f,T;return{c(){l=a("p"),b=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),p=a("code"),f=n("Module"),T=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(i){l=r(i,"P",{});var m=d(l);b=s(m,"Although the recipe for forward pass needs to be defined within this function, one should call the "),p=r(m,"CODE",{});var F=d(p);f=s(F,"Module"),F.forEach(t),T=s(m,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),m.forEach(t)},m(i,m){g(i,l,m),e(l,b),e(l,p),e(p,f),e(l,T)},d(i){i&&t(l)}}}function um($){let l,b,p,f,T;return f=new Qe({props:{code:`from transformers import LEDTokenizer, TFLEDForConditionalGeneration
import tensorflow as tf
...
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-comment"># probs[5] is associated with the mask token</span>`}}),{c(){l=a("p"),b=n("Examples:"),p=c(),k(f.$$.fragment)},l(i){l=r(i,"P",{});var m=d(l);b=s(m,"Examples:"),m.forEach(t),p=h(i),v(f.$$.fragment,i)},m(i,m){g(i,l,m),e(l,b),g(i,p,m),y(f,i,m),T=!0},p:Ge,i(i){T||(w(f.$$.fragment,i),T=!0)},o(i){E(f.$$.fragment,i),T=!1},d(i){i&&t(l),i&&t(p),L(f,i)}}}function mm($){let l,b,p,f,T,i,m,F,He,xe,j,te,ne,D,We,K,Ue,Se,B,Re,se,ae,Ve,Me,W,Ke,Oe,U,we,Xe,me,M,P,Ce,x,C,fe,re,Je,_e,A,Ze,X,Ye,et,J,tt,ot,G,nt,de,ge,Ee,N,be,Q,st,at,q,z,rt,Le,vt,dt,S,yt,wt,H,Et,it,Z,ie,lt,Lt,le,je,qt,ct,ht,qe,$t,kd,Y,vd,Hs,yd,wd,Ws,Ed,Ld,is,qd,$d,Us,Dd,Fd,Rs,zd,xd,Vs,Sd,Md,Od,pt,Cd,Ks,jd,Pd,Xs,Ad,Nd,Js,Id,Bd,Gd,Uo,Qd,Ro,Hd,Wd,Ud,Vo,Rd,Ko,Vd,Kd,ar,to,Xd,Xo,Jd,Zd,rr,Dt,oo,Zs,Jo,Yd,Ys,ei,dr,$e,Zo,ti,Ft,oi,ls,ni,si,Yo,ai,ri,di,zt,ii,cs,li,ci,hs,hi,pi,ui,no,ir,xt,so,ea,en,mi,ta,fi,lr,I,tn,_i,oa,gi,bi,ao,ps,Ti,ki,us,vi,yi,wi,on,Ei,ms,Li,qi,$i,ut,nn,Di,na,Fi,zi,sn,fs,xi,sa,Si,Mi,_s,Oi,aa,Ci,ji,ro,an,Pi,rn,Ai,ra,Ni,Ii,Bi,io,dn,Gi,da,Qi,Hi,gs,ln,cr,St,lo,ia,cn,Wi,la,Ui,hr,De,hn,Ri,pn,Vi,ca,Ki,Xi,Ji,co,bs,Zi,Yi,Ts,el,tl,ol,un,nl,ks,sl,al,pr,Mt,ho,ha,mn,rl,pa,dl,ur,Ot,fn,il,ua,ll,mr,Ct,_n,cl,ma,hl,fr,jt,gn,pl,fa,ul,_r,Pt,bn,ml,_a,fl,gr,At,Tn,_l,ga,gl,br,Nt,kn,bl,ba,Tl,Tr,It,vn,kl,Ta,vl,kr,Bt,yn,yl,ka,wl,vr,Gt,po,va,wn,El,ya,Ll,yr,Fe,En,ql,Ln,$l,vs,Dl,Fl,zl,qn,xl,$n,Sl,Ml,Ol,Pe,Dn,Cl,Qt,jl,ys,Pl,Al,wa,Nl,Il,Bl,uo,Gl,mo,wr,Ht,fo,Ea,Fn,Ql,La,Hl,Er,ze,zn,Wl,xn,Ul,ws,Rl,Vl,Kl,Sn,Xl,Mn,Jl,Zl,Yl,Te,On,ec,Wt,tc,Es,oc,nc,qa,sc,ac,rc,_o,dc,go,ic,bo,Lr,Ut,To,$a,Cn,lc,Da,cc,qr,ce,jn,hc,Fa,pc,uc,Pn,mc,Ls,fc,_c,gc,An,bc,Nn,Tc,kc,vc,R,In,yc,Rt,wc,qs,Ec,Lc,za,qc,$c,Dc,ko,Fc,vo,zc,yo,xc,wo,Sc,Eo,$r,Vt,Lo,xa,Bn,Mc,Sa,Oc,Dr,he,Gn,Cc,Kt,jc,Ma,Pc,Ac,Oa,Nc,Ic,Bc,Qn,Gc,$s,Qc,Hc,Wc,Hn,Uc,Wn,Rc,Vc,Kc,ke,Un,Xc,Xt,Jc,Ds,Zc,Yc,Ca,eh,th,oh,qo,nh,$o,sh,Do,Fr,Jt,Fo,ja,Rn,ah,Pa,rh,zr,pe,Vn,dh,Kn,ih,Fs,lh,ch,hh,Xn,ph,Jn,uh,mh,fh,zo,_h,Ae,Zn,gh,Zt,bh,zs,Th,kh,Aa,vh,yh,wh,xo,Eh,So,xr,Yt,Mo,Na,Yn,Lh,Ia,qh,Sr,ue,es,$h,ts,Dh,xs,Fh,zh,xh,os,Sh,ns,Mh,Oh,Ch,Oo,jh,Ne,ss,Ph,eo,Ah,Ss,Nh,Ih,Ba,Bh,Gh,Qh,Co,Hh,jo,Mr;return i=new Ie({}),D=new Ie({}),Jo=new Ie({}),Zo=new O({props:{name:"class transformers.LEDConfig",anchor:"transformers.LEDConfig",parameters:[{name:"vocab_size",val:" = 50265"},{name:"max_encoder_position_embeddings",val:" = 16384"},{name:"max_decoder_position_embeddings",val:" = 1024"},{name:"encoder_layers",val:" = 12"},{name:"encoder_ffn_dim",val:" = 4096"},{name:"encoder_attention_heads",val:" = 16"},{name:"decoder_layers",val:" = 12"},{name:"decoder_ffn_dim",val:" = 4096"},{name:"decoder_attention_heads",val:" = 16"},{name:"encoder_layerdrop",val:" = 0.0"},{name:"decoder_layerdrop",val:" = 0.0"},{name:"use_cache",val:" = True"},{name:"is_encoder_decoder",val:" = True"},{name:"activation_function",val:" = 'gelu'"},{name:"d_model",val:" = 1024"},{name:"dropout",val:" = 0.1"},{name:"attention_dropout",val:" = 0.0"},{name:"activation_dropout",val:" = 0.0"},{name:"init_std",val:" = 0.02"},{name:"decoder_start_token_id",val:" = 2"},{name:"classifier_dropout",val:" = 0.0"},{name:"pad_token_id",val:" = 1"},{name:"bos_token_id",val:" = 0"},{name:"eos_token_id",val:" = 2"},{name:"attention_window",val:": typing.Union[typing.List[int], int] = 512"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.LEDConfig.vocab_size",description:`<strong>vocab_size</strong> (<code>int</code>, <em>optional</em>, defaults to 50265) &#x2014;
...
Whether or not the model should return the last key/values attentions (not used by all models)`,name:"use_cache"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/led/configuration_led.py#L31"}}),no=new Be({props:{anchor:"transformers.LEDConfig.example",$$slots:{default:[Vu]},$$scope:{ctx:$}}}),en=new Ie({}),tn=new O({props:{name:"class transformers.LEDTokenizer",anchor:"transformers.LEDTokenizer",parameters:[{name:"vocab_file",val:""},{name:"merges_file",val:""},{name:"errors",val:" = 'replace'"},{name:"bos_token",val:" = '<s>'"},{name:"eos_token",val:" = '</s>'"},{name:"sep_token",val:" = '</s>'"},{name:"cls_token",val:" = '<s>'"},{name:"unk_token",val:" = '<unk>'"},{name:"pad_token",val:" = '<pad>'"},{name:"mask_token",val:" = '<mask>'"},{name:"add_prefix_space",val:" = False"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/led/tokenization_led.py#L43"}}),nn=new O({props:{name:"build_inputs_with_special_tokens",anchor:"transformers.LEDTokenizer.build_inputs_with_special_tokens",parameters:[{name:"token_ids_0",val:": typing.List[int]"},{name:"token_ids_1",val:": typing.Optional[typing.List[int]] = None"}],parametersDescription:[{anchor:"transformers.LEDTokenizer.build_inputs_with_special_tokens.token_ids_0",description:`<strong>token_ids_0</strong> (<code>List[int]</code>) &#x2014;
...
`,returnType:`
<p><code>List[int]</code></p>
`}}),dn=new O({props:{name:"create_token_type_ids_from_sequences",anchor:"transformers.LEDTokenizer.create_token_type_ids_from_sequences",parameters:[{name:"token_ids_0",val:": typing.List[int]"},{name:"token_ids_1",val:": typing.Optional[typing.List[int]] = None"}],parametersDescription:[{anchor:"transformers.LEDTokenizer.create_token_type_ids_from_sequences.token_ids_0",description:`<strong>token_ids_0</strong> (<code>List[int]</code>) &#x2014;
...
`,returnType:`
<p><code>List[int]</code></p>
`}}),ln=new O({props:{name:"save_vocabulary",anchor:"transformers.LEDTokenizer.save_vocabulary",parameters:[{name:"save_directory",val:": str"},{name:"filename_prefix",val:": typing.Optional[str] = None"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/bart/tokenization_bart.py#L309"}}),cn=new Ie({}),hn=new O({props:{name:"class transformers.LEDTokenizerFast",anchor:"transformers.LEDTokenizerFast",parameters:[{name:"vocab_file",val:" = None"},{name:"merges_file",val:" = None"},{name:"tokenizer_file",val:" = None"},{name:"errors",val:" = 'replace'"},{name:"bos_token",val:" = '<s>'"},{name:"eos_token",val:" = '</s>'"},{name:"sep_token",val:" = '</s>'"},{name:"cls_token",val:" = '<s>'"},{name:"unk_token",val:" = '<unk>'"},{name:"pad_token",val:" = '<pad>'"},{name:"mask_token",val:" = '<mask>'"},{name:"add_prefix_space",val:" = False"},{name:"trim_offsets",val:" = True"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/led/tokenization_led_fast.py#L44"}}),mn=new Ie({}),fn=new O({props:{name:"class transformers.models.led.modeling_led.LEDEncoderBaseModelOutput",anchor:"transformers.models.led.modeling_led.LEDEncoderBaseModelOutput",parameters:[{name:"last_hidden_state",val:": FloatTensor"},{name:"hidden_states",val:": typing.Optional[typing.Tuple[torch.FloatTensor]] = None"},{name:"attentions",val:": typing.Optional[typing.Tuple[torch.FloatTensor]] = None"},{name:"global_attentions",val:": typing.Optional[typing.Tuple[torch.FloatTensor]] = None"}],parametersDescription:[{anchor:"transformers.models.led.modeling_led.LEDEncoderBaseModelOutput.last_hidden_state",description:`<strong>last_hidden_state</strong> (<code>torch.FloatTensor</code> of shape <code>(batch_size, sequence_length, hidden_size)</code>) &#x2014;
...
<p>Global attentions weights after the attention softmax, used to compute the weighted average in the
self-attention heads. Those are the attention weights from every token with global attention to every token
in the sequence.`,name:"encoder_global_attentions"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/led/modeling_tf_led.py#L1399"}}),yn=new O({props:{name:"class transformers.models.led.modeling_tf_led.TFLEDSeq2SeqLMOutput",anchor:"transformers.models.led.modeling_tf_led.TFLEDSeq2SeqLMOutput",parameters:[{name:"loss",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"logits",val:": Tensor = None"},{name:"past_key_values",val:": typing.Optional[typing.List[tensorflow.python.framework.ops.Tensor]] = None"},{name:"decoder_hidden_states",val:": typing.Optional[typing.Tuple[tensorflow.python.framework.ops.Tensor]] = None"},{name:"decoder_attentions",val:": typing.Optional[typing.Tuple[tensorflow.python.framework.ops.Tensor]] = None"},{name:"cross_attentions",val:": typing.Optional[typing.Tuple[tensorflow.python.framework.ops.Tensor]] = None"},{name:"encoder_last_hidden_state",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"encoder_hidden_states",val:": typing.Optional[typing.Tuple[tensorflow.python.framework.ops.Tensor]] = None"},{name:"encoder_attentions",val:": typing.Optional[typing.Tuple[tensorflow.python.framework.ops.Tensor]] = None"},{name:"encoder_global_attentions",val:": typing.Optional[typing.Tuple[tensorflow.python.framework.ops.Tensor]] = None"}],parametersDescription:[{anchor:"transformers.models.led.modeling_tf_led.TFLEDSeq2SeqLMOutput.loss",description:`<strong>loss</strong> (<code>tf.Tensor</code> of shape <code>(1,)</code>, <em>optional</em>, returned when <code>labels</code> is provided) &#x2014;
...
`}}),uo=new Wo({props:{$$slots:{default:[Ku]},$$scope:{ctx:$}}}),mo=new Be({props:{anchor:"transformers.LEDModel.forward.example",$$slots:{default:[Xu]},$$scope:{ctx:$}}}),Fn=new Ie({}),zn=new O({props:{name:"class transformers.LEDForConditionalGeneration",anchor:"transformers.LEDForConditionalGeneration",parameters:[{name:"config",val:": LEDConfig"}],parametersDescription:[{anchor:"transformers.LEDForConditionalGeneration.config",description:`<strong>config</strong> (<a href="/docs/transformers/main/en/model_doc/led#transformers.LEDConfig">LEDConfig</a>) &#x2014;
Model configuration class with all the parameters of the model. Initializing with a config file does not
load the weights associated with the model, only the configuration. Check out the
<a href="/docs/transformers/main/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/led/modeling_led.py#L2336"}}),On=new O({props:{name:"forward",anchor:"transformers.LEDForConditionalGeneration.forward",parameters:[{name:"input_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"attention_mask",val:": typing.Optional[torch.Tensor] = None"},{name:"decoder_input_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"decoder_attention_mask",val:": typing.Optional[torch.LongTensor] = None"},{name:"head_mask",val:": typing.Optional[torch.Tensor] = None"},{name:"decoder_head_mask",val:": typing.Optional[torch.Tensor] = None"},{name:"cross_attn_head_mask",val:": typing.Optional[torch.Tensor] = None"},{name:"encoder_outputs",val:": typing.Optional[typing.Tuple[typing.Tuple[torch.FloatTensor]]] = None"},{name:"global_attention_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"past_key_values",val:": typing.Optional[typing.Tuple[typing.Tuple[torch.FloatTensor]]] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"decoder_inputs_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"labels",val:": typing.Optional[torch.LongTensor] = None"},{name:"use_cache",val:": typing.Optional[bool] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.LEDForConditionalGeneration.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. Padding will be ignored by default should you provide
it.</p>
<p>Indices can be obtained using <a href="/docs/transformers/main/en/model_doc/led#transformers.LEDTokenizer">LEDTokenizer</a>. See <a href="/docs/transformers/main/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/main/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
`}}),_o=new Wo({props:{$$slots:{default:[Ju]},$$scope:{ctx:$}}}),go=new Be({props:{anchor:"transformers.LEDForConditionalGeneration.forward.example",$$slots:{default:[Zu]},$$scope:{ctx:$}}}),bo=new Be({props:{anchor:"transformers.LEDForConditionalGeneration.forward.example-2",$$slots:{default:[Yu]},$$scope:{ctx:$}}}),Cn=new Ie({}),jn=new O({props:{name:"class transformers.LEDForSequenceClassification",anchor:"transformers.LEDForSequenceClassification",parameters:[{name:"config",val:": LEDConfig"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.LEDForSequenceClassification.config",description:`<strong>config</strong> (<a href="/docs/transformers/main/en/model_doc/led#transformers.LEDConfig">LEDConfig</a>) &#x2014;
Model configuration class with all the parameters of the model. Initializing with a config file does not
load the weights associated with the model, only the configuration. Check out the
<a href="/docs/transformers/main/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/led/modeling_led.py#L2529"}}),In=new O({props:{name:"forward",anchor:"transformers.LEDForSequenceClassification.forward",parameters:[{name:"input_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"attention_mask",val:": typing.Optional[torch.Tensor] = None"},{name:"decoder_input_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"decoder_attention_mask",val:": typing.Optional[torch.LongTensor] = None"},{name:"head_mask",val:": typing.Optional[torch.Tensor] = None"},{name:"decoder_head_mask",val:": typing.Optional[torch.Tensor] = None"},{name:"cross_attn_head_mask",val:": typing.Optional[torch.Tensor] = None"},{name:"encoder_outputs",val:": typing.Optional[typing.Tuple[typing.Tuple[torch.FloatTensor]]] = None"},{name:"global_attention_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"decoder_inputs_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"labels",val:": typing.Optional[torch.LongTensor] = None"},{name:"use_cache",val:": typing.Optional[bool] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.LEDForSequenceClassification.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. Padding will be ignored by default should you provide
it.</p>
<p>Indices can be obtained using <a href="/docs/transformers/main/en/model_doc/led#transformers.LEDTokenizer">LEDTokenizer</a>. See <a href="/docs/transformers/main/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/main/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
`}}),ko=new Wo({props:{$$slots:{default:[em]},$$scope:{ctx:$}}}),vo=new Be({props:{anchor:"transformers.LEDForSequenceClassification.forward.example",$$slots:{default:[tm]},$$scope:{ctx:$}}}),yo=new Be({props:{anchor:"transformers.LEDForSequenceClassification.forward.example-2",$$slots:{default:[om]},$$scope:{ctx:$}}}),wo=new Be({props:{anchor:"transformers.LEDForSequenceClassification.forward.example-3",$$slots:{default:[nm]},$$scope:{ctx:$}}}),Eo=new Be({props:{anchor:"transformers.LEDForSequenceClassification.forward.example-4",$$slots:{default:[sm]},$$scope:{ctx:$}}}),Bn=new Ie({}),Gn=new O({props:{name:"class transformers.LEDForQuestionAnswering",anchor:"transformers.LEDForQuestionAnswering",parameters:[{name:"config",val:""}],parametersDescription:[{anchor:"transformers.LEDForQuestionAnswering.config",description:`<strong>config</strong> (<a href="/docs/transformers/main/en/model_doc/led#transformers.LEDConfig">LEDConfig</a>) &#x2014;
Model configuration class with all the parameters of the model. Initializing with a config file does not
load the weights associated with the model, only the configuration. Check out the
<a href="/docs/transformers/main/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/led/modeling_led.py#L2657"}}),Un=new O({props:{name:"forward",anchor:"transformers.LEDForQuestionAnswering.forward",parameters:[{name:"input_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"attention_mask",val:": typing.Optional[torch.Tensor] = None"},{name:"decoder_input_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"decoder_attention_mask",val:": typing.Optional[torch.LongTensor] = None"},{name:"head_mask",val:": typing.Optional[torch.Tensor] = None"},{name:"decoder_head_mask",val:": typing.Optional[torch.Tensor] = None"},{name:"cross_attn_head_mask",val:": typing.Optional[torch.Tensor] = None"},{name:"encoder_outputs",val:": typing.Optional[typing.Tuple[typing.Tuple[torch.FloatTensor]]] = None"},{name:"global_attention_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"start_positions",val:": typing.Optional[torch.LongTensor] = None"},{name:"end_positions",val:": typing.Optional[torch.LongTensor] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"decoder_inputs_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"use_cache",val:": typing.Optional[bool] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.LEDForQuestionAnswering.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. Padding will be ignored by default should you provide
it.</p>
<p>Indices can be obtained using <a href="/docs/transformers/main/en/model_doc/led#transformers.LEDTokenizer">LEDTokenizer</a>. See <a href="/docs/transformers/main/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/main/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
`}}),Co=new Wo({props:{$$slots:{default:[pm]},$$scope:{ctx:$}}}),jo=new Be({props:{anchor:"transformers.TFLEDForConditionalGeneration.call.example",$$slots:{default:[um]},$$scope:{ctx:$}}}),{c(){l=a("meta"),b=c(),p=a("h1"),f=a("a"),T=a("span"),k(i.$$.fragment),m=c(),F=a("span"),He=n("LED"),xe=c(),j=a("h2"),te=a("a"),ne=a("span"),k(D.$$.fragment),We=c(),K=a("span"),Ue=n("Overview"),Se=c(),B=a("p"),Re=n("The LED model was proposed in "),se=a("a"),ae=n("Longformer: The Long-Document Transformer"),Ve=n(` by Iz
Beltagy, Matthew E. Peters, Arman Cohan.`),Me=c(),W=a("p"),Ke=n("The abstract from the paper is the following:"),Oe=c(),U=a("p"),we=a("em"),Xe=n(`Transformer-based models are unable to process long sequences due to their self-attention operation, which scales
...
dataset.`),me=c(),M=a("p"),P=n("Tips:"),Ce=c(),x=a("ul"),C=a("li"),fe=a("a"),re=n("LEDForConditionalGeneration"),Je=n(` is an extension of
`),_e=a("a"),A=n("BartForConditionalGeneration"),Ze=n(" exchanging the traditional "),X=a("em"),Ye=n("self-attention"),et=n(` layer with
`),J=a("em"),tt=n("Longformer"),ot=n("\u2019s "),G=a("em"),nt=n("chunked self-attention"),de=n(" layer. "),ge=a("a"),Ee=n("LEDTokenizer"),N=n(` is an alias of
`),be=a("a"),Q=n("BartTokenizer"),st=n("."),at=c(),q=a("li"),z=n("LED works very well on long-range "),rt=a("em"),Le=n("sequence-to-sequence"),vt=n(" tasks where the "),dt=a("code"),S=n("input_ids"),yt=n(` largely exceed a length of
1024 tokens.`),wt=c(),H=a("li"),Et=n("LED pads the "),it=a("code"),Z=n("input_ids"),ie=n(" to be a multiple of "),lt=a("code"),Lt=n("config.attention_window"),le=n(` if required. Therefore a small speed-up is
gained, when `),je=a("a"),qt=n("LEDTokenizer"),ct=n(" is used with the "),ht=a("code"),qe=n("pad_to_multiple_of"),$t=n(" argument."),kd=c(),Y=a("li"),vd=n("LED makes use of "),Hs=a("em"),yd=n("global attention"),wd=n(" by means of the "),Ws=a("code"),Ed=n("global_attention_mask"),Ld=n(` (see
`),is=a("a"),qd=n("LongformerModel"),$d=n("). For summarization, it is advised to put "),Us=a("em"),Dd=n("global attention"),Fd=n(` only on the first
`),Rs=a("code"),zd=n("<s>"),xd=n(" token. For question answering, it is advised to put "),Vs=a("em"),Sd=n("global attention"),Md=n(" on all tokens of the question."),Od=c(),pt=a("li"),Cd=n("To fine-tune LED on all 16384, "),Ks=a("em"),jd=n("gradient checkpointing"),Pd=n(` can be enabled in case training leads to out-of-memory (OOM)
errors. This can be done by executing `),Xs=a("code"),Ad=n("model.gradient_checkpointing_enable()"),Nd=n(`.
Moreover, the `),Js=a("code"),Id=n("use_cache=False"),Bd=n(`
flag can be used to disable the caching mechanism to save memory.`),Gd=c(),Uo=a("li"),Qd=n("A notebook showing how to evaluate LED, can be accessed "),Ro=a("a"),Hd=n("here"),Wd=n("."),Ud=c(),Vo=a("li"),Rd=n("A notebook showing how to fine-tune LED, can be accessed "),Ko=a("a"),Vd=n("here"),Kd=n("."),ar=c(),to=a("p"),Xd=n("This model was contributed by "),Xo=a("a"),Jd=n("patrickvonplaten"),Zd=n("."),rr=c(),Dt=a("h2"),oo=a("a"),Zs=a("span"),k(Jo.$$.fragment),Yd=c(),Ys=a("span"),ei=n("LEDConfig"),dr=c(),$e=a("div"),k(Zo.$$.fragment),ti=c(),Ft=a("p"),oi=n("This is the configuration class to store the configuration of a "),ls=a("a"),ni=n("LEDModel"),si=n(`. It is used to instantiate an LED
...
documentation from `),hs=a("a"),hi=n("PretrainedConfig"),pi=n(" for more information."),ui=c(),k(no.$$.fragment),ir=c(),xt=a("h2"),so=a("a"),ea=a("span"),k(en.$$.fragment),mi=c(),ta=a("span"),fi=n("LEDTokenizer"),lr=c(),I=a("div"),k(tn.$$.fragment),_i=c(),oa=a("p"),gi=n("Construct a LED tokenizer."),bi=c(),ao=a("p"),ps=a("a"),Ti=n("LEDTokenizer"),ki=n(" is identical to "),us=a("a"),vi=n("BartTokenizer"),yi=n(` and runs end-to-end tokenization: punctuation splitting and
wordpiece.`),wi=c(),on=a("p"),Ei=n("Refer to superclass "),ms=a("a"),Li=n("BartTokenizer"),qi=n(" for usage examples and documentation concerning parameters."),$i=c(),ut=a("div"),k(nn.$$.fragment),Di=c(),na=a("p"),Fi=n(`Build model inputs from a sequence or a pair of sequence for sequence classification tasks by concatenating and
adding special tokens. A BART sequence has the following format:`),zi=c(),sn=a("ul"),fs=a("li"),xi=n("single sequence: "),sa=a("code"),Si=n("<s> X </s>"),Mi=c(),_s=a("li"),Oi=n("pair of sequences: "),aa=a("code"),Ci=n("<s> A </s></s> B </s>"),ji=c(),ro=a("div"),k(an.$$.fragment),Pi=c(),rn=a("p"),Ai=n(`Retrieve sequence ids from a token list that has no special tokens added. This method is called when adding
special tokens using the tokenizer `),ra=a("code"),Ni=n("prepare_for_model"),Ii=n(" method."),Bi=c(),io=a("div"),k(dn.$$.fragment),Gi=c(),da=a("p"),Qi=n(`Create a mask from the two sequences passed to be used in a sequence-pair classification task. BART does not
make use of token type ids, therefore a list of zeros is returned.`),Hi=c(),gs=a("div"),k(ln.$$.fragment),cr=c(),St=a("h2"),lo=a("a"),ia=a("span"),k(cn.$$.fragment),Wi=c(),la=a("span"),Ui=n("LEDTokenizerFast"),hr=c(),De=a("div"),k(hn.$$.fragment),Ri=c(),pn=a("p"),Vi=n("Construct a \u201Cfast\u201D LED tokenizer (backed by HuggingFace\u2019s "),ca=a("em"),Ki=n("tokenizers"),Xi=n(" library)."),Ji=c(),co=a("p"),bs=a("a"),Zi=n("LEDTokenizerFast"),Yi=n(" is identical to "),Ts=a("a"),el=n("BartTokenizerFast"),tl=n(` and runs end-to-end tokenization: punctuation splitting
and wordpiece.`),ol=c(),un=a("p"),nl=n("Refer to superclass "),ks=a("a"),sl=n("BartTokenizerFast"),al=n(" for usage examples and documentation concerning parameters."),pr=c(),Mt=a("h2"),ho=a("a"),ha=a("span"),k(mn.$$.fragment),rl=c(),pa=a("span"),dl=n("LED specific outputs"),ur=c(),Ot=a("div"),k(fn.$$.fragment),il=c(),ua=a("p"),ll=n("Base class for LEDEncoder\u2019s outputs, with potential hidden states, local and global attentions."),mr=c(),Ct=a("div"),k(_n.$$.fragment),cl=c(),ma=a("p"),hl=n(`Base class for model encoder\u2019s outputs that also contains : pre-computed hidden states that can speed up sequential
decoding.`),fr=c(),jt=a("div"),k(gn.$$.fragment),pl=c(),fa=a("p"),ul=n("Base class for sequence-to-sequence language models outputs."),_r=c(),Pt=a("div"),k(bn.$$.fragment),ml=c(),_a=a("p"),fl=n("Base class for outputs of sequence-to-sequence sentence classification models."),gr=c(),At=a("div"),k(Tn.$$.fragment),_l=c(),ga=a("p"),gl=n("Base class for outputs of sequence-to-sequence question answering models."),br=c(),Nt=a("div"),k(kn.$$.fragment),bl=c(),ba=a("p"),Tl=n("Base class for Longformer\u2019s outputs, with potential hidden states, local and global attentions."),Tr=c(),It=a("div"),k(vn.$$.fragment),kl=c(),Ta=a("p"),vl=n(`Base class for model encoder\u2019s outputs that also contains : pre-computed hidden states that can speed up sequential
decoding.`),kr=c(),Bt=a("div"),k(yn.$$.fragment),yl=c(),ka=a("p"),wl=n("Base class for sequence-to-sequence language models outputs."),vr=c(),Gt=a("h2"),po=a("a"),va=a("span"),k(wn.$$.fragment),El=c(),ya=a("span"),Ll=n("LEDModel"),yr=c(),Fe=a("div"),k(En.$$.fragment),ql=c(),Ln=a("p"),$l=n(`The bare LED Model outputting raw hidden-states without any specific head on top.
This model inherits from `),vs=a("a"),Dl=n("PreTrainedModel"),Fl=n(`. See the superclass documentation for the generic methods the library
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for general usage and behavior.`),Ol=c(),Pe=a("div"),k(Dn.$$.fragment),Cl=c(),Qt=a("p"),jl=n("The "),ys=a("a"),Pl=n("LEDModel"),Al=n(" forward method, overrides the "),wa=a("code"),Nl=n("__call__"),Il=n(" special method."),Bl=c(),k(uo.$$.fragment),Gl=c(),k(mo.$$.fragment),wr=c(),Ht=a("h2"),fo=a("a"),Ea=a("span"),k(Fn.$$.fragment),Ql=c(),La=a("span"),Hl=n("LEDForConditionalGeneration"),Er=c(),ze=a("div"),k(zn.$$.fragment),Wl=c(),xn=a("p"),Ul=n(`The LED Model with a language modeling head. Can be used for summarization.
This model inherits from `),ws=a("a"),Rl=n("PreTrainedModel"),Vl=n(`. See the superclass documentation for the generic methods the library
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for general usage and behavior.`),Yl=c(),Te=a("div"),k(On.$$.fragment),ec=c(),Wt=a("p"),tc=n("The "),Es=a("a"),oc=n("LEDForConditionalGeneration"),nc=n(" forward method, overrides the "),qa=a("code"),sc=n("__call__"),ac=n(" special method."),rc=c(),k(_o.$$.fragment),dc=c(),k(go.$$.fragment),ic=c(),k(bo.$$.fragment),Lr=c(),Ut=a("h2"),To=a("a"),$a=a("span"),k(Cn.$$.fragment),lc=c(),Da=a("span"),cc=n("LEDForSequenceClassification"),qr=c(),ce=a("div"),k(jn.$$.fragment),hc=c(),Fa=a("p"),pc=n(`LED model with a sequence classification/head on top (a linear layer on top of the pooled output) e.g. for GLUE
...
implements for all its models (such as downloading or saving, resizing the input embeddings, pruning heads etc.)`),gc=c(),An=a("p"),bc=n("This model is also a PyTorch "),Nn=a("a"),Tc=n("torch.nn.Module"),kc=n(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for general usage and behavior.`),vc=c(),R=a("div"),k(In.$$.fragment),yc=c(),Rt=a("p"),wc=n("The "),qs=a("a"),Ec=n("LEDForSequenceClassification"),Lc=n(" forward method, overrides the "),za=a("code"),qc=n("__call__"),$c=n(" special method."),Dc=c(),k(ko.$$.fragment),Fc=c(),k(vo.$$.fragment),zc=c(),k(yo.$$.fragment),xc=c(),k(wo.$$.fragment),Sc=c(),k(Eo.$$.fragment),$r=c(),Vt=a("h2"),Lo=a("a"),xa=a("span"),k(Bn.$$.fragment),Mc=c(),Sa=a("span"),Oc=n("LEDForQuestionAnswering"),Dr=c(),he=a("div"),k(Gn.$$.fragment),Cc=c(),Kt=a("p"),jc=n(`LED Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear layer
on top of the hidden-states output to compute `),Ma=a("code"),Pc=n("span start logits"),Ac=n(" and "),Oa=a("code"),Nc=n("span end logits"),Ic=n(")."),Bc=c(),Qn=a("p"),Gc=n("This model inherits from "),$s=a("a"),Qc=n("PreTrainedModel"),Hc=n(`. See the superclass documentation for the generic methods the library
implements for all its models (such as downloading or saving, resizing the input embeddings, pruning heads etc.)`),Wc=c(),Hn=a("p"),Uc=n("This model is also a PyTorch "),Wn=a("a"),Rc=n("torch.nn.Module"),Vc=n(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for general usage and behavior.`),Kc=c(),ke=a("div"),k(Un.$$.fragment),Xc=c(),Xt=a("p"),Jc=n("The "),Ds=a("a"),Zc=n("LEDForQuestionAnswering"),Yc=n(" forward method, overrides the "),Ca=a("code"),eh=n("__call__"),th=n(" special method."),oh=c(),k(qo.$$.fragment),nh=c(),k($o.$$.fragment),sh=c(),k(Do.$$.fragment),Fr=c(),Jt=a("h2"),Fo=a("a"),ja=a("span"),k(Rn.$$.fragment),ah=c(),Pa=a("span"),rh=n("TFLEDModel"),zr=c(),pe=a("div"),k(Vn.$$.fragment),dh=c(),Kn=a("p"),ih=n(`The bare LED Model outputting raw hidden-states without any specific head on top.
...
behavior.`),fh=c(),k(zo.$$.fragment),_h=c(),Ae=a("div"),k(Zn.$$.fragment),gh=c(),Zt=a("p"),bh=n("The "),zs=a("a"),Th=n("TFLEDModel"),kh=n(" forward method, overrides the "),Aa=a("code"),vh=n("__call__"),yh=n(" special method."),wh=c(),k(xo.$$.fragment),Eh=c(),k(So.$$.fragment),xr=c(),Yt=a("h2"),Mo=a("a"),Na=a("span"),k(Yn.$$.fragment),Lh=c(),Ia=a("span"),qh=n("TFLEDForConditionalGeneration"),Sr=c(),ue=a("div"),k(es.$$.fragment),$h=c(),ts=a("p"),Dh=n(`The LED Model with a language modeling head. Can be used for summarization.
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),xh=c(),os=a("p"),Sh=n("This model is also a "),ns=a("a"),Mh=n("tf.keras.Model"),Oh=n(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Ch=c(),k(Oo.$$.fragment),jh=c(),Ne=a("div"),k(ss.$$.fragment),Ph=c(),eo=a("p"),Ah=n("The "),Ss=a("a"),Nh=n("TFLEDForConditionalGeneration"),Ih=n(" forward method, overrides the "),Ba=a("code"),Bh=n("__call__"),Gh=n(" special method."),Qh=c(),k(Co.$$.fragment),Hh=c(),k(jo.$$.fragment),this.h()},l(o){const _=Uu('[data-svelte="svelte-1phssyn"]',document.head);l=r(_,"META",{name:!0,content:!0}),_.forEach(t),b=h(o),p=r(o,"H1",{class:!0});var as=d(p);f=r(as,"A",{id:!0,class:!0,href:!0});var Ga=d(f);T=r(Ga,"SPAN",{});var Qa=d(T);v(i.$$.fragment,Qa),Qa.forEach(t),Ga.forEach(t),m=h(as),F=r(as,"SPAN",{});var Ha=d(F);He=s(Ha,"LED"),Ha.forEach(t),as.forEach(t),xe=h(o),j=r(o,"H2",{class:!0});var rs=d(j);te=r(rs,"A",{id:!0,class:!0,href:!0});var Wa=d(te);ne=r(Wa,"SPAN",{});var Ua=d(ne);v(D.$$.fragment,Ua),Ua.forEach(t),Wa.forEach(t),We=h(rs),K=r(rs,"SPAN",{});var Ra=d(K);Ue=s(Ra,"Overview"),Ra.forEach(t),rs.forEach(t),Se=h(o),B=r(o,"P",{});var ds=d(B);Re=s(ds,"The LED model was proposed in "),se=r(ds,"A",{href:!0,rel:!0});var Va=d(se);ae=s(Va,"Longformer: The Long-Document Transformer"),Va.forEach(t),Ve=s(ds,` by Iz
Beltagy, Matthew E. Peters, Arman Cohan.`),ds.forEach(t),Me=h(o),W=r(o,"P",{});var Ka=d(W);Ke=s(Ka,"The abstract from the paper is the following:"),Ka.forEach(t),Oe=h(o),U=r(o,"P",{});var Xa=d(U);we=r(Xa,"EM",{});var Ja=d(we);Xe=s(Ja,`Transformer-based models are unable to process long sequences due to their self-attention operation, which scales
quadratically with the sequence length. To address this limitation, we introduce the Longformer with an attention
mechanism that scales linearly with sequence length, making it easy to process documents of thousands of tokens or
longer. Longformer\u2019s attention mechanism is a drop-in replacement for the standard self-attention and combines a local
windowed attention with a task motivated global attention. Following prior work on long-sequence transformers, we
...
WikiHop and TriviaQA. We finally introduce the Longformer-Encoder-Decoder (LED), a Longformer variant for supporting
long document generative sequence-to-sequence tasks, and demonstrate its effectiveness on the arXiv summarization
dataset.`),Ja.forEach(t),Xa.forEach(t),me=h(o),M=r(o,"P",{});var Za=d(M);P=s(Za,"Tips:"),Za.forEach(t),Ce=h(o),x=r(o,"UL",{});var ee=d(x);C=r(ee,"LI",{});var V=d(C);fe=r(V,"A",{href:!0});var Ya=d(fe);re=s(Ya,"LEDForConditionalGeneration"),Ya.forEach(t),Je=s(V,` is an extension of
`),_e=r(V,"A",{href:!0});var er=d(_e);A=s(er,"BartForConditionalGeneration"),er.forEach(t),Ze=s(V," exchanging the traditional "),X=r(V,"EM",{});var tr=d(X);Ye=s(tr,"self-attention"),tr.forEach(t),et=s(V,` layer with
`),J=r(V,"EM",{});var or=d(J);tt=s(or,"Longformer"),or.forEach(t),ot=s(V,"\u2019s "),G=r(V,"EM",{});var Rh=d(G);nt=s(Rh,"chunked self-attention"),Rh.forEach(t),de=s(V," layer. "),ge=r(V,"A",{href:!0});var Vh=d(ge);Ee=s(Vh,"LEDTokenizer"),Vh.forEach(t),N=s(V,` is an alias of
`),be=r(V,"A",{href:!0});var Kh=d(be);Q=s(Kh,"BartTokenizer"),Kh.forEach(t),st=s(V,"."),V.forEach(t),at=h(ee),q=r(ee,"LI",{});var Ms=d(q);z=s(Ms,"LED works very well on long-range "),rt=r(Ms,"EM",{});var Xh=d(rt);Le=s(Xh,"sequence-to-sequence"),Xh.forEach(t),vt=s(Ms," tasks where the "),dt=r(Ms,"CODE",{});var Jh=d(dt);S=s(Jh,"input_ids"),Jh.forEach(t),yt=s(Ms,` largely exceed a length of
1024 tokens.`),Ms.forEach(t),wt=h(ee),H=r(ee,"LI",{});var mt=d(H);Et=s(mt,"LED pads the "),it=r(mt,"CODE",{});var Zh=d(it);Z=s(Zh,"input_ids"),Zh.forEach(t),ie=s(mt," to be a multiple of "),lt=r(mt,"CODE",{});var Yh=d(lt);Lt=s(Yh,"config.attention_window"),Yh.forEach(t),le=s(mt,` if required. Therefore a small speed-up is
gained, when `),je=r(mt,"A",{href:!0});var ep=d(je);qt=s(ep,"LEDTokenizer"),ep.forEach(t),ct=s(mt," is used with the "),ht=r(mt,"CODE",{});var tp=d(ht);qe=s(tp,"pad_to_multiple_of"),tp.forEach(t),$t=s(mt," argument."),mt.forEach(t),kd=h(ee),Y=r(ee,"LI",{});var ve=d(Y);vd=s(ve,"LED makes use of "),Hs=r(ve,"EM",{});var op=d(Hs);yd=s(op,"global attention"),op.forEach(t),wd=s(ve," by means of the "),Ws=r(ve,"CODE",{});var np=d(Ws);Ed=s(np,"global_attention_mask"),np.forEach(t),Ld=s(ve,` (see
`),is=r(ve,"A",{href:!0});var sp=d(is);qd=s(sp,"LongformerModel"),sp.forEach(t),$d=s(ve,"). For summarization, it is advised to put "),Us=r(ve,"EM",{});var ap=d(Us);Dd=s(ap,"global attention"),ap.forEach(t),Fd=s(ve,` only on the first
`),Rs=r(ve,"CODE",{});var rp=d(Rs);zd=s(rp,"<s>"),rp.forEach(t),xd=s(ve," token. For question answering, it is advised to put "),Vs=r(ve,"EM",{});var dp=d(Vs);Sd=s(dp,"global attention"),dp.forEach(t),Md=s(ve," on all tokens of the question."),ve.forEach(t),Od=h(ee),pt=r(ee,"LI",{});var Po=d(pt);Cd=s(Po,"To fine-tune LED on all 16384, "),Ks=r(Po,"EM",{});var ip=d(Ks);jd=s(ip,"gradient checkpointing"),ip.forEach(t),Pd=s(Po,` can be enabled in case training leads to out-of-memory (OOM)
...
Moreover, the `),Js=r(Po,"CODE",{});var cp=d(Js);Id=s(cp,"use_cache=False"),cp.forEach(t),Bd=s(Po,`
flag can be used to disable the caching mechanism to save memory.`),Po.forEach(t),Gd=h(ee),Uo=r(ee,"LI",{});var Or=d(Uo);Qd=s(Or,"A notebook showing how to evaluate LED, can be accessed "),Ro=r(Or,"A",{href:!0,rel:!0});var hp=d(Ro);Hd=s(hp,"here"),hp.forEach(t),Wd=s(Or,"."),Or.forEach(t),Ud=h(ee),Vo=r(ee,"LI",{});var Cr=d(Vo);Rd=s(Cr,"A notebook showing how to fine-tune LED, can be accessed "),Ko=r(Cr,"A",{href:!0,rel:!0});var pp=d(Ko);Vd=s(pp,"here"),pp.forEach(t),Kd=s(Cr,"."),Cr.forEach(t),ee.forEach(t),ar=h(o),to=r(o,"P",{});var jr=d(to);Xd=s(jr,"This model was contributed by "),Xo=r(jr,"A",{href:!0,rel:!0});var up=d(Xo);Jd=s(up,"patrickvonplaten"),up.forEach(t),Zd=s(jr,"."),jr.forEach(t),rr=h(o),Dt=r(o,"H2",{class:!0});var Pr=d(Dt);oo=r(Pr,"A",{id:!0,class:!0,href:!0});var mp=d(oo);Zs=r(mp,"SPAN",{});var fp=d(Zs);v(Jo.$$.fragment,fp),fp.forEach(t),mp.forEach(t),Yd=h(Pr),Ys=r(Pr,"SPAN",{});var _p=d(Ys);ei=s(_p,"LEDConfig"),_p.forEach(t),Pr.forEach(t),dr=h(o),$e=r(o,"DIV",{class:!0});var Ao=d($e);v(Zo.$$.fragment,Ao),ti=h(Ao),Ft=r(Ao,"P",{});var Os=d(Ft);oi=s(Os,"This is the configuration class to store the configuration of a "),ls=r(Os,"A",{href:!0});var gp=d(ls);ni=s(gp,"LEDModel"),gp.forEach(t),si=s(Os,`. It is used to instantiate an LED
model according to the specified arguments, defining the model architecture. Instantiating a configuration with the
defaults will yield a similar configuration to that of the LED
`),Yo=r(Os,"A",{href:!0,rel:!0});var bp=d(Yo);ai=s(bp,"allenai/led-base-16384"),bp.forEach(t),ri=s(Os," architecture."),Os.forEach(t),di=h(Ao),zt=r(Ao,"P",{});var Cs=d(zt);ii=s(Cs,"Configuration objects inherit from "),cs=r(Cs,"A",{href:!0});var Tp=d(cs);li=s(Tp,"PretrainedConfig"),Tp.forEach(t),ci=s(Cs,` and can be used to control the model outputs. Read the
documentation from `),hs=r(Cs,"A",{href:!0});var kp=d(hs);hi=s(kp,"PretrainedConfig"),kp.forEach(t),pi=s(Cs," for more information."),Cs.forEach(t),ui=h(Ao),v(no.$$.fragment,Ao),Ao.forEach(t),ir=h(o),xt=r(o,"H2",{class:!0});var Ar=d(xt);so=r(Ar,"A",{id:!0,class:!0,href:!0});var vp=d(so);ea=r(vp,"SPAN",{});var yp=d(ea);v(en.$$.fragment,yp),yp.forEach(t),vp.forEach(t),mi=h(Ar),ta=r(Ar,"SPAN",{});var wp=d(ta);fi=s(wp,"LEDTokenizer"),wp.forEach(t),Ar.forEach(t),lr=h(o),I=r(o,"DIV",{class:!0});var oe=d(I);v(tn.$$.fragment,oe),_i=h(oe),oa=r(oe,"P",{});var Ep=d(oa);gi=s(Ep,"Construct a LED tokenizer."),Ep.forEach(t),bi=h(oe),ao=r(oe,"P",{});var nr=d(ao);ps=r(nr,"A",{href:!0});var Lp=d(ps);Ti=s(Lp,"LEDTokenizer"),Lp.forEach(t),ki=s(nr," is identical to "),us=r(nr,"A",{href:!0});var qp=d(us);vi=s(qp,"BartTokenizer"),qp.forEach(t),yi=s(nr,` and runs end-to-end tokenization: punctuation splitting and
wordpiece.`),nr.forEach(t),wi=h(oe),on=r(oe,"P",{});var Nr=d(on);Ei=s(Nr,"Refer to superclass "),ms=r(Nr,"A",{href:!0});var $p=d(ms);Li=s($p,"BartTokenizer"),$p.forEach(t),qi=s(Nr," for usage examples and documentation concerning parameters."),Nr.forEach(t),$i=h(oe),ut=r(oe,"DIV",{class:!0});var js=d(ut);v(nn.$$.fragment,js),Di=h(js),na=r(js,"P",{});var Dp=d(na);Fi=s(Dp,`Build model inputs from a sequence or a pair of sequence for sequence classification tasks by concatenating and
adding special tokens. A BART sequence has the following format:`),Dp.forEach(t),zi=h(js),sn=r(js,"UL",{});var Ir=d(sn);fs=r(Ir,"LI",{});var Wh=d(fs);xi=s(Wh,"single sequence: "),sa=r(Wh,"CODE",{});var Fp=d(sa);Si=s(Fp,"<s> X </s>"),Fp.forEach(t),Wh.forEach(t),Mi=h(Ir),_s=r(Ir,"LI",{});var Uh=d(_s);Oi=s(Uh,"pair of sequences: "),aa=r(Uh,"CODE",{});var zp=d(aa);Ci=s(zp,"<s> A </s></s> B </s>"),zp.forEach(t),Uh.forEach(t),Ir.forEach(t),js.forEach(t),ji=h(oe),ro=r(oe,"DIV",{class:!0});var Br=d(ro);v(an.$$.fragment,Br),Pi=h(Br),rn=r(Br,"P",{});var Gr=d(rn);Ai=s(Gr,`Retrieve sequence ids from a token list that has no special tokens added. This method is called when adding
special tokens using the tokenizer `),ra=r(Gr,"CODE",{});var xp=d(ra);Ni=s(xp,"prepare_for_model"),xp.forEach(t),Ii=s(Gr," method."),Gr.forEach(t),Br.forEach(t),Bi=h(oe),io=r(oe,"DIV",{class:!0});var Qr=d(io);v(dn.$$.fragment,Qr),Gi=h(Qr),da=r(Qr,"P",{});var Sp=d(da);Qi=s(Sp,`Create a mask from the two sequences passed to be used in a sequence-pair classification task. BART does not
make use of token type ids, therefore a list of zeros is returned.`),Sp.forEach(t),Qr.forEach(t),Hi=h(oe),gs=r(oe,"DIV",{class:!0});var Mp=d(gs);v(ln.$$.fragment,Mp),Mp.forEach(t),oe.forEach(t),cr=h(o),St=r(o,"H2",{class:!0});var Hr=d(St);lo=r(Hr,"A",{id:!0,class:!0,href:!0});var Op=d(lo);ia=r(Op,"SPAN",{});var Cp=d(ia);v(cn.$$.fragment,Cp),Cp.forEach(t),Op.forEach(t),Wi=h(Hr),la=r(Hr,"SPAN",{});var jp=d(la);Ui=s(jp,"LEDTokenizerFast"),jp.forEach(t),Hr.forEach(t),hr=h(o),De=r(o,"DIV",{class:!0});var No=d(De);v(hn.$$.fragment,No),Ri=h(No),pn=r(No,"P",{});var Wr=d(pn);Vi=s(Wr,"Construct a \u201Cfast\u201D LED tokenizer (backed by HuggingFace\u2019s "),ca=r(Wr,"EM",{});var Pp=d(ca);Ki=s(Pp,"tokenizers"),Pp.forEach(t),Xi=s(Wr," library)."),Wr.forEach(t),Ji=h(No),co=r(No,"P",{});var sr=d(co);bs=r(sr,"A",{href:!0});var Ap=d(bs);Zi=s(Ap,"LEDTokenizerFast"),Ap.forEach(t),Yi=s(sr," is identical to "),Ts=r(sr,"A",{href:!0});var Np=d(Ts);el=s(Np,"BartTokenizerFast"),Np.forEach(t),tl=s(sr,` and runs end-to-end tokenization: punctuation splitting
and wordpiece.`),sr.forEach(t),ol=h(No),un=r(No,"P",{});var Ur=d(un);nl=s(Ur,"Refer to superclass "),ks=r(Ur,"A",{href:!0});var Ip=d(ks);sl=s(Ip,"BartTokenizerFast"),Ip.forEach(t),al=s(Ur," for usage examples and documentation concerning parameters."),Ur.forEach(t),No.forEach(t),pr=h(o),Mt=r(o,"H2",{class:!0});var Rr=d(Mt);ho=r(Rr,"A",{id:!0,class:!0,href:!0});var Bp=d(ho);ha=r(Bp,"SPAN",{});var Gp=d(ha);v(mn.$$.fragment,Gp),Gp.forEach(t),Bp.forEach(t),rl=h(Rr),pa=r(Rr,"SPAN",{});var Qp=d(pa);dl=s(Qp,"LED specific outputs"),Qp.forEach(t),Rr.forEach(t),ur=h(o),Ot=r(o,"DIV",{class:!0});var Vr=d(Ot);v(fn.$$.fragment,Vr),il=h(Vr),ua=r(Vr,"P",{});var Hp=d(ua);ll=s(Hp,"Base class for LEDEncoder\u2019s outputs, with potential hidden states, local and global attentions."),Hp.forEach(t),Vr.forEach(t),mr=h(o),Ct=r(o,"DIV",{class:!0});var Kr=d(Ct);v(_n.$$.fragment,Kr),cl=h(Kr),ma=r(Kr,"P",{});var Wp=d(ma);hl=s(Wp,`Base class for model encoder\u2019s outputs that also contains : pre-computed hidden states that can speed up sequential
decoding.`),Wp.forEach(t),Kr.forEach(t),fr=h(o),jt=r(o,"DIV",{class:!0});var Xr=d(jt);v(gn.$$.fragment,Xr),pl=h(Xr),fa=r(Xr,"P",{});var Up=d(fa);ul=s(Up,"Base class for sequence-to-sequence language models outputs."),Up.forEach(t),Xr.forEach(t),_r=h(o),Pt=r(o,"DIV",{class:!0});var Jr=d(Pt);v(bn.$$.fragment,Jr),ml=h(Jr),_a=r(Jr,"P",{});var Rp=d(_a);fl=s(Rp,"Base class for outputs of sequence-to-sequence sentence classification models."),Rp.forEach(t),Jr.forEach(t),gr=h(o),At=r(o,"DIV",{class:!0});var Zr=d(At);v(Tn.$$.fragment,Zr),_l=h(Zr),ga=r(Zr,"P",{});var Vp=d(ga);gl=s(Vp,"Base class for outputs of sequence-to-sequence question answering models."),Vp.forEach(t),Zr.forEach(t),br=h(o),Nt=r(o,"DIV",{class:!0});var Yr=d(Nt);v(kn.$$.fragment,Yr),bl=h(Yr),ba=r(Yr,"P",{});var Kp=d(ba);Tl=s(Kp,"Base class for Longformer\u2019s outputs, with potential hidden states, local and global attentions."),Kp.forEach(t),Yr.forEach(t),Tr=h(o),It=r(o,"DIV",{class:!0});var ed=d(It);v(vn.$$.fragment,ed),kl=h(ed),Ta=r(ed,"P",{});var Xp=d(Ta);vl=s(Xp,`Base class for model encoder\u2019s outputs that also contains : pre-computed hidden states that can speed up sequential
decoding.`),Xp.forEach(t),ed.forEach(t),kr=h(o),Bt=r(o,"DIV",{class:!0});var td=d(Bt);v(yn.$$.fragment,td),yl=h(td),ka=r(td,"P",{});var Jp=d(ka);wl=s(Jp,"Base class for sequence-to-sequence language models outputs."),Jp.forEach(t),td.forEach(t),vr=h(o),Gt=r(o,"H2",{class:!0});var od=d(Gt);po=r(od,"A",{id:!0,class:!0,href:!0});var Zp=d(po);va=r(Zp,"SPAN",{});var Yp=d(va);v(wn.$$.fragment,Yp),Yp.forEach(t),Zp.forEach(t),El=h(od),ya=r(od,"SPAN",{});var eu=d(ya);Ll=s(eu,"LEDModel"),eu.forEach(t),od.forEach(t),yr=h(o),Fe=r(o,"DIV",{class:!0});var Io=d(Fe);v(En.$$.fragment,Io),ql=h(Io),Ln=r(Io,"P",{});var nd=d(Ln);$l=s(nd,`The bare LED Model outputting raw hidden-states without any specific head on top.
This model inherits from `),vs=r(nd,"A",{href:!0});var tu=d(vs);Dl=s(tu,"PreTrainedModel"),tu.forEach(t),Fl=s(nd,`. See the superclass documentation for the generic methods the library
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for general usage and behavior.`),sd.forEach(t),Ol=h(Io),Pe=r(Io,"DIV",{class:!0});var Bo=d(Pe);v(Dn.$$.fragment,Bo),Cl=h(Bo),Qt=r(Bo,"P",{});var Ps=d(Qt);jl=s(Ps,"The "),ys=r(Ps,"A",{href:!0});var nu=d(ys);Pl=s(nu,"LEDModel"),nu.forEach(t),Al=s(Ps," forward method, overrides the "),wa=r(Ps,"CODE",{});var su=d(wa);Nl=s(su,"__call__"),su.forEach(t),Il=s(Ps," special method."),Ps.forEach(t),Bl=h(Bo),v(uo.$$.fragment,Bo),Gl=h(Bo),v(mo.$$.fragment,Bo),Bo.forEach(t),Io.forEach(t),wr=h(o),Ht=r(o,"H2",{class:!0});var ad=d(Ht);fo=r(ad,"A",{id:!0,class:!0,href:!0});var au=d(fo);Ea=r(au,"SPAN",{});var ru=d(Ea);v(Fn.$$.fragment,ru),ru.forEach(t),au.forEach(t),Ql=h(ad),La=r(ad,"SPAN",{});var du=d(La);Hl=s(du,"LEDForConditionalGeneration"),du.forEach(t),ad.forEach(t),Er=h(o),ze=r(o,"DIV",{class:!0});var Go=d(ze);v(zn.$$.fragment,Go),Wl=h(Go),xn=r(Go,"P",{});var rd=d(xn);Ul=s(rd,`The LED Model with a language modeling head. Can be used for summarization.
This model inherits from `),ws=r(rd,"A",{href:!0});var iu=d(ws);Rl=s(iu,"PreTrainedModel"),iu.forEach(t),Vl=s(rd,`. See the superclass documentation for the generic methods the library
implements for all its models (such as downloading or saving, resizing the input embeddings, pruning heads etc.)`),rd.forEach(t),Kl=h(Go),Sn=r(Go,"P",{});var dd=d(Sn);Xl=s(dd,"This model is also a PyTorch "),Mn=r(dd,"A",{href:!0,rel:!0});var lu=d(Mn);Jl=s(lu,"torch.nn.Module"),lu.forEach(t),Zl=s(dd,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for general usage and behavior.`),dd.forEach(t),Yl=h(Go),Te=r(Go,"DIV",{class:!0});var ft=d(Te);v(On.$$.fragment,ft),ec=h(ft),Wt=r(ft,"P",{});var As=d(Wt);tc=s(As,"The "),Es=r(As,"A",{href:!0});var cu=d(Es);oc=s(cu,"LEDForConditionalGeneration"),cu.forEach(t),nc=s(As," forward method, overrides the "),qa=r(As,"CODE",{});var hu=d(qa);sc=s(hu,"__call__"),hu.forEach(t),ac=s(As," special method."),As.forEach(t),rc=h(ft),v(_o.$$.fragment,ft),dc=h(ft),v(go.$$.fragment,ft),ic=h(ft),v(bo.$$.fragment,ft),ft.forEach(t),Go.forEach(t),Lr=h(o),Ut=r(o,"H2",{class:!0});var id=d(Ut);To=r(id,"A",{id:!0,class:!0,href:!0});var pu=d(To);$a=r(pu,"SPAN",{});var uu=d($a);v(Cn.$$.fragment,uu),uu.forEach(t),pu.forEach(t),lc=h(id),Da=r(id,"SPAN",{});var mu=d(Da);cc=s(mu,"LEDForSequenceClassification"),mu.forEach(t),id.forEach(t),qr=h(o),ce=r(o,"DIV",{class:!0});var _t=d(ce);v(jn.$$.fragment,_t),hc=h(_t),Fa=r(_t,"P",{});var fu=d(Fa);pc=s(fu,`LED model with a sequence classification/head on top (a linear layer on top of the pooled output) e.g. for GLUE
...
implements for all its models (such as downloading or saving, resizing the input embeddings, pruning heads etc.)`),ld.forEach(t),gc=h(_t),An=r(_t,"P",{});var cd=d(An);bc=s(cd,"This model is also a PyTorch "),Nn=r(cd,"A",{href:!0,rel:!0});var gu=d(Nn);Tc=s(gu,"torch.nn.Module"),gu.forEach(t),kc=s(cd,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for general usage and behavior.`),cd.forEach(t),vc=h(_t),R=r(_t,"DIV",{class:!0});var ye=d(R);v(In.$$.fragment,ye),yc=h(ye),Rt=r(ye,"P",{});var Ns=d(Rt);wc=s(Ns,"The "),qs=r(Ns,"A",{href:!0});var bu=d(qs);Ec=s(bu,"LEDForSequenceClassification"),bu.forEach(t),Lc=s(Ns," forward method, overrides the "),za=r(Ns,"CODE",{});var Tu=d(za);qc=s(Tu,"__call__"),Tu.forEach(t),$c=s(Ns," special method."),Ns.forEach(t),Dc=h(ye),v(ko.$$.fragment,ye),Fc=h(ye),v(vo.$$.fragment,ye),zc=h(ye),v(yo.$$.fragment,ye),xc=h(ye),v(wo.$$.fragment,ye),Sc=h(ye),v(Eo.$$.fragment,ye),ye.forEach(t),_t.forEach(t),$r=h(o),Vt=r(o,"H2",{class:!0});var hd=d(Vt);Lo=r(hd,"A",{id:!0,class:!0,href:!0});var ku=d(Lo);xa=r(ku,"SPAN",{});var vu=d(xa);v(Bn.$$.fragment,vu),vu.forEach(t),ku.forEach(t),Mc=h(hd),Sa=r(hd,"SPAN",{});var yu=d(Sa);Oc=s(yu,"LEDForQuestionAnswering"),yu.forEach(t),hd.forEach(t),Dr=h(o),he=r(o,"DIV",{class:!0});var gt=d(he);v(Gn.$$.fragment,gt),Cc=h(gt),Kt=r(gt,"P",{});var Is=d(Kt);jc=s(Is,`LED Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear layer
on top of the hidden-states output to compute `),Ma=r(Is,"CODE",{});var wu=d(Ma);Pc=s(wu,"span start logits"),wu.forEach(t),Ac=s(Is," and "),Oa=r(Is,"CODE",{});var Eu=d(Oa);Nc=s(Eu,"span end logits"),Eu.forEach(t),Ic=s(Is,")."),Is.forEach(t),Bc=h(gt),Qn=r(gt,"P",{});var pd=d(Qn);Gc=s(pd,"This model inherits from "),$s=r(pd,"A",{href:!0});var Lu=d($s);Qc=s(Lu,"PreTrainedModel"),Lu.forEach(t),Hc=s(pd,`. See the superclass documentation for the generic methods the library
implements for all its models (such as downloading or saving, resizing the input embeddings, pruning heads etc.)`),pd.forEach(t),Wc=h(gt),Hn=r(gt,"P",{});var ud=d(Hn);Uc=s(ud,"This model is also a PyTorch "),Wn=r(ud,"A",{href:!0,rel:!0});var qu=d(Wn);Rc=s(qu,"torch.nn.Module"),qu.forEach(t),Vc=s(ud,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for general usage and behavior.`),ud.forEach(t),Kc=h(gt),ke=r(gt,"DIV",{class:!0});var bt=d(ke);v(Un.$$.fragment,bt),Xc=h(bt),Xt=r(bt,"P",{});var Bs=d(Xt);Jc=s(Bs,"The "),Ds=r(Bs,"A",{href:!0});var $u=d(Ds);Zc=s($u,"LEDForQuestionAnswering"),$u.forEach(t),Yc=s(Bs," forward method, overrides the "),Ca=r(Bs,"CODE",{});var Du=d(Ca);eh=s(Du,"__call__"),Du.forEach(t),th=s(Bs," special method."),Bs.forEach(t),oh=h(bt),v(qo.$$.fragment,bt),nh=h(bt),v($o.$$.fragment,bt),sh=h(bt),v(Do.$$.fragment,bt),bt.forEach(t),gt.forEach(t),Fr=h(o),Jt=r(o,"H2",{class:!0});var md=d(Jt);Fo=r(md,"A",{id:!0,class:!0,href:!0});var Fu=d(Fo);ja=r(Fu,"SPAN",{});var zu=d(ja);v(Rn.$$.fragment,zu),zu.forEach(t),Fu.forEach(t),ah=h(md),Pa=r(md,"SPAN",{});var xu=d(Pa);rh=s(xu,"TFLEDModel"),xu.forEach(t),md.forEach(t),zr=h(o),pe=r(o,"DIV",{class:!0});var Tt=d(pe);v(Vn.$$.fragment,Tt),dh=h(Tt),Kn=r(Tt,"P",{});var fd=d(Kn);ih=s(fd,`The bare LED Model outputting raw hidden-states without any specific head on top.
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),fd.forEach(t),hh=h(Tt),Xn=r(Tt,"P",{});var _d=d(Xn);ph=s(_d,"This model is also a "),Jn=r(_d,"A",{href:!0,rel:!0});var Mu=d(Jn);uh=s(Mu,"tf.keras.Model"),Mu.forEach(t),mh=s(_d,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),_d.forEach(t),fh=h(Tt),v(zo.$$.fragment,Tt),_h=h(Tt),Ae=r(Tt,"DIV",{class:!0});var Qo=d(Ae);v(Zn.$$.fragment,Qo),gh=h(Qo),Zt=r(Qo,"P",{});var Gs=d(Zt);bh=s(Gs,"The "),zs=r(Gs,"A",{href:!0});var Ou=d(zs);Th=s(Ou,"TFLEDModel"),Ou.forEach(t),kh=s(Gs," forward method, overrides the "),Aa=r(Gs,"CODE",{});var Cu=d(Aa);vh=s(Cu,"__call__"),Cu.forEach(t),yh=s(Gs," special method."),Gs.forEach(t),wh=h(Qo),v(xo.$$.fragment,Qo),Eh=h(Qo),v(So.$$.fragment,Qo),Qo.forEach(t),Tt.forEach(t),xr=h(o),Yt=r(o,"H2",{class:!0});var gd=d(Yt);Mo=r(gd,"A",{id:!0,class:!0,href:!0});var ju=d(Mo);Na=r(ju,"SPAN",{});var Pu=d(Na);v(Yn.$$.fragment,Pu),Pu.forEach(t),ju.forEach(t),Lh=h(gd),Ia=r(gd,"SPAN",{});var Au=d(Ia);qh=s(Au,"TFLEDForConditionalGeneration"),Au.forEach(t),gd.forEach(t),Sr=h(o),ue=r(o,"DIV",{class:!0});var kt=d(ue);v(es.$$.fragment,kt),$h=h(kt),ts=r(kt,"P",{});var bd=d(ts);Dh=s(bd,`The LED Model with a language modeling head. Can be used for summarization.
This model inherits from `),xs=r(bd,"A",{href:!0});var Nu=d(xs);Fh=s(Nu,"TFPreTrainedModel"),Nu.forEach(t),zh=s(bd,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),bd.forEach(t),xh=h(kt),os=r(kt,"P",{});var Td=d(os);Sh=s(Td,"This model is also a "),ns=r(Td,"A",{href:!0,rel:!0});var Iu=d(ns);Mh=s(Iu,"tf.keras.Model"),Iu.forEach(t),Oh=s(Td,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Td.forEach(t),Ch=h(kt),v(Oo.$$.fragment,kt),jh=h(kt),Ne=r(kt,"DIV",{class:!0});var Ho=d(Ne);v(ss.$$.fragment,Ho),Ph=h(Ho),eo=r(Ho,"P",{});var Qs=d(eo);Ah=s(Qs,"The "),Ss=r(Qs,"A",{href:!0});var Bu=d(Ss);Nh=s(Bu,"TFLEDForConditionalGeneration"),Bu.forEach(t),Ih=s(Qs," forward method, overrides the "),Ba=r(Qs,"CODE",{});var Gu=d(Ba);Bh=s(Gu,"__call__"),Gu.forEach(t),Gh=s(Qs," special method."),Qs.forEach(t),Qh=h(Ho),v(Co.$$.fragment,Ho),Hh=h(Ho),v(jo.$$.fragment,Ho),Ho.forEach(t),kt.forEach(t),this.h()},h(){u(l,"name","hf:doc:metadata"),u(l,"content",JSON.stringify(fm)),u(f,"id","led"),u(f,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),u(f,"href","#led"),u(p,"class","relative group"),u(te,"id","overview"),u(te,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),u(te,"href","#overview"),u(j,"class","relative group"),u(se,"href","https://arxiv.org/abs/2004.05150"),u(se,"rel","nofollow"),u(fe,"href","/docs/transformers/main/en/model_doc/led#transformers.LEDForConditionalGeneration"),u(_e,"href","/docs/transformers/main/en/model_doc/bart#transformers.BartForConditionalGeneration"),u(ge,"href","/docs/transformers/main/en/model_doc/led#transformers.LEDTokenizer"),u(be,"href","/docs/transformers/main/en/model_doc/bart#transformers.BartTokenizer"),u(je,"href","/docs/transformers/main/en/model_doc/led#transformers.LEDTokenizer"),u(is,"href","/docs/transformers/main/en/model_doc/longformer#transformers.LongformerModel"),u(Ro,"href","https://colab.research.google.com/drive/12INTTR6n64TzS4RrXZxMSXfrOd9Xzamo?usp=sharing"),u(Ro,"rel","nofollow"),u(Ko,"href","https://colab.research.google.com/drive/12LjJazBl7Gam0XBPy_y0CTOJZeZ34c2v?usp=sharing"),u(Ko,"rel","nofollow"),u(Xo,"href","https://huggingface.co/patrickvonplaten"),u(Xo,"rel","nofollow"),u(oo,"id","transformers.LEDConfig"),u(oo,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),u(oo,"href","#transformers.LEDConfig"),u(Dt,"class","relative group"),u(ls,"href","/docs/transformers/main/en/model_doc/led#transformers.LEDModel"),u(Yo,"href","https://huggingface.co/allenai/led-base-16384"),u(Yo,"rel","nofollow"),u(cs,"href","/docs/transformers/main/en/main_classes/configuration#transformers.PretrainedConfig"),u(hs,"href","/docs/transformers/main/en/main_classes/configuration#transformers.PretrainedConfig"),u($e,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),u(so,"id","transformers.LEDTokenizer"),u(so,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),u(so,"href","#transformers.LEDTokenizer"),u(xt,"class","relative group"),u(ps,"href","/docs/transformers/main/en/model_doc/led#transformers.LEDTokenizer"),u(us,"href","/docs/transformers/main/en/model_doc/bart#transformers.BartTokenizer"),u(ms,"href","/docs/transformers/main/en/model_doc/bart#transformers.BartTokenizer"),u(ut,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),u(ro,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),u(io,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),u(gs,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),u(I,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),u(lo,"id","transformers.LEDTokenizerFast"),u(lo,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),u(lo,"href","#transformers.LEDTokenizerFast"),u(St,"class","relative group"),u(bs,"href","/docs/transformers/main/en/model_doc/led#transformers.LEDTokenizerFast"),u(Ts,"href","/docs/transformers/main/en/model_doc/bart#transformers.BartTokenizerFast"),u(ks,"href","/docs/transformers/main/en/model_doc/bart#transformers.BartTokenizerFast"),u(De,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),u(ho,"id","transformers.models.led.modeling_led.LEDEncoderBaseModelOutput"),u(ho,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),u(ho,"href","#transformers.models.led.modeling_led.LEDEncoderBaseModelOutput"),u(Mt,"class","relative group"),u(Ot,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),u(Ct,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),u(jt,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),u(Pt,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),u(At,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),u(Nt,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),u(It,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),u(Bt,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),u(po,"id","transformers.LEDModel"),u(po,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),u(po,"href","#transformers.LEDModel"),u(Gt,"class","relative group"),u(vs,"href","/docs/transformers/main/en/main_classes/model#transformers.PreTrainedModel"),u($n,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),u($n,"rel","nofollow"),u(ys,"href","/docs/transformers/main/en/model_doc/led#transformers.LEDModel"),u(Pe,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),u(Fe,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),u(fo,"id","transformers.LEDForConditionalGeneration"),u(fo,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),u(fo,"href","#transformers.LEDForConditionalGeneration"),u(Ht,"class","relative group"),u(ws,"href","/docs/transformers/main/en/main_classes/model#transformers.PreTrainedModel"),u(Mn,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),u(Mn,"rel","nofollow"),u(Es,"href","/docs/transformers/main/en/model_doc/led#transformers.LEDForConditionalGeneration"),u(Te,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),u(ze,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),u(To,"id","transformers.LEDForSequenceClassification"),u(To,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),u(To,"href","#transformers.LEDForSequenceClassification"),u(Ut,"class","relative group"),u(Ls,"href","/docs/transformers/main/en/main_classes/model#transformers.PreTrainedModel"),u(Nn,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),u(Nn,"rel","nofollow"),u(qs,"href","/docs/transformers/main/en/model_doc/led#transformers.LEDForSequenceClassification"),u(R,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),u(ce,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),u(Lo,"id","transformers.LEDForQuestionAnswering"),u(Lo,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),u(Lo,"href","#transformers.LEDForQuestionAnswering"),u(Vt,"class","relative group"),u($s,"href","/docs/transformers/main/en/main_classes/model#transformers.PreTrainedModel"),u(Wn,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),u(Wn,"rel","nofollow"),u(Ds,"href","/docs/transformers/main/en/model_doc/led#transformers.LEDForQuestionAnswering"),u(ke,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),u(he,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),u(Fo,"id","transformers.TFLEDModel"),u(Fo,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),u(Fo,"href","#transformers.TFLEDModel"),u(Jt,"class","relative group"),u(Fs,"href","/docs/transformers/main/en/main_classes/model#transformers.TFPreTrainedModel"),u(Jn,"href","https://www.tensorflow.org/api_docs/python/tf/keras/Model"),u(Jn,"rel","nofollow"),u(zs,"href","/docs/transformers/main/en/model_doc/led#transformers.TFLEDModel"),u(Ae,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),u(pe,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),u(Mo,"id","transformers.TFLEDForConditionalGeneration"),u(Mo,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),u(Mo,"href","#transformers.TFLEDForConditionalGeneration"),u(Yt,"class","relative group"),u(xs,"href","/docs/transformers/main/en/main_classes/model#transformers.TFPreTrainedModel"),u(ns,"href","https://www.tensorflow.org/api_docs/python/tf/keras/Model"),u(ns,"rel","nofollow"),u(Ss,"href","/docs/transformers/main/en/model_doc/led#transformers.TFLEDForConditionalGeneration"),u(Ne,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),u(ue,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8")},m(o,_){e(document.head,l),g(o,b,_),g(o,p,_),e(p,f),e(f,T),y(i,T,null),e(p,m),e(p,F),e(F,He),g(o,xe,_),g(o,j,_),e(j,te),e(te,ne),y(D,ne,null),e(j,We),e(j,K),e(K,Ue),g(o,Se,_),g(o,B,_),e(B,Re),e(B,se),e(se,ae),e(B,Ve),g(o,Me,_),g(o,W,_),e(W,Ke),g(o,Oe,_),g(o,U,_),e(U,we),e(we,Xe),g(o,me,_),g(o,M,_),e(M,P),g(o,Ce,_),g(o,x,_),e(x,C),e(C,fe),e(fe,re),e(C,Je),e(C,_e),e(_e,A),e(C,Ze),e(C,X),e(X,Ye),e(C,et),e(C,J),e(J,tt),e(C,ot),e(C,G),e(G,nt),e(C,de),e(C,ge),e(ge,Ee),e(C,N),e(C,be),e(be,Q),e(C,st),e(x,at),e(x,q),e(q,z),e(q,rt),e(rt,Le),e(q,vt),e(q,dt),e(dt,S),e(q,yt),e(x,wt),e(x,H),e(H,Et),e(H,it),e(it,Z),e(H,ie),e(H,lt),e(lt,Lt),e(H,le),e(H,je),e(je,qt),e(H,ct),e(H,ht),e(ht,qe),e(H,$t),e(x,kd),e(x,Y),e(Y,vd),e(Y,Hs),e(Hs,yd),e(Y,wd),e(Y,Ws),e(Ws,Ed),e(Y,Ld),e(Y,is),e(is,qd),e(Y,$d),e(Y,Us),e(Us,Dd),e(Y,Fd),e(Y,Rs),e(Rs,zd),e(Y,xd),e(Y,Vs),e(Vs,Sd),e(Y,Md),e(x,Od),e(x,pt),e(pt,Cd),e(pt,Ks),e(Ks,jd),e(pt,Pd),e(pt,Xs),e(Xs,Ad),e(pt,Nd),e(pt,Js),e(Js,Id),e(pt,Bd),e(x,Gd),e(x,Uo),e(Uo,Qd),e(Uo,Ro),e(Ro,Hd),e(Uo,Wd),e(x,Ud),e(x,Vo),e(Vo,Rd),e(Vo,Ko),e(Ko,Vd),e(Vo,Kd),g(o,ar,_),g(o,to,_),e(to,Xd),e(to,Xo),e(Xo,Jd),e(to,Zd),g(o,rr,_),g(o,Dt,_),e(Dt,oo),e(oo,Zs),y(Jo,Zs,null),e(Dt,Yd),e(Dt,Ys),e(Ys,ei),g(o,dr,_),g(o,$e,_),y(Zo,$e,null),e($e,ti),e($e,Ft),e(Ft,oi),e(Ft,ls),e(ls,ni),e(Ft,si),e(Ft,Yo),e(Yo,ai),e(Ft,ri),e($e,di),e($e,zt),e(zt,ii),e(zt,cs),e(cs,li),e(zt,ci),e(zt,hs),e(hs,hi),e(zt,pi),e($e,ui),y(no,$e,null),g(o,ir,_),g(o,xt,_),e(xt,so),e(so,ea),y(en,ea,null),e(xt,mi),e(xt,ta),e(ta,fi),g(o,lr,_),g(o,I,_),y(tn,I,null),e(I,_i),e(I,oa),e(oa,gi),e(I,bi),e(I,ao),e(ao,ps),e(ps,Ti),e(ao,ki),e(ao,us),e(us,vi),e(ao,yi),e(I,wi),e(I,on),e(on,Ei),e(on,ms),e(ms,Li),e(on,qi),e(I,$i),e(I,ut),y(nn,ut,null),e(ut,Di),e(ut,na),e(na,Fi),e(ut,zi),e(ut,sn),e(sn,fs),e(fs,xi),e(fs,sa),e(sa,Si),e(sn,Mi),e(sn,_s),e(_s,Oi),e(_s,aa),e(aa,Ci),e(I,ji),e(I,ro),y(an,ro,null),e(ro,Pi),e(ro,rn),e(rn,Ai),e(rn,ra),e(ra,Ni),e(rn,Ii),e(I,Bi),e(I,io),y(dn,io,null),e(io,Gi),e(io,da),e(da,Qi),e(I,Hi),e(I,gs),y(ln,gs,null),g(o,cr,_),g(o,St,_),e(St,lo),e(lo,ia),y(cn,ia,null),e(St,Wi),e(St,la),e(la,Ui),g(o,hr,_),g(o,De,_),y(hn,De,null),e(De,Ri),e(De,pn),e(pn,Vi),e(pn,ca),e(ca,Ki),e(pn,Xi),e(De,Ji),e(De,co),e(co,bs),e(bs,Zi),e(co,Yi),e(co,Ts),e(Ts,el),e(co,tl),e(De,ol),e(De,un),e(un,nl),e(un,ks),e(ks,sl),e(un,al),g(o,pr,_),g(o,Mt,_),e(Mt,ho),e(ho,ha),y(mn,ha,null),e(Mt,rl),e(Mt,pa),e(pa,dl),g(o,ur,_),g(o,Ot,_),y(fn,Ot,null),e(Ot,il),e(Ot,ua),e(ua,ll),g(o,mr,_),g(o,Ct,_),y(_n,Ct,null),e(Ct,cl),e(Ct,ma),e(ma,hl),g(o,fr,_),g(o,jt,_),y(gn,jt,null),e(jt,pl),e(jt,fa),e(fa,ul),g(o,_r,_),g(o,Pt,_),y(bn,Pt,null),e(Pt,ml),e(Pt,_a),e(_a,fl),g(o,gr,_),g(o,At,_),y(Tn,At,null),e(At,_l),e(At,ga),e(ga,gl),g(o,br,_),g(o,Nt,_),y(kn,Nt,null),e(Nt,bl),e(Nt,ba),e(ba,Tl),g(o,Tr,_),g(o,It,_),y(vn,It,null),e(It,kl),e(It,Ta),e(Ta,vl),g(o,kr,_),g(o,Bt,_),y(yn,Bt,null),e(Bt,yl),e(Bt,ka),e(ka,wl),g(o,vr,_),g(o,Gt,_),e(Gt,po),e(po,va),y(wn,va,null),e(Gt,El),e(Gt,ya),e(ya,Ll),g(o,yr,_),g(o,Fe,_),y(En,Fe,null),e(Fe,ql),e(Fe,Ln),e(Ln,$l),e(Ln,vs),e(vs,Dl),e(Ln,Fl),e(Fe,zl),e(Fe,qn),e(qn,xl),e(qn,$n),e($n,Sl),e(qn,Ml),e(Fe,Ol),e(Fe,Pe),y(Dn,Pe,null),e(Pe,Cl),e(Pe,Qt),e(Qt,jl),e(Qt,ys),e(ys,Pl),e(Qt,Al),e(Qt,wa),e(wa,Nl),e(Qt,Il),e(Pe,Bl),y(uo,Pe,null),e(Pe,Gl),y(mo,Pe,null),g(o,wr,_),g(o,Ht,_),e(Ht,fo),e(fo,Ea),y(Fn,Ea,null),e(Ht,Ql),e(Ht,La),e(La,Hl),g(o,Er,_),g(o,ze,_),y(zn,ze,null),e(ze,Wl),e(ze,xn),e(xn,Ul),e(xn,ws),e(ws,Rl),e(xn,Vl),e(ze,Kl),e(ze,Sn),e(Sn,Xl),e(Sn,Mn),e(Mn,Jl),e(Sn,Zl),e(ze,Yl),e(ze,Te),y(On,Te,null),e(Te,ec),e(Te,Wt),e(Wt,tc),e(Wt,Es),e(Es,oc),e(Wt,nc),e(Wt,qa),e(qa,sc),e(Wt,ac),e(Te,rc),y(_o,Te,null),e(Te,dc),y(go,Te,null),e(Te,ic),y(bo,Te,null),g(o,Lr,_),g(o,Ut,_),e(Ut,To),e(To,$a),y(Cn,$a,null),e(Ut,lc),e(Ut,Da),e(Da,cc),g(o,qr,_),g(o,ce,_),y(jn,ce,null),e(ce,hc),e(ce,Fa),e(Fa,pc),e(ce,uc),e(ce,Pn),e(Pn,mc),e(Pn,Ls),e(Ls,fc),e(Pn,_c),e(ce,gc),e(ce,An),e(An,bc),e(An,Nn),e(Nn,Tc),e(An,kc),e(ce,vc),e(ce,R),y(In,R,null),e(R,yc),e(R,Rt),e(Rt,wc),e(Rt,qs),e(qs,Ec),e(Rt,Lc),e(Rt,za),e(za,qc),e(Rt,$c),e(R,Dc),y(ko,R,null),e(R,Fc),y(vo,R,null),e(R,zc),y(yo,R,null),e(R,xc),y(wo,R,null),e(R,Sc),y(Eo,R,null),g(o,$r,_),g(o,Vt,_),e(Vt,Lo),e(Lo,xa),y(Bn,xa,null),e(Vt,Mc),e(Vt,Sa),e(Sa,Oc),g(o,Dr,_),g(o,he,_),y(Gn,he,null),e(he,Cc),e(he,Kt),e(Kt,jc),e(Kt,Ma),e(Ma,Pc),e(Kt,Ac),e(Kt,Oa),e(Oa,Nc),e(Kt,Ic),e(he,Bc),e(he,Qn),e(Qn,Gc),e(Qn,$s),e($s,Qc),e(Qn,Hc),e(he,Wc),e(he,Hn),e(Hn,Uc),e(Hn,Wn),e(Wn,Rc),e(Hn,Vc),e(he,Kc),e(he,ke),y(Un,ke,null),e(ke,Xc),e(ke,Xt),e(Xt,Jc),e(Xt,Ds),e(Ds,Zc),e(Xt,Yc),e(Xt,Ca),e(Ca,eh),e(Xt,th),e(ke,oh),y(qo,ke,null),e(ke,nh),y($o,ke,null),e(ke,sh),y(Do,ke,null),g(o,Fr,_),g(o,Jt,_),e(Jt,Fo),e(Fo,ja),y(Rn,ja,null),e(Jt,ah),e(Jt,Pa),e(Pa,rh),g(o,zr,_),g(o,pe,_),y(Vn,pe,null),e(pe,dh),e(pe,Kn),e(Kn,ih),e(Kn,Fs),e(Fs,lh),e(Kn,ch),e(pe,hh),e(pe,Xn),e(Xn,ph),e(Xn,Jn),e(Jn,uh),e(Xn,mh),e(pe,fh),y(zo,pe,null),e(pe,_h),e(pe,Ae),y(Zn,Ae,null),e(Ae,gh),e(Ae,Zt),e(Zt,bh),e(Zt,zs),e(zs,Th),e(Zt,kh),e(Zt,Aa),e(Aa,vh),e(Zt,yh),e(Ae,wh),y(xo,Ae,null),e(Ae,Eh),y(So,Ae,null),g(o,xr,_),g(o,Yt,_),e(Yt,Mo),e(Mo,Na),y(Yn,Na,null),e(Yt,Lh),e(Yt,Ia),e(Ia,qh),g(o,Sr,_),g(o,ue,_),y(es,ue,null),e(ue,$h),e(ue,ts),e(ts,Dh),e(ts,xs),e(xs,Fh),e(ts,zh),e(ue,xh),e(ue,os),e(os,Sh),e(os,ns),e(ns,Mh),e(os,Oh),e(ue,Ch),y(Oo,ue,null),e(ue,jh),e(ue,Ne),y(ss,Ne,null),e(Ne,Ph),e(Ne,eo),e(eo,Ah),e(eo,Ss),e(Ss,Nh),e(eo,Ih),e(eo,Ba),e(Ba,Bh),e(eo,Gh),e(Ne,Qh),y(Co,Ne,null),e(Ne,Hh),y(jo,Ne,null),Mr=!0},p(o,[_]){const as={};_&2&&(as.$$scope={dirty:_,ctx:o}),no.$set(as);const Ga={};_&2&&(Ga.$$scope={dirty:_,ctx:o}),uo.$set(Ga);const Qa={};_&2&&(Qa.$$scope={dirty:_,ctx:o}),mo.$set(Qa);const Ha={};_&2&&(Ha.$$scope={dirty:_,ctx:o}),_o.$set(Ha);const rs={};_&2&&(rs.$$scope={dirty:_,ctx:o}),go.$set(rs);const Wa={};_&2&&(Wa.$$scope={dirty:_,ctx:o}),bo.$set(Wa);const Ua={};_&2&&(Ua.$$scope={dirty:_,ctx:o}),ko.$set(Ua);const Ra={};_&2&&(Ra.$$scope={dirty:_,ctx:o}),vo.$set(Ra);const ds={};_&2&&(ds.$$scope={dirty:_,ctx:o}),yo.$set(ds);const Va={};_&2&&(Va.$$scope={dirty:_,ctx:o}),wo.$set(Va);const Ka={};_&2&&(Ka.$$scope={dirty:_,ctx:o}),Eo.$set(Ka);const Xa={};_&2&&(Xa.$$scope={dirty:_,ctx:o}),qo.$set(Xa);const Ja={};_&2&&(Ja.$$scope={dirty:_,ctx:o}),$o.$set(Ja);const Za={};_&2&&(Za.$$scope={dirty:_,ctx:o}),Do.$set(Za);const ee={};_&2&&(ee.$$scope={dirty:_,ctx:o}),zo.$set(ee);const V={};_&2&&(V.$$scope={dirty:_,ctx:o}),xo.$set(V);const Ya={};_&2&&(Ya.$$scope={dirty:_,ctx:o}),So.$set(Ya);const er={};_&2&&(er.$$scope={dirty:_,ctx:o}),Oo.$set(er);const tr={};_&2&&(tr.$$scope={dirty:_,ctx:o}),Co.$set(tr);const or={};_&2&&(or.$$scope={dirty:_,ctx:o}),jo.$set(or)},i(o){Mr||(w(i.$$.fragment,o),w(D.$$.fragment,o),w(Jo.$$.fragment,o),w(Zo.$$.fragment,o),w(no.$$.fragment,o),w(en.$$.fragment,o),w(tn.$$.fragment,o),w(nn.$$.fragment,o),w(an.$$.fragment,o),w(dn.$$.fragment,o),w(ln.$$.fragment,o),w(cn.$$.fragment,o),w(hn.$$.fragment,o),w(mn.$$.fragment,o),w(fn.$$.fragment,o),w(_n.$$.fragment,o),w(gn.$$.fragment,o),w(bn.$$.fragment,o),w(Tn.$$.fragment,o),w(kn.$$.fragment,o),w(vn.$$.fragment,o),w(yn.$$.fragment,o),w(wn.$$.fragment,o),w(En.$$.fragment,o),w(Dn.$$.fragment,o),w(uo.$$.fragment,o),w(mo.$$.fragment,o),w(Fn.$$.fragment,o),w(zn.$$.fragment,o),w(On.$$.fragment,o),w(_o.$$.fragment,o),w(go.$$.fragment,o),w(bo.$$.fragment,o),w(Cn.$$.fragment,o),w(jn.$$.fragment,o),w(In.$$.fragment,o),w(ko.$$.fragment,o),w(vo.$$.fragment,o),w(yo.$$.fragment,o),w(wo.$$.fragment,o),w(Eo.$$.fragment,o),w(Bn.$$.fragment,o),w(Gn.$$.fragment,o),w(Un.$$.fragment,o),w(qo.$$.fragment,o),w($o.$$.fragment,o),w(Do.$$.fragment,o),w(Rn.$$.fragment,o),w(Vn.$$.fragment,o),w(zo.$$.fragment,o),w(Zn.$$.fragment,o),w(xo.$$.fragment,o),w(So.$$.fragment,o),w(Yn.$$.fragment,o),w(es.$$.fragment,o),w(Oo.$$.fragment,o),w(ss.$$.fragment,o),w(Co.$$.fragment,o),w(jo.$$.fragment,o),Mr=!0)},o(o){E(i.$$.fragment,o),E(D.$$.fragment,o),E(Jo.$$.fragment,o),E(Zo.$$.fragment,o),E(no.$$.fragment,o),E(en.$$.fragment,o),E(tn.$$.fragment,o),E(nn.$$.fragment,o),E(an.$$.fragment,o),E(dn.$$.fragment,o),E(ln.$$.fragment,o),E(cn.$$.fragment,o),E(hn.$$.fragment,o),E(mn.$$.fragment,o),E(fn.$$.fragment,o),E(_n.$$.fragment,o),E(gn.$$.fragment,o),E(bn.$$.fragment,o),E(Tn.$$.fragment,o),E(kn.$$.fragment,o),E(vn.$$.fragment,o),E(yn.$$.fragment,o),E(wn.$$.fragment,o),E(En.$$.fragment,o),E(Dn.$$.fragment,o),E(uo.$$.fragment,o),E(mo.$$.fragment,o),E(Fn.$$.fragment,o),E(zn.$$.fragment,o),E(On.$$.fragment,o),E(_o.$$.fragment,o),E(go.$$.fragment,o),E(bo.$$.fragment,o),E(Cn.$$.fragment,o),E(jn.$$.fragment,o),E(In.$$.fragment,o),E(ko.$$.fragment,o),E(vo.$$.fragment,o),E(yo.$$.fragment,o),E(wo.$$.fragment,o),E(Eo.$$.fragment,o),E(Bn.$$.fragment,o),E(Gn.$$.fragment,o),E(Un.$$.fragment,o),E(qo.$$.fragment,o),E($o.$$.fragment,o),E(Do.$$.fragment,o),E(Rn.$$.fragment,o),E(Vn.$$.fragment,o),E(zo.$$.fragment,o),E(Zn.$$.fragment,o),E(xo.$$.fragment,o),E(So.$$.fragment,o),E(Yn.$$.fragment,o),E(es.$$.fragment,o),E(Oo.$$.fragment,o),E(ss.$$.fragment,o),E(Co.$$.fragment,o),E(jo.$$.fragment,o),Mr=!1},d(o){t(l),o&&t(b),o&&t(p),L(i),o&&t(xe),o&&t(j),L(D),o&&t(Se),o&&t(B),o&&t(Me),o&&t(W),o&&t(Oe),o&&t(U),o&&t(me),o&&t(M),o&&t(Ce),o&&t(x),o&&t(ar),o&&t(to),o&&t(rr),o&&t(Dt),L(Jo),o&&t(dr),o&&t($e),L(Zo),L(no),o&&t(ir),o&&t(xt),L(en),o&&t(lr),o&&t(I),L(tn),L(nn),L(an),L(dn),L(ln),o&&t(cr),o&&t(St),L(cn),o&&t(hr),o&&t(De),L(hn),o&&t(pr),o&&t(Mt),L(mn),o&&t(ur),o&&t(Ot),L(fn),o&&t(mr),o&&t(Ct),L(_n),o&&t(fr),o&&t(jt),L(gn),o&&t(_r),o&&t(Pt),L(bn),o&&t(gr),o&&t(At),L(Tn),o&&t(br),o&&t(Nt),L(kn),o&&t(Tr),o&&t(It),L(vn),o&&t(kr),o&&t(Bt),L(yn),o&&t(vr),o&&t(Gt),L(wn),o&&t(yr),o&&t(Fe),L(En),L(Dn),L(uo),L(mo),o&&t(wr),o&&t(Ht),L(Fn),o&&t(Er),o&&t(ze),L(zn),L(On),L(_o),L(go),L(bo),o&&t(Lr),o&&t(Ut),L(Cn),o&&t(qr),o&&t(ce),L(jn),L(In),L(ko),L(vo),L(yo),L(wo),L(Eo),o&&t($r),o&&t(Vt),L(Bn),o&&t(Dr),o&&t(he),L(Gn),L(Un),L(qo),L($o),L(Do),o&&t(Fr),o&&t(Jt),L(Rn),o&&t(zr),o&&t(pe),L(Vn),L(zo),L(Zn),L(xo),L(So),o&&t(xr),o&&t(Yt),L(Yn),o&&t(Sr),o&&t(ue),L(es),L(Oo),L(ss),L(Co),L(jo)}}}const fm={local:"led",sections:[{local:"overview",title:"Overview"},{local:"transformers.LEDConfig",title:"LEDConfig"},{local:"transformers.LEDTokenizer",title:"LEDTokenizer"},{local:"transformers.LEDTokenizerFast",title:"LEDTokenizerFast"},{local:"transformers.models.led.modeling_led.LEDEncoderBaseModelOutput",title:"LED specific outputs"},{local:"transformers.LEDModel",title:"LEDModel"},{local:"transformers.LEDForConditionalGeneration",title:"LEDForConditionalGeneration"},{local:"transformers.LEDForSequenceClassification",title:"LEDForSequenceClassification"},{local:"transformers.LEDForQuestionAnswering",title:"LEDForQuestionAnswering"},{local:"transformers.TFLEDModel",title:"TFLEDModel"},{local:"transformers.TFLEDForConditionalGeneration",title:"TFLEDForConditionalGeneration"}],title:"LED"};function _m($){return Ru(()=>{new URLSearchParams(window.location.search).get("fw")}),[]}class wm extends Qu{constructor(l){super();Hu(this,l,_m,mm,Wu,{})}}export{wm as default,fm as metadata};
