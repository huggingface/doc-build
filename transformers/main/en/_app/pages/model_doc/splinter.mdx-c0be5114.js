...
special tokens using the tokenizer `),tn=o("code"),As=a("prepare_for_model"),Ps=a(" method."),Fs=d(),W=o("div"),u(Oe.$$.fragment),Ms=d(),yt=o("p"),Is=a("Create the token type IDs corresponding to the sequences passed. "),Tt=o("a"),Cs=a(`What are token type
...
one also has the pretrained wights of the QASS layer (`),Wt=s(B,"EM",{});var ua=r(Wt);Fo=i(ua,"tau/splinter-base-qass"),ua.forEach(n),Mo=i(B," and "),Ut=s(B,"EM",{});var fa=r(Ut);Io=i(fa,"tau/splinter-large-qass"),fa.forEach(n),Co=i(B,`) and one
