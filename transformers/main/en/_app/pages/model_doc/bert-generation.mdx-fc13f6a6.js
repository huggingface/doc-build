import{S as sa,i as aa,s as ia,e as s,k as h,w as k,t as n,M as da,c as a,d as o,m as p,a as i,x as w,h as r,b as l,F as e,g as u,y,q as T,o as $,B as E,v as la,L as Zr}from"../../chunks/vendor-6b77c823.js";import{T as ra}from"../../chunks/Tip-39098574.js";import{D as Je}from"../../chunks/Docstring-1088f2fb.js";import{C as Qt}from"../../chunks/CodeBlock-3a8b25a8.js";import{I as yt}from"../../chunks/IconCopyLink-7a11ce68.js";import{E as Yr}from"../../chunks/ExampleCodeBlock-5212b321.js";function ca(j){let m,v,_,f,b;return f=new Qt({props:{code:`from transformers import BertGenerationConfig, BertGenerationEncoder
...
<span class="hljs-meta">&gt;&gt;&gt; </span>configuration = model.config`}}),{c(){m=s("p"),v=n("Examples:"),_=h(),k(f.$$.fragment)},l(d){m=a(d,"P",{});var g=i(m);v=r(g,"Examples:"),g.forEach(o),_=p(d),w(f.$$.fragment,d)},m(d,g){u(d,m,g),e(m,v),u(d,_,g),y(f,d,g),b=!0},p:Zr,i(d){b||(T(f.$$.fragment,d),b=!0)},o(d){$(f.$$.fragment,d),b=!1},d(d){d&&o(m),d&&o(_),E(f,d)}}}function ha(j){let m,v,_,f,b;return{c(){m=s("p"),v=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),_=s("code"),f=n("Module"),b=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(d){m=a(d,"P",{});var g=i(m);v=r(g,"Although the recipe for forward pass needs to be defined within this function, one should call the "),_=a(g,"CODE",{});var A=i(_);f=r(A,"Module"),A.forEach(o),b=r(g,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),g.forEach(o)},m(d,g){u(d,m,g),e(m,v),e(m,_),e(_,f),e(m,b)},d(d){d&&o(m)}}}function pa(j){let m,v,_,f,b;return f=new Qt({props:{code:`from transformers import BertGenerationTokenizer, BertGenerationEncoder
import torch
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),{c(){m=s("p"),v=n("Example:"),_=h(),k(f.$$.fragment)},l(d){m=a(d,"P",{});var g=i(m);v=r(g,"Example:"),g.forEach(o),_=p(d),w(f.$$.fragment,d)},m(d,g){u(d,m,g),e(m,v),u(d,_,g),y(f,d,g),b=!0},p:Zr,i(d){b||(T(f.$$.fragment,d),b=!0)},o(d){$(f.$$.fragment,d),b=!1},d(d){d&&o(m),d&&o(_),E(f,d)}}}function ma(j){let m,v,_,f,b;return{c(){m=s("p"),v=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),_=s("code"),f=n("Module"),b=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(d){m=a(d,"P",{});var g=i(m);v=r(g,"Although the recipe for forward pass needs to be defined within this function, one should call the "),_=a(g,"CODE",{});var A=i(_);f=r(A,"Module"),A.forEach(o),b=r(g,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),g.forEach(o)},m(d,g){u(d,m,g),e(m,v),e(m,_),e(_,f),e(m,b)},d(d){d&&o(m)}}}function ua(j){let m,v,_,f,b;return f=new Qt({props:{code:`from transformers import BertGenerationTokenizer, BertGenerationDecoder, BertGenerationConfig
import torch
...
<span class="hljs-meta">&gt;&gt;&gt; </span>prediction_logits = outputs.logits`}}),{c(){m=s("p"),v=n("Example:"),_=h(),k(f.$$.fragment)},l(d){m=a(d,"P",{});var g=i(m);v=r(g,"Example:"),g.forEach(o),_=p(d),w(f.$$.fragment,d)},m(d,g){u(d,m,g),e(m,v),u(d,_,g),y(f,d,g),b=!0},p:Zr,i(d){b||(T(f.$$.fragment,d),b=!0)},o(d){$(f.$$.fragment,d),b=!1},d(d){d&&o(m),d&&o(_),E(f,d)}}}function fa(j){let m,v,_,f,b,d,g,A,Do,Xt,I,X,Tt,pe,So,$t,Ao,Yt,M,Mo,Ke,Lo,No,me,Fo,Io,Zt,Qe,Oo,eo,Xe,Et,Ro,to,Ye,Wo,oo,Ze,ue,Uo,et,Ho,Vo,no,fe,ro,tt,ge,Jo,ot,Ko,Qo,so,_e,ao,nt,Xo,io,Y,L,rt,Yo,Zo,st,en,tn,Bt,on,nn,rn,zt,sn,lo,N,an,be,dn,ln,ve,cn,hn,co,O,Z,Gt,ke,pn,qt,mn,ho,P,we,un,R,fn,xt,gn,_n,ye,bn,vn,kn,W,wn,at,yn,Tn,it,$n,En,Bn,ee,po,U,te,Pt,Te,zn,Ct,Gn,mo,C,$e,qn,Ee,xn,Be,Pn,Cn,jn,ze,Dn,dt,Sn,An,Mn,lt,Ge,uo,H,oe,jt,qe,Ln,Dt,Nn,fo,B,xe,Fn,St,In,On,Pe,Rn,ct,Wn,Un,Hn,Ce,Vn,je,Jn,Kn,Qn,De,Xn,Se,Yn,Zn,er,V,tr,ht,or,nr,Ae,rr,sr,ar,z,ir,At,dr,lr,Mt,cr,hr,Lt,pr,mr,Nt,ur,fr,Ft,gr,_r,It,br,vr,kr,D,Me,wr,J,yr,pt,Tr,$r,Ot,Er,Br,zr,ne,Gr,re,go,K,se,Rt,Le,qr,Wt,xr,_o,q,Ne,Pr,Fe,Cr,Ut,jr,Dr,Sr,Ie,Ar,mt,Mr,Lr,Nr,Oe,Fr,Re,Ir,Or,Rr,S,We,Wr,Q,Ur,ut,Hr,Vr,Ht,Jr,Kr,Qr,ae,Xr,ie,bo;return d=new yt({}),pe=new yt({}),fe=new Qt({props:{code:`# leverage checkpoints for Bert2Bert model...
...
<code>past_key_values</code>).`,name:"use_cache"}],source:"https://github.com/huggingface/transformers/blob/vmain/src/transformers/models/bert_generation/modeling_bert_generation.py#L294",returnDescription:`
<p>A <a
...
If set to <code>True</code>, <code>past_key_values</code> key value states are returned and can be used to speed up decoding (see
<code>past_key_values</code>).`,name:"use_cache"}],source:"https://github.com/huggingface/transformers/blob/vmain/src/transformers/models/bert_generation/modeling_bert_generation.py#L461",returnDescription:`
<p>A <a
...
`}}),ae=new ra({props:{$$slots:{default:[ma]},$$scope:{ctx:j}}}),ie=new Yr({props:{anchor:"transformers.BertGenerationDecoder.forward.example",$$slots:{default:[ua]},$$scope:{ctx:j}}}),{c(){m=s("meta"),v=h(),_=s("h1"),f=s("a"),b=s("span"),k(d.$$.fragment),g=h(),A=s("span"),Do=n("BertGeneration"),Xt=h(),I=s("h2"),X=s("a"),Tt=s("span"),k(pe.$$.fragment),So=h(),$t=s("span"),Ao=n("Overview"),Yt=h(),M=s("p"),Mo=n(`The BertGeneration model is a BERT model that can be leveraged for sequence-to-sequence tasks using
`),Ke=s("a"),Lo=n("EncoderDecoderModel"),No=n(" as proposed in "),me=s("a"),Fo=n(`Leveraging Pre-trained Checkpoints for Sequence Generation
...
Text Summarization, Sentence Splitting, and Sentence Fusion.`),to=h(),Ye=s("p"),Wo=n("Usage:"),oo=h(),Ze=s("ul"),ue=s("li"),Uo=n("The model can be used in combination with the "),et=s("a"),Ho=n("EncoderDecoderModel"),Vo=n(` to leverage two pretrained
BERT checkpoints for subsequent fine-tuning.`),no=h(),k(fe.$$.fragment),ro=h(),tt=s("ul"),ge=s("li"),Jo=n("Pretrained "),ot=s("a"),Ko=n("EncoderDecoderModel"),Qo=n(" are also directly available in the model hub, e.g.,"),so=h(),k(_e.$$.fragment),ao=h(),nt=s("p"),Xo=n("Tips:"),io=h(),Y=s("ul"),L=s("li"),rt=s("a"),Yo=n("BertGenerationEncoder"),Zo=n(" and "),st=s("a"),en=n("BertGenerationDecoder"),tn=n(` should be used in
...
found `),ve=s("a"),cn=n("here"),hn=n("."),co=h(),O=s("h2"),Z=s("a"),Gt=s("span"),k(ke.$$.fragment),pn=h(),qt=s("span"),mn=n("BertGenerationConfig"),ho=h(),P=s("div"),k(we.$$.fragment),un=h(),R=s("p"),fn=n("This is the configuration class to store the configuration of a "),xt=s("code"),gn=n("BertGenerationPreTrainedModel"),_n=n(`. It is used to
...
to `),Mt=s("code"),cr=n("True"),hr=n(". To be used in a Seq2Seq model, the model needs to initialized with both "),Lt=s("code"),pr=n("is_decoder"),mr=n(` argument and
`),Nt=s("code"),ur=n("add_cross_attention"),fr=n(" set to "),Ft=s("code"),gr=n("True"),_r=n("; an "),It=s("code"),br=n("encoder_hidden_states"),vr=n(" is then expected as an input to the forward pass."),kr=h(),D=s("div"),k(Me.$$.fragment),wr=h(),J=s("p"),yr=n("The "),pt=s("a"),Tr=n("BertGenerationEncoder"),$r=n(" forward method, overrides the "),Ot=s("code"),Er=n("__call__"),Br=n(" special method."),zr=h(),k(ne.$$.fragment),Gr=h(),k(re.$$.fragment),go=h(),K=s("h2"),se=s("a"),Rt=s("span"),k(Le.$$.fragment),qr=h(),Wt=s("span"),xr=n("BertGenerationDecoder"),_o=h(),q=s("div"),k(Ne.$$.fragment),Pr=h(),Fe=s("p"),Cr=n("BertGeneration Model with a "),Ut=s("code"),jr=n("language modeling"),Dr=n(" head on top for CLM fine-tuning."),Sr=h(),Ie=s("p"),Ar=n("This model inherits from "),mt=s("a"),Mr=n("PreTrainedModel"),Lr=n(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Nr=h(),Oe=s("p"),Fr=n("This model is also a PyTorch "),Re=s("a"),Ir=n("torch.nn.Module"),Or=n(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Rr=h(),S=s("div"),k(We.$$.fragment),Wr=h(),Q=s("p"),Ur=n("The "),ut=s("a"),Hr=n("BertGenerationDecoder"),Vr=n(" forward method, overrides the "),Ht=s("code"),Jr=n("__call__"),Kr=n(" special method."),Qr=h(),k(ae.$$.fragment),Xr=h(),k(ie.$$.fragment),this.h()},l(t){const c=da('[data-svelte="svelte-1phssyn"]',document.head);m=a(c,"META",{name:!0,content:!0}),c.forEach(o),v=p(t),_=a(t,"H1",{class:!0});var Ue=i(_);f=a(Ue,"A",{id:!0,class:!0,href:!0});var Vt=i(f);b=a(Vt,"SPAN",{});var Jt=i(b);w(d.$$.fragment,Jt),Jt.forEach(o),Vt.forEach(o),g=p(Ue),A=a(Ue,"SPAN",{});var Kt=i(A);Do=r(Kt,"BertGeneration"),Kt.forEach(o),Ue.forEach(o),Xt=p(t),I=a(t,"H2",{class:!0});var He=i(I);X=a(He,"A",{id:!0,class:!0,href:!0});var es=i(X);Tt=a(es,"SPAN",{});var ts=i(Tt);w(pe.$$.fragment,ts),ts.forEach(o),es.forEach(o),So=p(He),$t=a(He,"SPAN",{});var os=i($t);Ao=r(os,"Overview"),os.forEach(o),He.forEach(o),Yt=p(t),M=a(t,"P",{});var ft=i(M);Mo=r(ft,`The BertGeneration model is a BERT model that can be leveraged for sequence-to-sequence tasks using
`),Ke=a(ft,"A",{href:!0});var ns=i(Ke);Lo=r(ns,"EncoderDecoderModel"),ns.forEach(o),No=r(ft," as proposed in "),me=a(ft,"A",{href:!0,rel:!0});var rs=i(me);Fo=r(rs,`Leveraging Pre-trained Checkpoints for Sequence Generation
Tasks`),rs.forEach(o),Io=r(ft," by Sascha Rothe, Shashi Narayan, Aliaksei Severyn."),ft.forEach(o),Zt=p(t),Qe=a(t,"P",{});var ss=i(Qe);Oo=r(ss,"The abstract from the paper is the following:"),ss.forEach(o),eo=p(t),Xe=a(t,"P",{});var as=i(Xe);Et=a(as,"EM",{});var is=i(Et);Ro=r(is,`Unsupervised pretraining of large neural models has recently revolutionized Natural Language Processing. By
warm-starting from the publicly released checkpoints, NLP practitioners have pushed the state-of-the-art on multiple
benchmarks while saving significant amounts of compute time. So far the focus has been mainly on the Natural Language
Understanding tasks. In this paper, we demonstrate the efficacy of pre-trained checkpoints for Sequence Generation. We
developed a Transformer-based sequence-to-sequence model that is compatible with publicly available pre-trained BERT,
GPT-2 and RoBERTa checkpoints and conducted an extensive empirical study on the utility of initializing our model, both
encoder and decoder, with these checkpoints. Our models result in new state-of-the-art results on Machine Translation,
Text Summarization, Sentence Splitting, and Sentence Fusion.`),is.forEach(o),as.forEach(o),to=p(t),Ye=a(t,"P",{});var ds=i(Ye);Wo=r(ds,"Usage:"),ds.forEach(o),oo=p(t),Ze=a(t,"UL",{});var ls=i(Ze);ue=a(ls,"LI",{});var vo=i(ue);Uo=r(vo,"The model can be used in combination with the "),et=a(vo,"A",{href:!0});var cs=i(et);Ho=r(cs,"EncoderDecoderModel"),cs.forEach(o),Vo=r(vo,` to leverage two pretrained
BERT checkpoints for subsequent fine-tuning.`),vo.forEach(o),ls.forEach(o),no=p(t),w(fe.$$.fragment,t),ro=p(t),tt=a(t,"UL",{});var hs=i(tt);ge=a(hs,"LI",{});var ko=i(ge);Jo=r(ko,"Pretrained "),ot=a(ko,"A",{href:!0});var ps=i(ot);Ko=r(ps,"EncoderDecoderModel"),ps.forEach(o),Qo=r(ko," are also directly available in the model hub, e.g.,"),ko.forEach(o),hs.forEach(o),so=p(t),w(_e.$$.fragment,t),ao=p(t),nt=a(t,"P",{});var ms=i(nt);Xo=r(ms,"Tips:"),ms.forEach(o),io=p(t),Y=a(t,"UL",{});var wo=i(Y);L=a(wo,"LI",{});var Ve=i(L);rt=a(Ve,"A",{href:!0});var us=i(rt);Yo=r(us,"BertGenerationEncoder"),us.forEach(o),Zo=r(Ve," and "),st=a(Ve,"A",{href:!0});var fs=i(st);en=r(fs,"BertGenerationDecoder"),fs.forEach(o),tn=r(Ve,` should be used in
...
found `),ve=a(gt,"A",{href:!0,rel:!0});var vs=i(ve);cn=r(vs,"here"),vs.forEach(o),hn=r(gt,"."),gt.forEach(o),co=p(t),O=a(t,"H2",{class:!0});var yo=i(O);Z=a(yo,"A",{id:!0,class:!0,href:!0});var ks=i(Z);Gt=a(ks,"SPAN",{});var ws=i(Gt);w(ke.$$.fragment,ws),ws.forEach(o),ks.forEach(o),pn=p(yo),qt=a(yo,"SPAN",{});var ys=i(qt);mn=r(ys,"BertGenerationConfig"),ys.forEach(o),yo.forEach(o),ho=p(t),P=a(t,"DIV",{class:!0});var de=i(P);w(we.$$.fragment,de),un=p(de),R=a(de,"P",{});var _t=i(R);fn=r(_t,"This is the configuration class to store the configuration of a "),xt=a(_t,"CODE",{});var Ts=i(xt);gn=r(Ts,"BertGenerationPreTrainedModel"),Ts.forEach(o),_n=r(_t,`. It is used to
instantiate a BertGeneration model according to the specified arguments, defining the model architecture.
Instantiating a configuration with the defaults will yield a similar configuration to that of the BertGeneration
