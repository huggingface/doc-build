import{S as gm,i as _m,s as km,e as o,k as d,w as M,t as r,M as vm,c as s,d as t,m as c,a,x as b,h as i,b as p,G as e,g,y,q as x,o as w,B as $,v as Tm,L as jt}from"../../chunks/vendor-hf-doc-builder.js";import{T as bn}from"../../chunks/Tip-hf-doc-builder.js";import{D as B}from"../../chunks/Docstring-hf-doc-builder.js";import{C as ye}from"../../chunks/CodeBlock-hf-doc-builder.js";import{I as de}from"../../chunks/IconCopyLink-hf-doc-builder.js";import{E as zt}from"../../chunks/ExampleCodeBlock-hf-doc-builder.js";function Mm(z){let h,v,_,u,k;return u=new ye({props:{code:`from transformers import MarianModel, MarianConfig
...
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-comment"># should give *Meine Freunde sind cool, aber sie essen zu viele Kohlenhydrate.*</span>`}}),{c(){h=o("p"),v=r("Example:"),_=d(),M(u.$$.fragment)},l(l){h=s(l,"P",{});var m=a(h);v=i(m,"Example:"),m.forEach(t),_=c(l),b(u.$$.fragment,l)},m(l,m){g(l,h,m),e(h,v),g(l,_,m),y(u,l,m),k=!0},p:jt,i(l){k||(x(u.$$.fragment,l),k=!0)},o(l){w(u.$$.fragment,l),k=!1},d(l){l&&t(h),l&&t(_),$(u,l)}}}function Om(z){let h,v,_,u,k,l,m,j,Ce,ce,E,ue,Y,Le,K,Z,Ie,xe,G,O,we,L,F,N,X,Q,me,Ae,J,P,fe,C,Oe,ee,ge,te,ne,oe,Se,S,He,H,D,T,q,_e,Ke,ke,U,Ze,Xe,De,I,se,Qe,Ue,W,et,tt,ae,ve,bi,ts,yi,xi,wi,nt,yn,$i,Ps,zi,ji,qi,xn,Ei,Ns,Fi,Pi,Ni,ot,Ci,Cs,Li,Ii,Ls,Ai,Oi,Si,Is,wn,Hi,As,Di,Ui,Wi,Os,$n,Ri,zn,Vi,Bi,Za,st,qt,Ss,jn,Gi,Hs,Ji,Xa,$e,ns,Yi,Ds,Ki,Zi,qn,Xi,En,Qi,el,tl,at,nl,Us,ol,sl,Ws,al,rl,il,Rs,ll,Qa,rt,Et,Vs,Fn,dl,Bs,cl,er,Ft,Gs,pl,hl,Js,Pn,ul,tr,it,Pt,Ys,Nn,ml,Ks,fl,nr,ze,Cn,gl,Zs,_l,kl,vl,Ln,Tl,Xs,Ml,bl,yl,In,xl,An,wl,$l,zl,On,jl,Qs,ql,El,or,Nt,Fl,Sn,Pl,Nl,sr,Hn,ar,os,Cl,rr,Dn,ir,lt,Ct,ea,Un,Ll,ta,Il,lr,ss,Al,dr,Wn,cr,as,Ol,pr,Rn,hr,dt,Lt,na,Vn,Sl,oa,Hl,ur,Te,Bn,Dl,ct,Ul,rs,Wl,Rl,Gn,Vl,Bl,Gl,pt,Jl,is,Yl,Kl,ls,Zl,Xl,Ql,It,mr,ht,At,sa,Jn,ed,aa,td,fr,re,Yn,nd,Kn,od,Zn,sd,ad,rd,Xn,id,ds,ld,dd,cd,Ot,pd,St,Qn,hd,ra,ud,gr,ut,Ht,ia,eo,md,la,fd,_r,Me,to,gd,no,_d,cs,kd,vd,Td,oo,Md,so,bd,yd,xd,je,ao,wd,mt,$d,ps,zd,jd,da,qd,Ed,Fd,Dt,Pd,Ut,kr,ft,Wt,ca,ro,Nd,pa,Cd,vr,be,io,Ld,lo,Id,hs,Ad,Od,Sd,co,Hd,po,Dd,Ud,Wd,pe,ho,Rd,gt,Vd,us,Bd,Gd,ha,Jd,Yd,Kd,Rt,Zd,uo,Xd,mo,Qd,ec,tc,Vt,Tr,_t,Bt,ua,fo,nc,ma,oc,Mr,kt,go,sc,Gt,_o,ac,Jt,br,vt,Yt,fa,ko,rc,ga,ic,yr,ie,vo,lc,To,dc,ms,cc,pc,hc,Mo,uc,bo,mc,fc,gc,Kt,_c,qe,yo,kc,Tt,vc,fs,Tc,Mc,_a,bc,yc,xc,Zt,wc,Xt,xr,Mt,Qt,ka,xo,$c,va,zc,wr,le,wo,jc,$o,qc,gs,Ec,Fc,Pc,zo,Nc,jo,Cc,Lc,Ic,en,Ac,he,qo,Oc,bt,Sc,_s,Hc,Dc,Ta,Uc,Wc,Rc,tn,Vc,Eo,Bc,Fo,Gc,Jc,Yc,nn,$r,yt,on,Ma,Po,Kc,ba,Zc,zr,R,No,Xc,Co,Qc,ks,ep,tp,np,Lo,op,Io,sp,ap,rp,ya,ip,lp,We,xa,Ao,dp,cp,wa,Oo,pp,hp,$a,So,up,mp,za,Ho,fp,gp,Ee,Do,_p,xt,kp,ja,vp,Tp,qa,Mp,bp,yp,sn,xp,an,jr,wt,rn,Ea,Uo,wp,Fa,$p,qr,V,Wo,zp,Ro,jp,vs,qp,Ep,Fp,Vo,Pp,Bo,Np,Cp,Lp,Pa,Ip,Ap,Re,Na,Go,Op,Sp,Ca,Jo,Hp,Dp,La,Yo,Up,Wp,Ia,Ko,Rp,Vp,Fe,Zo,Bp,$t,Gp,Aa,Jp,Yp,Oa,Kp,Zp,Xp,ln,Qp,dn,Er;return l=new de({}),X=new de({}),jn=new de({}),Fn=new de({}),Nn=new de({}),Hn=new ye({props:{code:`from transformers import MarianMTModel, MarianTokenizer
...
<code>eos_token_id</code>.`,name:"forced_eos_token_id"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/marian/configuration_marian.py#L34"}}),It=new zt({props:{anchor:"transformers.MarianConfig.example",$$slots:{default:[Mm]},$$scope:{ctx:z}}}),Jn=new de({}),Yn=new B({props:{name:"class transformers.MarianTokenizer",anchor:"transformers.MarianTokenizer",parameters:[{name:"source_spm",val:""},{name:"target_spm",val:""},{name:"vocab",val:""},{name:"target_vocab_file",val:" = None"},{name:"source_lang",val:" = None"},{name:"target_lang",val:" = None"},{name:"unk_token",val:" = '<unk>'"},{name:"eos_token",val:" = '</s>'"},{name:"pad_token",val:" = '<pad>'"},{name:"model_max_length",val:" = 512"},{name:"sp_model_kwargs",val:": typing.Union[typing.Dict[str, typing.Any], NoneType] = None"},{name:"separate_vocabs",val:" = False"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.MarianTokenizer.source_spm",description:`<strong>source_spm</strong> (<code>str</code>) &#x2014;
...
`}}),Jt=new zt({props:{anchor:"transformers.MarianForCausalLM.forward.example",$$slots:{default:[zm]},$$scope:{ctx:z}}}),ko=new de({}),vo=new B({props:{name:"class transformers.TFMarianModel",anchor:"transformers.TFMarianModel",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.TFMarianModel.config",description:`<strong>config</strong> (<a href="/docs/transformers/main/en/model_doc/marian#transformers.MarianConfig">MarianConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
