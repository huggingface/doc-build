import{S as gm,i as _m,s as km,e as o,k as l,w as M,t as r,M as vm,c as s,d as t,m as c,a,x as b,h as i,b as p,G as e,g,y,q as x,o as w,B as $,v as Tm,L as jt}from"../../chunks/vendor-hf-doc-builder.js";import{T as bn}from"../../chunks/Tip-hf-doc-builder.js";import{D as B}from"../../chunks/Docstring-hf-doc-builder.js";import{C as ye}from"../../chunks/CodeBlock-hf-doc-builder.js";import{I as le}from"../../chunks/IconCopyLink-hf-doc-builder.js";import{E as zt}from"../../chunks/ExampleCodeBlock-hf-doc-builder.js";function Mm(z){let h,v,_,u,k;return u=new ye({props:{code:`from transformers import MarianModel, MarianConfig
...
<span class="hljs-meta">&gt;&gt;&gt; </span>configuration = model.config`}}),{c(){h=o("p"),v=r("Examples:"),_=l(),M(u.$$.fragment)},l(d){h=s(d,"P",{});var m=a(h);v=i(m,"Examples:"),m.forEach(t),_=c(d),b(u.$$.fragment,d)},m(d,m){g(d,h,m),e(h,v),g(d,_,m),y(u,d,m),k=!0},p:jt,i(d){k||(x(u.$$.fragment,d),k=!0)},o(d){w(u.$$.fragment,d),k=!1},d(d){d&&t(h),d&&t(_),$(u,d)}}}function bm(z){let h,v,_,u,k;return u=new ye({props:{code:`from transformers import MarianTokenizer
...
<span class="hljs-meta">&gt;&gt;&gt; </span>outputs = model(**inputs)  <span class="hljs-comment"># should work</span>`}}),{c(){h=o("p"),v=r("Examples:"),_=l(),M(u.$$.fragment)},l(d){h=s(d,"P",{});var m=a(h);v=i(m,"Examples:"),m.forEach(t),_=c(d),b(u.$$.fragment,d)},m(d,m){g(d,h,m),e(h,v),g(d,_,m),y(u,d,m),k=!0},p:jt,i(d){k||(x(u.$$.fragment,d),k=!0)},o(d){w(u.$$.fragment,d),k=!1},d(d){d&&t(h),d&&t(_),$(u,d)}}}function ym(z){let h,v,_,u,k;return{c(){h=o("p"),v=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),_=o("code"),u=r("Module"),k=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(d){h=s(d,"P",{});var m=a(h);v=i(m,"Although the recipe for forward pass needs to be defined within this function, one should call the "),_=s(m,"CODE",{});var j=a(_);u=i(j,"Module"),j.forEach(t),k=i(m,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),m.forEach(t)},m(d,m){g(d,h,m),e(h,v),e(h,_),e(_,u),e(h,k)},d(d){d&&t(h)}}}function xm(z){let h,v,_,u,k;return u=new ye({props:{code:`from transformers import MarianTokenizer, MarianModel
...
[<span class="hljs-number">1</span>, <span class="hljs-number">26</span>, <span class="hljs-number">512</span>]`}}),{c(){h=o("p"),v=r("Example:"),_=l(),M(u.$$.fragment)},l(d){h=s(d,"P",{});var m=a(h);v=i(m,"Example:"),m.forEach(t),_=c(d),b(u.$$.fragment,d)},m(d,m){g(d,h,m),e(h,v),g(d,_,m),y(u,d,m),k=!0},p:jt,i(d){k||(x(u.$$.fragment,d),k=!0)},o(d){w(u.$$.fragment,d),k=!1},d(d){d&&t(h),d&&t(_),$(u,d)}}}function wm(z){let h,v,_,u,k;return{c(){h=o("p"),v=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),_=o("code"),u=r("Module"),k=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(d){h=s(d,"P",{});var m=a(h);v=i(m,"Although the recipe for forward pass needs to be defined within this function, one should call the "),_=s(m,"CODE",{});var j=a(_);u=i(j,"Module"),j.forEach(t),k=i(m,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),m.forEach(t)},m(d,m){g(d,h,m),e(h,v),e(h,_),e(_,u),e(h,k)},d(d){d&&t(h)}}}function $m(z){let h,v,_,u,k;return u=new ye({props:{code:`from transformers import MarianTokenizer, MarianMTModel
...
<span class="hljs-literal">True</span>`}}),{c(){h=o("p"),v=r("Example:"),_=l(),M(u.$$.fragment)},l(d){h=s(d,"P",{});var m=a(h);v=i(m,"Example:"),m.forEach(t),_=c(d),b(u.$$.fragment,d)},m(d,m){g(d,h,m),e(h,v),g(d,_,m),y(u,d,m),k=!0},p:jt,i(d){k||(x(u.$$.fragment,d),k=!0)},o(d){w(u.$$.fragment,d),k=!1},d(d){d&&t(h),d&&t(_),$(u,d)}}}function jm(z){let h,v,_,u,k,d,m,j,Ce,ce,E,ue,Y,Le,K,Z,Ie,xe,G,O,we,L,F,N,X,Q,me,Ae,J,P,fe,C,Oe,ee,ge,te,ne,oe,Se,S,He,H,D;return{c(){h=o("p"),v=r("TF 2.0 models accepts two formats as inputs:"),_=l(),u=o("ul"),k=o("li"),d=r("having all inputs as keyword arguments (like PyTorch models), or"),m=l(),j=o("li"),Ce=r("having all inputs as a list, tuple or dict in the first positional arguments."),ce=l(),E=o("p"),ue=r("This second option is useful when using "),Y=o("code"),Le=r("tf.keras.Model.fit"),K=r(` method which currently requires having all the
tensors in the first argument of the model call function: `),Z=o("code"),Ie=r("model(inputs)"),xe=r("."),G=l(),O=o("p"),we=r(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),L=l(),F=o("ul"),N=o("li"),X=r("a single Tensor with "),Q=o("code"),me=r("input_ids"),Ae=r(" only and nothing else: "),J=o("code"),P=r("model(input_ids)"),fe=l(),C=o("li"),Oe=r(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),ee=o("code"),ge=r("model([input_ids, attention_mask])"),te=r(" or "),ne=o("code"),oe=r("model([input_ids, attention_mask, token_type_ids])"),Se=l(),S=o("li"),He=r(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),H=o("code"),D=r('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(T){h=s(T,"P",{});var q=a(h);v=i(q,"TF 2.0 models accepts two formats as inputs:"),q.forEach(t),_=c(T),u=s(T,"UL",{});var _e=a(u);k=s(_e,"LI",{});var Ke=a(k);d=i(Ke,"having all inputs as keyword arguments (like PyTorch models), or"),Ke.forEach(t),m=c(_e),j=s(_e,"LI",{});var ke=a(j);Ce=i(ke,"having all inputs as a list, tuple or dict in the first positional arguments."),ke.forEach(t),_e.forEach(t),ce=c(T),E=s(T,"P",{});var U=a(E);ue=i(U,"This second option is useful when using "),Y=s(U,"CODE",{});var Ze=a(Y);Le=i(Ze,"tf.keras.Model.fit"),Ze.forEach(t),K=i(U,` method which currently requires having all the
...
`),H=s(ae,"CODE",{});var ve=a(H);D=i(ve,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),ve.forEach(t),ae.forEach(t),I.forEach(t)},m(T,q){g(T,h,q),e(h,v),g(T,_,q),g(T,u,q),e(u,k),e(k,d),e(u,m),e(u,j),e(j,Ce),g(T,ce,q),g(T,E,q),e(E,ue),e(E,Y),e(Y,Le),e(E,K),e(E,Z),e(Z,Ie),e(E,xe),g(T,G,q),g(T,O,q),e(O,we),g(T,L,q),g(T,F,q),e(F,N),e(N,X),e(N,Q),e(Q,me),e(N,Ae),e(N,J),e(J,P),e(F,fe),e(F,C),e(C,Oe),e(C,ee),e(ee,ge),e(C,te),e(C,ne),e(ne,oe),e(F,Se),e(F,S),e(S,He),e(S,H),e(H,D)},d(T){T&&t(h),T&&t(_),T&&t(u),T&&t(ce),T&&t(E),T&&t(G),T&&t(O),T&&t(L),T&&t(F)}}}function qm(z){let h,v,_,u,k;return{c(){h=o("p"),v=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),_=o("code"),u=r("Module"),k=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(d){h=s(d,"P",{});var m=a(h);v=i(m,"Although the recipe for forward pass needs to be defined within this function, one should call the "),_=s(m,"CODE",{});var j=a(_);u=i(j,"Module"),j.forEach(t),k=i(m,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),m.forEach(t)},m(d,m){g(d,h,m),e(h,v),e(h,_),e(_,u),e(h,k)},d(d){d&&t(h)}}}function Em(z){let h,v,_,u,k;return u=new ye({props:{code:`from transformers import MarianTokenizer, TFMarianModel
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),{c(){h=o("p"),v=r("Example:"),_=l(),M(u.$$.fragment)},l(d){h=s(d,"P",{});var m=a(h);v=i(m,"Example:"),m.forEach(t),_=c(d),b(u.$$.fragment,d)},m(d,m){g(d,h,m),e(h,v),g(d,_,m),y(u,d,m),k=!0},p:jt,i(d){k||(x(u.$$.fragment,d),k=!0)},o(d){w(u.$$.fragment,d),k=!1},d(d){d&&t(h),d&&t(_),$(u,d)}}}function Fm(z){let h,v,_,u,k,d,m,j,Ce,ce,E,ue,Y,Le,K,Z,Ie,xe,G,O,we,L,F,N,X,Q,me,Ae,J,P,fe,C,Oe,ee,ge,te,ne,oe,Se,S,He,H,D;return{c(){h=o("p"),v=r("TF 2.0 models accepts two formats as inputs:"),_=l(),u=o("ul"),k=o("li"),d=r("having all inputs as keyword arguments (like PyTorch models), or"),m=l(),j=o("li"),Ce=r("having all inputs as a list, tuple or dict in the first positional arguments."),ce=l(),E=o("p"),ue=r("This second option is useful when using "),Y=o("code"),Le=r("tf.keras.Model.fit"),K=r(` method which currently requires having all the
tensors in the first argument of the model call function: `),Z=o("code"),Ie=r("model(inputs)"),xe=r("."),G=l(),O=o("p"),we=r(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),L=l(),F=o("ul"),N=o("li"),X=r("a single Tensor with "),Q=o("code"),me=r("input_ids"),Ae=r(" only and nothing else: "),J=o("code"),P=r("model(input_ids)"),fe=l(),C=o("li"),Oe=r(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),ee=o("code"),ge=r("model([input_ids, attention_mask])"),te=r(" or "),ne=o("code"),oe=r("model([input_ids, attention_mask, token_type_ids])"),Se=l(),S=o("li"),He=r(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),H=o("code"),D=r('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(T){h=s(T,"P",{});var q=a(h);v=i(q,"TF 2.0 models accepts two formats as inputs:"),q.forEach(t),_=c(T),u=s(T,"UL",{});var _e=a(u);k=s(_e,"LI",{});var Ke=a(k);d=i(Ke,"having all inputs as keyword arguments (like PyTorch models), or"),Ke.forEach(t),m=c(_e),j=s(_e,"LI",{});var ke=a(j);Ce=i(ke,"having all inputs as a list, tuple or dict in the first positional arguments."),ke.forEach(t),_e.forEach(t),ce=c(T),E=s(T,"P",{});var U=a(E);ue=i(U,"This second option is useful when using "),Y=s(U,"CODE",{});var Ze=a(Y);Le=i(Ze,"tf.keras.Model.fit"),Ze.forEach(t),K=i(U,` method which currently requires having all the
...
first positional argument :`),De.forEach(t),L=c(T),F=s(T,"UL",{});var I=a(F);N=s(I,"LI",{});var se=a(N);X=i(se,"a single Tensor with "),Q=s(se,"CODE",{});var Qe=a(Q);me=i(Qe,"input_ids"),Qe.forEach(t),Ae=i(se," only and nothing else: "),J=s(se,"CODE",{});var Ue=a(J);P=i(Ue,"model(input_ids)"),Ue.forEach(t),se.forEach(t),fe=c(I),C=s(I,"LI",{});var W=a(C);Oe=i(W,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),ee=s(W,"CODE",{});var et=a(ee);ge=i(et,"model([input_ids, attention_mask])"),et.forEach(t),te=i(W," or "),ne=s(W,"CODE",{});var tt=a(ne);oe=i(tt,"model([input_ids, attention_mask, token_type_ids])"),tt.forEach(t),W.forEach(t),Se=c(I),S=s(I,"LI",{});var ae=a(S);He=i(ae,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),H=s(ae,"CODE",{});var ve=a(H);D=i(ve,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),ve.forEach(t),ae.forEach(t),I.forEach(t)},m(T,q){g(T,h,q),e(h,v),g(T,_,q),g(T,u,q),e(u,k),e(k,d),e(u,m),e(u,j),e(j,Ce),g(T,ce,q),g(T,E,q),e(E,ue),e(E,Y),e(Y,Le),e(E,K),e(E,Z),e(Z,Ie),e(E,xe),g(T,G,q),g(T,O,q),e(O,we),g(T,L,q),g(T,F,q),e(F,N),e(N,X),e(N,Q),e(Q,me),e(N,Ae),e(N,J),e(J,P),e(F,fe),e(F,C),e(C,Oe),e(C,ee),e(ee,ge),e(C,te),e(C,ne),e(ne,oe),e(F,Se),e(F,S),e(S,He),e(S,H),e(H,D)},d(T){T&&t(h),T&&t(_),T&&t(u),T&&t(ce),T&&t(E),T&&t(G),T&&t(O),T&&t(L),T&&t(F)}}}function Pm(z){let h,v,_,u,k;return{c(){h=o("p"),v=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),_=o("code"),u=r("Module"),k=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(d){h=s(d,"P",{});var m=a(h);v=i(m,"Although the recipe for forward pass needs to be defined within this function, one should call the "),_=s(m,"CODE",{});var j=a(_);u=i(j,"Module"),j.forEach(t),k=i(m,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),m.forEach(t)},m(d,m){g(d,h,m),e(h,v),e(h,_),e(_,u),e(h,k)},d(d){d&&t(h)}}}function Nm(z){let h,v,_,u,k;return u=new ye({props:{code:`from transformers import MarianTokenizer, TFMarianMTModel
...
<span class="hljs-string">&quot;Where is the bus stop ?&quot;</span>`}}),{c(){h=o("p"),v=r("Examples:"),_=l(),M(u.$$.fragment)},l(d){h=s(d,"P",{});var m=a(h);v=i(m,"Examples:"),m.forEach(t),_=c(d),b(u.$$.fragment,d)},m(d,m){g(d,h,m),e(h,v),g(d,_,m),y(u,d,m),k=!0},p:jt,i(d){k||(x(u.$$.fragment,d),k=!0)},o(d){w(u.$$.fragment,d),k=!1},d(d){d&&t(h),d&&t(_),$(u,d)}}}function Cm(z){let h,v,_,u,k;return{c(){h=o("p"),v=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),_=o("code"),u=r("Module"),k=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(d){h=s(d,"P",{});var m=a(h);v=i(m,"Although the recipe for forward pass needs to be defined within this function, one should call the "),_=s(m,"CODE",{});var j=a(_);u=i(j,"Module"),j.forEach(t),k=i(m,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),m.forEach(t)},m(d,m){g(d,h,m),e(h,v),e(h,_),e(_,u),e(h,k)},d(d){d&&t(h)}}}function Lm(z){let h,v,_,u,k;return u=new ye({props:{code:`from transformers import MarianTokenizer, FlaxMarianModel
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),{c(){h=o("p"),v=r("Example:"),_=l(),M(u.$$.fragment)},l(d){h=s(d,"P",{});var m=a(h);v=i(m,"Example:"),m.forEach(t),_=c(d),b(u.$$.fragment,d)},m(d,m){g(d,h,m),e(h,v),g(d,_,m),y(u,d,m),k=!0},p:jt,i(d){k||(x(u.$$.fragment,d),k=!0)},o(d){w(u.$$.fragment,d),k=!1},d(d){d&&t(h),d&&t(_),$(u,d)}}}function Im(z){let h,v,_,u,k;return{c(){h=o("p"),v=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),_=o("code"),u=r("Module"),k=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(d){h=s(d,"P",{});var m=a(h);v=i(m,"Although the recipe for forward pass needs to be defined within this function, one should call the "),_=s(m,"CODE",{});var j=a(_);u=i(j,"Module"),j.forEach(t),k=i(m,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),m.forEach(t)},m(d,m){g(d,h,m),e(h,v),e(h,_),e(_,u),e(h,k)},d(d){d&&t(h)}}}function Am(z){let h,v,_,u,k;return u=new ye({props:{code:`from transformers import MarianTokenizer, FlaxMarianMTModel
...
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-comment"># should give *Meine Freunde sind cool, aber sie essen zu viele Kohlenhydrate.*</span>`}}),{c(){h=o("p"),v=r("Example:"),_=l(),M(u.$$.fragment)},l(d){h=s(d,"P",{});var m=a(h);v=i(m,"Example:"),m.forEach(t),_=c(d),b(u.$$.fragment,d)},m(d,m){g(d,h,m),e(h,v),g(d,_,m),y(u,d,m),k=!0},p:jt,i(d){k||(x(u.$$.fragment,d),k=!0)},o(d){w(u.$$.fragment,d),k=!1},d(d){d&&t(h),d&&t(_),$(u,d)}}}function Om(z){let h,v,_,u,k,d,m,j,Ce,ce,E,ue,Y,Le,K,Z,Ie,xe,G,O,we,L,F,N,X,Q,me,Ae,J,P,fe,C,Oe,ee,ge,te,ne,oe,Se,S,He,H,D,T,q,_e,Ke,ke,U,Ze,Xe,De,I,se,Qe,Ue,W,et,tt,ae,ve,bi,ts,yi,xi,wi,nt,yn,$i,Ps,zi,ji,qi,xn,Ei,Ns,Fi,Pi,Ni,ot,Ci,Cs,Li,Ii,Ls,Ai,Oi,Si,Is,wn,Hi,As,Di,Ui,Wi,Os,$n,Ri,zn,Vi,Bi,Za,st,qt,Ss,jn,Gi,Hs,Ji,Xa,$e,ns,Yi,Ds,Ki,Zi,qn,Xi,En,Qi,ed,td,at,nd,Us,od,sd,Ws,ad,rd,id,Rs,dd,Qa,rt,Et,Vs,Fn,ld,Bs,cd,er,Ft,Gs,pd,hd,Js,Pn,ud,tr,it,Pt,Ys,Nn,md,Ks,fd,nr,ze,Cn,gd,Zs,_d,kd,vd,Ln,Td,Xs,Md,bd,yd,In,xd,An,wd,$d,zd,On,jd,Qs,qd,Ed,or,Nt,Fd,Sn,Pd,Nd,sr,Hn,ar,os,Cd,rr,Dn,ir,dt,Ct,ea,Un,Ld,ta,Id,dr,ss,Ad,lr,Wn,cr,as,Od,pr,Rn,hr,lt,Lt,na,Vn,Sd,oa,Hd,ur,Te,Bn,Dd,ct,Ud,rs,Wd,Rd,Gn,Vd,Bd,Gd,pt,Jd,is,Yd,Kd,ds,Zd,Xd,Qd,It,mr,ht,At,sa,Jn,el,aa,tl,fr,re,Yn,nl,Kn,ol,Zn,sl,al,rl,Xn,il,ls,dl,ll,cl,Ot,pl,St,Qn,hl,ra,ul,gr,ut,Ht,ia,eo,ml,da,fl,_r,Me,to,gl,no,_l,cs,kl,vl,Tl,oo,Ml,so,bl,yl,xl,je,ao,wl,mt,$l,ps,zl,jl,la,ql,El,Fl,Dt,Pl,Ut,kr,ft,Wt,ca,ro,Nl,pa,Cl,vr,be,io,Ll,lo,Il,hs,Al,Ol,Sl,co,Hl,po,Dl,Ul,Wl,pe,ho,Rl,gt,Vl,us,Bl,Gl,ha,Jl,Yl,Kl,Rt,Zl,uo,Xl,mo,Ql,ec,tc,Vt,Tr,_t,Bt,ua,fo,nc,ma,oc,Mr,kt,go,sc,Gt,_o,ac,Jt,br,vt,Yt,fa,ko,rc,ga,ic,yr,ie,vo,dc,To,lc,ms,cc,pc,hc,Mo,uc,bo,mc,fc,gc,Kt,_c,qe,yo,kc,Tt,vc,fs,Tc,Mc,_a,bc,yc,xc,Zt,wc,Xt,xr,Mt,Qt,ka,xo,$c,va,zc,wr,de,wo,jc,$o,qc,gs,Ec,Fc,Pc,zo,Nc,jo,Cc,Lc,Ic,en,Ac,he,qo,Oc,bt,Sc,_s,Hc,Dc,Ta,Uc,Wc,Rc,tn,Vc,Eo,Bc,Fo,Gc,Jc,Yc,nn,$r,yt,on,Ma,Po,Kc,ba,Zc,zr,R,No,Xc,Co,Qc,ks,ep,tp,np,Lo,op,Io,sp,ap,rp,ya,ip,dp,We,xa,Ao,lp,cp,wa,Oo,pp,hp,$a,So,up,mp,za,Ho,fp,gp,Ee,Do,_p,xt,kp,ja,vp,Tp,qa,Mp,bp,yp,sn,xp,an,jr,wt,rn,Ea,Uo,wp,Fa,$p,qr,V,Wo,zp,Ro,jp,vs,qp,Ep,Fp,Vo,Pp,Bo,Np,Cp,Lp,Pa,Ip,Ap,Re,Na,Go,Op,Sp,Ca,Jo,Hp,Dp,La,Yo,Up,Wp,Ia,Ko,Rp,Vp,Fe,Zo,Bp,$t,Gp,Aa,Jp,Yp,Oa,Kp,Zp,Xp,dn,Qp,ln,Er;return d=new le({}),X=new le({}),jn=new le({}),Fn=new le({}),Nn=new le({}),Hn=new ye({props:{code:`from transformers import MarianMTModel, MarianTokenizer
...
old_style_multi_models = [<span class="hljs-string">f&quot;<span class="hljs-subst">{org}</span>/<span class="hljs-subst">{s}</span>&quot;</span> <span class="hljs-keyword">for</span> s <span class="hljs-keyword">in</span> suffix <span class="hljs-keyword">if</span> s != s.lower()]`}}),Un=new le({}),Wn=new ye({props:{code:`['Helsinki-NLP/opus-mt-NORTH_EU-NORTH_EU',
...
<code>eos_token_id</code>.`,name:"forced_eos_token_id"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/marian/configuration_marian.py#L34"}}),It=new zt({props:{anchor:"transformers.MarianConfig.example",$$slots:{default:[Mm]},$$scope:{ctx:z}}}),Jn=new le({}),Yn=new B({props:{name:"class transformers.MarianTokenizer",anchor:"transformers.MarianTokenizer",parameters:[{name:"source_spm",val:""},{name:"target_spm",val:""},{name:"vocab",val:""},{name:"target_vocab_file",val:" = None"},{name:"source_lang",val:" = None"},{name:"target_lang",val:" = None"},{name:"unk_token",val:" = '<unk>'"},{name:"eos_token",val:" = '</s>'"},{name:"pad_token",val:" = '<pad>'"},{name:"model_max_length",val:" = 512"},{name:"sp_model_kwargs",val:": typing.Union[typing.Dict[str, typing.Any], NoneType] = None"},{name:"separate_vocabs",val:" = False"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.MarianTokenizer.source_spm",description:`<strong>source_spm</strong> (<code>str</code>) &#x2014;
...
Whether or not to return a <a href="/docs/transformers/main/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/marian/modeling_marian.py#L1169",returnDescription:`
<p>A <a
...
(masked), the loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/marian/modeling_marian.py#L1396",returnDescription:`
<p>A <a
...
Whether or not to return a <a href="/docs/transformers/main/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/marian/modeling_marian.py#L1571",returnDescription:`
<p>A <a
...
`}}),Jt=new zt({props:{anchor:"transformers.MarianForCausalLM.forward.example",$$slots:{default:[zm]},$$scope:{ctx:z}}}),ko=new le({}),vo=new B({props:{name:"class transformers.TFMarianModel",anchor:"transformers.TFMarianModel",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.TFMarianModel.config",description:`<strong>config</strong> (<a href="/docs/transformers/main/en/model_doc/marian#transformers.MarianConfig">MarianConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/main/en/main_classes/model#transformers.TFPreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/marian/modeling_tf_marian.py#L1188"}}),Kt=new bn({props:{$$slots:{default:[jm]},$$scope:{ctx:z}}}),yo=new B({props:{name:"call",anchor:"transformers.TFMarianModel.call",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"decoder_input_ids",val:" = None"},{name:"decoder_attention_mask",val:" = None"},{name:"decoder_position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"decoder_head_mask",val:" = None"},{name:"cross_attn_head_mask",val:" = None"},{name:"encoder_outputs",val:": typing.Union[typing.Tuple, transformers.modeling_tf_outputs.TFBaseModelOutput, NoneType] = None"},{name:"past_key_values",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"decoder_inputs_embeds",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"},{name:"training",val:" = False"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.TFMarianModel.call.input_ids",description:`<strong>input_ids</strong> (<code>tf.Tensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
...
behaviors between training and evaluation).`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/marian/modeling_tf_marian.py#L1200",returnDescription:`
<p>A <a
...
`}}),Zt=new bn({props:{$$slots:{default:[qm]},$$scope:{ctx:z}}}),Xt=new zt({props:{anchor:"transformers.TFMarianModel.call.example",$$slots:{default:[Em]},$$scope:{ctx:z}}}),xo=new le({}),wo=new B({props:{name:"class transformers.TFMarianMTModel",anchor:"transformers.TFMarianMTModel",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.TFMarianMTModel.config",description:`<strong>config</strong> (<a href="/docs/transformers/main/en/model_doc/marian#transformers.MarianConfig">MarianConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/main/en/main_classes/model#transformers.TFPreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/marian/modeling_tf_marian.py#L1276"}}),en=new bn({props:{$$slots:{default:[Fm]},$$scope:{ctx:z}}}),qo=new B({props:{name:"call",anchor:"transformers.TFMarianMTModel.call",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"decoder_input_ids",val:" = None"},{name:"decoder_attention_mask",val:" = None"},{name:"decoder_position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"decoder_head_mask",val:" = None"},{name:"cross_attn_head_mask",val:" = None"},{name:"encoder_outputs",val:": typing.Optional[transformers.modeling_tf_outputs.TFBaseModelOutput] = None"},{name:"past_key_values",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"decoder_inputs_embeds",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"},{name:"labels",val:" = None"},{name:"training",val:" = False"}],parametersDescription:[{anchor:"transformers.TFMarianMTModel.call.input_ids",description:`<strong>input_ids</strong> (<code>tf.Tensor</code> of shape <code>({0})</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/main/en/model_doc/marian#transformers.MarianTokenizer">MarianTokenizer</a>. See <a href="/docs/transformers/main/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/main/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
Labels for computing the masked language modeling loss. Indices should either be in <code>[0, ..., config.vocab_size]</code> or -100 (see <code>input_ids</code> docstring). Tokens with indices set to <code>-100</code> are ignored
(masked), the loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/marian/modeling_tf_marian.py#L1309",returnDescription:`
<p>A <a
...
`}}),sn=new bn({props:{$$slots:{default:[Cm]},$$scope:{ctx:z}}}),an=new zt({props:{anchor:"transformers.FlaxMarianModel.__call__.example",$$slots:{default:[Lm]},$$scope:{ctx:z}}}),Uo=new le({}),Wo=new B({props:{name:"class transformers.FlaxMarianMTModel",anchor:"transformers.FlaxMarianMTModel",parameters:[{name:"config",val:": MarianConfig"},{name:"input_shape",val:": typing.Tuple[int] = (1, 1)"},{name:"seed",val:": int = 0"},{name:"dtype",val:": dtype = <class 'jax.numpy.float32'>"},{name:"_do_init",val:": bool = True"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.FlaxMarianMTModel.config",description:`<strong>config</strong> (<a href="/docs/transformers/main/en/model_doc/marian#transformers.MarianConfig">MarianConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
...
`}}),dn=new bn({props:{$$slots:{default:[Im]},$$scope:{ctx:z}}}),ln=new zt({props:{anchor:"transformers.FlaxMarianMTModel.__call__.example",$$slots:{default:[Am]},$$scope:{ctx:z}}}),{c(){h=o("meta"),v=l(),_=o("h1"),u=o("a"),k=o("span"),M(d.$$.fragment),m=l(),j=o("span"),Ce=r("MarianMT"),ce=l(),E=o("p"),ue=o("strong"),Y=r("Bugs:"),Le=r(" If you see something strange, file a "),K=o("a"),Z=r("Github Issue"),Ie=r(`
and assign @patrickvonplaten.`),xe=l(),G=o("p"),O=r("Translations should be similar, but not identical to output in the test set linked to in each model card."),we=l(),L=o("h2"),F=o("a"),N=o("span"),M(X.$$.fragment),Q=l(),me=o("span"),Ae=r("Implementation Notes"),J=l(),P=o("ul"),fe=o("li"),C=o("p"),Oe=r("Each model is about 298 MB on disk, there are more than 1,000 models."),ee=l(),ge=o("li"),te=o("p"),ne=r("The list of supported language pairs can be found "),oe=o("a"),Se=r("here"),S=r("."),He=l(),H=o("li"),D=o("p"),T=r("Models were originally trained by "),q=o("a"),_e=r("J\xF6rg Tiedemann"),Ke=r(" using the "),ke=o("a"),U=r("Marian"),Ze=r(" C++ library, which supports fast training and translation."),Xe=l(),De=o("li"),I=o("p"),se=r(`All models are transformer encoder-decoders with 6 layers in each component. Each model\u2019s performance is documented
in a model card.`),Qe=l(),Ue=o("li"),W=o("p"),et=r("The 80 opus models that require BPE preprocessing are not supported."),tt=l(),ae=o("li"),ve=o("p"),bi=r("The modeling code is the same as "),ts=o("a"),yi=r("BartForConditionalGeneration"),xi=r(" with a few minor modifications:"),wi=l(),nt=o("ul"),yn=o("li"),$i=r("static (sinusoid) positional embeddings ("),Ps=o("code"),zi=r("MarianConfig.static_position_embeddings=True"),ji=r(")"),qi=l(),xn=o("li"),Ei=r("no layernorm_embedding ("),Ns=o("code"),Fi=r("MarianConfig.normalize_embedding=False"),Pi=r(")"),Ni=l(),ot=o("li"),Ci=r("the model starts generating with "),Cs=o("code"),Li=r("pad_token_id"),Ii=r(` (which has 0 as a token_embedding) as the prefix (Bart uses
`),Ls=o("code"),Ai=r("<s/>"),Oi=r("),"),Si=l(),Is=o("li"),wn=o("p"),Hi=r("Code to bulk convert models can be found in "),As=o("code"),Di=r("convert_marian_to_pytorch.py"),Ui=r("."),Wi=l(),Os=o("li"),$n=o("p"),Ri=r("This model was contributed by "),zn=o("a"),Vi=r("sshleifer"),Bi=r("."),Za=l(),st=o("h2"),qt=o("a"),Ss=o("span"),M(jn.$$.fragment),Gi=l(),Hs=o("span"),Ji=r("Naming"),Xa=l(),$e=o("ul"),ns=o("li"),Yi=r("All model names use the following format: "),Ds=o("code"),Ki=r("Helsinki-NLP/opus-mt-{src}-{tgt}"),Zi=l(),qn=o("li"),Xi=r("The language codes used to name models are inconsistent. Two digit codes can usually be found "),En=o("a"),Qi=r("here"),ed=r(`, three digit codes require googling \u201Clanguage
code {code}\u201C.`),td=l(),at=o("li"),nd=r("Codes formatted like "),Us=o("code"),od=r("es_AR"),sd=r(" are usually "),Ws=o("code"),ad=r("code_{region}"),rd=r(". That one is Spanish from Argentina."),id=l(),Rs=o("li"),dd=r(`The models were converted in two stages. The first 1000 models use ISO-639-2 codes to identify languages, the second
group use a combination of ISO-639-5 codes and ISO-639-2 codes.`),Qa=l(),rt=o("h2"),Et=o("a"),Vs=o("span"),M(Fn.$$.fragment),ld=l(),Bs=o("span"),cd=r("Examples"),er=l(),Ft=o("ul"),Gs=o("li"),pd=r(`Since Marian models are smaller than many other translation models available in the library, they can be useful for
fine-tuning experiments and integration tests.`),hd=l(),Js=o("li"),Pn=o("a"),ud=r("Fine-tune on GPU"),tr=l(),it=o("h2"),Pt=o("a"),Ys=o("span"),M(Nn.$$.fragment),md=l(),Ks=o("span"),fd=r("Multilingual Models"),nr=l(),ze=o("ul"),Cn=o("li"),gd=r("All model names use the following format: "),Zs=o("code"),_d=r("Helsinki-NLP/opus-mt-{src}-{tgt}"),kd=r(":"),vd=l(),Ln=o("li"),Td=r(`If a model can output multiple languages, and you should specify a language code by prepending the desired output
language to the `),Xs=o("code"),Md=r("src_text"),bd=r("."),yd=l(),In=o("li"),xd=r("You can see a models\u2019s supported language codes in its model card, under target constituents, like in "),An=o("a"),wd=r("opus-mt-en-roa"),$d=r("."),zd=l(),On=o("li"),jd=r("Note that if a model is only multilingual on the source side, like "),Qs=o("code"),qd=r("Helsinki-NLP/opus-mt-roa-en"),Ed=r(`, no language
codes are required.`),or=l(),Nt=o("p"),Fd=r("New multi-lingual models from the "),Sn=o("a"),Pd=r("Tatoeba-Challenge repo"),Nd=r(`
require 3 character language codes:`),sr=l(),M(Hn.$$.fragment),ar=l(),os=o("p"),Cd=r("Here is the code to see all available pretrained models on the hub:"),rr=l(),M(Dn.$$.fragment),ir=l(),dt=o("h2"),Ct=o("a"),ea=o("span"),M(Un.$$.fragment),Ld=l(),ta=o("span"),Id=r("Old Style Multi-Lingual Models"),dr=l(),ss=o("p"),Ad=r(`These are the old style multi-lingual models ported from the OPUS-MT-Train repo: and the members of each language
group:`),lr=l(),M(Wn.$$.fragment),cr=l(),as=o("p"),Od=r("Example of translating english to many romance languages, using old-style 2 character language codes"),pr=l(),M(Rn.$$.fragment),hr=l(),lt=o("h2"),Lt=o("a"),na=o("span"),M(Vn.$$.fragment),Sd=l(),oa=o("span"),Hd=r("MarianConfig"),ur=l(),Te=o("div"),M(Bn.$$.fragment),Dd=l(),ct=o("p"),Ud=r("This is the configuration class to store the configuration of a "),rs=o("a"),Wd=r("MarianModel"),Rd=r(`. It is used to instantiate an
...
`),Gn=o("a"),Vd=r("Helsinki-NLP/opus-mt-en-de"),Bd=r(" architecture."),Gd=l(),pt=o("p"),Jd=r("Configuration objects inherit from "),is=o("a"),Yd=r("PretrainedConfig"),Kd=r(` and can be used to control the model outputs. Read the
documentation from `),ds=o("a"),Zd=r("PretrainedConfig"),Xd=r(" for more information."),Qd=l(),M(It.$$.fragment),mr=l(),ht=o("h2"),At=o("a"),sa=o("span"),M(Jn.$$.fragment),el=l(),aa=o("span"),tl=r("MarianTokenizer"),fr=l(),re=o("div"),M(Yn.$$.fragment),nl=l(),Kn=o("p"),ol=r("Construct a Marian tokenizer. Based on "),Zn=o("a"),sl=r("SentencePiece"),al=r("."),rl=l(),Xn=o("p"),il=r("This tokenizer inherits from "),ls=o("a"),dl=r("PreTrainedTokenizer"),ll=r(` which contains most of the main methods. Users should refer to
this superclass for more information regarding those methods.`),cl=l(),M(Ot.$$.fragment),pl=l(),St=o("div"),M(Qn.$$.fragment),hl=l(),ra=o("p"),ul=r("Build model inputs from a sequence by appending eos_token_id."),gr=l(),ut=o("h2"),Ht=o("a"),ia=o("span"),M(eo.$$.fragment),ml=l(),da=o("span"),fl=r("MarianModel"),_r=l(),Me=o("div"),M(to.$$.fragment),gl=l(),no=o("p"),_l=r(`The bare Marian Model outputting raw hidden-states without any specific head on top.
This model inherits from `),cs=o("a"),kl=r("PreTrainedModel"),vl=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Tl=l(),oo=o("p"),Ml=r("This model is also a PyTorch "),so=o("a"),bl=r("torch.nn.Module"),yl=r(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),xl=l(),je=o("div"),M(ao.$$.fragment),wl=l(),mt=o("p"),$l=r("The "),ps=o("a"),zl=r("MarianModel"),jl=r(" forward method, overrides the "),la=o("code"),ql=r("__call__"),El=r(" special method."),Fl=l(),M(Dt.$$.fragment),Pl=l(),M(Ut.$$.fragment),kr=l(),ft=o("h2"),Wt=o("a"),ca=o("span"),M(ro.$$.fragment),Nl=l(),pa=o("span"),Cl=r("MarianMTModel"),vr=l(),be=o("div"),M(io.$$.fragment),Ll=l(),lo=o("p"),Il=r(`The Marian Model with a language modeling head. Can be used for summarization.
This model inherits from `),hs=o("a"),Al=r("PreTrainedModel"),Ol=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Sl=l(),co=o("p"),Hl=r("This model is also a PyTorch "),po=o("a"),Dl=r("torch.nn.Module"),Ul=r(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Wl=l(),pe=o("div"),M(ho.$$.fragment),Rl=l(),gt=o("p"),Vl=r("The "),us=o("a"),Bl=r("MarianMTModel"),Gl=r(" forward method, overrides the "),ha=o("code"),Jl=r("__call__"),Yl=r(" special method."),Kl=l(),M(Rt.$$.fragment),Zl=l(),uo=o("p"),Xl=r(`Pytorch version of marian-nmt\u2019s transformer.h (c++). Designed for the OPUS-NMT translation checkpoints. Available
models are listed `),mo=o("a"),Ql=r("here"),ec=r("."),tc=l(),M(Vt.$$.fragment),Tr=l(),_t=o("h2"),Bt=o("a"),ua=o("span"),M(fo.$$.fragment),nc=l(),ma=o("span"),oc=r("MarianForCausalLM"),Mr=l(),kt=o("div"),M(go.$$.fragment),sc=l(),Gt=o("div"),M(_o.$$.fragment),ac=l(),M(Jt.$$.fragment),br=l(),vt=o("h2"),Yt=o("a"),fa=o("span"),M(ko.$$.fragment),rc=l(),ga=o("span"),ic=r("TFMarianModel"),yr=l(),ie=o("div"),M(vo.$$.fragment),dc=l(),To=o("p"),lc=r(`The bare MARIAN Model outputting raw hidden-states without any specific head on top.
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),hc=l(),Mo=o("p"),uc=r("This model is also a "),bo=o("a"),mc=r("tf.keras.Model"),fc=r(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),gc=l(),M(Kt.$$.fragment),_c=l(),qe=o("div"),M(yo.$$.fragment),kc=l(),Tt=o("p"),vc=r("The "),fs=o("a"),Tc=r("TFMarianModel"),Mc=r(" forward method, overrides the "),_a=o("code"),bc=r("__call__"),yc=r(" special method."),xc=l(),M(Zt.$$.fragment),wc=l(),M(Xt.$$.fragment),xr=l(),Mt=o("h2"),Qt=o("a"),ka=o("span"),M(xo.$$.fragment),$c=l(),va=o("span"),zc=r("TFMarianMTModel"),wr=l(),de=o("div"),M(wo.$$.fragment),jc=l(),$o=o("p"),qc=r(`The MARIAN Model with a language modeling head. Can be used for summarization.
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Pc=l(),zo=o("p"),Nc=r("This model is also a "),jo=o("a"),Cc=r("tf.keras.Model"),Lc=r(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Ic=l(),M(en.$$.fragment),Ac=l(),he=o("div"),M(qo.$$.fragment),Oc=l(),bt=o("p"),Sc=r("The "),_s=o("a"),Hc=r("TFMarianMTModel"),Dc=r(" forward method, overrides the "),Ta=o("code"),Uc=r("__call__"),Wc=r(" special method."),Rc=l(),M(tn.$$.fragment),Vc=l(),Eo=o("p"),Bc=r(`TF version of marian-nmt\u2019s transformer.h (c++). Designed for the OPUS-NMT translation checkpoints. Available
models are listed `),Fo=o("a"),Gc=r("here"),Jc=r("."),Yc=l(),M(nn.$$.fragment),$r=l(),yt=o("h2"),on=o("a"),Ma=o("span"),M(Po.$$.fragment),Kc=l(),ba=o("span"),Zc=r("FlaxMarianModel"),zr=l(),R=o("div"),M(No.$$.fragment),Xc=l(),Co=o("p"),Qc=r(`The bare Marian Model transformer outputting raw hidden-states without any specific head on top.
This model inherits from `),ks=o("a"),ep=r("FlaxPreTrainedModel"),tp=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),np=l(),Lo=o("p"),op=r(`This model is also a Flax Linen
`),Io=o("a"),sp=r("flax.nn.Module"),ap=r(` subclass. Use it as a
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),rp=l(),ya=o("p"),ip=r("Finally, this model supports inherent JAX features such as:"),dp=l(),We=o("ul"),xa=o("li"),Ao=o("a"),lp=r("Just-In-Time (JIT) compilation"),cp=l(),wa=o("li"),Oo=o("a"),pp=r("Automatic Differentiation"),hp=l(),$a=o("li"),So=o("a"),up=r("Vectorization"),mp=l(),za=o("li"),Ho=o("a"),fp=r("Parallelization"),gp=l(),Ee=o("div"),M(Do.$$.fragment),_p=l(),xt=o("p"),kp=r("The "),ja=o("code"),vp=r("FlaxMarianPreTrainedModel"),Tp=r(" forward method, overrides the "),qa=o("code"),Mp=r("__call__"),bp=r(" special method."),yp=l(),M(sn.$$.fragment),xp=l(),M(an.$$.fragment),jr=l(),wt=o("h2"),rn=o("a"),Ea=o("span"),M(Uo.$$.fragment),wp=l(),Fa=o("span"),$p=r("FlaxMarianMTModel"),qr=l(),V=o("div"),M(Wo.$$.fragment),zp=l(),Ro=o("p"),jp=r(`The MARIAN Model with a language modeling head. Can be used for translation.
This model inherits from `),vs=o("a"),qp=r("FlaxPreTrainedModel"),Ep=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Fp=l(),Vo=o("p"),Pp=r(`This model is also a Flax Linen
`),Bo=o("a"),Np=r("flax.nn.Module"),Cp=r(` subclass. Use it as a
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),Lp=l(),Pa=o("p"),Ip=r("Finally, this model supports inherent JAX features such as:"),Ap=l(),Re=o("ul"),Na=o("li"),Go=o("a"),Op=r("Just-In-Time (JIT) compilation"),Sp=l(),Ca=o("li"),Jo=o("a"),Hp=r("Automatic Differentiation"),Dp=l(),La=o("li"),Yo=o("a"),Up=r("Vectorization"),Wp=l(),Ia=o("li"),Ko=o("a"),Rp=r("Parallelization"),Vp=l(),Fe=o("div"),M(Zo.$$.fragment),Bp=l(),$t=o("p"),Gp=r("The "),Aa=o("code"),Jp=r("FlaxMarianPreTrainedModel"),Yp=r(" forward method, overrides the "),Oa=o("code"),Kp=r("__call__"),Zp=r(" special method."),Xp=l(),M(dn.$$.fragment),Qp=l(),M(ln.$$.fragment),this.h()},l(n){const f=vm('[data-svelte="svelte-1phssyn"]',document.head);h=s(f,"META",{name:!0,content:!0}),f.forEach(t),v=c(n),_=s(n,"H1",{class:!0});var Xo=a(_);u=s(Xo,"A",{id:!0,class:!0,href:!0});var Sa=a(u);k=s(Sa,"SPAN",{});var Ha=a(k);b(d.$$.fragment,Ha),Ha.forEach(t),Sa.forEach(t),m=c(Xo),j=s(Xo,"SPAN",{});var Da=a(j);Ce=i(Da,"MarianMT"),Da.forEach(t),Xo.forEach(t),ce=c(n),E=s(n,"P",{});var cn=a(E);ue=s(cn,"STRONG",{});var Ua=a(ue);Y=i(Ua,"Bugs:"),Ua.forEach(t),Le=i(cn," If you see something strange, file a "),K=s(cn,"A",{href:!0,rel:!0});var Wa=a(K);Z=i(Wa,"Github Issue"),Wa.forEach(t),Ie=i(cn,`
and assign @patrickvonplaten.`),cn.forEach(t),xe=c(n),G=s(n,"P",{});var Ra=a(G);O=i(Ra,"Translations should be similar, but not identical to output in the test set linked to in each model card."),Ra.forEach(t),we=c(n),L=s(n,"H2",{class:!0});var Qo=a(L);F=s(Qo,"A",{id:!0,class:!0,href:!0});var Va=a(F);N=s(Va,"SPAN",{});var Ba=a(N);b(X.$$.fragment,Ba),Ba.forEach(t),Va.forEach(t),Q=c(Qo),me=s(Qo,"SPAN",{});var Ga=a(me);Ae=i(Ga,"Implementation Notes"),Ga.forEach(t),Qo.forEach(t),J=c(n),P=s(n,"UL",{});var A=a(P);fe=s(A,"LI",{});var Ja=a(fe);C=s(Ja,"P",{});var Ya=a(C);Oe=i(Ya,"Each model is about 298 MB on disk, there are more than 1,000 models."),Ya.forEach(t),Ja.forEach(t),ee=c(A),ge=s(A,"LI",{});var Ka=a(ge);te=s(Ka,"P",{});var es=a(te);ne=i(es,"The list of supported language pairs can be found "),oe=s(es,"A",{href:!0,rel:!0});var th=a(oe);Se=i(th,"here"),th.forEach(t),S=i(es,"."),es.forEach(t),Ka.forEach(t),He=c(A),H=s(A,"LI",{});var nh=a(H);D=s(nh,"P",{});var Ts=a(D);T=i(Ts,"Models were originally trained by "),q=s(Ts,"A",{href:!0,rel:!0});var oh=a(q);_e=i(oh,"J\xF6rg Tiedemann"),oh.forEach(t),Ke=i(Ts," using the "),ke=s(Ts,"A",{href:!0,rel:!0});var sh=a(ke);U=i(sh,"Marian"),sh.forEach(t),Ze=i(Ts," C++ library, which supports fast training and translation."),Ts.forEach(t),nh.forEach(t),Xe=c(A),De=s(A,"LI",{});var ah=a(De);I=s(ah,"P",{});var rh=a(I);se=i(rh,`All models are transformer encoder-decoders with 6 layers in each component. Each model\u2019s performance is documented
in a model card.`),rh.forEach(t),ah.forEach(t),Qe=c(A),Ue=s(A,"LI",{});var ih=a(Ue);W=s(ih,"P",{});var dh=a(W);et=i(dh,"The 80 opus models that require BPE preprocessing are not supported."),dh.forEach(t),ih.forEach(t),tt=c(A),ae=s(A,"LI",{});var Fr=a(ae);ve=s(Fr,"P",{});var Pr=a(ve);bi=i(Pr,"The modeling code is the same as "),ts=s(Pr,"A",{href:!0});var lh=a(ts);yi=i(lh,"BartForConditionalGeneration"),lh.forEach(t),xi=i(Pr," with a few minor modifications:"),Pr.forEach(t),wi=c(Fr),nt=s(Fr,"UL",{});var Ms=a(nt);yn=s(Ms,"LI",{});var Nr=a(yn);$i=i(Nr,"static (sinusoid) positional embeddings ("),Ps=s(Nr,"CODE",{});var ch=a(Ps);zi=i(ch,"MarianConfig.static_position_embeddings=True"),ch.forEach(t),ji=i(Nr,")"),Nr.forEach(t),qi=c(Ms),xn=s(Ms,"LI",{});var Cr=a(xn);Ei=i(Cr,"no layernorm_embedding ("),Ns=s(Cr,"CODE",{});var ph=a(Ns);Fi=i(ph,"MarianConfig.normalize_embedding=False"),ph.forEach(t),Pi=i(Cr,")"),Cr.forEach(t),Ni=c(Ms),ot=s(Ms,"LI",{});var bs=a(ot);Ci=i(bs,"the model starts generating with "),Cs=s(bs,"CODE",{});var hh=a(Cs);Li=i(hh,"pad_token_id"),hh.forEach(t),Ii=i(bs,` (which has 0 as a token_embedding) as the prefix (Bart uses
`),Ls=s(bs,"CODE",{});var uh=a(Ls);Ai=i(uh,"<s/>"),uh.forEach(t),Oi=i(bs,"),"),bs.forEach(t),Ms.forEach(t),Fr.forEach(t),Si=c(A),Is=s(A,"LI",{});var mh=a(Is);wn=s(mh,"P",{});var Lr=a(wn);Hi=i(Lr,"Code to bulk convert models can be found in "),As=s(Lr,"CODE",{});var fh=a(As);Di=i(fh,"convert_marian_to_pytorch.py"),fh.forEach(t),Ui=i(Lr,"."),Lr.forEach(t),mh.forEach(t),Wi=c(A),Os=s(A,"LI",{});var gh=a(Os);$n=s(gh,"P",{});var Ir=a($n);Ri=i(Ir,"This model was contributed by "),zn=s(Ir,"A",{href:!0,rel:!0});var _h=a(zn);Vi=i(_h,"sshleifer"),_h.forEach(t),Bi=i(Ir,"."),Ir.forEach(t),gh.forEach(t),A.forEach(t),Za=c(n),st=s(n,"H2",{class:!0});var Ar=a(st);qt=s(Ar,"A",{id:!0,class:!0,href:!0});var kh=a(qt);Ss=s(kh,"SPAN",{});var vh=a(Ss);b(jn.$$.fragment,vh),vh.forEach(t),kh.forEach(t),Gi=c(Ar),Hs=s(Ar,"SPAN",{});var Th=a(Hs);Ji=i(Th,"Naming"),Th.forEach(t),Ar.forEach(t),Xa=c(n),$e=s(n,"UL",{});var pn=a($e);ns=s(pn,"LI",{});var eh=a(ns);Yi=i(eh,"All model names use the following format: "),Ds=s(eh,"CODE",{});var Mh=a(Ds);Ki=i(Mh,"Helsinki-NLP/opus-mt-{src}-{tgt}"),Mh.forEach(t),eh.forEach(t),Zi=c(pn),qn=s(pn,"LI",{});var Or=a(qn);Xi=i(Or,"The language codes used to name models are inconsistent. Two digit codes can usually be found "),En=s(Or,"A",{href:!0,rel:!0});var bh=a(En);Qi=i(bh,"here"),bh.forEach(t),ed=i(Or,`, three digit codes require googling \u201Clanguage
code {code}\u201C.`),Or.forEach(t),td=c(pn),at=s(pn,"LI",{});var ys=a(at);nd=i(ys,"Codes formatted like "),Us=s(ys,"CODE",{});var yh=a(Us);od=i(yh,"es_AR"),yh.forEach(t),sd=i(ys," are usually "),Ws=s(ys,"CODE",{});var xh=a(Ws);ad=i(xh,"code_{region}"),xh.forEach(t),rd=i(ys,". That one is Spanish from Argentina."),ys.forEach(t),id=c(pn),Rs=s(pn,"LI",{});var wh=a(Rs);dd=i(wh,`The models were converted in two stages. The first 1000 models use ISO-639-2 codes to identify languages, the second
group use a combination of ISO-639-5 codes and ISO-639-2 codes.`),wh.forEach(t),pn.forEach(t),Qa=c(n),rt=s(n,"H2",{class:!0});var Sr=a(rt);Et=s(Sr,"A",{id:!0,class:!0,href:!0});var $h=a(Et);Vs=s($h,"SPAN",{});var zh=a(Vs);b(Fn.$$.fragment,zh),zh.forEach(t),$h.forEach(t),ld=c(Sr),Bs=s(Sr,"SPAN",{});var jh=a(Bs);cd=i(jh,"Examples"),jh.forEach(t),Sr.forEach(t),er=c(n),Ft=s(n,"UL",{});var Hr=a(Ft);Gs=s(Hr,"LI",{});var qh=a(Gs);pd=i(qh,`Since Marian models are smaller than many other translation models available in the library, they can be useful for
fine-tuning experiments and integration tests.`),qh.forEach(t),hd=c(Hr),Js=s(Hr,"LI",{});var Eh=a(Js);Pn=s(Eh,"A",{href:!0,rel:!0});var Fh=a(Pn);ud=i(Fh,"Fine-tune on GPU"),Fh.forEach(t),Eh.forEach(t),Hr.forEach(t),tr=c(n),it=s(n,"H2",{class:!0});var Dr=a(it);Pt=s(Dr,"A",{id:!0,class:!0,href:!0});var Ph=a(Pt);Ys=s(Ph,"SPAN",{});var Nh=a(Ys);b(Nn.$$.fragment,Nh),Nh.forEach(t),Ph.forEach(t),md=c(Dr),Ks=s(Dr,"SPAN",{});var Ch=a(Ks);fd=i(Ch,"Multilingual Models"),Ch.forEach(t),Dr.forEach(t),nr=c(n),ze=s(n,"UL",{});var hn=a(ze);Cn=s(hn,"LI",{});var Ur=a(Cn);gd=i(Ur,"All model names use the following format: "),Zs=s(Ur,"CODE",{});var Lh=a(Zs);_d=i(Lh,"Helsinki-NLP/opus-mt-{src}-{tgt}"),Lh.forEach(t),kd=i(Ur,":"),Ur.forEach(t),vd=c(hn),Ln=s(hn,"LI",{});var Wr=a(Ln);Td=i(Wr,`If a model can output multiple languages, and you should specify a language code by prepending the desired output
language to the `),Xs=s(Wr,"CODE",{});var Ih=a(Xs);Md=i(Ih,"src_text"),Ih.forEach(t),bd=i(Wr,"."),Wr.forEach(t),yd=c(hn),In=s(hn,"LI",{});var Rr=a(In);xd=i(Rr,"You can see a models\u2019s supported language codes in its model card, under target constituents, like in "),An=s(Rr,"A",{href:!0,rel:!0});var Ah=a(An);wd=i(Ah,"opus-mt-en-roa"),Ah.forEach(t),$d=i(Rr,"."),Rr.forEach(t),zd=c(hn),On=s(hn,"LI",{});var Vr=a(On);jd=i(Vr,"Note that if a model is only multilingual on the source side, like "),Qs=s(Vr,"CODE",{});var Oh=a(Qs);qd=i(Oh,"Helsinki-NLP/opus-mt-roa-en"),Oh.forEach(t),Ed=i(Vr,`, no language
codes are required.`),Vr.forEach(t),hn.forEach(t),or=c(n),Nt=s(n,"P",{});var Br=a(Nt);Fd=i(Br,"New multi-lingual models from the "),Sn=s(Br,"A",{href:!0,rel:!0});var Sh=a(Sn);Pd=i(Sh,"Tatoeba-Challenge repo"),Sh.forEach(t),Nd=i(Br,`
require 3 character language codes:`),Br.forEach(t),sr=c(n),b(Hn.$$.fragment,n),ar=c(n),os=s(n,"P",{});var Hh=a(os);Cd=i(Hh,"Here is the code to see all available pretrained models on the hub:"),Hh.forEach(t),rr=c(n),b(Dn.$$.fragment,n),ir=c(n),dt=s(n,"H2",{class:!0});var Gr=a(dt);Ct=s(Gr,"A",{id:!0,class:!0,href:!0});var Dh=a(Ct);ea=s(Dh,"SPAN",{});var Uh=a(ea);b(Un.$$.fragment,Uh),Uh.forEach(t),Dh.forEach(t),Ld=c(Gr),ta=s(Gr,"SPAN",{});var Wh=a(ta);Id=i(Wh,"Old Style Multi-Lingual Models"),Wh.forEach(t),Gr.forEach(t),dr=c(n),ss=s(n,"P",{});var Rh=a(ss);Ad=i(Rh,`These are the old style multi-lingual models ported from the OPUS-MT-Train repo: and the members of each language
group:`),Rh.forEach(t),lr=c(n),b(Wn.$$.fragment,n),cr=c(n),as=s(n,"P",{});var Vh=a(as);Od=i(Vh,"Example of translating english to many romance languages, using old-style 2 character language codes"),Vh.forEach(t),pr=c(n),b(Rn.$$.fragment,n),hr=c(n),lt=s(n,"H2",{class:!0});var Jr=a(lt);Lt=s(Jr,"A",{id:!0,class:!0,href:!0});var Bh=a(Lt);na=s(Bh,"SPAN",{});var Gh=a(na);b(Vn.$$.fragment,Gh),Gh.forEach(t),Bh.forEach(t),Sd=c(Jr),oa=s(Jr,"SPAN",{});var Jh=a(oa);Hd=i(Jh,"MarianConfig"),Jh.forEach(t),Jr.forEach(t),ur=c(n),Te=s(n,"DIV",{class:!0});var un=a(Te);b(Bn.$$.fragment,un),Dd=c(un),ct=s(un,"P",{});var xs=a(ct);Ud=i(xs,"This is the configuration class to store the configuration of a "),rs=s(xs,"A",{href:!0});var Yh=a(rs);Wd=i(Yh,"MarianModel"),Yh.forEach(t),Rd=i(xs,`. It is used to instantiate an
Marian model according to the specified arguments, defining the model architecture. Instantiating a configuration
with the defaults will yield a similar configuration to that of the Marian
`),Gn=s(xs,"A",{href:!0,rel:!0});var Kh=a(Gn);Vd=i(Kh,"Helsinki-NLP/opus-mt-en-de"),Kh.forEach(t),Bd=i(xs," architecture."),xs.forEach(t),Gd=c(un),pt=s(un,"P",{});var ws=a(pt);Jd=i(ws,"Configuration objects inherit from "),is=s(ws,"A",{href:!0});var Zh=a(is);Yd=i(Zh,"PretrainedConfig"),Zh.forEach(t),Kd=i(ws,` and can be used to control the model outputs. Read the
documentation from `),ds=s(ws,"A",{href:!0});var Xh=a(ds);Zd=i(Xh,"PretrainedConfig"),Xh.forEach(t),Xd=i(ws," for more information."),ws.forEach(t),Qd=c(un),b(It.$$.fragment,un),un.forEach(t),mr=c(n),ht=s(n,"H2",{class:!0});var Yr=a(ht);At=s(Yr,"A",{id:!0,class:!0,href:!0});var Qh=a(At);sa=s(Qh,"SPAN",{});var eu=a(sa);b(Jn.$$.fragment,eu),eu.forEach(t),Qh.forEach(t),el=c(Yr),aa=s(Yr,"SPAN",{});var tu=a(aa);tl=i(tu,"MarianTokenizer"),tu.forEach(t),Yr.forEach(t),fr=c(n),re=s(n,"DIV",{class:!0});var Ve=a(re);b(Yn.$$.fragment,Ve),nl=c(Ve),Kn=s(Ve,"P",{});var Kr=a(Kn);ol=i(Kr,"Construct a Marian tokenizer. Based on "),Zn=s(Kr,"A",{href:!0,rel:!0});var nu=a(Zn);sl=i(nu,"SentencePiece"),nu.forEach(t),al=i(Kr,"."),Kr.forEach(t),rl=c(Ve),Xn=s(Ve,"P",{});var Zr=a(Xn);il=i(Zr,"This tokenizer inherits from "),ls=s(Zr,"A",{href:!0});var ou=a(ls);dl=i(ou,"PreTrainedTokenizer"),ou.forEach(t),ll=i(Zr,` which contains most of the main methods. Users should refer to
this superclass for more information regarding those methods.`),Zr.forEach(t),cl=c(Ve),b(Ot.$$.fragment,Ve),pl=c(Ve),St=s(Ve,"DIV",{class:!0});var Xr=a(St);b(Qn.$$.fragment,Xr),hl=c(Xr),ra=s(Xr,"P",{});var su=a(ra);ul=i(su,"Build model inputs from a sequence by appending eos_token_id."),su.forEach(t),Xr.forEach(t),Ve.forEach(t),gr=c(n),ut=s(n,"H2",{class:!0});var Qr=a(ut);Ht=s(Qr,"A",{id:!0,class:!0,href:!0});var au=a(Ht);ia=s(au,"SPAN",{});var ru=a(ia);b(eo.$$.fragment,ru),ru.forEach(t),au.forEach(t),ml=c(Qr),da=s(Qr,"SPAN",{});var iu=a(da);fl=i(iu,"MarianModel"),iu.forEach(t),Qr.forEach(t),_r=c(n),Me=s(n,"DIV",{class:!0});var mn=a(Me);b(to.$$.fragment,mn),gl=c(mn),no=s(mn,"P",{});var ei=a(no);_l=i(ei,`The bare Marian Model outputting raw hidden-states without any specific head on top.
This model inherits from `),cs=s(ei,"A",{href:!0});var du=a(cs);kl=i(du,"PreTrainedModel"),du.forEach(t),vl=i(ei,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),ei.forEach(t),Tl=c(mn),oo=s(mn,"P",{});var ti=a(oo);Ml=i(ti,"This model is also a PyTorch "),so=s(ti,"A",{href:!0,rel:!0});var lu=a(so);bl=i(lu,"torch.nn.Module"),lu.forEach(t),yl=i(ti,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),ti.forEach(t),xl=c(mn),je=s(mn,"DIV",{class:!0});var fn=a(je);b(ao.$$.fragment,fn),wl=c(fn),mt=s(fn,"P",{});var $s=a(mt);$l=i($s,"The "),ps=s($s,"A",{href:!0});var cu=a(ps);zl=i(cu,"MarianModel"),cu.forEach(t),jl=i($s," forward method, overrides the "),la=s($s,"CODE",{});var pu=a(la);ql=i(pu,"__call__"),pu.forEach(t),El=i($s," special method."),$s.forEach(t),Fl=c(fn),b(Dt.$$.fragment,fn),Pl=c(fn),b(Ut.$$.fragment,fn),fn.forEach(t),mn.forEach(t),kr=c(n),ft=s(n,"H2",{class:!0});var ni=a(ft);Wt=s(ni,"A",{id:!0,class:!0,href:!0});var hu=a(Wt);ca=s(hu,"SPAN",{});var uu=a(ca);b(ro.$$.fragment,uu),uu.forEach(t),hu.forEach(t),Nl=c(ni),pa=s(ni,"SPAN",{});var mu=a(pa);Cl=i(mu,"MarianMTModel"),mu.forEach(t),ni.forEach(t),vr=c(n),be=s(n,"DIV",{class:!0});var gn=a(be);b(io.$$.fragment,gn),Ll=c(gn),lo=s(gn,"P",{});var oi=a(lo);Il=i(oi,`The Marian Model with a language modeling head. Can be used for summarization.
This model inherits from `),hs=s(oi,"A",{href:!0});var fu=a(hs);Al=i(fu,"PreTrainedModel"),fu.forEach(t),Ol=i(oi,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),oi.forEach(t),Sl=c(gn),co=s(gn,"P",{});var si=a(co);Hl=i(si,"This model is also a PyTorch "),po=s(si,"A",{href:!0,rel:!0});var gu=a(po);Dl=i(gu,"torch.nn.Module"),gu.forEach(t),Ul=i(si,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),si.forEach(t),Wl=c(gn),pe=s(gn,"DIV",{class:!0});var Be=a(pe);b(ho.$$.fragment,Be),Rl=c(Be),gt=s(Be,"P",{});var zs=a(gt);Vl=i(zs,"The "),us=s(zs,"A",{href:!0});var _u=a(us);Bl=i(_u,"MarianMTModel"),_u.forEach(t),Gl=i(zs," forward method, overrides the "),ha=s(zs,"CODE",{});var ku=a(ha);Jl=i(ku,"__call__"),ku.forEach(t),Yl=i(zs," special method."),zs.forEach(t),Kl=c(Be),b(Rt.$$.fragment,Be),Zl=c(Be),uo=s(Be,"P",{});var ai=a(uo);Xl=i(ai,`Pytorch version of marian-nmt\u2019s transformer.h (c++). Designed for the OPUS-NMT translation checkpoints. Available
models are listed `),mo=s(ai,"A",{href:!0,rel:!0});var vu=a(mo);Ql=i(vu,"here"),vu.forEach(t),ec=i(ai,"."),ai.forEach(t),tc=c(Be),b(Vt.$$.fragment,Be),Be.forEach(t),gn.forEach(t),Tr=c(n),_t=s(n,"H2",{class:!0});var ri=a(_t);Bt=s(ri,"A",{id:!0,class:!0,href:!0});var Tu=a(Bt);ua=s(Tu,"SPAN",{});var Mu=a(ua);b(fo.$$.fragment,Mu),Mu.forEach(t),Tu.forEach(t),nc=c(ri),ma=s(ri,"SPAN",{});var bu=a(ma);oc=i(bu,"MarianForCausalLM"),bu.forEach(t),ri.forEach(t),Mr=c(n),kt=s(n,"DIV",{class:!0});var ii=a(kt);b(go.$$.fragment,ii),sc=c(ii),Gt=s(ii,"DIV",{class:!0});var di=a(Gt);b(_o.$$.fragment,di),ac=c(di),b(Jt.$$.fragment,di),di.forEach(t),ii.forEach(t),br=c(n),vt=s(n,"H2",{class:!0});var li=a(vt);Yt=s(li,"A",{id:!0,class:!0,href:!0});var yu=a(Yt);fa=s(yu,"SPAN",{});var xu=a(fa);b(ko.$$.fragment,xu),xu.forEach(t),yu.forEach(t),rc=c(li),ga=s(li,"SPAN",{});var wu=a(ga);ic=i(wu,"TFMarianModel"),wu.forEach(t),li.forEach(t),yr=c(n),ie=s(n,"DIV",{class:!0});var Ge=a(ie);b(vo.$$.fragment,Ge),dc=c(Ge),To=s(Ge,"P",{});var ci=a(To);lc=i(ci,`The bare MARIAN Model outputting raw hidden-states without any specific head on top.
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),pi.forEach(t),gc=c(Ge),b(Kt.$$.fragment,Ge),_c=c(Ge),qe=s(Ge,"DIV",{class:!0});var _n=a(qe);b(yo.$$.fragment,_n),kc=c(_n),Tt=s(_n,"P",{});var js=a(Tt);vc=i(js,"The "),fs=s(js,"A",{href:!0});var ju=a(fs);Tc=i(ju,"TFMarianModel"),ju.forEach(t),Mc=i(js," forward method, overrides the "),_a=s(js,"CODE",{});var qu=a(_a);bc=i(qu,"__call__"),qu.forEach(t),yc=i(js," special method."),js.forEach(t),xc=c(_n),b(Zt.$$.fragment,_n),wc=c(_n),b(Xt.$$.fragment,_n),_n.forEach(t),Ge.forEach(t),xr=c(n),Mt=s(n,"H2",{class:!0});var hi=a(Mt);Qt=s(hi,"A",{id:!0,class:!0,href:!0});var Eu=a(Qt);ka=s(Eu,"SPAN",{});var Fu=a(ka);b(xo.$$.fragment,Fu),Fu.forEach(t),Eu.forEach(t),$c=c(hi),va=s(hi,"SPAN",{});var Pu=a(va);zc=i(Pu,"TFMarianMTModel"),Pu.forEach(t),hi.forEach(t),wr=c(n),de=s(n,"DIV",{class:!0});var Je=a(de);b(wo.$$.fragment,Je),jc=c(Je),$o=s(Je,"P",{});var ui=a($o);qc=i(ui,`The MARIAN Model with a language modeling head. Can be used for summarization.
...
This model inherits from `),ks=s(_i,"A",{href:!0});var Du=a(ks);ep=i(Du,"FlaxPreTrainedModel"),Du.forEach(t),tp=i(_i,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),_i.forEach(t),np=c(Pe),Lo=s(Pe,"P",{});var ki=a(Lo);op=i(ki,`This model is also a Flax Linen
`),Io=s(ki,"A",{href:!0,rel:!0});var Uu=a(Io);sp=i(Uu,"flax.nn.Module"),Uu.forEach(t),ap=i(ki,` subclass. Use it as a
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),ki.forEach(t),rp=c(Pe),ya=s(Pe,"P",{});var Wu=a(ya);ip=i(Wu,"Finally, this model supports inherent JAX features such as:"),Wu.forEach(t),dp=c(Pe),We=s(Pe,"UL",{});var kn=a(We);xa=s(kn,"LI",{});var Ru=a(xa);Ao=s(Ru,"A",{href:!0,rel:!0});var Vu=a(Ao);lp=i(Vu,"Just-In-Time (JIT) compilation"),Vu.forEach(t),Ru.forEach(t),cp=c(kn),wa=s(kn,"LI",{});var Bu=a(wa);Oo=s(Bu,"A",{href:!0,rel:!0});var Gu=a(Oo);pp=i(Gu,"Automatic Differentiation"),Gu.forEach(t),Bu.forEach(t),hp=c(kn),$a=s(kn,"LI",{});var Ju=a($a);So=s(Ju,"A",{href:!0,rel:!0});var Yu=a(So);up=i(Yu,"Vectorization"),Yu.forEach(t),Ju.forEach(t),mp=c(kn),za=s(kn,"LI",{});var Ku=a(za);Ho=s(Ku,"A",{href:!0,rel:!0});var Zu=a(Ho);fp=i(Zu,"Parallelization"),Zu.forEach(t),Ku.forEach(t),kn.forEach(t),gp=c(Pe),Ee=s(Pe,"DIV",{class:!0});var vn=a(Ee);b(Do.$$.fragment,vn),_p=c(vn),xt=s(vn,"P",{});var Es=a(xt);kp=i(Es,"The "),ja=s(Es,"CODE",{});var Xu=a(ja);vp=i(Xu,"FlaxMarianPreTrainedModel"),Xu.forEach(t),Tp=i(Es," forward method, overrides the "),qa=s(Es,"CODE",{});var Qu=a(qa);Mp=i(Qu,"__call__"),Qu.forEach(t),bp=i(Es," special method."),Es.forEach(t),yp=c(vn),b(sn.$$.fragment,vn),xp=c(vn),b(an.$$.fragment,vn),vn.forEach(t),Pe.forEach(t),jr=c(n),wt=s(n,"H2",{class:!0});var vi=a(wt);rn=s(vi,"A",{id:!0,class:!0,href:!0});var em=a(rn);Ea=s(em,"SPAN",{});var tm=a(Ea);b(Uo.$$.fragment,tm),tm.forEach(t),em.forEach(t),wp=c(vi),Fa=s(vi,"SPAN",{});var nm=a(Fa);$p=i(nm,"FlaxMarianMTModel"),nm.forEach(t),vi.forEach(t),qr=c(n),V=s(n,"DIV",{class:!0});var Ne=a(V);b(Wo.$$.fragment,Ne),zp=c(Ne),Ro=s(Ne,"P",{});var Ti=a(Ro);jp=i(Ti,`The MARIAN Model with a language modeling head. Can be used for translation.
This model inherits from `),vs=s(Ti,"A",{href:!0});var om=a(vs);qp=i(om,"FlaxPreTrainedModel"),om.forEach(t),Ep=i(Ti,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),Mi.forEach(t),Lp=c(Ne),Pa=s(Ne,"P",{});var am=a(Pa);Ip=i(am,"Finally, this model supports inherent JAX features such as:"),am.forEach(t),Ap=c(Ne),Re=s(Ne,"UL",{});var Tn=a(Re);Na=s(Tn,"LI",{});var rm=a(Na);Go=s(rm,"A",{href:!0,rel:!0});var im=a(Go);Op=i(im,"Just-In-Time (JIT) compilation"),im.forEach(t),rm.forEach(t),Sp=c(Tn),Ca=s(Tn,"LI",{});var dm=a(Ca);Jo=s(dm,"A",{href:!0,rel:!0});var lm=a(Jo);Hp=i(lm,"Automatic Differentiation"),lm.forEach(t),dm.forEach(t),Dp=c(Tn),La=s(Tn,"LI",{});var cm=a(La);Yo=s(cm,"A",{href:!0,rel:!0});var pm=a(Yo);Up=i(pm,"Vectorization"),pm.forEach(t),cm.forEach(t),Wp=c(Tn),Ia=s(Tn,"LI",{});var hm=a(Ia);Ko=s(hm,"A",{href:!0,rel:!0});var um=a(Ko);Rp=i(um,"Parallelization"),um.forEach(t),hm.forEach(t),Tn.forEach(t),Vp=c(Ne),Fe=s(Ne,"DIV",{class:!0});var Mn=a(Fe);b(Zo.$$.fragment,Mn),Bp=c(Mn),$t=s(Mn,"P",{});var Fs=a($t);Gp=i(Fs,"The "),Aa=s(Fs,"CODE",{});var mm=a(Aa);Jp=i(mm,"FlaxMarianPreTrainedModel"),mm.forEach(t),Yp=i(Fs," forward method, overrides the "),Oa=s(Fs,"CODE",{});var fm=a(Oa);Kp=i(fm,"__call__"),fm.forEach(t),Zp=i(Fs," special method."),Fs.forEach(t),Xp=c(Mn),b(dn.$$.fragment,Mn),Qp=c(Mn),b(ln.$$.fragment,Mn),Mn.forEach(t),Ne.forEach(t),this.h()},h(){p(h,"name","hf:doc:metadata"),p(h,"content",JSON.stringify(Sm)),p(u,"id","marianmt"),p(u,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),p(u,"href","#marianmt"),p(_,"class","relative group"),p(K,"href","https://github.com/huggingface/transformers/issues/new?assignees=sshleifer&labels=&template=bug-report.md&title"),p(K,"rel","nofollow"),p(F,"id","implementation-notes"),p(F,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),p(F,"href","#implementation-notes"),p(L,"class","relative group"),p(oe,"href","https://huggingface.co/Helsinki-NLP"),p(oe,"rel","nofollow"),p(q,"href","https://researchportal.helsinki.fi/en/persons/j%C3%B6rg-tiedemann"),p(q,"rel","nofollow"),p(ke,"href","https://marian-nmt.github.io/"),p(ke,"rel","nofollow"),p(ts,"href","/docs/transformers/main/en/model_doc/bart#transformers.BartForConditionalGeneration"),p(zn,"href","https://huggingface.co/sshleifer"),p(zn,"rel","nofollow"),p(qt,"id","naming"),p(qt,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),p(qt,"href","#naming"),p(st,"class","relative group"),p(En,"href","https://developers.google.com/admin-sdk/directory/v1/languages"),p(En,"rel","nofollow"),p(Et,"id","examples"),p(Et,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),p(Et,"href","#examples"),p(rt,"class","relative group"),p(Pn,"href","https://github.com/huggingface/transformers/blob/master/examples/legacy/seq2seq/train_distil_marian_enro.sh"),p(Pn,"rel","nofollow"),p(Pt,"id","multilingual-models"),p(Pt,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),p(Pt,"href","#multilingual-models"),p(it,"class","relative group"),p(An,"href","https://huggingface.co/Helsinki-NLP/opus-mt-en-roa"),p(An,"rel","nofollow"),p(Sn,"href","https://github.com/Helsinki-NLP/Tatoeba-Challenge"),p(Sn,"rel","nofollow"),p(Ct,"id","old-style-multilingual-models"),p(Ct,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),p(Ct,"href","#old-style-multilingual-models"),p(dt,"class","relative group"),p(Lt,"id","transformers.MarianConfig"),p(Lt,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),p(Lt,"href","#transformers.MarianConfig"),p(lt,"class","relative group"),p(rs,"href","/docs/transformers/main/en/model_doc/marian#transformers.MarianModel"),p(Gn,"href","https://huggingface.co/Helsinki-NLP/opus-mt-en-de"),p(Gn,"rel","nofollow"),p(is,"href","/docs/transformers/main/en/main_classes/configuration#transformers.PretrainedConfig"),p(ds,"href","/docs/transformers/main/en/main_classes/configuration#transformers.PretrainedConfig"),p(Te,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),p(At,"id","transformers.MarianTokenizer"),p(At,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),p(At,"href","#transformers.MarianTokenizer"),p(ht,"class","relative group"),p(Zn,"href","https://github.com/google/sentencepiece"),p(Zn,"rel","nofollow"),p(ls,"href","/docs/transformers/main/en/main_classes/tokenizer#transformers.PreTrainedTokenizer"),p(St,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),p(re,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),p(Ht,"id","transformers.MarianModel"),p(Ht,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),p(Ht,"href","#transformers.MarianModel"),p(ut,"class","relative group"),p(cs,"href","/docs/transformers/main/en/main_classes/model#transformers.PreTrainedModel"),p(so,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),p(so,"rel","nofollow"),p(ps,"href","/docs/transformers/main/en/model_doc/marian#transformers.MarianModel"),p(je,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),p(Me,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),p(Wt,"id","transformers.MarianMTModel"),p(Wt,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),p(Wt,"href","#transformers.MarianMTModel"),p(ft,"class","relative group"),p(hs,"href","/docs/transformers/main/en/main_classes/model#transformers.PreTrainedModel"),p(po,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),p(po,"rel","nofollow"),p(us,"href","/docs/transformers/main/en/model_doc/marian#transformers.MarianMTModel"),p(mo,"href","https://huggingface.co/models?search=Helsinki-NLP"),p(mo,"rel","nofollow"),p(pe,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),p(be,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),p(Bt,"id","transformers.MarianForCausalLM"),p(Bt,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),p(Bt,"href","#transformers.MarianForCausalLM"),p(_t,"class","relative group"),p(Gt,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),p(kt,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),p(Yt,"id","transformers.TFMarianModel"),p(Yt,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),p(Yt,"href","#transformers.TFMarianModel"),p(vt,"class","relative group"),p(ms,"href","/docs/transformers/main/en/main_classes/model#transformers.TFPreTrainedModel"),p(bo,"href","https://www.tensorflow.org/api_docs/python/tf/keras/Model"),p(bo,"rel","nofollow"),p(fs,"href","/docs/transformers/main/en/model_doc/marian#transformers.TFMarianModel"),p(qe,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),p(ie,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),p(Qt,"id","transformers.TFMarianMTModel"),p(Qt,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),p(Qt,"href","#transformers.TFMarianMTModel"),p(Mt,"class","relative group"),p(gs,"href","/docs/transformers/main/en/main_classes/model#transformers.TFPreTrainedModel"),p(jo,"href","https://www.tensorflow.org/api_docs/python/tf/keras/Model"),p(jo,"rel","nofollow"),p(_s,"href","/docs/transformers/main/en/model_doc/marian#transformers.TFMarianMTModel"),p(Fo,"href","https://huggingface.co/models?search=Helsinki-NLP"),p(Fo,"rel","nofollow"),p(he,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),p(de,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),p(on,"id","transformers.FlaxMarianModel"),p(on,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),p(on,"href","#transformers.FlaxMarianModel"),p(yt,"class","relative group"),p(ks,"href","/docs/transformers/main/en/main_classes/model#transformers.FlaxPreTrainedModel"),p(Io,"href","https://flax.readthedocs.io/en/latest/_autosummary/flax.nn.module.html"),p(Io,"rel","nofollow"),p(Ao,"href","https://jax.readthedocs.io/en/latest/jax.html#just-in-time-compilation-jit"),p(Ao,"rel","nofollow"),p(Oo,"href","https://jax.readthedocs.io/en/latest/jax.html#automatic-differentiation"),p(Oo,"rel","nofollow"),p(So,"href","https://jax.readthedocs.io/en/latest/jax.html#vectorization-vmap"),p(So,"rel","nofollow"),p(Ho,"href","https://jax.readthedocs.io/en/latest/jax.html#parallelization-pmap"),p(Ho,"rel","nofollow"),p(Ee,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),p(R,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),p(rn,"id","transformers.FlaxMarianMTModel"),p(rn,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),p(rn,"href","#transformers.FlaxMarianMTModel"),p(wt,"class","relative group"),p(vs,"href","/docs/transformers/main/en/main_classes/model#transformers.FlaxPreTrainedModel"),p(Bo,"href","https://flax.readthedocs.io/en/latest/_autosummary/flax.nn.module.html"),p(Bo,"rel","nofollow"),p(Go,"href","https://jax.readthedocs.io/en/latest/jax.html#just-in-time-compilation-jit"),p(Go,"rel","nofollow"),p(Jo,"href","https://jax.readthedocs.io/en/latest/jax.html#automatic-differentiation"),p(Jo,"rel","nofollow"),p(Yo,"href","https://jax.readthedocs.io/en/latest/jax.html#vectorization-vmap"),p(Yo,"rel","nofollow"),p(Ko,"href","https://jax.readthedocs.io/en/latest/jax.html#parallelization-pmap"),p(Ko,"rel","nofollow"),p(Fe,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),p(V,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8")},m(n,f){e(document.head,h),g(n,v,f),g(n,_,f),e(_,u),e(u,k),y(d,k,null),e(_,m),e(_,j),e(j,Ce),g(n,ce,f),g(n,E,f),e(E,ue),e(ue,Y),e(E,Le),e(E,K),e(K,Z),e(E,Ie),g(n,xe,f),g(n,G,f),e(G,O),g(n,we,f),g(n,L,f),e(L,F),e(F,N),y(X,N,null),e(L,Q),e(L,me),e(me,Ae),g(n,J,f),g(n,P,f),e(P,fe),e(fe,C),e(C,Oe),e(P,ee),e(P,ge),e(ge,te),e(te,ne),e(te,oe),e(oe,Se),e(te,S),e(P,He),e(P,H),e(H,D),e(D,T),e(D,q),e(q,_e),e(D,Ke),e(D,ke),e(ke,U),e(D,Ze),e(P,Xe),e(P,De),e(De,I),e(I,se),e(P,Qe),e(P,Ue),e(Ue,W),e(W,et),e(P,tt),e(P,ae),e(ae,ve),e(ve,bi),e(ve,ts),e(ts,yi),e(ve,xi),e(ae,wi),e(ae,nt),e(nt,yn),e(yn,$i),e(yn,Ps),e(Ps,zi),e(yn,ji),e(nt,qi),e(nt,xn),e(xn,Ei),e(xn,Ns),e(Ns,Fi),e(xn,Pi),e(nt,Ni),e(nt,ot),e(ot,Ci),e(ot,Cs),e(Cs,Li),e(ot,Ii),e(ot,Ls),e(Ls,Ai),e(ot,Oi),e(P,Si),e(P,Is),e(Is,wn),e(wn,Hi),e(wn,As),e(As,Di),e(wn,Ui),e(P,Wi),e(P,Os),e(Os,$n),e($n,Ri),e($n,zn),e(zn,Vi),e($n,Bi),g(n,Za,f),g(n,st,f),e(st,qt),e(qt,Ss),y(jn,Ss,null),e(st,Gi),e(st,Hs),e(Hs,Ji),g(n,Xa,f),g(n,$e,f),e($e,ns),e(ns,Yi),e(ns,Ds),e(Ds,Ki),e($e,Zi),e($e,qn),e(qn,Xi),e(qn,En),e(En,Qi),e(qn,ed),e($e,td),e($e,at),e(at,nd),e(at,Us),e(Us,od),e(at,sd),e(at,Ws),e(Ws,ad),e(at,rd),e($e,id),e($e,Rs),e(Rs,dd),g(n,Qa,f),g(n,rt,f),e(rt,Et),e(Et,Vs),y(Fn,Vs,null),e(rt,ld),e(rt,Bs),e(Bs,cd),g(n,er,f),g(n,Ft,f),e(Ft,Gs),e(Gs,pd),e(Ft,hd),e(Ft,Js),e(Js,Pn),e(Pn,ud),g(n,tr,f),g(n,it,f),e(it,Pt),e(Pt,Ys),y(Nn,Ys,null),e(it,md),e(it,Ks),e(Ks,fd),g(n,nr,f),g(n,ze,f),e(ze,Cn),e(Cn,gd),e(Cn,Zs),e(Zs,_d),e(Cn,kd),e(ze,vd),e(ze,Ln),e(Ln,Td),e(Ln,Xs),e(Xs,Md),e(Ln,bd),e(ze,yd),e(ze,In),e(In,xd),e(In,An),e(An,wd),e(In,$d),e(ze,zd),e(ze,On),e(On,jd),e(On,Qs),e(Qs,qd),e(On,Ed),g(n,or,f),g(n,Nt,f),e(Nt,Fd),e(Nt,Sn),e(Sn,Pd),e(Nt,Nd),g(n,sr,f),y(Hn,n,f),g(n,ar,f),g(n,os,f),e(os,Cd),g(n,rr,f),y(Dn,n,f),g(n,ir,f),g(n,dt,f),e(dt,Ct),e(Ct,ea),y(Un,ea,null),e(dt,Ld),e(dt,ta),e(ta,Id),g(n,dr,f),g(n,ss,f),e(ss,Ad),g(n,lr,f),y(Wn,n,f),g(n,cr,f),g(n,as,f),e(as,Od),g(n,pr,f),y(Rn,n,f),g(n,hr,f),g(n,lt,f),e(lt,Lt),e(Lt,na),y(Vn,na,null),e(lt,Sd),e(lt,oa),e(oa,Hd),g(n,ur,f),g(n,Te,f),y(Bn,Te,null),e(Te,Dd),e(Te,ct),e(ct,Ud),e(ct,rs),e(rs,Wd),e(ct,Rd),e(ct,Gn),e(Gn,Vd),e(ct,Bd),e(Te,Gd),e(Te,pt),e(pt,Jd),e(pt,is),e(is,Yd),e(pt,Kd),e(pt,ds),e(ds,Zd),e(pt,Xd),e(Te,Qd),y(It,Te,null),g(n,mr,f),g(n,ht,f),e(ht,At),e(At,sa),y(Jn,sa,null),e(ht,el),e(ht,aa),e(aa,tl),g(n,fr,f),g(n,re,f),y(Yn,re,null),e(re,nl),e(re,Kn),e(Kn,ol),e(Kn,Zn),e(Zn,sl),e(Kn,al),e(re,rl),e(re,Xn),e(Xn,il),e(Xn,ls),e(ls,dl),e(Xn,ll),e(re,cl),y(Ot,re,null),e(re,pl),e(re,St),y(Qn,St,null),e(St,hl),e(St,ra),e(ra,ul),g(n,gr,f),g(n,ut,f),e(ut,Ht),e(Ht,ia),y(eo,ia,null),e(ut,ml),e(ut,da),e(da,fl),g(n,_r,f),g(n,Me,f),y(to,Me,null),e(Me,gl),e(Me,no),e(no,_l),e(no,cs),e(cs,kl),e(no,vl),e(Me,Tl),e(Me,oo),e(oo,Ml),e(oo,so),e(so,bl),e(oo,yl),e(Me,xl),e(Me,je),y(ao,je,null),e(je,wl),e(je,mt),e(mt,$l),e(mt,ps),e(ps,zl),e(mt,jl),e(mt,la),e(la,ql),e(mt,El),e(je,Fl),y(Dt,je,null),e(je,Pl),y(Ut,je,null),g(n,kr,f),g(n,ft,f),e(ft,Wt),e(Wt,ca),y(ro,ca,null),e(ft,Nl),e(ft,pa),e(pa,Cl),g(n,vr,f),g(n,be,f),y(io,be,null),e(be,Ll),e(be,lo),e(lo,Il),e(lo,hs),e(hs,Al),e(lo,Ol),e(be,Sl),e(be,co),e(co,Hl),e(co,po),e(po,Dl),e(co,Ul),e(be,Wl),e(be,pe),y(ho,pe,null),e(pe,Rl),e(pe,gt),e(gt,Vl),e(gt,us),e(us,Bl),e(gt,Gl),e(gt,ha),e(ha,Jl),e(gt,Yl),e(pe,Kl),y(Rt,pe,null),e(pe,Zl),e(pe,uo),e(uo,Xl),e(uo,mo),e(mo,Ql),e(uo,ec),e(pe,tc),y(Vt,pe,null),g(n,Tr,f),g(n,_t,f),e(_t,Bt),e(Bt,ua),y(fo,ua,null),e(_t,nc),e(_t,ma),e(ma,oc),g(n,Mr,f),g(n,kt,f),y(go,kt,null),e(kt,sc),e(kt,Gt),y(_o,Gt,null),e(Gt,ac),y(Jt,Gt,null),g(n,br,f),g(n,vt,f),e(vt,Yt),e(Yt,fa),y(ko,fa,null),e(vt,rc),e(vt,ga),e(ga,ic),g(n,yr,f),g(n,ie,f),y(vo,ie,null),e(ie,dc),e(ie,To),e(To,lc),e(To,ms),e(ms,cc),e(To,pc),e(ie,hc),e(ie,Mo),e(Mo,uc),e(Mo,bo),e(bo,mc),e(Mo,fc),e(ie,gc),y(Kt,ie,null),e(ie,_c),e(ie,qe),y(yo,qe,null),e(qe,kc),e(qe,Tt),e(Tt,vc),e(Tt,fs),e(fs,Tc),e(Tt,Mc),e(Tt,_a),e(_a,bc),e(Tt,yc),e(qe,xc),y(Zt,qe,null),e(qe,wc),y(Xt,qe,null),g(n,xr,f),g(n,Mt,f),e(Mt,Qt),e(Qt,ka),y(xo,ka,null),e(Mt,$c),e(Mt,va),e(va,zc),g(n,wr,f),g(n,de,f),y(wo,de,null),e(de,jc),e(de,$o),e($o,qc),e($o,gs),e(gs,Ec),e($o,Fc),e(de,Pc),e(de,zo),e(zo,Nc),e(zo,jo),e(jo,Cc),e(zo,Lc),e(de,Ic),y(en,de,null),e(de,Ac),e(de,he),y(qo,he,null),e(he,Oc),e(he,bt),e(bt,Sc),e(bt,_s),e(_s,Hc),e(bt,Dc),e(bt,Ta),e(Ta,Uc),e(bt,Wc),e(he,Rc),y(tn,he,null),e(he,Vc),e(he,Eo),e(Eo,Bc),e(Eo,Fo),e(Fo,Gc),e(Eo,Jc),e(he,Yc),y(nn,he,null),g(n,$r,f),g(n,yt,f),e(yt,on),e(on,Ma),y(Po,Ma,null),e(yt,Kc),e(yt,ba),e(ba,Zc),g(n,zr,f),g(n,R,f),y(No,R,null),e(R,Xc),e(R,Co),e(Co,Qc),e(Co,ks),e(ks,ep),e(Co,tp),e(R,np),e(R,Lo),e(Lo,op),e(Lo,Io),e(Io,sp),e(Lo,ap),e(R,rp),e(R,ya),e(ya,ip),e(R,dp),e(R,We),e(We,xa),e(xa,Ao),e(Ao,lp),e(We,cp),e(We,wa),e(wa,Oo),e(Oo,pp),e(We,hp),e(We,$a),e($a,So),e(So,up),e(We,mp),e(We,za),e(za,Ho),e(Ho,fp),e(R,gp),e(R,Ee),y(Do,Ee,null),e(Ee,_p),e(Ee,xt),e(xt,kp),e(xt,ja),e(ja,vp),e(xt,Tp),e(xt,qa),e(qa,Mp),e(xt,bp),e(Ee,yp),y(sn,Ee,null),e(Ee,xp),y(an,Ee,null),g(n,jr,f),g(n,wt,f),e(wt,rn),e(rn,Ea),y(Uo,Ea,null),e(wt,wp),e(wt,Fa),e(Fa,$p),g(n,qr,f),g(n,V,f),y(Wo,V,null),e(V,zp),e(V,Ro),e(Ro,jp),e(Ro,vs),e(vs,qp),e(Ro,Ep),e(V,Fp),e(V,Vo),e(Vo,Pp),e(Vo,Bo),e(Bo,Np),e(Vo,Cp),e(V,Lp),e(V,Pa),e(Pa,Ip),e(V,Ap),e(V,Re),e(Re,Na),e(Na,Go),e(Go,Op),e(Re,Sp),e(Re,Ca),e(Ca,Jo),e(Jo,Hp),e(Re,Dp),e(Re,La),e(La,Yo),e(Yo,Up),e(Re,Wp),e(Re,Ia),e(Ia,Ko),e(Ko,Rp),e(V,Vp),e(V,Fe),y(Zo,Fe,null),e(Fe,Bp),e(Fe,$t),e($t,Gp),e($t,Aa),e(Aa,Jp),e($t,Yp),e($t,Oa),e(Oa,Kp),e($t,Zp),e(Fe,Xp),y(dn,Fe,null),e(Fe,Qp),y(ln,Fe,null),Er=!0},p(n,[f]){const Xo={};f&2&&(Xo.$$scope={dirty:f,ctx:n}),It.$set(Xo);const Sa={};f&2&&(Sa.$$scope={dirty:f,ctx:n}),Ot.$set(Sa);const Ha={};f&2&&(Ha.$$scope={dirty:f,ctx:n}),Dt.$set(Ha);const Da={};f&2&&(Da.$$scope={dirty:f,ctx:n}),Ut.$set(Da);const cn={};f&2&&(cn.$$scope={dirty:f,ctx:n}),Rt.$set(cn);const Ua={};f&2&&(Ua.$$scope={dirty:f,ctx:n}),Vt.$set(Ua);const Wa={};f&2&&(Wa.$$scope={dirty:f,ctx:n}),Jt.$set(Wa);const Ra={};f&2&&(Ra.$$scope={dirty:f,ctx:n}),Kt.$set(Ra);const Qo={};f&2&&(Qo.$$scope={dirty:f,ctx:n}),Zt.$set(Qo);const Va={};f&2&&(Va.$$scope={dirty:f,ctx:n}),Xt.$set(Va);const Ba={};f&2&&(Ba.$$scope={dirty:f,ctx:n}),en.$set(Ba);const Ga={};f&2&&(Ga.$$scope={dirty:f,ctx:n}),tn.$set(Ga);const A={};f&2&&(A.$$scope={dirty:f,ctx:n}),nn.$set(A);const Ja={};f&2&&(Ja.$$scope={dirty:f,ctx:n}),sn.$set(Ja);const Ya={};f&2&&(Ya.$$scope={dirty:f,ctx:n}),an.$set(Ya);const Ka={};f&2&&(Ka.$$scope={dirty:f,ctx:n}),dn.$set(Ka);const es={};f&2&&(es.$$scope={dirty:f,ctx:n}),ln.$set(es)},i(n){Er||(x(d.$$.fragment,n),x(X.$$.fragment,n),x(jn.$$.fragment,n),x(Fn.$$.fragment,n),x(Nn.$$.fragment,n),x(Hn.$$.fragment,n),x(Dn.$$.fragment,n),x(Un.$$.fragment,n),x(Wn.$$.fragment,n),x(Rn.$$.fragment,n),x(Vn.$$.fragment,n),x(Bn.$$.fragment,n),x(It.$$.fragment,n),x(Jn.$$.fragment,n),x(Yn.$$.fragment,n),x(Ot.$$.fragment,n),x(Qn.$$.fragment,n),x(eo.$$.fragment,n),x(to.$$.fragment,n),x(ao.$$.fragment,n),x(Dt.$$.fragment,n),x(Ut.$$.fragment,n),x(ro.$$.fragment,n),x(io.$$.fragment,n),x(ho.$$.fragment,n),x(Rt.$$.fragment,n),x(Vt.$$.fragment,n),x(fo.$$.fragment,n),x(go.$$.fragment,n),x(_o.$$.fragment,n),x(Jt.$$.fragment,n),x(ko.$$.fragment,n),x(vo.$$.fragment,n),x(Kt.$$.fragment,n),x(yo.$$.fragment,n),x(Zt.$$.fragment,n),x(Xt.$$.fragment,n),x(xo.$$.fragment,n),x(wo.$$.fragment,n),x(en.$$.fragment,n),x(qo.$$.fragment,n),x(tn.$$.fragment,n),x(nn.$$.fragment,n),x(Po.$$.fragment,n),x(No.$$.fragment,n),x(Do.$$.fragment,n),x(sn.$$.fragment,n),x(an.$$.fragment,n),x(Uo.$$.fragment,n),x(Wo.$$.fragment,n),x(Zo.$$.fragment,n),x(dn.$$.fragment,n),x(ln.$$.fragment,n),Er=!0)},o(n){w(d.$$.fragment,n),w(X.$$.fragment,n),w(jn.$$.fragment,n),w(Fn.$$.fragment,n),w(Nn.$$.fragment,n),w(Hn.$$.fragment,n),w(Dn.$$.fragment,n),w(Un.$$.fragment,n),w(Wn.$$.fragment,n),w(Rn.$$.fragment,n),w(Vn.$$.fragment,n),w(Bn.$$.fragment,n),w(It.$$.fragment,n),w(Jn.$$.fragment,n),w(Yn.$$.fragment,n),w(Ot.$$.fragment,n),w(Qn.$$.fragment,n),w(eo.$$.fragment,n),w(to.$$.fragment,n),w(ao.$$.fragment,n),w(Dt.$$.fragment,n),w(Ut.$$.fragment,n),w(ro.$$.fragment,n),w(io.$$.fragment,n),w(ho.$$.fragment,n),w(Rt.$$.fragment,n),w(Vt.$$.fragment,n),w(fo.$$.fragment,n),w(go.$$.fragment,n),w(_o.$$.fragment,n),w(Jt.$$.fragment,n),w(ko.$$.fragment,n),w(vo.$$.fragment,n),w(Kt.$$.fragment,n),w(yo.$$.fragment,n),w(Zt.$$.fragment,n),w(Xt.$$.fragment,n),w(xo.$$.fragment,n),w(wo.$$.fragment,n),w(en.$$.fragment,n),w(qo.$$.fragment,n),w(tn.$$.fragment,n),w(nn.$$.fragment,n),w(Po.$$.fragment,n),w(No.$$.fragment,n),w(Do.$$.fragment,n),w(sn.$$.fragment,n),w(an.$$.fragment,n),w(Uo.$$.fragment,n),w(Wo.$$.fragment,n),w(Zo.$$.fragment,n),w(dn.$$.fragment,n),w(ln.$$.fragment,n),Er=!1},d(n){t(h),n&&t(v),n&&t(_),$(d),n&&t(ce),n&&t(E),n&&t(xe),n&&t(G),n&&t(we),n&&t(L),$(X),n&&t(J),n&&t(P),n&&t(Za),n&&t(st),$(jn),n&&t(Xa),n&&t($e),n&&t(Qa),n&&t(rt),$(Fn),n&&t(er),n&&t(Ft),n&&t(tr),n&&t(it),$(Nn),n&&t(nr),n&&t(ze),n&&t(or),n&&t(Nt),n&&t(sr),$(Hn,n),n&&t(ar),n&&t(os),n&&t(rr),$(Dn,n),n&&t(ir),n&&t(dt),$(Un),n&&t(dr),n&&t(ss),n&&t(lr),$(Wn,n),n&&t(cr),n&&t(as),n&&t(pr),$(Rn,n),n&&t(hr),n&&t(lt),$(Vn),n&&t(ur),n&&t(Te),$(Bn),$(It),n&&t(mr),n&&t(ht),$(Jn),n&&t(fr),n&&t(re),$(Yn),$(Ot),$(Qn),n&&t(gr),n&&t(ut),$(eo),n&&t(_r),n&&t(Me),$(to),$(ao),$(Dt),$(Ut),n&&t(kr),n&&t(ft),$(ro),n&&t(vr),n&&t(be),$(io),$(ho),$(Rt),$(Vt),n&&t(Tr),n&&t(_t),$(fo),n&&t(Mr),n&&t(kt),$(go),$(_o),$(Jt),n&&t(br),n&&t(vt),$(ko),n&&t(yr),n&&t(ie),$(vo),$(Kt),$(yo),$(Zt),$(Xt),n&&t(xr),n&&t(Mt),$(xo),n&&t(wr),n&&t(de),$(wo),$(en),$(qo),$(tn),$(nn),n&&t($r),n&&t(yt),$(Po),n&&t(zr),n&&t(R),$(No),$(Do),$(sn),$(an),n&&t(jr),n&&t(wt),$(Uo),n&&t(qr),n&&t(V),$(Wo),$(Zo),$(dn),$(ln)}}}const Sm={local:"marianmt",sections:[{local:"implementation-notes",title:"Implementation Notes"},{local:"naming",title:"Naming"},{local:"examples",title:"Examples"},{local:"multilingual-models",title:"Multilingual Models"},{local:"old-style-multilingual-models",title:"Old Style Multi-Lingual Models"},{local:"transformers.MarianConfig",title:"MarianConfig"},{local:"transformers.MarianTokenizer",title:"MarianTokenizer"},{local:"transformers.MarianModel",title:"MarianModel"},{local:"transformers.MarianMTModel",title:"MarianMTModel"},{local:"transformers.MarianForCausalLM",title:"MarianForCausalLM"},{local:"transformers.TFMarianModel",title:"TFMarianModel"},{local:"transformers.TFMarianMTModel",title:"TFMarianMTModel"},{local:"transformers.FlaxMarianModel",title:"FlaxMarianModel"},{local:"transformers.FlaxMarianMTModel",title:"FlaxMarianMTModel"}],title:"MarianMT"};function Hm(z){return Tm(()=>{new URLSearchParams(window.location.search).get("fw")}),[]}class Gm extends gm{constructor(h){super();_m(this,h,Hm,Om,km,{})}}export{Gm as default,Sm as metadata};
