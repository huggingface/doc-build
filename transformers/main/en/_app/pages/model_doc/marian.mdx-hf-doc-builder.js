import{S as gm,i as _m,s as km,e as o,k as l,w as M,t as r,M as vm,c as s,d as t,m as c,a,x as b,h as i,b as p,G as e,g as f,y,q as x,o as w,B as $,v as Tm,L as Vt}from"../../chunks/vendor-hf-doc-builder.js";import{T as Dn}from"../../chunks/Tip-hf-doc-builder.js";import{D as Z}from"../../chunks/Docstring-hf-doc-builder.js";import{C as Pe}from"../../chunks/CodeBlock-hf-doc-builder.js";import{I as fe}from"../../chunks/IconCopyLink-hf-doc-builder.js";import{E as Bt}from"../../chunks/ExampleCodeBlock-hf-doc-builder.js";function Mm(E){let h,v,_,g,k;return g=new Pe({props:{code:`from transformers import MarianModel, MarianConfig
...
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),u.forEach(t)},m(d,u){f(d,h,u),e(h,v),e(h,_),e(_,g),e(h,k)},d(d){d&&t(h)}}}function xm(E){let h,v,_,g,k;return g=new Pe({props:{code:`from transformers import MarianTokenizer, MarianModel
...
the latter silently ignores them.`)},l(d){h=s(d,"P",{});var u=a(h);v=i(u,"Although the recipe for forward pass needs to be defined within this function, one should call the "),_=s(u,"CODE",{});var q=a(_);g=i(q,"Module"),q.forEach(t),k=i(u,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),u.forEach(t)},m(d,u){f(d,h,u),e(h,v),e(h,_),e(_,g),e(h,k)},d(d){d&&t(h)}}}function $m(E){let h,v,_,g,k;return g=new Pe({props:{code:`from transformers import MarianTokenizer, MarianMTModel
...
<span class="hljs-string">&quot;Where&#x27;s the bus stop?&quot;</span>`}}),{c(){h=o("p"),v=r("Examples:"),_=l(),M(g.$$.fragment)},l(d){h=s(d,"P",{});var u=a(h);v=i(u,"Examples:"),u.forEach(t),_=c(d),b(g.$$.fragment,d)},m(d,u){f(d,h,u),e(h,v),f(d,_,u),y(g,d,u),k=!0},p:Vt,i(d){k||(x(g.$$.fragment,d),k=!0)},o(d){w(g.$$.fragment,d),k=!1},d(d){d&&t(h),d&&t(_),$(g,d)}}}function zm(E){let h,v,_,g,k;return g=new Pe({props:{code:`from transformers import MarianTokenizer, MarianForCausalLM
...
pass your inputs and labels in any format that `),B=o("code"),Ge=r("model.fit()"),Le=r(` supports! If, however, you want to use the second
...
pass your inputs and labels in any format that `),B=s(F,"CODE",{});var le=a(B);Ge=i(le,"model.fit()"),le.forEach(t),Le=i(F,` supports! If, however, you want to use the second
...
`),ie=s(it,"CODE",{});var Tt=a(ie);ye=i(Tt,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),Tt.forEach(t),it.forEach(t),G.forEach(t),de=c(T),S=s(T,"P",{});var W=a(S);ot=i(W,`Note that when creating models and layers with
`),D=s(W,"A",{href:!0,rel:!0});var Mt=a(D);xe=i(Mt,"subclassing"),Mt.forEach(t),st=i(W,` then you don\u2019t need to worry
about any of this, as you can just pass inputs like you would to any other Python function!`),W.forEach(t),this.h()},h(){p(D,"href","https://keras.io/guides/making_new_layers_and_models_via_subclassing/"),p(D,"rel","nofollow")},m(T,j){f(T,h,j),e(h,v),e(h,_),e(_,g),e(h,k),f(T,d,j),f(T,u,j),e(u,q),e(q,Ve),e(u,Ne),e(u,C),e(C,ke),f(T,ve,j),f(T,z,j),e(z,Q),e(z,ee),e(ee,Ke),e(z,Ce),e(z,B),e(B,Ge),e(z,Le),e(z,L),e(L,X),e(z,Te),e(z,H),e(H,Je),e(z,Me),e(z,te),e(te,Ie),e(z,P),f(T,ne,j),f(T,N,j),e(N,I),e(I,Ye),e(I,V),e(V,oe),e(I,Ze),e(I,U),e(U,Xe),e(N,Qe),e(N,A),e(A,be),e(A,O),e(O,et),e(A,se),e(A,ae),e(ae,tt),e(N,re),e(N,K),e(K,nt),e(K,ie),e(ie,ye),f(T,de,j),f(T,S,j),e(S,ot),e(S,D),e(D,xe),e(S,st)},d(T){T&&t(h),T&&t(d),T&&t(u),T&&t(ve),T&&t(z),T&&t(ne),T&&t(N),T&&t(de),T&&t(S)}}}function Em(E){let h,v,_,g,k;return{c(){h=o("p"),v=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),_=o("code"),g=r("Module"),k=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(d){h=s(d,"P",{});var u=a(h);v=i(u,"Although the recipe for forward pass needs to be defined within this function, one should call the "),_=s(u,"CODE",{});var q=a(_);g=i(q,"Module"),q.forEach(t),k=i(u,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),u.forEach(t)},m(d,u){f(d,h,u),e(h,v),e(h,_),e(_,g),e(h,k)},d(d){d&&t(h)}}}function qm(E){let h,v,_,g,k;return g=new Pe({props:{code:`from transformers import MarianTokenizer, TFMarianModel
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),{c(){h=o("p"),v=r("Example:"),_=l(),M(g.$$.fragment)},l(d){h=s(d,"P",{});var u=a(h);v=i(u,"Example:"),u.forEach(t),_=c(d),b(g.$$.fragment,d)},m(d,u){f(d,h,u),e(h,v),f(d,_,u),y(g,d,u),k=!0},p:Vt,i(d){k||(x(g.$$.fragment,d),k=!0)},o(d){w(g.$$.fragment,d),k=!1},d(d){d&&t(h),d&&t(_),$(g,d)}}}function Fm(E){let h,v,_,g,k,d,u,q,Ve,Ne,C,ke,ve,z,Q,ee,Ke,Ce,B,Ge,Le,L,X,Te,H,Je,Me,te,Ie,P,ne,N,I,Ye,V,oe,Ze,U,Xe,Qe,A,be,O,et,se,ae,tt,re,K,nt,ie,ye,de,S,ot,D,xe,st;return{c(){h=o("p"),v=r("TensorFlow models and layers in "),_=o("code"),g=r("transformers"),k=r(" accept two formats as input:"),d=l(),u=o("ul"),q=o("li"),Ve=r("having all inputs as keyword arguments (like PyTorch models), or"),Ne=l(),C=o("li"),ke=r("having all inputs as a list, tuple or dict in the first positional argument."),ve=l(),z=o("p"),Q=r(`The reason the second format is supported is that Keras methods prefer this format when passing inputs to models
and layers. Because of this support, when using methods like `),ee=o("code"),Ke=r("model.fit()"),Ce=r(` things should \u201Cjust work\u201D for you - just
pass your inputs and labels in any format that `),B=o("code"),Ge=r("model.fit()"),Le=r(` supports! If, however, you want to use the second
format outside of Keras methods like `),L=o("code"),X=r("fit()"),Te=r(" and "),H=o("code"),Je=r("predict()"),Me=r(`, such as when creating your own layers or models with
the Keras `),te=o("code"),Ie=r("Functional"),P=r(` API, there are three possibilities you can use to gather all the input Tensors in the first
...
`),ie=s(it,"CODE",{});var Tt=a(ie);ye=i(Tt,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),Tt.forEach(t),it.forEach(t),G.forEach(t),de=c(T),S=s(T,"P",{});var W=a(S);ot=i(W,`Note that when creating models and layers with
`),D=s(W,"A",{href:!0,rel:!0});var Mt=a(D);xe=i(Mt,"subclassing"),Mt.forEach(t),st=i(W,` then you don\u2019t need to worry
about any of this, as you can just pass inputs like you would to any other Python function!`),W.forEach(t),this.h()},h(){p(D,"href","https://keras.io/guides/making_new_layers_and_models_via_subclassing/"),p(D,"rel","nofollow")},m(T,j){f(T,h,j),e(h,v),e(h,_),e(_,g),e(h,k),f(T,d,j),f(T,u,j),e(u,q),e(q,Ve),e(u,Ne),e(u,C),e(C,ke),f(T,ve,j),f(T,z,j),e(z,Q),e(z,ee),e(ee,Ke),e(z,Ce),e(z,B),e(B,Ge),e(z,Le),e(z,L),e(L,X),e(z,Te),e(z,H),e(H,Je),e(z,Me),e(z,te),e(te,Ie),e(z,P),f(T,ne,j),f(T,N,j),e(N,I),e(I,Ye),e(I,V),e(V,oe),e(I,Ze),e(I,U),e(U,Xe),e(N,Qe),e(N,A),e(A,be),e(A,O),e(O,et),e(A,se),e(A,ae),e(ae,tt),e(N,re),e(N,K),e(K,nt),e(K,ie),e(ie,ye),f(T,de,j),f(T,S,j),e(S,ot),e(S,D),e(D,xe),e(S,st)},d(T){T&&t(h),T&&t(d),T&&t(u),T&&t(ve),T&&t(z),T&&t(ne),T&&t(N),T&&t(de),T&&t(S)}}}function Pm(E){let h,v,_,g,k;return{c(){h=o("p"),v=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),_=o("code"),g=r("Module"),k=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(d){h=s(d,"P",{});var u=a(h);v=i(u,"Although the recipe for forward pass needs to be defined within this function, one should call the "),_=s(u,"CODE",{});var q=a(_);g=i(q,"Module"),q.forEach(t),k=i(u,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),u.forEach(t)},m(d,u){f(d,h,u),e(h,v),e(h,_),e(_,g),e(h,k)},d(d){d&&t(h)}}}function Nm(E){let h,v,_,g,k;return g=new Pe({props:{code:`from transformers import MarianTokenizer, TFMarianMTModel
...
the latter silently ignores them.`)},l(d){h=s(d,"P",{});var u=a(h);v=i(u,"Although the recipe for forward pass needs to be defined within this function, one should call the "),_=s(u,"CODE",{});var q=a(_);g=i(q,"Module"),q.forEach(t),k=i(u,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),u.forEach(t)},m(d,u){f(d,h,u),e(h,v),e(h,_),e(_,g),e(h,k)},d(d){d&&t(h)}}}function Lm(E){let h,v,_,g,k;return g=new Pe({props:{code:`from transformers import MarianTokenizer, FlaxMarianModel
...
the latter silently ignores them.`)},l(d){h=s(d,"P",{});var u=a(h);v=i(u,"Although the recipe for forward pass needs to be defined within this function, one should call the "),_=s(u,"CODE",{});var q=a(_);g=i(q,"Module"),q.forEach(t),k=i(u,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),u.forEach(t)},m(d,u){f(d,h,u),e(h,v),e(h,_),e(_,g),e(h,k)},d(d){d&&t(h)}}}function Am(E){let h,v,_,g,k;return g=new Pe({props:{code:`from transformers import MarianTokenizer, FlaxMarianMTModel
...
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-comment"># should give *Meine Freunde sind cool, aber sie essen zu viele Kohlenhydrate.*</span>`}}),{c(){h=o("p"),v=r("Example:"),_=l(),M(g.$$.fragment)},l(d){h=s(d,"P",{});var u=a(h);v=i(u,"Example:"),u.forEach(t),_=c(d),b(g.$$.fragment,d)},m(d,u){f(d,h,u),e(h,v),f(d,_,u),y(g,d,u),k=!0},p:Vt,i(d){k||(x(g.$$.fragment,d),k=!0)},o(d){w(g.$$.fragment,d),k=!1},d(d){d&&t(h),d&&t(_),$(g,d)}}}function Om(E){let h,v,_,g,k,d,u,q,Ve,Ne,C,ke,ve,z,Q,ee,Ke,Ce,B,Ge,Le,L,X,Te,H,Je,Me,te,Ie,P,ne,N,I,Ye,V,oe,Ze,U,Xe,Qe,A,be,O,et,se,ae,tt,re,K,nt,ie,ye,de,S,ot,D,xe,st,T,j,we,$e,Ae,ft,F,gt,le,ze,_t,at,G,ce,kt,je,pe,rt,vt,it,Tt,W,Mt,Ks,Li,Ii,Gs,Ai,Oi,Si,Js,Hn,Di,Ys,Hi,Ui,Wi,Zs,Un,Ri,Wn,Bi,Vi,cr,bt,Kt,Xs,Rn,Ki,Qs,Gi,pr,Oe,_s,Ji,ea,Yi,Zi,Bn,Xi,Vn,Qi,ed,td,yt,nd,ta,od,sd,na,ad,rd,id,oa,dd,hr,xt,Gt,sa,Kn,ld,aa,cd,ur,Jt,ra,pd,hd,ia,Gn,ud,mr,wt,Yt,da,Jn,md,la,fd,fr,Se,Yn,gd,ca,_d,kd,vd,Zn,Td,pa,Md,bd,yd,Xn,xd,Qn,wd,$d,zd,eo,jd,ha,Ed,qd,gr,Zt,Fd,to,Pd,Nd,_r,no,kr,ks,Cd,vr,oo,Tr,$t,Xt,ua,so,Ld,ma,Id,Mr,vs,Ad,br,ao,yr,Ts,Od,xr,ro,wr,zt,Qt,fa,io,Sd,ga,Dd,$r,Ee,lo,Hd,jt,Ud,Ms,Wd,Rd,co,Bd,Vd,Kd,Et,Gd,bs,Jd,Yd,ys,Zd,Xd,Qd,en,zr,qt,tn,_a,po,el,ka,tl,jr,he,ho,nl,uo,ol,mo,sl,al,rl,fo,il,xs,dl,ll,cl,nn,pl,on,go,hl,va,ul,Er,Ft,sn,Ta,_o,ml,Ma,fl,qr,qe,ko,gl,vo,_l,ws,kl,vl,Tl,To,Ml,Mo,bl,yl,xl,De,bo,wl,Pt,$l,$s,zl,jl,ba,El,ql,Fl,an,Pl,rn,Fr,Nt,dn,ya,yo,Nl,xa,Cl,Pr,Fe,xo,Ll,wo,Il,zs,Al,Ol,Sl,$o,Dl,zo,Hl,Ul,Wl,ge,jo,Rl,Ct,Bl,js,Vl,Kl,wa,Gl,Jl,Yl,ln,Zl,Eo,Xl,qo,Ql,ec,tc,cn,Nr,Lt,pn,$a,Fo,nc,za,oc,Cr,It,Po,sc,hn,No,ac,un,Lr,At,mn,ja,Co,rc,Ea,ic,Ir,ue,Lo,dc,Io,lc,Es,cc,pc,hc,Ao,uc,Oo,mc,fc,gc,fn,_c,He,So,kc,Ot,vc,qs,Tc,Mc,qa,bc,yc,xc,gn,wc,_n,Ar,St,kn,Fa,Do,$c,Pa,zc,Or,me,Ho,jc,Uo,Ec,Fs,qc,Fc,Pc,Wo,Nc,Ro,Cc,Lc,Ic,vn,Ac,_e,Bo,Oc,Dt,Sc,Ps,Dc,Hc,Na,Uc,Wc,Rc,Tn,Bc,Vo,Vc,Ko,Kc,Gc,Jc,Mn,Sr,Ht,bn,Ca,Go,Yc,La,Zc,Dr,J,Jo,Xc,Yo,Qc,Ns,ep,tp,np,Zo,op,Xo,sp,ap,rp,Ia,ip,dp,dt,Aa,Qo,lp,cp,Oa,es,pp,hp,Sa,ts,up,mp,Da,ns,fp,gp,Ue,os,_p,Ut,kp,Ha,vp,Tp,Ua,Mp,bp,yp,yn,xp,xn,Hr,Wt,wn,Wa,ss,wp,Ra,$p,Ur,Y,as,zp,rs,jp,Cs,Ep,qp,Fp,is,Pp,ds,Np,Cp,Lp,Ba,Ip,Ap,lt,Va,ls,Op,Sp,Ka,cs,Dp,Hp,Ga,ps,Up,Wp,Ja,hs,Rp,Bp,We,us,Vp,Rt,Kp,Ya,Gp,Jp,Za,Yp,Zp,Xp,$n,Qp,zn,Wr;return d=new fe({}),H=new fe({}),Rn=new fe({}),Kn=new fe({}),Jn=new fe({}),no=new Pe({props:{code:`from transformers import MarianMTModel, MarianTokenizer
...
</ul>`,name:"sp_model_kwargs"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/marian/tokenization_marian.py#L61"}}),nn=new Bt({props:{anchor:"transformers.MarianTokenizer.example",$$slots:{default:[bm]},$$scope:{ctx:E}}}),go=new Z({props:{name:"build_inputs_with_special_tokens",anchor:"transformers.MarianTokenizer.build_inputs_with_special_tokens",parameters:[{name:"token_ids_0",val:""},{name:"token_ids_1",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/marian/tokenization_marian.py#L273"}}),_o=new fe({}),ko=new Z({props:{name:"class transformers.MarianModel",anchor:"transformers.MarianModel",parameters:[{name:"config",val:": MarianConfig"}],parametersDescription:[{anchor:"transformers.MarianModel.config",description:`<strong>config</strong> (<a href="/docs/transformers/main/en/model_doc/marian#transformers.MarianConfig">MarianConfig</a>) &#x2014;
...
`}}),un=new Bt({props:{anchor:"transformers.MarianForCausalLM.forward.example",$$slots:{default:[zm]},$$scope:{ctx:E}}}),Co=new fe({}),Lo=new Z({props:{name:"class transformers.TFMarianModel",anchor:"transformers.TFMarianModel",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.TFMarianModel.config",description:`<strong>config</strong> (<a href="/docs/transformers/main/en/model_doc/marian#transformers.MarianConfig">MarianConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
...
`}}),gn=new Dn({props:{$$slots:{default:[Em]},$$scope:{ctx:E}}}),_n=new Bt({props:{anchor:"transformers.TFMarianModel.call.example",$$slots:{default:[qm]},$$scope:{ctx:E}}}),Do=new fe({}),Ho=new Z({props:{name:"class transformers.TFMarianMTModel",anchor:"transformers.TFMarianMTModel",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.TFMarianMTModel.config",description:`<strong>config</strong> (<a href="/docs/transformers/main/en/model_doc/marian#transformers.MarianConfig">MarianConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/main/en/main_classes/model#transformers.TFPreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/marian/modeling_tf_marian.py#L1283"}}),vn=new Dn({props:{$$slots:{default:[Fm]},$$scope:{ctx:E}}}),Bo=new Z({props:{name:"call",anchor:"transformers.TFMarianMTModel.call",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"decoder_input_ids",val:" = None"},{name:"decoder_attention_mask",val:" = None"},{name:"decoder_position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"decoder_head_mask",val:" = None"},{name:"cross_attn_head_mask",val:" = None"},{name:"encoder_outputs",val:": typing.Optional[transformers.modeling_tf_outputs.TFBaseModelOutput] = None"},{name:"past_key_values",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"decoder_inputs_embeds",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"},{name:"labels",val:" = None"},{name:"training",val:" = False"}],parametersDescription:[{anchor:"transformers.TFMarianMTModel.call.input_ids",description:`<strong>input_ids</strong> (<code>tf.Tensor</code> of shape <code>({0})</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/main/en/model_doc/marian#transformers.MarianTokenizer">MarianTokenizer</a>. See <a href="/docs/transformers/main/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/main/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
`}}),Tn=new Dn({props:{$$slots:{default:[Pm]},$$scope:{ctx:E}}}),Mn=new Bt({props:{anchor:"transformers.TFMarianMTModel.call.example",$$slots:{default:[Nm]},$$scope:{ctx:E}}}),Go=new fe({}),Jo=new Z({props:{name:"class transformers.FlaxMarianModel",anchor:"transformers.FlaxMarianModel",parameters:[{name:"config",val:": MarianConfig"},{name:"input_shape",val:": typing.Tuple[int] = (1, 1)"},{name:"seed",val:": int = 0"},{name:"dtype",val:": dtype = <class 'jax.numpy.float32'>"},{name:"_do_init",val:": bool = True"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.FlaxMarianModel.config",description:`<strong>config</strong> (<a href="/docs/transformers/main/en/model_doc/marian#transformers.MarianConfig">MarianConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
...
`}}),yn=new Dn({props:{$$slots:{default:[Cm]},$$scope:{ctx:E}}}),xn=new Bt({props:{anchor:"transformers.FlaxMarianModel.__call__.example",$$slots:{default:[Lm]},$$scope:{ctx:E}}}),ss=new fe({}),as=new Z({props:{name:"class transformers.FlaxMarianMTModel",anchor:"transformers.FlaxMarianMTModel",parameters:[{name:"config",val:": MarianConfig"},{name:"input_shape",val:": typing.Tuple[int] = (1, 1)"},{name:"seed",val:": int = 0"},{name:"dtype",val:": dtype = <class 'jax.numpy.float32'>"},{name:"_do_init",val:": bool = True"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.FlaxMarianMTModel.config",description:`<strong>config</strong> (<a href="/docs/transformers/main/en/model_doc/marian#transformers.MarianConfig">MarianConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
...
`}}),$n=new Dn({props:{$$slots:{default:[Im]},$$scope:{ctx:E}}}),zn=new Bt({props:{anchor:"transformers.FlaxMarianMTModel.__call__.example",$$slots:{default:[Am]},$$scope:{ctx:E}}}),{c(){h=o("meta"),v=l(),_=o("h1"),g=o("a"),k=o("span"),M(d.$$.fragment),u=l(),q=o("span"),Ve=r("MarianMT"),Ne=l(),C=o("p"),ke=o("strong"),ve=r("Bugs:"),z=r(" If you see something strange, file a "),Q=o("a"),ee=r("Github Issue"),Ke=r(`
and assign @patrickvonplaten.`),Ce=l(),B=o("p"),Ge=r("Translations should be similar, but not identical to output in the test set linked to in each model card."),Le=l(),L=o("h2"),X=o("a"),Te=o("span"),M(H.$$.fragment),Je=l(),Me=o("span"),te=r("Implementation Notes"),Ie=l(),P=o("ul"),ne=o("li"),N=o("p"),I=r("Each model is about 298 MB on disk, there are more than 1,000 models."),Ye=l(),V=o("li"),oe=o("p"),Ze=r("The list of supported language pairs can be found "),U=o("a"),Xe=r("here"),Qe=r("."),A=l(),be=o("li"),O=o("p"),et=r("Models were originally trained by "),se=o("a"),ae=r("J\xF6rg Tiedemann"),tt=r(" using the "),re=o("a"),K=r("Marian"),nt=r(" C++ library, which supports fast training and translation."),ie=l(),ye=o("li"),de=o("p"),S=r(`All models are transformer encoder-decoders with 6 layers in each component. Each model\u2019s performance is documented
in a model card.`),ot=l(),D=o("li"),xe=o("p"),st=r("The 80 opus models that require BPE preprocessing are not supported."),T=l(),j=o("li"),we=o("p"),$e=r("The modeling code is the same as "),Ae=o("a"),ft=r("BartForConditionalGeneration"),F=r(" with a few minor modifications:"),gt=l(),le=o("ul"),ze=o("li"),_t=r("static (sinusoid) positional embeddings ("),at=o("code"),G=r("MarianConfig.static_position_embeddings=True"),ce=r(")"),kt=l(),je=o("li"),pe=r("no layernorm_embedding ("),rt=o("code"),vt=r("MarianConfig.normalize_embedding=False"),it=r(")"),Tt=l(),W=o("li"),Mt=r("the model starts generating with "),Ks=o("code"),Li=r("pad_token_id"),Ii=r(` (which has 0 as a token_embedding) as the prefix (Bart uses
`),Gs=o("code"),Ai=r("<s/>"),Oi=r("),"),Si=l(),Js=o("li"),Hn=o("p"),Di=r("Code to bulk convert models can be found in "),Ys=o("code"),Hi=r("convert_marian_to_pytorch.py"),Ui=r("."),Wi=l(),Zs=o("li"),Un=o("p"),Ri=r("This model was contributed by "),Wn=o("a"),Bi=r("sshleifer"),Vi=r("."),cr=l(),bt=o("h2"),Kt=o("a"),Xs=o("span"),M(Rn.$$.fragment),Ki=l(),Qs=o("span"),Gi=r("Naming"),pr=l(),Oe=o("ul"),_s=o("li"),Ji=r("All model names use the following format: "),ea=o("code"),Yi=r("Helsinki-NLP/opus-mt-{src}-{tgt}"),Zi=l(),Bn=o("li"),Xi=r("The language codes used to name models are inconsistent. Two digit codes can usually be found "),Vn=o("a"),Qi=r("here"),ed=r(`, three digit codes require googling \u201Clanguage
...
`),co=o("a"),Bd=r("Helsinki-NLP/opus-mt-en-de"),Vd=r(" architecture."),Kd=l(),Et=o("p"),Gd=r("Configuration objects inherit from "),bs=o("a"),Jd=r("PretrainedConfig"),Yd=r(` and can be used to control the model outputs. Read the
...
this superclass for more information regarding those methods.`),cl=l(),M(nn.$$.fragment),pl=l(),on=o("div"),M(go.$$.fragment),hl=l(),va=o("p"),ul=r("Build model inputs from a sequence by appending eos_token_id."),Er=l(),Ft=o("h2"),sn=o("a"),Ta=o("span"),M(_o.$$.fragment),ml=l(),Ma=o("span"),fl=r("MarianModel"),qr=l(),qe=o("div"),M(ko.$$.fragment),gl=l(),vo=o("p"),_l=r(`The bare Marian Model outputting raw hidden-states without any specific head on top.
...
and behavior.`),xl=l(),De=o("div"),M(bo.$$.fragment),wl=l(),Pt=o("p"),$l=r("The "),$s=o("a"),zl=r("MarianModel"),jl=r(" forward method, overrides the "),ba=o("code"),El=r("__call__"),ql=r(" special method."),Fl=l(),M(an.$$.fragment),Pl=l(),M(rn.$$.fragment),Fr=l(),Nt=o("h2"),dn=o("a"),ya=o("span"),M(yo.$$.fragment),Nl=l(),xa=o("span"),Cl=r("MarianMTModel"),Pr=l(),Fe=o("div"),M(xo.$$.fragment),Ll=l(),wo=o("p"),Il=r(`The Marian Model with a language modeling head. Can be used for summarization.
...
behavior.`),gc=l(),M(fn.$$.fragment),_c=l(),He=o("div"),M(So.$$.fragment),kc=l(),Ot=o("p"),vc=r("The "),qs=o("a"),Tc=r("TFMarianModel"),Mc=r(" forward method, overrides the "),qa=o("code"),bc=r("__call__"),yc=r(" special method."),xc=l(),M(gn.$$.fragment),wc=l(),M(_n.$$.fragment),Ar=l(),St=o("h2"),kn=o("a"),Fa=o("span"),M(Do.$$.fragment),$c=l(),Pa=o("span"),zc=r("TFMarianMTModel"),Or=l(),me=o("div"),M(Ho.$$.fragment),jc=l(),Uo=o("p"),Ec=r(`The MARIAN Model with a language modeling head. Can be used for summarization.
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Pc=l(),Wo=o("p"),Nc=r("This model is also a "),Ro=o("a"),Cc=r("tf.keras.Model"),Lc=r(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Ic=l(),M(vn.$$.fragment),Ac=l(),_e=o("div"),M(Bo.$$.fragment),Oc=l(),Dt=o("p"),Sc=r("The "),Ps=o("a"),Dc=r("TFMarianMTModel"),Hc=r(" forward method, overrides the "),Na=o("code"),Uc=r("__call__"),Wc=r(" special method."),Rc=l(),M(Tn.$$.fragment),Bc=l(),Vo=o("p"),Vc=r(`TF version of marian-nmt\u2019s transformer.h (c++). Designed for the OPUS-NMT translation checkpoints. Available
...
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),Lp=l(),Ba=o("p"),Ip=r("Finally, this model supports inherent JAX features such as:"),Ap=l(),lt=o("ul"),Va=o("li"),ls=o("a"),Op=r("Just-In-Time (JIT) compilation"),Sp=l(),Ka=o("li"),cs=o("a"),Dp=r("Automatic Differentiation"),Hp=l(),Ga=o("li"),ps=o("a"),Up=r("Vectorization"),Wp=l(),Ja=o("li"),hs=o("a"),Rp=r("Parallelization"),Bp=l(),We=o("div"),M(us.$$.fragment),Vp=l(),Rt=o("p"),Kp=r("The "),Ya=o("code"),Gp=r("FlaxMarianPreTrainedModel"),Jp=r(" forward method, overrides the "),Za=o("code"),Yp=r("__call__"),Zp=r(" special method."),Xp=l(),M($n.$$.fragment),Qp=l(),M(zn.$$.fragment),this.h()},l(n){const m=vm('[data-svelte="svelte-1phssyn"]',document.head);h=s(m,"META",{name:!0,content:!0}),m.forEach(t),v=c(n),_=s(n,"H1",{class:!0});var ms=a(_);g=s(ms,"A",{id:!0,class:!0,href:!0});var Xa=a(g);k=s(Xa,"SPAN",{});var Qa=a(k);b(d.$$.fragment,Qa),Qa.forEach(t),Xa.forEach(t),u=c(ms),q=s(ms,"SPAN",{});var er=a(q);Ve=i(er,"MarianMT"),er.forEach(t),ms.forEach(t),Ne=c(n),C=s(n,"P",{});var jn=a(C);ke=s(jn,"STRONG",{});var tr=a(ke);ve=i(tr,"Bugs:"),tr.forEach(t),z=i(jn," If you see something strange, file a "),Q=s(jn,"A",{href:!0,rel:!0});var nr=a(Q);ee=i(nr,"Github Issue"),nr.forEach(t),Ke=i(jn,`
and assign @patrickvonplaten.`),jn.forEach(t),Ce=c(n),B=s(n,"P",{});var or=a(B);Ge=i(or,"Translations should be similar, but not identical to output in the test set linked to in each model card."),or.forEach(t),Le=c(n),L=s(n,"H2",{class:!0});var fs=a(L);X=s(fs,"A",{id:!0,class:!0,href:!0});var sr=a(X);Te=s(sr,"SPAN",{});var ar=a(Te);b(H.$$.fragment,ar),ar.forEach(t),sr.forEach(t),Je=c(fs),Me=s(fs,"SPAN",{});var rr=a(Me);te=i(rr,"Implementation Notes"),rr.forEach(t),fs.forEach(t),Ie=c(n),P=s(n,"UL",{});var R=a(P);ne=s(R,"LI",{});var ir=a(ne);N=s(ir,"P",{});var dr=a(N);I=i(dr,"Each model is about 298 MB on disk, there are more than 1,000 models."),dr.forEach(t),ir.forEach(t),Ye=c(R),V=s(R,"LI",{});var lr=a(V);oe=s(lr,"P",{});var gs=a(oe);Ze=i(gs,"The list of supported language pairs can be found "),U=s(gs,"A",{href:!0,rel:!0});var th=a(U);Xe=i(th,"here"),th.forEach(t),Qe=i(gs,"."),gs.forEach(t),lr.forEach(t),A=c(R),be=s(R,"LI",{});var nh=a(be);O=s(nh,"P",{});var Ls=a(O);et=i(Ls,"Models were originally trained by "),se=s(Ls,"A",{href:!0,rel:!0});var oh=a(se);ae=i(oh,"J\xF6rg Tiedemann"),oh.forEach(t),tt=i(Ls," using the "),re=s(Ls,"A",{href:!0,rel:!0});var sh=a(re);K=i(sh,"Marian"),sh.forEach(t),nt=i(Ls," C++ library, which supports fast training and translation."),Ls.forEach(t),nh.forEach(t),ie=c(R),ye=s(R,"LI",{});var ah=a(ye);de=s(ah,"P",{});var rh=a(de);S=i(rh,`All models are transformer encoder-decoders with 6 layers in each component. Each model\u2019s performance is documented
in a model card.`),rh.forEach(t),ah.forEach(t),ot=c(R),D=s(R,"LI",{});var ih=a(D);xe=s(ih,"P",{});var dh=a(xe);st=i(dh,"The 80 opus models that require BPE preprocessing are not supported."),dh.forEach(t),ih.forEach(t),T=c(R),j=s(R,"LI",{});var Rr=a(j);we=s(Rr,"P",{});var Br=a(we);$e=i(Br,"The modeling code is the same as "),Ae=s(Br,"A",{href:!0});var lh=a(Ae);ft=i(lh,"BartForConditionalGeneration"),lh.forEach(t),F=i(Br," with a few minor modifications:"),Br.forEach(t),gt=c(Rr),le=s(Rr,"UL",{});var Is=a(le);ze=s(Is,"LI",{});var Vr=a(ze);_t=i(Vr,"static (sinusoid) positional embeddings ("),at=s(Vr,"CODE",{});var ch=a(at);G=i(ch,"MarianConfig.static_position_embeddings=True"),ch.forEach(t),ce=i(Vr,")"),Vr.forEach(t),kt=c(Is),je=s(Is,"LI",{});var Kr=a(je);pe=i(Kr,"no layernorm_embedding ("),rt=s(Kr,"CODE",{});var ph=a(rt);vt=i(ph,"MarianConfig.normalize_embedding=False"),ph.forEach(t),it=i(Kr,")"),Kr.forEach(t),Tt=c(Is),W=s(Is,"LI",{});var As=a(W);Mt=i(As,"the model starts generating with "),Ks=s(As,"CODE",{});var hh=a(Ks);Li=i(hh,"pad_token_id"),hh.forEach(t),Ii=i(As,` (which has 0 as a token_embedding) as the prefix (Bart uses
`),Gs=s(As,"CODE",{});var uh=a(Gs);Ai=i(uh,"<s/>"),uh.forEach(t),Oi=i(As,"),"),As.forEach(t),Is.forEach(t),Rr.forEach(t),Si=c(R),Js=s(R,"LI",{});var mh=a(Js);Hn=s(mh,"P",{});var Gr=a(Hn);Di=i(Gr,"Code to bulk convert models can be found in "),Ys=s(Gr,"CODE",{});var fh=a(Ys);Hi=i(fh,"convert_marian_to_pytorch.py"),fh.forEach(t),Ui=i(Gr,"."),Gr.forEach(t),mh.forEach(t),Wi=c(R),Zs=s(R,"LI",{});var gh=a(Zs);Un=s(gh,"P",{});var Jr=a(Un);Ri=i(Jr,"This model was contributed by "),Wn=s(Jr,"A",{href:!0,rel:!0});var _h=a(Wn);Bi=i(_h,"sshleifer"),_h.forEach(t),Vi=i(Jr,"."),Jr.forEach(t),gh.forEach(t),R.forEach(t),cr=c(n),bt=s(n,"H2",{class:!0});var Yr=a(bt);Kt=s(Yr,"A",{id:!0,class:!0,href:!0});var kh=a(Kt);Xs=s(kh,"SPAN",{});var vh=a(Xs);b(Rn.$$.fragment,vh),vh.forEach(t),kh.forEach(t),Ki=c(Yr),Qs=s(Yr,"SPAN",{});var Th=a(Qs);Gi=i(Th,"Naming"),Th.forEach(t),Yr.forEach(t),pr=c(n),Oe=s(n,"UL",{});var En=a(Oe);_s=s(En,"LI",{});var eh=a(_s);Ji=i(eh,"All model names use the following format: "),ea=s(eh,"CODE",{});var Mh=a(ea);Yi=i(Mh,"Helsinki-NLP/opus-mt-{src}-{tgt}"),Mh.forEach(t),eh.forEach(t),Zi=c(En),Bn=s(En,"LI",{});var Zr=a(Bn);Xi=i(Zr,"The language codes used to name models are inconsistent. Two digit codes can usually be found "),Vn=s(Zr,"A",{href:!0,rel:!0});var bh=a(Vn);Qi=i(bh,"here"),bh.forEach(t),ed=i(Zr,`, three digit codes require googling \u201Clanguage
...
require 3 character language codes:`),ai.forEach(t),_r=c(n),b(no.$$.fragment,n),kr=c(n),ks=s(n,"P",{});var Dh=a(ks);Cd=i(Dh,"Here is the code to see all available pretrained models on the hub:"),Dh.forEach(t),vr=c(n),b(oo.$$.fragment,n),Tr=c(n),$t=s(n,"H2",{class:!0});var ri=a($t);Xt=s(ri,"A",{id:!0,class:!0,href:!0});var Hh=a(Xt);ua=s(Hh,"SPAN",{});var Uh=a(ua);b(so.$$.fragment,Uh),Uh.forEach(t),Hh.forEach(t),Ld=c(ri),ma=s(ri,"SPAN",{});var Wh=a(ma);Id=i(Wh,"Old Style Multi-Lingual Models"),Wh.forEach(t),ri.forEach(t),Mr=c(n),vs=s(n,"P",{});var Rh=a(vs);Ad=i(Rh,`These are the old style multi-lingual models ported from the OPUS-MT-Train repo: and the members of each language
group:`),Rh.forEach(t),br=c(n),b(ao.$$.fragment,n),yr=c(n),Ts=s(n,"P",{});var Bh=a(Ts);Od=i(Bh,"Example of translating english to many romance languages, using old-style 2 character language codes"),Bh.forEach(t),xr=c(n),b(ro.$$.fragment,n),wr=c(n),zt=s(n,"H2",{class:!0});var ii=a(zt);Qt=s(ii,"A",{id:!0,class:!0,href:!0});var Vh=a(Qt);fa=s(Vh,"SPAN",{});var Kh=a(fa);b(io.$$.fragment,Kh),Kh.forEach(t),Vh.forEach(t),Sd=c(ii),ga=s(ii,"SPAN",{});var Gh=a(ga);Dd=i(Gh,"MarianConfig"),Gh.forEach(t),ii.forEach(t),$r=c(n),Ee=s(n,"DIV",{class:!0});var Fn=a(Ee);b(lo.$$.fragment,Fn),Hd=c(Fn),jt=s(Fn,"P",{});var Ss=a(jt);Ud=i(Ss,"This is the configuration class to store the configuration of a "),Ms=s(Ss,"A",{href:!0});var Jh=a(Ms);Wd=i(Jh,"MarianModel"),Jh.forEach(t),Rd=i(Ss,`. It is used to instantiate an
Marian model according to the specified arguments, defining the model architecture. Instantiating a configuration
with the defaults will yield a similar configuration to that of the Marian
`),co=s(Ss,"A",{href:!0,rel:!0});var Yh=a(co);Bd=i(Yh,"Helsinki-NLP/opus-mt-en-de"),Yh.forEach(t),Vd=i(Ss," architecture."),Ss.forEach(t),Kd=c(Fn),Et=s(Fn,"P",{});var Ds=a(Et);Gd=i(Ds,"Configuration objects inherit from "),bs=s(Ds,"A",{href:!0});var Zh=a(bs);Jd=i(Zh,"PretrainedConfig"),Zh.forEach(t),Yd=i(Ds,` and can be used to control the model outputs. Read the
documentation from `),ys=s(Ds,"A",{href:!0});var Xh=a(ys);Zd=i(Xh,"PretrainedConfig"),Xh.forEach(t),Xd=i(Ds," for more information."),Ds.forEach(t),Qd=c(Fn),b(en.$$.fragment,Fn),Fn.forEach(t),zr=c(n),qt=s(n,"H2",{class:!0});var di=a(qt);tn=s(di,"A",{id:!0,class:!0,href:!0});var Qh=a(tn);_a=s(Qh,"SPAN",{});var eu=a(_a);b(po.$$.fragment,eu),eu.forEach(t),Qh.forEach(t),el=c(di),ka=s(di,"SPAN",{});var tu=a(ka);tl=i(tu,"MarianTokenizer"),tu.forEach(t),di.forEach(t),jr=c(n),he=s(n,"DIV",{class:!0});var ct=a(he);b(ho.$$.fragment,ct),nl=c(ct),uo=s(ct,"P",{});var li=a(uo);ol=i(li,"Construct a Marian tokenizer. Based on "),mo=s(li,"A",{href:!0,rel:!0});var nu=a(mo);sl=i(nu,"SentencePiece"),nu.forEach(t),al=i(li,"."),li.forEach(t),rl=c(ct),fo=s(ct,"P",{});var ci=a(fo);il=i(ci,"This tokenizer inherits from "),xs=s(ci,"A",{href:!0});var ou=a(xs);dl=i(ou,"PreTrainedTokenizer"),ou.forEach(t),ll=i(ci,` which contains most of the main methods. Users should refer to
this superclass for more information regarding those methods.`),ci.forEach(t),cl=c(ct),b(nn.$$.fragment,ct),pl=c(ct),on=s(ct,"DIV",{class:!0});var pi=a(on);b(go.$$.fragment,pi),hl=c(pi),va=s(pi,"P",{});var su=a(va);ul=i(su,"Build model inputs from a sequence by appending eos_token_id."),su.forEach(t),pi.forEach(t),ct.forEach(t),Er=c(n),Ft=s(n,"H2",{class:!0});var hi=a(Ft);sn=s(hi,"A",{id:!0,class:!0,href:!0});var au=a(sn);Ta=s(au,"SPAN",{});var ru=a(Ta);b(_o.$$.fragment,ru),ru.forEach(t),au.forEach(t),ml=c(hi),Ma=s(hi,"SPAN",{});var iu=a(Ma);fl=i(iu,"MarianModel"),iu.forEach(t),hi.forEach(t),qr=c(n),qe=s(n,"DIV",{class:!0});var Pn=a(qe);b(ko.$$.fragment,Pn),gl=c(Pn),vo=s(Pn,"P",{});var ui=a(vo);_l=i(ui,`The bare Marian Model outputting raw hidden-states without any specific head on top.
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),_i.forEach(t),Wl=c(Cn),ge=s(Cn,"DIV",{class:!0});var pt=a(ge);b(jo.$$.fragment,pt),Rl=c(pt),Ct=s(pt,"P",{});var Us=a(Ct);Bl=i(Us,"The "),js=s(Us,"A",{href:!0});var _u=a(js);Vl=i(_u,"MarianMTModel"),_u.forEach(t),Kl=i(Us," forward method, overrides the "),wa=s(Us,"CODE",{});var ku=a(wa);Gl=i(ku,"__call__"),ku.forEach(t),Jl=i(Us," special method."),Us.forEach(t),Yl=c(pt),b(ln.$$.fragment,pt),Zl=c(pt),Eo=s(pt,"P",{});var ki=a(Eo);Xl=i(ki,`Pytorch version of marian-nmt\u2019s transformer.h (c++). Designed for the OPUS-NMT translation checkpoints. Available
models are listed `),qo=s(ki,"A",{href:!0,rel:!0});var vu=a(qo);Ql=i(vu,"here"),vu.forEach(t),ec=i(ki,"."),ki.forEach(t),tc=c(pt),b(cn.$$.fragment,pt),pt.forEach(t),Cn.forEach(t),Nr=c(n),Lt=s(n,"H2",{class:!0});var vi=a(Lt);pn=s(vi,"A",{id:!0,class:!0,href:!0});var Tu=a(pn);$a=s(Tu,"SPAN",{});var Mu=a($a);b(Fo.$$.fragment,Mu),Mu.forEach(t),Tu.forEach(t),nc=c(vi),za=s(vi,"SPAN",{});var bu=a(za);oc=i(bu,"MarianForCausalLM"),bu.forEach(t),vi.forEach(t),Cr=c(n),It=s(n,"DIV",{class:!0});var Ti=a(It);b(Po.$$.fragment,Ti),sc=c(Ti),hn=s(Ti,"DIV",{class:!0});var Mi=a(hn);b(No.$$.fragment,Mi),ac=c(Mi),b(un.$$.fragment,Mi),Mi.forEach(t),Ti.forEach(t),Lr=c(n),At=s(n,"H2",{class:!0});var bi=a(At);mn=s(bi,"A",{id:!0,class:!0,href:!0});var yu=a(mn);ja=s(yu,"SPAN",{});var xu=a(ja);b(Co.$$.fragment,xu),xu.forEach(t),yu.forEach(t),rc=c(bi),Ea=s(bi,"SPAN",{});var wu=a(Ea);ic=i(wu,"TFMarianModel"),wu.forEach(t),bi.forEach(t),Ir=c(n),ue=s(n,"DIV",{class:!0});var ht=a(ue);b(Lo.$$.fragment,ht),dc=c(ht),Io=s(ht,"P",{});var yi=a(Io);lc=i(yi,`The bare MARIAN Model outputting raw hidden-states without any specific head on top.
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),xi.forEach(t),gc=c(ht),b(fn.$$.fragment,ht),_c=c(ht),He=s(ht,"DIV",{class:!0});var Ln=a(He);b(So.$$.fragment,Ln),kc=c(Ln),Ot=s(Ln,"P",{});var Ws=a(Ot);vc=i(Ws,"The "),qs=s(Ws,"A",{href:!0});var ju=a(qs);Tc=i(ju,"TFMarianModel"),ju.forEach(t),Mc=i(Ws," forward method, overrides the "),qa=s(Ws,"CODE",{});var Eu=a(qa);bc=i(Eu,"__call__"),Eu.forEach(t),yc=i(Ws," special method."),Ws.forEach(t),xc=c(Ln),b(gn.$$.fragment,Ln),wc=c(Ln),b(_n.$$.fragment,Ln),Ln.forEach(t),ht.forEach(t),Ar=c(n),St=s(n,"H2",{class:!0});var wi=a(St);kn=s(wi,"A",{id:!0,class:!0,href:!0});var qu=a(kn);Fa=s(qu,"SPAN",{});var Fu=a(Fa);b(Do.$$.fragment,Fu),Fu.forEach(t),qu.forEach(t),$c=c(wi),Pa=s(wi,"SPAN",{});var Pu=a(Pa);zc=i(Pu,"TFMarianMTModel"),Pu.forEach(t),wi.forEach(t),Or=c(n),me=s(n,"DIV",{class:!0});var ut=a(me);b(Ho.$$.fragment,ut),jc=c(ut),Uo=s(ut,"P",{});var $i=a(Uo);Ec=i($i,`The MARIAN Model with a language modeling head. Can be used for summarization.
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),$i.forEach(t),Pc=c(ut),Wo=s(ut,"P",{});var zi=a(Wo);Nc=i(zi,"This model is also a "),Ro=s(zi,"A",{href:!0,rel:!0});var Cu=a(Ro);Cc=i(Cu,"tf.keras.Model"),Cu.forEach(t),Lc=i(zi,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),zi.forEach(t),Ic=c(ut),b(vn.$$.fragment,ut),Ac=c(ut),_e=s(ut,"DIV",{class:!0});var mt=a(_e);b(Bo.$$.fragment,mt),Oc=c(mt),Dt=s(mt,"P",{});var Rs=a(Dt);Sc=i(Rs,"The "),Ps=s(Rs,"A",{href:!0});var Lu=a(Ps);Dc=i(Lu,"TFMarianMTModel"),Lu.forEach(t),Hc=i(Rs," forward method, overrides the "),Na=s(Rs,"CODE",{});var Iu=a(Na);Uc=i(Iu,"__call__"),Iu.forEach(t),Wc=i(Rs," special method."),Rs.forEach(t),Rc=c(mt),b(Tn.$$.fragment,mt),Bc=c(mt),Vo=s(mt,"P",{});var ji=a(Vo);Vc=i(ji,`TF version of marian-nmt\u2019s transformer.h (c++). Designed for the OPUS-NMT translation checkpoints. Available
...
`),Xo=s(Fi,"A",{href:!0,rel:!0});var Uu=a(Xo);sp=i(Uu,"flax.nn.Module"),Uu.forEach(t),ap=i(Fi,` subclass. Use it as a
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),Fi.forEach(t),rp=c(Re),Ia=s(Re,"P",{});var Wu=a(Ia);ip=i(Wu,"Finally, this model supports inherent JAX features such as:"),Wu.forEach(t),dp=c(Re),dt=s(Re,"UL",{});var In=a(dt);Aa=s(In,"LI",{});var Ru=a(Aa);Qo=s(Ru,"A",{href:!0,rel:!0});var Bu=a(Qo);lp=i(Bu,"Just-In-Time (JIT) compilation"),Bu.forEach(t),Ru.forEach(t),cp=c(In),Oa=s(In,"LI",{});var Vu=a(Oa);es=s(Vu,"A",{href:!0,rel:!0});var Ku=a(es);pp=i(Ku,"Automatic Differentiation"),Ku.forEach(t),Vu.forEach(t),hp=c(In),Sa=s(In,"LI",{});var Gu=a(Sa);ts=s(Gu,"A",{href:!0,rel:!0});var Ju=a(ts);up=i(Ju,"Vectorization"),Ju.forEach(t),Gu.forEach(t),mp=c(In),Da=s(In,"LI",{});var Yu=a(Da);ns=s(Yu,"A",{href:!0,rel:!0});var Zu=a(ns);fp=i(Zu,"Parallelization"),Zu.forEach(t),Yu.forEach(t),In.forEach(t),gp=c(Re),Ue=s(Re,"DIV",{class:!0});var An=a(Ue);b(os.$$.fragment,An),_p=c(An),Ut=s(An,"P",{});var Bs=a(Ut);kp=i(Bs,"The "),Ha=s(Bs,"CODE",{});var Xu=a(Ha);vp=i(Xu,"FlaxMarianPreTrainedModel"),Xu.forEach(t),Tp=i(Bs," forward method, overrides the "),Ua=s(Bs,"CODE",{});var Qu=a(Ua);Mp=i(Qu,"__call__"),Qu.forEach(t),bp=i(Bs," special method."),Bs.forEach(t),yp=c(An),b(yn.$$.fragment,An),xp=c(An),b(xn.$$.fragment,An),An.forEach(t),Re.forEach(t),Hr=c(n),Wt=s(n,"H2",{class:!0});var Pi=a(Wt);wn=s(Pi,"A",{id:!0,class:!0,href:!0});var em=a(wn);Wa=s(em,"SPAN",{});var tm=a(Wa);b(ss.$$.fragment,tm),tm.forEach(t),em.forEach(t),wp=c(Pi),Ra=s(Pi,"SPAN",{});var nm=a(Ra);$p=i(nm,"FlaxMarianMTModel"),nm.forEach(t),Pi.forEach(t),Ur=c(n),Y=s(n,"DIV",{class:!0});var Be=a(Y);b(as.$$.fragment,Be),zp=c(Be),rs=s(Be,"P",{});var Ni=a(rs);jp=i(Ni,`The MARIAN Model with a language modeling head. Can be used for translation.
