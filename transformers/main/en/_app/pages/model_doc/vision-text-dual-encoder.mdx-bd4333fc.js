import{S as Nr,i as Br,s as Or,e as n,k as d,w as _,t as r,M as Wr,c as a,d as t,m as c,a as s,x as v,h as i,b as l,F as e,g as h,y as x,q as T,o as E,B as b,v as Rr}from"../../chunks/vendor-6b77c823.js";import{T as Sr}from"../../chunks/Tip-39098574.js";import{D as U}from"../../chunks/Docstring-abef54e3.js";import{C as ys}from"../../chunks/CodeBlock-3a8b25a8.js";import{I as $t}from"../../chunks/IconCopyLink-7a11ce68.js";function Ur(et){let p,q,g,$,A;return{c(){p=n("p"),q=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),g=n("code"),$=r("Module"),A=r(`
...
the latter silently ignores them.`)},l(j){p=a(j,"P",{});var D=s(p);q=i(D,"Although the recipe for forward pass needs to be defined within this function, one should call the "),g=a(D,"CODE",{});var L=s(g);$=i(L,"Module"),L.forEach(t),A=i(D,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),D.forEach(t)},m(j,D){h(j,p,D),e(p,q),e(p,g),e(g,$),e(p,A)},d(j){j&&t(p)}}}function Hr(et){let p,q,g,$,A,j,D,L,Lo,no,J,ee,Pt,he,So,Mt,No,ao,u,Bo,tt,Oo,Wo,zt,Ro,Uo,ot,Jo,Ho,nt,Zo,Go,at,Xo,Ko,Ct,Qo,Yo,st,en,tn,rt,on,nn,so,te,an,fe,sn,rn,ro,H,oe,Ft,ue,ln,It,dn,io,w,ge,cn,B,it,mn,pn,lt,hn,fn,dt,un,gn,_n,Z,vn,ct,xn,Tn,mt,En,bn,jn,At,wn,yn,_e,Vn,ne,ve,kn,xe,Dn,pt,$n,Pn,Mn,ae,Te,zn,Ee,Cn,ht,Fn,In,lo,G,se,qt,be,An,Lt,qn,co,P,je,Ln,St,Sn,Nn,M,ft,Bn,On,ut,Wn,Rn,gt,Un,Jn,Nt,Hn,Zn,_t,Gn,Xn,Kn,re,we,Qn,ye,Yn,vt,ea,ta,oa,ie,Ve,na,ke,aa,xt,sa,ra,mo,X,le,Bt,De,ia,Ot,la,po,y,$e,da,Pe,ca,Tt,ma,pa,ha,Me,fa,ze,ua,ga,_a,Wt,va,xa,Ce,Ta,Et,Ea,ba,ja,Fe,wa,Ie,ya,Va,ka,z,Ae,Da,K,$a,bt,Pa,Ma,Rt,za,Ca,Fa,de,Ia,Ut,Aa,qa,qe,ho,Q,ce,Jt,Le,La,Ht,Sa,fo,f,Se,Na,Ne,Ba,jt,Oa,Wa,Ra,Be,Ua,Oe,Ja,Ha,Za,Zt,Ga,Xa,We,Ka,wt,Qa,Ya,es,Re,ts,Ue,os,ns,as,Gt,ss,rs,S,Xt,Je,is,ls,Kt,He,ds,cs,Qt,Ze,ms,ps,Yt,Ge,hs,fs,C,Xe,us,Y,gs,yt,_s,vs,eo,xs,Ts,Es,me,bs,to,js,ws,Ke,uo;return j=new $t({}),he=new $t({}),ue=new $t({}),ge=new U({props:{name:"class transformers.VisionTextDualEncoderConfig",anchor:"transformers.VisionTextDualEncoderConfig",parameters:[{name:"projection_dim",val:" = 512"},{name:"logit_scale_init_value",val:" = 2.6592"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/vision_text_dual_encoder/configuration_vision_text_dual_encoder.py#L28",parametersDescription:[{anchor:"transformers.VisionTextDualEncoderConfig.text_config_dict",description:`<strong>text_config_dict</strong> (<code>dict</code>) &#x2014;
...
<span class="hljs-meta">&gt;&gt;&gt; </span>outputs = model(**inputs)
<span class="hljs-meta">&gt;&gt;&gt; </span>logits_per_image = outputs.logits_per_image  <span class="hljs-comment"># this is the image-text similarity score</span>
<span class="hljs-meta">&gt;&gt;&gt; </span>probs = jax.nn.softmax(logits_per_image, axis=<span class="hljs-number">1</span>)  <span class="hljs-comment"># we can take the softmax to get the label probabilities</span>`}}),{c(){p=n("meta"),q=d(),g=n("h1"),$=n("a"),A=n("span"),_(j.$$.fragment),D=d(),L=n("span"),Lo=r("VisionTextDualEncoder"),no=d(),J=n("h2"),ee=n("a"),Pt=n("span"),_(he.$$.fragment),So=d(),Mt=n("span"),No=r("Overview"),ao=d(),u=n("p"),Bo=r("The "),tt=n("a"),Oo=r("VisionTextDualEncoderModel"),Wo=r(` can be used to initialize a vision-text dual encoder model with
...
new zero-shot vision tasks such as image classification or retrieval.`),ro=d(),H=n("h2"),oe=n("a"),Ft=n("span"),_(ue.$$.fragment),ln=d(),It=n("span"),dn=r("VisionTextDualEncoderConfig"),io=d(),w=n("div"),_(ge.$$.fragment),cn=d(),B=n("p"),it=n("a"),mn=r("VisionTextDualEncoderConfig"),pn=r(` is the configuration class to store the configuration of a
...
documentation from `),mt=n("a"),En=r("PretrainedConfig"),bn=r(" for more information."),jn=d(),At=n("p"),wn=r("Examples:"),yn=d(),_(_e.$$.fragment),Vn=d(),ne=n("div"),_(ve.$$.fragment),kn=d(),xe=n("p"),Dn=r("Instantiate a "),pt=n("a"),$n=r("VisionTextDualEncoderConfig"),Pn=r(` (or a derived class) from text model configuration and vision
...
`),vt=n("a"),ea=r("batch_decode()"),ta=r(". Please refer to the docstring of this method for more information."),oa=d(),ie=n("div"),_(Ve.$$.fragment),na=d(),ke=n("p"),aa=r("This method forwards all its arguments to VisionTextDualEncoderTokenizer\u2019s "),xt=n("a"),sa=r("decode()"),ra=r(`.
Please refer to the docstring of this method for more information.`),mo=d(),X=n("h2"),le=n("a"),Bt=n("span"),_(De.$$.fragment),ia=d(),Ot=n("span"),la=r("VisionTextDualEncoderModel"),po=d(),y=n("div"),_($e.$$.fragment),da=d(),Pe=n("p"),ca=r(`This class can be used to initialize a vision-text dual encoder model with any pretrained vision autoencoding model
...
etc.)`),ja=d(),Fe=n("p"),wa=r("This model is also a PyTorch "),Ie=n("a"),ya=r("torch.nn.Module"),Va=r(` subclass.
...
as the vision encoder and any pretrained text model as the text encoder. The vision and text encoders are loaded
via the `),jt=n("a"),Oa=r("from_pretrained()"),Wa=r(` method. The projection layers are automatically added to the model and
...
leveraging pre-trained (locked/frozen) image and text model for contrastive learning yields significant improvment on
new zero-shot vision tasks such as image classification or retrieval.`),_o.forEach(t),ro=c(o),H=a(o,"H2",{class:!0});var vo=s(H);oe=a(vo,"A",{id:!0,class:!0,href:!0});var Ns=s(oe);Ft=a(Ns,"SPAN",{});var Bs=s(Ft);v(ue.$$.fragment,Bs),Bs.forEach(t),Ns.forEach(t),ln=c(vo),It=a(vo,"SPAN",{});var Os=s(It);dn=i(Os,"VisionTextDualEncoderConfig"),Os.forEach(t),vo.forEach(t),io=c(o),w=a(o,"DIV",{class:!0});var F=s(w);v(ge.$$.fragment,F),cn=c(F),B=a(F,"P",{});var Ye=s(B);it=a(Ye,"A",{href:!0});var Ws=s(it);mn=i(Ws,"VisionTextDualEncoderConfig"),Ws.forEach(t),pn=i(Ye,` is the configuration class to store the configuration of a
...
specified arguments, defining the text model and vision model configs.`),Ye.forEach(t),_n=c(F),Z=a(F,"P",{});var Vt=s(Z);vn=i(Vt,"Configuration objects inherit from "),ct=a(Vt,"A",{href:!0});var Js=s(ct);xn=i(Js,"PretrainedConfig"),Js.forEach(t),Tn=i(Vt,` and can be used to control the model outputs. Read the
documentation from `),mt=a(Vt,"A",{href:!0});var Hs=s(mt);En=i(Hs,"PretrainedConfig"),Hs.forEach(t),bn=i(Vt," for more information."),Vt.forEach(t),jn=c(F),At=a(F,"P",{});var Zs=s(At);wn=i(Zs,"Examples:"),Zs.forEach(t),yn=c(F),v(_e.$$.fragment,F),Vn=c(F),ne=a(F,"DIV",{class:!0});var xo=s(ne);v(ve.$$.fragment,xo),kn=c(xo),xe=a(xo,"P",{});var To=s(xe);Dn=i(To,"Instantiate a "),pt=a(To,"A",{href:!0});var Gs=s(pt);$n=i(Gs,"VisionTextDualEncoderConfig"),Gs.forEach(t),Pn=i(To,` (or a derived class) from text model configuration and vision
model configuration.`),To.forEach(t),xo.forEach(t),Mn=c(F),ae=a(F,"DIV",{class:!0});var Eo=s(ae);v(Te.$$.fragment,Eo),zn=c(Eo),Ee=a(Eo,"P",{});var bo=s(Ee);Cn=i(bo,"Serializes this instance to a Python dictionary. Override the default "),ht=a(bo,"A",{href:!0});var Xs=s(ht);Fn=i(Xs,"to_dict()"),Xs.forEach(t),In=i(bo,"."),bo.forEach(t),Eo.forEach(t),F.forEach(t),lo=c(o),G=a(o,"H2",{class:!0});var jo=s(G);se=a(jo,"A",{id:!0,class:!0,href:!0});var Ks=s(se);qt=a(Ks,"SPAN",{});var Qs=s(qt);v(be.$$.fragment,Qs),Qs.forEach(t),Ks.forEach(t),An=c(jo),Lt=a(jo,"SPAN",{});var Ys=s(Lt);qn=i(Ys,"VisionTextDualEncoderProcessor"),Ys.forEach(t),jo.forEach(t),co=c(o),P=a(o,"DIV",{class:!0});var O=s(P);v(je.$$.fragment,O),Ln=c(O),St=a(O,"P",{});var er=s(St);Sn=i(er,`Constructs a VisionTextDualEncoder processor which wraps a vision feature extractor and a tokenizer into a single
...
`),vt=a(yo,"A",{href:!0});var rr=s(vt);ea=i(rr,"batch_decode()"),rr.forEach(t),ta=i(yo,". Please refer to the docstring of this method for more information."),yo.forEach(t),wo.forEach(t),oa=c(O),ie=a(O,"DIV",{class:!0});var Vo=s(ie);v(Ve.$$.fragment,Vo),na=c(Vo),ke=a(Vo,"P",{});var ko=s(ke);aa=i(ko,"This method forwards all its arguments to VisionTextDualEncoderTokenizer\u2019s "),xt=a(ko,"A",{href:!0});var ir=s(xt);sa=i(ir,"decode()"),ir.forEach(t),ra=i(ko,`.
Please refer to the docstring of this method for more information.`),ko.forEach(t),Vo.forEach(t),O.forEach(t),mo=c(o),X=a(o,"H2",{class:!0});var Do=s(X);le=a(Do,"A",{id:!0,class:!0,href:!0});var lr=s(le);Bt=a(lr,"SPAN",{});var dr=s(Bt);v(De.$$.fragment,dr),dr.forEach(t),lr.forEach(t),ia=c(Do),Ot=a(Do,"SPAN",{});var cr=s(Ot);la=i(cr,"VisionTextDualEncoderModel"),cr.forEach(t),Do.forEach(t),po=c(o),y=a(o,"DIV",{class:!0});var I=s(y);v($e.$$.fragment,I),da=c(I),Pe=a(I,"P",{});var $o=s(Pe);ca=i($o,`This class can be used to initialize a vision-text dual encoder model with any pretrained vision autoencoding model
as the vision encoder and any pretrained text model as the text encoder. The vision and text encoders are loaded
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Mo.forEach(t),ja=c(I),Fe=a(I,"P",{});var zo=s(Fe);wa=i(zo,"This model is also a PyTorch "),Ie=a(zo,"A",{href:!0,rel:!0});var ur=s(Ie);ya=i(ur,"torch.nn.Module"),ur.forEach(t),Va=i(zo,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),zo.forEach(t),ka=c(I),z=a(I,"DIV",{class:!0});var W=s(z);v(Ae.$$.fragment,W),Da=c(W),K=a(W,"P",{});var kt=s(K);$a=i(kt,"The "),bt=a(kt,"A",{href:!0});var gr=s(bt);Pa=i(gr,"VisionTextDualEncoderModel"),gr.forEach(t),Ma=i(kt," forward method, overrides the "),Rt=a(kt,"CODE",{});var _r=s(Rt);za=i(_r,"__call__"),_r.forEach(t),Ca=i(kt," special method."),kt.forEach(t),Fa=c(W),v(de.$$.fragment,W),Ia=c(W),Ut=a(W,"P",{});var vr=s(Ut);Aa=i(vr,"Examples:"),vr.forEach(t),qa=c(W),v(qe.$$.fragment,W),W.forEach(t),I.forEach(t),ho=c(o),Q=a(o,"H2",{class:!0});var Co=s(Q);ce=a(Co,"A",{id:!0,class:!0,href:!0});var xr=s(ce);Jt=a(xr,"SPAN",{});var Tr=s(Jt);v(Le.$$.fragment,Tr),Tr.forEach(t),xr.forEach(t),La=c(Co),Ht=a(Co,"SPAN",{});var Er=s(Ht);Sa=i(Er,"FlaxVisionTextDualEncoderModel"),Er.forEach(t),Co.forEach(t),fo=c(o),f=a(o,"DIV",{class:!0});var k=s(f);v(Se.$$.fragment,k),Na=c(k),Ne=a(k,"P",{});var Fo=s(Ne);Ba=i(Fo,`This class can be used to initialize a vision-text dual encoder model with any pretrained vision autoencoding model
as the vision encoder and any pretrained text model as the text encoder. The vision and text encoders are loaded
via the `),jt=a(Fo,"A",{href:!0});var br=s(jt);Oa=i(br,"from_pretrained()"),br.forEach(t),Wa=i(Fo,` method. The projection layers are automatically added to the model and
should be fine-tuned on a downstream task, like contrastive image-text modeling.`),Fo.forEach(t),Ra=c(k),Be=a(k,"P",{});var Io=s(Be);Ua=i(Io,"In "),Oe=a(Io,"A",{href:!0,rel:!0});var jr=s(Oe);Ja=i(jr,"LiT: Zero-Shot Transfer with Locked-image Text Tuning"),jr.forEach(t),Ha=i(Io,` it is shown how
leveraging pre-trained (locked/frozen) image and text model for contrastive learning yields significant improvment
on new zero-shot vision tasks such as image classification or retrieval.`),Io.forEach(t),Za=c(k),Zt=a(k,"P",{});var wr=s(Zt);Ga=i(wr,`After such a Vision-Text-Dual-Encoder model has been trained/fine-tuned, it can be saved/loaded just like any other
models (see the examples for more information).`),wr.forEach(t),Xa=c(k),We=a(k,"P",{});var Ao=s(We);Ka=i(Ao,"This model inherits from "),wt=a(Ao,"A",{href:!0});var yr=s(wt);Qa=i(yr,"PreTrainedModel"),yr.forEach(t),Ya=i(Ao,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
