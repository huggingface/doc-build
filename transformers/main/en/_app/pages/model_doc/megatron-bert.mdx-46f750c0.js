import{S as ch,i as ph,s as mh,e as a,k as h,w as k,t as s,M as hh,c as i,d as o,m as u,a as l,x as M,h as r,b as g,F as e,g as b,y as w,q as $,o as T,B as y,v as uh,L as j}from"../../chunks/vendor-6b77c823.js";import{T as We}from"../../chunks/Tip-39098574.js";import{D as P}from"../../chunks/Docstring-1088f2fb.js";import{C as z}from"../../chunks/CodeBlock-3a8b25a8.js";import{I as te}from"../../chunks/IconCopyLink-7a11ce68.js";import{E}from"../../chunks/ExampleCodeBlock-5212b321.js";function fh(B){let d,_,c,m,v;return m=new z({props:{code:`from transformers import MegatronBertModel, MegatronBertConfig
...
<span class="hljs-meta">&gt;&gt;&gt; </span>configuration = model.config`}}),{c(){d=a("p"),_=s("Examples:"),c=h(),k(m.$$.fragment)},l(n){d=i(n,"P",{});var p=l(d);_=r(p,"Examples:"),p.forEach(o),c=u(n),M(m.$$.fragment,n)},m(n,p){b(n,d,p),e(d,_),b(n,c,p),w(m,n,p),v=!0},p:j,i(n){v||($(m.$$.fragment,n),v=!0)},o(n){T(m.$$.fragment,n),v=!1},d(n){n&&o(d),n&&o(c),y(m,n)}}}function gh(B){let d,_,c,m,v;return{c(){d=a("p"),_=s("Although the recipe for forward pass needs to be defined within this function, one should call the "),c=a("code"),m=s("Module"),v=s(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(n){d=i(n,"P",{});var p=l(d);_=r(p,"Although the recipe for forward pass needs to be defined within this function, one should call the "),c=i(p,"CODE",{});var F=l(c);m=r(F,"Module"),F.forEach(o),v=r(p,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),p.forEach(o)},m(n,p){b(n,d,p),e(d,_),e(d,c),e(c,m),e(d,v)},d(n){n&&o(d)}}}function _h(B){let d,_,c,m,v;return m=new z({props:{code:`from transformers import BertTokenizer, MegatronBertModel
import torch
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),{c(){d=a("p"),_=s("Example:"),c=h(),k(m.$$.fragment)},l(n){d=i(n,"P",{});var p=l(d);_=r(p,"Example:"),p.forEach(o),c=u(n),M(m.$$.fragment,n)},m(n,p){b(n,d,p),e(d,_),b(n,c,p),w(m,n,p),v=!0},p:j,i(n){v||($(m.$$.fragment,n),v=!0)},o(n){T(m.$$.fragment,n),v=!1},d(n){n&&o(d),n&&o(c),y(m,n)}}}function bh(B){let d,_,c,m,v;return{c(){d=a("p"),_=s("Although the recipe for forward pass needs to be defined within this function, one should call the "),c=a("code"),m=s("Module"),v=s(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(n){d=i(n,"P",{});var p=l(d);_=r(p,"Although the recipe for forward pass needs to be defined within this function, one should call the "),c=i(p,"CODE",{});var F=l(c);m=r(F,"Module"),F.forEach(o),v=r(p,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),p.forEach(o)},m(n,p){b(n,d,p),e(d,_),e(d,c),e(c,m),e(d,v)},d(n){n&&o(d)}}}function vh(B){let d,_,c,m,v;return m=new z({props:{code:`from transformers import BertTokenizer, MegatronBertForMaskedLM
import torch
...
`}}),{c(){d=a("p"),_=s("Example:"),c=h(),k(m.$$.fragment)},l(n){d=i(n,"P",{});var p=l(d);_=r(p,"Example:"),p.forEach(o),c=u(n),M(m.$$.fragment,n)},m(n,p){b(n,d,p),e(d,_),b(n,c,p),w(m,n,p),v=!0},p:j,i(n){v||($(m.$$.fragment,n),v=!0)},o(n){T(m.$$.fragment,n),v=!1},d(n){n&&o(d),n&&o(c),y(m,n)}}}function kh(B){let d,_;return d=new z({props:{code:`labels = tokenizer("The capital of France is Paris.", return_tensors="pt")["input_ids"]
...
`}}),{c(){k(d.$$.fragment)},l(c){M(d.$$.fragment,c)},m(c,m){w(d,c,m),_=!0},p:j,i(c){_||($(d.$$.fragment,c),_=!0)},o(c){T(d.$$.fragment,c),_=!1},d(c){y(d,c)}}}function Mh(B){let d,_,c,m,v;return{c(){d=a("p"),_=s("Although the recipe for forward pass needs to be defined within this function, one should call the "),c=a("code"),m=s("Module"),v=s(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(n){d=i(n,"P",{});var p=l(d);_=r(p,"Although the recipe for forward pass needs to be defined within this function, one should call the "),c=i(p,"CODE",{});var F=l(c);m=r(F,"Module"),F.forEach(o),v=r(p,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),p.forEach(o)},m(n,p){b(n,d,p),e(d,_),e(d,c),e(c,m),e(d,v)},d(n){n&&o(d)}}}function wh(B){let d,_,c,m,v;return m=new z({props:{code:`from transformers import BertTokenizer, MegatronBertForCausalLM, MegatronBertConfig
import torch
...
<span class="hljs-meta">&gt;&gt;&gt; </span>prediction_logits = outputs.logits`}}),{c(){d=a("p"),_=s("Example:"),c=h(),k(m.$$.fragment)},l(n){d=i(n,"P",{});var p=l(d);_=r(p,"Example:"),p.forEach(o),c=u(n),M(m.$$.fragment,n)},m(n,p){b(n,d,p),e(d,_),b(n,c,p),w(m,n,p),v=!0},p:j,i(n){v||($(m.$$.fragment,n),v=!0)},o(n){T(m.$$.fragment,n),v=!1},d(n){n&&o(d),n&&o(c),y(m,n)}}}function $h(B){let d,_,c,m,v;return{c(){d=a("p"),_=s("Although the recipe for forward pass needs to be defined within this function, one should call the "),c=a("code"),m=s("Module"),v=s(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(n){d=i(n,"P",{});var p=l(d);_=r(p,"Although the recipe for forward pass needs to be defined within this function, one should call the "),c=i(p,"CODE",{});var F=l(c);m=r(F,"Module"),F.forEach(o),v=r(p,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),p.forEach(o)},m(n,p){b(n,d,p),e(d,_),e(d,c),e(c,m),e(d,v)},d(n){n&&o(d)}}}function Th(B){let d,_,c,m,v;return m=new z({props:{code:`from transformers import BertTokenizer, MegatronBertForNextSentencePrediction
import torch
...
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-keyword">assert</span> logits[<span class="hljs-number">0</span>, <span class="hljs-number">0</span>] &lt; logits[<span class="hljs-number">0</span>, <span class="hljs-number">1</span>]  <span class="hljs-comment"># next sentence was random</span>`}}),{c(){d=a("p"),_=s("Example:"),c=h(),k(m.$$.fragment)},l(n){d=i(n,"P",{});var p=l(d);_=r(p,"Example:"),p.forEach(o),c=u(n),M(m.$$.fragment,n)},m(n,p){b(n,d,p),e(d,_),b(n,c,p),w(m,n,p),v=!0},p:j,i(n){v||($(m.$$.fragment,n),v=!0)},o(n){T(m.$$.fragment,n),v=!1},d(n){n&&o(d),n&&o(c),y(m,n)}}}function yh(B){let d,_,c,m,v;return{c(){d=a("p"),_=s("Although the recipe for forward pass needs to be defined within this function, one should call the "),c=a("code"),m=s("Module"),v=s(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(n){d=i(n,"P",{});var p=l(d);_=r(p,"Although the recipe for forward pass needs to be defined within this function, one should call the "),c=i(p,"CODE",{});var F=l(c);m=r(F,"Module"),F.forEach(o),v=r(p,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),p.forEach(o)},m(n,p){b(n,d,p),e(d,_),e(d,c),e(c,m),e(d,v)},d(n){n&&o(d)}}}function Bh(B){let d,_,c,m,v;return m=new z({props:{code:`from transformers import BertTokenizer, MegatronBertForPreTraining
import torch
...
<span class="hljs-meta">&gt;&gt;&gt; </span>seq_relationship_logits = outputs.seq_relationship_logits`}}),{c(){d=a("p"),_=s("Example:"),c=h(),k(m.$$.fragment)},l(n){d=i(n,"P",{});var p=l(d);_=r(p,"Example:"),p.forEach(o),c=u(n),M(m.$$.fragment,n)},m(n,p){b(n,d,p),e(d,_),b(n,c,p),w(m,n,p),v=!0},p:j,i(n){v||($(m.$$.fragment,n),v=!0)},o(n){T(m.$$.fragment,n),v=!1},d(n){n&&o(d),n&&o(c),y(m,n)}}}function Fh(B){let d,_,c,m,v;return{c(){d=a("p"),_=s("Although the recipe for forward pass needs to be defined within this function, one should call the "),c=a("code"),m=s("Module"),v=s(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(n){d=i(n,"P",{});var p=l(d);_=r(p,"Although the recipe for forward pass needs to be defined within this function, one should call the "),c=i(p,"CODE",{});var F=l(c);m=r(F,"Module"),F.forEach(o),v=r(p,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),p.forEach(o)},m(n,p){b(n,d,p),e(d,_),e(d,c),e(c,m),e(d,v)},d(n){n&&o(d)}}}function zh(B){let d,_,c,m,v;return m=new z({props:{code:`import torch
...
`}}),{c(){d=a("p"),_=s("Example of single-label classification:"),c=h(),k(m.$$.fragment)},l(n){d=i(n,"P",{});var p=l(d);_=r(p,"Example of single-label classification:"),p.forEach(o),c=u(n),M(m.$$.fragment,n)},m(n,p){b(n,d,p),e(d,_),b(n,c,p),w(m,n,p),v=!0},p:j,i(n){v||($(m.$$.fragment,n),v=!0)},o(n){T(m.$$.fragment,n),v=!1},d(n){n&&o(d),n&&o(c),y(m,n)}}}function xh(B){let d,_;return d=new z({props:{code:`# To train a model on \`num_labels\` classes, you can pass \`num_labels=num_labels\` to \`.from_pretrained(...)\`
...
`}}),{c(){k(d.$$.fragment)},l(c){M(d.$$.fragment,c)},m(c,m){w(d,c,m),_=!0},p:j,i(c){_||($(d.$$.fragment,c),_=!0)},o(c){T(d.$$.fragment,c),_=!1},d(c){y(d,c)}}}function Ph(B){let d,_,c,m,v;return m=new z({props:{code:`import torch
from transformers import BertTokenizer, MegatronBertForSequenceClassification
...
<span class="hljs-meta">&gt;&gt;&gt; </span>predicted_class_id = logits.argmax().item()
<span class="hljs-meta">&gt;&gt;&gt; </span>model.config.id2label[predicted_class_id]
`}}),{c(){d=a("p"),_=s("Example of multi-label classification:"),c=h(),k(m.$$.fragment)},l(n){d=i(n,"P",{});var p=l(d);_=r(p,"Example of multi-label classification:"),p.forEach(o),c=u(n),M(m.$$.fragment,n)},m(n,p){b(n,d,p),e(d,_),b(n,c,p),w(m,n,p),v=!0},p:j,i(n){v||($(m.$$.fragment,n),v=!0)},o(n){T(m.$$.fragment,n),v=!1},d(n){n&&o(d),n&&o(c),y(m,n)}}}function qh(B){let d,_;return d=new z({props:{code:`# To train a model on \`num_labels\` classes, you can pass \`num_labels=num_labels\` to \`.from_pretrained(...)\`
num_labels = len(model.config.id2label)
...
<span class="hljs-meta">... </span>)
<span class="hljs-meta">&gt;&gt;&gt; </span>loss = model(**inputs, labels=labels).loss
<span class="hljs-meta">&gt;&gt;&gt; </span>loss.backward()`}}),{c(){k(d.$$.fragment)},l(c){M(d.$$.fragment,c)},m(c,m){w(d,c,m),_=!0},p:j,i(c){_||($(d.$$.fragment,c),_=!0)},o(c){T(d.$$.fragment,c),_=!1},d(c){y(d,c)}}}function Ch(B){let d,_,c,m,v;return{c(){d=a("p"),_=s("Although the recipe for forward pass needs to be defined within this function, one should call the "),c=a("code"),m=s("Module"),v=s(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(n){d=i(n,"P",{});var p=l(d);_=r(p,"Although the recipe for forward pass needs to be defined within this function, one should call the "),c=i(p,"CODE",{});var F=l(c);m=r(F,"Module"),F.forEach(o),v=r(p,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),p.forEach(o)},m(n,p){b(n,d,p),e(d,_),e(d,c),e(c,m),e(d,v)},d(n){n&&o(d)}}}function Eh(B){let d,_,c,m,v;return m=new z({props:{code:`from transformers import BertTokenizer, MegatronBertForMultipleChoice
import torch
...
<span class="hljs-meta">&gt;&gt;&gt; </span>logits = outputs.logits`}}),{c(){d=a("p"),_=s("Example:"),c=h(),k(m.$$.fragment)},l(n){d=i(n,"P",{});var p=l(d);_=r(p,"Example:"),p.forEach(o),c=u(n),M(m.$$.fragment,n)},m(n,p){b(n,d,p),e(d,_),b(n,c,p),w(m,n,p),v=!0},p:j,i(n){v||($(m.$$.fragment,n),v=!0)},o(n){T(m.$$.fragment,n),v=!1},d(n){n&&o(d),n&&o(c),y(m,n)}}}function jh(B){let d,_,c,m,v;return{c(){d=a("p"),_=s("Although the recipe for forward pass needs to be defined within this function, one should call the "),c=a("code"),m=s("Module"),v=s(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(n){d=i(n,"P",{});var p=l(d);_=r(p,"Although the recipe for forward pass needs to be defined within this function, one should call the "),c=i(p,"CODE",{});var F=l(c);m=r(F,"Module"),F.forEach(o),v=r(p,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),p.forEach(o)},m(n,p){b(n,d,p),e(d,_),e(d,c),e(c,m),e(d,v)},d(n){n&&o(d)}}}function Ah(B){let d,_,c,m,v;return m=new z({props:{code:`from transformers import BertTokenizer, MegatronBertForTokenClassification
import torch
...
`}}),{c(){d=a("p"),_=s("Example:"),c=h(),k(m.$$.fragment)},l(n){d=i(n,"P",{});var p=l(d);_=r(p,"Example:"),p.forEach(o),c=u(n),M(m.$$.fragment,n)},m(n,p){b(n,d,p),e(d,_),b(n,c,p),w(m,n,p),v=!0},p:j,i(n){v||($(m.$$.fragment,n),v=!0)},o(n){T(m.$$.fragment,n),v=!1},d(n){n&&o(d),n&&o(c),y(m,n)}}}function Sh(B){let d,_;return d=new z({props:{code:`labels = predicted_token_class_ids
loss = model(**inputs, labels=labels).loss
round(loss.item(), 2)
`,highlighted:`<span class="hljs-meta">&gt;&gt;&gt; </span>labels = predicted_token_class_ids
<span class="hljs-meta">&gt;&gt;&gt; </span>loss = model(**inputs, labels=labels).loss
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-built_in">round</span>(loss.item(), <span class="hljs-number">2</span>)
`}}),{c(){k(d.$$.fragment)},l(c){M(d.$$.fragment,c)},m(c,m){w(d,c,m),_=!0},p:j,i(c){_||($(d.$$.fragment,c),_=!0)},o(c){T(d.$$.fragment,c),_=!1},d(c){y(d,c)}}}function Nh(B){let d,_,c,m,v;return{c(){d=a("p"),_=s("Although the recipe for forward pass needs to be defined within this function, one should call the "),c=a("code"),m=s("Module"),v=s(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(n){d=i(n,"P",{});var p=l(d);_=r(p,"Although the recipe for forward pass needs to be defined within this function, one should call the "),c=i(p,"CODE",{});var F=l(c);m=r(F,"Module"),F.forEach(o),v=r(p,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),p.forEach(o)},m(n,p){b(n,d,p),e(d,_),e(d,c),e(c,m),e(d,v)},d(n){n&&o(d)}}}function Lh(B){let d,_,c,m,v;return m=new z({props:{code:`from transformers import BertTokenizer, MegatronBertForQuestionAnswering
import torch
...
`}}),{c(){d=a("p"),_=s("Example:"),c=h(),k(m.$$.fragment)},l(n){d=i(n,"P",{});var p=l(d);_=r(p,"Example:"),p.forEach(o),c=u(n),M(m.$$.fragment,n)},m(n,p){b(n,d,p),e(d,_),b(n,c,p),w(m,n,p),v=!0},p:j,i(n){v||($(m.$$.fragment,n),v=!0)},o(n){T(m.$$.fragment,n),v=!1},d(n){n&&o(d),n&&o(c),y(m,n)}}}function Ih(B){let d,_;return d=new z({props:{code:`# target is "nice puppet"
...
<span class="hljs-meta">&gt;&gt;&gt; </span>loss = outputs.loss
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-built_in">round</span>(loss.item(), <span class="hljs-number">2</span>)
`}}),{c(){k(d.$$.fragment)},l(c){M(d.$$.fragment,c)},m(c,m){w(d,c,m),_=!0},p:j,i(c){_||($(d.$$.fragment,c),_=!0)},o(c){T(d.$$.fragment,c),_=!1},d(c){y(d,c)}}}function Oh(B){let d,_,c,m,v,n,p,F,Ta,lr,ge,Re,Qn,Et,ya,Vn,Ba,dr,He,Fa,jt,za,xa,cr,nn,Pa,pr,sn,Gn,qa,mr,rn,Ca,hr,Ue,Ea,At,ja,Aa,ur,oe,Sa,St,Na,La,Nt,Ia,Oa,fr,an,Da,gr,ln,Wa,_r,Lt,br,dn,Ra,vr,It,kr,cn,Ha,Mr,ne,Ua,Jn,Qa,Va,Kn,Ga,Ja,wr,Ot,$r,Dt,Tr,se,Ka,Wt,Ya,Xa,Rt,Za,ei,yr,_e,Qe,Yn,Ht,ti,Xn,oi,Br,J,Ut,ni,be,si,pn,ri,ai,Qt,ii,li,di,ve,ci,mn,pi,mi,hn,hi,ui,fi,Ve,Fr,ke,Ge,Zn,Vt,gi,es,_i,zr,x,Gt,bi,ts,vi,ki,Jt,Mi,un,wi,$i,Ti,Kt,yi,Yt,Bi,Fi,zi,Xt,xi,Zt,Pi,qi,Ci,C,Ei,os,ji,Ai,ns,Si,Ni,ss,Li,Ii,rs,Oi,Di,as,Wi,Ri,is,Hi,Ui,Qi,K,eo,Vi,Me,Gi,fn,Ji,Ki,ls,Yi,Xi,Zi,Je,el,Ke,xr,we,Ye,ds,to,tl,cs,ol,Pr,A,oo,nl,no,sl,ps,rl,al,il,so,ll,gn,dl,cl,pl,ro,ml,ao,hl,ul,fl,R,io,gl,$e,_l,_n,bl,vl,ms,kl,Ml,wl,Xe,$l,Ze,Tl,et,qr,Te,tt,hs,lo,yl,us,Bl,Cr,S,co,Fl,po,zl,fs,xl,Pl,ql,mo,Cl,bn,El,jl,Al,ho,Sl,uo,Nl,Ll,Il,Y,fo,Ol,ye,Dl,vn,Wl,Rl,gs,Hl,Ul,Ql,ot,Vl,nt,Er,Be,st,_s,go,Gl,bs,Jl,jr,N,_o,Kl,bo,Yl,vs,Xl,Zl,ed,vo,td,kn,od,nd,sd,ko,rd,Mo,ad,id,ld,X,wo,dd,Fe,cd,Mn,pd,md,ks,hd,ud,fd,rt,gd,at,Ar,ze,it,Ms,$o,_d,ws,bd,Sr,L,To,vd,xe,kd,$s,Md,wd,Ts,$d,Td,yd,yo,Bd,wn,Fd,zd,xd,Bo,Pd,Fo,qd,Cd,Ed,Z,zo,jd,Pe,Ad,$n,Sd,Nd,ys,Ld,Id,Od,lt,Dd,dt,Nr,qe,ct,Bs,xo,Wd,Fs,Rd,Lr,I,Po,Hd,zs,Ud,Qd,qo,Vd,Tn,Gd,Jd,Kd,Co,Yd,Eo,Xd,Zd,ec,q,jo,tc,Ce,oc,yn,nc,sc,xs,rc,ac,ic,pt,lc,mt,dc,ht,cc,ut,pc,ft,Ir,Ee,gt,Ps,Ao,mc,qs,hc,Or,O,So,uc,Cs,fc,gc,No,_c,Bn,bc,vc,kc,Lo,Mc,Io,wc,$c,Tc,ee,Oo,yc,je,Bc,Fn,Fc,zc,Es,xc,Pc,qc,_t,Cc,bt,Dr,Ae,vt,js,Do,Ec,As,jc,Wr,D,Wo,Ac,Ss,Sc,Nc,Ro,Lc,zn,Ic,Oc,Dc,Ho,Wc,Uo,Rc,Hc,Uc,H,Qo,Qc,Se,Vc,xn,Gc,Jc,Ns,Kc,Yc,Xc,kt,Zc,Mt,ep,wt,Rr,Ne,$t,Ls,Vo,tp,Is,op,Hr,W,Go,np,Le,sp,Os,rp,ap,Ds,ip,lp,dp,Jo,cp,Pn,pp,mp,hp,Ko,up,Yo,fp,gp,_p,U,Xo,bp,Ie,vp,qn,kp,Mp,Ws,wp,$p,Tp,Tt,yp,yt,Bp,Bt,Ur;return n=new te({}),Et=new te({}),Lt=new z({props:{code:`wget --content-disposition https://api.ngc.nvidia.com/v2/models/nvidia/megatron_bert_345m/versions/v0.1_uncased/zip
...
<code>past_key_values</code>).`,name:"use_cache"}],source:"https://github.com/huggingface/transformers/blob/vmain/src/transformers/models/megatron_bert/modeling_megatron_bert.py#L867",returnDescription:`
<p>A <a
...
loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vmain/src/transformers/models/megatron_bert/modeling_megatron_bert.py#L1281",returnDescription:`
<p>A <a
...
If set to <code>True</code>, <code>past_key_values</code> key value states are returned and can be used to speed up decoding (see
<code>past_key_values</code>).`,name:"use_cache"}],source:"https://github.com/huggingface/transformers/blob/vmain/src/transformers/models/megatron_bert/modeling_megatron_bert.py#L1132",returnDescription:`
<p>A <a
...
</ul>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vmain/src/transformers/models/megatron_bert/modeling_megatron_bert.py#L1378",returnDescription:`
<p>A <a
...
Used to hide legacy arguments that have been deprecated.`,name:"kwargs"}],source:"https://github.com/huggingface/transformers/blob/vmain/src/transformers/models/megatron_bert/modeling_megatron_bert.py#L1021",returnDescription:`
...
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vmain/src/transformers/models/megatron_bert/modeling_megatron_bert.py#L1483",returnDescription:`
<p>A <a
...
<code>input_ids</code> above)`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vmain/src/transformers/models/megatron_bert/modeling_megatron_bert.py#L1580",returnDescription:`
<p>A <a
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vmain/src/transformers/models/megatron_bert/modeling_megatron_bert.py#L1678",returnDescription:`
<p>A <a
...
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/vmain/src/transformers/models/megatron_bert/modeling_megatron_bert.py#L1759",returnDescription:`
<p>A <a
...
`}}),Tt=new We({props:{$$slots:{default:[Nh]},$$scope:{ctx:B}}}),yt=new E({props:{anchor:"transformers.MegatronBertForQuestionAnswering.forward.example",$$slots:{default:[Lh]},$$scope:{ctx:B}}}),Bt=new E({props:{anchor:"transformers.MegatronBertForQuestionAnswering.forward.example-2",$$slots:{default:[Ih]},$$scope:{ctx:B}}}),{c(){d=a("meta"),_=h(),c=a("h1"),m=a("a"),v=a("span"),k(n.$$.fragment),p=h(),F=a("span"),Ta=s("MegatronBERT"),lr=h(),ge=a("h2"),Re=a("a"),Qn=a("span"),k(Et.$$.fragment),ya=h(),Vn=a("span"),Ba=s("Overview"),dr=h(),He=a("p"),Fa=s("The MegatronBERT model was proposed in "),jt=a("a"),za=s(`Megatron-LM: Training Multi-Billion Parameter Language Models Using Model
...
`),Kn=a("code"),Ga=s("megatron_bert_345m_v0_1_{cased, uncased}.zip"),Ja=s(" and that the commands are run from inside that folder:"),wr=h(),k(Ot.$$.fragment),$r=h(),k(Dt.$$.fragment),Tr=h(),se=a("p"),Ka=s("This model was contributed by "),Wt=a("a"),Ya=s("jdemouth"),Xa=s(". The original code can be found "),Rt=a("a"),Za=s("here"),ei=s(`. That repository contains a multi-GPU and multi-node implementation of the
Megatron Language models. In particular, it contains a hybrid model parallel approach using \u201Ctensor parallel\u201D and
\u201Cpipeline parallel\u201D techniques.`),yr=h(),_e=a("h2"),Qe=a("a"),Yn=a("span"),k(Ht.$$.fragment),ti=h(),Xn=a("span"),oi=s("MegatronBertConfig"),Br=h(),J=a("div"),k(Ut.$$.fragment),ni=h(),be=a("p"),si=s("This is the configuration class to store the configuration of a "),pn=a("a"),ri=s("MegatronBertModel"),ai=s(`. It is used to instantiate a
...
`),Qt=a("a"),ii=s("nvidia/megatron-bert-uncased-345m"),li=s(" architecture."),di=h(),ve=a("p"),ci=s("Configuration objects inherit from "),mn=a("a"),pi=s("PretrainedConfig"),mi=s(` and can be used to control the model outputs. Read the
documentation from `),hn=a("a"),hi=s("PretrainedConfig"),ui=s(" for more information."),fi=h(),k(Ve.$$.fragment),Fr=h(),ke=a("h2"),Ge=a("a"),Zn=a("span"),k(Vt.$$.fragment),gi=h(),es=a("span"),_i=s("MegatronBertModel"),zr=h(),x=a("div"),k(Gt.$$.fragment),bi=h(),ts=a("p"),vi=s("The bare MegatronBert Model transformer outputting raw hidden-states without any specific head on top."),ki=h(),Jt=a("p"),Mi=s("This model inherits from "),un=a("a"),wi=s("PreTrainedModel"),$i=s(`. Check the superclass documentation for the generic methods the
...
`),rs=a("code"),Oi=s("add_cross_attention"),Di=s(" set to "),as=a("code"),Wi=s("True"),Ri=s("; an "),is=a("code"),Hi=s("encoder_hidden_states"),Ui=s(" is then expected as an input to the forward pass."),Qi=h(),K=a("div"),k(eo.$$.fragment),Vi=h(),Me=a("p"),Gi=s("The "),fn=a("a"),Ji=s("MegatronBertModel"),Ki=s(" forward method, overrides the "),ls=a("code"),Yi=s("__call__"),Xi=s(" special method."),Zi=h(),k(Je.$$.fragment),el=h(),k(Ke.$$.fragment),xr=h(),we=a("h2"),Ye=a("a"),ds=a("span"),k(to.$$.fragment),tl=h(),cs=a("span"),ol=s("MegatronBertForMaskedLM"),Pr=h(),A=a("div"),k(oo.$$.fragment),nl=h(),no=a("p"),sl=s("MegatronBert Model with a "),ps=a("code"),rl=s("language modeling"),al=s(" head on top."),il=h(),so=a("p"),ll=s("This model inherits from "),gn=a("a"),dl=s("PreTrainedModel"),cl=s(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),pl=h(),ro=a("p"),ml=s("This model is also a PyTorch "),ao=a("a"),hl=s("torch.nn.Module"),ul=s(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),fl=h(),R=a("div"),k(io.$$.fragment),gl=h(),$e=a("p"),_l=s("The "),_n=a("a"),bl=s("MegatronBertForMaskedLM"),vl=s(" forward method, overrides the "),ms=a("code"),kl=s("__call__"),Ml=s(" special method."),wl=h(),k(Xe.$$.fragment),$l=h(),k(Ze.$$.fragment),Tl=h(),k(et.$$.fragment),qr=h(),Te=a("h2"),tt=a("a"),hs=a("span"),k(lo.$$.fragment),yl=h(),us=a("span"),Bl=s("MegatronBertForCausalLM"),Cr=h(),S=a("div"),k(co.$$.fragment),Fl=h(),po=a("p"),zl=s("MegatronBert Model with a "),fs=a("code"),xl=s("language modeling"),Pl=s(" head on top for CLM fine-tuning."),ql=h(),mo=a("p"),Cl=s("This model inherits from "),bn=a("a"),El=s("PreTrainedModel"),jl=s(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Al=h(),ho=a("p"),Sl=s("This model is also a PyTorch "),uo=a("a"),Nl=s("torch.nn.Module"),Ll=s(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Il=h(),Y=a("div"),k(fo.$$.fragment),Ol=h(),ye=a("p"),Dl=s("The "),vn=a("a"),Wl=s("MegatronBertForCausalLM"),Rl=s(" forward method, overrides the "),gs=a("code"),Hl=s("__call__"),Ul=s(" special method."),Ql=h(),k(ot.$$.fragment),Vl=h(),k(nt.$$.fragment),Er=h(),Be=a("h2"),st=a("a"),_s=a("span"),k(go.$$.fragment),Gl=h(),bs=a("span"),Jl=s("MegatronBertForNextSentencePrediction"),jr=h(),N=a("div"),k(_o.$$.fragment),Kl=h(),bo=a("p"),Yl=s("MegatronBert Model with a "),vs=a("code"),Xl=s("next sentence prediction (classification)"),Zl=s(" head on top."),ed=h(),vo=a("p"),td=s("This model inherits from "),kn=a("a"),od=s("PreTrainedModel"),nd=s(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),sd=h(),ko=a("p"),rd=s("This model is also a PyTorch "),Mo=a("a"),ad=s("torch.nn.Module"),id=s(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),ld=h(),X=a("div"),k(wo.$$.fragment),dd=h(),Fe=a("p"),cd=s("The "),Mn=a("a"),pd=s("MegatronBertForNextSentencePrediction"),md=s(" forward method, overrides the "),ks=a("code"),hd=s("__call__"),ud=s(" special method."),fd=h(),k(rt.$$.fragment),gd=h(),k(at.$$.fragment),Ar=h(),ze=a("h2"),it=a("a"),Ms=a("span"),k($o.$$.fragment),_d=h(),ws=a("span"),bd=s("MegatronBertForPreTraining"),Sr=h(),L=a("div"),k(To.$$.fragment),vd=h(),xe=a("p"),kd=s("MegatronBert Model with two heads on top as done during the pretraining: a "),$s=a("code"),Md=s("masked language modeling"),wd=s(` head and a
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Ed=h(),Z=a("div"),k(zo.$$.fragment),jd=h(),Pe=a("p"),Ad=s("The "),$n=a("a"),Sd=s("MegatronBertForPreTraining"),Nd=s(" forward method, overrides the "),ys=a("code"),Ld=s("__call__"),Id=s(" special method."),Od=h(),k(lt.$$.fragment),Dd=h(),k(dt.$$.fragment),Nr=h(),qe=a("h2"),ct=a("a"),Bs=a("span"),k(xo.$$.fragment),Wd=h(),Fs=a("span"),Rd=s("MegatronBertForSequenceClassification"),Lr=h(),I=a("div"),k(Po.$$.fragment),Hd=h(),zs=a("p"),Ud=s(`MegatronBert Model transformer with a sequence classification/regression head on top (a linear layer on top of the
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),ec=h(),q=a("div"),k(jo.$$.fragment),tc=h(),Ce=a("p"),oc=s("The "),yn=a("a"),nc=s("MegatronBertForSequenceClassification"),sc=s(" forward method, overrides the "),xs=a("code"),rc=s("__call__"),ac=s(" special method."),ic=h(),k(pt.$$.fragment),lc=h(),k(mt.$$.fragment),dc=h(),k(ht.$$.fragment),cc=h(),k(ut.$$.fragment),pc=h(),k(ft.$$.fragment),Ir=h(),Ee=a("h2"),gt=a("a"),Ps=a("span"),k(Ao.$$.fragment),mc=h(),qs=a("span"),hc=s("MegatronBertForMultipleChoice"),Or=h(),O=a("div"),k(So.$$.fragment),uc=h(),Cs=a("p"),fc=s(`MegatronBert Model with a multiple choice classification head on top (a linear layer on top of the pooled output
and a softmax) e.g. for RocStories/SWAG tasks.`),gc=h(),No=a("p"),_c=s("This model inherits from "),Bn=a("a"),bc=s("PreTrainedModel"),vc=s(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),kc=h(),Lo=a("p"),Mc=s("This model is also a PyTorch "),Io=a("a"),wc=s("torch.nn.Module"),$c=s(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Tc=h(),ee=a("div"),k(Oo.$$.fragment),yc=h(),je=a("p"),Bc=s("The "),Fn=a("a"),Fc=s("MegatronBertForMultipleChoice"),zc=s(" forward method, overrides the "),Es=a("code"),xc=s("__call__"),Pc=s(" special method."),qc=h(),k(_t.$$.fragment),Cc=h(),k(bt.$$.fragment),Dr=h(),Ae=a("h2"),vt=a("a"),js=a("span"),k(Do.$$.fragment),Ec=h(),As=a("span"),jc=s("MegatronBertForTokenClassification"),Wr=h(),D=a("div"),k(Wo.$$.fragment),Ac=h(),Ss=a("p"),Sc=s(`MegatronBert Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g.
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Uc=h(),H=a("div"),k(Qo.$$.fragment),Qc=h(),Se=a("p"),Vc=s("The "),xn=a("a"),Gc=s("MegatronBertForTokenClassification"),Jc=s(" forward method, overrides the "),Ns=a("code"),Kc=s("__call__"),Yc=s(" special method."),Xc=h(),k(kt.$$.fragment),Zc=h(),k(Mt.$$.fragment),ep=h(),k(wt.$$.fragment),Rr=h(),Ne=a("h2"),$t=a("a"),Ls=a("span"),k(Vo.$$.fragment),tp=h(),Is=a("span"),op=s("MegatronBertForQuestionAnswering"),Hr=h(),W=a("div"),k(Go.$$.fragment),np=h(),Le=a("p"),sp=s(`MegatronBert Model with a span classification head on top for extractive question-answering tasks like SQuAD (a
...
and a softmax) e.g. for RocStories/SWAG tasks.`),Wm.forEach(o),gc=u(pe),No=i(pe,"P",{});var ga=l(No);_c=r(ga,"This model inherits from "),Bn=i(ga,"A",{href:!0});var Rm=l(Bn);bc=r(Rm,"PreTrainedModel"),Rm.forEach(o),vc=r(ga,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),ga.forEach(o),kc=u(pe),Lo=i(pe,"P",{});var _a=l(Lo);Mc=r(_a,"This model is also a PyTorch "),Io=i(_a,"A",{href:!0,rel:!0});var Hm=l(Io);wc=r(Hm,"torch.nn.Module"),Hm.forEach(o),$c=r(_a,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),_a.forEach(o),Tc=u(pe),ee=i(pe,"DIV",{class:!0});var Ct=l(ee);M(Oo.$$.fragment,Ct),yc=u(Ct),je=i(Ct,"P",{});var Wn=l(je);Bc=r(Wn,"The "),Fn=i(Wn,"A",{href:!0});var Um=l(Fn);Fc=r(Um,"MegatronBertForMultipleChoice"),Um.forEach(o),zc=r(Wn," forward method, overrides the "),Es=i(Wn,"CODE",{});var Qm=l(Es);xc=r(Qm,"__call__"),Qm.forEach(o),Pc=r(Wn," special method."),Wn.forEach(o),qc=u(Ct),M(_t.$$.fragment,Ct),Cc=u(Ct),M(bt.$$.fragment,Ct),Ct.forEach(o),pe.forEach(o),Dr=u(t),Ae=i(t,"H2",{class:!0});var ba=l(Ae);vt=i(ba,"A",{id:!0,class:!0,href:!0});var Vm=l(vt);js=i(Vm,"SPAN",{});var Gm=l(js);M(Do.$$.fragment,Gm),Gm.forEach(o),Vm.forEach(o),Ec=u(ba),As=i(ba,"SPAN",{});var Jm=l(As);jc=r(Jm,"MegatronBertForTokenClassification"),Jm.forEach(o),ba.forEach(o),Wr=u(t),D=i(t,"DIV",{class:!0});var me=l(D);M(Wo.$$.fragment,me),Ac=u(me),Ss=i(me,"P",{});var Km=l(Ss);Sc=r(Km,`MegatronBert Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g.
for Named-Entity-Recognition (NER) tasks.`),Km.forEach(o),Nc=u(me),Ro=i(me,"P",{});var va=l(Ro);Lc=r(va,"This model inherits from "),zn=i(va,"A",{href:!0});var Ym=l(zn);Ic=r(Ym,"PreTrainedModel"),Ym.forEach(o),Oc=r(va,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),va.forEach(o),Dc=u(me),Ho=i(me,"P",{});var ka=l(Ho);Wc=r(ka,"This model is also a PyTorch "),Uo=i(ka,"A",{href:!0,rel:!0});var Xm=l(Uo);Rc=r(Xm,"torch.nn.Module"),Xm.forEach(o),Hc=r(ka,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),ka.forEach(o),Uc=u(me),H=i(me,"DIV",{class:!0});var he=l(H);M(Qo.$$.fragment,he),Qc=u(he),Se=i(he,"P",{});var Rn=l(Se);Vc=r(Rn,"The "),xn=i(Rn,"A",{href:!0});var Zm=l(xn);Gc=r(Zm,"MegatronBertForTokenClassification"),Zm.forEach(o),Jc=r(Rn," forward method, overrides the "),Ns=i(Rn,"CODE",{});var eh=l(Ns);Kc=r(eh,"__call__"),eh.forEach(o),Yc=r(Rn," special method."),Rn.forEach(o),Xc=u(he),M(kt.$$.fragment,he),Zc=u(he),M(Mt.$$.fragment,he),ep=u(he),M(wt.$$.fragment,he),he.forEach(o),me.forEach(o),Rr=u(t),Ne=i(t,"H2",{class:!0});var Ma=l(Ne);$t=i(Ma,"A",{id:!0,class:!0,href:!0});var th=l($t);Ls=i(th,"SPAN",{});var oh=l(Ls);M(Vo.$$.fragment,oh),oh.forEach(o),th.forEach(o),tp=u(Ma),Is=i(Ma,"SPAN",{});var nh=l(Is);op=r(nh,"MegatronBertForQuestionAnswering"),nh.forEach(o),Ma.forEach(o),Hr=u(t),W=i(t,"DIV",{class:!0});var ue=l(W);M(Go.$$.fragment,ue),np=u(ue),Le=i(ue,"P",{});var Hn=l(Le);sp=r(Hn,`MegatronBert Model with a span classification head on top for extractive question-answering tasks like SQuAD (a
