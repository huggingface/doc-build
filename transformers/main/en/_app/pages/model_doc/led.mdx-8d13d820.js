...
`),ae=s(Ve,"CODE",{});var Re=a(ae);ye=d(Re,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),Re.forEach(t),Ve.forEach(t),K.forEach(t)},m(L,z){g(L,l,z),e(l,b),g(L,u,z),g(L,m,z),e(m,T),e(T,i),e(m,f),e(m,D),e(D,je),g(L,fe,z),g(L,F,z),e(F,Z),e(F,W),e(W,oe),e(F,Ie),e(F,U),e(U,Be),e(F,De),g(L,B,z),g(L,V,z),e(V,ne),g(L,we,z),g(L,C,z),e(C,A),e(A,_e),e(A,se),e(se,Fe),e(A,ge),e(A,R),e(R,Ge),e(C,ze),e(C,O),e(O,Qe),e(O,Y),e(Y,S),e(O,M),e(O,G),e(G,He),e(C,We),e(C,j),e(j,Ue),e(j,ae),e(ae,ye)},d(L){L&&t(l),L&&t(u),L&&t(m),L&&t(fe),L&&t(F),L&&t(B),L&&t(V),L&&t(we),L&&t(C)}}}function vf($){let l,b,u,m,T;return{c(){l=n("p"),b=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),u=n("code"),m=r("Module"),T=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(i){l=s(i,"P",{});var f=a(l);b=d(f,"Although the recipe for forward pass needs to be defined within this function, one should call the "),u=s(f,"CODE",{});var D=a(u);m=d(D,"Module"),D.forEach(t),T=d(f,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),{c(){l=n("p"),b=r("Example:"),u=c(),v(m.$$.fragment)},l(i){l=s(i,"P",{});var f=a(l);b=d(f,"Example:"),f.forEach(t),u=h(i),k(m.$$.fragment,i)},m(i,f){g(i,l,f),e(l,b),g(i,u,f),w(m,i,f),T=!0},p:Pe,i(i){T||(y(m.$$.fragment,i),T=!0)},o(i){E(m.$$.fragment,i),T=!1},d(i){i&&t(l),i&&t(u),q(m,i)}}}function wf($){let l,b,u,m,T,i,f,D,je,fe,F,Z,W,oe,Ie,U,Be,De,B,V,ne,we,C,A,_e,se,Fe,ge,R,Ge,ze,O,Qe,Y,S,M,G,He,We,j,Ue,ae,ye;return{c(){l=n("p"),b=r("TF 2.0 models accepts two formats as inputs:"),u=c(),m=n("ul"),T=n("li"),i=r("having all inputs as keyword arguments (like PyTorch models), or"),f=c(),D=n("li"),je=r("having all inputs as a list, tuple or dict in the first positional arguments."),fe=c(),F=n("p"),Z=r("This second option is useful when using "),W=n("code"),oe=r("tf.keras.Model.fit"),Ie=r(` method which currently requires having all the
tensors in the first argument of the model call function: `),U=n("code"),Be=r("model(inputs)"),De=r("."),B=c(),V=n("p"),ne=r(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),we=c(),C=n("ul"),A=n("li"),_e=r("a single Tensor with "),se=n("code"),Fe=r("input_ids"),ge=r(" only and nothing else: "),R=n("code"),Ge=r("model(input_ids)"),ze=c(),O=n("li"),Qe=r(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),Y=n("code"),S=r("model([input_ids, attention_mask])"),M=r(" or "),G=n("code"),He=r("model([input_ids, attention_mask, token_type_ids])"),We=c(),j=n("li"),Ue=r(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),ae=n("code"),ye=r('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(L){l=s(L,"P",{});var z=a(l);b=d(z,"TF 2.0 models accepts two formats as inputs:"),z.forEach(t),u=h(L),m=s(L,"UL",{});var re=a(m);T=s(re,"LI",{});var nt=a(T);i=d(nt,"having all inputs as keyword arguments (like PyTorch models), or"),nt.forEach(t),f=h(re),D=s(re,"LI",{});var st=a(D);je=d(st,"having all inputs as a list, tuple or dict in the first positional arguments."),st.forEach(t),re.forEach(t),fe=h(L),F=s(L,"P",{});var I=a(F);Z=d(I,"This second option is useful when using "),W=s(I,"CODE",{});var at=a(W);oe=d(at,"tf.keras.Model.fit"),at.forEach(t),Ie=d(I,` method which currently requires having all the
...
first positional argument :`),xe.forEach(t),we=h(L),C=s(L,"UL",{});var K=a(C);A=s(K,"LI",{});var de=a(A);_e=d(de,"a single Tensor with "),se=s(de,"CODE",{});var Se=a(se);Fe=d(Se,"input_ids"),Se.forEach(t),ge=d(de," only and nothing else: "),R=s(de,"CODE",{});var dt=a(R);Ge=d(dt,"model(input_ids)"),dt.forEach(t),de.forEach(t),ze=h(K),O=s(K,"LI",{});var ie=a(O);Qe=d(ie,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),Y=s(ie,"CODE",{});var it=a(Y);S=d(it,"model([input_ids, attention_mask])"),it.forEach(t),M=d(ie," or "),G=s(ie,"CODE",{});var le=a(G);He=d(le,"model([input_ids, attention_mask, token_type_ids])"),le.forEach(t),ie.forEach(t),We=h(K),j=s(K,"LI",{});var Ve=a(j);Ue=d(Ve,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),ae=s(Ve,"CODE",{});var Re=a(ae);ye=d(Re,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),Re.forEach(t),Ve.forEach(t),K.forEach(t)},m(L,z){g(L,l,z),e(l,b),g(L,u,z),g(L,m,z),e(m,T),e(T,i),e(m,f),e(m,D),e(D,je),g(L,fe,z),g(L,F,z),e(F,Z),e(F,W),e(W,oe),e(F,Ie),e(F,U),e(U,Be),e(F,De),g(L,B,z),g(L,V,z),e(V,ne),g(L,we,z),g(L,C,z),e(C,A),e(A,_e),e(A,se),e(se,Fe),e(A,ge),e(A,R),e(R,Ge),e(C,ze),e(C,O),e(O,Qe),e(O,Y),e(Y,S),e(O,M),e(O,G),e(G,He),e(C,We),e(C,j),e(j,Ue),e(j,ae),e(ae,ye)},d(L){L&&t(l),L&&t(u),L&&t(m),L&&t(fe),L&&t(F),L&&t(B),L&&t(V),L&&t(we),L&&t(C)}}}function yf($){let l,b,u,m,T;return{c(){l=n("p"),b=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),u=n("code"),m=r("Module"),T=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(i){l=s(i,"P",{});var f=a(l);b=d(f,"Although the recipe for forward pass needs to be defined within this function, one should call the "),u=s(f,"CODE",{});var D=a(u);m=d(D,"Module"),D.forEach(t),T=d(f,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-comment"># probs[5] is associated with the mask token</span>`}}),{c(){l=n("p"),b=r("Examples:"),u=c(),v(m.$$.fragment)},l(i){l=s(i,"P",{});var f=a(l);b=d(f,"Examples:"),f.forEach(t),u=h(i),k(m.$$.fragment,i)},m(i,f){g(i,l,f),e(l,b),g(i,u,f),w(m,i,f),T=!0},p:Pe,i(i){T||(y(m.$$.fragment,i),T=!0)},o(i){E(m.$$.fragment,i),T=!1},d(i){i&&t(l),i&&t(u),q(m,i)}}}function qf($){let l,b,u,m,T,i,f,D,je,fe,F,Z,W,oe,Ie,U,Be,De,B,V,ne,we,C,A,_e,se,Fe,ge,R,Ge,ze,O,Qe,Y,S,M,G,He,We,j,Ue,ae,ye,L,z,re,nt,st,I,at,rt,xe,K,de,Se,dt,ie,it,le,Ve,Re,Nd,jd,As,Id,Bd,Gd,Ee,Qd,Ps,Hd,Wd,Ns,Ud,Vd,Zn,Rd,Kd,js,Xd,Jd,Zd,X,Yd,Is,ei,ti,Bs,oi,ni,Yn,si,ai,Gs,ri,di,Qs,ii,li,H
Xa,Pn,Rh,Ja,Kh,Hr,pe,Nn,Xh,jn,Jh,vs,Zh,Yh,ep,In,tp,Bn,op,np,sp,bo,ap,Ce,Gn,rp,Ct,dp,ks,ip,lp,Za,cp,hp,pp,To,up,vo,Wr,Ot,ko,Ya,Qn,mp,er,fp,Ur,ue,Hn,_p,Wn,gp,ws,bp,Tp,vp,Un,kp,Vn,wp,yp,Ep,wo,qp,Oe,Rn,Lp,At,$p,ys,Dp,Fp,tr,zp,xp,Sp,yo,Mp,Eo,Vr;return i=new me({}),oe=new me({}),Po=new me({}),No=new x({props:{name:"class transformers.LEDConfig",anchor:"transformers.LEDConfig",parameters:[{name:"vocab_size",val:" = 50265"},{name:"max_encoder_position_embeddings",val:" = 16384"},{name:"max_decoder_position_embeddings",val:" = 1024"},{name:"encoder_layers",val:" = 12"},{name:"encoder_ffn_dim",val:" = 4096"},{name:"encoder_attention_heads",val:" = 16"},{name:"decoder_layers",val:" = 12"},{name:"decoder_ffn_dim",val:" = 4096"},{name:"decoder_attention_heads",val:" = 16"},{name:"encoder_layerdrop",val:" = 0.0"},{name:"decoder_layerdrop",val:" = 0.0"},{name:"use_cache",val:" = True"},{name:"is_encoder_decoder",val:" = True"},{name:"activation_function",val:" = 'gelu'"},{name:"d_model",val:" = 1024"},{name:"dropout",val:" = 0.1"},{name:"attention_dropout",val:" = 0.0"},{name:"activation_dropout",val:" = 0.0"},{name:"init_std",val:" = 0.02"},{name:"decoder_start_token_id",val:" = 2"},{name:"classifier_dropout",val:" = 0.0"},{name:"pad_token_id",val:" = 1"},{name:"bos_token_id",val:" = 0"},{name:"eos_token_id",val:" = 2"},{name:"attention_window",val:": typing.Union[typing.List[int], int] = 512"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.LEDConfig.vocab_size",description:`<strong>vocab_size</strong> (<code>int</code>, <em>optional</em>, defaults to 50265) &#x2014;
...
Whether or not the model should return the last key/values attentions (not used by all models)`,name:"use_cache"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/led/configuration_led.py#L31"}}),jt=new Ae({props:{anchor:"transformers.LEDConfig.example",$$slots:{default:[sf]},$$scope:{ctx:$}}}),Io=new me({}),Go=new me({}),Qo=new me({}),Ho=new me({}),Wo=new x({props:{name:"class transformers.LEDTokenizer",anchor:"transformers.LEDTokenizer",parameters:[{name:"vocab_file",val:""},{name:"merges_file",val:""},{name:"errors",val:" = 'replace'"},{name:"bos_token",val:" = '<s>'"},{name:"eos_token",val:" = '</s>'"},{name:"sep_token",val:" = '</s>'"},{name:"cls_token",val:" = '<s>'"},{name:"unk_token",val:" = '<unk>'"},{name:"pad_token",val:" = '<pad>'"},{name:"mask_token",val:" = '<mask>'"},{name:"add_prefix_space",val:" = False"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/led/tokenization_led.py#L43"}}),Vo=new x({props:{name:"build_inputs_with_special_tokens",anchor:"transformers.LEDTokenizer.build_inputs_with_special_tokens",parameters:[{name:"token_ids_0",val:": typing.List[int]"},{name:"token_ids_1",val:": typing.Optional[typing.List[int]] = None"}],parametersDescription:[{anchor:"transformers.LEDTokenizer.build_inputs_with_special_tokens.token_ids_0",description:`<strong>token_ids_0</strong> (<code>List[int]</code>) &#x2014;
...
<p>Global attentions weights after the attention softmax, used to compute the weighted average in the
self-attention heads. Those are the attention weights from every token with global attention to every token
in the sequence.`,name:"encoder_global_attentions"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/led/modeling_tf_led.py#L1373"}}),pn=new x({props:{name:"class transformers.models.led.modeling_tf_led.TFLEDSeq2SeqLMOutput",anchor:"transformers.models.led.modeling_tf_led.TFLEDSeq2SeqLMOutput",parameters:[{name:"loss",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"logits",val:": Tensor = None"},{name:"past_key_values",val:": typing.Optional[typing.List[tensorflow.python.framework.ops.Tensor]] = None"},{name:"decoder_hidden_states",val:": typing.Optional[typing.Tuple[tensorflow.python.framework.ops.Tensor]] = None"},{name:"decoder_attentions",val:": typing.Optional[typing.Tuple[tensorflow.python.framework.ops.Tensor]] = None"},{name:"cross_attentions",val:": typing.Optional[typing.Tuple[tensorflow.python.framework.ops.Tensor]] = None"},{name:"encoder_last_hidden_state",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"encoder_hidden_states",val:": typing.Optional[typing.Tuple[tensorflow.python.framework.ops.Tensor]] = None"},{name:"encoder_attentions",val:": typing.Optional[typing.Tuple[tensorflow.python.framework.ops.Tensor]] = None"},{name:"encoder_global_attentions",val:": typing.Optional[typing.Tuple[tensorflow.python.framework.ops.Tensor]] = None"}],parametersDescription:[{anchor:"transformers.models.led.modeling_tf_led.TFLEDSeq2SeqLMOutput.loss",description:`<strong>loss</strong> (<code>tf.Tensor</code> of shape <code>(1,)</code>, <em>optional</em>, returned when <code>labels</code> is provided) &#x2014;
...
documentation from `),os=n("a"),Bi=r("PretrainedConfig"),Gi=r(" for more information."),Qi=c(),v(jt.$$.fragment),Hi=c(),Ks=n("blockquote"),Xs=n("blockquote"),Js=n("blockquote"),Zs=n("p"),Wi=r("from transformers import LEDModel, LEDConfig"),Ui=c(),Ys=n("blockquote"),ea=n("blockquote"),ta=n("blockquote"),It=n("h1"),Bt=n("a"),oa=n("span"),v(Io.$$.fragment),Vi=c(),na=n("span"),Ri=r("Initializing a LED allenai/led-base-16384 style configuration >>> configuration = LEDConfig()"),Ki=c(),sa=n("blockquote"),aa=n("blockquote"),Bo=n("blockquote"),Gt=n("h1"),Qt=n("a"),ra=n("span"),v(Go.$$.fragment),Xi=c(),da=n("span"),Ji=r("Initializing a model from the allenai/led-base-16384 style configuration >>> model ="),Zi=c(),ia=n("p"),Yi=r("LEDModel(configuration)"),el=c(),la=n("blockquote"),ca=n("blockquote"),ha=n("blockquote"),Ht=n("h1"),Wt=n("a"),pa=n("span"),v(Qo.$$.fragment),tl=c(),ua=n("span"),ol=r("Accessing the model configuration >>> configuration = model.config"),wr=c(),ut=n("h2"),Ut=n("a"),ma=n("span"),v(Ho.$$.fragment),nl=c(),fa=n("span"),sl=r("LEDTokenizer"),yr=c(),N=n("div"),v(Wo.$$.fragment),al=c(),_a=n("p"),rl=r("Construct a LED tokenizer."),dl=c(),Vt=n("p"),ns=n("a"),il=r("LEDTokenizer"),ll=r(" is identical to "),ss=n("a"),cl=r("BartTokenizer"),hl=r(` and runs end-to-end tokenization: punctuation splitting and
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Gc=c(),be=n("div"),v(En.$$.fragment),Qc=c(),$t=n("p"),Hc=r("The "),fs=n("a"),Wc=r("LEDForConditionalGeneration"),Uc=r(" forward method, overrides the "),Ia=n("code"),Vc=r("__call__"),Rc=r(" special method."),Kc=c(),v(no.$$.fragment),Xc=c(),v(so.$$.fragment),Jc=c(),v(ao.$$.fragment),jr=c(),Dt=n("h2"),ro=n("a"),Ba=n("span"),v(qn.$$.fragment),Zc=c(),Ga=n("span"),Yc=r("LEDForSequenceClassification"),Ir=c(),ce=n("div"),v(Ln.$$.fragment),eh=c(),Qa=n("p"),th=r(`LED model with a sequence classification/head on top (a linear layer on top of the pooled output) e.g. for GLUE
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),ch=c(),Q=n("div"),v(zn.$$.fragment),hh=c(),Ft=n("p"),ph=r("The "),gs=n("a"),uh=r("LEDForSequenceClassification"),mh=r(" forward method, overrides the "),Ha=n("code"),fh=r("__call__"),_h=r(" special method."),gh=c(),v(io.$$.fragment),bh=c(),v(lo.$$.fragment),Th=c(),v(co.$$.fragment),vh=c(),v(ho.$$.fragment),kh=c(),v(po.$$.fragment),Br=c(),zt=n("h2"),uo=n("a"),Wa=n("span"),v(xn.$$.fragment),wh=c(),Ua=n("span"),yh=r("LEDForQuestionAnswering"),Gr=c(),he=n("div"),v(Sn.$$.fragment),Eh=c(),xt=n("p"),qh=r(`LED Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear layer
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Nh=c(),Te=n("div"),v(An.$$.fragment),jh=c(),St=n("p"),Ih=r("The "),Ts=n("a"),Bh=r("LEDForQuestionAnswering"),Gh=r(" forward method, overrides the "),Ka=n("code"),Qh=r("__call__"),Hh=r(" special method."),Wh=c(),v(mo.$$.fragment),Uh=c(),v(fo.$$.fragment),Vh=c(),v(_o.$$.fragment),Qr=c(),Mt=n("h2"),go=n("a"),Xa=n("span"),v(Pn.$$.fragment),Rh=c(),Ja=n("span"),Kh=r("TFLEDModel"),Hr=c(),pe=n("div"),v(Nn.$$.fragment),Xh=c(),jn=n("p"),Jh=r(`The bare LED Model outputting raw hidden-states without any specific head on top.
...
gained, when `),Zn=s(Xe,"A",{href:!0});var Qp=a(Zn);Rd=d(Qp,"LEDTokenizer"),Qp.forEach(t),Kd=d(Xe," is used with the "),js=s(Xe,"CODE",{});var Hp=a(js);Xd=d(Hp,"pad_to_multiple_of"),Hp.forEach(t),Jd=d(Xe," argument."),Xe.forEach(t),Zd=h(J),X=s(J,"LI",{});var ve=a(X);Yd=d(ve,"LED makes use of "),Is=s(ve,"EM",{});var Wp=a(Is);ei=d(Wp,"global attention"),Wp.forEach(t),ti=d(ve," by means of the "),Bs=s(ve,"CODE",{});var Up=a(Bs);oi=d(Up,"global_attention_mask"),Up.forEach(t),ni=d(ve,` (see
`),Yn=s(ve,"A",{href:!0});var Vp=a(Yn);si=d(Vp,"LongformerModel"),Vp.forEach(t),ai=d(ve,"). For summarization, it is advised to put "),Gs=s(ve,"EM",{});var Rp=a(Gs);ri=d(Rp,"global attention"),Rp.forEach(t),di=d(ve,` only on the first
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Ed.forEach(t),Nc=h(Do),wn=s(Do,"P",{});var qd=a(wn);jc=d(qd,"This model is also a PyTorch "),yn=s(qd,"A",{href:!0,rel:!0});var Tm=a(yn);Ic=d(Tm,"torch.nn.Module"),Tm.forEach(t),Bc=d(qd,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
