...
Will be passed to the underlying model specific decode method.`,name:"kwargs"}],source:"https://github.com/huggingface/transformers/blob/vmain/src/transformers/models/wav2vec2_phoneme/tokenization_wav2vec2_phoneme.py#L502",returnDescription:`
<p>The
...
Will be passed to the underlying model specific decode method.`,name:"kwargs"}],source:"https://github.com/huggingface/transformers/blob/vmain/src/transformers/models/wav2vec2_phoneme/tokenization_wav2vec2_phoneme.py#L446",returnDescription:`
<p>The decoded
...
mapping phonemes of the training languages to the target language using articulatory features. Experiments show that
this simple method significantly outperforms prior work which introduced task-specific architectures and used only part
of a monolingually pretrained model.`),lt.forEach(t),ct.forEach(t),Ve=l(e),oe=r(e,"P",{});var dt=a(oe);ao=i(dt,"Tips:"),dt.forEach(t),$e=l(e),u=r(e,"UL",{});var g=a(u);pe=r(g,"LI",{});var pt=a(pe);so=i(pt,"Wav2Vec2Phoneme uses the exact same architecture as Wav2Vec2"),pt.forEach(t),io=l(g),me=r(g,"LI",{});var mt=a(me);co=i(mt,"Wav2Vec2Phoneme is a speech model that accepts a float array corresponding to the raw waveform of the speech signal."),mt.forEach(t),lo=l(g),R=r(g,"LI",{});var Oe=a(R);po=i(Oe,`Wav2Vec2Phoneme model was trained using connectionist temporal classification (CTC) so the model output has to be
decoded using `),te=r(Oe,"A",{href:!0});var ht=a(te);mo=i(ht,"Wav2Vec2PhonemeCTCTokenizer"),ht.forEach(t),ho=i(Oe,"."),Oe.forEach(t),uo=l(g),he=r(g,"LI",{});var ut=a(he);fo=i(ut,`Wav2Vec2Phoneme can be fine-tuned on multiple language at once and decode unseen languages in a single forward pass
