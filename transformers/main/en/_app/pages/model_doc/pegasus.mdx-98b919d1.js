...
`),oe=s(H,"CODE",{});var kt=a(oe);R=i(kt,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),kt.forEach(t),H.forEach(t),I.forEach(t)},m(y,q){u(y,h,q),e(h,z),u(y,b,q),u(y,w,q),e(w,x),e(x,P),e(w,T),e(w,$),e($,Oe),u(y,me,q),u(y,F,q),e(F,we),e(F,ae),e(ae,Ae),e(F,re),e(F,ie),e(ie,Ie),e(F,Me),u(y,G,q),u(y,O,q),e(O,xe),u(y,K,q),u(y,C,q),e(C,S),e(S,Le),e(S,Y),e(Y,ee),e(S,Ne),e(S,D),e(D,Ge),e(C,De),e(C,A),e(A,ge),e(A,de),e(de,je),e(A,te),e(A,V),e(V,Ue),e(C,Be),e(C,U),e(U,We),e(U,oe),e(oe,R)},d(y){y&&t(h),y&&t(b),y&&t(w),y&&t(me),y&&t(F),y&&t(G),y&&t(O),y&&t(K),y&&t(C)}}}function Dk(W){let h,z,b,w,x;return{c(){h=n("p"),z=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),b=n("code"),w=r("Module"),x=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(P){h=s(P,"P",{});var T=a(h);z=i(T,"Although the recipe for forward pass needs to be defined within this function, one should call the "),b=s(T,"CODE",{});var $=a(b);w=i($,"Module"),$.forEach(t),x=i(T,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
the latter silently ignores them.`)},l(P){h=s(P,"P",{});var T=a(h);z=i(T,"Although the recipe for forward pass needs to be defined within this function, one should call the "),b=s(T,"CODE",{});var $=a(b);w=i($,"Module"),$.forEach(t),x=i(T,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),T.forEach(t)},m(P,T){u(P,h,T),e(h,z),e(h,b),e(b,w),e(h,x)},d(P){P&&t(h)}}}function Wk(W){let h,z,b,w,x;return{c(){h=n("p"),z=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),b=n("code"),w=r("Module"),x=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(P){h=s(P,"P",{});var T=a(h);z=i(T,"Although the recipe for forward pass needs to be defined within this function, one should call the "),b=s(T,"CODE",{});var $=a(b);w=i($,"Module"),$.forEach(t),x=i(T,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),T.forEach(t)},m(P,T){u(P,h,T),e(h,z),e(h,b),e(b,w),e(h,x)},d(P){P&&t(h)}}}function Rk(W){let h,z,b,w,x;return{c(){h=n("p"),z=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),b=n("code"),w=r("Module"),x=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(P){h=s(P,"P",{});var T=a(h);z=i(T,"Although the recipe for forward pass needs to be defined within this function, one should call the "),b=s(T,"CODE",{});var $=a(b);w=i($,"Module"),$.forEach(t),x=i(T,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),T.forEach(t)},m(P,T){u(P,h,T),e(h,z),e(h,b),e(b,w),e(h,x)},d(P){P&&t(h)}}}function Hk(W){let h,z,b,w,x,P,T,$,Oe,me,F,we,ae,Ae,re,ie,Ie,Me,G,O,xe,K,C,S,Le,Y,ee,Ne,D,Ge,De,A,ge,de,je,te,V,Ue,Be,U,We,oe,R,y,q,ze,mt,$e,Q,gt,Ve,le,I,J,qe,ft,X,_t,Qe,H,kt,Fo,Yd,el,ca,tl,ol,Mi,fe,ua,nl,sl,pa,al,rl,ha,il,dl,Eo,ll,Mo,cl,ul,pl,Wt,jo,hl,ml,Co,gl,fl,ji,vt,Rt,ma,So,_l,ga,kl,Ci,Je,Ht,Oo,vl,yl,Ao,bl,Tl,Pl,fa,wl,xl,_a,zl,Si,yt,Kt,ka,Io,$l,va,ql,Oi,_e,ya,ba,Fl,El,Ta,xs,Ml,zs,jl,Cl,Lo,Pa,Sl,Ol,bt,wa,Al,Il,xa,Ll,Nl,No,Gl,za,Dl,Ul,Bl,$a,Re,Wl,qa,Rl,Hl,Fa,Kl,Vl,Ea,Ql,Jl,Xl,Ma,Tt,Zl,Go,Yl,ec,ja,tc,oc,Ai,Pt,Vt,Ca,Do,nc,Sa,sc,Ii,Uo,Li,wt,Qt,Oa,Bo,ac,Aa,rc,Ni,ce,Wo,ic,xt,dc,$s,lc,cc,Ro,uc,pc,hc,zt,mc,qs,gc,fc,Fs,_c,kc,vc,Ia,yc,bc,Ho,Gi,$t,Jt,La,Ko,Tc,Na,Pc,Di,Xt,wc,Ga,xc,zc,Ui,B,Vo,$c,Qo,qc,Jo,Fc,Ec,Mc,Xo,jc,Es,Cc,Sc,Oc,Ce,Zo,Ac,Yo,Ic,Da,Lc,Nc,Gc,en,Ms,Dc,Ua,Uc,Bc,tn,Wc,Ba,Rc,Hc,Kc,Wa,Vc,Qc,Zt,on,Jc,Ra,Xc,Zc,Yt,nn,Yc,Ha,eu,tu,eo,sn,ou,Ka,nu,Bi,qt,to,Va,an,su,Qa,au,Wi,ue,rn,ru,Ft,iu,Ja,du,lu,dn,cu,uu,pu,ln,hu,js,mu,gu,fu,Xe,cn,_u,Xa,ku,vu,un,Cs,yu,Za,bu,Tu,pn,Pu,Ya,wu,xu,zu,oo,hn,$u,er,qu,Ri,Et,no,tr,mn,Fu,or,Eu,Hi,Fe,gn,Mu,fn,ju,Ss,Cu,Su,Ou,_n,Au,kn,Iu,Lu,Nu,ke,vn,Gu,Mt,Du,Os,Uu,Bu,nr,Wu,Ru,Hu,so,Ku,sr,Vu,Qu,yn,Ki,jt,ao,ar,bn,Ju,rr,Xu,Vi,Ee,Tn,Zu,Pn,Yu,As,ep,tp,op,wn,np,xn,sp,ap,rp,ve,zn,ip,Ct,dp,Is,lp,cp,ir,up,pp,hp,ro,mp,dr,gp,fp,$n,Qi,St,io,lr,qn,_p,cr,kp,Ji,Ot,Fn,vp,Ze,En,yp,ur,bp,Tp,Mn,Xi,At,lo,pr,jn,Pp,hr,wp,Zi,pe,Cn,xp,Sn,zp,Ls,$p,qp,Fp,On,Ep,An,Mp,jp,Cp,co,Sp,ye,In,Op,It,Ap,Ns,Ip,Lp,mr,Np,Gp,Dp,uo,Up,gr,Bp,Wp,Ln,Yi,Lt,po,fr,Nn,Rp,_r,Hp,ed,he,Gn,Kp,Dn,Vp,Gs,Qp,Jp,Xp,Un,Zp,Bn,Yp,eh,th,ho,oh,be,Wn,nh,Nt,sh,Ds,ah,rh,kr,ih,dh,lh,mo,ch,vr,uh,ph,Rn,td,Gt,go,yr,Hn,hh,br,mh,od,L,Kn,gh,Vn,fh,Us,_h,kh,vh,Qn,yh,Jn,bh,Th,Ph,Tr,wh,xh,He,Pr,Xn,zh,$h,wr,Zn,qh,Fh,xr,Yn,Eh,Mh,zr,es,jh,Ch,Te,ts,Sh,Dt,Oh,$r,Ah,Ih,qr,Lh,Nh,Gh,fo,Dh,Fr,Uh,Bh,os,Wh,Ye,ns,Rh,Er,Hh,Kh,ss,Vh,et,as,Qh,Mr,Jh,Xh,rs,nd,Ut,_o,jr,is,Zh,Cr,Yh,sd,N,ds,em,ls,tm,Bs,om,nm,sm,cs,am,us,rm,im,dm,Sr,lm,cm,Ke,Or,ps,um,pm,Ar,hs,hm,mm,Ir,ms,gm,fm,Lr,gs,_m,km,E,fs,vm,Bt,ym,Nr,bm,Tm,Gr,Pm,wm,xm,ko,zm,Dr,$m,qm,Ur,Br,Wr,Rr,Fm,Em,Hr,Kr,Vr,Qr,Mm,jm,Jr,Xr,Zr,Yr,Cm,Sm,ei,ti,_s,vo,yo,oi,ks,Om,ni,Am,Im,si,Lm,Nm,ai,Gm,Dm,ri,ii,di,li,Um,Bm,ci,ui,pi,hi,Wm,Rm,mi,gi,fi,_i,Hm,Km,ki,vi,yi,bi,Vm,Qm,tt,vs,Jm,Ti,Xm,Zm,ys,Ym,ot,bs,eg,Pi,tg,og,Ts,ad;return P=new Z({}),K=new Z({}),qe=new Z({}),So=new Z({}),Io=new Z({}),Do=new Z({}),Uo=new Se({props:{code:`from transformers import PegasusForConditionalGeneration, PegasusTokenizer
import torch
...
Model configuration class with all the parameters of the model. Initializing with a config file does not
load the weights associated with the model, only the configuration. Check out the
<a href="/docs/transformers/main/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),zn=new M({props:{name:"forward",anchor:"transformers.PegasusForConditionalGeneration.forward",parameters:[{name:"input_ids",val:": typing.Optional[torch.Tensor] = None"},{name:"attention_mask",val:": typing.Optional[torch.Tensor] = None"},{name:"decoder_input_ids",val:": typing.Optional[torch.Tensor] = None"},{name:"decoder_attention_mask",val:": typing.Optional[torch.Tensor] = None"},{name:"head_mask",val:": typing.Optional[torch.Tensor] = None"},{name:"decoder_head_mask",val:": typing.Optional[torch.Tensor] = None"},{name:"cross_attn_head_mask",val:": typing.Optional[torch.Tensor] = None"},{name:"encoder_outputs",val:": typing.Optional[typing.Tuple[torch.FloatTensor]] = None"},{name:"past_key_values",val:": typing.Optional[typing.Tuple[torch.FloatTensor]] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.Tensor] = None"},{name:"decoder_inputs_embeds",val:": typing.Optional[torch.Tensor] = None"},{name:"labels",val:": typing.Optional[torch.Tensor] = None"},{name:"use_cache",val:": typing.Optional[bool] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/pegasus/modeling_pegasus.py#L1350",parametersDescription:[{anchor:"transformers.PegasusForConditionalGeneration.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. Padding will be ignored by default should you provide
it.</p>
<p>Indices can be obtained using <a href="/docs/transformers/main/en/model_doc/pegasus#transformers.PegasusTokenizer">PegasusTokenizer</a>. See <a href="/docs/transformers/main/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/main/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
`}}),uo=new qo({props:{$$slots:{default:[Dk]},$$scope:{ctx:W}}}),Ln=new Se({props:{code:`from transformers import PegasusTokenizer, TFPegasusModel
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),Nn=new Z({}),Gn=new M({props:{name:"class transformers.TFPegasusForConditionalGeneration",anchor:"transformers.TFPegasusForConditionalGeneration",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/pegasus/modeling_tf_pegasus.py#L1246",parametersDescription:[{anchor:"transformers.TFPegasusForConditionalGeneration.config",description:`<strong>config</strong> (<a href="/docs/transformers/main/en/model_doc/pegasus#transformers.PegasusConfig">PegasusConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/main/en/main_classes/model#transformers.TFPreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),ho=new qo({props:{$$slots:{default:[Uk]},$$scope:{ctx:W}}}),Wn=new M({props:{name:"call",anchor:"transformers.TFPegasusForConditionalGeneration.call",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"decoder_input_ids",val:" = None"},{name:"decoder_attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"decoder_head_mask",val:" = None"},{name:"cross_attn_head_mask",val:" = None"},{name:"encoder_outputs",val:": typing.Optional[transformers.modeling_tf_outputs.TFBaseModelOutput] = None"},{name:"past_key_values",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"decoder_inputs_embeds",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"},{name:"labels",val:" = None"},{name:"training",val:" = False"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/pegasus/modeling_tf_pegasus.py#L1279",parametersDescription:[{anchor:"transformers.TFPegasusForConditionalGeneration.call.input_ids",description:`<strong>input_ids</strong> (<code>tf.Tensor</code> of shape <code>({0})</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/main/en/model_doc/pegasus#transformers.PegasusTokenizer">PegasusTokenizer</a>. See <a href="/docs/transformers/main/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/main/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
`),Ro=n("a"),uc=r("google/pegasus-large"),pc=r(" architecture."),hc=d(),zt=n("p"),mc=r("Configuration objects inherit from "),qs=n("a"),gc=r("PretrainedConfig"),fc=r(` and can be used to control the model outputs. Read the
...
separator.`),Qc=d(),Zt=n("div"),m(on.$$.fragment),Jc=d(),Ra=n("p"),Xc=r("Converts a sequence of tokens (string) in a single string."),Zc=d(),Yt=n("div"),m(nn.$$.fragment),Yc=d(),Ha=n("p"),eu=r("Get list where entries are [1] if a token is [eos] or [pad] else 0."),tu=d(),eo=n("div"),m(sn.$$.fragment),ou=d(),Ka=n("p"),nu=r("Just EOS"),Bi=d(),qt=n("h2"),to=n("a"),Va=n("span"),m(an.$$.fragment),su=d(),Qa=n("span"),au=r("PegasusTokenizerFast"),Wi=d(),ue=n("div"),m(rn.$$.fragment),ru=d(),Ft=n("p"),iu=r("Construct a \u201Cfast\u201D PEGASUS tokenizer (backed by HuggingFace\u2019s "),Ja=n("em"),du=r("tokenizers"),lu=r(` library). Based on
...
and behavior.`),Nu=d(),ke=n("div"),m(vn.$$.fragment),Gu=d(),Mt=n("p"),Du=r("The "),Os=n("a"),Uu=r("PegasusModel"),Bu=r(" forward method, overrides the "),nr=n("code"),Wu=r("__call__"),Ru=r(" special method."),Hu=d(),m(so.$$.fragment),Ku=d(),sr=n("p"),Vu=r("Example:"),Qu=d(),m(yn.$$.fragment),Ki=d(),jt=n("h2"),ao=n("a"),ar=n("span"),m(bn.$$.fragment),Ju=d(),rr=n("span"),Xu=r("PegasusForConditionalGeneration"),Vi=d(),Ee=n("div"),m(Tn.$$.fragment),Zu=d(),Pn=n("p"),Yu=r(`The PEGASUS Model with a language modeling head. Can be used for summarization.
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),rp=d(),ve=n("div"),m(zn.$$.fragment),ip=d(),Ct=n("p"),dp=r("The "),Is=n("a"),lp=r("PegasusForConditionalGeneration"),cp=r(" forward method, overrides the "),ir=n("code"),up=r("__call__"),pp=r(" special method."),hp=d(),m(ro.$$.fragment),mp=d(),dr=n("p"),gp=r("Summarization example:"),fp=d(),m($n.$$.fragment),Qi=d(),St=n("h2"),io=n("a"),lr=n("span"),m(qn.$$.fragment),_p=d(),cr=n("span"),kp=r("PegasusForCausalLM"),Ji=d(),Ot=n("div"),m(Fn.$$.fragment),vp=d(),Ze=n("div"),m(En.$$.fragment),yp=d(),ur=n("p"),bp=r("Example:"),Tp=d(),m(Mn.$$.fragment),Xi=d(),At=n("h2"),lo=n("a"),pr=n("span"),m(jn.$$.fragment),Pp=d(),hr=n("span"),wp=r("TFPegasusModel"),Zi=d(),pe=n("div"),m(Cn.$$.fragment),xp=d(),Sn=n("p"),zp=r(`The bare PEGASUS Model outputting raw hidden-states without any specific head on top.
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Fp=d(),On=n("p"),Ep=r("This model is also a "),An=n("a"),Mp=r("tf.keras.Model"),jp=r(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Cp=d(),m(co.$$.fragment),Sp=d(),ye=n("div"),m(In.$$.fragment),Op=d(),It=n("p"),Ap=r("The "),Ns=n("a"),Ip=r("TFPegasusModel"),Lp=r(" forward method, overrides the "),mr=n("code"),Np=r("__call__"),Gp=r(" special method."),Dp=d(),m(uo.$$.fragment),Up=d(),gr=n("p"),Bp=r("Example:"),Wp=d(),m(Ln.$$.fragment),Yi=d(),Lt=n("h2"),po=n("a"),fr=n("span"),m(Nn.$$.fragment),Rp=d(),_r=n("span"),Hp=r("TFPegasusForConditionalGeneration"),ed=d(),he=n("div"),m(Gn.$$.fragment),Kp=d(),Dn=n("p"),Vp=r(`The PEGASUS Model with a language modeling head. Can be used for summarization.
...
separator.`),kf.forEach(t),Po.forEach(t),Qc=l(Pe),Zt=s(Pe,"DIV",{class:!0});var Pd=a(Zt);g(on.$$.fragment,Pd),Jc=l(Pd),Ra=s(Pd,"P",{});var vf=a(Ra);Xc=i(vf,"Converts a sequence of tokens (string) in a single string."),vf.forEach(t),Pd.forEach(t),Zc=l(Pe),Yt=s(Pe,"DIV",{class:!0});var wd=a(Yt);g(nn.$$.fragment,wd),Yc=l(wd),Ha=s(wd,"P",{});var yf=a(Ha);eu=i(yf,"Get list where entries are [1] if a token is [eos] or [pad] else 0."),yf.forEach(t),wd.forEach(t),tu=l(Pe),eo=s(Pe,"DIV",{class:!0});var xd=a(eo);g(sn.$$.fragment,xd),ou=l(xd),Ka=s(xd,"P",{});var bf=a(Ka);nu=i(bf,"Just EOS"),bf.forEach(t),xd.forEach(t),Pe.forEach(t),Bi=l(o),qt=s(o,"H2",{class:!0});var zd=a(qt);to=s(zd,"A",{id:!0,class:!0,href:!0});var Tf=a(to);Va=s(Tf,"SPAN",{});var Pf=a(Va);g(an.$$.fragment,Pf),Pf.forEach(t),Tf.forEach(t),su=l(zd),Qa=s(zd,"SPAN",{});var wf=a(Qa);au=i(wf,"PegasusTokenizerFast"),wf.forEach(t),zd.forEach(t),Wi=l(o),ue=s(o,"DIV",{class:!0});var rt=a(ue);g(rn.$$.fragment,rt),ru=l(rt),Ft=s(rt,"P",{});var Xs=a(Ft);iu=i(Xs,"Construct a \u201Cfast\u201D PEGASUS tokenizer (backed by HuggingFace\u2019s "),Ja=s(Xs,"EM",{});var xf=a(Ja);du=i(xf,"tokenizers"),xf.forEach(t),lu=i(Xs,` library). Based on
...
refer to this superclass for more information regarding those methods.`),$d.forEach(t),fu=l(rt),Xe=s(rt,"DIV",{class:!0});var Zs=a(Xe);g(cn.$$.fragment,Zs),_u=l(Zs),Xa=s(Zs,"P",{});var qf=a(Xa);ku=i(qf,"Build model inputs from a sequence by adding eos to the end. no bos token is added to the front."),qf.forEach(t),vu=l(Zs),un=s(Zs,"UL",{});var qd=a(un);Cs=s(qd,"LI",{});var ag=a(Cs);yu=i(ag,"single sequence: "),Za=s(ag,"CODE",{});var Ff=a(Za);bu=i(Ff,"X </s>"),Ff.forEach(t),ag.forEach(t),Tu=l(qd),pn=s(qd,"LI",{});var Fd=a(pn);Pu=i(Fd,"pair of sequences: "),Ya=s(Fd,"CODE",{});var Ef=a(Ya);wu=i(Ef,"A B </s>"),Ef.forEach(t),xu=i(Fd," (not intended use)"),Fd.forEach(t),qd.forEach(t),Zs.forEach(t),zu=l(rt),oo=s(rt,"DIV",{class:!0});var Ed=a(oo);g(hn.$$.fragment,Ed),$u=l(Ed),er=s(Ed,"P",{});var Mf=a(er);qu=i(Mf,"Get list where entries are [1] if a token is [eos] or [pad] else 0."),Mf.forEach(t),Ed.forEach(t),rt.forEach(t),Ri=l(o),Et=s(o,"H2",{class:!0});var Md=a(Et);no=s(Md,"A",{id:!0,class:!0,href:!0});var jf=a(no);tr=s(jf,"SPAN",{});var Cf=a(tr);g(mn.$$.fragment,Cf),Cf.forEach(t),jf.forEach(t),Fu=l(Md),or=s(Md,"SPAN",{});var Sf=a(or);Eu=i(Sf,"PegasusModel"),Sf.forEach(t),Md.forEach(t),Hi=l(o),Fe=s(o,"DIV",{class:!0});var wo=a(Fe);g(gn.$$.fragment,wo),Mu=l(wo),fn=s(wo,"P",{});var jd=a(fn);ju=i(jd,`The bare PEGASUS Model outputting raw hidden-states without any specific head on top.
This model inherits from `),Ss=s(jd,"A",{href:!0});var Of=a(Ss);Cu=i(Of,"PreTrainedModel"),Of.forEach(t),Su=i(jd,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),jd.forEach(t),Ou=l(wo),_n=s(wo,"P",{});var Cd=a(_n);Au=i(Cd,"This model is also a PyTorch "),kn=s(Cd,"A",{href:!0,rel:!0});var Af=a(kn);Iu=i(Af,"torch.nn.Module"),Af.forEach(t),Lu=i(Cd,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Cd.forEach(t),Nu=l(wo),ke=s(wo,"DIV",{class:!0});var it=a(ke);g(vn.$$.fragment,it),Gu=l(it),Mt=s(it,"P",{});var Ys=a(Mt);Du=i(Ys,"The "),Os=s(Ys,"A",{href:!0});var If=a(Os);Uu=i(If,"PegasusModel"),If.forEach(t),Bu=i(Ys," forward method, overrides the "),nr=s(Ys,"CODE",{});var Lf=a(nr);Wu=i(Lf,"__call__"),Lf.forEach(t),Ru=i(Ys," special method."),Ys.forEach(t),Hu=l(it),g(so.$$.fragment,it),Ku=l(it),sr=s(it,"P",{});var Nf=a(sr);Vu=i(Nf,"Example:"),Nf.forEach(t),Qu=l(it),g(yn.$$.fragment,it),it.forEach(t),wo.forEach(t),Ki=l(o),jt=s(o,"H2",{class:!0});var Sd=a(jt);ao=s(Sd,"A",{id:!0,class:!0,href:!0});var Gf=a(ao);ar=s(Gf,"SPAN",{});var Df=a(ar);g(bn.$$.fragment,Df),Df.forEach(t),Gf.forEach(t),Ju=l(Sd),rr=s(Sd,"SPAN",{});var Uf=a(rr);Xu=i(Uf,"PegasusForConditionalGeneration"),Uf.forEach(t),Sd.forEach(t),Vi=l(o),Ee=s(o,"DIV",{class:!0});var xo=a(Ee);g(Tn.$$.fragment,xo),Zu=l(xo),Pn=s(xo,"P",{});var Od=a(Pn);Yu=i(Od,`The PEGASUS Model with a language modeling head. Can be used for summarization.
This model inherits from `),As=s(Od,"A",{href:!0});var Bf=a(As);ep=i(Bf,"PreTrainedModel"),Bf.forEach(t),tp=i(Od,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Od.forEach(t),op=l(xo),wn=s(xo,"P",{});var Ad=a(wn);np=i(Ad,"This model is also a PyTorch "),xn=s(Ad,"A",{href:!0,rel:!0});var Wf=a(xn);sp=i(Wf,"torch.nn.Module"),Wf.forEach(t),ap=i(Ad,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Ad.forEach(t),rp=l(xo),ve=s(xo,"DIV",{class:!0});var dt=a(ve);g(zn.$$.fragment,dt),ip=l(dt),Ct=s(dt,"P",{});var ea=a(Ct);dp=i(ea,"The "),Is=s(ea,"A",{href:!0});var Rf=a(Is);lp=i(Rf,"PegasusForConditionalGeneration"),Rf.forEach(t),cp=i(ea," forward method, overrides the "),ir=s(ea,"CODE",{});var Hf=a(ir);up=i(Hf,"__call__"),Hf.forEach(t),pp=i(ea," special method."),ea.forEach(t),hp=l(dt),g(ro.$$.fragment,dt),mp=l(dt),dr=s(dt,"P",{});var Kf=a(dr);gp=i(Kf,"Summarization example:"),Kf.forEach(t),fp=l(dt),g($n.$$.fragment,dt),dt.forEach(t),xo.forEach(t),Qi=l(o),St=s(o,"H2",{class:!0});var Id=a(St);io=s(Id,"A",{id:!0,class:!0,href:!0});var Vf=a(io);lr=s(Vf,"SPAN",{});var Qf=a(lr);g(qn.$$.fragment,Qf),Qf.forEach(t),Vf.forEach(t),_p=l(Id),cr=s(Id,"SPAN",{});var Jf=a(cr);kp=i(Jf,"PegasusForCausalLM"),Jf.forEach(t),Id.forEach(t),Ji=l(o),Ot=s(o,"DIV",{class:!0});var Ld=a(Ot);g(Fn.$$.fragment,Ld),vp=l(Ld),Ze=s(Ld,"DIV",{class:!0});var ta=a(Ze);g(En.$$.fragment,ta),yp=l(ta),ur=s(ta,"P",{});var Xf=a(ur);bp=i(Xf,"Example:"),Xf.forEach(t),Tp=l(ta),g(Mn.$$.fragment,ta),ta.forEach(t),Ld.forEach(t),Xi=l(o),At=s(o,"H2",{class:!0});var Nd=a(At);lo=s(Nd,"A",{id:!0,class:!0,href:!0});var Zf=a(lo);pr=s(Zf,"SPAN",{});var Yf=a(pr);g(jn.$$.fragment,Yf),Yf.forEach(t),Zf.forEach(t),Pp=l(Nd),hr=s(Nd,"SPAN",{});var e_=a(hr);wp=i(e_,"TFPegasusModel"),e_.forEach(t),Nd.forEach(t),Zi=l(o),pe=s(o,"DIV",{class:!0});var lt=a(pe);g(Cn.$$.fragment,lt),xp=l(lt),Sn=s(lt,"P",{});var Gd=a(Sn);zp=i(Gd,`The bare PEGASUS Model outputting raw hidden-states without any specific head on top.
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Gd.forEach(t),Fp=l(lt),On=s(lt,"P",{});var Dd=a(On);Ep=i(Dd,"This model is also a "),An=s(Dd,"A",{href:!0,rel:!0});var o_=a(An);Mp=i(o_,"tf.keras.Model"),o_.forEach(t),jp=i(Dd,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Dd.forEach(t),Cp=l(lt),g(co.$$.fragment,lt),Sp=l(lt),ye=s(lt,"DIV",{class:!0});var ct=a(ye);g(In.$$.fragment,ct),Op=l(ct),It=s(ct,"P",{});var oa=a(It);Ap=i(oa,"The "),Ns=s(oa,"A",{href:!0});var n_=a(Ns);Ip=i(n_,"TFPegasusModel"),n_.forEach(t),Lp=i(oa," forward method, overrides the "),mr=s(oa,"CODE",{});var s_=a(mr);Np=i(s_,"__call__"),s_.forEach(t),Gp=i(oa," special method."),oa.forEach(t),Dp=l(ct),g(uo.$$.fragment,ct),Up=l(ct),gr=s(ct,"P",{});var a_=a(gr);Bp=i(a_,"Example:"),a_.forEach(t),Wp=l(ct),g(Ln.$$.fragment,ct),ct.forEach(t),lt.forEach(t),Yi=l(o),Lt=s(o,"H2",{class:!0});var Ud=a(Lt);po=s(Ud,"A",{id:!0,class:!0,href:!0});var r_=a(po);fr=s(r_,"SPAN",{});var i_=a(fr);g(Nn.$$.fragment,i_),i_.forEach(t),r_.forEach(t),Rp=l(Ud),_r=s(Ud,"SPAN",{});var d_=a(_r);Hp=i(d_,"TFPegasusForConditionalGeneration"),d_.forEach(t),Ud.forEach(t),ed=l(o),he=s(o,"DIV",{class:!0});var ut=a(he);g(Gn.$$.fragment,ut),Kp=l(ut),Dn=s(ut,"P",{});var Bd=a(Dn);Vp=i(Bd,`The PEGASUS Model with a language modeling head. Can be used for summarization.
