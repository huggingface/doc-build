import{S as pp,i as mp,s as fp,e as a,k as c,w as T,t as n,M as up,c as r,d as t,m as l,a as i,x as v,h as s,b as d,F as e,g as p,y as x,q as k,o as b,B as y,v as _p}from"../../chunks/vendor-6b77c823.js";import{T as Yt}from"../../chunks/Tip-39098574.js";import{D}from"../../chunks/Docstring-abef54e3.js";import{C as ln}from"../../chunks/CodeBlock-3a8b25a8.js";import{I as We}from"../../chunks/IconCopyLink-7a11ce68.js";function gp(U){let h,q,u,g,S,_,w,$;return{c(){h=a("p"),q=n(`This class method is simply calling the feature extractor
...
`),u=r(z,"A",{href:!0});var E=i(u);g=s(E,"from_pretrained()"),E.forEach(t),S=s(z,` and the tokenizer
`),_=r(z,"CODE",{});var N=i(_);w=s(N,"from_pretrained"),N.forEach(t),$=s(z,` methods. Please refer to the docstrings of the
methods above for more information.`),z.forEach(t),this.h()},h(){d(u,"href","/docs/transformers/main/en/main_classes/feature_extractor#transformers.FeatureExtractionMixin.from_pretrained")},m(A,z){p(A,h,z),e(h,q),e(h,u),e(u,g),e(h,S),e(h,_),e(_,w),e(h,$)},d(A){A&&t(h)}}}function Tp(U){let h,q,u,g,S,_,w,$;return{c(){h=a("p"),q=n("This class method is simply calling "),u=a("a"),g=n("save_pretrained()"),S=n(` and
`),_=a("code"),w=n("save_pretrained"),$=n(`. Please refer to the docstrings of the methods
above for more information.`),this.h()},l(A){h=r(A,"P",{});var z=i(h);q=s(z,"This class method is simply calling "),u=r(z,"A",{href:!0});var E=i(u);g=s(E,"save_pretrained()"),E.forEach(t),S=s(z,` and
`),_=r(z,"CODE",{});var N=i(_);w=s(N,"save_pretrained"),N.forEach(t),$=s(z,`. Please refer to the docstrings of the methods
above for more information.`),z.forEach(t),this.h()},h(){d(u,"href","/docs/transformers/main/en/main_classes/feature_extractor#transformers.FeatureExtractionMixin.save_pretrained")},m(A,z){p(A,h,z),e(h,q),e(h,u),e(u,g),e(h,S),e(h,_),e(_,w),e(h,$)},d(A){A&&t(h)}}}function vp(U){let h,q,u,g,S;return{c(){h=a("p"),q=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),u=a("code"),g=n("Module"),S=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(_){h=r(_,"P",{});var w=i(h);q=s(w,"Although the recipe for forward pass needs to be defined within this function, one should call the "),u=r(w,"CODE",{});var $=i(u);g=s($,"Module"),$.forEach(t),S=s(w,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),w.forEach(t)},m(_,w){p(_,h,w),e(h,q),e(h,u),e(u,g),e(h,S)},d(_){_&&t(h)}}}function xp(U){let h,q,u,g,S;return{c(){h=a("p"),q=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),u=a("code"),g=n("Module"),S=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(_){h=r(_,"P",{});var w=i(h);q=s(w,"Although the recipe for forward pass needs to be defined within this function, one should call the "),u=r(w,"CODE",{});var $=i(u);g=s($,"Module"),$.forEach(t),S=s(w,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),w.forEach(t)},m(_,w){p(_,h,w),e(h,q),e(h,u),e(u,g),e(h,S)},d(_){_&&t(h)}}}function kp(U){let h,q,u,g,S,_,w,$,A,z,E,N,H,ee,Fe,B,je,$e,M,J,te,ye,C,P,Ce,oe,ne,Pe,se,ae,Me,O,Ee,L,Ae,re,ie,Ie,de,K,De,Z,Y;return{c(){h=a("p"),q=n("TF 2.0 models accepts two formats as inputs:"),u=c(),g=a("ul"),S=a("li"),_=n("having all inputs as keyword arguments (like PyTorch models), or"),w=c(),$=a("li"),A=n("having all inputs as a list, tuple or dict in the first positional arguments."),z=c(),E=a("p"),N=n("This second option is useful when using "),H=a("code"),ee=n("tf.keras.Model.fit"),Fe=n(` method which currently requires having all the
...
`),Z=r(Le,"CODE",{});var dt=i(Z);Y=s(dt,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),dt.forEach(t),Le.forEach(t),G.forEach(t)},m(f,F){p(f,h,F),e(h,q),p(f,u,F),p(f,g,F),e(g,S),e(S,_),e(g,w),e(g,$),e($,A),p(f,z,F),p(f,E,F),e(E,N),e(E,H),e(H,ee),e(E,Fe),e(E,B),e(B,je),e(E,$e),p(f,M,F),p(f,J,F),e(J,te),p(f,ye,F),p(f,C,F),e(C,P),e(P,Ce),e(P,oe),e(oe,ne),e(P,Pe),e(P,se),e(se,ae),e(C,Me),e(C,O),e(O,Ee),e(O,L),e(L,Ae),e(O,re),e(O,ie),e(ie,Ie),e(C,de),e(C,K),e(K,De),e(K,Z),e(Z,Y)},d(f){f&&t(h),f&&t(u),f&&t(g),f&&t(z),f&&t(E),f&&t(M),f&&t(J),f&&t(ye),f&&t(C)}}}function bp(U){let h,q,u,g,S;return{c(){h=a("p"),q=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),u=a("code"),g=n("Module"),S=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(_){h=r(_,"P",{});var w=i(h);q=s(w,"Although the recipe for forward pass needs to be defined within this function, one should call the "),u=r(w,"CODE",{});var $=i(u);g=s($,"Module"),$.forEach(t),S=s(w,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),w.forEach(t)},m(_,w){p(_,h,w),e(h,q),e(h,u),e(u,g),e(h,S)},d(_){_&&t(h)}}}function yp(U){let h,q,u,g,S,_,w,$,A,z,E,N,H,ee,Fe,B,je,$e,M,J,te,ye,C,P,Ce,oe,ne,Pe,se,ae,Me,O,Ee,L,Ae,re,ie,Ie,de,K,De,Z,Y;return{c(){h=a("p"),q=n("TF 2.0 models accepts two formats as inputs:"),u=c(),g=a("ul"),S=a("li"),_=n("having all inputs as keyword arguments (like PyTorch models), or"),w=c(),$=a("li"),A=n("having all inputs as a list, tuple or dict in the first positional arguments."),z=c(),E=a("p"),N=n("This second option is useful when using "),H=a("code"),ee=n("tf.keras.Model.fit"),Fe=n(` method which currently requires having all the
tensors in the first argument of the model call function: `),B=a("code"),je=n("model(inputs)"),$e=n("."),M=c(),J=a("p"),te=n(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),ye=c(),C=a("ul"),P=a("li"),Ce=n("a single Tensor with "),oe=a("code"),ne=n("input_ids"),Pe=n(" only and nothing else: "),se=a("code"),ae=n("model(input_ids)"),Me=c(),O=a("li"),Ee=n(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),L=a("code"),Ae=n("model([input_ids, attention_mask])"),re=n(" or "),ie=a("code"),Ie=n("model([input_ids, attention_mask, token_type_ids])"),de=c(),K=a("li"),De=n(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),Z=a("code"),Y=n('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(f){h=r(f,"P",{});var F=i(h);q=s(F,"TF 2.0 models accepts two formats as inputs:"),F.forEach(t),u=l(f),g=r(f,"UL",{});var X=i(g);S=r(X,"LI",{});var st=i(S);_=s(st,"having all inputs as keyword arguments (like PyTorch models), or"),st.forEach(t),w=l(X),$=r(X,"LI",{});var Ne=i($);A=s(Ne,"having all inputs as a list, tuple or dict in the first positional arguments."),Ne.forEach(t),X.forEach(t),z=l(f),E=r(f,"P",{});var Q=i(E);N=s(Q,"This second option is useful when using "),H=r(Q,"CODE",{});var Ve=i(H);ee=s(Ve,"tf.keras.Model.fit"),Ve.forEach(t),Fe=s(Q,` method which currently requires having all the
...
first positional argument :`),at.forEach(t),ye=l(f),C=r(f,"UL",{});var G=i(C);P=r(G,"LI",{});var ce=i(P);Ce=s(ce,"a single Tensor with "),oe=r(ce,"CODE",{});var rt=i(oe);ne=s(rt,"input_ids"),rt.forEach(t),Pe=s(ce," only and nothing else: "),se=r(ce,"CODE",{});var Ue=i(se);ae=s(Ue,"model(input_ids)"),Ue.forEach(t),ce.forEach(t),Me=l(G),O=r(G,"LI",{});var j=i(O);Ee=s(j,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),L=r(j,"CODE",{});var it=i(L);Ae=s(it,"model([input_ids, attention_mask])"),it.forEach(t),re=s(j," or "),ie=r(j,"CODE",{});var qe=i(ie);Ie=s(qe,"model([input_ids, attention_mask, token_type_ids])"),qe.forEach(t),j.forEach(t),de=l(G),K=r(G,"LI",{});var Le=i(K);De=s(Le,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),Z=r(Le,"CODE",{});var dt=i(Z);Y=s(dt,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),dt.forEach(t),Le.forEach(t),G.forEach(t)},m(f,F){p(f,h,F),e(h,q),p(f,u,F),p(f,g,F),e(g,S),e(S,_),e(g,w),e(g,$),e($,A),p(f,z,F),p(f,E,F),e(E,N),e(E,H),e(H,ee),e(E,Fe),e(E,B),e(B,je),e(E,$e),p(f,M,F),p(f,J,F),e(J,te),p(f,ye,F),p(f,C,F),e(C,P),e(P,Ce),e(P,oe),e(oe,ne),e(P,Pe),e(P,se),e(se,ae),e(C,Me),e(C,O),e(O,Ee),e(O,L),e(L,Ae),e(O,re),e(O,ie),e(ie,Ie),e(C,de),e(C,K),e(K,De),e(K,Z),e(Z,Y)},d(f){f&&t(h),f&&t(u),f&&t(g),f&&t(z),f&&t(E),f&&t(M),f&&t(J),f&&t(ye),f&&t(C)}}}function wp(U){let h,q,u,g,S;return{c(){h=a("p"),q=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),u=a("code"),g=n("Module"),S=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(_){h=r(_,"P",{});var w=i(h);q=s(w,"Although the recipe for forward pass needs to be defined within this function, one should call the "),u=r(w,"CODE",{});var $=i(u);g=s($,"Module"),$.forEach(t),S=s(w,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),w.forEach(t)},m(_,w){p(_,h,w),e(h,q),e(h,u),e(u,g),e(h,S)},d(_){_&&t(h)}}}function Sp(U){let h,q,u,g,S,_,w,$,A,z,E,N,H,ee,Fe,B,je,$e,M,J,te,ye,C,P,Ce,oe,ne,Pe,se,ae,Me,O,Ee,L,Ae,re,ie,Ie,de,K,De,Z,Y,f,F,X,st,Ne,Q,Ve,_e,at,G,ce,rt,Ue,j,it,qe,Le,dt,hn,tr,or,pn,nr,sr,mn,ar,rr,Zs,W,ir,Yn,dr,cr,Xn,lr,hr,Qn,pr,mr,Zn,fr,ur,es,_r,gr,Xt,Tr,vr,ts,xr,ea,fn,os,kr,ta,Qt,oa,un,Zt,ns,br,yr,le,wr,ss,Sr,$r,as,Er,qr,rs,zr,Fr,is,jr,Cr,ds,Pr,Mr,na,eo,sa,yt,Ar,to,Ir,Dr,aa,ct,wt,cs,oo,Nr,ls,Lr,ra,he,no,Or,lt,Gr,_n,Wr,Vr,so,Ur,Rr,Hr,ht,Br,gn,Jr,Kr,Tn,Yr,Xr,Qr,hs,Zr,ei,ao,ia,pt,St,ps,ro,ti,ms,oi,da,V,io,ni,fs,si,ai,co,ri,vn,ii,di,ci,$t,lo,li,us,hi,pi,Et,ho,mi,po,fi,_s,ui,_i,gi,Re,mo,Ti,xn,vi,kn,xi,ki,gs,bi,yi,bn,fo,ca,mt,qt,Ts,uo,wi,vs,Si,la,pe,_o,$i,xs,Ei,qi,go,zi,yn,Fi,ji,Ci,ks,Pi,Mi,zt,To,Ai,bs,Ii,ha,ft,Ft,ys,vo,Di,ws,Ni,pa,I,xo,Li,Ss,Oi,Gi,ge,wn,Wi,Vi,Sn,Ui,Ri,$n,Hi,Bi,ko,$s,Ji,Ki,Yi,En,Xi,Qi,Zi,jt,bo,ed,Oe,td,yo,Es,od,nd,sd,qn,ad,rd,wo,qs,id,dd,cd,ld,He,So,hd,zs,pd,md,Ct,fd,Be,$o,ud,Eo,_d,zn,gd,Td,vd,Pt,xd,Mt,qo,kd,zo,bd,Fn,yd,wd,Sd,At,Fo,$d,jo,Ed,jn,qd,zd,Fd,It,Co,jd,Fs,Cd,ma,ut,Dt,js,Po,Pd,Cs,Md,fa,we,Mo,Ad,Ao,Id,Cn,Dd,Nd,Ld,Io,Od,Do,Gd,Wd,Vd,Te,No,Ud,_t,Rd,Pn,Hd,Bd,Ps,Jd,Kd,Yd,Nt,Xd,Ms,Qd,Zd,Lo,ua,gt,Lt,As,Oo,ec,Is,tc,_a,Se,Go,oc,Wo,nc,Mn,sc,ac,rc,Vo,ic,Uo,dc,cc,lc,ve,Ro,hc,Tt,pc,An,mc,fc,Ds,uc,_c,gc,Ot,Tc,Ns,vc,xc,Ho,ga,vt,Gt,Ls,Bo,kc,Os,bc,Ta,me,Jo,yc,Ko,wc,In,Sc,$c,Ec,Yo,qc,Xo,zc,Fc,jc,Wt,Cc,xe,Qo,Pc,xt,Mc,Dn,Ac,Ic,Gs,Dc,Nc,Lc,Vt,Oc,Ws,Gc,Wc,Zo,va,kt,Ut,Vs,en,Vc,Us,Uc,xa,fe,tn,Rc,on,Hc,Nn,Bc,Jc,Kc,nn,Yc,sn,Xc,Qc,Zc,Rt,el,ke,an,tl,bt,ol,Ln,nl,sl,Rs,al,rl,il,Ht,dl,Hs,cl,ll,rn,ka;return _=new We({}),ee=new We({}),X=new We({}),Qt=new ln({props:{code:`import torch
...
Model configuration class with all the parameters of the model. Initializing with a config file does not
load the weights associated with the model, only the configuration. Check out the
<a href="/docs/transformers/main/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),Ro=new D({props:{name:"forward",anchor:"transformers.Speech2TextForConditionalGeneration.forward",parameters:[{name:"input_features",val:" = None"},{name:"attention_mask",val:" = None"},{name:"decoder_input_ids",val:" = None"},{name:"decoder_attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"decoder_head_mask",val:" = None"},{name:"cross_attn_head_mask",val:" = None"},{name:"encoder_outputs",val:" = None"},{name:"past_key_values",val:" = None"},{name:"decoder_inputs_embeds",val:" = None"},{name:"labels",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/speech_to_text/modeling_speech_to_text.py#L1284",parametersDescription:[{anchor:"transformers.Speech2TextForConditionalGeneration.forward.input_features",description:`<strong>input_features</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length, feature_size)</code>) &#x2014;
Float values of fbank features extracted from the raw speech waveform. Raw speech waveform can be obtained
by loading a <code>.flac</code> or <code>.wav</code> audio file into an array of type <code>List[float]</code> or a <code>numpy.ndarray</code>, <em>e.g.</em>
via the soundfile library (<code>pip install soundfile</code>). To prepare the array into <code>input_features</code>, the
<a href="/docs/transformers/main/en/model_doc/speech_to_text#transformers.Speech2TextTokenizer">Speech2TextTokenizer</a> should be used for extracting the fbank features, padding and conversion into a
...
documentation from `),Tn=a("a"),Yr=n("PretrainedConfig"),Xr=n(" for more information."),Qr=c(),hs=a("p"),Zr=n("Example:"),ei=c(),T(ao.$$.fragment),ia=c(),pt=a("h2"),St=a("a"),ps=a("span"),T(ro.$$.fragment),ti=c(),ms=a("span"),oi=n("Speech2TextTokenizer"),da=c(),V=a("div"),T(io.$$.fragment),ni=c(),fs=a("p"),si=n("Construct an Speech2Text tokenizer."),ai=c(),co=a("p"),ri=n("This tokenizer inherits from "),vn=a("a"),ii=n("PreTrainedTokenizer"),di=n(` which contains some of the main methods. Users should refer to
...
special tokens using the tokenizer `),_s=a("code"),ui=n("prepare_for_model"),_i=n(" method."),gi=c(),Re=a("div"),T(mo.$$.fragment),Ti=c(),xn=a("p"),vi=n("Create the token type IDs corresponding to the sequences passed. "),kn=a("a"),xi=n(`What are token type
IDs?`),ki=c(),gs=a("p"),bi=n("Should be overridden in a subclass if the model has a special way of building those."),yi=c(),bn=a("div"),T(fo.$$.fragment),ca=c(),mt=a("h2"),qt=a("a"),Ts=a("span"),T(uo.$$.fragment),wi=c(),vs=a("span"),Si=n("Speech2TextFeatureExtractor"),la=c(),pe=a("div"),T(_o.$$.fragment),$i=c(),xs=a("p"),Ei=n("Constructs a Speech2Text feature extractor."),qi=c(),go=a("p"),zi=n("This feature extractor inherits from "),yn=a("a"),Fi=n("Speech2TextFeatureExtractor"),ji=n(` which contains most of the main methods. Users
...
information.`),ld=c(),He=a("div"),T(So.$$.fragment),hd=c(),zs=a("p"),pd=n("Instantiate a processor associated with a pretrained model."),md=c(),T(Ct.$$.fragment),fd=c(),Be=a("div"),T($o.$$.fragment),ud=c(),Eo=a("p"),_d=n(`Saves the attributes of this processor (feature extractor, tokenizer\u2026) in the specified directory so that it
...
Speech2Text.`),ma=c(),ut=a("h2"),Dt=a("a"),js=a("span"),T(Po.$$.fragment),Pd=c(),Cs=a("span"),Md=n("Speech2TextModel"),fa=c(),we=a("div"),T(Mo.$$.fragment),Ad=c(),Ao=a("p"),Id=n(`The bare Speech2Text Model outputting raw hidden-states without any specific head on top.
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),lc=c(),ve=a("div"),T(Ro.$$.fragment),hc=c(),Tt=a("p"),pc=n("The "),An=a("a"),mc=n("Speech2TextForConditionalGeneration"),fc=n(" forward method, overrides the "),Ds=a("code"),uc=n("__call__"),_c=n(" special method."),gc=c(),T(Ot.$$.fragment),Tc=c(),Ns=a("p"),vc=n("Example:"),xc=c(),T(Ho.$$.fragment),ga=c(),vt=a("h2"),Gt=a("a"),Ls=a("span"),T(Bo.$$.fragment),kc=c(),Os=a("span"),bc=n("TFSpeech2TextModel"),Ta=c(),me=a("div"),T(Jo.$$.fragment),yc=c(),Ko=a("p"),wc=n(`The bare Speech2Text Model outputting raw hidden-states without any specific head on top.
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Zc=c(),T(Rt.$$.fragment),el=c(),ke=a("div"),T(an.$$.fragment),tl=c(),bt=a("p"),ol=n("The "),Ln=a("a"),nl=n("TFSpeech2TextForConditionalGeneration"),sl=n(" forward method, overrides the "),Rs=a("code"),al=n("__call__"),rl=n(" special method."),il=c(),T(Ht.$$.fragment),dl=c(),Hs=a("p"),cl=n("Example:"),ll=c(),T(rn.$$.fragment),this.h()},l(o){const m=up('[data-svelte="svelte-1phssyn"]',document.head);h=r(m,"META",{name:!0,content:!0}),m.forEach(t),q=l(o),u=r(o,"H1",{class:!0});var dn=i(u);g=r(dn,"A",{id:!0,class:!0,href:!0});var Bs=i(g);S=r(Bs,"SPAN",{});var Js=i(S);v(_.$$.fragment,Js),Js.forEach(t),Bs.forEach(t),w=l(dn),$=r(dn,"SPAN",{});var Ks=i($);A=s(Ks,"Speech2Text"),Ks.forEach(t),dn.forEach(t),z=l(o),E=r(o,"H2",{class:!0});var cn=i(E);N=r(cn,"A",{id:!0,class:!0,href:!0});var Ys=i(N);H=r(Ys,"SPAN",{});var Xs=i(H);v(ee.$$.fragment,Xs),Xs.forEach(t),Ys.forEach(t),Fe=l(cn),B=r(cn,"SPAN",{});var Qs=i(B);je=s(Qs,"Overview"),Qs.forEach(t),cn.forEach(t),$e=l(o),M=r(o,"P",{});var Je=i(M);J=s(Je,"The Speech2Text model was proposed in "),te=r(Je,"A",{href:!0,rel:!0});var ul=i(te);ye=s(ul,"fairseq S2T: Fast Speech-to-Text Modeling with fairseq"),ul.forEach(t),C=s(Je,` by Changhan Wang, Yun Tang, Xutai Ma, Anne Wu, Dmytro Okhonko, Juan Pino. It\u2019s a
transformer-based seq2seq (encoder-decoder) model designed for end-to-end Automatic Speech Recognition (ASR) and Speech
Translation (ST). It uses a convolutional downsampler to reduce the length of speech inputs by 3/4th before they are
fed into the encoder. The model is trained with standard autoregressive cross-entropy loss and generates the
transcripts/translations autoregressively. Speech2Text has been fine-tuned on several datasets for ASR and ST:
...
predicted token ids.`),Ke.forEach(t),Zs=l(o),W=r(o,"P",{});var ue=i(W);ir=s(ue,"The feature extractor depends on "),Yn=r(ue,"CODE",{});var zl=i(Yn);dr=s(zl,"torchaudio"),zl.forEach(t),cr=s(ue," and the tokenizer depends on "),Xn=r(ue,"CODE",{});var Fl=i(Xn);lr=s(Fl,"sentencepiece"),Fl.forEach(t),hr=s(ue,` so be sure to
install those packages before running the examples. You could either install those as extra speech dependencies with
`),Qn=r(ue,"CODE",{});var jl=i(Qn);pr=s(jl,'pip install transformers"[speech, sentencepiece]"'),jl.forEach(t),mr=s(ue," or install the packages seperately with "),Zn=r(ue,"CODE",{});var Cl=i(Zn);fr=s(Cl,"pip install torchaudio sentencepiece"),Cl.forEach(t),ur=s(ue,". Also "),es=r(ue,"CODE",{});var Pl=i(es);_r=s(Pl,"torchaudio"),Pl.forEach(t),gr=s(ue," requires the development version of the "),Xt=r(ue,"A",{href:!0,rel:!0});var Ml=i(Xt);Tr=s(Ml,"libsndfile"),Ml.forEach(t),vr=s(ue,` package which can be installed via a system package manager. On Ubuntu it can
...
documentation from `),Tn=r(Wn,"A",{href:!0});var Ql=i(Tn);Yr=s(Ql,"PretrainedConfig"),Ql.forEach(t),Xr=s(Wn," for more information."),Wn.forEach(t),Qr=l(Ye),hs=r(Ye,"P",{});var Zl=i(hs);Zr=s(Zl,"Example:"),Zl.forEach(t),ei=l(Ye),v(ao.$$.fragment,Ye),Ye.forEach(t),ia=l(o),pt=r(o,"H2",{class:!0});var Ea=i(pt);St=r(Ea,"A",{id:!0,class:!0,href:!0});var eh=i(St);ps=r(eh,"SPAN",{});var th=i(ps);v(ro.$$.fragment,th),th.forEach(t),eh.forEach(t),ti=l(Ea),ms=r(Ea,"SPAN",{});var oh=i(ms);oi=s(oh,"Speech2TextTokenizer"),oh.forEach(t),Ea.forEach(t),da=l(o),V=r(o,"DIV",{class:!0});var be=i(V);v(io.$$.fragment,be),ni=l(be),fs=r(be,"P",{});var nh=i(fs);si=s(nh,"Construct an Speech2Text tokenizer."),nh.forEach(t),ai=l(be),co=r(be,"P",{});var qa=i(co);ri=s(qa,"This tokenizer inherits from "),vn=r(qa,"A",{href:!0});var sh=i(vn);ii=s(sh,"PreTrainedTokenizer"),sh.forEach(t),di=s(qa,` which contains some of the main methods. Users should refer to
the superclass for more information regarding such methods.`),qa.forEach(t),ci=l(be),$t=r(be,"DIV",{class:!0});var za=i($t);v(lo.$$.fragment,za),li=l(za),us=r(za,"P",{});var ah=i(us);hi=s(ah,"Build model inputs from a sequence by appending eos_token_id."),ah.forEach(t),za.forEach(t),pi=l(be),Et=r(be,"DIV",{class:!0});var Fa=i(Et);v(ho.$$.fragment,Fa),mi=l(Fa),po=r(Fa,"P",{});var ja=i(po);fi=s(ja,`Retrieve sequence ids from a token list that has no special tokens added. This method is called when adding
special tokens using the tokenizer `),_s=r(ja,"CODE",{});var rh=i(_s);ui=s(rh,"prepare_for_model"),rh.forEach(t),_i=s(ja," method."),ja.forEach(t),Fa.forEach(t),gi=l(be),Re=r(be,"DIV",{class:!0});var Vn=i(Re);v(mo.$$.fragment,Vn),Ti=l(Vn),xn=r(Vn,"P",{});var hl=i(xn);vi=s(hl,"Create the token type IDs corresponding to the sequences passed. "),kn=r(hl,"A",{href:!0});var ih=i(kn);xi=s(ih,`What are token type
IDs?`),ih.forEach(t),hl.forEach(t),ki=l(Vn),gs=r(Vn,"P",{});var dh=i(gs);bi=s(dh,"Should be overridden in a subclass if the model has a special way of building those."),dh.forEach(t),Vn.forEach(t),yi=l(be),bn=r(be,"DIV",{class:!0});var ch=i(bn);v(fo.$$.fragment,ch),ch.forEach(t),be.forEach(t),ca=l(o),mt=r(o,"H2",{class:!0});var Ca=i(mt);qt=r(Ca,"A",{id:!0,class:!0,href:!0});var lh=i(qt);Ts=r(lh,"SPAN",{});var hh=i(Ts);v(uo.$$.fragment,hh),hh.forEach(t),lh.forEach(t),wi=l(Ca),vs=r(Ca,"SPAN",{});var ph=i(vs);Si=s(ph,"Speech2TextFeatureExtractor"),ph.forEach(t),Ca.forEach(t),la=l(o),pe=r(o,"DIV",{class:!0});var Xe=i(pe);v(_o.$$.fragment,Xe),$i=l(Xe),xs=r(Xe,"P",{});var mh=i(xs);Ei=s(mh,"Constructs a Speech2Text feature extractor."),mh.forEach(t),qi=l(Xe),go=r(Xe,"P",{});var Pa=i(go);zi=s(Pa,"This feature extractor inherits from "),yn=r(Pa,"A",{href:!0});var fh=i(yn);Fi=s(fh,"Speech2TextFeatureExtractor"),fh.forEach(t),ji=s(Pa,` which contains most of the main methods. Users
should refer to this superclass for more information regarding those methods.`),Pa.forEach(t),Ci=l(Xe),ks=r(Xe,"P",{});var uh=i(ks);Pi=s(uh,`This class extracts mel-filter bank features from raw speech using TorchAudio and applies utterance-level cepstral
mean and variance normalization to the extracted features.`),uh.forEach(t),Mi=l(Xe),zt=r(Xe,"DIV",{class:!0});var Ma=i(zt);v(To.$$.fragment,Ma),Ai=l(Ma),bs=r(Ma,"P",{});var _h=i(bs);Ii=s(_h,"Main method to featurize and prepare for the model one or several sequence(s). sequences."),_h.forEach(t),Ma.forEach(t),Xe.forEach(t),ha=l(o),ft=r(o,"H2",{class:!0});var Aa=i(ft);Ft=r(Aa,"A",{id:!0,class:!0,href:!0});var gh=i(Ft);ys=r(gh,"SPAN",{});var Th=i(ys);v(vo.$$.fragment,Th),Th.forEach(t),gh.forEach(t),Di=l(Aa),ws=r(Aa,"SPAN",{});var vh=i(ws);Ni=s(vh,"Speech2TextProcessor"),vh.forEach(t),Aa.forEach(t),pa=l(o),I=r(o,"DIV",{class:!0});var R=i(I);v(xo.$$.fragment,R),Li=l(R),Ss=r(R,"P",{});var xh=i(Ss);Oi=s(xh,`Constructs a Speech2Text processor which wraps a Speech2Text feature extractor and a Speech2Text tokenizer into a
...
information.`),Bt.forEach(t),Ia.forEach(t),ld=l(R),He=r(R,"DIV",{class:!0});var Un=i(He);v(So.$$.fragment,Un),hd=l(Un),zs=r(Un,"P",{});var zh=i(zs);pd=s(zh,"Instantiate a processor associated with a pretrained model."),zh.forEach(t),md=l(Un),v(Ct.$$.fragment,Un),Un.forEach(t),fd=l(R),Be=r(R,"DIV",{class:!0});var Rn=i(Be);v($o.$$.fragment,Rn),ud=l(Rn),Eo=r(Rn,"P",{});var Da=i(Eo);_d=s(Da,`Saves the attributes of this processor (feature extractor, tokenizer\u2026) in the specified directory so that it
can be reloaded using the `),zn=r(Da,"A",{href:!0});var Fh=i(zn);gd=s(Fh,"from_pretrained()"),Fh.forEach(t),Td=s(Da," method."),Da.forEach(t),vd=l(Rn),v(Pt.$$.fragment,Rn),Rn.forEach(t),xd=l(R),Mt=r(R,"DIV",{class:!0});var Na=i(Mt);v(qo.$$.fragment,Na),kd=l(Na),zo=r(Na,"P",{});var La=i(zo);bd=s(La,"This method forwards all its arguments to Speech2TextTokenizer\u2019s "),Fn=r(La,"A",{href:!0});var jh=i(Fn);yd=s(jh,"batch_decode()"),jh.forEach(t),wd=s(La,`. Please
refer to the docstring of this method for more information.`),La.forEach(t),Na.forEach(t),Sd=l(R),At=r(R,"DIV",{class:!0});var Oa=i(At);v(Fo.$$.fragment,Oa),$d=l(Oa),jo=r(Oa,"P",{});var Ga=i(jo);Ed=s(Ga,"This method forwards all its arguments to Speech2TextTokenizer\u2019s "),jn=r(Ga,"A",{href:!0});var Ch=i(jn);qd=s(Ch,"decode()"),Ch.forEach(t),zd=s(Ga,`. Please refer
to the docstring of this method for more information.`),Ga.forEach(t),Oa.forEach(t),Fd=l(R),It=r(R,"DIV",{class:!0});var Wa=i(It);v(Co.$$.fragment,Wa),jd=l(Wa),Fs=r(Wa,"P",{});var Ph=i(Fs);Cd=s(Ph,`Temporarily sets the tokenizer for processing the input. Useful for encoding the labels when fine-tuning
Speech2Text.`),Ph.forEach(t),Wa.forEach(t),R.forEach(t),ma=l(o),ut=r(o,"H2",{class:!0});var Va=i(ut);Dt=r(Va,"A",{id:!0,class:!0,href:!0});var Mh=i(Dt);js=r(Mh,"SPAN",{});var Ah=i(js);v(Po.$$.fragment,Ah),Ah.forEach(t),Mh.forEach(t),Pd=l(Va),Cs=r(Va,"SPAN",{});var Ih=i(Cs);Md=s(Ih,"Speech2TextModel"),Ih.forEach(t),Va.forEach(t),fa=l(o),we=r(o,"DIV",{class:!0});var Jt=i(we);v(Mo.$$.fragment,Jt),Ad=l(Jt),Ao=r(Jt,"P",{});var Ua=i(Ao);Id=s(Ua,`The bare Speech2Text Model outputting raw hidden-states without any specific head on top.
This model inherits from `),Cn=r(Ua,"A",{href:!0});var Dh=i(Cn);Dd=s(Dh,"PreTrainedModel"),Dh.forEach(t),Nd=s(Ua,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Ra.forEach(t),Vd=l(Jt),Te=r(Jt,"DIV",{class:!0});var Qe=i(Te);v(No.$$.fragment,Qe),Ud=l(Qe),_t=r(Qe,"P",{});var Hn=i(_t);Rd=s(Hn,"The "),Pn=r(Hn,"A",{href:!0});var Lh=i(Pn);Hd=s(Lh,"Speech2TextModel"),Lh.forEach(t),Bd=s(Hn," forward method, overrides the "),Ps=r(Hn,"CODE",{});var Oh=i(Ps);Jd=s(Oh,"__call__"),Oh.forEach(t),Kd=s(Hn," special method."),Hn.forEach(t),Yd=l(Qe),v(Nt.$$.fragment,Qe),Xd=l(Qe),Ms=r(Qe,"P",{});var Gh=i(Ms);Qd=s(Gh,"Example:"),Gh.forEach(t),Zd=l(Qe),v(Lo.$$.fragment,Qe),Qe.forEach(t),Jt.forEach(t),ua=l(o),gt=r(o,"H2",{class:!0});var Ha=i(gt);Lt=r(Ha,"A",{id:!0,class:!0,href:!0});var Wh=i(Lt);As=r(Wh,"SPAN",{});var Vh=i(As);v(Oo.$$.fragment,Vh),Vh.forEach(t),Wh.forEach(t),ec=l(Ha),Is=r(Ha,"SPAN",{});var Uh=i(Is);tc=s(Uh,"Speech2TextForConditionalGeneration"),Uh.forEach(t),Ha.forEach(t),_a=l(o),Se=r(o,"DIV",{class:!0});var Kt=i(Se);v(Go.$$.fragment,Kt),oc=l(Kt),Wo=r(Kt,"P",{});var Ba=i(Wo);nc=s(Ba,`The Speech2Text Model with a language modeling head. Can be used for summarization.
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Xa.forEach(t),jc=l(et),v(Wt.$$.fragment,et),Cc=l(et),xe=r(et,"DIV",{class:!0});var tt=i(xe);v(Qo.$$.fragment,tt),Pc=l(tt),xt=r(tt,"P",{});var Jn=i(xt);Mc=s(Jn,"The "),Dn=r(Jn,"A",{href:!0});var tp=i(Dn);Ac=s(tp,"TFSpeech2TextModel"),tp.forEach(t),Ic=s(Jn," forward method, overrides the "),Gs=r(Jn,"CODE",{});var op=i(Gs);Dc=s(op,"__call__"),op.forEach(t),Nc=s(Jn," special method."),Jn.forEach(t),Lc=l(tt),v(Vt.$$.fragment,tt),Oc=l(tt),Ws=r(tt,"P",{});var np=i(Ws);Gc=s(np,"Example:"),np.forEach(t),Wc=l(tt),v(Zo.$$.fragment,tt),tt.forEach(t),et.forEach(t),va=l(o),kt=r(o,"H2",{class:!0});var Qa=i(kt);Ut=r(Qa,"A",{id:!0,class:!0,href:!0});var sp=i(Ut);Vs=r(sp,"SPAN",{});var ap=i(Vs);v(en.$$.fragment,ap),ap.forEach(t),sp.forEach(t),Vc=l(Qa),Us=r(Qa,"SPAN",{});var rp=i(Us);Uc=s(rp,"TFSpeech2TextForConditionalGeneration"),rp.forEach(t),Qa.forEach(t),xa=l(o),fe=r(o,"DIV",{class:!0});var ot=i(fe);v(tn.$$.fragment,ot),Rc=l(ot),on=r(ot,"P",{});var Za=i(on);Hc=s(Za,`The Speech2Text Model with a language modeling head. Can be used for summarization.
