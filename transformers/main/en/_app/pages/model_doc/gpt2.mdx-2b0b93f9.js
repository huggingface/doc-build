...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),{c(){d=s("p"),T=r("Example:"),m=p(),y(c.$$.fragment)},l(n){d=a(n,"P",{});var u=l(d);T=i(u,"Example:"),u.forEach(t),m=h(n),k(c.$$.fragment,n)},m(n,u){_(n,d,u),e(d,T),_(n,m,u),w(c,n,u),g=!0},p:ae,i(n){g||($(c.$$.fragment,n),g=!0)},o(n){P(c.$$.fragment,n),g=!1},d(n){n&&t(d),n&&t(m),M(c,n)}}}function Jb(G){let d,T,m,c,g,n,u,j,Q,C,F,R,S,Z,_e,A,Te,ue,W,N,ee,te,z,q,ie,V,fe,le,O,be,ge,E,ve,U,B,de,K,ye,oe,H,ce,J,ke;return{c(){d=s("p"),T=r("TF 2.0 models accepts two formats as inputs:"),m=p(),c=s("ul"),g=s("li"),n=r("having all inputs as keyword arguments (like PyTorch models), or"),u=p(),j=s("li"),Q=r("having all inputs as a list, tuple or dict in the first positional arguments."),C=p(),F=s("p"),R=r("This second option is useful when using "),S=s("code"),Z=r("tf.keras.Model.fit"),_e=r(` method which currently requires having all the
tensors in the first argument of the model call function: `),A=s("code"),Te=r("model(inputs)"),ue=r("."),W=p(),N=s("p"),ee=r(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),te=p(),z=s("ul"),q=s("li"),ie=r("a single Tensor with "),V=s("code"),fe=r("input_ids"),le=r(" only and nothing else: "),O=s("code"),be=r("model(inputs_ids)"),ge=p(),E=s("li"),ve=r(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),U=s("code"),B=r("model([input_ids, attention_mask])"),de=r(" or "),K=s("code"),ye=r("model([input_ids, attention_mask, token_type_ids])"),oe=p(),H=s("li"),ce=r(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),J=s("code"),ke=r('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(v){d=a(v,"P",{});var x=l(d);T=i(x,"TF 2.0 models accepts two formats as inputs:"),x.forEach(t),m=h(v),c=a(v,"UL",{});var ne=l(c);g=a(ne,"LI",{});var Ee=l(g);n=i(Ee,"having all inputs as keyword arguments (like PyTorch models), or"),Ee.forEach(t),u=h(ne),j=a(ne,"LI",{});var Oe=l(j);Q=i(Oe,"having all inputs as a list, tuple or dict in the first positional arguments."),Oe.forEach(t),ne.forEach(t),C=h(v),F=a(v,"P",{});var I=l(F);R=i(I,"This second option is useful when using "),S=a(I,"CODE",{});var qe=l(S);Z=i(qe,"tf.keras.Model.fit"),qe.forEach(t),_e=i(I,` method which currently requires having all the
...
<span class="hljs-meta">&gt;&gt;&gt; </span>inputs = tokenizer(<span class="hljs-string">&quot;Hello, my dog is cute&quot;</span>, return_tensors=<span class="hljs-string">&quot;tf&quot;</span>)
<span class="hljs-meta">&gt;&gt;&gt; </span>outputs = model(inputs)
<span class="hljs-meta">&gt;&gt;&gt; </span>logits = outputs.logits`}}),{c(){d=s("p"),T=r("Example:"),m=p(),y(c.$$.fragment)},l(n){d=a(n,"P",{});var u=l(d);T=i(u,"Example:"),u.forEach(t),m=h(n),k(c.$$.fragment,n)},m(n,u){_(n,d,u),e(d,T),_(n,m,u),w(c,n,u),g=!0},p:ae,i(n){g||($(c.$$.fragment,n),g=!0)},o(n){P(c.$$.fragment,n),g=!1},d(n){n&&t(d),n&&t(m),M(c,n)}}}function Qb(G){let d,T,m,c,g,n,u,j,Q,C,F,R,S,Z,_e,A,Te,ue,W,N,ee,te,z,q,ie,V,fe,le,O,be,ge,E,ve,U,B,de,K,ye,oe,H,ce,J,ke;return{c(){d=s("p"),T=r("TF 2.0 models accepts two formats as inputs:"),m=p(),c=s("ul"),g=s("li"),n=r("having all inputs as keyword arguments (like PyTorch models), or"),u=p(),j=s("li"),Q=r("having all inputs as a list, tuple or dict in the first positional arguments."),C=p(),F=s("p"),R=r("This second option is useful when using "),S=s("code"),Z=r("tf.keras.Model.fit"),_e=r(` method which currently requires having all the
tensors in the first argument of the model call function: `),A=s("code"),Te=r("model(inputs)"),ue=r("."),W=p(),N=s("p"),ee=r(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),te=p(),z=s("ul"),q=s("li"),ie=r("a single Tensor with "),V=s("code"),fe=r("input_ids"),le=r(" only and nothing else: "),O=s("code"),be=r("model(inputs_ids)"),ge=p(),E=s("li"),ve=r(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),U=s("code"),B=r("model([input_ids, attention_mask])"),de=r(" or "),K=s("code"),ye=r("model([input_ids, attention_mask, token_type_ids])"),oe=p(),H=s("li"),ce=r(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),J=s("code"),ke=r('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(v){d=a(v,"P",{});var x=l(d);T=i(x,"TF 2.0 models accepts two formats as inputs:"),x.forEach(t),m=h(v),c=a(v,"UL",{});var ne=l(c);g=a(ne,"LI",{});var Ee=l(g);n=i(Ee,"having all inputs as keyword arguments (like PyTorch models), or"),Ee.forEach(t),u=h(ne),j=a(ne,"LI",{});var Oe=l(j);Q=i(Oe,"having all inputs as a list, tuple or dict in the first positional arguments."),Oe.forEach(t),ne.forEach(t),C=h(v),F=a(v,"P",{});var I=l(F);R=i(I,"This second option is useful when using "),S=a(I,"CODE",{});var qe=l(S);Z=i(qe,"tf.keras.Model.fit"),qe.forEach(t),_e=i(I,` method which currently requires having all the
...
<span class="hljs-meta">&gt;&gt;&gt; </span>next_token_logits = outputs.logits[:, -<span class="hljs-number">1</span>]`}}),{c(){d=s("p"),T=r("Example:"),m=p(),y(c.$$.fragment)},l(n){d=a(n,"P",{});var u=l(d);T=i(u,"Example:"),u.forEach(t),m=h(n),k(c.$$.fragment,n)},m(n,u){_(n,d,u),e(d,T),_(n,m,u),w(c,n,u),g=!0},p:ae,i(n){g||($(c.$$.fragment,n),g=!0)},o(n){P(c.$$.fragment,n),g=!1},d(n){n&&t(d),n&&t(m),M(c,n)}}}function dv(G){let d,T,m,c,g,n,u,j,Q,C,F,R,S,Z,_e,A,Te,ue,W,N,ee,te,z,q,ie,V,fe,le,O,be,ge,E,ve,U,B,de,K,ye,oe,H,ce,J,ke,v,x,ne,Ee,Oe,I,qe,We,Ue,D,X,Be,Ce,Y,Re,De,we,Ve,za,hc,mc,$r,uc,fc,Ea,gc,_c,Tc,yt,bc,Pr,vc,yc,Mr,kc,wc,Cn,$c,Pc,Il,Lt,Dn,Mc,Gc,Gr,xc,jc,Sl,Gt,Fc,Ln,zc,Ec,Nn,qc,Cc,Al,Nt,go,xr,Hn,Dc,jr,Lc,Ol,at,In,Nc,kt,Hc,qa,Ic,Sc,Ca,Ac,Oc,Sn,Wc,Uc,Bc,Ht,Rc,Da,Vc,Kc,La,Jc,Xc,Yc,_o,Wl,It,To,Fr,An,Qc,zr,Zc,Ul,pe,On,ep,Er,tp,op,qr,np,sp,bo,ap,Wn,rp,Cr,ip,lp,dp,vo,cp,Un,pp,Na,hp,mp,up,Ha,Bn,Bl,St,yo,Dr,Rn,fp,Lr,gp,Rl,$e,Vn,_p,Kn,Tp,Nr,bp,vp,yp,Hr,kp,wp,ko,$p,Jn,Pp,Ir,Mp,Gp,xp,wo,jp,Xn,Fp,Ia,zp,Ep,Vl,At,$o,Sr,Yn,qp,Ar,Cp,Kl,Ot,Qn,Dp,Or,Lp,Jl,Wt,Zn,Np,Wr,Hp,Xl,Ut,Po,Ur,es,Ip,Br,Sp,Yl,Pe,ts,Ap,Rr,Op,Wp,os,Up,Sa,Bp,Rp,Vp,ns,Kp,ss,Jp,Xp,Yp,lt,as,Qp,Bt,Zp,Aa,eh,th,Vr,oh,nh,sh,Mo,ah,Go,rh,dt,rs,ih,Kr,lh,dh,Jr,ch,ph,xo,hh,xt,is,mh,Xr,uh,fh,jo,Ql,Rt,Fo,Yr,ls,gh,Qr,_h,Zl,Me,ds,Th,Zr,bh,vh,cs,yh,Oa,kh,wh,$h,ps,Ph,hs,Mh,Gh,xh,ct,ms,jh,Vt,Fh,Wa,zh,Eh,ei,qh,Ch,Dh,zo,Lh,Eo,Nh,pt,us,Hh,ti,Ih,Sh,oi,Ah,Oh,qo,Wh,jt,fs,Uh,ni,Bh,Rh,Co,ed,Kt,Do,si,gs,Vh,ai,Kh,td,Ke,_s,Jh,ri,Xh,Yh,Ts,Qh,Ua,Zh,em,tm,bs,om,vs,nm,sm,am,ht,ys,rm,Jt,im,Ba,lm,dm,ii,cm,pm,hm,Lo,mm,No,od,Xt,Ho,li,ks,um,di,fm,nd,Ge,ws,gm,ci,_m,Tm,Ra,Va,bm,vm,ym,rt,km,pi,wm,$m,hi,Pm,Mm,mi,Gm,xm,ui,jm,Fm,zm,$s,Em,Ka,qm,Cm,Dm,Ps,Lm,Ms,Nm,Hm,Im,Fe,Gs,Sm,Yt,Am,Ja,Om,Wm,fi,Um,Bm,Rm,Io,Vm,So,Km,Ao,Jm,Oo,Xm,Wo,sd,Qt,Uo,gi,xs,Ym,_i,Qm,ad,Je,js,Zm,Ti,eu,tu,Fs,ou,Xa,nu,su,au,zs,ru,Es,iu,lu,du,Xe,qs,cu,Zt,pu,Ya,hu,mu,bi,uu,fu,gu,Bo,_u,Ro,Tu,Vo,rd,eo,Ko,vi,Cs,bu,yi,vu,id,Le,Ds,yu,ki,ku,wu,Ls,$u,Qa,Pu,Mu,Gu,Ns,xu,Hs,ju,Fu,zu,Jo,Eu,mt,Is,qu,to,Cu,Za,Du,Lu,wi,Nu,Hu,Iu,Xo,Su,Yo,ld,oo,Qo,$i,Ss,Au,Pi,Ou,dd,Ne,As,Wu,Mi,Uu,Bu,Os,Ru,er,Vu,Ku,Ju,Ws,Xu,Us,Yu,Qu,Zu,Zo,ef,ut,Bs,tf,no,of,tr,nf,sf,Gi,af,rf,lf,en,df,tn,cd,so,on,xi,Rs,cf,ji,pf,pd,He,Vs,hf,Fi,mf,uf,Ks,ff,or,gf,_f,Tf,Js,bf,Xs,vf,yf,kf,nn,wf,ft,Ys,$f,ao,Pf,nr,Mf,Gf,zi,xf,jf,Ff,sn,zf,an,hd,ro,rn,Ei,Qs,Ef,qi,qf,md,he,Zs,Cf,Ci,Df,Lf,sr,ar,Nf,Hf,If,it,Sf,Di,Af,Of,Li,Wf,Uf,Ni,Bf,Rf,Hi,Vf,Kf,Jf,ea,Xf,rr,Yf,Qf,Zf,ta,eg,oa,tg,og,ng,ln,sg,Ye,na,ag,io,rg,ir,ig,lg,Ii,dg,cg,pg,dn,hg,cn,mg,pn,ud,lo,hn,Si,sa,ug,Ai,fg,fd,co,aa,gg,Oi,_g,gd,po,mn,Wi,ra,Tg,Ui,bg,_d,xe,ia,vg,Bi,yg,kg,la,wg,lr,$g,Pg,Mg,da,Gg,ca,xg,jg,Fg,Ri,zg,Eg,wt,Vi,pa,qg,Cg,Ki,ha,Dg,Lg,Ji,ma,Ng,Hg,Xi,ua,Ig,Sg,gt,fa,Ag,ho,Og,Yi,Wg,Ug,Qi,Bg,Rg,Vg,un,Kg,fn,Td,mo,gn,Zi,ga,Jg,el,Xg,bd,je,_a,Yg,tl,Qg,Zg,Ta,e_,dr,t_,o_,n_,ba,s_,va,a_,r_,i_,ol,l_,d_,$t,nl,ya,c_,p_,sl,ka,h_,m_,al,wa,u_,f_,rl,$a,g_,__,_t,Pa,T_,uo,b_,il,v_,y_,ll,k_,w_,$_,_n,P_,Tn,vd;return n=new ze({}),Z=new ze({}),Hn=new ze({}),In=new L({props:{name:"class transformers.GPT2Config",anchor:"transformers.GPT2Config",parameters:[{name:"vocab_size",val:" = 50257"},{name:"n_positions",val:" = 1024"},{name:"n_embd",val:" = 768"},{name:"n_layer",val:" = 12"},{name:"n_head",val:" = 12"},{name:"n_inner",val:" = None"},{name:"activation_function",val:" = 'gelu_new'"},{name:"resid_pdrop",val:" = 0.1"},{name:"embd_pdrop",val:" = 0.1"},{name:"attn_pdrop",val:" = 0.1"},{name:"layer_norm_epsilon",val:" = 1e-05"},{name:"initializer_range",val:" = 0.02"},{name:"summary_type",val:" = 'cls_index'"},{name:"summary_use_proj",val:" = True"},{name:"summary_activation",val:" = None"},{name:"summary_proj_to_labels",val:" = True"},{name:"summary_first_dropout",val:" = 0.1"},{name:"scale_attn_weights",val:" = True"},{name:"use_cache",val:" = True"},{name:"bos_token_id",val:" = 50256"},{name:"eos_token_id",val:" = 50256"},{name:"scale_attn_by_inverse_layer_idx",val:" = False"},{name:"reorder_and_upcast_attn",val:" = False"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.GPT2Config.vocab_size",description:`<strong>vocab_size</strong> (<code>int</code>, <em>optional</em>, defaults to 50257) &#x2014;
...
configuration. Check out the <a href="/docs/transformers/main/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/gpt2/modeling_gpt2.py#L667"}}),as=new L({props:{name:"forward",anchor:"transformers.GPT2Model.forward",parameters:[{name:"input_ids",val:" = None"},{name:"past_key_values",val:" = None"},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"encoder_hidden_states",val:" = None"},{name:"encoder_attention_mask",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],parametersDescription:[{anchor:"transformers.GPT2Model.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, input_ids_length)</code>) &#x2014;
...
<li>gpt2-large: 36</li>
<li>gpt2-xl: 48</li>
</ul>`,name:"device_map"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/gpt2/modeling_gpt2.py#L690"}}),xo=new se({props:{anchor:"transformers.GPT2Model.parallelize.example",$$slots:{default:[Fb]},$$scope:{ctx:G}}}),is=new L({props:{name:"deparallelize",anchor:"transformers.GPT2Model.deparallelize",parameters:[],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/gpt2/modeling_gpt2.py#L710"}}),jo=new se({props:{anchor:"transformers.GPT2Model.deparallelize.example",$$slots:{default:[zb]},$$scope:{ctx:G}}}),ls=new ze({}),ds=new L({props:{name:"class transformers.GPT2LMHeadModel",anchor:"transformers.GPT2LMHeadModel",parameters:[{name:"config",val:""}],parametersDescription:[{anchor:"transformers.GPT2LMHeadModel.config",description:`<strong>config</strong> (<a href="/docs/transformers/main/en/model_doc/gpt2#transformers.GPT2Config">GPT2Config</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/main/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/gpt2/modeling_gpt2.py#L945"}}),ms=new L({props:{name:"forward",anchor:"transformers.GPT2LMHeadModel.forward",parameters:[{name:"input_ids",val:" = None"},{name:"past_key_values",val:" = None"},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"encoder_hidden_states",val:" = None"},{name:"encoder_attention_mask",val:" = None"},{name:"labels",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],parametersDescription:[{anchor:"transformers.GPT2LMHeadModel.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, input_ids_length)</code>) &#x2014;
<code>input_ids_length</code> = <code>sequence_length</code> if <code>past_key_values</code> is <code>None</code> else
<code>past_key_values[0][0].shape[-2]</code> (<code>sequence_length</code> of input past key value states). Indices of input
sequence tokens in the vocabulary.</p>
<p>If <code>past_key_values</code> is used, only <code>input_ids</code> that do not have their past calculated should be passed as
...
<li>gpt2-large: 36</li>
<li>gpt2-xl: 48</li>
</ul>`,name:"device_map"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/gpt2/modeling_gpt2.py#L960"}}),qo=new se({props:{anchor:"transformers.GPT2LMHeadModel.parallelize.example",$$slots:{default:[Cb]},$$scope:{ctx:G}}}),fs=new L({props:{name:"deparallelize",anchor:"transformers.GPT2LMHeadModel.deparallelize",parameters:[],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/gpt2/modeling_gpt2.py#L972"}}),Co=new se({props:{anchor:"transformers.GPT2LMHeadModel.deparallelize.example",$$slots:{default:[Db]},$$scope:{ctx:G}}}),gs=new ze({}),_s=new L({props:{name:"class transformers.GPT2DoubleHeadsModel",anchor:"transformers.GPT2DoubleHeadsModel",parameters:[{name:"config",val:""}],parametersDescription:[{anchor:"transformers.GPT2DoubleHeadsModel.config",description:`<strong>config</strong> (<a href="/docs/transformers/main/en/model_doc/gpt2#transformers.GPT2Config">GPT2Config</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/main/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/gpt2/modeling_gpt2.py#L1114"}}),ys=new L({props:{name:"forward",anchor:"transformers.GPT2DoubleHeadsModel.forward",parameters:[{name:"input_ids",val:" = None"},{name:"past_key_values",val:" = None"},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"mc_token_ids",val:" = None"},{name:"labels",val:" = None"},{name:"mc_labels",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.GPT2DoubleHeadsModel.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, input_ids_length)</code>) &#x2014;
<code>input_ids_length</code> = <code>sequence_length</code> if <code>past_key_values</code> is <code>None</code> else
<code>past_key_values[0][0].shape[-2]</code> (<code>sequence_length</code> of input past key value states). Indices of input
sequence tokens in the vocabulary.</p>
<p>If <code>past_key_values</code> is used, only <code>input_ids</code> that do not have their past calculated should be passed as
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/main/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/gpt2/modeling_gpt2.py#L1328"}}),Gs=new L({props:{name:"forward",anchor:"transformers.GPT2ForSequenceClassification.forward",parameters:[{name:"input_ids",val:" = None"},{name:"past_key_values",val:" = None"},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"labels",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],parametersDescription:[{anchor:"transformers.GPT2ForSequenceClassification.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, input_ids_length)</code>) &#x2014;
<code>input_ids_length</code> = <code>sequence_length</code> if <code>past_key_values</code> is <code>None</code> else
<code>past_key_values[0][0].shape[-2]</code> (<code>sequence_length</code> of input past key value states). Indices of input
sequence tokens in the vocabulary.</p>
<p>If <code>past_key_values</code> is used, only <code>input_ids</code> that do not have their past calculated should be passed as
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/main/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/gpt2/modeling_gpt2.py#L1456"}}),qs=new L({props:{name:"forward",anchor:"transformers.GPT2ForTokenClassification.forward",parameters:[{name:"input_ids",val:" = None"},{name:"past_key_values",val:" = None"},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"labels",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],parametersDescription:[{anchor:"transformers.GPT2ForTokenClassification.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, input_ids_length)</code>) &#x2014;
<code>input_ids_length</code> = <code>sequence_length</code> if <code>past_key_values</code> is <code>None</code> else
<code>past_key_values[0][0].shape[-2]</code> (<code>sequence_length</code> of input past key value states). Indices of input
sequence tokens in the vocabulary.</p>
<p>If <code>past_key_values</code> is used, only <code>input_ids</code> that do not have their past calculated should be passed as
...
this superclass for more information regarding those methods.`),up=p(),Ha=s("div"),y(Bn.$$.fragment),Bl=p(),St=s("h2"),yo=s("a"),Dr=s("span"),y(Rn.$$.fragment),fp=p(),Lr=s("span"),gp=r("GPT2TokenizerFast"),Rl=p(),$e=s("div"),y(Vn.$$.fragment),_p=p(),Kn=s("p"),Tp=r("Construct a \u201Cfast\u201D GPT-2 tokenizer (backed by HuggingFace\u2019s "),Nr=s("em"),bp=r("tokenizers"),vp=r(` library). Based on byte-level
...
it will evenly distribute blocks across all devices.`),ph=p(),y(xo.$$.fragment),hh=p(),xt=s("div"),y(is.$$.fragment),mh=p(),Xr=s("p"),uh=r("Moves the model to cpu from a model parallel state."),fh=p(),y(jo.$$.fragment),Ql=p(),Rt=s("h2"),Fo=s("a"),Yr=s("span"),y(ls.$$.fragment),gh=p(),Qr=s("span"),_h=r("GPT2LMHeadModel"),Zl=p(),Me=s("div"),y(ds.$$.fragment),Th=p(),Zr=s("p"),bh=r(`The GPT2 Model transformer with a language modeling head on top (linear layer with weights tied to the input
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),am=p(),ht=s("div"),y(ys.$$.fragment),rm=p(),Jt=s("p"),im=r("The "),Ba=s("a"),lm=r("GPT2DoubleHeadsModel"),dm=r(" forward method, overrides the "),ii=s("code"),cm=r("__call__"),pm=r(" special method."),hm=p(),y(Lo.$$.fragment),mm=p(),y(No.$$.fragment),od=p(),Xt=s("h2"),Ho=s("a"),li=s("span"),y(ks.$$.fragment),um=p(),di=s("span"),fm=r("GPT2ForSequenceClassification"),nd=p(),Ge=s("div"),y(ws.$$.fragment),gm=p(),ci=s("p"),_m=r("The GPT2 Model transformer with a sequence classification head on top (linear layer)."),Tm=p(),Ra=s("p"),Va=s("a"),bm=r("GPT2ForSequenceClassification"),vm=r(` uses the last token in order to do the classification, as other causal models
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Im=p(),Fe=s("div"),y(Gs.$$.fragment),Sm=p(),Yt=s("p"),Am=r("The "),Ja=s("a"),Om=r("GPT2ForSequenceClassification"),Wm=r(" forward method, overrides the "),fi=s("code"),Um=r("__call__"),Bm=r(" special method."),Rm=p(),y(Io.$$.fragment),Vm=p(),y(So.$$.fragment),Km=p(),y(Ao.$$.fragment),Jm=p(),y(Oo.$$.fragment),Xm=p(),y(Wo.$$.fragment),sd=p(),Qt=s("h2"),Uo=s("a"),gi=s("span"),y(xs.$$.fragment),Ym=p(),_i=s("span"),Qm=r("GPT2ForTokenClassification"),ad=p(),Je=s("div"),y(js.$$.fragment),Zm=p(),Ti=s("p"),eu=r(`GPT2 Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g. for
...
embeddings).`),Bu=p(),Os=s("p"),Ru=r("This model inherits from "),er=s("a"),Vu=r("TFPreTrainedModel"),Ku=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Ju=p(),Ws=s("p"),Xu=r("This model is also a "),Us=s("a"),Yu=r("tf.keras.Model"),Qu=r(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Zu=p(),y(Zo.$$.fragment),ef=p(),ut=s("div"),y(Bs.$$.fragment),tf=p(),no=s("p"),of=r("The "),tr=s("a"),nf=r("TFGPT2LMHeadModel"),sf=r(" forward method, overrides the "),Gi=s("code"),af=r("__call__"),rf=r(" special method."),lf=p(),y(en.$$.fragment),df=p(),y(tn.$$.fragment),cd=p(),so=s("h2"),on=s("a"),xi=s("span"),y(Rs.$$.fragment),cf=p(),ji=s("span"),pf=r("TFGPT2DoubleHeadsModel"),pd=p(),He=s("div"),y(Vs.$$.fragment),hf=p(),Fi=s("p"),mf=r(`The GPT2 Model transformer with a language modeling and a multiple-choice classification head on top e.g. for
RocStories/SWAG tasks. The two heads are two linear layers. The language modeling head has its weights tied to the
input embeddings, the classification head takes as input the input of a specified classification token index in the
...
this superclass for more information regarding those methods.`),wd.forEach(t),up=h(Se),Ha=a(Se,"DIV",{class:!0});var A_=l(Ha);k(Bn.$$.fragment,A_),A_.forEach(t),Se.forEach(t),Bl=h(o),St=a(o,"H2",{class:!0});var $d=l(St);yo=a($d,"A",{id:!0,class:!0,href:!0});var O_=l(yo);Dr=a(O_,"SPAN",{});var W_=l(Dr);k(Rn.$$.fragment,W_),W_.forEach(t),O_.forEach(t),fp=h($d),Lr=a($d,"SPAN",{});var U_=l(Lr);gp=i(U_,"GPT2TokenizerFast"),U_.forEach(t),$d.forEach(t),Rl=h(o),$e=a(o,"DIV",{class:!0});var Qe=l($e);k(Vn.$$.fragment,Qe),_p=h(Qe),Kn=a(Qe,"P",{});var Pd=l(Kn);Tp=i(Pd,"Construct a \u201Cfast\u201D GPT-2 tokenizer (backed by HuggingFace\u2019s "),Nr=a(Pd,"EM",{});var B_=l(Nr);bp=i(B_,"tokenizers"),B_.forEach(t),vp=i(Pd,` library). Based on byte-level
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Od.forEach(t),Im=h(tt),Fe=a(tt,"DIV",{class:!0});var ot=l(Fe);k(Gs.$$.fragment,ot),Sm=h(ot),Yt=a(ot,"P",{});var gr=l(Yt);Am=i(gr,"The "),Ja=a(gr,"A",{href:!0});var A2=l(Ja);Om=i(A2,"GPT2ForSequenceClassification"),A2.forEach(t),Wm=i(gr," forward method, overrides the "),fi=a(gr,"CODE",{});var O2=l(fi);Um=i(O2,"__call__"),O2.forEach(t),Bm=i(gr," special method."),gr.forEach(t),Rm=h(ot),k(Io.$$.fragment,ot),Vm=h(ot),k(So.$$.fragment,ot),Km=h(ot),k(Ao.$$.fragment,ot),Jm=h(ot),k(Oo.$$.fragment,ot),Xm=h(ot),k(Wo.$$.fragment,ot),ot.forEach(t),tt.forEach(t),sd=h(o),Qt=a(o,"H2",{class:!0});var Wd=l(Qt);Uo=a(Wd,"A",{id:!0,class:!0,href:!0});var W2=l(Uo);gi=a(W2,"SPAN",{});var U2=l(gi);k(xs.$$.fragment,U2),U2.forEach(t),W2.forEach(t),Ym=h(Wd),_i=a(Wd,"SPAN",{});var B2=l(_i);Qm=i(B2,"GPT2ForTokenClassification"),B2.forEach(t),Wd.forEach(t),ad=h(o),Je=a(o,"DIV",{class:!0});var Et=l(Je);k(js.$$.fragment,Et),Zm=h(Et),Ti=a(Et,"P",{});var R2=l(Ti);eu=i(R2,`GPT2 Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g. for
Named-Entity-Recognition (NER) tasks.`),R2.forEach(t),tu=h(Et),Fs=a(Et,"P",{});var Ud=l(Fs);ou=i(Ud,"This model inherits from "),Xa=a(Ud,"A",{href:!0});var V2=l(Xa);nu=i(V2,"PreTrainedModel"),V2.forEach(t),su=i(Ud,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Ud.forEach(t),au=h(Et),zs=a(Et,"P",{});var Bd=l(zs);ru=i(Bd,"This model is also a PyTorch "),Es=a(Bd,"A",{href:!0,rel:!0});var K2=l(Es);iu=i(K2,"torch.nn.Module"),K2.forEach(t),lu=i(Bd,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Bd.forEach(t),du=h(Et),Xe=a(Et,"DIV",{class:!0});var qt=l(Xe);k(qs.$$.fragment,qt),cu=h(qt),Zt=a(qt,"P",{});var _r=l(Zt);pu=i(_r,"The "),Ya=a(_r,"A",{href:!0});var J2=l(Ya);hu=i(J2,"GPT2ForTokenClassification"),J2.forEach(t),mu=i(_r," forward method, overrides the "),bi=a(_r,"CODE",{});var X2=l(bi);uu=i(X2,"__call__"),X2.forEach(t),fu=i(_r," special method."),_r.forEach(t),gu=h(qt),k(Bo.$$.fragment,qt),_u=h(qt),k(Ro.$$.fragment,qt),Tu=h(qt),k(Vo.$$.fragment,qt),qt.forEach(t),Et.forEach(t),rd=h(o),eo=a(o,"H2",{class:!0});var Rd=l(eo);Ko=a(Rd,"A",{id:!0,class:!0,href:!0});var Y2=l(Ko);vi=a(Y2,"SPAN",{});var Q2=l(vi);k(Cs.$$.fragment,Q2),Q2.forEach(t),Y2.forEach(t),bu=h(Rd),yi=a(Rd,"SPAN",{});var Z2=l(yi);vu=i(Z2,"TFGPT2Model"),Z2.forEach(t),Rd.forEach(t),id=h(o),Le=a(o,"DIV",{class:!0});var Tt=l(Le);k(Ds.$$.fragment,Tt),yu=h(Tt),ki=a(Tt,"P",{});var eT=l(ki);ku=i(eT,"The bare GPT2 Model transformer outputting raw hidden-states without any specific head on top."),eT.forEach(t),wu=h(Tt),Ls=a(Tt,"P",{});var Vd=l(Ls);$u=i(Vd,"This model inherits from "),Qa=a(Vd,"A",{href:!0});var tT=l(Qa);Pu=i(tT,"TFPreTrainedModel"),tT.forEach(t),Mu=i(Vd,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
embeddings).`),lT.forEach(t),Bu=h(bt),Os=a(bt,"P",{});var Xd=l(Os);Ru=i(Xd,"This model inherits from "),er=a(Xd,"A",{href:!0});var dT=l(er);Vu=i(dT,"TFPreTrainedModel"),dT.forEach(t),Ku=i(Xd,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Yd.forEach(t),Zu=h(bt),k(Zo.$$.fragment,bt),ef=h(bt),ut=a(bt,"DIV",{class:!0});var xn=l(ut);k(Bs.$$.fragment,xn),tf=h(xn),no=a(xn,"P",{});var br=l(no);of=i(br,"The "),tr=a(br,"A",{href:!0});var pT=l(tr);nf=i(pT,"TFGPT2LMHeadModel"),pT.forEach(t),sf=i(br," forward method, overrides the "),Gi=a(br,"CODE",{});var hT=l(Gi);af=i(hT,"__call__"),hT.forEach(t),rf=i(br," special method."),br.forEach(t),lf=h(xn),k(en.$$.fragment,xn),df=h(xn),k(tn.$$.fragment,xn),xn.forEach(t),bt.forEach(t),cd=h(o),so=a(o,"H2",{class:!0});var Qd=l(so);on=a(Qd,"A",{id:!0,class:!0,href:!0});var mT=l(on);xi=a(mT,"SPAN",{});var uT=l(xi);k(Rs.$$.fragment,uT),uT.forEach(t),mT.forEach(t),cf=h(Qd),ji=a(Qd,"SPAN",{});var fT=l(ji);pf=i(fT,"TFGPT2DoubleHeadsModel"),fT.forEach(t),Qd.forEach(t),pd=h(o),He=a(o,"DIV",{class:!0});var vt=l(He);k(Vs.$$.fragment,vt),hf=h(vt),Fi=a(vt,"P",{});var gT=l(Fi);mf=i(gT,`The GPT2 Model transformer with a language modeling and a multiple-choice classification head on top e.g. for
RocStories/SWAG tasks. The two heads are two linear layers. The language modeling head has its weights tied to the
input embeddings, the classification head takes as input the input of a specified classification token index in the
