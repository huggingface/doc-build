import{S as uk,i as mk,s as fk,e as n,k as c,w as y,t as s,M as gk,c as o,d as t,m as h,a as r,x as q,h as a,b as f,N as _k,G as e,g as m,y as j,q as $,o as E,B as F,v as Tk,L as ut}from"../../chunks/vendor-hf-doc-builder.js";import{T as Ms}from"../../chunks/Tip-hf-doc-builder.js";import{D as He}from"../../chunks/Docstring-hf-doc-builder.js";import{C as Ve}from"../../chunks/CodeBlock-hf-doc-builder.js";import{I as Rt}from"../../chunks/IconCopyLink-hf-doc-builder.js";import{F as Pc,M as To}from"../../chunks/Markdown-hf-doc-builder.js";import{E as Tn}from"../../chunks/ExampleCodeBlock-hf-doc-builder.js";function bk(P){let l,b,d,u,T,p,g,A,k,N,x,U,G,V,B,K,re,W,L;return g=new Ve({props:{code:`from transformers import TapasConfig, TapasForQuestionAnswering
...
<span class="hljs-meta">&gt;&gt;&gt; </span>config = TapasConfig(num_aggregation_labels=<span class="hljs-number">3</span>, average_logits_per_cell=<span class="hljs-literal">True</span>)
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-comment"># initializing the pre-trained base sized model with our custom classification heads</span>
<span class="hljs-meta">&gt;&gt;&gt; </span>model = TFTapasForQuestionAnswering.from_pretrained(<span class="hljs-string">&quot;google/tapas-base&quot;</span>, config=config)`}}),{c(){l=n("p"),b=s("Initializing a model with a pre-trained base and randomly initialized classification heads from the hub can be done as shown below. Be sure to have installed the "),d=n("a"),u=s("tensorflow_probability"),T=s(" dependency:"),p=c(),y(g.$$.fragment),A=c(),k=n("p"),N=s("Of course, you don\u2019t necessarily have to follow one of these three ways in which TAPAS was fine-tuned. You can also experiment by defining any hyperparameters you want when initializing "),x=n("a"),U=s("TapasConfig"),G=s(", and then create a "),V=n("a"),B=s("TFTapasForQuestionAnswering"),K=s(" based on that configuration. For example, if you have a dataset that has both conversational questions and questions that might involve aggregation, then you can do it this way. Here\u2019s an example:"),re=c(),y(W.$$.fragment),this.h()},l(w){l=o(w,"P",{});var M=r(l);b=a(M,"Initializing a model with a pre-trained base and randomly initialized classification heads from the hub can be done as shown below. Be sure to have installed the "),d=o(M,"A",{href:!0,rel:!0});var R=r(d);u=a(R,"tensorflow_probability"),R.forEach(t),T=a(M," dependency:"),M.forEach(t),p=h(w),q(g.$$.fragment,w),A=h(w),k=o(w,"P",{});var C=r(k);N=a(C,"Of course, you don\u2019t necessarily have to follow one of these three ways in which TAPAS was fine-tuned. You can also experiment by defining any hyperparameters you want when initializing "),x=o(C,"A",{href:!0});var O=r(x);U=a(O,"TapasConfig"),O.forEach(t),G=a(C,", and then create a "),V=o(C,"A",{href:!0});var ee=r(V);B=a(ee,"TFTapasForQuestionAnswering"),ee.forEach(t),K=a(C," based on that configuration. For example, if you have a dataset that has both conversational questions and questions that might involve aggregation, then you can do it this way. Here\u2019s an example:"),C.forEach(t),re=h(w),q(W.$$.fragment,w),this.h()},h(){f(d,"href","https://github.com/tensorflow/probability"),f(d,"rel","nofollow"),f(x,"href","/docs/transformers/main/en/model_doc/tapas#transformers.TapasConfig"),f(V,"href","/docs/transformers/main/en/model_doc/tapas#transformers.TFTapasForQuestionAnswering")},m(w,M){m(w,l,M),e(l,b),e(l,d),e(d,u),e(l,T),m(w,p,M),j(g,w,M),m(w,A,M),m(w,k,M),e(k,N),e(k,x),e(x,U),e(k,G),e(k,V),e(V,B),e(k,K),m(w,re,M),j(W,w,M),L=!0},p:ut,i(w){L||($(g.$$.fragment,w),$(W.$$.fragment,w),L=!0)},o(w){E(g.$$.fragment,w),E(W.$$.fragment,w),L=!1},d(w){w&&t(l),w&&t(p),F(g,w),w&&t(A),w&&t(k),w&&t(re),F(W,w)}}}function kk(P){let l,b;return l=new To({props:{$$slots:{default:[wk]},$$scope:{ctx:P}}}),{c(){y(l.$$.fragment)},l(d){q(l.$$.fragment,d)},m(d,u){j(l,d,u),b=!0},p(d,u){const T={};u&2&&(T.$$scope={dirty:u,ctx:d}),l.$set(T)},i(d){b||($(l.$$.fragment,d),b=!0)},o(d){E(l.$$.fragment,d),b=!1},d(d){F(l,d)}}}function yk(P){let l,b,d,u,T,p,g,A,k,N,x,U,G,V,B,K,re,W,L,w,M,R,C,O,ee,te,ce,ne,se,S,Q,H,X,I,Y,ge,ue,_e,me,oe,qe,ie,ve,v,D,be,xe,we,le,ze,Me,Z,de,pe,De,je,Te,Ne,ke,Ae,Oe,Ze,Ps,Ss,mt,ft,ca,gt,_t,Ds,tt,Ns,Os,Ke,Pe,Ls,kt,ye,yt,qt,Qs,jt,$t,Is,Et,cs,Gt,Ft,hs,Ye,$e,Ws,At,ae,nt,Vt,Hs,xt,Jt,Us,zt,Ct,Bs,Mt,Xt,Rs,Pt,Zt,Gs,St,Vs,Le,Dt,es,Ks,Nt,ts,Ys,ss,Ue,as,Ee,ns,ot,Js,Ot,Lt,Xs,Zs,Be,ea,os,rs,et,Qt;return Ue=new Ve({props:{code:`from transformers import TapasTokenizer
import pandas as pd
...
<span class="hljs-meta">&gt;&gt;&gt; </span>train_dataloader = torch.utils.data.DataLoader(train_dataset, batch_size=<span class="hljs-number">32</span>)`}}),{c(){l=n("p"),b=s("Third, given that you\u2019ve prepared your data in this TSV/CSV format (and corresponding CSV files containing the tabular data), you can then use "),d=n("a"),u=s("TapasTokenizer"),T=s(" to convert table-question pairs into "),p=n("code"),g=s("input_ids"),A=s(", "),k=n("code"),N=s("attention_mask"),x=s(", "),U=n("code"),G=s("token_type_ids"),V=s(" and so on. Again, based on which of the three cases you picked above, "),B=n("a"),K=s("TapasForQuestionAnswering"),re=s(` requires different
inputs to be fine-tuned:`),W=c(),L=n("table"),w=n("thead"),M=n("tr"),R=n("th"),C=n("strong"),O=s("Task"),ee=c(),te=n("th"),ce=n("strong"),ne=s("Required inputs"),se=c(),S=n("tbody"),Q=n("tr"),H=n("td"),X=s("Conversational"),I=c(),Y=n("td"),ge=n("code"),ue=s("input_ids"),_e=s(", "),me=n("code"),oe=s("attention_mask"),qe=s(", "),ie=n("code"),ve=s("token_type_ids"),v=s(", "),D=n("code"),be=s("labels"),xe=c(),we=n("tr"),le=n("td"),ze=s("Weak supervision for aggregation"),Me=c(),Z=n("td"),de=n("code"),pe=s("input_ids"),De=s(", "),je=n("code"),Te=s("attention_mask"),Ne=s(", "),ke=n("code"),Ae=s("token_type_ids"),Oe=s(", "),Ze=n("code"),Ps=s("labels"),Ss=s(", "),mt=n("code"),ft=s("numeric_values"),ca=s(", "),gt=n("code"),_t=s("numeric_values_scale"),Ds=s(", "),tt=n("code"),Ns=s("float_answer"),Os=c(),Ke=n("tr"),Pe=n("td"),Ls=s("Strong supervision for aggregation"),kt=c(),ye=n("td"),yt=n("code"),qt=s("input ids"),Qs=s(", "),jt=n("code"),$t=s("attention mask"),Is=s(", "),Et=n("code"),cs=s("token type ids"),Gt=s(", "),Ft=n("code"),hs=s("labels"),Ye=s(", "),$e=n("code"),Ws=s("aggregation_labels"),At=c(),ae=n("p"),nt=n("a"),Vt=s("TapasTokenizer"),Hs=s(" creates the "),xt=n("code"),Jt=s("labels"),Us=s(", "),zt=n("code"),Ct=s("numeric_values"),Bs=s(" and "),Mt=n("code"),Xt=s("numeric_values_scale"),Rs=s(" based on the "),Pt=n("code"),Zt=s("answer_coordinates"),Gs=s(" and "),St=n("code"),Vs=s("answer_text"),Le=s(" columns of the TSV file. The "),Dt=n("code"),es=s("float_answer"),Ks=s(" and "),Nt=n("code"),ts=s("aggregation_labels"),Ys=s(" are already in the TSV file of step 2. Here\u2019s an example:"),ss=c(),y(Ue.$$.fragment),as=c(),Ee=n("p"),ns=s("Note that "),ot=n("a"),Js=s("TapasTokenizer"),Ot=s(" expects the data of the table to be "),Lt=n("strong"),Xs=s("text-only"),Zs=s(". You can use "),Be=n("code"),ea=s(".astype(str)"),os=s(` on a dataframe to turn it into text-only data.
Of course, this only shows how to encode a single training example. It is advised to create a dataloader to iterate over batches:`),rs=c(),y(et.$$.fragment),this.h()},l(z){l=o(z,"P",{});var J=r(l);b=a(J,"Third, given that you\u2019ve prepared your data in this TSV/CSV format (and corresponding CSV files containing the tabular data), you can then use "),d=o(J,"A",{href:!0});var ya=r(d);u=a(ya,"TapasTokenizer"),ya.forEach(t),T=a(J," to convert table-question pairs into "),p=o(J,"CODE",{});var ta=r(p);g=a(ta,"input_ids"),ta.forEach(t),A=a(J,", "),k=o(J,"CODE",{});var qa=r(k);N=a(qa,"attention_mask"),qa.forEach(t),x=a(J,", "),U=o(J,"CODE",{});var ha=r(U);G=a(ha,"token_type_ids"),ha.forEach(t),V=a(J," and so on. Again, based on which of the three cases you picked above, "),B=o(J,"A",{href:!0});var It=r(B);K=a(It,"TapasForQuestionAnswering"),It.forEach(t),re=a(J,` requires different
inputs to be fine-tuned:`),J.forEach(t),W=h(z),L=o(z,"TABLE",{});var st=r(L);w=o(st,"THEAD",{});var sa=r(w);M=o(sa,"TR",{});var rt=r(M);R=o(rt,"TH",{});var ja=r(R);C=o(ja,"STRONG",{});var aa=r(C);O=a(aa,"Task"),aa.forEach(t),ja.forEach(t),ee=h(rt),te=o(rt,"TH",{});var $a=r(te);ce=o($a,"STRONG",{});var ua=r(ce);ne=a(ua,"Required inputs"),ua.forEach(t),$a.forEach(t),rt.forEach(t),sa.forEach(t),se=h(st),S=o(st,"TBODY",{});var Ie=r(S);Q=o(Ie,"TR",{});var is=r(Q);H=o(is,"TD",{});var us=r(H);X=a(us,"Conversational"),us.forEach(t),I=h(is),Y=o(is,"TD",{});var Re=r(Y);ge=o(Re,"CODE",{});var Ea=r(ge);ue=a(Ea,"input_ids"),Ea.forEach(t),_e=a(Re,", "),me=o(Re,"CODE",{});var ma=r(me);oe=a(ma,"attention_mask"),ma.forEach(t),qe=a(Re,", "),ie=o(Re,"CODE",{});var ms=r(ie);ve=a(ms,"token_type_ids"),ms.forEach(t),v=a(Re,", "),D=o(Re,"CODE",{});var na=r(D);be=a(na,"labels"),na.forEach(t),Re.forEach(t),is.forEach(t),xe=h(Ie),we=o(Ie,"TR",{});var ls=r(we);le=o(ls,"TD",{});var fa=r(le);ze=a(fa,"Weak supervision for aggregation"),fa.forEach(t),Me=h(ls),Z=o(ls,"TD",{});var fe=r(Z);de=o(fe,"CODE",{});var Fa=r(de);pe=a(Fa,"input_ids"),Fa.forEach(t),De=a(fe,", "),je=o(fe,"CODE",{});var fs=r(je);Te=a(fs,"attention_mask"),fs.forEach(t),Ne=a(fe,", "),ke=o(fe,"CODE",{});var Aa=r(ke);Ae=a(Aa,"token_type_ids"),Aa.forEach(t),Oe=a(fe,", "),Ze=o(fe,"CODE",{});var xa=r(Ze);Ps=a(xa,"labels"),xa.forEach(t),Ss=a(fe,", "),mt=o(fe,"CODE",{});var ga=r(mt);ft=a(ga,"numeric_values"),ga.forEach(t),ca=a(fe,", "),gt=o(fe,"CODE",{});var Tt=r(gt);_t=a(Tt,"numeric_values_scale"),Tt.forEach(t),Ds=a(fe,", "),tt=o(fe,"CODE",{});var oa=r(tt);Ns=a(oa,"float_answer"),oa.forEach(t),fe.forEach(t),ls.forEach(t),Os=h(Ie),Ke=o(Ie,"TR",{});var ds=r(Ke);Pe=o(ds,"TD",{});var za=r(Pe);Ls=a(za,"Strong supervision for aggregation"),za.forEach(t),kt=h(ds),ye=o(ds,"TD",{});var Fe=r(ye);yt=o(Fe,"CODE",{});var Ca=r(yt);qt=a(Ca,"input ids"),Ca.forEach(t),Qs=a(Fe,", "),jt=o(Fe,"CODE",{});var ra=r(jt);$t=a(ra,"attention mask"),ra.forEach(t),Is=a(Fe,", "),Et=o(Fe,"CODE",{});var Ma=r(Et);cs=a(Ma,"token type ids"),Ma.forEach(t),Gt=a(Fe,", "),Ft=o(Fe,"CODE",{});var Pa=r(Ft);hs=a(Pa,"labels"),Pa.forEach(t),Ye=a(Fe,", "),$e=o(Fe,"CODE",{});var Sa=r($e);Ws=a(Sa,"aggregation_labels"),Sa.forEach(t),Fe.forEach(t),ds.forEach(t),Ie.forEach(t),st.forEach(t),At=h(z),ae=o(z,"P",{});var he=r(ae);nt=o(he,"A",{href:!0});var Da=r(nt);Vt=a(Da,"TapasTokenizer"),Da.forEach(t),Hs=a(he," creates the "),xt=o(he,"CODE",{});var ia=r(xt);Jt=a(ia,"labels"),ia.forEach(t),Us=a(he,", "),zt=o(he,"CODE",{});var Na=r(zt);Ct=a(Na,"numeric_values"),Na.forEach(t),Bs=a(he," and "),Mt=o(he,"CODE",{});var Oa=r(Mt);Xt=a(Oa,"numeric_values_scale"),Oa.forEach(t),Rs=a(he," based on the "),Pt=o(he,"CODE",{});var _a=r(Pt);Zt=a(_a,"answer_coordinates"),_a.forEach(t),Gs=a(he," and "),St=o(he,"CODE",{});var gs=r(St);Vs=a(gs,"answer_text"),gs.forEach(t),Le=a(he," columns of the TSV file. The "),Dt=o(he,"CODE",{});var La=r(Dt);es=a(La,"float_answer"),La.forEach(t),Ks=a(he," and "),Nt=o(he,"CODE",{});var Ta=r(Nt);ts=a(Ta,"aggregation_labels"),Ta.forEach(t),Ys=a(he," are already in the TSV file of step 2. Here\u2019s an example:"),he.forEach(t),ss=h(z),q(Ue.$$.fragment,z),as=h(z),Ee=o(z,"P",{});var Ce=r(Ee);ns=a(Ce,"Note that "),ot=o(Ce,"A",{href:!0});var la=r(ot);Js=a(la,"TapasTokenizer"),la.forEach(t),Ot=a(Ce," expects the data of the table to be "),Lt=o(Ce,"STRONG",{});var Wt=r(Lt);Xs=a(Wt,"text-only"),Wt.forEach(t),Zs=a(Ce,". You can use "),Be=o(Ce,"CODE",{});var da=r(Be);ea=a(da,".astype(str)"),da.forEach(t),os=a(Ce,` on a dataframe to turn it into text-only data.
Of course, this only shows how to encode a single training example. It is advised to create a dataloader to iterate over batches:`),Ce.forEach(t),rs=h(z),q(et.$$.fragment,z),this.h()},h(){f(d,"href","/docs/transformers/main/en/model_doc/tapas#transformers.TapasTokenizer"),f(B,"href","/docs/transformers/main/en/model_doc/tapas#transformers.TapasForQuestionAnswering"),f(nt,"href","/docs/transformers/main/en/model_doc/tapas#transformers.TapasTokenizer"),f(ot,"href","/docs/transformers/main/en/model_doc/tapas#transformers.TapasTokenizer")},m(z,J){m(z,l,J),e(l,b),e(l,d),e(d,u),e(l,T),e(l,p),e(p,g),e(l,A),e(l,k),e(k,N),e(l,x),e(l,U),e(U,G),e(l,V),e(l,B),e(B,K),e(l,re),m(z,W,J),m(z,L,J),e(L,w),e(w,M),e(M,R),e(R,C),e(C,O),e(M,ee),e(M,te),e(te,ce),e(ce,ne),e(L,se),e(L,S),e(S,Q),e(Q,H),e(H,X),e(Q,I),e(Q,Y),e(Y,ge),e(ge,ue),e(Y,_e),e(Y,me),e(me,oe),e(Y,qe),e(Y,ie),e(ie,ve),e(Y,v),e(Y,D),e(D,be),e(S,xe),e(S,we),e(we,le),e(le,ze),e(we,Me),e(we,Z),e(Z,de),e(de,pe),e(Z,De),e(Z,je),e(je,Te),e(Z,Ne),e(Z,ke),e(ke,Ae),e(Z,Oe),e(Z,Ze),e(Ze,Ps),e(Z,Ss),e(Z,mt),e(mt,ft),e(Z,ca),e(Z,gt),e(gt,_t),e(Z,Ds),e(Z,tt),e(tt,Ns),e(S,Os),e(S,Ke),e(Ke,Pe),e(Pe,Ls),e(Ke,kt),e(Ke,ye),e(ye,yt),e(yt,qt),e(ye,Qs),e(ye,jt),e(jt,$t),e(ye,Is),e(ye,Et),e(Et,cs),e(ye,Gt),e(ye,Ft),e(Ft,hs),e(ye,Ye),e(ye,$e),e($e,Ws),m(z,At,J),m(z,ae,J),e(ae,nt),e(nt,Vt),e(ae,Hs),e(ae,xt),e(xt,Jt),e(ae,Us),e(ae,zt),e(zt,Ct),e(ae,Bs),e(ae,Mt),e(Mt,Xt),e(ae,Rs),e(ae,Pt),e(Pt,Zt),e(ae,Gs),e(ae,St),e(St,Vs),e(ae,Le),e(ae,Dt),e(Dt,es),e(ae,Ks),e(ae,Nt),e(Nt,ts),e(ae,Ys),m(z,ss,J),j(Ue,z,J),m(z,as,J),m(z,Ee,J),e(Ee,ns),e(Ee,ot),e(ot,Js),e(Ee,Ot),e(Ee,Lt),e(Lt,Xs),e(Ee,Zs),e(Ee,Be),e(Be,ea),e(Ee,os),m(z,rs,J),j(et,z,J),Qt=!0},p:ut,i(z){Qt||($(Ue.$$.fragment,z),$(et.$$.fragment,z),Qt=!0)},o(z){E(Ue.$$.fragment,z),E(et.$$.fragment,z),Qt=!1},d(z){z&&t(l),z&&t(W),z&&t(L),z&&t(At),z&&t(ae),z&&t(ss),F(Ue,z),z&&t(as),z&&t(Ee),z&&t(rs),F(et,z)}}}function qk(P){let l,b;return l=new To({props:{$$slots:{default:[yk]},$$scope:{ctx:P}}}),{c(){y(l.$$.fragment)},l(d){q(l.$$.fragment,d)},m(d,u){j(l,d,u),b=!0},p(d,u){const T={};u&2&&(T.$$scope={dirty:u,ctx:d}),l.$set(T)},i(d){b||($(l.$$.fragment,d),b=!0)},o(d){E(l.$$.fragment,d),b=!1},d(d){F(l,d)}}}function jk(P){let l,b,d,u,T,p,g,A,k,N,x,U,G,V,B,K,re,W,L,w,M,R,C,O,ee,te,ce,ne,se,S,Q,H,X,I,Y,ge,ue,_e,me,oe,qe,ie,ve,v,D,be,xe,we,le,ze,Me,Z,de,pe,De,je,Te,Ne,ke,Ae,Oe,Ze,Ps,Ss,mt,ft,ca,gt,_t,Ds,tt,Ns,Os,Ke,Pe,Ls,kt,ye,yt,qt,Qs,jt,$t,Is,Et,cs,Gt,Ft,hs,Ye,$e,Ws,At,ae,nt,Vt,Hs,xt,Jt,Us,zt,Ct,Bs,Mt,Xt,Rs,Pt,Zt,Gs,St,Vs,Le,Dt,es,Ks,Nt,ts,Ys,ss,Ue,as,Ee,ns,ot,Js,Ot,Lt,Xs,Zs,Be,ea,os,rs,et,Qt;return Ue=new Ve({props:{code:`from transformers import TapasTokenizer
import pandas as pd
...
<span class="hljs-meta">... </span>    tf.TensorSpec(shape=(<span class="hljs-number">512</span>,), dtype=tf.float32),
<span class="hljs-meta">... </span>)
<span class="hljs-meta">&gt;&gt;&gt; </span>train_dataloader = tf.data.Dataset.from_generator(train_dataset, output_signature=output_signature).batch(<span class="hljs-number">32</span>)`}}),{c(){l=n("p"),b=s("Third, given that you\u2019ve prepared your data in this TSV/CSV format (and corresponding CSV files containing the tabular data), you can then use "),d=n("a"),u=s("TapasTokenizer"),T=s(" to convert table-question pairs into "),p=n("code"),g=s("input_ids"),A=s(", "),k=n("code"),N=s("attention_mask"),x=s(", "),U=n("code"),G=s("token_type_ids"),V=s(" and so on. Again, based on which of the three cases you picked above, "),B=n("a"),K=s("TFTapasForQuestionAnswering"),re=s(` requires different
inputs to be fine-tuned:`),W=c(),L=n("table"),w=n("thead"),M=n("tr"),R=n("th"),C=n("strong"),O=s("Task"),ee=c(),te=n("th"),ce=n("strong"),ne=s("Required inputs"),se=c(),S=n("tbody"),Q=n("tr"),H=n("td"),X=s("Conversational"),I=c(),Y=n("td"),ge=n("code"),ue=s("input_ids"),_e=s(", "),me=n("code"),oe=s("attention_mask"),qe=s(", "),ie=n("code"),ve=s("token_type_ids"),v=s(", "),D=n("code"),be=s("labels"),xe=c(),we=n("tr"),le=n("td"),ze=s("Weak supervision for aggregation"),Me=c(),Z=n("td"),de=n("code"),pe=s("input_ids"),De=s(", "),je=n("code"),Te=s("attention_mask"),Ne=s(", "),ke=n("code"),Ae=s("token_type_ids"),Oe=s(", "),Ze=n("code"),Ps=s("labels"),Ss=s(", "),mt=n("code"),ft=s("numeric_values"),ca=s(", "),gt=n("code"),_t=s("numeric_values_scale"),Ds=s(", "),tt=n("code"),Ns=s("float_answer"),Os=c(),Ke=n("tr"),Pe=n("td"),Ls=s("Strong supervision for aggregation"),kt=c(),ye=n("td"),yt=n("code"),qt=s("input ids"),Qs=s(", "),jt=n("code"),$t=s("attention mask"),Is=s(", "),Et=n("code"),cs=s("token type ids"),Gt=s(", "),Ft=n("code"),hs=s("labels"),Ye=s(", "),$e=n("code"),Ws=s("aggregation_labels"),At=c(),ae=n("p"),nt=n("a"),Vt=s("TapasTokenizer"),Hs=s(" creates the "),xt=n("code"),Jt=s("labels"),Us=s(", "),zt=n("code"),Ct=s("numeric_values"),Bs=s(" and "),Mt=n("code"),Xt=s("numeric_values_scale"),Rs=s(" based on the "),Pt=n("code"),Zt=s("answer_coordinates"),Gs=s(" and "),St=n("code"),Vs=s("answer_text"),Le=s(" columns of the TSV file. The "),Dt=n("code"),es=s("float_answer"),Ks=s(" and "),Nt=n("code"),ts=s("aggregation_labels"),Ys=s(" are already in the TSV file of step 2. Here\u2019s an example:"),ss=c(),y(Ue.$$.fragment),as=c(),Ee=n("p"),ns=s("Note that "),ot=n("a"),Js=s("TapasTokenizer"),Ot=s(" expects the data of the table to be "),Lt=n("strong"),Xs=s("text-only"),Zs=s(". You can use "),Be=n("code"),ea=s(".astype(str)"),os=s(` on a dataframe to turn it into text-only data.
Of course, this only shows how to encode a single training example. It is advised to create a dataloader to iterate over batches:`),rs=c(),y(et.$$.fragment),this.h()},l(z){l=o(z,"P",{});var J=r(l);b=a(J,"Third, given that you\u2019ve prepared your data in this TSV/CSV format (and corresponding CSV files containing the tabular data), you can then use "),d=o(J,"A",{href:!0});var ya=r(d);u=a(ya,"TapasTokenizer"),ya.forEach(t),T=a(J," to convert table-question pairs into "),p=o(J,"CODE",{});var ta=r(p);g=a(ta,"input_ids"),ta.forEach(t),A=a(J,", "),k=o(J,"CODE",{});var qa=r(k);N=a(qa,"attention_mask"),qa.forEach(t),x=a(J,", "),U=o(J,"CODE",{});var ha=r(U);G=a(ha,"token_type_ids"),ha.forEach(t),V=a(J," and so on. Again, based on which of the three cases you picked above, "),B=o(J,"A",{href:!0});var It=r(B);K=a(It,"TFTapasForQuestionAnswering"),It.forEach(t),re=a(J,` requires different
inputs to be fine-tuned:`),J.forEach(t),W=h(z),L=o(z,"TABLE",{});var st=r(L);w=o(st,"THEAD",{});var sa=r(w);M=o(sa,"TR",{});var rt=r(M);R=o(rt,"TH",{});var ja=r(R);C=o(ja,"STRONG",{});var aa=r(C);O=a(aa,"Task"),aa.forEach(t),ja.forEach(t),ee=h(rt),te=o(rt,"TH",{});var $a=r(te);ce=o($a,"STRONG",{});var ua=r(ce);ne=a(ua,"Required inputs"),ua.forEach(t),$a.forEach(t),rt.forEach(t),sa.forEach(t),se=h(st),S=o(st,"TBODY",{});var Ie=r(S);Q=o(Ie,"TR",{});var is=r(Q);H=o(is,"TD",{});var us=r(H);X=a(us,"Conversational"),us.forEach(t),I=h(is),Y=o(is,"TD",{});var Re=r(Y);ge=o(Re,"CODE",{});var Ea=r(ge);ue=a(Ea,"input_ids"),Ea.forEach(t),_e=a(Re,", "),me=o(Re,"CODE",{});var ma=r(me);oe=a(ma,"attention_mask"),ma.forEach(t),qe=a(Re,", "),ie=o(Re,"CODE",{});var ms=r(ie);ve=a(ms,"token_type_ids"),ms.forEach(t),v=a(Re,", "),D=o(Re,"CODE",{});var na=r(D);be=a(na,"labels"),na.forEach(t),Re.forEach(t),is.forEach(t),xe=h(Ie),we=o(Ie,"TR",{});var ls=r(we);le=o(ls,"TD",{});var fa=r(le);ze=a(fa,"Weak supervision for aggregation"),fa.forEach(t),Me=h(ls),Z=o(ls,"TD",{});var fe=r(Z);de=o(fe,"CODE",{});var Fa=r(de);pe=a(Fa,"input_ids"),Fa.forEach(t),De=a(fe,", "),je=o(fe,"CODE",{});var fs=r(je);Te=a(fs,"attention_mask"),fs.forEach(t),Ne=a(fe,", "),ke=o(fe,"CODE",{});var Aa=r(ke);Ae=a(Aa,"token_type_ids"),Aa.forEach(t),Oe=a(fe,", "),Ze=o(fe,"CODE",{});var xa=r(Ze);Ps=a(xa,"labels"),xa.forEach(t),Ss=a(fe,", "),mt=o(fe,"CODE",{});var ga=r(mt);ft=a(ga,"numeric_values"),ga.forEach(t),ca=a(fe,", "),gt=o(fe,"CODE",{});var Tt=r(gt);_t=a(Tt,"numeric_values_scale"),Tt.forEach(t),Ds=a(fe,", "),tt=o(fe,"CODE",{});var oa=r(tt);Ns=a(oa,"float_answer"),oa.forEach(t),fe.forEach(t),ls.forEach(t),Os=h(Ie),Ke=o(Ie,"TR",{});var ds=r(Ke);Pe=o(ds,"TD",{});var za=r(Pe);Ls=a(za,"Strong supervision for aggregation"),za.forEach(t),kt=h(ds),ye=o(ds,"TD",{});var Fe=r(ye);yt=o(Fe,"CODE",{});var Ca=r(yt);qt=a(Ca,"input ids"),Ca.forEach(t),Qs=a(Fe,", "),jt=o(Fe,"CODE",{});var ra=r(jt);$t=a(ra,"attention mask"),ra.forEach(t),Is=a(Fe,", "),Et=o(Fe,"CODE",{});var Ma=r(Et);cs=a(Ma,"token type ids"),Ma.forEach(t),Gt=a(Fe,", "),Ft=o(Fe,"CODE",{});var Pa=r(Ft);hs=a(Pa,"labels"),Pa.forEach(t),Ye=a(Fe,", "),$e=o(Fe,"CODE",{});var Sa=r($e);Ws=a(Sa,"aggregation_labels"),Sa.forEach(t),Fe.forEach(t),ds.forEach(t),Ie.forEach(t),st.forEach(t),At=h(z),ae=o(z,"P",{});var he=r(ae);nt=o(he,"A",{href:!0});var Da=r(nt);Vt=a(Da,"TapasTokenizer"),Da.forEach(t),Hs=a(he," creates the "),xt=o(he,"CODE",{});var ia=r(xt);Jt=a(ia,"labels"),ia.forEach(t),Us=a(he,", "),zt=o(he,"CODE",{});var Na=r(zt);Ct=a(Na,"numeric_values"),Na.forEach(t),Bs=a(he," and "),Mt=o(he,"CODE",{});var Oa=r(Mt);Xt=a(Oa,"numeric_values_scale"),Oa.forEach(t),Rs=a(he," based on the "),Pt=o(he,"CODE",{});var _a=r(Pt);Zt=a(_a,"answer_coordinates"),_a.forEach(t),Gs=a(he," and "),St=o(he,"CODE",{});var gs=r(St);Vs=a(gs,"answer_text"),gs.forEach(t),Le=a(he," columns of the TSV file. The "),Dt=o(he,"CODE",{});var La=r(Dt);es=a(La,"float_answer"),La.forEach(t),Ks=a(he," and "),Nt=o(he,"CODE",{});var Ta=r(Nt);ts=a(Ta,"aggregation_labels"),Ta.forEach(t),Ys=a(he," are already in the TSV file of step 2. Here\u2019s an example:"),he.forEach(t),ss=h(z),q(Ue.$$.fragment,z),as=h(z),Ee=o(z,"P",{});var Ce=r(Ee);ns=a(Ce,"Note that "),ot=o(Ce,"A",{href:!0});var la=r(ot);Js=a(la,"TapasTokenizer"),la.forEach(t),Ot=a(Ce," expects the data of the table to be "),Lt=o(Ce,"STRONG",{});var Wt=r(Lt);Xs=a(Wt,"text-only"),Wt.forEach(t),Zs=a(Ce,". You can use "),Be=o(Ce,"CODE",{});var da=r(Be);ea=a(da,".astype(str)"),da.forEach(t),os=a(Ce,` on a dataframe to turn it into text-only data.
Of course, this only shows how to encode a single training example. It is advised to create a dataloader to iterate over batches:`),Ce.forEach(t),rs=h(z),q(et.$$.fragment,z),this.h()},h(){f(d,"href","/docs/transformers/main/en/model_doc/tapas#transformers.TapasTokenizer"),f(B,"href","/docs/transformers/main/en/model_doc/tapas#transformers.TFTapasForQuestionAnswering"),f(nt,"href","/docs/transformers/main/en/model_doc/tapas#transformers.TapasTokenizer"),f(ot,"href","/docs/transformers/main/en/model_doc/tapas#transformers.TapasTokenizer")},m(z,J){m(z,l,J),e(l,b),e(l,d),e(d,u),e(l,T),e(l,p),e(p,g),e(l,A),e(l,k),e(k,N),e(l,x),e(l,U),e(U,G),e(l,V),e(l,B),e(B,K),e(l,re),m(z,W,J),m(z,L,J),e(L,w),e(w,M),e(M,R),e(R,C),e(C,O),e(M,ee),e(M,te),e(te,ce),e(ce,ne),e(L,se),e(L,S),e(S,Q),e(Q,H),e(H,X),e(Q,I),e(Q,Y),e(Y,ge),e(ge,ue),e(Y,_e),e(Y,me),e(me,oe),e(Y,qe),e(Y,ie),e(ie,ve),e(Y,v),e(Y,D),e(D,be),e(S,xe),e(S,we),e(we,le),e(le,ze),e(we,Me),e(we,Z),e(Z,de),e(de,pe),e(Z,De),e(Z,je),e(je,Te),e(Z,Ne),e(Z,ke),e(ke,Ae),e(Z,Oe),e(Z,Ze),e(Ze,Ps),e(Z,Ss),e(Z,mt),e(mt,ft),e(Z,ca),e(Z,gt),e(gt,_t),e(Z,Ds),e(Z,tt),e(tt,Ns),e(S,Os),e(S,Ke),e(Ke,Pe),e(Pe,Ls),e(Ke,kt),e(Ke,ye),e(ye,yt),e(yt,qt),e(ye,Qs),e(ye,jt),e(jt,$t),e(ye,Is),e(ye,Et),e(Et,cs),e(ye,Gt),e(ye,Ft),e(Ft,hs),e(ye,Ye),e(ye,$e),e($e,Ws),m(z,At,J),m(z,ae,J),e(ae,nt),e(nt,Vt),e(ae,Hs),e(ae,xt),e(xt,Jt),e(ae,Us),e(ae,zt),e(zt,Ct),e(ae,Bs),e(ae,Mt),e(Mt,Xt),e(ae,Rs),e(ae,Pt),e(Pt,Zt),e(ae,Gs),e(ae,St),e(St,Vs),e(ae,Le),e(ae,Dt),e(Dt,es),e(ae,Ks),e(ae,Nt),e(Nt,ts),e(ae,Ys),m(z,ss,J),j(Ue,z,J),m(z,as,J),m(z,Ee,J),e(Ee,ns),e(Ee,ot),e(ot,Js),e(Ee,Ot),e(Ee,Lt),e(Lt,Xs),e(Ee,Zs),e(Ee,Be),e(Be,ea),e(Ee,os),m(z,rs,J),j(et,z,J),Qt=!0},p:ut,i(z){Qt||($(Ue.$$.fragment,z),$(et.$$.fragment,z),Qt=!0)},o(z){E(Ue.$$.fragment,z),E(et.$$.fragment,z),Qt=!1},d(z){z&&t(l),z&&t(W),z&&t(L),z&&t(At),z&&t(ae),z&&t(ss),F(Ue,z),z&&t(as),z&&t(Ee),z&&t(rs),F(et,z)}}}function $k(P){let l,b;return l=new To({props:{$$slots:{default:[jk]},$$scope:{ctx:P}}}),{c(){y(l.$$.fragment)},l(d){q(l.$$.fragment,d)},m(d,u){j(l,d,u),b=!0},p(d,u){const T={};u&2&&(T.$$scope={dirty:u,ctx:d}),l.$set(T)},i(d){b||($(l.$$.fragment,d),b=!0)},o(d){E(l.$$.fragment,d),b=!1},d(d){F(l,d)}}}function Ek(P){let l,b,d,u,T,p,g,A;return g=new Ve({props:{code:`from transformers import TapasConfig, TapasForQuestionAnswering, AdamW
...
<span class="hljs-meta">... </span>        optimizer.step()`}}),{c(){l=n("p"),b=s("You can then fine-tune "),d=n("a"),u=s("TapasForQuestionAnswering"),T=s(" as follows (shown here for the weak supervision for aggregation case):"),p=c(),y(g.$$.fragment),this.h()},l(k){l=o(k,"P",{});var N=r(l);b=a(N,"You can then fine-tune "),d=o(N,"A",{href:!0});var x=r(d);u=a(x,"TapasForQuestionAnswering"),x.forEach(t),T=a(N," as follows (shown here for the weak supervision for aggregation case):"),N.forEach(t),p=h(k),q(g.$$.fragment,k),this.h()},h(){f(d,"href","/docs/transformers/main/en/model_doc/tapas#transformers.TapasForQuestionAnswering")},m(k,N){m(k,l,N),e(l,b),e(l,d),e(d,u),e(l,T),m(k,p,N),j(g,k,N),A=!0},p:ut,i(k){A||($(g.$$.fragment,k),A=!0)},o(k){E(g.$$.fragment,k),A=!1},d(k){k&&t(l),k&&t(p),F(g,k)}}}function Fk(P){let l,b;return l=new To({props:{$$slots:{default:[Ek]},$$scope:{ctx:P}}}),{c(){y(l.$$.fragment)},l(d){q(l.$$.fragment,d)},m(d,u){j(l,d,u),b=!0},p(d,u){const T={};u&2&&(T.$$scope={dirty:u,ctx:d}),l.$set(T)},i(d){b||($(l.$$.fragment,d),b=!0)},o(d){E(l.$$.fragment,d),b=!1},d(d){F(l,d)}}}function Ak(P){let l,b,d,u,T,p,g,A;return g=new Ve({props:{code:`import tensorflow as tf
...
<span class="hljs-meta">... </span>        optimizer.apply_gradients(<span class="hljs-built_in">zip</span>(grads, model.trainable_weights))`}}),{c(){l=n("p"),b=s("You can then fine-tune "),d=n("a"),u=s("TFTapasForQuestionAnswering"),T=s(" as follows (shown here for the weak supervision for aggregation case):"),p=c(),y(g.$$.fragment),this.h()},l(k){l=o(k,"P",{});var N=r(l);b=a(N,"You can then fine-tune "),d=o(N,"A",{href:!0});var x=r(d);u=a(x,"TFTapasForQuestionAnswering"),x.forEach(t),T=a(N," as follows (shown here for the weak supervision for aggregation case):"),N.forEach(t),p=h(k),q(g.$$.fragment,k),this.h()},h(){f(d,"href","/docs/transformers/main/en/model_doc/tapas#transformers.TFTapasForQuestionAnswering")},m(k,N){m(k,l,N),e(l,b),e(l,d),e(d,u),e(l,T),m(k,p,N),j(g,k,N),A=!0},p:ut,i(k){A||($(g.$$.fragment,k),A=!0)},o(k){E(g.$$.fragment,k),A=!1},d(k){k&&t(l),k&&t(p),F(g,k)}}}function xk(P){let l,b;return l=new To({props:{$$slots:{default:[Ak]},$$scope:{ctx:P}}}),{c(){y(l.$$.fragment)},l(d){q(l.$$.fragment,d)},m(d,u){j(l,d,u),b=!0},p(d,u){const T={};u&2&&(T.$$scope={dirty:u,ctx:d}),l.$set(T)},i(d){b||($(l.$$.fragment,d),b=!0)},o(d){E(l.$$.fragment,d),b=!1},d(d){F(l,d)}}}function zk(P){let l,b,d,u,T,p,g,A,k,N,x,U,G,V,B,K,re,W,L,w,M,R,C,O,ee,te,ce,ne,se,S,Q,H;return Q=new Ve({props:{code:`from transformers import TapasTokenizer, TapasForQuestionAnswering
import pandas as pd
...
Predicted answer: SUM &gt; <span class="hljs-number">87</span>, <span class="hljs-number">53</span>, <span class="hljs-number">69</span>`}}),{c(){l=n("p"),b=s("Here we explain how you can use "),d=n("a"),u=s("TapasForQuestionAnswering"),T=s(" or "),p=n("a"),g=s("TFTapasForQuestionAnswering"),A=s(" for inference (i.e. making predictions on new data). For inference, only "),k=n("code"),N=s("input_ids"),x=s(", "),U=n("code"),G=s("attention_mask"),V=s(" and "),B=n("code"),K=s("token_type_ids"),re=s(" (which you can obtain using "),W=n("a"),L=s("TapasTokenizer"),w=s(") have to be provided to the model to obtain the logits. Next, you can use the handy "),M=n("code"),R=s("convert_logits_to_predictions"),C=s(" method to convert these into predicted coordinates and optional aggregation indices."),O=c(),ee=n("p"),te=s("However, note that inference is "),ce=n("strong"),ne=s("different"),se=s(" depending on whether or not the setup is conversational. In a non-conversational set-up, inference can be done in parallel on all table-question pairs of a batch. Here\u2019s an example of that:"),S=c(),y(Q.$$.fragment),this.h()},l(X){l=o(X,"P",{});var I=r(l);b=a(I,"Here we explain how you can use "),d=o(I,"A",{href:!0});var Y=r(d);u=a(Y,"TapasForQuestionAnswering"),Y.forEach(t),T=a(I," or "),p=o(I,"A",{href:!0});var ge=r(p);g=a(ge,"TFTapasForQuestionAnswering"),ge.forEach(t),A=a(I," for inference (i.e. making predictions on new data). For inference, only "),k=o(I,"CODE",{});var ue=r(k);N=a(ue,"input_ids"),ue.forEach(t),x=a(I,", "),U=o(I,"CODE",{});var _e=r(U);G=a(_e,"attention_mask"),_e.forEach(t),V=a(I," and "),B=o(I,"CODE",{});var me=r(B);K=a(me,"token_type_ids"),me.forEach(t),re=a(I," (which you can obtain using "),W=o(I,"A",{href:!0});var oe=r(W);L=a(oe,"TapasTokenizer"),oe.forEach(t),w=a(I,") have to be provided to the model to obtain the logits. Next, you can use the handy "),M=o(I,"CODE",{});var qe=r(M);R=a(qe,"convert_logits_to_predictions"),qe.forEach(t),C=a(I," method to convert these into predicted coordinates and optional aggregation indices."),I.forEach(t),O=h(X),ee=o(X,"P",{});var ie=r(ee);te=a(ie,"However, note that inference is "),ce=o(ie,"STRONG",{});var ve=r(ce);ne=a(ve,"different"),ve.forEach(t),se=a(ie," depending on whether or not the setup is conversational. In a non-conversational set-up, inference can be done in parallel on all table-question pairs of a batch. Here\u2019s an example of that:"),ie.forEach(t),S=h(X),q(Q.$$.fragment,X),this.h()},h(){f(d,"href","/docs/transformers/main/en/model_doc/tapas#transformers.TapasForQuestionAnswering"),f(p,"href","/docs/transformers/main/en/model_doc/tapas#transformers.TFTapasForQuestionAnswering"),f(W,"href","/docs/transformers/main/en/model_doc/tapas#transformers.TapasTokenizer")},m(X,I){m(X,l,I),e(l,b),e(l,d),e(d,u),e(l,T),e(l,p),e(p,g),e(l,A),e(l,k),e(k,N),e(l,x),e(l,U),e(U,G),e(l,V),e(l,B),e(B,K),e(l,re),e(l,W),e(W,L),e(l,w),e(l,M),e(M,R),e(l,C),m(X,O,I),m(X,ee,I),e(ee,te),e(ee,ce),e(ce,ne),e(ee,se),m(X,S,I),j(Q,X,I),H=!0},p:ut,i(X){H||($(Q.$$.fragment,X),H=!0)},o(X){E(Q.$$.fragment,X),H=!1},d(X){X&&t(l),X&&t(O),X&&t(ee),X&&t(S),F(Q,X)}}}function Ck(P){let l,b;return l=new To({props:{$$slots:{default:[zk]},$$scope:{ctx:P}}}),{c(){y(l.$$.fragment)},l(d){q(l.$$.fragment,d)},m(d,u){j(l,d,u),b=!0},p(d,u){const T={};u&2&&(T.$$scope={dirty:u,ctx:d}),l.$set(T)},i(d){b||($(l.$$.fragment,d),b=!0)},o(d){E(l.$$.fragment,d),b=!1},d(d){F(l,d)}}}function Mk(P){let l,b,d,u,T,p,g,A,k,N,x,U,G,V,B,K,re,W,L,w,M,R,C,O,ee,te,ce,ne,se;return ne=new Ve({props:{code:`from transformers import TapasTokenizer, TFTapasForQuestionAnswering
import pandas as pd
...
Predicted answer: COUNT &gt; <span class="hljs-number">69</span>
What <span class="hljs-keyword">is</span> the total number of movies?
Predicted answer: SUM &gt; <span class="hljs-number">87</span>, <span class="hljs-number">53</span>, <span class="hljs-number">69</span>`}}),{c(){l=n("p"),b=s("Here we explain how you can use "),d=n("a"),u=s("TFTapasForQuestionAnswering"),T=s(" for inference (i.e. making predictions on new data). For inference, only "),p=n("code"),g=s("input_ids"),A=s(", "),k=n("code"),N=s("attention_mask"),x=s(" and "),U=n("code"),G=s("token_type_ids"),V=s(" (which you can obtain using "),B=n("a"),K=s("TapasTokenizer"),re=s(") have to be provided to the model to obtain the logits. Next, you can use the handy "),W=n("code"),L=s("convert_logits_to_predictions"),w=s(" method to convert these into predicted coordinates and optional aggregation indices."),M=c(),R=n("p"),C=s("However, note that inference is "),O=n("strong"),ee=s("different"),te=s(" depending on whether or not the setup is conversational. In a non-conversational set-up, inference can be done in parallel on all table-question pairs of a batch. Here\u2019s an example of that:"),ce=c(),y(ne.$$.fragment),this.h()},l(S){l=o(S,"P",{});var Q=r(l);b=a(Q,"Here we explain how you can use "),d=o(Q,"A",{href:!0});var H=r(d);u=a(H,"TFTapasForQuestionAnswering"),H.forEach(t),T=a(Q," for inference (i.e. making predictions on new data). For inference, only "),p=o(Q,"CODE",{});var X=r(p);g=a(X,"input_ids"),X.forEach(t),A=a(Q,", "),k=o(Q,"CODE",{});var I=r(k);N=a(I,"attention_mask"),I.forEach(t),x=a(Q," and "),U=o(Q,"CODE",{});var Y=r(U);G=a(Y,"token_type_ids"),Y.forEach(t),V=a(Q," (which you can obtain using "),B=o(Q,"A",{href:!0});var ge=r(B);K=a(ge,"TapasTokenizer"),ge.forEach(t),re=a(Q,") have to be provided to the model to obtain the logits. Next, you can use the handy "),W=o(Q,"CODE",{});var ue=r(W);L=a(ue,"convert_logits_to_predictions"),ue.forEach(t),w=a(Q," method to convert these into predicted coordinates and optional aggregation indices."),Q.forEach(t),M=h(S),R=o(S,"P",{});var _e=r(R);C=a(_e,"However, note that inference is "),O=o(_e,"STRONG",{});var me=r(O);ee=a(me,"different"),me.forEach(t),te=a(_e," depending on whether or not the setup is conversational. In a non-conversational set-up, inference can be done in parallel on all table-question pairs of a batch. Here\u2019s an example of that:"),_e.forEach(t),ce=h(S),q(ne.$$.fragment,S),this.h()},h(){f(d,"href","/docs/transformers/main/en/model_doc/tapas#transformers.TFTapasForQuestionAnswering"),f(B,"href","/docs/transformers/main/en/model_doc/tapas#transformers.TapasTokenizer")},m(S,Q){m(S,l,Q),e(l,b),e(l,d),e(d,u),e(l,T),e(l,p),e(p,g),e(l,A),e(l,k),e(k,N),e(l,x),e(l,U),e(U,G),e(l,V),e(l,B),e(B,K),e(l,re),e(l,W),e(W,L),e(l,w),m(S,M,Q),m(S,R,Q),e(R,C),e(R,O),e(O,ee),e(R,te),m(S,ce,Q),j(ne,S,Q),se=!0},p:ut,i(S){se||($(ne.$$.fragment,S),se=!0)},o(S){E(ne.$$.fragment,S),se=!1},d(S){S&&t(l),S&&t(M),S&&t(R),S&&t(ce),F(ne,S)}}}function Pk(P){let l,b;return l=new To({props:{$$slots:{default:[Mk]},$$scope:{ctx:P}}}),{c(){y(l.$$.fragment)},l(d){q(l.$$.fragment,d)},m(d,u){j(l,d,u),b=!0},p(d,u){const T={};u&2&&(T.$$scope={dirty:u,ctx:d}),l.$set(T)},i(d){b||($(l.$$.fragment,d),b=!0)},o(d){E(l.$$.fragment,d),b=!1},d(d){F(l,d)}}}function Sk(P){let l,b,d,u,T;return u=new Ve({props:{code:`from transformers import TapasModel, TapasConfig
...
<span class="hljs-meta">&gt;&gt;&gt; </span>configuration = model.config`}}),{c(){l=n("p"),b=s("Example:"),d=c(),y(u.$$.fragment)},l(p){l=o(p,"P",{});var g=r(l);b=a(g,"Example:"),g.forEach(t),d=h(p),q(u.$$.fragment,p)},m(p,g){m(p,l,g),e(l,b),m(p,d,g),j(u,p,g),T=!0},p:ut,i(p){T||($(u.$$.fragment,p),T=!0)},o(p){E(u.$$.fragment,p),T=!1},d(p){p&&t(l),p&&t(d),F(u,p)}}}function Dk(P){let l,b,d,u,T;return{c(){l=n("p"),b=s("Although the recipe for forward pass needs to be defined within this function, one should call the "),d=n("code"),u=s("Module"),T=s(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(p){l=o(p,"P",{});var g=r(l);b=a(g,"Although the recipe for forward pass needs to be defined within this function, one should call the "),d=o(g,"CODE",{});var A=r(d);u=a(A,"Module"),A.forEach(t),T=a(g,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),{c(){l=n("p"),b=s("Examples:"),d=c(),y(u.$$.fragment)},l(p){l=o(p,"P",{});var g=r(l);b=a(g,"Examples:"),g.forEach(t),d=h(p),q(u.$$.fragment,p)},m(p,g){m(p,l,g),e(l,b),m(p,d,g),j(u,p,g),T=!0},p:ut,i(p){T||($(u.$$.fragment,p),T=!0)},o(p){E(u.$$.fragment,p),T=!1},d(p){p&&t(l),p&&t(d),F(u,p)}}}function Ok(P){let l,b,d,u,T;return{c(){l=n("p"),b=s("Although the recipe for forward pass needs to be defined within this function, one should call the "),d=n("code"),u=s("Module"),T=s(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(p){l=o(p,"P",{});var g=r(l);b=a(g,"Although the recipe for forward pass needs to be defined within this function, one should call the "),d=o(g,"CODE",{});var A=r(d);u=a(A,"Module"),A.forEach(t),T=a(g,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
<span class="hljs-meta">&gt;&gt;&gt; </span>logits = outputs.logits`}}),{c(){l=n("p"),b=s("Examples:"),d=c(),y(u.$$.fragment)},l(p){l=o(p,"P",{});var g=r(l);b=a(g,"Examples:"),g.forEach(t),d=h(p),q(u.$$.fragment,p)},m(p,g){m(p,l,g),e(l,b),m(p,d,g),j(u,p,g),T=!0},p:ut,i(p){T||($(u.$$.fragment,p),T=!0)},o(p){E(u.$$.fragment,p),T=!1},d(p){p&&t(l),p&&t(d),F(u,p)}}}function Qk(P){let l,b,d,u,T;return{c(){l=n("p"),b=s("Although the recipe for forward pass needs to be defined within this function, one should call the "),d=n("code"),u=s("Module"),T=s(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(p){l=o(p,"P",{});var g=r(l);b=a(g,"Although the recipe for forward pass needs to be defined within this function, one should call the "),d=o(g,"CODE",{});var A=r(d);u=a(A,"Module"),A.forEach(t),T=a(g,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
<span class="hljs-meta">&gt;&gt;&gt; </span>outputs = model(**inputs, labels=labels)
<span class="hljs-meta">&gt;&gt;&gt; </span>loss = outputs.loss
<span class="hljs-meta">&gt;&gt;&gt; </span>logits = outputs.logits`}}),{c(){l=n("p"),b=s("Examples:"),d=c(),y(u.$$.fragment)},l(p){l=o(p,"P",{});var g=r(l);b=a(g,"Examples:"),g.forEach(t),d=h(p),q(u.$$.fragment,p)},m(p,g){m(p,l,g),e(l,b),m(p,d,g),j(u,p,g),T=!0},p:ut,i(p){T||($(u.$$.fragment,p),T=!0)},o(p){E(u.$$.fragment,p),T=!1},d(p){p&&t(l),p&&t(d),F(u,p)}}}function Wk(P){let l,b,d,u,T;return{c(){l=n("p"),b=s("Although the recipe for forward pass needs to be defined within this function, one should call the "),d=n("code"),u=s("Module"),T=s(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(p){l=o(p,"P",{});var g=r(l);b=a(g,"Although the recipe for forward pass needs to be defined within this function, one should call the "),d=o(g,"CODE",{});var A=r(d);u=a(A,"Module"),A.forEach(t),T=a(g,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
<span class="hljs-meta">&gt;&gt;&gt; </span>logits_aggregation = outputs.logits_aggregation`}}),{c(){l=n("p"),b=s("Examples:"),d=c(),y(u.$$.fragment)},l(p){l=o(p,"P",{});var g=r(l);b=a(g,"Examples:"),g.forEach(t),d=h(p),q(u.$$.fragment,p)},m(p,g){m(p,l,g),e(l,b),m(p,d,g),j(u,p,g),T=!0},p:ut,i(p){T||($(u.$$.fragment,p),T=!0)},o(p){E(u.$$.fragment,p),T=!1},d(p){p&&t(l),p&&t(d),F(u,p)}}}function Uk(P){let l,b,d,u,T,p,g,A,k,N,x,U,G,V,B,K,re,W,L,w,M,R,C,O,ee,te,ce,ne,se,S,Q,H,X,I,Y,ge,ue,_e,me,oe,qe,ie,ve;return{c(){l=n("p"),b=s("TF 2.0 models accepts two formats as inputs:"),d=c(),u=n("ul"),T=n("li"),p=s("having all inputs as keyword arguments (like PyTorch models), or"),g=c(),A=n("li"),k=s("having all inputs as a list, tuple or dict in the first positional arguments."),N=c(),x=n("p"),U=s("This second option is useful when using "),G=n("code"),V=s("tf.keras.Model.fit"),B=s(` method which currently requires having all the
...
first positional argument :`),R=c(),C=n("ul"),O=n("li"),ee=s("a single Tensor with "),te=n("code"),ce=s("input_ids"),ne=s(" only and nothing else: "),se=n("code"),S=s("model(inputs_ids)"),Q=c(),H=n("li"),X=s(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),I=n("code"),Y=s("model([input_ids, attention_mask])"),ge=s(" or "),ue=n("code"),_e=s("model([input_ids, attention_mask, token_type_ids])"),me=c(),oe=n("li"),qe=s(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),ie=n("code"),ve=s('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(v){l=o(v,"P",{});var D=r(l);b=a(D,"TF 2.0 models accepts two formats as inputs:"),D.forEach(t),d=h(v),u=o(v,"UL",{});var be=r(u);T=o(be,"LI",{});var xe=r(T);p=a(xe,"having all inputs as keyword arguments (like PyTorch models), or"),xe.forEach(t),g=h(be),A=o(be,"LI",{});var we=r(A);k=a(we,"having all inputs as a list, tuple or dict in the first positional arguments."),we.forEach(t),be.forEach(t),N=h(v),x=o(v,"P",{});var le=r(x);U=a(le,"This second option is useful when using "),G=o(le,"CODE",{});var ze=r(G);V=a(ze,"tf.keras.Model.fit"),ze.forEach(t),B=a(le,` method which currently requires having all the
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),{c(){l=n("p"),b=s("Examples:"),d=c(),y(u.$$.fragment)},l(p){l=o(p,"P",{});var g=r(l);b=a(g,"Examples:"),g.forEach(t),d=h(p),q(u.$$.fragment,p)},m(p,g){m(p,l,g),e(l,b),m(p,d,g),j(u,p,g),T=!0},p:ut,i(p){T||($(u.$$.fragment,p),T=!0)},o(p){E(u.$$.fragment,p),T=!1},d(p){p&&t(l),p&&t(d),F(u,p)}}}function Gk(P){let l,b,d,u,T,p,g,A,k,N,x,U,G,V,B,K,re,W,L,w,M,R,C,O,ee,te,ce,ne,se,S,Q,H,X,I,Y,ge,ue,_e,me,oe,qe,ie,ve;return{c(){l=n("p"),b=s("TF 2.0 models accepts two formats as inputs:"),d=c(),u=n("ul"),T=n("li"),p=s("having all inputs as keyword arguments (like PyTorch models), or"),g=c(),A=n("li"),k=s("having all inputs as a list, tuple or dict in the first positional arguments."),N=c(),x=n("p"),U=s("This second option is useful when using "),G=n("code"),V=s("tf.keras.Model.fit"),B=s(` method which currently requires having all the
tensors in the first argument of the model call function: `),K=n("code"),re=s("model(inputs)"),W=s("."),L=c(),w=n("p"),M=s(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),R=c(),C=n("ul"),O=n("li"),ee=s("a single Tensor with "),te=n("code"),ce=s("input_ids"),ne=s(" only and nothing else: "),se=n("code"),S=s("model(inputs_ids)"),Q=c(),H=n("li"),X=s(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),I=n("code"),Y=s("model([input_ids, attention_mask])"),ge=s(" or "),ue=n("code"),_e=s("model([input_ids, attention_mask, token_type_ids])"),me=c(),oe=n("li"),qe=s(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),ie=n("code"),ve=s('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(v){l=o(v,"P",{});var D=r(l);b=a(D,"TF 2.0 models accepts two formats as inputs:"),D.forEach(t),d=h(v),u=o(v,"UL",{});var be=r(u);T=o(be,"LI",{});var xe=r(T);p=a(xe,"having all inputs as keyword arguments (like PyTorch models), or"),xe.forEach(t),g=h(be),A=o(be,"LI",{});var we=r(A);k=a(we,"having all inputs as a list, tuple or dict in the first positional arguments."),we.forEach(t),be.forEach(t),N=h(v),x=o(v,"P",{});var le=r(x);U=a(le,"This second option is useful when using "),G=o(le,"CODE",{});var ze=r(G);V=a(ze,"tf.keras.Model.fit"),ze.forEach(t),B=a(le,` method which currently requires having all the
...
first positional argument :`),Z.forEach(t),R=h(v),C=o(v,"UL",{});var de=r(C);O=o(de,"LI",{});var pe=r(O);ee=a(pe,"a single Tensor with "),te=o(pe,"CODE",{});var De=r(te);ce=a(De,"input_ids"),De.forEach(t),ne=a(pe," only and nothing else: "),se=o(pe,"CODE",{});var je=r(se);S=a(je,"model(inputs_ids)"),je.forEach(t),pe.forEach(t),Q=h(de),H=o(de,"LI",{});var Te=r(H);X=a(Te,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),I=o(Te,"CODE",{});var Ne=r(I);Y=a(Ne,"model([input_ids, attention_mask])"),Ne.forEach(t),ge=a(Te," or "),ue=o(Te,"CODE",{});var ke=r(ue);_e=a(ke,"model([input_ids, attention_mask, token_type_ids])"),ke.forEach(t),Te.forEach(t),me=h(de),oe=o(de,"LI",{});var Ae=r(oe);qe=a(Ae,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),ie=o(Ae,"CODE",{});var Oe=r(ie);ve=a(Oe,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),Oe.forEach(t),Ae.forEach(t),de.forEach(t)},m(v,D){m(v,l,D),e(l,b),m(v,d,D),m(v,u,D),e(u,T),e(T,p),e(u,g),e(u,A),e(A,k),m(v,N,D),m(v,x,D),e(x,U),e(x,G),e(G,V),e(x,B),e(x,K),e(K,re),e(x,W),m(v,L,D),m(v,w,D),e(w,M),m(v,R,D),m(v,C,D),e(C,O),e(O,ee),e(O,te),e(te,ce),e(O,ne),e(O,se),e(se,S),e(C,Q),e(C,H),e(H,X),e(H,I),e(I,Y),e(H,ge),e(H,ue),e(ue,_e),e(C,me),e(C,oe),e(oe,qe),e(oe,ie),e(ie,ve)},d(v){v&&t(l),v&&t(d),v&&t(u),v&&t(N),v&&t(x),v&&t(L),v&&t(w),v&&t(R),v&&t(C)}}}function Vk(P){let l,b,d,u,T;return{c(){l=n("p"),b=s("Although the recipe for forward pass needs to be defined within this function, one should call the "),d=n("code"),u=s("Module"),T=s(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(p){l=o(p,"P",{});var g=r(l);b=a(g,"Although the recipe for forward pass needs to be defined within this function, one should call the "),d=o(g,"CODE",{});var A=r(d);u=a(A,"Module"),A.forEach(t),T=a(g,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
<span class="hljs-meta">&gt;&gt;&gt; </span>outputs = model(**inputs, labels=labels)
<span class="hljs-meta">&gt;&gt;&gt; </span>logits = outputs.logits`}}),{c(){l=n("p"),b=s("Examples:"),d=c(),y(u.$$.fragment)},l(p){l=o(p,"P",{});var g=r(l);b=a(g,"Examples:"),g.forEach(t),d=h(p),q(u.$$.fragment,p)},m(p,g){m(p,l,g),e(l,b),m(p,d,g),j(u,p,g),T=!0},p:ut,i(p){T||($(u.$$.fragment,p),T=!0)},o(p){E(u.$$.fragment,p),T=!1},d(p){p&&t(l),p&&t(d),F(u,p)}}}function Yk(P){let l,b,d,u,T,p,g,A,k,N,x,U,G,V,B,K,re,W,L,w,M,R,C,O,ee,te,ce,ne,se,S,Q,H,X,I,Y,ge,ue,_e,me,oe,qe,ie,ve;return{c(){l=n("p"),b=s("TF 2.0 models accepts two formats as inputs:"),d=c(),u=n("ul"),T=n("li"),p=s("having all inputs as keyword arguments (like PyTorch models), or"),g=c(),A=n("li"),k=s("having all inputs as a list, tuple or dict in the first positional arguments."),N=c(),x=n("p"),U=s("This second option is useful when using "),G=n("code"),V=s("tf.keras.Model.fit"),B=s(` method which currently requires having all the
tensors in the first argument of the model call function: `),K=n("code"),re=s("model(inputs)"),W=s("."),L=c(),w=n("p"),M=s(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),R=c(),C=n("ul"),O=n("li"),ee=s("a single Tensor with "),te=n("code"),ce=s("input_ids"),ne=s(" only and nothing else: "),se=n("code"),S=s("model(inputs_ids)"),Q=c(),H=n("li"),X=s(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),I=n("code"),Y=s("model([input_ids, attention_mask])"),ge=s(" or "),ue=n("code"),_e=s("model([input_ids, attention_mask, token_type_ids])"),me=c(),oe=n("li"),qe=s(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),ie=n("code"),ve=s('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(v){l=o(v,"P",{});var D=r(l);b=a(D,"TF 2.0 models accepts two formats as inputs:"),D.forEach(t),d=h(v),u=o(v,"UL",{});var be=r(u);T=o(be,"LI",{});var xe=r(T);p=a(xe,"having all inputs as keyword arguments (like PyTorch models), or"),xe.forEach(t),g=h(be),A=o(be,"LI",{});var we=r(A);k=a(we,"having all inputs as a list, tuple or dict in the first positional arguments."),we.forEach(t),be.forEach(t),N=h(v),x=o(v,"P",{});var le=r(x);U=a(le,"This second option is useful when using "),G=o(le,"CODE",{});var ze=r(G);V=a(ze,"tf.keras.Model.fit"),ze.forEach(t),B=a(le,` method which currently requires having all the
...
first positional argument :`),Z.forEach(t),R=h(v),C=o(v,"UL",{});var de=r(C);O=o(de,"LI",{});var pe=r(O);ee=a(pe,"a single Tensor with "),te=o(pe,"CODE",{});var De=r(te);ce=a(De,"input_ids"),De.forEach(t),ne=a(pe," only and nothing else: "),se=o(pe,"CODE",{});var je=r(se);S=a(je,"model(inputs_ids)"),je.forEach(t),pe.forEach(t),Q=h(de),H=o(de,"LI",{});var Te=r(H);X=a(Te,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),I=o(Te,"CODE",{});var Ne=r(I);Y=a(Ne,"model([input_ids, attention_mask])"),Ne.forEach(t),ge=a(Te," or "),ue=o(Te,"CODE",{});var ke=r(ue);_e=a(ke,"model([input_ids, attention_mask, token_type_ids])"),ke.forEach(t),Te.forEach(t),me=h(de),oe=o(de,"LI",{});var Ae=r(oe);qe=a(Ae,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),ie=o(Ae,"CODE",{});var Oe=r(ie);ve=a(Oe,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),Oe.forEach(t),Ae.forEach(t),de.forEach(t)},m(v,D){m(v,l,D),e(l,b),m(v,d,D),m(v,u,D),e(u,T),e(T,p),e(u,g),e(u,A),e(A,k),m(v,N,D),m(v,x,D),e(x,U),e(x,G),e(G,V),e(x,B),e(x,K),e(K,re),e(x,W),m(v,L,D),m(v,w,D),e(w,M),m(v,R,D),m(v,C,D),e(C,O),e(O,ee),e(O,te),e(te,ce),e(O,ne),e(O,se),e(se,S),e(C,Q),e(C,H),e(H,X),e(H,I),e(I,Y),e(H,ge),e(H,ue),e(ue,_e),e(C,me),e(C,oe),e(oe,qe),e(oe,ie),e(ie,ve)},d(v){v&&t(l),v&&t(d),v&&t(u),v&&t(N),v&&t(x),v&&t(L),v&&t(w),v&&t(R),v&&t(C)}}}function Jk(P){let l,b,d,u,T;return{c(){l=n("p"),b=s("Although the recipe for forward pass needs to be defined within this function, one should call the "),d=n("code"),u=s("Module"),T=s(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(p){l=o(p,"P",{});var g=r(l);b=a(g,"Although the recipe for forward pass needs to be defined within this function, one should call the "),d=o(g,"CODE",{});var A=r(d);u=a(A,"Module"),A.forEach(t),T=a(g,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
<span class="hljs-meta">&gt;&gt;&gt; </span>outputs = model(**inputs, labels=labels)
<span class="hljs-meta">&gt;&gt;&gt; </span>loss = outputs.loss
<span class="hljs-meta">&gt;&gt;&gt; </span>logits = outputs.logits`}}),{c(){l=n("p"),b=s("Examples:"),d=c(),y(u.$$.fragment)},l(p){l=o(p,"P",{});var g=r(l);b=a(g,"Examples:"),g.forEach(t),d=h(p),q(u.$$.fragment,p)},m(p,g){m(p,l,g),e(l,b),m(p,d,g),j(u,p,g),T=!0},p:ut,i(p){T||($(u.$$.fragment,p),T=!0)},o(p){E(u.$$.fragment,p),T=!1},d(p){p&&t(l),p&&t(d),F(u,p)}}}function Zk(P){let l,b,d,u,T,p,g,A,k,N,x,U,G,V,B,K,re,W,L,w,M,R,C,O,ee,te,ce,ne,se,S,Q,H,X,I,Y,ge,ue,_e,me,oe,qe,ie,ve;return{c(){l=n("p"),b=s("TF 2.0 models accepts two formats as inputs:"),d=c(),u=n("ul"),T=n("li"),p=s("having all inputs as keyword arguments (like PyTorch models), or"),g=c(),A=n("li"),k=s("having all inputs as a list, tuple or dict in the first positional arguments."),N=c(),x=n("p"),U=s("This second option is useful when using "),G=n("code"),V=s("tf.keras.Model.fit"),B=s(` method which currently requires having all the
tensors in the first argument of the model call function: `),K=n("code"),re=s("model(inputs)"),W=s("."),L=c(),w=n("p"),M=s(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),R=c(),C=n("ul"),O=n("li"),ee=s("a single Tensor with "),te=n("code"),ce=s("input_ids"),ne=s(" only and nothing else: "),se=n("code"),S=s("model(inputs_ids)"),Q=c(),H=n("li"),X=s(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),I=n("code"),Y=s("model([input_ids, attention_mask])"),ge=s(" or "),ue=n("code"),_e=s("model([input_ids, attention_mask, token_type_ids])"),me=c(),oe=n("li"),qe=s(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),ie=n("code"),ve=s('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(v){l=o(v,"P",{});var D=r(l);b=a(D,"TF 2.0 models accepts two formats as inputs:"),D.forEach(t),d=h(v),u=o(v,"UL",{});var be=r(u);T=o(be,"LI",{});var xe=r(T);p=a(xe,"having all inputs as keyword arguments (like PyTorch models), or"),xe.forEach(t),g=h(be),A=o(be,"LI",{});var we=r(A);k=a(we,"having all inputs as a list, tuple or dict in the first positional arguments."),we.forEach(t),be.forEach(t),N=h(v),x=o(v,"P",{});var le=r(x);U=a(le,"This second option is useful when using "),G=o(le,"CODE",{});var ze=r(G);V=a(ze,"tf.keras.Model.fit"),ze.forEach(t),B=a(le,` method which currently requires having all the
...
first positional argument :`),Z.forEach(t),R=h(v),C=o(v,"UL",{});var de=r(C);O=o(de,"LI",{});var pe=r(O);ee=a(pe,"a single Tensor with "),te=o(pe,"CODE",{});var De=r(te);ce=a(De,"input_ids"),De.forEach(t),ne=a(pe," only and nothing else: "),se=o(pe,"CODE",{});var je=r(se);S=a(je,"model(inputs_ids)"),je.forEach(t),pe.forEach(t),Q=h(de),H=o(de,"LI",{});var Te=r(H);X=a(Te,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),I=o(Te,"CODE",{});var Ne=r(I);Y=a(Ne,"model([input_ids, attention_mask])"),Ne.forEach(t),ge=a(Te," or "),ue=o(Te,"CODE",{});var ke=r(ue);_e=a(ke,"model([input_ids, attention_mask, token_type_ids])"),ke.forEach(t),Te.forEach(t),me=h(de),oe=o(de,"LI",{});var Ae=r(oe);qe=a(Ae,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),ie=o(Ae,"CODE",{});var Oe=r(ie);ve=a(Oe,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),Oe.forEach(t),Ae.forEach(t),de.forEach(t)},m(v,D){m(v,l,D),e(l,b),m(v,d,D),m(v,u,D),e(u,T),e(T,p),e(u,g),e(u,A),e(A,k),m(v,N,D),m(v,x,D),e(x,U),e(x,G),e(G,V),e(x,B),e(x,K),e(K,re),e(x,W),m(v,L,D),m(v,w,D),e(w,M),m(v,R,D),m(v,C,D),e(C,O),e(O,ee),e(O,te),e(te,ce),e(O,ne),e(O,se),e(se,S),e(C,Q),e(C,H),e(H,X),e(H,I),e(I,Y),e(H,ge),e(H,ue),e(ue,_e),e(C,me),e(C,oe),e(oe,qe),e(oe,ie),e(ie,ve)},d(v){v&&t(l),v&&t(d),v&&t(u),v&&t(N),v&&t(x),v&&t(L),v&&t(w),v&&t(R),v&&t(C)}}}function ey(P){let l,b,d,u,T;return{c(){l=n("p"),b=s("Although the recipe for forward pass needs to be defined within this function, one should call the "),d=n("code"),u=s("Module"),T=s(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(p){l=o(p,"P",{});var g=r(l);b=a(g,"Although the recipe for forward pass needs to be defined within this function, one should call the "),d=o(g,"CODE",{});var A=r(d);u=a(A,"Module"),A.forEach(t),T=a(g,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
<span class="hljs-meta">&gt;&gt;&gt; </span>logits = outputs.logits
<span class="hljs-meta">&gt;&gt;&gt; </span>logits_aggregation = outputs.logits_aggregation`}}),{c(){l=n("p"),b=s("Examples:"),d=c(),y(u.$$.fragment)},l(p){l=o(p,"P",{});var g=r(l);b=a(g,"Examples:"),g.forEach(t),d=h(p),q(u.$$.fragment,p)},m(p,g){m(p,l,g),e(l,b),m(p,d,g),j(u,p,g),T=!0},p:ut,i(p){T||($(u.$$.fragment,p),T=!0)},o(p){E(u.$$.fragment,p),T=!1},d(p){p&&t(l),p&&t(d),F(u,p)}}}function sy(P){let l,b,d,u,T,p,g,A,k,N,x,U,G,V,B,K,re,W,L,w,M,R,C,O,ee,te,ce,ne,se,S,Q,H,X,I,Y,ge,ue,_e,me,oe,qe,ie,ve,v,D,be,xe,we,le,ze,Me,Z,de,pe,De,je,Te,Ne,ke,Ae,Oe,Ze,Ps,Ss,mt,ft,ca,gt,_t,Ds,tt,Ns,Os,Ke,Pe,Ls,kt,ye,yt,qt,Qs,jt,$t,Is,Et,cs,Gt,Ft,hs,Ye,$e,Ws,At,ae,nt,Vt,Hs,xt,Jt,Us,zt,Ct,Bs,Mt,Xt,Rs,Pt,Zt,Gs,St,Vs,Le,Dt,es,Ks,Nt,ts,Ys,ss,Ue,as,Ee,ns,ot,Js,Ot,Lt,Xs,Zs,Be,ea,os,rs,et,Qt,z,J,ya,ta,qa,ha,It,st,sa,rt,ja,aa,$a,ua,Ie,is,us,Re,Ea,ma,ms,na,ls,fa,fe,Fa,fs,Aa,xa,ga,Tt,oa,ds,za,Fe,Ca,ra,Ma,Pa,Sa,he,Da,ia,Na,Oa,_a,gs,La,Ta,Ce,la,Wt,da,el,Sc,Dc,tl,sl,Nc,Oc,al,nl,Lc,Qc,Qa,Ia,ol,Ic,Wc,rl,Hc,Uc,il,Bc,Rc,Wa,ll,Gc,Vc,dl,Kc,Yc,pl,Jc,Xc,Ha,cl,Zc,eh,hl,th,sh,ul,ah,np,bn,op,vn,nh,bo,oh,rh,rp,wn,ih,vo,lh,dh,ip,Br,ml,ph,lp,kn,ch,wo,hh,uh,dp,We,Rr,fl,mh,fh,gh,Gr,gl,_h,Th,bh,Vr,_l,vh,wh,kh,Kr,Tl,yh,qh,jh,Yr,bl,$h,Eh,Fh,Jr,vl,Ah,xh,zh,Xr,wl,Ch,Mh,Ph,Zr,kl,Sh,Dh,Nh,ei,yl,Oh,Lh,pp,bt,Qh,ko,Ih,Wh,yo,Hh,Uh,ql,Bh,Rh,jl,Gh,Vh,$l,Kh,Yh,cp,ti,El,Jh,hp,yn,up,Se,Xh,Fl,Zh,eu,Al,tu,su,xl,au,nu,zl,ou,ru,Cl,iu,lu,Ml,du,pu,si,cu,hu,qo,uu,mu,jo,fu,gu,mp,ai,_u,fp,qn,gp,Ua,jn,Pl,$o,Tu,Sl,bu,_p,$n,Tp,vt,vu,Dl,wu,ku,Nl,yu,qu,Ol,ju,$u,Eo,Eu,Fu,Fo,Au,xu,bp,Ba,En,Ll,Ao,zu,Ql,Cu,vp,Ra,xo,Mu,zo,Pu,ni,Su,Du,wp,Ga,Fn,Il,Co,Nu,Wl,Ou,kp,Ht,Mo,Lu,Va,Qu,oi,Iu,Wu,Po,Hu,Uu,Bu,Ka,Ru,Hl,Gu,Vu,ri,Ku,Yu,Ju,So,Xu,Do,Zu,em,tm,An,yp,Ya,xn,Ul,No,sm,Bl,am,qp,Ge,Oo,nm,Rl,om,rm,Qe,im,ii,lm,dm,li,pm,cm,Gl,hm,um,Vl,mm,fm,Kl,gm,_m,Yl,Tm,bm,Jl,vm,wm,Xl,km,ym,Zl,qm,jm,$m,it,ed,Em,Fm,td,Am,xm,sd,zm,Cm,ad,Mm,Pm,nd,Sm,Dm,od,Nm,Om,rd,Lm,Qm,di,pi,Im,Wm,Hm,zn,Lo,Um,id,Bm,Rm,ba,Qo,Gm,Io,Vm,ci,Km,Ym,Jm,Wo,Xm,Ho,Zm,ef,tf,hi,Uo,jp,Ja,Cn,ld,Bo,sf,dd,af,$p,lt,Ro,nf,Go,of,ui,rf,lf,df,Vo,pf,Ko,cf,hf,uf,Yo,mf,mi,ff,gf,_f,Jo,Tf,Xo,bf,vf,wf,_s,Zo,kf,Xa,yf,fi,qf,jf,pd,$f,Ef,Ff,Mn,Af,Pn,Ep,Za,Sn,cd,er,xf,hd,zf,Fp,ps,tr,Cf,en,Mf,ud,Pf,Sf,gi,Df,Nf,Of,sr,Lf,ar,Qf,If,Wf,Ts,nr,Hf,tn,Uf,_i,Bf,Rf,md,Gf,Vf,Kf,Dn,Yf,Nn,Ap,sn,On,fd,or,Jf,gd,Xf,xp,Ut,rr,Zf,_d,eg,tg,ir,sg,Ti,ag,ng,og,lr,rg,dr,ig,lg,dg,bs,pr,pg,an,cg,bi,hg,ug,Td,mg,fg,gg,Ln,_g,Qn,zp,nn,In,bd,cr,Tg,vd,bg,Cp,Bt,hr,vg,on,wg,wd,kg,yg,kd,qg,jg,$g,ur,Eg,vi,Fg,Ag,xg,mr,zg,fr,Cg,Mg,Pg,vs,gr,Sg,rn,Dg,wi,Ng,Og,yd,Lg,Qg,Ig,Wn,Wg,Hn,Mp,ln,Un,qd,_r,Hg,jd,Ug,Pp,dt,Tr,Bg,$d,Rg,Gg,br,Vg,ki,Kg,Yg,Jg,vr,Xg,wr,Zg,e_,t_,Bn,s_,ws,kr,a_,dn,n_,yi,o_,r_,Ed,i_,l_,d_,Rn,p_,Gn,Sp,pn,Vn,Fd,yr,c_,Ad,h_,Dp,pt,qr,u_,jr,m_,xd,f_,g_,__,$r,T_,qi,b_,v_,w_,Er,k_,Fr,y_,q_,j_,Kn,$_,ks,Ar,E_,cn,F_,ji,A_,x_,zd,z_,C_,M_,Yn,P_,Jn,Np,hn,Xn,Cd,xr,S_,Md,D_,Op,ct,zr,N_,Pd,O_,L_,Cr,Q_,$i,I_,W_,H_,Mr,U_,Pr,B_,R_,G_,Zn,V_,ys,Sr,K_,un,Y_,Ei,J_,X_,Sd,Z_,eT,tT,eo,sT,to,Lp,mn,so,Dd,Dr,aT,Nd,nT,Qp,ht,Nr,oT,fn,rT,Od,iT,lT,Ld,dT,pT,cT,Or,hT,Fi,uT,mT,fT,Lr,gT,Qr,_T,TT,bT,ao,vT,qs,Ir,wT,gn,kT,Ai,yT,qT,Qd,jT,$T,ET,no,FT,oo,Ip;return p=new Rt({}),V=new Rt({}),rt=new Rt({}),bn=new Pc({props:{pytorch:!0,tensorflow:!0,jax:!1,$$slots:{tensorflow:[kk],pytorch:[vk]},$$scope:{ctx:P}}}),yn=new Pc({props:{pytorch:!0,tensorflow:!0,jax:!1,$$slots:{tensorflow:[$k],pytorch:[qk]},$$scope:{ctx:P}}}),qn=new Pc({props:{pytorch:!0,tensorflow:!0,jax:!1,$$slots:{tensorflow:[xk],pytorch:[Fk]},$$scope:{ctx:P}}}),$o=new Rt({}),$n=new Pc({props:{pytorch:!0,tensorflow:!0,jax:!1,$$slots:{tensorflow:[Pk],pytorch:[Ck]},$$scope:{ctx:P}}}),Ao=new Rt({}),xo=new He({props:{name:"class transformers.models.tapas.modeling_tapas.TableQuestionAnsweringOutput",anchor:"transformers.models.tapas.modeling_tapas.TableQuestionAnsweringOutput",parameters:[{name:"loss",val:": typing.Optional[torch.FloatTensor] = None"},{name:"logits",val:": FloatTensor = None"},{name:"logits_aggregation",val:": FloatTensor = None"},{name:"hidden_states",val:": typing.Optional[typing.Tuple[torch.FloatTensor]] = None"},{name:"attentions",val:": typing.Optional[typing.Tuple[torch.FloatTensor]] = None"}],parametersDescription:[{anchor:"transformers.models.tapas.modeling_tapas.TableQuestionAnsweringOutput.loss",description:`<strong>loss</strong> (<code>torch.FloatTensor</code> of shape <code>(1,)</code>, <em>optional</em>, returned when <code>labels</code> (and possibly <code>answer</code>, <code>aggregation_labels</code>, <code>numeric_values</code> and <code>numeric_values_scale</code> are provided)) &#x2014;
...
`}}),Uo=new He({props:{name:"save_vocabulary",anchor:"transformers.TapasTokenizer.save_vocabulary",parameters:[{name:"save_directory",val:": str"},{name:"filename_prefix",val:": typing.Optional[str] = None"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/tapas/tokenization_tapas.py#L444"}}),Bo=new Rt({}),Ro=new He({props:{name:"class transformers.TapasModel",anchor:"transformers.TapasModel",parameters:[{name:"config",val:""},{name:"add_pooling_layer",val:" = True"}],parametersDescription:[{anchor:"transformers.TapasModel.config",description:`<strong>config</strong> (<a href="/docs/transformers/main/en/model_doc/tapas#transformers.TapasConfig">TapasConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
...
`}}),Mn=new Ms({props:{$$slots:{default:[Dk]},$$scope:{ctx:P}}}),Pn=new Tn({props:{anchor:"transformers.TapasModel.forward.example",$$slots:{default:[Nk]},$$scope:{ctx:P}}}),er=new Rt({}),tr=new He({props:{name:"class transformers.TapasForMaskedLM",anchor:"transformers.TapasForMaskedLM",parameters:[{name:"config",val:""}],parametersDescription:[{anchor:"transformers.TapasForMaskedLM.config",description:`<strong>config</strong> (<a href="/docs/transformers/main/en/model_doc/tapas#transformers.TapasConfig">TapasConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
...
`}}),Dn=new Ms({props:{$$slots:{default:[Ok]},$$scope:{ctx:P}}}),Nn=new Tn({props:{anchor:"transformers.TapasForMaskedLM.forward.example",$$slots:{default:[Lk]},$$scope:{ctx:P}}}),or=new Rt({}),rr=new He({props:{name:"class transformers.TapasForSequenceClassification",anchor:"transformers.TapasForSequenceClassification",parameters:[{name:"config",val:""}],parametersDescription:[{anchor:"transformers.TapasForSequenceClassification.config",description:`<strong>config</strong> (<a href="/docs/transformers/main/en/model_doc/tapas#transformers.TapasConfig">TapasConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
...
`}}),Ln=new Ms({props:{$$slots:{default:[Qk]},$$scope:{ctx:P}}}),Qn=new Tn({props:{anchor:"transformers.TapasForSequenceClassification.forward.example",$$slots:{default:[Ik]},$$scope:{ctx:P}}}),cr=new Rt({}),hr=new He({props:{name:"class transformers.TapasForQuestionAnswering",anchor:"transformers.TapasForQuestionAnswering",parameters:[{name:"config",val:": TapasConfig"}],parametersDescription:[{anchor:"transformers.TapasForQuestionAnswering.config",description:`<strong>config</strong> (<a href="/docs/transformers/main/en/model_doc/tapas#transformers.TapasConfig">TapasConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
...
`}}),Rn=new Ms({props:{$$slots:{default:[Bk]},$$scope:{ctx:P}}}),Gn=new Tn({props:{anchor:"transformers.TFTapasModel.call.example",$$slots:{default:[Rk]},$$scope:{ctx:P}}}),yr=new Rt({}),qr=new He({props:{name:"class transformers.TFTapasForMaskedLM",anchor:"transformers.TFTapasForMaskedLM",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.TFTapasForMaskedLM.config",description:`<strong>config</strong> (<a href="/docs/transformers/main/en/model_doc/tapas#transformers.TapasConfig">TapasConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/main/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/tapas/modeling_tf_tapas.py#L1036"}}),Kn=new Ms({props:{$$slots:{default:[Gk]},$$scope:{ctx:P}}}),Ar=new He({props:{name:"call",anchor:"transformers.TFTapasForMaskedLM.call",parameters:[{name:"input_ids",val:": typing.Union[typing.List[tensorflow.python.framework.ops.Tensor], typing.List[numpy.ndarray], typing.List[tensorflow.python.keras.engine.keras_tensor.KerasTensor], typing.Dict[str, tensorflow.python.framework.ops.Tensor], typing.Dict[str, numpy.ndarray], typing.Dict[str, tensorflow.python.keras.engine.keras_tensor.KerasTensor], tensorflow.python.framework.ops.Tensor, numpy.ndarray, tensorflow.python.keras.engine.keras_tensor.KerasTensor, NoneType] = None"},{name:"attention_mask",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"token_type_ids",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"position_ids",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"head_mask",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"inputs_embeds",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"labels",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"training",val:": typing.Optional[bool] = False"}],parametersDescription:[{anchor:"transformers.TFTapasForMaskedLM.call.input_ids",description:`<strong>input_ids</strong> (<code>np.ndarray</code>, <code>tf.Tensor</code>, <code>List[tf.Tensor]</code> \`<code>Dict[str, tf.Tensor]</code> or <code>Dict[str, np.ndarray]</code> and each example must have the shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/main/en/model_doc/tapas#transformers.TapasTokenizer">TapasTokenizer</a>. See <a href="/docs/transformers/main/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
<a href="/docs/transformers/main/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> for details.</p>
...
`}}),Yn=new Ms({props:{$$slots:{default:[Vk]},$$scope:{ctx:P}}}),Jn=new Tn({props:{anchor:"transformers.TFTapasForMaskedLM.call.example",$$slots:{default:[Kk]},$$scope:{ctx:P}}}),xr=new Rt({}),zr=new He({props:{name:"class transformers.TFTapasForSequenceClassification",anchor:"transformers.TFTapasForSequenceClassification",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.TFTapasForSequenceClassification.config",description:`<strong>config</strong> (<a href="/docs/transformers/main/en/model_doc/tapas#transformers.TapasConfig">TapasConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
...
millions of tables from English Wikipedia and corresponding texts.`),O=c(),ee=n("p"),te=s("For question answering, TAPAS has 2 heads on top: a cell selection head and an aggregation head, for (optionally) performing aggregations (such as counting or summing) among selected cells. TAPAS has been fine-tuned on several datasets:"),ce=c(),ne=n("ul"),se=n("li"),S=n("a"),Q=s("SQA"),H=s(" (Sequential Question Answering by Microsoft)"),X=c(),I=n("li"),Y=n("a"),ge=s("WTQ"),ue=s(" (Wiki Table Questions by Stanford University)"),_e=c(),me=n("li"),oe=n("a"),qe=s("WikiSQL"),ie=s(" (by Salesforce)."),ve=c(),v=n("p"),D=s("It achieves state-of-the-art on both SQA and WTQ, while having comparable performance to SOTA on WikiSQL, with a much simpler architecture."),be=c(),xe=n("p"),we=s("The abstract from the paper is the following:"),le=c(),ze=n("p"),Me=n("em"),Z=s("Answering natural language questions over tables is usually seen as a semantic parsing task. To alleviate the collection cost of full logical forms, one popular approach focuses on weak supervision consisting of denotations instead of logical forms. However, training semantic parsers from weak supervision poses difficulties, and in addition, the generated logical forms are only used as an intermediate step prior to retrieving the denotation. In this paper, we present TAPAS, an approach to question answering over tables without generating logical forms. TAPAS trains from weak supervision, and predicts the denotation by selecting table cells and optionally applying a corresponding aggregation operator to such selection. TAPAS extends BERT\u2019s architecture to encode tables as input, initializes from an effective joint pre-training of text segments and tables crawled from Wikipedia, and is trained end-to-end. We experiment with three different semantic parsing datasets, and find that TAPAS outperforms or rivals semantic parsing models by improving state-of-the-art accuracy on SQA from 55.1 to 67.2 and performing on par with the state-of-the-art on WIKISQL and WIKITQ, but with a simpler model architecture. We additionally find that transfer learning, which is trivial in our setting, from WIKISQL to WIKITQ, yields 48.7 accuracy, 4.2 points above the state-of-the-art."),de=c(),pe=n("p"),De=s("In addition, the authors have further pre-trained TAPAS to recognize "),je=n("strong"),Te=s("table entailment"),Ne=s(", by creating a balanced dataset of millions of automatically created training examples which are learned in an intermediate step prior to fine-tuning. The authors of TAPAS call this further pre-training intermediate pre-training (since TAPAS is first pre-trained on MLM, and then on another dataset). They found that intermediate pre-training further improves performance on SQA, achieving a new state-of-the-art as well as state-of-the-art on "),ke=n("a"),Ae=s("TabFact"),Oe=s(", a large-scale dataset with 16k Wikipedia tables for table entailment (a binary classification task). For more details, see their follow-up paper: "),Ze=n("a"),Ps=s("Understanding tables with intermediate pre-training"),Ss=s(" by Julian Martin Eisenschlos, Syrine Krichene and Thomas M\xFCller."),mt=c(),ft=n("img"),gt=c(),_t=n("small"),Ds=s("TAPAS architecture. Taken from the "),tt=n("a"),Ns=s("original blog post"),Os=s("."),Ke=c(),Pe=n("p"),Ls=s("This model was contributed by "),kt=n("a"),ye=s("nielsr"),yt=s(". The Tensorflow version of this model was contributed by "),qt=n("a"),Qs=s("kamalkraj"),jt=s(". The original code can be found "),$t=n("a"),Is=s("here"),Et=s("."),cs=c(),Gt=n("p"),Ft=s("Tips:"),hs=c(),Ye=n("ul"),$e=n("li"),Ws=s("TAPAS is a model that uses relative position embeddings by default (restarting the position embeddings at every cell of the table). Note that this is something that was added after the publication of the original TAPAS paper. According to the authors, this usually results in a slightly better performance, and allows you to encode longer sequences without running out of embeddings. This is reflected in the "),At=n("code"),ae=s("reset_position_index_per_cell"),nt=s(" parameter of "),Vt=n("a"),Hs=s("TapasConfig"),xt=s(", which is set to "),Jt=n("code"),Us=s("True"),zt=s(" by default. The default versions of the models available on the "),Ct=n("a"),Bs=s("hub"),Mt=s(" all use relative position embeddings. You can still use the ones with absolute position embeddings by passing in an additional argument "),Xt=n("code"),Rs=s('revision="no_reset"'),Pt=s(" when calling the "),Zt=n("code"),Gs=s("from_pretrained()"),St=s(" method. Note that it\u2019s usually advised to pad the inputs on the right rather than the left."),Vs=c(),Le=n("li"),Dt=s("TAPAS is based on BERT, so "),es=n("code"),Ks=s("TAPAS-base"),Nt=s(" for example corresponds to a "),ts=n("code"),Ys=s("BERT-base"),ss=s(" architecture. Of course, "),Ue=n("code"),as=s("TAPAS-large"),Ee=s(" will result in the best performance (the results reported in the paper are from "),ns=n("code"),ot=s("TAPAS-large"),Js=s("). Results of the various sized models are shown on the "),Ot=n("a"),Lt=s("original Github repository"),Xs=s("."),Zs=c(),Be=n("li"),ea=s("TAPAS has checkpoints fine-tuned on SQA, which are capable of answering questions related to a table in a conversational set-up. This means that you can ask follow-up questions such as \u201Cwhat is his age?\u201D related to the previous question. Note that the forward pass of TAPAS is a bit different in case of a conversational set-up: in that case, you have to feed every table-question pair one by one to the model, such that the "),os=n("code"),rs=s("prev_labels"),et=s(" token type ids can be overwritten by the predicted "),Qt=n("code"),z=s("labels"),J=s(" of the model to the previous question. See \u201CUsage\u201D section for more info."),ya=c(),ta=n("li"),qa=s("TAPAS is similar to BERT and therefore relies on the masked language modeling (MLM) objective. It is therefore efficient at predicting masked tokens and at NLU in general, but is not optimal for text generation. Models trained with a causal language modeling (CLM) objective are better in that regard. Note that TAPAS can be used as an encoder in the EncoderDecoderModel framework, to combine it with an autoregressive text decoder such as GPT-2."),ha=c(),It=n("h2"),st=n("a"),sa=n("span"),y(rt.$$.fragment),ja=c(),aa=n("span"),$a=s("Usage: fine-tuning"),ua=c(),Ie=n("p"),is=s("Here we explain how you can fine-tune "),us=n("a"),Re=s("TapasForQuestionAnswering"),Ea=s(" on your own dataset."),ma=c(),ms=n("p"),na=n("strong"),ls=s("STEP 1: Choose one of the 3 ways in which you can use TAPAS - or experiment"),fa=c(),fe=n("p"),Fa=s("Basically, there are 3 different ways in which one can fine-tune "),fs=n("a"),Aa=s("TapasForQuestionAnswering"),xa=s(", corresponding to the different datasets on which Tapas was fine-tuned:"),ga=c(),Tt=n("ol"),oa=n("li"),ds=s("SQA: if you\u2019re interested in asking follow-up questions related to a table, in a conversational set-up. For example if you first ask \u201Cwhat\u2019s the name of the first actor?\u201D then you can ask a follow-up question such as \u201Chow old is he?\u201C. Here, questions do not involve any aggregation (all questions are cell selection questions)."),za=c(),Fe=n("li"),Ca=s("WTQ: if you\u2019re not interested in asking questions in a conversational set-up, but rather just asking questions related to a table, which might involve aggregation, such as counting a number of rows, summing up cell values or averaging cell values. You can then for example ask \u201Cwhat\u2019s the total number of goals Cristiano Ronaldo made in his career?\u201C. This case is also called "),ra=n("strong"),Ma=s("weak supervision"),Pa=s(", since the model itself must learn the appropriate aggregation operator (SUM/COUNT/AVERAGE/NONE) given only the answer to the question as supervision."),Sa=c(),he=n("li"),Da=s("WikiSQL-supervised: this dataset is based on WikiSQL with the model being given the ground truth aggregation operator during training. This is also called "),ia=n("strong"),Na=s("strong supervision"),Oa=s(". Here, learning the appropriate aggregation operator is much easier."),_a=c(),gs=n("p"),La=s("To summarize:"),Ta=c(),Ce=n("table"),la=n("thead"),Wt=n("tr"),da=n("th"),el=n("strong"),Sc=s("Task"),Dc=c(),tl=n("th"),sl=n("strong"),Nc=s("Example dataset"),Oc=c(),al=n("th"),nl=n("strong"),Lc=s("Description"),Qc=c(),Qa=n("tbody"),Ia=n("tr"),ol=n("td"),Ic=s("Conversational"),Wc=c(),rl=n("td"),Hc=s("SQA"),Uc=c(),il=n("td"),Bc=s("Conversational, only cell selection questions"),Rc=c(),Wa=n("tr"),ll=n("td"),Gc=s("Weak supervision for aggregation"),Vc=c(),dl=n("td"),Kc=s("WTQ"),Yc=c(),pl=n("td"),Jc=s("Questions might involve aggregation, and the model must learn this given only the answer as supervision"),Xc=c(),Ha=n("tr"),cl=n("td"),Zc=s("Strong supervision for aggregation"),eh=c(),hl=n("td"),th=s("WikiSQL-supervised"),sh=c(),ul=n("td"),ah=s("Questions might involve aggregation, and the model must learn this given the gold aggregation operator"),np=c(),y(bn.$$.fragment),op=c(),vn=n("p"),nh=s("What you can also do is start from an already fine-tuned checkpoint. A note here is that the already fine-tuned checkpoint on WTQ has some issues due to the L2-loss which is somewhat brittle. See "),bo=n("a"),oh=s("here"),rh=s(" for more info."),rp=c(),wn=n("p"),ih=s("For a list of all pre-trained and fine-tuned TAPAS checkpoints available on HuggingFace\u2019s  hub, see "),vo=n("a"),lh=s("here"),dh=s("."),ip=c(),Br=n("p"),ml=n("strong"),ph=s("STEP 2: Prepare your data in the SQA format"),lp=c(),kn=n("p"),ch=s("Second, no matter what you picked above, you should prepare your dataset in the "),wo=n("a"),hh=s("SQA"),uh=s(" format. This format is a TSV/CSV file with the following columns:"),dp=c(),We=n("ul"),Rr=n("li"),fl=n("code"),mh=s("id"),fh=s(": optional, id of the table-question pair, for bookkeeping purposes."),gh=c(),Gr=n("li"),gl=n("code"),_h=s("annotator"),Th=s(": optional, id of the person who annotated the table-question pair, for bookkeeping purposes."),bh=c(),Vr=n("li"),_l=n("code"),vh=s("position"),wh=s(": integer indicating if the question is the first, second, third,\u2026 related to the table. Only required in case of conversational setup (SQA). You don\u2019t need this column in case you\u2019re going for WTQ/WikiSQL-supervised."),kh=c(),Kr=n("li"),Tl=n("code"),yh=s("question"),qh=s(": string"),jh=c(),Yr=n("li"),bl=n("code"),$h=s("table_file"),Eh=s(": string, name of a csv file containing the tabular data"),Fh=c(),Jr=n("li"),vl=n("code"),Ah=s("answer_coordinates"),xh=s(": list of one or more tuples (each tuple being a cell coordinate, i.e. row, column pair that is part of the answer)"),zh=c(),Xr=n("li"),wl=n("code"),Ch=s("answer_text"),Mh=s(": list of one or more strings (each string being a cell value that is part of the answer)"),Ph=c(),Zr=n("li"),kl=n("code"),Sh=s("aggregation_label"),Dh=s(": index of the aggregation operator. Only required in case of strong supervision for aggregation (the WikiSQL-supervised case)"),Nh=c(),ei=n("li"),yl=n("code"),Oh=s("float_answer"),Lh=s(": the float answer to the question, if there is one (np.nan if there isn\u2019t). Only required in case of weak supervision for aggregation (such as WTQ and WikiSQL)"),pp=c(),bt=n("p"),Qh=s("The tables themselves should be present in a folder, each table being a separate csv file. Note that the authors of the TAPAS algorithm used conversion scripts with some automated logic to convert the other datasets (WTQ, WikiSQL) into the SQA format. The author explains this "),ko=n("a"),Ih=s("here"),Wh=s(". A conversion of this script that works with HuggingFace\u2019s implementation can be found "),yo=n("a"),Hh=s("here"),Uh=s(". Interestingly, these conversion scripts are not perfect (the "),ql=n("code"),Bh=s("answer_coordinates"),Rh=s(" and "),jl=n("code"),Gh=s("float_answer"),Vh=s(" fields are populated based on the "),$l=n("code"),Kh=s("answer_text"),Yh=s("), meaning that WTQ and WikiSQL results could actually be improved."),cp=c(),ti=n("p"),El=n("strong"),Jh=s("STEP 3: Convert your data into tensors using TapasTokenizer"),hp=c(),y(yn.$$.fragment),up=c(),Se=n("p"),Xh=s("Note that here, we encode each table-question pair independently. This is fine as long as your dataset is "),Fl=n("strong"),Zh=s("not conversational"),eu=s(". In case your dataset involves conversational questions (such as in SQA), then you should first group together the "),Al=n("code"),tu=s("queries"),su=s(", "),xl=n("code"),au=s("answer_coordinates"),nu=s(" and "),zl=n("code"),ou=s("answer_text"),ru=s(" per table (in the order of their "),Cl=n("code"),iu=s("position"),lu=s(`
index) and batch encode each table with its questions. This will make sure that the `),Ml=n("code"),du=s("prev_labels"),pu=s(" token types (see docs of "),si=n("a"),cu=s("TapasTokenizer"),hu=s(") are set correctly. See "),qo=n("a"),uu=s("this notebook"),mu=s(" for more info. See "),jo=n("a"),fu=s("this notebook"),gu=s(" for more info regarding using the TensorFlow model."),mp=c(),ai=n("p"),_u=s("**STEP 4: Train (fine-tune) the model"),fp=c(),y(qn.$$.fragment),gp=c(),Ua=n("h2"),jn=n("a"),Pl=n("span"),y($o.$$.fragment),Tu=c(),Sl=n("span"),bu=s("Usage: inference"),_p=c(),y($n.$$.fragment),Tp=c(),vt=n("p"),vu=s("In case of a conversational set-up, then each table-question pair must be provided "),Dl=n("strong"),wu=s("sequentially"),ku=s(" to the model, such that the "),Nl=n("code"),yu=s("prev_labels"),qu=s(" token types can be overwritten by the predicted "),Ol=n("code"),ju=s("labels"),$u=s(" of the previous table-question pair. Again, more info can be found in "),Eo=n("a"),Eu=s("this notebook"),Fu=s(" (for PyTorch) and "),Fo=n("a"),Au=s("this notebook"),xu=s(" (for TensorFlow)."),bp=c(),Ba=n("h2"),En=n("a"),Ll=n("span"),y(Ao.$$.fragment),zu=c(),Ql=n("span"),Cu=s("TAPAS specific outputs"),vp=c(),Ra=n("div"),y(xo.$$.fragment),Mu=c(),zo=n("p"),Pu=s("Output type of "),ni=n("a"),Su=s("TapasForQuestionAnswering"),Du=s("."),wp=c(),Ga=n("h2"),Fn=n("a"),Il=n("span"),y(Co.$$.fragment),Nu=c(),Wl=n("span"),Ou=s("TapasConfig"),kp=c(),Ht=n("div"),y(Mo.$$.fragment),Lu=c(),Va=n("p"),Qu=s("This is the configuration class to store the configuration of a "),oi=n("a"),Iu=s("TapasModel"),Wu=s(`. It is used to instantiate a TAPAS
model according to the specified arguments, defining the model architecture. Instantiating a configuration with the
defaults will yield a similar configuration to that of the TAPAS
`),Po=n("a"),Hu=s("google/tapas-base-finetuned-sqa"),Uu=s(" architecture."),Bu=c(),Ka=n("p"),Ru=s("Configuration objects inherit from "),Hl=n("code"),Gu=s("PreTrainedConfig"),Vu=s(` and can be used to control the model outputs. Read the
documentation from `),ri=n("a"),Ku=s("PretrainedConfig"),Yu=s(" for more information."),Ju=c(),So=n("p"),Xu=s(`Hyperparameters additional to BERT are taken from run_task_main.py and hparam_utils.py of the original
implementation. Original implementation available at `),Do=n("a"),Zu=s("https://github.com/google-research/tapas/tree/master"),em=s("."),tm=c(),y(An.$$.fragment),yp=c(),Ya=n("h2"),xn=n("a"),Ul=n("span"),y(No.$$.fragment),sm=c(),Bl=n("span"),am=s("TapasTokenizer"),qp=c(),Ge=n("div"),y(Oo.$$.fragment),nm=c(),Rl=n("p"),om=s(`Construct a TAPAS tokenizer. Based on WordPiece. Flattens a table and one or more related sentences to be used by
TAPAS models.`),rm=c(),Qe=n("p"),im=s("This tokenizer inherits from "),ii=n("a"),lm=s("PreTrainedTokenizer"),dm=s(` which contains most of the main methods. Users should refer to
this superclass for more information regarding those methods. `),li=n("a"),pm=s("TapasTokenizer"),cm=s(` creates several token type ids to
encode tabular structure. To be more precise, it adds 7 token type ids, in the following order: `),Gl=n("code"),hm=s("segment_ids"),um=s(`,
`),Vl=n("code"),mm=s("column_ids"),fm=s(", "),Kl=n("code"),gm=s("row_ids"),_m=s(", "),Yl=n("code"),Tm=s("prev_labels"),bm=s(", "),Jl=n("code"),vm=s("column_ranks"),wm=s(", "),Xl=n("code"),km=s("inv_column_ranks"),ym=s(" and "),Zl=n("code"),qm=s("numeric_relations"),jm=s(":"),$m=c(),it=n("ul"),ed=n("li"),Em=s(`segment_ids: indicate whether a token belongs to the question (0) or the table (1). 0 for special tokens and
padding.`),Fm=c(),td=n("li"),Am=s(`column_ids: indicate to which column of the table a token belongs (starting from 1). Is 0 for all question
tokens, special tokens and padding.`),xm=c(),sd=n("li"),zm=s(`row_ids: indicate to which row of the table a token belongs (starting from 1). Is 0 for all question tokens,
special tokens and padding. Tokens of column headers are also 0.`),Cm=c(),ad=n("li"),Mm=s(`prev_labels: indicate whether a token was (part of) an answer to the previous question (1) or not (0). Useful in
a conversational setup (such as SQA).`),Pm=c(),nd=n("li"),Sm=s(`column_ranks: indicate the rank of a table token relative to a column, if applicable. For example, if you have a
column \u201Cnumber of movies\u201D with values 87, 53 and 69, then the column ranks of these tokens are 3, 1 and 2
respectively. 0 for all question tokens, special tokens and padding.`),Dm=c(),od=n("li"),Nm=s(`inv_column_ranks: indicate the inverse rank of a table token relative to a column, if applicable. For example, if
you have a column \u201Cnumber of movies\u201D with values 87, 53 and 69, then the inverse column ranks of these tokens are
1, 3 and 2 respectively. 0 for all question tokens, special tokens and padding.`),Om=c(),rd=n("li"),Lm=s(`numeric_relations: indicate numeric relations between the question and the tokens of the table. 0 for all
question tokens, special tokens and padding.`),Qm=c(),di=n("p"),pi=n("a"),Im=s("TapasTokenizer"),Wm=s(` runs end-to-end tokenization on a table and associated sentences: punctuation splitting and
wordpiece.`),Hm=c(),zn=n("div"),y(Lo.$$.fragment),Um=c(),id=n("p"),Bm=s("Main method to tokenize and prepare for the model one or several sequence(s) related to a table."),Rm=c(),ba=n("div"),y(Qo.$$.fragment),Gm=c(),Io=n("p"),Vm=s("Converts logits of "),ci=n("a"),Km=s("TapasForQuestionAnswering"),Ym=s(` to actual predicted answer coordinates and optional
aggregation indices.`),Jm=c(),Wo=n("p"),Xm=s(`The original implementation, on which this function is based, can be found
`),Ho=n("a"),Zm=s("here"),ef=s("."),tf=c(),hi=n("div"),y(Uo.$$.fragment),jp=c(),Ja=n("h2"),Cn=n("a"),ld=n("span"),y(Bo.$$.fragment),sf=c(),dd=n("span"),af=s("TapasModel"),$p=c(),lt=n("div"),y(Ro.$$.fragment),nf=c(),Go=n("p"),of=s(`The bare Tapas Model transformer outputting raw hidden-states without any specific head on top.
This model inherits from `),ui=n("a"),rf=s("PreTrainedModel"),lf=s(`. Check the superclass documentation for the generic methods the
...
and behavior.`),uf=c(),Yo=n("p"),mf=s("This class is a small change compared to "),mi=n("a"),ff=s("BertModel"),gf=s(", taking into account the additional token type ids."),_f=c(),Jo=n("p"),Tf=s(`The model can behave as an encoder (with only self-attention) as well as a decoder, in which case a layer of
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),dg=c(),bs=n("div"),y(pr.$$.fragment),pg=c(),an=n("p"),cg=s("The "),bi=n("a"),hg=s("TapasForSequenceClassification"),ug=s(" forward method, overrides the "),Td=n("code"),mg=s("__call__"),fg=s(" special method."),gg=c(),y(Ln.$$.fragment),_g=c(),y(Qn.$$.fragment),zp=c(),nn=n("h2"),In=n("a"),bd=n("span"),y(cr.$$.fragment),Tg=c(),vd=n("span"),bg=s("TapasForQuestionAnswering"),Cp=c(),Bt=n("div"),y(hr.$$.fragment),vg=c(),on=n("p"),wg=s(`Tapas Model with a cell selection head and optional aggregation head on top for question-answering tasks on tables
...
SQA, WTQ or WikiSQL-supervised tasks.`),$g=c(),ur=n("p"),Eg=s("This model inherits from "),vi=n("a"),Fg=s("PreTrainedModel"),Ag=s(`. Check the superclass documentation for the generic methods the
library implements for all its models (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),xg=c(),mr=n("p"),zg=s("This model is also a PyTorch "),fr=n("a"),Cg=s("torch.nn.Module"),Mg=s(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Pg=c(),vs=n("div"),y(gr.$$.fragment),Sg=c(),rn=n("p"),Dg=s("The "),wi=n("a"),Ng=s("TapasForQuestionAnswering"),Og=s(" forward method, overrides the "),yd=n("code"),Lg=s("__call__"),Qg=s(" special method."),Ig=c(),y(Wn.$$.fragment),Wg=c(),y(Hn.$$.fragment),Mp=c(),ln=n("h2"),Un=n("a"),qd=n("span"),y(_r.$$.fragment),Hg=c(),jd=n("span"),Ug=s("TFTapasModel"),Pp=c(),dt=n("div"),y(Tr.$$.fragment),Bg=c(),$d=n("p"),Rg=s("The bare Tapas Model transformer outputting raw hidden-states without any specific head on top."),Gg=c(),br=n("p"),Vg=s("This model inherits from "),ki=n("a"),Kg=s("TFPreTrainedModel"),Yg=s(`. Check the superclass documentation for the generic methods the
...
behavior.`),t_=c(),y(Bn.$$.fragment),s_=c(),ws=n("div"),y(kr.$$.fragment),a_=c(),dn=n("p"),n_=s("The "),yi=n("a"),o_=s("TFTapasModel"),r_=s(" forward method, overrides the "),Ed=n("code"),i_=s("__call__"),l_=s(" special method."),d_=c(),y(Rn.$$.fragment),p_=c(),y(Gn.$$.fragment),Sp=c(),pn=n("h2"),Vn=n("a"),Fd=n("span"),y(yr.$$.fragment),c_=c(),Ad=n("span"),h_=s("TFTapasForMaskedLM"),Dp=c(),pt=n("div"),y(qr.$$.fragment),u_=c(),jr=n("p"),m_=s("Tapas Model with a "),xd=n("code"),f_=s("language modeling"),g_=s(" head on top."),__=c(),$r=n("p"),T_=s("This model inherits from "),qi=n("a"),b_=s("TFPreTrainedModel"),v_=s(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),H_=c(),Mr=n("p"),U_=s("This model is also a "),Pr=n("a"),B_=s("tf.keras.Model"),R_=s(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),G_=c(),y(Zn.$$.fragment),V_=c(),ys=n("div"),y(Sr.$$.fragment),K_=c(),un=n("p"),Y_=s("The "),Ei=n("a"),J_=s("TFTapasForSequenceClassification"),X_=s(" forward method, overrides the "),Sd=n("code"),Z_=s("__call__"),eT=s(" special method."),tT=c(),y(eo.$$.fragment),sT=c(),y(to.$$.fragment),Lp=c(),mn=n("h2"),so=n("a"),Dd=n("span"),y(Dr.$$.fragment),aT=c(),Nd=n("span"),nT=s("TFTapasForQuestionAnswering"),Qp=c(),ht=n("div"),y(Nr.$$.fragment),oT=c(),fn=n("p"),rT=s(`Tapas Model with a cell selection head and optional aggregation head on top for question-answering tasks on tables
...
SQA, WTQ or WikiSQL-supervised tasks.`),cT=c(),Or=n("p"),hT=s("This model inherits from "),Fi=n("a"),uT=s("TFPreTrainedModel"),mT=s(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),fT=c(),Lr=n("p"),gT=s("This model is also a "),Qr=n("a"),_T=s("tf.keras.Model"),TT=s(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),bT=c(),y(ao.$$.fragment),vT=c(),qs=n("div"),y(Ir.$$.fragment),wT=c(),gn=n("p"),kT=s("The "),Ai=n("a"),yT=s("TFTapasForQuestionAnswering"),qT=s(" forward method, overrides the "),Qd=n("code"),jT=s("__call__"),$T=s(" special method."),ET=c(),y(no.$$.fragment),FT=c(),y(oo.$$.fragment),this.h()},l(i){const _=gk('[data-svelte="svelte-1phssyn"]',document.head);l=o(_,"META",{name:!0,content:!0}),_.forEach(t),b=h(i),d=o(i,"H1",{class:!0});var Wr=r(d);u=o(Wr,"A",{id:!0,class:!0,href:!0});var Id=r(u);T=o(Id,"SPAN",{});var Wd=r(T);q(p.$$.fragment,Wd),Wd.forEach(t),Id.forEach(t),g=h(Wr),A=o(Wr,"SPAN",{});var Hd=r(A);k=a(Hd,"TAPAS"),Hd.forEach(t),Wr.forEach(t),N=h(i),x=o(i,"H2",{class:!0});var Hr=r(x);U=o(Hr,"A",{id:!0,class:!0,href:!0});var Ud=r(U);G=o(Ud,"SPAN",{});var Bd=r(G);q(V.$$.fragment,Bd),Bd.forEach(t),Ud.forEach(t),B=h(Hr),K=o(Hr,"SPAN",{});var Rd=r(K);re=a(Rd,"Overview"),Rd.forEach(t),Hr.forEach(t),W=h(i),L=o(i,"P",{});var Ur=r(L);w=a(Ur,"The TAPAS model was proposed in "),M=o(Ur,"A",{href:!0,rel:!0});var Gd=r(M);R=a(Gd,"TAPAS: Weakly Supervised Table Parsing via Pre-training"),Gd.forEach(t),C=a(Ur,`
by Jonathan Herzig, Pawe\u0142 Krzysztof Nowak, Thomas M\xFCller, Francesco Piccinno and Julian Martin Eisenschlos. It\u2019s a BERT-based model specifically
designed (and pre-trained) for answering questions about tabular data. Compared to BERT, TAPAS uses relative position embeddings and has 7
token types that encode tabular structure. TAPAS is pre-trained on the masked language modeling (MLM) objective on a large dataset comprising
millions of tables from English Wikipedia and corresponding texts.`),Ur.forEach(t),O=h(i),ee=o(i,"P",{});var Vd=r(ee);te=a(Vd,"For question answering, TAPAS has 2 heads on top: a cell selection head and an aggregation head, for (optionally) performing aggregations (such as counting or summing) among selected cells. TAPAS has been fine-tuned on several datasets:"),Vd.forEach(t),ce=h(i),ne=o(i,"UL",{});var _n=r(ne);se=o(_n,"LI",{});var xi=r(se);S=o(xi,"A",{href:!0,rel:!0});var Kd=r(S);Q=a(Kd,"SQA"),Kd.forEach(t),H=a(xi," (Sequential Question Answering by Microsoft)"),xi.forEach(t),X=h(_n),I=o(_n,"LI",{});var zi=r(I);Y=o(zi,"A",{href:!0,rel:!0});var Yd=r(Y);ge=a(Yd,"WTQ"),Yd.forEach(t),ue=a(zi," (Wiki Table Questions by Stanford University)"),zi.forEach(t),_e=h(_n),me=o(_n,"LI",{});var Ci=r(me);oe=o(Ci,"A",{href:!0,rel:!0});var Jd=r(oe);qe=a(Jd,"WikiSQL"),Jd.forEach(t),ie=a(Ci," (by Salesforce)."),Ci.forEach(t),_n.forEach(t),ve=h(i),v=o(i,"P",{});var Xd=r(v);D=a(Xd,"It achieves state-of-the-art on both SQA and WTQ, while having comparable performance to SOTA on WikiSQL, with a much simpler architecture."),Xd.forEach(t),be=h(i),xe=o(i,"P",{});var Zd=r(xe);we=a(Zd,"The abstract from the paper is the following:"),Zd.forEach(t),le=h(i),ze=o(i,"P",{});var ep=r(ze);Me=o(ep,"EM",{});var tp=r(Me);Z=a(tp,"Answering natural language questions over tables is usually seen as a semantic parsing task. To alleviate the collection cost of full logical forms, one popular approach focuses on weak supervision consisting of denotations instead of logical forms. However, training semantic parsers from weak supervision poses difficulties, and in addition, the generated logical forms are only used as an intermediate step prior to retrieving the denotation. In this paper, we present TAPAS, an approach to question answering over tables without generating logical forms. TAPAS trains from weak supervision, and predicts the denotation by selecting table cells and optionally applying a corresponding aggregation operator to such selection. TAPAS extends BERT\u2019s architecture to encode tables as input, initializes from an effective joint pre-training of text segments and tables crawled from Wikipedia, and is trained end-to-end. We experiment with three different semantic parsing datasets, and find that TAPAS outperforms or rivals semantic parsing models by improving state-of-the-art accuracy on SQA from 55.1 to 67.2 and performing on par with the state-of-the-art on WIKISQL and WIKITQ, but with a simpler model architecture. We additionally find that transfer learning, which is trivial in our setting, from WIKISQL to WIKITQ, yields 48.7 accuracy, 4.2 points above the state-of-the-art."),tp.forEach(t),ep.forEach(t),de=h(i),pe=o(i,"P",{});var pa=r(pe);De=a(pa,"In addition, the authors have further pre-trained TAPAS to recognize "),je=o(pa,"STRONG",{});var sp=r(je);Te=a(sp,"table entailment"),sp.forEach(t),Ne=a(pa,", by creating a balanced dataset of millions of automatically created training examples which are learned in an intermediate step prior to fine-tuning. The authors of TAPAS call this further pre-training intermediate pre-training (since TAPAS is first pre-trained on MLM, and then on another dataset). They found that intermediate pre-training further improves performance on SQA, achieving a new state-of-the-art as well as state-of-the-art on "),ke=o(pa,"A",{href:!0,rel:!0});var ap=r(ke);Ae=a(ap,"TabFact"),ap.forEach(t),Oe=a(pa,", a large-scale dataset with 16k Wikipedia tables for table entailment (a binary classification task). For more details, see their follow-up paper: "),Ze=o(pa,"A",{href:!0,rel:!0});var LT=r(Ze);Ps=a(LT,"Understanding tables with intermediate pre-training"),LT.forEach(t),Ss=a(pa," by Julian Martin Eisenschlos, Syrine Krichene and Thomas M\xFCller."),pa.forEach(t),mt=h(i),ft=o(i,"IMG",{src:!0,alt:!0,width:!0}),gt=h(i),_t=o(i,"SMALL",{});var Wp=r(_t);Ds=a(Wp,"TAPAS architecture. Taken from the "),tt=o(Wp,"A",{href:!0});var QT=r(tt);Ns=a(QT,"original blog post"),QT.forEach(t),Os=a(Wp,"."),Wp.forEach(t),Ke=h(i),Pe=o(i,"P",{});var ro=r(Pe);Ls=a(ro,"This model was contributed by "),kt=o(ro,"A",{href:!0,rel:!0});var IT=r(kt);ye=a(IT,"nielsr"),IT.forEach(t),yt=a(ro,". The Tensorflow version of this model was contributed by "),qt=o(ro,"A",{href:!0,rel:!0});var WT=r(qt);Qs=a(WT,"kamalkraj"),WT.forEach(t),jt=a(ro,". The original code can be found "),$t=o(ro,"A",{href:!0,rel:!0});var HT=r($t);Is=a(HT,"here"),HT.forEach(t),Et=a(ro,"."),ro.forEach(t),cs=h(i),Gt=o(i,"P",{});var UT=r(Gt);Ft=a(UT,"Tips:"),UT.forEach(t),hs=h(i),Ye=o(i,"UL",{});var io=r(Ye);$e=o(io,"LI",{});var Kt=r($e);Ws=a(Kt,"TAPAS is a model that uses relative position embeddings by default (restarting the position embeddings at every cell of the table). Note that this is something that was added after the publication of the original TAPAS paper. According to the authors, this usually results in a slightly better performance, and allows you to encode longer sequences without running out of embeddings. This is reflected in the "),At=o(Kt,"CODE",{});var BT=r(At);ae=a(BT,"reset_position_index_per_cell"),BT.forEach(t),nt=a(Kt," parameter of "),Vt=o(Kt,"A",{href:!0});var RT=r(Vt);Hs=a(RT,"TapasConfig"),RT.forEach(t),xt=a(Kt,", which is set to "),Jt=o(Kt,"CODE",{});var GT=r(Jt);Us=a(GT,"True"),GT.forEach(t),zt=a(Kt," by default. The default versions of the models available on the "),Ct=o(Kt,"A",{href:!0,rel:!0});var VT=r(Ct);Bs=a(VT,"hub"),VT.forEach(t),Mt=a(Kt," all use relative position embeddings. You can still use the ones with absolute position embeddings by passing in an additional argument "),Xt=o(Kt,"CODE",{});var KT=r(Xt);Rs=a(KT,'revision="no_reset"'),KT.forEach(t),Pt=a(Kt," when calling the "),Zt=o(Kt,"CODE",{});var YT=r(Zt);Gs=a(YT,"from_pretrained()"),YT.forEach(t),St=a(Kt," method. Note that it\u2019s usually advised to pad the inputs on the right rather than the left."),Kt.forEach(t),Vs=h(io),Le=o(io,"LI",{});var js=r(Le);Dt=a(js,"TAPAS is based on BERT, so "),es=o(js,"CODE",{});var JT=r(es);Ks=a(JT,"TAPAS-base"),JT.forEach(t),Nt=a(js," for example corresponds to a "),ts=o(js,"CODE",{});var XT=r(ts);Ys=a(XT,"BERT-base"),XT.forEach(t),ss=a(js," architecture. Of course, "),Ue=o(js,"CODE",{});var ZT=r(Ue);as=a(ZT,"TAPAS-large"),ZT.forEach(t),Ee=a(js," will result in the best performance (the results reported in the paper are from "),ns=o(js,"CODE",{});var eb=r(ns);ot=a(eb,"TAPAS-large"),eb.forEach(t),Js=a(js,"). Results of the various sized models are shown on the "),Ot=o(js,"A",{href:!0,rel:!0});var tb=r(Ot);Lt=a(tb,"original Github repository"),tb.forEach(t),Xs=a(js,"."),js.forEach(t),Zs=h(io),Be=o(io,"LI",{});var Mi=r(Be);ea=a(Mi,"TAPAS has checkpoints fine-tuned on SQA, which are capable of answering questions related to a table in a conversational set-up. This means that you can ask follow-up questions such as \u201Cwhat is his age?\u201D related to the previous question. Note that the forward pass of TAPAS is a bit different in case of a conversational set-up: in that case, you have to feed every table-question pair one by one to the model, such that the "),os=o(Mi,"CODE",{});var sb=r(os);rs=a(sb,"prev_labels"),sb.forEach(t),et=a(Mi," token type ids can be overwritten by the predicted "),Qt=o(Mi,"CODE",{});var ab=r(Qt);z=a(ab,"labels"),ab.forEach(t),J=a(Mi," of the model to the previous question. See \u201CUsage\u201D section for more info."),Mi.forEach(t),ya=h(io),ta=o(io,"LI",{});var nb=r(ta);qa=a(nb,"TAPAS is similar to BERT and therefore relies on the masked language modeling (MLM) objective. It is therefore efficient at predicting masked tokens and at NLU in general, but is not optimal for text generation. Models trained with a causal language modeling (CLM) objective are better in that regard. Note that TAPAS can be used as an encoder in the EncoderDecoderModel framework, to combine it with an autoregressive text decoder such as GPT-2."),nb.forEach(t),io.forEach(t),ha=h(i),It=o(i,"H2",{class:!0});var Hp=r(It);st=o(Hp,"A",{id:!0,class:!0,href:!0});var ob=r(st);sa=o(ob,"SPAN",{});var rb=r(sa);q(rt.$$.fragment,rb),rb.forEach(t),ob.forEach(t),ja=h(Hp),aa=o(Hp,"SPAN",{});var ib=r(aa);$a=a(ib,"Usage: fine-tuning"),ib.forEach(t),Hp.forEach(t),ua=h(i),Ie=o(i,"P",{});var Up=r(Ie);is=a(Up,"Here we explain how you can fine-tune "),us=o(Up,"A",{href:!0});var lb=r(us);Re=a(lb,"TapasForQuestionAnswering"),lb.forEach(t),Ea=a(Up," on your own dataset."),Up.forEach(t),ma=h(i),ms=o(i,"P",{});var db=r(ms);na=o(db,"STRONG",{});var pb=r(na);ls=a(pb,"STEP 1: Choose one of the 3 ways in which you can use TAPAS - or experiment"),pb.forEach(t),db.forEach(t),fa=h(i),fe=o(i,"P",{});var Bp=r(fe);Fa=a(Bp,"Basically, there are 3 different ways in which one can fine-tune "),fs=o(Bp,"A",{href:!0});var cb=r(fs);Aa=a(cb,"TapasForQuestionAnswering"),cb.forEach(t),xa=a(Bp,", corresponding to the different datasets on which Tapas was fine-tuned:"),Bp.forEach(t),ga=h(i),Tt=o(i,"OL",{});var Pi=r(Tt);oa=o(Pi,"LI",{});var hb=r(oa);ds=a(hb,"SQA: if you\u2019re interested in asking follow-up questions related to a table, in a conversational set-up. For example if you first ask \u201Cwhat\u2019s the name of the first actor?\u201D then you can ask a follow-up question such as \u201Chow old is he?\u201C. Here, questions do not involve any aggregation (all questions are cell selection questions)."),hb.forEach(t),za=h(Pi),Fe=o(Pi,"LI",{});var Rp=r(Fe);Ca=a(Rp,"WTQ: if you\u2019re not interested in asking questions in a conversational set-up, but rather just asking questions related to a table, which might involve aggregation, such as counting a number of rows, summing up cell values or averaging cell values. You can then for example ask \u201Cwhat\u2019s the total number of goals Cristiano Ronaldo made in his career?\u201C. This case is also called "),ra=o(Rp,"STRONG",{});var ub=r(ra);Ma=a(ub,"weak supervision"),ub.forEach(t),Pa=a(Rp,", since the model itself must learn the appropriate aggregation operator (SUM/COUNT/AVERAGE/NONE) given only the answer to the question as supervision."),Rp.forEach(t),Sa=h(Pi),he=o(Pi,"LI",{});var Gp=r(he);Da=a(Gp,"WikiSQL-supervised: this dataset is based on WikiSQL with the model being given the ground truth aggregation operator during training. This is also called "),ia=o(Gp,"STRONG",{});var mb=r(ia);Na=a(mb,"strong supervision"),mb.forEach(t),Oa=a(Gp,". Here, learning the appropriate aggregation operator is much easier."),Gp.forEach(t),Pi.forEach(t),_a=h(i),gs=o(i,"P",{});var fb=r(gs);La=a(fb,"To summarize:"),fb.forEach(t),Ta=h(i),Ce=o(i,"TABLE",{});var Vp=r(Ce);la=o(Vp,"THEAD",{});var gb=r(la);Wt=o(gb,"TR",{});var Si=r(Wt);da=o(Si,"TH",{});var _b=r(da);el=o(_b,"STRONG",{});var Tb=r(el);Sc=a(Tb,"Task"),Tb.forEach(t),_b.forEach(t),Dc=h(Si),tl=o(Si,"TH",{});var bb=r(tl);sl=o(bb,"STRONG",{});var vb=r(sl);Nc=a(vb,"Example dataset"),vb.forEach(t),bb.forEach(t),Oc=h(Si),al=o(Si,"TH",{});var wb=r(al);nl=o(wb,"STRONG",{});var kb=r(nl);Lc=a(kb,"Description"),kb.forEach(t),wb.forEach(t),Si.forEach(t),gb.forEach(t),Qc=h(Vp),Qa=o(Vp,"TBODY",{});var Di=r(Qa);Ia=o(Di,"TR",{});var Ni=r(Ia);ol=o(Ni,"TD",{});var yb=r(ol);Ic=a(yb,"Conversational"),yb.forEach(t),Wc=h(Ni),rl=o(Ni,"TD",{});var qb=r(rl);Hc=a(qb,"SQA"),qb.forEach(t),Uc=h(Ni),il=o(Ni,"TD",{});var jb=r(il);Bc=a(jb,"Conversational, only cell selection questions"),jb.forEach(t),Ni.forEach(t),Rc=h(Di),Wa=o(Di,"TR",{});var Oi=r(Wa);ll=o(Oi,"TD",{});var $b=r(ll);Gc=a($b,"Weak supervision for aggregation"),$b.forEach(t),Vc=h(Oi),dl=o(Oi,"TD",{});var Eb=r(dl);Kc=a(Eb,"WTQ"),Eb.forEach(t),Yc=h(Oi),pl=o(Oi,"TD",{});var Fb=r(pl);Jc=a(Fb,"Questions might involve aggregation, and the model must learn this given only the answer as supervision"),Fb.forEach(t),Oi.forEach(t),Xc=h(Di),Ha=o(Di,"TR",{});var Li=r(Ha);cl=o(Li,"TD",{});var Ab=r(cl);Zc=a(Ab,"Strong supervision for aggregation"),Ab.forEach(t),eh=h(Li),hl=o(Li,"TD",{});var xb=r(hl);th=a(xb,"WikiSQL-supervised"),xb.forEach(t),sh=h(Li),ul=o(Li,"TD",{});var zb=r(ul);ah=a(zb,"Questions might involve aggregation, and the model must learn this given the gold aggregation operator"),zb.forEach(t),Li.forEach(t),Di.forEach(t),Vp.forEach(t),np=h(i),q(bn.$$.fragment,i),op=h(i),vn=o(i,"P",{});var Kp=r(vn);nh=a(Kp,"What you can also do is start from an already fine-tuned checkpoint. A note here is that the already fine-tuned checkpoint on WTQ has some issues due to the L2-loss which is somewhat brittle. See "),bo=o(Kp,"A",{href:!0,rel:!0});var Cb=r(bo);oh=a(Cb,"here"),Cb.forEach(t),rh=a(Kp," for more info."),Kp.forEach(t),rp=h(i),wn=o(i,"P",{});var Yp=r(wn);ih=a(Yp,"For a list of all pre-trained and fine-tuned TAPAS checkpoints available on HuggingFace\u2019s  hub, see "),vo=o(Yp,"A",{href:!0,rel:!0});var Mb=r(vo);lh=a(Mb,"here"),Mb.forEach(t),dh=a(Yp,"."),Yp.forEach(t),ip=h(i),Br=o(i,"P",{});var Pb=r(Br);ml=o(Pb,"STRONG",{});var Sb=r(ml);ph=a(Sb,"STEP 2: Prepare your data in the SQA format"),Sb.forEach(t),Pb.forEach(t),lp=h(i),kn=o(i,"P",{});var Jp=r(kn);ch=a(Jp,"Second, no matter what you picked above, you should prepare your dataset in the "),wo=o(Jp,"A",{href:!0,rel:!0});var Db=r(wo);hh=a(Db,"SQA"),Db.forEach(t),uh=a(Jp," format. This format is a TSV/CSV file with the following columns:"),Jp.forEach(t),dp=h(i),We=o(i,"UL",{});var at=r(We);Rr=o(at,"LI",{});var AT=r(Rr);fl=o(AT,"CODE",{});var Nb=r(fl);mh=a(Nb,"id"),Nb.forEach(t),fh=a(AT,": optional, id of the table-question pair, for bookkeeping purposes."),AT.forEach(t),gh=h(at),Gr=o(at,"LI",{});var xT=r(Gr);gl=o(xT,"CODE",{});var Ob=r(gl);_h=a(Ob,"annotator"),Ob.forEach(t),Th=a(xT,": optional, id of the person who annotated the table-question pair, for bookkeeping purposes."),xT.forEach(t),bh=h(at),Vr=o(at,"LI",{});var zT=r(Vr);_l=o(zT,"CODE",{});var Lb=r(_l);vh=a(Lb,"position"),Lb.forEach(t),wh=a(zT,": integer indicating if the question is the first, second, third,\u2026 related to the table. Only required in case of conversational setup (SQA). You don\u2019t need this column in case you\u2019re going for WTQ/WikiSQL-supervised."),zT.forEach(t),kh=h(at),Kr=o(at,"LI",{});var CT=r(Kr);Tl=o(CT,"CODE",{});var Qb=r(Tl);yh=a(Qb,"question"),Qb.forEach(t),qh=a(CT,": string"),CT.forEach(t),jh=h(at),Yr=o(at,"LI",{});var MT=r(Yr);bl=o(MT,"CODE",{});var Ib=r(bl);$h=a(Ib,"table_file"),Ib.forEach(t),Eh=a(MT,": string, name of a csv file containing the tabular data"),MT.forEach(t),Fh=h(at),Jr=o(at,"LI",{});var PT=r(Jr);vl=o(PT,"CODE",{});var Wb=r(vl);Ah=a(Wb,"answer_coordinates"),Wb.forEach(t),xh=a(PT,": list of one or more tuples (each tuple being a cell coordinate, i.e. row, column pair that is part of the answer)"),PT.forEach(t),zh=h(at),Xr=o(at,"LI",{});var ST=r(Xr);wl=o(ST,"CODE",{});var Hb=r(wl);Ch=a(Hb,"answer_text"),Hb.forEach(t),Mh=a(ST,": list of one or more strings (each string being a cell value that is part of the answer)"),ST.forEach(t),Ph=h(at),Zr=o(at,"LI",{});var DT=r(Zr);kl=o(DT,"CODE",{});var Ub=r(kl);Sh=a(Ub,"aggregation_label"),Ub.forEach(t),Dh=a(DT,": index of the aggregation operator. Only required in case of strong supervision for aggregation (the WikiSQL-supervised case)"),DT.forEach(t),Nh=h(at),ei=o(at,"LI",{});var NT=r(ei);yl=o(NT,"CODE",{});var Bb=r(yl);Oh=a(Bb,"float_answer"),Bb.forEach(t),Lh=a(NT,": the float answer to the question, if there is one (np.nan if there isn\u2019t). Only required in case of weak supervision for aggregation (such as WTQ and WikiSQL)"),NT.forEach(t),at.forEach(t),pp=h(i),bt=o(i,"P",{});var $s=r(bt);Qh=a($s,"The tables themselves should be present in a folder, each table being a separate csv file. Note that the authors of the TAPAS algorithm used conversion scripts with some automated logic to convert the other datasets (WTQ, WikiSQL) into the SQA format. The author explains this "),ko=o($s,"A",{href:!0,rel:!0});var Rb=r(ko);Ih=a(Rb,"here"),Rb.forEach(t),Wh=a($s,". A conversion of this script that works with HuggingFace\u2019s implementation can be found "),yo=o($s,"A",{href:!0,rel:!0});var Gb=r(yo);Hh=a(Gb,"here"),Gb.forEach(t),Uh=a($s,". Interestingly, these conversion scripts are not perfect (the "),ql=o($s,"CODE",{});var Vb=r(ql);Bh=a(Vb,"answer_coordinates"),Vb.forEach(t),Rh=a($s," and "),jl=o($s,"CODE",{});var Kb=r(jl);Gh=a(Kb,"float_answer"),Kb.forEach(t),Vh=a($s," fields are populated based on the "),$l=o($s,"CODE",{});var Yb=r($l);Kh=a(Yb,"answer_text"),Yb.forEach(t),Yh=a($s,"), meaning that WTQ and WikiSQL results could actually be improved."),$s.forEach(t),cp=h(i),ti=o(i,"P",{});var Jb=r(ti);El=o(Jb,"STRONG",{});var Xb=r(El);Jh=a(Xb,"STEP 3: Convert your data into tensors using TapasTokenizer"),Xb.forEach(t),Jb.forEach(t),hp=h(i),q(yn.$$.fragment,i),up=h(i),Se=o(i,"P",{});var Je=r(Se);Xh=a(Je,"Note that here, we encode each table-question pair independently. This is fine as long as your dataset is "),Fl=o(Je,"STRONG",{});var Zb=r(Fl);Zh=a(Zb,"not conversational"),Zb.forEach(t),eu=a(Je,". In case your dataset involves conversational questions (such as in SQA), then you should first group together the "),Al=o(Je,"CODE",{});var ev=r(Al);tu=a(ev,"queries"),ev.forEach(t),su=a(Je,", "),xl=o(Je,"CODE",{});var tv=r(xl);au=a(tv,"answer_coordinates"),tv.forEach(t),nu=a(Je," and "),zl=o(Je,"CODE",{});var sv=r(zl);ou=a(sv,"answer_text"),sv.forEach(t),ru=a(Je," per table (in the order of their "),Cl=o(Je,"CODE",{});var av=r(Cl);iu=a(av,"position"),av.forEach(t),lu=a(Je,`
index) and batch encode each table with its questions. This will make sure that the `),Ml=o(Je,"CODE",{});var nv=r(Ml);du=a(nv,"prev_labels"),nv.forEach(t),pu=a(Je," token types (see docs of "),si=o(Je,"A",{href:!0});var ov=r(si);cu=a(ov,"TapasTokenizer"),ov.forEach(t),hu=a(Je,") are set correctly. See "),qo=o(Je,"A",{href:!0,rel:!0});var rv=r(qo);uu=a(rv,"this notebook"),rv.forEach(t),mu=a(Je," for more info. See "),jo=o(Je,"A",{href:!0,rel:!0});var iv=r(jo);fu=a(iv,"this notebook"),iv.forEach(t),gu=a(Je," for more info regarding using the TensorFlow model."),Je.forEach(t),mp=h(i),ai=o(i,"P",{});var lv=r(ai);_u=a(lv,"**STEP 4: Train (fine-tune) the model"),lv.forEach(t),fp=h(i),q(qn.$$.fragment,i),gp=h(i),Ua=o(i,"H2",{class:!0});var Xp=r(Ua);jn=o(Xp,"A",{id:!0,class:!0,href:!0});var dv=r(jn);Pl=o(dv,"SPAN",{});var pv=r(Pl);q($o.$$.fragment,pv),pv.forEach(t),dv.forEach(t),Tu=h(Xp),Sl=o(Xp,"SPAN",{});var cv=r(Sl);bu=a(cv,"Usage: inference"),cv.forEach(t),Xp.forEach(t),_p=h(i),q($n.$$.fragment,i),Tp=h(i),vt=o(i,"P",{});var Es=r(vt);vu=a(Es,"In case of a conversational set-up, then each table-question pair must be provided "),Dl=o(Es,"STRONG",{});var hv=r(Dl);wu=a(hv,"sequentially"),hv.forEach(t),ku=a(Es," to the model, such that the "),Nl=o(Es,"CODE",{});var uv=r(Nl);yu=a(uv,"prev_labels"),uv.forEach(t),qu=a(Es," token types can be overwritten by the predicted "),Ol=o(Es,"CODE",{});var mv=r(Ol);ju=a(mv,"labels"),mv.forEach(t),$u=a(Es," of the previous table-question pair. Again, more info can be found in "),Eo=o(Es,"A",{href:!0,rel:!0});var fv=r(Eo);Eu=a(fv,"this notebook"),fv.forEach(t),Fu=a(Es," (for PyTorch) and "),Fo=o(Es,"A",{href:!0,rel:!0});var gv=r(Fo);Au=a(gv,"this notebook"),gv.forEach(t),xu=a(Es," (for TensorFlow)."),Es.forEach(t),bp=h(i),Ba=o(i,"H2",{class:!0});var Zp=r(Ba);En=o(Zp,"A",{id:!0,class:!0,href:!0});var _v=r(En);Ll=o(_v,"SPAN",{});var Tv=r(Ll);q(Ao.$$.fragment,Tv),Tv.forEach(t),_v.forEach(t),zu=h(Zp),Ql=o(Zp,"SPAN",{});var bv=r(Ql);Cu=a(bv,"TAPAS specific outputs"),bv.forEach(t),Zp.forEach(t),vp=h(i),Ra=o(i,"DIV",{class:!0});var ec=r(Ra);q(xo.$$.fragment,ec),Mu=h(ec),zo=o(ec,"P",{});var tc=r(zo);Pu=a(tc,"Output type of "),ni=o(tc,"A",{href:!0});var vv=r(ni);Su=a(vv,"TapasForQuestionAnswering"),vv.forEach(t),Du=a(tc,"."),tc.forEach(t),ec.forEach(t),wp=h(i),Ga=o(i,"H2",{class:!0});var sc=r(Ga);Fn=o(sc,"A",{id:!0,class:!0,href:!0});var wv=r(Fn);Il=o(wv,"SPAN",{});var kv=r(Il);q(Co.$$.fragment,kv),kv.forEach(t),wv.forEach(t),Nu=h(sc),Wl=o(sc,"SPAN",{});var yv=r(Wl);Ou=a(yv,"TapasConfig"),yv.forEach(t),sc.forEach(t),kp=h(i),Ht=o(i,"DIV",{class:!0});var va=r(Ht);q(Mo.$$.fragment,va),Lu=h(va),Va=o(va,"P",{});var Qi=r(Va);Qu=a(Qi,"This is the configuration class to store the configuration of a "),oi=o(Qi,"A",{href:!0});var qv=r(oi);Iu=a(qv,"TapasModel"),qv.forEach(t),Wu=a(Qi,`. It is used to instantiate a TAPAS
model according to the specified arguments, defining the model architecture. Instantiating a configuration with the
defaults will yield a similar configuration to that of the TAPAS
`),Po=o(Qi,"A",{href:!0,rel:!0});var jv=r(Po);Hu=a(jv,"google/tapas-base-finetuned-sqa"),jv.forEach(t),Uu=a(Qi," architecture."),Qi.forEach(t),Bu=h(va),Ka=o(va,"P",{});var Ii=r(Ka);Ru=a(Ii,"Configuration objects inherit from "),Hl=o(Ii,"CODE",{});var $v=r(Hl);Gu=a($v,"PreTrainedConfig"),$v.forEach(t),Vu=a(Ii,` and can be used to control the model outputs. Read the
documentation from `),ri=o(Ii,"A",{href:!0});var Ev=r(ri);Ku=a(Ev,"PretrainedConfig"),Ev.forEach(t),Yu=a(Ii," for more information."),Ii.forEach(t),Ju=h(va),So=o(va,"P",{});var ac=r(So);Xu=a(ac,`Hyperparameters additional to BERT are taken from run_task_main.py and hparam_utils.py of the original
implementation. Original implementation available at `),Do=o(ac,"A",{href:!0,rel:!0});var Fv=r(Do);Zu=a(Fv,"https://github.com/google-research/tapas/tree/master"),Fv.forEach(t),em=a(ac,"."),ac.forEach(t),tm=h(va),q(An.$$.fragment,va),va.forEach(t),yp=h(i),Ya=o(i,"H2",{class:!0});var nc=r(Ya);xn=o(nc,"A",{id:!0,class:!0,href:!0});var Av=r(xn);Ul=o(Av,"SPAN",{});var xv=r(Ul);q(No.$$.fragment,xv),xv.forEach(t),Av.forEach(t),sm=h(nc),Bl=o(nc,"SPAN",{});var zv=r(Bl);am=a(zv,"TapasTokenizer"),zv.forEach(t),nc.forEach(t),qp=h(i),Ge=o(i,"DIV",{class:!0});var wt=r(Ge);q(Oo.$$.fragment,wt),nm=h(wt),Rl=o(wt,"P",{});var Cv=r(Rl);om=a(Cv,`Construct a TAPAS tokenizer. Based on WordPiece. Flattens a table and one or more related sentences to be used by
TAPAS models.`),Cv.forEach(t),rm=h(wt),Qe=o(wt,"P",{});var Xe=r(Qe);im=a(Xe,"This tokenizer inherits from "),ii=o(Xe,"A",{href:!0});var Mv=r(ii);lm=a(Mv,"PreTrainedTokenizer"),Mv.forEach(t),dm=a(Xe,` which contains most of the main methods. Users should refer to
this superclass for more information regarding those methods. `),li=o(Xe,"A",{href:!0});var Pv=r(li);pm=a(Pv,"TapasTokenizer"),Pv.forEach(t),cm=a(Xe,` creates several token type ids to
encode tabular structure. To be more precise, it adds 7 token type ids, in the following order: `),Gl=o(Xe,"CODE",{});var Sv=r(Gl);hm=a(Sv,"segment_ids"),Sv.forEach(t),um=a(Xe,`,
`),Vl=o(Xe,"CODE",{});var Dv=r(Vl);mm=a(Dv,"column_ids"),Dv.forEach(t),fm=a(Xe,", "),Kl=o(Xe,"CODE",{});var Nv=r(Kl);gm=a(Nv,"row_ids"),Nv.forEach(t),_m=a(Xe,", "),Yl=o(Xe,"CODE",{});var Ov=r(Yl);Tm=a(Ov,"prev_labels"),Ov.forEach(t),bm=a(Xe,", "),Jl=o(Xe,"CODE",{});var Lv=r(Jl);vm=a(Lv,"column_ranks"),Lv.forEach(t),wm=a(Xe,", "),Xl=o(Xe,"CODE",{});var Qv=r(Xl);km=a(Qv,"inv_column_ranks"),Qv.forEach(t),ym=a(Xe," and "),Zl=o(Xe,"CODE",{});var Iv=r(Zl);qm=a(Iv,"numeric_relations"),Iv.forEach(t),jm=a(Xe,":"),Xe.forEach(t),$m=h(wt),it=o(wt,"UL",{});var Yt=r(it);ed=o(Yt,"LI",{});var Wv=r(ed);Em=a(Wv,`segment_ids: indicate whether a token belongs to the question (0) or the table (1). 0 for special tokens and
padding.`),Wv.forEach(t),Fm=h(Yt),td=o(Yt,"LI",{});var Hv=r(td);Am=a(Hv,`column_ids: indicate to which column of the table a token belongs (starting from 1). Is 0 for all question
tokens, special tokens and padding.`),Hv.forEach(t),xm=h(Yt),sd=o(Yt,"LI",{});var Uv=r(sd);zm=a(Uv,`row_ids: indicate to which row of the table a token belongs (starting from 1). Is 0 for all question tokens,
special tokens and padding. Tokens of column headers are also 0.`),Uv.forEach(t),Cm=h(Yt),ad=o(Yt,"LI",{});var Bv=r(ad);Mm=a(Bv,`prev_labels: indicate whether a token was (part of) an answer to the previous question (1) or not (0). Useful in
a conversational setup (such as SQA).`),Bv.forEach(t),Pm=h(Yt),nd=o(Yt,"LI",{});var Rv=r(nd);Sm=a(Rv,`column_ranks: indicate the rank of a table token relative to a column, if applicable. For example, if you have a
column \u201Cnumber of movies\u201D with values 87, 53 and 69, then the column ranks of these tokens are 3, 1 and 2
respectively. 0 for all question tokens, special tokens and padding.`),Rv.forEach(t),Dm=h(Yt),od=o(Yt,"LI",{});var Gv=r(od);Nm=a(Gv,`inv_column_ranks: indicate the inverse rank of a table token relative to a column, if applicable. For example, if
you have a column \u201Cnumber of movies\u201D with values 87, 53 and 69, then the inverse column ranks of these tokens are
1, 3 and 2 respectively. 0 for all question tokens, special tokens and padding.`),Gv.forEach(t),Om=h(Yt),rd=o(Yt,"LI",{});var Vv=r(rd);Lm=a(Vv,`numeric_relations: indicate numeric relations between the question and the tokens of the table. 0 for all
question tokens, special tokens and padding.`),Vv.forEach(t),Yt.forEach(t),Qm=h(wt),di=o(wt,"P",{});var OT=r(di);pi=o(OT,"A",{href:!0});var Kv=r(pi);Im=a(Kv,"TapasTokenizer"),Kv.forEach(t),Wm=a(OT,` runs end-to-end tokenization on a table and associated sentences: punctuation splitting and
wordpiece.`),OT.forEach(t),Hm=h(wt),zn=o(wt,"DIV",{class:!0});var oc=r(zn);q(Lo.$$.fragment,oc),Um=h(oc),id=o(oc,"P",{});var Yv=r(id);Bm=a(Yv,"Main method to tokenize and prepare for the model one or several sequence(s) related to a table."),Yv.forEach(t),oc.forEach(t),Rm=h(wt),ba=o(wt,"DIV",{class:!0});var Wi=r(ba);q(Qo.$$.fragment,Wi),Gm=h(Wi),Io=o(Wi,"P",{});var rc=r(Io);Vm=a(rc,"Converts logits of "),ci=o(rc,"A",{href:!0});var Jv=r(ci);Km=a(Jv,"TapasForQuestionAnswering"),Jv.forEach(t),Ym=a(rc,` to actual predicted answer coordinates and optional
aggregation indices.`),rc.forEach(t),Jm=h(Wi),Wo=o(Wi,"P",{});var ic=r(Wo);Xm=a(ic,`The original implementation, on which this function is based, can be found
`),Ho=o(ic,"A",{href:!0,rel:!0});var Xv=r(Ho);Zm=a(Xv,"here"),Xv.forEach(t),ef=a(ic,"."),ic.forEach(t),Wi.forEach(t),tf=h(wt),hi=o(wt,"DIV",{class:!0});var Zv=r(hi);q(Uo.$$.fragment,Zv),Zv.forEach(t),wt.forEach(t),jp=h(i),Ja=o(i,"H2",{class:!0});var lc=r(Ja);Cn=o(lc,"A",{id:!0,class:!0,href:!0});var ew=r(Cn);ld=o(ew,"SPAN",{});var tw=r(ld);q(Bo.$$.fragment,tw),tw.forEach(t),ew.forEach(t),sf=h(lc),dd=o(lc,"SPAN",{});var sw=r(dd);af=a(sw,"TapasModel"),sw.forEach(t),lc.forEach(t),$p=h(i),lt=o(i,"DIV",{class:!0});var Fs=r(lt);q(Ro.$$.fragment,Fs),nf=h(Fs),Go=o(Fs,"P",{});var dc=r(Go);of=a(dc,`The bare Tapas Model transformer outputting raw hidden-states without any specific head on top.
This model inherits from `),ui=o(dc,"A",{href:!0});var aw=r(ui);rf=a(aw,"PreTrainedModel"),aw.forEach(t),lf=a(dc,`. Check the superclass documentation for the generic methods the
library implements for all its models (such as downloading or saving, resizing the input embeddings, pruning heads
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),pc.forEach(t),uf=h(Fs),Yo=o(Fs,"P",{});var cc=r(Yo);mf=a(cc,"This class is a small change compared to "),mi=o(cc,"A",{href:!0});var ow=r(mi);ff=a(ow,"BertModel"),ow.forEach(t),gf=a(cc,", taking into account the additional token type ids."),cc.forEach(t),_f=h(Fs),Jo=o(Fs,"P",{});var hc=r(Jo);Tf=a(hc,`The model can behave as an encoder (with only self-attention) as well as a decoder, in which case a layer of
...
Llion Jones, Aidan N. Gomez, Lukasz Kaiser and Illia Polosukhin.`),hc.forEach(t),wf=h(Fs),_s=o(Fs,"DIV",{class:!0});var lo=r(_s);q(Zo.$$.fragment,lo),kf=h(lo),Xa=o(lo,"P",{});var Hi=r(Xa);yf=a(Hi,"The "),fi=o(Hi,"A",{href:!0});var iw=r(fi);qf=a(iw,"TapasModel"),iw.forEach(t),jf=a(Hi," forward method, overrides the "),pd=o(Hi,"CODE",{});var lw=r(pd);$f=a(lw,"__call__"),lw.forEach(t),Ef=a(Hi," special method."),Hi.forEach(t),Ff=h(lo),q(Mn.$$.fragment,lo),Af=h(lo),q(Pn.$$.fragment,lo),lo.forEach(t),Fs.forEach(t),Ep=h(i),Za=o(i,"H2",{class:!0});var uc=r(Za);Sn=o(uc,"A",{id:!0,class:!0,href:!0});var dw=r(Sn);cd=o(dw,"SPAN",{});var pw=r(cd);q(er.$$.fragment,pw),pw.forEach(t),dw.forEach(t),xf=h(uc),hd=o(uc,"SPAN",{});var cw=r(hd);zf=a(cw,"TapasForMaskedLM"),cw.forEach(t),uc.forEach(t),Fp=h(i),ps=o(i,"DIV",{class:!0});var po=r(ps);q(tr.$$.fragment,po),Cf=h(po),en=o(po,"P",{});var Ui=r(en);Mf=a(Ui,"Tapas Model with a "),ud=o(Ui,"CODE",{});var hw=r(ud);Pf=a(hw,"language modeling"),hw.forEach(t),Sf=a(Ui,` head on top.
This model inherits from `),gi=o(Ui,"A",{href:!0});var uw=r(gi);Df=a(uw,"PreTrainedModel"),uw.forEach(t),Nf=a(Ui,`. Check the superclass documentation for the generic methods the
library implements for all its models (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Ui.forEach(t),Of=h(po),sr=o(po,"P",{});var mc=r(sr);Lf=a(mc,"This model is also a PyTorch "),ar=o(mc,"A",{href:!0,rel:!0});var mw=r(ar);Qf=a(mw,"torch.nn.Module"),mw.forEach(t),If=a(mc,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),mc.forEach(t),Wf=h(po),Ts=o(po,"DIV",{class:!0});var co=r(Ts);q(nr.$$.fragment,co),Hf=h(co),tn=o(co,"P",{});var Bi=r(tn);Uf=a(Bi,"The "),_i=o(Bi,"A",{href:!0});var fw=r(_i);Bf=a(fw,"TapasForMaskedLM"),fw.forEach(t),Rf=a(Bi," forward method, overrides the "),md=o(Bi,"CODE",{});var gw=r(md);Gf=a(gw,"__call__"),gw.forEach(t),Vf=a(Bi," special method."),Bi.forEach(t),Kf=h(co),q(Dn.$$.fragment,co),Yf=h(co),q(Nn.$$.fragment,co),co.forEach(t),po.forEach(t),Ap=h(i),sn=o(i,"H2",{class:!0});var fc=r(sn);On=o(fc,"A",{id:!0,class:!0,href:!0});var _w=r(On);fd=o(_w,"SPAN",{});var Tw=r(fd);q(or.$$.fragment,Tw),Tw.forEach(t),_w.forEach(t),Jf=h(fc),gd=o(fc,"SPAN",{});var bw=r(gd);Xf=a(bw,"TapasForSequenceClassification"),bw.forEach(t),fc.forEach(t),xp=h(i),Ut=o(i,"DIV",{class:!0});var wa=r(Ut);q(rr.$$.fragment,wa),Zf=h(wa),_d=o(wa,"P",{});var vw=r(_d);eg=a(vw,`Tapas Model with a sequence classification head on top (a linear layer on top of the pooled output), e.g. for table
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),_c.forEach(t),dg=h(wa),bs=o(wa,"DIV",{class:!0});var ho=r(bs);q(pr.$$.fragment,ho),pg=h(ho),an=o(ho,"P",{});var Ri=r(an);cg=a(Ri,"The "),bi=o(Ri,"A",{href:!0});var yw=r(bi);hg=a(yw,"TapasForSequenceClassification"),yw.forEach(t),ug=a(Ri," forward method, overrides the "),Td=o(Ri,"CODE",{});var qw=r(Td);mg=a(qw,"__call__"),qw.forEach(t),fg=a(Ri," special method."),Ri.forEach(t),gg=h(ho),q(Ln.$$.fragment,ho),_g=h(ho),q(Qn.$$.fragment,ho),ho.forEach(t),wa.forEach(t),zp=h(i),nn=o(i,"H2",{class:!0});var Tc=r(nn);In=o(Tc,"A",{id:!0,class:!0,href:!0});var jw=r(In);bd=o(jw,"SPAN",{});var $w=r(bd);q(cr.$$.fragment,$w),$w.forEach(t),jw.forEach(t),Tg=h(Tc),vd=o(Tc,"SPAN",{});var Ew=r(vd);bg=a(Ew,"TapasForQuestionAnswering"),Ew.forEach(t),Tc.forEach(t),Cp=h(i),Bt=o(i,"DIV",{class:!0});var ka=r(Bt);q(hr.$$.fragment,ka),vg=h(ka),on=o(ka,"P",{});var Gi=r(on);wg=a(Gi,`Tapas Model with a cell selection head and optional aggregation head on top for question-answering tasks on tables
(linear layers on top of the hidden-states output to compute `),wd=o(Gi,"CODE",{});var Fw=r(wd);kg=a(Fw,"logits"),Fw.forEach(t),yg=a(Gi," and optional "),kd=o(Gi,"CODE",{});var Aw=r(kd);qg=a(Aw,"logits_aggregation"),Aw.forEach(t),jg=a(Gi,`), e.g. for
SQA, WTQ or WikiSQL-supervised tasks.`),Gi.forEach(t),$g=h(ka),ur=o(ka,"P",{});var bc=r(ur);Eg=a(bc,"This model inherits from "),vi=o(bc,"A",{href:!0});var xw=r(vi);Fg=a(xw,"PreTrainedModel"),xw.forEach(t),Ag=a(bc,`. Check the superclass documentation for the generic methods the
library implements for all its models (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),bc.forEach(t),xg=h(ka),mr=o(ka,"P",{});var vc=r(mr);zg=a(vc,"This model is also a PyTorch "),fr=o(vc,"A",{href:!0,rel:!0});var zw=r(fr);Cg=a(zw,"torch.nn.Module"),zw.forEach(t),Mg=a(vc,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),vc.forEach(t),Pg=h(ka),vs=o(ka,"DIV",{class:!0});var uo=r(vs);q(gr.$$.fragment,uo),Sg=h(uo),rn=o(uo,"P",{});var Vi=r(rn);Dg=a(Vi,"The "),wi=o(Vi,"A",{href:!0});var Cw=r(wi);Ng=a(Cw,"TapasForQuestionAnswering"),Cw.forEach(t),Og=a(Vi," forward method, overrides the "),yd=o(Vi,"CODE",{});var Mw=r(yd);Lg=a(Mw,"__call__"),Mw.forEach(t),Qg=a(Vi," special method."),Vi.forEach(t),Ig=h(uo),q(Wn.$$.fragment,uo),Wg=h(uo),q(Hn.$$.fragment,uo),uo.forEach(t),ka.forEach(t),Mp=h(i),ln=o(i,"H2",{class:!0});var wc=r(ln);Un=o(wc,"A",{id:!0,class:!0,href:!0});var Pw=r(Un);qd=o(Pw,"SPAN",{});var Sw=r(qd);q(_r.$$.fragment,Sw),Sw.forEach(t),Pw.forEach(t),Hg=h(wc),jd=o(wc,"SPAN",{});var Dw=r(jd);Ug=a(Dw,"TFTapasModel"),Dw.forEach(t),wc.forEach(t),Pp=h(i),dt=o(i,"DIV",{class:!0});var As=r(dt);q(Tr.$$.fragment,As),Bg=h(As),$d=o(As,"P",{});var Nw=r($d);Rg=a(Nw,"The bare Tapas Model transformer outputting raw hidden-states without any specific head on top."),Nw.forEach(t),Gg=h(As),br=o(As,"P",{});var kc=r(br);Vg=a(kc,"This model inherits from "),ki=o(kc,"A",{href:!0});var Ow=r(ki);Kg=a(Ow,"TFPreTrainedModel"),Ow.forEach(t),Yg=a(kc,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),yc.forEach(t),t_=h(As),q(Bn.$$.fragment,As),s_=h(As),ws=o(As,"DIV",{class:!0});var mo=r(ws);q(kr.$$.fragment,mo),a_=h(mo),dn=o(mo,"P",{});var Ki=r(dn);n_=a(Ki,"The "),yi=o(Ki,"A",{href:!0});var Qw=r(yi);o_=a(Qw,"TFTapasModel"),Qw.forEach(t),r_=a(Ki," forward method, overrides the "),Ed=o(Ki,"CODE",{});var Iw=r(Ed);i_=a(Iw,"__call__"),Iw.forEach(t),l_=a(Ki," special method."),Ki.forEach(t),d_=h(mo),q(Rn.$$.fragment,mo),p_=h(mo),q(Gn.$$.fragment,mo),mo.forEach(t),As.forEach(t),Sp=h(i),pn=o(i,"H2",{class:!0});var qc=r(pn);Vn=o(qc,"A",{id:!0,class:!0,href:!0});var Ww=r(Vn);Fd=o(Ww,"SPAN",{});var Hw=r(Fd);q(yr.$$.fragment,Hw),Hw.forEach(t),Ww.forEach(t),c_=h(qc),Ad=o(qc,"SPAN",{});var Uw=r(Ad);h_=a(Uw,"TFTapasForMaskedLM"),Uw.forEach(t),qc.forEach(t),Dp=h(i),pt=o(i,"DIV",{class:!0});var xs=r(pt);q(qr.$$.fragment,xs),u_=h(xs),jr=o(xs,"P",{});var jc=r(jr);m_=a(jc,"Tapas Model with a "),xd=o(jc,"CODE",{});var Bw=r(xd);f_=a(Bw,"language modeling"),Bw.forEach(t),g_=a(jc," head on top."),jc.forEach(t),__=h(xs),$r=o(xs,"P",{});var $c=r($r);T_=a($c,"This model inherits from "),qi=o($c,"A",{href:!0});var Rw=r(qi);b_=a(Rw,"TFPreTrainedModel"),Rw.forEach(t),v_=a($c,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),$c.forEach(t),w_=h(xs),Er=o(xs,"P",{});var Ec=r(Er);k_=a(Ec,"This model is also a "),Fr=o(Ec,"A",{href:!0,rel:!0});var Gw=r(Fr);y_=a(Gw,"tf.keras.Model"),Gw.forEach(t),q_=a(Ec,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
...
SQA, WTQ or WikiSQL-supervised tasks.`),Xi.forEach(t),cT=h(Cs),Or=o(Cs,"P",{});var Cc=r(Or);hT=a(Cc,"This model inherits from "),Fi=o(Cc,"A",{href:!0});var dk=r(Fi);uT=a(dk,"TFPreTrainedModel"),dk.forEach(t),mT=a(Cc,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
