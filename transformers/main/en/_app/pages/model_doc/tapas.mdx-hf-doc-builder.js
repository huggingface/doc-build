...
<span class="hljs-meta">... </span>    tf.TensorSpec(shape=(<span class="hljs-number">512</span>,), dtype=tf.float32),
<span class="hljs-meta">... </span>)
<span class="hljs-meta">&gt;&gt;&gt; </span>train_dataloader = tf.data.Dataset.from_generator(train_dataset, output_signature=output_signature).batch(<span class="hljs-number">32</span>)`}}),{c(){l=o("p"),T=s("Third, given that you\u2019ve prepared your data in this TSV/CSV format (and corresponding CSV files containing the tabular data), you can then use "),d=o("a"),g=s("TapasTokenizer"),b=s(" to convert table-question pairs into "),p=o("code"),f=s("input_ids"),x=s(", "),k=o("code"),W=s("attention_mask"),O=s(", "),G=o("code"),ae=s("token_type_ids"),v=s(" and so on. Again, based on which of the three cases you picked above, "),J=o("a"),Z=s("TFTapasForQuestionAnswering"),de=s(` requires different
inputs to be fine-tuned:`),U=c(),N=o("table"),y=o("thead"),C=o("tr"),B=o("th"),ee=o("strong"),pe=s("Task"),R=c(),ge=o("th"),he=o("strong"),X=s("Required inputs"),_e=c(),D=o("tbody"),L=o("tr"),I=o("td"),M=s("Conversational"),K=c(),H=o("td"),ve=o("code"),xe=s("input_ids"),ue=s(", "),fe=o("code"),Ae=s("attention_mask"),se=s(", "),ke=o("code"),Te=s("token_type_ids"),Pe=s(", "),Ce=o("code"),je=s("labels"),Me=c(),$e=o("tr"),ce=o("td"),Se=s("Weak supervision for aggregation"),ye=c(),Y=o("td"),qe=o("code"),V=s("input_ids"),We=s(", "),oe=o("code"),He=s("attention_mask"),Ue=s(", "),w=o("code"),S=s("token_type_ids"),Ve=s(", "),be=o("code"),Ye=s("labels"),Je=s(", "),Q=o("code"),Le=s("numeric_values"),ot=s(", "),Qe=o("code"),Ie=s("numeric_values_scale"),Xe=s(", "),le=o("code"),Ee=s("float_answer"),Ze=c(),ze=o("tr"),ne=o("td"),et=s("Strong supervision for aggregation"),Be=c(),re=o("td"),Re=o("code"),Fe=s("input ids"),tt=s(", "),Pt=o("code"),Mt=s("attention mask"),Ws=s(", "),St=o("code"),bs=s("token type ids"),ts=s(", "),Dt=o("code"),ws=s("labels"),ut=s(", "),De=o("code"),Hs=s("aggregation_labels"),Ot=c(),ie=o("p"),bt=o("a"),ss=s("TapasTokenizer"),Us=s(" creates the "),Nt=o("code"),ns=s("labels"),Bs=s(", "),Lt=o("code"),Qt=s("numeric_values"),Rs=s(" and "),It=o("code"),rs=s("numeric_values_scale"),Gs=s(" based on the "),Wt=o("code"),is=s("answer_coordinates"),Ks=s(" and "),Ht=o("code"),Vs=s("answer_text"),st=s(" columns of the TSV file. The "),Ut=o("code"),ls=s("float_answer"),Ys=s(" and "),Bt=o("code"),ds=s("aggregation_labels"),Js=s(" are already in the TSV file of step 2. Here\u2019s an example:"),ps=c(),j(lt.$$.fragment),cs=c(),Oe=o("p"),hs=s("Note that "),wt=o("a"),Xs=s("TapasTokenizer"),Rt=s(" expects the data of the table to be "),Gt=o("strong"),Zs=s("text-only"),ea=s(". You can use "),dt=o("code"),ta=s(".astype(str)"),us=s(` on a dataframe to turn it into text-only data.
...
inputs to be fine-tuned:`),te.forEach(t),U=h(z),N=n(z,"TABLE",{});var _t=r(N);y=n(_t,"THEAD",{});var aa=r(y);C=n(aa,"TR",{});var vt=r(C);B=n(vt,"TH",{});var qa=r(B);ee=n(qa,"STRONG",{});var oa=r(ee);pe=a(oa,"Task"),oa.forEach(t),qa.forEach(t),R=h(vt),ge=n(vt,"TH",{});var $a=r(ge);he=n($a,"STRONG",{});var ua=r(he);X=a(ua,"Required inputs"),ua.forEach(t),$a.forEach(t),vt.forEach(t),aa.forEach(t),_e=h(_t),D=n(_t,"TBODY",{});var nt=r(D);L=n(nt,"TR",{});var fs=r(L);I=n(fs,"TD",{});var vs=r(I);M=a(vs,"Conversational"),vs.forEach(t),K=h(fs),H=n(fs,"TD",{});var pt=r(H);ve=n(pt,"CODE",{});var Ea=r(ve);xe=a(Ea,"input_ids"),Ea.forEach(t),ue=a(pt,", "),fe=n(pt,"CODE",{});var ma=r(fe);Ae=a(ma,"attention_mask"),ma.forEach(t),se=a(pt,", "),ke=n(pt,"CODE",{});var ys=r(ke);Te=a(ys,"token_type_ids"),ys.forEach(t),Pe=a(pt,", "),Ce=n(pt,"CODE",{});var na=r(Ce);je=a(na,"labels"),na.forEach(t),pt.forEach(t),fs.forEach(t),Me=h(nt),$e=n(nt,"TR",{});var gs=r($e);ce=n(gs,"TD",{});var fa=r(ce);Se=a(fa,"Weak supervision for aggregation"),fa.forEach(t),ye=h(gs),Y=n(gs,"TD",{});var we=r(Y);qe=n(we,"CODE",{});var Fa=r(qe);V=a(Fa,"input_ids"),Fa.forEach(t),We=a(we,", "),oe=n(we,"CODE",{});var ks=r(oe);He=a(ks,"attention_mask"),ks.forEach(t),Ue=a(we,", "),w=n(we,"CODE",{});var Aa=r(w);S=a(Aa,"token_type_ids"),Aa.forEach(t),Ve=a(we,", "),be=n(we,"CODE",{});var xa=r(be);Ye=a(xa,"labels"),xa.forEach(t),Je=a(we,", "),Q=n(we,"CODE",{});var ga=r(Q);Le=a(ga,"numeric_values"),ga.forEach(t),ot=a(we,", "),Qe=n(we,"CODE",{});var At=r(Qe);Ie=a(At,"numeric_values_scale"),At.forEach(t),Xe=a(we,", "),le=n(we,"CODE",{});var ra=r(le);Ee=a(ra,"float_answer"),ra.forEach(t),we.forEach(t),gs.forEach(t),Ze=h(nt),ze=n(nt,"TR",{});var _s=r(ze);ne=n(_s,"TD",{});var za=r(ne);et=a(za,"Strong supervision for aggregation"),za.forEach(t),Be=h(_s),re=n(_s,"TD",{});var Ne=r(re);Re=n(Ne,"CODE",{});var Ca=r(Re);Fe=a(Ca,"input ids"),Ca.forEach(t),tt=a(Ne,", "),Pt=n(Ne,"CODE",{});var ia=r(Pt);Mt=a(ia,"attention mask"),ia.forEach(t),Ws=a(Ne,", "),St=n(Ne,"CODE",{});var Pa=r(St);bs=a(Pa,"token type ids"),Pa.forEach(t),ts=a(Ne,", "),Dt=n(Ne,"CODE",{});var Ma=r(Dt);ws=a(Ma,"labels"),Ma.forEach(t),ut=a(Ne,", "),De=n(Ne,"CODE",{});var Sa=r(De);Hs=a(Sa,"aggregation_labels"),Sa.forEach(t),Ne.forEach(t),_s.forEach(t),nt.forEach(t),_t.forEach(t),Ot=h(z),ie=n(z,"P",{});var me=r(ie);bt=n(me,"A",{href:!0});var Da=r(bt);ss=a(Da,"TapasTokenizer"),Da.forEach(t),Us=a(me," creates the "),Nt=n(me,"CODE",{});var la=r(Nt);ns=a(la,"labels"),la.forEach(t),Bs=a(me,", "),Lt=n(me,"CODE",{});var Oa=r(Lt);Qt=a(Oa,"numeric_values"),Oa.forEach(t),Rs=a(me," and "),It=n(me,"CODE",{});var Na=r(It);rs=a(Na,"numeric_values_scale"),Na.forEach(t),Gs=a(me," based on the "),Wt=n(me,"CODE",{});var _a=r(Wt);is=a(_a,"answer_coordinates"),_a.forEach(t),Ks=a(me," and "),Ht=n(me,"CODE",{});var js=r(Ht);Vs=a(js,"answer_text"),js.forEach(t),st=a(me," columns of the TSV file. The "),Ut=n(me,"CODE",{});var La=r(Ut);ls=a(La,"float_answer"),La.forEach(t),Ys=a(me," and "),Bt=n(me,"CODE",{});var Ta=r(Bt);ds=a(Ta,"aggregation_labels"),Ta.forEach(t),Js=a(me," are already in the TSV file of step 2. Here\u2019s an example:"),me.forEach(t),ps=h(z),q(lt.$$.fragment,z),cs=h(z),Oe=n(z,"P",{});var Ge=r(Oe);hs=a(Ge,"Note that "),wt=n(Ge,"A",{href:!0});var da=r(wt);Xs=a(da,"TapasTokenizer"),da.forEach(t),Rt=a(Ge," expects the data of the table to be "),Gt=n(Ge,"STRONG",{});var Yt=r(Gt);Zs=a(Yt,"text-only"),Yt.forEach(t),ea=a(Ge,". You can use "),dt=n(Ge,"CODE",{});var pa=r(dt);ta=a(pa,".astype(str)"),pa.forEach(t),us=a(Ge,` on a dataframe to turn it into text-only data.
Of course, this only shows how to encode a single training example. It is advised to create a dataloader to iterate over batches:`),Ge.forEach(t),ms=h(z),q(gt.$$.fragment,z),this.h()},h(){m(d,"href","/docs/transformers/main/en/model_doc/tapas#transformers.TapasTokenizer"),m(J,"href","/docs/transformers/main/en/model_doc/tapas#transformers.TFTapasForQuestionAnswering"),m(bt,"href","/docs/transformers/main/en/model_doc/tapas#transformers.TapasTokenizer"),m(wt,"href","/docs/transformers/main/en/model_doc/tapas#transformers.TapasTokenizer")},m(z,te){u(z,l,te),e(l,T),e(l,d),e(d,g),e(l,b),e(l,p),e(p,f),e(l,x),e(l,k),e(k,W),e(l,O),e(l,G),e(G,ae),e(l,v),e(l,J),e(J,Z),e(l,de),u(z,U,te),u(z,N,te),e(N,y),e(y,C),e(C,B),e(B,ee),e(ee,pe),e(C,R),e(C,ge),e(ge,he),e(he,X),e(N,_e),e(N,D),e(D,L),e(L,I),e(I,M),e(L,K),e(L,H),e(H,ve),e(ve,xe),e(H,ue),e(H,fe),e(fe,Ae),e(H,se),e(H,ke),e(ke,Te),e(H,Pe),e(H,Ce),e(Ce,je),e(D,Me),e(D,$e),e($e,ce),e(ce,Se),e($e,ye),e($e,Y),e(Y,qe),e(qe,V),e(Y,We),e(Y,oe),e(oe,He),e(Y,Ue),e(Y,w),e(w,S),e(Y,Ve),e(Y,be),e(be,Ye),e(Y,Je),e(Y,Q),e(Q,Le),e(Y,ot),e(Y,Qe),e(Qe,Ie),e(Y,Xe),e(Y,le),e(le,Ee),e(D,Ze),e(D,ze),e(ze,ne),e(ne,et),e(ze,Be),e(ze,re),e(re,Re),e(Re,Fe),e(re,tt),e(re,Pt),e(Pt,Mt),e(re,Ws),e(re,St),e(St,bs),e(re,ts),e(re,Dt),e(Dt,ws),e(re,ut),e(re,De),e(De,Hs),u(z,Ot,te),u(z,ie,te),e(ie,bt),e(bt,ss),e(ie,Us),e(ie,Nt),e(Nt,ns),e(ie,Bs),e(ie,Lt),e(Lt,Qt),e(ie,Rs),e(ie,It),e(It,rs),e(ie,Gs),e(ie,Wt),e(Wt,is),e(ie,Ks),e(ie,Ht),e(Ht,Vs),e(ie,st),e(ie,Ut),e(Ut,ls),e(ie,Ys),e(ie,Bt),e(Bt,ds),e(ie,Js),u(z,ps,te),$(lt,z,te),u(z,cs,te),u(z,Oe,te),e(Oe,hs),e(Oe,wt),e(wt,Xs),e(Oe,Rt),e(Oe,Gt),e(Gt,Zs),e(Oe,ea),e(Oe,dt),e(dt,ta),e(Oe,us),u(z,ms,te),$(gt,z,te),Kt=!0},p:Ft,i(z){Kt||(E(lt.$$.fragment,z),E(gt.$$.fragment,z),Kt=!0)},o(z){F(lt.$$.fragment,z),F(gt.$$.fragment,z),Kt=!1},d(z){z&&t(l),z&&t(U),z&&t(N),z&&t(Ot),z&&t(ie),z&&t(ps),A(lt,z),z&&t(cs),z&&t(Oe),z&&t(ms),A(gt,z)}}}function $y(P){let l,T;return l=new Tn({props:{$$slots:{default:[qy]},$$scope:{ctx:P}}}),{c(){j(l.$$.fragment)},l(d){q(l.$$.fragment,d)},m(d,g){$(l,d,g),T=!0},p(d,g){const b={};g&2&&(b.$$scope={dirty:g,ctx:d}),l.$set(b)},i(d){T||(E(l.$$.fragment,d),T=!0)},o(d){F(l.$$.fragment,d),T=!1},d(d){A(l,d)}}}function Ey(P){let l,T,d,g,b,p,f,x;return f=new ht({props:{code:`from transformers import TapasConfig, TapasForQuestionAnswering, AdamW
...
the latter silently ignores them.`)},l(p){l=n(p,"P",{});var f=r(l);T=a(f,"Although the recipe for forward pass needs to be defined within this function, one should call the "),d=n(f,"CODE",{});var x=r(d);g=a(x,"Module"),x.forEach(t),b=a(f,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
positional argument:`),L=c(),I=o("ul"),M=o("li"),K=s("a single Tensor with "),H=o("code"),ve=s("input_ids"),xe=s(" only and nothing else: "),ue=o("code"),fe=s("model(input_ids)"),Ae=c(),se=o("li"),ke=s(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
...
about any of this, as you can just pass inputs like you would to any other Python function!`),this.h()},l(w){l=n(w,"P",{});var S=r(l);T=a(S,"TensorFlow models and layers in "),d=n(S,"CODE",{});var Ve=r(d);g=a(Ve,"transformers"),Ve.forEach(t),b=a(S," accept two formats as input:"),S.forEach(t),p=h(w),f=n(w,"UL",{});var be=r(f);x=n(be,"LI",{});var Ye=r(x);k=a(Ye,"having all inputs as keyword arguments (like PyTorch models), or"),Ye.forEach(t),W=h(be),O=n(be,"LI",{});var Je=r(O);G=a(Je,"having all inputs as a list, tuple or dict in the first positional argument."),Je.forEach(t),be.forEach(t),ae=h(w),v=n(w,"P",{});var Q=r(v);J=a(Q,`The reason the second format is supported is that Keras methods prefer this format when passing inputs to models
...
about any of this, as you can just pass inputs like you would to any other Python function!`),Fe.forEach(t),this.h()},h(){m(oe,"href","https://keras.io/guides/making_new_layers_and_models_via_subclassing/"),m(oe,"rel","nofollow")},m(w,S){u(w,l,S),e(l,T),e(l,d),e(d,g),e(l,b),u(w,p,S),u(w,f,S),e(f,x),e(x,k),e(f,W),e(f,O),e(O,G),u(w,ae,S),u(w,v,S),e(v,J),e(v,Z),e(Z,de),e(v,U),e(v,N),e(N,y),e(v,C),e(v,B),e(B,ee),e(v,pe),e(v,R),e(R,ge),e(v,he),e(v,X),e(X,_e),e(v,D),u(w,L,S),u(w,I,S),e(I,M),e(M,K),e(M,H),e(H,ve),e(M,xe),e(M,ue),e(ue,fe),e(I,Ae),e(I,se),e(se,ke),e(se,Te),e(Te,Pe),e(se,Ce),e(se,je),e(je,Me),e(I,$e),e(I,ce),e(ce,Se),e(ce,ye),e(ye,Y),u(w,qe,S),u(w,V,S),e(V,We),e(V,oe),e(oe,He),e(V,Ue)},d(w){w&&t(l),w&&t(p),w&&t(f),w&&t(ae),w&&t(v),w&&t(L),w&&t(I),w&&t(qe),w&&t(V)}}}function By(P){let l,T,d,g,b;return{c(){l=o("p"),T=s("Although the recipe for forward pass needs to be defined within this function, one should call the "),d=o("code"),g=s("Module"),b=s(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(p){l=n(p,"P",{});var f=r(l);T=a(f,"Although the recipe for forward pass needs to be defined within this function, one should call the "),d=n(f,"CODE",{});var x=r(d);g=a(x,"Module"),x.forEach(t),b=a(f,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
behavior.`),t_=c(),j(Bo.$$.fragment),s_=c(),As=o("div"),j(yr.$$.fragment),a_=c(),lo=o("p"),o_=s("The "),ki=o("a"),n_=s("TFTapasModel"),r_=s(" forward method, overrides the "),Ed=o("code"),i_=s("__call__"),l_=s(" special method."),d_=c(),j(Ro.$$.fragment),p_=c(),j(Go.$$.fragment),Sp=c(),po=o("h2"),Ko=o("a"),Fd=o("span"),j(kr.$$.fragment),c_=c(),Ad=o("span"),h_=s("TFTapasForMaskedLM"),Dp=c(),qt=o("div"),j(jr.$$.fragment),u_=c(),qr=o("p"),m_=s("Tapas Model with a "),xd=o("code"),f_=s("language modeling"),g_=s(" head on top."),__=c(),$r=o("p"),T_=s("This model inherits from "),ji=o("a"),b_=s("TFPreTrainedModel"),w_=s(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
tokens, special tokens and padding.`),Hw.forEach(t),xm=h(os),sd=n(os,"LI",{});var Uw=r(sd);zm=a(Uw,`row_ids: indicate to which row of the table a token belongs (starting from 1). Is 0 for all question tokens,
...
SQA, WTQ or WikiSQL-supervised tasks.`),Gi.forEach(t),$g=h(ya),ur=n(ya,"P",{});var bc=r(ur);Eg=a(bc,"This model inherits from "),wi=n(bc,"A",{href:!0});var xv=r(wi);Fg=a(xv,"PreTrainedModel"),xv.forEach(t),Ag=a(bc,`. Check the superclass documentation for the generic methods the
library implements for all its models (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),bc.forEach(t),xg=h(ya),mr=n(ya,"P",{});var wc=r(mr);zg=a(wc,"This model is also a PyTorch "),fr=n(wc,"A",{href:!0,rel:!0});var zv=r(fr);Cg=a(zv,"torch.nn.Module"),zv.forEach(t),Pg=a(wc,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Ec.forEach(t),q_=h(Ns),q(Vo.$$.fragment,Ns),$_=h(Ns),xs=n(Ns,"DIV",{class:!0});var fn=r(xs);q(Ar.$$.fragment,fn),E_=h(fn),co=n(fn,"P",{});var Yi=r(co);F_=a(Yi,"The "),qi=n(Yi,"A",{href:!0});var Kv=r(qi);A_=a(Kv,"TFTapasForMaskedLM"),Kv.forEach(t),x_=a(Yi," forward method, overrides the "),zd=n(Yi,"CODE",{});var Vv=r(zd);z_=a(Vv,"__call__"),Vv.forEach(t),C_=a(Yi," special method."),Yi.forEach(t),P_=h(fn),q(Yo.$$.fragment,fn),M_=h(fn),q(Jo.$$.fragment,fn),fn.forEach(t),Ns.forEach(t),Op=h(i),ho=n(i,"H2",{class:!0});var Fc=r(ho);Xo=n(Fc,"A",{id:!0,class:!0,href:!0});var Yv=r(Xo);Cd=n(Yv,"SPAN",{});var Jv=r(Cd);q(xr.$$.fragment,Jv),Jv.forEach(t),Yv.forEach(t),S_=h(Fc),Pd=n(Fc,"SPAN",{});var Xv=r(Pd);D_=a(Xv,"TFTapasForSequenceClassification"),Xv.forEach(t),Fc.forEach(t),Np=h(i),$t=n(i,"DIV",{class:!0});var Ls=r($t);q(zr.$$.fragment,Ls),O_=h(Ls),Md=n(Ls,"P",{});var Zv=r(Md);N_=a(Zv,`Tapas Model with a sequence classification head on top (a linear layer on top of the pooled output), e.g. for table
