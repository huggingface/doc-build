import{S as ys,i as Ss,s as Ws,e as n,k as c,w as v,t as r,M as ks,c as a,d as o,m as d,a as s,x as w,h as i,b as l,F as e,g as f,y as b,q as E,o as y,B as S}from"../../chunks/vendor-6b77c823.js";import{T as Ca}from"../../chunks/Tip-39098574.js";import{D as Je}from"../../chunks/Docstring-abef54e3.js";import{C as ft}from"../../chunks/CodeBlock-3a8b25a8.js";import{I as ht}from"../../chunks/IconCopyLink-7a11ce68.js";function Cs(I){let p,W,h,_,k;return{c(){p=n("p"),W=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),h=n("code"),_=r("Module"),k=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(u){p=a(u,"P",{});var g=s(p);W=i(g,"Although the recipe for forward pass needs to be defined within this function, one should call the "),h=a(g,"CODE",{});var P=s(h);_=i(P,"Module"),P.forEach(o),k=i(g,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),g.forEach(o)},m(u,g){f(u,p,g),e(p,W),e(p,h),e(h,_),e(p,k)},d(u){u&&o(p)}}}function Ts(I){let p,W,h,_,k;return{c(){p=n("p"),W=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),h=n("code"),_=r("Module"),k=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(u){p=a(u,"P",{});var g=s(p);W=i(g,"Although the recipe for forward pass needs to be defined within this function, one should call the "),h=a(g,"CODE",{});var P=s(h);_=i(P,"Module"),P.forEach(o),k=i(g,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),g.forEach(o)},m(u,g){f(u,p,g),e(p,W),e(p,h),e(h,_),e(p,k)},d(u){u&&o(p)}}}function $s(I){let p,W,h,_,k;return{c(){p=n("p"),W=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),h=n("code"),_=r("Module"),k=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(u){p=a(u,"P",{});var g=s(p);W=i(g,"Although the recipe for forward pass needs to be defined within this function, one should call the "),h=a(g,"CODE",{});var P=s(h);_=i(P,"Module"),P.forEach(o),k=i(g,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),g.forEach(o)},m(u,g){f(u,p,g),e(p,W),e(p,h),e(h,_),e(p,k)},d(u){u&&o(p)}}}function js(I){let p,W,h,_,k,u,g,P,vo,Vt,N,Z,ut,de,wo,gt,bo,Ot,ee,Eo,me,yo,So,Lt,Qe,Wo,It,Be,_t,ko,Nt,Ye,Co,Kt,te,vt,To,$o,pe,jo,Ge,qo,xo,Ht,oe,Po,fe,Fo,Mo,Rt,K,ne,wt,he,zo,bt,Ao,Ut,j,ue,Do,H,Vo,Xe,Oo,Lo,ge,Io,No,Ko,R,Ho,Ze,Ro,Uo,et,Jo,Qo,Bo,Et,Yo,Go,_e,Jt,U,ae,yt,ve,Xo,St,Zo,Qt,q,we,en,be,tn,Ee,on,nn,an,ye,sn,tt,rn,ln,cn,Se,dn,We,mn,pn,fn,F,ke,hn,J,un,ot,gn,_n,Wt,vn,wn,bn,se,En,kt,yn,Sn,Ce,Bt,Q,re,Ct,Te,Wn,Tt,kn,Yt,x,$e,Cn,B,Tn,$t,$n,jn,je,qn,xn,Pn,qe,Fn,nt,Mn,zn,An,xe,Dn,Pe,Vn,On,Ln,T,Fe,In,Y,Nn,at,Kn,Hn,jt,Rn,Un,Jn,ie,Qn,qt,Bn,Yn,Me,Gn,ze,Gt,G,le,xt,Ae,Xn,Pt,Zn,Xt,C,De,ea,Ft,ta,oa,Ve,na,Oe,aa,sa,ra,Le,ia,st,la,ca,da,Ie,ma,Ne,pa,fa,ha,$,Ke,ua,X,ga,rt,_a,va,Mt,wa,ba,Ea,ce,ya,zt,Sa,Wa,He,ka,Re,Zt;return u=new ht({}),de=new ht({}),he=new ht({}),ue=new Je({props:{name:"class transformers.SEWConfig",anchor:"transformers.SEWConfig",parameters:[{name:"vocab_size",val:" = 32"},{name:"hidden_size",val:" = 768"},{name:"num_hidden_layers",val:" = 12"},{name:"num_attention_heads",val:" = 12"},{name:"intermediate_size",val:" = 3072"},{name:"squeeze_factor",val:" = 2"},{name:"hidden_act",val:" = 'gelu'"},{name:"hidden_dropout",val:" = 0.1"},{name:"activation_dropout",val:" = 0.1"},{name:"attention_dropout",val:" = 0.1"},{name:"feat_proj_dropout",val:" = 0.0"},{name:"final_dropout",val:" = 0.1"},{name:"layerdrop",val:" = 0.1"},{name:"initializer_range",val:" = 0.02"},{name:"layer_norm_eps",val:" = 1e-05"},{name:"feat_extract_norm",val:" = 'group'"},{name:"feat_extract_activation",val:" = 'gelu'"},{name:"conv_dim",val:" = (64, 128, 128, 128, 128, 256, 256, 256, 256, 512, 512, 512, 512)"},{name:"conv_stride",val:" = (5, 2, 1, 2, 1, 2, 1, 2, 1, 2, 1, 2, 1)"},{name:"conv_kernel",val:" = (10, 3, 1, 3, 1, 3, 1, 3, 1, 2, 1, 2, 1)"},{name:"conv_bias",val:" = False"},{name:"num_conv_pos_embeddings",val:" = 128"},{name:"num_conv_pos_embedding_groups",val:" = 16"},{name:"apply_spec_augment",val:" = True"},{name:"mask_time_prob",val:" = 0.05"},{name:"mask_time_length",val:" = 10"},{name:"mask_time_min_masks",val:" = 2"},{name:"mask_feature_prob",val:" = 0.0"},{name:"mask_feature_length",val:" = 10"},{name:"mask_feature_min_masks",val:" = 0"},{name:"ctc_loss_reduction",val:" = 'mean'"},{name:"ctc_zero_infinity",val:" = False"},{name:"use_weighted_layer_sum",val:" = False"},{name:"classifier_proj_size",val:" = 256"},{name:"pad_token_id",val:" = 0"},{name:"bos_token_id",val:" = 1"},{name:"eos_token_id",val:" = 2"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/sew/configuration_sew.py#L32",parametersDescription:[{anchor:"transformers.SEWConfig.vocab_size",description:`<strong>vocab_size</strong> (<code>int</code>, <em>optional</em>, defaults to 32) &#x2014;
...
`}}),se=new Ca({props:{$$slots:{default:[Cs]},$$scope:{ctx:I}}}),Ce=new ft({props:{code:`from transformers import Wav2Vec2Processor, SEWModel
import torch
...
`}}),ie=new Ca({props:{$$slots:{default:[Ts]},$$scope:{ctx:I}}}),Me=new ft({props:{code:`from transformers import Wav2Vec2Processor, SEWForCTC
from datasets import load_dataset
import torch
...
`}}),ce=new Ca({props:{$$slots:{default:[$s]},$$scope:{ctx:I}}}),He=new ft({props:{code:`from transformers import Wav2Vec2FeatureExtractor, SEWForSequenceClassification
from datasets import load_dataset
import torch
...
<span class="hljs-meta">&gt;&gt;&gt; </span>loss = model(**inputs).loss
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-built_in">round</span>(loss.item(), <span class="hljs-number">2</span>)
<span class="hljs-number">9.52</span>`}}),{c(){p=n("meta"),W=c(),h=n("h1"),_=n("a"),k=n("span"),v(u.$$.fragment),g=c(),P=n("span"),vo=r("SEW"),Vt=c(),N=n("h2"),Z=n("a"),ut=n("span"),v(de.$$.fragment),wo=c(),gt=n("span"),bo=r("Overview"),Ot=c(),ee=n("p"),Eo=r("SEW (Squeezed and Efficient Wav2Vec) was proposed in "),me=n("a"),yo=r(`Performance-Efficiency Trade-offs in Unsupervised Pre-training
...
documentation from `),et=n("a"),Jo=r("PretrainedConfig"),Qo=r(" for more information."),Bo=c(),Et=n("p"),Yo=r("Example:"),Go=c(),v(_e.$$.fragment),Jt=c(),U=n("h2"),ae=n("a"),yt=n("span"),v(ve.$$.fragment),Xo=c(),St=n("span"),Zo=r("SEWModel"),Qt=c(),q=n("div"),v(we.$$.fragment),en=c(),be=n("p"),tn=r(`The bare SEW Model transformer outputting raw hidden-states without any specific head on top.
...
behavior.`),fn=c(),F=n("div"),v(ke.$$.fragment),hn=c(),J=n("p"),un=r("The "),ot=n("a"),gn=r("SEWModel"),_n=r(" forward method, overrides the "),Wt=n("code"),vn=r("__call__"),wn=r(" special method."),bn=c(),v(se.$$.fragment),En=c(),kt=n("p"),yn=r("Example:"),Sn=c(),v(Ce.$$.fragment),Bt=c(),Q=n("h2"),re=n("a"),Ct=n("span"),v(Te.$$.fragment),Wn=c(),Tt=n("span"),kn=r("SEWForCTC"),Yt=c(),x=n("div"),v($e.$$.fragment),Cn=c(),B=n("p"),Tn=r("SEW Model with a "),$t=n("code"),$n=r("language modeling"),jn=r(` head on top for Connectionist Temporal Classification (CTC).
...
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),Ln=c(),T=n("div"),v(Fe.$$.fragment),In=c(),Y=n("p"),Nn=r("The "),at=n("a"),Kn=r("SEWForCTC"),Hn=r(" forward method, overrides the "),jt=n("code"),Rn=r("__call__"),Un=r(" special method."),Jn=c(),v(ie.$$.fragment),Qn=c(),qt=n("p"),Bn=r("Example:"),Yn=c(),v(Me.$$.fragment),Gn=c(),v(ze.$$.fragment),Gt=c(),G=n("h2"),le=n("a"),xt=n("span"),v(Ae.$$.fragment),Xn=c(),Pt=n("span"),Zn=r("SEWForSequenceClassification"),Xt=c(),C=n("div"),v(De.$$.fragment),ea=c(),Ft=n("p"),ta=r(`SEW Model with a sequence classification head on top (a linear layer over the pooled output) for tasks like SUPERB
Keyword Spotting.`),oa=c(),Ve=n("p"),na=r("SEW was proposed in "),Oe=n("a"),aa=r(`Performance-Efficiency Trade-offs in Unsupervised Pre-training for Speech
...
`),Ge=a(no,"A",{href:!0});var Da=s(Ge);qo=i(Da,"Wav2Vec2CTCTokenizer"),Da.forEach(o),xo=i(no,"."),no.forEach(o),oo.forEach(o),Ht=d(t),oe=a(t,"P",{});var ao=s(oe);Po=i(ao,"This model was contributed by "),fe=a(ao,"A",{href:!0,rel:!0});var Va=s(fe);Fo=i(Va,"anton-l"),Va.forEach(o),Mo=i(ao,"."),ao.forEach(o),Rt=d(t),K=a(t,"H2",{class:!0});var so=s(K);ne=a(so,"A",{id:!0,class:!0,href:!0});var Oa=s(ne);wt=a(Oa,"SPAN",{});var La=s(wt);w(he.$$.fragment,La),La.forEach(o),Oa.forEach(o),zo=d(so),bt=a(so,"SPAN",{});var Ia=s(bt);Ao=i(Ia,"SEWConfig"),Ia.forEach(o),so.forEach(o),Ut=d(t),j=a(t,"DIV",{class:!0});var D=s(j);w(ue.$$.fragment,D),Do=d(D),H=a(D,"P",{});var it=s(H);Vo=i(it,"This is the configuration class to store the configuration of a "),Xe=a(it,"A",{href:!0});var Na=s(Xe);Oo=i(Na,"SEWModel"),Na.forEach(o),Lo=i(it,`. It is used to instantiate a SEW model
according to the specified arguments, defining the model architecture. Instantiating a configuration with the
defaults will yield a similar configuration to that of the SEW
...
documentation from `),et=a(lt,"A",{href:!0});var Ra=s(et);Jo=i(Ra,"PretrainedConfig"),Ra.forEach(o),Qo=i(lt," for more information."),lt.forEach(o),Bo=d(D),Et=a(D,"P",{});var Ua=s(Et);Yo=i(Ua,"Example:"),Ua.forEach(o),Go=d(D),w(_e.$$.fragment,D),D.forEach(o),Jt=d(t),U=a(t,"H2",{class:!0});var ro=s(U);ae=a(ro,"A",{id:!0,class:!0,href:!0});var Ja=s(ae);yt=a(Ja,"SPAN",{});var Qa=s(yt);w(ve.$$.fragment,Qa),Qa.forEach(o),Ja.forEach(o),Xo=d(ro),St=a(ro,"SPAN",{});var Ba=s(St);Zo=i(Ba,"SEWModel"),Ba.forEach(o),ro.forEach(o),Qt=d(t),q=a(t,"DIV",{class:!0});var V=s(q);w(we.$$.fragment,V),en=d(V),be=a(V,"P",{});var io=s(be);tn=i(io,`The bare SEW Model transformer outputting raw hidden-states without any specific head on top.
...
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),co.forEach(o),fn=d(V),F=a(V,"DIV",{class:!0});var O=s(F);w(ke.$$.fragment,O),hn=d(O),J=a(O,"P",{});var ct=s(J);un=i(ct,"The "),ot=a(ct,"A",{href:!0});var Za=s(ot);gn=i(Za,"SEWModel"),Za.forEach(o),_n=i(ct," forward method, overrides the "),Wt=a(ct,"CODE",{});var es=s(Wt);vn=i(es,"__call__"),es.forEach(o),wn=i(ct," special method."),ct.forEach(o),bn=d(O),w(se.$$.fragment,O),En=d(O),kt=a(O,"P",{});var ts=s(kt);yn=i(ts,"Example:"),ts.forEach(o),Sn=d(O),w(Ce.$$.fragment,O),O.forEach(o),V.forEach(o),Bt=d(t),Q=a(t,"H2",{class:!0});var mo=s(Q);re=a(mo,"A",{id:!0,class:!0,href:!0});var os=s(re);Ct=a(os,"SPAN",{});var ns=s(Ct);w(Te.$$.fragment,ns),ns.forEach(o),os.forEach(o),Wn=d(mo),Tt=a(mo,"SPAN",{});var as=s(Tt);kn=i(as,"SEWForCTC"),as.forEach(o),mo.forEach(o),Yt=d(t),x=a(t,"DIV",{class:!0});var L=s(x);w($e.$$.fragment,L),Cn=d(L),B=a(L,"P",{});var dt=s(B);Tn=i(dt,"SEW Model with a "),$t=a(dt,"CODE",{});var ss=s($t);$n=i(ss,"language modeling"),ss.forEach(o),jn=i(dt,` head on top for Connectionist Temporal Classification (CTC).
...
Yoav Artzi.`),dt.forEach(o),Pn=d(L),qe=a(L,"P",{});var po=s(qe);Fn=i(po,"This model inherits from "),nt=a(po,"A",{href:!0});var is=s(nt);Mn=i(is,"PreTrainedModel"),is.forEach(o),zn=i(po,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving etc.).`),po.forEach(o),An=d(L),xe=a(L,"P",{});var fo=s(xe);Dn=i(fo,"This model is a PyTorch "),Pe=a(fo,"A",{href:!0,rel:!0});var ls=s(Pe);Vn=i(ls,"torch.nn.Module"),ls.forEach(o),On=i(fo,` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),fo.forEach(o),Ln=d(L),T=a(L,"DIV",{class:!0});var M=s(T);w(Fe.$$.fragment,M),In=d(M),Y=a(M,"P",{});var mt=s(Y);Nn=i(mt,"The "),at=a(mt,"A",{href:!0});var cs=s(at);Kn=i(cs,"SEWForCTC"),cs.forEach(o),Hn=i(mt," forward method, overrides the "),jt=a(mt,"CODE",{});var ds=s(jt);Rn=i(ds,"__call__"),ds.forEach(o),Un=i(mt," special method."),mt.forEach(o),Jn=d(M),w(ie.$$.fragment,M),Qn=d(M),qt=a(M,"P",{});var ms=s(qt);Bn=i(ms,"Example:"),ms.forEach(o),Yn=d(M),w(Me.$$.fragment,M),Gn=d(M),w(ze.$$.fragment,M),M.forEach(o),L.forEach(o),Gt=d(t),G=a(t,"H2",{class:!0});var ho=s(G);le=a(ho,"A",{id:!0,class:!0,href:!0});var ps=s(le);xt=a(ps,"SPAN",{});var fs=s(xt);w(Ae.$$.fragment,fs),fs.forEach(o),ps.forEach(o),Xn=d(ho),Pt=a(ho,"SPAN",{});var hs=s(Pt);Zn=i(hs,"SEWForSequenceClassification"),hs.forEach(o),ho.forEach(o),Xt=d(t),C=a(t,"DIV",{class:!0});var z=s(C);w(De.$$.fragment,z),ea=d(z),Ft=a(z,"P",{});var us=s(Ft);ta=i(us,`SEW Model with a sequence classification head on top (a linear layer over the pooled output) for tasks like SUPERB
Keyword Spotting.`),us.forEach(o),oa=d(z),Ve=a(z,"P",{});var uo=s(Ve);na=i(uo,"SEW was proposed in "),Oe=a(uo,"A",{href:!0,rel:!0});var gs=s(Oe);aa=i(gs,`Performance-Efficiency Trade-offs in Unsupervised Pre-training for Speech
