...
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-built_in">print</span>(<span class="hljs-string">&quot;Predicted class:&quot;</span>, model.config.id2label[predicted_class_idx])`}}),{c(){c=a("p"),v=r("Example:"),u=m(),w(f.$$.fragment)},l(l){c=n(l,"P",{});var h=s(c);v=i(h,"Example:"),h.forEach(t),u=p(l),x(f.$$.fragment,l)},m(l,h){_(l,c,h),e(c,v),_(l,u,h),$(f,l,h),b=!0},p:yt,i(l){b||(y(f.$$.fragment,l),b=!0)},o(l){T(f.$$.fragment,l),b=!1},d(l){l&&t(c),l&&t(u),B(f,l)}}}function Bh(F){let c,v,u,f,b,l,h,E,or,ts,ce,ze,za,Bt,ar,Aa,nr,os,W,sr,Ft,rr,ir,Et,lr,dr,kt,cr,mr,as,Xo,pr,ns,Ko,qa,hr,ss,Yo,fr,rs,C,k,ur,Qo,gr,_r,Zo,br,vr,Mt,wr,xr,ea,$r,yr,ta,Tr,Br,oa,Fr,Er,aa,kr,Mr,Ir,It,jr,jt,Pr,Cr,zr,Pt,Ar,na,qr,Lr,Nr,me,Sr,La,Or,Dr,Ct,Vr,Wr,Ur,pe,Rr,zt,Hr,Jr,At,Gr,Xr,Kr,S,Yr,Na,Qr,Zr,Sa,ei,ti,sa,oi,ai,Oa,ni,si,is,U,ri,qt,ii,li,Lt,di,ci,Nt,mi,pi,ls,he,Ae,Da,St,hi,Va,fi,ds,fe,Ot,ui,Dt,gi,ra,_i,bi,cs,ue,Vt,vi,Wt,wi,ia,xi,$i,ms,ge,qe,Wa,Ut,yi,Ua,Ti,ps,Z,Rt,Bi,_e,Fi,la,Ei,ki,Ht,Mi,Ii,ji,Le,hs,be,Ne,Ra,Jt,Pi,Ha,Ci,fs,O,Gt,zi,Ja,Ai,qi,Xt,Li,da,Ni,Si,Oi,ie,Kt,Di,Ga,Vi,Wi,Se,us,ve,Oe,Xa,Yt,Ui,Ka,Ri,gs,ee,Qt,Hi,Zt,Ji,eo,Gi,Xi,Ki,R,to,Yi,we,Qi,ca,Zi,el,Ya,tl,ol,al,De,nl,Ve,_s,xe,We,Qa,oo,sl,Za,rl,bs,te,ao,il,oe,ll,ma,dl,cl,pa,ml,pl,no,hl,fl,ul,H,so,gl,$e,_l,ha,bl,vl,en,wl,xl,$l,Ue,yl,Re,vs,ye,He,tn,ro,Tl,on,Bl,ws,D,io,Fl,an,El,kl,lo,Ml,co,Il,jl,Pl,J,mo,Cl,Te,zl,fa,Al,ql,nn,Ll,Nl,Sl,Je,Ol,Ge,xs,Be,Xe,sn,po,Dl,rn,Vl,$s,V,ho,Wl,ln,Ul,Rl,fo,Hl,uo,Jl,Gl,Xl,G,go,Kl,Fe,Yl,ua,Ql,Zl,dn,ed,td,od,Ke,ad,Ye,ys,Ee,Qe,cn,_o,nd,mn,sd,Ts,M,bo,rd,pn,id,ld,vo,dd,ga,cd,md,pd,wo,hd,xo,fd,ud,gd,hn,_d,bd,ae,fn,$o,vd,wd,un,yo,xd,$d,gn,To,yd,Td,_n,Bo,Bd,Fd,X,Fo,Ed,ke,kd,bn,Md,Id,vn,jd,Pd,Cd,Ze,zd,et,Bs,Me,tt,wn,Eo,Ad,xn,qd,Fs,I,ko,Ld,$n,Nd,Sd,Mo,Od,_a,Dd,Vd,Wd,Io,Ud,jo,Rd,Hd,Jd,yn,Gd,Xd,ne,Tn,Po,Kd,Yd,Bn,Co,Qd,Zd,Fn,zo,ec,tc,En,Ao,oc,ac,A,qo,nc,Ie,sc,kn,rc,ic,Mn,lc,dc,cc,ot,mc,je,pc,In,hc,fc,jn,uc,gc,_c,at,Es,Pe,nt,Pn,Lo,bc,Cn,vc,ks,j,No,wc,zn,xc,$c,So,yc,ba,Tc,Bc,Fc,Oo,Ec,Do,kc,Mc,Ic,An,jc,Pc,se,qn,Vo,Cc,zc,Ln,Wo,Ac,qc,Nn,Uo,Lc,Nc,Sn,Ro,Sc,Oc,K,Ho,Dc,Ce,Vc,On,Wc,Uc,Dn,Rc,Hc,Jc,st,Gc,rt,Ms;return l=new Q({}),Bt=new Q({}),St=new Q({}),Ot=new P({props:{name:"class transformers.models.beit.modeling_beit.BeitModelOutputWithPooling",anchor:"transformers.models.beit.modeling_beit.BeitModelOutputWithPooling",parameters:[{name:"last_hidden_state",val:": FloatTensor = None"},{name:"pooler_output",val:": FloatTensor = None"},{name:"hidden_states",val:": typing.Optional[typing.Tuple[torch.FloatTensor]] = None"},{name:"attentions",val:": typing.Optional[typing.Tuple[torch.FloatTensor]] = None"}],parametersDescription:[{anchor:"transformers.models.beit.modeling_beit.BeitModelOutputWithPooling.last_hidden_state",description:`<strong>last_hidden_state</strong> (<code>torch.FloatTensor</code> of shape <code>(batch_size, sequence_length, hidden_size)</code>) &#x2014;
...
`),na=a("a"),qr=r("BeitFeatureExtractor"),Lr=r(" to resize (or rescale) and normalize images for the model."),Nr=m(),me=a("li"),Sr=r(`Both the patch resolution and image resolution used during pre-training or fine-tuning are reflected in the name of
...
images and 1,000 classes).`),Kr=m(),S=a("li"),Yr=r(`BEiT uses relative position embeddings, inspired by the T5 model. During pre-training, the authors shared the
relative position bias among the several self-attention layers. During fine-tuning, each layer\u2019s relative position
bias is initialized with the shared relative position bias obtained after pre-training. Note that, if one wants to
pre-train a model from scratch, one needs to either set the `),Na=a("code"),Qr=r("use_relative_position_bias"),Zr=r(` or the
`),Sa=a("code"),ei=r("use_relative_position_bias"),ti=r(" attribute of "),sa=a("a"),oi=r("BeitConfig"),ai=r(" to "),Oa=a("code"),ni=r("True"),si=r(` in order to add
...
general usage and behavior.`),gd=m(),hn=a("p"),_d=r("Finally, this model supports inherent JAX features such as:"),bd=m(),ae=a("ul"),fn=a("li"),$o=a("a"),vd=r("Just-In-Time (JIT) compilation"),wd=m(),un=a("li"),yo=a("a"),xd=r("Automatic Differentiation"),$d=m(),gn=a("li"),To=a("a"),yd=r("Vectorization"),Td=m(),_n=a("li"),Bo=a("a"),Bd=r("Parallelization"),Fd=m(),X=a("div"),w(Fo.$$.fragment),Ed=m(),ke=a("p"),kd=r("The "),bn=a("code"),Md=r("FlaxBeitPreTrainedModel"),Id=r(" forward method, overrides the "),vn=a("code"),jd=r("__call__"),Pd=r(" special method."),Cd=m(),w(Ze.$$.fragment),zd=m(),w(et.$$.fragment),Bs=m(),Me=a("h2"),tt=a("a"),wn=a("span"),w(Eo.$$.fragment),Ad=m(),xn=a("span"),qd=r("FlaxBeitForMaskedImageModeling"),Fs=m(),I=a("div"),w(ko.$$.fragment),Ld=m(),$n=a("p"),Nd=r("Beit Model transformer with a \u2018language\u2019 modeling head on top (to predict visual tokens)."),Sd=m(),Mo=a("p"),Od=r("This model inherits from "),_a=a("a"),Dd=r("FlaxPreTrainedModel"),Vd=r(`. Check the superclass documentation for the generic methods the
...
Boolean masked positions. Indicates which patches are masked (1) and which aren\u2019t (0).`),_c=m(),w(at.$$.fragment),Es=m(),Pe=a("h2"),nt=a("a"),Pn=a("span"),w(Lo.$$.fragment),bc=m(),Cn=a("span"),vc=r("FlaxBeitForImageClassification"),ks=m(),j=a("div"),w(No.$$.fragment),wc=m(),zn=a("p"),xc=r(`Beit Model transformer with an image classification head on top (a linear layer on top of the average of the final
hidden states of the patch tokens) e.g. for ImageNet.`),$c=m(),So=a("p"),yc=r("This model inherits from "),ba=a("a"),Tc=r("FlaxPreTrainedModel"),Bc=r(`. Check the superclass documentation for the generic methods the
...
`),na=n(js,"A",{href:!0});var am=s(na);qr=i(am,"BeitFeatureExtractor"),am.forEach(t),Lr=i(js," to resize (or rescale) and normalize images for the model."),js.forEach(t),Nr=p(Y),me=n(Y,"LI",{});var va=s(me);Sr=i(va,`Both the patch resolution and image resolution used during pre-training or fine-tuning are reflected in the name of
...
images and 1,000 classes).`),wa.forEach(t),Kr=p(Y),S=n(Y,"LI",{});var le=s(S);Yr=i(le,`BEiT uses relative position embeddings, inspired by the T5 model. During pre-training, the authors shared the
relative position bias among the several self-attention layers. During fine-tuning, each layer\u2019s relative position
bias is initialized with the shared relative position bias obtained after pre-training. Note that, if one wants to
pre-train a model from scratch, one needs to either set the `),Na=n(le,"CODE",{});var lm=s(Na);Qr=i(lm,"use_relative_position_bias"),lm.forEach(t),Zr=i(le,` or the
`),Sa=n(le,"CODE",{});var dm=s(Sa);ei=i(dm,"use_relative_position_bias"),dm.forEach(t),ti=i(le," attribute of "),sa=n(le,"A",{href:!0});var cm=s(sa);oi=i(cm,"BeitConfig"),cm.forEach(t),ai=i(le," to "),Oa=n(le,"CODE",{});var mm=s(Oa);ni=i(mm,"True"),mm.forEach(t),si=i(le,` in order to add
...
as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),Us.forEach(t),Pl=p(pt),J=n(pt,"DIV",{class:!0});var ht=s(J);x(mo.$$.fragment,ht),Cl=p(ht),Te=n(ht,"P",{});var ka=s(Te);zl=i(ka,"The "),fa=n(ka,"A",{href:!0});var Km=s(fa);Al=i(Km,"BeitForImageClassification"),Km.forEach(t),ql=i(ka," forward method, overrides the "),nn=n(ka,"CODE",{});var Ym=s(nn);Ll=i(Ym,"__call__"),Ym.forEach(t),Nl=i(ka," special method."),ka.forEach(t),Sl=p(ht),x(Je.$$.fragment,ht),Ol=p(ht),x(Ge.$$.fragment,ht),ht.forEach(t),pt.forEach(t),xs=p(o),Be=n(o,"H2",{class:!0});var Rs=s(Be);Xe=n(Rs,"A",{id:!0,class:!0,href:!0});var Qm=s(Xe);sn=n(Qm,"SPAN",{});var Zm=s(sn);x(po.$$.fragment,Zm),Zm.forEach(t),Qm.forEach(t),Dl=p(Rs),rn=n(Rs,"SPAN",{});var ep=s(rn);Vl=i(ep,"BeitForSemanticSegmentation"),ep.forEach(t),Rs.forEach(t),$s=p(o),V=n(o,"DIV",{class:!0});var ft=s(V);x(ho.$$.fragment,ft),Wl=p(ft),ln=n(ft,"P",{});var tp=s(ln);Ul=i(tp,"Beit Model transformer with a semantic segmentation head on top e.g. for ADE20k, CityScapes."),tp.forEach(t),Rl=p(ft),fo=n(ft,"P",{});var Hs=s(fo);Hl=i(Hs,"This model is a PyTorch "),uo=n(Hs,"A",{href:!0,rel:!0});var op=s(uo);Jl=i(op,"torch.nn.Module"),op.forEach(t),Gl=i(Hs,` subclass. Use it
as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
