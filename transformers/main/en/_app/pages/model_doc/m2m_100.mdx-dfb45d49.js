...
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),z.forEach(o)},m(y,z){p(y,m,z),e(m,S),e(m,v),e(v,q),e(m,F)},d(y){y&&o(m)}}}function mi(rt){let m,S,v,q,F;return{c(){m=n("p"),S=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),v=n("code"),q=r("Module"),F=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(y){m=s(y,"P",{});var z=a(m);S=i(z,"Although the recipe for forward pass needs to be defined within this function, one should call the "),v=s(z,"CODE",{});var I=a(v);q=i(I,"Module"),I.forEach(o),F=i(z,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),z.forEach(o)},m(y,z){p(y,m,z),e(m,S),e(m,v),e(v,q),e(m,F)},d(y){y&&o(m)}}}function ui(rt){let m,S,v,q,F,y,z,I,an,go,U,te,xt,_e,rn,Et,dn,ko,oe,ln,ge,cn,hn,Mo,it,pn,bo,dt,Ct,mn,vo,ne,un,ke,fn,_n,yo,V,se,jt,Me,gn,Ft,kn,To,L,Mn,Pt,bn,vn,Ot,yn,Tn,St,wn,zn,wo,E,qn,lt,$n,xn,Lt,En,Cn,At,jn,Fn,Dt,Pn,On,zo,ct,It,Sn,qo,be,$o,ht,ve,Nt,Ln,An,$,Dn,Gt,In,Nn,Wt,Gn,Wn,Bt,Bn,Hn,Ht,Un,Vn,Ut,Xn,Rn,xo,ye,Eo,X,ae,Vt,Te,Jn,Xt,Kn,Co,x,we,Zn,R,Qn,pt,Yn,es,ze,ts,os,ns,J,ss,mt,as,rs,ut,is,ds,ls,Rt,cs,hs,qe,jo,K,re,Jt,$e,ps,Kt,ms,Fo,b,xe,us,Ee,fs,Ce,_s,gs,ks,je,Ms,ft,bs,vs,ys,Zt,Ts,ws,Fe,zs,A,Pe,qs,Oe,$s,Qt,xs,Es,Cs,Se,Le,Yt,js,Fs,eo,Ps,Os,Ae,to,Ss,Ls,oo,As,Ds,no,Is,Ns,ie,De,Gs,Ie,Ws,so,Bs,Hs,Us,N,Ne,Vs,_t,Xs,gt,Rs,Js,ao,Ks,Zs,kt,Ge,Po,Z,de,ro,We,Qs,io,Ys,Oo,P,Be,ea,He,ta,Mt,oa,na,sa,Ue,aa,Ve,ra,ia,da,C,Xe,la,Q,ca,bt,ha,pa,lo,ma,ua,fa,le,_a,co,ga,ka,Re,So,Y,ce,ho,Je,Ma,po,ba,Lo,O,Ke,va,Ze,ya,vt,Ta,wa,za,Qe,qa,Ye,$a,xa,Ea,T,et,Ca,ee,ja,yt,Fa,Pa,mo,Oa,Sa,La,he,Aa,uo,Da,Ia,tt,Na,fo,Ga,Wa,ot,Ao;return y=new at({}),_e=new at({}),Me=new at({}),be=new st({props:{code:`from transformers import M2M100Config, M2M100ForConditionalGeneration, M2M100Tokenizer
...
Liptchinsky, Sergey Edunov, Edouard Grave, Michael Auli, Armand Joulin.`),Mo=d(),it=n("p"),pn=r("The abstract from the paper is the following:"),bo=d(),dt=n("p"),Ct=n("em"),mn=r(`Existing work in translation demonstrated the potential of massively multilingual machine translation by training a
...
documentation from `),ut=n("a"),is=r("PretrainedConfig"),ds=r(" for more information."),ls=d(),Rt=n("p"),cs=r("Example:"),hs=d(),u(qe.$$.fragment),jo=d(),K=n("h2"),re=n("a"),Jt=n("span"),u($e.$$.fragment),ps=d(),Kt=n("span"),ms=r("M2M100Tokenizer"),Fo=d(),b=n("div"),u(xe.$$.fragment),us=d(),Ee=n("p"),fs=r("Construct an M2M100 tokenizer. Based on "),Ce=n("a"),_s=r("SentencePiece"),gs=r("."),ks=d(),je=n("p"),Ms=r("This tokenizer inherits from "),ft=n("a"),bs=r("PreTrainedTokenizer"),vs=r(` which contains most of the main methods. Users should refer to
...
and behavior.`),da=d(),C=n("div"),u(Xe.$$.fragment),la=d(),Q=n("p"),ca=r("The "),bt=n("a"),ha=r("M2M100Model"),pa=r(" forward method, overrides the "),lo=n("code"),ma=r("__call__"),ua=r(" special method."),fa=d(),u(le.$$.fragment),_a=d(),co=n("p"),ga=r("Example:"),ka=d(),u(Re.$$.fragment),So=d(),Y=n("h2"),ce=n("a"),ho=n("span"),u(Je.$$.fragment),Ma=d(),po=n("span"),ba=r("M2M100ForConditionalGeneration"),Lo=d(),O=n("div"),u(Ke.$$.fragment),va=d(),Ze=n("p"),ya=r(`The M2M100 Model with a language modeling head. Can be used for summarization.
...
multilingual it expects the sequences in a certain format: A special language id token is used as prefix in both the
source and target text. The source text format is `),Pt=s(pe,"CODE",{});var nr=a(Pt);bn=i(nr,"[lang_code] X [eos]"),nr.forEach(o),vn=i(pe,", where "),Ot=s(pe,"CODE",{});var sr=a(Ot);yn=i(sr,"lang_code"),sr.forEach(o),Tn=i(pe,` is source language
