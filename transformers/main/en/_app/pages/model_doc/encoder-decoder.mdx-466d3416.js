import{S as ni,i as ti,s as ri,e as s,k as m,w as y,t,M as ai,c as d,d as o,m as h,a as i,x as k,h as r,b as l,F as e,g as b,y as T,q as w,o as E,B as $,v as si,L as $o}from"../../chunks/vendor-6b77c823.js";import{T as Us}from"../../chunks/Tip-39098574.js";import{D as B}from"../../chunks/Docstring-1088f2fb.js";import{C as Fe}from"../../chunks/CodeBlock-3a8b25a8.js";import{I as Un}from"../../chunks/IconCopyLink-7a11ce68.js";import{E as Eo}from"../../chunks/ExampleCodeBlock-5212b321.js";function di(q){let c,v,u,p,_;return p=new Fe({props:{code:`from transformers import BertConfig, EncoderDecoderConfig, EncoderDecoderModel
...
<span class="hljs-meta">&gt;&gt;&gt; </span>model = EncoderDecoderModel.from_pretrained(<span class="hljs-string">&quot;./bert2bert&quot;</span>)`}}),{c(){c=s("p"),v=t("Example:"),u=m(),y(p.$$.fragment)},l(a){c=d(a,"P",{});var f=i(c);v=r(f,"Example:"),f.forEach(o),u=h(a),k(p.$$.fragment,a)},m(a,f){b(a,c,f),e(c,v),b(a,u,f),T(p,a,f),_=!0},p:$o,i(a){_||(w(p.$$.fragment,a),_=!0)},o(a){E(p.$$.fragment,a),_=!1},d(a){a&&o(c),a&&o(u),$(p,a)}}}function pi(q){let c,v,u,p,_;return{c(){c=s("p"),v=t("Although the recipe for forward pass needs to be defined within this function, one should call the "),u=s("code"),p=t("Module"),_=t(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(a){c=d(a,"P",{});var f=i(c);v=r(f,"Although the recipe for forward pass needs to be defined within this function, one should call the "),u=d(f,"CODE",{});var C=i(u);p=r(C,"Module"),C.forEach(o),_=r(f,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
<span class="hljs-meta">&gt;&gt;&gt; </span>model.save_pretrained(<span class="hljs-string">&quot;./bert2gpt2&quot;</span>)
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-comment"># load fine-tuned model</span>
<span class="hljs-meta">&gt;&gt;&gt; </span>model = FlaxEncoderDecoderModel.from_pretrained(<span class="hljs-string">&quot;./bert2gpt2&quot;</span>)`}}),{c(){c=s("p"),v=t("Example:"),u=m(),y(p.$$.fragment)},l(a){c=d(a,"P",{});var f=i(c);v=r(f,"Example:"),f.forEach(o),u=h(a),k(p.$$.fragment,a)},m(a,f){b(a,c,f),e(c,v),b(a,u,f),T(p,a,f),_=!0},p:$o,i(a){_||(w(p.$$.fragment,a),_=!0)},o(a){E(p.$$.fragment,a),_=!1},d(a){a&&o(c),a&&o(u),$(p,a)}}}function _i(q){let c,v,u,p,_,a,f,C,$t,Hn,ie,xt,xo,Mt,Dt,Yn,ce,qt,Pe,zt,jt,Jn,le,Ft,Mo,Pt,Ct,Zn,O,At,Do,St,Nt,Ce,It,Lt,Kn,V,Bt,mn,Ot,Vt,hn,Wt,Rt,Qn,Ae,Xn,W,Gt,Se,Ut,Ht,Ne,Yt,Jt,et,J,pe,fn,Ie,Zt,un,Kt,ot,P,Le,Qt,me,qo,Xt,er,zo,or,nr,tr,Z,rr,jo,ar,sr,Fo,dr,ir,cr,he,lr,fe,Be,pr,Oe,mr,Po,hr,fr,ur,ue,Ve,gr,K,_r,gn,br,vr,_n,yr,kr,nt,Q,ge,bn,We,Tr,vn,wr,tt,x,Re,Er,X,$r,Co,xr,Mr,Ao,Dr,qr,zr,Ge,jr,Ue,Fr,Pr,Cr,yn,Ar,Sr,He,Nr,So,Ir,Lr,Br,Ye,Or,Je,Vr,Wr,Rr,R,No,Gr,Ur,kn,Hr,Yr,Tn,Jr,Zr,Kr,A,Ze,Qr,ee,Xr,Io,ea,oa,wn,na,ta,ra,_e,aa,be,sa,S,Ke,da,En,ia,ca,oe,la,$n,pa,ma,xn,ha,fa,ua,ve,rt,ne,ye,Mn,Qe,ga,Dn,_a,at,M,Xe,ba,te,va,Lo,ya,ka,Bo,Ta,wa,Ea,eo,$a,oo,xa,Ma,Da,qn,qa,za,no,ja,Oo,Fa,Pa,Ca,to,Aa,ro,Sa,Na,Ia,G,Vo,La,Ba,Wo,Oa,Va,Ro,Wa,Ra,Ga,N,ao,Ua,re,Ha,Go,Ya,Ja,zn,Za,Ka,Qa,ke,Xa,Te,es,U,so,os,jn,ns,ts,we,st,ae,Ee,Fn,io,rs,Pn,as,dt,D,co,ss,se,ds,Uo,is,cs,Ho,ls,ps,ms,lo,hs,po,fs,us,gs,Cn,_s,bs,mo,vs,Yo,ys,ks,Ts,ho,ws,fo,Es,$s,xs,H,Jo,Ms,Ds,An,qs,zs,Sn,js,Fs,Ps,I,uo,Cs,de,As,Zo,Ss,Ns,Nn,Is,Ls,Bs,$e,Os,xe,Vs,Y,go,Ws,In,Rs,Gs,Me,it;return a=new Un({}),Ae=new Fe({props:{code:`# a workaround to load from pytorch checkpoint
...
`}}),Ve=new B({props:{name:"to_dict",anchor:"transformers.EncoderDecoderConfig.to_dict",parameters:[],source:"https://github.com/huggingface/transformers/blob/vmain/src/transformers/models/encoder_decoder/configuration_encoder_decoder.py#L108",returnDescription:`
...
</ul>`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vmain/src/transformers/models/encoder_decoder/modeling_encoder_decoder.py#L429",returnDescription:`
<p>A <a
...
<p>Behaves differently depending on whether a <code>config</code> is provided or automatically loaded.`,name:"kwargs"}],source:"https://github.com/huggingface/transformers/blob/vmain/src/transformers/models/encoder_decoder/modeling_encoder_decoder.py#L278"}}),ve=new Eo({props:{anchor:"transformers.EncoderDecoderModel.from_encoder_decoder_pretrained.example",$$slots:{default:[li]},$$scope:{ctx:q}}}),Qe=new Un({}),Xe=new B({props:{name:"class transformers.TFEncoderDecoderModel",anchor:"transformers.TFEncoderDecoderModel",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.TFEncoderDecoderModel.config",description:`<strong>config</strong> (<a href="/docs/transformers/main/en/model_doc/encoder-decoder#transformers.EncoderDecoderConfig">EncoderDecoderConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
...
</ul>`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/vmain/src/transformers/models/encoder_decoder/modeling_tf_encoder_decoder.py#L494",returnDescription:`
<p>A <a
...
<p>Behaves differently depending on whether a <code>config</code> is provided or automatically loaded.`,name:"kwargs"}],source:"https://github.com/huggingface/transformers/blob/vmain/src/transformers/models/encoder_decoder/modeling_tf_encoder_decoder.py#L330"}}),we=new Eo({props:{anchor:"transformers.TFEncoderDecoderModel.from_encoder_decoder_pretrained.example",$$slots:{default:[hi]},$$scope:{ctx:q}}}),io=new Un({}),co=new B({props:{name:"class transformers.FlaxEncoderDecoderModel",anchor:"transformers.FlaxEncoderDecoderModel",parameters:[{name:"config",val:": EncoderDecoderConfig"},{name:"input_shape",val:": typing.Optional[typing.Tuple] = None"},{name:"seed",val:": int = 0"},{name:"dtype",val:": dtype = <class 'jax._src.numpy.lax_numpy.float32'>"},{name:"_do_init",val:": bool = True"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.FlaxEncoderDecoderModel.config",description:`<strong>config</strong> (<a href="/docs/transformers/main/en/model_doc/encoder-decoder#transformers.EncoderDecoderConfig">EncoderDecoderConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
...
If set to <code>True</code>, the model will return a <code>FlaxSeq2SeqLMOutput</code> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vmain/src/transformers/models/encoder_decoder/modeling_flax_encoder_decoder.py#L627",returnDescription:`
<p>A <a
...
<p>Behaves differently depending on whether a <code>config</code> is provided or automatically loaded.`,name:"kwargs"}],source:"https://github.com/huggingface/transformers/blob/vmain/src/transformers/models/encoder_decoder/modeling_flax_encoder_decoder.py#L758"}}),Me=new Eo({props:{anchor:"transformers.FlaxEncoderDecoderModel.from_encoder_decoder_pretrained.example",$$slots:{default:[gi]},$$scope:{ctx:q}}}),{c(){c=s("meta"),v=m(),u=s("h1"),p=s("a"),_=s("span"),y(a.$$.fragment),f=m(),C=s("span"),$t=t("Encoder Decoder Models"),Hn=m(),ie=s("p"),xt=t("The "),xo=s("a"),Mt=t("EncoderDecoderModel"),Dt=t(` can be used to initialize a sequence-to-sequence model with any
pretrained autoencoding model as the encoder and any pretrained autoregressive model as the decoder.`),Yn=m(),ce=s("p"),qt=t(`The effectiveness of initializing sequence-to-sequence models with pretrained checkpoints for sequence generation tasks
was shown in `),Pe=s("a"),zt=t("Leveraging Pre-trained Checkpoints for Sequence Generation Tasks"),jt=t(` by
Sascha Rothe, Shashi Narayan, Aliaksei Severyn.`),Jn=m(),le=s("p"),Ft=t("After such an "),Mo=s("a"),Pt=t("EncoderDecoderModel"),Ct=t(` has been trained/fine-tuned, it can be saved/loaded just like
any other models (see the examples for more information).`),Zn=m(),O=s("p"),At=t("An application of this architecture could be to leverage two pretrained "),Do=s("a"),St=t("BertModel"),Nt=t(` as the encoder
and decoder for a summarization model as was shown in: `),Ce=s("a"),It=t("Text Summarization with Pretrained Encoders"),Lt=t(" by Yang Liu and Mirella Lapata."),Kn=m(),V=s("p"),Bt=t("The "),mn=s("code"),Ot=t("from_pretrained()"),Vt=t(` currently doesn\u2019t support initializing the model from a
...
checkpoints for a particular encoder-decoder model, a workaround is:`),Qn=m(),y(Ae.$$.fragment),Xn=m(),W=s("p"),Gt=t("This model was contributed by "),Se=s("a"),Ut=t("thomwolf"),Ht=t(`. This model\u2019s TensorFlow and Flax versions
were contributed by `),Ne=s("a"),Yt=t("ydshieh"),Jt=t("."),et=m(),J=s("h2"),pe=s("a"),fn=s("span"),y(Ie.$$.fragment),Zt=m(),un=s("span"),Kt=t("EncoderDecoderConfig"),ot=m(),P=s("div"),y(Le.$$.fragment),Qt=m(),me=s("p"),qo=s("a"),Xt=t("EncoderDecoderConfig"),er=t(" is the configuration class to store the configuration of a "),zo=s("a"),or=t("EncoderDecoderModel"),nr=t(`. It is
...
`),Co=s("a"),xr=t("from_pretrained()"),Mr=t(" function and the decoder is loaded via "),Ao=s("a"),Dr=t("from_pretrained()"),qr=t(`
function. Cross-attention layers are automatically added to the decoder and should be fine-tuned on a downstream
generative task, like summarization.`),zr=m(),Ge=s("p"),jr=t(`The effectiveness of initializing sequence-to-sequence models with pretrained checkpoints for sequence generation
...
Zhou, Wei Li, Peter J. Liu.`),Cr=m(),yn=s("p"),Ar=t(`After such an Encoder Decoder model has been trained/fine-tuned, it can be saved/loaded just like any other models
...
:meth`),Tn=s("em"),Jr=t("~transformers.AutoModelForCausalLM.from_pretrained"),Zr=t(" class method for the decoder."),Kr=m(),A=s("div"),y(Ze.$$.fragment),Qr=m(),ee=s("p"),Xr=t("The "),Io=s("a"),ea=t("EncoderDecoderModel"),oa=t(" forward method, overrides the "),wn=s("code"),na=t("__call__"),ta=t(" special method."),ra=m(),y(_e.$$.fragment),aa=m(),y(be.$$.fragment),sa=m(),S=s("div"),y(Ke.$$.fragment),da=m(),En=s("p"),ia=t(`Instantiate an encoder and a decoder from one or two base classes of the library from pretrained model
...
Zhou, Wei Li, Peter J. Liu.`),Da=m(),qn=s("p"),qa=t(`After such an Encoder Decoder model has been trained/fine-tuned, it can be saved/loaded just like any other models
(see the examples for more information).`),za=m(),no=s("p"),ja=t("This model inherits from "),Oo=s("a"),Fa=t("TFPreTrainedModel"),Pa=t(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Ca=m(),to=s("p"),Aa=t("This model is also a "),ro=s("a"),Sa=t("tf.keras.Model"),Na=t(` subclass. Use it
...
method for the decoder.`),Ga=m(),N=s("div"),y(ao.$$.fragment),Ua=m(),re=s("p"),Ha=t("The "),Go=s("a"),Ya=t("TFEncoderDecoderModel"),Ja=t(" forward method, overrides the "),zn=s("code"),Za=t("__call__"),Ka=t(" special method."),Qa=m(),y(ke.$$.fragment),Xa=m(),y(Te.$$.fragment),es=m(),U=s("div"),y(so.$$.fragment),os=m(),jn=s("p"),ns=t(`Instantiate an encoder and a decoder from one or two base classes of the library from pretrained model
...
Zhou, Wei Li, Peter J. Liu.`),gs=m(),Cn=s("p"),_s=t(`After such an Encoder Decoder model has been trained/fine-tuned, it can be saved/loaded just like any other models
...
decoder module when created with the :meth`),An=s("em"),qs=t("~transformers.FlaxAutoModel.from_pretrained"),zs=t(` class method for the
encoder and :meth`),Sn=s("em"),js=t("~transformers.FlaxAutoModelForCausalLM.from_pretrained"),Fs=t(" class method for the decoder."),Ps=m(),I=s("div"),y(uo.$$.fragment),Cs=m(),de=s("p"),As=t("The "),Zo=s("a"),Ss=t("FlaxEncoderDecoderModel"),Ns=t(" forward method, overrides the "),Nn=s("code"),Is=t("__call__"),Ls=t(" special method."),Bs=m(),y($e.$$.fragment),Os=m(),y(xe.$$.fragment),Vs=m(),Y=s("div"),y(go.$$.fragment),Ws=m(),In=s("p"),Rs=t(`Instantiate an encoder and a decoder from one or two base classes of the library from pretrained model
checkpoints.`),Gs=m(),y(Me.$$.fragment),this.h()},l(n){const g=ai('[data-svelte="svelte-1phssyn"]',document.head);c=d(g,"META",{name:!0,content:!0}),g.forEach(o),v=h(n),u=d(n,"H1",{class:!0});var _o=i(u);p=d(_o,"A",{id:!0,class:!0,href:!0});var Ln=i(p);_=d(Ln,"SPAN",{});var Bn=i(_);k(a.$$.fragment,Bn),Bn.forEach(o),Ln.forEach(o),f=h(_o),C=d(_o,"SPAN",{});var On=i(C);$t=r(On,"Encoder Decoder Models"),On.forEach(o),_o.forEach(o),Hn=h(n),ie=d(n,"P",{});var bo=i(ie);xt=r(bo,"The "),xo=d(bo,"A",{href:!0});var Vn=i(xo);Mt=r(Vn,"EncoderDecoderModel"),Vn.forEach(o),Dt=r(bo,` can be used to initialize a sequence-to-sequence model with any
pretrained autoencoding model as the encoder and any pretrained autoregressive model as the decoder.`),bo.forEach(o),Yn=h(n),ce=d(n,"P",{});var vo=i(ce);qt=r(vo,`The effectiveness of initializing sequence-to-sequence models with pretrained checkpoints for sequence generation tasks
was shown in `),Pe=d(vo,"A",{href:!0,rel:!0});var Wn=i(Pe);zt=r(Wn,"Leveraging Pre-trained Checkpoints for Sequence Generation Tasks"),Wn.forEach(o),jt=r(vo,` by
Sascha Rothe, Shashi Narayan, Aliaksei Severyn.`),vo.forEach(o),Jn=h(n),le=d(n,"P",{});var yo=i(le);Ft=r(yo,"After such an "),Mo=d(yo,"A",{href:!0});var Rn=i(Mo);Pt=r(Rn,"EncoderDecoderModel"),Rn.forEach(o),Ct=r(yo,` has been trained/fine-tuned, it can be saved/loaded just like
any other models (see the examples for more information).`),yo.forEach(o),Zn=h(n),O=d(n,"P",{});var Ko=i(O);At=r(Ko,"An application of this architecture could be to leverage two pretrained "),Do=d(Ko,"A",{href:!0});var Hs=i(Do);St=r(Hs,"BertModel"),Hs.forEach(o),Nt=r(Ko,` as the encoder
and decoder for a summarization model as was shown in: `),Ce=d(Ko,"A",{href:!0,rel:!0});var Ys=i(Ce);It=r(Ys,"Text Summarization with Pretrained Encoders"),Ys.forEach(o),Lt=r(Ko," by Yang Liu and Mirella Lapata."),Ko.forEach(o),Kn=h(n),V=d(n,"P",{});var Qo=i(V);Bt=r(Qo,"The "),mn=d(Qo,"CODE",{});var Js=i(mn);Ot=r(Js,"from_pretrained()"),Js.forEach(o),Vt=r(Qo,` currently doesn\u2019t support initializing the model from a
...
checkpoints for a particular encoder-decoder model, a workaround is:`),Qo.forEach(o),Qn=h(n),k(Ae.$$.fragment,n),Xn=h(n),W=d(n,"P",{});var Xo=i(W);Gt=r(Xo,"This model was contributed by "),Se=d(Xo,"A",{href:!0,rel:!0});var Ks=i(Se);Ut=r(Ks,"thomwolf"),Ks.forEach(o),Ht=r(Xo,`. This model\u2019s TensorFlow and Flax versions
were contributed by `),Ne=d(Xo,"A",{href:!0,rel:!0});var Qs=i(Ne);Yt=r(Qs,"ydshieh"),Qs.forEach(o),Jt=r(Xo,"."),Xo.forEach(o),et=h(n),J=d(n,"H2",{class:!0});var ct=i(J);pe=d(ct,"A",{id:!0,class:!0,href:!0});var Xs=i(pe);fn=d(Xs,"SPAN",{});var ed=i(fn);k(Ie.$$.fragment,ed),ed.forEach(o),Xs.forEach(o),Zt=h(ct),un=d(ct,"SPAN",{});var od=i(un);Kt=r(od,"EncoderDecoderConfig"),od.forEach(o),ct.forEach(o),ot=h(n),P=d(n,"DIV",{class:!0});var L=i(P);k(Le.$$.fragment,L),Qt=h(L),me=d(L,"P",{});var Gn=i(me);qo=d(Gn,"A",{href:!0});var nd=i(qo);Xt=r(nd,"EncoderDecoderConfig"),nd.forEach(o),er=r(Gn," is the configuration class to store the configuration of a "),zo=d(Gn,"A",{href:!0});var td=i(zo);or=r(td,"EncoderDecoderModel"),td.forEach(o),nr=r(Gn,`. It is
used to instantiate an Encoder Decoder model according to the specified arguments, defining the encoder and decoder
...
decoder model configuration.`),pt.forEach(o),lt.forEach(o),ur=h(L),ue=d(L,"DIV",{class:!0});var mt=i(ue);k(Ve.$$.fragment,mt),gr=h(mt),K=d(mt,"P",{});var on=i(K);_r=r(on,"Serializes this instance to a Python dictionary. Override the default "),gn=d(on,"EM",{});var dd=i(gn);br=r(dd,"to_dict()"),dd.forEach(o),vr=r(on," from "),_n=d(on,"EM",{});var id=i(_n);yr=r(id,"PretrainedConfig"),id.forEach(o),kr=r(on,"."),on.forEach(o),mt.forEach(o),L.forEach(o),nt=h(n),Q=d(n,"H2",{class:!0});var ht=i(Q);ge=d(ht,"A",{id:!0,class:!0,href:!0});var cd=i(ge);bn=d(cd,"SPAN",{});var ld=i(bn);k(We.$$.fragment,ld),ld.forEach(o),cd.forEach(o),Tr=h(ht),vn=d(ht,"SPAN",{});var pd=i(vn);wr=r(pd,"EncoderDecoderModel"),pd.forEach(o),ht.forEach(o),tt=h(n),x=d(n,"DIV",{class:!0});var z=i(x);k(Re.$$.fragment,z),Er=h(z),X=d(z,"P",{});var nn=i(X);$r=r(nn,`This class can be used to initialize a sequence-to-sequence model with any pretrained autoencoding model as the
encoder and any pretrained autoregressive model as the decoder. The encoder is loaded via
`),Co=d(nn,"A",{href:!0});var md=i(Co);xr=r(md,"from_pretrained()"),md.forEach(o),Mr=r(nn," function and the decoder is loaded via "),Ao=d(nn,"A",{href:!0});var hd=i(Ao);Dr=r(hd,"from_pretrained()"),hd.forEach(o),qr=r(nn,`
function. Cross-attention layers are automatically added to the decoder and should be fine-tuned on a downstream
generative task, like summarization.`),nn.forEach(o),zr=h(z),Ge=d(z,"P",{});var ft=i(Ge);jr=r(ft,`The effectiveness of initializing sequence-to-sequence models with pretrained checkpoints for sequence generation
...
Zhou, Wei Li, Peter J. Liu.`),ft.forEach(o),Cr=h(z),yn=d(z,"P",{});var ud=i(yn);Ar=r(ud,`After such an Encoder Decoder model has been trained/fine-tuned, it can be saved/loaded just like any other models
(see the examples for more information).`),ud.forEach(o),Sr=h(z),He=d(z,"P",{});var ut=i(He);Nr=r(ut,"This model inherits from "),So=d(ut,"A",{href:!0});var gd=i(So);Ir=r(gd,"PreTrainedModel"),gd.forEach(o),Lr=r(ut,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),ut.forEach(o),Br=h(z),Ye=d(z,"P",{});var gt=i(Ye);Or=r(gt,"This model is also a PyTorch "),Je=d(gt,"A",{href:!0,rel:!0});var _d=i(Je);Vr=r(_d,"torch.nn.Module"),_d.forEach(o),Wr=r(gt,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),gt.forEach(o),Rr=h(z),R=d(z,"P",{});var ko=i(R);No=d(ko,"A",{href:!0});var bd=i(No);Gr=r(bd,"EncoderDecoderModel"),bd.forEach(o),Ur=r(ko,` is a generic model class that will be instantiated as a transformer architecture with one
of the base model classes of the library as encoder and another one as decoder when created with the
...
:meth`),Tn=d(ko,"EM",{});var yd=i(Tn);Jr=r(yd,"~transformers.AutoModelForCausalLM.from_pretrained"),yd.forEach(o),Zr=r(ko," class method for the decoder."),ko.forEach(o),Kr=h(z),A=d(z,"DIV",{class:!0});var De=i(A);k(Ze.$$.fragment,De),Qr=h(De),ee=d(De,"P",{});var tn=i(ee);Xr=r(tn,"The "),Io=d(tn,"A",{href:!0});var kd=i(Io);ea=r(kd,"EncoderDecoderModel"),kd.forEach(o),oa=r(tn," forward method, overrides the "),wn=d(tn,"CODE",{});var Td=i(wn);na=r(Td,"__call__"),Td.forEach(o),ta=r(tn," special method."),tn.forEach(o),ra=h(De),k(_e.$$.fragment,De),aa=h(De),k(be.$$.fragment,De),De.forEach(o),sa=h(z),S=d(z,"DIV",{class:!0});var qe=i(S);k(Ke.$$.fragment,qe),da=h(qe),En=d(qe,"P",{});var wd=i(En);ia=r(wd,`Instantiate an encoder and a decoder from one or two base classes of the library from pretrained model
checkpoints.`),wd.forEach(o),ca=h(qe),oe=d(qe,"P",{});var rn=i(oe);la=r(rn,"The model is set in evaluation mode by default using "),$n=d(rn,"CODE",{});var Ed=i($n);pa=r(Ed,"model.eval()"),Ed.forEach(o),ma=r(rn,` (Dropout modules are deactivated). To train
the model, you need to first set it back in training mode with `),xn=d(rn,"CODE",{});var $d=i(xn);ha=r($d,"model.train()"),$d.forEach(o),fa=r(rn,"."),rn.forEach(o),ua=h(qe),k(ve.$$.fragment,qe),qe.forEach(o),z.forEach(o),rt=h(n),ne=d(n,"H2",{class:!0});var _t=i(ne);ye=d(_t,"A",{id:!0,class:!0,href:!0});var xd=i(ye);Mn=d(xd,"SPAN",{});var Md=i(Mn);k(Qe.$$.fragment,Md),Md.forEach(o),xd.forEach(o),ga=h(_t),Dn=d(_t,"SPAN",{});var Dd=i(Dn);_a=r(Dd,"TFEncoderDecoderModel"),Dd.forEach(o),_t.forEach(o),at=h(n),M=d(n,"DIV",{class:!0});var j=i(M);k(Xe.$$.fragment,j),ba=h(j),te=d(j,"P",{});var an=i(te);va=r(an,`This class can be used to initialize a sequence-to-sequence model with any pretrained autoencoding model as the
encoder and any pretrained autoregressive model as the decoder. The encoder is loaded via
`),Lo=d(an,"A",{href:!0});var qd=i(Lo);ya=r(qd,"from_pretrained()"),qd.forEach(o),ka=r(an," function and the decoder is loaded via "),Bo=d(an,"A",{href:!0});var zd=i(Bo);Ta=r(zd,"from_pretrained()"),zd.forEach(o),wa=r(an,`
function. Cross-attention layers are automatically added to the decoder and should be fine-tuned on a downstream
...
Zhou, Wei Li, Peter J. Liu.`),bt.forEach(o),Da=h(j),qn=d(j,"P",{});var Fd=i(qn);qa=r(Fd,`After such an Encoder Decoder model has been trained/fine-tuned, it can be saved/loaded just like any other models
(see the examples for more information).`),Fd.forEach(o),za=h(j),no=d(j,"P",{});var vt=i(no);ja=r(vt,"This model inherits from "),Oo=d(vt,"A",{href:!0});var Pd=i(Oo);Fa=r(Pd,"TFPreTrainedModel"),Pd.forEach(o),Pa=r(vt,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),vt.forEach(o),Ca=h(j),to=d(j,"P",{});var yt=i(to);Aa=r(yt,"This model is also a "),ro=d(yt,"A",{href:!0,rel:!0});var Cd=i(ro);Sa=r(Cd,"tf.keras.Model"),Cd.forEach(o),Na=r(yt,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),yt.forEach(o),Ia=h(j),G=d(j,"P",{});var To=i(G);Vo=d(To,"A",{href:!0});var Ad=i(Vo);La=r(Ad,"TFEncoderDecoderModel"),Ad.forEach(o),Ba=r(To,` is a generic model class that will be instantiated as a transformer architecture with one
of the base model classes of the library as encoder and another one as decoder when created with the
...
Zhou, Wei Li, Peter J. Liu.`),Tt.forEach(o),gs=h(F),Cn=d(F,"P",{});var Hd=i(Cn);_s=r(Hd,`After such an Encoder Decoder model has been trained/fine-tuned, it can be saved/loaded just like any other models
