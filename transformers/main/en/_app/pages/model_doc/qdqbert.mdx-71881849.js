import{S as au,i as ru,s as iu,e as a,k as l,w as g,t as n,M as lu,c as r,d as o,m as d,a as i,x as _,h as s,b as c,F as e,g as m,y as b,q as k,o as v,B as Q,v as du}from"../../chunks/vendor-6b77c823.js";import{T as mt}from"../../chunks/Tip-39098574.js";import{D as E}from"../../chunks/Docstring-abef54e3.js";import{C as x}from"../../chunks/CodeBlock-3a8b25a8.js";import{I as Y}from"../../chunks/IconCopyLink-7a11ce68.js";function cu(B){let h,q,f,T,y;return{c(){h=a("p"),q=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=a("code"),T=n("Module"),y=n(`
...
the latter silently ignores them.`)},l(w){h=r(w,"P",{});var u=i(h);q=s(u,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=r(u,"CODE",{});var $=i(f);T=s($,"Module"),$.forEach(o),y=s(u,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),u.forEach(o)},m(w,u){m(w,h,u),e(h,q),e(h,f),e(f,T),e(h,y)},d(w){w&&o(h)}}}function bu(B){let h,q,f,T,y,w,u,$,yr,sa,_e,Ie,Fn,ut,qr,Pn,$r,aa,Oe,Dr,ft,zr,Br,ra,Ko,Mr,ia,Go,Cn,xr,la,Yo,jr,da,Z,An,Nn,Er,Fr,Sn,We,Pr,gt,Cr,Ar,Ln,Nr,Sr,In,_t,Lr,On,Ir,Or,Wr,Wn,bt,Hr,Zo,Rr,Ur,ca,He,Vr,kt,Xr,Jr,pa,be,Re,Hn,vt,Kr,Rn,Gr,ha,F,Yr,Un,Zr,ei,Qt,ti,oi,Vn,ni,si,Xn,ai,ri,wt,ii,li,ma,Ue,di,Jn,ci,pi,ua,en,hi,fa,Tt,ga,ke,Ve,Kn,yt,mi,Gn,ui,_a,tn,fi,ba,qt,ka,ve,Xe,Yn,$t,gi,Zn,_i,va,se,bi,Dt,ki,vi,zt,Qi,wi,Qa,Bt,wa,Qe,Je,es,Mt,Ti,ts,yi,Ta,N,xt,qi,we,$i,on,Di,zi,jt,Bi,Mi,xi,Te,ji,nn,Ei,Fi,sn,Pi,Ci,Ai,os,Ni,Si,Et,ya,ye,Ke,ns,Ft,Li,ss,Ii,qa,z,Pt,Oi,as,Wi,Hi,Ct,Ri,an,Ui,Vi,Xi,At,Ji,Nt,Ki,Gi,Yi,St,Zi,Lt,el,tl,ol,j,nl,rs,sl,al,is,rl,il,ls,ll,dl,ds,cl,pl,cs,hl,ml,ps,ul,fl,gl,U,It,_l,qe,bl,rn,kl,vl,hs,Ql,wl,Tl,Ge,yl,ms,ql,$l,Ot,$a,$e,Ye,us,Wt,Dl,fs,zl,Da,S,Ht,Bl,Rt,Ml,gs,xl,jl,El,Ut,Fl,ln,Pl,Cl,Al,Vt,Nl,Xt,Sl,Ll,Il,V,Jt,Ol,De,Wl,dn,Hl,Rl,_s,Ul,Vl,Xl,Ze,Jl,bs,Kl,Gl,Kt,za,ze,et,ks,Gt,Yl,vs,Zl,Ba,L,Yt,ed,Zt,td,Qs,od,nd,sd,eo,ad,cn,rd,id,ld,to,dd,oo,cd,pd,hd,P,no,md,Be,ud,pn,fd,gd,ws,_d,bd,kd,tt,vd,Ts,Qd,wd,so,Td,ao,Ma,Me,ot,ys,ro,yd,qs,qd,xa,I,io,$d,$s,Dd,zd,lo,Bd,hn,Md,xd,jd,co,Ed,po,Fd,Pd,Cd,D,ho,Ad,xe,Nd,mn,Sd,Ld,Ds,Id,Od,Wd,nt,Hd,zs,Rd,Ud,mo,Vd,uo,Xd,Bs,Jd,Kd,fo,Gd,go,ja,je,st,Ms,_o,Yd,xs,Zd,Ea,O,bo,ec,ko,tc,js,oc,nc,sc,vo,ac,un,rc,ic,lc,Qo,dc,wo,cc,pc,hc,X,To,mc,Ee,uc,fn,fc,gc,Es,_c,bc,kc,at,vc,Fs,Qc,wc,yo,Fa,Fe,rt,Ps,qo,Tc,Cs,yc,Pa,W,$o,qc,As,$c,Dc,Do,zc,gn,Bc,Mc,xc,zo,jc,Bo,Ec,Fc,Pc,J,Mo,Cc,Pe,Ac,_n,Nc,Sc,Ns,Lc,Ic,Oc,it,Wc,Ss,Hc,Rc,xo,Ca,Ce,lt,Ls,jo,Uc,Is,Vc,Aa,H,Eo,Xc,Os,Jc,Kc,Fo,Gc,bn,Yc,Zc,ep,Po,tp,Co,op,np,sp,C,Ao,ap,Ae,rp,kn,ip,lp,Ws,dp,cp,pp,dt,hp,Hs,mp,up,No,fp,So,Na,Ne,ct,Rs,Lo,gp,Us,_p,Sa,R,Io,bp,Se,kp,Vs,vp,Qp,Xs,wp,Tp,yp,Oo,qp,vn,$p,Dp,zp,Wo,Bp,Ho,Mp,xp,jp,A,Ro,Ep,Le,Fp,Qn,Pp,Cp,Js,Ap,Np,Sp,pt,Lp,Ks,Ip,Op,Uo,Wp,Vo,La;return w=new Y({}),ut=new Y({}),vt=new Y({}),Tt=new x({props:{code:`import pytorch_quantization.nn as quant_nn
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),nr.forEach(o),Il=d(ie),V=r(ie,"DIV",{class:!0});var le=i(V);_(Jt.$$.fragment,le),Ol=d(le),De=r(le,"P",{});var $n=i(De);Wl=s($n,"The "),dn=r($n,"A",{href:!0});var em=i(dn);Hl=s(em,"QDQBertLMHeadModel"),em.forEach(o),Rl=s($n," forward method, overrides the "),_s=r($n,"CODE",{});var tm=i(_s);Ul=s(tm,"__call__"),tm.forEach(o),Vl=s($n," special method."),$n.forEach(o),Xl=d(le),_(Ze.$$.fragment,le),Jl=d(le),bs=r(le,"P",{});var om=i(bs);Kl=s(om,"Example:"),om.forEach(o),Gl=d(le),_(Kt.$$.fragment,le),le.forEach(o),ie.forEach(o),za=d(t),ze=r(t,"H2",{class:!0});var sr=i(ze);et=r(sr,"A",{id:!0,class:!0,href:!0});var nm=i(et);ks=r(nm,"SPAN",{});var sm=i(ks);_(Gt.$$.fragment,sm),sm.forEach(o),nm.forEach(o),Yl=d(sr),vs=r(sr,"SPAN",{});var am=i(vs);Zl=s(am,"QDQBertForMaskedLM"),am.forEach(o),sr.forEach(o),Ba=d(t),L=r(t,"DIV",{class:!0});var de=i(L);_(Yt.$$.fragment,de),ed=d(de),Zt=r(de,"P",{});var ar=i(Zt);td=s(ar,"QDQBERT Model with a "),Qs=r(ar,"CODE",{});var rm=i(Qs);od=s(rm,"language modeling"),rm.forEach(o),nd=s(ar," head on top."),ar.forEach(o),sd=d(de),eo=r(de,"P",{});var rr=i(eo);ad=s(rr,"This model inherits from "),cn=r(rr,"A",{href:!0});var im=i(cn);rd=s(im,"PreTrainedModel"),im.forEach(o),id=s(rr,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),ir.forEach(o),hd=d(de),P=r(de,"DIV",{class:!0});var te=i(P);_(no.$$.fragment,te),md=d(te),Be=r(te,"P",{});var Dn=i(Be);ud=s(Dn,"The "),pn=r(Dn,"A",{href:!0});var dm=i(pn);fd=s(dm,"QDQBertForMaskedLM"),dm.forEach(o),gd=s(Dn," forward method, overrides the "),ws=r(Dn,"CODE",{});var cm=i(ws);_d=s(cm,"__call__"),cm.forEach(o),bd=s(Dn," special method."),Dn.forEach(o),kd=d(te),_(tt.$$.fragment,te),vd=d(te),Ts=r(te,"P",{});var pm=i(Ts);Qd=s(pm,"Example:"),pm.forEach(o),wd=d(te),_(so.$$.fragment,te),Td=d(te),_(ao.$$.fragment,te),te.forEach(o),de.forEach(o),Ma=d(t),Me=r(t,"H2",{class:!0});var lr=i(Me);ot=r(lr,"A",{id:!0,class:!0,href:!0});var hm=i(ot);ys=r(hm,"SPAN",{});var mm=i(ys);_(ro.$$.fragment,mm),mm.forEach(o),hm.forEach(o),yd=d(lr),qs=r(lr,"SPAN",{});var um=i(qs);qd=s(um,"QDQBertForSequenceClassification"),um.forEach(o),lr.forEach(o),xa=d(t),I=r(t,"DIV",{class:!0});var ce=i(I);_(io.$$.fragment,ce),$d=d(ce),$s=r(ce,"P",{});var fm=i($s);Dd=s(fm,`Bert Model transformer with a sequence classification/regression head on top (a linear layer on top of the pooled
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),cr.forEach(o),Cd=d(ce),D=r(ce,"DIV",{class:!0});var M=i(D);_(ho.$$.fragment,M),Ad=d(M),xe=r(M,"P",{});var zn=i(xe);Nd=s(zn,"The "),mn=r(zn,"A",{href:!0});var bm=i(mn);Sd=s(bm,"QDQBertForSequenceClassification"),bm.forEach(o),Ld=s(zn," forward method, overrides the "),Ds=r(zn,"CODE",{});var km=i(Ds);Id=s(km,"__call__"),km.forEach(o),Od=s(zn," special method."),zn.forEach(o),Wd=d(M),_(nt.$$.fragment,M),Hd=d(M),zs=r(M,"P",{});var vm=i(zs);Rd=s(vm,"Example of single-label classification:"),vm.forEach(o),Ud=d(M),_(mo.$$.fragment,M),Vd=d(M),_(uo.$$.fragment,M),Xd=d(M),Bs=r(M,"P",{});var Qm=i(Bs);Jd=s(Qm,"Example of multi-label classification:"),Qm.forEach(o),Kd=d(M),_(fo.$$.fragment,M),Gd=d(M),_(go.$$.fragment,M),M.forEach(o),ce.forEach(o),ja=d(t),je=r(t,"H2",{class:!0});var pr=i(je);st=r(pr,"A",{id:!0,class:!0,href:!0});var wm=i(st);Ms=r(wm,"SPAN",{});var Tm=i(Ms);_(_o.$$.fragment,Tm),Tm.forEach(o),wm.forEach(o),Yd=d(pr),xs=r(pr,"SPAN",{});var ym=i(xs);Zd=s(ym,"QDQBertForNextSentencePrediction"),ym.forEach(o),pr.forEach(o),Ea=d(t),O=r(t,"DIV",{class:!0});var pe=i(O);_(bo.$$.fragment,pe),ec=d(pe),ko=r(pe,"P",{});var hr=i(ko);tc=s(hr,"Bert Model with a "),js=r(hr,"CODE",{});var qm=i(js);oc=s(qm,"next sentence prediction (classification)"),qm.forEach(o),nc=s(hr," head on top."),hr.forEach(o),sc=d(pe),vo=r(pe,"P",{});var mr=i(vo);ac=s(mr,"This model inherits from "),un=r(mr,"A",{href:!0});var $m=i(un);rc=s($m,"PreTrainedModel"),$m.forEach(o),ic=s(mr,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),mr.forEach(o),lc=d(pe),Qo=r(pe,"P",{});var ur=i(Qo);dc=s(ur,"This model is also a PyTorch "),wo=r(ur,"A",{href:!0,rel:!0});var Dm=i(wo);cc=s(Dm,"torch.nn.Module"),Dm.forEach(o),pc=s(ur,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),ur.forEach(o),hc=d(pe),X=r(pe,"DIV",{class:!0});var he=i(X);_(To.$$.fragment,he),mc=d(he),Ee=r(he,"P",{});var Bn=i(Ee);uc=s(Bn,"The "),fn=r(Bn,"A",{href:!0});var zm=i(fn);fc=s(zm,"QDQBertForNextSentencePrediction"),zm.forEach(o),gc=s(Bn," forward method, overrides the "),Es=r(Bn,"CODE",{});var Bm=i(Es);_c=s(Bm,"__call__"),Bm.forEach(o),bc=s(Bn," special method."),Bn.forEach(o),kc=d(he),_(at.$$.fragment,he),vc=d(he),Fs=r(he,"P",{});var Mm=i(Fs);Qc=s(Mm,"Example:"),Mm.forEach(o),wc=d(he),_(yo.$$.fragment,he),he.forEach(o),pe.forEach(o),Fa=d(t),Fe=r(t,"H2",{class:!0});var fr=i(Fe);rt=r(fr,"A",{id:!0,class:!0,href:!0});var xm=i(rt);Ps=r(xm,"SPAN",{});var jm=i(Ps);_(qo.$$.fragment,jm),jm.forEach(o),xm.forEach(o),Tc=d(fr),Cs=r(fr,"SPAN",{});var Em=i(Cs);yc=s(Em,"QDQBertForMultipleChoice"),Em.forEach(o),fr.forEach(o),Pa=d(t),W=r(t,"DIV",{class:!0});var me=i(W);_($o.$$.fragment,me),qc=d(me),As=r(me,"P",{});var Fm=i(As);$c=s(Fm,`Bert Model with a multiple choice classification head on top (a linear layer on top of the pooled output and a
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),kr.forEach(o),ep=d(fe),Po=r(fe,"P",{});var vr=i(Po);tp=s(vr,"This model is also a PyTorch "),Co=r(vr,"A",{href:!0,rel:!0});var Rm=i(Co);op=s(Rm,"torch.nn.Module"),Rm.forEach(o),np=s(vr,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),vr.forEach(o),sp=d(fe),C=r(fe,"DIV",{class:!0});var oe=i(C);_(Ao.$$.fragment,oe),ap=d(oe),Ae=r(oe,"P",{});var xn=i(Ae);rp=s(xn,"The "),kn=r(xn,"A",{href:!0});var Um=i(kn);ip=s(Um,"QDQBertForTokenClassification"),Um.forEach(o),lp=s(xn," forward method, overrides the "),Ws=r(xn,"CODE",{});var Vm=i(Ws);dp=s(Vm,"__call__"),Vm.forEach(o),cp=s(xn," special method."),xn.forEach(o),pp=d(oe),_(dt.$$.fragment,oe),hp=d(oe),Hs=r(oe,"P",{});var Xm=i(Hs);mp=s(Xm,"Example:"),Xm.forEach(o),up=d(oe),_(No.$$.fragment,oe),fp=d(oe),_(So.$$.fragment,oe),oe.forEach(o),fe.forEach(o),Na=d(t),Ne=r(t,"H2",{class:!0});var Qr=i(Ne);ct=r(Qr,"A",{id:!0,class:!0,href:!0});var Jm=i(ct);Rs=r(Jm,"SPAN",{});var Km=i(Rs);_(Lo.$$.fragment,Km),Km.forEach(o),Jm.forEach(o),gp=d(Qr),Us=r(Qr,"SPAN",{});var Gm=i(Us);_p=s(Gm,"QDQBertForQuestionAnswering"),Gm.forEach(o),Qr.forEach(o),Sa=d(t),R=r(t,"DIV",{class:!0});var ge=i(R);_(Io.$$.fragment,ge),bp=d(ge),Se=r(ge,"P",{});var jn=i(Se);kp=s(jn,`QDQBERT Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
layers on top of the hidden-states output to compute `),Vs=r(jn,"CODE",{});var Ym=i(Vs);vp=s(Ym,"span start logits"),Ym.forEach(o),Qp=s(jn," and "),Xs=r(jn,"CODE",{});var Zm=i(Xs);wp=s(Zm,"span end logits"),Zm.forEach(o),Tp=s(jn,")."),jn.forEach(o),yp=d(ge),Oo=r(ge,"P",{});var wr=i(Oo);qp=s(wr,"This model inherits from "),vn=r(wr,"A",{href:!0});var eu=i(vn);$p=s(eu,"PreTrainedModel"),eu.forEach(o),Dp=s(wr,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
