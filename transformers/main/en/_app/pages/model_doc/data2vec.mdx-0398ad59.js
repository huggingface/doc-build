...
the latter silently ignores them.`)},l(g){h=r(g,"P",{});var u=i(h);x=n(u,"Although the recipe for forward pass needs to be defined within this function, one should call the "),m=r(u,"CODE",{});var V=i(m);y=n(V,"Module"),V.forEach(o),D=n(u,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),u.forEach(o)},m(g,u){f(g,h,u),e(h,x),e(h,m),e(m,y),e(h,D)},d(g){g&&o(h)}}}function rv($){let h,x,m,y,D,g,u,V,xd,Qr,ze,mt,ms,Ht,Dd,fs,Vd,Gr,ft,$d,Rt,Ad,Fd,Xr,pn,Cd,Ur,un,Qt,Md,Gt,qd,jd,Jr,mn,zd,Kr,fn,Xt,Ed,gn,Pd,Sd,Yr,ve,Ld,Ut,Nd,Wd,Jt,Id,Od,Zr,Ee,gt,gs,Kt,Bd,_s,Hd,ei,H,Yt,Rd,_e,Qd,_n,Gd,Xd,vn,Ud,Jd,Zt,Kd,Yd,Zd,Pe,el,bn,tl,ol,Tn,al,nl,sl,vs,rl,il,eo,ti,Se,_t,bs,to,dl,Ts,ll,oi,R,oo,cl,Le,hl,kn,pl,ul,ao,ml,fl,gl,Ne,_l,wn,vl,bl,yn,Tl,kl,wl,ks,yl,xl,no,ai,We,vt,ws,so,Dl,ys,Vl,ni,Q,ro,$l,io,Al,lo,Fl,Cl,Ml,co,ql,xn,jl,zl,El,ho,Pl,po,Sl,Ll,Nl,J,uo,Wl,Ie,Il,Dn,Ol,Bl,xs,Hl,Rl,Ql,bt,Gl,Ds,Xl,Ul,mo,si,Oe,Tt,Vs,fo,Jl,$s,Kl,ri,M,go,Yl,As,Zl,ec,_o,tc,vo,oc,ac,nc,bo,sc,Vn,rc,ic,dc,To,lc,ko,cc,hc,pc,K,wo,uc,Be,mc,$n,fc,gc,Fs,_c,vc,bc,kt,Tc,Cs,kc,wc,yo,ii,He,wt,Ms,xo,yc,qs,xc,di,G,Do,Dc,Re,Vc,js,$c,Ac,Vo,Fc,Cc,Mc,$o,qc,An,jc,zc,Ec,Ao,Pc,Fo,Sc,Lc,Nc,W,Co,Wc,Qe,Ic,Fn,Oc,Bc,zs,Hc,Rc,Qc,yt,Gc,Es,Xc,Uc,Mo,Jc,qo,li,Ge,xt,Ps,jo,Kc,Ss,Yc,ci,q,zo,Zc,Ls,eh,th,Eo,oh,Po,ah,nh,sh,So,rh,Cn,ih,dh,lh,Lo,ch,No,hh,ph,uh,I,Wo,mh,Xe,fh,Mn,gh,_h,Ns,vh,bh,Th,Dt,kh,Ws,wh,yh,Io,xh,Oo,hi,Ue,Vt,Is,Bo,Dh,Os,Vh,pi,j,Ho,$h,Bs,Ah,Fh,Ro,Ch,Qo,Mh,qh,jh,Go,zh,qn,Eh,Ph,Sh,Xo,Lh,Uo,Nh,Wh,Ih,Y,Jo,Oh,Je,Bh,jn,Hh,Rh,Hs,Qh,Gh,Xh,$t,Uh,Rs,Jh,Kh,Ko,ui,Ke,At,Qs,Yo,Yh,Gs,Zh,mi,F,Zo,ep,ea,tp,ta,op,ap,np,oa,sp,zn,rp,ip,dp,aa,lp,na,cp,hp,pp,sa,up,Xs,mp,fp,gp,z,_p,Us,vp,bp,Js,Tp,kp,Ks,wp,yp,Ys,xp,Dp,Zs,Vp,$p,er,Ap,Fp,Cp,Ft,Mp,tr,qp,jp,ra,zp,Ep,Z,ia,Pp,Ye,Sp,En,Lp,Np,or,Wp,Ip,Op,Ct,Bp,ar,Hp,Rp,da,fi,Ze,Mt,nr,la,Qp,sr,Gp,gi,X,ca,Xp,et,Up,rr,Jp,Kp,ha,Yp,Zp,eu,pa,tu,Pn,ou,au,nu,ua,su,ma,ru,iu,du,ee,fa,lu,tt,cu,Sn,hu,pu,ir,uu,mu,fu,qt,gu,dr,_u,vu,ga,_i,ot,jt,lr,_a,bu,cr,Tu,vi,U,va,ku,at,wu,hr,yu,xu,ba,Du,Vu,$u,Ta,Au,Ln,Fu,Cu,Mu,ka,qu,wa,ju,zu,Eu,te,ya,Pu,nt,Su,Nn,Lu,Nu,pr,Wu,Iu,Ou,zt,Bu,ur,Hu,Ru,xa,bi,st,Et,mr,Da,Qu,fr,Gu,Ti,E,Va,Xu,gr,Uu,Ju,$a,Ku,Aa,Yu,Zu,em,Fa,tm,Wn,om,am,nm,Ca,sm,Ma,rm,im,dm,C,qa,lm,rt,cm,In,hm,pm,_r,um,mm,fm,Pt,gm,vr,_m,vm,ja,bm,br,Tm,km,za,ki,it,St,Tr,Ea,wm,kr,ym,wi,P,Pa,xm,wr,Dm,Vm,Sa,$m,La,Am,Fm,Cm,Na,Mm,On,qm,jm,zm,Wa,Em,Ia,Pm,Sm,Lm,oe,Oa,Nm,dt,Wm,Bn,Im,Om,yr,Bm,Hm,Rm,Lt,Qm,xr,Gm,Xm,Ba,yi,lt,Nt,Dr,Ha,Um,Vr,Jm,xi,S,Ra,Km,$r,Ym,Zm,Qa,ef,Ga,tf,of,af,Xa,nf,Hn,sf,rf,df,Ua,lf,Ja,cf,hf,pf,ae,Ka,uf,ct,mf,Rn,ff,gf,Ar,_f,vf,bf,Wt,Tf,Fr,kf,wf,Ya,Di,ht,It,Cr,Za,yf,Mr,xf,Vi,L,en,Df,pt,Vf,qr,$f,Af,jr,Ff,Cf,Mf,tn,qf,on,jf,zf,Ef,an,Pf,Qn,Sf,Lf,Nf,nn,Wf,sn,If,Of,Bf,ne,rn,Hf,ut,Rf,Gn,Qf,Gf,zr,Xf,Uf,Jf,Ot,Kf,Er,Yf,Zf,dn,$i;return g=new B({}),Ht=new B({}),Kt=new B({}),Yt=new A({props:{name:"class transformers.Data2VecTextConfig",anchor:"transformers.Data2VecTextConfig",parameters:[{name:"vocab_size",val:" = 30522"},{name:"hidden_size",val:" = 768"},{name:"num_hidden_layers",val:" = 12"},{name:"num_attention_heads",val:" = 12"},{name:"intermediate_size",val:" = 3072"},{name:"hidden_act",val:" = 'gelu'"},{name:"hidden_dropout_prob",val:" = 0.1"},{name:"attention_probs_dropout_prob",val:" = 0.1"},{name:"max_position_embeddings",val:" = 512"},{name:"type_vocab_size",val:" = 2"},{name:"initializer_range",val:" = 0.02"},{name:"layer_norm_eps",val:" = 1e-12"},{name:"pad_token_id",val:" = 1"},{name:"bos_token_id",val:" = 0"},{name:"eos_token_id",val:" = 2"},{name:"position_embedding_type",val:" = 'absolute'"},{name:"use_cache",val:" = True"},{name:"classifier_dropout",val:" = None"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/data2vec/configuration_data2vec_text.py#L31",parametersDescription:[{anchor:"transformers.Data2VecTextConfig.vocab_size",description:`<strong>vocab_size</strong> (<code>int</code>, <em>optional</em>, defaults to 30522) &#x2014;
...
documentation from `),Tn=s("a"),al=a("PretrainedConfig"),nl=a(" for more information."),sl=l(),vs=s("p"),rl=a("Examples:"),il=l(),_(eo.$$.fragment),ti=l(),Se=s("h2"),_t=s("a"),bs=s("span"),_(to.$$.fragment),dl=l(),Ts=s("span"),ll=a("Data2VecAudioConfig"),oi=l(),R=s("div"),_(oo.$$.fragment),cl=l(),Le=s("p"),hl=a("This is the configuration class to store the configuration of a "),kn=s("a"),pl=a("Data2VecAudioModel"),ul=a(`. It is used to instantiate
...
library implements for all its model (such as downloading or saving etc.).`),dc=l(),To=s("p"),lc=a("This model is a PyTorch "),ko=s("a"),cc=a("torch.nn.Module"),hc=a(` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
...
to `),Js=s("code"),Tp=a("True"),kp=a(". To be used in a Seq2Seq model, the model needs to initialized with both "),Ks=s("code"),wp=a("is_decoder"),yp=a(` argument and
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),dm=l(),C=s("div"),_(qa.$$.fragment),lm=l(),rt=s("p"),cm=a("The "),In=s("a"),hm=a("Data2VecTextForSequenceClassification"),pm=a(" forward method, overrides the "),_r=s("code"),um=a("__call__"),mm=a(" special method."),fm=l(),_(Pt.$$.fragment),gm=l(),vr=s("p"),_m=a("Example of single-label classification:"),vm=l(),_(ja.$$.fragment),bm=l(),br=s("p"),Tm=a("Example of multi-label classification:"),km=l(),_(za.$$.fragment),ki=l(),it=s("h2"),St=s("a"),Tr=s("span"),_(Ea.$$.fragment),wm=l(),kr=s("span"),ym=a("Data2VecTextForMultipleChoice"),wi=l(),P=s("div"),_(Pa.$$.fragment),xm=l(),wr=s("p"),Dm=a(`Data2VecText Model with a multiple choice classification head on top (a linear layer on top of the pooled output
...
library implements for all its model (such as downloading or saving etc.).`),zi.forEach(o),El=c(ke),ho=r(ke,"P",{});var Ei=i(ho);Pl=n(Ei,"This model is a PyTorch "),po=r(Ei,"A",{href:!0,rel:!0});var Ag=i(po);Sl=n(Ag,"torch.nn.Module"),Ag.forEach(o),Ll=n(Ei,` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
...
library implements for all its model (such as downloading or saving etc.).`),Li.forEach(o),dc=c(ie),To=r(ie,"P",{});var Ni=i(To);lc=n(Ni,"This model is a PyTorch "),ko=r(Ni,"A",{href:!0,rel:!0});var Lg=i(ko);cc=n(Lg,"torch.nn.Module"),Lg.forEach(o),hc=n(Ni,` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
...
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),Ji.forEach(o),Ih=c(he),Y=r(he,"DIV",{class:!0});var De=i(Y);v(Jo.$$.fragment,De),Oh=c(De),Je=r(De,"P",{});var as=i(Je);Bh=n(as,"The "),jn=r(as,"A",{href:!0});var f_=i(jn);Hh=n(f_,"Data2VecAudioForXVector"),f_.forEach(o),Rh=n(as," forward method, overrides the "),Hs=r(as,"CODE",{});var g_=i(Hs);Qh=n(g_,"__call__"),g_.forEach(o),Gh=n(as," special method."),as.forEach(o),Xh=c(De),v($t.$$.fragment,De),Uh=c(De),Rs=r(De,"P",{});var __=i(Rs);Jh=n(__,"Example:"),__.forEach(o),Kh=c(De),v(Ko.$$.fragment,De),De.forEach(o),he.forEach(o),ui=c(t),Ke=r(t,"H2",{class:!0});var Ki=i(Ke);At=r(Ki,"A",{id:!0,class:!0,href:!0});var v_=i(At);Qs=r(v_,"SPAN",{});var b_=i(Qs);v(Yo.$$.fragment,b_),b_.forEach(o),v_.forEach(o),Yh=c(Ki),Gs=r(Ki,"SPAN",{});var T_=i(Gs);Zh=n(T_,"Data2VecTextModel"),T_.forEach(o),Ki.forEach(o),mi=c(t),F=r(t,"DIV",{class:!0});var O=i(F);v(Zo.$$.fragment,O),ep=c(O),ea=r(O,"P",{});var Yi=i(ea);tp=n(Yi,`The bare Data2VecText Model for text transformer outputting raw hidden-states without any specific head on top.
Data2VecText was proposed in `),ta=r(Yi,"A",{href:!0,rel:!0});var k_=i(ta);op=n(k_,`data2vec: A General Framework for Self-supervised Learning in Speech, Vision and
Language`),k_.forEach(o),ap=n(Yi,` by Alexei Baevski, Wei-Ning Hsu, Qiantong Xu, Arun Babu, Jiatao Gu and
...
to `),Js=r(se,"CODE",{});var V_=i(Js);Tp=n(V_,"True"),V_.forEach(o),kp=n(se,". To be used in a Seq2Seq model, the model needs to initialized with both "),Ks=r(se,"CODE",{});var $_=i(Ks);wp=n($_,"is_decoder"),$_.forEach(o),yp=n(se,` argument and
