...
format outside of Keras methods like `),Re=s("code"),In=i("fit()"),Ut=i(" and "),le=s("code"),Cn=i("predict()"),Rt=i(`, such as when creating your own layers or models with
the Keras `),de=s("code"),Ke=i("Functional"),xn=i(` API, there are three possibilities you can use to gather all the input Tensors in the first
positional argument:`),He=m(),F=s("ul"),N=s("li"),Ge=i("a single Tensor with "),ne=s("code"),Ln=i("input_ids"),Je=i(" only and nothing else: "),Xe=s("code"),Kt=i("model(input_ids)"),De=m(),ce=s("li"),Ht=i(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
...
format outside of Keras methods like `),Re=r(B,"CODE",{});var ur=a(Re);In=l(ur,"fit()"),ur.forEach(o),Ut=l(B," and "),le=r(B,"CODE",{});var Fn=a(le);Cn=l(Fn,"predict()"),Fn.forEach(o),Rt=l(B,`, such as when creating your own layers or models with
the Keras `),de=r(B,"CODE",{});var Ne=a(de);Ke=l(Ne,"Functional"),Ne.forEach(o),xn=l(B,` API, there are three possibilities you can use to gather all the input Tensors in the first
positional argument:`),B.forEach(o),He=f(w),F=r(w,"UL",{});var Ee=a(F);N=r(Ee,"LI",{});var U=a(N);Ge=l(U,"a single Tensor with "),ne=r(U,"CODE",{});var gr=a(ne);Ln=l(gr,"input_ids"),gr.forEach(o),Je=l(U," only and nothing else: "),Xe=r(U,"CODE",{});var Ve=a(Xe);Kt=l(Ve,"model(input_ids)"),Ve.forEach(o),U.forEach(o),De=f(Ee),ce=r(Ee,"LI",{});var et=a(ce);Ht=l(et,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
...
about any of this, as you can just pass inputs like you would to any other Python function!`),tt.forEach(o),this.h()},h(){h(Me,"href","https://keras.io/guides/making_new_layers_and_models_via_subclassing/"),h(Me,"rel","nofollow")},m(w,j){v(w,d,j),e(d,b),e(d,u),e(u,p),e(d,_),v(w,n,j),v(w,c,j),e(c,L),e(L,Pn),e(c,Wt),e(c,K),e(K,ie),v(w,qe,j),v(w,E,j),e(E,$n),e(E,ke),e(ke,yn),e(E,Bt),e(E,Z),e(Z,Tn),e(E,we),e(E,Re),e(Re,In),e(E,Ut),e(E,le),e(le,Cn),e(E,Rt),e(E,de),e(de,Ke),e(E,xn),v(w,He,j),v(w,F,j),e(F,N),e(N,Ge),e(N,ne),e(ne,Ln),e(N,Je),e(N,Xe),e(Xe,Kt),e(F,De),e(F,ce),e(ce,Ht),e(ce,Q),e(Q,kn),e(ce,Oe),e(ce,Ze),e(Ze,wn),e(F,Gt),e(F,M),e(M,Mn),e(M,pe),e(pe,En),v(w,Jt,j),v(w,H,j),e(H,jn),e(H,Me),e(Me,Ae),e(H,zn)},d(w){w&&o(d),w&&o(n),w&&o(c),w&&o(qe),w&&o(E),w&&o(He),w&&o(F),w&&o(Jt),w&&o(H)}}}function O_(x){let d,b,u,p,_;return{c(){d=s("p"),b=i("Although the recipe for forward pass needs to be defined within this function, one should call the "),u=s("code"),p=i("Module"),_=i(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(n){d=r(n,"P",{});var c=a(d);b=l(c,"Although the recipe for forward pass needs to be defined within this function, one should call the "),u=r(c,"CODE",{});var L=a(u);p=l(L,"Module"),L.forEach(o),_=l(c,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
the latter silently ignores them.`)},l(n){d=r(n,"P",{});var c=a(d);b=l(c,"Although the recipe for forward pass needs to be defined within this function, one should call the "),u=r(c,"CODE",{});var L=a(u);p=l(L,"Module"),L.forEach(o),_=l(c,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),c.forEach(o)},m(n,c){v(n,d,c),e(d,b),e(d,u),e(u,p),e(d,_)},d(n){n&&o(d)}}}function K_(x){let d,b,u,p,_;return p=new A({props:{code:`from PIL import Image
import requests
...
<span class="hljs-meta">&gt;&gt;&gt; </span>outputs = model(**inputs)
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_state = outputs.last_hidden_state
<span class="hljs-meta">&gt;&gt;&gt; </span>pooler_output = outputs.pooler_output  <span class="hljs-comment"># pooled CLS states</span>`}}),{c(){d=s("p"),b=i("Example:"),u=m(),P(p.$$.fragment)},l(n){d=r(n,"P",{});var c=a(d);b=l(c,"Example:"),c.forEach(o),u=f(n),$(p.$$.fragment,n)},m(n,c){v(n,d,c),e(d,b),v(n,u,c),y(p,n,c),_=!0},p:W,i(n){_||(T(p.$$.fragment,n),_=!0)},o(n){I(p.$$.fragment,n),_=!1},d(n){n&&o(d),n&&o(u),C(p,n)}}}function tv(x){let d,b,u,p,_,n,c,L,Pn,Wt,K,ie,qe,E,$n,ke,yn,Bt,Z,Tn,we,Re,In,Ut,le,Cn,Rt,de,Ke,xn,He,F,N,Ge,ne,Ln,Je,Xe,Kt,De,ce,Ht,Q,kn,Oe,Ze,wn,Gt,M,Mn,pe,En,Jt,H,jn,Me,Ae,zn,w,j,mr,Xt,Qe,fr,B,Ye,hr,ur,Fn,Ne,Ee,U,gr,Ve,et,_r,Se,qn,vr,tt,me,Zt,ba,Dn,Id,Pa,Cd,sl,se,On,xd,Qt,br,Ld,kd,Pr,wd,Md,Ed,ot,jd,$r,zd,Fd,yr,qd,Dd,Od,Yt,An,Ad,Nn,Nd,Tr,Vd,Sd,rl,nt,eo,$a,Vn,Wd,ya,Bd,al,re,Sn,Ud,st,Rd,Ir,Kd,Hd,Wn,Gd,Jd,Xd,rt,Zd,Cr,Qd,Yd,xr,ec,tc,oc,to,il,at,oo,Ta,Bn,nc,Ia,sc,ll,ae,Un,rc,it,ac,Lr,ic,lc,Rn,dc,cc,pc,lt,mc,kr,fc,hc,wr,uc,gc,_c,no,dl,dt,so,Ca,Kn,vc,xa,bc,cl,q,Hn,Pc,La,$c,yc,Gn,Tc,Mr,Ic,Cc,xc,fe,Jn,Lc,ka,kc,wc,wa,Er,Mc,Ma,Ec,jc,Ea,zc,Fc,ro,Xn,qc,Zn,Dc,ja,Oc,Ac,Nc,ao,Qn,Vc,za,Sc,Wc,jr,Yn,pl,ct,io,Fa,es,Bc,qa,Uc,ml,G,ts,Rc,os,Kc,Da,Hc,Gc,Jc,ns,Xc,zr,Zc,Qc,Yc,he,ss,ep,Oa,tp,op,Aa,Fr,np,Na,sp,rp,Va,ap,ip,lo,rs,lp,Sa,dp,fl,pt,co,Wa,as,cp,Ba,pp,hl,je,is,mp,Ua,fp,hp,ls,up,qr,gp,_p,ul,mt,po,Ra,ds,vp,Ka,bp,gl,J,cs,Pp,Ha,$p,yp,Y,Dr,Tp,Ip,Or,Cp,xp,Ar,Lp,kp,Ga,wp,Mp,Nr,Ep,jp,zp,mo,ps,Fp,ms,qp,Vr,Dp,Op,Ap,fo,fs,Np,hs,Vp,Sr,Sp,Wp,_l,ft,ho,Ja,us,Bp,Xa,Up,vl,X,gs,Rp,_s,Kp,vs,Hp,Gp,Jp,ue,bs,Xp,ht,Zp,Wr,Qp,Yp,Za,em,tm,om,uo,nm,go,sm,ge,Ps,rm,ut,am,Br,im,lm,Qa,dm,cm,pm,_o,mm,vo,fm,_e,$s,hm,gt,um,Ur,gm,_m,Ya,vm,bm,Pm,bo,$m,Po,bl,_t,$o,ei,ys,ym,ti,Tm,Pl,vt,Ts,Im,ve,Is,Cm,bt,xm,Rr,Lm,km,oi,wm,Mm,Em,yo,jm,To,$l,Pt,Io,ni,Cs,zm,si,Fm,yl,$t,xs,qm,be,Ls,Dm,yt,Om,Kr,Am,Nm,ri,Vm,Sm,Wm,Co,Bm,xo,Tl,Tt,Lo,ai,ks,Um,ii,Rm,Il,D,ws,Km,Ms,Hm,Hr,Gm,Jm,Xm,Es,Zm,js,Qm,Ym,ef,ko,tf,Pe,zs,of,It,nf,Gr,sf,rf,li,af,lf,df,wo,cf,Mo,pf,$e,Fs,mf,Ct,ff,Jr,hf,uf,di,gf,_f,vf,Eo,bf,jo,Pf,ye,qs,$f,xt,yf,Xr,Tf,If,ci,Cf,xf,Lf,zo,kf,Fo,Cl,Lt,qo,pi,Ds,wf,mi,Mf,xl,kt,Os,Ef,Te,As,jf,wt,zf,Zr,Ff,qf,fi,Df,Of,Af,Do,Nf,Oo,Ll,Mt,Ao,hi,Ns,Vf,ui,Sf,kl,Et,Vs,Wf,Ie,Ss,Bf,jt,Uf,Qr,Rf,Kf,gi,Hf,Gf,Jf,No,Xf,Vo,wl,zt,So,_i,Ws,Zf,vi,Qf,Ml,z,Bs,Yf,Us,eh,Yr,th,oh,nh,Rs,sh,Ks,rh,ah,ih,bi,lh,dh,ze,Pi,Hs,ch,ph,$i,Gs,mh,fh,yi,Js,hh,uh,Ti,Xs,gh,_h,Ce,Zs,vh,Ft,bh,Ii,Ph,$h,Ci,yh,Th,Ih,Wo,Ch,Bo,xh,Uo,Qs,Lh,Ro,kh,Ko,Ys,wh,Ho,El,qt,Go,xi,er,Mh,Li,Eh,jl,Dt,tr,jh,xe,or,zh,Ot,Fh,ki,qh,Dh,wi,Oh,Ah,Nh,Jo,Vh,Xo,zl,At,Zo,Mi,nr,Sh,Ei,Wh,Fl,Nt,sr,Bh,Le,rr,Uh,Vt,Rh,ji,Kh,Hh,zi,Gh,Jh,Xh,Qo,Zh,Yo,ql;return n=new O({}),E=new O({}),ne=new O({}),Ne=new A({props:{code:`from PIL import Image
import requests
...
Dictionary of keyword arguments.`,name:"kwargs"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/clip/configuration_clip.py#L254"}}),An=new k({props:{name:"from_text_vision_configs",anchor:"transformers.CLIPConfig.from_text_vision_configs",parameters:[{name:"text_config",val:": CLIPTextConfig"},{name:"vision_config",val:": CLIPVisionConfig"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/clip/configuration_clip.py#L303",returnDescription:`
...
The end of sequence token.`,name:"eos_token"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/clip/tokenization_clip_fast.py#L50"}}),ss=new k({props:{name:"build_inputs_with_special_tokens",anchor:"transformers.CLIPTokenizerFast.build_inputs_with_special_tokens",parameters:[{name:"token_ids_0",val:": typing.List[int]"},{name:"token_ids_1",val:": typing.Optional[typing.List[int]] = None"}],parametersDescription:[{anchor:"transformers.CLIPTokenizerFast.build_inputs_with_special_tokens.token_ids_0",description:`<strong>token_ids_0</strong> (<code>List[int]</code>) &#x2014;
...
`}}),yo=new oe({props:{$$slots:{default:[j_]},$$scope:{ctx:x}}}),To=new S({props:{anchor:"transformers.CLIPTextModel.forward.example",$$slots:{default:[z_]},$$scope:{ctx:x}}}),Cs=new O({}),xs=new k({props:{name:"class transformers.CLIPVisionModel",anchor:"transformers.CLIPVisionModel",parameters:[{name:"config",val:": CLIPVisionConfig"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/clip/modeling_clip.py#L801"}}),Ls=new k({props:{name:"forward",anchor:"transformers.CLIPVisionModel.forward",parameters:[{name:"pixel_values",val:": typing.Optional[torch.FloatTensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.CLIPVisionModel.forward.pixel_values",description:`<strong>pixel_values</strong> (<code>torch.FloatTensor</code> of shape <code>(batch_size, num_channels, height, width)</code>) &#x2014;
Pixel values. Padding will be ignored by default should you provide it. Pixel values can be obtained using
...
<p><a
  href="/docs/transformers/main/en/main_classes/output#transformers.modeling_tf_outputs.TFBaseModelOutputWithPooling"
>transformers.modeling_tf_outputs.TFBaseModelOutputWithPooling</a> or <code>tuple(tf.Tensor)</code></p>
`}}),No=new oe({props:{$$slots:{default:[R_]},$$scope:{ctx:x}}}),Vo=new S({props:{anchor:"transformers.TFCLIPVisionModel.call.example",$$slots:{default:[K_]},$$scope:{ctx:x}}}),Ws=new O({}),Bs=new k({props:{name:"class transformers.FlaxCLIPModel",anchor:"transformers.FlaxCLIPModel",parameters:[{name:"config",val:": CLIPConfig"},{name:"input_shape",val:": typing.Optional[typing.Tuple] = None"},{name:"seed",val:": int = 0"},{name:"dtype",val:": dtype = <class 'jax.numpy.float32'>"},{name:"_do_init",val:": bool = True"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.FlaxCLIPModel.config",description:`<strong>config</strong> (<a href="/docs/transformers/main/en/model_doc/clip#transformers.CLIPConfig">CLIPConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
...
<a href="/docs/transformers/main/en/main_classes/model#transformers.FlaxPreTrainedModel.to_bf16">to_bf16()</a>.`,name:"dtype"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/clip/modeling_flax_clip.py#L1148"}}),Zs=new k({props:{name:"__call__",anchor:"transformers.FlaxCLIPModel.__call__",parameters:[{name:"input_ids",val:""},{name:"pixel_values",val:""},{name:"attention_mask",val:" = None"},{name:"position_ids",val:" = None"},{name:"params",val:": dict = None"},{name:"dropout_rng",val:": PRNGKey = None"},{name:"train",val:": bool = False"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.FlaxCLIPModel.__call__.input_ids",description:`<strong>input_ids</strong> (<code>numpy.ndarray</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. Padding will be ignored by default should you provide
it.</p>
<p>Indices can be obtained using <a href="/docs/transformers/main/en/model_doc/clip#transformers.CLIPTokenizer">CLIPTokenizer</a>. See <a href="/docs/transformers/main/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/main/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
`}}),Ro=new S({props:{anchor:"transformers.FlaxCLIPModel.get_text_features.example",$$slots:{default:[J_]},$$scope:{ctx:x}}}),Ys=new k({props:{name:"get_image_features",anchor:"transformers.FlaxCLIPModel.get_image_features",parameters:[{name:"pixel_values",val:""},{name:"params",val:": dict = None"},{name:"dropout_rng",val:": PRNGKey = None"},{name:"train",val:" = False"}],parametersDescription:[{anchor:"transformers.FlaxCLIPModel.get_image_features.pixel_values",description:`<strong>pixel_values</strong> (<code>numpy.ndarray</code> of shape <code>(batch_size, num_channels, height, width)</code>) &#x2014;
...
`}}),Ho=new S({props:{anchor:"transformers.FlaxCLIPModel.get_image_features.example",$$slots:{default:[X_]},$$scope:{ctx:x}}}),er=new O({}),tr=new k({props:{name:"class transformers.FlaxCLIPTextModel",anchor:"transformers.FlaxCLIPTextModel",parameters:[{name:"config",val:": CLIPTextConfig"},{name:"input_shape",val:" = (1, 1)"},{name:"seed",val:": int = 0"},{name:"dtype",val:": dtype = <class 'jax.numpy.float32'>"},{name:"_do_init",val:": bool = True"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/clip/modeling_flax_clip.py#L969"}}),or=new k({props:{name:"__call__",anchor:"transformers.FlaxCLIPTextModel.__call__",parameters:[{name:"input_ids",val:""},{name:"attention_mask",val:" = None"},{name:"position_ids",val:" = None"},{name:"params",val:": dict = None"},{name:"dropout_rng",val:": PRNGKey = None"},{name:"train",val:": bool = False"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.FlaxCLIPTextModel.__call__.input_ids",description:`<strong>input_ids</strong> (<code>numpy.ndarray</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. Padding will be ignored by default should you provide
it.</p>
<p>Indices can be obtained using <a href="/docs/transformers/main/en/model_doc/clip#transformers.CLIPTokenizer">CLIPTokenizer</a>. See <a href="/docs/transformers/main/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/main/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
`}}),Jo=new oe({props:{$$slots:{default:[Z_]},$$scope:{ctx:x}}}),Xo=new S({props:{anchor:"transformers.FlaxCLIPTextModel.__call__.example",$$slots:{default:[Q_]},$$scope:{ctx:x}}}),nr=new O({}),sr=new k({props:{name:"class transformers.FlaxCLIPVisionModel",anchor:"transformers.FlaxCLIPVisionModel",parameters:[{name:"config",val:": CLIPVisionConfig"},{name:"input_shape",val:": typing.Optional[typing.Tuple] = None"},{name:"seed",val:": int = 0"},{name:"dtype",val:": dtype = <class 'jax.numpy.float32'>"},{name:"_do_init",val:": bool = True"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/clip/modeling_flax_clip.py#L1022"}}),rr=new k({props:{name:"__call__",anchor:"transformers.FlaxCLIPVisionModel.__call__",parameters:[{name:"pixel_values",val:""},{name:"params",val:": dict = None"},{name:"dropout_rng",val:": PRNGKey = None"},{name:"train",val:": bool = False"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.FlaxCLIPVisionModel.__call__.pixel_values",description:`<strong>pixel_values</strong> (<code>numpy.ndarray</code> of shape <code>(batch_size, num_channels, height, width)</code>) &#x2014;
Pixel values. Padding will be ignored by default should you provide it. Pixel values can be obtained using
...
<p><a
  href="/docs/transformers/main/en/main_classes/output#transformers.modeling_flax_outputs.FlaxBaseModelOutputWithPooling"
>transformers.modeling_flax_outputs.FlaxBaseModelOutputWithPooling</a> or <code>tuple(torch.FloatTensor)</code></p>
`}}),Qo=new oe({props:{$$slots:{default:[Y_]},$$scope:{ctx:x}}}),Yo=new S({props:{anchor:"transformers.FlaxCLIPVisionModel.__call__.example",$$slots:{default:[ev]},$$scope:{ctx:x}}}),{c(){d=s("meta"),b=m(),u=s("h1"),p=s("a"),_=s("span"),P(n.$$.fragment),c=m(),L=s("span"),Pn=i("CLIP"),Wt=m(),K=s("h2"),ie=s("a"),qe=s("span"),P(E.$$.fragment),$n=m(),ke=s("span"),yn=i("Overview"),Bt=m(),Z=s("p"),Tn=i("The CLIP model was proposed in "),we=s("a"),Re=i("Learning Transferable Visual Models From Natural Language Supervision"),In=i(` by Alec Radford, Jong Wook Kim, Chris Hallacy, Aditya Ramesh, Gabriel Goh,
Sandhini Agarwal, Girish Sastry, Amanda Askell, Pamela Mishkin, Jack Clark, Gretchen Krueger, Ilya Sutskever. CLIP
(Contrastive Language-Image Pre-Training) is a neural network trained on a variety of (image, text) pairs. It can be
instructed in natural language to predict the most relevant text snippet, given an image, without directly optimizing
for the task, similarly to the zero-shot capabilities of GPT-2 and 3.`),Ut=m(),le=s("p"),Cn=i("The abstract from the paper is the following:"),Rt=m(),de=s("p"),Ke=s("em"),xn=i(`State-of-the-art computer vision systems are trained to predict a fixed set of predetermined object categories. This
...
model weights at this https URL.`),He=m(),F=s("h2"),N=s("a"),Ge=s("span"),P(ne.$$.fragment),Ln=m(),Je=s("span"),Xe=i("Usage"),Kt=m(),De=s("p"),ce=i(`CLIP is a multi-modal vision and language model. It can be used for image-text similarity and for zero-shot image
...
configuration.`),rl=m(),nt=s("h2"),eo=s("a"),$a=s("span"),P(Vn.$$.fragment),Wd=m(),ya=s("span"),Bd=i("CLIPTextConfig"),al=m(),re=s("div"),P(Sn.$$.fragment),Ud=m(),st=s("p"),Rd=i("This is the configuration class to store the configuration of a "),Ir=s("a"),Kd=i("CLIPModel"),Hd=i(`. It is used to instantiate an CLIP
...
model according to the specified arguments, defining the model architecture. Instantiating a configuration with the
defaults will yield a similar configuration to that of the CLIP
`),Rn=s("a"),dc=i("openai/clip-vit-base-patch32"),cc=i(" architecture."),pc=m(),lt=s("p"),mc=i("Configuration objects inherit from "),kr=s("a"),fc=i("PretrainedConfig"),hc=i(` and can be used to control the model outputs. Read the
documentation from `),wr=s("a"),uc=i("PretrainedConfig"),gc=i(" for more information."),_c=m(),P(no.$$.fragment),dl=m(),dt=s("h2"),so=s("a"),Ca=s("span"),P(Kn.$$.fragment),vc=m(),xa=s("span"),bc=i("CLIPTokenizer"),cl=m(),q=s("div"),P(Hn.$$.fragment),Pc=m(),La=s("p"),$c=i("Construct a CLIP tokenizer. Based on byte-level Byte-Pair-Encoding."),yc=m(),Gn=s("p"),Tc=i("This tokenizer inherits from "),Mr=s("a"),Ic=i("PreTrainedTokenizer"),Cc=i(` which contains most of the main methods. Users should refer to
...
zeros is returned.`),Wc=m(),jr=s("div"),P(Yn.$$.fragment),pl=m(),ct=s("h2"),io=s("a"),Fa=s("span"),P(es.$$.fragment),Bc=m(),qa=s("span"),Uc=i("CLIPTokenizerFast"),ml=m(),G=s("div"),P(ts.$$.fragment),Rc=m(),os=s("p"),Kc=i("Construct a \u201Cfast\u201D CLIP tokenizer (backed by HuggingFace\u2019s "),Da=s("em"),Hc=i("tokenizers"),Gc=i(` library). Based on byte-level
...
the docstring of this method for more information.`),_l=m(),ft=s("h2"),ho=s("a"),Ja=s("span"),P(us.$$.fragment),Bp=m(),Xa=s("span"),Up=i("CLIPModel"),vl=m(),X=s("div"),P(gs.$$.fragment),Rp=m(),_s=s("p"),Kp=i("This model is a PyTorch "),vs=s("a"),Hp=i("torch.nn.Module"),Gp=i(` subclass. Use it
as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),Jp=m(),ue=s("div"),P(bs.$$.fragment),Xp=m(),ht=s("p"),Zp=i("The "),Wr=s("a"),Qp=i("CLIPModel"),Yp=i(" forward method, overrides the "),Za=s("code"),em=i("__call__"),tm=i(" special method."),om=m(),P(uo.$$.fragment),nm=m(),P(go.$$.fragment),sm=m(),ge=s("div"),P(Ps.$$.fragment),rm=m(),ut=s("p"),am=i("The "),Br=s("a"),im=i("CLIPModel"),lm=i(" forward method, overrides the "),Qa=s("code"),dm=i("__call__"),cm=i(" special method."),pm=m(),P(_o.$$.fragment),mm=m(),P(vo.$$.fragment),fm=m(),_e=s("div"),P($s.$$.fragment),hm=m(),gt=s("p"),um=i("The "),Ur=s("a"),gm=i("CLIPModel"),_m=i(" forward method, overrides the "),Ya=s("code"),vm=i("__call__"),bm=i(" special method."),Pm=m(),P(bo.$$.fragment),$m=m(),P(Po.$$.fragment),bl=m(),_t=s("h2"),$o=s("a"),ei=s("span"),P(ys.$$.fragment),ym=m(),ti=s("span"),Tm=i("CLIPTextModel"),Pl=m(),vt=s("div"),P(Ts.$$.fragment),Im=m(),ve=s("div"),P(Is.$$.fragment),Cm=m(),bt=s("p"),xm=i("The "),Rr=s("a"),Lm=i("CLIPTextModel"),km=i(" forward method, overrides the "),oi=s("code"),wm=i("__call__"),Mm=i(" special method."),Em=m(),P(yo.$$.fragment),jm=m(),P(To.$$.fragment),$l=m(),Pt=s("h2"),Io=s("a"),ni=s("span"),P(Cs.$$.fragment),zm=m(),si=s("span"),Fm=i("CLIPVisionModel"),yl=m(),$t=s("div"),P(xs.$$.fragment),qm=m(),be=s("div"),P(Ls.$$.fragment),Dm=m(),yt=s("p"),Om=i("The "),Kr=s("a"),Am=i("CLIPVisionModel"),Nm=i(" forward method, overrides the "),ri=s("code"),Vm=i("__call__"),Sm=i(" special method."),Wm=m(),P(Co.$$.fragment),Bm=m(),P(xo.$$.fragment),Tl=m(),Tt=s("h2"),Lo=s("a"),ai=s("span"),P(ks.$$.fragment),Um=m(),ii=s("span"),Rm=i("TFCLIPModel"),Il=m(),D=s("div"),P(ws.$$.fragment),Km=m(),Ms=s("p"),Hm=i("This model inherits from "),Hr=s("a"),Gm=i("TFPreTrainedModel"),Jm=i(`. Check the superclass documentation for the generic methods the
...
behavior.`),ef=m(),P(ko.$$.fragment),tf=m(),Pe=s("div"),P(zs.$$.fragment),of=m(),It=s("p"),nf=i("The "),Gr=s("a"),sf=i("TFCLIPModel"),rf=i(" forward method, overrides the "),li=s("code"),af=i("__call__"),lf=i(" special method."),df=m(),P(wo.$$.fragment),cf=m(),P(Mo.$$.fragment),pf=m(),$e=s("div"),P(Fs.$$.fragment),mf=m(),Ct=s("p"),ff=i("The "),Jr=s("a"),hf=i("TFCLIPModel"),uf=i(" forward method, overrides the "),di=s("code"),gf=i("__call__"),_f=i(" special method."),vf=m(),P(Eo.$$.fragment),bf=m(),P(jo.$$.fragment),Pf=m(),ye=s("div"),P(qs.$$.fragment),$f=m(),xt=s("p"),yf=i("The "),Xr=s("a"),Tf=i("TFCLIPModel"),If=i(" forward method, overrides the "),ci=s("code"),Cf=i("__call__"),xf=i(" special method."),Lf=m(),P(zo.$$.fragment),kf=m(),P(Fo.$$.fragment),Cl=m(),Lt=s("h2"),qo=s("a"),pi=s("span"),P(Ds.$$.fragment),wf=m(),mi=s("span"),Mf=i("TFCLIPTextModel"),xl=m(),kt=s("div"),P(Os.$$.fragment),Ef=m(),Te=s("div"),P(As.$$.fragment),jf=m(),wt=s("p"),zf=i("The "),Zr=s("a"),Ff=i("TFCLIPTextModel"),qf=i(" forward method, overrides the "),fi=s("code"),Df=i("__call__"),Of=i(" special method."),Af=m(),P(Do.$$.fragment),Nf=m(),P(Oo.$$.fragment),Ll=m(),Mt=s("h2"),Ao=s("a"),hi=s("span"),P(Ns.$$.fragment),Vf=m(),ui=s("span"),Sf=i("TFCLIPVisionModel"),kl=m(),Et=s("div"),P(Vs.$$.fragment),Wf=m(),Ie=s("div"),P(Ss.$$.fragment),Bf=m(),jt=s("p"),Uf=i("The "),Qr=s("a"),Rf=i("TFCLIPVisionModel"),Kf=i(" forward method, overrides the "),gi=s("code"),Hf=i("__call__"),Gf=i(" special method."),Jf=m(),P(No.$$.fragment),Xf=m(),P(Vo.$$.fragment),wl=m(),zt=s("h2"),So=s("a"),_i=s("span"),P(Ws.$$.fragment),Zf=m(),vi=s("span"),Qf=i("FlaxCLIPModel"),Ml=m(),z=s("div"),P(Bs.$$.fragment),Yf=m(),Us=s("p"),eh=i("This model inherits from "),Yr=s("a"),th=i("FlaxPreTrainedModel"),oh=i(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),nh=m(),Rs=s("p"),sh=i("This model is also a Flax Linen "),Ks=s("a"),rh=i("flax.linen.Module"),ah=i(`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),ih=m(),bi=s("p"),lh=i("Finally, this model supports inherent JAX features such as:"),dh=m(),ze=s("ul"),Pi=s("li"),Hs=s("a"),ch=i("Just-In-Time (JIT) compilation"),ph=m(),$i=s("li"),Gs=s("a"),mh=i("Automatic Differentiation"),fh=m(),yi=s("li"),Js=s("a"),hh=i("Vectorization"),uh=m(),Ti=s("li"),Xs=s("a"),gh=i("Parallelization"),_h=m(),Ce=s("div"),P(Zs.$$.fragment),vh=m(),Ft=s("p"),bh=i("The "),Ii=s("code"),Ph=i("FlaxCLIPPreTrainedModel"),$h=i(" forward method, overrides the "),Ci=s("code"),yh=i("__call__"),Th=i(" special method."),Ih=m(),P(Wo.$$.fragment),Ch=m(),P(Bo.$$.fragment),xh=m(),Uo=s("div"),P(Qs.$$.fragment),Lh=m(),P(Ro.$$.fragment),kh=m(),Ko=s("div"),P(Ys.$$.fragment),wh=m(),P(Ho.$$.fragment),El=m(),qt=s("h2"),Go=s("a"),xi=s("span"),P(er.$$.fragment),Mh=m(),Li=s("span"),Eh=i("FlaxCLIPTextModel"),jl=m(),Dt=s("div"),P(tr.$$.fragment),jh=m(),xe=s("div"),P(or.$$.fragment),zh=m(),Ot=s("p"),Fh=i("The "),ki=s("code"),qh=i("FlaxCLIPTextPreTrainedModel"),Dh=i(" forward method, overrides the "),wi=s("code"),Oh=i("__call__"),Ah=i(" special method."),Nh=m(),P(Jo.$$.fragment),Vh=m(),P(Xo.$$.fragment),zl=m(),At=s("h2"),Zo=s("a"),Mi=s("span"),P(nr.$$.fragment),Sh=m(),Ei=s("span"),Wh=i("FlaxCLIPVisionModel"),Fl=m(),Nt=s("div"),P(sr.$$.fragment),Bh=m(),Le=s("div"),P(rr.$$.fragment),Uh=m(),Vt=s("p"),Rh=i("The "),ji=s("code"),Kh=i("FlaxCLIPVisionPreTrainedModel"),Hh=i(" forward method, overrides the "),zi=s("code"),Gh=i("__call__"),Jh=i(" special method."),Xh=m(),P(Qo.$$.fragment),Zh=m(),P(Yo.$$.fragment),this.h()},l(t){const g=y_('[data-svelte="svelte-1phssyn"]',document.head);d=r(g,"META",{name:!0,content:!0}),g.forEach(o),b=f(t),u=r(t,"H1",{class:!0});var ar=a(u);p=r(ar,"A",{id:!0,class:!0,href:!0});var Fi=a(p);_=r(Fi,"SPAN",{});var qi=a(_);$(n.$$.fragment,qi),qi.forEach(o),Fi.forEach(o),c=f(ar),L=r(ar,"SPAN",{});var Di=a(L);Pn=l(Di,"CLIP"),Di.forEach(o),ar.forEach(o),Wt=f(t),K=r(t,"H2",{class:!0});var ir=a(K);ie=r(ir,"A",{id:!0,class:!0,href:!0});var Oi=a(ie);qe=r(Oi,"SPAN",{});var Ai=a(qe);$(E.$$.fragment,Ai),Ai.forEach(o),Oi.forEach(o),$n=f(ir),ke=r(ir,"SPAN",{});var Ni=a(ke);yn=l(Ni,"Overview"),Ni.forEach(o),ir.forEach(o),Bt=f(t),Z=r(t,"P",{});var lr=a(Z);Tn=l(lr,"The CLIP model was proposed in "),we=r(lr,"A",{href:!0,rel:!0});var Vi=a(we);Re=l(Vi,"Learning Transferable Visual Models From Natural Language Supervision"),Vi.forEach(o),In=l(lr,` by Alec Radford, Jong Wook Kim, Chris Hallacy, Aditya Ramesh, Gabriel Goh,
Sandhini Agarwal, Girish Sastry, Amanda Askell, Pamela Mishkin, Jack Clark, Gretchen Krueger, Ilya Sutskever. CLIP
(Contrastive Language-Image Pre-Training) is a neural network trained on a variety of (image, text) pairs. It can be
instructed in natural language to predict the most relevant text snippet, given an image, without directly optimizing
for the task, similarly to the zero-shot capabilities of GPT-2 and 3.`),lr.forEach(o),Ut=f(t),le=r(t,"P",{});var Si=a(le);Cn=l(Si,"The abstract from the paper is the following:"),Si.forEach(o),Rt=f(t),de=r(t,"P",{});var Wi=a(de);Ke=r(Wi,"EM",{});var Bi=a(Ke);xn=l(Bi,`State-of-the-art computer vision systems are trained to predict a fixed set of predetermined object categories. This
restricted form of supervision limits their generality and usability since additional labeled data is needed to specify
any other visual concept. Learning directly from raw text about images is a promising alternative which leverages a
much broader source of supervision. We demonstrate that the simple pre-training task of predicting which caption goes
with which image is an efficient and scalable way to learn SOTA image representations from scratch on a dataset of 400
...
for any dataset specific training. For instance, we match the accuracy of the original ResNet-50 on ImageNet zero-shot
without needing to use any of the 1.28 million training examples it was trained on. We release our code and pre-trained
model weights at this https URL.`),Bi.forEach(o),Wi.forEach(o),He=f(t),F=r(t,"H2",{class:!0});var dr=a(F);N=r(dr,"A",{id:!0,class:!0,href:!0});var Ui=a(N);Ge=r(Ui,"SPAN",{});var Ri=a(Ge);$(ne.$$.fragment,Ri),Ri.forEach(o),Ui.forEach(o),Ln=f(dr),Je=r(dr,"SPAN",{});var Ki=a(Je);Xe=l(Ki,"Usage"),Ki.forEach(o),dr.forEach(o),Kt=f(t),De=r(t,"P",{});var Hi=a(De);ce=l(Hi,`CLIP is a multi-modal vision and language model. It can be used for image-text similarity and for zero-shot image
classification. CLIP uses a ViT like transformer to get visual features and a causal language model to get the text
features. Both the text and visual features are then projected to a latent space with identical dimension. The dot
...
configuration.`),Ol.forEach(o),Dl.forEach(o),en.forEach(o),rl=f(t),nt=r(t,"H2",{class:!0});var Al=a(nt);eo=r(Al,"A",{id:!0,class:!0,href:!0});var lu=a(eo);$a=r(lu,"SPAN",{});var du=a($a);$(Vn.$$.fragment,du),du.forEach(o),lu.forEach(o),Wd=f(Al),ya=r(Al,"SPAN",{});var cu=a(ya);Bd=l(cu,"CLIPTextConfig"),cu.forEach(o),Al.forEach(o),al=f(t),re=r(t,"DIV",{class:!0});var tn=a(re);$(Sn.$$.fragment,tn),Ud=f(tn),st=r(tn,"P",{});var ta=a(st);Rd=l(ta,"This is the configuration class to store the configuration of a "),Ir=r(ta,"A",{href:!0});var pu=a(Ir);Kd=l(pu,"CLIPModel"),pu.forEach(o),Hd=l(ta,`. It is used to instantiate an CLIP
model according to the specified arguments, defining the model architecture. Instantiating a configuration with the
defaults will yield a similar configuration to that of the CLIP
...
zeros is returned.`),ju.forEach(o),Ul.forEach(o),Wc=f(ee),jr=r(ee,"DIV",{class:!0});var zu=a(jr);$(Yn.$$.fragment,zu),zu.forEach(o),ee.forEach(o),pl=f(t),ct=r(t,"H2",{class:!0});var Rl=a(ct);io=r(Rl,"A",{id:!0,class:!0,href:!0});var Fu=a(io);Fa=r(Fu,"SPAN",{});var qu=a(Fa);$(es.$$.fragment,qu),qu.forEach(o),Fu.forEach(o),Bc=f(Rl),qa=r(Rl,"SPAN",{});var Du=a(qa);Uc=l(Du,"CLIPTokenizerFast"),Du.forEach(o),Rl.forEach(o),ml=f(t),G=r(t,"DIV",{class:!0});var We=a(G);$(ts.$$.fragment,We),Rc=f(We),os=r(We,"P",{});var Kl=a(os);Kc=l(Kl,"Construct a \u201Cfast\u201D CLIP tokenizer (backed by HuggingFace\u2019s "),Da=r(Kl,"EM",{});var Ou=a(Da);Hc=l(Ou,"tokenizers"),Ou.forEach(o),Gc=l(Kl,` library). Based on byte-level
Byte-Pair-Encoding.`),Kl.forEach(o),Jc=f(We),ns=r(We,"P",{});var Hl=a(ns);Xc=l(Hl,"This tokenizer inherits from "),zr=r(Hl,"A",{href:!0});var Au=a(zr);Zc=l(Au,"PreTrainedTokenizerFast"),Au.forEach(o),Qc=l(Hl,` which contains most of the main methods. Users should
