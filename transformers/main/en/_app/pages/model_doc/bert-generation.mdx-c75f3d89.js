import{S as ha,i as pa,s as ma,e as s,k as l,w as g,t as o,M as ua,c as a,d as n,m as c,a as i,x as _,h as r,b as d,F as e,g as p,y as b,q as v,o as k,B as T}from"../../chunks/vendor-4833417e.js";import{T as ca}from"../../chunks/Tip-fffd6df1.js";import{D as He}from"../../chunks/Docstring-4f315ed9.js";import{C as Jt}from"../../chunks/CodeBlock-6a3d1b46.js";import{I as vt}from"../../chunks/IconCopyLink-4b81c553.js";import"../../chunks/CopyButton-dacfbfaf.js";function fa(ie){let m,q,u,y,C;return{c(){m=s("p"),q=o("Although the recipe for forward pass needs to be defined within this function, one should call the "),u=s("code"),y=o("Module"),C=o(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(w){m=a(w,"P",{});var E=i(m);q=r(E,"Although the recipe for forward pass needs to be defined within this function, one should call the "),u=a(E,"CODE",{});var S=i(u);y=r(S,"Module"),S.forEach(n),C=r(E,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),E.forEach(n)},m(w,E){p(w,m,E),e(m,q),e(m,u),e(u,y),e(m,C)},d(w){w&&n(m)}}}function ga(ie){let m,q,u,y,C;return{c(){m=s("p"),q=o("Although the recipe for forward pass needs to be defined within this function, one should call the "),u=s("code"),y=o("Module"),C=o(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(w){m=a(w,"P",{});var E=i(m);q=r(E,"Although the recipe for forward pass needs to be defined within this function, one should call the "),u=a(E,"CODE",{});var S=i(u);y=r(S,"Module"),S.forEach(n),C=r(E,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),E.forEach(n)},m(w,E){p(w,m,E),e(m,q),e(m,u),e(u,y),e(m,C)},d(w){w&&n(m)}}}function _a(ie){let m,q,u,y,C,w,E,S,Dn,Kt,R,Y,kt,de,Sn,Tt,An,Qt,A,Mn,Ve,Nn,Ln,le,Fn,On,Xt,Je,In,Yt,Ke,yt,Rn,Zt,Qe,Wn,en,Xe,ce,Un,Ye,Hn,Vn,tn,he,nn,Ze,pe,Jn,et,Kn,Qn,on,me,rn,tt,Xn,sn,Z,M,nt,Yn,Zn,ot,eo,to,wt,no,oo,ro,Et,so,an,N,ao,ue,io,lo,fe,co,ho,dn,W,ee,Bt,ge,po,zt,mo,ln,$,_e,uo,be,fo,$t,go,_o,bo,U,vo,rt,ko,To,st,yo,wo,Eo,Gt,Bo,zo,ve,cn,H,te,qt,ke,$o,Pt,Go,hn,D,Te,qo,ye,Po,we,jo,xo,Co,Ee,Do,at,So,Ao,Mo,it,Be,pn,V,ne,jt,ze,No,xt,Lo,mn,f,$e,Fo,Ct,Oo,Io,Ge,Ro,dt,Wo,Uo,Ho,qe,Vo,Pe,Jo,Ko,Qo,je,Xo,xe,Yo,Zo,er,J,tr,lt,nr,or,Ce,rr,sr,ar,B,ir,Dt,dr,lr,St,cr,hr,At,pr,mr,Mt,ur,fr,Nt,gr,_r,Lt,br,vr,kr,P,De,Tr,K,yr,ct,wr,Er,Ft,Br,zr,$r,oe,Gr,Ot,qr,Pr,Se,un,Q,re,It,Ae,jr,Rt,xr,fn,G,Me,Cr,Ne,Dr,Wt,Sr,Ar,Mr,Le,Nr,ht,Lr,Fr,Or,Fe,Ir,Oe,Rr,Wr,Ur,j,Ie,Hr,X,Vr,pt,Jr,Kr,Ut,Qr,Xr,Yr,se,Zr,Ht,es,ts,Re,gn;return w=new vt({}),de=new vt({}),he=new Jt({props:{code:`# leverage checkpoints for Bert2Bert model...
...
<span class="hljs-meta">&gt;&gt;&gt; </span>prediction_logits = outputs.logits`}}),{c(){m=s("meta"),q=l(),u=s("h1"),y=s("a"),C=s("span"),g(w.$$.fragment),E=l(),S=s("span"),Dn=o("BertGeneration"),Kt=l(),R=s("h2"),Y=s("a"),kt=s("span"),g(de.$$.fragment),Sn=l(),Tt=s("span"),An=o("Overview"),Qt=l(),A=s("p"),Mn=o(`The BertGeneration model is a BERT model that can be leveraged for sequence-to-sequence tasks using
...
BERT checkpoints for subsequent fine-tuning.`),tn=l(),g(he.$$.fragment),nn=l(),Ze=s("ul"),pe=s("li"),Jn=o("Pretrained "),et=s("a"),Kn=o("EncoderDecoderModel"),Qn=o(" are also directly available in the model hub, e.g.,"),on=l(),g(me.$$.fragment),rn=l(),tt=s("p"),Xn=o("Tips:"),sn=l(),Z=s("ul"),M=s("li"),nt=s("a"),Yn=o("BertGenerationEncoder"),Zn=o(" and "),ot=s("a"),eo=o("BertGenerationDecoder"),to=o(` should be used in
...
found `),fe=s("a"),co=o("here"),ho=o("."),dn=l(),W=s("h2"),ee=s("a"),Bt=s("span"),g(ge.$$.fragment),po=l(),zt=s("span"),mo=o("BertGenerationConfig"),ln=l(),$=s("div"),g(_e.$$.fragment),uo=l(),be=s("p"),fo=o("This is the configuration class to store the configuration of a "),$t=s("code"),go=o("BertGenerationPreTrainedModel"),_o=o(` It is used to
...
this superclass for more information regarding those methods.`),Mo=l(),it=s("div"),g(Be.$$.fragment),pn=l(),V=s("h2"),ne=s("a"),jt=s("span"),g(ze.$$.fragment),No=l(),xt=s("span"),Lo=o("BertGenerationEncoder"),mn=l(),f=s("div"),g($e.$$.fragment),Fo=l(),Ct=s("p"),Oo=o("The bare BertGeneration model transformer outputting raw hidden-states without any specific head on top."),Io=l(),Ge=s("p"),Ro=o("This model inherits from "),dt=s("a"),Wo=o("PreTrainedModel"),Uo=o(`. Check the superclass documentation for the generic methods the
...
to `),St=s("code"),cr=o("True"),hr=o(". To be used in a Seq2Seq model, the model needs to initialized with both "),At=s("code"),pr=o("is_decoder"),mr=o(` argument and
`),Mt=s("code"),ur=o("add_cross_attention"),fr=o(" set to "),Nt=s("code"),gr=o("True"),_r=o("; an "),Lt=s("code"),br=o("encoder_hidden_states"),vr=o(" is then expected as an input to the forward pass."),kr=l(),P=s("div"),g(De.$$.fragment),Tr=l(),K=s("p"),yr=o("The "),ct=s("a"),wr=o("BertGenerationEncoder"),Er=o(" forward method, overrides the "),Ft=s("code"),Br=o("__call__"),zr=o(" special method."),$r=l(),g(oe.$$.fragment),Gr=l(),Ot=s("p"),qr=o("Example:"),Pr=l(),g(Se.$$.fragment),un=l(),Q=s("h2"),re=s("a"),It=s("span"),g(Ae.$$.fragment),jr=l(),Rt=s("span"),xr=o("BertGenerationDecoder"),fn=l(),G=s("div"),g(Me.$$.fragment),Cr=l(),Ne=s("p"),Dr=o("BertGeneration Model with a "),Wt=s("code"),Sr=o("language modeling"),Ar=o(" head on top for CLM fine-tuning."),Mr=l(),Le=s("p"),Nr=o("This model inherits from "),ht=s("a"),Lr=o("PreTrainedModel"),Fr=o(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Or=l(),Fe=s("p"),Ir=o("This model is also a PyTorch "),Oe=s("a"),Rr=o("torch.nn.Module"),Wr=o(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Ur=l(),j=s("div"),g(Ie.$$.fragment),Hr=l(),X=s("p"),Vr=o("The "),pt=s("a"),Jr=o("BertGenerationDecoder"),Kr=o(" forward method, overrides the "),Ut=s("code"),Qr=o("__call__"),Xr=o(" special method."),Yr=l(),g(se.$$.fragment),Zr=l(),Ht=s("p"),es=o("Example:"),ts=l(),g(Re.$$.fragment),this.h()},l(t){const h=ua('[data-svelte="svelte-1phssyn"]',document.head);m=a(h,"META",{name:!0,content:!0}),h.forEach(n),q=c(t),u=a(t,"H1",{class:!0});var We=i(u);y=a(We,"A",{id:!0,class:!0,href:!0});var Vt=i(y);C=a(Vt,"SPAN",{});var ns=i(C);_(w.$$.fragment,ns),ns.forEach(n),Vt.forEach(n),E=c(We),S=a(We,"SPAN",{});var os=i(S);Dn=r(os,"BertGeneration"),os.forEach(n),We.forEach(n),Kt=c(t),R=a(t,"H2",{class:!0});var _n=i(R);Y=a(_n,"A",{id:!0,class:!0,href:!0});var rs=i(Y);kt=a(rs,"SPAN",{});var ss=i(kt);_(de.$$.fragment,ss),ss.forEach(n),rs.forEach(n),Sn=c(_n),Tt=a(_n,"SPAN",{});var as=i(Tt);An=r(as,"Overview"),as.forEach(n),_n.forEach(n),Qt=c(t),A=a(t,"P",{});var mt=i(A);Mn=r(mt,`The BertGeneration model is a BERT model that can be leveraged for sequence-to-sequence tasks using
...
Therefore, no EOS token should be added to the end of the input.`),Ts.forEach(n),kn.forEach(n),an=c(t),N=a(t,"P",{});var ut=i(N);ao=r(ut,"This model was contributed by "),ue=a(ut,"A",{href:!0,rel:!0});var ys=i(ue);io=r(ys,"patrickvonplaten"),ys.forEach(n),lo=r(ut,`. The original code can be
found `),fe=a(ut,"A",{href:!0,rel:!0});var ws=i(fe);co=r(ws,"here"),ws.forEach(n),ho=r(ut,"."),ut.forEach(n),dn=c(t),W=a(t,"H2",{class:!0});var Tn=i(W);ee=a(Tn,"A",{id:!0,class:!0,href:!0});var Es=i(ee);Bt=a(Es,"SPAN",{});var Bs=i(Bt);_(ge.$$.fragment,Bs),Bs.forEach(n),Es.forEach(n),po=c(Tn),zt=a(Tn,"SPAN",{});var zs=i(zt);mo=r(zs,"BertGenerationConfig"),zs.forEach(n),Tn.forEach(n),ln=c(t),$=a(t,"DIV",{class:!0});var L=i($);_(_e.$$.fragment,L),uo=c(L),be=a(L,"P",{});var yn=i(be);fo=r(yn,"This is the configuration class to store the configuration of a "),$t=a(yn,"CODE",{});var $s=i($t);go=r($s,"BertGenerationPreTrainedModel"),$s.forEach(n),_o=r(yn,` It is used to
