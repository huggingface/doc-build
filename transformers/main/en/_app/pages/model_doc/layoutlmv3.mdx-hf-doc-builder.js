...
documentation from `),Fo=s("a"),Fr=n("PretrainedConfig"),Pr=n(" for more information."),Cr=c(),y(Ee.$$.fragment),Ia=c(),pe=s("h2"),Fe=s("a"),gn=s("span"),y(bt.$$.fragment),Ar=c(),_n=s("span"),jr=n("LayoutLMv3FeatureExtractor"),Na=c(),D=s("div"),y(Lt.$$.fragment),Ir=c(),vn=s("p"),Nr=n(`Constructs a LayoutLMv3 feature extractor. This can be used to resize + normalize document images, as well as to
apply OCR on them in order to get a list of words and normalized bounding boxes.`),Sr=c(),kt=s("p"),Dr=n("This feature extractor inherits from "),yn=s("code"),Or=n("PreTrainedFeatureExtractor()"),Rr=n(` which contains most
of the main methods. Users should refer to this superclass for more information regarding those methods.`),Wr=c(),ne=s("div"),y(xt.$$.fragment),Br=c(),bn=s("p"),Ur=n("Main method to prepare for the model one or several image(s)."),Qr=c(),y(Pe.$$.fragment),Sa=c(),he=s("h2"),Ce=s("a"),Ln=s("span"),y(wt.$$.fragment),Vr=c(),kn=s("span"),Hr=n("LayoutLMv3Tokenizer"),Da=c(),A=s("div"),y(Tt.$$.fragment),Gr=c(),F=s("p"),Xr=n("Construct a LayoutLMv3 tokenizer. Based on "),xn=s("code"),Yr=n("RoBERTatokenizer"),Jr=n(` (Byte Pair Encoding or BPE).
...
single processor.`),Si=c(),So=s("p"),Do=s("a"),Di=n("LayoutLMv3Processor"),Oi=n(" offers all the functionalities you need to prepare data for the model."),Ri=c(),z=s("p"),Wi=n("It first uses "),Oo=s("a"),Bi=n("LayoutLMv3FeatureExtractor"),Ui=n(` to resize and normalize document images, and optionally applies OCR to
...
`),Sn=s("code"),Ji=n("attention_mask"),Ki=n(", "),Dn=s("code"),Zi=n("token_type_ids"),el=n(", "),On=s("code"),tl=n("bbox"),ol=n(". Optionally, one can provide integer "),Rn=s("code"),nl=n("word_labels"),al=n(`, which are turned
...
bounding boxes along with the additional arguments to `),St=s("a"),Hn=s("strong"),Ll=n("call"),kl=n("()"),xl=n(` and returns the output,
...
along with the additional arguments to `),Dt=s("a"),ea=s("strong"),Sl=n("call"),Dl=n("()"),Ol=n(` and returns the output, together with
resized and normalized `),ta=s("code"),Rl=n("pixel_values"),Wl=n("."),Bl=c(),oa=s("p"),Ul=n("Please refer to the docstring of the above two methods for more information."),Ua=c(),_e=s("h2"),Se=s("a"),na=s("span"),y(Ot.$$.fragment),Ql=c(),aa=s("span"),Vl=n("LayoutLMv3Model"),Qa=c(),K=s("div"),y(Rt.$$.fragment),Hl=c(),Wt=s("p"),Gl=n(`The bare LayoutLMv3 Model transformer outputting raw hidden-states without any specific head on top.
This model is a PyTorch `),Bt=s("a"),Xl=n("torch.nn.Module"),Yl=n(` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),Jl=c(),H=s("div"),y(Ut.$$.fragment),Kl=c(),ve=s("p"),Zl=n("The "),Qo=s("a"),ed=n("LayoutLMv3Model"),td=n(" forward method, overrides the "),sa=s("code"),od=n("__call__"),nd=n(" special method."),ad=c(),y(De.$$.fragment),sd=c(),y(Oe.$$.fragment),Va=c(),ye=s("h2"),Re=s("a"),ra=s("span"),y(Qt.$$.fragment),rd=c(),ia=s("span"),id=n("LayoutLMv3ForSequenceClassification"),Ha=c(),R=s("div"),y(Vt.$$.fragment),ld=c(),Ht=s("p"),dd=n(`LayoutLMv3 Model with a sequence classification head on top (a linear layer on top of the final hidden state of the
...
`),no=s("a"),jd=n("Kleister-NDA"),Id=n("."),Nd=c(),ao=s("p"),Sd=n("This model is a PyTorch "),so=s("a"),Dd=n("torch.nn.Module"),Od=n(` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
...
`),Sn=r(E,"CODE",{});var Pm=i(Sn);Ji=a(Pm,"attention_mask"),Pm.forEach(t),Ki=a(E,", "),Dn=r(E,"CODE",{});var Cm=i(Dn);Zi=a(Cm,"token_type_ids"),Cm.forEach(t),el=a(E,", "),On=r(E,"CODE",{});var Am=i(On);tl=a(Am,"bbox"),Am.forEach(t),ol=a(E,". Optionally, one can provide integer "),Rn=r(E,"CODE",{});var jm=i(Rn);nl=a(jm,"word_labels"),jm.forEach(t),al=a(E,`, which are turned
into token-level `),Wn=r(E,"CODE",{});var Im=i(Wn);sl=a(Im,"labels"),Im.forEach(t),rl=a(E," for token classification tasks (such as FUNSD, CORD)."),E.forEach(t),il=m(re),ae=r(re,"DIV",{class:!0});var en=i(ae);b(It.$$.fragment,en),ll=m(en),M=r(en,"P",{});var $=i(M);dl=a($,"This method first forwards the "),Bn=r($,"CODE",{});var Nm=i(Bn);cl=a(Nm,"images"),Nm.forEach(t),ml=a($," argument to "),Nt=r($,"A",{href:!0});var Lc=i(Nt);Un=r(Lc,"STRONG",{});var Sm=i(Un);ul=a(Sm,"call"),Sm.forEach(t),pl=a(Lc,"()"),Lc.forEach(t),hl=a($,`. In case
`),Bo=r($,"A",{href:!0});var Dm=i(Bo);fl=a(Dm,"LayoutLMv3FeatureExtractor"),Dm.forEach(t),gl=a($," was initialized with "),Qn=r($,"CODE",{});var Om=i(Qn);_l=a(Om,"apply_ocr"),Om.forEach(t),vl=a($," set to "),Vn=r($,"CODE",{});var Rm=i(Vn);yl=a(Rm,"True"),Rm.forEach(t),bl=a($,`, it passes the obtained words and
bounding boxes along with the additional arguments to `),St=r($,"A",{href:!0});var kc=i(St);Hn=r(kc,"STRONG",{});var Wm=i(Hn);Ll=a(Wm,"call"),Wm.forEach(t),kl=a(kc,"()"),kc.forEach(t),xl=a($,` and returns the output,
...
along with the additional arguments to `),Dt=r($,"A",{href:!0});var xc=i(Dt);ea=r(xc,"STRONG",{});var Ym=i(ea);Sl=a(Ym,"call"),Ym.forEach(t),Dl=a(xc,"()"),xc.forEach(t),Ol=a($,` and returns the output, together with
resized and normalized `),ta=r($,"CODE",{});var Jm=i(ta);Rl=a(Jm,"pixel_values"),Jm.forEach(t),Wl=a($,"."),$.forEach(t),Bl=m(en),oa=r(en,"P",{});var Km=i(oa);Ul=a(Km,"Please refer to the docstring of the above two methods for more information."),Km.forEach(t),en.forEach(t),re.forEach(t),Ua=m(o),_e=r(o,"H2",{class:!0});var hs=i(_e);Se=r(hs,"A",{id:!0,class:!0,href:!0});var Zm=i(Se);na=r(Zm,"SPAN",{});var eu=i(na);b(Ot.$$.fragment,eu),eu.forEach(t),Zm.forEach(t),Ql=m(hs),aa=r(hs,"SPAN",{});var tu=i(aa);Vl=a(tu,"LayoutLMv3Model"),tu.forEach(t),hs.forEach(t),Qa=m(o),K=r(o,"DIV",{class:!0});var tn=i(K);b(Rt.$$.fragment,tn),Hl=m(tn),Wt=r(tn,"P",{});var fs=i(Wt);Gl=a(fs,`The bare LayoutLMv3 Model transformer outputting raw hidden-states without any specific head on top.
This model is a PyTorch `),Bt=r(fs,"A",{href:!0,rel:!0});var ou=i(Bt);Xl=a(ou,"torch.nn.Module"),ou.forEach(t),Yl=a(fs,` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),fs.forEach(t),Jl=m(tn),H=r(tn,"DIV",{class:!0});var et=i(H);b(Ut.$$.fragment,et),Kl=m(et),ve=r(et,"P",{});var on=i(ve);Zl=a(on,"The "),Qo=r(on,"A",{href:!0});var nu=i(Qo);ed=a(nu,"LayoutLMv3Model"),nu.forEach(t),td=a(on," forward method, overrides the "),sa=r(on,"CODE",{});var au=i(sa);od=a(au,"__call__"),au.forEach(t),nd=a(on," special method."),on.forEach(t),ad=m(et),b(De.$$.fragment,et),sd=m(et),b(Oe.$$.fragment,et),et.forEach(t),tn.forEach(t),Va=m(o),ye=r(o,"H2",{class:!0});var gs=i(ye);Re=r(gs,"A",{id:!0,class:!0,href:!0});var su=i(Re);ra=r(su,"SPAN",{});var ru=i(ra);b(Qt.$$.fragment,ru),ru.forEach(t),su.forEach(t),rd=m(gs),ia=r(gs,"SPAN",{});var iu=i(ia);id=a(iu,"LayoutLMv3ForSequenceClassification"),iu.forEach(t),gs.forEach(t),Ha=m(o),R=r(o,"DIV",{class:!0});var tt=i(R);b(Vt.$$.fragment,tt),ld=m(tt),Ht=r(tt,"P",{});var _s=i(Ht);dd=a(_s,`LayoutLMv3 Model with a sequence classification head on top (a linear layer on top of the final hidden state of the
[CLS] token) e.g. for document image classification tasks such as the
...
`),no=r(ie,"A",{href:!0,rel:!0});var vu=i(no);jd=a(vu,"Kleister-NDA"),vu.forEach(t),Id=a(ie,"."),ie.forEach(t),Nd=m(nt),ao=r(nt,"P",{});var bs=i(ao);Sd=a(bs,"This model is a PyTorch "),so=r(bs,"A",{href:!0,rel:!0});var yu=i(so);Dd=a(yu,"torch.nn.Module"),yu.forEach(t),Od=a(bs,` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
