...
<span class="hljs-meta">&gt;&gt;&gt; </span>configuration = model.config`}}),{c(){u=s("p"),T=n("Example:"),_=c(),y(f.$$.fragment)},l(l){u=r(l,"P",{});var h=i(u);T=a(h,"Example:"),h.forEach(t),_=m(l),b(f.$$.fragment,l)},m(l,h){g(l,u,h),e(u,T),g(l,_,h),L(f,l,h),v=!0},p:sn,i(l){v||(k(f.$$.fragment,l),v=!0)},o(l){x(f.$$.fragment,l),v=!1},d(l){l&&t(u),l&&t(_),w(f,l)}}}function Eu(q){let u,T,_,f,v;return f=new rn({props:{code:`from transformers import LayoutLMv3FeatureExtractor
...
<span class="hljs-meta">&gt;&gt;&gt; </span>encoding = feature_extractor(image, return_tensors=<span class="hljs-string">&quot;pt&quot;</span>)
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-built_in">print</span>(encoding.keys())
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-comment"># dict_keys([&#x27;pixel_values&#x27;])</span>`}}),{c(){u=s("p"),T=n("Examples:"),_=c(),y(f.$$.fragment)},l(l){u=r(l,"P",{});var h=i(u);T=a(h,"Examples:"),h.forEach(t),_=m(l),b(f.$$.fragment,l)},m(l,h){g(l,u,h),e(u,T),g(l,_,h),L(f,l,h),v=!0},p:sn,i(l){v||(k(f.$$.fragment,l),v=!0)},o(l){x(f.$$.fragment,l),v=!1},d(l){l&&t(u),l&&t(_),w(f,l)}}}function Fu(q){let u,T,_,f,v;return{c(){u=s("p"),T=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),_=s("code"),f=n("Module"),v=n(`
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),{c(){u=s("p"),T=n("Examples:"),_=c(),y(f.$$.fragment)},l(l){u=r(l,"P",{});var h=i(u);T=a(h,"Examples:"),h.forEach(t),_=m(l),b(f.$$.fragment,l)},m(l,h){g(l,u,h),e(u,T),g(l,_,h),L(f,l,h),v=!0},p:sn,i(l){v||(k(f.$$.fragment,l),v=!0)},o(l){x(f.$$.fragment,l),v=!1},d(l){l&&t(u),l&&t(_),w(f,l)}}}function Cu(q){let u,T,_,f,v;return{c(){u=s("p"),T=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),_=s("code"),f=n("Module"),v=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(l){u=r(l,"P",{});var h=i(u);T=a(h,"Although the recipe for forward pass needs to be defined within this function, one should call the "),_=r(h,"CODE",{});var C=i(_);f=a(C,"Module"),C.forEach(t),v=a(h,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
<span class="hljs-meta">&gt;&gt;&gt; </span>logits = outputs.logits`}}),{c(){u=s("p"),T=n("Examples:"),_=c(),y(f.$$.fragment)},l(l){u=r(l,"P",{});var h=i(u);T=a(h,"Examples:"),h.forEach(t),_=m(l),b(f.$$.fragment,l)},m(l,h){g(l,u,h),e(u,T),g(l,_,h),L(f,l,h),v=!0},p:sn,i(l){v||(k(f.$$.fragment,l),v=!0)},o(l){x(f.$$.fragment,l),v=!1},d(l){l&&t(u),l&&t(_),w(f,l)}}}function ju(q){let u,T,_,f,v;return{c(){u=s("p"),T=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),_=s("code"),f=n("Module"),v=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(l){u=r(l,"P",{});var h=i(u);T=a(h,"Although the recipe for forward pass needs to be defined within this function, one should call the "),_=r(h,"CODE",{});var C=i(_);f=a(C,"Module"),C.forEach(t),v=a(h,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
<span class="hljs-meta">&gt;&gt;&gt; </span>outputs = model(**encoding)
<span class="hljs-meta">&gt;&gt;&gt; </span>loss = outputs.loss
<span class="hljs-meta">&gt;&gt;&gt; </span>logits = outputs.logits`}}),{c(){u=s("p"),T=n("Examples:"),_=c(),y(f.$$.fragment)},l(l){u=r(l,"P",{});var h=i(u);T=a(h,"Examples:"),h.forEach(t),_=m(l),b(f.$$.fragment,l)},m(l,h){g(l,u,h),e(u,T),g(l,_,h),L(f,l,h),v=!0},p:sn,i(l){v||(k(f.$$.fragment,l),v=!0)},o(l){x(f.$$.fragment,l),v=!1},d(l){l&&t(u),l&&t(_),w(f,l)}}}function Nu(q){let u,T,_,f,v;return{c(){u=s("p"),T=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),_=s("code"),f=n("Module"),v=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(l){u=r(l,"P",{});var h=i(u);T=a(h,"Although the recipe for forward pass needs to be defined within this function, one should call the "),_=r(h,"CODE",{});var C=i(_);f=a(C,"Module"),C.forEach(t),v=a(h,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
<span class="hljs-meta">&gt;&gt;&gt; </span>end_scores = outputs.end_logits`}}),{c(){u=s("p"),T=n("Examples:"),_=c(),y(f.$$.fragment)},l(l){u=r(l,"P",{});var h=i(u);T=a(h,"Examples:"),h.forEach(t),_=m(l),b(f.$$.fragment,l)},m(l,h){g(l,u,h),e(u,T),g(l,_,h),L(f,l,h),v=!0},p:sn,i(l){v||(k(f.$$.fragment,l),v=!0)},o(l){x(f.$$.fragment,l),v=!1},d(l){l&&t(u),l&&t(_),w(f,l)}}}function Du(q){let u,T,_,f,v,l,h,C,Ls,xa,le,Te,ln,it,ks,dn,xs,wa,Q,ws,lt,Ts,Ms,po,$s,zs,ho,qs,Es,Ta,fo,Fs,Ma,go,cn,Ps,$a,_o,Cs,za,te,Me,As,vo,js,Is,dt,mn,Ns,Ss,N,Ds,yo,Os,Rs,bo,Bs,Ws,Lo,Us,Qs,ko,Vs,Hs,Gs,de,Xs,xo,Ys,Js,wo,Ks,Zs,er,ct,tr,mt,or,nr,qa,$e,_c,Ea,ze,ar,To,sr,rr,Fa,oe,ir,ut,lr,dr,pt,cr,mr,Pa,ce,qe,un,ht,ur,pn,pr,Ca,S,ft,hr,me,fr,Mo,gr,_r,gt,vr,yr,br,ue,Lr,$o,kr,xr,zo,wr,Tr,Mr,Ee,Aa,pe,Fe,hn,_t,$r,fn,zr,ja,D,vt,qr,gn,Er,Fr,yt,Pr,_n,Cr,Ar,jr,ne,bt,Ir,vn,Nr,Sr,Pe,Ia,he,Ce,yn,Lt,Dr,bn,Or,Na,A,kt,Rr,F,Br,Ln,Wr,Ur,qo,Qr,Vr,kn,Hr,Gr,xn,Xr,Yr,wn,Jr,Kr,Tn,Zr,ei,Mn,ti,oi,ni,xt,ai,Eo,si,ri,ii,Fo,Po,li,di,ci,Ae,wt,mi,$n,ui,pi,Co,Tt,Sa,fe,je,zn,Mt,hi,qn,fi,Da,O,$t,gi,zt,_i,En,vi,yi,bi,qt,Li,Ao,ki,xi,wi,Ie,Et,Ti,Fn,Mi,Oa,ge,Ne,Pn,Ft,$i,Cn,zi,Ra,I,Pt,qi,An,Ei,Fi,jo,Io,Pi,Ci,Ai,z,ji,No,Ii,Ni,So,Si,Di,Do,Oi,Ri,jn,Bi,Wi,In,Ui,Qi,Nn,Vi,Hi,Sn,Gi,Xi,Dn,Yi,Ji,On,Ki,Zi,el,ae,Ct,tl,M,ol,Rn,nl,al,At,Bn,sl,rl,il,Oo,ll,dl,Wn,cl,ml,Un,ul,pl,jt,Qn,hl,fl,gl,Vn,_l,vl,Ro,yl,bl,Hn,Ll,kl,Gn,xl,wl,Xn,Tl,Ml,Yn,$l,zl,Jn,ql,El,It,Kn,Fl,Pl,Cl,Zn,Al,jl,Il,ea,Nl,Ba,_e,Se,ta,Nt,Sl,oa,Dl,Wa,J,St,Ol,Dt,Rl,Ot,Bl,Wl,Ul,V,Rt,Ql,ve,Vl,Bo,Hl,Gl,na,Xl,Yl,Jl,De,Kl,Oe,Ua,ye,Re,aa,Bt,Zl,sa,ed,Qa,R,Wt,td,Ut,od,Qt,nd,ad,sd,Vt,rd,Ht,id,ld,dd,H,Gt,cd,be,md,Wo,ud,pd,ra,hd,fd,gd,Be,_d,We,Va,Le,Ue,ia,Xt,vd,la,yd,Ha,B,Yt,bd,W,Ld,Jt,kd,xd,Kt,wd,Td,Zt,Md,$d,eo,zd,qd,Ed,to,Fd,oo,Pd,Cd,Ad,G,no,jd,ke,Id,Uo,Nd,Sd,da,Dd,Od,Rd,Qe,Bd,Ve,Ga,xe,He,ca,ao,Wd,ma,Ud,Xa,U,so,Qd,K,Vd,ro,Hd,Gd,ua,Xd,Yd,pa,Jd,Kd,Zd,io,ec,lo,tc,oc,nc,X,co,ac,we,sc,Qo,rc,ic,ha,lc,dc,cc,Ge,mc,Xe,Ya;return l=new ee({}),it=new ee({}),ht=new ee({}),ft=new P({props:{name:"class transformers.LayoutLMv3Config",anchor:"transformers.LayoutLMv3Config",parameters:[{name:"vocab_size",val:" = 50265"},{name:"hidden_size",val:" = 768"},{name:"num_hidden_layers",val:" = 12"},{name:"num_attention_heads",val:" = 12"},{name:"intermediate_size",val:" = 3072"},{name:"hidden_act",val:" = 'gelu'"},{name:"hidden_dropout_prob",val:" = 0.1"},{name:"attention_probs_dropout_prob",val:" = 0.1"},{name:"max_position_embeddings",val:" = 512"},{name:"type_vocab_size",val:" = 2"},{name:"initializer_range",val:" = 0.02"},{name:"layer_norm_eps",val:" = 1e-05"},{name:"pad_token_id",val:" = 1"},{name:"bos_token_id",val:" = 0"},{name:"eos_token_id",val:" = 2"},{name:"max_2d_position_embeddings",val:" = 1024"},{name:"coordinate_size",val:" = 128"},{name:"shape_size",val:" = 128"},{name:"has_relative_attention_bias",val:" = True"},{name:"rel_pos_bins",val:" = 32"},{name:"max_rel_pos",val:" = 128"},{name:"rel_2d_pos_bins",val:" = 64"},{name:"max_rel_2d_pos",val:" = 256"},{name:"has_spatial_attention_bias",val:" = True"},{name:"text_embed",val:" = True"},{name:"visual_embed",val:" = True"},{name:"input_size",val:" = 224"},{name:"num_channels",val:" = 3"},{name:"patch_size",val:" = 16"},{name:"classifier_dropout",val:" = None"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.LayoutLMv3Config.vocab_size",description:`<strong>vocab_size</strong> (<code>int</code>, <em>optional</em>, defaults to 50265) &#x2014;
...
word-level bounding boxes into token-level bounding boxes.`),ci=c(),Ae=s("div"),y(wt.$$.fragment),mi=c(),$n=s("p"),ui=n(`Main method to tokenize and prepare for the model one or several sequence(s) or one or several pair(s) of
...
`),Oo=s("a"),ll=n("LayoutLMv3FeatureExtractor"),dl=n(" was initialized with "),Wn=s("code"),cl=n("apply_ocr"),ml=n(" set to "),Un=s("code"),ul=n("True"),pl=n(`, it passes the obtained words and
...
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),Ad=c(),G=s("div"),y(no.$$.fragment),jd=c(),ke=s("p"),Id=n("The "),Uo=s("a"),Nd=n("LayoutLMv3ForTokenClassification"),Sd=n(" forward method, overrides the "),da=s("code"),Dd=n("__call__"),Od=n(" special method."),Rd=c(),y(Qe.$$.fragment),Bd=c(),y(Ve.$$.fragment),Ga=c(),xe=s("h2"),He=s("a"),ca=s("span"),y(ao.$$.fragment),Wd=c(),ma=s("span"),Ud=n("LayoutLMv3ForQuestionAnswering"),Xa=c(),U=s("div"),y(so.$$.fragment),Qd=c(),K=s("p"),Vd=n(`LayoutLMv3 Model with a span classification head on top for extractive question-answering tasks such as
...
token-level `),kn=r(j,"CODE",{});var em=i(kn);Hr=a(em,"input_ids"),em.forEach(t),Gr=a(j,", "),xn=r(j,"CODE",{});var tm=i(xn);Xr=a(tm,"attention_mask"),tm.forEach(t),Yr=a(j,", "),wn=r(j,"CODE",{});var om=i(wn);Jr=a(om,"token_type_ids"),om.forEach(t),Kr=a(j,", "),Tn=r(j,"CODE",{});var nm=i(Tn);Zr=a(nm,"bbox"),nm.forEach(t),ei=a(j,", and optional "),Mn=r(j,"CODE",{});var am=i(Mn);ti=a(am,"labels"),am.forEach(t),oi=a(j,` (for token
classification).`),j.forEach(t),ni=m(Y),xt=r(Y,"P",{});var as=i(xt);ai=a(as,"This tokenizer inherits from "),Eo=r(as,"A",{href:!0});var sm=i(Eo);si=a(sm,"PreTrainedTokenizer"),sm.forEach(t),ri=a(as,` which contains most of the main methods. Users should refer to
...
word-level bounding boxes into token-level bounding boxes.`),uc.forEach(t),ci=m(Y),Ae=r(Y,"DIV",{class:!0});var ss=i(Ae);b(wt.$$.fragment,ss),mi=m(ss),$n=r(ss,"P",{});var im=i($n);ui=a(im,`Main method to tokenize and prepare for the model one or several sequence(s) or one or several pair(s) of
sequences with word-level normalized bounding boxes and optional labels.`),im.forEach(t),ss.forEach(t),pi=m(Y),Co=r(Y,"DIV",{class:!0});var lm=i(Co);b(Tt.$$.fragment,lm),lm.forEach(t),Y.forEach(t),Sa=m(o),fe=r(o,"H2",{class:!0});var rs=i(fe);je=r(rs,"A",{id:!0,class:!0,href:!0});var dm=i(je);zn=r(dm,"SPAN",{});var cm=i(zn);b(Mt.$$.fragment,cm),cm.forEach(t),dm.forEach(t),hi=m(rs),qn=r(rs,"SPAN",{});var mm=i(qn);fi=a(mm,"LayoutLMv3TokenizerFast"),mm.forEach(t),rs.forEach(t),Da=m(o),O=r(o,"DIV",{class:!0});var Ke=i(O);b($t.$$.fragment,Ke),gi=m(Ke),zt=r(Ke,"P",{});var is=i(zt);_i=a(is,"Construct a \u201Cfast\u201D LayoutLMv3 tokenizer (backed by HuggingFace\u2019s "),En=r(is,"EM",{});var um=i(En);vi=a(um,"tokenizers"),um.forEach(t),yi=a(is," library). Based on BPE."),is.forEach(t),bi=m(Ke),qt=r(Ke,"P",{});var ls=i(qt);Li=a(ls,"This tokenizer inherits from "),Ao=r(ls,"A",{href:!0});var pm=i(Ao);ki=a(pm,"PreTrainedTokenizerFast"),pm.forEach(t),xi=a(ls,` which contains most of the main methods. Users should
refer to this superclass for more information regarding those methods.`),ls.forEach(t),wi=m(Ke),Ie=r(Ke,"DIV",{class:!0});var ds=i(Ie);b(Et.$$.fragment,ds),Ti=m(ds),Fn=r(ds,"P",{});var hm=i(Fn);Mi=a(hm,`Main method to tokenize and prepare for the model one or several sequence(s) or one or several pair(s) of
...
`),Do=r(E,"A",{href:!0});var km=i(Do);Oi=a(km,"LayoutLMv3TokenizerFast"),km.forEach(t),Ri=a(E,", which turns the words and bounding boxes into token-level "),jn=r(E,"CODE",{});var xm=i(jn);Bi=a(xm,"input_ids"),xm.forEach(t),Wi=a(E,`,
`),In=r(E,"CODE",{});var wm=i(In);Ui=a(wm,"attention_mask"),wm.forEach(t),Qi=a(E,", "),Nn=r(E,"CODE",{});var Tm=i(Nn);Vi=a(Tm,"token_type_ids"),Tm.forEach(t),Hi=a(E,", "),Sn=r(E,"CODE",{});var Mm=i(Sn);Gi=a(Mm,"bbox"),Mm.forEach(t),Xi=a(E,". Optionally, one can provide integer "),Dn=r(E,"CODE",{});var $m=i(Dn);Yi=a($m,"word_labels"),$m.forEach(t),Ji=a(E,`, which are turned
into token-level `),On=r(E,"CODE",{});var zm=i(On);Ki=a(zm,"labels"),zm.forEach(t),Zi=a(E," for token classification tasks (such as FUNSD, CORD)."),E.forEach(t),el=m(re),ae=r(re,"DIV",{class:!0});var Ko=i(ae);b(Ct.$$.fragment,Ko),tl=m(Ko),M=r(Ko,"P",{});var $=i(M);ol=a($,"This method first forwards the "),Rn=r($,"CODE",{});var qm=i(Rn);nl=a(qm,"images"),qm.forEach(t),al=a($," argument to "),At=r($,"A",{href:!0});var hc=i(At);Bn=r(hc,"STRONG",{});var Em=i(Bn);sl=a(Em,"call"),Em.forEach(t),rl=a(hc,"()"),hc.forEach(t),il=a($,`. In case
`),Oo=r($,"A",{href:!0});var Fm=i(Oo);ll=a(Fm,"LayoutLMv3FeatureExtractor"),Fm.forEach(t),dl=a($," was initialized with "),Wn=r($,"CODE",{});var Pm=i(Wn);cl=a(Pm,"apply_ocr"),Pm.forEach(t),ml=a($," set to "),Un=r($,"CODE",{});var Cm=i(Un);ul=a(Cm,"True"),Cm.forEach(t),pl=a($,`, it passes the obtained words and
...
with `),Hn=r($,"CODE",{});var Nm=i(Hn);Ll=a(Nm,"apply_ocr"),Nm.forEach(t),kl=a($," set to "),Gn=r($,"CODE",{});var Sm=i(Gn);xl=a(Sm,"False"),Sm.forEach(t),wl=a($,", it passes the words ("),Xn=r($,"CODE",{});var Dm=i(Xn);Tl=a(Dm,"text"),Dm.forEach(t),Ml=a($,"/`"),Yn=r($,"CODE",{});var Om=i(Yn);$l=a(Om,"text_pair"),Om.forEach(t),zl=a($,") and "),Jn=r($,"CODE",{});var Rm=i(Jn);ql=a(Rm,"boxes"),Rm.forEach(t),El=a($,` specified by the user
along with the additional arguments to `),It=r($,"A",{href:!0});var gc=i(It);Kn=r(gc,"STRONG",{});var Bm=i(Kn);Fl=a(Bm,"call"),Bm.forEach(t),Pl=a(gc,"()"),gc.forEach(t),Cl=a($,` and returns the output, together with
resized and normalized `),Zn=r($,"CODE",{});var Wm=i(Zn);Al=a(Wm,"pixel_values"),Wm.forEach(t),jl=a($,"."),$.forEach(t),Il=m(Ko),ea=r(Ko,"P",{});var Um=i(ea);Nl=a(Um,"Please refer to the docstring of the above two methods for more information."),Um.forEach(t),Ko.forEach(t),re.forEach(t),Ba=m(o),_e=r(o,"H2",{class:!0});var ms=i(_e);Se=r(ms,"A",{id:!0,class:!0,href:!0});var Qm=i(Se);ta=r(Qm,"SPAN",{});var Vm=i(ta);b(Nt.$$.fragment,Vm),Vm.forEach(t),Qm.forEach(t),Sl=m(ms),oa=r(ms,"SPAN",{});var Hm=i(oa);Dl=a(Hm,"LayoutLMv3Model"),Hm.forEach(t),ms.forEach(t),Wa=m(o),J=r(o,"DIV",{class:!0});var Zo=i(J);b(St.$$.fragment,Zo),Ol=m(Zo),Dt=r(Zo,"P",{});var us=i(Dt);Rl=a(us,`The bare LayoutLMv3 Model transformer outputting raw hidden-states without any specific head on top.
This model is a PyTorch `),Ot=r(us,"A",{href:!0,rel:!0});var Gm=i(Ot);Bl=a(Gm,"torch.nn.Module"),Gm.forEach(t),Wl=a(us,` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),us.forEach(t),Ul=m(Zo),V=r(Zo,"DIV",{class:!0});var Ze=i(V);b(Rt.$$.fragment,Ze),Ql=m(Ze),ve=r(Ze,"P",{});var en=i(ve);Vl=a(en,"The "),Bo=r(en,"A",{href:!0});var Xm=i(Bo);Hl=a(Xm,"LayoutLMv3Model"),Xm.forEach(t),Gl=a(en," forward method, overrides the "),na=r(en,"CODE",{});var Ym=i(na);Xl=a(Ym,"__call__"),Ym.forEach(t),Yl=a(en," special method."),en.forEach(t),Jl=m(Ze),b(De.$$.fragment,Ze),Kl=m(Ze),b(Oe.$$.fragment,Ze),Ze.forEach(t),Zo.forEach(t),Ua=m(o),ye=r(o,"H2",{class:!0});var ps=i(ye);Re=r(ps,"A",{id:!0,class:!0,href:!0});var Jm=i(Re);aa=r(Jm,"SPAN",{});var Km=i(aa);b(Bt.$$.fragment,Km),Km.forEach(t),Jm.forEach(t),Zl=m(ps),sa=r(ps,"SPAN",{});var Zm=i(sa);ed=a(Zm,"LayoutLMv3ForSequenceClassification"),Zm.forEach(t),ps.forEach(t),Qa=m(o),R=r(o,"DIV",{class:!0});var et=i(R);b(Wt.$$.fragment,et),td=m(et),Ut=r(et,"P",{});var hs=i(Ut);od=a(hs,`LayoutLMv3 Model with a sequence classification head on top (a linear layer on top of the final hidden state of the
[CLS] token) e.g. for document image classification tasks such as the
...
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),fs.forEach(t),dd=m(et),H=r(et,"DIV",{class:!0});var tt=i(H);b(Gt.$$.fragment,tt),cd=m(tt),be=r(tt,"P",{});var tn=i(be);md=a(tn,"The "),Wo=r(tn,"A",{href:!0});var ou=i(Wo);ud=a(ou,"LayoutLMv3ForSequenceClassification"),ou.forEach(t),pd=a(tn," forward method, overrides the "),ra=r(tn,"CODE",{});var nu=i(ra);hd=a(nu,"__call__"),nu.forEach(t),fd=a(tn," special method."),tn.forEach(t),gd=m(tt),b(Be.$$.fragment,tt),_d=m(tt),b(We.$$.fragment,tt),tt.forEach(t),et.forEach(t),Va=m(o),Le=r(o,"H2",{class:!0});var gs=i(Le);Ue=r(gs,"A",{id:!0,class:!0,href:!0});var au=i(Ue);ia=r(au,"SPAN",{});var su=i(ia);b(Xt.$$.fragment,su),su.forEach(t),au.forEach(t),vd=m(gs),la=r(gs,"SPAN",{});var ru=i(la);yd=a(ru,"LayoutLMv3ForTokenClassification"),ru.forEach(t),gs.forEach(t),Ha=m(o),B=r(o,"DIV",{class:!0});var ot=i(B);b(Yt.$$.fragment,ot),bd=m(ot),W=r(ot,"P",{});var ie=i(W);Ld=a(ie,`LayoutLMv3 Model with a token classification head on top (a linear layer on top of the final hidden states) e.g.
for sequence labeling (information extraction) tasks such as `),Jt=r(ie,"A",{href:!0,rel:!0});var iu=i(Jt);kd=a(iu,"FUNSD"),iu.forEach(t),xd=a(ie,`,
`),Kt=r(ie,"A",{href:!0,rel:!0});var lu=i(Kt);wd=a(lu,"SROIE"),lu.forEach(t),Td=a(ie,", "),Zt=r(ie,"A",{href:!0,rel:!0});var du=i(Zt);Md=a(du,"CORD"),du.forEach(t),$d=a(ie,` and
