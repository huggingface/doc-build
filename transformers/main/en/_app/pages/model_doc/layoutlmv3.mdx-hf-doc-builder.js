import{S as P_,i as j_,s as O_,e as a,k as p,w as k,t as o,M as N_,c as r,d as t,m as u,a as i,x as w,h as n,b as d,N as I_,G as e,g as f,y as T,q as x,o as M,B as $,v as S_,L as Wt}from"../../chunks/vendor-hf-doc-builder.js";import{T as Et}from"../../chunks/Tip-hf-doc-builder.js";import{D as ne}from"../../chunks/Docstring-hf-doc-builder.js";import{C as Qt}from"../../chunks/CodeBlock-hf-doc-builder.js";import{I as it}from"../../chunks/IconCopyLink-hf-doc-builder.js";import{E as Bt}from"../../chunks/ExampleCodeBlock-hf-doc-builder.js";function D_(A){let c,b,g,m,y;return m=new Qt({props:{code:`from transformers import LayoutLMv3Model, LayoutLMv3Config
...
`),N=a("code"),Pe=o('model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),te=p(),j=a("p"),je=o(`Note that when creating models and layers with
`),O=a("a"),Oe=o("subclassing"),Ne=o(` then you don\u2019t need to worry
...
`),N=r(Se,"CODE",{});var st=i(N);Pe=n(st,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),st.forEach(t),Se.forEach(t),D.forEach(t),te=u(_),j=r(_,"P",{});var de=i(j);je=n(de,`Note that when creating models and layers with
`),O=r(de,"A",{href:!0,rel:!0});var De=i(O);Oe=n(De,"subclassing"),De.forEach(t),Ne=n(de,` then you don\u2019t need to worry
about any of this, as you can just pass inputs like you would to any other Python function!`),de.forEach(t),this.h()},h(){d(O,"href","https://keras.io/guides/making_new_layers_and_models_via_subclassing/"),d(O,"rel","nofollow")},m(_,q){f(_,c,q),e(c,b),e(c,g),e(g,m),e(c,y),f(_,l,q),f(_,h,q),e(h,E),e(E,we),e(h,_e),e(h,R),e(R,ae),f(_,se,q),f(_,L,q),e(L,Te),e(L,V),e(V,xe),e(L,ve),e(L,I),e(I,Me),e(L,ie),e(L,K),e(K,$e),e(L,pe),e(L,G),e(G,qe),e(L,ue),e(L,X),e(X,Fe),e(L,ye),f(_,ee,q),f(_,C,q),e(C,P),e(P,he),e(P,H),e(H,Ee),e(P,be),e(P,U),e(U,ze),e(C,Le),e(C,z),e(z,re),e(z,Y),e(Y,me),e(z,Ce),e(z,J),e(J,le),e(C,fe),e(C,W),e(W,Ae),e(W,N),e(N,Pe),f(_,te,q),f(_,j,q),e(j,je),e(j,O),e(O,Oe),e(j,Ne)},d(_){_&&t(c),_&&t(l),_&&t(h),_&&t(se),_&&t(L),_&&t(ee),_&&t(C),_&&t(te),_&&t(j)}}}function Y_(A){let c,b,g,m,y;return{c(){c=a("p"),b=o("Although the recipe for forward pass needs to be defined within this function, one should call the "),g=a("code"),m=o("Module"),y=o(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(l){c=r(l,"P",{});var h=i(c);b=n(h,"Although the recipe for forward pass needs to be defined within this function, one should call the "),g=r(h,"CODE",{});var E=i(g);m=n(E,"Module"),E.forEach(t),y=n(h,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
<li><code>&apos;pt&apos;</code>: Return PyTorch <code>torch.Tensor</code> objects.</li>
<li><code>&apos;np&apos;</code>: Return Numpy <code>np.ndarray</code> objects.</li>
</ul>`,name:"return_tensors"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/layoutlmv3/tokenization_layoutlmv3.py#L547"}}),jn=new ne({props:{name:"save_vocabulary",anchor:"transformers.LayoutLMv3Tokenizer.save_vocabulary",parameters:[{name:"save_directory",val:": str"},{name:"filename_prefix",val:": typing.Optional[str] = None"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/layoutlmv3/tokenization_layoutlmv3.py#L428"}}),On=new it({}),Nn=new ne({props:{name:"class transformers.LayoutLMv3TokenizerFast",anchor:"transformers.LayoutLMv3TokenizerFast",parameters:[{name:"vocab_file",val:" = None"},{name:"merges_file",val:" = None"},{name:"tokenizer_file",val:" = None"},{name:"errors",val:" = 'replace'"},{name:"bos_token",val:" = '<s>'"},{name:"eos_token",val:" = '</s>'"},{name:"sep_token",val:" = '</s>'"},{name:"cls_token",val:" = '<s>'"},{name:"unk_token",val:" = '<unk>'"},{name:"pad_token",val:" = '<pad>'"},{name:"mask_token",val:" = '<mask>'"},{name:"add_prefix_space",val:" = True"},{name:"trim_offsets",val:" = True"},{name:"cls_token_box",val:" = [0, 0, 0, 0]"},{name:"sep_token_box",val:" = [0, 0, 0, 0]"},{name:"pad_token_box",val:" = [0, 0, 0, 0]"},{name:"pad_token_label",val:" = -100"},{name:"only_label_first_subword",val:" = True"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.LayoutLMv3TokenizerFast.vocab_file",description:`<strong>vocab_file</strong> (<code>str</code>) &#x2014;
...
into token-level `),_r=a("code"),Oc=o("labels"),Nc=o(" for token classification tasks (such as FUNSD, CORD)."),Ic=p(),Nt=a("div"),k(Wn.$$.fragment),Sc=p(),S=a("p"),Dc=o("This method first forwards the "),vr=a("code"),Rc=o("images"),Bc=o(" argument to "),Qn=a("a"),yr=a("strong"),Wc=o("call"),Qc=o("()"),Uc=o(`. In case
...
behavior.`),qp=p(),_t=a("div"),k(Yn.$$.fragment),Fp=p(),Zt=a("p"),Ep=o("The "),_a=a("a"),zp=o("LayoutLMv3Model"),Cp=o(" forward method, overrides the "),Pr=a("code"),Ap=o("__call__"),Pp=o(" special method."),jp=p(),k($o.$$.fragment),Op=p(),k(qo.$$.fragment),Oi=p(),eo=a("h2"),Fo=a("a"),jr=a("span"),k(Jn.$$.fragment),Np=p(),Or=a("span"),Ip=o("LayoutLMv3ForSequenceClassification"),Ni=p(),pt=a("div"),k(Zn.$$.fragment),Sp=p(),es=a("p"),Dp=o(`LayoutLMv3 Model with a sequence classification head on top (a linear layer on top of the final hidden state of the
...
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),Hp=p(),vt=a("div"),k(ss.$$.fragment),Kp=p(),to=a("p"),Gp=o("The "),va=a("a"),Xp=o("LayoutLMv3ForSequenceClassification"),Yp=o(" forward method, overrides the "),Nr=a("code"),Jp=o("__call__"),Zp=o(" special method."),eu=p(),k(Eo.$$.fragment),tu=p(),k(zo.$$.fragment),Ii=p(),oo=a("h2"),Co=a("a"),Ir=a("span"),k(as.$$.fragment),ou=p(),Sr=a("span"),nu=o("LayoutLMv3ForTokenClassification"),Si=p(),ut=a("div"),k(rs.$$.fragment),su=p(),ht=a("p"),au=o(`LayoutLMv3 Model with a token classification head on top (a linear layer on top of the final hidden states) e.g.
...
compute `),Wr=a("code"),Au=o("span start logits"),Pu=o(" and "),Qr=a("code"),ju=o("span end logits"),Ou=o(")."),Nu=p(),_s=a("p"),Iu=o("This model is a PyTorch "),vs=a("a"),Su=o("torch.nn.Module"),Du=o(` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),Ru=p(),bt=a("div"),k(ys.$$.fragment),Bu=p(),ao=a("p"),Wu=o("The "),ba=a("a"),Qu=o("LayoutLMv3ForQuestionAnswering"),Uu=o(" forward method, overrides the "),Ur=a("code"),Vu=o("__call__"),Hu=o(" special method."),Ku=p(),k(Oo.$$.fragment),Gu=p(),k(No.$$.fragment),Bi=p(),ro=a("h2"),Io=a("a"),Vr=a("span"),k(bs.$$.fragment),Xu=p(),Hr=a("span"),Yu=o("TFLayoutLMv3Model"),Wi=p(),rt=a("div"),k(Ls.$$.fragment),Ju=p(),ks=a("p"),Zu=o(`The bare LayoutLMv3 Model transformer outputting raw hidden-states without any specific head on top.
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Eh=p(),k(Wo.$$.fragment),zh=p(),kt=a("div"),k(As.$$.fragment),Ch=p(),co=a("p"),Ah=o("The "),Ta=a("a"),Ph=o("TFLayoutLMv3ForSequenceClassification"),jh=o(" forward method, overrides the "),Yr=a("code"),Oh=o("__call__"),Nh=o(" special method."),Ih=p(),k(Qo.$$.fragment),Sh=p(),k(Uo.$$.fragment),Vi=p(),po=a("h2"),Vo=a("a"),Jr=a("span"),k(Ps.$$.fragment),Dh=p(),Zr=a("span"),Rh=o("TFLayoutLMv3ForTokenClassification"),Hi=p(),Ue=a("div"),k(js.$$.fragment),Bh=p(),ft=a("p"),Wh=o(`LayoutLMv3 Model with a token classification head on top (a linear layer on top of the final hidden states) e.g.
for sequence labeling (information extraction) tasks such as `),Os=a("a"),Qh=o("FUNSD"),Uh=o(`,
`),Ns=a("a"),Vh=o("SROIE"),Hh=o(", "),Is=a("a"),Kh=o("CORD"),Gh=o(` and
...
and word-patch alignment (WPA).`),Pt.forEach(t),ye=u(s),ee=r(s,"P",{});var fi=i(ee);C=n(fi,"The abstract from the paper is the following:"),fi.forEach(t),P=u(s),he=r(s,"P",{});var gi=i(he);H=r(gi,"EM",{});var _i=i(H);Ee=n(_i,"Self-supervised pre-training techniques have achieved remarkable progress in Document AI. Most multimodal pre-trained models use a masked language modeling objective to learn bidirectional representations on the text modality, but they differ in pre-training objectives for the image modality. This discrepancy adds difficulty to multimodal representation learning. In this paper, we propose LayoutLMv3 to pre-train multimodal Transformers for Document AI with unified text and image masking. Additionally, LayoutLMv3 is pre-trained with a word-patch alignment objective to learn cross-modal alignment by predicting whether the corresponding image patch of a text word is masked. The simple unified architecture and training objectives make LayoutLMv3 a general-purpose pre-trained model for both text-centric and image-centric Document AI tasks. Experimental results show that LayoutLMv3 achieves state-of-the-art performance not only in text-centric tasks, including form understanding, receipt understanding, and document visual question answering, but also in image-centric tasks such as document image classification and document layout analysis."),_i.forEach(t),gi.forEach(t),be=u(s),U=r(s,"P",{});var vi=i(U);ze=n(vi,"Tips:"),vi.forEach(t),Le=u(s),z=r(s,"UL",{});var jt=i(z);re=r(jt,"LI",{});var en=i(re);Y=n(en,"In terms of data processing, LayoutLMv3 is identical to its predecessor "),me=r(en,"A",{href:!0});var yi=i(me);Ce=n(yi,"LayoutLMv2"),yi.forEach(t),J=n(en,", except that:"),le=r(en,"UL",{});var Zs=i(le);fe=r(Zs,"LI",{});var bi=i(fe);W=n(bi,"images need to be resized and normalized with channels in regular RGB format. LayoutLMv2 on the other hand normalizes the images internally and expects the channels in BGR format."),bi.forEach(t),Ae=u(Zs),N=r(Zs,"LI",{});var gt=i(N);Pe=n(gt,`text is tokenized using byte-pair encoding (BPE), as opposed to WordPiece.
Due to these differences in data preprocessing, one can use `),te=r(gt,"A",{href:!0});var Xm=i(te);j=n(Xm,"LayoutLMv3Processor"),Xm.forEach(t),je=n(gt," which internally combines a "),O=r(gt,"A",{href:!0});var Ym=i(O);Oe=n(Ym,"LayoutLMv3FeatureExtractor"),Ym.forEach(t),Ne=n(gt," (for the image modality) and a "),_=r(gt,"A",{href:!0});var Jm=i(_);q=n(Jm,"LayoutLMv3Tokenizer"),Jm.forEach(t),Ge=n(gt,"/"),oe=r(gt,"A",{href:!0});var Zm=i(oe);Xe=n(Zm,"LayoutLMv3TokenizerFast"),Zm.forEach(t),Ye=n(gt," (for the text modality) to prepare all data for the model."),gt.forEach(t),Zs.forEach(t),en.forEach(t),F=u(jt),ge=r(jt,"LI",{});var Fa=i(ge);Je=n(Fa,"Regarding usage of "),Be=r(Fa,"A",{href:!0});var ef=i(Be);Ze=n(ef,"LayoutLMv3Processor"),ef.forEach(t),et=n(Fa,", we refer to the "),D=r(Fa,"A",{href:!0});var tf=i(D);Z=n(tf,"usage guide"),tf.forEach(t),tt=n(Fa," of its predecessor."),Fa.forEach(t),ot=u(jt),Q=r(jt,"LI",{});var Yi=i(Q);nt=n(Yi,"Demo notebooks for LayoutLMv3 can be found "),Ie=r(Yi,"A",{href:!0,rel:!0});var of=i(Ie);Se=n(of,"here"),of.forEach(t),st=n(Yi,"."),Yi.forEach(t),de=u(jt),De=r(jt,"LI",{});var Ji=i(De);Al=n(Ji,"Demo scripts can be found "),vn=r(Ji,"A",{href:!0,rel:!0});var nf=i(vn);Pl=n(nf,"here"),nf.forEach(t),jl=n(Ji,"."),Ji.forEach(t),jt.forEach(t),Li=u(s),fo=r(s,"IMG",{src:!0,alt:!0,width:!0}),ki=u(s),go=r(s,"SMALL",{});var Zi=i(go);Ol=n(Zi,"LayoutLMv3 architecture. Taken from the "),ea=r(Zi,"A",{href:!0});var sf=i(ea);Nl=n(sf,"original paper"),sf.forEach(t),Il=n(Zi,"."),Zi.forEach(t),wi=u(s),He=r(s,"P",{});var xt=i(He);Sl=n(xt,"This model was contributed by "),yn=r(xt,"A",{href:!0,rel:!0});var af=i(yn);Dl=n(af,"nielsr"),af.forEach(t),Rl=n(xt,". The TensorFlow version of this model was added by "),bn=r(xt,"A",{href:!0,rel:!0});var rf=i(bn);Bl=n(rf,"chriskoo"),rf.forEach(t),Wl=n(xt,", "),Ln=r(xt,"A",{href:!0,rel:!0});var lf=i(Ln);Ql=n(lf,"tokec"),lf.forEach(t),Ul=n(xt,", and "),kn=r(xt,"A",{href:!0,rel:!0});var df=i(kn);Vl=n(df,"lre"),df.forEach(t),Hl=n(xt,". The original code can be found "),wn=r(xt,"A",{href:!0,rel:!0});var cf=i(wn);Kl=n(cf,"here"),cf.forEach(t),Gl=n(xt,"."),xt.forEach(t),Ti=u(s),Ut=r(s,"H2",{class:!0});var el=i(Ut);_o=r(el,"A",{id:!0,class:!0,href:!0});var pf=i(_o);Wa=r(pf,"SPAN",{});var uf=i(Wa);w(Tn.$$.fragment,uf),uf.forEach(t),pf.forEach(t),Xl=u(el),Qa=r(el,"SPAN",{});var hf=i(Qa);Yl=n(hf,"LayoutLMv3Config"),hf.forEach(t),el.forEach(t),xi=u(s),lt=r(s,"DIV",{class:!0});var tn=i(lt);w(xn.$$.fragment,tn),Jl=u(tn),Vt=r(tn,"P",{});var Ea=i(Vt);Zl=n(Ea,"This is the configuration class to store the configuration of a "),ta=r(Ea,"A",{href:!0});var mf=i(ta);ed=n(mf,"LayoutLMv3Model"),mf.forEach(t),td=n(Ea,`. It is used to instantiate an
LayoutLMv3 model according to the specified arguments, defining the model architecture. Instantiating a
configuration with the defaults will yield a similar configuration to that of the LayoutLMv3
...
word-level bounding boxes into token-level bounding boxes.`),Qm.forEach(t),Kd=u(Mt),ko=r(Mt,"DIV",{class:!0});var al=i(ko);w(Pn.$$.fragment,al),Gd=u(al),sr=r(al,"P",{});var Of=i(sr);Xd=n(Of,`Main method to tokenize and prepare for the model one or several sequence(s) or one or several pair(s) of
sequences with word-level normalized bounding boxes and optional labels.`),Of.forEach(t),al.forEach(t),Yd=u(Mt),la=r(Mt,"DIV",{class:!0});var Nf=i(la);w(jn.$$.fragment,Nf),Nf.forEach(t),Mt.forEach(t),Ei=u(s),Xt=r(s,"H2",{class:!0});var rl=i(Xt);wo=r(rl,"A",{id:!0,class:!0,href:!0});var If=i(wo);ar=r(If,"SPAN",{});var Sf=i(ar);w(On.$$.fragment,Sf),Sf.forEach(t),If.forEach(t),Jd=u(rl),rr=r(rl,"SPAN",{});var Df=i(rr);Zd=n(Df,"LayoutLMv3TokenizerFast"),Df.forEach(t),rl.forEach(t),zi=u(s),ct=r(s,"DIV",{class:!0});var nn=i(ct);w(Nn.$$.fragment,nn),ec=u(nn),In=r(nn,"P",{});var il=i(In);tc=n(il,"Construct a \u201Cfast\u201D LayoutLMv3 tokenizer (backed by HuggingFace\u2019s "),ir=r(il,"EM",{});var Rf=i(ir);oc=n(Rf,"tokenizers"),Rf.forEach(t),nc=n(il," library). Based on BPE."),il.forEach(t),sc=u(nn),Sn=r(nn,"P",{});var ll=i(Sn);ac=n(ll,"This tokenizer inherits from "),da=r(ll,"A",{href:!0});var Bf=i(da);rc=n(Bf,"PreTrainedTokenizerFast"),Bf.forEach(t),ic=n(ll,` which contains most of the main methods. Users should
...
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),ul.forEach(t),qp=u(Pa),_t=r(Pa,"DIV",{class:!0});var sn=i(_t);w(Yn.$$.fragment,sn),Fp=u(sn),Zt=r(sn,"P",{});var ja=i(Zt);Ep=n(ja,"The "),_a=r(ja,"A",{href:!0});var Tg=i(_a);zp=n(Tg,"LayoutLMv3Model"),Tg.forEach(t),Cp=n(ja," forward method, overrides the "),Pr=r(ja,"CODE",{});var xg=i(Pr);Ap=n(xg,"__call__"),xg.forEach(t),Pp=n(ja," special method."),ja.forEach(t),jp=u(sn),w($o.$$.fragment,sn),Op=u(sn),w(qo.$$.fragment,sn),sn.forEach(t),Pa.forEach(t),Oi=u(s),eo=r(s,"H2",{class:!0});var hl=i(eo);Fo=r(hl,"A",{id:!0,class:!0,href:!0});var Mg=i(Fo);jr=r(Mg,"SPAN",{});var $g=i(jr);w(Jn.$$.fragment,$g),$g.forEach(t),Mg.forEach(t),Np=u(hl),Or=r(hl,"SPAN",{});var qg=i(Or);Ip=n(qg,"LayoutLMv3ForSequenceClassification"),qg.forEach(t),hl.forEach(t),Ni=u(s),pt=r(s,"DIV",{class:!0});var an=i(pt);w(Zn.$$.fragment,an),Sp=u(an),es=r(an,"P",{});var ml=i(es);Dp=n(ml,`LayoutLMv3 Model with a sequence classification head on top (a linear layer on top of the final hidden state of the
[CLS] token) e.g. for document image classification tasks such as the
...
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),fl.forEach(t),Hp=u(an),vt=r(an,"DIV",{class:!0});var rn=i(vt);w(ss.$$.fragment,rn),Kp=u(rn),to=r(rn,"P",{});var Oa=i(to);Gp=n(Oa,"The "),va=r(Oa,"A",{href:!0});var zg=i(va);Xp=n(zg,"LayoutLMv3ForSequenceClassification"),zg.forEach(t),Yp=n(Oa," forward method, overrides the "),Nr=r(Oa,"CODE",{});var Cg=i(Nr);Jp=n(Cg,"__call__"),Cg.forEach(t),Zp=n(Oa," special method."),Oa.forEach(t),eu=u(rn),w(Eo.$$.fragment,rn),tu=u(rn),w(zo.$$.fragment,rn),rn.forEach(t),an.forEach(t),Ii=u(s),oo=r(s,"H2",{class:!0});var gl=i(oo);Co=r(gl,"A",{id:!0,class:!0,href:!0});var Ag=i(Co);Ir=r(Ag,"SPAN",{});var Pg=i(Ir);w(as.$$.fragment,Pg),Pg.forEach(t),Ag.forEach(t),ou=u(gl),Sr=r(gl,"SPAN",{});var jg=i(Sr);nu=n(jg,"LayoutLMv3ForTokenClassification"),jg.forEach(t),gl.forEach(t),Si=u(s),ut=r(s,"DIV",{class:!0});var ln=i(ut);w(rs.$$.fragment,ln),su=u(ln),ht=r(ln,"P",{});var St=i(ht);au=n(St,`LayoutLMv3 Model with a token classification head on top (a linear layer on top of the final hidden states) e.g.
for sequence labeling (information extraction) tasks such as `),is=r(St,"A",{href:!0,rel:!0});var Og=i(is);ru=n(Og,"FUNSD"),Og.forEach(t),iu=n(St,`,
`),ls=r(St,"A",{href:!0,rel:!0});var Ng=i(ls);lu=n(Ng,"SROIE"),Ng.forEach(t),du=n(St,", "),ds=r(St,"A",{href:!0,rel:!0});var Ig=i(ds);cu=n(Ig,"CORD"),Ig.forEach(t),pu=n(St,` and
