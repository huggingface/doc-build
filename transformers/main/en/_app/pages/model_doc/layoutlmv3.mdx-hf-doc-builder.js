...
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),Ad=c(),G=s("div"),y(no.$$.fragment),jd=c(),ke=s("p"),Id=n("The "),Uo=s("a"),Nd=n("LayoutLMv3ForTokenClassification"),Sd=n(" forward method, overrides the "),da=s("code"),Dd=n("__call__"),Od=n(" special method."),Rd=c(),y(Qe.$$.fragment),Wd=c(),y(Ve.$$.fragment),Ga=c(),xe=s("h2"),He=s("a"),ca=s("span"),y(ao.$$.fragment),Bd=c(),ma=s("span"),Ud=n("LayoutLMv3ForQuestionAnswering"),Xa=c(),U=s("div"),y(so.$$.fragment),Qd=c(),K=s("p"),Vd=n(`LayoutLMv3 Model with a span classification head on top for extractive question-answering tasks such as
...
`),Do=r(E,"A",{href:!0});var km=i(Do);Oi=a(km,"LayoutLMv3TokenizerFast"),km.forEach(t),Ri=a(E,", which turns the words and bounding boxes into token-level "),jn=r(E,"CODE",{});var xm=i(jn);Wi=a(xm,"input_ids"),xm.forEach(t),Bi=a(E,`,
