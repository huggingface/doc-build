...
<span class="hljs-meta">&gt;&gt;&gt; </span>configuration = model.config`}}),{c(){c=a("p"),b=o("Example:"),g=p(),k(h.$$.fragment)},l(l){c=r(l,"P",{});var m=i(c);b=n(m,"Example:"),m.forEach(t),g=u(l),w(h.$$.fragment,l)},m(l,m){f(l,c,m),e(c,b),f(l,g,m),T(h,l,m),y=!0},p:Bt,i(l){y||(x(h.$$.fragment,l),y=!0)},o(l){M(h.$$.fragment,l),y=!1},d(l){l&&t(c),l&&t(g),$(h,l)}}}function W_(A){let c,b,g,h,y;return h=new Qt({props:{code:`from transformers import LayoutLMv3FeatureExtractor
...
<span class="hljs-meta">&gt;&gt;&gt; </span>encoding = feature_extractor(image, return_tensors=<span class="hljs-string">&quot;pt&quot;</span>)
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-built_in">print</span>(encoding.keys())
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-comment"># dict_keys([&#x27;pixel_values&#x27;])</span>`}}),{c(){c=a("p"),b=o("Examples:"),g=p(),k(h.$$.fragment)},l(l){c=r(l,"P",{});var m=i(c);b=n(m,"Examples:"),m.forEach(t),g=u(l),w(h.$$.fragment,l)},m(l,m){f(l,c,m),e(c,b),f(l,g,m),T(h,l,m),y=!0},p:Bt,i(l){y||(x(h.$$.fragment,l),y=!0)},o(l){M(h.$$.fragment,l),y=!1},d(l){l&&t(c),l&&t(g),$(h,l)}}}function R_(A){let c,b,g,h,y;return{c(){c=a("p"),b=o("Although the recipe for forward pass needs to be defined within this function, one should call the "),g=a("code"),h=o("Module"),y=o(`
...
<span class="hljs-meta">&gt;&gt;&gt; </span>end_scores = outputs.end_logits`}}),{c(){c=a("p"),b=o("Examples:"),g=p(),k(h.$$.fragment)},l(l){c=r(l,"P",{});var m=i(c);b=n(m,"Examples:"),m.forEach(t),g=u(l),w(h.$$.fragment,l)},m(l,m){f(l,c,m),e(c,b),f(l,g,m),T(h,l,m),y=!0},p:Bt,i(l){y||(x(h.$$.fragment,l),y=!0)},o(l){M(h.$$.fragment,l),y=!1},d(l){l&&t(c),l&&t(g),$(h,l)}}}function X_(A){let c,b,g,h,y,l,m,E,we,_e,W,ae,se,L,Te,V,xe,ve,S,Me,ie,K,$e,pe,G,qe,ue,X,Fe,ye,ee,C,P,me,H,Ee,be,U,ze,Le,z,re,Y,he,Ce,J,le,fe,B,Ae,I,Pe,te,j,je,N,Ne,Ie;return{c(){c=a("p"),b=o("TensorFlow models and layers in "),g=a("code"),h=o("transformers"),y=o(" accept two formats as input:"),l=p(),m=a("ul"),E=a("li"),we=o("having all inputs as keyword arguments (like PyTorch models), or"),_e=p(),W=a("li"),ae=o("having all inputs as a list, tuple or dict in the first positional argument."),se=p(),L=a("p"),Te=o(`The reason the second format is supported is that Keras methods prefer this format when passing inputs to models
...
about any of this, as you can just pass inputs like you would to any other Python function!`),de.forEach(t),this.h()},h(){d(N,"href","https://keras.io/guides/making_new_layers_and_models_via_subclassing/"),d(N,"rel","nofollow")},m(_,q){f(_,c,q),e(c,b),e(c,g),e(g,h),e(c,y),f(_,l,q),f(_,m,q),e(m,E),e(E,we),e(m,_e),e(m,W),e(W,ae),f(_,se,q),f(_,L,q),e(L,Te),e(L,V),e(V,xe),e(L,ve),e(L,S),e(S,Me),e(L,ie),e(L,K),e(K,$e),e(L,pe),e(L,G),e(G,qe),e(L,ue),e(L,X),e(X,Fe),e(L,ye),f(_,ee,q),f(_,C,q),e(C,P),e(P,me),e(P,H),e(H,Ee),e(P,be),e(P,U),e(U,ze),e(C,Le),e(C,z),e(z,re),e(z,Y),e(Y,he),e(z,Ce),e(z,J),e(J,le),e(C,fe),e(C,B),e(B,Ae),e(B,I),e(I,Pe),f(_,te,q),f(_,j,q),e(j,je),e(j,N),e(N,Ne),e(j,Ie)},d(_){_&&t(c),_&&t(l),_&&t(m),_&&t(se),_&&t(L),_&&t(ee),_&&t(C),_&&t(te),_&&t(j)}}}function Y_(A){let c,b,g,h,y;return{c(){c=a("p"),b=o("Although the recipe for forward pass needs to be defined within this function, one should call the "),g=a("code"),h=o("Module"),y=o(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(l){c=r(l,"P",{});var m=i(c);b=n(m,"Although the recipe for forward pass needs to be defined within this function, one should call the "),g=r(m,"CODE",{});var E=i(g);h=n(E,"Module"),E.forEach(t),y=n(m,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
<span class="hljs-meta">&gt;&gt;&gt; </span>outputs = model(**encoding)
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),{c(){c=a("p"),b=o("Examples:"),g=p(),k(h.$$.fragment)},l(l){c=r(l,"P",{});var m=i(c);b=n(m,"Examples:"),m.forEach(t),g=u(l),w(h.$$.fragment,l)},m(l,m){f(l,c,m),e(c,b),f(l,g,m),T(h,l,m),y=!0},p:Bt,i(l){y||(x(h.$$.fragment,l),y=!0)},o(l){M(h.$$.fragment,l),y=!1},d(l){l&&t(c),l&&t(g),$(h,l)}}}function Z_(A){let c,b,g,h,y,l,m,E,we,_e,W,ae,se,L,Te,V,xe,ve,S,Me,ie,K,$e,pe,G,qe,ue,X,Fe,ye,ee,C,P,me,H,Ee,be,U,ze,Le,z,re,Y,he,Ce,J,le,fe,B,Ae,I,Pe,te,j,je,N,Ne,Ie;return{c(){c=a("p"),b=o("TensorFlow models and layers in "),g=a("code"),h=o("transformers"),y=o(" accept two formats as input:"),l=p(),m=a("ul"),E=a("li"),we=o("having all inputs as keyword arguments (like PyTorch models), or"),_e=p(),W=a("li"),ae=o("having all inputs as a list, tuple or dict in the first positional argument."),se=p(),L=a("p"),Te=o(`The reason the second format is supported is that Keras methods prefer this format when passing inputs to models
and layers. Because of this support, when using methods like `),V=a("code"),xe=o("model.fit()"),ve=o(` things should \u201Cjust work\u201D for you - just
pass your inputs and labels in any format that `),S=a("code"),Me=o("model.fit()"),ie=o(` supports! If, however, you want to use the second
format outside of Keras methods like `),K=a("code"),$e=o("fit()"),pe=o(" and "),G=a("code"),qe=o("predict()"),ue=o(`, such as when creating your own layers or models with
the Keras `),X=a("code"),Fe=o("Functional"),ye=o(` API, there are three possibilities you can use to gather all the input Tensors in the first
...
<span class="hljs-meta">&gt;&gt;&gt; </span>outputs = model(**encoding, labels=sequence_label)
<span class="hljs-meta">&gt;&gt;&gt; </span>loss = outputs.loss
<span class="hljs-meta">&gt;&gt;&gt; </span>logits = outputs.logits`}}),{c(){c=a("p"),b=o("Examples:"),g=p(),k(h.$$.fragment)},l(l){c=r(l,"P",{});var m=i(c);b=n(m,"Examples:"),m.forEach(t),g=u(l),w(h.$$.fragment,l)},m(l,m){f(l,c,m),e(c,b),f(l,g,m),T(h,l,m),y=!0},p:Bt,i(l){y||(x(h.$$.fragment,l),y=!0)},o(l){M(h.$$.fragment,l),y=!1},d(l){l&&t(c),l&&t(g),$(h,l)}}}function ov(A){let c,b,g,h,y,l,m,E,we,_e,W,ae,se,L,Te,V,xe,ve,S,Me,ie,K,$e,pe,G,qe,ue,X,Fe,ye,ee,C,P,me,H,Ee,be,U,ze,Le,z,re,Y,he,Ce,J,le,fe,B,Ae,I,Pe,te,j,je,N,Ne,Ie;return{c(){c=a("p"),b=o("TensorFlow models and layers in "),g=a("code"),h=o("transformers"),y=o(" accept two formats as input:"),l=p(),m=a("ul"),E=a("li"),we=o("having all inputs as keyword arguments (like PyTorch models), or"),_e=p(),W=a("li"),ae=o("having all inputs as a list, tuple or dict in the first positional argument."),se=p(),L=a("p"),Te=o(`The reason the second format is supported is that Keras methods prefer this format when passing inputs to models
and layers. Because of this support, when using methods like `),V=a("code"),xe=o("model.fit()"),ve=o(` things should \u201Cjust work\u201D for you - just
pass your inputs and labels in any format that `),S=a("code"),Me=o("model.fit()"),ie=o(` supports! If, however, you want to use the second
format outside of Keras methods like `),K=a("code"),$e=o("fit()"),pe=o(" and "),G=a("code"),qe=o("predict()"),ue=o(`, such as when creating your own layers or models with
the Keras `),X=a("code"),Fe=o("Functional"),ye=o(` API, there are three possibilities you can use to gather all the input Tensors in the first
...
<span class="hljs-meta">&gt;&gt;&gt; </span>outputs = model(**encoding)
<span class="hljs-meta">&gt;&gt;&gt; </span>loss = outputs.loss
<span class="hljs-meta">&gt;&gt;&gt; </span>logits = outputs.logits`}}),{c(){c=a("p"),b=o("Examples:"),g=p(),k(h.$$.fragment)},l(l){c=r(l,"P",{});var m=i(c);b=n(m,"Examples:"),m.forEach(t),g=u(l),w(h.$$.fragment,l)},m(l,m){f(l,c,m),e(c,b),f(l,g,m),T(h,l,m),y=!0},p:Bt,i(l){y||(x(h.$$.fragment,l),y=!0)},o(l){M(h.$$.fragment,l),y=!1},d(l){l&&t(c),l&&t(g),$(h,l)}}}function av(A){let c,b,g,h,y,l,m,E,we,_e,W,ae,se,L,Te,V,xe,ve,S,Me,ie,K,$e,pe,G,qe,ue,X,Fe,ye,ee,C,P,me,H,Ee,be,U,ze,Le,z,re,Y,he,Ce,J,le,fe,B,Ae,I,Pe,te,j,je,N,Ne,Ie;return{c(){c=a("p"),b=o("TensorFlow models and layers in "),g=a("code"),h=o("transformers"),y=o(" accept two formats as input:"),l=p(),m=a("ul"),E=a("li"),we=o("having all inputs as keyword arguments (like PyTorch models), or"),_e=p(),W=a("li"),ae=o("having all inputs as a list, tuple or dict in the first positional argument."),se=p(),L=a("p"),Te=o(`The reason the second format is supported is that Keras methods prefer this format when passing inputs to models
and layers. Because of this support, when using methods like `),V=a("code"),xe=o("model.fit()"),ve=o(` things should \u201Cjust work\u201D for you - just
pass your inputs and labels in any format that `),S=a("code"),Me=o("model.fit()"),ie=o(` supports! If, however, you want to use the second
format outside of Keras methods like `),K=a("code"),$e=o("fit()"),pe=o(" and "),G=a("code"),qe=o("predict()"),ue=o(`, such as when creating your own layers or models with
the Keras `),X=a("code"),Fe=o("Functional"),ye=o(` API, there are three possibilities you can use to gather all the input Tensors in the first
...
<span class="hljs-meta">&gt;&gt;&gt; </span>loss = outputs.loss
<span class="hljs-meta">&gt;&gt;&gt; </span>start_scores = outputs.start_logits
<span class="hljs-meta">&gt;&gt;&gt; </span>end_scores = outputs.end_logits`}}),{c(){c=a("p"),b=o("Examples:"),g=p(),k(h.$$.fragment)},l(l){c=r(l,"P",{});var m=i(c);b=n(m,"Examples:"),m.forEach(t),g=u(l),w(h.$$.fragment,l)},m(l,m){f(l,c,m),e(c,b),f(l,g,m),T(h,l,m),y=!0},p:Bt,i(l){y||(x(h.$$.fragment,l),y=!0)},o(l){M(h.$$.fragment,l),y=!1},d(l){l&&t(c),l&&t(g),$(h,l)}}}function lv(A){let c,b,g,h,y,l,m,E,we,_e,W,ae,se,L,Te,V,xe,ve,S,Me,ie,K,$e,pe,G,qe,ue,X,Fe,ye,ee,C,P,me,H,Ee,be,U,ze,Le,z,re,Y,he,Ce,J,le,fe,B,Ae,I,Pe,te,j,je,N,Ne,Ie,_,q,Ge,oe,Xe,Ye,F,ge,Je,Re,Ze,et,D,Z,tt,ot,Q,nt,Se,Oe,st,de,De,Al,vn,Pl,jl,Li,fo,Gh,ki,go,Nl,ea,Il,Sl,wi,He,Ol,yn,Dl,Wl,bn,Rl,Bl,Ln,Ql,Ul,kn,Vl,Hl,wn,Kl,Gl,Ti,Ut,_o,Ba,Tn,Xl,Qa,Yl,xi,lt,xn,Jl,Vt,Zl,ta,ed,td,Mn,od,nd,sd,Ht,ad,oa,rd,id,na,ld,dd,cd,vo,Mi,Kt,yo,Ua,$n,pd,Va,ud,$i,dt,qn,md,Ha,hd,fd,Fn,gd,Ka,_d,vd,yd,Nt,En,bd,Ga,Ld,kd,bo,qi,Gt,Lo,Xa,zn,wd,Ya,Td,Fi,Be,Cn,xd,We,Md,Ja,$d,qd,sa,Fd,Ed,Za,zd,Cd,er,Ad,Pd,tr,jd,Nd,or,Id,Sd,nr,Od,Dd,Wd,An,Rd,aa,Bd,Qd,Ud,ra,ia,Vd,Hd,Kd,ko,Pn,Gd,sr,Xd,Yd,la,jn,Ei,Xt,wo,ar,Nn,Jd,rr,Zd,zi,ct,In,ec,Sn,tc,ir,oc,nc,sc,On,ac,da,rc,ic,lc,To,Dn,dc,lr,cc,Ci,Yt,xo,dr,Wn,pc,cr,uc,Ai,at,Rn,mc,pr,hc,fc,ca,pa,gc,_c,vc,ce,yc,ua,bc,Lc,ma,kc,wc,ha,Tc,xc,ur,Mc,$c,mr,qc,Fc,hr,Ec,zc,fr,Cc,Ac,gr,Pc,jc,_r,Nc,Ic,Sc,It,Bn,Oc,O,Dc,vr,Wc,Rc,Qn,yr,Bc,Qc,Uc,fa,Vc,Hc,br,Kc,Gc,Lr,Xc,Yc,Un,kr,Jc,Zc,ep,wr,tp,op,ga,np,sp,Tr,ap,rp,xr,ip,lp,Mr,dp,cp,$r,pp,up,qr,mp,hp,Vn,Fr,fp,gp,_p,Er,vp,yp,bp,zr,Lp,Pi,Jt,Mo,Cr,Hn,kp,Ar,wp,ji,zt,Kn,Tp,Gn,xp,Xn,Mp,$p,qp,_t,Yn,Fp,Zt,Ep,_a,zp,Cp,Pr,Ap,Pp,jp,$o,Np,qo,Ni,eo,Fo,jr,Jn,Ip,Nr,Sp,Ii,pt,Zn,Op,es,Dp,ts,Wp,Rp,Bp,os,Qp,ns,Up,Vp,Hp,vt,ss,Kp,to,Gp,va,Xp,Yp,Ir,Jp,Zp,eu,Eo,tu,zo,Si,oo,Co,Sr,as,ou,Or,nu,Oi,ut,rs,su,mt,au,is,ru,iu,ls,lu,du,ds,cu,pu,cs,uu,mu,hu,ps,fu,us,gu,_u,vu,yt,ms,yu,no,bu,ya,Lu,ku,Dr,wu,Tu,xu,Ao,Mu,Po,Di,so,jo,Wr,hs,$u,Rr,qu,Wi,ht,fs,Fu,Ct,Eu,gs,zu,Cu,Br,Au,Pu,Qr,ju,Nu,Iu,_s,Su,vs,Ou,Du,Wu,bt,ys,Ru,ao,Bu,ba,Qu,Uu,Ur,Vu,Hu,Ku,No,Gu,Io,Ri,ro,So,Vr,bs,Xu,Hr,Yu,Bi,rt,Ls,Ju,ks,Zu,La,em,tm,om,ws,nm,Ts,sm,am,rm,Oo,im,Lt,xs,lm,io,dm,ka,cm,pm,Kr,um,mm,hm,Do,fm,Wo,Qi,lo,Ro,Gr,Ms,gm,Xr,_m,Ui,Qe,$s,vm,qs,ym,Fs,bm,Lm,km,Es,wm,wa,Tm,xm,Mm,zs,$m,Cs,qm,Fm,Em,Bo,zm,kt,As,Cm,co,Am,Ta,Pm,jm,Yr,Nm,Im,Sm,Qo,Om,Uo,Vi,po,Vo,Jr,Ps,Dm,Zr,Wm,Hi,Ue,js,Rm,ft,Bm,Ns,Qm,Um,Is,Vm,Hm,Ss,Km,Gm,Os,Xm,Ym,Jm,Ds,Zm,xa,eh,th,oh,Ws,nh,Rs,sh,ah,rh,Ho,ih,wt,Bs,lh,uo,dh,Ma,ch,ph,ei,uh,mh,hh,Ko,fh,Go,Ki,mo,Xo,ti,Qs,gh,oi,_h,Gi,Ve,Us,vh,At,yh,Vs,bh,Lh,ni,kh,wh,si,Th,xh,Mh,Hs,$h,$a,qh,Fh,Eh,Ks,zh,Gs,Ch,Ah,Ph,Yo,jh,Tt,Xs,Nh,ho,Ih,qa,Sh,Oh,ai,Dh,Wh,Rh,Jo,Bh,Zo,Xi;return l=new it({}),L=new it({}),Tn=new it({}),xn=new ne({props:{name:"class transformers.LayoutLMv3Config",anchor:"transformers.LayoutLMv3Config",parameters:[{name:"vocab_size",val:" = 50265"},{name:"hidden_size",val:" = 768"},{name:"num_hidden_layers",val:" = 12"},{name:"num_attention_heads",val:" = 12"},{name:"intermediate_size",val:" = 3072"},{name:"hidden_act",val:" = 'gelu'"},{name:"hidden_dropout_prob",val:" = 0.1"},{name:"attention_probs_dropout_prob",val:" = 0.1"},{name:"max_position_embeddings",val:" = 512"},{name:"type_vocab_size",val:" = 2"},{name:"initializer_range",val:" = 0.02"},{name:"layer_norm_eps",val:" = 1e-05"},{name:"pad_token_id",val:" = 1"},{name:"bos_token_id",val:" = 0"},{name:"eos_token_id",val:" = 2"},{name:"max_2d_position_embeddings",val:" = 1024"},{name:"coordinate_size",val:" = 128"},{name:"shape_size",val:" = 128"},{name:"has_relative_attention_bias",val:" = True"},{name:"rel_pos_bins",val:" = 32"},{name:"max_rel_pos",val:" = 128"},{name:"rel_2d_pos_bins",val:" = 64"},{name:"max_rel_2d_pos",val:" = 256"},{name:"has_spatial_attention_bias",val:" = True"},{name:"text_embed",val:" = True"},{name:"visual_embed",val:" = True"},{name:"input_size",val:" = 224"},{name:"num_channels",val:" = 3"},{name:"patch_size",val:" = 16"},{name:"classifier_dropout",val:" = None"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.LayoutLMv3Config.vocab_size",description:`<strong>vocab_size</strong> (<code>int</code>, <em>optional</em>, defaults to 50265) &#x2014;
...
`}}),Jo=new Et({props:{$$slots:{default:[rv]},$$scope:{ctx:A}}}),Zo=new Rt({props:{anchor:"transformers.TFLayoutLMv3ForQuestionAnswering.call.example",$$slots:{default:[iv]},$$scope:{ctx:A}}}),{c(){c=a("meta"),b=p(),g=a("h1"),h=a("a"),y=a("span"),k(l.$$.fragment),m=p(),E=a("span"),we=o("LayoutLMv3"),_e=p(),W=a("h2"),ae=a("a"),se=a("span"),k(L.$$.fragment),Te=p(),V=a("span"),xe=o("Overview"),ve=p(),S=a("p"),Me=o("The LayoutLMv3 model was proposed in "),ie=a("a"),K=o("LayoutLMv3: Pre-training for Document AI with Unified Text and Image Masking"),$e=o(` by Yupan Huang, Tengchao Lv, Lei Cui, Yutong Lu, Furu Wei.
...
sequences with word-level normalized bounding boxes and optional labels.`),Ci=p(),Yt=a("h2"),xo=a("a"),dr=a("span"),k(Wn.$$.fragment),pc=p(),cr=a("span"),uc=o("LayoutLMv3Processor"),Ai=p(),at=a("div"),k(Rn.$$.fragment),mc=p(),pr=a("p"),hc=o(`Constructs a LayoutLMv3 processor which combines a LayoutLMv3 feature extractor and a LayoutLMv3 tokenizer into a
...
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),vu=p(),yt=a("div"),k(ms.$$.fragment),yu=p(),no=a("p"),bu=o("The "),ya=a("a"),Lu=o("LayoutLMv3ForTokenClassification"),ku=o(" forward method, overrides the "),Dr=a("code"),wu=o("__call__"),Tu=o(" special method."),xu=p(),k(Ao.$$.fragment),Mu=p(),k(Po.$$.fragment),Di=p(),so=a("h2"),jo=a("a"),Wr=a("span"),k(hs.$$.fragment),$u=p(),Rr=a("span"),qu=o("LayoutLMv3ForQuestionAnswering"),Wi=p(),ht=a("div"),k(fs.$$.fragment),Fu=p(),Ct=a("p"),Eu=o(`LayoutLMv3 Model with a span classification head on top for extractive question-answering tasks such as
...
behavior.`),rm=p(),k(Oo.$$.fragment),im=p(),Lt=a("div"),k(xs.$$.fragment),lm=p(),io=a("p"),dm=o("The "),ka=a("a"),cm=o("TFLayoutLMv3Model"),pm=o(" forward method, overrides the "),Kr=a("code"),um=o("__call__"),mm=o(" special method."),hm=p(),k(Do.$$.fragment),fm=p(),k(Wo.$$.fragment),Qi=p(),lo=a("h2"),Ro=a("a"),Gr=a("span"),k(Ms.$$.fragment),gm=p(),Xr=a("span"),_m=o("TFLayoutLMv3ForSequenceClassification"),Ui=p(),Qe=a("div"),k($s.$$.fragment),vm=p(),qs=a("p"),ym=o(`LayoutLMv3 Model with a sequence classification head on top (a linear layer on top of the final hidden state of the
[CLS] token) e.g. for document image classification tasks such as the
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Em=p(),k(Bo.$$.fragment),zm=p(),kt=a("div"),k(As.$$.fragment),Cm=p(),co=a("p"),Am=o("The "),Ta=a("a"),Pm=o("TFLayoutLMv3ForSequenceClassification"),jm=o(" forward method, overrides the "),Yr=a("code"),Nm=o("__call__"),Im=o(" special method."),Sm=p(),k(Qo.$$.fragment),Om=p(),k(Uo.$$.fragment),Vi=p(),po=a("h2"),Vo=a("a"),Jr=a("span"),k(Ps.$$.fragment),Dm=p(),Zr=a("span"),Wm=o("TFLayoutLMv3ForTokenClassification"),Hi=p(),Ue=a("div"),k(js.$$.fragment),Rm=p(),ft=a("p"),Bm=o(`LayoutLMv3 Model with a token classification head on top (a linear layer on top of the final hidden states) e.g.
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),oh=p(),Ws=a("p"),nh=o("This model is also a "),Rs=a("a"),sh=o("tf.keras.Model"),ah=o(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
...
Due to these differences in data preprocessing, one can use `),te=r(gt,"A",{href:!0});var Xh=i(te);j=n(Xh,"LayoutLMv3Processor"),Xh.forEach(t),je=n(gt," which internally combines a "),N=r(gt,"A",{href:!0});var Yh=i(N);Ne=n(Yh,"LayoutLMv3FeatureExtractor"),Yh.forEach(t),Ie=n(gt," (for the image modality) and a "),_=r(gt,"A",{href:!0});var Jh=i(_);q=n(Jh,"LayoutLMv3Tokenizer"),Jh.forEach(t),Ge=n(gt,"/"),oe=r(gt,"A",{href:!0});var Zh=i(oe);Xe=n(Zh,"LayoutLMv3TokenizerFast"),Zh.forEach(t),Ye=n(gt," (for the text modality) to prepare all data for the model."),gt.forEach(t),Zs.forEach(t),en.forEach(t),F=u(jt),ge=r(jt,"LI",{});var Fa=i(ge);Je=n(Fa,"Regarding usage of "),Re=r(Fa,"A",{href:!0});var ef=i(Re);Ze=n(ef,"LayoutLMv3Processor"),ef.forEach(t),et=n(Fa,", we refer to the "),D=r(Fa,"A",{href:!0});var tf=i(D);Z=n(tf,"usage guide"),tf.forEach(t),tt=n(Fa," of its predecessor."),Fa.forEach(t),ot=u(jt),Q=r(jt,"LI",{});var Yi=i(Q);nt=n(Yi,"Demo notebooks for LayoutLMv3 can be found "),Se=r(Yi,"A",{href:!0,rel:!0});var of=i(Se);Oe=n(of,"here"),of.forEach(t),st=n(Yi,"."),Yi.forEach(t),de=u(jt),De=r(jt,"LI",{});var Ji=i(De);Al=n(Ji,"Demo scripts can be found "),vn=r(Ji,"A",{href:!0,rel:!0});var nf=i(vn);Pl=n(nf,"here"),nf.forEach(t),jl=n(Ji,"."),Ji.forEach(t),jt.forEach(t),Li=u(s),fo=r(s,"IMG",{src:!0,alt:!0,width:!0}),ki=u(s),go=r(s,"SMALL",{});var Zi=i(go);Nl=n(Zi,"LayoutLMv3 architecture. Taken from the "),ea=r(Zi,"A",{href:!0});var sf=i(ea);Il=n(sf,"original paper"),sf.forEach(t),Sl=n(Zi,"."),Zi.forEach(t),wi=u(s),He=r(s,"P",{});var xt=i(He);Ol=n(xt,"This model was contributed by "),yn=r(xt,"A",{href:!0,rel:!0});var af=i(yn);Dl=n(af,"nielsr"),af.forEach(t),Wl=n(xt,". The TensorFlow version of this model was added by "),bn=r(xt,"A",{href:!0,rel:!0});var rf=i(bn);Rl=n(rf,"chriskoo"),rf.forEach(t),Bl=n(xt,", "),Ln=r(xt,"A",{href:!0,rel:!0});var lf=i(Ln);Ql=n(lf,"tokec"),lf.forEach(t),Ul=n(xt,", and "),kn=r(xt,"A",{href:!0,rel:!0});var df=i(kn);Vl=n(df,"lre"),df.forEach(t),Hl=n(xt,". The original code can be found "),wn=r(xt,"A",{href:!0,rel:!0});var cf=i(wn);Kl=n(cf,"here"),cf.forEach(t),Gl=n(xt,"."),xt.forEach(t),Ti=u(s),Ut=r(s,"H2",{class:!0});var el=i(Ut);_o=r(el,"A",{id:!0,class:!0,href:!0});var pf=i(_o);Ba=r(pf,"SPAN",{});var uf=i(Ba);w(Tn.$$.fragment,uf),uf.forEach(t),pf.forEach(t),Xl=u(el),Qa=r(el,"SPAN",{});var mf=i(Qa);Yl=n(mf,"LayoutLMv3Config"),mf.forEach(t),el.forEach(t),xi=u(s),lt=r(s,"DIV",{class:!0});var tn=i(lt);w(xn.$$.fragment,tn),Jl=u(tn),Vt=r(tn,"P",{});var Ea=i(Vt);Zl=n(Ea,"This is the configuration class to store the configuration of a "),ta=r(Ea,"A",{href:!0});var hf=i(ta);ed=n(hf,"LayoutLMv3Model"),hf.forEach(t),td=n(Ea,`. It is used to instantiate an
LayoutLMv3 model according to the specified arguments, defining the model architecture. Instantiating a
configuration with the defaults will yield a similar configuration to that of the LayoutLMv3
...
sequences with word-level normalized bounding boxes and optional labels.`),Bf.forEach(t),dl.forEach(t),nn.forEach(t),Ci=u(s),Yt=r(s,"H2",{class:!0});var cl=i(Yt);xo=r(cl,"A",{id:!0,class:!0,href:!0});var Qf=i(xo);dr=r(Qf,"SPAN",{});var Uf=i(dr);w(Wn.$$.fragment,Uf),Uf.forEach(t),Qf.forEach(t),pc=u(cl),cr=r(cl,"SPAN",{});var Vf=i(cr);uc=n(Vf,"LayoutLMv3Processor"),Vf.forEach(t),cl.forEach(t),Ai=u(s),at=r(s,"DIV",{class:!0});var St=i(at);w(Rn.$$.fragment,St),mc=u(St),pr=r(St,"P",{});var Hf=i(pr);hc=n(Hf,`Constructs a LayoutLMv3 processor which combines a LayoutLMv3 feature extractor and a LayoutLMv3 tokenizer into a
...
bounding boxes along with the additional arguments to `),Un=r(R,"A",{href:!0});var Hh=i(Un);kr=r(Hh,"STRONG",{});var dg=i(kr);Jc=n(dg,"call"),dg.forEach(t),Zc=n(Hh,"()"),Hh.forEach(t),ep=n(R,` and returns the output,
...
with `),Tr=r(R,"CODE",{});var ug=i(Tr);ap=n(ug,"apply_ocr"),ug.forEach(t),rp=n(R," set to "),xr=r(R,"CODE",{});var mg=i(xr);ip=n(mg,"False"),mg.forEach(t),lp=n(R,", it passes the words ("),Mr=r(R,"CODE",{});var hg=i(Mr);dp=n(hg,"text"),hg.forEach(t),cp=n(R,"/`"),$r=r(R,"CODE",{});var fg=i($r);pp=n(fg,"text_pair"),fg.forEach(t),up=n(R,") and "),qr=r(R,"CODE",{});var gg=i(qr);mp=n(gg,"boxes"),gg.forEach(t),hp=n(R,` specified by the user
along with the additional arguments to `),Vn=r(R,"A",{href:!0});var Kh=i(Vn);Fr=r(Kh,"STRONG",{});var _g=i(Fr);fp=n(_g,"call"),_g.forEach(t),gp=n(Kh,"()"),Kh.forEach(t),_p=n(R,` and returns the output, together with
...
[CLS] token) e.g. for document image classification tasks such as the
`),ts=r(hl,"A",{href:!0,rel:!0});var Fg=i(ts);Wp=n(Fg,"RVL-CDIP"),Fg.forEach(t),Rp=n(hl," dataset."),hl.forEach(t),Bp=u(an),os=r(an,"P",{});var fl=i(os);Qp=n(fl,"This model is a PyTorch "),ns=r(fl,"A",{href:!0,rel:!0});var Eg=i(ns);Up=n(Eg,"torch.nn.Module"),Eg.forEach(t),Vp=n(fl,` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
...
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),_l.forEach(t),vu=u(ln),yt=r(ln,"DIV",{class:!0});var dn=i(yt);w(ms.$$.fragment,dn),yu=u(dn),no=r(dn,"P",{});var Ia=i(no);bu=n(Ia,"The "),ya=r(Ia,"A",{href:!0});var Wg=i(ya);Lu=n(Wg,"LayoutLMv3ForTokenClassification"),Wg.forEach(t),ku=n(Ia," forward method, overrides the "),Dr=r(Ia,"CODE",{});var Rg=i(Dr);wu=n(Rg,"__call__"),Rg.forEach(t),Tu=n(Ia," special method."),Ia.forEach(t),xu=u(dn),w(Ao.$$.fragment,dn),Mu=u(dn),w(Po.$$.fragment,dn),dn.forEach(t),ln.forEach(t),Di=u(s),so=r(s,"H2",{class:!0});var vl=i(so);jo=r(vl,"A",{id:!0,class:!0,href:!0});var Bg=i(jo);Wr=r(Bg,"SPAN",{});var Qg=i(Wr);w(hs.$$.fragment,Qg),Qg.forEach(t),Bg.forEach(t),$u=u(vl),Rr=r(vl,"SPAN",{});var Ug=i(Rr);qu=n(Ug,"LayoutLMv3ForQuestionAnswering"),Ug.forEach(t),vl.forEach(t),Wi=u(s),ht=r(s,"DIV",{class:!0});var cn=i(ht);w(fs.$$.fragment,cn),Fu=u(cn),Ct=r(cn,"P",{});var pn=i(Ct);Eu=n(pn,`LayoutLMv3 Model with a span classification head on top for extractive question-answering tasks such as
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),kl.forEach(t),rm=u(Dt),w(Oo.$$.fragment,Dt),im=u(Dt),Lt=r(Dt,"DIV",{class:!0});var mn=i(Lt);w(xs.$$.fragment,mn),lm=u(mn),io=r(mn,"P",{});var Oa=i(io);dm=n(Oa,"The "),ka=r(Oa,"A",{href:!0});var n_=i(ka);cm=n(n_,"TFLayoutLMv3Model"),n_.forEach(t),pm=n(Oa," forward method, overrides the "),Kr=r(Oa,"CODE",{});var s_=i(Kr);um=n(s_,"__call__"),s_.forEach(t),mm=n(Oa," special method."),Oa.forEach(t),hm=u(mn),w(Do.$$.fragment,mn),fm=u(mn),w(Wo.$$.fragment,mn),mn.forEach(t),Dt.forEach(t),Qi=u(s),lo=r(s,"H2",{class:!0});var wl=i(lo);Ro=r(wl,"A",{id:!0,class:!0,href:!0});var a_=i(Ro);Gr=r(a_,"SPAN",{});var r_=i(Gr);w(Ms.$$.fragment,r_),r_.forEach(t),a_.forEach(t),gm=u(wl),Xr=r(wl,"SPAN",{});var i_=i(Xr);_m=n(i_,"TFLayoutLMv3ForSequenceClassification"),i_.forEach(t),wl.forEach(t),Ui=u(s),Qe=r(s,"DIV",{class:!0});var $t=i(Qe);w($s.$$.fragment,$t),vm=u($t),qs=r($t,"P",{});var Tl=i(qs);ym=n(Tl,`LayoutLMv3 Model with a sequence classification head on top (a linear layer on top of the final hidden state of the
[CLS] token) e.g. for document image classification tasks such as the
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Ml.forEach(t),Em=u($t),w(Bo.$$.fragment,$t),zm=u($t),kt=r($t,"DIV",{class:!0});var hn=i(kt);w(As.$$.fragment,hn),Cm=u(hn),co=r(hn,"P",{});var Da=i(co);Am=n(Da,"The "),Ta=r(Da,"A",{href:!0});var p_=i(Ta);Pm=n(p_,"TFLayoutLMv3ForSequenceClassification"),p_.forEach(t),jm=n(Da," forward method, overrides the "),Yr=r(Da,"CODE",{});var u_=i(Yr);Nm=n(u_,"__call__"),u_.forEach(t),Im=n(Da," special method."),Da.forEach(t),Sm=u(hn),w(Qo.$$.fragment,hn),Om=u(hn),w(Uo.$$.fragment,hn),hn.forEach(t),$t.forEach(t),Vi=u(s),po=r(s,"H2",{class:!0});var $l=i(po);Vo=r($l,"A",{id:!0,class:!0,href:!0});var m_=i(Vo);Jr=r(m_,"SPAN",{});var h_=i(Jr);w(Ps.$$.fragment,h_),h_.forEach(t),m_.forEach(t),Dm=u($l),Zr=r($l,"SPAN",{});var f_=i(Zr);Wm=n(f_,"TFLayoutLMv3ForTokenClassification"),f_.forEach(t),$l.forEach(t),Hi=u(s),Ue=r(s,"DIV",{class:!0});var qt=i(Ue);w(js.$$.fragment,qt),Rm=u(qt),ft=r(qt,"P",{});var Wt=i(ft);Bm=n(Wt,`LayoutLMv3 Model with a token classification head on top (a linear layer on top of the final hidden states) e.g.
for sequence labeling (information extraction) tasks such as `),Ns=r(Wt,"A",{href:!0,rel:!0});var g_=i(Ns);Qm=n(g_,"FUNSD"),g_.forEach(t),Um=n(Wt,`,
`),Is=r(Wt,"A",{href:!0,rel:!0});var __=i(Is);Vm=n(__,"SROIE"),__.forEach(t),Hm=n(Wt,", "),Ss=r(Wt,"A",{href:!0,rel:!0});var v_=i(Ss);Km=n(v_,"CORD"),v_.forEach(t),Gm=n(Wt,` and
`),Os=r(Wt,"A",{href:!0,rel:!0});var y_=i(Os);Xm=n(y_,"Kleister-NDA"),y_.forEach(t),Ym=n(Wt,"."),Wt.forEach(t),Jm=u(qt),Ds=r(qt,"P",{});var ql=i(Ds);Zm=n(ql,"This model inherits from "),xa=r(ql,"A",{href:!0});var b_=i(xa);eh=n(b_,"TFPreTrainedModel"),b_.forEach(t),th=n(ql,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),ql.forEach(t),oh=u(qt),Ws=r(qt,"P",{});var Fl=i(Ws);nh=n(Fl,"This model is also a "),Rs=r(Fl,"A",{href:!0,rel:!0});var L_=i(Rs);sh=n(L_,"tf.keras.Model"),L_.forEach(t),ah=n(Fl,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Fl.forEach(t),rh=u(qt),w(Ho.$$.fragment,qt),ih=u(qt),wt=r(qt,"DIV",{class:!0});var fn=i(wt);w(Bs.$$.fragment,fn),lh=u(fn),uo=r(fn,"P",{});var Wa=i(uo);dh=n(Wa,"The "),Ma=r(Wa,"A",{href:!0});var k_=i(Ma);ch=n(k_,"TFLayoutLMv3ForTokenClassification"),k_.forEach(t),ph=n(Wa," forward method, overrides the "),ei=r(Wa,"CODE",{});var w_=i(ei);uh=n(w_,"__call__"),w_.forEach(t),mh=n(Wa," special method."),Wa.forEach(t),hh=u(fn),w(Ko.$$.fragment,fn),fh=u(fn),w(Go.$$.fragment,fn),fn.forEach(t),qt.forEach(t),Ki=u(s),mo=r(s,"H2",{class:!0});var El=i(mo);Xo=r(El,"A",{id:!0,class:!0,href:!0});var T_=i(Xo);ti=r(T_,"SPAN",{});var x_=i(ti);w(Qs.$$.fragment,x_),x_.forEach(t),T_.forEach(t),gh=u(El),oi=r(El,"SPAN",{});var M_=i(oi);_h=n(M_,"TFLayoutLMv3ForQuestionAnswering"),M_.forEach(t),El.forEach(t),Gi=u(s),Ve=r(s,"DIV",{class:!0});var Ft=i(Ve);w(Us.$$.fragment,Ft),vh=u(Ft),At=r(Ft,"P",{});var gn=i(At);yh=n(gn,`LayoutLMv3 Model with a span classification head on top for extractive question-answering tasks such as
