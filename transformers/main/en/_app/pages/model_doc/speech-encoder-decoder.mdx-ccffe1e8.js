...
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),M.forEach(o)},m(T,M){u(T,h,M),e(h,A),e(h,g),e(g,D),e(h,F)},d(T){T&&o(h)}}}function qs(Je){let h,A,g,D,F;return{c(){h=r("p"),A=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),g=r("code"),D=n("Module"),F=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(T){h=s(T,"P",{});var M=d(h);A=t(M,"Although the recipe for forward pass needs to be defined within this function, one should call the "),g=s(M,"CODE",{});var L=d(g);D=t(L,"Module"),L.forEach(o),F=t(M,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),M.forEach(o)},m(T,M){u(T,h,M),e(h,A),e(h,g),e(g,D),e(h,F)},d(T){T&&o(h)}}}function Ps(Je){let h,A,g,D,F,T,M,L,Mn,on,$,Dn,Ye,$n,jn,To,qn,Pn,Ze,zn,Fn,Ke,An,Cn,nn,N,Ln,xo,Nn,In,he,Vn,Wn,tn,I,On,Qe,Bn,Rn,Xe,Un,Hn,an,H,te,Mo,me,Gn,Do,Jn,rn,x,fe,Yn,ae,eo,Zn,Kn,oo,Qn,Xn,et,G,ot,no,nt,tt,to,at,rt,st,$o,dt,ct,ue,it,re,ge,lt,_e,pt,ao,ht,mt,ft,se,ve,ut,J,gt,jo,_t,vt,qo,bt,yt,sn,Y,de,Po,be,wt,zo,Et,dn,m,ye,kt,Z,St,ro,Tt,xt,so,Mt,Dt,$t,we,jt,Ee,qt,Pt,zt,ke,Ft,Se,At,Ct,Lt,Fo,Nt,It,Te,Vt,co,Wt,Ot,Bt,xe,Rt,Me,Ut,Ht,Gt,V,io,Jt,Yt,Ao,Zt,Kt,Co,Qt,Xt,ea,j,De,oa,K,na,lo,ta,aa,Lo,ra,sa,da,ce,ca,No,ia,la,$e,pa,q,je,ha,Io,ma,fa,Q,ua,Vo,ga,_a,Wo,va,ba,ya,Oo,wa,Ea,qe,cn,X,ie,Bo,Pe,ka,Ro,Sa,ln,f,ze,Ta,ee,xa,po,Ma,Da,ho,$a,ja,qa,Fe,Pa,Ae,za,Fa,Aa,Ce,Ca,Le,La,Na,Ia,Uo,Va,Wa,Ne,Oa,mo,Ba,Ra,Ua,Ie,Ha,Ve,Ga,Ja,Ya,W,fo,Za,Ka,Ho,Qa,Xa,Go,er,or,nr,P,We,tr,oe,ar,uo,rr,sr,Jo,dr,cr,ir,le,lr,Yo,pr,hr,Oe,mr,C,Be,fr,Zo,ur,gr,Ko,_r,vr,Re,pn;return T=new xn({}),me=new xn({}),fe=new ne({props:{name:"class transformers.SpeechEncoderDecoderConfig",anchor:"transformers.SpeechEncoderDecoderConfig",parameters:[{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/speech_encoder_decoder/configuration_speech_encoder_decoder.py#L27",parametersDescription:[{anchor:"transformers.SpeechEncoderDecoderConfig.kwargs",description:`<strong>kwargs</strong> (<em>optional</em>) &#x2014;
...
Zhou, Wei Li, Peter J. Liu.`),zt=i(),ke=r("p"),Ft=n("Additionally, in "),Se=r("a"),At=n(`Large-Scale Self- and Semi-Supervised Learning for Speech
...
:meth`),Ao=r("em"),Zt=n("~transformers.AutoModel.from_pretrained"),Kt=n(` class method for the encoder and
...
Zhou, Wei Li, Peter J. Liu.`),Aa=i(),Ce=r("p"),Ca=n("Additionally, in "),Le=r("a"),La=n(`Large-Scale Self- and Semi-Supervised Learning for Speech
...
encoder and :meth`),Go=r("em"),er=n("~transformers.FlaxAutoModelForCausalLM.from_pretrained"),or=n(" class method for the decoder."),nr=i(),P=r("div"),b(We.$$.fragment),tr=i(),oe=r("p"),ar=n("The "),uo=r("a"),rr=n("FlaxSpeechEncoderDecoderModel"),sr=n(" forward method, overrides the "),Jo=r("code"),dr=n("__call__"),cr=n(" special method."),ir=i(),b(le.$$.fragment),lr=i(),Yo=r("p"),pr=n("Examples:"),hr=i(),b(Oe.$$.fragment),mr=i(),C=r("div"),b(Be.$$.fragment),fr=i(),Zo=r("p"),ur=n(`Instantiate an encoder and a decoder from one or two base classes of the library from pretrained model
checkpoints.`),gr=i(),Ko=r("p"),_r=n("Example:"),vr=i(),b(Re.$$.fragment),this.h()},l(a){const p=Ds('[data-svelte="svelte-1phssyn"]',document.head);h=s(p,"META",{name:!0,content:!0}),p.forEach(o),A=l(a),g=s(a,"H1",{class:!0});var Ue=d(g);D=s(Ue,"A",{id:!0,class:!0,href:!0});var Qo=d(D);F=s(Qo,"SPAN",{});var br=d(F);y(T.$$.fragment,br),br.forEach(o),Qo.forEach(o),M=l(Ue),L=s(Ue,"SPAN",{});var yr=d(L);Mn=t(yr,"Speech Encoder Decoder Models"),yr.forEach(o),Ue.forEach(o),on=l(a),$=s(a,"P",{});var O=d($);Dn=t(O,"The "),Ye=s(O,"A",{href:!0});var wr=d(Ye);$n=t(wr,"SpeechEncoderDecoderModel"),wr.forEach(o),jn=t(O,` can be used to initialize a speech-sequence-to-text-sequence model
with any pretrained speech autoencoding model as the encoder (`),To=s(O,"EM",{});var Er=d(To);qn=t(Er,"e.g."),Er.forEach(o),Pn=l(O),Ze=s(O,"A",{href:!0});var kr=d(Ze);zn=t(kr,"Wav2Vec2"),kr.forEach(o),Fn=t(O,", "),Ke=s(O,"A",{href:!0});var Sr=d(Ke);An=t(Sr,"Hubert"),Sr.forEach(o),Cn=t(O,") and any pretrained autoregressive model as the decoder."),O.forEach(o),nn=l(a),N=s(a,"P",{});var go=d(N);Ln=t(go,`The effectiveness of initializing speech-sequence-to-text-sequence models with pretrained checkpoints for speech
...
documentation from `),to=s(vo,"A",{href:!0});var Ar=d(to);at=t(Ar,"PretrainedConfig"),Ar.forEach(o),rt=t(vo," for more information."),vo.forEach(o),st=l(z),$o=s(z,"P",{});var Cr=d($o);dt=t(Cr,"Examples:"),Cr.forEach(o),ct=l(z),y(ue.$$.fragment,z),it=l(z),re=s(z,"DIV",{class:!0});var mn=d(re);y(ge.$$.fragment,mn),lt=l(mn),_e=s(mn,"P",{});var fn=d(_e);pt=t(fn,"Instantiate a "),ao=s(fn,"A",{href:!0});var Lr=d(ao);ht=t(Lr,"SpeechEncoderDecoderConfig"),Lr.forEach(o),mt=t(fn,` (or a derived class) from a pre-trained encoder model
...
Zhou, Wei Li, Peter J. Liu.`),_n.forEach(o),zt=l(_),ke=s(_,"P",{});var vn=d(ke);Ft=t(vn,"Additionally, in "),Se=s(vn,"A",{href:!0,rel:!0});var Hr=d(Se);At=t(Hr,`Large-Scale Self- and Semi-Supervised Learning for Speech
Translation`),Hr.forEach(o),Ct=t(vn,` it is shown how leveraging large pretrained speech models for speech
...
Zhou, Wei Li, Peter J. Liu.`),En.forEach(o),Aa=l(v),Ce=s(v,"P",{});var kn=d(Ce);Ca=t(kn,"Additionally, in "),Le=s(kn,"A",{href:!0,rel:!0});var hs=d(Le);La=t(hs,`Large-Scale Self- and Semi-Supervised Learning for Speech
