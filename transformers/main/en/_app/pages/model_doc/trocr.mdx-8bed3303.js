import{S as _i,i as vi,s as Ti,e as s,k as l,w as v,t as r,M as bi,c as n,d as o,m as c,a as i,x as T,h as a,b as d,N as Ci,F as e,g as m,y as b,q as C,o as w,B as k,v as wi}from"../../chunks/vendor-6b77c823.js";import{T as gi}from"../../chunks/Tip-39098574.js";import{D as J}from"../../chunks/Docstring-abef54e3.js";import{C as Zs}from"../../chunks/CodeBlock-3a8b25a8.js";import{I as zt}from"../../chunks/IconCopyLink-7a11ce68.js";function ki(at){let f,q,u,$,L,y,A,F;return{c(){f=s("p"),q=r(`This class method is simply calling the feature extractor
`),u=s("a"),$=r("from_pretrained()"),L=r(` and the tokenizer
...
`),u=n(_,"A",{href:!0});var P=i(u);$=a(P,"from_pretrained()"),P.forEach(o),L=a(_,` and the tokenizer
`),y=n(_,"CODE",{});var z=i(y);A=a(z,"from_pretrained"),z.forEach(o),F=a(_,` methods. Please refer to the docstrings of the
methods above for more information.`),_.forEach(o),this.h()},h(){d(u,"href","/docs/transformers/main/en/main_classes/feature_extractor#transformers.FeatureExtractionMixin.from_pretrained")},m(x,_){m(x,f,_),e(f,q),e(f,u),e(u,$),e(f,L),e(f,y),e(y,A),e(f,F)},d(x){x&&o(f)}}}function Oi(at){let f,q,u,$,L,y,A,F;return{c(){f=s("p"),q=r("This class method is simply calling "),u=s("a"),$=r("save_pretrained()"),L=r(` and
`),y=s("code"),A=r("save_pretrained"),F=r(`. Please refer to the docstrings of the methods
above for more information.`),this.h()},l(x){f=n(x,"P",{});var _=i(f);q=a(_,"This class method is simply calling "),u=n(_,"A",{href:!0});var P=i(u);$=a(P,"save_pretrained()"),P.forEach(o),L=a(_,` and
`),y=n(_,"CODE",{});var z=i(y);A=a(z,"save_pretrained"),z.forEach(o),F=a(_,`. Please refer to the docstrings of the methods
above for more information.`),_.forEach(o),this.h()},h(){d(u,"href","/docs/transformers/main/en/main_classes/feature_extractor#transformers.FeatureExtractionMixin.save_pretrained")},m(x,_){m(x,f,_),e(f,q),e(f,u),e(u,$),e(f,L),e(f,y),e(y,A),e(f,F)},d(x){x&&o(f)}}}function yi(at){let f,q,u,$,L,y,A,F,x,_,P,z,Lt,Ce,rr,Ft,ar,_o,S,sr,we,nr,ir,ke,dr,lr,vo,st,cr,To,nt,Dt,hr,bo,re,Js,Co,ae,mr,it,fr,pr,wo,se,ur,qt,gr,_r,ko,W,vr,Oe,Tr,br,ye,Cr,wr,Oo,dt,kr,yo,B,Re,Or,Ee,yr,Rr,Er,I,$r,$e,xr,Pr,xe,Mr,jr,Pe,zr,Lr,Fr,Me,Dr,lt,qr,Ar,Ro,Y,ne,At,je,Ir,It,Vr,Eo,H,Nr,Vt,Sr,Wr,ct,Br,Hr,$o,p,Ur,Nt,Xr,Gr,St,Zr,Jr,Wt,Yr,Kr,Bt,Qr,ea,ht,ta,oa,Ht,ra,aa,Ut,sa,na,Xt,ia,da,Gt,la,ca,xo,mt,Zt,ha,Po,ze,Mo,ie,ma,Le,fa,pa,jo,K,de,Jt,Fe,ua,Yt,ga,zo,M,De,_a,Q,va,ft,Ta,ba,qe,Ca,wa,ka,ee,Oa,pt,ya,Ra,ut,Ea,$a,xa,Kt,Pa,Ma,Ae,Lo,te,le,Qt,Ie,ja,eo,za,Fo,g,Ve,La,to,Fa,Da,R,gt,qa,Aa,oo,Ia,Va,ro,Na,Sa,ao,Wa,Ba,so,Ha,Ua,Ne,no,Xa,Ga,Za,_t,Ja,Ya,Ka,ce,Se,Qa,V,es,io,ts,os,vt,rs,as,lo,ss,ns,is,U,We,ds,co,ls,cs,he,hs,X,Be,ms,He,fs,Tt,ps,us,gs,me,_s,fe,Ue,vs,Xe,Ts,bt,bs,Cs,ws,pe,Ge,ks,Ze,Os,Ct,ys,Rs,Es,ue,Je,$s,ho,xs,Do,oe,ge,mo,Ye,Ps,fo,Ms,qo,D,Ke,js,N,zs,wt,Ls,Fs,po,Ds,qs,kt,As,Is,Vs,Qe,Ns,et,Ss,Ws,Bs,G,tt,Hs,uo,Us,Xs,ot,Ao;return y=new zt({}),Ce=new zt({}),je=new zt({}),ze=new Zs({props:{code:`from transformers import TrOCRProcessor, VisionEncoderDecoderModel
import requests 
...
<span class="hljs-string">&#x27;industry, &quot; Mr. Brown commented icily. &quot; Let us have a&#x27;</span>`}}),{c(){f=s("meta"),q=l(),u=s("h1"),$=s("a"),L=s("span"),v(y.$$.fragment),A=l(),F=s("span"),x=r("TrOCR"),_=l(),P=s("h2"),z=s("a"),Lt=s("span"),v(Ce.$$.fragment),rr=l(),Ft=s("span"),ar=r("Overview"),_o=l(),S=s("p"),sr=r("The TrOCR model was proposed in "),we=s("a"),nr=r(`TrOCR: Transformer-based Optical Character Recognition with Pre-trained
...
tasks.`),bo=l(),re=s("img"),Co=l(),ae=s("small"),mr=r("TrOCR architecture. Taken from the "),it=s("a"),fr=r("original paper"),pr=r("."),wo=l(),se=s("p"),ur=r("Please refer to the "),qt=s("code"),gr=r("VisionEncoderDecoder"),_r=r(" class on how to use this model."),ko=l(),W=s("p"),vr=r("This model was contributed by "),Oe=s("a"),Tr=r("nielsr"),br=r(`. The original code can be found
`),ye=s("a"),Cr=r("here"),wr=r("."),Oo=l(),dt=s("p"),kr=r("Tips:"),yo=l(),B=s("ul"),Re=s("li"),Or=r("The quickest way to get started with TrOCR is by checking the "),Ee=s("a"),yr=r(`tutorial
notebooks`),Rr=r(`, which show how to use the model
at inference time as well as fine-tuning on custom data.`),Er=l(),I=s("li"),$r=r(`TrOCR is pre-trained in 2 stages before being fine-tuned on downstream datasets. It achieves state-of-the-art results
...
information, see the `),Pe=s("a"),zr=r("official models"),Lr=r("."),Fr=l(),Me=s("li"),Dr=r("TrOCR is always used within the "),lt=s("a"),qr=r("VisionEncoderDecoder"),Ar=r(" framework."),Ro=l(),Y=s("h2"),ne=s("a"),At=s("span"),v(je.$$.fragment),Ir=l(),It=s("span"),Vr=r("Inference"),Eo=l(),H=s("p"),Nr=r("TrOCR\u2019s "),Vt=s("code"),Sr=r("VisionEncoderDecoder"),Wr=r(` model accepts images as input and makes use of
`),ct=s("a"),Br=r("generate()"),Hr=r(" to autoregressively generate text given the input image."),$o=l(),p=s("p"),Ur=r("The ["),Nt=s("code"),Xr=r("ViTFeatureExtractor"),Gr=r("/"),St=s("code"),Zr=r("DeiTFeatureExtractor"),Jr=r(`] class is responsible for preprocessing the input image and
[`),Wt=s("code"),Yr=r("RobertaTokenizer"),Kr=r("/"),Bt=s("code"),Qr=r("XLMRobertaTokenizer"),ea=r(`] decodes the generated target tokens to the target string. The
`),ht=s("a"),ta=r("TrOCRProcessor"),oa=r(" wraps ["),Ht=s("code"),ra=r("ViTFeatureExtractor"),aa=r("/"),Ut=s("code"),sa=r("DeiTFeatureExtractor"),na=r("] and ["),Xt=s("code"),ia=r("RobertaTokenizer"),da=r("/"),Gt=s("code"),la=r("XLMRobertaTokenizer"),ca=r(`]
into a single instance to both extract the input features and decode the predicted token ids.`),xo=l(),mt=s("ul"),Zt=s("li"),ha=r("Step-by-step Optical Character Recognition (OCR)"),Po=l(),v(ze.$$.fragment),Mo=l(),ie=s("p"),ma=r("See the "),Le=s("a"),fa=r("model hub"),pa=r(" to look for TrOCR checkpoints."),jo=l(),K=s("h2"),de=s("a"),Jt=s("span"),v(Fe.$$.fragment),ua=l(),Yt=s("span"),ga=r("TrOCRConfig"),zo=l(),M=s("div"),v(De.$$.fragment),_a=l(),Q=s("p"),va=r("This is the configuration class to store the configuration of a "),ft=s("a"),Ta=r("TrOCRForCausalLM"),ba=r(`. It is used to instantiate an
...
`),qe=s("a"),Ca=r("microsoft/trocr-base"),wa=r(" architecture."),ka=l(),ee=s("p"),Oa=r("Configuration objects inherit from "),pt=s("a"),ya=r("PretrainedConfig"),Ra=r(` and can be used to control the model outputs. Read the
documentation from `),ut=s("a"),Ea=r("PretrainedConfig"),$a=r(" for more information."),xa=l(),Kt=s("p"),Pa=r("Example:"),Ma=l(),v(Ae.$$.fragment),Lo=l(),te=s("h2"),le=s("a"),Qt=s("span"),v(Ie.$$.fragment),ja=l(),eo=s("span"),za=r("TrOCRProcessor"),Fo=l(),g=s("div"),v(Ve.$$.fragment),La=l(),to=s("p"),Fa=r("Constructs a TrOCR processor which wraps a vision feature extractor and a TrOCR tokenizer into a single processor."),Da=l(),R=s("p"),gt=s("a"),qa=r("TrOCRProcessor"),Aa=r(" offers all the functionalities of ["),oo=s("code"),Ia=r("ViTFeatureExtractor"),Va=r("/"),ro=s("code"),Na=r("DeiTFeatureExtractor"),Sa=r(`] and
[`),ao=s("code"),Wa=r("RobertaTokenizer"),Ba=r("/"),so=s("code"),Ha=r("XLMRobertaTokenizer"),Ua=r("]. See the "),Ne=s("a"),no=s("strong"),Xa=r("call"),Ga=r("()"),Za=r(" and "),_t=s("a"),Ja=r("decode()"),Ya=r(` for
...
`),lo=s("code"),ss=r("__call__"),ns=r(". Please refer to the doctsring of the above two methods for more information."),is=l(),U=s("div"),v(We.$$.fragment),ds=l(),co=s("p"),ls=r("Instantiate a processor associated with a pretrained model."),cs=l(),v(he.$$.fragment),hs=l(),X=s("div"),v(Be.$$.fragment),ms=l(),He=s("p"),fs=r(`Saves the attributes of this processor (feature extractor, tokenizer\u2026) in the specified directory so that it
can be reloaded using the `),Tt=s("a"),ps=r("from_pretrained()"),us=r(" method."),gs=l(),v(me.$$.fragment),_s=l(),fe=s("div"),v(Ue.$$.fragment),vs=l(),Xe=s("p"),Ts=r("This method forwards all its arguments to TrOCRTokenizer\u2019s "),bt=s("a"),bs=r("batch_decode()"),Cs=r(`. Please refer
to the docstring of this method for more information.`),ws=l(),pe=s("div"),v(Ge.$$.fragment),ks=l(),Ze=s("p"),Os=r("This method forwards all its arguments to TrOCRTokenizer\u2019s "),Ct=s("a"),ys=r("decode()"),Rs=r(`. Please refer to the
docstring of this method for more information.`),Es=l(),ue=s("div"),v(Je.$$.fragment),$s=l(),ho=s("p"),xs=r("Temporarily sets the tokenizer for processing the input. Useful for encoding the labels when fine-tuning TrOCR."),Do=l(),oe=s("h2"),ge=s("a"),mo=s("span"),v(Ye.$$.fragment),Ps=l(),fo=s("span"),Ms=r("TrOCRForCausalLM"),qo=l(),D=s("div"),v(Ke.$$.fragment),js=l(),N=s("p"),zs=r("The TrOCR Decoder with a language modeling head. Can be used as the decoder part of "),wt=s("a"),Ls=r("EncoderDecoderModel"),Fs=r(" and "),po=s("code"),Ds=r("VisionEncoderDecoder"),qs=r(`.
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),or.forEach(o),Bs=c(Te),G=n(Te,"DIV",{class:!0});var jt=i(G);T(tt.$$.fragment,jt),Hs=c(jt),uo=n(jt,"P",{});var ui=i(uo);Us=a(ui,"Example:"),ui.forEach(o),Xs=c(jt),T(ot.$$.fragment,jt),jt.forEach(o),Te.forEach(o),this.h()},h(){d(f,"name","hf:doc:metadata"),d(f,"content",JSON.stringify(Ri)),d($,"id","trocr"),d($,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),d($,"href","#trocr"),d(u,"class","relative group"),d(z,"id","overview"),d(z,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),d(z,"href","#overview"),d(P,"class","relative group"),d(we,"href","https://arxiv.org/abs/2109.10282"),d(we,"rel","nofollow"),d(ke,"href","https://en.wikipedia.org/wiki/Optical_character_recognition"),d(ke,"rel","nofollow"),Ci(re.src,Js="https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/trocr_architecture.jpg")||d(re,"src",Js),d(re,"alt","drawing"),d(re,"width","600"),d(it,"href","https://arxiv.org/abs/2109.10282"),d(Oe,"href","https://huggingface.co/nielsr"),d(Oe,"rel","nofollow"),d(ye,"href","https://github.com/microsoft/unilm/tree/6f60612e7cc86a2a1ae85c47231507a587ab4e01/trocr"),d(ye,"rel","nofollow"),d(Ee,"href","https://github.com/NielsRogge/Transformers-Tutorials/tree/master/TrOCR"),d(Ee,"rel","nofollow"),d($e,"href","https://paperswithcode.com/dataset/sroie"),d($e,"rel","nofollow"),d(xe,"href","https://fki.tic.heia-fr.ch/databases/iam-handwriting-database%3E"),d(xe,"rel","nofollow"),d(Pe,"href","https://huggingface.co/models?other=trocr%3E"),d(Pe,"rel","nofollow"),d(lt,"href","vision-encoder-decoder"),d(ne,"id","inference"),d(ne,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),d(ne,"href","#inference"),d(Y,"class","relative group"),d(ct,"href","/docs/transformers/main/en/main_classes/text_generation#transformers.generation_utils.GenerationMixin.generate"),d(ht,"href","/docs/transformers/main/en/model_doc/trocr#transformers.TrOCRProcessor"),d(Le,"href","https://huggingface.co/models?filter=trocr"),d(Le,"rel","nofollow"),d(de,"id","transformers.TrOCRConfig"),d(de,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),d(de,"href","#transformers.TrOCRConfig"),d(K,"class","relative group"),d(ft,"href","/docs/transformers/main/en/model_doc/trocr#transformers.TrOCRForCausalLM"),d(qe,"href","https://huggingface.co/microsoft/trocr-base"),d(qe,"rel","nofollow"),d(pt,"href","/docs/transformers/main/en/main_classes/configuration#transformers.PretrainedConfig"),d(ut,"href","/docs/transformers/main/en/main_classes/configuration#transformers.PretrainedConfig"),d(M,"class","docstring"),d(le,"id","transformers.TrOCRProcessor"),d(le,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),d(le,"href","#transformers.TrOCRProcessor"),d(te,"class","relative group"),d(gt,"href","/docs/transformers/main/en/model_doc/trocr#transformers.TrOCRProcessor"),d(Ne,"href","/docs/transformers/main/en/model_doc/trocr#transformers.TrOCRProcessor.__call__"),d(_t,"href","/docs/transformers/main/en/model_doc/trocr#transformers.TrOCRProcessor.decode"),d(vt,"href","/docs/transformers/main/en/model_doc/trocr#transformers.TrOCRProcessor.as_target_processor"),d(ce,"class","docstring"),d(U,"class","docstring"),d(Tt,"href","/docs/transformers/main/en/model_doc/trocr#transformers.TrOCRProcessor.from_pretrained"),d(X,"class","docstring"),d(bt,"href","/docs/transformers/main/en/model_doc/speech_to_text_2#transformers.Speech2Text2Tokenizer.batch_decode"),d(fe,"class","docstring"),d(Ct,"href","/docs/transformers/main/en/model_doc/speech_to_text_2#transformers.Speech2Text2Tokenizer.decode"),d(pe,"class","docstring"),d(ue,"class","docstring"),d(g,"class","docstring"),d(ge,"id","transformers.TrOCRForCausalLM"),d(ge,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),d(ge,"href","#transformers.TrOCRForCausalLM"),d(oe,"class","relative group"),d(wt,"href","/docs/transformers/main/en/model_doc/encoder-decoder#transformers.EncoderDecoderModel"),d(kt,"href","/docs/transformers/main/en/main_classes/model#transformers.PreTrainedModel"),d(et,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),d(et,"rel","nofollow"),d(G,"class","docstring"),d(D,"class","docstring")},m(t,h){e(document.head,f),m(t,q,h),m(t,u,h),e(u,$),e($,L),b(y,L,null),e(u,A),e(u,F),e(F,x),m(t,_,h),m(t,P,h),e(P,z),e(z,Lt),b(Ce,Lt,null),e(P,rr),e(P,Ft),e(Ft,ar),m(t,_o,h),m(t,S,h),e(S,sr),e(S,we),e(we,nr),e(S,ir),e(S,ke),e(ke,dr),e(S,lr),m(t,vo,h),m(t,st,h),e(st,cr),m(t,To,h),m(t,nt,h),e(nt,Dt),e(Dt,hr),m(t,bo,h),m(t,re,h),m(t,Co,h),m(t,ae,h),e(ae,mr),e(ae,it),e(it,fr),e(ae,pr),m(t,wo,h),m(t,se,h),e(se,ur),e(se,qt),e(qt,gr),e(se,_r),m(t,ko,h),m(t,W,h),e(W,vr),e(W,Oe),e(Oe,Tr),e(W,br),e(W,ye),e(ye,Cr),e(W,wr),m(t,Oo,h),m(t,dt,h),e(dt,kr),m(t,yo,h),m(t,B,h),e(B,Re),e(Re,Or),e(Re,Ee),e(Ee,yr),e(Re,Rr),e(B,Er),e(B,I),e(I,$r),e(I,$e),e($e,xr),e(I,Pr),e(I,xe),e(xe,Mr),e(I,jr),e(I,Pe),e(Pe,zr),e(I,Lr),e(B,Fr),e(B,Me),e(Me,Dr),e(Me,lt),e(lt,qr),e(Me,Ar),m(t,Ro,h),m(t,Y,h),e(Y,ne),e(ne,At),b(je,At,null),e(Y,Ir),e(Y,It),e(It,Vr),m(t,Eo,h),m(t,H,h),e(H,Nr),e(H,Vt),e(Vt,Sr),e(H,Wr),e(H,ct),e(ct,Br),e(H,Hr),m(t,$o,h),m(t,p,h),e(p,Ur),e(p,Nt),e(Nt,Xr),e(p,Gr),e(p,St),e(St,Zr),e(p,Jr),e(p,Wt),e(Wt,Yr),e(p,Kr),e(p,Bt),e(Bt,Qr),e(p,ea),e(p,ht),e(ht,ta),e(p,oa),e(p,Ht),e(Ht,ra),e(p,aa),e(p,Ut),e(Ut,sa),e(p,na),e(p,Xt),e(Xt,ia),e(p,da),e(p,Gt),e(Gt,la),e(p,ca),m(t,xo,h),m(t,mt,h),e(mt,Zt),e(Zt,ha),m(t,Po,h),b(ze,t,h),m(t,Mo,h),m(t,ie,h),e(ie,ma),e(ie,Le),e(Le,fa),e(ie,pa),m(t,jo,h),m(t,K,h),e(K,de),e(de,Jt),b(Fe,Jt,null),e(K,ua),e(K,Yt),e(Yt,ga),m(t,zo,h),m(t,M,h),b(De,M,null),e(M,_a),e(M,Q),e(Q,va),e(Q,ft),e(ft,Ta),e(Q,ba),e(Q,qe),e(qe,Ca),e(Q,wa),e(M,ka),e(M,ee),e(ee,Oa),e(ee,pt),e(pt,ya),e(ee,Ra),e(ee,ut),e(ut,Ea),e(ee,$a),e(M,xa),e(M,Kt),e(Kt,Pa),e(M,Ma),b(Ae,M,null),m(t,Lo,h),m(t,te,h),e(te,le),e(le,Qt),b(Ie,Qt,null),e(te,ja),e(te,eo),e(eo,za),m(t,Fo,h),m(t,g,h),b(Ve,g,null),e(g,La),e(g,to),e(to,Fa),e(g,Da),e(g,R),e(R,gt),e(gt,qa),e(R,Aa),e(R,oo),e(oo,Ia),e(R,Va),e(R,ro),e(ro,Na),e(R,Sa),e(R,ao),e(ao,Wa),e(R,Ba),e(R,so),e(so,Ha),e(R,Ua),e(R,Ne),e(Ne,no),e(no,Xa),e(Ne,Ga),e(R,Za),e(R,_t),e(_t,Ja),e(R,Ya),e(g,Ka),e(g,ce),b(Se,ce,null),e(ce,Qa),e(ce,V),e(V,es),e(V,io),e(io,ts),e(V,os),e(V,vt),e(vt,rs),e(V,as),e(V,lo),e(lo,ss),e(V,ns),e(g,is),e(g,U),b(We,U,null),e(U,ds),e(U,co),e(co,ls),e(U,cs),b(he,U,null),e(g,hs),e(g,X),b(Be,X,null),e(X,ms),e(X,He),e(He,fs),e(He,Tt),e(Tt,ps),e(He,us),e(X,gs),b(me,X,null),e(g,_s),e(g,fe),b(Ue,fe,null),e(fe,vs),e(fe,Xe),e(Xe,Ts),e(Xe,bt),e(bt,bs),e(Xe,Cs),e(g,ws),e(g,pe),b(Ge,pe,null),e(pe,ks),e(pe,Ze),e(Ze,Os),e(Ze,Ct),e(Ct,ys),e(Ze,Rs),e(g,Es),e(g,ue),b(Je,ue,null),e(ue,$s),e(ue,ho),e(ho,xs),m(t,Do,h),m(t,oe,h),e(oe,ge),e(ge,mo),b(Ye,mo,null),e(oe,Ps),e(oe,fo),e(fo,Ms),m(t,qo,h),m(t,D,h),b(Ke,D,null),e(D,js),e(D,N),e(N,zs),e(N,wt),e(wt,Ls),e(N,Fs),e(N,po),e(po,Ds),e(N,qs),e(N,kt),e(kt,As),e(N,Is),e(D,Vs),e(D,Qe),e(Qe,Ns),e(Qe,et),e(et,Ss),e(Qe,Ws),e(D,Bs),e(D,G),b(tt,G,null),e(G,Hs),e(G,uo),e(uo,Us),e(G,Xs),b(ot,G,null),Ao=!0},p(t,[h]){const rt={};h&2&&(rt.$$scope={dirty:h,ctx:t}),he.$set(rt);const go={};h&2&&(go.$$scope={dirty:h,ctx:t}),me.$set(go)},i(t){Ao||(C(y.$$.fragment,t),C(Ce.$$.fragment,t),C(je.$$.fragment,t),C(ze.$$.fragment,t),C(Fe.$$.fragment,t),C(De.$$.fragment,t),C(Ae.$$.fragment,t),C(Ie.$$.fragment,t),C(Ve.$$.fragment,t),C(Se.$$.fragment,t),C(We.$$.fragment,t),C(he.$$.fragment,t),C(Be.$$.fragment,t),C(me.$$.fragment,t),C(Ue.$$.fragment,t),C(Ge.$$.fragment,t),C(Je.$$.fragment,t),C(Ye.$$.fragment,t),C(Ke.$$.fragment,t),C(tt.$$.fragment,t),C(ot.$$.fragment,t),Ao=!0)},o(t){w(y.$$.fragment,t),w(Ce.$$.fragment,t),w(je.$$.fragment,t),w(ze.$$.fragment,t),w(Fe.$$.fragment,t),w(De.$$.fragment,t),w(Ae.$$.fragment,t),w(Ie.$$.fragment,t),w(Ve.$$.fragment,t),w(Se.$$.fragment,t),w(We.$$.fragment,t),w(he.$$.fragment,t),w(Be.$$.fragment,t),w(me.$$.fragment,t),w(Ue.$$.fragment,t),w(Ge.$$.fragment,t),w(Je.$$.fragment,t),w(Ye.$$.fragment,t),w(Ke.$$.fragment,t),w(tt.$$.fragment,t),w(ot.$$.fragment,t),Ao=!1},d(t){o(f),t&&o(q),t&&o(u),k(y),t&&o(_),t&&o(P),k(Ce),t&&o(_o),t&&o(S),t&&o(vo),t&&o(st),t&&o(To),t&&o(nt),t&&o(bo),t&&o(re),t&&o(Co),t&&o(ae),t&&o(wo),t&&o(se),t&&o(ko),t&&o(W),t&&o(Oo),t&&o(dt),t&&o(yo),t&&o(B),t&&o(Ro),t&&o(Y),k(je),t&&o(Eo),t&&o(H),t&&o($o),t&&o(p),t&&o(xo),t&&o(mt),t&&o(Po),k(ze,t),t&&o(Mo),t&&o(ie),t&&o(jo),t&&o(K),k(Fe),t&&o(zo),t&&o(M),k(De),k(Ae),t&&o(Lo),t&&o(te),k(Ie),t&&o(Fo),t&&o(g),k(Ve),k(Se),k(We),k(he),k(Be),k(me),k(Ue),k(Ge),k(Je),t&&o(Do),t&&o(oe),k(Ye),t&&o(qo),t&&o(D),k(Ke),k(tt),k(ot)}}}const Ri={local:"trocr",sections:[{local:"overview",title:"Overview"},{local:"inference",title:"Inference"},{local:"transformers.TrOCRConfig",title:"TrOCRConfig"},{local:"transformers.TrOCRProcessor",title:"TrOCRProcessor"},{local:"transformers.TrOCRForCausalLM",title:"TrOCRForCausalLM"}],title:"TrOCR"};function Ei(at){return wi(()=>{new URLSearchParams(window.location.search).get("fw")}),[]}class zi extends _i{constructor(f){super();vi(this,f,Ei,yi,Ti,{})}}export{zi as default,Ri as metadata};
