...
above for more information.`),P.forEach(t),this.h()},h(){d(f,"href","/docs/transformers/main/en/main_classes/feature_extractor#transformers.FeatureExtractionMixin.save_pretrained")},m(D,P){h(D,p,P),e(p,W),e(p,f),e(f,T),e(p,x),e(p,k),e(k,y),e(p,j)},d(D){D&&t(p)}}}function T1(C){let p,W,f,T,x,k,y,j,D,P,F,A,O,X;return{c(){p=a("p"),W=r(`This class method is simply calling Wav2Vec2FeatureExtractor\u2019s
...
`),D=s(q,"CODE",{});var B=n(D);P=i(B,"pyctcdecode.BeamSearchDecoderCTC.load_from_hf_hub"),B.forEach(t),F=i(q,"."),q.forEach(t),A=c(S),O=s(S,"P",{});var R=n(O);X=i(R,"Please refer to the docstrings of the methods above for more information."),R.forEach(t),this.h()},h(){d(f,"href","/docs/transformers/main/en/main_classes/feature_extractor#transformers.FeatureExtractionMixin.from_pretrained")},m(S,q){h(S,p,q),e(p,W),e(p,f),e(f,T),e(p,x),e(p,k),e(k,y),e(p,j),e(p,D),e(D,P),e(p,F),h(S,A,q),h(S,O,q),e(O,X)},d(S){S&&t(p),S&&t(A),S&&t(O)}}}function x1(C){let p,W;return{c(){p=a("p"),W=r("This function makes use of Python\u2019s multiprocessing.")},l(f){p=s(f,"P",{});var T=n(p);W=i(T,"This function makes use of Python\u2019s multiprocessing."),T.forEach(t)},m(f,T){h(f,p,T),e(p,W)},d(f){f&&t(p)}}}function W1(C){let p,W,f,T,x;return{c(){p=a("p"),W=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=a("code"),T=r("Module"),x=r(`
...
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),y.forEach(t)},m(k,y){h(k,p,y),e(p,W),e(p,f),e(f,T),e(p,x)},d(k){k&&t(p)}}}function $1(C){let p,W,f,T,x;return{c(){p=a("p"),W=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=a("code"),T=r("Module"),x=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(k){p=s(k,"P",{});var y=n(p);W=i(y,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=s(y,"CODE",{});var j=n(f);T=i(j,"Module"),j.forEach(t),x=i(y,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),y.forEach(t)},m(k,y){h(k,p,y),e(p,W),e(p,f),e(f,T),e(p,x)},d(k){k&&t(p)}}}function j1(C){let p,W,f,T,x;return{c(){p=a("p"),W=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=a("code"),T=r("Module"),x=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(k){p=s(k,"P",{});var y=n(p);W=i(y,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=s(y,"CODE",{});var j=n(f);T=i(j,"Module"),j.forEach(t),x=i(y,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),y.forEach(t)},m(k,y){h(k,p,y),e(p,W),e(p,f),e(f,T),e(p,x)},d(k){k&&t(p)}}}function V1(C){let p,W,f,T,x;return{c(){p=a("p"),W=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=a("code"),T=r("Module"),x=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(k){p=s(k,"P",{});var y=n(p);W=i(y,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=s(y,"CODE",{});var j=n(f);T=i(j,"Module"),j.forEach(t),x=i(y,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),y.forEach(t)},m(k,y){h(k,p,y),e(p,W),e(p,f),e(f,T),e(p,x)},d(k){k&&t(p)}}}function F1(C){let p,W,f,T,x;return{c(){p=a("p"),W=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=a("code"),T=r("Module"),x=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(k){p=s(k,"P",{});var y=n(p);W=i(y,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=s(y,"CODE",{});var j=n(f);T=i(j,"Module"),j.forEach(t),x=i(y,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),y.forEach(t)},m(k,y){h(k,p,y),e(p,W),e(p,f),e(f,T),e(p,x)},d(k){k&&t(p)}}}function C1(C){let p,W,f,T,x;return{c(){p=a("p"),W=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=a("code"),T=r("Module"),x=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(k){p=s(k,"P",{});var y=n(p);W=i(y,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=s(y,"CODE",{});var j=n(f);T=i(j,"Module"),j.forEach(t),x=i(y,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),y.forEach(t)},m(k,y){h(k,p,y),e(p,W),e(p,f),e(f,T),e(p,x)},d(k){k&&t(p)}}}function E1(C){let p,W,f,T,x,k,y,j,D,P,F,A,O,X,S,q,Ve,ge,B,R,_e,Ge,z,I,Fe,ve,Ye,Ce,oe,ct,et,L,dt,de,pe,Je,we,pt,be,ae,Ee,ye,mt;return{c(){p=a("p"),W=r("TF 2.0 models accepts two formats as inputs:"),f=l(),T=a("ul"),x=a("li"),k=r("having all inputs as keyword arguments (like PyTorch models), or"),y=l(),j=a("li"),D=r("having all inputs as a list, tuple or dict in the first positional arguments."),P=l(),F=a("p"),A=r("This second option is useful when using "),O=a("code"),X=r("tf.keras.Model.fit"),S=r(` method which currently requires having all the
...
`),ye=s(xe,"CODE",{});var Rt=n(ye);mt=i(Rt,'model({"input_values": input_values, "token_type_ids": token_type_ids})'),Rt.forEach(t),xe.forEach(t),G.forEach(t)},m($,E){h($,p,E),e(p,W),h($,f,E),h($,T,E),e(T,x),e(x,k),e(T,y),e(T,j),e(j,D),h($,P,E),h($,F,E),e(F,A),e(F,O),e(O,X),e(F,S),e(F,q),e(q,Ve),e(F,ge),h($,B,E),h($,R,E),e(R,_e),h($,Ge,E),h($,z,E),e(z,I),e(I,Fe),e(I,ve),e(ve,Ye),e(I,Ce),e(I,oe),e(oe,ct),e(z,et),e(z,L),e(L,dt),e(L,de),e(de,pe),e(L,Je),e(L,we),e(we,pt),e(z,be),e(z,ae),e(ae,Ee),e(ae,ye),e(ye,mt)},d($){$&&t(p),$&&t(f),$&&t(T),$&&t(P),$&&t(F),$&&t(B),$&&t(R),$&&t(Ge),$&&t(z)}}}function q1(C){let p,W,f,T,x;return{c(){p=a("p"),W=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=a("code"),T=r("Module"),x=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(k){p=s(k,"P",{});var y=n(p);W=i(y,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=s(y,"CODE",{});var j=n(f);T=i(j,"Module"),j.forEach(t),x=i(y,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),y.forEach(t)},m(k,y){h(k,p,y),e(p,W),e(p,f),e(f,T),e(p,x)},d(k){k&&t(p)}}}function P1(C){let p,W,f,T,x,k,y,j,D,P,F,A,O,X,S,q,Ve,ge,B,R,_e,Ge,z,I,Fe,ve,Ye,Ce,oe,ct,et,L,dt,de,pe,Je,we,pt,be,ae,Ee,ye,mt;return{c(){p=a("p"),W=r("TF 2.0 models accepts two formats as inputs:"),f=l(),T=a("ul"),x=a("li"),k=r("having all inputs as keyword arguments (like PyTorch models), or"),y=l(),j=a("li"),D=r("having all inputs as a list, tuple or dict in the first positional arguments."),P=l(),F=a("p"),A=r("This second option is useful when using "),O=a("code"),X=r("tf.keras.Model.fit"),S=r(` method which currently requires having all the
tensors in the first argument of the model call function: `),q=a("code"),Ve=r("model(inputs)"),ge=r("."),B=l(),R=a("p"),_e=r(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),Ge=l(),z=a("ul"),I=a("li"),Fe=r("a single Tensor with "),ve=a("code"),Ye=r("input_values"),Ce=r(" only and nothing else: "),oe=a("code"),ct=r("model(inputs_ids)"),et=l(),L=a("li"),dt=r(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),de=a("code"),pe=r("model([input_values, attention_mask])"),Je=r(" or "),we=a("code"),pt=r("model([input_values, attention_mask, token_type_ids])"),be=l(),ae=a("li"),Ee=r(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),ye=a("code"),mt=r('model({"input_values": input_values, "token_type_ids": token_type_ids})')},l($){p=s($,"P",{});var E=n(p);W=i(E,"TF 2.0 models accepts two formats as inputs:"),E.forEach(t),f=c($),T=s($,"UL",{});var Ze=n(T);x=s(Ze,"LI",{});var Ke=n(x);k=i(Ke,"having all inputs as keyword arguments (like PyTorch models), or"),Ke.forEach(t),y=c(Ze),j=s(Ze,"LI",{});var Bt=n(j);D=i(Bt,"having all inputs as a list, tuple or dict in the first positional arguments."),Bt.forEach(t),Ze.forEach(t),P=c($),F=s($,"P",{});var se=n(F);A=i(se,"This second option is useful when using "),O=s(se,"CODE",{});var xt=n(O);X=i(xt,"tf.keras.Model.fit"),xt.forEach(t),S=i(se,` method which currently requires having all the
...
`}}),Ko=new fe({props:{$$slots:{default:[W1]},$$scope:{ctx:C}}}),Ds=new ue({props:{code:`from transformers import Wav2Vec2Processor, Wav2Vec2Model
import torch
from datasets import load_dataset
...
`}}),Yo=new fe({props:{$$slots:{default:[$1]},$$scope:{ctx:C}}}),Xs=new ue({props:{code:`from transformers import Wav2Vec2Processor, Wav2Vec2ForCTC
from datasets import load_dataset
import torch
...
<span class="hljs-number">53.48</span>`}}),Js=new ee({}),Zs=new V({props:{name:"class transformers.Wav2Vec2ForSequenceClassification",anchor:"transformers.Wav2Vec2ForSequenceClassification",parameters:[{name:"config",val:""}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/wav2vec2/modeling_wav2vec2.py#L1777",parametersDescription:[{anchor:"transformers.Wav2Vec2ForSequenceClassification.config",description:`<strong>config</strong> (<a href="/docs/transformers/main/en/model_doc/wav2vec2#transformers.Wav2Vec2Config">Wav2Vec2Config</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/main/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),on=new V({props:{name:"forward",anchor:"transformers.Wav2Vec2ForSequenceClassification.forward",parameters:[{name:"input_values",val:": typing.Optional[torch.Tensor]"},{name:"attention_mask",val:": typing.Optional[torch.Tensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"labels",val:": typing.Optional[torch.Tensor] = None"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/wav2vec2/modeling_wav2vec2.py#L1822",parametersDescription:[{anchor:"transformers.Wav2Vec2ForSequenceClassification.forward.input_values",description:`<strong>input_values</strong> (<code>torch.FloatTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Float values of input raw speech waveform. Values can be obtained by loading a <em>.flac</em> or <em>.wav</em> audio file
into an array of type <em>List[float]</em> or a <em>numpy.ndarray</em>, <em>e.g.</em> via the soundfile library (<em>pip install
soundfile</em>). To prepare the array into <em>input_values</em>, the <a href="/docs/transformers/main/en/model_doc/wav2vec2#transformers.Wav2Vec2Processor">Wav2Vec2Processor</a> should be used for padding
...
`}}),ta=new fe({props:{$$slots:{default:[j1]},$$scope:{ctx:C}}}),an=new ue({props:{code:`from transformers import Wav2Vec2FeatureExtractor, Wav2Vec2ForSequenceClassification
from datasets import load_dataset
import torch
...
<span class="hljs-meta">&gt;&gt;&gt; </span>loss = model(**inputs).loss
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-built_in">round</span>(loss.item(), <span class="hljs-number">2</span>)
<span class="hljs-number">6.54</span>`}}),nn=new ee({}),rn=new V({props:{name:"class transformers.Wav2Vec2ForAudioFrameClassification",anchor:"transformers.Wav2Vec2ForAudioFrameClassification",parameters:[{name:"config",val:""}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/wav2vec2/modeling_wav2vec2.py#L1900",parametersDescription:[{anchor:"transformers.Wav2Vec2ForAudioFrameClassification.config",description:`<strong>config</strong> (<a href="/docs/transformers/main/en/model_doc/wav2vec2#transformers.Wav2Vec2Config">Wav2Vec2Config</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/main/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),hn=new V({props:{name:"forward",anchor:"transformers.Wav2Vec2ForAudioFrameClassification.forward",parameters:[{name:"input_values",val:": typing.Optional[torch.Tensor]"},{name:"attention_mask",val:": typing.Optional[torch.Tensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/wav2vec2/modeling_wav2vec2.py#L1943",parametersDescription:[{anchor:"transformers.Wav2Vec2ForAudioFrameClassification.forward.input_values",description:`<strong>input_values</strong> (<code>torch.FloatTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Float values of input raw speech waveform. Values can be obtained by loading a <em>.flac</em> or <em>.wav</em> audio file
into an array of type <em>List[float]</em> or a <em>numpy.ndarray</em>, <em>e.g.</em> via the soundfile library (<em>pip install
soundfile</em>). To prepare the array into <em>input_values</em>, the <a href="/docs/transformers/main/en/model_doc/wav2vec2#transformers.Wav2Vec2Processor">Wav2Vec2Processor</a> should be used for padding
...
`}}),aa=new fe({props:{$$slots:{default:[V1]},$$scope:{ctx:C}}}),fn=new ue({props:{code:`from transformers import Wav2Vec2FeatureExtractor, Wav2Vec2ForAudioFrameClassification
from datasets import load_dataset
import torch
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/main/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),kn=new V({props:{name:"forward",anchor:"transformers.Wav2Vec2ForXVector.forward",parameters:[{name:"input_values",val:": typing.Optional[torch.Tensor]"},{name:"attention_mask",val:": typing.Optional[torch.Tensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"labels",val:": typing.Optional[torch.Tensor] = None"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/wav2vec2/modeling_wav2vec2.py#L2117",parametersDescription:[{anchor:"transformers.Wav2Vec2ForXVector.forward.input_values",description:`<strong>input_values</strong> (<code>torch.FloatTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Float values of input raw speech waveform. Values can be obtained by loading a <em>.flac</em> or <em>.wav</em> audio file
into an array of type <em>List[float]</em> or a <em>numpy.ndarray</em>, <em>e.g.</em> via the soundfile library (<em>pip install
soundfile</em>). To prepare the array into <em>input_values</em>, the <a href="/docs/transformers/main/en/model_doc/wav2vec2#transformers.Wav2Vec2Processor">Wav2Vec2Processor</a> should be used for padding
...
`}}),na=new fe({props:{$$slots:{default:[F1]},$$scope:{ctx:C}}}),Tn=new ue({props:{code:`from transformers import Wav2Vec2FeatureExtractor, Wav2Vec2ForXVector
from datasets import load_dataset
import torch
...
`}}),ia=new fe({props:{$$slots:{default:[C1]},$$scope:{ctx:C}}}),En=new ue({props:{code:`import torch
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/main/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),ca=new fe({props:{$$slots:{default:[E1]},$$scope:{ctx:C}}}),On=new V({props:{name:"call",anchor:"transformers.TFWav2Vec2Model.call",parameters:[{name:"input_values",val:": Tensor"},{name:"attention_mask",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"token_type_ids",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"position_ids",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"head_mask",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"inputs_embeds",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"training",val:": bool = False"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/wav2vec2/modeling_tf_wav2vec2.py#L1434",parametersDescription:[{anchor:"transformers.TFWav2Vec2Model.call.input_values",description:`<strong>input_values</strong> (<code>np.ndarray</code>, <code>tf.Tensor</code>, <code>List[tf.Tensor]</code> \`<code>Dict[str, tf.Tensor]</code> or <code>Dict[str, np.ndarray]</code> and each example must have the shape <code>({0})</code>) &#x2014;
...
`}}),da=new fe({props:{$$slots:{default:[q1]},$$scope:{ctx:C}}}),Ln=new ue({props:{code:`from transformers import Wav2Vec2Processor, TFWav2Vec2Model
from datasets import load_dataset
import soundfile as sf
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/main/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),ma=new fe({props:{$$slots:{default:[P1]},$$scope:{ctx:C}}}),Rn=new V({props:{name:"call",anchor:"transformers.TFWav2Vec2ForCTC.call",parameters:[{name:"input_values",val:": Tensor"},{name:"attention_mask",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"token_type_ids",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"position_ids",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"head_mask",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"inputs_embeds",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"labels",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"training",val:": typing.Optional[bool] = False"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/wav2vec2/modeling_tf_wav2vec2.py#L1558",parametersDescription:[{anchor:"transformers.TFWav2Vec2ForCTC.call.input_values",description:`<strong>input_values</strong> (<code>np.ndarray</code>, <code>tf.Tensor</code>, <code>List[tf.Tensor]</code> \`<code>Dict[str, tf.Tensor]</code> or <code>Dict[str, np.ndarray]</code> and each example must have the shape <code>({0})</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/main/en/model_doc/bert#transformers.BertTokenizer">BertTokenizer</a>. See <a href="/docs/transformers/main/en/model_doc/wav2vec2#transformers.Wav2Vec2CTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
<a href="/docs/transformers/main/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> for details.</p>
...
`}}),ha=new fe({props:{$$slots:{default:[z1]},$$scope:{ctx:C}}}),Hn=new ue({props:{code:`import tensorflow as tf
...
`}}),ua=new fe({props:{$$slots:{default:[M1]},$$scope:{ctx:C}}}),nr=new ue({props:{code:`from transformers import Wav2Vec2Processor, FlaxWav2Vec2Model
from datasets import load_dataset
import soundfile as sf
...
`}}),_a=new fe({props:{$$slots:{default:[A1]},$$scope:{ctx:C}}}),_r=new ue({props:{code:`import jax.numpy as jnp
...
`}}),wa=new fe({props:{$$slots:{default:[O1]},$$scope:{ctx:C}}}),Fr=new ue({props:{code:`import optax
import numpy as np
...
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),$p.forEach(t),Du=c(Et),Me=s(Et,"DIV",{class:!0});var qt=n(Me);g(Ls.$$.fragment,qt),Su=c(qt),ao=s(qt,"P",{});var qi=n(ao);Nu=i(qi,"The "),ri=s(qi,"A",{href:!0});var Qy=n(ri);Iu=i(Qy,"Wav2Vec2Model"),Qy.forEach(t),Bu=i(qi," forward method, overrides the "),ql=s(qi,"CODE",{});var Yy=n(ql);Uu=i(Yy,"__call__"),Yy.forEach(t),Ru=i(qi," special method."),qi.forEach(t),Hu=c(qt),g(Ko.$$.fragment,qt),Xu=c(qt),Pl=s(qt,"P",{});var ek=n(Pl);Gu=i(ek,"Example:"),ek.forEach(t),Ju=c(qt),g(Ds.$$.fragment,qt),qt.forEach(t),Et.forEach(t),bd=c(o),so=s(o,"H2",{class:!0});var jp=n(so);Qo=s(jp,"A",{id:!0,class:!0,href:!0});var tk=n(Qo);zl=s(tk,"SPAN",{});var ok=n(zl);g(Ss.$$.fragment,ok),ok.forEach(t),tk.forEach(t),Zu=c(jp),Ml=s(jp,"SPAN",{});var ak=n(Ml);Ku=i(ak,"Wav2Vec2ForCTC"),ak.forEach(t),jp.forEach(t),yd=c(o),$e=s(o,"DIV",{class:!0});var Pt=n($e);g(Ns.$$.fragment,Pt),Qu=c(Pt),no=s(Pt,"P",{});var Pi=n(no);Yu=i(Pi,"Wav2Vec2 Model with a "),Al=s(Pi,"CODE",{});var sk=n(Al);eg=i(sk,"language modeling"),sk.forEach(t),tg=i(Pi,` head on top for Connectionist Temporal Classification (CTC).
...
Auli.`),Pi.forEach(t),sg=c(Pt),Bs=s(Pt,"P",{});var Vp=n(Bs);ng=i(Vp,"This model inherits from "),ii=s(Vp,"A",{href:!0});var rk=n(ii);rg=i(rk,"PreTrainedModel"),rk.forEach(t),ig=i(Vp,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving etc.).`),Vp.forEach(t),lg=c(Pt),Us=s(Pt,"P",{});var Fp=n(Us);cg=i(Fp,"This model is a PyTorch "),Rs=s(Fp,"A",{href:!0,rel:!0});var ik=n(Rs);dg=i(ik,"torch.nn.Module"),ik.forEach(t),pg=i(Fp,` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),Fp.forEach(t),mg=c(Pt),me=s(Pt,"DIV",{class:!0});var ot=n(me);g(Hs.$$.fragment,ot),hg=c(ot),ro=s(ot,"P",{});var zi=n(ro);fg=i(zi,"The "),li=s(zi,"A",{href:!0});var lk=n(li);ug=i(lk,"Wav2Vec2ForCTC"),lk.forEach(t),gg=i(zi," forward method, overrides the "),Ol=s(zi,"CODE",{});var ck=n(Ol);_g=i(ck,"__call__"),ck.forEach(t),vg=i(zi," special method."),zi.forEach(t),wg=c(ot),g(Yo.$$.fragment,ot),bg=c(ot),Ll=s(ot,"P",{});var dk=n(Ll);yg=i(dk,"Example:"),dk.forEach(t),kg=c(ot),g(Xs.$$.fragment,ot),Tg=c(ot),g(Gs.$$.fragment,ot),ot.forEach(t),Pt.forEach(t),kd=c(o),io=s(o,"H2",{class:!0});var Cp=n(io);ea=s(Cp,"A",{id:!0,class:!0,href:!0});var pk=n(ea);Dl=s(pk,"SPAN",{});var mk=n(Dl);g(Js.$$.fragment,mk),mk.forEach(t),pk.forEach(t),xg=c(Cp),Sl=s(Cp,"SPAN",{});var hk=n(Sl);Wg=i(hk,"Wav2Vec2ForSequenceClassification"),hk.forEach(t),Cp.forEach(t),Td=c(o),ne=s(o,"DIV",{class:!0});var at=n(ne);g(Zs.$$.fragment,at),$g=c(at),Nl=s(at,"P",{});var fk=n(Nl);jg=i(fk,`Wav2Vec2 Model with a sequence classification head on top (a linear layer over the pooled output) for tasks like
SUPERB Keyword Spotting.`),fk.forEach(t),Vg=c(at),Ks=s(at,"P",{});var Ep=n(Ks);Fg=i(Ep,"Wav2Vec2 was proposed in "),Qs=s(Ep,"A",{href:!0,rel:!0});var uk=n(Qs);Cg=i(uk,`wav2vec 2.0: A Framework for Self-Supervised Learning of Speech
...
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),Pp.forEach(t),Sg=c(at),he=s(at,"DIV",{class:!0});var st=n(he);g(on.$$.fragment,st),Ng=c(st),lo=s(st,"P",{});var Mi=n(lo);Ig=i(Mi,"The "),di=s(Mi,"A",{href:!0});var vk=n(di);Bg=i(vk,"Wav2Vec2ForSequenceClassification"),vk.forEach(t),Ug=i(Mi," forward method, overrides the "),Il=s(Mi,"CODE",{});var wk=n(Il);Rg=i(wk,"__call__"),wk.forEach(t),Hg=i(Mi," special method."),Mi.forEach(t),Xg=c(st),g(ta.$$.fragment,st),Gg=c(st),Bl=s(st,"P",{});var bk=n(Bl);Jg=i(bk,"Example:"),bk.forEach(t),Zg=c(st),g(an.$$.fragment,st),Kg=c(st),g(sn.$$.fragment,st),st.forEach(t),at.forEach(t),xd=c(o),co=s(o,"H2",{class:!0});var zp=n(co);oa=s(zp,"A",{id:!0,class:!0,href:!0});var yk=n(oa);Ul=s(yk,"SPAN",{});var kk=n(Ul);g(nn.$$.fragment,kk),kk.forEach(t),yk.forEach(t),Qg=c(zp),Rl=s(zp,"SPAN",{});var Tk=n(Rl);Yg=i(Tk,"Wav2Vec2ForAudioFrameClassification"),Tk.forEach(t),zp.forEach(t),Wd=c(o),re=s(o,"DIV",{class:!0});var nt=n(re);g(rn.$$.fragment,nt),e_=c(nt),Hl=s(nt,"P",{});var xk=n(Hl);t_=i(xk,"Wav2Vec2 Model with a frame classification head on top for tasks like Speaker Diarization."),xk.forEach(t),o_=c(nt),ln=s(nt,"P",{});var Mp=n(ln);a_=i(Mp,"Wav2Vec2 was proposed in "),cn=s(Mp,"A",{href:!0,rel:!0});var Wk=n(cn);s_=i(Wk,`wav2vec 2.0: A Framework for Self-Supervised Learning of Speech
...
library implements for all its model (such as downloading or saving etc.).`),Ap.forEach(t),d_=c(nt),pn=s(nt,"P",{});var Op=n(pn);p_=i(Op,"This model is a PyTorch "),mn=s(Op,"A",{href:!0,rel:!0});var jk=n(mn);m_=i(jk,"torch.nn.Module"),jk.forEach(t),h_=i(Op,` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),Op.forEach(t),f_=c(nt),Ae=s(nt,"DIV",{class:!0});var zt=n(Ae);g(hn.$$.fragment,zt),u_=c(zt),po=s(zt,"P",{});var Ai=n(po);g_=i(Ai,"The "),mi=s(Ai,"A",{href:!0});var Vk=n(mi);__=i(Vk,"Wav2Vec2ForAudioFrameClassification"),Vk.forEach(t),v_=i(Ai," forward method, overrides the "),Xl=s(Ai,"CODE",{});var Fk=n(Xl);w_=i(Fk,"__call__"),Fk.forEach(t),b_=i(Ai," special method."),Ai.forEach(t),y_=c(zt),g(aa.$$.fragment,zt),k_=c(zt),Gl=s(zt,"P",{});var Ck=n(Gl);T_=i(Ck,"Example:"),Ck.forEach(t),x_=c(zt),g(fn.$$.fragment,zt),zt.forEach(t),nt.forEach(t),$d=c(o),mo=s(o,"H2",{class:!0});var Lp=n(mo);sa=s(Lp,"A",{id:!0,class:!0,href:!0});var Ek=n(sa);Jl=s(Ek,"SPAN",{});var qk=n(Jl);g(un.$$.fragment,qk),qk.forEach(t),Ek.forEach(t),W_=c(Lp),Zl=s(Lp,"SPAN",{});var Pk=n(Zl);$_=i(Pk,"Wav2Vec2ForXVector"),Pk.forEach(t),Lp.forEach(t),jd=c(o),ie=s(o,"DIV",{class:!0});var rt=n(ie);g(gn.$$.fragment,rt),j_=c(rt),Kl=s(rt,"P",{});var zk=n(Kl);V_=i(zk,"Wav2Vec2 Model with an XVector feature extraction head on top for tasks like Speaker Verification."),zk.forEach(t),F_=c(rt),_n=s(rt,"P",{});var Dp=n(_n);C_=i(Dp,"Wav2Vec2 was proposed in "),vn=s(Dp,"A",{href:!0,rel:!0});var Mk=n(vn);E_=i(Mk,`wav2vec 2.0: A Framework for Self-Supervised Learning of Speech
Representations`),Mk.forEach(t),q_=i(Dp,` by Alexei Baevski, Henry Zhou, Abdelrahman Mohamed, Michael
Auli.`),Dp.forEach(t),P_=c(rt),wn=s(rt,"P",{});var Sp=n(wn);z_=i(Sp,"This model inherits from "),hi=s(Sp,"A",{href:!0});var Ak=n(hi);M_=i(Ak,"PreTrainedModel"),Ak.forEach(t),A_=i(Sp,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving etc.).`),Sp.forEach(t),O_=c(rt),bn=s(rt,"P",{});var Np=n(bn);L_=i(Np,"This model is a PyTorch "),yn=s(Np,"A",{href:!0,rel:!0});var Ok=n(yn);D_=i(Ok,"torch.nn.Module"),Ok.forEach(t),S_=i(Np,` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),Np.forEach(t),N_=c(rt),Oe=s(rt,"DIV",{class:!0});var Mt=n(Oe);g(kn.$$.fragment,Mt),I_=c(Mt),ho=s(Mt,"P",{});var Oi=n(ho);B_=i(Oi,"The "),fi=s(Oi,"A",{href:!0});var Lk=n(fi);U_=i(Lk,"Wav2Vec2ForXVector"),Lk.forEach(t),R_=i(Oi," forward method, overrides the "),Ql=s(Oi,"CODE",{});var Dk=n(Ql);H_=i(Dk,"__call__"),Dk.forEach(t),X_=i(Oi," special method."),Oi.forEach(t),G_=c(Mt),g(na.$$.fragment,Mt),J_=c(Mt),Yl=s(Mt,"P",{});var Sk=n(Yl);Z_=i(Sk,"Example:"),Sk.forEach(t),K_=c(Mt),g(Tn.$$.fragment,Mt),Mt.forEach(t),rt.forEach(t),Vd=c(o),fo=s(o,"H2",{class:!0});var Ip=n(fo);ra=s(Ip,"A",{id:!0,class:!0,href:!0});var Nk=n(ra);ec=s(Nk,"SPAN",{});var Ik=n(ec);g(xn.$$.fragment,Ik),Ik.forEach(t),Nk.forEach(t),Q_=c(Ip),tc=s(Ip,"SPAN",{});var Bk=n(tc);Y_=i(Bk,"Wav2Vec2ForPreTraining"),Bk.forEach(t),Ip.forEach(t),Fd=c(o),je=s(o,"DIV",{class:!0});var At=n(je);g(Wn.$$.fragment,At),ev=c(At),uo=s(At,"P",{});var Li=n(uo);tv=i(Li,"Wav2Vec2 Model with a quantizer and "),oc=s(Li,"CODE",{});var Uk=n(oc);ov=i(Uk,"VQ"),Uk.forEach(t),av=i(Li,` head on top.
Wav2Vec2 was proposed in `),$n=s(Li,"A",{href:!0,rel:!0});var Rk=n($n);sv=i(Rk,`wav2vec 2.0: A Framework for Self-Supervised Learning of Speech
Representations`),Rk.forEach(t),nv=i(Li,` by Alexei Baevski, Henry Zhou, Abdelrahman Mohamed, Michael
Auli.`),Li.forEach(t),rv=c(At),jn=s(At,"P",{});var Bp=n(jn);iv=i(Bp,"This model inherits from "),ui=s(Bp,"A",{href:!0});var Hk=n(ui);lv=i(Hk,"PreTrainedModel"),Hk.forEach(t),cv=i(Bp,`. Check the superclass documentation for the generic methods the
...
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),Up.forEach(t),fv=c(At),Le=s(At,"DIV",{class:!0});var Ot=n(Le);g(Cn.$$.fragment,Ot),uv=c(Ot),go=s(Ot,"P",{});var Di=n(go);gv=i(Di,"The "),gi=s(Di,"A",{href:!0});var Gk=n(gi);_v=i(Gk,"Wav2Vec2ForPreTraining"),Gk.forEach(t),vv=i(Di," forward method, overrides the "),ac=s(Di,"CODE",{});var Jk=n(ac);wv=i(Jk,"__call__"),Jk.forEach(t),bv=i(Di," special method."),Di.forEach(t),yv=c(Ot),g(ia.$$.fragment,Ot),kv=c(Ot),sc=s(Ot,"P",{});var Zk=n(sc);Tv=i(Zk,"Example:"),Zk.forEach(t),xv=c(Ot),g(En.$$.fragment,Ot),Ot.forEach(t),At.forEach(t),Cd=c(o),_o=s(o,"H2",{class:!0});var Rp=n(_o);la=s(Rp,"A",{id:!0,class:!0,href:!0});var Kk=n(la);nc=s(Kk,"SPAN",{});var Qk=n(nc);g(qn.$$.fragment,Qk),Qk.forEach(t),Kk.forEach(t),Wv=c(Rp),rc=s(Rp,"SPAN",{});var Yk=n(rc);$v=i(Yk,"TFWav2Vec2Model"),Yk.forEach(t),Rp.forEach(t),Ed=c(o),le=s(o,"DIV",{class:!0});var it=n(le);g(Pn.$$.fragment,it),jv=c(it),ic=s(it,"P",{});var eT=n(ic);Vv=i(eT,"The bare TFWav2Vec2 Model transformer outputing raw hidden-states without any specific head on top."),eT.forEach(t),Fv=c(it),zn=s(it,"P",{});var Hp=n(zn);Cv=i(Hp,"This model inherits from "),_i=s(Hp,"A",{href:!0});var tT=n(_i);Ev=i(tT,"TFPreTrainedModel"),tT.forEach(t),qv=i(Hp,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Hp.forEach(t),Pv=c(it),Mn=s(it,"P",{});var Xp=n(Mn);zv=i(Xp,"This model is also a "),An=s(Xp,"A",{href:!0,rel:!0});var oT=n(An);Mv=i(oT,"tf.keras.Model"),oT.forEach(t),Av=i(Xp,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Xp.forEach(t),Ov=c(it),g(ca.$$.fragment,it),Lv=c(it),De=s(it,"DIV",{class:!0});var Lt=n(De);g(On.$$.fragment,Lt),Dv=c(Lt),vo=s(Lt,"P",{});var Si=n(vo);Sv=i(Si,"The "),vi=s(Si,"A",{href:!0});var aT=n(vi);Nv=i(aT,"TFWav2Vec2Model"),aT.forEach(t),Iv=i(Si," forward method, overrides the "),lc=s(Si,"CODE",{});var sT=n(lc);Bv=i(sT,"__call__"),sT.forEach(t),Uv=i(Si," special method."),Si.forEach(t),Rv=c(Lt),g(da.$$.fragment,Lt),Hv=c(Lt),cc=s(Lt,"P",{});var nT=n(cc);Xv=i(nT,"Example:"),nT.forEach(t),Gv=c(Lt),g(Ln.$$.fragment,Lt),Lt.forEach(t),it.forEach(t),qd=c(o),wo=s(o,"H2",{class:!0});var Gp=n(wo);pa=s(Gp,"A",{id:!0,class:!0,href:!0});var rT=n(pa);dc=s(rT,"SPAN",{});var iT=n(dc);g(Dn.$$.fragment,iT),iT.forEach(t),rT.forEach(t),Jv=c(Gp),pc=s(Gp,"SPAN",{});var lT=n(pc);Zv=i(lT,"TFWav2Vec2ForCTC"),lT.forEach(t),Gp.forEach(t),Pd=c(o),ce=s(o,"DIV",{class:!0});var lt=n(ce);g(Sn.$$.fragment,lt),Kv=c(lt),Nn=s(lt,"P",{});var Jp=n(Nn);Qv=i(Jp,"TFWav2Vec2 Model with a "),mc=s(Jp,"CODE",{});var cT=n(mc);Yv=i(cT,"language modeling"),cT.forEach(t),e2=i(Jp," head on top for Connectionist Temporal Classification (CTC)."),Jp.forEach(t),t2=c(lt),In=s(lt,"P",{});var Zp=n(In);o2=i(Zp,"This model inherits from "),wi=s(Zp,"A",{href:!0});var dT=n(wi);a2=i(dT,"TFPreTrainedModel"),dT.forEach(t),s2=i(Zp,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Kp.forEach(t),c2=c(lt),g(ma.$$.fragment,lt),d2=c(lt),Se=s(lt,"DIV",{class:!0});var Dt=n(Se);g(Rn.$$.fragment,Dt),p2=c(Dt),bo=s(Dt,"P",{});var Ni=n(bo);m2=i(Ni,"The "),bi=s(Ni,"A",{href:!0});var mT=n(bi);h2=i(mT,"TFWav2Vec2ForCTC"),mT.forEach(t),f2=i(Ni," forward method, overrides the "),hc=s(Ni,"CODE",{});var hT=n(hc);u2=i(hT,"__call__"),hT.forEach(t),g2=i(Ni," special method."),Ni.forEach(t),_2=c(Dt),g(ha.$$.fragment,Dt),v2=c(Dt),fc=s(Dt,"P",{});var fT=n(fc);w2=i(fT,"Example:"),fT.forEach(t),b2=c(Dt),g(Hn.$$.fragment,Dt),Dt.forEach(t),lt.forEach(t),zd=c(o),yo=s(o,"H2",{class:!0});var Qp=n(yo);fa=s(Qp,"A",{id:!0,class:!0,href:!0});var uT=n(fa);uc=s(uT,"SPAN",{});var gT=n(uc);g(Xn.$$.fragment,gT),gT.forEach(t),uT.forEach(t),y2=c(Qp),gc=s(Qp,"SPAN",{});var _T=n(gc);k2=i(_T,"FlaxWav2Vec2Model"),_T.forEach(t),Qp.forEach(t),Md=c(o),K=s(o,"DIV",{class:!0});var Re=n(K);g(Gn.$$.fragment,Re),T2=c(Re),Jn=s(Re,"P",{});var Yp=n(Jn);x2=i(Yp,`The bare Wav2Vec2 Model transformer outputting raw hidden-states without any specific head on top.
...
Auli.`),Yp.forEach(t),j2=c(Re),Kn=s(Re,"P",{});var em=n(Kn);V2=i(em,"This model inherits from "),yi=s(em,"A",{href:!0});var wT=n(yi);F2=i(wT,"FlaxPreTrainedModel"),wT.forEach(t),C2=i(em,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),em.forEach(t),E2=c(Re),Qn=s(Re,"P",{});var tm=n(Qn);q2=i(tm,`This model is also a Flax Linen
`),Yn=s(tm,"A",{href:!0,rel:!0});var bT=n(Yn);P2=i(bT,"flax.nn.Module"),bT.forEach(t),z2=i(tm,` subclass. Use it as a
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),tm.forEach(t),M2=c(Re),_c=s(Re,"P",{});var yT=n(_c);A2=i(yT,"Finally, this model supports inherent JAX features such as:"),yT.forEach(t),O2=c(Re),bt=s(Re,"UL",{});var $a=n(bt);vc=s($a,"LI",{});var kT=n(vc);er=s(kT,"A",{href:!0,rel:!0});var TT=n(er);L2=i(TT,"Just-In-Time (JIT) compilation"),TT.forEach(t),kT.forEach(t),D2=c($a),wc=s($a,"LI",{});var xT=n(wc);tr=s(xT,"A",{href:!0,rel:!0});var WT=n(tr);S2=i(WT,"Automatic Differentiation"),WT.forEach(t),xT.forEach(t),N2=c($a),bc=s($a,"LI",{});var $T=n(bc);or=s($T,"A",{href:!0,rel:!0});var jT=n(or);I2=i(jT,"Vectorization"),jT.forEach(t),$T.forEach(t),B2=c($a),yc=s($a,"LI",{});var VT=n(yc);ar=s(VT,"A",{href:!0,rel:!0});var FT=n(ar);U2=i(FT,"Parallelization"),FT.forEach(t),VT.forEach(t),$a.forEach(t),R2=c(Re),Ne=s(Re,"DIV",{class:!0});var St=n(Ne);g(sr.$$.fragment,St),H2=c(St),ko=s(St,"P",{});var Ii=n(ko);X2=i(Ii,"The "),kc=s(Ii,"CODE",{});var CT=n(kc);G2=i(CT,"FlaxWav2Vec2PreTrainedModel"),CT.forEach(t),J2=i(Ii,"forward method, overrides the "),Tc=s(Ii,"CODE",{});var ET=n(Tc);Z2=i(ET,"__call__"),ET.forEach(t),K2=i(Ii," special method."),Ii.forEach(t),Q2=c(St),g(ua.$$.fragment,St),Y2=c(St),xc=s(St,"P",{});var qT=n(xc);ew=i(qT,"Example:"),qT.forEach(t),tw=c(St),g(nr.$$.fragment,St),St.forEach(t),Re.forEach(t),Ad=c(o),To=s(o,"H2",{class:!0});var om=n(To);ga=s(om,"A",{id:!0,class:!0,href:!0});var PT=n(ga);Wc=s(PT,"SPAN",{});var zT=n(Wc);g(rr.$$.fragment,zT),zT.forEach(t),PT.forEach(t),ow=c(om),$c=s(om,"SPAN",{});var MT=n($c);aw=i(MT,"FlaxWav2Vec2ForCTC"),MT.forEach(t),om.forEach(t),Od=c(o),Q=s(o,"DIV",{class:!0});var He=n(Q);g(ir.$$.fragment,He),sw=c(He),xo=s(He,"P",{});var Bi=n(xo);nw=i(Bi,"Wav2Vec2 Model with a "),jc=s(Bi,"CODE",{});var AT=n(jc);rw=i(AT,"language modeling"),AT.forEach(t),iw=i(Bi,` head on top for Connectionist Temporal Classification (CTC).
Wav2Vec2 was proposed in `),lr=s(Bi,"A",{href:!0,rel:!0});var OT=n(lr);lw=i(OT,`wav2vec 2.0: A Framework for Self-Supervised Learning of Speech
Representations`),OT.forEach(t),cw=i(Bi,` by Alexei Baevski, Henry Zhou, Abdelrahman Mohamed, Michael
Auli.`),Bi.forEach(t),dw=c(He),cr=s(He,"P",{});var am=n(cr);pw=i(am,"This model inherits from "),ki=s(am,"A",{href:!0});var LT=n(ki);mw=i(LT,"FlaxPreTrainedModel"),LT.forEach(t),hw=i(am,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),am.forEach(t),fw=c(He),dr=s(He,"P",{});var sm=n(dr);uw=i(sm,`This model is also a Flax Linen
`),pr=s(sm,"A",{href:!0,rel:!0});var DT=n(pr);gw=i(DT,"flax.nn.Module"),DT.forEach(t),_w=i(sm,` subclass. Use it as a
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),sm.forEach(t),vw=c(He),Vc=s(He,"P",{});var ST=n(Vc);ww=i(ST,"Finally, this model supports inherent JAX features such as:"),ST.forEach(t),bw=c(He),yt=s(He,"UL",{});var ja=n(yt);Fc=s(ja,"LI",{});var NT=n(Fc);mr=s(NT,"A",{href:!0,rel:!0});var IT=n(mr);yw=i(IT,"Just-In-Time (JIT) compilation"),IT.forEach(t),NT.forEach(t),kw=c(ja),Cc=s(ja,"LI",{});var BT=n(Cc);hr=s(BT,"A",{href:!0,rel:!0});var UT=n(hr);Tw=i(UT,"Automatic Differentiation"),UT.forEach(t),BT.forEach(t),xw=c(ja),Ec=s(ja,"LI",{});var RT=n(Ec);fr=s(RT,"A",{href:!0,rel:!0});var HT=n(fr);Ww=i(HT,"Vectorization"),HT.forEach(t),RT.forEach(t),$w=c(ja),qc=s(ja,"LI",{});var XT=n(qc);ur=s(XT,"A",{href:!0,rel:!0});var GT=n(ur);jw=i(GT,"Parallelization"),GT.forEach(t),XT.forEach(t),ja.forEach(t),Vw=c(He),Ie=s(He,"DIV",{class:!0});var Nt=n(Ie);g(gr.$$.fragment,Nt),Fw=c(Nt),Wo=s(Nt,"P",{});var Ui=n(Wo);Cw=i(Ui,"The "),Pc=s(Ui,"CODE",{});var JT=n(Pc);Ew=i(JT,"FlaxWav2Vec2PreTrainedModel"),JT.forEach(t),qw=i(Ui,"forward method, overrides the "),zc=s(Ui,"CODE",{});var ZT=n(zc);Pw=i(ZT,"__call__"),ZT.forEach(t),zw=i(Ui," special method."),Ui.forEach(t),Mw=c(Nt),g(_a.$$.fragment,Nt),Aw=c(Nt),Mc=s(Nt,"P",{});var KT=n(Mc);Ow=i(KT,"Example:"),KT.forEach(t),Lw=c(Nt),g(_r.$$.fragment,Nt),Nt.forEach(t),He.forEach(t),Ld=c(o),$o=s(o,"H2",{class:!0});var nm=n($o);va=s(nm,"A",{id:!0,class:!0,href:!0});var QT=n(va);Ac=s(QT,"SPAN",{});var YT=n(Ac);g(vr.$$.fragment,YT),YT.forEach(t),QT.forEach(t),Dw=c(nm),Oc=s(nm,"SPAN",{});var e1=n(Oc);Sw=i(e1,"FlaxWav2Vec2ForPreTraining"),e1.forEach(t),nm.forEach(t),Dd=c(o),Y=s(o,"DIV",{class:!0});var Xe=n(Y);g(wr.$$.fragment,Xe),Nw=c(Xe),jo=s(Xe,"P",{});var Ri=n(jo);Iw=i(Ri,"Wav2Vec2 Model with a quantizer and "),Lc=s(Ri,"CODE",{});var t1=n(Lc);Bw=i(t1,"VQ"),t1.forEach(t),Uw=i(Ri,` head on top.
Wav2Vec2 was proposed in `),br=s(Ri,"A",{href:!0,rel:!0});var o1=n(br);Rw=i(o1,`wav2vec 2.0: A Framework for Self-Supervised Learning of Speech
Representations`),o1.forEach(t),Hw=i(Ri,` by Alexei Baevski, Henry Zhou, Abdelrahman Mohamed, Michael
Auli.`),Ri.forEach(t),Xw=c(Xe),yr=s(Xe,"P",{});var rm=n(yr);Gw=i(rm,"This model inherits from "),Ti=s(rm,"A",{href:!0});var a1=n(Ti);Jw=i(a1,"FlaxPreTrainedModel"),a1.forEach(t),Zw=i(rm,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
