...
the latter silently ignores them.`)},l(T){m=r(T,"P",{});var _=i(m);F=n(_,"Although the recipe for forward pass needs to be defined within this function, one should call the "),g=r(_,"CODE",{});var A=i(g);f=n(A,"Module"),A.forEach(s),q=n(_,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),_.forEach(s)},m(T,_){c(T,m,_),e(m,F),e(m,g),e(g,f),e(m,q)},d(T){T&&s(m)}}}function n0(U){let m,F,g,f,q,T,_,A,_e,K,$,Y,O,Z,Te,I,be,ce,W,N,ee,se,z,x,oe,H,he,V,L,te,ve,C,we,Q,ae,ye,B,ke,re,P,je,G,ue,u,E,J,Fe,Ge,S,Ae,xe,Re,D,M,Ve,Ce,R,Ke,qe,Ee,Ye,fa,ph,ch,op,At,Gy,rp,$t,hh,bo,uh,mh,ip,_s,gh,_a,fh,_h,Ta,Th,bh,ba,vh,wh,lp,vo,yh,dp,Ts,Me,kh,Rr,jh,qh,wo,Eh,Fh,Vr,Ah,$h,va,zh,xh,Kr,Ch,Mh,Yr,Ph,Sh,Dh,Je,Nh,Jr,Lh,Qh,Xr,Oh,Ih,Zr,Wh,Uh,ei,Hh,Bh,wa,Gh,Rh,Vh,Vs,Kh,si,Yh,Jh,ti,Xh,Zh,eu,ai,su,pp,Ks,zt,ni,ya,tu,oi,au,cp,xt,nu,yo,ou,ru,hp,ko,ri,iu,up,Ct,lu,jo,du,pu,mp,zs,ii,cu,hu,ka,uu,li,mu,gu,fu,ja,_u,di,Tu,bu,gp,qo,vu,fp,Mt,pi,Ys,ci,hi,wu,yu,ui,mi,ku,ju,gi,fi,qu,Eu,Js,Xs,_i,Fu,Au,Ti,$u,zu,bi,xu,Cu,Zs,vi,Mu,Pu,wi,Su,Du,yi,Nu,Lu,et,ki,Qu,Ou,ji,Iu,Wu,qi,Uu,_p,xs,Hu,qa,Bu,Gu,Ea,Ru,Vu,Tp,Fa,bp,Cs,Ku,Eo,Yu,Ju,Fo,Xu,Zu,vp,Aa,wp,Pt,em,$a,sm,tm,yp,St,am,za,nm,om,kp,Ao,Ei,rm,jp,Dt,im,xa,lm,dm,qp,ie,$o,Fi,pm,cm,hm,zo,Ai,um,mm,gm,xo,$i,fm,_m,Tm,Co,zi,bm,vm,wm,Mo,xi,ym,km,jm,Po,Ci,qm,Em,Fm,So,Mi,Am,$m,zm,Do,Pi,xm,Cm,Mm,No,Si,Pm,Sm,Ep,We,Dm,Ca,Nm,Lm,Ma,Qm,Om,Di,Im,Wm,Ni,Um,Hm,Li,Bm,Gm,Fp,Lo,Qi,Rm,Ap,$e,Vm,Qo,Km,Ym,Oi,Jm,Xm,Ii,Zm,eg,Wi,sg,tg,Oo,ag,ng,Io,og,rg,$p,Nt,Ui,Pa,Hi,Bi,ig,lg,Gi,Ri,dg,pg,st,Sa,Vi,cg,hg,$s,Ki,ug,mg,Yi,gg,fg,Ji,_g,Tg,Xi,bg,vg,Da,Zi,wg,yg,Pe,el,kg,jg,sl,qg,Eg,tl,Fg,Ag,al,$g,zg,nl,xg,Cg,ol,Mg,Pg,rl,Sg,Dg,Na,il,Ng,Lg,ms,ll,Qg,Og,dl,Ig,Wg,pl,Ug,Hg,cl,Bg,Gg,hl,Rg,zp,de,Wo,Vg,Kg,ul,Yg,Jg,ml,Xg,Zg,gl,ef,sf,fl,tf,af,_l,nf,of,Tl,rf,lf,bl,df,pf,xp,La,Cp,bs,cf,Uo,hf,uf,vl,mf,gf,wl,ff,_f,Mp,Qa,Pp,X,Tf,yl,bf,vf,kl,wf,yf,jl,kf,jf,ql,qf,Ef,El,Ff,Af,Fl,$f,zf,Ho,xf,Cf,Oa,Mf,Pf,Ia,Sf,Df,Sp,Bo,Al,Nf,Dp,Ms,Lf,Go,Qf,Of,Ro,If,Wf,Np,Wa,Lp,tt,Lt,$l,Ua,Uf,zl,Hf,Qp,me,Bf,Vo,Gf,Rf,Ko,Vf,Kf,xl,Yf,Jf,Cl,Xf,Zf,Ml,e_,s_,Yo,t_,a_,Pl,n_,o_,Op,Qt,r_,Sl,i_,l_,Ip,Ha,Wp,Ue,d_,Dl,p_,c_,Nl,h_,u_,Ll,m_,g_,Ba,f_,__,Ga,T_,b_,Up,at,Ot,Ql,Ra,v_,Ol,w_,Hp,nt,Va,y_,Ka,k_,Jo,j_,q_,Bp,ot,It,Il,Ya,E_,Wl,F_,Gp,Xe,Ja,A_,gs,$_,Xo,z_,x_,Ul,C_,M_,Hl,P_,S_,Zo,D_,N_,L_,Xa,Q_,Za,O_,I_,W_,Bl,U_,H_,en,Rp,rt,Wt,Gl,sn,B_,Rl,G_,Vp,pe,tn,R_,Vl,V_,K_,ne,Y_,er,J_,X_,sr,Z_,eT,Kl,sT,tT,Yl,aT,nT,Jl,oT,rT,Xl,iT,lT,Zl,dT,pT,ed,cT,hT,sd,uT,mT,gT,Se,td,fT,_T,ad,TT,bT,nd,vT,wT,od,yT,kT,rd,jT,qT,id,ET,FT,ld,AT,$T,tr,ar,zT,xT,CT,Ut,an,MT,dd,PT,ST,Ps,nn,DT,on,NT,nr,LT,QT,OT,rn,IT,ln,WT,UT,HT,or,dn,Kp,it,Ht,pd,pn,BT,cd,GT,Yp,De,cn,RT,hn,VT,rr,KT,YT,JT,un,XT,mn,ZT,eb,sb,gn,tb,ir,ab,nb,ob,fn,rb,_n,ib,lb,db,ts,Tn,pb,lt,cb,lr,hb,ub,hd,mb,gb,fb,Bt,_b,ud,Tb,bb,bn,Jp,dt,Gt,md,vn,vb,gd,wb,Xp,fs,wn,yb,pt,kb,fd,jb,qb,dr,Eb,Fb,Ab,yn,$b,kn,zb,xb,Cb,as,jn,Mb,ct,Pb,pr,Sb,Db,_d,Nb,Lb,Qb,Rt,Ob,Td,Ib,Wb,qn,Zp,ht,Vt,bd,En,Ub,vd,Hb,ec,Ze,Fn,Bb,wd,Gb,Rb,An,Vb,cr,Kb,Yb,Jb,$n,Xb,zn,Zb,ev,sv,ns,xn,tv,ut,av,hr,nv,ov,yd,rv,iv,lv,Kt,dv,kd,pv,cv,Cn,sc,mt,Yt,jd,Mn,hv,qd,uv,tc,es,Pn,mv,gt,gv,Ed,fv,_v,Fd,Tv,bv,vv,Sn,wv,ur,yv,kv,jv,Dn,qv,Nn,Ev,Fv,Av,os,Ln,$v,ft,zv,mr,xv,Cv,Ad,Mv,Pv,Sv,Jt,Dv,$d,Nv,Lv,Qn,ac,_t,Xt,zd,On,Qv,xd,Ov,nc,Ne,In,Iv,Cd,Wv,Uv,Wn,Hv,gr,Bv,Gv,Rv,Un,Vv,Hn,Kv,Yv,Jv,Zt,Xv,rs,Bn,Zv,Tt,ew,fr,sw,tw,Md,aw,nw,ow,ea,rw,Pd,iw,lw,Gn,oc,bt,sa,Sd,Rn,dw,Dd,pw,rc,Le,Vn,cw,Kn,hw,Nd,uw,mw,gw,Yn,fw,_r,_w,Tw,bw,Jn,vw,Xn,ww,yw,kw,ta,jw,is,Zn,qw,vt,Ew,Tr,Fw,Aw,Ld,$w,zw,xw,aa,Cw,Qd,Mw,Pw,eo,ic,wt,na,Od,so,Sw,Id,Dw,lc,Qe,to,Nw,Wd,Lw,Qw,ao,Ow,br,Iw,Ww,Uw,no,Hw,oo,Bw,Gw,Rw,oa,Vw,ls,ro,Kw,yt,Yw,vr,Jw,Xw,Ud,Zw,ey,sy,ra,ty,Hd,ay,ny,io,dc,kt,ia,Bd,lo,oy,Gd,ry,pc,Oe,po,iy,jt,ly,Rd,dy,py,Vd,cy,hy,uy,co,my,wr,gy,fy,_y,ho,Ty,uo,by,vy,wy,la,yy,ds,mo,ky,qt,jy,yr,qy,Ey,Kd,Fy,Ay,$y,da,zy,Yd,xy,Cy,go,cc;return T=new ss({}),Z=new ss({}),ya=new ss({}),Fa=new Gr({props:{group1:{id:"pt",code:`from transformers import TapasConfig, TapasForQuestionAnswering
...
`}}),dn=new le({props:{name:"save_vocabulary",anchor:"transformers.TapasTokenizer.save_vocabulary",parameters:[{name:"save_directory",val:": str"},{name:"filename_prefix",val:": typing.Optional[str] = None"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/tapas/tokenization_tapas.py#L397"}}),pn=new ss({}),cn=new le({props:{name:"class transformers.TapasModel",anchor:"transformers.TapasModel",parameters:[{name:"config",val:""},{name:"add_pooling_layer",val:" = True"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/tapas/modeling_tapas.py#L856",parametersDescription:[{anchor:"transformers.TapasModel.config",description:`<strong>config</strong> (<a href="/docs/transformers/main/en/model_doc/tapas#transformers.TapasConfig">TapasConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/main/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),Tn=new le({props:{name:"forward",anchor:"transformers.TapasModel.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"encoder_hidden_states",val:" = None"},{name:"encoder_attention_mask",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/tapas/modeling_tapas.py#L894",parametersDescription:[{anchor:"transformers.TapasModel.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/main/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),jn=new le({props:{name:"forward",anchor:"transformers.TapasForMaskedLM.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"encoder_hidden_states",val:" = None"},{name:"encoder_attention_mask",val:" = None"},{name:"labels",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/tapas/modeling_tapas.py#L1028",parametersDescription:[{anchor:"transformers.TapasForMaskedLM.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. Indices can be obtained using <a href="/docs/transformers/main/en/model_doc/tapas#transformers.TapasTokenizer">TapasTokenizer</a>. See
<a href="/docs/transformers/main/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and <a href="/docs/transformers/main/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/main/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),xn=new le({props:{name:"forward",anchor:"transformers.TapasForSequenceClassification.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"labels",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/tapas/modeling_tapas.py#L1480",parametersDescription:[{anchor:"transformers.TapasForSequenceClassification.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. Indices can be obtained using <a href="/docs/transformers/main/en/model_doc/tapas#transformers.TapasTokenizer">TapasTokenizer</a>. See
<a href="/docs/transformers/main/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and <a href="/docs/transformers/main/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
<span class="hljs-meta">&gt;&gt;&gt; </span>logits_aggregation = outputs.logits_aggregation`}}),On=new ss({}),In=new le({props:{name:"class transformers.TFTapasModel",anchor:"transformers.TFTapasModel",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/tapas/modeling_tf_tapas.py#L976",parametersDescription:[{anchor:"transformers.TFTapasModel.config",description:`<strong>config</strong> (<a href="/docs/transformers/main/en/model_doc/tapas#transformers.TapasConfig">TapasConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/main/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),Zt=new As({props:{$$slots:{default:[Y2]},$$scope:{ctx:U}}}),Bn=new le({props:{name:"call",anchor:"transformers.TFTapasModel.call",parameters:[{name:"input_ids",val:": typing.Union[typing.List[tensorflow.python.framework.ops.Tensor], typing.List[numpy.ndarray], typing.List[tensorflow.python.keras.engine.keras_tensor.KerasTensor], typing.Dict[str, tensorflow.python.framework.ops.Tensor], typing.Dict[str, numpy.ndarray], typing.Dict[str, tensorflow.python.keras.engine.keras_tensor.KerasTensor], tensorflow.python.framework.ops.Tensor, numpy.ndarray, tensorflow.python.keras.engine.keras_tensor.KerasTensor, NoneType] = None"},{name:"attention_mask",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"token_type_ids",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"position_ids",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"head_mask",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"inputs_embeds",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"training",val:": typing.Optional[bool] = False"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/tapas/modeling_tf_tapas.py#L982",parametersDescription:[{anchor:"transformers.TFTapasModel.call.input_ids",description:`<strong>input_ids</strong> (<code>np.ndarray</code>, <code>tf.Tensor</code>, <code>List[tf.Tensor]</code> \`<code>Dict[str, tf.Tensor]</code> or <code>Dict[str, np.ndarray]</code> and each example must have the shape <code>(batch_size, sequence_length)</code>) &#x2014;
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),Rn=new ss({}),Vn=new le({props:{name:"class transformers.TFTapasForMaskedLM",anchor:"transformers.TFTapasForMaskedLM",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/tapas/modeling_tf_tapas.py#L1066",parametersDescription:[{anchor:"transformers.TFTapasForMaskedLM.config",description:`<strong>config</strong> (<a href="/docs/transformers/main/en/model_doc/tapas#transformers.TapasConfig">TapasConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/main/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),ta=new As({props:{$$slots:{default:[X2]},$$scope:{ctx:U}}}),Zn=new le({props:{name:"call",anchor:"transformers.TFTapasForMaskedLM.call",parameters:[{name:"input_ids",val:": typing.Union[typing.List[tensorflow.python.framework.ops.Tensor], typing.List[numpy.ndarray], typing.List[tensorflow.python.keras.engine.keras_tensor.KerasTensor], typing.Dict[str, tensorflow.python.framework.ops.Tensor], typing.Dict[str, numpy.ndarray], typing.Dict[str, tensorflow.python.keras.engine.keras_tensor.KerasTensor], tensorflow.python.framework.ops.Tensor, numpy.ndarray, tensorflow.python.keras.engine.keras_tensor.KerasTensor, NoneType] = None"},{name:"attention_mask",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"token_type_ids",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"position_ids",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"head_mask",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"inputs_embeds",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"labels",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"training",val:": typing.Optional[bool] = False"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/tapas/modeling_tf_tapas.py#L1082",parametersDescription:[{anchor:"transformers.TFTapasForMaskedLM.call.input_ids",description:`<strong>input_ids</strong> (<code>np.ndarray</code>, <code>tf.Tensor</code>, <code>List[tf.Tensor]</code> \`<code>Dict[str, tf.Tensor]</code> or <code>Dict[str, np.ndarray]</code> and each example must have the shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/main/en/model_doc/tapas#transformers.TapasTokenizer">TapasTokenizer</a>. See <a href="/docs/transformers/main/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
<a href="/docs/transformers/main/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> for details.</p>
...
<span class="hljs-meta">&gt;&gt;&gt; </span>outputs = model(**inputs, labels=labels)
<span class="hljs-meta">&gt;&gt;&gt; </span>logits = outputs.logits`}}),so=new ss({}),to=new le({props:{name:"class transformers.TFTapasForSequenceClassification",anchor:"transformers.TFTapasForSequenceClassification",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/tapas/modeling_tf_tapas.py#L1649",parametersDescription:[{anchor:"transformers.TFTapasForSequenceClassification.config",description:`<strong>config</strong> (<a href="/docs/transformers/main/en/model_doc/tapas#transformers.TapasConfig">TapasConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/main/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),oa=new As({props:{$$slots:{default:[e0]},$$scope:{ctx:U}}}),ro=new le({props:{name:"call",anchor:"transformers.TFTapasForSequenceClassification.call",parameters:[{name:"input_ids",val:": typing.Union[typing.List[tensorflow.python.framework.ops.Tensor], typing.List[numpy.ndarray], typing.List[tensorflow.python.keras.engine.keras_tensor.KerasTensor], typing.Dict[str, tensorflow.python.framework.ops.Tensor], typing.Dict[str, numpy.ndarray], typing.Dict[str, tensorflow.python.keras.engine.keras_tensor.KerasTensor], tensorflow.python.framework.ops.Tensor, numpy.ndarray, tensorflow.python.keras.engine.keras_tensor.KerasTensor, NoneType] = None"},{name:"attention_mask",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"token_type_ids",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"position_ids",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"head_mask",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"inputs_embeds",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"labels",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"training",val:": typing.Optional[bool] = False"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/tapas/modeling_tf_tapas.py#L1660",parametersDescription:[{anchor:"transformers.TFTapasForSequenceClassification.call.input_ids",description:`<strong>input_ids</strong> (<code>np.ndarray</code>, <code>tf.Tensor</code>, <code>List[tf.Tensor]</code> \`<code>Dict[str, tf.Tensor]</code> or <code>Dict[str, np.ndarray]</code> and each example must have the shape <code>(batch_size, num_choices, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/main/en/model_doc/tapas#transformers.TapasTokenizer">TapasTokenizer</a>. See <a href="/docs/transformers/main/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
<a href="/docs/transformers/main/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> for details.</p>
...
Llion Jones, Aidan N. Gomez, Lukasz Kaiser and Illia Polosukhin.`),db=l(),ts=o("div"),b(Tn.$$.fragment),pb=l(),lt=o("p"),cb=a("The "),lr=o("a"),hb=a("TapasModel"),ub=a(" forward method, overrides the "),hd=o("code"),mb=a("__call__"),gb=a(" special method."),fb=l(),b(Bt.$$.fragment),_b=l(),ud=o("p"),Tb=a("Examples:"),bb=l(),b(bn.$$.fragment),Jp=l(),dt=o("h2"),Gt=o("a"),md=o("span"),b(vn.$$.fragment),vb=l(),gd=o("span"),wb=a("TapasForMaskedLM"),Xp=l(),fs=o("div"),b(wn.$$.fragment),yb=l(),pt=o("p"),kb=a("Tapas Model with a "),fd=o("code"),jb=a("language modeling"),qb=a(` head on top.
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),sv=l(),ns=o("div"),b(xn.$$.fragment),tv=l(),ut=o("p"),av=a("The "),hr=o("a"),nv=a("TapasForSequenceClassification"),ov=a(" forward method, overrides the "),yd=o("code"),rv=a("__call__"),iv=a(" special method."),lv=l(),b(Kt.$$.fragment),dv=l(),kd=o("p"),pv=a("Examples:"),cv=l(),b(Cn.$$.fragment),sc=l(),mt=o("h2"),Yt=o("a"),jd=o("span"),b(Mn.$$.fragment),hv=l(),qd=o("span"),uv=a("TapasForQuestionAnswering"),tc=l(),es=o("div"),b(Pn.$$.fragment),mv=l(),gt=o("p"),gv=a(`Tapas Model with a cell selection head and optional aggregation head on top for question-answering tasks on tables
...
tokens, special tokens and padding.`),dq.forEach(s),bT=d(us),nd=r(us,"LI",{});var pq=i(nd);vT=n(pq,`row_ids: indicate to which row of the table a token belongs (starting from 1). Is 0 for all question tokens,
...
library implements for all its models (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Qc.forEach(s),JT=d(ks),un=r(ks,"P",{});var Oc=i(un);XT=n(Oc,"This model is also a PyTorch "),mn=r(Oc,"A",{href:!0,rel:!0});var jq=i(mn);ZT=n(jq,"torch.nn.Module"),jq.forEach(s),eb=n(Oc,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
...
Llion Jones, Aidan N. Gomez, Lukasz Kaiser and Illia Polosukhin.`),Wc.forEach(s),db=d(ks),ts=r(ks,"DIV",{class:!0});var Ls=i(ts);v(Tn.$$.fragment,Ls),pb=d(Ls),lt=r(Ls,"P",{});var Sr=i(lt);cb=n(Sr,"The "),lr=r(Sr,"A",{href:!0});var Fq=i(lr);hb=n(Fq,"TapasModel"),Fq.forEach(s),ub=n(Sr," forward method, overrides the "),hd=r(Sr,"CODE",{});var Aq=i(hd);mb=n(Aq,"__call__"),Aq.forEach(s),gb=n(Sr," special method."),Sr.forEach(s),fb=d(Ls),v(Bt.$$.fragment,Ls),_b=d(Ls),ud=r(Ls,"P",{});var $q=i(ud);Tb=n($q,"Examples:"),$q.forEach(s),bb=d(Ls),v(bn.$$.fragment,Ls),Ls.forEach(s),ks.forEach(s),Jp=d(t),dt=r(t,"H2",{class:!0});var Uc=i(dt);Gt=r(Uc,"A",{id:!0,class:!0,href:!0});var zq=i(Gt);md=r(zq,"SPAN",{});var xq=i(md);v(vn.$$.fragment,xq),xq.forEach(s),zq.forEach(s),vb=d(Uc),gd=r(Uc,"SPAN",{});var Cq=i(gd);wb=n(Cq,"TapasForMaskedLM"),Cq.forEach(s),Uc.forEach(s),Xp=d(t),fs=r(t,"DIV",{class:!0});var ga=i(fs);v(wn.$$.fragment,ga),yb=d(ga),pt=r(ga,"P",{});var Dr=i(pt);kb=n(Dr,"Tapas Model with a "),fd=r(Dr,"CODE",{});var Mq=i(fd);jb=n(Mq,"language modeling"),Mq.forEach(s),qb=n(Dr,` head on top.
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Rc.forEach(s),sv=d(Os),ns=r(Os,"DIV",{class:!0});var Is=i(ns);v(xn.$$.fragment,Is),tv=d(Is),ut=r(Is,"P",{});var Lr=i(ut);av=n(Lr,"The "),hr=r(Lr,"A",{href:!0});var Bq=i(hr);nv=n(Bq,"TapasForSequenceClassification"),Bq.forEach(s),ov=n(Lr," forward method, overrides the "),yd=r(Lr,"CODE",{});var Gq=i(yd);rv=n(Gq,"__call__"),Gq.forEach(s),iv=n(Lr," special method."),Lr.forEach(s),lv=d(Is),v(Kt.$$.fragment,Is),dv=d(Is),kd=r(Is,"P",{});var Rq=i(kd);pv=n(Rq,"Examples:"),Rq.forEach(s),cv=d(Is),v(Cn.$$.fragment,Is),Is.forEach(s),Os.forEach(s),sc=d(t),mt=r(t,"H2",{class:!0});var Vc=i(mt);Yt=r(Vc,"A",{id:!0,class:!0,href:!0});var Vq=i(Yt);jd=r(Vq,"SPAN",{});var Kq=i(jd);v(Mn.$$.fragment,Kq),Kq.forEach(s),Vq.forEach(s),hv=d(Vc),qd=r(Vc,"SPAN",{});var Yq=i(qd);uv=n(Yq,"TapasForQuestionAnswering"),Yq.forEach(s),Vc.forEach(s),tc=d(t),es=r(t,"DIV",{class:!0});var Ws=i(es);v(Pn.$$.fragment,Ws),mv=d(Ws),gt=r(Ws,"P",{});var Qr=i(gt);gv=n(Qr,`Tapas Model with a cell selection head and optional aggregation head on top for question-answering tasks on tables
...
SQA, WTQ or WikiSQL-supervised tasks.`),Qr.forEach(s),vv=d(Ws),Sn=r(Ws,"P",{});var Kc=i(Sn);wv=n(Kc,"This model inherits from "),ur=r(Kc,"A",{href:!0});var Zq=i(ur);yv=n(Zq,"PreTrainedModel"),Zq.forEach(s),kv=n(Kc,`. Check the superclass documentation for the generic methods the
library implements for all its models (such as downloading or saving, resizing the input embeddings, pruning heads
