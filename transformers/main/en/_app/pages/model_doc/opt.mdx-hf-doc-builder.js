import{S as Zd,i as Rd,s as Jd,e as n,k as h,w as v,t as a,M as Xd,c as s,d as t,m,a as i,x as k,h as r,b as f,G as e,g as _,y as w,q as $,o as P,B as O,v as Yd,L as Me}from"../../chunks/vendor-hf-doc-builder.js";import{T as Wn}from"../../chunks/Tip-hf-doc-builder.js";import{D as oe}from"../../chunks/Docstring-hf-doc-builder.js";import{C as Ee}from"../../chunks/CodeBlock-hf-doc-builder.js";import{I as at}from"../../chunks/IconCopyLink-hf-doc-builder.js";import{E as ze}from"../../chunks/ExampleCodeBlock-hf-doc-builder.js";function ec(x){let d,T,c,u,b;return u=new Ee({props:{code:`from transformers import OPTModel, OPTConfig
...
<span class="hljs-meta">&gt;&gt;&gt; </span>configuration = model.config`}}),{c(){d=n("p"),T=a("Example:"),c=h(),v(u.$$.fragment)},l(l){d=s(l,"P",{});var p=i(d);T=r(p,"Example:"),p.forEach(t),c=m(l),k(u.$$.fragment,l)},m(l,p){_(l,d,p),e(d,T),_(l,c,p),w(u,l,p),b=!0},p:Me,i(l){b||($(u.$$.fragment,l),b=!0)},o(l){P(u.$$.fragment,l),b=!1},d(l){l&&t(d),l&&t(c),O(u,l)}}}function tc(x){let d,T,c,u,b;return{c(){d=n("p"),T=a("Although the recipe for forward pass needs to be defined within this function, one should call the "),c=n("code"),u=a("Module"),b=a(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(l){d=s(l,"P",{});var p=i(d);T=r(p,"Although the recipe for forward pass needs to be defined within this function, one should call the "),c=s(p,"CODE",{});var E=i(c);u=r(E,"Module"),E.forEach(t),b=r(p,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),p.forEach(t)},m(l,p){_(l,d,p),e(d,T),e(d,c),e(c,u),e(d,b)},d(l){l&&t(d)}}}function oc(x){let d,T,c,u,b;return u=new Ee({props:{code:`from transformers import GPT2Tokenizer, OPTModel
import torch
...
<span class="hljs-string">&quot;Hey, are you consciours? Can you talk to me?\\nI&#x27;m not consciours, but I can talk to you.&quot;</span>`}}),{c(){d=n("p"),T=a("Example:"),c=h(),v(u.$$.fragment)},l(l){d=s(l,"P",{});var p=i(d);T=r(p,"Example:"),p.forEach(t),c=m(l),k(u.$$.fragment,l)},m(l,p){_(l,d,p),e(d,T),_(l,c,p),w(u,l,p),b=!0},p:Me,i(l){b||($(u.$$.fragment,l),b=!0)},o(l){P(u.$$.fragment,l),b=!1},d(l){l&&t(d),l&&t(c),O(u,l)}}}function sc(x){let d,T,c,u,b,l,p,E,De,Ce,L,ne,ae,F,We,J,Ge,qe,W,Be,re,ie,He,je,K,Ue,Le,V,ye,Qe,me,C,A,Ae,G,le,Ke,X,Ve,Ze,N,I,de,ve,Re,ce,ke,Je,Y,we,pe,Xe,se,S,Ye,B,j,et;return{c(){d=n("p"),T=a("TensorFlow models and layers in "),c=n("code"),u=a("transformers"),b=a(" accept two formats as input:"),l=h(),p=n("ul"),E=n("li"),De=a("having all inputs as keyword arguments (like PyTorch models), or"),Ce=h(),L=n("li"),ne=a("having all inputs as a list, tuple or dict in the first positional argument."),ae=h(),F=n("p"),We=a(`The reason the second format is supported is that Keras methods prefer this format when passing inputs to models
...
the Keras `),V=n("code"),ye=a("Functional"),Qe=a(` API, there are three possibilities you can use to gather all the input Tensors in the first
positional argument:`),me=h(),C=n("ul"),A=n("li"),Ae=a("a single Tensor with "),G=n("code"),le=a("input_ids"),Ke=a(" only and nothing else: "),X=n("code"),Ve=a("model(input_ids)"),Ze=h(),N=n("li"),I=a(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),de=n("code"),ve=a("model([input_ids, attention_mask])"),Re=a(" or "),ce=n("code"),ke=a("model([input_ids, attention_mask, token_type_ids])"),Je=h(),Y=n("li"),we=a(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
...
about any of this, as you can just pass inputs like you would to any other Python function!`),this.h()},l(y){d=s(y,"P",{});var z=i(d);T=r(z,"TensorFlow models and layers in "),c=s(z,"CODE",{});var ut=i(c);u=r(ut,"transformers"),ut.forEach(t),b=r(z," accept two formats as input:"),z.forEach(t),l=m(y),p=s(y,"UL",{});var ee=i(p);E=s(ee,"LI",{});var ht=i(E);De=r(ht,"having all inputs as keyword arguments (like PyTorch models), or"),ht.forEach(t),Ce=m(ee),L=s(ee,"LI",{});var mt=i(L);ne=r(mt,"having all inputs as a list, tuple or dict in the first positional argument."),mt.forEach(t),ee.forEach(t),ae=m(y),F=s(y,"P",{});var M=i(F);We=r(M,`The reason the second format is supported is that Keras methods prefer this format when passing inputs to models
and layers. Because of this support, when using methods like `),J=s(M,"CODE",{});var ft=i(J);Ge=r(ft,"model.fit()"),ft.forEach(t),qe=r(M,` things should \u201Cjust work\u201D for you - just
...
the Keras `),V=s(M,"CODE",{});var Tt=i(V);ye=r(Tt,"Functional"),Tt.forEach(t),Qe=r(M,` API, there are three possibilities you can use to gather all the input Tensors in the first
positional argument:`),M.forEach(t),me=m(y),C=s(y,"UL",{});var Z=i(C);A=s(Z,"LI",{});var D=i(A);Ae=r(D,"a single Tensor with "),G=s(D,"CODE",{});var fe=i(G);le=r(fe,"input_ids"),fe.forEach(t),Ke=r(D," only and nothing else: "),X=s(D,"CODE",{});var tt=i(X);Ve=r(tt,"model(input_ids)"),tt.forEach(t),D.forEach(t),Ze=m(Z),N=s(Z,"LI",{});var H=i(N);I=r(H,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),de=s(H,"CODE",{});var bt=i(de);ve=r(bt,"model([input_ids, attention_mask])"),bt.forEach(t),Re=r(H," or "),ce=s(H,"CODE",{});var ot=i(ce);ke=r(ot,"model([input_ids, attention_mask, token_type_ids])"),ot.forEach(t),H.forEach(t),Je=m(Z),Y=s(Z,"LI",{});var nt=i(Y);we=r(nt,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),pe=s(nt,"CODE",{});var rt=i(pe);Xe=r(rt,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),rt.forEach(t),nt.forEach(t),Z.forEach(t),se=m(y),S=s(y,"P",{});var q=i(S);Ye=r(q,`Note that when creating models and layers with
`),B=s(q,"A",{href:!0,rel:!0});var Pe=i(B);j=r(Pe,"subclassing"),Pe.forEach(t),et=r(q,` then you don\u2019t need to worry
about any of this, as you can just pass inputs like you would to any other Python function!`),q.forEach(t),this.h()},h(){f(B,"href","https://keras.io/guides/making_new_layers_and_models_via_subclassing/"),f(B,"rel","nofollow")},m(y,z){_(y,d,z),e(d,T),e(d,c),e(c,u),e(d,b),_(y,l,z),_(y,p,z),e(p,E),e(E,De),e(p,Ce),e(p,L),e(L,ne),_(y,ae,z),_(y,F,z),e(F,We),e(F,J),e(J,Ge),e(F,qe),e(F,W),e(W,Be),e(F,re),e(F,ie),e(ie,He),e(F,je),e(F,K),e(K,Ue),e(F,Le),e(F,V),e(V,ye),e(F,Qe),_(y,me,z),_(y,C,z),e(C,A),e(A,Ae),e(A,G),e(G,le),e(A,Ke),e(A,X),e(X,Ve),e(C,Ze),e(C,N),e(N,I),e(N,de),e(de,ve),e(N,Re),e(N,ce),e(ce,ke),e(C,Je),e(C,Y),e(Y,we),e(Y,pe),e(pe,Xe),_(y,se,z),_(y,S,z),e(S,Ye),e(S,B),e(B,j),e(S,et)},d(y){y&&t(d),y&&t(l),y&&t(p),y&&t(ae),y&&t(F),y&&t(me),y&&t(C),y&&t(se),y&&t(S)}}}function ac(x){let d,T,c,u,b;return{c(){d=n("p"),T=a("Although the recipe for forward pass needs to be defined within this function, one should call the "),c=n("code"),u=a("Module"),b=a(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(l){d=s(l,"P",{});var p=i(d);T=r(p,"Although the recipe for forward pass needs to be defined within this function, one should call the "),c=s(p,"CODE",{});var E=i(c);u=r(E,"Module"),E.forEach(t),b=r(p,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),p.forEach(t)},m(l,p){_(l,d,p),e(d,T),e(d,c),e(c,u),e(d,b)},d(l){l&&t(d)}}}function rc(x){let d,T,c,u,b;return u=new Ee({props:{code:`from transformers import GPT2Tokenizer, TFOPTModel
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),{c(){d=n("p"),T=a("Example:"),c=h(),v(u.$$.fragment)},l(l){d=s(l,"P",{});var p=i(d);T=r(p,"Example:"),p.forEach(t),c=m(l),k(u.$$.fragment,l)},m(l,p){_(l,d,p),e(d,T),_(l,c,p),w(u,l,p),b=!0},p:Me,i(l){b||($(u.$$.fragment,l),b=!0)},o(l){P(u.$$.fragment,l),b=!1},d(l){l&&t(d),l&&t(c),O(u,l)}}}function ic(x){let d,T,c,u,b,l,p,E,De,Ce,L,ne,ae,F,We,J,Ge,qe,W,Be,re,ie,He,je,K,Ue,Le,V,ye,Qe,me,C,A,Ae,G,le,Ke,X,Ve,Ze,N,I,de,ve,Re,ce,ke,Je,Y,we,pe,Xe,se,S,Ye,B,j,et;return{c(){d=n("p"),T=a("TensorFlow models and layers in "),c=n("code"),u=a("transformers"),b=a(" accept two formats as input:"),l=h(),p=n("ul"),E=n("li"),De=a("having all inputs as keyword arguments (like PyTorch models), or"),Ce=h(),L=n("li"),ne=a("having all inputs as a list, tuple or dict in the first positional argument."),ae=h(),F=n("p"),We=a(`The reason the second format is supported is that Keras methods prefer this format when passing inputs to models
and layers. Because of this support, when using methods like `),J=n("code"),Ge=a("model.fit()"),qe=a(` things should \u201Cjust work\u201D for you - just
pass your inputs and labels in any format that `),W=n("code"),Be=a("model.fit()"),re=a(` supports! If, however, you want to use the second
format outside of Keras methods like `),ie=n("code"),He=a("fit()"),je=a(" and "),K=n("code"),Ue=a("predict()"),Le=a(`, such as when creating your own layers or models with
the Keras `),V=n("code"),ye=a("Functional"),Qe=a(` API, there are three possibilities you can use to gather all the input Tensors in the first
...
`),pe=s(nt,"CODE",{});var rt=i(pe);Xe=r(rt,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),rt.forEach(t),nt.forEach(t),Z.forEach(t),se=m(y),S=s(y,"P",{});var q=i(S);Ye=r(q,`Note that when creating models and layers with
`),B=s(q,"A",{href:!0,rel:!0});var Pe=i(B);j=r(Pe,"subclassing"),Pe.forEach(t),et=r(q,` then you don\u2019t need to worry
about any of this, as you can just pass inputs like you would to any other Python function!`),q.forEach(t),this.h()},h(){f(B,"href","https://keras.io/guides/making_new_layers_and_models_via_subclassing/"),f(B,"rel","nofollow")},m(y,z){_(y,d,z),e(d,T),e(d,c),e(c,u),e(d,b),_(y,l,z),_(y,p,z),e(p,E),e(E,De),e(p,Ce),e(p,L),e(L,ne),_(y,ae,z),_(y,F,z),e(F,We),e(F,J),e(J,Ge),e(F,qe),e(F,W),e(W,Be),e(F,re),e(F,ie),e(ie,He),e(F,je),e(F,K),e(K,Ue),e(F,Le),e(F,V),e(V,ye),e(F,Qe),_(y,me,z),_(y,C,z),e(C,A),e(A,Ae),e(A,G),e(G,le),e(A,Ke),e(A,X),e(X,Ve),e(C,Ze),e(C,N),e(N,I),e(N,de),e(de,ve),e(N,Re),e(N,ce),e(ce,ke),e(C,Je),e(C,Y),e(Y,we),e(Y,pe),e(pe,Xe),_(y,se,z),_(y,S,z),e(S,Ye),e(S,B),e(B,j),e(S,et)},d(y){y&&t(d),y&&t(l),y&&t(p),y&&t(ae),y&&t(F),y&&t(me),y&&t(C),y&&t(se),y&&t(S)}}}function lc(x){let d,T,c,u,b;return u=new Ee({props:{code:`from transformers import GPT2Tokenizer, TFOPTForCausalLM
import tensorflow as tf
...
<span class="hljs-meta">&gt;&gt;&gt; </span>inputs = tokenizer(<span class="hljs-string">&quot;Hello, my dog is cute&quot;</span>, return_tensors=<span class="hljs-string">&quot;tf&quot;</span>)
<span class="hljs-meta">&gt;&gt;&gt; </span>outputs = model(inputs)
<span class="hljs-meta">&gt;&gt;&gt; </span>logits = outputs.logits`}}),{c(){d=n("p"),T=a("Example:"),c=h(),v(u.$$.fragment)},l(l){d=s(l,"P",{});var p=i(d);T=r(p,"Example:"),p.forEach(t),c=m(l),k(u.$$.fragment,l)},m(l,p){_(l,d,p),e(d,T),_(l,c,p),w(u,l,p),b=!0},p:Me,i(l){b||($(u.$$.fragment,l),b=!0)},o(l){P(u.$$.fragment,l),b=!1},d(l){l&&t(d),l&&t(c),O(u,l)}}}function dc(x){let d,T,c,u,b;return{c(){d=n("p"),T=a("Although the recipe for forward pass needs to be defined within this function, one should call the "),c=n("code"),u=a("Module"),b=a(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(l){d=s(l,"P",{});var p=i(d);T=r(p,"Although the recipe for forward pass needs to be defined within this function, one should call the "),c=s(p,"CODE",{});var E=i(c);u=r(E,"Module"),E.forEach(t),b=r(p,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),p.forEach(t)},m(l,p){_(l,d,p),e(d,T),e(d,c),e(c,u),e(d,b)},d(l){l&&t(d)}}}function cc(x){let d,T,c,u,b;return u=new Ee({props:{code:`import torch
...
<span class="hljs-number">1.71</span>`}}),{c(){v(d.$$.fragment)},l(c){k(d.$$.fragment,c)},m(c,u){w(d,c,u),T=!0},p:Me,i(c){T||($(d.$$.fragment,c),T=!0)},o(c){P(d.$$.fragment,c),T=!1},d(c){O(d,c)}}}function uc(x){let d,T,c,u,b;return u=new Ee({props:{code:`import torch
from transformers import GPT2Tokenizer, OPTForSequenceClassification
...
<span class="hljs-meta">&gt;&gt;&gt; </span>predicted_class_id = logits.argmax().item()
<span class="hljs-meta">&gt;&gt;&gt; </span>model.config.id2label[predicted_class_id]
<span class="hljs-string">&#x27;LABEL_0&#x27;</span>`}}),{c(){d=n("p"),T=a("Example of multi-label classification:"),c=h(),v(u.$$.fragment)},l(l){d=s(l,"P",{});var p=i(d);T=r(p,"Example of multi-label classification:"),p.forEach(t),c=m(l),k(u.$$.fragment,l)},m(l,p){_(l,d,p),e(d,T),_(l,c,p),w(u,l,p),b=!0},p:Me,i(l){b||($(u.$$.fragment,l),b=!0)},o(l){P(u.$$.fragment,l),b=!1},d(l){l&&t(d),l&&t(c),O(u,l)}}}function hc(x){let d,T;return d=new Ee({props:{code:`# To train a model on \`num_labels\` classes, you can pass \`num_labels=num_labels\` to \`.from_pretrained(...)\`
num_labels = len(model.config.id2label)
...
<span class="hljs-meta">... </span>)
<span class="hljs-meta">&gt;&gt;&gt; </span>loss = model(**inputs, labels=labels).loss
<span class="hljs-meta">&gt;&gt;&gt; </span>loss.backward()`}}),{c(){v(d.$$.fragment)},l(c){k(d.$$.fragment,c)},m(c,u){w(d,c,u),T=!0},p:Me,i(c){T||($(d.$$.fragment,c),T=!0)},o(c){P(d.$$.fragment,c),T=!1},d(c){O(d,c)}}}function mc(x){let d,T,c,u,b;return{c(){d=n("p"),T=a("Although the recipe for forward pass needs to be defined within this function, one should call the "),c=n("code"),u=a("Module"),b=a(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(l){d=s(l,"P",{});var p=i(d);T=r(p,"Although the recipe for forward pass needs to be defined within this function, one should call the "),c=s(p,"CODE",{});var E=i(c);u=r(E,"Module"),E.forEach(t),b=r(p,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),p.forEach(t)},m(l,p){_(l,d,p),e(d,T),e(d,c),e(c,u),e(d,b)},d(l){l&&t(d)}}}function fc(x){let d,T,c,u,b;return u=new Ee({props:{code:`from transformers import GPT2Tokenizer, OPTForQuestionAnswering
import torch
...
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-built_in">round</span>(loss.item(), <span class="hljs-number">2</span>)
<span class="hljs-number">7.41</span>`}}),{c(){v(d.$$.fragment)},l(c){k(d.$$.fragment,c)},m(c,u){w(d,c,u),T=!0},p:Me,i(c){T||($(d.$$.fragment,c),T=!0)},o(c){P(d.$$.fragment,c),T=!1},d(c){O(d,c)}}}function _c(x){let d,T,c,u,b;return u=new Ee({props:{code:`from transformers import GPT2Tokenizer, FlaxOPTModel
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),{c(){d=n("p"),T=a("Example:"),c=h(),v(u.$$.fragment)},l(l){d=s(l,"P",{});var p=i(d);T=r(p,"Example:"),p.forEach(t),c=m(l),k(u.$$.fragment,l)},m(l,p){_(l,d,p),e(d,T),_(l,c,p),w(u,l,p),b=!0},p:Me,i(l){b||($(u.$$.fragment,l),b=!0)},o(l){P(u.$$.fragment,l),b=!1},d(l){l&&t(d),l&&t(c),O(u,l)}}}function Tc(x){let d,T,c,u,b;return u=new Ee({props:{code:`from transformers import GPT2Tokenizer, FlaxOPTForCausalLM
...
<span class="hljs-meta">&gt;&gt;&gt; </span>next_token_logits = outputs.logits[:, -<span class="hljs-number">1</span>]`}}),{c(){d=n("p"),T=a("Example:"),c=h(),v(u.$$.fragment)},l(l){d=s(l,"P",{});var p=i(d);T=r(p,"Example:"),p.forEach(t),c=m(l),k(u.$$.fragment,l)},m(l,p){_(l,d,p),e(d,T),_(l,c,p),w(u,l,p),b=!0},p:Me,i(l){b||($(u.$$.fragment,l),b=!0)},o(l){P(u.$$.fragment,l),b=!1},d(l){l&&t(d),l&&t(c),O(u,l)}}}function bc(x){let d,T,c,u,b,l,p,E,De,Ce,L,ne,ae,F,We,J,Ge,qe,W,Be,re,ie,He,je,K,Ue,Le,V,ye,Qe,me,C,A,Ae,G,le,Ke,X,Ve,Ze,N,I,de,ve,Re,ce,ke,Je,Y,we,pe,Xe,se,S,Ye,B,j,et,y,z,ut,ee,ht,mt,M,ft,gt,$e,_t,Tt,Z,D,fe,tt,H,bt,ot,nt,rt,q,Pe,Pa,yt,Oa,bn,Fa,xa,yo,za,Ma,Ea,vt,Ca,yn,qa,ja,vn,La,Aa,Na,Nt,Ls,kt,It,Gn,vo,Ia,Bn,Sa,As,Oe,ko,Da,wo,Wa,kn,Ga,Ba,Ha,$o,Ua,Po,Qa,Ka,Va,Ne,Oo,Za,wt,Ra,wn,Ja,Xa,Hn,Ya,er,tr,St,or,Dt,Ns,$t,Wt,Un,Fo,nr,Qn,sr,Is,Pt,xo,ar,Gt,zo,rr,Bt,Ss,Ot,Ht,Kn,Mo,ir,Vn,lr,Ds,ue,Eo,dr,Co,cr,$n,pr,ur,hr,qo,mr,jo,fr,gr,_r,Ut,Tr,Ie,Lo,br,Ft,yr,Pn,vr,kr,Zn,wr,$r,Pr,Qt,Or,Kt,Ws,xt,Vt,Rn,Ao,Fr,Jn,xr,Gs,te,No,zr,Xn,Mr,Er,Io,Cr,On,qr,jr,Lr,So,Ar,Do,Nr,Ir,Sr,Zt,Dr,Rt,Wo,Wr,Jt,Bs,zt,Xt,Yn,Go,Gr,es,Br,Hs,U,Bo,Hr,ts,Ur,Qr,Fn,xn,Kr,Vr,Zr,Fe,Rr,os,Jr,Xr,ns,Yr,ei,ss,ti,oi,as,ni,si,ai,Ho,ri,zn,ii,li,di,Uo,ci,Qo,pi,ui,hi,R,Ko,mi,Mt,fi,Mn,gi,_i,rs,Ti,bi,yi,Yt,vi,eo,ki,to,wi,oo,$i,no,Us,Et,so,is,Vo,Pi,ls,Oi,Qs,he,Zo,Fi,Ct,xi,ds,zi,Mi,cs,Ei,Ci,qi,Ro,ji,En,Li,Ai,Ni,Jo,Ii,Xo,Si,Di,Wi,ge,Yo,Gi,qt,Bi,Cn,Hi,Ui,ps,Qi,Ki,Vi,ao,Zi,ro,Ri,io,Ks,jt,lo,us,en,Ji,hs,Xi,Vs,Lt,tn,Yi,co,on,el,po,Zs,At,uo,ms,nn,tl,fs,ol,Rs,Q,sn,nl,gs,sl,al,an,rl,qn,il,ll,dl,rn,cl,ln,pl,ul,hl,_s,ml,fl,st,Ts,dn,gl,_l,bs,cn,Tl,bl,ys,pn,yl,vl,vs,un,kl,wl,ho,hn,$l,mo,Js;return l=new at({}),F=new at({}),H=new at({}),Pe=new oe({props:{name:"class transformers.OPTConfig",anchor:"transformers.OPTConfig",parameters:[{name:"vocab_size",val:" = 50272"},{name:"hidden_size",val:" = 768"},{name:"num_hidden_layers",val:" = 12"},{name:"ffn_dim",val:" = 3072"},{name:"max_position_embeddings",val:" = 2048"},{name:"do_layer_norm_before",val:" = True"},{name:"_remove_final_layer_norm",val:" = False"},{name:"word_embed_proj_dim",val:" = None"},{name:"dropout",val:" = 0.1"},{name:"attention_dropout",val:" = 0.0"},{name:"num_attention_heads",val:" = 12"},{name:"activation_function",val:" = 'relu'"},{name:"layerdrop",val:" = 0.0"},{name:"init_std",val:" = 0.02"},{name:"use_cache",val:" = True"},{name:"pad_token_id",val:" = 1"},{name:"bos_token_id",val:" = 2"},{name:"eos_token_id",val:" = 2"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.OPTConfig.vocab_size",description:`<strong>vocab_size</strong> (<code>int</code>, <em>optional</em>, defaults to 50272) &#x2014;
...
Whether or not to return a <a href="/docs/transformers/main/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/opt/modeling_opt.py#L757",returnDescription:`
<p>A <a
...
Whether or not to return a <a href="/docs/transformers/main/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/opt/modeling_opt.py#L840",returnDescription:`
<p>A <a
...
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/opt/modeling_opt.py#L1020",returnDescription:`
...
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/opt/modeling_opt.py#L1142",returnDescription:`
<p>A <a
...
<p><a
  href="/docs/transformers/main/en/main_classes/output#transformers.modeling_flax_outputs.FlaxBaseModelOutput"
>transformers.modeling_flax_outputs.FlaxBaseModelOutput</a> or <code>tuple(torch.FloatTensor)</code></p>
`}}),mo=new ze({props:{anchor:"transformers.FlaxOPTForCausalLM.__call__.example",$$slots:{default:[Tc]},$$scope:{ctx:x}}}),{c(){d=n("meta"),T=h(),c=n("h1"),u=n("a"),b=n("span"),v(l.$$.fragment),p=h(),E=n("span"),De=a("OPT"),Ce=h(),L=n("h2"),ne=n("a"),ae=n("span"),v(F.$$.fragment),We=h(),J=n("span"),Ge=a("Overview"),qe=h(),W=n("p"),Be=a("The OPT model was proposed in "),re=n("a"),ie=a("Open Pre-trained Transformer Language Models"),He=a(` by Meta AI.
OPT is a series of open-sourced large causal language models which perform similar in performance to GPT3.`),je=h(),K=n("p"),Ue=a("The abstract from the paper is the following:"),Le=h(),V=n("p"),ye=n("em"),Qe=a("Large language models, which are often trained for hundreds of thousands of compute days, have shown remarkable capabilities for zero- and few-shot learning. Given their computational cost, these models are difficult to replicate without significant capital. For the few that are available through APIs, no access is granted to the full model weights, making them difficult to study. We present Open Pre-trained Transformers (OPT), a suite of decoder-only pre-trained transformers ranging from 125M to 175B parameters, which we aim to fully and responsibly share with interested researchers. We show that OPT-175B is comparable to GPT-3, while requiring only 1/7th the carbon footprint to develop. We are also releasing our logbook detailing the infrastructure challenges we faced, along with code for experimenting with all of the released models."),me=h(),C=n("p"),A=a("Tips:"),Ae=h(),G=n("ul"),le=n("li"),Ke=a("OPT has the same architecture as "),X=n("code"),Ve=a("BartDecoder"),Ze=a("."),N=h(),I=n("li"),de=a("Contrary to GPT2, OPT adds the EOS token "),ve=n("code"),Re=a("</s>"),ce=a(" to the beginning of every prompt. "),ke=n("strong"),Je=a("Note"),Y=a(": Make sure to pass "),we=n("code"),pe=a("use_fast=False"),Xe=a(" when loading OPT\u2019s tokenizer with "),se=n("a"),S=a("AutoTokenizer"),Ye=a(" to get the correct tokenizer."),B=h(),j=n("p"),et=a("This model was contributed by "),y=n("a"),z=a("Arthur Zucker"),ut=a(", "),ee=n("a"),ht=a("Younes Belkada"),mt=a(", and "),M=n("a"),ft=a("Patrick Von Platen"),gt=a(`.
The original code can be found `),$e=n("a"),_t=a("here"),Tt=a("."),Z=h(),D=n("h2"),fe=n("a"),tt=n("span"),v(H.$$.fragment),bt=h(),ot=n("span"),nt=a("OPTConfig"),rt=h(),q=n("div"),v(Pe.$$.fragment),Pa=h(),yt=n("p"),Oa=a("This is the configuration class to store the configuration of a "),bn=n("a"),Fa=a("OPTModel"),xa=a(`. It is used to instantiate a OPT model
according to the specified arguments, defining the model architecture. Instantiating a configuration with the
defaults will yield a similar configuration to that of the OPT
`),yo=n("a"),za=a("facebook/opt-350m"),Ma=a(" architecture."),Ea=h(),vt=n("p"),Ca=a("Configuration objects inherit from "),yn=n("a"),qa=a("PretrainedConfig"),ja=a(` and can be used to control the model outputs. Read the
documentation from `),vn=n("a"),La=a("PretrainedConfig"),Aa=a(" for more information."),Na=h(),v(Nt.$$.fragment),Ls=h(),kt=n("h2"),It=n("a"),Gn=n("span"),v(vo.$$.fragment),Ia=h(),Bn=n("span"),Sa=a("OPTModel"),As=h(),Oe=n("div"),v(ko.$$.fragment),Da=h(),wo=n("p"),Wa=a(`The bare OPT Model outputting raw hidden-states without any specific head on top.
...
and behavior.`),Va=h(),Ne=n("div"),v(Oo.$$.fragment),Za=h(),wt=n("p"),Ra=a("The "),wn=n("a"),Ja=a("OPTModel"),Xa=a(" forward method, overrides the "),Hn=n("code"),Ya=a("__call__"),er=a(" special method."),tr=h(),v(St.$$.fragment),or=h(),v(Dt.$$.fragment),Ns=h(),$t=n("h2"),Wt=n("a"),Un=n("span"),v(Fo.$$.fragment),nr=h(),Qn=n("span"),sr=a("OPTForCausalLM"),Is=h(),Pt=n("div"),v(xo.$$.fragment),ar=h(),Gt=n("div"),v(zo.$$.fragment),rr=h(),v(Bt.$$.fragment),Ss=h(),Ot=n("h2"),Ht=n("a"),Kn=n("span"),v(Mo.$$.fragment),ir=h(),Vn=n("span"),lr=a("TFOPTModel"),Ds=h(),ue=n("div"),v(Eo.$$.fragment),dr=h(),Co=n("p"),cr=a(`The bare TF OPT Model outputting raw hidden-states without any specific head on top.
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),hr=h(),qo=n("p"),mr=a("This model is also a "),jo=n("a"),fr=a("tf.keras.Model"),gr=a(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),_r=h(),v(Ut.$$.fragment),Tr=h(),Ie=n("div"),v(Lo.$$.fragment),br=h(),Ft=n("p"),yr=a("The "),Pn=n("a"),vr=a("TFOPTModel"),kr=a(" forward method, overrides the "),Zn=n("code"),wr=a("__call__"),$r=a(" special method."),Pr=h(),v(Qt.$$.fragment),Or=h(),v(Kt.$$.fragment),Ws=h(),xt=n("h2"),Vt=n("a"),Rn=n("span"),v(Ao.$$.fragment),Fr=h(),Jn=n("span"),xr=a("TFOPTForCausalLM"),Gs=h(),te=n("div"),v(No.$$.fragment),zr=h(),Xn=n("p"),Mr=a("The OPT Model transformer with a language modeling head on top."),Er=h(),Io=n("p"),Cr=a("This model inherits from "),On=n("a"),qr=a("TFPreTrainedModel"),jr=a(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Lr=h(),So=n("p"),Ar=a("This model is also a "),Do=n("a"),Nr=a("tf.keras.Model"),Ir=a(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Sr=h(),v(Zt.$$.fragment),Dr=h(),Rt=n("div"),v(Wo.$$.fragment),Wr=h(),v(Jt.$$.fragment),Bs=h(),zt=n("h2"),Xt=n("a"),Yn=n("span"),v(Go.$$.fragment),Gr=h(),es=n("span"),Br=a("OPTForSequenceClassification"),Hs=h(),U=n("div"),v(Bo.$$.fragment),Hr=h(),ts=n("p"),Ur=a("The OPT Model transformer with a sequence classification head on top (linear layer)."),Qr=h(),Fn=n("p"),xn=n("a"),Kr=a("OPTForSequenceClassification"),Vr=a(` uses the last token in order to do the classification, as other causal models
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),hi=h(),R=n("div"),v(Ko.$$.fragment),mi=h(),Mt=n("p"),fi=a("The "),Mn=n("a"),gi=a("OPTForSequenceClassification"),_i=a(" forward method, overrides the "),rs=n("code"),Ti=a("__call__"),bi=a(" special method."),yi=h(),v(Yt.$$.fragment),vi=h(),v(eo.$$.fragment),ki=h(),v(to.$$.fragment),wi=h(),v(oo.$$.fragment),$i=h(),v(no.$$.fragment),Us=h(),Et=n("h2"),so=n("a"),is=n("span"),v(Vo.$$.fragment),Pi=h(),ls=n("span"),Oi=a("OPTForQuestionAnswering"),Qs=h(),he=n("div"),v(Zo.$$.fragment),Fi=h(),Ct=n("p"),xi=a(`The OPT Model transformer with a span classification head on top for extractive question-answering tasks like SQuAD
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Wi=h(),ge=n("div"),v(Yo.$$.fragment),Gi=h(),qt=n("p"),Bi=a("The "),Cn=n("a"),Hi=a("OPTForQuestionAnswering"),Ui=a(" forward method, overrides the "),ps=n("code"),Qi=a("__call__"),Ki=a(" special method."),Vi=h(),v(ao.$$.fragment),Zi=h(),v(ro.$$.fragment),Ri=h(),v(io.$$.fragment),Ks=h(),jt=n("h2"),lo=n("a"),us=n("span"),v(en.$$.fragment),Ji=h(),hs=n("span"),Xi=a("FlaxOPTModel"),Vs=h(),Lt=n("div"),v(tn.$$.fragment),Yi=h(),co=n("div"),v(on.$$.fragment),el=h(),v(po.$$.fragment),Zs=h(),At=n("h2"),uo=n("a"),ms=n("span"),v(nn.$$.fragment),tl=h(),fs=n("span"),ol=a("FlaxOPTForCausalLM"),Rs=h(),Q=n("div"),v(sn.$$.fragment),nl=h(),gs=n("p"),sl=a(`OPT Model with a language modeling head on top (linear layer with weights tied to the input embeddings) e.g for
...
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),hl=h(),_s=n("p"),ml=a("Finally, this model supports inherent JAX features such as:"),fl=h(),st=n("ul"),Ts=n("li"),dn=n("a"),gl=a("Just-In-Time (JIT) compilation"),_l=h(),bs=n("li"),cn=n("a"),Tl=a("Automatic Differentiation"),bl=h(),ys=n("li"),pn=n("a"),yl=a("Vectorization"),vl=h(),vs=n("li"),un=n("a"),kl=a("Parallelization"),wl=h(),ho=n("div"),v(hn.$$.fragment),$l=h(),v(mo.$$.fragment),this.h()},l(o){const g=Xd('[data-svelte="svelte-1phssyn"]',document.head);d=s(g,"META",{name:!0,content:!0}),g.forEach(t),T=m(o),c=s(o,"H1",{class:!0});var mn=i(c);u=s(mn,"A",{id:!0,class:!0,href:!0});var ks=i(u);b=s(ks,"SPAN",{});var ws=i(b);k(l.$$.fragment,ws),ws.forEach(t),ks.forEach(t),p=m(mn),E=s(mn,"SPAN",{});var $s=i(E);De=r($s,"OPT"),$s.forEach(t),mn.forEach(t),Ce=m(o),L=s(o,"H2",{class:!0});var fn=i(L);ne=s(fn,"A",{id:!0,class:!0,href:!0});var Ps=i(ne);ae=s(Ps,"SPAN",{});var Os=i(ae);k(F.$$.fragment,Os),Os.forEach(t),Ps.forEach(t),We=m(fn),J=s(fn,"SPAN",{});var Fs=i(J);Ge=r(Fs,"Overview"),Fs.forEach(t),fn.forEach(t),qe=m(o),W=s(o,"P",{});var gn=i(W);Be=r(gn,"The OPT model was proposed in "),re=s(gn,"A",{href:!0,rel:!0});var xs=i(re);ie=r(xs,"Open Pre-trained Transformer Language Models"),xs.forEach(t),He=r(gn,` by Meta AI.
OPT is a series of open-sourced large causal language models which perform similar in performance to GPT3.`),gn.forEach(t),je=m(o),K=s(o,"P",{});var zs=i(K);Ue=r(zs,"The abstract from the paper is the following:"),zs.forEach(t),Le=m(o),V=s(o,"P",{});var Ms=i(V);ye=s(Ms,"EM",{});var Es=i(ye);Qe=r(Es,"Large language models, which are often trained for hundreds of thousands of compute days, have shown remarkable capabilities for zero- and few-shot learning. Given their computational cost, these models are difficult to replicate without significant capital. For the few that are available through APIs, no access is granted to the full model weights, making them difficult to study. We present Open Pre-trained Transformers (OPT), a suite of decoder-only pre-trained transformers ranging from 125M to 175B parameters, which we aim to fully and responsibly share with interested researchers. We show that OPT-175B is comparable to GPT-3, while requiring only 1/7th the carbon footprint to develop. We are also releasing our logbook detailing the infrastructure challenges we faced, along with code for experimenting with all of the released models."),Es.forEach(t),Ms.forEach(t),me=m(o),C=s(o,"P",{});var Cs=i(C);A=r(Cs,"Tips:"),Cs.forEach(t),Ae=m(o),G=s(o,"UL",{});var _n=i(G);le=s(_n,"LI",{});var Tn=i(le);Ke=r(Tn,"OPT has the same architecture as "),X=s(Tn,"CODE",{});var qs=i(X);Ve=r(qs,"BartDecoder"),qs.forEach(t),Ze=r(Tn,"."),Tn.forEach(t),N=m(_n),I=s(_n,"LI",{});var xe=i(I);de=r(xe,"Contrary to GPT2, OPT adds the EOS token "),ve=s(xe,"CODE",{});var js=i(ve);Re=r(js,"</s>"),js.forEach(t),ce=r(xe," to the beginning of every prompt. "),ke=s(xe,"STRONG",{});var Ol=i(ke);Je=r(Ol,"Note"),Ol.forEach(t),Y=r(xe,": Make sure to pass "),we=s(xe,"CODE",{});var Fl=i(we);pe=r(Fl,"use_fast=False"),Fl.forEach(t),Xe=r(xe," when loading OPT\u2019s tokenizer with "),se=s(xe,"A",{href:!0});var xl=i(se);S=r(xl,"AutoTokenizer"),xl.forEach(t),Ye=r(xe," to get the correct tokenizer."),xe.forEach(t),_n.forEach(t),B=m(o),j=s(o,"P",{});var it=i(j);et=r(it,"This model was contributed by "),y=s(it,"A",{href:!0,rel:!0});var zl=i(y);z=r(zl,"Arthur Zucker"),zl.forEach(t),ut=r(it,", "),ee=s(it,"A",{href:!0,rel:!0});var Ml=i(ee);ht=r(Ml,"Younes Belkada"),Ml.forEach(t),mt=r(it,", and "),M=s(it,"A",{href:!0,rel:!0});var El=i(M);ft=r(El,"Patrick Von Platen"),El.forEach(t),gt=r(it,`.
The original code can be found `),$e=s(it,"A",{href:!0,rel:!0});var Cl=i($e);_t=r(Cl,"here"),Cl.forEach(t),Tt=r(it,"."),it.forEach(t),Z=m(o),D=s(o,"H2",{class:!0});var Xs=i(D);fe=s(Xs,"A",{id:!0,class:!0,href:!0});var ql=i(fe);tt=s(ql,"SPAN",{});var jl=i(tt);k(H.$$.fragment,jl),jl.forEach(t),ql.forEach(t),bt=m(Xs),ot=s(Xs,"SPAN",{});var Ll=i(ot);nt=r(Ll,"OPTConfig"),Ll.forEach(t),Xs.forEach(t),rt=m(o),q=s(o,"DIV",{class:!0});var fo=i(q);k(Pe.$$.fragment,fo),Pa=m(fo),yt=s(fo,"P",{});var jn=i(yt);Oa=r(jn,"This is the configuration class to store the configuration of a "),bn=s(jn,"A",{href:!0});var Al=i(bn);Fa=r(Al,"OPTModel"),Al.forEach(t),xa=r(jn,`. It is used to instantiate a OPT model
according to the specified arguments, defining the model architecture. Instantiating a configuration with the
defaults will yield a similar configuration to that of the OPT
`),yo=s(jn,"A",{href:!0,rel:!0});var Nl=i(yo);za=r(Nl,"facebook/opt-350m"),Nl.forEach(t),Ma=r(jn," architecture."),jn.forEach(t),Ea=m(fo),vt=s(fo,"P",{});var Ln=i(vt);Ca=r(Ln,"Configuration objects inherit from "),yn=s(Ln,"A",{href:!0});var Il=i(yn);qa=r(Il,"PretrainedConfig"),Il.forEach(t),ja=r(Ln,` and can be used to control the model outputs. Read the
documentation from `),vn=s(Ln,"A",{href:!0});var Sl=i(vn);La=r(Sl,"PretrainedConfig"),Sl.forEach(t),Aa=r(Ln," for more information."),Ln.forEach(t),Na=m(fo),k(Nt.$$.fragment,fo),fo.forEach(t),Ls=m(o),kt=s(o,"H2",{class:!0});var Ys=i(kt);It=s(Ys,"A",{id:!0,class:!0,href:!0});var Dl=i(It);Gn=s(Dl,"SPAN",{});var Wl=i(Gn);k(vo.$$.fragment,Wl),Wl.forEach(t),Dl.forEach(t),Ia=m(Ys),Bn=s(Ys,"SPAN",{});var Gl=i(Bn);Sa=r(Gl,"OPTModel"),Gl.forEach(t),Ys.forEach(t),As=m(o),Oe=s(o,"DIV",{class:!0});var go=i(Oe);k(ko.$$.fragment,go),Da=m(go),wo=s(go,"P",{});var ea=i(wo);Wa=r(ea,`The bare OPT Model outputting raw hidden-states without any specific head on top.
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),ea.forEach(t),Ha=m(go),$o=s(go,"P",{});var ta=i($o);Ua=r(ta,"This model is also a PyTorch "),Po=s(ta,"A",{href:!0,rel:!0});var Hl=i(Po);Qa=r(Hl,"torch.nn.Module"),Hl.forEach(t),Ka=r(ta,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),ta.forEach(t),Va=m(go),Ne=s(go,"DIV",{class:!0});var _o=i(Ne);k(Oo.$$.fragment,_o),Za=m(_o),wt=s(_o,"P",{});var An=i(wt);Ra=r(An,"The "),wn=s(An,"A",{href:!0});var Ul=i(wn);Ja=r(Ul,"OPTModel"),Ul.forEach(t),Xa=r(An," forward method, overrides the "),Hn=s(An,"CODE",{});var Ql=i(Hn);Ya=r(Ql,"__call__"),Ql.forEach(t),er=r(An," special method."),An.forEach(t),tr=m(_o),k(St.$$.fragment,_o),or=m(_o),k(Dt.$$.fragment,_o),_o.forEach(t),go.forEach(t),Ns=m(o),$t=s(o,"H2",{class:!0});var oa=i($t);Wt=s(oa,"A",{id:!0,class:!0,href:!0});var Kl=i(Wt);Un=s(Kl,"SPAN",{});var Vl=i(Un);k(Fo.$$.fragment,Vl),Vl.forEach(t),Kl.forEach(t),nr=m(oa),Qn=s(oa,"SPAN",{});var Zl=i(Qn);sr=r(Zl,"OPTForCausalLM"),Zl.forEach(t),oa.forEach(t),Is=m(o),Pt=s(o,"DIV",{class:!0});var na=i(Pt);k(xo.$$.fragment,na),ar=m(na),Gt=s(na,"DIV",{class:!0});var sa=i(Gt);k(zo.$$.fragment,sa),rr=m(sa),k(Bt.$$.fragment,sa),sa.forEach(t),na.forEach(t),Ss=m(o),Ot=s(o,"H2",{class:!0});var aa=i(Ot);Ht=s(aa,"A",{id:!0,class:!0,href:!0});var Rl=i(Ht);Kn=s(Rl,"SPAN",{});var Jl=i(Kn);k(Mo.$$.fragment,Jl),Jl.forEach(t),Rl.forEach(t),ir=m(aa),Vn=s(aa,"SPAN",{});var Xl=i(Vn);lr=r(Xl,"TFOPTModel"),Xl.forEach(t),aa.forEach(t),Ds=m(o),ue=s(o,"DIV",{class:!0});var lt=i(ue);k(Eo.$$.fragment,lt),dr=m(lt),Co=s(lt,"P",{});var ra=i(Co);cr=r(ra,`The bare TF OPT Model outputting raw hidden-states without any specific head on top.
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),ra.forEach(t),hr=m(lt),qo=s(lt,"P",{});var ia=i(qo);mr=r(ia,"This model is also a "),jo=s(ia,"A",{href:!0,rel:!0});var ed=i(jo);fr=r(ed,"tf.keras.Model"),ed.forEach(t),gr=r(ia,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),ia.forEach(t),_r=m(lt),k(Ut.$$.fragment,lt),Tr=m(lt),Ie=s(lt,"DIV",{class:!0});var To=i(Ie);k(Lo.$$.fragment,To),br=m(To),Ft=s(To,"P",{});var Nn=i(Ft);yr=r(Nn,"The "),Pn=s(Nn,"A",{href:!0});var td=i(Pn);vr=r(td,"TFOPTModel"),td.forEach(t),kr=r(Nn," forward method, overrides the "),Zn=s(Nn,"CODE",{});var od=i(Zn);wr=r(od,"__call__"),od.forEach(t),$r=r(Nn," special method."),Nn.forEach(t),Pr=m(To),k(Qt.$$.fragment,To),Or=m(To),k(Kt.$$.fragment,To),To.forEach(t),lt.forEach(t),Ws=m(o),xt=s(o,"H2",{class:!0});var la=i(xt);Vt=s(la,"A",{id:!0,class:!0,href:!0});var nd=i(Vt);Rn=s(nd,"SPAN",{});var sd=i(Rn);k(Ao.$$.fragment,sd),sd.forEach(t),nd.forEach(t),Fr=m(la),Jn=s(la,"SPAN",{});var ad=i(Jn);xr=r(ad,"TFOPTForCausalLM"),ad.forEach(t),la.forEach(t),Gs=m(o),te=s(o,"DIV",{class:!0});var Se=i(te);k(No.$$.fragment,Se),zr=m(Se),Xn=s(Se,"P",{});var rd=i(Xn);Mr=r(rd,"The OPT Model transformer with a language modeling head on top."),rd.forEach(t),Er=m(Se),Io=s(Se,"P",{});var da=i(Io);Cr=r(da,"This model inherits from "),On=s(da,"A",{href:!0});var id=i(On);qr=r(id,"TFPreTrainedModel"),id.forEach(t),jr=r(da,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),da.forEach(t),Lr=m(Se),So=s(Se,"P",{});var ca=i(So);Ar=r(ca,"This model is also a "),Do=s(ca,"A",{href:!0,rel:!0});var ld=i(Do);Nr=r(ld,"tf.keras.Model"),ld.forEach(t),Ir=r(ca,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),ca.forEach(t),Sr=m(Se),k(Zt.$$.fragment,Se),Dr=m(Se),Rt=s(Se,"DIV",{class:!0});var pa=i(Rt);k(Wo.$$.fragment,pa),Wr=m(pa),k(Jt.$$.fragment,pa),pa.forEach(t),Se.forEach(t),Bs=m(o),zt=s(o,"H2",{class:!0});var ua=i(zt);Xt=s(ua,"A",{id:!0,class:!0,href:!0});var dd=i(Xt);Yn=s(dd,"SPAN",{});var cd=i(Yn);k(Go.$$.fragment,cd),cd.forEach(t),dd.forEach(t),Gr=m(ua),es=s(ua,"SPAN",{});var pd=i(es);Br=r(pd,"OPTForSequenceClassification"),pd.forEach(t),ua.forEach(t),Hs=m(o),U=s(o,"DIV",{class:!0});var _e=i(U);k(Bo.$$.fragment,_e),Hr=m(_e),ts=s(_e,"P",{});var ud=i(ts);Ur=r(ud,"The OPT Model transformer with a sequence classification head on top (linear layer)."),ud.forEach(t),Qr=m(_e),Fn=s(_e,"P",{});var Pl=i(Fn);xn=s(Pl,"A",{href:!0});var hd=i(xn);Kr=r(hd,"OPTForSequenceClassification"),hd.forEach(t),Vr=r(Pl,` uses the last token in order to do the classification, as other causal models
(e.g. GPT-2) do.`),Pl.forEach(t),Zr=m(_e),Fe=s(_e,"P",{});var dt=i(Fe);Rr=r(dt,`Since it does classification on the last token, it requires to know the position of the last token. If a
`),os=s(dt,"CODE",{});var md=i(os);Jr=r(md,"pad_token_id"),md.forEach(t),Xr=r(dt,` is defined in the configuration, it finds the last token that is not a padding token in each row. If
no `),ns=s(dt,"CODE",{});var fd=i(ns);Yr=r(fd,"pad_token_id"),fd.forEach(t),ei=r(dt,` is defined, it simply takes the last value in each row of the batch. Since it cannot guess the
...
each row of the batch).`),dt.forEach(t),ai=m(_e),Ho=s(_e,"P",{});var ha=i(Ho);ri=r(ha,"This model inherits from "),zn=s(ha,"A",{href:!0});var Td=i(zn);ii=r(Td,"PreTrainedModel"),Td.forEach(t),li=r(ha,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),ha.forEach(t),di=m(_e),Uo=s(_e,"P",{});var ma=i(Uo);ci=r(ma,"This model is also a PyTorch "),Qo=s(ma,"A",{href:!0,rel:!0});var bd=i(Qo);pi=r(bd,"torch.nn.Module"),bd.forEach(t),ui=r(ma,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),ma.forEach(t),hi=m(_e),R=s(_e,"DIV",{class:!0});var Te=i(R);k(Ko.$$.fragment,Te),mi=m(Te),Mt=s(Te,"P",{});var In=i(Mt);fi=r(In,"The "),Mn=s(In,"A",{href:!0});var yd=i(Mn);gi=r(yd,"OPTForSequenceClassification"),yd.forEach(t),_i=r(In," forward method, overrides the "),rs=s(In,"CODE",{});var vd=i(rs);Ti=r(vd,"__call__"),vd.forEach(t),bi=r(In," special method."),In.forEach(t),yi=m(Te),k(Yt.$$.fragment,Te),vi=m(Te),k(eo.$$.fragment,Te),ki=m(Te),k(to.$$.fragment,Te),wi=m(Te),k(oo.$$.fragment,Te),$i=m(Te),k(no.$$.fragment,Te),Te.forEach(t),_e.forEach(t),Us=m(o),Et=s(o,"H2",{class:!0});var fa=i(Et);so=s(fa,"A",{id:!0,class:!0,href:!0});var kd=i(so);is=s(kd,"SPAN",{});var wd=i(is);k(Vo.$$.fragment,wd),wd.forEach(t),kd.forEach(t),Pi=m(fa),ls=s(fa,"SPAN",{});var $d=i(ls);Oi=r($d,"OPTForQuestionAnswering"),$d.forEach(t),fa.forEach(t),Qs=m(o),he=s(o,"DIV",{class:!0});var ct=i(he);k(Zo.$$.fragment,ct),Fi=m(ct),Ct=s(ct,"P",{});var Sn=i(Ct);xi=r(Sn,`The OPT Model transformer with a span classification head on top for extractive question-answering tasks like SQuAD
(a linear layers on top of the hidden-states output to compute `),ds=s(Sn,"CODE",{});var Pd=i(ds);zi=r(Pd,"span start logits"),Pd.forEach(t),Mi=r(Sn," and "),cs=s(Sn,"CODE",{});var Od=i(cs);Ei=r(Od,"span end logits"),Od.forEach(t),Ci=r(Sn,")."),Sn.forEach(t),qi=m(ct),Ro=s(ct,"P",{});var ga=i(Ro);ji=r(ga,"This model inherits from "),En=s(ga,"A",{href:!0});var Fd=i(En);Li=r(Fd,"PreTrainedModel"),Fd.forEach(t),Ai=r(ga,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),ga.forEach(t),Ni=m(ct),Jo=s(ct,"P",{});var _a=i(Jo);Ii=r(_a,"This model is also a PyTorch "),Xo=s(_a,"A",{href:!0,rel:!0});var xd=i(Xo);Si=r(xd,"torch.nn.Module"),xd.forEach(t),Di=r(_a,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),_a.forEach(t),Wi=m(ct),ge=s(ct,"DIV",{class:!0});var pt=i(ge);k(Yo.$$.fragment,pt),Gi=m(pt),qt=s(pt,"P",{});var Dn=i(qt);Bi=r(Dn,"The "),Cn=s(Dn,"A",{href:!0});var zd=i(Cn);Hi=r(zd,"OPTForQuestionAnswering"),zd.forEach(t),Ui=r(Dn," forward method, overrides the "),ps=s(Dn,"CODE",{});var Md=i(ps);Qi=r(Md,"__call__"),Md.forEach(t),Ki=r(Dn," special method."),Dn.forEach(t),Vi=m(pt),k(ao.$$.fragment,pt),Zi=m(pt),k(ro.$$.fragment,pt),Ri=m(pt),k(io.$$.fragment,pt),pt.forEach(t),ct.forEach(t),Ks=m(o),jt=s(o,"H2",{class:!0});var Ta=i(jt);lo=s(Ta,"A",{id:!0,class:!0,href:!0});var Ed=i(lo);us=s(Ed,"SPAN",{});var Cd=i(us);k(en.$$.fragment,Cd),Cd.forEach(t),Ed.forEach(t),Ji=m(Ta),hs=s(Ta,"SPAN",{});var qd=i(hs);Xi=r(qd,"FlaxOPTModel"),qd.forEach(t),Ta.forEach(t),Vs=m(o),Lt=s(o,"DIV",{class:!0});var ba=i(Lt);k(tn.$$.fragment,ba),Yi=m(ba),co=s(ba,"DIV",{class:!0});var ya=i(co);k(on.$$.fragment,ya),el=m(ya),k(po.$$.fragment,ya),ya.forEach(t),ba.forEach(t),Zs=m(o),At=s(o,"H2",{class:!0});var va=i(At);uo=s(va,"A",{id:!0,class:!0,href:!0});var jd=i(uo);ms=s(jd,"SPAN",{});var Ld=i(ms);k(nn.$$.fragment,Ld),Ld.forEach(t),jd.forEach(t),tl=m(va),fs=s(va,"SPAN",{});var Ad=i(fs);ol=r(Ad,"FlaxOPTForCausalLM"),Ad.forEach(t),va.forEach(t),Rs=m(o),Q=s(o,"DIV",{class:!0});var be=i(Q);k(sn.$$.fragment,be),nl=m(be),gs=s(be,"P",{});var Nd=i(gs);sl=r(Nd,`OPT Model with a language modeling head on top (linear layer with weights tied to the input embeddings) e.g for
autoregressive tasks.`),Nd.forEach(t),al=m(be),an=s(be,"P",{});var ka=i(an);rl=r(ka,"This model inherits from "),qn=s(ka,"A",{href:!0});var Id=i(qn);il=r(Id,"FlaxPreTrainedModel"),Id.forEach(t),ll=r(ka,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),ka.forEach(t),dl=m(be),rn=s(be,"P",{});var wa=i(rn);cl=r(wa,`This model is also a Flax Linen
`),ln=s(wa,"A",{href:!0,rel:!0});var Sd=i(ln);pl=r(Sd,"flax.nn.Module"),Sd.forEach(t),ul=r(wa,` subclass. Use it as a
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),wa.forEach(t),hl=m(be),_s=s(be,"P",{});var Dd=i(_s);ml=r(Dd,"Finally, this model supports inherent JAX features such as:"),Dd.forEach(t),fl=m(be),st=s(be,"UL",{});var bo=i(st);Ts=s(bo,"LI",{});var Wd=i(Ts);dn=s(Wd,"A",{href:!0,rel:!0});var Gd=i(dn);gl=r(Gd,"Just-In-Time (JIT) compilation"),Gd.forEach(t),Wd.forEach(t),_l=m(bo),bs=s(bo,"LI",{});var Bd=i(bs);cn=s(Bd,"A",{href:!0,rel:!0});var Hd=i(cn);Tl=r(Hd,"Automatic Differentiation"),Hd.forEach(t),Bd.forEach(t),bl=m(bo),ys=s(bo,"LI",{});var Ud=i(ys);pn=s(Ud,"A",{href:!0,rel:!0});var Qd=i(pn);yl=r(Qd,"Vectorization"),Qd.forEach(t),Ud.forEach(t),vl=m(bo),vs=s(bo,"LI",{});var Kd=i(vs);un=s(Kd,"A",{href:!0,rel:!0});var Vd=i(un);kl=r(Vd,"Parallelization"),Vd.forEach(t),Kd.forEach(t),bo.forEach(t),wl=m(be),ho=s(be,"DIV",{class:!0});var $a=i(ho);k(hn.$$.fragment,$a),$l=m($a),k(mo.$$.fragment,$a),$a.forEach(t),be.forEach(t),this.h()},h(){f(d,"name","hf:doc:metadata"),f(d,"content",JSON.stringify(yc)),f(u,"id","opt"),f(u,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),f(u,"href","#opt"),f(c,"class","relative group"),f(ne,"id","overview"),f(ne,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),f(ne,"href","#overview"),f(L,"class","relative group"),f(re,"href","https://arxiv.org/pdf/2205.01068"),f(re,"rel","nofollow"),f(se,"href","/docs/transformers/main/en/model_doc/auto#transformers.AutoTokenizer"),f(y,"href","https://huggingface.co/ArthurZ"),f(y,"rel","nofollow"),f(ee,"href","https://huggingface.co/ybelkada"),f(ee,"rel","nofollow"),f(M,"href","https://huggingface.co/patrickvonplaten"),f(M,"rel","nofollow"),f($e,"href","https://github.com/facebookresearch/metaseq"),f($e,"rel","nofollow"),f(fe,"id","transformers.OPTConfig"),f(fe,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),f(fe,"href","#transformers.OPTConfig"),f(D,"class","relative group"),f(bn,"href","/docs/transformers/main/en/model_doc/opt#transformers.OPTModel"),f(yo,"href","https://huggingface.co/facebook/opt-350m"),f(yo,"rel","nofollow"),f(yn,"href","/docs/transformers/main/en/main_classes/configuration#transformers.PretrainedConfig"),f(vn,"href","/docs/transformers/main/en/main_classes/configuration#transformers.PretrainedConfig"),f(q,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),f(It,"id","transformers.OPTModel"),f(It,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),f(It,"href","#transformers.OPTModel"),f(kt,"class","relative group"),f(kn,"href","/docs/transformers/main/en/main_classes/model#transformers.PreTrainedModel"),f(Po,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),f(Po,"rel","nofollow"),f(wn,"href","/docs/transformers/main/en/model_doc/opt#transformers.OPTModel"),f(Ne,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),f(Oe,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),f(Wt,"id","transformers.OPTForCausalLM"),f(Wt,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),f(Wt,"href","#transformers.OPTForCausalLM"),f($t,"class","relative group"),f(Gt,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),f(Pt,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),f(Ht,"id","transformers.TFOPTModel"),f(Ht,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),f(Ht,"href","#transformers.TFOPTModel"),f(Ot,"class","relative group"),f($n,"href","/docs/transformers/main/en/main_classes/model#transformers.TFPreTrainedModel"),f(jo,"href","https://www.tensorflow.org/api_docs/python/tf/keras/Model"),f(jo,"rel","nofollow"),f(Pn,"href","/docs/transformers/main/en/model_doc/opt#transformers.TFOPTModel"),f(Ie,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),f(ue,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),f(Vt,"id","transformers.TFOPTForCausalLM"),f(Vt,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),f(Vt,"href","#transformers.TFOPTForCausalLM"),f(xt,"class","relative group"),f(On,"href","/docs/transformers/main/en/main_classes/model#transformers.TFPreTrainedModel"),f(Do,"href","https://www.tensorflow.org/api_docs/python/tf/keras/Model"),f(Do,"rel","nofollow"),f(Rt,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),f(te,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),f(Xt,"id","transformers.OPTForSequenceClassification"),f(Xt,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),f(Xt,"href","#transformers.OPTForSequenceClassification"),f(zt,"class","relative group"),f(xn,"href","/docs/transformers/main/en/model_doc/opt#transformers.OPTForSequenceClassification"),f(zn,"href","/docs/transformers/main/en/main_classes/model#transformers.PreTrainedModel"),f(Qo,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),f(Qo,"rel","nofollow"),f(Mn,"href","/docs/transformers/main/en/model_doc/opt#transformers.OPTForSequenceClassification"),f(R,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),f(U,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),f(so,"id","transformers.OPTForQuestionAnswering"),f(so,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),f(so,"href","#transformers.OPTForQuestionAnswering"),f(Et,"class","relative group"),f(En,"href","/docs/transformers/main/en/main_classes/model#transformers.PreTrainedModel"),f(Xo,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),f(Xo,"rel","nofollow"),f(Cn,"href","/docs/transformers/main/en/model_doc/opt#transformers.OPTForQuestionAnswering"),f(ge,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),f(he,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),f(lo,"id","transformers.FlaxOPTModel"),f(lo,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),f(lo,"href","#transformers.FlaxOPTModel"),f(jt,"class","relative group"),f(co,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),f(Lt,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),f(uo,"id","transformers.FlaxOPTForCausalLM"),f(uo,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),f(uo,"href","#transformers.FlaxOPTForCausalLM"),f(At,"class","relative group"),f(qn,"href","/docs/transformers/main/en/main_classes/model#transformers.FlaxPreTrainedModel"),f(ln,"href","https://flax.readthedocs.io/en/latest/_autosummary/flax.nn.module.html"),f(ln,"rel","nofollow"),f(dn,"href","https://jax.readthedocs.io/en/latest/jax.html#just-in-time-compilation-jit"),f(dn,"rel","nofollow"),f(cn,"href","https://jax.readthedocs.io/en/latest/jax.html#automatic-differentiation"),f(cn,"rel","nofollow"),f(pn,"href","https://jax.readthedocs.io/en/latest/jax.html#vectorization-vmap"),f(pn,"rel","nofollow"),f(un,"href","https://jax.readthedocs.io/en/latest/jax.html#parallelization-pmap"),f(un,"rel","nofollow"),f(ho,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),f(Q,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8")},m(o,g){e(document.head,d),_(o,T,g),_(o,c,g),e(c,u),e(u,b),w(l,b,null),e(c,p),e(c,E),e(E,De),_(o,Ce,g),_(o,L,g),e(L,ne),e(ne,ae),w(F,ae,null),e(L,We),e(L,J),e(J,Ge),_(o,qe,g),_(o,W,g),e(W,Be),e(W,re),e(re,ie),e(W,He),_(o,je,g),_(o,K,g),e(K,Ue),_(o,Le,g),_(o,V,g),e(V,ye),e(ye,Qe),_(o,me,g),_(o,C,g),e(C,A),_(o,Ae,g),_(o,G,g),e(G,le),e(le,Ke),e(le,X),e(X,Ve),e(le,Ze),e(G,N),e(G,I),e(I,de),e(I,ve),e(ve,Re),e(I,ce),e(I,ke),e(ke,Je),e(I,Y),e(I,we),e(we,pe),e(I,Xe),e(I,se),e(se,S),e(I,Ye),_(o,B,g),_(o,j,g),e(j,et),e(j,y),e(y,z),e(j,ut),e(j,ee),e(ee,ht),e(j,mt),e(j,M),e(M,ft),e(j,gt),e(j,$e),e($e,_t),e(j,Tt),_(o,Z,g),_(o,D,g),e(D,fe),e(fe,tt),w(H,tt,null),e(D,bt),e(D,ot),e(ot,nt),_(o,rt,g),_(o,q,g),w(Pe,q,null),e(q,Pa),e(q,yt),e(yt,Oa),e(yt,bn),e(bn,Fa),e(yt,xa),e(yt,yo),e(yo,za),e(yt,Ma),e(q,Ea),e(q,vt),e(vt,Ca),e(vt,yn),e(yn,qa),e(vt,ja),e(vt,vn),e(vn,La),e(vt,Aa),e(q,Na),w(Nt,q,null),_(o,Ls,g),_(o,kt,g),e(kt,It),e(It,Gn),w(vo,Gn,null),e(kt,Ia),e(kt,Bn),e(Bn,Sa),_(o,As,g),_(o,Oe,g),w(ko,Oe,null),e(Oe,Da),e(Oe,wo),e(wo,Wa),e(wo,kn),e(kn,Ga),e(wo,Ba),e(Oe,Ha),e(Oe,$o),e($o,Ua),e($o,Po),e(Po,Qa),e($o,Ka),e(Oe,Va),e(Oe,Ne),w(Oo,Ne,null),e(Ne,Za),e(Ne,wt),e(wt,Ra),e(wt,wn),e(wn,Ja),e(wt,Xa),e(wt,Hn),e(Hn,Ya),e(wt,er),e(Ne,tr),w(St,Ne,null),e(Ne,or),w(Dt,Ne,null),_(o,Ns,g),_(o,$t,g),e($t,Wt),e(Wt,Un),w(Fo,Un,null),e($t,nr),e($t,Qn),e(Qn,sr),_(o,Is,g),_(o,Pt,g),w(xo,Pt,null),e(Pt,ar),e(Pt,Gt),w(zo,Gt,null),e(Gt,rr),w(Bt,Gt,null),_(o,Ss,g),_(o,Ot,g),e(Ot,Ht),e(Ht,Kn),w(Mo,Kn,null),e(Ot,ir),e(Ot,Vn),e(Vn,lr),_(o,Ds,g),_(o,ue,g),w(Eo,ue,null),e(ue,dr),e(ue,Co),e(Co,cr),e(Co,$n),e($n,pr),e(Co,ur),e(ue,hr),e(ue,qo),e(qo,mr),e(qo,jo),e(jo,fr),e(qo,gr),e(ue,_r),w(Ut,ue,null),e(ue,Tr),e(ue,Ie),w(Lo,Ie,null),e(Ie,br),e(Ie,Ft),e(Ft,yr),e(Ft,Pn),e(Pn,vr),e(Ft,kr),e(Ft,Zn),e(Zn,wr),e(Ft,$r),e(Ie,Pr),w(Qt,Ie,null),e(Ie,Or),w(Kt,Ie,null),_(o,Ws,g),_(o,xt,g),e(xt,Vt),e(Vt,Rn),w(Ao,Rn,null),e(xt,Fr),e(xt,Jn),e(Jn,xr),_(o,Gs,g),_(o,te,g),w(No,te,null),e(te,zr),e(te,Xn),e(Xn,Mr),e(te,Er),e(te,Io),e(Io,Cr),e(Io,On),e(On,qr),e(Io,jr),e(te,Lr),e(te,So),e(So,Ar),e(So,Do),e(Do,Nr),e(So,Ir),e(te,Sr),w(Zt,te,null),e(te,Dr),e(te,Rt),w(Wo,Rt,null),e(Rt,Wr),w(Jt,Rt,null),_(o,Bs,g),_(o,zt,g),e(zt,Xt),e(Xt,Yn),w(Go,Yn,null),e(zt,Gr),e(zt,es),e(es,Br),_(o,Hs,g),_(o,U,g),w(Bo,U,null),e(U,Hr),e(U,ts),e(ts,Ur),e(U,Qr),e(U,Fn),e(Fn,xn),e(xn,Kr),e(Fn,Vr),e(U,Zr),e(U,Fe),e(Fe,Rr),e(Fe,os),e(os,Jr),e(Fe,Xr),e(Fe,ns),e(ns,Yr),e(Fe,ei),e(Fe,ss),e(ss,ti),e(Fe,oi),e(Fe,as),e(as,ni),e(Fe,si),e(U,ai),e(U,Ho),e(Ho,ri),e(Ho,zn),e(zn,ii),e(Ho,li),e(U,di),e(U,Uo),e(Uo,ci),e(Uo,Qo),e(Qo,pi),e(Uo,ui),e(U,hi),e(U,R),w(Ko,R,null),e(R,mi),e(R,Mt),e(Mt,fi),e(Mt,Mn),e(Mn,gi),e(Mt,_i),e(Mt,rs),e(rs,Ti),e(Mt,bi),e(R,yi),w(Yt,R,null),e(R,vi),w(eo,R,null),e(R,ki),w(to,R,null),e(R,wi),w(oo,R,null),e(R,$i),w(no,R,null),_(o,Us,g),_(o,Et,g),e(Et,so),e(so,is),w(Vo,is,null),e(Et,Pi),e(Et,ls),e(ls,Oi),_(o,Qs,g),_(o,he,g),w(Zo,he,null),e(he,Fi),e(he,Ct),e(Ct,xi),e(Ct,ds),e(ds,zi),e(Ct,Mi),e(Ct,cs),e(cs,Ei),e(Ct,Ci),e(he,qi),e(he,Ro),e(Ro,ji),e(Ro,En),e(En,Li),e(Ro,Ai),e(he,Ni),e(he,Jo),e(Jo,Ii),e(Jo,Xo),e(Xo,Si),e(Jo,Di),e(he,Wi),e(he,ge),w(Yo,ge,null),e(ge,Gi),e(ge,qt),e(qt,Bi),e(qt,Cn),e(Cn,Hi),e(qt,Ui),e(qt,ps),e(ps,Qi),e(qt,Ki),e(ge,Vi),w(ao,ge,null),e(ge,Zi),w(ro,ge,null),e(ge,Ri),w(io,ge,null),_(o,Ks,g),_(o,jt,g),e(jt,lo),e(lo,us),w(en,us,null),e(jt,Ji),e(jt,hs),e(hs,Xi),_(o,Vs,g),_(o,Lt,g),w(tn,Lt,null),e(Lt,Yi),e(Lt,co),w(on,co,null),e(co,el),w(po,co,null),_(o,Zs,g),_(o,At,g),e(At,uo),e(uo,ms),w(nn,ms,null),e(At,tl),e(At,fs),e(fs,ol),_(o,Rs,g),_(o,Q,g),w(sn,Q,null),e(Q,nl),e(Q,gs),e(gs,sl),e(Q,al),e(Q,an),e(an,rl),e(an,qn),e(qn,il),e(an,ll),e(Q,dl),e(Q,rn),e(rn,cl),e(rn,ln),e(ln,pl),e(rn,ul),e(Q,hl),e(Q,_s),e(_s,ml),e(Q,fl),e(Q,st),e(st,Ts),e(Ts,dn),e(dn,gl),e(st,_l),e(st,bs),e(bs,cn),e(cn,Tl),e(st,bl),e(st,ys),e(ys,pn),e(pn,yl),e(st,vl),e(st,vs),e(vs,un),e(un,kl),e(Q,wl),e(Q,ho),w(hn,ho,null),e(ho,$l),w(mo,ho,null),Js=!0},p(o,[g]){const mn={};g&2&&(mn.$$scope={dirty:g,ctx:o}),Nt.$set(mn);const ks={};g&2&&(ks.$$scope={dirty:g,ctx:o}),St.$set(ks);const ws={};g&2&&(ws.$$scope={dirty:g,ctx:o}),Dt.$set(ws);const $s={};g&2&&($s.$$scope={dirty:g,ctx:o}),Bt.$set($s);const fn={};g&2&&(fn.$$scope={dirty:g,ctx:o}),Ut.$set(fn);const Ps={};g&2&&(Ps.$$scope={dirty:g,ctx:o}),Qt.$set(Ps);const Os={};g&2&&(Os.$$scope={dirty:g,ctx:o}),Kt.$set(Os);const Fs={};g&2&&(Fs.$$scope={dirty:g,ctx:o}),Zt.$set(Fs);const gn={};g&2&&(gn.$$scope={dirty:g,ctx:o}),Jt.$set(gn);const xs={};g&2&&(xs.$$scope={dirty:g,ctx:o}),Yt.$set(xs);const zs={};g&2&&(zs.$$scope={dirty:g,ctx:o}),eo.$set(zs);const Ms={};g&2&&(Ms.$$scope={dirty:g,ctx:o}),to.$set(Ms);const Es={};g&2&&(Es.$$scope={dirty:g,ctx:o}),oo.$set(Es);const Cs={};g&2&&(Cs.$$scope={dirty:g,ctx:o}),no.$set(Cs);const _n={};g&2&&(_n.$$scope={dirty:g,ctx:o}),ao.$set(_n);const Tn={};g&2&&(Tn.$$scope={dirty:g,ctx:o}),ro.$set(Tn);const qs={};g&2&&(qs.$$scope={dirty:g,ctx:o}),io.$set(qs);const xe={};g&2&&(xe.$$scope={dirty:g,ctx:o}),po.$set(xe);const js={};g&2&&(js.$$scope={dirty:g,ctx:o}),mo.$set(js)},i(o){Js||($(l.$$.fragment,o),$(F.$$.fragment,o),$(H.$$.fragment,o),$(Pe.$$.fragment,o),$(Nt.$$.fragment,o),$(vo.$$.fragment,o),$(ko.$$.fragment,o),$(Oo.$$.fragment,o),$(St.$$.fragment,o),$(Dt.$$.fragment,o),$(Fo.$$.fragment,o),$(xo.$$.fragment,o),$(zo.$$.fragment,o),$(Bt.$$.fragment,o),$(Mo.$$.fragment,o),$(Eo.$$.fragment,o),$(Ut.$$.fragment,o),$(Lo.$$.fragment,o),$(Qt.$$.fragment,o),$(Kt.$$.fragment,o),$(Ao.$$.fragment,o),$(No.$$.fragment,o),$(Zt.$$.fragment,o),$(Wo.$$.fragment,o),$(Jt.$$.fragment,o),$(Go.$$.fragment,o),$(Bo.$$.fragment,o),$(Ko.$$.fragment,o),$(Yt.$$.fragment,o),$(eo.$$.fragment,o),$(to.$$.fragment,o),$(oo.$$.fragment,o),$(no.$$.fragment,o),$(Vo.$$.fragment,o),$(Zo.$$.fragment,o),$(Yo.$$.fragment,o),$(ao.$$.fragment,o),$(ro.$$.fragment,o),$(io.$$.fragment,o),$(en.$$.fragment,o),$(tn.$$.fragment,o),$(on.$$.fragment,o),$(po.$$.fragment,o),$(nn.$$.fragment,o),$(sn.$$.fragment,o),$(hn.$$.fragment,o),$(mo.$$.fragment,o),Js=!0)},o(o){P(l.$$.fragment,o),P(F.$$.fragment,o),P(H.$$.fragment,o),P(Pe.$$.fragment,o),P(Nt.$$.fragment,o),P(vo.$$.fragment,o),P(ko.$$.fragment,o),P(Oo.$$.fragment,o),P(St.$$.fragment,o),P(Dt.$$.fragment,o),P(Fo.$$.fragment,o),P(xo.$$.fragment,o),P(zo.$$.fragment,o),P(Bt.$$.fragment,o),P(Mo.$$.fragment,o),P(Eo.$$.fragment,o),P(Ut.$$.fragment,o),P(Lo.$$.fragment,o),P(Qt.$$.fragment,o),P(Kt.$$.fragment,o),P(Ao.$$.fragment,o),P(No.$$.fragment,o),P(Zt.$$.fragment,o),P(Wo.$$.fragment,o),P(Jt.$$.fragment,o),P(Go.$$.fragment,o),P(Bo.$$.fragment,o),P(Ko.$$.fragment,o),P(Yt.$$.fragment,o),P(eo.$$.fragment,o),P(to.$$.fragment,o),P(oo.$$.fragment,o),P(no.$$.fragment,o),P(Vo.$$.fragment,o),P(Zo.$$.fragment,o),P(Yo.$$.fragment,o),P(ao.$$.fragment,o),P(ro.$$.fragment,o),P(io.$$.fragment,o),P(en.$$.fragment,o),P(tn.$$.fragment,o),P(on.$$.fragment,o),P(po.$$.fragment,o),P(nn.$$.fragment,o),P(sn.$$.fragment,o),P(hn.$$.fragment,o),P(mo.$$.fragment,o),Js=!1},d(o){t(d),o&&t(T),o&&t(c),O(l),o&&t(Ce),o&&t(L),O(F),o&&t(qe),o&&t(W),o&&t(je),o&&t(K),o&&t(Le),o&&t(V),o&&t(me),o&&t(C),o&&t(Ae),o&&t(G),o&&t(B),o&&t(j),o&&t(Z),o&&t(D),O(H),o&&t(rt),o&&t(q),O(Pe),O(Nt),o&&t(Ls),o&&t(kt),O(vo),o&&t(As),o&&t(Oe),O(ko),O(Oo),O(St),O(Dt),o&&t(Ns),o&&t($t),O(Fo),o&&t(Is),o&&t(Pt),O(xo),O(zo),O(Bt),o&&t(Ss),o&&t(Ot),O(Mo),o&&t(Ds),o&&t(ue),O(Eo),O(Ut),O(Lo),O(Qt),O(Kt),o&&t(Ws),o&&t(xt),O(Ao),o&&t(Gs),o&&t(te),O(No),O(Zt),O(Wo),O(Jt),o&&t(Bs),o&&t(zt),O(Go),o&&t(Hs),o&&t(U),O(Bo),O(Ko),O(Yt),O(eo),O(to),O(oo),O(no),o&&t(Us),o&&t(Et),O(Vo),o&&t(Qs),o&&t(he),O(Zo),O(Yo),O(ao),O(ro),O(io),o&&t(Ks),o&&t(jt),O(en),o&&t(Vs),o&&t(Lt),O(tn),O(on),O(po),o&&t(Zs),o&&t(At),O(nn),o&&t(Rs),o&&t(Q),O(sn),O(hn),O(mo)}}}const yc={local:"opt",sections:[{local:"overview",title:"Overview"},{local:"transformers.OPTConfig",title:"OPTConfig"},{local:"transformers.OPTModel",title:"OPTModel"},{local:"transformers.OPTForCausalLM",title:"OPTForCausalLM"},{local:"transformers.TFOPTModel",title:"TFOPTModel"},{local:"transformers.TFOPTForCausalLM",title:"TFOPTForCausalLM"},{local:"transformers.OPTForSequenceClassification",title:"OPTForSequenceClassification"},{local:"transformers.OPTForQuestionAnswering",title:"OPTForQuestionAnswering"},{local:"transformers.FlaxOPTModel",title:"FlaxOPTModel"},{local:"transformers.FlaxOPTForCausalLM",title:"FlaxOPTForCausalLM"}],title:"OPT"};function vc(x){return Yd(()=>{new URLSearchParams(window.location.search).get("fw")}),[]}class xc extends Zd{constructor(d){super();Rd(this,d,vc,bc,Jd,{})}}export{xc as default,yc as metadata};
