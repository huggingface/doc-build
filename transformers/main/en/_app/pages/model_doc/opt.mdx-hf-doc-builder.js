...
the Keras `),V=n("code"),ye=a("Functional"),Ue=a(` API, there are three possibilities you can use to gather all the input Tensors in the first
...
the Keras `),V=s(M,"CODE",{});var _t=i(V);ye=r(_t,"Functional"),_t.forEach(t),Ue=r(M,` API, there are three possibilities you can use to gather all the input Tensors in the first
...
about any of this, as you can just pass inputs like you would to any other Python function!`),q.forEach(t),this.h()},h(){f(B,"href","https://keras.io/guides/making_new_layers_and_models_via_subclassing/"),f(B,"rel","nofollow")},m(b,z){g(b,d,z),e(d,y),e(d,m),e(m,h),e(d,T),g(b,l,z),g(b,c,z),e(c,E),e(E,De),e(c,xe),e(c,L),e(L,ne),g(b,ae,z),g(b,F,z),e(F,We),e(F,J),e(J,Ge),e(F,ze),e(F,W),e(W,Be),e(F,re),e(F,ie),e(ie,He),e(F,Me),e(F,K),e(K,Qe),e(F,Ee),e(F,V),e(V,ye),e(F,Ue),g(b,me,z),g(b,C,z),e(C,A),e(A,Ce),e(A,G),e(G,le),e(A,Ke),e(A,X),e(X,Ve),e(C,Ze),e(C,N),e(N,I),e(N,de),e(de,be),e(N,Re),e(N,ce),e(ce,ve),e(C,Je),e(C,Y),e(Y,ke),e(Y,pe),e(pe,Xe),g(b,se,z),g(b,S,z),e(S,Ye),e(S,B),e(B,j),e(S,et)},d(b){b&&t(d),b&&t(l),b&&t(c),b&&t(ae),b&&t(F),b&&t(me),b&&t(C),b&&t(se),b&&t(S)}}}function nc(x){let d,y,m,h,T;return{c(){d=n("p"),y=a("Although the recipe for forward pass needs to be defined within this function, one should call the "),m=n("code"),h=a("Module"),T=a(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(l){d=s(l,"P",{});var c=i(d);y=r(c,"Although the recipe for forward pass needs to be defined within this function, one should call the "),m=s(c,"CODE",{});var E=i(m);h=r(E,"Module"),E.forEach(t),T=r(c,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
<span class="hljs-meta">&gt;&gt;&gt; </span>next_token_logits = outputs.logits[:, -<span class="hljs-number">1</span>]`}}),{c(){d=n("p"),y=a("Example:"),m=p(),v(h.$$.fragment)},l(l){d=s(l,"P",{});var c=i(d);y=r(c,"Example:"),c.forEach(t),m=u(l),k(h.$$.fragment,l)},m(l,c){g(l,d,c),e(d,y),g(l,m,c),w(h,l,c),T=!0},p:Ie,i(l){T||(P(h.$$.fragment,l),T=!0)},o(l){$(h.$$.fragment,l),T=!1},d(l){l&&t(d),l&&t(m),O(h,l)}}}function gc(x){let d,y,m,h,T,l,c,E,De,xe,L,ne,ae,F,We,J,Ge,ze,W,Be,re,ie,He,Me,K,Qe,Ee,V,ye,Ue,me,C,A,Ce,G,le,Ke,X,Ve,Ze,N,I,de,be,Re,ce,ve,Je,Y,ke,pe,Xe,se,S,Ye,B,j,et,b,z,pt,ee,ut,ht,M,mt,ft,we,gt,_t,Z,D,fe,tt,H,Tt,ot,nt,rt,q,Pe,wa,yt,Pa,Tn,$a,Oa,yo,Fa,xa,za,bt,Ma,yn,Ea,Ca,bn,qa,ja,La,At,qs,vt,Nt,Wn,bo,Aa,Gn,Na,js,$e,vo,Ia,ko,Sa,vn,Da,Wa,Ga,wo,Ba,Po,Ha,Qa,Ua,qe,$o,Ka,kt,Va,kn,Za,Ra,Bn,Ja,Xa,Ya,It,er,St,Ls,wt,Dt,Hn,Oo,tr,Qn,or,As,Pt,Fo,nr,Wt,xo,sr,Gt,Ns,$t,Bt,Un,zo,ar,Kn,rr,Is,ue,Mo,ir,Eo,lr,wn,dr,cr,pr,Co,ur,qo,hr,mr,fr,Ht,gr,je,jo,_r,Ot,Tr,Pn,yr,br,Vn,vr,kr,wr,Qt,Pr,Ut,Ss,Ft,Kt,Zn,Lo,$r,Rn,Or,Ds,te,Ao,Fr,Jn,xr,zr,No,Mr,$n,Er,Cr,qr,Io,jr,So,Lr,Ar,Nr,Vt,Ir,Zt,Do,Sr,Rt,Ws,xt,Jt,Xn,Wo,Dr,Yn,Wr,Gs,Q,Go,Gr,es,Br,Hr,On,Fn,Qr,Ur,Kr,Oe,Vr,ts,Zr,Rr,os,Jr,Xr,ns,Yr,ei,ss,ti,oi,ni,Bo,si,xn,ai,ri,ii,Ho,li,Qo,di,ci,pi,R,Uo,ui,zt,hi,zn,mi,fi,as,gi,_i,Ti,Xt,yi,Yt,bi,eo,vi,to,ki,oo,Bs,Mt,no,rs,Ko,wi,is,Pi,Hs,he,Vo,$i,Et,Oi,ls,Fi,xi,ds,zi,Mi,Ei,Zo,Ci,Mn,qi,ji,Li,Ro,Ai,Jo,Ni,Ii,Si,Le,Xo,Di,Ct,Wi,En,Gi,Bi,cs,Hi,Qi,Ui,so,Ki,ao,Qs,qt,ro,ps,Yo,Vi,us,Zi,Us,jt,en,Ri,io,tn,Ji,lo,Ks,Lt,co,hs,on,Xi,ms,Yi,Vs,U,nn,el,fs,tl,ol,sn,nl,Cn,sl,al,rl,an,il,rn,ll,dl,cl,gs,pl,ul,st,_s,ln,hl,ml,Ts,dn,fl,gl,ys,cn,_l,Tl,bs,pn,yl,bl,po,un,vl,uo,Zs;return l=new at({}),F=new at({}),H=new at({}),Pe=new oe({props:{name:"class transformers.OPTConfig",anchor:"transformers.OPTConfig",parameters:[{name:"vocab_size",val:" = 50272"},{name:"hidden_size",val:" = 768"},{name:"num_hidden_layers",val:" = 12"},{name:"ffn_dim",val:" = 3072"},{name:"max_position_embeddings",val:" = 2048"},{name:"do_layer_norm_before",val:" = True"},{name:"_remove_final_layer_norm",val:" = False"},{name:"word_embed_proj_dim",val:" = None"},{name:"dropout",val:" = 0.1"},{name:"attention_dropout",val:" = 0.0"},{name:"num_attention_heads",val:" = 12"},{name:"activation_function",val:" = 'relu'"},{name:"layerdrop",val:" = 0.0"},{name:"init_std",val:" = 0.02"},{name:"use_cache",val:" = True"},{name:"pad_token_id",val:" = 1"},{name:"bos_token_id",val:" = 2"},{name:"eos_token_id",val:" = 2"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.OPTConfig.vocab_size",description:`<strong>vocab_size</strong> (<code>int</code>, <em>optional</em>, defaults to 50272) &#x2014;
...
<p><a
  href="/docs/transformers/main/en/main_classes/output#transformers.modeling_flax_outputs.FlaxBaseModelOutput"
>transformers.modeling_flax_outputs.FlaxBaseModelOutput</a> or <code>tuple(torch.FloatTensor)</code></p>
`}}),uo=new Ne({props:{anchor:"transformers.FlaxOPTForCausalLM.__call__.example",$$slots:{default:[fc]},$$scope:{ctx:x}}}),{c(){d=n("meta"),y=p(),m=n("h1"),h=n("a"),T=n("span"),v(l.$$.fragment),c=p(),E=n("span"),De=a("OPT"),xe=p(),L=n("h2"),ne=n("a"),ae=n("span"),v(F.$$.fragment),We=p(),J=n("span"),Ge=a("Overview"),ze=p(),W=n("p"),Be=a("The OPT model was proposed in "),re=n("a"),ie=a("Open Pre-trained Transformer Language Models"),He=a(` by Meta AI.
OPT is a series of open-sourced large causal language models which perform similar in performance to GPT3.`),Me=p(),K=n("p"),Qe=a("The abstract from the paper is the following:"),Ee=p(),V=n("p"),ye=n("em"),Ue=a("Large language models, which are often trained for hundreds of thousands of compute days, have shown remarkable capabilities for zero- and few-shot learning. Given their computational cost, these models are difficult to replicate without significant capital. For the few that are available through APIs, no access is granted to the full model weights, making them difficult to study. We present Open Pre-trained Transformers (OPT), a suite of decoder-only pre-trained transformers ranging from 125M to 175B parameters, which we aim to fully and responsibly share with interested researchers. We show that OPT-175B is comparable to GPT-3, while requiring only 1/7th the carbon footprint to develop. We are also releasing our logbook detailing the infrastructure challenges we faced, along with code for experimenting with all of the released models."),me=p(),C=n("p"),A=a("Tips:"),Ce=p(),G=n("ul"),le=n("li"),Ke=a("OPT has the same architecture as "),X=n("code"),Ve=a("BartDecoder"),Ze=a("."),N=p(),I=n("li"),de=a("Contrary to GPT2, OPT adds the EOS token "),be=n("code"),Re=a("</s>"),ce=a(" to the beginning of every prompt. "),ve=n("strong"),Je=a("Note"),Y=a(": Make sure to pass "),ke=n("code"),pe=a("use_fast=False"),Xe=a(" when loading OPT\u2019s tokenizer with "),se=n("a"),S=a("AutoTokenizer"),Ye=a(" to get the correct tokenizer."),B=p(),j=n("p"),et=a("This model was contributed by "),b=n("a"),z=a("Arthur Zucker"),pt=a(", "),ee=n("a"),ut=a("Younes Belkada"),ht=a(", and "),M=n("a"),mt=a("Patrick Von Platen"),ft=a(`.
The original code can be found `),we=n("a"),gt=a("here"),_t=a("."),Z=p(),D=n("h2"),fe=n("a"),tt=n("span"),v(H.$$.fragment),Tt=p(),ot=n("span"),nt=a("OPTConfig"),rt=p(),q=n("div"),v(Pe.$$.fragment),wa=p(),yt=n("p"),Pa=a("This is the configuration class to store the configuration of a "),Tn=n("a"),$a=a("OPTModel"),Oa=a(`. It is used to instantiate a OPT model
...
and behavior.`),Ua=p(),qe=n("div"),v($o.$$.fragment),Ka=p(),kt=n("p"),Va=a("The "),kn=n("a"),Za=a("OPTModel"),Ra=a(" forward method, overrides the "),Bn=n("code"),Ja=a("__call__"),Xa=a(" special method."),Ya=p(),v(It.$$.fragment),er=p(),v(St.$$.fragment),Ls=p(),wt=n("h2"),Dt=n("a"),Hn=n("span"),v(Oo.$$.fragment),tr=p(),Qn=n("span"),or=a("OPTForCausalLM"),As=p(),Pt=n("div"),v(Fo.$$.fragment),nr=p(),Wt=n("div"),v(xo.$$.fragment),sr=p(),v(Gt.$$.fragment),Ns=p(),$t=n("h2"),Bt=n("a"),Un=n("span"),v(zo.$$.fragment),ar=p(),Kn=n("span"),rr=a("TFOPTModel"),Is=p(),ue=n("div"),v(Mo.$$.fragment),ir=p(),Eo=n("p"),lr=a(`The bare TF OPT Model outputting raw hidden-states without any specific head on top.
...
behavior.`),fr=p(),v(Ht.$$.fragment),gr=p(),je=n("div"),v(jo.$$.fragment),_r=p(),Ot=n("p"),Tr=a("The "),Pn=n("a"),yr=a("TFOPTModel"),br=a(" forward method, overrides the "),Vn=n("code"),vr=a("__call__"),kr=a(" special method."),wr=p(),v(Qt.$$.fragment),Pr=p(),v(Ut.$$.fragment),Ss=p(),Ft=n("h2"),Kt=n("a"),Zn=n("span"),v(Lo.$$.fragment),$r=p(),Rn=n("span"),Or=a("TFOPTForCausalLM"),Ds=p(),te=n("div"),v(Ao.$$.fragment),Fr=p(),Jn=n("p"),xr=a("The OPT Model transformer with a language modeling head on top."),zr=p(),No=n("p"),Mr=a("This model inherits from "),$n=n("a"),Er=a("TFPreTrainedModel"),Cr=a(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),qr=p(),Io=n("p"),jr=a("This model is also a "),So=n("a"),Lr=a("tf.keras.Model"),Ar=a(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Nr=p(),v(Vt.$$.fragment),Ir=p(),Zt=n("div"),v(Do.$$.fragment),Sr=p(),v(Rt.$$.fragment),Ws=p(),xt=n("h2"),Jt=n("a"),Xn=n("span"),v(Wo.$$.fragment),Dr=p(),Yn=n("span"),Wr=a("OPTForSequenceClassification"),Gs=p(),Q=n("div"),v(Go.$$.fragment),Gr=p(),es=n("p"),Br=a("The OPT Model transformer with a sequence classification head on top (linear layer)."),Hr=p(),On=n("p"),Fn=n("a"),Qr=a("OPTForSequenceClassification"),Ur=a(` uses the last token in order to do the classification, as other causal models
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),pi=p(),R=n("div"),v(Uo.$$.fragment),ui=p(),zt=n("p"),hi=a("The "),zn=n("a"),mi=a("OPTForSequenceClassification"),fi=a(" forward method, overrides the "),as=n("code"),gi=a("__call__"),_i=a(" special method."),Ti=p(),v(Xt.$$.fragment),yi=p(),v(Yt.$$.fragment),bi=p(),v(eo.$$.fragment),vi=p(),v(to.$$.fragment),ki=p(),v(oo.$$.fragment),Bs=p(),Mt=n("h2"),no=n("a"),rs=n("span"),v(Ko.$$.fragment),wi=p(),is=n("span"),Pi=a("OPTForQuestionAnswering"),Hs=p(),he=n("div"),v(Vo.$$.fragment),$i=p(),Et=n("p"),Oi=a(`The OPT Model transformer with a span classification head on top for extractive question-answering tasks like SQuAD
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Si=p(),Le=n("div"),v(Xo.$$.fragment),Di=p(),Ct=n("p"),Wi=a("The "),En=n("a"),Gi=a("OPTForQuestionAnswering"),Bi=a(" forward method, overrides the "),cs=n("code"),Hi=a("__call__"),Qi=a(" special method."),Ui=p(),v(so.$$.fragment),Ki=p(),v(ao.$$.fragment),Qs=p(),qt=n("h2"),ro=n("a"),ps=n("span"),v(Yo.$$.fragment),Vi=p(),us=n("span"),Zi=a("FlaxOPTModel"),Us=p(),jt=n("div"),v(en.$$.fragment),Ri=p(),io=n("div"),v(tn.$$.fragment),Ji=p(),v(lo.$$.fragment),Ks=p(),Lt=n("h2"),co=n("a"),hs=n("span"),v(on.$$.fragment),Xi=p(),ms=n("span"),Yi=a("FlaxOPTForCausalLM"),Vs=p(),U=n("div"),v(nn.$$.fragment),el=p(),fs=n("p"),tl=a(`OPT Model with a language modeling head on top (linear layer with weights tied to the input embeddings) e.g for
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),ua.forEach(t),pi=u(ge),R=s(ge,"DIV",{class:!0});var _e=i(R);k(Uo.$$.fragment,_e),ui=u(_e),zt=s(_e,"P",{});var Nn=i(zt);hi=r(Nn,"The "),zn=s(Nn,"A",{href:!0});var Td=i(zn);mi=r(Td,"OPTForSequenceClassification"),Td.forEach(t),fi=r(Nn," forward method, overrides the "),as=s(Nn,"CODE",{});var yd=i(as);gi=r(yd,"__call__"),yd.forEach(t),_i=r(Nn," special method."),Nn.forEach(t),Ti=u(_e),k(Xt.$$.fragment,_e),yi=u(_e),k(Yt.$$.fragment,_e),bi=u(_e),k(eo.$$.fragment,_e),vi=u(_e),k(to.$$.fragment,_e),ki=u(_e),k(oo.$$.fragment,_e),_e.forEach(t),ge.forEach(t),Bs=u(o),Mt=s(o,"H2",{class:!0});var ha=i(Mt);no=s(ha,"A",{id:!0,class:!0,href:!0});var bd=i(no);rs=s(bd,"SPAN",{});var vd=i(rs);k(Ko.$$.fragment,vd),vd.forEach(t),bd.forEach(t),wi=u(ha),is=s(ha,"SPAN",{});var kd=i(is);Pi=r(kd,"OPTForQuestionAnswering"),kd.forEach(t),ha.forEach(t),Hs=u(o),he=s(o,"DIV",{class:!0});var ct=i(he);k(Vo.$$.fragment,ct),$i=u(ct),Et=s(ct,"P",{});var In=i(Et);Oi=r(In,`The OPT Model transformer with a span classification head on top for extractive question-answering tasks like SQuAD
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),fa.forEach(t),Si=u(ct),Le=s(ct,"DIV",{class:!0});var _o=i(Le);k(Xo.$$.fragment,_o),Di=u(_o),Ct=s(_o,"P",{});var Sn=i(Ct);Wi=r(Sn,"The "),En=s(Sn,"A",{href:!0});var Fd=i(En);Gi=r(Fd,"OPTForQuestionAnswering"),Fd.forEach(t),Bi=r(Sn," forward method, overrides the "),cs=s(Sn,"CODE",{});var xd=i(cs);Hi=r(xd,"__call__"),xd.forEach(t),Qi=r(Sn," special method."),Sn.forEach(t),Ui=u(_o),k(so.$$.fragment,_o),Ki=u(_o),k(ao.$$.fragment,_o),_o.forEach(t),ct.forEach(t),Qs=u(o),qt=s(o,"H2",{class:!0});var ga=i(qt);ro=s(ga,"A",{id:!0,class:!0,href:!0});var zd=i(ro);ps=s(zd,"SPAN",{});var Md=i(ps);k(Yo.$$.fragment,Md),Md.forEach(t),zd.forEach(t),Vi=u(ga),us=s(ga,"SPAN",{});var Ed=i(us);Zi=r(Ed,"FlaxOPTModel"),Ed.forEach(t),ga.forEach(t),Us=u(o),jt=s(o,"DIV",{class:!0});var _a=i(jt);k(en.$$.fragment,_a),Ri=u(_a),io=s(_a,"DIV",{class:!0});var Ta=i(io);k(tn.$$.fragment,Ta),Ji=u(Ta),k(lo.$$.fragment,Ta),Ta.forEach(t),_a.forEach(t),Ks=u(o),Lt=s(o,"H2",{class:!0});var ya=i(Lt);co=s(ya,"A",{id:!0,class:!0,href:!0});var Cd=i(co);hs=s(Cd,"SPAN",{});var qd=i(hs);k(on.$$.fragment,qd),qd.forEach(t),Cd.forEach(t),Xi=u(ya),ms=s(ya,"SPAN",{});var jd=i(ms);Yi=r(jd,"FlaxOPTForCausalLM"),jd.forEach(t),ya.forEach(t),Vs=u(o),U=s(o,"DIV",{class:!0});var Te=i(U);k(nn.$$.fragment,Te),el=u(Te),fs=s(Te,"P",{});var Ld=i(fs);tl=r(Ld,`OPT Model with a language modeling head on top (linear layer with weights tied to the input embeddings) e.g for
