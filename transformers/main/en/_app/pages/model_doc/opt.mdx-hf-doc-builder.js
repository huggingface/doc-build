...
<span class="hljs-meta">&gt;&gt;&gt; </span>configuration = model.config`}}),{c(){d=n("p"),T=r("Example:"),h=c(),v(m.$$.fragment)},l(l){d=s(l,"P",{});var u=a(d);T=i(u,"Example:"),u.forEach(t),h=p(l),k(m.$$.fragment,l)},m(l,u){g(l,d,u),e(d,T),g(l,h,u),w(m,l,u),y=!0},p:et,i(l){y||($(m.$$.fragment,l),y=!0)},o(l){P(m.$$.fragment,l),y=!1},d(l){l&&t(d),l&&t(h),O(m,l)}}}function Hl(M){let d,T,h,m,y;return{c(){d=n("p"),T=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),h=n("code"),m=r("Module"),y=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(l){d=s(l,"P",{});var u=a(d);T=i(u,"Although the recipe for forward pass needs to be defined within this function, one should call the "),h=s(u,"CODE",{});var E=a(h);m=i(E,"Module"),E.forEach(t),y=i(u,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),u.forEach(t)},m(l,u){g(l,d,u),e(d,T),e(d,h),e(h,m),e(d,y)},d(l){l&&t(d)}}}function Bl(M){let d,T,h,m,y;return m=new tt({props:{code:`from transformers import GPT2Tokenizer, OPTModel
import torch
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),{c(){d=n("p"),T=r("Example:"),h=c(),v(m.$$.fragment)},l(l){d=s(l,"P",{});var u=a(d);T=i(u,"Example:"),u.forEach(t),h=p(l),k(m.$$.fragment,l)},m(l,u){g(l,d,u),e(d,T),g(l,h,u),w(m,l,u),y=!0},p:et,i(l){y||($(m.$$.fragment,l),y=!0)},o(l){P(m.$$.fragment,l),y=!1},d(l){l&&t(d),l&&t(h),O(m,l)}}}function Ul(M){let d,T,h,m,y;return m=new tt({props:{code:`from transformers import GPT2Tokenizer, OPTForCausalLM
...
<span class="hljs-string">&quot;Hey, are you consciours? Can you talk to me?\\nI&#x27;m not consciours, but I can talk to you.&quot;</span>`}}),{c(){d=n("p"),T=r("Example:"),h=c(),v(m.$$.fragment)},l(l){d=s(l,"P",{});var u=a(d);T=i(u,"Example:"),u.forEach(t),h=p(l),k(m.$$.fragment,l)},m(l,u){g(l,d,u),e(d,T),g(l,h,u),w(m,l,u),y=!0},p:et,i(l){y||($(m.$$.fragment,l),y=!0)},o(l){P(m.$$.fragment,l),y=!1},d(l){l&&t(d),l&&t(h),O(m,l)}}}function Kl(M){let d,T,h,m,y,l,u,E,je,Oe,L,oe,se,F,Le,X,Ae,Fe,W,Ne,ae,re,Ie,Me,V,Se,xe,Z,Te,De,he,C,A,ze,G,ie,We,Y,Ge,He,N,I,le,ye,Be,de,be,Ue,Q,ve,ce,Ke,ne,S,Ve,H,j,Ze;return{c(){d=n("p"),T=r("TensorFlow models and layers in "),h=n("code"),m=r("transformers"),y=r(" accept two formats as input:"),l=c(),u=n("ul"),E=n("li"),je=r("having all inputs as keyword arguments (like PyTorch models), or"),Oe=c(),L=n("li"),oe=r("having all inputs as a list, tuple or dict in the first positional argument."),se=c(),F=n("p"),Le=r(`The reason the second format is supported is that Keras methods prefer this format when passing inputs to models
...
positional argument:`),he=c(),C=n("ul"),A=n("li"),ze=r("a single Tensor with "),G=n("code"),ie=r("input_ids"),We=r(" only and nothing else: "),Y=n("code"),Ge=r("model(input_ids)"),He=c(),N=n("li"),I=r(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),le=n("code"),ye=r("model([input_ids, attention_mask])"),Be=r(" or "),de=n("code"),be=r("model([input_ids, attention_mask, token_type_ids])"),Ue=c(),Q=n("li"),ve=r(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
...
about any of this, as you can just pass inputs like you would to any other Python function!`),this.h()},l(b){d=s(b,"P",{});var x=a(d);T=i(x,"TensorFlow models and layers in "),h=s(x,"CODE",{});var lt=a(h);m=i(lt,"transformers"),lt.forEach(t),y=i(x," accept two formats as input:"),x.forEach(t),l=p(b),u=s(b,"UL",{});var ee=a(u);E=s(ee,"LI",{});var dt=a(E);je=i(dt,"having all inputs as keyword arguments (like PyTorch models), or"),dt.forEach(t),Oe=p(ee),L=s(ee,"LI",{});var ct=a(L);oe=i(ct,"having all inputs as a list, tuple or dict in the first positional argument."),ct.forEach(t),ee.forEach(t),se=p(b),F=s(b,"P",{});var z=a(F);Le=i(z,`The reason the second format is supported is that Keras methods prefer this format when passing inputs to models
...
the Keras `),Z=s(z,"CODE",{});var mt=a(Z);Te=i(mt,"Functional"),mt.forEach(t),De=i(z,` API, there are three possibilities you can use to gather all the input Tensors in the first
positional argument:`),z.forEach(t),he=p(b),C=s(b,"UL",{});var R=a(C);A=s(R,"LI",{});var D=a(A);ze=i(D,"a single Tensor with "),G=s(D,"CODE",{});var me=a(G);ie=i(me,"input_ids"),me.forEach(t),We=i(D," only and nothing else: "),Y=s(D,"CODE",{});var Re=a(Y);Ge=i(Re,"model(input_ids)"),Re.forEach(t),D.forEach(t),He=p(R),N=s(R,"LI",{});var B=a(N);I=i(B,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),le=s(B,"CODE",{});var ft=a(le);ye=i(ft,"model([input_ids, attention_mask])"),ft.forEach(t),Be=i(B," or "),de=s(B,"CODE",{});var Je=a(de);be=i(Je,"model([input_ids, attention_mask, token_type_ids])"),Je.forEach(t),B.forEach(t),Ue=p(R),Q=s(R,"LI",{});var Xe=a(Q);ve=i(Xe,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),ce=s(Xe,"CODE",{});var ot=a(ce);Ke=i(ot,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),ot.forEach(t),Xe.forEach(t),R.forEach(t),ne=p(b),S=s(b,"P",{});var q=a(S);Ve=i(q,`Note that when creating models and layers with
`),H=s(q,"A",{href:!0,rel:!0});var we=a(H);j=i(we,"subclassing"),we.forEach(t),Ze=i(q,` then you don\u2019t need to worry
about any of this, as you can just pass inputs like you would to any other Python function!`),q.forEach(t),this.h()},h(){f(H,"href","https://keras.io/guides/making_new_layers_and_models_via_subclassing/"),f(H,"rel","nofollow")},m(b,x){g(b,d,x),e(d,T),e(d,h),e(h,m),e(d,y),g(b,l,x),g(b,u,x),e(u,E),e(E,je),e(u,Oe),e(u,L),e(L,oe),g(b,se,x),g(b,F,x),e(F,Le),e(F,X),e(X,Ae),e(F,Fe),e(F,W),e(W,Ne),e(F,ae),e(F,re),e(re,Ie),e(F,Me),e(F,V),e(V,Se),e(F,xe),e(F,Z),e(Z,Te),e(F,De),g(b,he,x),g(b,C,x),e(C,A),e(A,ze),e(A,G),e(G,ie),e(A,We),e(A,Y),e(Y,Ge),e(C,He),e(C,N),e(N,I),e(N,le),e(le,ye),e(N,Be),e(N,de),e(de,be),e(C,Ue),e(C,Q),e(Q,ve),e(Q,ce),e(ce,Ke),g(b,ne,x),g(b,S,x),e(S,Ve),e(S,H),e(H,j),e(S,Ze)},d(b){b&&t(d),b&&t(l),b&&t(u),b&&t(se),b&&t(F),b&&t(he),b&&t(C),b&&t(ne),b&&t(S)}}}function Vl(M){let d,T,h,m,y;return{c(){d=n("p"),T=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),h=n("code"),m=r("Module"),y=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(l){d=s(l,"P",{});var u=a(d);T=i(u,"Although the recipe for forward pass needs to be defined within this function, one should call the "),h=s(u,"CODE",{});var E=a(h);m=i(E,"Module"),E.forEach(t),y=i(u,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),u.forEach(t)},m(l,u){g(l,d,u),e(d,T),e(d,h),e(h,m),e(d,y)},d(l){l&&t(d)}}}function Zl(M){let d,T,h,m,y;return m=new tt({props:{code:`from transformers import GPT2Tokenizer, TFOPTModel
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),{c(){d=n("p"),T=r("Example:"),h=c(),v(m.$$.fragment)},l(l){d=s(l,"P",{});var u=a(d);T=i(u,"Example:"),u.forEach(t),h=p(l),k(m.$$.fragment,l)},m(l,u){g(l,d,u),e(d,T),g(l,h,u),w(m,l,u),y=!0},p:et,i(l){y||($(m.$$.fragment,l),y=!0)},o(l){P(m.$$.fragment,l),y=!1},d(l){l&&t(d),l&&t(h),O(m,l)}}}function Rl(M){let d,T,h,m,y,l,u,E,je,Oe,L,oe,se,F,Le,X,Ae,Fe,W,Ne,ae,re,Ie,Me,V,Se,xe,Z,Te,De,he,C,A,ze,G,ie,We,Y,Ge,He,N,I,le,ye,Be,de,be,Ue,Q,ve,ce,Ke,ne,S,Ve,H,j,Ze;return{c(){d=n("p"),T=r("TensorFlow models and layers in "),h=n("code"),m=r("transformers"),y=r(" accept two formats as input:"),l=c(),u=n("ul"),E=n("li"),je=r("having all inputs as keyword arguments (like PyTorch models), or"),Oe=c(),L=n("li"),oe=r("having all inputs as a list, tuple or dict in the first positional argument."),se=c(),F=n("p"),Le=r(`The reason the second format is supported is that Keras methods prefer this format when passing inputs to models
and layers. Because of this support, when using methods like `),X=n("code"),Ae=r("model.fit()"),Fe=r(` things should \u201Cjust work\u201D for you - just
pass your inputs and labels in any format that `),W=n("code"),Ne=r("model.fit()"),ae=r(` supports! If, however, you want to use the second
format outside of Keras methods like `),re=n("code"),Ie=r("fit()"),Me=r(" and "),V=n("code"),Se=r("predict()"),xe=r(`, such as when creating your own layers or models with
the Keras `),Z=n("code"),Te=r("Functional"),De=r(` API, there are three possibilities you can use to gather all the input Tensors in the first
...
`),ce=s(Xe,"CODE",{});var ot=a(ce);Ke=i(ot,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),ot.forEach(t),Xe.forEach(t),R.forEach(t),ne=p(b),S=s(b,"P",{});var q=a(S);Ve=i(q,`Note that when creating models and layers with
`),H=s(q,"A",{href:!0,rel:!0});var we=a(H);j=i(we,"subclassing"),we.forEach(t),Ze=i(q,` then you don\u2019t need to worry
about any of this, as you can just pass inputs like you would to any other Python function!`),q.forEach(t),this.h()},h(){f(H,"href","https://keras.io/guides/making_new_layers_and_models_via_subclassing/"),f(H,"rel","nofollow")},m(b,x){g(b,d,x),e(d,T),e(d,h),e(h,m),e(d,y),g(b,l,x),g(b,u,x),e(u,E),e(E,je),e(u,Oe),e(u,L),e(L,oe),g(b,se,x),g(b,F,x),e(F,Le),e(F,X),e(X,Ae),e(F,Fe),e(F,W),e(W,Ne),e(F,ae),e(F,re),e(re,Ie),e(F,Me),e(F,V),e(V,Se),e(F,xe),e(F,Z),e(Z,Te),e(F,De),g(b,he,x),g(b,C,x),e(C,A),e(A,ze),e(A,G),e(G,ie),e(A,We),e(A,Y),e(Y,Ge),e(C,He),e(C,N),e(N,I),e(N,le),e(le,ye),e(N,Be),e(N,de),e(de,be),e(C,Ue),e(C,Q),e(Q,ve),e(Q,ce),e(ce,Ke),g(b,ne,x),g(b,S,x),e(S,Ve),e(S,H),e(H,j),e(S,Ze)},d(b){b&&t(d),b&&t(l),b&&t(u),b&&t(se),b&&t(F),b&&t(he),b&&t(C),b&&t(ne),b&&t(S)}}}function Jl(M){let d,T,h,m,y;return m=new tt({props:{code:`from transformers import GPT2Tokenizer, TFOPTForCausalLM
import tensorflow as tf
...
<span class="hljs-meta">&gt;&gt;&gt; </span>inputs = tokenizer(<span class="hljs-string">&quot;Hello, my dog is cute&quot;</span>, return_tensors=<span class="hljs-string">&quot;tf&quot;</span>)
<span class="hljs-meta">&gt;&gt;&gt; </span>outputs = model(inputs)
<span class="hljs-meta">&gt;&gt;&gt; </span>logits = outputs.logits`}}),{c(){d=n("p"),T=r("Example:"),h=c(),v(m.$$.fragment)},l(l){d=s(l,"P",{});var u=a(d);T=i(u,"Example:"),u.forEach(t),h=p(l),k(m.$$.fragment,l)},m(l,u){g(l,d,u),e(d,T),g(l,h,u),w(m,l,u),y=!0},p:et,i(l){y||($(m.$$.fragment,l),y=!0)},o(l){P(m.$$.fragment,l),y=!1},d(l){l&&t(d),l&&t(h),O(m,l)}}}function Xl(M){let d,T,h,m,y;return{c(){d=n("p"),T=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),h=n("code"),m=r("Module"),y=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(l){d=s(l,"P",{});var u=a(d);T=i(u,"Although the recipe for forward pass needs to be defined within this function, one should call the "),h=s(u,"CODE",{});var E=a(h);m=i(E,"Module"),E.forEach(t),y=i(u,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),u.forEach(t)},m(l,u){g(l,d,u),e(d,T),e(d,h),e(h,m),e(d,y)},d(l){l&&t(d)}}}function Yl(M){let d,T,h,m,y;return m=new tt({props:{code:`import torch
...
<span class="hljs-number">1.71</span>`}}),{c(){v(d.$$.fragment)},l(h){k(d.$$.fragment,h)},m(h,m){w(d,h,m),T=!0},p:et,i(h){T||($(d.$$.fragment,h),T=!0)},o(h){P(d.$$.fragment,h),T=!1},d(h){O(d,h)}}}function ed(M){let d,T,h,m,y;return m=new tt({props:{code:`import torch
from transformers import GPT2Tokenizer, OPTForSequenceClassification
...
<span class="hljs-meta">&gt;&gt;&gt; </span>predicted_class_id = logits.argmax().item()
<span class="hljs-meta">&gt;&gt;&gt; </span>model.config.id2label[predicted_class_id]
<span class="hljs-string">&#x27;LABEL_0&#x27;</span>`}}),{c(){d=n("p"),T=r("Example of multi-label classification:"),h=c(),v(m.$$.fragment)},l(l){d=s(l,"P",{});var u=a(d);T=i(u,"Example of multi-label classification:"),u.forEach(t),h=p(l),k(m.$$.fragment,l)},m(l,u){g(l,d,u),e(d,T),g(l,h,u),w(m,l,u),y=!0},p:et,i(l){y||($(m.$$.fragment,l),y=!0)},o(l){P(m.$$.fragment,l),y=!1},d(l){l&&t(d),l&&t(h),O(m,l)}}}function td(M){let d,T;return d=new tt({props:{code:`# To train a model on \`num_labels\` classes, you can pass \`num_labels=num_labels\` to \`.from_pretrained(...)\`
num_labels = len(model.config.id2label)
...
<span class="hljs-meta">... </span>)
<span class="hljs-meta">&gt;&gt;&gt; </span>loss = model(**inputs, labels=labels).loss
<span class="hljs-meta">&gt;&gt;&gt; </span>loss.backward()`}}),{c(){v(d.$$.fragment)},l(h){k(d.$$.fragment,h)},m(h,m){w(d,h,m),T=!0},p:et,i(h){T||($(d.$$.fragment,h),T=!0)},o(h){P(d.$$.fragment,h),T=!1},d(h){O(d,h)}}}function od(M){let d,T,h,m,y;return m=new tt({props:{code:`from transformers import GPT2Tokenizer, FlaxOPTModel
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),{c(){d=n("p"),T=r("Example:"),h=c(),v(m.$$.fragment)},l(l){d=s(l,"P",{});var u=a(d);T=i(u,"Example:"),u.forEach(t),h=p(l),k(m.$$.fragment,l)},m(l,u){g(l,d,u),e(d,T),g(l,h,u),w(m,l,u),y=!0},p:et,i(l){y||($(m.$$.fragment,l),y=!0)},o(l){P(m.$$.fragment,l),y=!1},d(l){l&&t(d),l&&t(h),O(m,l)}}}function nd(M){let d,T,h,m,y;return m=new tt({props:{code:`from transformers import GPT2Tokenizer, FlaxOPTForCausalLM
...
<span class="hljs-meta">&gt;&gt;&gt; </span>next_token_logits = outputs.logits[:, -<span class="hljs-number">1</span>]`}}),{c(){d=n("p"),T=r("Example:"),h=c(),v(m.$$.fragment)},l(l){d=s(l,"P",{});var u=a(d);T=i(u,"Example:"),u.forEach(t),h=p(l),k(m.$$.fragment,l)},m(l,u){g(l,d,u),e(d,T),g(l,h,u),w(m,l,u),y=!0},p:et,i(l){y||($(m.$$.fragment,l),y=!0)},o(l){P(m.$$.fragment,l),y=!1},d(l){l&&t(d),l&&t(h),O(m,l)}}}function sd(M){let d,T,h,m,y,l,u,E,je,Oe,L,oe,se,F,Le,X,Ae,Fe,W,Ne,ae,re,Ie,Me,V,Se,xe,Z,Te,De,he,C,A,ze,G,ie,We,Y,Ge,He,N,I,le,ye,Be,de,be,Ue,Q,ve,ce,Ke,ne,S,Ve,H,j,Ze,b,x,lt,ee,dt,ct,z,pt,ut,ke,ht,mt,R,D,me,Re,B,ft,Je,Xe,ot,q,we,Ks,gt,Vs,tn,Zs,Rs,lo,Js,Xs,Ys,_t,Qs,on,ea,ta,nn,oa,na,sa,zt,is,Tt,Ct,bn,co,aa,vn,ra,ls,$e,po,ia,uo,la,sn,da,ca,pa,ho,ua,mo,ha,ma,fa,Ce,fo,ga,yt,_a,an,Ta,ya,kn,ba,va,ka,Et,wa,qt,ds,bt,jt,wn,go,$a,$n,Pa,cs,vt,_o,Oa,Lt,To,Fa,At,ps,kt,Nt,Pn,yo,Ma,On,xa,us,pe,bo,za,vo,Ca,rn,Ea,qa,ja,ko,La,wo,Aa,Na,Ia,It,Sa,Ee,$o,Da,wt,Wa,ln,Ga,Ha,Fn,Ba,Ua,Ka,St,Va,Dt,hs,$t,Wt,Mn,Po,Za,xn,Ra,ms,te,Oo,Ja,zn,Xa,Ya,Fo,Qa,dn,er,tr,or,Mo,nr,xo,sr,ar,rr,Gt,ir,Ht,zo,lr,Bt,fs,Pt,Ut,Cn,Co,dr,En,cr,gs,U,Eo,pr,qn,ur,hr,cn,pn,mr,fr,gr,Pe,_r,jn,Tr,yr,Ln,br,vr,An,kr,wr,Nn,$r,Pr,Or,qo,Fr,un,Mr,xr,zr,jo,Cr,Lo,Er,qr,jr,J,Ao,Lr,Ot,Ar,hn,Nr,Ir,In,Sr,Dr,Wr,Kt,Gr,Vt,Hr,Zt,Br,Rt,Ur,Jt,_s,Ft,Xt,Sn,No,Kr,Dn,Vr,Ts,Mt,Io,Zr,Yt,So,Rr,Qt,ys,xt,eo,Wn,Do,Jr,Gn,Xr,bs,K,Wo,Yr,Hn,Qr,ei,Go,ti,mn,oi,ni,si,Ho,ai,Bo,ri,ii,li,Bn,di,ci,Ye,Un,Uo,pi,ui,Kn,Ko,hi,mi,Vn,Vo,fi,gi,Zn,Zo,_i,Ti,to,Ro,yi,oo,vs;return l=new it({}),F=new it({}),B=new it({}),we=new ue({props:{name:"class transformers.OPTConfig",anchor:"transformers.OPTConfig",parameters:[{name:"vocab_size",val:" = 50272"},{name:"hidden_size",val:" = 768"},{name:"num_hidden_layers",val:" = 12"},{name:"ffn_dim",val:" = 3072"},{name:"max_position_embeddings",val:" = 2048"},{name:"do_layer_norm_before",val:" = True"},{name:"_remove_final_layer_norm",val:" = False"},{name:"word_embed_proj_dim",val:" = None"},{name:"dropout",val:" = 0.1"},{name:"attention_dropout",val:" = 0.0"},{name:"num_attention_heads",val:" = 12"},{name:"activation_function",val:" = 'relu'"},{name:"layerdrop",val:" = 0.0"},{name:"init_std",val:" = 0.02"},{name:"use_cache",val:" = True"},{name:"pad_token_id",val:" = 1"},{name:"bos_token_id",val:" = 2"},{name:"eos_token_id",val:" = 2"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.OPTConfig.vocab_size",description:`<strong>vocab_size</strong> (<code>int</code>, <em>optional</em>, defaults to 50272) &#x2014;
...
behaviors between training and evaluation).`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/opt/modeling_tf_opt.py#L789",returnDescription:`
<p>A <a
...
Whether or not to return a <a href="/docs/transformers/main/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/opt/modeling_tf_opt.py#L888",returnDescription:`
<p>A <a
...
<p><a
  href="/docs/transformers/main/en/main_classes/output#transformers.modeling_flax_outputs.FlaxBaseModelOutput"
>transformers.modeling_flax_outputs.FlaxBaseModelOutput</a> or <code>tuple(torch.FloatTensor)</code></p>
`}}),oo=new Qe({props:{anchor:"transformers.FlaxOPTForCausalLM.__call__.example",$$slots:{default:[nd]},$$scope:{ctx:M}}}),{c(){d=n("meta"),T=c(),h=n("h1"),m=n("a"),y=n("span"),v(l.$$.fragment),u=c(),E=n("span"),je=r("OPT"),Oe=c(),L=n("h2"),oe=n("a"),se=n("span"),v(F.$$.fragment),Le=c(),X=n("span"),Ae=r("Overview"),Fe=c(),W=n("p"),Ne=r("The OPT model was proposed in "),ae=n("a"),re=r("Open Pre-trained Transformer Language Models"),Ie=r(` by Meta AI.
OPT is a series of open-sourced large causal language models which perform similar in performance to GPT3.`),Me=c(),V=n("p"),Se=r("The abstract from the paper is the following:"),xe=c(),Z=n("p"),Te=n("em"),De=r("Large language models, which are often trained for hundreds of thousands of compute days, have shown remarkable capabilities for zero- and few-shot learning. Given their computational cost, these models are difficult to replicate without significant capital. For the few that are available through APIs, no access is granted to the full model weights, making them difficult to study. We present Open Pre-trained Transformers (OPT), a suite of decoder-only pre-trained transformers ranging from 125M to 175B parameters, which we aim to fully and responsibly share with interested researchers. We show that OPT-175B is comparable to GPT-3, while requiring only 1/7th the carbon footprint to develop. We are also releasing our logbook detailing the infrastructure challenges we faced, along with code for experimenting with all of the released models."),he=c(),C=n("p"),A=r("Tips:"),ze=c(),G=n("ul"),ie=n("li"),We=r("OPT has the same architecture as "),Y=n("code"),Ge=r("BartDecoder"),He=r("."),N=c(),I=n("li"),le=r("Contrary to GPT2, OPT adds the EOS token "),ye=n("code"),Be=r("</s>"),de=r(" to the beginning of every prompt. "),be=n("strong"),Ue=r("Note"),Q=r(": Make sure to pass "),ve=n("code"),ce=r("use_fast=False"),Ke=r(" when loading OPT\u2019s tokenizer with "),ne=n("a"),S=r("AutoTokenizer"),Ve=r(" to get the correct tokenizer."),H=c(),j=n("p"),Ze=r("This model was contributed by "),b=n("a"),x=r("Arthur Zucker"),lt=r(", "),ee=n("a"),dt=r("Younes Belkada"),ct=r(", and "),z=n("a"),pt=r("Patrick Von Platen"),ut=r(`.
The original code can be found `),ke=n("a"),ht=r("here"),mt=r("."),R=c(),D=n("h2"),me=n("a"),Re=n("span"),v(B.$$.fragment),ft=c(),Je=n("span"),Xe=r("OPTConfig"),ot=c(),q=n("div"),v(we.$$.fragment),Ks=c(),gt=n("p"),Vs=r("This is the configuration class to store the configuration of a "),tn=n("a"),Zs=r("OPTModel"),Rs=r(`. It is used to instantiate a OPT model
...
documentation from `),nn=n("a"),oa=r("PretrainedConfig"),na=r(" for more information."),sa=c(),v(zt.$$.fragment),is=c(),Tt=n("h2"),Ct=n("a"),bn=n("span"),v(co.$$.fragment),aa=c(),vn=n("span"),ra=r("OPTModel"),ls=c(),$e=n("div"),v(po.$$.fragment),ia=c(),uo=n("p"),la=r(`The bare OPT Model outputting raw hidden-states without any specific head on top.
...
and behavior.`),fa=c(),Ce=n("div"),v(fo.$$.fragment),ga=c(),yt=n("p"),_a=r("The "),an=n("a"),Ta=r("OPTModel"),ya=r(" forward method, overrides the "),kn=n("code"),ba=r("__call__"),va=r(" special method."),ka=c(),v(Et.$$.fragment),wa=c(),v(qt.$$.fragment),ds=c(),bt=n("h2"),jt=n("a"),wn=n("span"),v(go.$$.fragment),$a=c(),$n=n("span"),Pa=r("OPTForCausalLM"),cs=c(),vt=n("div"),v(_o.$$.fragment),Oa=c(),Lt=n("div"),v(To.$$.fragment),Fa=c(),v(At.$$.fragment),ps=c(),kt=n("h2"),Nt=n("a"),Pn=n("span"),v(yo.$$.fragment),Ma=c(),On=n("span"),xa=r("TFOPTModel"),us=c(),pe=n("div"),v(bo.$$.fragment),za=c(),vo=n("p"),Ca=r(`The bare TF OPT Model outputting raw hidden-states without any specific head on top.
...
behavior.`),Ia=c(),v(It.$$.fragment),Sa=c(),Ee=n("div"),v($o.$$.fragment),Da=c(),wt=n("p"),Wa=r("The "),ln=n("a"),Ga=r("TFOPTModel"),Ha=r(" forward method, overrides the "),Fn=n("code"),Ba=r("__call__"),Ua=r(" special method."),Ka=c(),v(St.$$.fragment),Va=c(),v(Dt.$$.fragment),hs=c(),$t=n("h2"),Wt=n("a"),Mn=n("span"),v(Po.$$.fragment),Za=c(),xn=n("span"),Ra=r("TFOPTForCausalLM"),ms=c(),te=n("div"),v(Oo.$$.fragment),Ja=c(),zn=n("p"),Xa=r("The OPT Model transformer with a language modeling head on top."),Ya=c(),Fo=n("p"),Qa=r("This model inherits from "),dn=n("a"),er=r("TFPreTrainedModel"),tr=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),or=c(),Mo=n("p"),nr=r("This model is also a "),xo=n("a"),sr=r("tf.keras.Model"),ar=r(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),rr=c(),v(Gt.$$.fragment),ir=c(),Ht=n("div"),v(zo.$$.fragment),lr=c(),v(Bt.$$.fragment),fs=c(),Pt=n("h2"),Ut=n("a"),Cn=n("span"),v(Co.$$.fragment),dr=c(),En=n("span"),cr=r("OPTForSequenceClassification"),gs=c(),U=n("div"),v(Eo.$$.fragment),pr=c(),qn=n("p"),ur=r("The OPT Model transformer with a sequence classification head on top (linear layer)."),hr=c(),cn=n("p"),pn=n("a"),mr=r("OPTForSequenceClassification"),fr=r(` uses the last token in order to do the classification, as other causal models
...
`),jn=n("code"),Tr=r("pad_token_id"),yr=r(` is defined in the configuration, it finds the last token that is not a padding token in each row. If
no `),Ln=n("code"),br=r("pad_token_id"),vr=r(` is defined, it simply takes the last value in each row of the batch. Since it cannot guess the
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),jr=c(),J=n("div"),v(Ao.$$.fragment),Lr=c(),Ot=n("p"),Ar=r("The "),hn=n("a"),Nr=r("OPTForSequenceClassification"),Ir=r(" forward method, overrides the "),In=n("code"),Sr=r("__call__"),Dr=r(" special method."),Wr=c(),v(Kt.$$.fragment),Gr=c(),v(Vt.$$.fragment),Hr=c(),v(Zt.$$.fragment),Br=c(),v(Rt.$$.fragment),Ur=c(),v(Jt.$$.fragment),_s=c(),Ft=n("h2"),Xt=n("a"),Sn=n("span"),v(No.$$.fragment),Kr=c(),Dn=n("span"),Vr=r("FlaxOPTModel"),Ts=c(),Mt=n("div"),v(Io.$$.fragment),Zr=c(),Yt=n("div"),v(So.$$.fragment),Rr=c(),v(Qt.$$.fragment),ys=c(),xt=n("h2"),eo=n("a"),Wn=n("span"),v(Do.$$.fragment),Jr=c(),Gn=n("span"),Xr=r("FlaxOPTForCausalLM"),bs=c(),K=n("div"),v(Wo.$$.fragment),Yr=c(),Hn=n("p"),Qr=r(`OPT Model with a language modeling head on top (linear layer with weights tied to the input embeddings) e.g for
...
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),li=c(),Bn=n("p"),di=r("Finally, this model supports inherent JAX features such as:"),ci=c(),Ye=n("ul"),Un=n("li"),Uo=n("a"),pi=r("Just-In-Time (JIT) compilation"),ui=c(),Kn=n("li"),Ko=n("a"),hi=r("Automatic Differentiation"),mi=c(),Vn=n("li"),Vo=n("a"),fi=r("Vectorization"),gi=c(),Zn=n("li"),Zo=n("a"),_i=r("Parallelization"),Ti=c(),to=n("div"),v(Ro.$$.fragment),yi=c(),v(oo.$$.fragment),this.h()},l(o){const _=Dl('[data-svelte="svelte-1phssyn"]',document.head);d=s(_,"META",{name:!0,content:!0}),_.forEach(t),T=p(o),h=s(o,"H1",{class:!0});var Jo=a(h);m=s(Jo,"A",{id:!0,class:!0,href:!0});var Rn=a(m);y=s(Rn,"SPAN",{});var Jn=a(y);k(l.$$.fragment,Jn),Jn.forEach(t),Rn.forEach(t),u=p(Jo),E=s(Jo,"SPAN",{});var Xn=a(E);je=i(Xn,"OPT"),Xn.forEach(t),Jo.forEach(t),Oe=p(o),L=s(o,"H2",{class:!0});var Xo=a(L);oe=s(Xo,"A",{id:!0,class:!0,href:!0});var Yn=a(oe);se=s(Yn,"SPAN",{});var Qn=a(se);k(F.$$.fragment,Qn),Qn.forEach(t),Yn.forEach(t),Le=p(Xo),X=s(Xo,"SPAN",{});var es=a(X);Ae=i(es,"Overview"),es.forEach(t),Xo.forEach(t),Fe=p(o),W=s(o,"P",{});var Yo=a(W);Ne=i(Yo,"The OPT model was proposed in "),ae=s(Yo,"A",{href:!0,rel:!0});var ts=a(ae);re=i(ts,"Open Pre-trained Transformer Language Models"),ts.forEach(t),Ie=i(Yo,` by Meta AI.
OPT is a series of open-sourced large causal language models which perform similar in performance to GPT3.`),Yo.forEach(t),Me=p(o),V=s(o,"P",{});var os=a(V);Se=i(os,"The abstract from the paper is the following:"),os.forEach(t),xe=p(o),Z=s(o,"P",{});var ns=a(Z);Te=s(ns,"EM",{});var ss=a(Te);De=i(ss,"Large language models, which are often trained for hundreds of thousands of compute days, have shown remarkable capabilities for zero- and few-shot learning. Given their computational cost, these models are difficult to replicate without significant capital. For the few that are available through APIs, no access is granted to the full model weights, making them difficult to study. We present Open Pre-trained Transformers (OPT), a suite of decoder-only pre-trained transformers ranging from 125M to 175B parameters, which we aim to fully and responsibly share with interested researchers. We show that OPT-175B is comparable to GPT-3, while requiring only 1/7th the carbon footprint to develop. We are also releasing our logbook detailing the infrastructure challenges we faced, along with code for experimenting with all of the released models."),ss.forEach(t),ns.forEach(t),he=p(o),C=s(o,"P",{});var as=a(C);A=i(as,"Tips:"),as.forEach(t),ze=p(o),G=s(o,"UL",{});var Qo=a(G);ie=s(Qo,"LI",{});var en=a(ie);We=i(en,"OPT has the same architecture as "),Y=s(en,"CODE",{});var vi=a(Y);Ge=i(vi,"BartDecoder"),vi.forEach(t),He=i(en,"."),en.forEach(t),N=p(Qo),I=s(Qo,"LI",{});var nt=a(I);le=i(nt,"Contrary to GPT2, OPT adds the EOS token "),ye=s(nt,"CODE",{});var ki=a(ye);Be=i(ki,"</s>"),ki.forEach(t),de=i(nt," to the beginning of every prompt. "),be=s(nt,"STRONG",{});var wi=a(be);Ue=i(wi,"Note"),wi.forEach(t),Q=i(nt,": Make sure to pass "),ve=s(nt,"CODE",{});var $i=a(ve);ce=i($i,"use_fast=False"),$i.forEach(t),Ke=i(nt," when loading OPT\u2019s tokenizer with "),ne=s(nt,"A",{href:!0});var Pi=a(ne);S=i(Pi,"AutoTokenizer"),Pi.forEach(t),Ve=i(nt," to get the correct tokenizer."),nt.forEach(t),Qo.forEach(t),H=p(o),j=s(o,"P",{});var st=a(j);Ze=i(st,"This model was contributed by "),b=s(st,"A",{href:!0,rel:!0});var Oi=a(b);x=i(Oi,"Arthur Zucker"),Oi.forEach(t),lt=i(st,", "),ee=s(st,"A",{href:!0,rel:!0});var Fi=a(ee);dt=i(Fi,"Younes Belkada"),Fi.forEach(t),ct=i(st,", and "),z=s(st,"A",{href:!0,rel:!0});var Mi=a(z);pt=i(Mi,"Patrick Von Platen"),Mi.forEach(t),ut=i(st,`.
The original code can be found `),ke=s(st,"A",{href:!0,rel:!0});var xi=a(ke);ht=i(xi,"here"),xi.forEach(t),mt=i(st,"."),st.forEach(t),R=p(o),D=s(o,"H2",{class:!0});var ks=a(D);me=s(ks,"A",{id:!0,class:!0,href:!0});var zi=a(me);Re=s(zi,"SPAN",{});var Ci=a(Re);k(B.$$.fragment,Ci),Ci.forEach(t),zi.forEach(t),ft=p(ks),Je=s(ks,"SPAN",{});var Ei=a(Je);Xe=i(Ei,"OPTConfig"),Ei.forEach(t),ks.forEach(t),ot=p(o),q=s(o,"DIV",{class:!0});var no=a(q);k(we.$$.fragment,no),Ks=p(no),gt=s(no,"P",{});var fn=a(gt);Vs=i(fn,"This is the configuration class to store the configuration of a "),tn=s(fn,"A",{href:!0});var qi=a(tn);Zs=i(qi,"OPTModel"),qi.forEach(t),Rs=i(fn,`. It is used to instantiate a OPT model
according to the specified arguments, defining the model architecture. Instantiating a configuration with the
defaults will yield a similar configuration to that of the OPT
...
documentation from `),nn=s(gn,"A",{href:!0});var Ai=a(nn);oa=i(Ai,"PretrainedConfig"),Ai.forEach(t),na=i(gn," for more information."),gn.forEach(t),sa=p(no),k(zt.$$.fragment,no),no.forEach(t),is=p(o),Tt=s(o,"H2",{class:!0});var ws=a(Tt);Ct=s(ws,"A",{id:!0,class:!0,href:!0});var Ni=a(Ct);bn=s(Ni,"SPAN",{});var Ii=a(bn);k(co.$$.fragment,Ii),Ii.forEach(t),Ni.forEach(t),aa=p(ws),vn=s(ws,"SPAN",{});var Si=a(vn);ra=i(Si,"OPTModel"),Si.forEach(t),ws.forEach(t),ls=p(o),$e=s(o,"DIV",{class:!0});var so=a($e);k(po.$$.fragment,so),ia=p(so),uo=s(so,"P",{});var $s=a(uo);la=i($s,`The bare OPT Model outputting raw hidden-states without any specific head on top.
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Ps.forEach(t),fa=p(so),Ce=s(so,"DIV",{class:!0});var ao=a(Ce);k(fo.$$.fragment,ao),ga=p(ao),yt=s(ao,"P",{});var _n=a(yt);_a=i(_n,"The "),an=s(_n,"A",{href:!0});var Gi=a(an);Ta=i(Gi,"OPTModel"),Gi.forEach(t),ya=i(_n," forward method, overrides the "),kn=s(_n,"CODE",{});var Hi=a(kn);ba=i(Hi,"__call__"),Hi.forEach(t),va=i(_n," special method."),_n.forEach(t),ka=p(ao),k(Et.$$.fragment,ao),wa=p(ao),k(qt.$$.fragment,ao),ao.forEach(t),so.forEach(t),ds=p(o),bt=s(o,"H2",{class:!0});var Os=a(bt);jt=s(Os,"A",{id:!0,class:!0,href:!0});var Bi=a(jt);wn=s(Bi,"SPAN",{});var Ui=a(wn);k(go.$$.fragment,Ui),Ui.forEach(t),Bi.forEach(t),$a=p(Os),$n=s(Os,"SPAN",{});var Ki=a($n);Pa=i(Ki,"OPTForCausalLM"),Ki.forEach(t),Os.forEach(t),cs=p(o),vt=s(o,"DIV",{class:!0});var Fs=a(vt);k(_o.$$.fragment,Fs),Oa=p(Fs),Lt=s(Fs,"DIV",{class:!0});var Ms=a(Lt);k(To.$$.fragment,Ms),Fa=p(Ms),k(At.$$.fragment,Ms),Ms.forEach(t),Fs.forEach(t),ps=p(o),kt=s(o,"H2",{class:!0});var xs=a(kt);Nt=s(xs,"A",{id:!0,class:!0,href:!0});var Vi=a(Nt);Pn=s(Vi,"SPAN",{});var Zi=a(Pn);k(yo.$$.fragment,Zi),Zi.forEach(t),Vi.forEach(t),Ma=p(xs),On=s(xs,"SPAN",{});var Ri=a(On);xa=i(Ri,"TFOPTModel"),Ri.forEach(t),xs.forEach(t),us=p(o),pe=s(o,"DIV",{class:!0});var at=a(pe);k(bo.$$.fragment,at),za=p(at),vo=s(at,"P",{});var zs=a(vo);Ca=i(zs,`The bare TF OPT Model outputting raw hidden-states without any specific head on top.
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Cs.forEach(t),Ia=p(at),k(It.$$.fragment,at),Sa=p(at),Ee=s(at,"DIV",{class:!0});var ro=a(Ee);k($o.$$.fragment,ro),Da=p(ro),wt=s(ro,"P",{});var Tn=a(wt);Wa=i(Tn,"The "),ln=s(Tn,"A",{href:!0});var Yi=a(ln);Ga=i(Yi,"TFOPTModel"),Yi.forEach(t),Ha=i(Tn," forward method, overrides the "),Fn=s(Tn,"CODE",{});var Qi=a(Fn);Ba=i(Qi,"__call__"),Qi.forEach(t),Ua=i(Tn," special method."),Tn.forEach(t),Ka=p(ro),k(St.$$.fragment,ro),Va=p(ro),k(Dt.$$.fragment,ro),ro.forEach(t),at.forEach(t),hs=p(o),$t=s(o,"H2",{class:!0});var Es=a($t);Wt=s(Es,"A",{id:!0,class:!0,href:!0});var el=a(Wt);Mn=s(el,"SPAN",{});var tl=a(Mn);k(Po.$$.fragment,tl),tl.forEach(t),el.forEach(t),Za=p(Es),xn=s(Es,"SPAN",{});var ol=a(xn);Ra=i(ol,"TFOPTForCausalLM"),ol.forEach(t),Es.forEach(t),ms=p(o),te=s(o,"DIV",{class:!0});var qe=a(te);k(Oo.$$.fragment,qe),Ja=p(qe),zn=s(qe,"P",{});var nl=a(zn);Xa=i(nl,"The OPT Model transformer with a language modeling head on top."),nl.forEach(t),Ya=p(qe),Fo=s(qe,"P",{});var qs=a(Fo);Qa=i(qs,"This model inherits from "),dn=s(qs,"A",{href:!0});var sl=a(dn);er=i(sl,"TFPreTrainedModel"),sl.forEach(t),tr=i(qs,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),js.forEach(t),rr=p(qe),k(Gt.$$.fragment,qe),ir=p(qe),Ht=s(qe,"DIV",{class:!0});var Ls=a(Ht);k(zo.$$.fragment,Ls),lr=p(Ls),k(Bt.$$.fragment,Ls),Ls.forEach(t),qe.forEach(t),fs=p(o),Pt=s(o,"H2",{class:!0});var As=a(Pt);Ut=s(As,"A",{id:!0,class:!0,href:!0});var rl=a(Ut);Cn=s(rl,"SPAN",{});var il=a(Cn);k(Co.$$.fragment,il),il.forEach(t),rl.forEach(t),dr=p(As),En=s(As,"SPAN",{});var ll=a(En);cr=i(ll,"OPTForSequenceClassification"),ll.forEach(t),As.forEach(t),gs=p(o),U=s(o,"DIV",{class:!0});var fe=a(U);k(Eo.$$.fragment,fe),pr=p(fe),qn=s(fe,"P",{});var dl=a(qn);ur=i(dl,"The OPT Model transformer with a sequence classification head on top (linear layer)."),dl.forEach(t),hr=p(fe),cn=s(fe,"P",{});var bi=a(cn);pn=s(bi,"A",{href:!0});var cl=a(pn);mr=i(cl,"OPTForSequenceClassification"),cl.forEach(t),fr=i(bi,` uses the last token in order to do the classification, as other causal models
(e.g. GPT-2) do.`),bi.forEach(t),gr=p(fe),Pe=s(fe,"P",{});var rt=a(Pe);_r=i(rt,`Since it does classification on the last token, it requires to know the position of the last token. If a
`),jn=s(rt,"CODE",{});var pl=a(jn);Tr=i(pl,"pad_token_id"),pl.forEach(t),yr=i(rt,` is defined in the configuration, it finds the last token that is not a padding token in each row. If
no `),Ln=s(rt,"CODE",{});var ul=a(Ln);br=i(ul,"pad_token_id"),ul.forEach(t),vr=i(rt,` is defined, it simply takes the last value in each row of the batch. Since it cannot guess the
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Ns.forEach(t),zr=p(fe),jo=s(fe,"P",{});var Is=a(jo);Cr=i(Is,"This model is also a PyTorch "),Lo=s(Is,"A",{href:!0,rel:!0});var gl=a(Lo);Er=i(gl,"torch.nn.Module"),gl.forEach(t),qr=i(Is,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Is.forEach(t),jr=p(fe),J=s(fe,"DIV",{class:!0});var ge=a(J);k(Ao.$$.fragment,ge),Lr=p(ge),Ot=s(ge,"P",{});var yn=a(Ot);Ar=i(yn,"The "),hn=s(yn,"A",{href:!0});var _l=a(hn);Nr=i(_l,"OPTForSequenceClassification"),_l.forEach(t),Ir=i(yn," forward method, overrides the "),In=s(yn,"CODE",{});var Tl=a(In);Sr=i(Tl,"__call__"),Tl.forEach(t),Dr=i(yn," special method."),yn.forEach(t),Wr=p(ge),k(Kt.$$.fragment,ge),Gr=p(ge),k(Vt.$$.fragment,ge),Hr=p(ge),k(Zt.$$.fragment,ge),Br=p(ge),k(Rt.$$.fragment,ge),Ur=p(ge),k(Jt.$$.fragment,ge),ge.forEach(t),fe.forEach(t),_s=p(o),Ft=s(o,"H2",{class:!0});var Ss=a(Ft);Xt=s(Ss,"A",{id:!0,class:!0,href:!0});var yl=a(Xt);Sn=s(yl,"SPAN",{});var bl=a(Sn);k(No.$$.fragment,bl),bl.forEach(t),yl.forEach(t),Kr=p(Ss),Dn=s(Ss,"SPAN",{});var vl=a(Dn);Vr=i(vl,"FlaxOPTModel"),vl.forEach(t),Ss.forEach(t),Ts=p(o),Mt=s(o,"DIV",{class:!0});var Ds=a(Mt);k(Io.$$.fragment,Ds),Zr=p(Ds),Yt=s(Ds,"DIV",{class:!0});var Ws=a(Yt);k(So.$$.fragment,Ws),Rr=p(Ws),k(Qt.$$.fragment,Ws),Ws.forEach(t),Ds.forEach(t),ys=p(o),xt=s(o,"H2",{class:!0});var Gs=a(xt);eo=s(Gs,"A",{id:!0,class:!0,href:!0});var kl=a(eo);Wn=s(kl,"SPAN",{});var wl=a(Wn);k(Do.$$.fragment,wl),wl.forEach(t),kl.forEach(t),Jr=p(Gs),Gn=s(Gs,"SPAN",{});var $l=a(Gn);Xr=i($l,"FlaxOPTForCausalLM"),$l.forEach(t),Gs.forEach(t),bs=p(o),K=s(o,"DIV",{class:!0});var _e=a(K);k(Wo.$$.fragment,_e),Yr=p(_e),Hn=s(_e,"P",{});var Pl=a(Hn);Qr=i(Pl,`OPT Model with a language modeling head on top (linear layer with weights tied to the input embeddings) e.g for
...
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),Bs.forEach(t),li=p(_e),Bn=s(_e,"P",{});var Ml=a(Bn);di=i(Ml,"Finally, this model supports inherent JAX features such as:"),Ml.forEach(t),ci=p(_e),Ye=s(_e,"UL",{});var io=a(Ye);Un=s(io,"LI",{});var xl=a(Un);Uo=s(xl,"A",{href:!0,rel:!0});var zl=a(Uo);pi=i(zl,"Just-In-Time (JIT) compilation"),zl.forEach(t),xl.forEach(t),ui=p(io),Kn=s(io,"LI",{});var Cl=a(Kn);Ko=s(Cl,"A",{href:!0,rel:!0});var El=a(Ko);hi=i(El,"Automatic Differentiation"),El.forEach(t),Cl.forEach(t),mi=p(io),Vn=s(io,"LI",{});var ql=a(Vn);Vo=s(ql,"A",{href:!0,rel:!0});var jl=a(Vo);fi=i(jl,"Vectorization"),jl.forEach(t),ql.forEach(t),gi=p(io),Zn=s(io,"LI",{});var Ll=a(Zn);Zo=s(Ll,"A",{href:!0,rel:!0});var Al=a(Zo);_i=i(Al,"Parallelization"),Al.forEach(t),Ll.forEach(t),io.forEach(t),Ti=p(_e),to=s(_e,"DIV",{class:!0});var Us=a(to);k(Ro.$$.fragment,Us),yi=p(Us),k(oo.$$.fragment,Us),Us.forEach(t),_e.forEach(t),this.h()},h(){f(d,"name","hf:doc:metadata"),f(d,"content",JSON.stringify(ad)),f(m,"id","opt"),f(m,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),f(m,"href","#opt"),f(h,"class","relative group"),f(oe,"id","overview"),f(oe,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),f(oe,"href","#overview"),f(L,"class","relative group"),f(ae,"href","https://arxiv.org/pdf/2205.01068"),f(ae,"rel","nofollow"),f(ne,"href","/docs/transformers/main/en/model_doc/auto#transformers.AutoTokenizer"),f(b,"href","https://huggingface.co/ArthurZ"),f(b,"rel","nofollow"),f(ee,"href","https://huggingface.co/ybelkada"),f(ee,"rel","nofollow"),f(z,"href","https://huggingface.co/patrickvonplaten"),f(z,"rel","nofollow"),f(ke,"href","https://github.com/facebookresearch/metaseq"),f(ke,"rel","nofollow"),f(me,"id","transformers.OPTConfig"),f(me,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),f(me,"href","#transformers.OPTConfig"),f(D,"class","relative group"),f(tn,"href","/docs/transformers/main/en/model_doc/opt#transformers.OPTModel"),f(lo,"href","https://huggingface.co/facebook/opt-350m"),f(lo,"rel","nofollow"),f(on,"href","/docs/transformers/main/en/main_classes/configuration#transformers.PretrainedConfig"),f(nn,"href","/docs/transformers/main/en/main_classes/configuration#transformers.PretrainedConfig"),f(q,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),f(Ct,"id","transformers.OPTModel"),f(Ct,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),f(Ct,"href","#transformers.OPTModel"),f(Tt,"class","relative group"),f(sn,"href","/docs/transformers/main/en/main_classes/model#transformers.PreTrainedModel"),f(mo,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),f(mo,"rel","nofollow"),f(an,"href","/docs/transformers/main/en/model_doc/opt#transformers.OPTModel"),f(Ce,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),f($e,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),f(jt,"id","transformers.OPTForCausalLM"),f(jt,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),f(jt,"href","#transformers.OPTForCausalLM"),f(bt,"class","relative group"),f(Lt,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),f(vt,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),f(Nt,"id","transformers.TFOPTModel"),f(Nt,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),f(Nt,"href","#transformers.TFOPTModel"),f(kt,"class","relative group"),f(rn,"href","/docs/transformers/main/en/main_classes/model#transformers.TFPreTrainedModel"),f(wo,"href","https://www.tensorflow.org/api_docs/python/tf/keras/Model"),f(wo,"rel","nofollow"),f(ln,"href","/docs/transformers/main/en/model_doc/opt#transformers.TFOPTModel"),f(Ee,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),f(pe,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),f(Wt,"id","transformers.TFOPTForCausalLM"),f(Wt,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),f(Wt,"href","#transformers.TFOPTForCausalLM"),f($t,"class","relative group"),f(dn,"href","/docs/transformers/main/en/main_classes/model#transformers.TFPreTrainedModel"),f(xo,"href","https://www.tensorflow.org/api_docs/python/tf/keras/Model"),f(xo,"rel","nofollow"),f(Ht,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),f(te,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),f(Ut,"id","transformers.OPTForSequenceClassification"),f(Ut,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),f(Ut,"href","#transformers.OPTForSequenceClassification"),f(Pt,"class","relative group"),f(pn,"href","/docs/transformers/main/en/model_doc/opt#transformers.OPTForSequenceClassification"),f(un,"href","/docs/transformers/main/en/main_classes/model#transformers.PreTrainedModel"),f(Lo,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),f(Lo,"rel","nofollow"),f(hn,"href","/docs/transformers/main/en/model_doc/opt#transformers.OPTForSequenceClassification"),f(J,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),f(U,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),f(Xt,"id","transformers.FlaxOPTModel"),f(Xt,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),f(Xt,"href","#transformers.FlaxOPTModel"),f(Ft,"class","relative group"),f(Yt,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),f(Mt,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),f(eo,"id","transformers.FlaxOPTForCausalLM"),f(eo,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),f(eo,"href","#transformers.FlaxOPTForCausalLM"),f(xt,"class","relative group"),f(mn,"href","/docs/transformers/main/en/main_classes/model#transformers.FlaxPreTrainedModel"),f(Bo,"href","https://flax.readthedocs.io/en/latest/_autosummary/flax.nn.module.html"),f(Bo,"rel","nofollow"),f(Uo,"href","https://jax.readthedocs.io/en/latest/jax.html#just-in-time-compilation-jit"),f(Uo,"rel","nofollow"),f(Ko,"href","https://jax.readthedocs.io/en/latest/jax.html#automatic-differentiation"),f(Ko,"rel","nofollow"),f(Vo,"href","https://jax.readthedocs.io/en/latest/jax.html#vectorization-vmap"),f(Vo,"rel","nofollow"),f(Zo,"href","https://jax.readthedocs.io/en/latest/jax.html#parallelization-pmap"),f(Zo,"rel","nofollow"),f(to,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),f(K,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8")},m(o,_){e(document.head,d),g(o,T,_),g(o,h,_),e(h,m),e(m,y),w(l,y,null),e(h,u),e(h,E),e(E,je),g(o,Oe,_),g(o,L,_),e(L,oe),e(oe,se),w(F,se,null),e(L,Le),e(L,X),e(X,Ae),g(o,Fe,_),g(o,W,_),e(W,Ne),e(W,ae),e(ae,re),e(W,Ie),g(o,Me,_),g(o,V,_),e(V,Se),g(o,xe,_),g(o,Z,_),e(Z,Te),e(Te,De),g(o,he,_),g(o,C,_),e(C,A),g(o,ze,_),g(o,G,_),e(G,ie),e(ie,We),e(ie,Y),e(Y,Ge),e(ie,He),e(G,N),e(G,I),e(I,le),e(I,ye),e(ye,Be),e(I,de),e(I,be),e(be,Ue),e(I,Q),e(I,ve),e(ve,ce),e(I,Ke),e(I,ne),e(ne,S),e(I,Ve),g(o,H,_),g(o,j,_),e(j,Ze),e(j,b),e(b,x),e(j,lt),e(j,ee),e(ee,dt),e(j,ct),e(j,z),e(z,pt),e(j,ut),e(j,ke),e(ke,ht),e(j,mt),g(o,R,_),g(o,D,_),e(D,me),e(me,Re),w(B,Re,null),e(D,ft),e(D,Je),e(Je,Xe),g(o,ot,_),g(o,q,_),w(we,q,null),e(q,Ks),e(q,gt),e(gt,Vs),e(gt,tn),e(tn,Zs),e(gt,Rs),e(gt,lo),e(lo,Js),e(gt,Xs),e(q,Ys),e(q,_t),e(_t,Qs),e(_t,on),e(on,ea),e(_t,ta),e(_t,nn),e(nn,oa),e(_t,na),e(q,sa),w(zt,q,null),g(o,is,_),g(o,Tt,_),e(Tt,Ct),e(Ct,bn),w(co,bn,null),e(Tt,aa),e(Tt,vn),e(vn,ra),g(o,ls,_),g(o,$e,_),w(po,$e,null),e($e,ia),e($e,uo),e(uo,la),e(uo,sn),e(sn,da),e(uo,ca),e($e,pa),e($e,ho),e(ho,ua),e(ho,mo),e(mo,ha),e(ho,ma),e($e,fa),e($e,Ce),w(fo,Ce,null),e(Ce,ga),e(Ce,yt),e(yt,_a),e(yt,an),e(an,Ta),e(yt,ya),e(yt,kn),e(kn,ba),e(yt,va),e(Ce,ka),w(Et,Ce,null),e(Ce,wa),w(qt,Ce,null),g(o,ds,_),g(o,bt,_),e(bt,jt),e(jt,wn),w(go,wn,null),e(bt,$a),e(bt,$n),e($n,Pa),g(o,cs,_),g(o,vt,_),w(_o,vt,null),e(vt,Oa),e(vt,Lt),w(To,Lt,null),e(Lt,Fa),w(At,Lt,null),g(o,ps,_),g(o,kt,_),e(kt,Nt),e(Nt,Pn),w(yo,Pn,null),e(kt,Ma),e(kt,On),e(On,xa),g(o,us,_),g(o,pe,_),w(bo,pe,null),e(pe,za),e(pe,vo),e(vo,Ca),e(vo,rn),e(rn,Ea),e(vo,qa),e(pe,ja),e(pe,ko),e(ko,La),e(ko,wo),e(wo,Aa),e(ko,Na),e(pe,Ia),w(It,pe,null),e(pe,Sa),e(pe,Ee),w($o,Ee,null),e(Ee,Da),e(Ee,wt),e(wt,Wa),e(wt,ln),e(ln,Ga),e(wt,Ha),e(wt,Fn),e(Fn,Ba),e(wt,Ua),e(Ee,Ka),w(St,Ee,null),e(Ee,Va),w(Dt,Ee,null),g(o,hs,_),g(o,$t,_),e($t,Wt),e(Wt,Mn),w(Po,Mn,null),e($t,Za),e($t,xn),e(xn,Ra),g(o,ms,_),g(o,te,_),w(Oo,te,null),e(te,Ja),e(te,zn),e(zn,Xa),e(te,Ya),e(te,Fo),e(Fo,Qa),e(Fo,dn),e(dn,er),e(Fo,tr),e(te,or),e(te,Mo),e(Mo,nr),e(Mo,xo),e(xo,sr),e(Mo,ar),e(te,rr),w(Gt,te,null),e(te,ir),e(te,Ht),w(zo,Ht,null),e(Ht,lr),w(Bt,Ht,null),g(o,fs,_),g(o,Pt,_),e(Pt,Ut),e(Ut,Cn),w(Co,Cn,null),e(Pt,dr),e(Pt,En),e(En,cr),g(o,gs,_),g(o,U,_),w(Eo,U,null),e(U,pr),e(U,qn),e(qn,ur),e(U,hr),e(U,cn),e(cn,pn),e(pn,mr),e(cn,fr),e(U,gr),e(U,Pe),e(Pe,_r),e(Pe,jn),e(jn,Tr),e(Pe,yr),e(Pe,Ln),e(Ln,br),e(Pe,vr),e(Pe,An),e(An,kr),e(Pe,wr),e(Pe,Nn),e(Nn,$r),e(Pe,Pr),e(U,Or),e(U,qo),e(qo,Fr),e(qo,un),e(un,Mr),e(qo,xr),e(U,zr),e(U,jo),e(jo,Cr),e(jo,Lo),e(Lo,Er),e(jo,qr),e(U,jr),e(U,J),w(Ao,J,null),e(J,Lr),e(J,Ot),e(Ot,Ar),e(Ot,hn),e(hn,Nr),e(Ot,Ir),e(Ot,In),e(In,Sr),e(Ot,Dr),e(J,Wr),w(Kt,J,null),e(J,Gr),w(Vt,J,null),e(J,Hr),w(Zt,J,null),e(J,Br),w(Rt,J,null),e(J,Ur),w(Jt,J,null),g(o,_s,_),g(o,Ft,_),e(Ft,Xt),e(Xt,Sn),w(No,Sn,null),e(Ft,Kr),e(Ft,Dn),e(Dn,Vr),g(o,Ts,_),g(o,Mt,_),w(Io,Mt,null),e(Mt,Zr),e(Mt,Yt),w(So,Yt,null),e(Yt,Rr),w(Qt,Yt,null),g(o,ys,_),g(o,xt,_),e(xt,eo),e(eo,Wn),w(Do,Wn,null),e(xt,Jr),e(xt,Gn),e(Gn,Xr),g(o,bs,_),g(o,K,_),w(Wo,K,null),e(K,Yr),e(K,Hn),e(Hn,Qr),e(K,ei),e(K,Go),e(Go,ti),e(Go,mn),e(mn,oi),e(Go,ni),e(K,si),e(K,Ho),e(Ho,ai),e(Ho,Bo),e(Bo,ri),e(Ho,ii),e(K,li),e(K,Bn),e(Bn,di),e(K,ci),e(K,Ye),e(Ye,Un),e(Un,Uo),e(Uo,pi),e(Ye,ui),e(Ye,Kn),e(Kn,Ko),e(Ko,hi),e(Ye,mi),e(Ye,Vn),e(Vn,Vo),e(Vo,fi),e(Ye,gi),e(Ye,Zn),e(Zn,Zo),e(Zo,_i),e(K,Ti),e(K,to),w(Ro,to,null),e(to,yi),w(oo,to,null),vs=!0},p(o,[_]){const Jo={};_&2&&(Jo.$$scope={dirty:_,ctx:o}),zt.$set(Jo);const Rn={};_&2&&(Rn.$$scope={dirty:_,ctx:o}),Et.$set(Rn);const Jn={};_&2&&(Jn.$$scope={dirty:_,ctx:o}),qt.$set(Jn);const Xn={};_&2&&(Xn.$$scope={dirty:_,ctx:o}),At.$set(Xn);const Xo={};_&2&&(Xo.$$scope={dirty:_,ctx:o}),It.$set(Xo);const Yn={};_&2&&(Yn.$$scope={dirty:_,ctx:o}),St.$set(Yn);const Qn={};_&2&&(Qn.$$scope={dirty:_,ctx:o}),Dt.$set(Qn);const es={};_&2&&(es.$$scope={dirty:_,ctx:o}),Gt.$set(es);const Yo={};_&2&&(Yo.$$scope={dirty:_,ctx:o}),Bt.$set(Yo);const ts={};_&2&&(ts.$$scope={dirty:_,ctx:o}),Kt.$set(ts);const os={};_&2&&(os.$$scope={dirty:_,ctx:o}),Vt.$set(os);const ns={};_&2&&(ns.$$scope={dirty:_,ctx:o}),Zt.$set(ns);const ss={};_&2&&(ss.$$scope={dirty:_,ctx:o}),Rt.$set(ss);const as={};_&2&&(as.$$scope={dirty:_,ctx:o}),Jt.$set(as);const Qo={};_&2&&(Qo.$$scope={dirty:_,ctx:o}),Qt.$set(Qo);const en={};_&2&&(en.$$scope={dirty:_,ctx:o}),oo.$set(en)},i(o){vs||($(l.$$.fragment,o),$(F.$$.fragment,o),$(B.$$.fragment,o),$(we.$$.fragment,o),$(zt.$$.fragment,o),$(co.$$.fragment,o),$(po.$$.fragment,o),$(fo.$$.fragment,o),$(Et.$$.fragment,o),$(qt.$$.fragment,o),$(go.$$.fragment,o),$(_o.$$.fragment,o),$(To.$$.fragment,o),$(At.$$.fragment,o),$(yo.$$.fragment,o),$(bo.$$.fragment,o),$(It.$$.fragment,o),$($o.$$.fragment,o),$(St.$$.fragment,o),$(Dt.$$.fragment,o),$(Po.$$.fragment,o),$(Oo.$$.fragment,o),$(Gt.$$.fragment,o),$(zo.$$.fragment,o),$(Bt.$$.fragment,o),$(Co.$$.fragment,o),$(Eo.$$.fragment,o),$(Ao.$$.fragment,o),$(Kt.$$.fragment,o),$(Vt.$$.fragment,o),$(Zt.$$.fragment,o),$(Rt.$$.fragment,o),$(Jt.$$.fragment,o),$(No.$$.fragment,o),$(Io.$$.fragment,o),$(So.$$.fragment,o),$(Qt.$$.fragment,o),$(Do.$$.fragment,o),$(Wo.$$.fragment,o),$(Ro.$$.fragment,o),$(oo.$$.fragment,o),vs=!0)},o(o){P(l.$$.fragment,o),P(F.$$.fragment,o),P(B.$$.fragment,o),P(we.$$.fragment,o),P(zt.$$.fragment,o),P(co.$$.fragment,o),P(po.$$.fragment,o),P(fo.$$.fragment,o),P(Et.$$.fragment,o),P(qt.$$.fragment,o),P(go.$$.fragment,o),P(_o.$$.fragment,o),P(To.$$.fragment,o),P(At.$$.fragment,o),P(yo.$$.fragment,o),P(bo.$$.fragment,o),P(It.$$.fragment,o),P($o.$$.fragment,o),P(St.$$.fragment,o),P(Dt.$$.fragment,o),P(Po.$$.fragment,o),P(Oo.$$.fragment,o),P(Gt.$$.fragment,o),P(zo.$$.fragment,o),P(Bt.$$.fragment,o),P(Co.$$.fragment,o),P(Eo.$$.fragment,o),P(Ao.$$.fragment,o),P(Kt.$$.fragment,o),P(Vt.$$.fragment,o),P(Zt.$$.fragment,o),P(Rt.$$.fragment,o),P(Jt.$$.fragment,o),P(No.$$.fragment,o),P(Io.$$.fragment,o),P(So.$$.fragment,o),P(Qt.$$.fragment,o),P(Do.$$.fragment,o),P(Wo.$$.fragment,o),P(Ro.$$.fragment,o),P(oo.$$.fragment,o),vs=!1},d(o){t(d),o&&t(T),o&&t(h),O(l),o&&t(Oe),o&&t(L),O(F),o&&t(Fe),o&&t(W),o&&t(Me),o&&t(V),o&&t(xe),o&&t(Z),o&&t(he),o&&t(C),o&&t(ze),o&&t(G),o&&t(H),o&&t(j),o&&t(R),o&&t(D),O(B),o&&t(ot),o&&t(q),O(we),O(zt),o&&t(is),o&&t(Tt),O(co),o&&t(ls),o&&t($e),O(po),O(fo),O(Et),O(qt),o&&t(ds),o&&t(bt),O(go),o&&t(cs),o&&t(vt),O(_o),O(To),O(At),o&&t(ps),o&&t(kt),O(yo),o&&t(us),o&&t(pe),O(bo),O(It),O($o),O(St),O(Dt),o&&t(hs),o&&t($t),O(Po),o&&t(ms),o&&t(te),O(Oo),O(Gt),O(zo),O(Bt),o&&t(fs),o&&t(Pt),O(Co),o&&t(gs),o&&t(U),O(Eo),O(Ao),O(Kt),O(Vt),O(Zt),O(Rt),O(Jt),o&&t(_s),o&&t(Ft),O(No),o&&t(Ts),o&&t(Mt),O(Io),O(So),O(Qt),o&&t(ys),o&&t(xt),O(Do),o&&t(bs),o&&t(K),O(Wo),O(Ro),O(oo)}}}const ad={local:"opt",sections:[{local:"overview",title:"Overview"},{local:"transformers.OPTConfig",title:"OPTConfig"},{local:"transformers.OPTModel",title:"OPTModel"},{local:"transformers.OPTForCausalLM",title:"OPTForCausalLM"},{local:"transformers.TFOPTModel",title:"TFOPTModel"},{local:"transformers.TFOPTForCausalLM",title:"TFOPTForCausalLM"},{local:"transformers.OPTForSequenceClassification",title:"OPTForSequenceClassification"},{local:"transformers.FlaxOPTModel",title:"FlaxOPTModel"},{local:"transformers.FlaxOPTForCausalLM",title:"FlaxOPTForCausalLM"}],title:"OPT"};function rd(M){return Wl(()=>{new URLSearchParams(window.location.search).get("fw")}),[]}class hd extends Nl{constructor(d){super();Il(this,d,rd,sd,Sl,{})}}export{hd as default,ad as metadata};
