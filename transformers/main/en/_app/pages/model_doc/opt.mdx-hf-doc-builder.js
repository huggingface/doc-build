...
<span class="hljs-meta">&gt;&gt;&gt; </span>configuration = model.config`}}),{c(){d=n("p"),T=r("Example:"),h=c(),b(m.$$.fragment)},l(l){d=s(l,"P",{});var u=a(d);T=i(u,"Example:"),u.forEach(t),h=p(l),k(m.$$.fragment,l)},m(l,u){g(l,d,u),e(d,T),g(l,h,u),w(m,l,u),y=!0},p:et,i(l){y||($(m.$$.fragment,l),y=!0)},o(l){P(m.$$.fragment,l),y=!1},d(l){l&&t(d),l&&t(h),O(m,l)}}}function Hl(M){let d,T,h,m,y;return{c(){d=n("p"),T=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),h=n("code"),m=r("Module"),y=r(`
...
`),le=n("code"),ye=r("model([input_ids, attention_mask])"),Be=r(" or "),de=n("code"),ve=r("model([input_ids, attention_mask, token_type_ids])"),Ue=c(),Q=n("li"),be=r(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
...
about any of this, as you can just pass inputs like you would to any other Python function!`),this.h()},l(v){d=s(v,"P",{});var x=a(d);T=i(x,"TensorFlow models and layers in "),h=s(x,"CODE",{});var lt=a(h);m=i(lt,"transformers"),lt.forEach(t),y=i(x," accept two formats as input:"),x.forEach(t),l=p(v),u=s(v,"UL",{});var ee=a(u);E=s(ee,"LI",{});var dt=a(E);je=i(dt,"having all inputs as keyword arguments (like PyTorch models), or"),dt.forEach(t),Oe=p(ee),L=s(ee,"LI",{});var ct=a(L);oe=i(ct,"having all inputs as a list, tuple or dict in the first positional argument."),ct.forEach(t),ee.forEach(t),se=p(v),F=s(v,"P",{});var C=a(F);Le=i(C,`The reason the second format is supported is that Keras methods prefer this format when passing inputs to models
...
`),ce=s(Xe,"CODE",{});var ot=a(ce);Ve=i(ot,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),ot.forEach(t),Xe.forEach(t),R.forEach(t),ne=p(v),S=s(v,"P",{});var q=a(S);Ke=i(q,`Note that when creating models and layers with
`),H=s(q,"A",{href:!0,rel:!0});var we=a(H);j=i(we,"subclassing"),we.forEach(t),Ze=i(q,` then you don\u2019t need to worry
about any of this, as you can just pass inputs like you would to any other Python function!`),q.forEach(t),this.h()},h(){f(H,"href","https://keras.io/guides/making_new_layers_and_models_via_subclassing/"),f(H,"rel","nofollow")},m(v,x){g(v,d,x),e(d,T),e(d,h),e(h,m),e(d,y),g(v,l,x),g(v,u,x),e(u,E),e(E,je),e(u,Oe),e(u,L),e(L,oe),g(v,se,x),g(v,F,x),e(F,Le),e(F,X),e(X,Ae),e(F,Fe),e(F,W),e(W,Ne),e(F,ae),e(F,re),e(re,Ie),e(F,Me),e(F,K),e(K,Se),e(F,xe),e(F,Z),e(Z,Te),e(F,De),g(v,he,x),g(v,z,x),e(z,A),e(A,Ce),e(A,G),e(G,ie),e(A,We),e(A,Y),e(Y,Ge),e(z,He),e(z,N),e(N,I),e(N,le),e(le,ye),e(N,Be),e(N,de),e(de,ve),e(z,Ue),e(z,Q),e(Q,be),e(Q,ce),e(ce,Ve),g(v,ne,x),g(v,S,x),e(S,Ke),e(S,H),e(H,j),e(S,Ze)},d(v){v&&t(d),v&&t(l),v&&t(u),v&&t(se),v&&t(F),v&&t(he),v&&t(z),v&&t(ne),v&&t(S)}}}function Kl(M){let d,T,h,m,y;return{c(){d=n("p"),T=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),h=n("code"),m=r("Module"),y=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(l){d=s(l,"P",{});var u=a(d);T=i(u,"Although the recipe for forward pass needs to be defined within this function, one should call the "),h=s(u,"CODE",{});var E=a(h);m=i(E,"Module"),E.forEach(t),y=i(u,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),{c(){d=n("p"),T=r("Example:"),h=c(),b(m.$$.fragment)},l(l){d=s(l,"P",{});var u=a(d);T=i(u,"Example:"),u.forEach(t),h=p(l),k(m.$$.fragment,l)},m(l,u){g(l,d,u),e(d,T),g(l,h,u),w(m,l,u),y=!0},p:et,i(l){y||($(m.$$.fragment,l),y=!0)},o(l){P(m.$$.fragment,l),y=!1},d(l){l&&t(d),l&&t(h),O(m,l)}}}function Rl(M){let d,T,h,m,y,l,u,E,je,Oe,L,oe,se,F,Le,X,Ae,Fe,W,Ne,ae,re,Ie,Me,K,Se,xe,Z,Te,De,he,z,A,Ce,G,ie,We,Y,Ge,He,N,I,le,ye,Be,de,ve,Ue,Q,be,ce,Ve,ne,S,Ke,H,j,Ze;return{c(){d=n("p"),T=r("TensorFlow models and layers in "),h=n("code"),m=r("transformers"),y=r(" accept two formats as input:"),l=c(),u=n("ul"),E=n("li"),je=r("having all inputs as keyword arguments (like PyTorch models), or"),Oe=c(),L=n("li"),oe=r("having all inputs as a list, tuple or dict in the first positional argument."),se=c(),F=n("p"),Le=r(`The reason the second format is supported is that Keras methods prefer this format when passing inputs to models
and layers. Because of this support, when using methods like `),X=n("code"),Ae=r("model.fit()"),Fe=r(` things should \u201Cjust work\u201D for you - just
pass your inputs and labels in any format that `),W=n("code"),Ne=r("model.fit()"),ae=r(` supports! If, however, you want to use the second
format outside of Keras methods like `),re=n("code"),Ie=r("fit()"),Me=r(" and "),K=n("code"),Se=r("predict()"),xe=r(`, such as when creating your own layers or models with
the Keras `),Z=n("code"),Te=r("Functional"),De=r(` API, there are three possibilities you can use to gather all the input Tensors in the first
...
`),ce=s(Xe,"CODE",{});var ot=a(ce);Ve=i(ot,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),ot.forEach(t),Xe.forEach(t),R.forEach(t),ne=p(v),S=s(v,"P",{});var q=a(S);Ke=i(q,`Note that when creating models and layers with
`),H=s(q,"A",{href:!0,rel:!0});var we=a(H);j=i(we,"subclassing"),we.forEach(t),Ze=i(q,` then you don\u2019t need to worry
about any of this, as you can just pass inputs like you would to any other Python function!`),q.forEach(t),this.h()},h(){f(H,"href","https://keras.io/guides/making_new_layers_and_models_via_subclassing/"),f(H,"rel","nofollow")},m(v,x){g(v,d,x),e(d,T),e(d,h),e(h,m),e(d,y),g(v,l,x),g(v,u,x),e(u,E),e(E,je),e(u,Oe),e(u,L),e(L,oe),g(v,se,x),g(v,F,x),e(F,Le),e(F,X),e(X,Ae),e(F,Fe),e(F,W),e(W,Ne),e(F,ae),e(F,re),e(re,Ie),e(F,Me),e(F,K),e(K,Se),e(F,xe),e(F,Z),e(Z,Te),e(F,De),g(v,he,x),g(v,z,x),e(z,A),e(A,Ce),e(A,G),e(G,ie),e(A,We),e(A,Y),e(Y,Ge),e(z,He),e(z,N),e(N,I),e(N,le),e(le,ye),e(N,Be),e(N,de),e(de,ve),e(z,Ue),e(z,Q),e(Q,be),e(Q,ce),e(ce,Ve),g(v,ne,x),g(v,S,x),e(S,Ke),e(S,H),e(H,j),e(S,Ze)},d(v){v&&t(d),v&&t(l),v&&t(u),v&&t(se),v&&t(F),v&&t(he),v&&t(z),v&&t(ne),v&&t(S)}}}function Jl(M){let d,T,h,m,y;return m=new tt({props:{code:`from transformers import GPT2Tokenizer, TFOPTForCausalLM
import tensorflow as tf
...
<span class="hljs-number">1.71</span>`}}),{c(){b(d.$$.fragment)},l(h){k(d.$$.fragment,h)},m(h,m){w(d,h,m),T=!0},p:et,i(h){T||($(d.$$.fragment,h),T=!0)},o(h){P(d.$$.fragment,h),T=!1},d(h){O(d,h)}}}function ed(M){let d,T,h,m,y;return m=new tt({props:{code:`import torch
from transformers import GPT2Tokenizer, OPTForSequenceClassification
...
<span class="hljs-meta">&gt;&gt;&gt; </span>predicted_class_id = logits.argmax().item()
<span class="hljs-meta">&gt;&gt;&gt; </span>model.config.id2label[predicted_class_id]
<span class="hljs-string">&#x27;LABEL_0&#x27;</span>`}}),{c(){d=n("p"),T=r("Example of multi-label classification:"),h=c(),b(m.$$.fragment)},l(l){d=s(l,"P",{});var u=a(d);T=i(u,"Example of multi-label classification:"),u.forEach(t),h=p(l),k(m.$$.fragment,l)},m(l,u){g(l,d,u),e(d,T),g(l,h,u),w(m,l,u),y=!0},p:et,i(l){y||($(m.$$.fragment,l),y=!0)},o(l){P(m.$$.fragment,l),y=!1},d(l){l&&t(d),l&&t(h),O(m,l)}}}function td(M){let d,T;return d=new tt({props:{code:`# To train a model on \`num_labels\` classes, you can pass \`num_labels=num_labels\` to \`.from_pretrained(...)\`
num_labels = len(model.config.id2label)
...
<span class="hljs-meta">... </span>)
<span class="hljs-meta">&gt;&gt;&gt; </span>loss = model(**inputs, labels=labels).loss
<span class="hljs-meta">&gt;&gt;&gt; </span>loss.backward()`}}),{c(){b(d.$$.fragment)},l(h){k(d.$$.fragment,h)},m(h,m){w(d,h,m),T=!0},p:et,i(h){T||($(d.$$.fragment,h),T=!0)},o(h){P(d.$$.fragment,h),T=!1},d(h){O(d,h)}}}function od(M){let d,T,h,m,y;return m=new tt({props:{code:`from transformers import GPT2Tokenizer, FlaxOPTModel
...
<span class="hljs-meta">&gt;&gt;&gt; </span>next_token_logits = outputs.logits[:, -<span class="hljs-number">1</span>]`}}),{c(){d=n("p"),T=r("Example:"),h=c(),b(m.$$.fragment)},l(l){d=s(l,"P",{});var u=a(d);T=i(u,"Example:"),u.forEach(t),h=p(l),k(m.$$.fragment,l)},m(l,u){g(l,d,u),e(d,T),g(l,h,u),w(m,l,u),y=!0},p:et,i(l){y||($(m.$$.fragment,l),y=!0)},o(l){P(m.$$.fragment,l),y=!1},d(l){l&&t(d),l&&t(h),O(m,l)}}}function sd(M){let d,T,h,m,y,l,u,E,je,Oe,L,oe,se,F,Le,X,Ae,Fe,W,Ne,ae,re,Ie,Me,K,Se,xe,Z,Te,De,he,z,A,Ce,G,ie,We,Y,Ge,He,N,I,le,ye,Be,de,ve,Ue,Q,be,ce,Ve,ne,S,Ke,H,j,Ze,v,x,lt,ee,dt,ct,C,pt,ut,ke,ht,mt,R,D,me,Re,B,ft,Je,Xe,ot,q,we,Vs,gt,Ks,tn,Zs,Rs,lo,Js,Xs,Ys,_t,Qs,on,ea,ta,nn,oa,na,sa,Ct,is,Tt,zt,vn,co,aa,bn,ra,ls,$e,po,ia,uo,la,sn,da,ca,pa,ho,ua,mo,ha,ma,fa,ze,fo,ga,yt,_a,an,Ta,ya,kn,va,ba,ka,Et,wa,qt,ds,vt,jt,wn,go,$a,$n,Pa,cs,bt,_o,Oa,Lt,To,Fa,At,ps,kt,Nt,Pn,yo,Ma,On,xa,us,pe,vo,Ca,bo,za,rn,Ea,qa,ja,ko,La,wo,Aa,Na,Ia,It,Sa,Ee,$o,Da,wt,Wa,ln,Ga,Ha,Fn,Ba,Ua,Va,St,Ka,Dt,hs,$t,Wt,Mn,Po,Za,xn,Ra,ms,te,Oo,Ja,Cn,Xa,Ya,Fo,Qa,dn,er,tr,or,Mo,nr,xo,sr,ar,rr,Gt,ir,Ht,Co,lr,Bt,fs,Pt,Ut,zn,zo,dr,En,cr,gs,U,Eo,pr,qn,ur,hr,cn,pn,mr,fr,gr,Pe,_r,jn,Tr,yr,Ln,vr,br,An,kr,wr,Nn,$r,Pr,Or,qo,Fr,un,Mr,xr,Cr,jo,zr,Lo,Er,qr,jr,J,Ao,Lr,Ot,Ar,hn,Nr,Ir,In,Sr,Dr,Wr,Vt,Gr,Kt,Hr,Zt,Br,Rt,Ur,Jt,_s,Ft,Xt,Sn,No,Vr,Dn,Kr,Ts,Mt,Io,Zr,Yt,So,Rr,Qt,ys,xt,eo,Wn,Do,Jr,Gn,Xr,vs,V,Wo,Yr,Hn,Qr,ei,Go,ti,mn,oi,ni,si,Ho,ai,Bo,ri,ii,li,Bn,di,ci,Ye,Un,Uo,pi,ui,Vn,Vo,hi,mi,Kn,Ko,fi,gi,Zn,Zo,_i,Ti,to,Ro,yi,oo,bs;return l=new it({}),F=new it({}),B=new it({}),we=new ue({props:{name:"class transformers.OPTConfig",anchor:"transformers.OPTConfig",parameters:[{name:"vocab_size",val:" = 50272"},{name:"hidden_size",val:" = 768"},{name:"num_hidden_layers",val:" = 12"},{name:"ffn_dim",val:" = 3072"},{name:"max_position_embeddings",val:" = 2048"},{name:"do_layer_norm_before",val:" = True"},{name:"_remove_final_layer_norm",val:" = False"},{name:"word_embed_proj_dim",val:" = None"},{name:"dropout",val:" = 0.1"},{name:"attention_dropout",val:" = 0.0"},{name:"num_attention_heads",val:" = 12"},{name:"activation_function",val:" = 'relu'"},{name:"layerdrop",val:" = 0.0"},{name:"init_std",val:" = 0.02"},{name:"use_cache",val:" = True"},{name:"pad_token_id",val:" = 1"},{name:"bos_token_id",val:" = 2"},{name:"eos_token_id",val:" = 2"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.OPTConfig.vocab_size",description:`<strong>vocab_size</strong> (<code>int</code>, <em>optional</em>, defaults to 50272) &#x2014;
...
<p><a
  href="/docs/transformers/main/en/main_classes/output#transformers.modeling_flax_outputs.FlaxBaseModelOutput"
>transformers.modeling_flax_outputs.FlaxBaseModelOutput</a> or <code>tuple(torch.FloatTensor)</code></p>
`}}),oo=new Qe({props:{anchor:"transformers.FlaxOPTForCausalLM.__call__.example",$$slots:{default:[nd]},$$scope:{ctx:M}}}),{c(){d=n("meta"),T=c(),h=n("h1"),m=n("a"),y=n("span"),b(l.$$.fragment),u=c(),E=n("span"),je=r("OPT"),Oe=c(),L=n("h2"),oe=n("a"),se=n("span"),b(F.$$.fragment),Le=c(),X=n("span"),Ae=r("Overview"),Fe=c(),W=n("p"),Ne=r("The OPT model was proposed in "),ae=n("a"),re=r("Open Pre-trained Transformer Language Models"),Ie=r(` by Meta AI.
OPT is a series of open-sourced large causal language models which perform similar in performance to GPT3.`),Me=c(),K=n("p"),Se=r("The abstract from the paper is the following:"),xe=c(),Z=n("p"),Te=n("em"),De=r("Large language models, which are often trained for hundreds of thousands of compute days, have shown remarkable capabilities for zero- and few-shot learning. Given their computational cost, these models are difficult to replicate without significant capital. For the few that are available through APIs, no access is granted to the full model weights, making them difficult to study. We present Open Pre-trained Transformers (OPT), a suite of decoder-only pre-trained transformers ranging from 125M to 175B parameters, which we aim to fully and responsibly share with interested researchers. We show that OPT-175B is comparable to GPT-3, while requiring only 1/7th the carbon footprint to develop. We are also releasing our logbook detailing the infrastructure challenges we faced, along with code for experimenting with all of the released models."),he=c(),z=n("p"),A=r("Tips:"),Ce=c(),G=n("ul"),ie=n("li"),We=r("OPT has the same architecture as "),Y=n("code"),Ge=r("BartDecoder"),He=r("."),N=c(),I=n("li"),le=r("Contrary to GPT2, OPT adds the EOS token "),ye=n("code"),Be=r("</s>"),de=r(" to the beginning of every prompt. "),ve=n("strong"),Ue=r("Note"),Q=r(": Make sure to pass "),be=n("code"),ce=r("use_fast=False"),Ve=r(" when loading OPT\u2019s tokenizer with "),ne=n("a"),S=r("AutoTokenizer"),Ke=r(" to get the correct tokenizer."),H=c(),j=n("p"),Ze=r("This model was contributed by "),v=n("a"),x=r("Arthur Zucker"),lt=r(", "),ee=n("a"),dt=r("Younes Belkada"),ct=r(", and "),C=n("a"),pt=r("Patrick Von Platen"),ut=r(`.
...
documentation from `),nn=n("a"),oa=r("PretrainedConfig"),na=r(" for more information."),sa=c(),b(Ct.$$.fragment),is=c(),Tt=n("h2"),zt=n("a"),vn=n("span"),b(co.$$.fragment),aa=c(),bn=n("span"),ra=r("OPTModel"),ls=c(),$e=n("div"),b(po.$$.fragment),ia=c(),uo=n("p"),la=r(`The bare OPT Model outputting raw hidden-states without any specific head on top.
...
and behavior.`),fa=c(),ze=n("div"),b(fo.$$.fragment),ga=c(),yt=n("p"),_a=r("The "),an=n("a"),Ta=r("OPTModel"),ya=r(" forward method, overrides the "),kn=n("code"),va=r("__call__"),ba=r(" special method."),ka=c(),b(Et.$$.fragment),wa=c(),b(qt.$$.fragment),ds=c(),vt=n("h2"),jt=n("a"),wn=n("span"),b(go.$$.fragment),$a=c(),$n=n("span"),Pa=r("OPTForCausalLM"),cs=c(),bt=n("div"),b(_o.$$.fragment),Oa=c(),Lt=n("div"),b(To.$$.fragment),Fa=c(),b(At.$$.fragment),ps=c(),kt=n("h2"),Nt=n("a"),Pn=n("span"),b(yo.$$.fragment),Ma=c(),On=n("span"),xa=r("TFOPTModel"),us=c(),pe=n("div"),b(vo.$$.fragment),Ca=c(),bo=n("p"),za=r(`The bare TF OPT Model outputting raw hidden-states without any specific head on top.
...
no `),Ln=n("code"),vr=r("pad_token_id"),br=r(` is defined, it simply takes the last value in each row of the batch. Since it cannot guess the
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),jr=c(),J=n("div"),b(Ao.$$.fragment),Lr=c(),Ot=n("p"),Ar=r("The "),hn=n("a"),Nr=r("OPTForSequenceClassification"),Ir=r(" forward method, overrides the "),In=n("code"),Sr=r("__call__"),Dr=r(" special method."),Wr=c(),b(Vt.$$.fragment),Gr=c(),b(Kt.$$.fragment),Hr=c(),b(Zt.$$.fragment),Br=c(),b(Rt.$$.fragment),Ur=c(),b(Jt.$$.fragment),_s=c(),Ft=n("h2"),Xt=n("a"),Sn=n("span"),b(No.$$.fragment),Vr=c(),Dn=n("span"),Kr=r("FlaxOPTModel"),Ts=c(),Mt=n("div"),b(Io.$$.fragment),Zr=c(),Yt=n("div"),b(So.$$.fragment),Rr=c(),b(Qt.$$.fragment),ys=c(),xt=n("h2"),eo=n("a"),Wn=n("span"),b(Do.$$.fragment),Jr=c(),Gn=n("span"),Xr=r("FlaxOPTForCausalLM"),vs=c(),V=n("div"),b(Wo.$$.fragment),Yr=c(),Hn=n("p"),Qr=r(`OPT Model with a language modeling head on top (linear layer with weights tied to the input embeddings) e.g for
...
documentation from `),nn=s(gn,"A",{href:!0});var Ai=a(nn);oa=i(Ai,"PretrainedConfig"),Ai.forEach(t),na=i(gn," for more information."),gn.forEach(t),sa=p(no),k(Ct.$$.fragment,no),no.forEach(t),is=p(o),Tt=s(o,"H2",{class:!0});var ws=a(Tt);zt=s(ws,"A",{id:!0,class:!0,href:!0});var Ni=a(zt);vn=s(Ni,"SPAN",{});var Ii=a(vn);k(co.$$.fragment,Ii),Ii.forEach(t),Ni.forEach(t),aa=p(ws),bn=s(ws,"SPAN",{});var Si=a(bn);ra=i(Si,"OPTModel"),Si.forEach(t),ws.forEach(t),ls=p(o),$e=s(o,"DIV",{class:!0});var so=a($e);k(po.$$.fragment,so),ia=p(so),uo=s(so,"P",{});var $s=a(uo);la=i($s,`The bare OPT Model outputting raw hidden-states without any specific head on top.
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Ps.forEach(t),fa=p(so),ze=s(so,"DIV",{class:!0});var ao=a(ze);k(fo.$$.fragment,ao),ga=p(ao),yt=s(ao,"P",{});var _n=a(yt);_a=i(_n,"The "),an=s(_n,"A",{href:!0});var Gi=a(an);Ta=i(Gi,"OPTModel"),Gi.forEach(t),ya=i(_n," forward method, overrides the "),kn=s(_n,"CODE",{});var Hi=a(kn);va=i(Hi,"__call__"),Hi.forEach(t),ba=i(_n," special method."),_n.forEach(t),ka=p(ao),k(Et.$$.fragment,ao),wa=p(ao),k(qt.$$.fragment,ao),ao.forEach(t),so.forEach(t),ds=p(o),vt=s(o,"H2",{class:!0});var Os=a(vt);jt=s(Os,"A",{id:!0,class:!0,href:!0});var Bi=a(jt);wn=s(Bi,"SPAN",{});var Ui=a(wn);k(go.$$.fragment,Ui),Ui.forEach(t),Bi.forEach(t),$a=p(Os),$n=s(Os,"SPAN",{});var Vi=a($n);Pa=i(Vi,"OPTForCausalLM"),Vi.forEach(t),Os.forEach(t),cs=p(o),bt=s(o,"DIV",{class:!0});var Fs=a(bt);k(_o.$$.fragment,Fs),Oa=p(Fs),Lt=s(Fs,"DIV",{class:!0});var Ms=a(Lt);k(To.$$.fragment,Ms),Fa=p(Ms),k(At.$$.fragment,Ms),Ms.forEach(t),Fs.forEach(t),ps=p(o),kt=s(o,"H2",{class:!0});var xs=a(kt);Nt=s(xs,"A",{id:!0,class:!0,href:!0});var Ki=a(Nt);Pn=s(Ki,"SPAN",{});var Zi=a(Pn);k(yo.$$.fragment,Zi),Zi.forEach(t),Ki.forEach(t),Ma=p(xs),On=s(xs,"SPAN",{});var Ri=a(On);xa=i(Ri,"TFOPTModel"),Ri.forEach(t),xs.forEach(t),us=p(o),pe=s(o,"DIV",{class:!0});var at=a(pe);k(vo.$$.fragment,at),Ca=p(at),bo=s(at,"P",{});var Cs=a(bo);za=i(Cs,`The bare TF OPT Model outputting raw hidden-states without any specific head on top.
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),js.forEach(t),rr=p(qe),k(Gt.$$.fragment,qe),ir=p(qe),Ht=s(qe,"DIV",{class:!0});var Ls=a(Ht);k(Co.$$.fragment,Ls),lr=p(Ls),k(Bt.$$.fragment,Ls),Ls.forEach(t),qe.forEach(t),fs=p(o),Pt=s(o,"H2",{class:!0});var As=a(Pt);Ut=s(As,"A",{id:!0,class:!0,href:!0});var rl=a(Ut);zn=s(rl,"SPAN",{});var il=a(zn);k(zo.$$.fragment,il),il.forEach(t),rl.forEach(t),dr=p(As),En=s(As,"SPAN",{});var ll=a(En);cr=i(ll,"OPTForSequenceClassification"),ll.forEach(t),As.forEach(t),gs=p(o),U=s(o,"DIV",{class:!0});var fe=a(U);k(Eo.$$.fragment,fe),pr=p(fe),qn=s(fe,"P",{});var dl=a(qn);ur=i(dl,"The OPT Model transformer with a sequence classification head on top (linear layer)."),dl.forEach(t),hr=p(fe),cn=s(fe,"P",{});var vi=a(cn);pn=s(vi,"A",{href:!0});var cl=a(pn);mr=i(cl,"OPTForSequenceClassification"),cl.forEach(t),fr=i(vi,` uses the last token in order to do the classification, as other causal models
(e.g. GPT-2) do.`),vi.forEach(t),gr=p(fe),Pe=s(fe,"P",{});var rt=a(Pe);_r=i(rt,`Since it does classification on the last token, it requires to know the position of the last token. If a
...
no `),Ln=s(rt,"CODE",{});var ul=a(Ln);vr=i(ul,"pad_token_id"),ul.forEach(t),br=i(rt,` is defined, it simply takes the last value in each row of the batch. Since it cannot guess the
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Is.forEach(t),jr=p(fe),J=s(fe,"DIV",{class:!0});var ge=a(J);k(Ao.$$.fragment,ge),Lr=p(ge),Ot=s(ge,"P",{});var yn=a(Ot);Ar=i(yn,"The "),hn=s(yn,"A",{href:!0});var _l=a(hn);Nr=i(_l,"OPTForSequenceClassification"),_l.forEach(t),Ir=i(yn," forward method, overrides the "),In=s(yn,"CODE",{});var Tl=a(In);Sr=i(Tl,"__call__"),Tl.forEach(t),Dr=i(yn," special method."),yn.forEach(t),Wr=p(ge),k(Vt.$$.fragment,ge),Gr=p(ge),k(Kt.$$.fragment,ge),Hr=p(ge),k(Zt.$$.fragment,ge),Br=p(ge),k(Rt.$$.fragment,ge),Ur=p(ge),k(Jt.$$.fragment,ge),ge.forEach(t),fe.forEach(t),_s=p(o),Ft=s(o,"H2",{class:!0});var Ss=a(Ft);Xt=s(Ss,"A",{id:!0,class:!0,href:!0});var yl=a(Xt);Sn=s(yl,"SPAN",{});var vl=a(Sn);k(No.$$.fragment,vl),vl.forEach(t),yl.forEach(t),Vr=p(Ss),Dn=s(Ss,"SPAN",{});var bl=a(Dn);Kr=i(bl,"FlaxOPTModel"),bl.forEach(t),Ss.forEach(t),Ts=p(o),Mt=s(o,"DIV",{class:!0});var Ds=a(Mt);k(Io.$$.fragment,Ds),Zr=p(Ds),Yt=s(Ds,"DIV",{class:!0});var Ws=a(Yt);k(So.$$.fragment,Ws),Rr=p(Ws),k(Qt.$$.fragment,Ws),Ws.forEach(t),Ds.forEach(t),ys=p(o),xt=s(o,"H2",{class:!0});var Gs=a(xt);eo=s(Gs,"A",{id:!0,class:!0,href:!0});var kl=a(eo);Wn=s(kl,"SPAN",{});var wl=a(Wn);k(Do.$$.fragment,wl),wl.forEach(t),kl.forEach(t),Jr=p(Gs),Gn=s(Gs,"SPAN",{});var $l=a(Gn);Xr=i($l,"FlaxOPTForCausalLM"),$l.forEach(t),Gs.forEach(t),vs=p(o),V=s(o,"DIV",{class:!0});var _e=a(V);k(Wo.$$.fragment,_e),Yr=p(_e),Hn=s(_e,"P",{});var Pl=a(Hn);Qr=i(Pl,`OPT Model with a language modeling head on top (linear layer with weights tied to the input embeddings) e.g for
