...
`),E=n("code"),Oe=i('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(T){d=a(T,"P",{});var F=s(d);y=l(F,"TF 2.0 models accepts two formats as inputs:"),F.forEach(t),_=h(T),c=a(T,"UL",{});var le=s(c);v=a(le,"LI",{});var Me=s(v);r=l(Me,"having all inputs as keyword arguments (like PyTorch models), or"),Me.forEach(t),f=h(le),q=a(le,"LI",{});var Le=s(q);ve=l(Le,"having all inputs as a list, tuple or dict in the first positional arguments."),Le.forEach(t),le.forEach(t),oe=h(T),M=a(T,"P",{});var H=s(M);V=l(H,"This second option is useful when using "),D=a(H,"CODE",{});var Fe=s(D);J=l(Fe,"tf.keras.Model.fit"),Fe.forEach(t),ye=l(H,` method which currently requires having all the
tensors in the first argument of the model call function: `),S=a(H,"CODE",{});var Ne=s(S);be=l(Ne,"model(inputs)"),Ne.forEach(t),he=l(H,"."),H.forEach(t),A=h(T),W=a(T,"P",{});var Ie=s(W);Z=l(Ie,`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
...
Whether or not to return a <a href="/docs/transformers/main/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/opt/modeling_opt.py#L745",returnDescription:`
<p>A <a
...
Whether or not to return a <a href="/docs/transformers/main/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/opt/modeling_opt.py#L828",returnDescription:`
<p>A <a
...
behaviors between training and evaluation).`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/opt/modeling_tf_opt.py#L796",returnDescription:`
<p>A <a
...
Whether or not to return a <a href="/docs/transformers/main/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/opt/modeling_tf_opt.py#L895",returnDescription:`
<p>A <a
...
`),jt=n("a"),da=i("facebook/opt-350m"),ca=i(" architecture."),pa=u(),Be=n("p"),ua=i("Configuration objects inherit from "),ko=n("a"),ha=i("PretrainedConfig"),ma=i(` and can be used to control the model outputs. Read the
documentation from `),wo=n("a"),fa=i("PretrainedConfig"),ga=i(" for more information."),_a=u(),b(ot.$$.fragment),mn=u(),He=n("h2"),nt=n("a"),No=n("span"),b(qt.$$.fragment),Ta=u(),Io=n("span"),va=i("OPTModel"),fn=u(),pe=n("div"),b(Lt.$$.fragment),ya=u(),Nt=n("p"),ba=i(`The bare OPT Model outputting raw hidden-states without any specific head on top.
...
etc.)`),Pa=u(),It=n("p"),$a=i("This model is also a PyTorch "),At=n("a"),Oa=i("torch.nn.Module"),Ma=i(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Fa=u(),ge=n("div"),b(Dt.$$.fragment),xa=u(),Ue=n("p"),za=i("The "),$o=n("a"),Ea=i("OPTModel"),Ca=i(" forward method, overrides the "),Ao=n("code"),ja=i("__call__"),qa=i(" special method."),La=u(),b(at.$$.fragment),Na=u(),b(st.$$.fragment),gn=u(),Ve=n("h2"),rt=n("a"),Do=n("span"),b(St.$$.fragment),Ia=u(),So=n("span"),Aa=i("OPTForCausalLM"),_n=u(),Re=n("div"),b(Wt.$$.fragment),Da=u(),it=n("div"),b(Gt.$$.fragment),Sa=u(),b(lt.$$.fragment),Tn=u(),Ke=n("h2"),dt=n("a"),Wo=n("span"),b(Bt.$$.fragment),Wa=u(),Go=n("span"),Ga=i("TFOPTModel"),vn=u(),te=n("div"),b(Ht.$$.fragment),Ba=u(),Ut=n("p"),Ha=i(`The bare TF OPT Model outputting raw hidden-states without any specific head on top.
This model inherits from `),Oo=n("a"),Ua=i("TFPreTrainedModel"),Va=i(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Ra=u(),Vt=n("p"),Ka=i("This model is also a "),Rt=n("a"),Ja=i("tf.keras.Model"),Za=i(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Xa=u(),b(ct.$$.fragment),Ya=u(),_e=n("div"),b(Kt.$$.fragment),Qa=u(),Je=n("p"),es=i("The "),Mo=n("a"),ts=i("TFOPTModel"),os=i(" forward method, overrides the "),Bo=n("code"),ns=i("__call__"),as=i(" special method."),ss=u(),b(pt.$$.fragment),rs=u(),b(ut.$$.fragment),yn=u(),Ze=n("h2"),ht=n("a"),Ho=n("span"),b(Jt.$$.fragment),is=u(),Uo=n("span"),ls=i("TFOPTForCausalLM"),bn=u(),U=n("div"),b(Zt.$$.fragment),ds=u(),Vo=n("p"),cs=i("The OPT Model transformer with a language modeling head on top."),ps=u(),Xt=n("p"),us=i("This model inherits from "),Fo=n("a"),hs=i("TFPreTrainedModel"),ms=i(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),fs=u(),Yt=n("p"),gs=i("This model is also a "),Qt=n("a"),_s=i("tf.keras.Model"),Ts=i(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),vs=u(),b(mt.$$.fragment),ys=u(),ft=n("div"),b(eo.$$.fragment),bs=u(),b(gt.$$.fragment),kn=u(),Xe=n("h2"),_t=n("a"),Ro=n("span"),b(to.$$.fragment),ks=u(),Ko=n("span"),ws=i("FlaxOPTModel"),wn=u(),Ye=n("div"),b(oo.$$.fragment),Ps=u(),Tt=n("div"),b(no.$$.fragment),$s=u(),b(vt.$$.fragment),Pn=u(),Qe=n("h2"),yt=n("a"),Jo=n("span"),b(ao.$$.fragment),Os=u(),Zo=n("span"),Ms=i("FlaxOPTForCausalLM"),$n=u(),I=n("div"),b(so.$$.fragment),Fs=u(),Xo=n("p"),xs=i(`OPT Model with a language modeling head on top (linear layer with weights tied to the input embeddings) e.g for
...
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),As=u(),Yo=n("p"),Ds=i("Finally, this model supports inherent JAX features such as:"),Ss=u(),ze=n("ul"),Qo=n("li"),co=n("a"),Ws=i("Just-In-Time (JIT) compilation"),Gs=u(),en=n("li"),po=n("a"),Bs=i("Automatic Differentiation"),Hs=u(),tn=n("li"),uo=n("a"),Us=i("Vectorization"),Vs=u(),on=n("li"),ho=n("a"),Rs=i("Parallelization"),Ks=u(),bt=n("div"),b(mo.$$.fragment),Js=u(),b(kt.$$.fragment),this.h()},l(o){const g=si('[data-svelte="svelte-1phssyn"]',document.head);d=a(g,"META",{name:!0,content:!0}),g.forEach(t),y=h(o),_=a(o,"H1",{class:!0});var fo=s(_);c=a(fo,"A",{id:!0,class:!0,href:!0});var nn=s(c);v=a(nn,"SPAN",{});var an=s(v);k(r.$$.fragment,an),an.forEach(t),nn.forEach(t),f=h(fo),q=a(fo,"SPAN",{});var sn=s(q);ve=l(sn,"OPT"),sn.forEach(t),fo.forEach(t),oe=h(o),M=a(o,"H2",{class:!0});var go=s(M);V=a(go,"A",{id:!0,class:!0,href:!0});var rn=s(V);D=a(rn,"SPAN",{});var ln=s(D);k(J.$$.fragment,ln),ln.forEach(t),rn.forEach(t),ye=h(go),S=a(go,"SPAN",{});var dn=s(S);be=l(dn,"Overview"),dn.forEach(t),go.forEach(t),he=h(o),A=a(o,"P",{});var _o=s(A);W=l(_o,"The OPT model was proposed in "),Z=a(_o,"A",{href:!0,rel:!0});var cn=s(Z);re=l(cn,"Open Pre-trained Transformer Language Models"),cn.forEach(t),z=l(_o,` by Meta AI.
OPT is a series of open-sourced large causal language models which perform similar in performance to GPT3.`),_o.forEach(t),L=h(o),ne=a(o,"P",{});var pn=s(ne);X=l(pn,"The abstract from the paper is the following:"),pn.forEach(t),me=h(o),ae=a(o,"P",{});var Zs=s(ae);G=a(Zs,"EM",{});var Xs=s(G);ke=l(Xs,"Large language models, which are often trained for hundreds of thousands of compute days, have shown remarkable capabilities for zero- and few-shot learning. Given their computational cost, these models are difficult to replicate without significant capital. For the few that are available through APIs, no access is granted to the full model weights, making them difficult to study. We present Open Pre-trained Transformers (OPT), a suite of decoder-only pre-trained transformers ranging from 125M to 175B parameters, which we aim to fully and responsibly share with interested researchers. We show that OPT-175B is comparable to GPT-3, while requiring only 1/7th the carbon footprint to develop. We are also releasing our logbook detailing the infrastructure challenges we faced, along with code for experimenting with all of the released models."),Xs.forEach(t),Zs.forEach(t),fe=h(o),j=a(o,"P",{});var Ys=s(j);we=l(Ys,"Tips:"),Ys.forEach(t),R=h(o),K=a(o,"UL",{});var Mn=s(K);Y=a(Mn,"LI",{});var Fn=s(Y);Q=l(Fn,"OPT has the same architecture as "),ie=a(Fn,"CODE",{});var Qs=s(ie);Pe=l(Qs,"BartDecoder"),Qs.forEach(t),B=l(Fn,"."),Fn.forEach(t),$e=h(Mn),E=a(Mn,"LI",{});var Ce=s(E);Oe=l(Ce,"Contrary to GPT2, OPT adds the EOS token "),T=a(Ce,"CODE",{});var er=s(T);F=l(er,"</s>"),er.forEach(t),le=l(Ce," to the beginning of every prompt. "),Me=a(Ce,"STRONG",{});var tr=s(Me);Le=l(tr,"Note"),tr.forEach(t),H=l(Ce,": Make sure to pass "),Fe=a(Ce,"CODE",{});var or=s(Fe);Ne=l(or,"use_fast=False"),or.forEach(t),Ie=l(Ce," when loading OPT\u2019s tokenizer with "),N=a(Ce,"A",{href:!0});var nr=s(N);ee=l(nr,"AutoTokenizer"),nr.forEach(t),Ae=l(Ce," to get the correct tokenizer."),Ce.forEach(t),Mn.forEach(t),Ee=h(o),x=a(o,"P",{});var je=s(x);De=l(je,"This model was contributed by "),de=a(je,"A",{href:!0,rel:!0});var ar=s(de);xe=l(ar,"Arthur Zucker"),ar.forEach(t),Se=l(je,", "),Ft=a(je,"A",{href:!0,rel:!0});var sr=s(Ft);Xn=l(sr,"Younes Belkada"),sr.forEach(t),Yn=l(je,", and "),xt=a(je,"A",{href:!0,rel:!0});var rr=s(xt);Qn=l(rr,"Patrick Von Platen"),rr.forEach(t),ea=l(je,`.
...
according to the specified arguments, defining the model architecture. Instantiating a configuration with the
defaults will yield a similar configuration to that of the OPT
`),jt=a(zo,"A",{href:!0,rel:!0});var ur=s(jt);da=l(ur,"facebook/opt-350m"),ur.forEach(t),ca=l(zo," architecture."),zo.forEach(t),pa=h(wt),Be=a(wt,"P",{});var Eo=s(Be);ua=l(Eo,"Configuration objects inherit from "),ko=a(Eo,"A",{href:!0});var hr=s(ko);ha=l(hr,"PretrainedConfig"),hr.forEach(t),ma=l(Eo,` and can be used to control the model outputs. Read the
documentation from `),wo=a(Eo,"A",{href:!0});var mr=s(wo);fa=l(mr,"PretrainedConfig"),mr.forEach(t),ga=l(Eo," for more information."),Eo.forEach(t),_a=h(wt),k(ot.$$.fragment,wt),wt.forEach(t),mn=h(o),He=a(o,"H2",{class:!0});var zn=s(He);nt=a(zn,"A",{id:!0,class:!0,href:!0});var fr=s(nt);No=a(fr,"SPAN",{});var gr=s(No);k(qt.$$.fragment,gr),gr.forEach(t),fr.forEach(t),Ta=h(zn),Io=a(zn,"SPAN",{});var _r=s(Io);va=l(_r,"OPTModel"),_r.forEach(t),zn.forEach(t),fn=h(o),pe=a(o,"DIV",{class:!0});var Pt=s(pe);k(Lt.$$.fragment,Pt),ya=h(Pt),Nt=a(Pt,"P",{});var En=s(Nt);ba=l(En,`The bare OPT Model outputting raw hidden-states without any specific head on top.
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),En.forEach(t),Pa=h(Pt),It=a(Pt,"P",{});var Cn=s(It);$a=l(Cn,"This model is also a PyTorch "),At=a(Cn,"A",{href:!0,rel:!0});var vr=s(At);Oa=l(vr,"torch.nn.Module"),vr.forEach(t),Ma=l(Cn,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Cn.forEach(t),Fa=h(Pt),ge=a(Pt,"DIV",{class:!0});var $t=s(ge);k(Dt.$$.fragment,$t),xa=h($t),Ue=a($t,"P",{});var Co=s(Ue);za=l(Co,"The "),$o=a(Co,"A",{href:!0});var yr=s($o);Ea=l(yr,"OPTModel"),yr.forEach(t),Ca=l(Co," forward method, overrides the "),Ao=a(Co,"CODE",{});var br=s(Ao);ja=l(br,"__call__"),br.forEach(t),qa=l(Co," special method."),Co.forEach(t),La=h($t),k(at.$$.fragment,$t),Na=h($t),k(st.$$.fragment,$t),$t.forEach(t),Pt.forEach(t),gn=h(o),Ve=a(o,"H2",{class:!0});var jn=s(Ve);rt=a(jn,"A",{id:!0,class:!0,href:!0});var kr=s(rt);Do=a(kr,"SPAN",{});var wr=s(Do);k(St.$$.fragment,wr),wr.forEach(t),kr.forEach(t),Ia=h(jn),So=a(jn,"SPAN",{});var Pr=s(So);Aa=l(Pr,"OPTForCausalLM"),Pr.forEach(t),jn.forEach(t),_n=h(o),Re=a(o,"DIV",{class:!0});var qn=s(Re);k(Wt.$$.fragment,qn),Da=h(qn),it=a(qn,"DIV",{class:!0});var Ln=s(it);k(Gt.$$.fragment,Ln),Sa=h(Ln),k(lt.$$.fragment,Ln),Ln.forEach(t),qn.forEach(t),Tn=h(o),Ke=a(o,"H2",{class:!0});var Nn=s(Ke);dt=a(Nn,"A",{id:!0,class:!0,href:!0});var $r=s(dt);Wo=a($r,"SPAN",{});var Or=s(Wo);k(Bt.$$.fragment,Or),Or.forEach(t),$r.forEach(t),Wa=h(Nn),Go=a(Nn,"SPAN",{});var Mr=s(Go);Ga=l(Mr,"TFOPTModel"),Mr.forEach(t),Nn.forEach(t),vn=h(o),te=a(o,"DIV",{class:!0});var qe=s(te);k(Ht.$$.fragment,qe),Ba=h(qe),Ut=a(qe,"P",{});var In=s(Ut);Ha=l(In,`The bare TF OPT Model outputting raw hidden-states without any specific head on top.
This model inherits from `),Oo=a(In,"A",{href:!0});var Fr=s(Oo);Ua=l(Fr,"TFPreTrainedModel"),Fr.forEach(t),Va=l(In,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),An.forEach(t),Xa=h(qe),k(ct.$$.fragment,qe),Ya=h(qe),_e=a(qe,"DIV",{class:!0});var Ot=s(_e);k(Kt.$$.fragment,Ot),Qa=h(Ot),Je=a(Ot,"P",{});var jo=s(Je);es=l(jo,"The "),Mo=a(jo,"A",{href:!0});var zr=s(Mo);ts=l(zr,"TFOPTModel"),zr.forEach(t),os=l(jo," forward method, overrides the "),Bo=a(jo,"CODE",{});var Er=s(Bo);ns=l(Er,"__call__"),Er.forEach(t),as=l(jo," special method."),jo.forEach(t),ss=h(Ot),k(pt.$$.fragment,Ot),rs=h(Ot),k(ut.$$.fragment,Ot),Ot.forEach(t),qe.forEach(t),yn=h(o),Ze=a(o,"H2",{class:!0});var Dn=s(Ze);ht=a(Dn,"A",{id:!0,class:!0,href:!0});var Cr=s(ht);Ho=a(Cr,"SPAN",{});var jr=s(Ho);k(Jt.$$.fragment,jr),jr.forEach(t),Cr.forEach(t),is=h(Dn),Uo=a(Dn,"SPAN",{});var qr=s(Uo);ls=l(qr,"TFOPTForCausalLM"),qr.forEach(t),Dn.forEach(t),bn=h(o),U=a(o,"DIV",{class:!0});var Te=s(U);k(Zt.$$.fragment,Te),ds=h(Te),Vo=a(Te,"P",{});var Lr=s(Vo);cs=l(Lr,"The OPT Model transformer with a language modeling head on top."),Lr.forEach(t),ps=h(Te),Xt=a(Te,"P",{});var Sn=s(Xt);us=l(Sn,"This model inherits from "),Fo=a(Sn,"A",{href:!0});var Nr=s(Fo);hs=l(Nr,"TFPreTrainedModel"),Nr.forEach(t),ms=l(Sn,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Wn.forEach(t),vs=h(Te),k(mt.$$.fragment,Te),ys=h(Te),ft=a(Te,"DIV",{class:!0});var Gn=s(ft);k(eo.$$.fragment,Gn),bs=h(Gn),k(gt.$$.fragment,Gn),Gn.forEach(t),Te.forEach(t),kn=h(o),Xe=a(o,"H2",{class:!0});var Bn=s(Xe);_t=a(Bn,"A",{id:!0,class:!0,href:!0});var Ar=s(_t);Ro=a(Ar,"SPAN",{});var Dr=s(Ro);k(to.$$.fragment,Dr),Dr.forEach(t),Ar.forEach(t),ks=h(Bn),Ko=a(Bn,"SPAN",{});var Sr=s(Ko);ws=l(Sr,"FlaxOPTModel"),Sr.forEach(t),Bn.forEach(t),wn=h(o),Ye=a(o,"DIV",{class:!0});var Hn=s(Ye);k(oo.$$.fragment,Hn),Ps=h(Hn),Tt=a(Hn,"DIV",{class:!0});var Un=s(Tt);k(no.$$.fragment,Un),$s=h(Un),k(vt.$$.fragment,Un),Un.forEach(t),Hn.forEach(t),Pn=h(o),Qe=a(o,"H2",{class:!0});var Vn=s(Qe);yt=a(Vn,"A",{id:!0,class:!0,href:!0});var Wr=s(yt);Jo=a(Wr,"SPAN",{});var Gr=s(Jo);k(ao.$$.fragment,Gr),Gr.forEach(t),Wr.forEach(t),Os=h(Vn),Zo=a(Vn,"SPAN",{});var Br=s(Zo);Ms=l(Br,"FlaxOPTForCausalLM"),Br.forEach(t),Vn.forEach(t),$n=h(o),I=a(o,"DIV",{class:!0});var se=s(I);k(so.$$.fragment,se),Fs=h(se),Xo=a(se,"P",{});var Hr=s(Xo);xs=l(Hr,`OPT Model with a language modeling head on top (linear layer with weights tied to the input embeddings) e.g for
autoregressive tasks.`),Hr.forEach(t),zs=h(se),ro=a(se,"P",{});var Rn=s(ro);Es=l(Rn,"This model inherits from "),xo=a(Rn,"A",{href:!0});var Ur=s(xo);Cs=l(Ur,"FlaxPreTrainedModel"),Ur.forEach(t),js=l(Rn,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
