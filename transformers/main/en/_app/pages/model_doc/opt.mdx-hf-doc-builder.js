...
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),u.forEach(t)},m(l,u){g(l,d,u),e(d,T),e(d,h),e(h,m),e(d,y)},d(l){l&&t(d)}}}function Hl(M){let d,T,h,m,y;return m=new tt({props:{code:`from transformers import GPT2Tokenizer, OPTModel
import torch
...
`),le=n("code"),ye=r("model([input_ids, attention_mask])"),He=r(" or "),de=n("code"),be=r("model([input_ids, attention_mask, token_type_ids])"),Ue=c(),Q=n("li"),ve=r(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
...
`),le=s(H,"CODE",{});var ft=a(le);ye=i(ft,"model([input_ids, attention_mask])"),ft.forEach(t),He=i(H," or "),de=s(H,"CODE",{});var Je=a(de);be=i(Je,"model([input_ids, attention_mask, token_type_ids])"),Je.forEach(t),H.forEach(t),Ue=p(R),Q=s(R,"LI",{});var Xe=a(Q);ve=i(Xe,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
...
about any of this, as you can just pass inputs like you would to any other Python function!`),q.forEach(t),this.h()},h(){f(B,"href","https://keras.io/guides/making_new_layers_and_models_via_subclassing/"),f(B,"rel","nofollow")},m(b,x){g(b,d,x),e(d,T),e(d,h),e(h,m),e(d,y),g(b,l,x),g(b,u,x),e(u,E),e(E,je),e(u,Oe),e(u,L),e(L,oe),g(b,se,x),g(b,F,x),e(F,Le),e(F,X),e(X,Ae),e(F,Fe),e(F,W),e(W,Ne),e(F,ae),e(F,re),e(re,Ie),e(F,Me),e(F,V),e(V,Se),e(F,xe),e(F,Z),e(Z,Te),e(F,De),g(b,he,x),g(b,C,x),e(C,A),e(A,ze),e(A,G),e(G,ie),e(A,We),e(A,Y),e(Y,Ge),e(C,Be),e(C,N),e(N,I),e(N,le),e(le,ye),e(N,He),e(N,de),e(de,be),e(C,Ue),e(C,Q),e(Q,ve),e(Q,ce),e(ce,Ke),g(b,ne,x),g(b,S,x),e(S,Ve),e(S,B),e(B,j),e(S,Ze)},d(b){b&&t(d),b&&t(l),b&&t(u),b&&t(se),b&&t(F),b&&t(he),b&&t(C),b&&t(ne),b&&t(S)}}}function Vl(M){let d,T,h,m,y;return{c(){d=n("p"),T=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),h=n("code"),m=r("Module"),y=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(l){d=s(l,"P",{});var u=a(d);T=i(u,"Although the recipe for forward pass needs to be defined within this function, one should call the "),h=s(u,"CODE",{});var E=a(h);m=i(E,"Module"),E.forEach(t),y=i(u,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),{c(){d=n("p"),T=r("Example:"),h=c(),v(m.$$.fragment)},l(l){d=s(l,"P",{});var u=a(d);T=i(u,"Example:"),u.forEach(t),h=p(l),k(m.$$.fragment,l)},m(l,u){g(l,d,u),e(d,T),g(l,h,u),w(m,l,u),y=!0},p:et,i(l){y||($(m.$$.fragment,l),y=!0)},o(l){P(m.$$.fragment,l),y=!1},d(l){l&&t(d),l&&t(h),O(m,l)}}}function Rl(M){let d,T,h,m,y,l,u,E,je,Oe,L,oe,se,F,Le,X,Ae,Fe,W,Ne,ae,re,Ie,Me,V,Se,xe,Z,Te,De,he,C,A,ze,G,ie,We,Y,Ge,Be,N,I,le,ye,He,de,be,Ue,Q,ve,ce,Ke,ne,S,Ve,B,j,Ze;return{c(){d=n("p"),T=r("TensorFlow models and layers in "),h=n("code"),m=r("transformers"),y=r(" accept two formats as input:"),l=c(),u=n("ul"),E=n("li"),je=r("having all inputs as keyword arguments (like PyTorch models), or"),Oe=c(),L=n("li"),oe=r("having all inputs as a list, tuple or dict in the first positional argument."),se=c(),F=n("p"),Le=r(`The reason the second format is supported is that Keras methods prefer this format when passing inputs to models
and layers. Because of this support, when using methods like `),X=n("code"),Ae=r("model.fit()"),Fe=r(` things should \u201Cjust work\u201D for you - just
pass your inputs and labels in any format that `),W=n("code"),Ne=r("model.fit()"),ae=r(` supports! If, however, you want to use the second
format outside of Keras methods like `),re=n("code"),Ie=r("fit()"),Me=r(" and "),V=n("code"),Se=r("predict()"),xe=r(`, such as when creating your own layers or models with
the Keras `),Z=n("code"),Te=r("Functional"),De=r(` API, there are three possibilities you can use to gather all the input Tensors in the first
...
Whether or not to return a <a href="/docs/transformers/main/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/opt/modeling_opt.py#L747",returnDescription:`
<p>A <a
...
Whether or not to return a <a href="/docs/transformers/main/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/opt/modeling_opt.py#L830",returnDescription:`
<p>A <a
...
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/opt/modeling_opt.py#L1010",returnDescription:`
...
OPT is a series of open-sourced large causal language models which perform similar in performance to GPT3.`),Me=c(),V=n("p"),Se=r("The abstract from the paper is the following:"),xe=c(),Z=n("p"),Te=n("em"),De=r("Large language models, which are often trained for hundreds of thousands of compute days, have shown remarkable capabilities for zero- and few-shot learning. Given their computational cost, these models are difficult to replicate without significant capital. For the few that are available through APIs, no access is granted to the full model weights, making them difficult to study. We present Open Pre-trained Transformers (OPT), a suite of decoder-only pre-trained transformers ranging from 125M to 175B parameters, which we aim to fully and responsibly share with interested researchers. We show that OPT-175B is comparable to GPT-3, while requiring only 1/7th the carbon footprint to develop. We are also releasing our logbook detailing the infrastructure challenges we faced, along with code for experimenting with all of the released models."),he=c(),C=n("p"),A=r("Tips:"),ze=c(),G=n("ul"),ie=n("li"),We=r("OPT has the same architecture as "),Y=n("code"),Ge=r("BartDecoder"),Be=r("."),N=c(),I=n("li"),le=r("Contrary to GPT2, OPT adds the EOS token "),ye=n("code"),He=r("</s>"),de=r(" to the beginning of every prompt. "),be=n("strong"),Ue=r("Note"),Q=r(": Make sure to pass "),ve=n("code"),ce=r("use_fast=False"),Ke=r(" when loading OPT\u2019s tokenizer with "),ne=n("a"),S=r("AutoTokenizer"),Ve=r(" to get the correct tokenizer."),B=c(),j=n("p"),Ze=r("This model was contributed by "),b=n("a"),x=r("Arthur Zucker"),lt=r(", "),ee=n("a"),dt=r("Younes Belkada"),ct=r(", and "),z=n("a"),pt=r("Patrick Von Platen"),ut=r(`.
The original code can be found `),ke=n("a"),ht=r("here"),mt=r("."),R=c(),D=n("h2"),me=n("a"),Re=n("span"),v(H.$$.fragment),ft=c(),Je=n("span"),Xe=r("OPTConfig"),ot=c(),q=n("div"),v(we.$$.fragment),Ks=c(),gt=n("p"),Vs=r("This is the configuration class to store the configuration of a "),tn=n("a"),Zs=r("OPTModel"),Rs=r(`. It is used to instantiate a OPT model
...
behavior.`),Ia=c(),v(It.$$.fragment),Sa=c(),Ee=n("div"),v($o.$$.fragment),Da=c(),wt=n("p"),Wa=r("The "),ln=n("a"),Ga=r("TFOPTModel"),Ba=r(" forward method, overrides the "),Fn=n("code"),Ha=r("__call__"),Ua=r(" special method."),Ka=c(),v(St.$$.fragment),Va=c(),v(Dt.$$.fragment),hs=c(),$t=n("h2"),Wt=n("a"),Mn=n("span"),v(Po.$$.fragment),Za=c(),xn=n("span"),Ra=r("TFOPTForCausalLM"),ms=c(),te=n("div"),v(Oo.$$.fragment),Ja=c(),zn=n("p"),Xa=r("The OPT Model transformer with a language modeling head on top."),Ya=c(),Fo=n("p"),Qa=r("This model inherits from "),dn=n("a"),er=r("TFPreTrainedModel"),tr=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),or=c(),Mo=n("p"),nr=r("This model is also a "),xo=n("a"),sr=r("tf.keras.Model"),ar=r(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),rr=c(),v(Gt.$$.fragment),ir=c(),Bt=n("div"),v(zo.$$.fragment),lr=c(),v(Ht.$$.fragment),fs=c(),Pt=n("h2"),Ut=n("a"),Cn=n("span"),v(Co.$$.fragment),dr=c(),En=n("span"),cr=r("OPTForSequenceClassification"),gs=c(),U=n("div"),v(Eo.$$.fragment),pr=c(),qn=n("p"),ur=r("The OPT Model transformer with a sequence classification head on top (linear layer)."),hr=c(),cn=n("p"),pn=n("a"),mr=r("OPTForSequenceClassification"),fr=r(` uses the last token in order to do the classification, as other causal models
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),jr=c(),J=n("div"),v(Ao.$$.fragment),Lr=c(),Ot=n("p"),Ar=r("The "),hn=n("a"),Nr=r("OPTForSequenceClassification"),Ir=r(" forward method, overrides the "),In=n("code"),Sr=r("__call__"),Dr=r(" special method."),Wr=c(),v(Kt.$$.fragment),Gr=c(),v(Vt.$$.fragment),Br=c(),v(Zt.$$.fragment),Hr=c(),v(Rt.$$.fragment),Ur=c(),v(Jt.$$.fragment),_s=c(),Ft=n("h2"),Xt=n("a"),Sn=n("span"),v(No.$$.fragment),Kr=c(),Dn=n("span"),Vr=r("FlaxOPTModel"),Ts=c(),Mt=n("div"),v(Io.$$.fragment),Zr=c(),Yt=n("div"),v(So.$$.fragment),Rr=c(),v(Qt.$$.fragment),ys=c(),xt=n("h2"),eo=n("a"),Wn=n("span"),v(Do.$$.fragment),Jr=c(),Gn=n("span"),Xr=r("FlaxOPTForCausalLM"),bs=c(),K=n("div"),v(Wo.$$.fragment),Yr=c(),Bn=n("p"),Qr=r(`OPT Model with a language modeling head on top (linear layer with weights tied to the input embeddings) e.g for
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Ps.forEach(t),fa=p(so),Ce=s(so,"DIV",{class:!0});var ao=a(Ce);k(fo.$$.fragment,ao),ga=p(ao),yt=s(ao,"P",{});var _n=a(yt);_a=i(_n,"The "),an=s(_n,"A",{href:!0});var Gi=a(an);Ta=i(Gi,"OPTModel"),Gi.forEach(t),ya=i(_n," forward method, overrides the "),kn=s(_n,"CODE",{});var Bi=a(kn);ba=i(Bi,"__call__"),Bi.forEach(t),va=i(_n," special method."),_n.forEach(t),ka=p(ao),k(Et.$$.fragment,ao),wa=p(ao),k(qt.$$.fragment,ao),ao.forEach(t),so.forEach(t),ds=p(o),bt=s(o,"H2",{class:!0});var Os=a(bt);jt=s(Os,"A",{id:!0,class:!0,href:!0});var Hi=a(jt);wn=s(Hi,"SPAN",{});var Ui=a(wn);k(go.$$.fragment,Ui),Ui.forEach(t),Hi.forEach(t),$a=p(Os),$n=s(Os,"SPAN",{});var Ki=a($n);Pa=i(Ki,"OPTForCausalLM"),Ki.forEach(t),Os.forEach(t),cs=p(o),vt=s(o,"DIV",{class:!0});var Fs=a(vt);k(_o.$$.fragment,Fs),Oa=p(Fs),Lt=s(Fs,"DIV",{class:!0});var Ms=a(Lt);k(To.$$.fragment,Ms),Fa=p(Ms),k(At.$$.fragment,Ms),Ms.forEach(t),Fs.forEach(t),ps=p(o),kt=s(o,"H2",{class:!0});var xs=a(kt);Nt=s(xs,"A",{id:!0,class:!0,href:!0});var Vi=a(Nt);Pn=s(Vi,"SPAN",{});var Zi=a(Pn);k(yo.$$.fragment,Zi),Zi.forEach(t),Vi.forEach(t),Ma=p(xs),On=s(xs,"SPAN",{});var Ri=a(On);xa=i(Ri,"TFOPTModel"),Ri.forEach(t),xs.forEach(t),us=p(o),pe=s(o,"DIV",{class:!0});var at=a(pe);k(bo.$$.fragment,at),za=p(at),vo=s(at,"P",{});var zs=a(vo);Ca=i(zs,`The bare TF OPT Model outputting raw hidden-states without any specific head on top.
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Cs.forEach(t),Ia=p(at),k(It.$$.fragment,at),Sa=p(at),Ee=s(at,"DIV",{class:!0});var ro=a(Ee);k($o.$$.fragment,ro),Da=p(ro),wt=s(ro,"P",{});var Tn=a(wt);Wa=i(Tn,"The "),ln=s(Tn,"A",{href:!0});var Yi=a(ln);Ga=i(Yi,"TFOPTModel"),Yi.forEach(t),Ba=i(Tn," forward method, overrides the "),Fn=s(Tn,"CODE",{});var Qi=a(Fn);Ha=i(Qi,"__call__"),Qi.forEach(t),Ua=i(Tn," special method."),Tn.forEach(t),Ka=p(ro),k(St.$$.fragment,ro),Va=p(ro),k(Dt.$$.fragment,ro),ro.forEach(t),at.forEach(t),hs=p(o),$t=s(o,"H2",{class:!0});var Es=a($t);Wt=s(Es,"A",{id:!0,class:!0,href:!0});var el=a(Wt);Mn=s(el,"SPAN",{});var tl=a(Mn);k(Po.$$.fragment,tl),tl.forEach(t),el.forEach(t),Za=p(Es),xn=s(Es,"SPAN",{});var ol=a(xn);Ra=i(ol,"TFOPTForCausalLM"),ol.forEach(t),Es.forEach(t),ms=p(o),te=s(o,"DIV",{class:!0});var qe=a(te);k(Oo.$$.fragment,qe),Ja=p(qe),zn=s(qe,"P",{});var nl=a(zn);Xa=i(nl,"The OPT Model transformer with a language modeling head on top."),nl.forEach(t),Ya=p(qe),Fo=s(qe,"P",{});var qs=a(Fo);Qa=i(qs,"This model inherits from "),dn=s(qs,"A",{href:!0});var sl=a(dn);er=i(sl,"TFPreTrainedModel"),sl.forEach(t),tr=i(qs,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
