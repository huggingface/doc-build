import{S as ic,i as cc,s as lc,e as r,k as l,w as f,t as s,M as dc,c as n,d as o,m as d,a as i,x as u,h as a,b as c,F as e,g as h,y as _,q as g,o as v,B as T,v as pc}from"../../chunks/vendor-6b77c823.js";import{T as nc}from"../../chunks/Tip-39098574.js";import{D as A}from"../../chunks/Docstring-90e3aa51.js";import{C as Ps}from"../../chunks/CodeBlock-3a8b25a8.js";import{I as _t}from"../../chunks/IconCopyLink-7a11ce68.js";function hc(gt){let m,I,x,E,L,S,O,D;return{c(){m=r("p"),I=s(`This class method is simply calling the feature extractor
...
above for more information.`),b.forEach(o),this.h()},h(){c(x,"href","/docs/transformers/main/en/main_classes/feature_extractor#transformers.FeatureExtractionMixin.save_pretrained")},m(P,b){h(P,m,b),e(m,I),e(m,x),e(x,E),e(m,L),e(m,S),e(S,O),e(m,D)},d(P){P&&o(m)}}}function fc(gt){let m,I,x,E,L,S,O,D,P,b,j,q,so,ye,js,ao,Cs,Lo,B,qs,vt,Fs,Ms,$e,As,Ls,Do,w,Ds,ro,Ws,Is,no,Vs,Ns,Tt,Os,Us,xt,Rs,Hs,kt,Bs,Js,io,Gs,Ks,Wo,ie,Qs,Ee,Xs,Ys,Io,ce,Zs,ze,ea,ta,Vo,bt,oa,No,J,Pe,sa,je,aa,ra,na,Ce,ia,St,ca,la,da,qe,pa,Fe,ha,ma,Oo,ee,le,co,Me,fa,lo,ua,Uo,G,_a,wt,ga,va,yt,Ta,xa,Ro,z,ka,$t,ba,Sa,Et,wa,ya,zt,$a,Ea,Pt,za,Pa,jt,ja,Ca,Ho,Ct,po,qa,Bo,Ae,Jo,qt,Le,ho,Fa,Ma,mo,Aa,Go,De,Ko,de,La,We,Da,Wa,Qo,te,pe,fo,Ie,Ia,uo,Va,Xo,C,Ve,Na,oe,Oa,Ft,Ua,Ra,Ne,Ha,Ba,Ja,se,Ga,Mt,Ka,Qa,At,Xa,Ya,Za,_o,er,tr,Oe,Yo,ae,he,go,Ue,or,vo,sr,Zo,$,Re,ar,To,rr,nr,He,ir,Lt,cr,lr,dr,me,Be,pr,xo,hr,mr,K,Je,fr,ko,ur,_r,Ge,gr,bo,vr,Tr,xr,Dt,Ke,es,re,fe,So,Qe,kr,wo,br,ts,k,Xe,Sr,yo,wr,yr,F,Wt,$r,Er,It,zr,Pr,Vt,jr,Cr,Ye,$o,qr,Fr,Mr,Nt,Ar,Lr,Dr,ue,Ze,Wr,U,Ir,Eo,Vr,Nr,Ot,Or,Ur,et,zo,Rr,Hr,Br,Jr,Q,tt,Gr,Po,Kr,Qr,_e,Xr,X,ot,Yr,st,Zr,Ut,en,tn,on,ge,sn,ve,at,an,rt,rn,Rt,nn,cn,ln,Te,nt,dn,it,pn,Ht,hn,mn,fn,xe,ct,un,jo,_n,os,ne,ke,Co,lt,gn,qo,vn,ss,W,dt,Tn,R,xn,Bt,kn,bn,Fo,Sn,wn,Jt,yn,$n,En,pt,zn,ht,Pn,jn,Cn,Y,mt,qn,Mo,Fn,Mn,ft,as;return S=new _t({}),ye=new _t({}),Me=new _t({}),Ae=new Ps({props:{code:`import torch
...
just in case (e.g., 512 or 1024 or 2048).`,name:"max_source_positions"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/speech_to_text_2/configuration_speech_to_text_2.py#L29"}}),Oe=new Ps({props:{code:`from transformers import Speech2Text2ForCausalLM, Speech2Text2Config
...
<span class="hljs-meta">&gt;&gt;&gt; </span>loss.backward()`}}),{c(){m=r("meta"),I=l(),x=r("h1"),E=r("a"),L=r("span"),f(S.$$.fragment),O=l(),D=r("span"),P=s("Speech2Text2"),b=l(),j=r("h2"),q=r("a"),so=r("span"),f(ye.$$.fragment),js=l(),ao=r("span"),Cs=s("Overview"),Lo=l(),B=r("p"),qs=s("The Speech2Text2 model is used together with "),vt=r("a"),Fs=s("Wav2Vec2"),Ms=s(` for Speech Translation models proposed in
...
a single processor.`),Wi.forEach(o),yr=d(y),F=n(y,"P",{});var H=i(F);Wt=n(H,"A",{href:!0});var Ii=i(Wt);$r=a(Ii,"Speech2Text2Processor"),Ii.forEach(o),Er=a(H," offers all the functionalities of "),It=n(H,"A",{href:!0});var Vi=i(It);zr=a(Vi,"AutoFeatureExtractor"),Vi.forEach(o),Pr=a(H," and "),Vt=n(H,"A",{href:!0});var Ni=i(Vt);jr=a(Ni,"Speech2Text2Tokenizer"),Ni.forEach(o),Cr=a(H,`.
See the `),Ye=n(H,"A",{href:!0});var An=i(Ye);$o=n(An,"STRONG",{});var Oi=i($o);qr=a(Oi,"call"),Oi.forEach(o),Fr=a(An,"()"),An.forEach(o),Mr=a(H," and "),Nt=n(H,"A",{href:!0});var Ui=i(Nt);Ar=a(Ui,"decode()"),Ui.forEach(o),Lr=a(H," for more information."),H.forEach(o),Dr=d(y),ue=n(y,"DIV",{class:!0});var xs=i(ue);u(Ze.$$.fragment,xs),Wr=d(xs),U=n(xs,"P",{});var be=i(U);Ir=a(be,`When used in normal mode, this method forwards all its arguments to AutoFeatureExtractor\u2019s
