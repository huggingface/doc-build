...
tensors in the first argument of the model call function: `),V=s(H,"CODE",{});var he=a(V);$e=i(he,"model(inputs)"),he.forEach(t),ge=i(H,"."),H.forEach(t),B=d(m),N=s(m,"P",{});var He=a(N);ne=i(He,`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
...
`),j=s(ye,"CODE",{});var D=a(j);Ee=i(D,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),D.forEach(t),ye.forEach(t),P.forEach(t)},m(m,E){f(m,h,E),e(h,M),f(m,u,E),f(m,g,E),e(g,$),e($,_),e(g,T),e(g,X),e(X,I),f(m,W,E),f(m,x,E),e(x,z),e(x,O),e(O,K),e(x,ae),e(x,V),e(V,$e),e(x,ge),f(m,B,E),f(m,N,E),e(N,ne),f(m,re,E),f(m,F,E),e(F,C),e(C,ie),e(C,Q),e(Q,_e),e(C,le),e(C,U),e(U,xe),e(F,Te),e(F,q),e(q,Xe),e(q,G),e(G,oe),e(q,fe),e(q,Z),e(Z,Me),e(F,me),e(F,A),e(A,ve),e(A,j),e(j,Ee)},d(m){m&&t(h),m&&t(u),m&&t(g),m&&t(W),m&&t(x),m&&t(B),m&&t(N),m&&t(re),m&&t(F)}}}function Wf(R){let h,M,u,g,$;return{c(){h=n("p"),M=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),u=n("code"),g=r("Module"),$=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(_){h=s(_,"P",{});var T=a(h);M=i(T,"Although the recipe for forward pass needs to be defined within this function, one should call the "),u=s(T,"CODE",{});var X=a(u);g=i(X,"Module"),X.forEach(t),$=i(T,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),T.forEach(t)},m(_,T){f(_,h,T),e(h,M),e(h,u),e(u,g),e(h,$)},d(_){_&&t(h)}}}function Vf(R){let h,M,u,g,$,_,T,X,I,W,x,z,O,K,ae,V,$e,ge,B,N,ne,re,F,C,ie,Q,_e,le,U,xe,Te,q,Xe,G,oe,fe,Z,Me,me,A,ve,j,Ee;return{c(){h=n("p"),M=r("TF 2.0 models accepts two formats as inputs:"),u=l(),g=n("ul"),$=n("li"),_=r("having all inputs as keyword arguments (like PyTorch models), or"),T=l(),X=n("li"),I=r("having all inputs as a list, tuple or dict in the first positional arguments."),W=l(),x=n("p"),z=r("This second option is useful when using "),O=n("code"),K=r("tf.keras.Model.fit"),ae=r(` method which currently requires having all the
tensors in the first argument of the model call function: `),V=n("code"),$e=r("model(inputs)"),ge=r("."),B=l(),N=n("p"),ne=r(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),re=l(),F=n("ul"),C=n("li"),ie=r("a single Tensor with "),Q=n("code"),_e=r("input_ids"),le=r(" only and nothing else: "),U=n("code"),xe=r("model(inputs_ids)"),Te=l(),q=n("li"),Xe=r(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),G=n("code"),oe=r("model([input_ids, attention_mask])"),fe=r(" or "),Z=n("code"),Me=r("model([input_ids, attention_mask, token_type_ids])"),me=l(),A=n("li"),ve=r(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),j=n("code"),Ee=r('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(m){h=s(m,"P",{});var E=a(h);M=i(E,"TF 2.0 models accepts two formats as inputs:"),E.forEach(t),u=d(m),g=s(m,"UL",{});var de=a(g);$=s(de,"LI",{});var be=a($);_=i(be,"having all inputs as keyword arguments (like PyTorch models), or"),be.forEach(t),T=d(de),X=s(de,"LI",{});var Ve=a(X);I=i(Ve,"having all inputs as a list, tuple or dict in the first positional arguments."),Ve.forEach(t),de.forEach(t),W=d(m),x=s(m,"P",{});var H=a(x);z=i(H,"This second option is useful when using "),O=s(H,"CODE",{});var Ae=a(O);K=i(Ae,"tf.keras.Model.fit"),Ae.forEach(t),ae=i(H,` method which currently requires having all the
...
first positional argument :`),He.forEach(t),re=d(m),F=s(m,"UL",{});var P=a(F);C=s(P,"LI",{});var S=a(C);ie=i(S,"a single Tensor with "),Q=s(S,"CODE",{});var Ce=a(Q);_e=i(Ce,"input_ids"),Ce.forEach(t),le=i(S," only and nothing else: "),U=s(S,"CODE",{});var we=a(U);xe=i(we,"model(inputs_ids)"),we.forEach(t),S.forEach(t),Te=d(P),q=s(P,"LI",{});var J=a(q);Xe=i(J,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),G=s(J,"CODE",{});var ze=a(G);oe=i(ze,"model([input_ids, attention_mask])"),ze.forEach(t),fe=i(J," or "),Z=s(J,"CODE",{});var Be=a(Z);Me=i(Be,"model([input_ids, attention_mask, token_type_ids])"),Be.forEach(t),J.forEach(t),me=d(P),A=s(P,"LI",{});var ye=a(A);ve=i(ye,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),j=s(ye,"CODE",{});var D=a(j);Ee=i(D,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),D.forEach(t),ye.forEach(t),P.forEach(t)},m(m,E){f(m,h,E),e(h,M),f(m,u,E),f(m,g,E),e(g,$),e($,_),e(g,T),e(g,X),e(X,I),f(m,W,E),f(m,x,E),e(x,z),e(x,O),e(O,K),e(x,ae),e(x,V),e(V,$e),e(x,ge),f(m,B,E),f(m,N,E),e(N,ne),f(m,re,E),f(m,F,E),e(F,C),e(C,ie),e(C,Q),e(Q,_e),e(C,le),e(C,U),e(U,xe),e(F,Te),e(F,q),e(q,Xe),e(q,G),e(G,oe),e(q,fe),e(q,Z),e(Z,Me),e(F,me),e(F,A),e(A,ve),e(A,j),e(j,Ee)},d(m){m&&t(h),m&&t(u),m&&t(g),m&&t(W),m&&t(x),m&&t(B),m&&t(N),m&&t(re),m&&t(F)}}}function Bf(R){let h,M,u,g,$;return{c(){h=n("p"),M=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),u=n("code"),g=r("Module"),$=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(_){h=s(_,"P",{});var T=a(h);M=i(T,"Although the recipe for forward pass needs to be defined within this function, one should call the "),u=s(T,"CODE",{});var X=a(u);g=i(X,"Module"),X.forEach(t),$=i(T,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),T.forEach(t)},m(_,T){f(_,h,T),e(h,M),e(h,u),e(u,g),e(h,$)},d(_){_&&t(h)}}}function Uf(R){let h,M,u,g,$,_,T,X,I,W,x,z,O,K,ae,V,$e,ge,B,N,ne,re,F,C,ie,Q,_e,le,U,xe,Te,q,Xe,G,oe,fe,Z,Me,me,A,ve,j,Ee;return{c(){h=n("p"),M=r("TF 2.0 models accepts two formats as inputs:"),u=l(),g=n("ul"),$=n("li"),_=r("having all inputs as keyword arguments (like PyTorch models), or"),T=l(),X=n("li"),I=r("having all inputs as a list, tuple or dict in the first positional arguments."),W=l(),x=n("p"),z=r("This second option is useful when using "),O=n("code"),K=r("tf.keras.Model.fit"),ae=r(` method which currently requires having all the
tensors in the first argument of the model call function: `),V=n("code"),$e=r("model(inputs)"),ge=r("."),B=l(),N=n("p"),ne=r(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),re=l(),F=n("ul"),C=n("li"),ie=r("a single Tensor with "),Q=n("code"),_e=r("input_ids"),le=r(" only and nothing else: "),U=n("code"),xe=r("model(inputs_ids)"),Te=l(),q=n("li"),Xe=r(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),G=n("code"),oe=r("model([input_ids, attention_mask])"),fe=r(" or "),Z=n("code"),Me=r("model([input_ids, attention_mask, token_type_ids])"),me=l(),A=n("li"),ve=r(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),j=n("code"),Ee=r('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(m){h=s(m,"P",{});var E=a(h);M=i(E,"TF 2.0 models accepts two formats as inputs:"),E.forEach(t),u=d(m),g=s(m,"UL",{});var de=a(g);$=s(de,"LI",{});var be=a($);_=i(be,"having all inputs as keyword arguments (like PyTorch models), or"),be.forEach(t),T=d(de),X=s(de,"LI",{});var Ve=a(X);I=i(Ve,"having all inputs as a list, tuple or dict in the first positional arguments."),Ve.forEach(t),de.forEach(t),W=d(m),x=s(m,"P",{});var H=a(x);z=i(H,"This second option is useful when using "),O=s(H,"CODE",{});var Ae=a(O);K=i(Ae,"tf.keras.Model.fit"),Ae.forEach(t),ae=i(H,` method which currently requires having all the
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/main/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),St=new it({props:{$$slots:{default:[If]},$$scope:{ctx:R}}}),No=new te({props:{name:"call",anchor:"transformers.TFTransfoXLModel.call",parameters:[{name:"input_ids",val:" = None"},{name:"mems",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"},{name:"training",val:" = False"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/transfo_xl/modeling_tf_transfo_xl.py#L883",parametersDescription:[{anchor:"transformers.TFTransfoXLModel.call.input_ids",description:`<strong>input_ids</strong> (<code>tf.Tensor</code> or <code>Numpy array</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/main/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),Ht=new it({props:{$$slots:{default:[Vf]},$$scope:{ctx:R}}}),Bo=new te({props:{name:"call",anchor:"transformers.TFTransfoXLLMHeadModel.call",parameters:[{name:"input_ids",val:" = None"},{name:"mems",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"},{name:"labels",val:" = None"},{name:"training",val:" = False"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/transfo_xl/modeling_tf_transfo_xl.py#L963",parametersDescription:[{anchor:"transformers.TFTransfoXLLMHeadModel.call.input_ids",description:`<strong>input_ids</strong> (<code>tf.Tensor</code> or <code>Numpy array</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/main/en/model_doc/bert#transformers.BertTokenizer">BertTokenizer</a>. See <a href="/docs/transformers/main/en/model_doc/wav2vec2#transformers.Wav2Vec2CTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
<a href="/docs/transformers/main/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> for details.</p>
...
this superclass for more information regarding those methods.`),pr=l(),un=n("div"),v(oo.$$.fragment),Bs=l(),ct=n("h2"),Et=n("a"),Wn=n("span"),v(no.$$.fragment),ur=l(),Vn=n("span"),gr=r("TransfoXL specific outputs"),Us=l(),ft=n("div"),v(so.$$.fragment),_r=l(),Bn=n("p"),Tr=r("Base class for model\u2019s outputs that may also contain a past key/values (to speed up sequential decoding)."),Rs=l(),mt=n("div"),v(ao.$$.fragment),vr=l(),Un=n("p"),br=r("Base class for model\u2019s outputs that may also contain a past key/values (to speed up sequential decoding)."),Ks=l(),ht=n("div"),v(ro.$$.fragment),wr=l(),Rn=n("p"),yr=r("Base class for model\u2019s outputs that may also contain a past key/values (to speed up sequential decoding)."),Gs=l(),pt=n("div"),v(io.$$.fragment),Lr=l(),Kn=n("p"),kr=r("Base class for model\u2019s outputs that may also contain a past key/values (to speed up sequential decoding)."),Ys=l(),ut=n("h2"),Ft=n("a"),Gn=n("span"),v(lo.$$.fragment),$r=l(),Yn=n("span"),xr=r("TransfoXLModel"),Qs=l(),Fe=n("div"),v(co.$$.fragment),Xr=l(),Qn=n("p"),Mr=r("The bare Bert Model transformer outputting raw hidden-states without any specific head on top."),Er=l(),fo=n("p"),Fr=r("This model inherits from "),gn=n("a"),qr=r("PreTrainedModel"),Cr=r(`. Check the superclass documentation for the generic methods the
...
and behavior.`),Sr=l(),Pe=n("div"),v(po.$$.fragment),Nr=l(),gt=n("p"),Ar=r("The "),_n=n("a"),Hr=r("TransfoXLModel"),Dr=r(" forward method, overrides the "),Zn=n("code"),Ir=r("__call__"),Wr=r(" special method."),Vr=l(),v(qt.$$.fragment),Br=l(),Jn=n("p"),Ur=r("Example:"),Rr=l(),v(uo.$$.fragment),Zs=l(),_t=n("h2"),Ct=n("a"),es=n("span"),v(go.$$.fragment),Kr=l(),ts=n("span"),Gr=r("TransfoXLLMHeadModel"),Js=l(),qe=n("div"),v(_o.$$.fragment),Yr=l(),os=n("p"),Qr=r(`The Transformer-XL Model with a language modeling head on top (adaptive softmax with weights tied to the adaptive
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Ii=l(),Y=n("div"),v(Mo.$$.fragment),Wi=l(),bt=n("p"),Vi=r("The "),Ln=n("a"),Bi=r("TransfoXLForSequenceClassification"),Ui=r(" forward method, overrides the "),ms=n("code"),Ri=r("__call__"),Ki=r(" special method."),Gi=l(),v(jt.$$.fragment),Yi=l(),hs=n("p"),Qi=r("Example of single-label classification:"),Zi=l(),v(Eo.$$.fragment),Ji=l(),v(Fo.$$.fragment),el=l(),ps=n("p"),tl=r("Example of multi-label classification:"),ol=l(),v(qo.$$.fragment),nl=l(),v(Co.$$.fragment),oa=l(),wt=n("h2"),Ot=n("a"),us=n("span"),v(zo.$$.fragment),sl=l(),gs=n("span"),al=r("TFTransfoXLModel"),na=l(),pe=n("div"),v(Po.$$.fragment),rl=l(),_s=n("p"),il=r("The bare Bert Model transformer outputting raw hidden-states without any specific head on top."),ll=l(),jo=n("p"),dl=r("This model inherits from "),kn=n("a"),cl=r("TFPreTrainedModel"),fl=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
original implementation trains on SQuAD with padding on the left, therefore the padding defaults are set to left.`),Vd.forEach(t),Me=d(ma),me=s(ma,"LI",{});var Bd=a(me);A=i(Bd,"Transformer-XL is one of the few models that has no sequence length limit."),Bd.forEach(t),ma.forEach(t),ve=d(o),j=s(o,"P",{});var Cn=a(j);Ee=i(Cn,"This model was contributed by "),m=s(Cn,"A",{href:!0,rel:!0});var Ud=a(m);E=i(Ud,"thomwolf"),Ud.forEach(t),de=i(Cn,". The original code can be found "),be=s(Cn,"A",{href:!0,rel:!0});var Rd=a(be);Ve=i(Rd,"here"),Rd.forEach(t),H=i(Cn,"."),Cn.forEach(t),Ae=d(o),b(he.$$.fragment,o),He=d(o),P=s(o,"H2",{class:!0});var ha=a(P);S=s(ha,"A",{id:!0,class:!0,href:!0});var Kd=a(S);Ce=s(Kd,"SPAN",{});var Gd=a(Ce);b(we.$$.fragment,Gd),Gd.forEach(t),Kd.forEach(t),J=d(ha),ze=s(ha,"SPAN",{});var Yd=a(ze);Be=i(Yd,"TransfoXLConfig"),Yd.forEach(t),ha.forEach(t),ye=d(o),D=s(o,"DIV",{class:!0});var Ze=a(D);b(Kt.$$.fragment,Ze),Da=d(Ze),Ye=s(Ze,"P",{});var Ut=a(Ye);Ia=i(Ut,"This is the configuration class to store the configuration of a "),cn=s(Ut,"A",{href:!0});var Qd=a(cn);Wa=i(Qd,"TransfoXLModel"),Qd.forEach(t),Va=i(Ut," or a "),fn=s(Ut,"A",{href:!0});var Zd=a(fn);Ba=i(Zd,"TFTransfoXLModel"),Zd.forEach(t),Ua=i(Ut,`. It is
used to instantiate a Transformer-XL model according to the specified arguments, defining the model architecture.
...
XL`),Jd.forEach(t),Ka=i(Ut," architecture."),Ut.forEach(t),Ga=d(Ze),lt=s(Ze,"P",{});var zn=a(lt);Ya=i(zn,"Configuration objects inherit from "),mn=s(zn,"A",{href:!0});var ec=a(mn);Qa=i(ec,"PretrainedConfig"),ec.forEach(t),Za=i(zn,` and can be used to control the model outputs. Read the
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Fa.forEach(t),Ii=d(Ne),Y=s(Ne,"DIV",{class:!0});var ce=a(Y);b(Mo.$$.fragment,ce),Wi=d(ce),bt=s(ce,"P",{});var On=a(bt);Vi=i(On,"The "),Ln=s(On,"A",{href:!0});var Bc=a(Ln);Bi=i(Bc,"TransfoXLForSequenceClassification"),Bc.forEach(t),Ui=i(On," forward method, overrides the "),ms=s(On,"CODE",{});var Uc=a(ms);Ri=i(Uc,"__call__"),Uc.forEach(t),Ki=i(On," special method."),On.forEach(t),Gi=d(ce),b(jt.$$.fragment,ce),Yi=d(ce),hs=s(ce,"P",{});var Rc=a(hs);Qi=i(Rc,"Example of single-label classification:"),Rc.forEach(t),Zi=d(ce),b(Eo.$$.fragment,ce),Ji=d(ce),b(Fo.$$.fragment,ce),el=d(ce),ps=s(ce,"P",{});var Kc=a(ps);tl=i(Kc,"Example of multi-label classification:"),Kc.forEach(t),ol=d(ce),b(qo.$$.fragment,ce),nl=d(ce),b(Co.$$.fragment,ce),ce.forEach(t),Ne.forEach(t),oa=d(o),wt=s(o,"H2",{class:!0});var qa=a(wt);Ot=s(qa,"A",{id:!0,class:!0,href:!0});var Gc=a(Ot);us=s(Gc,"SPAN",{});var Yc=a(us);b(zo.$$.fragment,Yc),Yc.forEach(t),Gc.forEach(t),sl=d(qa),gs=s(qa,"SPAN",{});var Qc=a(gs);al=i(Qc,"TFTransfoXLModel"),Qc.forEach(t),qa.forEach(t),na=d(o),pe=s(o,"DIV",{class:!0});var Ue=a(pe);b(Po.$$.fragment,Ue),rl=d(Ue),_s=s(Ue,"P",{});var Zc=a(_s);il=i(Zc,"The bare Bert Model transformer outputting raw hidden-states without any specific head on top."),Zc.forEach(t),ll=d(Ue),jo=s(Ue,"P",{});var Ca=a(jo);dl=i(Ca,"This model inherits from "),kn=s(Ca,"A",{href:!0});var Jc=a(kn);cl=i(Jc,"TFPreTrainedModel"),Jc.forEach(t),fl=i(Ca,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Ca.forEach(t),ml=d(Ue),Oo=s(Ue,"P",{});var za=a(Oo);hl=i(za,"This model is also a "),So=s(za,"A",{href:!0,rel:!0});var ef=a(So);pl=i(ef,"tf.keras.Model"),ef.forEach(t),ul=i(za,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
