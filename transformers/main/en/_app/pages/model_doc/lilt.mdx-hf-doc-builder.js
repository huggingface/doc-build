...
<span class="hljs-meta">&gt;&gt;&gt; </span>predicted_answer = tokenizer.decode(predict_answer_tokens)`}}),{c(){d=r("p"),v=n("Examples:"),g=m(),w(u.$$.fragment)},l(l){d=a(l,"P",{});var p=i(d);v=s(p,"Examples:"),p.forEach(o),g=f(l),T(u.$$.fragment,l)},m(l,p){_(l,d,p),e(d,v),_(l,g,p),y(u,l,p),b=!0},p:yo,i(l){b||(L(u.$$.fragment,l),b=!0)},o(l){k(u.$$.fragment,l),b=!1},d(l){l&&o(d),l&&o(g),$(u,l)}}}function ai(x){let d,v,g,u,b,l,p,C,ln,Lo,J,ie,Qt,Ee,dn,Rt,cn,ko,I,pn,Me,hn,mn,ut,fn,un,$o,gt,gn,xo,_t,Bt,_n,Co,bt,bn,qo,vt,M,vn,Fe,wn,Tn,Ae,yn,Ln,Ht,kn,$n,Jt,xn,Cn,zo,je,Eo,U,Gt,qn,zn,D,En,wt,Mn,Fn,Tt,An,jn,yt,Sn,Pn,On,Se,Dn,Pe,Nn,In,Mo,le,Ir,Fo,de,Un,Lt,Wn,Vn,Ao,W,Qn,Oe,Rn,Bn,De,Hn,Jn,jo,G,ce,Xt,Ne,Gn,Kt,Xn,So,N,Ie,Kn,F,Yn,kt,Zn,es,Ue,ts,os,$t,ns,ss,xt,rs,as,is,pe,Po,X,he,Yt,We,ls,Zt,ds,Oo,A,Ve,cs,Qe,ps,Ct,hs,ms,fs,Re,us,Be,gs,_s,bs,j,He,vs,K,ws,qt,Ts,ys,eo,Ls,ks,$s,me,xs,fe,Do,Y,ue,to,Je,Cs,oo,qs,No,q,Ge,zs,no,Es,Ms,Xe,Fs,zt,As,js,Ss,Ke,Ps,Ye,Os,Ds,Ns,S,Ze,Is,Z,Us,Et,Ws,Vs,so,Qs,Rs,Bs,ge,Hs,_e,Io,ee,be,ro,et,Js,ao,Gs,Uo,z,tt,Xs,io,Ks,Ys,ot,Zs,Mt,er,tr,or,nt,nr,st,sr,rr,ar,P,rt,ir,te,lr,Ft,dr,cr,lo,pr,hr,mr,ve,fr,we,Wo,oe,Te,co,at,ur,po,gr,Vo,E,it,_r,ne,br,ho,vr,wr,mo,Tr,yr,Lr,lt,kr,At,$r,xr,Cr,dt,qr,ct,zr,Er,Mr,O,pt,Fr,se,Ar,jt,jr,Sr,fo,Pr,Or,Dr,ye,Nr,Le,Qo;return l=new ft({}),Ee=new ft({}),je=new Vt({props:{code:`from transformers import LiltModel
...
`}}),ye=new an({props:{$$slots:{default:[si]},$$scope:{ctx:x}}}),Le=new To({props:{anchor:"transformers.LiltForQuestionAnswering.forward.example",$$slots:{default:[ri]},$$scope:{ctx:x}}}),{c(){d=r("meta"),v=m(),g=r("h1"),u=r("a"),b=r("span"),w(l.$$.fragment),p=m(),C=r("span"),ln=n("LiLT"),Lo=m(),J=r("h2"),ie=r("a"),Qt=r("span"),w(Ee.$$.fragment),dn=m(),Rt=r("span"),cn=n("Overview"),ko=m(),I=r("p"),pn=n("The LiLT model was proposed in "),Me=r("a"),hn=n("LiLT: A Simple yet Effective Language-Independent Layout Transformer for Structured Document Understanding"),mn=n(` by Jiapeng Wang, Lianwen Jin, Kai Ding.
...
and behavior.`),bs=m(),j=r("div"),w(He.$$.fragment),vs=m(),K=r("p"),ws=n("The "),qt=r("a"),Ts=n("LiltModel"),ys=n(" forward method, overrides the "),eo=r("code"),Ls=n("__call__"),ks=n(" special method."),$s=m(),w(me.$$.fragment),xs=m(),w(fe.$$.fragment),Do=m(),Y=r("h2"),ue=r("a"),to=r("span"),w(Je.$$.fragment),Cs=m(),oo=r("span"),qs=n("LiltForSequenceClassification"),No=m(),q=r("div"),w(Ge.$$.fragment),zs=m(),no=r("p"),Es=n(`LiLT Model transformer with a sequence classification/regression head on top (a linear layer on top of the pooled
output) e.g. for GLUE tasks.`),Ms=m(),Xe=r("p"),Fs=n("This model inherits from "),zt=r("a"),As=n("PreTrainedModel"),js=n(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Ss=m(),Ke=r("p"),Ps=n("This model is also a PyTorch "),Ye=r("a"),Os=n("torch.nn.Module"),Ds=n(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Ns=m(),S=r("div"),w(Ze.$$.fragment),Is=m(),Z=r("p"),Us=n("The "),Et=r("a"),Ws=n("LiltForSequenceClassification"),Vs=n(" forward method, overrides the "),so=r("code"),Qs=n("__call__"),Rs=n(" special method."),Bs=m(),w(ge.$$.fragment),Hs=m(),w(_e.$$.fragment),Io=m(),ee=r("h2"),be=r("a"),ro=r("span"),w(et.$$.fragment),Js=m(),ao=r("span"),Gs=n("LiltForTokenClassification"),Uo=m(),z=r("div"),w(tt.$$.fragment),Xs=m(),io=r("p"),Ks=n(`Lilt Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g. for
Named-Entity-Recognition (NER) tasks.`),Ys=m(),ot=r("p"),Zs=n("This model inherits from "),Mt=r("a"),er=n("PreTrainedModel"),tr=n(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),or=m(),nt=r("p"),nr=n("This model is also a PyTorch "),st=r("a"),sr=n("torch.nn.Module"),rr=n(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),ar=m(),P=r("div"),w(rt.$$.fragment),ir=m(),te=r("p"),lr=n("The "),Ft=r("a"),dr=n("LiltForTokenClassification"),cr=n(" forward method, overrides the "),lo=r("code"),pr=n("__call__"),hr=n(" special method."),mr=m(),w(ve.$$.fragment),fr=m(),w(we.$$.fragment),Wo=m(),oe=r("h2"),Te=r("a"),co=r("span"),w(at.$$.fragment),ur=m(),po=r("span"),gr=n("LiltForQuestionAnswering"),Vo=m(),E=r("div"),w(it.$$.fragment),_r=m(),ne=r("p"),br=n(`Lilt Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Cr=m(),dt=r("p"),qr=n("This model is also a PyTorch "),ct=r("a"),zr=n("torch.nn.Module"),Er=n(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Mr=m(),O=r("div"),w(pt.$$.fragment),Fr=m(),se=r("p"),Ar=n("The "),jt=r("a"),jr=n("LiltForQuestionAnswering"),Sr=n(" forward method, overrides the "),fo=r("code"),Pr=n("__call__"),Or=n(" special method."),Dr=m(),w(ye.$$.fragment),Nr=m(),w(Le.$$.fragment),this.h()},l(t){const h=Ja('[data-svelte="svelte-1phssyn"]',document.head);d=a(h,"META",{name:!0,content:!0}),h.forEach(o),v=f(t),g=a(t,"H1",{class:!0});var ht=i(g);u=a(ht,"A",{id:!0,class:!0,href:!0});var uo=i(u);b=a(uo,"SPAN",{});var go=i(b);T(l.$$.fragment,go),go.forEach(o),uo.forEach(o),p=f(ht),C=a(ht,"SPAN",{});var _o=i(C);ln=s(_o,"LiLT"),_o.forEach(o),ht.forEach(o),Lo=f(t),J=a(t,"H2",{class:!0});var mt=i(J);ie=a(mt,"A",{id:!0,class:!0,href:!0});var bo=i(ie);Qt=a(bo,"SPAN",{});var vo=i(Qt);T(Ee.$$.fragment,vo),vo.forEach(o),bo.forEach(o),dn=f(mt),Rt=a(mt,"SPAN",{});var wo=i(Rt);cn=s(wo,"Overview"),wo.forEach(o),mt.forEach(o),ko=f(t),I=a(t,"P",{});var re=i(I);pn=s(re,"The LiLT model was proposed in "),Me=a(re,"A",{href:!0,rel:!0});var Ur=i(Me);hn=s(Ur,"LiLT: A Simple yet Effective Language-Independent Layout Transformer for Structured Document Understanding"),Ur.forEach(o),mn=s(re,` by Jiapeng Wang, Lianwen Jin, Kai Ding.
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Xo.forEach(o),bs=f($e),j=a($e,"DIV",{class:!0});var xe=i(j);T(He.$$.fragment,xe),vs=f(xe),K=a(xe,"P",{});var Dt=i(K);ws=s(Dt,"The "),qt=a(Dt,"A",{href:!0});var ba=i(qt);Ts=s(ba,"LiltModel"),ba.forEach(o),ys=s(Dt," forward method, overrides the "),eo=a(Dt,"CODE",{});var va=i(eo);Ls=s(va,"__call__"),va.forEach(o),ks=s(Dt," special method."),Dt.forEach(o),$s=f(xe),T(me.$$.fragment,xe),xs=f(xe),T(fe.$$.fragment,xe),xe.forEach(o),$e.forEach(o),Do=f(t),Y=a(t,"H2",{class:!0});var Ko=i(Y);ue=a(Ko,"A",{id:!0,class:!0,href:!0});var wa=i(ue);to=a(wa,"SPAN",{});var Ta=i(to);T(Je.$$.fragment,Ta),Ta.forEach(o),wa.forEach(o),Cs=f(Ko),oo=a(Ko,"SPAN",{});var ya=i(oo);qs=s(ya,"LiltForSequenceClassification"),ya.forEach(o),Ko.forEach(o),No=f(t),q=a(t,"DIV",{class:!0});var R=i(q);T(Ge.$$.fragment,R),zs=f(R),no=a(R,"P",{});var La=i(no);Es=s(La,`LiLT Model transformer with a sequence classification/regression head on top (a linear layer on top of the pooled
output) e.g. for GLUE tasks.`),La.forEach(o),Ms=f(R),Xe=a(R,"P",{});var Yo=i(Xe);Fs=s(Yo,"This model inherits from "),zt=a(Yo,"A",{href:!0});var ka=i(zt);As=s(ka,"PreTrainedModel"),ka.forEach(o),js=s(Yo,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Zo.forEach(o),Ns=f(R),S=a(R,"DIV",{class:!0});var Ce=i(S);T(Ze.$$.fragment,Ce),Is=f(Ce),Z=a(Ce,"P",{});var Nt=i(Z);Us=s(Nt,"The "),Et=a(Nt,"A",{href:!0});var xa=i(Et);Ws=s(xa,"LiltForSequenceClassification"),xa.forEach(o),Vs=s(Nt," forward method, overrides the "),so=a(Nt,"CODE",{});var Ca=i(so);Qs=s(Ca,"__call__"),Ca.forEach(o),Rs=s(Nt," special method."),Nt.forEach(o),Bs=f(Ce),T(ge.$$.fragment,Ce),Hs=f(Ce),T(_e.$$.fragment,Ce),Ce.forEach(o),R.forEach(o),Io=f(t),ee=a(t,"H2",{class:!0});var en=i(ee);be=a(en,"A",{id:!0,class:!0,href:!0});var qa=i(be);ro=a(qa,"SPAN",{});var za=i(ro);T(et.$$.fragment,za),za.forEach(o),qa.forEach(o),Js=f(en),ao=a(en,"SPAN",{});var Ea=i(ao);Gs=s(Ea,"LiltForTokenClassification"),Ea.forEach(o),en.forEach(o),Uo=f(t),z=a(t,"DIV",{class:!0});var B=i(z);T(tt.$$.fragment,B),Xs=f(B),io=a(B,"P",{});var Ma=i(io);Ks=s(Ma,`Lilt Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g. for
Named-Entity-Recognition (NER) tasks.`),Ma.forEach(o),Ys=f(B),ot=a(B,"P",{});var tn=i(ot);Zs=s(tn,"This model inherits from "),Mt=a(tn,"A",{href:!0});var Fa=i(Mt);er=s(Fa,"PreTrainedModel"),Fa.forEach(o),tr=s(tn,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),on.forEach(o),ar=f(B),P=a(B,"DIV",{class:!0});var qe=i(P);T(rt.$$.fragment,qe),ir=f(qe),te=a(qe,"P",{});var It=i(te);lr=s(It,"The "),Ft=a(It,"A",{href:!0});var ja=i(Ft);dr=s(ja,"LiltForTokenClassification"),ja.forEach(o),cr=s(It," forward method, overrides the "),lo=a(It,"CODE",{});var Sa=i(lo);pr=s(Sa,"__call__"),Sa.forEach(o),hr=s(It," special method."),It.forEach(o),mr=f(qe),T(ve.$$.fragment,qe),fr=f(qe),T(we.$$.fragment,qe),qe.forEach(o),B.forEach(o),Wo=f(t),oe=a(t,"H2",{class:!0});var nn=i(oe);Te=a(nn,"A",{id:!0,class:!0,href:!0});var Pa=i(Te);co=a(Pa,"SPAN",{});var Oa=i(co);T(at.$$.fragment,Oa),Oa.forEach(o),Pa.forEach(o),ur=f(nn),po=a(nn,"SPAN",{});var Da=i(po);gr=s(Da,"LiltForQuestionAnswering"),Da.forEach(o),nn.forEach(o),Vo=f(t),E=a(t,"DIV",{class:!0});var H=i(E);T(it.$$.fragment,H),_r=f(H),ne=a(H,"P",{});var Ut=i(ne);br=s(Ut,`Lilt Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
