...
Whether or not to return a <a href="/docs/transformers/main/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/lilt/modeling_lilt.py#L730",returnDescription:`
<p>A <a
...
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/lilt/modeling_lilt.py#L865",returnDescription:`
<p>A <a
...
model. Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/main/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/lilt/modeling_lilt.py#L968"}}),it=new ie({props:{name:"forward",anchor:"transformers.LiltForTokenClassification.forward",parameters:[{name:"input_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"bbox",val:": typing.Optional[torch.LongTensor] = None"},{name:"attention_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"token_type_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"position_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"head_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"labels",val:": typing.Optional[torch.LongTensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.LiltForTokenClassification.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/main/en/model_doc/roberta#transformers.RobertaTokenizer">RobertaTokenizer</a>. See <a href="/docs/transformers/main/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/main/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/lilt/modeling_lilt.py#L987",returnDescription:`
<p>A <a
...
model. Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/main/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/lilt/modeling_lilt.py#L1095"}}),mt=new ie({props:{name:"forward",anchor:"transformers.LiltForQuestionAnswering.forward",parameters:[{name:"input_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"bbox",val:": typing.Optional[torch.LongTensor] = None"},{name:"attention_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"token_type_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"position_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"head_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"start_positions",val:": typing.Optional[torch.LongTensor] = None"},{name:"end_positions",val:": typing.Optional[torch.LongTensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.LiltForQuestionAnswering.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/main/en/model_doc/roberta#transformers.RobertaTokenizer">RobertaTokenizer</a>. See <a href="/docs/transformers/main/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/main/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/lilt/modeling_lilt.py#L1110",returnDescription:`
<p>A <a
...
`}}),ke=new dn({props:{$$slots:{default:[hi]},$$scope:{ctx:x}}}),Le=new ko({props:{anchor:"transformers.LiltForQuestionAnswering.forward.example",$$slots:{default:[mi]},$$scope:{ctx:x}}}),{c(){c=r("meta"),v=m(),g=r("h1"),u=r("a"),b=r("span"),w(l.$$.fragment),p=m(),C=r("span"),cn=n("LiLT"),$o=m(),G=r("h2"),le=r("a"),Bt=r("span"),w(Ee.$$.fragment),pn=m(),Ht=r("span"),hn=n("Overview"),xo=m(),U=r("p"),mn=n("The LiLT model was proposed in "),Me=r("a"),fn=n("LiLT: A Simple yet Effective Language-Independent Layout Transformer for Structured Document Understanding"),un=n(` by Jiapeng Wang, Lianwen Jin, Kai Ding.
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Yo.forEach(o),Ls=f($e),S=a($e,"DIV",{class:!0});var xe=i(S);T(Ge.$$.fragment,xe),$s=f(xe),Y=a(xe,"P",{});var It=i(Y);xs=s(It,"The "),Et=a(It,"A",{href:!0});var xa=i(Et);Cs=s(xa,"LiltModel"),xa.forEach(o),qs=s(It," forward method, overrides the "),oo=a(It,"CODE",{});var Ca=i(oo);zs=s(Ca,"__call__"),Ca.forEach(o),Es=s(It," special method."),It.forEach(o),Ms=f(xe),T(fe.$$.fragment,xe),Fs=f(xe),T(ue.$$.fragment,xe),xe.forEach(o),$e.forEach(o),Io=f(t),Z=a(t,"H2",{class:!0});var Zo=i(Z);ge=a(Zo,"A",{id:!0,class:!0,href:!0});var qa=i(ge);no=a(qa,"SPAN",{});var za=i(no);T(Xe.$$.fragment,za),za.forEach(o),qa.forEach(o),As=f(Zo),so=a(Zo,"SPAN",{});var Ea=i(so);js=s(Ea,"LiltForSequenceClassification"),Ea.forEach(o),Zo.forEach(o),Uo=f(t),z=a(t,"DIV",{class:!0});var B=i(z);T(Ke.$$.fragment,B),Ss=f(B),ro=a(B,"P",{});var Ma=i(ro);Ps=s(Ma,`LiLT Model transformer with a sequence classification/regression head on top (a linear layer on top of the pooled
output) e.g. for GLUE tasks.`),Ma.forEach(o),Os=f(B),Ye=a(B,"P",{});var en=i(Ye);Ds=s(en,"This model inherits from "),Mt=a(en,"A",{href:!0});var Fa=i(Mt);Ns=s(Fa,"PreTrainedModel"),Fa.forEach(o),Is=s(en,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),sn.forEach(o),hr=f(H),O=a(H,"DIV",{class:!0});var qe=i(O);T(it.$$.fragment,qe),mr=f(qe),oe=a(qe,"P",{});var Wt=i(oe);fr=s(Wt,"The "),jt=a(Wt,"A",{href:!0});var Wa=i(jt);ur=s(Wa,"LiltForTokenClassification"),Wa.forEach(o),gr=s(Wt," forward method, overrides the "),po=a(Wt,"CODE",{});var Qa=i(po);_r=s(Qa,"__call__"),Qa.forEach(o),br=s(Wt," special method."),Wt.forEach(o),vr=f(qe),T(we.$$.fragment,qe),wr=f(qe),T(Te.$$.fragment,qe),qe.forEach(o),H.forEach(o),Vo=f(t),ne=a(t,"H2",{class:!0});var rn=i(ne);ye=a(rn,"A",{id:!0,class:!0,href:!0});var Va=i(ye);ho=a(Va,"SPAN",{});var Ra=i(ho);T(lt.$$.fragment,Ra),Ra.forEach(o),Va.forEach(o),Tr=f(rn),mo=a(rn,"SPAN",{});var Ba=i(mo);yr=s(Ba,"LiltForQuestionAnswering"),Ba.forEach(o),rn.forEach(o),Ro=f(t),M=a(t,"DIV",{class:!0});var J=i(M);T(dt.$$.fragment,J),kr=f(J),se=a(J,"P",{});var Qt=i(se);Lr=s(Qt,`Lilt Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
