...
methods above for more information.`),this.h()},l(A){h=r(A,"P",{});var q=i(h);z=s(q,`This class method is simply calling the feature extractor
`),f=r(q,"A",{href:!0});var E=i(f);g=s(E,"from_pretrained()"),E.forEach(t),S=s(q,` and the tokenizer
`),_=r(q,"CODE",{});var N=i(_);w=s(N,"from_pretrained"),N.forEach(t),$=s(q,` methods. Please refer to the docstrings of the
methods above for more information.`),q.forEach(t),this.h()},h(){d(f,"href","/docs/transformers/main/en/main_classes/feature_extractor#transformers.FeatureExtractionMixin.from_pretrained")},m(A,q){p(A,h,q),e(h,z),e(h,f),e(f,g),e(h,S),e(h,_),e(_,w),e(h,$)},d(A){A&&t(h)}}}function Tp(R){let h,z,f,g,S,_,w,$;return{c(){h=a("p"),z=n("This class method is simply calling "),f=a("a"),g=n("save_pretrained()"),S=n(` and
`),_=a("code"),w=n("save_pretrained"),$=n(`. Please refer to the docstrings of the methods
above for more information.`),this.h()},l(A){h=r(A,"P",{});var q=i(h);z=s(q,"This class method is simply calling "),f=r(q,"A",{href:!0});var E=i(f);g=s(E,"save_pretrained()"),E.forEach(t),S=s(q,` and
`),_=r(q,"CODE",{});var N=i(_);w=s(N,"save_pretrained"),N.forEach(t),$=s(q,`. Please refer to the docstrings of the methods
above for more information.`),q.forEach(t),this.h()},h(){d(f,"href","/docs/transformers/main/en/main_classes/feature_extractor#transformers.FeatureExtractionMixin.save_pretrained")},m(A,q){p(A,h,q),e(h,z),e(h,f),e(f,g),e(h,S),e(h,_),e(_,w),e(h,$)},d(A){A&&t(h)}}}function vp(R){let h,z,f,g,S;return{c(){h=a("p"),z=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=a("code"),g=n("Module"),S=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(_){h=r(_,"P",{});var w=i(h);z=s(w,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=r(w,"CODE",{});var $=i(f);g=s($,"Module"),$.forEach(t),S=s(w,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),w.forEach(t)},m(_,w){p(_,h,w),e(h,z),e(h,f),e(f,g),e(h,S)},d(_){_&&t(h)}}}function xp(R){let h,z,f,g,S;return{c(){h=a("p"),z=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=a("code"),g=n("Module"),S=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(_){h=r(_,"P",{});var w=i(h);z=s(w,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=r(w,"CODE",{});var $=i(f);g=s($,"Module"),$.forEach(t),S=s(w,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),w.forEach(t)},m(_,w){p(_,h,w),e(h,z),e(h,f),e(f,g),e(h,S)},d(_){_&&t(h)}}}function kp(R){let h,z,f,g,S,_,w,$,A,q,E,N,V,ee,Fe,B,je,$e,C,J,te,ye,P,M,Pe,oe,ne,Me,se,ae,Ce,O,Ee,L,Ae,re,ie,Ie,de,K,De,Z,Y;return{c(){h=a("p"),z=n("TF 2.0 models accepts two formats as inputs:"),f=c(),g=a("ul"),S=a("li"),_=n("having all inputs as keyword arguments (like PyTorch models), or"),w=c(),$=a("li"),A=n("having all inputs as a list, tuple or dict in the first positional arguments."),q=c(),E=a("p"),N=n("This second option is useful when using "),V=a("code"),ee=n("tf.keras.Model.fit"),Fe=n(` method which currently requires having all the
...
`),Z=r(Le,"CODE",{});var dt=i(Z);Y=s(dt,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),dt.forEach(t),Le.forEach(t),G.forEach(t)},m(u,F){p(u,h,F),e(h,z),p(u,f,F),p(u,g,F),e(g,S),e(S,_),e(g,w),e(g,$),e($,A),p(u,q,F),p(u,E,F),e(E,N),e(E,V),e(V,ee),e(E,Fe),e(E,B),e(B,je),e(E,$e),p(u,C,F),p(u,J,F),e(J,te),p(u,ye,F),p(u,P,F),e(P,M),e(M,Pe),e(M,oe),e(oe,ne),e(M,Me),e(M,se),e(se,ae),e(P,Ce),e(P,O),e(O,Ee),e(O,L),e(L,Ae),e(O,re),e(O,ie),e(ie,Ie),e(P,de),e(P,K),e(K,De),e(K,Z),e(Z,Y)},d(u){u&&t(h),u&&t(f),u&&t(g),u&&t(q),u&&t(E),u&&t(C),u&&t(J),u&&t(ye),u&&t(P)}}}function bp(R){let h,z,f,g,S;return{c(){h=a("p"),z=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=a("code"),g=n("Module"),S=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(_){h=r(_,"P",{});var w=i(h);z=s(w,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=r(w,"CODE",{});var $=i(f);g=s($,"Module"),$.forEach(t),S=s(w,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),w.forEach(t)},m(_,w){p(_,h,w),e(h,z),e(h,f),e(f,g),e(h,S)},d(_){_&&t(h)}}}function yp(R){let h,z,f,g,S,_,w,$,A,q,E,N,V,ee,Fe,B,je,$e,C,J,te,ye,P,M,Pe,oe,ne,Me,se,ae,Ce,O,Ee,L,Ae,re,ie,Ie,de,K,De,Z,Y;return{c(){h=a("p"),z=n("TF 2.0 models accepts two formats as inputs:"),f=c(),g=a("ul"),S=a("li"),_=n("having all inputs as keyword arguments (like PyTorch models), or"),w=c(),$=a("li"),A=n("having all inputs as a list, tuple or dict in the first positional arguments."),q=c(),E=a("p"),N=n("This second option is useful when using "),V=a("code"),ee=n("tf.keras.Model.fit"),Fe=n(` method which currently requires having all the
tensors in the first argument of the model call function: `),B=a("code"),je=n("model(inputs)"),$e=n("."),C=c(),J=a("p"),te=n(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),ye=c(),P=a("ul"),M=a("li"),Pe=n("a single Tensor with "),oe=a("code"),ne=n("input_ids"),Me=n(" only and nothing else: "),se=a("code"),ae=n("model(input_ids)"),Ce=c(),O=a("li"),Ee=n(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),L=a("code"),Ae=n("model([input_ids, attention_mask])"),re=n(" or "),ie=a("code"),Ie=n("model([input_ids, attention_mask, token_type_ids])"),de=c(),K=a("li"),De=n(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),Z=a("code"),Y=n('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(u){h=r(u,"P",{});var F=i(h);z=s(F,"TF 2.0 models accepts two formats as inputs:"),F.forEach(t),f=l(u),g=r(u,"UL",{});var X=i(g);S=r(X,"LI",{});var st=i(S);_=s(st,"having all inputs as keyword arguments (like PyTorch models), or"),st.forEach(t),w=l(X),$=r(X,"LI",{});var Ne=i($);A=s(Ne,"having all inputs as a list, tuple or dict in the first positional arguments."),Ne.forEach(t),X.forEach(t),q=l(u),E=r(u,"P",{});var Q=i(E);N=s(Q,"This second option is useful when using "),V=r(Q,"CODE",{});var Ue=i(V);ee=s(Ue,"tf.keras.Model.fit"),Ue.forEach(t),Fe=s(Q,` method which currently requires having all the
...
first positional argument :`),at.forEach(t),ye=l(u),P=r(u,"UL",{});var G=i(P);M=r(G,"LI",{});var ce=i(M);Pe=s(ce,"a single Tensor with "),oe=r(ce,"CODE",{});var rt=i(oe);ne=s(rt,"input_ids"),rt.forEach(t),Me=s(ce," only and nothing else: "),se=r(ce,"CODE",{});var Re=i(se);ae=s(Re,"model(input_ids)"),Re.forEach(t),ce.forEach(t),Ce=l(G),O=r(G,"LI",{});var j=i(O);Ee=s(j,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),L=r(j,"CODE",{});var it=i(L);Ae=s(it,"model([input_ids, attention_mask])"),it.forEach(t),re=s(j," or "),ie=r(j,"CODE",{});var ze=i(ie);Ie=s(ze,"model([input_ids, attention_mask, token_type_ids])"),ze.forEach(t),j.forEach(t),de=l(G),K=r(G,"LI",{});var Le=i(K);De=s(Le,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),Z=r(Le,"CODE",{});var dt=i(Z);Y=s(dt,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),dt.forEach(t),Le.forEach(t),G.forEach(t)},m(u,F){p(u,h,F),e(h,z),p(u,f,F),p(u,g,F),e(g,S),e(S,_),e(g,w),e(g,$),e($,A),p(u,q,F),p(u,E,F),e(E,N),e(E,V),e(V,ee),e(E,Fe),e(E,B),e(B,je),e(E,$e),p(u,C,F),p(u,J,F),e(J,te),p(u,ye,F),p(u,P,F),e(P,M),e(M,Pe),e(M,oe),e(oe,ne),e(M,Me),e(M,se),e(se,ae),e(P,Ce),e(P,O),e(O,Ee),e(O,L),e(L,Ae),e(O,re),e(O,ie),e(ie,Ie),e(P,de),e(P,K),e(K,De),e(K,Z),e(Z,Y)},d(u){u&&t(h),u&&t(f),u&&t(g),u&&t(q),u&&t(E),u&&t(C),u&&t(J),u&&t(ye),u&&t(P)}}}function wp(R){let h,z,f,g,S;return{c(){h=a("p"),z=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=a("code"),g=n("Module"),S=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(_){h=r(_,"P",{});var w=i(h);z=s(w,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=r(w,"CODE",{});var $=i(f);g=s($,"Module"),$.forEach(t),S=s(w,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),w.forEach(t)},m(_,w){p(_,h,w),e(h,z),e(h,f),e(f,g),e(h,S)},d(_){_&&t(h)}}}function Sp(R){let h,z,f,g,S,_,w,$,A,q,E,N,V,ee,Fe,B,je,$e,C,J,te,ye,P,M,Pe,oe,ne,Me,se,ae,Ce,O,Ee,L,Ae,re,ie,Ie,de,K,De,Z,Y,u,F,X,st,Ne,Q,Ue,_e,at,G,ce,rt,Re,j,it,ze,Le,dt,hn,tr,or,pn,nr,sr,mn,ar,rr,Zs,W,ir,Yn,dr,cr,Xn,lr,hr,Qn,pr,mr,Zn,ur,fr,es,_r,gr,Xt,Tr,vr,ts,xr,ea,un,os,kr,ta,Qt,oa,fn,Zt,ns,br,yr,le,wr,ss,Sr,$r,as,Er,zr,rs,qr,Fr,is,jr,Pr,ds,Mr,Cr,na,eo,sa,yt,Ar,to,Ir,Dr,aa,ct,wt,cs,oo,Nr,ls,Lr,ra,he,no,Or,lt,Gr,_n,Wr,Ur,so,Rr,Hr,Vr,ht,Br,gn,Jr,Kr,Tn,Yr,Xr,Qr,hs,Zr,ei,ao,ia,pt,St,ps,ro,ti,ms,oi,da,U,io,ni,us,si,ai,co,ri,vn,ii,di,ci,$t,lo,li,fs,hi,pi,Et,ho,mi,po,ui,_s,fi,_i,gi,He,mo,Ti,xn,vi,kn,xi,ki,gs,bi,yi,bn,uo,ca,mt,zt,Ts,fo,wi,vs,Si,la,pe,_o,$i,xs,Ei,zi,go,qi,yn,Fi,ji,Pi,ks,Mi,Ci,qt,To,Ai,bs,Ii,ha,ut,Ft,ys,vo,Di,ws,Ni,pa,I,xo,Li,Ss,Oi,Gi,ge,wn,Wi,Ui,Sn,Ri,Hi,$n,Vi,Bi,ko,$s,Ji,Ki,Yi,En,Xi,Qi,Zi,jt,bo,ed,Oe,td,yo,Es,od,nd,sd,zn,ad,rd,wo,zs,id,dd,cd,ld,Ve,So,hd,qs,pd,md,Pt,ud,Be,$o,fd,Eo,_d,qn,gd,Td,vd,Mt,xd,Ct,zo,kd,qo,bd,Fn,yd,wd,Sd,At,Fo,$d,jo,Ed,jn,zd,qd,Fd,It,Po,jd,Fs,Pd,ma,ft,Dt,js,Mo,Md,Ps,Cd,ua,we,Co,Ad,Ao,Id,Pn,Dd,Nd,Ld,Io,Od,Do,Gd,Wd,Ud,Te,No,Rd,_t,Hd,Mn,Vd,Bd,Ms,Jd,Kd,Yd,Nt,Xd,Cs,Qd,Zd,Lo,fa,gt,Lt,As,Oo,ec,Is,tc,_a,Se,Go,oc,Wo,nc,Cn,sc,ac,rc,Uo,ic,Ro,dc,cc,lc,ve,Ho,hc,Tt,pc,An,mc,uc,Ds,fc,_c,gc,Ot,Tc,Ns,vc,xc,Vo,ga,vt,Gt,Ls,Bo,kc,Os,bc,Ta,me,Jo,yc,Ko,wc,In,Sc,$c,Ec,Yo,zc,Xo,qc,Fc,jc,Wt,Pc,xe,Qo,Mc,xt,Cc,Dn,Ac,Ic,Gs,Dc,Nc,Lc,Ut,Oc,Ws,Gc,Wc,Zo,va,kt,Rt,Us,en,Uc,Rs,Rc,xa,ue,tn,Hc,on,Vc,Nn,Bc,Jc,Kc,nn,Yc,sn,Xc,Qc,Zc,Ht,el,ke,an,tl,bt,ol,Ln,nl,sl,Hs,al,rl,il,Vt,dl,Vs,cl,ll,rn,ka;return _=new We({}),ee=new We({}),X=new We({}),Qt=new ln({props:{code:`import torch
...
Model configuration class with all the parameters of the model. Initializing with a config file does not
load the weights associated with the model, only the configuration. Check out the
<a href="/docs/transformers/main/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),Ho=new D({props:{name:"forward",anchor:"transformers.Speech2TextForConditionalGeneration.forward",parameters:[{name:"input_features",val:" = None"},{name:"attention_mask",val:" = None"},{name:"decoder_input_ids",val:" = None"},{name:"decoder_attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"decoder_head_mask",val:" = None"},{name:"cross_attn_head_mask",val:" = None"},{name:"encoder_outputs",val:" = None"},{name:"past_key_values",val:" = None"},{name:"decoder_inputs_embeds",val:" = None"},{name:"labels",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/speech_to_text/modeling_speech_to_text.py#L1284",parametersDescription:[{anchor:"transformers.Speech2TextForConditionalGeneration.forward.input_features",description:`<strong>input_features</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length, feature_size)</code>) &#x2014;
Float values of fbank features extracted from the raw speech waveform. Raw speech waveform can be obtained
by loading a <code>.flac</code> or <code>.wav</code> audio file into an array of type <code>List[float]</code> or a <code>numpy.ndarray</code>, <em>e.g.</em>
via the soundfile library (<code>pip install soundfile</code>). To prepare the array into <code>input_features</code>, the
<a href="/docs/transformers/main/en/model_doc/speech_to_text#transformers.Speech2TextTokenizer">Speech2TextTokenizer</a> should be used for extracting the fbank features, padding and conversion into a
...
<p><a
  href="/docs/transformers/main/en/main_classes/output#transformers.modeling_outputs.Seq2SeqLMOutput"
>transformers.modeling_outputs.Seq2SeqLMOutput</a> or <code>tuple(torch.FloatTensor)</code></p>
`}}),Ot=new Yt({props:{$$slots:{default:[xp]},$$scope:{ctx:R}}}),Vo=new ln({props:{code:`import torch
from transformers import Speech2TextProcessor, Speech2TextForConditionalGeneration
from datasets import load_dataset
...
`}}),Vt=new Yt({props:{$$slots:{default:[wp]},$$scope:{ctx:R}}}),rn=new ln({props:{code:`import tensorflow as tf
...
special tokens using the tokenizer `),_s=a("code"),fi=n("prepare_for_model"),_i=n(" method."),gi=c(),He=a("div"),T(mo.$$.fragment),Ti=c(),xn=a("p"),vi=n("Create the token type IDs corresponding to the sequences passed. "),kn=a("a"),xi=n(`What are token type
IDs?`),ki=c(),gs=a("p"),bi=n("Should be overridden in a subclass if the model has a special way of building those."),yi=c(),bn=a("div"),T(uo.$$.fragment),ca=c(),mt=a("h2"),zt=a("a"),Ts=a("span"),T(fo.$$.fragment),wi=c(),vs=a("span"),Si=n("Speech2TextFeatureExtractor"),la=c(),pe=a("div"),T(_o.$$.fragment),$i=c(),xs=a("p"),Ei=n("Constructs a Speech2Text feature extractor."),zi=c(),go=a("p"),qi=n("This feature extractor inherits from "),yn=a("a"),Fi=n("Speech2TextFeatureExtractor"),ji=n(` which contains most of the main methods. Users
...
information.`),ld=c(),Ve=a("div"),T(So.$$.fragment),hd=c(),qs=a("p"),pd=n("Instantiate a processor associated with a pretrained model."),md=c(),T(Pt.$$.fragment),ud=c(),Be=a("div"),T($o.$$.fragment),fd=c(),Eo=a("p"),_d=n(`Saves the attributes of this processor (feature extractor, tokenizer\u2026) in the specified directory so that it
...
Speech2Text.`),ma=c(),ft=a("h2"),Dt=a("a"),js=a("span"),T(Mo.$$.fragment),Md=c(),Ps=a("span"),Cd=n("Speech2TextModel"),ua=c(),we=a("div"),T(Co.$$.fragment),Ad=c(),Ao=a("p"),Id=n(`The bare Speech2Text Model outputting raw hidden-states without any specific head on top.
...
and behavior.`),Ud=c(),Te=a("div"),T(No.$$.fragment),Rd=c(),_t=a("p"),Hd=n("The "),Mn=a("a"),Vd=n("Speech2TextModel"),Bd=n(" forward method, overrides the "),Ms=a("code"),Jd=n("__call__"),Kd=n(" special method."),Yd=c(),T(Nt.$$.fragment),Xd=c(),Cs=a("p"),Qd=n("Example:"),Zd=c(),T(Lo.$$.fragment),fa=c(),gt=a("h2"),Lt=a("a"),As=a("span"),T(Oo.$$.fragment),ec=c(),Is=a("span"),tc=n("Speech2TextForConditionalGeneration"),_a=c(),Se=a("div"),T(Go.$$.fragment),oc=c(),Wo=a("p"),nc=n(`The Speech2Text Model with a language modeling head. Can be used for summarization.
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),lc=c(),ve=a("div"),T(Ho.$$.fragment),hc=c(),Tt=a("p"),pc=n("The "),An=a("a"),mc=n("Speech2TextForConditionalGeneration"),uc=n(" forward method, overrides the "),Ds=a("code"),fc=n("__call__"),_c=n(" special method."),gc=c(),T(Ot.$$.fragment),Tc=c(),Ns=a("p"),vc=n("Example:"),xc=c(),T(Vo.$$.fragment),ga=c(),vt=a("h2"),Gt=a("a"),Ls=a("span"),T(Bo.$$.fragment),kc=c(),Os=a("span"),bc=n("TFSpeech2TextModel"),Ta=c(),me=a("div"),T(Jo.$$.fragment),yc=c(),Ko=a("p"),wc=n(`The bare Speech2Text Model outputting raw hidden-states without any specific head on top.
...
predicted token ids.`),Ke.forEach(t),Zs=l(o),W=r(o,"P",{});var fe=i(W);ir=s(fe,"The feature extractor depends on "),Yn=r(fe,"CODE",{});var ql=i(Yn);dr=s(ql,"torchaudio"),ql.forEach(t),cr=s(fe," and the tokenizer depends on "),Xn=r(fe,"CODE",{});var Fl=i(Xn);lr=s(Fl,"sentencepiece"),Fl.forEach(t),hr=s(fe,` so be sure to
install those packages before running the examples. You could either install those as extra speech dependencies with
`),Qn=r(fe,"CODE",{});var jl=i(Qn);pr=s(jl,'pip install transformers"[speech, sentencepiece]"'),jl.forEach(t),mr=s(fe," or install the packages seperately with "),Zn=r(fe,"CODE",{});var Pl=i(Zn);ur=s(Pl,"pip install torchaudio sentencepiece"),Pl.forEach(t),fr=s(fe,". Also "),es=r(fe,"CODE",{});var Ml=i(es);_r=s(Ml,"torchaudio"),Ml.forEach(t),gr=s(fe," requires the development version of the "),Xt=r(fe,"A",{href:!0,rel:!0});var Cl=i(Xt);Tr=s(Cl,"libsndfile"),Cl.forEach(t),vr=s(fe,` package which can be installed via a system package manager. On Ubuntu it can
...
information.`),Bt.forEach(t),Ia.forEach(t),ld=l(H),Ve=r(H,"DIV",{class:!0});var Rn=i(Ve);v(So.$$.fragment,Rn),hd=l(Rn),qs=r(Rn,"P",{});var qh=i(qs);pd=s(qh,"Instantiate a processor associated with a pretrained model."),qh.forEach(t),md=l(Rn),v(Pt.$$.fragment,Rn),Rn.forEach(t),ud=l(H),Be=r(H,"DIV",{class:!0});var Hn=i(Be);v($o.$$.fragment,Hn),fd=l(Hn),Eo=r(Hn,"P",{});var Da=i(Eo);_d=s(Da,`Saves the attributes of this processor (feature extractor, tokenizer\u2026) in the specified directory so that it
can be reloaded using the `),qn=r(Da,"A",{href:!0});var Fh=i(qn);gd=s(Fh,"from_pretrained()"),Fh.forEach(t),Td=s(Da," method."),Da.forEach(t),vd=l(Hn),v(Mt.$$.fragment,Hn),Hn.forEach(t),xd=l(H),Ct=r(H,"DIV",{class:!0});var Na=i(Ct);v(zo.$$.fragment,Na),kd=l(Na),qo=r(Na,"P",{});var La=i(qo);bd=s(La,"This method forwards all its arguments to Speech2TextTokenizer\u2019s "),Fn=r(La,"A",{href:!0});var jh=i(Fn);yd=s(jh,"batch_decode()"),jh.forEach(t),wd=s(La,`. Please
...
to the docstring of this method for more information.`),Ga.forEach(t),Oa.forEach(t),Fd=l(H),It=r(H,"DIV",{class:!0});var Wa=i(It);v(Po.$$.fragment,Wa),jd=l(Wa),Fs=r(Wa,"P",{});var Mh=i(Fs);Pd=s(Mh,`Temporarily sets the tokenizer for processing the input. Useful for encoding the labels when fine-tuning
Speech2Text.`),Mh.forEach(t),Wa.forEach(t),H.forEach(t),ma=l(o),ft=r(o,"H2",{class:!0});var Ua=i(ft);Dt=r(Ua,"A",{id:!0,class:!0,href:!0});var Ch=i(Dt);js=r(Ch,"SPAN",{});var Ah=i(js);v(Mo.$$.fragment,Ah),Ah.forEach(t),Ch.forEach(t),Md=l(Ua),Ps=r(Ua,"SPAN",{});var Ih=i(Ps);Cd=s(Ih,"Speech2TextModel"),Ih.forEach(t),Ua.forEach(t),ua=l(o),we=r(o,"DIV",{class:!0});var Jt=i(we);v(Co.$$.fragment,Jt),Ad=l(Jt),Ao=r(Jt,"P",{});var Ra=i(Ao);Id=s(Ra,`The bare Speech2Text Model outputting raw hidden-states without any specific head on top.
