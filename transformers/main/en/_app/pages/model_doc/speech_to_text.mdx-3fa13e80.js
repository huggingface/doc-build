import{S as pp,i as mp,s as up,e as a,k as c,w as T,t as n,M as fp,c as r,d as t,m as l,a as i,x as v,h as s,b as d,F as e,g as p,y as x,q as k,o as b,B as y,v as _p}from"../../chunks/vendor-6b77c823.js";import{T as Yt}from"../../chunks/Tip-39098574.js";import{D}from"../../chunks/Docstring-af1d0ae0.js";import{C as ln}from"../../chunks/CodeBlock-3a8b25a8.js";import{I as We}from"../../chunks/IconCopyLink-7a11ce68.js";function gp(U){let h,q,f,g,S,_,w,$;return{c(){h=a("p"),q=n(`This class method is simply calling the feature extractor
...
the latter silently ignores them.`)},l(_){h=r(_,"P",{});var w=i(h);q=s(w,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=r(w,"CODE",{});var $=i(f);g=s($,"Module"),$.forEach(t),S=s(w,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),w.forEach(t)},m(_,w){p(_,h,w),e(h,q),e(h,f),e(f,g),e(h,S)},d(_){_&&t(h)}}}function Sp(U){let h,q,f,g,S,_,w,$,A,z,E,N,H,ee,Fe,B,Ce,$e,M,J,te,ye,P,j,Pe,oe,ne,je,se,ae,Me,O,Ee,L,Ae,re,ie,Ie,de,K,De,Z,Y,u,F,X,st,Ne,Q,Ve,_e,at,G,ce,rt,Ue,C,it,qe,Le,dt,hn,tr,or,pn,nr,sr,mn,ar,rr,Zs,W,ir,Yn,dr,cr,Xn,lr,hr,Qn,pr,mr,Zn,ur,fr,es,_r,gr,Xt,Tr,vr,ts,xr,ea,un,os,kr,ta,Qt,oa,fn,Zt,ns,br,yr,le,wr,ss,Sr,$r,as,Er,qr,rs,zr,Fr,is,Cr,Pr,ds,jr,Mr,na,eo,sa,yt,Ar,to,Ir,Dr,aa,ct,wt,cs,oo,Nr,ls,Lr,ra,he,no,Or,lt,Gr,_n,Wr,Vr,so,Ur,Rr,Hr,ht,Br,gn,Jr,Kr,Tn,Yr,Xr,Qr,hs,Zr,ei,ao,ia,pt,St,ps,ro,ti,ms,oi,da,V,io,ni,us,si,ai,co,ri,vn,ii,di,ci,$t,lo,li,fs,hi,pi,Et,ho,mi,po,ui,_s,fi,_i,gi,Re,mo,Ti,xn,vi,kn,xi,ki,gs,bi,yi,bn,uo,ca,mt,qt,Ts,fo,wi,vs,Si,la,pe,_o,$i,xs,Ei,qi,go,zi,yn,Fi,Ci,Pi,ks,ji,Mi,zt,To,Ai,bs,Ii,ha,ut,Ft,ys,vo,Di,ws,Ni,pa,I,xo,Li,Ss,Oi,Gi,ge,wn,Wi,Vi,Sn,Ui,Ri,$n,Hi,Bi,ko,$s,Ji,Ki,Yi,En,Xi,Qi,Zi,Ct,bo,ed,Oe,td,yo,Es,od,nd,sd,qn,ad,rd,wo,qs,id,dd,cd,ld,He,So,hd,zs,pd,md,Pt,ud,Be,$o,fd,Eo,_d,zn,gd,Td,vd,jt,xd,Mt,qo,kd,zo,bd,Fn,yd,wd,Sd,At,Fo,$d,Co,Ed,Cn,qd,zd,Fd,It,Po,Cd,Fs,Pd,ma,ft,Dt,Cs,jo,jd,Ps,Md,ua,we,Mo,Ad,Ao,Id,Pn,Dd,Nd,Ld,Io,Od,Do,Gd,Wd,Vd,Te,No,Ud,_t,Rd,jn,Hd,Bd,js,Jd,Kd,Yd,Nt,Xd,Ms,Qd,Zd,Lo,fa,gt,Lt,As,Oo,ec,Is,tc,_a,Se,Go,oc,Wo,nc,Mn,sc,ac,rc,Vo,ic,Uo,dc,cc,lc,ve,Ro,hc,Tt,pc,An,mc,uc,Ds,fc,_c,gc,Ot,Tc,Ns,vc,xc,Ho,ga,vt,Gt,Ls,Bo,kc,Os,bc,Ta,me,Jo,yc,Ko,wc,In,Sc,$c,Ec,Yo,qc,Xo,zc,Fc,Cc,Wt,Pc,xe,Qo,jc,xt,Mc,Dn,Ac,Ic,Gs,Dc,Nc,Lc,Vt,Oc,Ws,Gc,Wc,Zo,va,kt,Ut,Vs,en,Vc,Us,Uc,xa,ue,tn,Rc,on,Hc,Nn,Bc,Jc,Kc,nn,Yc,sn,Xc,Qc,Zc,Rt,el,ke,an,tl,bt,ol,Ln,nl,sl,Rs,al,rl,il,Ht,dl,Hs,cl,ll,rn,ka;return _=new We({}),ee=new We({}),X=new We({}),Qt=new ln({props:{code:`import torch
...
special tokens using the tokenizer `),_s=a("code"),fi=n("prepare_for_model"),_i=n(" method."),gi=c(),Re=a("div"),T(mo.$$.fragment),Ti=c(),xn=a("p"),vi=n("Create the token type IDs corresponding to the sequences passed. "),kn=a("a"),xi=n(`What are token type
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),lc=c(),ve=a("div"),T(Ro.$$.fragment),hc=c(),Tt=a("p"),pc=n("The "),An=a("a"),mc=n("Speech2TextForConditionalGeneration"),uc=n(" forward method, overrides the "),Ds=a("code"),fc=n("__call__"),_c=n(" special method."),gc=c(),T(Ot.$$.fragment),Tc=c(),Ns=a("p"),vc=n("Example:"),xc=c(),T(Ho.$$.fragment),ga=c(),vt=a("h2"),Gt=a("a"),Ls=a("span"),T(Bo.$$.fragment),kc=c(),Os=a("span"),bc=n("TFSpeech2TextModel"),Ta=c(),me=a("div"),T(Jo.$$.fragment),yc=c(),Ko=a("p"),wc=n(`The bare Speech2Text Model outputting raw hidden-states without any specific head on top.
...
IDs?`),ih.forEach(t),hl.forEach(t),ki=l(Vn),gs=r(Vn,"P",{});var dh=i(gs);bi=s(dh,"Should be overridden in a subclass if the model has a special way of building those."),dh.forEach(t),Vn.forEach(t),yi=l(be),bn=r(be,"DIV",{class:!0});var ch=i(bn);v(uo.$$.fragment,ch),ch.forEach(t),be.forEach(t),ca=l(o),mt=r(o,"H2",{class:!0});var Pa=i(mt);qt=r(Pa,"A",{id:!0,class:!0,href:!0});var lh=i(qt);Ts=r(lh,"SPAN",{});var hh=i(Ts);v(fo.$$.fragment,hh),hh.forEach(t),lh.forEach(t),wi=l(Pa),vs=r(Pa,"SPAN",{});var ph=i(vs);Si=s(ph,"Speech2TextFeatureExtractor"),ph.forEach(t),Pa.forEach(t),la=l(o),pe=r(o,"DIV",{class:!0});var Xe=i(pe);v(_o.$$.fragment,Xe),$i=l(Xe),xs=r(Xe,"P",{});var mh=i(xs);Ei=s(mh,"Constructs a Speech2Text feature extractor."),mh.forEach(t),qi=l(Xe),go=r(Xe,"P",{});var ja=i(go);zi=s(ja,"This feature extractor inherits from "),yn=r(ja,"A",{href:!0});var uh=i(yn);Fi=s(uh,"Speech2TextFeatureExtractor"),uh.forEach(t),Ci=s(ja,` which contains most of the main methods. Users
should refer to this superclass for more information regarding those methods.`),ja.forEach(t),Pi=l(Xe),ks=r(Xe,"P",{});var fh=i(ks);ji=s(fh,`This class extracts mel-filter bank features from raw speech using TorchAudio and applies utterance-level cepstral
mean and variance normalization to the extracted features.`),fh.forEach(t),Mi=l(Xe),zt=r(Xe,"DIV",{class:!0});var Ma=i(zt);v(To.$$.fragment,Ma),Ai=l(Ma),bs=r(Ma,"P",{});var _h=i(bs);Ii=s(_h,"Main method to featurize and prepare for the model one or several sequence(s). sequences."),_h.forEach(t),Ma.forEach(t),Xe.forEach(t),ha=l(o),ut=r(o,"H2",{class:!0});var Aa=i(ut);Ft=r(Aa,"A",{id:!0,class:!0,href:!0});var gh=i(Ft);ys=r(gh,"SPAN",{});var Th=i(ys);v(vo.$$.fragment,Th),Th.forEach(t),gh.forEach(t),Di=l(Aa),ws=r(Aa,"SPAN",{});var vh=i(ws);Ni=s(vh,"Speech2TextProcessor"),vh.forEach(t),Aa.forEach(t),pa=l(o),I=r(o,"DIV",{class:!0});var R=i(I);v(xo.$$.fragment,R),Li=l(R),Ss=r(R,"P",{});var xh=i(Ss);Oi=s(xh,`Constructs a Speech2Text processor which wraps a Speech2Text feature extractor and a Speech2Text tokenizer into a
...
can be reloaded using the `),zn=r(Da,"A",{href:!0});var Fh=i(zn);gd=s(Fh,"from_pretrained()"),Fh.forEach(t),Td=s(Da," method."),Da.forEach(t),vd=l(Rn),v(jt.$$.fragment,Rn),Rn.forEach(t),xd=l(R),Mt=r(R,"DIV",{class:!0});var Na=i(Mt);v(qo.$$.fragment,Na),kd=l(Na),zo=r(Na,"P",{});var La=i(zo);bd=s(La,"This method forwards all its arguments to Speech2TextTokenizer\u2019s "),Fn=r(La,"A",{href:!0});var Ch=i(Fn);yd=s(Ch,"batch_decode()"),Ch.forEach(t),wd=s(La,`. Please
