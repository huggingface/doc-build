import{S as j_,i as x_,s as L_,e as n,k as l,w as M,t as r,M as A_,c as s,d as t,m as d,a,x as b,h as i,b as h,F as e,g as m,y as w,q as P,o as N,B as $}from"../../chunks/vendor-4833417e.js";import{T as Ne}from"../../chunks/Tip-fffd6df1.js";import{D as J}from"../../chunks/Docstring-4f315ed9.js";import{C as Ye}from"../../chunks/CodeBlock-6a3d1b46.js";import{I as je}from"../../chunks/IconCopyLink-4b81c553.js";import"../../chunks/CopyButton-dacfbfaf.js";function I_(Q){let p,y,f,g,v;return{c(){p=n("p"),y=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=n("code"),g=r("Module"),v=r(`
...
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),_.forEach(t)},m(k,_){m(k,p,_),e(p,y),e(p,f),e(f,g),e(p,v)},d(k){k&&t(p)}}}function D_(Q){let p,y,f,g,v;return{c(){p=n("p"),y=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=n("code"),g=r("Module"),v=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(k){p=s(k,"P",{});var _=a(p);y=i(_,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=s(_,"CODE",{});var F=a(f);g=i(F,"Module"),F.forEach(t),v=i(_,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),_.forEach(t)},m(k,_){m(k,p,_),e(p,y),e(p,f),e(f,g),e(p,v)},d(k){k&&t(p)}}}function S_(Q){let p,y,f,g,v;return{c(){p=n("p"),y=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=n("code"),g=r("Module"),v=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(k){p=s(k,"P",{});var _=a(p);y=i(_,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=s(_,"CODE",{});var F=a(f);g=i(F,"Module"),F.forEach(t),v=i(_,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),_.forEach(t)},m(k,_){m(k,p,_),e(p,y),e(p,f),e(f,g),e(p,v)},d(k){k&&t(p)}}}function O_(Q){let p,y,f,g,v;return{c(){p=n("p"),y=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=n("code"),g=r("Module"),v=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(k){p=s(k,"P",{});var _=a(p);y=i(_,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=s(_,"CODE",{});var F=a(f);g=i(F,"Module"),F.forEach(t),v=i(_,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),_.forEach(t)},m(k,_){m(k,p,_),e(p,y),e(p,f),e(f,g),e(p,v)},d(k){k&&t(p)}}}function W_(Q){let p,y,f,g,v;return{c(){p=n("p"),y=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=n("code"),g=r("Module"),v=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(k){p=s(k,"P",{});var _=a(p);y=i(_,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=s(_,"CODE",{});var F=a(f);g=i(F,"Module"),F.forEach(t),v=i(_,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),_.forEach(t)},m(k,_){m(k,p,_),e(p,y),e(p,f),e(f,g),e(p,v)},d(k){k&&t(p)}}}function Q_(Q){let p,y,f,g,v;return{c(){p=n("p"),y=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=n("code"),g=r("Module"),v=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(k){p=s(k,"P",{});var _=a(p);y=i(_,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=s(_,"CODE",{});var F=a(f);g=i(F,"Module"),F.forEach(t),v=i(_,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),_.forEach(t)},m(k,_){m(k,p,_),e(p,y),e(p,f),e(f,g),e(p,v)},d(k){k&&t(p)}}}function B_(Q){let p,y,f,g,v,k,_,F,le,U,z,X,S,G,de,O,ce,se,R,A,Y,V,E,q,Z,B,ae,ee,H,re,te,C,pe,W,oe,he,x,ne,j,me;return{c(){p=n("p"),y=r("TF 2.0 models accepts two formats as inputs:"),f=l(),g=n("ul"),v=n("li"),k=r("having all inputs as keyword arguments (like PyTorch models), or"),_=l(),F=n("li"),le=r("having all inputs as a list, tuple or dict in the first positional arguments."),U=l(),z=n("p"),X=r("This second option is useful when using "),S=n("code"),G=r("tf.keras.Model.fit"),de=r(` method which currently requires having all the
...
first positional argument :`),V=l(),E=n("ul"),q=n("li"),Z=r("a single Tensor with "),B=n("code"),ae=r("input_ids"),ee=r(" only and nothing else: "),H=n("code"),re=r("model(inputs_ids)"),te=l(),C=n("li"),pe=r(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
...
first positional argument :`),Me.forEach(t),V=d(c),E=s(c,"UL",{});var L=a(E);q=s(L,"LI",{});var D=a(q);Z=i(D,"a single Tensor with "),B=s(D,"CODE",{});var be=a(B);ae=i(be,"input_ids"),be.forEach(t),ee=i(D," only and nothing else: "),H=s(D,"CODE",{});var ge=a(H);re=i(ge,"model(inputs_ids)"),ge.forEach(t),D.forEach(t),te=d(L),C=s(L,"LI",{});var ue=a(C);pe=i(ue,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),W=s(ue,"CODE",{});var we=a(W);oe=i(we,"model([input_ids, attention_mask])"),we.forEach(t),ue.forEach(t),he=d(L),x=s(L,"LI",{});var ie=a(x);ne=i(ie,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),j=s(ie,"CODE",{});var fe=a(j);me=i(fe,'model({"input_ids": input_ids, "attention_mask": attention_mask})'),fe.forEach(t),ie.forEach(t),L.forEach(t)},m(c,T){m(c,p,T),e(p,y),m(c,f,T),m(c,g,T),e(g,v),e(v,k),e(g,_),e(g,F),e(F,le),m(c,U,T),m(c,z,T),e(z,X),e(z,S),e(S,G),e(z,de),e(z,O),e(O,ce),e(z,se),m(c,R,T),m(c,A,T),e(A,Y),m(c,V,T),m(c,E,T),e(E,q),e(q,Z),e(q,B),e(B,ae),e(q,ee),e(q,H),e(H,re),e(E,te),e(E,C),e(C,pe),e(C,W),e(W,oe),e(E,he),e(E,x),e(x,ne),e(x,j),e(j,me)},d(c){c&&t(p),c&&t(f),c&&t(g),c&&t(U),c&&t(z),c&&t(R),c&&t(A),c&&t(V),c&&t(E)}}}function U_(Q){let p,y,f,g,v;return{c(){p=n("p"),y=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=n("code"),g=r("Module"),v=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(k){p=s(k,"P",{});var _=a(p);y=i(_,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=s(_,"CODE",{});var F=a(f);g=i(F,"Module"),F.forEach(t),v=i(_,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),_.forEach(t)},m(k,_){m(k,p,_),e(p,y),e(p,f),e(f,g),e(p,v)},d(k){k&&t(p)}}}function V_(Q){let p,y,f,g,v,k,_,F,le,U,z,X,S,G,de,O,ce,se,R,A,Y,V,E,q,Z,B,ae,ee,H,re,te,C,pe,W,oe,he,x,ne,j,me;return{c(){p=n("p"),y=r("TF 2.0 models accepts two formats as inputs:"),f=l(),g=n("ul"),v=n("li"),k=r("having all inputs as keyword arguments (like PyTorch models), or"),_=l(),F=n("li"),le=r("having all inputs as a list, tuple or dict in the first positional arguments."),U=l(),z=n("p"),X=r("This second option is useful when using "),S=n("code"),G=r("tf.keras.Model.fit"),de=r(` method which currently requires having all the
tensors in the first argument of the model call function: `),O=n("code"),ce=r("model(inputs)"),se=r("."),R=l(),A=n("p"),Y=r(`If you choose this second option, there are three possibilities you can use to gather all the input Tensor in the
first positional argument :`),V=l(),E=n("ul"),q=n("li"),Z=r("a single Tensor with "),B=n("code"),ae=r("input_ids"),ee=r(" only and nothing else: "),H=n("code"),re=r("model(inputs_ids)"),te=l(),C=n("li"),pe=r(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),W=n("code"),oe=r("model([input_ids, attention_mask])"),he=l(),x=n("li"),ne=r(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),j=n("code"),me=r('model({"input_ids": input_ids, "attention_mask": attention_mask})')},l(c){p=s(c,"P",{});var T=a(p);y=i(T,"TF 2.0 models accepts two formats as inputs:"),T.forEach(t),f=d(c),g=s(c,"UL",{});var K=a(g);v=s(K,"LI",{});var _e=a(v);k=i(_e,"having all inputs as keyword arguments (like PyTorch models), or"),_e.forEach(t),_=d(K),F=s(K,"LI",{});var ve=a(F);le=i(ve,"having all inputs as a list, tuple or dict in the first positional arguments."),ve.forEach(t),K.forEach(t),U=d(c),z=s(c,"P",{});var I=a(z);X=i(I,"This second option is useful when using "),S=s(I,"CODE",{});var ke=a(S);G=i(ke,"tf.keras.Model.fit"),ke.forEach(t),de=i(I,` method which currently requires having all the
...
first positional argument :`),Me.forEach(t),V=d(c),E=s(c,"UL",{});var L=a(E);q=s(L,"LI",{});var D=a(q);Z=i(D,"a single Tensor with "),B=s(D,"CODE",{});var be=a(B);ae=i(be,"input_ids"),be.forEach(t),ee=i(D," only and nothing else: "),H=s(D,"CODE",{});var ge=a(H);re=i(ge,"model(inputs_ids)"),ge.forEach(t),D.forEach(t),te=d(L),C=s(L,"LI",{});var ue=a(C);pe=i(ue,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),W=s(ue,"CODE",{});var we=a(W);oe=i(we,"model([input_ids, attention_mask])"),we.forEach(t),ue.forEach(t),he=d(L),x=s(L,"LI",{});var ie=a(x);ne=i(ie,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),j=s(ie,"CODE",{});var fe=a(j);me=i(fe,'model({"input_ids": input_ids, "attention_mask": attention_mask})'),fe.forEach(t),ie.forEach(t),L.forEach(t)},m(c,T){m(c,p,T),e(p,y),m(c,f,T),m(c,g,T),e(g,v),e(v,k),e(g,_),e(g,F),e(F,le),m(c,U,T),m(c,z,T),e(z,X),e(z,S),e(S,G),e(z,de),e(z,O),e(O,ce),e(z,se),m(c,R,T),m(c,A,T),e(A,Y),m(c,V,T),m(c,E,T),e(E,q),e(q,Z),e(q,B),e(B,ae),e(q,ee),e(q,H),e(H,re),e(E,te),e(E,C),e(C,pe),e(C,W),e(W,oe),e(E,he),e(E,x),e(x,ne),e(x,j),e(j,me)},d(c){c&&t(p),c&&t(f),c&&t(g),c&&t(U),c&&t(z),c&&t(R),c&&t(A),c&&t(V),c&&t(E)}}}function K_(Q){let p,y,f,g,v;return{c(){p=n("p"),y=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=n("code"),g=r("Module"),v=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(k){p=s(k,"P",{});var _=a(p);y=i(_,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=s(_,"CODE",{});var F=a(f);g=i(F,"Module"),F.forEach(t),v=i(_,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),_.forEach(t)},m(k,_){m(k,p,_),e(p,y),e(p,f),e(f,g),e(p,v)},d(k){k&&t(p)}}}function X_(Q){let p,y,f,g,v,k,_,F,le,U,z,X,S,G,de,O,ce,se,R,A,Y,V,E,q,Z,B,ae,ee,H,re,te,C,pe,W,oe,he,x,ne,j,me;return{c(){p=n("p"),y=r("TF 2.0 models accepts two formats as inputs:"),f=l(),g=n("ul"),v=n("li"),k=r("having all inputs as keyword arguments (like PyTorch models), or"),_=l(),F=n("li"),le=r("having all inputs as a list, tuple or dict in the first positional arguments."),U=l(),z=n("p"),X=r("This second option is useful when using "),S=n("code"),G=r("tf.keras.Model.fit"),de=r(` method which currently requires having all the
tensors in the first argument of the model call function: `),O=n("code"),ce=r("model(inputs)"),se=r("."),R=l(),A=n("p"),Y=r(`If you choose this second option, there are three possibilities you can use to gather all the input Tensor in the
first positional argument :`),V=l(),E=n("ul"),q=n("li"),Z=r("a single Tensor with "),B=n("code"),ae=r("input_ids"),ee=r(" only and nothing else: "),H=n("code"),re=r("model(inputs_ids)"),te=l(),C=n("li"),pe=r(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),W=n("code"),oe=r("model([input_ids, attention_mask])"),he=l(),x=n("li"),ne=r(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),j=n("code"),me=r('model({"input_ids": input_ids, "attention_mask": attention_mask})')},l(c){p=s(c,"P",{});var T=a(p);y=i(T,"TF 2.0 models accepts two formats as inputs:"),T.forEach(t),f=d(c),g=s(c,"UL",{});var K=a(g);v=s(K,"LI",{});var _e=a(v);k=i(_e,"having all inputs as keyword arguments (like PyTorch models), or"),_e.forEach(t),_=d(K),F=s(K,"LI",{});var ve=a(F);le=i(ve,"having all inputs as a list, tuple or dict in the first positional arguments."),ve.forEach(t),K.forEach(t),U=d(c),z=s(c,"P",{});var I=a(z);X=i(I,"This second option is useful when using "),S=s(I,"CODE",{});var ke=a(S);G=i(ke,"tf.keras.Model.fit"),ke.forEach(t),de=i(I,` method which currently requires having all the
...
first positional argument :`),Me.forEach(t),V=d(c),E=s(c,"UL",{});var L=a(E);q=s(L,"LI",{});var D=a(q);Z=i(D,"a single Tensor with "),B=s(D,"CODE",{});var be=a(B);ae=i(be,"input_ids"),be.forEach(t),ee=i(D," only and nothing else: "),H=s(D,"CODE",{});var ge=a(H);re=i(ge,"model(inputs_ids)"),ge.forEach(t),D.forEach(t),te=d(L),C=s(L,"LI",{});var ue=a(C);pe=i(ue,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),W=s(ue,"CODE",{});var we=a(W);oe=i(we,"model([input_ids, attention_mask])"),we.forEach(t),ue.forEach(t),he=d(L),x=s(L,"LI",{});var ie=a(x);ne=i(ie,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),j=s(ie,"CODE",{});var fe=a(j);me=i(fe,'model({"input_ids": input_ids, "attention_mask": attention_mask})'),fe.forEach(t),ie.forEach(t),L.forEach(t)},m(c,T){m(c,p,T),e(p,y),m(c,f,T),m(c,g,T),e(g,v),e(v,k),e(g,_),e(g,F),e(F,le),m(c,U,T),m(c,z,T),e(z,X),e(z,S),e(S,G),e(z,de),e(z,O),e(O,ce),e(z,se),m(c,R,T),m(c,A,T),e(A,Y),m(c,V,T),m(c,E,T),e(E,q),e(q,Z),e(q,B),e(B,ae),e(q,ee),e(q,H),e(H,re),e(E,te),e(E,C),e(C,pe),e(C,W),e(W,oe),e(E,he),e(E,x),e(x,ne),e(x,j),e(j,me)},d(c){c&&t(p),c&&t(f),c&&t(g),c&&t(U),c&&t(z),c&&t(R),c&&t(A),c&&t(V),c&&t(E)}}}function J_(Q){let p,y,f,g,v;return{c(){p=n("p"),y=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=n("code"),g=r("Module"),v=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(k){p=s(k,"P",{});var _=a(p);y=i(_,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=s(_,"CODE",{});var F=a(f);g=i(F,"Module"),F.forEach(t),v=i(_,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),_.forEach(t)},m(k,_){m(k,p,_),e(p,y),e(p,f),e(f,g),e(p,v)},d(k){k&&t(p)}}}function G_(Q){let p,y,f,g,v,k,_,F,le,U,z,X,S,G,de,O,ce,se,R,A,Y,V,E,q,Z,B,ae,ee,H,re,te,C,pe,W,oe,he,x,ne,j,me;return{c(){p=n("p"),y=r("TF 2.0 models accepts two formats as inputs:"),f=l(),g=n("ul"),v=n("li"),k=r("having all inputs as keyword arguments (like PyTorch models), or"),_=l(),F=n("li"),le=r("having all inputs as a list, tuple or dict in the first positional arguments."),U=l(),z=n("p"),X=r("This second option is useful when using "),S=n("code"),G=r("tf.keras.Model.fit"),de=r(` method which currently requires having all the
tensors in the first argument of the model call function: `),O=n("code"),ce=r("model(inputs)"),se=r("."),R=l(),A=n("p"),Y=r(`If you choose this second option, there are three possibilities you can use to gather all the input Tensor in the
first positional argument :`),V=l(),E=n("ul"),q=n("li"),Z=r("a single Tensor with "),B=n("code"),ae=r("input_ids"),ee=r(" only and nothing else: "),H=n("code"),re=r("model(inputs_ids)"),te=l(),C=n("li"),pe=r(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),W=n("code"),oe=r("model([input_ids, attention_mask])"),he=l(),x=n("li"),ne=r(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),j=n("code"),me=r('model({"input_ids": input_ids, "attention_mask": attention_mask})')},l(c){p=s(c,"P",{});var T=a(p);y=i(T,"TF 2.0 models accepts two formats as inputs:"),T.forEach(t),f=d(c),g=s(c,"UL",{});var K=a(g);v=s(K,"LI",{});var _e=a(v);k=i(_e,"having all inputs as keyword arguments (like PyTorch models), or"),_e.forEach(t),_=d(K),F=s(K,"LI",{});var ve=a(F);le=i(ve,"having all inputs as a list, tuple or dict in the first positional arguments."),ve.forEach(t),K.forEach(t),U=d(c),z=s(c,"P",{});var I=a(z);X=i(I,"This second option is useful when using "),S=s(I,"CODE",{});var ke=a(S);G=i(ke,"tf.keras.Model.fit"),ke.forEach(t),de=i(I,` method which currently requires having all the
...
first positional argument :`),Me.forEach(t),V=d(c),E=s(c,"UL",{});var L=a(E);q=s(L,"LI",{});var D=a(q);Z=i(D,"a single Tensor with "),B=s(D,"CODE",{});var be=a(B);ae=i(be,"input_ids"),be.forEach(t),ee=i(D," only and nothing else: "),H=s(D,"CODE",{});var ge=a(H);re=i(ge,"model(inputs_ids)"),ge.forEach(t),D.forEach(t),te=d(L),C=s(L,"LI",{});var ue=a(C);pe=i(ue,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),W=s(ue,"CODE",{});var we=a(W);oe=i(we,"model([input_ids, attention_mask])"),we.forEach(t),ue.forEach(t),he=d(L),x=s(L,"LI",{});var ie=a(x);ne=i(ie,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),j=s(ie,"CODE",{});var fe=a(j);me=i(fe,'model({"input_ids": input_ids, "attention_mask": attention_mask})'),fe.forEach(t),ie.forEach(t),L.forEach(t)},m(c,T){m(c,p,T),e(p,y),m(c,f,T),m(c,g,T),e(g,v),e(v,k),e(g,_),e(g,F),e(F,le),m(c,U,T),m(c,z,T),e(z,X),e(z,S),e(S,G),e(z,de),e(z,O),e(O,ce),e(z,se),m(c,R,T),m(c,A,T),e(A,Y),m(c,V,T),m(c,E,T),e(E,q),e(q,Z),e(q,B),e(B,ae),e(q,ee),e(q,H),e(H,re),e(E,te),e(E,C),e(C,pe),e(C,W),e(W,oe),e(E,he),e(E,x),e(x,ne),e(x,j),e(j,me)},d(c){c&&t(p),c&&t(f),c&&t(g),c&&t(U),c&&t(z),c&&t(R),c&&t(A),c&&t(V),c&&t(E)}}}function Y_(Q){let p,y,f,g,v;return{c(){p=n("p"),y=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=n("code"),g=r("Module"),v=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(k){p=s(k,"P",{});var _=a(p);y=i(_,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=s(_,"CODE",{});var F=a(f);g=i(F,"Module"),F.forEach(t),v=i(_,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),_.forEach(t)},m(k,_){m(k,p,_),e(p,y),e(p,f),e(f,g),e(p,v)},d(k){k&&t(p)}}}function Z_(Q){let p,y,f,g,v,k,_,F,le,U,z,X,S,G,de,O,ce,se,R,A,Y,V,E,q,Z,B,ae,ee,H,re,te,C,pe,W,oe,he,x,ne,j,me;return{c(){p=n("p"),y=r("TF 2.0 models accepts two formats as inputs:"),f=l(),g=n("ul"),v=n("li"),k=r("having all inputs as keyword arguments (like PyTorch models), or"),_=l(),F=n("li"),le=r("having all inputs as a list, tuple or dict in the first positional arguments."),U=l(),z=n("p"),X=r("This second option is useful when using "),S=n("code"),G=r("tf.keras.Model.fit"),de=r(` method which currently requires having all the
tensors in the first argument of the model call function: `),O=n("code"),ce=r("model(inputs)"),se=r("."),R=l(),A=n("p"),Y=r(`If you choose this second option, there are three possibilities you can use to gather all the input Tensor in the
first positional argument :`),V=l(),E=n("ul"),q=n("li"),Z=r("a single Tensor with "),B=n("code"),ae=r("input_ids"),ee=r(" only and nothing else: "),H=n("code"),re=r("model(inputs_ids)"),te=l(),C=n("li"),pe=r(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),W=n("code"),oe=r("model([input_ids, attention_mask])"),he=l(),x=n("li"),ne=r(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),j=n("code"),me=r('model({"input_ids": input_ids, "attention_mask": attention_mask})')},l(c){p=s(c,"P",{});var T=a(p);y=i(T,"TF 2.0 models accepts two formats as inputs:"),T.forEach(t),f=d(c),g=s(c,"UL",{});var K=a(g);v=s(K,"LI",{});var _e=a(v);k=i(_e,"having all inputs as keyword arguments (like PyTorch models), or"),_e.forEach(t),_=d(K),F=s(K,"LI",{});var ve=a(F);le=i(ve,"having all inputs as a list, tuple or dict in the first positional arguments."),ve.forEach(t),K.forEach(t),U=d(c),z=s(c,"P",{});var I=a(z);X=i(I,"This second option is useful when using "),S=s(I,"CODE",{});var ke=a(S);G=i(ke,"tf.keras.Model.fit"),ke.forEach(t),de=i(I,` method which currently requires having all the
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/main/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),$o=new Ne({props:{$$slots:{default:[R_]},$$scope:{ctx:Q}}}),rs=new J({props:{name:"call",anchor:"transformers.TFMPNetForMaskedLM.call",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"},{name:"labels",val:" = None"},{name:"training",val:" = False"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/mpnet/modeling_tf_mpnet.py#L812",parametersDescription:[{anchor:"transformers.TFMPNetForMaskedLM.call.input_ids",description:`<strong>input_ids</strong> (<code>Numpy array</code> or <code>tf.Tensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/main/en/model_doc/mpnet#transformers.MPNetTokenizer">MPNetTokenizer</a>. See <a href="/docs/transformers/main/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
<a href="/docs/transformers/main/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> for details.</p>
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/main/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),zo=new Ne({props:{$$slots:{default:[V_]},$$scope:{ctx:Q}}}),ms=new J({props:{name:"call",anchor:"transformers.TFMPNetForSequenceClassification.call",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"},{name:"labels",val:" = None"},{name:"training",val:" = False"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/mpnet/modeling_tf_mpnet.py#L933",parametersDescription:[{anchor:"transformers.TFMPNetForSequenceClassification.call.input_ids",description:`<strong>input_ids</strong> (<code>Numpy array</code> or <code>tf.Tensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/main/en/model_doc/mpnet#transformers.MPNetTokenizer">MPNetTokenizer</a>. See <a href="/docs/transformers/main/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
<a href="/docs/transformers/main/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> for details.</p>
