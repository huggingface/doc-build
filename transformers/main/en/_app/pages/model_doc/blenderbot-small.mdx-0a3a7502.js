import{S as du,i as iu,s as cu,e as n,k as i,w as y,t as r,M as pu,c as a,d as o,m as c,a as s,x as v,h as l,b as m,F as e,g as _,y as T,q as w,o as $,B as S,v as mu,L as Xe}from"../../chunks/vendor-6b77c823.js";import{T as qn}from"../../chunks/Tip-39098574.js";import{D as C}from"../../chunks/Docstring-1088f2fb.js";import{C as Ye}from"../../chunks/CodeBlock-3a8b25a8.js";import{I as xe}from"../../chunks/IconCopyLink-7a11ce68.js";import{E as Je}from"../../chunks/ExampleCodeBlock-5212b321.js";function hu(z){let p,k,f,h,b;return h=new Ye({props:{code:`from transformers import BlenderbotSmallModel, BlenderbotSmallConfig
...
tensors in the first argument of the model call function: `),R=a(O,"CODE",{});var ye=s(R);Le=l(ye,"model(inputs)"),ye.forEach(o),Ne=l(O,"."),O.forEach(o),V=c(x),Q=a(x,"P",{});var oo=s(Q);Ie=l(oo,`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
...
<span class="hljs-meta">&gt;&gt;&gt; </span>outputs = model.decode(decoder_input_ids, encoder_outputs)
<span class="hljs-meta">&gt;&gt;&gt; </span>logits = outputs.logits`}}),{c(){p=n("p"),k=r("Example:"),f=i(),y(h.$$.fragment)},l(d){p=a(d,"P",{});var u=s(p);k=l(u,"Example:"),u.forEach(o),f=c(d),v(h.$$.fragment,d)},m(d,u){_(d,p,u),e(p,k),_(d,f,u),T(h,d,u),b=!0},p:Xe,i(d){b||(w(h.$$.fragment,d),b=!0)},o(d){$(h.$$.fragment,d),b=!1},d(d){d&&o(p),d&&o(f),S(h,d)}}}function qu(z){let p,k,f,h,b,d,u,F,Ce,he,B,je,W,Oe,Pe,R,Le,Ne,V,Q,Ie,Z,j,L,ue,ae,Be,J,D,be,se,N,ke,re,ze,ee,le,de,Ae,X,Fe,H,De,x,q,ie,Ze,Re,O,eo,ye,oo,Y,G,to,no,oe,ce,fe,ve,Te,ml,ra,hl,cr,we,ht,ul,ao,fl,En,_l,gl,ut,bl,kl,yl,so,vl,Mn,Tl,wl,Cn,$l,Sl,xl,wo,pr,ro,$o,la,ft,Bl,da,zl,mr,U,_t,Fl,ia,ql,El,gt,Ml,jn,Cl,jl,Ol,He,bt,Pl,ca,Ll,Nl,pa,Il,Al,So,kt,Dl,lo,Gl,ma,Ul,Wl,ha,Rl,Hl,Kl,Ke,yt,Vl,On,Ql,Pn,Jl,Xl,ua,Yl,Zl,Ln,vt,hr,io,xo,fa,Tt,ed,_a,od,ur,Ge,wt,td,$t,nd,ga,ad,sd,rd,Bo,St,ld,ba,dd,fr,co,zo,ka,xt,id,ya,cd,_r,$e,Bt,pd,zt,md,Nn,hd,ud,fd,Ft,_d,qt,gd,bd,kd,qe,Et,yd,po,vd,In,Td,wd,va,$d,Sd,xd,Fo,Bd,qo,gr,mo,Eo,Ta,Mt,zd,wa,Fd,br,Se,Ct,qd,jt,Ed,An,Md,Cd,jd,Ot,Od,Pt,Pd,Ld,Nd,Ee,Lt,Id,ho,Ad,Dn,Dd,Gd,$a,Ud,Wd,Rd,Mo,Hd,Co,kr,uo,jo,Sa,Nt,Kd,xa,Vd,yr,fo,It,Qd,Oo,At,Jd,Po,vr,_o,Lo,Ba,Dt,Xd,za,Yd,Tr,pe,Gt,Zd,Ut,ei,Gn,oi,ti,ni,Wt,ai,Rt,si,ri,li,No,di,Me,Ht,ii,go,ci,Un,pi,mi,Fa,hi,ui,fi,Io,_i,Ao,wr,bo,Do,qa,Kt,gi,Ea,bi,$r,me,Vt,ki,Qt,yi,Wn,vi,Ti,wi,Jt,$i,Xt,Si,xi,Bi,Go,zi,P,Yt,Fi,ko,qi,Rn,Ei,Mi,Ma,Ci,ji,Oi,Uo,Pi,Ca,Li,Ni,ja,Oa,Pa,La,Ii,Ai,Na,Ia,Aa,Da,Di,Gi,Ga,Ua,Wa,Ra,Ui,Wi,Ha,Ka,Va,Zt,Ri,Qa,Hi,Ki,Vi,Ja,Xa,Ya,Za,Qi,Sr,yo,Wo,es,en,Ji,os,Xi,xr,I,on,Yi,tn,Zi,Hn,ec,oc,tc,nn,nc,an,ac,sc,rc,ts,lc,dc,Ue,ns,sn,ic,cc,as,rn,pc,mc,ss,ln,hc,uc,rs,dn,fc,_c,Ro,cn,gc,Ho,bc,Ko,pn,kc,Vo,yc,Qo,mn,vc,Jo,Br,vo,Xo,ls,hn,Tc,ds,wc,zr,A,un,$c,fn,Sc,Kn,xc,Bc,zc,_n,Fc,gn,qc,Ec,Mc,is,Cc,jc,We,cs,bn,Oc,Pc,ps,kn,Lc,Nc,ms,yn,Ic,Ac,hs,vn,Dc,Gc,E,Tn,Uc,To,Wc,us,Rc,Hc,fs,Kc,Vc,Qc,Yo,Jc,_s,Xc,Yc,gs,bs,ks,ys,Zc,ep,vs,Ts,ws,$s,op,tp,Ss,xs,Bs,zs,np,ap,Fs,qs,wn,Zo,et,Es,$n,sp,Ms,rp,lp,Cs,dp,ip,js,cp,pp,Os,Ps,Ls,Ns,mp,hp,Is,As,Ds,Gs,up,fp,Us,Ws,Rs,Hs,_p,gp,Ks,Vs,Qs,Js,bp,kp,ot,Sn,yp,tt,vp,nt,xn,Tp,at,Fr;return d=new xe({}),se=new xe({}),Te=new xe({}),ht=new C({props:{name:"class transformers.BlenderbotSmallConfig",anchor:"transformers.BlenderbotSmallConfig",parameters:[{name:"vocab_size",val:" = 50265"},{name:"max_position_embeddings",val:" = 512"},{name:"encoder_layers",val:" = 8"},{name:"encoder_ffn_dim",val:" = 2048"},{name:"encoder_attention_heads",val:" = 16"},{name:"decoder_layers",val:" = 8"},{name:"decoder_ffn_dim",val:" = 2048"},{name:"decoder_attention_heads",val:" = 16"},{name:"encoder_layerdrop",val:" = 0.0"},{name:"decoder_layerdrop",val:" = 0.0"},{name:"use_cache",val:" = True"},{name:"is_encoder_decoder",val:" = True"},{name:"activation_function",val:" = 'gelu'"},{name:"d_model",val:" = 512"},{name:"dropout",val:" = 0.1"},{name:"attention_dropout",val:" = 0.0"},{name:"activation_dropout",val:" = 0.0"},{name:"init_std",val:" = 0.02"},{name:"decoder_start_token_id",val:" = 1"},{name:"classifier_dropout",val:" = 0.0"},{name:"scale_embedding",val:" = False"},{name:"pad_token_id",val:" = 0"},{name:"bos_token_id",val:" = 1"},{name:"eos_token_id",val:" = 2"},{name:"forced_eos_token_id",val:" = 2"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.BlenderbotSmallConfig.vocab_size",description:`<strong>vocab_size</strong> (<code>int</code>, <em>optional</em>, defaults to 50265) &#x2014;
...
`}}),at=new Je({props:{anchor:"transformers.FlaxBlenderbotSmallForConditionalGeneration.decode.example",$$slots:{default:[Fu]},$$scope:{ctx:z}}}),{c(){p=n("meta"),k=i(),f=n("h1"),h=n("a"),b=n("span"),y(d.$$.fragment),u=i(),F=n("span"),Ce=r("Blenderbot Small"),he=i(),B=n("p"),je=r("Note that "),W=n("a"),Oe=r("BlenderbotSmallModel"),Pe=r(` and
...
`),ue=n("a"),ae=r("BlenderbotForConditionalGeneration"),Be=i(),J=n("h2"),D=n("a"),be=n("span"),y(se.$$.fragment),N=i(),ke=n("span"),re=r("Overview"),ze=i(),ee=n("p"),le=r("The Blender chatbot model was proposed in "),de=n("a"),Ae=r("Recipes for building an open-domain chatbot"),X=r(` Stephen Roller, Emily Dinan, Naman Goyal, Da Ju, Mary Williamson, Yinhan Liu,
...
found `),G=n("a"),to=r("here"),no=r(" ."),oe=i(),ce=n("h2"),fe=n("a"),ve=n("span"),y(Te.$$.fragment),ml=i(),ra=n("span"),hl=r("BlenderbotSmallConfig"),cr=i(),we=n("div"),y(ht.$$.fragment),ul=i(),ao=n("p"),fl=r("This is the configuration class to store the configuration of a "),En=n("a"),_l=r("BlenderbotSmallModel"),gl=r(`. It is used to instantiate
an BlenderbotSmall model according to the specified arguments, defining the model architecture. Instantiating a
configuration with the defaults will yield a similar configuration to that of the BlenderbotSmall
`),ut=n("a"),bl=r("facebook/blenderbot_small-90M"),kl=r(" architecture."),yl=i(),so=n("p"),vl=r("Configuration objects inherit from "),Mn=n("a"),Tl=r("PretrainedConfig"),wl=r(` and can be used to control the model outputs. Read the
documentation from `),Cn=n("a"),$l=r("PretrainedConfig"),Sl=r(" for more information."),xl=i(),y(wo.$$.fragment),pr=i(),ro=n("h2"),$o=n("a"),la=n("span"),y(ft.$$.fragment),Bl=i(),da=n("span"),zl=r("BlenderbotSmallTokenizer"),mr=i(),U=n("div"),y(_t.$$.fragment),Fl=i(),ia=n("p"),ql=r("Constructs a Blenderbot-90M tokenizer based on BPE (Byte-Pair-Encoding)"),El=i(),gt=n("p"),Ml=r("This tokenizer inherits from "),jn=n("a"),Cl=r("PreTrainedTokenizer"),jl=r(` which contains most of the main methods. Users should refer to
...
adding special tokens.`),Nl=i(),pa=n("p"),Il=r("This implementation does not add special tokens and this method should be overridden in a subclass."),Al=i(),So=n("div"),y(kt.$$.fragment),Dl=i(),lo=n("p"),Gl=r(`Retrieves sequence ids from a token list that has no special tokens added. This method is called when adding
special tokens using the tokenizer `),ma=n("code"),Ul=r("prepare_for_model"),Wl=r(" or "),ha=n("code"),Rl=r("encode_plus"),Hl=r(" methods."),Kl=i(),Ke=n("div"),y(yt.$$.fragment),Vl=i(),On=n("p"),Ql=r("Create the token type IDs corresponding to the sequences passed. "),Pn=n("a"),Jl=r(`What are token type
IDs?`),Xl=i(),ua=n("p"),Yl=r("Should be overridden in a subclass if the model has a special way of building those."),Zl=i(),Ln=n("div"),y(vt.$$.fragment),hr=i(),io=n("h2"),xo=n("a"),fa=n("span"),y(Tt.$$.fragment),ed=i(),_a=n("span"),od=r("BlenderbotSmallTokenizerFast"),ur=i(),Ge=n("div"),y(wt.$$.fragment),td=i(),$t=n("p"),nd=r("Construct a \u201Cfast\u201D BlenderbotSmall tokenizer (backed by HuggingFace\u2019s "),ga=n("em"),ad=r("tokenizers"),sd=r(" library)."),rd=i(),Bo=n("div"),y(St.$$.fragment),ld=i(),ba=n("p"),dd=r(`Create a mask from the two sequences passed to be used in a sequence-pair classification task. BlenderbotSmall
does not make use of token type ids, therefore a list of zeros is returned.`),fr=i(),co=n("h2"),zo=n("a"),ka=n("span"),y(xt.$$.fragment),id=i(),ya=n("span"),cd=r("BlenderbotSmallModel"),_r=i(),$e=n("div"),y(Bt.$$.fragment),pd=i(),zt=n("p"),md=r(`The bare BlenderbotSmall Model outputting raw hidden-states without any specific head on top.
...
and behavior.`),kd=i(),qe=n("div"),y(Et.$$.fragment),yd=i(),po=n("p"),vd=r("The "),In=n("a"),Td=r("BlenderbotSmallModel"),wd=r(" forward method, overrides the "),va=n("code"),$d=r("__call__"),Sd=r(" special method."),xd=i(),y(Fo.$$.fragment),Bd=i(),y(qo.$$.fragment),gr=i(),mo=n("h2"),Eo=n("a"),Ta=n("span"),y(Mt.$$.fragment),zd=i(),wa=n("span"),Fd=r("BlenderbotSmallForConditionalGeneration"),br=i(),Se=n("div"),y(Ct.$$.fragment),qd=i(),jt=n("p"),Ed=r(`The BlenderbotSmall Model with a language modeling head. Can be used for summarization.
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Nd=i(),Ee=n("div"),y(Lt.$$.fragment),Id=i(),ho=n("p"),Ad=r("The "),Dn=n("a"),Dd=r("BlenderbotSmallForConditionalGeneration"),Gd=r(" forward method, overrides the "),$a=n("code"),Ud=r("__call__"),Wd=r(" special method."),Rd=i(),y(Mo.$$.fragment),Hd=i(),y(Co.$$.fragment),kr=i(),uo=n("h2"),jo=n("a"),Sa=n("span"),y(Nt.$$.fragment),Kd=i(),xa=n("span"),Vd=r("BlenderbotSmallForCausalLM"),yr=i(),fo=n("div"),y(It.$$.fragment),Qd=i(),Oo=n("div"),y(At.$$.fragment),Jd=i(),y(Po.$$.fragment),vr=i(),_o=n("h2"),Lo=n("a"),Ba=n("span"),y(Dt.$$.fragment),Xd=i(),za=n("span"),Yd=r("TFBlenderbotSmallModel"),Tr=i(),pe=n("div"),y(Gt.$$.fragment),Zd=i(),Ut=n("p"),ei=r(`The bare BLENDERBOT_SMALL Model outputting raw hidden-states without any specific head on top.
...
skip_special_tokens=True)[0])`),Sr=i(),yo=n("h2"),Wo=n("a"),es=n("span"),y(en.$$.fragment),Ji=i(),os=n("span"),Xi=r("FlaxBlenderbotSmallModel"),xr=i(),I=n("div"),y(on.$$.fragment),Yi=i(),tn=n("p"),Zi=r(`The bare BlenderbotSmall Model transformer outputting raw hidden-states without any specific head on top.
...
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),rc=i(),ts=n("p"),lc=r("Finally, this model supports inherent JAX features such as:"),dc=i(),Ue=n("ul"),ns=n("li"),sn=n("a"),ic=r("Just-In-Time (JIT) compilation"),cc=i(),as=n("li"),rn=n("a"),pc=r("Automatic Differentiation"),mc=i(),ss=n("li"),ln=n("a"),hc=r("Vectorization"),uc=i(),rs=n("li"),dn=n("a"),fc=r("Parallelization"),_c=i(),Ro=n("div"),y(cn.$$.fragment),gc=i(),y(Ho.$$.fragment),bc=i(),Ko=n("div"),y(pn.$$.fragment),kc=i(),y(Vo.$$.fragment),yc=i(),Qo=n("div"),y(mn.$$.fragment),vc=i(),y(Jo.$$.fragment),Br=i(),vo=n("h2"),Xo=n("a"),ls=n("span"),y(hn.$$.fragment),Tc=i(),ds=n("span"),wc=r("FlaxBlenderbotForConditionalGeneration"),zr=i(),A=n("div"),y(un.$$.fragment),$c=i(),fn=n("p"),Sc=r(`The BLENDERBOT_SMALL Model with a language modeling head. Can be used for summarization.
...
tokenizer([ARTICLE_TO_SUMMARIZE], max_length=1024, return_tensors=\u2018np\u2019)`),ap=i(),Fs=n("blockquote"),qs=n("blockquote"),wn=n("blockquote"),Zo=n("h1"),et=n("a"),Es=n("span"),y($n.$$.fragment),sp=i(),Ms=n("span"),rp=r("Generate Summary >>> summary_ids = model.generate(inputs[\u2018input_ids\u2019]).sequences >>>"),lp=i(),Cs=n("p"),dp=r("print(tokenizer.batch_decode(summary_ids, skip_special_tokens=True, clean_up_tokenization_spaces=False))"),ip=i(),js=n("p"),cp=r("Mask filling example:"),pp=i(),Os=n("blockquote"),Ps=n("blockquote"),Ls=n("blockquote"),Ns=n("p"),mp=r(`from transformers import BlenderbotSmallTokenizer, FlaxBlenderbotSmallForConditionalGeneration >>>
...
jax.nn.softmax(logits[0, masked_index], axis=0) >>> values, predictions = jax.lax.top_k(probs)`),gp=i(),Ks=n("blockquote"),Vs=n("blockquote"),Qs=n("blockquote"),Js=n("p"),bp=r("tokenizer.decode(predictions).split()"),kp=i(),ot=n("div"),y(Sn.$$.fragment),yp=i(),y(tt.$$.fragment),vp=i(),nt=n("div"),y(xn.$$.fragment),Tp=i(),y(at.$$.fragment),this.h()},l(t){const g=pu('[data-svelte="svelte-1phssyn"]',document.head);p=a(g,"META",{name:!0,content:!0}),g.forEach(o),k=c(t),f=a(t,"H1",{class:!0});var Bn=s(f);h=a(Bn,"A",{id:!0,class:!0,href:!0});var Xs=s(h);b=a(Xs,"SPAN",{});var Ys=s(b);v(d.$$.fragment,Ys),Ys.forEach(o),Xs.forEach(o),u=c(Bn),F=a(Bn,"SPAN",{});var Zs=s(F);Ce=l(Zs,"Blenderbot Small"),Zs.forEach(o),Bn.forEach(o),he=c(t),B=a(t,"P",{});var _e=s(B);je=l(_e,"Note that "),W=a(_e,"A",{href:!0});var er=s(W);Oe=l(er,"BlenderbotSmallModel"),er.forEach(o),Pe=l(_e,` and
...
adding special tokens.`),Ap.forEach(o),Nl=c(Xn),pa=a(Xn,"P",{});var Dp=s(pa);Il=l(Dp,"This implementation does not add special tokens and this method should be overridden in a subclass."),Dp.forEach(o),Xn.forEach(o),Al=c(ge),So=a(ge,"DIV",{class:!0});var Cr=s(So);v(kt.$$.fragment,Cr),Dl=c(Cr),lo=a(Cr,"P",{});var Yn=s(lo);Gl=l(Yn,`Retrieves sequence ids from a token list that has no special tokens added. This method is called when adding
special tokens using the tokenizer `),ma=a(Yn,"CODE",{});var Gp=s(ma);Ul=l(Gp,"prepare_for_model"),Gp.forEach(o),Wl=l(Yn," or "),ha=a(Yn,"CODE",{});var Up=s(ha);Rl=l(Up,"encode_plus"),Up.forEach(o),Hl=l(Yn," methods."),Yn.forEach(o),Cr.forEach(o),Kl=c(ge),Ke=a(ge,"DIV",{class:!0});var Zn=s(Ke);v(yt.$$.fragment,Zn),Vl=c(Zn),On=a(Zn,"P",{});var wp=s(On);Ql=l(wp,"Create the token type IDs corresponding to the sequences passed. "),Pn=a(wp,"A",{href:!0});var Wp=s(Pn);Jl=l(Wp,`What are token type
IDs?`),Wp.forEach(o),wp.forEach(o),Xl=c(Zn),ua=a(Zn,"P",{});var Rp=s(ua);Yl=l(Rp,"Should be overridden in a subclass if the model has a special way of building those."),Rp.forEach(o),Zn.forEach(o),Zl=c(ge),Ln=a(ge,"DIV",{class:!0});var Hp=s(Ln);v(vt.$$.fragment,Hp),Hp.forEach(o),ge.forEach(o),hr=c(t),io=a(t,"H2",{class:!0});var jr=s(io);xo=a(jr,"A",{id:!0,class:!0,href:!0});var Kp=s(xo);fa=a(Kp,"SPAN",{});var Vp=s(fa);v(Tt.$$.fragment,Vp),Vp.forEach(o),Kp.forEach(o),ed=c(jr),_a=a(jr,"SPAN",{});var Qp=s(_a);od=l(Qp,"BlenderbotSmallTokenizerFast"),Qp.forEach(o),jr.forEach(o),ur=c(t),Ge=a(t,"DIV",{class:!0});var ea=s(Ge);v(wt.$$.fragment,ea),td=c(ea),$t=a(ea,"P",{});var Or=s($t);nd=l(Or,"Construct a \u201Cfast\u201D BlenderbotSmall tokenizer (backed by HuggingFace\u2019s "),ga=a(Or,"EM",{});var Jp=s(ga);ad=l(Jp,"tokenizers"),Jp.forEach(o),sd=l(Or," library)."),Or.forEach(o),rd=c(ea),Bo=a(ea,"DIV",{class:!0});var Pr=s(Bo);v(St.$$.fragment,Pr),ld=c(Pr),ba=a(Pr,"P",{});var Xp=s(ba);dd=l(Xp,`Create a mask from the two sequences passed to be used in a sequence-pair classification task. BlenderbotSmall
does not make use of token type ids, therefore a list of zeros is returned.`),Xp.forEach(o),Pr.forEach(o),ea.forEach(o),fr=c(t),co=a(t,"H2",{class:!0});var Lr=s(co);zo=a(Lr,"A",{id:!0,class:!0,href:!0});var Yp=s(zo);ka=a(Yp,"SPAN",{});var Zp=s(ka);v(xt.$$.fragment,Zp),Zp.forEach(o),Yp.forEach(o),id=c(Lr),ya=a(Lr,"SPAN",{});var em=s(ya);cd=l(em,"BlenderbotSmallModel"),em.forEach(o),Lr.forEach(o),_r=c(t),$e=a(t,"DIV",{class:!0});var rt=s($e);v(Bt.$$.fragment,rt),pd=c(rt),zt=a(rt,"P",{});var Nr=s(zt);md=l(Nr,`The bare BlenderbotSmall Model outputting raw hidden-states without any specific head on top.
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Ir.forEach(o),kd=c(rt),qe=a(rt,"DIV",{class:!0});var lt=s(qe);v(Et.$$.fragment,lt),yd=c(lt),po=a(lt,"P",{});var oa=s(po);vd=l(oa,"The "),In=a(oa,"A",{href:!0});var nm=s(In);Td=l(nm,"BlenderbotSmallModel"),nm.forEach(o),wd=l(oa," forward method, overrides the "),va=a(oa,"CODE",{});var am=s(va);$d=l(am,"__call__"),am.forEach(o),Sd=l(oa," special method."),oa.forEach(o),xd=c(lt),v(Fo.$$.fragment,lt),Bd=c(lt),v(qo.$$.fragment,lt),lt.forEach(o),rt.forEach(o),gr=c(t),mo=a(t,"H2",{class:!0});var Ar=s(mo);Eo=a(Ar,"A",{id:!0,class:!0,href:!0});var sm=s(Eo);Ta=a(sm,"SPAN",{});var rm=s(Ta);v(Mt.$$.fragment,rm),rm.forEach(o),sm.forEach(o),zd=c(Ar),wa=a(Ar,"SPAN",{});var lm=s(wa);Fd=l(lm,"BlenderbotSmallForConditionalGeneration"),lm.forEach(o),Ar.forEach(o),br=c(t),Se=a(t,"DIV",{class:!0});var dt=s(Se);v(Ct.$$.fragment,dt),qd=c(dt),jt=a(dt,"P",{});var Dr=s(jt);Ed=l(Dr,`The BlenderbotSmall Model with a language modeling head. Can be used for summarization.
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Gr.forEach(o),Nd=c(dt),Ee=a(dt,"DIV",{class:!0});var it=s(Ee);v(Lt.$$.fragment,it),Id=c(it),ho=a(it,"P",{});var ta=s(ho);Ad=l(ta,"The "),Dn=a(ta,"A",{href:!0});var cm=s(Dn);Dd=l(cm,"BlenderbotSmallForConditionalGeneration"),cm.forEach(o),Gd=l(ta," forward method, overrides the "),$a=a(ta,"CODE",{});var pm=s($a);Ud=l(pm,"__call__"),pm.forEach(o),Wd=l(ta," special method."),ta.forEach(o),Rd=c(it),v(Mo.$$.fragment,it),Hd=c(it),v(Co.$$.fragment,it),it.forEach(o),dt.forEach(o),kr=c(t),uo=a(t,"H2",{class:!0});var Ur=s(uo);jo=a(Ur,"A",{id:!0,class:!0,href:!0});var mm=s(jo);Sa=a(mm,"SPAN",{});var hm=s(Sa);v(Nt.$$.fragment,hm),hm.forEach(o),mm.forEach(o),Kd=c(Ur),xa=a(Ur,"SPAN",{});var um=s(xa);Vd=l(um,"BlenderbotSmallForCausalLM"),um.forEach(o),Ur.forEach(o),yr=c(t),fo=a(t,"DIV",{class:!0});var Wr=s(fo);v(It.$$.fragment,Wr),Qd=c(Wr),Oo=a(Wr,"DIV",{class:!0});var Rr=s(Oo);v(At.$$.fragment,Rr),Jd=c(Rr),v(Po.$$.fragment,Rr),Rr.forEach(o),Wr.forEach(o),vr=c(t),_o=a(t,"H2",{class:!0});var Hr=s(_o);Lo=a(Hr,"A",{id:!0,class:!0,href:!0});var fm=s(Lo);Ba=a(fm,"SPAN",{});var _m=s(Ba);v(Dt.$$.fragment,_m),_m.forEach(o),fm.forEach(o),Xd=c(Hr),za=a(Hr,"SPAN",{});var gm=s(za);Yd=l(gm,"TFBlenderbotSmallModel"),gm.forEach(o),Hr.forEach(o),Tr=c(t),pe=a(t,"DIV",{class:!0});var Ve=s(pe);v(Gt.$$.fragment,Ve),Zd=c(Ve),Ut=a(Ve,"P",{});var Kr=s(Ut);ei=l(Kr,`The bare BLENDERBOT_SMALL Model outputting raw hidden-states without any specific head on top.
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Vr.forEach(o),li=c(Ve),v(No.$$.fragment,Ve),di=c(Ve),Me=a(Ve,"DIV",{class:!0});var ct=s(Me);v(Ht.$$.fragment,ct),ii=c(ct),go=a(ct,"P",{});var na=s(go);ci=l(na,"The "),Un=a(na,"A",{href:!0});var ym=s(Un);pi=l(ym,"TFBlenderbotSmallModel"),ym.forEach(o),mi=l(na," forward method, overrides the "),Fa=a(na,"CODE",{});var vm=s(Fa);hi=l(vm,"__call__"),vm.forEach(o),ui=l(na," special method."),na.forEach(o),fi=c(ct),v(Io.$$.fragment,ct),_i=c(ct),v(Ao.$$.fragment,ct),ct.forEach(o),Ve.forEach(o),wr=c(t),bo=a(t,"H2",{class:!0});var Qr=s(bo);Do=a(Qr,"A",{id:!0,class:!0,href:!0});var Tm=s(Do);qa=a(Tm,"SPAN",{});var wm=s(qa);v(Kt.$$.fragment,wm),wm.forEach(o),Tm.forEach(o),gi=c(Qr),Ea=a(Qr,"SPAN",{});var $m=s(Ea);bi=l($m,"TFBlenderbotSmallForConditionalGeneration"),$m.forEach(o),Qr.forEach(o),$r=c(t),me=a(t,"DIV",{class:!0});var Qe=s(me);v(Vt.$$.fragment,Qe),ki=c(Qe),Qt=a(Qe,"P",{});var Jr=s(Qt);yi=l(Jr,`The BLENDERBOT_SMALL Model with a language modeling head. Can be used for summarization.
This model inherits from `),Wn=a(Jr,"A",{href:!0});var Sm=s(Wn);vi=l(Sm,"TFPreTrainedModel"),Sm.forEach(o),Ti=l(Jr,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Xr.forEach(o),Bi=c(Qe),v(Go.$$.fragment,Qe),zi=c(Qe),P=a(Qe,"DIV",{class:!0});var K=s(P);v(Yt.$$.fragment,K),Fi=c(K),ko=a(K,"P",{});var aa=s(ko);qi=l(aa,"The "),Rn=a(aa,"A",{href:!0});var Bm=s(Rn);Ei=l(Bm,"TFBlenderbotSmallForConditionalGeneration"),Bm.forEach(o),Mi=l(aa," forward method, overrides the "),Ma=a(aa,"CODE",{});var zm=s(Ma);Ci=l(zm,"__call__"),zm.forEach(o),ji=l(aa," special method."),aa.forEach(o),Oi=c(K),v(Uo.$$.fragment,K),Pi=c(K),Ca=a(K,"P",{});var Fm=s(Ca);Li=l(Fm,"Conversation example::"),Fm.forEach(o),Ni=c(K),ja=a(K,"BLOCKQUOTE",{});var qm=s(ja);Oa=a(qm,"BLOCKQUOTE",{});var Em=s(Oa);Pa=a(Em,"BLOCKQUOTE",{});var Mm=s(Pa);La=a(Mm,"P",{});var Cm=s(La);Ii=l(Cm,`from transformers import BlenderbotSmallTokenizer, TFBlenderbotSmallForConditionalGeneration >>> mname =
\u2018facebook/blenderbot_small-90M\u2019 >>> model = BlenderbotSmallForConditionalGeneration.from_pretrained(mname) >>>
...
next_reply_ids = model.generate(**inputs) >>> print(\u201CBot: \u201D, tokenizer.batch_decode(next_reply_ids,
skip_special_tokens=True)[0])`),Qm.forEach(o),Vm.forEach(o),Km.forEach(o),Hm.forEach(o),K.forEach(o),Qe.forEach(o),Sr=c(t),yo=a(t,"H2",{class:!0});var Zr=s(yo);Wo=a(Zr,"A",{id:!0,class:!0,href:!0});var Jm=s(Wo);es=a(Jm,"SPAN",{});var Xm=s(es);v(en.$$.fragment,Xm),Xm.forEach(o),Jm.forEach(o),Ji=c(Zr),os=a(Zr,"SPAN",{});var Ym=s(os);Xi=l(Ym,"FlaxBlenderbotSmallModel"),Ym.forEach(o),Zr.forEach(o),xr=c(t),I=a(t,"DIV",{class:!0});var te=s(I);v(on.$$.fragment,te),Yi=c(te),tn=a(te,"P",{});var el=s(tn);Zi=l(el,`The bare BlenderbotSmall Model transformer outputting raw hidden-states without any specific head on top.
...
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),ol.forEach(o),rc=c(te),ts=a(te,"P",{});var oh=s(ts);lc=l(oh,"Finally, this model supports inherent JAX features such as:"),oh.forEach(o),dc=c(te),Ue=a(te,"UL",{});var pt=s(Ue);ns=a(pt,"LI",{});var th=s(ns);sn=a(th,"A",{href:!0,rel:!0});var nh=s(sn);ic=l(nh,"Just-In-Time (JIT) compilation"),nh.forEach(o),th.forEach(o),cc=c(pt),as=a(pt,"LI",{});var ah=s(as);rn=a(ah,"A",{href:!0,rel:!0});var sh=s(rn);pc=l(sh,"Automatic Differentiation"),sh.forEach(o),ah.forEach(o),mc=c(pt),ss=a(pt,"LI",{});var rh=s(ss);ln=a(rh,"A",{href:!0,rel:!0});var lh=s(ln);hc=l(lh,"Vectorization"),lh.forEach(o),rh.forEach(o),uc=c(pt),rs=a(pt,"LI",{});var dh=s(rs);dn=a(dh,"A",{href:!0,rel:!0});var ih=s(dn);fc=l(ih,"Parallelization"),ih.forEach(o),dh.forEach(o),pt.forEach(o),_c=c(te),Ro=a(te,"DIV",{class:!0});var tl=s(Ro);v(cn.$$.fragment,tl),gc=c(tl),v(Ho.$$.fragment,tl),tl.forEach(o),bc=c(te),Ko=a(te,"DIV",{class:!0});var nl=s(Ko);v(pn.$$.fragment,nl),kc=c(nl),v(Vo.$$.fragment,nl),nl.forEach(o),yc=c(te),Qo=a(te,"DIV",{class:!0});var al=s(Qo);v(mn.$$.fragment,al),vc=c(al),v(Jo.$$.fragment,al),al.forEach(o),te.forEach(o),Br=c(t),vo=a(t,"H2",{class:!0});var sl=s(vo);Xo=a(sl,"A",{id:!0,class:!0,href:!0});var ch=s(Xo);ls=a(ch,"SPAN",{});var ph=s(ls);v(hn.$$.fragment,ph),ph.forEach(o),ch.forEach(o),Tc=c(sl),ds=a(sl,"SPAN",{});var mh=s(ds);wc=l(mh,"FlaxBlenderbotForConditionalGeneration"),mh.forEach(o),sl.forEach(o),zr=c(t),A=a(t,"DIV",{class:!0});var ne=s(A);v(un.$$.fragment,ne),$c=c(ne),fn=a(ne,"P",{});var rl=s(fn);Sc=l(rl,`The BLENDERBOT_SMALL Model with a language modeling head. Can be used for summarization.
...
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),ll.forEach(o),Mc=c(ne),is=a(ne,"P",{});var fh=s(is);Cc=l(fh,"Finally, this model supports inherent JAX features such as:"),fh.forEach(o),jc=c(ne),We=a(ne,"UL",{});var mt=s(We);cs=a(mt,"LI",{});var _h=s(cs);bn=a(_h,"A",{href:!0,rel:!0});var gh=s(bn);Oc=l(gh,"Just-In-Time (JIT) compilation"),gh.forEach(o),_h.forEach(o),Pc=c(mt),ps=a(mt,"LI",{});var bh=s(ps);kn=a(bh,"A",{href:!0,rel:!0});var kh=s(kn);Lc=l(kh,"Automatic Differentiation"),kh.forEach(o),bh.forEach(o),Nc=c(mt),ms=a(mt,"LI",{});var yh=s(ms);yn=a(yh,"A",{href:!0,rel:!0});var vh=s(yn);Ic=l(vh,"Vectorization"),vh.forEach(o),yh.forEach(o),Ac=c(mt),hs=a(mt,"LI",{});var Th=s(hs);vn=a(Th,"A",{href:!0,rel:!0});var wh=s(vn);Dc=l(wh,"Parallelization"),wh.forEach(o),Th.forEach(o),mt.forEach(o),Gc=c(ne),E=a(ne,"DIV",{class:!0});var M=s(E);v(Tn.$$.fragment,M),Uc=c(M),To=a(M,"P",{});var sa=s(To);Wc=l(sa,"The "),us=a(sa,"CODE",{});var $h=s(us);Rc=l($h,"FlaxBlenderbotSmallPreTrainedModel"),$h.forEach(o),Hc=l(sa," forward method, overrides the "),fs=a(sa,"CODE",{});var Sh=s(fs);Kc=l(Sh,"__call__"),Sh.forEach(o),Vc=l(sa," special method."),sa.forEach(o),Qc=c(M),v(Yo.$$.fragment,M),Jc=c(M),_s=a(M,"P",{});var xh=s(_s);Xc=l(xh,"Summarization example:"),xh.forEach(o),Yc=c(M),gs=a(M,"BLOCKQUOTE",{});var Bh=s(gs);bs=a(Bh,"BLOCKQUOTE",{});var zh=s(bs);ks=a(zh,"BLOCKQUOTE",{});var Fh=s(ks);ys=a(Fh,"P",{});var qh=s(ys);Zc=l(qh,"from transformers import BlenderbotSmallTokenizer, FlaxBlenderbotSmallForConditionalGeneration"),qh.forEach(o),Fh.forEach(o),zh.forEach(o),Bh.forEach(o),ep=c(M),vs=a(M,"BLOCKQUOTE",{});var Eh=s(vs);Ts=a(Eh,"BLOCKQUOTE",{});var Mh=s(Ts);ws=a(Mh,"BLOCKQUOTE",{});var Ch=s(ws);$s=a(Ch,"P",{});var jh=s($s);op=l(jh,`model = FlaxBlenderbotSmallForConditionalGeneration.from_pretrained(\u2018facebook/blenderbot_small-90M\u2019) >>>
