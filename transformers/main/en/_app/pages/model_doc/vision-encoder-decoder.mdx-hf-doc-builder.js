...
<span class="hljs-meta">&gt;&gt;&gt; </span>model.save_pretrained(<span class="hljs-string">&quot;./vit-gpt2&quot;</span>)
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-comment"># load fine-tuned model</span>
<span class="hljs-meta">&gt;&gt;&gt; </span>model = FlaxVisionEncoderDecoderModel.from_pretrained(<span class="hljs-string">&quot;./vit-gpt2&quot;</span>)`}}),{c(){h=a("p"),x=n("Example:"),_=l(),b(f.$$.fragment)},l(d){h=s(d,"P",{});var u=i(h);x=r(u,"Example:"),u.forEach(t),_=p(d),w(f.$$.fragment,d)},m(d,u){g(d,h,u),e(h,x),g(d,_,u),E(f,d,u),v=!0},p:mt,i(d){v||(T(f.$$.fragment,d),v=!0)},o(d){y(f.$$.fragment,d),v=!1},d(d){d&&t(h),d&&t(_),k(f,d)}}}function ih(z){let h,x,_,f,v,d,u,I,qa,yr,ne,ye,fn,to,za,gn,Pa,kr,$,Fa,ht,Aa,Ca,un,Sa,Ia,ft,La,Na,gt,Oa,Ra,ut,Ba,Ga,_t,Wa,Ha,_n,Ua,Za,vt,Ya,Ja,bt,Ka,Qa,wt,Xa,es,Et,os,ts,xr,ke,ns,no,rs,as,$r,xe,ss,Tt,is,ds,jr,J,cs,yt,ls,ps,kt,ms,hs,Mr,re,$e,vn,ro,fs,ao,gs,bn,us,_s,Dr,Z,xt,vs,bs,$t,ws,Es,wn,Ts,ys,Vr,so,qr,ae,je,En,io,ks,co,xs,Tn,$s,js,zr,M,jt,Ms,Ds,yn,Vs,qs,Mt,zs,Ps,kn,Fs,As,xn,Cs,Ss,$n,Is,Ls,Dt,Ns,Os,Me,Rs,jn,Bs,Gs,Mn,Ws,Hs,Vt,Us,Zs,Pr,lo,Fr,se,De,Dn,po,Ys,mo,Js,Vn,Ks,Qs,Ar,L,Xs,qn,ei,oi,qt,ti,ni,zn,ri,ai,Cr,Ve,si,Pn,ii,di,Sr,ho,Ir,ie,qe,Fn,fo,ci,go,li,An,pi,mi,Lr,de,Cn,hi,fi,Sn,gi,ui,Nr,uo,Or,ce,ze,In,_o,_i,Ln,vi,Rr,N,bi,Nn,wi,Ei,On,Ti,yi,Rn,ki,xi,Br,vo,Gr,K,$i,bo,ji,Mi,wo,Di,Vi,Wr,le,Pe,Bn,Eo,qi,Gn,zi,Hr,S,To,Pi,Fe,zt,Fi,Ai,Pt,Ci,Si,Ii,pe,Li,Ft,Ni,Oi,At,Ri,Bi,Gi,Ae,Wi,Ce,yo,Hi,ko,Ui,Ct,Zi,Yi,Ji,Se,xo,Ki,me,Qi,Wn,Xi,ed,Hn,od,td,Ur,he,Ie,Un,$o,nd,Zn,rd,Zr,D,jo,ad,fe,sd,St,id,dd,It,cd,ld,pd,Mo,md,Do,hd,fd,gd,Vo,ud,qo,_d,vd,bd,Yn,wd,Ed,zo,Td,Lt,yd,kd,xd,Po,$d,Fo,jd,Md,Dd,Q,Nt,Vd,qd,Jn,zd,Pd,Kn,Fd,Ad,Cd,O,Ao,Sd,ge,Id,Ot,Ld,Nd,Qn,Od,Rd,Bd,Le,Gd,Ne,Wd,R,Co,Hd,Xn,Ud,Zd,ue,Yd,er,Jd,Kd,or,Qd,Xd,ec,Oe,Yr,_e,Re,tr,So,oc,nr,tc,Jr,V,Io,nc,ve,rc,Rt,ac,sc,Bt,ic,dc,cc,Lo,lc,No,pc,mc,hc,Oo,fc,Ro,gc,uc,_c,rr,vc,bc,Bo,wc,Gt,Ec,Tc,yc,Go,kc,Wo,xc,$c,jc,X,Wt,Mc,Dc,Ht,Vc,qc,Ut,zc,Pc,Fc,B,Ho,Ac,be,Cc,Zt,Sc,Ic,ar,Lc,Nc,Oc,Be,Rc,Ge,Bc,ee,Uo,Gc,sr,Wc,Hc,We,Kr,we,He,ir,Zo,Uc,dr,Zc,Qr,q,Yo,Yc,Ee,Jc,Yt,Kc,Qc,Jt,Xc,el,ol,Jo,tl,Ko,nl,rl,al,Qo,sl,Xo,il,dl,cl,cr,ll,pl,et,ml,Kt,hl,fl,gl,ot,ul,tt,_l,vl,bl,oe,Qt,wl,El,lr,Tl,yl,pr,kl,xl,$l,G,nt,jl,Te,Ml,Xt,Dl,Vl,mr,ql,zl,Pl,Ue,Fl,Ze,Al,te,rt,Cl,hr,Sl,Il,Ye,Xr;return d=new Y({}),to=new Y({}),ro=new Y({}),so=new U({props:{code:`from transformers import BertConfig, ViTConfig, VisionEncoderDecoderConfig, VisionEncoderDecoderModel
...
the caption. Another example is optical character recognition. Refer to `),yt=a("a"),ls=n("TrOCR"),ps=n(", which is an instance of "),kt=a("a"),ms=n("VisionEncoderDecoderModel"),hs=n("."),Mr=l(),re=a("h2"),$e=a("a"),vn=a("span"),b(ro.$$.fragment),fs=l(),ao=a("span"),gs=n("Randomly initializing "),bn=a("code"),us=n("VisionEncoderDecoderModel"),_s=n(" from model configurations."),Dr=l(),Z=a("p"),xt=a("a"),vs=n("VisionEncoderDecoderModel"),bs=n(" can be randomly initialized from an encoder and a decoder config. In the following example, we show how to do this using the default "),$t=a("a"),ws=n("ViTModel"),Es=n(` configuration for the encoder
and the default `),wn=a("code"),Ts=n("BertForCausalLM"),ys=n(" configuration for the decoder."),Vr=l(),b(so.$$.fragment),qr=l(),ae=a("h2"),je=a("a"),En=a("span"),b(io.$$.fragment),ks=l(),co=a("span"),xs=n("Initialising "),Tn=a("code"),$s=n("VisionEncoderDecoderModel"),js=n(" from a pretrained encoder and a pretrained decoder."),zr=l(),M=a("p"),jt=a("a"),Ms=n("VisionEncoderDecoderModel"),Ds=n(" can be initialized from a pretrained encoder checkpoint and a pretrained decoder checkpoint. Note that any pretrained Transformer-based vision model, "),yn=a("em"),Vs=n("e.g."),qs=l(),Mt=a("a"),zs=n("Swin"),Ps=n(", can serve as the encoder and both pretrained auto-encoding models, "),kn=a("em"),Fs=n("e.g."),As=n(" BERT, pretrained causal language models, "),xn=a("em"),Cs=n("e.g."),Ss=n(" GPT2, as well as the pretrained decoder part of sequence-to-sequence models, "),$n=a("em"),Is=n("e.g."),Ls=n(` decoder of BART, can be used as the decoder.
...
were contributed by `),wo=a("a"),Di=n("ydshieh"),Vi=n("."),Wr=l(),le=a("h2"),Pe=a("a"),Bn=a("span"),b(Eo.$$.fragment),qi=l(),Gn=a("span"),zi=n("VisionEncoderDecoderConfig"),Hr=l(),S=a("div"),b(To.$$.fragment),Pi=l(),Fe=a("p"),zt=a("a"),Fi=n("VisionEncoderDecoderConfig"),Ai=n(` is the configuration class to store the configuration of a
...
configuration and decoder model configuration.`),Ji=l(),Se=a("div"),b(xo.$$.fragment),Ki=l(),me=a("p"),Qi=n("Serializes this instance to a Python dictionary. Override the default "),Wn=a("em"),Xi=n("to_dict()"),ed=n(" from "),Hn=a("em"),od=n("PretrainedConfig"),td=n("."),Ur=l(),he=a("h2"),Ie=a("a"),Un=a("span"),b($o.$$.fragment),nd=l(),Zn=a("span"),rd=n("VisionEncoderDecoderModel"),Zr=l(),D=a("div"),b(jo.$$.fragment),ad=l(),fe=a("p"),sd=n(`This class can be used to initialize an image-to-text-sequence model with any pretrained vision autoencoding model
...
etc.)`),xd=l(),Po=a("p"),$d=n("This model is also a PyTorch "),Fo=a("a"),jd=n("torch.nn.Module"),Md=n(` subclass.
...
for the encoder and :meth`),pr=a("em"),kl=n("~transformers.FlaxAutoModelForCausalLM.from_pretrained"),xl=n(" class method for the decoder."),$l=l(),G=a("div"),b(nt.$$.fragment),jl=l(),Te=a("p"),Ml=n("The "),Xt=a("a"),Dl=n("FlaxVisionEncoderDecoderModel"),Vl=n(" forward method, overrides the "),mr=a("code"),ql=n("__call__"),zl=n(" special method."),Pl=l(),b(Ue.$$.fragment),Fl=l(),b(Ze.$$.fragment),Al=l(),te=a("div"),b(rt.$$.fragment),Cl=l(),hr=a("p"),Sl=n(`Instantiate an encoder and a decoder from one or two base classes of the library from pretrained model
...
checkpoints for a particular vision encoder-decoder model, a workaround is:`),Er.forEach(t),Nr=p(o),w(uo.$$.fragment,o),Or=p(o),ce=s(o,"H2",{class:!0});var pa=i(ce);ze=s(pa,"A",{id:!0,class:!0,href:!0});var zp=i(ze);In=s(zp,"SPAN",{});var Pp=i(In);w(_o.$$.fragment,Pp),Pp.forEach(t),zp.forEach(t),_i=p(pa),Ln=s(pa,"SPAN",{});var Fp=i(Ln);vi=r(Fp,"Training"),Fp.forEach(t),pa.forEach(t),Rr=p(o),N=s(o,"P",{});var Ke=i(N);bi=r(Ke,`Once the model is created, it can be fine-tuned similar to BART, T5 or any other encoder-decoder model on a dataset of (image, text) pairs.
...
were contributed by `),wo=s(on,"A",{href:!0,rel:!0});var Lp=i(wo);Di=r(Lp,"ydshieh"),Lp.forEach(t),Vi=r(on,"."),on.forEach(t),Wr=p(o),le=s(o,"H2",{class:!0});var ma=i(le);Pe=s(ma,"A",{id:!0,class:!0,href:!0});var Np=i(Pe);Bn=s(Np,"SPAN",{});var Op=i(Bn);w(Eo.$$.fragment,Op),Op.forEach(t),Np.forEach(t),qi=p(ma),Gn=s(ma,"SPAN",{});var Rp=i(Gn);zi=r(Rp,"VisionEncoderDecoderConfig"),Rp.forEach(t),ma.forEach(t),Hr=p(o),S=s(o,"DIV",{class:!0});var W=i(S);w(To.$$.fragment,W),Pi=p(W),Fe=s(W,"P",{});var Tr=i(Fe);zt=s(Tr,"A",{href:!0});var Bp=i(zt);Fi=r(Bp,"VisionEncoderDecoderConfig"),Bp.forEach(t),Ai=r(Tr,` is the configuration class to store the configuration of a
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),xa.forEach(t),jc=p(A),X=s(A,"P",{});var ct=i(X);Wt=s(ct,"A",{href:!0});var km=i(Wt);Mc=r(km,"TFVisionEncoderDecoderModel"),km.forEach(t),Dc=r(ct,` is a generic model class that will be instantiated as a transformer architecture
with one of the base vision model classes of the library as encoder and another one of the base model classes as
decoder when created with the `),Ht=s(ct,"A",{href:!0});var xm=i(Ht);Vc=r(xm,"from_pretrained()"),xm.forEach(t),qc=r(ct,` class method for the encoder and
`),Ut=s(ct,"A",{href:!0});var $m=i(Ut);zc=r($m,"from_pretrained()"),$m.forEach(t),Pc=r(ct," class method for the decoder."),ct.forEach(t),Fc=p(A),B=s(A,"DIV",{class:!0});var eo=i(B);w(Ho.$$.fragment,eo),Ac=p(eo),be=s(eo,"P",{});var cn=i(be);Cc=r(cn,"The "),Zt=s(cn,"A",{href:!0});var jm=i(Zt);Sc=r(jm,"TFVisionEncoderDecoderModel"),jm.forEach(t),Ic=r(cn," forward method, overrides the "),ar=s(cn,"CODE",{});var Mm=i(ar);Lc=r(Mm,"__call__"),Mm.forEach(t),Nc=r(cn," special method."),cn.forEach(t),Oc=p(eo),w(Be.$$.fragment,eo),Rc=p(eo),w(Ge.$$.fragment,eo),eo.forEach(t),Bc=p(A),ee=s(A,"DIV",{class:!0});var ln=i(ee);w(Uo.$$.fragment,ln),Gc=p(ln),sr=s(ln,"P",{});var Dm=i(sr);Wc=r(Dm,`Instantiate an encoder and a decoder from one or two base classes of the library from pretrained model
checkpoints.`),Dm.forEach(t),Hc=p(ln),w(We.$$.fragment,ln),ln.forEach(t),A.forEach(t),Kr=p(o),we=s(o,"H2",{class:!0});var $a=i(we);He=s($a,"A",{id:!0,class:!0,href:!0});var Vm=i(He);ir=s(Vm,"SPAN",{});var qm=i(ir);w(Zo.$$.fragment,qm),qm.forEach(t),Vm.forEach(t),Uc=p($a),dr=s($a,"SPAN",{});var zm=i(dr);Zc=r(zm,"FlaxVisionEncoderDecoderModel"),zm.forEach(t),$a.forEach(t),Qr=p(o),q=s(o,"DIV",{class:!0});var C=i(q);w(Yo.$$.fragment,C),Yc=p(C),Ee=s(C,"P",{});var pn=i(Ee);Jc=r(pn,`This class can be used to initialize an image-to-text-sequence model with any pretrained vision autoencoding model
as the encoder and any pretrained text autoregressive model as the decoder. The encoder is loaded via
`),Yt=s(pn,"A",{href:!0});var Pm=i(Yt);Kc=r(Pm,"from_pretrained()"),Pm.forEach(t),Qc=r(pn," function and the decoder is loaded via "),Jt=s(pn,"A",{href:!0});var Fm=i(Jt);Xc=r(Fm,"from_pretrained()"),Fm.forEach(t),el=r(pn,`
function. Cross-attention layers are automatically added to the decoder and should be fine-tuned on a downstream
...
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),Va.forEach(t),bl=p(C),oe=s(C,"P",{});var lt=i(oe);Qt=s(lt,"A",{href:!0});var Nm=i(Qt);wl=r(Nm,"FlaxVisionEncoderDecoderModel"),Nm.forEach(t),El=r(lt,` is a generic model class that will be instantiated as a transformer architecture
with the module (flax.nn.Module) of one of the base vision model classes of the library as encoder module and
