...
<span class="hljs-meta">&gt;&gt;&gt; </span>model = VisionEncoderDecoderModel.from_pretrained(<span class="hljs-string">&quot;my-model&quot;</span>, config=encoder_decoder_config)`}}),{c(){h=a("p"),$=n("Examples:"),_=l(),b(f.$$.fragment)},l(d){h=s(d,"P",{});var u=i(h);$=r(u,"Examples:"),u.forEach(t),_=p(d),w(f.$$.fragment,d)},m(d,u){g(d,h,u),e(h,$),g(d,_,u),T(f,d,u),v=!0},p:mt,i(d){v||(E(f.$$.fragment,d),v=!0)},o(d){y(f.$$.fragment,d),v=!1},d(d){d&&t(h),d&&t(_),k(f,d)}}}function Qm(P){let h,$,_,f,v;return{c(){h=a("p"),$=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),_=a("code"),f=n("Module"),v=n(`
...
<span class="hljs-meta">&gt;&gt;&gt; </span>generated_text = processor.batch_decode(generated_ids, skip_special_tokens=<span class="hljs-literal">True</span>)[<span class="hljs-number">0</span>]`}}),{c(){h=a("p"),$=n("Examples:"),_=l(),b(f.$$.fragment)},l(d){h=s(d,"P",{});var u=i(h);$=r(u,"Examples:"),u.forEach(t),_=p(d),w(f.$$.fragment,d)},m(d,u){g(d,h,u),e(h,$),g(d,_,u),T(f,d,u),v=!0},p:mt,i(d){v||(E(f.$$.fragment,d),v=!0)},o(d){y(f.$$.fragment,d),v=!1},d(d){d&&t(h),d&&t(_),k(f,d)}}}function eh(P){let h,$,_,f,v;return f=new U({props:{code:`from transformers import VisionEncoderDecoderModel
...
<span class="hljs-meta">&gt;&gt;&gt; </span>model = VisionEncoderDecoderModel.from_pretrained(<span class="hljs-string">&quot;./vit-bert&quot;</span>)`}}),{c(){h=a("p"),$=n("Example:"),_=l(),b(f.$$.fragment)},l(d){h=s(d,"P",{});var u=i(h);$=r(u,"Example:"),u.forEach(t),_=p(d),w(f.$$.fragment,d)},m(d,u){g(d,h,u),e(h,$),g(d,_,u),T(f,d,u),v=!0},p:mt,i(d){v||(E(f.$$.fragment,d),v=!0)},o(d){y(f.$$.fragment,d),v=!1},d(d){d&&t(h),d&&t(_),k(f,d)}}}function oh(P){let h,$,_,f,v;return{c(){h=a("p"),$=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),_=a("code"),f=n("Module"),v=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(d){h=s(d,"P",{});var u=i(h);$=r(u,"Although the recipe for forward pass needs to be defined within this function, one should call the "),_=s(u,"CODE",{});var I=i(_);f=r(I,"Module"),I.forEach(t),v=r(u,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
<span class="hljs-meta">&gt;&gt;&gt; </span>generated = model.generate(pixel_values, decoder_start_token_id=model.config.decoder.bos_token_id)`}}),{c(){h=a("p"),$=n("Examples:"),_=l(),b(f.$$.fragment)},l(d){h=s(d,"P",{});var u=i(h);$=r(u,"Examples:"),u.forEach(t),_=p(d),w(f.$$.fragment,d)},m(d,u){g(d,h,u),e(h,$),g(d,_,u),T(f,d,u),v=!0},p:mt,i(d){v||(E(f.$$.fragment,d),v=!0)},o(d){y(f.$$.fragment,d),v=!1},d(d){d&&t(h),d&&t(_),k(f,d)}}}function nh(P){let h,$,_,f,v;return f=new U({props:{code:`from transformers import TFVisionEncoderDecoderModel
...
<span class="hljs-meta">&gt;&gt;&gt; </span>model.save_pretrained(<span class="hljs-string">&quot;./vit-bert&quot;</span>)
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-comment"># load fine-tuned model</span>
<span class="hljs-meta">&gt;&gt;&gt; </span>model = TFVisionEncoderDecoderModel.from_pretrained(<span class="hljs-string">&quot;./vit-bert&quot;</span>)`}}),{c(){h=a("p"),$=n("Example:"),_=l(),b(f.$$.fragment)},l(d){h=s(d,"P",{});var u=i(h);$=r(u,"Example:"),u.forEach(t),_=p(d),w(f.$$.fragment,d)},m(d,u){g(d,h,u),e(h,$),g(d,_,u),T(f,d,u),v=!0},p:mt,i(d){v||(E(f.$$.fragment,d),v=!0)},o(d){y(f.$$.fragment,d),v=!1},d(d){d&&t(h),d&&t(_),k(f,d)}}}function rh(P){let h,$,_,f,v;return{c(){h=a("p"),$=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),_=a("code"),f=n("Module"),v=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(d){h=s(d,"P",{});var u=i(h);$=r(u,"Although the recipe for forward pass needs to be defined within this function, one should call the "),_=s(u,"CODE",{});var I=i(_);f=r(I,"Module"),I.forEach(t),v=r(u,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
<span class="hljs-meta">&gt;&gt;&gt; </span>captions = tokenizer_output.batch_decode(sequences, skip_special_tokens=<span class="hljs-literal">True</span>)`}}),{c(){h=a("p"),$=n("Examples:"),_=l(),b(f.$$.fragment)},l(d){h=s(d,"P",{});var u=i(h);$=r(u,"Examples:"),u.forEach(t),_=p(d),w(f.$$.fragment,d)},m(d,u){g(d,h,u),e(h,$),g(d,_,u),T(f,d,u),v=!0},p:mt,i(d){v||(E(f.$$.fragment,d),v=!0)},o(d){y(f.$$.fragment,d),v=!1},d(d){d&&t(h),d&&t(_),k(f,d)}}}function sh(P){let h,$,_,f,v;return f=new U({props:{code:`from transformers import FlaxVisionEncoderDecoderModel
...
<span class="hljs-meta">&gt;&gt;&gt; </span>model.save_pretrained(<span class="hljs-string">&quot;./vit-gpt2&quot;</span>)
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-comment"># load fine-tuned model</span>
<span class="hljs-meta">&gt;&gt;&gt; </span>model = FlaxVisionEncoderDecoderModel.from_pretrained(<span class="hljs-string">&quot;./vit-gpt2&quot;</span>)`}}),{c(){h=a("p"),$=n("Example:"),_=l(),b(f.$$.fragment)},l(d){h=s(d,"P",{});var u=i(h);$=r(u,"Example:"),u.forEach(t),_=p(d),w(f.$$.fragment,d)},m(d,u){g(d,h,u),e(h,$),g(d,_,u),T(f,d,u),v=!0},p:mt,i(d){v||(E(f.$$.fragment,d),v=!0)},o(d){y(f.$$.fragment,d),v=!1},d(d){d&&t(h),d&&t(_),k(f,d)}}}function ih(P){let h,$,_,f,v,d,u,I,qa,yr,ne,ye,fn,to,Pa,gn,za,kr,x,Fa,ht,Aa,Ca,un,Sa,Ia,ft,La,Na,gt,Oa,Ra,ut,Ba,Ga,_t,Wa,Ha,_n,Ua,Za,vt,Ya,Ja,bt,Ka,Qa,wt,Xa,es,Tt,os,ts,$r,ke,ns,no,rs,as,xr,$e,ss,Et,is,ds,jr,J,cs,yt,ls,ps,kt,ms,hs,Mr,re,xe,vn,ro,fs,ao,gs,bn,us,_s,Dr,Z,$t,vs,bs,xt,ws,Ts,wn,Es,ys,Vr,so,qr,ae,je,Tn,io,ks,co,$s,En,xs,js,Pr,M,jt,Ms,Ds,yn,Vs,qs,Mt,Ps,zs,kn,Fs,As,$n,Cs,Ss,xn,Is,Ls,Dt,Ns,Os,Me,Rs,jn,Bs,Gs,Mn,Ws,Hs,Vt,Us,Zs,zr,lo,Fr,se,De,Dn,po,Ys,mo,Js,Vn,Ks,Qs,Ar,L,Xs,qn,ei,oi,qt,ti,ni,Pn,ri,ai,Cr,Ve,si,zn,ii,di,Sr,ho,Ir,ie,qe,Fn,fo,ci,go,li,An,pi,mi,Lr,de,Cn,hi,fi,Sn,gi,ui,Nr,uo,Or,ce,Pe,In,_o,_i,Ln,vi,Rr,N,bi,Nn,wi,Ti,On,Ei,yi,Rn,ki,$i,Br,vo,Gr,K,xi,bo,ji,Mi,wo,Di,Vi,Wr,le,ze,Bn,To,qi,Gn,Pi,Hr,S,Eo,zi,Fe,Pt,Fi,Ai,zt,Ci,Si,Ii,pe,Li,Ft,Ni,Oi,At,Ri,Bi,Gi,Ae,Wi,Ce,yo,Hi,ko,Ui,Ct,Zi,Yi,Ji,Se,$o,Ki,me,Qi,Wn,Xi,ed,Hn,od,td,Ur,he,Ie,Un,xo,nd,Zn,rd,Zr,D,jo,ad,fe,sd,St,id,dd,It,cd,ld,pd,Mo,md,Do,hd,fd,gd,Vo,ud,qo,_d,vd,bd,Yn,wd,Td,Po,Ed,Lt,yd,kd,$d,zo,xd,Fo,jd,Md,Dd,Q,Nt,Vd,qd,Jn,Pd,zd,Kn,Fd,Ad,Cd,O,Ao,Sd,ge,Id,Ot,Ld,Nd,Qn,Od,Rd,Bd,Le,Gd,Ne,Wd,R,Co,Hd,Xn,Ud,Zd,ue,Yd,er,Jd,Kd,or,Qd,Xd,ec,Oe,Yr,_e,Re,tr,So,oc,nr,tc,Jr,V,Io,nc,ve,rc,Rt,ac,sc,Bt,ic,dc,cc,Lo,lc,No,pc,mc,hc,Oo,fc,Ro,gc,uc,_c,rr,vc,bc,Bo,wc,Gt,Tc,Ec,yc,Go,kc,Wo,$c,xc,jc,X,Wt,Mc,Dc,Ht,Vc,qc,Ut,Pc,zc,Fc,B,Ho,Ac,be,Cc,Zt,Sc,Ic,ar,Lc,Nc,Oc,Be,Rc,Ge,Bc,ee,Uo,Gc,sr,Wc,Hc,We,Kr,we,He,ir,Zo,Uc,dr,Zc,Qr,q,Yo,Yc,Te,Jc,Yt,Kc,Qc,Jt,Xc,el,ol,Jo,tl,Ko,nl,rl,al,Qo,sl,Xo,il,dl,cl,cr,ll,pl,et,ml,Kt,hl,fl,gl,ot,ul,tt,_l,vl,bl,oe,Qt,wl,Tl,lr,El,yl,pr,kl,$l,xl,G,nt,jl,Ee,Ml,Xt,Dl,Vl,mr,ql,Pl,zl,Ue,Fl,Ze,Al,te,rt,Cl,hr,Sl,Il,Ye,Xr;return d=new Y({}),to=new Y({}),ro=new Y({}),so=new U({props:{code:`from transformers import BertConfig, ViTConfig, VisionEncoderDecoderConfig, VisionEncoderDecoderModel
...
<span class="hljs-meta">&gt;&gt;&gt; </span>loss = model(pixel_values=pixel_values, labels=labels).loss`}}),To=new Y({}),Eo=new H({props:{name:"class transformers.VisionEncoderDecoderConfig",anchor:"transformers.VisionEncoderDecoderConfig",parameters:[{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.VisionEncoderDecoderConfig.kwargs",description:`<strong>kwargs</strong> (<em>optional</em>) &#x2014;
...
</ul>`,name:"kwargs"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/vision_encoder_decoder/configuration_vision_encoder_decoder.py#L34"}}),Ae=new pt({props:{anchor:"transformers.VisionEncoderDecoderConfig.example",$$slots:{default:[Km]},$$scope:{ctx:P}}}),yo=new H({props:{name:"from_encoder_decoder_configs",anchor:"transformers.VisionEncoderDecoderConfig.from_encoder_decoder_configs",parameters:[{name:"encoder_config",val:": PretrainedConfig"},{name:"decoder_config",val:": PretrainedConfig"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/vision_encoder_decoder/configuration_vision_encoder_decoder.py#L100",returnDescription:`
...
`}}),Be=new Nl({props:{$$slots:{default:[oh]},$$scope:{ctx:P}}}),Ge=new pt({props:{anchor:"transformers.TFVisionEncoderDecoderModel.call.example",$$slots:{default:[th]},$$scope:{ctx:P}}}),Uo=new H({props:{name:"from_encoder_decoder_pretrained",anchor:"transformers.TFVisionEncoderDecoderModel.from_encoder_decoder_pretrained",parameters:[{name:"encoder_pretrained_model_name_or_path",val:": str = None"},{name:"decoder_pretrained_model_name_or_path",val:": str = None"},{name:"*model_args",val:""},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.TFVisionEncoderDecoderModel.from_encoder_decoder_pretrained.encoder_pretrained_model_name_or_path",description:`<strong>encoder_pretrained_model_name_or_path</strong> (<code>str</code>, <em>optional</em>) &#x2014;
...
<p>Behaves differently depending on whether a <code>config</code> is provided or automatically loaded.`,name:"kwargs"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/vision_encoder_decoder/modeling_flax_vision_encoder_decoder.py#L724"}}),Ye=new pt({props:{anchor:"transformers.FlaxVisionEncoderDecoderModel.from_encoder_decoder_pretrained.example",$$slots:{default:[sh]},$$scope:{ctx:P}}}),{c(){h=a("meta"),$=l(),_=a("h1"),f=a("a"),v=a("span"),b(d.$$.fragment),u=l(),I=a("span"),qa=n("Vision Encoder Decoder Models"),yr=l(),ne=a("h2"),ye=a("a"),fn=a("span"),b(to.$$.fragment),Pa=l(),gn=a("span"),za=n("Overview"),kr=l(),x=a("p"),Fa=n("The "),ht=a("a"),Aa=n("VisionEncoderDecoderModel"),Ca=n(` can be used to initialize an image-to-text model with any
...
and any pretrained language model as the decoder (`),_n=a("em"),Ua=n("e.g."),Za=l(),vt=a("a"),Ya=n("RoBERTa"),Ja=n(", "),bt=a("a"),Ka=n("GPT2"),Qa=n(", "),wt=a("a"),Xa=n("BERT"),es=n(", "),Tt=a("a"),os=n("DistilBERT"),ts=n(")."),$r=l(),ke=a("p"),ns=n(`The effectiveness of initializing image-to-text-sequence models with pretrained checkpoints has been shown in (for
...
Zhoujun Li, Furu Wei.`),xr=l(),$e=a("p"),ss=n("After such a "),Et=a("a"),is=n("VisionEncoderDecoderModel"),ds=n(` has been trained/fine-tuned, it can be saved/loaded just like any other models (see the examples below
...
the caption. Another example is optical character recognition. Refer to `),yt=a("a"),ls=n("TrOCR"),ps=n(", which is an instance of "),kt=a("a"),ms=n("VisionEncoderDecoderModel"),hs=n("."),Mr=l(),re=a("h2"),xe=a("a"),vn=a("span"),b(ro.$$.fragment),fs=l(),ao=a("span"),gs=n("Randomly initializing "),bn=a("code"),us=n("VisionEncoderDecoderModel"),_s=n(" from model configurations."),Dr=l(),Z=a("p"),$t=a("a"),vs=n("VisionEncoderDecoderModel"),bs=n(" can be randomly initialized from an encoder and a decoder config. In the following example, we show how to do this using the default "),xt=a("a"),ws=n("ViTModel"),Ts=n(` configuration for the encoder
and the default `),wn=a("code"),Es=n("BertForCausalLM"),ys=n(" configuration for the decoder."),Vr=l(),b(so.$$.fragment),qr=l(),ae=a("h2"),je=a("a"),Tn=a("span"),b(io.$$.fragment),ks=l(),co=a("span"),$s=n("Initialising "),En=a("code"),xs=n("VisionEncoderDecoderModel"),js=n(" from a pretrained encoder and a pretrained decoder."),Pr=l(),M=a("p"),jt=a("a"),Ms=n("VisionEncoderDecoderModel"),Ds=n(" can be initialized from a pretrained encoder checkpoint and a pretrained decoder checkpoint. Note that any pretrained Transformer-based vision model, "),yn=a("em"),Vs=n("e.g."),qs=l(),Mt=a("a"),Ps=n("Swin"),zs=n(", can serve as the encoder and both pretrained auto-encoding models, "),kn=a("em"),Fs=n("e.g."),As=n(" BERT, pretrained causal language models, "),$n=a("em"),Cs=n("e.g."),Ss=n(" GPT2, as well as the pretrained decoder part of sequence-to-sequence models, "),xn=a("em"),Is=n("e.g."),Ls=n(` decoder of BART, can be used as the decoder.
...
To do so, the `),Mn=a("code"),Ws=n("VisionEncoderDecoderModel"),Hs=n(" class provides a "),Vt=a("a"),Us=n("VisionEncoderDecoderModel.from_encoder_decoder_pretrained()"),Zs=n(" method."),zr=l(),b(lo.$$.fragment),Fr=l(),se=a("h2"),De=a("a"),Dn=a("span"),b(po.$$.fragment),Ys=l(),mo=a("span"),Js=n("Loading an existing "),Vn=a("code"),Ks=n("VisionEncoderDecoderModel"),Qs=n(" checkpoint and perform inference."),Ar=l(),L=a("p"),Xs=n("To load fine-tuned checkpoints of the "),qn=a("code"),ei=n("VisionEncoderDecoderModel"),oi=n(" class, "),qt=a("a"),ti=n("VisionEncoderDecoderModel"),ni=n(" provides the "),Pn=a("code"),ri=n("from_pretrained(...)"),ai=n(" method just like any other model architecture in Transformers."),Cr=l(),Ve=a("p"),si=n("To perform inference, one uses the "),zn=a("code"),ii=n("generate"),di=n(" method, which allows to autoregressively generate text. This method supports various forms of decoding, such as greedy, beam search and multinomial sampling."),Sr=l(),b(ho.$$.fragment),Ir=l(),ie=a("h2"),qe=a("a"),Fn=a("span"),b(fo.$$.fragment),ci=l(),go=a("span"),li=n("Loading a PyTorch checkpoint into "),An=a("code"),pi=n("TFVisionEncoderDecoderModel"),mi=n("."),Lr=l(),de=a("p"),Cn=a("code"),hi=n("TFVisionEncoderDecoderModel.from_pretrained()"),fi=n(` currently doesn\u2019t support initializing the model from a
...
checkpoints for a particular vision encoder-decoder model, a workaround is:`),Nr=l(),b(uo.$$.fragment),Or=l(),ce=a("h2"),Pe=a("a"),In=a("span"),b(_o.$$.fragment),_i=l(),Ln=a("span"),vi=n("Training"),Rr=l(),N=a("p"),bi=n(`Once the model is created, it can be fine-tuned similar to BART, T5 or any other encoder-decoder model on a dataset of (image, text) pairs.
As you can see, only 2 inputs are required for the model in order to compute a loss: `),Nn=a("code"),wi=n("pixel_values"),Ti=n(` (which are the
images) and `),On=a("code"),Ei=n("labels"),yi=n(" (which are the "),Rn=a("code"),ki=n("input_ids"),$i=n(" of the encoded target sequence)."),Br=l(),b(vo.$$.fragment),Gr=l(),K=a("p"),xi=n("This model was contributed by "),bo=a("a"),ji=n("nielsr"),Mi=n(`. This model\u2019s TensorFlow and Flax versions
were contributed by `),wo=a("a"),Di=n("ydshieh"),Vi=n("."),Wr=l(),le=a("h2"),ze=a("a"),Bn=a("span"),b(To.$$.fragment),qi=l(),Gn=a("span"),Pi=n("VisionEncoderDecoderConfig"),Hr=l(),S=a("div"),b(Eo.$$.fragment),zi=l(),Fe=a("p"),Pt=a("a"),Fi=n("VisionEncoderDecoderConfig"),Ai=n(` is the configuration class to store the configuration of a
...
specified arguments, defining the encoder and decoder configs.`),Ii=l(),pe=a("p"),Li=n("Configuration objects inherit from "),Ft=a("a"),Ni=n("PretrainedConfig"),Oi=n(` and can be used to control the model outputs. Read the
...
configuration and decoder model configuration.`),Ji=l(),Se=a("div"),b($o.$$.fragment),Ki=l(),me=a("p"),Qi=n("Serializes this instance to a Python dictionary. Override the default "),Wn=a("em"),Xi=n("to_dict()"),ed=n(" from "),Hn=a("em"),od=n("PretrainedConfig"),td=n("."),Ur=l(),he=a("h2"),Ie=a("a"),Un=a("span"),b(xo.$$.fragment),nd=l(),Zn=a("span"),rd=n("VisionEncoderDecoderModel"),Zr=l(),D=a("div"),b(jo.$$.fragment),ad=l(),fe=a("p"),sd=n(`This class can be used to initialize an image-to-text-sequence model with any pretrained vision autoencoding model
...
Zhou, Wei Li, Peter J. Liu.`),gd=l(),Vo=a("p"),ud=n("Additionally, in "),qo=a("a"),_d=n(`TrOCR: Transformer-based Optical Character Recognition with Pre-trained
...
other models (see the examples for more information).`),Td=l(),Po=a("p"),Ed=n("This model inherits from "),Lt=a("a"),yd=n("PreTrainedModel"),kd=n(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),$d=l(),zo=a("p"),xd=n("This model is also a PyTorch "),Fo=a("a"),jd=n("torch.nn.Module"),Md=n(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Dd=l(),Q=a("p"),Nt=a("a"),Vd=n("VisionEncoderDecoderModel"),qd=n(` is a generic model class that will be instantiated as a transformer architecture with
...
the model, you need to first set it back in training mode with `),or=a("code"),Qd=n("model.train()"),Xd=n("."),ec=l(),b(Oe.$$.fragment),Yr=l(),_e=a("h2"),Re=a("a"),tr=a("span"),b(So.$$.fragment),oc=l(),nr=a("span"),tc=n("TFVisionEncoderDecoderModel"),Jr=l(),V=a("div"),b(Io.$$.fragment),nc=l(),ve=a("p"),rc=n(`This class can be used to initialize an image-to-text-sequence model with any pretrained vision autoencoding model
as the encoder and any pretrained text autoregressive model as the decoder. The encoder is loaded via
...
other models (see the examples for more information).`),bc=l(),Bo=a("p"),wc=n("This model inherits from "),Gt=a("a"),Tc=n("TFPreTrainedModel"),Ec=n(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),yc=l(),Go=a("p"),kc=n("This model is also a "),Wo=a("a"),$c=n("tf.keras.Model"),xc=n(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),jc=l(),X=a("p"),Wt=a("a"),Mc=n("TFVisionEncoderDecoderModel"),Dc=n(` is a generic model class that will be instantiated as a transformer architecture
with one of the base vision model classes of the library as encoder and another one of the base model classes as
decoder when created with the `),Ht=a("a"),Vc=n("from_pretrained()"),qc=n(` class method for the encoder and
`),Ut=a("a"),Pc=n("from_pretrained()"),zc=n(" class method for the decoder."),Fc=l(),B=a("div"),b(Ho.$$.fragment),Ac=l(),be=a("p"),Cc=n("The "),Zt=a("a"),Sc=n("TFVisionEncoderDecoderModel"),Ic=n(" forward method, overrides the "),ar=a("code"),Lc=n("__call__"),Nc=n(" special method."),Oc=l(),b(Be.$$.fragment),Rc=l(),b(Ge.$$.fragment),Bc=l(),ee=a("div"),b(Uo.$$.fragment),Gc=l(),sr=a("p"),Wc=n(`Instantiate an encoder and a decoder from one or two base classes of the library from pretrained model
checkpoints.`),Hc=l(),b(We.$$.fragment),Kr=l(),we=a("h2"),He=a("a"),ir=a("span"),b(Zo.$$.fragment),Uc=l(),dr=a("span"),Zc=n("FlaxVisionEncoderDecoderModel"),Qr=l(),q=a("div"),b(Yo.$$.fragment),Yc=l(),Te=a("p"),Jc=n(`This class can be used to initialize an image-to-text-sequence model with any pretrained vision autoencoding model
as the encoder and any pretrained text autoregressive model as the decoder. The encoder is loaded via
...
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),bl=l(),oe=a("p"),Qt=a("a"),wl=n("FlaxVisionEncoderDecoderModel"),Tl=n(` is a generic model class that will be instantiated as a transformer architecture
with the module (flax.nn.Module) of one of the base vision model classes of the library as encoder module and
another one as decoder module when created with the :meth`),lr=a("em"),El=n("~transformers.FlaxAutoModel.from_pretrained"),yl=n(` class method
for the encoder and :meth`),pr=a("em"),kl=n("~transformers.FlaxAutoModelForCausalLM.from_pretrained"),$l=n(" class method for the decoder."),xl=l(),G=a("div"),b(nt.$$.fragment),jl=l(),Ee=a("p"),Ml=n("The "),Xt=a("a"),Dl=n("FlaxVisionEncoderDecoderModel"),Vl=n(" forward method, overrides the "),mr=a("code"),ql=n("__call__"),Pl=n(" special method."),zl=l(),b(Ue.$$.fragment),Fl=l(),b(Ze.$$.fragment),Al=l(),te=a("div"),b(rt.$$.fragment),Cl=l(),hr=a("p"),Sl=n(`Instantiate an encoder and a decoder from one or two base classes of the library from pretrained model
checkpoints.`),Il=l(),b(Ye.$$.fragment),this.h()},l(o){const m=Ym('[data-svelte="svelte-1phssyn"]',document.head);h=s(m,"META",{name:!0,content:!0}),m.forEach(t),$=p(o),_=s(o,"H1",{class:!0});var at=i(_);f=s(at,"A",{id:!0,class:!0,href:!0});var fr=i(f);v=s(fr,"SPAN",{});var gr=i(v);w(d.$$.fragment,gr),gr.forEach(t),fr.forEach(t),u=p(at),I=s(at,"SPAN",{});var ur=i(I);qa=r(ur,"Vision Encoder Decoder Models"),ur.forEach(t),at.forEach(t),yr=p(o),ne=s(o,"H2",{class:!0});var st=i(ne);ye=s(st,"A",{id:!0,class:!0,href:!0});var _r=i(ye);fn=s(_r,"SPAN",{});var vr=i(fn);w(to.$$.fragment,vr),vr.forEach(t),_r.forEach(t),Pa=p(st),gn=s(st,"SPAN",{});var br=i(gn);za=r(br,"Overview"),br.forEach(t),st.forEach(t),kr=p(o),x=s(o,"P",{});var j=i(x);Fa=r(j,"The "),ht=s(j,"A",{href:!0});var wr=i(ht);Aa=r(wr,"VisionEncoderDecoderModel"),wr.forEach(t),Ca=r(j,` can be used to initialize an image-to-text model with any
...
Zhoujun Li, Furu Wei.`),ea.forEach(t),xr=p(o),$e=s(o,"P",{});var oa=i($e);ss=r(oa,"After such a "),Et=s(oa,"A",{href:!0});var Ql=i(Et);is=r(Ql,"VisionEncoderDecoderModel"),Ql.forEach(t),ds=r(oa,` has been trained/fine-tuned, it can be saved/loaded just like any other models (see the examples below
...
checkpoints for a particular vision encoder-decoder model, a workaround is:`),Tr.forEach(t),Nr=p(o),w(uo.$$.fragment,o),Or=p(o),ce=s(o,"H2",{class:!0});var pa=i(ce);Pe=s(pa,"A",{id:!0,class:!0,href:!0});var Pp=i(Pe);In=s(Pp,"SPAN",{});var zp=i(In);w(_o.$$.fragment,zp),zp.forEach(t),Pp.forEach(t),_i=p(pa),Ln=s(pa,"SPAN",{});var Fp=i(Ln);vi=r(Fp,"Training"),Fp.forEach(t),pa.forEach(t),Rr=p(o),N=s(o,"P",{});var Ke=i(N);bi=r(Ke,`Once the model is created, it can be fine-tuned similar to BART, T5 or any other encoder-decoder model on a dataset of (image, text) pairs.
As you can see, only 2 inputs are required for the model in order to compute a loss: `),Nn=s(Ke,"CODE",{});var Ap=i(Nn);wi=r(Ap,"pixel_values"),Ap.forEach(t),Ti=r(Ke,` (which are the
images) and `),On=s(Ke,"CODE",{});var Cp=i(On);Ei=r(Cp,"labels"),Cp.forEach(t),yi=r(Ke," (which are the "),Rn=s(Ke,"CODE",{});var Sp=i(Rn);ki=r(Sp,"input_ids"),Sp.forEach(t),$i=r(Ke," of the encoded target sequence)."),Ke.forEach(t),Br=p(o),w(vo.$$.fragment,o),Gr=p(o),K=s(o,"P",{});var on=i(K);xi=r(on,"This model was contributed by "),bo=s(on,"A",{href:!0,rel:!0});var Ip=i(bo);ji=r(Ip,"nielsr"),Ip.forEach(t),Mi=r(on,`. This model\u2019s TensorFlow and Flax versions
were contributed by `),wo=s(on,"A",{href:!0,rel:!0});var Lp=i(wo);Di=r(Lp,"ydshieh"),Lp.forEach(t),Vi=r(on,"."),on.forEach(t),Wr=p(o),le=s(o,"H2",{class:!0});var ma=i(le);ze=s(ma,"A",{id:!0,class:!0,href:!0});var Np=i(ze);Bn=s(Np,"SPAN",{});var Op=i(Bn);w(To.$$.fragment,Op),Op.forEach(t),Np.forEach(t),qi=p(ma),Gn=s(ma,"SPAN",{});var Rp=i(Gn);Pi=r(Rp,"VisionEncoderDecoderConfig"),Rp.forEach(t),ma.forEach(t),Hr=p(o),S=s(o,"DIV",{class:!0});var W=i(S);w(Eo.$$.fragment,W),zi=p(W),Fe=s(W,"P",{});var Er=i(Fe);Pt=s(Er,"A",{href:!0});var Bp=i(Pt);Fi=r(Bp,"VisionEncoderDecoderConfig"),Bp.forEach(t),Ai=r(Er,` is the configuration class to store the configuration of a
`),zt=s(Er,"A",{href:!0});var Gp=i(zt);Ci=r(Gp,"VisionEncoderDecoderModel"),Gp.forEach(t),Si=r(Er,`. It is used to instantiate a Vision-Encoder-Text-Decoder model according to the
specified arguments, defining the encoder and decoder configs.`),Er.forEach(t),Ii=p(W),pe=s(W,"P",{});var tn=i(pe);Li=r(tn,"Configuration objects inherit from "),Ft=s(tn,"A",{href:!0});var Wp=i(Ft);Ni=r(Wp,"PretrainedConfig"),Wp.forEach(t),Oi=r(tn,` and can be used to control the model outputs. Read the
...
other models (see the examples for more information).`),nm.forEach(t),Td=p(F),Po=s(F,"P",{});var ba=i(Po);Ed=r(ba,"This model inherits from "),Lt=s(ba,"A",{href:!0});var rm=i(Lt);yd=r(rm,"PreTrainedModel"),rm.forEach(t),kd=r(ba,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
:meth`),Kn=s(dt,"EM",{});var dm=i(Kn);Fd=r(dm,"~transformers.AutoModelForCausalLM.from_pretrained"),dm.forEach(t),Ad=r(dt," class method for the decoder."),dt.forEach(t),Cd=p(F),O=s(F,"DIV",{class:!0});var Qe=i(O);w(Ao.$$.fragment,Qe),Sd=p(Qe),ge=s(Qe,"P",{});var an=i(ge);Id=r(an,"The "),Ot=s(an,"A",{href:!0});var cm=i(Ot);Ld=r(cm,"VisionEncoderDecoderModel"),cm.forEach(t),Nd=r(an," forward method, overrides the "),Qn=s(an,"CODE",{});var lm=i(Qn);Od=r(lm,"__call__"),lm.forEach(t),Rd=r(an," special method."),an.forEach(t),Bd=p(Qe),w(Le.$$.fragment,Qe),Gd=p(Qe),w(Ne.$$.fragment,Qe),Qe.forEach(t),Wd=p(F),R=s(F,"DIV",{class:!0});var Xe=i(R);w(Co.$$.fragment,Xe),Hd=p(Xe),Xn=s(Xe,"P",{});var pm=i(Xn);Ud=r(pm,`Instantiate an encoder and a decoder from one or two base classes of the library from pretrained model
...
the model, you need to first set it back in training mode with `),or=s(sn,"CODE",{});var hm=i(or);Qd=r(hm,"model.train()"),hm.forEach(t),Xd=r(sn,"."),sn.forEach(t),ec=p(Xe),w(Oe.$$.fragment,Xe),Xe.forEach(t),F.forEach(t),Yr=p(o),_e=s(o,"H2",{class:!0});var Ta=i(_e);Re=s(Ta,"A",{id:!0,class:!0,href:!0});var fm=i(Re);tr=s(fm,"SPAN",{});var gm=i(tr);w(So.$$.fragment,gm),gm.forEach(t),fm.forEach(t),oc=p(Ta),nr=s(Ta,"SPAN",{});var um=i(nr);tc=r(um,"TFVisionEncoderDecoderModel"),um.forEach(t),Ta.forEach(t),Jr=p(o),V=s(o,"DIV",{class:!0});var A=i(V);w(Io.$$.fragment,A),nc=p(A),ve=s(A,"P",{});var dn=i(ve);rc=r(dn,`This class can be used to initialize an image-to-text-sequence model with any pretrained vision autoencoding model
as the encoder and any pretrained text autoregressive model as the decoder. The encoder is loaded via
...
function. Cross-attention layers are automatically added to the decoder and should be fine-tuned on a downstream
generative task, like image captioning.`),dn.forEach(t),cc=p(A),Lo=s(A,"P",{});var Ea=i(Lo);lc=r(Ea,`The effectiveness of initializing sequence-to-sequence models with pretrained checkpoints for sequence generation
tasks was shown in `),No=s(Ea,"A",{href:!0,rel:!0});var bm=i(No);pc=r(bm,`Leveraging Pre-trained Checkpoints for Sequence Generation
Tasks`),bm.forEach(t),mc=r(Ea,` by Sascha Rothe, Shashi Narayan, Aliaksei Severyn. Michael Matena, Yanqi
Zhou, Wei Li, Peter J. Liu.`),Ea.forEach(t),hc=p(A),Oo=s(A,"P",{});var ya=i(Oo);fc=r(ya,"Additionally, in "),Ro=s(ya,"A",{href:!0,rel:!0});var wm=i(Ro);gc=r(wm,`TrOCR: Transformer-based Optical Character Recognition with Pre-trained
Models`),wm.forEach(t),uc=r(ya,` it is shown how leveraging large pretrained vision models for optical
character recognition (OCR) yields a significant performance improvement.`),ya.forEach(t),_c=p(A),rr=s(A,"P",{});var Tm=i(rr);vc=r(Tm,`After such a Vision-Encoder-Text-Decoder model has been trained/fine-tuned, it can be saved/loaded just like any
other models (see the examples for more information).`),Tm.forEach(t),bc=p(A),Bo=s(A,"P",{});var ka=i(Bo);wc=r(ka,"This model inherits from "),Gt=s(ka,"A",{href:!0});var Em=i(Gt);Tc=r(Em,"TFPreTrainedModel"),Em.forEach(t),Ec=r(ka,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),ka.forEach(t),yc=p(A),Go=s(A,"P",{});var $a=i(Go);kc=r($a,"This model is also a "),Wo=s($a,"A",{href:!0,rel:!0});var ym=i(Wo);$c=r(ym,"tf.keras.Model"),ym.forEach(t),xc=r($a,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),$a.forEach(t),jc=p(A),X=s(A,"P",{});var ct=i(X);Wt=s(ct,"A",{href:!0});var km=i(Wt);Mc=r(km,"TFVisionEncoderDecoderModel"),km.forEach(t),Dc=r(ct,` is a generic model class that will be instantiated as a transformer architecture
with one of the base vision model classes of the library as encoder and another one of the base model classes as
decoder when created with the `),Ht=s(ct,"A",{href:!0});var $m=i(Ht);Vc=r($m,"from_pretrained()"),$m.forEach(t),qc=r(ct,` class method for the encoder and
`),Ut=s(ct,"A",{href:!0});var xm=i(Ut);Pc=r(xm,"from_pretrained()"),xm.forEach(t),zc=r(ct," class method for the decoder."),ct.forEach(t),Fc=p(A),B=s(A,"DIV",{class:!0});var eo=i(B);w(Ho.$$.fragment,eo),Ac=p(eo),be=s(eo,"P",{});var cn=i(be);Cc=r(cn,"The "),Zt=s(cn,"A",{href:!0});var jm=i(Zt);Sc=r(jm,"TFVisionEncoderDecoderModel"),jm.forEach(t),Ic=r(cn," forward method, overrides the "),ar=s(cn,"CODE",{});var Mm=i(ar);Lc=r(Mm,"__call__"),Mm.forEach(t),Nc=r(cn," special method."),cn.forEach(t),Oc=p(eo),w(Be.$$.fragment,eo),Rc=p(eo),w(Ge.$$.fragment,eo),eo.forEach(t),Bc=p(A),ee=s(A,"DIV",{class:!0});var ln=i(ee);w(Uo.$$.fragment,ln),Gc=p(ln),sr=s(ln,"P",{});var Dm=i(sr);Wc=r(Dm,`Instantiate an encoder and a decoder from one or two base classes of the library from pretrained model
checkpoints.`),Dm.forEach(t),Hc=p(ln),w(We.$$.fragment,ln),ln.forEach(t),A.forEach(t),Kr=p(o),we=s(o,"H2",{class:!0});var xa=i(we);He=s(xa,"A",{id:!0,class:!0,href:!0});var Vm=i(He);ir=s(Vm,"SPAN",{});var qm=i(ir);w(Zo.$$.fragment,qm),qm.forEach(t),Vm.forEach(t),Uc=p(xa),dr=s(xa,"SPAN",{});var Pm=i(dr);Zc=r(Pm,"FlaxVisionEncoderDecoderModel"),Pm.forEach(t),xa.forEach(t),Qr=p(o),q=s(o,"DIV",{class:!0});var C=i(q);w(Yo.$$.fragment,C),Yc=p(C),Te=s(C,"P",{});var pn=i(Te);Jc=r(pn,`This class can be used to initialize an image-to-text-sequence model with any pretrained vision autoencoding model
as the encoder and any pretrained text autoregressive model as the decoder. The encoder is loaded via
`),Yt=s(pn,"A",{href:!0});var zm=i(Yt);Kc=r(zm,"from_pretrained()"),zm.forEach(t),Qc=r(pn," function and the decoder is loaded via "),Jt=s(pn,"A",{href:!0});var Fm=i(Jt);Xc=r(Fm,"from_pretrained()"),Fm.forEach(t),el=r(pn,`
function. Cross-attention layers are automatically added to the decoder and should be fine-tuned on a downstream
...
other models (see the examples for more information).`),Sm.forEach(t),pl=p(C),et=s(C,"P",{});var Da=i(et);ml=r(Da,"This model inherits from "),Kt=s(Da,"A",{href:!0});var Im=i(Kt);hl=r(Im,"FlaxPreTrainedModel"),Im.forEach(t),fl=r(Da,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Da.forEach(t),gl=p(C),ot=s(C,"P",{});var Va=i(ot);ul=r(Va,`This model is also a Flax Linen
`),tt=s(Va,"A",{href:!0,rel:!0});var Lm=i(tt);_l=r(Lm,"flax.nn.Module"),Lm.forEach(t),vl=r(Va,` subclass. Use it as a
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),Va.forEach(t),bl=p(C),oe=s(C,"P",{});var lt=i(oe);Qt=s(lt,"A",{href:!0});var Nm=i(Qt);wl=r(Nm,"FlaxVisionEncoderDecoderModel"),Nm.forEach(t),Tl=r(lt,` is a generic model class that will be instantiated as a transformer architecture
with the module (flax.nn.Module) of one of the base vision model classes of the library as encoder module and
another one as decoder module when created with the :meth`),lr=s(lt,"EM",{});var Om=i(lr);El=r(Om,"~transformers.FlaxAutoModel.from_pretrained"),Om.forEach(t),yl=r(lt,` class method
for the encoder and :meth`),pr=s(lt,"EM",{});var Rm=i(pr);kl=r(Rm,"~transformers.FlaxAutoModelForCausalLM.from_pretrained"),Rm.forEach(t),$l=r(lt," class method for the decoder."),lt.forEach(t),xl=p(C),G=s(C,"DIV",{class:!0});var oo=i(G);w(nt.$$.fragment,oo),jl=p(oo),Ee=s(oo,"P",{});var mn=i(Ee);Ml=r(mn,"The "),Xt=s(mn,"A",{href:!0});var Bm=i(Xt);Dl=r(Bm,"FlaxVisionEncoderDecoderModel"),Bm.forEach(t),Vl=r(mn," forward method, overrides the "),mr=s(mn,"CODE",{});var Gm=i(mr);ql=r(Gm,"__call__"),Gm.forEach(t),Pl=r(mn," special method."),mn.forEach(t),zl=p(oo),w(Ue.$$.fragment,oo),Fl=p(oo),w(Ze.$$.fragment,oo),oo.forEach(t),Al=p(C),te=s(C,"DIV",{class:!0});var hn=i(te);w(rt.$$.fragment,hn),Cl=p(hn),hr=s(hn,"P",{});var Wm=i(hr);Sl=r(Wm,`Instantiate an encoder and a decoder from one or two base classes of the library from pretrained model
checkpoints.`),Wm.forEach(t),Il=p(hn),w(Ye.$$.fragment,hn),hn.forEach(t),C.forEach(t),this.h()},h(){c(h,"name","hf:doc:metadata"),c(h,"content",JSON.stringify(dh)),c(f,"id","vision-encoder-decoder-models"),c(f,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(f,"href","#vision-encoder-decoder-models"),c(_,"class","relative group"),c(ye,"id","overview"),c(ye,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(ye,"href","#overview"),c(ne,"class","relative group"),c(ht,"href","/docs/transformers/main/en/model_doc/vision-encoder-decoder#transformers.VisionEncoderDecoderModel"),c(ft,"href","vit"),c(gt,"href","beit"),c(ut,"href","deit"),c(_t,"href","swin"),c(vt,"href","roberta"),c(bt,"href","gpt2"),c(wt,"href","bert"),c(Tt,"href","distilbert"),c(no,"href","https://arxiv.org/abs/2109.10282"),c(no,"rel","nofollow"),c(Et,"href","/docs/transformers/main/en/model_doc/vision-encoder-decoder#transformers.VisionEncoderDecoderModel"),c(yt,"href","trocr"),c(kt,"href","/docs/transformers/main/en/model_doc/vision-encoder-decoder#transformers.VisionEncoderDecoderModel"),c(xe,"id","randomly-initializing-visionencoderdecodermodel-from-model-configurations"),c(xe,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(xe,"href","#randomly-initializing-visionencoderdecodermodel-from-model-configurations"),c(re,"class","relative group"),c($t,"href","/docs/transformers/main/en/model_doc/vision-encoder-decoder#transformers.VisionEncoderDecoderModel"),c(xt,"href","/docs/transformers/main/en/model_doc/vit#transformers.ViTModel"),c(je,"id","initialising-visionencoderdecodermodel-from-a-pretrained-encoder-and-a-pretrained-decoder"),c(je,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(je,"href","#initialising-visionencoderdecodermodel-from-a-pretrained-encoder-and-a-pretrained-decoder"),c(ae,"class","relative group"),c(jt,"href","/docs/transformers/main/en/model_doc/vision-encoder-decoder#transformers.VisionEncoderDecoderModel"),c(Mt,"href","swin"),c(Dt,"href","/docs/transformers/main/en/model_doc/vision-encoder-decoder#transformers.VisionEncoderDecoderModel"),c(Me,"href","https://huggingface.co/blog/warm-starting-encoder-decoder"),c(Me,"rel","nofollow"),c(Vt,"href","/docs/transformers/main/en/model_doc/vision-encoder-decoder#transformers.VisionEncoderDecoderModel.from_encoder_decoder_pretrained"),c(De,"id","loading-an-existing-visionencoderdecodermodel-checkpoint-and-perform-inference"),c(De,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(De,"href","#loading-an-existing-visionencoderdecodermodel-checkpoint-and-perform-inference"),c(se,"class","relative group"),c(qt,"href","/docs/transformers/main/en/model_doc/vision-encoder-decoder#transformers.VisionEncoderDecoderModel"),c(qe,"id","loading-a-pytorch-checkpoint-into-tfvisionencoderdecodermodel"),c(qe,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(qe,"href","#loading-a-pytorch-checkpoint-into-tfvisionencoderdecodermodel"),c(ie,"class","relative group"),c(Pe,"id","training"),c(Pe,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(Pe,"href","#training"),c(ce,"class","relative group"),c(bo,"href","https://github.com/nielsrogge"),c(bo,"rel","nofollow"),c(wo,"href","https://github.com/ydshieh"),c(wo,"rel","nofollow"),c(ze,"id","transformers.VisionEncoderDecoderConfig"),c(ze,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(ze,"href","#transformers.VisionEncoderDecoderConfig"),c(le,"class","relative group"),c(Pt,"href","/docs/transformers/main/en/model_doc/vision-encoder-decoder#transformers.VisionEncoderDecoderConfig"),c(zt,"href","/docs/transformers/main/en/model_doc/vision-encoder-decoder#transformers.VisionEncoderDecoderModel"),c(Ft,"href","/docs/transformers/main/en/main_classes/configuration#transformers.PretrainedConfig"),c(At,"href","/docs/transformers/main/en/main_classes/configuration#transformers.PretrainedConfig"),c(Ct,"href","/docs/transformers/main/en/model_doc/vision-encoder-decoder#transformers.VisionEncoderDecoderConfig"),c(Ce,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),c(Se,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),c(S,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),c(Ie,"id","transformers.VisionEncoderDecoderModel"),c(Ie,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(Ie,"href","#transformers.VisionEncoderDecoderModel"),c(he,"class","relative group"),c(St,"href","/docs/transformers/main/en/model_doc/auto#transformers.FlaxAutoModelForVision2Seq.from_pretrained"),c(It,"href","/docs/transformers/main/en/model_doc/auto#transformers.FlaxAutoModelForVision2Seq.from_pretrained"),c(Do,"href","https://arxiv.org/abs/1907.12461"),c(Do,"rel","nofollow"),c(qo,"href","https://arxiv.org/abs/2109.10282"),c(qo,"rel","nofollow"),c(Lt,"href","/docs/transformers/main/en/main_classes/model#transformers.PreTrainedModel"),c(Fo,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),c(Fo,"rel","nofollow"),c(Nt,"href","/docs/transformers/main/en/model_doc/vision-encoder-decoder#transformers.VisionEncoderDecoderModel"),c(Ot,"href","/docs/transformers/main/en/model_doc/vision-encoder-decoder#transformers.VisionEncoderDecoderModel"),c(O,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),c(R,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),c(D,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),c(Re,"id","transformers.TFVisionEncoderDecoderModel"),c(Re,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(Re,"href","#transformers.TFVisionEncoderDecoderModel"),c(_e,"class","relative group"),c(Rt,"href","/docs/transformers/main/en/model_doc/auto#transformers.FlaxAutoModelForVision2Seq.from_pretrained"),c(Bt,"href","/docs/transformers/main/en/model_doc/auto#transformers.FlaxAutoModelForVision2Seq.from_pretrained"),c(No,"href","https://arxiv.org/abs/1907.12461"),c(No,"rel","nofollow"),c(Ro,"href","https://arxiv.org/abs/2109.10282"),c(Ro,"rel","nofollow"),c(Gt,"href","/docs/transformers/main/en/main_classes/model#transformers.TFPreTrainedModel"),c(Wo,"href","https://www.tensorflow.org/api_docs/python/tf/keras/Model"),c(Wo,"rel","nofollow"),c(Wt,"href","/docs/transformers/main/en/model_doc/vision-encoder-decoder#transformers.TFVisionEncoderDecoderModel"),c(Ht,"href","/docs/transformers/main/en/model_doc/auto#transformers.FlaxAutoModelForVision2Seq.from_pretrained"),c(Ut,"href","/docs/transformers/main/en/model_doc/auto#transformers.FlaxAutoModelForVision2Seq.from_pretrained"),c(Zt,"href","/docs/transformers/main/en/model_doc/vision-encoder-decoder#transformers.TFVisionEncoderDecoderModel"),c(B,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),c(ee,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),c(V,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),c(He,"id","transformers.FlaxVisionEncoderDecoderModel"),c(He,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(He,"href","#transformers.FlaxVisionEncoderDecoderModel"),c(we,"class","relative group"),c(Yt,"href","/docs/transformers/main/en/model_doc/auto#transformers.FlaxAutoModelForVision2Seq.from_pretrained"),c(Jt,"href","/docs/transformers/main/en/model_doc/auto#transformers.FlaxAutoModelForVision2Seq.from_pretrained"),c(Ko,"href","https://arxiv.org/abs/1907.12461"),c(Ko,"rel","nofollow"),c(Xo,"href","https://arxiv.org/abs/2109.10282"),c(Xo,"rel","nofollow"),c(Kt,"href","/docs/transformers/main/en/main_classes/model#transformers.FlaxPreTrainedModel"),c(tt,"href","https://flax.readthedocs.io/en/latest/_autosummary/flax.nn.module.html"),c(tt,"rel","nofollow"),c(Qt,"href","/docs/transformers/main/en/model_doc/vision-encoder-decoder#transformers.FlaxVisionEncoderDecoderModel"),c(Xt,"href","/docs/transformers/main/en/model_doc/vision-encoder-decoder#transformers.FlaxVisionEncoderDecoderModel"),c(G,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),c(te,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),c(q,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8")},m(o,m){e(document.head,h),g(o,$,m),g(o,_,m),e(_,f),e(f,v),T(d,v,null),e(_,u),e(_,I),e(I,qa),g(o,yr,m),g(o,ne,m),e(ne,ye),e(ye,fn),T(to,fn,null),e(ne,Pa),e(ne,gn),e(gn,za),g(o,kr,m),g(o,x,m),e(x,Fa),e(x,ht),e(ht,Aa),e(x,Ca),e(x,un),e(un,Sa),e(x,Ia),e(x,ft),e(ft,La),e(x,Na),e(x,gt),e(gt,Oa),e(x,Ra),e(x,ut),e(ut,Ba),e(x,Ga),e(x,_t),e(_t,Wa),e(x,Ha),e(x,_n),e(_n,Ua),e(x,Za),e(x,vt),e(vt,Ya),e(x,Ja),e(x,bt),e(bt,Ka),e(x,Qa),e(x,wt),e(wt,Xa),e(x,es),e(x,Tt),e(Tt,os),e(x,ts),g(o,$r,m),g(o,ke,m),e(ke,ns),e(ke,no),e(no,rs),e(ke,as),g(o,xr,m),g(o,$e,m),e($e,ss),e($e,Et),e(Et,is),e($e,ds),g(o,jr,m),g(o,J,m),e(J,cs),e(J,yt),e(yt,ls),e(J,ps),e(J,kt),e(kt,ms),e(J,hs),g(o,Mr,m),g(o,re,m),e(re,xe),e(xe,vn),T(ro,vn,null),e(re,fs),e(re,ao),e(ao,gs),e(ao,bn),e(bn,us),e(ao,_s),g(o,Dr,m),g(o,Z,m),e(Z,$t),e($t,vs),e(Z,bs),e(Z,xt),e(xt,ws),e(Z,Ts),e(Z,wn),e(wn,Es),e(Z,ys),g(o,Vr,m),T(so,o,m),g(o,qr,m),g(o,ae,m),e(ae,je),e(je,Tn),T(io,Tn,null),e(ae,ks),e(ae,co),e(co,$s),e(co,En),e(En,xs),e(co,js),g(o,Pr,m),g(o,M,m),e(M,jt),e(jt,Ms),e(M,Ds),e(M,yn),e(yn,Vs),e(M,qs),e(M,Mt),e(Mt,Ps),e(M,zs),e(M,kn),e(kn,Fs),e(M,As),e(M,$n),e($n,Cs),e(M,Ss),e(M,xn),e(xn,Is),e(M,Ls),e(M,Dt),e(Dt,Ns),e(M,Os),e(M,Me),e(Me,Rs),e(Me,jn),e(jn,Bs),e(M,Gs),e(M,Mn),e(Mn,Ws),e(M,Hs),e(M,Vt),e(Vt,Us),e(M,Zs),g(o,zr,m),T(lo,o,m),g(o,Fr,m),g(o,se,m),e(se,De),e(De,Dn),T(po,Dn,null),e(se,Ys),e(se,mo),e(mo,Js),e(mo,Vn),e(Vn,Ks),e(mo,Qs),g(o,Ar,m),g(o,L,m),e(L,Xs),e(L,qn),e(qn,ei),e(L,oi),e(L,qt),e(qt,ti),e(L,ni),e(L,Pn),e(Pn,ri),e(L,ai),g(o,Cr,m),g(o,Ve,m),e(Ve,si),e(Ve,zn),e(zn,ii),e(Ve,di),g(o,Sr,m),T(ho,o,m),g(o,Ir,m),g(o,ie,m),e(ie,qe),e(qe,Fn),T(fo,Fn,null),e(ie,ci),e(ie,go),e(go,li),e(go,An),e(An,pi),e(go,mi),g(o,Lr,m),g(o,de,m),e(de,Cn),e(Cn,hi),e(de,fi),e(de,Sn),e(Sn,gi),e(de,ui),g(o,Nr,m),T(uo,o,m),g(o,Or,m),g(o,ce,m),e(ce,Pe),e(Pe,In),T(_o,In,null),e(ce,_i),e(ce,Ln),e(Ln,vi),g(o,Rr,m),g(o,N,m),e(N,bi),e(N,Nn),e(Nn,wi),e(N,Ti),e(N,On),e(On,Ei),e(N,yi),e(N,Rn),e(Rn,ki),e(N,$i),g(o,Br,m),T(vo,o,m),g(o,Gr,m),g(o,K,m),e(K,xi),e(K,bo),e(bo,ji),e(K,Mi),e(K,wo),e(wo,Di),e(K,Vi),g(o,Wr,m),g(o,le,m),e(le,ze),e(ze,Bn),T(To,Bn,null),e(le,qi),e(le,Gn),e(Gn,Pi),g(o,Hr,m),g(o,S,m),T(Eo,S,null),e(S,zi),e(S,Fe),e(Fe,Pt),e(Pt,Fi),e(Fe,Ai),e(Fe,zt),e(zt,Ci),e(Fe,Si),e(S,Ii),e(S,pe),e(pe,Li),e(pe,Ft),e(Ft,Ni),e(pe,Oi),e(pe,At),e(At,Ri),e(pe,Bi),e(S,Gi),T(Ae,S,null),e(S,Wi),e(S,Ce),T(yo,Ce,null),e(Ce,Hi),e(Ce,ko),e(ko,Ui),e(ko,Ct),e(Ct,Zi),e(ko,Yi),e(S,Ji),e(S,Se),T($o,Se,null),e(Se,Ki),e(Se,me),e(me,Qi),e(me,Wn),e(Wn,Xi),e(me,ed),e(me,Hn),e(Hn,od),e(me,td),g(o,Ur,m),g(o,he,m),e(he,Ie),e(Ie,Un),T(xo,Un,null),e(he,nd),e(he,Zn),e(Zn,rd),g(o,Zr,m),g(o,D,m),T(jo,D,null),e(D,ad),e(D,fe),e(fe,sd),e(fe,St),e(St,id),e(fe,dd),e(fe,It),e(It,cd),e(fe,ld),e(D,pd),e(D,Mo),e(Mo,md),e(Mo,Do),e(Do,hd),e(Mo,fd),e(D,gd),e(D,Vo),e(Vo,ud),e(Vo,qo),e(qo,_d),e(Vo,vd),e(D,bd),e(D,Yn),e(Yn,wd),e(D,Td),e(D,Po),e(Po,Ed),e(Po,Lt),e(Lt,yd),e(Po,kd),e(D,$d),e(D,zo),e(zo,xd),e(zo,Fo),e(Fo,jd),e(zo,Md),e(D,Dd),e(D,Q),e(Q,Nt),e(Nt,Vd),e(Q,qd),e(Q,Jn),e(Jn,Pd),e(Q,zd),e(Q,Kn),e(Kn,Fd),e(Q,Ad),e(D,Cd),e(D,O),T(Ao,O,null),e(O,Sd),e(O,ge),e(ge,Id),e(ge,Ot),e(Ot,Ld),e(ge,Nd),e(ge,Qn),e(Qn,Od),e(ge,Rd),e(O,Bd),T(Le,O,null),e(O,Gd),T(Ne,O,null),e(D,Wd),e(D,R),T(Co,R,null),e(R,Hd),e(R,Xn),e(Xn,Ud),e(R,Zd),e(R,ue),e(ue,Yd),e(ue,er),e(er,Jd),e(ue,Kd),e(ue,or),e(or,Qd),e(ue,Xd),e(R,ec),T(Oe,R,null),g(o,Yr,m),g(o,_e,m),e(_e,Re),e(Re,tr),T(So,tr,null),e(_e,oc),e(_e,nr),e(nr,tc),g(o,Jr,m),g(o,V,m),T(Io,V,null),e(V,nc),e(V,ve),e(ve,rc),e(ve,Rt),e(Rt,ac),e(ve,sc),e(ve,Bt),e(Bt,ic),e(ve,dc),e(V,cc),e(V,Lo),e(Lo,lc),e(Lo,No),e(No,pc),e(Lo,mc),e(V,hc),e(V,Oo),e(Oo,fc),e(Oo,Ro),e(Ro,gc),e(Oo,uc),e(V,_c),e(V,rr),e(rr,vc),e(V,bc),e(V,Bo),e(Bo,wc),e(Bo,Gt),e(Gt,Tc),e(Bo,Ec),e(V,yc),e(V,Go),e(Go,kc),e(Go,Wo),e(Wo,$c),e(Go,xc),e(V,jc),e(V,X),e(X,Wt),e(Wt,Mc),e(X,Dc),e(X,Ht),e(Ht,Vc),e(X,qc),e(X,Ut),e(Ut,Pc),e(X,zc),e(V,Fc),e(V,B),T(Ho,B,null),e(B,Ac),e(B,be),e(be,Cc),e(be,Zt),e(Zt,Sc),e(be,Ic),e(be,ar),e(ar,Lc),e(be,Nc),e(B,Oc),T(Be,B,null),e(B,Rc),T(Ge,B,null),e(V,Bc),e(V,ee),T(Uo,ee,null),e(ee,Gc),e(ee,sr),e(sr,Wc),e(ee,Hc),T(We,ee,null),g(o,Kr,m),g(o,we,m),e(we,He),e(He,ir),T(Zo,ir,null),e(we,Uc),e(we,dr),e(dr,Zc),g(o,Qr,m),g(o,q,m),T(Yo,q,null),e(q,Yc),e(q,Te),e(Te,Jc),e(Te,Yt),e(Yt,Kc),e(Te,Qc),e(Te,Jt),e(Jt,Xc),e(Te,el),e(q,ol),e(q,Jo),e(Jo,tl),e(Jo,Ko),e(Ko,nl),e(Jo,rl),e(q,al),e(q,Qo),e(Qo,sl),e(Qo,Xo),e(Xo,il),e(Qo,dl),e(q,cl),e(q,cr),e(cr,ll),e(q,pl),e(q,et),e(et,ml),e(et,Kt),e(Kt,hl),e(et,fl),e(q,gl),e(q,ot),e(ot,ul),e(ot,tt),e(tt,_l),e(ot,vl),e(q,bl),e(q,oe),e(oe,Qt),e(Qt,wl),e(oe,Tl),e(oe,lr),e(lr,El),e(oe,yl),e(oe,pr),e(pr,kl),e(oe,$l),e(q,xl),e(q,G),T(nt,G,null),e(G,jl),e(G,Ee),e(Ee,Ml),e(Ee,Xt),e(Xt,Dl),e(Ee,Vl),e(Ee,mr),e(mr,ql),e(Ee,Pl),e(G,zl),T(Ue,G,null),e(G,Fl),T(Ze,G,null),e(q,Al),e(q,te),T(rt,te,null),e(te,Cl),e(te,hr),e(hr,Sl),e(te,Il),T(Ye,te,null),Xr=!0},p(o,[m]){const at={};m&2&&(at.$$scope={dirty:m,ctx:o}),Ae.$set(at);const fr={};m&2&&(fr.$$scope={dirty:m,ctx:o}),Le.$set(fr);const gr={};m&2&&(gr.$$scope={dirty:m,ctx:o}),Ne.$set(gr);const ur={};m&2&&(ur.$$scope={dirty:m,ctx:o}),Oe.$set(ur);const st={};m&2&&(st.$$scope={dirty:m,ctx:o}),Be.$set(st);const _r={};m&2&&(_r.$$scope={dirty:m,ctx:o}),Ge.$set(_r);const vr={};m&2&&(vr.$$scope={dirty:m,ctx:o}),We.$set(vr);const br={};m&2&&(br.$$scope={dirty:m,ctx:o}),Ue.$set(br);const j={};m&2&&(j.$$scope={dirty:m,ctx:o}),Ze.$set(j);const wr={};m&2&&(wr.$$scope={dirty:m,ctx:o}),Ye.$set(wr)},i(o){Xr||(E(d.$$.fragment,o),E(to.$$.fragment,o),E(ro.$$.fragment,o),E(so.$$.fragment,o),E(io.$$.fragment,o),E(lo.$$.fragment,o),E(po.$$.fragment,o),E(ho.$$.fragment,o),E(fo.$$.fragment,o),E(uo.$$.fragment,o),E(_o.$$.fragment,o),E(vo.$$.fragment,o),E(To.$$.fragment,o),E(Eo.$$.fragment,o),E(Ae.$$.fragment,o),E(yo.$$.fragment,o),E($o.$$.fragment,o),E(xo.$$.fragment,o),E(jo.$$.fragment,o),E(Ao.$$.fragment,o),E(Le.$$.fragment,o),E(Ne.$$.fragment,o),E(Co.$$.fragment,o),E(Oe.$$.fragment,o),E(So.$$.fragment,o),E(Io.$$.fragment,o),E(Ho.$$.fragment,o),E(Be.$$.fragment,o),E(Ge.$$.fragment,o),E(Uo.$$.fragment,o),E(We.$$.fragment,o),E(Zo.$$.fragment,o),E(Yo.$$.fragment,o),E(nt.$$.fragment,o),E(Ue.$$.fragment,o),E(Ze.$$.fragment,o),E(rt.$$.fragment,o),E(Ye.$$.fragment,o),Xr=!0)},o(o){y(d.$$.fragment,o),y(to.$$.fragment,o),y(ro.$$.fragment,o),y(so.$$.fragment,o),y(io.$$.fragment,o),y(lo.$$.fragment,o),y(po.$$.fragment,o),y(ho.$$.fragment,o),y(fo.$$.fragment,o),y(uo.$$.fragment,o),y(_o.$$.fragment,o),y(vo.$$.fragment,o),y(To.$$.fragment,o),y(Eo.$$.fragment,o),y(Ae.$$.fragment,o),y(yo.$$.fragment,o),y($o.$$.fragment,o),y(xo.$$.fragment,o),y(jo.$$.fragment,o),y(Ao.$$.fragment,o),y(Le.$$.fragment,o),y(Ne.$$.fragment,o),y(Co.$$.fragment,o),y(Oe.$$.fragment,o),y(So.$$.fragment,o),y(Io.$$.fragment,o),y(Ho.$$.fragment,o),y(Be.$$.fragment,o),y(Ge.$$.fragment,o),y(Uo.$$.fragment,o),y(We.$$.fragment,o),y(Zo.$$.fragment,o),y(Yo.$$.fragment,o),y(nt.$$.fragment,o),y(Ue.$$.fragment,o),y(Ze.$$.fragment,o),y(rt.$$.fragment,o),y(Ye.$$.fragment,o),Xr=!1},d(o){t(h),o&&t($),o&&t(_),k(d),o&&t(yr),o&&t(ne),k(to),o&&t(kr),o&&t(x),o&&t($r),o&&t(ke),o&&t(xr),o&&t($e),o&&t(jr),o&&t(J),o&&t(Mr),o&&t(re),k(ro),o&&t(Dr),o&&t(Z),o&&t(Vr),k(so,o),o&&t(qr),o&&t(ae),k(io),o&&t(Pr),o&&t(M),o&&t(zr),k(lo,o),o&&t(Fr),o&&t(se),k(po),o&&t(Ar),o&&t(L),o&&t(Cr),o&&t(Ve),o&&t(Sr),k(ho,o),o&&t(Ir),o&&t(ie),k(fo),o&&t(Lr),o&&t(de),o&&t(Nr),k(uo,o),o&&t(Or),o&&t(ce),k(_o),o&&t(Rr),o&&t(N),o&&t(Br),k(vo,o),o&&t(Gr),o&&t(K),o&&t(Wr),o&&t(le),k(To),o&&t(Hr),o&&t(S),k(Eo),k(Ae),k(yo),k($o),o&&t(Ur),o&&t(he),k(xo),o&&t(Zr),o&&t(D),k(jo),k(Ao),k(Le),k(Ne),k(Co),k(Oe),o&&t(Yr),o&&t(_e),k(So),o&&t(Jr),o&&t(V),k(Io),k(Ho),k(Be),k(Ge),k(Uo),k(We),o&&t(Kr),o&&t(we),k(Zo),o&&t(Qr),o&&t(q),k(Yo),k(nt),k(Ue),k(Ze),k(rt),k(Ye)}}}const dh={local:"vision-encoder-decoder-models",sections:[{local:"overview",title:"Overview"},{local:"randomly-initializing-visionencoderdecodermodel-from-model-configurations",title:"Randomly initializing `VisionEncoderDecoderModel` from model configurations."},{local:"initialising-visionencoderdecodermodel-from-a-pretrained-encoder-and-a-pretrained-decoder",title:"Initialising `VisionEncoderDecoderModel` from a pretrained encoder and a pretrained decoder."},{local:"loading-an-existing-visionencoderdecodermodel-checkpoint-and-perform-inference",title:"Loading an existing `VisionEncoderDecoderModel` checkpoint and perform inference."},{local:"loading-a-pytorch-checkpoint-into-tfvisionencoderdecodermodel",title:"Loading a PyTorch checkpoint into `TFVisionEncoderDecoderModel`."},{local:"training",title:"Training"},{local:"transformers.VisionEncoderDecoderConfig",title:"VisionEncoderDecoderConfig"},{local:"transformers.VisionEncoderDecoderModel",title:"VisionEncoderDecoderModel"},{local:"transformers.TFVisionEncoderDecoderModel",title:"TFVisionEncoderDecoderModel"},{local:"transformers.FlaxVisionEncoderDecoderModel",title:"FlaxVisionEncoderDecoderModel"}],title:"Vision Encoder Decoder Models"};function ch(P){return Jm(()=>{new URLSearchParams(window.location.search).get("fw")}),[]}class uh extends Hm{constructor(h){super();Um(this,h,ch,ih,Zm,{})}}export{uh as default,dh as metadata};
