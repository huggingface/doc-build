import{S as P2,i as C2,s as S2,e as o,k as d,w as m,t as r,M as A2,c as a,d as t,m as l,a as s,x as f,h as i,b as c,F as e,g as h,y as _,q as g,o as k,B as b}from"../../chunks/vendor-6b77c823.js";import{T as at}from"../../chunks/Tip-39098574.js";import{D as q}from"../../chunks/Docstring-abef54e3.js";import{C as $}from"../../chunks/CodeBlock-3a8b25a8.js";import{I as U}from"../../chunks/IconCopyLink-7a11ce68.js";function O2(E){let u,z,y,M,x;return{c(){u=o("p"),z=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),y=o("code"),M=r("Module"),x=r(`
...
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),v.forEach(t)},m(T,v){h(T,u,v),e(u,z),e(u,y),e(y,M),e(u,x)},d(T){T&&t(u)}}}function I2(E){let u,z,y,M,x;return{c(){u=o("p"),z=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),y=o("code"),M=r("Module"),x=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(T){u=a(T,"P",{});var v=s(u);z=i(v,"Although the recipe for forward pass needs to be defined within this function, one should call the "),y=a(v,"CODE",{});var B=s(y);M=i(B,"Module"),B.forEach(t),x=i(v,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),v.forEach(t)},m(T,v){h(T,u,v),e(u,z),e(u,y),e(y,M),e(u,x)},d(T){T&&t(u)}}}function N2(E){let u,z,y,M,x;return{c(){u=o("p"),z=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),y=o("code"),M=r("Module"),x=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(T){u=a(T,"P",{});var v=s(u);z=i(v,"Although the recipe for forward pass needs to be defined within this function, one should call the "),y=a(v,"CODE",{});var B=s(y);M=i(B,"Module"),B.forEach(t),x=i(v,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),v.forEach(t)},m(T,v){h(T,u,v),e(u,z),e(u,y),e(y,M),e(u,x)},d(T){T&&t(u)}}}function D2(E){let u,z,y,M,x;return{c(){u=o("p"),z=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),y=o("code"),M=r("Module"),x=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(T){u=a(T,"P",{});var v=s(u);z=i(v,"Although the recipe for forward pass needs to be defined within this function, one should call the "),y=a(v,"CODE",{});var B=s(y);M=i(B,"Module"),B.forEach(t),x=i(v,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),v.forEach(t)},m(T,v){h(T,u,v),e(u,z),e(u,y),e(y,M),e(u,x)},d(T){T&&t(u)}}}function L2(E){let u,z,y,M,x,T,v,B,st,je,j,Ue,_e,rt,ge,ke,it,Ke,Q,N,Xe,ae,P,A,dt,ce,pe,lt,J,ct,pt,D,Ee,be,Ze,se,ye,ve,ht,re,Te,Me,Ye;return{c(){u=o("p"),z=r("TF 2.0 models accepts two formats as inputs:"),y=d(),M=o("ul"),x=o("li"),T=r("having all inputs as keyword arguments (like PyTorch models), or"),v=d(),B=o("li"),st=r("having all inputs as a list, tuple or dict in the first positional arguments."),je=d(),j=o("p"),Ue=r("This second option is useful when using "),_e=o("code"),rt=r("tf.keras.Model.fit"),ge=r(` method which currently requires having all the
...
`),Me=a(Ve,"CODE",{});var Kt=s(Me);Ye=i(Kt,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),Kt.forEach(t),Ve.forEach(t),ie.forEach(t)},m(w,F){h(w,u,F),e(u,z),h(w,y,F),h(w,M,F),e(M,x),e(x,T),e(M,v),e(M,B),e(B,st),h(w,je,F),h(w,j,F),e(j,Ue),e(j,_e),e(_e,rt),e(j,ge),e(j,ke),e(ke,it),e(j,Ke),h(w,Q,F),h(w,N,F),e(N,Xe),h(w,ae,F),h(w,P,F),e(P,A),e(A,dt),e(A,ce),e(ce,pe),e(A,lt),e(A,J),e(J,ct),e(P,pt),e(P,D),e(D,Ee),e(D,be),e(be,Ze),e(D,se),e(D,ye),e(ye,ve),e(P,ht),e(P,re),e(re,Te),e(re,Me),e(Me,Ye)},d(w){w&&t(u),w&&t(y),w&&t(M),w&&t(je),w&&t(j),w&&t(Q),w&&t(N),w&&t(ae),w&&t(P)}}}function G2(E){let u,z,y,M,x;return{c(){u=o("p"),z=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),y=o("code"),M=r("Module"),x=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(T){u=a(T,"P",{});var v=s(u);z=i(v,"Although the recipe for forward pass needs to be defined within this function, one should call the "),y=a(v,"CODE",{});var B=s(y);M=i(B,"Module"),B.forEach(t),x=i(v,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
first positional argument :`),X.forEach(t),ae=l(w),P=a(w,"UL",{});var ie=s(P);A=a(ie,"LI",{});var de=s(A);dt=i(de,"a single Tensor with "),ce=a(de,"CODE",{});var Ht=s(ce);pe=i(Ht,"input_ids"),Ht.forEach(t),lt=i(de," only and nothing else: "),J=a(de,"CODE",{});var Vt=s(J);ct=i(Vt,"model(input_ids)"),Vt.forEach(t),de.forEach(t),pt=l(ie),D=a(ie,"LI",{});var le=s(D);Ee=i(le,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),be=a(le,"CODE",{});var Qt=s(be);Ze=i(Qt,"model([input_ids, attention_mask])"),Qt.forEach(t),se=i(le," or "),ye=a(le,"CODE",{});var Jt=s(ye);ve=i(Jt,"model([input_ids, attention_mask, token_type_ids])"),Jt.forEach(t),le.forEach(t),ht=l(ie),re=a(ie,"LI",{});var Ve=s(re);Te=i(Ve,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),Me=a(Ve,"CODE",{});var Kt=s(Me);Ye=i(Kt,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),Kt.forEach(t),Ve.forEach(t),ie.forEach(t)},m(w,F){h(w,u,F),e(u,z),h(w,y,F),h(w,M,F),e(M,x),e(x,T),e(M,v),e(M,B),e(B,st),h(w,je,F),h(w,j,F),e(j,Ue),e(j,_e),e(_e,rt),e(j,ge),e(j,ke),e(ke,it),e(j,Ke),h(w,Q,F),h(w,N,F),e(N,Xe),h(w,ae,F),h(w,P,F),e(P,A),e(A,dt),e(A,ce),e(ce,pe),e(A,lt),e(A,J),e(J,ct),e(P,pt),e(P,D),e(D,Ee),e(D,be),e(be,Ze),e(D,se),e(D,ye),e(ye,ve),e(P,ht),e(P,re),e(re,Te),e(re,Me),e(Me,Ye)},d(w){w&&t(u),w&&t(y),w&&t(M),w&&t(je),w&&t(j),w&&t(Q),w&&t(N),w&&t(ae),w&&t(P)}}}function R2(E){let u,z,y,M,x;return{c(){u=o("p"),z=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),y=o("code"),M=r("Module"),x=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(T){u=a(T,"P",{});var v=s(u);z=i(v,"Although the recipe for forward pass needs to be defined within this function, one should call the "),y=a(v,"CODE",{});var B=s(y);M=i(B,"Module"),B.forEach(t),x=i(v,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),v.forEach(t)},m(T,v){h(T,u,v),e(u,z),e(u,y),e(y,M),e(u,x)},d(T){T&&t(u)}}}function U2(E){let u,z,y,M,x;return{c(){u=o("p"),z=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),y=o("code"),M=r("Module"),x=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(T){u=a(T,"P",{});var v=s(u);z=i(v,"Although the recipe for forward pass needs to be defined within this function, one should call the "),y=a(v,"CODE",{});var B=s(y);M=i(B,"Module"),B.forEach(t),x=i(v,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),v.forEach(t)},m(T,v){h(T,u,v),e(u,z),e(u,y),e(y,M),e(u,x)},d(T){T&&t(u)}}}function X2(E){let u,z,y,M,x;return{c(){u=o("p"),z=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),y=o("code"),M=r("Module"),x=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(T){u=a(T,"P",{});var v=s(u);z=i(v,"Although the recipe for forward pass needs to be defined within this function, one should call the "),y=a(v,"CODE",{});var B=s(y);M=i(B,"Module"),B.forEach(t),x=i(v,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),v.forEach(t)},m(T,v){h(T,u,v),e(u,z),e(u,y),e(y,M),e(u,x)},d(T){T&&t(u)}}}function H2(E){let u,z,y,M,x;return{c(){u=o("p"),z=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),y=o("code"),M=r("Module"),x=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(T){u=a(T,"P",{});var v=s(u);z=i(v,"Although the recipe for forward pass needs to be defined within this function, one should call the "),y=a(v,"CODE",{});var B=s(y);M=i(B,"Module"),B.forEach(t),x=i(v,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),v.forEach(t)},m(T,v){h(T,u,v),e(u,z),e(u,y),e(y,M),e(u,x)},d(T){T&&t(u)}}}function V2(E){let u,z,y,M,x;return{c(){u=o("p"),z=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),y=o("code"),M=r("Module"),x=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(T){u=a(T,"P",{});var v=s(u);z=i(v,"Although the recipe for forward pass needs to be defined within this function, one should call the "),y=a(v,"CODE",{});var B=s(y);M=i(B,"Module"),B.forEach(t),x=i(v,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),v.forEach(t)},m(T,v){h(T,u,v),e(u,z),e(u,y),e(y,M),e(u,x)},d(T){T&&t(u)}}}function Q2(E){let u,z,y,M,x,T,v,B,st,je,j,Ue,_e,rt,ge,ke,it,Ke,Q,N,Xe,ae,P,A,dt,ce,pe,lt,J,ct,pt,D,Ee,be,Ze,se,ye,ve,ht,re,Te,Me,Ye,w,F,we,He,Ut,K,Xt,kt,X,ie,de,Ht,Vt,le,Qt,Jt,Ve,Kt,Eu,rd,Pu,Cu,_p,bt,Su,Co,id,Au,Ou,Iu,Zr,Nu,Du,gp,Yr,dd,Lu,kp,So,bp,ei,Ao,ld,Gu,Wu,Zt,Ru,cd,Uu,Xu,pd,Hu,Vu,yp,Oo,vp,Yt,Sn,hd,Io,Qu,ud,Ju,Tp,yt,Ku,No,Zu,Yu,md,em,tm,Mp,ti,nm,wp,ni,fd,om,xp,en,An,_d,Do,am,gd,sm,zp,et,rm,kd,im,dm,bd,lm,cm,yd,pm,hm,qp,On,um,oi,mm,fm,Bp,ai,vd,_m,Fp,Lo,$p,si,Go,Td,gm,km,xe,bm,Md,ym,vm,wd,Tm,Mm,xd,wm,xm,zd,zm,qm,qd,Bm,Fm,jp,Wo,Ep,tn,In,Bd,Ro,$m,Fd,jm,Pp,ze,Uo,Em,nn,Pm,ri,Cm,Sm,Xo,Am,Om,Im,on,Nm,ii,Dm,Lm,di,Gm,Wm,Rm,$d,Um,Xm,Ho,Cp,an,Nn,jd,Vo,Hm,Ed,Vm,Sp,L,Qo,Qm,Pd,Jm,Km,ut,Zm,li,Ym,ef,ci,tf,nf,Jo,of,af,sf,Ko,rf,Cd,df,lf,cf,Sd,pf,hf,Zo,uf,Dn,Yo,mf,Ad,ff,_f,tt,ea,gf,ta,kf,Od,bf,yf,vf,na,oa,Id,Tf,Mf,Nd,wf,xf,aa,Dd,zf,qf,Ld,Bf,Ff,Gd,$f,Ap,sn,Ln,Wd,sa,jf,Rd,Ef,Op,C,ra,Pf,rn,Cf,Ud,Sf,Af,ia,Of,If,Nf,vt,pi,Df,Lf,hi,Gf,Wf,ui,Rf,Uf,Xf,da,Hf,Xd,Vf,Qf,Jf,Hd,Kf,Zf,la,Yf,Pe,ca,e_,Vd,t_,n_,pa,o_,Qd,a_,s_,r_,ha,ua,Jd,i_,d_,Kd,l_,c_,ma,Zd,p_,h_,Yd,u_,m_,el,f_,__,Gn,fa,g_,tl,k_,b_,Wn,_a,y_,nl,v_,T_,Rn,ga,M_,ol,w_,Ip,dn,Un,al,ka,x_,sl,z_,Np,S,ba,q_,ya,B_,va,F_,$_,j_,Ta,E_,mi,P_,C_,S_,rl,A_,O_,Ma,I_,nt,wa,N_,xa,D_,il,L_,G_,W_,za,qa,dl,R_,U_,ll,X_,H_,Ba,cl,V_,Q_,pl,J_,K_,hl,Z_,Y_,Xn,Fa,eg,ul,tg,ng,Hn,$a,og,ja,ag,ml,sg,rg,ig,Vn,Ea,dg,fl,lg,cg,Qn,Pa,pg,_l,hg,Dp,ln,Jn,gl,Ca,ug,kl,mg,Lp,G,Sa,fg,cn,_g,bl,gg,kg,Aa,bg,yg,vg,Oa,Tg,fi,Mg,wg,xg,yl,zg,qg,Ia,Bg,Ce,Na,Fg,vl,$g,jg,Da,Eg,Tl,Pg,Cg,Sg,La,Ga,Ml,Ag,Og,wl,Ig,Ng,Wa,xl,Dg,Lg,zl,Gg,Wg,ql,Rg,Ug,Kn,Ra,Xg,Bl,Hg,Vg,Zn,Ua,Qg,Fl,Jg,Gp,pn,Yn,$l,Xa,Kg,jl,Zg,Wp,Qe,Ha,Yg,Va,ek,_i,tk,nk,ok,Qa,ak,Ja,sk,rk,ik,Se,Ka,dk,hn,lk,gi,ck,pk,El,hk,uk,mk,eo,fk,Pl,_k,gk,Za,Rp,un,to,Cl,Ya,kk,Sl,bk,Up,Je,es,yk,ts,vk,ki,Tk,Mk,wk,ns,xk,os,zk,qk,Bk,Z,as,Fk,mn,$k,bi,jk,Ek,Al,Pk,Ck,Sk,no,Ak,Ol,Ok,Ik,ss,Nk,Il,Dk,Lk,rs,Xp,fn,oo,Nl,is,Gk,Dl,Wk,Hp,qe,ds,Rk,_n,Uk,Ll,Xk,Hk,Gl,Vk,Qk,Jk,ls,Kk,yi,Zk,Yk,eb,cs,tb,ps,nb,ob,ab,Ae,hs,sb,gn,rb,vi,ib,db,Wl,lb,cb,pb,ao,hb,Rl,ub,mb,us,Vp,kn,so,Ul,ms,fb,Xl,_b,Qp,Be,fs,gb,Hl,kb,bb,_s,yb,Ti,vb,Tb,Mb,gs,wb,ks,xb,zb,qb,Y,bs,Bb,bn,Fb,Mi,$b,jb,Vl,Eb,Pb,Cb,ro,Sb,Ql,Ab,Ob,ys,Ib,Jl,Nb,Db,vs,Jp,yn,io,Kl,Ts,Lb,Zl,Gb,Kp,vn,Ms,Wb,Tt,ws,Rb,Yl,Ub,Xb,xs,Zp,Tn,lo,ec,zs,Hb,tc,Vb,Yp,Fe,qs,Qb,Bs,Jb,wi,Kb,Zb,Yb,Fs,ey,$s,ty,ny,oy,co,ay,Oe,js,sy,Mn,ry,xi,iy,dy,nc,ly,cy,py,po,hy,oc,uy,my,Es,eh,wn,ho,ac,Ps,fy,sc,_y,th,$e,Cs,gy,Ss,ky,zi,by,yy,vy,As,Ty,Os,My,wy,xy,uo,zy,ee,Is,qy,xn,By,qi,Fy,$y,rc,jy,Ey,Py,mo,Cy,ic,Sy,Ay,Ns,Oy,dc,Iy,Ny,Ds,nh,zn,fo,lc,Ls,Dy,cc,Ly,oh,W,Gs,Gy,Ws,Wy,Bi,Ry,Uy,Xy,Rs,Hy,Us,Vy,Qy,Jy,pc,Ky,Zy,mt,hc,Xs,Yy,ev,uc,Hs,tv,nv,mc,Vs,ov,av,fc,Qs,sv,rv,Ie,Js,iv,qn,dv,_c,lv,cv,gc,pv,hv,uv,_o,mv,kc,fv,_v,Ks,gv,Mt,Zs,kv,bc,bv,yv,Ys,vv,wt,er,Tv,yc,Mv,wv,tr,ah,Bn,go,vc,nr,xv,Tc,zv,sh,R,or,qv,ar,Bv,Fi,Fv,$v,jv,sr,Ev,rr,Pv,Cv,Sv,Mc,Av,Ov,ft,wc,ir,Iv,Nv,xc,dr,Dv,Lv,zc,lr,Gv,Wv,qc,cr,Rv,Uv,te,pr,Xv,Fn,Hv,Bc,Vv,Qv,Fc,Jv,Kv,Zv,ko,Yv,$c,eT,tT,hr,nT,jc,oT,aT,ur,sT,xt,mr,rT,Ec,iT,dT,fr,lT,zt,_r,cT,Pc,pT,hT,gr,rh,$n,bo,Cc,kr,uT,Sc,mT,ih,O,br,fT,Ac,_T,gT,yr,kT,$i,bT,yT,vT,vr,TT,Tr,MT,wT,xT,Oc,zT,qT,_t,Ic,Mr,BT,FT,Nc,wr,$T,jT,Dc,xr,ET,PT,Lc,zr,CT,ST,Ne,qr,AT,jn,OT,Gc,IT,NT,Wc,DT,LT,GT,yo,WT,Rc,RT,UT,Br,XT,qt,Fr,HT,Uc,VT,QT,$r,JT,Bt,jr,KT,Xc,ZT,YT,Er,dh,En,vo,Hc,Pr,eM,Vc,tM,lh,I,Cr,nM,Pn,oM,Qc,aM,sM,Jc,rM,iM,dM,Sr,lM,ji,cM,pM,hM,Ar,uM,Or,mM,fM,_M,Kc,gM,kM,gt,Zc,Ir,bM,yM,Yc,Nr,vM,TM,ep,Dr,MM,wM,tp,Lr,xM,zM,De,Gr,qM,Cn,BM,np,FM,$M,op,jM,EM,PM,To,CM,ap,SM,AM,Wr,OM,Ft,Rr,IM,sp,NM,DM,Ur,LM,$t,Xr,GM,rp,WM,RM,Hr,ch;return T=new U({}),ae=new U({}),He=new U({}),So=new $({props:{code:`from transformers import MBartForConditionalGeneration, MBartTokenizer
...
<span class="hljs-string">&quot;\u015Eeful ONU declar\u0103 c\u0103 nu exist\u0103 o solu\u0163ie militar\u0103 \xEEn Siria&quot;</span>`}}),Io=new U({}),Do=new U({}),Lo=new $({props:{code:`from transformers import MBartForConditionalGeneration, MBart50TokenizerFast
...
`}}),eo=new at({props:{$$slots:{default:[O2]},$$scope:{ctx:E}}}),Za=new $({props:{code:`from transformers import MBartTokenizer, MBartModel
import torch
...
`}}),no=new at({props:{$$slots:{default:[I2]},$$scope:{ctx:E}}}),ss=new $({props:{code:`from transformers import MBartTokenizer, MBartForConditionalGeneration
...
`}}),ao=new at({props:{$$slots:{default:[N2]},$$scope:{ctx:E}}}),us=new $({props:{code:`from transformers import MBartTokenizer, MBartForQuestionAnswering
import torch
...
`}}),ro=new at({props:{$$slots:{default:[D2]},$$scope:{ctx:E}}}),ys=new $({props:{code:`import torch
...
`}}),po=new at({props:{$$slots:{default:[G2]},$$scope:{ctx:E}}}),Es=new $({props:{code:`from transformers import MBartTokenizer, TFMBartModel
...
`}}),mo=new at({props:{$$slots:{default:[R2]},$$scope:{ctx:E}}}),Ns=new $({props:{code:`from transformers import MBartTokenizer, TFMBartForConditionalGeneration, MBartConfig
...
`}}),_o=new at({props:{$$slots:{default:[U2]},$$scope:{ctx:E}}}),Ks=new $({props:{code:`from transformers import MBartTokenizer, FlaxMBartModel
...
`}}),ko=new at({props:{$$slots:{default:[X2]},$$scope:{ctx:E}}}),hr=new $({props:{code:`from transformers import MBartTokenizer, FlaxMBartForConditionalGeneration, MBartConfig
...
`}}),yo=new at({props:{$$slots:{default:[H2]},$$scope:{ctx:E}}}),Br=new $({props:{code:`from transformers import MBartTokenizer, FlaxMBartForSequenceClassification
...
`}}),To=new at({props:{$$slots:{default:[V2]},$$scope:{ctx:E}}}),Wr=new $({props:{code:`from transformers import MBartTokenizer, FlaxMBartForQuestionAnswering
...
<span class="hljs-meta">&gt;&gt;&gt; </span>outputs = model.decode(decoder_input_ids, encoder_outputs)
<span class="hljs-meta">&gt;&gt;&gt; </span>last_decoder_hidden_states = outputs.last_hidden_state`}}),{c(){u=o("meta"),z=d(),y=o("h1"),M=o("a"),x=o("span"),m(T.$$.fragment),v=d(),B=o("span"),st=r("MBart and MBart-50"),je=d(),j=o("p"),Ue=o("strong"),_e=r("DISCLAIMER:"),rt=r(" If you see something strange, file a "),ge=o("a"),ke=r("Github Issue"),it=r(` and assign
@patrickvonplaten`),Ke=d(),Q=o("h2"),N=o("a"),Xe=o("span"),m(ae.$$.fragment),P=d(),A=o("span"),dt=r("Overview of MBart"),ce=d(),pe=o("p"),lt=r("The MBart model was presented in "),J=o("a"),ct=r("Multilingual Denoising Pre-training for Neural Machine Translation"),pt=r(` by Yinhan Liu, Jiatao Gu, Naman Goyal, Xian Li, Sergey Edunov Marjan
...
on the encoder, decoder, or reconstructing parts of the text.`),Ze=d(),se=o("p"),ye=r("This model was contributed by "),ve=o("a"),ht=r("valhalla"),re=r(". The Authors\u2019 code can be found "),Te=o("a"),Me=r("here"),Ye=d(),w=o("h3"),F=o("a"),we=o("span"),m(He.$$.fragment),Ut=d(),K=o("span"),Xt=r("Training of MBart"),kt=d(),X=o("p"),ie=r(`MBart is a multilingual encoder-decoder (sequence-to-sequence) model primarily intended for translation task. As the
...
inside the context manager `),Zr=o("a"),Nu=r("as_target_tokenizer()"),Du=r(" to encode target text format."),gp=d(),Yr=o("ul"),dd=o("li"),Lu=r("Supervised training"),kp=d(),m(So.$$.fragment),bp=d(),ei=o("ul"),Ao=o("li"),ld=o("p"),Gu=r("Generation"),Wu=d(),Zt=o("p"),Ru=r("While generating the target text set the "),cd=o("code"),Uu=r("decoder_start_token_id"),Xu=r(` to the target language id. The following
example shows how to translate English to Romanian using the `),pd=o("em"),Hu=r("facebook/mbart-large-en-ro"),Vu=r(" model."),yp=d(),m(Oo.$$.fragment),vp=d(),Yt=o("h2"),Sn=o("a"),hd=o("span"),m(Io.$$.fragment),Qu=d(),ud=o("span"),Ju=r("Overview of MBart-50"),Tp=d(),yt=o("p"),Ku=r("MBart-50 was introduced in the "),No=o("a"),Zu=r("Multilingual Translation with Extensible Multilingual Pretraining and Finetuning"),Yu=r(` paper by Yuqing Tang, Chau Tran, Xian Li, Peng-Jen Chen, Naman Goyal, Vishrav
...
respectively.`),qp=d(),On=o("p"),um=r("MBart-50 has its own tokenizer "),oi=o("a"),mm=r("MBart50Tokenizer"),fm=r("."),Bp=d(),ai=o("ul"),vd=o("li"),_m=r("Supervised training"),Fp=d(),m(Lo.$$.fragment),$p=d(),si=o("ul"),Go=o("li"),Td=o("p"),gm=r("Generation"),km=d(),xe=o("p"),bm=r("To generate using the mBART-50 multilingual translation models, "),Md=o("code"),ym=r("eos_token_id"),vm=r(` is used as the
...
`),qd=o("em"),Bm=r("facebook/mbart-50-large-many-to-many"),Fm=r(" checkpoint."),jp=d(),m(Wo.$$.fragment),Ep=d(),tn=o("h2"),In=o("a"),Bd=o("span"),m(Ro.$$.fragment),$m=d(),Fd=o("span"),jm=r("MBartConfig"),Pp=d(),ze=o("div"),m(Uo.$$.fragment),Em=d(),nn=o("p"),Pm=r("This is the configuration class to store the configuration of a "),ri=o("a"),Cm=r("MBartModel"),Sm=r(`. It is used to instantiate an MBART
...
documentation from `),di=o("a"),Gm=r("PretrainedConfig"),Wm=r(" for more information."),Rm=d(),$d=o("p"),Um=r("Example:"),Xm=d(),m(Ho.$$.fragment),Cp=d(),an=o("h2"),Nn=o("a"),jd=o("span"),m(Vo.$$.fragment),Hm=d(),Ed=o("span"),Vm=r("MBartTokenizer"),Sp=d(),L=o("div"),m(Qo.$$.fragment),Qm=d(),Pd=o("p"),Jm=r("Construct an MBART tokenizer."),Km=d(),ut=o("p"),Zm=r("Adapted from "),li=o("a"),Ym=r("RobertaTokenizer"),ef=r(" and "),ci=o("a"),tf=r("XLNetTokenizer"),nf=r(`. Based on
...
adding special tokens. An MBART sequence has the following format, where `),Od=o("code"),bf=r("X"),yf=r(" represents the sequence:"),vf=d(),na=o("ul"),oa=o("li"),Id=o("code"),Tf=r("input_ids"),Mf=r(" (for encoder) "),Nd=o("code"),wf=r("X [eos, src_lang_code]"),xf=d(),aa=o("li"),Dd=o("code"),zf=r("decoder_input_ids"),qf=r(": (for decoder) "),Ld=o("code"),Bf=r("X [eos, tgt_lang_code]"),Ff=d(),Gd=o("p"),$f=r(`BOS is never used. Pairs of sequences are not the expected use case, but they will be handled without a
separator.`),Ap=d(),sn=o("h2"),Ln=o("a"),Wd=o("span"),m(sa.$$.fragment),jf=d(),Rd=o("span"),Ef=r("MBartTokenizerFast"),Op=d(),C=o("div"),m(ra.$$.fragment),Pf=d(),rn=o("p"),Cf=r("Construct a \u201Cfast\u201D MBART tokenizer (backed by HuggingFace\u2019s "),Ud=o("em"),Sf=r("tokenizers"),Af=r(` library). Based on
...
make use of token type ids, therefore a list of zeros is returned.`),b_=d(),Wn=o("div"),m(_a.$$.fragment),y_=d(),nl=o("p"),v_=r("Reset the special tokens to the source lang setting. No prefix and suffix=[eos, src_lang_code]."),T_=d(),Rn=o("div"),m(ga.$$.fragment),M_=d(),ol=o("p"),w_=r("Reset the special tokens to the target language setting. No prefix and suffix=[eos, tgt_lang_code]."),Ip=d(),dn=o("h2"),Un=o("a"),al=o("span"),m(ka.$$.fragment),x_=d(),sl=o("span"),z_=r("MBart50Tokenizer"),Np=d(),S=o("div"),m(ba.$$.fragment),q_=d(),ya=o("p"),B_=r("Construct a MBart50 tokenizer. Based on "),va=o("a"),F_=r("SentencePiece"),$_=r("."),j_=d(),Ta=o("p"),E_=r("This tokenizer inherits from "),mi=o("a"),P_=r("PreTrainedTokenizer"),C_=r(` which contains most of the main methods. Users should refer to
this superclass for more information regarding those methods.`),S_=d(),rl=o("p"),A_=r("Examples:"),O_=d(),m(Ma.$$.fragment),I_=d(),nt=o("div"),m(wa.$$.fragment),N_=d(),xa=o("p"),D_=r(`Build model inputs from a sequence or a pair of sequence for sequence classification tasks by concatenating and
...
separator.`),Y_=d(),Xn=o("div"),m(Fa.$$.fragment),eg=d(),ul=o("p"),tg=r("Converts a sequence of tokens (strings for sub-words) in a single string."),ng=d(),Hn=o("div"),m($a.$$.fragment),og=d(),ja=o("p"),ag=r(`Retrieve sequence ids from a token list that has no special tokens added. This method is called when adding
...
refer to this superclass for more information regarding those methods.`),xg=d(),yl=o("p"),zg=r("Examples:"),qg=d(),m(Ia.$$.fragment),Bg=d(),Ce=o("div"),m(Na.$$.fragment),Fg=d(),vl=o("p"),$g=r(`Build model inputs from a sequence or a pair of sequence for sequence classification tasks by concatenating and
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Bk=d(),Z=o("div"),m(as.$$.fragment),Fk=d(),mn=o("p"),$k=r("The "),bi=o("a"),jk=r("MBartForConditionalGeneration"),Ek=r(" forward method, overrides the "),Al=o("code"),Pk=r("__call__"),Ck=r(" special method."),Sk=d(),m(no.$$.fragment),Ak=d(),Ol=o("p"),Ok=r("Translation example:"),Ik=d(),m(ss.$$.fragment),Nk=d(),Il=o("p"),Dk=r("Mask filling example:"),Lk=d(),m(rs.$$.fragment),Xp=d(),fn=o("h2"),oo=o("a"),Nl=o("span"),m(is.$$.fragment),Gk=d(),Dl=o("span"),Wk=r("MBartForQuestionAnswering"),Hp=d(),qe=o("div"),m(ds.$$.fragment),Rk=d(),_n=o("p"),Uk=r(`MBART Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),qb=d(),Y=o("div"),m(bs.$$.fragment),Bb=d(),bn=o("p"),Fb=r("The "),Mi=o("a"),$b=r("MBartForSequenceClassification"),jb=r(" forward method, overrides the "),Vl=o("code"),Eb=r("__call__"),Pb=r(" special method."),Cb=d(),m(ro.$$.fragment),Sb=d(),Ql=o("p"),Ab=r("Example of single-label classification:"),Ob=d(),m(ys.$$.fragment),Ib=d(),Jl=o("p"),Nb=r("Example of multi-label classification:"),Db=d(),m(vs.$$.fragment),Jp=d(),yn=o("h2"),io=o("a"),Kl=o("span"),m(Ts.$$.fragment),Lb=d(),Zl=o("span"),Gb=r("MBartForCausalLM"),Kp=d(),vn=o("div"),m(Ms.$$.fragment),Wb=d(),Tt=o("div"),m(ws.$$.fragment),Rb=d(),Yl=o("p"),Ub=r("Example:"),Xb=d(),m(xs.$$.fragment),Zp=d(),Tn=o("h2"),lo=o("a"),ec=o("span"),m(zs.$$.fragment),Hb=d(),tc=o("span"),Vb=r("TFMBartModel"),Yp=d(),Fe=o("div"),m(qs.$$.fragment),Qb=d(),Bs=o("p"),Jb=r(`The bare MBART Model outputting raw hidden-states without any specific head on top.
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Yb=d(),Fs=o("p"),ey=r("This model is also a "),$s=o("a"),ty=r("tf.keras.Model"),ny=r(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),oy=d(),m(co.$$.fragment),ay=d(),Oe=o("div"),m(js.$$.fragment),sy=d(),Mn=o("p"),ry=r("The "),xi=o("a"),iy=r("TFMBartModel"),dy=r(" forward method, overrides the "),nc=o("code"),ly=r("__call__"),cy=r(" special method."),py=d(),m(po.$$.fragment),hy=d(),oc=o("p"),uy=r("Example:"),my=d(),m(Es.$$.fragment),eh=d(),wn=o("h2"),ho=o("a"),ac=o("span"),m(Ps.$$.fragment),fy=d(),sc=o("span"),_y=r("TFMBartForConditionalGeneration"),th=d(),$e=o("div"),m(Cs.$$.fragment),gy=d(),Ss=o("p"),ky=r(`The MBART Model with a language modeling head. Can be used for summarization.
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),xy=d(),m(uo.$$.fragment),zy=d(),ee=o("div"),m(Is.$$.fragment),qy=d(),xn=o("p"),By=r("The "),qi=o("a"),Fy=r("TFMBartForConditionalGeneration"),$y=r(" forward method, overrides the "),rc=o("code"),jy=r("__call__"),Ey=r(" special method."),Py=d(),m(mo.$$.fragment),Cy=d(),ic=o("p"),Sy=r("Summarization example:"),Ay=d(),m(Ns.$$.fragment),Oy=d(),dc=o("p"),Iy=r("Mask filling example:"),Ny=d(),m(Ds.$$.fragment),nh=d(),zn=o("h2"),fo=o("a"),lc=o("span"),m(Ls.$$.fragment),Dy=d(),cc=o("span"),Ly=r("FlaxMBartModel"),oh=d(),W=o("div"),m(Gs.$$.fragment),Gy=d(),Ws=o("p"),Wy=r(`The bare MBart Model transformer outputting raw hidden-states without any specific head on top.
...
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),Jy=d(),pc=o("p"),Ky=r("Finally, this model supports inherent JAX features such as:"),Zy=d(),mt=o("ul"),hc=o("li"),Xs=o("a"),Yy=r("Just-In-Time (JIT) compilation"),ev=d(),uc=o("li"),Hs=o("a"),tv=r("Automatic Differentiation"),nv=d(),mc=o("li"),Vs=o("a"),ov=r("Vectorization"),av=d(),fc=o("li"),Qs=o("a"),sv=r("Parallelization"),rv=d(),Ie=o("div"),m(Js.$$.fragment),iv=d(),qn=o("p"),dv=r("The "),_c=o("code"),lv=r("FlaxMBartPreTrainedModel"),cv=r("forward method, overrides the "),gc=o("code"),pv=r("__call__"),hv=r(" special method."),uv=d(),m(_o.$$.fragment),mv=d(),kc=o("p"),fv=r("Example:"),_v=d(),m(Ks.$$.fragment),gv=d(),Mt=o("div"),m(Zs.$$.fragment),kv=d(),bc=o("p"),bv=r("Example:"),yv=d(),m(Ys.$$.fragment),vv=d(),wt=o("div"),m(er.$$.fragment),Tv=d(),yc=o("p"),Mv=r("Example:"),wv=d(),m(tr.$$.fragment),ah=d(),Bn=o("h2"),go=o("a"),vc=o("span"),m(nr.$$.fragment),xv=d(),Tc=o("span"),zv=r("FlaxMBartForConditionalGeneration"),sh=d(),R=o("div"),m(or.$$.fragment),qv=d(),ar=o("p"),Bv=r(`The MMBart Model with a language modeling head. Can be used for summarization.
This model inherits from `),Fi=o("a"),Fv=r("FlaxPreTrainedModel"),$v=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),jv=d(),sr=o("p"),Ev=r(`This model is also a Flax Linen
`),rr=o("a"),Pv=r("flax.nn.Module"),Cv=r(` subclass. Use it as a
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),Sv=d(),Mc=o("p"),Av=r("Finally, this model supports inherent JAX features such as:"),Ov=d(),ft=o("ul"),wc=o("li"),ir=o("a"),Iv=r("Just-In-Time (JIT) compilation"),Nv=d(),xc=o("li"),dr=o("a"),Dv=r("Automatic Differentiation"),Lv=d(),zc=o("li"),lr=o("a"),Gv=r("Vectorization"),Wv=d(),qc=o("li"),cr=o("a"),Rv=r("Parallelization"),Uv=d(),te=o("div"),m(pr.$$.fragment),Xv=d(),Fn=o("p"),Hv=r("The "),Bc=o("code"),Vv=r("FlaxMBartPreTrainedModel"),Qv=r("forward method, overrides the "),Fc=o("code"),Jv=r("__call__"),Kv=r(" special method."),Zv=d(),m(ko.$$.fragment),Yv=d(),$c=o("p"),eT=r("Summarization example:"),tT=d(),m(hr.$$.fragment),nT=d(),jc=o("p"),oT=r("Mask filling example:"),aT=d(),m(ur.$$.fragment),sT=d(),xt=o("div"),m(mr.$$.fragment),rT=d(),Ec=o("p"),iT=r("Example:"),dT=d(),m(fr.$$.fragment),lT=d(),zt=o("div"),m(_r.$$.fragment),cT=d(),Pc=o("p"),pT=r("Example:"),hT=d(),m(gr.$$.fragment),rh=d(),$n=o("h2"),bo=o("a"),Cc=o("span"),m(kr.$$.fragment),uT=d(),Sc=o("span"),mT=r("FlaxMBartForSequenceClassification"),ih=d(),O=o("div"),m(br.$$.fragment),fT=d(),Ac=o("p"),_T=r(`MBart model with a sequence classification/head on top (a linear layer on top of the pooled output) e.g. for GLUE
tasks.`),gT=d(),yr=o("p"),kT=r("This model inherits from "),$i=o("a"),bT=r("FlaxPreTrainedModel"),yT=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),vT=d(),vr=o("p"),TT=r(`This model is also a Flax Linen
`),Tr=o("a"),MT=r("flax.nn.Module"),wT=r(` subclass. Use it as a
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),xT=d(),Oc=o("p"),zT=r("Finally, this model supports inherent JAX features such as:"),qT=d(),_t=o("ul"),Ic=o("li"),Mr=o("a"),BT=r("Just-In-Time (JIT) compilation"),FT=d(),Nc=o("li"),wr=o("a"),$T=r("Automatic Differentiation"),jT=d(),Dc=o("li"),xr=o("a"),ET=r("Vectorization"),PT=d(),Lc=o("li"),zr=o("a"),CT=r("Parallelization"),ST=d(),Ne=o("div"),m(qr.$$.fragment),AT=d(),jn=o("p"),OT=r("The "),Gc=o("code"),IT=r("FlaxMBartPreTrainedModel"),NT=r("forward method, overrides the "),Wc=o("code"),DT=r("__call__"),LT=r(" special method."),GT=d(),m(yo.$$.fragment),WT=d(),Rc=o("p"),RT=r("Example:"),UT=d(),m(Br.$$.fragment),XT=d(),qt=o("div"),m(Fr.$$.fragment),HT=d(),Uc=o("p"),VT=r("Example:"),QT=d(),m($r.$$.fragment),JT=d(),Bt=o("div"),m(jr.$$.fragment),KT=d(),Xc=o("p"),ZT=r("Example:"),YT=d(),m(Er.$$.fragment),dh=d(),En=o("h2"),vo=o("a"),Hc=o("span"),m(Pr.$$.fragment),eM=d(),Vc=o("span"),tM=r("FlaxMBartForQuestionAnswering"),lh=d(),I=o("div"),m(Cr.$$.fragment),nM=d(),Pn=o("p"),oM=r(`MBart Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
...
inside the context manager `),Zr=a(Ei,"A",{href:!0});var aw=s(Zr);Nu=i(aw,"as_target_tokenizer()"),aw.forEach(t),Du=i(Ei," to encode target text format."),Ei.forEach(t),gp=l(n),Yr=a(n,"UL",{});var sw=s(Yr);dd=a(sw,"LI",{});var rw=s(dd);Lu=i(rw,"Supervised training"),rw.forEach(t),sw.forEach(t),kp=l(n),f(So.$$.fragment,n),bp=l(n),ei=a(n,"UL",{});var iw=s(ei);Ao=a(iw,"LI",{});var hh=s(Ao);ld=a(hh,"P",{});var dw=s(ld);Gu=i(dw,"Generation"),dw.forEach(t),Wu=l(hh),Zt=a(hh,"P",{});var Pi=s(Zt);Ru=i(Pi,"While generating the target text set the "),cd=a(Pi,"CODE",{});var lw=s(cd);Uu=i(lw,"decoder_start_token_id"),lw.forEach(t),Xu=i(Pi,` to the target language id. The following
example shows how to translate English to Romanian using the `),pd=a(Pi,"EM",{});var cw=s(pd);Hu=i(cw,"facebook/mbart-large-en-ro"),cw.forEach(t),Vu=i(Pi," model."),Pi.forEach(t),hh.forEach(t),iw.forEach(t),yp=l(n),f(Oo.$$.fragment,n),vp=l(n),Yt=a(n,"H2",{class:!0});var uh=s(Yt);Sn=a(uh,"A",{id:!0,class:!0,href:!0});var pw=s(Sn);hd=a(pw,"SPAN",{});var hw=s(hd);f(Io.$$.fragment,hw),hw.forEach(t),pw.forEach(t),Qu=l(uh),ud=a(uh,"SPAN",{});var uw=s(ud);Ju=i(uw,"Overview of MBart-50"),uw.forEach(t),uh.forEach(t),Tp=l(n),yt=a(n,"P",{});var Ci=s(yt);Ku=i(Ci,"MBart-50 was introduced in the "),No=a(Ci,"A",{href:!0,rel:!0});var mw=s(No);Zu=i(mw,"Multilingual Translation with Extensible Multilingual Pretraining and Finetuning"),mw.forEach(t),Yu=i(Ci,` paper by Yuqing Tang, Chau Tran, Xian Li, Peng-Jen Chen, Naman Goyal, Vishrav
...
respectively.`),wo.forEach(t),qp=l(n),On=a(n,"P",{});var fh=s(On);um=i(fh,"MBart-50 has its own tokenizer "),oi=a(fh,"A",{href:!0});var xw=s(oi);mm=i(xw,"MBart50Tokenizer"),xw.forEach(t),fm=i(fh,"."),fh.forEach(t),Bp=l(n),ai=a(n,"UL",{});var zw=s(ai);vd=a(zw,"LI",{});var qw=s(vd);_m=i(qw,"Supervised training"),qw.forEach(t),zw.forEach(t),Fp=l(n),f(Lo.$$.fragment,n),$p=l(n),si=a(n,"UL",{});var Bw=s(si);Go=a(Bw,"LI",{});var _h=s(Go);Td=a(_h,"P",{});var Fw=s(Td);gm=i(Fw,"Generation"),Fw.forEach(t),km=l(_h),xe=a(_h,"P",{});var ot=s(xe);bm=i(ot,"To generate using the mBART-50 multilingual translation models, "),Md=a(ot,"CODE",{});var $w=s(Md);ym=i($w,"eos_token_id"),$w.forEach(t),vm=i(ot,` is used as the
...
The following example shows how to translate between Hindi to French and Arabic to English using the
`),qd=a(ot,"EM",{});var Cw=s(qd);Bm=i(Cw,"facebook/mbart-50-large-many-to-many"),Cw.forEach(t),Fm=i(ot," checkpoint."),ot.forEach(t),_h.forEach(t),Bw.forEach(t),jp=l(n),f(Wo.$$.fragment,n),Ep=l(n),tn=a(n,"H2",{class:!0});var gh=s(tn);In=a(gh,"A",{id:!0,class:!0,href:!0});var Sw=s(In);Bd=a(Sw,"SPAN",{});var Aw=s(Bd);f(Ro.$$.fragment,Aw),Aw.forEach(t),Sw.forEach(t),$m=l(gh),Fd=a(gh,"SPAN",{});var Ow=s(Fd);jm=i(Ow,"MBartConfig"),Ow.forEach(t),gh.forEach(t),Pp=l(n),ze=a(n,"DIV",{class:!0});var Et=s(ze);f(Uo.$$.fragment,Et),Em=l(Et),nn=a(Et,"P",{});var Si=s(nn);Pm=i(Si,"This is the configuration class to store the configuration of a "),ri=a(Si,"A",{href:!0});var Iw=s(ri);Cm=i(Iw,"MBartModel"),Iw.forEach(t),Sm=i(Si,`. It is used to instantiate an MBART
model according to the specified arguments, defining the model architecture. Instantiating a configuration with the
defaults will yield a similar configuration to that of the MBART
...
separator.`),A1.forEach(t),qo.forEach(t),Y_=l(V),Xn=a(V,"DIV",{class:!0});var Lh=s(Xn);f(Fa.$$.fragment,Lh),eg=l(Lh),ul=a(Lh,"P",{});var O1=s(ul);tg=i(O1,"Converts a sequence of tokens (strings for sub-words) in a single string."),O1.forEach(t),Lh.forEach(t),ng=l(V),Hn=a(V,"DIV",{class:!0});var Gh=s(Hn);f($a.$$.fragment,Gh),og=l(Gh),ja=a(Gh,"P",{});var Wh=s(ja);ag=i(Wh,`Retrieve sequence ids from a token list that has no special tokens added. This method is called when adding
special tokens using the tokenizer `),ml=a(Wh,"CODE",{});var I1=s(ml);sg=i(I1,"prepare_for_model"),I1.forEach(t),rg=i(Wh," method."),Wh.forEach(t),Gh.forEach(t),ig=l(V),Vn=a(V,"DIV",{class:!0});var Rh=s(Vn);f(Ea.$$.fragment,Rh),dg=l(Rh),fl=a(Rh,"P",{});var N1=s(fl);lg=i(N1,"Reset the special tokens to the source lang setting. prefix=[src_lang_code] and suffix=[eos]."),N1.forEach(t),Rh.forEach(t),cg=l(V),Qn=a(V,"DIV",{class:!0});var Uh=s(Qn);f(Pa.$$.fragment,Uh),pg=l(Uh),_l=a(Uh,"P",{});var D1=s(_l);hg=i(D1,"Reset the special tokens to the target language setting. prefix=[tgt_lang_code] and suffix=[eos]."),D1.forEach(t),Uh.forEach(t),V.forEach(t),Dp=l(n),ln=a(n,"H2",{class:!0});var Xh=s(ln);Jn=a(Xh,"A",{id:!0,class:!0,href:!0});var L1=s(Jn);gl=a(L1,"SPAN",{});var G1=s(gl);f(Ca.$$.fragment,G1),G1.forEach(t),L1.forEach(t),ug=l(Xh),kl=a(Xh,"SPAN",{});var W1=s(kl);mg=i(W1,"MBart50TokenizerFast"),W1.forEach(t),Xh.forEach(t),Lp=l(n),G=a(n,"DIV",{class:!0});var ue=s(G);f(Sa.$$.fragment,ue),fg=l(ue),cn=a(ue,"P",{});var Ii=s(cn);_g=i(Ii,"Construct a \u201Cfast\u201D MBART tokenizer for mBART-50 (backed by HuggingFace\u2019s "),bl=a(Ii,"EM",{});var R1=s(bl);gg=i(R1,"tokenizers"),R1.forEach(t),kg=i(Ii,` library). Based on
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),nu.forEach(t),ik=l(Bo),Se=a(Bo,"DIV",{class:!0});var St=s(Se);f(Ka.$$.fragment,St),dk=l(St),hn=a(St,"P",{});var Ni=s(hn);lk=i(Ni,"The "),gi=a(Ni,"A",{href:!0});var dx=s(gi);ck=i(dx,"MBartModel"),dx.forEach(t),pk=i(Ni," forward method, overrides the "),El=a(Ni,"CODE",{});var lx=s(El);hk=i(lx,"__call__"),lx.forEach(t),uk=i(Ni," special method."),Ni.forEach(t),mk=l(St),f(eo.$$.fragment,St),fk=l(St),Pl=a(St,"P",{});var cx=s(Pl);_k=i(cx,"Example:"),cx.forEach(t),gk=l(St),f(Za.$$.fragment,St),St.forEach(t),Bo.forEach(t),Rp=l(n),un=a(n,"H2",{class:!0});var ou=s(un);to=a(ou,"A",{id:!0,class:!0,href:!0});var px=s(to);Cl=a(px,"SPAN",{});var hx=s(Cl);f(Ya.$$.fragment,hx),hx.forEach(t),px.forEach(t),kk=l(ou),Sl=a(ou,"SPAN",{});var ux=s(Sl);bk=i(ux,"MBartForConditionalGeneration"),ux.forEach(t),ou.forEach(t),Up=l(n),Je=a(n,"DIV",{class:!0});var Fo=s(Je);f(es.$$.fragment,Fo),yk=l(Fo),ts=a(Fo,"P",{});var au=s(ts);vk=i(au,`The MBART Model with a language modeling head. Can be used for summarization.
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),au.forEach(t),wk=l(Fo),ns=a(Fo,"P",{});var su=s(ns);xk=i(su,"This model is also a PyTorch "),os=a(su,"A",{href:!0,rel:!0});var fx=s(os);zk=i(fx,"torch.nn.Module"),fx.forEach(t),qk=i(su,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),su.forEach(t),Bk=l(Fo),Z=a(Fo,"DIV",{class:!0});var Le=s(Z);f(as.$$.fragment,Le),Fk=l(Le),mn=a(Le,"P",{});var Di=s(mn);$k=i(Di,"The "),bi=a(Di,"A",{href:!0});var _x=s(bi);jk=i(_x,"MBartForConditionalGeneration"),_x.forEach(t),Ek=i(Di," forward method, overrides the "),Al=a(Di,"CODE",{});var gx=s(Al);Pk=i(gx,"__call__"),gx.forEach(t),Ck=i(Di," special method."),Di.forEach(t),Sk=l(Le),f(no.$$.fragment,Le),Ak=l(Le),Ol=a(Le,"P",{});var kx=s(Ol);Ok=i(kx,"Translation example:"),kx.forEach(t),Ik=l(Le),f(ss.$$.fragment,Le),Nk=l(Le),Il=a(Le,"P",{});var bx=s(Il);Dk=i(bx,"Mask filling example:"),bx.forEach(t),Lk=l(Le),f(rs.$$.fragment,Le),Le.forEach(t),Fo.forEach(t),Xp=l(n),fn=a(n,"H2",{class:!0});var ru=s(fn);oo=a(ru,"A",{id:!0,class:!0,href:!0});var yx=s(oo);Nl=a(yx,"SPAN",{});var vx=s(Nl);f(is.$$.fragment,vx),vx.forEach(t),yx.forEach(t),Gk=l(ru),Dl=a(ru,"SPAN",{});var Tx=s(Dl);Wk=i(Tx,"MBartForQuestionAnswering"),Tx.forEach(t),ru.forEach(t),Hp=l(n),qe=a(n,"DIV",{class:!0});var At=s(qe);f(ds.$$.fragment,At),Rk=l(At),_n=a(At,"P",{});var Li=s(_n);Uk=i(Li,`MBART Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),du.forEach(t),ab=l(At),Ae=a(At,"DIV",{class:!0});var Ot=s(Ae);f(hs.$$.fragment,Ot),sb=l(Ot),gn=a(Ot,"P",{});var Gi=s(gn);rb=i(Gi,"The "),vi=a(Gi,"A",{href:!0});var qx=s(vi);ib=i(qx,"MBartForQuestionAnswering"),qx.forEach(t),db=i(Gi," forward method, overrides the "),Wl=a(Gi,"CODE",{});var Bx=s(Wl);lb=i(Bx,"__call__"),Bx.forEach(t),cb=i(Gi," special method."),Gi.forEach(t),pb=l(Ot),f(ao.$$.fragment,Ot),hb=l(Ot),Rl=a(Ot,"P",{});var Fx=s(Rl);ub=i(Fx,"Example:"),Fx.forEach(t),mb=l(Ot),f(us.$$.fragment,Ot),Ot.forEach(t),At.forEach(t),Vp=l(n),kn=a(n,"H2",{class:!0});var lu=s(kn);so=a(lu,"A",{id:!0,class:!0,href:!0});var $x=s(so);Ul=a($x,"SPAN",{});var jx=s(Ul);f(ms.$$.fragment,jx),jx.forEach(t),$x.forEach(t),fb=l(lu),Xl=a(lu,"SPAN",{});var Ex=s(Xl);_b=i(Ex,"MBartForSequenceClassification"),Ex.forEach(t),lu.forEach(t),Qp=l(n),Be=a(n,"DIV",{class:!0});var It=s(Be);f(fs.$$.fragment,It),gb=l(It),Hl=a(It,"P",{});var Px=s(Hl);kb=i(Px,`MBart model with a sequence classification/head on top (a linear layer on top of the pooled output) e.g. for GLUE
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),pu.forEach(t),qb=l(It),Y=a(It,"DIV",{class:!0});var Ge=s(Y);f(bs.$$.fragment,Ge),Bb=l(Ge),bn=a(Ge,"P",{});var Wi=s(bn);Fb=i(Wi,"The "),Mi=a(Wi,"A",{href:!0});var Ax=s(Mi);$b=i(Ax,"MBartForSequenceClassification"),Ax.forEach(t),jb=i(Wi," forward method, overrides the "),Vl=a(Wi,"CODE",{});var Ox=s(Vl);Eb=i(Ox,"__call__"),Ox.forEach(t),Pb=i(Wi," special method."),Wi.forEach(t),Cb=l(Ge),f(ro.$$.fragment,Ge),Sb=l(Ge),Ql=a(Ge,"P",{});var Ix=s(Ql);Ab=i(Ix,"Example of single-label classification:"),Ix.forEach(t),Ob=l(Ge),f(ys.$$.fragment,Ge),Ib=l(Ge),Jl=a(Ge,"P",{});var Nx=s(Jl);Nb=i(Nx,"Example of multi-label classification:"),Nx.forEach(t),Db=l(Ge),f(vs.$$.fragment,Ge),Ge.forEach(t),It.forEach(t),Jp=l(n),yn=a(n,"H2",{class:!0});var hu=s(yn);io=a(hu,"A",{id:!0,class:!0,href:!0});var Dx=s(io);Kl=a(Dx,"SPAN",{});var Lx=s(Kl);f(Ts.$$.fragment,Lx),Lx.forEach(t),Dx.forEach(t),Lb=l(hu),Zl=a(hu,"SPAN",{});var Gx=s(Zl);Gb=i(Gx,"MBartForCausalLM"),Gx.forEach(t),hu.forEach(t),Kp=l(n),vn=a(n,"DIV",{class:!0});var uu=s(vn);f(Ms.$$.fragment,uu),Wb=l(uu),Tt=a(uu,"DIV",{class:!0});var Ri=s(Tt);f(ws.$$.fragment,Ri),Rb=l(Ri),Yl=a(Ri,"P",{});var Wx=s(Yl);Ub=i(Wx,"Example:"),Wx.forEach(t),Xb=l(Ri),f(xs.$$.fragment,Ri),Ri.forEach(t),uu.forEach(t),Zp=l(n),Tn=a(n,"H2",{class:!0});var mu=s(Tn);lo=a(mu,"A",{id:!0,class:!0,href:!0});var Rx=s(lo);ec=a(Rx,"SPAN",{});var Ux=s(ec);f(zs.$$.fragment,Ux),Ux.forEach(t),Rx.forEach(t),Hb=l(mu),tc=a(mu,"SPAN",{});var Xx=s(tc);Vb=i(Xx,"TFMBartModel"),Xx.forEach(t),mu.forEach(t),Yp=l(n),Fe=a(n,"DIV",{class:!0});var Nt=s(Fe);f(qs.$$.fragment,Nt),Qb=l(Nt),Bs=a(Nt,"P",{});var fu=s(Bs);Jb=i(fu,`The bare MBART Model outputting raw hidden-states without any specific head on top.
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),fu.forEach(t),Yb=l(Nt),Fs=a(Nt,"P",{});var _u=s(Fs);ey=i(_u,"This model is also a "),$s=a(_u,"A",{href:!0,rel:!0});var Vx=s($s);ty=i(Vx,"tf.keras.Model"),Vx.forEach(t),ny=i(_u,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),_u.forEach(t),oy=l(Nt),f(co.$$.fragment,Nt),ay=l(Nt),Oe=a(Nt,"DIV",{class:!0});var Dt=s(Oe);f(js.$$.fragment,Dt),sy=l(Dt),Mn=a(Dt,"P",{});var Ui=s(Mn);ry=i(Ui,"The "),xi=a(Ui,"A",{href:!0});var Qx=s(xi);iy=i(Qx,"TFMBartModel"),Qx.forEach(t),dy=i(Ui," forward method, overrides the "),nc=a(Ui,"CODE",{});var Jx=s(nc);ly=i(Jx,"__call__"),Jx.forEach(t),cy=i(Ui," special method."),Ui.forEach(t),py=l(Dt),f(po.$$.fragment,Dt),hy=l(Dt),oc=a(Dt,"P",{});var Kx=s(oc);uy=i(Kx,"Example:"),Kx.forEach(t),my=l(Dt),f(Es.$$.fragment,Dt),Dt.forEach(t),Nt.forEach(t),eh=l(n),wn=a(n,"H2",{class:!0});var gu=s(wn);ho=a(gu,"A",{id:!0,class:!0,href:!0});var Zx=s(ho);ac=a(Zx,"SPAN",{});var Yx=s(ac);f(Ps.$$.fragment,Yx),Yx.forEach(t),Zx.forEach(t),fy=l(gu),sc=a(gu,"SPAN",{});var ez=s(sc);_y=i(ez,"TFMBartForConditionalGeneration"),ez.forEach(t),gu.forEach(t),th=l(n),$e=a(n,"DIV",{class:!0});var Lt=s($e);f(Cs.$$.fragment,Lt),gy=l(Lt),Ss=a(Lt,"P",{});var ku=s(Ss);ky=i(ku,`The MBART Model with a language modeling head. Can be used for summarization.
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),bu.forEach(t),xy=l(Lt),f(uo.$$.fragment,Lt),zy=l(Lt),ee=a(Lt,"DIV",{class:!0});var We=s(ee);f(Is.$$.fragment,We),qy=l(We),xn=a(We,"P",{});var Xi=s(xn);By=i(Xi,"The "),qi=a(Xi,"A",{href:!0});var oz=s(qi);Fy=i(oz,"TFMBartForConditionalGeneration"),oz.forEach(t),$y=i(Xi," forward method, overrides the "),rc=a(Xi,"CODE",{});var az=s(rc);jy=i(az,"__call__"),az.forEach(t),Ey=i(Xi," special method."),Xi.forEach(t),Py=l(We),f(mo.$$.fragment,We),Cy=l(We),ic=a(We,"P",{});var sz=s(ic);Sy=i(sz,"Summarization example:"),sz.forEach(t),Ay=l(We),f(Ns.$$.fragment,We),Oy=l(We),dc=a(We,"P",{});var rz=s(dc);Iy=i(rz,"Mask filling example:"),rz.forEach(t),Ny=l(We),f(Ds.$$.fragment,We),We.forEach(t),Lt.forEach(t),nh=l(n),zn=a(n,"H2",{class:!0});var yu=s(zn);fo=a(yu,"A",{id:!0,class:!0,href:!0});var iz=s(fo);lc=a(iz,"SPAN",{});var dz=s(lc);f(Ls.$$.fragment,dz),dz.forEach(t),iz.forEach(t),Dy=l(yu),cc=a(yu,"SPAN",{});var lz=s(cc);Ly=i(lz,"FlaxMBartModel"),lz.forEach(t),yu.forEach(t),oh=l(n),W=a(n,"DIV",{class:!0});var me=s(W);f(Gs.$$.fragment,me),Gy=l(me),Ws=a(me,"P",{});var vu=s(Ws);Wy=i(vu,`The bare MBart Model transformer outputting raw hidden-states without any specific head on top.
...
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),Tu.forEach(t),Jy=l(me),pc=a(me,"P",{});var hz=s(pc);Ky=i(hz,"Finally, this model supports inherent JAX features such as:"),hz.forEach(t),Zy=l(me),mt=a(me,"UL",{});var $o=s(mt);hc=a($o,"LI",{});var uz=s(hc);Xs=a(uz,"A",{href:!0,rel:!0});var mz=s(Xs);Yy=i(mz,"Just-In-Time (JIT) compilation"),mz.forEach(t),uz.forEach(t),ev=l($o),uc=a($o,"LI",{});var fz=s(uc);Hs=a(fz,"A",{href:!0,rel:!0});var _z=s(Hs);tv=i(_z,"Automatic Differentiation"),_z.forEach(t),fz.forEach(t),nv=l($o),mc=a($o,"LI",{});var gz=s(mc);Vs=a(gz,"A",{href:!0,rel:!0});var kz=s(Vs);ov=i(kz,"Vectorization"),kz.forEach(t),gz.forEach(t),av=l($o),fc=a($o,"LI",{});var bz=s(fc);Qs=a(bz,"A",{href:!0,rel:!0});var yz=s(Qs);sv=i(yz,"Parallelization"),yz.forEach(t),bz.forEach(t),$o.forEach(t),rv=l(me),Ie=a(me,"DIV",{class:!0});var Gt=s(Ie);f(Js.$$.fragment,Gt),iv=l(Gt),qn=a(Gt,"P",{});var Hi=s(qn);dv=i(Hi,"The "),_c=a(Hi,"CODE",{});var vz=s(_c);lv=i(vz,"FlaxMBartPreTrainedModel"),vz.forEach(t),cv=i(Hi,"forward method, overrides the "),gc=a(Hi,"CODE",{});var Tz=s(gc);pv=i(Tz,"__call__"),Tz.forEach(t),hv=i(Hi," special method."),Hi.forEach(t),uv=l(Gt),f(_o.$$.fragment,Gt),mv=l(Gt),kc=a(Gt,"P",{});var Mz=s(kc);fv=i(Mz,"Example:"),Mz.forEach(t),_v=l(Gt),f(Ks.$$.fragment,Gt),Gt.forEach(t),gv=l(me),Mt=a(me,"DIV",{class:!0});var Vi=s(Mt);f(Zs.$$.fragment,Vi),kv=l(Vi),bc=a(Vi,"P",{});var wz=s(bc);bv=i(wz,"Example:"),wz.forEach(t),yv=l(Vi),f(Ys.$$.fragment,Vi),Vi.forEach(t),vv=l(me),wt=a(me,"DIV",{class:!0});var Qi=s(wt);f(er.$$.fragment,Qi),Tv=l(Qi),yc=a(Qi,"P",{});var xz=s(yc);Mv=i(xz,"Example:"),xz.forEach(t),wv=l(Qi),f(tr.$$.fragment,Qi),Qi.forEach(t),me.forEach(t),ah=l(n),Bn=a(n,"H2",{class:!0});var Mu=s(Bn);go=a(Mu,"A",{id:!0,class:!0,href:!0});var zz=s(go);vc=a(zz,"SPAN",{});var qz=s(vc);f(nr.$$.fragment,qz),qz.forEach(t),zz.forEach(t),xv=l(Mu),Tc=a(Mu,"SPAN",{});var Bz=s(Tc);zv=i(Bz,"FlaxMBartForConditionalGeneration"),Bz.forEach(t),Mu.forEach(t),sh=l(n),R=a(n,"DIV",{class:!0});var fe=s(R);f(or.$$.fragment,fe),qv=l(fe),ar=a(fe,"P",{});var wu=s(ar);Bv=i(wu,`The MMBart Model with a language modeling head. Can be used for summarization.
...
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),xu.forEach(t),Sv=l(fe),Mc=a(fe,"P",{});var jz=s(Mc);Av=i(jz,"Finally, this model supports inherent JAX features such as:"),jz.forEach(t),Ov=l(fe),ft=a(fe,"UL",{});var jo=s(ft);wc=a(jo,"LI",{});var Ez=s(wc);ir=a(Ez,"A",{href:!0,rel:!0});var Pz=s(ir);Iv=i(Pz,"Just-In-Time (JIT) compilation"),Pz.forEach(t),Ez.forEach(t),Nv=l(jo),xc=a(jo,"LI",{});var Cz=s(xc);dr=a(Cz,"A",{href:!0,rel:!0});var Sz=s(dr);Dv=i(Sz,"Automatic Differentiation"),Sz.forEach(t),Cz.forEach(t),Lv=l(jo),zc=a(jo,"LI",{});var Az=s(zc);lr=a(Az,"A",{href:!0,rel:!0});var Oz=s(lr);Gv=i(Oz,"Vectorization"),Oz.forEach(t),Az.forEach(t),Wv=l(jo),qc=a(jo,"LI",{});var Iz=s(qc);cr=a(Iz,"A",{href:!0,rel:!0});var Nz=s(cr);Rv=i(Nz,"Parallelization"),Nz.forEach(t),Iz.forEach(t),jo.forEach(t),Uv=l(fe),te=a(fe,"DIV",{class:!0});var Re=s(te);f(pr.$$.fragment,Re),Xv=l(Re),Fn=a(Re,"P",{});var Ji=s(Fn);Hv=i(Ji,"The "),Bc=a(Ji,"CODE",{});var Dz=s(Bc);Vv=i(Dz,"FlaxMBartPreTrainedModel"),Dz.forEach(t),Qv=i(Ji,"forward method, overrides the "),Fc=a(Ji,"CODE",{});var Lz=s(Fc);Jv=i(Lz,"__call__"),Lz.forEach(t),Kv=i(Ji," special method."),Ji.forEach(t),Zv=l(Re),f(ko.$$.fragment,Re),Yv=l(Re),$c=a(Re,"P",{});var Gz=s($c);eT=i(Gz,"Summarization example:"),Gz.forEach(t),tT=l(Re),f(hr.$$.fragment,Re),nT=l(Re),jc=a(Re,"P",{});var Wz=s(jc);oT=i(Wz,"Mask filling example:"),Wz.forEach(t),aT=l(Re),f(ur.$$.fragment,Re),Re.forEach(t),sT=l(fe),xt=a(fe,"DIV",{class:!0});var Ki=s(xt);f(mr.$$.fragment,Ki),rT=l(Ki),Ec=a(Ki,"P",{});var Rz=s(Ec);iT=i(Rz,"Example:"),Rz.forEach(t),dT=l(Ki),f(fr.$$.fragment,Ki),Ki.forEach(t),lT=l(fe),zt=a(fe,"DIV",{class:!0});var Zi=s(zt);f(_r.$$.fragment,Zi),cT=l(Zi),Pc=a(Zi,"P",{});var Uz=s(Pc);pT=i(Uz,"Example:"),Uz.forEach(t),hT=l(Zi),f(gr.$$.fragment,Zi),Zi.forEach(t),fe.forEach(t),rh=l(n),$n=a(n,"H2",{class:!0});var zu=s($n);bo=a(zu,"A",{id:!0,class:!0,href:!0});var Xz=s(bo);Cc=a(Xz,"SPAN",{});var Hz=s(Cc);f(kr.$$.fragment,Hz),Hz.forEach(t),Xz.forEach(t),uT=l(zu),Sc=a(zu,"SPAN",{});var Vz=s(Sc);mT=i(Vz,"FlaxMBartForSequenceClassification"),Vz.forEach(t),zu.forEach(t),ih=l(n),O=a(n,"DIV",{class:!0});var ne=s(O);f(br.$$.fragment,ne),fT=l(ne),Ac=a(ne,"P",{});var Qz=s(Ac);_T=i(Qz,`MBart model with a sequence classification/head on top (a linear layer on top of the pooled output) e.g. for GLUE
tasks.`),Qz.forEach(t),gT=l(ne),yr=a(ne,"P",{});var qu=s(yr);kT=i(qu,"This model inherits from "),$i=a(qu,"A",{href:!0});var Jz=s($i);bT=i(Jz,"FlaxPreTrainedModel"),Jz.forEach(t),yT=i(qu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
