...
<span class="hljs-meta">&gt;&gt;&gt; </span>loss = model(**inputs).loss
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-built_in">round</span>(loss.item(), <span class="hljs-number">2</span>)
<span class="hljs-number">9.52</span>`}}),{c(){p=n("meta"),W=c(),h=n("h1"),_=n("a"),k=n("span"),v(u.$$.fragment),g=c(),P=n("span"),vo=r("SEW"),Vt=c(),O=n("h2"),Z=n("a"),ut=n("span"),v(de.$$.fragment),wo=c(),gt=n("span"),bo=r("Overview"),Lt=c(),ee=n("p"),Eo=r("SEW (Squeezed and Efficient Wav2Vec) was proposed in "),me=n("a"),yo=r(`Performance-Efficiency Trade-offs in Unsupervised Pre-training
...
library implements for all its model (such as downloading or saving etc.).`),da=c(),Ne=n("p"),ma=r("This model is a PyTorch "),Oe=n("a"),pa=r("torch.nn.Module"),fa=r(` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
...
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),co.forEach(o),fn=d(V),F=a(V,"DIV",{class:!0});var L=s(F);w(ke.$$.fragment,L),hn=d(L),J=a(L,"P",{});var ct=s(J);un=i(ct,"The "),ot=a(ct,"A",{href:!0});var Za=s(ot);gn=i(Za,"SEWModel"),Za.forEach(o),_n=i(ct," forward method, overrides the "),Wt=a(ct,"CODE",{});var es=s(Wt);vn=i(es,"__call__"),es.forEach(o),wn=i(ct," special method."),ct.forEach(o),bn=d(L),w(se.$$.fragment,L),En=d(L),kt=a(L,"P",{});var ts=s(kt);yn=i(ts,"Example:"),ts.forEach(o),Sn=d(L),w(Ce.$$.fragment,L),L.forEach(o),V.forEach(o),Yt=d(t),Q=a(t,"H2",{class:!0});var mo=s(Q);re=a(mo,"A",{id:!0,class:!0,href:!0});var os=s(re);Ct=a(os,"SPAN",{});var ns=s(Ct);w(Te.$$.fragment,ns),ns.forEach(o),os.forEach(o),Wn=d(mo),Tt=a(mo,"SPAN",{});var as=s(Tt);kn=i(as,"SEWForCTC"),as.forEach(o),mo.forEach(o),Bt=d(t),x=a(t,"DIV",{class:!0});var I=s(x);w($e.$$.fragment,I),Cn=d(I),Y=a(I,"P",{});var dt=s(Y);Tn=i(dt,"SEW Model with a "),$t=a(dt,"CODE",{});var ss=s($t);$n=i(ss,"language modeling"),ss.forEach(o),jn=i(dt,` head on top for Connectionist Temporal Classification (CTC).
...
Yoav Artzi.`),dt.forEach(o),Pn=d(I),qe=a(I,"P",{});var po=s(qe);Fn=i(po,"This model inherits from "),nt=a(po,"A",{href:!0});var is=s(nt);Mn=i(is,"PreTrainedModel"),is.forEach(o),zn=i(po,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving etc.).`),po.forEach(o),An=d(I),xe=a(I,"P",{});var fo=s(xe);Dn=i(fo,"This model is a PyTorch "),Pe=a(fo,"A",{href:!0,rel:!0});var ls=s(Pe);Vn=i(ls,"torch.nn.Module"),ls.forEach(o),Ln=i(fo,` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),fo.forEach(o),In=d(I),T=a(I,"DIV",{class:!0});var M=s(T);w(Fe.$$.fragment,M),Nn=d(M),B=a(M,"P",{});var mt=s(B);On=i(mt,"The "),at=a(mt,"A",{href:!0});var cs=s(at);Kn=i(cs,"SEWForCTC"),cs.forEach(o),Hn=i(mt," forward method, overrides the "),jt=a(mt,"CODE",{});var ds=s(jt);Rn=i(ds,"__call__"),ds.forEach(o),Un=i(mt," special method."),mt.forEach(o),Jn=d(M),w(ie.$$.fragment,M),Qn=d(M),qt=a(M,"P",{});var ms=s(qt);Yn=i(ms,"Example:"),ms.forEach(o),Bn=d(M),w(Me.$$.fragment,M),Gn=d(M),w(ze.$$.fragment,M),M.forEach(o),I.forEach(o),Gt=d(t),G=a(t,"H2",{class:!0});var ho=s(G);le=a(ho,"A",{id:!0,class:!0,href:!0});var ps=s(le);xt=a(ps,"SPAN",{});var fs=s(xt);w(Ae.$$.fragment,fs),fs.forEach(o),ps.forEach(o),Xn=d(ho),Pt=a(ho,"SPAN",{});var hs=s(Pt);Zn=i(hs,"SEWForSequenceClassification"),hs.forEach(o),ho.forEach(o),Xt=d(t),C=a(t,"DIV",{class:!0});var z=s(C);w(De.$$.fragment,z),ea=d(z),Ft=a(z,"P",{});var us=s(Ft);ta=i(us,`SEW Model with a sequence classification head on top (a linear layer over the pooled output) for tasks like SUPERB
