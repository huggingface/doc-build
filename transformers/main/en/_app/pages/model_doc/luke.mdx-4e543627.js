...
the latter silently ignores them.`)},l(g){h=i(g,"P",{});var f=r(h);E=s(f,"Although the recipe for forward pass needs to be defined within this function, one should call the "),m=i(f,"CODE",{});var z=r(m);w=s(z,"Module"),z.forEach(t),L=s(f,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),f.forEach(t)},m(g,f){u(g,h,f),e(h,E),e(h,m),e(m,w),e(h,L)},d(g){g&&t(h)}}}function up(K){let h,E,m,w,L,g,f,z,Ds,Vo,le,xe,Nn,Ve,Ws,Dn,Bs,Ho,$e,Us,He,Ks,Rs,Yo,Jt,Vs,Qo,Xt,Wn,Hs,Jo,Gt,Ys,Xo,R,Bn,Ye,Qs,Zt,Js,Xs,Gs,Un,q,Zs,Kn,ea,ta,Rn,na,oa,Vn,sa,aa,Hn,ia,ra,en,da,la,ca,Qe,V,tn,pa,ha,Yn,ua,ma,Qn,fa,ga,Jn,_a,ka,ya,Je,nn,Xn,ba,va,Ta,on,Gn,wa,La,Ea,U,Zn,za,xa,ce,qe,sn,$a,qa,Xe,Ca,Fa,Ma,Ce,an,ja,Pa,Ge,Aa,Ia,Oa,rn,dn,Sa,Na,Da,O,ln,Wa,Ba,eo,Ua,Ka,to,Ra,Va,no,Ha,Ya,oo,Qa,Ja,Xa,pe,Ga,cn,Za,ei,Ze,ti,ni,oi,et,si,tt,ai,ii,Go,pn,ri,Zo,nt,es,H,di,ot,li,ci,st,pi,hi,at,ui,mi,ts,he,Fe,so,it,fi,ao,gi,ns,C,rt,_i,dt,ki,hn,yi,bi,vi,ue,Ti,un,wi,Li,mn,Ei,zi,xi,io,$i,qi,lt,os,me,Me,ro,ct,Ci,lo,Fi,ss,F,pt,Mi,co,ji,Pi,x,Ai,fn,Ii,Oi,gn,Si,Ni,_n,Di,Wi,po,Bi,Ui,ho,Ki,Ri,uo,Vi,Hi,mo,Yi,Qi,Ji,je,ht,Xi,fo,Gi,Zi,kn,ut,as,fe,Pe,go,mt,er,_o,tr,is,M,ft,nr,ko,or,sr,gt,ar,yn,ir,rr,dr,_t,lr,kt,cr,pr,hr,S,yt,ur,ge,mr,bn,fr,gr,yo,_r,kr,yr,Ae,br,bo,vr,Tr,bt,rs,_e,Ie,vo,vt,wr,To,Lr,ds,j,Tt,Er,wo,zr,xr,wt,$r,vn,qr,Cr,Fr,Lt,Mr,Et,jr,Pr,Ar,J,zt,Ir,ke,Or,Tn,Sr,Nr,Lo,Dr,Wr,Br,Oe,ls,ye,Se,Eo,xt,Ur,zo,Kr,cs,P,$t,Rr,xo,Vr,Hr,qt,Yr,wn,Qr,Jr,Xr,Ct,Gr,Ft,Zr,ed,td,N,Mt,nd,be,od,Ln,sd,ad,$o,id,rd,dd,Ne,ld,qo,cd,pd,jt,ps,ve,De,Co,Pt,hd,Fo,ud,hs,A,At,md,Mo,fd,gd,It,_d,En,kd,yd,bd,Ot,vd,St,Td,wd,Ld,D,Nt,Ed,Te,zd,zn,xd,$d,jo,qd,Cd,Fd,We,Md,Po,jd,Pd,Dt,us,we,Be,Ao,Wt,Ad,Io,Id,ms,I,Bt,Od,Oo,Sd,Nd,Ut,Dd,xn,Wd,Bd,Ud,Kt,Kd,Rt,Rd,Vd,Hd,W,Vt,Yd,Le,Qd,$n,Jd,Xd,So,Gd,Zd,el,Ue,tl,No,nl,ol,Ht,fs;return g=new ze({}),Ve=new ze({}),nt=new Sn({props:{code:`from transformers import LukeTokenizer, LukeModel, LukeForEntityPairClassification
...
<p><a
  href="/docs/transformers/main/en/main_classes/tokenizer#transformers.BatchEncoding"
>BatchEncoding</a></p>
`}}),ut=new B({props:{name:"save_vocabulary",anchor:"transformers.LukeTokenizer.save_vocabulary",parameters:[{name:"save_directory",val:": str"},{name:"filename_prefix",val:": typing.Optional[str] = None"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/luke/tokenization_luke.py#L1378"}}),mt=new ze({}),ft=new B({props:{name:"class transformers.LukeModel",anchor:"transformers.LukeModel",parameters:[{name:"config",val:": LukeConfig"},{name:"add_pooling_layer",val:": bool = True"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/luke/modeling_luke.py#L879",parametersDescription:[{anchor:"transformers.LukeModel.config",description:`<strong>config</strong> (<a href="/docs/transformers/main/en/model_doc/luke#transformers.LukeConfig">LukeConfig</a>) &#x2014; Model configuration class with all the parameters of the
model. Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/main/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),yt=new B({props:{name:"forward",anchor:"transformers.LukeModel.forward",parameters:[{name:"input_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"attention_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"token_type_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"position_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"entity_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"entity_attention_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"entity_token_type_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"entity_position_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"head_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/luke/modeling_luke.py#L911",parametersDescription:[{anchor:"transformers.LukeModel.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
...
model. Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/main/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),zt=new B({props:{name:"forward",anchor:"transformers.LukeForMaskedLM.forward",parameters:[{name:"input_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"attention_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"token_type_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"position_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"entity_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"entity_attention_mask",val:": typing.Optional[torch.LongTensor] = None"},{name:"entity_token_type_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"entity_position_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"labels",val:": typing.Optional[torch.LongTensor] = None"},{name:"entity_labels",val:": typing.Optional[torch.LongTensor] = None"},{name:"head_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/luke/modeling_luke.py#L1168",parametersDescription:[{anchor:"transformers.LukeForMaskedLM.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/main/en/model_doc/luke#transformers.LukeTokenizer">LukeTokenizer</a>. See <a href="/docs/transformers/main/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/main/en/model_doc/wav2vec2#transformers.Wav2Vec2CTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
model. Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/main/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),Nt=new B({props:{name:"forward",anchor:"transformers.LukeForEntityPairClassification.forward",parameters:[{name:"input_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"attention_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"token_type_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"position_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"entity_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"entity_attention_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"entity_token_type_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"entity_position_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"head_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"labels",val:": typing.Optional[torch.LongTensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/luke/modeling_luke.py#L1396",parametersDescription:[{anchor:"transformers.LukeForEntityPairClassification.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/main/en/model_doc/luke#transformers.LukeTokenizer">LukeTokenizer</a>. See <a href="/docs/transformers/main/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/main/en/model_doc/wav2vec2#transformers.Wav2Vec2CTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
model. Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/main/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),Vt=new B({props:{name:"forward",anchor:"transformers.LukeForEntitySpanClassification.forward",parameters:[{name:"input_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"position_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"entity_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"entity_attention_mask",val:": typing.Optional[torch.LongTensor] = None"},{name:"entity_token_type_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"entity_position_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"entity_start_positions",val:": typing.Optional[torch.LongTensor] = None"},{name:"entity_end_positions",val:": typing.Optional[torch.LongTensor] = None"},{name:"head_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"labels",val:": typing.Optional[torch.LongTensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/luke/modeling_luke.py#L1516",parametersDescription:[{anchor:"transformers.LukeForEntitySpanClassification.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/main/en/model_doc/luke#transformers.LukeTokenizer">LukeTokenizer</a>. See <a href="/docs/transformers/main/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/main/en/model_doc/wav2vec2#transformers.Wav2Vec2CTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
documentation from `),mn=a("a"),Ei=o("PretrainedConfig"),zi=o(" for more information."),xi=l(),io=a("p"),$i=o("Examples:"),qi=l(),_(lt.$$.fragment),os=l(),me=a("h2"),Me=a("a"),ro=a("span"),_(ct.$$.fragment),Ci=l(),lo=a("span"),Fi=o("LukeTokenizer"),ss=l(),F=a("div"),_(pt.$$.fragment),Mi=l(),co=a("p"),ji=o("Construct a LUKE tokenizer."),Pi=l(),x=a("p"),Ai=o("This tokenizer inherits from "),fn=a("a"),Ii=o("RobertaTokenizer"),Oi=o(` which contains most of the main methods. Users should refer to
...
also creates entity sequences, namely `),po=a("code"),Bi=o("entity_ids"),Ui=o(", "),ho=a("code"),Ki=o("entity_attention_mask"),Ri=o(", "),uo=a("code"),Vi=o("entity_token_type_ids"),Hi=o(`, and
`),mo=a("code"),Yi=o("entity_position_ids"),Qi=o(" to be used by the LUKE model."),Ji=l(),je=a("div"),_(ht.$$.fragment),Xi=l(),fo=a("p"),Gi=o(`Main method to tokenize and prepare for the model one or several sequence(s) or one or several pair(s) of
sequences, depending on the task you want to prepare them for.`),Zi=l(),kn=a("div"),_(ut.$$.fragment),as=l(),fe=a("h2"),Pe=a("a"),go=a("span"),_(mt.$$.fragment),er=l(),_o=a("span"),tr=o("LukeModel"),is=l(),M=a("div"),_(ft.$$.fragment),nr=l(),ko=a("p"),or=o("The bare LUKE model transformer outputting raw hidden-states for both word tokens and entities without any specific head on top."),sr=l(),gt=a("p"),ar=o("This model inherits from "),yn=a("a"),ir=o("PreTrainedModel"),rr=o(`. Check the superclass documentation for the generic methods the
...
and behavior.`),hr=l(),S=a("div"),_(yt.$$.fragment),ur=l(),ge=a("p"),mr=o("The "),bn=a("a"),fr=o("LukeModel"),gr=o(" forward method, overrides the "),yo=a("code"),_r=o("__call__"),kr=o(" special method."),yr=l(),_(Ae.$$.fragment),br=l(),bo=a("p"),vr=o("Examples:"),Tr=l(),_(bt.$$.fragment),rs=l(),_e=a("h2"),Ie=a("a"),vo=a("span"),_(vt.$$.fragment),wr=l(),To=a("span"),Lr=o("LukeForMaskedLM"),ds=l(),j=a("div"),_(Tt.$$.fragment),Er=l(),wo=a("p"),zr=o(`The LUKE model with a language modeling head and entity prediction head on top for masked language modeling and
masked entity prediction.`),xr=l(),wt=a("p"),$r=o("This model inherits from "),vn=a("a"),qr=o("PreTrainedModel"),Cr=o(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Fr=l(),Lt=a("p"),Mr=o("This model is also a PyTorch "),Et=a("a"),jr=o("torch.nn.Module"),Pr=o(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Ar=l(),J=a("div"),_(zt.$$.fragment),Ir=l(),ke=a("p"),Or=o("The "),Tn=a("a"),Sr=o("LukeForMaskedLM"),Nr=o(" forward method, overrides the "),Lo=a("code"),Dr=o("__call__"),Wr=o(" special method."),Br=l(),_(Oe.$$.fragment),ls=l(),ye=a("h2"),Se=a("a"),Eo=a("span"),_(xt.$$.fragment),Ur=l(),zo=a("span"),Kr=o("LukeForEntityClassification"),cs=l(),P=a("div"),_($t.$$.fragment),Rr=l(),xo=a("p"),Vr=o(`The LUKE model with a classification head on top (a linear layer on top of the hidden state of the first entity
token) for entity classification tasks, such as Open Entity.`),Hr=l(),qt=a("p"),Yr=o("This model inherits from "),wn=a("a"),Qr=o("PreTrainedModel"),Jr=o(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Xr=l(),Ct=a("p"),Gr=o("This model is also a PyTorch "),Ft=a("a"),Zr=o("torch.nn.Module"),ed=o(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),td=l(),N=a("div"),_(Mt.$$.fragment),nd=l(),be=a("p"),od=o("The "),Ln=a("a"),sd=o("LukeForEntityClassification"),ad=o(" forward method, overrides the "),$o=a("code"),id=o("__call__"),rd=o(" special method."),dd=l(),_(Ne.$$.fragment),ld=l(),qo=a("p"),cd=o("Examples:"),pd=l(),_(jt.$$.fragment),ps=l(),ve=a("h2"),De=a("a"),Co=a("span"),_(Pt.$$.fragment),hd=l(),Fo=a("span"),ud=o("LukeForEntityPairClassification"),hs=l(),A=a("div"),_(At.$$.fragment),md=l(),Mo=a("p"),fd=o(`The LUKE model with a classification head on top (a linear layer on top of the hidden states of the two entity
...
`),Vn=i(Y,"CODE",{});var bl=r(Vn);sa=s(bl,"entity_token_type_ids"),bl.forEach(t),aa=s(Y," and "),Hn=i(Y,"CODE",{});var vl=r(Hn);ia=s(vl,"entity_position_ids"),vl.forEach(t),ra=s(Y,` as extra input. You can obtain those using
...
using Wikipedia entities as input tokens, LUKE outputs token representations enriched by the information stored in
the embeddings of these entities. This is particularly effective for tasks requiring real-world knowledge, such as
question answering.`),al.forEach(t),ys.forEach(t),ks.forEach(t),Ea=c(Ke),U=i(Ke,"LI",{});var X=r(U);Zn=i(X,"P",{});var ql=r(Zn);za=s(ql,"There are three head models for the former use case:"),ql.forEach(t),xa=c(X),ce=i(X,"UL",{});var qn=r(ce);qe=i(qn,"LI",{});var Uo=r(qe);sn=i(Uo,"A",{href:!0});var Cl=r(sn);$a=s(Cl,"LukeForEntityClassification"),Cl.forEach(t),qa=s(Uo,`, for tasks to classify a single entity in an input text such as
entity typing, e.g. the `),Xe=i(Uo,"A",{href:!0,rel:!0});var Fl=r(Xe);Ca=s(Fl,"Open Entity dataset"),Fl.forEach(t),Fa=s(Uo,`.
This model places a linear head on top of the output entity representation.`),Uo.forEach(t),Ma=c(qn),Ce=i(qn,"LI",{});var Ko=r(Ce);an=i(Ko,"A",{href:!0});var Ml=r(an);ja=s(Ml,"LukeForEntityPairClassification"),Ml.forEach(t),Pa=s(Ko,`, for tasks to classify the relationship between two entities
such as relation classification, e.g. the `),Ge=i(Ko,"A",{href:!0,rel:!0});var jl=r(Ge);Aa=s(jl,"TACRED dataset"),jl.forEach(t),Ia=s(Ko,`. This
model places a linear head on top of the concatenated output representation of the pair of given entities.`),Ko.forEach(t),Oa=c(qn),rn=i(qn,"LI",{});var il=r(rn);dn=i(il,"A",{href:!0});var Pl=r(dn);Sa=s(Pl,"LukeForEntitySpanClassification"),Pl.forEach(t),Na=s(il,`, for tasks to classify the sequence of entity spans, such as
named entity recognition (NER). This model places a linear head on top of the output entity representations. You
can address NER using this model by inputting all possible entity spans in the text to the model.`),il.forEach(t),qn.forEach(t),Da=c(X),O=i(X,"P",{});var Q=r(O);ln=i(Q,"A",{href:!0});var Al=r(ln);Wa=s(Al,"LukeTokenizer"),Al.forEach(t),Ba=s(Q," has a "),eo=i(Q,"CODE",{});var Il=r(eo);Ua=s(Il,"task"),Il.forEach(t),Ka=s(Q,` argument, which enables you to easily create an input to these
...
`),oo=i(Q,"CODE",{});var Nl=r(oo);Qa=s(Nl,'task="entity_span_classification"'),Nl.forEach(t),Ja=s(Q,". Please refer to the example code of each head models."),Q.forEach(t),Xa=c(X),pe=i(X,"P",{});var Cn=r(pe);Ga=s(Cn,"A demo notebook on how to fine-tune "),cn=i(Cn,"A",{href:!0});var Dl=r(cn);Za=s(Dl,"LukeForEntityPairClassification"),Dl.forEach(t),ei=s(Cn,` for relation
classification can be found `),Ze=i(Cn,"A",{href:!0,rel:!0});var Wl=r(Ze);ti=s(Wl,"here"),Wl.forEach(t),ni=s(Cn,"."),Cn.forEach(t),oi=c(X),et=i(X,"P",{});var bs=r(et);si=s(bs,`There are also 3 notebooks available, which showcase how you can reproduce the results as reported in the paper with
the HuggingFace implementation of LUKE. They can be found `),tt=i(bs,"A",{href:!0,rel:!0});var Bl=r(tt);ai=s(Bl,"here"),Bl.forEach(t),ii=s(bs,"."),bs.forEach(t),X.forEach(t),Ke.forEach(t),Go=c(n),pn=i(n,"P",{});var Ul=r(pn);ri=s(Ul,"Example:"),Ul.forEach(t),Zo=c(n),k(nt.$$.fragment,n),es=c(n),H=i(n,"P",{});var Re=r(H);di=s(Re,"This model was contributed by "),ot=i(Re,"A",{href:!0,rel:!0});var Kl=r(ot);li=s(Kl,"ikuyamada"),Kl.forEach(t),ci=s(Re," and "),st=i(Re,"A",{href:!0,rel:!0});var Rl=r(st);pi=s(Rl,"nielsr"),Rl.forEach(t),hi=s(Re,". The original code can be found "),at=i(Re,"A",{href:!0,rel:!0});var Vl=r(at);ui=s(Vl,"here"),Vl.forEach(t),mi=s(Re,"."),Re.forEach(t),ts=c(n),he=i(n,"H2",{class:!0});var vs=r(he);Fe=i(vs,"A",{id:!0,class:!0,href:!0});var Hl=r(Fe);so=i(Hl,"SPAN",{});var Yl=r(so);k(it.$$.fragment,Yl),Yl.forEach(t),Hl.forEach(t),fi=c(vs),ao=i(vs,"SPAN",{});var Ql=r(ao);gi=s(Ql,"LukeConfig"),Ql.forEach(t),vs.forEach(t),ns=c(n),C=i(n,"DIV",{class:!0});var G=r(C);k(rt.$$.fragment,G),_i=c(G),dt=i(G,"P",{});var Ts=r(dt);ki=s(Ts,"This is the configuration class to store the configuration of a "),hn=i(Ts,"A",{href:!0});var Jl=r(hn);yi=s(Jl,"LukeModel"),Jl.forEach(t),bi=s(Ts,`. It is used to instantiate a LUKE
model according to the specified arguments, defining the model architecture.`),Ts.forEach(t),vi=c(G),ue=i(G,"P",{});var Fn=r(ue);Ti=s(Fn,"Configuration objects inherit from "),un=i(Fn,"A",{href:!0});var Xl=r(un);wi=s(Xl,"PretrainedConfig"),Xl.forEach(t),Li=s(Fn,` and can be used to control the model outputs. Read the
documentation from `),mn=i(Fn,"A",{href:!0});var Gl=r(mn);Ei=s(Gl,"PretrainedConfig"),Gl.forEach(t),zi=s(Fn," for more information."),Fn.forEach(t),xi=c(G),io=i(G,"P",{});var Zl=r(io);$i=s(Zl,"Examples:"),Zl.forEach(t),qi=c(G),k(lt.$$.fragment,G),G.forEach(t),os=c(n),me=i(n,"H2",{class:!0});var ws=r(me);Me=i(ws,"A",{id:!0,class:!0,href:!0});var ec=r(Me);ro=i(ec,"SPAN",{});var tc=r(ro);k(ct.$$.fragment,tc),tc.forEach(t),ec.forEach(t),Ci=c(ws),lo=i(ws,"SPAN",{});var nc=r(lo);Fi=s(nc,"LukeTokenizer"),nc.forEach(t),ws.forEach(t),ss=c(n),F=i(n,"DIV",{class:!0});var Z=r(F);k(pt.$$.fragment,Z),Mi=c(Z),co=i(Z,"P",{});var oc=r(co);ji=s(oc,"Construct a LUKE tokenizer."),oc.forEach(t),Pi=c(Z),x=i(Z,"P",{});var $=r(x);Ai=s($,"This tokenizer inherits from "),fn=i($,"A",{href:!0});var sc=r(fn);Ii=s(sc,"RobertaTokenizer"),sc.forEach(t),Oi=s($,` which contains most of the main methods. Users should refer to
...
also creates entity sequences, namely `),po=i($,"CODE",{});var rc=r(po);Bi=s(rc,"entity_ids"),rc.forEach(t),Ui=s($,", "),ho=i($,"CODE",{});var dc=r(ho);Ki=s(dc,"entity_attention_mask"),dc.forEach(t),Ri=s($,", "),uo=i($,"CODE",{});var lc=r(uo);Vi=s(lc,"entity_token_type_ids"),lc.forEach(t),Hi=s($,`, and
`),mo=i($,"CODE",{});var cc=r(mo);Yi=s(cc,"entity_position_ids"),cc.forEach(t),Qi=s($," to be used by the LUKE model."),$.forEach(t),Ji=c(Z),je=i(Z,"DIV",{class:!0});var Ls=r(je);k(ht.$$.fragment,Ls),Xi=c(Ls),fo=i(Ls,"P",{});var pc=r(fo);Gi=s(pc,`Main method to tokenize and prepare for the model one or several sequence(s) or one or several pair(s) of
sequences, depending on the task you want to prepare them for.`),pc.forEach(t),Ls.forEach(t),Zi=c(Z),kn=i(Z,"DIV",{class:!0});var hc=r(kn);k(ut.$$.fragment,hc),hc.forEach(t),Z.forEach(t),as=c(n),fe=i(n,"H2",{class:!0});var Es=r(fe);Pe=i(Es,"A",{id:!0,class:!0,href:!0});var uc=r(Pe);go=i(uc,"SPAN",{});var mc=r(go);k(mt.$$.fragment,mc),mc.forEach(t),uc.forEach(t),er=c(Es),_o=i(Es,"SPAN",{});var fc=r(_o);tr=s(fc,"LukeModel"),fc.forEach(t),Es.forEach(t),is=c(n),M=i(n,"DIV",{class:!0});var ee=r(M);k(ft.$$.fragment,ee),nr=c(ee),ko=i(ee,"P",{});var gc=r(ko);or=s(gc,"The bare LUKE model transformer outputting raw hidden-states for both word tokens and entities without any specific head on top."),gc.forEach(t),sr=c(ee),gt=i(ee,"P",{});var zs=r(gt);ar=s(zs,"This model inherits from "),yn=i(zs,"A",{href:!0});var _c=r(yn);ir=s(_c,"PreTrainedModel"),_c.forEach(t),rr=s(zs,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
