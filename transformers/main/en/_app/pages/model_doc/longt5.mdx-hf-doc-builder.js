...
<span class="hljs-meta">&gt;&gt;&gt; </span>outputs = model.decode(decoder_input_ids, encoder_outputs)
<span class="hljs-meta">&gt;&gt;&gt; </span>logits = outputs.logits`}}),{c(){l=r("p"),b=a("Example:"),m=u(),k(p.$$.fragment)},l(n){l=d(n,"P",{});var c=i(l);b=s(c,"Example:"),c.forEach(o),m=h(n),y(p.$$.fragment,n)},m(n,c){T(n,l,c),e(l,b),T(n,m,c),v(p,n,c),_=!0},p:me,i(n){_||(w(p.$$.fragment,n),_=!0)},o(n){$(p.$$.fragment,n),_=!1},d(n){n&&o(l),n&&o(m),x(p,n)}}}function _l(L){let l,b,m,p,_,n,c,z,la,bn,ee,ge,_o,Ke,ca,To,pa,kn,fe,ua,Ze,ha,ma,yn,Vt,ga,vn,Yt,bo,fa,wn,Rt,_a,$n,E,O,Jt,Ta,ba,Kt,ka,ya,ko,va,wa,yo,$a,xa,vo,La,za,wo,qa,Fa,ja,Qe,Ma,Zt,Ca,Ea,Oa,Xe,Pa,$o,Ga,Sa,Aa,F,Na,xo,Ia,Da,Lo,Wa,Ua,zo,Ba,Ha,qo,Va,Ya,Fo,Ra,Ja,jo,Ka,Za,Qa,q,Mo,Xa,es,Co,ts,os,Eo,ns,as,Oo,ss,rs,Po,ds,is,Go,ls,cs,So,ps,us,hs,et,ms,tt,gs,fs,xn,ot,Ln,Q,_s,nt,Ts,bs,at,ks,ys,zn,te,_e,Ao,st,vs,No,ws,qn,K,rt,$s,Z,xs,Qt,Ls,zs,Xt,qs,Fs,dt,js,Ms,Cs,oe,Es,eo,Os,Ps,to,Gs,Ss,Fn,ne,Te,Io,it,As,Do,Ns,jn,j,lt,Is,Wo,Ds,Ws,ct,Us,pt,Bs,Hs,Vs,ut,Ys,oo,Rs,Js,Ks,ht,Zs,mt,Qs,Xs,er,D,gt,tr,ae,or,no,nr,ar,Uo,sr,rr,dr,be,ir,ke,Mn,se,ye,Bo,ft,lr,Ho,cr,Cn,M,_t,pr,Tt,ur,Vo,hr,mr,gr,bt,fr,kt,_r,Tr,br,yt,kr,ao,yr,vr,wr,vt,$r,wt,xr,Lr,zr,W,$t,qr,re,Fr,so,jr,Mr,Yo,Cr,Er,Or,ve,Pr,we,En,de,$e,Ro,xt,Gr,Jo,Sr,On,C,Lt,Ar,Ko,Nr,Ir,zt,Dr,qt,Wr,Ur,Br,Ft,Hr,ro,Vr,Yr,Rr,jt,Jr,Mt,Kr,Zr,Qr,U,Ct,Xr,ie,ed,io,td,od,Zo,nd,ad,sd,xe,rd,Le,Pn,le,ze,Qo,Et,dd,Xo,id,Gn,A,Ot,ld,B,Pt,cd,ce,pd,en,ud,hd,tn,md,gd,fd,qe,_d,Fe,Td,je,Gt,bd,Me,kd,Ce,St,yd,Ee,Sn,pe,Oe,on,At,vd,nn,wd,An,N,Nt,$d,H,It,xd,ue,Ld,an,zd,qd,sn,Fd,jd,Md,Pe,Cd,Ge,Ed,Se,Dt,Od,Ae,Pd,Ne,Wt,Gd,Ie,Nn;return n=new Je({}),Ke=new Je({}),ot=new X({props:{code:`import evaluate
...
Whether or not to return a <a href="/docs/transformers/main/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/longt5/modeling_longt5.py#L1780",returnDescription:`
<p>A <a
...
labels in <code>[0, ..., config.vocab_size]</code>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/longt5/modeling_longt5.py#L1936",returnDescription:`
<p>A <a
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/main/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/longt5/modeling_longt5.py#L2124"}}),Ct=new G({props:{name:"forward",anchor:"transformers.LongT5EncoderModel.forward",parameters:[{name:"input_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"attention_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"head_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.LongT5EncoderModel.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. LongT5 is a model with relative position embeddings so
you should be able to pad the inputs on both the right and the left.</p>
<p>Indices can be obtained using <a href="/docs/transformers/main/en/model_doc/t5#transformers.T5Tokenizer">T5Tokenizer</a>. See <a href="/docs/transformers/main/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/main/en/model_doc/wav2vec2_phoneme#transformers.Wav2Vec2PhonemeCTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for detail.</p>
...
Whether or not to return a <a href="/docs/transformers/main/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/longt5/modeling_longt5.py#L2159",returnDescription:`
<p>A <a
...
<p>If <code>past_key_values</code> are used, the user can optionally input only the last <code>decoder_input_ids</code> (those that
don&#x2019;t have their past key value states given to this model) of shape <code>(batch_size, 1)</code> instead of all
<code>decoder_input_ids</code> of shape <code>(batch_size, sequence_length)</code>.`,name:"past_key_values"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/longt5/modeling_flax_longt5.py#L1718",returnDescription:`
<p>A <a
...
Transient-Global attention.`),yn=u(),Vt=r("p"),ga=a("The abstract from the paper is the following:"),vn=u(),Yt=r("p"),bo=r("em"),fa=a(`Recent work has shown that either (1) increasing the input length or (2) increasing model size can improve the
...
encoder `),ko=r("em"),va=a("self-attention"),wa=a(" layer with efficient either "),yo=r("em"),$a=a("local"),xa=a(" attention or "),vo=r("em"),La=a("transient-global"),za=a(" ("),wo=r("em"),qa=a("tglobal"),Fa=a(") attention."),ja=u(),Qe=r("li"),Ma=a(`Unlike the T5 model, LongT5 does not use a task prefix. Furthermore, it uses a different pre-training objective
inspired by the pre-training of `),Zt=r("a"),Ca=a("PegasusForConditionalGeneration"),Ea=a("."),Oa=u(),Xe=r("li"),Pa=a("LongT5 model is designed to work efficiently and very well on long-range "),$o=r("em"),Ga=a("sequence-to-sequence"),Sa=a(` tasks where the
input sequence exceeds commonly used 512 tokens. It is capable of handling input sequences of a length up to 16,384 tokens.`),Aa=u(),F=r("li"),Na=a("For "),xo=r("em"),Ia=a("Local Attention"),Da=a(", the sparse sliding-window local attention operation allows a given token to attend only "),Lo=r("code"),Wa=a("r"),Ua=a(`
tokens to the left and right of it (with `),zo=r("code"),Ba=a("r=127"),Ha=a(" by default). "),qo=r("em"),Va=a("Local Attention"),Ya=a(` does not introduce any new parameters
...
The original code can be found `),at=r("a"),ks=a("here"),ys=a("."),zn=u(),te=r("h2"),_e=r("a"),Ao=r("span"),k(st.$$.fragment),vs=u(),No=r("span"),ws=a("LongT5Config"),qn=u(),K=r("div"),k(rt.$$.fragment),$s=u(),Z=r("p"),xs=a("This is the configuration class to store the configuration of a "),Qt=r("a"),Ls=a("LongT5Model"),zs=a(" or a "),Xt=r("a"),qs=a("FlaxLongT5Model"),Fs=a(`. It is
used to instantiate a LongT5 model according to the specified arguments, defining the model architecture.
Instantiating a configuration with the defaults will yield a similar configuration to that of the LongT5
`),dt=r("a"),js=a("google/long-t5-local-base"),Ms=a(" architecture."),Cs=u(),oe=r("p"),Es=a("Configuration objects inherit from "),eo=r("a"),Os=a("PretrainedConfig"),Ps=a(` and can be used to control the model outputs. Read the
documentation from `),to=r("a"),Gs=a("PretrainedConfig"),Ss=a(" for more information."),Fn=u(),ne=r("h2"),Te=r("a"),Io=r("span"),k(it.$$.fragment),As=u(),Do=r("span"),Ns=a("LongT5Model"),jn=u(),j=r("div"),k(lt.$$.fragment),Is=u(),Wo=r("p"),Ds=a("The bare LONGT5 Model transformer outputting raw hidden-states without any specific head on top."),Ws=u(),ct=r("p"),Us=a("The LongT5 model was proposed in "),pt=r("a"),Bs=a(`LongT5: Efficient Text-To-Text Transformer for Long
Sequences`),Hs=a(` by Mandy Guo, Joshua Ainslie, David Uthus, Santiago Ontanon, Jianmo
Ni, Yun-Hsuan Sung and Yinfei Yang. It\u2019s an encoder-decoder transformer pre-trained in a text-to-text denoising
generative setting. LongT5 model is an extension of T5 model, and it enables using one of the two different
efficient attention mechanisms - (1) Local attention, or (2) Transient-Global attention.`),Vs=u(),ut=r("p"),Ys=a("This model inherits from "),oo=r("a"),Rs=a("PreTrainedModel"),Js=a(`. Check the superclass documentation for the generic methods the
...
and behavior.`),er=u(),D=r("div"),k(gt.$$.fragment),tr=u(),ae=r("p"),or=a("The "),no=r("a"),nr=a("LongT5Model"),ar=a(" forward method, overrides the "),Uo=r("code"),sr=a("__call__"),rr=a(" special method."),dr=u(),k(be.$$.fragment),ir=u(),k(ke.$$.fragment),Mn=u(),se=r("h2"),ye=r("a"),Bo=r("span"),k(ft.$$.fragment),lr=u(),Ho=r("span"),cr=a("LongT5ForConditionalGeneration"),Cn=u(),M=r("div"),k(_t.$$.fragment),pr=u(),Tt=r("p"),ur=a("LONGT5 Model with a "),Vo=r("code"),hr=a("language modeling"),mr=a(" head on top."),gr=u(),bt=r("p"),fr=a("The LongT5 model was proposed in "),kt=r("a"),_r=a(`LongT5: Efficient Text-To-Text Transformer for Long
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),zr=u(),W=r("div"),k($t.$$.fragment),qr=u(),re=r("p"),Fr=a("The "),so=r("a"),jr=a("LongT5ForConditionalGeneration"),Mr=a(" forward method, overrides the "),Yo=r("code"),Cr=a("__call__"),Er=a(" special method."),Or=u(),k(ve.$$.fragment),Pr=u(),k(we.$$.fragment),En=u(),de=r("h2"),$e=r("a"),Ro=r("span"),k(xt.$$.fragment),Gr=u(),Jo=r("span"),Sr=a("LongT5EncoderModel"),On=u(),C=r("div"),k(Lt.$$.fragment),Ar=u(),Ko=r("p"),Nr=a("The bare LONGT5 Model transformer outputting encoder\u2019s raw hidden-states without any specific head on top."),Ir=u(),zt=r("p"),Dr=a("The LongT5 model was proposed in "),qt=r("a"),Wr=a(`LongT5: Efficient Text-To-Text Transformer for Long
Sequences`),Ur=a(` by Mandy Guo, Joshua Ainslie, David Uthus, Santiago Ontanon, Jianmo
Ni, Yun-Hsuan Sung and Yinfei Yang. It\u2019s an encoder-decoder transformer pre-trained in a text-to-text denoising
generative setting. LongT5 model is an extension of T5 model, and it enables using one of the two different
efficient attention mechanisms - (1) Local attention, or (2) Transient-Global attention.`),Br=u(),Ft=r("p"),Hr=a("This model inherits from "),ro=r("a"),Vr=a("PreTrainedModel"),Yr=a(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Rr=u(),jt=r("p"),Jr=a("This model is also a PyTorch "),Mt=r("a"),Kr=a("torch.nn.Module"),Zr=a(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Qr=u(),U=r("div"),k(Ct.$$.fragment),Xr=u(),ie=r("p"),ed=a("The "),io=r("a"),td=a("LongT5EncoderModel"),od=a(" forward method, overrides the "),Zo=r("code"),nd=a("__call__"),ad=a(" special method."),sd=u(),k(xe.$$.fragment),rd=u(),k(Le.$$.fragment),Pn=u(),le=r("h2"),ze=r("a"),Qo=r("span"),k(Et.$$.fragment),dd=u(),Xo=r("span"),id=a("FlaxLongT5Model"),Gn=u(),A=r("div"),k(Ot.$$.fragment),ld=u(),B=r("div"),k(Pt.$$.fragment),cd=u(),ce=r("p"),pd=a("The "),en=r("code"),ud=a("FlaxLongT5PreTrainedModel"),hd=a(" forward method, overrides the "),tn=r("code"),md=a("__call__"),gd=a(" special method."),fd=u(),k(qe.$$.fragment),_d=u(),k(Fe.$$.fragment),Td=u(),je=r("div"),k(Gt.$$.fragment),bd=u(),k(Me.$$.fragment),kd=u(),Ce=r("div"),k(St.$$.fragment),yd=u(),k(Ee.$$.fragment),Sn=u(),pe=r("h2"),Oe=r("a"),on=r("span"),k(At.$$.fragment),vd=u(),nn=r("span"),wd=a("FlaxLongT5ForConditionalGeneration"),An=u(),N=r("div"),k(Nt.$$.fragment),$d=u(),H=r("div"),k(It.$$.fragment),xd=u(),ue=r("p"),Ld=a("The "),an=r("code"),zd=a("FlaxLongT5PreTrainedModel"),qd=a(" forward method, overrides the "),sn=r("code"),Fd=a("__call__"),jd=a(" special method."),Md=u(),k(Pe.$$.fragment),Cd=u(),k(Ge.$$.fragment),Ed=u(),Se=r("div"),k(Dt.$$.fragment),Od=u(),k(Ae.$$.fragment),Pd=u(),Ne=r("div"),k(Wt.$$.fragment),Gd=u(),k(Ie.$$.fragment),this.h()},l(t){const f=tl('[data-svelte="svelte-1phssyn"]',document.head);l=d(f,"META",{name:!0,content:!0}),f.forEach(o),b=h(t),m=d(t,"H1",{class:!0});var Ut=i(m);p=d(Ut,"A",{id:!0,class:!0,href:!0});var rn=i(p);_=d(rn,"SPAN",{});var dn=i(_);y(n.$$.fragment,dn),dn.forEach(o),rn.forEach(o),c=h(Ut),z=d(Ut,"SPAN",{});var ln=i(z);la=s(ln,"LongT5"),ln.forEach(o),Ut.forEach(o),bn=h(t),ee=d(t,"H2",{class:!0});var Bt=i(ee);ge=d(Bt,"A",{id:!0,class:!0,href:!0});var cn=i(ge);_o=d(cn,"SPAN",{});var pn=i(_o);y(Ke.$$.fragment,pn),pn.forEach(o),cn.forEach(o),ca=h(Bt),To=d(Bt,"SPAN",{});var un=i(To);pa=s(un,"Overview"),un.forEach(o),Bt.forEach(o),kn=h(t),fe=d(t,"P",{});var Ht=i(fe);ua=s(Ht,"The LongT5 model was proposed in "),Ze=d(Ht,"A",{href:!0,rel:!0});var hn=i(Ze);ha=s(hn,"LongT5: Efficient Text-To-Text Transformer for Long Sequences"),hn.forEach(o),ma=s(Ht,`
by Mandy Guo, Joshua Ainslie, David Uthus, Santiago Ontanon, Jianmo Ni, Yun-Hsuan Sung and Yinfei Yang. It\u2019s an
encoder-decoder transformer pre-trained in a text-to-text denoising generative setting. LongT5 model is an extension of
T5 model, and it enables using one of the two different efficient attention mechanisms - (1) Local attention, or (2)
Transient-Global attention.`),Ht.forEach(o),yn=h(t),Vt=d(t,"P",{});var mn=i(Vt);ga=s(mn,"The abstract from the paper is the following:"),mn.forEach(o),vn=h(t),Yt=d(t,"P",{});var gn=i(Yt);bo=d(gn,"EM",{});var fn=i(bo);fa=s(fn,`Recent work has shown that either (1) increasing the input length or (2) increasing model size can improve the
performance of Transformer-based neural models. In this paper, we present a new model, called LongT5, with which we
explore the effects of scaling both the input length and model size at the same time. Specifically, we integrated
attention ideas from long-input transformers (ETC), and adopted pre-training strategies from summarization pre-training
(PEGASUS) into the scalable T5 architecture. The result is a new attention mechanism we call {\\em Transient Global}
...
encoder `),ko=d(I,"EM",{});var Nd=i(ko);va=s(Nd,"self-attention"),Nd.forEach(o),wa=s(I," layer with efficient either "),yo=d(I,"EM",{});var Id=i(yo);$a=s(Id,"local"),Id.forEach(o),xa=s(I," attention or "),vo=d(I,"EM",{});var Dd=i(vo);La=s(Dd,"transient-global"),Dd.forEach(o),za=s(I," ("),wo=d(I,"EM",{});var Wd=i(wo);qa=s(Wd,"tglobal"),Wd.forEach(o),Fa=s(I,") attention."),I.forEach(o),ja=h(V),Qe=d(V,"LI",{});var In=i(Qe);Ma=s(In,`Unlike the T5 model, LongT5 does not use a task prefix. Furthermore, it uses a different pre-training objective
inspired by the pre-training of `),Zt=d(In,"A",{href:!0});var Ud=i(Zt);Ca=s(Ud,"PegasusForConditionalGeneration"),Ud.forEach(o),Ea=s(In,"."),In.forEach(o),Oa=h(V),Xe=d(V,"LI",{});var Dn=i(Xe);Pa=s(Dn,"LongT5 model is designed to work efficiently and very well on long-range "),$o=d(Dn,"EM",{});var Bd=i($o);Ga=s(Bd,"sequence-to-sequence"),Bd.forEach(o),Sa=s(Dn,` tasks where the
input sequence exceeds commonly used 512 tokens. It is capable of handling input sequences of a length up to 16,384 tokens.`),Dn.forEach(o),Aa=h(V),F=d(V,"LI",{});var S=i(F);Na=s(S,"For "),xo=d(S,"EM",{});var Hd=i(xo);Ia=s(Hd,"Local Attention"),Hd.forEach(o),Da=s(S,", the sparse sliding-window local attention operation allows a given token to attend only "),Lo=d(S,"CODE",{});var Vd=i(Lo);Wa=s(Vd,"r"),Vd.forEach(o),Ua=s(S,`
tokens to the left and right of it (with `),zo=d(S,"CODE",{});var Yd=i(zo);Ba=s(Yd,"r=127"),Yd.forEach(o),Ha=s(S," by default). "),qo=d(S,"EM",{});var Rd=i(qo);Va=s(Rd,"Local Attention"),Rd.forEach(o),Ya=s(S,` does not introduce any new parameters
...
a few new parameters \u2014 global relative position biases and a layer normalization for global token\u2019s embedding.
The complexity of this mechanism is `),So=d(P,"CODE",{});var ni=i(So);ps=s(ni,"O(l(r + l/k))"),ni.forEach(o),us=s(P,"."),P.forEach(o),hs=h(V),et=d(V,"LI",{});var Wn=i(et);ms=s(Wn,"An example showing how to evaluate a fine-tuned LongT5 model on the "),tt=d(Wn,"A",{href:!0,rel:!0});var ai=i(tt);gs=s(ai,"pubmed dataset"),ai.forEach(o),fs=s(Wn," is below."),Wn.forEach(o),V.forEach(o),xn=h(t),y(ot.$$.fragment,t),Ln=h(t),Q=d(t,"P",{});var lo=i(Q);_s=s(lo,"This model was contributed by "),nt=d(lo,"A",{href:!0,rel:!0});var si=i(nt);Ts=s(si,"stancld"),si.forEach(o),bs=s(lo,`.
The original code can be found `),at=d(lo,"A",{href:!0,rel:!0});var ri=i(at);ks=s(ri,"here"),ri.forEach(o),ys=s(lo,"."),lo.forEach(o),zn=h(t),te=d(t,"H2",{class:!0});var Un=i(te);_e=d(Un,"A",{id:!0,class:!0,href:!0});var di=i(_e);Ao=d(di,"SPAN",{});var ii=i(Ao);y(st.$$.fragment,ii),ii.forEach(o),di.forEach(o),vs=h(Un),No=d(Un,"SPAN",{});var li=i(No);ws=s(li,"LongT5Config"),li.forEach(o),Un.forEach(o),qn=h(t),K=d(t,"DIV",{class:!0});var co=i(K);y(rt.$$.fragment,co),$s=h(co),Z=d(co,"P",{});var De=i(Z);xs=s(De,"This is the configuration class to store the configuration of a "),Qt=d(De,"A",{href:!0});var ci=i(Qt);Ls=s(ci,"LongT5Model"),ci.forEach(o),zs=s(De," or a "),Xt=d(De,"A",{href:!0});var pi=i(Xt);qs=s(pi,"FlaxLongT5Model"),pi.forEach(o),Fs=s(De,`. It is
used to instantiate a LongT5 model according to the specified arguments, defining the model architecture.
Instantiating a configuration with the defaults will yield a similar configuration to that of the LongT5
`),dt=d(De,"A",{href:!0,rel:!0});var ui=i(dt);js=s(ui,"google/long-t5-local-base"),ui.forEach(o),Ms=s(De," architecture."),De.forEach(o),Cs=h(co),oe=d(co,"P",{});var po=i(oe);Es=s(po,"Configuration objects inherit from "),eo=d(po,"A",{href:!0});var hi=i(eo);Os=s(hi,"PretrainedConfig"),hi.forEach(o),Ps=s(po,` and can be used to control the model outputs. Read the
documentation from `),to=d(po,"A",{href:!0});var mi=i(to);Gs=s(mi,"PretrainedConfig"),mi.forEach(o),Ss=s(po," for more information."),po.forEach(o),co.forEach(o),Fn=h(t),ne=d(t,"H2",{class:!0});var Bn=i(ne);Te=d(Bn,"A",{id:!0,class:!0,href:!0});var gi=i(Te);Io=d(gi,"SPAN",{});var fi=i(Io);y(it.$$.fragment,fi),fi.forEach(o),gi.forEach(o),As=h(Bn),Do=d(Bn,"SPAN",{});var _i=i(Do);Ns=s(_i,"LongT5Model"),_i.forEach(o),Bn.forEach(o),jn=h(t),j=d(t,"DIV",{class:!0});var Y=i(j);y(lt.$$.fragment,Y),Is=h(Y),Wo=d(Y,"P",{});var Ti=i(Wo);Ds=s(Ti,"The bare LONGT5 Model transformer outputting raw hidden-states without any specific head on top."),Ti.forEach(o),Ws=h(Y),ct=d(Y,"P",{});var Hn=i(ct);Us=s(Hn,"The LongT5 model was proposed in "),pt=d(Hn,"A",{href:!0,rel:!0});var bi=i(pt);Bs=s(bi,`LongT5: Efficient Text-To-Text Transformer for Long
Sequences`),bi.forEach(o),Hs=s(Hn,` by Mandy Guo, Joshua Ainslie, David Uthus, Santiago Ontanon, Jianmo
Ni, Yun-Hsuan Sung and Yinfei Yang. It\u2019s an encoder-decoder transformer pre-trained in a text-to-text denoising
generative setting. LongT5 model is an extension of T5 model, and it enables using one of the two different
efficient attention mechanisms - (1) Local attention, or (2) Transient-Global attention.`),Hn.forEach(o),Vs=h(Y),ut=d(Y,"P",{});var Vn=i(ut);Ys=s(Vn,"This model inherits from "),oo=d(Vn,"A",{href:!0});var ki=i(oo);Rs=s(ki,"PreTrainedModel"),ki.forEach(o),Js=s(Vn,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Vn.forEach(o),Ks=h(Y),ht=d(Y,"P",{});var Yn=i(ht);Zs=s(Yn,"This model is also a PyTorch "),mt=d(Yn,"A",{href:!0,rel:!0});var yi=i(mt);Qs=s(yi,"torch.nn.Module"),yi.forEach(o),Xs=s(Yn,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Yn.forEach(o),er=h(Y),D=d(Y,"DIV",{class:!0});var We=i(D);y(gt.$$.fragment,We),tr=h(We),ae=d(We,"P",{});var uo=i(ae);or=s(uo,"The "),no=d(uo,"A",{href:!0});var vi=i(no);nr=s(vi,"LongT5Model"),vi.forEach(o),ar=s(uo," forward method, overrides the "),Uo=d(uo,"CODE",{});var wi=i(Uo);sr=s(wi,"__call__"),wi.forEach(o),rr=s(uo," special method."),uo.forEach(o),dr=h(We),y(be.$$.fragment,We),ir=h(We),y(ke.$$.fragment,We),We.forEach(o),Y.forEach(o),Mn=h(t),se=d(t,"H2",{class:!0});var Rn=i(se);ye=d(Rn,"A",{id:!0,class:!0,href:!0});var $i=i(ye);Bo=d($i,"SPAN",{});var xi=i(Bo);y(ft.$$.fragment,xi),xi.forEach(o),$i.forEach(o),lr=h(Rn),Ho=d(Rn,"SPAN",{});var Li=i(Ho);cr=s(Li,"LongT5ForConditionalGeneration"),Li.forEach(o),Rn.forEach(o),Cn=h(t),M=d(t,"DIV",{class:!0});var R=i(M);y(_t.$$.fragment,R),pr=h(R),Tt=d(R,"P",{});var Jn=i(Tt);ur=s(Jn,"LONGT5 Model with a "),Vo=d(Jn,"CODE",{});var zi=i(Vo);hr=s(zi,"language modeling"),zi.forEach(o),mr=s(Jn," head on top."),Jn.forEach(o),gr=h(R),bt=d(R,"P",{});var Kn=i(bt);fr=s(Kn,"The LongT5 model was proposed in "),kt=d(Kn,"A",{href:!0,rel:!0});var qi=i(kt);_r=s(qi,`LongT5: Efficient Text-To-Text Transformer for Long
Sequences`),qi.forEach(o),Tr=s(Kn,` by Mandy Guo, Joshua Ainslie, David Uthus, Santiago Ontanon, Jianmo
Ni, Yun-Hsuan Sung and Yinfei Yang. It\u2019s an encoder-decoder transformer pre-trained in a text-to-text denoising
generative setting. LongT5 model is an extension of T5 model, and it enables using one of the two different
efficient attention mechanisms - (1) Local attention, or (2) Transient-Global attention.`),Kn.forEach(o),br=h(R),yt=d(R,"P",{});var Zn=i(yt);kr=s(Zn,"This model inherits from "),ao=d(Zn,"A",{href:!0});var Fi=i(ao);yr=s(Fi,"PreTrainedModel"),Fi.forEach(o),vr=s(Zn,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Zn.forEach(o),wr=h(R),vt=d(R,"P",{});var Qn=i(vt);$r=s(Qn,"This model is also a PyTorch "),wt=d(Qn,"A",{href:!0,rel:!0});var ji=i(wt);xr=s(ji,"torch.nn.Module"),ji.forEach(o),Lr=s(Qn,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Qn.forEach(o),zr=h(R),W=d(R,"DIV",{class:!0});var Ue=i(W);y($t.$$.fragment,Ue),qr=h(Ue),re=d(Ue,"P",{});var ho=i(re);Fr=s(ho,"The "),so=d(ho,"A",{href:!0});var Mi=i(so);jr=s(Mi,"LongT5ForConditionalGeneration"),Mi.forEach(o),Mr=s(ho," forward method, overrides the "),Yo=d(ho,"CODE",{});var Ci=i(Yo);Cr=s(Ci,"__call__"),Ci.forEach(o),Er=s(ho," special method."),ho.forEach(o),Or=h(Ue),y(ve.$$.fragment,Ue),Pr=h(Ue),y(we.$$.fragment,Ue),Ue.forEach(o),R.forEach(o),En=h(t),de=d(t,"H2",{class:!0});var Xn=i(de);$e=d(Xn,"A",{id:!0,class:!0,href:!0});var Ei=i($e);Ro=d(Ei,"SPAN",{});var Oi=i(Ro);y(xt.$$.fragment,Oi),Oi.forEach(o),Ei.forEach(o),Gr=h(Xn),Jo=d(Xn,"SPAN",{});var Pi=i(Jo);Sr=s(Pi,"LongT5EncoderModel"),Pi.forEach(o),Xn.forEach(o),On=h(t),C=d(t,"DIV",{class:!0});var J=i(C);y(Lt.$$.fragment,J),Ar=h(J),Ko=d(J,"P",{});var Gi=i(Ko);Nr=s(Gi,"The bare LONGT5 Model transformer outputting encoder\u2019s raw hidden-states without any specific head on top."),Gi.forEach(o),Ir=h(J),zt=d(J,"P",{});var ea=i(zt);Dr=s(ea,"The LongT5 model was proposed in "),qt=d(ea,"A",{href:!0,rel:!0});var Si=i(qt);Wr=s(Si,`LongT5: Efficient Text-To-Text Transformer for Long
Sequences`),Si.forEach(o),Ur=s(ea,` by Mandy Guo, Joshua Ainslie, David Uthus, Santiago Ontanon, Jianmo
Ni, Yun-Hsuan Sung and Yinfei Yang. It\u2019s an encoder-decoder transformer pre-trained in a text-to-text denoising
generative setting. LongT5 model is an extension of T5 model, and it enables using one of the two different
efficient attention mechanisms - (1) Local attention, or (2) Transient-Global attention.`),ea.forEach(o),Br=h(J),Ft=d(J,"P",{});var ta=i(Ft);Hr=s(ta,"This model inherits from "),ro=d(ta,"A",{href:!0});var Ai=i(ro);Vr=s(Ai,"PreTrainedModel"),Ai.forEach(o),Yr=s(ta,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),oa.forEach(o),Qr=h(J),U=d(J,"DIV",{class:!0});var Be=i(U);y(Ct.$$.fragment,Be),Xr=h(Be),ie=d(Be,"P",{});var mo=i(ie);ed=s(mo,"The "),io=d(mo,"A",{href:!0});var Ii=i(io);td=s(Ii,"LongT5EncoderModel"),Ii.forEach(o),od=s(mo," forward method, overrides the "),Zo=d(mo,"CODE",{});var Di=i(Zo);nd=s(Di,"__call__"),Di.forEach(o),ad=s(mo," special method."),mo.forEach(o),sd=h(Be),y(xe.$$.fragment,Be),rd=h(Be),y(Le.$$.fragment,Be),Be.forEach(o),J.forEach(o),Pn=h(t),le=d(t,"H2",{class:!0});var na=i(le);ze=d(na,"A",{id:!0,class:!0,href:!0});var Wi=i(ze);Qo=d(Wi,"SPAN",{});var Ui=i(Qo);y(Et.$$.fragment,Ui),Ui.forEach(o),Wi.forEach(o),dd=h(na),Xo=d(na,"SPAN",{});var Bi=i(Xo);id=s(Bi,"FlaxLongT5Model"),Bi.forEach(o),na.forEach(o),Gn=h(t),A=d(t,"DIV",{class:!0});var He=i(A);y(Ot.$$.fragment,He),ld=h(He),B=d(He,"DIV",{class:!0});var Ve=i(B);y(Pt.$$.fragment,Ve),cd=h(Ve),ce=d(Ve,"P",{});var go=i(ce);pd=s(go,"The "),en=d(go,"CODE",{});var Hi=i(en);ud=s(Hi,"FlaxLongT5PreTrainedModel"),Hi.forEach(o),hd=s(go," forward method, overrides the "),tn=d(go,"CODE",{});var Vi=i(tn);md=s(Vi,"__call__"),Vi.forEach(o),gd=s(go," special method."),go.forEach(o),fd=h(Ve),y(qe.$$.fragment,Ve),_d=h(Ve),y(Fe.$$.fragment,Ve),Ve.forEach(o),Td=h(He),je=d(He,"DIV",{class:!0});var aa=i(je);y(Gt.$$.fragment,aa),bd=h(aa),y(Me.$$.fragment,aa),aa.forEach(o),kd=h(He),Ce=d(He,"DIV",{class:!0});var sa=i(Ce);y(St.$$.fragment,sa),yd=h(sa),y(Ee.$$.fragment,sa),sa.forEach(o),He.forEach(o),Sn=h(t),pe=d(t,"H2",{class:!0});var ra=i(pe);Oe=d(ra,"A",{id:!0,class:!0,href:!0});var Yi=i(Oe);on=d(Yi,"SPAN",{});var Ri=i(on);y(At.$$.fragment,Ri),Ri.forEach(o),Yi.forEach(o),vd=h(ra),nn=d(ra,"SPAN",{});var Ji=i(nn);wd=s(Ji,"FlaxLongT5ForConditionalGeneration"),Ji.forEach(o),ra.forEach(o),An=h(t),N=d(t,"DIV",{class:!0});var Ye=i(N);y(Nt.$$.fragment,Ye),$d=h(Ye),H=d(Ye,"DIV",{class:!0});var Re=i(H);y(It.$$.fragment,Re),xd=h(Re),ue=d(Re,"P",{});var fo=i(ue);Ld=s(fo,"The "),an=d(fo,"CODE",{});var Ki=i(an);zd=s(Ki,"FlaxLongT5PreTrainedModel"),Ki.forEach(o),qd=s(fo," forward method, overrides the "),sn=d(fo,"CODE",{});var Zi=i(sn);Fd=s(Zi,"__call__"),Zi.forEach(o),jd=s(fo," special method."),fo.forEach(o),Md=h(Re),y(Pe.$$.fragment,Re),Cd=h(Re),y(Ge.$$.fragment,Re),Re.forEach(o),Ed=h(Ye),Se=d(Ye,"DIV",{class:!0});var da=i(Se);y(Dt.$$.fragment,da),Od=h(da),y(Ae.$$.fragment,da),da.forEach(o),Pd=h(Ye),Ne=d(Ye,"DIV",{class:!0});var ia=i(Ne);y(Wt.$$.fragment,ia),Gd=h(ia),y(Ie.$$.fragment,ia),ia.forEach(o),Ye.forEach(o),this.h()},h(){g(l,"name","hf:doc:metadata"),g(l,"content",JSON.stringify(Tl)),g(p,"id","longt5"),g(p,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),g(p,"href","#longt5"),g(m,"class","relative group"),g(ge,"id","overview"),g(ge,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),g(ge,"href","#overview"),g(ee,"class","relative group"),g(Ze,"href","https://arxiv.org/abs/2112.07916"),g(Ze,"rel","nofollow"),g(Jt,"href","/docs/transformers/main/en/model_doc/longt5#transformers.LongT5ForConditionalGeneration"),g(Kt,"href","/docs/transformers/main/en/model_doc/t5#transformers.T5ForConditionalGeneration"),g(Zt,"href","/docs/transformers/main/en/model_doc/pegasus#transformers.PegasusForConditionalGeneration"),g(tt,"href","https://huggingface.co/datasets/scientific_papers"),g(tt,"rel","nofollow"),g(nt,"href","https://huggingface.co/stancld"),g(nt,"rel","nofollow"),g(at,"href","https://github.com/google-research/longt5"),g(at,"rel","nofollow"),g(_e,"id","transformers.LongT5Config"),g(_e,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),g(_e,"href","#transformers.LongT5Config"),g(te,"class","relative group"),g(Qt,"href","/docs/transformers/main/en/model_doc/longt5#transformers.LongT5Model"),g(Xt,"href","/docs/transformers/main/en/model_doc/longt5#transformers.FlaxLongT5Model"),g(dt,"href","https://huggingface.co/google/long-t5-local-base"),g(dt,"rel","nofollow"),g(eo,"href","/docs/transformers/main/en/main_classes/configuration#transformers.PretrainedConfig"),g(to,"href","/docs/transformers/main/en/main_classes/configuration#transformers.PretrainedConfig"),g(K,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),g(Te,"id","transformers.LongT5Model"),g(Te,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),g(Te,"href","#transformers.LongT5Model"),g(ne,"class","relative group"),g(pt,"href","https://arxiv.org/abs/2112.07916"),g(pt,"rel","nofollow"),g(oo,"href","/docs/transformers/main/en/main_classes/model#transformers.PreTrainedModel"),g(mt,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),g(mt,"rel","nofollow"),g(no,"href","/docs/transformers/main/en/model_doc/longt5#transformers.LongT5Model"),g(D,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),g(j,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),g(ye,"id","transformers.LongT5ForConditionalGeneration"),g(ye,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),g(ye,"href","#transformers.LongT5ForConditionalGeneration"),g(se,"class","relative group"),g(kt,"href","https://arxiv.org/abs/2112.07916"),g(kt,"rel","nofollow"),g(ao,"href","/docs/transformers/main/en/main_classes/model#transformers.PreTrainedModel"),g(wt,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),g(wt,"rel","nofollow"),g(so,"href","/docs/transformers/main/en/model_doc/longt5#transformers.LongT5ForConditionalGeneration"),g(W,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),g(M,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),g($e,"id","transformers.LongT5EncoderModel"),g($e,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),g($e,"href","#transformers.LongT5EncoderModel"),g(de,"class","relative group"),g(qt,"href","https://arxiv.org/abs/2112.07916"),g(qt,"rel","nofollow"),g(ro,"href","/docs/transformers/main/en/main_classes/model#transformers.PreTrainedModel"),g(Mt,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),g(Mt,"rel","nofollow"),g(io,"href","/docs/transformers/main/en/model_doc/longt5#transformers.LongT5EncoderModel"),g(U,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),g(C,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),g(ze,"id","transformers.FlaxLongT5Model"),g(ze,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),g(ze,"href","#transformers.FlaxLongT5Model"),g(le,"class","relative group"),g(B,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),g(je,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),g(Ce,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),g(A,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),g(Oe,"id","transformers.FlaxLongT5ForConditionalGeneration"),g(Oe,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),g(Oe,"href","#transformers.FlaxLongT5ForConditionalGeneration"),g(pe,"class","relative group"),g(H,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),g(Se,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),g(Ne,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),g(N,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8")},m(t,f){e(document.head,l),T(t,b,f),T(t,m,f),e(m,p),e(p,_),v(n,_,null),e(m,c),e(m,z),e(z,la),T(t,bn,f),T(t,ee,f),e(ee,ge),e(ge,_o),v(Ke,_o,null),e(ee,ca),e(ee,To),e(To,pa),T(t,kn,f),T(t,fe,f),e(fe,ua),e(fe,Ze),e(Ze,ha),e(fe,ma),T(t,yn,f),T(t,Vt,f),e(Vt,ga),T(t,vn,f),T(t,Yt,f),e(Yt,bo),e(bo,fa),T(t,wn,f),T(t,Rt,f),e(Rt,_a),T(t,$n,f),T(t,E,f),e(E,O),e(O,Jt),e(Jt,Ta),e(O,ba),e(O,Kt),e(Kt,ka),e(O,ya),e(O,ko),e(ko,va),e(O,wa),e(O,yo),e(yo,$a),e(O,xa),e(O,vo),e(vo,La),e(O,za),e(O,wo),e(wo,qa),e(O,Fa),e(E,ja),e(E,Qe),e(Qe,Ma),e(Qe,Zt),e(Zt,Ca),e(Qe,Ea),e(E,Oa),e(E,Xe),e(Xe,Pa),e(Xe,$o),e($o,Ga),e(Xe,Sa),e(E,Aa),e(E,F),e(F,Na),e(F,xo),e(xo,Ia),e(F,Da),e(F,Lo),e(Lo,Wa),e(F,Ua),e(F,zo),e(zo,Ba),e(F,Ha),e(F,qo),e(qo,Va),e(F,Ya),e(F,Fo),e(Fo,Ra),e(F,Ja),e(F,jo),e(jo,Ka),e(F,Za),e(E,Qa),e(E,q),e(q,Mo),e(Mo,Xa),e(q,es),e(q,Co),e(Co,ts),e(q,os),e(q,Eo),e(Eo,ns),e(q,as),e(q,Oo),e(Oo,ss),e(q,rs),e(q,Po),e(Po,ds),e(q,is),e(q,Go),e(Go,ls),e(q,cs),e(q,So),e(So,ps),e(q,us),e(E,hs),e(E,et),e(et,ms),e(et,tt),e(tt,gs),e(et,fs),T(t,xn,f),v(ot,t,f),T(t,Ln,f),T(t,Q,f),e(Q,_s),e(Q,nt),e(nt,Ts),e(Q,bs),e(Q,at),e(at,ks),e(Q,ys),T(t,zn,f),T(t,te,f),e(te,_e),e(_e,Ao),v(st,Ao,null),e(te,vs),e(te,No),e(No,ws),T(t,qn,f),T(t,K,f),v(rt,K,null),e(K,$s),e(K,Z),e(Z,xs),e(Z,Qt),e(Qt,Ls),e(Z,zs),e(Z,Xt),e(Xt,qs),e(Z,Fs),e(Z,dt),e(dt,js),e(Z,Ms),e(K,Cs),e(K,oe),e(oe,Es),e(oe,eo),e(eo,Os),e(oe,Ps),e(oe,to),e(to,Gs),e(oe,Ss),T(t,Fn,f),T(t,ne,f),e(ne,Te),e(Te,Io),v(it,Io,null),e(ne,As),e(ne,Do),e(Do,Ns),T(t,jn,f),T(t,j,f),v(lt,j,null),e(j,Is),e(j,Wo),e(Wo,Ds),e(j,Ws),e(j,ct),e(ct,Us),e(ct,pt),e(pt,Bs),e(ct,Hs),e(j,Vs),e(j,ut),e(ut,Ys),e(ut,oo),e(oo,Rs),e(ut,Js),e(j,Ks),e(j,ht),e(ht,Zs),e(ht,mt),e(mt,Qs),e(ht,Xs),e(j,er),e(j,D),v(gt,D,null),e(D,tr),e(D,ae),e(ae,or),e(ae,no),e(no,nr),e(ae,ar),e(ae,Uo),e(Uo,sr),e(ae,rr),e(D,dr),v(be,D,null),e(D,ir),v(ke,D,null),T(t,Mn,f),T(t,se,f),e(se,ye),e(ye,Bo),v(ft,Bo,null),e(se,lr),e(se,Ho),e(Ho,cr),T(t,Cn,f),T(t,M,f),v(_t,M,null),e(M,pr),e(M,Tt),e(Tt,ur),e(Tt,Vo),e(Vo,hr),e(Tt,mr),e(M,gr),e(M,bt),e(bt,fr),e(bt,kt),e(kt,_r),e(bt,Tr),e(M,br),e(M,yt),e(yt,kr),e(yt,ao),e(ao,yr),e(yt,vr),e(M,wr),e(M,vt),e(vt,$r),e(vt,wt),e(wt,xr),e(vt,Lr),e(M,zr),e(M,W),v($t,W,null),e(W,qr),e(W,re),e(re,Fr),e(re,so),e(so,jr),e(re,Mr),e(re,Yo),e(Yo,Cr),e(re,Er),e(W,Or),v(ve,W,null),e(W,Pr),v(we,W,null),T(t,En,f),T(t,de,f),e(de,$e),e($e,Ro),v(xt,Ro,null),e(de,Gr),e(de,Jo),e(Jo,Sr),T(t,On,f),T(t,C,f),v(Lt,C,null),e(C,Ar),e(C,Ko),e(Ko,Nr),e(C,Ir),e(C,zt),e(zt,Dr),e(zt,qt),e(qt,Wr),e(zt,Ur),e(C,Br),e(C,Ft),e(Ft,Hr),e(Ft,ro),e(ro,Vr),e(Ft,Yr),e(C,Rr),e(C,jt),e(jt,Jr),e(jt,Mt),e(Mt,Kr),e(jt,Zr),e(C,Qr),e(C,U),v(Ct,U,null),e(U,Xr),e(U,ie),e(ie,ed),e(ie,io),e(io,td),e(ie,od),e(ie,Zo),e(Zo,nd),e(ie,ad),e(U,sd),v(xe,U,null),e(U,rd),v(Le,U,null),T(t,Pn,f),T(t,le,f),e(le,ze),e(ze,Qo),v(Et,Qo,null),e(le,dd),e(le,Xo),e(Xo,id),T(t,Gn,f),T(t,A,f),v(Ot,A,null),e(A,ld),e(A,B),v(Pt,B,null),e(B,cd),e(B,ce),e(ce,pd),e(ce,en),e(en,ud),e(ce,hd),e(ce,tn),e(tn,md),e(ce,gd),e(B,fd),v(qe,B,null),e(B,_d),v(Fe,B,null),e(A,Td),e(A,je),v(Gt,je,null),e(je,bd),v(Me,je,null),e(A,kd),e(A,Ce),v(St,Ce,null),e(Ce,yd),v(Ee,Ce,null),T(t,Sn,f),T(t,pe,f),e(pe,Oe),e(Oe,on),v(At,on,null),e(pe,vd),e(pe,nn),e(nn,wd),T(t,An,f),T(t,N,f),v(Nt,N,null),e(N,$d),e(N,H),v(It,H,null),e(H,xd),e(H,ue),e(ue,Ld),e(ue,an),e(an,zd),e(ue,qd),e(ue,sn),e(sn,Fd),e(ue,jd),e(H,Md),v(Pe,H,null),e(H,Cd),v(Ge,H,null),e(N,Ed),e(N,Se),v(Dt,Se,null),e(Se,Od),v(Ae,Se,null),e(N,Pd),e(N,Ne),v(Wt,Ne,null),e(Ne,Gd),v(Ie,Ne,null),Nn=!0},p(t,[f]){const Ut={};f&2&&(Ut.$$scope={dirty:f,ctx:t}),be.$set(Ut);const rn={};f&2&&(rn.$$scope={dirty:f,ctx:t}),ke.$set(rn);const dn={};f&2&&(dn.$$scope={dirty:f,ctx:t}),ve.$set(dn);const ln={};f&2&&(ln.$$scope={dirty:f,ctx:t}),we.$set(ln);const Bt={};f&2&&(Bt.$$scope={dirty:f,ctx:t}),xe.$set(Bt);const cn={};f&2&&(cn.$$scope={dirty:f,ctx:t}),Le.$set(cn);const pn={};f&2&&(pn.$$scope={dirty:f,ctx:t}),qe.$set(pn);const un={};f&2&&(un.$$scope={dirty:f,ctx:t}),Fe.$set(un);const Ht={};f&2&&(Ht.$$scope={dirty:f,ctx:t}),Me.$set(Ht);const hn={};f&2&&(hn.$$scope={dirty:f,ctx:t}),Ee.$set(hn);const mn={};f&2&&(mn.$$scope={dirty:f,ctx:t}),Pe.$set(mn);const gn={};f&2&&(gn.$$scope={dirty:f,ctx:t}),Ge.$set(gn);const fn={};f&2&&(fn.$$scope={dirty:f,ctx:t}),Ae.$set(fn);const _n={};f&2&&(_n.$$scope={dirty:f,ctx:t}),Ie.$set(_n)},i(t){Nn||(w(n.$$.fragment,t),w(Ke.$$.fragment,t),w(ot.$$.fragment,t),w(st.$$.fragment,t),w(rt.$$.fragment,t),w(it.$$.fragment,t),w(lt.$$.fragment,t),w(gt.$$.fragment,t),w(be.$$.fragment,t),w(ke.$$.fragment,t),w(ft.$$.fragment,t),w(_t.$$.fragment,t),w($t.$$.fragment,t),w(ve.$$.fragment,t),w(we.$$.fragment,t),w(xt.$$.fragment,t),w(Lt.$$.fragment,t),w(Ct.$$.fragment,t),w(xe.$$.fragment,t),w(Le.$$.fragment,t),w(Et.$$.fragment,t),w(Ot.$$.fragment,t),w(Pt.$$.fragment,t),w(qe.$$.fragment,t),w(Fe.$$.fragment,t),w(Gt.$$.fragment,t),w(Me.$$.fragment,t),w(St.$$.fragment,t),w(Ee.$$.fragment,t),w(At.$$.fragment,t),w(Nt.$$.fragment,t),w(It.$$.fragment,t),w(Pe.$$.fragment,t),w(Ge.$$.fragment,t),w(Dt.$$.fragment,t),w(Ae.$$.fragment,t),w(Wt.$$.fragment,t),w(Ie.$$.fragment,t),Nn=!0)},o(t){$(n.$$.fragment,t),$(Ke.$$.fragment,t),$(ot.$$.fragment,t),$(st.$$.fragment,t),$(rt.$$.fragment,t),$(it.$$.fragment,t),$(lt.$$.fragment,t),$(gt.$$.fragment,t),$(be.$$.fragment,t),$(ke.$$.fragment,t),$(ft.$$.fragment,t),$(_t.$$.fragment,t),$($t.$$.fragment,t),$(ve.$$.fragment,t),$(we.$$.fragment,t),$(xt.$$.fragment,t),$(Lt.$$.fragment,t),$(Ct.$$.fragment,t),$(xe.$$.fragment,t),$(Le.$$.fragment,t),$(Et.$$.fragment,t),$(Ot.$$.fragment,t),$(Pt.$$.fragment,t),$(qe.$$.fragment,t),$(Fe.$$.fragment,t),$(Gt.$$.fragment,t),$(Me.$$.fragment,t),$(St.$$.fragment,t),$(Ee.$$.fragment,t),$(At.$$.fragment,t),$(Nt.$$.fragment,t),$(It.$$.fragment,t),$(Pe.$$.fragment,t),$(Ge.$$.fragment,t),$(Dt.$$.fragment,t),$(Ae.$$.fragment,t),$(Wt.$$.fragment,t),$(Ie.$$.fragment,t),Nn=!1},d(t){o(l),t&&o(b),t&&o(m),x(n),t&&o(bn),t&&o(ee),x(Ke),t&&o(kn),t&&o(fe),t&&o(yn),t&&o(Vt),t&&o(vn),t&&o(Yt),t&&o(wn),t&&o(Rt),t&&o($n),t&&o(E),t&&o(xn),x(ot,t),t&&o(Ln),t&&o(Q),t&&o(zn),t&&o(te),x(st),t&&o(qn),t&&o(K),x(rt),t&&o(Fn),t&&o(ne),x(it),t&&o(jn),t&&o(j),x(lt),x(gt),x(be),x(ke),t&&o(Mn),t&&o(se),x(ft),t&&o(Cn),t&&o(M),x(_t),x($t),x(ve),x(we),t&&o(En),t&&o(de),x(xt),t&&o(On),t&&o(C),x(Lt),x(Ct),x(xe),x(Le),t&&o(Pn),t&&o(le),x(Et),t&&o(Gn),t&&o(A),x(Ot),x(Pt),x(qe),x(Fe),x(Gt),x(Me),x(St),x(Ee),t&&o(Sn),t&&o(pe),x(At),t&&o(An),t&&o(N),x(Nt),x(It),x(Pe),x(Ge),x(Dt),x(Ae),x(Wt),x(Ie)}}}const Tl={local:"longt5",sections:[{local:"overview",title:"Overview"},{local:"transformers.LongT5Config",title:"LongT5Config"},{local:"transformers.LongT5Model",title:"LongT5Model"},{local:"transformers.LongT5ForConditionalGeneration",title:"LongT5ForConditionalGeneration"},{local:"transformers.LongT5EncoderModel",title:"LongT5EncoderModel"},{local:"transformers.FlaxLongT5Model",title:"FlaxLongT5Model"},{local:"transformers.FlaxLongT5ForConditionalGeneration",title:"FlaxLongT5ForConditionalGeneration"}],title:"LongT5"};function bl(L){return ol(()=>{new URLSearchParams(window.location.search).get("fw")}),[]}class Ll extends Qi{constructor(l){super();Xi(this,l,bl,_l,el,{})}}export{Ll as default,Tl as metadata};
