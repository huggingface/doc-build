...
<span class="hljs-meta">&gt;&gt;&gt; </span>outputs = model.decode(decoder_input_ids, encoder_outputs)
<span class="hljs-meta">&gt;&gt;&gt; </span>logits = outputs.logits`}}),{c(){l=r("p"),b=a("Example:"),m=u(),k(p.$$.fragment)},l(n){l=d(n,"P",{});var c=i(l);b=s(c,"Example:"),c.forEach(o),m=h(n),y(p.$$.fragment,n)},m(n,c){T(n,l,c),e(l,b),T(n,m,c),v(p,n,c),_=!0},p:me,i(n){_||(w(p.$$.fragment,n),_=!0)},o(n){$(p.$$.fragment,n),_=!1},d(n){n&&o(l),n&&o(m),x(p,n)}}}function _l(L){let l,b,m,p,_,n,c,z,la,bn,ee,ge,_o,Ke,ca,To,pa,kn,fe,ua,Ze,ha,ma,yn,Vt,ga,vn,Yt,bo,fa,wn,Rt,_a,$n,E,O,Jt,Ta,ba,Kt,ka,ya,ko,va,wa,yo,$a,xa,vo,La,za,wo,qa,Fa,ja,Qe,Ma,Zt,Ca,Ea,Oa,Xe,Pa,$o,Ga,Sa,Aa,F,Na,xo,Ia,Da,Lo,Wa,Ba,zo,Ua,Ha,qo,Va,Ya,Fo,Ra,Ja,jo,Ka,Za,Qa,q,Mo,Xa,es,Co,ts,os,Eo,ns,as,Oo,ss,rs,Po,ds,is,Go,ls,cs,So,ps,us,hs,et,ms,tt,gs,fs,xn,ot,Ln,Q,_s,nt,Ts,bs,at,ks,ys,zn,te,_e,Ao,st,vs,No,ws,qn,K,rt,$s,Z,xs,Qt,Ls,zs,Xt,qs,Fs,dt,js,Ms,Cs,oe,Es,eo,Os,Ps,to,Gs,Ss,Fn,ne,Te,Io,it,As,Do,Ns,jn,j,lt,Is,Wo,Ds,Ws,ct,Bs,pt,Us,Hs,Vs,ut,Ys,oo,Rs,Js,Ks,ht,Zs,mt,Qs,Xs,er,D,gt,tr,ae,or,no,nr,ar,Bo,sr,rr,dr,be,ir,ke,Mn,se,ye,Uo,ft,lr,Ho,cr,Cn,M,_t,pr,Tt,ur,Vo,hr,mr,gr,bt,fr,kt,_r,Tr,br,yt,kr,ao,yr,vr,wr,vt,$r,wt,xr,Lr,zr,W,$t,qr,re,Fr,so,jr,Mr,Yo,Cr,Er,Or,ve,Pr,we,En,de,$e,Ro,xt,Gr,Jo,Sr,On,C,Lt,Ar,Ko,Nr,Ir,zt,Dr,qt,Wr,Br,Ur,Ft,Hr,ro,Vr,Yr,Rr,jt,Jr,Mt,Kr,Zr,Qr,B,Ct,Xr,ie,ed,io,td,od,Zo,nd,ad,sd,xe,rd,Le,Pn,le,ze,Qo,Et,dd,Xo,id,Gn,A,Ot,ld,U,Pt,cd,ce,pd,en,ud,hd,tn,md,gd,fd,qe,_d,Fe,Td,je,Gt,bd,Me,kd,Ce,St,yd,Ee,Sn,pe,Oe,on,At,vd,nn,wd,An,N,Nt,$d,H,It,xd,ue,Ld,an,zd,qd,sn,Fd,jd,Md,Pe,Cd,Ge,Ed,Se,Dt,Od,Ae,Pd,Ne,Wt,Gd,Ie,Nn;return n=new Je({}),Ke=new Je({}),ot=new X({props:{code:`import evaluate
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/main/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/longt5/modeling_longt5.py#L2118"}}),Ct=new G({props:{name:"forward",anchor:"transformers.LongT5EncoderModel.forward",parameters:[{name:"input_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"attention_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"head_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.LongT5EncoderModel.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. LongT5 is a model with relative position embeddings so
you should be able to pad the inputs on both the right and the left.</p>
<p>Indices can be obtained using <a href="/docs/transformers/main/en/model_doc/t5#transformers.T5Tokenizer">T5Tokenizer</a>. See <a href="/docs/transformers/main/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/main/en/model_doc/wav2vec2_phoneme#transformers.Wav2Vec2PhonemeCTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for detail.</p>
...
Whether or not to return a <a href="/docs/transformers/main/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/longt5/modeling_longt5.py#L2153",returnDescription:`
<p>A <a
...
and behavior.`),er=u(),D=r("div"),k(gt.$$.fragment),tr=u(),ae=r("p"),or=a("The "),no=r("a"),nr=a("LongT5Model"),ar=a(" forward method, overrides the "),Bo=r("code"),sr=a("__call__"),rr=a(" special method."),dr=u(),k(be.$$.fragment),ir=u(),k(ke.$$.fragment),Mn=u(),se=r("h2"),ye=r("a"),Uo=r("span"),k(ft.$$.fragment),lr=u(),Ho=r("span"),cr=a("LongT5ForConditionalGeneration"),Cn=u(),M=r("div"),k(_t.$$.fragment),pr=u(),Tt=r("p"),ur=a("LONGT5 Model with a "),Vo=r("code"),hr=a("language modeling"),mr=a(" head on top."),gr=u(),bt=r("p"),fr=a("The LongT5 model was proposed in "),kt=r("a"),_r=a(`LongT5: Efficient Text-To-Text Transformer for Long
...
The original code can be found `),at=d(lo,"A",{href:!0,rel:!0});var ri=i(at);ks=s(ri,"here"),ri.forEach(o),ys=s(lo,"."),lo.forEach(o),zn=h(t),te=d(t,"H2",{class:!0});var Bn=i(te);_e=d(Bn,"A",{id:!0,class:!0,href:!0});var di=i(_e);Ao=d(di,"SPAN",{});var ii=i(Ao);y(st.$$.fragment,ii),ii.forEach(o),di.forEach(o),vs=h(Bn),No=d(Bn,"SPAN",{});var li=i(No);ws=s(li,"LongT5Config"),li.forEach(o),Bn.forEach(o),qn=h(t),K=d(t,"DIV",{class:!0});var co=i(K);y(rt.$$.fragment,co),$s=h(co),Z=d(co,"P",{});var De=i(Z);xs=s(De,"This is the configuration class to store the configuration of a "),Qt=d(De,"A",{href:!0});var ci=i(Qt);Ls=s(ci,"LongT5Model"),ci.forEach(o),zs=s(De," or a "),Xt=d(De,"A",{href:!0});var pi=i(Xt);qs=s(pi,"FlaxLongT5Model"),pi.forEach(o),Fs=s(De,`. It is
used to instantiate a LongT5 model according to the specified arguments, defining the model architecture.
Instantiating a configuration with the defaults will yield a similar configuration to that of the LongT5
...
documentation from `),to=d(po,"A",{href:!0});var mi=i(to);Gs=s(mi,"PretrainedConfig"),mi.forEach(o),Ss=s(po," for more information."),po.forEach(o),co.forEach(o),Fn=h(t),ne=d(t,"H2",{class:!0});var Un=i(ne);Te=d(Un,"A",{id:!0,class:!0,href:!0});var gi=i(Te);Io=d(gi,"SPAN",{});var fi=i(Io);y(it.$$.fragment,fi),fi.forEach(o),gi.forEach(o),As=h(Un),Do=d(Un,"SPAN",{});var _i=i(Do);Ns=s(_i,"LongT5Model"),_i.forEach(o),Un.forEach(o),jn=h(t),j=d(t,"DIV",{class:!0});var Y=i(j);y(lt.$$.fragment,Y),Is=h(Y),Wo=d(Y,"P",{});var Ti=i(Wo);Ds=s(Ti,"The bare LONGT5 Model transformer outputting raw hidden-states without any specific head on top."),Ti.forEach(o),Ws=h(Y),ct=d(Y,"P",{});var Hn=i(ct);Bs=s(Hn,"The LongT5 model was proposed in "),pt=d(Hn,"A",{href:!0,rel:!0});var bi=i(pt);Us=s(bi,`LongT5: Efficient Text-To-Text Transformer for Long
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Yn.forEach(o),er=h(Y),D=d(Y,"DIV",{class:!0});var We=i(D);y(gt.$$.fragment,We),tr=h(We),ae=d(We,"P",{});var uo=i(ae);or=s(uo,"The "),no=d(uo,"A",{href:!0});var vi=i(no);nr=s(vi,"LongT5Model"),vi.forEach(o),ar=s(uo," forward method, overrides the "),Bo=d(uo,"CODE",{});var wi=i(Bo);sr=s(wi,"__call__"),wi.forEach(o),rr=s(uo," special method."),uo.forEach(o),dr=h(We),y(be.$$.fragment,We),ir=h(We),y(ke.$$.fragment,We),We.forEach(o),Y.forEach(o),Mn=h(t),se=d(t,"H2",{class:!0});var Rn=i(se);ye=d(Rn,"A",{id:!0,class:!0,href:!0});var $i=i(ye);Uo=d($i,"SPAN",{});var xi=i(Uo);y(ft.$$.fragment,xi),xi.forEach(o),$i.forEach(o),lr=h(Rn),Ho=d(Rn,"SPAN",{});var Li=i(Ho);cr=s(Li,"LongT5ForConditionalGeneration"),Li.forEach(o),Rn.forEach(o),Cn=h(t),M=d(t,"DIV",{class:!0});var R=i(M);y(_t.$$.fragment,R),pr=h(R),Tt=d(R,"P",{});var Jn=i(Tt);ur=s(Jn,"LONGT5 Model with a "),Vo=d(Jn,"CODE",{});var zi=i(Vo);hr=s(zi,"language modeling"),zi.forEach(o),mr=s(Jn," head on top."),Jn.forEach(o),gr=h(R),bt=d(R,"P",{});var Kn=i(bt);fr=s(Kn,"The LongT5 model was proposed in "),kt=d(Kn,"A",{href:!0,rel:!0});var qi=i(kt);_r=s(qi,`LongT5: Efficient Text-To-Text Transformer for Long
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Qn.forEach(o),zr=h(R),W=d(R,"DIV",{class:!0});var Be=i(W);y($t.$$.fragment,Be),qr=h(Be),re=d(Be,"P",{});var ho=i(re);Fr=s(ho,"The "),so=d(ho,"A",{href:!0});var Mi=i(so);jr=s(Mi,"LongT5ForConditionalGeneration"),Mi.forEach(o),Mr=s(ho," forward method, overrides the "),Yo=d(ho,"CODE",{});var Ci=i(Yo);Cr=s(Ci,"__call__"),Ci.forEach(o),Er=s(ho," special method."),ho.forEach(o),Or=h(Be),y(ve.$$.fragment,Be),Pr=h(Be),y(we.$$.fragment,Be),Be.forEach(o),R.forEach(o),En=h(t),de=d(t,"H2",{class:!0});var Xn=i(de);$e=d(Xn,"A",{id:!0,class:!0,href:!0});var Ei=i($e);Ro=d(Ei,"SPAN",{});var Oi=i(Ro);y(xt.$$.fragment,Oi),Oi.forEach(o),Ei.forEach(o),Gr=h(Xn),Jo=d(Xn,"SPAN",{});var Pi=i(Jo);Sr=s(Pi,"LongT5EncoderModel"),Pi.forEach(o),Xn.forEach(o),On=h(t),C=d(t,"DIV",{class:!0});var J=i(C);y(Lt.$$.fragment,J),Ar=h(J),Ko=d(J,"P",{});var Gi=i(Ko);Nr=s(Gi,"The bare LONGT5 Model transformer outputting encoder\u2019s raw hidden-states without any specific head on top."),Gi.forEach(o),Ir=h(J),zt=d(J,"P",{});var ea=i(zt);Dr=s(ea,"The LongT5 model was proposed in "),qt=d(ea,"A",{href:!0,rel:!0});var Si=i(qt);Wr=s(Si,`LongT5: Efficient Text-To-Text Transformer for Long
Sequences`),Si.forEach(o),Br=s(ea,` by Mandy Guo, Joshua Ainslie, David Uthus, Santiago Ontanon, Jianmo
Ni, Yun-Hsuan Sung and Yinfei Yang. It\u2019s an encoder-decoder transformer pre-trained in a text-to-text denoising
generative setting. LongT5 model is an extension of T5 model, and it enables using one of the two different
efficient attention mechanisms - (1) Local attention, or (2) Transient-Global attention.`),ea.forEach(o),Ur=h(J),Ft=d(J,"P",{});var ta=i(Ft);Hr=s(ta,"This model inherits from "),ro=d(ta,"A",{href:!0});var Ai=i(ro);Vr=s(Ai,"PreTrainedModel"),Ai.forEach(o),Yr=s(ta,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
