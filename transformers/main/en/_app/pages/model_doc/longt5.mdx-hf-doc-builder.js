...
<span class="hljs-meta">&gt;&gt;&gt; </span>outputs = model.decode(decoder_input_ids, encoder_outputs)
<span class="hljs-meta">&gt;&gt;&gt; </span>logits = outputs.logits`}}),{c(){l=r("p"),b=a("Example:"),m=u(),k(p.$$.fragment)},l(n){l=i(n,"P",{});var c=d(l);b=s(c,"Example:"),c.forEach(o),m=h(n),y(p.$$.fragment,n)},m(n,c){T(n,l,c),e(l,b),T(n,m,c),v(p,n,c),_=!0},p:me,i(n){_||(w(p.$$.fragment,n),_=!0)},o(n){$(p.$$.fragment,n),_=!1},d(n){n&&o(l),n&&o(m),x(p,n)}}}function _l(z){let l,b,m,p,_,n,c,L,la,bn,ee,ge,fo,Ke,ca,_o,pa,kn,fe,ua,Ze,ha,ma,yn,Yt,ga,vn,Rt,To,fa,wn,Jt,_a,$n,C,O,Vt,Ta,ba,Kt,ka,ya,bo,va,wa,ko,$a,xa,yo,za,La,vo,Fa,qa,ja,Qe,Ma,wo,Ea,Ca,Oa,Xe,Pa,$o,Ga,Sa,Aa,q,Na,xo,Ia,Da,zo,Wa,Ba,Lo,Ua,Ha,Fo,Ya,Ra,qo,Ja,Va,jo,Ka,Za,Qa,F,Mo,Xa,es,Eo,ts,os,Co,ns,as,Oo,ss,rs,Po,is,ds,Go,ls,cs,So,ps,us,hs,et,ms,tt,gs,fs,xn,ot,zn,Q,_s,nt,Ts,bs,at,ks,ys,Ln,te,_e,Ao,st,vs,No,ws,Fn,K,rt,$s,Z,xs,Zt,zs,Ls,Qt,Fs,qs,it,js,Ms,Es,oe,Cs,Xt,Os,Ps,eo,Gs,Ss,qn,ne,Te,Io,dt,As,Do,Ns,jn,j,lt,Is,Wo,Ds,Ws,ct,Bs,pt,Us,Hs,Ys,ut,Rs,to,Js,Vs,Ks,ht,Zs,mt,Qs,Xs,er,D,gt,tr,ae,or,oo,nr,ar,Bo,sr,rr,ir,be,dr,ke,Mn,se,ye,Uo,ft,lr,Ho,cr,En,M,_t,pr,Tt,ur,Yo,hr,mr,gr,bt,fr,kt,_r,Tr,br,yt,kr,no,yr,vr,wr,vt,$r,wt,xr,zr,Lr,W,$t,Fr,re,qr,ao,jr,Mr,Ro,Er,Cr,Or,ve,Pr,we,Cn,ie,$e,Jo,xt,Gr,Vo,Sr,On,E,zt,Ar,Ko,Nr,Ir,Lt,Dr,Ft,Wr,Br,Ur,qt,Hr,so,Yr,Rr,Jr,jt,Vr,Mt,Kr,Zr,Qr,B,Et,Xr,de,ei,ro,ti,oi,Zo,ni,ai,si,xe,ri,ze,Pn,le,Le,Qo,Ct,ii,Xo,di,Gn,A,Ot,li,U,Pt,ci,ce,pi,en,ui,hi,tn,mi,gi,fi,Fe,_i,qe,Ti,je,Gt,bi,Me,ki,Ee,St,yi,Ce,Sn,pe,Oe,on,At,vi,nn,wi,An,N,Nt,$i,H,It,xi,ue,zi,an,Li,Fi,sn,qi,ji,Mi,Pe,Ei,Ge,Ci,Se,Dt,Oi,Ae,Pi,Ne,Wt,Gi,Ie,Nn;return n=new Ve({}),Ke=new Ve({}),ot=new X({props:{code:`import evaluate
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/main/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/longt5/modeling_longt5.py#L2118"}}),Et=new G({props:{name:"forward",anchor:"transformers.LongT5EncoderModel.forward",parameters:[{name:"input_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"attention_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"head_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.LongT5EncoderModel.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. LongT5 is a model with relative position embeddings so
you should be able to pad the inputs on both the right and the left.</p>
<p>Indices can be obtained using <a href="/docs/transformers/main/en/model_doc/mt5#transformers.T5Tokenizer">T5Tokenizer</a>. See <a href="/docs/transformers/main/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/main/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for detail.</p>
...
`),it=r("a"),js=a("google/long-t5-local-base"),Ms=a(" architecture."),Es=u(),oe=r("p"),Cs=a("Configuration objects inherit from "),Xt=r("a"),Os=a("PretrainedConfig"),Ps=a(` and can be used to control the model outputs. Read the
documentation from `),eo=r("a"),Gs=a("PretrainedConfig"),Ss=a(" for more information."),qn=u(),ne=r("h2"),Te=r("a"),Io=r("span"),k(dt.$$.fragment),As=u(),Do=r("span"),Ns=a("LongT5Model"),jn=u(),j=r("div"),k(lt.$$.fragment),Is=u(),Wo=r("p"),Ds=a("The bare LONGT5 Model transformer outputting raw hidden-states without any specific head on top."),Ws=u(),ct=r("p"),Bs=a("The LongT5 model was proposed in "),pt=r("a"),Us=a(`LongT5: Efficient Text-To-Text Transformer for Long
...
and behavior.`),er=u(),D=r("div"),k(gt.$$.fragment),tr=u(),ae=r("p"),or=a("The "),oo=r("a"),nr=a("LongT5Model"),ar=a(" forward method, overrides the "),Bo=r("code"),sr=a("__call__"),rr=a(" special method."),ir=u(),k(be.$$.fragment),dr=u(),k(ke.$$.fragment),Mn=u(),se=r("h2"),ye=r("a"),Uo=r("span"),k(ft.$$.fragment),lr=u(),Ho=r("span"),cr=a("LongT5ForConditionalGeneration"),En=u(),M=r("div"),k(_t.$$.fragment),pr=u(),Tt=r("p"),ur=a("LONGT5 Model with a "),Yo=r("code"),hr=a("language modeling"),mr=a(" head on top."),gr=u(),bt=r("p"),fr=a("The LongT5 model was proposed in "),kt=r("a"),_r=a(`LongT5: Efficient Text-To-Text Transformer for Long
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Qr=u(),B=r("div"),k(Et.$$.fragment),Xr=u(),de=r("p"),ei=a("The "),ro=r("a"),ti=a("LongT5EncoderModel"),oi=a(" forward method, overrides the "),Zo=r("code"),ni=a("__call__"),ai=a(" special method."),si=u(),k(xe.$$.fragment),ri=u(),k(ze.$$.fragment),Pn=u(),le=r("h2"),Le=r("a"),Qo=r("span"),k(Ct.$$.fragment),ii=u(),Xo=r("span"),di=a("FlaxLongT5Model"),Gn=u(),A=r("div"),k(Ot.$$.fragment),li=u(),U=r("div"),k(Pt.$$.fragment),ci=u(),ce=r("p"),pi=a("The "),en=r("code"),ui=a("FlaxLongT5PreTrainedModel"),hi=a(" forward method, overrides the "),tn=r("code"),mi=a("__call__"),gi=a(" special method."),fi=u(),k(Fe.$$.fragment),_i=u(),k(qe.$$.fragment),Ti=u(),je=r("div"),k(Gt.$$.fragment),bi=u(),k(Me.$$.fragment),ki=u(),Ee=r("div"),k(St.$$.fragment),yi=u(),k(Ce.$$.fragment),Sn=u(),pe=r("h2"),Oe=r("a"),on=r("span"),k(At.$$.fragment),vi=u(),nn=r("span"),wi=a("FlaxLongT5ForConditionalGeneration"),An=u(),N=r("div"),k(Nt.$$.fragment),$i=u(),H=r("div"),k(It.$$.fragment),xi=u(),ue=r("p"),zi=a("The "),an=r("code"),Li=a("FlaxLongT5PreTrainedModel"),Fi=a(" forward method, overrides the "),sn=r("code"),qi=a("__call__"),ji=a(" special method."),Mi=u(),k(Pe.$$.fragment),Ei=u(),k(Ge.$$.fragment),Ci=u(),Se=r("div"),k(Dt.$$.fragment),Oi=u(),k(Ae.$$.fragment),Pi=u(),Ne=r("div"),k(Wt.$$.fragment),Gi=u(),k(Ie.$$.fragment),this.h()},l(t){const f=tl('[data-svelte="svelte-1phssyn"]',document.head);l=i(f,"META",{name:!0,content:!0}),f.forEach(o),b=h(t),m=i(t,"H1",{class:!0});var Bt=d(m);p=i(Bt,"A",{id:!0,class:!0,href:!0});var rn=d(p);_=i(rn,"SPAN",{});var dn=d(_);y(n.$$.fragment,dn),dn.forEach(o),rn.forEach(o),c=h(Bt),L=i(Bt,"SPAN",{});var ln=d(L);la=s(ln,"LongT5"),ln.forEach(o),Bt.forEach(o),bn=h(t),ee=i(t,"H2",{class:!0});var Ut=d(ee);ge=i(Ut,"A",{id:!0,class:!0,href:!0});var cn=d(ge);fo=i(cn,"SPAN",{});var pn=d(fo);y(Ke.$$.fragment,pn),pn.forEach(o),cn.forEach(o),ca=h(Ut),_o=i(Ut,"SPAN",{});var un=d(_o);pa=s(un,"Overview"),un.forEach(o),Ut.forEach(o),kn=h(t),fe=i(t,"P",{});var Ht=d(fe);ua=s(Ht,"The LongT5 model was proposed in "),Ze=i(Ht,"A",{href:!0,rel:!0});var hn=d(Ze);ha=s(hn,"LongT5: Efficient Text-To-Text Transformer for Long Sequences"),hn.forEach(o),ma=s(Ht,`
by Mandy Guo, Joshua Ainslie, David Uthus, Santiago Ontanon, Jianmo Ni, Yun-Hsuan Sung and Yinfei Yang. It\u2019s an
encoder-decoder transformer pre-trained in a text-to-text denoising generative setting. LongT5 model is an extension of
T5 model, and it enables using one of the two different efficient attention mechanisms - (1) Local attention, or (2)
Transient-Global attention.`),Ht.forEach(o),yn=h(t),Yt=i(t,"P",{});var mn=d(Yt);ga=s(mn,"The abstract from the paper is the following:"),mn.forEach(o),vn=h(t),Rt=i(t,"P",{});var gn=d(Rt);To=i(gn,"EM",{});var fn=d(To);fa=s(fn,`Recent work has shown that either (1) increasing the input length or (2) increasing model size can improve the
performance of Transformer-based neural models. In this paper, we present a new model, called LongT5, with which we
explore the effects of scaling both the input length and model size at the same time. Specifically, we integrated
attention ideas from long-input transformers (ETC), and adopted pre-training strategies from summarization pre-training
(PEGASUS) into the scalable T5 architecture. The result is a new attention mechanism we call {\\em Transient Global}
...
a few new parameters \u2014 global relative position biases and a layer normalization for global token\u2019s embedding.
The complexity of this mechanism is `),So=i(P,"CODE",{});var nd=d(So);ps=s(nd,"O(l(r + l/k))"),nd.forEach(o),us=s(P,"."),P.forEach(o),hs=h(Y),et=i(Y,"LI",{});var Wn=d(et);ms=s(Wn,"An example showing how to evaluate a fine-tuned LongT5 model on the "),tt=i(Wn,"A",{href:!0,rel:!0});var ad=d(tt);gs=s(ad,"pubmed dataset"),ad.forEach(o),fs=s(Wn," is below."),Wn.forEach(o),Y.forEach(o),xn=h(t),y(ot.$$.fragment,t),zn=h(t),Q=i(t,"P",{});var io=d(Q);_s=s(io,"This model was contributed by "),nt=i(io,"A",{href:!0,rel:!0});var sd=d(nt);Ts=s(sd,"stancld"),sd.forEach(o),bs=s(io,`.
The original code can be found `),at=i(io,"A",{href:!0,rel:!0});var rd=d(at);ks=s(rd,"here"),rd.forEach(o),ys=s(io,"."),io.forEach(o),Ln=h(t),te=i(t,"H2",{class:!0});var Bn=d(te);_e=i(Bn,"A",{id:!0,class:!0,href:!0});var id=d(_e);Ao=i(id,"SPAN",{});var dd=d(Ao);y(st.$$.fragment,dd),dd.forEach(o),id.forEach(o),vs=h(Bn),No=i(Bn,"SPAN",{});var ld=d(No);ws=s(ld,"LongT5Config"),ld.forEach(o),Bn.forEach(o),Fn=h(t),K=i(t,"DIV",{class:!0});var lo=d(K);y(rt.$$.fragment,lo),$s=h(lo),Z=i(lo,"P",{});var De=d(Z);xs=s(De,"This is the configuration class to store the configuration of a "),Zt=i(De,"A",{href:!0});var cd=d(Zt);zs=s(cd,"LongT5Model"),cd.forEach(o),Ls=s(De," or a "),Qt=i(De,"A",{href:!0});var pd=d(Qt);Fs=s(pd,"FlaxLongT5Model"),pd.forEach(o),qs=s(De,`. It is
used to instantiate a LongT5 model according to the specified arguments, defining the model architecture.
Instantiating a configuration with the defaults will yield a similar configuration to that of the LongT5
`),it=i(De,"A",{href:!0,rel:!0});var ud=d(it);js=s(ud,"google/long-t5-local-base"),ud.forEach(o),Ms=s(De," architecture."),De.forEach(o),Es=h(lo),oe=i(lo,"P",{});var co=d(oe);Cs=s(co,"Configuration objects inherit from "),Xt=i(co,"A",{href:!0});var hd=d(Xt);Os=s(hd,"PretrainedConfig"),hd.forEach(o),Ps=s(co,` and can be used to control the model outputs. Read the
documentation from `),eo=i(co,"A",{href:!0});var md=d(eo);Gs=s(md,"PretrainedConfig"),md.forEach(o),Ss=s(co," for more information."),co.forEach(o),lo.forEach(o),qn=h(t),ne=i(t,"H2",{class:!0});var Un=d(ne);Te=i(Un,"A",{id:!0,class:!0,href:!0});var gd=d(Te);Io=i(gd,"SPAN",{});var fd=d(Io);y(dt.$$.fragment,fd),fd.forEach(o),gd.forEach(o),As=h(Un),Do=i(Un,"SPAN",{});var _d=d(Do);Ns=s(_d,"LongT5Model"),_d.forEach(o),Un.forEach(o),jn=h(t),j=i(t,"DIV",{class:!0});var R=d(j);y(lt.$$.fragment,R),Is=h(R),Wo=i(R,"P",{});var Td=d(Wo);Ds=s(Td,"The bare LONGT5 Model transformer outputting raw hidden-states without any specific head on top."),Td.forEach(o),Ws=h(R),ct=i(R,"P",{});var Hn=d(ct);Bs=s(Hn,"The LongT5 model was proposed in "),pt=i(Hn,"A",{href:!0,rel:!0});var bd=d(pt);Us=s(bd,`LongT5: Efficient Text-To-Text Transformer for Long
Sequences`),bd.forEach(o),Hs=s(Hn,` by Mandy Guo, Joshua Ainslie, David Uthus, Santiago Ontanon, Jianmo
Ni, Yun-Hsuan Sung and Yinfei Yang. It\u2019s an encoder-decoder transformer pre-trained in a text-to-text denoising
generative setting. LongT5 model is an extension of T5 model, and it enables using one of the two different
efficient attention mechanisms - (1) Local attention, or (2) Transient-Global attention.`),Hn.forEach(o),Ys=h(R),ut=i(R,"P",{});var Yn=d(ut);Rs=s(Yn,"This model inherits from "),to=i(Yn,"A",{href:!0});var kd=d(to);Js=s(kd,"PreTrainedModel"),kd.forEach(o),Vs=s(Yn,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Rn.forEach(o),er=h(R),D=i(R,"DIV",{class:!0});var We=d(D);y(gt.$$.fragment,We),tr=h(We),ae=i(We,"P",{});var po=d(ae);or=s(po,"The "),oo=i(po,"A",{href:!0});var vd=d(oo);nr=s(vd,"LongT5Model"),vd.forEach(o),ar=s(po," forward method, overrides the "),Bo=i(po,"CODE",{});var wd=d(Bo);sr=s(wd,"__call__"),wd.forEach(o),rr=s(po," special method."),po.forEach(o),ir=h(We),y(be.$$.fragment,We),dr=h(We),y(ke.$$.fragment,We),We.forEach(o),R.forEach(o),Mn=h(t),se=i(t,"H2",{class:!0});var Jn=d(se);ye=i(Jn,"A",{id:!0,class:!0,href:!0});var $d=d(ye);Uo=i($d,"SPAN",{});var xd=d(Uo);y(ft.$$.fragment,xd),xd.forEach(o),$d.forEach(o),lr=h(Jn),Ho=i(Jn,"SPAN",{});var zd=d(Ho);cr=s(zd,"LongT5ForConditionalGeneration"),zd.forEach(o),Jn.forEach(o),En=h(t),M=i(t,"DIV",{class:!0});var J=d(M);y(_t.$$.fragment,J),pr=h(J),Tt=i(J,"P",{});var Vn=d(Tt);ur=s(Vn,"LONGT5 Model with a "),Yo=i(Vn,"CODE",{});var Ld=d(Yo);hr=s(Ld,"language modeling"),Ld.forEach(o),mr=s(Vn," head on top."),Vn.forEach(o),gr=h(J),bt=i(J,"P",{});var Kn=d(bt);fr=s(Kn,"The LongT5 model was proposed in "),kt=i(Kn,"A",{href:!0,rel:!0});var Fd=d(kt);_r=s(Fd,`LongT5: Efficient Text-To-Text Transformer for Long
Sequences`),Fd.forEach(o),Tr=s(Kn,` by Mandy Guo, Joshua Ainslie, David Uthus, Santiago Ontanon, Jianmo
Ni, Yun-Hsuan Sung and Yinfei Yang. It\u2019s an encoder-decoder transformer pre-trained in a text-to-text denoising
generative setting. LongT5 model is an extension of T5 model, and it enables using one of the two different
efficient attention mechanisms - (1) Local attention, or (2) Transient-Global attention.`),Kn.forEach(o),br=h(J),yt=i(J,"P",{});var Zn=d(yt);kr=s(Zn,"This model inherits from "),no=i(Zn,"A",{href:!0});var qd=d(no);yr=s(qd,"PreTrainedModel"),qd.forEach(o),vr=s(Zn,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
