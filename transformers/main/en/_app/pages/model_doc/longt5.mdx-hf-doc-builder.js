...
<span class="hljs-meta">&gt;&gt;&gt; </span>outputs = model.decode(decoder_input_ids, encoder_outputs)
<span class="hljs-meta">&gt;&gt;&gt; </span>logits = outputs.logits`}}),{c(){l=r("p"),b=a("Example:"),m=u(),k(p.$$.fragment)},l(n){l=i(n,"P",{});var c=d(l);b=s(c,"Example:"),c.forEach(o),m=h(n),y(p.$$.fragment,n)},m(n,c){T(n,l,c),e(l,b),T(n,m,c),v(p,n,c),_=!0},p:me,i(n){_||(w(p.$$.fragment,n),_=!0)},o(n){$(p.$$.fragment,n),_=!1},d(n){n&&o(l),n&&o(m),x(p,n)}}}function _l(z){let l,b,m,p,_,n,c,L,la,bn,ee,ge,fo,Ke,ca,_o,pa,kn,fe,ua,Ze,ha,ma,yn,Yt,ga,vn,Rt,To,fa,wn,Jt,_a,$n,C,O,Vt,Ta,ba,Kt,ka,ya,bo,va,wa,ko,$a,xa,yo,za,La,vo,qa,ja,Fa,Qe,Ma,wo,Ea,Ca,Oa,Xe,Pa,$o,Ga,Sa,Aa,j,Na,xo,Ia,Da,zo,Ba,Wa,Lo,Ua,Ha,qo,Ya,Ra,jo,Ja,Va,Fo,Ka,Za,Qa,q,Mo,Xa,es,Eo,ts,os,Co,ns,as,Oo,ss,rs,Po,is,ds,Go,ls,cs,So,ps,us,hs,et,ms,tt,gs,fs,xn,ot,zn,Q,_s,nt,Ts,bs,at,ks,ys,Ln,te,_e,Ao,st,vs,No,ws,qn,K,rt,$s,Z,xs,Zt,zs,Ls,Qt,qs,js,it,Fs,Ms,Es,oe,Cs,Xt,Os,Ps,eo,Gs,Ss,jn,ne,Te,Io,dt,As,Do,Ns,Fn,F,lt,Is,Bo,Ds,Bs,ct,Ws,pt,Us,Hs,Ys,ut,Rs,to,Js,Vs,Ks,ht,Zs,mt,Qs,Xs,er,D,gt,tr,ae,or,oo,nr,ar,Wo,sr,rr,ir,be,dr,ke,Mn,se,ye,Uo,ft,lr,Ho,cr,En,M,_t,pr,Tt,ur,Yo,hr,mr,gr,bt,fr,kt,_r,Tr,br,yt,kr,no,yr,vr,wr,vt,$r,wt,xr,zr,Lr,B,$t,qr,re,jr,ao,Fr,Mr,Ro,Er,Cr,Or,ve,Pr,we,Cn,ie,$e,Jo,xt,Gr,Vo,Sr,On,E,zt,Ar,Ko,Nr,Ir,Lt,Dr,qt,Br,Wr,Ur,jt,Hr,so,Yr,Rr,Jr,Ft,Vr,Mt,Kr,Zr,Qr,W,Et,Xr,de,ei,ro,ti,oi,Zo,ni,ai,si,xe,ri,ze,Pn,le,Le,Qo,Ct,ii,Xo,di,Gn,A,Ot,li,U,Pt,ci,ce,pi,en,ui,hi,tn,mi,gi,fi,qe,_i,je,Ti,Fe,Gt,bi,Me,ki,Ee,St,yi,Ce,Sn,pe,Oe,on,At,vi,nn,wi,An,N,Nt,$i,H,It,xi,ue,zi,an,Li,qi,sn,ji,Fi,Mi,Pe,Ei,Ge,Ci,Se,Dt,Oi,Ae,Pi,Ne,Bt,Gi,Ie,Nn;return n=new Ve({}),Ke=new Ve({}),ot=new X({props:{code:`import evaluate
...
`),it=r("a"),Fs=a("google/long-t5-local-base"),Ms=a(" architecture."),Es=u(),oe=r("p"),Cs=a("Configuration objects inherit from "),Xt=r("a"),Os=a("PretrainedConfig"),Ps=a(` and can be used to control the model outputs. Read the
documentation from `),eo=r("a"),Gs=a("PretrainedConfig"),Ss=a(" for more information."),jn=u(),ne=r("h2"),Te=r("a"),Io=r("span"),k(dt.$$.fragment),As=u(),Do=r("span"),Ns=a("LongT5Model"),Fn=u(),F=r("div"),k(lt.$$.fragment),Is=u(),Bo=r("p"),Ds=a("The bare LONGT5 Model transformer outputting raw hidden-states without any specific head on top."),Bs=u(),ct=r("p"),Ws=a("The LongT5 model was proposed in "),pt=r("a"),Us=a(`LongT5: Efficient Text-To-Text Transformer for Long
...
and behavior.`),er=u(),D=r("div"),k(gt.$$.fragment),tr=u(),ae=r("p"),or=a("The "),oo=r("a"),nr=a("LongT5Model"),ar=a(" forward method, overrides the "),Wo=r("code"),sr=a("__call__"),rr=a(" special method."),ir=u(),k(be.$$.fragment),dr=u(),k(ke.$$.fragment),Mn=u(),se=r("h2"),ye=r("a"),Uo=r("span"),k(ft.$$.fragment),lr=u(),Ho=r("span"),cr=a("LongT5ForConditionalGeneration"),En=u(),M=r("div"),k(_t.$$.fragment),pr=u(),Tt=r("p"),ur=a("LONGT5 Model with a "),Yo=r("code"),hr=a("language modeling"),mr=a(" head on top."),gr=u(),bt=r("p"),fr=a("The LongT5 model was proposed in "),kt=r("a"),_r=a(`LongT5: Efficient Text-To-Text Transformer for Long
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Rn.forEach(o),er=h(R),D=i(R,"DIV",{class:!0});var Be=d(D);y(gt.$$.fragment,Be),tr=h(Be),ae=i(Be,"P",{});var po=d(ae);or=s(po,"The "),oo=i(po,"A",{href:!0});var vd=d(oo);nr=s(vd,"LongT5Model"),vd.forEach(o),ar=s(po," forward method, overrides the "),Wo=i(po,"CODE",{});var wd=d(Wo);sr=s(wd,"__call__"),wd.forEach(o),rr=s(po," special method."),po.forEach(o),ir=h(Be),y(be.$$.fragment,Be),dr=h(Be),y(ke.$$.fragment,Be),Be.forEach(o),R.forEach(o),Mn=h(t),se=i(t,"H2",{class:!0});var Jn=d(se);ye=i(Jn,"A",{id:!0,class:!0,href:!0});var $d=d(ye);Uo=i($d,"SPAN",{});var xd=d(Uo);y(ft.$$.fragment,xd),xd.forEach(o),$d.forEach(o),lr=h(Jn),Ho=i(Jn,"SPAN",{});var zd=d(Ho);cr=s(zd,"LongT5ForConditionalGeneration"),zd.forEach(o),Jn.forEach(o),En=h(t),M=i(t,"DIV",{class:!0});var J=d(M);y(_t.$$.fragment,J),pr=h(J),Tt=i(J,"P",{});var Vn=d(Tt);ur=s(Vn,"LONGT5 Model with a "),Yo=i(Vn,"CODE",{});var Ld=d(Yo);hr=s(Ld,"language modeling"),Ld.forEach(o),mr=s(Vn," head on top."),Vn.forEach(o),gr=h(J),bt=i(J,"P",{});var Kn=d(bt);fr=s(Kn,"The LongT5 model was proposed in "),kt=i(Kn,"A",{href:!0,rel:!0});var qd=d(kt);_r=s(qd,`LongT5: Efficient Text-To-Text Transformer for Long
Sequences`),qd.forEach(o),Tr=s(Kn,` by Mandy Guo, Joshua Ainslie, David Uthus, Santiago Ontanon, Jianmo
Ni, Yun-Hsuan Sung and Yinfei Yang. It\u2019s an encoder-decoder transformer pre-trained in a text-to-text denoising
generative setting. LongT5 model is an extension of T5 model, and it enables using one of the two different
efficient attention mechanisms - (1) Local attention, or (2) Transient-Global attention.`),Kn.forEach(o),br=h(J),yt=i(J,"P",{});var Zn=d(yt);kr=s(Zn,"This model inherits from "),no=i(Zn,"A",{href:!0});var jd=d(no);yr=s(jd,"PreTrainedModel"),jd.forEach(o),vr=s(Zn,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
