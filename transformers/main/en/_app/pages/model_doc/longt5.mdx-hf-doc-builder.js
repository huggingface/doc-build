...
<span class="hljs-meta">&gt;&gt;&gt; </span>outputs = model.decode(decoder_input_ids, encoder_outputs)
<span class="hljs-meta">&gt;&gt;&gt; </span>logits = outputs.logits`}}),{c(){l=r("p"),b=a("Example:"),m=u(),k(p.$$.fragment)},l(n){l=i(n,"P",{});var c=d(l);b=s(c,"Example:"),c.forEach(o),m=h(n),y(p.$$.fragment,n)},m(n,c){T(n,l,c),e(l,b),T(n,m,c),v(p,n,c),_=!0},p:me,i(n){_||(w(p.$$.fragment,n),_=!0)},o(n){$(p.$$.fragment,n),_=!1},d(n){n&&o(l),n&&o(m),x(p,n)}}}function _l(z){let l,b,m,p,_,n,c,L,la,bn,ee,ge,_o,Ke,ca,To,pa,kn,fe,ua,Ze,ha,ma,yn,Yt,ga,vn,Rt,bo,fa,wn,Jt,_a,$n,C,O,Vt,Ta,ba,Kt,ka,ya,ko,va,wa,yo,$a,xa,vo,za,La,wo,Fa,qa,ja,Qe,Ma,Zt,Ea,Ca,Oa,Xe,Pa,$o,Ga,Sa,Aa,q,Na,xo,Ia,Da,zo,Wa,Ua,Lo,Ba,Ha,Fo,Ya,Ra,qo,Ja,Va,jo,Ka,Za,Qa,F,Mo,Xa,es,Eo,ts,os,Co,ns,as,Oo,ss,rs,Po,is,ds,Go,ls,cs,So,ps,us,hs,et,ms,tt,gs,fs,xn,ot,zn,Q,_s,nt,Ts,bs,at,ks,ys,Ln,te,_e,Ao,st,vs,No,ws,Fn,K,rt,$s,Z,xs,Qt,zs,Ls,Xt,Fs,qs,it,js,Ms,Es,oe,Cs,eo,Os,Ps,to,Gs,Ss,qn,ne,Te,Io,dt,As,Do,Ns,jn,j,lt,Is,Wo,Ds,Ws,ct,Us,pt,Bs,Hs,Ys,ut,Rs,oo,Js,Vs,Ks,ht,Zs,mt,Qs,Xs,er,D,gt,tr,ae,or,no,nr,ar,Uo,sr,rr,ir,be,dr,ke,Mn,se,ye,Bo,ft,lr,Ho,cr,En,M,_t,pr,Tt,ur,Yo,hr,mr,gr,bt,fr,kt,_r,Tr,br,yt,kr,ao,yr,vr,wr,vt,$r,wt,xr,zr,Lr,W,$t,Fr,re,qr,so,jr,Mr,Ro,Er,Cr,Or,ve,Pr,we,Cn,ie,$e,Jo,xt,Gr,Vo,Sr,On,E,zt,Ar,Ko,Nr,Ir,Lt,Dr,Ft,Wr,Ur,Br,qt,Hr,ro,Yr,Rr,Jr,jt,Vr,Mt,Kr,Zr,Qr,U,Et,Xr,de,ei,io,ti,oi,Zo,ni,ai,si,xe,ri,ze,Pn,le,Le,Qo,Ct,ii,Xo,di,Gn,A,Ot,li,B,Pt,ci,ce,pi,en,ui,hi,tn,mi,gi,fi,Fe,_i,qe,Ti,je,Gt,bi,Me,ki,Ee,St,yi,Ce,Sn,pe,Oe,on,At,vi,nn,wi,An,N,Nt,$i,H,It,xi,ue,zi,an,Li,Fi,sn,qi,ji,Mi,Pe,Ei,Ge,Ci,Se,Dt,Oi,Ae,Pi,Ne,Wt,Gi,Ie,Nn;return n=new Ve({}),Ke=new Ve({}),ot=new X({props:{code:`import evaluate
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/main/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/longt5/modeling_longt5.py#L2124"}}),Et=new G({props:{name:"forward",anchor:"transformers.LongT5EncoderModel.forward",parameters:[{name:"input_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"attention_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"head_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.LongT5EncoderModel.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. LongT5 is a model with relative position embeddings so
you should be able to pad the inputs on both the right and the left.</p>
<p>Indices can be obtained using <a href="/docs/transformers/main/en/model_doc/t5#transformers.T5Tokenizer">T5Tokenizer</a>. See <a href="/docs/transformers/main/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/main/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for detail.</p>
...
input sequence exceeds commonly used 512 tokens. It is capable of handling input sequences of a length up to 16,384 tokens.`),Aa=u(),q=r("li"),Na=a("For "),xo=r("em"),Ia=a("Local Attention"),Da=a(", the sparse sliding-window local attention operation allows a given token to attend only "),zo=r("code"),Wa=a("r"),Ua=a(`
tokens to the left and right of it (with `),Lo=r("code"),Ba=a("r=127"),Ha=a(" by default). "),Fo=r("em"),Ya=a("Local Attention"),Ra=a(` does not introduce any new parameters
...
and behavior.`),er=u(),D=r("div"),k(gt.$$.fragment),tr=u(),ae=r("p"),or=a("The "),no=r("a"),nr=a("LongT5Model"),ar=a(" forward method, overrides the "),Uo=r("code"),sr=a("__call__"),rr=a(" special method."),ir=u(),k(be.$$.fragment),dr=u(),k(ke.$$.fragment),Mn=u(),se=r("h2"),ye=r("a"),Bo=r("span"),k(ft.$$.fragment),lr=u(),Ho=r("span"),cr=a("LongT5ForConditionalGeneration"),En=u(),M=r("div"),k(_t.$$.fragment),pr=u(),Tt=r("p"),ur=a("LONGT5 Model with a "),Yo=r("code"),hr=a("language modeling"),mr=a(" head on top."),gr=u(),bt=r("p"),fr=a("The LongT5 model was proposed in "),kt=r("a"),_r=a(`LongT5: Efficient Text-To-Text Transformer for Long
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Lr=u(),W=r("div"),k($t.$$.fragment),Fr=u(),re=r("p"),qr=a("The "),so=r("a"),jr=a("LongT5ForConditionalGeneration"),Mr=a(" forward method, overrides the "),Ro=r("code"),Er=a("__call__"),Cr=a(" special method."),Or=u(),k(ve.$$.fragment),Pr=u(),k(we.$$.fragment),Cn=u(),ie=r("h2"),$e=r("a"),Jo=r("span"),k(xt.$$.fragment),Gr=u(),Vo=r("span"),Sr=a("LongT5EncoderModel"),On=u(),E=r("div"),k(zt.$$.fragment),Ar=u(),Ko=r("p"),Nr=a("The bare LONGT5 Model transformer outputting encoder\u2019s raw hidden-states without any specific head on top."),Ir=u(),Lt=r("p"),Dr=a("The LongT5 model was proposed in "),Ft=r("a"),Wr=a(`LongT5: Efficient Text-To-Text Transformer for Long
Sequences`),Ur=a(` by Mandy Guo, Joshua Ainslie, David Uthus, Santiago Ontanon, Jianmo
Ni, Yun-Hsuan Sung and Yinfei Yang. It\u2019s an encoder-decoder transformer pre-trained in a text-to-text denoising
generative setting. LongT5 model is an extension of T5 model, and it enables using one of the two different
efficient attention mechanisms - (1) Local attention, or (2) Transient-Global attention.`),Br=u(),qt=r("p"),Hr=a("This model inherits from "),ro=r("a"),Yr=a("PreTrainedModel"),Rr=a(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Jr=u(),jt=r("p"),Vr=a("This model is also a PyTorch "),Mt=r("a"),Kr=a("torch.nn.Module"),Zr=a(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Qr=u(),U=r("div"),k(Et.$$.fragment),Xr=u(),de=r("p"),ei=a("The "),io=r("a"),ti=a("LongT5EncoderModel"),oi=a(" forward method, overrides the "),Zo=r("code"),ni=a("__call__"),ai=a(" special method."),si=u(),k(xe.$$.fragment),ri=u(),k(ze.$$.fragment),Pn=u(),le=r("h2"),Le=r("a"),Qo=r("span"),k(Ct.$$.fragment),ii=u(),Xo=r("span"),di=a("FlaxLongT5Model"),Gn=u(),A=r("div"),k(Ot.$$.fragment),li=u(),B=r("div"),k(Pt.$$.fragment),ci=u(),ce=r("p"),pi=a("The "),en=r("code"),ui=a("FlaxLongT5PreTrainedModel"),hi=a(" forward method, overrides the "),tn=r("code"),mi=a("__call__"),gi=a(" special method."),fi=u(),k(Fe.$$.fragment),_i=u(),k(qe.$$.fragment),Ti=u(),je=r("div"),k(Gt.$$.fragment),bi=u(),k(Me.$$.fragment),ki=u(),Ee=r("div"),k(St.$$.fragment),yi=u(),k(Ce.$$.fragment),Sn=u(),pe=r("h2"),Oe=r("a"),on=r("span"),k(At.$$.fragment),vi=u(),nn=r("span"),wi=a("FlaxLongT5ForConditionalGeneration"),An=u(),N=r("div"),k(Nt.$$.fragment),$i=u(),H=r("div"),k(It.$$.fragment),xi=u(),ue=r("p"),zi=a("The "),an=r("code"),Li=a("FlaxLongT5PreTrainedModel"),Fi=a(" forward method, overrides the "),sn=r("code"),qi=a("__call__"),ji=a(" special method."),Mi=u(),k(Pe.$$.fragment),Ei=u(),k(Ge.$$.fragment),Ci=u(),Se=r("div"),k(Dt.$$.fragment),Oi=u(),k(Ae.$$.fragment),Pi=u(),Ne=r("div"),k(Wt.$$.fragment),Gi=u(),k(Ie.$$.fragment),this.h()},l(t){const f=tl('[data-svelte="svelte-1phssyn"]',document.head);l=i(f,"META",{name:!0,content:!0}),f.forEach(o),b=h(t),m=i(t,"H1",{class:!0});var Ut=d(m);p=i(Ut,"A",{id:!0,class:!0,href:!0});var rn=d(p);_=i(rn,"SPAN",{});var dn=d(_);y(n.$$.fragment,dn),dn.forEach(o),rn.forEach(o),c=h(Ut),L=i(Ut,"SPAN",{});var ln=d(L);la=s(ln,"LongT5"),ln.forEach(o),Ut.forEach(o),bn=h(t),ee=i(t,"H2",{class:!0});var Bt=d(ee);ge=i(Bt,"A",{id:!0,class:!0,href:!0});var cn=d(ge);_o=i(cn,"SPAN",{});var pn=d(_o);y(Ke.$$.fragment,pn),pn.forEach(o),cn.forEach(o),ca=h(Bt),To=i(Bt,"SPAN",{});var un=d(To);pa=s(un,"Overview"),un.forEach(o),Bt.forEach(o),kn=h(t),fe=i(t,"P",{});var Ht=d(fe);ua=s(Ht,"The LongT5 model was proposed in "),Ze=i(Ht,"A",{href:!0,rel:!0});var hn=d(Ze);ha=s(hn,"LongT5: Efficient Text-To-Text Transformer for Long Sequences"),hn.forEach(o),ma=s(Ht,`
by Mandy Guo, Joshua Ainslie, David Uthus, Santiago Ontanon, Jianmo Ni, Yun-Hsuan Sung and Yinfei Yang. It\u2019s an
encoder-decoder transformer pre-trained in a text-to-text denoising generative setting. LongT5 model is an extension of
T5 model, and it enables using one of the two different efficient attention mechanisms - (1) Local attention, or (2)
...
encoder `),ko=i(I,"EM",{});var Ni=d(ko);va=s(Ni,"self-attention"),Ni.forEach(o),wa=s(I," layer with efficient either "),yo=i(I,"EM",{});var Ii=d(yo);$a=s(Ii,"local"),Ii.forEach(o),xa=s(I," attention or "),vo=i(I,"EM",{});var Di=d(vo);za=s(Di,"transient-global"),Di.forEach(o),La=s(I," ("),wo=i(I,"EM",{});var Wi=d(wo);Fa=s(Wi,"tglobal"),Wi.forEach(o),qa=s(I,") attention."),I.forEach(o),ja=h(Y),Qe=i(Y,"LI",{});var In=d(Qe);Ma=s(In,`Unlike the T5 model, LongT5 does not use a task prefix. Furthermore, it uses a different pre-training objective
inspired by the pre-training of `),Zt=i(In,"A",{href:!0});var Ui=d(Zt);Ea=s(Ui,"PegasusForConditionalGeneration"),Ui.forEach(o),Ca=s(In,"."),In.forEach(o),Oa=h(Y),Xe=i(Y,"LI",{});var Dn=d(Xe);Pa=s(Dn,"LongT5 model is designed to work efficiently and very well on long-range "),$o=i(Dn,"EM",{});var Bi=d($o);Ga=s(Bi,"sequence-to-sequence"),Bi.forEach(o),Sa=s(Dn,` tasks where the
input sequence exceeds commonly used 512 tokens. It is capable of handling input sequences of a length up to 16,384 tokens.`),Dn.forEach(o),Aa=h(Y),q=i(Y,"LI",{});var S=d(q);Na=s(S,"For "),xo=i(S,"EM",{});var Hi=d(xo);Ia=s(Hi,"Local Attention"),Hi.forEach(o),Da=s(S,", the sparse sliding-window local attention operation allows a given token to attend only "),zo=i(S,"CODE",{});var Yi=d(zo);Wa=s(Yi,"r"),Yi.forEach(o),Ua=s(S,`
tokens to the left and right of it (with `),Lo=i(S,"CODE",{});var Ri=d(Lo);Ba=s(Ri,"r=127"),Ri.forEach(o),Ha=s(S," by default). "),Fo=i(S,"EM",{});var Ji=d(Fo);Ya=s(Ji,"Local Attention"),Ji.forEach(o),Ra=s(S,` does not introduce any new parameters
to the model. The complexity of the mechanism is linear in input sequence length `),qo=i(S,"CODE",{});var Vi=d(qo);Ja=s(Vi,"l"),Vi.forEach(o),Va=s(S,": "),jo=i(S,"CODE",{});var Ki=d(jo);Ka=s(Ki,"O(l*r)"),Ki.forEach(o),Za=s(S,"."),S.forEach(o),Qa=h(Y),F=i(Y,"LI",{});var P=d(F);Mo=i(P,"EM",{});var Zi=d(Mo);Xa=s(Zi,"Transient Global Attention"),Zi.forEach(o),es=s(P," is an extension of the "),Eo=i(P,"EM",{});var Qi=d(Eo);ts=s(Qi,"Local Attention"),Qi.forEach(o),os=s(P,`. It, furthermore, allows each input token to
interact with all other tokens in the layer. This is achieved via splitting an input sequence into blocks of a fixed
...
a few new parameters \u2014 global relative position biases and a layer normalization for global token\u2019s embedding.
The complexity of this mechanism is `),So=i(P,"CODE",{});var nd=d(So);ps=s(nd,"O(l(r + l/k))"),nd.forEach(o),us=s(P,"."),P.forEach(o),hs=h(Y),et=i(Y,"LI",{});var Wn=d(et);ms=s(Wn,"An example showing how to evaluate a fine-tuned LongT5 model on the "),tt=i(Wn,"A",{href:!0,rel:!0});var ad=d(tt);gs=s(ad,"pubmed dataset"),ad.forEach(o),fs=s(Wn," is below."),Wn.forEach(o),Y.forEach(o),xn=h(t),y(ot.$$.fragment,t),zn=h(t),Q=i(t,"P",{});var lo=d(Q);_s=s(lo,"This model was contributed by "),nt=i(lo,"A",{href:!0,rel:!0});var sd=d(nt);Ts=s(sd,"stancld"),sd.forEach(o),bs=s(lo,`.
The original code can be found `),at=i(lo,"A",{href:!0,rel:!0});var rd=d(at);ks=s(rd,"here"),rd.forEach(o),ys=s(lo,"."),lo.forEach(o),Ln=h(t),te=i(t,"H2",{class:!0});var Un=d(te);_e=i(Un,"A",{id:!0,class:!0,href:!0});var id=d(_e);Ao=i(id,"SPAN",{});var dd=d(Ao);y(st.$$.fragment,dd),dd.forEach(o),id.forEach(o),vs=h(Un),No=i(Un,"SPAN",{});var ld=d(No);ws=s(ld,"LongT5Config"),ld.forEach(o),Un.forEach(o),Fn=h(t),K=i(t,"DIV",{class:!0});var co=d(K);y(rt.$$.fragment,co),$s=h(co),Z=i(co,"P",{});var De=d(Z);xs=s(De,"This is the configuration class to store the configuration of a "),Qt=i(De,"A",{href:!0});var cd=d(Qt);zs=s(cd,"LongT5Model"),cd.forEach(o),Ls=s(De," or a "),Xt=i(De,"A",{href:!0});var pd=d(Xt);Fs=s(pd,"FlaxLongT5Model"),pd.forEach(o),qs=s(De,`. It is
used to instantiate a LongT5 model according to the specified arguments, defining the model architecture.
Instantiating a configuration with the defaults will yield a similar configuration to that of the LongT5
`),it=i(De,"A",{href:!0,rel:!0});var ud=d(it);js=s(ud,"google/long-t5-local-base"),ud.forEach(o),Ms=s(De," architecture."),De.forEach(o),Es=h(co),oe=i(co,"P",{});var po=d(oe);Cs=s(po,"Configuration objects inherit from "),eo=i(po,"A",{href:!0});var hd=d(eo);Os=s(hd,"PretrainedConfig"),hd.forEach(o),Ps=s(po,` and can be used to control the model outputs. Read the
documentation from `),to=i(po,"A",{href:!0});var md=d(to);Gs=s(md,"PretrainedConfig"),md.forEach(o),Ss=s(po," for more information."),po.forEach(o),co.forEach(o),qn=h(t),ne=i(t,"H2",{class:!0});var Bn=d(ne);Te=i(Bn,"A",{id:!0,class:!0,href:!0});var gd=d(Te);Io=i(gd,"SPAN",{});var fd=d(Io);y(dt.$$.fragment,fd),fd.forEach(o),gd.forEach(o),As=h(Bn),Do=i(Bn,"SPAN",{});var _d=d(Do);Ns=s(_d,"LongT5Model"),_d.forEach(o),Bn.forEach(o),jn=h(t),j=i(t,"DIV",{class:!0});var R=d(j);y(lt.$$.fragment,R),Is=h(R),Wo=i(R,"P",{});var Td=d(Wo);Ds=s(Td,"The bare LONGT5 Model transformer outputting raw hidden-states without any specific head on top."),Td.forEach(o),Ws=h(R),ct=i(R,"P",{});var Hn=d(ct);Us=s(Hn,"The LongT5 model was proposed in "),pt=i(Hn,"A",{href:!0,rel:!0});var bd=d(pt);Bs=s(bd,`LongT5: Efficient Text-To-Text Transformer for Long
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Rn.forEach(o),er=h(R),D=i(R,"DIV",{class:!0});var We=d(D);y(gt.$$.fragment,We),tr=h(We),ae=i(We,"P",{});var uo=d(ae);or=s(uo,"The "),no=i(uo,"A",{href:!0});var vd=d(no);nr=s(vd,"LongT5Model"),vd.forEach(o),ar=s(uo," forward method, overrides the "),Uo=i(uo,"CODE",{});var wd=d(Uo);sr=s(wd,"__call__"),wd.forEach(o),rr=s(uo," special method."),uo.forEach(o),ir=h(We),y(be.$$.fragment,We),dr=h(We),y(ke.$$.fragment,We),We.forEach(o),R.forEach(o),Mn=h(t),se=i(t,"H2",{class:!0});var Jn=d(se);ye=i(Jn,"A",{id:!0,class:!0,href:!0});var $d=d(ye);Bo=i($d,"SPAN",{});var xd=d(Bo);y(ft.$$.fragment,xd),xd.forEach(o),$d.forEach(o),lr=h(Jn),Ho=i(Jn,"SPAN",{});var zd=d(Ho);cr=s(zd,"LongT5ForConditionalGeneration"),zd.forEach(o),Jn.forEach(o),En=h(t),M=i(t,"DIV",{class:!0});var J=d(M);y(_t.$$.fragment,J),pr=h(J),Tt=i(J,"P",{});var Vn=d(Tt);ur=s(Vn,"LONGT5 Model with a "),Yo=i(Vn,"CODE",{});var Ld=d(Yo);hr=s(Ld,"language modeling"),Ld.forEach(o),mr=s(Vn," head on top."),Vn.forEach(o),gr=h(J),bt=i(J,"P",{});var Kn=d(bt);fr=s(Kn,"The LongT5 model was proposed in "),kt=i(Kn,"A",{href:!0,rel:!0});var Fd=d(kt);_r=s(Fd,`LongT5: Efficient Text-To-Text Transformer for Long
Sequences`),Fd.forEach(o),Tr=s(Kn,` by Mandy Guo, Joshua Ainslie, David Uthus, Santiago Ontanon, Jianmo
Ni, Yun-Hsuan Sung and Yinfei Yang. It\u2019s an encoder-decoder transformer pre-trained in a text-to-text denoising
generative setting. LongT5 model is an extension of T5 model, and it enables using one of the two different
efficient attention mechanisms - (1) Local attention, or (2) Transient-Global attention.`),Kn.forEach(o),br=h(J),yt=i(J,"P",{});var Zn=d(yt);kr=s(Zn,"This model inherits from "),ao=i(Zn,"A",{href:!0});var qd=d(ao);yr=s(qd,"PreTrainedModel"),qd.forEach(o),vr=s(Zn,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Zn.forEach(o),wr=h(J),vt=i(J,"P",{});var Qn=d(vt);$r=s(Qn,"This model is also a PyTorch "),wt=i(Qn,"A",{href:!0,rel:!0});var jd=d(wt);xr=s(jd,"torch.nn.Module"),jd.forEach(o),zr=s(Qn,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Qn.forEach(o),Lr=h(J),W=i(J,"DIV",{class:!0});var Ue=d(W);y($t.$$.fragment,Ue),Fr=h(Ue),re=i(Ue,"P",{});var ho=d(re);qr=s(ho,"The "),so=i(ho,"A",{href:!0});var Md=d(so);jr=s(Md,"LongT5ForConditionalGeneration"),Md.forEach(o),Mr=s(ho," forward method, overrides the "),Ro=i(ho,"CODE",{});var Ed=d(Ro);Er=s(Ed,"__call__"),Ed.forEach(o),Cr=s(ho," special method."),ho.forEach(o),Or=h(Ue),y(ve.$$.fragment,Ue),Pr=h(Ue),y(we.$$.fragment,Ue),Ue.forEach(o),J.forEach(o),Cn=h(t),ie=i(t,"H2",{class:!0});var Xn=d(ie);$e=i(Xn,"A",{id:!0,class:!0,href:!0});var Cd=d($e);Jo=i(Cd,"SPAN",{});var Od=d(Jo);y(xt.$$.fragment,Od),Od.forEach(o),Cd.forEach(o),Gr=h(Xn),Vo=i(Xn,"SPAN",{});var Pd=d(Vo);Sr=s(Pd,"LongT5EncoderModel"),Pd.forEach(o),Xn.forEach(o),On=h(t),E=i(t,"DIV",{class:!0});var V=d(E);y(zt.$$.fragment,V),Ar=h(V),Ko=i(V,"P",{});var Gd=d(Ko);Nr=s(Gd,"The bare LONGT5 Model transformer outputting encoder\u2019s raw hidden-states without any specific head on top."),Gd.forEach(o),Ir=h(V),Lt=i(V,"P",{});var ea=d(Lt);Dr=s(ea,"The LongT5 model was proposed in "),Ft=i(ea,"A",{href:!0,rel:!0});var Sd=d(Ft);Wr=s(Sd,`LongT5: Efficient Text-To-Text Transformer for Long
Sequences`),Sd.forEach(o),Ur=s(ea,` by Mandy Guo, Joshua Ainslie, David Uthus, Santiago Ontanon, Jianmo
Ni, Yun-Hsuan Sung and Yinfei Yang. It\u2019s an encoder-decoder transformer pre-trained in a text-to-text denoising
generative setting. LongT5 model is an extension of T5 model, and it enables using one of the two different
efficient attention mechanisms - (1) Local attention, or (2) Transient-Global attention.`),ea.forEach(o),Br=h(V),qt=i(V,"P",{});var ta=d(qt);Hr=s(ta,"This model inherits from "),ro=i(ta,"A",{href:!0});var Ad=d(ro);Yr=s(Ad,"PreTrainedModel"),Ad.forEach(o),Rr=s(ta,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),ta.forEach(o),Jr=h(V),jt=i(V,"P",{});var oa=d(jt);Vr=s(oa,"This model is also a PyTorch "),Mt=i(oa,"A",{href:!0,rel:!0});var Nd=d(Mt);Kr=s(Nd,"torch.nn.Module"),Nd.forEach(o),Zr=s(oa,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),oa.forEach(o),Qr=h(V),U=i(V,"DIV",{class:!0});var Be=d(U);y(Et.$$.fragment,Be),Xr=h(Be),de=i(Be,"P",{});var mo=d(de);ei=s(mo,"The "),io=i(mo,"A",{href:!0});var Id=d(io);ti=s(Id,"LongT5EncoderModel"),Id.forEach(o),oi=s(mo," forward method, overrides the "),Zo=i(mo,"CODE",{});var Dd=d(Zo);ni=s(Dd,"__call__"),Dd.forEach(o),ai=s(mo," special method."),mo.forEach(o),si=h(Be),y(xe.$$.fragment,Be),ri=h(Be),y(ze.$$.fragment,Be),Be.forEach(o),V.forEach(o),Pn=h(t),le=i(t,"H2",{class:!0});var na=d(le);Le=i(na,"A",{id:!0,class:!0,href:!0});var Wd=d(Le);Qo=i(Wd,"SPAN",{});var Ud=d(Qo);y(Ct.$$.fragment,Ud),Ud.forEach(o),Wd.forEach(o),ii=h(na),Xo=i(na,"SPAN",{});var Bd=d(Xo);di=s(Bd,"FlaxLongT5Model"),Bd.forEach(o),na.forEach(o),Gn=h(t),A=i(t,"DIV",{class:!0});var He=d(A);y(Ot.$$.fragment,He),li=h(He),B=i(He,"DIV",{class:!0});var Ye=d(B);y(Pt.$$.fragment,Ye),ci=h(Ye),ce=i(Ye,"P",{});var go=d(ce);pi=s(go,"The "),en=i(go,"CODE",{});var Hd=d(en);ui=s(Hd,"FlaxLongT5PreTrainedModel"),Hd.forEach(o),hi=s(go," forward method, overrides the "),tn=i(go,"CODE",{});var Yd=d(tn);mi=s(Yd,"__call__"),Yd.forEach(o),gi=s(go," special method."),go.forEach(o),fi=h(Ye),y(Fe.$$.fragment,Ye),_i=h(Ye),y(qe.$$.fragment,Ye),Ye.forEach(o),Ti=h(He),je=i(He,"DIV",{class:!0});var aa=d(je);y(Gt.$$.fragment,aa),bi=h(aa),y(Me.$$.fragment,aa),aa.forEach(o),ki=h(He),Ee=i(He,"DIV",{class:!0});var sa=d(Ee);y(St.$$.fragment,sa),yi=h(sa),y(Ce.$$.fragment,sa),sa.forEach(o),He.forEach(o),Sn=h(t),pe=i(t,"H2",{class:!0});var ra=d(pe);Oe=i(ra,"A",{id:!0,class:!0,href:!0});var Rd=d(Oe);on=i(Rd,"SPAN",{});var Jd=d(on);y(At.$$.fragment,Jd),Jd.forEach(o),Rd.forEach(o),vi=h(ra),nn=i(ra,"SPAN",{});var Vd=d(nn);wi=s(Vd,"FlaxLongT5ForConditionalGeneration"),Vd.forEach(o),ra.forEach(o),An=h(t),N=i(t,"DIV",{class:!0});var Re=d(N);y(Nt.$$.fragment,Re),$i=h(Re),H=i(Re,"DIV",{class:!0});var Je=d(H);y(It.$$.fragment,Je),xi=h(Je),ue=i(Je,"P",{});var fo=d(ue);zi=s(fo,"The "),an=i(fo,"CODE",{});var Kd=d(an);Li=s(Kd,"FlaxLongT5PreTrainedModel"),Kd.forEach(o),Fi=s(fo," forward method, overrides the "),sn=i(fo,"CODE",{});var Zd=d(sn);qi=s(Zd,"__call__"),Zd.forEach(o),ji=s(fo," special method."),fo.forEach(o),Mi=h(Je),y(Pe.$$.fragment,Je),Ei=h(Je),y(Ge.$$.fragment,Je),Je.forEach(o),Ci=h(Re),Se=i(Re,"DIV",{class:!0});var ia=d(Se);y(Dt.$$.fragment,ia),Oi=h(ia),y(Ae.$$.fragment,ia),ia.forEach(o),Pi=h(Re),Ne=i(Re,"DIV",{class:!0});var da=d(Ne);y(Wt.$$.fragment,da),Gi=h(da),y(Ie.$$.fragment,da),da.forEach(o),Re.forEach(o),this.h()},h(){g(l,"name","hf:doc:metadata"),g(l,"content",JSON.stringify(Tl)),g(p,"id","longt5"),g(p,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),g(p,"href","#longt5"),g(m,"class","relative group"),g(ge,"id","overview"),g(ge,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),g(ge,"href","#overview"),g(ee,"class","relative group"),g(Ze,"href","https://arxiv.org/abs/2112.07916"),g(Ze,"rel","nofollow"),g(Vt,"href","/docs/transformers/main/en/model_doc/longt5#transformers.LongT5ForConditionalGeneration"),g(Kt,"href","/docs/transformers/main/en/model_doc/t5#transformers.T5ForConditionalGeneration"),g(Zt,"href","/docs/transformers/main/en/model_doc/pegasus#transformers.PegasusForConditionalGeneration"),g(tt,"href","https://huggingface.co/datasets/scientific_papers"),g(tt,"rel","nofollow"),g(nt,"href","https://huggingface.co/stancld"),g(nt,"rel","nofollow"),g(at,"href","https://github.com/google-research/longt5"),g(at,"rel","nofollow"),g(_e,"id","transformers.LongT5Config"),g(_e,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),g(_e,"href","#transformers.LongT5Config"),g(te,"class","relative group"),g(Qt,"href","/docs/transformers/main/en/model_doc/longt5#transformers.LongT5Model"),g(Xt,"href","/docs/transformers/main/en/model_doc/longt5#transformers.FlaxLongT5Model"),g(it,"href","https://huggingface.co/google/long-t5-local-base"),g(it,"rel","nofollow"),g(eo,"href","/docs/transformers/main/en/main_classes/configuration#transformers.PretrainedConfig"),g(to,"href","/docs/transformers/main/en/main_classes/configuration#transformers.PretrainedConfig"),g(K,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),g(Te,"id","transformers.LongT5Model"),g(Te,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),g(Te,"href","#transformers.LongT5Model"),g(ne,"class","relative group"),g(pt,"href","https://arxiv.org/abs/2112.07916"),g(pt,"rel","nofollow"),g(oo,"href","/docs/transformers/main/en/main_classes/model#transformers.PreTrainedModel"),g(mt,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),g(mt,"rel","nofollow"),g(no,"href","/docs/transformers/main/en/model_doc/longt5#transformers.LongT5Model"),g(D,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),g(j,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),g(ye,"id","transformers.LongT5ForConditionalGeneration"),g(ye,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),g(ye,"href","#transformers.LongT5ForConditionalGeneration"),g(se,"class","relative group"),g(kt,"href","https://arxiv.org/abs/2112.07916"),g(kt,"rel","nofollow"),g(ao,"href","/docs/transformers/main/en/main_classes/model#transformers.PreTrainedModel"),g(wt,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),g(wt,"rel","nofollow"),g(so,"href","/docs/transformers/main/en/model_doc/longt5#transformers.LongT5ForConditionalGeneration"),g(W,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),g(M,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),g($e,"id","transformers.LongT5EncoderModel"),g($e,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),g($e,"href","#transformers.LongT5EncoderModel"),g(ie,"class","relative group"),g(Ft,"href","https://arxiv.org/abs/2112.07916"),g(Ft,"rel","nofollow"),g(ro,"href","/docs/transformers/main/en/main_classes/model#transformers.PreTrainedModel"),g(Mt,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),g(Mt,"rel","nofollow"),g(io,"href","/docs/transformers/main/en/model_doc/longt5#transformers.LongT5EncoderModel"),g(U,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),g(E,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),g(Le,"id","transformers.FlaxLongT5Model"),g(Le,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),g(Le,"href","#transformers.FlaxLongT5Model"),g(le,"class","relative group"),g(B,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),g(je,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),g(Ee,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),g(A,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),g(Oe,"id","transformers.FlaxLongT5ForConditionalGeneration"),g(Oe,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),g(Oe,"href","#transformers.FlaxLongT5ForConditionalGeneration"),g(pe,"class","relative group"),g(H,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),g(Se,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),g(Ne,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),g(N,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8")},m(t,f){e(document.head,l),T(t,b,f),T(t,m,f),e(m,p),e(p,_),v(n,_,null),e(m,c),e(m,L),e(L,la),T(t,bn,f),T(t,ee,f),e(ee,ge),e(ge,_o),v(Ke,_o,null),e(ee,ca),e(ee,To),e(To,pa),T(t,kn,f),T(t,fe,f),e(fe,ua),e(fe,Ze),e(Ze,ha),e(fe,ma),T(t,yn,f),T(t,Yt,f),e(Yt,ga),T(t,vn,f),T(t,Rt,f),e(Rt,bo),e(bo,fa),T(t,wn,f),T(t,Jt,f),e(Jt,_a),T(t,$n,f),T(t,C,f),e(C,O),e(O,Vt),e(Vt,Ta),e(O,ba),e(O,Kt),e(Kt,ka),e(O,ya),e(O,ko),e(ko,va),e(O,wa),e(O,yo),e(yo,$a),e(O,xa),e(O,vo),e(vo,za),e(O,La),e(O,wo),e(wo,Fa),e(O,qa),e(C,ja),e(C,Qe),e(Qe,Ma),e(Qe,Zt),e(Zt,Ea),e(Qe,Ca),e(C,Oa),e(C,Xe),e(Xe,Pa),e(Xe,$o),e($o,Ga),e(Xe,Sa),e(C,Aa),e(C,q),e(q,Na),e(q,xo),e(xo,Ia),e(q,Da),e(q,zo),e(zo,Wa),e(q,Ua),e(q,Lo),e(Lo,Ba),e(q,Ha),e(q,Fo),e(Fo,Ya),e(q,Ra),e(q,qo),e(qo,Ja),e(q,Va),e(q,jo),e(jo,Ka),e(q,Za),e(C,Qa),e(C,F),e(F,Mo),e(Mo,Xa),e(F,es),e(F,Eo),e(Eo,ts),e(F,os),e(F,Co),e(Co,ns),e(F,as),e(F,Oo),e(Oo,ss),e(F,rs),e(F,Po),e(Po,is),e(F,ds),e(F,Go),e(Go,ls),e(F,cs),e(F,So),e(So,ps),e(F,us),e(C,hs),e(C,et),e(et,ms),e(et,tt),e(tt,gs),e(et,fs),T(t,xn,f),v(ot,t,f),T(t,zn,f),T(t,Q,f),e(Q,_s),e(Q,nt),e(nt,Ts),e(Q,bs),e(Q,at),e(at,ks),e(Q,ys),T(t,Ln,f),T(t,te,f),e(te,_e),e(_e,Ao),v(st,Ao,null),e(te,vs),e(te,No),e(No,ws),T(t,Fn,f),T(t,K,f),v(rt,K,null),e(K,$s),e(K,Z),e(Z,xs),e(Z,Qt),e(Qt,zs),e(Z,Ls),e(Z,Xt),e(Xt,Fs),e(Z,qs),e(Z,it),e(it,js),e(Z,Ms),e(K,Es),e(K,oe),e(oe,Cs),e(oe,eo),e(eo,Os),e(oe,Ps),e(oe,to),e(to,Gs),e(oe,Ss),T(t,qn,f),T(t,ne,f),e(ne,Te),e(Te,Io),v(dt,Io,null),e(ne,As),e(ne,Do),e(Do,Ns),T(t,jn,f),T(t,j,f),v(lt,j,null),e(j,Is),e(j,Wo),e(Wo,Ds),e(j,Ws),e(j,ct),e(ct,Us),e(ct,pt),e(pt,Bs),e(ct,Hs),e(j,Ys),e(j,ut),e(ut,Rs),e(ut,oo),e(oo,Js),e(ut,Vs),e(j,Ks),e(j,ht),e(ht,Zs),e(ht,mt),e(mt,Qs),e(ht,Xs),e(j,er),e(j,D),v(gt,D,null),e(D,tr),e(D,ae),e(ae,or),e(ae,no),e(no,nr),e(ae,ar),e(ae,Uo),e(Uo,sr),e(ae,rr),e(D,ir),v(be,D,null),e(D,dr),v(ke,D,null),T(t,Mn,f),T(t,se,f),e(se,ye),e(ye,Bo),v(ft,Bo,null),e(se,lr),e(se,Ho),e(Ho,cr),T(t,En,f),T(t,M,f),v(_t,M,null),e(M,pr),e(M,Tt),e(Tt,ur),e(Tt,Yo),e(Yo,hr),e(Tt,mr),e(M,gr),e(M,bt),e(bt,fr),e(bt,kt),e(kt,_r),e(bt,Tr),e(M,br),e(M,yt),e(yt,kr),e(yt,ao),e(ao,yr),e(yt,vr),e(M,wr),e(M,vt),e(vt,$r),e(vt,wt),e(wt,xr),e(vt,zr),e(M,Lr),e(M,W),v($t,W,null),e(W,Fr),e(W,re),e(re,qr),e(re,so),e(so,jr),e(re,Mr),e(re,Ro),e(Ro,Er),e(re,Cr),e(W,Or),v(ve,W,null),e(W,Pr),v(we,W,null),T(t,Cn,f),T(t,ie,f),e(ie,$e),e($e,Jo),v(xt,Jo,null),e(ie,Gr),e(ie,Vo),e(Vo,Sr),T(t,On,f),T(t,E,f),v(zt,E,null),e(E,Ar),e(E,Ko),e(Ko,Nr),e(E,Ir),e(E,Lt),e(Lt,Dr),e(Lt,Ft),e(Ft,Wr),e(Lt,Ur),e(E,Br),e(E,qt),e(qt,Hr),e(qt,ro),e(ro,Yr),e(qt,Rr),e(E,Jr),e(E,jt),e(jt,Vr),e(jt,Mt),e(Mt,Kr),e(jt,Zr),e(E,Qr),e(E,U),v(Et,U,null),e(U,Xr),e(U,de),e(de,ei),e(de,io),e(io,ti),e(de,oi),e(de,Zo),e(Zo,ni),e(de,ai),e(U,si),v(xe,U,null),e(U,ri),v(ze,U,null),T(t,Pn,f),T(t,le,f),e(le,Le),e(Le,Qo),v(Ct,Qo,null),e(le,ii),e(le,Xo),e(Xo,di),T(t,Gn,f),T(t,A,f),v(Ot,A,null),e(A,li),e(A,B),v(Pt,B,null),e(B,ci),e(B,ce),e(ce,pi),e(ce,en),e(en,ui),e(ce,hi),e(ce,tn),e(tn,mi),e(ce,gi),e(B,fi),v(Fe,B,null),e(B,_i),v(qe,B,null),e(A,Ti),e(A,je),v(Gt,je,null),e(je,bi),v(Me,je,null),e(A,ki),e(A,Ee),v(St,Ee,null),e(Ee,yi),v(Ce,Ee,null),T(t,Sn,f),T(t,pe,f),e(pe,Oe),e(Oe,on),v(At,on,null),e(pe,vi),e(pe,nn),e(nn,wi),T(t,An,f),T(t,N,f),v(Nt,N,null),e(N,$i),e(N,H),v(It,H,null),e(H,xi),e(H,ue),e(ue,zi),e(ue,an),e(an,Li),e(ue,Fi),e(ue,sn),e(sn,qi),e(ue,ji),e(H,Mi),v(Pe,H,null),e(H,Ei),v(Ge,H,null),e(N,Ci),e(N,Se),v(Dt,Se,null),e(Se,Oi),v(Ae,Se,null),e(N,Pi),e(N,Ne),v(Wt,Ne,null),e(Ne,Gi),v(Ie,Ne,null),Nn=!0},p(t,[f]){const Ut={};f&2&&(Ut.$$scope={dirty:f,ctx:t}),be.$set(Ut);const rn={};f&2&&(rn.$$scope={dirty:f,ctx:t}),ke.$set(rn);const dn={};f&2&&(dn.$$scope={dirty:f,ctx:t}),ve.$set(dn);const ln={};f&2&&(ln.$$scope={dirty:f,ctx:t}),we.$set(ln);const Bt={};f&2&&(Bt.$$scope={dirty:f,ctx:t}),xe.$set(Bt);const cn={};f&2&&(cn.$$scope={dirty:f,ctx:t}),ze.$set(cn);const pn={};f&2&&(pn.$$scope={dirty:f,ctx:t}),Fe.$set(pn);const un={};f&2&&(un.$$scope={dirty:f,ctx:t}),qe.$set(un);const Ht={};f&2&&(Ht.$$scope={dirty:f,ctx:t}),Me.$set(Ht);const hn={};f&2&&(hn.$$scope={dirty:f,ctx:t}),Ce.$set(hn);const mn={};f&2&&(mn.$$scope={dirty:f,ctx:t}),Pe.$set(mn);const gn={};f&2&&(gn.$$scope={dirty:f,ctx:t}),Ge.$set(gn);const fn={};f&2&&(fn.$$scope={dirty:f,ctx:t}),Ae.$set(fn);const _n={};f&2&&(_n.$$scope={dirty:f,ctx:t}),Ie.$set(_n)},i(t){Nn||(w(n.$$.fragment,t),w(Ke.$$.fragment,t),w(ot.$$.fragment,t),w(st.$$.fragment,t),w(rt.$$.fragment,t),w(dt.$$.fragment,t),w(lt.$$.fragment,t),w(gt.$$.fragment,t),w(be.$$.fragment,t),w(ke.$$.fragment,t),w(ft.$$.fragment,t),w(_t.$$.fragment,t),w($t.$$.fragment,t),w(ve.$$.fragment,t),w(we.$$.fragment,t),w(xt.$$.fragment,t),w(zt.$$.fragment,t),w(Et.$$.fragment,t),w(xe.$$.fragment,t),w(ze.$$.fragment,t),w(Ct.$$.fragment,t),w(Ot.$$.fragment,t),w(Pt.$$.fragment,t),w(Fe.$$.fragment,t),w(qe.$$.fragment,t),w(Gt.$$.fragment,t),w(Me.$$.fragment,t),w(St.$$.fragment,t),w(Ce.$$.fragment,t),w(At.$$.fragment,t),w(Nt.$$.fragment,t),w(It.$$.fragment,t),w(Pe.$$.fragment,t),w(Ge.$$.fragment,t),w(Dt.$$.fragment,t),w(Ae.$$.fragment,t),w(Wt.$$.fragment,t),w(Ie.$$.fragment,t),Nn=!0)},o(t){$(n.$$.fragment,t),$(Ke.$$.fragment,t),$(ot.$$.fragment,t),$(st.$$.fragment,t),$(rt.$$.fragment,t),$(dt.$$.fragment,t),$(lt.$$.fragment,t),$(gt.$$.fragment,t),$(be.$$.fragment,t),$(ke.$$.fragment,t),$(ft.$$.fragment,t),$(_t.$$.fragment,t),$($t.$$.fragment,t),$(ve.$$.fragment,t),$(we.$$.fragment,t),$(xt.$$.fragment,t),$(zt.$$.fragment,t),$(Et.$$.fragment,t),$(xe.$$.fragment,t),$(ze.$$.fragment,t),$(Ct.$$.fragment,t),$(Ot.$$.fragment,t),$(Pt.$$.fragment,t),$(Fe.$$.fragment,t),$(qe.$$.fragment,t),$(Gt.$$.fragment,t),$(Me.$$.fragment,t),$(St.$$.fragment,t),$(Ce.$$.fragment,t),$(At.$$.fragment,t),$(Nt.$$.fragment,t),$(It.$$.fragment,t),$(Pe.$$.fragment,t),$(Ge.$$.fragment,t),$(Dt.$$.fragment,t),$(Ae.$$.fragment,t),$(Wt.$$.fragment,t),$(Ie.$$.fragment,t),Nn=!1},d(t){o(l),t&&o(b),t&&o(m),x(n),t&&o(bn),t&&o(ee),x(Ke),t&&o(kn),t&&o(fe),t&&o(yn),t&&o(Yt),t&&o(vn),t&&o(Rt),t&&o(wn),t&&o(Jt),t&&o($n),t&&o(C),t&&o(xn),x(ot,t),t&&o(zn),t&&o(Q),t&&o(Ln),t&&o(te),x(st),t&&o(Fn),t&&o(K),x(rt),t&&o(qn),t&&o(ne),x(dt),t&&o(jn),t&&o(j),x(lt),x(gt),x(be),x(ke),t&&o(Mn),t&&o(se),x(ft),t&&o(En),t&&o(M),x(_t),x($t),x(ve),x(we),t&&o(Cn),t&&o(ie),x(xt),t&&o(On),t&&o(E),x(zt),x(Et),x(xe),x(ze),t&&o(Pn),t&&o(le),x(Ct),t&&o(Gn),t&&o(A),x(Ot),x(Pt),x(Fe),x(qe),x(Gt),x(Me),x(St),x(Ce),t&&o(Sn),t&&o(pe),x(At),t&&o(An),t&&o(N),x(Nt),x(It),x(Pe),x(Ge),x(Dt),x(Ae),x(Wt),x(Ie)}}}const Tl={local:"longt5",sections:[{local:"overview",title:"Overview"},{local:"transformers.LongT5Config",title:"LongT5Config"},{local:"transformers.LongT5Model",title:"LongT5Model"},{local:"transformers.LongT5ForConditionalGeneration",title:"LongT5ForConditionalGeneration"},{local:"transformers.LongT5EncoderModel",title:"LongT5EncoderModel"},{local:"transformers.FlaxLongT5Model",title:"FlaxLongT5Model"},{local:"transformers.FlaxLongT5ForConditionalGeneration",title:"FlaxLongT5ForConditionalGeneration"}],title:"LongT5"};function bl(z){return ol(()=>{new URLSearchParams(window.location.search).get("fw")}),[]}class zl extends Qd{constructor(l){super();Xd(this,l,bl,_l,el,{})}}export{zl as default,Tl as metadata};
