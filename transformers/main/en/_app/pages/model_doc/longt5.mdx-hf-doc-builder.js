...
<span class="hljs-meta">&gt;&gt;&gt; </span>outputs = model.decode(decoder_input_ids, encoder_outputs)
<span class="hljs-meta">&gt;&gt;&gt; </span>logits = outputs.logits`}}),{c(){l=r("p"),b=a("Example:"),m=u(),k(p.$$.fragment)},l(n){l=i(n,"P",{});var c=d(l);b=s(c,"Example:"),c.forEach(o),m=h(n),y(p.$$.fragment,n)},m(n,c){T(n,l,c),e(l,b),T(n,m,c),v(p,n,c),_=!0},p:me,i(n){_||(w(p.$$.fragment,n),_=!0)},o(n){$(p.$$.fragment,n),_=!1},d(n){n&&o(l),n&&o(m),x(p,n)}}}function _l(L){let l,b,m,p,_,n,c,z,la,bn,ee,ge,fo,Ke,ca,_o,pa,kn,fe,ua,Ze,ha,ma,yn,Vt,ga,vn,Yt,To,fa,wn,Rt,_a,$n,E,O,Jt,Ta,ba,Kt,ka,ya,bo,va,wa,ko,$a,xa,yo,La,za,vo,qa,ja,Fa,Qe,Ma,wo,Ca,Ea,Oa,Xe,Ga,$o,Pa,Sa,Aa,j,Na,xo,Ia,Da,Lo,Ba,Wa,zo,Ua,Ha,qo,Va,Ya,jo,Ra,Ja,Fo,Ka,Za,Qa,q,Mo,Xa,es,Co,ts,os,Eo,ns,as,Oo,ss,rs,Go,is,ds,Po,ls,cs,So,ps,us,hs,et,ms,tt,gs,fs,xn,ot,Ln,Q,_s,nt,Ts,bs,at,ks,ys,zn,te,_e,Ao,st,vs,No,ws,qn,K,rt,$s,Z,xs,Zt,Ls,zs,Qt,qs,js,it,Fs,Ms,Cs,oe,Es,Xt,Os,Gs,eo,Ps,Ss,jn,ne,Te,Io,dt,As,Do,Ns,Fn,F,lt,Is,Bo,Ds,Bs,ct,Ws,pt,Us,Hs,Vs,ut,Ys,to,Rs,Js,Ks,ht,Zs,mt,Qs,Xs,er,D,gt,tr,ae,or,oo,nr,ar,Wo,sr,rr,ir,be,dr,ke,Mn,se,ye,Uo,ft,lr,Ho,cr,Cn,M,_t,pr,Tt,ur,Vo,hr,mr,gr,bt,fr,kt,_r,Tr,br,yt,kr,no,yr,vr,wr,vt,$r,wt,xr,Lr,zr,B,$t,qr,re,jr,ao,Fr,Mr,Yo,Cr,Er,Or,ve,Gr,we,En,ie,$e,Ro,xt,Pr,Jo,Sr,On,C,Lt,Ar,Ko,Nr,Ir,zt,Dr,qt,Br,Wr,Ur,jt,Hr,so,Vr,Yr,Rr,Ft,Jr,Mt,Kr,Zr,Qr,W,Ct,Xr,de,ei,ro,ti,oi,Zo,ni,ai,si,xe,ri,Le,Gn,le,ze,Qo,Et,ii,Xo,di,Pn,A,Ot,li,U,Gt,ci,ce,pi,en,ui,hi,tn,mi,gi,fi,qe,_i,je,Ti,Fe,Pt,bi,Me,ki,Ce,St,yi,Ee,Sn,pe,Oe,on,At,vi,nn,wi,An,N,Nt,$i,H,It,xi,ue,Li,an,zi,qi,sn,ji,Fi,Mi,Ge,Ci,Pe,Ei,Se,Dt,Oi,Ae,Gi,Ne,Bt,Pi,Ie,Nn;return n=new Je({}),Ke=new Je({}),ot=new X({props:{code:`import evaluate
...
`),it=r("a"),Fs=a("google/LongT5-Local-Base"),Ms=a(" architecture."),Cs=u(),oe=r("p"),Es=a("Configuration objects inherit from "),Xt=r("a"),Os=a("PretrainedConfig"),Gs=a(` and can be used to control the model outputs. Read the
...
and behavior.`),er=u(),D=r("div"),k(gt.$$.fragment),tr=u(),ae=r("p"),or=a("The "),oo=r("a"),nr=a("LongT5Model"),ar=a(" forward method, overrides the "),Wo=r("code"),sr=a("__call__"),rr=a(" special method."),ir=u(),k(be.$$.fragment),dr=u(),k(ke.$$.fragment),Mn=u(),se=r("h2"),ye=r("a"),Uo=r("span"),k(ft.$$.fragment),lr=u(),Ho=r("span"),cr=a("LongT5ForConditionalGeneration"),Cn=u(),M=r("div"),k(_t.$$.fragment),pr=u(),Tt=r("p"),ur=a("LONGT5 Model with a "),Vo=r("code"),hr=a("language modeling"),mr=a(" head on top."),gr=u(),bt=r("p"),fr=a("The LongT5 model was proposed in "),kt=r("a"),_r=a(`LongT5: Efficient Text-To-Text Transformer for Long
...
a few new parameters \u2014 global relative position biases and a layer normalization for global token\u2019s embedding.
The complexity of this mechanism is `),So=i(G,"CODE",{});var nd=d(So);ps=s(nd,"O(l(r + l/k))"),nd.forEach(o),us=s(G,"."),G.forEach(o),hs=h(V),et=i(V,"LI",{});var Bn=d(et);ms=s(Bn,"An example showing how to evaluate a fine-tuned LongT5 model on the "),tt=i(Bn,"A",{href:!0,rel:!0});var ad=d(tt);gs=s(ad,"pubmed dataset"),ad.forEach(o),fs=s(Bn," is below."),Bn.forEach(o),V.forEach(o),xn=h(t),y(ot.$$.fragment,t),Ln=h(t),Q=i(t,"P",{});var io=d(Q);_s=s(io,"This model was contributed by "),nt=i(io,"A",{href:!0,rel:!0});var sd=d(nt);Ts=s(sd,"stancld"),sd.forEach(o),bs=s(io,`.
The original code can be found `),at=i(io,"A",{href:!0,rel:!0});var rd=d(at);ks=s(rd,"here"),rd.forEach(o),ys=s(io,"."),io.forEach(o),zn=h(t),te=i(t,"H2",{class:!0});var Wn=d(te);_e=i(Wn,"A",{id:!0,class:!0,href:!0});var id=d(_e);Ao=i(id,"SPAN",{});var dd=d(Ao);y(st.$$.fragment,dd),dd.forEach(o),id.forEach(o),vs=h(Wn),No=i(Wn,"SPAN",{});var ld=d(No);ws=s(ld,"LongT5Config"),ld.forEach(o),Wn.forEach(o),qn=h(t),K=i(t,"DIV",{class:!0});var lo=d(K);y(rt.$$.fragment,lo),$s=h(lo),Z=i(lo,"P",{});var De=d(Z);xs=s(De,"This is the configuration class to store the configuration of a "),Zt=i(De,"A",{href:!0});var cd=d(Zt);Ls=s(cd,"LongT5Model"),cd.forEach(o),zs=s(De," or a "),Qt=i(De,"A",{href:!0});var pd=d(Qt);qs=s(pd,"FlaxLongT5Model"),pd.forEach(o),js=s(De,`. It is
used to instantiate a LongT5 model according to the specified arguments, defining the model architecture.
Instantiating a configuration with the defaults will yield a similar configuration to that of the LongT5
`),it=i(De,"A",{href:!0,rel:!0});var ud=d(it);Fs=s(ud,"google/LongT5-Local-Base"),ud.forEach(o),Ms=s(De," architecture."),De.forEach(o),Cs=h(lo),oe=i(lo,"P",{});var co=d(oe);Es=s(co,"Configuration objects inherit from "),Xt=i(co,"A",{href:!0});var hd=d(Xt);Os=s(hd,"PretrainedConfig"),hd.forEach(o),Gs=s(co,` and can be used to control the model outputs. Read the
documentation from `),eo=i(co,"A",{href:!0});var md=d(eo);Ps=s(md,"PretrainedConfig"),md.forEach(o),Ss=s(co," for more information."),co.forEach(o),lo.forEach(o),jn=h(t),ne=i(t,"H2",{class:!0});var Un=d(ne);Te=i(Un,"A",{id:!0,class:!0,href:!0});var gd=d(Te);Io=i(gd,"SPAN",{});var fd=d(Io);y(dt.$$.fragment,fd),fd.forEach(o),gd.forEach(o),As=h(Un),Do=i(Un,"SPAN",{});var _d=d(Do);Ns=s(_d,"LongT5Model"),_d.forEach(o),Un.forEach(o),Fn=h(t),F=i(t,"DIV",{class:!0});var Y=d(F);y(lt.$$.fragment,Y),Is=h(Y),Bo=i(Y,"P",{});var Td=d(Bo);Ds=s(Td,"The bare LONGT5 Model transformer outputting raw hidden-states without any specific head on top."),Td.forEach(o),Bs=h(Y),ct=i(Y,"P",{});var Hn=d(ct);Ws=s(Hn,"The LongT5 model was proposed in "),pt=i(Hn,"A",{href:!0,rel:!0});var bd=d(pt);Us=s(bd,`LongT5: Efficient Text-To-Text Transformer for Long
