import{S as Ji,i as Gi,s as Yi,e as a,k as l,w as g,t as r,M as Ki,c as n,d as o,m as d,a as i,x as v,h as s,b as c,G as e,g as m,y as T,q as x,o as k,B as b,v as Qi,L as Bi}from"../../chunks/vendor-hf-doc-builder.js";import{T as Ui}from"../../chunks/Tip-hf-doc-builder.js";import{D as V}from"../../chunks/Docstring-hf-doc-builder.js";import{C as $r}from"../../chunks/CodeBlock-hf-doc-builder.js";import{I as ut}from"../../chunks/IconCopyLink-hf-doc-builder.js";import{E as Hi}from"../../chunks/ExampleCodeBlock-hf-doc-builder.js";function Xi(B){let f,E,u,_,w;return _=new $r({props:{code:`from transformers import Speech2Text2ForCausalLM, Speech2Text2Config
...
<span class="hljs-meta">&gt;&gt;&gt; </span>configuration = model.config`}}),{c(){f=a("p"),E=r("Example:"),u=l(),g(_.$$.fragment)},l(h){f=n(h,"P",{});var S=i(f);E=s(S,"Example:"),S.forEach(o),u=d(h),v(_.$$.fragment,h)},m(h,S){m(h,f,S),e(f,E),m(h,u,S),T(_,h,S),w=!0},p:Bi,i(h){w||(x(_.$$.fragment,h),w=!0)},o(h){k(_.$$.fragment,h),w=!1},d(h){h&&o(f),h&&o(u),b(_,h)}}}function Zi(B){let f,E,u,_,w,h,S,D;return{c(){f=a("p"),E=r(`This class method is simply calling the feature extractor
...
`),h=n($,"CODE",{});var M=i(h);S=s(M,"~tokenization_utils_base.PreTrainedTokenizer.from_pretrained"),M.forEach(o),D=s($,` methods. Please refer to the docstrings of the
methods above for more information.`),$.forEach(o),this.h()},h(){c(u,"href","/docs/transformers/main/en/main_classes/feature_extractor#transformers.FeatureExtractionMixin.from_pretrained")},m(q,$){m(q,f,$),e(f,E),e(f,u),e(u,_),e(f,w),e(f,h),e(h,S),e(f,D)},d(q){q&&o(f)}}}function ec(B){let f,E,u,_,w,h,S,D;return{c(){f=a("p"),E=r("This class method is simply calling "),u=a("a"),_=r("save_pretrained()"),w=r(` and
`),h=a("a"),S=r("save_pretrained()"),D=r(`. Please refer to the docstrings of the
methods above for more information.`),this.h()},l(q){f=n(q,"P",{});var $=i(f);E=s($,"This class method is simply calling "),u=n($,"A",{href:!0});var F=i(u);_=s(F,"save_pretrained()"),F.forEach(o),w=s($,` and
`),h=n($,"A",{href:!0});var M=i(h);S=s(M,"save_pretrained()"),M.forEach(o),D=s($,`. Please refer to the docstrings of the
methods above for more information.`),$.forEach(o),this.h()},h(){c(u,"href","/docs/transformers/main/en/main_classes/feature_extractor#transformers.FeatureExtractionMixin.save_pretrained"),c(h,"href","/docs/transformers/main/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.save_pretrained")},m(q,$){m(q,f,$),e(f,E),e(f,u),e(u,_),e(f,w),e(f,h),e(h,S),e(f,D)},d(q){q&&o(f)}}}function tc(B){let f,E,u,_,w;return _=new $r({props:{code:`from transformers import (
...
<span class="hljs-meta">&gt;&gt;&gt; </span>loss.backward()`}}),{c(){f=a("p"),E=r("Example:"),u=l(),g(_.$$.fragment)},l(h){f=n(h,"P",{});var S=i(f);E=s(S,"Example:"),S.forEach(o),u=d(h),v(_.$$.fragment,h)},m(h,S){m(h,f,S),e(f,E),m(h,u,S),T(_,h,S),w=!0},p:Bi,i(h){w||(x(_.$$.fragment,h),w=!0)},o(h){k(_.$$.fragment,h),w=!1},d(h){h&&o(f),h&&o(u),b(_,h)}}}function oc(B){let f,E,u,_,w,h,S,D,q,$,F,M,Zt,Ee,yr,eo,Er,qo,J,zr,_t,Pr,jr,ze,Cr,qr,Fo,z,Fr,to,Mr,Ar,oo,Lr,Dr,gt,Wr,Ir,vt,Vr,Nr,Tt,Or,Rr,ro,Ur,Hr,Mo,ne,Br,Pe,Jr,Gr,Ao,ie,Yr,je,Kr,Qr,Lo,xt,Xr,Do,G,Ce,Zr,qe,es,ts,os,Fe,rs,kt,ss,as,ns,Me,is,Ae,cs,ls,Wo,Z,ce,so,Le,ds,ao,ps,Io,Y,hs,bt,ms,fs,St,us,_s,Vo,j,gs,wt,vs,Ts,$t,xs,ks,yt,bs,Ss,Et,ws,$s,zt,ys,Es,No,Pt,no,zs,Oo,De,Ro,jt,We,io,Ps,js,co,Cs,Uo,Ie,Ho,le,qs,Ve,Fs,Ms,Bo,ee,de,lo,Ne,As,po,Ls,Jo,W,Oe,Ds,te,Ws,Ct,Is,Vs,Re,Ns,Os,Rs,oe,Us,qt,Hs,Bs,Ft,Js,Gs,Ys,pe,Go,re,he,ho,Ue,Ks,mo,Qs,Yo,P,He,Xs,fo,Zs,ea,Be,ta,Mt,oa,ra,sa,me,Je,aa,uo,na,ia,K,Ge,ca,_o,la,da,Ye,pa,go,ha,ma,fa,At,Ke,Ko,se,fe,vo,Qe,ua,To,_a,Qo,y,Xe,ga,xo,va,Ta,A,Lt,xa,ka,Dt,ba,Sa,Wt,wa,$a,Ze,ko,ya,Ea,za,It,Pa,ja,Ca,ue,et,qa,R,Fa,bo,Ma,Aa,So,La,Da,tt,wo,Wa,Ia,Va,Na,Q,ot,Oa,$o,Ra,Ua,_e,Ha,X,rt,Ba,st,Ja,Vt,Ga,Ya,Ka,ge,Qa,ve,at,Xa,nt,Za,Nt,en,tn,on,Te,it,rn,ct,sn,Ot,an,nn,Xo,ae,xe,yo,lt,cn,Eo,ln,Zo,I,dt,dn,U,pn,Rt,hn,mn,zo,fn,un,Ut,_n,gn,vn,pt,Tn,ht,xn,kn,bn,ke,mt,Sn,be,er;return h=new ut({}),Ee=new ut({}),Le=new ut({}),De=new $r({props:{code:`import torch
...
Will be passed to the underlying model specific decode method.`,name:"kwargs"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/tokenization_utils_base.py#L3373",returnDescription:`
...
Will be passed to the underlying model specific decode method.`,name:"kwargs"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/tokenization_utils_base.py#L3406",returnDescription:`
...
`}}),be=new Hi({props:{anchor:"transformers.Speech2Text2ForCausalLM.forward.example",$$slots:{default:[tc]},$$scope:{ctx:B}}}),{c(){f=a("meta"),E=l(),u=a("h1"),_=a("a"),w=a("span"),g(h.$$.fragment),S=l(),D=a("span"),q=r("Speech2Text2"),$=l(),F=a("h2"),M=a("a"),Zt=a("span"),g(Ee.$$.fragment),yr=l(),eo=a("span"),Er=r("Overview"),qo=l(),J=a("p"),zr=r("The Speech2Text2 model is used together with "),_t=a("a"),Pr=r("Wav2Vec2"),jr=r(` for Speech Translation models proposed in
...
model.`),Mo=l(),ne=a("p"),Br=r("This model was contributed by "),Pe=a("a"),Jr=r("Patrick von Platen"),Gr=r("."),Ao=l(),ie=a("p"),Yr=r("The original code can be found "),je=a("a"),Kr=r("here"),Qr=r("."),Lo=l(),xt=a("p"),Xr=r("Tips:"),Do=l(),G=a("ul"),Ce=a("li"),Zr=r(`Speech2Text2 achieves state-of-the-art results on the CoVoST Speech Translation dataset. For more information, see
the `),qe=a("a"),es=r("official models"),ts=r(" ."),os=l(),Fe=a("li"),rs=r("Speech2Text2 is always used within the "),kt=a("a"),ss=r("SpeechEncoderDecoder"),as=r(" framework."),ns=l(),Me=a("li"),is=r("Speech2Text2\u2019s tokenizer is based on "),Ae=a("a"),cs=r("fastBPE"),ls=r("."),Wo=l(),Z=a("h2"),ce=a("a"),so=a("span"),g(Le.$$.fragment),ds=l(),ao=a("span"),ps=r("Inference"),Io=l(),Y=a("p"),hs=r("Speech2Text2\u2019s "),bt=a("a"),ms=r("SpeechEncoderDecoderModel"),fs=r(` model accepts raw waveform input values from speech and
...
documentation from `),Ft=a("a"),Js=r("PretrainedConfig"),Gs=r(" for more information."),Ys=l(),g(pe.$$.fragment),Go=l(),re=a("h2"),he=a("a"),ho=a("span"),g(Ue.$$.fragment),Ks=l(),mo=a("span"),Qs=r("Speech2TextTokenizer"),Yo=l(),P=a("div"),g(He.$$.fragment),Xs=l(),fo=a("p"),Zs=r("Constructs a Speech2Text2Tokenizer."),ea=l(),Be=a("p"),ta=r("This tokenizer inherits from "),Mt=a("a"),oa=r("PreTrainedTokenizer"),ra=r(` which contains some of the main methods. Users should refer to
...
See the `),Ze=a("a"),ko=a("strong"),ya=r("call"),Ea=r("()"),za=r(" and "),It=a("a"),Pa=r("decode()"),ja=r(" for more information."),Ca=l(),ue=a("div"),g(et.$$.fragment),qa=l(),R=a("p"),Fa=r(`When used in normal mode, this method forwards all its arguments to AutoFeatureExtractor\u2019s
...
`),Tt=n(L,"A",{href:!0});var An=i(Tt);Or=s(An,"SpeechEncoderDecoder"),An.forEach(o),Rr=s(L," class on how to combine Speech2Text2 with any speech "),ro=n(L,"EM",{});var Ln=i(ro);Ur=s(Ln,"encoder-only"),Ln.forEach(o),Hr=s(L,`
...
See the `),Ze=n(H,"A",{href:!0});var wn=i(Ze);ko=n(wn,"STRONG",{});var zi=i(ko);ya=s(zi,"call"),zi.forEach(o),Ea=s(wn,"()"),wn.forEach(o),za=s(H," and "),It=n(H,"A",{href:!0});var Pi=i(It);Pa=s(Pi,"decode()"),Pi.forEach(o),ja=s(H," for more information."),H.forEach(o),Ca=d(C),ue=n(C,"DIV",{class:!0});var _r=i(ue);v(et.$$.fragment,_r),qa=d(_r),R=n(_r,"P",{});var we=i(R);Fa=s(we,`When used in normal mode, this method forwards all its arguments to AutoFeatureExtractor\u2019s
...
methods for more information.`),we.forEach(o),_r.forEach(o),Na=d(C),Q=n(C,"DIV",{class:!0});var Qt=i(Q);v(ot.$$.fragment,Qt),Oa=d(Qt),$o=n(Qt,"P",{});var Fi=i($o);Ra=s(Fi,"Instantiate a processor associated with a pretrained model."),Fi.forEach(o),Ua=d(Qt),v(_e.$$.fragment,Qt),Qt.forEach(o),Ha=d(C),X=n(C,"DIV",{class:!0});var Xt=i(X);v(rt.$$.fragment,Xt),Ba=d(Xt),st=n(Xt,"P",{});var gr=i(st);Ja=s(gr,`Saves the attributes of this processor (feature extractor, tokenizer\u2026) in the specified directory so that it
