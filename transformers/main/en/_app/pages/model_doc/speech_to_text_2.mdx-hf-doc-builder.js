...
See the `),Ze=a("a"),ko=a("strong"),ya=r("call"),Ea=r("()"),za=r(" and "),It=a("a"),Pa=r("decode()"),ja=r(" for more information."),Ca=l(),ue=a("div"),g(et.$$.fragment),qa=l(),B=a("p"),Ma=r(`When used in normal mode, this method forwards all its arguments to AutoFeatureExtractor\u2019s
...
a single processor.`),wi.forEach(o),Ta=d(C),A=n(C,"P",{});var U=i(A);Lt=n(U,"A",{href:!0});var $i=i(Lt);xa=s($i,"Speech2Text2Processor"),$i.forEach(o),ka=s(U," offers all the functionalities of "),Dt=n(U,"A",{href:!0});var yi=i(Dt);ba=s(yi,"AutoFeatureExtractor"),yi.forEach(o),Sa=s(U," and "),Wt=n(U,"A",{href:!0});var Ei=i(Wt);wa=s(Ei,"Speech2Text2Tokenizer"),Ei.forEach(o),$a=s(U,`.
See the `),Ze=n(U,"A",{href:!0});var wn=i(Ze);ko=n(wn,"STRONG",{});var zi=i(ko);ya=s(zi,"call"),zi.forEach(o),Ea=s(wn,"()"),wn.forEach(o),za=s(U," and "),It=n(U,"A",{href:!0});var Pi=i(It);Pa=s(Pi,"decode()"),Pi.forEach(o),ja=s(U," for more information."),U.forEach(o),Ca=d(C),ue=n(C,"DIV",{class:!0});var _r=i(ue);v(et.$$.fragment,_r),qa=d(_r),B=n(_r,"P",{});var we=i(B);Ma=s(we,`When used in normal mode, this method forwards all its arguments to AutoFeatureExtractor\u2019s
