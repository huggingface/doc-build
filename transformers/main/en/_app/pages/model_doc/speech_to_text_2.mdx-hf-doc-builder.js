...
`}}),be=new Ui({props:{anchor:"transformers.Speech2Text2ForCausalLM.forward.example",$$slots:{default:[tc]},$$scope:{ctx:H}}}),{c(){f=a("meta"),E=l(),u=a("h1"),_=a("a"),w=a("span"),g(m.$$.fragment),S=l(),D=a("span"),q=r("Speech2Text2"),$=l(),M=a("h2"),F=a("a"),Zt=a("span"),g(Ee.$$.fragment),yr=l(),eo=a("span"),Er=r("Overview"),qo=l(),J=a("p"),zr=r("The Speech2Text2 model is used together with "),_t=a("a"),Pr=r("Wav2Vec2"),jr=r(` for Speech Translation models proposed in
