import{S as tc,i as oc,s as rc,e as a,k as l,w as g,t as r,M as sc,c as n,d as o,m as d,a as i,x as v,h as s,b as c,G as e,g as h,y as T,q as x,o as k,B as b,v as ac,L as ec}from"../../chunks/vendor-316217a5.js";import{T as Yi}from"../../chunks/Tip-27e9fea0.js";import{D}from"../../chunks/Docstring-1fe4a33a.js";import{C as Pr}from"../../chunks/CodeBlock-8418a95e.js";import{I as gt}from"../../chunks/IconCopyLink-40460835.js";import{E as Zi}from"../../chunks/ExampleCodeBlock-32fc0037.js";function nc(B){let f,E,u,_,w;return _=new Pr({props:{code:`from transformers import Speech2Text2ForCausalLM, Speech2Text2Config
...
<span class="hljs-meta">&gt;&gt;&gt; </span>configuration = model.config`}}),{c(){f=a("p"),E=r("Example:"),u=l(),g(_.$$.fragment)},l(m){f=n(m,"P",{});var S=i(f);E=s(S,"Example:"),S.forEach(o),u=d(m),v(_.$$.fragment,m)},m(m,S){h(m,f,S),e(f,E),h(m,u,S),T(_,m,S),w=!0},p:ec,i(m){w||(x(_.$$.fragment,m),w=!0)},o(m){k(_.$$.fragment,m),w=!1},d(m){m&&o(f),m&&o(u),b(_,m)}}}function ic(B){let f,E,u,_,w,m,S,I;return{c(){f=a("p"),E=r(`This class method is simply calling the feature extractor
`),u=a("a"),_=r("from_pretrained()"),w=r(` and the tokenizer
`),m=a("code"),S=r("from_pretrained"),I=r(` methods. Please refer to the docstrings of the
...
`),m=n(y,"CODE",{});var M=i(m);S=s(M,"from_pretrained"),M.forEach(o),I=s(y,` methods. Please refer to the docstrings of the
methods above for more information.`),y.forEach(o),this.h()},h(){c(u,"href","/docs/transformers/main/en/main_classes/feature_extractor#transformers.FeatureExtractionMixin.from_pretrained")},m(q,y){h(q,f,y),e(f,E),e(f,u),e(u,_),e(f,w),e(f,m),e(m,S),e(f,I)},d(q){q&&o(f)}}}function cc(B){let f,E,u,_,w,m,S,I;return{c(){f=a("p"),E=r("This class method is simply calling "),u=a("a"),_=r("save_pretrained()"),w=r(` and
`),m=a("code"),S=r("save_pretrained"),I=r(`. Please refer to the docstrings of the methods
...
`),m=n(y,"CODE",{});var M=i(m);S=s(M,"save_pretrained"),M.forEach(o),I=s(y,`. Please refer to the docstrings of the methods
above for more information.`),y.forEach(o),this.h()},h(){c(u,"href","/docs/transformers/main/en/main_classes/feature_extractor#transformers.FeatureExtractionMixin.save_pretrained")},m(q,y){h(q,f,y),e(f,E),e(f,u),e(u,_),e(f,w),e(f,m),e(m,S),e(f,I)},d(q){q&&o(f)}}}function lc(B){let f,E,u,_,w;return _=new Pr({props:{code:`from transformers import (
...
<span class="hljs-meta">&gt;&gt;&gt; </span>loss.backward()`}}),{c(){f=a("p"),E=r("Example:"),u=l(),g(_.$$.fragment)},l(m){f=n(m,"P",{});var S=i(f);E=s(S,"Example:"),S.forEach(o),u=d(m),v(_.$$.fragment,m)},m(m,S){h(m,f,S),e(f,E),h(m,u,S),T(_,m,S),w=!0},p:ec,i(m){w||(x(_.$$.fragment,m),w=!0)},o(m){k(_.$$.fragment,m),w=!1},d(m){m&&o(f),m&&o(u),b(_,m)}}}function dc(B){let f,E,u,_,w,m,S,I,q,y,F,M,oo,ze,jr,ro,Cr,Ao,J,qr,vt,Fr,Mr,Pe,Ar,Lr,Lo,z,Dr,so,Ir,Wr,ao,Vr,Nr,Tt,Or,Ur,xt,Rr,Hr,kt,Br,Jr,no,Gr,Kr,Do,ne,Qr,je,Xr,Yr,Io,ie,Zr,Ce,es,ts,Wo,bt,os,Vo,G,qe,rs,Fe,ss,as,ns,Me,is,St,cs,ls,ds,Ae,ps,Le,hs,ms,No,Z,ce,io,De,fs,co,us,Oo,K,_s,wt,gs,vs,$t,Ts,xs,Uo,C,ks,yt,bs,Ss,Et,ws,$s,zt,ys,Es,Pt,zs,Ps,jt,js,Cs,Ro,Ct,lo,qs,Ho,Ie,Bo,qt,We,po,Fs,Ms,ho,As,Jo,Ve,Go,le,Ls,Ne,Ds,Is,Ko,ee,de,mo,Oe,Ws,fo,Vs,Qo,W,Ue,Ns,te,Os,Ft,Us,Rs,Re,Hs,Bs,Js,oe,Gs,Mt,Ks,Qs,At,Xs,Ys,Zs,pe,Xo,re,he,uo,He,ea,_o,ta,Yo,j,Be,oa,go,ra,sa,Je,aa,Lt,na,ia,ca,me,Ge,la,vo,da,pa,Q,Ke,ha,To,ma,fa,Qe,ua,xo,_a,ga,va,Dt,Xe,Zo,se,fe,ko,Ye,Ta,bo,xa,er,$,Ze,ka,So,ba,Sa,A,It,wa,$a,Wt,ya,Ea,Vt,za,Pa,et,wo,ja,Ca,qa,Nt,Fa,Ma,Aa,ue,tt,La,U,Da,$o,Ia,Wa,Ot,Va,Na,ot,yo,Oa,Ua,Ra,Ha,X,rt,Ba,Eo,Ja,Ga,_e,Ka,Y,st,Qa,at,Xa,Ut,Ya,Za,en,ge,tn,ve,nt,on,it,rn,Rt,sn,an,nn,Te,ct,cn,lt,ln,Ht,dn,pn,hn,xe,dt,mn,zo,fn,tr,ae,ke,Po,pt,un,jo,_n,or,V,ht,gn,R,vn,Bt,Tn,xn,Co,kn,bn,Jt,Sn,wn,$n,mt,yn,ft,En,zn,Pn,be,ut,jn,Se,rr;return m=new gt({}),ze=new gt({}),De=new gt({}),Ie=new Pr({props:{code:`import torch
...
just in case (e.g., 512 or 1024 or 2048).`,name:"max_source_positions"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/speech_to_text_2/configuration_speech_to_text_2.py#L31"}}),pe=new Zi({props:{anchor:"transformers.Speech2Text2Config.example",$$slots:{default:[nc]},$$scope:{ctx:B}}}),He=new gt({}),Be=new D({props:{name:"class transformers.Speech2Text2Tokenizer",anchor:"transformers.Speech2Text2Tokenizer",parameters:[{name:"vocab_file",val:""},{name:"bos_token",val:" = '<s>'"},{name:"pad_token",val:" = '<pad>'"},{name:"eos_token",val:" = '</s>'"},{name:"unk_token",val:" = '<unk>'"},{name:"do_lower_case",val:" = False"},{name:"merges_file",val:" = None"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.Speech2Text2Tokenizer.vocab_file",description:`<strong>vocab_file</strong> (<code>str</code>) &#x2014;
...
Will be passed to the underlying model specific decode method.`,name:"kwargs"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/tokenization_utils_base.py#L3267",returnDescription:`
...
Will be passed to the underlying model specific decode method.`,name:"kwargs"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/tokenization_utils_base.py#L3300",returnDescription:`
...
`}}),Se=new Zi({props:{anchor:"transformers.Speech2Text2ForCausalLM.forward.example",$$slots:{default:[lc]},$$scope:{ctx:B}}}),{c(){f=a("meta"),E=l(),u=a("h1"),_=a("a"),w=a("span"),g(m.$$.fragment),S=l(),I=a("span"),q=r("Speech2Text2"),y=l(),F=a("h2"),M=a("a"),oo=a("span"),g(ze.$$.fragment),jr=l(),ro=a("span"),Cr=r("Overview"),Ao=l(),J=a("p"),qr=r("The Speech2Text2 model is used together with "),vt=a("a"),Fr=r("Wav2Vec2"),Mr=r(` for Speech Translation models proposed in
...
refer to the docstring of this method for more information.`),nn=l(),Te=a("div"),g(ct.$$.fragment),cn=l(),lt=a("p"),ln=r("This method forwards all its arguments to Speech2Text2Tokenizer\u2019s "),Ht=a("a"),dn=r("decode()"),pn=r(`. Please refer
...
refer to the docstring of this method for more information.`),br.forEach(o),kr.forEach(o),nn=d(P),Te=n(P,"DIV",{class:!0});var Sr=i(Te);v(ct.$$.fragment,Sr),cn=d(Sr),lt=n(Sr,"P",{});var wr=i(lt);ln=s(wr,"This method forwards all its arguments to Speech2Text2Tokenizer\u2019s "),Ht=n(wr,"A",{href:!0});var Ui=i(Ht);dn=s(Ui,"decode()"),Ui.forEach(o),pn=s(wr,`. Please refer
