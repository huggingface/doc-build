...
<span class="hljs-meta">&gt;&gt;&gt; </span>configuration = model.config`}}),{c(){f=a("p"),E=r("Example:"),u=l(),g(_.$$.fragment)},l(m){f=n(m,"P",{});var S=i(f);E=s(S,"Example:"),S.forEach(o),u=d(m),v(_.$$.fragment,m)},m(m,S){h(m,f,S),e(f,E),h(m,u,S),T(_,m,S),w=!0},p:ec,i(m){w||(x(_.$$.fragment,m),w=!0)},o(m){k(_.$$.fragment,m),w=!1},d(m){m&&o(f),m&&o(u),b(_,m)}}}function ic(H){let f,E,u,_,w,m,S,I;return{c(){f=a("p"),E=r(`This class method is simply calling the feature extractor
...
`),m=n(y,"CODE",{});var F=i(m);S=s(F,"from_pretrained"),F.forEach(o),I=s(y,` methods. Please refer to the docstrings of the
methods above for more information.`),y.forEach(o),this.h()},h(){c(u,"href","/docs/transformers/main/en/main_classes/feature_extractor#transformers.FeatureExtractionMixin.from_pretrained")},m(q,y){h(q,f,y),e(f,E),e(f,u),e(u,_),e(f,w),e(f,m),e(m,S),e(f,I)},d(q){q&&o(f)}}}function cc(H){let f,E,u,_,w,m,S,I;return{c(){f=a("p"),E=r("This class method is simply calling "),u=a("a"),_=r("save_pretrained()"),w=r(` and
...
`),m=n(y,"CODE",{});var F=i(m);S=s(F,"save_pretrained"),F.forEach(o),I=s(y,`. Please refer to the docstrings of the methods
above for more information.`),y.forEach(o),this.h()},h(){c(u,"href","/docs/transformers/main/en/main_classes/feature_extractor#transformers.FeatureExtractionMixin.save_pretrained")},m(q,y){h(q,f,y),e(f,E),e(f,u),e(u,_),e(f,w),e(f,m),e(m,S),e(f,I)},d(q){q&&o(f)}}}function lc(H){let f,E,u,_,w;return _=new Pr({props:{code:`from transformers import (
...
<span class="hljs-meta">&gt;&gt;&gt; </span>loss.backward()`}}),{c(){f=a("p"),E=r("Example:"),u=l(),g(_.$$.fragment)},l(m){f=n(m,"P",{});var S=i(f);E=s(S,"Example:"),S.forEach(o),u=d(m),v(_.$$.fragment,m)},m(m,S){h(m,f,S),e(f,E),h(m,u,S),T(_,m,S),w=!0},p:ec,i(m){w||(x(_.$$.fragment,m),w=!0)},o(m){k(_.$$.fragment,m),w=!1},d(m){m&&o(f),m&&o(u),b(_,m)}}}function dc(H){let f,E,u,_,w,m,S,I,q,y,M,F,oo,ze,jr,ro,Cr,Ao,J,qr,vt,Mr,Fr,Pe,Ar,Lr,Lo,z,Dr,so,Ir,Wr,ao,Vr,Nr,Tt,Or,Br,xt,Ur,Rr,kt,Hr,Jr,no,Gr,Kr,Do,ne,Qr,je,Xr,Yr,Io,ie,Zr,Ce,es,ts,Wo,bt,os,Vo,G,qe,rs,Me,ss,as,ns,Fe,is,St,cs,ls,ds,Ae,ps,Le,hs,ms,No,Z,ce,io,De,fs,co,us,Oo,K,_s,wt,gs,vs,$t,Ts,xs,Bo,C,ks,yt,bs,Ss,Et,ws,$s,zt,ys,Es,Pt,zs,Ps,jt,js,Cs,Uo,Ct,lo,qs,Ro,Ie,Ho,qt,We,po,Ms,Fs,ho,As,Jo,Ve,Go,le,Ls,Ne,Ds,Is,Ko,ee,de,mo,Oe,Ws,fo,Vs,Qo,W,Be,Ns,te,Os,Mt,Bs,Us,Ue,Rs,Hs,Js,oe,Gs,Ft,Ks,Qs,At,Xs,Ys,Zs,pe,Xo,re,he,uo,Re,ea,_o,ta,Yo,j,He,oa,go,ra,sa,Je,aa,Lt,na,ia,ca,me,Ge,la,vo,da,pa,Q,Ke,ha,To,ma,fa,Qe,ua,xo,_a,ga,va,Dt,Xe,Zo,se,fe,ko,Ye,Ta,bo,xa,er,$,Ze,ka,So,ba,Sa,A,It,wa,$a,Wt,ya,Ea,Vt,za,Pa,et,wo,ja,Ca,qa,Nt,Ma,Fa,Aa,ue,tt,La,B,Da,$o,Ia,Wa,Ot,Va,Na,ot,yo,Oa,Ba,Ua,Ra,X,rt,Ha,Eo,Ja,Ga,_e,Ka,Y,st,Qa,at,Xa,Bt,Ya,Za,en,ge,tn,ve,nt,on,it,rn,Ut,sn,an,nn,Te,ct,cn,lt,ln,Rt,dn,pn,hn,xe,dt,mn,zo,fn,tr,ae,ke,Po,pt,un,jo,_n,or,V,ht,gn,U,vn,Ht,Tn,xn,Co,kn,bn,Jt,Sn,wn,$n,mt,yn,ft,En,zn,Pn,be,ut,jn,Se,rr;return m=new gt({}),ze=new gt({}),De=new gt({}),Ie=new Pr({props:{code:`import torch
...
`}}),Se=new Zi({props:{anchor:"transformers.Speech2Text2ForCausalLM.forward.example",$$slots:{default:[lc]},$$scope:{ctx:H}}}),{c(){f=a("meta"),E=l(),u=a("h1"),_=a("a"),w=a("span"),g(m.$$.fragment),S=l(),I=a("span"),q=r("Speech2Text2"),y=l(),M=a("h2"),F=a("a"),oo=a("span"),g(ze.$$.fragment),jr=l(),ro=a("span"),Cr=r("Overview"),Ao=l(),J=a("p"),qr=r("The Speech2Text2 model is used together with "),vt=a("a"),Mr=r("Wav2Vec2"),Fr=r(` for Speech Translation models proposed in
...
to the docstring of this method for more information.`),wr.forEach(o),Sr.forEach(o),hn=d(P),xe=n(P,"DIV",{class:!0});var $r=i(xe);v(dt.$$.fragment,$r),mn=d($r),zo=n($r,"P",{});var Ui=i(zo);fn=s(Ui,`Temporarily sets the tokenizer for processing the input. Useful for encoding the labels when fine-tuning
