...
`),m=n($,"CODE",{});var M=i(m);S=s(M,"~tokenization_utils_base.PreTrainedTokenizer.from_pretrained"),M.forEach(o),D=s($,` methods. Please refer to the docstrings of the
...
`),m=n($,"CODE",{});var M=i(m);S=s(M,"~tokenization_utils_base.PreTrainedTokenizer.save_pretrained"),M.forEach(o),D=s($,`. Please refer to the docstrings of the methods
