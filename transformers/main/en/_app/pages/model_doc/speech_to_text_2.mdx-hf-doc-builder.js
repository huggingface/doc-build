import{S as Ji,i as Gi,s as Yi,e as a,k as l,w as g,t as r,M as Ki,c as n,d as o,m as d,a as i,x as v,h as s,b as c,G as e,g as h,y as T,q as x,o as k,B as b,v as Qi,L as Bi}from"../../chunks/vendor-hf-doc-builder.js";import{T as Ui}from"../../chunks/Tip-hf-doc-builder.js";import{D as V}from"../../chunks/Docstring-hf-doc-builder.js";import{C as $r}from"../../chunks/CodeBlock-hf-doc-builder.js";import{I as ut}from"../../chunks/IconCopyLink-hf-doc-builder.js";import{E as Hi}from"../../chunks/ExampleCodeBlock-hf-doc-builder.js";function Xi(B){let f,E,u,_,w;return _=new $r({props:{code:`from transformers import Speech2Text2ForCausalLM, Speech2Text2Config
...
<span class="hljs-meta">&gt;&gt;&gt; </span>loss.backward()`}}),{c(){f=a("p"),E=r("Example:"),u=l(),g(_.$$.fragment)},l(m){f=n(m,"P",{});var S=i(f);E=s(S,"Example:"),S.forEach(o),u=d(m),v(_.$$.fragment,m)},m(m,S){h(m,f,S),e(f,E),h(m,u,S),T(_,m,S),w=!0},p:Bi,i(m){w||(x(_.$$.fragment,m),w=!0)},o(m){k(_.$$.fragment,m),w=!1},d(m){m&&o(f),m&&o(u),b(_,m)}}}function oc(B){let f,E,u,_,w,m,S,D,q,$,M,F,Zt,Ee,yr,eo,Er,qo,J,zr,_t,Pr,jr,ze,Cr,qr,Mo,z,Mr,to,Fr,Ar,oo,Lr,Dr,gt,Wr,Ir,vt,Vr,Nr,Tt,Or,Rr,ro,Ur,Hr,Fo,ne,Br,Pe,Jr,Gr,Ao,ie,Yr,je,Kr,Qr,Lo,xt,Xr,Do,G,Ce,Zr,qe,es,ts,os,Me,rs,kt,ss,as,ns,Fe,is,Ae,cs,ls,Wo,Z,ce,so,Le,ds,ao,ps,Io,Y,hs,bt,ms,fs,St,us,_s,Vo,j,gs,wt,vs,Ts,$t,xs,ks,yt,bs,Ss,Et,ws,$s,zt,ys,Es,No,Pt,no,zs,Oo,De,Ro,jt,We,io,Ps,js,co,Cs,Uo,Ie,Ho,le,qs,Ve,Ms,Fs,Bo,ee,de,lo,Ne,As,po,Ls,Jo,W,Oe,Ds,te,Ws,Ct,Is,Vs,Re,Ns,Os,Rs,oe,Us,qt,Hs,Bs,Mt,Js,Gs,Ys,pe,Go,re,he,ho,Ue,Ks,mo,Qs,Yo,P,He,Xs,fo,Zs,ea,Be,ta,Ft,oa,ra,sa,me,Je,aa,uo,na,ia,K,Ge,ca,_o,la,da,Ye,pa,go,ha,ma,fa,At,Ke,Ko,se,fe,vo,Qe,ua,To,_a,Qo,y,Xe,ga,xo,va,Ta,A,Lt,xa,ka,Dt,ba,Sa,Wt,wa,$a,Ze,ko,ya,Ea,za,It,Pa,ja,Ca,ue,et,qa,R,Ma,bo,Fa,Aa,So,La,Da,tt,wo,Wa,Ia,Va,Na,Q,ot,Oa,$o,Ra,Ua,_e,Ha,X,rt,Ba,st,Ja,Vt,Ga,Ya,Ka,ge,Qa,ve,at,Xa,nt,Za,Nt,en,tn,on,Te,it,rn,ct,sn,Ot,an,nn,Xo,ae,xe,yo,lt,cn,Eo,ln,Zo,I,dt,dn,U,pn,Rt,hn,mn,zo,fn,un,Ut,_n,gn,vn,pt,Tn,ht,xn,kn,bn,ke,mt,Sn,be,er;return m=new ut({}),Ee=new ut({}),Le=new ut({}),De=new $r({props:{code:`import torch
...
model.`),Fo=l(),ne=a("p"),Br=r("This model was contributed by "),Pe=a("a"),Jr=r("Patrick von Platen"),Gr=r("."),Ao=l(),ie=a("p"),Yr=r("The original code can be found "),je=a("a"),Kr=r("here"),Qr=r("."),Lo=l(),xt=a("p"),Xr=r("Tips:"),Do=l(),G=a("ul"),Ce=a("li"),Zr=r(`Speech2Text2 achieves state-of-the-art results on the CoVoST Speech Translation dataset. For more information, see
