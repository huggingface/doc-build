import{S as tc,i as oc,s as rc,e as a,k as l,w as g,t as r,M as sc,c as n,d as o,m as d,a as i,x as v,h as s,b as c,G as e,g as h,y as x,q as T,o as k,B as b,v as ac,L as ec}from"../../chunks/vendor-hf-doc-builder.js";import{T as Yi}from"../../chunks/Tip-hf-doc-builder.js";import{D}from"../../chunks/Docstring-hf-doc-builder.js";import{C as Pr}from"../../chunks/CodeBlock-hf-doc-builder.js";import{I as gt}from"../../chunks/IconCopyLink-hf-doc-builder.js";import{E as Zi}from"../../chunks/ExampleCodeBlock-hf-doc-builder.js";function nc(H){let f,E,u,_,w;return _=new Pr({props:{code:`from transformers import Speech2Text2ForCausalLM, Speech2Text2Config
...
<span class="hljs-meta">&gt;&gt;&gt; </span>configuration = model.config`}}),{c(){f=a("p"),E=r("Example:"),u=l(),g(_.$$.fragment)},l(m){f=n(m,"P",{});var S=i(f);E=s(S,"Example:"),S.forEach(o),u=d(m),v(_.$$.fragment,m)},m(m,S){h(m,f,S),e(f,E),h(m,u,S),x(_,m,S),w=!0},p:ec,i(m){w||(T(_.$$.fragment,m),w=!0)},o(m){k(_.$$.fragment,m),w=!1},d(m){m&&o(f),m&&o(u),b(_,m)}}}function ic(H){let f,E,u,_,w,m,S,W;return{c(){f=a("p"),E=r(`This class method is simply calling the feature extractor
...
`),m=n(y,"CODE",{});var F=i(m);S=s(F,"from_pretrained"),F.forEach(o),W=s(y,` methods. Please refer to the docstrings of the
methods above for more information.`),y.forEach(o),this.h()},h(){c(u,"href","/docs/transformers/main/en/main_classes/feature_extractor#transformers.FeatureExtractionMixin.from_pretrained")},m(q,y){h(q,f,y),e(f,E),e(f,u),e(u,_),e(f,w),e(f,m),e(m,S),e(f,W)},d(q){q&&o(f)}}}function cc(H){let f,E,u,_,w,m,S,W;return{c(){f=a("p"),E=r("This class method is simply calling "),u=a("a"),_=r("save_pretrained()"),w=r(` and
`),m=a("code"),S=r("save_pretrained"),W=r(`. Please refer to the docstrings of the methods
above for more information.`),this.h()},l(q){f=n(q,"P",{});var y=i(f);E=s(y,"This class method is simply calling "),u=n(y,"A",{href:!0});var M=i(u);_=s(M,"save_pretrained()"),M.forEach(o),w=s(y,` and
`),m=n(y,"CODE",{});var F=i(m);S=s(F,"save_pretrained"),F.forEach(o),W=s(y,`. Please refer to the docstrings of the methods
above for more information.`),y.forEach(o),this.h()},h(){c(u,"href","/docs/transformers/main/en/main_classes/feature_extractor#transformers.FeatureExtractionMixin.save_pretrained")},m(q,y){h(q,f,y),e(f,E),e(f,u),e(u,_),e(f,w),e(f,m),e(m,S),e(f,W)},d(q){q&&o(f)}}}function lc(H){let f,E,u,_,w;return _=new Pr({props:{code:`from transformers import (
...
<span class="hljs-meta">&gt;&gt;&gt; </span>loss.backward()`}}),{c(){f=a("p"),E=r("Example:"),u=l(),g(_.$$.fragment)},l(m){f=n(m,"P",{});var S=i(f);E=s(S,"Example:"),S.forEach(o),u=d(m),v(_.$$.fragment,m)},m(m,S){h(m,f,S),e(f,E),h(m,u,S),x(_,m,S),w=!0},p:ec,i(m){w||(T(_.$$.fragment,m),w=!0)},o(m){k(_.$$.fragment,m),w=!1},d(m){m&&o(f),m&&o(u),b(_,m)}}}function dc(H){let f,E,u,_,w,m,S,W,q,y,M,F,oo,ze,jr,ro,Cr,Ao,J,qr,vt,Mr,Fr,Pe,Ar,Lr,Lo,z,Dr,so,Wr,Ir,ao,Vr,Nr,xt,Or,Ur,Tt,Rr,Br,kt,Hr,Jr,no,Gr,Kr,Do,ne,Qr,je,Xr,Yr,Wo,ie,Zr,Ce,es,ts,Io,bt,os,Vo,G,qe,rs,Me,ss,as,ns,Fe,is,St,cs,ls,ds,Ae,ps,Le,hs,ms,No,Z,ce,io,De,fs,co,us,Oo,K,_s,wt,gs,vs,$t,xs,Ts,Uo,C,ks,yt,bs,Ss,Et,ws,$s,zt,ys,Es,Pt,zs,Ps,jt,js,Cs,Ro,Ct,lo,qs,Bo,We,Ho,qt,Ie,po,Ms,Fs,ho,As,Jo,Ve,Go,le,Ls,Ne,Ds,Ws,Ko,ee,de,mo,Oe,Is,fo,Vs,Qo,I,Ue,Ns,te,Os,Mt,Us,Rs,Re,Bs,Hs,Js,oe,Gs,Ft,Ks,Qs,At,Xs,Ys,Zs,pe,Xo,re,he,uo,Be,ea,_o,ta,Yo,j,He,oa,go,ra,sa,Je,aa,Lt,na,ia,ca,me,Ge,la,vo,da,pa,Q,Ke,ha,xo,ma,fa,Qe,ua,To,_a,ga,va,Dt,Xe,Zo,se,fe,ko,Ye,xa,bo,Ta,er,$,Ze,ka,So,ba,Sa,A,Wt,wa,$a,It,ya,Ea,Vt,za,Pa,et,wo,ja,Ca,qa,Nt,Ma,Fa,Aa,ue,tt,La,U,Da,$o,Wa,Ia,Ot,Va,Na,ot,yo,Oa,Ua,Ra,Ba,X,rt,Ha,Eo,Ja,Ga,_e,Ka,Y,st,Qa,at,Xa,Ut,Ya,Za,en,ge,tn,ve,nt,on,it,rn,Rt,sn,an,nn,xe,ct,cn,lt,ln,Bt,dn,pn,hn,Te,dt,mn,zo,fn,tr,ae,ke,Po,pt,un,jo,_n,or,V,ht,gn,R,vn,Ht,xn,Tn,Co,kn,bn,Jt,Sn,wn,$n,mt,yn,ft,En,zn,Pn,be,ut,jn,Se,rr;return m=new gt({}),ze=new gt({}),De=new gt({}),We=new Pr({props:{code:`import torch
...
just in case (e.g., 512 or 1024 or 2048).`,name:"max_source_positions"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/speech_to_text_2/configuration_speech_to_text_2.py#L31"}}),pe=new Zi({props:{anchor:"transformers.Speech2Text2Config.example",$$slots:{default:[nc]},$$scope:{ctx:H}}}),Be=new gt({}),He=new D({props:{name:"class transformers.Speech2Text2Tokenizer",anchor:"transformers.Speech2Text2Tokenizer",parameters:[{name:"vocab_file",val:""},{name:"bos_token",val:" = '<s>'"},{name:"pad_token",val:" = '<pad>'"},{name:"eos_token",val:" = '</s>'"},{name:"unk_token",val:" = '<unk>'"},{name:"do_lower_case",val:" = False"},{name:"merges_file",val:" = None"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.Speech2Text2Tokenizer.vocab_file",description:`<strong>vocab_file</strong> (<code>str</code>) &#x2014;
...
`,returnType:`
<p><code>str</code></p>
`}}),Xe=new D({props:{name:"save_vocabulary",anchor:"transformers.Speech2Text2Tokenizer.save_vocabulary",parameters:[{name:"save_directory",val:": str"},{name:"filename_prefix",val:": typing.Optional[str] = None"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/speech_to_text_2/tokenization_speech_to_text_2.py#L241"}}),Ye=new gt({}),Ze=new D({props:{name:"class transformers.Speech2Text2Processor",anchor:"transformers.Speech2Text2Processor",parameters:[{name:"feature_extractor",val:""},{name:"tokenizer",val:""}],parametersDescription:[{anchor:"transformers.Speech2Text2Processor.feature_extractor",description:`<strong>feature_extractor</strong> (<code>AutoFeatureExtractor</code>) &#x2014;
...
An instance of <a href="/docs/transformers/main/en/model_doc/speech_to_text_2#transformers.Speech2Text2Tokenizer">Speech2Text2Tokenizer</a>. The tokenizer is a required input.`,name:"tokenizer"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/speech_to_text_2/processing_speech_to_text_2.py#L23"}}),tt=new D({props:{name:"__call__",anchor:"transformers.Speech2Text2Processor.__call__",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/speech_to_text_2/processing_speech_to_text_2.py#L44"}}),rt=new D({props:{name:"from_pretrained",anchor:"transformers.Speech2Text2Processor.from_pretrained",parameters:[{name:"pretrained_model_name_or_path",val:""},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.Speech2Text2Processor.from_pretrained.pretrained_model_name_or_path",description:`<strong>pretrained_model_name_or_path</strong> (<code>str</code> or <code>os.PathLike</code>) &#x2014;
...
`}}),Se=new Zi({props:{anchor:"transformers.Speech2Text2ForCausalLM.forward.example",$$slots:{default:[lc]},$$scope:{ctx:H}}}),{c(){f=a("meta"),E=l(),u=a("h1"),_=a("a"),w=a("span"),g(m.$$.fragment),S=l(),W=a("span"),q=r("Speech2Text2"),y=l(),M=a("h2"),F=a("a"),oo=a("span"),g(ze.$$.fragment),jr=l(),ro=a("span"),Cr=r("Overview"),Ao=l(),J=a("p"),qr=r("The Speech2Text2 model is used together with "),vt=a("a"),Mr=r("Wav2Vec2"),Fr=r(` for Speech Translation models proposed in
...
model.`),Do=l(),ne=a("p"),Qr=r("This model was contributed by "),je=a("a"),Xr=r("Patrick von Platen"),Yr=r("."),Wo=l(),ie=a("p"),Zr=r("The original code can be found "),Ce=a("a"),es=r("here"),ts=r("."),Io=l(),bt=a("p"),os=r("Tips:"),Vo=l(),G=a("ul"),qe=a("li"),rs=r(`Speech2Text2 achieves state-of-the-art results on the CoVoST Speech Translation dataset. For more information, see
the `),Me=a("a"),ss=r("official models"),as=r(" ."),ns=l(),Fe=a("li"),is=r("Speech2Text2 is always used within the "),St=a("a"),cs=r("SpeechEncoderDecoder"),ls=r(" framework."),ds=l(),Ae=a("li"),ps=r("Speech2Text2\u2019s tokenizer is based on "),Le=a("a"),hs=r("fastBPE"),ms=r("."),No=l(),Z=a("h2"),ce=a("a"),io=a("span"),g(De.$$.fragment),fs=l(),co=a("span"),us=r("Inference"),Oo=l(),K=a("p"),_s=r("Speech2Text2\u2019s "),wt=a("a"),gs=r("SpeechEncoderDecoderModel"),vs=r(` model accepts raw waveform input values from speech and
...
tokens and clean up tokenization spaces.`),fa=l(),Qe=a("p"),ua=r("Similar to doing "),To=a("code"),_a=r("self.convert_tokens_to_string(self.convert_ids_to_tokens(token_ids))"),ga=r("."),va=l(),Dt=a("div"),g(Xe.$$.fragment),Zo=l(),se=a("h2"),fe=a("a"),ko=a("span"),g(Ye.$$.fragment),xa=l(),bo=a("span"),Ta=r("Speech2Text2Processor"),er=l(),$=a("div"),g(Ze.$$.fragment),ka=l(),So=a("p"),ba=r(`Constructs a Speech2Text2 processor which wraps a Speech2Text2 feature extractor and a Speech2Text2 tokenizer into
...
refer to the docstring of this method for more information.`),nn=l(),xe=a("div"),g(ct.$$.fragment),cn=l(),lt=a("p"),ln=r("This method forwards all its arguments to Speech2Text2Tokenizer\u2019s "),Bt=a("a"),dn=r("decode()"),pn=r(`. Please refer
...
`),xt=n(L,"A",{href:!0});var Vn=i(xt);Or=s(Vn,"Wav2Vec2"),Vn.forEach(o),Ur=s(L," or "),Tt=n(L,"A",{href:!0});var Nn=i(Tt);Rr=s(Nn,"HuBERT"),Nn.forEach(o),Br=s(L,` for Speech-to-Text tasks. Please refer to the
`),kt=n(L,"A",{href:!0});var On=i(kt);Hr=s(On,"SpeechEncoderDecoder"),On.forEach(o),Jr=s(L," class on how to combine Speech2Text2 with any speech "),no=n(L,"EM",{});var Un=i(no);Gr=s(Un,"encoder-only"),Un.forEach(o),Kr=s(L,`
model.`),L.forEach(o),Do=d(t),ne=n(t,"P",{});var ar=i(ne);Qr=s(ar,"This model was contributed by "),je=n(ar,"A",{href:!0,rel:!0});var Rn=i(je);Xr=s(Rn,"Patrick von Platen"),Rn.forEach(o),Yr=s(ar,"."),ar.forEach(o),Wo=d(t),ie=n(t,"P",{});var nr=i(ie);Zr=s(nr,"The original code can be found "),Ce=n(nr,"A",{href:!0,rel:!0});var Bn=i(Ce);es=s(Bn,"here"),Bn.forEach(o),ts=s(nr,"."),nr.forEach(o),Io=d(t),bt=n(t,"P",{});var Hn=i(bt);os=s(Hn,"Tips:"),Hn.forEach(o),Vo=d(t),G=n(t,"UL",{});var Kt=i(G);qe=n(Kt,"LI",{});var ir=i(qe);rs=s(ir,`Speech2Text2 achieves state-of-the-art results on the CoVoST Speech Translation dataset. For more information, see
...
tokens and clean up tokenization spaces.`),$i.forEach(o),fa=d(Zt),Qe=n(Zt,"P",{});var gr=i(Qe);ua=s(gr,"Similar to doing "),To=n(gr,"CODE",{});var yi=i(To);_a=s(yi,"self.convert_tokens_to_string(self.convert_ids_to_tokens(token_ids))"),yi.forEach(o),ga=s(gr,"."),gr.forEach(o),Zt.forEach(o),va=d(O),Dt=n(O,"DIV",{class:!0});var Ei=i(Dt);v(Xe.$$.fragment,Ei),Ei.forEach(o),O.forEach(o),Zo=d(t),se=n(t,"H2",{class:!0});var vr=i(se);fe=n(vr,"A",{id:!0,class:!0,href:!0});var zi=i(fe);ko=n(zi,"SPAN",{});var Pi=i(ko);v(Ye.$$.fragment,Pi),Pi.forEach(o),zi.forEach(o),xa=d(vr),bo=n(vr,"SPAN",{});var ji=i(bo);Ta=s(ji,"Speech2Text2Processor"),ji.forEach(o),vr.forEach(o),er=d(t),$=n(t,"DIV",{class:!0});var P=i($);v(Ze.$$.fragment,P),ka=d(P),So=n(P,"P",{});var Ci=i(So);ba=s(Ci,`Constructs a Speech2Text2 processor which wraps a Speech2Text2 feature extractor and a Speech2Text2 tokenizer into
a single processor.`),Ci.forEach(o),Sa=d(P),A=n(P,"P",{});var B=i(A);Wt=n(B,"A",{href:!0});var qi=i(Wt);wa=s(qi,"Speech2Text2Processor"),qi.forEach(o),$a=s(B," offers all the functionalities of "),It=n(B,"A",{href:!0});var Mi=i(It);ya=s(Mi,"AutoFeatureExtractor"),Mi.forEach(o),Ea=s(B," and "),Vt=n(B,"A",{href:!0});var Fi=i(Vt);za=s(Fi,"Speech2Text2Tokenizer"),Fi.forEach(o),Pa=s(B,`.
See the `),et=n(B,"A",{href:!0});var Cn=i(et);wo=n(Cn,"STRONG",{});var Ai=i(wo);ja=s(Ai,"call"),Ai.forEach(o),Ca=s(Cn,"()"),Cn.forEach(o),qa=s(B," and "),Nt=n(B,"A",{href:!0});var Li=i(Nt);Ma=s(Li,"decode()"),Li.forEach(o),Fa=s(B," for more information."),B.forEach(o),Aa=d(P),ue=n(P,"DIV",{class:!0});var xr=i(ue);v(tt.$$.fragment,xr),La=d(xr),U=n(xr,"P",{});var $e=i(U);Da=s($e,`When used in normal mode, this method forwards all its arguments to AutoFeatureExtractor\u2019s
...
methods for more information.`),$e.forEach(o),xr.forEach(o),Ba=d(P),X=n(P,"DIV",{class:!0});var eo=i(X);v(rt.$$.fragment,eo),Ha=d(eo),Eo=n(eo,"P",{});var Vi=i(Eo);Ja=s(Vi,"Instantiate a processor associated with a pretrained model."),Vi.forEach(o),Ga=d(eo),v(_e.$$.fragment,eo),eo.forEach(o),Ka=d(P),Y=n(P,"DIV",{class:!0});var to=i(Y);v(st.$$.fragment,to),Qa=d(to),at=n(to,"P",{});var Tr=i(at);Xa=s(Tr,`Saves the attributes of this processor (feature extractor, tokenizer\u2026) in the specified directory so that it
can be reloaded using the `),Ut=n(Tr,"A",{href:!0});var Ni=i(Ut);Ya=s(Ni,"from_pretrained()"),Ni.forEach(o),Za=s(Tr," method."),Tr.forEach(o),en=d(to),v(ge.$$.fragment,to),to.forEach(o),tn=d(P),ve=n(P,"DIV",{class:!0});var kr=i(ve);v(nt.$$.fragment,kr),on=d(kr),it=n(kr,"P",{});var br=i(it);rn=s(br,"This method forwards all its arguments to Speech2Text2Tokenizer\u2019s "),Rt=n(br,"A",{href:!0});var Oi=i(Rt);sn=s(Oi,"batch_decode()"),Oi.forEach(o),an=s(br,`. Please
refer to the docstring of this method for more information.`),br.forEach(o),kr.forEach(o),nn=d(P),xe=n(P,"DIV",{class:!0});var Sr=i(xe);v(ct.$$.fragment,Sr),cn=d(Sr),lt=n(Sr,"P",{});var wr=i(lt);ln=s(wr,"This method forwards all its arguments to Speech2Text2Tokenizer\u2019s "),Bt=n(wr,"A",{href:!0});var Ui=i(Bt);dn=s(Ui,"decode()"),Ui.forEach(o),pn=s(wr,`. Please refer
...
Speech2Text2.`),Ri.forEach(o),$r.forEach(o),P.forEach(o),tr=d(t),ae=n(t,"H2",{class:!0});var yr=i(ae);ke=n(yr,"A",{id:!0,class:!0,href:!0});var Bi=i(ke);Po=n(Bi,"SPAN",{});var Hi=i(Po);v(pt.$$.fragment,Hi),Hi.forEach(o),Bi.forEach(o),un=d(yr),jo=n(yr,"SPAN",{});var Ji=i(jo);_n=s(Ji,"Speech2Text2ForCausalLM"),Ji.forEach(o),yr.forEach(o),or=d(t),V=n(t,"DIV",{class:!0});var ye=i(V);v(ht.$$.fragment,ye),gn=d(ye),R=n(ye,"P",{});var Ee=i(R);vn=s(Ee,"The Speech2Text2 Decoder with a language modeling head. Can be used as the decoder part of "),Ht=n(Ee,"A",{href:!0});var Gi=i(Ht);xn=s(Gi,"EncoderDecoderModel"),Gi.forEach(o),Tn=s(Ee," and "),Co=n(Ee,"CODE",{});var Ki=i(Co);kn=s(Ki,"SpeechEncoderDecoder"),Ki.forEach(o),bn=s(Ee,`.
