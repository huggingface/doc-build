import{S as pT,i as fT,s as gT,e as a,k as c,w as v,t as n,Y as Oo,M as uT,c as r,d as t,m,a as i,x as T,h as s,Z as Po,b as _,G as e,g as f,y,q as $,o as L,B as x,v as _T,L as je}from"../../chunks/vendor-hf-doc-builder.js";import{T as Ae}from"../../chunks/Tip-hf-doc-builder.js";import{D as W}from"../../chunks/Docstring-hf-doc-builder.js";import{C as Le}from"../../chunks/CodeBlock-hf-doc-builder.js";import{I as Oe}from"../../chunks/IconCopyLink-hf-doc-builder.js";import{E as Ce}from"../../chunks/ExampleCodeBlock-hf-doc-builder.js";function wT(M){let l,k,h,p,b;return p=new Le({props:{code:`from transformers import LongformerConfig, LongformerModel
...
first positional argument :`),X=c(),q=a("ul"),j=a("li"),ne=n("a single Tensor with "),U=a("code"),de=n("input_ids"),se=n(" only and nothing else: "),B=a("code"),ge=n("model(inputs_ids)"),ce=c(),C=a("li"),ue=n(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
...
first positional argument :`),Fe.forEach(t),X=m(w),q=r(w,"UL",{});var O=i(q);j=r(O,"LI",{});var V=i(j);ne=s(V,"a single Tensor with "),U=r(V,"CODE",{});var Me=i(U);de=s(Me,"input_ids"),Me.forEach(t),se=s(V," only and nothing else: "),B=r(V,"CODE",{});var ye=i(B);ge=s(ye,"model(inputs_ids)"),ye.forEach(t),V.forEach(t),ce=m(O),C=r(O,"LI",{});var I=i(C);ue=s(I,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
...
<span class="hljs-number">0.44</span>`}}),{c(){v(l.$$.fragment)},l(h){T(l.$$.fragment,h)},m(h,p){y(l,h,p),k=!0},p:je,i(h){k||($(l.$$.fragment,h),k=!0)},o(h){L(l.$$.fragment,h),k=!1},d(h){x(l,h)}}}function WT(M){let l,k,h,p,b,d,u,E,he,J,z,Z,S,ee,pe,D,fe,le,G,P,te,X,q,j,ne,U,de,se,B,ge,ce,C,ue,Q,ae,K,H,re,_e,N,ie,R,we;return{c(){l=a("p"),k=n("TF 2.0 models accepts two formats as inputs:"),h=c(),p=a("ul"),b=a("li"),d=n("having all inputs as keyword arguments (like PyTorch models), or"),u=c(),E=a("li"),he=n("having all inputs as a list, tuple or dict in the first positional arguments."),J=c(),z=a("p"),Z=n("This second option is useful when using "),S=a("code"),ee=n("tf.keras.Model.fit"),pe=n(` method which currently requires having all the
tensors in the first argument of the model call function: `),D=a("code"),fe=n("model(inputs)"),le=n("."),G=c(),P=a("p"),te=n(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),X=c(),q=a("ul"),j=a("li"),ne=n("a single Tensor with "),U=a("code"),de=n("input_ids"),se=n(" only and nothing else: "),B=a("code"),ge=n("model(inputs_ids)"),ce=c(),C=a("li"),ue=n(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),Q=a("code"),ae=n("model([input_ids, attention_mask])"),K=n(" or "),H=a("code"),re=n("model([input_ids, attention_mask, token_type_ids])"),_e=c(),N=a("li"),ie=n(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),R=a("code"),we=n('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(w){l=r(w,"P",{});var F=i(l);k=s(F,"TF 2.0 models accepts two formats as inputs:"),F.forEach(t),h=m(w),p=r(w,"UL",{});var Y=i(p);b=r(Y,"LI",{});var Te=i(b);d=s(Te,"having all inputs as keyword arguments (like PyTorch models), or"),Te.forEach(t),u=m(Y),E=r(Y,"LI",{});var me=i(E);he=s(me,"having all inputs as a list, tuple or dict in the first positional arguments."),me.forEach(t),Y.forEach(t),J=m(w),z=r(w,"P",{});var A=i(z);Z=s(A,"This second option is useful when using "),S=r(A,"CODE",{});var be=i(S);ee=s(be,"tf.keras.Model.fit"),be.forEach(t),pe=s(A,` method which currently requires having all the
...
first positional argument :`),Fe.forEach(t),X=m(w),q=r(w,"UL",{});var O=i(q);j=r(O,"LI",{});var V=i(j);ne=s(V,"a single Tensor with "),U=r(V,"CODE",{});var Me=i(U);de=s(Me,"input_ids"),Me.forEach(t),se=s(V," only and nothing else: "),B=r(V,"CODE",{});var ye=i(B);ge=s(ye,"model(inputs_ids)"),ye.forEach(t),V.forEach(t),ce=m(O),C=r(O,"LI",{});var I=i(C);ue=s(I,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),Q=r(I,"CODE",{});var ke=i(Q);ae=s(ke,"model([input_ids, attention_mask])"),ke.forEach(t),K=s(I," or "),H=r(I,"CODE",{});var ve=i(H);re=s(ve,"model([input_ids, attention_mask, token_type_ids])"),ve.forEach(t),I.forEach(t),_e=m(O),N=r(O,"LI",{});var oe=i(N);ie=s(oe,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),R=r(oe,"CODE",{});var Ee=i(R);we=s(Ee,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),Ee.forEach(t),oe.forEach(t),O.forEach(t)},m(w,F){f(w,l,F),e(l,k),f(w,h,F),f(w,p,F),e(p,b),e(b,d),e(p,u),e(p,E),e(E,he),f(w,J,F),f(w,z,F),e(z,Z),e(z,S),e(S,ee),e(z,pe),e(z,D),e(D,fe),e(z,le),f(w,G,F),f(w,P,F),e(P,te),f(w,X,F),f(w,q,F),e(q,j),e(j,ne),e(j,U),e(U,de),e(j,se),e(j,B),e(B,ge),e(q,ce),e(q,C),e(C,ue),e(C,Q),e(Q,ae),e(C,K),e(C,H),e(H,re),e(q,_e),e(q,N),e(N,ie),e(N,R),e(R,we)},d(w){w&&t(l),w&&t(h),w&&t(p),w&&t(J),w&&t(z),w&&t(G),w&&t(P),w&&t(X),w&&t(q)}}}function QT(M){let l,k,h,p,b;return{c(){l=a("p"),k=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),h=a("code"),p=n("Module"),b=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(d){l=r(d,"P",{});var u=i(l);k=s(u,"Although the recipe for forward pass needs to be defined within this function, one should call the "),h=r(u,"CODE",{});var E=i(h);p=s(E,"Module"),E.forEach(t),b=s(u,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
`}}),mn=new Ae({props:{$$slots:{default:[qT]},$$scope:{ctx:M}}}),hn=new Ce({props:{anchor:"transformers.LongformerForTokenClassification.forward.example",$$slots:{default:[CT]},$$scope:{ctx:M}}}),pn=new Ce({props:{anchor:"transformers.LongformerForTokenClassification.forward.example-2",$$slots:{default:[jT]},$$scope:{ctx:M}}}),Zs=new Oe({}),ea=new W({props:{name:"class transformers.LongformerForQuestionAnswering",anchor:"transformers.LongformerForQuestionAnswering",parameters:[{name:"config",val:""}],parametersDescription:[{anchor:"transformers.LongformerForQuestionAnswering.config",description:`<strong>config</strong> (<a href="/docs/transformers/main/en/model_doc/longformer#transformers.LongformerConfig">LongformerConfig</a>) &#x2014; Model configuration class with all the parameters of the
model. Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/main/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/longformer/modeling_longformer.py#L1982"}}),sa=new W({props:{name:"forward",anchor:"transformers.LongformerForQuestionAnswering.forward",parameters:[{name:"input_ids",val:": typing.Optional[torch.Tensor] = None"},{name:"attention_mask",val:": typing.Optional[torch.Tensor] = None"},{name:"global_attention_mask",val:": typing.Optional[torch.Tensor] = None"},{name:"head_mask",val:": typing.Optional[torch.Tensor] = None"},{name:"token_type_ids",val:": typing.Optional[torch.Tensor] = None"},{name:"position_ids",val:": typing.Optional[torch.Tensor] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.Tensor] = None"},{name:"start_positions",val:": typing.Optional[torch.Tensor] = None"},{name:"end_positions",val:": typing.Optional[torch.Tensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.LongformerForQuestionAnswering.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/main/en/model_doc/longformer#transformers.LongformerTokenizer">LongformerTokenizer</a>. See <a href="/docs/transformers/main/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/main/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
`}}),Tn=new Ae({props:{$$slots:{default:[ST]},$$scope:{ctx:M}}}),yn=new Ce({props:{anchor:"transformers.TFLongformerForMaskedLM.call.example",$$slots:{default:[DT]},$$scope:{ctx:M}}}),$n=new Ce({props:{anchor:"transformers.TFLongformerForMaskedLM.call.example-2",$$slots:{default:[BT]},$$scope:{ctx:M}}}),ba=new Oe({}),va=new W({props:{name:"class transformers.TFLongformerForQuestionAnswering",anchor:"transformers.TFLongformerForQuestionAnswering",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.TFLongformerForQuestionAnswering.config",description:`<strong>config</strong> (<a href="/docs/transformers/main/en/model_doc/longformer#transformers.LongformerConfig">LongformerConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/main/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/longformer/modeling_tf_longformer.py#L2181"}}),xn=new Ae({props:{$$slots:{default:[WT]},$$scope:{ctx:M}}}),La=new W({props:{name:"call",anchor:"transformers.TFLongformerForQuestionAnswering.call",parameters:[{name:"input_ids",val:": typing.Union[typing.List[tensorflow.python.framework.ops.Tensor], typing.List[numpy.ndarray], typing.List[tensorflow.python.keras.engine.keras_tensor.KerasTensor], typing.Dict[str, tensorflow.python.framework.ops.Tensor], typing.Dict[str, numpy.ndarray], typing.Dict[str, tensorflow.python.keras.engine.keras_tensor.KerasTensor], tensorflow.python.framework.ops.Tensor, numpy.ndarray, tensorflow.python.keras.engine.keras_tensor.KerasTensor, NoneType] = None"},{name:"attention_mask",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"head_mask",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"global_attention_mask",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"token_type_ids",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"position_ids",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"inputs_embeds",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"start_positions",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"end_positions",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"training",val:": typing.Optional[bool] = False"}],parametersDescription:[{anchor:"transformers.TFLongformerForQuestionAnswering.call.input_ids",description:`<strong>input_ids</strong> (<code>np.ndarray</code> or <code>tf.Tensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/main/en/model_doc/longformer#transformers.LongformerTokenizer">LongformerTokenizer</a>. See <a href="/docs/transformers/main/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
<a href="/docs/transformers/main/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> for details.</p>
...
`}}),Cn=new Ae({props:{$$slots:{default:[VT]},$$scope:{ctx:M}}}),jn=new Ce({props:{anchor:"transformers.TFLongformerForSequenceClassification.call.example",$$slots:{default:[GT]},$$scope:{ctx:M}}}),On=new Ce({props:{anchor:"transformers.TFLongformerForSequenceClassification.call.example-2",$$slots:{default:[KT]},$$scope:{ctx:M}}}),Ca=new Oe({}),ja=new W({props:{name:"class transformers.TFLongformerForTokenClassification",anchor:"transformers.TFLongformerForTokenClassification",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.TFLongformerForTokenClassification.config",description:`<strong>config</strong> (<a href="/docs/transformers/main/en/model_doc/longformer#transformers.LongformerConfig">LongformerConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/main/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/longformer/modeling_tf_longformer.py#L2572"}}),Nn=new Ae({props:{$$slots:{default:[JT]},$$scope:{ctx:M}}}),Aa=new W({props:{name:"call",anchor:"transformers.TFLongformerForTokenClassification.call",parameters:[{name:"input_ids",val:": typing.Union[typing.List[tensorflow.python.framework.ops.Tensor], typing.List[numpy.ndarray], typing.List[tensorflow.python.keras.engine.keras_tensor.KerasTensor], typing.Dict[str, tensorflow.python.framework.ops.Tensor], typing.Dict[str, numpy.ndarray], typing.Dict[str, tensorflow.python.keras.engine.keras_tensor.KerasTensor], tensorflow.python.framework.ops.Tensor, numpy.ndarray, tensorflow.python.keras.engine.keras_tensor.KerasTensor, NoneType] = None"},{name:"attention_mask",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"head_mask",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"token_type_ids",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"position_ids",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"global_attention_mask",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"inputs_embeds",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"labels",val:": typing.Union[<built-in function array>, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"training",val:": typing.Optional[bool] = False"}],parametersDescription:[{anchor:"transformers.TFLongformerForTokenClassification.call.input_ids",description:`<strong>input_ids</strong> (<code>np.ndarray</code> or <code>tf.Tensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/main/en/model_doc/longformer#transformers.LongformerTokenizer">LongformerTokenizer</a>. See <a href="/docs/transformers/main/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
<a href="/docs/transformers/main/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> for details.</p>
...
trained and should be used as follows:`),Bd=c(),v(Jn.$$.fragment),Wd=c(),Pt=a("h2"),Do=a("a"),pi=a("span"),v(Xn.$$.fragment),Th=c(),fi=a("span"),yh=n("LongformerConfig"),Qd=c(),He=a("div"),v(Yn.$$.fragment),$h=c(),Nt=a("p"),Lh=n("This is the configuration class to store the configuration of a "),Ya=a("a"),xh=n("LongformerModel"),Fh=n(" or a "),Za=a("a"),Mh=n("TFLongformerModel"),Eh=n(`. It
...
length 4,096.`),Nh=c(),It=a("p"),Ah=n("The "),tr=a("a"),Ih=n("LongformerConfig"),Sh=n(" class directly inherits "),or=a("a"),Dh=n("RobertaConfig"),Bh=n(`. It reuses the same defaults. Please check the
parent class for more information.`),Wh=c(),v(Bo.$$.fragment),Ud=c(),St=a("h2"),Wo=a("a"),gi=a("span"),v(es.$$.fragment),Qh=c(),ui=a("span"),Uh=n("LongformerTokenizer"),Hd=c(),gt=a("div"),v(ts.$$.fragment),Hh=c(),_i=a("p"),Rh=n("Construct a Longformer tokenizer."),Vh=c(),Qo=a("p"),nr=a("a"),Gh=n("LongformerTokenizer"),Kh=n(" is identical to "),sr=a("a"),Jh=n("RobertaTokenizer"),Xh=n(`. Refer to the superclass for usage examples and
...
kernel to be memory and compute efficient.`),lf=c(),at=a("div"),v(Fs.$$.fragment),df=c(),so=a("p"),cf=n("The "),dr=a("a"),mf=n("LongformerModel"),hf=n(" forward method, overrides the "),Bi=a("code"),pf=n("__call__"),ff=n(" special method."),gf=c(),v(Go.$$.fragment),uf=c(),v(Ko.$$.fragment),mc=c(),ao=a("h2"),Jo=a("a"),Wi=a("span"),v(Ms.$$.fragment),_f=c(),Qi=a("span"),wf=n("LongformerForMaskedLM"),hc=c(),Re=a("div"),v(Es.$$.fragment),kf=c(),zs=a("p"),bf=n("Longformer Model with a "),Ui=a("code"),vf=n("language modeling"),Tf=n(" head on top."),yf=c(),qs=a("p"),$f=n("This model inherits from "),cr=a("a"),Lf=n("PreTrainedModel"),xf=n(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Ff=c(),Cs=a("p"),Mf=n("This model is also a PyTorch "),js=a("a"),Ef=n("torch.nn.Module"),zf=n(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),qf=c(),Qe=a("div"),v(Os.$$.fragment),Cf=c(),ro=a("p"),jf=n("The "),mr=a("a"),Of=n("LongformerForMaskedLM"),Pf=n(" forward method, overrides the "),Hi=a("code"),Nf=n("__call__"),Af=n(" special method."),If=c(),v(Xo.$$.fragment),Sf=c(),v(Yo.$$.fragment),Df=c(),Ri=a("p"),Bf=n("Let\u2019s try a very long input."),Wf=c(),v(Zo.$$.fragment),pc=c(),io=a("h2"),en=a("a"),Vi=a("span"),v(Ps.$$.fragment),Qf=c(),Gi=a("span"),Uf=n("LongformerForSequenceClassification"),fc=c(),Ve=a("div"),v(Ns.$$.fragment),Hf=c(),Ki=a("p"),Rf=n(`Longformer Model transformer with a sequence classification/regression head on top (a linear layer on top of the
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),tg=c(),Ne=a("div"),v(Ds.$$.fragment),og=c(),lo=a("p"),ng=n("The "),pr=a("a"),sg=n("LongformerForSequenceClassification"),ag=n(" forward method, overrides the "),Ji=a("code"),rg=n("__call__"),ig=n(" special method."),lg=c(),v(tn.$$.fragment),dg=c(),v(on.$$.fragment),cg=c(),v(nn.$$.fragment),mg=c(),v(sn.$$.fragment),hg=c(),v(an.$$.fragment),gc=c(),co=a("h2"),rn=a("a"),Xi=a("span"),v(Bs.$$.fragment),pg=c(),Yi=a("span"),fg=n("LongformerForMultipleChoice"),uc=c(),Ge=a("div"),v(Ws.$$.fragment),gg=c(),Zi=a("p"),ug=n(`Longformer Model with a multiple choice classification head on top (a linear layer on top of the pooled output and
...
for Named-Entity-Recognition (NER) tasks.`),Ig=c(),Ks=a("p"),Sg=n("This model inherits from "),ur=a("a"),Dg=n("PreTrainedModel"),Bg=n(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Wg=c(),Js=a("p"),Qg=n("This model is also a PyTorch "),Xs=a("a"),Ug=n("torch.nn.Module"),Hg=n(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
...
behavior.`),Su=c(),v(wn.$$.fragment),Du=c(),wo=a("p"),Bu=n("This class copies code from "),vr=a("a"),Wu=n("TFRobertaModel"),Qu=n(` and overwrites standard self-attention with longformer
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),B_=c(),ya=a("p"),W_=n("This model is also a "),$a=a("a"),Q_=n("tf.keras.Model"),U_=n(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Aw=c(),v(Nn.$$.fragment),Iw=c(),ot=a("div"),v(Aa.$$.fragment),Sw=c(),Mo=a("p"),Dw=n("The "),zr=a("a"),Bw=n("TFLongformerForTokenClassification"),Ww=n(" forward method, overrides the "),ql=a("code"),Qw=n("__call__"),Uw=n(" special method."),Hw=c(),v(An.$$.fragment),Rw=c(),v(In.$$.fragment),Vw=c(),v(Sn.$$.fragment),qc=c(),Eo=a("h2"),Dn=a("a"),Cl=a("span"),v(Ia.$$.fragment),Gw=c(),jl=a("span"),Kw=n("TFLongformerForMultipleChoice"),Cc=c(),We=a("div"),v(Sa.$$.fragment),Jw=c(),Ol=a("p"),Xw=n(`Longformer Model with a multiple choice classification head on top (a linear layer on top of the pooled output and
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),ok=c(),Ba=a("p"),nk=n("This model is also a "),Wa=a("a"),sk=n("tf.keras.Model"),ak=n(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),rk=c(),v(Bn.$$.fragment),ik=c(),lt=a("div"),v(Qa.$$.fragment),lk=c(),zo=a("p"),dk=n("The "),Cr=a("a"),ck=n("TFLongformerForMultipleChoice"),mk=n(" forward method, overrides the "),Pl=a("code"),hk=n("__call__"),pk=n(" special method."),fk=c(),v(Wn.$$.fragment),gk=c(),v(Qn.$$.fragment),this.h()},l(o){const g=uT('[data-svelte="svelte-1phssyn"]',document.head);l=r(g,"META",{name:!0,content:!0}),g.forEach(t),k=m(o),h=r(o,"H1",{class:!0});var Ua=i(h);p=r(Ua,"A",{id:!0,class:!0,href:!0});var Nl=i(p);b=r(Nl,"SPAN",{});var Al=i(b);T(d.$$.fragment,Al),Al.forEach(t),Nl.forEach(t),u=m(Ua),E=r(Ua,"SPAN",{});var Il=i(E);he=s(Il,"Longformer"),Il.forEach(t),Ua.forEach(t),J=m(o),z=r(o,"H2",{class:!0});var Ha=i(z);Z=r(Ha,"A",{id:!0,class:!0,href:!0});var Sl=i(Z);S=r(Sl,"SPAN",{});var Dl=i(S);T(ee.$$.fragment,Dl),Dl.forEach(t),Sl.forEach(t),pe=m(Ha),D=r(Ha,"SPAN",{});var Bl=i(D);fe=s(Bl,"Overview"),Bl.forEach(t),Ha.forEach(t),le=m(o),G=r(o,"P",{});var Ra=i(G);P=s(Ra,"The Longformer model was presented in "),te=r(Ra,"A",{href:!0,rel:!0});var Wl=i(te);X=s(Wl,"Longformer: The Long-Document Transformer"),Wl.forEach(t),q=s(Ra," by Iz Beltagy, Matthew E. Peters, Arman Cohan."),Ra.forEach(t),j=m(o),ne=r(o,"P",{});var Ql=i(ne);U=s(Ql,"The abstract from the paper is the following:"),Ql.forEach(t),de=m(o),se=r(o,"P",{});var Ul=i(se);B=r(Ul,"EM",{});var Hl=i(B);ge=s(Hl,`Transformer-based models are unable to process long sequences due to their self-attention operation, which scales
quadratically with the sequence length. To address this limitation, we introduce the Longformer with an attention
mechanism that scales linearly with sequence length, making it easy to process documents of thousands of tokens or
longer. Longformer\u2019s attention mechanism is a drop-in replacement for the standard self-attention and combines a local
windowed attention with a task motivated global attention. Following prior work on long-sequence transformers, we
...
attention are more relevant for autoregressive language modeling than finetuning on downstream tasks. Future
release will add support for autoregressive attention, but the support for dilated attention requires a custom CUDA
kernel to be memory and compute efficient.`),am.forEach(t),lf=m(nt),at=r(nt,"DIV",{class:!0});var Un=i(at);T(Fs.$$.fragment,Un),df=m(Un),so=r(Un,"P",{});var Sr=i(so);cf=s(Sr,"The "),dr=r(Sr,"A",{href:!0});var ub=i(dr);mf=s(ub,"LongformerModel"),ub.forEach(t),hf=s(Sr," forward method, overrides the "),Bi=r(Sr,"CODE",{});var _b=i(Bi);pf=s(_b,"__call__"),_b.forEach(t),ff=s(Sr," special method."),Sr.forEach(t),gf=m(Un),T(Go.$$.fragment,Un),uf=m(Un),T(Ko.$$.fragment,Un),Un.forEach(t),nt.forEach(t),mc=m(o),ao=r(o,"H2",{class:!0});var rm=i(ao);Jo=r(rm,"A",{id:!0,class:!0,href:!0});var wb=i(Jo);Wi=r(wb,"SPAN",{});var kb=i(Wi);T(Ms.$$.fragment,kb),kb.forEach(t),wb.forEach(t),_f=m(rm),Qi=r(rm,"SPAN",{});var bb=i(Qi);wf=s(bb,"LongformerForMaskedLM"),bb.forEach(t),rm.forEach(t),hc=m(o),Re=r(o,"DIV",{class:!0});var yt=i(Re);T(Es.$$.fragment,yt),kf=m(yt),zs=r(yt,"P",{});var im=i(zs);bf=s(im,"Longformer Model with a "),Ui=r(im,"CODE",{});var vb=i(Ui);vf=s(vb,"language modeling"),vb.forEach(t),Tf=s(im," head on top."),im.forEach(t),yf=m(yt),qs=r(yt,"P",{});var lm=i(qs);$f=s(lm,"This model inherits from "),cr=r(lm,"A",{href:!0});var Tb=i(cr);Lf=s(Tb,"PreTrainedModel"),Tb.forEach(t),xf=s(lm,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),dm.forEach(t),qf=m(yt),Qe=r(yt,"DIV",{class:!0});var dt=i(Qe);T(Os.$$.fragment,dt),Cf=m(dt),ro=r(dt,"P",{});var Dr=i(ro);jf=s(Dr,"The "),mr=r(Dr,"A",{href:!0});var $b=i(mr);Of=s($b,"LongformerForMaskedLM"),$b.forEach(t),Pf=s(Dr," forward method, overrides the "),Hi=r(Dr,"CODE",{});var Lb=i(Hi);Nf=s(Lb,"__call__"),Lb.forEach(t),Af=s(Dr," special method."),Dr.forEach(t),If=m(dt),T(Xo.$$.fragment,dt),Sf=m(dt),T(Yo.$$.fragment,dt),Df=m(dt),Ri=r(dt,"P",{});var xb=i(Ri);Bf=s(xb,"Let\u2019s try a very long input."),xb.forEach(t),Wf=m(dt),T(Zo.$$.fragment,dt),dt.forEach(t),yt.forEach(t),pc=m(o),io=r(o,"H2",{class:!0});var cm=i(io);en=r(cm,"A",{id:!0,class:!0,href:!0});var Fb=i(en);Vi=r(Fb,"SPAN",{});var Mb=i(Vi);T(Ps.$$.fragment,Mb),Mb.forEach(t),Fb.forEach(t),Qf=m(cm),Gi=r(cm,"SPAN",{});var Eb=i(Gi);Uf=s(Eb,"LongformerForSequenceClassification"),Eb.forEach(t),cm.forEach(t),fc=m(o),Ve=r(o,"DIV",{class:!0});var $t=i(Ve);T(Ns.$$.fragment,$t),Hf=m($t),Ki=r($t,"P",{});var zb=i(Ki);Rf=s(zb,`Longformer Model transformer with a sequence classification/regression head on top (a linear layer on top of the
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),hm.forEach(t),tg=m($t),Ne=r($t,"DIV",{class:!0});var st=i(Ne);T(Ds.$$.fragment,st),og=m(st),lo=r(st,"P",{});var Br=i(lo);ng=s(Br,"The "),pr=r(Br,"A",{href:!0});var jb=i(pr);sg=s(jb,"LongformerForSequenceClassification"),jb.forEach(t),ag=s(Br," forward method, overrides the "),Ji=r(Br,"CODE",{});var Ob=i(Ji);rg=s(Ob,"__call__"),Ob.forEach(t),ig=s(Br," special method."),Br.forEach(t),lg=m(st),T(tn.$$.fragment,st),dg=m(st),T(on.$$.fragment,st),cg=m(st),T(nn.$$.fragment,st),mg=m(st),T(sn.$$.fragment,st),hg=m(st),T(an.$$.fragment,st),st.forEach(t),$t.forEach(t),gc=m(o),co=r(o,"H2",{class:!0});var pm=i(co);rn=r(pm,"A",{id:!0,class:!0,href:!0});var Pb=i(rn);Xi=r(Pb,"SPAN",{});var Nb=i(Xi);T(Bs.$$.fragment,Nb),Nb.forEach(t),Pb.forEach(t),pg=m(pm),Yi=r(pm,"SPAN",{});var Ab=i(Yi);fg=s(Ab,"LongformerForMultipleChoice"),Ab.forEach(t),pm.forEach(t),uc=m(o),Ge=r(o,"DIV",{class:!0});var Lt=i(Ge);T(Ws.$$.fragment,Lt),gg=m(Lt),Zi=r(Lt,"P",{});var Ib=i(Zi);ug=s(Ib,`Longformer Model with a multiple choice classification head on top (a linear layer on top of the pooled output and
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),gm.forEach(t),Lg=m(Lt),rt=r(Lt,"DIV",{class:!0});var Hn=i(rt);T(Rs.$$.fragment,Hn),xg=m(Hn),mo=r(Hn,"P",{});var Wr=i(mo);Fg=s(Wr,"The "),gr=r(Wr,"A",{href:!0});var Bb=i(gr);Mg=s(Bb,"LongformerForMultipleChoice"),Bb.forEach(t),Eg=s(Wr," forward method, overrides the "),el=r(Wr,"CODE",{});var Wb=i(el);zg=s(Wb,"__call__"),Wb.forEach(t),qg=s(Wr," special method."),Wr.forEach(t),Cg=m(Hn),T(ln.$$.fragment,Hn),jg=m(Hn),T(dn.$$.fragment,Hn),Hn.forEach(t),Lt.forEach(t),_c=m(o),ho=r(o,"H2",{class:!0});var um=i(ho);cn=r(um,"A",{id:!0,class:!0,href:!0});var Qb=i(cn);tl=r(Qb,"SPAN",{});var Ub=i(tl);T(Vs.$$.fragment,Ub),Ub.forEach(t),Qb.forEach(t),Og=m(um),ol=r(um,"SPAN",{});var Hb=i(ol);Pg=s(Hb,"LongformerForTokenClassification"),Hb.forEach(t),um.forEach(t),wc=m(o),Ke=r(o,"DIV",{class:!0});var xt=i(Ke);T(Gs.$$.fragment,xt),Ng=m(xt),nl=r(xt,"P",{});var Rb=i(nl);Ag=s(Rb,`Longformer Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g.
for Named-Entity-Recognition (NER) tasks.`),Rb.forEach(t),Ig=m(xt),Ks=r(xt,"P",{});var _m=i(Ks);Sg=s(_m,"This model inherits from "),ur=r(_m,"A",{href:!0});var Vb=i(ur);Dg=s(Vb,"PreTrainedModel"),Vb.forEach(t),Bg=s(_m,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),_m.forEach(t),Wg=m(xt),Js=r(xt,"P",{});var wm=i(Js);Qg=s(wm,"This model is also a PyTorch "),Xs=r(wm,"A",{href:!0,rel:!0});var Gb=i(Xs);Ug=s(Gb,"torch.nn.Module"),Gb.forEach(t),Hg=s(wm,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),$m.forEach(t),Su=m(Ue),T(wn.$$.fragment,Ue),Du=m(Ue),wo=r(Ue,"P",{});var Rr=i(wo);Bu=s(Rr,"This class copies code from "),vr=r(Rr,"A",{href:!0});var hv=i(vr);Wu=s(hv,"TFRobertaModel"),hv.forEach(t),Qu=s(Rr,` and overwrites standard self-attention with longformer
self-attention to provide the ability to process long sequences following the self-attention approach described in
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),qm.forEach(t),B_=m(mt),ya=r(mt,"P",{});var Cm=i(ya);W_=s(Cm,"This model is also a "),$a=r(Cm,"A",{href:!0,rel:!0});var qv=i($a);Q_=s(qv,"tf.keras.Model"),qv.forEach(t),U_=s(Cm,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Pm.forEach(t),fw=m(ht),T(qn.$$.fragment,ht),gw=m(ht),tt=r(ht,"DIV",{class:!0});var qt=i(tt);T(qa.$$.fragment,qt),uw=m(qt),xo=r(qt,"P",{});var Yr=i(xo);_w=s(Yr,"The "),Mr=r(Yr,"A",{href:!0});var Dv=i(Mr);ww=s(Dv,"TFLongformerForSequenceClassification"),Dv.forEach(t),kw=s(Yr," forward method, overrides the "),Fl=r(Yr,"CODE",{});var Bv=i(Fl);bw=s(Bv,"__call__"),Bv.forEach(t),vw=s(Yr," special method."),Yr.forEach(t),Tw=m(qt),T(Cn.$$.fragment,qt),yw=m(qt),T(jn.$$.fragment,qt),$w=m(qt),T(On.$$.fragment,qt),qt.forEach(t),ht.forEach(t),Ec=m(o),Fo=r(o,"H2",{class:!0});var Nm=i(Fo);Pn=r(Nm,"A",{id:!0,class:!0,href:!0});var Wv=i(Pn);Ml=r(Wv,"SPAN",{});var Qv=i(Ml);T(Ca.$$.fragment,Qv),Qv.forEach(t),Wv.forEach(t),Lw=m(Nm),El=r(Nm,"SPAN",{});var Uv=i(El);xw=s(Uv,"TFLongformerForTokenClassification"),Uv.forEach(t),Nm.forEach(t),zc=m(o),Be=r(o,"DIV",{class:!0});var pt=i(Be);T(ja.$$.fragment,pt),Fw=m(pt),zl=r(pt,"P",{});var Hv=i(zl);Mw=s(Hv,`Longformer Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g.
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Im.forEach(t),Aw=m(pt),T(Nn.$$.fragment,pt),Iw=m(pt),ot=r(pt,"DIV",{class:!0});var Ct=i(ot);T(Aa.$$.fragment,Ct),Sw=m(Ct),Mo=r(Ct,"P",{});var Zr=i(Mo);Dw=s(Zr,"The "),zr=r(Zr,"A",{href:!0});var Gv=i(zr);Bw=s(Gv,"TFLongformerForTokenClassification"),Gv.forEach(t),Ww=s(Zr," forward method, overrides the "),ql=r(Zr,"CODE",{});var Kv=i(ql);Qw=s(Kv,"__call__"),Kv.forEach(t),Uw=s(Zr," special method."),Zr.forEach(t),Hw=m(Ct),T(An.$$.fragment,Ct),Rw=m(Ct),T(In.$$.fragment,Ct),Vw=m(Ct),T(Sn.$$.fragment,Ct),Ct.forEach(t),pt.forEach(t),qc=m(o),Eo=r(o,"H2",{class:!0});var Sm=i(Eo);Dn=r(Sm,"A",{id:!0,class:!0,href:!0});var Jv=i(Dn);Cl=r(Jv,"SPAN",{});var Xv=i(Cl);T(Ia.$$.fragment,Xv),Xv.forEach(t),Jv.forEach(t),Gw=m(Sm),jl=r(Sm,"SPAN",{});var Yv=i(jl);Kw=s(Yv,"TFLongformerForMultipleChoice"),Yv.forEach(t),Sm.forEach(t),Cc=m(o),We=r(o,"DIV",{class:!0});var ft=i(We);T(Sa.$$.fragment,ft),Jw=m(ft),Ol=r(ft,"P",{});var Zv=i(Ol);Xw=s(Zv,`Longformer Model with a multiple choice classification head on top (a linear layer on top of the pooled output and
