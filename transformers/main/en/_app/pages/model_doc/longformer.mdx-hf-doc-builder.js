...
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),p.forEach(t)},m(d,p){f(d,l,p),e(l,k),e(l,h),e(h,_),e(l,b)},d(d){d&&t(l)}}}function by(z){let l,k,h,_,b;return _=new Be({props:{code:`import torch
...
the latter silently ignores them.`)},l(d){l=r(d,"P",{});var p=i(l);k=s(p,"Although the recipe for forward pass needs to be defined within this function, one should call the "),h=r(p,"CODE",{});var q=i(h);_=s(q,"Module"),q.forEach(t),b=s(p,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),p.forEach(t)},m(d,p){f(d,l,p),e(l,k),e(l,h),e(h,_),e(l,b)},d(d){d&&t(l)}}}function yy(z){let l,k,h,_,b;return _=new Be({props:{code:`from transformers import LongformerTokenizer, LongformerForMaskedLM
...
the latter silently ignores them.`)},l(d){l=r(d,"P",{});var p=i(l);k=s(p,"Although the recipe for forward pass needs to be defined within this function, one should call the "),h=r(p,"CODE",{});var q=i(h);_=s(q,"Module"),q.forEach(t),b=s(p,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),p.forEach(t)},m(d,p){f(d,l,p),e(l,k),e(l,h),e(h,_),e(l,b)},d(d){d&&t(l)}}}function Ly(z){let l,k,h,_,b;return _=new Be({props:{code:`import torch
...
<span class="hljs-number">5.44</span>`}}),{c(){v(l.$$.fragment)},l(h){y(l.$$.fragment,h)},m(h,_){T(l,h,_),k=!0},p:Je,i(h){k||($(l.$$.fragment,h),k=!0)},o(h){L(l.$$.fragment,h),k=!1},d(h){x(l,h)}}}function Fy(z){let l,k,h,_,b;return _=new Be({props:{code:`import torch
from transformers import LongformerTokenizer, LongformerForSequenceClassification
...
the latter silently ignores them.`)},l(d){l=r(d,"P",{});var p=i(l);k=s(p,"Although the recipe for forward pass needs to be defined within this function, one should call the "),h=r(p,"CODE",{});var q=i(h);_=s(q,"Module"),q.forEach(t),b=s(p,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),p.forEach(t)},m(d,p){f(d,l,p),e(l,k),e(l,h),e(h,_),e(l,b)},d(d){d&&t(l)}}}function zy(z){let l,k,h,_,b;return _=new Be({props:{code:`from transformers import LongformerTokenizer, LongformerForMultipleChoice
import torch
...
the latter silently ignores them.`)},l(d){l=r(d,"P",{});var p=i(l);k=s(p,"Although the recipe for forward pass needs to be defined within this function, one should call the "),h=r(p,"CODE",{});var q=i(h);_=s(q,"Module"),q.forEach(t),b=s(p,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),p.forEach(t)},m(d,p){f(d,l,p),e(l,k),e(l,h),e(h,_),e(l,b)},d(d){d&&t(l)}}}function jy(z){let l,k,h,_,b;return _=new Be({props:{code:`from transformers import LongformerTokenizer, LongformerForTokenClassification
import torch
...
the latter silently ignores them.`)},l(d){l=r(d,"P",{});var p=i(l);k=s(p,"Although the recipe for forward pass needs to be defined within this function, one should call the "),h=r(p,"CODE",{});var q=i(h);_=s(q,"Module"),q.forEach(t),b=s(p,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),p.forEach(t)},m(d,p){f(d,l,p),e(l,k),e(l,h),e(h,_),e(l,b)},d(d){d&&t(l)}}}function Py(z){let l,k,h,_,b;return _=new Be({props:{code:`from transformers import LongformerTokenizer, LongformerForQuestionAnswering
import torch
...
format outside of Keras methods like `),G=a("code"),Te=n("fit()"),ge=n(" and "),B=a("code"),$e=n("predict()"),ue=n(`, such as when creating your own layers or models with
the Keras `),W=a("code"),me=n("Functional"),Le=n(` API, there are three possibilities you can use to gather all the input Tensors in the first
positional argument:`),ne=c(),j=a("ul"),O=a("li"),_e=n("a single Tensor with "),Q=a("code"),te=n("input_ids"),xe=n(" only and nothing else: "),H=a("code"),Fe=n("model(input_ids)"),Me=c(),C=a("li"),Ee=n(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
...
format outside of Keras methods like `),G=r(M,"CODE",{});var Ye=i(G);Te=s(Ye,"fit()"),Ye.forEach(t),ge=s(M," and "),B=r(M,"CODE",{});var Ie=i(B);$e=s(Ie,"predict()"),Ie.forEach(t),ue=s(M,`, such as when creating your own layers or models with
the Keras `),W=r(M,"CODE",{});var De=i(W);me=s(De,"Functional"),De.forEach(t),Le=s(M,` API, there are three possibilities you can use to gather all the input Tensors in the first
positional argument:`),M.forEach(t),ne=m(w),j=r(w,"UL",{});var S=i(j);O=r(S,"LI",{});var K=i(O);_e=s(K,"a single Tensor with "),Q=r(K,"CODE",{});var Se=i(Q);te=s(Se,"input_ids"),Se.forEach(t),xe=s(K," only and nothing else: "),H=r(K,"CODE",{});var Ze=i(H);Fe=s(Ze,"model(input_ids)"),Ze.forEach(t),K.forEach(t),Me=m(S),C=r(S,"LI",{});var V=i(C);Ee=s(V,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),J=r(V,"CODE",{});var Oe=i(J);he=s(Oe,"model([input_ids, attention_mask])"),Oe.forEach(t),ze=s(V," or "),X=r(V,"CODE",{});var He=i(X);we=s(He,"model([input_ids, attention_mask, token_type_ids])"),He.forEach(t),V.forEach(t),se=m(S),I=r(S,"LI",{});var Ce=i(I);ce=s(Ce,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),Y=r(Ce,"CODE",{});var Pe=i(Y);qe=s(Pe,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),Pe.forEach(t),Ce.forEach(t),S.forEach(t),Z=m(w),P=r(w,"P",{});var re=i(P);je=s(re,`Note that when creating models and layers with
`),N=r(re,"A",{href:!0,rel:!0});var Re=i(N);ae=s(Re,"subclassing"),Re.forEach(t),le=s(re,` then you don\u2019t need to worry
about any of this, as you can just pass inputs like you would to any other Python function!`),re.forEach(t),this.h()},h(){g(N,"href","https://keras.io/guides/making_new_layers_and_models_via_subclassing/"),g(N,"rel","nofollow")},m(w,E){f(w,l,E),e(l,k),e(l,h),e(h,_),e(l,b),f(w,d,E),f(w,p,E),e(p,q),e(q,ke),e(p,pe),e(p,A),e(A,ie),f(w,ee,E),f(w,F,E),e(F,be),e(F,U),e(U,ve),e(F,fe),e(F,D),e(D,ye),e(F,de),e(F,G),e(G,Te),e(F,ge),e(F,B),e(B,$e),e(F,ue),e(F,W),e(W,me),e(F,Le),f(w,ne,E),f(w,j,E),e(j,O),e(O,_e),e(O,Q),e(Q,te),e(O,xe),e(O,H),e(H,Fe),e(j,Me),e(j,C),e(C,Ee),e(C,J),e(J,he),e(C,ze),e(C,X),e(X,we),e(j,se),e(j,I),e(I,ce),e(I,Y),e(Y,qe),f(w,Z,E),f(w,P,E),e(P,je),e(P,N),e(N,ae),e(P,le)},d(w){w&&t(l),w&&t(d),w&&t(p),w&&t(ee),w&&t(F),w&&t(ne),w&&t(j),w&&t(Z),w&&t(P)}}}function Ay(z){let l,k,h,_,b;return{c(){l=a("p"),k=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),h=a("code"),_=n("Module"),b=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(d){l=r(d,"P",{});var p=i(l);k=s(p,"Although the recipe for forward pass needs to be defined within this function, one should call the "),h=r(p,"CODE",{});var q=i(h);_=s(q,"Module"),q.forEach(t),b=s(p,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
`),Y=r(Ce,"CODE",{});var Pe=i(Y);qe=s(Pe,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),Pe.forEach(t),Ce.forEach(t),S.forEach(t),Z=m(w),P=r(w,"P",{});var re=i(P);je=s(re,`Note that when creating models and layers with
`),N=r(re,"A",{href:!0,rel:!0});var Re=i(N);ae=s(Re,"subclassing"),Re.forEach(t),le=s(re,` then you don\u2019t need to worry
about any of this, as you can just pass inputs like you would to any other Python function!`),re.forEach(t),this.h()},h(){g(N,"href","https://keras.io/guides/making_new_layers_and_models_via_subclassing/"),g(N,"rel","nofollow")},m(w,E){f(w,l,E),e(l,k),e(l,h),e(h,_),e(l,b),f(w,d,E),f(w,p,E),e(p,q),e(q,ke),e(p,pe),e(p,A),e(A,ie),f(w,ee,E),f(w,F,E),e(F,be),e(F,U),e(U,ve),e(F,fe),e(F,D),e(D,ye),e(F,de),e(F,G),e(G,Te),e(F,ge),e(F,B),e(B,$e),e(F,ue),e(F,W),e(W,me),e(F,Le),f(w,ne,E),f(w,j,E),e(j,O),e(O,_e),e(O,Q),e(Q,te),e(O,xe),e(O,H),e(H,Fe),e(j,Me),e(j,C),e(C,Ee),e(C,J),e(J,he),e(C,ze),e(C,X),e(X,we),e(j,se),e(j,I),e(I,ce),e(I,Y),e(Y,qe),f(w,Z,E),f(w,P,E),e(P,je),e(P,N),e(N,ae),e(P,le)},d(w){w&&t(l),w&&t(d),w&&t(p),w&&t(ee),w&&t(F),w&&t(ne),w&&t(j),w&&t(Z),w&&t(P)}}}function Dy(z){let l,k,h,_,b;return{c(){l=a("p"),k=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),h=a("code"),_=n("Module"),b=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(d){l=r(d,"P",{});var p=i(l);k=s(p,"Although the recipe for forward pass needs to be defined within this function, one should call the "),h=r(p,"CODE",{});var q=i(h);_=s(q,"Module"),q.forEach(t),b=s(p,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),p.forEach(t)},m(d,p){f(d,l,p),e(l,k),e(l,h),e(h,_),e(l,b)},d(d){d&&t(l)}}}function Sy(z){let l,k,h,_,b;return _=new Be({props:{code:`from transformers import LongformerTokenizer, TFLongformerForMaskedLM
...
<span class="hljs-number">0.44</span>`}}),{c(){v(l.$$.fragment)},l(h){y(l.$$.fragment,h)},m(h,_){T(l,h,_),k=!0},p:Je,i(h){k||($(l.$$.fragment,h),k=!0)},o(h){L(l.$$.fragment,h),k=!1},d(h){x(l,h)}}}function Wy(z){let l,k,h,_,b,d,p,q,ke,pe,A,ie,ee,F,be,U,ve,fe,D,ye,de,G,Te,ge,B,$e,ue,W,me,Le,ne,j,O,_e,Q,te,xe,H,Fe,Me,C,Ee,J,he,ze,X,we,se,I,ce,Y,qe,Z,P,je,N,ae,le;return{c(){l=a("p"),k=n("TensorFlow models and layers in "),h=a("code"),_=n("transformers"),b=n(" accept two formats as input:"),d=c(),p=a("ul"),q=a("li"),ke=n("having all inputs as keyword arguments (like PyTorch models), or"),pe=c(),A=a("li"),ie=n("having all inputs as a list, tuple or dict in the first positional argument."),ee=c(),F=a("p"),be=n(`The reason the second format is supported is that Keras methods prefer this format when passing inputs to models
and layers. Because of this support, when using methods like `),U=a("code"),ve=n("model.fit()"),fe=n(` things should \u201Cjust work\u201D for you - just
pass your inputs and labels in any format that `),D=a("code"),ye=n("model.fit()"),de=n(` supports! If, however, you want to use the second
format outside of Keras methods like `),G=a("code"),Te=n("fit()"),ge=n(" and "),B=a("code"),$e=n("predict()"),ue=n(`, such as when creating your own layers or models with
the Keras `),W=a("code"),me=n("Functional"),Le=n(` API, there are three possibilities you can use to gather all the input Tensors in the first
...
`),Y=r(Ce,"CODE",{});var Pe=i(Y);qe=s(Pe,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),Pe.forEach(t),Ce.forEach(t),S.forEach(t),Z=m(w),P=r(w,"P",{});var re=i(P);je=s(re,`Note that when creating models and layers with
`),N=r(re,"A",{href:!0,rel:!0});var Re=i(N);ae=s(Re,"subclassing"),Re.forEach(t),le=s(re,` then you don\u2019t need to worry
about any of this, as you can just pass inputs like you would to any other Python function!`),re.forEach(t),this.h()},h(){g(N,"href","https://keras.io/guides/making_new_layers_and_models_via_subclassing/"),g(N,"rel","nofollow")},m(w,E){f(w,l,E),e(l,k),e(l,h),e(h,_),e(l,b),f(w,d,E),f(w,p,E),e(p,q),e(q,ke),e(p,pe),e(p,A),e(A,ie),f(w,ee,E),f(w,F,E),e(F,be),e(F,U),e(U,ve),e(F,fe),e(F,D),e(D,ye),e(F,de),e(F,G),e(G,Te),e(F,ge),e(F,B),e(B,$e),e(F,ue),e(F,W),e(W,me),e(F,Le),f(w,ne,E),f(w,j,E),e(j,O),e(O,_e),e(O,Q),e(Q,te),e(O,xe),e(O,H),e(H,Fe),e(j,Me),e(j,C),e(C,Ee),e(C,J),e(J,he),e(C,ze),e(C,X),e(X,we),e(j,se),e(j,I),e(I,ce),e(I,Y),e(Y,qe),f(w,Z,E),f(w,P,E),e(P,je),e(P,N),e(N,ae),e(P,le)},d(w){w&&t(l),w&&t(d),w&&t(p),w&&t(ee),w&&t(F),w&&t(ne),w&&t(j),w&&t(Z),w&&t(P)}}}function Qy(z){let l,k,h,_,b;return{c(){l=a("p"),k=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),h=a("code"),_=n("Module"),b=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(d){l=r(d,"P",{});var p=i(l);k=s(p,"Although the recipe for forward pass needs to be defined within this function, one should call the "),h=r(p,"CODE",{});var q=i(h);_=s(q,"Module"),q.forEach(t),b=s(p,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),p.forEach(t)},m(d,p){f(d,l,p),e(l,k),e(l,h),e(h,_),e(l,b)},d(d){d&&t(l)}}}function Uy(z){let l,k,h,_,b;return _=new Be({props:{code:`from transformers import LongformerTokenizer, TFLongformerForQuestionAnswering
import tensorflow as tf
...
`),Y=r(Ce,"CODE",{});var Pe=i(Y);qe=s(Pe,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),Pe.forEach(t),Ce.forEach(t),S.forEach(t),Z=m(w),P=r(w,"P",{});var re=i(P);je=s(re,`Note that when creating models and layers with
`),N=r(re,"A",{href:!0,rel:!0});var Re=i(N);ae=s(Re,"subclassing"),Re.forEach(t),le=s(re,` then you don\u2019t need to worry
about any of this, as you can just pass inputs like you would to any other Python function!`),re.forEach(t),this.h()},h(){g(N,"href","https://keras.io/guides/making_new_layers_and_models_via_subclassing/"),g(N,"rel","nofollow")},m(w,E){f(w,l,E),e(l,k),e(l,h),e(h,_),e(l,b),f(w,d,E),f(w,p,E),e(p,q),e(q,ke),e(p,pe),e(p,A),e(A,ie),f(w,ee,E),f(w,F,E),e(F,be),e(F,U),e(U,ve),e(F,fe),e(F,D),e(D,ye),e(F,de),e(F,G),e(G,Te),e(F,ge),e(F,B),e(B,$e),e(F,ue),e(F,W),e(W,me),e(F,Le),f(w,ne,E),f(w,j,E),e(j,O),e(O,_e),e(O,Q),e(Q,te),e(O,xe),e(O,H),e(H,Fe),e(j,Me),e(j,C),e(C,Ee),e(C,J),e(J,he),e(C,ze),e(C,X),e(X,we),e(j,se),e(j,I),e(I,ce),e(I,Y),e(Y,qe),f(w,Z,E),f(w,P,E),e(P,je),e(P,N),e(N,ae),e(P,le)},d(w){w&&t(l),w&&t(d),w&&t(p),w&&t(ee),w&&t(F),w&&t(ne),w&&t(j),w&&t(Z),w&&t(P)}}}function Ky(z){let l,k,h,_,b;return{c(){l=a("p"),k=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),h=a("code"),_=n("Module"),b=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(d){l=r(d,"P",{});var p=i(l);k=s(p,"Although the recipe for forward pass needs to be defined within this function, one should call the "),h=r(p,"CODE",{});var q=i(h);_=s(q,"Module"),q.forEach(t),b=s(p,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),p.forEach(t)},m(d,p){f(d,l,p),e(l,k),e(l,h),e(h,_),e(l,b)},d(d){d&&t(l)}}}function Vy(z){let l,k,h,_,b;return _=new Be({props:{code:`from transformers import LongformerTokenizer, TFLongformerForSequenceClassification
import tensorflow as tf
...
`),Y=r(Ce,"CODE",{});var Pe=i(Y);qe=s(Pe,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),Pe.forEach(t),Ce.forEach(t),S.forEach(t),Z=m(w),P=r(w,"P",{});var re=i(P);je=s(re,`Note that when creating models and layers with
`),N=r(re,"A",{href:!0,rel:!0});var Re=i(N);ae=s(Re,"subclassing"),Re.forEach(t),le=s(re,` then you don\u2019t need to worry
about any of this, as you can just pass inputs like you would to any other Python function!`),re.forEach(t),this.h()},h(){g(N,"href","https://keras.io/guides/making_new_layers_and_models_via_subclassing/"),g(N,"rel","nofollow")},m(w,E){f(w,l,E),e(l,k),e(l,h),e(h,_),e(l,b),f(w,d,E),f(w,p,E),e(p,q),e(q,ke),e(p,pe),e(p,A),e(A,ie),f(w,ee,E),f(w,F,E),e(F,be),e(F,U),e(U,ve),e(F,fe),e(F,D),e(D,ye),e(F,de),e(F,G),e(G,Te),e(F,ge),e(F,B),e(B,$e),e(F,ue),e(F,W),e(W,me),e(F,Le),f(w,ne,E),f(w,j,E),e(j,O),e(O,_e),e(O,Q),e(Q,te),e(O,xe),e(O,H),e(H,Fe),e(j,Me),e(j,C),e(C,Ee),e(C,J),e(J,he),e(C,ze),e(C,X),e(X,we),e(j,se),e(j,I),e(I,ce),e(I,Y),e(Y,qe),f(w,Z,E),f(w,P,E),e(P,je),e(P,N),e(N,ae),e(P,le)},d(w){w&&t(l),w&&t(d),w&&t(p),w&&t(ee),w&&t(F),w&&t(ne),w&&t(j),w&&t(Z),w&&t(P)}}}function Xy(z){let l,k,h,_,b;return{c(){l=a("p"),k=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),h=a("code"),_=n("Module"),b=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(d){l=r(d,"P",{});var p=i(l);k=s(p,"Although the recipe for forward pass needs to be defined within this function, one should call the "),h=r(p,"CODE",{});var q=i(h);_=s(q,"Module"),q.forEach(t),b=s(p,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),p.forEach(t)},m(d,p){f(d,l,p),e(l,k),e(l,h),e(h,_),e(l,b)},d(d){d&&t(l)}}}function Yy(z){let l,k,h,_,b;return _=new Be({props:{code:`from transformers import LongformerTokenizer, TFLongformerForTokenClassification
import tensorflow as tf
...
`),Y=r(Ce,"CODE",{});var Pe=i(Y);qe=s(Pe,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),Pe.forEach(t),Ce.forEach(t),S.forEach(t),Z=m(w),P=r(w,"P",{});var re=i(P);je=s(re,`Note that when creating models and layers with
`),N=r(re,"A",{href:!0,rel:!0});var Re=i(N);ae=s(Re,"subclassing"),Re.forEach(t),le=s(re,` then you don\u2019t need to worry
about any of this, as you can just pass inputs like you would to any other Python function!`),re.forEach(t),this.h()},h(){g(N,"href","https://keras.io/guides/making_new_layers_and_models_via_subclassing/"),g(N,"rel","nofollow")},m(w,E){f(w,l,E),e(l,k),e(l,h),e(h,_),e(l,b),f(w,d,E),f(w,p,E),e(p,q),e(q,ke),e(p,pe),e(p,A),e(A,ie),f(w,ee,E),f(w,F,E),e(F,be),e(F,U),e(U,ve),e(F,fe),e(F,D),e(D,ye),e(F,de),e(F,G),e(G,Te),e(F,ge),e(F,B),e(B,$e),e(F,ue),e(F,W),e(W,me),e(F,Le),f(w,ne,E),f(w,j,E),e(j,O),e(O,_e),e(O,Q),e(Q,te),e(O,xe),e(O,H),e(H,Fe),e(j,Me),e(j,C),e(C,Ee),e(C,J),e(J,he),e(C,ze),e(C,X),e(X,we),e(j,se),e(j,I),e(I,ce),e(I,Y),e(Y,qe),f(w,Z,E),f(w,P,E),e(P,je),e(P,N),e(N,ae),e(P,le)},d(w){w&&t(l),w&&t(d),w&&t(p),w&&t(ee),w&&t(F),w&&t(ne),w&&t(j),w&&t(Z),w&&t(P)}}}function tT(z){let l,k,h,_,b;return{c(){l=a("p"),k=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),h=a("code"),_=n("Module"),b=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(d){l=r(d,"P",{});var p=i(l);k=s(p,"Although the recipe for forward pass needs to be defined within this function, one should call the "),h=r(p,"CODE",{});var q=i(h);_=s(q,"Module"),q.forEach(t),b=s(p,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),p.forEach(t)},m(d,p){f(d,l,p),e(l,k),e(l,h),e(h,_),e(l,b)},d(d){d&&t(l)}}}function oT(z){let l,k,h,_,b;return _=new Be({props:{code:`from transformers import LongformerTokenizer, TFLongformerForMultipleChoice
import tensorflow as tf
...
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-comment"># the linear classifier still needs to be trained</span>
<span class="hljs-meta">&gt;&gt;&gt; </span>logits = outputs.logits`}}),{c(){l=a("p"),k=n("Example:"),h=c(),v(_.$$.fragment)},l(d){l=r(d,"P",{});var p=i(l);k=s(p,"Example:"),p.forEach(t),h=m(d),y(_.$$.fragment,d)},m(d,p){f(d,l,p),e(l,k),f(d,h,p),T(_,d,p),b=!0},p:Je,i(d){b||($(_.$$.fragment,d),b=!0)},o(d){L(_.$$.fragment,d),b=!1},d(d){d&&t(l),d&&t(h),x(_,d)}}}function nT(z){let l,k,h,_,b,d,p,q,ke,pe,A,ie,ee,F,be,U,ve,fe,D,ye,de,G,Te,ge,B,$e,ue,W,me,Le,ne,j,O,_e,Q,te,xe,H,Fe,Me,C,Ee,J,he,ze,X,we,se,I,ce,Y,qe,Z,P,je,N,ae,le,w,E,We,oe,Qe,Ne,M,Ue,Ae,Ye='<span class="katex"><span class="katex-mathml"><math xmlns="http://www.w3.org/1998/Math/MathML"><semantics><mrow><mfrac><mn>1</mn><mn>2</mn></mfrac><mi>w</mi></mrow><annotation encoding="application/x-tex">\\frac{1}{2} w</annotation></semantics></math></span><span class="katex-html" aria-hidden="true"><span class="base"><span class="strut" style="height:1.1901em;vertical-align:-0.345em;"></span><span class="mord"><span class="mopen nulldelimiter"></span><span class="mfrac"><span class="vlist-t vlist-t2"><span class="vlist-r"><span class="vlist" style="height:0.8451em;"><span style="top:-2.655em;"><span class="pstrut" style="height:3em;"></span><span class="sizing reset-size6 size3 mtight"><span class="mord mtight"><span class="mord mtight">2</span></span></span></span><span style="top:-3.23em;"><span class="pstrut" style="height:3em;"></span><span class="frac-line" style="border-bottom-width:0.04em;"></span></span><span style="top:-3.394em;"><span class="pstrut" style="height:3em;"></span><span class="sizing reset-size6 size3 mtight"><span class="mord mtight"><span class="mord mtight">1</span></span></span></span></span><span class="vlist-s">\u200B</span></span><span class="vlist-r"><span class="vlist" style="height:0.345em;"><span></span></span></span></span></span><span class="mclose nulldelimiter"></span></span><span class="mord mathnormal" style="margin-right:0.02691em;">w</span></span></span></span>',Ie,De,S='<span class="katex"><span class="katex-mathml"><math xmlns="http://www.w3.org/1998/Math/MathML"><semantics><mrow><mfrac><mn>1</mn><mn>2</mn></mfrac><mi>w</mi></mrow><annotation encoding="application/x-tex">\\frac{1}{2} w</annotation></semantics></math></span><span class="katex-html" aria-hidden="true"><span class="base"><span class="strut" style="height:1.1901em;vertical-align:-0.345em;"></span><span class="mord"><span class="mopen nulldelimiter"></span><span class="mfrac"><span class="vlist-t vlist-t2"><span class="vlist-r"><span class="vlist" style="height:0.8451em;"><span style="top:-2.655em;"><span class="pstrut" style="height:3em;"></span><span class="sizing reset-size6 size3 mtight"><span class="mord mtight"><span class="mord mtight">2</span></span></span></span><span style="top:-3.23em;"><span class="pstrut" style="height:3em;"></span><span class="frac-line" style="border-bottom-width:0.04em;"></span></span><span style="top:-3.394em;"><span class="pstrut" style="height:3em;"></span><span class="sizing reset-size6 size3 mtight"><span class="mord mtight"><span class="mord mtight">1</span></span></span></span></span><span class="vlist-s">\u200B</span></span><span class="vlist-r"><span class="vlist" style="height:0.345em;"><span></span></span></span></span></span><span class="mclose nulldelimiter"></span></span><span class="mord mathnormal" style="margin-right:0.02691em;">w</span></span></span></span>',K,Se,Ze='<span class="katex"><span class="katex-mathml"><math xmlns="http://www.w3.org/1998/Math/MathML"><semantics><mrow><mi>w</mi></mrow><annotation encoding="application/x-tex">w</annotation></semantics></math></span><span class="katex-html" aria-hidden="true"><span class="base"><span class="strut" style="height:0.4306em;"></span><span class="mord mathnormal" style="margin-right:0.02691em;">w</span></span></span></span>',V,Oe,He,Ce,Pe,re,Re,bi,Xm,Ym,zd,iy='<span class="katex"><span class="katex-mathml"><math xmlns="http://www.w3.org/1998/Math/MathML"><semantics><mrow><mi>w</mi></mrow><annotation encoding="application/x-tex">w</annotation></semantics></math></span><span class="katex-html" aria-hidden="true"><span class="base"><span class="strut" style="height:0.4306em;"></span><span class="mord mathnormal" style="margin-right:0.02691em;">w</span></span></span></span>',qd,vi,Zm,eh,jd,At,th,Cd,ly='<span class="katex"><span class="katex-mathml"><math xmlns="http://www.w3.org/1998/Math/MathML"><semantics><mrow><mi>w</mi></mrow><annotation encoding="application/x-tex">w</annotation></semantics></math></span><span class="katex-html" aria-hidden="true"><span class="base"><span class="strut" style="height:0.4306em;"></span><span class="mord mathnormal" style="margin-right:0.02691em;">w</span></span></span></span>',Od,yi,oh,nh,Pd,It,sh,Ti,ah,rh,$i,ih,lh,Nd,tn,Li,dh,ch,xi,mh,Ad,on,hh,fr,ph,fh,Id,ut,gh,Dd,dy='<span class="katex"><span class="katex-mathml"><math xmlns="http://www.w3.org/1998/Math/MathML"><semantics><mrow><mi mathvariant="script">O</mi><mo stretchy="false">(</mo><msub><mi>n</mi><mi>s</mi></msub><mo>\xD7</mo><msub><mi>n</mi><mi>s</mi></msub><mo stretchy="false">)</mo></mrow><annotation encoding="application/x-tex">\\mathcal{O}(n_s \\times n_s)</annotation></semantics></math></span><span class="katex-html" aria-hidden="true"><span class="base"><span class="strut" style="height:1em;vertical-align:-0.25em;"></span><span class="mord mathcal" style="margin-right:0.02778em;">O</span><span class="mopen">(</span><span class="mord"><span class="mord mathnormal">n</span><span class="msupsub"><span class="vlist-t vlist-t2"><span class="vlist-r"><span class="vlist" style="height:0.1514em;"><span style="top:-2.55em;margin-left:0em;margin-right:0.05em;"><span class="pstrut" style="height:2.7em;"></span><span class="sizing reset-size6 size3 mtight"><span class="mord mathnormal mtight">s</span></span></span></span><span class="vlist-s">\u200B</span></span><span class="vlist-r"><span class="vlist" style="height:0.15em;"><span></span></span></span></span></span></span><span class="mspace" style="margin-right:0.2222em;"></span><span class="mbin">\xD7</span><span class="mspace" style="margin-right:0.2222em;"></span></span><span class="base"><span class="strut" style="height:1em;vertical-align:-0.25em;"></span><span class="mord"><span class="mord mathnormal">n</span><span class="msupsub"><span class="vlist-t vlist-t2"><span class="vlist-r"><span class="vlist" style="height:0.1514em;"><span style="top:-2.55em;margin-left:0em;margin-right:0.05em;"><span class="pstrut" style="height:2.7em;"></span><span class="sizing reset-size6 size3 mtight"><span class="mord mathnormal mtight">s</span></span></span></span><span class="vlist-s">\u200B</span></span><span class="vlist-r"><span class="vlist" style="height:0.15em;"><span></span></span></span></span></span></span><span class="mclose">)</span></span></span></span>',Sd,Bd,cy='<span class="katex"><span class="katex-mathml"><math xmlns="http://www.w3.org/1998/Math/MathML"><semantics><mrow><mi mathvariant="script">O</mi><mo stretchy="false">(</mo><msub><mi>n</mi><mi>s</mi></msub><mo>\xD7</mo><mi>w</mi><mo stretchy="false">)</mo></mrow><annotation encoding="application/x-tex">\\mathcal{O}(n_s \\times w)</annotation></semantics></math></span><span class="katex-html" aria-hidden="true"><span class="base"><span class="strut" style="height:1em;vertical-align:-0.25em;"></span><span class="mord mathcal" style="margin-right:0.02778em;">O</span><span class="mopen">(</span><span class="mord"><span class="mord mathnormal">n</span><span class="msupsub"><span class="vlist-t vlist-t2"><span class="vlist-r"><span class="vlist" style="height:0.1514em;"><span style="top:-2.55em;margin-left:0em;margin-right:0.05em;"><span class="pstrut" style="height:2.7em;"></span><span class="sizing reset-size6 size3 mtight"><span class="mord mathnormal mtight">s</span></span></span></span><span class="vlist-s">\u200B</span></span><span class="vlist-r"><span class="vlist" style="height:0.15em;"><span></span></span></span></span></span></span><span class="mspace" style="margin-right:0.2222em;"></span><span class="mbin">\xD7</span><span class="mspace" style="margin-right:0.2222em;"></span></span><span class="base"><span class="strut" style="height:1em;vertical-align:-0.25em;"></span><span class="mord mathnormal" style="margin-right:0.02691em;">w</span><span class="mclose">)</span></span></span></span>',Wd,Qd,my='<span class="katex"><span class="katex-mathml"><math xmlns="http://www.w3.org/1998/Math/MathML"><semantics><mrow><msub><mi>n</mi><mi>s</mi></msub></mrow><annotation encoding="application/x-tex">n_s</annotation></semantics></math></span><span class="katex-html" aria-hidden="true"><span class="base"><span class="strut" style="height:0.5806em;vertical-align:-0.15em;"></span><span class="mord"><span class="mord mathnormal">n</span><span class="msupsub"><span class="vlist-t vlist-t2"><span class="vlist-r"><span class="vlist" style="height:0.1514em;"><span style="top:-2.55em;margin-left:0em;margin-right:0.05em;"><span class="pstrut" style="height:2.7em;"></span><span class="sizing reset-size6 size3 mtight"><span class="mord mathnormal mtight">s</span></span></span></span><span class="vlist-s">\u200B</span></span><span class="vlist-r"><span class="vlist" style="height:0.15em;"><span></span></span></span></span></span></span></span></span></span>',Ud,Hd,hy='<span class="katex"><span class="katex-mathml"><math xmlns="http://www.w3.org/1998/Math/MathML"><semantics><mrow><mi>w</mi></mrow><annotation encoding="application/x-tex">w</annotation></semantics></math></span><span class="katex-html" aria-hidden="true"><span class="base"><span class="strut" style="height:0.4306em;"></span><span class="mord mathnormal" style="margin-right:0.02691em;">w</span></span></span></span>',Rd,Kd,nn,uh,ps,_h,wh,Vd,Yt,sn,Fi,fs,kh,Mi,bh,Gd,Zt,gr,vh,yh,ur,Th,$h,Jd,gs,Xd,eo,an,Ei,us,Lh,zi,xh,Yd,ct,_s,Fh,to,Mh,_r,Eh,zh,wr,qh,jh,Ch,oo,Oh,kr,Ph,Nh,ws,Ah,Ih,Dh,no,Sh,br,Bh,Wh,vr,Qh,Uh,Hh,rn,Zd,so,ln,qi,ks,Rh,ji,Kh,ec,Ot,bs,Vh,Ci,Gh,Jh,dn,yr,Xh,Yh,Tr,Zh,ep,tc,ao,cn,Oi,vs,tp,Pi,op,oc,Pt,ys,np,Ts,sp,Ni,ap,rp,ip,mn,$r,lp,dp,Lr,cp,mp,nc,ro,hn,Ai,$s,hp,Ii,pp,sc,io,Ls,fp,Di,gp,ac,lo,xs,up,Si,_p,rc,co,Fs,wp,Bi,kp,ic,mo,Ms,bp,Wi,vp,lc,ho,Es,yp,Qi,Tp,dc,po,zs,$p,Ui,Lp,cc,fo,qs,xp,Hi,Fp,mc,go,js,Mp,Ri,Ep,hc,uo,Cs,zp,Ki,qp,pc,_o,Os,jp,Vi,Cp,fc,wo,Ps,Op,Gi,Pp,gc,ko,Ns,Np,Ji,Ap,uc,bo,As,Ip,Xi,Dp,_c,vo,Is,Sp,Yi,Bp,wc,yo,pn,Zi,Ds,Wp,el,Qp,kc,et,Ss,Up,tl,Hp,Rp,Bs,Kp,xr,Vp,Gp,Jp,Ws,Xp,Qs,Yp,Zp,ef,To,tf,Fr,of,nf,Us,sf,af,rf,Hs,lf,ol,df,cf,mf,$t,Rs,hf,$o,pf,Mr,ff,gf,nl,uf,_f,wf,fn,kf,gn,bc,Lo,un,sl,Ks,bf,al,vf,vc,mt,Vs,yf,Gs,Tf,rl,$f,Lf,xf,Js,Ff,Er,Mf,Ef,zf,Xs,qf,Ys,jf,Cf,Of,lt,Zs,Pf,xo,Nf,zr,Af,If,il,Df,Sf,Bf,_n,Wf,wn,Qf,ll,Uf,Hf,kn,yc,Fo,bn,dl,ea,Rf,cl,Kf,Tc,ht,ta,Vf,ml,Gf,Jf,oa,Xf,qr,Yf,Zf,eg,na,tg,sa,og,ng,sg,tt,aa,ag,Mo,rg,jr,ig,lg,hl,dg,cg,mg,vn,hg,yn,pg,Tn,fg,$n,gg,Ln,$c,Eo,xn,pl,ra,ug,fl,_g,Lc,pt,ia,wg,gl,kg,bg,la,vg,Cr,yg,Tg,$g,da,Lg,ca,xg,Fg,Mg,Lt,ma,Eg,zo,zg,Or,qg,jg,ul,Cg,Og,Pg,Fn,Ng,Mn,xc,qo,En,_l,ha,Ag,wl,Ig,Fc,ft,pa,Dg,kl,Sg,Bg,fa,Wg,Pr,Qg,Ug,Hg,ga,Rg,ua,Kg,Vg,Gg,_t,_a,Jg,jo,Xg,Nr,Yg,Zg,bl,eu,tu,ou,zn,nu,qn,su,jn,Mc,Co,Cn,vl,wa,au,yl,ru,Ec,gt,ka,iu,Oo,lu,Tl,du,cu,$l,mu,hu,pu,ba,fu,Ar,gu,uu,_u,va,wu,ya,ku,bu,vu,xt,Ta,yu,Po,Tu,Ir,$u,Lu,Ll,xu,Fu,Mu,On,Eu,Pn,zc,No,Nn,xl,$a,zu,Fl,qu,qc,Ke,La,ju,Ml,Cu,Ou,xa,Pu,Dr,Nu,Au,Iu,Fa,Du,Ma,Su,Bu,Wu,An,Qu,Ao,Uu,Sr,Hu,Ru,Ea,Ku,Vu,Gu,za,Ju,El,Xu,Yu,Zu,Dt,qa,e_,Io,t_,Br,o_,n_,zl,s_,a_,r_,In,jc,Do,Dn,ql,ja,i_,jl,l_,Cc,nt,Ca,d_,Oa,c_,Cl,m_,h_,p_,Pa,f_,Wr,g_,u_,__,Na,w_,Aa,k_,b_,v_,Sn,y_,wt,Ia,T_,So,$_,Qr,L_,x_,Ol,F_,M_,E_,Bn,z_,Wn,q_,Qn,Oc,Bo,Un,Pl,Da,j_,Nl,C_,Pc,st,Sa,O_,Wo,P_,Al,N_,A_,Il,I_,D_,S_,Ba,B_,Ur,W_,Q_,U_,Wa,H_,Qa,R_,K_,V_,Hn,G_,kt,Ua,J_,Qo,X_,Hr,Y_,Z_,Dl,ew,tw,ow,Rn,nw,Kn,sw,Vn,Nc,Uo,Gn,Sl,Ha,aw,Bl,rw,Ac,at,Ra,iw,Wl,lw,dw,Ka,cw,Rr,mw,hw,pw,Va,fw,Ga,gw,uw,_w,Jn,ww,bt,Ja,kw,Ho,bw,Kr,vw,yw,Ql,Tw,$w,Lw,Xn,xw,Yn,Fw,Zn,Ic,Ro,es,Ul,Xa,Mw,Hl,Ew,Dc,rt,Ya,zw,Rl,qw,jw,Za,Cw,Vr,Ow,Pw,Nw,er,Aw,tr,Iw,Dw,Sw,ts,Bw,vt,or,Ww,Ko,Qw,Gr,Uw,Hw,Kl,Rw,Kw,Vw,os,Gw,ns,Jw,ss,Sc,Vo,as,Vl,nr,Xw,Gl,Yw,Bc,it,sr,Zw,Jl,ek,tk,ar,ok,Jr,nk,sk,ak,rr,rk,ir,ik,lk,dk,rs,ck,Ft,lr,mk,Go,hk,Xr,pk,fk,Xl,gk,uk,_k,is,wk,ls,Wc;return d=new Xe({}),F=new Xe({}),E=new Xe({}),fs=new Xe({}),gs=new Be({props:{code:`input_ids = tokenizer.encode("This is a sentence from [MASK] training data", return_tensors="pt")
...
`}}),zn=new ot({props:{$$slots:{default:[qy]},$$scope:{ctx:z}}}),qn=new Ge({props:{anchor:"transformers.LongformerForTokenClassification.forward.example",$$slots:{default:[jy]},$$scope:{ctx:z}}}),jn=new Ge({props:{anchor:"transformers.LongformerForTokenClassification.forward.example-2",$$slots:{default:[Cy]},$$scope:{ctx:z}}}),wa=new Xe({}),ka=new R({props:{name:"class transformers.LongformerForQuestionAnswering",anchor:"transformers.LongformerForQuestionAnswering",parameters:[{name:"config",val:""}],parametersDescription:[{anchor:"transformers.LongformerForQuestionAnswering.config",description:`<strong>config</strong> (<a href="/docs/transformers/main/en/model_doc/longformer#transformers.LongformerConfig">LongformerConfig</a>) &#x2014; Model configuration class with all the parameters of the
model. Initializing with a config file does not load the weights associated with the model, only the
...
Labels for computing the masked language modeling loss. Indices should be in <code>[-100, 0, ..., config.vocab_size]</code> (see <code>input_ids</code> docstring) Tokens with indices set to <code>-100</code> are ignored (masked), the
loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/longformer/modeling_tf_longformer.py#L2110",returnDescription:`
<p>A <a
...
`}}),Bn=new ot({props:{$$slots:{default:[Dy]},$$scope:{ctx:z}}}),Wn=new Ge({props:{anchor:"transformers.TFLongformerForMaskedLM.call.example",$$slots:{default:[Sy]},$$scope:{ctx:z}}}),Qn=new Ge({props:{anchor:"transformers.TFLongformerForMaskedLM.call.example-2",$$slots:{default:[By]},$$scope:{ctx:z}}}),Da=new Xe({}),Sa=new R({props:{name:"class transformers.TFLongformerForQuestionAnswering",anchor:"transformers.TFLongformerForQuestionAnswering",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.TFLongformerForQuestionAnswering.config",description:`<strong>config</strong> (<a href="/docs/transformers/main/en/model_doc/longformer#transformers.LongformerConfig">LongformerConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/main/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/longformer/modeling_tf_longformer.py#L2190"}}),Hn=new ot({props:{$$slots:{default:[Wy]},$$scope:{ctx:z}}}),Ua=new R({props:{name:"call",anchor:"transformers.TFLongformerForQuestionAnswering.call",parameters:[{name:"input_ids",val:": typing.Union[typing.List[tensorflow.python.framework.ops.Tensor], typing.List[numpy.ndarray], typing.List[tensorflow.python.keras.engine.keras_tensor.KerasTensor], typing.Dict[str, tensorflow.python.framework.ops.Tensor], typing.Dict[str, numpy.ndarray], typing.Dict[str, tensorflow.python.keras.engine.keras_tensor.KerasTensor], tensorflow.python.framework.ops.Tensor, numpy.ndarray, tensorflow.python.keras.engine.keras_tensor.KerasTensor, NoneType] = None"},{name:"attention_mask",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"head_mask",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"global_attention_mask",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"token_type_ids",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"position_ids",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"inputs_embeds",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"start_positions",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"end_positions",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"training",val:": typing.Optional[bool] = False"}],parametersDescription:[{anchor:"transformers.TFLongformerForQuestionAnswering.call.input_ids",description:`<strong>input_ids</strong> (<code>np.ndarray</code> or <code>tf.Tensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/main/en/model_doc/longformer#transformers.LongformerTokenizer">LongformerTokenizer</a>. See <a href="/docs/transformers/main/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
<a href="/docs/transformers/main/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> for details.</p>
...
Labels for position (index) of the end of the labelled span for computing the token classification loss.
Positions are clamped to the length of the sequence (<em>sequence_length</em>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/longformer/modeling_tf_longformer.py#L2205",returnDescription:`
<p>A <a
...
Whether or not to use the model in training mode (some modules like dropout modules have different
behaviors between training and evaluation).`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/longformer/modeling_tf_longformer.py#L2371",returnDescription:`
<p>A <a
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/longformer/modeling_tf_longformer.py#L2626",returnDescription:`
<p>A <a
...
where <code>num_choices</code> is the size of the second dimension of the input tensors. (See <code>input_ids</code> above)`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/longformer/modeling_tf_longformer.py#L2495",returnDescription:`
<p>A <a
...
WikiHop and TriviaQA.`),ne=c(),j=a("p"),O=n("Tips:"),_e=c(),Q=a("ul"),te=a("li"),xe=n("Since the Longformer is based on RoBERTa, it doesn\u2019t have "),H=a("code"),Fe=n("token_type_ids"),Me=n(`. You don\u2019t need to indicate which
token belongs to which segment. Just separate your segments with the separation token `),C=a("code"),Ee=n("tokenizer.sep_token"),J=n(` (or
`),he=a("code"),ze=n("</s>"),X=n(")."),we=c(),se=a("p"),I=n("This model was contributed by "),ce=a("a"),Y=n("beltagy"),qe=n(". The Authors\u2019 code can be found "),Z=a("a"),P=n("here"),je=n("."),N=c(),ae=a("h2"),le=a("a"),w=a("span"),v(E.$$.fragment),We=c(),oe=a("span"),Qe=n("Longformer Self Attention"),Ne=c(),M=a("p"),Ue=n(`Longformer self attention employs self attention on both a \u201Clocal\u201D context and a \u201Cglobal\u201D context. Most tokens only
...
`),Oe=a("code"),He=n("config.attention_window"),Ce=n(". Note that "),Pe=a("code"),re=n("config.attention_window"),Re=n(" can be of type "),bi=a("code"),Xm=n("List"),Ym=n(` to define a
different `),zd=new Zo,qd=n(` for each layer. A selected few tokens attend \u201Cglobally\u201D to all other tokens, as it is
conventionally done for all tokens in `),vi=a("code"),Zm=n("BertSelfAttention"),eh=n("."),jd=c(),At=a("p"),th=n(`Note that \u201Clocally\u201D and \u201Cglobally\u201D attending tokens are projected by different query, key and value matrices. Also note
...
trained and should be used as follows:`),Jd=c(),v(gs.$$.fragment),Xd=c(),eo=a("h2"),an=a("a"),Ei=a("span"),v(us.$$.fragment),Lh=c(),zi=a("span"),xh=n("LongformerConfig"),Yd=c(),ct=a("div"),v(_s.$$.fragment),Fh=c(),to=a("p"),Mh=n("This is the configuration class to store the configuration of a "),_r=a("a"),Eh=n("LongformerModel"),zh=n(" or a "),wr=a("a"),qh=n("TFLongformerModel"),jh=n(`. It
is used to instantiate a Longformer model according to the specified arguments, defining the model architecture.`),Ch=c(),oo=a("p"),Oh=n("This is the configuration class to store the configuration of a "),kr=a("a"),Ph=n("LongformerModel"),Nh=n(`. It is used to instantiate an
...
length 4,096.`),Dh=c(),no=a("p"),Sh=n("The "),br=a("a"),Bh=n("LongformerConfig"),Wh=n(" class directly inherits "),vr=a("a"),Qh=n("RobertaConfig"),Uh=n(`. It reuses the same defaults. Please check the
parent class for more information.`),Hh=c(),v(rn.$$.fragment),Zd=c(),so=a("h2"),ln=a("a"),qi=a("span"),v(ks.$$.fragment),Rh=c(),ji=a("span"),Kh=n("LongformerTokenizer"),ec=c(),Ot=a("div"),v(bs.$$.fragment),Vh=c(),Ci=a("p"),Gh=n("Construct a Longformer tokenizer."),Jh=c(),dn=a("p"),yr=a("a"),Xh=n("LongformerTokenizer"),Yh=n(" is identical to "),Tr=a("a"),Zh=n("RobertaTokenizer"),ep=n(`. Refer to the superclass for usage examples and
...
and documentation concerning parameters.`),nc=c(),ro=a("h2"),hn=a("a"),Ai=a("span"),v($s.$$.fragment),hp=c(),Ii=a("span"),pp=n("Longformer specific outputs"),sc=c(),io=a("div"),v(Ls.$$.fragment),fp=c(),Di=a("p"),gp=n("Base class for Longformer\u2019s outputs, with potential hidden states, local and global attentions."),ac=c(),lo=a("div"),v(xs.$$.fragment),up=c(),Si=a("p"),_p=n("Base class for Longformer\u2019s outputs that also contains a pooling of the last hidden states."),rc=c(),co=a("div"),v(Fs.$$.fragment),wp=c(),Bi=a("p"),kp=n("Base class for masked language models outputs."),ic=c(),mo=a("div"),v(Ms.$$.fragment),bp=c(),Wi=a("p"),vp=n("Base class for outputs of question answering Longformer models."),lc=c(),ho=a("div"),v(Es.$$.fragment),yp=c(),Qi=a("p"),Tp=n("Base class for outputs of sentence classification models."),dc=c(),po=a("div"),v(zs.$$.fragment),$p=c(),Ui=a("p"),Lp=n("Base class for outputs of multiple choice Longformer models."),cc=c(),fo=a("div"),v(qs.$$.fragment),xp=c(),Hi=a("p"),Fp=n("Base class for outputs of token classification models."),mc=c(),go=a("div"),v(js.$$.fragment),Mp=c(),Ri=a("p"),Ep=n("Base class for Longformer\u2019s outputs, with potential hidden states, local and global attentions."),hc=c(),uo=a("div"),v(Cs.$$.fragment),zp=c(),Ki=a("p"),qp=n("Base class for Longformer\u2019s outputs that also contains a pooling of the last hidden states."),pc=c(),_o=a("div"),v(Os.$$.fragment),jp=c(),Vi=a("p"),Cp=n("Base class for masked language models outputs."),fc=c(),wo=a("div"),v(Ps.$$.fragment),Op=c(),Gi=a("p"),Pp=n("Base class for outputs of question answering Longformer models."),gc=c(),ko=a("div"),v(Ns.$$.fragment),Np=c(),Ji=a("p"),Ap=n("Base class for outputs of sentence classification models."),uc=c(),bo=a("div"),v(As.$$.fragment),Ip=c(),Xi=a("p"),Dp=n("Base class for outputs of multiple choice models."),_c=c(),vo=a("div"),v(Is.$$.fragment),Sp=c(),Yi=a("p"),Bp=n("Base class for outputs of token classification models."),wc=c(),yo=a("h2"),pn=a("a"),Zi=a("span"),v(Ds.$$.fragment),Wp=c(),el=a("span"),Qp=n("LongformerModel"),kc=c(),et=a("div"),v(Ss.$$.fragment),Up=c(),tl=a("p"),Hp=n("The bare Longformer Model outputting raw hidden-states without any specific head on top."),Rp=c(),Bs=a("p"),Kp=n("This model inherits from "),xr=a("a"),Vp=n("PreTrainedModel"),Gp=n(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Jp=c(),Ws=a("p"),Xp=n("This model is also a PyTorch "),Qs=a("a"),Yp=n("torch.nn.Module"),Zp=n(` subclass.
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),zf=c(),Xs=a("p"),qf=n("This model is also a PyTorch "),Ys=a("a"),jf=n("torch.nn.Module"),Cf=n(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Of=c(),lt=a("div"),v(Zs.$$.fragment),Pf=c(),xo=a("p"),Nf=n("The "),zr=a("a"),Af=n("LongformerForMaskedLM"),If=n(" forward method, overrides the "),il=a("code"),Df=n("__call__"),Sf=n(" special method."),Bf=c(),v(_n.$$.fragment),Wf=c(),v(wn.$$.fragment),Qf=c(),ll=a("p"),Uf=n("Let\u2019s try a very long input."),Hf=c(),v(kn.$$.fragment),yc=c(),Fo=a("h2"),bn=a("a"),dl=a("span"),v(ea.$$.fragment),Rf=c(),cl=a("span"),Kf=n("LongformerForSequenceClassification"),Tc=c(),ht=a("div"),v(ta.$$.fragment),Vf=c(),ml=a("p"),Gf=n(`Longformer Model transformer with a sequence classification/regression head on top (a linear layer on top of the
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),vu=c(),xt=a("div"),v(Ta.$$.fragment),yu=c(),Po=a("p"),Tu=n("The "),Ir=a("a"),$u=n("LongformerForQuestionAnswering"),Lu=n(" forward method, overrides the "),Ll=a("code"),xu=n("__call__"),Fu=n(" special method."),Mu=c(),v(On.$$.fragment),Eu=c(),v(Pn.$$.fragment),zc=c(),No=a("h2"),Nn=a("a"),xl=a("span"),v($a.$$.fragment),zu=c(),Fl=a("span"),qu=n("TFLongformerModel"),qc=c(),Ke=a("div"),v(La.$$.fragment),ju=c(),Ml=a("p"),Cu=n("The bare Longformer Model outputting raw hidden-states without any specific head on top."),Ou=c(),xa=a("p"),Pu=n("This model inherits from "),Dr=a("a"),Nu=n("TFPreTrainedModel"),Au=n(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Iu=c(),Fa=a("p"),Du=n("This model is also a "),Ma=a("a"),Su=n("tf.keras.Model"),Bu=n(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Wu=c(),v(An.$$.fragment),Qu=c(),Ao=a("p"),Uu=n("This class copies code from "),Sr=a("a"),Hu=n("TFRobertaModel"),Ru=n(` and overwrites standard self-attention with longformer
...
attention are more relevant for autoregressive language modeling than finetuning on downstream tasks. Future
release will add support for autoregressive attention, but the support for dilated attention requires a custom CUDA
kernel to be memory and compute efficient.`),Zu=c(),Dt=a("div"),v(qa.$$.fragment),e_=c(),Io=a("p"),t_=n("The "),Br=a("a"),o_=n("TFLongformerModel"),n_=n(" forward method, overrides the "),zl=a("code"),s_=n("__call__"),a_=n(" special method."),r_=c(),v(In.$$.fragment),jc=c(),Do=a("h2"),Dn=a("a"),ql=a("span"),v(ja.$$.fragment),i_=c(),jl=a("span"),l_=n("TFLongformerForMaskedLM"),Cc=c(),nt=a("div"),v(Ca.$$.fragment),d_=c(),Oa=a("p"),c_=n("Longformer Model with a "),Cl=a("code"),m_=n("language modeling"),h_=n(" head on top."),p_=c(),Pa=a("p"),f_=n("This model inherits from "),Wr=a("a"),g_=n("TFPreTrainedModel"),u_=n(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),__=c(),Na=a("p"),w_=n("This model is also a "),Aa=a("a"),k_=n("tf.keras.Model"),b_=n(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),v_=c(),v(Sn.$$.fragment),y_=c(),wt=a("div"),v(Ia.$$.fragment),T_=c(),So=a("p"),$_=n("The "),Qr=a("a"),L_=n("TFLongformerForMaskedLM"),x_=n(" forward method, overrides the "),Ol=a("code"),F_=n("__call__"),M_=n(" special method."),E_=c(),v(Bn.$$.fragment),z_=c(),v(Wn.$$.fragment),q_=c(),v(Qn.$$.fragment),Oc=c(),Bo=a("h2"),Un=a("a"),Pl=a("span"),v(Da.$$.fragment),j_=c(),Nl=a("span"),C_=n("TFLongformerForQuestionAnswering"),Pc=c(),st=a("div"),v(Sa.$$.fragment),O_=c(),Wo=a("p"),P_=n(`Longformer Model with a span classification head on top for extractive question-answering tasks like SQuAD /
TriviaQA (a linear layer on top of the hidden-states output to compute `),Al=a("code"),N_=n("span start logits"),A_=n(" and "),Il=a("code"),I_=n("span end logits"),D_=n(")."),S_=c(),Ba=a("p"),B_=n("This model inherits from "),Ur=a("a"),W_=n("TFPreTrainedModel"),Q_=n(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),U_=c(),Wa=a("p"),H_=n("This model is also a "),Qa=a("a"),R_=n("tf.keras.Model"),K_=n(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),V_=c(),v(Hn.$$.fragment),G_=c(),kt=a("div"),v(Ua.$$.fragment),J_=c(),Qo=a("p"),X_=n("The "),Hr=a("a"),Y_=n("TFLongformerForQuestionAnswering"),Z_=n(" forward method, overrides the "),Dl=a("code"),ew=n("__call__"),tw=n(" special method."),ow=c(),v(Rn.$$.fragment),nw=c(),v(Kn.$$.fragment),sw=c(),v(Vn.$$.fragment),Nc=c(),Uo=a("h2"),Gn=a("a"),Sl=a("span"),v(Ha.$$.fragment),aw=c(),Bl=a("span"),rw=n("TFLongformerForSequenceClassification"),Ac=c(),at=a("div"),v(Ra.$$.fragment),iw=c(),Wl=a("p"),lw=n(`Longformer Model transformer with a sequence classification/regression head on top (a linear layer on top of the
...
for Named-Entity-Recognition (NER) tasks.`),jw=c(),Za=a("p"),Cw=n("This model inherits from "),Vr=a("a"),Ow=n("TFPreTrainedModel"),Pw=n(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Nw=c(),er=a("p"),Aw=n("This model is also a "),tr=a("a"),Iw=n("tf.keras.Model"),Dw=n(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Sw=c(),v(ts.$$.fragment),Bw=c(),vt=a("div"),v(or.$$.fragment),Ww=c(),Ko=a("p"),Qw=n("The "),Gr=a("a"),Uw=n("TFLongformerForTokenClassification"),Hw=n(" forward method, overrides the "),Kl=a("code"),Rw=n("__call__"),Kw=n(" special method."),Vw=c(),v(os.$$.fragment),Gw=c(),v(ns.$$.fragment),Jw=c(),v(ss.$$.fragment),Sc=c(),Vo=a("h2"),as=a("a"),Vl=a("span"),v(nr.$$.fragment),Xw=c(),Gl=a("span"),Yw=n("TFLongformerForMultipleChoice"),Bc=c(),it=a("div"),v(sr.$$.fragment),Zw=c(),Jl=a("p"),ek=n(`Longformer Model with a multiple choice classification head on top (a linear layer on top of the pooled output and
...
contrast to most prior work, we also pretrain Longformer and finetune it on a variety of downstream tasks. Our
pretrained Longformer consistently outperforms RoBERTa on long document tasks and sets new state-of-the-art results on
WikiHop and TriviaQA.`),id.forEach(t),rd.forEach(t),ne=m(o),j=r(o,"P",{});var ld=i(j);O=s(ld,"Tips:"),ld.forEach(t),_e=m(o),Q=r(o,"UL",{});var dd=i(Q);te=r(dd,"LI",{});var Nt=i(te);xe=s(Nt,"Since the Longformer is based on RoBERTa, it doesn\u2019t have "),H=r(Nt,"CODE",{});var cd=i(H);Fe=s(cd,"token_type_ids"),cd.forEach(t),Me=s(Nt,`. You don\u2019t need to indicate which
token belongs to which segment. Just separate your segments with the separation token `),C=r(Nt,"CODE",{});var md=i(C);Ee=s(md,"tokenizer.sep_token"),md.forEach(t),J=s(Nt,` (or
`),he=r(Nt,"CODE",{});var hd=i(he);ze=s(hd,"</s>"),hd.forEach(t),X=s(Nt,")."),Nt.forEach(t),dd.forEach(t),we=m(o),se=r(o,"P",{});var Jo=i(se);I=s(Jo,"This model was contributed by "),ce=r(Jo,"A",{href:!0,rel:!0});var pd=i(ce);Y=s(pd,"beltagy"),pd.forEach(t),qe=s(Jo,". The Authors\u2019 code can be found "),Z=r(Jo,"A",{href:!0,rel:!0});var fd=i(Z);P=s(fd,"here"),fd.forEach(t),je=s(Jo,"."),Jo.forEach(t),N=m(o),ae=r(o,"H2",{class:!0});var hr=i(ae);le=r(hr,"A",{id:!0,class:!0,href:!0});var gd=i(le);w=r(gd,"SPAN",{});var ud=i(w);y(E.$$.fragment,ud),ud.forEach(t),gd.forEach(t),We=m(hr),oe=r(hr,"SPAN",{});var _d=i(oe);Qe=s(_d,"Longformer Self Attention"),_d.forEach(t),hr.forEach(t),Ne=m(o),M=r(o,"P",{});var Ve=i(M);Ue=s(Ve,`Longformer self attention employs self attention on both a \u201Clocal\u201D context and a \u201Cglobal\u201D context. Most tokens only
...
`),Oe=r(Ve,"CODE",{});var wd=i(Oe);He=s(wd,"config.attention_window"),wd.forEach(t),Ce=s(Ve,". Note that "),Pe=r(Ve,"CODE",{});var kd=i(Pe);re=s(kd,"config.attention_window"),kd.forEach(t),Re=s(Ve," can be of type "),bi=r(Ve,"CODE",{});var bd=i(bi);Xm=s(bd,"List"),bd.forEach(t),Ym=s(Ve,` to define a
different `),zd=en(Ve),qd=s(Ve,` for each layer. A selected few tokens attend \u201Cglobally\u201D to all other tokens, as it is
conventionally done for all tokens in `),vi=r(Ve,"CODE",{});var vd=i(vi);Zm=s(vd,"BertSelfAttention"),vd.forEach(t),eh=s(Ve,"."),Ve.forEach(t),jd=m(o),At=r(o,"P",{});var Xo=i(At);th=s(Xo,`Note that \u201Clocally\u201D and \u201Cglobally\u201D attending tokens are projected by different query, key and value matrices. Also note
...
trained and should be used as follows:`),Fd.forEach(t),Jd=m(o),y(gs.$$.fragment,o),Xd=m(o),eo=r(o,"H2",{class:!0});var Rc=i(eo);an=r(Rc,"A",{id:!0,class:!0,href:!0});var xk=i(an);Ei=r(xk,"SPAN",{});var Fk=i(Ei);y(us.$$.fragment,Fk),Fk.forEach(t),xk.forEach(t),Lh=m(Rc),zi=r(Rc,"SPAN",{});var Mk=i(zi);xh=s(Mk,"LongformerConfig"),Mk.forEach(t),Rc.forEach(t),Yd=m(o),ct=r(o,"DIV",{class:!0});var Bt=i(ct);y(_s.$$.fragment,Bt),Fh=m(Bt),to=r(Bt,"P",{});var Yr=i(to);Mh=s(Yr,"This is the configuration class to store the configuration of a "),_r=r(Yr,"A",{href:!0});var Ek=i(_r);Eh=s(Ek,"LongformerModel"),Ek.forEach(t),zh=s(Yr," or a "),wr=r(Yr,"A",{href:!0});var zk=i(wr);qh=s(zk,"TFLongformerModel"),zk.forEach(t),jh=s(Yr,`. It
is used to instantiate a Longformer model according to the specified arguments, defining the model architecture.`),Yr.forEach(t),Ch=m(Bt),oo=r(Bt,"P",{});var Zr=i(oo);Oh=s(Zr,"This is the configuration class to store the configuration of a "),kr=r(Zr,"A",{href:!0});var qk=i(kr);Ph=s(qk,"LongformerModel"),qk.forEach(t),Nh=s(Zr,`. It is used to instantiate an
Longformer model according to the specified arguments, defining the model architecture. Instantiating a
configuration with the defaults will yield a similar configuration to that of the LongFormer
`),ws=r(Zr,"A",{href:!0,rel:!0});var jk=i(ws);Ah=s(jk,"allenai/longformer-base-4096"),jk.forEach(t),Ih=s(Zr,` architecture with a sequence
length 4,096.`),Zr.forEach(t),Dh=m(Bt),no=r(Bt,"P",{});var ei=i(no);Sh=s(ei,"The "),br=r(ei,"A",{href:!0});var Ck=i(br);Bh=s(Ck,"LongformerConfig"),Ck.forEach(t),Wh=s(ei," class directly inherits "),vr=r(ei,"A",{href:!0});var Ok=i(vr);Qh=s(Ok,"RobertaConfig"),Ok.forEach(t),Uh=s(ei,`. It reuses the same defaults. Please check the
parent class for more information.`),ei.forEach(t),Hh=m(Bt),y(rn.$$.fragment,Bt),Bt.forEach(t),Zd=m(o),so=r(o,"H2",{class:!0});var Kc=i(so);ln=r(Kc,"A",{id:!0,class:!0,href:!0});var Pk=i(ln);qi=r(Pk,"SPAN",{});var Nk=i(qi);y(ks.$$.fragment,Nk),Nk.forEach(t),Pk.forEach(t),Rh=m(Kc),ji=r(Kc,"SPAN",{});var Ak=i(ji);Kh=s(Ak,"LongformerTokenizer"),Ak.forEach(t),Kc.forEach(t),ec=m(o),Ot=r(o,"DIV",{class:!0});var ti=i(Ot);y(bs.$$.fragment,ti),Vh=m(ti),Ci=r(ti,"P",{});var Ik=i(Ci);Gh=s(Ik,"Construct a Longformer tokenizer."),Ik.forEach(t),Jh=m(ti),dn=r(ti,"P",{});var Md=i(dn);yr=r(Md,"A",{href:!0});var Dk=i(yr);Xh=s(Dk,"LongformerTokenizer"),Dk.forEach(t),Yh=s(Md," is identical to "),Tr=r(Md,"A",{href:!0});var Sk=i(Tr);Zh=s(Sk,"RobertaTokenizer"),Sk.forEach(t),ep=s(Md,`. Refer to the superclass for usage examples and
documentation concerning parameters.`),Md.forEach(t),ti.forEach(t),tc=m(o),ao=r(o,"H2",{class:!0});var Vc=i(ao);cn=r(Vc,"A",{id:!0,class:!0,href:!0});var Bk=i(cn);Oi=r(Bk,"SPAN",{});var Wk=i(Oi);y(vs.$$.fragment,Wk),Wk.forEach(t),Bk.forEach(t),tp=m(Vc),Pi=r(Vc,"SPAN",{});var Qk=i(Pi);op=s(Qk,"LongformerTokenizerFast"),Qk.forEach(t),Vc.forEach(t),oc=m(o),Pt=r(o,"DIV",{class:!0});var oi=i(Pt);y(ys.$$.fragment,oi),np=m(oi),Ts=r(oi,"P",{});var Gc=i(Ts);sp=s(Gc,"Construct a \u201Cfast\u201D Longformer tokenizer (backed by HuggingFace\u2019s "),Ni=r(Gc,"EM",{});var Uk=i(Ni);ap=s(Uk,"tokenizers"),Uk.forEach(t),rp=s(Gc," library)."),Gc.forEach(t),ip=m(oi),mn=r(oi,"P",{});var Ed=i(mn);$r=r(Ed,"A",{href:!0});var Hk=i($r);lp=s(Hk,"LongformerTokenizerFast"),Hk.forEach(t),dp=s(Ed," is identical to "),Lr=r(Ed,"A",{href:!0});var Rk=i(Lr);cp=s(Rk,"RobertaTokenizerFast"),Rk.forEach(t),mp=s(Ed,`. Refer to the superclass for usage examples
and documentation concerning parameters.`),Ed.forEach(t),oi.forEach(t),nc=m(o),ro=r(o,"H2",{class:!0});var Jc=i(ro);hn=r(Jc,"A",{id:!0,class:!0,href:!0});var Kk=i(hn);Ai=r(Kk,"SPAN",{});var Vk=i(Ai);y($s.$$.fragment,Vk),Vk.forEach(t),Kk.forEach(t),hp=m(Jc),Ii=r(Jc,"SPAN",{});var Gk=i(Ii);pp=s(Gk,"Longformer specific outputs"),Gk.forEach(t),Jc.forEach(t),sc=m(o),io=r(o,"DIV",{class:!0});var Xc=i(io);y(Ls.$$.fragment,Xc),fp=m(Xc),Di=r(Xc,"P",{});var Jk=i(Di);gp=s(Jk,"Base class for Longformer\u2019s outputs, with potential hidden states, local and global attentions."),Jk.forEach(t),Xc.forEach(t),ac=m(o),lo=r(o,"DIV",{class:!0});var Yc=i(lo);y(xs.$$.fragment,Yc),up=m(Yc),Si=r(Yc,"P",{});var Xk=i(Si);_p=s(Xk,"Base class for Longformer\u2019s outputs that also contains a pooling of the last hidden states."),Xk.forEach(t),Yc.forEach(t),rc=m(o),co=r(o,"DIV",{class:!0});var Zc=i(co);y(Fs.$$.fragment,Zc),wp=m(Zc),Bi=r(Zc,"P",{});var Yk=i(Bi);kp=s(Yk,"Base class for masked language models outputs."),Yk.forEach(t),Zc.forEach(t),ic=m(o),mo=r(o,"DIV",{class:!0});var em=i(mo);y(Ms.$$.fragment,em),bp=m(em),Wi=r(em,"P",{});var Zk=i(Wi);vp=s(Zk,"Base class for outputs of question answering Longformer models."),Zk.forEach(t),em.forEach(t),lc=m(o),ho=r(o,"DIV",{class:!0});var tm=i(ho);y(Es.$$.fragment,tm),yp=m(tm),Qi=r(tm,"P",{});var eb=i(Qi);Tp=s(eb,"Base class for outputs of sentence classification models."),eb.forEach(t),tm.forEach(t),dc=m(o),po=r(o,"DIV",{class:!0});var om=i(po);y(zs.$$.fragment,om),$p=m(om),Ui=r(om,"P",{});var tb=i(Ui);Lp=s(tb,"Base class for outputs of multiple choice Longformer models."),tb.forEach(t),om.forEach(t),cc=m(o),fo=r(o,"DIV",{class:!0});var nm=i(fo);y(qs.$$.fragment,nm),xp=m(nm),Hi=r(nm,"P",{});var ob=i(Hi);Fp=s(ob,"Base class for outputs of token classification models."),ob.forEach(t),nm.forEach(t),mc=m(o),go=r(o,"DIV",{class:!0});var sm=i(go);y(js.$$.fragment,sm),Mp=m(sm),Ri=r(sm,"P",{});var nb=i(Ri);Ep=s(nb,"Base class for Longformer\u2019s outputs, with potential hidden states, local and global attentions."),nb.forEach(t),sm.forEach(t),hc=m(o),uo=r(o,"DIV",{class:!0});var am=i(uo);y(Cs.$$.fragment,am),zp=m(am),Ki=r(am,"P",{});var sb=i(Ki);qp=s(sb,"Base class for Longformer\u2019s outputs that also contains a pooling of the last hidden states."),sb.forEach(t),am.forEach(t),pc=m(o),_o=r(o,"DIV",{class:!0});var rm=i(_o);y(Os.$$.fragment,rm),jp=m(rm),Vi=r(rm,"P",{});var ab=i(Vi);Cp=s(ab,"Base class for masked language models outputs."),ab.forEach(t),rm.forEach(t),fc=m(o),wo=r(o,"DIV",{class:!0});var im=i(wo);y(Ps.$$.fragment,im),Op=m(im),Gi=r(im,"P",{});var rb=i(Gi);Pp=s(rb,"Base class for outputs of question answering Longformer models."),rb.forEach(t),im.forEach(t),gc=m(o),ko=r(o,"DIV",{class:!0});var lm=i(ko);y(Ns.$$.fragment,lm),Np=m(lm),Ji=r(lm,"P",{});var ib=i(Ji);Ap=s(ib,"Base class for outputs of sentence classification models."),ib.forEach(t),lm.forEach(t),uc=m(o),bo=r(o,"DIV",{class:!0});var dm=i(bo);y(As.$$.fragment,dm),Ip=m(dm),Xi=r(dm,"P",{});var lb=i(Xi);Dp=s(lb,"Base class for outputs of multiple choice models."),lb.forEach(t),dm.forEach(t),_c=m(o),vo=r(o,"DIV",{class:!0});var cm=i(vo);y(Is.$$.fragment,cm),Sp=m(cm),Yi=r(cm,"P",{});var db=i(Yi);Bp=s(db,"Base class for outputs of token classification models."),db.forEach(t),cm.forEach(t),wc=m(o),yo=r(o,"H2",{class:!0});var mm=i(yo);pn=r(mm,"A",{id:!0,class:!0,href:!0});var cb=i(pn);Zi=r(cb,"SPAN",{});var mb=i(Zi);y(Ds.$$.fragment,mb),mb.forEach(t),cb.forEach(t),Wp=m(mm),el=r(mm,"SPAN",{});var hb=i(el);Qp=s(hb,"LongformerModel"),hb.forEach(t),mm.forEach(t),kc=m(o),et=r(o,"DIV",{class:!0});var yt=i(et);y(Ss.$$.fragment,yt),Up=m(yt),tl=r(yt,"P",{});var pb=i(tl);Hp=s(pb,"The bare Longformer Model outputting raw hidden-states without any specific head on top."),pb.forEach(t),Rp=m(yt),Bs=r(yt,"P",{});var hm=i(Bs);Kp=s(hm,"This model inherits from "),xr=r(hm,"A",{href:!0});var fb=i(xr);Vp=s(fb,"PreTrainedModel"),fb.forEach(t),Gp=s(hm,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),hm.forEach(t),Jp=m(yt),Ws=r(yt,"P",{});var pm=i(Ws);Xp=s(pm,"This model is also a PyTorch "),Qs=r(pm,"A",{href:!0,rel:!0});var gb=i(Qs);Yp=s(gb,"torch.nn.Module"),gb.forEach(t),Zp=s(pm,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
...
attention are more relevant for autoregressive language modeling than finetuning on downstream tasks. Future
release will add support for autoregressive attention, but the support for dilated attention requires a custom CUDA
kernel to be memory and compute efficient.`),fm.forEach(t),mf=m(yt),$t=r(yt,"DIV",{class:!0});var ds=i($t);y(Rs.$$.fragment,ds),hf=m(ds),$o=r(ds,"P",{});var si=i($o);pf=s(si,"The "),Mr=r(si,"A",{href:!0});var kb=i(Mr);ff=s(kb,"LongformerModel"),kb.forEach(t),gf=s(si," forward method, overrides the "),nl=r(si,"CODE",{});var bb=i(nl);uf=s(bb,"__call__"),bb.forEach(t),_f=s(si," special method."),si.forEach(t),wf=m(ds),y(fn.$$.fragment,ds),kf=m(ds),y(gn.$$.fragment,ds),ds.forEach(t),yt.forEach(t),bc=m(o),Lo=r(o,"H2",{class:!0});var gm=i(Lo);un=r(gm,"A",{id:!0,class:!0,href:!0});var vb=i(un);sl=r(vb,"SPAN",{});var yb=i(sl);y(Ks.$$.fragment,yb),yb.forEach(t),vb.forEach(t),bf=m(gm),al=r(gm,"SPAN",{});var Tb=i(al);vf=s(Tb,"LongformerForMaskedLM"),Tb.forEach(t),gm.forEach(t),vc=m(o),mt=r(o,"DIV",{class:!0});var Wt=i(mt);y(Vs.$$.fragment,Wt),yf=m(Wt),Gs=r(Wt,"P",{});var um=i(Gs);Tf=s(um,"Longformer Model with a "),rl=r(um,"CODE",{});var $b=i(rl);$f=s($b,"language modeling"),$b.forEach(t),Lf=s(um," head on top."),um.forEach(t),xf=m(Wt),Js=r(Wt,"P",{});var _m=i(Js);Ff=s(_m,"This model inherits from "),Er=r(_m,"A",{href:!0});var Lb=i(Er);Mf=s(Lb,"PreTrainedModel"),Lb.forEach(t),Ef=s(_m,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),_m.forEach(t),zf=m(Wt),Xs=r(Wt,"P",{});var wm=i(Xs);qf=s(wm,"This model is also a PyTorch "),Ys=r(wm,"A",{href:!0,rel:!0});var xb=i(Ys);jf=s(xb,"torch.nn.Module"),xb.forEach(t),Cf=s(wm,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),wm.forEach(t),Of=m(Wt),lt=r(Wt,"DIV",{class:!0});var Mt=i(lt);y(Zs.$$.fragment,Mt),Pf=m(Mt),xo=r(Mt,"P",{});var ai=i(xo);Nf=s(ai,"The "),zr=r(ai,"A",{href:!0});var Fb=i(zr);Af=s(Fb,"LongformerForMaskedLM"),Fb.forEach(t),If=s(ai," forward method, overrides the "),il=r(ai,"CODE",{});var Mb=i(il);Df=s(Mb,"__call__"),Mb.forEach(t),Sf=s(ai," special method."),ai.forEach(t),Bf=m(Mt),y(_n.$$.fragment,Mt),Wf=m(Mt),y(wn.$$.fragment,Mt),Qf=m(Mt),ll=r(Mt,"P",{});var Eb=i(ll);Uf=s(Eb,"Let\u2019s try a very long input."),Eb.forEach(t),Hf=m(Mt),y(kn.$$.fragment,Mt),Mt.forEach(t),Wt.forEach(t),yc=m(o),Fo=r(o,"H2",{class:!0});var km=i(Fo);bn=r(km,"A",{id:!0,class:!0,href:!0});var zb=i(bn);dl=r(zb,"SPAN",{});var qb=i(dl);y(ea.$$.fragment,qb),qb.forEach(t),zb.forEach(t),Rf=m(km),cl=r(km,"SPAN",{});var jb=i(cl);Kf=s(jb,"LongformerForSequenceClassification"),jb.forEach(t),km.forEach(t),Tc=m(o),ht=r(o,"DIV",{class:!0});var Qt=i(ht);y(ta.$$.fragment,Qt),Vf=m(Qt),ml=r(Qt,"P",{});var Cb=i(ml);Gf=s(Cb,`Longformer Model transformer with a sequence classification/regression head on top (a linear layer on top of the
pooled output) e.g. for GLUE tasks.`),Cb.forEach(t),Jf=m(Qt),oa=r(Qt,"P",{});var bm=i(oa);Xf=s(bm,"This model inherits from "),qr=r(bm,"A",{href:!0});var Ob=i(qr);Yf=s(Ob,"PreTrainedModel"),Ob.forEach(t),Zf=s(bm,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),vm.forEach(t),sg=m(Qt),tt=r(Qt,"DIV",{class:!0});var Tt=i(tt);y(aa.$$.fragment,Tt),ag=m(Tt),Mo=r(Tt,"P",{});var ri=i(Mo);rg=s(ri,"The "),jr=r(ri,"A",{href:!0});var Nb=i(jr);ig=s(Nb,"LongformerForSequenceClassification"),Nb.forEach(t),lg=s(ri," forward method, overrides the "),hl=r(ri,"CODE",{});var Ab=i(hl);dg=s(Ab,"__call__"),Ab.forEach(t),cg=s(ri," special method."),ri.forEach(t),mg=m(Tt),y(vn.$$.fragment,Tt),hg=m(Tt),y(yn.$$.fragment,Tt),pg=m(Tt),y(Tn.$$.fragment,Tt),fg=m(Tt),y($n.$$.fragment,Tt),gg=m(Tt),y(Ln.$$.fragment,Tt),Tt.forEach(t),Qt.forEach(t),$c=m(o),Eo=r(o,"H2",{class:!0});var ym=i(Eo);xn=r(ym,"A",{id:!0,class:!0,href:!0});var Ib=i(xn);pl=r(Ib,"SPAN",{});var Db=i(pl);y(ra.$$.fragment,Db),Db.forEach(t),Ib.forEach(t),ug=m(ym),fl=r(ym,"SPAN",{});var Sb=i(fl);_g=s(Sb,"LongformerForMultipleChoice"),Sb.forEach(t),ym.forEach(t),Lc=m(o),pt=r(o,"DIV",{class:!0});var Ut=i(pt);y(ia.$$.fragment,Ut),wg=m(Ut),gl=r(Ut,"P",{});var Bb=i(gl);kg=s(Bb,`Longformer Model with a multiple choice classification head on top (a linear layer on top of the pooled output and
a softmax) e.g. for RocStories/SWAG tasks.`),Bb.forEach(t),bg=m(Ut),la=r(Ut,"P",{});var Tm=i(la);vg=s(Tm,"This model inherits from "),Cr=r(Tm,"A",{href:!0});var Wb=i(Cr);yg=s(Wb,"PreTrainedModel"),Wb.forEach(t),Tg=s(Tm,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Fm.forEach(t),Gg=m(Ht),_t=r(Ht,"DIV",{class:!0});var Rt=i(_t);y(_a.$$.fragment,Rt),Jg=m(Rt),jo=r(Rt,"P",{});var li=i(jo);Xg=s(li,"The "),Nr=r(li,"A",{href:!0});var Yb=i(Nr);Yg=s(Yb,"LongformerForTokenClassification"),Yb.forEach(t),Zg=s(li," forward method, overrides the "),bl=r(li,"CODE",{});var Zb=i(bl);eu=s(Zb,"__call__"),Zb.forEach(t),tu=s(li," special method."),li.forEach(t),ou=m(Rt),y(zn.$$.fragment,Rt),nu=m(Rt),y(qn.$$.fragment,Rt),su=m(Rt),y(jn.$$.fragment,Rt),Rt.forEach(t),Ht.forEach(t),Mc=m(o),Co=r(o,"H2",{class:!0});var Mm=i(Co);Cn=r(Mm,"A",{id:!0,class:!0,href:!0});var ev=i(Cn);vl=r(ev,"SPAN",{});var tv=i(vl);y(wa.$$.fragment,tv),tv.forEach(t),ev.forEach(t),au=m(Mm),yl=r(Mm,"SPAN",{});var ov=i(yl);ru=s(ov,"LongformerForQuestionAnswering"),ov.forEach(t),Mm.forEach(t),Ec=m(o),gt=r(o,"DIV",{class:!0});var Kt=i(gt);y(ka.$$.fragment,Kt),iu=m(Kt),Oo=r(Kt,"P",{});var di=i(Oo);lu=s(di,`Longformer Model with a span classification head on top for extractive question-answering tasks like SQuAD /
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),zm.forEach(t),vu=m(Kt),xt=r(Kt,"DIV",{class:!0});var ms=i(xt);y(Ta.$$.fragment,ms),yu=m(ms),Po=r(ms,"P",{});var ci=i(Po);Tu=s(ci,"The "),Ir=r(ci,"A",{href:!0});var iv=i(Ir);$u=s(iv,"LongformerForQuestionAnswering"),iv.forEach(t),Lu=s(ci," forward method, overrides the "),Ll=r(ci,"CODE",{});var lv=i(Ll);xu=s(lv,"__call__"),lv.forEach(t),Fu=s(ci," special method."),ci.forEach(t),Mu=m(ms),y(On.$$.fragment,ms),Eu=m(ms),y(Pn.$$.fragment,ms),ms.forEach(t),Kt.forEach(t),zc=m(o),No=r(o,"H2",{class:!0});var qm=i(No);Nn=r(qm,"A",{id:!0,class:!0,href:!0});var dv=i(Nn);xl=r(dv,"SPAN",{});var cv=i(xl);y($a.$$.fragment,cv),cv.forEach(t),dv.forEach(t),zu=m(qm),Fl=r(qm,"SPAN",{});var mv=i(Fl);qu=s(mv,"TFLongformerModel"),mv.forEach(t),qm.forEach(t),qc=m(o),Ke=r(o,"DIV",{class:!0});var dt=i(Ke);y(La.$$.fragment,dt),ju=m(dt),Ml=r(dt,"P",{});var hv=i(Ml);Cu=s(hv,"The bare Longformer Model outputting raw hidden-states without any specific head on top."),hv.forEach(t),Ou=m(dt),xa=r(dt,"P",{});var jm=i(xa);Pu=s(jm,"This model inherits from "),Dr=r(jm,"A",{href:!0});var pv=i(Dr);Nu=s(pv,"TFPreTrainedModel"),pv.forEach(t),Au=s(jm,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),jm.forEach(t),Iu=m(dt),Fa=r(dt,"P",{});var Cm=i(Fa);Du=s(Cm,"This model is also a "),Ma=r(Cm,"A",{href:!0,rel:!0});var fv=i(Ma);Su=s(fv,"tf.keras.Model"),fv.forEach(t),Bu=s(Cm,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Cm.forEach(t),Wu=m(dt),y(An.$$.fragment,dt),Qu=m(dt),Ao=r(dt,"P",{});var mi=i(Ao);Uu=s(mi,"This class copies code from "),Sr=r(mi,"A",{href:!0});var gv=i(Sr);Hu=s(gv,"TFRobertaModel"),gv.forEach(t),Ru=s(mi,` and overwrites standard self-attention with longformer
self-attention to provide the ability to process long sequences following the self-attention approach described in
...
attention are more relevant for autoregressive language modeling than finetuning on downstream tasks. Future
release will add support for autoregressive attention, but the support for dilated attention requires a custom CUDA
kernel to be memory and compute efficient.`),Om.forEach(t),Zu=m(dt),Dt=r(dt,"DIV",{class:!0});var hi=i(Dt);y(qa.$$.fragment,hi),e_=m(hi),Io=r(hi,"P",{});var pi=i(Io);t_=s(pi,"The "),Br=r(pi,"A",{href:!0});var wv=i(Br);o_=s(wv,"TFLongformerModel"),wv.forEach(t),n_=s(pi," forward method, overrides the "),zl=r(pi,"CODE",{});var kv=i(zl);s_=s(kv,"__call__"),kv.forEach(t),a_=s(pi," special method."),pi.forEach(t),r_=m(hi),y(In.$$.fragment,hi),hi.forEach(t),dt.forEach(t),jc=m(o),Do=r(o,"H2",{class:!0});var Pm=i(Do);Dn=r(Pm,"A",{id:!0,class:!0,href:!0});var bv=i(Dn);ql=r(bv,"SPAN",{});var vv=i(ql);y(ja.$$.fragment,vv),vv.forEach(t),bv.forEach(t),i_=m(Pm),jl=r(Pm,"SPAN",{});var yv=i(jl);l_=s(yv,"TFLongformerForMaskedLM"),yv.forEach(t),Pm.forEach(t),Cc=m(o),nt=r(o,"DIV",{class:!0});var Et=i(nt);y(Ca.$$.fragment,Et),d_=m(Et),Oa=r(Et,"P",{});var Nm=i(Oa);c_=s(Nm,"Longformer Model with a "),Cl=r(Nm,"CODE",{});var Tv=i(Cl);m_=s(Tv,"language modeling"),Tv.forEach(t),h_=s(Nm," head on top."),Nm.forEach(t),p_=m(Et),Pa=r(Et,"P",{});var Am=i(Pa);f_=s(Am,"This model inherits from "),Wr=r(Am,"A",{href:!0});var $v=i(Wr);g_=s($v,"TFPreTrainedModel"),$v.forEach(t),u_=s(Am,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
