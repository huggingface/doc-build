import{S as pT,i as fT,s as gT,e as a,k as c,w as v,t as n,Y as Oo,M as uT,c as r,d as t,m,a as i,x as T,h as s,Z as Po,b as _,G as e,g as f,y,q as $,o as L,B as x,v as _T,L as je}from"../../chunks/vendor-hf-doc-builder.js";import{T as Ae}from"../../chunks/Tip-hf-doc-builder.js";import{D as B}from"../../chunks/Docstring-hf-doc-builder.js";import{C as Le}from"../../chunks/CodeBlock-hf-doc-builder.js";import{I as Oe}from"../../chunks/IconCopyLink-hf-doc-builder.js";import{E as Ce}from"../../chunks/ExampleCodeBlock-hf-doc-builder.js";function wT(M){let l,k,h,p,b;return p=new Le({props:{code:`from transformers import LongformerConfig, LongformerModel
...
the latter silently ignores them.`)},l(d){l=r(d,"P",{});var u=i(l);k=s(u,"Although the recipe for forward pass needs to be defined within this function, one should call the "),h=r(u,"CODE",{});var E=i(h);p=s(E,"Module"),E.forEach(t),b=s(u,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),u.forEach(t)},m(d,u){f(d,l,u),e(l,k),e(l,h),e(h,p),e(l,b)},d(d){d&&t(l)}}}function qT(M){let l,k,h,p,b;return p=new Le({props:{code:`from transformers import LongformerTokenizer, LongformerForMultipleChoice
import torch
...
`),R=r(oe,"CODE",{});var Ee=i(R);we=s(Ee,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),Ee.forEach(t),oe.forEach(t),O.forEach(t)},m(w,F){f(w,l,F),e(l,k),f(w,h,F),f(w,p,F),e(p,b),e(b,d),e(p,u),e(p,E),e(E,he),f(w,J,F),f(w,q,F),e(q,Z),e(q,S),e(S,ee),e(q,pe),e(q,D),e(D,fe),e(q,le),f(w,G,F),f(w,P,F),e(P,te),f(w,X,F),f(w,z,F),e(z,j),e(j,ne),e(j,U),e(U,de),e(j,se),e(j,W),e(W,ge),e(z,ce),e(z,C),e(C,ue),e(C,Q),e(Q,ae),e(C,K),e(C,H),e(H,re),e(z,_e),e(z,N),e(N,ie),e(N,R),e(R,we)},d(w){w&&t(l),w&&t(h),w&&t(p),w&&t(J),w&&t(q),w&&t(G),w&&t(P),w&&t(X),w&&t(z)}}}function AT(M){let l,k,h,p,b;return{c(){l=a("p"),k=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),h=a("code"),p=n("Module"),b=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(d){l=r(d,"P",{});var u=i(l);k=s(u,"Although the recipe for forward pass needs to be defined within this function, one should call the "),h=r(u,"CODE",{});var E=i(h);p=s(E,"Module"),E.forEach(t),b=s(u,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
first positional argument :`),Fe.forEach(t),X=m(w),z=r(w,"UL",{});var O=i(z);j=r(O,"LI",{});var V=i(j);ne=s(V,"a single Tensor with "),U=r(V,"CODE",{});var Me=i(U);de=s(Me,"input_ids"),Me.forEach(t),se=s(V," only and nothing else: "),W=r(V,"CODE",{});var ye=i(W);ge=s(ye,"model(inputs_ids)"),ye.forEach(t),V.forEach(t),ce=m(O),C=r(O,"LI",{});var I=i(C);ue=s(I,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),Q=r(I,"CODE",{});var ke=i(Q);ae=s(ke,"model([input_ids, attention_mask])"),ke.forEach(t),K=s(I," or "),H=r(I,"CODE",{});var ve=i(H);re=s(ve,"model([input_ids, attention_mask, token_type_ids])"),ve.forEach(t),I.forEach(t),_e=m(O),N=r(O,"LI",{});var oe=i(N);ie=s(oe,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),R=r(oe,"CODE",{});var Ee=i(R);we=s(Ee,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),Ee.forEach(t),oe.forEach(t),O.forEach(t)},m(w,F){f(w,l,F),e(l,k),f(w,h,F),f(w,p,F),e(p,b),e(b,d),e(p,u),e(p,E),e(E,he),f(w,J,F),f(w,q,F),e(q,Z),e(q,S),e(S,ee),e(q,pe),e(q,D),e(D,fe),e(q,le),f(w,G,F),f(w,P,F),e(P,te),f(w,X,F),f(w,z,F),e(z,j),e(j,ne),e(j,U),e(U,de),e(j,se),e(j,W),e(W,ge),e(z,ce),e(z,C),e(C,ue),e(C,Q),e(Q,ae),e(C,K),e(C,H),e(H,re),e(z,_e),e(z,N),e(N,ie),e(N,R),e(R,we)},d(w){w&&t(l),w&&t(h),w&&t(p),w&&t(J),w&&t(q),w&&t(G),w&&t(P),w&&t(X),w&&t(z)}}}function ST(M){let l,k,h,p,b;return{c(){l=a("p"),k=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),h=a("code"),p=n("Module"),b=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(d){l=r(d,"P",{});var u=i(l);k=s(u,"Although the recipe for forward pass needs to be defined within this function, one should call the "),h=r(u,"CODE",{});var E=i(h);p=s(E,"Module"),E.forEach(t),b=s(u,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
<span class="hljs-number">0.44</span>`}}),{c(){v(l.$$.fragment)},l(h){T(l.$$.fragment,h)},m(h,p){y(l,h,p),k=!0},p:je,i(h){k||($(l.$$.fragment,h),k=!0)},o(h){L(l.$$.fragment,h),k=!1},d(h){x(l,h)}}}function BT(M){let l,k,h,p,b,d,u,E,he,J,q,Z,S,ee,pe,D,fe,le,G,P,te,X,z,j,ne,U,de,se,W,ge,ce,C,ue,Q,ae,K,H,re,_e,N,ie,R,we;return{c(){l=a("p"),k=n("TF 2.0 models accepts two formats as inputs:"),h=c(),p=a("ul"),b=a("li"),d=n("having all inputs as keyword arguments (like PyTorch models), or"),u=c(),E=a("li"),he=n("having all inputs as a list, tuple or dict in the first positional arguments."),J=c(),q=a("p"),Z=n("This second option is useful when using "),S=a("code"),ee=n("tf.keras.Model.fit"),pe=n(` method which currently requires having all the
tensors in the first argument of the model call function: `),D=a("code"),fe=n("model(inputs)"),le=n("."),G=c(),P=a("p"),te=n(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),X=c(),z=a("ul"),j=a("li"),ne=n("a single Tensor with "),U=a("code"),de=n("input_ids"),se=n(" only and nothing else: "),W=a("code"),ge=n("model(inputs_ids)"),ce=c(),C=a("li"),ue=n(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),Q=a("code"),ae=n("model([input_ids, attention_mask])"),K=n(" or "),H=a("code"),re=n("model([input_ids, attention_mask, token_type_ids])"),_e=c(),N=a("li"),ie=n(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),R=a("code"),we=n('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(w){l=r(w,"P",{});var F=i(l);k=s(F,"TF 2.0 models accepts two formats as inputs:"),F.forEach(t),h=m(w),p=r(w,"UL",{});var Y=i(p);b=r(Y,"LI",{});var Te=i(b);d=s(Te,"having all inputs as keyword arguments (like PyTorch models), or"),Te.forEach(t),u=m(Y),E=r(Y,"LI",{});var me=i(E);he=s(me,"having all inputs as a list, tuple or dict in the first positional arguments."),me.forEach(t),Y.forEach(t),J=m(w),q=r(w,"P",{});var A=i(q);Z=s(A,"This second option is useful when using "),S=r(A,"CODE",{});var be=i(S);ee=s(be,"tf.keras.Model.fit"),be.forEach(t),pe=s(A,` method which currently requires having all the
...
first positional argument :`),Fe.forEach(t),X=m(w),z=r(w,"UL",{});var O=i(z);j=r(O,"LI",{});var V=i(j);ne=s(V,"a single Tensor with "),U=r(V,"CODE",{});var Me=i(U);de=s(Me,"input_ids"),Me.forEach(t),se=s(V," only and nothing else: "),W=r(V,"CODE",{});var ye=i(W);ge=s(ye,"model(inputs_ids)"),ye.forEach(t),V.forEach(t),ce=m(O),C=r(O,"LI",{});var I=i(C);ue=s(I,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),Q=r(I,"CODE",{});var ke=i(Q);ae=s(ke,"model([input_ids, attention_mask])"),ke.forEach(t),K=s(I," or "),H=r(I,"CODE",{});var ve=i(H);re=s(ve,"model([input_ids, attention_mask, token_type_ids])"),ve.forEach(t),I.forEach(t),_e=m(O),N=r(O,"LI",{});var oe=i(N);ie=s(oe,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),R=r(oe,"CODE",{});var Ee=i(R);we=s(Ee,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),Ee.forEach(t),oe.forEach(t),O.forEach(t)},m(w,F){f(w,l,F),e(l,k),f(w,h,F),f(w,p,F),e(p,b),e(b,d),e(p,u),e(p,E),e(E,he),f(w,J,F),f(w,q,F),e(q,Z),e(q,S),e(S,ee),e(q,pe),e(q,D),e(D,fe),e(q,le),f(w,G,F),f(w,P,F),e(P,te),f(w,X,F),f(w,z,F),e(z,j),e(j,ne),e(j,U),e(U,de),e(j,se),e(j,W),e(W,ge),e(z,ce),e(z,C),e(C,ue),e(C,Q),e(Q,ae),e(C,K),e(C,H),e(H,re),e(z,_e),e(z,N),e(N,ie),e(N,R),e(R,we)},d(w){w&&t(l),w&&t(h),w&&t(p),w&&t(J),w&&t(q),w&&t(G),w&&t(P),w&&t(X),w&&t(z)}}}function QT(M){let l,k,h,p,b;return{c(){l=a("p"),k=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),h=a("code"),p=n("Module"),b=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(d){l=r(d,"P",{});var u=i(l);k=s(u,"Although the recipe for forward pass needs to be defined within this function, one should call the "),h=r(u,"CODE",{});var E=i(h);p=s(E,"Module"),E.forEach(t),b=s(u,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
first positional argument :`),Fe.forEach(t),X=m(w),z=r(w,"UL",{});var O=i(z);j=r(O,"LI",{});var V=i(j);ne=s(V,"a single Tensor with "),U=r(V,"CODE",{});var Me=i(U);de=s(Me,"input_ids"),Me.forEach(t),se=s(V," only and nothing else: "),W=r(V,"CODE",{});var ye=i(W);ge=s(ye,"model(inputs_ids)"),ye.forEach(t),V.forEach(t),ce=m(O),C=r(O,"LI",{});var I=i(C);ue=s(I,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),Q=r(I,"CODE",{});var ke=i(Q);ae=s(ke,"model([input_ids, attention_mask])"),ke.forEach(t),K=s(I," or "),H=r(I,"CODE",{});var ve=i(H);re=s(ve,"model([input_ids, attention_mask, token_type_ids])"),ve.forEach(t),I.forEach(t),_e=m(O),N=r(O,"LI",{});var oe=i(N);ie=s(oe,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),R=r(oe,"CODE",{});var Ee=i(R);we=s(Ee,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),Ee.forEach(t),oe.forEach(t),O.forEach(t)},m(w,F){f(w,l,F),e(l,k),f(w,h,F),f(w,p,F),e(p,b),e(b,d),e(p,u),e(p,E),e(E,he),f(w,J,F),f(w,q,F),e(q,Z),e(q,S),e(S,ee),e(q,pe),e(q,D),e(D,fe),e(q,le),f(w,G,F),f(w,P,F),e(P,te),f(w,X,F),f(w,z,F),e(z,j),e(j,ne),e(j,U),e(U,de),e(j,se),e(j,W),e(W,ge),e(z,ce),e(z,C),e(C,ue),e(C,Q),e(Q,ae),e(C,K),e(C,H),e(H,re),e(z,_e),e(z,N),e(N,ie),e(N,R),e(R,we)},d(w){w&&t(l),w&&t(h),w&&t(p),w&&t(J),w&&t(q),w&&t(G),w&&t(P),w&&t(X),w&&t(z)}}}function VT(M){let l,k,h,p,b;return{c(){l=a("p"),k=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),h=a("code"),p=n("Module"),b=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(d){l=r(d,"P",{});var u=i(l);k=s(u,"Although the recipe for forward pass needs to be defined within this function, one should call the "),h=r(u,"CODE",{});var E=i(h);p=s(E,"Module"),E.forEach(t),b=s(u,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
first positional argument :`),Fe.forEach(t),X=m(w),z=r(w,"UL",{});var O=i(z);j=r(O,"LI",{});var V=i(j);ne=s(V,"a single Tensor with "),U=r(V,"CODE",{});var Me=i(U);de=s(Me,"input_ids"),Me.forEach(t),se=s(V," only and nothing else: "),W=r(V,"CODE",{});var ye=i(W);ge=s(ye,"model(inputs_ids)"),ye.forEach(t),V.forEach(t),ce=m(O),C=r(O,"LI",{});var I=i(C);ue=s(I,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),Q=r(I,"CODE",{});var ke=i(Q);ae=s(ke,"model([input_ids, attention_mask])"),ke.forEach(t),K=s(I," or "),H=r(I,"CODE",{});var ve=i(H);re=s(ve,"model([input_ids, attention_mask, token_type_ids])"),ve.forEach(t),I.forEach(t),_e=m(O),N=r(O,"LI",{});var oe=i(N);ie=s(oe,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),R=r(oe,"CODE",{});var Ee=i(R);we=s(Ee,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),Ee.forEach(t),oe.forEach(t),O.forEach(t)},m(w,F){f(w,l,F),e(l,k),f(w,h,F),f(w,p,F),e(p,b),e(b,d),e(p,u),e(p,E),e(E,he),f(w,J,F),f(w,q,F),e(q,Z),e(q,S),e(S,ee),e(q,pe),e(q,D),e(D,fe),e(q,le),f(w,G,F),f(w,P,F),e(P,te),f(w,X,F),f(w,z,F),e(z,j),e(j,ne),e(j,U),e(U,de),e(j,se),e(j,W),e(W,ge),e(z,ce),e(z,C),e(C,ue),e(C,Q),e(Q,ae),e(C,K),e(C,H),e(H,re),e(z,_e),e(z,N),e(N,ie),e(N,R),e(R,we)},d(w){w&&t(l),w&&t(h),w&&t(p),w&&t(J),w&&t(q),w&&t(G),w&&t(P),w&&t(X),w&&t(z)}}}function XT(M){let l,k,h,p,b;return{c(){l=a("p"),k=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),h=a("code"),p=n("Module"),b=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(d){l=r(d,"P",{});var u=i(l);k=s(u,"Although the recipe for forward pass needs to be defined within this function, one should call the "),h=r(u,"CODE",{});var E=i(h);p=s(E,"Module"),E.forEach(t),b=s(u,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
first positional argument :`),Fe.forEach(t),X=m(w),z=r(w,"UL",{});var O=i(z);j=r(O,"LI",{});var V=i(j);ne=s(V,"a single Tensor with "),U=r(V,"CODE",{});var Me=i(U);de=s(Me,"input_ids"),Me.forEach(t),se=s(V," only and nothing else: "),W=r(V,"CODE",{});var ye=i(W);ge=s(ye,"model(inputs_ids)"),ye.forEach(t),V.forEach(t),ce=m(O),C=r(O,"LI",{});var I=i(C);ue=s(I,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),Q=r(I,"CODE",{});var ke=i(Q);ae=s(ke,"model([input_ids, attention_mask])"),ke.forEach(t),K=s(I," or "),H=r(I,"CODE",{});var ve=i(H);re=s(ve,"model([input_ids, attention_mask, token_type_ids])"),ve.forEach(t),I.forEach(t),_e=m(O),N=r(O,"LI",{});var oe=i(N);ie=s(oe,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),R=r(oe,"CODE",{});var Ee=i(R);we=s(Ee,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),Ee.forEach(t),oe.forEach(t),O.forEach(t)},m(w,F){f(w,l,F),e(l,k),f(w,h,F),f(w,p,F),e(p,b),e(b,d),e(p,u),e(p,E),e(E,he),f(w,J,F),f(w,q,F),e(q,Z),e(q,S),e(S,ee),e(q,pe),e(q,D),e(D,fe),e(q,le),f(w,G,F),f(w,P,F),e(P,te),f(w,X,F),f(w,z,F),e(z,j),e(j,ne),e(j,U),e(U,de),e(j,se),e(j,W),e(W,ge),e(z,ce),e(z,C),e(C,ue),e(C,Q),e(Q,ae),e(C,K),e(C,H),e(H,re),e(z,_e),e(z,N),e(N,ie),e(N,R),e(R,we)},d(w){w&&t(l),w&&t(h),w&&t(p),w&&t(J),w&&t(q),w&&t(G),w&&t(P),w&&t(X),w&&t(z)}}}function ty(M){let l,k,h,p,b;return{c(){l=a("p"),k=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),h=a("code"),p=n("Module"),b=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(d){l=r(d,"P",{});var u=i(l);k=s(u,"Although the recipe for forward pass needs to be defined within this function, one should call the "),h=r(u,"CODE",{});var E=i(h);p=s(E,"Module"),E.forEach(t),b=s(u,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
Used to hide legacy arguments that have been deprecated.`,name:"kwargs"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/longformer/modeling_longformer.py#L1759",returnDescription:`
<p>A <a
...
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/longformer/modeling_longformer.py#L1868",returnDescription:`
<p>A <a
...
<code>input_ids</code> above)`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/longformer/modeling_longformer.py#L2223",returnDescription:`
<p>A <a
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/longformer/modeling_longformer.py#L2137",returnDescription:`
<p>A <a
...
`}}),mn=new Ae({props:{$$slots:{default:[zT]},$$scope:{ctx:M}}}),hn=new Ce({props:{anchor:"transformers.LongformerForTokenClassification.forward.example",$$slots:{default:[CT]},$$scope:{ctx:M}}}),pn=new Ce({props:{anchor:"transformers.LongformerForTokenClassification.forward.example-2",$$slots:{default:[jT]},$$scope:{ctx:M}}}),Zs=new Oe({}),ea=new B({props:{name:"class transformers.LongformerForQuestionAnswering",anchor:"transformers.LongformerForQuestionAnswering",parameters:[{name:"config",val:""}],parametersDescription:[{anchor:"transformers.LongformerForQuestionAnswering.config",description:`<strong>config</strong> (<a href="/docs/transformers/main/en/model_doc/longformer#transformers.LongformerConfig">LongformerConfig</a>) &#x2014; Model configuration class with all the parameters of the
model. Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/main/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/longformer/modeling_longformer.py#L1982"}}),sa=new B({props:{name:"forward",anchor:"transformers.LongformerForQuestionAnswering.forward",parameters:[{name:"input_ids",val:": typing.Optional[torch.Tensor] = None"},{name:"attention_mask",val:": typing.Optional[torch.Tensor] = None"},{name:"global_attention_mask",val:": typing.Optional[torch.Tensor] = None"},{name:"head_mask",val:": typing.Optional[torch.Tensor] = None"},{name:"token_type_ids",val:": typing.Optional[torch.Tensor] = None"},{name:"position_ids",val:": typing.Optional[torch.Tensor] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.Tensor] = None"},{name:"start_positions",val:": typing.Optional[torch.Tensor] = None"},{name:"end_positions",val:": typing.Optional[torch.Tensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.LongformerForQuestionAnswering.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/main/en/model_doc/longformer#transformers.LongformerTokenizer">LongformerTokenizer</a>. See <a href="/docs/transformers/main/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/main/en/model_doc/wav2vec2#transformers.Wav2Vec2CTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/longformer/modeling_longformer.py#L1996",returnDescription:`
<p>A <a
...
`}}),gn=new Ae({props:{$$slots:{default:[OT]},$$scope:{ctx:M}}}),un=new Ce({props:{anchor:"transformers.LongformerForQuestionAnswering.forward.example",$$slots:{default:[PT]},$$scope:{ctx:M}}}),aa=new Oe({}),ra=new B({props:{name:"class transformers.TFLongformerModel",anchor:"transformers.TFLongformerModel",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.TFLongformerModel.config",description:`<strong>config</strong> (<a href="/docs/transformers/main/en/model_doc/longformer#transformers.LongformerConfig">LongformerConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/main/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/longformer/modeling_tf_longformer.py#L2011"}}),wn=new Ae({props:{$$slots:{default:[NT]},$$scope:{ctx:M}}}),ha=new B({props:{name:"call",anchor:"transformers.TFLongformerModel.call",parameters:[{name:"input_ids",val:": typing.Union[typing.List[tensorflow.python.framework.ops.Tensor], typing.List[numpy.ndarray], typing.List[tensorflow.python.keras.engine.keras_tensor.KerasTensor], typing.Dict[str, tensorflow.python.framework.ops.Tensor], typing.Dict[str, numpy.ndarray], typing.Dict[str, tensorflow.python.keras.engine.keras_tensor.KerasTensor], tensorflow.python.framework.ops.Tensor, numpy.ndarray, tensorflow.python.keras.engine.keras_tensor.KerasTensor, NoneType] = None"},{name:"attention_mask",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"head_mask",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"global_attention_mask",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"token_type_ids",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"position_ids",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"inputs_embeds",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"training",val:": typing.Optional[bool] = False"}],parametersDescription:[{anchor:"transformers.TFLongformerModel.call.input_ids",description:`<strong>input_ids</strong> (<code>np.ndarray</code> or <code>tf.Tensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/main/en/model_doc/longformer#transformers.LongformerTokenizer">LongformerTokenizer</a>. See <a href="/docs/transformers/main/en/model_doc/wav2vec2#transformers.Wav2Vec2CTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
...
`}}),Cn=new Ae({props:{$$slots:{default:[VT]},$$scope:{ctx:M}}}),jn=new Ce({props:{anchor:"transformers.TFLongformerForSequenceClassification.call.example",$$slots:{default:[GT]},$$scope:{ctx:M}}}),On=new Ce({props:{anchor:"transformers.TFLongformerForSequenceClassification.call.example-2",$$slots:{default:[KT]},$$scope:{ctx:M}}}),Ca=new Oe({}),ja=new B({props:{name:"class transformers.TFLongformerForTokenClassification",anchor:"transformers.TFLongformerForTokenClassification",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.TFLongformerForTokenClassification.config",description:`<strong>config</strong> (<a href="/docs/transformers/main/en/model_doc/longformer#transformers.LongformerConfig">LongformerConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/main/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/longformer/modeling_tf_longformer.py#L2572"}}),Nn=new Ae({props:{$$slots:{default:[JT]},$$scope:{ctx:M}}}),Aa=new B({props:{name:"call",anchor:"transformers.TFLongformerForTokenClassification.call",parameters:[{name:"input_ids",val:": typing.Union[typing.List[tensorflow.python.framework.ops.Tensor], typing.List[numpy.ndarray], typing.List[tensorflow.python.keras.engine.keras_tensor.KerasTensor], typing.Dict[str, tensorflow.python.framework.ops.Tensor], typing.Dict[str, numpy.ndarray], typing.Dict[str, tensorflow.python.keras.engine.keras_tensor.KerasTensor], tensorflow.python.framework.ops.Tensor, numpy.ndarray, tensorflow.python.keras.engine.keras_tensor.KerasTensor, NoneType] = None"},{name:"attention_mask",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"head_mask",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"token_type_ids",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"position_ids",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"global_attention_mask",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"inputs_embeds",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"labels",val:": typing.Union[<built-in function array>, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"training",val:": typing.Optional[bool] = False"}],parametersDescription:[{anchor:"transformers.TFLongformerForTokenClassification.call.input_ids",description:`<strong>input_ids</strong> (<code>np.ndarray</code> or <code>tf.Tensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/main/en/model_doc/longformer#transformers.LongformerTokenizer">LongformerTokenizer</a>. See <a href="/docs/transformers/main/en/model_doc/wav2vec2#transformers.Wav2Vec2CTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
<a href="/docs/transformers/main/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> for details.</p>
...
`}}),Bn=new Ae({props:{$$slots:{default:[ty]},$$scope:{ctx:M}}}),Qn=new Ce({props:{anchor:"transformers.TFLongformerForMultipleChoice.call.example",$$slots:{default:[oy]},$$scope:{ctx:M}}}),{c(){l=a("meta"),k=c(),h=a("h1"),p=a("a"),b=a("span"),v(d.$$.fragment),u=c(),E=a("span"),he=n("Longformer"),J=c(),q=a("h2"),Z=a("a"),S=a("span"),v(ee.$$.fragment),pe=c(),D=a("span"),fe=n("Overview"),le=c(),G=a("p"),P=n("The Longformer model was presented in "),te=a("a"),X=n("Longformer: The Long-Document Transformer"),z=n(" by Iz Beltagy, Matthew E. Peters, Arman Cohan."),j=c(),ne=a("p"),U=n("The abstract from the paper is the following:"),de=c(),se=a("p"),W=a("em"),ge=n(`Transformer-based models are unable to process long sequences due to their self-attention operation, which scales
...
WikiHop and TriviaQA.`),ce=c(),C=a("p"),ue=n("Tips:"),Q=c(),ae=a("ul"),K=a("li"),H=n("Since the Longformer is based on RoBERTa, it doesn\u2019t have "),re=a("code"),_e=n("token_type_ids"),N=n(`. You don\u2019t need to indicate which
...
`),w=a("code"),F=n("</s>"),Y=n(")."),Te=c(),me=a("p"),A=n("This model was contributed by "),be=a("a"),xe=n("beltagy"),Fe=n(". The Authors\u2019 code can be found "),O=a("a"),V=n("here"),Me=n("."),ye=c(),I=a("h2"),ke=a("a"),ve=a("span"),v(oe.$$.fragment),Ee=c(),ti=a("span"),Bm=n("Longformer Self Attention"),fd=c(),$e=a("p"),Qm=n(`Longformer self attention employs self attention on both a \u201Clocal\u201D context and a \u201Cglobal\u201D context. Most tokens only
...
trained and should be used as follows:`),Wd=c(),v(Jn.$$.fragment),Bd=c(),Pt=a("h2"),Do=a("a"),pi=a("span"),v(Xn.$$.fragment),Th=c(),fi=a("span"),yh=n("LongformerConfig"),Qd=c(),He=a("div"),v(Yn.$$.fragment),$h=c(),Nt=a("p"),Lh=n("This is the configuration class to store the configuration of a "),Ya=a("a"),xh=n("LongformerModel"),Fh=n(" or a "),Za=a("a"),Mh=n("TFLongformerModel"),Eh=n(`. It
is used to instantiate a Longformer model according to the specified arguments, defining the model architecture.`),qh=c(),At=a("p"),zh=n("This is the configuration class to store the configuration of a "),er=a("a"),Ch=n("LongformerModel"),jh=n(`. It is used to instantiate an
...
parent class for more information.`),Bh=c(),v(Wo.$$.fragment),Ud=c(),St=a("h2"),Bo=a("a"),gi=a("span"),v(es.$$.fragment),Qh=c(),ui=a("span"),Uh=n("LongformerTokenizer"),Hd=c(),gt=a("div"),v(ts.$$.fragment),Hh=c(),_i=a("p"),Rh=n("Construct a Longformer tokenizer."),Vh=c(),Qo=a("p"),nr=a("a"),Gh=n("LongformerTokenizer"),Kh=n(" is identical to "),sr=a("a"),Jh=n("RobertaTokenizer"),Xh=n(`. Refer to the superclass for usage examples and
...
and documentation concerning parameters.`),Gd=c(),Wt=a("h2"),Ro=a("a"),vi=a("span"),v(as.$$.fragment),dp=c(),Ti=a("span"),cp=n("Longformer specific outputs"),Kd=c(),Bt=a("div"),v(rs.$$.fragment),mp=c(),yi=a("p"),hp=n("Base class for Longformer\u2019s outputs, with potential hidden states, local and global attentions."),Jd=c(),Qt=a("div"),v(is.$$.fragment),pp=c(),$i=a("p"),fp=n("Base class for Longformer\u2019s outputs that also contains a pooling of the last hidden states."),Xd=c(),Ut=a("div"),v(ls.$$.fragment),gp=c(),Li=a("p"),up=n("Base class for masked language models outputs."),Yd=c(),Ht=a("div"),v(ds.$$.fragment),_p=c(),xi=a("p"),wp=n("Base class for outputs of question answering Longformer models."),Zd=c(),Rt=a("div"),v(cs.$$.fragment),kp=c(),Fi=a("p"),bp=n("Base class for outputs of sentence classification models."),ec=c(),Vt=a("div"),v(ms.$$.fragment),vp=c(),Mi=a("p"),Tp=n("Base class for outputs of multiple choice Longformer models."),tc=c(),Gt=a("div"),v(hs.$$.fragment),yp=c(),Ei=a("p"),$p=n("Base class for outputs of token classification models."),oc=c(),Kt=a("div"),v(ps.$$.fragment),Lp=c(),qi=a("p"),xp=n("Base class for Longformer\u2019s outputs, with potential hidden states, local and global attentions."),nc=c(),Jt=a("div"),v(fs.$$.fragment),Fp=c(),zi=a("p"),Mp=n("Base class for Longformer\u2019s outputs that also contains a pooling of the last hidden states."),sc=c(),Xt=a("div"),v(gs.$$.fragment),Ep=c(),Ci=a("p"),qp=n("Base class for masked language models outputs."),ac=c(),Yt=a("div"),v(us.$$.fragment),zp=c(),ji=a("p"),Cp=n("Base class for outputs of question answering Longformer models."),rc=c(),Zt=a("div"),v(_s.$$.fragment),jp=c(),Oi=a("p"),Op=n("Base class for outputs of sentence classification models."),ic=c(),eo=a("div"),v(ws.$$.fragment),Pp=c(),Pi=a("p"),Np=n("Base class for outputs of multiple choice models."),lc=c(),to=a("div"),v(ks.$$.fragment),Ap=c(),Ni=a("p"),Ip=n("Base class for outputs of token classification models."),dc=c(),oo=a("h2"),Vo=a("a"),Ai=a("span"),v(bs.$$.fragment),Sp=c(),Ii=a("span"),Dp=n("LongformerModel"),cc=c(),Pe=a("div"),v(vs.$$.fragment),Wp=c(),Si=a("p"),Bp=n("The bare Longformer Model outputting raw hidden-states without any specific head on top."),Qp=c(),Ts=a("p"),Up=n("This model inherits from "),ir=a("a"),Hp=n("PreTrainedModel"),Rp=n(`. Check the superclass documentation for the generic methods the
...
kernel to be memory and compute efficient.`),lf=c(),at=a("div"),v(Fs.$$.fragment),df=c(),so=a("p"),cf=n("The "),dr=a("a"),mf=n("LongformerModel"),hf=n(" forward method, overrides the "),Wi=a("code"),pf=n("__call__"),ff=n(" special method."),gf=c(),v(Go.$$.fragment),uf=c(),v(Ko.$$.fragment),mc=c(),ao=a("h2"),Jo=a("a"),Bi=a("span"),v(Ms.$$.fragment),_f=c(),Qi=a("span"),wf=n("LongformerForMaskedLM"),hc=c(),Re=a("div"),v(Es.$$.fragment),kf=c(),qs=a("p"),bf=n("Longformer Model with a "),Ui=a("code"),vf=n("language modeling"),Tf=n(" head on top."),yf=c(),zs=a("p"),$f=n("This model inherits from "),cr=a("a"),Lf=n("PreTrainedModel"),xf=n(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Ff=c(),Cs=a("p"),Mf=n("This model is also a PyTorch "),js=a("a"),Ef=n("torch.nn.Module"),qf=n(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),zf=c(),Qe=a("div"),v(Os.$$.fragment),Cf=c(),ro=a("p"),jf=n("The "),mr=a("a"),Of=n("LongformerForMaskedLM"),Pf=n(" forward method, overrides the "),Hi=a("code"),Nf=n("__call__"),Af=n(" special method."),If=c(),v(Xo.$$.fragment),Sf=c(),v(Yo.$$.fragment),Df=c(),Ri=a("p"),Wf=n("Let\u2019s try a very long input."),Bf=c(),v(Zo.$$.fragment),pc=c(),io=a("h2"),en=a("a"),Vi=a("span"),v(Ps.$$.fragment),Qf=c(),Gi=a("span"),Uf=n("LongformerForSequenceClassification"),fc=c(),Ve=a("div"),v(Ns.$$.fragment),Hf=c(),Ki=a("p"),Rf=n(`Longformer Model transformer with a sequence classification/regression head on top (a linear layer on top of the
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),tg=c(),Ne=a("div"),v(Ds.$$.fragment),og=c(),lo=a("p"),ng=n("The "),pr=a("a"),sg=n("LongformerForSequenceClassification"),ag=n(" forward method, overrides the "),Ji=a("code"),rg=n("__call__"),ig=n(" special method."),lg=c(),v(tn.$$.fragment),dg=c(),v(on.$$.fragment),cg=c(),v(nn.$$.fragment),mg=c(),v(sn.$$.fragment),hg=c(),v(an.$$.fragment),gc=c(),co=a("h2"),rn=a("a"),Xi=a("span"),v(Ws.$$.fragment),pg=c(),Yi=a("span"),fg=n("LongformerForMultipleChoice"),uc=c(),Ge=a("div"),v(Bs.$$.fragment),gg=c(),Zi=a("p"),ug=n(`Longformer Model with a multiple choice classification head on top (a linear layer on top of the pooled output and
a softmax) e.g. for RocStories/SWAG tasks.`),_g=c(),Qs=a("p"),wg=n("This model inherits from "),fr=a("a"),kg=n("PreTrainedModel"),bg=n(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),vg=c(),Us=a("p"),Tg=n("This model is also a PyTorch "),Hs=a("a"),yg=n("torch.nn.Module"),$g=n(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Lg=c(),rt=a("div"),v(Rs.$$.fragment),xg=c(),mo=a("p"),Fg=n("The "),gr=a("a"),Mg=n("LongformerForMultipleChoice"),Eg=n(" forward method, overrides the "),el=a("code"),qg=n("__call__"),zg=n(" special method."),Cg=c(),v(ln.$$.fragment),jg=c(),v(dn.$$.fragment),_c=c(),ho=a("h2"),cn=a("a"),tl=a("span"),v(Vs.$$.fragment),Og=c(),ol=a("span"),Pg=n("LongformerForTokenClassification"),wc=c(),Ke=a("div"),v(Gs.$$.fragment),Ng=c(),nl=a("p"),Ag=n(`Longformer Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g.
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Bg=c(),Js=a("p"),Qg=n("This model is also a PyTorch "),Xs=a("a"),Ug=n("torch.nn.Module"),Hg=n(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),wu=c(),it=a("div"),v(sa.$$.fragment),ku=c(),uo=a("p"),bu=n("The "),kr=a("a"),vu=n("LongformerForQuestionAnswering"),Tu=n(" forward method, overrides the "),dl=a("code"),yu=n("__call__"),$u=n(" special method."),Lu=c(),v(gn.$$.fragment),xu=c(),v(un.$$.fragment),vc=c(),_o=a("h2"),_n=a("a"),cl=a("span"),v(aa.$$.fragment),Fu=c(),ml=a("span"),Mu=n("TFLongformerModel"),Tc=c(),qe=a("div"),v(ra.$$.fragment),Eu=c(),hl=a("p"),qu=n("The bare Longformer Model outputting raw hidden-states without any specific head on top."),zu=c(),ia=a("p"),Cu=n("This model inherits from "),br=a("a"),ju=n("TFPreTrainedModel"),Ou=n(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Pu=c(),la=a("p"),Nu=n("This model is also a "),da=a("a"),Au=n("tf.keras.Model"),Iu=n(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Su=c(),v(wn.$$.fragment),Du=c(),wo=a("p"),Wu=n("This class copies code from "),vr=a("a"),Bu=n("TFRobertaModel"),Qu=n(` and overwrites standard self-attention with longformer
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),w_=c(),v(vn.$$.fragment),k_=c(),Ze=a("div"),v(ka.$$.fragment),b_=c(),vo=a("p"),v_=n("The "),$r=a("a"),T_=n("TFLongformerForMaskedLM"),y_=n(" forward method, overrides the "),wl=a("code"),$_=n("__call__"),L_=n(" special method."),x_=c(),v(Tn.$$.fragment),F_=c(),v(yn.$$.fragment),M_=c(),v($n.$$.fragment),Lc=c(),To=a("h2"),Ln=a("a"),kl=a("span"),v(ba.$$.fragment),E_=c(),bl=a("span"),q_=n("TFLongformerForQuestionAnswering"),xc=c(),Se=a("div"),v(va.$$.fragment),z_=c(),yo=a("p"),C_=n(`Longformer Model with a span classification head on top for extractive question-answering tasks like SQuAD /
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),W_=c(),ya=a("p"),B_=n("This model is also a "),$a=a("a"),Q_=n("tf.keras.Model"),U_=n(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),H_=c(),v(xn.$$.fragment),R_=c(),et=a("div"),v(La.$$.fragment),V_=c(),$o=a("p"),G_=n("The "),xr=a("a"),K_=n("TFLongformerForQuestionAnswering"),J_=n(" forward method, overrides the "),yl=a("code"),X_=n("__call__"),Y_=n(" special method."),Z_=c(),v(Fn.$$.fragment),ew=c(),v(Mn.$$.fragment),tw=c(),v(En.$$.fragment),Fc=c(),Lo=a("h2"),qn=a("a"),$l=a("span"),v(xa.$$.fragment),ow=c(),Ll=a("span"),nw=n("TFLongformerForSequenceClassification"),Mc=c(),De=a("div"),v(Fa.$$.fragment),sw=c(),xl=a("p"),aw=n(`Longformer Model transformer with a sequence classification/regression head on top (a linear layer on top of the
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),fw=c(),v(zn.$$.fragment),gw=c(),tt=a("div"),v(za.$$.fragment),uw=c(),xo=a("p"),_w=n("The "),Mr=a("a"),ww=n("TFLongformerForSequenceClassification"),kw=n(" forward method, overrides the "),Fl=a("code"),bw=n("__call__"),vw=n(" special method."),Tw=c(),v(Cn.$$.fragment),yw=c(),v(jn.$$.fragment),$w=c(),v(On.$$.fragment),Ec=c(),Fo=a("h2"),Pn=a("a"),Ml=a("span"),v(Ca.$$.fragment),Lw=c(),El=a("span"),xw=n("TFLongformerForTokenClassification"),qc=c(),We=a("div"),v(ja.$$.fragment),Fw=c(),ql=a("p"),Mw=n(`Longformer Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g.
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Aw=c(),v(Nn.$$.fragment),Iw=c(),ot=a("div"),v(Aa.$$.fragment),Sw=c(),Mo=a("p"),Dw=n("The "),qr=a("a"),Ww=n("TFLongformerForTokenClassification"),Bw=n(" forward method, overrides the "),zl=a("code"),Qw=n("__call__"),Uw=n(" special method."),Hw=c(),v(An.$$.fragment),Rw=c(),v(In.$$.fragment),Vw=c(),v(Sn.$$.fragment),zc=c(),Eo=a("h2"),Dn=a("a"),Cl=a("span"),v(Ia.$$.fragment),Gw=c(),jl=a("span"),Kw=n("TFLongformerForMultipleChoice"),Cc=c(),Be=a("div"),v(Sa.$$.fragment),Jw=c(),Ol=a("p"),Xw=n(`Longformer Model with a multiple choice classification head on top (a linear layer on top of the pooled output and
a softmax) e.g. for RocStories/SWAG tasks.`),Yw=c(),Da=a("p"),Zw=n("This model inherits from "),zr=a("a"),ek=n("TFPreTrainedModel"),tk=n(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),ok=c(),Wa=a("p"),nk=n("This model is also a "),Ba=a("a"),sk=n("tf.keras.Model"),ak=n(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),rk=c(),v(Wn.$$.fragment),ik=c(),lt=a("div"),v(Qa.$$.fragment),lk=c(),qo=a("p"),dk=n("The "),Cr=a("a"),ck=n("TFLongformerForMultipleChoice"),mk=n(" forward method, overrides the "),Pl=a("code"),hk=n("__call__"),pk=n(" special method."),fk=c(),v(Bn.$$.fragment),gk=c(),v(Qn.$$.fragment),this.h()},l(o){const g=uT('[data-svelte="svelte-1phssyn"]',document.head);l=r(g,"META",{name:!0,content:!0}),g.forEach(t),k=m(o),h=r(o,"H1",{class:!0});var Ua=i(h);p=r(Ua,"A",{id:!0,class:!0,href:!0});var Nl=i(p);b=r(Nl,"SPAN",{});var Al=i(b);T(d.$$.fragment,Al),Al.forEach(t),Nl.forEach(t),u=m(Ua),E=r(Ua,"SPAN",{});var Il=i(E);he=s(Il,"Longformer"),Il.forEach(t),Ua.forEach(t),J=m(o),q=r(o,"H2",{class:!0});var Ha=i(q);Z=r(Ha,"A",{id:!0,class:!0,href:!0});var Sl=i(Z);S=r(Sl,"SPAN",{});var Dl=i(S);T(ee.$$.fragment,Dl),Dl.forEach(t),Sl.forEach(t),pe=m(Ha),D=r(Ha,"SPAN",{});var Wl=i(D);fe=s(Wl,"Overview"),Wl.forEach(t),Ha.forEach(t),le=m(o),G=r(o,"P",{});var Ra=i(G);P=s(Ra,"The Longformer model was presented in "),te=r(Ra,"A",{href:!0,rel:!0});var Bl=i(te);X=s(Bl,"Longformer: The Long-Document Transformer"),Bl.forEach(t),z=s(Ra," by Iz Beltagy, Matthew E. Peters, Arman Cohan."),Ra.forEach(t),j=m(o),ne=r(o,"P",{});var Ql=i(ne);U=s(Ql,"The abstract from the paper is the following:"),Ql.forEach(t),de=m(o),se=r(o,"P",{});var Ul=i(se);W=r(Ul,"EM",{});var Hl=i(W);ge=s(Hl,`Transformer-based models are unable to process long sequences due to their self-attention operation, which scales
quadratically with the sequence length. To address this limitation, we introduce the Longformer with an attention
mechanism that scales linearly with sequence length, making it easy to process documents of thousands of tokens or
longer. Longformer\u2019s attention mechanism is a drop-in replacement for the standard self-attention and combines a local
windowed attention with a task motivated global attention. Following prior work on long-sequence transformers, we
...
`),w=r(_t,"CODE",{});var Jl=i(w);F=s(Jl,"</s>"),Jl.forEach(t),Y=s(_t,")."),_t.forEach(t),Vl.forEach(t),Te=m(o),me=r(o,"P",{});var zo=i(me);A=s(zo,"This model was contributed by "),be=r(zo,"A",{href:!0,rel:!0});var Xl=i(be);xe=s(Xl,"beltagy"),Xl.forEach(t),Fe=s(zo,". The Authors\u2019 code can be found "),O=r(zo,"A",{href:!0,rel:!0});var Yl=i(O);V=s(Yl,"here"),Yl.forEach(t),Me=s(zo,"."),zo.forEach(t),ye=m(o),I=r(o,"H2",{class:!0});var Va=i(I);ke=r(Va,"A",{id:!0,class:!0,href:!0});var Zl=i(ke);ve=r(Zl,"SPAN",{});var ed=i(ve);T(oe.$$.fragment,ed),ed.forEach(t),Zl.forEach(t),Ee=m(Va),ti=r(Va,"SPAN",{});var td=i(ti);Bm=s(td,"Longformer Self Attention"),td.forEach(t),Va.forEach(t),fd=m(o),$e=r(o,"P",{});var ze=i($e);Qm=s(ze,`Longformer self attention employs self attention on both a \u201Clocal\u201D context and a \u201Cglobal\u201D context. Most tokens only
...
`),oi=r(ze,"CODE",{});var od=i(oi);Um=s(od,"config.attention_window"),od.forEach(t),Hm=s(ze,". Note that "),ni=r(ze,"CODE",{});var nd=i(ni);Rm=s(nd,"config.attention_window"),nd.forEach(t),Vm=s(ze," can be of type "),si=r(ze,"CODE",{});var sd=i(si);Gm=s(sd,"List"),sd.forEach(t),Km=s(ze,` to define a
different `),vd=Po(ze),Td=s(ze,` for each layer. A selected few tokens attend \u201Cglobally\u201D to all other tokens, as it is
conventionally done for all tokens in `),ai=r(ze,"CODE",{});var ad=i(ai);Jm=s(ad,"BertSelfAttention"),ad.forEach(t),Xm=s(ze,"."),ze.forEach(t),yd=m(o),wt=r(o,"P",{});var Co=i(wt);Ym=s(Co,`Note that \u201Clocally\u201D and \u201Cglobally\u201D attending tokens are projected by different query, key and value matrices. Also note
...
trained and should be used as follows:`),md.forEach(t),Wd=m(o),T(Jn.$$.fragment,o),Bd=m(o),Pt=r(o,"H2",{class:!0});var Ac=i(Pt);Do=r(Ac,"A",{id:!0,class:!0,href:!0});var yk=i(Do);pi=r(yk,"SPAN",{});var $k=i(pi);T(Xn.$$.fragment,$k),$k.forEach(t),yk.forEach(t),Th=m(Ac),fi=r(Ac,"SPAN",{});var Lk=i(fi);yh=s(Lk,"LongformerConfig"),Lk.forEach(t),Ac.forEach(t),Qd=m(o),He=r(o,"DIV",{class:!0});var Tt=i(He);T(Yn.$$.fragment,Tt),$h=m(Tt),Nt=r(Tt,"P",{});var jr=i(Nt);Lh=s(jr,"This is the configuration class to store the configuration of a "),Ya=r(jr,"A",{href:!0});var xk=i(Ya);xh=s(xk,"LongformerModel"),xk.forEach(t),Fh=s(jr," or a "),Za=r(jr,"A",{href:!0});var Fk=i(Za);Mh=s(Fk,"TFLongformerModel"),Fk.forEach(t),Eh=s(jr,`. It
is used to instantiate a Longformer model according to the specified arguments, defining the model architecture.`),jr.forEach(t),qh=m(Tt),At=r(Tt,"P",{});var Or=i(At);zh=s(Or,"This is the configuration class to store the configuration of a "),er=r(Or,"A",{href:!0});var Mk=i(er);Ch=s(Mk,"LongformerModel"),Mk.forEach(t),jh=s(Or,`. It is used to instantiate an
Longformer model according to the specified arguments, defining the model architecture. Instantiating a
configuration with the defaults will yield a similar configuration to that of the LongFormer
...
length 4,096.`),Or.forEach(t),Nh=m(Tt),It=r(Tt,"P",{});var Pr=i(It);Ah=s(Pr,"The "),tr=r(Pr,"A",{href:!0});var qk=i(tr);Ih=s(qk,"LongformerConfig"),qk.forEach(t),Sh=s(Pr," class directly inherits "),or=r(Pr,"A",{href:!0});var zk=i(or);Dh=s(zk,"RobertaConfig"),zk.forEach(t),Wh=s(Pr,`. It reuses the same defaults. Please check the
parent class for more information.`),Pr.forEach(t),Bh=m(Tt),T(Wo.$$.fragment,Tt),Tt.forEach(t),Ud=m(o),St=r(o,"H2",{class:!0});var Ic=i(St);Bo=r(Ic,"A",{id:!0,class:!0,href:!0});var Ck=i(Bo);gi=r(Ck,"SPAN",{});var jk=i(gi);T(es.$$.fragment,jk),jk.forEach(t),Ck.forEach(t),Qh=m(Ic),ui=r(Ic,"SPAN",{});var Ok=i(ui);Uh=s(Ok,"LongformerTokenizer"),Ok.forEach(t),Ic.forEach(t),Hd=m(o),gt=r(o,"DIV",{class:!0});var Nr=i(gt);T(ts.$$.fragment,Nr),Hh=m(Nr),_i=r(Nr,"P",{});var Pk=i(_i);Rh=s(Pk,"Construct a Longformer tokenizer."),Pk.forEach(t),Vh=m(Nr),Qo=r(Nr,"P",{});var hd=i(Qo);nr=r(hd,"A",{href:!0});var Nk=i(nr);Gh=s(Nk,"LongformerTokenizer"),Nk.forEach(t),Kh=s(hd," is identical to "),sr=r(hd,"A",{href:!0});var Ak=i(sr);Jh=s(Ak,"RobertaTokenizer"),Ak.forEach(t),Xh=s(hd,`. Refer to the superclass for usage examples and
documentation concerning parameters.`),hd.forEach(t),Nr.forEach(t),Rd=m(o),Dt=r(o,"H2",{class:!0});var Sc=i(Dt);Uo=r(Sc,"A",{id:!0,class:!0,href:!0});var Ik=i(Uo);wi=r(Ik,"SPAN",{});var Sk=i(wi);T(os.$$.fragment,Sk),Sk.forEach(t),Ik.forEach(t),Yh=m(Sc),ki=r(Sc,"SPAN",{});var Dk=i(ki);Zh=s(Dk,"LongformerTokenizerFast"),Dk.forEach(t),Sc.forEach(t),Vd=m(o),ut=r(o,"DIV",{class:!0});var Ar=i(ut);T(ns.$$.fragment,Ar),ep=m(Ar),ss=r(Ar,"P",{});var Dc=i(ss);tp=s(Dc,"Construct a \u201Cfast\u201D Longformer tokenizer (backed by HuggingFace\u2019s "),bi=r(Dc,"EM",{});var Wk=i(bi);op=s(Wk,"tokenizers"),Wk.forEach(t),np=s(Dc," library)."),Dc.forEach(t),sp=m(Ar),Ho=r(Ar,"P",{});var pd=i(Ho);ar=r(pd,"A",{href:!0});var Bk=i(ar);ap=s(Bk,"LongformerTokenizerFast"),Bk.forEach(t),rp=s(pd," is identical to "),rr=r(pd,"A",{href:!0});var Qk=i(rr);ip=s(Qk,"RobertaTokenizerFast"),Qk.forEach(t),lp=s(pd,`. Refer to the superclass for usage examples
and documentation concerning parameters.`),pd.forEach(t),Ar.forEach(t),Gd=m(o),Wt=r(o,"H2",{class:!0});var Wc=i(Wt);Ro=r(Wc,"A",{id:!0,class:!0,href:!0});var Uk=i(Ro);vi=r(Uk,"SPAN",{});var Hk=i(vi);T(as.$$.fragment,Hk),Hk.forEach(t),Uk.forEach(t),dp=m(Wc),Ti=r(Wc,"SPAN",{});var Rk=i(Ti);cp=s(Rk,"Longformer specific outputs"),Rk.forEach(t),Wc.forEach(t),Kd=m(o),Bt=r(o,"DIV",{class:!0});var Bc=i(Bt);T(rs.$$.fragment,Bc),mp=m(Bc),yi=r(Bc,"P",{});var Vk=i(yi);hp=s(Vk,"Base class for Longformer\u2019s outputs, with potential hidden states, local and global attentions."),Vk.forEach(t),Bc.forEach(t),Jd=m(o),Qt=r(o,"DIV",{class:!0});var Qc=i(Qt);T(is.$$.fragment,Qc),pp=m(Qc),$i=r(Qc,"P",{});var Gk=i($i);fp=s(Gk,"Base class for Longformer\u2019s outputs that also contains a pooling of the last hidden states."),Gk.forEach(t),Qc.forEach(t),Xd=m(o),Ut=r(o,"DIV",{class:!0});var Uc=i(Ut);T(ls.$$.fragment,Uc),gp=m(Uc),Li=r(Uc,"P",{});var Kk=i(Li);up=s(Kk,"Base class for masked language models outputs."),Kk.forEach(t),Uc.forEach(t),Yd=m(o),Ht=r(o,"DIV",{class:!0});var Hc=i(Ht);T(ds.$$.fragment,Hc),_p=m(Hc),xi=r(Hc,"P",{});var Jk=i(xi);wp=s(Jk,"Base class for outputs of question answering Longformer models."),Jk.forEach(t),Hc.forEach(t),Zd=m(o),Rt=r(o,"DIV",{class:!0});var Rc=i(Rt);T(cs.$$.fragment,Rc),kp=m(Rc),Fi=r(Rc,"P",{});var Xk=i(Fi);bp=s(Xk,"Base class for outputs of sentence classification models."),Xk.forEach(t),Rc.forEach(t),ec=m(o),Vt=r(o,"DIV",{class:!0});var Vc=i(Vt);T(ms.$$.fragment,Vc),vp=m(Vc),Mi=r(Vc,"P",{});var Yk=i(Mi);Tp=s(Yk,"Base class for outputs of multiple choice Longformer models."),Yk.forEach(t),Vc.forEach(t),tc=m(o),Gt=r(o,"DIV",{class:!0});var Gc=i(Gt);T(hs.$$.fragment,Gc),yp=m(Gc),Ei=r(Gc,"P",{});var Zk=i(Ei);$p=s(Zk,"Base class for outputs of token classification models."),Zk.forEach(t),Gc.forEach(t),oc=m(o),Kt=r(o,"DIV",{class:!0});var Kc=i(Kt);T(ps.$$.fragment,Kc),Lp=m(Kc),qi=r(Kc,"P",{});var eb=i(qi);xp=s(eb,"Base class for Longformer\u2019s outputs, with potential hidden states, local and global attentions."),eb.forEach(t),Kc.forEach(t),nc=m(o),Jt=r(o,"DIV",{class:!0});var Jc=i(Jt);T(fs.$$.fragment,Jc),Fp=m(Jc),zi=r(Jc,"P",{});var tb=i(zi);Mp=s(tb,"Base class for Longformer\u2019s outputs that also contains a pooling of the last hidden states."),tb.forEach(t),Jc.forEach(t),sc=m(o),Xt=r(o,"DIV",{class:!0});var Xc=i(Xt);T(gs.$$.fragment,Xc),Ep=m(Xc),Ci=r(Xc,"P",{});var ob=i(Ci);qp=s(ob,"Base class for masked language models outputs."),ob.forEach(t),Xc.forEach(t),ac=m(o),Yt=r(o,"DIV",{class:!0});var Yc=i(Yt);T(us.$$.fragment,Yc),zp=m(Yc),ji=r(Yc,"P",{});var nb=i(ji);Cp=s(nb,"Base class for outputs of question answering Longformer models."),nb.forEach(t),Yc.forEach(t),rc=m(o),Zt=r(o,"DIV",{class:!0});var Zc=i(Zt);T(_s.$$.fragment,Zc),jp=m(Zc),Oi=r(Zc,"P",{});var sb=i(Oi);Op=s(sb,"Base class for outputs of sentence classification models."),sb.forEach(t),Zc.forEach(t),ic=m(o),eo=r(o,"DIV",{class:!0});var em=i(eo);T(ws.$$.fragment,em),Pp=m(em),Pi=r(em,"P",{});var ab=i(Pi);Np=s(ab,"Base class for outputs of multiple choice models."),ab.forEach(t),em.forEach(t),lc=m(o),to=r(o,"DIV",{class:!0});var tm=i(to);T(ks.$$.fragment,tm),Ap=m(tm),Ni=r(tm,"P",{});var rb=i(Ni);Ip=s(rb,"Base class for outputs of token classification models."),rb.forEach(t),tm.forEach(t),dc=m(o),oo=r(o,"H2",{class:!0});var om=i(oo);Vo=r(om,"A",{id:!0,class:!0,href:!0});var ib=i(Vo);Ai=r(ib,"SPAN",{});var lb=i(Ai);T(bs.$$.fragment,lb),lb.forEach(t),ib.forEach(t),Sp=m(om),Ii=r(om,"SPAN",{});var db=i(Ii);Dp=s(db,"LongformerModel"),db.forEach(t),om.forEach(t),cc=m(o),Pe=r(o,"DIV",{class:!0});var nt=i(Pe);T(vs.$$.fragment,nt),Wp=m(nt),Si=r(nt,"P",{});var cb=i(Si);Bp=s(cb,"The bare Longformer Model outputting raw hidden-states without any specific head on top."),cb.forEach(t),Qp=m(nt),Ts=r(nt,"P",{});var nm=i(Ts);Up=s(nm,"This model inherits from "),ir=r(nm,"A",{href:!0});var mb=i(ir);Hp=s(mb,"PreTrainedModel"),mb.forEach(t),Rp=s(nm,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
attention are more relevant for autoregressive language modeling than finetuning on downstream tasks. Future
release will add support for autoregressive attention, but the support for dilated attention requires a custom CUDA
kernel to be memory and compute efficient.`),am.forEach(t),lf=m(nt),at=r(nt,"DIV",{class:!0});var Un=i(at);T(Fs.$$.fragment,Un),df=m(Un),so=r(Un,"P",{});var Sr=i(so);cf=s(Sr,"The "),dr=r(Sr,"A",{href:!0});var ub=i(dr);mf=s(ub,"LongformerModel"),ub.forEach(t),hf=s(Sr," forward method, overrides the "),Wi=r(Sr,"CODE",{});var _b=i(Wi);pf=s(_b,"__call__"),_b.forEach(t),ff=s(Sr," special method."),Sr.forEach(t),gf=m(Un),T(Go.$$.fragment,Un),uf=m(Un),T(Ko.$$.fragment,Un),Un.forEach(t),nt.forEach(t),mc=m(o),ao=r(o,"H2",{class:!0});var rm=i(ao);Jo=r(rm,"A",{id:!0,class:!0,href:!0});var wb=i(Jo);Bi=r(wb,"SPAN",{});var kb=i(Bi);T(Ms.$$.fragment,kb),kb.forEach(t),wb.forEach(t),_f=m(rm),Qi=r(rm,"SPAN",{});var bb=i(Qi);wf=s(bb,"LongformerForMaskedLM"),bb.forEach(t),rm.forEach(t),hc=m(o),Re=r(o,"DIV",{class:!0});var yt=i(Re);T(Es.$$.fragment,yt),kf=m(yt),qs=r(yt,"P",{});var im=i(qs);bf=s(im,"Longformer Model with a "),Ui=r(im,"CODE",{});var vb=i(Ui);vf=s(vb,"language modeling"),vb.forEach(t),Tf=s(im," head on top."),im.forEach(t),yf=m(yt),zs=r(yt,"P",{});var lm=i(zs);$f=s(lm,"This model inherits from "),cr=r(lm,"A",{href:!0});var Tb=i(cr);Lf=s(Tb,"PreTrainedModel"),Tb.forEach(t),xf=s(lm,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),lm.forEach(t),Ff=m(yt),Cs=r(yt,"P",{});var dm=i(Cs);Mf=s(dm,"This model is also a PyTorch "),js=r(dm,"A",{href:!0,rel:!0});var yb=i(js);Ef=s(yb,"torch.nn.Module"),yb.forEach(t),qf=s(dm,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),dm.forEach(t),zf=m(yt),Qe=r(yt,"DIV",{class:!0});var dt=i(Qe);T(Os.$$.fragment,dt),Cf=m(dt),ro=r(dt,"P",{});var Dr=i(ro);jf=s(Dr,"The "),mr=r(Dr,"A",{href:!0});var $b=i(mr);Of=s($b,"LongformerForMaskedLM"),$b.forEach(t),Pf=s(Dr," forward method, overrides the "),Hi=r(Dr,"CODE",{});var Lb=i(Hi);Nf=s(Lb,"__call__"),Lb.forEach(t),Af=s(Dr," special method."),Dr.forEach(t),If=m(dt),T(Xo.$$.fragment,dt),Sf=m(dt),T(Yo.$$.fragment,dt),Df=m(dt),Ri=r(dt,"P",{});var xb=i(Ri);Wf=s(xb,"Let\u2019s try a very long input."),xb.forEach(t),Bf=m(dt),T(Zo.$$.fragment,dt),dt.forEach(t),yt.forEach(t),pc=m(o),io=r(o,"H2",{class:!0});var cm=i(io);en=r(cm,"A",{id:!0,class:!0,href:!0});var Fb=i(en);Vi=r(Fb,"SPAN",{});var Mb=i(Vi);T(Ps.$$.fragment,Mb),Mb.forEach(t),Fb.forEach(t),Qf=m(cm),Gi=r(cm,"SPAN",{});var Eb=i(Gi);Uf=s(Eb,"LongformerForSequenceClassification"),Eb.forEach(t),cm.forEach(t),fc=m(o),Ve=r(o,"DIV",{class:!0});var $t=i(Ve);T(Ns.$$.fragment,$t),Hf=m($t),Ki=r($t,"P",{});var qb=i(Ki);Rf=s(qb,`Longformer Model transformer with a sequence classification/regression head on top (a linear layer on top of the
pooled output) e.g. for GLUE tasks.`),qb.forEach(t),Vf=m($t),As=r($t,"P",{});var mm=i(As);Gf=s(mm,"This model inherits from "),hr=r(mm,"A",{href:!0});var zb=i(hr);Kf=s(zb,"PreTrainedModel"),zb.forEach(t),Jf=s(mm,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),hm.forEach(t),tg=m($t),Ne=r($t,"DIV",{class:!0});var st=i(Ne);T(Ds.$$.fragment,st),og=m(st),lo=r(st,"P",{});var Wr=i(lo);ng=s(Wr,"The "),pr=r(Wr,"A",{href:!0});var jb=i(pr);sg=s(jb,"LongformerForSequenceClassification"),jb.forEach(t),ag=s(Wr," forward method, overrides the "),Ji=r(Wr,"CODE",{});var Ob=i(Ji);rg=s(Ob,"__call__"),Ob.forEach(t),ig=s(Wr," special method."),Wr.forEach(t),lg=m(st),T(tn.$$.fragment,st),dg=m(st),T(on.$$.fragment,st),cg=m(st),T(nn.$$.fragment,st),mg=m(st),T(sn.$$.fragment,st),hg=m(st),T(an.$$.fragment,st),st.forEach(t),$t.forEach(t),gc=m(o),co=r(o,"H2",{class:!0});var pm=i(co);rn=r(pm,"A",{id:!0,class:!0,href:!0});var Pb=i(rn);Xi=r(Pb,"SPAN",{});var Nb=i(Xi);T(Ws.$$.fragment,Nb),Nb.forEach(t),Pb.forEach(t),pg=m(pm),Yi=r(pm,"SPAN",{});var Ab=i(Yi);fg=s(Ab,"LongformerForMultipleChoice"),Ab.forEach(t),pm.forEach(t),uc=m(o),Ge=r(o,"DIV",{class:!0});var Lt=i(Ge);T(Bs.$$.fragment,Lt),gg=m(Lt),Zi=r(Lt,"P",{});var Ib=i(Zi);ug=s(Ib,`Longformer Model with a multiple choice classification head on top (a linear layer on top of the pooled output and
a softmax) e.g. for RocStories/SWAG tasks.`),Ib.forEach(t),_g=m(Lt),Qs=r(Lt,"P",{});var fm=i(Qs);wg=s(fm,"This model inherits from "),fr=r(fm,"A",{href:!0});var Sb=i(fr);kg=s(Sb,"PreTrainedModel"),Sb.forEach(t),bg=s(fm,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),gm.forEach(t),Lg=m(Lt),rt=r(Lt,"DIV",{class:!0});var Hn=i(rt);T(Rs.$$.fragment,Hn),xg=m(Hn),mo=r(Hn,"P",{});var Br=i(mo);Fg=s(Br,"The "),gr=r(Br,"A",{href:!0});var Wb=i(gr);Mg=s(Wb,"LongformerForMultipleChoice"),Wb.forEach(t),Eg=s(Br," forward method, overrides the "),el=r(Br,"CODE",{});var Bb=i(el);qg=s(Bb,"__call__"),Bb.forEach(t),zg=s(Br," special method."),Br.forEach(t),Cg=m(Hn),T(ln.$$.fragment,Hn),jg=m(Hn),T(dn.$$.fragment,Hn),Hn.forEach(t),Lt.forEach(t),_c=m(o),ho=r(o,"H2",{class:!0});var um=i(ho);cn=r(um,"A",{id:!0,class:!0,href:!0});var Qb=i(cn);tl=r(Qb,"SPAN",{});var Ub=i(tl);T(Vs.$$.fragment,Ub),Ub.forEach(t),Qb.forEach(t),Og=m(um),ol=r(um,"SPAN",{});var Hb=i(ol);Pg=s(Hb,"LongformerForTokenClassification"),Hb.forEach(t),um.forEach(t),wc=m(o),Ke=r(o,"DIV",{class:!0});var xt=i(Ke);T(Gs.$$.fragment,xt),Ng=m(xt),nl=r(xt,"P",{});var Rb=i(nl);Ag=s(Rb,`Longformer Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g.
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),$m.forEach(t),Su=m(Ue),T(wn.$$.fragment,Ue),Du=m(Ue),wo=r(Ue,"P",{});var Rr=i(wo);Wu=s(Rr,"This class copies code from "),vr=r(Rr,"A",{href:!0});var hv=i(vr);Bu=s(hv,"TFRobertaModel"),hv.forEach(t),Qu=s(Rr,` and overwrites standard self-attention with longformer
self-attention to provide the ability to process long sequences following the self-attention approach described in
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Em.forEach(t),w_=m(ct),T(vn.$$.fragment,ct),k_=m(ct),Ze=r(ct,"DIV",{class:!0});var Et=i(Ze);T(ka.$$.fragment,Et),b_=m(Et),vo=r(Et,"P",{});var Kr=i(vo);v_=s(Kr,"The "),$r=r(Kr,"A",{href:!0});var yv=i($r);T_=s(yv,"TFLongformerForMaskedLM"),yv.forEach(t),y_=s(Kr," forward method, overrides the "),wl=r(Kr,"CODE",{});var $v=i(wl);$_=s($v,"__call__"),$v.forEach(t),L_=s(Kr," special method."),Kr.forEach(t),x_=m(Et),T(Tn.$$.fragment,Et),F_=m(Et),T(yn.$$.fragment,Et),M_=m(Et),T($n.$$.fragment,Et),Et.forEach(t),ct.forEach(t),Lc=m(o),To=r(o,"H2",{class:!0});var qm=i(To);Ln=r(qm,"A",{id:!0,class:!0,href:!0});var Lv=i(Ln);kl=r(Lv,"SPAN",{});var xv=i(kl);T(ba.$$.fragment,xv),xv.forEach(t),Lv.forEach(t),E_=m(qm),bl=r(qm,"SPAN",{});var Fv=i(bl);q_=s(Fv,"TFLongformerForQuestionAnswering"),Fv.forEach(t),qm.forEach(t),xc=m(o),Se=r(o,"DIV",{class:!0});var mt=i(Se);T(va.$$.fragment,mt),z_=m(mt),yo=r(mt,"P",{});var Jr=i(yo);C_=s(Jr,`Longformer Model with a span classification head on top for extractive question-answering tasks like SQuAD /
TriviaQA (a linear layer on top of the hidden-states output to compute `),vl=r(Jr,"CODE",{});var Mv=i(vl);j_=s(Mv,"span start logits"),Mv.forEach(t),O_=s(Jr," and "),Tl=r(Jr,"CODE",{});var Ev=i(Tl);P_=s(Ev,"span end logits"),Ev.forEach(t),N_=s(Jr,")."),Jr.forEach(t),A_=m(mt),Ta=r(mt,"P",{});var zm=i(Ta);I_=s(zm,"This model inherits from "),Lr=r(zm,"A",{href:!0});var qv=i(Lr);S_=s(qv,"TFPreTrainedModel"),qv.forEach(t),D_=s(zm,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),zm.forEach(t),W_=m(mt),ya=r(mt,"P",{});var Cm=i(ya);B_=s(Cm,"This model is also a "),$a=r(Cm,"A",{href:!0,rel:!0});var zv=i($a);Q_=s(zv,"tf.keras.Model"),zv.forEach(t),U_=s(Cm,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Cm.forEach(t),H_=m(mt),T(xn.$$.fragment,mt),R_=m(mt),et=r(mt,"DIV",{class:!0});var qt=i(et);T(La.$$.fragment,qt),V_=m(qt),$o=r(qt,"P",{});var Xr=i($o);G_=s(Xr,"The "),xr=r(Xr,"A",{href:!0});var Cv=i(xr);K_=s(Cv,"TFLongformerForQuestionAnswering"),Cv.forEach(t),J_=s(Xr," forward method, overrides the "),yl=r(Xr,"CODE",{});var jv=i(yl);X_=s(jv,"__call__"),jv.forEach(t),Y_=s(Xr," special method."),Xr.forEach(t),Z_=m(qt),T(Fn.$$.fragment,qt),ew=m(qt),T(Mn.$$.fragment,qt),tw=m(qt),T(En.$$.fragment,qt),qt.forEach(t),mt.forEach(t),Fc=m(o),Lo=r(o,"H2",{class:!0});var jm=i(Lo);qn=r(jm,"A",{id:!0,class:!0,href:!0});var Ov=i(qn);$l=r(Ov,"SPAN",{});var Pv=i($l);T(xa.$$.fragment,Pv),Pv.forEach(t),Ov.forEach(t),ow=m(jm),Ll=r(jm,"SPAN",{});var Nv=i(Ll);nw=s(Nv,"TFLongformerForSequenceClassification"),Nv.forEach(t),jm.forEach(t),Mc=m(o),De=r(o,"DIV",{class:!0});var ht=i(De);T(Fa.$$.fragment,ht),sw=m(ht),xl=r(ht,"P",{});var Av=i(xl);aw=s(Av,`Longformer Model transformer with a sequence classification/regression head on top (a linear layer on top of the
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Om.forEach(t),cw=m(ht),Ea=r(ht,"P",{});var Pm=i(Ea);mw=s(Pm,"This model is also a "),qa=r(Pm,"A",{href:!0,rel:!0});var Sv=i(qa);hw=s(Sv,"tf.keras.Model"),Sv.forEach(t),pw=s(Pm,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Pm.forEach(t),fw=m(ht),T(zn.$$.fragment,ht),gw=m(ht),tt=r(ht,"DIV",{class:!0});var zt=i(tt);T(za.$$.fragment,zt),uw=m(zt),xo=r(zt,"P",{});var Yr=i(xo);_w=s(Yr,"The "),Mr=r(Yr,"A",{href:!0});var Dv=i(Mr);ww=s(Dv,"TFLongformerForSequenceClassification"),Dv.forEach(t),kw=s(Yr," forward method, overrides the "),Fl=r(Yr,"CODE",{});var Wv=i(Fl);bw=s(Wv,"__call__"),Wv.forEach(t),vw=s(Yr," special method."),Yr.forEach(t),Tw=m(zt),T(Cn.$$.fragment,zt),yw=m(zt),T(jn.$$.fragment,zt),$w=m(zt),T(On.$$.fragment,zt),zt.forEach(t),ht.forEach(t),Ec=m(o),Fo=r(o,"H2",{class:!0});var Nm=i(Fo);Pn=r(Nm,"A",{id:!0,class:!0,href:!0});var Bv=i(Pn);Ml=r(Bv,"SPAN",{});var Qv=i(Ml);T(Ca.$$.fragment,Qv),Qv.forEach(t),Bv.forEach(t),Lw=m(Nm),El=r(Nm,"SPAN",{});var Uv=i(El);xw=s(Uv,"TFLongformerForTokenClassification"),Uv.forEach(t),Nm.forEach(t),qc=m(o),We=r(o,"DIV",{class:!0});var pt=i(We);T(ja.$$.fragment,pt),Fw=m(pt),ql=r(pt,"P",{});var Hv=i(ql);Mw=s(Hv,`Longformer Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g.
for Named-Entity-Recognition (NER) tasks.`),Hv.forEach(t),Ew=m(pt),Oa=r(pt,"P",{});var Am=i(Oa);qw=s(Am,"This model inherits from "),Er=r(Am,"A",{href:!0});var Rv=i(Er);zw=s(Rv,"TFPreTrainedModel"),Rv.forEach(t),Cw=s(Am,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
