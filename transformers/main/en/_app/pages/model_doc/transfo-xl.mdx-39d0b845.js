...
XL`),Jd.forEach(t),Ka=i(Bt," architecture."),Bt.forEach(t),Ga=d(Ze),lt=s(Ze,"P",{});var zn=a(lt);Ya=i(zn,"Configuration objects inherit from "),mn=s(zn,"A",{href:!0});var ec=a(mn);Qa=i(ec,"PretrainedConfig"),ec.forEach(t),Za=i(zn,` and can be used to control the model outputs. Read the
