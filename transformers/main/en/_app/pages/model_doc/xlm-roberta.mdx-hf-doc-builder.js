import{S as zR,i as qR,s as CR,e as s,k as c,w as y,t as o,M as jR,c as a,d as t,m as p,a as r,x as T,h as n,b as u,G as e,g as _,y as w,q as $,o as M,B as F,v as XR,L as ge}from"../../chunks/vendor-hf-doc-builder.js";import{T as De}from"../../chunks/Tip-hf-doc-builder.js";import{D as A}from"../../chunks/Docstring-hf-doc-builder.js";import{C as _e}from"../../chunks/CodeBlock-hf-doc-builder.js";import{I as Be}from"../../chunks/IconCopyLink-hf-doc-builder.js";import{E as fe}from"../../chunks/ExampleCodeBlock-hf-doc-builder.js";function PR(x){let d,g,h,f,k;return{c(){d=s("p"),g=o("Although the recipe for forward pass needs to be defined within this function, one should call the "),h=s("code"),f=o("Module"),k=o(`
...
<span class="hljs-number">0.1</span>`}}),{c(){y(d.$$.fragment)},l(h){T(d.$$.fragment,h)},m(h,f){w(d,h,f),g=!0},p:ge,i(h){g||($(d.$$.fragment,h),g=!0)},o(h){M(d.$$.fragment,h),g=!1},d(h){F(d,h)}}}function BR(x){let d,g,h,f,k;return{c(){d=s("p"),g=o("Although the recipe for forward pass needs to be defined within this function, one should call the "),h=s("code"),f=o("Module"),k=o(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(l){d=a(l,"P",{});var m=r(d);g=n(m,"Although the recipe for forward pass needs to be defined within this function, one should call the "),h=a(m,"CODE",{});var L=r(h);f=n(L,"Module"),L.forEach(t),k=n(m,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),m.forEach(t)},m(l,m){_(l,d,m),e(d,g),e(d,h),e(h,f),e(d,k)},d(l){l&&t(d)}}}function WR(x){let d,g,h,f,k;return f=new _e({props:{code:`import torch
...
<span class="hljs-meta">... </span>)
<span class="hljs-meta">&gt;&gt;&gt; </span>loss = model(**inputs, labels=labels).loss
<span class="hljs-meta">&gt;&gt;&gt; </span>loss.backward()`}}),{c(){y(d.$$.fragment)},l(h){T(d.$$.fragment,h)},m(h,f){w(d,h,f),g=!0},p:ge,i(h){g||($(d.$$.fragment,h),g=!0)},o(h){M(d.$$.fragment,h),g=!1},d(h){F(d,h)}}}function KR(x){let d,g,h,f,k;return{c(){d=s("p"),g=o("Although the recipe for forward pass needs to be defined within this function, one should call the "),h=s("code"),f=o("Module"),k=o(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(l){d=a(l,"P",{});var m=r(d);g=n(m,"Although the recipe for forward pass needs to be defined within this function, one should call the "),h=a(m,"CODE",{});var L=r(h);f=n(L,"Module"),L.forEach(t),k=n(m,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),m.forEach(t)},m(l,m){_(l,d,m),e(d,g),e(d,h),e(h,f),e(d,k)},d(l){l&&t(d)}}}function VR(x){let d,g,h,f,k;return f=new _e({props:{code:`from transformers import RobertaTokenizer, RobertaForMultipleChoice
import torch
...
the Keras `),W=s("code"),ue=o("Functional"),Ee=o(` API, there are three possibilities you can use to gather all the input Tensors in the first
...
`),K=s("code"),me=o("model([input_ids, attention_mask])"),je=o(" or "),V=s("code"),we=o("model([input_ids, attention_mask, token_type_ids])"),se=c(),N=s("li"),he=o(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
...
the Keras `),W=a(z,"CODE",{});var Se=r(W);ue=n(Se,"Functional"),Se.forEach(t),Ee=n(z,` API, there are three possibilities you can use to gather all the input Tensors in the first
...
<span class="hljs-meta">&gt;&gt;&gt; </span>end_scores = outputs.end_logits`}}),{c(){d=s("p"),g=o("Example:"),h=c(),y(f.$$.fragment)},l(l){d=a(l,"P",{});var m=r(d);g=n(m,"Example:"),m.forEach(t),h=p(l),T(f.$$.fragment,l)},m(l,m){_(l,d,m),e(d,g),_(l,h,m),w(f,l,m),k=!0},p:ge,i(l){k||($(f.$$.fragment,l),k=!0)},o(l){M(f.$$.fragment,l),k=!1},d(l){l&&t(d),l&&t(h),F(f,l)}}}function PL(x){let d,g,h,f,k,l,m,L,$e,be,O,re,te,R,Me,U,Fe,ke,D,xe,de,H,Re,ve,B,Le,ye,W,ue,Ee,ne,q,C,Te,S,ce,ze,Q,qe,Ce,j,pe,K,me,je,V,we,se,N,he,J,Xe,Z,X,Pe,P,ae,ie,v,E,He,oe,Ke,Ue,z,Ne,Ve,Ae,Je,Se,I,G,Ie,Ge,Y,Qe,Oe,le,We,ee,Ye,hc,Rf,pm,nt,ra,Lf,io,Ef,Cl,zf,qf,jl,Cf,jf,ia,Xf,Pf,Af,la,Of,Xl,Nf,If,Df,go,da,Sf,mc,Bf,Wf,ca,Pl,Uf,uc,Qf,Hf,Al,Kf,fc,Vf,Jf,vn,pa,Gf,ha,Yf,gc,Zf,eg,tg,yn,ma,og,_c,ng,sg,Ol,ua,hm,xo,Tn,bc,fa,ag,kc,rg,mm,Mt,ga,ig,St,lg,vc,dg,cg,Nl,pg,hg,Il,mg,ug,_a,fg,gg,_g,ba,bg,Dl,kg,vg,yg,_o,ka,Tg,yc,wg,$g,va,Sl,Mg,Tc,Fg,xg,Bl,Rg,wc,Lg,Eg,wn,ya,zg,$c,qg,um,Ro,$n,Mc,Ta,Cg,Fc,jg,fm,mt,wa,Xg,xc,Pg,Ag,$a,Og,Wl,Ng,Ig,Dg,Ma,Sg,Fa,Bg,Wg,Ug,xa,Qg,Ul,Hg,Kg,Vg,Bt,Ra,Jg,Lo,Gg,Ql,Yg,Zg,Rc,e_,t_,o_,Mn,n_,Fn,gm,Eo,xn,Lc,La,s_,Ec,a_,_m,ut,Ea,r_,za,i_,zc,l_,d_,c_,qa,p_,Hl,h_,m_,u_,Ca,f_,ja,g_,__,b_,Xa,k_,Kl,v_,y_,T_,Wt,Pa,w_,zo,$_,Vl,M_,F_,qc,x_,R_,L_,Rn,E_,Ln,bm,qo,En,Cc,Aa,z_,jc,q_,km,ft,Oa,C_,Na,j_,Xc,X_,P_,A_,Ia,O_,Jl,N_,I_,D_,Da,S_,Sa,B_,W_,U_,Ba,Q_,Gl,H_,K_,V_,Ft,Wa,J_,Co,G_,Yl,Y_,Z_,Pc,eb,tb,ob,zn,nb,qn,sb,Cn,vm,jo,jn,Ac,Ua,ab,Oc,rb,ym,gt,Qa,ib,Nc,lb,db,Ha,cb,Zl,pb,hb,mb,Ka,ub,Va,fb,gb,_b,Ja,bb,ed,kb,vb,yb,ht,Ga,Tb,Xo,wb,td,$b,Mb,Ic,Fb,xb,Rb,Xn,Lb,Pn,Eb,An,zb,On,qb,Nn,Tm,Po,In,Dc,Ya,Cb,Sc,jb,wm,_t,Za,Xb,Bc,Pb,Ab,er,Ob,od,Nb,Ib,Db,tr,Sb,or,Bb,Wb,Ub,nr,Qb,nd,Hb,Kb,Vb,Ut,sr,Jb,Ao,Gb,sd,Yb,Zb,Wc,ek,tk,ok,Dn,nk,Sn,$m,Oo,Bn,Uc,ar,sk,Qc,ak,Mm,bt,rr,rk,Hc,ik,lk,ir,dk,ad,ck,pk,hk,lr,mk,dr,uk,fk,gk,cr,_k,rd,bk,kk,vk,xt,pr,yk,No,Tk,id,wk,$k,Kc,Mk,Fk,xk,Wn,Rk,Un,Lk,Qn,Fm,Io,Hn,Vc,hr,Ek,Jc,zk,xm,kt,mr,qk,Do,Ck,Gc,jk,Xk,Yc,Pk,Ak,Ok,ur,Nk,ld,Ik,Dk,Sk,fr,Bk,gr,Wk,Uk,Qk,_r,Hk,dd,Kk,Vk,Jk,Rt,br,Gk,So,Yk,cd,Zk,ev,Zc,tv,ov,nv,Kn,sv,Vn,av,Jn,Rm,Bo,Gn,ep,kr,rv,tp,iv,Lm,st,vr,lv,op,dv,cv,yr,pv,pd,hv,mv,uv,Tr,fv,wr,gv,_v,bv,Yn,kv,$r,vv,hd,yv,Tv,wv,Qt,Mr,$v,Wo,Mv,md,Fv,xv,np,Rv,Lv,Ev,Zn,zv,es,Em,Uo,ts,sp,Fr,qv,ap,Cv,zm,at,xr,jv,Rr,Xv,rp,Pv,Av,Ov,Lr,Nv,ud,Iv,Dv,Sv,Er,Bv,zr,Wv,Uv,Qv,os,Hv,qr,Kv,fd,Vv,Jv,Gv,Lt,Cr,Yv,Qo,Zv,gd,ey,ty,ip,oy,ny,sy,ns,ay,ss,ry,as,qm,Ho,rs,lp,jr,iy,dp,ly,Cm,rt,Xr,dy,cp,cy,py,Pr,hy,_d,my,uy,fy,Ar,gy,Or,_y,by,ky,is,vy,Nr,yy,bd,Ty,wy,$y,Et,Ir,My,Ko,Fy,kd,xy,Ry,pp,Ly,Ey,zy,ls,qy,ds,Cy,cs,jm,Vo,ps,hp,Dr,jy,mp,Xy,Xm,it,Sr,Py,up,Ay,Oy,Br,Ny,vd,Iy,Dy,Sy,Wr,By,Ur,Wy,Uy,Qy,hs,Hy,Qr,Ky,yd,Vy,Jy,Gy,Ht,Hr,Yy,Jo,Zy,Td,eT,tT,fp,oT,nT,sT,ms,aT,us,Pm,Go,fs,gp,Kr,rT,_p,iT,Am,lt,Vr,lT,bp,dT,cT,Jr,pT,wd,hT,mT,uT,Gr,fT,Yr,gT,_T,bT,gs,kT,Zr,vT,$d,yT,TT,wT,zt,ei,$T,Yo,MT,Md,FT,xT,kp,RT,LT,ET,_s,zT,bs,qT,ks,Om,Zo,vs,vp,ti,CT,yp,jT,Nm,dt,oi,XT,en,PT,Tp,AT,OT,wp,NT,IT,DT,ni,ST,Fd,BT,WT,UT,si,QT,ai,HT,KT,VT,ys,JT,ri,GT,$p,YT,ZT,ew,qt,ii,tw,tn,ow,xd,nw,sw,Mp,aw,rw,iw,Ts,lw,ws,dw,$s,Im,on,Ms,Fp,li,cw,xp,pw,Dm,ct,di,hw,ci,mw,Rd,uw,fw,gw,pi,_w,hi,bw,kw,vw,Rp,yw,Tw,lo,Lp,mi,ww,$w,Ep,ui,Mw,Fw,zp,fi,xw,Rw,qp,gi,Lw,Ew,_i,zw,Ld,qw,Cw,jw,Kt,bi,Xw,nn,Pw,Cp,Aw,Ow,jp,Nw,Iw,Dw,Fs,Sw,xs,Sm,sn,Rs,Xp,ki,Bw,Pp,Ww,Bm,pt,vi,Uw,an,Qw,Ap,Hw,Kw,Ed,Vw,Jw,Gw,yi,Yw,Ti,Zw,e$,t$,Op,o$,n$,co,Np,wi,s$,a$,Ip,$i,r$,i$,Dp,Mi,l$,d$,Sp,Fi,c$,p$,xi,h$,zd,m$,u$,f$,Vt,Ri,g$,rn,_$,Bp,b$,k$,Wp,v$,y$,T$,Ls,w$,Es,Wm,ln,zs,Up,Li,$$,Qp,M$,Um,Ze,Ei,F$,Hp,x$,R$,zi,L$,qd,E$,z$,q$,qi,C$,Ci,j$,X$,P$,Kp,A$,O$,po,Vp,ji,N$,I$,Jp,Xi,D$,S$,Gp,Pi,B$,W$,Yp,Ai,U$,Q$,Oi,H$,Cd,K$,V$,J$,Jt,Ni,G$,dn,Y$,Zp,Z$,e1,eh,t1,o1,n1,qs,s1,Cs,Qm,cn,js,th,Ii,a1,oh,r1,Hm,et,Di,i1,nh,l1,d1,Si,c1,jd,p1,h1,m1,Bi,u1,Wi,f1,g1,_1,sh,b1,k1,ho,ah,Ui,v1,y1,rh,Qi,T1,w1,ih,Hi,$1,M1,lh,Ki,F1,x1,Vi,R1,Xd,L1,E1,z1,Gt,Ji,q1,pn,C1,dh,j1,X1,ch,P1,A1,O1,Xs,N1,Ps,Km,hn,As,ph,Gi,I1,hh,D1,Vm,tt,Yi,S1,mh,B1,W1,Zi,U1,Pd,Q1,H1,K1,el,V1,tl,J1,G1,Y1,uh,Z1,eM,mo,fh,ol,tM,oM,gh,nl,nM,sM,_h,sl,aM,rM,bh,al,iM,lM,rl,dM,Ad,cM,pM,hM,Yt,il,mM,mn,uM,kh,fM,gM,vh,_M,bM,kM,Os,vM,Ns,Jm,un,Is,yh,ll,yM,Th,TM,Gm,ot,dl,wM,fn,$M,wh,MM,FM,$h,xM,RM,LM,cl,EM,Od,zM,qM,CM,pl,jM,hl,XM,PM,AM,Mh,OM,NM,uo,Fh,ml,IM,DM,xh,ul,SM,BM,Rh,fl,WM,UM,Lh,gl,QM,HM,_l,KM,Nd,VM,JM,GM,Zt,bl,YM,gn,ZM,Eh,e2,t2,zh,o2,n2,s2,Ds,a2,Ss,Ym;return l=new Be({}),R=new Be({}),E=new Be({}),Ne=new A({props:{name:"class transformers.XLMRobertaConfig",anchor:"transformers.XLMRobertaConfig",parameters:[{name:"pad_token_id",val:" = 1"},{name:"bos_token_id",val:" = 0"},{name:"eos_token_id",val:" = 2"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/xlm_roberta/configuration_xlm_roberta.py#L45"}}),ee=new Be({}),ra=new A({props:{name:"class transformers.XLMRobertaTokenizer",anchor:"transformers.XLMRobertaTokenizer",parameters:[{name:"vocab_file",val:""},{name:"bos_token",val:" = '<s>'"},{name:"eos_token",val:" = '</s>'"},{name:"sep_token",val:" = '</s>'"},{name:"cls_token",val:" = '<s>'"},{name:"unk_token",val:" = '<unk>'"},{name:"pad_token",val:" = '<pad>'"},{name:"mask_token",val:" = '<mask>'"},{name:"sp_model_kwargs",val:": typing.Union[typing.Dict[str, typing.Any], NoneType] = None"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.XLMRobertaTokenizer.vocab_file",description:`<strong>vocab_file</strong> (<code>str</code>) &#x2014;
...
`,returnType:`
<p><code>List[int]</code></p>
`}}),ua=new A({props:{name:"save_vocabulary",anchor:"transformers.XLMRobertaTokenizer.save_vocabulary",parameters:[{name:"save_directory",val:": str"},{name:"filename_prefix",val:": typing.Optional[str] = None"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/xlm_roberta/tokenization_xlm_roberta.py#L313"}}),fa=new Be({}),ga=new A({props:{name:"class transformers.XLMRobertaTokenizerFast",anchor:"transformers.XLMRobertaTokenizerFast",parameters:[{name:"vocab_file",val:" = None"},{name:"tokenizer_file",val:" = None"},{name:"bos_token",val:" = '<s>'"},{name:"eos_token",val:" = '</s>'"},{name:"sep_token",val:" = '</s>'"},{name:"cls_token",val:" = '<s>'"},{name:"unk_token",val:" = '<unk>'"},{name:"pad_token",val:" = '<pad>'"},{name:"mask_token",val:" = '<mask>'"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.XLMRobertaTokenizerFast.vocab_file",description:`<strong>vocab_file</strong> (<code>str</code>) &#x2014;
...
`}}),Rn=new De({props:{$$slots:{default:[OR]},$$scope:{ctx:x}}}),Ln=new fe({props:{anchor:"transformers.XLMRobertaForCausalLM.forward.example",$$slots:{default:[NR]},$$scope:{ctx:x}}}),Aa=new Be({}),Oa=new A({props:{name:"class transformers.XLMRobertaForMaskedLM",anchor:"transformers.XLMRobertaForMaskedLM",parameters:[{name:"config",val:""}],parametersDescription:[{anchor:"transformers.XLMRobertaForMaskedLM.config",description:`<strong>config</strong> (<a href="/docs/transformers/main/en/model_doc/xlm-roberta#transformers.XLMRobertaConfig">XLMRobertaConfig</a>) &#x2014; Model configuration class with all the parameters of the
model. Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/main/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/xlm_roberta/modeling_xlm_roberta.py#L91"}}),Wa=new A({props:{name:"forward",anchor:"transformers.XLMRobertaForMaskedLM.forward",parameters:[{name:"input_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"attention_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"token_type_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"position_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"head_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"encoder_hidden_states",val:": typing.Optional[torch.FloatTensor] = None"},{name:"encoder_attention_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"labels",val:": typing.Optional[torch.LongTensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.XLMRobertaForMaskedLM.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/main/en/model_doc/roberta#transformers.RobertaTokenizer">RobertaTokenizer</a>. See <a href="/docs/transformers/main/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/main/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
`}}),zn=new De({props:{$$slots:{default:[IR]},$$scope:{ctx:x}}}),qn=new fe({props:{anchor:"transformers.XLMRobertaForMaskedLM.forward.example",$$slots:{default:[DR]},$$scope:{ctx:x}}}),Cn=new fe({props:{anchor:"transformers.XLMRobertaForMaskedLM.forward.example-2",$$slots:{default:[SR]},$$scope:{ctx:x}}}),Ua=new Be({}),Qa=new A({props:{name:"class transformers.XLMRobertaForSequenceClassification",anchor:"transformers.XLMRobertaForSequenceClassification",parameters:[{name:"config",val:""}],parametersDescription:[{anchor:"transformers.XLMRobertaForSequenceClassification.config",description:`<strong>config</strong> (<a href="/docs/transformers/main/en/model_doc/xlm-roberta#transformers.XLMRobertaConfig">XLMRobertaConfig</a>) &#x2014; Model configuration class with all the parameters of the
model. Initializing with a config file does not load the weights associated with the model, only the
...
`}}),Dn=new De({props:{$$slots:{default:[KR]},$$scope:{ctx:x}}}),Sn=new fe({props:{anchor:"transformers.XLMRobertaForMultipleChoice.forward.example",$$slots:{default:[VR]},$$scope:{ctx:x}}}),ar=new Be({}),rr=new A({props:{name:"class transformers.XLMRobertaForTokenClassification",anchor:"transformers.XLMRobertaForTokenClassification",parameters:[{name:"config",val:""}],parametersDescription:[{anchor:"transformers.XLMRobertaForTokenClassification.config",description:`<strong>config</strong> (<a href="/docs/transformers/main/en/model_doc/xlm-roberta#transformers.XLMRobertaConfig">XLMRobertaConfig</a>) &#x2014; Model configuration class with all the parameters of the
model. Initializing with a config file does not load the weights associated with the model, only the
...
`}}),Zn=new De({props:{$$slots:{default:[nL]},$$scope:{ctx:x}}}),es=new fe({props:{anchor:"transformers.TFXLMRobertaModel.call.example",$$slots:{default:[sL]},$$scope:{ctx:x}}}),Fr=new Be({}),xr=new A({props:{name:"class transformers.TFXLMRobertaForMaskedLM",anchor:"transformers.TFXLMRobertaForMaskedLM",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.TFXLMRobertaForMaskedLM.config",description:`<strong>config</strong> (<a href="/docs/transformers/main/en/model_doc/xlm-roberta#transformers.XLMRobertaConfig">XLMRobertaConfig</a>) &#x2014; Model configuration class with all the parameters of the
model. Initializing with a config file does not load the weights associated with the model, only the
...
`}}),ns=new De({props:{$$slots:{default:[rL]},$$scope:{ctx:x}}}),ss=new fe({props:{anchor:"transformers.TFXLMRobertaForMaskedLM.call.example",$$slots:{default:[iL]},$$scope:{ctx:x}}}),as=new fe({props:{anchor:"transformers.TFXLMRobertaForMaskedLM.call.example-2",$$slots:{default:[lL]},$$scope:{ctx:x}}}),jr=new Be({}),Xr=new A({props:{name:"class transformers.TFXLMRobertaForSequenceClassification",anchor:"transformers.TFXLMRobertaForSequenceClassification",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.TFXLMRobertaForSequenceClassification.config",description:`<strong>config</strong> (<a href="/docs/transformers/main/en/model_doc/xlm-roberta#transformers.XLMRobertaConfig">XLMRobertaConfig</a>) &#x2014; Model configuration class with all the parameters of the
model. Initializing with a config file does not load the weights associated with the model, only the
...
`}}),ls=new De({props:{$$slots:{default:[cL]},$$scope:{ctx:x}}}),ds=new fe({props:{anchor:"transformers.TFXLMRobertaForSequenceClassification.call.example",$$slots:{default:[pL]},$$scope:{ctx:x}}}),cs=new fe({props:{anchor:"transformers.TFXLMRobertaForSequenceClassification.call.example-2",$$slots:{default:[hL]},$$scope:{ctx:x}}}),Dr=new Be({}),Sr=new A({props:{name:"class transformers.TFXLMRobertaForMultipleChoice",anchor:"transformers.TFXLMRobertaForMultipleChoice",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.TFXLMRobertaForMultipleChoice.config",description:`<strong>config</strong> (<a href="/docs/transformers/main/en/model_doc/xlm-roberta#transformers.XLMRobertaConfig">XLMRobertaConfig</a>) &#x2014; Model configuration class with all the parameters of the
model. Initializing with a config file does not load the weights associated with the model, only the
...
`}}),ms=new De({props:{$$slots:{default:[uL]},$$scope:{ctx:x}}}),us=new fe({props:{anchor:"transformers.TFXLMRobertaForMultipleChoice.call.example",$$slots:{default:[fL]},$$scope:{ctx:x}}}),Kr=new Be({}),Vr=new A({props:{name:"class transformers.TFXLMRobertaForTokenClassification",anchor:"transformers.TFXLMRobertaForTokenClassification",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.TFXLMRobertaForTokenClassification.config",description:`<strong>config</strong> (<a href="/docs/transformers/main/en/model_doc/xlm-roberta#transformers.XLMRobertaConfig">XLMRobertaConfig</a>) &#x2014; Model configuration class with all the parameters of the
model. Initializing with a config file does not load the weights associated with the model, only the
...
`}}),_s=new De({props:{$$slots:{default:[_L]},$$scope:{ctx:x}}}),bs=new fe({props:{anchor:"transformers.TFXLMRobertaForTokenClassification.call.example",$$slots:{default:[bL]},$$scope:{ctx:x}}}),ks=new fe({props:{anchor:"transformers.TFXLMRobertaForTokenClassification.call.example-2",$$slots:{default:[kL]},$$scope:{ctx:x}}}),ti=new Be({}),oi=new A({props:{name:"class transformers.TFXLMRobertaForQuestionAnswering",anchor:"transformers.TFXLMRobertaForQuestionAnswering",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.TFXLMRobertaForQuestionAnswering.config",description:`<strong>config</strong> (<a href="/docs/transformers/main/en/model_doc/xlm-roberta#transformers.XLMRobertaConfig">XLMRobertaConfig</a>) &#x2014; Model configuration class with all the parameters of the
model. Initializing with a config file does not load the weights associated with the model, only the
...
`}}),Fs=new De({props:{$$slots:{default:[$L]},$$scope:{ctx:x}}}),xs=new fe({props:{anchor:"transformers.FlaxXLMRobertaModel.__call__.example",$$slots:{default:[ML]},$$scope:{ctx:x}}}),ki=new Be({}),vi=new A({props:{name:"class transformers.FlaxXLMRobertaForMaskedLM",anchor:"transformers.FlaxXLMRobertaForMaskedLM",parameters:[{name:"config",val:": RobertaConfig"},{name:"input_shape",val:": typing.Tuple = (1, 1)"},{name:"seed",val:": int = 0"},{name:"dtype",val:": dtype = <class 'jax.numpy.float32'>"},{name:"_do_init",val:": bool = True"},{name:"gradient_checkpointing",val:": bool = False"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.FlaxXLMRobertaForMaskedLM.config",description:`<strong>config</strong> (<a href="/docs/transformers/main/en/model_doc/xlm-roberta#transformers.XLMRobertaConfig">XLMRobertaConfig</a>) &#x2014; Model configuration class with all the parameters of the
model. Initializing with a config file does not load the weights associated with the model, only the
...
`}}),Os=new De({props:{$$slots:{default:[qL]},$$scope:{ctx:x}}}),Ns=new fe({props:{anchor:"transformers.FlaxXLMRobertaForTokenClassification.__call__.example",$$slots:{default:[CL]},$$scope:{ctx:x}}}),ll=new Be({}),dl=new A({props:{name:"class transformers.FlaxXLMRobertaForQuestionAnswering",anchor:"transformers.FlaxXLMRobertaForQuestionAnswering",parameters:[{name:"config",val:": RobertaConfig"},{name:"input_shape",val:": typing.Tuple = (1, 1)"},{name:"seed",val:": int = 0"},{name:"dtype",val:": dtype = <class 'jax.numpy.float32'>"},{name:"_do_init",val:": bool = True"},{name:"gradient_checkpointing",val:": bool = False"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.FlaxXLMRobertaForQuestionAnswering.config",description:`<strong>config</strong> (<a href="/docs/transformers/main/en/model_doc/xlm-roberta#transformers.XLMRobertaConfig">XLMRobertaConfig</a>) &#x2014; Model configuration class with all the parameters of the
model. Initializing with a config file does not load the weights associated with the model, only the
...
data.`),ve=c(),B=s("p"),Le=o("The abstract from the paper is the following:"),ye=c(),W=s("p"),ue=s("em"),Ee=o(`This paper shows that pretraining multilingual language models at scale leads to significant performance gains for a
...
language from the input ids.`),j=c(),pe=s("li"),K=o("This implementation is the same as RoBERTa. Refer to the "),me=s("a"),je=o("documentation of RoBERTa"),V=o(` for usage examples
...
XLMRoBERTa `),Ie=s("a"),Ge=o("xlm-roberta-base"),Y=o(" architecture."),Qe=c(),Oe=s("h2"),le=s("a"),We=s("span"),y(ee.$$.fragment),Ye=c(),hc=s("span"),Rf=o("XLMRobertaTokenizer"),pm=c(),nt=s("div"),y(ra.$$.fragment),Lf=c(),io=s("p"),Ef=o("Adapted from "),Cl=s("a"),zf=o("RobertaTokenizer"),qf=o(" and "),jl=s("a"),Cf=o("XLNetTokenizer"),jf=o(`. Based on
...
this superclass for more information regarding those methods.`),Df=c(),go=s("div"),y(da.$$.fragment),Sf=c(),mc=s("p"),Bf=o(`Build model inputs from a sequence or a pair of sequence for sequence classification tasks by concatenating and
adding special tokens. An XLM-RoBERTa sequence has the following format:`),Wf=c(),ca=s("ul"),Pl=s("li"),Uf=o("single sequence: "),uc=s("code"),Qf=o("<s> X </s>"),Hf=c(),Al=s("li"),Kf=o("pair of sequences: "),fc=s("code"),Vf=o("<s> A </s></s> B </s>"),Jf=c(),vn=s("div"),y(pa.$$.fragment),Gf=c(),ha=s("p"),Yf=o(`Retrieve sequence ids from a token list that has no special tokens added. This method is called when adding
...
not make use of token type ids, therefore a list of zeros is returned.`),um=c(),Ro=s("h2"),$n=s("a"),Mc=s("span"),y(Ta.$$.fragment),Cg=c(),Fc=s("span"),jg=o("XLMRobertaModel"),fm=c(),mt=s("div"),y(wa.$$.fragment),Xg=c(),xc=s("p"),Pg=o("The bare XLM-RoBERTa Model transformer outputting raw hidden-states without any specific head on top."),Ag=c(),$a=s("p"),Og=o("This model inherits from "),Wl=s("a"),Ng=o("PreTrainedModel"),Ig=o(`. Check the superclass documentation for the generic methods the
...
alongside usage examples.`),V_=c(),Ft=s("div"),y(Wa.$$.fragment),J_=c(),Co=s("p"),G_=o("The "),Yl=s("a"),Y_=o("RobertaForMaskedLM"),Z_=o(" forward method, overrides the "),Pc=s("code"),eb=o("__call__"),tb=o(" special method."),ob=c(),y(zn.$$.fragment),nb=c(),y(qn.$$.fragment),sb=c(),y(Cn.$$.fragment),vm=c(),jo=s("h2"),jn=s("a"),Ac=s("span"),y(Ua.$$.fragment),ab=c(),Oc=s("span"),rb=o("XLMRobertaForSequenceClassification"),ym=c(),gt=s("div"),y(Qa.$$.fragment),ib=c(),Nc=s("p"),lb=o(`XLM-RoBERTa Model transformer with a sequence classification/regression head on top (a linear layer on top of the
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),mb=c(),Ka=s("p"),ub=o("This model is also a PyTorch "),Va=s("a"),fb=o("torch.nn.Module"),gb=o(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
...
documentation alongside usage examples.`),yb=c(),ht=s("div"),y(Ga.$$.fragment),Tb=c(),Xo=s("p"),wb=o("The "),td=s("a"),$b=o("RobertaForSequenceClassification"),Mb=o(" forward method, overrides the "),Ic=s("code"),Fb=o("__call__"),xb=o(" special method."),Rb=c(),y(Xn.$$.fragment),Lb=c(),y(Pn.$$.fragment),Eb=c(),y(An.$$.fragment),zb=c(),y(On.$$.fragment),qb=c(),y(Nn.$$.fragment),Tm=c(),Po=s("h2"),In=s("a"),Dc=s("span"),y(Ya.$$.fragment),Cb=c(),Sc=s("span"),jb=o("XLMRobertaForMultipleChoice"),wm=c(),_t=s("div"),y(Za.$$.fragment),Xb=c(),Bc=s("p"),Pb=o(`XLM-RoBERTa Model with a multiple choice classification head on top (a linear layer on top of the pooled output and
...
alongside usage examples.`),Vb=c(),Ut=s("div"),y(sr.$$.fragment),Jb=c(),Ao=s("p"),Gb=o("The "),sd=s("a"),Yb=o("RobertaForMultipleChoice"),Zb=o(" forward method, overrides the "),Wc=s("code"),ek=o("__call__"),tk=o(" special method."),ok=c(),y(Dn.$$.fragment),nk=c(),y(Sn.$$.fragment),$m=c(),Oo=s("h2"),Bn=s("a"),Uc=s("span"),y(ar.$$.fragment),sk=c(),Qc=s("span"),ak=o("XLMRobertaForTokenClassification"),Mm=c(),bt=s("div"),y(rr.$$.fragment),rk=c(),Hc=s("p"),ik=o(`XLM-RoBERTa Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g.
...
documentation alongside usage examples.`),vk=c(),xt=s("div"),y(pr.$$.fragment),yk=c(),No=s("p"),Tk=o("The "),id=s("a"),wk=o("RobertaForTokenClassification"),$k=o(" forward method, overrides the "),Kc=s("code"),Mk=o("__call__"),Fk=o(" special method."),xk=c(),y(Wn.$$.fragment),Rk=c(),y(Un.$$.fragment),Lk=c(),y(Qn.$$.fragment),Fm=c(),Io=s("h2"),Hn=s("a"),Vc=s("span"),y(hr.$$.fragment),Ek=c(),Jc=s("span"),zk=o("XLMRobertaForQuestionAnswering"),xm=c(),kt=s("div"),y(mr.$$.fragment),qk=c(),Do=s("p"),Ck=o(`XLM-RoBERTa Model with a span classification head on top for extractive question-answering tasks like SQuAD (a
...
alongside usage examples.`),Jk=c(),Rt=s("div"),y(br.$$.fragment),Gk=c(),So=s("p"),Yk=o("The "),cd=s("a"),Zk=o("RobertaForQuestionAnswering"),ev=o(" forward method, overrides the "),Zc=s("code"),tv=o("__call__"),ov=o(" special method."),nv=c(),y(Kn.$$.fragment),sv=c(),y(Vn.$$.fragment),av=c(),y(Jn.$$.fragment),Rm=c(),Bo=s("h2"),Gn=s("a"),ep=s("span"),y(kr.$$.fragment),rv=c(),tp=s("span"),iv=o("TFXLMRobertaModel"),Lm=c(),st=s("div"),y(vr.$$.fragment),lv=c(),op=s("p"),dv=o("The bare XLM-RoBERTa Model transformer outputting raw hidden-states without any specific head on top."),cv=c(),yr=s("p"),pv=o("This model inherits from "),pd=s("a"),hv=o("TFPreTrainedModel"),mv=o(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
documentation alongside usage examples.`),$y=c(),Et=s("div"),y(Ir.$$.fragment),My=c(),Ko=s("p"),Fy=o("The "),kd=s("a"),xy=o("TFRobertaForSequenceClassification"),Ry=o(" forward method, overrides the "),pp=s("code"),Ly=o("__call__"),Ey=o(" special method."),zy=c(),y(ls.$$.fragment),qy=c(),y(ds.$$.fragment),Cy=c(),y(cs.$$.fragment),jm=c(),Vo=s("h2"),ps=s("a"),hp=s("span"),y(Dr.$$.fragment),jy=c(),mp=s("span"),Xy=o("TFXLMRobertaForMultipleChoice"),Xm=c(),it=s("div"),y(Sr.$$.fragment),Py=c(),up=s("p"),Ay=o(`Roberta Model with a multiple choice classification head on top (a linear layer on top of the pooled output and a
softmax) e.g. for RocStories/SWAG tasks.`),Oy=c(),Br=s("p"),Ny=o("This model inherits from "),vd=s("a"),Iy=o("TFPreTrainedModel"),Dy=o(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Sy=c(),Wr=s("p"),By=o("This model is also a "),Ur=s("a"),Wy=o("tf.keras.Model"),Uy=o(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Qy=c(),y(hs.$$.fragment),Hy=c(),Qr=s("p"),Ky=o("This class overrides "),yd=s("a"),Vy=o("TFRobertaForMultipleChoice"),Jy=o(`. Please check the superclass for the appropriate documentation
alongside usage examples.`),Gy=c(),Ht=s("div"),y(Hr.$$.fragment),Yy=c(),Jo=s("p"),Zy=o("The "),Td=s("a"),eT=o("TFRobertaForMultipleChoice"),tT=o(" forward method, overrides the "),fp=s("code"),oT=o("__call__"),nT=o(" special method."),sT=c(),y(ms.$$.fragment),aT=c(),y(us.$$.fragment),Pm=c(),Go=s("h2"),fs=s("a"),gp=s("span"),y(Kr.$$.fragment),rT=c(),_p=s("span"),iT=o("TFXLMRobertaForTokenClassification"),Am=c(),lt=s("div"),y(Vr.$$.fragment),lT=c(),bp=s("p"),dT=o(`XLM-RoBERTa Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g.
...
layers on top of the hidden-states output to compute `),Tp=s("code"),AT=o("span start logits"),OT=o(" and "),wp=s("code"),NT=o("span end logits"),IT=o(")."),DT=c(),ni=s("p"),ST=o("This model inherits from "),Fd=s("a"),BT=o("TFPreTrainedModel"),WT=o(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),UT=c(),si=s("p"),QT=o("This model is also a "),ai=s("a"),HT=o("tf.keras.Model"),KT=o(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),VT=c(),y(ys.$$.fragment),JT=c(),ri=s("p"),GT=o("This class overrides "),$p=s("code"),YT=o("TFRobertaForQuestionAnsweringSimple"),ZT=o(`. Please check the superclass for the appropriate
...
usage examples.`),jw=c(),Kt=s("div"),y(bi.$$.fragment),Xw=c(),nn=s("p"),Pw=o("The "),Cp=s("code"),Aw=o("FlaxRobertaPreTrainedModel"),Ow=o(" forward method, overrides the "),jp=s("code"),Nw=o("__call__"),Iw=o(" special method."),Dw=c(),y(Fs.$$.fragment),Sw=c(),y(xs.$$.fragment),Sm=c(),sn=s("h2"),Rs=s("a"),Xp=s("span"),y(ki.$$.fragment),Bw=c(),Pp=s("span"),Ww=o("FlaxXLMRobertaForMaskedLM"),Bm=c(),pt=s("div"),y(vi.$$.fragment),Uw=c(),an=s("p"),Qw=o("XLM-RoBERTa Model with a "),Ap=s("code"),Hw=o("language modeling"),Kw=o(` head on top.
This model inherits from `),Ed=s("a"),Vw=o("FlaxPreTrainedModel"),Jw=o(`. Check the superclass documentation for the generic methods the
...
alongside usage examples.`),f$=c(),Vt=s("div"),y(Ri.$$.fragment),g$=c(),rn=s("p"),_$=o("The "),Bp=s("code"),b$=o("FlaxRobertaPreTrainedModel"),k$=o(" forward method, overrides the "),Wp=s("code"),v$=o("__call__"),y$=o(" special method."),T$=c(),y(Ls.$$.fragment),w$=c(),y(Es.$$.fragment),Wm=c(),ln=s("h2"),zs=s("a"),Up=s("span"),y(Li.$$.fragment),$$=c(),Qp=s("span"),M$=o("FlaxXLMRobertaForSequenceClassification"),Um=c(),Ze=s("div"),y(Ei.$$.fragment),F$=c(),Hp=s("p"),x$=o(`XLM-RoBERTa Model transformer with a sequence classification/regression head on top (a linear layer on top of the
...
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),P$=c(),Kp=s("p"),A$=o("Finally, this model supports inherent JAX features such as:"),O$=c(),po=s("ul"),Vp=s("li"),ji=s("a"),N$=o("Just-In-Time (JIT) compilation"),I$=c(),Jp=s("li"),Xi=s("a"),D$=o("Automatic Differentiation"),S$=c(),Gp=s("li"),Pi=s("a"),B$=o("Vectorization"),W$=c(),Yp=s("li"),Ai=s("a"),U$=o("Parallelization"),Q$=c(),Oi=s("p"),H$=o("This class overrides "),Cd=s("a"),K$=o("FlaxRobertaForSequenceClassification"),V$=o(`. Please check the superclass for the appropriate
...
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),m1=c(),Bi=s("p"),u1=o("This model is also a Flax Linen "),Wi=s("a"),f1=o("flax.linen.Module"),g1=o(`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),_1=c(),sh=s("p"),b1=o("Finally, this model supports inherent JAX features such as:"),k1=c(),ho=s("ul"),ah=s("li"),Ui=s("a"),v1=o("Just-In-Time (JIT) compilation"),y1=c(),rh=s("li"),Qi=s("a"),T1=o("Automatic Differentiation"),w1=c(),ih=s("li"),Hi=s("a"),$1=o("Vectorization"),M1=c(),lh=s("li"),Ki=s("a"),F1=o("Parallelization"),x1=c(),Vi=s("p"),R1=o("This class overrides "),Xd=s("a"),L1=o("FlaxRobertaForMultipleChoice"),E1=o(`. Please check the superclass for the appropriate
documentation alongside usage examples.`),z1=c(),Gt=s("div"),y(Ji.$$.fragment),q1=c(),pn=s("p"),C1=o("The "),dh=s("code"),j1=o("FlaxRobertaPreTrainedModel"),X1=o(" forward method, overrides the "),ch=s("code"),P1=o("__call__"),A1=o(" special method."),O1=c(),y(Xs.$$.fragment),N1=c(),y(Ps.$$.fragment),Km=c(),hn=s("h2"),As=s("a"),ph=s("span"),y(Gi.$$.fragment),I1=c(),hh=s("span"),D1=o("FlaxXLMRobertaForTokenClassification"),Vm=c(),tt=s("div"),y(Yi.$$.fragment),S1=c(),mh=s("p"),B1=o(`XLM-RoBERTa Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g.
for Named-Entity-Recognition (NER) tasks.`),W1=c(),Zi=s("p"),U1=o("This model inherits from "),Pd=s("a"),Q1=o("FlaxPreTrainedModel"),H1=o(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),K1=c(),el=s("p"),V1=o("This model is also a Flax Linen "),tl=s("a"),J1=o("flax.linen.Module"),G1=o(`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
...
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),AM=c(),Mh=s("p"),OM=o("Finally, this model supports inherent JAX features such as:"),NM=c(),uo=s("ul"),Fh=s("li"),ml=s("a"),IM=o("Just-In-Time (JIT) compilation"),DM=c(),xh=s("li"),ul=s("a"),SM=o("Automatic Differentiation"),BM=c(),Rh=s("li"),fl=s("a"),WM=o("Vectorization"),UM=c(),Lh=s("li"),gl=s("a"),QM=o("Parallelization"),HM=c(),_l=s("p"),KM=o("This class overrides "),Nd=s("a"),VM=o("FlaxRobertaForQuestionAnswering"),JM=o(`. Please check the superclass for the appropriate
...
Wenzek, Francisco Guzm\xE1n, Edouard Grave, Myle Ott, Luke Zettlemoyer and Veselin Stoyanov. It is based on Facebook\u2019s
RoBERTa model released in 2019. It is a large multi-lingual language model, trained on 2.5TB of filtered CommonCrawl
data.`),yl.forEach(t),ve=p(i),B=a(i,"P",{});var Nh=r(B);Le=n(Nh,"The abstract from the paper is the following:"),Nh.forEach(t),ye=p(i),W=a(i,"P",{});var Ih=r(W);ue=a(Ih,"EM",{});var Dh=r(ue);Ee=n(Dh,`This paper shows that pretraining multilingual language models at scale leads to significant performance gains for a
wide range of cross-lingual transfer tasks. We train a Transformer-based masked language model on one hundred
languages, using more than two terabytes of filtered CommonCrawl data. Our model, dubbed XLM-R, significantly
outperforms multilingual BERT (mBERT) on a variety of cross-lingual benchmarks, including +13.8% average accuracy on
XNLI, +12.3% average F1 score on MLQA, and +2.1% average F1 score on NER. XLM-R performs particularly well on
...
language from the input ids.`),wl.forEach(t),j=p(Tl),pe=a(Tl,"LI",{});var $l=r(pe);K=n($l,"This implementation is the same as RoBERTa. Refer to the "),me=a($l,"A",{href:!0});var Wh=r(me);je=n(Wh,"documentation of RoBERTa"),Wh.forEach(t),V=n($l,` for usage examples
...
this superclass for more information regarding those methods.`),Rl.forEach(t),Df=p(vt),go=a(vt,"DIV",{class:!0});var kn=r(go);T(da.$$.fragment,kn),Sf=p(kn),mc=a(kn,"P",{});var am=r(mc);Bf=n(am,`Build model inputs from a sequence or a pair of sequence for sequence classification tasks by concatenating and
adding special tokens. An XLM-RoBERTa sequence has the following format:`),am.forEach(t),Wf=p(kn),ca=a(kn,"UL",{});var Ll=r(ca);Pl=a(Ll,"LI",{});var Id=r(Pl);Uf=n(Id,"single sequence: "),uc=a(Id,"CODE",{});var rm=r(uc);Qf=n(rm,"<s> X </s>"),rm.forEach(t),Id.forEach(t),Hf=p(Ll),Al=a(Ll,"LI",{});var Dd=r(Al);Kf=n(Dd,"pair of sequences: "),fc=a(Dd,"CODE",{});var im=r(fc);Vf=n(im,"<s> A </s></s> B </s>"),im.forEach(t),Dd.forEach(t),Ll.forEach(t),kn.forEach(t),Jf=p(vt),vn=a(vt,"DIV",{class:!0});var El=r(vn);T(pa.$$.fragment,El),Gf=p(El),ha=a(El,"P",{});var zl=r(ha);Yf=n(zl,`Retrieve sequence ids from a token list that has no special tokens added. This method is called when adding
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),cu.forEach(t),b_=p(to),Xa=a(to,"P",{});var pu=r(Xa);k_=n(pu,"This class overrides "),Kl=a(pu,"A",{href:!0});var X2=r(Kl);v_=n(X2,"RobertaForCausalLM"),X2.forEach(t),y_=n(pu,`. Please check the superclass for the appropriate documentation
alongside usage examples.`),pu.forEach(t),T_=p(to),Wt=a(to,"DIV",{class:!0});var Ws=r(Wt);T(Pa.$$.fragment,Ws),w_=p(Ws),zo=a(Ws,"P",{});var Wd=r(zo);$_=n(Wd,"The "),Vl=a(Wd,"A",{href:!0});var P2=r(Vl);M_=n(P2,"RobertaForCausalLM"),P2.forEach(t),F_=n(Wd," forward method, overrides the "),qc=a(Wd,"CODE",{});var A2=r(qc);x_=n(A2,"__call__"),A2.forEach(t),R_=n(Wd," special method."),Wd.forEach(t),L_=p(Ws),T(Rn.$$.fragment,Ws),E_=p(Ws),T(Ln.$$.fragment,Ws),Ws.forEach(t),to.forEach(t),bm=p(i),qo=a(i,"H2",{class:!0});var hu=r(qo);En=a(hu,"A",{id:!0,class:!0,href:!0});var O2=r(En);Cc=a(O2,"SPAN",{});var N2=r(Cc);T(Aa.$$.fragment,N2),N2.forEach(t),O2.forEach(t),z_=p(hu),jc=a(hu,"SPAN",{});var I2=r(jc);q_=n(I2,"XLMRobertaForMaskedLM"),I2.forEach(t),hu.forEach(t),km=p(i),ft=a(i,"DIV",{class:!0});var oo=r(ft);T(Oa.$$.fragment,oo),C_=p(oo),Na=a(oo,"P",{});var mu=r(Na);j_=n(mu,"XLM-RoBERTa Model with a "),Xc=a(mu,"CODE",{});var D2=r(Xc);X_=n(D2,"language modeling"),D2.forEach(t),P_=n(mu," head on top."),mu.forEach(t),A_=p(oo),Ia=a(oo,"P",{});var uu=r(Ia);O_=n(uu,"This model inherits from "),Jl=a(uu,"A",{href:!0});var S2=r(Jl);N_=n(S2,"PreTrainedModel"),S2.forEach(t),I_=n(uu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),uu.forEach(t),D_=p(oo),Da=a(oo,"P",{});var fu=r(Da);S_=n(fu,"This model is also a PyTorch "),Sa=a(fu,"A",{href:!0,rel:!0});var B2=r(Sa);B_=n(B2,"torch.nn.Module"),B2.forEach(t),W_=n(fu,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),fu.forEach(t),U_=p(oo),Ba=a(oo,"P",{});var gu=r(Ba);Q_=n(gu,"This class overrides "),Gl=a(gu,"A",{href:!0});var W2=r(Gl);H_=n(W2,"RobertaForMaskedLM"),W2.forEach(t),K_=n(gu,`. Please check the superclass for the appropriate documentation
alongside usage examples.`),gu.forEach(t),V_=p(oo),Ft=a(oo,"DIV",{class:!0});var vo=r(Ft);T(Wa.$$.fragment,vo),J_=p(vo),Co=a(vo,"P",{});var Ud=r(Co);G_=n(Ud,"The "),Yl=a(Ud,"A",{href:!0});var U2=r(Yl);Y_=n(U2,"RobertaForMaskedLM"),U2.forEach(t),Z_=n(Ud," forward method, overrides the "),Pc=a(Ud,"CODE",{});var Q2=r(Pc);eb=n(Q2,"__call__"),Q2.forEach(t),tb=n(Ud," special method."),Ud.forEach(t),ob=p(vo),T(zn.$$.fragment,vo),nb=p(vo),T(qn.$$.fragment,vo),sb=p(vo),T(Cn.$$.fragment,vo),vo.forEach(t),oo.forEach(t),vm=p(i),jo=a(i,"H2",{class:!0});var _u=r(jo);jn=a(_u,"A",{id:!0,class:!0,href:!0});var H2=r(jn);Ac=a(H2,"SPAN",{});var K2=r(Ac);T(Ua.$$.fragment,K2),K2.forEach(t),H2.forEach(t),ab=p(_u),Oc=a(_u,"SPAN",{});var V2=r(Oc);rb=n(V2,"XLMRobertaForSequenceClassification"),V2.forEach(t),_u.forEach(t),ym=p(i),gt=a(i,"DIV",{class:!0});var no=r(gt);T(Qa.$$.fragment,no),ib=p(no),Nc=a(no,"P",{});var J2=r(Nc);lb=n(J2,`XLM-RoBERTa Model transformer with a sequence classification/regression head on top (a linear layer on top of the
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),bu.forEach(t),mb=p(no),Ka=a(no,"P",{});var ku=r(Ka);ub=n(ku,"This model is also a PyTorch "),Va=a(ku,"A",{href:!0,rel:!0});var Y2=r(Va);fb=n(Y2,"torch.nn.Module"),Y2.forEach(t),gb=n(ku,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Tu.forEach(t),Db=p(so),tr=a(so,"P",{});var wu=r(tr);Sb=n(wu,"This model is also a PyTorch "),or=a(wu,"A",{href:!0,rel:!0});var iF=r(or);Bb=n(iF,"torch.nn.Module"),iF.forEach(t),Wb=n(wu,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),wu.forEach(t),Ub=p(so),nr=a(so,"P",{});var $u=r(nr);Qb=n($u,"This class overrides "),nd=a($u,"A",{href:!0});var lF=r(nd);Hb=n(lF,"RobertaForMultipleChoice"),lF.forEach(t),Kb=n($u,`. Please check the superclass for the appropriate documentation
alongside usage examples.`),$u.forEach(t),Vb=p(so),Ut=a(so,"DIV",{class:!0});var Us=r(Ut);T(sr.$$.fragment,Us),Jb=p(Us),Ao=a(Us,"P",{});var Hd=r(Ao);Gb=n(Hd,"The "),sd=a(Hd,"A",{href:!0});var dF=r(sd);Yb=n(dF,"RobertaForMultipleChoice"),dF.forEach(t),Zb=n(Hd," forward method, overrides the "),Wc=a(Hd,"CODE",{});var cF=r(Wc);ek=n(cF,"__call__"),cF.forEach(t),tk=n(Hd," special method."),Hd.forEach(t),ok=p(Us),T(Dn.$$.fragment,Us),nk=p(Us),T(Sn.$$.fragment,Us),Us.forEach(t),so.forEach(t),$m=p(i),Oo=a(i,"H2",{class:!0});var Mu=r(Oo);Bn=a(Mu,"A",{id:!0,class:!0,href:!0});var pF=r(Bn);Uc=a(pF,"SPAN",{});var hF=r(Uc);T(ar.$$.fragment,hF),hF.forEach(t),pF.forEach(t),sk=p(Mu),Qc=a(Mu,"SPAN",{});var mF=r(Qc);ak=n(mF,"XLMRobertaForTokenClassification"),mF.forEach(t),Mu.forEach(t),Mm=p(i),bt=a(i,"DIV",{class:!0});var ao=r(bt);T(rr.$$.fragment,ao),rk=p(ao),Hc=a(ao,"P",{});var uF=r(Hc);ik=n(uF,`XLM-RoBERTa Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g.
...
documentation alongside usage examples.`),Ru.forEach(t),vk=p(ao),xt=a(ao,"DIV",{class:!0});var yo=r(xt);T(pr.$$.fragment,yo),yk=p(yo),No=a(yo,"P",{});var Kd=r(No);Tk=n(Kd,"The "),id=a(Kd,"A",{href:!0});var bF=r(id);wk=n(bF,"RobertaForTokenClassification"),bF.forEach(t),$k=n(Kd," forward method, overrides the "),Kc=a(Kd,"CODE",{});var kF=r(Kc);Mk=n(kF,"__call__"),kF.forEach(t),Fk=n(Kd," special method."),Kd.forEach(t),xk=p(yo),T(Wn.$$.fragment,yo),Rk=p(yo),T(Un.$$.fragment,yo),Lk=p(yo),T(Qn.$$.fragment,yo),yo.forEach(t),ao.forEach(t),Fm=p(i),Io=a(i,"H2",{class:!0});var Lu=r(Io);Hn=a(Lu,"A",{id:!0,class:!0,href:!0});var vF=r(Hn);Vc=a(vF,"SPAN",{});var yF=r(Vc);T(hr.$$.fragment,yF),yF.forEach(t),vF.forEach(t),Ek=p(Lu),Jc=a(Lu,"SPAN",{});var TF=r(Jc);zk=n(TF,"XLMRobertaForQuestionAnswering"),TF.forEach(t),Lu.forEach(t),xm=p(i),kt=a(i,"DIV",{class:!0});var ro=r(kt);T(mr.$$.fragment,ro),qk=p(ro),Do=a(ro,"P",{});var Vd=r(Do);Ck=n(Vd,`XLM-RoBERTa Model with a span classification head on top for extractive question-answering tasks like SQuAD (a
linear layers on top of the hidden-states output to compute `),Gc=a(Vd,"CODE",{});var wF=r(Gc);jk=n(wF,"span start logits"),wF.forEach(t),Xk=n(Vd," and "),Yc=a(Vd,"CODE",{});var $F=r(Yc);Pk=n($F,"span end logits"),$F.forEach(t),Ak=n(Vd,")."),Vd.forEach(t),Ok=p(ro),ur=a(ro,"P",{});var Eu=r(ur);Nk=n(Eu,"This model inherits from "),ld=a(Eu,"A",{href:!0});var MF=r(ld);Ik=n(MF,"PreTrainedModel"),MF.forEach(t),Dk=n(Eu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Eu.forEach(t),Sk=p(ro),fr=a(ro,"P",{});var zu=r(fr);Bk=n(zu,"This model is also a PyTorch "),gr=a(zu,"A",{href:!0,rel:!0});var FF=r(gr);Wk=n(FF,"torch.nn.Module"),FF.forEach(t),Uk=n(zu,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),zu.forEach(t),Qk=p(ro),_r=a(ro,"P",{});var qu=r(_r);Hk=n(qu,"This class overrides "),dd=a(qu,"A",{href:!0});var xF=r(dd);Kk=n(xF,"RobertaForQuestionAnswering"),xF.forEach(t),Vk=n(qu,`. Please check the superclass for the appropriate documentation
alongside usage examples.`),qu.forEach(t),Jk=p(ro),Rt=a(ro,"DIV",{class:!0});var To=r(Rt);T(br.$$.fragment,To),Gk=p(To),So=a(To,"P",{});var Jd=r(So);Yk=n(Jd,"The "),cd=a(Jd,"A",{href:!0});var RF=r(cd);Zk=n(RF,"RobertaForQuestionAnswering"),RF.forEach(t),ev=n(Jd," forward method, overrides the "),Zc=a(Jd,"CODE",{});var LF=r(Zc);tv=n(LF,"__call__"),LF.forEach(t),ov=n(Jd," special method."),Jd.forEach(t),nv=p(To),T(Kn.$$.fragment,To),sv=p(To),T(Vn.$$.fragment,To),av=p(To),T(Jn.$$.fragment,To),To.forEach(t),ro.forEach(t),Rm=p(i),Bo=a(i,"H2",{class:!0});var Cu=r(Bo);Gn=a(Cu,"A",{id:!0,class:!0,href:!0});var EF=r(Gn);ep=a(EF,"SPAN",{});var zF=r(ep);T(kr.$$.fragment,zF),zF.forEach(t),EF.forEach(t),rv=p(Cu),tp=a(Cu,"SPAN",{});var qF=r(tp);iv=n(qF,"TFXLMRobertaModel"),qF.forEach(t),Cu.forEach(t),Lm=p(i),st=a(i,"DIV",{class:!0});var jt=r(st);T(vr.$$.fragment,jt),lv=p(jt),op=a(jt,"P",{});var CF=r(op);dv=n(CF,"The bare XLM-RoBERTa Model transformer outputting raw hidden-states without any specific head on top."),CF.forEach(t),cv=p(jt),yr=a(jt,"P",{});var ju=r(yr);pv=n(ju,"This model inherits from "),pd=a(ju,"A",{href:!0});var jF=r(pd);hv=n(jF,"TFPreTrainedModel"),jF.forEach(t),mv=n(ju,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
usage examples.`),Pu.forEach(t),wv=p(jt),Qt=a(jt,"DIV",{class:!0});var Qs=r(Qt);T(Mr.$$.fragment,Qs),$v=p(Qs),Wo=a(Qs,"P",{});var Gd=r(Wo);Mv=n(Gd,"The "),md=a(Gd,"A",{href:!0});var AF=r(md);Fv=n(AF,"TFRobertaModel"),AF.forEach(t),xv=n(Gd," forward method, overrides the "),np=a(Gd,"CODE",{});var OF=r(np);Rv=n(OF,"__call__"),OF.forEach(t),Lv=n(Gd," special method."),Gd.forEach(t),Ev=p(Qs),T(Zn.$$.fragment,Qs),zv=p(Qs),T(es.$$.fragment,Qs),Qs.forEach(t),jt.forEach(t),Em=p(i),Uo=a(i,"H2",{class:!0});var Au=r(Uo);ts=a(Au,"A",{id:!0,class:!0,href:!0});var NF=r(ts);sp=a(NF,"SPAN",{});var IF=r(sp);T(Fr.$$.fragment,IF),IF.forEach(t),NF.forEach(t),qv=p(Au),ap=a(Au,"SPAN",{});var DF=r(ap);Cv=n(DF,"TFXLMRobertaForMaskedLM"),DF.forEach(t),Au.forEach(t),zm=p(i),at=a(i,"DIV",{class:!0});var Xt=r(at);T(xr.$$.fragment,Xt),jv=p(Xt),Rr=a(Xt,"P",{});var Ou=r(Rr);Xv=n(Ou,"XLM-RoBERTa Model with a "),rp=a(Ou,"CODE",{});var SF=r(rp);Pv=n(SF,"language modeling"),SF.forEach(t),Av=n(Ou," head on top."),Ou.forEach(t),Ov=p(Xt),Lr=a(Xt,"P",{});var Nu=r(Lr);Nv=n(Nu,"This model inherits from "),ud=a(Nu,"A",{href:!0});var BF=r(ud);Iv=n(BF,"TFPreTrainedModel"),BF.forEach(t),Dv=n(Nu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Nu.forEach(t),Sv=p(Xt),Er=a(Xt,"P",{});var Iu=r(Er);Bv=n(Iu,"This model is also a "),zr=a(Iu,"A",{href:!0,rel:!0});var WF=r(zr);Wv=n(WF,"tf.keras.Model"),WF.forEach(t),Uv=n(Iu,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Iu.forEach(t),Qv=p(Xt),T(os.$$.fragment,Xt),Hv=p(Xt),qr=a(Xt,"P",{});var Du=r(qr);Kv=n(Du,"This class overrides "),fd=a(Du,"A",{href:!0});var UF=r(fd);Vv=n(UF,"TFRobertaForMaskedLM"),UF.forEach(t),Jv=n(Du,`. Please check the superclass for the appropriate documentation
alongside usage examples.`),Du.forEach(t),Gv=p(Xt),Lt=a(Xt,"DIV",{class:!0});var wo=r(Lt);T(Cr.$$.fragment,wo),Yv=p(wo),Qo=a(wo,"P",{});var Yd=r(Qo);Zv=n(Yd,"The "),gd=a(Yd,"A",{href:!0});var QF=r(gd);ey=n(QF,"TFRobertaForMaskedLM"),QF.forEach(t),ty=n(Yd," forward method, overrides the "),ip=a(Yd,"CODE",{});var HF=r(ip);oy=n(HF,"__call__"),HF.forEach(t),ny=n(Yd," special method."),Yd.forEach(t),sy=p(wo),T(ns.$$.fragment,wo),ay=p(wo),T(ss.$$.fragment,wo),ry=p(wo),T(as.$$.fragment,wo),wo.forEach(t),Xt.forEach(t),qm=p(i),Ho=a(i,"H2",{class:!0});var Su=r(Ho);rs=a(Su,"A",{id:!0,class:!0,href:!0});var KF=r(rs);lp=a(KF,"SPAN",{});var VF=r(lp);T(jr.$$.fragment,VF),VF.forEach(t),KF.forEach(t),iy=p(Su),dp=a(Su,"SPAN",{});var JF=r(dp);ly=n(JF,"TFXLMRobertaForSequenceClassification"),JF.forEach(t),Su.forEach(t),Cm=p(i),rt=a(i,"DIV",{class:!0});var Pt=r(rt);T(Xr.$$.fragment,Pt),dy=p(Pt),cp=a(Pt,"P",{});var GF=r(cp);cy=n(GF,`XLM-RoBERTa Model transformer with a sequence classification/regression head on top (a linear layer on top of the
pooled output) e.g. for GLUE tasks.`),GF.forEach(t),py=p(Pt),Pr=a(Pt,"P",{});var Bu=r(Pr);hy=n(Bu,"This model inherits from "),_d=a(Bu,"A",{href:!0});var YF=r(_d);my=n(YF,"TFPreTrainedModel"),YF.forEach(t),uy=n(Bu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Bu.forEach(t),fy=p(Pt),Ar=a(Pt,"P",{});var Wu=r(Ar);gy=n(Wu,"This model is also a "),Or=a(Wu,"A",{href:!0,rel:!0});var ZF=r(Or);_y=n(ZF,"tf.keras.Model"),ZF.forEach(t),by=n(Wu,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Wu.forEach(t),ky=p(Pt),T(is.$$.fragment,Pt),vy=p(Pt),Nr=a(Pt,"P",{});var Uu=r(Nr);yy=n(Uu,"This class overrides "),bd=a(Uu,"A",{href:!0});var e0=r(bd);Ty=n(e0,"TFRobertaForSequenceClassification"),e0.forEach(t),wy=n(Uu,`. Please check the superclass for the appropriate
documentation alongside usage examples.`),Uu.forEach(t),$y=p(Pt),Et=a(Pt,"DIV",{class:!0});var $o=r(Et);T(Ir.$$.fragment,$o),My=p($o),Ko=a($o,"P",{});var Zd=r(Ko);Fy=n(Zd,"The "),kd=a(Zd,"A",{href:!0});var t0=r(kd);xy=n(t0,"TFRobertaForSequenceClassification"),t0.forEach(t),Ry=n(Zd," forward method, overrides the "),pp=a(Zd,"CODE",{});var o0=r(pp);Ly=n(o0,"__call__"),o0.forEach(t),Ey=n(Zd," special method."),Zd.forEach(t),zy=p($o),T(ls.$$.fragment,$o),qy=p($o),T(ds.$$.fragment,$o),Cy=p($o),T(cs.$$.fragment,$o),$o.forEach(t),Pt.forEach(t),jm=p(i),Vo=a(i,"H2",{class:!0});var Qu=r(Vo);ps=a(Qu,"A",{id:!0,class:!0,href:!0});var n0=r(ps);hp=a(n0,"SPAN",{});var s0=r(hp);T(Dr.$$.fragment,s0),s0.forEach(t),n0.forEach(t),jy=p(Qu),mp=a(Qu,"SPAN",{});var a0=r(mp);Xy=n(a0,"TFXLMRobertaForMultipleChoice"),a0.forEach(t),Qu.forEach(t),Xm=p(i),it=a(i,"DIV",{class:!0});var At=r(it);T(Sr.$$.fragment,At),Py=p(At),up=a(At,"P",{});var r0=r(up);Ay=n(r0,`Roberta Model with a multiple choice classification head on top (a linear layer on top of the pooled output and a
softmax) e.g. for RocStories/SWAG tasks.`),r0.forEach(t),Oy=p(At),Br=a(At,"P",{});var Hu=r(Br);Ny=n(Hu,"This model inherits from "),vd=a(Hu,"A",{href:!0});var i0=r(vd);Iy=n(i0,"TFPreTrainedModel"),i0.forEach(t),Dy=n(Hu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Hu.forEach(t),Sy=p(At),Wr=a(At,"P",{});var Ku=r(Wr);By=n(Ku,"This model is also a "),Ur=a(Ku,"A",{href:!0,rel:!0});var l0=r(Ur);Wy=n(l0,"tf.keras.Model"),l0.forEach(t),Uy=n(Ku,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Ku.forEach(t),Qy=p(At),T(hs.$$.fragment,At),Hy=p(At),Qr=a(At,"P",{});var Vu=r(Qr);Ky=n(Vu,"This class overrides "),yd=a(Vu,"A",{href:!0});var d0=r(yd);Vy=n(d0,"TFRobertaForMultipleChoice"),d0.forEach(t),Jy=n(Vu,`. Please check the superclass for the appropriate documentation
alongside usage examples.`),Vu.forEach(t),Gy=p(At),Ht=a(At,"DIV",{class:!0});var Hs=r(Ht);T(Hr.$$.fragment,Hs),Yy=p(Hs),Jo=a(Hs,"P",{});var ec=r(Jo);Zy=n(ec,"The "),Td=a(ec,"A",{href:!0});var c0=r(Td);eT=n(c0,"TFRobertaForMultipleChoice"),c0.forEach(t),tT=n(ec," forward method, overrides the "),fp=a(ec,"CODE",{});var p0=r(fp);oT=n(p0,"__call__"),p0.forEach(t),nT=n(ec," special method."),ec.forEach(t),sT=p(Hs),T(ms.$$.fragment,Hs),aT=p(Hs),T(us.$$.fragment,Hs),Hs.forEach(t),At.forEach(t),Pm=p(i),Go=a(i,"H2",{class:!0});var Ju=r(Go);fs=a(Ju,"A",{id:!0,class:!0,href:!0});var h0=r(fs);gp=a(h0,"SPAN",{});var m0=r(gp);T(Kr.$$.fragment,m0),m0.forEach(t),h0.forEach(t),rT=p(Ju),_p=a(Ju,"SPAN",{});var u0=r(_p);iT=n(u0,"TFXLMRobertaForTokenClassification"),u0.forEach(t),Ju.forEach(t),Am=p(i),lt=a(i,"DIV",{class:!0});var Ot=r(lt);T(Vr.$$.fragment,Ot),lT=p(Ot),bp=a(Ot,"P",{});var f0=r(bp);dT=n(f0,`XLM-RoBERTa Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g.
...
layers on top of the hidden-states output to compute `),Tp=a(oc,"CODE",{});var $0=r(Tp);AT=n($0,"span start logits"),$0.forEach(t),OT=n(oc," and "),wp=a(oc,"CODE",{});var M0=r(wp);NT=n(M0,"span end logits"),M0.forEach(t),IT=n(oc,")."),oc.forEach(t),DT=p(Nt),ni=a(Nt,"P",{});var tf=r(ni);ST=n(tf,"This model inherits from "),Fd=a(tf,"A",{href:!0});var F0=r(Fd);BT=n(F0,"TFPreTrainedModel"),F0.forEach(t),WT=n(tf,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),tf.forEach(t),UT=p(Nt),si=a(Nt,"P",{});var of=r(si);QT=n(of,"This model is also a "),ai=a(of,"A",{href:!0,rel:!0});var x0=r(ai);HT=n(x0,"tf.keras.Model"),x0.forEach(t),KT=n(of,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),of.forEach(t),VT=p(Nt),T(ys.$$.fragment,Nt),JT=p(Nt),ri=a(Nt,"P",{});var nf=r(ri);GT=n(nf,"This class overrides "),$p=a(nf,"CODE",{});var R0=r($p);YT=n(R0,"TFRobertaForQuestionAnsweringSimple"),R0.forEach(t),ZT=n(nf,`. Please check the superclass for the appropriate
...
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),rf.forEach(t),vw=p(It),Rp=a(It,"P",{});var P0=r(Rp);yw=n(P0,"Finally, this model supports inherent JAX features such as:"),P0.forEach(t),Tw=p(It),lo=a(It,"UL",{});var Ks=r(lo);Lp=a(Ks,"LI",{});var A0=r(Lp);mi=a(A0,"A",{href:!0,rel:!0});var O0=r(mi);ww=n(O0,"Just-In-Time (JIT) compilation"),O0.forEach(t),A0.forEach(t),$w=p(Ks),Ep=a(Ks,"LI",{});var N0=r(Ep);ui=a(N0,"A",{href:!0,rel:!0});var I0=r(ui);Mw=n(I0,"Automatic Differentiation"),I0.forEach(t),N0.forEach(t),Fw=p(Ks),zp=a(Ks,"LI",{});var D0=r(zp);fi=a(D0,"A",{href:!0,rel:!0});var S0=r(fi);xw=n(S0,"Vectorization"),S0.forEach(t),D0.forEach(t),Rw=p(Ks),qp=a(Ks,"LI",{});var B0=r(qp);gi=a(B0,"A",{href:!0,rel:!0});var W0=r(gi);Lw=n(W0,"Parallelization"),W0.forEach(t),B0.forEach(t),Ks.forEach(t),Ew=p(It),_i=a(It,"P",{});var lf=r(_i);zw=n(lf,"This class overrides "),Ld=a(lf,"A",{href:!0});var U0=r(Ld);qw=n(U0,"FlaxRobertaModel"),U0.forEach(t),Cw=n(lf,`. Please check the superclass for the appropriate documentation alongside
usage examples.`),lf.forEach(t),jw=p(It),Kt=a(It,"DIV",{class:!0});var Vs=r(Kt);T(bi.$$.fragment,Vs),Xw=p(Vs),nn=a(Vs,"P",{});var sc=r(nn);Pw=n(sc,"The "),Cp=a(sc,"CODE",{});var Q0=r(Cp);Aw=n(Q0,"FlaxRobertaPreTrainedModel"),Q0.forEach(t),Ow=n(sc," forward method, overrides the "),jp=a(sc,"CODE",{});var H0=r(jp);Nw=n(H0,"__call__"),H0.forEach(t),Iw=n(sc," special method."),sc.forEach(t),Dw=p(Vs),T(Fs.$$.fragment,Vs),Sw=p(Vs),T(xs.$$.fragment,Vs),Vs.forEach(t),It.forEach(t),Sm=p(i),sn=a(i,"H2",{class:!0});var df=r(sn);Rs=a(df,"A",{id:!0,class:!0,href:!0});var K0=r(Rs);Xp=a(K0,"SPAN",{});var V0=r(Xp);T(ki.$$.fragment,V0),V0.forEach(t),K0.forEach(t),Bw=p(df),Pp=a(df,"SPAN",{});var J0=r(Pp);Ww=n(J0,"FlaxXLMRobertaForMaskedLM"),J0.forEach(t),df.forEach(t),Bm=p(i),pt=a(i,"DIV",{class:!0});var Dt=r(pt);T(vi.$$.fragment,Dt),Uw=p(Dt),an=a(Dt,"P",{});var ac=r(an);Qw=n(ac,"XLM-RoBERTa Model with a "),Ap=a(ac,"CODE",{});var G0=r(Ap);Hw=n(G0,"language modeling"),G0.forEach(t),Kw=n(ac,` head on top.
This model inherits from `),Ed=a(ac,"A",{href:!0});var Y0=r(Ed);Vw=n(Y0,"FlaxPreTrainedModel"),Y0.forEach(t),Jw=n(ac,`. Check the superclass documentation for the generic methods the
...
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),uf.forEach(t),P$=p(yt),Kp=a(yt,"P",{});var bx=r(Kp);A$=n(bx,"Finally, this model supports inherent JAX features such as:"),bx.forEach(t),O$=p(yt),po=a(yt,"UL",{});var Ys=r(po);Vp=a(Ys,"LI",{});var kx=r(Vp);ji=a(kx,"A",{href:!0,rel:!0});var vx=r(ji);N$=n(vx,"Just-In-Time (JIT) compilation"),vx.forEach(t),kx.forEach(t),I$=p(Ys),Jp=a(Ys,"LI",{});var yx=r(Jp);Xi=a(yx,"A",{href:!0,rel:!0});var Tx=r(Xi);D$=n(Tx,"Automatic Differentiation"),Tx.forEach(t),yx.forEach(t),S$=p(Ys),Gp=a(Ys,"LI",{});var wx=r(Gp);Pi=a(wx,"A",{href:!0,rel:!0});var $x=r(Pi);B$=n($x,"Vectorization"),$x.forEach(t),wx.forEach(t),W$=p(Ys),Yp=a(Ys,"LI",{});var Mx=r(Yp);Ai=a(Mx,"A",{href:!0,rel:!0});var Fx=r(Ai);U$=n(Fx,"Parallelization"),Fx.forEach(t),Mx.forEach(t),Ys.forEach(t),Q$=p(yt),Oi=a(yt,"P",{});var ff=r(Oi);H$=n(ff,"This class overrides "),Cd=a(ff,"A",{href:!0});var xx=r(Cd);K$=n(xx,"FlaxRobertaForSequenceClassification"),xx.forEach(t),V$=n(ff,`. Please check the superclass for the appropriate
...
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),_f.forEach(t),m1=p(Tt),Bi=a(Tt,"P",{});var bf=r(Bi);u1=n(bf,"This model is also a Flax Linen "),Wi=a(bf,"A",{href:!0,rel:!0});var Xx=r(Wi);f1=n(Xx,"flax.linen.Module"),Xx.forEach(t),g1=n(bf,`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),bf.forEach(t),_1=p(Tt),sh=a(Tt,"P",{});var Px=r(sh);b1=n(Px,"Finally, this model supports inherent JAX features such as:"),Px.forEach(t),k1=p(Tt),ho=a(Tt,"UL",{});var ea=r(ho);ah=a(ea,"LI",{});var Ax=r(ah);Ui=a(Ax,"A",{href:!0,rel:!0});var Ox=r(Ui);v1=n(Ox,"Just-In-Time (JIT) compilation"),Ox.forEach(t),Ax.forEach(t),y1=p(ea),rh=a(ea,"LI",{});var Nx=r(rh);Qi=a(Nx,"A",{href:!0,rel:!0});var Ix=r(Qi);T1=n(Ix,"Automatic Differentiation"),Ix.forEach(t),Nx.forEach(t),w1=p(ea),ih=a(ea,"LI",{});var Dx=r(ih);Hi=a(Dx,"A",{href:!0,rel:!0});var Sx=r(Hi);$1=n(Sx,"Vectorization"),Sx.forEach(t),Dx.forEach(t),M1=p(ea),lh=a(ea,"LI",{});var Bx=r(lh);Ki=a(Bx,"A",{href:!0,rel:!0});var Wx=r(Ki);F1=n(Wx,"Parallelization"),Wx.forEach(t),Bx.forEach(t),ea.forEach(t),x1=p(Tt),Vi=a(Tt,"P",{});var kf=r(Vi);R1=n(kf,"This class overrides "),Xd=a(kf,"A",{href:!0});var Ux=r(Xd);L1=n(Ux,"FlaxRobertaForMultipleChoice"),Ux.forEach(t),E1=n(kf,`. Please check the superclass for the appropriate
documentation alongside usage examples.`),kf.forEach(t),z1=p(Tt),Gt=a(Tt,"DIV",{class:!0});var ta=r(Gt);T(Ji.$$.fragment,ta),q1=p(ta),pn=a(ta,"P",{});var lc=r(pn);C1=n(lc,"The "),dh=a(lc,"CODE",{});var Qx=r(dh);j1=n(Qx,"FlaxRobertaPreTrainedModel"),Qx.forEach(t),X1=n(lc," forward method, overrides the "),ch=a(lc,"CODE",{});var Hx=r(ch);P1=n(Hx,"__call__"),Hx.forEach(t),A1=n(lc," special method."),lc.forEach(t),O1=p(ta),T(Xs.$$.fragment,ta),N1=p(ta),T(Ps.$$.fragment,ta),ta.forEach(t),Tt.forEach(t),Km=p(i),hn=a(i,"H2",{class:!0});var vf=r(hn);As=a(vf,"A",{id:!0,class:!0,href:!0});var Kx=r(As);ph=a(Kx,"SPAN",{});var Vx=r(ph);T(Gi.$$.fragment,Vx),Vx.forEach(t),Kx.forEach(t),I1=p(vf),hh=a(vf,"SPAN",{});var Jx=r(hh);D1=n(Jx,"FlaxXLMRobertaForTokenClassification"),Jx.forEach(t),vf.forEach(t),Vm=p(i),tt=a(i,"DIV",{class:!0});var wt=r(tt);T(Yi.$$.fragment,wt),S1=p(wt),mh=a(wt,"P",{});var Gx=r(mh);B1=n(Gx,`XLM-RoBERTa Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g.
for Named-Entity-Recognition (NER) tasks.`),Gx.forEach(t),W1=p(wt),Zi=a(wt,"P",{});var yf=r(Zi);U1=n(yf,"This model inherits from "),Pd=a(yf,"A",{href:!0});var Yx=r(Pd);Q1=n(Yx,"FlaxPreTrainedModel"),Yx.forEach(t),H1=n(yf,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),yf.forEach(t),K1=p(wt),el=a(wt,"P",{});var Tf=r(el);V1=n(Tf,"This model is also a Flax Linen "),tl=a(Tf,"A",{href:!0,rel:!0});var Zx=r(tl);J1=n(Zx,"flax.linen.Module"),Zx.forEach(t),G1=n(Tf,`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
