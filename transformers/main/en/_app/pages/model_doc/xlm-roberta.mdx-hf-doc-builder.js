...
<span class="hljs-meta">&gt;&gt;&gt; </span>end_scores = outputs.end_logits`}}),{c(){d=s("p"),g=o("Example:"),h=c(),y(f.$$.fragment)},l(l){d=a(l,"P",{});var m=r(d);g=n(m,"Example:"),m.forEach(t),h=p(l),T(f.$$.fragment,l)},m(l,m){_(l,d,m),e(d,g),_(l,h,m),w(f,l,m),k=!0},p:ge,i(l){k||($(f.$$.fragment,l),k=!0)},o(l){M(f.$$.fragment,l),k=!1},d(l){l&&t(d),l&&t(h),F(f,l)}}}function PL(x){let d,g,h,f,k,l,m,L,$e,be,O,re,te,R,Me,U,Fe,ke,D,xe,de,H,Re,ve,W,Le,ye,B,ue,Ee,ne,q,C,Te,S,ce,ze,Q,qe,Ce,j,pe,K,me,je,V,we,se,N,he,J,Xe,Z,X,Pe,P,ae,ie,v,E,He,oe,Ke,Ue,z,Ne,Ve,Ae,Je,Se,I,G,Ie,Ge,Y,Qe,Oe,le,Be,ee,Ye,hc,Rf,pm,nt,ra,Lf,io,Ef,Cl,zf,qf,jl,Cf,jf,ia,Xf,Pf,Af,la,Of,Xl,Nf,If,Df,go,da,Sf,mc,Wf,Bf,ca,Pl,Uf,uc,Qf,Hf,Al,Kf,fc,Vf,Jf,vn,pa,Gf,ha,Yf,gc,Zf,eg,tg,yn,ma,og,_c,ng,sg,Ol,ua,hm,xo,Tn,bc,fa,ag,kc,rg,mm,Mt,ga,ig,St,lg,vc,dg,cg,Nl,pg,hg,Il,mg,ug,_a,fg,gg,_g,ba,bg,Dl,kg,vg,yg,_o,ka,Tg,yc,wg,$g,va,Sl,Mg,Tc,Fg,xg,Wl,Rg,wc,Lg,Eg,wn,ya,zg,$c,qg,um,Ro,$n,Mc,Ta,Cg,Fc,jg,fm,mt,wa,Xg,xc,Pg,Ag,$a,Og,Bl,Ng,Ig,Dg,Ma,Sg,Fa,Wg,Bg,Ug,xa,Qg,Ul,Hg,Kg,Vg,Wt,Ra,Jg,Lo,Gg,Ql,Yg,Zg,Rc,e_,t_,o_,Mn,n_,Fn,gm,Eo,xn,Lc,La,s_,Ec,a_,_m,ut,Ea,r_,za,i_,zc,l_,d_,c_,qa,p_,Hl,h_,m_,u_,Ca,f_,ja,g_,__,b_,Xa,k_,Kl,v_,y_,T_,Bt,Pa,w_,zo,$_,Vl,M_,F_,qc,x_,R_,L_,Rn,E_,Ln,bm,qo,En,Cc,Aa,z_,jc,q_,km,ft,Oa,C_,Na,j_,Xc,X_,P_,A_,Ia,O_,Jl,N_,I_,D_,Da,S_,Sa,W_,B_,U_,Wa,Q_,Gl,H_,K_,V_,Ft,Ba,J_,Co,G_,Yl,Y_,Z_,Pc,eb,tb,ob,zn,nb,qn,sb,Cn,vm,jo,jn,Ac,Ua,ab,Oc,rb,ym,gt,Qa,ib,Nc,lb,db,Ha,cb,Zl,pb,hb,mb,Ka,ub,Va,fb,gb,_b,Ja,bb,ed,kb,vb,yb,ht,Ga,Tb,Xo,wb,td,$b,Mb,Ic,Fb,xb,Rb,Xn,Lb,Pn,Eb,An,zb,On,qb,Nn,Tm,Po,In,Dc,Ya,Cb,Sc,jb,wm,_t,Za,Xb,Wc,Pb,Ab,er,Ob,od,Nb,Ib,Db,tr,Sb,or,Wb,Bb,Ub,nr,Qb,nd,Hb,Kb,Vb,Ut,sr,Jb,Ao,Gb,sd,Yb,Zb,Bc,ek,tk,ok,Dn,nk,Sn,$m,Oo,Wn,Uc,ar,sk,Qc,ak,Mm,bt,rr,rk,Hc,ik,lk,ir,dk,ad,ck,pk,hk,lr,mk,dr,uk,fk,gk,cr,_k,rd,bk,kk,vk,xt,pr,yk,No,Tk,id,wk,$k,Kc,Mk,Fk,xk,Bn,Rk,Un,Lk,Qn,Fm,Io,Hn,Vc,hr,Ek,Jc,zk,xm,kt,mr,qk,Do,Ck,Gc,jk,Xk,Yc,Pk,Ak,Ok,ur,Nk,ld,Ik,Dk,Sk,fr,Wk,gr,Bk,Uk,Qk,_r,Hk,dd,Kk,Vk,Jk,Rt,br,Gk,So,Yk,cd,Zk,ev,Zc,tv,ov,nv,Kn,sv,Vn,av,Jn,Rm,Wo,Gn,ep,kr,rv,tp,iv,Lm,st,vr,lv,op,dv,cv,yr,pv,pd,hv,mv,uv,Tr,fv,wr,gv,_v,bv,Yn,kv,$r,vv,hd,yv,Tv,wv,Qt,Mr,$v,Bo,Mv,md,Fv,xv,np,Rv,Lv,Ev,Zn,zv,es,Em,Uo,ts,sp,Fr,qv,ap,Cv,zm,at,xr,jv,Rr,Xv,rp,Pv,Av,Ov,Lr,Nv,ud,Iv,Dv,Sv,Er,Wv,zr,Bv,Uv,Qv,os,Hv,qr,Kv,fd,Vv,Jv,Gv,Lt,Cr,Yv,Qo,Zv,gd,ey,ty,ip,oy,ny,sy,ns,ay,ss,ry,as,qm,Ho,rs,lp,jr,iy,dp,ly,Cm,rt,Xr,dy,cp,cy,py,Pr,hy,_d,my,uy,fy,Ar,gy,Or,_y,by,ky,is,vy,Nr,yy,bd,Ty,wy,$y,Et,Ir,My,Ko,Fy,kd,xy,Ry,pp,Ly,Ey,zy,ls,qy,ds,Cy,cs,jm,Vo,ps,hp,Dr,jy,mp,Xy,Xm,it,Sr,Py,up,Ay,Oy,Wr,Ny,vd,Iy,Dy,Sy,Br,Wy,Ur,By,Uy,Qy,hs,Hy,Qr,Ky,yd,Vy,Jy,Gy,Ht,Hr,Yy,Jo,Zy,Td,eT,tT,fp,oT,nT,sT,ms,aT,us,Pm,Go,fs,gp,Kr,rT,_p,iT,Am,lt,Vr,lT,bp,dT,cT,Jr,pT,wd,hT,mT,uT,Gr,fT,Yr,gT,_T,bT,gs,kT,Zr,vT,$d,yT,TT,wT,zt,ei,$T,Yo,MT,Md,FT,xT,kp,RT,LT,ET,_s,zT,bs,qT,ks,Om,Zo,vs,vp,ti,CT,yp,jT,Nm,dt,oi,XT,en,PT,Tp,AT,OT,wp,NT,IT,DT,ni,ST,Fd,WT,BT,UT,si,QT,ai,HT,KT,VT,ys,JT,ri,GT,$p,YT,ZT,ew,qt,ii,tw,tn,ow,xd,nw,sw,Mp,aw,rw,iw,Ts,lw,ws,dw,$s,Im,on,Ms,Fp,li,cw,xp,pw,Dm,ct,di,hw,ci,mw,Rd,uw,fw,gw,pi,_w,hi,bw,kw,vw,Rp,yw,Tw,lo,Lp,mi,ww,$w,Ep,ui,Mw,Fw,zp,fi,xw,Rw,qp,gi,Lw,Ew,_i,zw,Ld,qw,Cw,jw,Kt,bi,Xw,nn,Pw,Cp,Aw,Ow,jp,Nw,Iw,Dw,Fs,Sw,xs,Sm,sn,Rs,Xp,ki,Ww,Pp,Bw,Wm,pt,vi,Uw,an,Qw,Ap,Hw,Kw,Ed,Vw,Jw,Gw,yi,Yw,Ti,Zw,e$,t$,Op,o$,n$,co,Np,wi,s$,a$,Ip,$i,r$,i$,Dp,Mi,l$,d$,Sp,Fi,c$,p$,xi,h$,zd,m$,u$,f$,Vt,Ri,g$,rn,_$,Wp,b$,k$,Bp,v$,y$,T$,Ls,w$,Es,Bm,ln,zs,Up,Li,$$,Qp,M$,Um,Ze,Ei,F$,Hp,x$,R$,zi,L$,qd,E$,z$,q$,qi,C$,Ci,j$,X$,P$,Kp,A$,O$,po,Vp,ji,N$,I$,Jp,Xi,D$,S$,Gp,Pi,W$,B$,Yp,Ai,U$,Q$,Oi,H$,Cd,K$,V$,J$,Jt,Ni,G$,dn,Y$,Zp,Z$,e1,eh,t1,o1,n1,qs,s1,Cs,Qm,cn,js,th,Ii,a1,oh,r1,Hm,et,Di,i1,nh,l1,d1,Si,c1,jd,p1,h1,m1,Wi,u1,Bi,f1,g1,_1,sh,b1,k1,ho,ah,Ui,v1,y1,rh,Qi,T1,w1,ih,Hi,$1,M1,lh,Ki,F1,x1,Vi,R1,Xd,L1,E1,z1,Gt,Ji,q1,pn,C1,dh,j1,X1,ch,P1,A1,O1,Xs,N1,Ps,Km,hn,As,ph,Gi,I1,hh,D1,Vm,tt,Yi,S1,mh,W1,B1,Zi,U1,Pd,Q1,H1,K1,el,V1,tl,J1,G1,Y1,uh,Z1,eM,mo,fh,ol,tM,oM,gh,nl,nM,sM,_h,sl,aM,rM,bh,al,iM,lM,rl,dM,Ad,cM,pM,hM,Yt,il,mM,mn,uM,kh,fM,gM,vh,_M,bM,kM,Os,vM,Ns,Jm,un,Is,yh,ll,yM,Th,TM,Gm,ot,dl,wM,fn,$M,wh,MM,FM,$h,xM,RM,LM,cl,EM,Od,zM,qM,CM,pl,jM,hl,XM,PM,AM,Mh,OM,NM,uo,Fh,ml,IM,DM,xh,ul,SM,WM,Rh,fl,BM,UM,Lh,gl,QM,HM,_l,KM,Nd,VM,JM,GM,Zt,bl,YM,gn,ZM,Eh,e2,t2,zh,o2,n2,s2,Ds,a2,Ss,Ym;return l=new We({}),R=new We({}),E=new We({}),Ne=new A({props:{name:"class transformers.XLMRobertaConfig",anchor:"transformers.XLMRobertaConfig",parameters:[{name:"pad_token_id",val:" = 1"},{name:"bos_token_id",val:" = 0"},{name:"eos_token_id",val:" = 2"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/xlm_roberta/configuration_xlm_roberta.py#L45"}}),ee=new We({}),ra=new A({props:{name:"class transformers.XLMRobertaTokenizer",anchor:"transformers.XLMRobertaTokenizer",parameters:[{name:"vocab_file",val:""},{name:"bos_token",val:" = '<s>'"},{name:"eos_token",val:" = '</s>'"},{name:"sep_token",val:" = '</s>'"},{name:"cls_token",val:" = '<s>'"},{name:"unk_token",val:" = '<unk>'"},{name:"pad_token",val:" = '<pad>'"},{name:"mask_token",val:" = '<mask>'"},{name:"sp_model_kwargs",val:": typing.Union[typing.Dict[str, typing.Any], NoneType] = None"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.XLMRobertaTokenizer.vocab_file",description:`<strong>vocab_file</strong> (<code>str</code>) &#x2014;
...
`}}),Dn=new De({props:{$$slots:{default:[KR]},$$scope:{ctx:x}}}),Sn=new fe({props:{anchor:"transformers.XLMRobertaForMultipleChoice.forward.example",$$slots:{default:[VR]},$$scope:{ctx:x}}}),ar=new We({}),rr=new A({props:{name:"class transformers.XLMRobertaForTokenClassification",anchor:"transformers.XLMRobertaForTokenClassification",parameters:[{name:"config",val:""}],parametersDescription:[{anchor:"transformers.XLMRobertaForTokenClassification.config",description:`<strong>config</strong> (<a href="/docs/transformers/main/en/model_doc/xlm-roberta#transformers.XLMRobertaConfig">XLMRobertaConfig</a>) &#x2014; Model configuration class with all the parameters of the
model. Initializing with a config file does not load the weights associated with the model, only the
...
`}}),ms=new De({props:{$$slots:{default:[uL]},$$scope:{ctx:x}}}),us=new fe({props:{anchor:"transformers.TFXLMRobertaForMultipleChoice.call.example",$$slots:{default:[fL]},$$scope:{ctx:x}}}),Kr=new We({}),Vr=new A({props:{name:"class transformers.TFXLMRobertaForTokenClassification",anchor:"transformers.TFXLMRobertaForTokenClassification",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.TFXLMRobertaForTokenClassification.config",description:`<strong>config</strong> (<a href="/docs/transformers/main/en/model_doc/xlm-roberta#transformers.XLMRobertaConfig">XLMRobertaConfig</a>) &#x2014; Model configuration class with all the parameters of the
model. Initializing with a config file does not load the weights associated with the model, only the
...
adding special tokens. An XLM-RoBERTa sequence has the following format:`),Bf=c(),ca=s("ul"),Pl=s("li"),Uf=o("single sequence: "),uc=s("code"),Qf=o("<s> X </s>"),Hf=c(),Al=s("li"),Kf=o("pair of sequences: "),fc=s("code"),Vf=o("<s> A </s></s> B </s>"),Jf=c(),vn=s("div"),y(pa.$$.fragment),Gf=c(),ha=s("p"),Yf=o(`Retrieve sequence ids from a token list that has no special tokens added. This method is called when adding
...
alongside usage examples.`),T_=c(),Bt=s("div"),y(Pa.$$.fragment),w_=c(),zo=s("p"),$_=o("The "),Vl=s("a"),M_=o("RobertaForCausalLM"),F_=o(" forward method, overrides the "),qc=s("code"),x_=o("__call__"),R_=o(" special method."),L_=c(),y(Rn.$$.fragment),E_=c(),y(Ln.$$.fragment),bm=c(),qo=s("h2"),En=s("a"),Cc=s("span"),y(Aa.$$.fragment),z_=c(),jc=s("span"),q_=o("XLMRobertaForMaskedLM"),km=c(),ft=s("div"),y(Oa.$$.fragment),C_=c(),Na=s("p"),j_=o("XLM-RoBERTa Model with a "),Xc=s("code"),X_=o("language modeling"),P_=o(" head on top."),A_=c(),Ia=s("p"),O_=o("This model inherits from "),Jl=s("a"),N_=o("PreTrainedModel"),I_=o(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),D_=c(),Da=s("p"),S_=o("This model is also a PyTorch "),Sa=s("a"),W_=o("torch.nn.Module"),B_=o(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),U_=c(),Wa=s("p"),Q_=o("This class overrides "),Gl=s("a"),H_=o("RobertaForMaskedLM"),K_=o(`. Please check the superclass for the appropriate documentation
alongside usage examples.`),V_=c(),Ft=s("div"),y(Ba.$$.fragment),J_=c(),Co=s("p"),G_=o("The "),Yl=s("a"),Y_=o("RobertaForMaskedLM"),Z_=o(" forward method, overrides the "),Pc=s("code"),eb=o("__call__"),tb=o(" special method."),ob=c(),y(zn.$$.fragment),nb=c(),y(qn.$$.fragment),sb=c(),y(Cn.$$.fragment),vm=c(),jo=s("h2"),jn=s("a"),Ac=s("span"),y(Ua.$$.fragment),ab=c(),Oc=s("span"),rb=o("XLMRobertaForSequenceClassification"),ym=c(),gt=s("div"),y(Qa.$$.fragment),ib=c(),Nc=s("p"),lb=o(`XLM-RoBERTa Model transformer with a sequence classification/regression head on top (a linear layer on top of the
...
alongside usage examples.`),Vb=c(),Ut=s("div"),y(sr.$$.fragment),Jb=c(),Ao=s("p"),Gb=o("The "),sd=s("a"),Yb=o("RobertaForMultipleChoice"),Zb=o(" forward method, overrides the "),Bc=s("code"),ek=o("__call__"),tk=o(" special method."),ok=c(),y(Dn.$$.fragment),nk=c(),y(Sn.$$.fragment),$m=c(),Oo=s("h2"),Wn=s("a"),Uc=s("span"),y(ar.$$.fragment),sk=c(),Qc=s("span"),ak=o("XLMRobertaForTokenClassification"),Mm=c(),bt=s("div"),y(rr.$$.fragment),rk=c(),Hc=s("p"),ik=o(`XLM-RoBERTa Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g.
...
documentation alongside usage examples.`),vk=c(),xt=s("div"),y(pr.$$.fragment),yk=c(),No=s("p"),Tk=o("The "),id=s("a"),wk=o("RobertaForTokenClassification"),$k=o(" forward method, overrides the "),Kc=s("code"),Mk=o("__call__"),Fk=o(" special method."),xk=c(),y(Bn.$$.fragment),Rk=c(),y(Un.$$.fragment),Lk=c(),y(Qn.$$.fragment),Fm=c(),Io=s("h2"),Hn=s("a"),Vc=s("span"),y(hr.$$.fragment),Ek=c(),Jc=s("span"),zk=o("XLMRobertaForQuestionAnswering"),xm=c(),kt=s("div"),y(mr.$$.fragment),qk=c(),Do=s("p"),Ck=o(`XLM-RoBERTa Model with a span classification head on top for extractive question-answering tasks like SQuAD (a
...
alongside usage examples.`),Jk=c(),Rt=s("div"),y(br.$$.fragment),Gk=c(),So=s("p"),Yk=o("The "),cd=s("a"),Zk=o("RobertaForQuestionAnswering"),ev=o(" forward method, overrides the "),Zc=s("code"),tv=o("__call__"),ov=o(" special method."),nv=c(),y(Kn.$$.fragment),sv=c(),y(Vn.$$.fragment),av=c(),y(Jn.$$.fragment),Rm=c(),Wo=s("h2"),Gn=s("a"),ep=s("span"),y(kr.$$.fragment),rv=c(),tp=s("span"),iv=o("TFXLMRobertaModel"),Lm=c(),st=s("div"),y(vr.$$.fragment),lv=c(),op=s("p"),dv=o("The bare XLM-RoBERTa Model transformer outputting raw hidden-states without any specific head on top."),cv=c(),yr=s("p"),pv=o("This model inherits from "),pd=s("a"),hv=o("TFPreTrainedModel"),mv=o(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
usage examples.`),jw=c(),Kt=s("div"),y(bi.$$.fragment),Xw=c(),nn=s("p"),Pw=o("The "),Cp=s("code"),Aw=o("FlaxRobertaPreTrainedModel"),Ow=o(" forward method, overrides the "),jp=s("code"),Nw=o("__call__"),Iw=o(" special method."),Dw=c(),y(Fs.$$.fragment),Sw=c(),y(xs.$$.fragment),Sm=c(),sn=s("h2"),Rs=s("a"),Xp=s("span"),y(ki.$$.fragment),Ww=c(),Pp=s("span"),Bw=o("FlaxXLMRobertaForMaskedLM"),Wm=c(),pt=s("div"),y(vi.$$.fragment),Uw=c(),an=s("p"),Qw=o("XLM-RoBERTa Model with a "),Ap=s("code"),Hw=o("language modeling"),Kw=o(` head on top.
...
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),P$=c(),Kp=s("p"),A$=o("Finally, this model supports inherent JAX features such as:"),O$=c(),po=s("ul"),Vp=s("li"),ji=s("a"),N$=o("Just-In-Time (JIT) compilation"),I$=c(),Jp=s("li"),Xi=s("a"),D$=o("Automatic Differentiation"),S$=c(),Gp=s("li"),Pi=s("a"),W$=o("Vectorization"),B$=c(),Yp=s("li"),Ai=s("a"),U$=o("Parallelization"),Q$=c(),Oi=s("p"),H$=o("This class overrides "),Cd=s("a"),K$=o("FlaxRobertaForSequenceClassification"),V$=o(`. Please check the superclass for the appropriate
...
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),AM=c(),Mh=s("p"),OM=o("Finally, this model supports inherent JAX features such as:"),NM=c(),uo=s("ul"),Fh=s("li"),ml=s("a"),IM=o("Just-In-Time (JIT) compilation"),DM=c(),xh=s("li"),ul=s("a"),SM=o("Automatic Differentiation"),WM=c(),Rh=s("li"),fl=s("a"),BM=o("Vectorization"),UM=c(),Lh=s("li"),gl=s("a"),QM=o("Parallelization"),HM=c(),_l=s("p"),KM=o("This class overrides "),Nd=s("a"),VM=o("FlaxRobertaForQuestionAnswering"),JM=o(`. Please check the superclass for the appropriate
...
language from the input ids.`),wl.forEach(t),j=p(Tl),pe=a(Tl,"LI",{});var $l=r(pe);K=n($l,"This implementation is the same as RoBERTa. Refer to the "),me=a($l,"A",{href:!0});var Bh=r(me);je=n(Bh,"documentation of RoBERTa"),Bh.forEach(t),V=n($l,` for usage examples
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Hu.forEach(t),Sy=p(At),Br=a(At,"P",{});var Ku=r(Br);Wy=n(Ku,"This model is also a "),Ur=a(Ku,"A",{href:!0,rel:!0});var l0=r(Ur);By=n(l0,"tf.keras.Model"),l0.forEach(t),Uy=n(Ku,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
...
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),uf.forEach(t),P$=p(yt),Kp=a(yt,"P",{});var bx=r(Kp);A$=n(bx,"Finally, this model supports inherent JAX features such as:"),bx.forEach(t),O$=p(yt),po=a(yt,"UL",{});var Ys=r(po);Vp=a(Ys,"LI",{});var kx=r(Vp);ji=a(kx,"A",{href:!0,rel:!0});var vx=r(ji);N$=n(vx,"Just-In-Time (JIT) compilation"),vx.forEach(t),kx.forEach(t),I$=p(Ys),Jp=a(Ys,"LI",{});var yx=r(Jp);Xi=a(yx,"A",{href:!0,rel:!0});var Tx=r(Xi);D$=n(Tx,"Automatic Differentiation"),Tx.forEach(t),yx.forEach(t),S$=p(Ys),Gp=a(Ys,"LI",{});var wx=r(Gp);Pi=a(wx,"A",{href:!0,rel:!0});var $x=r(Pi);W$=n($x,"Vectorization"),$x.forEach(t),wx.forEach(t),B$=p(Ys),Yp=a(Ys,"LI",{});var Mx=r(Yp);Ai=a(Mx,"A",{href:!0,rel:!0});var Fx=r(Ai);U$=n(Fx,"Parallelization"),Fx.forEach(t),Mx.forEach(t),Ys.forEach(t),Q$=p(yt),Oi=a(yt,"P",{});var ff=r(Oi);H$=n(ff,"This class overrides "),Cd=a(ff,"A",{href:!0});var xx=r(Cd);K$=n(xx,"FlaxRobertaForSequenceClassification"),xx.forEach(t),V$=n(ff,`. Please check the superclass for the appropriate
