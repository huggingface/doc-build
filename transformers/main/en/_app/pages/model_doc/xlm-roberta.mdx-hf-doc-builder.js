import{S as IL,i as DL,s as SL,e as s,k as p,w as v,t as o,M as WL,c as a,d as t,m as h,a as r,x as T,h as n,b as u,G as e,g as _,y as w,q as M,o as $,B as F,v as BL,L as ue}from"../../chunks/vendor-hf-doc-builder.js";import{T as Ie}from"../../chunks/Tip-hf-doc-builder.js";import{D as A}from"../../chunks/Docstring-hf-doc-builder.js";import{C as fe}from"../../chunks/CodeBlock-hf-doc-builder.js";import{I as We}from"../../chunks/IconCopyLink-hf-doc-builder.js";import{E as me}from"../../chunks/ExampleCodeBlock-hf-doc-builder.js";function UL(x){let d,g,c,f,k;return f=new fe({props:{code:`from transformers import XLMRobertaConfig, XLMRobertaModel
...
format outside of Keras methods like `),H=s("code"),Le=o("fit()"),ye=o(" and "),W=s("code"),Re=o("predict()"),ve=o(`, such as when creating your own layers or models with
the Keras `),B=s("code"),ge=o("Functional"),Ee=o(` API, there are three possibilities you can use to gather all the input Tensors in the first
...
about any of this, as you can just pass inputs like you would to any other Python function!`),this.h()},l(y){d=a(y,"P",{});var E=r(d);g=n(E,"TensorFlow models and layers in "),c=a(E,"CODE",{});var Ue=r(c);f=n(Ue,"transformers"),Ue.forEach(t),k=n(E," accept two formats as input:"),E.forEach(t),l=h(y),m=a(y,"UL",{});var oe=r(m);R=a(oe,"LI",{});var Qe=r(R);Me=n(Qe,"having all inputs as keyword arguments (like PyTorch models), or"),Qe.forEach(t),be=h(oe),O=a(oe,"LI",{});var Be=r(O);re=n(Be,"having all inputs as a list, tuple or dict in the first positional argument."),Be.forEach(t),oe.forEach(t),te=h(y),L=a(y,"P",{});var z=r(L);$e=n(z,`The reason the second format is supported is that Keras methods prefer this format when passing inputs to models
...
format outside of Keras methods like `),H=a(z,"CODE",{});var _e=r(H);Le=n(_e,"fit()"),_e.forEach(t),ye=n(z," and "),W=a(z,"CODE",{});var Ke=r(W);Re=n(Ke,"predict()"),Ke.forEach(t),ve=n(z,`, such as when creating your own layers or models with
the Keras `),B=a(z,"CODE",{});var De=r(B);ge=n(De,"Functional"),De.forEach(t),Ee=n(z,` API, there are three possibilities you can use to gather all the input Tensors in the first
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),{c(){d=s("p"),g=o("Example:"),c=p(),v(f.$$.fragment)},l(l){d=a(l,"P",{});var m=r(d);g=n(m,"Example:"),m.forEach(t),c=h(l),T(f.$$.fragment,l)},m(l,m){_(l,d,m),e(d,g),_(l,c,m),w(f,l,m),k=!0},p:ue,i(l){k||(M(f.$$.fragment,l),k=!0)},o(l){$(f.$$.fragment,l),k=!1},d(l){l&&t(d),l&&t(c),F(f,l)}}}function fR(x){let d,g,c,f,k,l,m,R,Me,be,O,re,te,L,$e,U,Fe,ke,D,xe,le,H,Le,ye,W,Re,ve,B,ge,Ee,ne,q,X,Te,S,de,ze,Q,qe,Xe,C,ce,K,he,Ce,V,we,se,N,pe,J,je,ee,j,Pe,P,ae,ie;return{c(){d=s("p"),g=o("TensorFlow models and layers in "),c=s("code"),f=o("transformers"),k=o(" accept two formats as input:"),l=p(),m=s("ul"),R=s("li"),Me=o("having all inputs as keyword arguments (like PyTorch models), or"),be=p(),O=s("li"),re=o("having all inputs as a list, tuple or dict in the first positional argument."),te=p(),L=s("p"),$e=o(`The reason the second format is supported is that Keras methods prefer this format when passing inputs to models
and layers. Because of this support, when using methods like `),U=s("code"),Fe=o("model.fit()"),ke=o(` things should \u201Cjust work\u201D for you - just
pass your inputs and labels in any format that `),D=s("code"),xe=o("model.fit()"),le=o(` supports! If, however, you want to use the second
format outside of Keras methods like `),H=s("code"),Le=o("fit()"),ye=o(" and "),W=s("code"),Re=o("predict()"),ve=o(`, such as when creating your own layers or models with
the Keras `),B=s("code"),ge=o("Functional"),Ee=o(` API, there are three possibilities you can use to gather all the input Tensors in the first
...
<span class="hljs-number">0.1</span>`}}),{c(){v(d.$$.fragment)},l(c){T(d.$$.fragment,c)},m(c,f){w(d,c,f),g=!0},p:ue,i(c){g||(M(d.$$.fragment,c),g=!0)},o(c){$(d.$$.fragment,c),g=!1},d(c){F(d,c)}}}function kR(x){let d,g,c,f,k,l,m,R,Me,be,O,re,te,L,$e,U,Fe,ke,D,xe,le,H,Le,ye,W,Re,ve,B,ge,Ee,ne,q,X,Te,S,de,ze,Q,qe,Xe,C,ce,K,he,Ce,V,we,se,N,pe,J,je,ee,j,Pe,P,ae,ie;return{c(){d=s("p"),g=o("TensorFlow models and layers in "),c=s("code"),f=o("transformers"),k=o(" accept two formats as input:"),l=p(),m=s("ul"),R=s("li"),Me=o("having all inputs as keyword arguments (like PyTorch models), or"),be=p(),O=s("li"),re=o("having all inputs as a list, tuple or dict in the first positional argument."),te=p(),L=s("p"),$e=o(`The reason the second format is supported is that Keras methods prefer this format when passing inputs to models
and layers. Because of this support, when using methods like `),U=s("code"),Fe=o("model.fit()"),ke=o(` things should \u201Cjust work\u201D for you - just
pass your inputs and labels in any format that `),D=s("code"),xe=o("model.fit()"),le=o(` supports! If, however, you want to use the second
format outside of Keras methods like `),H=s("code"),Le=o("fit()"),ye=o(" and "),W=s("code"),Re=o("predict()"),ve=o(`, such as when creating your own layers or models with
the Keras `),B=s("code"),ge=o("Functional"),Ee=o(` API, there are three possibilities you can use to gather all the input Tensors in the first
...
<span class="hljs-number">0.08</span>`}}),{c(){v(d.$$.fragment)},l(c){T(d.$$.fragment,c)},m(c,f){w(d,c,f),g=!0},p:ue,i(c){g||(M(d.$$.fragment,c),g=!0)},o(c){$(d.$$.fragment,c),g=!1},d(c){F(d,c)}}}function wR(x){let d,g,c,f,k,l,m,R,Me,be,O,re,te,L,$e,U,Fe,ke,D,xe,le,H,Le,ye,W,Re,ve,B,ge,Ee,ne,q,X,Te,S,de,ze,Q,qe,Xe,C,ce,K,he,Ce,V,we,se,N,pe,J,je,ee,j,Pe,P,ae,ie;return{c(){d=s("p"),g=o("TensorFlow models and layers in "),c=s("code"),f=o("transformers"),k=o(" accept two formats as input:"),l=p(),m=s("ul"),R=s("li"),Me=o("having all inputs as keyword arguments (like PyTorch models), or"),be=p(),O=s("li"),re=o("having all inputs as a list, tuple or dict in the first positional argument."),te=p(),L=s("p"),$e=o(`The reason the second format is supported is that Keras methods prefer this format when passing inputs to models
and layers. Because of this support, when using methods like `),U=s("code"),Fe=o("model.fit()"),ke=o(` things should \u201Cjust work\u201D for you - just
pass your inputs and labels in any format that `),D=s("code"),xe=o("model.fit()"),le=o(` supports! If, however, you want to use the second
format outside of Keras methods like `),H=s("code"),Le=o("fit()"),ye=o(" and "),W=s("code"),Re=o("predict()"),ve=o(`, such as when creating your own layers or models with
the Keras `),B=s("code"),ge=o("Functional"),Ee=o(` API, there are three possibilities you can use to gather all the input Tensors in the first
...
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-built_in">round</span>(<span class="hljs-built_in">float</span>(loss), <span class="hljs-number">2</span>)
<span class="hljs-number">0.01</span>`}}),{c(){v(d.$$.fragment)},l(c){T(d.$$.fragment,c)},m(c,f){w(d,c,f),g=!0},p:ue,i(c){g||(M(d.$$.fragment,c),g=!0)},o(c){$(d.$$.fragment,c),g=!1},d(c){F(d,c)}}}function ER(x){let d,g,c,f,k,l,m,R,Me,be,O,re,te,L,$e,U,Fe,ke,D,xe,le,H,Le,ye,W,Re,ve,B,ge,Ee,ne,q,X,Te,S,de,ze,Q,qe,Xe,C,ce,K,he,Ce,V,we,se,N,pe,J,je,ee,j,Pe,P,ae,ie;return{c(){d=s("p"),g=o("TensorFlow models and layers in "),c=s("code"),f=o("transformers"),k=o(" accept two formats as input:"),l=p(),m=s("ul"),R=s("li"),Me=o("having all inputs as keyword arguments (like PyTorch models), or"),be=p(),O=s("li"),re=o("having all inputs as a list, tuple or dict in the first positional argument."),te=p(),L=s("p"),$e=o(`The reason the second format is supported is that Keras methods prefer this format when passing inputs to models
and layers. Because of this support, when using methods like `),U=s("code"),Fe=o("model.fit()"),ke=o(` things should \u201Cjust work\u201D for you - just
pass your inputs and labels in any format that `),D=s("code"),xe=o("model.fit()"),le=o(` supports! If, however, you want to use the second
format outside of Keras methods like `),H=s("code"),Le=o("fit()"),ye=o(" and "),W=s("code"),Re=o("predict()"),ve=o(`, such as when creating your own layers or models with
the Keras `),B=s("code"),ge=o("Functional"),Ee=o(` API, there are three possibilities you can use to gather all the input Tensors in the first
...
the latter silently ignores them.`)},l(l){d=a(l,"P",{});var m=r(d);g=n(m,"Although the recipe for forward pass needs to be defined within this function, one should call the "),c=a(m,"CODE",{});var R=r(c);f=n(R,"Module"),R.forEach(t),k=n(m,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),m.forEach(t)},m(l,m){_(l,d,m),e(d,g),e(d,c),e(c,f),e(d,k)},d(l){l&&t(d)}}}function WR(x){let d,g,c,f,k;return f=new fe({props:{code:`from transformers import RobertaTokenizer, FlaxRobertaForTokenClassification
...
<span class="hljs-meta">&gt;&gt;&gt; </span>outputs = model(**inputs)
<span class="hljs-meta">&gt;&gt;&gt; </span>logits = outputs.logits`}}),{c(){d=s("p"),g=o("Example:"),c=p(),v(f.$$.fragment)},l(l){d=a(l,"P",{});var m=r(d);g=n(m,"Example:"),m.forEach(t),c=h(l),T(f.$$.fragment,l)},m(l,m){_(l,d,m),e(d,g),_(l,c,m),w(f,l,m),k=!0},p:ue,i(l){k||(M(f.$$.fragment,l),k=!0)},o(l){$(f.$$.fragment,l),k=!1},d(l){l&&t(d),l&&t(c),F(f,l)}}}function BR(x){let d,g,c,f,k;return{c(){d=s("p"),g=o("Although the recipe for forward pass needs to be defined within this function, one should call the "),c=s("code"),f=o("Module"),k=o(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(l){d=a(l,"P",{});var m=r(d);g=n(m,"Although the recipe for forward pass needs to be defined within this function, one should call the "),c=a(m,"CODE",{});var R=r(c);f=n(R,"Module"),R.forEach(t),k=n(m,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
<span class="hljs-meta">&gt;&gt;&gt; </span>end_scores = outputs.end_logits`}}),{c(){d=s("p"),g=o("Example:"),c=p(),v(f.$$.fragment)},l(l){d=a(l,"P",{});var m=r(d);g=n(m,"Example:"),m.forEach(t),c=h(l),T(f.$$.fragment,l)},m(l,m){_(l,d,m),e(d,g),_(l,c,m),w(f,l,m),k=!0},p:ue,i(l){k||(M(f.$$.fragment,l),k=!0)},o(l){$(f.$$.fragment,l),k=!1},d(l){l&&t(d),l&&t(c),F(f,l)}}}function QR(x){let d,g,c,f,k,l,m,R,Me,be,O,re,te,L,$e,U,Fe,ke,D,xe,le,H,Le,ye,W,Re,ve,B,ge,Ee,ne,q,X,Te,S,de,ze,Q,qe,Xe,C,ce,K,he,Ce,V,we,se,N,pe,J,je,ee,j,Pe,P,ae,ie,y,E,Ue,oe,Qe,Be,z,Oe,He,_e,Ke,De,I,G,Se,Ve,Y,Ne,Je,Ae,Ge,Z,Ye,jl,qf,Xf,Pl,Cf,jf,Pf,$n,km,zo,Fn,dc,ua,Af,cc,Of,ym,st,fa,Nf,no,If,Al,Df,Sf,Ol,Wf,Bf,ga,Uf,Qf,Hf,_a,Kf,Nl,Vf,Jf,Gf,uo,ba,Yf,pc,Zf,eg,ka,Il,tg,hc,og,ng,Dl,sg,mc,ag,rg,xn,ya,ig,va,lg,uc,dg,cg,pg,Ln,Ta,hg,fc,mg,ug,Sl,wa,vm,qo,Rn,gc,Ma,fg,_c,gg,Tm,vt,$a,_g,Ut,bg,bc,kg,yg,Wl,vg,Tg,Bl,wg,Mg,Fa,$g,Fg,xg,xa,Lg,Ul,Rg,Eg,zg,fo,La,qg,kc,Xg,Cg,Ra,Ql,jg,yc,Pg,Ag,Hl,Og,vc,Ng,Ig,En,Ea,Dg,Tc,Sg,wm,Xo,zn,wc,za,Wg,Mc,Bg,Mm,Ze,qa,Ug,$c,Qg,Hg,Xa,Kg,Kl,Vg,Jg,Gg,Ca,Yg,ja,Zg,e_,t_,Pa,o_,Fc,n_,s_,a_,ut,r_,xc,i_,l_,Lc,d_,c_,Rc,p_,h_,Ec,m_,u_,zc,f_,g_,qc,__,b_,k_,qn,y_,Xc,v_,T_,Aa,w_,M_,Qt,Oa,$_,Co,F_,Vl,x_,L_,Cc,R_,E_,z_,Xn,q_,Cn,$m,jo,jn,jc,Na,X_,Pc,C_,Fm,Tt,Ia,j_,Da,P_,Ac,A_,O_,N_,Sa,I_,Jl,D_,S_,W_,Wa,B_,Ba,U_,Q_,H_,Ht,Ua,K_,Po,V_,Gl,J_,G_,Oc,Y_,Z_,eb,Pn,tb,An,xm,Ao,On,Nc,Qa,ob,Ic,nb,Lm,wt,Ha,sb,Ka,ab,Dc,rb,ib,lb,Va,db,Yl,cb,pb,hb,Ja,mb,Ga,ub,fb,gb,Lt,Ya,_b,Oo,bb,Zl,kb,yb,Sc,vb,Tb,wb,Nn,Mb,In,$b,Dn,Rm,No,Sn,Wc,Za,Fb,Bc,xb,Em,Mt,er,Lb,Uc,Rb,Eb,tr,zb,ed,qb,Xb,Cb,or,jb,nr,Pb,Ab,Ob,mt,sr,Nb,Io,Ib,td,Db,Sb,Qc,Wb,Bb,Ub,Wn,Qb,Bn,Hb,Un,Kb,Qn,Vb,Hn,zm,Do,Kn,Hc,ar,Jb,Kc,Gb,qm,$t,rr,Yb,Vc,Zb,ek,ir,tk,od,ok,nk,sk,lr,ak,dr,rk,ik,lk,Kt,cr,dk,So,ck,nd,pk,hk,Jc,mk,uk,fk,Vn,gk,Jn,Xm,Wo,Gn,Gc,pr,_k,Yc,bk,Cm,Ft,hr,kk,Zc,yk,vk,mr,Tk,sd,wk,Mk,$k,ur,Fk,fr,xk,Lk,Rk,Rt,gr,Ek,Bo,zk,ad,qk,Xk,ep,Ck,jk,Pk,Yn,Ak,Zn,Ok,es,jm,Uo,ts,tp,_r,Nk,op,Ik,Pm,xt,br,Dk,Qo,Sk,np,Wk,Bk,sp,Uk,Qk,Hk,kr,Kk,rd,Vk,Jk,Gk,yr,Yk,vr,Zk,ey,ty,Et,Tr,oy,Ho,ny,id,sy,ay,ap,ry,iy,ly,os,dy,ns,cy,ss,Am,Ko,as,rp,wr,py,ip,hy,Om,at,Mr,my,lp,uy,fy,$r,gy,ld,_y,by,ky,Fr,yy,xr,vy,Ty,wy,rs,My,Lr,$y,dd,Fy,xy,Ly,Vt,Rr,Ry,Vo,Ey,cd,zy,qy,dp,Xy,Cy,jy,is,Py,ls,Nm,Jo,ds,cp,Er,Ay,pp,Oy,Im,rt,zr,Ny,qr,Iy,hp,Dy,Sy,Wy,Xr,By,pd,Uy,Qy,Hy,Cr,Ky,jr,Vy,Jy,Gy,cs,Yy,Pr,Zy,hd,ev,tv,ov,zt,Ar,nv,Go,sv,md,av,rv,mp,iv,lv,dv,ps,cv,hs,pv,ms,Dm,Yo,us,up,Or,hv,fp,mv,Sm,it,Nr,uv,gp,fv,gv,Ir,_v,ud,bv,kv,yv,Dr,vv,Sr,Tv,wv,Mv,fs,$v,Wr,Fv,fd,xv,Lv,Rv,qt,Br,Ev,Zo,zv,gd,qv,Xv,_p,Cv,jv,Pv,gs,Av,_s,Ov,bs,Wm,en,ks,bp,Ur,Nv,kp,Iv,Bm,lt,Qr,Dv,yp,Sv,Wv,Hr,Bv,_d,Uv,Qv,Hv,Kr,Kv,Vr,Vv,Jv,Gv,ys,Yv,Jr,Zv,bd,eT,tT,oT,Jt,Gr,nT,tn,sT,kd,aT,rT,vp,iT,lT,dT,vs,cT,Ts,Um,on,ws,Tp,Yr,pT,wp,hT,Qm,dt,Zr,mT,Mp,uT,fT,ei,gT,yd,_T,bT,kT,ti,yT,oi,vT,TT,wT,Ms,MT,ni,$T,vd,FT,xT,LT,Xt,si,RT,nn,ET,Td,zT,qT,$p,XT,CT,jT,$s,PT,Fs,AT,xs,Hm,sn,Ls,Fp,ai,OT,xp,NT,Km,ct,ri,IT,an,DT,Lp,ST,WT,Rp,BT,UT,QT,ii,HT,wd,KT,VT,JT,li,GT,di,YT,ZT,ew,Rs,tw,ci,ow,Ep,nw,sw,aw,Ct,pi,rw,rn,iw,Md,lw,dw,zp,cw,pw,hw,Es,mw,zs,uw,qs,Vm,ln,Xs,qp,hi,fw,Xp,gw,Jm,pt,mi,_w,ui,bw,$d,kw,yw,vw,fi,Tw,gi,ww,Mw,$w,Cp,Fw,xw,so,jp,_i,Lw,Rw,Pp,bi,Ew,zw,Ap,ki,qw,Xw,Op,yi,Cw,jw,vi,Pw,Fd,Aw,Ow,Nw,Gt,Ti,Iw,dn,Dw,Np,Sw,Ww,Ip,Bw,Uw,Qw,Cs,Hw,js,Gm,cn,Ps,Dp,wi,Kw,Sp,Vw,Ym,ht,Mi,Jw,pn,Gw,Wp,Yw,Zw,xd,eM,tM,oM,$i,nM,Fi,sM,aM,rM,Bp,iM,lM,ao,Up,xi,dM,cM,Qp,Li,pM,hM,Hp,Ri,mM,uM,Kp,Ei,fM,gM,zi,_M,Ld,bM,kM,yM,Yt,qi,vM,hn,TM,Vp,wM,MM,Jp,$M,FM,xM,As,LM,Os,Zm,mn,Ns,Gp,Xi,RM,Yp,EM,eu,et,Ci,zM,Zp,qM,XM,ji,CM,Rd,jM,PM,AM,Pi,OM,Ai,NM,IM,DM,eh,SM,WM,ro,th,Oi,BM,UM,oh,Ni,QM,HM,nh,Ii,KM,VM,sh,Di,JM,GM,Si,YM,Ed,ZM,e$,t$,Zt,Wi,o$,un,n$,ah,s$,a$,rh,r$,i$,l$,Is,d$,Ds,tu,fn,Ss,ih,Bi,c$,lh,p$,ou,tt,Ui,h$,dh,m$,u$,Qi,f$,zd,g$,_$,b$,Hi,k$,Ki,y$,v$,T$,ch,w$,M$,io,ph,Vi,$$,F$,hh,Ji,x$,L$,mh,Gi,R$,E$,uh,Yi,z$,q$,Zi,X$,qd,C$,j$,P$,eo,el,A$,gn,O$,fh,N$,I$,gh,D$,S$,W$,Ws,B$,Bs,nu,_n,Us,_h,tl,U$,bh,Q$,su,ot,ol,H$,kh,K$,V$,nl,J$,Xd,G$,Y$,Z$,sl,e1,al,t1,o1,n1,yh,s1,a1,lo,vh,rl,r1,i1,Th,il,l1,d1,wh,ll,c1,p1,Mh,dl,h1,m1,cl,u1,Cd,f1,g1,_1,to,pl,b1,bn,k1,$h,y1,v1,Fh,T1,w1,M1,Qs,$1,Hs,au,kn,Ks,xh,hl,F1,Lh,x1,ru,nt,ml,L1,yn,R1,Rh,E1,z1,Eh,q1,X1,C1,ul,j1,jd,P1,A1,O1,fl,N1,gl,I1,D1,S1,zh,W1,B1,co,qh,_l,U1,Q1,Xh,bl,H1,K1,Ch,kl,V1,J1,jh,yl,G1,Y1,vl,Z1,Pd,e2,t2,o2,oo,Tl,n2,vn,s2,Ph,a2,r2,Ah,i2,l2,d2,Vs,c2,Js,iu;return l=new We({}),L=new We({}),E=new We({}),Oe=new A({props:{name:"class transformers.XLMRobertaConfig",anchor:"transformers.XLMRobertaConfig",parameters:[{name:"vocab_size",val:" = 30522"},{name:"hidden_size",val:" = 768"},{name:"num_hidden_layers",val:" = 12"},{name:"num_attention_heads",val:" = 12"},{name:"intermediate_size",val:" = 3072"},{name:"hidden_act",val:" = 'gelu'"},{name:"hidden_dropout_prob",val:" = 0.1"},{name:"attention_probs_dropout_prob",val:" = 0.1"},{name:"max_position_embeddings",val:" = 512"},{name:"type_vocab_size",val:" = 2"},{name:"initializer_range",val:" = 0.02"},{name:"layer_norm_eps",val:" = 1e-12"},{name:"pad_token_id",val:" = 1"},{name:"bos_token_id",val:" = 0"},{name:"eos_token_id",val:" = 2"},{name:"position_embedding_type",val:" = 'absolute'"},{name:"use_cache",val:" = True"},{name:"classifier_dropout",val:" = None"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.XLMRobertaConfig.vocab_size",description:`<strong>vocab_size</strong> (<code>int</code>, <em>optional</em>, defaults to 30522) &#x2014;
...
The dropout ratio for the classification head.`,name:"classifier_dropout"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/xlm_roberta/configuration_xlm_roberta.py#L45"}}),$n=new me({props:{anchor:"transformers.XLMRobertaConfig.example",$$slots:{default:[UL]},$$scope:{ctx:x}}}),ua=new We({}),fa=new A({props:{name:"class transformers.XLMRobertaTokenizer",anchor:"transformers.XLMRobertaTokenizer",parameters:[{name:"vocab_file",val:""},{name:"bos_token",val:" = '<s>'"},{name:"eos_token",val:" = '</s>'"},{name:"sep_token",val:" = '</s>'"},{name:"cls_token",val:" = '<s>'"},{name:"unk_token",val:" = '<unk>'"},{name:"pad_token",val:" = '<pad>'"},{name:"mask_token",val:" = '<mask>'"},{name:"sp_model_kwargs",val:": typing.Union[typing.Dict[str, typing.Any], NoneType] = None"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.XLMRobertaTokenizer.vocab_file",description:`<strong>vocab_file</strong> (<code>str</code>) &#x2014;
...
`,returnType:`
<p><code>List[int]</code></p>
`}}),wa=new A({props:{name:"save_vocabulary",anchor:"transformers.XLMRobertaTokenizer.save_vocabulary",parameters:[{name:"save_directory",val:": str"},{name:"filename_prefix",val:": typing.Optional[str] = None"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/xlm_roberta/tokenization_xlm_roberta.py#L313"}}),Ma=new We({}),$a=new A({props:{name:"class transformers.XLMRobertaTokenizerFast",anchor:"transformers.XLMRobertaTokenizerFast",parameters:[{name:"vocab_file",val:" = None"},{name:"tokenizer_file",val:" = None"},{name:"bos_token",val:" = '<s>'"},{name:"eos_token",val:" = '</s>'"},{name:"sep_token",val:" = '</s>'"},{name:"cls_token",val:" = '<s>'"},{name:"unk_token",val:" = '<unk>'"},{name:"pad_token",val:" = '<pad>'"},{name:"mask_token",val:" = '<mask>'"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.XLMRobertaTokenizerFast.vocab_file",description:`<strong>vocab_file</strong> (<code>str</code>) &#x2014;
...
`,returnType:`
<p><code>List[int]</code></p>
`}}),za=new We({}),qa=new A({props:{name:"class transformers.XLMRobertaModel",anchor:"transformers.XLMRobertaModel",parameters:[{name:"config",val:""},{name:"add_pooling_layer",val:" = True"}],parametersDescription:[{anchor:"transformers.XLMRobertaModel.config",description:`<strong>config</strong> (<a href="/docs/transformers/main/en/model_doc/xlm-roberta#transformers.XLMRobertaConfig">XLMRobertaConfig</a>) &#x2014; Model configuration class with all the parameters of the
...
<p>Indices can be obtained using <a href="/docs/transformers/main/en/model_doc/xlm-roberta#transformers.XLMRobertaTokenizer">XLMRobertaTokenizer</a>. See <a href="/docs/transformers/main/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
...
`}}),Pn=new Ie({props:{$$slots:{default:[KL]},$$scope:{ctx:x}}}),An=new me({props:{anchor:"transformers.XLMRobertaForCausalLM.forward.example",$$slots:{default:[VL]},$$scope:{ctx:x}}}),Qa=new We({}),Ha=new A({props:{name:"class transformers.XLMRobertaForMaskedLM",anchor:"transformers.XLMRobertaForMaskedLM",parameters:[{name:"config",val:""}],parametersDescription:[{anchor:"transformers.XLMRobertaForMaskedLM.config",description:`<strong>config</strong> (<a href="/docs/transformers/main/en/model_doc/xlm-roberta#transformers.XLMRobertaConfig">XLMRobertaConfig</a>) &#x2014; Model configuration class with all the parameters of the
model. Initializing with a config file does not load the weights associated with the model, only the
...
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/main/en/model_doc/roberta#transformers.RobertaTokenizer">RobertaTokenizer</a>. See <a href="/docs/transformers/main/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
...
`}}),is=new Ie({props:{$$slots:{default:[mR]},$$scope:{ctx:x}}}),ls=new me({props:{anchor:"transformers.TFXLMRobertaModel.call.example",$$slots:{default:[uR]},$$scope:{ctx:x}}}),Er=new We({}),zr=new A({props:{name:"class transformers.TFXLMRobertaForMaskedLM",anchor:"transformers.TFXLMRobertaForMaskedLM",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.TFXLMRobertaForMaskedLM.config",description:`<strong>config</strong> (<a href="/docs/transformers/main/en/model_doc/xlm-roberta#transformers.XLMRobertaConfig">XLMRobertaConfig</a>) &#x2014; Model configuration class with all the parameters of the
model. Initializing with a config file does not load the weights associated with the model, only the
...
`}}),ps=new Ie({props:{$$slots:{default:[gR]},$$scope:{ctx:x}}}),hs=new me({props:{anchor:"transformers.TFXLMRobertaForMaskedLM.call.example",$$slots:{default:[_R]},$$scope:{ctx:x}}}),ms=new me({props:{anchor:"transformers.TFXLMRobertaForMaskedLM.call.example-2",$$slots:{default:[bR]},$$scope:{ctx:x}}}),Or=new We({}),Nr=new A({props:{name:"class transformers.TFXLMRobertaForSequenceClassification",anchor:"transformers.TFXLMRobertaForSequenceClassification",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.TFXLMRobertaForSequenceClassification.config",description:`<strong>config</strong> (<a href="/docs/transformers/main/en/model_doc/xlm-roberta#transformers.XLMRobertaConfig">XLMRobertaConfig</a>) &#x2014; Model configuration class with all the parameters of the
model. Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/main/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/xlm_roberta/modeling_tf_xlm_roberta.py#L127"}}),fs=new Ie({props:{$$slots:{default:[kR]},$$scope:{ctx:x}}}),Br=new A({props:{name:"call",anchor:"transformers.TFXLMRobertaForSequenceClassification.call",parameters:[{name:"input_ids",val:": typing.Union[typing.List[tensorflow.python.framework.ops.Tensor], typing.List[numpy.ndarray], typing.List[tensorflow.python.keras.engine.keras_tensor.KerasTensor], typing.Dict[str, tensorflow.python.framework.ops.Tensor], typing.Dict[str, numpy.ndarray], typing.Dict[str, tensorflow.python.keras.engine.keras_tensor.KerasTensor], tensorflow.python.framework.ops.Tensor, numpy.ndarray, tensorflow.python.keras.engine.keras_tensor.KerasTensor, NoneType] = None"},{name:"attention_mask",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"token_type_ids",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"position_ids",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"head_mask",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"inputs_embeds",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"labels",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"training",val:": typing.Optional[bool] = False"}],parametersDescription:[{anchor:"transformers.TFXLMRobertaForSequenceClassification.call.input_ids",description:`<strong>input_ids</strong> (<code>Numpy array</code> or <code>tf.Tensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/main/en/model_doc/roberta#transformers.RobertaTokenizer">RobertaTokenizer</a>. See <a href="/docs/transformers/main/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
<a href="/docs/transformers/main/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> for details.</p>
...
`}}),gs=new Ie({props:{$$slots:{default:[yR]},$$scope:{ctx:x}}}),_s=new me({props:{anchor:"transformers.TFXLMRobertaForSequenceClassification.call.example",$$slots:{default:[vR]},$$scope:{ctx:x}}}),bs=new me({props:{anchor:"transformers.TFXLMRobertaForSequenceClassification.call.example-2",$$slots:{default:[TR]},$$scope:{ctx:x}}}),Ur=new We({}),Qr=new A({props:{name:"class transformers.TFXLMRobertaForMultipleChoice",anchor:"transformers.TFXLMRobertaForMultipleChoice",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.TFXLMRobertaForMultipleChoice.config",description:`<strong>config</strong> (<a href="/docs/transformers/main/en/model_doc/xlm-roberta#transformers.XLMRobertaConfig">XLMRobertaConfig</a>) &#x2014; Model configuration class with all the parameters of the
model. Initializing with a config file does not load the weights associated with the model, only the
...
`}}),vs=new Ie({props:{$$slots:{default:[MR]},$$scope:{ctx:x}}}),Ts=new me({props:{anchor:"transformers.TFXLMRobertaForMultipleChoice.call.example",$$slots:{default:[$R]},$$scope:{ctx:x}}}),Yr=new We({}),Zr=new A({props:{name:"class transformers.TFXLMRobertaForTokenClassification",anchor:"transformers.TFXLMRobertaForTokenClassification",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.TFXLMRobertaForTokenClassification.config",description:`<strong>config</strong> (<a href="/docs/transformers/main/en/model_doc/xlm-roberta#transformers.XLMRobertaConfig">XLMRobertaConfig</a>) &#x2014; Model configuration class with all the parameters of the
model. Initializing with a config file does not load the weights associated with the model, only the
...
`}}),$s=new Ie({props:{$$slots:{default:[xR]},$$scope:{ctx:x}}}),Fs=new me({props:{anchor:"transformers.TFXLMRobertaForTokenClassification.call.example",$$slots:{default:[LR]},$$scope:{ctx:x}}}),xs=new me({props:{anchor:"transformers.TFXLMRobertaForTokenClassification.call.example-2",$$slots:{default:[RR]},$$scope:{ctx:x}}}),ai=new We({}),ri=new A({props:{name:"class transformers.TFXLMRobertaForQuestionAnswering",anchor:"transformers.TFXLMRobertaForQuestionAnswering",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.TFXLMRobertaForQuestionAnswering.config",description:`<strong>config</strong> (<a href="/docs/transformers/main/en/model_doc/xlm-roberta#transformers.XLMRobertaConfig">XLMRobertaConfig</a>) &#x2014; Model configuration class with all the parameters of the
model. Initializing with a config file does not load the weights associated with the model, only the
...
`}}),Cs=new Ie({props:{$$slots:{default:[CR]},$$scope:{ctx:x}}}),js=new me({props:{anchor:"transformers.FlaxXLMRobertaModel.__call__.example",$$slots:{default:[jR]},$$scope:{ctx:x}}}),wi=new We({}),Mi=new A({props:{name:"class transformers.FlaxXLMRobertaForMaskedLM",anchor:"transformers.FlaxXLMRobertaForMaskedLM",parameters:[{name:"config",val:": RobertaConfig"},{name:"input_shape",val:": typing.Tuple = (1, 1)"},{name:"seed",val:": int = 0"},{name:"dtype",val:": dtype = <class 'jax.numpy.float32'>"},{name:"_do_init",val:": bool = True"},{name:"gradient_checkpointing",val:": bool = False"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.FlaxXLMRobertaForMaskedLM.config",description:`<strong>config</strong> (<a href="/docs/transformers/main/en/model_doc/xlm-roberta#transformers.XLMRobertaConfig">XLMRobertaConfig</a>) &#x2014; Model configuration class with all the parameters of the
model. Initializing with a config file does not load the weights associated with the model, only the
...
`}}),Qs=new Ie({props:{$$slots:{default:[SR]},$$scope:{ctx:x}}}),Hs=new me({props:{anchor:"transformers.FlaxXLMRobertaForTokenClassification.__call__.example",$$slots:{default:[WR]},$$scope:{ctx:x}}}),hl=new We({}),ml=new A({props:{name:"class transformers.FlaxXLMRobertaForQuestionAnswering",anchor:"transformers.FlaxXLMRobertaForQuestionAnswering",parameters:[{name:"config",val:": RobertaConfig"},{name:"input_shape",val:": typing.Tuple = (1, 1)"},{name:"seed",val:": int = 0"},{name:"dtype",val:": dtype = <class 'jax.numpy.float32'>"},{name:"_do_init",val:": bool = True"},{name:"gradient_checkpointing",val:": bool = False"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.FlaxXLMRobertaForQuestionAnswering.config",description:`<strong>config</strong> (<a href="/docs/transformers/main/en/model_doc/xlm-roberta#transformers.XLMRobertaConfig">XLMRobertaConfig</a>) &#x2014; Model configuration class with all the parameters of the
model. Initializing with a config file does not load the weights associated with the model, only the
...
data.`),ye=p(),W=s("p"),Re=o("The abstract from the paper is the following:"),ve=p(),B=s("p"),ge=s("em"),Ee=o(`This paper shows that pretraining multilingual language models at scale leads to significant performance gains for a
...
`),Wl=s("a"),vg=o("RobertaTokenizer"),Tg=o(" and "),Bl=s("a"),wg=o("XLNetTokenizer"),Mg=o(`. Based on
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),W_=p(),Wa=s("p"),B_=o("This model is also a PyTorch "),Ba=s("a"),U_=o("torch.nn.Module"),Q_=o(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),gb=p(),Lt=s("div"),v(Ya.$$.fragment),_b=p(),Oo=s("p"),bb=o("The "),Zl=s("a"),kb=o("XLMRobertaForMaskedLM"),yb=o(" forward method, overrides the "),Sc=s("code"),vb=o("__call__"),Tb=o(" special method."),wb=p(),v(Nn.$$.fragment),Mb=p(),v(In.$$.fragment),$b=p(),v(Dn.$$.fragment),Rm=p(),No=s("h2"),Sn=s("a"),Wc=s("span"),v(Za.$$.fragment),Fb=p(),Bc=s("span"),xb=o("XLMRobertaForSequenceClassification"),Em=p(),Mt=s("div"),v(er.$$.fragment),Lb=p(),Uc=s("p"),Rb=o(`XLM-RoBERTa Model transformer with a sequence classification/regression head on top (a linear layer on top of the
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),lk=p(),Kt=s("div"),v(cr.$$.fragment),dk=p(),So=s("p"),ck=o("The "),nd=s("a"),pk=o("XLMRobertaForMultipleChoice"),hk=o(" forward method, overrides the "),Jc=s("code"),mk=o("__call__"),uk=o(" special method."),fk=p(),v(Vn.$$.fragment),gk=p(),v(Jn.$$.fragment),Xm=p(),Wo=s("h2"),Gn=s("a"),Gc=s("span"),v(pr.$$.fragment),_k=p(),Yc=s("span"),bk=o("XLMRobertaForTokenClassification"),Cm=p(),Ft=s("div"),v(hr.$$.fragment),kk=p(),Zc=s("p"),yk=o(`XLM-RoBERTa Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g.
...
usage examples.`),Ly=p(),Vt=s("div"),v(Rr.$$.fragment),Ry=p(),Vo=s("p"),Ey=o("The "),cd=s("a"),zy=o("TFRobertaModel"),qy=o(" forward method, overrides the "),dp=s("code"),Xy=o("__call__"),Cy=o(" special method."),jy=p(),v(is.$$.fragment),Py=p(),v(ls.$$.fragment),Nm=p(),Jo=s("h2"),ds=s("a"),cp=s("span"),v(Er.$$.fragment),Ay=p(),pp=s("span"),Oy=o("TFXLMRobertaForMaskedLM"),Im=p(),rt=s("div"),v(zr.$$.fragment),Ny=p(),qr=s("p"),Iy=o("XLM-RoBERTa Model with a "),hp=s("code"),Dy=o("language modeling"),Sy=o(" head on top."),Wy=p(),Xr=s("p"),By=o("This model inherits from "),pd=s("a"),Uy=o("TFPreTrainedModel"),Qy=o(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Mv=p(),v(fs.$$.fragment),$v=p(),Wr=s("p"),Fv=o("This class overrides "),fd=s("a"),xv=o("TFRobertaForSequenceClassification"),Lv=o(`. Please check the superclass for the appropriate
documentation alongside usage examples.`),Rv=p(),qt=s("div"),v(Br.$$.fragment),Ev=p(),Zo=s("p"),zv=o("The "),gd=s("a"),qv=o("TFRobertaForSequenceClassification"),Xv=o(" forward method, overrides the "),_p=s("code"),Cv=o("__call__"),jv=o(" special method."),Pv=p(),v(gs.$$.fragment),Av=p(),v(_s.$$.fragment),Ov=p(),v(bs.$$.fragment),Wm=p(),en=s("h2"),ks=s("a"),bp=s("span"),v(Ur.$$.fragment),Nv=p(),kp=s("span"),Iv=o("TFXLMRobertaForMultipleChoice"),Bm=p(),lt=s("div"),v(Qr.$$.fragment),Dv=p(),yp=s("p"),Sv=o(`Roberta Model with a multiple choice classification head on top (a linear layer on top of the pooled output and a
softmax) e.g. for RocStories/SWAG tasks.`),Wv=p(),Hr=s("p"),Bv=o("This model inherits from "),_d=s("a"),Uv=o("TFPreTrainedModel"),Qv=o(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
layers on top of the hidden-states output to compute `),Lp=s("code"),ST=o("span start logits"),WT=o(" and "),Rp=s("code"),BT=o("span end logits"),UT=o(")."),QT=p(),ii=s("p"),HT=o("This model inherits from "),wd=s("a"),KT=o("TFPreTrainedModel"),VT=o(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
usage examples.`),Nw=p(),Gt=s("div"),v(Ti.$$.fragment),Iw=p(),dn=s("p"),Dw=o("The "),Np=s("code"),Sw=o("FlaxRobertaPreTrainedModel"),Ww=o(" forward method, overrides the "),Ip=s("code"),Bw=o("__call__"),Uw=o(" special method."),Qw=p(),v(Cs.$$.fragment),Hw=p(),v(js.$$.fragment),Gm=p(),cn=s("h2"),Ps=s("a"),Dp=s("span"),v(wi.$$.fragment),Kw=p(),Sp=s("span"),Vw=o("FlaxXLMRobertaForMaskedLM"),Ym=p(),ht=s("div"),v(Mi.$$.fragment),Jw=p(),pn=s("p"),Gw=o("XLM-RoBERTa Model with a "),Wp=s("code"),Yw=o("language modeling"),Zw=o(` head on top.
...
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),rM=p(),Bp=s("p"),iM=o("Finally, this model supports inherent JAX features such as:"),lM=p(),ao=s("ul"),Up=s("li"),xi=s("a"),dM=o("Just-In-Time (JIT) compilation"),cM=p(),Qp=s("li"),Li=s("a"),pM=o("Automatic Differentiation"),hM=p(),Hp=s("li"),Ri=s("a"),mM=o("Vectorization"),uM=p(),Kp=s("li"),Ei=s("a"),fM=o("Parallelization"),gM=p(),zi=s("p"),_M=o("This class overrides "),Ld=s("a"),bM=o("FlaxRobertaForMaskedLM"),kM=o(`. Please check the superclass for the appropriate documentation
...
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),DM=p(),eh=s("p"),SM=o("Finally, this model supports inherent JAX features such as:"),WM=p(),ro=s("ul"),th=s("li"),Oi=s("a"),BM=o("Just-In-Time (JIT) compilation"),UM=p(),oh=s("li"),Ni=s("a"),QM=o("Automatic Differentiation"),HM=p(),nh=s("li"),Ii=s("a"),KM=o("Vectorization"),VM=p(),sh=s("li"),Di=s("a"),JM=o("Parallelization"),GM=p(),Si=s("p"),YM=o("This class overrides "),Ed=s("a"),ZM=o("FlaxRobertaForSequenceClassification"),e$=o(`. Please check the superclass for the appropriate
documentation alongside usage examples.`),t$=p(),Zt=s("div"),v(Wi.$$.fragment),o$=p(),un=s("p"),n$=o("The "),ah=s("code"),s$=o("FlaxRobertaPreTrainedModel"),a$=o(" forward method, overrides the "),rh=s("code"),r$=o("__call__"),i$=o(" special method."),l$=p(),v(Is.$$.fragment),d$=p(),v(Ds.$$.fragment),tu=p(),fn=s("h2"),Ss=s("a"),ih=s("span"),v(Bi.$$.fragment),c$=p(),lh=s("span"),p$=o("FlaxXLMRobertaForMultipleChoice"),ou=p(),tt=s("div"),v(Ui.$$.fragment),h$=p(),dh=s("p"),m$=o(`XLM-RoBERTa Model with a multiple choice classification head on top (a linear layer on top of the pooled output and
...
documentation alongside usage examples.`),P$=p(),eo=s("div"),v(el.$$.fragment),A$=p(),gn=s("p"),O$=o("The "),fh=s("code"),N$=o("FlaxRobertaPreTrainedModel"),I$=o(" forward method, overrides the "),gh=s("code"),D$=o("__call__"),S$=o(" special method."),W$=p(),v(Ws.$$.fragment),B$=p(),v(Bs.$$.fragment),nu=p(),_n=s("h2"),Us=s("a"),_h=s("span"),v(tl.$$.fragment),U$=p(),bh=s("span"),Q$=o("FlaxXLMRobertaForTokenClassification"),su=p(),ot=s("div"),v(ol.$$.fragment),H$=p(),kh=s("p"),K$=o(`XLM-RoBERTa Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g.
...
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),S1=p(),zh=s("p"),W1=o("Finally, this model supports inherent JAX features such as:"),B1=p(),co=s("ul"),qh=s("li"),_l=s("a"),U1=o("Just-In-Time (JIT) compilation"),Q1=p(),Xh=s("li"),bl=s("a"),H1=o("Automatic Differentiation"),K1=p(),Ch=s("li"),kl=s("a"),V1=o("Vectorization"),J1=p(),jh=s("li"),yl=s("a"),G1=o("Parallelization"),Y1=p(),vl=s("p"),Z1=o("This class overrides "),Pd=s("a"),e2=o("FlaxRobertaForQuestionAnswering"),t2=o(`. Please check the superclass for the appropriate
documentation alongside usage examples.`),o2=p(),oo=s("div"),v(Tl.$$.fragment),n2=p(),vn=s("p"),s2=o("The "),Ph=s("code"),a2=o("FlaxRobertaPreTrainedModel"),r2=o(" forward method, overrides the "),Ah=s("code"),i2=o("__call__"),l2=o(" special method."),d2=p(),v(Vs.$$.fragment),c2=p(),v(Js.$$.fragment),this.h()},l(i){const b=WL('[data-svelte="svelte-1phssyn"]',document.head);d=a(b,"META",{name:!0,content:!0}),b.forEach(t),g=h(i),c=a(i,"H1",{class:!0});var wl=r(c);f=a(wl,"A",{id:!0,class:!0,href:!0});var Oh=r(f);k=a(Oh,"SPAN",{});var Nh=r(k);T(l.$$.fragment,Nh),Nh.forEach(t),Oh.forEach(t),m=h(wl),R=a(wl,"SPAN",{});var Ih=r(R);Me=n(Ih,"XLM-RoBERTa"),Ih.forEach(t),wl.forEach(t),be=h(i),O=a(i,"H2",{class:!0});var Ml=r(O);re=a(Ml,"A",{id:!0,class:!0,href:!0});var Dh=r(re);te=a(Dh,"SPAN",{});var Sh=r(te);T(L.$$.fragment,Sh),Sh.forEach(t),Dh.forEach(t),$e=h(Ml),U=a(Ml,"SPAN",{});var Wh=r(U);Fe=n(Wh,"Overview"),Wh.forEach(t),Ml.forEach(t),ke=h(i),D=a(i,"P",{});var $l=r(D);xe=n($l,"The XLM-RoBERTa model was proposed in "),le=a($l,"A",{href:!0,rel:!0});var Bh=r(le);H=n(Bh,"Unsupervised Cross-lingual Representation Learning at Scale"),Bh.forEach(t),Le=n($l,` by Alexis Conneau, Kartikay Khandelwal, Naman Goyal, Vishrav Chaudhary, Guillaume
Wenzek, Francisco Guzm\xE1n, Edouard Grave, Myle Ott, Luke Zettlemoyer and Veselin Stoyanov. It is based on Facebook\u2019s
RoBERTa model released in 2019. It is a large multi-lingual language model, trained on 2.5TB of filtered CommonCrawl
data.`),$l.forEach(t),ye=h(i),W=a(i,"P",{});var Uh=r(W);Re=n(Uh,"The abstract from the paper is the following:"),Uh.forEach(t),ve=h(i),B=a(i,"P",{});var Qh=r(B);ge=a(Qh,"EM",{});var Hh=r(ge);Ee=n(Hh,`This paper shows that pretraining multilingual language models at scale leads to significant performance gains for a
wide range of cross-lingual transfer tasks. We train a Transformer-based masked language model on one hundred
languages, using more than two terabytes of filtered CommonCrawl data. Our model, dubbed XLM-R, significantly
outperforms multilingual BERT (mBERT) on a variety of cross-lingual benchmarks, including +13.8% average accuracy on
XNLI, +12.3% average F1 score on MLQA, and +2.1% average F1 score on NER. XLM-R performs particularly well on
...
`),Wl=a(_o,"A",{href:!0});var k2=r(Wl);vg=n(k2,"RobertaTokenizer"),k2.forEach(t),Tg=n(_o," and "),Bl=a(_o,"A",{href:!0});var y2=r(Bl);wg=n(y2,"XLNetTokenizer"),y2.forEach(t),Mg=n(_o,`. Based on
...
not make use of token type ids, therefore a list of zeros is returned.`),F2.forEach(t),hu.forEach(t),go.forEach(t),wm=h(i),Xo=a(i,"H2",{class:!0});var mu=r(Xo);zn=a(mu,"A",{id:!0,class:!0,href:!0});var x2=r(zn);wc=a(x2,"SPAN",{});var L2=r(wc);T(za.$$.fragment,L2),L2.forEach(t),x2.forEach(t),Wg=h(mu),Mc=a(mu,"SPAN",{});var R2=r(Mc);Bg=n(R2,"XLMRobertaModel"),R2.forEach(t),mu.forEach(t),Mm=h(i),Ze=a(i,"DIV",{class:!0});var gt=r(Ze);T(qa.$$.fragment,gt),Ug=h(gt),$c=a(gt,"P",{});var E2=r($c);Qg=n(E2,"The bare XLM-RoBERTa Model transformer outputting raw hidden-states without any specific head on top."),E2.forEach(t),Hg=h(gt),Xa=a(gt,"P",{});var uu=r(Xa);Kg=n(uu,"This model inherits from "),Kl=a(uu,"A",{href:!0});var z2=r(Kl);Vg=n(z2,"PreTrainedModel"),z2.forEach(t),Jg=n(uu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Eu.forEach(t),lk=h(To),Kt=a(To,"DIV",{class:!0});var Zs=r(Kt);T(cr.$$.fragment,Zs),dk=h(Zs),So=a(Zs,"P",{});var Bd=r(So);ck=n(Bd,"The "),nd=a(Bd,"A",{href:!0});var yF=r(nd);pk=n(yF,"XLMRobertaForMultipleChoice"),yF.forEach(t),hk=n(Bd," forward method, overrides the "),Jc=a(Bd,"CODE",{});var vF=r(Jc);mk=n(vF,"__call__"),vF.forEach(t),uk=n(Bd," special method."),Bd.forEach(t),fk=h(Zs),T(Vn.$$.fragment,Zs),gk=h(Zs),T(Jn.$$.fragment,Zs),Zs.forEach(t),To.forEach(t),Xm=h(i),Wo=a(i,"H2",{class:!0});var zu=r(Wo);Gn=a(zu,"A",{id:!0,class:!0,href:!0});var TF=r(Gn);Gc=a(TF,"SPAN",{});var wF=r(Gc);T(pr.$$.fragment,wF),wF.forEach(t),TF.forEach(t),_k=h(zu),Yc=a(zu,"SPAN",{});var MF=r(Yc);bk=n(MF,"XLMRobertaForTokenClassification"),MF.forEach(t),zu.forEach(t),Cm=h(i),Ft=a(i,"DIV",{class:!0});var wo=r(Ft);T(hr.$$.fragment,wo),kk=h(wo),Zc=a(wo,"P",{});var $F=r(Zc);yk=n($F,`XLM-RoBERTa Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g.
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Pu.forEach(t),ty=h($o),Et=a($o,"DIV",{class:!0});var Fo=r(Et);T(Tr.$$.fragment,Fo),oy=h(Fo),Ho=a(Fo,"P",{});var Hd=r(Ho);ny=n(Hd,"The "),id=a(Hd,"A",{href:!0});var AF=r(id);sy=n(AF,"XLMRobertaForQuestionAnswering"),AF.forEach(t),ay=n(Hd," forward method, overrides the "),ap=a(Hd,"CODE",{});var OF=r(ap);ry=n(OF,"__call__"),OF.forEach(t),iy=n(Hd," special method."),Hd.forEach(t),ly=h(Fo),T(os.$$.fragment,Fo),dy=h(Fo),T(ns.$$.fragment,Fo),cy=h(Fo),T(ss.$$.fragment,Fo),Fo.forEach(t),$o.forEach(t),Am=h(i),Ko=a(i,"H2",{class:!0});var Au=r(Ko);as=a(Au,"A",{id:!0,class:!0,href:!0});var NF=r(as);rp=a(NF,"SPAN",{});var IF=r(rp);T(wr.$$.fragment,IF),IF.forEach(t),NF.forEach(t),py=h(Au),ip=a(Au,"SPAN",{});var DF=r(ip);hy=n(DF,"TFXLMRobertaModel"),DF.forEach(t),Au.forEach(t),Om=h(i),at=a(i,"DIV",{class:!0});var At=r(at);T(Mr.$$.fragment,At),my=h(At),lp=a(At,"P",{});var SF=r(lp);uy=n(SF,"The bare XLM-RoBERTa Model transformer outputting raw hidden-states without any specific head on top."),SF.forEach(t),fy=h(At),$r=a(At,"P",{});var Ou=r($r);gy=n(Ou,"This model inherits from "),ld=a(Ou,"A",{href:!0});var WF=r(ld);_y=n(WF,"TFPreTrainedModel"),WF.forEach(t),by=n(Ou,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Ou.forEach(t),ky=h(At),Fr=a(At,"P",{});var Nu=r(Fr);yy=n(Nu,"This model is also a "),xr=a(Nu,"A",{href:!0,rel:!0});var BF=r(xr);vy=n(BF,"tf.keras.Model"),BF.forEach(t),Ty=n(Nu,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Ku.forEach(t),Mv=h(Nt),T(fs.$$.fragment,Nt),$v=h(Nt),Wr=a(Nt,"P",{});var Vu=r(Wr);Fv=n(Vu,"This class overrides "),fd=a(Vu,"A",{href:!0});var dx=r(fd);xv=n(dx,"TFRobertaForSequenceClassification"),dx.forEach(t),Lv=n(Vu,`. Please check the superclass for the appropriate
documentation alongside usage examples.`),Vu.forEach(t),Rv=h(Nt),qt=a(Nt,"DIV",{class:!0});var Lo=r(qt);T(Br.$$.fragment,Lo),Ev=h(Lo),Zo=a(Lo,"P",{});var Jd=r(Zo);zv=n(Jd,"The "),gd=a(Jd,"A",{href:!0});var cx=r(gd);qv=n(cx,"TFRobertaForSequenceClassification"),cx.forEach(t),Xv=n(Jd," forward method, overrides the "),_p=a(Jd,"CODE",{});var px=r(_p);Cv=n(px,"__call__"),px.forEach(t),jv=n(Jd," special method."),Jd.forEach(t),Pv=h(Lo),T(gs.$$.fragment,Lo),Av=h(Lo),T(_s.$$.fragment,Lo),Ov=h(Lo),T(bs.$$.fragment,Lo),Lo.forEach(t),Nt.forEach(t),Wm=h(i),en=a(i,"H2",{class:!0});var Ju=r(en);ks=a(Ju,"A",{id:!0,class:!0,href:!0});var hx=r(ks);bp=a(hx,"SPAN",{});var mx=r(bp);T(Ur.$$.fragment,mx),mx.forEach(t),hx.forEach(t),Nv=h(Ju),kp=a(Ju,"SPAN",{});var ux=r(kp);Iv=n(ux,"TFXLMRobertaForMultipleChoice"),ux.forEach(t),Ju.forEach(t),Bm=h(i),lt=a(i,"DIV",{class:!0});var It=r(lt);T(Qr.$$.fragment,It),Dv=h(It),yp=a(It,"P",{});var fx=r(yp);Sv=n(fx,`Roberta Model with a multiple choice classification head on top (a linear layer on top of the pooled output and a
softmax) e.g. for RocStories/SWAG tasks.`),fx.forEach(t),Wv=h(It),Hr=a(It,"P",{});var Gu=r(Hr);Bv=n(Gu,"This model inherits from "),_d=a(Gu,"A",{href:!0});var gx=r(_d);Uv=n(gx,"TFPreTrainedModel"),gx.forEach(t),Qv=n(Gu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
documentation alongside usage examples.`),lf.forEach(t),aw=h(St),Ct=a(St,"DIV",{class:!0});var Eo=r(Ct);T(pi.$$.fragment,Eo),rw=h(Eo),rn=a(Eo,"P",{});var ec=r(rn);iw=n(ec,"The "),Md=a(ec,"A",{href:!0});var Ox=r(Md);lw=n(Ox,"TFRobertaForQuestionAnswering"),Ox.forEach(t),dw=n(ec," forward method, overrides the "),zp=a(ec,"CODE",{});var Nx=r(zp);cw=n(Nx,"__call__"),Nx.forEach(t),pw=n(ec," special method."),ec.forEach(t),hw=h(Eo),T(Es.$$.fragment,Eo),mw=h(Eo),T(zs.$$.fragment,Eo),uw=h(Eo),T(qs.$$.fragment,Eo),Eo.forEach(t),St.forEach(t),Vm=h(i),ln=a(i,"H2",{class:!0});var df=r(ln);Xs=a(df,"A",{id:!0,class:!0,href:!0});var Ix=r(Xs);qp=a(Ix,"SPAN",{});var Dx=r(qp);T(hi.$$.fragment,Dx),Dx.forEach(t),Ix.forEach(t),fw=h(df),Xp=a(df,"SPAN",{});var Sx=r(Xp);gw=n(Sx,"FlaxXLMRobertaModel"),Sx.forEach(t),df.forEach(t),Jm=h(i),pt=a(i,"DIV",{class:!0});var Wt=r(pt);T(mi.$$.fragment,Wt),_w=h(Wt),ui=a(Wt,"P",{});var cf=r(ui);bw=n(cf,`The bare XLM-RoBERTa Model transformer outputting raw hidden-states without any specific head on top.
This model inherits from `),$d=a(cf,"A",{href:!0});var Wx=r($d);kw=n(Wx,"FlaxPreTrainedModel"),Wx.forEach(t),yw=n(cf,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),cf.forEach(t),vw=h(Wt),fi=a(Wt,"P",{});var pf=r(fi);Tw=n(pf,"This model is also a Flax Linen "),gi=a(pf,"A",{href:!0,rel:!0});var Bx=r(gi);ww=n(Bx,"flax.linen.Module"),Bx.forEach(t),Mw=n(pf,`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),pf.forEach(t),$w=h(Wt),Cp=a(Wt,"P",{});var Ux=r(Cp);Fw=n(Ux,"Finally, this model supports inherent JAX features such as:"),Ux.forEach(t),xw=h(Wt),so=a(Wt,"UL",{});var oa=r(so);jp=a(oa,"LI",{});var Qx=r(jp);_i=a(Qx,"A",{href:!0,rel:!0});var Hx=r(_i);Lw=n(Hx,"Just-In-Time (JIT) compilation"),Hx.forEach(t),Qx.forEach(t),Rw=h(oa),Pp=a(oa,"LI",{});var Kx=r(Pp);bi=a(Kx,"A",{href:!0,rel:!0});var Vx=r(bi);Ew=n(Vx,"Automatic Differentiation"),Vx.forEach(t),Kx.forEach(t),zw=h(oa),Ap=a(oa,"LI",{});var Jx=r(Ap);ki=a(Jx,"A",{href:!0,rel:!0});var Gx=r(ki);qw=n(Gx,"Vectorization"),Gx.forEach(t),Jx.forEach(t),Xw=h(oa),Op=a(oa,"LI",{});var Yx=r(Op);yi=a(Yx,"A",{href:!0,rel:!0});var Zx=r(yi);Cw=n(Zx,"Parallelization"),Zx.forEach(t),Yx.forEach(t),oa.forEach(t),jw=h(Wt),vi=a(Wt,"P",{});var hf=r(vi);Pw=n(hf,"This class overrides "),Fd=a(hf,"A",{href:!0});var e0=r(Fd);Aw=n(e0,"FlaxRobertaModel"),e0.forEach(t),Ow=n(hf,`. Please check the superclass for the appropriate documentation alongside
usage examples.`),hf.forEach(t),Nw=h(Wt),Gt=a(Wt,"DIV",{class:!0});var na=r(Gt);T(Ti.$$.fragment,na),Iw=h(na),dn=a(na,"P",{});var tc=r(dn);Dw=n(tc,"The "),Np=a(tc,"CODE",{});var t0=r(Np);Sw=n(t0,"FlaxRobertaPreTrainedModel"),t0.forEach(t),Ww=n(tc," forward method, overrides the "),Ip=a(tc,"CODE",{});var o0=r(Ip);Bw=n(o0,"__call__"),o0.forEach(t),Uw=n(tc," special method."),tc.forEach(t),Qw=h(na),T(Cs.$$.fragment,na),Hw=h(na),T(js.$$.fragment,na),na.forEach(t),Wt.forEach(t),Gm=h(i),cn=a(i,"H2",{class:!0});var mf=r(cn);Ps=a(mf,"A",{id:!0,class:!0,href:!0});var n0=r(Ps);Dp=a(n0,"SPAN",{});var s0=r(Dp);T(wi.$$.fragment,s0),s0.forEach(t),n0.forEach(t),Kw=h(mf),Sp=a(mf,"SPAN",{});var a0=r(Sp);Vw=n(a0,"FlaxXLMRobertaForMaskedLM"),a0.forEach(t),mf.forEach(t),Ym=h(i),ht=a(i,"DIV",{class:!0});var Bt=r(ht);T(Mi.$$.fragment,Bt),Jw=h(Bt),pn=a(Bt,"P",{});var oc=r(pn);Gw=n(oc,"XLM-RoBERTa Model with a "),Wp=a(oc,"CODE",{});var r0=r(Wp);Yw=n(r0,"language modeling"),r0.forEach(t),Zw=n(oc,` head on top.
...
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),oc.forEach(t),oM=h(Bt),$i=a(Bt,"P",{});var uf=r($i);nM=n(uf,"This model is also a Flax Linen "),Fi=a(uf,"A",{href:!0,rel:!0});var l0=r(Fi);sM=n(l0,"flax.linen.Module"),l0.forEach(t),aM=n(uf,`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),uf.forEach(t),rM=h(Bt),Bp=a(Bt,"P",{});var d0=r(Bp);iM=n(d0,"Finally, this model supports inherent JAX features such as:"),d0.forEach(t),lM=h(Bt),ao=a(Bt,"UL",{});var sa=r(ao);Up=a(sa,"LI",{});var c0=r(Up);xi=a(c0,"A",{href:!0,rel:!0});var p0=r(xi);dM=n(p0,"Just-In-Time (JIT) compilation"),p0.forEach(t),c0.forEach(t),cM=h(sa),Qp=a(sa,"LI",{});var h0=r(Qp);Li=a(h0,"A",{href:!0,rel:!0});var m0=r(Li);pM=n(m0,"Automatic Differentiation"),m0.forEach(t),h0.forEach(t),hM=h(sa),Hp=a(sa,"LI",{});var u0=r(Hp);Ri=a(u0,"A",{href:!0,rel:!0});var f0=r(Ri);mM=n(f0,"Vectorization"),f0.forEach(t),u0.forEach(t),uM=h(sa),Kp=a(sa,"LI",{});var g0=r(Kp);Ei=a(g0,"A",{href:!0,rel:!0});var _0=r(Ei);fM=n(_0,"Parallelization"),_0.forEach(t),g0.forEach(t),sa.forEach(t),gM=h(Bt),zi=a(Bt,"P",{});var ff=r(zi);_M=n(ff,"This class overrides "),Ld=a(ff,"A",{href:!0});var b0=r(Ld);bM=n(b0,"FlaxRobertaForMaskedLM"),b0.forEach(t),kM=n(ff,`. Please check the superclass for the appropriate documentation
alongside usage examples.`),ff.forEach(t),yM=h(Bt),Yt=a(Bt,"DIV",{class:!0});var aa=r(Yt);T(qi.$$.fragment,aa),vM=h(aa),hn=a(aa,"P",{});var nc=r(hn);TM=n(nc,"The "),Vp=a(nc,"CODE",{});var k0=r(Vp);wM=n(k0,"FlaxRobertaPreTrainedModel"),k0.forEach(t),MM=n(nc," forward method, overrides the "),Jp=a(nc,"CODE",{});var y0=r(Jp);$M=n(y0,"__call__"),y0.forEach(t),FM=n(nc," special method."),nc.forEach(t),xM=h(aa),T(As.$$.fragment,aa),LM=h(aa),T(Os.$$.fragment,aa),aa.forEach(t),Bt.forEach(t),Zm=h(i),mn=a(i,"H2",{class:!0});var gf=r(mn);Ns=a(gf,"A",{id:!0,class:!0,href:!0});var v0=r(Ns);Gp=a(v0,"SPAN",{});var T0=r(Gp);T(Xi.$$.fragment,T0),T0.forEach(t),v0.forEach(t),RM=h(gf),Yp=a(gf,"SPAN",{});var w0=r(Yp);EM=n(w0,"FlaxXLMRobertaForSequenceClassification"),w0.forEach(t),gf.forEach(t),eu=h(i),et=a(i,"DIV",{class:!0});var _t=r(et);T(Ci.$$.fragment,_t),zM=h(_t),Zp=a(_t,"P",{});var M0=r(Zp);qM=n(M0,`XLM-RoBERTa Model transformer with a sequence classification/regression head on top (a linear layer on top of the
...
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),bf.forEach(t),DM=h(_t),eh=a(_t,"P",{});var x0=r(eh);SM=n(x0,"Finally, this model supports inherent JAX features such as:"),x0.forEach(t),WM=h(_t),ro=a(_t,"UL",{});var ra=r(ro);th=a(ra,"LI",{});var L0=r(th);Oi=a(L0,"A",{href:!0,rel:!0});var R0=r(Oi);BM=n(R0,"Just-In-Time (JIT) compilation"),R0.forEach(t),L0.forEach(t),UM=h(ra),oh=a(ra,"LI",{});var E0=r(oh);Ni=a(E0,"A",{href:!0,rel:!0});var z0=r(Ni);QM=n(z0,"Automatic Differentiation"),z0.forEach(t),E0.forEach(t),HM=h(ra),nh=a(ra,"LI",{});var q0=r(nh);Ii=a(q0,"A",{href:!0,rel:!0});var X0=r(Ii);KM=n(X0,"Vectorization"),X0.forEach(t),q0.forEach(t),VM=h(ra),sh=a(ra,"LI",{});var C0=r(sh);Di=a(C0,"A",{href:!0,rel:!0});var j0=r(Di);JM=n(j0,"Parallelization"),j0.forEach(t),C0.forEach(t),ra.forEach(t),GM=h(_t),Si=a(_t,"P",{});var kf=r(Si);YM=n(kf,"This class overrides "),Ed=a(kf,"A",{href:!0});var P0=r(Ed);ZM=n(P0,"FlaxRobertaForSequenceClassification"),P0.forEach(t),e$=n(kf,`. Please check the superclass for the appropriate
documentation alongside usage examples.`),kf.forEach(t),t$=h(_t),Zt=a(_t,"DIV",{class:!0});var ia=r(Zt);T(Wi.$$.fragment,ia),o$=h(ia),un=a(ia,"P",{});var sc=r(un);n$=n(sc,"The "),ah=a(sc,"CODE",{});var A0=r(ah);s$=n(A0,"FlaxRobertaPreTrainedModel"),A0.forEach(t),a$=n(sc," forward method, overrides the "),rh=a(sc,"CODE",{});var O0=r(rh);r$=n(O0,"__call__"),O0.forEach(t),i$=n(sc," special method."),sc.forEach(t),l$=h(ia),T(Is.$$.fragment,ia),d$=h(ia),T(Ds.$$.fragment,ia),ia.forEach(t),_t.forEach(t),tu=h(i),fn=a(i,"H2",{class:!0});var yf=r(fn);Ss=a(yf,"A",{id:!0,class:!0,href:!0});var N0=r(Ss);ih=a(N0,"SPAN",{});var I0=r(ih);T(Bi.$$.fragment,I0),I0.forEach(t),N0.forEach(t),c$=h(yf),lh=a(yf,"SPAN",{});var D0=r(lh);p$=n(D0,"FlaxXLMRobertaForMultipleChoice"),D0.forEach(t),yf.forEach(t),ou=h(i),tt=a(i,"DIV",{class:!0});var bt=r(tt);T(Ui.$$.fragment,bt),h$=h(bt),dh=a(bt,"P",{});var S0=r(dh);m$=n(S0,`XLM-RoBERTa Model with a multiple choice classification head on top (a linear layer on top of the pooled output and
a softmax) e.g. for RocStories/SWAG tasks.`),S0.forEach(t),u$=h(bt),Qi=a(bt,"P",{});var vf=r(Qi);f$=n(vf,"This model inherits from "),zd=a(vf,"A",{href:!0});var W0=r(zd);g$=n(W0,"FlaxPreTrainedModel"),W0.forEach(t),_$=n(vf,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),vf.forEach(t),b$=h(bt),Hi=a(bt,"P",{});var Tf=r(Hi);k$=n(Tf,"This model is also a Flax Linen "),Ki=a(Tf,"A",{href:!0,rel:!0});var B0=r(Ki);y$=n(B0,"flax.linen.Module"),B0.forEach(t),v$=n(Tf,`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
