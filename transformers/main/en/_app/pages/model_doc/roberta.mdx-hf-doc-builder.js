import{S as AM,i as LM,s as OM,e as a,k as h,w as v,t as n,M as NM,c as r,d as t,m,a as i,x as w,h as s,b as f,G as e,g as k,y as T,q as $,o as F,B as x,v as IM,L as re}from"../../chunks/vendor-hf-doc-builder.js";import{T as fe}from"../../chunks/Tip-hf-doc-builder.js";import{D as O}from"../../chunks/Docstring-hf-doc-builder.js";import{C as ie}from"../../chunks/CodeBlock-hf-doc-builder.js";import{I as De}from"../../chunks/IconCopyLink-hf-doc-builder.js";import{E as ae}from"../../chunks/ExampleCodeBlock-hf-doc-builder.js";function DM(R){let d,g,c,u,_;return u=new ie({props:{code:`from transformers import RobertaConfig, RobertaModel
...
positional argument:`),ee=h(),j=a("ul"),P=a("li"),ye=n("a single Tensor with "),Q=a("code"),Ee=n("input_ids"),ve=n(" only and nothing else: "),I=a("code"),he=n("model(input_ids)"),Me=h(),C=a("li"),ze=n(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),V=a("code"),qe=n("model([input_ids, attention_mask])"),me=n(" or "),G=a("code"),je=n("model([input_ids, attention_mask, token_type_ids])"),ne=h(),D=a("li"),ue=n(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),X=a("code"),Ce=n('model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),se=h(),A=a("p"),Pe=n(`Note that when creating models and layers with
`),L=a("a"),Ae=n("subclassing"),Le=n(` then you don\u2019t need to worry
about any of this, as you can just pass inputs like you would to any other Python function!`),this.h()},l(y){d=r(y,"P",{});var z=i(d);g=s(z,"TensorFlow models and layers in "),c=r(z,"CODE",{});var He=i(c);u=s(He,"transformers"),He.forEach(t),_=s(z," accept two formats as input:"),z.forEach(t),l=m(y),p=r(y,"UL",{});var de=i(p);E=r(de,"LI",{});var Xe=i(E);le=s(Xe,"having all inputs as keyword arguments (like PyTorch models), or"),Xe.forEach(t),Z=m(de),N=r(de,"LI",{});var Je=i(N);te=s(Je,"having all inputs as a list, tuple or dict in the first positional argument."),Je.forEach(t),de.forEach(t),oe=m(y),M=r(y,"P",{});var q=i(M);we=s(q,`The reason the second format is supported is that Keras methods prefer this format when passing inputs to models
and layers. Because of this support, when using methods like `),K=r(q,"CODE",{});var Ye=i(K);Te=s(Ye,"model.fit()"),Ye.forEach(t),ge=s(q,` things should \u201Cjust work\u201D for you - just
pass your inputs and labels in any format that `),B=r(q,"CODE",{});var Se=i(B);$e=s(Se,"model.fit()"),Se.forEach(t),pe=s(q,` supports! If, however, you want to use the second
format outside of Keras methods like `),J=r(q,"CODE",{});var Ze=i(J);Fe=s(Ze,"fit()"),Ze.forEach(t),_e=s(q," and "),U=r(q,"CODE",{});var et=i(U);xe=s(et,"predict()"),et.forEach(t),be=s(q,`, such as when creating your own layers or models with
the Keras `),H=r(q,"CODE",{});var Be=i(H);Re=s(Be,"Functional"),Be.forEach(t),ke=s(q,` API, there are three possibilities you can use to gather all the input Tensors in the first
positional argument:`),q.forEach(t),ee=m(y),j=r(y,"UL",{});var S=i(j);P=r(S,"LI",{});var Y=i(P);ye=s(Y,"a single Tensor with "),Q=r(Y,"CODE",{});var Ve=i(Q);Ee=s(Ve,"input_ids"),Ve.forEach(t),ve=s(Y," only and nothing else: "),I=r(Y,"CODE",{});var Oe=i(I);he=s(Oe,"model(input_ids)"),Oe.forEach(t),Y.forEach(t),Me=m(S),C=r(S,"LI",{});var W=i(C);ze=s(W,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),V=r(W,"CODE",{});var Qe=i(V);qe=s(Qe,"model([input_ids, attention_mask])"),Qe.forEach(t),me=s(W," or "),G=r(W,"CODE",{});var We=i(G);je=s(We,"model([input_ids, attention_mask, token_type_ids])"),We.forEach(t),W.forEach(t),ne=m(S),D=r(S,"LI",{});var Ne=i(D);ue=s(Ne,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),X=r(Ne,"CODE",{});var Ke=i(X);Ce=s(Ke,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),Ke.forEach(t),Ne.forEach(t),S.forEach(t),se=m(y),A=r(y,"P",{});var ce=i(A);Pe=s(ce,`Note that when creating models and layers with
`),L=r(ce,"A",{href:!0,rel:!0});var Ge=i(L);Ae=s(Ge,"subclassing"),Ge.forEach(t),Le=s(ce,` then you don\u2019t need to worry
about any of this, as you can just pass inputs like you would to any other Python function!`),ce.forEach(t),this.h()},h(){f(L,"href","https://keras.io/guides/making_new_layers_and_models_via_subclassing/"),f(L,"rel","nofollow")},m(y,z){k(y,d,z),e(d,g),e(d,c),e(c,u),e(d,_),k(y,l,z),k(y,p,z),e(p,E),e(E,le),e(p,Z),e(p,N),e(N,te),k(y,oe,z),k(y,M,z),e(M,we),e(M,K),e(K,Te),e(M,ge),e(M,B),e(B,$e),e(M,pe),e(M,J),e(J,Fe),e(M,_e),e(M,U),e(U,xe),e(M,be),e(M,H),e(H,Re),e(M,ke),k(y,ee,z),k(y,j,z),e(j,P),e(P,ye),e(P,Q),e(Q,Ee),e(P,ve),e(P,I),e(I,he),e(j,Me),e(j,C),e(C,ze),e(C,V),e(V,qe),e(C,me),e(C,G),e(G,je),e(j,ne),e(j,D),e(D,ue),e(D,X),e(X,Ce),k(y,se,z),k(y,A,z),e(A,Pe),e(A,L),e(L,Ae),e(A,Le)},d(y){y&&t(d),y&&t(l),y&&t(p),y&&t(oe),y&&t(M),y&&t(ee),y&&t(j),y&&t(se),y&&t(A)}}}function hz(R){let d,g,c,u,_;return{c(){d=a("p"),g=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),c=a("code"),u=n("Module"),_=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(l){d=r(l,"P",{});var p=i(d);g=s(p,"Although the recipe for forward pass needs to be defined within this function, one should call the "),c=r(p,"CODE",{});var E=i(c);u=s(E,"Module"),E.forEach(t),_=s(p,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
`),X=r(Ne,"CODE",{});var Ke=i(X);Ce=s(Ke,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),Ke.forEach(t),Ne.forEach(t),S.forEach(t),se=m(y),A=r(y,"P",{});var ce=i(A);Pe=s(ce,`Note that when creating models and layers with
`),L=r(ce,"A",{href:!0,rel:!0});var Ge=i(L);Ae=s(Ge,"subclassing"),Ge.forEach(t),Le=s(ce,` then you don\u2019t need to worry
about any of this, as you can just pass inputs like you would to any other Python function!`),ce.forEach(t),this.h()},h(){f(L,"href","https://keras.io/guides/making_new_layers_and_models_via_subclassing/"),f(L,"rel","nofollow")},m(y,z){k(y,d,z),e(d,g),e(d,c),e(c,u),e(d,_),k(y,l,z),k(y,p,z),e(p,E),e(E,le),e(p,Z),e(p,N),e(N,te),k(y,oe,z),k(y,M,z),e(M,we),e(M,K),e(K,Te),e(M,ge),e(M,B),e(B,$e),e(M,pe),e(M,J),e(J,Fe),e(M,_e),e(M,U),e(U,xe),e(M,be),e(M,H),e(H,Re),e(M,ke),k(y,ee,z),k(y,j,z),e(j,P),e(P,ye),e(P,Q),e(Q,Ee),e(P,ve),e(P,I),e(I,he),e(j,Me),e(j,C),e(C,ze),e(C,V),e(V,qe),e(C,me),e(C,G),e(G,je),e(j,ne),e(j,D),e(D,ue),e(D,X),e(X,Ce),k(y,se,z),k(y,A,z),e(A,Pe),e(A,L),e(L,Ae),e(A,Le)},d(y){y&&t(d),y&&t(l),y&&t(p),y&&t(oe),y&&t(M),y&&t(ee),y&&t(j),y&&t(se),y&&t(A)}}}function _z(R){let d,g,c,u,_;return{c(){d=a("p"),g=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),c=a("code"),u=n("Module"),_=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(l){d=r(l,"P",{});var p=i(d);g=s(p,"Although the recipe for forward pass needs to be defined within this function, one should call the "),c=r(p,"CODE",{});var E=i(c);u=s(E,"Module"),E.forEach(t),_=s(p,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
`),X=r(Ne,"CODE",{});var Ke=i(X);Ce=s(Ke,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),Ke.forEach(t),Ne.forEach(t),S.forEach(t),se=m(y),A=r(y,"P",{});var ce=i(A);Pe=s(ce,`Note that when creating models and layers with
`),L=r(ce,"A",{href:!0,rel:!0});var Ge=i(L);Ae=s(Ge,"subclassing"),Ge.forEach(t),Le=s(ce,` then you don\u2019t need to worry
about any of this, as you can just pass inputs like you would to any other Python function!`),ce.forEach(t),this.h()},h(){f(L,"href","https://keras.io/guides/making_new_layers_and_models_via_subclassing/"),f(L,"rel","nofollow")},m(y,z){k(y,d,z),e(d,g),e(d,c),e(c,u),e(d,_),k(y,l,z),k(y,p,z),e(p,E),e(E,le),e(p,Z),e(p,N),e(N,te),k(y,oe,z),k(y,M,z),e(M,we),e(M,K),e(K,Te),e(M,ge),e(M,B),e(B,$e),e(M,pe),e(M,J),e(J,Fe),e(M,_e),e(M,U),e(U,xe),e(M,be),e(M,H),e(H,Re),e(M,ke),k(y,ee,z),k(y,j,z),e(j,P),e(P,ye),e(P,Q),e(Q,Ee),e(P,ve),e(P,I),e(I,he),e(j,Me),e(j,C),e(C,ze),e(C,V),e(V,qe),e(C,me),e(C,G),e(G,je),e(j,ne),e(j,D),e(D,ue),e(D,X),e(X,Ce),k(y,se,z),k(y,A,z),e(A,Pe),e(A,L),e(L,Ae),e(A,Le)},d(y){y&&t(d),y&&t(l),y&&t(p),y&&t(oe),y&&t(M),y&&t(ee),y&&t(j),y&&t(se),y&&t(A)}}}function vz(R){let d,g,c,u,_;return{c(){d=a("p"),g=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),c=a("code"),u=n("Module"),_=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(l){d=r(l,"P",{});var p=i(d);g=s(p,"Although the recipe for forward pass needs to be defined within this function, one should call the "),c=r(p,"CODE",{});var E=i(c);u=s(E,"Module"),E.forEach(t),_=s(p,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
`),X=r(Ne,"CODE",{});var Ke=i(X);Ce=s(Ke,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),Ke.forEach(t),Ne.forEach(t),S.forEach(t),se=m(y),A=r(y,"P",{});var ce=i(A);Pe=s(ce,`Note that when creating models and layers with
`),L=r(ce,"A",{href:!0,rel:!0});var Ge=i(L);Ae=s(Ge,"subclassing"),Ge.forEach(t),Le=s(ce,` then you don\u2019t need to worry
about any of this, as you can just pass inputs like you would to any other Python function!`),ce.forEach(t),this.h()},h(){f(L,"href","https://keras.io/guides/making_new_layers_and_models_via_subclassing/"),f(L,"rel","nofollow")},m(y,z){k(y,d,z),e(d,g),e(d,c),e(c,u),e(d,_),k(y,l,z),k(y,p,z),e(p,E),e(E,le),e(p,Z),e(p,N),e(N,te),k(y,oe,z),k(y,M,z),e(M,we),e(M,K),e(K,Te),e(M,ge),e(M,B),e(B,$e),e(M,pe),e(M,J),e(J,Fe),e(M,_e),e(M,U),e(U,xe),e(M,be),e(M,H),e(H,Re),e(M,ke),k(y,ee,z),k(y,j,z),e(j,P),e(P,ye),e(P,Q),e(Q,Ee),e(P,ve),e(P,I),e(I,he),e(j,Me),e(j,C),e(C,ze),e(C,V),e(V,qe),e(C,me),e(C,G),e(G,je),e(j,ne),e(j,D),e(D,ue),e(D,X),e(X,Ce),k(y,se,z),k(y,A,z),e(A,Pe),e(A,L),e(L,Ae),e(A,Le)},d(y){y&&t(d),y&&t(l),y&&t(p),y&&t(oe),y&&t(M),y&&t(ee),y&&t(j),y&&t(se),y&&t(A)}}}function Fz(R){let d,g,c,u,_;return{c(){d=a("p"),g=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),c=a("code"),u=n("Module"),_=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(l){d=r(l,"P",{});var p=i(d);g=s(p,"Although the recipe for forward pass needs to be defined within this function, one should call the "),c=r(p,"CODE",{});var E=i(c);u=s(E,"Module"),E.forEach(t),_=s(p,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
`),X=r(Ne,"CODE",{});var Ke=i(X);Ce=s(Ke,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),Ke.forEach(t),Ne.forEach(t),S.forEach(t),se=m(y),A=r(y,"P",{});var ce=i(A);Pe=s(ce,`Note that when creating models and layers with
`),L=r(ce,"A",{href:!0,rel:!0});var Ge=i(L);Ae=s(Ge,"subclassing"),Ge.forEach(t),Le=s(ce,` then you don\u2019t need to worry
about any of this, as you can just pass inputs like you would to any other Python function!`),ce.forEach(t),this.h()},h(){f(L,"href","https://keras.io/guides/making_new_layers_and_models_via_subclassing/"),f(L,"rel","nofollow")},m(y,z){k(y,d,z),e(d,g),e(d,c),e(c,u),e(d,_),k(y,l,z),k(y,p,z),e(p,E),e(E,le),e(p,Z),e(p,N),e(N,te),k(y,oe,z),k(y,M,z),e(M,we),e(M,K),e(K,Te),e(M,ge),e(M,B),e(B,$e),e(M,pe),e(M,J),e(J,Fe),e(M,_e),e(M,U),e(U,xe),e(M,be),e(M,H),e(H,Re),e(M,ke),k(y,ee,z),k(y,j,z),e(j,P),e(P,ye),e(P,Q),e(Q,Ee),e(P,ve),e(P,I),e(I,he),e(j,Me),e(j,C),e(C,ze),e(C,V),e(V,qe),e(C,me),e(C,G),e(G,je),e(j,ne),e(j,D),e(D,ue),e(D,X),e(X,Ce),k(y,se,z),k(y,A,z),e(A,Pe),e(A,L),e(L,Ae),e(A,Le)},d(y){y&&t(d),y&&t(l),y&&t(p),y&&t(oe),y&&t(M),y&&t(ee),y&&t(j),y&&t(se),y&&t(A)}}}function Ez(R){let d,g,c,u,_;return{c(){d=a("p"),g=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),c=a("code"),u=n("Module"),_=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(l){d=r(l,"P",{});var p=i(d);g=s(p,"Although the recipe for forward pass needs to be defined within this function, one should call the "),c=r(p,"CODE",{});var E=i(c);u=s(E,"Module"),E.forEach(t),_=s(p,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-built_in">round</span>(<span class="hljs-built_in">float</span>(loss), <span class="hljs-number">2</span>)
<span class="hljs-number">0.01</span>`}}),{c(){v(d.$$.fragment)},l(c){w(d.$$.fragment,c)},m(c,u){T(d,c,u),g=!0},p:re,i(c){g||($(d.$$.fragment,c),g=!0)},o(c){F(d.$$.fragment,c),g=!1},d(c){x(d,c)}}}function qz(R){let d,g,c,u,_,l,p,E,le,Z,N,te,oe,M,we,K,Te,ge,B,$e,pe,J,Fe,_e,U,xe,be,H,Re,ke,ee,j,P,ye,Q,Ee,ve,I,he,Me,C,ze,V,qe,me,G,je,ne,D,ue,X,Ce,se,A,Pe,L,Ae,Le;return{c(){d=a("p"),g=n("TensorFlow models and layers in "),c=a("code"),u=n("transformers"),_=n(" accept two formats as input:"),l=h(),p=a("ul"),E=a("li"),le=n("having all inputs as keyword arguments (like PyTorch models), or"),Z=h(),N=a("li"),te=n("having all inputs as a list, tuple or dict in the first positional argument."),oe=h(),M=a("p"),we=n(`The reason the second format is supported is that Keras methods prefer this format when passing inputs to models
and layers. Because of this support, when using methods like `),K=a("code"),Te=n("model.fit()"),ge=n(` things should \u201Cjust work\u201D for you - just
pass your inputs and labels in any format that `),B=a("code"),$e=n("model.fit()"),pe=n(` supports! If, however, you want to use the second
format outside of Keras methods like `),J=a("code"),Fe=n("fit()"),_e=n(" and "),U=a("code"),xe=n("predict()"),be=n(`, such as when creating your own layers or models with
the Keras `),H=a("code"),Re=n("Functional"),ke=n(` API, there are three possibilities you can use to gather all the input Tensors in the first
...
`),X=r(Ne,"CODE",{});var Ke=i(X);Ce=s(Ke,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),Ke.forEach(t),Ne.forEach(t),S.forEach(t),se=m(y),A=r(y,"P",{});var ce=i(A);Pe=s(ce,`Note that when creating models and layers with
`),L=r(ce,"A",{href:!0,rel:!0});var Ge=i(L);Ae=s(Ge,"subclassing"),Ge.forEach(t),Le=s(ce,` then you don\u2019t need to worry
about any of this, as you can just pass inputs like you would to any other Python function!`),ce.forEach(t),this.h()},h(){f(L,"href","https://keras.io/guides/making_new_layers_and_models_via_subclassing/"),f(L,"rel","nofollow")},m(y,z){k(y,d,z),e(d,g),e(d,c),e(c,u),e(d,_),k(y,l,z),k(y,p,z),e(p,E),e(E,le),e(p,Z),e(p,N),e(N,te),k(y,oe,z),k(y,M,z),e(M,we),e(M,K),e(K,Te),e(M,ge),e(M,B),e(B,$e),e(M,pe),e(M,J),e(J,Fe),e(M,_e),e(M,U),e(U,xe),e(M,be),e(M,H),e(H,Re),e(M,ke),k(y,ee,z),k(y,j,z),e(j,P),e(P,ye),e(P,Q),e(Q,Ee),e(P,ve),e(P,I),e(I,he),e(j,Me),e(j,C),e(C,ze),e(C,V),e(V,qe),e(C,me),e(C,G),e(G,je),e(j,ne),e(j,D),e(D,ue),e(D,X),e(X,Ce),k(y,se,z),k(y,A,z),e(A,Pe),e(A,L),e(L,Ae),e(A,Le)},d(y){y&&t(d),y&&t(l),y&&t(p),y&&t(oe),y&&t(M),y&&t(ee),y&&t(j),y&&t(se),y&&t(A)}}}function jz(R){let d,g,c,u,_;return{c(){d=a("p"),g=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),c=a("code"),u=n("Module"),_=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(l){d=r(l,"P",{});var p=i(d);g=s(p,"Although the recipe for forward pass needs to be defined within this function, one should call the "),c=r(p,"CODE",{});var E=i(c);u=s(E,"Module"),E.forEach(t),_=s(p,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),p.forEach(t)},m(l,p){k(l,d,p),e(d,g),e(d,c),e(c,u),e(d,_)},d(l){l&&t(d)}}}function Cz(R){let d,g,c,u,_;return u=new ie({props:{code:`from transformers import RobertaTokenizer, TFRobertaForQuestionAnswering
import tensorflow as tf
...
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-built_in">round</span>(<span class="hljs-built_in">float</span>(loss), <span class="hljs-number">2</span>)
<span class="hljs-number">0.86</span>`}}),{c(){v(d.$$.fragment)},l(c){w(d.$$.fragment,c)},m(c,u){T(d,c,u),g=!0},p:re,i(c){g||($(d.$$.fragment,c),g=!0)},o(c){F(d.$$.fragment,c),g=!1},d(c){x(d,c)}}}function Az(R){let d,g,c,u,_;return{c(){d=a("p"),g=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),c=a("code"),u=n("Module"),_=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(l){d=r(l,"P",{});var p=i(d);g=s(p,"Although the recipe for forward pass needs to be defined within this function, one should call the "),c=r(p,"CODE",{});var E=i(c);u=s(E,"Module"),E.forEach(t),_=s(p,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),p.forEach(t)},m(l,p){k(l,d,p),e(d,g),e(d,c),e(c,u),e(d,_)},d(l){l&&t(d)}}}function Lz(R){let d,g,c,u,_;return u=new ie({props:{code:`from transformers import RobertaTokenizer, FlaxRobertaModel
...
<span class="hljs-meta">&gt;&gt;&gt; </span>end_scores = outputs.end_logits`}}),{c(){d=a("p"),g=n("Example:"),c=h(),v(u.$$.fragment)},l(l){d=r(l,"P",{});var p=i(d);g=s(p,"Example:"),p.forEach(t),c=m(l),w(u.$$.fragment,l)},m(l,p){k(l,d,p),e(d,g),k(l,c,p),T(u,l,p),_=!0},p:re,i(l){_||($(u.$$.fragment,l),_=!0)},o(l){F(u.$$.fragment,l),_=!1},d(l){l&&t(d),l&&t(c),x(u,l)}}}function Vz(R){let d,g,c,u,_,l,p,E,le,Z,N,te,oe,M,we,K,Te,ge,B,$e,pe,J,Fe,_e,U,xe,be,H,Re,ke,ee,j,P,ye,Q,Ee,ve,I,he,Me,C,ze,V,qe,me,G,je,ne,D,ue,X,Ce,se,A,Pe,L,Ae,Le,y,z,He,de,Xe,Je,q,Ye,Se,Ze,et,Be,S,Y,Ve,Oe,W,Qe,We,Ne,Ke,ce,Ge,yt,Oa,ug,co,fg,id,gg,_g,ld,bg,kg,Na,yg,vg,wg,Ao,Tg,dd,$g,Fg,cd,xg,Rg,Eg,Lo,Mg,pd,zg,qg,hd,jg,Cg,Pg,Ln,ou,Oo,On,xc,Ia,Ag,Rc,Lg,nu,Ie,Da,Og,Ec,Ng,Ig,Mc,Dg,Sg,Nn,Bg,Sa,Wg,zc,Ug,Hg,Qg,In,Kg,Ba,Jg,md,Vg,Gg,Xg,vo,Wa,Yg,qc,Zg,e_,Ua,ud,t_,jc,o_,n_,fd,s_,Cc,a_,r_,Dn,Ha,i_,Qa,l_,Pc,d_,c_,p_,Sn,Ka,h_,Ac,m_,u_,gd,Ja,su,No,Bn,Lc,Va,f_,Oc,g_,au,tt,Ga,__,Xa,b_,Nc,k_,y_,v_,Ic,w_,T_,Wn,$_,Ya,F_,Dc,x_,R_,E_,Un,M_,Za,z_,_d,q_,j_,C_,bd,er,ru,Io,Hn,Sc,tr,P_,Bc,A_,iu,ot,or,L_,Wc,O_,N_,nr,I_,kd,D_,S_,B_,sr,W_,ar,U_,H_,Q_,rr,K_,Uc,J_,V_,G_,pt,X_,Hc,Y_,Z_,Qc,eb,tb,Kc,ob,nb,Jc,sb,ab,Vc,rb,ib,Gc,lb,db,cb,Qn,pb,Xc,hb,mb,ir,ub,fb,Ut,lr,gb,Do,_b,yd,bb,kb,Yc,yb,vb,wb,Kn,Tb,Jn,lu,So,Vn,Zc,dr,$b,ep,Fb,du,vt,cr,xb,pr,Rb,tp,Eb,Mb,zb,hr,qb,vd,jb,Cb,Pb,mr,Ab,ur,Lb,Ob,Nb,Ht,fr,Ib,Bo,Db,wd,Sb,Bb,op,Wb,Ub,Hb,Gn,Qb,Xn,cu,Wo,Yn,np,gr,Kb,sp,Jb,pu,wt,_r,Vb,br,Gb,ap,Xb,Yb,Zb,kr,ek,Td,tk,ok,nk,yr,sk,vr,ak,rk,ik,Rt,wr,lk,Uo,dk,$d,ck,pk,rp,hk,mk,uk,Zn,fk,es,gk,ts,hu,Ho,os,ip,Tr,_k,lp,bk,mu,Tt,$r,kk,dp,yk,vk,Fr,wk,Fd,Tk,$k,Fk,xr,xk,Rr,Rk,Ek,Mk,ct,Er,zk,Qo,qk,xd,jk,Ck,cp,Pk,Ak,Lk,ns,Ok,ss,Nk,as,Ik,rs,Dk,is,uu,Ko,ls,pp,Mr,Sk,hp,Bk,fu,$t,zr,Wk,mp,Uk,Hk,qr,Qk,Rd,Kk,Jk,Vk,jr,Gk,Cr,Xk,Yk,Zk,Qt,Pr,ey,Jo,ty,Ed,oy,ny,up,sy,ay,ry,ds,iy,cs,gu,Vo,ps,fp,Ar,ly,gp,dy,_u,Ft,Lr,cy,_p,py,hy,Or,my,Md,uy,fy,gy,Nr,_y,Ir,by,ky,yy,Et,Dr,vy,Go,wy,zd,Ty,$y,bp,Fy,xy,Ry,hs,Ey,ms,My,us,bu,Xo,fs,kp,Sr,zy,yp,qy,ku,xt,Br,jy,Yo,Cy,vp,Py,Ay,wp,Ly,Oy,Ny,Wr,Iy,qd,Dy,Sy,By,Ur,Wy,Hr,Uy,Hy,Qy,Mt,Qr,Ky,Zo,Jy,jd,Vy,Gy,Tp,Xy,Yy,Zy,gs,ev,_s,tv,bs,yu,en,ks,$p,Kr,ov,Fp,nv,vu,ht,Jr,sv,xp,av,rv,Vr,iv,Cd,lv,dv,cv,Gr,pv,Xr,hv,mv,uv,ys,fv,Kt,Yr,gv,tn,_v,Pd,bv,kv,Rp,yv,vv,wv,vs,Tv,ws,wu,on,Ts,Ep,Zr,$v,Mp,Fv,Tu,nn,ei,xv,Jt,ti,Rv,sn,Ev,Ad,Mv,zv,zp,qv,jv,Cv,$s,Pv,Fs,$u,an,xs,qp,oi,Av,jp,Lv,Fu,mt,ni,Ov,si,Nv,Cp,Iv,Dv,Sv,ai,Bv,Ld,Wv,Uv,Hv,ri,Qv,ii,Kv,Jv,Vv,Rs,Gv,zt,li,Xv,rn,Yv,Od,Zv,ew,Pp,tw,ow,nw,Es,sw,Ms,aw,zs,xu,ln,qs,Ap,di,rw,Lp,iw,Ru,ut,ci,lw,Op,dw,cw,pi,pw,Nd,hw,mw,uw,hi,fw,mi,gw,_w,bw,js,kw,qt,ui,yw,dn,vw,Id,ww,Tw,Np,$w,Fw,xw,Cs,Rw,Ps,Ew,As,Eu,cn,Ls,Ip,fi,Mw,Dp,zw,Mu,ft,gi,qw,Sp,jw,Cw,_i,Pw,Dd,Aw,Lw,Ow,bi,Nw,ki,Iw,Dw,Sw,Os,Bw,Vt,yi,Ww,pn,Uw,Sd,Hw,Qw,Bp,Kw,Jw,Vw,Ns,Gw,Is,zu,hn,Ds,Wp,vi,Xw,Up,Yw,qu,gt,wi,Zw,Hp,eT,tT,Ti,oT,Bd,nT,sT,aT,$i,rT,Fi,iT,lT,dT,Ss,cT,jt,xi,pT,mn,hT,Wd,mT,uT,Qp,fT,gT,_T,Bs,bT,Ws,kT,Us,ju,un,Hs,Kp,Ri,yT,Jp,vT,Cu,_t,Ei,wT,fn,TT,Vp,$T,FT,Gp,xT,RT,ET,Mi,MT,Ud,zT,qT,jT,zi,CT,qi,PT,AT,LT,Qs,OT,Ct,ji,NT,gn,IT,Hd,DT,ST,Xp,BT,WT,UT,Ks,HT,Js,QT,Vs,Pu,_n,Gs,Yp,Ci,KT,Zp,JT,Au,nt,Pi,VT,eh,GT,XT,Ai,YT,Qd,ZT,e$,t$,Li,o$,Oi,n$,s$,a$,th,r$,i$,po,oh,Ni,l$,d$,nh,Ii,c$,p$,sh,Di,h$,m$,ah,Si,u$,f$,Gt,Bi,g$,bn,_$,rh,b$,k$,ih,y$,v$,w$,Xs,T$,Ys,Lu,kn,Zs,lh,Wi,$$,dh,F$,Ou,st,Ui,x$,ch,R$,E$,Hi,M$,Kd,z$,q$,j$,Qi,C$,Ki,P$,A$,L$,ph,O$,N$,ho,hh,Ji,I$,D$,mh,Vi,S$,B$,uh,Gi,W$,U$,fh,Xi,H$,Q$,Xt,Yi,K$,yn,J$,gh,V$,G$,_h,X$,Y$,Z$,ea,e1,ta,Nu,vn,oa,bh,Zi,t1,kh,o1,Iu,at,el,n1,tl,s1,yh,a1,r1,i1,ol,l1,Jd,d1,c1,p1,nl,h1,sl,m1,u1,f1,vh,g1,_1,mo,wh,al,b1,k1,Th,rl,y1,v1,$h,il,w1,T1,Fh,ll,$1,F1,Yt,dl,x1,wn,R1,xh,E1,M1,Rh,z1,q1,j1,na,C1,sa,Du,Tn,aa,Eh,cl,P1,Mh,A1,Su,rt,pl,L1,zh,O1,N1,hl,I1,Vd,D1,S1,B1,ml,W1,ul,U1,H1,Q1,qh,K1,J1,uo,jh,fl,V1,G1,Ch,gl,X1,Y1,Ph,_l,Z1,e2,Ah,bl,t2,o2,Zt,kl,n2,$n,s2,Lh,a2,r2,Oh,i2,l2,d2,ra,c2,ia,Bu,Fn,la,Nh,yl,p2,Ih,h2,Wu,it,vl,m2,Dh,u2,f2,wl,g2,Gd,_2,b2,k2,Tl,y2,$l,v2,w2,T2,Sh,$2,F2,fo,Bh,Fl,x2,R2,Wh,xl,E2,M2,Uh,Rl,z2,q2,Hh,El,j2,C2,eo,Ml,P2,xn,A2,Qh,L2,O2,Kh,N2,I2,D2,da,S2,ca,Uu,Rn,pa,Jh,zl,B2,Vh,W2,Hu,lt,ql,U2,Gh,H2,Q2,jl,K2,Xd,J2,V2,G2,Cl,X2,Pl,Y2,Z2,eF,Xh,tF,oF,go,Yh,Al,nF,sF,Zh,Ll,aF,rF,em,Ol,iF,lF,tm,Nl,dF,cF,to,Il,pF,En,hF,om,mF,uF,nm,fF,gF,_F,ha,bF,ma,Qu,Mn,ua,sm,Dl,kF,am,yF,Ku,dt,Sl,vF,zn,wF,rm,TF,$F,im,FF,xF,RF,Bl,EF,Yd,MF,zF,qF,Wl,jF,Ul,CF,PF,AF,lm,LF,OF,_o,dm,Hl,NF,IF,cm,Ql,DF,SF,pm,Kl,BF,WF,hm,Jl,UF,HF,oo,Vl,QF,qn,KF,mm,JF,VF,um,GF,XF,YF,fa,ZF,ga,Ju;return l=new De({}),M=new De({}),We=new De({}),Oa=new O({props:{name:"class transformers.RobertaConfig",anchor:"transformers.RobertaConfig",parameters:[{name:"pad_token_id",val:" = 1"},{name:"bos_token_id",val:" = 0"},{name:"eos_token_id",val:" = 2"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/roberta/configuration_roberta.py#L37"}}),Ln=new ae({props:{anchor:"transformers.RobertaConfig.example",$$slots:{default:[DM]},$$scope:{ctx:R}}}),Ia=new De({}),Da=new O({props:{name:"class transformers.RobertaTokenizer",anchor:"transformers.RobertaTokenizer",parameters:[{name:"vocab_file",val:""},{name:"merges_file",val:""},{name:"errors",val:" = 'replace'"},{name:"bos_token",val:" = '<s>'"},{name:"eos_token",val:" = '</s>'"},{name:"sep_token",val:" = '</s>'"},{name:"cls_token",val:" = '<s>'"},{name:"unk_token",val:" = '<unk>'"},{name:"pad_token",val:" = '<pad>'"},{name:"mask_token",val:" = '<mask>'"},{name:"add_prefix_space",val:" = False"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.RobertaTokenizer.vocab_file",description:`<strong>vocab_file</strong> (<code>str</code>) &#x2014;
...
<code>past_key_values</code>).`,name:"use_cache"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/roberta/modeling_roberta.py#L735",returnDescription:`
<p>A <a
...
model. Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/main/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/roberta/modeling_roberta.py#L876"}}),fr=new O({props:{name:"forward",anchor:"transformers.RobertaForCausalLM.forward",parameters:[{name:"input_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"attention_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"token_type_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"position_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"head_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"encoder_hidden_states",val:": typing.Optional[torch.FloatTensor] = None"},{name:"encoder_attention_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"labels",val:": typing.Optional[torch.LongTensor] = None"},{name:"past_key_values",val:": typing.Tuple[typing.Tuple[torch.FloatTensor]] = None"},{name:"use_cache",val:": typing.Optional[bool] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.RobertaForCausalLM.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/main/en/model_doc/roberta#transformers.RobertaTokenizer">RobertaTokenizer</a>. See <a href="/docs/transformers/main/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/main/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
If set to <code>True</code>, <code>past_key_values</code> key value states are returned and can be used to speed up decoding (see
<code>past_key_values</code>).`,name:"use_cache"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/roberta/modeling_roberta.py#L902",returnDescription:`
<p>A <a
...
Used to hide legacy arguments that have been deprecated.`,name:"kwargs"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/roberta/modeling_roberta.py#L1057",returnDescription:`
<p>A <a
...
model. Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/main/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/roberta/modeling_roberta.py#L1159"}}),Er=new O({props:{name:"forward",anchor:"transformers.RobertaForSequenceClassification.forward",parameters:[{name:"input_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"attention_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"token_type_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"position_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"head_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"labels",val:": typing.Optional[torch.LongTensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.RobertaForSequenceClassification.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/main/en/model_doc/roberta#transformers.RobertaTokenizer">RobertaTokenizer</a>. See <a href="/docs/transformers/main/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/main/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/roberta/modeling_roberta.py#L1173",returnDescription:`
<p>A <a
...
<code>input_ids</code> above)`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/roberta/modeling_roberta.py#L1272",returnDescription:`
<p>A <a
...
`}}),ds=new fe({props:{$$slots:{default:[nz]},$$scope:{ctx:R}}}),cs=new ae({props:{anchor:"transformers.RobertaForMultipleChoice.forward.example",$$slots:{default:[sz]},$$scope:{ctx:R}}}),Ar=new De({}),Lr=new O({props:{name:"class transformers.RobertaForTokenClassification",anchor:"transformers.RobertaForTokenClassification",parameters:[{name:"config",val:""}],parametersDescription:[{anchor:"transformers.RobertaForTokenClassification.config",description:`<strong>config</strong> (<a href="/docs/transformers/main/en/model_doc/roberta#transformers.RobertaConfig">RobertaConfig</a>) &#x2014; Model configuration class with all the parameters of the
model. Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/main/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/roberta/modeling_roberta.py#L1352"}}),Dr=new O({props:{name:"forward",anchor:"transformers.RobertaForTokenClassification.forward",parameters:[{name:"input_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"attention_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"token_type_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"position_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"head_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"labels",val:": typing.Optional[torch.LongTensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.RobertaForTokenClassification.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/main/en/model_doc/roberta#transformers.RobertaTokenizer">RobertaTokenizer</a>. See <a href="/docs/transformers/main/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/main/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/roberta/modeling_roberta.py#L1370",returnDescription:`
<p>A <a
...
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/roberta/modeling_roberta.py#L1475",returnDescription:`
<p>A <a
...
`}}),Cs=new fe({props:{$$slots:{default:[vz]},$$scope:{ctx:R}}}),Ps=new ae({props:{anchor:"transformers.TFRobertaForSequenceClassification.call.example",$$slots:{default:[wz]},$$scope:{ctx:R}}}),As=new ae({props:{anchor:"transformers.TFRobertaForSequenceClassification.call.example-2",$$slots:{default:[Tz]},$$scope:{ctx:R}}}),fi=new De({}),gi=new O({props:{name:"class transformers.TFRobertaForMultipleChoice",anchor:"transformers.TFRobertaForMultipleChoice",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.TFRobertaForMultipleChoice.config",description:`<strong>config</strong> (<a href="/docs/transformers/main/en/model_doc/roberta#transformers.RobertaConfig">RobertaConfig</a>) &#x2014; Model configuration class with all the parameters of the
model. Initializing with a config file does not load the weights associated with the model, only the
...
`}}),Ks=new fe({props:{$$slots:{default:[jz]},$$scope:{ctx:R}}}),Js=new ae({props:{anchor:"transformers.TFRobertaForQuestionAnswering.call.example",$$slots:{default:[Cz]},$$scope:{ctx:R}}}),Vs=new ae({props:{anchor:"transformers.TFRobertaForQuestionAnswering.call.example-2",$$slots:{default:[Pz]},$$scope:{ctx:R}}}),Ci=new De({}),Pi=new O({props:{name:"class transformers.FlaxRobertaModel",anchor:"transformers.FlaxRobertaModel",parameters:[{name:"config",val:": RobertaConfig"},{name:"input_shape",val:": typing.Tuple = (1, 1)"},{name:"seed",val:": int = 0"},{name:"dtype",val:": dtype = <class 'jax.numpy.float32'>"},{name:"_do_init",val:": bool = True"},{name:"gradient_checkpointing",val:": bool = False"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.FlaxRobertaModel.config",description:`<strong>config</strong> (<a href="/docs/transformers/main/en/model_doc/roberta#transformers.RobertaConfig">RobertaConfig</a>) &#x2014; Model configuration class with all the parameters of the
model. Initializing with a config file does not load the weights associated with the model, only the
...
reported improvements. We release our models and code.`),ye=h(),Q=a("p"),Ee=n("Tips:"),ve=h(),I=a("ul"),he=a("li"),Me=n("This implementation is the same as "),C=a("a"),ze=n("BertModel"),V=n(` with a tiny embeddings tweak as well as a setup
for Roberta pretrained models.`),qe=h(),me=a("li"),G=n(`RoBERTa has the same architecture as BERT, but uses a byte-level BPE as a tokenizer (same as GPT-2) and uses a
different pretraining scheme.`),je=h(),ne=a("li"),D=n("RoBERTa doesn\u2019t have "),ue=a("code"),X=n("token_type_ids"),Ce=n(`, you don\u2019t need to indicate which token belongs to which segment. Just
separate your segments with the separation token `),se=a("code"),A=n("tokenizer.sep_token"),Pe=n(" (or "),L=a("code"),Ae=n("</s>"),Le=n(")"),y=h(),z=a("li"),He=a("a"),de=n("CamemBERT"),Xe=n(" is a wrapper around RoBERTa. Refer to this page for usage examples."),Je=h(),q=a("p"),Ye=n("This model was contributed by "),Se=a("a"),Ze=n("julien-c"),et=n(". The original code can be found "),Be=a("a"),S=n("here"),Y=n("."),Ve=h(),Oe=a("h2"),W=a("a"),Qe=a("span"),v(We.$$.fragment),Ne=h(),Ke=a("span"),ce=n("RobertaConfig"),Ge=h(),yt=a("div"),v(Oa.$$.fragment),ug=h(),co=a("p"),fg=n("This is the configuration class to store the configuration of a "),id=a("a"),gg=n("RobertaModel"),_g=n(" or a "),ld=a("a"),bg=n("TFRobertaModel"),kg=n(`. It is
used to instantiate a RoBERTa model according to the specified arguments, defining the model architecture.
Instantiating a configuration with the defaults will yield a similar configuration to that of the RoBERTa
`),Na=a("a"),yg=n("roberta-base"),vg=n(" architecture."),wg=h(),Ao=a("p"),Tg=n("Configuration objects inherit from "),dd=a("a"),$g=n("PretrainedConfig"),Fg=n(` and can be used to control the model outputs. Read the
documentation from `),cd=a("a"),xg=n("PretrainedConfig"),Rg=n(" for more information."),Eg=h(),Lo=a("p"),Mg=n("The "),pd=a("a"),zg=n("RobertaConfig"),qg=n(" class directly inherits "),hd=a("a"),jg=n("BertConfig"),Cg=n(`. It reuses the same defaults. Please check the parent
class for more information.`),Pg=h(),v(Ln.$$.fragment),ou=h(),Oo=a("h2"),On=a("a"),xc=a("span"),v(Ia.$$.fragment),Ag=h(),Rc=a("span"),Lg=n("RobertaTokenizer"),nu=h(),Ie=a("div"),v(Da.$$.fragment),Og=h(),Ec=a("p"),Ng=n("Constructs a RoBERTa tokenizer, derived from the GPT-2 tokenizer, using byte-level Byte-Pair-Encoding."),Ig=h(),Mc=a("p"),Dg=n("This tokenizer has been trained to treat spaces like parts of the tokens (a bit like sentencepiece) so a word will"),Sg=h(),v(Nn.$$.fragment),Bg=h(),Sa=a("p"),Wg=n("You can get around that behavior by passing "),zc=a("code"),Ug=n("add_prefix_space=True"),Hg=n(` when instantiating this tokenizer or when you
...
this superclass for more information regarding those methods.`),Xg=h(),vo=a("div"),v(Wa.$$.fragment),Yg=h(),qc=a("p"),Zg=n(`Build model inputs from a sequence or a pair of sequence for sequence classification tasks by concatenating and
adding special tokens. A RoBERTa sequence has the following format:`),e_=h(),Ua=a("ul"),ud=a("li"),t_=n("single sequence: "),jc=a("code"),o_=n("<s> X </s>"),n_=h(),fd=a("li"),s_=n("pair of sequences: "),Cc=a("code"),a_=n("<s> A </s></s> B </s>"),r_=h(),Dn=a("div"),v(Ha.$$.fragment),i_=h(),Qa=a("p"),l_=n(`Retrieve sequence ids from a token list that has no special tokens added. This method is called when adding
special tokens using the tokenizer `),Pc=a("code"),d_=n("prepare_for_model"),c_=n(" method."),p_=h(),Sn=a("div"),v(Ka.$$.fragment),h_=h(),Ac=a("p"),m_=n(`Create a mask from the two sequences passed to be used in a sequence-pair classification task. RoBERTa does not
make use of token type ids, therefore a list of zeros is returned.`),u_=h(),gd=a("div"),v(Ja.$$.fragment),su=h(),No=a("h2"),Bn=a("a"),Lc=a("span"),v(Va.$$.fragment),f_=h(),Oc=a("span"),g_=n("RobertaTokenizerFast"),au=h(),tt=a("div"),v(Ga.$$.fragment),__=h(),Xa=a("p"),b_=n("Construct a \u201Cfast\u201D RoBERTa tokenizer (backed by HuggingFace\u2019s "),Nc=a("em"),k_=n("tokenizers"),y_=n(` library), derived from the GPT-2
...
call it on some text, but since the model was not pretrained this way, it might yield a decrease in performance.`),E_=h(),v(Un.$$.fragment),M_=h(),Za=a("p"),z_=n("This tokenizer inherits from "),_d=a("a"),q_=n("PreTrainedTokenizerFast"),j_=n(` which contains most of the main methods. Users should
refer to this superclass for more information regarding those methods.`),C_=h(),bd=a("div"),v(er.$$.fragment),ru=h(),Io=a("h2"),Hn=a("a"),Sc=a("span"),v(tr.$$.fragment),P_=h(),Bc=a("span"),A_=n("RobertaModel"),iu=h(),ot=a("div"),v(or.$$.fragment),L_=h(),Wc=a("p"),O_=n("The bare RoBERTa Model transformer outputting raw hidden-states without any specific head on top."),N_=h(),nr=a("p"),I_=n("This model inherits from "),kd=a("a"),D_=n("PreTrainedModel"),S_=n(`. Check the superclass documentation for the generic methods the
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Mk=h(),ct=a("div"),v(Er.$$.fragment),zk=h(),Qo=a("p"),qk=n("The "),xd=a("a"),jk=n("RobertaForSequenceClassification"),Ck=n(" forward method, overrides the "),cp=a("code"),Pk=n("__call__"),Ak=n(" special method."),Lk=h(),v(ns.$$.fragment),Ok=h(),v(ss.$$.fragment),Nk=h(),v(as.$$.fragment),Ik=h(),v(rs.$$.fragment),Dk=h(),v(is.$$.fragment),uu=h(),Ko=a("h2"),ls=a("a"),pp=a("span"),v(Mr.$$.fragment),Sk=h(),hp=a("span"),Bk=n("RobertaForMultipleChoice"),fu=h(),$t=a("div"),v(zr.$$.fragment),Wk=h(),mp=a("p"),Uk=n(`Roberta Model with a multiple choice classification head on top (a linear layer on top of the pooled output and a
softmax) e.g. for RocStories/SWAG tasks.`),Hk=h(),qr=a("p"),Qk=n("This model inherits from "),Rd=a("a"),Kk=n("PreTrainedModel"),Jk=n(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Vk=h(),jr=a("p"),Gk=n("This model is also a PyTorch "),Cr=a("a"),Xk=n("torch.nn.Module"),Yk=n(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Zk=h(),Qt=a("div"),v(Pr.$$.fragment),ey=h(),Jo=a("p"),ty=n("The "),Ed=a("a"),oy=n("RobertaForMultipleChoice"),ny=n(" forward method, overrides the "),up=a("code"),sy=n("__call__"),ay=n(" special method."),ry=h(),v(ds.$$.fragment),iy=h(),v(cs.$$.fragment),gu=h(),Vo=a("h2"),ps=a("a"),fp=a("span"),v(Ar.$$.fragment),ly=h(),gp=a("span"),dy=n("RobertaForTokenClassification"),_u=h(),Ft=a("div"),v(Lr.$$.fragment),cy=h(),_p=a("p"),py=n(`Roberta Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g. for
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),yy=h(),Et=a("div"),v(Dr.$$.fragment),vy=h(),Go=a("p"),wy=n("The "),zd=a("a"),Ty=n("RobertaForTokenClassification"),$y=n(" forward method, overrides the "),bp=a("code"),Fy=n("__call__"),xy=n(" special method."),Ry=h(),v(hs.$$.fragment),Ey=h(),v(ms.$$.fragment),My=h(),v(us.$$.fragment),bu=h(),Xo=a("h2"),fs=a("a"),kp=a("span"),v(Sr.$$.fragment),zy=h(),yp=a("span"),qy=n("RobertaForQuestionAnswering"),ku=h(),xt=a("div"),v(Br.$$.fragment),jy=h(),Yo=a("p"),Cy=n(`Roberta Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
layers on top of the hidden-states output to compute `),vp=a("code"),Py=n("span start logits"),Ay=n(" and "),wp=a("code"),Ly=n("span end logits"),Oy=n(")."),Ny=h(),Wr=a("p"),Iy=n("This model inherits from "),qd=a("a"),Dy=n("PreTrainedModel"),Sy=n(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),By=h(),Ur=a("p"),Wy=n("This model is also a PyTorch "),Hr=a("a"),Uy=n("torch.nn.Module"),Hy=n(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Qy=h(),Mt=a("div"),v(Qr.$$.fragment),Ky=h(),Zo=a("p"),Jy=n("The "),jd=a("a"),Vy=n("RobertaForQuestionAnswering"),Gy=n(" forward method, overrides the "),Tp=a("code"),Xy=n("__call__"),Yy=n(" special method."),Zy=h(),v(gs.$$.fragment),ev=h(),v(_s.$$.fragment),tv=h(),v(bs.$$.fragment),yu=h(),en=a("h2"),ks=a("a"),$p=a("span"),v(Kr.$$.fragment),ov=h(),Fp=a("span"),nv=n("TFRobertaModel"),vu=h(),ht=a("div"),v(Jr.$$.fragment),sv=h(),xp=a("p"),av=n("The bare RoBERTa Model transformer outputting raw hidden-states without any specific head on top."),rv=h(),Vr=a("p"),iv=n("This model inherits from "),Cd=a("a"),lv=n("TFPreTrainedModel"),dv=n(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),cv=h(),Gr=a("p"),pv=n("This model is also a "),Xr=a("a"),hv=n("tf.keras.Model"),mv=n(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),uv=h(),v(ys.$$.fragment),fv=h(),Kt=a("div"),v(Yr.$$.fragment),gv=h(),tn=a("p"),_v=n("The "),Pd=a("a"),bv=n("TFRobertaModel"),kv=n(" forward method, overrides the "),Rp=a("code"),yv=n("__call__"),vv=n(" special method."),wv=h(),v(vs.$$.fragment),Tv=h(),v(ws.$$.fragment),wu=h(),on=a("h2"),Ts=a("a"),Ep=a("span"),v(Zr.$$.fragment),$v=h(),Mp=a("span"),Fv=n("TFRobertaForCausalLM"),Tu=h(),nn=a("div"),v(ei.$$.fragment),xv=h(),Jt=a("div"),v(ti.$$.fragment),Rv=h(),sn=a("p"),Ev=n("The "),Ad=a("a"),Mv=n("TFRobertaForCausalLM"),zv=n(" forward method, overrides the "),zp=a("code"),qv=n("__call__"),jv=n(" special method."),Cv=h(),v($s.$$.fragment),Pv=h(),v(Fs.$$.fragment),$u=h(),an=a("h2"),xs=a("a"),qp=a("span"),v(oi.$$.fragment),Av=h(),jp=a("span"),Lv=n("TFRobertaForMaskedLM"),Fu=h(),mt=a("div"),v(ni.$$.fragment),Ov=h(),si=a("p"),Nv=n("RoBERTa Model with a "),Cp=a("code"),Iv=n("language modeling"),Dv=n(" head on top."),Sv=h(),ai=a("p"),Bv=n("This model inherits from "),Ld=a("a"),Wv=n("TFPreTrainedModel"),Uv=n(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Hv=h(),ri=a("p"),Qv=n("This model is also a "),ii=a("a"),Kv=n("tf.keras.Model"),Jv=n(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Vv=h(),v(Rs.$$.fragment),Gv=h(),zt=a("div"),v(li.$$.fragment),Xv=h(),rn=a("p"),Yv=n("The "),Od=a("a"),Zv=n("TFRobertaForMaskedLM"),ew=n(" forward method, overrides the "),Pp=a("code"),tw=n("__call__"),ow=n(" special method."),nw=h(),v(Es.$$.fragment),sw=h(),v(Ms.$$.fragment),aw=h(),v(zs.$$.fragment),xu=h(),ln=a("h2"),qs=a("a"),Ap=a("span"),v(di.$$.fragment),rw=h(),Lp=a("span"),iw=n("TFRobertaForSequenceClassification"),Ru=h(),ut=a("div"),v(ci.$$.fragment),lw=h(),Op=a("p"),dw=n(`RoBERTa Model transformer with a sequence classification/regression head on top (a linear layer on top of the
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),bw=h(),v(js.$$.fragment),kw=h(),qt=a("div"),v(ui.$$.fragment),yw=h(),dn=a("p"),vw=n("The "),Id=a("a"),ww=n("TFRobertaForSequenceClassification"),Tw=n(" forward method, overrides the "),Np=a("code"),$w=n("__call__"),Fw=n(" special method."),xw=h(),v(Cs.$$.fragment),Rw=h(),v(Ps.$$.fragment),Ew=h(),v(As.$$.fragment),Eu=h(),cn=a("h2"),Ls=a("a"),Ip=a("span"),v(fi.$$.fragment),Mw=h(),Dp=a("span"),zw=n("TFRobertaForMultipleChoice"),Mu=h(),ft=a("div"),v(gi.$$.fragment),qw=h(),Sp=a("p"),jw=n(`Roberta Model with a multiple choice classification head on top (a linear layer on top of the pooled output and a
softmax) e.g. for RocStories/SWAG tasks.`),Cw=h(),_i=a("p"),Pw=n("This model inherits from "),Dd=a("a"),Aw=n("TFPreTrainedModel"),Lw=n(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Ow=h(),bi=a("p"),Nw=n("This model is also a "),ki=a("a"),Iw=n("tf.keras.Model"),Dw=n(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Sw=h(),v(Os.$$.fragment),Bw=h(),Vt=a("div"),v(yi.$$.fragment),Ww=h(),pn=a("p"),Uw=n("The "),Sd=a("a"),Hw=n("TFRobertaForMultipleChoice"),Qw=n(" forward method, overrides the "),Bp=a("code"),Kw=n("__call__"),Jw=n(" special method."),Vw=h(),v(Ns.$$.fragment),Gw=h(),v(Is.$$.fragment),zu=h(),hn=a("h2"),Ds=a("a"),Wp=a("span"),v(vi.$$.fragment),Xw=h(),Up=a("span"),Yw=n("TFRobertaForTokenClassification"),qu=h(),gt=a("div"),v(wi.$$.fragment),Zw=h(),Hp=a("p"),eT=n(`RoBERTa Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g. for
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),dT=h(),v(Ss.$$.fragment),cT=h(),jt=a("div"),v(xi.$$.fragment),pT=h(),mn=a("p"),hT=n("The "),Wd=a("a"),mT=n("TFRobertaForTokenClassification"),uT=n(" forward method, overrides the "),Qp=a("code"),fT=n("__call__"),gT=n(" special method."),_T=h(),v(Bs.$$.fragment),bT=h(),v(Ws.$$.fragment),kT=h(),v(Us.$$.fragment),ju=h(),un=a("h2"),Hs=a("a"),Kp=a("span"),v(Ri.$$.fragment),yT=h(),Jp=a("span"),vT=n("TFRobertaForQuestionAnswering"),Cu=h(),_t=a("div"),v(Ei.$$.fragment),wT=h(),fn=a("p"),TT=n(`RoBERTa Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
layers on top of the hidden-states output to compute `),Vp=a("code"),$T=n("span start logits"),FT=n(" and "),Gp=a("code"),xT=n("span end logits"),RT=n(")."),ET=h(),Mi=a("p"),MT=n("This model inherits from "),Ud=a("a"),zT=n("TFPreTrainedModel"),qT=n(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),jT=h(),zi=a("p"),CT=n("This model is also a "),qi=a("a"),PT=n("tf.keras.Model"),AT=n(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),LT=h(),v(Qs.$$.fragment),OT=h(),Ct=a("div"),v(ji.$$.fragment),NT=h(),gn=a("p"),IT=n("The "),Hd=a("a"),DT=n("TFRobertaForQuestionAnswering"),ST=n(" forward method, overrides the "),Xp=a("code"),BT=n("__call__"),WT=n(" special method."),UT=h(),v(Ks.$$.fragment),HT=h(),v(Js.$$.fragment),QT=h(),v(Vs.$$.fragment),Pu=h(),_n=a("h2"),Gs=a("a"),Yp=a("span"),v(Ci.$$.fragment),KT=h(),Zp=a("span"),JT=n("FlaxRobertaModel"),Au=h(),nt=a("div"),v(Pi.$$.fragment),VT=h(),eh=a("p"),GT=n("The bare RoBERTa Model transformer outputting raw hidden-states without any specific head on top."),XT=h(),Ai=a("p"),YT=n("This model inherits from "),Qd=a("a"),ZT=n("FlaxPreTrainedModel"),e$=n(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),t$=h(),Li=a("p"),o$=n("This model is also a Flax Linen "),Oi=a("a"),n$=n("flax.linen.Module"),s$=n(`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),a$=h(),th=a("p"),r$=n("Finally, this model supports inherent JAX features such as:"),i$=h(),po=a("ul"),oh=a("li"),Ni=a("a"),l$=n("Just-In-Time (JIT) compilation"),d$=h(),nh=a("li"),Ii=a("a"),c$=n("Automatic Differentiation"),p$=h(),sh=a("li"),Di=a("a"),h$=n("Vectorization"),m$=h(),ah=a("li"),Si=a("a"),u$=n("Parallelization"),f$=h(),Gt=a("div"),v(Bi.$$.fragment),g$=h(),bn=a("p"),_$=n("The "),rh=a("code"),b$=n("FlaxRobertaPreTrainedModel"),k$=n(" forward method, overrides the "),ih=a("code"),y$=n("__call__"),v$=n(" special method."),w$=h(),v(Xs.$$.fragment),T$=h(),v(Ys.$$.fragment),Lu=h(),kn=a("h2"),Zs=a("a"),lh=a("span"),v(Wi.$$.fragment),$$=h(),dh=a("span"),F$=n("FlaxRobertaForCausalLM"),Ou=h(),st=a("div"),v(Ui.$$.fragment),x$=h(),ch=a("p"),R$=n(`Roberta Model with a language modeling head on top (a linear layer on top of the hidden-states output) e.g for
autoregressive tasks.`),E$=h(),Hi=a("p"),M$=n("This model inherits from "),Kd=a("a"),z$=n("FlaxPreTrainedModel"),q$=n(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),j$=h(),Qi=a("p"),C$=n("This model is also a Flax Linen "),Ki=a("a"),P$=n("flax.linen.Module"),A$=n(`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),L$=h(),ph=a("p"),O$=n("Finally, this model supports inherent JAX features such as:"),N$=h(),ho=a("ul"),hh=a("li"),Ji=a("a"),I$=n("Just-In-Time (JIT) compilation"),D$=h(),mh=a("li"),Vi=a("a"),S$=n("Automatic Differentiation"),B$=h(),uh=a("li"),Gi=a("a"),W$=n("Vectorization"),U$=h(),fh=a("li"),Xi=a("a"),H$=n("Parallelization"),Q$=h(),Xt=a("div"),v(Yi.$$.fragment),K$=h(),yn=a("p"),J$=n("The "),gh=a("code"),V$=n("FlaxRobertaPreTrainedModel"),G$=n(" forward method, overrides the "),_h=a("code"),X$=n("__call__"),Y$=n(" special method."),Z$=h(),v(ea.$$.fragment),e1=h(),v(ta.$$.fragment),Nu=h(),vn=a("h2"),oa=a("a"),bh=a("span"),v(Zi.$$.fragment),t1=h(),kh=a("span"),o1=n("FlaxRobertaForMaskedLM"),Iu=h(),at=a("div"),v(el.$$.fragment),n1=h(),tl=a("p"),s1=n("RoBERTa Model with a "),yh=a("code"),a1=n("language modeling"),r1=n(" head on top."),i1=h(),ol=a("p"),l1=n("This model inherits from "),Jd=a("a"),d1=n("FlaxPreTrainedModel"),c1=n(`. Check the superclass documentation for the generic methods the
...
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),f1=h(),vh=a("p"),g1=n("Finally, this model supports inherent JAX features such as:"),_1=h(),mo=a("ul"),wh=a("li"),al=a("a"),b1=n("Just-In-Time (JIT) compilation"),k1=h(),Th=a("li"),rl=a("a"),y1=n("Automatic Differentiation"),v1=h(),$h=a("li"),il=a("a"),w1=n("Vectorization"),T1=h(),Fh=a("li"),ll=a("a"),$1=n("Parallelization"),F1=h(),Yt=a("div"),v(dl.$$.fragment),x1=h(),wn=a("p"),R1=n("The "),xh=a("code"),E1=n("FlaxRobertaPreTrainedModel"),M1=n(" forward method, overrides the "),Rh=a("code"),z1=n("__call__"),q1=n(" special method."),j1=h(),v(na.$$.fragment),C1=h(),v(sa.$$.fragment),Du=h(),Tn=a("h2"),aa=a("a"),Eh=a("span"),v(cl.$$.fragment),P1=h(),Mh=a("span"),A1=n("FlaxRobertaForSequenceClassification"),Su=h(),rt=a("div"),v(pl.$$.fragment),L1=h(),zh=a("p"),O1=n(`Roberta Model transformer with a sequence classification/regression head on top (a linear layer on top of the
...
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),Q1=h(),qh=a("p"),K1=n("Finally, this model supports inherent JAX features such as:"),J1=h(),uo=a("ul"),jh=a("li"),fl=a("a"),V1=n("Just-In-Time (JIT) compilation"),G1=h(),Ch=a("li"),gl=a("a"),X1=n("Automatic Differentiation"),Y1=h(),Ph=a("li"),_l=a("a"),Z1=n("Vectorization"),e2=h(),Ah=a("li"),bl=a("a"),t2=n("Parallelization"),o2=h(),Zt=a("div"),v(kl.$$.fragment),n2=h(),$n=a("p"),s2=n("The "),Lh=a("code"),a2=n("FlaxRobertaPreTrainedModel"),r2=n(" forward method, overrides the "),Oh=a("code"),i2=n("__call__"),l2=n(" special method."),d2=h(),v(ra.$$.fragment),c2=h(),v(ia.$$.fragment),Bu=h(),Fn=a("h2"),la=a("a"),Nh=a("span"),v(yl.$$.fragment),p2=h(),Ih=a("span"),h2=n("FlaxRobertaForMultipleChoice"),Wu=h(),it=a("div"),v(vl.$$.fragment),m2=h(),Dh=a("p"),u2=n(`Roberta Model with a multiple choice classification head on top (a linear layer on top of the pooled output and a
...
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),T2=h(),Sh=a("p"),$2=n("Finally, this model supports inherent JAX features such as:"),F2=h(),fo=a("ul"),Bh=a("li"),Fl=a("a"),x2=n("Just-In-Time (JIT) compilation"),R2=h(),Wh=a("li"),xl=a("a"),E2=n("Automatic Differentiation"),M2=h(),Uh=a("li"),Rl=a("a"),z2=n("Vectorization"),q2=h(),Hh=a("li"),El=a("a"),j2=n("Parallelization"),C2=h(),eo=a("div"),v(Ml.$$.fragment),P2=h(),xn=a("p"),A2=n("The "),Qh=a("code"),L2=n("FlaxRobertaPreTrainedModel"),O2=n(" forward method, overrides the "),Kh=a("code"),N2=n("__call__"),I2=n(" special method."),D2=h(),v(da.$$.fragment),S2=h(),v(ca.$$.fragment),Uu=h(),Rn=a("h2"),pa=a("a"),Jh=a("span"),v(zl.$$.fragment),B2=h(),Vh=a("span"),W2=n("FlaxRobertaForTokenClassification"),Hu=h(),lt=a("div"),v(ql.$$.fragment),U2=h(),Gh=a("p"),H2=n(`Roberta Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g. for
Named-Entity-Recognition (NER) tasks.`),Q2=h(),jl=a("p"),K2=n("This model inherits from "),Xd=a("a"),J2=n("FlaxPreTrainedModel"),V2=n(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),G2=h(),Cl=a("p"),X2=n("This model is also a Flax Linen "),Pl=a("a"),Y2=n("flax.linen.Module"),Z2=n(`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),eF=h(),Xh=a("p"),tF=n("Finally, this model supports inherent JAX features such as:"),oF=h(),go=a("ul"),Yh=a("li"),Al=a("a"),nF=n("Just-In-Time (JIT) compilation"),sF=h(),Zh=a("li"),Ll=a("a"),aF=n("Automatic Differentiation"),rF=h(),em=a("li"),Ol=a("a"),iF=n("Vectorization"),lF=h(),tm=a("li"),Nl=a("a"),dF=n("Parallelization"),cF=h(),to=a("div"),v(Il.$$.fragment),pF=h(),En=a("p"),hF=n("The "),om=a("code"),mF=n("FlaxRobertaPreTrainedModel"),uF=n(" forward method, overrides the "),nm=a("code"),fF=n("__call__"),gF=n(" special method."),_F=h(),v(ha.$$.fragment),bF=h(),v(ma.$$.fragment),Qu=h(),Mn=a("h2"),ua=a("a"),sm=a("span"),v(Dl.$$.fragment),kF=h(),am=a("span"),yF=n("FlaxRobertaForQuestionAnswering"),Ku=h(),dt=a("div"),v(Sl.$$.fragment),vF=h(),zn=a("p"),wF=n(`Roberta Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
...
model published after it. Our best model achieves state-of-the-art results on GLUE, RACE and SQuAD. These results
highlight the importance of previously overlooked design choices, and raise questions about the source of recently
reported improvements. We release our models and code.`),Fm.forEach(t),$m.forEach(t),ye=m(o),Q=r(o,"P",{});var xm=i(Q);Ee=s(xm,"Tips:"),xm.forEach(t),ve=m(o),I=r(o,"UL",{});var bo=i(I);he=r(bo,"LI",{});var Zl=i(he);Me=s(Zl,"This implementation is the same as "),C=r(Zl,"A",{href:!0});var Rm=i(C);ze=s(Rm,"BertModel"),Rm.forEach(t),V=s(Zl,` with a tiny embeddings tweak as well as a setup
for Roberta pretrained models.`),Zl.forEach(t),qe=m(bo),me=r(bo,"LI",{});var Em=i(me);G=s(Em,`RoBERTa has the same architecture as BERT, but uses a byte-level BPE as a tokenizer (same as GPT-2) and uses a
different pretraining scheme.`),Em.forEach(t),je=m(bo),ne=r(bo,"LI",{});var ko=i(ne);D=s(ko,"RoBERTa doesn\u2019t have "),ue=r(ko,"CODE",{});var Mm=i(ue);X=s(Mm,"token_type_ids"),Mm.forEach(t),Ce=s(ko,`, you don\u2019t need to indicate which token belongs to which segment. Just
separate your segments with the separation token `),se=r(ko,"CODE",{});var zm=i(se);A=s(zm,"tokenizer.sep_token"),zm.forEach(t),Pe=s(ko," (or "),L=r(ko,"CODE",{});var qm=i(L);Ae=s(qm,"</s>"),qm.forEach(t),Le=s(ko,")"),ko.forEach(t),y=m(bo),z=r(bo,"LI",{});var Zd=i(z);He=r(Zd,"A",{href:!0});var jm=i(He);de=s(jm,"CamemBERT"),jm.forEach(t),Xe=s(Zd," is a wrapper around RoBERTa. Refer to this page for usage examples."),Zd.forEach(t),bo.forEach(t),Je=m(o),q=r(o,"P",{});var jn=i(q);Ye=s(jn,"This model was contributed by "),Se=r(jn,"A",{href:!0,rel:!0});var Cm=i(Se);Ze=s(Cm,"julien-c"),Cm.forEach(t),et=s(jn,". The original code can be found "),Be=r(jn,"A",{href:!0,rel:!0});var Pm=i(Be);S=s(Pm,"here"),Pm.forEach(t),Y=s(jn,"."),jn.forEach(t),Ve=m(o),Oe=r(o,"H2",{class:!0});var ed=i(Oe);W=r(ed,"A",{id:!0,class:!0,href:!0});var Am=i(W);Qe=r(Am,"SPAN",{});var Lm=i(Qe);w(We.$$.fragment,Lm),Lm.forEach(t),Am.forEach(t),Ne=m(ed),Ke=r(ed,"SPAN",{});var Om=i(Ke);ce=s(Om,"RobertaConfig"),Om.forEach(t),ed.forEach(t),Ge=m(o),yt=r(o,"DIV",{class:!0});var Wt=i(yt);w(Oa.$$.fragment,Wt),ug=m(Wt),co=r(Wt,"P",{});var yo=i(co);fg=s(yo,"This is the configuration class to store the configuration of a "),id=r(yo,"A",{href:!0});var Nm=i(id);gg=s(Nm,"RobertaModel"),Nm.forEach(t),_g=s(yo," or a "),ld=r(yo,"A",{href:!0});var Im=i(ld);bg=s(Im,"TFRobertaModel"),Im.forEach(t),kg=s(yo,`. It is
used to instantiate a RoBERTa model according to the specified arguments, defining the model architecture.
Instantiating a configuration with the defaults will yield a similar configuration to that of the RoBERTa
`),Na=r(yo,"A",{href:!0,rel:!0});var Dm=i(Na);yg=s(Dm,"roberta-base"),Dm.forEach(t),vg=s(yo," architecture."),yo.forEach(t),wg=m(Wt),Ao=r(Wt,"P",{});var Cn=i(Ao);Tg=s(Cn,"Configuration objects inherit from "),dd=r(Cn,"A",{href:!0});var Sm=i(dd);$g=s(Sm,"PretrainedConfig"),Sm.forEach(t),Fg=s(Cn,` and can be used to control the model outputs. Read the
documentation from `),cd=r(Cn,"A",{href:!0});var Bm=i(cd);xg=s(Bm,"PretrainedConfig"),Bm.forEach(t),Rg=s(Cn," for more information."),Cn.forEach(t),Eg=m(Wt),Lo=r(Wt,"P",{});var Pn=i(Lo);Mg=s(Pn,"The "),pd=r(Pn,"A",{href:!0});var Wm=i(pd);zg=s(Wm,"RobertaConfig"),Wm.forEach(t),qg=s(Pn," class directly inherits "),hd=r(Pn,"A",{href:!0});var Um=i(hd);jg=s(Um,"BertConfig"),Um.forEach(t),Cg=s(Pn,`. It reuses the same defaults. Please check the parent
class for more information.`),Pn.forEach(t),Pg=m(Wt),w(Ln.$$.fragment,Wt),Wt.forEach(t),ou=m(o),Oo=r(o,"H2",{class:!0});var td=i(Oo);On=r(td,"A",{id:!0,class:!0,href:!0});var Hm=i(On);xc=r(Hm,"SPAN",{});var Qm=i(xc);w(Ia.$$.fragment,Qm),Qm.forEach(t),Hm.forEach(t),Ag=m(td),Rc=r(td,"SPAN",{});var Km=i(Rc);Lg=s(Km,"RobertaTokenizer"),Km.forEach(t),td.forEach(t),nu=m(o),Ie=r(o,"DIV",{class:!0});var Ue=i(Ie);w(Da.$$.fragment,Ue),Og=m(Ue),Ec=r(Ue,"P",{});var Jm=i(Ec);Ng=s(Jm,"Constructs a RoBERTa tokenizer, derived from the GPT-2 tokenizer, using byte-level Byte-Pair-Encoding."),Jm.forEach(t),Ig=m(Ue),Mc=r(Ue,"P",{});var Vm=i(Mc);Dg=s(Vm,"This tokenizer has been trained to treat spaces like parts of the tokens (a bit like sentencepiece) so a word will"),Vm.forEach(t),Sg=m(Ue),w(Nn.$$.fragment,Ue),Bg=m(Ue),Sa=r(Ue,"P",{});var od=i(Sa);Wg=s(od,"You can get around that behavior by passing "),zc=r(od,"CODE",{});var Gm=i(zc);Ug=s(Gm,"add_prefix_space=True"),Gm.forEach(t),Hg=s(od,` when instantiating this tokenizer or when you
...
this superclass for more information regarding those methods.`),nd.forEach(t),Xg=m(Ue),vo=r(Ue,"DIV",{class:!0});var An=i(vo);w(Wa.$$.fragment,An),Yg=m(An),qc=r(An,"P",{});var Ym=i(qc);Zg=s(Ym,`Build model inputs from a sequence or a pair of sequence for sequence classification tasks by concatenating and
adding special tokens. A RoBERTa sequence has the following format:`),Ym.forEach(t),e_=m(An),Ua=r(An,"UL",{});var sd=i(Ua);ud=r(sd,"LI",{});var ec=i(ud);t_=s(ec,"single sequence: "),jc=r(ec,"CODE",{});var Zm=i(jc);o_=s(Zm,"<s> X </s>"),Zm.forEach(t),ec.forEach(t),n_=m(sd),fd=r(sd,"LI",{});var tc=i(fd);s_=s(tc,"pair of sequences: "),Cc=r(tc,"CODE",{});var eu=i(Cc);a_=s(eu,"<s> A </s></s> B </s>"),eu.forEach(t),tc.forEach(t),sd.forEach(t),An.forEach(t),r_=m(Ue),Dn=r(Ue,"DIV",{class:!0});var ad=i(Dn);w(Ha.$$.fragment,ad),i_=m(ad),Qa=r(ad,"P",{});var rd=i(Qa);l_=s(rd,`Retrieve sequence ids from a token list that has no special tokens added. This method is called when adding
special tokens using the tokenizer `),Pc=r(rd,"CODE",{});var e0=i(Pc);d_=s(e0,"prepare_for_model"),e0.forEach(t),c_=s(rd," method."),rd.forEach(t),ad.forEach(t),p_=m(Ue),Sn=r(Ue,"DIV",{class:!0});var Vu=i(Sn);w(Ka.$$.fragment,Vu),h_=m(Vu),Ac=r(Vu,"P",{});var t0=i(Ac);m_=s(t0,`Create a mask from the two sequences passed to be used in a sequence-pair classification task. RoBERTa does not
make use of token type ids, therefore a list of zeros is returned.`),t0.forEach(t),Vu.forEach(t),u_=m(Ue),gd=r(Ue,"DIV",{class:!0});var o0=i(gd);w(Ja.$$.fragment,o0),o0.forEach(t),Ue.forEach(t),su=m(o),No=r(o,"H2",{class:!0});var Gu=i(No);Bn=r(Gu,"A",{id:!0,class:!0,href:!0});var n0=i(Bn);Lc=r(n0,"SPAN",{});var s0=i(Lc);w(Va.$$.fragment,s0),s0.forEach(t),n0.forEach(t),f_=m(Gu),Oc=r(Gu,"SPAN",{});var a0=i(Oc);g_=s(a0,"RobertaTokenizerFast"),a0.forEach(t),Gu.forEach(t),au=m(o),tt=r(o,"DIV",{class:!0});var bt=i(tt);w(Ga.$$.fragment,bt),__=m(bt),Xa=r(bt,"P",{});var Xu=i(Xa);b_=s(Xu,"Construct a \u201Cfast\u201D RoBERTa tokenizer (backed by HuggingFace\u2019s "),Nc=r(Xu,"EM",{});var r0=i(Nc);k_=s(r0,"tokenizers"),r0.forEach(t),y_=s(Xu,` library), derived from the GPT-2
...
call it on some text, but since the model was not pretrained this way, it might yield a decrease in performance.`),Yu.forEach(t),E_=m(bt),w(Un.$$.fragment,bt),M_=m(bt),Za=r(bt,"P",{});var Zu=i(Za);z_=s(Zu,"This tokenizer inherits from "),_d=r(Zu,"A",{href:!0});var d0=i(_d);q_=s(d0,"PreTrainedTokenizerFast"),d0.forEach(t),j_=s(Zu,` which contains most of the main methods. Users should
refer to this superclass for more information regarding those methods.`),Zu.forEach(t),C_=m(bt),bd=r(bt,"DIV",{class:!0});var c0=i(bd);w(er.$$.fragment,c0),c0.forEach(t),bt.forEach(t),ru=m(o),Io=r(o,"H2",{class:!0});var ef=i(Io);Hn=r(ef,"A",{id:!0,class:!0,href:!0});var p0=i(Hn);Sc=r(p0,"SPAN",{});var h0=i(Sc);w(tr.$$.fragment,h0),h0.forEach(t),p0.forEach(t),P_=m(ef),Bc=r(ef,"SPAN",{});var m0=i(Bc);A_=s(m0,"RobertaModel"),m0.forEach(t),ef.forEach(t),iu=m(o),ot=r(o,"DIV",{class:!0});var kt=i(ot);w(or.$$.fragment,kt),L_=m(kt),Wc=r(kt,"P",{});var u0=i(Wc);O_=s(u0,"The bare RoBERTa Model transformer outputting raw hidden-states without any specific head on top."),u0.forEach(t),N_=m(kt),nr=r(kt,"P",{});var tf=i(nr);I_=s(tf,"This model inherits from "),kd=r(tf,"A",{href:!0});var f0=i(kd);D_=s(f0,"PreTrainedModel"),f0.forEach(t),S_=s(tf,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),ff.forEach(t),Mk=m(Fo),ct=r(Fo,"DIV",{class:!0});var At=i(ct);w(Er.$$.fragment,At),zk=m(At),Qo=r(At,"P",{});var ac=i(Qo);qk=s(ac,"The "),xd=r(ac,"A",{href:!0});var G0=i(xd);jk=s(G0,"RobertaForSequenceClassification"),G0.forEach(t),Ck=s(ac," forward method, overrides the "),cp=r(ac,"CODE",{});var X0=i(cp);Pk=s(X0,"__call__"),X0.forEach(t),Ak=s(ac," special method."),ac.forEach(t),Lk=m(At),w(ns.$$.fragment,At),Ok=m(At),w(ss.$$.fragment,At),Nk=m(At),w(as.$$.fragment,At),Ik=m(At),w(rs.$$.fragment,At),Dk=m(At),w(is.$$.fragment,At),At.forEach(t),Fo.forEach(t),uu=m(o),Ko=r(o,"H2",{class:!0});var gf=i(Ko);ls=r(gf,"A",{id:!0,class:!0,href:!0});var Y0=i(ls);pp=r(Y0,"SPAN",{});var Z0=i(pp);w(Mr.$$.fragment,Z0),Z0.forEach(t),Y0.forEach(t),Sk=m(gf),hp=r(gf,"SPAN",{});var ex=i(hp);Bk=s(ex,"RobertaForMultipleChoice"),ex.forEach(t),gf.forEach(t),fu=m(o),$t=r(o,"DIV",{class:!0});var xo=i($t);w(zr.$$.fragment,xo),Wk=m(xo),mp=r(xo,"P",{});var tx=i(mp);Uk=s(tx,`Roberta Model with a multiple choice classification head on top (a linear layer on top of the pooled output and a
softmax) e.g. for RocStories/SWAG tasks.`),tx.forEach(t),Hk=m(xo),qr=r(xo,"P",{});var _f=i(qr);Qk=s(_f,"This model inherits from "),Rd=r(_f,"A",{href:!0});var ox=i(Rd);Kk=s(ox,"PreTrainedModel"),ox.forEach(t),Jk=s(_f,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),_f.forEach(t),Vk=m(xo),jr=r(xo,"P",{});var bf=i(jr);Gk=s(bf,"This model is also a PyTorch "),Cr=r(bf,"A",{href:!0,rel:!0});var nx=i(Cr);Xk=s(nx,"torch.nn.Module"),nx.forEach(t),Yk=s(bf,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),bf.forEach(t),Zk=m(xo),Qt=r(xo,"DIV",{class:!0});var ka=i(Qt);w(Pr.$$.fragment,ka),ey=m(ka),Jo=r(ka,"P",{});var rc=i(Jo);ty=s(rc,"The "),Ed=r(rc,"A",{href:!0});var sx=i(Ed);oy=s(sx,"RobertaForMultipleChoice"),sx.forEach(t),ny=s(rc," forward method, overrides the "),up=r(rc,"CODE",{});var ax=i(up);sy=s(ax,"__call__"),ax.forEach(t),ay=s(rc," special method."),rc.forEach(t),ry=m(ka),w(ds.$$.fragment,ka),iy=m(ka),w(cs.$$.fragment,ka),ka.forEach(t),xo.forEach(t),gu=m(o),Vo=r(o,"H2",{class:!0});var kf=i(Vo);ps=r(kf,"A",{id:!0,class:!0,href:!0});var rx=i(ps);fp=r(rx,"SPAN",{});var ix=i(fp);w(Ar.$$.fragment,ix),ix.forEach(t),rx.forEach(t),ly=m(kf),gp=r(kf,"SPAN",{});var lx=i(gp);dy=s(lx,"RobertaForTokenClassification"),lx.forEach(t),kf.forEach(t),_u=m(o),Ft=r(o,"DIV",{class:!0});var Ro=i(Ft);w(Lr.$$.fragment,Ro),cy=m(Ro),_p=r(Ro,"P",{});var dx=i(_p);py=s(dx,`Roberta Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g. for
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),vf.forEach(t),yy=m(Ro),Et=r(Ro,"DIV",{class:!0});var Eo=i(Et);w(Dr.$$.fragment,Eo),vy=m(Eo),Go=r(Eo,"P",{});var ic=i(Go);wy=s(ic,"The "),zd=r(ic,"A",{href:!0});var hx=i(zd);Ty=s(hx,"RobertaForTokenClassification"),hx.forEach(t),$y=s(ic," forward method, overrides the "),bp=r(ic,"CODE",{});var mx=i(bp);Fy=s(mx,"__call__"),mx.forEach(t),xy=s(ic," special method."),ic.forEach(t),Ry=m(Eo),w(hs.$$.fragment,Eo),Ey=m(Eo),w(ms.$$.fragment,Eo),My=m(Eo),w(us.$$.fragment,Eo),Eo.forEach(t),Ro.forEach(t),bu=m(o),Xo=r(o,"H2",{class:!0});var wf=i(Xo);fs=r(wf,"A",{id:!0,class:!0,href:!0});var ux=i(fs);kp=r(ux,"SPAN",{});var fx=i(kp);w(Sr.$$.fragment,fx),fx.forEach(t),ux.forEach(t),zy=m(wf),yp=r(wf,"SPAN",{});var gx=i(yp);qy=s(gx,"RobertaForQuestionAnswering"),gx.forEach(t),wf.forEach(t),ku=m(o),xt=r(o,"DIV",{class:!0});var Mo=i(xt);w(Br.$$.fragment,Mo),jy=m(Mo),Yo=r(Mo,"P",{});var lc=i(Yo);Cy=s(lc,`Roberta Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
layers on top of the hidden-states output to compute `),vp=r(lc,"CODE",{});var _x=i(vp);Py=s(_x,"span start logits"),_x.forEach(t),Ay=s(lc," and "),wp=r(lc,"CODE",{});var bx=i(wp);Ly=s(bx,"span end logits"),bx.forEach(t),Oy=s(lc,")."),lc.forEach(t),Ny=m(Mo),Wr=r(Mo,"P",{});var Tf=i(Wr);Iy=s(Tf,"This model inherits from "),qd=r(Tf,"A",{href:!0});var kx=i(qd);Dy=s(kx,"PreTrainedModel"),kx.forEach(t),Sy=s(Tf,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Rf.forEach(t),uv=m(no),w(ys.$$.fragment,no),fv=m(no),Kt=r(no,"DIV",{class:!0});var ya=i(Kt);w(Yr.$$.fragment,ya),gv=m(ya),tn=r(ya,"P",{});var cc=i(tn);_v=s(cc,"The "),Pd=r(cc,"A",{href:!0});var Mx=i(Pd);bv=s(Mx,"TFRobertaModel"),Mx.forEach(t),kv=s(cc," forward method, overrides the "),Rp=r(cc,"CODE",{});var zx=i(Rp);yv=s(zx,"__call__"),zx.forEach(t),vv=s(cc," special method."),cc.forEach(t),wv=m(ya),w(vs.$$.fragment,ya),Tv=m(ya),w(ws.$$.fragment,ya),ya.forEach(t),no.forEach(t),wu=m(o),on=r(o,"H2",{class:!0});var Ef=i(on);Ts=r(Ef,"A",{id:!0,class:!0,href:!0});var qx=i(Ts);Ep=r(qx,"SPAN",{});var jx=i(Ep);w(Zr.$$.fragment,jx),jx.forEach(t),qx.forEach(t),$v=m(Ef),Mp=r(Ef,"SPAN",{});var Cx=i(Mp);Fv=s(Cx,"TFRobertaForCausalLM"),Cx.forEach(t),Ef.forEach(t),Tu=m(o),nn=r(o,"DIV",{class:!0});var Mf=i(nn);w(ei.$$.fragment,Mf),xv=m(Mf),Jt=r(Mf,"DIV",{class:!0});var va=i(Jt);w(ti.$$.fragment,va),Rv=m(va),sn=r(va,"P",{});var pc=i(sn);Ev=s(pc,"The "),Ad=r(pc,"A",{href:!0});var Px=i(Ad);Mv=s(Px,"TFRobertaForCausalLM"),Px.forEach(t),zv=s(pc," forward method, overrides the "),zp=r(pc,"CODE",{});var Ax=i(zp);qv=s(Ax,"__call__"),Ax.forEach(t),jv=s(pc," special method."),pc.forEach(t),Cv=m(va),w($s.$$.fragment,va),Pv=m(va),w(Fs.$$.fragment,va),va.forEach(t),Mf.forEach(t),$u=m(o),an=r(o,"H2",{class:!0});var zf=i(an);xs=r(zf,"A",{id:!0,class:!0,href:!0});var Lx=i(xs);qp=r(Lx,"SPAN",{});var Ox=i(qp);w(oi.$$.fragment,Ox),Ox.forEach(t),Lx.forEach(t),Av=m(zf),jp=r(zf,"SPAN",{});var Nx=i(jp);Lv=s(Nx,"TFRobertaForMaskedLM"),Nx.forEach(t),zf.forEach(t),Fu=m(o),mt=r(o,"DIV",{class:!0});var so=i(mt);w(ni.$$.fragment,so),Ov=m(so),si=r(so,"P",{});var qf=i(si);Nv=s(qf,"RoBERTa Model with a "),Cp=r(qf,"CODE",{});var Ix=i(Cp);Iv=s(Ix,"language modeling"),Ix.forEach(t),Dv=s(qf," head on top."),qf.forEach(t),Sv=m(so),ai=r(so,"P",{});var jf=i(ai);Bv=s(jf,"This model inherits from "),Ld=r(jf,"A",{href:!0});var Dx=i(Ld);Wv=s(Dx,"TFPreTrainedModel"),Dx.forEach(t),Uv=s(jf,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),jf.forEach(t),Hv=m(so),ri=r(so,"P",{});var Cf=i(ri);Qv=s(Cf,"This model is also a "),ii=r(Cf,"A",{href:!0,rel:!0});var Sx=i(ii);Kv=s(Sx,"tf.keras.Model"),Sx.forEach(t),Jv=s(Cf,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Cf.forEach(t),Vv=m(so),w(Rs.$$.fragment,so),Gv=m(so),zt=r(so,"DIV",{class:!0});var qo=i(zt);w(li.$$.fragment,qo),Xv=m(qo),rn=r(qo,"P",{});var hc=i(rn);Yv=s(hc,"The "),Od=r(hc,"A",{href:!0});var Bx=i(Od);Zv=s(Bx,"TFRobertaForMaskedLM"),Bx.forEach(t),ew=s(hc," forward method, overrides the "),Pp=r(hc,"CODE",{});var Wx=i(Pp);tw=s(Wx,"__call__"),Wx.forEach(t),ow=s(hc," special method."),hc.forEach(t),nw=m(qo),w(Es.$$.fragment,qo),sw=m(qo),w(Ms.$$.fragment,qo),aw=m(qo),w(zs.$$.fragment,qo),qo.forEach(t),so.forEach(t),xu=m(o),ln=r(o,"H2",{class:!0});var Pf=i(ln);qs=r(Pf,"A",{id:!0,class:!0,href:!0});var Ux=i(qs);Ap=r(Ux,"SPAN",{});var Hx=i(Ap);w(di.$$.fragment,Hx),Hx.forEach(t),Ux.forEach(t),rw=m(Pf),Lp=r(Pf,"SPAN",{});var Qx=i(Lp);iw=s(Qx,"TFRobertaForSequenceClassification"),Qx.forEach(t),Pf.forEach(t),Ru=m(o),ut=r(o,"DIV",{class:!0});var ao=i(ut);w(ci.$$.fragment,ao),lw=m(ao),Op=r(ao,"P",{});var Kx=i(Op);dw=s(Kx,`RoBERTa Model transformer with a sequence classification/regression head on top (a linear layer on top of the
pooled output) e.g. for GLUE tasks.`),Kx.forEach(t),cw=m(ao),pi=r(ao,"P",{});var Af=i(pi);pw=s(Af,"This model inherits from "),Nd=r(Af,"A",{href:!0});var Jx=i(Nd);hw=s(Jx,"TFPreTrainedModel"),Jx.forEach(t),mw=s(Af,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Af.forEach(t),uw=m(ao),hi=r(ao,"P",{});var Lf=i(hi);fw=s(Lf,"This model is also a "),mi=r(Lf,"A",{href:!0,rel:!0});var Vx=i(mi);gw=s(Vx,"tf.keras.Model"),Vx.forEach(t),_w=s(Lf,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Lf.forEach(t),bw=m(ao),w(js.$$.fragment,ao),kw=m(ao),qt=r(ao,"DIV",{class:!0});var jo=i(qt);w(ui.$$.fragment,jo),yw=m(jo),dn=r(jo,"P",{});var mc=i(dn);vw=s(mc,"The "),Id=r(mc,"A",{href:!0});var Gx=i(Id);ww=s(Gx,"TFRobertaForSequenceClassification"),Gx.forEach(t),Tw=s(mc," forward method, overrides the "),Np=r(mc,"CODE",{});var Xx=i(Np);$w=s(Xx,"__call__"),Xx.forEach(t),Fw=s(mc," special method."),mc.forEach(t),xw=m(jo),w(Cs.$$.fragment,jo),Rw=m(jo),w(Ps.$$.fragment,jo),Ew=m(jo),w(As.$$.fragment,jo),jo.forEach(t),ao.forEach(t),Eu=m(o),cn=r(o,"H2",{class:!0});var Of=i(cn);Ls=r(Of,"A",{id:!0,class:!0,href:!0});var Yx=i(Ls);Ip=r(Yx,"SPAN",{});var Zx=i(Ip);w(fi.$$.fragment,Zx),Zx.forEach(t),Yx.forEach(t),Mw=m(Of),Dp=r(Of,"SPAN",{});var eR=i(Dp);zw=s(eR,"TFRobertaForMultipleChoice"),eR.forEach(t),Of.forEach(t),Mu=m(o),ft=r(o,"DIV",{class:!0});var ro=i(ft);w(gi.$$.fragment,ro),qw=m(ro),Sp=r(ro,"P",{});var tR=i(Sp);jw=s(tR,`Roberta Model with a multiple choice classification head on top (a linear layer on top of the pooled output and a
softmax) e.g. for RocStories/SWAG tasks.`),tR.forEach(t),Cw=m(ro),_i=r(ro,"P",{});var Nf=i(_i);Pw=s(Nf,"This model inherits from "),Dd=r(Nf,"A",{href:!0});var oR=i(Dd);Aw=s(oR,"TFPreTrainedModel"),oR.forEach(t),Lw=s(Nf,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Bf.forEach(t),dT=m(io),w(Ss.$$.fragment,io),cT=m(io),jt=r(io,"DIV",{class:!0});var Co=i(jt);w(xi.$$.fragment,Co),pT=m(Co),mn=r(Co,"P",{});var fc=i(mn);hT=s(fc,"The "),Wd=r(fc,"A",{href:!0});var hR=i(Wd);mT=s(hR,"TFRobertaForTokenClassification"),hR.forEach(t),uT=s(fc," forward method, overrides the "),Qp=r(fc,"CODE",{});var mR=i(Qp);fT=s(mR,"__call__"),mR.forEach(t),gT=s(fc," special method."),fc.forEach(t),_T=m(Co),w(Bs.$$.fragment,Co),bT=m(Co),w(Ws.$$.fragment,Co),kT=m(Co),w(Us.$$.fragment,Co),Co.forEach(t),io.forEach(t),ju=m(o),un=r(o,"H2",{class:!0});var Wf=i(un);Hs=r(Wf,"A",{id:!0,class:!0,href:!0});var uR=i(Hs);Kp=r(uR,"SPAN",{});var fR=i(Kp);w(Ri.$$.fragment,fR),fR.forEach(t),uR.forEach(t),yT=m(Wf),Jp=r(Wf,"SPAN",{});var gR=i(Jp);vT=s(gR,"TFRobertaForQuestionAnswering"),gR.forEach(t),Wf.forEach(t),Cu=m(o),_t=r(o,"DIV",{class:!0});var lo=i(_t);w(Ei.$$.fragment,lo),wT=m(lo),fn=r(lo,"P",{});var gc=i(fn);TT=s(gc,`RoBERTa Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
layers on top of the hidden-states output to compute `),Vp=r(gc,"CODE",{});var _R=i(Vp);$T=s(_R,"span start logits"),_R.forEach(t),FT=s(gc," and "),Gp=r(gc,"CODE",{});var bR=i(Gp);xT=s(bR,"span end logits"),bR.forEach(t),RT=s(gc,")."),gc.forEach(t),ET=m(lo),Mi=r(lo,"P",{});var Uf=i(Mi);MT=s(Uf,"This model inherits from "),Ud=r(Uf,"A",{href:!0});var kR=i(Ud);zT=s(kR,"TFPreTrainedModel"),kR.forEach(t),qT=s(Uf,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Uf.forEach(t),jT=m(lo),zi=r(lo,"P",{});var Hf=i(zi);CT=s(Hf,"This model is also a "),qi=r(Hf,"A",{href:!0,rel:!0});var yR=i(qi);PT=s(yR,"tf.keras.Model"),yR.forEach(t),AT=s(Hf,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Hf.forEach(t),LT=m(lo),w(Qs.$$.fragment,lo),OT=m(lo),Ct=r(lo,"DIV",{class:!0});var Po=i(Ct);w(ji.$$.fragment,Po),NT=m(Po),gn=r(Po,"P",{});var _c=i(gn);IT=s(_c,"The "),Hd=r(_c,"A",{href:!0});var vR=i(Hd);DT=s(vR,"TFRobertaForQuestionAnswering"),vR.forEach(t),ST=s(_c," forward method, overrides the "),Xp=r(_c,"CODE",{});var wR=i(Xp);BT=s(wR,"__call__"),wR.forEach(t),WT=s(_c," special method."),_c.forEach(t),UT=m(Po),w(Ks.$$.fragment,Po),HT=m(Po),w(Js.$$.fragment,Po),QT=m(Po),w(Vs.$$.fragment,Po),Po.forEach(t),lo.forEach(t),Pu=m(o),_n=r(o,"H2",{class:!0});var Qf=i(_n);Gs=r(Qf,"A",{id:!0,class:!0,href:!0});var TR=i(Gs);Yp=r(TR,"SPAN",{});var $R=i(Yp);w(Ci.$$.fragment,$R),$R.forEach(t),TR.forEach(t),KT=m(Qf),Zp=r(Qf,"SPAN",{});var FR=i(Zp);JT=s(FR,"FlaxRobertaModel"),FR.forEach(t),Qf.forEach(t),Au=m(o),nt=r(o,"DIV",{class:!0});var Lt=i(nt);w(Pi.$$.fragment,Lt),VT=m(Lt),eh=r(Lt,"P",{});var xR=i(eh);GT=s(xR,"The bare RoBERTa Model transformer outputting raw hidden-states without any specific head on top."),xR.forEach(t),XT=m(Lt),Ai=r(Lt,"P",{});var Kf=i(Ai);YT=s(Kf,"This model inherits from "),Qd=r(Kf,"A",{href:!0});var RR=i(Qd);ZT=s(RR,"FlaxPreTrainedModel"),RR.forEach(t),e$=s(Kf,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),Kf.forEach(t),t$=m(Lt),Li=r(Lt,"P",{});var Jf=i(Li);o$=s(Jf,"This model is also a Flax Linen "),Oi=r(Jf,"A",{href:!0,rel:!0});var ER=i(Oi);n$=s(ER,"flax.linen.Module"),ER.forEach(t),s$=s(Jf,`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),Jf.forEach(t),a$=m(Lt),th=r(Lt,"P",{});var MR=i(th);r$=s(MR,"Finally, this model supports inherent JAX features such as:"),MR.forEach(t),i$=m(Lt),po=r(Lt,"UL",{});var Ta=i(po);oh=r(Ta,"LI",{});var zR=i(oh);Ni=r(zR,"A",{href:!0,rel:!0});var qR=i(Ni);l$=s(qR,"Just-In-Time (JIT) compilation"),qR.forEach(t),zR.forEach(t),d$=m(Ta),nh=r(Ta,"LI",{});var jR=i(nh);Ii=r(jR,"A",{href:!0,rel:!0});var CR=i(Ii);c$=s(CR,"Automatic Differentiation"),CR.forEach(t),jR.forEach(t),p$=m(Ta),sh=r(Ta,"LI",{});var PR=i(sh);Di=r(PR,"A",{href:!0,rel:!0});var AR=i(Di);h$=s(AR,"Vectorization"),AR.forEach(t),PR.forEach(t),m$=m(Ta),ah=r(Ta,"LI",{});var LR=i(ah);Si=r(LR,"A",{href:!0,rel:!0});var OR=i(Si);u$=s(OR,"Parallelization"),OR.forEach(t),LR.forEach(t),Ta.forEach(t),f$=m(Lt),Gt=r(Lt,"DIV",{class:!0});var $a=i(Gt);w(Bi.$$.fragment,$a),g$=m($a),bn=r($a,"P",{});var bc=i(bn);_$=s(bc,"The "),rh=r(bc,"CODE",{});var NR=i(rh);b$=s(NR,"FlaxRobertaPreTrainedModel"),NR.forEach(t),k$=s(bc," forward method, overrides the "),ih=r(bc,"CODE",{});var IR=i(ih);y$=s(IR,"__call__"),IR.forEach(t),v$=s(bc," special method."),bc.forEach(t),w$=m($a),w(Xs.$$.fragment,$a),T$=m($a),w(Ys.$$.fragment,$a),$a.forEach(t),Lt.forEach(t),Lu=m(o),kn=r(o,"H2",{class:!0});var Vf=i(kn);Zs=r(Vf,"A",{id:!0,class:!0,href:!0});var DR=i(Zs);lh=r(DR,"SPAN",{});var SR=i(lh);w(Wi.$$.fragment,SR),SR.forEach(t),DR.forEach(t),$$=m(Vf),dh=r(Vf,"SPAN",{});var BR=i(dh);F$=s(BR,"FlaxRobertaForCausalLM"),BR.forEach(t),Vf.forEach(t),Ou=m(o),st=r(o,"DIV",{class:!0});var Ot=i(st);w(Ui.$$.fragment,Ot),x$=m(Ot),ch=r(Ot,"P",{});var WR=i(ch);R$=s(WR,`Roberta Model with a language modeling head on top (a linear layer on top of the hidden-states output) e.g for
autoregressive tasks.`),WR.forEach(t),E$=m(Ot),Hi=r(Ot,"P",{});var Gf=i(Hi);M$=s(Gf,"This model inherits from "),Kd=r(Gf,"A",{href:!0});var UR=i(Kd);z$=s(UR,"FlaxPreTrainedModel"),UR.forEach(t),q$=s(Gf,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),Gf.forEach(t),j$=m(Ot),Qi=r(Ot,"P",{});var Xf=i(Qi);C$=s(Xf,"This model is also a Flax Linen "),Ki=r(Xf,"A",{href:!0,rel:!0});var HR=i(Ki);P$=s(HR,"flax.linen.Module"),HR.forEach(t),A$=s(Xf,`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),Xf.forEach(t),L$=m(Ot),ph=r(Ot,"P",{});var QR=i(ph);O$=s(QR,"Finally, this model supports inherent JAX features such as:"),QR.forEach(t),N$=m(Ot),ho=r(Ot,"UL",{});var Fa=i(ho);hh=r(Fa,"LI",{});var KR=i(hh);Ji=r(KR,"A",{href:!0,rel:!0});var JR=i(Ji);I$=s(JR,"Just-In-Time (JIT) compilation"),JR.forEach(t),KR.forEach(t),D$=m(Fa),mh=r(Fa,"LI",{});var VR=i(mh);Vi=r(VR,"A",{href:!0,rel:!0});var GR=i(Vi);S$=s(GR,"Automatic Differentiation"),GR.forEach(t),VR.forEach(t),B$=m(Fa),uh=r(Fa,"LI",{});var XR=i(uh);Gi=r(XR,"A",{href:!0,rel:!0});var YR=i(Gi);W$=s(YR,"Vectorization"),YR.forEach(t),XR.forEach(t),U$=m(Fa),fh=r(Fa,"LI",{});var ZR=i(fh);Xi=r(ZR,"A",{href:!0,rel:!0});var eE=i(Xi);H$=s(eE,"Parallelization"),eE.forEach(t),ZR.forEach(t),Fa.forEach(t),Q$=m(Ot),Xt=r(Ot,"DIV",{class:!0});var xa=i(Xt);w(Yi.$$.fragment,xa),K$=m(xa),yn=r(xa,"P",{});var kc=i(yn);J$=s(kc,"The "),gh=r(kc,"CODE",{});var tE=i(gh);V$=s(tE,"FlaxRobertaPreTrainedModel"),tE.forEach(t),G$=s(kc," forward method, overrides the "),_h=r(kc,"CODE",{});var oE=i(_h);X$=s(oE,"__call__"),oE.forEach(t),Y$=s(kc," special method."),kc.forEach(t),Z$=m(xa),w(ea.$$.fragment,xa),e1=m(xa),w(ta.$$.fragment,xa),xa.forEach(t),Ot.forEach(t),Nu=m(o),vn=r(o,"H2",{class:!0});var Yf=i(vn);oa=r(Yf,"A",{id:!0,class:!0,href:!0});var nE=i(oa);bh=r(nE,"SPAN",{});var sE=i(bh);w(Zi.$$.fragment,sE),sE.forEach(t),nE.forEach(t),t1=m(Yf),kh=r(Yf,"SPAN",{});var aE=i(kh);o1=s(aE,"FlaxRobertaForMaskedLM"),aE.forEach(t),Yf.forEach(t),Iu=m(o),at=r(o,"DIV",{class:!0});var Nt=i(at);w(el.$$.fragment,Nt),n1=m(Nt),tl=r(Nt,"P",{});var Zf=i(tl);s1=s(Zf,"RoBERTa Model with a "),yh=r(Zf,"CODE",{});var rE=i(yh);a1=s(rE,"language modeling"),rE.forEach(t),r1=s(Zf," head on top."),Zf.forEach(t),i1=m(Nt),ol=r(Nt,"P",{});var eg=i(ol);l1=s(eg,"This model inherits from "),Jd=r(eg,"A",{href:!0});var iE=i(Jd);d1=s(iE,"FlaxPreTrainedModel"),iE.forEach(t),c1=s(eg,`. Check the superclass documentation for the generic methods the
...
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),sg.forEach(t),Q1=m(It),qh=r(It,"P",{});var xE=i(qh);K1=s(xE,"Finally, this model supports inherent JAX features such as:"),xE.forEach(t),J1=m(It),uo=r(It,"UL",{});var Ma=i(uo);jh=r(Ma,"LI",{});var RE=i(jh);fl=r(RE,"A",{href:!0,rel:!0});var EE=i(fl);V1=s(EE,"Just-In-Time (JIT) compilation"),EE.forEach(t),RE.forEach(t),G1=m(Ma),Ch=r(Ma,"LI",{});var ME=i(Ch);gl=r(ME,"A",{href:!0,rel:!0});var zE=i(gl);X1=s(zE,"Automatic Differentiation"),zE.forEach(t),ME.forEach(t),Y1=m(Ma),Ph=r(Ma,"LI",{});var qE=i(Ph);_l=r(qE,"A",{href:!0,rel:!0});var jE=i(_l);Z1=s(jE,"Vectorization"),jE.forEach(t),qE.forEach(t),e2=m(Ma),Ah=r(Ma,"LI",{});var CE=i(Ah);bl=r(CE,"A",{href:!0,rel:!0});var PE=i(bl);t2=s(PE,"Parallelization"),PE.forEach(t),CE.forEach(t),Ma.forEach(t),o2=m(It),Zt=r(It,"DIV",{class:!0});var za=i(Zt);w(kl.$$.fragment,za),n2=m(za),$n=r(za,"P",{});var vc=i($n);s2=s(vc,"The "),Lh=r(vc,"CODE",{});var AE=i(Lh);a2=s(AE,"FlaxRobertaPreTrainedModel"),AE.forEach(t),r2=s(vc," forward method, overrides the "),Oh=r(vc,"CODE",{});var LE=i(Oh);i2=s(LE,"__call__"),LE.forEach(t),l2=s(vc," special method."),vc.forEach(t),d2=m(za),w(ra.$$.fragment,za),c2=m(za),w(ia.$$.fragment,za),za.forEach(t),It.forEach(t),Bu=m(o),Fn=r(o,"H2",{class:!0});var ag=i(Fn);la=r(ag,"A",{id:!0,class:!0,href:!0});var OE=i(la);Nh=r(OE,"SPAN",{});var NE=i(Nh);w(yl.$$.fragment,NE),NE.forEach(t),OE.forEach(t),p2=m(ag),Ih=r(ag,"SPAN",{});var IE=i(Ih);h2=s(IE,"FlaxRobertaForMultipleChoice"),IE.forEach(t),ag.forEach(t),Wu=m(o),it=r(o,"DIV",{class:!0});var Dt=i(it);w(vl.$$.fragment,Dt),m2=m(Dt),Dh=r(Dt,"P",{});var DE=i(Dh);u2=s(DE,`Roberta Model with a multiple choice classification head on top (a linear layer on top of the pooled output and a
...
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),ig.forEach(t),T2=m(Dt),Sh=r(Dt,"P",{});var WE=i(Sh);$2=s(WE,"Finally, this model supports inherent JAX features such as:"),WE.forEach(t),F2=m(Dt),fo=r(Dt,"UL",{});var qa=i(fo);Bh=r(qa,"LI",{});var UE=i(Bh);Fl=r(UE,"A",{href:!0,rel:!0});var HE=i(Fl);x2=s(HE,"Just-In-Time (JIT) compilation"),HE.forEach(t),UE.forEach(t),R2=m(qa),Wh=r(qa,"LI",{});var QE=i(Wh);xl=r(QE,"A",{href:!0,rel:!0});var KE=i(xl);E2=s(KE,"Automatic Differentiation"),KE.forEach(t),QE.forEach(t),M2=m(qa),Uh=r(qa,"LI",{});var JE=i(Uh);Rl=r(JE,"A",{href:!0,rel:!0});var VE=i(Rl);z2=s(VE,"Vectorization"),VE.forEach(t),JE.forEach(t),q2=m(qa),Hh=r(qa,"LI",{});var GE=i(Hh);El=r(GE,"A",{href:!0,rel:!0});var XE=i(El);j2=s(XE,"Parallelization"),XE.forEach(t),GE.forEach(t),qa.forEach(t),C2=m(Dt),eo=r(Dt,"DIV",{class:!0});var ja=i(eo);w(Ml.$$.fragment,ja),P2=m(ja),xn=r(ja,"P",{});var wc=i(xn);A2=s(wc,"The "),Qh=r(wc,"CODE",{});var YE=i(Qh);L2=s(YE,"FlaxRobertaPreTrainedModel"),YE.forEach(t),O2=s(wc," forward method, overrides the "),Kh=r(wc,"CODE",{});var ZE=i(Kh);N2=s(ZE,"__call__"),ZE.forEach(t),I2=s(wc," special method."),wc.forEach(t),D2=m(ja),w(da.$$.fragment,ja),S2=m(ja),w(ca.$$.fragment,ja),ja.forEach(t),Dt.forEach(t),Uu=m(o),Rn=r(o,"H2",{class:!0});var lg=i(Rn);pa=r(lg,"A",{id:!0,class:!0,href:!0});var eM=i(pa);Jh=r(eM,"SPAN",{});var tM=i(Jh);w(zl.$$.fragment,tM),tM.forEach(t),eM.forEach(t),B2=m(lg),Vh=r(lg,"SPAN",{});var oM=i(Vh);W2=s(oM,"FlaxRobertaForTokenClassification"),oM.forEach(t),lg.forEach(t),Hu=m(o),lt=r(o,"DIV",{class:!0});var St=i(lt);w(ql.$$.fragment,St),U2=m(St),Gh=r(St,"P",{});var nM=i(Gh);H2=s(nM,`Roberta Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g. for
Named-Entity-Recognition (NER) tasks.`),nM.forEach(t),Q2=m(St),jl=r(St,"P",{});var dg=i(jl);K2=s(dg,"This model inherits from "),Xd=r(dg,"A",{href:!0});var sM=i(Xd);J2=s(sM,"FlaxPreTrainedModel"),sM.forEach(t),V2=s(dg,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),dg.forEach(t),G2=m(St),Cl=r(St,"P",{});var cg=i(Cl);X2=s(cg,"This model is also a Flax Linen "),Pl=r(cg,"A",{href:!0,rel:!0});var aM=i(Pl);Y2=s(aM,"flax.linen.Module"),aM.forEach(t),Z2=s(cg,`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),cg.forEach(t),eF=m(St),Xh=r(St,"P",{});var rM=i(Xh);tF=s(rM,"Finally, this model supports inherent JAX features such as:"),rM.forEach(t),oF=m(St),go=r(St,"UL",{});var Ca=i(go);Yh=r(Ca,"LI",{});var iM=i(Yh);Al=r(iM,"A",{href:!0,rel:!0});var lM=i(Al);nF=s(lM,"Just-In-Time (JIT) compilation"),lM.forEach(t),iM.forEach(t),sF=m(Ca),Zh=r(Ca,"LI",{});var dM=i(Zh);Ll=r(dM,"A",{href:!0,rel:!0});var cM=i(Ll);aF=s(cM,"Automatic Differentiation"),cM.forEach(t),dM.forEach(t),rF=m(Ca),em=r(Ca,"LI",{});var pM=i(em);Ol=r(pM,"A",{href:!0,rel:!0});var hM=i(Ol);iF=s(hM,"Vectorization"),hM.forEach(t),pM.forEach(t),lF=m(Ca),tm=r(Ca,"LI",{});var mM=i(tm);Nl=r(mM,"A",{href:!0,rel:!0});var uM=i(Nl);dF=s(uM,"Parallelization"),uM.forEach(t),mM.forEach(t),Ca.forEach(t),cF=m(St),to=r(St,"DIV",{class:!0});var Pa=i(to);w(Il.$$.fragment,Pa),pF=m(Pa),En=r(Pa,"P",{});var Tc=i(En);hF=s(Tc,"The "),om=r(Tc,"CODE",{});var fM=i(om);mF=s(fM,"FlaxRobertaPreTrainedModel"),fM.forEach(t),uF=s(Tc," forward method, overrides the "),nm=r(Tc,"CODE",{});var gM=i(nm);fF=s(gM,"__call__"),gM.forEach(t),gF=s(Tc," special method."),Tc.forEach(t),_F=m(Pa),w(ha.$$.fragment,Pa),bF=m(Pa),w(ma.$$.fragment,Pa),Pa.forEach(t),St.forEach(t),Qu=m(o),Mn=r(o,"H2",{class:!0});var pg=i(Mn);ua=r(pg,"A",{id:!0,class:!0,href:!0});var _M=i(ua);sm=r(_M,"SPAN",{});var bM=i(sm);w(Dl.$$.fragment,bM),bM.forEach(t),_M.forEach(t),kF=m(pg),am=r(pg,"SPAN",{});var kM=i(am);yF=s(kM,"FlaxRobertaForQuestionAnswering"),kM.forEach(t),pg.forEach(t),Ku=m(o),dt=r(o,"DIV",{class:!0});var Bt=i(dt);w(Sl.$$.fragment,Bt),vF=m(Bt),zn=r(Bt,"P",{});var $c=i(zn);wF=s($c,`Roberta Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
