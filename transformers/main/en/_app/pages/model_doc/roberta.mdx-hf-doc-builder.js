...
pass your inputs and labels in any format that `),W=r(j,"CODE",{});var Se=i(W);$e=s(Se,"model.fit()"),Se.forEach(t),pe=s(j,` supports! If, however, you want to use the second
...
the Keras `),H=r(j,"CODE",{});var We=i(H);Re=s(We,"Functional"),We.forEach(t),ke=s(j,` API, there are three possibilities you can use to gather all the input Tensors in the first
...
<span class="hljs-meta">&gt;&gt;&gt; </span>end_scores = outputs.end_logits`}}),{c(){d=a("p"),g=n("Example:"),c=h(),v(u.$$.fragment)},l(l){d=r(l,"P",{});var p=i(d);g=s(p,"Example:"),p.forEach(t),c=m(l),w(u.$$.fragment,l)},m(l,p){k(l,d,p),e(d,g),k(l,c,p),T(u,l,p),_=!0},p:re,i(l){_||($(u.$$.fragment,l),_=!0)},o(l){F(u.$$.fragment,l),_=!1},d(l){l&&t(d),l&&t(c),x(u,l)}}}function Vz(R){let d,g,c,u,_,l,p,E,le,Z,N,te,oe,M,we,K,Te,ge,W,$e,pe,J,Fe,_e,U,xe,be,H,Re,ke,ee,C,P,ye,Q,Ee,ve,I,he,Me,q,ze,V,je,me,G,Ce,ne,D,ue,X,qe,se,L,Pe,A,Le,Ae,y,z,He,de,Xe,Je,j,Ye,Se,Ze,et,We,S,Y,Ve,Oe,B,Qe,Be,Ne,Ke,ce,Ge,yt,Oa,ug,co,fg,id,gg,_g,ld,bg,kg,Na,yg,vg,wg,Lo,Tg,dd,$g,Fg,cd,xg,Rg,Eg,Ao,Mg,pd,zg,jg,hd,Cg,qg,Pg,An,ou,Oo,On,xc,Ia,Lg,Rc,Ag,nu,Ie,Da,Og,Ec,Ng,Ig,Mc,Dg,Sg,Nn,Wg,Sa,Bg,zc,Ug,Hg,Qg,In,Kg,Wa,Jg,md,Vg,Gg,Xg,vo,Ba,Yg,jc,Zg,e_,Ua,ud,t_,Cc,o_,n_,fd,s_,qc,a_,r_,Dn,Ha,i_,Qa,l_,Pc,d_,c_,p_,Sn,Ka,h_,Lc,m_,u_,gd,Ja,su,No,Wn,Ac,Va,f_,Oc,g_,au,tt,Ga,__,Xa,b_,Nc,k_,y_,v_,Ic,w_,T_,Bn,$_,Ya,F_,Dc,x_,R_,E_,Un,M_,Za,z_,_d,j_,C_,q_,bd,er,ru,Io,Hn,Sc,tr,P_,Wc,L_,iu,ot,or,A_,Bc,O_,N_,nr,I_,kd,D_,S_,W_,sr,B_,ar,U_,H_,Q_,rr,K_,Uc,J_,V_,G_,pt,X_,Hc,Y_,Z_,Qc,eb,tb,Kc,ob,nb,Jc,sb,ab,Vc,rb,ib,Gc,lb,db,cb,Qn,pb,Xc,hb,mb,ir,ub,fb,Ut,lr,gb,Do,_b,yd,bb,kb,Yc,yb,vb,wb,Kn,Tb,Jn,lu,So,Vn,Zc,dr,$b,ep,Fb,du,vt,cr,xb,pr,Rb,tp,Eb,Mb,zb,hr,jb,vd,Cb,qb,Pb,mr,Lb,ur,Ab,Ob,Nb,Ht,fr,Ib,Wo,Db,wd,Sb,Wb,op,Bb,Ub,Hb,Gn,Qb,Xn,cu,Bo,Yn,np,gr,Kb,sp,Jb,pu,wt,_r,Vb,br,
,bF,ma,Qu,Mn,ua,sm,Dl,kF,am,yF,Ku,dt,Sl,vF,zn,wF,rm,TF,$F,im,FF,xF,RF,Wl,EF,Yd,MF,zF,jF,Bl,CF,Ul,qF,PF,LF,lm,AF,OF,_o,dm,Hl,NF,IF,cm,Ql,DF,SF,pm,Kl,WF,BF,hm,Jl,UF,HF,oo,Vl,QF,jn,KF,mm,JF,VF,um,GF,XF,YF,fa,ZF,ga,Ju;return l=new De({}),M=new De({}),Be=new De({}),Oa=new O({props:{name:"class transformers.RobertaConfig",anchor:"transformers.RobertaConfig",parameters:[{name:"pad_token_id",val:" = 1"},{name:"bos_token_id",val:" = 0"},{name:"eos_token_id",val:" = 2"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/roberta/configuration_roberta.py#L37"}}),An=new ae({props:{anchor:"transformers.RobertaConfig.example",$$slots:{default:[DM]},$$scope:{ctx:R}}}),Ia=new De({}),Da=new O({props:{name:"class transformers.RobertaTokenizer",anchor:"transformers.RobertaTokenizer",parameters:[{name:"vocab_file",val:""},{name:"merges_file",val:""},{name:"errors",val:" = 'replace'"},{name:"bos_token",val:" = '<s>'"},{name:"eos_token",val:" = '</s>'"},{name:"sep_token",val:" = '</s>'"},{name:"cls_token",val:" = '<s>'"},{name:"unk_token",val:" = '<unk>'"},{name:"pad_token",val:" = '<pad>'"},{name:"mask_token",val:" = '<mask>'"},{name:"add_prefix_space",val:" = False"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.RobertaTokenizer.vocab_file",description:`<strong>vocab_file</strong> (<code>str</code>) &#x2014;
...
`}}),fa=new fe({props:{$$slots:{default:[Kz]},$$scope:{ctx:R}}}),ga=new ae({props:{anchor:"transformers.FlaxRobertaForQuestionAnswering.__call__.example",$$slots:{default:[Jz]},$$scope:{ctx:R}}}),{c(){d=a("meta"),g=h(),c=a("h1"),u=a("a"),_=a("span"),v(l.$$.fragment),p=h(),E=a("span"),le=n("RoBERTa"),Z=h(),N=a("h2"),te=a("a"),oe=a("span"),v(M.$$.fragment),we=h(),K=a("span"),Te=n("Overview"),ge=h(),W=a("p"),$e=n("The RoBERTa model was proposed in "),pe=a("a"),J=n("RoBERTa: A Robustly Optimized BERT Pretraining Approach"),Fe=n(` by Yinhan Liu, Myle Ott, Naman Goyal, Jingfei Du, Mandar Joshi, Danqi Chen, Omer
...
call it on some text, but since the model was not pretrained this way, it might yield a decrease in performance.`),Qg=h(),v(In.$$.fragment),Kg=h(),Wa=a("p"),Jg=n("This tokenizer inherits from "),md=a("a"),Vg=n("PreTrainedTokenizer"),Gg=n(` which contains most of the main methods. Users should refer to
this superclass for more information regarding those methods.`),Xg=h(),vo=a("div"),v(Ba.$$.fragment),Yg=h(),jc=a("p"),Zg=n(`Build model inputs from a sequence or a pair of sequence for sequence classification tasks by concatenating and
...
make use of token type ids, therefore a list of zeros is returned.`),u_=h(),gd=a("div"),v(Ja.$$.fragment),su=h(),No=a("h2"),Wn=a("a"),Ac=a("span"),v(Va.$$.fragment),f_=h(),Oc=a("span"),g_=n("RobertaTokenizerFast"),au=h(),tt=a("div"),v(Ga.$$.fragment),__=h(),Xa=a("p"),b_=n("Construct a \u201Cfast\u201D RoBERTa tokenizer (backed by HuggingFace\u2019s "),Nc=a("em"),k_=n("tokenizers"),y_=n(` library), derived from the GPT-2
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Nb=h(),Ht=a("div"),v(fr.$$.fragment),Ib=h(),Wo=a("p"),Db=n("The "),wd=a("a"),Sb=n("RobertaForCausalLM"),Wb=n(" forward method, overrides the "),op=a("code"),Bb=n("__call__"),Ub=n(" special method."),Hb=h(),v(Gn.$$.fragment),Qb=h(),v(Xn.$$.fragment),cu=h(),Bo=a("h2"),Yn=a("a"),np=a("span"),v(gr.$$.fragment),Kb=h(),sp=a("span"),Jb=n("RobertaForMaskedLM"),pu=h(),wt=a("div"),v(_r.$$.fragment),Vb=h(),br=a("p"),Gb=n("RoBERTa Model with a "),ap=a("code"),Xb=n("language modeling"),Yb=n(" head on top."),Zb=h(),kr=a("p"),ek=n("This model inherits from "),Td=a("a"),tk=n("PreTrainedModel"),ok=n(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),yy=h(),Et=a("div"),v(Dr.$$.fragment),vy=h(),Go=a("p"),wy=n("The "),zd=a("a"),Ty=n("RobertaForTokenClassification"),$y=n(" forward method, overrides the "),bp=a("code"),Fy=n("__call__"),xy=n(" special method."),Ry=h(),v(hs.$$.fragment),Ey=h(),v(ms.$$.fragment),My=h(),v(us.$$.fragment),bu=h(),Xo=a("h2"),fs=a("a"),kp=a("span"),v(Sr.$$.fragment),zy=h(),yp=a("span"),jy=n("RobertaForQuestionAnswering"),ku=h(),xt=a("div"),v(Wr.$$.fragment),Cy=h(),Yo=a("p"),qy=n(`Roberta Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
layers on top of the hidden-states output to compute `),vp=a("code"),Py=n("span start logits"),Ly=n(" and "),wp=a("code"),Ay=n("span end logits"),Oy=n(")."),Ny=h(),Br=a("p"),Iy=n("This model inherits from "),jd=a("a"),Dy=n("PreTrainedModel"),Sy=n(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Sw=h(),v(Os.$$.fragment),Ww=h(),Vt=a("div"),v(yi.$$.fragment),Bw=h(),pn=a("p"),Uw=n("The "),Sd=a("a"),Hw=n("TFRobertaForMultipleChoice"),Qw=n(" forward method, overrides the "),Wp=a("code"),Kw=n("__call__"),Jw=n(" special method."),Vw=h(),v(Ns.$$.fragment),Gw=h(),v(Is.$$.fragment),zu=h(),hn=a("h2"),Ds=a("a"),Bp=a("span"),v(vi.$$.fragment),Xw=h(),Up=a("span"),Yw=n("TFRobertaForTokenClassification"),ju=h(),gt=a("div"),v(wi.$$.fragment),Zw=h(),Hp=a("p"),eT=n(`RoBERTa Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g. for
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),dT=h(),v(Ss.$$.fragment),cT=h(),Ct=a("div"),v(xi.$$.fragment),pT=h(),mn=a("p"),hT=n("The "),Bd=a("a"),mT=n("TFRobertaForTokenClassification"),uT=n(" forward method, overrides the "),Qp=a("code"),fT=n("__call__"),gT=n(" special method."),_T=h(),v(Ws.$$.fragment),bT=h(),v(Bs.$$.fragment),kT=h(),v(Us.$$.fragment),Cu=h(),un=a("h2"),Hs=a("a"),Kp=a("span"),v(Ri.$$.fragment),yT=h(),Jp=a("span"),vT=n("TFRobertaForQuestionAnswering"),qu=h(),_t=a("div"),v(Ei.$$.fragment),wT=h(),fn=a("p"),TT=n(`RoBERTa Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),AT=h(),v(Qs.$$.fragment),OT=h(),qt=a("div"),v(Ci.$$.fragment),NT=h(),gn=a("p"),IT=n("The "),Hd=a("a"),DT=n("TFRobertaForQuestionAnswering"),ST=n(" forward method, overrides the "),Xp=a("code"),WT=n("__call__"),BT=n(" special method."),UT=h(),v(Ks.$$.fragment),HT=h(),v(Js.$$.fragment),QT=h(),v(Vs.$$.fragment),Pu=h(),_n=a("h2"),Gs=a("a"),Yp=a("span"),v(qi.$$.fragment),KT=h(),Zp=a("span"),JT=n("FlaxRobertaModel"),Lu=h(),nt=a("div"),v(Pi.$$.fragment),VT=h(),eh=a("p"),GT=n("The bare RoBERTa Model transformer outputting raw hidden-states without any specific head on top."),XT=h(),Li=a("p"),YT=n("This model inherits from "),Qd=a("a"),ZT=n("FlaxPreTrainedModel"),e$=n(`. Check the superclass documentation for the generic methods the
...
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),T2=h(),Sh=a("p"),$2=n("Finally, this model supports inherent JAX features such as:"),F2=h(),fo=a("ul"),Wh=a("li"),Fl=a("a"),x2=n("Just-In-Time (JIT) compilation"),R2=h(),Bh=a("li"),xl=a("a"),E2=n("Automatic Differentiation"),M2=h(),Uh=a("li"),Rl=a("a"),z2=n("Vectorization"),j2=h(),Hh=a("li"),El=a("a"),C2=n("Parallelization"),q2=h(),eo=a("div"),v(Ml.$$.fragment),P2=h(),xn=a("p"),L2=n("The "),Qh=a("code"),A2=n("FlaxRobertaPreTrainedModel"),O2=n(" forward method, overrides the "),Kh=a("code"),N2=n("__call__"),I2=n(" special method."),D2=h(),v(da.$$.fragment),S2=h(),v(ca.$$.fragment),Uu=h(),Rn=a("h2"),pa=a("a"),Jh=a("span"),v(zl.$$.fragment),W2=h(),Vh=a("span"),B2=n("FlaxRobertaForTokenClassification"),Hu=h(),lt=a("div"),v(jl.$$.fragment),U2=h(),Gh=a("p"),H2=n(`Roberta Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g. for
...
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),jF=h(),Bl=a("p"),CF=n("This model is also a Flax Linen "),Ul=a("a"),qF=n("flax.linen.Module"),PF=n(`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),LF=h(),lm=a("p"),AF=n("Finally, this model supports inherent JAX features such as:"),OF=h(),_o=a("ul"),dm=a("li"),Hl=a("a"),NF=n("Just-In-Time (JIT) compilation"),IF=h(),cm=a("li"),Ql=a("a"),DF=n("Automatic Differentiation"),SF=h(),pm=a("li"),Kl=a("a"),WF=n("Vectorization"),BF=h(),hm=a("li"),Jl=a("a"),UF=n("Parallelization"),HF=h(),oo=a("div"),v(Vl.$$.fragment),QF=h(),jn=a("p"),KF=n("The "),mm=a("code"),JF=n("FlaxRobertaPreTrainedModel"),VF=n(" forward method, overrides the "),um=a("code"),GF=n("__call__"),XF=n(" special method."),YF=h(),v(fa.$$.fragment),ZF=h(),v(ga.$$.fragment),this.h()},l(o){const b=NM('[data-svelte="svelte-1phssyn"]',document.head);d=r(b,"META",{name:!0,content:!0}),b.forEach(t),g=m(o),c=r(o,"H1",{class:!0});var Gl=i(c);u=r(Gl,"A",{id:!0,class:!0,href:!0});var fm=i(u);_=r(fm,"SPAN",{});var gm=i(_);w(l.$$.fragment,gm),gm.forEach(t),fm.forEach(t),p=m(Gl),E=r(Gl,"SPAN",{});var _m=i(E);le=s(_m,"RoBERTa"),_m.forEach(t),Gl.forEach(t),Z=m(o),N=r(o,"H2",{class:!0});var Xl=i(N);te=r(Xl,"A",{id:!0,class:!0,href:!0});var bm=i(te);oe=r(bm,"SPAN",{});var km=i(oe);w(M.$$.fragment,km),km.forEach(t),bm.forEach(t),we=m(Xl),K=r(Xl,"SPAN",{});var ym=i(K);Te=s(ym,"Overview"),ym.forEach(t),Xl.forEach(t),ge=m(o),W=r(o,"P",{});var Yl=i(W);$e=s(Yl,"The RoBERTa model was proposed in "),pe=r(Yl,"A",{href:!0,rel:!0});var vm=i(pe);J=s(vm,"RoBERTa: A Robustly Optimized BERT Pretraining Approach"),vm.forEach(t),Fe=s(Yl,` by Yinhan Liu, Myle Ott, Naman Goyal, Jingfei Du, Mandar Joshi, Danqi Chen, Omer
...
documentation from `),cd=r(qn,"A",{href:!0});var Wm=i(cd);xg=s(Wm,"PretrainedConfig"),Wm.forEach(t),Rg=s(qn," for more information."),qn.forEach(t),Eg=m(Bt),Ao=r(Bt,"P",{});var Pn=i(Ao);Mg=s(Pn,"The "),pd=r(Pn,"A",{href:!0});var Bm=i(pd);zg=s(Bm,"RobertaConfig"),Bm.forEach(t),jg=s(Pn," class directly inherits "),hd=r(Pn,"A",{href:!0});var Um=i(hd);Cg=s(Um,"BertConfig"),Um.forEach(t),qg=s(Pn,`. It reuses the same defaults. Please check the parent
class for more information.`),Pn.forEach(t),Pg=m(Bt),w(An.$$.fragment,Bt),Bt.forEach(t),ou=m(o),Oo=r(o,"H2",{class:!0});var td=i(Oo);On=r(td,"A",{id:!0,class:!0,href:!0});var Hm=i(On);xc=r(Hm,"SPAN",{});var Qm=i(xc);w(Ia.$$.fragment,Qm),Qm.forEach(t),Hm.forEach(t),Lg=m(td),Rc=r(td,"SPAN",{});var Km=i(Rc);Ag=s(Km,"RobertaTokenizer"),Km.forEach(t),td.forEach(t),nu=m(o),Ie=r(o,"DIV",{class:!0});var Ue=i(Ie);w(Da.$$.fragment,Ue),Og=m(Ue),Ec=r(Ue,"P",{});var Jm=i(Ec);Ng=s(Jm,"Constructs a RoBERTa tokenizer, derived from the GPT-2 tokenizer, using byte-level Byte-Pair-Encoding."),Jm.forEach(t),Ig=m(Ue),Mc=r(Ue,"P",{});var Vm=i(Mc);Dg=s(Vm,"This tokenizer has been trained to treat spaces like parts of the tokens (a bit like sentencepiece) so a word will"),Vm.forEach(t),Sg=m(Ue),w(Nn.$$.fragment,Ue),Wg=m(Ue),Sa=r(Ue,"P",{});var od=i(Sa);Bg=s(od,"You can get around that behavior by passing "),zc=r(od,"CODE",{});var Gm=i(zc);Ug=s(Gm,"add_prefix_space=True"),Gm.forEach(t),Hg=s(od,` when instantiating this tokenizer or when you
call it on some text, but since the model was not pretrained this way, it might yield a decrease in performance.`),od.forEach(t),Qg=m(Ue),w(In.$$.fragment,Ue),Kg=m(Ue),Wa=r(Ue,"P",{});var nd=i(Wa);Jg=s(nd,"This tokenizer inherits from "),md=r(nd,"A",{href:!0});var Xm=i(md);Vg=s(Xm,"PreTrainedTokenizer"),Xm.forEach(t),Gg=s(nd,` which contains most of the main methods. Users should refer to
this superclass for more information regarding those methods.`),nd.forEach(t),Xg=m(Ue),vo=r(Ue,"DIV",{class:!0});var Ln=i(vo);w(Ba.$$.fragment,Ln),Yg=m(Ln),jc=r(Ln,"P",{});var Ym=i(jc);Zg=s(Ym,`Build model inputs from a sequence or a pair of sequence for sequence classification tasks by concatenating and
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),qf.forEach(t),Vv=m(so),w(Rs.$$.fragment,so),Gv=m(so),zt=r(so,"DIV",{class:!0});var jo=i(zt);w(li.$$.fragment,jo),Xv=m(jo),rn=r(jo,"P",{});var hc=i(rn);Yv=s(hc,"The "),Od=r(hc,"A",{href:!0});var Wx=i(Od);Zv=s(Wx,"TFRobertaForMaskedLM"),Wx.forEach(t),ew=s(hc," forward method, overrides the "),Pp=r(hc,"CODE",{});var Bx=i(Pp);tw=s(Bx,"__call__"),Bx.forEach(t),ow=s(hc," special method."),hc.forEach(t),nw=m(jo),w(Es.$$.fragment,jo),sw=m(jo),w(Ms.$$.fragment,jo),aw=m(jo),w(zs.$$.fragment,jo),jo.forEach(t),so.forEach(t),xu=m(o),ln=r(o,"H2",{class:!0});var Pf=i(ln);js=r(Pf,"A",{id:!0,class:!0,href:!0});var Ux=i(js);Lp=r(Ux,"SPAN",{});var Hx=i(Lp);w(di.$$.fragment,Hx),Hx.forEach(t),Ux.forEach(t),rw=m(Pf),Ap=r(Pf,"SPAN",{});var Qx=i(Ap);iw=s(Qx,"TFRobertaForSequenceClassification"),Qx.forEach(t),Pf.forEach(t),Ru=m(o),ut=r(o,"DIV",{class:!0});var ao=i(ut);w(ci.$$.fragment,ao),lw=m(ao),Op=r(ao,"P",{});var Kx=i(Op);dw=s(Kx,`RoBERTa Model transformer with a sequence classification/regression head on top (a linear layer on top of the
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),If.forEach(t),Sw=m(ro),w(Os.$$.fragment,ro),Ww=m(ro),Vt=r(ro,"DIV",{class:!0});var wa=i(Vt);w(yi.$$.fragment,wa),Bw=m(wa),pn=r(wa,"P",{});var uc=i(pn);Uw=s(uc,"The "),Sd=r(uc,"A",{href:!0});var sR=i(Sd);Hw=s(sR,"TFRobertaForMultipleChoice"),sR.forEach(t),Qw=s(uc," forward method, overrides the "),Wp=r(uc,"CODE",{});var aR=i(Wp);Kw=s(aR,"__call__"),aR.forEach(t),Jw=s(uc," special method."),uc.forEach(t),Vw=m(wa),w(Ns.$$.fragment,wa),Gw=m(wa),w(Is.$$.fragment,wa),wa.forEach(t),ro.forEach(t),zu=m(o),hn=r(o,"H2",{class:!0});var Df=i(hn);Ds=r(Df,"A",{id:!0,class:!0,href:!0});var rR=i(Ds);Bp=r(rR,"SPAN",{});var iR=i(Bp);w(vi.$$.fragment,iR),iR.forEach(t),rR.forEach(t),Xw=m(Df),Up=r(Df,"SPAN",{});var lR=i(Up);Yw=s(lR,"TFRobertaForTokenClassification"),lR.forEach(t),Df.forEach(t),ju=m(o),gt=r(o,"DIV",{class:!0});var io=i(gt);w(wi.$$.fragment,io),Zw=m(io),Hp=r(io,"P",{});var dR=i(Hp);eT=s(dR,`RoBERTa Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g. for
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Wf.forEach(t),dT=m(io),w(Ss.$$.fragment,io),cT=m(io),Ct=r(io,"DIV",{class:!0});var qo=i(Ct);w(xi.$$.fragment,qo),pT=m(qo),mn=r(qo,"P",{});var fc=i(mn);hT=s(fc,"The "),Bd=r(fc,"A",{href:!0});var hR=i(Bd);mT=s(hR,"TFRobertaForTokenClassification"),hR.forEach(t),uT=s(fc," forward method, overrides the "),Qp=r(fc,"CODE",{});var mR=i(Qp);fT=s(mR,"__call__"),mR.forEach(t),gT=s(fc," special method."),fc.forEach(t),_T=m(qo),w(Ws.$$.fragment,qo),bT=m(qo),w(Bs.$$.fragment,qo),kT=m(qo),w(Us.$$.fragment,qo),qo.forEach(t),io.forEach(t),Cu=m(o),un=r(o,"H2",{class:!0});var Bf=i(un);Hs=r(Bf,"A",{id:!0,class:!0,href:!0});var uR=i(Hs);Kp=r(uR,"SPAN",{});var fR=i(Kp);w(Ri.$$.fragment,fR),fR.forEach(t),uR.forEach(t),yT=m(Bf),Jp=r(Bf,"SPAN",{});var gR=i(Jp);vT=s(gR,"TFRobertaForQuestionAnswering"),gR.forEach(t),Bf.forEach(t),qu=m(o),_t=r(o,"DIV",{class:!0});var lo=i(_t);w(Ei.$$.fragment,lo),wT=m(lo),fn=r(lo,"P",{});var gc=i(fn);TT=s(gc,`RoBERTa Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
...
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),Jf.forEach(t),a$=m(At),th=r(At,"P",{});var MR=i(th);r$=s(MR,"Finally, this model supports inherent JAX features such as:"),MR.forEach(t),i$=m(At),po=r(At,"UL",{});var Ta=i(po);oh=r(Ta,"LI",{});var zR=i(oh);Ni=r(zR,"A",{href:!0,rel:!0});var jR=i(Ni);l$=s(jR,"Just-In-Time (JIT) compilation"),jR.forEach(t),zR.forEach(t),d$=m(Ta),nh=r(Ta,"LI",{});var CR=i(nh);Ii=r(CR,"A",{href:!0,rel:!0});var qR=i(Ii);c$=s(qR,"Automatic Differentiation"),qR.forEach(t),CR.forEach(t),p$=m(Ta),sh=r(Ta,"LI",{});var PR=i(sh);Di=r(PR,"A",{href:!0,rel:!0});var LR=i(Di);h$=s(LR,"Vectorization"),LR.forEach(t),PR.forEach(t),m$=m(Ta),ah=r(Ta,"LI",{});var AR=i(ah);Si=r(AR,"A",{href:!0,rel:!0});var OR=i(Si);u$=s(OR,"Parallelization"),OR.forEach(t),AR.forEach(t),Ta.forEach(t),f$=m(At),Gt=r(At,"DIV",{class:!0});var $a=i(Gt);w(Wi.$$.fragment,$a),g$=m($a),bn=r($a,"P",{});var bc=i(bn);_$=s(bc,"The "),rh=r(bc,"CODE",{});var NR=i(rh);b$=s(NR,"FlaxRobertaPreTrainedModel"),NR.forEach(t),k$=s(bc," forward method, overrides the "),ih=r(bc,"CODE",{});var IR=i(ih);y$=s(IR,"__call__"),IR.forEach(t),v$=s(bc," special method."),bc.forEach(t),w$=m($a),w(Xs.$$.fragment,$a),T$=m($a),w(Ys.$$.fragment,$a),$a.forEach(t),At.forEach(t),Au=m(o),kn=r(o,"H2",{class:!0});var Vf=i(kn);Zs=r(Vf,"A",{id:!0,class:!0,href:!0});var DR=i(Zs);lh=r(DR,"SPAN",{});var SR=i(lh);w(Bi.$$.fragment,SR),SR.forEach(t),DR.forEach(t),$$=m(Vf),dh=r(Vf,"SPAN",{});var WR=i(dh);F$=s(WR,"FlaxRobertaForCausalLM"),WR.forEach(t),Vf.forEach(t),Ou=m(o),st=r(o,"DIV",{class:!0});var Ot=i(st);w(Ui.$$.fragment,Ot),x$=m(Ot),ch=r(Ot,"P",{});var BR=i(ch);R$=s(BR,`Roberta Model with a language modeling head on top (a linear layer on top of the hidden-states output) e.g for
autoregressive tasks.`),BR.forEach(t),E$=m(Ot),Hi=r(Ot,"P",{});var Gf=i(Hi);M$=s(Gf,"This model inherits from "),Kd=r(Gf,"A",{href:!0});var UR=i(Kd);z$=s(UR,"FlaxPreTrainedModel"),UR.forEach(t),j$=s(Gf,`. Check the superclass documentation for the generic methods the
