...
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),Qu.forEach(t),u1=h(bt),dh=s(bt,"P",{});var dM=a(dh);g1=i(dM,"Finally, this model supports inherent JAX features such as:"),dM.forEach(t),_1=h(bt),Qt=s(bt,"UL",{});var ca=a(Qt);ch=s(ca,"LI",{});var cM=a(ch);Hi=s(cM,"A",{href:!0,rel:!0});var pM=a(Hi);b1=i(pM,"Just-In-Time (JIT) compilation"),pM.forEach(t),cM.forEach(t),k1=h(ca),ph=s(ca,"LI",{});var hM=a(ph);Qi=s(hM,"A",{href:!0,rel:!0});var mM=a(Qi);v1=i(mM,"Automatic Differentiation"),mM.forEach(t),hM.forEach(t),T1=h(ca),hh=s(ca,"LI",{});var fM=a(hh);Vi=s(fM,"A",{href:!0,rel:!0});var uM=a(Vi);y1=i(uM,"Vectorization"),uM.forEach(t),fM.forEach(t),w1=h(ca),mh=s(ca,"LI",{});var gM=a(mh);Ji=s(gM,"A",{href:!0,rel:!0});var _M=a(Ji);$1=i(_M,"Parallelization"),_M.forEach(t),gM.forEach(t),ca.forEach(t),F1=h(bt),qt=s(bt,"DIV",{class:!0});var pa=a(qt);y(Ki.$$.fragment,pa),x1=h(pa),nn=s(pa,"P",{});var rc=a(nn);R1=i(rc,"The "),fh=s(rc,"CODE",{});var bM=a(fh);M1=i(bM,"FlaxRobertaPreTrainedModel"),bM.forEach(t),E1=i(rc," forward method, overrides the "),uh=s(rc,"CODE",{});var kM=a(uh);z1=i(kM,"__call__"),kM.forEach(t),C1=i(rc," special method."),rc.forEach(t),q1=h(pa),y(Ds.$$.fragment,pa),j1=h(pa),y(Ss.$$.fragment,pa),pa.forEach(t),bt.forEach(t),qf=h(o),sn=s(o,"H2",{class:!0});var Vu=a(sn);Ws=s(Vu,"A",{id:!0,class:!0,href:!0});var vM=a(Ws);gh=s(vM,"SPAN",{});var TM=a(gh);y(Gi.$$.fragment,TM),TM.forEach(t),vM.forEach(t),P1=h(Vu),_h=s(Vu,"SPAN",{});var yM=a(_h);L1=i(yM,"FlaxRobertaForSequenceClassification"),yM.forEach(t),Vu.forEach(t),jf=h(o),De=s(o,"DIV",{class:!0});var kt=a(De);y(Xi.$$.fragment,kt),A1=h(kt),bh=s(kt,"P",{});var wM=a(bh);O1=i(wM,`Roberta Model transformer with a sequence classification/regression head on top (a linear layer on top of the
