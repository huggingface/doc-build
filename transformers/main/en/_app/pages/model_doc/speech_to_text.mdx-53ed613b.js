...
methods above for more information.`),F.forEach(t),this.h()},h(){c(_,"href","/docs/transformers/main/en/main_classes/feature_extractor#transformers.FeatureExtractionMixin.from_pretrained")},m(A,F){f(A,h,F),e(h,b),e(h,_),e(_,m),e(h,v),e(h,d),e(d,g),e(h,E)},d(A){A&&t(h)}}}function th(C){let h,b,_,m,v,d,g,E;return{c(){h=a("p"),b=n("This class method is simply calling "),_=a("a"),m=n("save_pretrained()"),v=n(` and
...
[<span class="hljs-number">1</span>, <span class="hljs-number">2</span>, <span class="hljs-number">256</span>]`}}),{c(){h=a("p"),b=n("Example:"),_=l(),x(m.$$.fragment)},l(d){h=r(d,"P",{});var g=i(h);b=s(g,"Example:"),g.forEach(t),_=p(d),k(m.$$.fragment,d)},m(d,g){f(d,h,g),e(h,b),f(d,_,g),y(m,d,g),v=!0},p:Zs,i(d){v||(w(m.$$.fragment,d),v=!0)},o(d){S(m.$$.fragment,d),v=!1},d(d){d&&t(h),d&&t(_),$(m,d)}}}function sh(C){let h,b,_,m,v;return{c(){h=a("p"),b=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),_=a("code"),m=n("Module"),v=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(d){h=r(d,"P",{});var g=i(h);b=s(g,"Although the recipe for forward pass needs to be defined within this function, one should call the "),_=r(g,"CODE",{});var E=i(_);m=s(E,"Module"),E.forEach(t),v=s(g,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),g.forEach(t)},m(d,g){f(d,h,g),e(h,b),e(h,_),e(_,m),e(h,v)},d(d){d&&t(h)}}}function ah(C){let h,b,_,m,v;return m=new ln({props:{code:`import torch
...
<span class="hljs-string">&#x27;mister quilter is the apostle of the middle classes and we are glad to welcome his gospel&#x27;</span>`}}),{c(){h=a("p"),b=n("Example:"),_=l(),x(m.$$.fragment)},l(d){h=r(d,"P",{});var g=i(h);b=s(g,"Example:"),g.forEach(t),_=p(d),k(m.$$.fragment,d)},m(d,g){f(d,h,g),e(h,b),f(d,_,g),y(m,d,g),v=!0},p:Zs,i(d){v||(w(m.$$.fragment,d),v=!0)},o(d){S(m.$$.fragment,d),v=!1},d(d){d&&t(h),d&&t(_),$(m,d)}}}function rh(C){let h,b,_,m,v,d,g,E,A,F,q,L,H,ee,Ce,B,Pe,ye,N,K,te,Te,j,M,je,oe,ne,Me,se,ae,Ne,G,we,O,Ae,re,ie,De,de,J,Ie,Z,Y;return{c(){h=a("p"),b=n("TF 2.0 models accepts two formats as inputs:"),_=l(),m=a("ul"),v=a("li"),d=n("having all inputs as keyword arguments (like PyTorch models), or"),g=l(),E=a("li"),A=n("having all inputs as a list, tuple or dict in the first positional arguments."),F=l(),q=a("p"),L=n("This second option is useful when using "),H=a("code"),ee=n("tf.keras.Model.fit"),Ce=n(` method which currently requires having all the
tensors in the first argument of the model call function: `),B=a("code"),Pe=n("model(inputs)"),ye=n("."),N=l(),K=a("p"),te=n(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
...
tensors in the first argument of the model call function: `),B=r(Q,"CODE",{});var ue=i(B);Pe=s(ue,"model(inputs)"),ue.forEach(t),ye=s(Q,"."),Q.forEach(t),N=p(T),K=r(T,"P",{});var et=i(K);te=s(et,`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),et.forEach(t),Te=p(T),j=r(T,"UL",{});var U=i(j);M=r(U,"LI",{});var ce=i(M);je=s(ce,"a single Tensor with "),oe=r(ce,"CODE",{});var tt=i(oe);ne=s(tt,"input_ids"),tt.forEach(t),Me=s(ce," only and nothing else: "),se=r(ce,"CODE",{});var Re=i(se);ae=s(Re,"model(input_ids)"),Re.forEach(t),ce.forEach(t),Ne=p(U),G=r(U,"LI",{});var P=i(G);we=s(P,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),O=r(P,"CODE",{});var ot=i(O);Ae=s(ot,"model([input_ids, attention_mask])"),ot.forEach(t),re=s(P," or "),ie=r(P,"CODE",{});var Se=i(ie);De=s(Se,"model([input_ids, attention_mask, token_type_ids])"),Se.forEach(t),P.forEach(t),de=p(U),J=r(U,"LI",{});var Oe=i(J);Ie=s(Oe,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),Z=r(Oe,"CODE",{});var nt=i(Z);Y=s(nt,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),nt.forEach(t),Oe.forEach(t),U.forEach(t)},m(T,z){f(T,h,z),e(h,b),f(T,_,z),f(T,m,z),e(m,v),e(v,d),e(m,g),e(m,E),e(E,A),f(T,F,z),f(T,q,z),e(q,L),e(q,H),e(H,ee),e(q,Ce),e(q,B),e(B,Pe),e(q,ye),f(T,N,z),f(T,K,z),e(K,te),f(T,Te,z),f(T,j,z),e(j,M),e(M,je),e(M,oe),e(oe,ne),e(M,Me),e(M,se),e(se,ae),e(j,Ne),e(j,G),e(G,we),e(G,O),e(O,Ae),e(G,re),e(G,ie),e(ie,De),e(j,de),e(j,J),e(J,Ie),e(J,Z),e(Z,Y)},d(T){T&&t(h),T&&t(_),T&&t(m),T&&t(F),T&&t(q),T&&t(N),T&&t(K),T&&t(Te),T&&t(j)}}}function ih(C){let h,b,_,m,v;return{c(){h=a("p"),b=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),_=a("code"),m=n("Module"),v=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(d){h=r(d,"P",{});var g=i(h);b=s(g,"Although the recipe for forward pass needs to be defined within this function, one should call the "),_=r(g,"CODE",{});var E=i(_);m=s(E,"Module"),E.forEach(t),v=s(g,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),{c(){h=a("p"),b=n("Example:"),_=l(),x(m.$$.fragment)},l(d){h=r(d,"P",{});var g=i(h);b=s(g,"Example:"),g.forEach(t),_=p(d),k(m.$$.fragment,d)},m(d,g){f(d,h,g),e(h,b),f(d,_,g),y(m,d,g),v=!0},p:Zs,i(d){v||(w(m.$$.fragment,d),v=!0)},o(d){S(m.$$.fragment,d),v=!1},d(d){d&&t(h),d&&t(_),$(m,d)}}}function ch(C){let h,b,_,m,v,d,g,E,A,F,q,L,H,ee,Ce,B,Pe,ye,N,K,te,Te,j,M,je,oe,ne,Me,se,ae,Ne,G,we,O,Ae,re,ie,De,de,J,Ie,Z,Y;return{c(){h=a("p"),b=n("TF 2.0 models accepts two formats as inputs:"),_=l(),m=a("ul"),v=a("li"),d=n("having all inputs as keyword arguments (like PyTorch models), or"),g=l(),E=a("li"),A=n("having all inputs as a list, tuple or dict in the first positional arguments."),F=l(),q=a("p"),L=n("This second option is useful when using "),H=a("code"),ee=n("tf.keras.Model.fit"),Ce=n(` method which currently requires having all the
tensors in the first argument of the model call function: `),B=a("code"),Pe=n("model(inputs)"),ye=n("."),N=l(),K=a("p"),te=n(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),Te=l(),j=a("ul"),M=a("li"),je=n("a single Tensor with "),oe=a("code"),ne=n("input_ids"),Me=n(" only and nothing else: "),se=a("code"),ae=n("model(input_ids)"),Ne=l(),G=a("li"),we=n(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),O=a("code"),Ae=n("model([input_ids, attention_mask])"),re=n(" or "),ie=a("code"),De=n("model([input_ids, attention_mask, token_type_ids])"),de=l(),J=a("li"),Ie=n(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),Z=a("code"),Y=n('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(T){h=r(T,"P",{});var z=i(h);b=s(z,"TF 2.0 models accepts two formats as inputs:"),z.forEach(t),_=p(T),m=r(T,"UL",{});var X=i(m);v=r(X,"LI",{});var Ze=i(v);d=s(Ze,"having all inputs as keyword arguments (like PyTorch models), or"),Ze.forEach(t),g=p(X),E=r(X,"LI",{});var Le=i(E);A=s(Le,"having all inputs as a list, tuple or dict in the first positional arguments."),Le.forEach(t),X.forEach(t),F=p(T),q=r(T,"P",{});var Q=i(q);L=s(Q,"This second option is useful when using "),H=r(Q,"CODE",{});var Ve=i(H);ee=s(Ve,"tf.keras.Model.fit"),Ve.forEach(t),Ce=s(Q,` method which currently requires having all the
...
first positional argument :`),et.forEach(t),Te=p(T),j=r(T,"UL",{});var U=i(j);M=r(U,"LI",{});var ce=i(M);je=s(ce,"a single Tensor with "),oe=r(ce,"CODE",{});var tt=i(oe);ne=s(tt,"input_ids"),tt.forEach(t),Me=s(ce," only and nothing else: "),se=r(ce,"CODE",{});var Re=i(se);ae=s(Re,"model(input_ids)"),Re.forEach(t),ce.forEach(t),Ne=p(U),G=r(U,"LI",{});var P=i(G);we=s(P,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),O=r(P,"CODE",{});var ot=i(O);Ae=s(ot,"model([input_ids, attention_mask])"),ot.forEach(t),re=s(P," or "),ie=r(P,"CODE",{});var Se=i(ie);De=s(Se,"model([input_ids, attention_mask, token_type_ids])"),Se.forEach(t),P.forEach(t),de=p(U),J=r(U,"LI",{});var Oe=i(J);Ie=s(Oe,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),Z=r(Oe,"CODE",{});var nt=i(Z);Y=s(nt,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),nt.forEach(t),Oe.forEach(t),U.forEach(t)},m(T,z){f(T,h,z),e(h,b),f(T,_,z),f(T,m,z),e(m,v),e(v,d),e(m,g),e(m,E),e(E,A),f(T,F,z),f(T,q,z),e(q,L),e(q,H),e(H,ee),e(q,Ce),e(q,B),e(B,Pe),e(q,ye),f(T,N,z),f(T,K,z),e(K,te),f(T,Te,z),f(T,j,z),e(j,M),e(M,je),e(M,oe),e(oe,ne),e(M,Me),e(M,se),e(se,ae),e(j,Ne),e(j,G),e(G,we),e(G,O),e(O,Ae),e(G,re),e(G,ie),e(ie,De),e(j,de),e(j,J),e(J,Ie),e(J,Z),e(Z,Y)},d(T){T&&t(h),T&&t(_),T&&t(m),T&&t(F),T&&t(q),T&&t(N),T&&t(K),T&&t(Te),T&&t(j)}}}function lh(C){let h,b,_,m,v;return{c(){h=a("p"),b=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),_=a("code"),m=n("Module"),v=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(d){h=r(d,"P",{});var g=i(h);b=s(g,"Although the recipe for forward pass needs to be defined within this function, one should call the "),_=r(g,"CODE",{});var E=i(_);m=s(E,"Module"),E.forEach(t),v=s(g,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
<span class="hljs-meta">&gt;&gt;&gt; </span>transcription = processor.batch_decode(generated_ids)`}}),{c(){h=a("p"),b=n("Example:"),_=l(),x(m.$$.fragment)},l(d){h=r(d,"P",{});var g=i(h);b=s(g,"Example:"),g.forEach(t),_=p(d),k(m.$$.fragment,d)},m(d,g){f(d,h,g),e(h,b),f(d,_,g),y(m,d,g),v=!0},p:Zs,i(d){v||(w(m.$$.fragment,d),v=!0)},o(d){S(m.$$.fragment,d),v=!1},d(d){d&&t(h),d&&t(_),$(m,d)}}}function hh(C){let h,b,_,m,v,d,g,E,A,F,q,L,H,ee,Ce,B,Pe,ye,N,K,te,Te,j,M,je,oe,ne,Me,se,ae,Ne,G,we,O,Ae,re,ie,De,de,J,Ie,Z,Y,T,z,X,Ze,Le,Q,Ve,ue,et,U,ce,tt,Re,P,ot,Se,Oe,nt,pn,or,nr,hn,sr,ar,mn,rr,ir,ea,W,dr,Yn,cr,lr,Xn,pr,hr,Qn,mr,fr,Zn,ur,_r,es,gr,Tr,oo,vr,br,ts,xr,ta,fn,os,kr,oa,no,na,un,so,ns,yr,wr,le,Sr,ss,$r,Er,as,qr,Fr,rs,zr,Cr,is,Pr,jr,ds,Mr,Nr,sa,ao,aa,Tt,Ar,ro,Dr,Ir,ra,st,vt,cs,io,Lr,ls,Or,ia,ve,co,Gr,at,Ur,_n,Wr,Vr,lo,Rr,Hr,Br,rt,Kr,gn,Jr,Yr,Tn,Xr,Qr,Zr,bt,da,it,xt,ps,po,ei,hs,ti,ca,V,ho,oi,ms,ni,si,mo,ai,vn,ri,ii,di,kt,fo,ci,fs,li,pi,yt,uo,hi,_o,mi,us,fi,ui,_i,He,go,gi,bn,Ti,xn,vi,bi,_s,xi,ki,kn,To,la,dt,wt,gs,vo,yi,Ts,wi,pa,pe,bo,Si,vs,$i,Ei,xo,qi,yn,Fi,zi,Ci,bs,Pi,ji,St,ko,Mi,xs,Ni,ha,ct,$t,ks,yo,Ai,ys,Di,ma,D,wo,Ii,ws,Li,Oi,_e,wn,Gi,Ui,Sn,Wi,Vi,$n,Ri,Hi,So,Ss,Bi,Ki,Ji,En,Yi,Xi,Qi,Et,$o,Zi,Ge,ed,Eo,$s,td,od,nd,qn,sd,ad,qo,Es,rd,id,dd,cd,Be,Fo,ld,qs,pd,hd,qt,md,Ke,zo,fd,Co,ud,Fn,_d,gd,Td,Ft,vd,zt,Po,bd,jo,xd,zn,kd,yd,wd,Ct,Mo,Sd,No,$d,Cn,Ed,qd,Fd,Pt,Ao,zd,Fs,Cd,fa,lt,jt,zs,Do,Pd,Cs,jd,ua,be,Io,Md,Lo,Nd,Pn,Ad,Dd,Id,Oo,Ld,Go,Od,Gd,Ud,$e,Uo,Wd,pt,Vd,jn,Rd,Hd,Ps,Bd,Kd,Jd,Mt,Yd,Nt,_a,ht,At,js,Wo,Xd,Ms,Qd,ga,xe,Vo,Zd,Ro,ec,Mn,tc,oc,nc,Ho,sc,Bo,ac,rc,ic,Ee,Ko,dc,mt,cc,Nn,lc,pc,Ns,hc,mc,fc,Dt,uc,It,Ta,ft,Lt,As,Jo,_c,Ds,gc,va,he,Yo,Tc,Xo,vc,An,bc,xc,kc,Qo,yc,Zo,wc,Sc,$c,Ot,Ec,qe,en,qc,ut,Fc,Dn,zc,Cc,Is,Pc,jc,Mc,Gt,Nc,Ut,ba,_t,Wt,Ls,tn,Ac,Os,Dc,xa,me,on,Ic,nn,Lc,In,Oc,Gc,Uc,sn,Wc,an,Vc,Rc,Hc,Vt,Bc,Fe,rn,Kc,gt,Jc,Ln,Yc,Xc,Gs,Qc,Zc,el,Rt,tl,Ht,ka;return d=new We({}),ee=new We({}),X=new We({}),no=new ln({props:{code:`import torch
from transformers import Speech2TextProcessor, Speech2TextForConditionalGeneration
from datasets import load_dataset
...
only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vain/src/transformers/models/speech_to_text/modeling_speech_to_text.py#L1284",returnDescription:`
<p>A <a
  href="/docs/transformers/main/en/main_classes/output#transformers.modeling_outputs.Seq2SeqLMOutput"
>transformers.modeling_outputs.Seq2SeqLMOutput</a> or a tuple of
<code>torch.FloatTensor</code> (if <code>return_dict=False</code> is passed or when <code>config.return_dict=False</code>) comprising various
...
behaviors between training and evaluation).`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/vain/src/transformers/models/speech_to_text/modeling_tf_speech_to_text.py#L1240",returnDescription:`
<p>A <a
...
(masked), the loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vain/src/transformers/models/speech_to_text/modeling_tf_speech_to_text.py#L1333",returnDescription:`
<p>A <a
...
`}}),Rt=new to({props:{$$slots:{default:[lh]},$$scope:{ctx:C}}}),Ht=new Qs({props:{anchor:"transformers.TFSpeech2TextForConditionalGeneration.call.example",$$slots:{default:[ph]},$$scope:{ctx:C}}}),{c(){h=a("meta"),b=l(),_=a("h1"),m=a("a"),v=a("span"),x(d.$$.fragment),g=l(),E=a("span"),A=n("Speech2Text"),F=l(),q=a("h2"),L=a("a"),H=a("span"),x(ee.$$.fragment),Ce=l(),B=a("span"),Pe=n("Overview"),ye=l(),N=a("p"),K=n("The Speech2Text model was proposed in "),te=a("a"),Te=n("fairseq S2T: Fast Speech-to-Text Modeling with fairseq"),j=n(` by Changhan Wang, Yun Tang, Xutai Ma, Anne Wu, Dmytro Okhonko, Juan Pino. It\u2019s a
transformer-based seq2seq (encoder-decoder) model designed for end-to-end Automatic Speech Recognition (ASR) and Speech
Translation (ST). It uses a convolutional downsampler to reduce the length of speech inputs by 3/4th before they are
fed into the encoder. The model is trained with standard autoregressive cross-entropy loss and generates the
transcripts/translations autoregressively. Speech2Text has been fine-tuned on several datasets for ASR and ST:
`),M=a("a"),je=n("LibriSpeech"),oe=n(", "),ne=a("a"),Me=n("CoVoST 2"),se=n(", "),ae=a("a"),Ne=n("MuST-C"),G=n("."),we=l(),O=a("p"),Ae=n("This model was contributed by "),re=a("a"),ie=n("valhalla"),De=n(". The original code can be found "),de=a("a"),J=n("here"),Ie=n("."),Z=l(),Y=a("h2"),T=a("a"),z=a("span"),x(X.$$.fragment),Ze=l(),Le=a("span"),Q=n("Inference"),Ve=l(),ue=a("p"),et=n(`Speech2Text is a speech model that accepts a float tensor of log-mel filter-bank features extracted from the speech
...
generated token, pass the `),rs=a("code"),zr=n("forced_bos_token_id"),Cr=n(" parameter to the "),is=a("code"),Pr=n("generate()"),jr=n(` method. The following
...
`),lo=a("a"),Rr=n("facebook/s2t-small-librispeech-asr"),Hr=n(" architecture."),Br=l(),rt=a("p"),Kr=n("Configuration objects inherit from "),gn=a("a"),Jr=n("PretrainedConfig"),Yr=n(` and can be used to control the model outputs. Read the
documentation from `),Tn=a("a"),Xr=n("PretrainedConfig"),Qr=n(" for more information."),Zr=l(),x(bt.$$.fragment),da=l(),it=a("h2"),xt=a("a"),ps=a("span"),x(po.$$.fragment),ei=l(),hs=a("span"),ti=n("Speech2TextTokenizer"),ca=l(),V=a("div"),x(ho.$$.fragment),oi=l(),ms=a("p"),ni=n("Construct an Speech2Text tokenizer."),si=l(),mo=a("p"),ai=n("This tokenizer inherits from "),vn=a("a"),ri=n("PreTrainedTokenizer"),ii=n(` which contains some of the main methods. Users should refer to
...
single processor.`),Oi=l(),_e=a("p"),wn=a("a"),Gi=n("Speech2TextProcessor"),Ui=n(" offers all the functionalities of "),Sn=a("a"),Wi=n("Speech2TextFeatureExtractor"),Vi=n(` and
`),$n=a("a"),Ri=n("Speech2TextTokenizer"),Hi=n(". See the "),So=a("a"),Ss=a("strong"),Bi=n("call"),Ki=n("()"),Ji=n(" and "),En=a("a"),Yi=n("decode()"),Xi=n(` for more
...
information.`),cd=l(),Be=a("div"),x(Fo.$$.fragment),ld=l(),qs=a("p"),pd=n("Instantiate a processor associated with a pretrained model."),hd=l(),x(qt.$$.fragment),md=l(),Ke=a("div"),x(zo.$$.fragment),fd=l(),Co=a("p"),ud=n(`Saves the attributes of this processor (feature extractor, tokenizer\u2026) in the specified directory so that it
can be reloaded using the `),Fn=a("a"),_d=n("from_pretrained()"),gd=n(" method."),Td=l(),x(Ft.$$.fragment),vd=l(),zt=a("div"),x(Po.$$.fragment),bd=l(),jo=a("p"),xd=n("This method forwards all its arguments to Speech2TextTokenizer\u2019s "),zn=a("a"),kd=n("batch_decode()"),yd=n(`. Please
refer to the docstring of this method for more information.`),wd=l(),Ct=a("div"),x(Mo.$$.fragment),Sd=l(),No=a("p"),$d=n("This method forwards all its arguments to Speech2TextTokenizer\u2019s "),Cn=a("a"),Ed=n("decode()"),qd=n(`. Please refer
to the docstring of this method for more information.`),Fd=l(),Pt=a("div"),x(Ao.$$.fragment),zd=l(),Fs=a("p"),Cd=n(`Temporarily sets the tokenizer for processing the input. Useful for encoding the labels when fine-tuning
Speech2Text.`),fa=l(),lt=a("h2"),jt=a("a"),zs=a("span"),x(Do.$$.fragment),Pd=l(),Cs=a("span"),jd=n("Speech2TextModel"),ua=l(),be=a("div"),x(Io.$$.fragment),Md=l(),Lo=a("p"),Nd=n(`The bare Speech2Text Model outputting raw hidden-states without any specific head on top.
This model inherits from `),Pn=a("a"),Ad=n("PreTrainedModel"),Dd=n(`. Check the superclass documentation for the generic methods the
...
and behavior.`),Ud=l(),$e=a("div"),x(Uo.$$.fragment),Wd=l(),pt=a("p"),Vd=n("The "),jn=a("a"),Rd=n("Speech2TextModel"),Hd=n(" forward method, overrides the "),Ps=a("code"),Bd=n("__call__"),Kd=n(" special method."),Jd=l(),x(Mt.$$.fragment),Yd=l(),x(Nt.$$.fragment),_a=l(),ht=a("h2"),At=a("a"),js=a("span"),x(Wo.$$.fragment),Xd=l(),Ms=a("span"),Qd=n("Speech2TextForConditionalGeneration"),ga=l(),xe=a("div"),x(Vo.$$.fragment),Zd=l(),Ro=a("p"),ec=n(`The Speech2Text Model with a language modeling head. Can be used for summarization.
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Uc=l(),sn=a("p"),Wc=n("This model is also a "),an=a("a"),Vc=n("tf.keras.Model"),Rc=n(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Hc=l(),x(Vt.$$.fragment),Bc=l(),Fe=a("div"),x(rn.$$.fragment),Kc=l(),gt=a("p"),Jc=n("The "),Ln=a("a"),Yc=n("TFSpeech2TextForConditionalGeneration"),Xc=n(" forward method, overrides the "),Gs=a("code"),Qc=n("__call__"),Zc=n(" special method."),el=l(),x(Rt.$$.fragment),tl=l(),x(Ht.$$.fragment),this.h()},l(o){const u=Xp('[data-svelte="svelte-1phssyn"]',document.head);h=r(u,"META",{name:!0,content:!0}),u.forEach(t),b=p(o),_=r(o,"H1",{class:!0});var dn=i(_);m=r(dn,"A",{id:!0,class:!0,href:!0});var Us=i(m);v=r(Us,"SPAN",{});var Ws=i(v);k(d.$$.fragment,Ws),Ws.forEach(t),Us.forEach(t),g=p(dn),E=r(dn,"SPAN",{});var Vs=i(E);A=s(Vs,"Speech2Text"),Vs.forEach(t),dn.forEach(t),F=p(o),q=r(o,"H2",{class:!0});var cn=i(q);L=r(cn,"A",{id:!0,class:!0,href:!0});var Rs=i(L);H=r(Rs,"SPAN",{});var Hs=i(H);k(ee.$$.fragment,Hs),Hs.forEach(t),Rs.forEach(t),Ce=p(cn),B=r(cn,"SPAN",{});var Bs=i(B);Pe=s(Bs,"Overview"),Bs.forEach(t),cn.forEach(t),ye=p(o),N=r(o,"P",{});var ke=i(N);K=s(ke,"The Speech2Text model was proposed in "),te=r(ke,"A",{href:!0,rel:!0});var Ks=i(te);Te=s(Ks,"fairseq S2T: Fast Speech-to-Text Modeling with fairseq"),Ks.forEach(t),j=s(ke,` by Changhan Wang, Yun Tang, Xutai Ma, Anne Wu, Dmytro Okhonko, Juan Pino. It\u2019s a
transformer-based seq2seq (encoder-decoder) model designed for end-to-end Automatic Speech Recognition (ASR) and Speech
Translation (ST). It uses a convolutional downsampler to reduce the length of speech inputs by 3/4th before they are
fed into the encoder. The model is trained with standard autoregressive cross-entropy loss and generates the
transcripts/translations autoregressively. Speech2Text has been fine-tuned on several datasets for ASR and ST:
`),M=r(ke,"A",{href:!0,rel:!0});var Js=i(M);je=s(Js,"LibriSpeech"),Js.forEach(t),oe=s(ke,", "),ne=r(ke,"A",{href:!0,rel:!0});var Ys=i(ne);Me=s(Ys,"CoVoST 2"),Ys.forEach(t),se=s(ke,", "),ae=r(ke,"A",{href:!0,rel:!0});var Xs=i(ae);Ne=s(Xs,"MuST-C"),Xs.forEach(t),G=s(ke,"."),ke.forEach(t),we=p(o),O=r(o,"P",{});var On=i(O);Ae=s(On,"This model was contributed by "),re=r(On,"A",{href:!0,rel:!0});var rl=i(re);ie=s(rl,"valhalla"),rl.forEach(t),De=s(On,". The original code can be found "),de=r(On,"A",{href:!0,rel:!0});var il=i(de);J=s(il,"here"),il.forEach(t),Ie=s(On,"."),On.forEach(t),Z=p(o),Y=r(o,"H2",{class:!0});var ya=i(Y);T=r(ya,"A",{id:!0,class:!0,href:!0});var dl=i(T);z=r(dl,"SPAN",{});var cl=i(z);k(X.$$.fragment,cl),cl.forEach(t),dl.forEach(t),Ze=p(ya),Le=r(ya,"SPAN",{});var ll=i(Le);Q=s(ll,"Inference"),ll.forEach(t),ya.forEach(t),Ve=p(o),ue=r(o,"P",{});var wa=i(ue);et=s(wa,`Speech2Text is a speech model that accepts a float tensor of log-mel filter-bank features extracted from the speech
signal. It\u2019s a transformer-based seq2seq model, so the transcripts/translations are generated autoregressively. The
`),U=r(wa,"CODE",{});var pl=i(U);ce=s(pl,"generate()"),pl.forEach(t),tt=s(wa," method can be used for inference."),wa.forEach(t),Re=p(o),P=r(o,"P",{});var Je=i(P);ot=s(Je,"The "),Se=r(Je,"A",{href:!0});var hl=i(Se);Oe=s(hl,"Speech2TextFeatureExtractor"),hl.forEach(t),nt=s(Je,` class is responsible for extracting the log-mel filter-bank
...
the target language id is forced as the first generated token. To force the target language id as the first
generated token, pass the `),rs=r(ze,"CODE",{});var Fl=i(rs);zr=s(Fl,"forced_bos_token_id"),Fl.forEach(t),Cr=s(ze," parameter to the "),is=r(ze,"CODE",{});var zl=i(is);Pr=s(zl,"generate()"),zl.forEach(t),jr=s(ze,` method. The following
example shows how to transate English speech to French text using the `),ds=r(ze,"EM",{});var Cl=i(ds);Mr=s(Cl,"facebook/s2t-medium-mustc-multilingual-st"),Cl.forEach(t),Nr=s(ze,`
checkpoint.`),ze.forEach(t),Sa.forEach(t),Sl.forEach(t),sa=p(o),k(ao.$$.fragment,o),aa=p(o),Tt=r(o,"P",{});var $a=i(Tt);Ar=s($a,"See the "),ro=r($a,"A",{href:!0,rel:!0});var Pl=i(ro);Dr=s(Pl,"model hub"),Pl.forEach(t),Ir=s($a," to look for Speech2Text checkpoints."),$a.forEach(t),ra=p(o),st=r(o,"H2",{class:!0});var Ea=i(st);vt=r(Ea,"A",{id:!0,class:!0,href:!0});var jl=i(vt);cs=r(jl,"SPAN",{});var Ml=i(cs);k(io.$$.fragment,Ml),Ml.forEach(t),jl.forEach(t),Lr=p(Ea),ls=r(Ea,"SPAN",{});var Nl=i(ls);Or=s(Nl,"Speech2TextConfig"),Nl.forEach(t),Ea.forEach(t),ia=p(o),ve=r(o,"DIV",{class:!0});var Bt=i(ve);k(co.$$.fragment,Bt),Gr=p(Bt),at=r(Bt,"P",{});var Gn=i(at);Ur=s(Gn,"This is the configuration class to store the configuration of a "),_n=r(Gn,"A",{href:!0});var Al=i(_n);Wr=s(Al,"Speech2TextModel"),Al.forEach(t),Vr=s(Gn,`. It is used to instantiate an
Speech2Text model according to the specified arguments, defining the model architecture. Instantiating a
configuration with the defaults will yield a similar configuration to that of the Speech2Text
...
mean and variance normalization to the extracted features.`),tp.forEach(t),ji=p(Ye),St=r(Ye,"DIV",{class:!0});var Na=i(St);k(ko.$$.fragment,Na),Mi=p(Na),xs=r(Na,"P",{});var op=i(xs);Ni=s(op,"Main method to featurize and prepare for the model one or several sequence(s). sequences."),op.forEach(t),Na.forEach(t),Ye.forEach(t),ha=p(o),ct=r(o,"H2",{class:!0});var Aa=i(ct);$t=r(Aa,"A",{id:!0,class:!0,href:!0});var np=i($t);ks=r(np,"SPAN",{});var sp=i(ks);k(yo.$$.fragment,sp),sp.forEach(t),np.forEach(t),Ai=p(Aa),ys=r(Aa,"SPAN",{});var ap=i(ys);Di=s(ap,"Speech2TextProcessor"),ap.forEach(t),Aa.forEach(t),ma=p(o),D=r(o,"DIV",{class:!0});var R=i(D);k(wo.$$.fragment,R),Ii=p(R),ws=r(R,"P",{});var rp=i(ws);Li=s(rp,`Constructs a Speech2Text processor which wraps a Speech2Text feature extractor and a Speech2Text tokenizer into a
single processor.`),rp.forEach(t),Oi=p(R),_e=r(R,"P",{});var Ue=i(_e);wn=r(Ue,"A",{href:!0});var ip=i(wn);Gi=s(ip,"Speech2TextProcessor"),ip.forEach(t),Ui=s(Ue," offers all the functionalities of "),Sn=r(Ue,"A",{href:!0});var dp=i(Sn);Wi=s(dp,"Speech2TextFeatureExtractor"),dp.forEach(t),Vi=s(Ue,` and
`),$n=r(Ue,"A",{href:!0});var cp=i($n);Ri=s(cp,"Speech2TextTokenizer"),cp.forEach(t),Hi=s(Ue,". See the "),So=r(Ue,"A",{href:!0});var nl=i(So);Ss=r(nl,"STRONG",{});var lp=i(Ss);Bi=s(lp,"call"),lp.forEach(t),Ki=s(nl,"()"),nl.forEach(t),Ji=s(Ue," and "),En=r(Ue,"A",{href:!0});var pp=i(En);Yi=s(pp,"decode()"),pp.forEach(t),Xi=s(Ue,` for more
information.`),Ue.forEach(t),Qi=p(R),Et=r(R,"DIV",{class:!0});var Da=i(Et);k($o.$$.fragment,Da),Zi=p(Da),Ge=r(Da,"P",{});var Kt=i(Ge);ed=s(Kt,`When used in normal mode, this method forwards all its arguments to Speech2TextFeatureExtractor\u2019s
...
information.`),Kt.forEach(t),Da.forEach(t),cd=p(R),Be=r(R,"DIV",{class:!0});var Vn=i(Be);k(Fo.$$.fragment,Vn),ld=p(Vn),qs=r(Vn,"P",{});var up=i(qs);pd=s(up,"Instantiate a processor associated with a pretrained model."),up.forEach(t),hd=p(Vn),k(qt.$$.fragment,Vn),Vn.forEach(t),md=p(R),Ke=r(R,"DIV",{class:!0});var Rn=i(Ke);k(zo.$$.fragment,Rn),fd=p(Rn),Co=r(Rn,"P",{});var Ia=i(Co);ud=s(Ia,`Saves the attributes of this processor (feature extractor, tokenizer\u2026) in the specified directory so that it
can be reloaded using the `),Fn=r(Ia,"A",{href:!0});var _p=i(Fn);_d=s(_p,"from_pretrained()"),_p.forEach(t),gd=s(Ia," method."),Ia.forEach(t),Td=p(Rn),k(Ft.$$.fragment,Rn),Rn.forEach(t),vd=p(R),zt=r(R,"DIV",{class:!0});var La=i(zt);k(Po.$$.fragment,La),bd=p(La),jo=r(La,"P",{});var Oa=i(jo);xd=s(Oa,"This method forwards all its arguments to Speech2TextTokenizer\u2019s "),zn=r(Oa,"A",{href:!0});var gp=i(zn);kd=s(gp,"batch_decode()"),gp.forEach(t),yd=s(Oa,`. Please
refer to the docstring of this method for more information.`),Oa.forEach(t),La.forEach(t),wd=p(R),Ct=r(R,"DIV",{class:!0});var Ga=i(Ct);k(Mo.$$.fragment,Ga),Sd=p(Ga),No=r(Ga,"P",{});var Ua=i(No);$d=s(Ua,"This method forwards all its arguments to Speech2TextTokenizer\u2019s "),Cn=r(Ua,"A",{href:!0});var Tp=i(Cn);Ed=s(Tp,"decode()"),Tp.forEach(t),qd=s(Ua,`. Please refer
to the docstring of this method for more information.`),Ua.forEach(t),Ga.forEach(t),Fd=p(R),Pt=r(R,"DIV",{class:!0});var Wa=i(Pt);k(Ao.$$.fragment,Wa),zd=p(Wa),Fs=r(Wa,"P",{});var vp=i(Fs);Cd=s(vp,`Temporarily sets the tokenizer for processing the input. Useful for encoding the labels when fine-tuning
Speech2Text.`),vp.forEach(t),Wa.forEach(t),R.forEach(t),fa=p(o),lt=r(o,"H2",{class:!0});var Va=i(lt);jt=r(Va,"A",{id:!0,class:!0,href:!0});var bp=i(jt);zs=r(bp,"SPAN",{});var xp=i(zs);k(Do.$$.fragment,xp),xp.forEach(t),bp.forEach(t),Pd=p(Va),Cs=r(Va,"SPAN",{});var kp=i(Cs);jd=s(kp,"Speech2TextModel"),kp.forEach(t),Va.forEach(t),ua=p(o),be=r(o,"DIV",{class:!0});var Jt=i(be);k(Io.$$.fragment,Jt),Md=p(Jt),Lo=r(Jt,"P",{});var Ra=i(Lo);Nd=s(Ra,`The bare Speech2Text Model outputting raw hidden-states without any specific head on top.
This model inherits from `),Pn=r(Ra,"A",{href:!0});var yp=i(Pn);Ad=s(yp,"PreTrainedModel"),yp.forEach(t),Dd=s(Ra,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Ra.forEach(t),Id=p(Jt),Oo=r(Jt,"P",{});var Ha=i(Oo);Ld=s(Ha,"This model is also a PyTorch "),Go=r(Ha,"A",{href:!0,rel:!0});var wp=i(Go);Od=s(wp,"torch.nn.Module"),wp.forEach(t),Gd=s(Ha,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Ha.forEach(t),Ud=p(Jt),$e=r(Jt,"DIV",{class:!0});var Yt=i($e);k(Uo.$$.fragment,Yt),Wd=p(Yt),pt=r(Yt,"P",{});var Hn=i(pt);Vd=s(Hn,"The "),jn=r(Hn,"A",{href:!0});var Sp=i(jn);Rd=s(Sp,"Speech2TextModel"),Sp.forEach(t),Hd=s(Hn," forward method, overrides the "),Ps=r(Hn,"CODE",{});var $p=i(Ps);Bd=s($p,"__call__"),$p.forEach(t),Kd=s(Hn," special method."),Hn.forEach(t),Jd=p(Yt),k(Mt.$$.fragment,Yt),Yd=p(Yt),k(Nt.$$.fragment,Yt),Yt.forEach(t),Jt.forEach(t),_a=p(o),ht=r(o,"H2",{class:!0});var Ba=i(ht);At=r(Ba,"A",{id:!0,class:!0,href:!0});var Ep=i(At);js=r(Ep,"SPAN",{});var qp=i(js);k(Wo.$$.fragment,qp),qp.forEach(t),Ep.forEach(t),Xd=p(Ba),Ms=r(Ba,"SPAN",{});var Fp=i(Ms);Qd=s(Fp,"Speech2TextForConditionalGeneration"),Fp.forEach(t),Ba.forEach(t),ga=p(o),xe=r(o,"DIV",{class:!0});var Xt=i(xe);k(Vo.$$.fragment,Xt),Zd=p(Xt),Ro=r(Xt,"P",{});var Ka=i(Ro);ec=s(Ka,`The Speech2Text Model with a language modeling head. Can be used for summarization.
