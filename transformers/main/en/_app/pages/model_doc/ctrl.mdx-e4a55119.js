...
`),G=r(ye,"CODE",{});var Ue=i(G);be=s(Ue,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),Ue.forEach(t),ye.forEach(t),D.forEach(t)},m(h,k){u(h,p,k),e(p,b),u(h,f,k),u(h,g,k),e(g,v),e(v,T),e(g,_),e(g,E),e(E,fe),u(h,Q,k),u(h,y,k),e(y,J),e(y,A),e(A,Y),e(y,ge),e(y,O),e(O,_e),e(y,ce),u(h,x,k),u(h,S,k),e(S,Z),u(h,oe,k),u(h,F,k),e(F,q),e(q,Te),e(q,U),e(U,he),e(q,ne),e(q,V),e(V,pe),e(F,se),e(F,z),e(z,ve),e(z,H),e(H,ae),e(z,ke),e(z,W),e(W,j),e(F,ee),e(F,I),e(I,te),e(I,G),e(G,be)},d(h){h&&t(p),h&&t(f),h&&t(g),h&&t(Q),h&&t(y),h&&t(x),h&&t(S),h&&t(oe),h&&t(F)}}}function Xc(B){let p,b,f,g,v;return{c(){p=a("p"),b=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=a("code"),g=n("Module"),v=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(T){p=r(T,"P",{});var _=i(p);b=s(_,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=r(_,"CODE",{});var E=i(f);g=s(E,"Module"),E.forEach(t),v=s(_,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),_.forEach(t)},m(T,_){u(T,p,_),e(p,b),e(p,f),e(f,g),e(p,v)},d(T){T&&t(p)}}}function Jc(B){let p,b,f,g,v,T,_,E,fe,Q,y,J,A,Y,ge,O,_e,ce,x,S,Z,oe,F,q,Te,U,he,ne,V,pe,se,z,ve,H,ae,ke,W,j,ee,I,te,G,be;return{c(){p=a("p"),b=n("TF 2.0 models accepts two formats as inputs:"),f=l(),g=a("ul"),v=a("li"),T=n("having all inputs as keyword arguments (like PyTorch models), or"),_=l(),E=a("li"),fe=n("having all inputs as a list, tuple or dict in the first positional arguments."),Q=l(),y=a("p"),J=n("This second option is useful when using "),A=a("code"),Y=n("tf.keras.Model.fit"),ge=n(` method which currently requires having all the
tensors in the first argument of the model call function: `),O=a("code"),_e=n("model(inputs)"),ce=n("."),x=l(),S=a("p"),Z=n(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),oe=l(),F=a("ul"),q=a("li"),Te=n("a single Tensor with "),U=a("code"),he=n("input_ids"),ne=n(" only and nothing else: "),V=a("code"),pe=n("model(inputs_ids)"),se=l(),z=a("li"),ve=n(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),H=a("code"),ae=n("model([input_ids, attention_mask])"),ke=n(" or "),W=a("code"),j=n("model([input_ids, attention_mask, token_type_ids])"),ee=l(),I=a("li"),te=n(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),G=a("code"),be=n('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(h){p=r(h,"P",{});var k=i(p);b=s(k,"TF 2.0 models accepts two formats as inputs:"),k.forEach(t),f=d(h),g=r(h,"UL",{});var re=i(g);v=r(re,"LI",{});var Ae=i(v);T=s(Ae,"having all inputs as keyword arguments (like PyTorch models), or"),Ae.forEach(t),_=d(re),E=r(re,"LI",{});var ue=i(E);fe=s(ue,"having all inputs as a list, tuple or dict in the first positional arguments."),ue.forEach(t),re.forEach(t),Q=d(h),y=r(h,"P",{});var N=i(y);J=s(N,"This second option is useful when using "),A=r(N,"CODE",{});var Ee=i(A);Y=s(Ee,"tf.keras.Model.fit"),Ee.forEach(t),ge=s(N,` method which currently requires having all the
...
first positional argument :`),He.forEach(t),oe=d(h),F=r(h,"UL",{});var D=i(F);q=r(D,"LI",{});var P=i(q);Te=s(P,"a single Tensor with "),U=r(P,"CODE",{});var We=i(U);he=s(We,"input_ids"),We.forEach(t),ne=s(P," only and nothing else: "),V=r(P,"CODE",{});var Fe=i(V);pe=s(Fe,"model(inputs_ids)"),Fe.forEach(t),P.forEach(t),se=d(D),z=r(D,"LI",{});var K=i(z);ve=s(K,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),H=r(K,"CODE",{});var Be=i(H);ae=s(Be,"model([input_ids, attention_mask])"),Be.forEach(t),ke=s(K," or "),W=r(K,"CODE",{});var qe=i(W);j=s(qe,"model([input_ids, attention_mask, token_type_ids])"),qe.forEach(t),K.forEach(t),ee=d(D),I=r(D,"LI",{});var ye=i(I);te=s(ye,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),G=r(ye,"CODE",{});var Ue=i(G);be=s(Ue,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),Ue.forEach(t),ye.forEach(t),D.forEach(t)},m(h,k){u(h,p,k),e(p,b),u(h,f,k),u(h,g,k),e(g,v),e(v,T),e(g,_),e(g,E),e(E,fe),u(h,Q,k),u(h,y,k),e(y,J),e(y,A),e(A,Y),e(y,ge),e(y,O),e(O,_e),e(y,ce),u(h,x,k),u(h,S,k),e(S,Z),u(h,oe,k),u(h,F,k),e(F,q),e(q,Te),e(q,U),e(U,he),e(q,ne),e(q,V),e(V,pe),e(F,se),e(F,z),e(z,ve),e(z,H),e(H,ae),e(z,ke),e(z,W),e(W,j),e(F,ee),e(F,I),e(I,te),e(I,G),e(G,be)},d(h){h&&t(p),h&&t(f),h&&t(g),h&&t(Q),h&&t(y),h&&t(x),h&&t(S),h&&t(oe),h&&t(F)}}}function Qc(B){let p,b,f,g,v;return{c(){p=a("p"),b=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=a("code"),g=n("Module"),v=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(T){p=r(T,"P",{});var _=i(p);b=s(_,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=r(_,"CODE",{});var E=i(f);g=s(E,"Module"),E.forEach(t),v=s(_,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),_.forEach(t)},m(T,_){u(T,p,_),e(p,b),e(p,f),e(f,g),e(p,v)},d(T){T&&t(p)}}}function Yc(B){let p,b,f,g,v,T,_,E,fe,Q,y,J,A,Y,ge,O,_e,ce,x,S,Z,oe,F,q,Te,U,he,ne,V,pe,se,z,ve,H,ae,ke,W,j,ee,I,te,G,be;return{c(){p=a("p"),b=n("TF 2.0 models accepts two formats as inputs:"),f=l(),g=a("ul"),v=a("li"),T=n("having all inputs as keyword arguments (like PyTorch models), or"),_=l(),E=a("li"),fe=n("having all inputs as a list, tuple or dict in the first positional arguments."),Q=l(),y=a("p"),J=n("This second option is useful when using "),A=a("code"),Y=n("tf.keras.Model.fit"),ge=n(` method which currently requires having all the
tensors in the first argument of the model call function: `),O=a("code"),_e=n("model(inputs)"),ce=n("."),x=l(),S=a("p"),Z=n(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),oe=l(),F=a("ul"),q=a("li"),Te=n("a single Tensor with "),U=a("code"),he=n("input_ids"),ne=n(" only and nothing else: "),V=a("code"),pe=n("model(inputs_ids)"),se=l(),z=a("li"),ve=n(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),H=a("code"),ae=n("model([input_ids, attention_mask])"),ke=n(" or "),W=a("code"),j=n("model([input_ids, attention_mask, token_type_ids])"),ee=l(),I=a("li"),te=n(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),G=a("code"),be=n('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(h){p=r(h,"P",{});var k=i(p);b=s(k,"TF 2.0 models accepts two formats as inputs:"),k.forEach(t),f=d(h),g=r(h,"UL",{});var re=i(g);v=r(re,"LI",{});var Ae=i(v);T=s(Ae,"having all inputs as keyword arguments (like PyTorch models), or"),Ae.forEach(t),_=d(re),E=r(re,"LI",{});var ue=i(E);fe=s(ue,"having all inputs as a list, tuple or dict in the first positional arguments."),ue.forEach(t),re.forEach(t),Q=d(h),y=r(h,"P",{});var N=i(y);J=s(N,"This second option is useful when using "),A=r(N,"CODE",{});var Ee=i(A);Y=s(Ee,"tf.keras.Model.fit"),Ee.forEach(t),ge=s(N,` method which currently requires having all the
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/main/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),St=new Lt({props:{$$slots:{default:[Kc]},$$scope:{ctx:B}}}),qo=new Me({props:{name:"call",anchor:"transformers.TFCTRLModel.call",parameters:[{name:"input_ids",val:" = None"},{name:"past_key_values",val:" = None"},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"},{name:"training",val:" = False"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/ctrl/modeling_tf_ctrl.py#L523",parametersDescription:[{anchor:"transformers.TFCTRLModel.call.input_ids",description:`<strong>input_ids</strong> (<code>Numpy array</code> or <code>tf.Tensor</code> of shape <code>(batch_size, input_ids_length)</code>) &#x2014;
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/main/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),Nt=new Lt({props:{$$slots:{default:[Jc]},$$scope:{ctx:B}}}),No=new Me({props:{name:"call",anchor:"transformers.TFCTRLLMHeadModel.call",parameters:[{name:"input_ids",val:" = None"},{name:"past_key_values",val:" = None"},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"},{name:"labels",val:" = None"},{name:"training",val:" = False"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/ctrl/modeling_tf_ctrl.py#L634",parametersDescription:[{anchor:"transformers.TFCTRLLMHeadModel.call.input_ids",description:`<strong>input_ids</strong> (<code>Numpy array</code> or <code>tf.Tensor</code> of shape <code>(batch_size, input_ids_length)</code>) &#x2014;
<code>input_ids_length</code> = <code>sequence_length</code> if <code>past</code> is <code>None</code> else <code>past[0].shape[-2]</code> (<code>sequence_length</code> of
input past key value states).</p>
<p>Indices of input sequence tokens in the vocabulary.</p>
<p>If <code>past</code> is used, only input IDs that do not have their past calculated should be passed as <code>input_ids</code>.</p>
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/main/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),Ot=new Lt({props:{$$slots:{default:[Yc]},$$scope:{ctx:B}}}),Uo=new Me({props:{name:"call",anchor:"transformers.TFCTRLForSequenceClassification.call",parameters:[{name:"input_ids",val:" = None"},{name:"past_key_values",val:" = None"},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"},{name:"labels",val:" = None"},{name:"training",val:" = False"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/ctrl/modeling_tf_ctrl.py#L746",parametersDescription:[{anchor:"transformers.TFCTRLForSequenceClassification.call.input_ids",description:`<strong>input_ids</strong> (<code>Numpy array</code> or <code>tf.Tensor</code> of shape <code>(batch_size, input_ids_length)</code>) &#x2014;
<code>input_ids_length</code> = <code>sequence_length</code> if <code>past</code> is <code>None</code> else <code>past[0].shape[-2]</code> (<code>sequence_length</code> of
input past key value states).</p>
<p>Indices of input sequence tokens in the vocabulary.</p>
<p>If <code>past</code> is used, only input IDs that do not have their past calculated should be passed as <code>input_ids</code>.</p>
...
<span class="hljs-meta">&gt;&gt;&gt; </span>outputs = model(inputs)
<span class="hljs-meta">&gt;&gt;&gt; </span>loss = outputs.loss
<span class="hljs-meta">&gt;&gt;&gt; </span>logits = outputs.logits`}}),{c(){p=a("meta"),b=l(),f=a("h1"),g=a("a"),v=a("span"),C(T.$$.fragment),_=l(),E=a("span"),fe=n("CTRL"),Q=l(),y=a("h2"),J=a("a"),A=a("span"),C(Y.$$.fragment),ge=l(),O=a("span"),_e=n("Overview"),ce=l(),x=a("p"),S=n("CTRL model was proposed in "),Z=a("a"),oe=n("CTRL: A Conditional Transformer Language Model for Controllable Generation"),F=n(" by Nitish Shirish Keskar"),q=a("em"),Te=n(", Bryan McCann"),U=n(`, Lav R. Varshney, Caiming Xiong and
...
documentation from `),Zo=a("a"),xa=n("PretrainedConfig"),Sa=n(" for more information."),ja=l(),Fn=a("p"),Ia=n("Examples:"),Na=l(),C(Yt.$$.fragment),Rs=l(),ht=a("h2"),Rt=a("a"),qn=a("span"),C(Zt.$$.fragment),Da=l(),zn=a("span"),Aa=n("CTRLTokenizer"),Ms=l(),Ne=a("div"),C(eo.$$.fragment),Oa=l(),Pn=a("p"),Ha=n("Construct a CTRL tokenizer. Based on Byte-Pair-Encoding."),Wa=l(),to=a("p"),Ba=n("This tokenizer inherits from "),en=a("a"),Ua=n("PreTrainedTokenizer"),Va=n(` which contains most of the main methods. Users should refer to
...
behavior.`),xi=l(),C(St.$$.fragment),Si=l(),xe=a("div"),C(qo.$$.fragment),ji=l(),vt=a("p"),Ii=n("The "),hn=a("a"),Ni=n("TFCTRLModel"),Di=n(" forward method, overrides the "),os=a("code"),Ai=n("__call__"),Oi=n(" special method."),Hi=l(),C(jt.$$.fragment),Wi=l(),ns=a("p"),Bi=n("Example:"),Ui=l(),C(zo.$$.fragment),Is=l(),kt=a("h2"),It=a("a"),ss=a("span"),C(Po.$$.fragment),Vi=l(),as=a("span"),Gi=n("TFCTRLLMHeadModel"),Ns=l(),de=a("div"),C(xo.$$.fragment),Ki=l(),rs=a("p"),Xi=n(`The CTRL Model transformer with a language modeling head on top (linear layer with weights tied to the input
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Ol=l(),C(Ot.$$.fragment),Hl=l(),je=a("div"),C(Uo.$$.fragment),Wl=l(),Ct=a("p"),Bl=n("The "),_n=a("a"),Ul=n("TFCTRLForSequenceClassification"),Vl=n(" forward method, overrides the "),gs=a("code"),Gl=n("__call__"),Kl=n(" special method."),Xl=l(),C(Ht.$$.fragment),Jl=l(),_s=a("p"),Ql=n("Example:"),Yl=l(),C(Vo.$$.fragment),this.h()},l(o){const m=Bc('[data-svelte="svelte-1phssyn"]',document.head);p=r(m,"META",{name:!0,content:!0}),m.forEach(t),b=d(o),f=r(o,"H1",{class:!0});var Go=i(f);g=r(Go,"A",{id:!0,class:!0,href:!0});var Ts=i(g);v=r(Ts,"SPAN",{});var vs=i(v);w(T.$$.fragment,vs),vs.forEach(t),Ts.forEach(t),_=d(Go),E=r(Go,"SPAN",{});var ks=i(E);fe=s(ks,"CTRL"),ks.forEach(t),Go.forEach(t),Q=d(o),y=r(o,"H2",{class:!0});var Ko=i(y);J=r(Ko,"A",{id:!0,class:!0,href:!0});var bs=i(J);A=r(bs,"SPAN",{});var ys=i(A);w(Y.$$.fragment,ys),ys.forEach(t),bs.forEach(t),ge=d(Ko),O=r(Ko,"SPAN",{});var Cs=i(O);_e=s(Cs,"Overview"),Cs.forEach(t),Ko.forEach(t),ce=d(o),x=r(o,"P",{});var wt=i(x);S=s(wt,"CTRL model was proposed in "),Z=r(wt,"A",{href:!0,rel:!0});var ed=i(Z);oe=s(ed,"CTRL: A Conditional Transformer Language Model for Controllable Generation"),ed.forEach(t),F=s(wt," by Nitish Shirish Keskar"),q=r(wt,"EM",{});var td=i(q);Te=s(td,", Bryan McCann"),td.forEach(t),U=s(wt,`, Lav R. Varshney, Caiming Xiong and
Richard Socher. It\u2019s a causal (unidirectional) transformer pre-trained using language modeling on a very large corpus
