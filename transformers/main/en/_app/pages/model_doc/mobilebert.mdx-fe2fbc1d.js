import{S as py,i as my,s as hy,e as r,k as m,w as v,t as n,M as fy,c as a,d as t,m as h,a as i,x as y,h as s,b,F as e,g,y as w,q as M,o as $,B as F,v as uy,L as xe}from"../../chunks/vendor-6b77c823.js";import{T as Pe}from"../../chunks/Tip-39098574.js";import{D as ie}from"../../chunks/Docstring-1088f2fb.js";import{C as ze}from"../../chunks/CodeBlock-3a8b25a8.js";import{I as qe}from"../../chunks/IconCopyLink-7a11ce68.js";import{E as Ee}from"../../chunks/ExampleCodeBlock-5212b321.js";function gy(E){let d,_,c,p,T;return p=new ze({props:{code:`from transformers import MobileBertModel, MobileBertConfig
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),{c(){d=r("p"),_=n("Example:"),c=m(),v(p.$$.fragment)},l(l){d=a(l,"P",{});var f=i(d);_=s(f,"Example:"),f.forEach(t),c=h(l),y(p.$$.fragment,l)},m(l,f){g(l,d,f),e(d,_),g(l,c,f),w(p,l,f),T=!0},p:xe,i(l){T||(M(p.$$.fragment,l),T=!0)},o(l){$(p.$$.fragment,l),T=!1},d(l){l&&t(d),l&&t(c),F(p,l)}}}function Wy(E){let d,_,c,p,T,l,f,x,me,V,z,J,D,X,he,L,fe,le,K,N,ee,G,P,C,ne,U,de,se,W,ue,ce,q,ge,R,Z,re,H,_e,ae,O,pe,A,be;return{c(){d=r("p"),_=n("TF 2.0 models accepts two formats as inputs:"),c=m(),p=r("ul"),T=r("li"),l=n("having all inputs as keyword arguments (like PyTorch models), or"),f=m(),x=r("li"),me=n("having all inputs as a list, tuple or dict in the first positional arguments."),V=m(),z=r("p"),J=n("This second option is useful when using "),D=r("code"),X=n("tf.keras.Model.fit"),he=n(` method which currently requires having all the
tensors in the first argument of the model call function: `),L=r("code"),fe=n("model(inputs)"),le=n("."),K=m(),N=r("p"),ee=n(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),G=m(),P=r("ul"),C=r("li"),ne=n("a single Tensor with "),U=r("code"),de=n("input_ids"),se=n(" only and nothing else: "),W=r("code"),ue=n("model(inputs_ids)"),ce=m(),q=r("li"),ge=n(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),R=r("code"),Z=n("model([input_ids, attention_mask])"),re=n(" or "),H=r("code"),_e=n("model([input_ids, attention_mask, token_type_ids])"),ae=m(),O=r("li"),pe=n(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),A=r("code"),be=n('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(u){d=a(u,"P",{});var B=i(d);_=s(B,"TF 2.0 models accepts two formats as inputs:"),B.forEach(t),c=h(u),p=a(u,"UL",{});var Y=i(p);T=a(Y,"LI",{});var ve=i(T);l=s(ve,"having all inputs as keyword arguments (like PyTorch models), or"),ve.forEach(t),f=h(Y),x=a(Y,"LI",{});var $e=i(x);me=s($e,"having all inputs as a list, tuple or dict in the first positional arguments."),$e.forEach(t),Y.forEach(t),V=h(u),z=a(u,"P",{});var S=i(z);J=s(S,"This second option is useful when using "),D=a(S,"CODE",{});var we=i(D);X=s(we,"tf.keras.Model.fit"),we.forEach(t),he=s(S,` method which currently requires having all the
...
<span class="hljs-number">0.57</span>`}}),{c(){v(d.$$.fragment)},l(c){y(d.$$.fragment,c)},m(c,p){w(d,c,p),_=!0},p:xe,i(c){_||(M(d.$$.fragment,c),_=!0)},o(c){$(d.$$.fragment,c),_=!1},d(c){F(d,c)}}}function Gy(E){let d,_,c,p,T,l,f,x,me,V,z,J,D,X,he,L,fe,le,K,N,ee,G,P,C,ne,U,de,se,W,ue,ce,q,ge,R,Z,re,H,_e,ae,O,pe,A,be;return{c(){d=r("p"),_=n("TF 2.0 models accepts two formats as inputs:"),c=m(),p=r("ul"),T=r("li"),l=n("having all inputs as keyword arguments (like PyTorch models), or"),f=m(),x=r("li"),me=n("having all inputs as a list, tuple or dict in the first positional arguments."),V=m(),z=r("p"),J=n("This second option is useful when using "),D=r("code"),X=n("tf.keras.Model.fit"),he=n(` method which currently requires having all the
tensors in the first argument of the model call function: `),L=r("code"),fe=n("model(inputs)"),le=n("."),K=m(),N=r("p"),ee=n(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),G=m(),P=r("ul"),C=r("li"),ne=n("a single Tensor with "),U=r("code"),de=n("input_ids"),se=n(" only and nothing else: "),W=r("code"),ue=n("model(inputs_ids)"),ce=m(),q=r("li"),ge=n(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),R=r("code"),Z=n("model([input_ids, attention_mask])"),re=n(" or "),H=r("code"),_e=n("model([input_ids, attention_mask, token_type_ids])"),ae=m(),O=r("li"),pe=n(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),A=r("code"),be=n('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(u){d=a(u,"P",{});var B=i(d);_=s(B,"TF 2.0 models accepts two formats as inputs:"),B.forEach(t),c=h(u),p=a(u,"UL",{});var Y=i(p);T=a(Y,"LI",{});var ve=i(T);l=s(ve,"having all inputs as keyword arguments (like PyTorch models), or"),ve.forEach(t),f=h(Y),x=a(Y,"LI",{});var $e=i(x);me=s($e,"having all inputs as a list, tuple or dict in the first positional arguments."),$e.forEach(t),Y.forEach(t),V=h(u),z=a(u,"P",{});var S=i(z);J=s(S,"This second option is useful when using "),D=a(S,"CODE",{});var we=i(D);X=s(we,"tf.keras.Model.fit"),we.forEach(t),he=s(S,` method which currently requires having all the
...
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-comment"># the linear classifier still needs to be trained</span>
<span class="hljs-meta">&gt;&gt;&gt; </span>logits = outputs.logits`}}),{c(){d=r("p"),_=n("Example:"),c=m(),v(p.$$.fragment)},l(l){d=a(l,"P",{});var f=i(d);_=s(f,"Example:"),f.forEach(t),c=h(l),y(p.$$.fragment,l)},m(l,f){g(l,d,f),e(d,_),g(l,c,f),w(p,l,f),T=!0},p:xe,i(l){T||(M(p.$$.fragment,l),T=!0)},o(l){$(p.$$.fragment,l),T=!1},d(l){l&&t(d),l&&t(c),F(p,l)}}}function rw(E){let d,_,c,p,T,l,f,x,me,V,z,J,D,X,he,L,fe,le,K,N,ee,G,P,C,ne,U,de,se,W,ue,ce,q,ge,R,Z,re,H,_e,ae,O,pe,A,be;return{c(){d=r("p"),_=n("TF 2.0 models accepts two formats as inputs:"),c=m(),p=r("ul"),T=r("li"),l=n("having all inputs as keyword arguments (like PyTorch models), or"),f=m(),x=r("li"),me=n("having all inputs as a list, tuple or dict in the first positional arguments."),V=m(),z=r("p"),J=n("This second option is useful when using "),D=r("code"),X=n("tf.keras.Model.fit"),he=n(` method which currently requires having all the
tensors in the first argument of the model call function: `),L=r("code"),fe=n("model(inputs)"),le=n("."),K=m(),N=r("p"),ee=n(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),G=m(),P=r("ul"),C=r("li"),ne=n("a single Tensor with "),U=r("code"),de=n("input_ids"),se=n(" only and nothing else: "),W=r("code"),ue=n("model(inputs_ids)"),ce=m(),q=r("li"),ge=n(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),R=r("code"),Z=n("model([input_ids, attention_mask])"),re=n(" or "),H=r("code"),_e=n("model([input_ids, attention_mask, token_type_ids])"),ae=m(),O=r("li"),pe=n(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),A=r("code"),be=n('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(u){d=a(u,"P",{});var B=i(d);_=s(B,"TF 2.0 models accepts two formats as inputs:"),B.forEach(t),c=h(u),p=a(u,"UL",{});var Y=i(p);T=a(Y,"LI",{});var ve=i(T);l=s(ve,"having all inputs as keyword arguments (like PyTorch models), or"),ve.forEach(t),f=h(Y),x=a(Y,"LI",{});var $e=i(x);me=s($e,"having all inputs as a list, tuple or dict in the first positional arguments."),$e.forEach(t),Y.forEach(t),V=h(u),z=a(u,"P",{});var S=i(z);J=s(S,"This second option is useful when using "),D=a(S,"CODE",{});var we=i(D);X=s(we,"tf.keras.Model.fit"),we.forEach(t),he=s(S,` method which currently requires having all the
...
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-built_in">round</span>(<span class="hljs-built_in">float</span>(loss), <span class="hljs-number">2</span>)
<span class="hljs-number">0.03</span>`}}),{c(){v(d.$$.fragment)},l(c){y(d.$$.fragment,c)},m(c,p){w(d,c,p),_=!0},p:xe,i(c){_||(M(d.$$.fragment,c),_=!0)},o(c){$(d.$$.fragment,c),_=!1},d(c){F(d,c)}}}function dw(E){let d,_,c,p,T,l,f,x,me,V,z,J,D,X,he,L,fe,le,K,N,ee,G,P,C,ne,U,de,se,W,ue,ce,q,ge,R,Z,re,H,_e,ae,O,pe,A,be;return{c(){d=r("p"),_=n("TF 2.0 models accepts two formats as inputs:"),c=m(),p=r("ul"),T=r("li"),l=n("having all inputs as keyword arguments (like PyTorch models), or"),f=m(),x=r("li"),me=n("having all inputs as a list, tuple or dict in the first positional arguments."),V=m(),z=r("p"),J=n("This second option is useful when using "),D=r("code"),X=n("tf.keras.Model.fit"),he=n(` method which currently requires having all the
tensors in the first argument of the model call function: `),L=r("code"),fe=n("model(inputs)"),le=n("."),K=m(),N=r("p"),ee=n(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),G=m(),P=r("ul"),C=r("li"),ne=n("a single Tensor with "),U=r("code"),de=n("input_ids"),se=n(" only and nothing else: "),W=r("code"),ue=n("model(inputs_ids)"),ce=m(),q=r("li"),ge=n(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),R=r("code"),Z=n("model([input_ids, attention_mask])"),re=n(" or "),H=r("code"),_e=n("model([input_ids, attention_mask, token_type_ids])"),ae=m(),O=r("li"),pe=n(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),A=r("code"),be=n('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(u){d=a(u,"P",{});var B=i(d);_=s(B,"TF 2.0 models accepts two formats as inputs:"),B.forEach(t),c=h(u),p=a(u,"UL",{});var Y=i(p);T=a(Y,"LI",{});var ve=i(T);l=s(ve,"having all inputs as keyword arguments (like PyTorch models), or"),ve.forEach(t),f=h(Y),x=a(Y,"LI",{});var $e=i(x);me=s($e,"having all inputs as a list, tuple or dict in the first positional arguments."),$e.forEach(t),Y.forEach(t),V=h(u),z=a(u,"P",{});var S=i(z);J=s(S,"This second option is useful when using "),D=a(S,"CODE",{});var we=i(D);X=s(we,"tf.keras.Model.fit"),we.forEach(t),he=s(S,` method which currently requires having all the
...
</ul>`,name:"next_sentence_label"}],source:"https://github.com/huggingface/transformers/blob/vmain/src/transformers/models/mobilebert/modeling_mobilebert.py#L944",returnDescription:`
<p>A <a
...
Labels for computing the masked language modeling loss. Indices should be in <code>[-100, 0, ..., config.vocab_size]</code> (see <code>input_ids</code> docstring) Tokens with indices set to <code>-100</code> are ignored (masked), the
loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vmain/src/transformers/models/mobilebert/modeling_mobilebert.py#L1053",returnDescription:`
<p>A <a
...
<li>0 indicates sequence B is a continuation of sequence A,</li>
<li>1 indicates sequence B is a random sequence.</li>
</ul>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vmain/src/transformers/models/mobilebert/modeling_mobilebert.py#L1139",returnDescription:`
<p>A <a
...
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vmain/src/transformers/models/mobilebert/modeling_mobilebert.py#L1248",returnDescription:`
<p>A <a
...
<code>input_ids</code> above)`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vmain/src/transformers/models/mobilebert/modeling_mobilebert.py#L1459",returnDescription:`
<p>A <a
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vmain/src/transformers/models/mobilebert/modeling_mobilebert.py#L1561",returnDescription:`
<p>A <a
...
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/vmain/src/transformers/models/mobilebert/modeling_mobilebert.py#L1351",returnDescription:`
<p>A <a
...
behaviors between training and evaluation).`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/vmain/src/transformers/models/mobilebert/modeling_tf_mobilebert.py#L929",returnDescription:`
<p>A <a
...
Whether or not to use the model in training mode (some modules like dropout modules have different
behaviors between training and evaluation).`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/vmain/src/transformers/models/mobilebert/modeling_tf_mobilebert.py#L998",returnDescription:`
<p>A <a
...
Labels for computing the masked language modeling loss. Indices should be in <code>[-100, 0, ..., config.vocab_size]</code> (see <code>input_ids</code> docstring) Tokens with indices set to <code>-100</code> are ignored (masked), the
loss is only computed for the tokens with labels`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vmain/src/transformers/models/mobilebert/modeling_tf_mobilebert.py#L1090",returnDescription:`
<p>A <a
...
Whether or not to use the model in training mode (some modules like dropout modules have different
behaviors between training and evaluation).`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/vmain/src/transformers/models/mobilebert/modeling_tf_mobilebert.py#L1180",returnDescription:`
<p>A <a
...
Labels for computing the sequence classification/regression loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>. If <code>config.num_labels == 1</code> a regression loss is computed (Mean-Square loss), If
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vmain/src/transformers/models/mobilebert/modeling_tf_mobilebert.py#L1285",returnDescription:`
<p>A <a
...
where <code>num_choices</code> is the size of the second dimension of the input tensors. (See <code>input_ids</code> above)`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vmain/src/transformers/models/mobilebert/modeling_tf_mobilebert.py#L1498",returnDescription:`
<p>A <a
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vmain/src/transformers/models/mobilebert/modeling_tf_mobilebert.py#L1627",returnDescription:`
<p>A <a
...
Labels for position (index) of the end of the labelled span for computing the token classification loss.
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/vmain/src/transformers/models/mobilebert/modeling_tf_mobilebert.py#L1379",returnDescription:`
<p>A <a
...
`}}),Gn=new Pe({props:{$$slots:{default:[cw]},$$scope:{ctx:E}}}),Yn=new Ee({props:{anchor:"transformers.TFMobileBertForQuestionAnswering.call.example",$$slots:{default:[pw]},$$scope:{ctx:E}}}),Jn=new Ee({props:{anchor:"transformers.TFMobileBertForQuestionAnswering.call.example-2",$$slots:{default:[mw]},$$scope:{ctx:E}}}),{c(){d=r("meta"),_=m(),c=r("h1"),p=r("a"),T=r("span"),v(l.$$.fragment),f=m(),x=r("span"),me=n("MobileBERT"),V=m(),z=r("h2"),J=r("a"),D=r("span"),v(X.$$.fragment),he=m(),L=r("span"),fe=n("Overview"),le=m(),K=r("p"),N=n("The MobileBERT model was proposed in "),ee=r("a"),G=n("MobileBERT: a Compact Task-Agnostic BERT for Resource-Limited Devices"),P=n(` by Zhiqing Sun, Hongkun Yu, Xiaodan Song, Renjie Liu, Yiming Yang, and Denny
...
splitting and wordpiece.`),fm=m(),fs=r("p"),um=n("Refer to superclass "),Pa=r("a"),gm=n("BertTokenizerFast"),_m=n(" for usage examples and documentation concerning parameters."),Wd=m(),Ht=r("h2"),Ao=r("a"),Ii=r("span"),v(us.$$.fragment),bm=m(),Di=r("span"),Tm=n("MobileBert specific outputs"),Rd=m(),Qt=r("div"),v(gs.$$.fragment),km=m(),_s=r("p"),vm=n("Output type of "),qa=r("a"),ym=n("MobileBertForPreTraining"),wm=n("."),Ud=m(),Kt=r("div"),v(bs.$$.fragment),Mm=m(),Ts=r("p"),$m=n("Output type of "),Ca=r("a"),Fm=n("TFMobileBertForPreTraining"),Bm=n("."),Hd=m(),Vt=r("h2"),Io=r("a"),Li=r("span"),v(ks.$$.fragment),Em=m(),Wi=r("span"),xm=n("MobileBertModel"),Qd=m(),je=r("div"),v(vs.$$.fragment),zm=m(),Ri=r("p"),Pm=n("The bare MobileBert Model transformer outputting raw hidden-states without any specific head on top."),qm=m(),ys=r("p"),Cm=n("This model inherits from "),ja=r("a"),jm=n("PreTrainedModel"),Nm=n(`. Check the superclass documentation for the generic methods the
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),af=m(),dt=r("div"),v(Qs.$$.fragment),lf=m(),oo=r("p"),df=n("The "),La=r("a"),cf=n("MobileBertForNextSentencePrediction"),pf=n(" forward method, overrides the "),sl=r("code"),mf=n("__call__"),hf=n(" special method."),ff=m(),v(Yo.$$.fragment),uf=m(),v(Jo.$$.fragment),Xd=m(),no=r("h2"),Zo=r("a"),rl=r("span"),v(Ks.$$.fragment),gf=m(),al=r("span"),_f=n("MobileBertForSequenceClassification"),ec=m(),Qe=r("div"),v(Vs.$$.fragment),bf=m(),il=r("p"),Tf=n(`MobileBert Model transformer with a sequence classification/regression head on top (a linear layer on top of the
...
linear layers on top of the hidden-states output to compute `),Tl=r("code"),Cu=n("span start logits"),ju=n(" and "),kl=r("code"),Nu=n("span end logits"),Ou=n(")."),Su=m(),hr=r("p"),Au=n("This model inherits from "),Va=r("a"),Iu=n("PreTrainedModel"),Du=n(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Lu=m(),fr=r("p"),Wu=n("This model is also a PyTorch "),ur=r("a"),Ru=n("torch.nn.Module"),Uu=n(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),j_=m(),v(zn.$$.fragment),N_=m(),ht=r("div"),v(Wr.$$.fragment),O_=m(),vo=r("p"),S_=n("The "),ni=r("a"),A_=n("TFMobileBertForNextSentencePrediction"),I_=n(" forward method, overrides the "),Al=r("code"),D_=n("__call__"),L_=n(" special method."),W_=m(),v(Pn.$$.fragment),R_=m(),v(qn.$$.fragment),uc=m(),yo=r("h2"),Cn=r("a"),Il=r("span"),v(Rr.$$.fragment),U_=m(),Dl=r("span"),H_=n("TFMobileBertForSequenceClassification"),gc=m(),Ie=r("div"),v(Ur.$$.fragment),Q_=m(),Ll=r("p"),K_=n(`MobileBert Model transformer with a sequence classification/regression head on top (a linear layer on top of the
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Ic.forEach(t),Oh=h(xt),Ye=a(xt,"DIV",{class:!0});var zt=i(Ye);y(Is.$$.fragment,zt),Sh=h(zt),eo=a(zt,"P",{});var ui=i(eo);Ah=s(ui,"The "),Ia=a(ui,"A",{href:!0});var ck=i(Ia);Ih=s(ck,"MobileBertForMaskedLM"),ck.forEach(t),Dh=s(ui," forward method, overrides the "),el=a(ui,"CODE",{});var pk=i(el);Lh=s(pk,"__call__"),pk.forEach(t),Wh=s(ui," special method."),ui.forEach(t),Rh=h(zt),y(Qo.$$.fragment,zt),Uh=h(zt),y(Ko.$$.fragment,zt),Hh=h(zt),y(Vo.$$.fragment,zt),zt.forEach(t),xt.forEach(t),Jd=h(o),to=a(o,"H2",{class:!0});var Dc=i(to);Go=a(Dc,"A",{id:!0,class:!0,href:!0});var mk=i(Go);tl=a(mk,"SPAN",{});var hk=i(tl);y(Ds.$$.fragment,hk),hk.forEach(t),mk.forEach(t),Qh=h(Dc),ol=a(Dc,"SPAN",{});var fk=i(ol);Kh=s(fk,"MobileBertForNextSentencePrediction"),fk.forEach(t),Dc.forEach(t),Zd=h(o),He=a(o,"DIV",{class:!0});var Pt=i(He);y(Ls.$$.fragment,Pt),Vh=h(Pt),Ws=a(Pt,"P",{});var Lc=i(Ws);Gh=s(Lc,"MobileBert Model with a "),nl=a(Lc,"CODE",{});var uk=i(nl);Yh=s(uk,"next sentence prediction (classification)"),uk.forEach(t),Jh=s(Lc," head on top."),Lc.forEach(t),Zh=h(Pt),Rs=a(Pt,"P",{});var Wc=i(Rs);Xh=s(Wc,"This model inherits from "),Da=a(Wc,"A",{href:!0});var gk=i(Da);ef=s(gk,"PreTrainedModel"),gk.forEach(t),tf=s(Wc,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
for Named-Entity-Recognition (NER) tasks.`),Ik.forEach(t),pu=h(jt),ir=a(jt,"P",{});var Jc=i(ir);mu=s(Jc,"This model inherits from "),Qa=a(Jc,"A",{href:!0});var Dk=i(Qa);hu=s(Dk,"PreTrainedModel"),Dk.forEach(t),fu=s(Jc,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Jc.forEach(t),uu=h(jt),lr=a(jt,"P",{});var Zc=i(lr);gu=s(Zc,"This model is also a PyTorch "),dr=a(Zc,"A",{href:!0,rel:!0});var Lk=i(dr);_u=s(Lk,"torch.nn.Module"),Lk.forEach(t),bu=s(Zc,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
...
linear layers on top of the hidden-states output to compute `),Tl=a(ki,"CODE",{});var Kk=i(Tl);Cu=s(Kk,"span start logits"),Kk.forEach(t),ju=s(ki," and "),kl=a(ki,"CODE",{});var Vk=i(kl);Nu=s(Vk,"span end logits"),Vk.forEach(t),Ou=s(ki,")."),ki.forEach(t),Su=h(Ot),hr=a(Ot,"P",{});var ep=i(hr);Au=s(ep,"This model inherits from "),Va=a(ep,"A",{href:!0});var Gk=i(Va);Iu=s(Gk,"PreTrainedModel"),Gk.forEach(t),Du=s(ep,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),ep.forEach(t),Lu=h(Ot),fr=a(Ot,"P",{});var tp=i(fr);Wu=s(tp,"This model is also a PyTorch "),ur=a(tp,"A",{href:!0,rel:!0});var Yk=i(ur);Ru=s(Yk,"torch.nn.Module"),Yk.forEach(t),Uu=s(tp,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),fp.forEach(t),z_=h(Tt),Dr=a(Tt,"P",{});var up=i(Dr);P_=s(up,"This model is also a "),Lr=a(up,"A",{href:!0,rel:!0});var xv=i(Lr);q_=s(xv,"tf.keras.Model"),xv.forEach(t),C_=s(up,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),up.forEach(t),j_=h(Tt),y(zn.$$.fragment,Tt),N_=h(Tt),ht=a(Tt,"DIV",{class:!0});var rs=i(ht);y(Wr.$$.fragment,rs),O_=h(rs),vo=a(rs,"P",{});var Fi=i(vo);S_=s(Fi,"The "),ni=a(Fi,"A",{href:!0});var zv=i(ni);A_=s(zv,"TFMobileBertForNextSentencePrediction"),zv.forEach(t),I_=s(Fi," forward method, overrides the "),Al=a(Fi,"CODE",{});var Pv=i(Al);D_=s(Pv,"__call__"),Pv.forEach(t),L_=s(Fi," special method."),Fi.forEach(t),W_=h(rs),y(Pn.$$.fragment,rs),R_=h(rs),y(qn.$$.fragment,rs),rs.forEach(t),Tt.forEach(t),uc=h(o),yo=a(o,"H2",{class:!0});var gp=i(yo);Cn=a(gp,"A",{id:!0,class:!0,href:!0});var qv=i(Cn);Il=a(qv,"SPAN",{});var Cv=i(Il);y(Rr.$$.fragment,Cv),Cv.forEach(t),qv.forEach(t),U_=h(gp),Dl=a(gp,"SPAN",{});var jv=i(Dl);H_=s(jv,"TFMobileBertForSequenceClassification"),jv.forEach(t),gp.forEach(t),gc=h(o),Ie=a(o,"DIV",{class:!0});var kt=i(Ie);y(Ur.$$.fragment,kt),Q_=h(kt),Ll=a(kt,"P",{});var Nv=i(Ll);K_=s(Nv,`MobileBert Model transformer with a sequence classification/regression head on top (a linear layer on top of the
