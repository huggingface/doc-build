...
<span class="hljs-meta">&gt;&gt;&gt; </span>end_scores = outputs.end_logits`}}),{c(){h=s("p"),T=n("Examples:"),_=u(),v(g.$$.fragment)},l(d){h=r(d,"P",{});var f=i(h);T=a(f,"Examples:"),f.forEach(t),_=m(d),y(g.$$.fragment,d)},m(d,f){p(d,h,f),e(h,T),p(d,_,f),b(g,d,f),x=!0},p:ua,i(d){x||(L(g.$$.fragment,d),x=!0)},o(d){w(g.$$.fragment,d),x=!1},d(d){d&&t(h),d&&t(_),k(g,d)}}}function cv(P){let h,T,_,g,x,d,f,D,Ci,sr,xe,Be,ma,Mo,Ii,pa,Ai,rr,ue,Di,$o,Oi,Ni,Jt,Si,Ri,ir,me,H,Ui,Eo,Bi,Wi,zo,Vi,Qi,qo,Gi,Hi,Fo,Ki,Xi,Yi,Po,Zi,jo,Ji,el,ol,Co,tl,Io,nl,al,lr,en,sl,cr,on,ha,rl,dr,tn,il,ur,B,fa,ll,cl,Ao,dl,Do,ul,ml,pl,Oo,hl,No,fl,gl,_l,Te,vl,So,yl,bl,Ro,Ll,wl,kl,M,xl,ga,Tl,Ml,nn,$l,El,_a,zl,ql,va,Fl,Pl,ya,jl,Cl,ba,Il,Al,La,Dl,Ol,wa,Nl,Sl,ka,Rl,Ul,an,Bl,Wl,Uo,Vl,Ql,Bo,Gl,Hl,mr,Wo,pr,pe,Kl,xa,Xl,Yl,Ta,Zl,Jl,hr,Vo,fr,We,ec,sn,oc,tc,gr,he,I,nc,rn,ac,sc,Ma,rc,ic,$a,lc,cc,ln,dc,uc,Ea,mc,pc,za,hc,fc,qa,gc,_c,vc,Qo,yc,cn,bc,Lc,wc,Go,kc,Fa,xc,Tc,_r,Ve,Mc,dn,$c,Ec,vr,Me,Qe,Pa,Ho,zc,ja,qc,yr,W,Fc,un,Pc,jc,mn,Cc,Ic,pn,Ac,Dc,hn,Oc,Nc,br,Ko,Lr,E,Sc,fn,Rc,Uc,gn,Bc,Wc,Ca,Vc,Qc,_n,Gc,Hc,vn,Kc,Xc,Ia,Yc,Zc,Aa,Jc,ed,Da,od,td,Oa,nd,ad,Na,sd,rd,wr,R,yn,id,ld,Xo,cd,dd,bn,ud,md,Sa,pd,hd,Ra,fd,gd,kr,Ln,_d,xr,wn,Ua,vd,Tr,kn,yd,Mr,Yo,$r,xn,Ba,bd,Er,fe,Ld,Wa,wd,kd,Va,xd,Td,zr,Zo,qr,Tn,Qa,Md,Fr,V,$d,Ga,Ed,zd,Ha,qd,Fd,Ka,Pd,jd,Xa,Cd,Id,Pr,Jo,jr,Mn,Ya,Ad,Cr,$n,Dd,Ir,et,Ar,En,Za,Od,Dr,zn,Nd,Or,ot,Nr,$e,Ge,Ja,tt,Sd,es,Rd,Sr,K,nt,Ud,Ee,Bd,qn,Wd,Vd,at,Qd,Gd,Hd,ze,Kd,Fn,Xd,Yd,Pn,Zd,Jd,eu,He,Rr,qe,Ke,os,st,ou,ts,tu,Ur,X,rt,nu,ns,au,su,it,ru,as,iu,lu,cu,ge,lt,du,ss,uu,mu,Xe,Br,Fe,Ye,rs,ct,pu,is,hu,Wr,O,dt,fu,N,gu,jn,_u,vu,ls,yu,bu,cs,Lu,wu,ds,ku,xu,us,Tu,Mu,ms,$u,Eu,zu,ut,qu,Cn,Fu,Pu,ju,In,An,Cu,Iu,Au,Ze,mt,Du,ps,Ou,Nu,Dn,pt,Vr,Pe,Je,hs,ht,Su,fs,Ru,Qr,Y,ft,Uu,gt,Bu,gs,Wu,Vu,Qu,_t,Gu,On,Hu,Ku,Xu,eo,vt,Yu,_s,Zu,Gr,je,oo,vs,yt,Ju,ys,em,Hr,U,bt,om,bs,tm,nm,Nn,Sn,am,sm,rm,F,im,Rn,lm,cm,Un,dm,um,Bn,mm,pm,Ls,hm,fm,ws,gm,_m,ks,vm,ym,xs,bm,Lm,Ts,wm,km,Ms,xm,Tm,Mm,_e,Lt,$m,$,Em,$s,zm,qm,wt,Es,Fm,Pm,jm,Wn,Cm,Im,zs,Am,Dm,qs,Om,Nm,kt,Fs,Sm,Rm,Um,Ps,Bm,Wm,Vn,Vm,Qm,js,Gm,Hm,Cs,Km,Xm,Is,Ym,Zm,As,Jm,ep,op,Ds,tp,Kr,Ce,to,Os,xt,np,Ns,ap,Xr,le,Tt,sp,Mt,rp,$t,ip,lp,cp,te,Et,dp,Ie,up,Qn,mp,pp,Ss,hp,fp,gp,no,_p,ao,Yr,Ae,so,Rs,zt,vp,Us,yp,Zr,Z,qt,bp,Ft,Lp,Pt,wp,kp,xp,jt,Tp,Ct,Mp,$p,Ep,ne,It,zp,De,qp,Gn,Fp,Pp,Bs,jp,Cp,Ip,ro,Ap,io,Jr,Oe,lo,Ws,At,Dp,Vs,Op,ei,J,Dt,Np,ee,Sp,Ot,Rp,Up,Nt,Bp,Wp,St,Vp,Qp,Rt,Gp,Hp,Kp,Ut,Xp,Bt,Yp,Zp,Jp,ae,Wt,eh,Ne,oh,Hn,th,nh,Qs,ah,sh,rh,co,ih,uo,oi,Se,mo,Gs,Vt,lh,Hs,ch,ti,oe,Qt,dh,ce,uh,Gt,mh,ph,Ks,hh,fh,Xs,gh,_h,vh,Ht,yh,Kt,bh,Lh,wh,se,Xt,kh,Re,xh,Kn,Th,Mh,Ys,$h,Eh,zh,po,qh,ho,ni;return d=new ie({}),Mo=new ie({}),Wo=new G({props:{code:`def normalize_bbox(bbox, width, height):
    return [
...
<li><code>&apos;pt&apos;</code>: Return PyTorch <code>torch.Tensor</code> objects.</li>
<li><code>&apos;np&apos;</code>: Return Numpy <code>np.ndarray</code> objects.</li>
</ul>`,name:"return_tensors"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/layoutlmv2/tokenization_layoutlmv2.py#L414"}}),pt=new A({props:{name:"save_vocabulary",anchor:"transformers.LayoutLMv2Tokenizer.save_vocabulary",parameters:[{name:"save_directory",val:": str"},{name:"filename_prefix",val:": typing.Optional[str] = None"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/layoutlmv2/tokenization_layoutlmv2.py#L394"}}),ht=new ie({}),ft=new A({props:{name:"class transformers.LayoutLMv2TokenizerFast",anchor:"transformers.LayoutLMv2TokenizerFast",parameters:[{name:"vocab_file",val:" = None"},{name:"tokenizer_file",val:" = None"},{name:"do_lower_case",val:" = True"},{name:"unk_token",val:" = '[UNK]'"},{name:"sep_token",val:" = '[SEP]'"},{name:"pad_token",val:" = '[PAD]'"},{name:"cls_token",val:" = '[CLS]'"},{name:"mask_token",val:" = '[MASK]'"},{name:"cls_token_box",val:" = [0, 0, 0, 0]"},{name:"sep_token_box",val:" = [1000, 1000, 1000, 1000]"},{name:"pad_token_box",val:" = [0, 0, 0, 0]"},{name:"pad_token_label",val:" = -100"},{name:"only_label_first_subword",val:" = True"},{name:"tokenize_chinese_chars",val:" = True"},{name:"strip_accents",val:" = None"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.LayoutLMv2TokenizerFast.vocab_file",description:`<strong>vocab_file</strong> (<code>str</code>) &#x2014;
...
optional `),ms=s("code"),$u=n("labels"),Eu=n(" (for token classification)."),zu=u(),ut=s("p"),qu=n("This tokenizer inherits from "),Cn=s("a"),Fu=n("PreTrainedTokenizer"),Pu=n(` which contains most of the main methods. Users should refer to
...
single processor.`),nm=u(),Nn=s("p"),Sn=s("a"),am=n("LayoutLMv2Processor"),sm=n(" offers all the functionalities you need to prepare data for the model."),rm=u(),F=s("p"),im=n("It first uses "),Rn=s("a"),lm=n("LayoutLMv2FeatureExtractor"),cm=n(` to resize document images to a fixed size, and optionally applies OCR
...
into token-level `),Ms=s("code"),xm=n("labels"),Tm=n(" for token classification tasks (such as FUNSD, CORD)."),Mm=u(),_e=s("div"),v(Lt.$$.fragment),$m=u(),$=s("p"),Em=n("This method first forwards the "),$s=s("code"),zm=n("images"),qm=n(" argument to "),wt=s("a"),Es=s("strong"),Fm=n("call"),Pm=n("()"),jm=n(`. In case
`),Wn=s("a"),Cm=n("LayoutLMv2FeatureExtractor"),Im=n(" was initialized with "),zs=s("code"),Am=n("apply_ocr"),Dm=n(" set to "),qs=s("code"),Om=n("True"),Nm=n(`, it passes the obtained words and
bounding boxes along with the additional arguments to `),kt=s("a"),Fs=s("strong"),Sm=n("call"),Rm=n("()"),Um=n(` and returns the output,
...
`),qa=r(S,"CODE",{});var yf=i(qa);gc=a(yf,"config.image_feature_pool_shape[1]"),yf.forEach(t),_c=a(S,"."),S.forEach(t),vc=m(Jn),Qo=r(Jn,"LI",{});var ci=i(Qo);yc=a(ci,"When calling "),cn=r(ci,"A",{href:!0});var bf=i(cn);bc=a(bf,"from_pretrained()"),bf.forEach(t),Lc=a(ci,`, a warning will be printed with a long list of
parameter names that are not initialized. This is not a problem, as these parameters are batch normalization
statistics, which are going to have values when fine-tuning on a custom dataset.`),ci.forEach(t),wc=m(Jn),Go=r(Jn,"LI",{});var di=i(Go);kc=a(di,"If you want to train the model in a distributed environment, make sure to call "),Fa=r(di,"CODE",{});var Lf=i(Fa);xc=a(Lf,"synchronize_batch_norm"),Lf.forEach(t),Tc=a(di,` on the
...
handles the image modality, while the tokenizer handles the text modality. A processor combines both, which is ideal
for a multi-modal model like LayoutLMv2. Note that you can still use both separately, if you only want to handle one
modality.`),be.forEach(t),br=m(o),y(Ko.$$.fragment,o),Lr=m(o),E=r(o,"P",{});var j=i(E);Sc=a(j,"In short, one can provide a document image (and possibly additional data) to "),fn=r(j,"A",{href:!0});var qf=i(fn);Rc=a(qf,"LayoutLMv2Processor"),qf.forEach(t),Uc=a(j,`,
and it will create the inputs expected by the model. Internally, the processor first uses
...
the processor.`),ea.forEach(t),zr=m(o),y(Zo.$$.fragment,o),qr=m(o),Tn=r(o,"P",{});var Jf=i(Tn);Qa=r(Jf,"STRONG",{});var eg=i(Qa);Md=a(eg,"Use case 3: token classification (training), apply_ocr=False"),eg.forEach(t),Jf.forEach(t),Fr=m(o),V=r(o,"P",{});var Le=i(V);$d=a(Le,`For token classification tasks (such as FUNSD, CORD, SROIE, Kleister-NDA), one can also provide the corresponding word
...
documentation from `),Pn=r(ta,"A",{href:!0});var _g=i(Pn);Zd=a(_g,"PretrainedConfig"),_g.forEach(t),Jd=a(ta," for more information."),ta.forEach(t),eu=m(fo),y(He.$$.fragment,fo),fo.forEach(t),Rr=m(o),qe=r(o,"H2",{class:!0});var hi=i(qe);Ke=r(hi,"A",{id:!0,class:!0,href:!0});var vg=i(Ke);os=r(vg,"SPAN",{});var yg=i(os);y(st.$$.fragment,yg),yg.forEach(t),vg.forEach(t),ou=m(hi),ts=r(hi,"SPAN",{});var bg=i(ts);tu=a(bg,"LayoutLMv2FeatureExtractor"),bg.forEach(t),hi.forEach(t),Ur=m(o),X=r(o,"DIV",{class:!0});var go=i(X);y(rt.$$.fragment,go),nu=m(go),ns=r(go,"P",{});var Lg=i(ns);au=a(Lg,`Constructs a LayoutLMv2 feature extractor. This can be used to resize document images to the same size, as well as
...
of the main methods. Users should refer to this superclass for more information regarding those methods.`),fi.forEach(t),cu=m(go),ge=r(go,"DIV",{class:!0});var na=i(ge);y(lt.$$.fragment,na),du=m(na),ss=r(na,"P",{});var kg=i(ss);uu=a(kg,"Main method to prepare for the model one or several image(s)."),kg.forEach(t),mu=m(na),y(Xe.$$.fragment,na),na.forEach(t),go.forEach(t),Br=m(o),Fe=r(o,"H2",{class:!0});var gi=i(Fe);Ye=r(gi,"A",{id:!0,class:!0,href:!0});var xg=i(Ye);rs=r(xg,"SPAN",{});var Tg=i(rs);y(ct.$$.fragment,Tg),Tg.forEach(t),xg.forEach(t),pu=m(gi),is=r(gi,"SPAN",{});var Mg=i(is);hu=a(Mg,"LayoutLMv2Tokenizer"),Mg.forEach(t),gi.forEach(t),Wr=m(o),O=r(o,"DIV",{class:!0});var re=i(O);y(dt.$$.fragment,re),fu=m(re),N=r(re,"P",{});var Q=i(N);gu=a(Q,"Construct a LayoutLMv2 tokenizer. Based on WordPiece. "),jn=r(Q,"A",{href:!0});var $g=i(jn);_u=a($g,"LayoutLMv2Tokenizer"),$g.forEach(t),vu=a(Q,` can be used to turn words, word-level
...
optional `),ms=r(Q,"CODE",{});var Pg=i(ms);$u=a(Pg,"labels"),Pg.forEach(t),Eu=a(Q," (for token classification)."),Q.forEach(t),zu=m(re),ut=r(re,"P",{});var _i=i(ut);qu=a(_i,"This tokenizer inherits from "),Cn=r(_i,"A",{href:!0});var jg=i(Cn);Fu=a(jg,"PreTrainedTokenizer"),jg.forEach(t),Pu=a(_i,` which contains most of the main methods. Users should refer to
this superclass for more information regarding those methods.`),_i.forEach(t),ju=m(re),In=r(re,"P",{});var Fh=i(In);An=r(Fh,"A",{href:!0});var Cg=i(An);Cu=a(Cg,"LayoutLMv2Tokenizer"),Cg.forEach(t),Iu=a(Fh,` runs end-to-end tokenization: punctuation splitting and wordpiece. It also turns the
word-level bounding boxes into token-level bounding boxes.`),Fh.forEach(t),Au=m(re),Ze=r(re,"DIV",{class:!0});var vi=i(Ze);y(mt.$$.fragment,vi),Du=m(vi),ps=r(vi,"P",{});var Ig=i(ps);Ou=a(Ig,`Main method to tokenize and prepare for the model one or several sequence(s) or one or several pair(s) of
...
into token-level `),Ms=r(C,"CODE",{});var t_=i(Ms);xm=a(t_,"labels"),t_.forEach(t),Tm=a(C," for token classification tasks (such as FUNSD, CORD)."),C.forEach(t),Mm=m(we),_e=r(we,"DIV",{class:!0});var aa=i(_e);y(Lt.$$.fragment,aa),$m=m(aa),$=r(aa,"P",{});var q=i($);Em=a(q,"This method first forwards the "),$s=r(q,"CODE",{});var n_=i($s);zm=a(n_,"images"),n_.forEach(t),qm=a(q," argument to "),wt=r(q,"A",{href:!0});var jh=i(wt);Es=r(jh,"STRONG",{});var a_=i(Es);Fm=a(a_,"call"),a_.forEach(t),Pm=a(jh,"()"),jh.forEach(t),jm=a(q,`. In case
`),Wn=r(q,"A",{href:!0});var s_=i(Wn);Cm=a(s_,"LayoutLMv2FeatureExtractor"),s_.forEach(t),Im=a(q," was initialized with "),zs=r(q,"CODE",{});var r_=i(zs);Am=a(r_,"apply_ocr"),r_.forEach(t),Dm=a(q," set to "),qs=r(q,"CODE",{});var i_=i(qs);Om=a(i_,"True"),i_.forEach(t),Nm=a(q,`, it passes the obtained words and
bounding boxes along with the additional arguments to `),kt=r(q,"A",{href:!0});var Ch=i(kt);Fs=r(Ch,"STRONG",{});var l_=i(Fs);Sm=a(l_,"call"),l_.forEach(t),Rm=a(Ch,"()"),Ch.forEach(t),Um=a(q,` and returns the output,
together with resized `),Ps=r(q,"CODE",{});var c_=i(Ps);Bm=a(c_,"images"),c_.forEach(t),Wm=a(q,". In case "),Vn=r(q,"A",{href:!0});var d_=i(Vn);Vm=a(d_,"LayoutLMv2FeatureExtractor"),d_.forEach(t),Qm=a(q," was initialized with "),js=r(q,"CODE",{});var u_=i(js);Gm=a(u_,"apply_ocr"),u_.forEach(t),Hm=a(q,` set to
`),Cs=r(q,"CODE",{});var m_=i(Cs);Km=a(m_,"False"),m_.forEach(t),Xm=a(q,", it passes the words ("),Is=r(q,"CODE",{});var p_=i(Is);Ym=a(p_,"text"),p_.forEach(t),Zm=a(q,"/"),As=r(q,"CODE",{});var h_=i(As);Jm=a(h_,"text_pair`) and `boxes` specified by the user along with the additional arguments to [__call__()](/docs/transformers/main/en/model_doc/layoutlmv2#transformers.LayoutLMv2Tokenizer.__call__) and returns the output, together with resized `images"),h_.forEach(t),ep=a(q,"."),q.forEach(t),op=m(aa),Ds=r(aa,"P",{});var f_=i(Ds);tp=a(f_,"Please refer to the docstring of the above two methods for more information."),f_.forEach(t),aa.forEach(t),we.forEach(t),Kr=m(o),Ce=r(o,"H2",{class:!0});var xi=i(Ce);to=r(xi,"A",{id:!0,class:!0,href:!0});var g_=i(to);Os=r(g_,"SPAN",{});var __=i(Os);y(xt.$$.fragment,__),__.forEach(t),g_.forEach(t),np=m(xi),Ns=r(xi,"SPAN",{});var v_=i(Ns);ap=a(v_,"LayoutLMv2Model"),v_.forEach(t),xi.forEach(t),Xr=m(o),le=r(o,"DIV",{class:!0});var sa=i(le);y(Tt.$$.fragment,sa),sp=m(sa),Mt=r(sa,"P",{});var Ti=i(Mt);rp=a(Ti,`The bare LayoutLMv2 Model transformer outputting raw hidden-states without any specific head on top.
This model is a PyTorch `),$t=r(Ti,"A",{href:!0,rel:!0});var y_=i($t);ip=a(y_,"torch.nn.Module"),y_.forEach(t),lp=a(Ti,` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),Ti.forEach(t),cp=m(sa),te=r(sa,"DIV",{class:!0});var vo=i(te);y(Et.$$.fragment,vo),dp=m(vo),Ie=r(vo,"P",{});var ra=i(Ie);up=a(ra,"The "),Qn=r(ra,"A",{href:!0});var b_=i(Qn);mp=a(b_,"LayoutLMv2Model"),b_.forEach(t),pp=a(ra," forward method, overrides the "),Ss=r(ra,"CODE",{});var L_=i(Ss);hp=a(L_,"__call__"),L_.forEach(t),fp=a(ra," special method."),ra.forEach(t),gp=m(vo),y(no.$$.fragment,vo),_p=m(vo),y(ao.$$.fragment,vo),vo.forEach(t),sa.forEach(t),Yr=m(o),Ae=r(o,"H2",{class:!0});var Mi=i(Ae);so=r(Mi,"A",{id:!0,class:!0,href:!0});var w_=i(so);Rs=r(w_,"SPAN",{});var k_=i(Rs);y(zt.$$.fragment,k_),k_.forEach(t),w_.forEach(t),vp=m(Mi),Us=r(Mi,"SPAN",{});var x_=i(Us);yp=a(x_,"LayoutLMv2ForSequenceClassification"),x_.forEach(t),Mi.forEach(t),Zr=m(o),Z=r(o,"DIV",{class:!0});var yo=i(Z);y(qt.$$.fragment,yo),bp=m(yo),Ft=r(yo,"P",{});var $i=i(Ft);Lp=a($i,`LayoutLMv2 Model with a sequence classification head on top (a linear layer on top of the concatenation of the
final hidden state of the [CLS] token, average-pooled initial visual embeddings and average-pooled final visual
embeddings, e.g. for document image classification tasks such as the
...
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),Ei.forEach(t),Ep=m(yo),ne=r(yo,"DIV",{class:!0});var bo=i(ne);y(It.$$.fragment,bo),zp=m(bo),De=r(bo,"P",{});var ia=i(De);qp=a(ia,"The "),Gn=r(ia,"A",{href:!0});var $_=i(Gn);Fp=a($_,"LayoutLMv2ForSequenceClassification"),$_.forEach(t),Pp=a(ia," forward method, overrides the "),Bs=r(ia,"CODE",{});var E_=i(Bs);jp=a(E_,"__call__"),E_.forEach(t),Cp=a(ia," special method."),ia.forEach(t),Ip=m(bo),y(ro.$$.fragment,bo),Ap=m(bo),y(io.$$.fragment,bo),bo.forEach(t),yo.forEach(t),Jr=m(o),Oe=r(o,"H2",{class:!0});var zi=i(Oe);lo=r(zi,"A",{id:!0,class:!0,href:!0});var z_=i(lo);Ws=r(z_,"SPAN",{});var q_=i(Ws);y(At.$$.fragment,q_),q_.forEach(t),z_.forEach(t),Dp=m(zi),Vs=r(zi,"SPAN",{});var F_=i(Vs);Op=a(F_,"LayoutLMv2ForTokenClassification"),F_.forEach(t),zi.forEach(t),ei=m(o),J=r(o,"DIV",{class:!0});var Lo=i(J);y(Dt.$$.fragment,Lo),Np=m(Lo),ee=r(Lo,"P",{});var ke=i(ee);Sp=a(ke,`LayoutLMv2 Model with a token classification head on top (a linear layer on top of the text part of the hidden
states) e.g. for sequence labeling (information extraction) tasks such as
...
`),St=r(ke,"A",{href:!0,rel:!0});var C_=i(St);Vp=a(C_,"CORD"),C_.forEach(t),Qp=a(ke," and "),Rt=r(ke,"A",{href:!0,rel:!0});var I_=i(Rt);Gp=a(I_,"Kleister-NDA"),I_.forEach(t),Hp=a(ke,"."),ke.forEach(t),Kp=m(Lo),Ut=r(Lo,"P",{});var qi=i(Ut);Xp=a(qi,"This model is a PyTorch "),Bt=r(qi,"A",{href:!0,rel:!0});var A_=i(Bt);Yp=a(A_,"torch.nn.Module"),A_.forEach(t),Zp=a(qi,` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),qi.forEach(t),Jp=m(Lo),ae=r(Lo,"DIV",{class:!0});var wo=i(ae);y(Wt.$$.fragment,wo),eh=m(wo),Ne=r(wo,"P",{});var la=i(Ne);oh=a(la,"The "),Hn=r(la,"A",{href:!0});var D_=i(Hn);th=a(D_,"LayoutLMv2ForTokenClassification"),D_.forEach(t),nh=a(la," forward method, overrides the "),Qs=r(la,"CODE",{});var O_=i(Qs);ah=a(O_,"__call__"),O_.forEach(t),sh=a(la," special method."),la.forEach(t),rh=m(wo),y(co.$$.fragment,wo),ih=m(wo),y(uo.$$.fragment,wo),wo.forEach(t),Lo.forEach(t),oi=m(o),Se=r(o,"H2",{class:!0});var Fi=i(Se);mo=r(Fi,"A",{id:!0,class:!0,href:!0});var N_=i(mo);Gs=r(N_,"SPAN",{});var S_=i(Gs);y(Vt.$$.fragment,S_),S_.forEach(t),N_.forEach(t),lh=m(Fi),Hs=r(Fi,"SPAN",{});var R_=i(Hs);ch=a(R_,"LayoutLMv2ForQuestionAnswering"),R_.forEach(t),Fi.forEach(t),ti=m(o),oe=r(o,"DIV",{class:!0});var ko=i(oe);y(Qt.$$.fragment,ko),dh=m(ko),ce=r(ko,"P",{});var xo=i(ce);uh=a(xo,`LayoutLMv2 Model with a span classification head on top for extractive question-answering tasks such as
