...
<span class="hljs-meta">&gt;&gt;&gt; </span>loss = outputs.loss
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-built_in">round</span>(loss.item(), <span class="hljs-number">2</span>)
<span class="hljs-number">0.86</span>`}}),{c(){w(l.$$.fragment)},l(c){v(l.$$.fragment,c)},m(c,u){$(l,c,u),_=!0},p:Je,i(c){_||(C(l.$$.fragment,c),_=!0)},o(c){F(l.$$.fragment,c),_=!1},d(c){E(l,c)}}}function $T(q){let l,_,c,u,y,d,m,x,Te,he,I,re,ee,T,we,Q,ve,ue,W,$e,le,V,Ce,fe,B,Fe,ge,U,pe,Ee,ne,j,O,_e,K,de,Me,H,ze,qe,L,se,J,ce,xe,G,me,je,D,be,S,ie,te,P,Pe,N,Le,ke;return{c(){l=a("p"),_=o("TensorFlow models and layers in "),c=a("code"),u=o("transformers"),y=o(" accept two formats as input:"),d=p(),m=a("ul"),x=a("li"),Te=o("having all inputs as keyword arguments (like PyTorch models), or"),he=p(),I=a("li"),re=o("having all inputs as a list, tuple or dict in the first positional argument."),ee=p(),T=a("p"),we=o(`The reason the second format is supported is that Keras methods prefer this format when passing inputs to models
...
pass your inputs and labels in any format that `),W=a("code"),$e=o("model.fit()"),le=o(` supports! If, however, you want to use the second
format outside of Keras methods like `),V=a("code"),Ce=o("fit()"),fe=o(" and "),B=a("code"),Fe=o("predict()"),ge=o(`, such as when creating your own layers or models with
...
about any of this, as you can just pass inputs like you would to any other Python function!`),this.h()},l(f){l=r(f,"P",{});var M=i(l);_=n(M,"TensorFlow models and layers in "),c=r(M,"CODE",{});var We=i(c);u=n(We,"transformers"),We.forEach(t),y=n(M," accept two formats as input:"),M.forEach(t),d=h(f),m=r(f,"UL",{});var Y=i(m);x=r(Y,"LI",{});var Re=i(x);Te=n(Re,"having all inputs as keyword arguments (like PyTorch models), or"),Re.forEach(t),he=h(Y),I=r(Y,"LI",{});var Ae=i(I);re=n(Ae,"having all inputs as a list, tuple or dict in the first positional argument."),Ae.forEach(t),Y.forEach(t),ee=h(f),T=r(f,"P",{});var z=i(T);we=n(z,`The reason the second format is supported is that Keras methods prefer this format when passing inputs to models
and layers. Because of this support, when using methods like `),Q=r(z,"CODE",{});var Be=i(Q);ve=n(Be,"model.fit()"),Be.forEach(t),ue=n(z,` things should \u201Cjust work\u201D for you - just
pass your inputs and labels in any format that `),W=r(z,"CODE",{});var Oe=i(W);$e=n(Oe,"model.fit()"),Oe.forEach(t),le=n(z,` supports! If, however, you want to use the second
format outside of Keras methods like `),V=r(z,"CODE",{});var Ue=i(V);Ce=n(Ue,"fit()"),Ue.forEach(t),fe=n(z," and "),B=r(z,"CODE",{});var Ke=i(B);Fe=n(Ke,"predict()"),Ke.forEach(t),ge=n(z,`, such as when creating your own layers or models with
...
positional argument:`),z.forEach(t),ne=h(f),j=r(f,"UL",{});var A=i(j);O=r(A,"LI",{});var R=i(O);_e=n(R,"a single Tensor with "),K=r(R,"CODE",{});var De=i(K);de=n(De,"input_ids"),De.forEach(t),Me=n(R," only and nothing else: "),H=r(R,"CODE",{});var Ne=i(H);ze=n(Ne,"model(input_ids)"),Ne.forEach(t),R.forEach(t),qe=h(A),L=r(A,"LI",{});var X=i(L);se=n(X,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
...
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-comment"># the linear classifier still needs to be trained</span>
<span class="hljs-meta">&gt;&gt;&gt; </span>logits = outputs.logits`}}),{c(){l=a("p"),_=o("Example:"),c=p(),w(u.$$.fragment)},l(d){l=r(d,"P",{});var m=i(l);_=n(m,"Example:"),m.forEach(t),c=h(d),v(u.$$.fragment,d)},m(d,m){b(d,l,m),e(l,_),b(d,c,m),$(u,d,m),y=!0},p:Je,i(d){y||(C(u.$$.fragment,d),y=!0)},o(d){F(u.$$.fragment,d),y=!1},d(d){d&&t(l),d&&t(c),E(u,d)}}}function WT(q){let l,_,c,u,y,d,m,x,Te,he,I,re,ee,T,we,Q,ve,ue,W,$e,le,V,Ce,fe,B,Fe,ge,U,pe,Ee,ne,j,O,_e,K,de,Me,H,ze,qe,L,se,J,ce,xe,G,me,je,D,be,S,ie,te,P,Pe,N,Le,ke;return{c(){l=a("p"),_=o("TensorFlow models and layers in "),c=a("code"),u=o("transformers"),y=o(" accept two formats as input:"),d=p(),m=a("ul"),x=a("li"),Te=o("having all inputs as keyword arguments (like PyTorch models), or"),he=p(),I=a("li"),re=o("having all inputs as a list, tuple or dict in the first positional argument."),ee=p(),T=a("p"),we=o(`The reason the second format is supported is that Keras methods prefer this format when passing inputs to models
and layers. Because of this support, when using methods like `),Q=a("code"),ve=o("model.fit()"),ue=o(` things should \u201Cjust work\u201D for you - just
pass your inputs and labels in any format that `),W=a("code"),$e=o("model.fit()"),le=o(` supports! If, however, you want to use the second
format outside of Keras methods like `),V=a("code"),Ce=o("fit()"),fe=o(" and "),B=a("code"),Fe=o("predict()"),ge=o(`, such as when creating your own layers or models with
the Keras `),U=a("code"),pe=o("Functional"),Ee=o(` API, there are three possibilities you can use to gather all the input Tensors in the first
...
`),S=r(ye,"CODE",{});var oe=i(S);ie=n(oe,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),oe.forEach(t),ye.forEach(t),A.forEach(t),te=h(f),P=r(f,"P",{});var Z=i(P);Pe=n(Z,`Note that when creating models and layers with
`),N=r(Z,"A",{href:!0,rel:!0});var Qe=i(N);Le=n(Qe,"subclassing"),Qe.forEach(t),ke=n(Z,` then you don\u2019t need to worry
about any of this, as you can just pass inputs like you would to any other Python function!`),Z.forEach(t),this.h()},h(){g(N,"href","https://keras.io/guides/making_new_layers_and_models_via_subclassing/"),g(N,"rel","nofollow")},m(f,M){b(f,l,M),e(l,_),e(l,c),e(c,u),e(l,y),b(f,d,M),b(f,m,M),e(m,x),e(x,Te),e(m,he),e(m,I),e(I,re),b(f,ee,M),b(f,T,M),e(T,we),e(T,Q),e(Q,ve),e(T,ue),e(T,W),e(W,$e),e(T,le),e(T,V),e(V,Ce),e(T,fe),e(T,B),e(B,Fe),e(T,ge),e(T,U),e(U,pe),e(T,Ee),b(f,ne,M),b(f,j,M),e(j,O),e(O,_e),e(O,K),e(K,de),e(O,Me),e(O,H),e(H,ze),e(j,qe),e(j,L),e(L,se),e(L,J),e(J,ce),e(L,xe),e(L,G),e(G,me),e(j,je),e(j,D),e(D,be),e(D,S),e(S,ie),b(f,te,M),b(f,P,M),e(P,Pe),e(P,N),e(N,Le),e(P,ke)},d(f){f&&t(l),f&&t(d),f&&t(m),f&&t(ee),f&&t(T),f&&t(ne),f&&t(j),f&&t(te),f&&t(P)}}}function RT(q){let l,_,c,u,y;return{c(){l=a("p"),_=o("Although the recipe for forward pass needs to be defined within this function, one should call the "),c=a("code"),u=o("Module"),y=o(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(d){l=r(d,"P",{});var m=i(l);_=n(m,"Although the recipe for forward pass needs to be defined within this function, one should call the "),c=r(m,"CODE",{});var x=i(c);u=n(x,"Module"),x.forEach(t),y=n(m,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),m.forEach(t)},m(d,m){b(d,l,m),e(l,_),e(l,c),e(c,u),e(l,y)},d(d){d&&t(l)}}}function BT(q){let l,_,c,u,y;return u=new Ge({props:{code:`from transformers import CamembertTokenizer, TFCamembertForTokenClassification
import tensorflow as tf
...
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-built_in">round</span>(<span class="hljs-built_in">float</span>(loss), <span class="hljs-number">2</span>)
<span class="hljs-number">0.86</span>`}}),{c(){w(l.$$.fragment)},l(c){v(l.$$.fragment,c)},m(c,u){$(l,c,u),_=!0},p:Je,i(c){_||(C(l.$$.fragment,c),_=!0)},o(c){F(l.$$.fragment,c),_=!1},d(c){E(l,c)}}}function JT(q){let l,_,c,u,y,d,m,x,Te,he,I,re,ee,T,we,Q,ve,ue,W,$e,le,V,Ce,fe,B,Fe,ge,U,pe,Ee,ne,j,O,_e,K,de,Me,H,ze,qe,L,se,J,ce,xe,G,me,je,D,be,S,ie,te,P,Pe,N,Le,ke,f,M,We,Y,Re,Ae,z,Be,Oe,Ue,Ke,Se,A,R,De,Ne,X,Ie,He,ye,oe,Z,Qe,Wt,Kc,cr,Hc,Qc,mr,Vc,Jc,ss,Gc,Xc,Yc,as,Zc,pr,em,tm,om,Bt,rs,nm,hi,sm,am,is,hr,rm,ui,im,lm,ur,dm,fi,cm,mm,So,ls,pm,ds,hm,gi,um,fm,gm,Wo,cs,_m,_i,bm,km,fr,ms,ud,ro,Ro,bi,ps,ym,ki,Tm,fd,mt,hs,wm,Et,vm,yi,$m,Cm,gr,Fm,Em,_r,Mm,zm,us,qm,xm,jm,fs,Pm,br,Lm,Om,Nm,Ut,gs,Am,Ti,Dm,Im,_s,kr,Sm,wi,Wm,Rm,yr,Bm,vi,Um,Km,Bo,bs,Hm,$i,Qm,gd,io,Uo,Ci,ks,Vm,Fi,Jm,_d,Xe,ys,Gm,Ei,Xm,Ym,Ts,Zm,Tr,ep,tp,op,ws,np,vs,sp,ap,rp,$s,ip,Mi,lp,dp,cp,tt,mp,zi,pp,hp,qi,up,fp,xi,gp,_p,ji,bp,kp,Pi,yp,Tp,Li,wp,vp,$p,Ko,Cp,Oi,Fp,Ep,Cs,Mp,zp,Mt,Fs,qp,lo,xp,wr,jp,Pp,Ni,Lp,Op,Np,Ho,Ap,Qo,bd,co,Vo,Ai,Es,Dp,Di,Ip,kd,pt,Ms,Sp,zs,Wp,Ii,Rp,Bp,Up,qs,Kp,vr,Hp,Qp,Vp,xs,Jp,js,Gp,Xp,Yp,zt,Ps,Zp,mo,eh,$r,th,oh,Si,nh,sh,ah,Jo,rh,Go,yd,po,Xo,Wi,Ls,ih,Ri,lh,Td,ht,Os,dh,Ns,ch,Bi,mh,ph,hh,As,uh,Cr,fh,gh,_h,Ds,bh,Is,kh,yh,Th,bt,Ss,wh,ho,vh,Fr,$h,Ch,Ui,Fh,Eh,Mh,Yo,zh,Zo,qh,en,wd,uo,tn,Ki,Ws,xh,Hi,jh,vd,ut,Rs,Ph,Qi,Lh,Oh,Bs,Nh,Er,Ah,Dh,Ih,Us,Sh,Ks,Wh,Rh,Bh,et,Hs,Uh,fo,Kh,Mr,Hh,Qh,Vi,Vh,Jh,Gh,on,Xh,nn,Yh,sn,Zh,an,eu,rn,$d,go,ln,Ji,Qs,tu,Gi,ou,Cd,ft,Vs,nu,Xi,su,au,Js,ru,zr,iu,lu,du,Gs,cu,Xs,mu,pu,hu,qt,Ys,uu,_o,fu,qr,gu,_u,Yi,bu,ku,yu,dn,Tu,cn,Fd,bo,mn,Zi,Zs,wu,el,vu,Ed,gt,ea,$u,tl,Cu,Fu,ta,Eu,xr,Mu,zu,qu,oa,xu,na,ju,Pu,Lu,kt,sa,Ou,ko,Nu,jr,Au,Du,ol,Iu,Su,Wu,pn,Ru,hn,Bu,un,Md,yo,fn,nl,aa,Uu,sl,Ku,zd,_t,ra,Hu,gn,Qu,al,Vu,Ju,rl,Gu,Xu,ia,Yu,Pr,Zu,ef,tf,la,of,da,nf,sf,af,yt,ca,rf,To,lf,Lr,df,cf,il,mf,pf,hf,_n,uf,bn,ff,kn,qd,wo,yn,ll,ma,gf,dl,_f,xd,ot,pa,bf,cl,kf,yf,ha,Tf,Or,wf,vf,$f,ua,Cf,fa,Ff,Ef,Mf,Tn,zf,xt,ga,qf,vo,xf,Nr,jf,Pf,ml,Lf,Of,Nf,wn,Af,vn,jd,$o,$n,pl,_a,Df,hl,If,Pd,nt,ba,Sf,ka,Wf,ul,Rf,Bf,Uf,ya,Kf,Ar,Hf,Qf,Vf,Ta,Jf,wa,Gf,Xf,Yf,Cn,Zf,jt,va,eg,Co,tg,Dr,og,ng,fl,sg,ag,rg,Fn,ig,En,Ld,Fo,Mn,gl,$a,lg,_l,dg,Od,st,Ca,cg,Fa,mg,bl,pg,hg,ug,Ea,fg,Ir,gg,_g,bg,Ma,kg,za,yg,Tg,wg,zn,vg,Tt,qa,$g,Eo,Cg,Sr,Fg,Eg,kl,Mg,zg,qg,qn,xg,xn,jg,jn,Nd,Mo,Pn,yl,xa,Pg,Tl,Lg,Ad,at,ja,Og,wl,Ng,Ag,Pa,Dg,Wr,Ig,Sg,Wg,La,Rg,Oa,Bg,Ug,Kg,Ln,Hg,wt,Na,Qg,zo,Vg,Rr,Jg,Gg,vl,Xg,Yg,Zg,On,e_,Nn,t_,An,Dd,qo,Dn,$l,Aa,o_,Cl,n_,Id,rt,Da,s_,Fl,a_,r_,Ia,i_,Br,l_,d_,c_,Sa,m_,Wa,p_,h_,u_,In,f_,Pt,Ra,g_,xo,__,Ur,b_,k_,El,y_,T_,w_,Sn,v_,Wn,Sd,jo,Rn,Ml,Ba,$_,zl,C_,Wd,it,Ua,F_,ql,E_,M_,Ka,z_,Kr,q_,x_,j_,Ha,P_,Qa,L_,O_,N_,Bn,A_,vt,Va,D_,Po,I_,Hr,S_,W_,xl,R_,B_,U_,Un,K_,Kn,H_,Hn,Rd,Lo,Qn,jl,Ja,Q_,Pl,V_,Bd,lt,Ga,J_,Oo,G_,Ll,X_,Y_,Ol,Z_,eb,tb,Xa,ob,Qr,nb,sb,ab,Ya,rb,Za,ib,lb,db,Vn,cb,$t,er,mb,No,pb,Vr,hb,ub,Nl,fb,gb,_b,Jn,bb,Gn,kb,Xn,Ud;return d=new Ze({}),T=new Ze({}),P=new Ze({}),M=new ae({props:{name:"class transformers.CamembertConfig",anchor:"transformers.CamembertConfig",parameters:[{name:"pad_token_id",val:" = 1"},{name:"bos_token_id",val:" = 0"},{name:"eos_token_id",val:" = 2"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/camembert/configuration_camembert.py#L39"}}),Ne=new Ze({}),Z=new ae({props:{name:"class transformers.CamembertTokenizer",anchor:"transformers.CamembertTokenizer",parameters:[{name:"vocab_file",val:""},{name:"bos_token",val:" = '<s>'"},{name:"eos_token",val:" = '</s>'"},{name:"sep_token",val:" = '</s>'"},{name:"cls_token",val:" = '<s>'"},{name:"unk_token",val:" = '<unk>'"},{name:"pad_token",val:" = '<pad>'"},{name:"mask_token",val:" = '<mask>'"},{name:"additional_special_tokens",val:" = ['<s>NOTUSED', '</s>NOTUSED']"},{name:"sp_model_kwargs",val:": typing.Union[typing.Dict[str, typing.Any], NoneType] = None"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.CamembertTokenizer.vocab_file",description:`<strong>vocab_file</strong> (<code>str</code>) &#x2014;
...
model. Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/main/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/camembert/modeling_camembert.py#L1418"}}),Ps=new ae({props:{name:"forward",anchor:"transformers.CamembertForCausalLM.forward",parameters:[{name:"input_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"attention_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"token_type_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"position_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"head_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"encoder_hidden_states",val:": typing.Optional[torch.FloatTensor] = None"},{name:"encoder_attention_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"labels",val:": typing.Optional[torch.LongTensor] = None"},{name:"past_key_values",val:": typing.Tuple[typing.Tuple[torch.FloatTensor]] = None"},{name:"use_cache",val:": typing.Optional[bool] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.CamembertForCausalLM.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/main/en/model_doc/camembert#transformers.CamembertTokenizer">CamembertTokenizer</a>. See <a href="/docs/transformers/main/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/main/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
`}}),Yo=new Ye({props:{$$slots:{default:[lT]},$$scope:{ctx:q}}}),Zo=new Ve({props:{anchor:"transformers.CamembertForMaskedLM.forward.example",$$slots:{default:[dT]},$$scope:{ctx:q}}}),en=new Ve({props:{anchor:"transformers.CamembertForMaskedLM.forward.example-2",$$slots:{default:[cT]},$$scope:{ctx:q}}}),Ws=new Ze({}),Rs=new ae({props:{name:"class transformers.CamembertForSequenceClassification",anchor:"transformers.CamembertForSequenceClassification",parameters:[{name:"config",val:""}],parametersDescription:[{anchor:"transformers.CamembertForSequenceClassification.config",description:`<strong>config</strong> (<a href="/docs/transformers/main/en/model_doc/camembert#transformers.CamembertConfig">CamembertConfig</a>) &#x2014; Model configuration class with all the parameters of the
model. Initializing with a config file does not load the weights associated with the model, only the
...
model. Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/main/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/camembert/modeling_camembert.py#L1132"}}),Ys=new ae({props:{name:"forward",anchor:"transformers.CamembertForMultipleChoice.forward",parameters:[{name:"input_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"token_type_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"attention_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"labels",val:": typing.Optional[torch.LongTensor] = None"},{name:"position_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"head_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.CamembertForMultipleChoice.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, num_choices, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/main/en/model_doc/camembert#transformers.CamembertTokenizer">CamembertTokenizer</a>. See <a href="/docs/transformers/main/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/main/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
model. Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/main/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/camembert/modeling_camembert.py#L1228"}}),sa=new ae({props:{name:"forward",anchor:"transformers.CamembertForTokenClassification.forward",parameters:[{name:"input_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"attention_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"token_type_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"position_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"head_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"labels",val:": typing.Optional[torch.LongTensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.CamembertForTokenClassification.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/main/en/model_doc/camembert#transformers.CamembertTokenizer">CamembertTokenizer</a>. See <a href="/docs/transformers/main/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/main/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/main/en/model_doc/camembert#transformers.CamembertTokenizer">CamembertTokenizer</a>. See <a href="/docs/transformers/main/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
...
`}}),Sn=new Ye({props:{$$slots:{default:[IT]},$$scope:{ctx:q}}}),Wn=new Ve({props:{anchor:"transformers.TFCamembertForMultipleChoice.call.example",$$slots:{default:[ST]},$$scope:{ctx:q}}}),Ba=new Ze({}),Ua=new ae({props:{name:"class transformers.TFCamembertForTokenClassification",anchor:"transformers.TFCamembertForTokenClassification",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.TFCamembertForTokenClassification.config",description:`<strong>config</strong> (<a href="/docs/transformers/main/en/model_doc/camembert#transformers.CamembertConfig">CamembertConfig</a>) &#x2014; Model configuration class with all the parameters of the
model. Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/main/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/camembert/modeling_tf_camembert.py#L1279"}}),Bn=new Ye({props:{$$slots:{default:[WT]},$$scope:{ctx:q}}}),Va=new ae({props:{name:"call",anchor:"transformers.TFCamembertForTokenClassification.call",parameters:[{name:"input_ids",val:": typing.Union[typing.List[tensorflow.python.framework.ops.Tensor], typing.List[numpy.ndarray], typing.List[tensorflow.python.keras.engine.keras_tensor.KerasTensor], typing.Dict[str, tensorflow.python.framework.ops.Tensor], typing.Dict[str, numpy.ndarray], typing.Dict[str, tensorflow.python.keras.engine.keras_tensor.KerasTensor], tensorflow.python.framework.ops.Tensor, numpy.ndarray, tensorflow.python.keras.engine.keras_tensor.KerasTensor, NoneType] = None"},{name:"attention_mask",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"token_type_ids",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"position_ids",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"head_mask",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"inputs_embeds",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"labels",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"training",val:": typing.Optional[bool] = False"}],parametersDescription:[{anchor:"transformers.TFCamembertForTokenClassification.call.input_ids",description:`<strong>input_ids</strong> (<code>Numpy array</code> or <code>tf.Tensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/main/en/model_doc/camembert#transformers.CamembertTokenizer">CamembertTokenizer</a>. See <a href="/docs/transformers/main/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
<a href="/docs/transformers/main/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> for details.</p>
...
`}}),Un=new Ye({props:{$$slots:{default:[RT]},$$scope:{ctx:q}}}),Kn=new Ve({props:{anchor:"transformers.TFCamembertForTokenClassification.call.example",$$slots:{default:[BT]},$$scope:{ctx:q}}}),Hn=new Ve({props:{anchor:"transformers.TFCamembertForTokenClassification.call.example-2",$$slots:{default:[UT]},$$scope:{ctx:q}}}),Ja=new Ze({}),Ga=new ae({props:{name:"class transformers.TFCamembertForQuestionAnswering",anchor:"transformers.TFCamembertForQuestionAnswering",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.TFCamembertForQuestionAnswering.config",description:`<strong>config</strong> (<a href="/docs/transformers/main/en/model_doc/camembert#transformers.CamembertConfig">CamembertConfig</a>) &#x2014; Model configuration class with all the parameters of the
model. Initializing with a config file does not load the weights associated with the model, only the
...
`}}),Jn=new Ye({props:{$$slots:{default:[HT]},$$scope:{ctx:q}}}),Gn=new Ve({props:{anchor:"transformers.TFCamembertForQuestionAnswering.call.example",$$slots:{default:[QT]},$$scope:{ctx:q}}}),Xn=new Ve({props:{anchor:"transformers.TFCamembertForQuestionAnswering.call.example-2",$$slots:{default:[VT]},$$scope:{ctx:q}}}),{c(){l=a("meta"),_=p(),c=a("h1"),u=a("a"),y=a("span"),w(d.$$.fragment),m=p(),x=a("span"),Te=o("CamemBERT"),he=p(),I=a("h2"),re=a("a"),ee=a("span"),w(T.$$.fragment),we=p(),Q=a("span"),ve=o("Overview"),ue=p(),W=a("p"),$e=o("The CamemBERT model was proposed in "),le=a("a"),V=o("CamemBERT: a Tasty French Language Model"),Ce=o(` by
...
trained on 138GB of French text.`),fe=p(),B=a("p"),Fe=o("The abstract from the paper is the following:"),ge=p(),U=a("p"),pe=a("em"),Ee=o(`Pretrained language models are now ubiquitous in Natural Language Processing. Despite their success, most available
...
as well as the information relative to the inputs and outputs.`),L=p(),se=a("p"),J=o("This model was contributed by "),ce=a("a"),xe=o("camembert"),G=o(". The original code can be found "),me=a("a"),je=o("here"),D=o("."),be=p(),S=a("h2"),ie=a("a"),te=a("span"),w(P.$$.fragment),Pe=p(),N=a("span"),Le=o("CamembertConfig"),ke=p(),f=a("div"),w(M.$$.fragment),We=p(),Y=a("p"),Re=o("This class overrides "),Ae=a("a"),z=o("RobertaConfig"),Be=o(`. Please check the superclass for the appropriate documentation alongside
usage examples. Instantiating a configuration with the defaults will yield a similar configuration to that of the
Camembert `),Oe=a("a"),Ue=o("camembert-base"),Ke=o(" architecture."),Se=p(),A=a("h2"),R=a("a"),De=a("span"),w(Ne.$$.fragment),X=p(),Ie=a("span"),He=o("CamembertTokenizer"),ye=p(),oe=a("div"),w(Z.$$.fragment),Qe=p(),Wt=a("p"),Kc=o("Adapted from "),cr=a("a"),Hc=o("RobertaTokenizer"),Qc=o(" and "),mr=a("a"),Vc=o("XLNetTokenizer"),Jc=o(`. Construct a CamemBERT tokenizer. Based on
...
this superclass for more information regarding those methods.`),om=p(),Bt=a("div"),w(rs.$$.fragment),nm=p(),hi=a("p"),sm=o(`Build model inputs from a sequence or a pair of sequence for sequence classification tasks by concatenating and
...
special tokens using the tokenizer `),gi=a("code"),um=o("prepare_for_model"),fm=o(" method."),gm=p(),Wo=a("div"),w(cs.$$.fragment),_m=p(),_i=a("p"),bm=o(`Create a mask from the two sequences passed to be used in a sequence-pair classification task. CamemBERT, like
RoBERTa, does not make use of token type ids, therefore a list of zeros is returned.`),km=p(),fr=a("div"),w(ms.$$.fragment),ud=p(),ro=a("h2"),Ro=a("a"),bi=a("span"),w(ps.$$.fragment),ym=p(),ki=a("span"),Tm=o("CamembertTokenizerFast"),fd=p(),mt=a("div"),w(hs.$$.fragment),wm=p(),Et=a("p"),vm=o("Construct a \u201Cfast\u201D CamemBERT tokenizer (backed by HuggingFace\u2019s "),yi=a("em"),$m=o("tokenizers"),Cm=o(` library). Adapted from
...
adding special tokens. An CamemBERT sequence has the following format:`),Im=p(),_s=a("ul"),kr=a("li"),Sm=o("single sequence: "),wi=a("code"),Wm=o("<s> X </s>"),Rm=p(),yr=a("li"),Bm=o("pair of sequences: "),vi=a("code"),Um=o("<s> A </s></s> B </s>"),Km=p(),Bo=a("div"),w(bs.$$.fragment),Hm=p(),$i=a("p"),Qm=o(`Create a mask from the two sequences passed to be used in a sequence-pair classification task. CamemBERT, like
...
`),ji=a("code"),bp=o("add_cross_attention"),kp=o(" set to "),Pi=a("code"),yp=o("True"),Tp=o("; an "),Li=a("code"),wp=o("encoder_hidden_states"),vp=o(" is then expected as an input to the forward pass."),$p=p(),Ko=a("p"),Cp=o(".. _"),Oi=a("em"),Fp=o("Attention is all you need"),Ep=o(": "),Cs=a("a"),Mp=o("https://arxiv.org/abs/1706.03762"),zp=p(),Mt=a("div"),w(Fs.$$.fragment),qp=p(),lo=a("p"),xp=o("The "),wr=a("a"),jp=o("CamembertModel"),Pp=o(" forward method, overrides the "),Ni=a("code"),Lp=o("__call__"),Op=o(" special method."),Np=p(),w(Ho.$$.fragment),Ap=p(),w(Qo.$$.fragment),bd=p(),co=a("h2"),Vo=a("a"),Ai=a("span"),w(Es.$$.fragment),Dp=p(),Di=a("span"),Ip=o("CamembertForCausalLM"),kd=p(),pt=a("div"),w(Ms.$$.fragment),Sp=p(),zs=a("p"),Wp=o("CamemBERT Model with a "),Ii=a("code"),Rp=o("language modeling"),Bp=o(" head on top for CLM fine-tuning."),Up=p(),qs=a("p"),Kp=o("This model inherits from "),vr=a("a"),Hp=o("PreTrainedModel"),Qp=o(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Vp=p(),xs=a("p"),Jp=o("This model is also a PyTorch "),js=a("a"),Gp=o("torch.nn.Module"),Xp=o(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Yp=p(),zt=a("div"),w(Ps.$$.fragment),Zp=p(),mo=a("p"),eh=o("The "),$r=a("a"),th=o("CamembertForCausalLM"),oh=o(" forward method, overrides the "),Si=a("code"),nh=o("__call__"),sh=o(" special method."),ah=p(),w(Jo.$$.fragment),rh=p(),w(Go.$$.fragment),yd=p(),po=a("h2"),Xo=a("a"),Wi=a("span"),w(Ls.$$.fragment),ih=p(),Ri=a("span"),lh=o("CamembertForMaskedLM"),Td=p(),ht=a("div"),w(Os.$$.fragment),dh=p(),Ns=a("p"),ch=o("CamemBERT Model with a "),Bi=a("code"),mh=o("language modeling"),ph=o(" head on top."),hh=p(),As=a("p"),uh=o("This model inherits from "),Cr=a("a"),fh=o("PreTrainedModel"),gh=o(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),_h=p(),Ds=a("p"),bh=o("This model is also a PyTorch "),Is=a("a"),kh=o("torch.nn.Module"),yh=o(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Th=p(),bt=a("div"),w(Ss.$$.fragment),wh=p(),ho=a("p"),vh=o("The "),Fr=a("a"),$h=o("CamembertForMaskedLM"),Ch=o(" forward method, overrides the "),Ui=a("code"),Fh=o("__call__"),Eh=o(" special method."),Mh=p(),w(Yo.$$.fragment),zh=p(),w(Zo.$$.fragment),qh=p(),w(en.$$.fragment),wd=p(),uo=a("h2"),tn=a("a"),Ki=a("span"),w(Ws.$$.fragment),xh=p(),Hi=a("span"),jh=o("CamembertForSequenceClassification"),vd=p(),ut=a("div"),w(Rs.$$.fragment),Ph=p(),Qi=a("p"),Lh=o(`CamemBERT Model transformer with a sequence classification/regression head on top (a linear layer on top of the
pooled output) e.g. for GLUE tasks.`),Oh=p(),Bs=a("p"),Nh=o("This model inherits from "),Er=a("a"),Ah=o("PreTrainedModel"),Dh=o(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Ih=p(),Us=a("p"),Sh=o("This model is also a PyTorch "),Ks=a("a"),Wh=o("torch.nn.Module"),Rh=o(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Bh=p(),et=a("div"),w(Hs.$$.fragment),Uh=p(),fo=a("p"),Kh=o("The "),Mr=a("a"),Hh=o("CamembertForSequenceClassification"),Qh=o(" forward method, overrides the "),Vi=a("code"),Vh=o("__call__"),Jh=o(" special method."),Gh=p(),w(on.$$.fragment),Xh=p(),w(nn.$$.fragment),Yh=p(),w(sn.$$.fragment),Zh=p(),w(an.$$.fragment),eu=p(),w(rn.$$.fragment),$d=p(),go=a("h2"),ln=a("a"),Ji=a("span"),w(Qs.$$.fragment),tu=p(),Gi=a("span"),ou=o("CamembertForMultipleChoice"),Cd=p(),ft=a("div"),w(Vs.$$.fragment),nu=p(),Xi=a("p"),su=o(`CamemBERT Model with a multiple choice classification head on top (a linear layer on top of the pooled output and a
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Lu=p(),kt=a("div"),w(sa.$$.fragment),Ou=p(),ko=a("p"),Nu=o("The "),jr=a("a"),Au=o("CamembertForTokenClassification"),Du=o(" forward method, overrides the "),ol=a("code"),Iu=o("__call__"),Su=o(" special method."),Wu=p(),w(pn.$$.fragment),Ru=p(),w(hn.$$.fragment),Bu=p(),w(un.$$.fragment),Md=p(),yo=a("h2"),fn=a("a"),nl=a("span"),w(aa.$$.fragment),Uu=p(),sl=a("span"),Ku=o("CamembertForQuestionAnswering"),zd=p(),_t=a("div"),w(ra.$$.fragment),Hu=p(),gn=a("p"),Qu=o(`CamemBERT Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
...
behavior.`),Mf=p(),w(Tn.$$.fragment),zf=p(),xt=a("div"),w(ga.$$.fragment),qf=p(),vo=a("p"),xf=o("The "),Nr=a("a"),jf=o("TFCamembertModel"),Pf=o(" forward method, overrides the "),ml=a("code"),Lf=o("__call__"),Of=o(" special method."),Nf=p(),w(wn.$$.fragment),Af=p(),w(vn.$$.fragment),jd=p(),$o=a("h2"),$n=a("a"),pl=a("span"),w(_a.$$.fragment),Df=p(),hl=a("span"),If=o("TFCamembertForCasualLM"),Pd=p(),nt=a("div"),w(ba.$$.fragment),Sf=p(),ka=a("p"),Wf=o("CamemBERT Model with a "),ul=a("code"),Rf=o("language modeling"),Bf=o(" head on top for CLM fine-tuning."),Uf=p(),ya=a("p"),Kf=o("This model inherits from "),Ar=a("a"),Hf=o("TFPreTrainedModel"),Qf=o(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
pooled output) e.g. for GLUE tasks.`),Ag=p(),Pa=a("p"),Dg=o("This model inherits from "),Wr=a("a"),Ig=o("TFPreTrainedModel"),Sg=o(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Wg=p(),La=a("p"),Rg=o("This model is also a "),Oa=a("a"),Bg=o("tf.keras.Model"),Ug=o(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Kg=p(),w(Ln.$$.fragment),Hg=p(),wt=a("div"),w(Na.$$.fragment),Qg=p(),zo=a("p"),Vg=o("The "),Rr=a("a"),Jg=o("TFCamembertForSequenceClassification"),Gg=o(" forward method, overrides the "),vl=a("code"),Xg=o("__call__"),Yg=o(" special method."),Zg=p(),w(On.$$.fragment),e_=p(),w(Nn.$$.fragment),t_=p(),w(An.$$.fragment),Dd=p(),qo=a("h2"),Dn=a("a"),$l=a("span"),w(Aa.$$.fragment),o_=p(),Cl=a("span"),n_=o("TFCamembertForMultipleChoice"),Id=p(),rt=a("div"),w(Da.$$.fragment),s_=p(),Fl=a("p"),a_=o(`CamemBERT Model with a multiple choice classification head on top (a linear layer on top of the pooled output and a
softmax) e.g. for RocStories/SWAG tasks.`),r_=p(),Ia=a("p"),i_=o("This model inherits from "),Br=a("a"),l_=o("TFPreTrainedModel"),d_=o(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),c_=p(),Sa=a("p"),m_=o("This model is also a "),Wa=a("a"),p_=o("tf.keras.Model"),h_=o(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),u_=p(),w(In.$$.fragment),f_=p(),Pt=a("div"),w(Ra.$$.fragment),g_=p(),xo=a("p"),__=o("The "),Ur=a("a"),b_=o("TFCamembertForMultipleChoice"),k_=o(" forward method, overrides the "),El=a("code"),y_=o("__call__"),T_=o(" special method."),w_=p(),w(Sn.$$.fragment),v_=p(),w(Wn.$$.fragment),Sd=p(),jo=a("h2"),Rn=a("a"),Ml=a("span"),w(Ba.$$.fragment),$_=p(),zl=a("span"),C_=o("TFCamembertForTokenClassification"),Wd=p(),it=a("div"),w(Ua.$$.fragment),F_=p(),ql=a("p"),E_=o(`CamemBERT Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g.
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),N_=p(),w(Bn.$$.fragment),A_=p(),vt=a("div"),w(Va.$$.fragment),D_=p(),Po=a("p"),I_=o("The "),Hr=a("a"),S_=o("TFCamembertForTokenClassification"),W_=o(" forward method, overrides the "),xl=a("code"),R_=o("__call__"),B_=o(" special method."),U_=p(),w(Un.$$.fragment),K_=p(),w(Kn.$$.fragment),H_=p(),w(Hn.$$.fragment),Rd=p(),Lo=a("h2"),Qn=a("a"),jl=a("span"),w(Ja.$$.fragment),Q_=p(),Pl=a("span"),V_=o("TFCamembertForQuestionAnswering"),Bd=p(),lt=a("div"),w(Ga.$$.fragment),J_=p(),Oo=a("p"),G_=o(`CamemBERT Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
...
as well as the information relative to the inputs and outputs.`),sr.forEach(t),Vl.forEach(t),L=h(s),se=r(s,"P",{});var Ao=i(se);J=n(Ao,"This model was contributed by "),ce=r(Ao,"A",{href:!0,rel:!0});var Gl=i(ce);xe=n(Gl,"camembert"),Gl.forEach(t),G=n(Ao,". The original code can be found "),me=r(Ao,"A",{href:!0,rel:!0});var Xl=i(me);je=n(Xl,"here"),Xl.forEach(t),D=n(Ao,"."),Ao.forEach(t),be=h(s),S=r(s,"H2",{class:!0});var ar=i(S);ie=r(ar,"A",{id:!0,class:!0,href:!0});var Yl=i(ie);te=r(Yl,"SPAN",{});var Zl=i(te);v(P.$$.fragment,Zl),Zl.forEach(t),Yl.forEach(t),Pe=h(ar),N=r(ar,"SPAN",{});var ed=i(N);Le=n(ed,"CamembertConfig"),ed.forEach(t),ar.forEach(t),ke=h(s),f=r(s,"DIV",{class:!0});var rr=i(f);v(M.$$.fragment,rr),We=h(rr),Y=r(rr,"P",{});var Do=i(Y);Re=n(Do,"This class overrides "),Ae=r(Do,"A",{href:!0});var td=i(Ae);z=n(td,"RobertaConfig"),td.forEach(t),Be=n(Do,`. Please check the superclass for the appropriate documentation alongside
usage examples. Instantiating a configuration with the defaults will yield a similar configuration to that of the
Camembert `),Oe=r(Do,"A",{href:!0,rel:!0});var od=i(Oe);Ue=n(od,"camembert-base"),od.forEach(t),Ke=n(Do," architecture."),Do.forEach(t),rr.forEach(t),Se=h(s),A=r(s,"H2",{class:!0});var ir=i(A);R=r(ir,"A",{id:!0,class:!0,href:!0});var nd=i(R);De=r(nd,"SPAN",{});var sd=i(De);v(Ne.$$.fragment,sd),sd.forEach(t),nd.forEach(t),X=h(ir),Ie=r(ir,"SPAN",{});var ad=i(Ie);He=n(ad,"CamembertTokenizer"),ad.forEach(t),ir.forEach(t),ye=h(s),oe=r(s,"DIV",{class:!0});var dt=i(oe);v(Z.$$.fragment,dt),Qe=h(dt),Wt=r(dt,"P",{});var Rt=i(Wt);Kc=n(Rt,"Adapted from "),cr=r(Rt,"A",{href:!0});var rd=i(cr);Hc=n(rd,"RobertaTokenizer"),rd.forEach(t),Qc=n(Rt," and "),mr=r(Rt,"A",{href:!0});var id=i(mr);Vc=n(id,"XLNetTokenizer"),id.forEach(t),Jc=n(Rt,`. Construct a CamemBERT tokenizer. Based on
`),ss=r(Rt,"A",{href:!0,rel:!0});var ld=i(ss);Gc=n(ld,"SentencePiece"),ld.forEach(t),Xc=n(Rt,"."),Rt.forEach(t),Yc=h(dt),as=r(dt,"P",{});var lr=i(as);Zc=n(lr,"This tokenizer inherits from "),pr=r(lr,"A",{href:!0});var dd=i(pr);em=n(dd,"PreTrainedTokenizer"),dd.forEach(t),tm=n(lr,` which contains most of the main methods. Users should refer to
this superclass for more information regarding those methods.`),lr.forEach(t),om=h(dt),Bt=r(dt,"DIV",{class:!0});var Io=i(Bt);v(rs.$$.fragment,Io),nm=h(Io),hi=r(Io,"P",{});var cd=i(hi);sm=n(cd,`Build model inputs from a sequence or a pair of sequence for sequence classification tasks by concatenating and
...
adding special tokens. An CamemBERT sequence has the following format:`),Lb.forEach(t),Im=h(Xr),_s=r(Xr,"UL",{});var Gd=i(_s);kr=r(Gd,"LI",{});var yb=i(kr);Sm=n(yb,"single sequence: "),wi=r(yb,"CODE",{});var Ob=i(wi);Wm=n(Ob,"<s> X </s>"),Ob.forEach(t),yb.forEach(t),Rm=h(Gd),yr=r(Gd,"LI",{});var Tb=i(yr);Bm=n(Tb,"pair of sequences: "),vi=r(Tb,"CODE",{});var Nb=i(vi);Um=n(Nb,"<s> A </s></s> B </s>"),Nb.forEach(t),Tb.forEach(t),Gd.forEach(t),Xr.forEach(t),Km=h(Kt),Bo=r(Kt,"DIV",{class:!0});var Xd=i(Bo);v(bs.$$.fragment,Xd),Hm=h(Xd),$i=r(Xd,"P",{});var Ab=i($i);Qm=n(Ab,`Create a mask from the two sequences passed to be used in a sequence-pair classification task. CamemBERT, like
RoBERTa, does not make use of token type ids, therefore a list of zeros is returned.`),Ab.forEach(t),Xd.forEach(t),Kt.forEach(t),gd=h(s),io=r(s,"H2",{class:!0});var Yd=i(io);Uo=r(Yd,"A",{id:!0,class:!0,href:!0});var Db=i(Uo);Ci=r(Db,"SPAN",{});var Ib=i(Ci);v(ks.$$.fragment,Ib),Ib.forEach(t),Db.forEach(t),Vm=h(Yd),Fi=r(Yd,"SPAN",{});var Sb=i(Fi);Jm=n(Sb,"CamembertModel"),Sb.forEach(t),Yd.forEach(t),_d=h(s),Xe=r(s,"DIV",{class:!0});var ct=i(Xe);v(ys.$$.fragment,ct),Gm=h(ct),Ei=r(ct,"P",{});var Wb=i(Ei);Xm=n(Wb,"The bare CamemBERT Model transformer outputting raw hidden-states without any specific head on top."),Wb.forEach(t),Ym=h(ct),Ts=r(ct,"P",{});var Zd=i(Ts);Zm=n(Zd,"This model inherits from "),Tr=r(Zd,"A",{href:!0});var Rb=i(Tr);ep=n(Rb,"PreTrainedModel"),Rb.forEach(t),tp=n(Zd,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Zd.forEach(t),op=h(ct),ws=r(ct,"P",{});var ec=i(ws);np=n(ec,"This model is also a PyTorch "),vs=r(ec,"A",{href:!0,rel:!0});var Bb=i(vs);sp=n(Bb,"torch.nn.Module"),Bb.forEach(t),ap=n(ec,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),ac.forEach(t),Yp=h(Qt),zt=r(Qt,"DIV",{class:!0});var Zn=i(zt);v(Ps.$$.fragment,Zn),Zp=h(Zn),mo=r(Zn,"P",{});var Zr=i(mo);eh=n(Zr,"The "),$r=r(Zr,"A",{href:!0});var ik=i($r);th=n(ik,"CamembertForCausalLM"),ik.forEach(t),oh=n(Zr," forward method, overrides the "),Si=r(Zr,"CODE",{});var lk=i(Si);nh=n(lk,"__call__"),lk.forEach(t),sh=n(Zr," special method."),Zr.forEach(t),ah=h(Zn),v(Jo.$$.fragment,Zn),rh=h(Zn),v(Go.$$.fragment,Zn),Zn.forEach(t),Qt.forEach(t),yd=h(s),po=r(s,"H2",{class:!0});var rc=i(po);Xo=r(rc,"A",{id:!0,class:!0,href:!0});var dk=i(Xo);Wi=r(dk,"SPAN",{});var ck=i(Wi);v(Ls.$$.fragment,ck),ck.forEach(t),dk.forEach(t),ih=h(rc),Ri=r(rc,"SPAN",{});var mk=i(Ri);lh=n(mk,"CamembertForMaskedLM"),mk.forEach(t),rc.forEach(t),Td=h(s),ht=r(s,"DIV",{class:!0});var Vt=i(ht);v(Os.$$.fragment,Vt),dh=h(Vt),Ns=r(Vt,"P",{});var ic=i(Ns);ch=n(ic,"CamemBERT Model with a "),Bi=r(ic,"CODE",{});var pk=i(Bi);mh=n(pk,"language modeling"),pk.forEach(t),ph=n(ic," head on top."),ic.forEach(t),hh=h(Vt),As=r(Vt,"P",{});var lc=i(As);uh=n(lc,"This model inherits from "),Cr=r(lc,"A",{href:!0});var hk=i(Cr);fh=n(hk,"PreTrainedModel"),hk.forEach(t),gh=n(lc,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
pooled output) e.g. for GLUE tasks.`),vy.forEach(t),Ag=h(At),Pa=r(At,"P",{});var Lc=i(Pa);Dg=n(Lc,"This model inherits from "),Wr=r(Lc,"A",{href:!0});var $y=i(Wr);Ig=n($y,"TFPreTrainedModel"),$y.forEach(t),Sg=n(Lc,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Lc.forEach(t),Wg=h(At),La=r(At,"P",{});var Oc=i(La);Rg=n(Oc,"This model is also a "),Oa=r(Oc,"A",{href:!0,rel:!0});var Cy=i(Oa);Bg=n(Cy,"tf.keras.Model"),Cy.forEach(t),Ug=n(Oc,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Oc.forEach(t),Kg=h(At),v(Ln.$$.fragment,At),Hg=h(At),wt=r(At,"DIV",{class:!0});var no=i(wt);v(Na.$$.fragment,no),Qg=h(no),zo=r(no,"P",{});var li=i(zo);Vg=n(li,"The "),Rr=r(li,"A",{href:!0});var Fy=i(Rr);Jg=n(Fy,"TFCamembertForSequenceClassification"),Fy.forEach(t),Gg=n(li," forward method, overrides the "),vl=r(li,"CODE",{});var Ey=i(vl);Xg=n(Ey,"__call__"),Ey.forEach(t),Yg=n(li," special method."),li.forEach(t),Zg=h(no),v(On.$$.fragment,no),e_=h(no),v(Nn.$$.fragment,no),t_=h(no),v(An.$$.fragment,no),no.forEach(t),At.forEach(t),Dd=h(s),qo=r(s,"H2",{class:!0});var Nc=i(qo);Dn=r(Nc,"A",{id:!0,class:!0,href:!0});var My=i(Dn);$l=r(My,"SPAN",{});var zy=i($l);v(Aa.$$.fragment,zy),zy.forEach(t),My.forEach(t),o_=h(Nc),Cl=r(Nc,"SPAN",{});var qy=i(Cl);n_=n(qy,"TFCamembertForMultipleChoice"),qy.forEach(t),Nc.forEach(t),Id=h(s),rt=r(s,"DIV",{class:!0});var Dt=i(rt);v(Da.$$.fragment,Dt),s_=h(Dt),Fl=r(Dt,"P",{});var xy=i(Fl);a_=n(xy,`CamemBERT Model with a multiple choice classification head on top (a linear layer on top of the pooled output and a
softmax) e.g. for RocStories/SWAG tasks.`),xy.forEach(t),r_=h(Dt),Ia=r(Dt,"P",{});var Ac=i(Ia);i_=n(Ac,"This model inherits from "),Br=r(Ac,"A",{href:!0});var jy=i(Br);l_=n(jy,"TFPreTrainedModel"),jy.forEach(t),d_=n(Ac,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Ac.forEach(t),c_=h(Dt),Sa=r(Dt,"P",{});var Dc=i(Sa);m_=n(Dc,"This model is also a "),Wa=r(Dc,"A",{href:!0,rel:!0});var Py=i(Wa);p_=n(Py,"tf.keras.Model"),Py.forEach(t),h_=n(Dc,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Dc.forEach(t),u_=h(Dt),v(In.$$.fragment,Dt),f_=h(Dt),Pt=r(Dt,"DIV",{class:!0});var ns=i(Pt);v(Ra.$$.fragment,ns),g_=h(ns),xo=r(ns,"P",{});var di=i(xo);__=n(di,"The "),Ur=r(di,"A",{href:!0});var Ly=i(Ur);b_=n(Ly,"TFCamembertForMultipleChoice"),Ly.forEach(t),k_=n(di," forward method, overrides the "),El=r(di,"CODE",{});var Oy=i(El);y_=n(Oy,"__call__"),Oy.forEach(t),T_=n(di," special method."),di.forEach(t),w_=h(ns),v(Sn.$$.fragment,ns),v_=h(ns),v(Wn.$$.fragment,ns),ns.forEach(t),Dt.forEach(t),Sd=h(s),jo=r(s,"H2",{class:!0});var Ic=i(jo);Rn=r(Ic,"A",{id:!0,class:!0,href:!0});var Ny=i(Rn);Ml=r(Ny,"SPAN",{});var Ay=i(Ml);v(Ba.$$.fragment,Ay),Ay.forEach(t),Ny.forEach(t),$_=h(Ic),zl=r(Ic,"SPAN",{});var Dy=i(zl);C_=n(Dy,"TFCamembertForTokenClassification"),Dy.forEach(t),Ic.forEach(t),Wd=h(s),it=r(s,"DIV",{class:!0});var It=i(it);v(Ua.$$.fragment,It),F_=h(It),ql=r(It,"P",{});var Iy=i(ql);E_=n(Iy,`CamemBERT Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g.
