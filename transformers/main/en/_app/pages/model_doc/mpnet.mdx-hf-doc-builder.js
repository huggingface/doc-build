...
<span class="hljs-meta">&gt;&gt;&gt; </span>loss = outputs.loss
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-built_in">round</span>(loss.item(), <span class="hljs-number">2</span>)
`}}),{c(){T(l.$$.fragment)},l(c){v(l.$$.fragment,c)},m(c,f){y(l,c,f),g=!0},p:Se,i(c){g||($(l.$$.fragment,c),g=!0)},o(c){M(l.$$.fragment,c),g=!1},d(c){P(l,c)}}}function T_(z){let l,g,c,f,w,d,p,q,we,me,A,ae,te,N,Te,R,ve,he,S,ye,le,B,$e,fe,K,Me,ue,U,Pe,ge,ee,x,C,_e,Q,Ne,ke,H,oe,Fe,j,Ee,V,de,ze,X,ce,qe,D,be,W,xe,Z,O,je,L,se,re;return{c(){l=a("p"),g=n("TensorFlow models and layers in "),c=a("code"),f=n("transformers"),w=n(" accept two formats as input:"),d=m(),p=a("ul"),q=a("li"),we=n("having all inputs as keyword arguments (like PyTorch models), or"),me=m(),A=a("li"),ae=n("having all inputs as a list, tuple or dict in the first positional argument."),te=m(),N=a("p"),Te=n(`The reason the second format is supported is that Keras methods prefer this format when passing inputs to models
...
positional argument:`),ee=m(),x=a("ul"),C=a("li"),_e=n("a single Tensor with "),Q=a("code"),Ne=n("input_ids"),ke=n(" only and nothing else: "),H=a("code"),oe=n("model(input_ids)"),Fe=m(),j=a("li"),Ee=n(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
...
`),W=r(Ce,"CODE",{});var Xe=i(W);xe=s(Xe,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),Xe.forEach(t),Ce.forEach(t),I.forEach(t),Z=h(u),O=r(u,"P",{});var Y=i(O);je=s(Y,`Note that when creating models and layers with
`),L=r(Y,"A",{href:!0,rel:!0});var Ge=i(L);se=s(Ge,"subclassing"),Ge.forEach(t),re=s(Y,` then you don\u2019t need to worry
about any of this, as you can just pass inputs like you would to any other Python function!`),Y.forEach(t),this.h()},h(){k(L,"href","https://keras.io/guides/making_new_layers_and_models_via_subclassing/"),k(L,"rel","nofollow")},m(u,F){_(u,l,F),e(l,g),e(l,c),e(c,f),e(l,w),_(u,d,F),_(u,p,F),e(p,q),e(q,we),e(p,me),e(p,A),e(A,ae),_(u,te,F),_(u,N,F),e(N,Te),e(N,R),e(R,ve),e(N,he),e(N,S),e(S,ye),e(N,le),e(N,B),e(B,$e),e(N,fe),e(N,K),e(K,Me),e(N,ue),e(N,U),e(U,Pe),e(N,ge),_(u,ee,F),_(u,x,F),e(x,C),e(C,_e),e(C,Q),e(Q,Ne),e(C,ke),e(C,H),e(H,oe),e(x,Fe),e(x,j),e(j,Ee),e(j,V),e(V,de),e(j,ze),e(j,X),e(X,ce),e(x,qe),e(x,D),e(D,be),e(D,W),e(W,xe),_(u,Z,F),_(u,O,F),e(O,je),e(O,L),e(L,se),e(O,re)},d(u){u&&t(l),u&&t(d),u&&t(p),u&&t(te),u&&t(N),u&&t(ee),u&&t(x),u&&t(Z),u&&t(O)}}}function v_(z){let l,g,c,f,w;return{c(){l=a("p"),g=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),c=a("code"),f=n("Module"),w=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(d){l=r(d,"P",{});var p=i(l);g=s(p,"Although the recipe for forward pass needs to be defined within this function, one should call the "),c=r(p,"CODE",{});var q=i(c);f=s(q,"Module"),q.forEach(t),w=s(p,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),{c(){l=a("p"),g=n("Example:"),c=m(),T(f.$$.fragment)},l(d){l=r(d,"P",{});var p=i(l);g=s(p,"Example:"),p.forEach(t),c=h(d),v(f.$$.fragment,d)},m(d,p){_(d,l,p),e(l,g),_(d,c,p),y(f,d,p),w=!0},p:Se,i(d){w||($(f.$$.fragment,d),w=!0)},o(d){M(f.$$.fragment,d),w=!1},d(d){d&&t(l),d&&t(c),P(f,d)}}}function $_(z){let l,g,c,f,w,d,p,q,we,me,A,ae,te,N,Te,R,ve,he,S,ye,le,B,$e,fe,K,Me,ue,U,Pe,ge,ee,x,C,_e,Q,Ne,ke,H,oe,Fe,j,Ee,V,de,ze,X,ce,qe,D,be,W,xe,Z,O,je,L,se,re;return{c(){l=a("p"),g=n("TensorFlow models and layers in "),c=a("code"),f=n("transformers"),w=n(" accept two formats as input:"),d=m(),p=a("ul"),q=a("li"),we=n("having all inputs as keyword arguments (like PyTorch models), or"),me=m(),A=a("li"),ae=n("having all inputs as a list, tuple or dict in the first positional argument."),te=m(),N=a("p"),Te=n(`The reason the second format is supported is that Keras methods prefer this format when passing inputs to models
and layers. Because of this support, when using methods like `),R=a("code"),ve=n("model.fit()"),he=n(` things should \u201Cjust work\u201D for you - just
pass your inputs and labels in any format that `),S=a("code"),ye=n("model.fit()"),le=n(` supports! If, however, you want to use the second
format outside of Keras methods like `),B=a("code"),$e=n("fit()"),fe=n(" and "),K=a("code"),Me=n("predict()"),ue=n(`, such as when creating your own layers or models with
the Keras `),U=a("code"),Pe=n("Functional"),ge=n(` API, there are three possibilities you can use to gather all the input Tensors in the first
...
`),W=r(Ce,"CODE",{});var Xe=i(W);xe=s(Xe,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),Xe.forEach(t),Ce.forEach(t),I.forEach(t),Z=h(u),O=r(u,"P",{});var Y=i(O);je=s(Y,`Note that when creating models and layers with
`),L=r(Y,"A",{href:!0,rel:!0});var Ge=i(L);se=s(Ge,"subclassing"),Ge.forEach(t),re=s(Y,` then you don\u2019t need to worry
about any of this, as you can just pass inputs like you would to any other Python function!`),Y.forEach(t),this.h()},h(){k(L,"href","https://keras.io/guides/making_new_layers_and_models_via_subclassing/"),k(L,"rel","nofollow")},m(u,F){_(u,l,F),e(l,g),e(l,c),e(c,f),e(l,w),_(u,d,F),_(u,p,F),e(p,q),e(q,we),e(p,me),e(p,A),e(A,ae),_(u,te,F),_(u,N,F),e(N,Te),e(N,R),e(R,ve),e(N,he),e(N,S),e(S,ye),e(N,le),e(N,B),e(B,$e),e(N,fe),e(N,K),e(K,Me),e(N,ue),e(N,U),e(U,Pe),e(N,ge),_(u,ee,F),_(u,x,F),e(x,C),e(C,_e),e(C,Q),e(Q,Ne),e(C,ke),e(C,H),e(H,oe),e(x,Fe),e(x,j),e(j,Ee),e(j,V),e(V,de),e(j,ze),e(j,X),e(X,ce),e(x,qe),e(x,D),e(D,be),e(D,W),e(W,xe),_(u,Z,F),_(u,O,F),e(O,je),e(O,L),e(L,se),e(O,re)},d(u){u&&t(l),u&&t(d),u&&t(p),u&&t(te),u&&t(N),u&&t(ee),u&&t(x),u&&t(Z),u&&t(O)}}}function M_(z){let l,g,c,f,w;return{c(){l=a("p"),g=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),c=a("code"),f=n("Module"),w=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(d){l=r(d,"P",{});var p=i(l);g=s(p,"Although the recipe for forward pass needs to be defined within this function, one should call the "),c=r(p,"CODE",{});var q=i(c);f=s(q,"Module"),q.forEach(t),w=s(p,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
`}}),{c(){T(l.$$.fragment)},l(c){v(l.$$.fragment,c)},m(c,f){y(l,c,f),g=!0},p:Se,i(c){g||($(l.$$.fragment,c),g=!0)},o(c){M(l.$$.fragment,c),g=!1},d(c){P(l,c)}}}function F_(z){let l,g,c,f,w,d,p,q,we,me,A,ae,te,N,Te,R,ve,he,S,ye,le,B,$e,fe,K,Me,ue,U,Pe,ge,ee,x,C,_e,Q,Ne,ke,H,oe,Fe,j,Ee,V,de,ze,X,ce,qe,D,be,W,xe,Z,O,je,L,se,re;return{c(){l=a("p"),g=n("TensorFlow models and layers in "),c=a("code"),f=n("transformers"),w=n(" accept two formats as input:"),d=m(),p=a("ul"),q=a("li"),we=n("having all inputs as keyword arguments (like PyTorch models), or"),me=m(),A=a("li"),ae=n("having all inputs as a list, tuple or dict in the first positional argument."),te=m(),N=a("p"),Te=n(`The reason the second format is supported is that Keras methods prefer this format when passing inputs to models
and layers. Because of this support, when using methods like `),R=a("code"),ve=n("model.fit()"),he=n(` things should \u201Cjust work\u201D for you - just
pass your inputs and labels in any format that `),S=a("code"),ye=n("model.fit()"),le=n(` supports! If, however, you want to use the second
format outside of Keras methods like `),B=a("code"),$e=n("fit()"),fe=n(" and "),K=a("code"),Me=n("predict()"),ue=n(`, such as when creating your own layers or models with
the Keras `),U=a("code"),Pe=n("Functional"),ge=n(` API, there are three possibilities you can use to gather all the input Tensors in the first
...
`),W=r(Ce,"CODE",{});var Xe=i(W);xe=s(Xe,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),Xe.forEach(t),Ce.forEach(t),I.forEach(t),Z=h(u),O=r(u,"P",{});var Y=i(O);je=s(Y,`Note that when creating models and layers with
`),L=r(Y,"A",{href:!0,rel:!0});var Ge=i(L);se=s(Ge,"subclassing"),Ge.forEach(t),re=s(Y,` then you don\u2019t need to worry
about any of this, as you can just pass inputs like you would to any other Python function!`),Y.forEach(t),this.h()},h(){k(L,"href","https://keras.io/guides/making_new_layers_and_models_via_subclassing/"),k(L,"rel","nofollow")},m(u,F){_(u,l,F),e(l,g),e(l,c),e(c,f),e(l,w),_(u,d,F),_(u,p,F),e(p,q),e(q,we),e(p,me),e(p,A),e(A,ae),_(u,te,F),_(u,N,F),e(N,Te),e(N,R),e(R,ve),e(N,he),e(N,S),e(S,ye),e(N,le),e(N,B),e(B,$e),e(N,fe),e(N,K),e(K,Me),e(N,ue),e(N,U),e(U,Pe),e(N,ge),_(u,ee,F),_(u,x,F),e(x,C),e(C,_e),e(C,Q),e(Q,Ne),e(C,ke),e(C,H),e(H,oe),e(x,Fe),e(x,j),e(j,Ee),e(j,V),e(V,de),e(j,ze),e(j,X),e(X,ce),e(x,qe),e(x,D),e(D,be),e(D,W),e(W,xe),_(u,Z,F),_(u,O,F),e(O,je),e(O,L),e(L,se),e(O,re)},d(u){u&&t(l),u&&t(d),u&&t(p),u&&t(te),u&&t(N),u&&t(ee),u&&t(x),u&&t(Z),u&&t(O)}}}function E_(z){let l,g,c,f,w;return{c(){l=a("p"),g=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),c=a("code"),f=n("Module"),w=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(d){l=r(d,"P",{});var p=i(l);g=s(p,"Although the recipe for forward pass needs to be defined within this function, one should call the "),c=r(p,"CODE",{});var q=i(c);f=s(q,"Module"),q.forEach(t),w=s(p,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
`}}),{c(){T(l.$$.fragment)},l(c){v(l.$$.fragment,c)},m(c,f){y(l,c,f),g=!0},p:Se,i(c){g||($(l.$$.fragment,c),g=!0)},o(c){M(l.$$.fragment,c),g=!1},d(c){P(l,c)}}}function x_(z){let l,g,c,f,w,d,p,q,we,me,A,ae,te,N,Te,R,ve,he,S,ye,le,B,$e,fe,K,Me,ue,U,Pe,ge,ee,x,C,_e,Q,Ne,ke,H,oe,Fe,j,Ee,V,de,ze,X,ce,qe,D,be,W,xe,Z,O,je,L,se,re;return{c(){l=a("p"),g=n("TensorFlow models and layers in "),c=a("code"),f=n("transformers"),w=n(" accept two formats as input:"),d=m(),p=a("ul"),q=a("li"),we=n("having all inputs as keyword arguments (like PyTorch models), or"),me=m(),A=a("li"),ae=n("having all inputs as a list, tuple or dict in the first positional argument."),te=m(),N=a("p"),Te=n(`The reason the second format is supported is that Keras methods prefer this format when passing inputs to models
and layers. Because of this support, when using methods like `),R=a("code"),ve=n("model.fit()"),he=n(` things should \u201Cjust work\u201D for you - just
pass your inputs and labels in any format that `),S=a("code"),ye=n("model.fit()"),le=n(` supports! If, however, you want to use the second
format outside of Keras methods like `),B=a("code"),$e=n("fit()"),fe=n(" and "),K=a("code"),Me=n("predict()"),ue=n(`, such as when creating your own layers or models with
the Keras `),U=a("code"),Pe=n("Functional"),ge=n(` API, there are three possibilities you can use to gather all the input Tensors in the first
...
`),W=r(Ce,"CODE",{});var Xe=i(W);xe=s(Xe,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),Xe.forEach(t),Ce.forEach(t),I.forEach(t),Z=h(u),O=r(u,"P",{});var Y=i(O);je=s(Y,`Note that when creating models and layers with
`),L=r(Y,"A",{href:!0,rel:!0});var Ge=i(L);se=s(Ge,"subclassing"),Ge.forEach(t),re=s(Y,` then you don\u2019t need to worry
about any of this, as you can just pass inputs like you would to any other Python function!`),Y.forEach(t),this.h()},h(){k(L,"href","https://keras.io/guides/making_new_layers_and_models_via_subclassing/"),k(L,"rel","nofollow")},m(u,F){_(u,l,F),e(l,g),e(l,c),e(c,f),e(l,w),_(u,d,F),_(u,p,F),e(p,q),e(q,we),e(p,me),e(p,A),e(A,ae),_(u,te,F),_(u,N,F),e(N,Te),e(N,R),e(R,ve),e(N,he),e(N,S),e(S,ye),e(N,le),e(N,B),e(B,$e),e(N,fe),e(N,K),e(K,Me),e(N,ue),e(N,U),e(U,Pe),e(N,ge),_(u,ee,F),_(u,x,F),e(x,C),e(C,_e),e(C,Q),e(Q,Ne),e(C,ke),e(C,H),e(H,oe),e(x,Fe),e(x,j),e(j,Ee),e(j,V),e(V,de),e(j,ze),e(j,X),e(X,ce),e(x,qe),e(x,D),e(D,be),e(D,W),e(W,xe),_(u,Z,F),_(u,O,F),e(O,je),e(O,L),e(L,se),e(O,re)},d(u){u&&t(l),u&&t(d),u&&t(p),u&&t(te),u&&t(N),u&&t(ee),u&&t(x),u&&t(Z),u&&t(O)}}}function j_(z){let l,g,c,f,w;return{c(){l=a("p"),g=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),c=a("code"),f=n("Module"),w=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(d){l=r(d,"P",{});var p=i(l);g=s(p,"Although the recipe for forward pass needs to be defined within this function, one should call the "),c=r(p,"CODE",{});var q=i(c);f=s(q,"Module"),q.forEach(t),w=s(p,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),p.forEach(t)},m(d,p){_(d,l,p),e(l,g),e(l,c),e(c,f),e(l,w)},d(d){d&&t(l)}}}function C_(z){let l,g,c,f,w;return f=new We({props:{code:`from transformers import MPNetTokenizer, TFMPNetForMultipleChoice
import tensorflow as tf
...
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-comment"># the linear classifier still needs to be trained</span>
<span class="hljs-meta">&gt;&gt;&gt; </span>logits = outputs.logits`}}),{c(){l=a("p"),g=n("Example:"),c=m(),T(f.$$.fragment)},l(d){l=r(d,"P",{});var p=i(l);g=s(p,"Example:"),p.forEach(t),c=h(d),v(f.$$.fragment,d)},m(d,p){_(d,l,p),e(l,g),_(d,c,p),y(f,d,p),w=!0},p:Se,i(d){w||($(f.$$.fragment,d),w=!0)},o(d){M(f.$$.fragment,d),w=!1},d(d){d&&t(l),d&&t(c),P(f,d)}}}function O_(z){let l,g,c,f,w,d,p,q,we,me,A,ae,te,N,Te,R,ve,he,S,ye,le,B,$e,fe,K,Me,ue,U,Pe,ge,ee,x,C,_e,Q,Ne,ke,H,oe,Fe,j,Ee,V,de,ze,X,ce,qe,D,be,W,xe,Z,O,je,L,se,re;return{c(){l=a("p"),g=n("TensorFlow models and layers in "),c=a("code"),f=n("transformers"),w=n(" accept two formats as input:"),d=m(),p=a("ul"),q=a("li"),we=n("having all inputs as keyword arguments (like PyTorch models), or"),me=m(),A=a("li"),ae=n("having all inputs as a list, tuple or dict in the first positional argument."),te=m(),N=a("p"),Te=n(`The reason the second format is supported is that Keras methods prefer this format when passing inputs to models
and layers. Because of this support, when using methods like `),R=a("code"),ve=n("model.fit()"),he=n(` things should \u201Cjust work\u201D for you - just
pass your inputs and labels in any format that `),S=a("code"),ye=n("model.fit()"),le=n(` supports! If, however, you want to use the second
format outside of Keras methods like `),B=a("code"),$e=n("fit()"),fe=n(" and "),K=a("code"),Me=n("predict()"),ue=n(`, such as when creating your own layers or models with
the Keras `),U=a("code"),Pe=n("Functional"),ge=n(` API, there are three possibilities you can use to gather all the input Tensors in the first
...
`),W=r(Ce,"CODE",{});var Xe=i(W);xe=s(Xe,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),Xe.forEach(t),Ce.forEach(t),I.forEach(t),Z=h(u),O=r(u,"P",{});var Y=i(O);je=s(Y,`Note that when creating models and layers with
`),L=r(Y,"A",{href:!0,rel:!0});var Ge=i(L);se=s(Ge,"subclassing"),Ge.forEach(t),re=s(Y,` then you don\u2019t need to worry
about any of this, as you can just pass inputs like you would to any other Python function!`),Y.forEach(t),this.h()},h(){k(L,"href","https://keras.io/guides/making_new_layers_and_models_via_subclassing/"),k(L,"rel","nofollow")},m(u,F){_(u,l,F),e(l,g),e(l,c),e(c,f),e(l,w),_(u,d,F),_(u,p,F),e(p,q),e(q,we),e(p,me),e(p,A),e(A,ae),_(u,te,F),_(u,N,F),e(N,Te),e(N,R),e(R,ve),e(N,he),e(N,S),e(S,ye),e(N,le),e(N,B),e(B,$e),e(N,fe),e(N,K),e(K,Me),e(N,ue),e(N,U),e(U,Pe),e(N,ge),_(u,ee,F),_(u,x,F),e(x,C),e(C,_e),e(C,Q),e(Q,Ne),e(C,ke),e(C,H),e(H,oe),e(x,Fe),e(x,j),e(j,Ee),e(j,V),e(V,de),e(j,ze),e(j,X),e(X,ce),e(x,qe),e(x,D),e(D,be),e(D,W),e(W,xe),_(u,Z,F),_(u,O,F),e(O,je),e(O,L),e(L,se),e(O,re)},d(u){u&&t(l),u&&t(d),u&&t(p),u&&t(te),u&&t(N),u&&t(ee),u&&t(x),u&&t(Z),u&&t(O)}}}function L_(z){let l,g,c,f,w;return{c(){l=a("p"),g=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),c=a("code"),f=n("Module"),w=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(d){l=r(d,"P",{});var p=i(l);g=s(p,"Although the recipe for forward pass needs to be defined within this function, one should call the "),c=r(p,"CODE",{});var q=i(c);f=s(q,"Module"),q.forEach(t),w=s(p,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-built_in">round</span>(<span class="hljs-built_in">float</span>(loss), <span class="hljs-number">2</span>)
`}}),{c(){T(l.$$.fragment)},l(c){v(l.$$.fragment,c)},m(c,f){y(l,c,f),g=!0},p:Se,i(c){g||($(l.$$.fragment,c),g=!0)},o(c){M(l.$$.fragment,c),g=!1},d(c){P(l,c)}}}function I_(z){let l,g,c,f,w,d,p,q,we,me,A,ae,te,N,Te,R,ve,he,S,ye,le,B,$e,fe,K,Me,ue,U,Pe,ge,ee,x,C,_e,Q,Ne,ke,H,oe,Fe,j,Ee,V,de,ze,X,ce,qe,D,be,W,xe,Z,O,je,L,se,re;return{c(){l=a("p"),g=n("TensorFlow models and layers in "),c=a("code"),f=n("transformers"),w=n(" accept two formats as input:"),d=m(),p=a("ul"),q=a("li"),we=n("having all inputs as keyword arguments (like PyTorch models), or"),me=m(),A=a("li"),ae=n("having all inputs as a list, tuple or dict in the first positional argument."),te=m(),N=a("p"),Te=n(`The reason the second format is supported is that Keras methods prefer this format when passing inputs to models
and layers. Because of this support, when using methods like `),R=a("code"),ve=n("model.fit()"),he=n(` things should \u201Cjust work\u201D for you - just
pass your inputs and labels in any format that `),S=a("code"),ye=n("model.fit()"),le=n(` supports! If, however, you want to use the second
format outside of Keras methods like `),B=a("code"),$e=n("fit()"),fe=n(" and "),K=a("code"),Me=n("predict()"),ue=n(`, such as when creating your own layers or models with
the Keras `),U=a("code"),Pe=n("Functional"),ge=n(` API, there are three possibilities you can use to gather all the input Tensors in the first
...
`),W=r(Ce,"CODE",{});var Xe=i(W);xe=s(Xe,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),Xe.forEach(t),Ce.forEach(t),I.forEach(t),Z=h(u),O=r(u,"P",{});var Y=i(O);je=s(Y,`Note that when creating models and layers with
`),L=r(Y,"A",{href:!0,rel:!0});var Ge=i(L);se=s(Ge,"subclassing"),Ge.forEach(t),re=s(Y,` then you don\u2019t need to worry
about any of this, as you can just pass inputs like you would to any other Python function!`),Y.forEach(t),this.h()},h(){k(L,"href","https://keras.io/guides/making_new_layers_and_models_via_subclassing/"),k(L,"rel","nofollow")},m(u,F){_(u,l,F),e(l,g),e(l,c),e(c,f),e(l,w),_(u,d,F),_(u,p,F),e(p,q),e(q,we),e(p,me),e(p,A),e(A,ae),_(u,te,F),_(u,N,F),e(N,Te),e(N,R),e(R,ve),e(N,he),e(N,S),e(S,ye),e(N,le),e(N,B),e(B,$e),e(N,fe),e(N,K),e(K,Me),e(N,ue),e(N,U),e(U,Pe),e(N,ge),_(u,ee,F),_(u,x,F),e(x,C),e(C,_e),e(C,Q),e(Q,Ne),e(C,ke),e(C,H),e(H,oe),e(x,Fe),e(x,j),e(j,Ee),e(j,V),e(V,de),e(j,ze),e(j,X),e(X,ce),e(x,qe),e(x,D),e(D,be),e(D,W),e(W,xe),_(u,Z,F),_(u,O,F),e(O,je),e(O,L),e(L,se),e(O,re)},d(u){u&&t(l),u&&t(d),u&&t(p),u&&t(te),u&&t(N),u&&t(ee),u&&t(x),u&&t(Z),u&&t(O)}}}function S_(z){let l,g,c,f,w;return{c(){l=a("p"),g=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),c=a("code"),f=n("Module"),w=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(d){l=r(d,"P",{});var p=i(l);g=s(p,"Although the recipe for forward pass needs to be defined within this function, one should call the "),c=r(p,"CODE",{});var q=i(c);f=s(q,"Module"),q.forEach(t),w=s(p,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-built_in">round</span>(<span class="hljs-built_in">float</span>(loss), <span class="hljs-number">2</span>)
`}}),{c(){T(l.$$.fragment)},l(c){v(l.$$.fragment,c)},m(c,f){y(l,c,f),g=!0},p:Se,i(c){g||($(l.$$.fragment,c),g=!0)},o(c){M(l.$$.fragment,c),g=!1},d(c){P(l,c)}}}function U_(z){let l,g,c,f,w,d,p,q,we,me,A,ae,te,N,Te,R,ve,he,S,ye,le,B,$e,fe,K,Me,ue,U,Pe,ge,ee,x,C,_e,Q,Ne,ke,H,oe,Fe,j,Ee,V,de,ze,X,ce,qe,D,be,W,xe,Z,O,je,L,se,re,u,F,Ue,ne,Qe,Ke,E,Oe,He,pe,Re,Ae,I,G,De,Be,J,Le,Ve,Ce,Xe,Y,Ge,ka,dd,cd,ba,pd,md,hd,Mo,Qi,Vt,Po,dr,On,fd,cr,ud,Hi,Ze,Ln,gd,An,_d,wa,kd,bd,wd,Ot,Dn,Td,pr,vd,yd,In,Ta,$d,mr,Md,Pd,va,Nd,hr,Fd,Ed,No,Sn,zd,Wn,qd,fr,xd,jd,Cd,Fo,Kn,Od,ur,Ld,Ad,ya,Un,Ri,Xt,Eo,gr,Qn,Dd,_r,Id,Bi,Tt,Hn,Sd,Rn,Wd,kr,Kd,Ud,Qd,Bn,Hd,$a,Rd,Bd,Vd,zo,Vn,Xd,br,Gd,Vi,Gt,qo,wr,Xn,Jd,Tr,Yd,Xi,it,Gn,Zd,vr,ec,tc,Jn,oc,Ma,nc,sc,ac,Yn,rc,Zn,ic,lc,dc,vt,es,cc,Jt,pc,Pa,mc,hc,yr,fc,uc,gc,xo,_c,jo,Gi,Yt,Co,$r,ts,kc,Mr,bc,Ji,Zt,os,wc,ht,ns,Tc,eo,vc,Na,yc,$c,Pr,Mc,Pc,Nc,Oo,Fc,Lo,Ec,Ao,Yi,to,Do,Nr,ss,zc,Fr,qc,Zi,lt,as,xc,Er,jc,Cc,rs,Oc,Fa,Lc,Ac,Dc,is,Ic,ls,Sc,Wc,Kc,Je,ds,Uc,oo,Qc,Ea,Hc,Rc,zr,Bc,Vc,Xc,Io,Gc,So,Jc,Wo,Yc,Ko,Zc,Uo,el,no,Qo,qr,cs,ep,xr,tp,tl,dt,ps,op,jr,np,sp,ms,ap,za,rp,ip,lp,hs,dp,fs,cp,pp,mp,yt,us,hp,so,fp,qa,up,gp,Cr,_p,kp,bp,Ho,wp,Ro,ol,ao,Bo,Or,gs,Tp,Lr,vp,nl,ct,_s,yp,Ar,$p,Mp,ks,Pp,xa,Np,Fp,Ep,bs,zp,ws,qp,xp,jp,ft,Ts,Cp,ro,Op,ja,Lp,Ap,Dr,Dp,Ip,Sp,Vo,Wp,Xo,Kp,Go,sl,io,Jo,Ir,vs,Up,Sr,Qp,al,pt,ys,Hp,lo,Rp,Wr,Bp,Vp,Kr,Xp,Gp,Jp,$s,Yp,Ca,Zp,em,tm,Ms,om,Ps,nm,sm,am,ut,Ns,rm,co,im,Oa,lm,dm,Ur,cm,pm,mm,Yo,hm,Zo,fm,en,rl,po,tn,Qr,Fs,um,Hr,gm,il,et,Es,_m,Rr,km,bm,zs,wm,La,Tm,vm,ym,qs,$m,xs,Mm,Pm,Nm,on,Fm,$t,js,Em,mo,zm,Aa,qm,xm,Br,jm,Cm,Om,nn,Lm,sn,ll,ho,an,Vr,Cs,Am,Xr,Dm,dl,tt,Os,Im,Ls,Sm,Gr,Wm,Km,Um,As,Qm,Da,Hm,Rm,Bm,Ds,Vm,Is,Xm,Gm,Jm,rn,Ym,gt,Ss,Zm,fo,eh,Ia,th,oh,Jr,nh,sh,ah,ln,rh,dn,ih,cn,cl,uo,pn,Yr,Ws,lh,Zr,dh,pl,ot,Ks,ch,ei,ph,mh,Us,hh,Sa,fh,uh,gh,Qs,_h,Hs,kh,bh,wh,mn,Th,_t,Rs,vh,go,yh,Wa,$h,Mh,ti,Ph,Nh,Fh,hn,Eh,fn,zh,un,ml,_o,gn,oi,Bs,qh,ni,xh,hl,nt,Vs,jh,si,Ch,Oh,Xs,Lh,Ka,Ah,Dh,Ih,Gs,Sh,Js,Wh,Kh,Uh,_n,Qh,Mt,Ys,Hh,ko,Rh,Ua,Bh,Vh,ai,Xh,Gh,Jh,kn,Yh,bn,fl,bo,wn,ri,Zs,Zh,ii,ef,ul,st,ea,tf,li,of,nf,ta,sf,Qa,af,rf,lf,oa,df,na,cf,pf,mf,Tn,hf,kt,sa,ff,wo,uf,Ha,gf,_f,di,kf,bf,wf,vn,Tf,yn,vf,$n,gl,To,Mn,ci,aa,yf,pi,$f,_l,at,ra,Mf,vo,Pf,mi,Nf,Ff,hi,Ef,zf,qf,ia,xf,Ra,jf,Cf,Of,la,Lf,da,Af,Df,If,Pn,Sf,bt,ca,Wf,yo,Kf,Ba,Uf,Qf,fi,Hf,Rf,Bf,Nn,Vf,Fn,Xf,En,kl;return d=new rt({}),N=new rt({}),F=new rt({}),Oe=new ie({props:{name:"class transformers.MPNetConfig",anchor:"transformers.MPNetConfig",parameters:[{name:"vocab_size",val:" = 30527"},{name:"hidden_size",val:" = 768"},{name:"num_hidden_layers",val:" = 12"},{name:"num_attention_heads",val:" = 12"},{name:"intermediate_size",val:" = 3072"},{name:"hidden_act",val:" = 'gelu'"},{name:"hidden_dropout_prob",val:" = 0.1"},{name:"attention_probs_dropout_prob",val:" = 0.1"},{name:"max_position_embeddings",val:" = 512"},{name:"initializer_range",val:" = 0.02"},{name:"layer_norm_eps",val:" = 1e-12"},{name:"relative_attention_num_buckets",val:" = 32"},{name:"pad_token_id",val:" = 1"},{name:"bos_token_id",val:" = 0"},{name:"eos_token_id",val:" = 2"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.MPNetConfig.vocab_size",description:`<strong>vocab_size</strong> (<code>int</code>, <em>optional</em>, defaults to 30527) &#x2014;
...
masked language modeling and permuted language modeling for natural language understanding.`),ue=m(),U=a("p"),Pe=n("The abstract from the paper is the following:"),ge=m(),ee=a("p"),x=a("em"),C=n(`BERT adopts masked language modeling (MLM) for pre-training and is one of the most successful pre-training models.
...
BERT, XLNet, RoBERTa) under the same model setting.`),_e=m(),Q=a("p"),Ne=n("Tips:"),ke=m(),H=a("ul"),oe=a("li"),Fe=n("MPNet doesn\u2019t have "),j=a("code"),Ee=n("token_type_ids"),V=n(`, you don\u2019t need to indicate which token belongs to which segment. just
separate your segments with the separation token `),de=a("code"),ze=n("tokenizer.sep_token"),X=n(" (or "),ce=a("code"),qe=n("[sep]"),D=n(")."),be=m(),W=a("p"),xe=n("The original code can be found "),Z=a("a"),O=n("here"),je=n("."),L=m(),se=a("h2"),re=a("a"),u=a("span"),T(F.$$.fragment),Ue=m(),ne=a("span"),Qe=n("MPNetConfig"),Ke=m(),E=a("div"),T(Oe.$$.fragment),He=m(),pe=a("p"),Re=n("This is the configuration class to store the configuration of a "),Ae=a("a"),I=n("MPNetModel"),G=n(" or a "),De=a("a"),Be=n("TFMPNetModel"),J=n(`. It is used to
...
special tokens using the tokenizer `),fr=a("code"),xd=n("prepare_for_model"),jd=n(" methods."),Cd=m(),Fo=a("div"),T(Kn.$$.fragment),Od=m(),ur=a("p"),Ld=n(`Creates a mask from the two sequences passed to be used in a sequence-pair classification task. MPNet does not
...
layers on top of the hidden-states output to compute `),mi=a("code"),Nf=n("span start logits"),Ff=n(" and "),hi=a("code"),Ef=n("span end logits"),zf=n(")."),qf=m(),ia=a("p"),xf=n("This model inherits from "),Ra=a("a"),jf=n("TFPreTrainedModel"),Cf=n(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
down-streaming tasks (GLUE, SQuAD, etc). Experimental results show that MPNet outperforms MLM and PLM by a large
margin, and achieves better results on these tasks compared with previous state-of-the-art pre-trained methods (e.g.,
BERT, XLNet, RoBERTa) under the same model setting.`),Mi.forEach(t),$i.forEach(t),_e=h(o),Q=r(o,"P",{});var Pi=i(Q);Ne=s(Pi,"Tips:"),Pi.forEach(t),ke=h(o),H=r(o,"UL",{});var Ni=i(H);oe=r(Ni,"LI",{});var xt=i(oe);Fe=s(xt,"MPNet doesn\u2019t have "),j=r(xt,"CODE",{});var Fi=i(j);Ee=s(Fi,"token_type_ids"),Fi.forEach(t),V=s(xt,`, you don\u2019t need to indicate which token belongs to which segment. just
separate your segments with the separation token `),de=r(xt,"CODE",{});var Ei=i(de);ze=s(Ei,"tokenizer.sep_token"),Ei.forEach(t),X=s(xt," (or "),ce=r(xt,"CODE",{});var zi=i(ce);qe=s(zi,"[sep]"),zi.forEach(t),D=s(xt,")."),xt.forEach(t),Ni.forEach(t),be=h(o),W=r(o,"P",{});var fa=i(W);xe=s(fa,"The original code can be found "),Z=r(fa,"A",{href:!0,rel:!0});var qi=i(Z);O=s(qi,"here"),qi.forEach(t),je=s(fa,"."),fa.forEach(t),L=h(o),se=r(o,"H2",{class:!0});var ua=i(se);re=r(ua,"A",{id:!0,class:!0,href:!0});var xi=i(re);u=r(xi,"SPAN",{});var ji=i(u);v(F.$$.fragment,ji),ji.forEach(t),xi.forEach(t),Ue=h(ua),ne=r(ua,"SPAN",{});var Ci=i(ne);Qe=s(Ci,"MPNetConfig"),Ci.forEach(t),ua.forEach(t),Ke=h(o),E=r(o,"DIV",{class:!0});var jt=i(E);v(Oe.$$.fragment,jt),He=h(jt),pe=r(jt,"P",{});var Ct=i(pe);Re=s(Ct,"This is the configuration class to store the configuration of a "),Ae=r(Ct,"A",{href:!0});var Oi=i(Ae);I=s(Oi,"MPNetModel"),Oi.forEach(t),G=s(Ct," or a "),De=r(Ct,"A",{href:!0});var Li=i(De);Be=s(Li,"TFMPNetModel"),Li.forEach(t),J=s(Ct,`. It is used to
instantiate a MPNet model according to the specified arguments, defining the model architecture. Instantiating a
configuration with the defaults will yield a similar configuration to that of the MPNet
...
documentation from `),ba=r($o,"A",{href:!0});var Ii=i(ba);pd=s(Ii,"PretrainedConfig"),Ii.forEach(t),md=s($o," for more information."),$o.forEach(t),hd=h(jt),v(Mo.$$.fragment,jt),jt.forEach(t),Qi=h(o),Vt=r(o,"H2",{class:!0});var ga=i(Vt);Po=r(ga,"A",{id:!0,class:!0,href:!0});var Si=i(Po);dr=r(Si,"SPAN",{});var Wi=i(dr);v(On.$$.fragment,Wi),Wi.forEach(t),Si.forEach(t),fd=h(ga),cr=r(ga,"SPAN",{});var Ki=i(cr);ud=s(Ki,"MPNetTokenizer"),Ki.forEach(t),ga.forEach(t),Hi=h(o),Ze=r(o,"DIV",{class:!0});var mt=i(Ze);v(Ln.$$.fragment,mt),gd=h(mt),An=r(mt,"P",{});var _a=i(An);_d=s(_a,"This tokenizer inherits from "),wa=r(_a,"A",{href:!0});var Ui=i(wa);kd=s(Ui,"BertTokenizer"),Ui.forEach(t),bd=s(_a,` which contains most of the methods. Users should refer to the
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),El.forEach(t),dc=h(Lt),vt=r(Lt,"DIV",{class:!0});var qn=i(vt);v(es.$$.fragment,qn),cc=h(qn),Jt=r(qn,"P",{});var Xa=i(Jt);pc=s(Xa,"The "),Pa=r(Xa,"A",{href:!0});var gu=i(Pa);mc=s(gu,"MPNetModel"),gu.forEach(t),hc=s(Xa," forward method, overrides the "),yr=r(Xa,"CODE",{});var _u=i(yr);fc=s(_u,"__call__"),_u.forEach(t),uc=s(Xa," special method."),Xa.forEach(t),gc=h(qn),v(xo.$$.fragment,qn),_c=h(qn),v(jo.$$.fragment,qn),qn.forEach(t),Lt.forEach(t),Gi=h(o),Yt=r(o,"H2",{class:!0});var zl=i(Yt);Co=r(zl,"A",{id:!0,class:!0,href:!0});var ku=i(Co);$r=r(ku,"SPAN",{});var bu=i($r);v(ts.$$.fragment,bu),bu.forEach(t),ku.forEach(t),kc=h(zl),Mr=r(zl,"SPAN",{});var wu=i(Mr);bc=s(wu,"MPNetForMaskedLM"),wu.forEach(t),zl.forEach(t),Ji=h(o),Zt=r(o,"DIV",{class:!0});var ql=i(Zt);v(os.$$.fragment,ql),wc=h(ql),ht=r(ql,"DIV",{class:!0});var At=i(ht);v(ns.$$.fragment,At),Tc=h(At),eo=r(At,"P",{});var Ga=i(eo);vc=s(Ga,"The "),Na=r(Ga,"A",{href:!0});var Tu=i(Na);yc=s(Tu,"MPNetForMaskedLM"),Tu.forEach(t),$c=s(Ga," forward method, overrides the "),Pr=r(Ga,"CODE",{});var vu=i(Pr);Mc=s(vu,"__call__"),vu.forEach(t),Pc=s(Ga," special method."),Ga.forEach(t),Nc=h(At),v(Oo.$$.fragment,At),Fc=h(At),v(Lo.$$.fragment,At),Ec=h(At),v(Ao.$$.fragment,At),At.forEach(t),ql.forEach(t),Yi=h(o),to=r(o,"H2",{class:!0});var xl=i(to);Do=r(xl,"A",{id:!0,class:!0,href:!0});var yu=i(Do);Nr=r(yu,"SPAN",{});var $u=i(Nr);v(ss.$$.fragment,$u),$u.forEach(t),yu.forEach(t),zc=h(xl),Fr=r(xl,"SPAN",{});var Mu=i(Fr);qc=s(Mu,"MPNetForSequenceClassification"),Mu.forEach(t),xl.forEach(t),Zi=h(o),lt=r(o,"DIV",{class:!0});var Dt=i(lt);v(as.$$.fragment,Dt),xc=h(Dt),Er=r(Dt,"P",{});var Pu=i(Er);jc=s(Pu,`MPNet Model transformer with a sequence classification/regression head on top (a linear layer on top of the pooled
output) e.g. for GLUE tasks.`),Pu.forEach(t),Cc=h(Dt),rs=r(Dt,"P",{});var jl=i(rs);Oc=s(jl,"This model inherits from "),Fa=r(jl,"A",{href:!0});var Nu=i(Fa);Lc=s(Nu,"PreTrainedModel"),Nu.forEach(t),Ac=s(jl,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),jl.forEach(t),Dc=h(Dt),is=r(Dt,"P",{});var Cl=i(is);Ic=s(Cl,"This model is also a PyTorch "),ls=r(Cl,"A",{href:!0,rel:!0});var Fu=i(ls);Sc=s(Fu,"torch.nn.Module"),Fu.forEach(t),Wc=s(Cl,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Cl.forEach(t),Kc=h(Dt),Je=r(Dt,"DIV",{class:!0});var wt=i(Je);v(ds.$$.fragment,wt),Uc=h(wt),oo=r(wt,"P",{});var Ja=i(oo);Qc=s(Ja,"The "),Ea=r(Ja,"A",{href:!0});var Eu=i(Ea);Hc=s(Eu,"MPNetForSequenceClassification"),Eu.forEach(t),Rc=s(Ja," forward method, overrides the "),zr=r(Ja,"CODE",{});var zu=i(zr);Bc=s(zu,"__call__"),zu.forEach(t),Vc=s(Ja," special method."),Ja.forEach(t),Xc=h(wt),v(Io.$$.fragment,wt),Gc=h(wt),v(So.$$.fragment,wt),Jc=h(wt),v(Wo.$$.fragment,wt),Yc=h(wt),v(Ko.$$.fragment,wt),Zc=h(wt),v(Uo.$$.fragment,wt),wt.forEach(t),Dt.forEach(t),el=h(o),no=r(o,"H2",{class:!0});var Ol=i(no);Qo=r(Ol,"A",{id:!0,class:!0,href:!0});var qu=i(Qo);qr=r(qu,"SPAN",{});var xu=i(qr);v(cs.$$.fragment,xu),xu.forEach(t),qu.forEach(t),ep=h(Ol),xr=r(Ol,"SPAN",{});var ju=i(xr);tp=s(ju,"MPNetForMultipleChoice"),ju.forEach(t),Ol.forEach(t),tl=h(o),dt=r(o,"DIV",{class:!0});var It=i(dt);v(ps.$$.fragment,It),op=h(It),jr=r(It,"P",{});var Cu=i(jr);np=s(Cu,`MPNet Model with a multiple choice classification head on top (a linear layer on top of the pooled output and a
softmax) e.g. for RocStories/SWAG tasks.`),Cu.forEach(t),sp=h(It),ms=r(It,"P",{});var Ll=i(ms);ap=s(Ll,"This model inherits from "),za=r(Ll,"A",{href:!0});var Ou=i(za);rp=s(Ou,"PreTrainedModel"),Ou.forEach(t),ip=s(Ll,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Al.forEach(t),mp=h(It),yt=r(It,"DIV",{class:!0});var xn=i(yt);v(us.$$.fragment,xn),hp=h(xn),so=r(xn,"P",{});var Ya=i(so);fp=s(Ya,"The "),qa=r(Ya,"A",{href:!0});var Au=i(qa);up=s(Au,"MPNetForMultipleChoice"),Au.forEach(t),gp=s(Ya," forward method, overrides the "),Cr=r(Ya,"CODE",{});var Du=i(Cr);_p=s(Du,"__call__"),Du.forEach(t),kp=s(Ya," special method."),Ya.forEach(t),bp=h(xn),v(Ho.$$.fragment,xn),wp=h(xn),v(Ro.$$.fragment,xn),xn.forEach(t),It.forEach(t),ol=h(o),ao=r(o,"H2",{class:!0});var Dl=i(ao);Bo=r(Dl,"A",{id:!0,class:!0,href:!0});var Iu=i(Bo);Or=r(Iu,"SPAN",{});var Su=i(Or);v(gs.$$.fragment,Su),Su.forEach(t),Iu.forEach(t),Tp=h(Dl),Lr=r(Dl,"SPAN",{});var Wu=i(Lr);vp=s(Wu,"MPNetForTokenClassification"),Wu.forEach(t),Dl.forEach(t),nl=h(o),ct=r(o,"DIV",{class:!0});var St=i(ct);v(_s.$$.fragment,St),yp=h(St),Ar=r(St,"P",{});var Ku=i(Ar);$p=s(Ku,`MPNet Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g. for
Named-Entity-Recognition (NER) tasks.`),Ku.forEach(t),Mp=h(St),ks=r(St,"P",{});var Il=i(ks);Pp=s(Il,"This model inherits from "),xa=r(Il,"A",{href:!0});var Uu=i(xa);Np=s(Uu,"PreTrainedModel"),Uu.forEach(t),Fp=s(Il,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Il.forEach(t),Ep=h(St),bs=r(St,"P",{});var Sl=i(bs);zp=s(Sl,"This model is also a PyTorch "),ws=r(Sl,"A",{href:!0,rel:!0});var Qu=i(ws);qp=s(Qu,"torch.nn.Module"),Qu.forEach(t),xp=s(Sl,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Sl.forEach(t),jp=h(St),ft=r(St,"DIV",{class:!0});var Wt=i(ft);v(Ts.$$.fragment,Wt),Cp=h(Wt),ro=r(Wt,"P",{});var Za=i(ro);Op=s(Za,"The "),ja=r(Za,"A",{href:!0});var Hu=i(ja);Lp=s(Hu,"MPNetForTokenClassification"),Hu.forEach(t),Ap=s(Za," forward method, overrides the "),Dr=r(Za,"CODE",{});var Ru=i(Dr);Dp=s(Ru,"__call__"),Ru.forEach(t),Ip=s(Za," special method."),Za.forEach(t),Sp=h(Wt),v(Vo.$$.fragment,Wt),Wp=h(Wt),v(Xo.$$.fragment,Wt),Kp=h(Wt),v(Go.$$.fragment,Wt),Wt.forEach(t),St.forEach(t),sl=h(o),io=r(o,"H2",{class:!0});var Wl=i(io);Jo=r(Wl,"A",{id:!0,class:!0,href:!0});var Bu=i(Jo);Ir=r(Bu,"SPAN",{});var Vu=i(Ir);v(vs.$$.fragment,Vu),Vu.forEach(t),Bu.forEach(t),Up=h(Wl),Sr=r(Wl,"SPAN",{});var Xu=i(Sr);Qp=s(Xu,"MPNetForQuestionAnswering"),Xu.forEach(t),Wl.forEach(t),al=h(o),pt=r(o,"DIV",{class:!0});var Kt=i(pt);v(ys.$$.fragment,Kt),Hp=h(Kt),lo=r(Kt,"P",{});var er=i(lo);Rp=s(er,`MPNet Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
layers on top of the hidden-states output to compute `),Wr=r(er,"CODE",{});var Gu=i(Wr);Bp=s(Gu,"span start logits"),Gu.forEach(t),Vp=s(er," and "),Kr=r(er,"CODE",{});var Ju=i(Kr);Xp=s(Ju,"span end logits"),Ju.forEach(t),Gp=s(er,")."),er.forEach(t),Jp=h(Kt),$s=r(Kt,"P",{});var Kl=i($s);Yp=s(Kl,"This model inherits from "),Ca=r(Kl,"A",{href:!0});var Yu=i(Ca);Zp=s(Yu,"PreTrainedModel"),Yu.forEach(t),em=s(Kl,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Hl.forEach(t),ym=h(Pt),qs=r(Pt,"P",{});var Rl=i(qs);$m=s(Rl,"This model is also a "),xs=r(Rl,"A",{href:!0,rel:!0});var ig=i(xs);Mm=s(ig,"tf.keras.Model"),ig.forEach(t),Pm=s(Rl,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Rl.forEach(t),Nm=h(Pt),v(on.$$.fragment,Pt),Fm=h(Pt),$t=r(Pt,"DIV",{class:!0});var jn=i($t);v(js.$$.fragment,jn),Em=h(jn),mo=r(jn,"P",{});var or=i(mo);zm=s(or,"The "),Aa=r(or,"A",{href:!0});var lg=i(Aa);qm=s(lg,"TFMPNetModel"),lg.forEach(t),xm=s(or," forward method, overrides the "),Br=r(or,"CODE",{});var dg=i(Br);jm=s(dg,"__call__"),dg.forEach(t),Cm=s(or," special method."),or.forEach(t),Om=h(jn),v(nn.$$.fragment,jn),Lm=h(jn),v(sn.$$.fragment,jn),jn.forEach(t),Pt.forEach(t),ll=h(o),ho=r(o,"H2",{class:!0});var Bl=i(ho);an=r(Bl,"A",{id:!0,class:!0,href:!0});var cg=i(an);Vr=r(cg,"SPAN",{});var pg=i(Vr);v(Cs.$$.fragment,pg),pg.forEach(t),cg.forEach(t),Am=h(Bl),Xr=r(Bl,"SPAN",{});var mg=i(Xr);Dm=s(mg,"TFMPNetForMaskedLM"),mg.forEach(t),Bl.forEach(t),dl=h(o),tt=r(o,"DIV",{class:!0});var Nt=i(tt);v(Os.$$.fragment,Nt),Im=h(Nt),Ls=r(Nt,"P",{});var Vl=i(Ls);Sm=s(Vl,"MPNet Model with a "),Gr=r(Vl,"CODE",{});var hg=i(Gr);Wm=s(hg,"language modeling"),hg.forEach(t),Km=s(Vl," head on top."),Vl.forEach(t),Um=h(Nt),As=r(Nt,"P",{});var Xl=i(As);Qm=s(Xl,"This model inherits from "),Da=r(Xl,"A",{href:!0});var fg=i(Da);Hm=s(fg,"TFPreTrainedModel"),fg.forEach(t),Rm=s(Xl,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),od.forEach(t),Uh=h(Et),v(_n.$$.fragment,Et),Qh=h(Et),Mt=r(Et,"DIV",{class:!0});var Cn=i(Mt);v(Ys.$$.fragment,Cn),Hh=h(Cn),ko=r(Cn,"P",{});var ar=i(ko);Rh=s(ar,"The "),Ua=r(ar,"A",{href:!0});var xg=i(Ua);Bh=s(xg,"TFMPNetForMultipleChoice"),xg.forEach(t),Vh=s(ar," forward method, overrides the "),ai=r(ar,"CODE",{});var jg=i(ai);Xh=s(jg,"__call__"),jg.forEach(t),Gh=s(ar," special method."),ar.forEach(t),Jh=h(Cn),v(kn.$$.fragment,Cn),Yh=h(Cn),v(bn.$$.fragment,Cn),Cn.forEach(t),Et.forEach(t),fl=h(o),bo=r(o,"H2",{class:!0});var nd=i(bo);wn=r(nd,"A",{id:!0,class:!0,href:!0});var Cg=i(wn);ri=r(Cg,"SPAN",{});var Og=i(ri);v(Zs.$$.fragment,Og),Og.forEach(t),Cg.forEach(t),Zh=h(nd),ii=r(nd,"SPAN",{});var Lg=i(ii);ef=s(Lg,"TFMPNetForTokenClassification"),Lg.forEach(t),nd.forEach(t),ul=h(o),st=r(o,"DIV",{class:!0});var zt=i(st);v(ea.$$.fragment,zt),tf=h(zt),li=r(zt,"P",{});var Ag=i(li);of=s(Ag,`MPNet Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g. for
...
layers on top of the hidden-states output to compute `),mi=r(ir,"CODE",{});var Hg=i(mi);Nf=s(Hg,"span start logits"),Hg.forEach(t),Ff=s(ir," and "),hi=r(ir,"CODE",{});var Rg=i(hi);Ef=s(Rg,"span end logits"),Rg.forEach(t),zf=s(ir,")."),ir.forEach(t),qf=h(qt),ia=r(qt,"P",{});var id=i(ia);xf=s(id,"This model inherits from "),Ra=r(id,"A",{href:!0});var Bg=i(Ra);jf=s(Bg,"TFPreTrainedModel"),Bg.forEach(t),Cf=s(id,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
