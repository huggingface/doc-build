...
<span class="hljs-meta">&gt;&gt;&gt; </span>loss = outputs.loss
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-built_in">round</span>(loss.item(), <span class="hljs-number">2</span>)
`}}),{c(){T(l.$$.fragment)},l(c){M(l.$$.fragment,c)},m(c,p){$(l,c,p),g=!0},p:ve,i(c){g||(w(l.$$.fragment,c),g=!0)},o(c){P(l.$$.fragment,c),g=!1},d(c){N(l,c)}}}function T_(y){let l,g,c,p,b,d,f,E,le,B,z,X,D,J,de,W,ce,se,U,O,Y,V,q,x,Z,H,ae,ee,R,re,te,C,pe,Q,oe,me,L,ne,j,he;return{c(){l=n("p"),g=r("TF 2.0 models accepts two formats as inputs:"),c=m(),p=n("ul"),b=n("li"),d=r("having all inputs as keyword arguments (like PyTorch models), or"),f=m(),E=n("li"),le=r("having all inputs as a list, tuple or dict in the first positional arguments."),B=m(),z=n("p"),X=r("This second option is useful when using "),D=n("code"),J=r("tf.keras.Model.fit"),de=r(` method which currently requires having all the
...
`),j=s(ie,"CODE",{});var ue=a(j);he=i(ue,'model({"input_ids": input_ids, "attention_mask": attention_mask})'),ue.forEach(t),ie.forEach(t),A.forEach(t)},m(u,F){_(u,l,F),e(l,g),_(u,c,F),_(u,p,F),e(p,b),e(b,d),e(p,f),e(p,E),e(E,le),_(u,B,F),_(u,z,F),e(z,X),e(z,D),e(D,J),e(z,de),e(z,W),e(W,ce),e(z,se),_(u,U,F),_(u,O,F),e(O,Y),_(u,V,F),_(u,q,F),e(q,x),e(x,Z),e(x,H),e(H,ae),e(x,ee),e(x,R),e(R,re),e(q,te),e(q,C),e(C,pe),e(C,Q),e(Q,oe),e(q,me),e(q,L),e(L,ne),e(L,j),e(j,he)},d(u){u&&t(l),u&&t(c),u&&t(p),u&&t(B),u&&t(z),u&&t(U),u&&t(O),u&&t(V),u&&t(q)}}}function M_(y){let l,g,c,p,b;return{c(){l=n("p"),g=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),c=n("code"),p=r("Module"),b=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(d){l=s(d,"P",{});var f=a(l);g=i(f,"Although the recipe for forward pass needs to be defined within this function, one should call the "),c=s(f,"CODE",{});var E=a(c);p=i(E,"Module"),E.forEach(t),b=i(f,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),{c(){l=n("p"),g=r("Example:"),c=m(),T(p.$$.fragment)},l(d){l=s(d,"P",{});var f=a(l);g=i(f,"Example:"),f.forEach(t),c=h(d),M(p.$$.fragment,d)},m(d,f){_(d,l,f),e(l,g),_(d,c,f),$(p,d,f),b=!0},p:ve,i(d){b||(w(p.$$.fragment,d),b=!0)},o(d){P(p.$$.fragment,d),b=!1},d(d){d&&t(l),d&&t(c),N(p,d)}}}function w_(y){let l,g,c,p,b,d,f,E,le,B,z,X,D,J,de,W,ce,se,U,O,Y,V,q,x,Z,H,ae,ee,R,re,te,C,pe,Q,oe,me,L,ne,j,he;return{c(){l=n("p"),g=r("TF 2.0 models accepts two formats as inputs:"),c=m(),p=n("ul"),b=n("li"),d=r("having all inputs as keyword arguments (like PyTorch models), or"),f=m(),E=n("li"),le=r("having all inputs as a list, tuple or dict in the first positional arguments."),B=m(),z=n("p"),X=r("This second option is useful when using "),D=n("code"),J=r("tf.keras.Model.fit"),de=r(` method which currently requires having all the
tensors in the first argument of the model call function: `),W=n("code"),ce=r("model(inputs)"),se=r("."),U=m(),O=n("p"),Y=r(`If you choose this second option, there are three possibilities you can use to gather all the input Tensor in the
first positional argument :`),V=m(),q=n("ul"),x=n("li"),Z=r("a single Tensor with "),H=n("code"),ae=r("input_ids"),ee=r(" only and nothing else: "),R=n("code"),re=r("model(inputs_ids)"),te=m(),C=n("li"),pe=r(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),Q=n("code"),oe=r("model([input_ids, attention_mask])"),me=m(),L=n("li"),ne=r(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),j=n("code"),he=r('model({"input_ids": input_ids, "attention_mask": attention_mask})')},l(u){l=s(u,"P",{});var F=a(l);g=i(F,"TF 2.0 models accepts two formats as inputs:"),F.forEach(t),c=h(u),p=s(u,"UL",{});var K=a(p);b=s(K,"LI",{});var _e=a(b);d=i(_e,"having all inputs as keyword arguments (like PyTorch models), or"),_e.forEach(t),f=h(K),E=s(K,"LI",{});var Me=a(E);le=i(Me,"having all inputs as a list, tuple or dict in the first positional arguments."),Me.forEach(t),K.forEach(t),B=h(u),z=s(u,"P",{});var I=a(z);X=i(I,"This second option is useful when using "),D=s(I,"CODE",{});var ke=a(D);J=i(ke,"tf.keras.Model.fit"),ke.forEach(t),de=i(I,` method which currently requires having all the
...
`}}),{c(){T(l.$$.fragment)},l(c){M(l.$$.fragment,c)},m(c,p){$(l,c,p),g=!0},p:ve,i(c){g||(w(l.$$.fragment,c),g=!0)},o(c){P(l.$$.fragment,c),g=!1},d(c){N(l,c)}}}function F_(y){let l,g,c,p,b,d,f,E,le,B,z,X,D,J,de,W,ce,se,U,O,Y,V,q,x,Z,H,ae,ee,R,re,te,C,pe,Q,oe,me,L,ne,j,he;return{c(){l=n("p"),g=r("TF 2.0 models accepts two formats as inputs:"),c=m(),p=n("ul"),b=n("li"),d=r("having all inputs as keyword arguments (like PyTorch models), or"),f=m(),E=n("li"),le=r("having all inputs as a list, tuple or dict in the first positional arguments."),B=m(),z=n("p"),X=r("This second option is useful when using "),D=n("code"),J=r("tf.keras.Model.fit"),de=r(` method which currently requires having all the
tensors in the first argument of the model call function: `),W=n("code"),ce=r("model(inputs)"),se=r("."),U=m(),O=n("p"),Y=r(`If you choose this second option, there are three possibilities you can use to gather all the input Tensor in the
first positional argument :`),V=m(),q=n("ul"),x=n("li"),Z=r("a single Tensor with "),H=n("code"),ae=r("input_ids"),ee=r(" only and nothing else: "),R=n("code"),re=r("model(inputs_ids)"),te=m(),C=n("li"),pe=r(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),Q=n("code"),oe=r("model([input_ids, attention_mask])"),me=m(),L=n("li"),ne=r(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),j=n("code"),he=r('model({"input_ids": input_ids, "attention_mask": attention_mask})')},l(u){l=s(u,"P",{});var F=a(l);g=i(F,"TF 2.0 models accepts two formats as inputs:"),F.forEach(t),c=h(u),p=s(u,"UL",{});var K=a(p);b=s(K,"LI",{});var _e=a(b);d=i(_e,"having all inputs as keyword arguments (like PyTorch models), or"),_e.forEach(t),f=h(K),E=s(K,"LI",{});var Me=a(E);le=i(Me,"having all inputs as a list, tuple or dict in the first positional arguments."),Me.forEach(t),K.forEach(t),B=h(u),z=s(u,"P",{});var I=a(z);X=i(I,"This second option is useful when using "),D=s(I,"CODE",{});var ke=a(D);J=i(ke,"tf.keras.Model.fit"),ke.forEach(t),de=i(I,` method which currently requires having all the
...
`}}),{c(){T(l.$$.fragment)},l(c){M(l.$$.fragment,c)},m(c,p){$(l,c,p),g=!0},p:ve,i(c){g||(w(l.$$.fragment,c),g=!0)},o(c){P(l.$$.fragment,c),g=!1},d(c){N(l,c)}}}function x_(y){let l,g,c,p,b,d,f,E,le,B,z,X,D,J,de,W,ce,se,U,O,Y,V,q,x,Z,H,ae,ee,R,re,te,C,pe,Q,oe,me,L,ne,j,he;return{c(){l=n("p"),g=r("TF 2.0 models accepts two formats as inputs:"),c=m(),p=n("ul"),b=n("li"),d=r("having all inputs as keyword arguments (like PyTorch models), or"),f=m(),E=n("li"),le=r("having all inputs as a list, tuple or dict in the first positional arguments."),B=m(),z=n("p"),X=r("This second option is useful when using "),D=n("code"),J=r("tf.keras.Model.fit"),de=r(` method which currently requires having all the
tensors in the first argument of the model call function: `),W=n("code"),ce=r("model(inputs)"),se=r("."),U=m(),O=n("p"),Y=r(`If you choose this second option, there are three possibilities you can use to gather all the input Tensor in the
first positional argument :`),V=m(),q=n("ul"),x=n("li"),Z=r("a single Tensor with "),H=n("code"),ae=r("input_ids"),ee=r(" only and nothing else: "),R=n("code"),re=r("model(inputs_ids)"),te=m(),C=n("li"),pe=r(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),Q=n("code"),oe=r("model([input_ids, attention_mask])"),me=m(),L=n("li"),ne=r(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),j=n("code"),he=r('model({"input_ids": input_ids, "attention_mask": attention_mask})')},l(u){l=s(u,"P",{});var F=a(l);g=i(F,"TF 2.0 models accepts two formats as inputs:"),F.forEach(t),c=h(u),p=s(u,"UL",{});var K=a(p);b=s(K,"LI",{});var _e=a(b);d=i(_e,"having all inputs as keyword arguments (like PyTorch models), or"),_e.forEach(t),f=h(K),E=s(K,"LI",{});var Me=a(E);le=i(Me,"having all inputs as a list, tuple or dict in the first positional arguments."),Me.forEach(t),K.forEach(t),B=h(u),z=s(u,"P",{});var I=a(z);X=i(I,"This second option is useful when using "),D=s(I,"CODE",{});var ke=a(D);J=i(ke,"tf.keras.Model.fit"),ke.forEach(t),de=i(I,` method which currently requires having all the
...
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-comment"># the linear classifier still needs to be trained</span>
<span class="hljs-meta">&gt;&gt;&gt; </span>logits = outputs.logits`}}),{c(){l=n("p"),g=r("Example:"),c=m(),T(p.$$.fragment)},l(d){l=s(d,"P",{});var f=a(l);g=i(f,"Example:"),f.forEach(t),c=h(d),M(p.$$.fragment,d)},m(d,f){_(d,l,f),e(l,g),_(d,c,f),$(p,d,f),b=!0},p:ve,i(d){b||(w(p.$$.fragment,d),b=!0)},o(d){P(p.$$.fragment,d),b=!1},d(d){d&&t(l),d&&t(c),N(p,d)}}}function L_(y){let l,g,c,p,b,d,f,E,le,B,z,X,D,J,de,W,ce,se,U,O,Y,V,q,x,Z,H,ae,ee,R,re,te,C,pe,Q,oe,me,L,ne,j,he;return{c(){l=n("p"),g=r("TF 2.0 models accepts two formats as inputs:"),c=m(),p=n("ul"),b=n("li"),d=r("having all inputs as keyword arguments (like PyTorch models), or"),f=m(),E=n("li"),le=r("having all inputs as a list, tuple or dict in the first positional arguments."),B=m(),z=n("p"),X=r("This second option is useful when using "),D=n("code"),J=r("tf.keras.Model.fit"),de=r(` method which currently requires having all the
tensors in the first argument of the model call function: `),W=n("code"),ce=r("model(inputs)"),se=r("."),U=m(),O=n("p"),Y=r(`If you choose this second option, there are three possibilities you can use to gather all the input Tensor in the
first positional argument :`),V=m(),q=n("ul"),x=n("li"),Z=r("a single Tensor with "),H=n("code"),ae=r("input_ids"),ee=r(" only and nothing else: "),R=n("code"),re=r("model(inputs_ids)"),te=m(),C=n("li"),pe=r(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),Q=n("code"),oe=r("model([input_ids, attention_mask])"),me=m(),L=n("li"),ne=r(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),j=n("code"),he=r('model({"input_ids": input_ids, "attention_mask": attention_mask})')},l(u){l=s(u,"P",{});var F=a(l);g=i(F,"TF 2.0 models accepts two formats as inputs:"),F.forEach(t),c=h(u),p=s(u,"UL",{});var K=a(p);b=s(K,"LI",{});var _e=a(b);d=i(_e,"having all inputs as keyword arguments (like PyTorch models), or"),_e.forEach(t),f=h(K),E=s(K,"LI",{});var Me=a(E);le=i(Me,"having all inputs as a list, tuple or dict in the first positional arguments."),Me.forEach(t),K.forEach(t),B=h(u),z=s(u,"P",{});var I=a(z);X=i(I,"This second option is useful when using "),D=s(I,"CODE",{});var ke=a(D);J=i(ke,"tf.keras.Model.fit"),ke.forEach(t),de=i(I,` method which currently requires having all the
...
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-built_in">round</span>(<span class="hljs-built_in">float</span>(loss), <span class="hljs-number">2</span>)
`}}),{c(){T(l.$$.fragment)},l(c){M(l.$$.fragment,c)},m(c,p){$(l,c,p),g=!0},p:ve,i(c){g||(w(l.$$.fragment,c),g=!0)},o(c){P(l.$$.fragment,c),g=!1},d(c){N(l,c)}}}function S_(y){let l,g,c,p,b,d,f,E,le,B,z,X,D,J,de,W,ce,se,U,O,Y,V,q,x,Z,H,ae,ee,R,re,te,C,pe,Q,oe,me,L,ne,j,he;return{c(){l=n("p"),g=r("TF 2.0 models accepts two formats as inputs:"),c=m(),p=n("ul"),b=n("li"),d=r("having all inputs as keyword arguments (like PyTorch models), or"),f=m(),E=n("li"),le=r("having all inputs as a list, tuple or dict in the first positional arguments."),B=m(),z=n("p"),X=r("This second option is useful when using "),D=n("code"),J=r("tf.keras.Model.fit"),de=r(` method which currently requires having all the
tensors in the first argument of the model call function: `),W=n("code"),ce=r("model(inputs)"),se=r("."),U=m(),O=n("p"),Y=r(`If you choose this second option, there are three possibilities you can use to gather all the input Tensor in the
first positional argument :`),V=m(),q=n("ul"),x=n("li"),Z=r("a single Tensor with "),H=n("code"),ae=r("input_ids"),ee=r(" only and nothing else: "),R=n("code"),re=r("model(inputs_ids)"),te=m(),C=n("li"),pe=r(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),Q=n("code"),oe=r("model([input_ids, attention_mask])"),me=m(),L=n("li"),ne=r(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),j=n("code"),he=r('model({"input_ids": input_ids, "attention_mask": attention_mask})')},l(u){l=s(u,"P",{});var F=a(l);g=i(F,"TF 2.0 models accepts two formats as inputs:"),F.forEach(t),c=h(u),p=s(u,"UL",{});var K=a(p);b=s(K,"LI",{});var _e=a(b);d=i(_e,"having all inputs as keyword arguments (like PyTorch models), or"),_e.forEach(t),f=h(K),E=s(K,"LI",{});var Me=a(E);le=i(Me,"having all inputs as a list, tuple or dict in the first positional arguments."),Me.forEach(t),K.forEach(t),B=h(u),z=s(u,"P",{});var I=a(z);X=i(I,"This second option is useful when using "),D=s(I,"CODE",{});var ke=a(D);J=i(ke,"tf.keras.Model.fit"),ke.forEach(t),de=i(I,` method which currently requires having all the
...
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-built_in">round</span>(<span class="hljs-built_in">float</span>(loss), <span class="hljs-number">2</span>)
`}}),{c(){T(l.$$.fragment)},l(c){M(l.$$.fragment,c)},m(c,p){$(l,c,p),g=!0},p:ve,i(c){g||(w(l.$$.fragment,c),g=!0)},o(c){P(l.$$.fragment,c),g=!1},d(c){N(l,c)}}}function H_(y){let l,g,c,p,b,d,f,E,le,B,z,X,D,J,de,W,ce,se,U,O,Y,V,q,x,Z,H,ae,ee,R,re,te,C,pe,Q,oe,me,L,ne,j,he,u,F,K,_e,Me,I,ke,$e,we,A,S,Pe,ge,fe,Ne,ie,ue,no,Ka,un,Jl,Xa,Yl,qi,Je,gn,Zl,dt,ed,ta,td,od,oa,nd,sd,_n,ad,rd,id,Nt,ld,na,dd,cd,sa,pd,md,hd,so,xi,yt,ao,Ga,kn,fd,Ja,ud,Ci,Ee,bn,gd,vn,_d,aa,kd,bd,vd,ht,Tn,Td,Ya,Md,$d,Mn,ra,wd,Za,Pd,Nd,ia,yd,er,Fd,Ed,ro,$n,zd,wn,qd,tr,xd,Cd,jd,io,Pn,Ld,or,Ad,Od,la,Nn,ji,Ft,lo,nr,yn,Id,sr,Sd,Li,Ye,Fn,Dd,En,Wd,ar,Qd,Hd,Rd,zn,Ud,da,Bd,Vd,Kd,co,qn,Xd,rr,Gd,Ai,Et,po,ir,xn,Jd,lr,Yd,Oi,Oe,Cn,Zd,dr,ec,tc,jn,oc,ca,nc,sc,ac,Ln,rc,An,ic,lc,dc,Ze,On,cc,zt,pc,pa,mc,hc,cr,fc,uc,gc,mo,_c,ho,Ii,qt,fo,pr,In,kc,mr,bc,Si,xt,Sn,vc,He,Dn,Tc,Ct,Mc,ma,$c,wc,hr,Pc,Nc,yc,uo,Fc,go,Ec,_o,Di,jt,ko,fr,Wn,zc,ur,qc,Wi,Ie,Qn,xc,gr,Cc,jc,Hn,Lc,ha,Ac,Oc,Ic,Rn,Sc,Un,Dc,Wc,Qc,ye,Bn,Hc,Lt,Rc,fa,Uc,Bc,_r,Vc,Kc,Xc,bo,Gc,vo,Jc,To,Yc,Mo,Zc,$o,Qi,At,wo,kr,Vn,ep,br,tp,Hi,Se,Kn,op,vr,np,sp,Xn,ap,ua,rp,ip,lp,Gn,dp,Jn,cp,pp,mp,et,Yn,hp,Ot,fp,ga,up,gp,Tr,_p,kp,bp,Po,vp,No,Ri,It,yo,Mr,Zn,Tp,$r,Mp,Ui,De,es,$p,wr,wp,Pp,ts,Np,_a,yp,Fp,Ep,os,zp,ns,qp,xp,Cp,Re,ss,jp,St,Lp,ka,Ap,Op,Pr,Ip,Sp,Dp,Fo,Wp,Eo,Qp,zo,Bi,Dt,qo,Nr,as,Hp,yr,Rp,Vi,We,rs,Up,Wt,Bp,Fr,Vp,Kp,Er,Xp,Gp,Jp,is,Yp,ba,Zp,em,tm,ls,om,ds,nm,sm,am,Ue,cs,rm,Qt,im,va,lm,dm,zr,cm,pm,mm,xo,hm,Co,fm,jo,Ki,Ht,Lo,qr,ps,um,xr,gm,Xi,ze,ms,_m,Cr,km,bm,hs,vm,Ta,Tm,Mm,$m,fs,wm,us,Pm,Nm,ym,Ao,Fm,tt,gs,Em,Rt,zm,Ma,qm,xm,jr,Cm,jm,Lm,Oo,Am,Io,Gi,Ut,So,Lr,_s,Om,Ar,Im,Ji,qe,ks,Sm,bs,Dm,Or,Wm,Qm,Hm,vs,Rm,$a,Um,Bm,Vm,Ts,Km,Ms,Xm,Gm,Jm,Do,Ym,Be,$s,Zm,Bt,eh,wa,th,oh,Ir,nh,sh,ah,Wo,rh,Qo,ih,Ho,Yi,Vt,Ro,Sr,ws,lh,Dr,dh,Zi,xe,Ps,ch,Wr,ph,mh,Ns,hh,Pa,fh,uh,gh,ys,_h,Fs,kh,bh,vh,Uo,Th,Ve,Es,Mh,Kt,$h,Na,wh,Ph,Qr,Nh,yh,Fh,Bo,Eh,Vo,zh,Ko,el,Xt,Xo,Hr,zs,qh,Rr,xh,tl,Ce,qs,Ch,Ur,jh,Lh,xs,Ah,ya,Oh,Ih,Sh,Cs,Dh,js,Wh,Qh,Hh,Go,Rh,ot,Ls,Uh,Gt,Bh,Fa,Vh,Kh,Br,Xh,Gh,Jh,Jo,Yh,Yo,ol,Jt,Zo,Vr,As,Zh,Kr,ef,nl,je,Os,tf,Xr,of,nf,Is,sf,Ea,af,rf,lf,Ss,df,Ds,cf,pf,mf,en,hf,Ke,Ws,ff,Yt,uf,za,gf,_f,Gr,kf,bf,vf,tn,Tf,on,Mf,nn,sl,Zt,sn,Jr,Qs,$f,Yr,wf,al,Le,Hs,Pf,eo,Nf,Zr,yf,Ff,ei,Ef,zf,qf,Rs,xf,qa,Cf,jf,Lf,Us,Af,Bs,Of,If,Sf,an,Df,Xe,Vs,Wf,to,Qf,xa,Hf,Rf,ti,Uf,Bf,Vf,rn,Kf,ln,Xf,dn,rl;return d=new Ae({}),J=new Ae({}),un=new Ae({}),gn=new G({props:{name:"class transformers.MPNetConfig",anchor:"transformers.MPNetConfig",parameters:[{name:"vocab_size",val:" = 30527"},{name:"hidden_size",val:" = 768"},{name:"num_hidden_layers",val:" = 12"},{name:"num_attention_heads",val:" = 12"},{name:"intermediate_size",val:" = 3072"},{name:"hidden_act",val:" = 'gelu'"},{name:"hidden_dropout_prob",val:" = 0.1"},{name:"attention_probs_dropout_prob",val:" = 0.1"},{name:"max_position_embeddings",val:" = 512"},{name:"initializer_range",val:" = 0.02"},{name:"layer_norm_eps",val:" = 1e-12"},{name:"relative_attention_num_buckets",val:" = 32"},{name:"pad_token_id",val:" = 1"},{name:"bos_token_id",val:" = 0"},{name:"eos_token_id",val:" = 2"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.MPNetConfig.vocab_size",description:`<strong>vocab_size</strong> (<code>int</code>, <em>optional</em>, defaults to 30527) &#x2014;
...
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/main/en/model_doc/mpnet#transformers.MPNetTokenizer">MPNetTokenizer</a>. See <a href="/docs/transformers/main/en/model_doc/wav2vec2#transformers.Wav2Vec2CTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
...
documentation from `),sa=n("a"),pd=r("PretrainedConfig"),md=r(" for more information."),hd=m(),T(so.$$.fragment),xi=m(),yt=n("h2"),ao=n("a"),Ga=n("span"),T(kn.$$.fragment),fd=m(),Ja=n("span"),ud=r("MPNetTokenizer"),Ci=m(),Ee=n("div"),T(bn.$$.fragment),gd=m(),vn=n("p"),_d=r("This tokenizer inherits from "),aa=n("a"),kd=r("BertTokenizer"),bd=r(` which contains most of the methods. Users should refer to the
...
layers on top of the hidden-states output to compute `),Fr=n("code"),Vp=r("span start logits"),Kp=r(" and "),Er=n("code"),Xp=r("span end logits"),Gp=r(")."),Jp=m(),is=n("p"),Yp=r("This model inherits from "),ba=n("a"),Zp=r("PreTrainedModel"),em=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),mf=m(),T(en.$$.fragment),hf=m(),Ke=n("div"),T(Ws.$$.fragment),ff=m(),Yt=n("p"),uf=r("The "),za=n("a"),gf=r("TFMPNetForTokenClassification"),_f=r(" forward method, overrides the "),Gr=n("code"),kf=r("__call__"),bf=r(" special method."),vf=m(),T(tn.$$.fragment),Tf=m(),T(on.$$.fragment),Mf=m(),T(nn.$$.fragment),sl=m(),Zt=n("h2"),sn=n("a"),Jr=n("span"),T(Qs.$$.fragment),$f=m(),Yr=n("span"),wf=r("TFMPNetForQuestionAnswering"),al=m(),Le=n("div"),T(Hs.$$.fragment),Pf=m(),eo=n("p"),Nf=r(`MPNet Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Sf=m(),T(an.$$.fragment),Df=m(),Xe=n("div"),T(Vs.$$.fragment),Wf=m(),to=n("p"),Qf=r("The "),xa=n("a"),Hf=r("TFMPNetForQuestionAnswering"),Rf=r(" forward method, overrides the "),ti=n("code"),Uf=r("__call__"),Bf=r(" special method."),Vf=m(),T(rn.$$.fragment),Kf=m(),T(ln.$$.fragment),Xf=m(),T(dn.$$.fragment),this.h()},l(o){const k=e_('[data-svelte="svelte-1phssyn"]',document.head);l=s(k,"META",{name:!0,content:!0}),k.forEach(t),g=h(o),c=s(o,"H1",{class:!0});var Ks=a(c);p=s(Ks,"A",{id:!0,class:!0,href:!0});var oi=a(p);b=s(oi,"SPAN",{});var ni=a(b);M(d.$$.fragment,ni),ni.forEach(t),oi.forEach(t),f=h(Ks),E=s(Ks,"SPAN",{});var si=a(E);le=i(si,"MPNet"),si.forEach(t),Ks.forEach(t),B=h(o),z=s(o,"H2",{class:!0});var Xs=a(z);X=s(Xs,"A",{id:!0,class:!0,href:!0});var ai=a(X);D=s(ai,"SPAN",{});var ri=a(D);M(J.$$.fragment,ri),ri.forEach(t),ai.forEach(t),de=h(Xs),W=s(Xs,"SPAN",{});var ii=a(W);ce=i(ii,"Overview"),ii.forEach(t),Xs.forEach(t),se=h(o),U=s(o,"P",{});var Gs=a(U);O=i(Gs,"The MPNet model was proposed in "),Y=s(Gs,"A",{href:!0,rel:!0});var li=a(Y);V=i(li,"MPNet: Masked and Permuted Pre-training for Language Understanding"),li.forEach(t),q=i(Gs," by Kaitao Song, Xu Tan, Tao Qin, Jianfeng Lu, Tie-Yan Liu."),Gs.forEach(t),x=h(o),Z=s(o,"P",{});var di=a(Z);H=i(di,`MPNet adopts a novel pre-training method, named masked and permuted language modeling, to inherit the advantages of
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Ml.forEach(t),Qc=h(gt),ye=s(gt,"DIV",{class:!0});var Ge=a(ye);M(Bn.$$.fragment,Ge),Hc=h(Ge),Lt=s(Ge,"P",{});var Aa=a(Lt);Rc=i(Aa,"The "),fa=s(Aa,"A",{href:!0});var Eu=a(fa);Uc=i(Eu,"MPNetForSequenceClassification"),Eu.forEach(t),Bc=i(Aa," forward method, overrides the "),_r=s(Aa,"CODE",{});var zu=a(_r);Vc=i(zu,"__call__"),zu.forEach(t),Kc=i(Aa," special method."),Aa.forEach(t),Xc=h(Ge),M(bo.$$.fragment,Ge),Gc=h(Ge),M(vo.$$.fragment,Ge),Jc=h(Ge),M(To.$$.fragment,Ge),Yc=h(Ge),M(Mo.$$.fragment,Ge),Zc=h(Ge),M($o.$$.fragment,Ge),Ge.forEach(t),gt.forEach(t),Qi=h(o),At=s(o,"H2",{class:!0});var $l=a(At);wo=s($l,"A",{id:!0,class:!0,href:!0});var qu=a(wo);kr=s(qu,"SPAN",{});var xu=a(kr);M(Vn.$$.fragment,xu),xu.forEach(t),qu.forEach(t),ep=h($l),br=s($l,"SPAN",{});var Cu=a(br);tp=i(Cu,"MPNetForMultipleChoice"),Cu.forEach(t),$l.forEach(t),Hi=h(o),Se=s(o,"DIV",{class:!0});var _t=a(Se);M(Kn.$$.fragment,_t),op=h(_t),vr=s(_t,"P",{});var ju=a(vr);np=i(ju,`MPNet Model with a multiple choice classification head on top (a linear layer on top of the pooled output and a
