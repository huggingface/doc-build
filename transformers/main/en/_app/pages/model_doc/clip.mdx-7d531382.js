import{S as aP,i as rP,s as iP,e as n,k as l,w as u,t as r,M as lP,c as s,d as o,m as d,a,x as g,h as i,b as c,F as e,g as h,y as _,q as v,o as P,B as T,v as dP}from"../../chunks/vendor-6b77c823.js";import{T as ce}from"../../chunks/Tip-39098574.js";import{D as k}from"../../chunks/Docstring-abef54e3.js";import{C as A}from"../../chunks/CodeBlock-3a8b25a8.js";import{I as D}from"../../chunks/IconCopyLink-7a11ce68.js";function cP(x){let p,L,I,C,b;return{c(){p=n("p"),L=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),I=n("code"),C=r("Module"),b=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(y){p=s(y,"P",{});var f=a(p);L=i(f,"Although the recipe for forward pass needs to be defined within this function, one should call the "),I=s(f,"CODE",{});var w=a(I);C=i(w,"Module"),w.forEach(o),b=i(f,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),f.forEach(o)},m(y,f){h(y,p,f),e(p,L),e(p,I),e(I,C),e(p,b)},d(y){y&&o(p)}}}function pP(x){let p,L,I,C,b;return{c(){p=n("p"),L=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),I=n("code"),C=r("Module"),b=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(y){p=s(y,"P",{});var f=a(p);L=i(f,"Although the recipe for forward pass needs to be defined within this function, one should call the "),I=s(f,"CODE",{});var w=a(I);C=i(w,"Module"),w.forEach(o),b=i(f,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),f.forEach(o)},m(y,f){h(y,p,f),e(p,L),e(p,I),e(I,C),e(p,b)},d(y){y&&o(p)}}}function mP(x){let p,L,I,C,b;return{c(){p=n("p"),L=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),I=n("code"),C=r("Module"),b=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(y){p=s(y,"P",{});var f=a(p);L=i(f,"Although the recipe for forward pass needs to be defined within this function, one should call the "),I=s(f,"CODE",{});var w=a(I);C=i(w,"Module"),w.forEach(o),b=i(f,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),f.forEach(o)},m(y,f){h(y,p,f),e(p,L),e(p,I),e(I,C),e(p,b)},d(y){y&&o(p)}}}function hP(x){let p,L,I,C,b;return{c(){p=n("p"),L=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),I=n("code"),C=r("Module"),b=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(y){p=s(y,"P",{});var f=a(p);L=i(f,"Although the recipe for forward pass needs to be defined within this function, one should call the "),I=s(f,"CODE",{});var w=a(I);C=i(w,"Module"),w.forEach(o),b=i(f,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),f.forEach(o)},m(y,f){h(y,p,f),e(p,L),e(p,I),e(I,C),e(p,b)},d(y){y&&o(p)}}}function fP(x){let p,L,I,C,b;return{c(){p=n("p"),L=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),I=n("code"),C=r("Module"),b=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(y){p=s(y,"P",{});var f=a(p);L=i(f,"Although the recipe for forward pass needs to be defined within this function, one should call the "),I=s(f,"CODE",{});var w=a(I);C=i(w,"Module"),w.forEach(o),b=i(f,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),f.forEach(o)},m(y,f){h(y,p,f),e(p,L),e(p,I),e(I,C),e(p,b)},d(y){y&&o(p)}}}function uP(x){let p,L,I,C,b,y,f,w,Ho,rt,z,ue,ye,Ce,Ko,be,Go,Xt,pe,ze,Le,Zt,H,me,je,it,Qt,Fe,we,Jo,Yt,O,ge,ke,$e,Xo,xe,Zo,eo,he,Qo,qe,_e;return{c(){p=n("p"),L=r("TF 2.0 models accepts two formats as inputs:"),I=l(),C=n("ul"),b=n("li"),y=r("having all inputs as keyword arguments (like PyTorch models), or"),f=l(),w=n("li"),Ho=r("having all inputs as a list, tuple or dict in the first positional arguments."),rt=l(),z=n("p"),ue=r("This second option is useful when using "),ye=n("code"),Ce=r("tf.keras.Model.fit"),Ko=r(` method which currently requires having all the
...
`),ke=n("code"),$e=r("model([input_ids, attention_mask])"),Xo=r(" or "),xe=n("code"),Zo=r("model([input_ids, attention_mask, token_type_ids])"),eo=l(),he=n("li"),Qo=r(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),qe=n("code"),_e=r('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l($){p=s($,"P",{});var j=a(p);L=i(j,"TF 2.0 models accepts two formats as inputs:"),j.forEach(o),I=d($),C=s($,"UL",{});var to=a(C);b=s(to,"LI",{});var Qs=a(b);y=i(Qs,"having all inputs as keyword arguments (like PyTorch models), or"),Qs.forEach(o),f=d(to),w=s(to,"LI",{});var Yo=a(w);Ho=i(Yo,"having all inputs as a list, tuple or dict in the first positional arguments."),Yo.forEach(o),to.forEach(o),rt=d($),z=s($,"P",{});var E=a(z);ue=i(E,"This second option is useful when using "),ye=s(E,"CODE",{});var Ys=a(ye);Ce=i(Ys,"tf.keras.Model.fit"),Ys.forEach(o),Ko=i(E,` method which currently requires having all the
tensors in the first argument of the model call function: `),be=s(E,"CODE",{});var lt=a(be);Go=i(lt,"model(inputs)"),lt.forEach(o),Xt=i(E,"."),E.forEach(o),pe=d($),ze=s($,"P",{});var ea=a(ze);Le=i(ea,`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
...
`),ke=s(Pe,"CODE",{});var na=a(ke);$e=i(na,"model([input_ids, attention_mask])"),na.forEach(o),Xo=i(Pe," or "),xe=s(Pe,"CODE",{});var sa=a(xe);Zo=i(sa,"model([input_ids, attention_mask, token_type_ids])"),sa.forEach(o),Pe.forEach(o),eo=d(De),he=s(De,"LI",{});var Oe=a(he);Qo=i(Oe,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),qe=s(Oe,"CODE",{});var aa=a(qe);_e=i(aa,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),aa.forEach(o),Oe.forEach(o),De.forEach(o)},m($,j){h($,p,j),e(p,L),h($,I,j),h($,C,j),e(C,b),e(b,y),e(C,f),e(C,w),e(w,Ho),h($,rt,j),h($,z,j),e(z,ue),e(z,ye),e(ye,Ce),e(z,Ko),e(z,be),e(be,Go),e(z,Xt),h($,pe,j),h($,ze,j),e(ze,Le),h($,Zt,j),h($,H,j),e(H,me),e(me,je),e(me,it),e(it,Qt),e(me,Fe),e(me,we),e(we,Jo),e(H,Yt),e(H,O),e(O,ge),e(O,ke),e(ke,$e),e(O,Xo),e(O,xe),e(xe,Zo),e(H,eo),e(H,he),e(he,Qo),e(he,qe),e(qe,_e)},d($){$&&o(p),$&&o(I),$&&o(C),$&&o(rt),$&&o(z),$&&o(pe),$&&o(ze),$&&o(Zt),$&&o(H)}}}function gP(x){let p,L,I,C,b;return{c(){p=n("p"),L=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),I=n("code"),C=r("Module"),b=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(y){p=s(y,"P",{});var f=a(p);L=i(f,"Although the recipe for forward pass needs to be defined within this function, one should call the "),I=s(f,"CODE",{});var w=a(I);C=i(w,"Module"),w.forEach(o),b=i(f,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),f.forEach(o)},m(y,f){h(y,p,f),e(p,L),e(p,I),e(I,C),e(p,b)},d(y){y&&o(p)}}}function _P(x){let p,L,I,C,b;return{c(){p=n("p"),L=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),I=n("code"),C=r("Module"),b=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(y){p=s(y,"P",{});var f=a(p);L=i(f,"Although the recipe for forward pass needs to be defined within this function, one should call the "),I=s(f,"CODE",{});var w=a(I);C=i(w,"Module"),w.forEach(o),b=i(f,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),f.forEach(o)},m(y,f){h(y,p,f),e(p,L),e(p,I),e(I,C),e(p,b)},d(y){y&&o(p)}}}function vP(x){let p,L,I,C,b;return{c(){p=n("p"),L=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),I=n("code"),C=r("Module"),b=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(y){p=s(y,"P",{});var f=a(p);L=i(f,"Although the recipe for forward pass needs to be defined within this function, one should call the "),I=s(f,"CODE",{});var w=a(I);C=i(w,"Module"),w.forEach(o),b=i(f,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),f.forEach(o)},m(y,f){h(y,p,f),e(p,L),e(p,I),e(I,C),e(p,b)},d(y){y&&o(p)}}}function PP(x){let p,L,I,C,b;return{c(){p=n("p"),L=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),I=n("code"),C=r("Module"),b=r(`
...
the latter silently ignores them.`)},l(y){p=s(y,"P",{});var f=a(p);L=i(f,"Although the recipe for forward pass needs to be defined within this function, one should call the "),I=s(f,"CODE",{});var w=a(I);C=i(w,"Module"),w.forEach(o),b=i(f,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),f.forEach(o)},m(y,f){h(y,p,f),e(p,L),e(p,I),e(I,C),e(p,b)},d(y){y&&o(p)}}}function TP(x){let p,L,I,C,b;return{c(){p=n("p"),L=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),I=n("code"),C=r("Module"),b=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(y){p=s(y,"P",{});var f=a(p);L=i(f,"Although the recipe for forward pass needs to be defined within this function, one should call the "),I=s(f,"CODE",{});var w=a(I);C=i(w,"Module"),w.forEach(o),b=i(f,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),f.forEach(o)},m(y,f){h(y,p,f),e(p,L),e(p,I),e(I,C),e(p,b)},d(y){y&&o(p)}}}function IP(x){let p,L,I,C,b;return{c(){p=n("p"),L=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),I=n("code"),C=r("Module"),b=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(y){p=s(y,"P",{});var f=a(p);L=i(f,"Although the recipe for forward pass needs to be defined within this function, one should call the "),I=s(f,"CODE",{});var w=a(I);C=i(w,"Module"),w.forEach(o),b=i(f,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),f.forEach(o)},m(y,f){h(y,p,f),e(p,L),e(p,I),e(I,C),e(p,b)},d(y){y&&o(p)}}}function yP(x){let p,L,I,C,b;return{c(){p=n("p"),L=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),I=n("code"),C=r("Module"),b=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(y){p=s(y,"P",{});var f=a(p);L=i(f,"Although the recipe for forward pass needs to be defined within this function, one should call the "),I=s(f,"CODE",{});var w=a(I);C=i(w,"Module"),w.forEach(o),b=i(f,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),f.forEach(o)},m(y,f){h(y,p,f),e(p,L),e(p,I),e(I,C),e(p,b)},d(y){y&&o(p)}}}function CP(x){let p,L,I,C,b;return{c(){p=n("p"),L=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),I=n("code"),C=r("Module"),b=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(y){p=s(y,"P",{});var f=a(p);L=i(f,"Although the recipe for forward pass needs to be defined within this function, one should call the "),I=s(f,"CODE",{});var w=a(I);C=i(w,"Module"),w.forEach(o),b=i(f,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),f.forEach(o)},m(y,f){h(y,p,f),e(p,L),e(p,I),e(I,C),e(p,b)},d(y){y&&o(p)}}}function bP(x){let p,L,I,C,b,y,f,w,Ho,rt,z,ue,ye,Ce,Ko,be,Go,Xt,pe,ze,Le,Zt,H,me,je,it,Qt,Fe,we,Jo,Yt,O,ge,ke,$e,Xo,xe,Zo,eo,he,Qo,qe,_e,$,j,to,Qs,Yo,E,Ys,lt,ea,De,ve,ta,oa,Pe,na,sa,Oe,aa,xd,ra,Ed,Md,ia,zd,jd,nl,en,sl,Ae,Fd,tn,qd,Dd,on,Od,Ad,al,dt,oo,pr,nn,Nd,mr,Vd,rl,fe,sn,Sd,no,la,Wd,Bd,da,Ud,Rd,Hd,ct,Kd,ca,Gd,Jd,pa,Xd,Zd,Qd,so,an,Yd,rn,ec,ma,tc,oc,il,pt,ao,hr,ln,nc,fr,sc,ll,V,dn,ac,mt,rc,ha,ic,lc,cn,dc,cc,pc,ht,mc,fa,hc,fc,ua,uc,gc,_c,ur,vc,Pc,pn,dl,ft,ro,gr,mn,Tc,_r,Ic,cl,S,hn,yc,ut,Cc,ga,bc,Lc,fn,wc,kc,$c,gt,xc,_a,Ec,Mc,va,zc,jc,Fc,vr,qc,Dc,un,pl,_t,io,Pr,gn,Oc,Tr,Ac,ml,F,_n,Nc,Ir,Vc,Sc,vn,Wc,Pa,Bc,Uc,Rc,Te,Pn,Hc,yr,Kc,Gc,Cr,Ta,Jc,br,Xc,Zc,Lr,Qc,Yc,lo,Tn,ep,In,tp,wr,op,np,sp,co,yn,ap,kr,rp,ip,Ia,Cn,hl,vt,po,$r,bn,lp,xr,dp,fl,W,Ln,cp,wn,pp,Er,mp,hp,fp,kn,up,ya,gp,_p,vp,Ie,$n,Pp,Mr,Tp,Ip,zr,Ca,yp,jr,Cp,bp,Fr,Lp,wp,mo,xn,kp,qr,$p,ul,Pt,ho,Dr,En,xp,Or,Ep,gl,B,Mn,Mp,Ar,zp,jp,zn,Fp,ba,qp,Dp,Op,fo,jn,Ap,Fn,Np,Nr,Vp,Sp,Wp,uo,qn,Bp,Tt,Up,Vr,Rp,Hp,Sr,Kp,Gp,_l,It,go,Wr,Dn,Jp,Br,Xp,vl,U,On,Zp,Ur,Qp,Yp,K,La,em,tm,wa,om,nm,ka,sm,am,Rr,rm,im,$a,lm,dm,cm,_o,An,pm,Nn,mm,xa,hm,fm,um,vo,Vn,gm,Sn,_m,Ea,vm,Pm,Pl,yt,Po,Hr,Wn,Tm,Kr,Im,Tl,R,Bn,ym,Un,Cm,Rn,bm,Lm,wm,G,Hn,km,Ct,$m,Ma,xm,Em,Gr,Mm,zm,jm,To,Fm,Jr,qm,Dm,Kn,Om,J,Gn,Am,bt,Nm,za,Vm,Sm,Xr,Wm,Bm,Um,Io,Rm,Zr,Hm,Km,Jn,Gm,X,Xn,Jm,Lt,Xm,ja,Zm,Qm,Qr,Ym,eh,th,yo,oh,Yr,nh,sh,Zn,Il,wt,Co,ei,Qn,ah,ti,rh,yl,kt,Yn,ih,Z,es,lh,$t,dh,Fa,ch,ph,oi,mh,hh,fh,bo,uh,ni,gh,_h,ts,Cl,xt,Lo,si,os,vh,ai,Ph,bl,Et,ns,Th,Q,ss,Ih,Mt,yh,qa,Ch,bh,ri,Lh,wh,kh,wo,$h,ii,xh,Eh,as,Ll,zt,ko,li,rs,Mh,di,zh,wl,q,is,jh,ls,Fh,Da,qh,Dh,Oh,ds,Ah,cs,Nh,Vh,Sh,$o,Wh,Y,ps,Bh,jt,Uh,Oa,Rh,Hh,ci,Kh,Gh,Jh,xo,Xh,pi,Zh,Qh,ms,Yh,ee,hs,ef,Ft,tf,Aa,of,nf,mi,sf,af,rf,Eo,lf,hi,df,cf,fs,pf,te,us,mf,qt,hf,Na,ff,uf,fi,gf,_f,vf,Mo,Pf,ui,Tf,If,gs,kl,Dt,zo,gi,_s,yf,_i,Cf,$l,Ot,vs,bf,oe,Ps,Lf,At,wf,Va,kf,$f,vi,xf,Ef,Mf,jo,zf,Pi,jf,Ff,Ts,xl,Nt,Fo,Ti,Is,qf,Ii,Df,El,Vt,ys,Of,ne,Cs,Af,St,Nf,Sa,Vf,Sf,yi,Wf,Bf,Uf,qo,Rf,Ci,Hf,Kf,bs,Ml,Wt,Do,bi,Ls,Gf,Li,Jf,zl,M,ws,Xf,ks,Zf,Wa,Qf,Yf,eu,$s,tu,xs,ou,nu,su,wi,au,ru,Ee,ki,Es,iu,lu,$i,Ms,du,cu,xi,zs,pu,mu,Ei,js,hu,fu,se,Fs,uu,Bt,gu,Mi,_u,vu,zi,Pu,Tu,Iu,Oo,yu,ji,Cu,bu,qs,Lu,Ne,Ds,wu,Fi,ku,$u,Os,xu,Ve,As,Eu,qi,Mu,zu,Ns,jl,Ut,Ao,Di,Vs,ju,Oi,Fu,Fl,Rt,Ss,qu,ae,Ws,Du,Ht,Ou,Ai,Au,Nu,Ni,Vu,Su,Wu,No,Bu,Vi,Uu,Ru,Bs,ql,Kt,Vo,Si,Us,Hu,Wi,Ku,Dl,Gt,Rs,Gu,re,Hs,Ju,Jt,Xu,Bi,Zu,Qu,Ui,Yu,eg,tg,So,og,Ri,ng,sg,Ks,Ol;return y=new D({}),Ce=new D({}),$e=new D({}),en=new A({props:{code:`from PIL import Image
import requests
...
<span class="hljs-meta">&gt;&gt;&gt; </span>outputs = model(**inputs)
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_state = outputs.last_hidden_state
<span class="hljs-meta">&gt;&gt;&gt; </span>pooler_output = outputs.pooler_output  <span class="hljs-comment"># pooled CLS states</span>`}}),{c(){p=n("meta"),L=l(),I=n("h1"),C=n("a"),b=n("span"),u(y.$$.fragment),f=l(),w=n("span"),Ho=r("CLIP"),rt=l(),z=n("h2"),ue=n("a"),ye=n("span"),u(Ce.$$.fragment),Ko=l(),be=n("span"),Go=r("Overview"),Xt=l(),pe=n("p"),ze=r("The CLIP model was proposed in "),Le=n("a"),Zt=r("Learning Transferable Visual Models From Natural Language Supervision"),H=r(` by Alec Radford, Jong Wook Kim, Chris Hallacy, Aditya Ramesh, Gabriel Goh,
...
model weights at this https URL.`),Yt=l(),O=n("h2"),ge=n("a"),ke=n("span"),u($e.$$.fragment),Xo=l(),xe=n("span"),Zo=r("Usage"),eo=l(),he=n("p"),Qo=r(`CLIP is a multi-modal vision and language model. It can be used for image-text similarity and for zero-shot image
...
adding special tokens. A CLIP sequence has the following format:`),Gc=l(),Cr=n("ul"),Ta=n("li"),Jc=r("single sequence: "),br=n("code"),Xc=r("<|startoftext|> X <|endoftext|>"),Zc=l(),Lr=n("p"),Qc=r("Pairs of sequences are not the expected use case, but they will be handled without a separator."),Yc=l(),lo=n("div"),u(Tn.$$.fragment),ep=l(),In=n("p"),tp=r(`Retrieve sequence ids from a token list that has no special tokens added. This method is called when adding
special tokens using the tokenizer `),wr=n("code"),op=r("prepare_for_model"),np=r(" method."),sp=l(),co=n("div"),u(yn.$$.fragment),ap=l(),kr=n("p"),rp=r(`Create a mask from the two sequences passed. CLIP does not make use of token type ids, therefore a list of
zeros is returned.`),ip=l(),Ia=n("div"),u(Cn.$$.fragment),hl=l(),vt=n("h2"),po=n("a"),$r=n("span"),u(bn.$$.fragment),lp=l(),xr=n("span"),dp=r("CLIPTokenizerFast"),fl=l(),W=n("div"),u(Ln.$$.fragment),cp=l(),wn=n("p"),pp=r("Construct a \u201Cfast\u201D CLIP tokenizer (backed by HuggingFace\u2019s "),Er=n("em"),mp=r("tokenizers"),hp=r(` library). Based on byte-level
Byte-Pair-Encoding.`),fp=l(),kn=n("p"),up=r("This tokenizer inherits from "),ya=n("a"),gp=r("PreTrainedTokenizerFast"),_p=r(` which contains most of the main methods. Users should
refer to this superclass for more information regarding those methods.`),vp=l(),Ie=n("div"),u($n.$$.fragment),Pp=l(),Mr=n("p"),Tp=r(`Build model inputs from a sequence or a pair of sequence for sequence classification tasks by concatenating and
adding special tokens. A CLIP sequence has the following format:`),Ip=l(),zr=n("ul"),Ca=n("li"),yp=r("single sequence: "),jr=n("code"),Cp=r("<|startoftext|> X <|endoftext|>"),bp=l(),Fr=n("p"),Lp=r("Pairs of sequences are not the expected use case, but they will be handled without a separator."),wp=l(),mo=n("div"),u(xn.$$.fragment),kp=l(),qr=n("p"),$p=r(`Create a mask from the two sequences passed. CLIP does not make use of token type ids, therefore a list of
...
size is given, it will be padded (so the returned result has the size asked).`),Wp=l(),uo=n("div"),u(qn.$$.fragment),Bp=l(),Tt=n("p"),Up=r("Resizes "),Vr=n("code"),Rp=r("image"),Hp=r(". Note that this will trigger a conversion of "),Sr=n("code"),Kp=r("image"),Gp=r(" to a PIL Image."),_l=l(),It=n("h2"),go=n("a"),Wr=n("span"),u(Dn.$$.fragment),Jp=l(),Br=n("span"),Xp=r("CLIPProcessor"),vl=l(),U=n("div"),u(On.$$.fragment),Zp=l(),Ur=n("p"),Qp=r("Constructs a CLIP processor which wraps a CLIP feature extractor and a CLIP tokenizer into a single processor."),Yp=l(),K=n("p"),La=n("a"),em=r("CLIPProcessor"),tm=r(" offers all the functionalities of "),wa=n("a"),om=r("CLIPFeatureExtractor"),nm=r(" and "),ka=n("a"),sm=r("CLIPTokenizerFast"),am=r(`. See the
`),Rr=n("code"),rm=r("__call__()"),im=r("and "),$a=n("a"),lm=r("decode()"),dm=r(" for more information."),cm=l(),_o=n("div"),u(An.$$.fragment),pm=l(),Nn=n("p"),mm=r("This method forwards all its arguments to CLIPTokenizerFast\u2019s "),xa=n("a"),hm=r("batch_decode()"),fm=r(`. Please
...
the docstring of this method for more information.`),Pl=l(),yt=n("h2"),Po=n("a"),Hr=n("span"),u(Wn.$$.fragment),Tm=l(),Kr=n("span"),Im=r("CLIPModel"),Tl=l(),R=n("div"),u(Bn.$$.fragment),ym=l(),Un=n("p"),Cm=r("This model is a PyTorch "),Rn=n("a"),bm=r("torch.nn.Module"),Lm=r(` subclass. Use it
as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),wm=l(),G=n("div"),u(Hn.$$.fragment),km=l(),Ct=n("p"),$m=r("The "),Ma=n("a"),xm=r("CLIPModel"),Em=r(" forward method, overrides the "),Gr=n("code"),Mm=r("__call__"),zm=r(" special method."),jm=l(),u(To.$$.fragment),Fm=l(),Jr=n("p"),qm=r("Examples:"),Dm=l(),u(Kn.$$.fragment),Om=l(),J=n("div"),u(Gn.$$.fragment),Am=l(),bt=n("p"),Nm=r("The "),za=n("a"),Vm=r("CLIPModel"),Sm=r(" forward method, overrides the "),Xr=n("code"),Wm=r("__call__"),Bm=r(" special method."),Um=l(),u(Io.$$.fragment),Rm=l(),Zr=n("p"),Hm=r("Examples:"),Km=l(),u(Jn.$$.fragment),Gm=l(),X=n("div"),u(Xn.$$.fragment),Jm=l(),Lt=n("p"),Xm=r("The "),ja=n("a"),Zm=r("CLIPModel"),Qm=r(" forward method, overrides the "),Qr=n("code"),Ym=r("__call__"),eh=r(" special method."),th=l(),u(yo.$$.fragment),oh=l(),Yr=n("p"),nh=r("Examples:"),sh=l(),u(Zn.$$.fragment),Il=l(),wt=n("h2"),Co=n("a"),ei=n("span"),u(Qn.$$.fragment),ah=l(),ti=n("span"),rh=r("CLIPTextModel"),yl=l(),kt=n("div"),u(Yn.$$.fragment),ih=l(),Z=n("div"),u(es.$$.fragment),lh=l(),$t=n("p"),dh=r("The "),Fa=n("a"),ch=r("CLIPTextModel"),ph=r(" forward method, overrides the "),oi=n("code"),mh=r("__call__"),hh=r(" special method."),fh=l(),u(bo.$$.fragment),uh=l(),ni=n("p"),gh=r("Examples:"),_h=l(),u(ts.$$.fragment),Cl=l(),xt=n("h2"),Lo=n("a"),si=n("span"),u(os.$$.fragment),vh=l(),ai=n("span"),Ph=r("CLIPVisionModel"),bl=l(),Et=n("div"),u(ns.$$.fragment),Th=l(),Q=n("div"),u(ss.$$.fragment),Ih=l(),Mt=n("p"),yh=r("The "),qa=n("a"),Ch=r("CLIPVisionModel"),bh=r(" forward method, overrides the "),ri=n("code"),Lh=r("__call__"),wh=r(" special method."),kh=l(),u(wo.$$.fragment),$h=l(),ii=n("p"),xh=r("Examples:"),Eh=l(),u(as.$$.fragment),Ll=l(),zt=n("h2"),ko=n("a"),li=n("span"),u(rs.$$.fragment),Mh=l(),di=n("span"),zh=r("TFCLIPModel"),wl=l(),q=n("div"),u(is.$$.fragment),jh=l(),ls=n("p"),Fh=r("This model inherits from "),Da=n("a"),qh=r("TFPreTrainedModel"),Dh=r(`. Check the superclass documentation for the generic methods the
...
behavior.`),Sh=l(),u($o.$$.fragment),Wh=l(),Y=n("div"),u(ps.$$.fragment),Bh=l(),jt=n("p"),Uh=r("The "),Oa=n("a"),Rh=r("TFCLIPModel"),Hh=r(" forward method, overrides the "),ci=n("code"),Kh=r("__call__"),Gh=r(" special method."),Jh=l(),u(xo.$$.fragment),Xh=l(),pi=n("p"),Zh=r("Examples:"),Qh=l(),u(ms.$$.fragment),Yh=l(),ee=n("div"),u(hs.$$.fragment),ef=l(),Ft=n("p"),tf=r("The "),Aa=n("a"),of=r("TFCLIPModel"),nf=r(" forward method, overrides the "),mi=n("code"),sf=r("__call__"),af=r(" special method."),rf=l(),u(Eo.$$.fragment),lf=l(),hi=n("p"),df=r("Examples:"),cf=l(),u(fs.$$.fragment),pf=l(),te=n("div"),u(us.$$.fragment),mf=l(),qt=n("p"),hf=r("The "),Na=n("a"),ff=r("TFCLIPModel"),uf=r(" forward method, overrides the "),fi=n("code"),gf=r("__call__"),_f=r(" special method."),vf=l(),u(Mo.$$.fragment),Pf=l(),ui=n("p"),Tf=r("Examples:"),If=l(),u(gs.$$.fragment),kl=l(),Dt=n("h2"),zo=n("a"),gi=n("span"),u(_s.$$.fragment),yf=l(),_i=n("span"),Cf=r("TFCLIPTextModel"),$l=l(),Ot=n("div"),u(vs.$$.fragment),bf=l(),oe=n("div"),u(Ps.$$.fragment),Lf=l(),At=n("p"),wf=r("The "),Va=n("a"),kf=r("TFCLIPTextModel"),$f=r(" forward method, overrides the "),vi=n("code"),xf=r("__call__"),Ef=r(" special method."),Mf=l(),u(jo.$$.fragment),zf=l(),Pi=n("p"),jf=r("Examples:"),Ff=l(),u(Ts.$$.fragment),xl=l(),Nt=n("h2"),Fo=n("a"),Ti=n("span"),u(Is.$$.fragment),qf=l(),Ii=n("span"),Df=r("TFCLIPVisionModel"),El=l(),Vt=n("div"),u(ys.$$.fragment),Of=l(),ne=n("div"),u(Cs.$$.fragment),Af=l(),St=n("p"),Nf=r("The "),Sa=n("a"),Vf=r("TFCLIPVisionModel"),Sf=r(" forward method, overrides the "),yi=n("code"),Wf=r("__call__"),Bf=r(" special method."),Uf=l(),u(qo.$$.fragment),Rf=l(),Ci=n("p"),Hf=r("Examples:"),Kf=l(),u(bs.$$.fragment),Ml=l(),Wt=n("h2"),Do=n("a"),bi=n("span"),u(Ls.$$.fragment),Gf=l(),Li=n("span"),Jf=r("FlaxCLIPModel"),zl=l(),M=n("div"),u(ws.$$.fragment),Xf=l(),ks=n("p"),Zf=r("This model inherits from "),Wa=n("a"),Qf=r("FlaxPreTrainedModel"),Yf=r(`. Check the superclass documentation for the generic methods the
...
general usage and behavior.`),su=l(),wi=n("p"),au=r("Finally, this model supports inherent JAX features such as:"),ru=l(),Ee=n("ul"),ki=n("li"),Es=n("a"),iu=r("Just-In-Time (JIT) compilation"),lu=l(),$i=n("li"),Ms=n("a"),du=r("Automatic Differentiation"),cu=l(),xi=n("li"),zs=n("a"),pu=r("Vectorization"),mu=l(),Ei=n("li"),js=n("a"),hu=r("Parallelization"),fu=l(),se=n("div"),u(Fs.$$.fragment),uu=l(),Bt=n("p"),gu=r("The "),Mi=n("code"),_u=r("FlaxCLIPPreTrainedModel"),vu=r("forward method, overrides the "),zi=n("code"),Pu=r("__call__"),Tu=r(" special method."),Iu=l(),u(Oo.$$.fragment),yu=l(),ji=n("p"),Cu=r("Example:"),bu=l(),u(qs.$$.fragment),Lu=l(),Ne=n("div"),u(Ds.$$.fragment),wu=l(),Fi=n("p"),ku=r("Examples:"),$u=l(),u(Os.$$.fragment),xu=l(),Ve=n("div"),u(As.$$.fragment),Eu=l(),qi=n("p"),Mu=r("Examples:"),zu=l(),u(Ns.$$.fragment),jl=l(),Ut=n("h2"),Ao=n("a"),Di=n("span"),u(Vs.$$.fragment),ju=l(),Oi=n("span"),Fu=r("FlaxCLIPTextModel"),Fl=l(),Rt=n("div"),u(Ss.$$.fragment),qu=l(),ae=n("div"),u(Ws.$$.fragment),Du=l(),Ht=n("p"),Ou=r("The "),Ai=n("code"),Au=r("FlaxCLIPTextPreTrainedModel"),Nu=r("forward method, overrides the "),Ni=n("code"),Vu=r("__call__"),Su=r(" special method."),Wu=l(),u(No.$$.fragment),Bu=l(),Vi=n("p"),Uu=r("Example:"),Ru=l(),u(Bs.$$.fragment),ql=l(),Kt=n("h2"),Vo=n("a"),Si=n("span"),u(Us.$$.fragment),Hu=l(),Wi=n("span"),Ku=r("FlaxCLIPVisionModel"),Dl=l(),Gt=n("div"),u(Rs.$$.fragment),Gu=l(),re=n("div"),u(Hs.$$.fragment),Ju=l(),Jt=n("p"),Xu=r("The "),Bi=n("code"),Zu=r("FlaxCLIPVisionPreTrainedModel"),Qu=r("forward method, overrides the "),Ui=n("code"),Yu=r("__call__"),eg=r(" special method."),tg=l(),u(So.$$.fragment),og=l(),Ri=n("p"),ng=r("Example:"),sg=l(),u(Ks.$$.fragment),this.h()},l(t){const m=lP('[data-svelte="svelte-1phssyn"]',document.head);p=s(m,"META",{name:!0,content:!0}),m.forEach(o),L=d(t),I=s(t,"H1",{class:!0});var Gs=a(I);C=s(Gs,"A",{id:!0,class:!0,href:!0});var Hi=a(C);b=s(Hi,"SPAN",{});var Ki=a(b);g(y.$$.fragment,Ki),Ki.forEach(o),Hi.forEach(o),f=d(Gs),w=s(Gs,"SPAN",{});var Gi=a(w);Ho=i(Gi,"CLIP"),Gi.forEach(o),Gs.forEach(o),rt=d(t),z=s(t,"H2",{class:!0});var Js=a(z);ue=s(Js,"A",{id:!0,class:!0,href:!0});var Ji=a(ue);ye=s(Ji,"SPAN",{});var Xi=a(ye);g(Ce.$$.fragment,Xi),Xi.forEach(o),Ji.forEach(o),Ko=d(Js),be=s(Js,"SPAN",{});var Zi=a(be);Go=i(Zi,"Overview"),Zi.forEach(o),Js.forEach(o),Xt=d(t),pe=s(t,"P",{});var Xs=a(pe);ze=i(Xs,"The CLIP model was proposed in "),Le=s(Xs,"A",{href:!0,rel:!0});var Qi=a(Le);Zt=i(Qi,"Learning Transferable Visual Models From Natural Language Supervision"),Qi.forEach(o),H=i(Xs,` by Alec Radford, Jong Wook Kim, Chris Hallacy, Aditya Ramesh, Gabriel Goh,
Sandhini Agarwal, Girish Sastry, Amanda Askell, Pamela Mishkin, Jack Clark, Gretchen Krueger, Ilya Sutskever. CLIP
(Contrastive Language-Image Pre-Training) is a neural network trained on a variety of (image, text) pairs. It can be
instructed in natural language to predict the most relevant text snippet, given an image, without directly optimizing
...
for any dataset specific training. For instance, we match the accuracy of the original ResNet-50 on ImageNet zero-shot
without needing to use any of the 1.28 million training examples it was trained on. We release our code and pre-trained
model weights at this https URL.`),tl.forEach(o),el.forEach(o),Yt=d(t),O=s(t,"H2",{class:!0});var Zs=a(O);ge=s(Zs,"A",{id:!0,class:!0,href:!0});var ig=a(ge);ke=s(ig,"SPAN",{});var lg=a(ke);g($e.$$.fragment,lg),lg.forEach(o),ig.forEach(o),Xo=d(Zs),xe=s(Zs,"SPAN",{});var dg=a(xe);Zo=i(dg,"Usage"),dg.forEach(o),Zs.forEach(o),eo=d(t),he=s(t,"P",{});var cg=a(he);Qo=i(cg,`CLIP is a multi-modal vision and language model. It can be used for image-text similarity and for zero-shot image
classification. CLIP uses a ViT like transformer to get visual features and a causal language model to get the text
features. Both the text and visual features are then projected to a latent space with identical dimension. The dot
...
documentation from `),pa=s(Ua,"A",{href:!0});var wg=a(pa);Xd=i(wg,"PretrainedConfig"),wg.forEach(o),Zd=i(Ua," for more information."),Ua.forEach(o),Qd=d(Wo),so=s(Wo,"DIV",{class:!0});var Vl=a(so);g(an.$$.fragment,Vl),Yd=d(Vl),rn=s(Vl,"P",{});var Sl=a(rn);ec=i(Sl,"Instantiate a "),ma=s(Sl,"A",{href:!0});var kg=a(ma);tc=i(kg,"CLIPConfig"),kg.forEach(o),oc=i(Sl,` (or a derived class) from clip text model configuration and clip vision model
configuration.`),Sl.forEach(o),Vl.forEach(o),Wo.forEach(o),il=d(t),pt=s(t,"H2",{class:!0});var Wl=a(pt);ao=s(Wl,"A",{id:!0,class:!0,href:!0});var $g=a(ao);hr=s($g,"SPAN",{});var xg=a(hr);g(ln.$$.fragment,xg),xg.forEach(o),$g.forEach(o),nc=d(Wl),fr=s(Wl,"SPAN",{});var Eg=a(fr);sc=i(Eg,"CLIPTextConfig"),Eg.forEach(o),Wl.forEach(o),ll=d(t),V=s(t,"DIV",{class:!0});var Se=a(V);g(dn.$$.fragment,Se),ac=d(Se),mt=s(Se,"P",{});var Ra=a(mt);rc=i(Ra,"This is the configuration class to store the configuration of a "),ha=s(Ra,"A",{href:!0});var Mg=a(ha);ic=i(Mg,"CLIPModel"),Mg.forEach(o),lc=i(Ra,`. It is used to instantiate an CLIP
model according to the specified arguments, defining the model architecture. Instantiating a configuration with the
defaults will yield a similar configuration to that of the CLIP
...
adding special tokens. A CLIP sequence has the following format:`),Jg.forEach(o),Gc=d(Bo),Cr=s(Bo,"UL",{});var Xg=a(Cr);Ta=s(Xg,"LI",{});var ag=a(Ta);Jc=i(ag,"single sequence: "),br=s(ag,"CODE",{});var Zg=a(br);Xc=i(Zg,"<|startoftext|> X <|endoftext|>"),Zg.forEach(o),ag.forEach(o),Xg.forEach(o),Zc=d(Bo),Lr=s(Bo,"P",{});var Qg=a(Lr);Qc=i(Qg,"Pairs of sequences are not the expected use case, but they will be handled without a separator."),Qg.forEach(o),Bo.forEach(o),Yc=d(le),lo=s(le,"DIV",{class:!0});var Hl=a(lo);g(Tn.$$.fragment,Hl),ep=d(Hl),In=s(Hl,"P",{});var Kl=a(In);tp=i(Kl,`Retrieve sequence ids from a token list that has no special tokens added. This method is called when adding
special tokens using the tokenizer `),wr=s(Kl,"CODE",{});var Yg=a(wr);op=i(Yg,"prepare_for_model"),Yg.forEach(o),np=i(Kl," method."),Kl.forEach(o),Hl.forEach(o),sp=d(le),co=s(le,"DIV",{class:!0});var Gl=a(co);g(yn.$$.fragment,Gl),ap=d(Gl),kr=s(Gl,"P",{});var e_=a(kr);rp=i(e_,`Create a mask from the two sequences passed. CLIP does not make use of token type ids, therefore a list of
zeros is returned.`),e_.forEach(o),Gl.forEach(o),ip=d(le),Ia=s(le,"DIV",{class:!0});var t_=a(Ia);g(Cn.$$.fragment,t_),t_.forEach(o),le.forEach(o),hl=d(t),vt=s(t,"H2",{class:!0});var Jl=a(vt);po=s(Jl,"A",{id:!0,class:!0,href:!0});var o_=a(po);$r=s(o_,"SPAN",{});var n_=a($r);g(bn.$$.fragment,n_),n_.forEach(o),o_.forEach(o),lp=d(Jl),xr=s(Jl,"SPAN",{});var s_=a(xr);dp=i(s_,"CLIPTokenizerFast"),s_.forEach(o),Jl.forEach(o),fl=d(t),W=s(t,"DIV",{class:!0});var Be=a(W);g(Ln.$$.fragment,Be),cp=d(Be),wn=s(Be,"P",{});var Xl=a(wn);pp=i(Xl,"Construct a \u201Cfast\u201D CLIP tokenizer (backed by HuggingFace\u2019s "),Er=s(Xl,"EM",{});var a_=a(Er);mp=i(a_,"tokenizers"),a_.forEach(o),hp=i(Xl,` library). Based on byte-level
Byte-Pair-Encoding.`),Xl.forEach(o),fp=d(Be),kn=s(Be,"P",{});var Zl=a(kn);up=i(Zl,"This tokenizer inherits from "),ya=s(Zl,"A",{href:!0});var r_=a(ya);gp=i(r_,"PreTrainedTokenizerFast"),r_.forEach(o),_p=i(Zl,` which contains most of the main methods. Users should
refer to this superclass for more information regarding those methods.`),Zl.forEach(o),vp=d(Be),Ie=s(Be,"DIV",{class:!0});var Uo=a(Ie);g($n.$$.fragment,Uo),Pp=d(Uo),Mr=s(Uo,"P",{});var i_=a(Mr);Tp=i(i_,`Build model inputs from a sequence or a pair of sequence for sequence classification tasks by concatenating and
adding special tokens. A CLIP sequence has the following format:`),i_.forEach(o),Ip=d(Uo),zr=s(Uo,"UL",{});var l_=a(zr);Ca=s(l_,"LI",{});var rg=a(Ca);yp=i(rg,"single sequence: "),jr=s(rg,"CODE",{});var d_=a(jr);Cp=i(d_,"<|startoftext|> X <|endoftext|>"),d_.forEach(o),rg.forEach(o),l_.forEach(o),bp=d(Uo),Fr=s(Uo,"P",{});var c_=a(Fr);Lp=i(c_,"Pairs of sequences are not the expected use case, but they will be handled without a separator."),c_.forEach(o),Uo.forEach(o),wp=d(Be),mo=s(Be,"DIV",{class:!0});var Ql=a(mo);g(xn.$$.fragment,Ql),kp=d(Ql),qr=s(Ql,"P",{});var p_=a(qr);$p=i(p_,`Create a mask from the two sequences passed. CLIP does not make use of token type ids, therefore a list of
