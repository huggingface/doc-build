...
Beyonc\xE9 PER
Los Angeles LOC`}}),{c(){h=a("p"),y=o("Examples:"),g=c(),b(f.$$.fragment)},l(l){h=i(l,"P",{});var u=r(h);y=s(u,"Examples:"),u.forEach(t),g=p(l),v(f.$$.fragment,l)},m(l,u){_(l,h,u),e(h,y),_(l,g,u),T(f,l,u),k=!0},p:Qo,i(l){k||(w(f.$$.fragment,l),k=!0)},o(l){L(f.$$.fragment,l),k=!1},d(l){l&&t(h),l&&t(g),E(f,l)}}}function sp(z){let h,y,g,f,k,l,u,$,Ws,Go,se,we,Wn,Xe,Us,Un,Ks,Jo,Le,Rs,Ze,Hs,Vs,Xo,Xt,Ys,Zo,Zt,Kn,Qs,es,en,Gs,ts,B,Rn,et,Js,tn,Xs,Zs,ea,Hn,F,ta,Vn,na,oa,Yn,sa,aa,Qn,ia,ra,Gn,la,da,nn,ca,pa,ha,tt,W,on,ua,ma,Jn,fa,ga,Xn,_a,ka,Zn,ya,ba,va,nt,sn,eo,Ta,wa,La,an,to,Ea,za,$a,N,no,xa,qa,ae,Ee,rn,Fa,Ca,ot,Ma,Pa,ja,ze,ln,Aa,Ia,st,Oa,Sa,Na,dn,cn,Da,Ba,Wa,O,pn,Ua,Ka,oo,Ra,Ha,so,Va,Ya,ao,Qa,Ga,io,Ja,Xa,Za,ie,ei,hn,ti,ni,at,oi,si,ai,it,ii,rt,ri,li,ns,un,di,os,lt,ss,U,ci,dt,pi,hi,ct,ui,mi,pt,fi,gi,as,re,$e,ro,ht,_i,lo,ki,is,D,ut,yi,le,bi,mn,vi,Ti,mt,wi,Li,Ei,de,zi,fn,$i,xi,gn,qi,Fi,Ci,xe,rs,ce,qe,co,ft,Mi,po,Pi,ls,C,gt,ji,ho,Ai,Ii,x,Oi,_n,Si,Ni,kn,Di,Bi,yn,Wi,Ui,uo,Ki,Ri,mo,Hi,Vi,fo,Yi,Qi,go,Gi,Ji,Xi,Fe,_t,Zi,_o,er,tr,bn,kt,ds,pe,Ce,ko,yt,nr,yo,or,cs,M,bt,sr,bo,ar,ir,vt,rr,vn,lr,dr,cr,Tt,pr,wt,hr,ur,mr,K,Lt,fr,he,gr,Tn,_r,kr,vo,yr,br,vr,Me,Tr,Pe,ps,ue,je,To,Et,wr,wo,Lr,hs,P,zt,Er,Lo,zr,$r,$t,xr,wn,qr,Fr,Cr,xt,Mr,qt,Pr,jr,Ar,G,Ft,Ir,me,Or,Ln,Sr,Nr,Eo,Dr,Br,Wr,Ae,us,fe,Ie,zo,Ct,Ur,$o,Kr,ms,j,Mt,Rr,xo,Hr,Vr,Pt,Yr,En,Qr,Gr,Jr,jt,Xr,At,Zr,el,tl,R,It,nl,ge,ol,zn,sl,al,qo,il,rl,ll,Oe,dl,Se,fs,_e,Ne,Fo,Ot,cl,Co,pl,gs,A,St,hl,Mo,ul,ml,Nt,fl,$n,gl,_l,kl,Dt,yl,Bt,bl,vl,Tl,H,Wt,wl,ke,Ll,xn,El,zl,Po,$l,xl,ql,De,Fl,Be,_s,ye,We,jo,Ut,Cl,Ao,Ml,ks,I,Kt,Pl,Io,jl,Al,Rt,Il,qn,Ol,Sl,Nl,Ht,Dl,Vt,Bl,Wl,Ul,V,Yt,Kl,be,Rl,Fn,Hl,Vl,Oo,Yl,Ql,Gl,Ue,Jl,Ke,ys;return l=new Te({}),Xe=new Te({}),lt=new Bn({props:{code:`from transformers import LukeTokenizer, LukeModel, LukeForEntityPairClassification
...
model. Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/main/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/luke/modeling_luke.py#L1134"}}),Ft=new S({props:{name:"forward",anchor:"transformers.LukeForMaskedLM.forward",parameters:[{name:"input_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"attention_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"token_type_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"position_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"entity_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"entity_attention_mask",val:": typing.Optional[torch.LongTensor] = None"},{name:"entity_token_type_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"entity_position_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"labels",val:": typing.Optional[torch.LongTensor] = None"},{name:"entity_labels",val:": typing.Optional[torch.LongTensor] = None"},{name:"head_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.LukeForMaskedLM.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/main/en/model_doc/luke#transformers.LukeTokenizer">LukeTokenizer</a>. See <a href="/docs/transformers/main/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/main/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
model. Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/main/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/luke/modeling_luke.py#L1387"}}),Wt=new S({props:{name:"forward",anchor:"transformers.LukeForEntityPairClassification.forward",parameters:[{name:"input_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"attention_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"token_type_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"position_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"entity_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"entity_attention_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"entity_token_type_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"entity_position_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"head_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"labels",val:": typing.Optional[torch.LongTensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.LukeForEntityPairClassification.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/main/en/model_doc/luke#transformers.LukeTokenizer">LukeTokenizer</a>. See <a href="/docs/transformers/main/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/main/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
documentation from `),gn=a("a"),qi=o("PretrainedConfig"),Fi=o(" for more information."),Ci=c(),b(xe.$$.fragment),rs=c(),ce=a("h2"),qe=a("a"),co=a("span"),b(ft.$$.fragment),Mi=c(),po=a("span"),Pi=o("LukeTokenizer"),ls=c(),C=a("div"),b(gt.$$.fragment),ji=c(),ho=a("p"),Ai=o("Construct a LUKE tokenizer."),Ii=c(),x=a("p"),Oi=o("This tokenizer inherits from "),_n=a("a"),Si=o("RobertaTokenizer"),Ni=o(` which contains most of the main methods. Users should refer to
this superclass for more information regarding those methods. Compared to `),kn=a("a"),Di=o("RobertaTokenizer"),Bi=o(", "),yn=a("a"),Wi=o("LukeTokenizer"),Ui=o(`
also creates entity sequences, namely `),uo=a("code"),Ki=o("entity_ids"),Ri=o(", "),mo=a("code"),Hi=o("entity_attention_mask"),Vi=o(", "),fo=a("code"),Yi=o("entity_token_type_ids"),Qi=o(`, and
`),go=a("code"),Gi=o("entity_position_ids"),Ji=o(" to be used by the LUKE model."),Xi=c(),Fe=a("div"),b(_t.$$.fragment),Zi=c(),_o=a("p"),er=o(`Main method to tokenize and prepare for the model one or several sequence(s) or one or several pair(s) of
sequences, depending on the task you want to prepare them for.`),tr=c(),bn=a("div"),b(kt.$$.fragment),ds=c(),pe=a("h2"),Ce=a("a"),ko=a("span"),b(yt.$$.fragment),nr=c(),yo=a("span"),or=o("LukeModel"),cs=c(),M=a("div"),b(bt.$$.fragment),sr=c(),bo=a("p"),ar=o("The bare LUKE model transformer outputting raw hidden-states for both word tokens and entities without any specific head on top."),ir=c(),vt=a("p"),rr=o("This model inherits from "),vn=a("a"),lr=o("PreTrainedModel"),dr=o(`. Check the superclass documentation for the generic methods the
...
masked entity prediction.`),$r=c(),$t=a("p"),xr=o("This model inherits from "),wn=a("a"),qr=o("PreTrainedModel"),Fr=o(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Cr=c(),xt=a("p"),Mr=o("This model is also a PyTorch "),qt=a("a"),Pr=o("torch.nn.Module"),jr=o(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Ar=c(),G=a("div"),b(Ft.$$.fragment),Ir=c(),me=a("p"),Or=o("The "),Ln=a("a"),Sr=o("LukeForMaskedLM"),Nr=o(" forward method, overrides the "),Eo=a("code"),Dr=o("__call__"),Br=o(" special method."),Wr=c(),b(Ae.$$.fragment),us=c(),fe=a("h2"),Ie=a("a"),zo=a("span"),b(Ct.$$.fragment),Ur=c(),$o=a("span"),Kr=o("LukeForEntityClassification"),ms=c(),j=a("div"),b(Mt.$$.fragment),Rr=c(),xo=a("p"),Hr=o(`The LUKE model with a classification head on top (a linear layer on top of the hidden state of the first entity
token) for entity classification tasks, such as Open Entity.`),Vr=c(),Pt=a("p"),Yr=o("This model inherits from "),En=a("a"),Qr=o("PreTrainedModel"),Gr=o(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Jr=c(),jt=a("p"),Xr=o("This model is also a PyTorch "),At=a("a"),Zr=o("torch.nn.Module"),el=o(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),tl=c(),R=a("div"),b(It.$$.fragment),nl=c(),ge=a("p"),ol=o("The "),zn=a("a"),sl=o("LukeForEntityClassification"),al=o(" forward method, overrides the "),qo=a("code"),il=o("__call__"),rl=o(" special method."),ll=c(),b(Oe.$$.fragment),dl=c(),b(Se.$$.fragment),fs=c(),_e=a("h2"),Ne=a("a"),Fo=a("span"),b(Ot.$$.fragment),cl=c(),Co=a("span"),pl=o("LukeForEntityPairClassification"),gs=c(),A=a("div"),b(St.$$.fragment),hl=c(),Mo=a("p"),ul=o(`The LUKE model with a classification head on top (a linear layer on top of the hidden states of the two entity
...
`),nn=i(Y,"A",{href:!0});var hd=r(nn);ca=s(hd,"LukeTokenizer"),hd.forEach(t),pa=s(Y,"."),Y.forEach(t),rd.forEach(t),ha=p(Re),tt=i(Re,"LI",{});var vs=r(tt);W=i(vs,"P",{});var ve=r(W);on=i(ve,"A",{href:!0});var ud=r(on);ua=s(ud,"LukeTokenizer"),ud.forEach(t),ma=s(ve," takes "),Jn=i(ve,"CODE",{});var md=r(Jn);fa=s(md,"entities"),md.forEach(t),ga=s(ve," and "),Xn=i(ve,"CODE",{});var fd=r(Xn);_a=s(fd,"entity_spans"),fd.forEach(t),ka=s(ve,` (character-based start and end
...
using Wikipedia entities as input tokens, LUKE outputs token representations enriched by the information stored in
the embeddings of these entities. This is particularly effective for tasks requiring real-world knowledge, such as
question answering.`),Zl.forEach(t),Ts.forEach(t),vs.forEach(t),$a=p(Re),N=i(Re,"LI",{});var J=r(N);no=i(J,"P",{});var yd=r(no);xa=s(yd,"There are three head models for the former use case:"),yd.forEach(t),qa=p(J),ae=i(J,"UL",{});var Cn=r(ae);Ee=i(Cn,"LI",{});var Ro=r(Ee);rn=i(Ro,"A",{href:!0});var bd=r(rn);Fa=s(bd,"LukeForEntityClassification"),bd.forEach(t),Ca=s(Ro,`, for tasks to classify a single entity in an input text such as
entity typing, e.g. the `),ot=i(Ro,"A",{href:!0,rel:!0});var vd=r(ot);Ma=s(vd,"Open Entity dataset"),vd.forEach(t),Pa=s(Ro,`.
This model places a linear head on top of the output entity representation.`),Ro.forEach(t),ja=p(Cn),ze=i(Cn,"LI",{});var Ho=r(ze);ln=i(Ho,"A",{href:!0});var Td=r(ln);Aa=s(Td,"LukeForEntityPairClassification"),Td.forEach(t),Ia=s(Ho,`, for tasks to classify the relationship between two entities
such as relation classification, e.g. the `),st=i(Ho,"A",{href:!0,rel:!0});var wd=r(st);Oa=s(wd,"TACRED dataset"),wd.forEach(t),Sa=s(Ho,`. This
model places a linear head on top of the concatenated output representation of the pair of given entities.`),Ho.forEach(t),Na=p(Cn),dn=i(Cn,"LI",{});var ed=r(dn);cn=i(ed,"A",{href:!0});var Ld=r(cn);Da=s(Ld,"LukeForEntitySpanClassification"),Ld.forEach(t),Ba=s(ed,`, for tasks to classify the sequence of entity spans, such as
named entity recognition (NER). This model places a linear head on top of the output entity representations. You
can address NER using this model by inputting all possible entity spans in the text to the model.`),ed.forEach(t),Cn.forEach(t),Wa=p(J),O=i(J,"P",{});var Q=r(O);pn=i(Q,"A",{href:!0});var Ed=r(pn);Ua=s(Ed,"LukeTokenizer"),Ed.forEach(t),Ka=s(Q," has a "),oo=i(Q,"CODE",{});var zd=r(oo);Ra=s(zd,"task"),zd.forEach(t),Ha=s(Q,` argument, which enables you to easily create an input to these
head models by specifying `),so=i(Q,"CODE",{});var $d=r(so);Va=s($d,'task="entity_classification"'),$d.forEach(t),Ya=s(Q,", "),ao=i(Q,"CODE",{});var xd=r(ao);Qa=s(xd,'task="entity_pair_classification"'),xd.forEach(t),Ga=s(Q,`, or
`),io=i(Q,"CODE",{});var qd=r(io);Ja=s(qd,'task="entity_span_classification"'),qd.forEach(t),Xa=s(Q,". Please refer to the example code of each head models."),Q.forEach(t),Za=p(J),ie=i(J,"P",{});var Mn=r(ie);ei=s(Mn,"A demo notebook on how to fine-tune "),hn=i(Mn,"A",{href:!0});var Fd=r(hn);ti=s(Fd,"LukeForEntityPairClassification"),Fd.forEach(t),ni=s(Mn,` for relation
classification can be found `),at=i(Mn,"A",{href:!0,rel:!0});var Cd=r(at);oi=s(Cd,"here"),Cd.forEach(t),si=s(Mn,"."),Mn.forEach(t),ai=p(J),it=i(J,"P",{});var ws=r(it);ii=s(ws,`There are also 3 notebooks available, which showcase how you can reproduce the results as reported in the paper with
the HuggingFace implementation of LUKE. They can be found `),rt=i(ws,"A",{href:!0,rel:!0});var Md=r(rt);ri=s(Md,"here"),Md.forEach(t),li=s(ws,"."),ws.forEach(t),J.forEach(t),Re.forEach(t),ns=p(n),un=i(n,"P",{});var Pd=r(un);di=s(Pd,"Example:"),Pd.forEach(t),os=p(n),v(lt.$$.fragment,n),ss=p(n),U=i(n,"P",{});var He=r(U);ci=s(He,"This model was contributed by "),dt=i(He,"A",{href:!0,rel:!0});var jd=r(dt);pi=s(jd,"ikuyamada"),jd.forEach(t),hi=s(He," and "),ct=i(He,"A",{href:!0,rel:!0});var Ad=r(ct);ui=s(Ad,"nielsr"),Ad.forEach(t),mi=s(He,". The original code can be found "),pt=i(He,"A",{href:!0,rel:!0});var Id=r(pt);fi=s(Id,"here"),Id.forEach(t),gi=s(He,"."),He.forEach(t),as=p(n),re=i(n,"H2",{class:!0});var Ls=r(re);$e=i(Ls,"A",{id:!0,class:!0,href:!0});var Od=r($e);ro=i(Od,"SPAN",{});var Sd=r(ro);v(ht.$$.fragment,Sd),Sd.forEach(t),Od.forEach(t),_i=p(Ls),lo=i(Ls,"SPAN",{});var Nd=r(lo);ki=s(Nd,"LukeConfig"),Nd.forEach(t),Ls.forEach(t),is=p(n),D=i(n,"DIV",{class:!0});var Ve=r(D);v(ut.$$.fragment,Ve),yi=p(Ve),le=i(Ve,"P",{});var Pn=r(le);bi=s(Pn,"This is the configuration class to store the configuration of a "),mn=i(Pn,"A",{href:!0});var Dd=r(mn);vi=s(Dd,"LukeModel"),Dd.forEach(t),Ti=s(Pn,`. It is used to instantiate a LUKE
model according to the specified arguments, defining the model architecture. Instantiating a configuration with the
defaults will yield a similar configuration to that of the LUKE
`),mt=i(Pn,"A",{href:!0,rel:!0});var Bd=r(mt);wi=s(Bd,"studio-ousia/luke-base"),Bd.forEach(t),Li=s(Pn," architecture."),Pn.forEach(t),Ei=p(Ve),de=i(Ve,"P",{});var jn=r(de);zi=s(jn,"Configuration objects inherit from "),fn=i(jn,"A",{href:!0});var Wd=r(fn);$i=s(Wd,"PretrainedConfig"),Wd.forEach(t),xi=s(jn,` and can be used to control the model outputs. Read the
documentation from `),gn=i(jn,"A",{href:!0});var Ud=r(gn);qi=s(Ud,"PretrainedConfig"),Ud.forEach(t),Fi=s(jn," for more information."),jn.forEach(t),Ci=p(Ve),v(xe.$$.fragment,Ve),Ve.forEach(t),rs=p(n),ce=i(n,"H2",{class:!0});var Es=r(ce);qe=i(Es,"A",{id:!0,class:!0,href:!0});var Kd=r(qe);co=i(Kd,"SPAN",{});var Rd=r(co);v(ft.$$.fragment,Rd),Rd.forEach(t),Kd.forEach(t),Mi=p(Es),po=i(Es,"SPAN",{});var Hd=r(po);Pi=s(Hd,"LukeTokenizer"),Hd.forEach(t),Es.forEach(t),ls=p(n),C=i(n,"DIV",{class:!0});var X=r(C);v(gt.$$.fragment,X),ji=p(X),ho=i(X,"P",{});var Vd=r(ho);Ai=s(Vd,"Construct a LUKE tokenizer."),Vd.forEach(t),Ii=p(X),x=i(X,"P",{});var q=r(x);Oi=s(q,"This tokenizer inherits from "),_n=i(q,"A",{href:!0});var Yd=r(_n);Si=s(Yd,"RobertaTokenizer"),Yd.forEach(t),Ni=s(q,` which contains most of the main methods. Users should refer to
this superclass for more information regarding those methods. Compared to `),kn=i(q,"A",{href:!0});var Qd=r(kn);Di=s(Qd,"RobertaTokenizer"),Qd.forEach(t),Bi=s(q,", "),yn=i(q,"A",{href:!0});var Gd=r(yn);Wi=s(Gd,"LukeTokenizer"),Gd.forEach(t),Ui=s(q,`
also creates entity sequences, namely `),uo=i(q,"CODE",{});var Jd=r(uo);Ki=s(Jd,"entity_ids"),Jd.forEach(t),Ri=s(q,", "),mo=i(q,"CODE",{});var Xd=r(mo);Hi=s(Xd,"entity_attention_mask"),Xd.forEach(t),Vi=s(q,", "),fo=i(q,"CODE",{});var Zd=r(fo);Yi=s(Zd,"entity_token_type_ids"),Zd.forEach(t),Qi=s(q,`, and
`),go=i(q,"CODE",{});var ec=r(go);Gi=s(ec,"entity_position_ids"),ec.forEach(t),Ji=s(q," to be used by the LUKE model."),q.forEach(t),Xi=p(X),Fe=i(X,"DIV",{class:!0});var zs=r(Fe);v(_t.$$.fragment,zs),Zi=p(zs),_o=i(zs,"P",{});var tc=r(_o);er=s(tc,`Main method to tokenize and prepare for the model one or several sequence(s) or one or several pair(s) of
sequences, depending on the task you want to prepare them for.`),tc.forEach(t),zs.forEach(t),tr=p(X),bn=i(X,"DIV",{class:!0});var nc=r(bn);v(kt.$$.fragment,nc),nc.forEach(t),X.forEach(t),ds=p(n),pe=i(n,"H2",{class:!0});var $s=r(pe);Ce=i($s,"A",{id:!0,class:!0,href:!0});var oc=r(Ce);ko=i(oc,"SPAN",{});var sc=r(ko);v(yt.$$.fragment,sc),sc.forEach(t),oc.forEach(t),nr=p($s),yo=i($s,"SPAN",{});var ac=r(yo);or=s(ac,"LukeModel"),ac.forEach(t),$s.forEach(t),cs=p(n),M=i(n,"DIV",{class:!0});var Z=r(M);v(bt.$$.fragment,Z),sr=p(Z),bo=i(Z,"P",{});var ic=r(bo);ar=s(ic,"The bare LUKE model transformer outputting raw hidden-states for both word tokens and entities without any specific head on top."),ic.forEach(t),ir=p(Z),vt=i(Z,"P",{});var xs=r(vt);rr=s(xs,"This model inherits from "),vn=i(xs,"A",{href:!0});var rc=r(vn);lr=s(rc,"PreTrainedModel"),rc.forEach(t),dr=s(xs,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),xs.forEach(t),cr=p(Z),Tt=i(Z,"P",{});var qs=r(Tt);pr=s(qs,"This model is also a PyTorch "),wt=i(qs,"A",{href:!0,rel:!0});var lc=r(wt);hr=s(lc,"torch.nn.Module"),lc.forEach(t),ur=s(qs,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),qs.forEach(t),mr=p(Z),K=i(Z,"DIV",{class:!0});var Ye=r(K);v(Lt.$$.fragment,Ye),fr=p(Ye),he=i(Ye,"P",{});var An=r(he);gr=s(An,"The "),Tn=i(An,"A",{href:!0});var dc=r(Tn);_r=s(dc,"LukeModel"),dc.forEach(t),kr=s(An," forward method, overrides the "),vo=i(An,"CODE",{});var cc=r(vo);yr=s(cc,"__call__"),cc.forEach(t),br=s(An," special method."),An.forEach(t),vr=p(Ye),v(Me.$$.fragment,Ye),Tr=p(Ye),v(Pe.$$.fragment,Ye),Ye.forEach(t),Z.forEach(t),ps=p(n),ue=i(n,"H2",{class:!0});var Fs=r(ue);je=i(Fs,"A",{id:!0,class:!0,href:!0});var pc=r(je);To=i(pc,"SPAN",{});var hc=r(To);v(Et.$$.fragment,hc),hc.forEach(t),pc.forEach(t),wr=p(Fs),wo=i(Fs,"SPAN",{});var uc=r(wo);Lr=s(uc,"LukeForMaskedLM"),uc.forEach(t),Fs.forEach(t),hs=p(n),P=i(n,"DIV",{class:!0});var ee=r(P);v(zt.$$.fragment,ee),Er=p(ee),Lo=i(ee,"P",{});var mc=r(Lo);zr=s(mc,`The LUKE model with a language modeling head and entity prediction head on top for masked language modeling and
masked entity prediction.`),mc.forEach(t),$r=p(ee),$t=i(ee,"P",{});var Cs=r($t);xr=s(Cs,"This model inherits from "),wn=i(Cs,"A",{href:!0});var fc=r(wn);qr=s(fc,"PreTrainedModel"),fc.forEach(t),Fr=s(Cs,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Cs.forEach(t),Cr=p(ee),xt=i(ee,"P",{});var Ms=r(xt);Mr=s(Ms,"This model is also a PyTorch "),qt=i(Ms,"A",{href:!0,rel:!0});var gc=r(qt);Pr=s(gc,"torch.nn.Module"),gc.forEach(t),jr=s(Ms,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Ms.forEach(t),Ar=p(ee),G=i(ee,"DIV",{class:!0});var In=r(G);v(Ft.$$.fragment,In),Ir=p(In),me=i(In,"P",{});var On=r(me);Or=s(On,"The "),Ln=i(On,"A",{href:!0});var _c=r(Ln);Sr=s(_c,"LukeForMaskedLM"),_c.forEach(t),Nr=s(On," forward method, overrides the "),Eo=i(On,"CODE",{});var kc=r(Eo);Dr=s(kc,"__call__"),kc.forEach(t),Br=s(On," special method."),On.forEach(t),Wr=p(In),v(Ae.$$.fragment,In),In.forEach(t),ee.forEach(t),us=p(n),fe=i(n,"H2",{class:!0});var Ps=r(fe);Ie=i(Ps,"A",{id:!0,class:!0,href:!0});var yc=r(Ie);zo=i(yc,"SPAN",{});var bc=r(zo);v(Ct.$$.fragment,bc),bc.forEach(t),yc.forEach(t),Ur=p(Ps),$o=i(Ps,"SPAN",{});var vc=r($o);Kr=s(vc,"LukeForEntityClassification"),vc.forEach(t),Ps.forEach(t),ms=p(n),j=i(n,"DIV",{class:!0});var te=r(j);v(Mt.$$.fragment,te),Rr=p(te),xo=i(te,"P",{});var Tc=r(xo);Hr=s(Tc,`The LUKE model with a classification head on top (a linear layer on top of the hidden state of the first entity
token) for entity classification tasks, such as Open Entity.`),Tc.forEach(t),Vr=p(te),Pt=i(te,"P",{});var js=r(Pt);Yr=s(js,"This model inherits from "),En=i(js,"A",{href:!0});var wc=r(En);Qr=s(wc,"PreTrainedModel"),wc.forEach(t),Gr=s(js,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),js.forEach(t),Jr=p(te),jt=i(te,"P",{});var As=r(jt);Xr=s(As,"This model is also a PyTorch "),At=i(As,"A",{href:!0,rel:!0});var Lc=r(At);Zr=s(Lc,"torch.nn.Module"),Lc.forEach(t),el=s(As,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),As.forEach(t),tl=p(te),R=i(te,"DIV",{class:!0});var Qe=r(R);v(It.$$.fragment,Qe),nl=p(Qe),ge=i(Qe,"P",{});var Sn=r(ge);ol=s(Sn,"The "),zn=i(Sn,"A",{href:!0});var Ec=r(zn);sl=s(Ec,"LukeForEntityClassification"),Ec.forEach(t),al=s(Sn," forward method, overrides the "),qo=i(Sn,"CODE",{});var zc=r(qo);il=s(zc,"__call__"),zc.forEach(t),rl=s(Sn," special method."),Sn.forEach(t),ll=p(Qe),v(Oe.$$.fragment,Qe),dl=p(Qe),v(Se.$$.fragment,Qe),Qe.forEach(t),te.forEach(t),fs=p(n),_e=i(n,"H2",{class:!0});var Is=r(_e);Ne=i(Is,"A",{id:!0,class:!0,href:!0});var $c=r(Ne);Fo=i($c,"SPAN",{});var xc=r(Fo);v(Ot.$$.fragment,xc),xc.forEach(t),$c.forEach(t),cl=p(Is),Co=i(Is,"SPAN",{});var qc=r(Co);pl=s(qc,"LukeForEntityPairClassification"),qc.forEach(t),Is.forEach(t),gs=p(n),A=i(n,"DIV",{class:!0});var ne=r(A);v(St.$$.fragment,ne),hl=p(ne),Mo=i(ne,"P",{});var Fc=r(Mo);ul=s(Fc,`The LUKE model with a classification head on top (a linear layer on top of the hidden states of the two entity
tokens) for entity pair classification tasks, such as TACRED.`),Fc.forEach(t),ml=p(ne),Nt=i(ne,"P",{});var Os=r(Nt);fl=s(Os,"This model inherits from "),$n=i(Os,"A",{href:!0});var Cc=r($n);gl=s(Cc,"PreTrainedModel"),Cc.forEach(t),_l=s(Os,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Os.forEach(t),kl=p(ne),Dt=i(ne,"P",{});var Ss=r(Dt);yl=s(Ss,"This model is also a PyTorch "),Bt=i(Ss,"A",{href:!0,rel:!0});var Mc=r(Bt);bl=s(Mc,"torch.nn.Module"),Mc.forEach(t),vl=s(Ss,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Ss.forEach(t),Tl=p(ne),H=i(ne,"DIV",{class:!0});var Ge=r(H);v(Wt.$$.fragment,Ge),wl=p(Ge),ke=i(Ge,"P",{});var Nn=r(ke);Ll=s(Nn,"The "),xn=i(Nn,"A",{href:!0});var Pc=r(xn);El=s(Pc,"LukeForEntityPairClassification"),Pc.forEach(t),zl=s(Nn," forward method, overrides the "),Po=i(Nn,"CODE",{});var jc=r(Po);$l=s(jc,"__call__"),jc.forEach(t),xl=s(Nn," special method."),Nn.forEach(t),ql=p(Ge),v(De.$$.fragment,Ge),Fl=p(Ge),v(Be.$$.fragment,Ge),Ge.forEach(t),ne.forEach(t),_s=p(n),ye=i(n,"H2",{class:!0});var Ns=r(ye);We=i(Ns,"A",{id:!0,class:!0,href:!0});var Ac=r(We);jo=i(Ac,"SPAN",{});var Ic=r(jo);v(Ut.$$.fragment,Ic),Ic.forEach(t),Ac.forEach(t),Cl=p(Ns),Ao=i(Ns,"SPAN",{});var Oc=r(Ao);Ml=s(Oc,"LukeForEntitySpanClassification"),Oc.forEach(t),Ns.forEach(t),ks=p(n),I=i(n,"DIV",{class:!0});var oe=r(I);v(Kt.$$.fragment,oe),Pl=p(oe),Io=i(oe,"P",{});var Sc=r(Io);jl=s(Sc,`The LUKE model with a span classification head on top (a linear layer on top of the hidden states output) for tasks
such as named entity recognition.`),Sc.forEach(t),Al=p(oe),Rt=i(oe,"P",{});var Ds=r(Rt);Il=s(Ds,"This model inherits from "),qn=i(Ds,"A",{href:!0});var Nc=r(qn);Ol=s(Nc,"PreTrainedModel"),Nc.forEach(t),Sl=s(Ds,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Ds.forEach(t),Nl=p(oe),Ht=i(oe,"P",{});var Bs=r(Ht);Dl=s(Bs,"This model is also a PyTorch "),Vt=i(Bs,"A",{href:!0,rel:!0});var Dc=r(Vt);Bl=s(Dc,"torch.nn.Module"),Dc.forEach(t),Wl=s(Bs,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Bs.forEach(t),Ul=p(oe),V=i(oe,"DIV",{class:!0});var Je=r(V);v(Yt.$$.fragment,Je),Kl=p(Je),be=i(Je,"P",{});var Dn=r(be);Rl=s(Dn,"The "),Fn=i(Dn,"A",{href:!0});var Bc=r(Fn);Hl=s(Bc,"LukeForEntitySpanClassification"),Bc.forEach(t),Vl=s(Dn," forward method, overrides the "),Oo=i(Dn,"CODE",{});var Wc=r(Oo);Yl=s(Wc,"__call__"),Wc.forEach(t),Ql=s(Dn," special method."),Dn.forEach(t),Gl=p(Je),v(Ue.$$.fragment,Je),Jl=p(Je),v(Ke.$$.fragment,Je),Je.forEach(t),oe.forEach(t),this.h()},h(){d(h,"name","hf:doc:metadata"),d(h,"content",JSON.stringify(ap)),d(f,"id","luke"),d(f,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),d(f,"href","#luke"),d(g,"class","relative group"),d(we,"id","overview"),d(we,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),d(we,"href","#overview"),d(se,"class","relative group"),d(Ze,"href","https://arxiv.org/abs/2010.01057"),d(Ze,"rel","nofollow"),d(tn,"href","/docs/transformers/main/en/model_doc/roberta#transformers.RobertaModel"),d(nn,"href","/docs/transformers/main/en/model_doc/luke#transformers.LukeTokenizer"),d(on,"href","/docs/transformers/main/en/model_doc/luke#transformers.LukeTokenizer"),d(rn,"href","/docs/transformers/main/en/model_doc/luke#transformers.LukeForEntityClassification"),d(ot,"href","https://www.cs.utexas.edu/~eunsol/html_pages/open_entity.html"),d(ot,"rel","nofollow"),d(ln,"href","/docs/transformers/main/en/model_doc/luke#transformers.LukeForEntityPairClassification"),d(st,"href","https://nlp.stanford.edu/projects/tacred/"),d(st,"rel","nofollow"),d(cn,"href","/docs/transformers/main/en/model_doc/luke#transformers.LukeForEntitySpanClassification"),d(pn,"href","/docs/transformers/main/en/model_doc/luke#transformers.LukeTokenizer"),d(hn,"href","/docs/transformers/main/en/model_doc/luke#transformers.LukeForEntityPairClassification"),d(at,"href","https://github.com/NielsRogge/Transformers-Tutorials/tree/master/LUKE"),d(at,"rel","nofollow"),d(rt,"href","https://github.com/studio-ousia/luke/tree/master/notebooks"),d(rt,"rel","nofollow"),d(dt,"href","https://huggingface.co/ikuyamada"),d(dt,"rel","nofollow"),d(ct,"href","https://huggingface.co/nielsr"),d(ct,"rel","nofollow"),d(pt,"href","https://github.com/studio-ousia/luke"),d(pt,"rel","nofollow"),d($e,"id","transformers.LukeConfig"),d($e,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),d($e,"href","#transformers.LukeConfig"),d(re,"class","relative group"),d(mn,"href","/docs/transformers/main/en/model_doc/luke#transformers.LukeModel"),d(mt,"href","https://huggingface.co/studio-ousia/luke-base"),d(mt,"rel","nofollow"),d(fn,"href","/docs/transformers/main/en/main_classes/configuration#transformers.PretrainedConfig"),d(gn,"href","/docs/transformers/main/en/main_classes/configuration#transformers.PretrainedConfig"),d(D,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),d(qe,"id","transformers.LukeTokenizer"),d(qe,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),d(qe,"href","#transformers.LukeTokenizer"),d(ce,"class","relative group"),d(_n,"href","/docs/transformers/main/en/model_doc/roberta#transformers.RobertaTokenizer"),d(kn,"href","/docs/transformers/main/en/model_doc/roberta#transformers.RobertaTokenizer"),d(yn,"href","/docs/transformers/main/en/model_doc/luke#transformers.LukeTokenizer"),d(Fe,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),d(bn,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),d(C,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),d(Ce,"id","transformers.LukeModel"),d(Ce,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),d(Ce,"href","#transformers.LukeModel"),d(pe,"class","relative group"),d(vn,"href","/docs/transformers/main/en/main_classes/model#transformers.PreTrainedModel"),d(wt,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),d(wt,"rel","nofollow"),d(Tn,"href","/docs/transformers/main/en/model_doc/luke#transformers.LukeModel"),d(K,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),d(M,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),d(je,"id","transformers.LukeForMaskedLM"),d(je,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),d(je,"href","#transformers.LukeForMaskedLM"),d(ue,"class","relative group"),d(wn,"href","/docs/transformers/main/en/main_classes/model#transformers.PreTrainedModel"),d(qt,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),d(qt,"rel","nofollow"),d(Ln,"href","/docs/transformers/main/en/model_doc/luke#transformers.LukeForMaskedLM"),d(G,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),d(P,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),d(Ie,"id","transformers.LukeForEntityClassification"),d(Ie,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),d(Ie,"href","#transformers.LukeForEntityClassification"),d(fe,"class","relative group"),d(En,"href","/docs/transformers/main/en/main_classes/model#transformers.PreTrainedModel"),d(At,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),d(At,"rel","nofollow"),d(zn,"href","/docs/transformers/main/en/model_doc/luke#transformers.LukeForEntityClassification"),d(R,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),d(j,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),d(Ne,"id","transformers.LukeForEntityPairClassification"),d(Ne,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),d(Ne,"href","#transformers.LukeForEntityPairClassification"),d(_e,"class","relative group"),d($n,"href","/docs/transformers/main/en/main_classes/model#transformers.PreTrainedModel"),d(Bt,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),d(Bt,"rel","nofollow"),d(xn,"href","/docs/transformers/main/en/model_doc/luke#transformers.LukeForEntityPairClassification"),d(H,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),d(A,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),d(We,"id","transformers.LukeForEntitySpanClassification"),d(We,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),d(We,"href","#transformers.LukeForEntitySpanClassification"),d(ye,"class","relative group"),d(qn,"href","/docs/transformers/main/en/main_classes/model#transformers.PreTrainedModel"),d(Vt,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),d(Vt,"rel","nofollow"),d(Fn,"href","/docs/transformers/main/en/model_doc/luke#transformers.LukeForEntitySpanClassification"),d(V,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),d(I,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8")},m(n,m){e(document.head,h),_(n,y,m),_(n,g,m),e(g,f),e(f,k),T(l,k,null),e(g,u),e(g,$),e($,Ws),_(n,Go,m),_(n,se,m),e(se,we),e(we,Wn),T(Xe,Wn,null),e(se,Us),e(se,Un),e(Un,Ks),_(n,Jo,m),_(n,Le,m),e(Le,Rs),e(Le,Ze),e(Ze,Hs),e(Le,Vs),_(n,Xo,m),_(n,Xt,m),e(Xt,Ys),_(n,Zo,m),_(n,Zt,m),e(Zt,Kn),e(Kn,Qs),_(n,es,m),_(n,en,m),e(en,Gs),_(n,ts,m),_(n,B,m),e(B,Rn),e(Rn,et),e(et,Js),e(et,tn),e(tn,Xs),e(et,Zs),e(B,ea),e(B,Hn),e(Hn,F),e(F,ta),e(F,Vn),e(Vn,na),e(F,oa),e(F,Yn),e(Yn,sa),e(F,aa),e(F,Qn),e(Qn,ia),e(F,ra),e(F,Gn),e(Gn,la),e(F,da),e(F,nn),e(nn,ca),e(F,pa),e(B,ha),e(B,tt),e(tt,W),e(W,on),e(on,ua),e(W,ma),e(W,Jn),e(Jn,fa),e(W,ga),e(W,Xn),e(Xn,_a),e(W,ka),e(W,Zn),e(Zn,ya),e(W,ba),e(tt,va),e(tt,nt),e(nt,sn),e(sn,eo),e(eo,Ta),e(sn,wa),e(nt,La),e(nt,an),e(an,to),e(to,Ea),e(an,za),e(B,$a),e(B,N),e(N,no),e(no,xa),e(N,qa),e(N,ae),e(ae,Ee),e(Ee,rn),e(rn,Fa),e(Ee,Ca),e(Ee,ot),e(ot,Ma),e(Ee,Pa),e(ae,ja),e(ae,ze),e(ze,ln),e(ln,Aa),e(ze,Ia),e(ze,st),e(st,Oa),e(ze,Sa),e(ae,Na),e(ae,dn),e(dn,cn),e(cn,Da),e(dn,Ba),e(N,Wa),e(N,O),e(O,pn),e(pn,Ua),e(O,Ka),e(O,oo),e(oo,Ra),e(O,Ha),e(O,so),e(so,Va),e(O,Ya),e(O,ao),e(ao,Qa),e(O,Ga),e(O,io),e(io,Ja),e(O,Xa),e(N,Za),e(N,ie),e(ie,ei),e(ie,hn),e(hn,ti),e(ie,ni),e(ie,at),e(at,oi),e(ie,si),e(N,ai),e(N,it),e(it,ii),e(it,rt),e(rt,ri),e(it,li),_(n,ns,m),_(n,un,m),e(un,di),_(n,os,m),T(lt,n,m),_(n,ss,m),_(n,U,m),e(U,ci),e(U,dt),e(dt,pi),e(U,hi),e(U,ct),e(ct,ui),e(U,mi),e(U,pt),e(pt,fi),e(U,gi),_(n,as,m),_(n,re,m),e(re,$e),e($e,ro),T(ht,ro,null),e(re,_i),e(re,lo),e(lo,ki),_(n,is,m),_(n,D,m),T(ut,D,null),e(D,yi),e(D,le),e(le,bi),e(le,mn),e(mn,vi),e(le,Ti),e(le,mt),e(mt,wi),e(le,Li),e(D,Ei),e(D,de),e(de,zi),e(de,fn),e(fn,$i),e(de,xi),e(de,gn),e(gn,qi),e(de,Fi),e(D,Ci),T(xe,D,null),_(n,rs,m),_(n,ce,m),e(ce,qe),e(qe,co),T(ft,co,null),e(ce,Mi),e(ce,po),e(po,Pi),_(n,ls,m),_(n,C,m),T(gt,C,null),e(C,ji),e(C,ho),e(ho,Ai),e(C,Ii),e(C,x),e(x,Oi),e(x,_n),e(_n,Si),e(x,Ni),e(x,kn),e(kn,Di),e(x,Bi),e(x,yn),e(yn,Wi),e(x,Ui),e(x,uo),e(uo,Ki),e(x,Ri),e(x,mo),e(mo,Hi),e(x,Vi),e(x,fo),e(fo,Yi),e(x,Qi),e(x,go),e(go,Gi),e(x,Ji),e(C,Xi),e(C,Fe),T(_t,Fe,null),e(Fe,Zi),e(Fe,_o),e(_o,er),e(C,tr),e(C,bn),T(kt,bn,null),_(n,ds,m),_(n,pe,m),e(pe,Ce),e(Ce,ko),T(yt,ko,null),e(pe,nr),e(pe,yo),e(yo,or),_(n,cs,m),_(n,M,m),T(bt,M,null),e(M,sr),e(M,bo),e(bo,ar),e(M,ir),e(M,vt),e(vt,rr),e(vt,vn),e(vn,lr),e(vt,dr),e(M,cr),e(M,Tt),e(Tt,pr),e(Tt,wt),e(wt,hr),e(Tt,ur),e(M,mr),e(M,K),T(Lt,K,null),e(K,fr),e(K,he),e(he,gr),e(he,Tn),e(Tn,_r),e(he,kr),e(he,vo),e(vo,yr),e(he,br),e(K,vr),T(Me,K,null),e(K,Tr),T(Pe,K,null),_(n,ps,m),_(n,ue,m),e(ue,je),e(je,To),T(Et,To,null),e(ue,wr),e(ue,wo),e(wo,Lr),_(n,hs,m),_(n,P,m),T(zt,P,null),e(P,Er),e(P,Lo),e(Lo,zr),e(P,$r),e(P,$t),e($t,xr),e($t,wn),e(wn,qr),e($t,Fr),e(P,Cr),e(P,xt),e(xt,Mr),e(xt,qt),e(qt,Pr),e(xt,jr),e(P,Ar),e(P,G),T(Ft,G,null),e(G,Ir),e(G,me),e(me,Or),e(me,Ln),e(Ln,Sr),e(me,Nr),e(me,Eo),e(Eo,Dr),e(me,Br),e(G,Wr),T(Ae,G,null),_(n,us,m),_(n,fe,m),e(fe,Ie),e(Ie,zo),T(Ct,zo,null),e(fe,Ur),e(fe,$o),e($o,Kr),_(n,ms,m),_(n,j,m),T(Mt,j,null),e(j,Rr),e(j,xo),e(xo,Hr),e(j,Vr),e(j,Pt),e(Pt,Yr),e(Pt,En),e(En,Qr),e(Pt,Gr),e(j,Jr),e(j,jt),e(jt,Xr),e(jt,At),e(At,Zr),e(jt,el),e(j,tl),e(j,R),T(It,R,null),e(R,nl),e(R,ge),e(ge,ol),e(ge,zn),e(zn,sl),e(ge,al),e(ge,qo),e(qo,il),e(ge,rl),e(R,ll),T(Oe,R,null),e(R,dl),T(Se,R,null),_(n,fs,m),_(n,_e,m),e(_e,Ne),e(Ne,Fo),T(Ot,Fo,null),e(_e,cl),e(_e,Co),e(Co,pl),_(n,gs,m),_(n,A,m),T(St,A,null),e(A,hl),e(A,Mo),e(Mo,ul),e(A,ml),e(A,Nt),e(Nt,fl),e(Nt,$n),e($n,gl),e(Nt,_l),e(A,kl),e(A,Dt),e(Dt,yl),e(Dt,Bt),e(Bt,bl),e(Dt,vl),e(A,Tl),e(A,H),T(Wt,H,null),e(H,wl),e(H,ke),e(ke,Ll),e(ke,xn),e(xn,El),e(ke,zl),e(ke,Po),e(Po,$l),e(ke,xl),e(H,ql),T(De,H,null),e(H,Fl),T(Be,H,null),_(n,_s,m),_(n,ye,m),e(ye,We),e(We,jo),T(Ut,jo,null),e(ye,Cl),e(ye,Ao),e(Ao,Ml),_(n,ks,m),_(n,I,m),T(Kt,I,null),e(I,Pl),e(I,Io),e(Io,jl),e(I,Al),e(I,Rt),e(Rt,Il),e(Rt,qn),e(qn,Ol),e(Rt,Sl),e(I,Nl),e(I,Ht),e(Ht,Dl),e(Ht,Vt),e(Vt,Bl),e(Ht,Wl),e(I,Ul),e(I,V),T(Yt,V,null),e(V,Kl),e(V,be),e(be,Rl),e(be,Fn),e(Fn,Hl),e(be,Vl),e(be,Oo),e(Oo,Yl),e(be,Ql),e(V,Gl),T(Ue,V,null),e(V,Jl),T(Ke,V,null),ys=!0},p(n,[m]){const Qt={};m&2&&(Qt.$$scope={dirty:m,ctx:n}),xe.$set(Qt);const So={};m&2&&(So.$$scope={dirty:m,ctx:n}),Me.$set(So);const No={};m&2&&(No.$$scope={dirty:m,ctx:n}),Pe.$set(No);const Do={};m&2&&(Do.$$scope={dirty:m,ctx:n}),Ae.$set(Do);const Gt={};m&2&&(Gt.$$scope={dirty:m,ctx:n}),Oe.$set(Gt);const Bo={};m&2&&(Bo.$$scope={dirty:m,ctx:n}),Se.$set(Bo);const Wo={};m&2&&(Wo.$$scope={dirty:m,ctx:n}),De.$set(Wo);const Uo={};m&2&&(Uo.$$scope={dirty:m,ctx:n}),Be.$set(Uo);const Jt={};m&2&&(Jt.$$scope={dirty:m,ctx:n}),Ue.$set(Jt);const Ko={};m&2&&(Ko.$$scope={dirty:m,ctx:n}),Ke.$set(Ko)},i(n){ys||(w(l.$$.fragment,n),w(Xe.$$.fragment,n),w(lt.$$.fragment,n),w(ht.$$.fragment,n),w(ut.$$.fragment,n),w(xe.$$.fragment,n),w(ft.$$.fragment,n),w(gt.$$.fragment,n),w(_t.$$.fragment,n),w(kt.$$.fragment,n),w(yt.$$.fragment,n),w(bt.$$.fragment,n),w(Lt.$$.fragment,n),w(Me.$$.fragment,n),w(Pe.$$.fragment,n),w(Et.$$.fragment,n),w(zt.$$.fragment,n),w(Ft.$$.fragment,n),w(Ae.$$.fragment,n),w(Ct.$$.fragment,n),w(Mt.$$.fragment,n),w(It.$$.fragment,n),w(Oe.$$.fragment,n),w(Se.$$.fragment,n),w(Ot.$$.fragment,n),w(St.$$.fragment,n),w(Wt.$$.fragment,n),w(De.$$.fragment,n),w(Be.$$.fragment,n),w(Ut.$$.fragment,n),w(Kt.$$.fragment,n),w(Yt.$$.fragment,n),w(Ue.$$.fragment,n),w(Ke.$$.fragment,n),ys=!0)},o(n){L(l.$$.fragment,n),L(Xe.$$.fragment,n),L(lt.$$.fragment,n),L(ht.$$.fragment,n),L(ut.$$.fragment,n),L(xe.$$.fragment,n),L(ft.$$.fragment,n),L(gt.$$.fragment,n),L(_t.$$.fragment,n),L(kt.$$.fragment,n),L(yt.$$.fragment,n),L(bt.$$.fragment,n),L(Lt.$$.fragment,n),L(Me.$$.fragment,n),L(Pe.$$.fragment,n),L(Et.$$.fragment,n),L(zt.$$.fragment,n),L(Ft.$$.fragment,n),L(Ae.$$.fragment,n),L(Ct.$$.fragment,n),L(Mt.$$.fragment,n),L(It.$$.fragment,n),L(Oe.$$.fragment,n),L(Se.$$.fragment,n),L(Ot.$$.fragment,n),L(St.$$.fragment,n),L(Wt.$$.fragment,n),L(De.$$.fragment,n),L(Be.$$.fragment,n),L(Ut.$$.fragment,n),L(Kt.$$.fragment,n),L(Yt.$$.fragment,n),L(Ue.$$.fragment,n),L(Ke.$$.fragment,n),ys=!1},d(n){t(h),n&&t(y),n&&t(g),E(l),n&&t(Go),n&&t(se),E(Xe),n&&t(Jo),n&&t(Le),n&&t(Xo),n&&t(Xt),n&&t(Zo),n&&t(Zt),n&&t(es),n&&t(en),n&&t(ts),n&&t(B),n&&t(ns),n&&t(un),n&&t(os),E(lt,n),n&&t(ss),n&&t(U),n&&t(as),n&&t(re),E(ht),n&&t(is),n&&t(D),E(ut),E(xe),n&&t(rs),n&&t(ce),E(ft),n&&t(ls),n&&t(C),E(gt),E(_t),E(kt),n&&t(ds),n&&t(pe),E(yt),n&&t(cs),n&&t(M),E(bt),E(Lt),E(Me),E(Pe),n&&t(ps),n&&t(ue),E(Et),n&&t(hs),n&&t(P),E(zt),E(Ft),E(Ae),n&&t(us),n&&t(fe),E(Ct),n&&t(ms),n&&t(j),E(Mt),E(It),E(Oe),E(Se),n&&t(fs),n&&t(_e),E(Ot),n&&t(gs),n&&t(A),E(St),E(Wt),E(De),E(Be),n&&t(_s),n&&t(ye),E(Ut),n&&t(ks),n&&t(I),E(Kt),E(Yt),E(Ue),E(Ke)}}}const ap={local:"luke",sections:[{local:"overview",title:"Overview"},{local:"transformers.LukeConfig",title:"LukeConfig"},{local:"transformers.LukeTokenizer",title:"LukeTokenizer"},{local:"transformers.LukeModel",title:"LukeModel"},{local:"transformers.LukeForMaskedLM",title:"LukeForMaskedLM"},{local:"transformers.LukeForEntityClassification",title:"LukeForEntityClassification"},{local:"transformers.LukeForEntityPairClassification",title:"LukeForEntityPairClassification"},{local:"transformers.LukeForEntitySpanClassification",title:"LukeForEntitySpanClassification"}],title:"LUKE"};function ip(z){return Vc(()=>{new URLSearchParams(window.location.search).get("fw")}),[]}class up extends Uc{constructor(h){super();Kc(this,h,ip,sp,Rc,{})}}export{up as default,ap as metadata};
