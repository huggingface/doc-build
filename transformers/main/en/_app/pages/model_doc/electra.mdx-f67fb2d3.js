...
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),YE=c(),Wp=n("p"),ZE=r("Finally, this model supports inherent JAX features such as:"),ew=c(),Qt=n("ul"),Up=n("li"),$i=n("a"),tw=r("Just-In-Time (JIT) compilation"),ow=c(),Rp=n("li"),Fi=n("a"),nw=r("Automatic Differentiation"),sw=c(),Hp=n("li"),xi=n("a"),aw=r("Vectorization"),rw=c(),Qp=n("li"),Mi=n("a"),iw=r("Parallelization"),lw=c(),Ct=n("div"),b(zi.$$.fragment),dw=c(),tn=n("p"),cw=r("The "),Vp=n("code"),pw=r("FlaxElectraPreTrainedModel"),hw=r(" forward method, overrides the "),Bp=n("code"),mw=r("__call__"),fw=r(" special method."),uw=c(),b(Ps.$$.fragment),gw=c(),b(As.$$.fragment),qf=c(),on=n("h2"),Os=n("a"),Kp=n("span"),b(Ci.$$.fragment),_w=c(),Jp=n("span"),kw=r("FlaxElectraForPreTraining"),Pf=c(),Pe=n("div"),b(ji.$$.fragment),Tw=c(),Gp=n("p"),vw=r("Electra model with a binary classification head on top as used during pretraining for identifying generated tokens."),bw=c(),Xp=n("p"),yw=r("It is recommended to load the discriminator checkpoint into that model."),Ew=c(),qi=n("p"),ww=r("This model inherits from "),Nd=n("a"),$w=r("FlaxPreTrainedModel"),Fw=r(`. Check the superclass documentation for the generic methods the
...
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),k1=c(),Mh=n("p"),T1=r("Finally, this model supports inherent JAX features such as:"),v1=c(),Jt=n("ul"),zh=n("li"),hl=n("a"),b1=r("Just-In-Time (JIT) compilation"),y1=c(),Ch=n("li"),ml=n("a"),E1=r("Automatic Differentiation"),w1=c(),jh=n("li"),fl=n("a"),$1=r("Vectorization"),F1=c(),qh=n("li"),ul=n("a"),x1=r("Parallelization"),M1=c(),At=n("div"),b(gl.$$.fragment),z1=c(),cn=n("p"),C1=r("The "),Ph=n("code"),j1=r("FlaxElectraPreTrainedModel"),q1=r(" forward method, overrides the "),Ah=n("code"),P1=r("__call__"),A1=r(" special method."),O1=c(),b(Qs.$$.fragment),L1=c(),b(Vs.$$.fragment),Df=c(),pn=n("h2"),Bs=n("a"),Oh=n("span"),b(_l.$$.fragment),N1=c(),Lh=n("span"),I1=r("FlaxElectraForTokenClassification"),Wf=c(),Ae=n("div"),b(kl.$$.fragment),S1=c(),Nh=n("p"),D1=r("Electra model with a token classification head on top."),W1=c(),Ih=n("p"),U1=r("Both the discriminator and generator may be loaded into this model."),R1=c(),Tl=n("p"),H1=r("This model inherits from "),Wd=n("a"),Q1=r("FlaxPreTrainedModel"),V1=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),B1=c(),vl=n("p"),K1=r(`This model is also a Flax Linen
...
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),Gu.forEach(t),c$=p(gt),lh=s(gt,"P",{});var rM=a(lh);p$=i(rM,"Finally, this model supports inherent JAX features such as:"),rM.forEach(t),h$=p(gt),Bt=s(gt,"UL",{});var ha=a(Bt);dh=s(ha,"LI",{});var iM=a(dh);Vi=s(iM,"A",{href:!0,rel:!0});var lM=a(Vi);m$=i(lM,"Just-In-Time (JIT) compilation"),lM.forEach(t),iM.forEach(t),f$=p(ha),ch=s(ha,"LI",{});var dM=a(ch);Bi=s(dM,"A",{href:!0,rel:!0});var cM=a(Bi);u$=i(cM,"Automatic Differentiation"),cM.forEach(t),dM.forEach(t),g$=p(ha),ph=s(ha,"LI",{});var pM=a(ph);Ki=s(pM,"A",{href:!0,rel:!0});var hM=a(Ki);_$=i(hM,"Vectorization"),hM.forEach(t),pM.forEach(t),k$=p(ha),hh=s(ha,"LI",{});var mM=a(hh);Ji=s(mM,"A",{href:!0,rel:!0});var fM=a(Ji);T$=i(fM,"Parallelization"),fM.forEach(t),mM.forEach(t),ha.forEach(t),v$=p(gt),qt=s(gt,"DIV",{class:!0});var ma=a(qt);y(Gi.$$.fragment,ma),b$=p(ma),an=s(ma,"P",{});var lc=a(an);y$=i(lc,"The "),mh=s(lc,"CODE",{});var uM=a(mh);E$=i(uM,"FlaxElectraPreTrainedModel"),uM.forEach(t),w$=i(lc," forward method, overrides the "),fh=s(lc,"CODE",{});var gM=a(fh);$$=i(gM,"__call__"),gM.forEach(t),F$=i(lc," special method."),lc.forEach(t),x$=p(ma),y(Ss.$$.fragment,ma),M$=p(ma),y(Ds.$$.fragment,ma),ma.forEach(t),gt.forEach(t),Lf=p(o),rn=s(o,"H2",{class:!0});var Xu=a(rn);Ws=s(Xu,"A",{id:!0,class:!0,href:!0});var _M=a(Ws);uh=s(_M,"SPAN",{});var kM=a(uh);y(Xi.$$.fragment,kM),kM.forEach(t),_M.forEach(t),z$=p(Xu),gh=s(Xu,"SPAN",{});var TM=a(gh);C$=i(TM,"FlaxElectraForSequenceClassification"),TM.forEach(t),Xu.forEach(t),Nf=p(o),De=s(o,"DIV",{class:!0});var _t=a(De);y(Yi.$$.fragment,_t),j$=p(_t),_h=s(_t,"P",{});var vM=a(_h);q$=i(vM,`Electra Model transformer with a sequence classification/regression head on top (a linear layer on top of the
pooled output) e.g. for GLUE tasks.`),vM.forEach(t),P$=p(_t),Zi=s(_t,"P",{});var Yu=a(Zi);A$=i(Yu,"This model inherits from "),Sd=s(Yu,"A",{href:!0});var bM=a(Sd);O$=i(bM,"FlaxPreTrainedModel"),bM.forEach(t),L$=i(Yu,`. Check the superclass documentation for the generic methods the
