...
`}}),se=new ka({props:{$$slots:{default:[Cs]},$$scope:{ctx:X}}}),ke=new ft({props:{code:`from transformers import Wav2Vec2Processor, SEWDModel
import torch
...
`}}),ie=new ka({props:{$$slots:{default:[Ts]},$$scope:{ctx:X}}}),Fe=new ft({props:{code:`from transformers import Wav2Vec2Processor, SEWDForCTC
from datasets import load_dataset
import torch
...
`}}),de=new ka({props:{$$slots:{default:[$s]},$$scope:{ctx:X}}}),He=new ft({props:{code:`from transformers import Wav2Vec2FeatureExtractor, SEWDForSequenceClassification
from datasets import load_dataset
import torch
...
<span class="hljs-meta">&gt;&gt;&gt; </span>loss = model(**inputs).loss
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-built_in">round</span>(loss.item(), <span class="hljs-number">2</span>)
<span class="hljs-number">3.16</span>`}}),{c(){p=n("meta"),k=d(),h=n("h1"),S=n("a"),W=n("span"),_(u.$$.fragment),g=d(),j=n("span"),vo=r("SEW-D"),Vt=d(),I=n("h2"),Z=n("a"),ut=n("span"),_(ce.$$.fragment),wo=d(),gt=n("span"),bo=r("Overview"),Lt=d(),ee=n("p"),yo=r("SEW-D (Squeezed and Efficient Wav2Vec with Disentangled attention) was proposed in "),me=n("a"),Eo=r(`Performance-Efficiency Trade-offs
...
behavior.`),fn=d(),P=n("div"),_(De.$$.fragment),hn=d(),U=n("p"),un=r("The "),ot=n("a"),gn=r("SEWDModel"),_n=r(" forward method, overrides the "),Wt=n("code"),vn=r("__call__"),wn=r(" special method."),bn=d(),_(se.$$.fragment),yn=d(),Dt=n("p"),En=r("Example:"),Sn=d(),_(ke.$$.fragment),Bt=d(),J=n("h2"),re=n("a"),kt=n("span"),_(Ce.$$.fragment),Wn=d(),Ct=n("span"),Dn=r("SEWDForCTC"),Yt=d(),x=n("div"),_(Te.$$.fragment),kn=d(),Q=n("p"),Cn=r("SEW-D Model with a "),Tt=n("code"),Tn=r("language modeling"),$n=r(` head on top for Connectionist Temporal Classification (CTC).
...
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),On=d(),C=n("div"),_(Pe.$$.fragment),In=d(),B=n("p"),Nn=r("The "),at=n("a"),Kn=r("SEWDForCTC"),Hn=r(" forward method, overrides the "),$t=n("code"),Rn=r("__call__"),Un=r(" special method."),Jn=d(),_(ie.$$.fragment),Qn=d(),qt=n("p"),Bn=r("Example:"),Yn=d(),_(Fe.$$.fragment),Gn=d(),_(Me.$$.fragment),Gt=d(),Y=n("h2"),le=n("a"),xt=n("span"),_(ze.$$.fragment),Xn=d(),jt=n("span"),Zn=r("SEWDForSequenceClassification"),Xt=d(),D=n("div"),_(Ae.$$.fragment),ea=d(),Pt=n("p"),ta=r(`SEWD Model with a sequence classification head on top (a linear layer over the pooled output) for tasks like SUPERB
...
Yoav Artzi.`),ra=d(),Oe=n("p"),ia=r("This model inherits from "),st=n("a"),la=r("PreTrainedModel"),da=r(`. Check the superclass documentation for the generic methods the
...
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),ha=d(),T=n("div"),_(Ke.$$.fragment),ua=d(),G=n("p"),ga=r("The "),rt=n("a"),_a=r("SEWDForSequenceClassification"),va=r(" forward method, overrides the "),Ft=n("code"),wa=r("__call__"),ba=r(" special method."),ya=d(),_(de.$$.fragment),Ea=d(),Mt=n("p"),Sa=r("Example:"),Wa=d(),_(He.$$.fragment),Da=d(),_(Re.$$.fragment),this.h()},l(t){const m=Ds('[data-svelte="svelte-1phssyn"]',document.head);p=a(m,"META",{name:!0,content:!0}),m.forEach(o),k=c(t),h=a(t,"H1",{class:!0});var Ue=s(h);S=a(Ue,"A",{id:!0,class:!0,href:!0});var zt=s(S);W=a(zt,"SPAN",{});var At=s(W);v(u.$$.fragment,At),At.forEach(o),zt.forEach(o),g=c(Ue),j=a(Ue,"SPAN",{});var Ca=s(j);vo=i(Ca,"SEW-D"),Ca.forEach(o),Ue.forEach(o),Vt=c(t),I=a(t,"H2",{class:!0});var eo=s(I);Z=a(eo,"A",{id:!0,class:!0,href:!0});var Ta=s(Z);ut=a(Ta,"SPAN",{});var $a=s(ut);v(ce.$$.fragment,$a),$a.forEach(o),Ta.forEach(o),wo=c(eo),gt=a(eo,"SPAN",{});var qa=s(gt);bo=i(qa,"Overview"),qa.forEach(o),eo.forEach(o),Lt=c(t),ee=a(t,"P",{});var to=s(ee);yo=i(to,"SEW-D (Squeezed and Efficient Wav2Vec with Disentangled attention) was proposed in "),me=a(to,"A",{href:!0,rel:!0});var xa=s(me);Eo=i(xa,`Performance-Efficiency Trade-offs
in Unsupervised Pre-training for Speech Recognition`),xa.forEach(o),So=i(to,` by Felix Wu, Kwangyoun Kim,
Jing Pan, Kyu Han, Kilian Q. Weinberger, Yoav Artzi.`),to.forEach(o),Ot=c(t),Qe=a(t,"P",{});var ja=s(Qe);Wo=i(ja,"The abstract from the paper is the following:"),ja.forEach(o),It=c(t),Be=a(t,"P",{});var Pa=s(Be);_t=a(Pa,"EM",{});var Fa=s(_t);Do=i(Fa,`This paper is a study of performance-efficiency trade-offs in pre-trained models for automatic speech recognition
(ASR). We focus on wav2vec 2.0, and formalize several architecture designs that influence both the model performance
and its efficiency. Putting together all our observations, we introduce SEW (Squeezed and Efficient Wav2vec), a
pre-trained model architecture with significant improvements along both performance and efficiency dimensions across a
variety of training setups. For example, under the 100h-960h semi-supervised setup on LibriSpeech, SEW achieves a 1.9x
...
using `),Ge=a(no,"A",{href:!0});var Aa=s(Ge);qo=i(Aa,"Wav2Vec2CTCTokenizer"),Aa.forEach(o),xo=i(no,"."),no.forEach(o),oo.forEach(o),Ht=c(t),oe=a(t,"P",{});var ao=s(oe);jo=i(ao,"This model was contributed by "),fe=a(ao,"A",{href:!0,rel:!0});var Va=s(fe);Po=i(Va,"anton-l"),Va.forEach(o),Fo=i(ao,"."),ao.forEach(o),Rt=c(t),N=a(t,"H2",{class:!0});var so=s(N);ne=a(so,"A",{id:!0,class:!0,href:!0});var La=s(ne);wt=a(La,"SPAN",{});var Oa=s(wt);v(he.$$.fragment,Oa),Oa.forEach(o),La.forEach(o),Mo=c(so),bt=a(so,"SPAN",{});var Ia=s(bt);zo=i(Ia,"SEWDConfig"),Ia.forEach(o),so.forEach(o),Ut=c(t),$=a(t,"DIV",{class:!0});var A=s($);v(ue.$$.fragment,A),Ao=c(A),K=a(A,"P",{});var it=s(K);Vo=i(it,"This is the configuration class to store the configuration of a "),Xe=a(it,"A",{href:!0});var Na=s(Xe);Lo=i(Na,"SEWDModel"),Na.forEach(o),Oo=i(it,`. It is used to instantiate a SEW-D
model according to the specified arguments, defining the model architecture. Instantiating a configuration with the
defaults will yield a similar configuration to that of the SEW-D
...
documentation from `),et=a(lt,"A",{href:!0});var Ra=s(et);Jo=i(Ra,"PretrainedConfig"),Ra.forEach(o),Qo=i(lt," for more information."),lt.forEach(o),Bo=c(A),yt=a(A,"P",{});var Ua=s(yt);Yo=i(Ua,"Example:"),Ua.forEach(o),Go=c(A),v(_e.$$.fragment,A),A.forEach(o),Jt=c(t),R=a(t,"H2",{class:!0});var ro=s(R);ae=a(ro,"A",{id:!0,class:!0,href:!0});var Ja=s(ae);Et=a(Ja,"SPAN",{});var Qa=s(Et);v(ve.$$.fragment,Qa),Qa.forEach(o),Ja.forEach(o),Xo=c(ro),St=a(ro,"SPAN",{});var Ba=s(St);Zo=i(Ba,"SEWDModel"),Ba.forEach(o),ro.forEach(o),Qt=c(t),q=a(t,"DIV",{class:!0});var V=s(q);v(we.$$.fragment,V),en=c(V),be=a(V,"P",{});var io=s(be);tn=i(io,`The bare SEW-D Model transformer outputting raw hidden-states without any specific head on top.
...
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),co.forEach(o),fn=c(V),P=a(V,"DIV",{class:!0});var L=s(P);v(De.$$.fragment,L),hn=c(L),U=a(L,"P",{});var dt=s(U);un=i(dt,"The "),ot=a(dt,"A",{href:!0});var Za=s(ot);gn=i(Za,"SEWDModel"),Za.forEach(o),_n=i(dt," forward method, overrides the "),Wt=a(dt,"CODE",{});var es=s(Wt);vn=i(es,"__call__"),es.forEach(o),wn=i(dt," special method."),dt.forEach(o),bn=c(L),v(se.$$.fragment,L),yn=c(L),Dt=a(L,"P",{});var ts=s(Dt);En=i(ts,"Example:"),ts.forEach(o),Sn=c(L),v(ke.$$.fragment,L),L.forEach(o),V.forEach(o),Bt=c(t),J=a(t,"H2",{class:!0});var mo=s(J);re=a(mo,"A",{id:!0,class:!0,href:!0});var os=s(re);kt=a(os,"SPAN",{});var ns=s(kt);v(Ce.$$.fragment,ns),ns.forEach(o),os.forEach(o),Wn=c(mo),Ct=a(mo,"SPAN",{});var as=s(Ct);Dn=i(as,"SEWDForCTC"),as.forEach(o),mo.forEach(o),Yt=c(t),x=a(t,"DIV",{class:!0});var O=s(x);v(Te.$$.fragment,O),kn=c(O),Q=a(O,"P",{});var ct=s(Q);Cn=i(ct,"SEW-D Model with a "),Tt=a(ct,"CODE",{});var ss=s(Tt);Tn=i(ss,"language modeling"),ss.forEach(o),$n=i(ct,` head on top for Connectionist Temporal Classification (CTC).
...
Yoav Artzi.`),ct.forEach(o),jn=c(O),qe=a(O,"P",{});var po=s(qe);Pn=i(po,"This model inherits from "),nt=a(po,"A",{href:!0});var is=s(nt);Fn=i(is,"PreTrainedModel"),is.forEach(o),Mn=i(po,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving etc.).`),po.forEach(o),zn=c(O),xe=a(O,"P",{});var fo=s(xe);An=i(fo,"This model is a PyTorch "),je=a(fo,"A",{href:!0,rel:!0});var ls=s(je);Vn=i(ls,"torch.nn.Module"),ls.forEach(o),Ln=i(fo,` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),fo.forEach(o),On=c(O),C=a(O,"DIV",{class:!0});var F=s(C);v(Pe.$$.fragment,F),In=c(F),B=a(F,"P",{});var mt=s(B);Nn=i(mt,"The "),at=a(mt,"A",{href:!0});var ds=s(at);Kn=i(ds,"SEWDForCTC"),ds.forEach(o),Hn=i(mt," forward method, overrides the "),$t=a(mt,"CODE",{});var cs=s($t);Rn=i(cs,"__call__"),cs.forEach(o),Un=i(mt," special method."),mt.forEach(o),Jn=c(F),v(ie.$$.fragment,F),Qn=c(F),qt=a(F,"P",{});var ms=s(qt);Bn=i(ms,"Example:"),ms.forEach(o),Yn=c(F),v(Fe.$$.fragment,F),Gn=c(F),v(Me.$$.fragment,F),F.forEach(o),O.forEach(o),Gt=c(t),Y=a(t,"H2",{class:!0});var ho=s(Y);le=a(ho,"A",{id:!0,class:!0,href:!0});var ps=s(le);xt=a(ps,"SPAN",{});var fs=s(xt);v(ze.$$.fragment,fs),fs.forEach(o),ps.forEach(o),Xn=c(ho),jt=a(ho,"SPAN",{});var hs=s(jt);Zn=i(hs,"SEWDForSequenceClassification"),hs.forEach(o),ho.forEach(o),Xt=c(t),D=a(t,"DIV",{class:!0});var M=s(D);v(Ae.$$.fragment,M),ea=c(M),Pt=a(M,"P",{});var us=s(Pt);ta=i(us,`SEWD Model with a sequence classification head on top (a linear layer over the pooled output) for tasks like SUPERB
...
Yoav Artzi.`),uo.forEach(o),ra=c(M),Oe=a(M,"P",{});var go=s(Oe);ia=i(go,"This model inherits from "),st=a(go,"A",{href:!0});var _s=s(st);la=i(_s,"PreTrainedModel"),_s.forEach(o),da=i(go,`. Check the superclass documentation for the generic methods the
...
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),_o.forEach(o),ha=c(M),T=a(M,"DIV",{class:!0});var z=s(T);v(Ke.$$.fragment,z),ua=c(z),G=a(z,"P",{});var pt=s(G);ga=i(pt,"The "),rt=a(pt,"A",{href:!0});var ws=s(rt);_a=i(ws,"SEWDForSequenceClassification"),ws.forEach(o),va=i(pt," forward method, overrides the "),Ft=a(pt,"CODE",{});var bs=s(Ft);wa=i(bs,"__call__"),bs.forEach(o),ba=i(pt," special method."),pt.forEach(o),ya=c(z),v(de.$$.fragment,z),Ea=c(z),Mt=a(z,"P",{});var ys=s(Mt);Sa=i(ys,"Example:"),ys.forEach(o),Wa=c(z),v(He.$$.fragment,z),Da=c(z),v(Re.$$.fragment,z),z.forEach(o),M.forEach(o),this.h()},h(){l(p,"name","hf:doc:metadata"),l(p,"content",JSON.stringify(xs)),l(S,"id","sewd"),l(S,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),l(S,"href","#sewd"),l(h,"class","relative group"),l(Z,"id","overview"),l(Z,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),l(Z,"href","#overview"),l(I,"class","relative group"),l(me,"href","https://arxiv.org/abs/2109.06870"),l(me,"rel","nofollow"),l(Ge,"href","/docs/transformers/main/en/model_doc/wav2vec2#transformers.Wav2Vec2CTCTokenizer"),l(fe,"href","https://huggingface.co/anton-l"),l(fe,"rel","nofollow"),l(ne,"id","transformers.SEWDConfig"),l(ne,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),l(ne,"href","#transformers.SEWDConfig"),l(N,"class","relative group"),l(Xe,"href","/docs/transformers/main/en/model_doc/sew-d#transformers.SEWDModel"),l(ge,"href","https://huggingface.co/asapp/sew-d-tiny-100k"),l(ge,"rel","nofollow"),l(Ze,"href","/docs/transformers/main/en/main_classes/configuration#transformers.PretrainedConfig"),l(et,"href","/docs/transformers/main/en/main_classes/configuration#transformers.PretrainedConfig"),l($,"class","docstring"),l(ae,"id","transformers.SEWDModel"),l(ae,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),l(ae,"href","#transformers.SEWDModel"),l(R,"class","relative group"),l(ye,"href","https://arxiv.org/abs/2109.06870"),l(ye,"rel","nofollow"),l(tt,"href","/docs/transformers/main/en/main_classes/model#transformers.PreTrainedModel"),l(We,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),l(We,"rel","nofollow"),l(ot,"href","/docs/transformers/main/en/model_doc/sew-d#transformers.SEWDModel"),l(P,"class","docstring"),l(q,"class","docstring"),l(re,"id","transformers.SEWDForCTC"),l(re,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),l(re,"href","#transformers.SEWDForCTC"),l(J,"class","relative group"),l($e,"href","https://arxiv.org/abs/2109.06870"),l($e,"rel","nofollow"),l(nt,"href","/docs/transformers/main/en/main_classes/model#transformers.PreTrainedModel"),l(je,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),l(je,"rel","nofollow"),l(at,"href","/docs/transformers/main/en/model_doc/sew-d#transformers.SEWDForCTC"),l(C,"class","docstring"),l(x,"class","docstring"),l(le,"id","transformers.SEWDForSequenceClassification"),l(le,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),l(le,"href","#transformers.SEWDForSequenceClassification"),l(Y,"class","relative group"),l(Le,"href","https://arxiv.org/abs/2109.06870"),l(Le,"rel","nofollow"),l(st,"href","/docs/transformers/main/en/main_classes/model#transformers.PreTrainedModel"),l(Ne,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),l(Ne,"rel","nofollow"),l(rt,"href","/docs/transformers/main/en/model_doc/sew-d#transformers.SEWDForSequenceClassification"),l(T,"class","docstring"),l(D,"class","docstring")},m(t,m){e(document.head,p),f(t,k,m),f(t,h,m),e(h,S),e(S,W),w(u,W,null),e(h,g),e(h,j),e(j,vo),f(t,Vt,m),f(t,I,m),e(I,Z),e(Z,ut),w(ce,ut,null),e(I,wo),e(I,gt),e(gt,bo),f(t,Lt,m),f(t,ee,m),e(ee,yo),e(ee,me),e(me,Eo),e(ee,So),f(t,Ot,m),f(t,Qe,m),e(Qe,Wo),f(t,It,m),f(t,Be,m),e(Be,_t),e(_t,Do),f(t,Nt,m),f(t,Ye,m),e(Ye,ko),f(t,Kt,m),f(t,te,m),e(te,vt),e(vt,Co),e(te,To),e(te,pe),e(pe,$o),e(pe,Ge),e(Ge,qo),e(pe,xo),f(t,Ht,m),f(t,oe,m),e(oe,jo),e(oe,fe),e(fe,Po),e(oe,Fo),f(t,Rt,m),f(t,N,m),e(N,ne),e(ne,wt),w(he,wt,null),e(N,Mo),e(N,bt),e(bt,zo),f(t,Ut,m),f(t,$,m),w(ue,$,null),e($,Ao),e($,K),e(K,Vo),e(K,Xe),e(Xe,Lo),e(K,Oo),e(K,ge),e(ge,Io),e(K,No),e($,Ko),e($,H),e(H,Ho),e(H,Ze),e(Ze,Ro),e(H,Uo),e(H,et),e(et,Jo),e(H,Qo),e($,Bo),e($,yt),e(yt,Yo),e($,Go),w(_e,$,null),f(t,Jt,m),f(t,R,m),e(R,ae),e(ae,Et),w(ve,Et,null),e(R,Xo),e(R,St),e(St,Zo),f(t,Qt,m),f(t,q,m),w(we,q,null),e(q,en),e(q,be),e(be,tn),e(be,ye),e(ye,on),e(be,nn),e(q,an),e(q,Ee),e(Ee,sn),e(Ee,tt),e(tt,rn),e(Ee,ln),e(q,dn),e(q,Se),e(Se,cn),e(Se,We),e(We,mn),e(Se,pn),e(q,fn),e(q,P),w(De,P,null),e(P,hn),e(P,U),e(U,un),e(U,ot),e(ot,gn),e(U,_n),e(U,Wt),e(Wt,vn),e(U,wn),e(P,bn),w(se,P,null),e(P,yn),e(P,Dt),e(Dt,En),e(P,Sn),w(ke,P,null),f(t,Bt,m),f(t,J,m),e(J,re),e(re,kt),w(Ce,kt,null),e(J,Wn),e(J,Ct),e(Ct,Dn),f(t,Yt,m),f(t,x,m),w(Te,x,null),e(x,kn),e(x,Q),e(Q,Cn),e(Q,Tt),e(Tt,Tn),e(Q,$n),e(Q,$e),e($e,qn),e(Q,xn),e(x,jn),e(x,qe),e(qe,Pn),e(qe,nt),e(nt,Fn),e(qe,Mn),e(x,zn),e(x,xe),e(xe,An),e(xe,je),e(je,Vn),e(xe,Ln),e(x,On),e(x,C),w(Pe,C,null),e(C,In),e(C,B),e(B,Nn),e(B,at),e(at,Kn),e(B,Hn),e(B,$t),e($t,Rn),e(B,Un),e(C,Jn),w(ie,C,null),e(C,Qn),e(C,qt),e(qt,Bn),e(C,Yn),w(Fe,C,null),e(C,Gn),w(Me,C,null),f(t,Gt,m),f(t,Y,m),e(Y,le),e(le,xt),w(ze,xt,null),e(Y,Xn),e(Y,jt),e(jt,Zn),f(t,Xt,m),f(t,D,m),w(Ae,D,null),e(D,ea),e(D,Pt),e(Pt,ta),e(D,oa),e(D,Ve),e(Ve,na),e(Ve,Le),e(Le,aa),e(Ve,sa),e(D,ra),e(D,Oe),e(Oe,ia),e(Oe,st),e(st,la),e(Oe,da),e(D,ca),e(D,Ie),e(Ie,ma),e(Ie,Ne),e(Ne,pa),e(Ie,fa),e(D,ha),e(D,T),w(Ke,T,null),e(T,ua),e(T,G),e(G,ga),e(G,rt),e(rt,_a),e(G,va),e(G,Ft),e(Ft,wa),e(G,ba),e(T,ya),w(de,T,null),e(T,Ea),e(T,Mt),e(Mt,Sa),e(T,Wa),w(He,T,null),e(T,Da),w(Re,T,null),Zt=!0},p(t,[m]){const Ue={};m&2&&(Ue.$$scope={dirty:m,ctx:t}),se.$set(Ue);const zt={};m&2&&(zt.$$scope={dirty:m,ctx:t}),ie.$set(zt);const At={};m&2&&(At.$$scope={dirty:m,ctx:t}),de.$set(At)},i(t){Zt||(b(u.$$.fragment,t),b(ce.$$.fragment,t),b(he.$$.fragment,t),b(ue.$$.fragment,t),b(_e.$$.fragment,t),b(ve.$$.fragment,t),b(we.$$.fragment,t),b(De.$$.fragment,t),b(se.$$.fragment,t),b(ke.$$.fragment,t),b(Ce.$$.fragment,t),b(Te.$$.fragment,t),b(Pe.$$.fragment,t),b(ie.$$.fragment,t),b(Fe.$$.fragment,t),b(Me.$$.fragment,t),b(ze.$$.fragment,t),b(Ae.$$.fragment,t),b(Ke.$$.fragment,t),b(de.$$.fragment,t),b(He.$$.fragment,t),b(Re.$$.fragment,t),Zt=!0)},o(t){y(u.$$.fragment,t),y(ce.$$.fragment,t),y(he.$$.fragment,t),y(ue.$$.fragment,t),y(_e.$$.fragment,t),y(ve.$$.fragment,t),y(we.$$.fragment,t),y(De.$$.fragment,t),y(se.$$.fragment,t),y(ke.$$.fragment,t),y(Ce.$$.fragment,t),y(Te.$$.fragment,t),y(Pe.$$.fragment,t),y(ie.$$.fragment,t),y(Fe.$$.fragment,t),y(Me.$$.fragment,t),y(ze.$$.fragment,t),y(Ae.$$.fragment,t),y(Ke.$$.fragment,t),y(de.$$.fragment,t),y(He.$$.fragment,t),y(Re.$$.fragment,t),Zt=!1},d(t){o(p),t&&o(k),t&&o(h),E(u),t&&o(Vt),t&&o(I),E(ce),t&&o(Lt),t&&o(ee),t&&o(Ot),t&&o(Qe),t&&o(It),t&&o(Be),t&&o(Nt),t&&o(Ye),t&&o(Kt),t&&o(te),t&&o(Ht),t&&o(oe),t&&o(Rt),t&&o(N),E(he),t&&o(Ut),t&&o($),E(ue),E(_e),t&&o(Jt),t&&o(R),E(ve),t&&o(Qt),t&&o(q),E(we),E(De),E(se),E(ke),t&&o(Bt),t&&o(J),E(Ce),t&&o(Yt),t&&o(x),E(Te),E(Pe),E(ie),E(Fe),E(Me),t&&o(Gt),t&&o(Y),E(ze),t&&o(Xt),t&&o(D),E(Ae),E(Ke),E(de),E(He),E(Re)}}}const xs={local:"sewd",sections:[{local:"overview",title:"Overview"},{local:"transformers.SEWDConfig",title:"SEWDConfig"},{local:"transformers.SEWDModel",title:"SEWDModel"},{local:"transformers.SEWDForCTC",title:"SEWDForCTC"},{local:"transformers.SEWDForSequenceClassification",title:"SEWDForSequenceClassification"}],title:"SEW-D"};function js(X){return ks(()=>{new URLSearchParams(window.location.search).get("fw")}),[]}class Vs extends Es{constructor(p){super();Ss(this,p,js,qs,Ws,{})}}export{Vs as default,xs as metadata};
