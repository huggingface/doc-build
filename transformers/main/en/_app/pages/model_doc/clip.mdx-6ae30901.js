import{S as aP,i as rP,s as iP,e as n,k as l,w as u,t as r,M as lP,c as s,d as o,m as d,a,x as g,h as i,b as c,F as e,g as h,y as _,q as v,o as P,B as T,v as dP}from"../../chunks/vendor-6b77c823.js";import{T as ce}from"../../chunks/Tip-39098574.js";import{D as w}from"../../chunks/Docstring-abef54e3.js";import{C as A}from"../../chunks/CodeBlock-3a8b25a8.js";import{I as D}from"../../chunks/IconCopyLink-7a11ce68.js";function cP(x){let p,L,I,b,C;return{c(){p=n("p"),L=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),I=n("code"),b=r("Module"),C=r(`
...
model weights at this https URL.`),Yt=l(),O=n("h2"),ge=n("a"),we=n("span"),u($e.$$.fragment),Xo=l(),xe=n("span"),Zo=r("Usage"),eo=l(),he=n("p"),Qo=r(`CLIP is a multi-modal vision and language model. It can be used for image-text similarity and for zero-shot image
...
special tokens using the tokenizer `),kr=n("code"),op=r("prepare_for_model"),np=r(" method."),sp=l(),co=n("div"),u(yn.$$.fragment),ap=l(),wr=n("p"),rp=r(`Create a mask from the two sequences passed. CLIP does not make use of token type ids, therefore a list of
zeros is returned.`),ip=l(),Ia=n("div"),u(bn.$$.fragment),hl=l(),vt=n("h2"),po=n("a"),$r=n("span"),u(Cn.$$.fragment),lp=l(),xr=n("span"),dp=r("CLIPTokenizerFast"),fl=l(),W=n("div"),u(Ln.$$.fragment),cp=l(),kn=n("p"),pp=r("Construct a \u201Cfast\u201D CLIP tokenizer (backed by HuggingFace\u2019s "),Er=n("em"),mp=r("tokenizers"),hp=r(` library). Based on byte-level
...
refer to this superclass for more information regarding those methods.`),vp=l(),Ie=n("div"),u($n.$$.fragment),Pp=l(),zr=n("p"),Tp=r(`Build model inputs from a sequence or a pair of sequence for sequence classification tasks by concatenating and
adding special tokens. A CLIP sequence has the following format:`),Ip=l(),Mr=n("ul"),ba=n("li"),yp=r("single sequence: "),jr=n("code"),bp=r("<|startoftext|> X <|endoftext|>"),Cp=l(),Fr=n("p"),Lp=r("Pairs of sequences are not the expected use case, but they will be handled without a separator."),kp=l(),mo=n("div"),u(xn.$$.fragment),wp=l(),qr=n("p"),$p=r(`Create a mask from the two sequences passed. CLIP does not make use of token type ids, therefore a list of
...
size is given, it will be padded (so the returned result has the size asked).`),Wp=l(),uo=n("div"),u(qn.$$.fragment),Bp=l(),Tt=n("p"),Up=r("Resizes "),Vr=n("code"),Rp=r("image"),Hp=r(". Note that this will trigger a conversion of "),Sr=n("code"),Kp=r("image"),Gp=r(" to a PIL Image."),_l=l(),It=n("h2"),go=n("a"),Wr=n("span"),u(Dn.$$.fragment),Jp=l(),Br=n("span"),Xp=r("CLIPProcessor"),vl=l(),U=n("div"),u(On.$$.fragment),Zp=l(),Ur=n("p"),Qp=r("Constructs a CLIP processor which wraps a CLIP feature extractor and a CLIP tokenizer into a single processor."),Yp=l(),K=n("p"),La=n("a"),em=r("CLIPProcessor"),tm=r(" offers all the functionalities of "),ka=n("a"),om=r("CLIPFeatureExtractor"),nm=r(" and "),wa=n("a"),sm=r("CLIPTokenizerFast"),am=r(`. See the
...
behavior.`),km=l(),G=n("div"),u(Hn.$$.fragment),wm=l(),bt=n("p"),$m=r("The "),za=n("a"),xm=r("CLIPModel"),Em=r(" forward method, overrides the "),Gr=n("code"),zm=r("__call__"),Mm=r(" special method."),jm=l(),u(To.$$.fragment),Fm=l(),Jr=n("p"),qm=r("Examples:"),Dm=l(),u(Kn.$$.fragment),Om=l(),J=n("div"),u(Gn.$$.fragment),Am=l(),Ct=n("p"),Nm=r("The "),Ma=n("a"),Vm=r("CLIPModel"),Sm=r(" forward method, overrides the "),Xr=n("code"),Wm=r("__call__"),Bm=r(" special method."),Um=l(),u(Io.$$.fragment),Rm=l(),Zr=n("p"),Hm=r("Examples:"),Km=l(),u(Jn.$$.fragment),Gm=l(),X=n("div"),u(Xn.$$.fragment),Jm=l(),Lt=n("p"),Xm=r("The "),ja=n("a"),Zm=r("CLIPModel"),Qm=r(" forward method, overrides the "),Qr=n("code"),Ym=r("__call__"),eh=r(" special method."),th=l(),u(yo.$$.fragment),oh=l(),Yr=n("p"),nh=r("Examples:"),sh=l(),u(Zn.$$.fragment),Il=l(),kt=n("h2"),bo=n("a"),ei=n("span"),u(Qn.$$.fragment),ah=l(),ti=n("span"),rh=r("CLIPTextModel"),yl=l(),wt=n("div"),u(Yn.$$.fragment),ih=l(),Z=n("div"),u(es.$$.fragment),lh=l(),$t=n("p"),dh=r("The "),Fa=n("a"),ch=r("CLIPTextModel"),ph=r(" forward method, overrides the "),oi=n("code"),mh=r("__call__"),hh=r(" special method."),fh=l(),u(Co.$$.fragment),uh=l(),ni=n("p"),gh=r("Examples:"),_h=l(),u(ts.$$.fragment),bl=l(),xt=n("h2"),Lo=n("a"),si=n("span"),u(os.$$.fragment),vh=l(),ai=n("span"),Ph=r("CLIPVisionModel"),Cl=l(),Et=n("div"),u(ns.$$.fragment),Th=l(),Q=n("div"),u(ss.$$.fragment),Ih=l(),zt=n("p"),yh=r("The "),qa=n("a"),bh=r("CLIPVisionModel"),Ch=r(" forward method, overrides the "),ri=n("code"),Lh=r("__call__"),kh=r(" special method."),wh=l(),u(ko.$$.fragment),$h=l(),ii=n("p"),xh=r("Examples:"),Eh=l(),u(as.$$.fragment),Ll=l(),Mt=n("h2"),wo=n("a"),li=n("span"),u(rs.$$.fragment),zh=l(),di=n("span"),Mh=r("TFCLIPModel"),kl=l(),q=n("div"),u(is.$$.fragment),jh=l(),ls=n("p"),Fh=r("This model inherits from "),Da=n("a"),qh=r("TFPreTrainedModel"),Dh=r(`. Check the superclass documentation for the generic methods the
...
behavior.`),Sh=l(),u($o.$$.fragment),Wh=l(),Y=n("div"),u(ps.$$.fragment),Bh=l(),jt=n("p"),Uh=r("The "),Oa=n("a"),Rh=r("TFCLIPModel"),Hh=r(" forward method, overrides the "),ci=n("code"),Kh=r("__call__"),Gh=r(" special method."),Jh=l(),u(xo.$$.fragment),Xh=l(),pi=n("p"),Zh=r("Examples:"),Qh=l(),u(ms.$$.fragment),Yh=l(),ee=n("div"),u(hs.$$.fragment),ef=l(),Ft=n("p"),tf=r("The "),Aa=n("a"),of=r("TFCLIPModel"),nf=r(" forward method, overrides the "),mi=n("code"),sf=r("__call__"),af=r(" special method."),rf=l(),u(Eo.$$.fragment),lf=l(),hi=n("p"),df=r("Examples:"),cf=l(),u(fs.$$.fragment),pf=l(),te=n("div"),u(us.$$.fragment),mf=l(),qt=n("p"),hf=r("The "),Na=n("a"),ff=r("TFCLIPModel"),uf=r(" forward method, overrides the "),fi=n("code"),gf=r("__call__"),_f=r(" special method."),vf=l(),u(zo.$$.fragment),Pf=l(),ui=n("p"),Tf=r("Examples:"),If=l(),u(gs.$$.fragment),wl=l(),Dt=n("h2"),Mo=n("a"),gi=n("span"),u(_s.$$.fragment),yf=l(),_i=n("span"),bf=r("TFCLIPTextModel"),$l=l(),Ot=n("div"),u(vs.$$.fragment),Cf=l(),oe=n("div"),u(Ps.$$.fragment),Lf=l(),At=n("p"),kf=r("The "),Va=n("a"),wf=r("TFCLIPTextModel"),$f=r(" forward method, overrides the "),vi=n("code"),xf=r("__call__"),Ef=r(" special method."),zf=l(),u(jo.$$.fragment),Mf=l(),Pi=n("p"),jf=r("Examples:"),Ff=l(),u(Ts.$$.fragment),xl=l(),Nt=n("h2"),Fo=n("a"),Ti=n("span"),u(Is.$$.fragment),qf=l(),Ii=n("span"),Df=r("TFCLIPVisionModel"),El=l(),Vt=n("div"),u(ys.$$.fragment),Of=l(),ne=n("div"),u(bs.$$.fragment),Af=l(),St=n("p"),Nf=r("The "),Sa=n("a"),Vf=r("TFCLIPVisionModel"),Sf=r(" forward method, overrides the "),yi=n("code"),Wf=r("__call__"),Bf=r(" special method."),Uf=l(),u(qo.$$.fragment),Rf=l(),bi=n("p"),Hf=r("Examples:"),Kf=l(),u(Cs.$$.fragment),zl=l(),Wt=n("h2"),Do=n("a"),Ci=n("span"),u(Ls.$$.fragment),Gf=l(),Li=n("span"),Jf=r("FlaxCLIPModel"),Ml=l(),z=n("div"),u(ks.$$.fragment),Xf=l(),ws=n("p"),Zf=r("This model inherits from "),Wa=n("a"),Qf=r("FlaxPreTrainedModel"),Yf=r(`. Check the superclass documentation for the generic methods the
...
for any dataset specific training. For instance, we match the accuracy of the original ResNet-50 on ImageNet zero-shot
without needing to use any of the 1.28 million training examples it was trained on. We release our code and pre-trained
model weights at this https URL.`),tl.forEach(o),el.forEach(o),Yt=d(t),O=s(t,"H2",{class:!0});var Zs=a(O);ge=s(Zs,"A",{id:!0,class:!0,href:!0});var ig=a(ge);we=s(ig,"SPAN",{});var lg=a(we);g($e.$$.fragment,lg),lg.forEach(o),ig.forEach(o),Xo=d(Zs),xe=s(Zs,"SPAN",{});var dg=a(xe);Zo=i(dg,"Usage"),dg.forEach(o),Zs.forEach(o),eo=d(t),he=s(t,"P",{});var cg=a(he);Qo=i(cg,`CLIP is a multi-modal vision and language model. It can be used for image-text similarity and for zero-shot image
classification. CLIP uses a ViT like transformer to get visual features and a causal language model to get the text
features. Both the text and visual features are then projected to a latent space with identical dimension. The dot
...
refer to this superclass for more information regarding those methods.`),Zl.forEach(o),vp=d(Be),Ie=s(Be,"DIV",{class:!0});var Uo=a(Ie);g($n.$$.fragment,Uo),Pp=d(Uo),zr=s(Uo,"P",{});var i_=a(zr);Tp=i(i_,`Build model inputs from a sequence or a pair of sequence for sequence classification tasks by concatenating and
adding special tokens. A CLIP sequence has the following format:`),i_.forEach(o),Ip=d(Uo),Mr=s(Uo,"UL",{});var l_=a(Mr);ba=s(l_,"LI",{});var rg=a(ba);yp=i(rg,"single sequence: "),jr=s(rg,"CODE",{});var d_=a(jr);bp=i(d_,"<|startoftext|> X <|endoftext|>"),d_.forEach(o),rg.forEach(o),l_.forEach(o),Cp=d(Uo),Fr=s(Uo,"P",{});var c_=a(Fr);Lp=i(c_,"Pairs of sequences are not the expected use case, but they will be handled without a separator."),c_.forEach(o),Uo.forEach(o),kp=d(Be),mo=s(Be,"DIV",{class:!0});var Ql=a(mo);g(xn.$$.fragment,Ql),wp=d(Ql),qr=s(Ql,"P",{});var p_=a(qr);$p=i(p_,`Create a mask from the two sequences passed. CLIP does not make use of token type ids, therefore a list of
