...
**kwargs &#x2014; passed to the <code>self.tokenize()</code> method`,name:"verbose"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/tokenization_utils_base.py#L2390",returnDescription:`
<p>A <a
...
`}}),Ho=new me({props:{$$slots:{default:[lT]},$$scope:{ctx:W}}}),Xo=new he({props:{anchor:"transformers.Wav2Vec2Model.forward.example",$$slots:{default:[cT]},$$scope:{ctx:W}}}),Zs=new Y({}),Ks=new F({props:{name:"class transformers.Wav2Vec2ForCTC",anchor:"transformers.Wav2Vec2ForCTC",parameters:[{name:"config",val:""}],parametersDescription:[{anchor:"transformers.Wav2Vec2ForCTC.config",description:`<strong>config</strong> (<a href="/docs/transformers/main/en/model_doc/wav2vec2#transformers.Wav2Vec2Config">Wav2Vec2Config</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
...
`}}),Wa=new me({props:{$$slots:{default:[qT]},$$scope:{ctx:W}}}),Va=new he({props:{anchor:"transformers.FlaxWav2Vec2ForPreTraining.__call__.example",$$slots:{default:[PT]},$$scope:{ctx:W}}}),{c(){c=a("meta"),b=d(),f=a("h1"),h=a("a"),v=a("span"),w(l.$$.fragment),u=d(),j=a("span"),L=r("Wav2Vec2"),P=d(),C=a("h2"),M=a("a"),A=a("span"),w(R.$$.fragment),D=d(),q=a("span"),je=r("Overview"),ge=d(),I=a("p"),U=r("The Wav2Vec2 model was proposed in "),_e=a("a"),Se=r("wav2vec 2.0: A Framework for Self-Supervised Learning of Speech Representations"),z=r(" by Alexei Baevski, Henry Zhou, Abdelrahman Mohamed, Michael Auli."),N=d(),Fe=a("p"),ve=r("The abstract from the paper is the following:"),Re=d(),Ce=a("p"),te=a("em"),lt=r(`We show for the first time that learning powerful representations from speech audio alone followed by fine-tuning on
