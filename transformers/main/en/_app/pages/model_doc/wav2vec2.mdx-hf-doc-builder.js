...
above for more information.`),A.forEach(t),this.h()},h(){m(f,"href","/docs/transformers/main/en/main_classes/feature_extractor#transformers.FeatureExtractionMixin.save_pretrained")},m(S,A){_(S,c,A),e(c,b),e(c,f),e(f,u),e(c,v),e(c,l),e(l,h),e(c,V)},d(S){S&&t(c)}}}function nT(j){let c,b,f,u,v,l,h,V,S,A,z,L,H,C;return{c(){c=a("p"),b=r(`This class method is simply calling Wav2Vec2FeatureExtractor\u2019s
...
`),S=a("code"),A=r("pyctcdecode.BeamSearchDecoderCTC.load_from_hf_hub"),z=r("."),L=d(),H=a("p"),C=r("Please refer to the docstrings of the methods above for more information."),this.h()},l(N){c=s(N,"P",{});var P=n(c);b=i(P,`This class method is simply calling Wav2Vec2FeatureExtractor\u2019s
...
`),S=s(P,"CODE",{});var I=n(S);A=i(I,"pyctcdecode.BeamSearchDecoderCTC.load_from_hf_hub"),I.forEach(t),z=i(P,"."),P.forEach(t),L=p(N),H=s(N,"P",{});var Me=n(H);C=i(Me,"Please refer to the docstrings of the methods above for more information."),Me.forEach(t),this.h()},h(){m(f,"href","/docs/transformers/main/en/main_classes/feature_extractor#transformers.FeatureExtractionMixin.from_pretrained")},m(N,P){_(N,c,P),e(c,b),e(c,f),e(f,u),e(c,v),e(c,l),e(l,h),e(c,V),e(c,S),e(S,A),e(c,z),_(N,L,P),_(N,H,P),e(H,C)},d(N){N&&t(c),N&&t(L),N&&t(H)}}}function rT(j){let c,b;return{c(){c=a("p"),b=r("This function makes use of Python\u2019s multiprocessing.")},l(f){c=s(f,"P",{});var u=n(c);b=i(u,"This function makes use of Python\u2019s multiprocessing."),u.forEach(t)},m(f,u){_(f,c,u),e(c,b)},d(f){f&&t(c)}}}function iT(j){let c,b,f,u,v;return u=new be({props:{code:`# Let's see how to retrieve time steps for a model
...
<span class="hljs-meta">... </span>).loss`}}),{c(){c=a("p"),b=r("Example:"),f=d(),w(u.$$.fragment)},l(l){c=s(l,"P",{});var h=n(c);b=i(h,"Example:"),h.forEach(t),f=p(l),y(u.$$.fragment,l)},m(l,h){_(l,c,h),e(c,b),_(l,f,h),k(u,l,h),v=!0},p:ve,i(l){v||(T(u.$$.fragment,l),v=!0)},o(l){$(u.$$.fragment,l),v=!1},d(l){l&&t(c),l&&t(f),x(u,l)}}}function kT(j){let c,b,f,u,v,l,h,V,S,A,z,L,H,C,N,P,ze,we,I,Me,ye,ke,vt,Ke,ae,bt,Ge,se,Ue,wt,Ae,M,R,Je,J,He,yt,Te,$e,kt,D,Tt,xe,Ze,he,We,je,$t,ie,Qe,X,fe,Ve,O,xt,K,Wt,Ye;return{c(){c=a("p"),b=r("TensorFlow models and layers in "),f=a("code"),u=r("transformers"),v=r(" accept two formats as input:"),l=d(),h=a("ul"),V=a("li"),S=r("having all inputs as keyword arguments (like PyTorch models), or"),A=d(),z=a("li"),L=r("having all inputs as a list, tuple or dict in the first positional argument."),H=d(),C=a("p"),N=r(`The reason the second format is supported is that Keras methods prefer this format when passing inputs to models
...
pass your inputs and labels in any format that `),I=s(q,"CODE",{});var Re=n(I);Me=i(Re,"model.fit()"),Re.forEach(t),ye=i(q,` supports! If, however, you want to use the second
...
<span class="hljs-meta">&gt;&gt;&gt; </span>hidden_states = model(input_values).last_hidden_state`}}),{c(){c=a("p"),b=r("Example:"),f=d(),w(u.$$.fragment)},l(l){c=s(l,"P",{});var h=n(c);b=i(h,"Example:"),h.forEach(t),f=p(l),y(u.$$.fragment,l)},m(l,h){_(l,c,h),e(c,b),_(l,f,h),k(u,l,h),v=!0},p:ve,i(l){v||(T(u.$$.fragment,l),v=!0)},o(l){$(u.$$.fragment,l),v=!1},d(l){l&&t(c),l&&t(f),x(u,l)}}}function xT(j){let c,b,f,u,v,l,h,V,S,A,z,L,H,C,N,P,ze,we,I,Me,ye,ke,vt,Ke,ae,bt,Ge,se,Ue,wt,Ae,M,R,Je,J,He,yt,Te,$e,kt,D,Tt,xe,Ze,he,We,je,$t,ie,Qe,X,fe,Ve,O,xt,K,Wt,Ye;return{c(){c=a("p"),b=r("TensorFlow models and layers in "),f=a("code"),u=r("transformers"),v=r(" accept two formats as input:"),l=d(),h=a("ul"),V=a("li"),S=r("having all inputs as keyword arguments (like PyTorch models), or"),A=d(),z=a("li"),L=r("having all inputs as a list, tuple or dict in the first positional argument."),H=d(),C=a("p"),N=r(`The reason the second format is supported is that Keras methods prefer this format when passing inputs to models
and layers. Because of this support, when using methods like `),P=a("code"),ze=r("model.fit()"),we=r(` things should \u201Cjust work\u201D for you - just
pass your inputs and labels in any format that `),I=a("code"),Me=r("model.fit()"),ye=r(` supports! If, however, you want to use the second
format outside of Keras methods like `),ke=a("code"),vt=r("fit()"),Ke=r(" and "),ae=a("code"),bt=r("predict()"),Ge=r(`, such as when creating your own layers or models with
the Keras `),se=a("code"),Ue=r("Functional"),wt=r(` API, there are three possibilities you can use to gather all the input Tensors in the first
...
`),X=s(jt,"CODE",{});var ao=n(X);fe=i(ao,'model({"input_values": input_values, "token_type_ids": token_type_ids})'),ao.forEach(t),jt.forEach(t),B.forEach(t),Ve=p(W),O=s(W,"P",{});var ne=n(O);xt=i(ne,`Note that when creating models and layers with
`),K=s(ne,"A",{href:!0,rel:!0});var Dt=n(K);Wt=i(Dt,"subclassing"),Dt.forEach(t),Ye=i(ne,` then you don\u2019t need to worry
about any of this, as you can just pass inputs like you would to any other Python function!`),ne.forEach(t),this.h()},h(){m(K,"href","https://keras.io/guides/making_new_layers_and_models_via_subclassing/"),m(K,"rel","nofollow")},m(W,E){_(W,c,E),e(c,b),e(c,f),e(f,u),e(c,v),_(W,l,E),_(W,h,E),e(h,V),e(V,S),e(h,A),e(h,z),e(z,L),_(W,H,E),_(W,C,E),e(C,N),e(C,P),e(P,ze),e(C,we),e(C,I),e(I,Me),e(C,ye),e(C,ke),e(ke,vt),e(C,Ke),e(C,ae),e(ae,bt),e(C,Ge),e(C,se),e(se,Ue),e(C,wt),_(W,Ae,E),_(W,M,E),e(M,R),e(R,Je),e(R,J),e(J,He),e(R,yt),e(R,Te),e(Te,$e),e(M,kt),e(M,D),e(D,Tt),e(D,xe),e(xe,Ze),e(D,he),e(D,We),e(We,je),e(M,$t),e(M,ie),e(ie,Qe),e(ie,X),e(X,fe),_(W,Ve,E),_(W,O,E),e(O,xt),e(O,K),e(K,Wt),e(O,Ye)},d(W){W&&t(c),W&&t(l),W&&t(h),W&&t(H),W&&t(C),W&&t(Ae),W&&t(M),W&&t(Ve),W&&t(O)}}}function WT(j){let c,b,f,u,v;return{c(){c=a("p"),b=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=a("code"),u=r("Module"),v=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(l){c=s(l,"P",{});var h=n(c);b=i(h,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=s(h,"CODE",{});var V=n(f);u=i(V,"Module"),V.forEach(t),v=i(h,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-comment"># show that cosine similarity is much higher than random</span>
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-keyword">assert</span> np.asarray(cosine_sim)[mask_time_indices].mean() &gt; <span class="hljs-number">0.5</span>`}}),{c(){c=a("p"),b=r("Example:"),f=d(),w(u.$$.fragment)},l(l){c=s(l,"P",{});var h=n(c);b=i(h,"Example:"),h.forEach(t),f=p(l),y(u.$$.fragment,l)},m(l,h){_(l,c,h),e(c,b),_(l,f,h),k(u,l,h),v=!0},p:ve,i(l){v||(T(u.$$.fragment,l),v=!0)},o(l){$(u.$$.fragment,l),v=!1},d(l){l&&t(c),l&&t(f),x(u,l)}}}function zT(j){let c,b,f,u,v,l,h,V,S,A,z,L,H,C,N,P,ze,we,I,Me,ye,ke,vt,Ke,ae,bt,Ge,se,Ue,wt,Ae,M,R,Je,J,He,yt,Te,$e,kt,D,Tt,xe,Ze,he,We,je,$t,ie,Qe,X,fe,Ve,O,xt,K,Wt,Ye,W,E,Gt,Z,Jt,et,q,Zt,Re,Qt,Yt,eo,B,Fe,tt,to,Ce,ot,oo,jt,ao,ne,Dt,so,No,al,cs,im,sl,lm,pd,Q,ds,cm,nl,dm,pm,ps,mm,Qr,hm,fm,um,Io,ms,gm,rl,_m,vm,Yr,hs,bm,at,fs,wm,il,ym,km,us,Tm,ll,$m,xm,Wm,Bo,jm,Uo,gs,Vm,cl,Fm,md,no,Ho,dl,_s,Cm,pl,Em,hd,Xe,vs,Pm,ml,qm,zm,bs,Mm,ei,Am,Om,Lm,Ro,ws,Dm,hl,Sm,fd,ro,Xo,fl,ys,Nm,ul,Im,ud,U,ks,Bm,gl,Um,Hm,Oe,ti,Rm,Xm,oi,Km,Gm,ai,Jm,Zm,Ts,_l,Qm,Ym,eh,si,th,oh,ah,Ko,$s,sh,Vt,nh,xs,vl,rh,ih,lh,bl,ch,dh,Ws,wl,ph,mh,hh,fh,Go,js,uh,Ft,gh,ni,_h,vh,yl,bh,wh,ri,yh,kh,Th,ii,Vs,$h,St,Fs,xh,Cs,Wh,li,jh,Vh,Fh,Jo,Ch,Zo,Es,Eh,Ps,Ph,ci,qh,zh,Mh,Qo,qs,Ah,zs,Oh,di,Lh,Dh,gd,io,Yo,kl,Ms,Sh,Tl,Nh,_d,G,As,Ih,$l,Bh,Uh,ea,Os,Hh,Ct,Rh,Ls,xl,Xh,Kh,Gh,Wl,Jh,Zh,Ds,jl,Qh,Yh,ef,tf,ta,Ss,of,Et,af,pi,sf,nf,Vl,rf,lf,mi,cf,df,pf,Nt,Ns,mf,Is,hf,hi,ff,uf,gf,oa,_f,fi,Bs,vf,It,Us,bf,Fl,wf,yf,aa,kf,Bt,Hs,Tf,Cl,$f,xf,sa,vd,lo,na,El,Rs,Wf,Pl,jf,bd,co,Xs,Vf,Ks,Ff,ql,Cf,Ef,wd,po,Gs,Pf,zl,qf,yd,mo,Js,zf,Zs,Mf,ui,Af,Of,kd,Pt,Qs,Lf,Ys,Df,Ml,Sf,Nf,If,ra,en,Bf,Al,Uf,Td,qt,tn,Hf,on,Rf,Ol,Xf,Kf,Gf,ia,an,Jf,Ll,Zf,$d,ho,la,Dl,sn,Qf,Sl,Yf,xd,Ee,nn,eu,rn,tu,ln,ou,au,su,cn,nu,gi,ru,iu,lu,dn,cu,pn,du,pu,mu,st,mn,hu,fo,fu,_i,uu,gu,Nl,_u,vu,bu,ca,wu,da,Wd,uo,pa,Il,hn,yu,Bl,ku,jd,Pe,fn,Tu,go,$u,Ul,xu,Wu,un,ju,Vu,Fu,gn,Cu,vi,Eu,Pu,qu,_n,zu,vn,Mu,Au,Ou,Le,bn,Lu,_o,Du,bi,Su,Nu,Hl,Iu,Bu,Uu,ma,Hu,ha,Ru,fa,Vd,vo,ua,Rl,wn,Xu,Xl,Ku,Fd,le,yn,Gu,Kl,Ju,Zu,kn,Qu,Tn,Yu,eg,tg,$n,og,wi,ag,sg,ng,xn,rg,Wn,ig,lg,cg,De,jn,dg,bo,pg,yi,mg,hg,Gl,fg,ug,gg,ga,_g,_a,vg,va,Cd,wo,ba,Jl,Vn,bg,Zl,wg,Ed,ce,Fn,yg,Ql,kg,Tg,Cn,$g,En,xg,Wg,jg,Pn,Vg,ki,Fg,Cg,Eg,qn,Pg,zn,qg,zg,Mg,nt,Mn,Ag,yo,Og,Ti,Lg,Dg,Yl,Sg,Ng,Ig,wa,Bg,ya,Pd,ko,ka,ec,An,Ug,tc,Hg,qd,de,On,Rg,oc,Xg,Kg,Ln,Gg,Dn,Jg,Zg,Qg,Sn,Yg,$i,e_,t_,o_,Nn,a_,In,s_,n_,r_,rt,Bn,i_,To,l_,xi,c_,d_,ac,p_,m_,h_,Ta,f_,$a,zd,$o,xa,sc,Un,u_,nc,g_,Md,qe,Hn,__,xo,v_,rc,b_,w_,Rn,y_,k_,T_,Xn,$_,Wi,x_,W_,j_,Kn,V_,Gn,F_,C_,E_,it,Jn,P_,Wo,q_,ji,z_,M_,ic,A_,O_,L_,Wa,D_,ja,Ad,jo,Va,lc,Zn,S_,cc,N_,Od,pe,Qn,I_,dc,B_,U_,Yn,H_,Vi,R_,X_,K_,er,G_,tr,J_,Z_,Q_,Fa,Y_,lt,or,ev,Vo,tv,Fi,ov,av,pc,sv,nv,rv,Ca,iv,Ea,Ld,Fo,Pa,mc,ar,lv,hc,cv,Dd,me,sr,dv,nr,pv,fc,mv,hv,fv,rr,uv,Ci,gv,_v,vv,ir,bv,lr,wv,yv,kv,qa,Tv,ct,cr,$v,Co,xv,Ei,Wv,jv,uc,Vv,Fv,Cv,za,Ev,Ma,Sd,Eo,Aa,gc,dr,Pv,_c,qv,Nd,Y,pr,zv,mr,Mv,hr,Av,Ov,Lv,fr,Dv,Pi,Sv,Nv,Iv,ur,Bv,gr,Uv,Hv,Rv,vc,Xv,Kv,zt,bc,_r,Gv,Jv,wc,vr,Zv,Qv,yc,br,Yv,e2,kc,wr,t2,o2,dt,yr,a2,Po,s2,Tc,n2,r2,$c,i2,l2,c2,Oa,d2,La,Id,qo,Da,xc,kr,p2,Wc,m2,Bd,ee,Tr,h2,zo,f2,jc,u2,g2,$r,_2,v2,b2,xr,w2,qi,y2,k2,T2,Wr,$2,jr,x2,W2,j2,Vc,V2,F2,Mt,Fc,Vr,C2,E2,Cc,Fr,P2,q2,Ec,Cr,z2,M2,Pc,Er,A2,O2,pt,Pr,L2,Mo,D2,qc,S2,N2,zc,I2,B2,U2,Sa,H2,Na,Ud,Ao,Ia,Mc,qr,R2,Ac,X2,Hd,te,zr,K2,Oo,G2,Oc,J2,Z2,Mr,Q2,Y2,eb,Ar,tb,zi,ob,ab,sb,Or,nb,Lr,rb,ib,lb,Lc,cb,db,At,Dc,Dr,pb,mb,Sc,Sr,hb,fb,Nc,Nr,ub,gb,Ic,Ir,_b,vb,mt,Br,bb,Lo,wb,Mi,yb,kb,Bc,Tb,$b,xb,Ba,Wb,Ua,Rd;return l=new oe({}),C=new oe({}),O=new oe({}),E=new F({props:{name:"class transformers.Wav2Vec2Config",anchor:"transformers.Wav2Vec2Config",parameters:[{name:"vocab_size",val:" = 32"},{name:"hidden_size",val:" = 768"},{name:"num_hidden_layers",val:" = 12"},{name:"num_attention_heads",val:" = 12"},{name:"intermediate_size",val:" = 3072"},{name:"hidden_act",val:" = 'gelu'"},{name:"hidden_dropout",val:" = 0.1"},{name:"activation_dropout",val:" = 0.1"},{name:"attention_dropout",val:" = 0.1"},{name:"feat_proj_dropout",val:" = 0.0"},{name:"feat_quantizer_dropout",val:" = 0.0"},{name:"final_dropout",val:" = 0.1"},{name:"layerdrop",val:" = 0.1"},{name:"initializer_range",val:" = 0.02"},{name:"layer_norm_eps",val:" = 1e-05"},{name:"feat_extract_norm",val:" = 'group'"},{name:"feat_extract_activation",val:" = 'gelu'"},{name:"conv_dim",val:" = (512, 512, 512, 512, 512, 512, 512)"},{name:"conv_stride",val:" = (5, 2, 2, 2, 2, 2, 2)"},{name:"conv_kernel",val:" = (10, 3, 3, 3, 3, 2, 2)"},{name:"conv_bias",val:" = False"},{name:"num_conv_pos_embeddings",val:" = 128"},{name:"num_conv_pos_embedding_groups",val:" = 16"},{name:"do_stable_layer_norm",val:" = False"},{name:"apply_spec_augment",val:" = True"},{name:"mask_time_prob",val:" = 0.05"},{name:"mask_time_length",val:" = 10"},{name:"mask_time_min_masks",val:" = 2"},{name:"mask_feature_prob",val:" = 0.0"},{name:"mask_feature_length",val:" = 10"},{name:"mask_feature_min_masks",val:" = 0"},{name:"num_codevectors_per_group",val:" = 320"},{name:"num_codevector_groups",val:" = 2"},{name:"contrastive_logits_temperature",val:" = 0.1"},{name:"num_negatives",val:" = 100"},{name:"codevector_dim",val:" = 256"},{name:"proj_codevector_dim",val:" = 256"},{name:"diversity_loss_weight",val:" = 0.1"},{name:"ctc_loss_reduction",val:" = 'sum'"},{name:"ctc_zero_infinity",val:" = False"},{name:"use_weighted_layer_sum",val:" = False"},{name:"classifier_proj_size",val:" = 256"},{name:"tdnn_dim",val:" = (512, 512, 512, 512, 1500)"},{name:"tdnn_kernel",val:" = (5, 3, 3, 1, 1)"},{name:"tdnn_dilation",val:" = (1, 2, 3, 1, 1)"},{name:"xvector_output_dim",val:" = 512"},{name:"pad_token_id",val:" = 0"},{name:"bos_token_id",val:" = 1"},{name:"eos_token_id",val:" = 2"},{name:"add_adapter",val:" = False"},{name:"adapter_kernel_size",val:" = 3"},{name:"adapter_stride",val:" = 2"},{name:"num_adapter_layers",val:" = 3"},{name:"output_hidden_size",val:" = None"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.Wav2Vec2Config.vocab_size",description:`<strong>vocab_size</strong> (<code>int</code>, <em>optional</em>, defaults to 32) &#x2014;
...
`}}),Ta=new ge({props:{$$slots:{default:[vT]},$$scope:{ctx:j}}}),$a=new _e({props:{anchor:"transformers.Wav2Vec2ForXVector.forward.example",$$slots:{default:[bT]},$$scope:{ctx:j}}}),Un=new oe({}),Hn=new F({props:{name:"class transformers.Wav2Vec2ForPreTraining",anchor:"transformers.Wav2Vec2ForPreTraining",parameters:[{name:"config",val:": Wav2Vec2Config"}],parametersDescription:[{anchor:"transformers.Wav2Vec2ForPreTraining.config",description:`<strong>config</strong> (<a href="/docs/transformers/main/en/model_doc/wav2vec2#transformers.Wav2Vec2Config">Wav2Vec2Config</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
...
`}}),Ba=new ge({props:{$$slots:{default:[PT]},$$scope:{ctx:j}}}),Ua=new _e({props:{anchor:"transformers.FlaxWav2Vec2ForPreTraining.__call__.example",$$slots:{default:[qT]},$$scope:{ctx:j}}}),{c(){c=a("meta"),b=d(),f=a("h1"),u=a("a"),v=a("span"),w(l.$$.fragment),h=d(),V=a("span"),S=r("Wav2Vec2"),A=d(),z=a("h2"),L=a("a"),H=a("span"),w(C.$$.fragment),N=d(),P=a("span"),ze=r("Overview"),we=d(),I=a("p"),Me=r("The Wav2Vec2 model was proposed in "),ye=a("a"),ke=r("wav2vec 2.0: A Framework for Self-Supervised Learning of Speech Representations"),vt=r(" by Alexei Baevski, Henry Zhou, Abdelrahman Mohamed, Michael Auli."),Ke=d(),ae=a("p"),bt=r("The abstract from the paper is the following:"),Ge=d(),se=a("p"),Ue=a("em"),wt=r(`We show for the first time that learning powerful representations from speech audio alone followed by fine-tuning on
...
for more information.`),pf=d(),Nt=a("div"),w(Ns.$$.fragment),mf=d(),Is=a("p"),hf=r("Instantiate a "),hi=a("a"),ff=r("Wav2Vec2ProcessorWithLM"),uf=r(" from a pretrained Wav2Vec2 processor."),gf=d(),w(oa.$$.fragment),_f=d(),fi=a("div"),w(Bs.$$.fragment),vf=d(),It=a("div"),w(Us.$$.fragment),bf=d(),Fl=a("p"),wf=r("Batch decode output logits to audio transcription with language model support."),yf=d(),w(aa.$$.fragment),kf=d(),Bt=a("div"),w(Hs.$$.fragment),Tf=d(),Cl=a("p"),$f=r("Decode output logits to audio transcription with language model support."),xf=d(),w(sa.$$.fragment),vd=d(),lo=a("h2"),na=a("a"),El=a("span"),w(Rs.$$.fragment),Wf=d(),Pl=a("span"),jf=r("Wav2Vec2 specific outputs"),bd=d(),co=a("div"),w(Xs.$$.fragment),Vf=d(),Ks=a("p"),Ff=r("Output type of "),ql=a("code"),Cf=r("Wav2Vec2DecoderWithLM"),Ef=r(", with transcription."),wd=d(),po=a("div"),w(Gs.$$.fragment),Pf=d(),zl=a("p"),qf=r("Base class for models that have been trained with the Wav2Vec2 loss objective."),yd=d(),mo=a("div"),w(Js.$$.fragment),zf=d(),Zs=a("p"),Mf=r("Output type of "),ui=a("a"),Af=r("Wav2Vec2ForPreTraining"),Of=r(", with potential hidden states and attentions."),kd=d(),Pt=a("div"),w(Qs.$$.fragment),Lf=d(),Ys=a("p"),Df=r("Output type of "),Ml=a("code"),Sf=r("FlaxWav2Vec2BaseModelOutput"),Nf=r(", with potential hidden states and attentions."),If=d(),ra=a("div"),w(en.$$.fragment),Bf=d(),Al=a("p"),Uf=r("\u201CReturns a new object replacing the specified fields with new values."),Td=d(),qt=a("div"),w(tn.$$.fragment),Hf=d(),on=a("p"),Rf=r("Output type of "),Ol=a("code"),Xf=r("FlaxWav2Vec2ForPreTrainingOutput"),Kf=r(", with potential hidden states and attentions."),Gf=d(),ia=a("div"),w(an.$$.fragment),Jf=d(),Ll=a("p"),Zf=r("\u201CReturns a new object replacing the specified fields with new values."),$d=d(),ho=a("h2"),la=a("a"),Dl=a("span"),w(sn.$$.fragment),Qf=d(),Sl=a("span"),Yf=r("Wav2Vec2Model"),xd=d(),Ee=a("div"),w(nn.$$.fragment),eu=d(),rn=a("p"),tu=r(`The bare Wav2Vec2 Model transformer outputting raw hidden-states without any specific head on top.
...
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),Mg=d(),nt=a("div"),w(Mn.$$.fragment),Ag=d(),yo=a("p"),Og=r("The "),Ti=a("a"),Lg=r("Wav2Vec2ForAudioFrameClassification"),Dg=r(" forward method, overrides the "),Yl=a("code"),Sg=r("__call__"),Ng=r(" special method."),Ig=d(),w(wa.$$.fragment),Bg=d(),w(ya.$$.fragment),Pd=d(),ko=a("h2"),ka=a("a"),ec=a("span"),w(An.$$.fragment),Ug=d(),tc=a("span"),Hg=r("Wav2Vec2ForXVector"),qd=d(),de=a("div"),w(On.$$.fragment),Rg=d(),oc=a("p"),Xg=r("Wav2Vec2 Model with an XVector feature extraction head on top for tasks like Speaker Verification."),Kg=d(),Ln=a("p"),Gg=r("Wav2Vec2 was proposed in "),Dn=a("a"),Jg=r(`wav2vec 2.0: A Framework for Self-Supervised Learning of Speech
...
tokens and clean up tokenization spaces.`),Db.forEach(t),km=p(Ha),us=s(Ha,"P",{});var Gd=n(us);Tm=i(Gd,"Similar to doing "),ll=s(Gd,"CODE",{});var Sb=n(ll);$m=i(Sb,"self.convert_tokens_to_string(self.convert_ids_to_tokens(token_ids))"),Sb.forEach(t),xm=i(Gd,"."),Gd.forEach(t),Wm=p(Ha),y(Bo.$$.fragment,Ha),Ha.forEach(t),jm=p(Se),Uo=s(Se,"DIV",{class:!0});var Jd=n(Uo);y(gs.$$.fragment,Jd),Vm=p(Jd),cl=s(Jd,"P",{});var Nb=n(cl);Fm=i(Nb,"Convert a list of lists of token ids into a list of strings by calling decode."),Nb.forEach(t),Jd.forEach(t),Se.forEach(t),md=p(o),no=s(o,"H2",{class:!0});var Zd=n(no);Ho=s(Zd,"A",{id:!0,class:!0,href:!0});var Ib=n(Ho);dl=s(Ib,"SPAN",{});var Bb=n(dl);y(_s.$$.fragment,Bb),Bb.forEach(t),Ib.forEach(t),Cm=p(Zd),pl=s(Zd,"SPAN",{});var Ub=n(pl);Em=i(Ub,"Wav2Vec2FeatureExtractor"),Ub.forEach(t),Zd.forEach(t),hd=p(o),Xe=s(o,"DIV",{class:!0});var Ra=n(Xe);y(vs.$$.fragment,Ra),Pm=p(Ra),ml=s(Ra,"P",{});var Hb=n(ml);qm=i(Hb,"Constructs a Wav2Vec2 feature extractor."),Hb.forEach(t),zm=p(Ra),bs=s(Ra,"P",{});var Qd=n(bs);Mm=i(Qd,"This feature extractor inherits from "),ei=s(Qd,"A",{href:!0});var Rb=n(ei);Am=i(Rb,"SequenceFeatureExtractor"),Rb.forEach(t),Om=i(Qd,` which contains
most of the main methods. Users should refer to this superclass for more information regarding those methods.`),Qd.forEach(t),Lm=p(Ra),Ro=s(Ra,"DIV",{class:!0});var Yd=n(Ro);y(ws.$$.fragment,Yd),Dm=p(Yd),hl=s(Yd,"P",{});var Xb=n(hl);Sm=i(Xb,"Main method to featurize and prepare for the model one or several sequence(s)."),Xb.forEach(t),Yd.forEach(t),Ra.forEach(t),fd=p(o),ro=s(o,"H2",{class:!0});var ep=n(ro);Xo=s(ep,"A",{id:!0,class:!0,href:!0});var Kb=n(Xo);fl=s(Kb,"SPAN",{});var Gb=n(fl);y(ys.$$.fragment,Gb),Gb.forEach(t),Kb.forEach(t),Nm=p(ep),ul=s(ep,"SPAN",{});var Jb=n(ul);Im=i(Jb,"Wav2Vec2Processor"),Jb.forEach(t),ep.forEach(t),ud=p(o),U=s(o,"DIV",{class:!0});var re=n(U);y(ks.$$.fragment,re),Bm=p(re),gl=s(re,"P",{});var Zb=n(gl);Um=i(Zb,`Constructs a Wav2Vec2 processor which wraps a Wav2Vec2 feature extractor and a Wav2Vec2 CTC tokenizer into a single
...
Auli.`),Bi.forEach(t),Fu=p(Ht),gn=s(Ht,"P",{});var jp=n(gn);Cu=i(jp,"This model inherits from "),vi=s(jp,"A",{href:!0});var Jw=n(vi);Eu=i(Jw,"PreTrainedModel"),Jw.forEach(t),Pu=i(jp,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving etc.).`),jp.forEach(t),qu=p(Ht),_n=s(Ht,"P",{});var Vp=n(_n);zu=i(Vp,"This model is a PyTorch "),vn=s(Vp,"A",{href:!0,rel:!0});var Zw=n(vn);Mu=i(Zw,"torch.nn.Module"),Zw.forEach(t),Au=i(Vp,` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
...
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),Ap.forEach(t),Mg=p(ft),nt=s(ft,"DIV",{class:!0});var Qa=n(nt);y(Mn.$$.fragment,Qa),Ag=p(Qa),yo=s(Qa,"P",{});var Ri=n(yo);Og=i(Ri,"The "),Ti=s(Ri,"A",{href:!0});var gy=n(Ti);Lg=i(gy,"Wav2Vec2ForAudioFrameClassification"),gy.forEach(t),Dg=i(Ri," forward method, overrides the "),Yl=s(Ri,"CODE",{});var _y=n(Yl);Sg=i(_y,"__call__"),_y.forEach(t),Ng=i(Ri," special method."),Ri.forEach(t),Ig=p(Qa),y(wa.$$.fragment,Qa),Bg=p(Qa),y(ya.$$.fragment,Qa),Qa.forEach(t),ft.forEach(t),Pd=p(o),ko=s(o,"H2",{class:!0});var Op=n(ko);ka=s(Op,"A",{id:!0,class:!0,href:!0});var vy=n(ka);ec=s(vy,"SPAN",{});var by=n(ec);y(An.$$.fragment,by),by.forEach(t),vy.forEach(t),Ug=p(Op),tc=s(Op,"SPAN",{});var wy=n(tc);Hg=i(wy,"Wav2Vec2ForXVector"),wy.forEach(t),Op.forEach(t),qd=p(o),de=s(o,"DIV",{class:!0});var ut=n(de);y(On.$$.fragment,ut),Rg=p(ut),oc=s(ut,"P",{});var yy=n(oc);Xg=i(yy,"Wav2Vec2 Model with an XVector feature extraction head on top for tasks like Speaker Verification."),yy.forEach(t),Kg=p(ut),Ln=s(ut,"P",{});var Lp=n(Ln);Gg=i(Lp,"Wav2Vec2 was proposed in "),Dn=s(Lp,"A",{href:!0,rel:!0});var ky=n(Dn);Jg=i(ky,`wav2vec 2.0: A Framework for Self-Supervised Learning of Speech
