...
`),S=a("code"),A=r("pyctcdecode.BeamSearchDecoderCTC.load_from_hf_hub"),z=r("."),L=d(),R=a("p"),C=r("Please refer to the docstrings of the methods above for more information."),this.h()},l(N){c=s(N,"P",{});var q=n(c);b=i(q,`This class method is simply calling Wav2Vec2FeatureExtractor\u2019s
`),f=s(q,"A",{href:!0});var ze=n(f);u=i(ze,"from_pretrained()"),ze.forEach(t),v=i(q,`, Wav2Vec2CTCTokenizer\u2019s
`),l=s(q,"CODE",{});var we=n(l);h=i(we,"~tokenization_utils_base.PreTrainedTokenizer.from_pretrained"),we.forEach(t),V=i(q,`, and
`),S=s(q,"CODE",{});var I=n(S);A=i(I,"pyctcdecode.BeamSearchDecoderCTC.load_from_hf_hub"),I.forEach(t),z=i(q,"."),q.forEach(t),L=p(N),R=s(N,"P",{});var Me=n(R);C=i(Me,"Please refer to the docstrings of the methods above for more information."),Me.forEach(t),this.h()},h(){m(f,"href","/docs/transformers/main/en/internal/image_processing_utils#transformers.FeatureExtractionMixin.from_pretrained")},m(N,q){_(N,c,q),e(c,b),e(c,f),e(f,u),e(c,v),e(c,l),e(l,h),e(c,V),e(c,S),e(S,A),e(c,z),_(N,L,q),_(N,R,q),e(R,C)},d(N){N&&t(c),N&&t(L),N&&t(R)}}}function rT(j){let c,b;return{c(){c=a("p"),b=r("This function makes use of Python\u2019s multiprocessing.")},l(f){c=s(f,"P",{});var u=n(c);b=i(u,"This function makes use of Python\u2019s multiprocessing."),u.forEach(t)},m(f,u){_(f,c,u),e(c,b)},d(f){f&&t(c)}}}function iT(j){let c,b,f,u,v;return u=new be({props:{code:`# Let's see how to retrieve time steps for a model
...
<span class="hljs-meta">... </span>).loss`}}),{c(){c=a("p"),b=r("Example:"),f=d(),w(u.$$.fragment)},l(l){c=s(l,"P",{});var h=n(c);b=i(h,"Example:"),h.forEach(t),f=p(l),y(u.$$.fragment,l)},m(l,h){_(l,c,h),e(c,b),_(l,f,h),k(u,l,h),v=!0},p:ve,i(l){v||(T(u.$$.fragment,l),v=!0)},o(l){$(u.$$.fragment,l),v=!1},d(l){l&&t(c),l&&t(f),x(u,l)}}}function kT(j){let c,b,f,u,v,l,h,V,S,A,z,L,R,C,N,q,ze,we,I,Me,ye,ke,vt,Ke,ae,bt,Ge,se,Ue,wt,Ae,M,H,Je,J,Re,yt,Te,$e,kt,D,Tt,xe,Ze,he,We,je,$t,ie,Qe,X,fe,Ve,O,xt,K,Wt,Ye;return{c(){c=a("p"),b=r("TensorFlow models and layers in "),f=a("code"),u=r("transformers"),v=r(" accept two formats as input:"),l=d(),h=a("ul"),V=a("li"),S=r("having all inputs as keyword arguments (like PyTorch models), or"),A=d(),z=a("li"),L=r("having all inputs as a list, tuple or dict in the first positional argument."),R=d(),C=a("p"),N=r(`The reason the second format is supported is that Keras methods prefer this format when passing inputs to models
...
pass your inputs and labels in any format that `),I=s(P,"CODE",{});var He=n(I);Me=i(He,"model.fit()"),He.forEach(t),ye=i(P,` supports! If, however, you want to use the second
...
<span class="hljs-meta">&gt;&gt;&gt; </span>hidden_states = model(input_values).last_hidden_state`}}),{c(){c=a("p"),b=r("Example:"),f=d(),w(u.$$.fragment)},l(l){c=s(l,"P",{});var h=n(c);b=i(h,"Example:"),h.forEach(t),f=p(l),y(u.$$.fragment,l)},m(l,h){_(l,c,h),e(c,b),_(l,f,h),k(u,l,h),v=!0},p:ve,i(l){v||(T(u.$$.fragment,l),v=!0)},o(l){$(u.$$.fragment,l),v=!1},d(l){l&&t(c),l&&t(f),x(u,l)}}}function xT(j){let c,b,f,u,v,l,h,V,S,A,z,L,R,C,N,q,ze,we,I,Me,ye,ke,vt,Ke,ae,bt,Ge,se,Ue,wt,Ae,M,H,Je,J,Re,yt,Te,$e,kt,D,Tt,xe,Ze,he,We,je,$t,ie,Qe,X,fe,Ve,O,xt,K,Wt,Ye;return{c(){c=a("p"),b=r("TensorFlow models and layers in "),f=a("code"),u=r("transformers"),v=r(" accept two formats as input:"),l=d(),h=a("ul"),V=a("li"),S=r("having all inputs as keyword arguments (like PyTorch models), or"),A=d(),z=a("li"),L=r("having all inputs as a list, tuple or dict in the first positional argument."),R=d(),C=a("p"),N=r(`The reason the second format is supported is that Keras methods prefer this format when passing inputs to models
and layers. Because of this support, when using methods like `),q=a("code"),ze=r("model.fit()"),we=r(` things should \u201Cjust work\u201D for you - just
pass your inputs and labels in any format that `),I=a("code"),Me=r("model.fit()"),ye=r(` supports! If, however, you want to use the second
format outside of Keras methods like `),ke=a("code"),vt=r("fit()"),Ke=r(" and "),ae=a("code"),bt=r("predict()"),Ge=r(`, such as when creating your own layers or models with
the Keras `),se=a("code"),Ue=r("Functional"),wt=r(` API, there are three possibilities you can use to gather all the input Tensors in the first
...
<span class="hljs-meta">&gt;&gt;&gt; </span>transcription = processor.decode(predicted_ids[<span class="hljs-number">0</span>])
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-comment"># should give:  &quot;A MAN SAID TO THE UNIVERSE SIR I EXIST&quot;</span>`}}),{c(){c=a("p"),b=r("Example:"),f=d(),w(u.$$.fragment)},l(l){c=s(l,"P",{});var h=n(c);b=i(h,"Example:"),h.forEach(t),f=p(l),y(u.$$.fragment,l)},m(l,h){_(l,c,h),e(c,b),_(l,f,h),k(u,l,h),v=!0},p:ve,i(l){v||(T(u.$$.fragment,l),v=!0)},o(l){$(u.$$.fragment,l),v=!1},d(l){l&&t(c),l&&t(f),x(u,l)}}}function qT(j){let c,b,f,u,v;return{c(){c=a("p"),b=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=a("code"),u=r("Module"),v=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(l){c=s(l,"P",{});var h=n(c);b=i(h,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=s(h,"CODE",{});var V=n(f);u=i(V,"Module"),V.forEach(t),v=i(h,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),h.forEach(t)},m(l,h){_(l,c,h),e(c,b),e(c,f),e(f,u),e(c,v)},d(l){l&&t(c)}}}function PT(j){let c,b,f,u,v;return u=new be({props:{code:`import optax
import numpy as np
...
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-comment"># show that cosine similarity is much higher than random</span>
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-keyword">assert</span> np.asarray(cosine_sim)[mask_time_indices].mean() &gt; <span class="hljs-number">0.5</span>`}}),{c(){c=a("p"),b=r("Example:"),f=d(),w(u.$$.fragment)},l(l){c=s(l,"P",{});var h=n(c);b=i(h,"Example:"),h.forEach(t),f=p(l),y(u.$$.fragment,l)},m(l,h){_(l,c,h),e(c,b),_(l,f,h),k(u,l,h),v=!0},p:ve,i(l){v||(T(u.$$.fragment,l),v=!0)},o(l){$(u.$$.fragment,l),v=!1},d(l){l&&t(c),l&&t(f),x(u,l)}}}function zT(j){let c,b,f,u,v,l,h,V,S,A,z,L,R,C,N,q,ze,we,I,Me,ye,ke,vt,Ke,ae,bt,Ge,se,Ue,wt,Ae,M,H,Je,J,Re,yt,Te,$e,kt,D,Tt,xe,Ze,he,We,je,$t,ie,Qe,X,fe,Ve,O,xt,K,Wt,Ye,W,E,Gt,Z,Jt,et,P,Zt,He,Qt,Yt,eo,B,Fe,tt,to,Ce,ot,oo,jt,ao,ne,Dt,so,No,al,cs,im,sl,lm,pd,Q,ds,cm,nl,dm,pm,ps,mm,Qr,hm,fm,um,Io,ms,gm,rl,_m,vm,Yr,hs,bm,at,fs,wm,il,ym,km,us,Tm,ll,$m,xm,Wm,Bo,jm,Uo,gs,Vm,cl,Fm,md,no,Ro,dl,_s,Cm,pl,Em,hd,Xe,vs,qm,ml,Pm,zm,bs,Mm,ei,Am,Om,Lm,Ho,ws,Dm,hl,Sm,fd,ro,Xo,fl,ys,Nm,ul,Im,ud,U,ks,Bm,gl,Um,Rm,Oe,ti,Hm,Xm,oi,Km,Gm,ai,Jm,Zm,Ts,_l,Qm,Ym,eh,si,th,oh,ah,Ko,$s,sh,Vt,nh,xs,vl,rh,ih,lh,bl,ch,dh,Ws,wl,ph,mh,hh,fh,Go,js,uh,Ft,gh,ni,_h,vh,yl,bh,wh,ri,yh,kh,Th,ii,Vs,$h,St,Fs,xh,Cs,Wh,li,jh,Vh,Fh,Jo,Ch,Zo,Es,Eh,qs,qh,ci,Ph,zh,Mh,Qo,Ps,Ah,zs,Oh,di,Lh,Dh,gd,io,Yo,kl,Ms,Sh,Tl,Nh,_d,G,As,Ih,$l,Bh,Uh,ea,Os,Rh,Ct,Hh,Ls,xl,Xh,Kh,Gh,Wl,Jh,Zh,Ds,jl,Qh,Yh,ef,tf,ta,Ss,of,Et,af,pi,sf,nf,Vl,rf,lf,mi,cf,df,pf,Nt,Ns,mf,Is,hf,hi,ff,uf,gf,oa,_f,fi,Bs,vf,It,Us,bf,Fl,wf,yf,aa,kf,Bt,Rs,Tf,Cl,$f,xf,sa,vd,lo,na,El,Hs,Wf,ql,jf,bd,co,Xs,Vf,Ks,Ff,Pl,Cf,Ef,wd,po,Gs,qf,zl,Pf,yd,mo,Js,zf,Zs,Mf,ui,Af,Of,kd,qt,Qs,Lf,Ys,Df,Ml,Sf,Nf,If,ra,en,Bf,Al,Uf,Td,Pt,tn,Rf,on,Hf,Ol,Xf,Kf,Gf,ia,an,Jf,Ll,Zf,$d,ho,la,Dl,sn,Qf,Sl,Yf,xd,Ee,nn,eu,rn,tu,ln,ou,au,su,cn,nu,gi,ru,iu,lu,dn,cu,pn,du,pu,mu,st,mn,hu,fo,fu,_i,uu,gu,Nl,_u,vu,bu,ca,wu,da,Wd,uo,pa,Il,hn,yu,Bl,ku,jd,qe,fn,Tu,go,$u,Ul,xu,Wu,un,ju,Vu,Fu,gn,Cu,vi,Eu,qu,Pu,_n,zu,vn,Mu,Au,Ou,Le,bn,Lu,_o,Du,bi,Su,Nu,Rl,Iu,Bu,Uu,ma,Ru,ha,Hu,fa,Vd,vo,ua,Hl,wn,Xu,Xl,Ku,Fd,le,yn,Gu,Kl,Ju,Zu,kn,Qu,Tn,Yu,eg,tg,$n,og,wi,ag,sg,ng,xn,rg,Wn,ig,lg,cg,De,jn,dg,bo,pg,yi,mg,hg,Gl,fg,ug,gg,ga,_g,_a,vg,va,Cd,wo,ba,Jl,Vn,bg,Zl,wg,Ed,ce,Fn,yg,Ql,kg,Tg,Cn,$g,En,xg,Wg,jg,qn,Vg,ki,Fg,Cg,Eg,Pn,qg,zn,Pg,zg,Mg,nt,Mn,Ag,yo,Og,Ti,Lg,Dg,Yl,Sg,Ng,Ig,wa,Bg,ya,qd,ko,ka,ec,An,Ug,tc,Rg,Pd,de,On,Hg,oc,Xg,Kg,Ln,Gg,Dn,Jg,Zg,Qg,Sn,Yg,$i,e_,t_,o_,Nn,a_,In,s_,n_,r_,rt,Bn,i_,To,l_,xi,c_,d_,ac,p_,m_,h_,Ta,f_,$a,zd,$o,xa,sc,Un,u_,nc,g_,Md,Pe,Rn,__,xo,v_,rc,b_,w_,Hn,y_,k_,T_,Xn,$_,Wi,x_,W_,j_,Kn,V_,Gn,F_,C_,E_,it,Jn,q_,Wo,P_,ji,z_,M_,ic,A_,O_,L_,Wa,D_,ja,Ad,jo,Va,lc,Zn,S_,cc,N_,Od,pe,Qn,I_,dc,B_,U_,Yn,R_,Vi,H_,X_,K_,er,G_,tr,J_,Z_,Q_,Fa,Y_,lt,or,ev,Vo,tv,Fi,ov,av,pc,sv,nv,rv,Ca,iv,Ea,Ld,Fo,qa,mc,ar,lv,hc,cv,Dd,me,sr,dv,nr,pv,fc,mv,hv,fv,rr,uv,Ci,gv,_v,vv,ir,bv,lr,wv,yv,kv,Pa,Tv,ct,cr,$v,Co,xv,Ei,Wv,jv,uc,Vv,Fv,Cv,za,Ev,Ma,Sd,Eo,Aa,gc,dr,qv,_c,Pv,Nd,Y,pr,zv,mr,Mv,hr,Av,Ov,Lv,fr,Dv,qi,Sv,Nv,Iv,ur,Bv,gr,Uv,Rv,Hv,vc,Xv,Kv,zt,bc,_r,Gv,Jv,wc,vr,Zv,Qv,yc,br,Yv,e2,kc,wr,t2,o2,dt,yr,a2,qo,s2,Tc,n2,r2,$c,i2,l2,c2,Oa,d2,La,Id,Po,Da,xc,kr,p2,Wc,m2,Bd,ee,Tr,h2,zo,f2,jc,u2,g2,$r,_2,v2,b2,xr,w2,Pi,y2,k2,T2,Wr,$2,jr,x2,W2,j2,Vc,V2,F2,Mt,Fc,Vr,C2,E2,Cc,Fr,q2,P2,Ec,Cr,z2,M2,qc,Er,A2,O2,pt,qr,L2,Mo,D2,Pc,S2,N2,zc,I2,B2,U2,Sa,R2,Na,Ud,Ao,Ia,Mc,Pr,H2,Ac,X2,Rd,te,zr,K2,Oo,G2,Oc,J2,Z2,Mr,Q2,Y2,eb,Ar,tb,zi,ob,ab,sb,Or,nb,Lr,rb,ib,lb,Lc,cb,db,At,Dc,Dr,pb,mb,Sc,Sr,hb,fb,Nc,Nr,ub,gb,Ic,Ir,_b,vb,mt,Br,bb,Lo,wb,Mi,yb,kb,Bc,Tb,$b,xb,Ba,Wb,Ua,Hd;return l=new oe({}),C=new oe({}),O=new oe({}),E=new F({props:{name:"class transformers.Wav2Vec2Config",anchor:"transformers.Wav2Vec2Config",parameters:[{name:"vocab_size",val:" = 32"},{name:"hidden_size",val:" = 768"},{name:"num_hidden_layers",val:" = 12"},{name:"num_attention_heads",val:" = 12"},{name:"intermediate_size",val:" = 3072"},{name:"hidden_act",val:" = 'gelu'"},{name:"hidden_dropout",val:" = 0.1"},{name:"activation_dropout",val:" = 0.1"},{name:"attention_dropout",val:" = 0.1"},{name:"feat_proj_dropout",val:" = 0.0"},{name:"feat_quantizer_dropout",val:" = 0.0"},{name:"final_dropout",val:" = 0.1"},{name:"layerdrop",val:" = 0.1"},{name:"initializer_range",val:" = 0.02"},{name:"layer_norm_eps",val:" = 1e-05"},{name:"feat_extract_norm",val:" = 'group'"},{name:"feat_extract_activation",val:" = 'gelu'"},{name:"conv_dim",val:" = (512, 512, 512, 512, 512, 512, 512)"},{name:"conv_stride",val:" = (5, 2, 2, 2, 2, 2, 2)"},{name:"conv_kernel",val:" = (10, 3, 3, 3, 3, 2, 2)"},{name:"conv_bias",val:" = False"},{name:"num_conv_pos_embeddings",val:" = 128"},{name:"num_conv_pos_embedding_groups",val:" = 16"},{name:"do_stable_layer_norm",val:" = False"},{name:"apply_spec_augment",val:" = True"},{name:"mask_time_prob",val:" = 0.05"},{name:"mask_time_length",val:" = 10"},{name:"mask_time_min_masks",val:" = 2"},{name:"mask_feature_prob",val:" = 0.0"},{name:"mask_feature_length",val:" = 10"},{name:"mask_feature_min_masks",val:" = 0"},{name:"num_codevectors_per_group",val:" = 320"},{name:"num_codevector_groups",val:" = 2"},{name:"contrastive_logits_temperature",val:" = 0.1"},{name:"num_negatives",val:" = 100"},{name:"codevector_dim",val:" = 256"},{name:"proj_codevector_dim",val:" = 256"},{name:"diversity_loss_weight",val:" = 0.1"},{name:"ctc_loss_reduction",val:" = 'sum'"},{name:"ctc_zero_infinity",val:" = False"},{name:"use_weighted_layer_sum",val:" = False"},{name:"classifier_proj_size",val:" = 256"},{name:"tdnn_dim",val:" = (512, 512, 512, 512, 1500)"},{name:"tdnn_kernel",val:" = (5, 3, 3, 1, 1)"},{name:"tdnn_dilation",val:" = (1, 2, 3, 1, 1)"},{name:"xvector_output_dim",val:" = 512"},{name:"pad_token_id",val:" = 0"},{name:"bos_token_id",val:" = 1"},{name:"eos_token_id",val:" = 2"},{name:"add_adapter",val:" = False"},{name:"adapter_kernel_size",val:" = 3"},{name:"adapter_stride",val:" = 2"},{name:"num_adapter_layers",val:" = 3"},{name:"output_hidden_size",val:" = None"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.Wav2Vec2Config.vocab_size",description:`<strong>vocab_size</strong> (<code>int</code>, <em>optional</em>, defaults to 32) &#x2014;
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/main/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/wav2vec2/modeling_tf_wav2vec2.py#L1564"}}),Pa=new ge({props:{$$slots:{default:[xT]},$$scope:{ctx:j}}}),cr=new F({props:{name:"call",anchor:"transformers.TFWav2Vec2ForCTC.call",parameters:[{name:"input_values",val:": Tensor"},{name:"attention_mask",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"token_type_ids",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"position_ids",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"head_mask",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"inputs_embeds",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"labels",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"training",val:": typing.Optional[bool] = False"}],parametersDescription:[{anchor:"transformers.TFWav2Vec2ForCTC.call.input_values",description:`<strong>input_values</strong> (<code>np.ndarray</code>, <code>tf.Tensor</code>, <code>List[tf.Tensor]</code> \`<code>Dict[str, tf.Tensor]</code> or <code>Dict[str, np.ndarray]</code> and each example must have the shape <code>({0})</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/main/en/model_doc/bert#transformers.BertTokenizer">BertTokenizer</a>. See <a href="/docs/transformers/main/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
<a href="/docs/transformers/main/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> for details.</p>
...
`}}),Ba=new ge({props:{$$slots:{default:[qT]},$$scope:{ctx:j}}}),Ua=new _e({props:{anchor:"transformers.FlaxWav2Vec2ForPreTraining.__call__.example",$$slots:{default:[PT]},$$scope:{ctx:j}}}),{c(){c=a("meta"),b=d(),f=a("h1"),u=a("a"),v=a("span"),w(l.$$.fragment),h=d(),V=a("span"),S=r("Wav2Vec2"),A=d(),z=a("h2"),L=a("a"),R=a("span"),w(C.$$.fragment),N=d(),q=a("span"),ze=r("Overview"),we=d(),I=a("p"),Me=r("The Wav2Vec2 model was proposed in "),ye=a("a"),ke=r("wav2vec 2.0: A Framework for Self-Supervised Learning of Speech Representations"),vt=r(" by Alexei Baevski, Henry Zhou, Abdelrahman Mohamed, Michael Auli."),Ke=d(),ae=a("p"),bt=r("The abstract from the paper is the following:"),Ge=d(),se=a("p"),Ue=a("em"),wt=r(`We show for the first time that learning powerful representations from speech audio alone followed by fine-tuning on
...
for more information.`),pf=d(),Nt=a("div"),w(Ns.$$.fragment),mf=d(),Is=a("p"),hf=r("Instantiate a "),hi=a("a"),ff=r("Wav2Vec2ProcessorWithLM"),uf=r(" from a pretrained Wav2Vec2 processor."),gf=d(),w(oa.$$.fragment),_f=d(),fi=a("div"),w(Bs.$$.fragment),vf=d(),It=a("div"),w(Us.$$.fragment),bf=d(),Fl=a("p"),wf=r("Batch decode output logits to audio transcription with language model support."),yf=d(),w(aa.$$.fragment),kf=d(),Bt=a("div"),w(Rs.$$.fragment),Tf=d(),Cl=a("p"),$f=r("Decode output logits to audio transcription with language model support."),xf=d(),w(sa.$$.fragment),vd=d(),lo=a("h2"),na=a("a"),El=a("span"),w(Hs.$$.fragment),Wf=d(),ql=a("span"),jf=r("Wav2Vec2 specific outputs"),bd=d(),co=a("div"),w(Xs.$$.fragment),Vf=d(),Ks=a("p"),Ff=r("Output type of "),Pl=a("code"),Cf=r("Wav2Vec2DecoderWithLM"),Ef=r(", with transcription."),wd=d(),po=a("div"),w(Gs.$$.fragment),qf=d(),zl=a("p"),Pf=r("Base class for models that have been trained with the Wav2Vec2 loss objective."),yd=d(),mo=a("div"),w(Js.$$.fragment),zf=d(),Zs=a("p"),Mf=r("Output type of "),ui=a("a"),Af=r("Wav2Vec2ForPreTraining"),Of=r(", with potential hidden states and attentions."),kd=d(),qt=a("div"),w(Qs.$$.fragment),Lf=d(),Ys=a("p"),Df=r("Output type of "),Ml=a("code"),Sf=r("FlaxWav2Vec2BaseModelOutput"),Nf=r(", with potential hidden states and attentions."),If=d(),ra=a("div"),w(en.$$.fragment),Bf=d(),Al=a("p"),Uf=r("\u201CReturns a new object replacing the specified fields with new values."),Td=d(),Pt=a("div"),w(tn.$$.fragment),Rf=d(),on=a("p"),Hf=r("Output type of "),Ol=a("code"),Xf=r("FlaxWav2Vec2ForPreTrainingOutput"),Kf=r(", with potential hidden states and attentions."),Gf=d(),ia=a("div"),w(an.$$.fragment),Jf=d(),Ll=a("p"),Zf=r("\u201CReturns a new object replacing the specified fields with new values."),$d=d(),ho=a("h2"),la=a("a"),Dl=a("span"),w(sn.$$.fragment),Qf=d(),Sl=a("span"),Yf=r("Wav2Vec2Model"),xd=d(),Ee=a("div"),w(nn.$$.fragment),eu=d(),rn=a("p"),tu=r(`The bare Wav2Vec2 Model transformer outputting raw hidden-states without any specific head on top.
...
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),Mg=d(),nt=a("div"),w(Mn.$$.fragment),Ag=d(),yo=a("p"),Og=r("The "),Ti=a("a"),Lg=r("Wav2Vec2ForAudioFrameClassification"),Dg=r(" forward method, overrides the "),Yl=a("code"),Sg=r("__call__"),Ng=r(" special method."),Ig=d(),w(wa.$$.fragment),Bg=d(),w(ya.$$.fragment),qd=d(),ko=a("h2"),ka=a("a"),ec=a("span"),w(An.$$.fragment),Ug=d(),tc=a("span"),Rg=r("Wav2Vec2ForXVector"),Pd=d(),de=a("div"),w(On.$$.fragment),Hg=d(),oc=a("p"),Xg=r("Wav2Vec2 Model with an XVector feature extraction head on top for tasks like Speaker Verification."),Kg=d(),Ln=a("p"),Gg=r("Wav2Vec2 was proposed in "),Dn=a("a"),Jg=r(`wav2vec 2.0: A Framework for Self-Supervised Learning of Speech
...
behavior.`),Q_=d(),w(Fa.$$.fragment),Y_=d(),lt=a("div"),w(or.$$.fragment),ev=d(),Vo=a("p"),tv=r("The "),Fi=a("a"),ov=r("TFWav2Vec2Model"),av=r(" forward method, overrides the "),pc=a("code"),sv=r("__call__"),nv=r(" special method."),rv=d(),w(Ca.$$.fragment),iv=d(),w(Ea.$$.fragment),Ld=d(),Fo=a("h2"),qa=a("a"),mc=a("span"),w(ar.$$.fragment),lv=d(),hc=a("span"),cv=r("TFWav2Vec2ForCTC"),Dd=d(),me=a("div"),w(sr.$$.fragment),dv=d(),nr=a("p"),pv=r("TFWav2Vec2 Model with a "),fc=a("code"),mv=r("language modeling"),hv=r(" head on top for Connectionist Temporal Classification (CTC)."),fv=d(),rr=a("p"),uv=r("This model inherits from "),Ci=a("a"),gv=r("TFPreTrainedModel"),_v=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),vv=d(),ir=a("p"),bv=r("This model is also a "),lr=a("a"),wv=r("tf.keras.Model"),yv=r(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),kv=d(),w(Pa.$$.fragment),Tv=d(),ct=a("div"),w(cr.$$.fragment),$v=d(),Co=a("p"),xv=r("The "),Ei=a("a"),Wv=r("TFWav2Vec2ForCTC"),jv=r(" forward method, overrides the "),uc=a("code"),Vv=r("__call__"),Fv=r(" special method."),Cv=d(),w(za.$$.fragment),Ev=d(),w(Ma.$$.fragment),Sd=d(),Eo=a("h2"),Aa=a("a"),gc=a("span"),w(dr.$$.fragment),qv=d(),_c=a("span"),Pv=r("FlaxWav2Vec2Model"),Nd=d(),Y=a("div"),w(pr.$$.fragment),zv=d(),mr=a("p"),Mv=r(`The bare Wav2Vec2 Model transformer outputting raw hidden-states without any specific head on top.
...
Auli.`),b2=d(),xr=a("p"),w2=r("This model inherits from "),Pi=a("a"),y2=r("FlaxPreTrainedModel"),k2=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),T2=d(),Wr=a("p"),$2=r(`This model is also a Flax Linen
`),jr=a("a"),x2=r("flax.nn.Module"),W2=r(` subclass. Use it as a
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),j2=d(),Vc=a("p"),V2=r("Finally, this model supports inherent JAX features such as:"),F2=d(),Mt=a("ul"),Fc=a("li"),Vr=a("a"),C2=r("Just-In-Time (JIT) compilation"),E2=d(),Cc=a("li"),Fr=a("a"),q2=r("Automatic Differentiation"),P2=d(),Ec=a("li"),Cr=a("a"),z2=r("Vectorization"),M2=d(),qc=a("li"),Er=a("a"),A2=r("Parallelization"),O2=d(),pt=a("div"),w(qr.$$.fragment),L2=d(),Mo=a("p"),D2=r("The "),Pc=a("code"),S2=r("FlaxWav2Vec2PreTrainedModel"),N2=r(" forward method, overrides the "),zc=a("code"),I2=r("__call__"),B2=r(" special method."),U2=d(),w(Sa.$$.fragment),R2=d(),w(Na.$$.fragment),Ud=d(),Ao=a("h2"),Ia=a("a"),Mc=a("span"),w(Pr.$$.fragment),H2=d(),Ac=a("span"),X2=r("FlaxWav2Vec2ForPreTraining"),Rd=d(),te=a("div"),w(zr.$$.fragment),K2=d(),Oo=a("p"),G2=r("Wav2Vec2 Model with a quantizer and "),Oc=a("code"),J2=r("VQ"),Z2=r(` head on top.
...
tokens and clean up tokenization spaces.`),Db.forEach(t),km=p(Ra),us=s(Ra,"P",{});var Gd=n(us);Tm=i(Gd,"Similar to doing "),ll=s(Gd,"CODE",{});var Sb=n(ll);$m=i(Sb,"self.convert_tokens_to_string(self.convert_ids_to_tokens(token_ids))"),Sb.forEach(t),xm=i(Gd,"."),Gd.forEach(t),Wm=p(Ra),y(Bo.$$.fragment,Ra),Ra.forEach(t),jm=p(Se),Uo=s(Se,"DIV",{class:!0});var Jd=n(Uo);y(gs.$$.fragment,Jd),Vm=p(Jd),cl=s(Jd,"P",{});var Nb=n(cl);Fm=i(Nb,"Convert a list of lists of token ids into a list of strings by calling decode."),Nb.forEach(t),Jd.forEach(t),Se.forEach(t),md=p(o),no=s(o,"H2",{class:!0});var Zd=n(no);Ro=s(Zd,"A",{id:!0,class:!0,href:!0});var Ib=n(Ro);dl=s(Ib,"SPAN",{});var Bb=n(dl);y(_s.$$.fragment,Bb),Bb.forEach(t),Ib.forEach(t),Cm=p(Zd),pl=s(Zd,"SPAN",{});var Ub=n(pl);Em=i(Ub,"Wav2Vec2FeatureExtractor"),Ub.forEach(t),Zd.forEach(t),hd=p(o),Xe=s(o,"DIV",{class:!0});var Ha=n(Xe);y(vs.$$.fragment,Ha),qm=p(Ha),ml=s(Ha,"P",{});var Rb=n(ml);Pm=i(Rb,"Constructs a Wav2Vec2 feature extractor."),Rb.forEach(t),zm=p(Ha),bs=s(Ha,"P",{});var Qd=n(bs);Mm=i(Qd,"This feature extractor inherits from "),ei=s(Qd,"A",{href:!0});var Hb=n(ei);Am=i(Hb,"SequenceFeatureExtractor"),Hb.forEach(t),Om=i(Qd,` which contains
...
Auli.`),Bi.forEach(t),Fu=p(Rt),gn=s(Rt,"P",{});var jp=n(gn);Cu=i(jp,"This model inherits from "),vi=s(jp,"A",{href:!0});var Jw=n(vi);Eu=i(Jw,"PreTrainedModel"),Jw.forEach(t),qu=i(jp,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving etc.).`),jp.forEach(t),Pu=p(Rt),_n=s(Rt,"P",{});var Vp=n(_n);zu=i(Vp,"This model is a PyTorch "),vn=s(Vp,"A",{href:!0,rel:!0});var Zw=n(vn);Mu=i(Zw,"torch.nn.Module"),Zw.forEach(t),Au=i(Vp,` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
...
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),Ap.forEach(t),Mg=p(ft),nt=s(ft,"DIV",{class:!0});var Qa=n(nt);y(Mn.$$.fragment,Qa),Ag=p(Qa),yo=s(Qa,"P",{});var Hi=n(yo);Og=i(Hi,"The "),Ti=s(Hi,"A",{href:!0});var gy=n(Ti);Lg=i(gy,"Wav2Vec2ForAudioFrameClassification"),gy.forEach(t),Dg=i(Hi," forward method, overrides the "),Yl=s(Hi,"CODE",{});var _y=n(Yl);Sg=i(_y,"__call__"),_y.forEach(t),Ng=i(Hi," special method."),Hi.forEach(t),Ig=p(Qa),y(wa.$$.fragment,Qa),Bg=p(Qa),y(ya.$$.fragment,Qa),Qa.forEach(t),ft.forEach(t),qd=p(o),ko=s(o,"H2",{class:!0});var Op=n(ko);ka=s(Op,"A",{id:!0,class:!0,href:!0});var vy=n(ka);ec=s(vy,"SPAN",{});var by=n(ec);y(An.$$.fragment,by),by.forEach(t),vy.forEach(t),Ug=p(Op),tc=s(Op,"SPAN",{});var wy=n(tc);Rg=i(wy,"Wav2Vec2ForXVector"),wy.forEach(t),Op.forEach(t),Pd=p(o),de=s(o,"DIV",{class:!0});var ut=n(de);y(On.$$.fragment,ut),Hg=p(ut),oc=s(ut,"P",{});var yy=n(oc);Xg=i(yy,"Wav2Vec2 Model with an XVector feature extraction head on top for tasks like Speaker Verification."),yy.forEach(t),Kg=p(ut),Ln=s(ut,"P",{});var Lp=n(Ln);Gg=i(Lp,"Wav2Vec2 was proposed in "),Dn=s(Lp,"A",{href:!0,rel:!0});var ky=n(Dn);Jg=i(ky,`wav2vec 2.0: A Framework for Self-Supervised Learning of Speech
...
Auli.`),Qp.forEach(t),Lv=p(Ne),fr=s(Ne,"P",{});var Yp=n(fr);Dv=i(Yp,"This model inherits from "),qi=s(Yp,"A",{href:!0});var ok=n(qi);Sv=i(ok,"FlaxPreTrainedModel"),ok.forEach(t),Nv=i(Yp,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
Auli.`),Yi.forEach(t),b2=p(Ie),xr=s(Ie,"P",{});var om=n(xr);w2=i(om,"This model inherits from "),Pi=s(om,"A",{href:!0});var wk=n(Pi);y2=i(wk,"FlaxPreTrainedModel"),wk.forEach(t),k2=i(om,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),am.forEach(t),j2=p(Ie),Vc=s(Ie,"P",{});var kk=n(Vc);V2=i(kk,"Finally, this model supports inherent JAX features such as:"),kk.forEach(t),F2=p(Ie),Mt=s(Ie,"UL",{});var ns=n(Mt);Fc=s(ns,"LI",{});var Tk=n(Fc);Vr=s(Tk,"A",{href:!0,rel:!0});var $k=n(Vr);C2=i($k,"Just-In-Time (JIT) compilation"),$k.forEach(t),Tk.forEach(t),E2=p(ns),Cc=s(ns,"LI",{});var xk=n(Cc);Fr=s(xk,"A",{href:!0,rel:!0});var Wk=n(Fr);q2=i(Wk,"Automatic Differentiation"),Wk.forEach(t),xk.forEach(t),P2=p(ns),Ec=s(ns,"LI",{});var jk=n(Ec);Cr=s(jk,"A",{href:!0,rel:!0});var Vk=n(Cr);z2=i(Vk,"Vectorization"),Vk.forEach(t),jk.forEach(t),M2=p(ns),qc=s(ns,"LI",{});var Fk=n(qc);Er=s(Fk,"A",{href:!0,rel:!0});var Ck=n(Er);A2=i(Ck,"Parallelization"),Ck.forEach(t),Fk.forEach(t),ns.forEach(t),O2=p(Ie),pt=s(Ie,"DIV",{class:!0});var rs=n(pt);y(qr.$$.fragment,rs),L2=p(rs),Mo=s(rs,"P",{});var el=n(Mo);D2=i(el,"The "),Pc=s(el,"CODE",{});var Ek=n(Pc);S2=i(Ek,"FlaxWav2Vec2PreTrainedModel"),Ek.forEach(t),N2=i(el," forward method, overrides the "),zc=s(el,"CODE",{});var qk=n(zc);I2=i(qk,"__call__"),qk.forEach(t),B2=i(el," special method."),el.forEach(t),U2=p(rs),y(Sa.$$.fragment,rs),R2=p(rs),y(Na.$$.fragment,rs),rs.forEach(t),Ie.forEach(t),Ud=p(o),Ao=s(o,"H2",{class:!0});var sm=n(Ao);Ia=s(sm,"A",{id:!0,class:!0,href:!0});var Pk=n(Ia);Mc=s(Pk,"SPAN",{});var zk=n(Mc);y(Pr.$$.fragment,zk),zk.forEach(t),Pk.forEach(t),H2=p(sm),Ac=s(sm,"SPAN",{});var Mk=n(Ac);X2=i(Mk,"FlaxWav2Vec2ForPreTraining"),Mk.forEach(t),sm.forEach(t),Rd=p(o),te=s(o,"DIV",{class:!0});var Be=n(te);y(zr.$$.fragment,Be),K2=p(Be),Oo=s(Be,"P",{});var tl=n(Oo);G2=i(tl,"Wav2Vec2 Model with a quantizer and "),Oc=s(tl,"CODE",{});var Ak=n(Oc);J2=i(Ak,"VQ"),Ak.forEach(t),Z2=i(tl,` head on top.
