import{S as Zk,i as Qk,s as Yk,e as a,k as d,w,t as r,M as eT,c as s,d as t,m as p,a as n,x as y,h as i,b as m,G as e,g as _,y as k,q as T,o as $,B as x,v as tT,L as ve}from"../../chunks/vendor-hf-doc-builder.js";import{T as ge}from"../../chunks/Tip-hf-doc-builder.js";import{D as F}from"../../chunks/Docstring-hf-doc-builder.js";import{C as be}from"../../chunks/CodeBlock-hf-doc-builder.js";import{I as oe}from"../../chunks/IconCopyLink-hf-doc-builder.js";import{E as _e}from"../../chunks/ExampleCodeBlock-hf-doc-builder.js";function oT(j){let c,b,f,u,v;return u=new be({props:{code:`from transformers import Wav2Vec2Model, Wav2Vec2Config
...
<span class="hljs-meta">&gt;&gt;&gt; </span>configuration = model.config`}}),{c(){c=a("p"),b=r("Example:"),f=d(),w(u.$$.fragment)},l(l){c=s(l,"P",{});var h=n(c);b=i(h,"Example:"),h.forEach(t),f=p(l),y(u.$$.fragment,l)},m(l,h){_(l,c,h),e(c,b),_(l,f,h),k(u,l,h),v=!0},p:ve,i(l){v||(T(u.$$.fragment,l),v=!0)},o(l){$(u.$$.fragment,l),v=!1},d(l){l&&t(c),l&&t(f),x(u,l)}}}function aT(j){let c,b,f,u,v;return u=new be({props:{code:`# Let's see how to retrieve time steps for a model
...
`),l=s(A,"CODE",{});var L=n(l);h=i(L,"~tokenization_utils_base.PreTrainedTokenizer.save_pretrained"),L.forEach(t),V=i(A,`. Please refer to the docstrings of the methods
above for more information.`),A.forEach(t),this.h()},h(){m(f,"href","/docs/transformers/main/en/main_classes/feature_extractor#transformers.FeatureExtractionMixin.save_pretrained")},m(S,A){_(S,c,A),e(c,b),e(c,f),e(f,u),e(c,v),e(c,l),e(l,h),e(c,V)},d(S){S&&t(c)}}}function nT(j){let c,b,f,u,v,l,h,V,S,A,z,L,R,C;return{c(){c=a("p"),b=r(`This class method is simply calling Wav2Vec2FeatureExtractor\u2019s
`),f=a("a"),u=r("from_pretrained()"),v=r(`, Wav2Vec2CTCTokenizer\u2019s
`),l=a("code"),h=r("~tokenization_utils_base.PreTrainedTokenizer.from_pretrained"),V=r(`, and
`),S=a("code"),A=r("pyctcdecode.BeamSearchDecoderCTC.load_from_hf_hub"),z=r("."),L=d(),R=a("p"),C=r("Please refer to the docstrings of the methods above for more information."),this.h()},l(N){c=s(N,"P",{});var P=n(c);b=i(P,`This class method is simply calling Wav2Vec2FeatureExtractor\u2019s
`),f=s(P,"A",{href:!0});var ze=n(f);u=i(ze,"from_pretrained()"),ze.forEach(t),v=i(P,`, Wav2Vec2CTCTokenizer\u2019s
`),l=s(P,"CODE",{});var we=n(l);h=i(we,"~tokenization_utils_base.PreTrainedTokenizer.from_pretrained"),we.forEach(t),V=i(P,`, and
`),S=s(P,"CODE",{});var I=n(S);A=i(I,"pyctcdecode.BeamSearchDecoderCTC.load_from_hf_hub"),I.forEach(t),z=i(P,"."),P.forEach(t),L=p(N),R=s(N,"P",{});var Me=n(R);C=i(Me,"Please refer to the docstrings of the methods above for more information."),Me.forEach(t),this.h()},h(){m(f,"href","/docs/transformers/main/en/main_classes/feature_extractor#transformers.FeatureExtractionMixin.from_pretrained")},m(N,P){_(N,c,P),e(c,b),e(c,f),e(f,u),e(c,v),e(c,l),e(l,h),e(c,V),e(c,S),e(S,A),e(c,z),_(N,L,P),_(N,R,P),e(R,C)},d(N){N&&t(c),N&&t(L),N&&t(R)}}}function rT(j){let c,b;return{c(){c=a("p"),b=r("This function makes use of Python\u2019s multiprocessing.")},l(f){c=s(f,"P",{});var u=n(c);b=i(u,"This function makes use of Python\u2019s multiprocessing."),u.forEach(t)},m(f,u){_(f,c,u),e(c,b)},d(f){f&&t(c)}}}function iT(j){let c,b,f,u,v;return u=new be({props:{code:`# Let's see how to retrieve time steps for a model
...
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),h.forEach(t)},m(l,h){_(l,c,h),e(c,b),e(c,f),e(f,u),e(c,v)},d(l){l&&t(c)}}}function cT(j){let c,b,f,u,v;return u=new be({props:{code:`from transformers import Wav2Vec2Processor, Wav2Vec2Model
import torch
from datasets import load_dataset
...
[<span class="hljs-number">1</span>, <span class="hljs-number">292</span>, <span class="hljs-number">768</span>]`}}),{c(){c=a("p"),b=r("Example:"),f=d(),w(u.$$.fragment)},l(l){c=s(l,"P",{});var h=n(c);b=i(h,"Example:"),h.forEach(t),f=p(l),y(u.$$.fragment,l)},m(l,h){_(l,c,h),e(c,b),_(l,f,h),k(u,l,h),v=!0},p:ve,i(l){v||(T(u.$$.fragment,l),v=!0)},o(l){$(u.$$.fragment,l),v=!1},d(l){l&&t(c),l&&t(f),x(u,l)}}}function dT(j){let c,b,f,u,v;return{c(){c=a("p"),b=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=a("code"),u=r("Module"),v=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(l){c=s(l,"P",{});var h=n(c);b=i(h,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=s(h,"CODE",{});var V=n(f);u=i(V,"Module"),V.forEach(t),v=i(h,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),h.forEach(t)},m(l,h){_(l,c,h),e(c,b),e(c,f),e(f,u),e(c,v)},d(l){l&&t(c)}}}function pT(j){let c,b,f,u,v;return u=new be({props:{code:`from transformers import Wav2Vec2Processor, Wav2Vec2ForCTC
from datasets import load_dataset
import torch
...
<span class="hljs-string">&#x27;MISTER QUILTER IS THE APOSTLE OF THE MIDDLE CLASSES AND WE ARE GLAD TO WELCOME HIS GOSPEL&#x27;</span>`}}),{c(){c=a("p"),b=r("Example:"),f=d(),w(u.$$.fragment)},l(l){c=s(l,"P",{});var h=n(c);b=i(h,"Example:"),h.forEach(t),f=p(l),y(u.$$.fragment,l)},m(l,h){_(l,c,h),e(c,b),_(l,f,h),k(u,l,h),v=!0},p:ve,i(l){v||(T(u.$$.fragment,l),v=!0)},o(l){$(u.$$.fragment,l),v=!1},d(l){l&&t(c),l&&t(f),x(u,l)}}}function mT(j){let c,b;return c=new be({props:{code:`inputs["labels"] = processor(text=dataset[0]["text"], return_tensors="pt").input_ids
...
<span class="hljs-number">53.48</span>`}}),{c(){w(c.$$.fragment)},l(f){y(c.$$.fragment,f)},m(f,u){k(c,f,u),b=!0},p:ve,i(f){b||(T(c.$$.fragment,f),b=!0)},o(f){$(c.$$.fragment,f),b=!1},d(f){x(c,f)}}}function hT(j){let c,b,f,u,v;return{c(){c=a("p"),b=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=a("code"),u=r("Module"),v=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(l){c=s(l,"P",{});var h=n(c);b=i(h,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=s(h,"CODE",{});var V=n(f);u=i(V,"Module"),V.forEach(t),v=i(h,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),h.forEach(t)},m(l,h){_(l,c,h),e(c,b),e(c,f),e(f,u),e(c,v)},d(l){l&&t(c)}}}function fT(j){let c,b,f,u,v;return u=new be({props:{code:`from transformers import Wav2Vec2FeatureExtractor, Wav2Vec2ForSequenceClassification
from datasets import load_dataset
import torch
...
<span class="hljs-string">&#x27;_unknown_&#x27;</span>`}}),{c(){c=a("p"),b=r("Example:"),f=d(),w(u.$$.fragment)},l(l){c=s(l,"P",{});var h=n(c);b=i(h,"Example:"),h.forEach(t),f=p(l),y(u.$$.fragment,l)},m(l,h){_(l,c,h),e(c,b),_(l,f,h),k(u,l,h),v=!0},p:ve,i(l){v||(T(u.$$.fragment,l),v=!0)},o(l){$(u.$$.fragment,l),v=!1},d(l){l&&t(c),l&&t(f),x(u,l)}}}function uT(j){let c,b;return c=new be({props:{code:`# compute loss - target_label is e.g. "down"
...
<span class="hljs-meta">&gt;&gt;&gt; </span>loss = model(**inputs).loss
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-built_in">round</span>(loss.item(), <span class="hljs-number">2</span>)
<span class="hljs-number">6.54</span>`}}),{c(){w(c.$$.fragment)},l(f){y(c.$$.fragment,f)},m(f,u){k(c,f,u),b=!0},p:ve,i(f){b||(T(c.$$.fragment,f),b=!0)},o(f){$(c.$$.fragment,f),b=!1},d(f){x(c,f)}}}function gT(j){let c,b,f,u,v;return{c(){c=a("p"),b=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=a("code"),u=r("Module"),v=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(l){c=s(l,"P",{});var h=n(c);b=i(h,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=s(h,"CODE",{});var V=n(f);u=i(V,"Module"),V.forEach(t),v=i(h,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),h.forEach(t)},m(l,h){_(l,c,h),e(c,b),e(c,f),e(f,u),e(c,v)},d(l){l&&t(c)}}}function _T(j){let c,b,f,u,v;return u=new be({props:{code:`from transformers import Wav2Vec2FeatureExtractor, Wav2Vec2ForAudioFrameClassification
from datasets import load_dataset
import torch
...
[<span class="hljs-number">0</span>, <span class="hljs-number">0</span>]`}}),{c(){c=a("p"),b=r("Example:"),f=d(),w(u.$$.fragment)},l(l){c=s(l,"P",{});var h=n(c);b=i(h,"Example:"),h.forEach(t),f=p(l),y(u.$$.fragment,l)},m(l,h){_(l,c,h),e(c,b),_(l,f,h),k(u,l,h),v=!0},p:ve,i(l){v||(T(u.$$.fragment,l),v=!0)},o(l){$(u.$$.fragment,l),v=!1},d(l){l&&t(c),l&&t(f),x(u,l)}}}function vT(j){let c,b,f,u,v;return{c(){c=a("p"),b=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=a("code"),u=r("Module"),v=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(l){c=s(l,"P",{});var h=n(c);b=i(h,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=s(h,"CODE",{});var V=n(f);u=i(V,"Module"),V.forEach(t),v=i(h,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),h.forEach(t)},m(l,h){_(l,c,h),e(c,b),e(c,f),e(f,u),e(c,v)},d(l){l&&t(c)}}}function bT(j){let c,b,f,u,v;return u=new be({props:{code:`from transformers import Wav2Vec2FeatureExtractor, Wav2Vec2ForXVector
from datasets import load_dataset
import torch
...
<span class="hljs-number">0.98</span>`}}),{c(){c=a("p"),b=r("Example:"),f=d(),w(u.$$.fragment)},l(l){c=s(l,"P",{});var h=n(c);b=i(h,"Example:"),h.forEach(t),f=p(l),y(u.$$.fragment,l)},m(l,h){_(l,c,h),e(c,b),_(l,f,h),k(u,l,h),v=!0},p:ve,i(l){v||(T(u.$$.fragment,l),v=!0)},o(l){$(u.$$.fragment,l),v=!1},d(l){l&&t(c),l&&t(f),x(u,l)}}}function wT(j){let c,b,f,u,v;return{c(){c=a("p"),b=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=a("code"),u=r("Module"),v=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(l){c=s(l,"P",{});var h=n(c);b=i(h,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=s(h,"CODE",{});var V=n(f);u=i(V,"Module"),V.forEach(t),v=i(h,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),h.forEach(t)},m(l,h){_(l,c,h),e(c,b),e(c,f),e(f,u),e(c,v)},d(l){l&&t(c)}}}function yT(j){let c,b,f,u,v;return u=new be({props:{code:`import torch
...
<span class="hljs-meta">... </span>).loss`}}),{c(){c=a("p"),b=r("Example:"),f=d(),w(u.$$.fragment)},l(l){c=s(l,"P",{});var h=n(c);b=i(h,"Example:"),h.forEach(t),f=p(l),y(u.$$.fragment,l)},m(l,h){_(l,c,h),e(c,b),_(l,f,h),k(u,l,h),v=!0},p:ve,i(l){v||(T(u.$$.fragment,l),v=!0)},o(l){$(u.$$.fragment,l),v=!1},d(l){l&&t(c),l&&t(f),x(u,l)}}}function kT(j){let c,b,f,u,v,l,h,V,S,A,z,L,R,C,N,P,ze,we,I,Me,ye,ke,vt,Ke,ae,bt,Ge,se,Ue,wt,Ae,M,H,Je,J,Re,yt,Te,$e,kt,D,Tt,xe,Ze,he,We,je,$t,ie,Qe,X,fe,Ve,O,xt,K,Wt,Ye;return{c(){c=a("p"),b=r("TensorFlow models and layers in "),f=a("code"),u=r("transformers"),v=r(" accept two formats as input:"),l=d(),h=a("ul"),V=a("li"),S=r("having all inputs as keyword arguments (like PyTorch models), or"),A=d(),z=a("li"),L=r("having all inputs as a list, tuple or dict in the first positional argument."),R=d(),C=a("p"),N=r(`The reason the second format is supported is that Keras methods prefer this format when passing inputs to models
and layers. Because of this support, when using methods like `),P=a("code"),ze=r("model.fit()"),we=r(` things should \u201Cjust work\u201D for you - just
...
positional argument:`),Ae=d(),M=a("ul"),H=a("li"),Je=r("a single Tensor with "),J=a("code"),Re=r("input_values"),yt=r(" only and nothing else: "),Te=a("code"),$e=r("model(input_values)"),kt=d(),D=a("li"),Tt=r(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
...
about any of this, as you can just pass inputs like you would to any other Python function!`),this.h()},l(W){c=s(W,"P",{});var E=n(c);b=i(E,"TensorFlow models and layers in "),f=s(E,"CODE",{});var Gt=n(f);u=i(Gt,"transformers"),Gt.forEach(t),v=i(E," accept two formats as input:"),E.forEach(t),l=p(W),h=s(W,"UL",{});var Z=n(h);V=s(Z,"LI",{});var Jt=n(V);S=i(Jt,"having all inputs as keyword arguments (like PyTorch models), or"),Jt.forEach(t),A=p(Z),z=s(Z,"LI",{});var et=n(z);L=i(et,"having all inputs as a list, tuple or dict in the first positional argument."),et.forEach(t),Z.forEach(t),R=p(W),C=s(W,"P",{});var q=n(C);N=i(q,`The reason the second format is supported is that Keras methods prefer this format when passing inputs to models
and layers. Because of this support, when using methods like `),P=s(q,"CODE",{});var Zt=n(P);ze=i(Zt,"model.fit()"),Zt.forEach(t),we=i(q,` things should \u201Cjust work\u201D for you - just
pass your inputs and labels in any format that `),I=s(q,"CODE",{});var He=n(I);Me=i(He,"model.fit()"),He.forEach(t),ye=i(q,` supports! If, however, you want to use the second
format outside of Keras methods like `),ke=s(q,"CODE",{});var Qt=n(ke);vt=i(Qt,"fit()"),Qt.forEach(t),Ke=i(q," and "),ae=s(q,"CODE",{});var Yt=n(ae);bt=i(Yt,"predict()"),Yt.forEach(t),Ge=i(q,`, such as when creating your own layers or models with
the Keras `),se=s(q,"CODE",{});var eo=n(se);Ue=i(eo,"Functional"),eo.forEach(t),wt=i(q,` API, there are three possibilities you can use to gather all the input Tensors in the first
positional argument:`),q.forEach(t),Ae=p(W),M=s(W,"UL",{});var B=n(M);H=s(B,"LI",{});var Fe=n(H);Je=i(Fe,"a single Tensor with "),J=s(Fe,"CODE",{});var tt=n(J);Re=i(tt,"input_values"),tt.forEach(t),yt=i(Fe," only and nothing else: "),Te=s(Fe,"CODE",{});var to=n(Te);$e=i(to,"model(input_values)"),to.forEach(t),Fe.forEach(t),kt=p(B),D=s(B,"LI",{});var Ce=n(D);Tt=i(Ce,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
...
about any of this, as you can just pass inputs like you would to any other Python function!`),ne.forEach(t),this.h()},h(){m(K,"href","https://keras.io/guides/making_new_layers_and_models_via_subclassing/"),m(K,"rel","nofollow")},m(W,E){_(W,c,E),e(c,b),e(c,f),e(f,u),e(c,v),_(W,l,E),_(W,h,E),e(h,V),e(V,S),e(h,A),e(h,z),e(z,L),_(W,R,E),_(W,C,E),e(C,N),e(C,P),e(P,ze),e(C,we),e(C,I),e(I,Me),e(C,ye),e(C,ke),e(ke,vt),e(C,Ke),e(C,ae),e(ae,bt),e(C,Ge),e(C,se),e(se,Ue),e(C,wt),_(W,Ae,E),_(W,M,E),e(M,H),e(H,Je),e(H,J),e(J,Re),e(H,yt),e(H,Te),e(Te,$e),e(M,kt),e(M,D),e(D,Tt),e(D,xe),e(xe,Ze),e(D,he),e(D,We),e(We,je),e(M,$t),e(M,ie),e(ie,Qe),e(ie,X),e(X,fe),_(W,Ve,E),_(W,O,E),e(O,xt),e(O,K),e(K,Wt),e(O,Ye)},d(W){W&&t(c),W&&t(l),W&&t(h),W&&t(R),W&&t(C),W&&t(Ae),W&&t(M),W&&t(Ve),W&&t(O)}}}function TT(j){let c,b,f,u,v;return{c(){c=a("p"),b=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=a("code"),u=r("Module"),v=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(l){c=s(l,"P",{});var h=n(c);b=i(h,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=s(h,"CODE",{});var V=n(f);u=i(V,"Module"),V.forEach(t),v=i(h,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),h.forEach(t)},m(l,h){_(l,c,h),e(c,b),e(c,f),e(f,u),e(c,v)},d(l){l&&t(c)}}}function $T(j){let c,b,f,u,v;return u=new be({props:{code:`from transformers import Wav2Vec2Processor, TFWav2Vec2Model
from datasets import load_dataset
...
<span class="hljs-meta">&gt;&gt;&gt; </span>hidden_states = model(input_values).last_hidden_state`}}),{c(){c=a("p"),b=r("Example:"),f=d(),w(u.$$.fragment)},l(l){c=s(l,"P",{});var h=n(c);b=i(h,"Example:"),h.forEach(t),f=p(l),y(u.$$.fragment,l)},m(l,h){_(l,c,h),e(c,b),_(l,f,h),k(u,l,h),v=!0},p:ve,i(l){v||(T(u.$$.fragment,l),v=!0)},o(l){$(u.$$.fragment,l),v=!1},d(l){l&&t(c),l&&t(f),x(u,l)}}}function xT(j){let c,b,f,u,v,l,h,V,S,A,z,L,R,C,N,P,ze,we,I,Me,ye,ke,vt,Ke,ae,bt,Ge,se,Ue,wt,Ae,M,H,Je,J,Re,yt,Te,$e,kt,D,Tt,xe,Ze,he,We,je,$t,ie,Qe,X,fe,Ve,O,xt,K,Wt,Ye;return{c(){c=a("p"),b=r("TensorFlow models and layers in "),f=a("code"),u=r("transformers"),v=r(" accept two formats as input:"),l=d(),h=a("ul"),V=a("li"),S=r("having all inputs as keyword arguments (like PyTorch models), or"),A=d(),z=a("li"),L=r("having all inputs as a list, tuple or dict in the first positional argument."),R=d(),C=a("p"),N=r(`The reason the second format is supported is that Keras methods prefer this format when passing inputs to models
and layers. Because of this support, when using methods like `),P=a("code"),ze=r("model.fit()"),we=r(` things should \u201Cjust work\u201D for you - just
pass your inputs and labels in any format that `),I=a("code"),Me=r("model.fit()"),ye=r(` supports! If, however, you want to use the second
format outside of Keras methods like `),ke=a("code"),vt=r("fit()"),Ke=r(" and "),ae=a("code"),bt=r("predict()"),Ge=r(`, such as when creating your own layers or models with
the Keras `),se=a("code"),Ue=r("Functional"),wt=r(` API, there are three possibilities you can use to gather all the input Tensors in the first
...
`),X=s(jt,"CODE",{});var ao=n(X);fe=i(ao,'model({"input_values": input_values, "token_type_ids": token_type_ids})'),ao.forEach(t),jt.forEach(t),B.forEach(t),Ve=p(W),O=s(W,"P",{});var ne=n(O);xt=i(ne,`Note that when creating models and layers with
`),K=s(ne,"A",{href:!0,rel:!0});var Dt=n(K);Wt=i(Dt,"subclassing"),Dt.forEach(t),Ye=i(ne,` then you don\u2019t need to worry
about any of this, as you can just pass inputs like you would to any other Python function!`),ne.forEach(t),this.h()},h(){m(K,"href","https://keras.io/guides/making_new_layers_and_models_via_subclassing/"),m(K,"rel","nofollow")},m(W,E){_(W,c,E),e(c,b),e(c,f),e(f,u),e(c,v),_(W,l,E),_(W,h,E),e(h,V),e(V,S),e(h,A),e(h,z),e(z,L),_(W,R,E),_(W,C,E),e(C,N),e(C,P),e(P,ze),e(C,we),e(C,I),e(I,Me),e(C,ye),e(C,ke),e(ke,vt),e(C,Ke),e(C,ae),e(ae,bt),e(C,Ge),e(C,se),e(se,Ue),e(C,wt),_(W,Ae,E),_(W,M,E),e(M,H),e(H,Je),e(H,J),e(J,Re),e(H,yt),e(H,Te),e(Te,$e),e(M,kt),e(M,D),e(D,Tt),e(D,xe),e(xe,Ze),e(D,he),e(D,We),e(We,je),e(M,$t),e(M,ie),e(ie,Qe),e(ie,X),e(X,fe),_(W,Ve,E),_(W,O,E),e(O,xt),e(O,K),e(K,Wt),e(O,Ye)},d(W){W&&t(c),W&&t(l),W&&t(h),W&&t(R),W&&t(C),W&&t(Ae),W&&t(M),W&&t(Ve),W&&t(O)}}}function WT(j){let c,b,f,u,v;return{c(){c=a("p"),b=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=a("code"),u=r("Module"),v=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(l){c=s(l,"P",{});var h=n(c);b=i(h,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=s(h,"CODE",{});var V=n(f);u=i(V,"Module"),V.forEach(t),v=i(h,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),h.forEach(t)},m(l,h){_(l,c,h),e(c,b),e(c,f),e(f,u),e(c,v)},d(l){l&&t(c)}}}function jT(j){let c,b,f,u,v;return u=new be({props:{code:`import tensorflow as tf
...
the latter silently ignores them.`)},l(l){c=s(l,"P",{});var h=n(c);b=i(h,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=s(h,"CODE",{});var V=n(f);u=i(V,"Module"),V.forEach(t),v=i(h,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),h.forEach(t)},m(l,h){_(l,c,h),e(c,b),e(c,f),e(f,u),e(c,v)},d(l){l&&t(c)}}}function FT(j){let c,b,f,u,v;return u=new be({props:{code:`from transformers import Wav2Vec2Processor, FlaxWav2Vec2Model
from datasets import load_dataset
import soundfile as sf
...
<span class="hljs-meta">&gt;&gt;&gt; </span>hidden_states = model(input_values).last_hidden_state`}}),{c(){c=a("p"),b=r("Example:"),f=d(),w(u.$$.fragment)},l(l){c=s(l,"P",{});var h=n(c);b=i(h,"Example:"),h.forEach(t),f=p(l),y(u.$$.fragment,l)},m(l,h){_(l,c,h),e(c,b),_(l,f,h),k(u,l,h),v=!0},p:ve,i(l){v||(T(u.$$.fragment,l),v=!0)},o(l){$(u.$$.fragment,l),v=!1},d(l){l&&t(c),l&&t(f),x(u,l)}}}function CT(j){let c,b,f,u,v;return{c(){c=a("p"),b=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=a("code"),u=r("Module"),v=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(l){c=s(l,"P",{});var h=n(c);b=i(h,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=s(h,"CODE",{});var V=n(f);u=i(V,"Module"),V.forEach(t),v=i(h,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),h.forEach(t)},m(l,h){_(l,c,h),e(c,b),e(c,f),e(f,u),e(c,v)},d(l){l&&t(c)}}}function ET(j){let c,b,f,u,v;return u=new be({props:{code:`import jax.numpy as jnp
...
<span class="hljs-meta">&gt;&gt;&gt; </span>transcription = processor.decode(predicted_ids[<span class="hljs-number">0</span>])
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-comment"># should give:  &quot;A MAN SAID TO THE UNIVERSE SIR I EXIST&quot;</span>`}}),{c(){c=a("p"),b=r("Example:"),f=d(),w(u.$$.fragment)},l(l){c=s(l,"P",{});var h=n(c);b=i(h,"Example:"),h.forEach(t),f=p(l),y(u.$$.fragment,l)},m(l,h){_(l,c,h),e(c,b),_(l,f,h),k(u,l,h),v=!0},p:ve,i(l){v||(T(u.$$.fragment,l),v=!0)},o(l){$(u.$$.fragment,l),v=!1},d(l){l&&t(c),l&&t(f),x(u,l)}}}function PT(j){let c,b,f,u,v;return{c(){c=a("p"),b=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=a("code"),u=r("Module"),v=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(l){c=s(l,"P",{});var h=n(c);b=i(h,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=s(h,"CODE",{});var V=n(f);u=i(V,"Module"),V.forEach(t),v=i(h,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),h.forEach(t)},m(l,h){_(l,c,h),e(c,b),e(c,f),e(f,u),e(c,v)},d(l){l&&t(c)}}}function qT(j){let c,b,f,u,v;return u=new be({props:{code:`import optax
import numpy as np
...
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-comment"># show that cosine similarity is much higher than random</span>
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-keyword">assert</span> np.asarray(cosine_sim)[mask_time_indices].mean() &gt; <span class="hljs-number">0.5</span>`}}),{c(){c=a("p"),b=r("Example:"),f=d(),w(u.$$.fragment)},l(l){c=s(l,"P",{});var h=n(c);b=i(h,"Example:"),h.forEach(t),f=p(l),y(u.$$.fragment,l)},m(l,h){_(l,c,h),e(c,b),_(l,f,h),k(u,l,h),v=!0},p:ve,i(l){v||(T(u.$$.fragment,l),v=!0)},o(l){$(u.$$.fragment,l),v=!1},d(l){l&&t(c),l&&t(f),x(u,l)}}}function zT(j){let c,b,f,u,v,l,h,V,S,A,z,L,R,C,N,P,ze,we,I,Me,ye,ke,vt,Ke,ae,bt,Ge,se,Ue,wt,Ae,M,H,Je,J,Re,yt,Te,$e,kt,D,Tt,xe,Ze,he,We,je,$t,ie,Qe,X,fe,Ve,O,xt,K,Wt,Ye,W,E,Gt,Z,Jt,et,q,Zt,He,Qt,Yt,eo,B,Fe,tt,to,Ce,ot,oo,jt,ao,ne,Dt,so,No,al,cs,im,sl,lm,pd,Q,ds,cm,nl,dm,pm,ps,mm,Qr,hm,fm,um,Io,ms,gm,rl,_m,vm,Yr,hs,bm,at,fs,wm,il,ym,km,us,Tm,ll,$m,xm,Wm,Bo,jm,Uo,gs,Vm,cl,Fm,md,no,Ro,dl,_s,Cm,pl,Em,hd,Xe,vs,Pm,ml,qm,zm,bs,Mm,ei,Am,Om,Lm,Ho,ws,Dm,hl,Sm,fd,ro,Xo,fl,ys,Nm,ul,Im,ud,U,ks,Bm,gl,Um,Rm,Oe,ti,Hm,Xm,oi,Km,Gm,ai,Jm,Zm,Ts,_l,Qm,Ym,eh,si,th,oh,ah,Ko,$s,sh,Vt,nh,xs,vl,rh,ih,lh,bl,ch,dh,Ws,wl,ph,mh,hh,fh,Go,js,uh,Ft,gh,ni,_h,vh,yl,bh,wh,ri,yh,kh,Th,ii,Vs,$h,St,Fs,xh,Cs,Wh,li,jh,Vh,Fh,Jo,Ch,Zo,Es,Eh,Ps,Ph,ci,qh,zh,Mh,Qo,qs,Ah,zs,Oh,di,Lh,Dh,gd,io,Yo,kl,Ms,Sh,Tl,Nh,_d,G,As,Ih,$l,Bh,Uh,ea,Os,Rh,Ct,Hh,Ls,xl,Xh,Kh,Gh,Wl,Jh,Zh,Ds,jl,Qh,Yh,ef,tf,ta,Ss,of,Et,af,pi,sf,nf,Vl,rf,lf,mi,cf,df,pf,Nt,Ns,mf,Is,hf,hi,ff,uf,gf,oa,_f,fi,Bs,vf,It,Us,bf,Fl,wf,yf,aa,kf,Bt,Rs,Tf,Cl,$f,xf,sa,vd,lo,na,El,Hs,Wf,Pl,jf,bd,co,Xs,Vf,Ks,Ff,ql,Cf,Ef,wd,po,Gs,Pf,zl,qf,yd,mo,Js,zf,Zs,Mf,ui,Af,Of,kd,Pt,Qs,Lf,Ys,Df,Ml,Sf,Nf,If,ra,en,Bf,Al,Uf,Td,qt,tn,Rf,on,Hf,Ol,Xf,Kf,Gf,ia,an,Jf,Ll,Zf,$d,ho,la,Dl,sn,Qf,Sl,Yf,xd,Ee,nn,eu,rn,tu,ln,ou,au,su,cn,nu,gi,ru,iu,lu,dn,cu,pn,du,pu,mu,st,mn,hu,fo,fu,_i,uu,gu,Nl,_u,vu,bu,ca,wu,da,Wd,uo,pa,Il,hn,yu,Bl,ku,jd,Pe,fn,Tu,go,$u,Ul,xu,Wu,un,ju,Vu,Fu,gn,Cu,vi,Eu,Pu,qu,_n,zu,vn,Mu,Au,Ou,Le,bn,Lu,_o,Du,bi,Su,Nu,Rl,Iu,Bu,Uu,ma,Ru,ha,Hu,fa,Vd,vo,ua,Hl,wn,Xu,Xl,Ku,Fd,le,yn,Gu,Kl,Ju,Zu,kn,Qu,Tn,Yu,eg,tg,$n,og,wi,ag,sg,ng,xn,rg,Wn,ig,lg,cg,De,jn,dg,bo,pg,yi,mg,hg,Gl,fg,ug,gg,ga,_g,_a,vg,va,Cd,wo,ba,Jl,Vn,bg,Zl,wg,Ed,ce,Fn,yg,Ql,kg,Tg,Cn,$g,En,xg,Wg,jg,Pn,Vg,ki,Fg,Cg,Eg,qn,Pg,zn,qg,zg,Mg,nt,Mn,Ag,yo,Og,Ti,Lg,Dg,Yl,Sg,Ng,Ig,wa,Bg,ya,Pd,ko,ka,ec,An,Ug,tc,Rg,qd,de,On,Hg,oc,Xg,Kg,Ln,Gg,Dn,Jg,Zg,Qg,Sn,Yg,$i,e_,t_,o_,Nn,a_,In,s_,n_,r_,rt,Bn,i_,To,l_,xi,c_,d_,ac,p_,m_,h_,Ta,f_,$a,zd,$o,xa,sc,Un,u_,nc,g_,Md,qe,Rn,__,xo,v_,rc,b_,w_,Hn,y_,k_,T_,Xn,$_,Wi,x_,W_,j_,Kn,V_,Gn,F_,C_,E_,it,Jn,P_,Wo,q_,ji,z_,M_,ic,A_,O_,L_,Wa,D_,ja,Ad,jo,Va,lc,Zn,S_,cc,N_,Od,pe,Qn,I_,dc,B_,U_,Yn,R_,Vi,H_,X_,K_,er,G_,tr,J_,Z_,Q_,Fa,Y_,lt,or,ev,Vo,tv,Fi,ov,av,pc,sv,nv,rv,Ca,iv,Ea,Ld,Fo,Pa,mc,ar,lv,hc,cv,Dd,me,sr,dv,nr,pv,fc,mv,hv,fv,rr,uv,Ci,gv,_v,vv,ir,bv,lr,wv,yv,kv,qa,Tv,ct,cr,$v,Co,xv,Ei,Wv,jv,uc,Vv,Fv,Cv,za,Ev,Ma,Sd,Eo,Aa,gc,dr,Pv,_c,qv,Nd,Y,pr,zv,mr,Mv,hr,Av,Ov,Lv,fr,Dv,Pi,Sv,Nv,Iv,ur,Bv,gr,Uv,Rv,Hv,vc,Xv,Kv,zt,bc,_r,Gv,Jv,wc,vr,Zv,Qv,yc,br,Yv,e2,kc,wr,t2,o2,dt,yr,a2,Po,s2,Tc,n2,r2,$c,i2,l2,c2,Oa,d2,La,Id,qo,Da,xc,kr,p2,Wc,m2,Bd,ee,Tr,h2,zo,f2,jc,u2,g2,$r,_2,v2,b2,xr,w2,qi,y2,k2,T2,Wr,$2,jr,x2,W2,j2,Vc,V2,F2,Mt,Fc,Vr,C2,E2,Cc,Fr,P2,q2,Ec,Cr,z2,M2,Pc,Er,A2,O2,pt,Pr,L2,Mo,D2,qc,S2,N2,zc,I2,B2,U2,Sa,R2,Na,Ud,Ao,Ia,Mc,qr,H2,Ac,X2,Rd,te,zr,K2,Oo,G2,Oc,J2,Z2,Mr,Q2,Y2,eb,Ar,tb,zi,ob,ab,sb,Or,nb,Lr,rb,ib,lb,Lc,cb,db,At,Dc,Dr,pb,mb,Sc,Sr,hb,fb,Nc,Nr,ub,gb,Ic,Ir,_b,vb,mt,Br,bb,Lo,wb,Mi,yb,kb,Bc,Tb,$b,xb,Ba,Wb,Ua,Hd;return l=new oe({}),C=new oe({}),O=new oe({}),E=new F({props:{name:"class transformers.Wav2Vec2Config",anchor:"transformers.Wav2Vec2Config",parameters:[{name:"vocab_size",val:" = 32"},{name:"hidden_size",val:" = 768"},{name:"num_hidden_layers",val:" = 12"},{name:"num_attention_heads",val:" = 12"},{name:"intermediate_size",val:" = 3072"},{name:"hidden_act",val:" = 'gelu'"},{name:"hidden_dropout",val:" = 0.1"},{name:"activation_dropout",val:" = 0.1"},{name:"attention_dropout",val:" = 0.1"},{name:"feat_proj_dropout",val:" = 0.0"},{name:"feat_quantizer_dropout",val:" = 0.0"},{name:"final_dropout",val:" = 0.1"},{name:"layerdrop",val:" = 0.1"},{name:"initializer_range",val:" = 0.02"},{name:"layer_norm_eps",val:" = 1e-05"},{name:"feat_extract_norm",val:" = 'group'"},{name:"feat_extract_activation",val:" = 'gelu'"},{name:"conv_dim",val:" = (512, 512, 512, 512, 512, 512, 512)"},{name:"conv_stride",val:" = (5, 2, 2, 2, 2, 2, 2)"},{name:"conv_kernel",val:" = (10, 3, 3, 3, 3, 2, 2)"},{name:"conv_bias",val:" = False"},{name:"num_conv_pos_embeddings",val:" = 128"},{name:"num_conv_pos_embedding_groups",val:" = 16"},{name:"do_stable_layer_norm",val:" = False"},{name:"apply_spec_augment",val:" = True"},{name:"mask_time_prob",val:" = 0.05"},{name:"mask_time_length",val:" = 10"},{name:"mask_time_min_masks",val:" = 2"},{name:"mask_feature_prob",val:" = 0.0"},{name:"mask_feature_length",val:" = 10"},{name:"mask_feature_min_masks",val:" = 0"},{name:"num_codevectors_per_group",val:" = 320"},{name:"num_codevector_groups",val:" = 2"},{name:"contrastive_logits_temperature",val:" = 0.1"},{name:"num_negatives",val:" = 100"},{name:"codevector_dim",val:" = 256"},{name:"proj_codevector_dim",val:" = 256"},{name:"diversity_loss_weight",val:" = 0.1"},{name:"ctc_loss_reduction",val:" = 'sum'"},{name:"ctc_zero_infinity",val:" = False"},{name:"use_weighted_layer_sum",val:" = False"},{name:"classifier_proj_size",val:" = 256"},{name:"tdnn_dim",val:" = (512, 512, 512, 512, 1500)"},{name:"tdnn_kernel",val:" = (5, 3, 3, 1, 1)"},{name:"tdnn_dilation",val:" = (1, 2, 3, 1, 1)"},{name:"xvector_output_dim",val:" = 512"},{name:"pad_token_id",val:" = 0"},{name:"bos_token_id",val:" = 1"},{name:"eos_token_id",val:" = 2"},{name:"add_adapter",val:" = False"},{name:"adapter_kernel_size",val:" = 3"},{name:"adapter_stride",val:" = 2"},{name:"num_adapter_layers",val:" = 3"},{name:"output_hidden_size",val:" = None"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.Wav2Vec2Config.vocab_size",description:`<strong>vocab_size</strong> (<code>int</code>, <em>optional</em>, defaults to 32) &#x2014;
...
`}}),Bo=new _e({props:{anchor:"transformers.Wav2Vec2CTCTokenizer.decode.example",$$slots:{default:[aT]},$$scope:{ctx:j}}}),gs=new F({props:{name:"batch_decode",anchor:"transformers.Wav2Vec2CTCTokenizer.batch_decode",parameters:[{name:"sequences",val:": typing.Union[typing.List[int], typing.List[typing.List[int]], ForwardRef('np.ndarray'), ForwardRef('torch.Tensor'), ForwardRef('tf.Tensor')]"},{name:"skip_special_tokens",val:": bool = False"},{name:"clean_up_tokenization_spaces",val:": bool = True"},{name:"output_char_offsets",val:": bool = False"},{name:"output_word_offsets",val:": bool = False"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.Wav2Vec2CTCTokenizer.batch_decode.sequences",description:`<strong>sequences</strong> (<code>Union[List[int], List[List[int]], np.ndarray, torch.Tensor, tf.Tensor]</code>) &#x2014;
...
<code>~model.wav2vec2.tokenization_wav2vec2.batch_decode</code> works the same way with batched output.</p>
...
<code>sampling_rate</code> at the forward call to prevent silent errors.`,name:"sampling_rate"},{anchor:"transformers.Wav2Vec2FeatureExtractor.__call__.padding_value",description:"<strong>padding_value</strong> (<code>float</code>, defaults to 0.0) &#x2014;",name:"padding_value"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/wav2vec2/feature_extraction_wav2vec2.py#L102"}}),ys=new oe({}),ks=new F({props:{name:"class transformers.Wav2Vec2Processor",anchor:"transformers.Wav2Vec2Processor",parameters:[{name:"feature_extractor",val:""},{name:"tokenizer",val:""}],parametersDescription:[{anchor:"transformers.Wav2Vec2Processor.feature_extractor",description:`<strong>feature_extractor</strong> (<code>Wav2Vec2FeatureExtractor</code>) &#x2014;
...
An instance of <a href="/docs/transformers/main/en/main_classes/tokenizer#transformers.PreTrainedTokenizer">PreTrainedTokenizer</a>. The tokenizer is a required input.`,name:"tokenizer"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/wav2vec2/processing_wav2vec2.py#L26"}}),$s=new F({props:{name:"__call__",anchor:"transformers.Wav2Vec2Processor.__call__",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/wav2vec2/processing_wav2vec2.py#L67"}}),js=new F({props:{name:"pad",anchor:"transformers.Wav2Vec2Processor.pad",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/wav2vec2/processing_wav2vec2.py#L104"}}),Vs=new F({props:{name:"from_pretrained",anchor:"transformers.Wav2Vec2Processor.from_pretrained",parameters:[{name:"pretrained_model_name_or_path",val:""},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/wav2vec2/processing_wav2vec2.py#L48"}}),Fs=new F({props:{name:"save_pretrained",anchor:"transformers.Wav2Vec2Processor.save_pretrained",parameters:[{name:"save_directory",val:""},{name:"push_to_hub",val:": bool = False"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.Wav2Vec2Processor.save_pretrained.save_directory",description:`<strong>save_directory</strong> (<code>str</code> or <code>os.PathLike</code>) &#x2014;
...
<p>Please take a look at the Example of <code>~model.wav2vec2_with_lm.processing_wav2vec2_with_lm.decode</code> to
better understand how to make use of <code>output_word_offsets</code>.
<code>~model.wav2vec2_with_lm.processing_wav2vec2_with_lm.batch_decode</code> works the same way with batched
output.</p>
...
<p>Please take a look at the example of <code>~models.wav2vec2_with_lm.processing_wav2vec2_with_lm.decode</code> to
...
`}}),ma=new ge({props:{$$slots:{default:[dT]},$$scope:{ctx:j}}}),ha=new _e({props:{anchor:"transformers.Wav2Vec2ForCTC.forward.example",$$slots:{default:[pT]},$$scope:{ctx:j}}}),fa=new _e({props:{anchor:"transformers.Wav2Vec2ForCTC.forward.example-2",$$slots:{default:[mT]},$$scope:{ctx:j}}}),wn=new oe({}),yn=new F({props:{name:"class transformers.Wav2Vec2ForSequenceClassification",anchor:"transformers.Wav2Vec2ForSequenceClassification",parameters:[{name:"config",val:""}],parametersDescription:[{anchor:"transformers.Wav2Vec2ForSequenceClassification.config",description:`<strong>config</strong> (<a href="/docs/transformers/main/en/model_doc/wav2vec2#transformers.Wav2Vec2Config">Wav2Vec2Config</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/main/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/wav2vec2/modeling_wav2vec2.py#L1738"}}),jn=new F({props:{name:"forward",anchor:"transformers.Wav2Vec2ForSequenceClassification.forward",parameters:[{name:"input_values",val:": typing.Optional[torch.Tensor]"},{name:"attention_mask",val:": typing.Optional[torch.Tensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"labels",val:": typing.Optional[torch.Tensor] = None"}],parametersDescription:[{anchor:"transformers.Wav2Vec2ForSequenceClassification.forward.input_values",description:`<strong>input_values</strong> (<code>torch.FloatTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Float values of input raw speech waveform. Values can be obtained by loading a <em>.flac</em> or <em>.wav</em> audio file
into an array of type <em>List[float]</em> or a <em>numpy.ndarray</em>, <em>e.g.</em> via the soundfile library (<em>pip install
soundfile</em>). To prepare the array into <em>input_values</em>, the <a href="/docs/transformers/main/en/model_doc/wav2vec2#transformers.Wav2Vec2Processor">Wav2Vec2Processor</a> should be used for padding
...
`}}),wa=new ge({props:{$$slots:{default:[gT]},$$scope:{ctx:j}}}),ya=new _e({props:{anchor:"transformers.Wav2Vec2ForAudioFrameClassification.forward.example",$$slots:{default:[_T]},$$scope:{ctx:j}}}),An=new oe({}),On=new F({props:{name:"class transformers.Wav2Vec2ForXVector",anchor:"transformers.Wav2Vec2ForXVector",parameters:[{name:"config",val:""}],parametersDescription:[{anchor:"transformers.Wav2Vec2ForXVector.config",description:`<strong>config</strong> (<a href="/docs/transformers/main/en/model_doc/wav2vec2#transformers.Wav2Vec2Config">Wav2Vec2Config</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/main/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/wav2vec2/modeling_wav2vec2.py#L2023"}}),Bn=new F({props:{name:"forward",anchor:"transformers.Wav2Vec2ForXVector.forward",parameters:[{name:"input_values",val:": typing.Optional[torch.Tensor]"},{name:"attention_mask",val:": typing.Optional[torch.Tensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"labels",val:": typing.Optional[torch.Tensor] = None"}],parametersDescription:[{anchor:"transformers.Wav2Vec2ForXVector.forward.input_values",description:`<strong>input_values</strong> (<code>torch.FloatTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Float values of input raw speech waveform. Values can be obtained by loading a <em>.flac</em> or <em>.wav</em> audio file
into an array of type <em>List[float]</em> or a <em>numpy.ndarray</em>, <em>e.g.</em> via the soundfile library (<em>pip install
soundfile</em>). To prepare the array into <em>input_values</em>, the <a href="/docs/transformers/main/en/model_doc/wav2vec2#transformers.Wav2Vec2Processor">Wav2Vec2Processor</a> should be used for padding
...
`}}),Ta=new ge({props:{$$slots:{default:[vT]},$$scope:{ctx:j}}}),$a=new _e({props:{anchor:"transformers.Wav2Vec2ForXVector.forward.example",$$slots:{default:[bT]},$$scope:{ctx:j}}}),Un=new oe({}),Rn=new F({props:{name:"class transformers.Wav2Vec2ForPreTraining",anchor:"transformers.Wav2Vec2ForPreTraining",parameters:[{name:"config",val:": Wav2Vec2Config"}],parametersDescription:[{anchor:"transformers.Wav2Vec2ForPreTraining.config",description:`<strong>config</strong> (<a href="/docs/transformers/main/en/model_doc/wav2vec2#transformers.Wav2Vec2Config">Wav2Vec2Config</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/main/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/wav2vec2/modeling_wav2vec2.py#L1336"}}),Jn=new F({props:{name:"forward",anchor:"transformers.Wav2Vec2ForPreTraining.forward",parameters:[{name:"input_values",val:": typing.Optional[torch.Tensor]"},{name:"attention_mask",val:": typing.Optional[torch.Tensor] = None"},{name:"mask_time_indices",val:": typing.Optional[torch.BoolTensor] = None"},{name:"sampled_negative_indices",val:": typing.Optional[torch.BoolTensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.Wav2Vec2ForPreTraining.forward.input_values",description:`<strong>input_values</strong> (<code>torch.FloatTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Float values of input raw speech waveform. Values can be obtained by loading a <em>.flac</em> or <em>.wav</em> audio file
into an array of type <em>List[float]</em> or a <em>numpy.ndarray</em>, <em>e.g.</em> via the soundfile library (<em>pip install
soundfile</em>). To prepare the array into <em>input_values</em>, the <a href="/docs/transformers/main/en/model_doc/wav2vec2#transformers.Wav2Vec2Processor">Wav2Vec2Processor</a> should be used for padding
...
`}}),Wa=new ge({props:{$$slots:{default:[wT]},$$scope:{ctx:j}}}),ja=new _e({props:{anchor:"transformers.Wav2Vec2ForPreTraining.forward.example",$$slots:{default:[yT]},$$scope:{ctx:j}}}),Zn=new oe({}),Qn=new F({props:{name:"class transformers.TFWav2Vec2Model",anchor:"transformers.TFWav2Vec2Model",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.TFWav2Vec2Model.config",description:`<strong>config</strong> (<a href="/docs/transformers/main/en/model_doc/wav2vec2#transformers.Wav2Vec2Config">Wav2Vec2Config</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/main/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/wav2vec2/modeling_tf_wav2vec2.py#L1461"}}),Fa=new ge({props:{$$slots:{default:[kT]},$$scope:{ctx:j}}}),or=new F({props:{name:"call",anchor:"transformers.TFWav2Vec2Model.call",parameters:[{name:"input_values",val:": Tensor"},{name:"attention_mask",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"token_type_ids",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"position_ids",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"head_mask",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"inputs_embeds",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"training",val:": bool = False"}],parametersDescription:[{anchor:"transformers.TFWav2Vec2Model.call.input_values",description:`<strong>input_values</strong> (<code>np.ndarray</code>, <code>tf.Tensor</code>, <code>List[tf.Tensor]</code> \`<code>Dict[str, tf.Tensor]</code> or <code>Dict[str, np.ndarray]</code> and each example must have the shape <code>({0})</code>) &#x2014;
...
`}}),Ca=new ge({props:{$$slots:{default:[TT]},$$scope:{ctx:j}}}),Ea=new _e({props:{anchor:"transformers.TFWav2Vec2Model.call.example",$$slots:{default:[$T]},$$scope:{ctx:j}}}),ar=new oe({}),sr=new F({props:{name:"class transformers.TFWav2Vec2ForCTC",anchor:"transformers.TFWav2Vec2ForCTC",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.TFWav2Vec2ForCTC.config",description:`<strong>config</strong> (<a href="/docs/transformers/main/en/model_doc/wav2vec2#transformers.Wav2Vec2Config">Wav2Vec2Config</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/main/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/wav2vec2/modeling_tf_wav2vec2.py#L1564"}}),qa=new ge({props:{$$slots:{default:[xT]},$$scope:{ctx:j}}}),cr=new F({props:{name:"call",anchor:"transformers.TFWav2Vec2ForCTC.call",parameters:[{name:"input_values",val:": Tensor"},{name:"attention_mask",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"token_type_ids",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"position_ids",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"head_mask",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"inputs_embeds",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"labels",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"training",val:": typing.Optional[bool] = False"}],parametersDescription:[{anchor:"transformers.TFWav2Vec2ForCTC.call.input_values",description:`<strong>input_values</strong> (<code>np.ndarray</code>, <code>tf.Tensor</code>, <code>List[tf.Tensor]</code> \`<code>Dict[str, tf.Tensor]</code> or <code>Dict[str, np.ndarray]</code> and each example must have the shape <code>({0})</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/main/en/model_doc/bert#transformers.BertTokenizer">BertTokenizer</a>. See <a href="/docs/transformers/main/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
<a href="/docs/transformers/main/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> for details.</p>
...
`}}),Sa=new ge({props:{$$slots:{default:[CT]},$$scope:{ctx:j}}}),Na=new _e({props:{anchor:"transformers.FlaxWav2Vec2ForCTC.__call__.example",$$slots:{default:[ET]},$$scope:{ctx:j}}}),qr=new oe({}),zr=new F({props:{name:"class transformers.FlaxWav2Vec2ForPreTraining",anchor:"transformers.FlaxWav2Vec2ForPreTraining",parameters:[{name:"config",val:": Wav2Vec2Config"},{name:"input_shape",val:": typing.Tuple = (1, 1024)"},{name:"seed",val:": int = 0"},{name:"dtype",val:": dtype = <class 'jax.numpy.float32'>"},{name:"_do_init",val:": bool = True"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.FlaxWav2Vec2ForPreTraining.config",description:`<strong>config</strong> (<a href="/docs/transformers/main/en/model_doc/wav2vec2#transformers.Wav2Vec2Config">Wav2Vec2Config</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
...
parameters.</strong></p>
<p>If you wish to change the dtype of the model parameters, see <a href="/docs/transformers/main/en/main_classes/model#transformers.FlaxPreTrainedModel.to_fp16">to_fp16()</a> and
<a href="/docs/transformers/main/en/main_classes/model#transformers.FlaxPreTrainedModel.to_bf16">to_bf16()</a>.`,name:"dtype"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/wav2vec2/modeling_flax_wav2vec2.py#L1322"}}),Br=new F({props:{name:"__call__",anchor:"transformers.FlaxWav2Vec2ForPreTraining.__call__",parameters:[{name:"input_values",val:""},{name:"attention_mask",val:" = None"},{name:"mask_time_indices",val:" = None"},{name:"gumbel_temperature",val:": int = 1"},{name:"params",val:": dict = None"},{name:"dropout_rng",val:": PRNGKey = None"},{name:"gumbel_rng",val:": PRNGKey = None"},{name:"train",val:": bool = False"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"freeze_feature_encoder",val:": bool = False"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.FlaxWav2Vec2ForPreTraining.__call__.input_values",description:`<strong>input_values</strong> (<code>jnp.ndarray</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Float values of input raw speech waveform. Values can be obtained by loading a <em>.flac</em> or <em>.wav</em> audio file
into an array of type <em>List[float]</em> or a <em>numpy.ndarray</em>, <em>e.g.</em> via the soundfile library (<em>pip install
soundfile</em>). To prepare the array into <em>input_values</em>, the <a href="/docs/transformers/main/en/model_doc/wav2vec2#transformers.Wav2Vec2Processor">Wav2Vec2Processor</a> should be used for padding
...
`}}),Ba=new ge({props:{$$slots:{default:[PT]},$$scope:{ctx:j}}}),Ua=new _e({props:{anchor:"transformers.FlaxWav2Vec2ForPreTraining.__call__.example",$$slots:{default:[qT]},$$scope:{ctx:j}}}),{c(){c=a("meta"),b=d(),f=a("h1"),u=a("a"),v=a("span"),w(l.$$.fragment),h=d(),V=a("span"),S=r("Wav2Vec2"),A=d(),z=a("h2"),L=a("a"),R=a("span"),w(C.$$.fragment),N=d(),P=a("span"),ze=r("Overview"),we=d(),I=a("p"),Me=r("The Wav2Vec2 model was proposed in "),ye=a("a"),ke=r("wav2vec 2.0: A Framework for Self-Supervised Learning of Speech Representations"),vt=r(" by Alexei Baevski, Henry Zhou, Abdelrahman Mohamed, Michael Auli."),Ke=d(),ae=a("p"),bt=r("The abstract from the paper is the following:"),Ge=d(),se=a("p"),Ue=a("em"),wt=r(`We show for the first time that learning powerful representations from speech audio alone followed by fine-tuning on
...
recognition with limited amounts of labeled data.`),Ae=d(),M=a("p"),H=r("Tips:"),Je=d(),J=a("ul"),Re=a("li"),yt=r("Wav2Vec2 is a speech model that accepts a float array corresponding to the raw waveform of the speech signal."),Te=d(),$e=a("li"),kt=r(`Wav2Vec2 model was trained using connectionist temporal classification (CTC) so the model output has to be decoded
using `),D=a("a"),Tt=r("Wav2Vec2CTCTokenizer"),xe=r("."),Ze=d(),he=a("p"),We=r("This model was contributed by "),je=a("a"),$t=r("patrickvonplaten"),ie=r("."),Qe=d(),X=a("h2"),fe=a("a"),Ve=a("span"),w(O.$$.fragment),xt=d(),K=a("span"),Wt=r("Wav2Vec2Config"),Ye=d(),W=a("div"),w(E.$$.fragment),Gt=d(),Z=a("p"),Jt=r("This is the configuration class to store the configuration of a "),et=a("a"),q=r("Wav2Vec2Model"),Zt=r(`. It is used to instantiate an
Wav2Vec2 model according to the specified arguments, defining the model architecture. Instantiating a configuration
with the defaults will yield a similar configuration to that of the Wav2Vec2
`),He=a("a"),Qt=r("facebook/wav2vec2-base-960h"),Yt=r(" architecture."),eo=d(),B=a("p"),Fe=r("Configuration objects inherit from "),tt=a("a"),to=r("PretrainedConfig"),Ce=r(` and can be used to control the model outputs. Read the
...
tokens and clean up tokenization spaces.`),km=d(),us=a("p"),Tm=r("Similar to doing "),ll=a("code"),$m=r("self.convert_tokens_to_string(self.convert_ids_to_tokens(token_ids))"),xm=r("."),Wm=d(),w(Bo.$$.fragment),jm=d(),Uo=a("div"),w(gs.$$.fragment),Vm=d(),cl=a("p"),Fm=r("Convert a list of lists of token ids into a list of strings by calling decode."),md=d(),no=a("h2"),Ro=a("a"),dl=a("span"),w(_s.$$.fragment),Cm=d(),pl=a("span"),Em=r("Wav2Vec2FeatureExtractor"),hd=d(),Xe=a("div"),w(vs.$$.fragment),Pm=d(),ml=a("p"),qm=r("Constructs a Wav2Vec2 feature extractor."),zm=d(),bs=a("p"),Mm=r("This feature extractor inherits from "),ei=a("a"),Am=r("SequenceFeatureExtractor"),Om=r(` which contains
most of the main methods. Users should refer to this superclass for more information regarding those methods.`),Lm=d(),Ho=a("div"),w(ws.$$.fragment),Dm=d(),hl=a("p"),Sm=r("Main method to featurize and prepare for the model one or several sequence(s)."),fd=d(),ro=a("h2"),Xo=a("a"),fl=a("span"),w(ys.$$.fragment),Nm=d(),ul=a("span"),Im=r("Wav2Vec2Processor"),ud=d(),U=a("div"),w(ks.$$.fragment),Bm=d(),gl=a("p"),Um=r(`Constructs a Wav2Vec2 processor which wraps a Wav2Vec2 feature extractor and a Wav2Vec2 CTC tokenizer into a single
processor.`),Rm=d(),Oe=a("p"),ti=a("a"),Hm=r("Wav2Vec2Processor"),Xm=r(" offers all the functionalities of "),oi=a("a"),Km=r("Wav2Vec2FeatureExtractor"),Gm=r(" and "),ai=a("a"),Jm=r("PreTrainedTokenizer"),Zm=r(`.
...
can be reloaded using the `),li=a("a"),jh=r("from_pretrained()"),Vh=r(" method."),Fh=d(),w(Jo.$$.fragment),Ch=d(),Zo=a("div"),w(Es.$$.fragment),Eh=d(),Ps=a("p"),Ph=r("This method forwards all its arguments to PreTrainedTokenizer\u2019s "),ci=a("a"),qh=r("batch_decode()"),zh=r(`. Please
refer to the docstring of this method for more information.`),Mh=d(),Qo=a("div"),w(qs.$$.fragment),Ah=d(),zs=a("p"),Oh=r("This method forwards all its arguments to PreTrainedTokenizer\u2019s "),di=a("a"),Lh=r("decode()"),Dh=r(`. Please refer
...
with language model support into a single processor for language model boosted speech recognition decoding.`),Uh=d(),ea=a("div"),w(Os.$$.fragment),Rh=d(),Ct=a("p"),Hh=r(`When used in normal mode, this method forwards all its arguments to Wav2Vec2FeatureExtractor\u2019s
...
for more information.`),pf=d(),Nt=a("div"),w(Ns.$$.fragment),mf=d(),Is=a("p"),hf=r("Instantiate a "),hi=a("a"),ff=r("Wav2Vec2ProcessorWithLM"),uf=r(" from a pretrained Wav2Vec2 processor."),gf=d(),w(oa.$$.fragment),_f=d(),fi=a("div"),w(Bs.$$.fragment),vf=d(),It=a("div"),w(Us.$$.fragment),bf=d(),Fl=a("p"),wf=r("Batch decode output logits to audio transcription with language model support."),yf=d(),w(aa.$$.fragment),kf=d(),Bt=a("div"),w(Rs.$$.fragment),Tf=d(),Cl=a("p"),$f=r("Decode output logits to audio transcription with language model support."),xf=d(),w(sa.$$.fragment),vd=d(),lo=a("h2"),na=a("a"),El=a("span"),w(Hs.$$.fragment),Wf=d(),Pl=a("span"),jf=r("Wav2Vec2 specific outputs"),bd=d(),co=a("div"),w(Xs.$$.fragment),Vf=d(),Ks=a("p"),Ff=r("Output type of "),ql=a("code"),Cf=r("Wav2Vec2DecoderWithLM"),Ef=r(", with transcription."),wd=d(),po=a("div"),w(Gs.$$.fragment),Pf=d(),zl=a("p"),qf=r("Base class for models that have been trained with the Wav2Vec2 loss objective."),yd=d(),mo=a("div"),w(Js.$$.fragment),zf=d(),Zs=a("p"),Mf=r("Output type of "),ui=a("a"),Af=r("Wav2Vec2ForPreTraining"),Of=r(", with potential hidden states and attentions."),kd=d(),Pt=a("div"),w(Qs.$$.fragment),Lf=d(),Ys=a("p"),Df=r("Output type of "),Ml=a("code"),Sf=r("FlaxWav2Vec2BaseModelOutput"),Nf=r(", with potential hidden states and attentions."),If=d(),ra=a("div"),w(en.$$.fragment),Bf=d(),Al=a("p"),Uf=r("\u201CReturns a new object replacing the specified fields with new values."),Td=d(),qt=a("div"),w(tn.$$.fragment),Rf=d(),on=a("p"),Hf=r("Output type of "),Ol=a("code"),Xf=r("FlaxWav2Vec2ForPreTrainingOutput"),Kf=r(", with potential hidden states and attentions."),Gf=d(),ia=a("div"),w(an.$$.fragment),Jf=d(),Ll=a("p"),Zf=r("\u201CReturns a new object replacing the specified fields with new values."),$d=d(),ho=a("h2"),la=a("a"),Dl=a("span"),w(sn.$$.fragment),Qf=d(),Sl=a("span"),Yf=r("Wav2Vec2Model"),xd=d(),Ee=a("div"),w(nn.$$.fragment),eu=d(),rn=a("p"),tu=r(`The bare Wav2Vec2 Model transformer outputting raw hidden-states without any specific head on top.
...
Auli.`),Fu=d(),gn=a("p"),Cu=r("This model inherits from "),vi=a("a"),Eu=r("PreTrainedModel"),Pu=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving etc.).`),qu=d(),_n=a("p"),zu=r("This model is a PyTorch "),vn=a("a"),Mu=r("torch.nn.Module"),Au=r(` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),Ou=d(),Le=a("div"),w(bn.$$.fragment),Lu=d(),_o=a("p"),Du=r("The "),bi=a("a"),Su=r("Wav2Vec2ForCTC"),Nu=r(" forward method, overrides the "),Rl=a("code"),Iu=r("__call__"),Bu=r(" special method."),Uu=d(),w(ma.$$.fragment),Ru=d(),w(ha.$$.fragment),Hu=d(),w(fa.$$.fragment),Vd=d(),vo=a("h2"),ua=a("a"),Hl=a("span"),w(wn.$$.fragment),Xu=d(),Xl=a("span"),Ku=r("Wav2Vec2ForSequenceClassification"),Fd=d(),le=a("div"),w(yn.$$.fragment),Gu=d(),Kl=a("p"),Ju=r(`Wav2Vec2 Model with a sequence classification head on top (a linear layer over the pooled output) for tasks like
...
Auli.`),jg=d(),Pn=a("p"),Vg=r("This model inherits from "),ki=a("a"),Fg=r("PreTrainedModel"),Cg=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving etc.).`),Eg=d(),qn=a("p"),Pg=r("This model is a PyTorch "),zn=a("a"),qg=r("torch.nn.Module"),zg=r(` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),Mg=d(),nt=a("div"),w(Mn.$$.fragment),Ag=d(),yo=a("p"),Og=r("The "),Ti=a("a"),Lg=r("Wav2Vec2ForAudioFrameClassification"),Dg=r(" forward method, overrides the "),Yl=a("code"),Sg=r("__call__"),Ng=r(" special method."),Ig=d(),w(wa.$$.fragment),Bg=d(),w(ya.$$.fragment),Pd=d(),ko=a("h2"),ka=a("a"),ec=a("span"),w(An.$$.fragment),Ug=d(),tc=a("span"),Rg=r("Wav2Vec2ForXVector"),qd=d(),de=a("div"),w(On.$$.fragment),Hg=d(),oc=a("p"),Xg=r("Wav2Vec2 Model with an XVector feature extraction head on top for tasks like Speaker Verification."),Kg=d(),Ln=a("p"),Gg=r("Wav2Vec2 was proposed in "),Dn=a("a"),Jg=r(`wav2vec 2.0: A Framework for Self-Supervised Learning of Speech
...
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),E_=d(),it=a("div"),w(Jn.$$.fragment),P_=d(),Wo=a("p"),q_=r("The "),ji=a("a"),z_=r("Wav2Vec2ForPreTraining"),M_=r(" forward method, overrides the "),ic=a("code"),A_=r("__call__"),O_=r(" special method."),L_=d(),w(Wa.$$.fragment),D_=d(),w(ja.$$.fragment),Ad=d(),jo=a("h2"),Va=a("a"),lc=a("span"),w(Zn.$$.fragment),S_=d(),cc=a("span"),N_=r("TFWav2Vec2Model"),Od=d(),pe=a("div"),w(Qn.$$.fragment),I_=d(),dc=a("p"),B_=r("The bare TFWav2Vec2 Model transformer outputing raw hidden-states without any specific head on top."),U_=d(),Yn=a("p"),R_=r("This model inherits from "),Vi=a("a"),H_=r("TFPreTrainedModel"),X_=r(`. Check the superclass documentation for the generic methods the
...
behavior.`),Q_=d(),w(Fa.$$.fragment),Y_=d(),lt=a("div"),w(or.$$.fragment),ev=d(),Vo=a("p"),tv=r("The "),Fi=a("a"),ov=r("TFWav2Vec2Model"),av=r(" forward method, overrides the "),pc=a("code"),sv=r("__call__"),nv=r(" special method."),rv=d(),w(Ca.$$.fragment),iv=d(),w(Ea.$$.fragment),Ld=d(),Fo=a("h2"),Pa=a("a"),mc=a("span"),w(ar.$$.fragment),lv=d(),hc=a("span"),cv=r("TFWav2Vec2ForCTC"),Dd=d(),me=a("div"),w(sr.$$.fragment),dv=d(),nr=a("p"),pv=r("TFWav2Vec2 Model with a "),fc=a("code"),mv=r("language modeling"),hv=r(" head on top for Connectionist Temporal Classification (CTC)."),fv=d(),rr=a("p"),uv=r("This model inherits from "),Ci=a("a"),gv=r("TFPreTrainedModel"),_v=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),vv=d(),ir=a("p"),bv=r("This model is also a "),lr=a("a"),wv=r("tf.keras.Model"),yv=r(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),kv=d(),w(qa.$$.fragment),Tv=d(),ct=a("div"),w(cr.$$.fragment),$v=d(),Co=a("p"),xv=r("The "),Ei=a("a"),Wv=r("TFWav2Vec2ForCTC"),jv=r(" forward method, overrides the "),uc=a("code"),Vv=r("__call__"),Fv=r(" special method."),Cv=d(),w(za.$$.fragment),Ev=d(),w(Ma.$$.fragment),Sd=d(),Eo=a("h2"),Aa=a("a"),gc=a("span"),w(dr.$$.fragment),Pv=d(),_c=a("span"),qv=r("FlaxWav2Vec2Model"),Nd=d(),Y=a("div"),w(pr.$$.fragment),zv=d(),mr=a("p"),Mv=r(`The bare Wav2Vec2 Model transformer outputting raw hidden-states without any specific head on top.
Wav2Vec2 was proposed in `),hr=a("a"),Av=r(`wav2vec 2.0: A Framework for Self-Supervised Learning of Speech
Representations`),Ov=r(` by Alexei Baevski, Henry Zhou, Abdelrahman Mohamed, Michael
Auli.`),Lv=d(),fr=a("p"),Dv=r("This model inherits from "),Pi=a("a"),Sv=r("FlaxPreTrainedModel"),Nv=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Iv=d(),ur=a("p"),Bv=r(`This model is also a Flax Linen
`),gr=a("a"),Uv=r("flax.nn.Module"),Rv=r(` subclass. Use it as a
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),Hv=d(),vc=a("p"),Xv=r("Finally, this model supports inherent JAX features such as:"),Kv=d(),zt=a("ul"),bc=a("li"),_r=a("a"),Gv=r("Just-In-Time (JIT) compilation"),Jv=d(),wc=a("li"),vr=a("a"),Zv=r("Automatic Differentiation"),Qv=d(),yc=a("li"),br=a("a"),Yv=r("Vectorization"),e2=d(),kc=a("li"),wr=a("a"),t2=r("Parallelization"),o2=d(),dt=a("div"),w(yr.$$.fragment),a2=d(),Po=a("p"),s2=r("The "),Tc=a("code"),n2=r("FlaxWav2Vec2PreTrainedModel"),r2=r(" forward method, overrides the "),$c=a("code"),i2=r("__call__"),l2=r(" special method."),c2=d(),w(Oa.$$.fragment),d2=d(),w(La.$$.fragment),Id=d(),qo=a("h2"),Da=a("a"),xc=a("span"),w(kr.$$.fragment),p2=d(),Wc=a("span"),m2=r("FlaxWav2Vec2ForCTC"),Bd=d(),ee=a("div"),w(Tr.$$.fragment),h2=d(),zo=a("p"),f2=r("Wav2Vec2 Model with a "),jc=a("code"),u2=r("language modeling"),g2=r(` head on top for Connectionist Temporal Classification (CTC).
Wav2Vec2 was proposed in `),$r=a("a"),_2=r(`wav2vec 2.0: A Framework for Self-Supervised Learning of Speech
Representations`),v2=r(` by Alexei Baevski, Henry Zhou, Abdelrahman Mohamed, Michael
Auli.`),b2=d(),xr=a("p"),w2=r("This model inherits from "),qi=a("a"),y2=r("FlaxPreTrainedModel"),k2=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),T2=d(),Wr=a("p"),$2=r(`This model is also a Flax Linen
`),jr=a("a"),x2=r("flax.nn.Module"),W2=r(` subclass. Use it as a
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),j2=d(),Vc=a("p"),V2=r("Finally, this model supports inherent JAX features such as:"),F2=d(),Mt=a("ul"),Fc=a("li"),Vr=a("a"),C2=r("Just-In-Time (JIT) compilation"),E2=d(),Cc=a("li"),Fr=a("a"),P2=r("Automatic Differentiation"),q2=d(),Ec=a("li"),Cr=a("a"),z2=r("Vectorization"),M2=d(),Pc=a("li"),Er=a("a"),A2=r("Parallelization"),O2=d(),pt=a("div"),w(Pr.$$.fragment),L2=d(),Mo=a("p"),D2=r("The "),qc=a("code"),S2=r("FlaxWav2Vec2PreTrainedModel"),N2=r(" forward method, overrides the "),zc=a("code"),I2=r("__call__"),B2=r(" special method."),U2=d(),w(Sa.$$.fragment),R2=d(),w(Na.$$.fragment),Ud=d(),Ao=a("h2"),Ia=a("a"),Mc=a("span"),w(qr.$$.fragment),H2=d(),Ac=a("span"),X2=r("FlaxWav2Vec2ForPreTraining"),Rd=d(),te=a("div"),w(zr.$$.fragment),K2=d(),Oo=a("p"),G2=r("Wav2Vec2 Model with a quantizer and "),Oc=a("code"),J2=r("VQ"),Z2=r(` head on top.
Wav2Vec2 was proposed in `),Mr=a("a"),Q2=r(`wav2vec 2.0: A Framework for Self-Supervised Learning of Speech
...
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),lb=d(),Lc=a("p"),cb=r("Finally, this model supports inherent JAX features such as:"),db=d(),At=a("ul"),Dc=a("li"),Dr=a("a"),pb=r("Just-In-Time (JIT) compilation"),mb=d(),Sc=a("li"),Sr=a("a"),hb=r("Automatic Differentiation"),fb=d(),Nc=a("li"),Nr=a("a"),ub=r("Vectorization"),gb=d(),Ic=a("li"),Ir=a("a"),_b=r("Parallelization"),vb=d(),mt=a("div"),w(Br.$$.fragment),bb=d(),Lo=a("p"),wb=r("The "),Mi=a("a"),yb=r("FlaxWav2Vec2ForPreTraining"),kb=r(" forward method, overrides the "),Bc=a("code"),Tb=r("__call__"),$b=r(" special method."),xb=d(),w(Ba.$$.fragment),Wb=d(),w(Ua.$$.fragment),this.h()},l(o){const g=eT('[data-svelte="svelte-1phssyn"]',document.head);c=s(g,"META",{name:!0,content:!0}),g.forEach(t),b=p(o),f=s(o,"H1",{class:!0});var Ur=n(f);u=s(Ur,"A",{id:!0,class:!0,href:!0});var Uc=n(u);v=s(Uc,"SPAN",{});var Rc=n(v);y(l.$$.fragment,Rc),Rc.forEach(t),Uc.forEach(t),h=p(Ur),V=s(Ur,"SPAN",{});var Hc=n(V);S=i(Hc,"Wav2Vec2"),Hc.forEach(t),Ur.forEach(t),A=p(o),z=s(o,"H2",{class:!0});var Rr=n(z);L=s(Rr,"A",{id:!0,class:!0,href:!0});var Xc=n(L);R=s(Xc,"SPAN",{});var Kc=n(R);y(C.$$.fragment,Kc),Kc.forEach(t),Xc.forEach(t),N=p(Rr),P=s(Rr,"SPAN",{});var Gc=n(P);ze=i(Gc,"Overview"),Gc.forEach(t),Rr.forEach(t),we=p(o),I=s(o,"P",{});var Hr=n(I);Me=i(Hr,"The Wav2Vec2 model was proposed in "),ye=s(Hr,"A",{href:!0,rel:!0});var Jc=n(ye);ke=i(Jc,"wav2vec 2.0: A Framework for Self-Supervised Learning of Speech Representations"),Jc.forEach(t),vt=i(Hr," by Alexei Baevski, Henry Zhou, Abdelrahman Mohamed, Michael Auli."),Hr.forEach(t),Ke=p(o),ae=s(o,"P",{});var Zc=n(ae);bt=i(Zc,"The abstract from the paper is the following:"),Zc.forEach(t),Ge=p(o),se=s(o,"P",{});var Qc=n(se);Ue=s(Qc,"EM",{});var Yc=n(Ue);wt=i(Yc,`We show for the first time that learning powerful representations from speech audio alone followed by fine-tuning on
transcribed speech can outperform the best semi-supervised methods while being conceptually simpler. wav2vec 2.0 masks
the speech input in the latent space and solves a contrastive task defined over a quantization of the latent
representations which are jointly learned. Experiments using all labeled data of Librispeech achieve 1.8/3.3 WER on the
clean/other test sets. When lowering the amount of labeled data to one hour, wav2vec 2.0 outperforms the previous state
...
sequences.`),Ob.forEach(t),Kd.forEach(t),vm=p(Se),Yr=s(Se,"DIV",{class:!0});var Lb=n(Yr);y(hs.$$.fragment,Lb),Lb.forEach(t),bm=p(Se),at=s(Se,"DIV",{class:!0});var Ra=n(at);y(fs.$$.fragment,Ra),wm=p(Ra),il=s(Ra,"P",{});var Db=n(il);ym=i(Db,`Converts a sequence of ids in a string, using the tokenizer and vocabulary with options to remove special
tokens and clean up tokenization spaces.`),Db.forEach(t),km=p(Ra),us=s(Ra,"P",{});var Gd=n(us);Tm=i(Gd,"Similar to doing "),ll=s(Gd,"CODE",{});var Sb=n(ll);$m=i(Sb,"self.convert_tokens_to_string(self.convert_ids_to_tokens(token_ids))"),Sb.forEach(t),xm=i(Gd,"."),Gd.forEach(t),Wm=p(Ra),y(Bo.$$.fragment,Ra),Ra.forEach(t),jm=p(Se),Uo=s(Se,"DIV",{class:!0});var Jd=n(Uo);y(gs.$$.fragment,Jd),Vm=p(Jd),cl=s(Jd,"P",{});var Nb=n(cl);Fm=i(Nb,"Convert a list of lists of token ids into a list of strings by calling decode."),Nb.forEach(t),Jd.forEach(t),Se.forEach(t),md=p(o),no=s(o,"H2",{class:!0});var Zd=n(no);Ro=s(Zd,"A",{id:!0,class:!0,href:!0});var Ib=n(Ro);dl=s(Ib,"SPAN",{});var Bb=n(dl);y(_s.$$.fragment,Bb),Bb.forEach(t),Ib.forEach(t),Cm=p(Zd),pl=s(Zd,"SPAN",{});var Ub=n(pl);Em=i(Ub,"Wav2Vec2FeatureExtractor"),Ub.forEach(t),Zd.forEach(t),hd=p(o),Xe=s(o,"DIV",{class:!0});var Ha=n(Xe);y(vs.$$.fragment,Ha),Pm=p(Ha),ml=s(Ha,"P",{});var Rb=n(ml);qm=i(Rb,"Constructs a Wav2Vec2 feature extractor."),Rb.forEach(t),zm=p(Ha),bs=s(Ha,"P",{});var Qd=n(bs);Mm=i(Qd,"This feature extractor inherits from "),ei=s(Qd,"A",{href:!0});var Hb=n(ei);Am=i(Hb,"SequenceFeatureExtractor"),Hb.forEach(t),Om=i(Qd,` which contains
most of the main methods. Users should refer to this superclass for more information regarding those methods.`),Qd.forEach(t),Lm=p(Ha),Ho=s(Ha,"DIV",{class:!0});var Yd=n(Ho);y(ws.$$.fragment,Yd),Dm=p(Yd),hl=s(Yd,"P",{});var Xb=n(hl);Sm=i(Xb,"Main method to featurize and prepare for the model one or several sequence(s)."),Xb.forEach(t),Yd.forEach(t),Ha.forEach(t),fd=p(o),ro=s(o,"H2",{class:!0});var ep=n(ro);Xo=s(ep,"A",{id:!0,class:!0,href:!0});var Kb=n(Xo);fl=s(Kb,"SPAN",{});var Gb=n(fl);y(ys.$$.fragment,Gb),Gb.forEach(t),Kb.forEach(t),Nm=p(ep),ul=s(ep,"SPAN",{});var Jb=n(ul);Im=i(Jb,"Wav2Vec2Processor"),Jb.forEach(t),ep.forEach(t),ud=p(o),U=s(o,"DIV",{class:!0});var re=n(U);y(ks.$$.fragment,re),Bm=p(re),gl=s(re,"P",{});var Zb=n(gl);Um=i(Zb,`Constructs a Wav2Vec2 processor which wraps a Wav2Vec2 feature extractor and a Wav2Vec2 CTC tokenizer into a single
processor.`),Zb.forEach(t),Rm=p(re),Oe=s(re,"P",{});var Lt=n(Oe);ti=s(Lt,"A",{href:!0});var Qb=n(ti);Hm=i(Qb,"Wav2Vec2Processor"),Qb.forEach(t),Xm=i(Lt," offers all the functionalities of "),oi=s(Lt,"A",{href:!0});var Yb=n(oi);Km=i(Yb,"Wav2Vec2FeatureExtractor"),Yb.forEach(t),Gm=i(Lt," and "),ai=s(Lt,"A",{href:!0});var ew=n(ai);Jm=i(ew,"PreTrainedTokenizer"),ew.forEach(t),Zm=i(Lt,`.
...
with language model support into a single processor for language model boosted speech recognition decoding.`),gw.forEach(t),Uh=p(ue),ea=s(ue,"DIV",{class:!0});var cp=n(ea);y(Os.$$.fragment,cp),Rh=p(cp),Ct=s(cp,"P",{});var Ga=n(Ct);Hh=i(Ga,`When used in normal mode, this method forwards all its arguments to Wav2Vec2FeatureExtractor\u2019s
...
for more information.`),Ja.forEach(t),dp.forEach(t),pf=p(ue),Nt=s(ue,"DIV",{class:!0});var Oi=n(Nt);y(Ns.$$.fragment,Oi),mf=p(Oi),Is=s(Oi,"P",{});var pp=n(Is);hf=i(pp,"Instantiate a "),hi=s(pp,"A",{href:!0});var Tw=n(hi);ff=i(Tw,"Wav2Vec2ProcessorWithLM"),Tw.forEach(t),uf=i(pp," from a pretrained Wav2Vec2 processor."),pp.forEach(t),gf=p(Oi),y(oa.$$.fragment,Oi),Oi.forEach(t),_f=p(ue),fi=s(ue,"DIV",{class:!0});var $w=n(fi);y(Bs.$$.fragment,$w),$w.forEach(t),vf=p(ue),It=s(ue,"DIV",{class:!0});var Li=n(It);y(Us.$$.fragment,Li),bf=p(Li),Fl=s(Li,"P",{});var xw=n(Fl);wf=i(xw,"Batch decode output logits to audio transcription with language model support."),xw.forEach(t),yf=p(Li),y(aa.$$.fragment,Li),Li.forEach(t),kf=p(ue),Bt=s(ue,"DIV",{class:!0});var Di=n(Bt);y(Rs.$$.fragment,Di),Tf=p(Di),Cl=s(Di,"P",{});var Ww=n(Cl);$f=i(Ww,"Decode output logits to audio transcription with language model support."),Ww.forEach(t),xf=p(Di),y(sa.$$.fragment,Di),Di.forEach(t),ue.forEach(t),vd=p(o),lo=s(o,"H2",{class:!0});var mp=n(lo);na=s(mp,"A",{id:!0,class:!0,href:!0});var jw=n(na);El=s(jw,"SPAN",{});var Vw=n(El);y(Hs.$$.fragment,Vw),Vw.forEach(t),jw.forEach(t),Wf=p(mp),Pl=s(mp,"SPAN",{});var Fw=n(Pl);jf=i(Fw,"Wav2Vec2 specific outputs"),Fw.forEach(t),mp.forEach(t),bd=p(o),co=s(o,"DIV",{class:!0});var hp=n(co);y(Xs.$$.fragment,hp),Vf=p(hp),Ks=s(hp,"P",{});var fp=n(Ks);Ff=i(fp,"Output type of "),ql=s(fp,"CODE",{});var Cw=n(ql);Cf=i(Cw,"Wav2Vec2DecoderWithLM"),Cw.forEach(t),Ef=i(fp,", with transcription."),fp.forEach(t),hp.forEach(t),wd=p(o),po=s(o,"DIV",{class:!0});var up=n(po);y(Gs.$$.fragment,up),Pf=p(up),zl=s(up,"P",{});var Ew=n(zl);qf=i(Ew,"Base class for models that have been trained with the Wav2Vec2 loss objective."),Ew.forEach(t),up.forEach(t),yd=p(o),mo=s(o,"DIV",{class:!0});var gp=n(mo);y(Js.$$.fragment,gp),zf=p(gp),Zs=s(gp,"P",{});var _p=n(Zs);Mf=i(_p,"Output type of "),ui=s(_p,"A",{href:!0});var Pw=n(ui);Af=i(Pw,"Wav2Vec2ForPreTraining"),Pw.forEach(t),Of=i(_p,", with potential hidden states and attentions."),_p.forEach(t),gp.forEach(t),kd=p(o),Pt=s(o,"DIV",{class:!0});var Si=n(Pt);y(Qs.$$.fragment,Si),Lf=p(Si),Ys=s(Si,"P",{});var vp=n(Ys);Df=i(vp,"Output type of "),Ml=s(vp,"CODE",{});var qw=n(Ml);Sf=i(qw,"FlaxWav2Vec2BaseModelOutput"),qw.forEach(t),Nf=i(vp,", with potential hidden states and attentions."),vp.forEach(t),If=p(Si),ra=s(Si,"DIV",{class:!0});var bp=n(ra);y(en.$$.fragment,bp),Bf=p(bp),Al=s(bp,"P",{});var zw=n(Al);Uf=i(zw,"\u201CReturns a new object replacing the specified fields with new values."),zw.forEach(t),bp.forEach(t),Si.forEach(t),Td=p(o),qt=s(o,"DIV",{class:!0});var Ni=n(qt);y(tn.$$.fragment,Ni),Rf=p(Ni),on=s(Ni,"P",{});var wp=n(on);Hf=i(wp,"Output type of "),Ol=s(wp,"CODE",{});var Mw=n(Ol);Xf=i(Mw,"FlaxWav2Vec2ForPreTrainingOutput"),Mw.forEach(t),Kf=i(wp,", with potential hidden states and attentions."),wp.forEach(t),Gf=p(Ni),ia=s(Ni,"DIV",{class:!0});var yp=n(ia);y(an.$$.fragment,yp),Jf=p(yp),Ll=s(yp,"P",{});var Aw=n(Ll);Zf=i(Aw,"\u201CReturns a new object replacing the specified fields with new values."),Aw.forEach(t),yp.forEach(t),Ni.forEach(t),$d=p(o),ho=s(o,"H2",{class:!0});var kp=n(ho);la=s(kp,"A",{id:!0,class:!0,href:!0});var Ow=n(la);Dl=s(Ow,"SPAN",{});var Lw=n(Dl);y(sn.$$.fragment,Lw),Lw.forEach(t),Ow.forEach(t),Qf=p(kp),Sl=s(kp,"SPAN",{});var Dw=n(Sl);Yf=i(Dw,"Wav2Vec2Model"),Dw.forEach(t),kp.forEach(t),xd=p(o),Ee=s(o,"DIV",{class:!0});var Ut=n(Ee);y(nn.$$.fragment,Ut),eu=p(Ut),rn=s(Ut,"P",{});var Tp=n(rn);tu=i(Tp,`The bare Wav2Vec2 Model transformer outputting raw hidden-states without any specific head on top.
...
Auli.`),Bi.forEach(t),Fu=p(Rt),gn=s(Rt,"P",{});var jp=n(gn);Cu=i(jp,"This model inherits from "),vi=s(jp,"A",{href:!0});var Jw=n(vi);Eu=i(Jw,"PreTrainedModel"),Jw.forEach(t),Pu=i(jp,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving etc.).`),jp.forEach(t),qu=p(Rt),_n=s(Rt,"P",{});var Vp=n(_n);zu=i(Vp,"This model is a PyTorch "),vn=s(Vp,"A",{href:!0,rel:!0});var Zw=n(vn);Mu=i(Zw,"torch.nn.Module"),Zw.forEach(t),Au=i(Vp,` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),Vp.forEach(t),Ou=p(Rt),Le=s(Rt,"DIV",{class:!0});var Ht=n(Le);y(bn.$$.fragment,Ht),Lu=p(Ht),_o=s(Ht,"P",{});var Ui=n(_o);Du=i(Ui,"The "),bi=s(Ui,"A",{href:!0});var Qw=n(bi);Su=i(Qw,"Wav2Vec2ForCTC"),Qw.forEach(t),Nu=i(Ui," forward method, overrides the "),Rl=s(Ui,"CODE",{});var Yw=n(Rl);Iu=i(Yw,"__call__"),Yw.forEach(t),Bu=i(Ui," special method."),Ui.forEach(t),Uu=p(Ht),y(ma.$$.fragment,Ht),Ru=p(Ht),y(ha.$$.fragment,Ht),Hu=p(Ht),y(fa.$$.fragment,Ht),Ht.forEach(t),Rt.forEach(t),Vd=p(o),vo=s(o,"H2",{class:!0});var Fp=n(vo);ua=s(Fp,"A",{id:!0,class:!0,href:!0});var ey=n(ua);Hl=s(ey,"SPAN",{});var ty=n(Hl);y(wn.$$.fragment,ty),ty.forEach(t),ey.forEach(t),Xu=p(Fp),Xl=s(Fp,"SPAN",{});var oy=n(Xl);Ku=i(oy,"Wav2Vec2ForSequenceClassification"),oy.forEach(t),Fp.forEach(t),Fd=p(o),le=s(o,"DIV",{class:!0});var ht=n(le);y(yn.$$.fragment,ht),Gu=p(ht),Kl=s(ht,"P",{});var ay=n(Kl);Ju=i(ay,`Wav2Vec2 Model with a sequence classification head on top (a linear layer over the pooled output) for tasks like
...
library implements for all its model (such as downloading or saving etc.).`),Ep.forEach(t),ng=p(ht),xn=s(ht,"P",{});var Pp=n(xn);rg=i(Pp,"This model is a PyTorch "),Wn=s(Pp,"A",{href:!0,rel:!0});var ry=n(Wn);ig=i(ry,"torch.nn.Module"),ry.forEach(t),lg=i(Pp,` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),Pp.forEach(t),cg=p(ht),De=s(ht,"DIV",{class:!0});var Xt=n(De);y(jn.$$.fragment,Xt),dg=p(Xt),bo=s(Xt,"P",{});var Ri=n(bo);pg=i(Ri,"The "),yi=s(Ri,"A",{href:!0});var iy=n(yi);mg=i(iy,"Wav2Vec2ForSequenceClassification"),iy.forEach(t),hg=i(Ri," forward method, overrides the "),Gl=s(Ri,"CODE",{});var ly=n(Gl);fg=i(ly,"__call__"),ly.forEach(t),ug=i(Ri," special method."),Ri.forEach(t),gg=p(Xt),y(ga.$$.fragment,Xt),_g=p(Xt),y(_a.$$.fragment,Xt),vg=p(Xt),y(va.$$.fragment,Xt),Xt.forEach(t),ht.forEach(t),Cd=p(o),wo=s(o,"H2",{class:!0});var qp=n(wo);ba=s(qp,"A",{id:!0,class:!0,href:!0});var cy=n(ba);Jl=s(cy,"SPAN",{});var dy=n(Jl);y(Vn.$$.fragment,dy),dy.forEach(t),cy.forEach(t),bg=p(qp),Zl=s(qp,"SPAN",{});var py=n(Zl);wg=i(py,"Wav2Vec2ForAudioFrameClassification"),py.forEach(t),qp.forEach(t),Ed=p(o),ce=s(o,"DIV",{class:!0});var ft=n(ce);y(Fn.$$.fragment,ft),yg=p(ft),Ql=s(ft,"P",{});var my=n(Ql);kg=i(my,"Wav2Vec2 Model with a frame classification head on top for tasks like Speaker Diarization."),my.forEach(t),Tg=p(ft),Cn=s(ft,"P",{});var zp=n(Cn);$g=i(zp,"Wav2Vec2 was proposed in "),En=s(zp,"A",{href:!0,rel:!0});var hy=n(En);xg=i(hy,`wav2vec 2.0: A Framework for Self-Supervised Learning of Speech
Representations`),hy.forEach(t),Wg=i(zp,` by Alexei Baevski, Henry Zhou, Abdelrahman Mohamed, Michael
Auli.`),zp.forEach(t),jg=p(ft),Pn=s(ft,"P",{});var Mp=n(Pn);Vg=i(Mp,"This model inherits from "),ki=s(Mp,"A",{href:!0});var fy=n(ki);Fg=i(fy,"PreTrainedModel"),fy.forEach(t),Cg=i(Mp,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving etc.).`),Mp.forEach(t),Eg=p(ft),qn=s(ft,"P",{});var Ap=n(qn);Pg=i(Ap,"This model is a PyTorch "),zn=s(Ap,"A",{href:!0,rel:!0});var uy=n(zn);qg=i(uy,"torch.nn.Module"),uy.forEach(t),zg=i(Ap,` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),Ap.forEach(t),Mg=p(ft),nt=s(ft,"DIV",{class:!0});var Qa=n(nt);y(Mn.$$.fragment,Qa),Ag=p(Qa),yo=s(Qa,"P",{});var Hi=n(yo);Og=i(Hi,"The "),Ti=s(Hi,"A",{href:!0});var gy=n(Ti);Lg=i(gy,"Wav2Vec2ForAudioFrameClassification"),gy.forEach(t),Dg=i(Hi," forward method, overrides the "),Yl=s(Hi,"CODE",{});var _y=n(Yl);Sg=i(_y,"__call__"),_y.forEach(t),Ng=i(Hi," special method."),Hi.forEach(t),Ig=p(Qa),y(wa.$$.fragment,Qa),Bg=p(Qa),y(ya.$$.fragment,Qa),Qa.forEach(t),ft.forEach(t),Pd=p(o),ko=s(o,"H2",{class:!0});var Op=n(ko);ka=s(Op,"A",{id:!0,class:!0,href:!0});var vy=n(ka);ec=s(vy,"SPAN",{});var by=n(ec);y(An.$$.fragment,by),by.forEach(t),vy.forEach(t),Ug=p(Op),tc=s(Op,"SPAN",{});var wy=n(tc);Rg=i(wy,"Wav2Vec2ForXVector"),wy.forEach(t),Op.forEach(t),qd=p(o),de=s(o,"DIV",{class:!0});var ut=n(de);y(On.$$.fragment,ut),Hg=p(ut),oc=s(ut,"P",{});var yy=n(oc);Xg=i(yy,"Wav2Vec2 Model with an XVector feature extraction head on top for tasks like Speaker Verification."),yy.forEach(t),Kg=p(ut),Ln=s(ut,"P",{});var Lp=n(Ln);Gg=i(Lp,"Wav2Vec2 was proposed in "),Dn=s(Lp,"A",{href:!0,rel:!0});var ky=n(Dn);Jg=i(ky,`wav2vec 2.0: A Framework for Self-Supervised Learning of Speech
...
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),Sp.forEach(t),r_=p(ut),rt=s(ut,"DIV",{class:!0});var Ya=n(rt);y(Bn.$$.fragment,Ya),i_=p(Ya),To=s(Ya,"P",{});var Xi=n(To);l_=i(Xi,"The "),xi=s(Xi,"A",{href:!0});var xy=n(xi);c_=i(xy,"Wav2Vec2ForXVector"),xy.forEach(t),d_=i(Xi," forward method, overrides the "),ac=s(Xi,"CODE",{});var Wy=n(ac);p_=i(Wy,"__call__"),Wy.forEach(t),m_=i(Xi," special method."),Xi.forEach(t),h_=p(Ya),y(Ta.$$.fragment,Ya),f_=p(Ya),y($a.$$.fragment,Ya),Ya.forEach(t),ut.forEach(t),zd=p(o),$o=s(o,"H2",{class:!0});var Np=n($o);xa=s(Np,"A",{id:!0,class:!0,href:!0});var jy=n(xa);sc=s(jy,"SPAN",{});var Vy=n(sc);y(Un.$$.fragment,Vy),Vy.forEach(t),jy.forEach(t),u_=p(Np),nc=s(Np,"SPAN",{});var Fy=n(nc);g_=i(Fy,"Wav2Vec2ForPreTraining"),Fy.forEach(t),Np.forEach(t),Md=p(o),qe=s(o,"DIV",{class:!0});var Kt=n(qe);y(Rn.$$.fragment,Kt),__=p(Kt),xo=s(Kt,"P",{});var Ki=n(xo);v_=i(Ki,"Wav2Vec2 Model with a quantizer and "),rc=s(Ki,"CODE",{});var Cy=n(rc);b_=i(Cy,"VQ"),Cy.forEach(t),w_=i(Ki,` head on top.
Wav2Vec2 was proposed in `),Hn=s(Ki,"A",{href:!0,rel:!0});var Ey=n(Hn);y_=i(Ey,`wav2vec 2.0: A Framework for Self-Supervised Learning of Speech
Representations`),Ey.forEach(t),k_=i(Ki,` by Alexei Baevski, Henry Zhou, Abdelrahman Mohamed, Michael
Auli.`),Ki.forEach(t),T_=p(Kt),Xn=s(Kt,"P",{});var Ip=n(Xn);$_=i(Ip,"This model inherits from "),Wi=s(Ip,"A",{href:!0});var Py=n(Wi);x_=i(Py,"PreTrainedModel"),Py.forEach(t),W_=i(Ip,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving etc.).`),Ip.forEach(t),j_=p(Kt),Kn=s(Kt,"P",{});var Bp=n(Kn);V_=i(Bp,"This model is a PyTorch "),Gn=s(Bp,"A",{href:!0,rel:!0});var qy=n(Gn);F_=i(qy,"torch.nn.Module"),qy.forEach(t),C_=i(Bp,` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),Bp.forEach(t),E_=p(Kt),it=s(Kt,"DIV",{class:!0});var es=n(it);y(Jn.$$.fragment,es),P_=p(es),Wo=s(es,"P",{});var Gi=n(Wo);q_=i(Gi,"The "),ji=s(Gi,"A",{href:!0});var zy=n(ji);z_=i(zy,"Wav2Vec2ForPreTraining"),zy.forEach(t),M_=i(Gi," forward method, overrides the "),ic=s(Gi,"CODE",{});var My=n(ic);A_=i(My,"__call__"),My.forEach(t),O_=i(Gi," special method."),Gi.forEach(t),L_=p(es),y(Wa.$$.fragment,es),D_=p(es),y(ja.$$.fragment,es),es.forEach(t),Kt.forEach(t),Ad=p(o),jo=s(o,"H2",{class:!0});var Up=n(jo);Va=s(Up,"A",{id:!0,class:!0,href:!0});var Ay=n(Va);lc=s(Ay,"SPAN",{});var Oy=n(lc);y(Zn.$$.fragment,Oy),Oy.forEach(t),Ay.forEach(t),S_=p(Up),cc=s(Up,"SPAN",{});var Ly=n(cc);N_=i(Ly,"TFWav2Vec2Model"),Ly.forEach(t),Up.forEach(t),Od=p(o),pe=s(o,"DIV",{class:!0});var gt=n(pe);y(Qn.$$.fragment,gt),I_=p(gt),dc=s(gt,"P",{});var Dy=n(dc);B_=i(Dy,"The bare TFWav2Vec2 Model transformer outputing raw hidden-states without any specific head on top."),Dy.forEach(t),U_=p(gt),Yn=s(gt,"P",{});var Rp=n(Yn);R_=i(Rp,"This model inherits from "),Vi=s(Rp,"A",{href:!0});var Sy=n(Vi);H_=i(Sy,"TFPreTrainedModel"),Sy.forEach(t),X_=i(Rp,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Rp.forEach(t),K_=p(gt),er=s(gt,"P",{});var Hp=n(er);G_=i(Hp,"This model is also a "),tr=s(Hp,"A",{href:!0,rel:!0});var Ny=n(tr);J_=i(Ny,"tf.keras.Model"),Ny.forEach(t),Z_=i(Hp,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Hp.forEach(t),Q_=p(gt),y(Fa.$$.fragment,gt),Y_=p(gt),lt=s(gt,"DIV",{class:!0});var ts=n(lt);y(or.$$.fragment,ts),ev=p(ts),Vo=s(ts,"P",{});var Ji=n(Vo);tv=i(Ji,"The "),Fi=s(Ji,"A",{href:!0});var Iy=n(Fi);ov=i(Iy,"TFWav2Vec2Model"),Iy.forEach(t),av=i(Ji," forward method, overrides the "),pc=s(Ji,"CODE",{});var By=n(pc);sv=i(By,"__call__"),By.forEach(t),nv=i(Ji," special method."),Ji.forEach(t),rv=p(ts),y(Ca.$$.fragment,ts),iv=p(ts),y(Ea.$$.fragment,ts),ts.forEach(t),gt.forEach(t),Ld=p(o),Fo=s(o,"H2",{class:!0});var Xp=n(Fo);Pa=s(Xp,"A",{id:!0,class:!0,href:!0});var Uy=n(Pa);mc=s(Uy,"SPAN",{});var Ry=n(mc);y(ar.$$.fragment,Ry),Ry.forEach(t),Uy.forEach(t),lv=p(Xp),hc=s(Xp,"SPAN",{});var Hy=n(hc);cv=i(Hy,"TFWav2Vec2ForCTC"),Hy.forEach(t),Xp.forEach(t),Dd=p(o),me=s(o,"DIV",{class:!0});var _t=n(me);y(sr.$$.fragment,_t),dv=p(_t),nr=s(_t,"P",{});var Kp=n(nr);pv=i(Kp,"TFWav2Vec2 Model with a "),fc=s(Kp,"CODE",{});var Xy=n(fc);mv=i(Xy,"language modeling"),Xy.forEach(t),hv=i(Kp," head on top for Connectionist Temporal Classification (CTC)."),Kp.forEach(t),fv=p(_t),rr=s(_t,"P",{});var Gp=n(rr);uv=i(Gp,"This model inherits from "),Ci=s(Gp,"A",{href:!0});var Ky=n(Ci);gv=i(Ky,"TFPreTrainedModel"),Ky.forEach(t),_v=i(Gp,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Gp.forEach(t),vv=p(_t),ir=s(_t,"P",{});var Jp=n(ir);bv=i(Jp,"This model is also a "),lr=s(Jp,"A",{href:!0,rel:!0});var Gy=n(lr);wv=i(Gy,"tf.keras.Model"),Gy.forEach(t),yv=i(Jp,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Jp.forEach(t),kv=p(_t),y(qa.$$.fragment,_t),Tv=p(_t),ct=s(_t,"DIV",{class:!0});var os=n(ct);y(cr.$$.fragment,os),$v=p(os),Co=s(os,"P",{});var Zi=n(Co);xv=i(Zi,"The "),Ei=s(Zi,"A",{href:!0});var Jy=n(Ei);Wv=i(Jy,"TFWav2Vec2ForCTC"),Jy.forEach(t),jv=i(Zi," forward method, overrides the "),uc=s(Zi,"CODE",{});var Zy=n(uc);Vv=i(Zy,"__call__"),Zy.forEach(t),Fv=i(Zi," special method."),Zi.forEach(t),Cv=p(os),y(za.$$.fragment,os),Ev=p(os),y(Ma.$$.fragment,os),os.forEach(t),_t.forEach(t),Sd=p(o),Eo=s(o,"H2",{class:!0});var Zp=n(Eo);Aa=s(Zp,"A",{id:!0,class:!0,href:!0});var Qy=n(Aa);gc=s(Qy,"SPAN",{});var Yy=n(gc);y(dr.$$.fragment,Yy),Yy.forEach(t),Qy.forEach(t),Pv=p(Zp),_c=s(Zp,"SPAN",{});var ek=n(_c);qv=i(ek,"FlaxWav2Vec2Model"),ek.forEach(t),Zp.forEach(t),Nd=p(o),Y=s(o,"DIV",{class:!0});var Ne=n(Y);y(pr.$$.fragment,Ne),zv=p(Ne),mr=s(Ne,"P",{});var Qp=n(mr);Mv=i(Qp,`The bare Wav2Vec2 Model transformer outputting raw hidden-states without any specific head on top.
Wav2Vec2 was proposed in `),hr=s(Qp,"A",{href:!0,rel:!0});var tk=n(hr);Av=i(tk,`wav2vec 2.0: A Framework for Self-Supervised Learning of Speech
Representations`),tk.forEach(t),Ov=i(Qp,` by Alexei Baevski, Henry Zhou, Abdelrahman Mohamed, Michael
Auli.`),Qp.forEach(t),Lv=p(Ne),fr=s(Ne,"P",{});var Yp=n(fr);Dv=i(Yp,"This model inherits from "),Pi=s(Yp,"A",{href:!0});var ok=n(Pi);Sv=i(ok,"FlaxPreTrainedModel"),ok.forEach(t),Nv=i(Yp,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Yp.forEach(t),Iv=p(Ne),ur=s(Ne,"P",{});var em=n(ur);Bv=i(em,`This model is also a Flax Linen
`),gr=s(em,"A",{href:!0,rel:!0});var ak=n(gr);Uv=i(ak,"flax.nn.Module"),ak.forEach(t),Rv=i(em,` subclass. Use it as a
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),em.forEach(t),Hv=p(Ne),vc=s(Ne,"P",{});var sk=n(vc);Xv=i(sk,"Finally, this model supports inherent JAX features such as:"),sk.forEach(t),Kv=p(Ne),zt=s(Ne,"UL",{});var as=n(zt);bc=s(as,"LI",{});var nk=n(bc);_r=s(nk,"A",{href:!0,rel:!0});var rk=n(_r);Gv=i(rk,"Just-In-Time (JIT) compilation"),rk.forEach(t),nk.forEach(t),Jv=p(as),wc=s(as,"LI",{});var ik=n(wc);vr=s(ik,"A",{href:!0,rel:!0});var lk=n(vr);Zv=i(lk,"Automatic Differentiation"),lk.forEach(t),ik.forEach(t),Qv=p(as),yc=s(as,"LI",{});var ck=n(yc);br=s(ck,"A",{href:!0,rel:!0});var dk=n(br);Yv=i(dk,"Vectorization"),dk.forEach(t),ck.forEach(t),e2=p(as),kc=s(as,"LI",{});var pk=n(kc);wr=s(pk,"A",{href:!0,rel:!0});var mk=n(wr);t2=i(mk,"Parallelization"),mk.forEach(t),pk.forEach(t),as.forEach(t),o2=p(Ne),dt=s(Ne,"DIV",{class:!0});var ss=n(dt);y(yr.$$.fragment,ss),a2=p(ss),Po=s(ss,"P",{});var Qi=n(Po);s2=i(Qi,"The "),Tc=s(Qi,"CODE",{});var hk=n(Tc);n2=i(hk,"FlaxWav2Vec2PreTrainedModel"),hk.forEach(t),r2=i(Qi," forward method, overrides the "),$c=s(Qi,"CODE",{});var fk=n($c);i2=i(fk,"__call__"),fk.forEach(t),l2=i(Qi," special method."),Qi.forEach(t),c2=p(ss),y(Oa.$$.fragment,ss),d2=p(ss),y(La.$$.fragment,ss),ss.forEach(t),Ne.forEach(t),Id=p(o),qo=s(o,"H2",{class:!0});var tm=n(qo);Da=s(tm,"A",{id:!0,class:!0,href:!0});var uk=n(Da);xc=s(uk,"SPAN",{});var gk=n(xc);y(kr.$$.fragment,gk),gk.forEach(t),uk.forEach(t),p2=p(tm),Wc=s(tm,"SPAN",{});var _k=n(Wc);m2=i(_k,"FlaxWav2Vec2ForCTC"),_k.forEach(t),tm.forEach(t),Bd=p(o),ee=s(o,"DIV",{class:!0});var Ie=n(ee);y(Tr.$$.fragment,Ie),h2=p(Ie),zo=s(Ie,"P",{});var Yi=n(zo);f2=i(Yi,"Wav2Vec2 Model with a "),jc=s(Yi,"CODE",{});var vk=n(jc);u2=i(vk,"language modeling"),vk.forEach(t),g2=i(Yi,` head on top for Connectionist Temporal Classification (CTC).
Wav2Vec2 was proposed in `),$r=s(Yi,"A",{href:!0,rel:!0});var bk=n($r);_2=i(bk,`wav2vec 2.0: A Framework for Self-Supervised Learning of Speech
Representations`),bk.forEach(t),v2=i(Yi,` by Alexei Baevski, Henry Zhou, Abdelrahman Mohamed, Michael
Auli.`),Yi.forEach(t),b2=p(Ie),xr=s(Ie,"P",{});var om=n(xr);w2=i(om,"This model inherits from "),qi=s(om,"A",{href:!0});var wk=n(qi);y2=i(wk,"FlaxPreTrainedModel"),wk.forEach(t),k2=i(om,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),om.forEach(t),T2=p(Ie),Wr=s(Ie,"P",{});var am=n(Wr);$2=i(am,`This model is also a Flax Linen
`),jr=s(am,"A",{href:!0,rel:!0});var yk=n(jr);x2=i(yk,"flax.nn.Module"),yk.forEach(t),W2=i(am,` subclass. Use it as a
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),am.forEach(t),j2=p(Ie),Vc=s(Ie,"P",{});var kk=n(Vc);V2=i(kk,"Finally, this model supports inherent JAX features such as:"),kk.forEach(t),F2=p(Ie),Mt=s(Ie,"UL",{});var ns=n(Mt);Fc=s(ns,"LI",{});var Tk=n(Fc);Vr=s(Tk,"A",{href:!0,rel:!0});var $k=n(Vr);C2=i($k,"Just-In-Time (JIT) compilation"),$k.forEach(t),Tk.forEach(t),E2=p(ns),Cc=s(ns,"LI",{});var xk=n(Cc);Fr=s(xk,"A",{href:!0,rel:!0});var Wk=n(Fr);P2=i(Wk,"Automatic Differentiation"),Wk.forEach(t),xk.forEach(t),q2=p(ns),Ec=s(ns,"LI",{});var jk=n(Ec);Cr=s(jk,"A",{href:!0,rel:!0});var Vk=n(Cr);z2=i(Vk,"Vectorization"),Vk.forEach(t),jk.forEach(t),M2=p(ns),Pc=s(ns,"LI",{});var Fk=n(Pc);Er=s(Fk,"A",{href:!0,rel:!0});var Ck=n(Er);A2=i(Ck,"Parallelization"),Ck.forEach(t),Fk.forEach(t),ns.forEach(t),O2=p(Ie),pt=s(Ie,"DIV",{class:!0});var rs=n(pt);y(Pr.$$.fragment,rs),L2=p(rs),Mo=s(rs,"P",{});var el=n(Mo);D2=i(el,"The "),qc=s(el,"CODE",{});var Ek=n(qc);S2=i(Ek,"FlaxWav2Vec2PreTrainedModel"),Ek.forEach(t),N2=i(el," forward method, overrides the "),zc=s(el,"CODE",{});var Pk=n(zc);I2=i(Pk,"__call__"),Pk.forEach(t),B2=i(el," special method."),el.forEach(t),U2=p(rs),y(Sa.$$.fragment,rs),R2=p(rs),y(Na.$$.fragment,rs),rs.forEach(t),Ie.forEach(t),Ud=p(o),Ao=s(o,"H2",{class:!0});var sm=n(Ao);Ia=s(sm,"A",{id:!0,class:!0,href:!0});var qk=n(Ia);Mc=s(qk,"SPAN",{});var zk=n(Mc);y(qr.$$.fragment,zk),zk.forEach(t),qk.forEach(t),H2=p(sm),Ac=s(sm,"SPAN",{});var Mk=n(Ac);X2=i(Mk,"FlaxWav2Vec2ForPreTraining"),Mk.forEach(t),sm.forEach(t),Rd=p(o),te=s(o,"DIV",{class:!0});var Be=n(te);y(zr.$$.fragment,Be),K2=p(Be),Oo=s(Be,"P",{});var tl=n(Oo);G2=i(tl,"Wav2Vec2 Model with a quantizer and "),Oc=s(tl,"CODE",{});var Ak=n(Oc);J2=i(Ak,"VQ"),Ak.forEach(t),Z2=i(tl,` head on top.
Wav2Vec2 was proposed in `),Mr=s(tl,"A",{href:!0,rel:!0});var Ok=n(Mr);Q2=i(Ok,`wav2vec 2.0: A Framework for Self-Supervised Learning of Speech
Representations`),Ok.forEach(t),Y2=i(tl,` by Alexei Baevski, Henry Zhou, Abdelrahman Mohamed, Michael
Auli.`),tl.forEach(t),eb=p(Be),Ar=s(Be,"P",{});var nm=n(Ar);tb=i(nm,"This model inherits from "),zi=s(nm,"A",{href:!0});var Lk=n(zi);ob=i(Lk,"FlaxPreTrainedModel"),Lk.forEach(t),ab=i(nm,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),nm.forEach(t),sb=p(Be),Or=s(Be,"P",{});var rm=n(Or);nb=i(rm,`This model is also a Flax Linen
`),Lr=s(rm,"A",{href:!0,rel:!0});var Dk=n(Lr);rb=i(Dk,"flax.nn.Module"),Dk.forEach(t),ib=i(rm,` subclass. Use it as a
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),rm.forEach(t),lb=p(Be),Lc=s(Be,"P",{});var Sk=n(Lc);cb=i(Sk,"Finally, this model supports inherent JAX features such as:"),Sk.forEach(t),db=p(Be),At=s(Be,"UL",{});var is=n(At);Dc=s(is,"LI",{});var Nk=n(Dc);Dr=s(Nk,"A",{href:!0,rel:!0});var Ik=n(Dr);pb=i(Ik,"Just-In-Time (JIT) compilation"),Ik.forEach(t),Nk.forEach(t),mb=p(is),Sc=s(is,"LI",{});var Bk=n(Sc);Sr=s(Bk,"A",{href:!0,rel:!0});var Uk=n(Sr);hb=i(Uk,"Automatic Differentiation"),Uk.forEach(t),Bk.forEach(t),fb=p(is),Nc=s(is,"LI",{});var Rk=n(Nc);Nr=s(Rk,"A",{href:!0,rel:!0});var Hk=n(Nr);ub=i(Hk,"Vectorization"),Hk.forEach(t),Rk.forEach(t),gb=p(is),Ic=s(is,"LI",{});var Xk=n(Ic);Ir=s(Xk,"A",{href:!0,rel:!0});var Kk=n(Ir);_b=i(Kk,"Parallelization"),Kk.forEach(t),Xk.forEach(t),is.forEach(t),vb=p(Be),mt=s(Be,"DIV",{class:!0});var ls=n(mt);y(Br.$$.fragment,ls),bb=p(ls),Lo=s(ls,"P",{});var ol=n(Lo);wb=i(ol,"The "),Mi=s(ol,"A",{href:!0});var Gk=n(Mi);yb=i(Gk,"FlaxWav2Vec2ForPreTraining"),Gk.forEach(t),kb=i(ol," forward method, overrides the "),Bc=s(ol,"CODE",{});var Jk=n(Bc);Tb=i(Jk,"__call__"),Jk.forEach(t),$b=i(ol," special method."),ol.forEach(t),xb=p(ls),y(Ba.$$.fragment,ls),Wb=p(ls),y(Ua.$$.fragment,ls),ls.forEach(t),Be.forEach(t),this.h()},h(){m(c,"name","hf:doc:metadata"),m(c,"content",JSON.stringify(MT)),m(u,"id","wav2vec2"),m(u,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),m(u,"href","#wav2vec2"),m(f,"class","relative group"),m(L,"id","overview"),m(L,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),m(L,"href","#overview"),m(z,"class","relative group"),m(ye,"href","https://arxiv.org/abs/2006.11477"),m(ye,"rel","nofollow"),m(D,"href","/docs/transformers/main/en/model_doc/wav2vec2#transformers.Wav2Vec2CTCTokenizer"),m(je,"href","https://huggingface.co/patrickvonplaten"),m(je,"rel","nofollow"),m(fe,"id","transformers.Wav2Vec2Config"),m(fe,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),m(fe,"href","#transformers.Wav2Vec2Config"),m(X,"class","relative group"),m(et,"href","/docs/transformers/main/en/model_doc/wav2vec2#transformers.Wav2Vec2Model"),m(He,"href","https://huggingface.co/facebook/wav2vec2-base-960h"),m(He,"rel","nofollow"),m(tt,"href","/docs/transformers/main/en/main_classes/configuration#transformers.PretrainedConfig"),m(ot,"href","/docs/transformers/main/en/main_classes/configuration#transformers.PretrainedConfig"),m(W,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),m(No,"id","transformers.Wav2Vec2CTCTokenizer"),m(No,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),m(No,"href","#transformers.Wav2Vec2CTCTokenizer"),m(so,"class","relative group"),m(Qr,"href","/docs/transformers/main/en/main_classes/tokenizer#transformers.PreTrainedTokenizer"),m(Io,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),m(Yr,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),m(at,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),m(Uo,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),m(Q,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),m(Ro,"id","transformers.Wav2Vec2FeatureExtractor"),m(Ro,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),m(Ro,"href","#transformers.Wav2Vec2FeatureExtractor"),m(no,"class","relative group"),m(ei,"href","/docs/transformers/main/en/main_classes/feature_extractor#transformers.SequenceFeatureExtractor"),m(Ho,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),m(Xe,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),m(Xo,"id","transformers.Wav2Vec2Processor"),m(Xo,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),m(Xo,"href","#transformers.Wav2Vec2Processor"),m(ro,"class","relative group"),m(ti,"href","/docs/transformers/main/en/model_doc/wav2vec2#transformers.Wav2Vec2Processor"),m(oi,"href","/docs/transformers/main/en/model_doc/wav2vec2#transformers.Wav2Vec2FeatureExtractor"),m(ai,"href","/docs/transformers/main/en/main_classes/tokenizer#transformers.PreTrainedTokenizer"),m(Ts,"href","/docs/transformers/main/en/model_doc/wav2vec2#transformers.Wav2Vec2Processor.__call__"),m(si,"href","/docs/transformers/main/en/model_doc/wav2vec2#transformers.Wav2Vec2Processor.decode"),m(xs,"href","/docs/transformers/main/en/model_doc/wav2vec2#transformers.Wav2Vec2FeatureExtractor.__call__"),m(Ws,"href","/docs/transformers/main/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__"),m(Ko,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),m(ni,"href","/docs/transformers/main/en/main_classes/feature_extractor#transformers.SequenceFeatureExtractor.pad"),m(ri,"href","/docs/transformers/main/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.pad"),m(Go,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),m(ii,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),m(li,"href","/docs/transformers/main/en/model_doc/trocr#transformers.TrOCRProcessor.from_pretrained"),m(St,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),m(ci,"href","/docs/transformers/main/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.batch_decode"),m(Zo,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),m(di,"href","/docs/transformers/main/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.decode"),m(Qo,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),m(U,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),m(Yo,"id","transformers.Wav2Vec2ProcessorWithLM"),m(Yo,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),m(Yo,"href","#transformers.Wav2Vec2ProcessorWithLM"),m(io,"class","relative group"),m(Ls,"href","/docs/transformers/main/en/model_doc/wav2vec2#transformers.Wav2Vec2FeatureExtractor.__call__"),m(Ds,"href","/docs/transformers/main/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__"),m(ea,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),m(pi,"href","/docs/transformers/main/en/main_classes/feature_extractor#transformers.SequenceFeatureExtractor.pad"),m(mi,"href","/docs/transformers/main/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.pad"),m(ta,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),m(hi,"href","/docs/transformers/main/en/model_doc/wav2vec2#transformers.Wav2Vec2ProcessorWithLM"),m(Nt,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),m(fi,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),m(It,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),m(Bt,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),m(G,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),m(na,"id","transformers.models.wav2vec2_with_lm.processing_wav2vec2_with_lm.Wav2Vec2DecoderWithLMOutput"),m(na,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),m(na,"href","#transformers.models.wav2vec2_with_lm.processing_wav2vec2_with_lm.Wav2Vec2DecoderWithLMOutput"),m(lo,"class","relative group"),m(co,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),m(po,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),m(ui,"href","/docs/transformers/main/en/model_doc/wav2vec2#transformers.Wav2Vec2ForPreTraining"),m(mo,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),m(ra,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),m(Pt,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),m(ia,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),m(qt,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),m(la,"id","transformers.Wav2Vec2Model"),m(la,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),m(la,"href","#transformers.Wav2Vec2Model"),m(ho,"class","relative group"),m(ln,"href","https://arxiv.org/abs/2006.11477"),m(ln,"rel","nofollow"),m(gi,"href","/docs/transformers/main/en/main_classes/model#transformers.PreTrainedModel"),m(pn,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),m(pn,"rel","nofollow"),m(_i,"href","/docs/transformers/main/en/model_doc/wav2vec2#transformers.Wav2Vec2Model"),m(st,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),m(Ee,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),m(pa,"id","transformers.Wav2Vec2ForCTC"),m(pa,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),m(pa,"href","#transformers.Wav2Vec2ForCTC"),m(uo,"class","relative group"),m(un,"href","https://arxiv.org/abs/2006.11477"),m(un,"rel","nofollow"),m(vi,"href","/docs/transformers/main/en/main_classes/model#transformers.PreTrainedModel"),m(vn,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),m(vn,"rel","nofollow"),m(bi,"href","/docs/transformers/main/en/model_doc/wav2vec2#transformers.Wav2Vec2ForCTC"),m(Le,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),m(Pe,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),m(ua,"id","transformers.Wav2Vec2ForSequenceClassification"),m(ua,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),m(ua,"href","#transformers.Wav2Vec2ForSequenceClassification"),m(vo,"class","relative group"),m(Tn,"href","https://arxiv.org/abs/2006.11477"),m(Tn,"rel","nofollow"),m(wi,"href","/docs/transformers/main/en/main_classes/model#transformers.PreTrainedModel"),m(Wn,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),m(Wn,"rel","nofollow"),m(yi,"href","/docs/transformers/main/en/model_doc/wav2vec2#transformers.Wav2Vec2ForSequenceClassification"),m(De,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),m(le,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),m(ba,"id","transformers.Wav2Vec2ForAudioFrameClassification"),m(ba,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),m(ba,"href","#transformers.Wav2Vec2ForAudioFrameClassification"),m(wo,"class","relative group"),m(En,"href","https://arxiv.org/abs/2006.11477"),m(En,"rel","nofollow"),m(ki,"href","/docs/transformers/main/en/main_classes/model#transformers.PreTrainedModel"),m(zn,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),m(zn,"rel","nofollow"),m(Ti,"href","/docs/transformers/main/en/model_doc/wav2vec2#transformers.Wav2Vec2ForAudioFrameClassification"),m(nt,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),m(ce,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),m(ka,"id","transformers.Wav2Vec2ForXVector"),m(ka,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),m(ka,"href","#transformers.Wav2Vec2ForXVector"),m(ko,"class","relative group"),m(Dn,"href","https://arxiv.org/abs/2006.11477"),m(Dn,"rel","nofollow"),m($i,"href","/docs/transformers/main/en/main_classes/model#transformers.PreTrainedModel"),m(In,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),m(In,"rel","nofollow"),m(xi,"href","/docs/transformers/main/en/model_doc/wav2vec2#transformers.Wav2Vec2ForXVector"),m(rt,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),m(de,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),m(xa,"id","transformers.Wav2Vec2ForPreTraining"),m(xa,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),m(xa,"href","#transformers.Wav2Vec2ForPreTraining"),m($o,"class","relative group"),m(Hn,"href","https://arxiv.org/abs/2006.11477"),m(Hn,"rel","nofollow"),m(Wi,"href","/docs/transformers/main/en/main_classes/model#transformers.PreTrainedModel"),m(Gn,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),m(Gn,"rel","nofollow"),m(ji,"href","/docs/transformers/main/en/model_doc/wav2vec2#transformers.Wav2Vec2ForPreTraining"),m(it,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),m(qe,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),m(Va,"id","transformers.TFWav2Vec2Model"),m(Va,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),m(Va,"href","#transformers.TFWav2Vec2Model"),m(jo,"class","relative group"),m(Vi,"href","/docs/transformers/main/en/main_classes/model#transformers.TFPreTrainedModel"),m(tr,"href","https://www.tensorflow.org/api_docs/python/tf/keras/Model"),m(tr,"rel","nofollow"),m(Fi,"href","/docs/transformers/main/en/model_doc/wav2vec2#transformers.TFWav2Vec2Model"),m(lt,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),m(pe,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),m(Pa,"id","transformers.TFWav2Vec2ForCTC"),m(Pa,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),m(Pa,"href","#transformers.TFWav2Vec2ForCTC"),m(Fo,"class","relative group"),m(Ci,"href","/docs/transformers/main/en/main_classes/model#transformers.TFPreTrainedModel"),m(lr,"href","https://www.tensorflow.org/api_docs/python/tf/keras/Model"),m(lr,"rel","nofollow"),m(Ei,"href","/docs/transformers/main/en/model_doc/wav2vec2#transformers.TFWav2Vec2ForCTC"),m(ct,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),m(me,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),m(Aa,"id","transformers.FlaxWav2Vec2Model"),m(Aa,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),m(Aa,"href","#transformers.FlaxWav2Vec2Model"),m(Eo,"class","relative group"),m(hr,"href","https://arxiv.org/abs/2006.11477"),m(hr,"rel","nofollow"),m(Pi,"href","/docs/transformers/main/en/main_classes/model#transformers.FlaxPreTrainedModel"),m(gr,"href","https://flax.readthedocs.io/en/latest/_autosummary/flax.nn.module.html"),m(gr,"rel","nofollow"),m(_r,"href","https://jax.readthedocs.io/en/latest/jax.html#just-in-time-compilation-jit"),m(_r,"rel","nofollow"),m(vr,"href","https://jax.readthedocs.io/en/latest/jax.html#automatic-differentiation"),m(vr,"rel","nofollow"),m(br,"href","https://jax.readthedocs.io/en/latest/jax.html#vectorization-vmap"),m(br,"rel","nofollow"),m(wr,"href","https://jax.readthedocs.io/en/latest/jax.html#parallelization-pmap"),m(wr,"rel","nofollow"),m(dt,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),m(Y,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),m(Da,"id","transformers.FlaxWav2Vec2ForCTC"),m(Da,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),m(Da,"href","#transformers.FlaxWav2Vec2ForCTC"),m(qo,"class","relative group"),m($r,"href","https://arxiv.org/abs/2006.11477"),m($r,"rel","nofollow"),m(qi,"href","/docs/transformers/main/en/main_classes/model#transformers.FlaxPreTrainedModel"),m(jr,"href","https://flax.readthedocs.io/en/latest/_autosummary/flax.nn.module.html"),m(jr,"rel","nofollow"),m(Vr,"href","https://jax.readthedocs.io/en/latest/jax.html#just-in-time-compilation-jit"),m(Vr,"rel","nofollow"),m(Fr,"href","https://jax.readthedocs.io/en/latest/jax.html#automatic-differentiation"),m(Fr,"rel","nofollow"),m(Cr,"href","https://jax.readthedocs.io/en/latest/jax.html#vectorization-vmap"),m(Cr,"rel","nofollow"),m(Er,"href","https://jax.readthedocs.io/en/latest/jax.html#parallelization-pmap"),m(Er,"rel","nofollow"),m(pt,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),m(ee,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),m(Ia,"id","transformers.FlaxWav2Vec2ForPreTraining"),m(Ia,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),m(Ia,"href","#transformers.FlaxWav2Vec2ForPreTraining"),m(Ao,"class","relative group"),m(Mr,"href","https://arxiv.org/abs/2006.11477"),m(Mr,"rel","nofollow"),m(zi,"href","/docs/transformers/main/en/main_classes/model#transformers.FlaxPreTrainedModel"),m(Lr,"href","https://flax.readthedocs.io/en/latest/_autosummary/flax.nn.module.html"),m(Lr,"rel","nofollow"),m(Dr,"href","https://jax.readthedocs.io/en/latest/jax.html#just-in-time-compilation-jit"),m(Dr,"rel","nofollow"),m(Sr,"href","https://jax.readthedocs.io/en/latest/jax.html#automatic-differentiation"),m(Sr,"rel","nofollow"),m(Nr,"href","https://jax.readthedocs.io/en/latest/jax.html#vectorization-vmap"),m(Nr,"rel","nofollow"),m(Ir,"href","https://jax.readthedocs.io/en/latest/jax.html#parallelization-pmap"),m(Ir,"rel","nofollow"),m(Mi,"href","/docs/transformers/main/en/model_doc/wav2vec2#transformers.FlaxWav2Vec2ForPreTraining"),m(mt,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),m(te,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8")},m(o,g){e(document.head,c),_(o,b,g),_(o,f,g),e(f,u),e(u,v),k(l,v,null),e(f,h),e(f,V),e(V,S),_(o,A,g),_(o,z,g),e(z,L),e(L,R),k(C,R,null),e(z,N),e(z,P),e(P,ze),_(o,we,g),_(o,I,g),e(I,Me),e(I,ye),e(ye,ke),e(I,vt),_(o,Ke,g),_(o,ae,g),e(ae,bt),_(o,Ge,g),_(o,se,g),e(se,Ue),e(Ue,wt),_(o,Ae,g),_(o,M,g),e(M,H),_(o,Je,g),_(o,J,g),e(J,Re),e(Re,yt),e(J,Te),e(J,$e),e($e,kt),e($e,D),e(D,Tt),e($e,xe),_(o,Ze,g),_(o,he,g),e(he,We),e(he,je),e(je,$t),e(he,ie),_(o,Qe,g),_(o,X,g),e(X,fe),e(fe,Ve),k(O,Ve,null),e(X,xt),e(X,K),e(K,Wt),_(o,Ye,g),_(o,W,g),k(E,W,null),e(W,Gt),e(W,Z),e(Z,Jt),e(Z,et),e(et,q),e(Z,Zt),e(Z,He),e(He,Qt),e(Z,Yt),e(W,eo),e(W,B),e(B,Fe),e(B,tt),e(tt,to),e(B,Ce),e(B,ot),e(ot,oo),e(B,jt),e(W,ao),k(ne,W,null),_(o,Dt,g),_(o,so,g),e(so,No),e(No,al),k(cs,al,null),e(so,im),e(so,sl),e(sl,lm),_(o,pd,g),_(o,Q,g),k(ds,Q,null),e(Q,cm),e(Q,nl),e(nl,dm),e(Q,pm),e(Q,ps),e(ps,mm),e(ps,Qr),e(Qr,hm),e(ps,fm),e(Q,um),e(Q,Io),k(ms,Io,null),e(Io,gm),e(Io,rl),e(rl,_m),e(Q,vm),e(Q,Yr),k(hs,Yr,null),e(Q,bm),e(Q,at),k(fs,at,null),e(at,wm),e(at,il),e(il,ym),e(at,km),e(at,us),e(us,Tm),e(us,ll),e(ll,$m),e(us,xm),e(at,Wm),k(Bo,at,null),e(Q,jm),e(Q,Uo),k(gs,Uo,null),e(Uo,Vm),e(Uo,cl),e(cl,Fm),_(o,md,g),_(o,no,g),e(no,Ro),e(Ro,dl),k(_s,dl,null),e(no,Cm),e(no,pl),e(pl,Em),_(o,hd,g),_(o,Xe,g),k(vs,Xe,null),e(Xe,Pm),e(Xe,ml),e(ml,qm),e(Xe,zm),e(Xe,bs),e(bs,Mm),e(bs,ei),e(ei,Am),e(bs,Om),e(Xe,Lm),e(Xe,Ho),k(ws,Ho,null),e(Ho,Dm),e(Ho,hl),e(hl,Sm),_(o,fd,g),_(o,ro,g),e(ro,Xo),e(Xo,fl),k(ys,fl,null),e(ro,Nm),e(ro,ul),e(ul,Im),_(o,ud,g),_(o,U,g),k(ks,U,null),e(U,Bm),e(U,gl),e(gl,Um),e(U,Rm),e(U,Oe),e(Oe,ti),e(ti,Hm),e(Oe,Xm),e(Oe,oi),e(oi,Km),e(Oe,Gm),e(Oe,ai),e(ai,Jm),e(Oe,Zm),e(Oe,Ts),e(Ts,_l),e(_l,Qm),e(Ts,Ym),e(Oe,eh),e(Oe,si),e(si,th),e(Oe,oh),e(U,ah),e(U,Ko),k($s,Ko,null),e(Ko,sh),e(Ko,Vt),e(Vt,nh),e(Vt,xs),e(xs,vl),e(vl,rh),e(xs,ih),e(Vt,lh),e(Vt,bl),e(bl,ch),e(Vt,dh),e(Vt,Ws),e(Ws,wl),e(wl,ph),e(Ws,mh),e(Vt,hh),e(U,fh),e(U,Go),k(js,Go,null),e(Go,uh),e(Go,Ft),e(Ft,gh),e(Ft,ni),e(ni,_h),e(Ft,vh),e(Ft,yl),e(yl,bh),e(Ft,wh),e(Ft,ri),e(ri,yh),e(Ft,kh),e(U,Th),e(U,ii),k(Vs,ii,null),e(U,$h),e(U,St),k(Fs,St,null),e(St,xh),e(St,Cs),e(Cs,Wh),e(Cs,li),e(li,jh),e(Cs,Vh),e(St,Fh),k(Jo,St,null),e(U,Ch),e(U,Zo),k(Es,Zo,null),e(Zo,Eh),e(Zo,Ps),e(Ps,Ph),e(Ps,ci),e(ci,qh),e(Ps,zh),e(U,Mh),e(U,Qo),k(qs,Qo,null),e(Qo,Ah),e(Qo,zs),e(zs,Oh),e(zs,di),e(di,Lh),e(zs,Dh),_(o,gd,g),_(o,io,g),e(io,Yo),e(Yo,kl),k(Ms,kl,null),e(io,Sh),e(io,Tl),e(Tl,Nh),_(o,_d,g),_(o,G,g),k(As,G,null),e(G,Ih),e(G,$l),e($l,Bh),e(G,Uh),e(G,ea),k(Os,ea,null),e(ea,Rh),e(ea,Ct),e(Ct,Hh),e(Ct,Ls),e(Ls,xl),e(xl,Xh),e(Ls,Kh),e(Ct,Gh),e(Ct,Wl),e(Wl,Jh),e(Ct,Zh),e(Ct,Ds),e(Ds,jl),e(jl,Qh),e(Ds,Yh),e(Ct,ef),e(G,tf),e(G,ta),k(Ss,ta,null),e(ta,of),e(ta,Et),e(Et,af),e(Et,pi),e(pi,sf),e(Et,nf),e(Et,Vl),e(Vl,rf),e(Et,lf),e(Et,mi),e(mi,cf),e(Et,df),e(G,pf),e(G,Nt),k(Ns,Nt,null),e(Nt,mf),e(Nt,Is),e(Is,hf),e(Is,hi),e(hi,ff),e(Is,uf),e(Nt,gf),k(oa,Nt,null),e(G,_f),e(G,fi),k(Bs,fi,null),e(G,vf),e(G,It),k(Us,It,null),e(It,bf),e(It,Fl),e(Fl,wf),e(It,yf),k(aa,It,null),e(G,kf),e(G,Bt),k(Rs,Bt,null),e(Bt,Tf),e(Bt,Cl),e(Cl,$f),e(Bt,xf),k(sa,Bt,null),_(o,vd,g),_(o,lo,g),e(lo,na),e(na,El),k(Hs,El,null),e(lo,Wf),e(lo,Pl),e(Pl,jf),_(o,bd,g),_(o,co,g),k(Xs,co,null),e(co,Vf),e(co,Ks),e(Ks,Ff),e(Ks,ql),e(ql,Cf),e(Ks,Ef),_(o,wd,g),_(o,po,g),k(Gs,po,null),e(po,Pf),e(po,zl),e(zl,qf),_(o,yd,g),_(o,mo,g),k(Js,mo,null),e(mo,zf),e(mo,Zs),e(Zs,Mf),e(Zs,ui),e(ui,Af),e(Zs,Of),_(o,kd,g),_(o,Pt,g),k(Qs,Pt,null),e(Pt,Lf),e(Pt,Ys),e(Ys,Df),e(Ys,Ml),e(Ml,Sf),e(Ys,Nf),e(Pt,If),e(Pt,ra),k(en,ra,null),e(ra,Bf),e(ra,Al),e(Al,Uf),_(o,Td,g),_(o,qt,g),k(tn,qt,null),e(qt,Rf),e(qt,on),e(on,Hf),e(on,Ol),e(Ol,Xf),e(on,Kf),e(qt,Gf),e(qt,ia),k(an,ia,null),e(ia,Jf),e(ia,Ll),e(Ll,Zf),_(o,$d,g),_(o,ho,g),e(ho,la),e(la,Dl),k(sn,Dl,null),e(ho,Qf),e(ho,Sl),e(Sl,Yf),_(o,xd,g),_(o,Ee,g),k(nn,Ee,null),e(Ee,eu),e(Ee,rn),e(rn,tu),e(rn,ln),e(ln,ou),e(rn,au),e(Ee,su),e(Ee,cn),e(cn,nu),e(cn,gi),e(gi,ru),e(cn,iu),e(Ee,lu),e(Ee,dn),e(dn,cu),e(dn,pn),e(pn,du),e(dn,pu),e(Ee,mu),e(Ee,st),k(mn,st,null),e(st,hu),e(st,fo),e(fo,fu),e(fo,_i),e(_i,uu),e(fo,gu),e(fo,Nl),e(Nl,_u),e(fo,vu),e(st,bu),k(ca,st,null),e(st,wu),k(da,st,null),_(o,Wd,g),_(o,uo,g),e(uo,pa),e(pa,Il),k(hn,Il,null),e(uo,yu),e(uo,Bl),e(Bl,ku),_(o,jd,g),_(o,Pe,g),k(fn,Pe,null),e(Pe,Tu),e(Pe,go),e(go,$u),e(go,Ul),e(Ul,xu),e(go,Wu),e(go,un),e(un,ju),e(go,Vu),e(Pe,Fu),e(Pe,gn),e(gn,Cu),e(gn,vi),e(vi,Eu),e(gn,Pu),e(Pe,qu),e(Pe,_n),e(_n,zu),e(_n,vn),e(vn,Mu),e(_n,Au),e(Pe,Ou),e(Pe,Le),k(bn,Le,null),e(Le,Lu),e(Le,_o),e(_o,Du),e(_o,bi),e(bi,Su),e(_o,Nu),e(_o,Rl),e(Rl,Iu),e(_o,Bu),e(Le,Uu),k(ma,Le,null),e(Le,Ru),k(ha,Le,null),e(Le,Hu),k(fa,Le,null),_(o,Vd,g),_(o,vo,g),e(vo,ua),e(ua,Hl),k(wn,Hl,null),e(vo,Xu),e(vo,Xl),e(Xl,Ku),_(o,Fd,g),_(o,le,g),k(yn,le,null),e(le,Gu),e(le,Kl),e(Kl,Ju),e(le,Zu),e(le,kn),e(kn,Qu),e(kn,Tn),e(Tn,Yu),e(kn,eg),e(le,tg),e(le,$n),e($n,og),e($n,wi),e(wi,ag),e($n,sg),e(le,ng),e(le,xn),e(xn,rg),e(xn,Wn),e(Wn,ig),e(xn,lg),e(le,cg),e(le,De),k(jn,De,null),e(De,dg),e(De,bo),e(bo,pg),e(bo,yi),e(yi,mg),e(bo,hg),e(bo,Gl),e(Gl,fg),e(bo,ug),e(De,gg),k(ga,De,null),e(De,_g),k(_a,De,null),e(De,vg),k(va,De,null),_(o,Cd,g),_(o,wo,g),e(wo,ba),e(ba,Jl),k(Vn,Jl,null),e(wo,bg),e(wo,Zl),e(Zl,wg),_(o,Ed,g),_(o,ce,g),k(Fn,ce,null),e(ce,yg),e(ce,Ql),e(Ql,kg),e(ce,Tg),e(ce,Cn),e(Cn,$g),e(Cn,En),e(En,xg),e(Cn,Wg),e(ce,jg),e(ce,Pn),e(Pn,Vg),e(Pn,ki),e(ki,Fg),e(Pn,Cg),e(ce,Eg),e(ce,qn),e(qn,Pg),e(qn,zn),e(zn,qg),e(qn,zg),e(ce,Mg),e(ce,nt),k(Mn,nt,null),e(nt,Ag),e(nt,yo),e(yo,Og),e(yo,Ti),e(Ti,Lg),e(yo,Dg),e(yo,Yl),e(Yl,Sg),e(yo,Ng),e(nt,Ig),k(wa,nt,null),e(nt,Bg),k(ya,nt,null),_(o,Pd,g),_(o,ko,g),e(ko,ka),e(ka,ec),k(An,ec,null),e(ko,Ug),e(ko,tc),e(tc,Rg),_(o,qd,g),_(o,de,g),k(On,de,null),e(de,Hg),e(de,oc),e(oc,Xg),e(de,Kg),e(de,Ln),e(Ln,Gg),e(Ln,Dn),e(Dn,Jg),e(Ln,Zg),e(de,Qg),e(de,Sn),e(Sn,Yg),e(Sn,$i),e($i,e_),e(Sn,t_),e(de,o_),e(de,Nn),e(Nn,a_),e(Nn,In),e(In,s_),e(Nn,n_),e(de,r_),e(de,rt),k(Bn,rt,null),e(rt,i_),e(rt,To),e(To,l_),e(To,xi),e(xi,c_),e(To,d_),e(To,ac),e(ac,p_),e(To,m_),e(rt,h_),k(Ta,rt,null),e(rt,f_),k($a,rt,null),_(o,zd,g),_(o,$o,g),e($o,xa),e(xa,sc),k(Un,sc,null),e($o,u_),e($o,nc),e(nc,g_),_(o,Md,g),_(o,qe,g),k(Rn,qe,null),e(qe,__),e(qe,xo),e(xo,v_),e(xo,rc),e(rc,b_),e(xo,w_),e(xo,Hn),e(Hn,y_),e(xo,k_),e(qe,T_),e(qe,Xn),e(Xn,$_),e(Xn,Wi),e(Wi,x_),e(Xn,W_),e(qe,j_),e(qe,Kn),e(Kn,V_),e(Kn,Gn),e(Gn,F_),e(Kn,C_),e(qe,E_),e(qe,it),k(Jn,it,null),e(it,P_),e(it,Wo),e(Wo,q_),e(Wo,ji),e(ji,z_),e(Wo,M_),e(Wo,ic),e(ic,A_),e(Wo,O_),e(it,L_),k(Wa,it,null),e(it,D_),k(ja,it,null),_(o,Ad,g),_(o,jo,g),e(jo,Va),e(Va,lc),k(Zn,lc,null),e(jo,S_),e(jo,cc),e(cc,N_),_(o,Od,g),_(o,pe,g),k(Qn,pe,null),e(pe,I_),e(pe,dc),e(dc,B_),e(pe,U_),e(pe,Yn),e(Yn,R_),e(Yn,Vi),e(Vi,H_),e(Yn,X_),e(pe,K_),e(pe,er),e(er,G_),e(er,tr),e(tr,J_),e(er,Z_),e(pe,Q_),k(Fa,pe,null),e(pe,Y_),e(pe,lt),k(or,lt,null),e(lt,ev),e(lt,Vo),e(Vo,tv),e(Vo,Fi),e(Fi,ov),e(Vo,av),e(Vo,pc),e(pc,sv),e(Vo,nv),e(lt,rv),k(Ca,lt,null),e(lt,iv),k(Ea,lt,null),_(o,Ld,g),_(o,Fo,g),e(Fo,Pa),e(Pa,mc),k(ar,mc,null),e(Fo,lv),e(Fo,hc),e(hc,cv),_(o,Dd,g),_(o,me,g),k(sr,me,null),e(me,dv),e(me,nr),e(nr,pv),e(nr,fc),e(fc,mv),e(nr,hv),e(me,fv),e(me,rr),e(rr,uv),e(rr,Ci),e(Ci,gv),e(rr,_v),e(me,vv),e(me,ir),e(ir,bv),e(ir,lr),e(lr,wv),e(ir,yv),e(me,kv),k(qa,me,null),e(me,Tv),e(me,ct),k(cr,ct,null),e(ct,$v),e(ct,Co),e(Co,xv),e(Co,Ei),e(Ei,Wv),e(Co,jv),e(Co,uc),e(uc,Vv),e(Co,Fv),e(ct,Cv),k(za,ct,null),e(ct,Ev),k(Ma,ct,null),_(o,Sd,g),_(o,Eo,g),e(Eo,Aa),e(Aa,gc),k(dr,gc,null),e(Eo,Pv),e(Eo,_c),e(_c,qv),_(o,Nd,g),_(o,Y,g),k(pr,Y,null),e(Y,zv),e(Y,mr),e(mr,Mv),e(mr,hr),e(hr,Av),e(mr,Ov),e(Y,Lv),e(Y,fr),e(fr,Dv),e(fr,Pi),e(Pi,Sv),e(fr,Nv),e(Y,Iv),e(Y,ur),e(ur,Bv),e(ur,gr),e(gr,Uv),e(ur,Rv),e(Y,Hv),e(Y,vc),e(vc,Xv),e(Y,Kv),e(Y,zt),e(zt,bc),e(bc,_r),e(_r,Gv),e(zt,Jv),e(zt,wc),e(wc,vr),e(vr,Zv),e(zt,Qv),e(zt,yc),e(yc,br),e(br,Yv),e(zt,e2),e(zt,kc),e(kc,wr),e(wr,t2),e(Y,o2),e(Y,dt),k(yr,dt,null),e(dt,a2),e(dt,Po),e(Po,s2),e(Po,Tc),e(Tc,n2),e(Po,r2),e(Po,$c),e($c,i2),e(Po,l2),e(dt,c2),k(Oa,dt,null),e(dt,d2),k(La,dt,null),_(o,Id,g),_(o,qo,g),e(qo,Da),e(Da,xc),k(kr,xc,null),e(qo,p2),e(qo,Wc),e(Wc,m2),_(o,Bd,g),_(o,ee,g),k(Tr,ee,null),e(ee,h2),e(ee,zo),e(zo,f2),e(zo,jc),e(jc,u2),e(zo,g2),e(zo,$r),e($r,_2),e(zo,v2),e(ee,b2),e(ee,xr),e(xr,w2),e(xr,qi),e(qi,y2),e(xr,k2),e(ee,T2),e(ee,Wr),e(Wr,$2),e(Wr,jr),e(jr,x2),e(Wr,W2),e(ee,j2),e(ee,Vc),e(Vc,V2),e(ee,F2),e(ee,Mt),e(Mt,Fc),e(Fc,Vr),e(Vr,C2),e(Mt,E2),e(Mt,Cc),e(Cc,Fr),e(Fr,P2),e(Mt,q2),e(Mt,Ec),e(Ec,Cr),e(Cr,z2),e(Mt,M2),e(Mt,Pc),e(Pc,Er),e(Er,A2),e(ee,O2),e(ee,pt),k(Pr,pt,null),e(pt,L2),e(pt,Mo),e(Mo,D2),e(Mo,qc),e(qc,S2),e(Mo,N2),e(Mo,zc),e(zc,I2),e(Mo,B2),e(pt,U2),k(Sa,pt,null),e(pt,R2),k(Na,pt,null),_(o,Ud,g),_(o,Ao,g),e(Ao,Ia),e(Ia,Mc),k(qr,Mc,null),e(Ao,H2),e(Ao,Ac),e(Ac,X2),_(o,Rd,g),_(o,te,g),k(zr,te,null),e(te,K2),e(te,Oo),e(Oo,G2),e(Oo,Oc),e(Oc,J2),e(Oo,Z2),e(Oo,Mr),e(Mr,Q2),e(Oo,Y2),e(te,eb),e(te,Ar),e(Ar,tb),e(Ar,zi),e(zi,ob),e(Ar,ab),e(te,sb),e(te,Or),e(Or,nb),e(Or,Lr),e(Lr,rb),e(Or,ib),e(te,lb),e(te,Lc),e(Lc,cb),e(te,db),e(te,At),e(At,Dc),e(Dc,Dr),e(Dr,pb),e(At,mb),e(At,Sc),e(Sc,Sr),e(Sr,hb),e(At,fb),e(At,Nc),e(Nc,Nr),e(Nr,ub),e(At,gb),e(At,Ic),e(Ic,Ir),e(Ir,_b),e(te,vb),e(te,mt),k(Br,mt,null),e(mt,bb),e(mt,Lo),e(Lo,wb),e(Lo,Mi),e(Mi,yb),e(Lo,kb),e(Lo,Bc),e(Bc,Tb),e(Lo,$b),e(mt,xb),k(Ba,mt,null),e(mt,Wb),k(Ua,mt,null),Hd=!0},p(o,[g]){const Ur={};g&2&&(Ur.$$scope={dirty:g,ctx:o}),ne.$set(Ur);const Uc={};g&2&&(Uc.$$scope={dirty:g,ctx:o}),Bo.$set(Uc);const Rc={};g&2&&(Rc.$$scope={dirty:g,ctx:o}),Jo.$set(Rc);const Hc={};g&2&&(Hc.$$scope={dirty:g,ctx:o}),oa.$set(Hc);const Rr={};g&2&&(Rr.$$scope={dirty:g,ctx:o}),aa.$set(Rr);const Xc={};g&2&&(Xc.$$scope={dirty:g,ctx:o}),sa.$set(Xc);const Kc={};g&2&&(Kc.$$scope={dirty:g,ctx:o}),ca.$set(Kc);const Gc={};g&2&&(Gc.$$scope={dirty:g,ctx:o}),da.$set(Gc);const Hr={};g&2&&(Hr.$$scope={dirty:g,ctx:o}),ma.$set(Hr);const Jc={};g&2&&(Jc.$$scope={dirty:g,ctx:o}),ha.$set(Jc);const Zc={};g&2&&(Zc.$$scope={dirty:g,ctx:o}),fa.$set(Zc);const Qc={};g&2&&(Qc.$$scope={dirty:g,ctx:o}),ga.$set(Qc);const Yc={};g&2&&(Yc.$$scope={dirty:g,ctx:o}),_a.$set(Yc);const ed={};g&2&&(ed.$$scope={dirty:g,ctx:o}),va.$set(ed);const Xr={};g&2&&(Xr.$$scope={dirty:g,ctx:o}),wa.$set(Xr);const td={};g&2&&(td.$$scope={dirty:g,ctx:o}),ya.$set(td);const Kr={};g&2&&(Kr.$$scope={dirty:g,ctx:o}),Ta.$set(Kr);const od={};g&2&&(od.$$scope={dirty:g,ctx:o}),$a.$set(od);const Gr={};g&2&&(Gr.$$scope={dirty:g,ctx:o}),Wa.$set(Gr);const ad={};g&2&&(ad.$$scope={dirty:g,ctx:o}),ja.$set(ad);const Jr={};g&2&&(Jr.$$scope={dirty:g,ctx:o}),Fa.$set(Jr);const sd={};g&2&&(sd.$$scope={dirty:g,ctx:o}),Ca.$set(sd);const nd={};g&2&&(nd.$$scope={dirty:g,ctx:o}),Ea.$set(nd);const rd={};g&2&&(rd.$$scope={dirty:g,ctx:o}),qa.$set(rd);const Ot={};g&2&&(Ot.$$scope={dirty:g,ctx:o}),za.$set(Ot);const Do={};g&2&&(Do.$$scope={dirty:g,ctx:o}),Ma.$set(Do);const id={};g&2&&(id.$$scope={dirty:g,ctx:o}),Oa.$set(id);const ld={};g&2&&(ld.$$scope={dirty:g,ctx:o}),La.$set(ld);const So={};g&2&&(So.$$scope={dirty:g,ctx:o}),Sa.$set(So);const cd={};g&2&&(cd.$$scope={dirty:g,ctx:o}),Na.$set(cd);const dd={};g&2&&(dd.$$scope={dirty:g,ctx:o}),Ba.$set(dd);const Zr={};g&2&&(Zr.$$scope={dirty:g,ctx:o}),Ua.$set(Zr)},i(o){Hd||(T(l.$$.fragment,o),T(C.$$.fragment,o),T(O.$$.fragment,o),T(E.$$.fragment,o),T(ne.$$.fragment,o),T(cs.$$.fragment,o),T(ds.$$.fragment,o),T(ms.$$.fragment,o),T(hs.$$.fragment,o),T(fs.$$.fragment,o),T(Bo.$$.fragment,o),T(gs.$$.fragment,o),T(_s.$$.fragment,o),T(vs.$$.fragment,o),T(ws.$$.fragment,o),T(ys.$$.fragment,o),T(ks.$$.fragment,o),T($s.$$.fragment,o),T(js.$$.fragment,o),T(Vs.$$.fragment,o),T(Fs.$$.fragment,o),T(Jo.$$.fragment,o),T(Es.$$.fragment,o),T(qs.$$.fragment,o),T(Ms.$$.fragment,o),T(As.$$.fragment,o),T(Os.$$.fragment,o),T(Ss.$$.fragment,o),T(Ns.$$.fragment,o),T(oa.$$.fragment,o),T(Bs.$$.fragment,o),T(Us.$$.fragment,o),T(aa.$$.fragment,o),T(Rs.$$.fragment,o),T(sa.$$.fragment,o),T(Hs.$$.fragment,o),T(Xs.$$.fragment,o),T(Gs.$$.fragment,o),T(Js.$$.fragment,o),T(Qs.$$.fragment,o),T(en.$$.fragment,o),T(tn.$$.fragment,o),T(an.$$.fragment,o),T(sn.$$.fragment,o),T(nn.$$.fragment,o),T(mn.$$.fragment,o),T(ca.$$.fragment,o),T(da.$$.fragment,o),T(hn.$$.fragment,o),T(fn.$$.fragment,o),T(bn.$$.fragment,o),T(ma.$$.fragment,o),T(ha.$$.fragment,o),T(fa.$$.fragment,o),T(wn.$$.fragment,o),T(yn.$$.fragment,o),T(jn.$$.fragment,o),T(ga.$$.fragment,o),T(_a.$$.fragment,o),T(va.$$.fragment,o),T(Vn.$$.fragment,o),T(Fn.$$.fragment,o),T(Mn.$$.fragment,o),T(wa.$$.fragment,o),T(ya.$$.fragment,o),T(An.$$.fragment,o),T(On.$$.fragment,o),T(Bn.$$.fragment,o),T(Ta.$$.fragment,o),T($a.$$.fragment,o),T(Un.$$.fragment,o),T(Rn.$$.fragment,o),T(Jn.$$.fragment,o),T(Wa.$$.fragment,o),T(ja.$$.fragment,o),T(Zn.$$.fragment,o),T(Qn.$$.fragment,o),T(Fa.$$.fragment,o),T(or.$$.fragment,o),T(Ca.$$.fragment,o),T(Ea.$$.fragment,o),T(ar.$$.fragment,o),T(sr.$$.fragment,o),T(qa.$$.fragment,o),T(cr.$$.fragment,o),T(za.$$.fragment,o),T(Ma.$$.fragment,o),T(dr.$$.fragment,o),T(pr.$$.fragment,o),T(yr.$$.fragment,o),T(Oa.$$.fragment,o),T(La.$$.fragment,o),T(kr.$$.fragment,o),T(Tr.$$.fragment,o),T(Pr.$$.fragment,o),T(Sa.$$.fragment,o),T(Na.$$.fragment,o),T(qr.$$.fragment,o),T(zr.$$.fragment,o),T(Br.$$.fragment,o),T(Ba.$$.fragment,o),T(Ua.$$.fragment,o),Hd=!0)},o(o){$(l.$$.fragment,o),$(C.$$.fragment,o),$(O.$$.fragment,o),$(E.$$.fragment,o),$(ne.$$.fragment,o),$(cs.$$.fragment,o),$(ds.$$.fragment,o),$(ms.$$.fragment,o),$(hs.$$.fragment,o),$(fs.$$.fragment,o),$(Bo.$$.fragment,o),$(gs.$$.fragment,o),$(_s.$$.fragment,o),$(vs.$$.fragment,o),$(ws.$$.fragment,o),$(ys.$$.fragment,o),$(ks.$$.fragment,o),$($s.$$.fragment,o),$(js.$$.fragment,o),$(Vs.$$.fragment,o),$(Fs.$$.fragment,o),$(Jo.$$.fragment,o),$(Es.$$.fragment,o),$(qs.$$.fragment,o),$(Ms.$$.fragment,o),$(As.$$.fragment,o),$(Os.$$.fragment,o),$(Ss.$$.fragment,o),$(Ns.$$.fragment,o),$(oa.$$.fragment,o),$(Bs.$$.fragment,o),$(Us.$$.fragment,o),$(aa.$$.fragment,o),$(Rs.$$.fragment,o),$(sa.$$.fragment,o),$(Hs.$$.fragment,o),$(Xs.$$.fragment,o),$(Gs.$$.fragment,o),$(Js.$$.fragment,o),$(Qs.$$.fragment,o),$(en.$$.fragment,o),$(tn.$$.fragment,o),$(an.$$.fragment,o),$(sn.$$.fragment,o),$(nn.$$.fragment,o),$(mn.$$.fragment,o),$(ca.$$.fragment,o),$(da.$$.fragment,o),$(hn.$$.fragment,o),$(fn.$$.fragment,o),$(bn.$$.fragment,o),$(ma.$$.fragment,o),$(ha.$$.fragment,o),$(fa.$$.fragment,o),$(wn.$$.fragment,o),$(yn.$$.fragment,o),$(jn.$$.fragment,o),$(ga.$$.fragment,o),$(_a.$$.fragment,o),$(va.$$.fragment,o),$(Vn.$$.fragment,o),$(Fn.$$.fragment,o),$(Mn.$$.fragment,o),$(wa.$$.fragment,o),$(ya.$$.fragment,o),$(An.$$.fragment,o),$(On.$$.fragment,o),$(Bn.$$.fragment,o),$(Ta.$$.fragment,o),$($a.$$.fragment,o),$(Un.$$.fragment,o),$(Rn.$$.fragment,o),$(Jn.$$.fragment,o),$(Wa.$$.fragment,o),$(ja.$$.fragment,o),$(Zn.$$.fragment,o),$(Qn.$$.fragment,o),$(Fa.$$.fragment,o),$(or.$$.fragment,o),$(Ca.$$.fragment,o),$(Ea.$$.fragment,o),$(ar.$$.fragment,o),$(sr.$$.fragment,o),$(qa.$$.fragment,o),$(cr.$$.fragment,o),$(za.$$.fragment,o),$(Ma.$$.fragment,o),$(dr.$$.fragment,o),$(pr.$$.fragment,o),$(yr.$$.fragment,o),$(Oa.$$.fragment,o),$(La.$$.fragment,o),$(kr.$$.fragment,o),$(Tr.$$.fragment,o),$(Pr.$$.fragment,o),$(Sa.$$.fragment,o),$(Na.$$.fragment,o),$(qr.$$.fragment,o),$(zr.$$.fragment,o),$(Br.$$.fragment,o),$(Ba.$$.fragment,o),$(Ua.$$.fragment,o),Hd=!1},d(o){t(c),o&&t(b),o&&t(f),x(l),o&&t(A),o&&t(z),x(C),o&&t(we),o&&t(I),o&&t(Ke),o&&t(ae),o&&t(Ge),o&&t(se),o&&t(Ae),o&&t(M),o&&t(Je),o&&t(J),o&&t(Ze),o&&t(he),o&&t(Qe),o&&t(X),x(O),o&&t(Ye),o&&t(W),x(E),x(ne),o&&t(Dt),o&&t(so),x(cs),o&&t(pd),o&&t(Q),x(ds),x(ms),x(hs),x(fs),x(Bo),x(gs),o&&t(md),o&&t(no),x(_s),o&&t(hd),o&&t(Xe),x(vs),x(ws),o&&t(fd),o&&t(ro),x(ys),o&&t(ud),o&&t(U),x(ks),x($s),x(js),x(Vs),x(Fs),x(Jo),x(Es),x(qs),o&&t(gd),o&&t(io),x(Ms),o&&t(_d),o&&t(G),x(As),x(Os),x(Ss),x(Ns),x(oa),x(Bs),x(Us),x(aa),x(Rs),x(sa),o&&t(vd),o&&t(lo),x(Hs),o&&t(bd),o&&t(co),x(Xs),o&&t(wd),o&&t(po),x(Gs),o&&t(yd),o&&t(mo),x(Js),o&&t(kd),o&&t(Pt),x(Qs),x(en),o&&t(Td),o&&t(qt),x(tn),x(an),o&&t($d),o&&t(ho),x(sn),o&&t(xd),o&&t(Ee),x(nn),x(mn),x(ca),x(da),o&&t(Wd),o&&t(uo),x(hn),o&&t(jd),o&&t(Pe),x(fn),x(bn),x(ma),x(ha),x(fa),o&&t(Vd),o&&t(vo),x(wn),o&&t(Fd),o&&t(le),x(yn),x(jn),x(ga),x(_a),x(va),o&&t(Cd),o&&t(wo),x(Vn),o&&t(Ed),o&&t(ce),x(Fn),x(Mn),x(wa),x(ya),o&&t(Pd),o&&t(ko),x(An),o&&t(qd),o&&t(de),x(On),x(Bn),x(Ta),x($a),o&&t(zd),o&&t($o),x(Un),o&&t(Md),o&&t(qe),x(Rn),x(Jn),x(Wa),x(ja),o&&t(Ad),o&&t(jo),x(Zn),o&&t(Od),o&&t(pe),x(Qn),x(Fa),x(or),x(Ca),x(Ea),o&&t(Ld),o&&t(Fo),x(ar),o&&t(Dd),o&&t(me),x(sr),x(qa),x(cr),x(za),x(Ma),o&&t(Sd),o&&t(Eo),x(dr),o&&t(Nd),o&&t(Y),x(pr),x(yr),x(Oa),x(La),o&&t(Id),o&&t(qo),x(kr),o&&t(Bd),o&&t(ee),x(Tr),x(Pr),x(Sa),x(Na),o&&t(Ud),o&&t(Ao),x(qr),o&&t(Rd),o&&t(te),x(zr),x(Br),x(Ba),x(Ua)}}}const MT={local:"wav2vec2",sections:[{local:"overview",title:"Overview"},{local:"transformers.Wav2Vec2Config",title:"Wav2Vec2Config"},{local:"transformers.Wav2Vec2CTCTokenizer",title:"Wav2Vec2CTCTokenizer"},{local:"transformers.Wav2Vec2FeatureExtractor",title:"Wav2Vec2FeatureExtractor"},{local:"transformers.Wav2Vec2Processor",title:"Wav2Vec2Processor"},{local:"transformers.Wav2Vec2ProcessorWithLM",title:"Wav2Vec2ProcessorWithLM"},{local:"transformers.models.wav2vec2_with_lm.processing_wav2vec2_with_lm.Wav2Vec2DecoderWithLMOutput",title:"Wav2Vec2 specific outputs"},{local:"transformers.Wav2Vec2Model",title:"Wav2Vec2Model"},{local:"transformers.Wav2Vec2ForCTC",title:"Wav2Vec2ForCTC"},{local:"transformers.Wav2Vec2ForSequenceClassification",title:"Wav2Vec2ForSequenceClassification"},{local:"transformers.Wav2Vec2ForAudioFrameClassification",title:"Wav2Vec2ForAudioFrameClassification"},{local:"transformers.Wav2Vec2ForXVector",title:"Wav2Vec2ForXVector"},{local:"transformers.Wav2Vec2ForPreTraining",title:"Wav2Vec2ForPreTraining"},{local:"transformers.TFWav2Vec2Model",title:"TFWav2Vec2Model"},{local:"transformers.TFWav2Vec2ForCTC",title:"TFWav2Vec2ForCTC"},{local:"transformers.FlaxWav2Vec2Model",title:"FlaxWav2Vec2Model"},{local:"transformers.FlaxWav2Vec2ForCTC",title:"FlaxWav2Vec2ForCTC"},{local:"transformers.FlaxWav2Vec2ForPreTraining",title:"FlaxWav2Vec2ForPreTraining"}],title:"Wav2Vec2"};function AT(j){return tT(()=>{new URLSearchParams(window.location.search).get("fw")}),[]}class BT extends Zk{constructor(c){super();Qk(this,c,AT,zT,Yk,{})}}export{BT as default,MT as metadata};
