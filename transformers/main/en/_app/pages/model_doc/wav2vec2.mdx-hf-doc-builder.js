...
</ul>`,name:"pretrained_model_name_or_path"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/wav2vec2_with_lm/processing_wav2vec2_with_lm.py#L112"}}),ma=new xe({props:{$$slots:{default:[QT]},$$scope:{ctx:W}}}),bn=new F({props:{name:"save_pretrained",anchor:"transformers.Wav2Vec2ProcessorWithLM.save_pretrained",parameters:[{name:"save_directory",val:""}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/wav2vec2_with_lm/processing_wav2vec2_with_lm.py#L108"}}),wn=new F({props:{name:"batch_decode",anchor:"transformers.Wav2Vec2ProcessorWithLM.batch_decode",parameters:[{name:"logits",val:": ndarray"},{name:"pool",val:": typing.Union[<bound method BaseContext.Pool of <multiprocessing.context.DefaultContext object at 0x7f020f3b3a00>>, NoneType] = None"},{name:"num_processes",val:": typing.Optional[int] = None"},{name:"beam_width",val:": typing.Optional[int] = None"},{name:"beam_prune_logp",val:": typing.Optional[float] = None"},{name:"token_min_logp",val:": typing.Optional[float] = None"},{name:"hotwords",val:": typing.Optional[typing.Iterable[str]] = None"},{name:"hotword_weight",val:": typing.Optional[float] = None"},{name:"alpha",val:": typing.Optional[float] = None"},{name:"beta",val:": typing.Optional[float] = None"},{name:"unk_score_offset",val:": typing.Optional[float] = None"},{name:"lm_score_boundary",val:": typing.Optional[bool] = None"},{name:"output_word_offsets",val:": bool = False"}],parametersDescription:[{anchor:"transformers.Wav2Vec2ProcessorWithLM.batch_decode.logits",description:`<strong>logits</strong> (<code>np.ndarray</code>) &#x2014;
...
`),fn=r(is,"A",{href:!0});var Jy=i(fn);vc=r(Jy,"STRONG",{});var e0=i(vc);Zu=s(e0,"call"),e0.forEach(t),Qu=s(Jy,"()"),Jy.forEach(t),Yu=s(is,` and returns its output. If used in the context
`),bc=r(is,"CODE",{});var t0=i(bc);eg=s(t0,"as_target_processor()"),t0.forEach(t),tg=s(is,` this method forwards all its arguments to
Wav2Vec2CTCTokenizer\u2019s `),un=r(is,"A",{href:!0});var Zy=i(un);wc=r(Zy,"STRONG",{});var o0=i(wc);og=s(o0,"call"),o0.forEach(t),ag=s(Zy,"()"),Zy.forEach(t),sg=s(is,`. Please refer to the docstring of the above two
...
`),Zi=r(ls,"A",{href:!0});var a0=i(Zi);lg=s(a0,"pad()"),a0.forEach(t),cg=s(ls,` and returns its output. If used in the context
`),yc=r(ls,"CODE",{});var s0=i(yc);dg=s(s0,"as_target_processor()"),s0.forEach(t),pg=s(ls,` this method forwards all its arguments to
Wav2Vec2CTCTokenizer\u2019s `),Qi=r(ls,"A",{href:!0});var n0=i(Qi);mg=s(n0,"pad()"),n0.forEach(t),hg=s(ls,`. Please refer to the docstring of the above two methods
for more information.`),ls.forEach(t),$m.forEach(t),fg=m($e),Ht=r($e,"DIV",{class:!0});var Fl=i(Ht);y(_n.$$.fragment,Fl),ug=m(Fl),vn=r(Fl,"P",{});var xm=i(vn);gg=s(xm,"Instantiate a "),Yi=r(xm,"A",{href:!0});var r0=i(Yi);_g=s(r0,"Wav2Vec2ProcessorWithLM"),r0.forEach(t),vg=s(xm," from a pretrained Wav2Vec2 processor."),xm.forEach(t),bg=m(Fl),y(ma.$$.fragment,Fl),Fl.forEach(t),wg=m($e),el=r($e,"DIV",{class:!0});var i0=i(el);y(bn.$$.fragment,i0),i0.forEach(t),yg=m($e),lt=r($e,"DIV",{class:!0});var cs=i(lt);y(wn.$$.fragment,cs),kg=m(cs),kc=r(cs,"P",{});var l0=i(kc);Tg=s(l0,"Batch decode output logits to audio transcription with language model support."),l0.forEach(t),$g=m(cs),y(ha.$$.fragment,cs),xg=m(cs),yn=r(cs,"P",{});var Wm=i(yn);Wg=s(Wm,`Example:
See `),tl=r(Wm,"A",{href:!0});var c0=i(tl);jg=s(c0,"Decoding multiple audios"),c0.forEach(t),Vg=s(Wm,"."),Wm.forEach(t),cs.forEach(t),Fg=m($e),Xt=r($e,"DIV",{class:!0});var El=i(Xt);y(kn.$$.fragment,El),Eg=m(El),Tc=r(El,"P",{});var d0=i(Tc);Cg=s(d0,"Decode output logits to audio transcription with language model support."),d0.forEach(t),qg=m(El),y(fa.$$.fragment,El),El.forEach(t),$e.forEach(t),kp=m(o),vo=r(o,"H3",{class:!0});var jm=i(vo);ua=r(jm,"A",{id:!0,class:!0,href:!0});var p0=i(ua);$c=r(p0,"SPAN",{});var m0=i($c);y(Tn.$$.fragment,m0),m0.forEach(t),p0.forEach(t),Pg=m(jm),xc=r(jm,"SPAN",{});var h0=i(xc);zg=s(h0,"Decoding multiple audios"),h0.forEach(t),jm.forEach(t),Tp=m(o),Te=r(o,"P",{});var vt=i(Te);Mg=s(vt,"If you are planning to decode multiple batches of audios, you should consider using "),ol=r(vt,"A",{href:!0});var f0=i(ol);Ag=s(f0,"batch_decode()"),f0.forEach(t),Lg=s(vt," and passing an instantiated "),Wc=r(vt,"CODE",{});var u0=i(Wc);Og=s(u0,"multiprocessing.Pool"),u0.forEach(t),Dg=s(vt,`.
Otherwise, `),al=r(vt,"A",{href:!0});var g0=i(al);Sg=s(g0,"batch_decode()"),g0.forEach(t),Ig=s(vt," performance will be slower than calling "),sl=r(vt,"A",{href:!0});var _0=i(sl);Ng=s(_0,"decode()"),_0.forEach(t),Bg=s(vt," for each audio individually, as it internally instantiates a new "),jc=r(vt,"CODE",{});var v0=i(jc);Rg=s(v0,"Pool"),v0.forEach(t),Ug=s(vt," for every call. See the example below:"),vt.forEach(t),$p=m(o),y($n.$$.fragment,o),xp=m(o),bo=r(o,"H2",{class:!0});var Vm=i(bo);ga=r(Vm,"A",{id:!0,class:!0,href:!0});var b0=i(ga);Vc=r(b0,"SPAN",{});var w0=i(Vc);y(xn.$$.fragment,w0),w0.forEach(t),b0.forEach(t),Hg=m(Vm),Fc=r(Vm,"SPAN",{});var y0=i(Fc);Xg=s(y0,"Wav2Vec2 specific outputs"),y0.forEach(t),Vm.forEach(t),Wp=m(o),wo=r(o,"DIV",{class:!0});var Fm=i(wo);y(Wn.$$.fragment,Fm),Gg=m(Fm),jn=r(Fm,"P",{});var Em=i(jn);Kg=s(Em,"Output type of "),Ec=r(Em,"CODE",{});var k0=i(Ec);Jg=s(k0,"Wav2Vec2DecoderWithLM"),k0.forEach(t),Zg=s(Em,", with transcription."),Em.forEach(t),Fm.forEach(t),jp=m(o),yo=r(o,"DIV",{class:!0});var Cm=i(yo);y(Vn.$$.fragment,Cm),Qg=m(Cm),Cc=r(Cm,"P",{});var T0=i(Cc);Yg=s(T0,"Base class for models that have been trained with the Wav2Vec2 loss objective."),T0.forEach(t),Cm.forEach(t),Vp=m(o),ko=r(o,"DIV",{class:!0});var qm=i(ko);y(Fn.$$.fragment,qm),e_=m(qm),En=r(qm,"P",{});var Pm=i(En);t_=s(Pm,"Output type of "),nl=r(Pm,"A",{href:!0});var $0=i(nl);o_=s($0,"Wav2Vec2ForPreTraining"),$0.forEach(t),a_=s(Pm,", with potential hidden states and attentions."),Pm.forEach(t),qm.forEach(t),Fp=m(o),Mt=r(o,"DIV",{class:!0});var Cl=i(Mt);y(Cn.$$.fragment,Cl),s_=m(Cl),qn=r(Cl,"P",{});var zm=i(qn);n_=s(zm,"Output type of "),qc=r(zm,"CODE",{});var x0=i(qc);r_=s(x0,"FlaxWav2Vec2BaseModelOutput"),x0.forEach(t),i_=s(zm,", with potential hidden states and attentions."),zm.forEach(t),l_=m(Cl),_a=r(Cl,"DIV",{class:!0});var Mm=i(_a);y(Pn.$$.fragment,Mm),c_=m(Mm),Pc=r(Mm,"P",{});var W0=i(Pc);d_=s(W0,"\u201CReturns a new object replacing the specified fields with new values."),W0.forEach(t),Mm.forEach(t),Cl.forEach(t),Ep=m(o),At=r(o,"DIV",{class:!0});var ql=i(At);y(zn.$$.fragment,ql),p_=m(ql),Mn=r(ql,"P",{});var Am=i(Mn);m_=s(Am,"Output type of "),zc=r(Am,"CODE",{});var j0=i(zc);h_=s(j0,"FlaxWav2Vec2ForPreTrainingOutput"),j0.forEach(t),f_=s(Am,", with potential hidden states and attentions."),Am.forEach(t),u_=m(ql),va=r(ql,"DIV",{class:!0});var Lm=i(va);y(An.$$.fragment,Lm),g_=m(Lm),Mc=r(Lm,"P",{});var V0=i(Mc);__=s(V0,"\u201CReturns a new object replacing the specified fields with new values."),V0.forEach(t),Lm.forEach(t),ql.forEach(t),Cp=m(o),To=r(o,"H2",{class:!0});var Om=i(To);ba=r(Om,"A",{id:!0,class:!0,href:!0});var F0=i(ba);Ac=r(F0,"SPAN",{});var E0=i(Ac);y(Ln.$$.fragment,E0),E0.forEach(t),F0.forEach(t),v_=m(Om),Lc=r(Om,"SPAN",{});var C0=i(Lc);b_=s(C0,"Wav2Vec2Model"),C0.forEach(t),Om.forEach(t),qp=m(o),Ae=r(o,"DIV",{class:!0});var Jt=i(Ae);y(On.$$.fragment,Jt),w_=m(Jt),Dn=r(Jt,"P",{});var Dm=i(Dn);y_=s(Dm,`The bare Wav2Vec2 Model transformer outputting raw hidden-states without any specific head on top.
Wav2Vec2 was proposed in `),Sn=r(Dm,"A",{href:!0,rel:!0});var q0=i(Sn);k_=s(q0,`wav2vec 2.0: A Framework for Self-Supervised Learning of Speech
Representations`),q0.forEach(t),T_=s(Dm,` by Alexei Baevski, Henry Zhou, Abdelrahman Mohamed, Michael
Auli.`),Dm.forEach(t),$_=m(Jt),In=r(Jt,"P",{});var Sm=i(In);x_=s(Sm,"This model inherits from "),rl=r(Sm,"A",{href:!0});var P0=i(rl);W_=s(P0,"PreTrainedModel"),P0.forEach(t),j_=s(Sm,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving etc.).`),Sm.forEach(t),V_=m(Jt),Nn=r(Jt,"P",{});var Im=i(Nn);F_=s(Im,"This model is a PyTorch "),Bn=r(Im,"A",{href:!0,rel:!0});var z0=i(Bn);E_=s(z0,"torch.nn.Module"),z0.forEach(t),C_=s(Im,` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),Im.forEach(t),q_=m(Jt),ct=r(Jt,"DIV",{class:!0});var ds=i(ct);y(Rn.$$.fragment,ds),P_=m(ds),$o=r(ds,"P",{});var Pl=i($o);z_=s(Pl,"The "),il=r(Pl,"A",{href:!0});var M0=i(il);M_=s(M0,"Wav2Vec2Model"),M0.forEach(t),A_=s(Pl," forward method, overrides the "),Oc=r(Pl,"CODE",{});var A0=i(Oc);L_=s(A0,"__call__"),A0.forEach(t),O_=s(Pl," special method."),Pl.forEach(t),D_=m(ds),y(wa.$$.fragment,ds),S_=m(ds),y(ya.$$.fragment,ds),ds.forEach(t),Jt.forEach(t),Pp=m(o),xo=r(o,"H2",{class:!0});var Nm=i(xo);ka=r(Nm,"A",{id:!0,class:!0,href:!0});var L0=i(ka);Dc=r(L0,"SPAN",{});var O0=i(Dc);y(Un.$$.fragment,O0),O0.forEach(t),L0.forEach(t),I_=m(Nm),Sc=r(Nm,"SPAN",{});var D0=i(Sc);N_=s(D0,"Wav2Vec2ForCTC"),D0.forEach(t),Nm.forEach(t),zp=m(o),Le=r(o,"DIV",{class:!0});var Zt=i(Le);y(Hn.$$.fragment,Zt),B_=m(Zt),Wo=r(Zt,"P",{});var zl=i(Wo);R_=s(zl,"Wav2Vec2 Model with a "),Ic=r(zl,"CODE",{});var S0=i(Ic);U_=s(S0,"language modeling"),S0.forEach(t),H_=s(zl,` head on top for Connectionist Temporal Classification (CTC).
Wav2Vec2 was proposed in `),Xn=r(zl,"A",{href:!0,rel:!0});var I0=i(Xn);X_=s(I0,`wav2vec 2.0: A Framework for Self-Supervised Learning of Speech
Representations`),I0.forEach(t),G_=s(zl,` by Alexei Baevski, Henry Zhou, Abdelrahman Mohamed, Michael
Auli.`),zl.forEach(t),K_=m(Zt),Gn=r(Zt,"P",{});var Bm=i(Gn);J_=s(Bm,"This model inherits from "),ll=r(Bm,"A",{href:!0});var N0=i(ll);Z_=s(N0,"PreTrainedModel"),N0.forEach(t),Q_=s(Bm,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving etc.).`),Bm.forEach(t),Y_=m(Zt),Kn=r(Zt,"P",{});var Rm=i(Kn);ev=s(Rm,"This model is a PyTorch "),Jn=r(Rm,"A",{href:!0,rel:!0});var B0=i(Jn);tv=s(B0,"torch.nn.Module"),B0.forEach(t),ov=s(Rm,` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),Rm.forEach(t),av=m(Zt),Ue=r(Zt,"DIV",{class:!0});var Qt=i(Ue);y(Zn.$$.fragment,Qt),sv=m(Qt),jo=r(Qt,"P",{});var Ml=i(jo);nv=s(Ml,"The "),cl=r(Ml,"A",{href:!0});var R0=i(cl);rv=s(R0,"Wav2Vec2ForCTC"),R0.forEach(t),iv=s(Ml," forward method, overrides the "),Nc=r(Ml,"CODE",{});var U0=i(Nc);lv=s(U0,"__call__"),U0.forEach(t),cv=s(Ml," special method."),Ml.forEach(t),dv=m(Qt),y(Ta.$$.fragment,Qt),pv=m(Qt),y($a.$$.fragment,Qt),mv=m(Qt),y(xa.$$.fragment,Qt),Qt.forEach(t),Zt.forEach(t),Mp=m(o),Vo=r(o,"H2",{class:!0});var Um=i(Vo);Wa=r(Um,"A",{id:!0,class:!0,href:!0});var H0=i(Wa);Bc=r(H0,"SPAN",{});var X0=i(Bc);y(Qn.$$.fragment,X0),X0.forEach(t),H0.forEach(t),hv=m(Um),Rc=r(Um,"SPAN",{});var G0=i(Rc);fv=s(G0,"Wav2Vec2ForSequenceClassification"),G0.forEach(t),Um.forEach(t),Ap=m(o),ue=r(o,"DIV",{class:!0});var bt=i(ue);y(Yn.$$.fragment,bt),uv=m(bt),Uc=r(bt,"P",{});var K0=i(Uc);gv=s(K0,`Wav2Vec2 Model with a sequence classification head on top (a linear layer over the pooled output) for tasks like
SUPERB Keyword Spotting.`),K0.forEach(t),_v=m(bt),er=r(bt,"P",{});var Hm=i(er);vv=s(Hm,"Wav2Vec2 was proposed in "),tr=r(Hm,"A",{href:!0,rel:!0});var J0=i(tr);bv=s(J0,`wav2vec 2.0: A Framework for Self-Supervised Learning of Speech
Representations`),J0.forEach(t),wv=s(Hm,` by Alexei Baevski, Henry Zhou, Abdelrahman Mohamed, Michael
Auli.`),Hm.forEach(t),yv=m(bt),or=r(bt,"P",{});var Xm=i(or);kv=s(Xm,"This model inherits from "),dl=r(Xm,"A",{href:!0});var Z0=i(dl);Tv=s(Z0,"PreTrainedModel"),Z0.forEach(t),$v=s(Xm,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving etc.).`),Xm.forEach(t),xv=m(bt),ar=r(bt,"P",{});var Gm=i(ar);Wv=s(Gm,"This model is a PyTorch "),sr=r(Gm,"A",{href:!0,rel:!0});var Q0=i(sr);jv=s(Q0,"torch.nn.Module"),Q0.forEach(t),Vv=s(Gm,` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),Gm.forEach(t),Fv=m(bt),He=r(bt,"DIV",{class:!0});var Yt=i(He);y(nr.$$.fragment,Yt),Ev=m(Yt),Fo=r(Yt,"P",{});var Al=i(Fo);Cv=s(Al,"The "),pl=r(Al,"A",{href:!0});var Y0=i(pl);qv=s(Y0,"Wav2Vec2ForSequenceClassification"),Y0.forEach(t),Pv=s(Al," forward method, overrides the "),Hc=r(Al,"CODE",{});var e1=i(Hc);zv=s(e1,"__call__"),e1.forEach(t),Mv=s(Al," special method."),Al.forEach(t),Av=m(Yt),y(ja.$$.fragment,Yt),Lv=m(Yt),y(Va.$$.fragment,Yt),Ov=m(Yt),y(Fa.$$.fragment,Yt),Yt.forEach(t),bt.forEach(t),Lp=m(o),Eo=r(o,"H2",{class:!0});var Km=i(Eo);Ea=r(Km,"A",{id:!0,class:!0,href:!0});var t1=i(Ea);Xc=r(t1,"SPAN",{});var o1=i(Xc);y(rr.$$.fragment,o1),o1.forEach(t),t1.forEach(t),Dv=m(Km),Gc=r(Km,"SPAN",{});var a1=i(Gc);Sv=s(a1,"Wav2Vec2ForAudioFrameClassification"),a1.forEach(t),Km.forEach(t),Op=m(o),ge=r(o,"DIV",{class:!0});var wt=i(ge);y(ir.$$.fragment,wt),Iv=m(wt),Kc=r(wt,"P",{});var s1=i(Kc);Nv=s(s1,"Wav2Vec2 Model with a frame classification head on top for tasks like Speaker Diarization."),s1.forEach(t),Bv=m(wt),lr=r(wt,"P",{});var Jm=i(lr);Rv=s(Jm,"Wav2Vec2 was proposed in "),cr=r(Jm,"A",{href:!0,rel:!0});var n1=i(cr);Uv=s(n1,`wav2vec 2.0: A Framework for Self-Supervised Learning of Speech
