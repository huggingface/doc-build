...
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-built_in">print</span>(model.config.id2label[predicted_label])
tabby, tabby cat`}}),{c(){d=s("p"),b=i("Example:"),p=f(),w(h.$$.fragment)},l(a){d=n(a,"P",{});var c=r(d);b=l(c,"Example:"),c.forEach(o),p=u(a),v(h.$$.fragment,a)},m(a,c){T(a,d,c),e(d,b),T(a,p,c),$(h,a,c),_=!0},p:je,i(a){_||(y(h.$$.fragment,a),_=!0)},o(a){D(h.$$.fragment,a),_=!1},d(a){a&&o(d),a&&o(p),F(h,a)}}}function hh(k){let d,b,p,h,_,a,c,x,pn,_s,Pe,Ts,re,qe,la,$t,mn,da,fn,bs,W,un,yt,gn,_n,Fo,Tn,bn,Dt,wn,vn,ws,ko,$n,vs,xo,ca,yn,$s,Io,Dn,ys,q,ha,Fn,kn,ie,xn,Mo,In,Mn,Eo,En,jn,Cn,pa,Pn,qn,ma,zn,An,I,Nn,jo,On,Ln,Co,Wn,Sn,fa,Vn,Bn,ua,Hn,Rn,ga,Un,Jn,_a,Gn,Kn,Po,Xn,Zn,Ds,ae,Qn,Ft,Yn,er,kt,tr,or,Fs,le,ze,Ta,xt,ar,ba,sr,ks,z,It,nr,de,rr,qo,ir,lr,Mt,dr,cr,hr,ce,pr,zo,mr,fr,Ao,ur,gr,_r,Ae,xs,he,Ne,wa,Et,Tr,va,br,Is,A,jt,wr,$a,vr,$r,Ct,yr,No,Dr,Fr,kr,se,Pt,xr,ya,Ir,Mr,Oe,Ms,pe,Le,Da,qt,Er,Fa,jr,Es,Q,zt,Cr,At,Pr,Nt,qr,zr,Ar,S,Ot,Nr,me,Or,Oo,Lr,Wr,ka,Sr,Vr,Br,We,Hr,Se,js,fe,Ve,xa,Lt,Rr,Ia,Ur,Cs,P,Wt,Jr,St,Gr,Vt,Kr,Xr,Zr,Be,Qr,Bt,Yr,Ht,ei,ti,oi,V,Rt,ai,ue,si,Lo,ni,ri,Ma,ii,li,di,He,ci,Re,Ps,ge,Ue,Ea,Ut,hi,ja,pi,qs,N,Jt,mi,Ca,fi,ui,Gt,gi,Kt,_i,Ti,bi,B,Xt,wi,_e,vi,Wo,$i,yi,Pa,Di,Fi,ki,Je,xi,Ge,zs,Te,Ke,qa,Zt,Ii,za,Mi,As,E,Qt,Ei,Aa,ji,Ci,Na,Pi,qi,Oa,zi,Ai,Yt,Ni,eo,Oi,Li,Wi,H,to,Si,be,Vi,So,Bi,Hi,La,Ri,Ui,Ji,Xe,Gi,Ze,Ns,we,Qe,Wa,oo,Ki,Sa,Xi,Os,Y,ao,Zi,so,Qi,no,Yi,el,tl,R,ro,ol,ve,al,Vo,sl,nl,Va,rl,il,ll,Ye,dl,et,Ls,$e,tt,Ba,io,cl,Ha,hl,Ws,ee,lo,pl,ye,ml,co,fl,ul,ho,gl,_l,Tl,U,po,bl,De,wl,Bo,vl,$l,Ra,yl,Dl,Fl,ot,kl,at,Ss,Fe,st,Ua,mo,xl,Ja,Il,Vs,O,fo,Ml,Ga,El,jl,uo,Cl,go,Pl,ql,zl,J,_o,Al,ke,Nl,Ho,Ol,Ll,Ka,Wl,Sl,Vl,nt,Bl,rt,Bs,xe,it,Xa,To,Hl,Za,Rl,Hs,j,bo,Ul,Qa,Jl,Gl,Ya,Kl,Xl,es,Zl,Ql,wo,Yl,vo,ed,td,od,G,$o,ad,Ie,sd,Ro,nd,rd,ts,id,ld,dd,lt,cd,dt,Rs;return a=new Z({}),Pe=new oe({props:{$$slots:{default:[Rc]},$$scope:{ctx:k}}}),$t=new Z({}),xt=new Z({}),It=new M({props:{name:"class transformers.DeiTConfig",anchor:"transformers.DeiTConfig",parameters:[{name:"hidden_size",val:" = 768"},{name:"num_hidden_layers",val:" = 12"},{name:"num_attention_heads",val:" = 12"},{name:"intermediate_size",val:" = 3072"},{name:"hidden_act",val:" = 'gelu'"},{name:"hidden_dropout_prob",val:" = 0.0"},{name:"attention_probs_dropout_prob",val:" = 0.0"},{name:"initializer_range",val:" = 0.02"},{name:"layer_norm_eps",val:" = 1e-12"},{name:"is_encoder_decoder",val:" = False"},{name:"image_size",val:" = 224"},{name:"patch_size",val:" = 16"},{name:"num_channels",val:" = 3"},{name:"qkv_bias",val:" = True"},{name:"encoder_stride",val:" = 16"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.DeiTConfig.hidden_size",description:`<strong>hidden_size</strong> (<code>int</code>, <em>optional</em>, defaults to 768) &#x2014;
...
</ul>`,name:"return_tensors"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/deit/feature_extraction_deit.py#L94",returnDescription:`
<p>A <a
...
`),fa=s("em"),Vn=i("facebook/deit-tiny-patch16-224"),Bn=i(", "),ua=s("em"),Hn=i("facebook/deit-small-patch16-224"),Rn=i(", "),ga=s("em"),Un=i("facebook/deit-base-patch16-224"),Jn=i(` and
...
behavior.`),Ar=f(),S=s("div"),w(Ot.$$.fragment),Nr=f(),me=s("p"),Or=i("The "),Oo=s("a"),Lr=i("DeiTModel"),Wr=i(" forward method, overrides the "),ka=s("code"),Sr=i("__call__"),Vr=i(" special method."),Br=f(),w(We.$$.fragment),Hr=f(),w(Se.$$.fragment),js=f(),fe=s("h2"),Ve=s("a"),xa=s("span"),w(Lt.$$.fragment),Rr=f(),Ia=s("span"),Ur=i("DeiTForMaskedImageModeling"),Cs=f(),P=s("div"),w(Wt.$$.fragment),Jr=f(),St=s("p"),Gr=i("DeiT Model with a decoder on top for masked image modeling, as proposed in "),Vt=s("a"),Kr=i("SimMIM"),Xr=i("."),Zr=f(),w(Be.$$.fragment),Qr=f(),Bt=s("p"),Yr=i("This model is a PyTorch "),Ht=s("a"),ei=i("torch.nn.Module"),ti=i(` subclass. Use it
as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),oi=f(),V=s("div"),w(Rt.$$.fragment),ai=f(),ue=s("p"),si=i("The "),Lo=s("a"),ni=i("DeiTForMaskedImageModeling"),ri=i(" forward method, overrides the "),Ma=s("code"),ii=i("__call__"),li=i(" special method."),di=f(),w(He.$$.fragment),ci=f(),w(Re.$$.fragment),Ps=f(),ge=s("h2"),Ue=s("a"),Ea=s("span"),w(Ut.$$.fragment),hi=f(),ja=s("span"),pi=i("DeiTForImageClassification"),qs=f(),N=s("div"),w(Jt.$$.fragment),mi=f(),Ca=s("p"),fi=i(`DeiT Model transformer with an image classification head on top (a linear layer on top of the final hidden state of
...
as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),Wi=f(),H=s("div"),w(to.$$.fragment),Si=f(),be=s("p"),Vi=i("The "),So=s("a"),Bi=i("DeiTForImageClassificationWithTeacher"),Hi=i(" forward method, overrides the "),La=s("code"),Ri=i("__call__"),Ui=i(" special method."),Ji=f(),w(Xe.$$.fragment),Gi=f(),w(Ze.$$.fragment),Ns=f(),we=s("h2"),Qe=s("a"),Wa=s("span"),w(oo.$$.fragment),Ki=f(),Sa=s("span"),Xi=i("TFDeiTModel"),Os=f(),Y=s("div"),w(ao.$$.fragment),Zi=f(),so=s("p"),Qi=i(`The bare DeiT Model transformer outputting raw hidden-states without any specific head on top.
This model is a TensorFlow
`),no=s("a"),Yi=i("tf.keras.layers.Layer"),el=i(`. Use it as a regular
TensorFlow Module and refer to the TensorFlow documentation for all matter related to general usage and behavior.`),tl=f(),R=s("div"),w(ro.$$.fragment),ol=f(),ve=s("p"),al=i("The "),Vo=s("a"),sl=i("TFDeiTModel"),nl=i(" forward method, overrides the "),Va=s("code"),rl=i("__call__"),il=i(" special method."),ll=f(),w(Ye.$$.fragment),dl=f(),w(et.$$.fragment),Ls=f(),$e=s("h2"),tt=s("a"),Ba=s("span"),w(io.$$.fragment),cl=f(),Ha=s("span"),hl=i("TFDeiTForMaskedImageModeling"),Ws=f(),ee=s("div"),w(lo.$$.fragment),pl=f(),ye=s("p"),ml=i("DeiT Model with a decoder on top for masked image modeling, as proposed in "),co=s("a"),fl=i("SimMIM"),ul=i(`.
This model is a TensorFlow
`),ho=s("a"),gl=i("tf.keras.layers.Layer"),_l=i(`. Use it as a regular
TensorFlow Module and refer to the TensorFlow documentation for all matter related to general usage and behavior.`),Tl=f(),U=s("div"),w(po.$$.fragment),bl=f(),De=s("p"),wl=i("The "),Bo=s("a"),vl=i("TFDeiTForMaskedImageModeling"),$l=i(" forward method, overrides the "),Ra=s("code"),yl=i("__call__"),Dl=i(" special method."),Fl=f(),w(ot.$$.fragment),kl=f(),w(at.$$.fragment),Ss=f(),Fe=s("h2"),st=s("a"),Ua=s("span"),w(mo.$$.fragment),xl=f(),Ja=s("span"),Il=i("TFDeiTForImageClassification"),Vs=f(),O=s("div"),w(fo.$$.fragment),Ml=f(),Ga=s("p"),El=i(`DeiT Model transformer with an image classification head on top (a linear layer on top of the final hidden state of
...
TensorFlow Module and refer to the TensorFlow documentation for all matter related to general usage and behavior.`),zl=f(),J=s("div"),w(_o.$$.fragment),Al=f(),ke=s("p"),Nl=i("The "),Ho=s("a"),Ol=i("TFDeiTForImageClassification"),Ll=i(" forward method, overrides the "),Ka=s("code"),Wl=i("__call__"),Sl=i(" special method."),Vl=f(),w(nt.$$.fragment),Bl=f(),w(rt.$$.fragment),Bs=f(),xe=s("h2"),it=s("a"),Xa=s("span"),w(To.$$.fragment),Hl=f(),Za=s("span"),Rl=i("TFDeiTForImageClassificationWithTeacher"),Hs=f(),j=s("div"),w(bo.$$.fragment),Ul=f(),Qa=s("p"),Jl=i(`DeiT Model transformer with image classification heads on top (a linear layer on top of the final hidden state of
...
augmentation, optimization, and regularization were used in order to simulate training on a much larger dataset
(while only using ImageNet-1k for pre-training). There are 4 variants available (in 3 different sizes):
`),fa=n(C,"EM",{});var gd=r(fa);Vn=l(gd,"facebook/deit-tiny-patch16-224"),gd.forEach(o),Bn=l(C,", "),ua=n(C,"EM",{});var _d=r(ua);Hn=l(_d,"facebook/deit-small-patch16-224"),_d.forEach(o),Rn=l(C,", "),ga=n(C,"EM",{});var Td=r(ga);Un=l(Td,"facebook/deit-base-patch16-224"),Td.forEach(o),Jn=l(C,` and
...
prepare images for the model.`),C.forEach(o),L.forEach(o),Ds=u(t),ae=n(t,"P",{});var Uo=r(ae);Qn=l(Uo,"This model was contributed by "),Ft=n(Uo,"A",{href:!0,rel:!0});var vd=r(Ft);Yn=l(vd,"nielsr"),vd.forEach(o),er=l(Uo,". The TensorFlow version of this model was added by "),kt=n(Uo,"A",{href:!0,rel:!0});var $d=r(kt);tr=l($d,"amyeroberts"),$d.forEach(o),or=l(Uo,"."),Uo.forEach(o),Fs=u(t),le=n(t,"H2",{class:!0});var Us=r(le);ze=n(Us,"A",{id:!0,class:!0,href:!0});var yd=r(ze);Ta=n(yd,"SPAN",{});var Dd=r(Ta);v(xt.$$.fragment,Dd),Dd.forEach(o),yd.forEach(o),ar=u(Us),ba=n(Us,"SPAN",{});var Fd=r(ba);sr=l(Fd,"DeiTConfig"),Fd.forEach(o),Us.forEach(o),ks=u(t),z=n(t,"DIV",{class:!0});var ct=r(z);v(It.$$.fragment,ct),nr=u(ct),de=n(ct,"P",{});var Jo=r(de);rr=l(Jo,"This is the configuration class to store the configuration of a "),qo=n(Jo,"A",{href:!0});var kd=r(qo);ir=l(kd,"DeiTModel"),kd.forEach(o),lr=l(Jo,`. It is used to instantiate an DeiT
model according to the specified arguments, defining the model architecture. Instantiating a configuration with the
defaults will yield a similar configuration to that of the DeiT
...
as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),Xs.forEach(o),Ar=u(Xo),S=n(Xo,"DIV",{class:!0});var pt=r(S);v(Ot.$$.fragment,pt),Nr=u(pt),me=n(pt,"P",{});var Zo=r(me);Or=l(Zo,"The "),Oo=n(Zo,"A",{href:!0});var Wd=r(Oo);Lr=l(Wd,"DeiTModel"),Wd.forEach(o),Wr=l(Zo," forward method, overrides the "),ka=n(Zo,"CODE",{});var Sd=r(ka);Sr=l(Sd,"__call__"),Sd.forEach(o),Vr=l(Zo," special method."),Zo.forEach(o),Br=u(pt),v(We.$$.fragment,pt),Hr=u(pt),v(Se.$$.fragment,pt),pt.forEach(o),Xo.forEach(o),js=u(t),fe=n(t,"H2",{class:!0});var Zs=r(fe);Ve=n(Zs,"A",{id:!0,class:!0,href:!0});var Vd=r(Ve);xa=n(Vd,"SPAN",{});var Bd=r(xa);v(Lt.$$.fragment,Bd),Bd.forEach(o),Vd.forEach(o),Rr=u(Zs),Ia=n(Zs,"SPAN",{});var Hd=r(Ia);Ur=l(Hd,"DeiTForMaskedImageModeling"),Hd.forEach(o),Zs.forEach(o),Cs=u(t),P=n(t,"DIV",{class:!0});var ne=r(P);v(Wt.$$.fragment,ne),Jr=u(ne),St=n(ne,"P",{});var Qs=r(St);Gr=l(Qs,"DeiT Model with a decoder on top for masked image modeling, as proposed in "),Vt=n(Qs,"A",{href:!0,rel:!0});var Rd=r(Vt);Kr=l(Rd,"SimMIM"),Rd.forEach(o),Xr=l(Qs,"."),Qs.forEach(o),Zr=u(ne),v(Be.$$.fragment,ne),Qr=u(ne),Bt=n(ne,"P",{});var Ys=r(Bt);Yr=l(Ys,"This model is a PyTorch "),Ht=n(Ys,"A",{href:!0,rel:!0});var Ud=r(Ht);ei=l(Ud,"torch.nn.Module"),Ud.forEach(o),ti=l(Ys,` subclass. Use it
as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),Ys.forEach(o),oi=u(ne),V=n(ne,"DIV",{class:!0});var mt=r(V);v(Rt.$$.fragment,mt),ai=u(mt),ue=n(mt,"P",{});var Qo=r(ue);si=l(Qo,"The "),Lo=n(Qo,"A",{href:!0});var Jd=r(Lo);ni=l(Jd,"DeiTForMaskedImageModeling"),Jd.forEach(o),ri=l(Qo," forward method, overrides the "),Ma=n(Qo,"CODE",{});var Gd=r(Ma);ii=l(Gd,"__call__"),Gd.forEach(o),li=l(Qo," special method."),Qo.forEach(o),di=u(mt),v(He.$$.fragment,mt),ci=u(mt),v(Re.$$.fragment,mt),mt.forEach(o),ne.forEach(o),Ps=u(t),ge=n(t,"H2",{class:!0});var en=r(ge);Ue=n(en,"A",{id:!0,class:!0,href:!0});var Kd=r(Ue);Ea=n(Kd,"SPAN",{});var Xd=r(Ea);v(Ut.$$.fragment,Xd),Xd.forEach(o),Kd.forEach(o),hi=u(en),ja=n(en,"SPAN",{});var Zd=r(ja);pi=l(Zd,"DeiTForImageClassification"),Zd.forEach(o),en.forEach(o),qs=u(t),N=n(t,"DIV",{class:!0});var ft=r(N);v(Jt.$$.fragment,ft),mi=u(ft),Ca=n(ft,"P",{});var Qd=r(Ca);fi=l(Qd,`DeiT Model transformer with an image classification head on top (a linear layer on top of the final hidden state of
