...
`}}),le=new $o({props:{$$slots:{default:[vn]},$$scope:{ctx:x}}}),ce=new Vo({props:{anchor:"transformers.VideoMAEForPreTraining.forward.example",$$slots:{default:[En]},$$scope:{ctx:x}}}),Oe=new He({}),Ue=new Z({props:{name:"class transformers.VideoMAEForVideoClassification",anchor:"transformers.VideoMAEForVideoClassification",parameters:[{name:"config",val:""}],parametersDescription:[{anchor:"transformers.VideoMAEForVideoClassification.config",description:`<strong>config</strong> (<a href="/docs/transformers/main/en/model_doc/videomae#transformers.VideoMAEConfig">VideoMAEConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
...
as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),ds=h(),P=a("div"),b(Je.$$.fragment),ls=h(),K=a("p"),cs=i("The "),lt=a("a"),ms=i("VideoMAEForVideoClassification"),ps=i(" forward method, overrides the "),St=a("code"),hs=i("__call__"),fs=i(" special method."),us=h(),b(pe.$$.fragment),gs=h(),b(he.$$.fragment),this.h()},l(e){const m=mn('[data-svelte="svelte-1phssyn"]',document.head);l=s(m,"META",{name:!0,content:!0}),m.forEach(o),E=f(e),u=s(e,"H1",{class:!0});var Be=n(u);p=s(Be,"A",{id:!0,class:!0,href:!0});var Lt=n(p);v=s(Lt,"SPAN",{});var Dt=n(v);M(r.$$.fragment,Dt),Dt.forEach(o),Lt.forEach(o),g=f(Be),y=s(Be,"SPAN",{});var Ot=n(y);To=d(Ot,"VideoMAE"),Ot.forEach(o),Be.forEach(o),Jt=f(e),L=s(e,"H2",{class:!0});var Ge=n(L);X=s(Ge,"A",{id:!0,class:!0,href:!0});var Ut=n(X);Mt=s(Ut,"SPAN",{});var Rt=n(Mt);M(Ee.$$.fragment,Rt),Rt.forEach(o),Ut.forEach(o),jo=f(Ge),wt=s(Ge,"SPAN",{});var Wt=n(wt);ko=d(Wt,"Overview"),Wt.forEach(o),Ge.forEach(o),Bt=f(e),q=s(e,"P",{});var ct=n(q);Fo=d(ct,"The VideoMAE model was proposed in "),be=s(ct,"A",{href:!0,rel:!0});var Es=n(be);Po=d(Es,"VideoMAE: Masked Autoencoders are Data-Efficient Learners for Self-Supervised Video Pre-Training"),Es.forEach(o),Co=d(ct,` by Zhan Tong, Yibing Song, Jue Wang, Limin Wang.
