import{S as dn,i as ln,s as cn,e as a,k as h,w as b,t as i,M as mn,c as s,d as o,m as f,a as n,x as M,h as d,b as c,N as pn,G as t,g as _,y as w,q as A,o as $,B as V,v as hn,L as yo}from"../../chunks/vendor-hf-doc-builder.js";import{T as $o}from"../../chunks/Tip-hf-doc-builder.js";import{D as Z}from"../../chunks/Docstring-hf-doc-builder.js";import{C as xo}from"../../chunks/CodeBlock-hf-doc-builder.js";import{I as He}from"../../chunks/IconCopyLink-hf-doc-builder.js";import{E as Vo}from"../../chunks/ExampleCodeBlock-hf-doc-builder.js";function fn(y){let l,E,u,p,v;return p=new xo({props:{code:`from transformers import VideoMAEConfig, VideoMAEModel
...
<span class="hljs-meta">&gt;&gt;&gt; </span>configuration = model.config`}}),{c(){l=a("p"),E=i("Example:"),u=h(),b(p.$$.fragment)},l(r){l=s(r,"P",{});var g=n(l);E=d(g,"Example:"),g.forEach(o),u=f(r),M(p.$$.fragment,r)},m(r,g){_(r,l,g),t(l,E),_(r,u,g),w(p,r,g),v=!0},p:yo,i(r){v||(A(p.$$.fragment,r),v=!0)},o(r){$(p.$$.fragment,r),v=!1},d(r){r&&o(l),r&&o(u),V(p,r)}}}function un(y){let l,E;return{c(){l=a("p"),E=i("NumPy arrays are converted to PIL images when resizing, so the most efficient is to pass PIL images.")},l(u){l=s(u,"P",{});var p=n(l);E=d(p,"NumPy arrays are converted to PIL images when resizing, so the most efficient is to pass PIL images."),p.forEach(o)},m(u,p){_(u,l,p),t(l,E)},d(u){u&&o(l)}}}function gn(y){let l,E,u,p,v;return{c(){l=a("p"),E=i("Although the recipe for forward pass needs to be defined within this function, one should call the "),u=a("code"),p=i("Module"),v=i(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(r){l=s(r,"P",{});var g=n(l);E=d(g,"Although the recipe for forward pass needs to be defined within this function, one should call the "),u=s(g,"CODE",{});var x=n(u);p=d(x,"Module"),x.forEach(o),v=d(g,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),g.forEach(o)},m(r,g){_(r,l,g),t(l,E),t(l,u),t(u,p),t(l,v)},d(r){r&&o(l)}}}function _n(y){let l,E,u,p,v;return p=new xo({props:{code:`from decord import VideoReader, cpu
import numpy as np
...
[<span class="hljs-number">1</span>, <span class="hljs-number">1568</span>, <span class="hljs-number">768</span>]`}}),{c(){l=a("p"),E=i("Examples:"),u=h(),b(p.$$.fragment)},l(r){l=s(r,"P",{});var g=n(l);E=d(g,"Examples:"),g.forEach(o),u=f(r),M(p.$$.fragment,r)},m(r,g){_(r,l,g),t(l,E),_(r,u,g),w(p,r,g),v=!0},p:yo,i(r){v||(A(p.$$.fragment,r),v=!0)},o(r){$(p.$$.fragment,r),v=!1},d(r){r&&o(l),r&&o(u),V(p,r)}}}function vn(y){let l,E,u,p,v;return{c(){l=a("p"),E=i("Although the recipe for forward pass needs to be defined within this function, one should call the "),u=a("code"),p=i("Module"),v=i(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(r){l=s(r,"P",{});var g=n(l);E=d(g,"Although the recipe for forward pass needs to be defined within this function, one should call the "),u=s(g,"CODE",{});var x=n(u);p=d(x,"Module"),x.forEach(o),v=d(g,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),g.forEach(o)},m(r,g){_(r,l,g),t(l,E),t(l,u),t(u,p),t(l,v)},d(r){r&&o(l)}}}function En(y){let l,E,u,p,v;return p=new xo({props:{code:`from transformers import VideoMAEFeatureExtractor, VideoMAEForPreTraining
import numpy as np
import torch
...
<span class="hljs-meta">&gt;&gt;&gt; </span>loss = outputs.loss`}}),{c(){l=a("p"),E=i("Examples:"),u=h(),b(p.$$.fragment)},l(r){l=s(r,"P",{});var g=n(l);E=d(g,"Examples:"),g.forEach(o),u=f(r),M(p.$$.fragment,r)},m(r,g){_(r,l,g),t(l,E),_(r,u,g),w(p,r,g),v=!0},p:yo,i(r){v||(A(p.$$.fragment,r),v=!0)},o(r){$(p.$$.fragment,r),v=!1},d(r){r&&o(l),r&&o(u),V(p,r)}}}function bn(y){let l,E,u,p,v;return{c(){l=a("p"),E=i("Although the recipe for forward pass needs to be defined within this function, one should call the "),u=a("code"),p=i("Module"),v=i(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(r){l=s(r,"P",{});var g=n(l);E=d(g,"Although the recipe for forward pass needs to be defined within this function, one should call the "),u=s(g,"CODE",{});var x=n(u);p=d(x,"Module"),x.forEach(o),v=d(g,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),g.forEach(o)},m(r,g){_(r,l,g),t(l,E),t(l,u),t(u,p),t(l,v)},d(r){r&&o(l)}}}function Mn(y){let l,E,u,p,v;return p=new xo({props:{code:`from decord import VideoReader, cpu
import torch
import numpy as np
...
</ul>`,name:"return_tensors"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/videomae/feature_extraction_videomae.py#L103",returnDescription:`
<p>A <a
...
`}}),re=new $o({props:{$$slots:{default:[gn]},$$scope:{ctx:y}}}),ie=new Vo({props:{anchor:"transformers.VideoMAEModel.forward.example",$$slots:{default:[_n]},$$scope:{ctx:y}}}),qe=new He({}),Ne=new Z({props:{name:"class transformers.VideoMAEForPreTraining",anchor:"transformers.VideoMAEForPreTraining",parameters:[{name:"config",val:""}],parametersDescription:[{anchor:"transformers.VideoMAEForPreTraining.config",description:`<strong>config</strong> (<a href="/docs/transformers/main/en/model_doc/videomae#transformers.VideoMAEConfig">VideoMAEConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
...
`}}),le=new $o({props:{$$slots:{default:[vn]},$$scope:{ctx:y}}}),ce=new Vo({props:{anchor:"transformers.VideoMAEForPreTraining.forward.example",$$slots:{default:[En]},$$scope:{ctx:y}}}),Oe=new He({}),Re=new Z({props:{name:"class transformers.VideoMAEForVideoClassification",anchor:"transformers.VideoMAEForVideoClassification",parameters:[{name:"config",val:""}],parametersDescription:[{anchor:"transformers.VideoMAEForVideoClassification.config",description:`<strong>config</strong> (<a href="/docs/transformers/main/en/model_doc/videomae#transformers.VideoMAEConfig">VideoMAEConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
...
`}}),pe=new $o({props:{$$slots:{default:[bn]},$$scope:{ctx:y}}}),he=new Vo({props:{anchor:"transformers.VideoMAEForVideoClassification.forward.example",$$slots:{default:[Mn]},$$scope:{ctx:y}}}),{c(){l=a("meta"),E=h(),u=a("h1"),p=a("a"),v=a("span"),b(r.$$.fragment),g=h(),x=a("span"),To=i("VideoMAE"),Jt=h(),L=a("h2"),X=a("a"),Mt=a("span"),b(Ee.$$.fragment),jo=h(),wt=a("span"),ko=i("Overview"),Bt=h(),q=a("p"),Fo=i("The VideoMAE model was proposed in "),be=a("a"),Po=i("VideoMAE: Masked Autoencoders are Data-Efficient Learners for Self-Supervised Video Pre-Training"),Co=i(` by Zhan Tong, Yibing Song, Jue Wang, Limin Wang.
...
`),ye=a("a"),na=i("MCG-NJU/videomae-base"),ra=i(" architecture."),ia=h(),R=a("p"),da=i("Configuration objects inherit from "),st=a("a"),la=i("PretrainedConfig"),ca=i(` and can be used to control the model outputs. Read the
documentation from `),nt=a("a"),ma=i("PretrainedConfig"),pa=i(" for more information."),ha=h(),b(oe.$$.fragment),oo=h(),U=a("h2"),ae=a("a"),yt=a("span"),b(xe.$$.fragment),fa=h(),xt=a("span"),ua=i("VideoMAEFeatureExtractor"),ao=h(),j=a("div"),b(Te.$$.fragment),ga=h(),Tt=a("p"),_a=i("Constructs a VideoMAE feature extractor. This feature extractor can be used to prepare videos for the model."),va=h(),je=a("p"),Ea=i("This feature extractor inherits from "),rt=a("a"),ba=i("FeatureExtractionMixin"),Ma=i(` which contains most of the main methods. Users
