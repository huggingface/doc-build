...
[<span class="hljs-number">1</span>, <span class="hljs-number">1568</span>, <span class="hljs-number">768</span>]`}}),{c(){l=a("p"),E=i("Examples:"),u=h(),b(p.$$.fragment)},l(r){l=s(r,"P",{});var g=n(l);E=d(g,"Examples:"),g.forEach(o),u=f(r),M(p.$$.fragment,r)},m(r,g){_(r,l,g),t(l,E),_(r,u,g),w(p,r,g),v=!0},p:xo,i(r){v||(A(p.$$.fragment,r),v=!0)},o(r){$(p.$$.fragment,r),v=!1},d(r){r&&o(l),r&&o(u),V(p,r)}}}function vn(x){let l,E,u,p,v;return{c(){l=a("p"),E=i("Although the recipe for forward pass needs to be defined within this function, one should call the "),u=a("code"),p=i("Module"),v=i(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(r){l=s(r,"P",{});var g=n(l);E=d(g,"Although the recipe for forward pass needs to be defined within this function, one should call the "),u=s(g,"CODE",{});var y=n(u);p=d(y,"Module"),y.forEach(o),v=d(g,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
<span class="hljs-meta">&gt;&gt;&gt; </span>loss = outputs.loss`}}),{c(){l=a("p"),E=i("Examples:"),u=h(),b(p.$$.fragment)},l(r){l=s(r,"P",{});var g=n(l);E=d(g,"Examples:"),g.forEach(o),u=f(r),M(p.$$.fragment,r)},m(r,g){_(r,l,g),t(l,E),_(r,u,g),w(p,r,g),v=!0},p:xo,i(r){v||(A(p.$$.fragment,r),v=!0)},o(r){$(p.$$.fragment,r),v=!1},d(r){r&&o(l),r&&o(u),V(p,r)}}}function bn(x){let l,E,u,p,v;return{c(){l=a("p"),E=i("Although the recipe for forward pass needs to be defined within this function, one should call the "),u=a("code"),p=i("Module"),v=i(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(r){l=s(r,"P",{});var g=n(l);E=d(g,"Although the recipe for forward pass needs to be defined within this function, one should call the "),u=s(g,"CODE",{});var y=n(u);p=d(y,"Module"),y.forEach(o),v=d(g,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
<p><a
  href="/docs/transformers/main/en/main_classes/feature_extractor#transformers.BatchFeature"
>BatchFeature</a></p>
`}}),se=new $o({props:{warning:!0,$$slots:{default:[un]},$$scope:{ctx:x}}}),Fe=new He({}),Pe=new Z({props:{name:"class transformers.VideoMAEModel",anchor:"transformers.VideoMAEModel",parameters:[{name:"config",val:""}],parametersDescription:[{anchor:"transformers.VideoMAEModel.config",description:`<strong>config</strong> (<a href="/docs/transformers/main/en/model_doc/videomae#transformers.VideoMAEConfig">VideoMAEConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
...
`}}),le=new $o({props:{$$slots:{default:[vn]},$$scope:{ctx:x}}}),ce=new Vo({props:{anchor:"transformers.VideoMAEForPreTraining.forward.example",$$slots:{default:[En]},$$scope:{ctx:x}}}),Oe=new He({}),Re=new Z({props:{name:"class transformers.VideoMAEForVideoClassification",anchor:"transformers.VideoMAEForVideoClassification",parameters:[{name:"config",val:""}],parametersDescription:[{anchor:"transformers.VideoMAEForVideoClassification.config",description:`<strong>config</strong> (<a href="/docs/transformers/main/en/model_doc/videomae#transformers.VideoMAEConfig">VideoMAEConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
...
`}}),pe=new $o({props:{$$slots:{default:[bn]},$$scope:{ctx:x}}}),he=new Vo({props:{anchor:"transformers.VideoMAEForVideoClassification.forward.example",$$slots:{default:[Mn]},$$scope:{ctx:x}}}),{c(){l=a("meta"),E=h(),u=a("h1"),p=a("a"),v=a("span"),b(r.$$.fragment),g=h(),y=a("span"),To=i("VideoMAE"),Jt=h(),L=a("h2"),X=a("a"),Mt=a("span"),b(Ee.$$.fragment),jo=h(),wt=a("span"),ko=i("Overview"),Bt=h(),q=a("p"),Fo=i("The VideoMAE model was proposed in "),be=a("a"),Po=i("VideoMAE: Masked Autoencoders are Data-Efficient Learners for Self-Supervised Video Pre-Training"),Co=i(` by Zhan Tong, Yibing Song, Jue Wang, Limin Wang.
...
`),xe=a("a"),na=i("MCG-NJU/videomae-base"),ra=i(" architecture."),ia=h(),R=a("p"),da=i("Configuration objects inherit from "),st=a("a"),la=i("PretrainedConfig"),ca=i(` and can be used to control the model outputs. Read the
documentation from `),nt=a("a"),ma=i("PretrainedConfig"),pa=i(" for more information."),ha=h(),b(oe.$$.fragment),oo=h(),U=a("h2"),ae=a("a"),xt=a("span"),b(ye.$$.fragment),fa=h(),yt=a("span"),ua=i("VideoMAEFeatureExtractor"),ao=h(),j=a("div"),b(Te.$$.fragment),ga=h(),Tt=a("p"),_a=i("Constructs a VideoMAE feature extractor. This feature extractor can be used to prepare videos for the model."),va=h(),je=a("p"),Ea=i("This feature extractor inherits from "),rt=a("a"),ba=i("FeatureExtractionMixin"),Ma=i(` which contains most of the main methods. Users
...
documentation from `),nt=s(ht,"A",{href:!0});var qs=n(nt);ma=d(qs,"PretrainedConfig"),qs.forEach(o),pa=d(ht," for more information."),ht.forEach(o),ha=f(fe),M(oe.$$.fragment,fe),fe.forEach(o),oo=f(e),U=s(e,"H2",{class:!0});var go=n(U);ae=s(go,"A",{id:!0,class:!0,href:!0});var Ns=n(ae);xt=s(Ns,"SPAN",{});var Ss=n(xt);M(ye.$$.fragment,Ss),Ss.forEach(o),Ns.forEach(o),fa=f(go),yt=s(go,"SPAN",{});var Ls=n(yt);ua=d(Ls,"VideoMAEFeatureExtractor"),Ls.forEach(o),go.forEach(o),ao=f(e),j=s(e,"DIV",{class:!0});var ue=n(j);M(Te.$$.fragment,ue),ga=f(ue),Tt=s(ue,"P",{});var Ds=n(Tt);_a=d(Ds,"Constructs a VideoMAE feature extractor. This feature extractor can be used to prepare videos for the model."),Ds.forEach(o),va=f(ue),je=s(ue,"P",{});var _o=n(je);Ea=d(_o,"This feature extractor inherits from "),rt=s(_o,"A",{href:!0});var Os=n(rt);ba=d(Os,"FeatureExtractionMixin"),Os.forEach(o),Ma=d(_o,` which contains most of the main methods. Users
should refer to this superclass for more information regarding those methods.`),_o.forEach(o),wa=f(ue),S=s(ue,"DIV",{class:!0});var ft=n(S);M(ke.$$.fragment,ft),Aa=f(ft),jt=s(ft,"P",{});var Rs=n(jt);$a=d(Rs,"Main method to prepare for the model one or several video(s)."),Rs.forEach(o),Va=f(ft),M(se.$$.fragment,ft),ft.forEach(o),ue.forEach(o),so=f(e),W=s(e,"H2",{class:!0});var vo=n(W);ne=s(vo,"A",{id:!0,class:!0,href:!0});var Us=n(ne);kt=s(Us,"SPAN",{});var Ws=n(kt);M(Fe.$$.fragment,Ws),Ws.forEach(o),Us.forEach(o),xa=f(vo),Ft=s(vo,"SPAN",{});var Js=n(Ft);ya=d(Js,"VideoMAEModel"),Js.forEach(o),vo.forEach(o),no=f(e),C=s(e,"DIV",{class:!0});var ut=n(C);M(Pe.$$.fragment,ut),Ta=f(ut),Ce=s(ut,"P",{});var Eo=n(Ce);ja=d(Eo,`The bare VideoMAE Model transformer outputting raw hidden-states without any specific head on top.
