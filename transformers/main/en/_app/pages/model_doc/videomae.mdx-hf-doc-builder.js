...
`}}),le=new $o({props:{$$slots:{default:[vn]},$$scope:{ctx:y}}}),ce=new Vo({props:{anchor:"transformers.VideoMAEForPreTraining.forward.example",$$slots:{default:[En]},$$scope:{ctx:y}}}),Oe=new He({}),Ue=new Z({props:{name:"class transformers.VideoMAEForVideoClassification",anchor:"transformers.VideoMAEForVideoClassification",parameters:[{name:"config",val:""}],parametersDescription:[{anchor:"transformers.VideoMAEForVideoClassification.config",description:`<strong>config</strong> (<a href="/docs/transformers/main/en/model_doc/videomae#transformers.VideoMAEConfig">VideoMAEConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
...
`),ye=a("a"),na=i("MCG-NJU/videomae-base"),ra=i(" architecture."),ia=h(),U=a("p"),da=i("Configuration objects inherit from "),st=a("a"),la=i("PretrainedConfig"),ca=i(` and can be used to control the model outputs. Read the
...
documentation from `),nt=s(ht,"A",{href:!0});var qs=n(nt);ma=d(qs,"PretrainedConfig"),qs.forEach(o),pa=d(ht," for more information."),ht.forEach(o),ha=f(fe),M(oe.$$.fragment,fe),fe.forEach(o),oo=f(e),R=s(e,"H2",{class:!0});var go=n(R);ae=s(go,"A",{id:!0,class:!0,href:!0});var Ns=n(ae);yt=s(Ns,"SPAN",{});var Ss=n(yt);M(xe.$$.fragment,Ss),Ss.forEach(o),Ns.forEach(o),fa=f(go),xt=s(go,"SPAN",{});var Ls=n(xt);ua=d(Ls,"VideoMAEFeatureExtractor"),Ls.forEach(o),go.forEach(o),ao=f(e),j=s(e,"DIV",{class:!0});var ue=n(j);M(Te.$$.fragment,ue),ga=f(ue),Tt=s(ue,"P",{});var Ds=n(Tt);_a=d(Ds,"Constructs a VideoMAE feature extractor. This feature extractor can be used to prepare videos for the model."),Ds.forEach(o),va=f(ue),je=s(ue,"P",{});var _o=n(je);Ea=d(_o,"This feature extractor inherits from "),rt=s(_o,"A",{href:!0});var Os=n(rt);ba=d(Os,"FeatureExtractionMixin"),Os.forEach(o),Ma=d(_o,` which contains most of the main methods. Users
should refer to this superclass for more information regarding those methods.`),_o.forEach(o),wa=f(ue),S=s(ue,"DIV",{class:!0});var ft=n(S);M(ke.$$.fragment,ft),Aa=f(ft),jt=s(ft,"P",{});var Us=n(jt);$a=d(Us,"Main method to prepare for the model one or several video(s)."),Us.forEach(o),Va=f(ft),M(se.$$.fragment,ft),ft.forEach(o),ue.forEach(o),so=f(e),W=s(e,"H2",{class:!0});var vo=n(W);ne=s(vo,"A",{id:!0,class:!0,href:!0});var Rs=n(ne);kt=s(Rs,"SPAN",{});var Ws=n(kt);M(Fe.$$.fragment,Ws),Ws.forEach(o),Rs.forEach(o),ya=f(vo),Ft=s(vo,"SPAN",{});var Js=n(Ft);xa=d(Js,"VideoMAEModel"),Js.forEach(o),vo.forEach(o),no=f(e),C=s(e,"DIV",{class:!0});var ut=n(C);M(Pe.$$.fragment,ut),Ta=f(ut),Ce=s(ut,"P",{});var Eo=n(Ce);ja=d(Eo,`The bare VideoMAE Model transformer outputting raw hidden-states without any specific head on top.
