import{S as Bf,i as zf,s as xf,e as n,k as i,w as f,t as r,M as Ff,c as a,d as t,m as l,a as s,x as _,h as d,b as c,F as e,g as p,y as g,q as b,o as k,B as v,v as $f}from"../../chunks/vendor-6b77c823.js";import{T as ho}from"../../chunks/Tip-39098574.js";import{D as O}from"../../chunks/Docstring-abef54e3.js";import{C as Ve}from"../../chunks/CodeBlock-3a8b25a8.js";import{I as pe}from"../../chunks/IconCopyLink-7a11ce68.js";function qf(U){let u,x,y,B,z;return{c(){u=n("p"),x=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),y=n("code"),B=r("Module"),z=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(w){u=a(w,"P",{});var T=s(u);x=d(T,"Although the recipe for forward pass needs to be defined within this function, one should call the "),y=a(T,"CODE",{});var F=s(y);B=d(F,"Module"),F.forEach(t),z=d(T,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),T.forEach(t)},m(w,T){p(w,u,T),e(u,x),e(u,y),e(y,B),e(u,z)},d(w){w&&t(u)}}}function Ef(U){let u,x,y,B,z;return{c(){u=n("p"),x=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),y=n("code"),B=r("Module"),z=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(w){u=a(w,"P",{});var T=s(u);x=d(T,"Although the recipe for forward pass needs to be defined within this function, one should call the "),y=a(T,"CODE",{});var F=s(y);B=d(F,"Module"),F.forEach(t),z=d(T,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),T.forEach(t)},m(w,T){p(w,u,T),e(u,x),e(u,y),e(y,B),e(u,z)},d(w){w&&t(u)}}}function Mf(U){let u,x,y,B,z,w,T,F,Me,he,q,ve,te,Ce,oe,ne,je,Fe,D,P,ye,R,E,C,Oe,J,Q,Pe,G,Ne,Ae,N,ue,ae,$e,me,H,Ie,qe,M,Le,W,Se;return{c(){u=n("p"),x=r("TF 2.0 models accepts two formats as inputs:"),y=i(),B=n("ul"),z=n("li"),w=r("having all inputs as keyword arguments (like PyTorch models), or"),T=i(),F=n("li"),Me=r("having all inputs as a list, tuple or dict in the first positional arguments."),he=i(),q=n("p"),ve=r("This second option is useful when using "),te=n("code"),Ce=r("tf.keras.Model.fit"),oe=r(` method which currently requires having all the
tensors in the first argument of the model call function: `),ne=n("code"),je=r("model(inputs)"),Fe=r("."),D=i(),P=n("p"),ye=r(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
...
`),W=n("code"),Se=r('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(m){u=a(m,"P",{});var $=s(u);x=d($,"TF 2.0 models accepts two formats as inputs:"),$.forEach(t),y=l(m),B=a(m,"UL",{});var Te=s(B);z=a(Te,"LI",{});var ht=s(z);w=d(ht,"having all inputs as keyword arguments (like PyTorch models), or"),ht.forEach(t),T=l(Te),F=a(Te,"LI",{});var Ke=s(F);Me=d(Ke,"having all inputs as a list, tuple or dict in the first positional arguments."),Ke.forEach(t),Te.forEach(t),he=l(m),q=a(m,"P",{});var j=s(q);ve=d(j,"This second option is useful when using "),te=a(j,"CODE",{});var fe=s(te);Ce=d(fe,"tf.keras.Model.fit"),fe.forEach(t),oe=d(j,` method which currently requires having all the
tensors in the first argument of the model call function: `),ne=a(j,"CODE",{});var De=s(ne);je=d(De,"model(inputs)"),De.forEach(t),Fe=d(j,"."),j.forEach(t),D=l(m),P=a(m,"P",{});var we=s(P);ye=d(we,`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
...
the latter silently ignores them.`)},l(w){u=a(w,"P",{});var T=s(u);x=d(T,"Although the recipe for forward pass needs to be defined within this function, one should call the "),y=a(T,"CODE",{});var F=s(y);B=d(F,"Module"),F.forEach(t),z=d(T,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),T.forEach(t)},m(w,T){p(w,u,T),e(u,x),e(u,y),e(y,B),e(u,z)},d(w){w&&t(u)}}}function Pf(U){let u,x,y,B,z;return{c(){u=n("p"),x=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),y=n("code"),B=r("Module"),z=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(w){u=a(w,"P",{});var T=s(u);x=d(T,"Although the recipe for forward pass needs to be defined within this function, one should call the "),y=a(T,"CODE",{});var F=s(y);B=d(F,"Module"),F.forEach(t),z=d(T,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),T.forEach(t)},m(w,T){p(w,u,T),e(u,x),e(u,y),e(y,B),e(u,z)},d(w){w&&t(u)}}}function Nf(U){let u,x,y,B,z;return{c(){u=n("p"),x=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),y=n("code"),B=r("Module"),z=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(w){u=a(w,"P",{});var T=s(u);x=d(T,"Although the recipe for forward pass needs to be defined within this function, one should call the "),y=a(T,"CODE",{});var F=s(y);B=d(F,"Module"),F.forEach(t),z=d(T,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),T.forEach(t)},m(w,T){p(w,u,T),e(u,x),e(u,y),e(y,B),e(u,z)},d(w){w&&t(u)}}}function Af(U){let u,x,y,B,z,w,T,F,Me,he,q,ve,te,Ce,oe,ne,je,Fe,D,P,ye,R,E,C,Oe,J,Q,Pe,G,Ne,Ae,N,ue,ae,$e,me,H,Ie,qe,M,Le,W,Se,m,$,Te,ht,Ke,j,fe,De,we,V,K,ut,Je,A,Be,mt,se,ft,$d,qd,uo,Ed,mo,Md,Cd,jd,Ge,Od,qa,Pd,Nd,Ea,Ad,Id,Un,Ld,Sd,Tr,_t,Nt,Ma,fo,Dd,Ca,Gd,wr,Rn,Wd,Br,_o,zr,gt,At,ja,go,Ud,Oa,Rd,xr,re,bo,Hd,bt,Vd,Hn,Kd,Jd,ko,Qd,Xd,Yd,kt,Zd,Vn,ei,ti,Kn,oi,ni,ai,Pa,si,ri,vo,Fr,vt,It,Na,yo,di,Aa,ii,$r,de,To,li,Ia,ci,pi,Lt,La,hi,ui,Jn,mi,fi,_i,wo,gi,Qn,bi,ki,vi,Qe,Bo,yi,Sa,Ti,wi,Da,Xn,Bi,Ga,zi,qr,yt,St,Wa,zo,xi,Ua,Fi,Er,ie,xo,$i,Fo,qi,Ra,Ei,Mi,Ci,Dt,Ha,ji,Oi,Yn,Pi,Ni,Ai,$o,Ii,Zn,Li,Si,Di,Xe,qo,Gi,Va,Wi,Ui,Ka,ea,Ri,Ja,Hi,Mr,Tt,Gt,Qa,Eo,Vi,Xa,Ki,Cr,We,Ji,Ya,Qi,Xi,Za,Yi,Zi,es,el,jr,ze,Mo,tl,Co,ol,ta,nl,al,sl,jo,rl,Oo,dl,il,ll,_e,Po,cl,wt,pl,oa,hl,ul,ts,ml,fl,_l,Wt,gl,os,bl,kl,No,Or,Bt,Ut,ns,Ao,vl,as,yl,Pr,Ue,Tl,na,wl,Bl,ss,zl,xl,rs,Fl,Nr,xe,Io,$l,Lo,ql,aa,El,Ml,Cl,So,jl,Do,Ol,Pl,Nl,ge,Go,Al,zt,Il,sa,Ll,Sl,ds,Dl,Gl,Wl,Rt,Ul,is,Rl,Hl,Wo,Ar,xt,Ht,ls,Uo,Vl,cs,Kl,Ir,Ft,Ro,Jl,Ye,Ho,Ql,ps,Xl,Yl,Vo,Lr,$t,Vt,hs,Ko,Zl,us,ec,Sr,le,Jo,tc,Qo,oc,ra,nc,ac,sc,Xo,rc,Yo,dc,ic,lc,Kt,cc,be,Zo,pc,qt,hc,da,uc,mc,ms,fc,_c,gc,Jt,bc,fs,kc,vc,en,Dr,Et,Qt,_s,tn,yc,gs,Tc,Gr,ce,on,wc,nn,Bc,ia,zc,xc,Fc,an,$c,sn,qc,Ec,Mc,Xt,Cc,X,rn,jc,Mt,Oc,la,Pc,Nc,bs,Ac,Ic,Lc,Yt,Sc,ks,Dc,Gc,vs,ys,Ts,ws,Wc,Uc,Bs,zs,xs,dn,Rc,Fs,Hc,Vc,Wr,Ct,Zt,$s,ln,Kc,qs,Jc,Ur,I,cn,Qc,pn,Xc,ca,Yc,Zc,ep,hn,tp,un,op,np,ap,Es,sp,rp,Re,Ms,mn,dp,ip,Cs,fn,lp,cp,js,_n,pp,hp,Os,gn,up,mp,ke,bn,fp,jt,_p,Ps,gp,bp,Ns,kp,vp,yp,eo,Tp,As,wp,Bp,kn,zp,Ze,vn,xp,Is,Fp,$p,yn,qp,et,Tn,Ep,Ls,Mp,Cp,wn,Rr,Ot,to,Ss,Bn,jp,Ds,Op,Hr,L,zn,Pp,xn,Np,pa,Ap,Ip,Lp,Fn,Sp,$n,Dp,Gp,Wp,Gs,Up,Rp,He,Ws,qn,Hp,Vp,Us,En,Kp,Jp,Rs,Mn,Qp,Xp,Hs,Cn,Yp,Zp,S,jn,eh,Pt,th,Vs,oh,nh,Ks,ah,sh,rh,oo,dh,Js,ih,lh,Qs,Xs,Ys,Zs,ch,ph,er,tr,or,nr,hh,uh,ar,sr,rr,dr,mh,fh,ir,lr,On,no,ao,cr,Pn,_h,pr,gh,bh,hr,kh,vh,tt,Nn,yh,ur,Th,wh,An,Bh,ot,In,zh,mr,xh,Fh,Ln,Vr;return w=new pe({}),R=new pe({}),we=new pe({}),fo=new pe({}),_o=new Ve({props:{code:`from transformers import BlenderbotTokenizer, BlenderbotForConditionalGeneration
...
<span class="hljs-meta">&gt;&gt;&gt; </span>outputs = model.decode(decoder_input_ids, encoder_outputs)
<span class="hljs-meta">&gt;&gt;&gt; </span>logits = outputs.logits`}}),{c(){u=n("meta"),x=i(),y=n("h1"),B=n("a"),z=n("span"),f(w.$$.fragment),T=i(),F=n("span"),Me=r("Blenderbot"),he=i(),q=n("p"),ve=n("strong"),te=r("DISCLAIMER:"),Ce=r(" If you see something strange, file a "),oe=n("a"),ne=r("Github Issue"),je=r(" ."),Fe=i(),D=n("h2"),P=n("a"),ye=n("span"),f(R.$$.fragment),E=i(),C=n("span"),Oe=r("Overview"),J=i(),Q=n("p"),Pe=r("The Blender chatbot model was proposed in "),G=n("a"),Ne=r("Recipes for building an open-domain chatbot"),Ae=r(` Stephen Roller, Emily Dinan, Naman Goyal, Da Ju, Mary Williamson, Yinhan Liu,
...
adding special tokens. A Blenderbot sequence has the following format:`),Ui=i(),Ka=n("ul"),ea=n("li"),Ri=r("single sequence: "),Ja=n("code"),Hi=r("X </s>"),Mr=i(),Tt=n("h2"),Gt=n("a"),Qa=n("span"),f(Eo.$$.fragment),Vi=i(),Xa=n("span"),Ki=r("BlenderbotModel"),Cr=i(),We=n("p"),Ji=r("See "),Ya=n("code"),Qi=r("transformers.BartModel"),Xi=r(" for arguments to "),Za=n("em"),Yi=r("forward"),Zi=r(" and "),es=n("em"),el=r("generate"),jr=i(),ze=n("div"),f(Mo.$$.fragment),tl=i(),Co=n("p"),ol=r(`The bare Blenderbot Model outputting raw hidden-states without any specific head on top.
...
and behavior.`),ll=i(),_e=n("div"),f(Po.$$.fragment),cl=i(),wt=n("p"),pl=r("The "),oa=n("a"),hl=r("BlenderbotModel"),ul=r(" forward method, overrides the "),ts=n("code"),ml=r("__call__"),fl=r(" special method."),_l=i(),f(Wt.$$.fragment),gl=i(),os=n("p"),bl=r("Example:"),kl=i(),f(No.$$.fragment),Or=i(),Bt=n("h2"),Ut=n("a"),ns=n("span"),f(Ao.$$.fragment),vl=i(),as=n("span"),yl=r("BlenderbotForConditionalGeneration"),Pr=i(),Ue=n("p"),Tl=r("See "),na=n("a"),wl=r("BartForConditionalGeneration"),Bl=r(" for arguments to "),ss=n("em"),zl=r("forward"),xl=r(" and "),rs=n("em"),Fl=r("generate"),Nr=i(),xe=n("div"),f(Io.$$.fragment),$l=i(),Lo=n("p"),ql=r(`The Blenderbot Model with a language modeling head. Can be used for summarization.
...
behavior.`),lc=i(),f(Kt.$$.fragment),cc=i(),be=n("div"),f(Zo.$$.fragment),pc=i(),qt=n("p"),hc=r("The "),da=n("a"),uc=r("TFBlenderbotModel"),mc=r(" forward method, overrides the "),ms=n("code"),fc=r("__call__"),_c=r(" special method."),gc=i(),f(Jt.$$.fragment),bc=i(),fs=n("p"),kc=r("Example:"),vc=i(),f(en.$$.fragment),Dr=i(),Et=n("h2"),Qt=n("a"),_s=n("span"),f(tn.$$.fragment),yc=i(),gs=n("span"),Tc=r("TFBlenderbotForConditionalGeneration"),Gr=i(),ce=n("div"),f(on.$$.fragment),wc=i(),nn=n("p"),Bc=r(`The BLENDERBOT Model with a language modeling head. Can be used for summarization.
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Fc=i(),an=n("p"),$c=r("This model is also a "),sn=n("a"),qc=r("tf.keras.Model"),Ec=r(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
...
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),ap=i(),Es=n("p"),sp=r("Finally, this model supports inherent JAX features such as:"),rp=i(),Re=n("ul"),Ms=n("li"),mn=n("a"),dp=r("Just-In-Time (JIT) compilation"),ip=i(),Cs=n("li"),fn=n("a"),lp=r("Automatic Differentiation"),cp=i(),js=n("li"),_n=n("a"),pp=r("Vectorization"),hp=i(),Os=n("li"),gn=n("a"),up=r("Parallelization"),mp=i(),ke=n("div"),f(bn.$$.fragment),fp=i(),jt=n("p"),_p=r("The "),Ps=n("code"),gp=r("FlaxBlenderbotPreTrainedModel"),bp=r("forward method, overrides the "),Ns=n("code"),kp=r("__call__"),vp=r(" special method."),yp=i(),f(eo.$$.fragment),Tp=i(),As=n("p"),wp=r("Example:"),Bp=i(),f(kn.$$.fragment),zp=i(),Ze=n("div"),f(vn.$$.fragment),xp=i(),Is=n("p"),Fp=r("Example:"),$p=i(),f(yn.$$.fragment),qp=i(),et=n("div"),f(Tn.$$.fragment),Ep=i(),Ls=n("p"),Mp=r("Example:"),Cp=i(),f(wn.$$.fragment),Rr=i(),Ot=n("h2"),to=n("a"),Ss=n("span"),f(Bn.$$.fragment),jp=i(),Ds=n("span"),Op=r("FlaxBlenderbotForConditionalGeneration"),Hr=i(),L=n("div"),f(zn.$$.fragment),Pp=i(),xn=n("p"),Np=r(`The Blenderbot Model with a language modeling head. Can be used for summarization.
...
clean_up_tokenization_spaces=False) for g in reply_ids])`),vh=i(),tt=n("div"),f(Nn.$$.fragment),yh=i(),ur=n("p"),Th=r("Example:"),wh=i(),f(An.$$.fragment),Bh=i(),ot=n("div"),f(In.$$.fragment),zh=i(),mr=n("p"),xh=r("Example:"),Fh=i(),f(Ln.$$.fragment),this.h()},l(o){const h=Ff('[data-svelte="svelte-1phssyn"]',document.head);u=a(h,"META",{name:!0,content:!0}),h.forEach(t),x=l(o),y=a(o,"H1",{class:!0});var Sn=s(y);B=a(Sn,"A",{id:!0,class:!0,href:!0});var fr=s(B);z=a(fr,"SPAN",{});var _r=s(z);_(w.$$.fragment,_r),_r.forEach(t),fr.forEach(t),T=l(Sn),F=a(Sn,"SPAN",{});var gr=s(F);Me=d(gr,"Blenderbot"),gr.forEach(t),Sn.forEach(t),he=l(o),q=a(o,"P",{});var so=s(q);ve=a(so,"STRONG",{});var br=s(ve);te=d(br,"DISCLAIMER:"),br.forEach(t),Ce=d(so," If you see something strange, file a "),oe=a(so,"A",{href:!0,rel:!0});var kr=s(oe);ne=d(kr,"Github Issue"),kr.forEach(t),je=d(so," ."),so.forEach(t),Fe=l(o),D=a(o,"H2",{class:!0});var Dn=s(D);P=a(Dn,"A",{id:!0,class:!0,href:!0});var Eh=s(P);ye=a(Eh,"SPAN",{});var Mh=s(ye);_(R.$$.fragment,Mh),Mh.forEach(t),Eh.forEach(t),E=l(Dn),C=a(Dn,"SPAN",{});var Ch=s(C);Oe=d(Ch,"Overview"),Ch.forEach(t),Dn.forEach(t),J=l(o),Q=a(o,"P",{});var Kr=s(Q);Pe=d(Kr,"The Blender chatbot model was proposed in "),G=a(Kr,"A",{href:!0,rel:!0});var jh=s(G);Ne=d(jh,"Recipes for building an open-domain chatbot"),jh.forEach(t),Ae=d(Kr,` Stephen Roller, Emily Dinan, Naman Goyal, Da Ju, Mary Williamson, Yinhan Liu,
...
adding special tokens. A Blenderbot sequence has the following format:`),Tu.forEach(t),Ui=l(ga),Ka=a(ga,"UL",{});var wu=s(Ka);ea=a(wu,"LI",{});var qh=s(ea);Ri=d(qh,"single sequence: "),Ja=a(qh,"CODE",{});var Bu=s(Ja);Hi=d(Bu,"X </s>"),Bu.forEach(t),qh.forEach(t),wu.forEach(t),ga.forEach(t),st.forEach(t),Mr=l(o),Tt=a(o,"H2",{class:!0});var sd=s(Tt);Gt=a(sd,"A",{id:!0,class:!0,href:!0});var zu=s(Gt);Qa=a(zu,"SPAN",{});var xu=s(Qa);_(Eo.$$.fragment,xu),xu.forEach(t),zu.forEach(t),Vi=l(sd),Xa=a(sd,"SPAN",{});var Fu=s(Xa);Ki=d(Fu,"BlenderbotModel"),Fu.forEach(t),sd.forEach(t),Cr=l(o),We=a(o,"P",{});var Gn=s(We);Ji=d(Gn,"See "),Ya=a(Gn,"CODE",{});var $u=s(Ya);Qi=d($u,"transformers.BartModel"),$u.forEach(t),Xi=d(Gn," for arguments to "),Za=a(Gn,"EM",{});var qu=s(Za);Yi=d(qu,"forward"),qu.forEach(t),Zi=d(Gn," and "),es=a(Gn,"EM",{});var Eu=s(es);el=d(Eu,"generate"),Eu.forEach(t),Gn.forEach(t),jr=l(o),ze=a(o,"DIV",{class:!0});var io=s(ze);_(Mo.$$.fragment,io),tl=l(io),Co=a(io,"P",{});var rd=s(Co);ol=d(rd,`The bare Blenderbot Model outputting raw hidden-states without any specific head on top.
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),cd.forEach(t),Nl=l(lo),ge=a(lo,"DIV",{class:!0});var dt=s(ge);_(Go.$$.fragment,dt),Al=l(dt),zt=a(dt,"P",{});var ka=s(zt);Il=d(ka,"The "),sa=a(ka,"A",{href:!0});var Uu=s(sa);Ll=d(Uu,"BlenderbotForConditionalGeneration"),Uu.forEach(t),Sl=d(ka," forward method, overrides the "),ds=a(ka,"CODE",{});var Ru=s(ds);Dl=d(Ru,"__call__"),Ru.forEach(t),Gl=d(ka," special method."),ka.forEach(t),Wl=l(dt),_(Rt.$$.fragment,dt),Ul=l(dt),is=a(dt,"P",{});var Hu=s(is);Rl=d(Hu,"Conversation example:"),Hu.forEach(t),Hl=l(dt),_(Wo.$$.fragment,dt),dt.forEach(t),lo.forEach(t),Ar=l(o),xt=a(o,"H2",{class:!0});var pd=s(xt);Ht=a(pd,"A",{id:!0,class:!0,href:!0});var Vu=s(Ht);ls=a(Vu,"SPAN",{});var Ku=s(ls);_(Uo.$$.fragment,Ku),Ku.forEach(t),Vu.forEach(t),Vl=l(pd),cs=a(pd,"SPAN",{});var Ju=s(cs);Kl=d(Ju,"BlenderbotForCausalLM"),Ju.forEach(t),pd.forEach(t),Ir=l(o),Ft=a(o,"DIV",{class:!0});var hd=s(Ft);_(Ro.$$.fragment,hd),Jl=l(hd),Ye=a(hd,"DIV",{class:!0});var va=s(Ye);_(Ho.$$.fragment,va),Ql=l(va),ps=a(va,"P",{});var Qu=s(ps);Xl=d(Qu,"Example:"),Qu.forEach(t),Yl=l(va),_(Vo.$$.fragment,va),va.forEach(t),hd.forEach(t),Lr=l(o),$t=a(o,"H2",{class:!0});var ud=s($t);Vt=a(ud,"A",{id:!0,class:!0,href:!0});var Xu=s(Vt);hs=a(Xu,"SPAN",{});var Yu=s(hs);_(Ko.$$.fragment,Yu),Yu.forEach(t),Xu.forEach(t),Zl=l(ud),us=a(ud,"SPAN",{});var Zu=s(us);ec=d(Zu,"TFBlenderbotModel"),Zu.forEach(t),ud.forEach(t),Sr=l(o),le=a(o,"DIV",{class:!0});var it=s(le);_(Jo.$$.fragment,it),tc=l(it),Qo=a(it,"P",{});var md=s(Qo);oc=d(md,`The bare BLENDERBOT Model outputting raw hidden-states without any specific head on top.
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),fd.forEach(t),lc=l(it),_(Kt.$$.fragment,it),cc=l(it),be=a(it,"DIV",{class:!0});var lt=s(be);_(Zo.$$.fragment,lt),pc=l(lt),qt=a(lt,"P",{});var ya=s(qt);hc=d(ya,"The "),da=a(ya,"A",{href:!0});var om=s(da);uc=d(om,"TFBlenderbotModel"),om.forEach(t),mc=d(ya," forward method, overrides the "),ms=a(ya,"CODE",{});var nm=s(ms);fc=d(nm,"__call__"),nm.forEach(t),_c=d(ya," special method."),ya.forEach(t),gc=l(lt),_(Jt.$$.fragment,lt),bc=l(lt),fs=a(lt,"P",{});var am=s(fs);kc=d(am,"Example:"),am.forEach(t),vc=l(lt),_(en.$$.fragment,lt),lt.forEach(t),it.forEach(t),Dr=l(o),Et=a(o,"H2",{class:!0});var _d=s(Et);Qt=a(_d,"A",{id:!0,class:!0,href:!0});var sm=s(Qt);_s=a(sm,"SPAN",{});var rm=s(_s);_(tn.$$.fragment,rm),rm.forEach(t),sm.forEach(t),yc=l(_d),gs=a(_d,"SPAN",{});var dm=s(gs);Tc=d(dm,"TFBlenderbotForConditionalGeneration"),dm.forEach(t),_d.forEach(t),Gr=l(o),ce=a(o,"DIV",{class:!0});var ct=s(ce);_(on.$$.fragment,ct),wc=l(ct),nn=a(ct,"P",{});var gd=s(nn);Bc=d(gd,`The BLENDERBOT Model with a language modeling head. Can be used for summarization.
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),gd.forEach(t),Fc=l(ct),an=a(ct,"P",{});var bd=s(an);$c=d(bd,"This model is also a "),sn=a(bd,"A",{href:!0,rel:!0});var lm=s(sn);qc=d(lm,"tf.keras.Model"),lm.forEach(t),Ec=d(bd,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
...
many carbs.\u201D >>> print(\u201CHuman: \u201D, UTTERANCE) >>> inputs = tokenizer([UTTERANCE], return_tensors=\u2018tf\u2019) >>>
reply_ids = model.generate(**inputs) >>> print(\u201CBot: \u201D, tokenizer.batch_decode(reply_ids,
skip_special_tokens=True)[0])`),_m.forEach(t),fm.forEach(t),mm.forEach(t),um.forEach(t),Uc=l(Ee),Bs=a(Ee,"BLOCKQUOTE",{});var gm=s(Bs);zs=a(gm,"BLOCKQUOTE",{});var bm=s(zs);xs=a(bm,"BLOCKQUOTE",{});var km=s(xs);dn=a(km,"P",{});var kd=s(dn);Rc=d(kd,`REPLY = \u201CI\u2019m not sure\u201D >>> print(\u201CHuman: \u201D, REPLY) >>> NEXT_UTTERANCE = ( \u2026 \u201CMy friends are cool but they
...
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),Td.forEach(t),ap=l(Y),Es=a(Y,"P",{});var xm=s(Es);sp=d(xm,"Finally, this model supports inherent JAX features such as:"),xm.forEach(t),rp=l(Y),Re=a(Y,"UL",{});var co=s(Re);Ms=a(co,"LI",{});var Fm=s(Ms);mn=a(Fm,"A",{href:!0,rel:!0});var $m=s(mn);dp=d($m,"Just-In-Time (JIT) compilation"),$m.forEach(t),Fm.forEach(t),ip=l(co),Cs=a(co,"LI",{});var qm=s(Cs);fn=a(qm,"A",{href:!0,rel:!0});var Em=s(fn);lp=d(Em,"Automatic Differentiation"),Em.forEach(t),qm.forEach(t),cp=l(co),js=a(co,"LI",{});var Mm=s(js);_n=a(Mm,"A",{href:!0,rel:!0});var Cm=s(_n);pp=d(Cm,"Vectorization"),Cm.forEach(t),Mm.forEach(t),hp=l(co),Os=a(co,"LI",{});var jm=s(Os);gn=a(jm,"A",{href:!0,rel:!0});var Om=s(gn);up=d(Om,"Parallelization"),Om.forEach(t),jm.forEach(t),co.forEach(t),mp=l(Y),ke=a(Y,"DIV",{class:!0});var pt=s(ke);_(bn.$$.fragment,pt),fp=l(pt),jt=a(pt,"P",{});var wa=s(jt);_p=d(wa,"The "),Ps=a(wa,"CODE",{});var Pm=s(Ps);gp=d(Pm,"FlaxBlenderbotPreTrainedModel"),Pm.forEach(t),bp=d(wa,"forward method, overrides the "),Ns=a(wa,"CODE",{});var Nm=s(Ns);kp=d(Nm,"__call__"),Nm.forEach(t),vp=d(wa," special method."),wa.forEach(t),yp=l(pt),_(eo.$$.fragment,pt),Tp=l(pt),As=a(pt,"P",{});var Am=s(As);wp=d(Am,"Example:"),Am.forEach(t),Bp=l(pt),_(kn.$$.fragment,pt),pt.forEach(t),zp=l(Y),Ze=a(Y,"DIV",{class:!0});var Ba=s(Ze);_(vn.$$.fragment,Ba),xp=l(Ba),Is=a(Ba,"P",{});var Im=s(Is);Fp=d(Im,"Example:"),Im.forEach(t),$p=l(Ba),_(yn.$$.fragment,Ba),Ba.forEach(t),qp=l(Y),et=a(Y,"DIV",{class:!0});var za=s(et);_(Tn.$$.fragment,za),Ep=l(za),Ls=a(za,"P",{});var Lm=s(Ls);Mp=d(Lm,"Example:"),Lm.forEach(t),Cp=l(za),_(wn.$$.fragment,za),za.forEach(t),Y.forEach(t),Rr=l(o),Ot=a(o,"H2",{class:!0});var wd=s(Ot);to=a(wd,"A",{id:!0,class:!0,href:!0});var Sm=s(to);Ss=a(Sm,"SPAN",{});var Dm=s(Ss);_(Bn.$$.fragment,Dm),Dm.forEach(t),Sm.forEach(t),jp=l(wd),Ds=a(wd,"SPAN",{});var Gm=s(Ds);Op=d(Gm,"FlaxBlenderbotForConditionalGeneration"),Gm.forEach(t),wd.forEach(t),Hr=l(o),L=a(o,"DIV",{class:!0});var Z=s(L);_(zn.$$.fragment,Z),Pp=l(Z),xn=a(Z,"P",{});var Bd=s(xn);Np=d(Bd,`The Blenderbot Model with a language modeling head. Can be used for summarization.
...
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),zd.forEach(t),Wp=l(Z),Gs=a(Z,"P",{});var Rm=s(Gs);Up=d(Rm,"Finally, this model supports inherent JAX features such as:"),Rm.forEach(t),Rp=l(Z),He=a(Z,"UL",{});var po=s(He);Ws=a(po,"LI",{});var Hm=s(Ws);qn=a(Hm,"A",{href:!0,rel:!0});var Vm=s(qn);Hp=d(Vm,"Just-In-Time (JIT) compilation"),Vm.forEach(t),Hm.forEach(t),Vp=l(po),Us=a(po,"LI",{});var Km=s(Us);En=a(Km,"A",{href:!0,rel:!0});var Jm=s(En);Kp=d(Jm,"Automatic Differentiation"),Jm.forEach(t),Km.forEach(t),Jp=l(po),Rs=a(po,"LI",{});var Qm=s(Rs);Mn=a(Qm,"A",{href:!0,rel:!0});var Xm=s(Mn);Qp=d(Xm,"Vectorization"),Xm.forEach(t),Qm.forEach(t),Xp=l(po),Hs=a(po,"LI",{});var Ym=s(Hs);Cn=a(Ym,"A",{href:!0,rel:!0});var Zm=s(Cn);Yp=d(Zm,"Parallelization"),Zm.forEach(t),Ym.forEach(t),po.forEach(t),Zp=l(Z),S=a(Z,"DIV",{class:!0});var ee=s(S);_(jn.$$.fragment,ee),eh=l(ee),Pt=a(ee,"P",{});var xa=s(Pt);th=d(xa,"The "),Vs=a(xa,"CODE",{});var ef=s(Vs);oh=d(ef,"FlaxBlenderbotPreTrainedModel"),ef.forEach(t),nh=d(xa,"forward method, overrides the "),Ks=a(xa,"CODE",{});var tf=s(Ks);ah=d(tf,"__call__"),tf.forEach(t),sh=d(xa," special method."),xa.forEach(t),rh=l(ee),_(oo.$$.fragment,ee),dh=l(ee),Js=a(ee,"P",{});var of=s(Js);ih=d(of,"Conversation example::"),of.forEach(t),lh=l(ee),Qs=a(ee,"BLOCKQUOTE",{});var nf=s(Qs);Xs=a(nf,"BLOCKQUOTE",{});var af=s(Xs);Ys=a(af,"BLOCKQUOTE",{});var sf=s(Ys);Zs=a(sf,"P",{});var rf=s(Zs);ch=d(rf,"from transformers import BlenderbotTokenizer, FlaxBlenderbotForConditionalGeneration, BlenderbotConfig"),rf.forEach(t),sf.forEach(t),af.forEach(t),nf.forEach(t),ph=l(ee),er=a(ee,"BLOCKQUOTE",{});var df=s(er);tr=a(df,"BLOCKQUOTE",{});var lf=s(tr);or=a(lf,"BLOCKQUOTE",{});var cf=s(or);nr=a(cf,"P",{});var pf=s(nr);hh=d(pf,`model = FlaxBlenderbotForConditionalGeneration.from_pretrained(\u2018facebook/blenderbot-400M-distill\u2019) >>>
