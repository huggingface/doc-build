import{S as pp,i as mp,s as up,e as a,k as c,w as T,t as n,M as fp,c as r,d as t,m as l,a as i,x as v,h as s,b as d,F as e,g as p,y as x,q as b,o as k,B as y,v as _p}from"../../chunks/vendor-6b77c823.js";import{T as Yt}from"../../chunks/Tip-39098574.js";import{D}from"../../chunks/Docstring-1088f2fb.js";import{C as ln}from"../../chunks/CodeBlock-3a8b25a8.js";import{I as We}from"../../chunks/IconCopyLink-7a11ce68.js";function gp(U){let h,q,f,g,S,_,w,$;return{c(){h=a("p"),q=n(`This class method is simply calling the feature extractor
...
methods above for more information.`),this.h()},l(A){h=r(A,"P",{});var F=i(h);q=s(F,`This class method is simply calling the feature extractor
`),f=r(F,"A",{href:!0});var E=i(f);g=s(E,"from_pretrained()"),E.forEach(t),S=s(F,` and the tokenizer
`),_=r(F,"CODE",{});var N=i(_);w=s(N,"from_pretrained"),N.forEach(t),$=s(F,` methods. Please refer to the docstrings of the
methods above for more information.`),F.forEach(t),this.h()},h(){d(f,"href","/docs/transformers/main/en/main_classes/feature_extractor#transformers.FeatureExtractionMixin.from_pretrained")},m(A,F){p(A,h,F),e(h,q),e(h,f),e(f,g),e(h,S),e(h,_),e(_,w),e(h,$)},d(A){A&&t(h)}}}function Tp(U){let h,q,f,g,S,_,w,$;return{c(){h=a("p"),q=n("This class method is simply calling "),f=a("a"),g=n("save_pretrained()"),S=n(` and
`),_=a("code"),w=n("save_pretrained"),$=n(`. Please refer to the docstrings of the methods
above for more information.`),this.h()},l(A){h=r(A,"P",{});var F=i(h);q=s(F,"This class method is simply calling "),f=r(F,"A",{href:!0});var E=i(f);g=s(E,"save_pretrained()"),E.forEach(t),S=s(F,` and
`),_=r(F,"CODE",{});var N=i(_);w=s(N,"save_pretrained"),N.forEach(t),$=s(F,`. Please refer to the docstrings of the methods
above for more information.`),F.forEach(t),this.h()},h(){d(f,"href","/docs/transformers/main/en/main_classes/feature_extractor#transformers.FeatureExtractionMixin.save_pretrained")},m(A,F){p(A,h,F),e(h,q),e(h,f),e(f,g),e(h,S),e(h,_),e(_,w),e(h,$)},d(A){A&&t(h)}}}function vp(U){let h,q,f,g,S;return{c(){h=a("p"),q=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=a("code"),g=n("Module"),S=n(`
...
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),w.forEach(t)},m(_,w){p(_,h,w),e(h,q),e(h,f),e(f,g),e(h,S)},d(_){_&&t(h)}}}function xp(U){let h,q,f,g,S;return{c(){h=a("p"),q=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=a("code"),g=n("Module"),S=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(_){h=r(_,"P",{});var w=i(h);q=s(w,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=r(w,"CODE",{});var $=i(f);g=s($,"Module"),$.forEach(t),S=s(w,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),w.forEach(t)},m(_,w){p(_,h,w),e(h,q),e(h,f),e(f,g),e(h,S)},d(_){_&&t(h)}}}function bp(U){let h,q,f,g,S,_,w,$,A,F,E,N,H,ee,ze,B,Ce,$e,M,J,te,ye,P,j,Pe,oe,ne,je,se,ae,Me,O,Ee,L,Ae,re,ie,Ie,de,K,De,Z,Y;return{c(){h=a("p"),q=n("TF 2.0 models accepts two formats as inputs:"),f=c(),g=a("ul"),S=a("li"),_=n("having all inputs as keyword arguments (like PyTorch models), or"),w=c(),$=a("li"),A=n("having all inputs as a list, tuple or dict in the first positional arguments."),F=c(),E=a("p"),N=n("This second option is useful when using "),H=a("code"),ee=n("tf.keras.Model.fit"),ze=n(` method which currently requires having all the
...
`),Z=r(Le,"CODE",{});var dt=i(Z);Y=s(dt,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),dt.forEach(t),Le.forEach(t),G.forEach(t)},m(u,z){p(u,h,z),e(h,q),p(u,f,z),p(u,g,z),e(g,S),e(S,_),e(g,w),e(g,$),e($,A),p(u,F,z),p(u,E,z),e(E,N),e(E,H),e(H,ee),e(E,ze),e(E,B),e(B,Ce),e(E,$e),p(u,M,z),p(u,J,z),e(J,te),p(u,ye,z),p(u,P,z),e(P,j),e(j,Pe),e(j,oe),e(oe,ne),e(j,je),e(j,se),e(se,ae),e(P,Me),e(P,O),e(O,Ee),e(O,L),e(L,Ae),e(O,re),e(O,ie),e(ie,Ie),e(P,de),e(P,K),e(K,De),e(K,Z),e(Z,Y)},d(u){u&&t(h),u&&t(f),u&&t(g),u&&t(F),u&&t(E),u&&t(M),u&&t(J),u&&t(ye),u&&t(P)}}}function kp(U){let h,q,f,g,S;return{c(){h=a("p"),q=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=a("code"),g=n("Module"),S=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(_){h=r(_,"P",{});var w=i(h);q=s(w,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=r(w,"CODE",{});var $=i(f);g=s($,"Module"),$.forEach(t),S=s(w,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
first positional argument :`),at.forEach(t),ye=l(u),P=r(u,"UL",{});var G=i(P);j=r(G,"LI",{});var ce=i(j);Pe=s(ce,"a single Tensor with "),oe=r(ce,"CODE",{});var rt=i(oe);ne=s(rt,"input_ids"),rt.forEach(t),je=s(ce," only and nothing else: "),se=r(ce,"CODE",{});var Ue=i(se);ae=s(Ue,"model(input_ids)"),Ue.forEach(t),ce.forEach(t),Me=l(G),O=r(G,"LI",{});var C=i(O);Ee=s(C,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),L=r(C,"CODE",{});var it=i(L);Ae=s(it,"model([input_ids, attention_mask])"),it.forEach(t),re=s(C," or "),ie=r(C,"CODE",{});var qe=i(ie);Ie=s(qe,"model([input_ids, attention_mask, token_type_ids])"),qe.forEach(t),C.forEach(t),de=l(G),K=r(G,"LI",{});var Le=i(K);De=s(Le,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),Z=r(Le,"CODE",{});var dt=i(Z);Y=s(dt,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),dt.forEach(t),Le.forEach(t),G.forEach(t)},m(u,z){p(u,h,z),e(h,q),p(u,f,z),p(u,g,z),e(g,S),e(S,_),e(g,w),e(g,$),e($,A),p(u,F,z),p(u,E,z),e(E,N),e(E,H),e(H,ee),e(E,ze),e(E,B),e(B,Ce),e(E,$e),p(u,M,z),p(u,J,z),e(J,te),p(u,ye,z),p(u,P,z),e(P,j),e(j,Pe),e(j,oe),e(oe,ne),e(j,je),e(j,se),e(se,ae),e(P,Me),e(P,O),e(O,Ee),e(O,L),e(L,Ae),e(O,re),e(O,ie),e(ie,Ie),e(P,de),e(P,K),e(K,De),e(K,Z),e(Z,Y)},d(u){u&&t(h),u&&t(f),u&&t(g),u&&t(F),u&&t(E),u&&t(M),u&&t(J),u&&t(ye),u&&t(P)}}}function wp(U){let h,q,f,g,S;return{c(){h=a("p"),q=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=a("code"),g=n("Module"),S=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(_){h=r(_,"P",{});var w=i(h);q=s(w,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=r(w,"CODE",{});var $=i(f);g=s($,"Module"),$.forEach(t),S=s(w,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),w.forEach(t)},m(_,w){p(_,h,w),e(h,q),e(h,f),e(f,g),e(h,S)},d(_){_&&t(h)}}}function Sp(U){let h,q,f,g,S,_,w,$,A,F,E,N,H,ee,ze,B,Ce,$e,M,J,te,ye,P,j,Pe,oe,ne,je,se,ae,Me,O,Ee,L,Ae,re,ie,Ie,de,K,De,Z,Y,u,z,X,st,Ne,Q,Ve,_e,at,G,ce,rt,Ue,C,it,qe,Le,dt,hn,tr,or,pn,nr,sr,mn,ar,rr,Zs,W,ir,Yn,dr,cr,Xn,lr,hr,Qn,pr,mr,Zn,ur,fr,es,_r,gr,Xt,Tr,vr,ts,xr,ea,un,os,br,ta,Qt,oa,fn,Zt,ns,kr,yr,le,wr,ss,Sr,$r,as,Er,qr,rs,Fr,zr,is,Cr,Pr,ds,jr,Mr,na,eo,sa,yt,Ar,to,Ir,Dr,aa,ct,wt,cs,oo,Nr,ls,Lr,ra,he,no,Or,lt,Gr,_n,Wr,Vr,so,Ur,Rr,Hr,ht,Br,gn,Jr,Kr,Tn,Yr,Xr,Qr,hs,Zr,ei,ao,ia,pt,St,ps,ro,ti,ms,oi,da,V,io,ni,us,si,ai,co,ri,vn,ii,di,ci,$t,lo,li,fs,hi,pi,Et,ho,mi,po,ui,_s,fi,_i,gi,Re,mo,Ti,xn,vi,bn,xi,bi,gs,ki,yi,kn,uo,ca,mt,qt,Ts,fo,wi,vs,Si,la,pe,_o,$i,xs,Ei,qi,go,Fi,yn,zi,Ci,Pi,bs,ji,Mi,Ft,To,Ai,ks,Ii,ha,ut,zt,ys,vo,Di,ws,Ni,pa,I,xo,Li,Ss,Oi,Gi,ge,wn,Wi,Vi,Sn,Ui,Ri,$n,Hi,Bi,bo,$s,Ji,Ki,Yi,En,Xi,Qi,Zi,Ct,ko,ed,Oe,td,yo,Es,od,nd,sd,qn,ad,rd,wo,qs,id,dd,cd,ld,He,So,hd,Fs,pd,md,Pt,ud,Be,$o,fd,Eo,_d,Fn,gd,Td,vd,jt,xd,Mt,qo,bd,Fo,kd,zn,yd,wd,Sd,At,zo,$d,Co,Ed,Cn,qd,Fd,zd,It,Po,Cd,zs,Pd,ma,ft,Dt,Cs,jo,jd,Ps,Md,ua,we,Mo,Ad,Ao,Id,Pn,Dd,Nd,Ld,Io,Od,Do,Gd,Wd,Vd,Te,No,Ud,_t,Rd,jn,Hd,Bd,js,Jd,Kd,Yd,Nt,Xd,Ms,Qd,Zd,Lo,fa,gt,Lt,As,Oo,ec,Is,tc,_a,Se,Go,oc,Wo,nc,Mn,sc,ac,rc,Vo,ic,Uo,dc,cc,lc,ve,Ro,hc,Tt,pc,An,mc,uc,Ds,fc,_c,gc,Ot,Tc,Ns,vc,xc,Ho,ga,vt,Gt,Ls,Bo,bc,Os,kc,Ta,me,Jo,yc,Ko,wc,In,Sc,$c,Ec,Yo,qc,Xo,Fc,zc,Cc,Wt,Pc,xe,Qo,jc,xt,Mc,Dn,Ac,Ic,Gs,Dc,Nc,Lc,Vt,Oc,Ws,Gc,Wc,Zo,va,bt,Ut,Vs,en,Vc,Us,Uc,xa,ue,tn,Rc,on,Hc,Nn,Bc,Jc,Kc,nn,Yc,sn,Xc,Qc,Zc,Rt,el,be,an,tl,kt,ol,Ln,nl,sl,Rs,al,rl,il,Ht,dl,Hs,cl,ll,rn,ba;return _=new We({}),ee=new We({}),X=new We({}),Qt=new ln({props:{code:`import torch
...
<span class="hljs-meta">&gt;&gt;&gt; </span>transcription = processor.batch_decode(generated_ids)`}}),{c(){h=a("meta"),q=c(),f=a("h1"),g=a("a"),S=a("span"),T(_.$$.fragment),w=c(),$=a("span"),A=n("Speech2Text"),F=c(),E=a("h2"),N=a("a"),H=a("span"),T(ee.$$.fragment),ze=c(),B=a("span"),Ce=n("Overview"),$e=c(),M=a("p"),J=n("The Speech2Text model was proposed in "),te=a("a"),ye=n("fairseq S2T: Fast Speech-to-Text Modeling with fairseq"),P=n(` by Changhan Wang, Yun Tang, Xutai Ma, Anne Wu, Dmytro Okhonko, Juan Pino. It\u2019s a
transformer-based seq2seq (encoder-decoder) model designed for end-to-end Automatic Speech Recognition (ASR) and Speech
Translation (ST). It uses a convolutional downsampler to reduce the length of speech inputs by 3/4th before they are
fed into the encoder. The model is trained with standard autoregressive cross-entropy loss and generates the
transcripts/translations autoregressively. Speech2Text has been fine-tuned on several datasets for ASR and ST:
`),j=a("a"),Pe=n("LibriSpeech"),oe=n(", "),ne=a("a"),je=n("CoVoST 2"),se=n(", "),ae=a("a"),Me=n("MuST-C"),O=n("."),Ee=c(),L=a("p"),Ae=n("This model was contributed by "),re=a("a"),ie=n("valhalla"),Ie=n(". The original code can be found "),de=a("a"),K=n("here"),De=n("."),Z=c(),Y=a("h2"),u=a("a"),z=a("span"),T(X.$$.fragment),st=c(),Ne=a("span"),Q=n("Inference"),Ve=c(),_e=a("p"),at=n(`Speech2Text is a speech model that accepts a float tensor of log-mel filter-bank features extracted from the speech
...
special tokens using the tokenizer `),_s=a("code"),fi=n("prepare_for_model"),_i=n(" method."),gi=c(),Re=a("div"),T(mo.$$.fragment),Ti=c(),xn=a("p"),vi=n("Create the token type IDs corresponding to the sequences passed. "),bn=a("a"),xi=n(`What are token type
IDs?`),bi=c(),gs=a("p"),ki=n("Should be overridden in a subclass if the model has a special way of building those."),yi=c(),kn=a("div"),T(uo.$$.fragment),ca=c(),mt=a("h2"),qt=a("a"),Ts=a("span"),T(fo.$$.fragment),wi=c(),vs=a("span"),Si=n("Speech2TextFeatureExtractor"),la=c(),pe=a("div"),T(_o.$$.fragment),$i=c(),xs=a("p"),Ei=n("Constructs a Speech2Text feature extractor."),qi=c(),go=a("p"),Fi=n("This feature extractor inherits from "),yn=a("a"),zi=n("Speech2TextFeatureExtractor"),Ci=n(` which contains most of the main methods. Users
...
mean and variance normalization to the extracted features.`),Mi=c(),Ft=a("div"),T(To.$$.fragment),Ai=c(),ks=a("p"),Ii=n("Main method to featurize and prepare for the model one or several sequence(s). sequences."),ha=c(),ut=a("h2"),zt=a("a"),ys=a("span"),T(vo.$$.fragment),Di=c(),ws=a("span"),Ni=n("Speech2TextProcessor"),pa=c(),I=a("div"),T(xo.$$.fragment),Li=c(),Ss=a("p"),Oi=n(`Constructs a Speech2Text processor which wraps a Speech2Text feature extractor and a Speech2Text tokenizer into a
...
`),$n=a("a"),Hi=n("Speech2TextTokenizer"),Bi=n(". See the "),bo=a("a"),$s=a("strong"),Ji=n("call"),Ki=n("()"),Yi=n(" and "),En=a("a"),Xi=n("decode()"),Qi=n(` for more
...
information.`),ld=c(),He=a("div"),T(So.$$.fragment),hd=c(),Fs=a("p"),pd=n("Instantiate a processor associated with a pretrained model."),md=c(),T(Pt.$$.fragment),ud=c(),Be=a("div"),T($o.$$.fragment),fd=c(),Eo=a("p"),_d=n(`Saves the attributes of this processor (feature extractor, tokenizer\u2026) in the specified directory so that it
can be reloaded using the `),Fn=a("a"),gd=n("from_pretrained()"),Td=n(" method."),vd=c(),T(jt.$$.fragment),xd=c(),Mt=a("div"),T(qo.$$.fragment),bd=c(),Fo=a("p"),kd=n("This method forwards all its arguments to Speech2TextTokenizer\u2019s "),zn=a("a"),yd=n("batch_decode()"),wd=n(`. Please
refer to the docstring of this method for more information.`),Sd=c(),At=a("div"),T(zo.$$.fragment),$d=c(),Co=a("p"),Ed=n("This method forwards all its arguments to Speech2TextTokenizer\u2019s "),Cn=a("a"),qd=n("decode()"),Fd=n(`. Please refer
to the docstring of this method for more information.`),zd=c(),It=a("div"),T(Po.$$.fragment),Cd=c(),zs=a("p"),Pd=n(`Temporarily sets the tokenizer for processing the input. Useful for encoding the labels when fine-tuning
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),lc=c(),ve=a("div"),T(Ro.$$.fragment),hc=c(),Tt=a("p"),pc=n("The "),An=a("a"),mc=n("Speech2TextForConditionalGeneration"),uc=n(" forward method, overrides the "),Ds=a("code"),fc=n("__call__"),_c=n(" special method."),gc=c(),T(Ot.$$.fragment),Tc=c(),Ns=a("p"),vc=n("Example:"),xc=c(),T(Ho.$$.fragment),ga=c(),vt=a("h2"),Gt=a("a"),Ls=a("span"),T(Bo.$$.fragment),bc=c(),Os=a("span"),kc=n("TFSpeech2TextModel"),Ta=c(),me=a("div"),T(Jo.$$.fragment),yc=c(),Ko=a("p"),wc=n(`The bare Speech2Text Model outputting raw hidden-states without any specific head on top.
...
behavior.`),Cc=c(),T(Wt.$$.fragment),Pc=c(),xe=a("div"),T(Qo.$$.fragment),jc=c(),xt=a("p"),Mc=n("The "),Dn=a("a"),Ac=n("TFSpeech2TextModel"),Ic=n(" forward method, overrides the "),Gs=a("code"),Dc=n("__call__"),Nc=n(" special method."),Lc=c(),T(Vt.$$.fragment),Oc=c(),Ws=a("p"),Gc=n("Example:"),Wc=c(),T(Zo.$$.fragment),va=c(),bt=a("h2"),Ut=a("a"),Vs=a("span"),T(en.$$.fragment),Vc=c(),Us=a("span"),Uc=n("TFSpeech2TextForConditionalGeneration"),xa=c(),ue=a("div"),T(tn.$$.fragment),Rc=c(),on=a("p"),Hc=n(`The Speech2Text Model with a language modeling head. Can be used for summarization.
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Zc=c(),T(Rt.$$.fragment),el=c(),be=a("div"),T(an.$$.fragment),tl=c(),kt=a("p"),ol=n("The "),Ln=a("a"),nl=n("TFSpeech2TextForConditionalGeneration"),sl=n(" forward method, overrides the "),Rs=a("code"),al=n("__call__"),rl=n(" special method."),il=c(),T(Ht.$$.fragment),dl=c(),Hs=a("p"),cl=n("Example:"),ll=c(),T(rn.$$.fragment),this.h()},l(o){const m=fp('[data-svelte="svelte-1phssyn"]',document.head);h=r(m,"META",{name:!0,content:!0}),m.forEach(t),q=l(o),f=r(o,"H1",{class:!0});var dn=i(f);g=r(dn,"A",{id:!0,class:!0,href:!0});var Bs=i(g);S=r(Bs,"SPAN",{});var Js=i(S);v(_.$$.fragment,Js),Js.forEach(t),Bs.forEach(t),w=l(dn),$=r(dn,"SPAN",{});var Ks=i($);A=s(Ks,"Speech2Text"),Ks.forEach(t),dn.forEach(t),F=l(o),E=r(o,"H2",{class:!0});var cn=i(E);N=r(cn,"A",{id:!0,class:!0,href:!0});var Ys=i(N);H=r(Ys,"SPAN",{});var Xs=i(H);v(ee.$$.fragment,Xs),Xs.forEach(t),Ys.forEach(t),ze=l(cn),B=r(cn,"SPAN",{});var Qs=i(B);Ce=s(Qs,"Overview"),Qs.forEach(t),cn.forEach(t),$e=l(o),M=r(o,"P",{});var Je=i(M);J=s(Je,"The Speech2Text model was proposed in "),te=r(Je,"A",{href:!0,rel:!0});var fl=i(te);ye=s(fl,"fairseq S2T: Fast Speech-to-Text Modeling with fairseq"),fl.forEach(t),P=s(Je,` by Changhan Wang, Yun Tang, Xutai Ma, Anne Wu, Dmytro Okhonko, Juan Pino. It\u2019s a
transformer-based seq2seq (encoder-decoder) model designed for end-to-end Automatic Speech Recognition (ASR) and Speech
Translation (ST). It uses a convolutional downsampler to reduce the length of speech inputs by 3/4th before they are
fed into the encoder. The model is trained with standard autoregressive cross-entropy loss and generates the
transcripts/translations autoregressively. Speech2Text has been fine-tuned on several datasets for ASR and ST:
`),j=r(Je,"A",{href:!0,rel:!0});var _l=i(j);Pe=s(_l,"LibriSpeech"),_l.forEach(t),oe=s(Je,", "),ne=r(Je,"A",{href:!0,rel:!0});var gl=i(ne);je=s(gl,"CoVoST 2"),gl.forEach(t),se=s(Je,", "),ae=r(Je,"A",{href:!0,rel:!0});var Tl=i(ae);Me=s(Tl,"MuST-C"),Tl.forEach(t),O=s(Je,"."),Je.forEach(t),Ee=l(o),L=r(o,"P",{});var On=i(L);Ae=s(On,"This model was contributed by "),re=r(On,"A",{href:!0,rel:!0});var vl=i(re);ie=s(vl,"valhalla"),vl.forEach(t),Ie=s(On,". The original code can be found "),de=r(On,"A",{href:!0,rel:!0});var xl=i(de);K=s(xl,"here"),xl.forEach(t),De=s(On,"."),On.forEach(t),Z=l(o),Y=r(o,"H2",{class:!0});var ka=i(Y);u=r(ka,"A",{id:!0,class:!0,href:!0});var bl=i(u);z=r(bl,"SPAN",{});var kl=i(z);v(X.$$.fragment,kl),kl.forEach(t),bl.forEach(t),st=l(ka),Ne=r(ka,"SPAN",{});var yl=i(Ne);Q=s(yl,"Inference"),yl.forEach(t),ka.forEach(t),Ve=l(o),_e=r(o,"P",{});var ya=i(_e);at=s(ya,`Speech2Text is a speech model that accepts a float tensor of log-mel filter-bank features extracted from the speech
signal. It\u2019s a transformer-based seq2seq model, so the transcripts/translations are generated autoregressively. The
...
predicted token ids.`),Ke.forEach(t),Zs=l(o),W=r(o,"P",{});var fe=i(W);ir=s(fe,"The feature extractor depends on "),Yn=r(fe,"CODE",{});var Fl=i(Yn);dr=s(Fl,"torchaudio"),Fl.forEach(t),cr=s(fe," and the tokenizer depends on "),Xn=r(fe,"CODE",{});var zl=i(Xn);lr=s(zl,"sentencepiece"),zl.forEach(t),hr=s(fe,` so be sure to
install those packages before running the examples. You could either install those as extra speech dependencies with
...
the superclass for more information regarding such methods.`),qa.forEach(t),ci=l(ke),$t=r(ke,"DIV",{class:!0});var Fa=i($t);v(lo.$$.fragment,Fa),li=l(Fa),fs=r(Fa,"P",{});var ah=i(fs);hi=s(ah,"Build model inputs from a sequence by appending eos_token_id."),ah.forEach(t),Fa.forEach(t),pi=l(ke),Et=r(ke,"DIV",{class:!0});var za=i(Et);v(ho.$$.fragment,za),mi=l(za),po=r(za,"P",{});var Ca=i(po);ui=s(Ca,`Retrieve sequence ids from a token list that has no special tokens added. This method is called when adding
special tokens using the tokenizer `),_s=r(Ca,"CODE",{});var rh=i(_s);fi=s(rh,"prepare_for_model"),rh.forEach(t),_i=s(Ca," method."),Ca.forEach(t),za.forEach(t),gi=l(ke),Re=r(ke,"DIV",{class:!0});var Vn=i(Re);v(mo.$$.fragment,Vn),Ti=l(Vn),xn=r(Vn,"P",{});var hl=i(xn);vi=s(hl,"Create the token type IDs corresponding to the sequences passed. "),bn=r(hl,"A",{href:!0});var ih=i(bn);xi=s(ih,`What are token type
IDs?`),ih.forEach(t),hl.forEach(t),bi=l(Vn),gs=r(Vn,"P",{});var dh=i(gs);ki=s(dh,"Should be overridden in a subclass if the model has a special way of building those."),dh.forEach(t),Vn.forEach(t),yi=l(ke),kn=r(ke,"DIV",{class:!0});var ch=i(kn);v(uo.$$.fragment,ch),ch.forEach(t),ke.forEach(t),ca=l(o),mt=r(o,"H2",{class:!0});var Pa=i(mt);qt=r(Pa,"A",{id:!0,class:!0,href:!0});var lh=i(qt);Ts=r(lh,"SPAN",{});var hh=i(Ts);v(fo.$$.fragment,hh),hh.forEach(t),lh.forEach(t),wi=l(Pa),vs=r(Pa,"SPAN",{});var ph=i(vs);Si=s(ph,"Speech2TextFeatureExtractor"),ph.forEach(t),Pa.forEach(t),la=l(o),pe=r(o,"DIV",{class:!0});var Xe=i(pe);v(_o.$$.fragment,Xe),$i=l(Xe),xs=r(Xe,"P",{});var mh=i(xs);Ei=s(mh,"Constructs a Speech2Text feature extractor."),mh.forEach(t),qi=l(Xe),go=r(Xe,"P",{});var ja=i(go);Fi=s(ja,"This feature extractor inherits from "),yn=r(ja,"A",{href:!0});var uh=i(yn);zi=s(uh,"Speech2TextFeatureExtractor"),uh.forEach(t),Ci=s(ja,` which contains most of the main methods. Users
should refer to this superclass for more information regarding those methods.`),ja.forEach(t),Pi=l(Xe),bs=r(Xe,"P",{});var fh=i(bs);ji=s(fh,`This class extracts mel-filter bank features from raw speech using TorchAudio and applies utterance-level cepstral
mean and variance normalization to the extracted features.`),fh.forEach(t),Mi=l(Xe),Ft=r(Xe,"DIV",{class:!0});var Ma=i(Ft);v(To.$$.fragment,Ma),Ai=l(Ma),ks=r(Ma,"P",{});var _h=i(ks);Ii=s(_h,"Main method to featurize and prepare for the model one or several sequence(s). sequences."),_h.forEach(t),Ma.forEach(t),Xe.forEach(t),ha=l(o),ut=r(o,"H2",{class:!0});var Aa=i(ut);zt=r(Aa,"A",{id:!0,class:!0,href:!0});var gh=i(zt);ys=r(gh,"SPAN",{});var Th=i(ys);v(vo.$$.fragment,Th),Th.forEach(t),gh.forEach(t),Di=l(Aa),ws=r(Aa,"SPAN",{});var vh=i(ws);Ni=s(vh,"Speech2TextProcessor"),vh.forEach(t),Aa.forEach(t),pa=l(o),I=r(o,"DIV",{class:!0});var R=i(I);v(xo.$$.fragment,R),Li=l(R),Ss=r(R,"P",{});var xh=i(Ss);Oi=s(xh,`Constructs a Speech2Text processor which wraps a Speech2Text feature extractor and a Speech2Text tokenizer into a
single processor.`),xh.forEach(t),Gi=l(R),ge=r(R,"P",{});var Ge=i(ge);wn=r(Ge,"A",{href:!0});var bh=i(wn);Wi=s(bh,"Speech2TextProcessor"),bh.forEach(t),Vi=s(Ge," offers all the functionalities of "),Sn=r(Ge,"A",{href:!0});var kh=i(Sn);Ui=s(kh,"Speech2TextFeatureExtractor"),kh.forEach(t),Ri=s(Ge,` and
`),$n=r(Ge,"A",{href:!0});var yh=i($n);Hi=s(yh,"Speech2TextTokenizer"),yh.forEach(t),Bi=s(Ge,". See the "),bo=r(Ge,"A",{href:!0});var pl=i(bo);$s=r(pl,"STRONG",{});var wh=i($s);Ji=s(wh,"call"),wh.forEach(t),Ki=s(pl,"()"),pl.forEach(t),Yi=s(Ge," and "),En=r(Ge,"A",{href:!0});var Sh=i(En);Xi=s(Sh,"decode()"),Sh.forEach(t),Qi=s(Ge,` for more
...
information.`),Bt.forEach(t),Ia.forEach(t),ld=l(R),He=r(R,"DIV",{class:!0});var Un=i(He);v(So.$$.fragment,Un),hd=l(Un),Fs=r(Un,"P",{});var Fh=i(Fs);pd=s(Fh,"Instantiate a processor associated with a pretrained model."),Fh.forEach(t),md=l(Un),v(Pt.$$.fragment,Un),Un.forEach(t),ud=l(R),Be=r(R,"DIV",{class:!0});var Rn=i(Be);v($o.$$.fragment,Rn),fd=l(Rn),Eo=r(Rn,"P",{});var Da=i(Eo);_d=s(Da,`Saves the attributes of this processor (feature extractor, tokenizer\u2026) in the specified directory so that it
can be reloaded using the `),Fn=r(Da,"A",{href:!0});var zh=i(Fn);gd=s(zh,"from_pretrained()"),zh.forEach(t),Td=s(Da," method."),Da.forEach(t),vd=l(Rn),v(jt.$$.fragment,Rn),Rn.forEach(t),xd=l(R),Mt=r(R,"DIV",{class:!0});var Na=i(Mt);v(qo.$$.fragment,Na),bd=l(Na),Fo=r(Na,"P",{});var La=i(Fo);kd=s(La,"This method forwards all its arguments to Speech2TextTokenizer\u2019s "),zn=r(La,"A",{href:!0});var Ch=i(zn);yd=s(Ch,"batch_decode()"),Ch.forEach(t),wd=s(La,`. Please
refer to the docstring of this method for more information.`),La.forEach(t),Na.forEach(t),Sd=l(R),At=r(R,"DIV",{class:!0});var Oa=i(At);v(zo.$$.fragment,Oa),$d=l(Oa),Co=r(Oa,"P",{});var Ga=i(Co);Ed=s(Ga,"This method forwards all its arguments to Speech2TextTokenizer\u2019s "),Cn=r(Ga,"A",{href:!0});var Ph=i(Cn);qd=s(Ph,"decode()"),Ph.forEach(t),Fd=s(Ga,`. Please refer
to the docstring of this method for more information.`),Ga.forEach(t),Oa.forEach(t),zd=l(R),It=r(R,"DIV",{class:!0});var Wa=i(It);v(Po.$$.fragment,Wa),Cd=l(Wa),zs=r(Wa,"P",{});var jh=i(zs);Pd=s(jh,`Temporarily sets the tokenizer for processing the input. Useful for encoding the labels when fine-tuning
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Ya.forEach(t),Ec=l(et),Yo=r(et,"P",{});var Xa=i(Yo);qc=s(Xa,"This model is also a "),Xo=r(Xa,"A",{href:!0,rel:!0});var ep=i(Xo);Fc=s(ep,"tf.keras.Model"),ep.forEach(t),zc=s(Xa,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Xa.forEach(t),Cc=l(et),v(Wt.$$.fragment,et),Pc=l(et),xe=r(et,"DIV",{class:!0});var tt=i(xe);v(Qo.$$.fragment,tt),jc=l(tt),xt=r(tt,"P",{});var Jn=i(xt);Mc=s(Jn,"The "),Dn=r(Jn,"A",{href:!0});var tp=i(Dn);Ac=s(tp,"TFSpeech2TextModel"),tp.forEach(t),Ic=s(Jn," forward method, overrides the "),Gs=r(Jn,"CODE",{});var op=i(Gs);Dc=s(op,"__call__"),op.forEach(t),Nc=s(Jn," special method."),Jn.forEach(t),Lc=l(tt),v(Vt.$$.fragment,tt),Oc=l(tt),Ws=r(tt,"P",{});var np=i(Ws);Gc=s(np,"Example:"),np.forEach(t),Wc=l(tt),v(Zo.$$.fragment,tt),tt.forEach(t),et.forEach(t),va=l(o),bt=r(o,"H2",{class:!0});var Qa=i(bt);Ut=r(Qa,"A",{id:!0,class:!0,href:!0});var sp=i(Ut);Vs=r(sp,"SPAN",{});var ap=i(Vs);v(en.$$.fragment,ap),ap.forEach(t),sp.forEach(t),Vc=l(Qa),Us=r(Qa,"SPAN",{});var rp=i(Us);Uc=s(rp,"TFSpeech2TextForConditionalGeneration"),rp.forEach(t),Qa.forEach(t),xa=l(o),ue=r(o,"DIV",{class:!0});var ot=i(ue);v(tn.$$.fragment,ot),Rc=l(ot),on=r(ot,"P",{});var Za=i(on);Hc=s(Za,`The Speech2Text Model with a language modeling head. Can be used for summarization.
