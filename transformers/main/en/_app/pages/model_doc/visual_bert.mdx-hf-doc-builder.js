...
outputs = model(**inputs, labels=labels)
loss = outputs.loss
scores = outputs.logits`}}),{c(){d=n("p"),b=i("Example:"),g=p(),k(m.$$.fragment)},l(r){d=s(r,"P",{});var u=a(d);b=l(u,"Example:"),u.forEach(o),g=h(r),T(m.$$.fragment,r)},m(r,u){_(r,d,u),e(d,b),_(r,g,u),y(m,r,u),v=!0},p:Gt,i(r){v||(w(m.$$.fragment,r),v=!0)},o(r){$(m.$$.fragment,r),v=!1},d(r){r&&o(d),r&&o(g),V(m,r)}}}function Pd(B){let d,b,g,m,v,r,u,q,qs,Bn,J,me,Mo,Ge,zs,Ao,xs,qn,fe,Fs,Je,Es,Ps,zn,Jt,Ms,xn,Yt,jo,As,Fn,Xt,js,En,ge,Co,Ye,Cs,Zt,Ls,Os,Rs,Lo,Oo,Ns,Pn,Y,_e,Ro,Xe,Is,No,Ds,Mn,eo,Ss,An,to,Ws,jn,ve,Qs,oo,Hs,Us,Cn,be,Io,no,Ze,Ks,Gs,Js,Do,so,et,Ys,Xs,Ln,ke,Zs,ao,ea,ta,On,tt,Rn,D,oa,ot,na,sa,nt,aa,ra,Nn,X,Te,So,st,ia,Wo,la,In,A,at,da,Z,ca,ro,ua,pa,rt,ha,ma,fa,ee,ga,io,_a,va,lo,ba,ka,Ta,ye,Dn,te,we,Qo,it,ya,Ho,wa,Sn,z,lt,$a,dt,Va,co,Ba,qa,za,ct,xa,ut,Fa,Ea,Pa,pt,Ma,ht,Aa,ja,Ca,C,mt,La,oe,Oa,uo,Ra,Na,Uo,Ia,Da,Sa,$e,Wa,Ve,Wn,ne,Be,Ko,ft,Qa,Go,Ha,Qn,x,gt,Ua,se,Ka,Jo,Ga,Ja,Yo,Ya,Xa,Za,_t,er,po,tr,or,nr,vt,sr,bt,ar,rr,ir,L,kt,lr,ae,dr,ho,cr,ur,Xo,pr,hr,mr,qe,fr,ze,Hn,re,xe,Zo,Tt,gr,en,_r,Un,F,yt,vr,tn,br,kr,wt,Tr,mo,yr,wr,$r,$t,Vr,Vt,Br,qr,zr,O,Bt,xr,ie,Fr,fo,Er,Pr,on,Mr,Ar,jr,Fe,Cr,Ee,Kn,le,Pe,nn,qt,Lr,sn,Or,Gn,E,zt,Rr,an,Nr,Ir,xt,Dr,go,Sr,Wr,Qr,Ft,Hr,Et,Ur,Kr,Gr,R,Pt,Jr,de,Yr,_o,Xr,Zr,rn,ei,ti,oi,Me,ni,Ae,Jn,ce,je,ln,Mt,si,dn,ai,Yn,P,At,ri,cn,ii,li,jt,di,vo,ci,ui,pi,Ct,hi,Lt,mi,fi,gi,N,Ot,_i,ue,vi,bo,bi,ki,un,Ti,yi,wi,Ce,$i,Le,Xn,pe,Oe,pn,Rt,Vi,hn,Bi,Zn,M,Nt,qi,mn,zi,xi,It,Fi,ko,Ei,Pi,Mi,Dt,Ai,St,ji,Ci,Li,I,Wt,Oi,he,Ri,To,Ni,Ii,fn,Di,Si,Wi,Re,Qi,Ne,es;return r=new G({}),Ge=new G({}),Xe=new G({}),tt=new Ke({props:{code:`import torch
from transformers import BertTokenizer, VisualBertModel
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/main/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/visual_bert/modeling_visual_bert.py#L1022"}}),Pt=new j({props:{name:"forward",anchor:"transformers.VisualBertForMultipleChoice.forward",parameters:[{name:"input_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"attention_mask",val:": typing.Optional[torch.LongTensor] = None"},{name:"token_type_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"position_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"head_mask",val:": typing.Optional[torch.LongTensor] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"visual_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"visual_attention_mask",val:": typing.Optional[torch.LongTensor] = None"},{name:"visual_token_type_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"image_text_alignment",val:": typing.Optional[torch.LongTensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"labels",val:": typing.Optional[torch.LongTensor] = None"}],parametersDescription:[{anchor:"transformers.VisualBertForMultipleChoice.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, num_choices, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/main/en/model_doc/bert#transformers.BertTokenizer">BertTokenizer</a>. See <a href="/docs/transformers/main/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/main/en/model_doc/wav2vec2#transformers.Wav2Vec2CTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
<p><a
  href="/docs/transformers/main/en/main_classes/output#transformers.modeling_outputs.SequenceClassifierOutput"
>transformers.modeling_outputs.SequenceClassifierOutput</a> or <code>tuple(torch.FloatTensor)</code></p>
`}}),Re=new Po({props:{$$slots:{default:[Fd]},$$scope:{ctx:B}}}),Ne=new Kt({props:{anchor:"transformers.VisualBertForRegionToPhraseAlignment.forward.example",$$slots:{default:[Ed]},$$scope:{ctx:B}}}),{c(){d=n("meta"),b=p(),g=n("h1"),m=n("a"),v=n("span"),k(r.$$.fragment),u=p(),q=n("span"),qs=i("VisualBERT"),Bn=p(),J=n("h2"),me=n("a"),Mo=n("span"),k(Ge.$$.fragment),zs=p(),Ao=n("span"),xs=i("Overview"),qn=p(),fe=n("p"),Fs=i("The VisualBERT model was proposed in "),Je=n("a"),Es=i("VisualBERT: A Simple and Performant Baseline for Vision and Language"),Ps=i(` by Liunian Harold Li, Mark Yatskar, Da Yin, Cho-Jui Hsieh, Kai-Wei Chang.
VisualBERT is a neural network trained on a variety of (image, text) pairs.`),zn=p(),Jt=n("p"),Ms=i("The abstract from the paper is the following:"),xn=p(),Yt=n("p"),jo=n("em"),As=i(`We propose VisualBERT, a simple and flexible framework for modeling a broad range of vision-and-language tasks.
...
verbs and image regions corresponding to their arguments.`),Fn=p(),Xt=n("p"),js=i("Tips:"),En=p(),ge=n("ol"),Co=n("li"),Ye=n("p"),Cs=i("Most of the checkpoints provided work with the "),Zt=n("a"),Ls=i("VisualBertForPreTraining"),Os=i(` configuration. Other
...
etc.)`),za=p(),ct=n("p"),xa=i("This model is also a PyTorch "),ut=n("a"),Fa=i("torch.nn.Module"),Ea=i(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Pa=p(),pt=n("p"),Ma=i("The model can behave as an encoder (with only self-attention) following the architecture described in "),ht=n("a"),Aa=i(`Attention is
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),zr=p(),O=n("div"),k(Bt.$$.fragment),xr=p(),ie=n("p"),Fr=i("The "),fo=n("a"),Er=i("VisualBertForQuestionAnswering"),Pr=i(" forward method, overrides the "),on=n("code"),Mr=i("__call__"),Ar=i(" special method."),jr=p(),k(Fe.$$.fragment),Cr=p(),k(Ee.$$.fragment),Kn=p(),le=n("h2"),Pe=n("a"),nn=n("span"),k(qt.$$.fragment),Lr=p(),sn=n("span"),Or=i("VisualBertForMultipleChoice"),Gn=p(),E=n("div"),k(zt.$$.fragment),Rr=p(),an=n("p"),Nr=i(`VisualBert Model with a multiple choice classification head on top (a linear layer on top of the pooled output and
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Qr=p(),Ft=n("p"),Hr=i("This model is also a PyTorch "),Et=n("a"),Ur=i("torch.nn.Module"),Kr=i(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Gr=p(),R=n("div"),k(Pt.$$.fragment),Jr=p(),de=n("p"),Yr=i("The "),_o=n("a"),Xr=i("VisualBertForMultipleChoice"),Zr=i(" forward method, overrides the "),rn=n("code"),ei=i("__call__"),ti=i(" special method."),oi=p(),k(Me.$$.fragment),ni=p(),k(Ae.$$.fragment),Jn=p(),ce=n("h2"),je=n("a"),ln=n("span"),k(Mt.$$.fragment),si=p(),dn=n("span"),ai=i("VisualBertForVisualReasoning"),Yn=p(),P=n("div"),k(At.$$.fragment),ri=p(),cn=n("p"),ii=i(`VisualBert Model with a sequence classification head on top (a dropout and a linear layer on top of the pooled
...
simpler. Further analysis demonstrates that VisualBERT can ground elements of language to image regions without any
explicit supervision and is even sensitive to syntactic relationships, tracking, for example, associations between
verbs and image regions corresponding to their arguments.`),Vn.forEach(o),$n.forEach(o),Fn=h(t),Xt=s(t,"P",{});var Ki=a(Xt);js=l(Ki,"Tips:"),Ki.forEach(o),En=h(t),ge=s(t,"OL",{});var ts=a(ge);Co=s(ts,"LI",{});var Gi=a(Co);Ye=s(Gi,"P",{});var os=a(Ye);Cs=l(os,"Most of the checkpoints provided work with the "),Zt=s(os,"A",{href:!0});var Ji=a(Zt);Ls=l(Ji,"VisualBertForPreTraining"),Ji.forEach(o),Os=l(os,` configuration. Other
checkpoints provided are the fine-tuned checkpoints for down-stream tasks - VQA (\u2018visualbert-vqa\u2019), VCR
(\u2018visualbert-vcr\u2019), NLVR2 (\u2018visualbert-nlvr2\u2019). Hence, if you are not working on these downstream tasks, it is
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),_s.forEach(o),zr=h(Q),O=s(Q,"DIV",{class:!0});var We=a(O);T(Bt.$$.fragment,We),xr=h(We),ie=s(We,"P",{});var zo=a(ie);Fr=l(zo,"The "),fo=s(zo,"A",{href:!0});var Dl=a(fo);Er=l(Dl,"VisualBertForQuestionAnswering"),Dl.forEach(o),Pr=l(zo," forward method, overrides the "),on=s(zo,"CODE",{});var Sl=a(on);Mr=l(Sl,"__call__"),Sl.forEach(o),Ar=l(zo," special method."),zo.forEach(o),jr=h(We),T(Fe.$$.fragment,We),Cr=h(We),T(Ee.$$.fragment,We),We.forEach(o),Q.forEach(o),Kn=h(t),le=s(t,"H2",{class:!0});var vs=a(le);Pe=s(vs,"A",{id:!0,class:!0,href:!0});var Wl=a(Pe);nn=s(Wl,"SPAN",{});var Ql=a(nn);T(qt.$$.fragment,Ql),Ql.forEach(o),Wl.forEach(o),Lr=h(vs),sn=s(vs,"SPAN",{});var Hl=a(sn);Or=l(Hl,"VisualBertForMultipleChoice"),Hl.forEach(o),vs.forEach(o),Gn=h(t),E=s(t,"DIV",{class:!0});var H=a(E);T(zt.$$.fragment,H),Rr=h(H),an=s(H,"P",{});var Ul=a(an);Nr=l(Ul,`VisualBert Model with a multiple choice classification head on top (a linear layer on top of the pooled output and
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),bs.forEach(o),Qr=h(H),Ft=s(H,"P",{});var ks=a(Ft);Hr=l(ks,"This model is also a PyTorch "),Et=s(ks,"A",{href:!0,rel:!0});var Gl=a(Et);Ur=l(Gl,"torch.nn.Module"),Gl.forEach(o),Kr=l(ks,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),ks.forEach(o),Gr=h(H),R=s(H,"DIV",{class:!0});var Qe=a(R);T(Pt.$$.fragment,Qe),Jr=h(Qe),de=s(Qe,"P",{});var xo=a(de);Yr=l(xo,"The "),_o=s(xo,"A",{href:!0});var Jl=a(_o);Xr=l(Jl,"VisualBertForMultipleChoice"),Jl.forEach(o),Zr=l(xo," forward method, overrides the "),rn=s(xo,"CODE",{});var Yl=a(rn);ei=l(Yl,"__call__"),Yl.forEach(o),ti=l(xo," special method."),xo.forEach(o),oi=h(Qe),T(Me.$$.fragment,Qe),ni=h(Qe),T(Ae.$$.fragment,Qe),Qe.forEach(o),H.forEach(o),Jn=h(t),ce=s(t,"H2",{class:!0});var Ts=a(ce);je=s(Ts,"A",{id:!0,class:!0,href:!0});var Xl=a(je);ln=s(Xl,"SPAN",{});var Zl=a(ln);T(Mt.$$.fragment,Zl),Zl.forEach(o),Xl.forEach(o),si=h(Ts),dn=s(Ts,"SPAN",{});var ed=a(dn);ai=l(ed,"VisualBertForVisualReasoning"),ed.forEach(o),Ts.forEach(o),Yn=h(t),P=s(t,"DIV",{class:!0});var U=a(P);T(At.$$.fragment,U),ri=h(U),cn=s(U,"P",{});var td=a(cn);ii=l(td,`VisualBert Model with a sequence classification head on top (a dropout and a linear layer on top of the pooled
...
e.g. for Flickr30 Entities task.`),dd.forEach(o),xi=h(K),It=s(K,"P",{});var Vs=a(It);Fi=l(Vs,"This model inherits from "),ko=s(Vs,"A",{href:!0});var cd=a(ko);Ei=l(cd,"PreTrainedModel"),cd.forEach(o),Pi=l(Vs,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
