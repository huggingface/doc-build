import{S as tn,i as nn,s as on,e as o,k as p,w as E,t as r,M as sn,c as s,d as n,m,a as i,x as $,h as a,b as l,F as t,g as d,y as P,L as rn,q as A,o as N,B as I,v as an}from"../../chunks/vendor-6b77c823.js";import{D as qt}from"../../chunks/Docstring-90e3aa51.js";import{C as en}from"../../chunks/CodeBlock-3a8b25a8.js";import{I as xt}from"../../chunks/IconCopyLink-7a11ce68.js";function ln(zt){let k,fe,y,w,ae,U,We,le,Ke,ge,v,T,ce,S,Re,de,De,_e,f,Fe,W,Oe,Be,K,je,Xe,ke,V,Ce,ye,J,Ye,ve,G,pe,He,be,Q,Ve,we,R,Te,L,Je,Z,Ge,Qe,Le,D,qe,q,Ze,ee,et,tt,xe,g,nt,F,ot,st,O,it,rt,ze,b,x,me,B,at,ue,lt,Me,u,j,ct,h,dt,te,pt,mt,ne,ut,ht,X,ft,gt,_t,C,kt,oe,yt,vt,bt,z,Y,wt,he,Tt,Lt,se,H,Ee;return U=new xt({}),S=new xt({}),R=new en({props:{code:`from transformers import LukeModel
...
<p><a
  href="/docs/transformers/main/en/main_classes/tokenizer#transformers.BatchEncoding"
>BatchEncoding</a></p>
`}}),H=new qt({props:{name:"save_vocabulary",anchor:"transformers.MLukeTokenizer.save_vocabulary",parameters:[{name:"save_directory",val:": str"},{name:"filename_prefix",val:": typing.Optional[str] = None"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/mluke/tokenization_mluke.py#L1492"}}),{c(){k=o("meta"),fe=p(),y=o("h1"),w=o("a"),ae=o("span"),E(U.$$.fragment),We=p(),le=o("span"),Ke=r("mLUKE"),ge=p(),v=o("h2"),T=o("a"),ce=o("span"),E(S.$$.fragment),Re=p(),de=o("span"),De=r("Overview"),_e=p(),f=o("p"),Fe=r("The mLUKE model was proposed in "),W=o("a"),Oe=r("mLUKE: The Power of Entity Representations in Multilingual Pretrained Language Models"),Be=r(` by Ryokan Ri, Ikuya Yamada, and Yoshimasa Tsuruoka. It\u2019s a multilingual extension
...
representations into the input allows us to extract more language-agnostic features. We also evaluate the model with a
multilingual cloze prompt task with the mLAMA dataset. We show that entity-based prompt elicits correct factual
knowledge more likely than using only word representations.`),Rt.forEach(n),Kt.forEach(n),be=m(e),Q=s(e,"P",{});var Dt=i(Q);Ve=a(Dt,"One can directly plug in the weights of mLUKE into a LUKE model, like so:"),Dt.forEach(n),we=m(e),$(R.$$.fragment,e),Te=m(e),L=s(e,"P",{});var Ae=i(L);Je=a(Ae,"Note that mLUKE has its own tokenizer, "),Z=s(Ae,"A",{href:!0});var Ft=i(Z);Ge=a(Ft,"MLukeTokenizer"),Ft.forEach(n),Qe=a(Ae,". You can initialize it as follows:"),Ae.forEach(n),Le=m(e),$(D.$$.fragment,e),qe=m(e),q=s(e,"P",{});var Ne=i(q);Ze=a(Ne,"As mLUKE\u2019s architecture is equivalent to that of LUKE, one can refer to "),ee=s(Ne,"A",{href:!0});var Ot=i(ee);et=a(Ot,"LUKE\u2019s documentation page"),Ot.forEach(n),tt=a(Ne,` for all
tips, code examples and notebooks.`),Ne.forEach(n),xe=m(e),g=s(e,"P",{});var re=i(g);nt=a(re,"This model was contributed by "),F=s(re,"A",{href:!0,rel:!0});var Bt=i(F);ot=a(Bt,"ryo0634"),Bt.forEach(n),st=a(re,". The original code can be found "),O=s(re,"A",{href:!0,rel:!0});var jt=i(O);it=a(jt,"here"),jt.forEach(n),rt=a(re,"."),re.forEach(n),ze=m(e),b=s(e,"H2",{class:!0});var Ie=i(b);x=s(Ie,"A",{id:!0,class:!0,href:!0});var Xt=i(x);me=s(Xt,"SPAN",{});var Ct=i(me);$(B.$$.fragment,Ct),Ct.forEach(n),Xt.forEach(n),at=m(Ie),ue=s(Ie,"SPAN",{});var Yt=i(ue);lt=a(Yt,"MLukeTokenizer"),Yt.forEach(n),Ie.forEach(n),Me=m(e),u=s(e,"DIV",{class:!0});var _=i(u);$(j.$$.fragment,_),ct=m(_),h=s(_,"P",{});var M=i(h);dt=a(M,"Adapted from "),te=s(M,"A",{href:!0});var Ht=i(te);pt=a(Ht,"XLMRobertaTokenizer"),Ht.forEach(n),mt=a(M," and "),ne=s(M,"A",{href:!0});var Vt=i(ne);ut=a(Vt,"LukeTokenizer"),Vt.forEach(n),ht=a(M,`. Based on
