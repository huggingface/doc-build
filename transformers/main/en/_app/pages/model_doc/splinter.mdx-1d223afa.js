...
special tokens using the tokenizer `),tn=o("code"),As=a("prepare_for_model"),Ps=a(" method."),Ms=d(),W=o("div"),u(Oe.$$.fragment),Fs=d(),yt=o("p"),Cs=a("Create the token type IDs corresponding to the sequences passed. "),Tt=o("a"),Is=a(`What are token type
...
one also has the pretrained wights of the QASS layer (`),Wt=s(B,"EM",{});var ua=r(Wt);Mo=i(ua,"tau/splinter-base-qass"),ua.forEach(n),Fo=i(B," and "),Ut=s(B,"EM",{});var fa=r(Ut);Co=i(fa,"tau/splinter-large-qass"),fa.forEach(n),Io=i(B,`) and one
