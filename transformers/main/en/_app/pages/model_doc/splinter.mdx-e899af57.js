...
one also has the pretrained wights of the QASS layer (`),Ot=s(B,"EM",{});var ha=r(Ot);Ao=i(ha,"tau/splinter-base-qass"),ha.forEach(n),Po=i(B," and "),Wt=s(B,"EM",{});var ma=r(Wt);Mo=i(ma,"tau/splinter-large-qass"),ma.forEach(n),Fo=i(B,`) and one
