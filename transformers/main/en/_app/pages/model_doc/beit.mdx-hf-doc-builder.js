...
<span class="hljs-meta">&gt;&gt;&gt; </span>outputs = model(**inputs)
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),{c(){c=a("p"),v=r("Examples:"),g=m(),w(f.$$.fragment)},l(l){c=n(l,"P",{});var h=s(c);v=i(h,"Examples:"),h.forEach(t),g=p(l),x(f.$$.fragment,l)},m(l,h){_(l,c,h),e(c,v),_(l,g,h),$(f,l,h),b=!0},p:Bt,i(l){b||(y(f.$$.fragment,l),b=!0)},o(l){T(f.$$.fragment,l),b=!1},d(l){l&&t(c),l&&t(g),B(f,l)}}}function Rh(F){let c,v,g,f,b;return{c(){c=a("p"),v=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),g=a("code"),f=r("Module"),b=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(l){c=n(l,"P",{});var h=s(c);v=i(h,"Although the recipe for forward pass needs to be defined within this function, one should call the "),g=n(h,"CODE",{});var E=s(g);f=i(E,"Module"),E.forEach(t),b=i(h,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-built_in">print</span>(<span class="hljs-string">&quot;Predicted class:&quot;</span>, model.config.id2label[predicted_class_idx])`}}),{c(){c=a("p"),v=r("Example:"),g=m(),w(f.$$.fragment)},l(l){c=n(l,"P",{});var h=s(c);v=i(h,"Example:"),h.forEach(t),g=p(l),x(f.$$.fragment,l)},m(l,h){_(l,c,h),e(c,v),_(l,g,h),$(f,l,h),b=!0},p:Bt,i(l){b||(y(f.$$.fragment,l),b=!0)},o(l){T(f.$$.fragment,l),b=!1},d(l){l&&t(c),l&&t(g),B(f,l)}}}function Gh(F){let c,v,g,f,b,l,h,E,hr,ls,me,Ae,Da,Et,fr,Va,ur,ds,W,gr,kt,_r,br,Mt,vr,wr,It,xr,$r,cs,ea,yr,ms,ta,Wa,Tr,ps,oa,Br,hs,C,M,Fr,aa,Er,kr,na,Mr,Ir,jt,jr,Pr,sa,Cr,zr,ra,Ar,qr,ia,Lr,Sr,la,Nr,Or,Dr,Pt,Vr,Ct,Wr,Rr,Ur,zt,Hr,da,Jr,Gr,Xr,pe,Kr,Ra,Yr,Qr,At,Zr,ei,ti,he,oi,qt,ai,ni,Lt,si,ri,ii,O,li,Ua,di,ci,Ha,mi,pi,ca,hi,fi,Ja,ui,gi,fs,qe,fm,us,St,_i,ma,bi,gs,R,vi,Nt,wi,xi,Ot,$i,yi,Dt,Ti,Bi,_s,fe,Le,Ga,Vt,Fi,Xa,Ei,bs,ue,Wt,ki,Rt,Mi,pa,Ii,ji,vs,ge,Ut,Pi,Ht,Ci,ha,zi,Ai,ws,_e,Se,Ka,Jt,qi,Ya,Li,xs,Z,Gt,Si,be,Ni,fa,Oi,Di,Xt,Vi,Wi,Ri,Ne,$s,ve,Oe,Qa,Kt,Ui,Za,Hi,ys,A,Yt,Ji,en,Gi,Xi,Qt,Ki,ua,Yi,Qi,Zi,ie,Zt,el,tn,tl,ol,De,al,Ve,eo,nl,to,sl,ga,rl,il,Ts,we,We,on,oo,ll,an,dl,Bs,ee,ao,cl,no,ml,so,pl,hl,fl,U,ro,ul,xe,gl,_a,_l,bl,nn,vl,wl,xl,Re,$l,Ue,Fs,$e,He,sn,io,yl,rn,Tl,Es,te,lo,Bl,oe,Fl,ba,El,kl,va,Ml,Il,co,jl,Pl,Cl,H,mo,zl,ye,Al,wa,ql,Ll,ln,Sl,Nl,Ol,Je,Dl,Ge,ks,Te,Xe,dn,po,Vl,cn,Wl,Ms,D,ho,Rl,mn,Ul,Hl,fo,Jl,uo,Gl,Xl,Kl,J,go,Yl,Be,Ql,xa,Zl,ed,pn,td,od,ad,Ke,nd,Ye,Is,Fe,Qe,hn,_o,sd,fn,rd,js,V,bo,id,un,ld,dd,vo,cd,wo,md,pd,hd,G,xo,fd,Ee,ud,$a,gd,_d,gn,bd,vd,wd,Ze,xd,et,Ps,ke,tt,_n,$o,$d,bn,yd,Cs,I,yo,Td,vn,Bd,Fd,To,Ed,ya,kd,Md,Id,Bo,jd,Fo,Pd,Cd,zd,wn,Ad,qd,ae,xn,Eo,Ld,Sd,$n,ko,Nd,Od,yn,Mo,Dd,Vd,Tn,Io,Wd,Rd,X,jo,Ud,Me,Hd,Bn,Jd,Gd,Fn,Xd,Kd,Yd,ot,Qd,at,zs,Ie,nt,En,Po,Zd,kn,ec,As,j,Co,tc,Mn,oc,ac,zo,nc,Ta,sc,rc,ic,Ao,lc,qo,dc,cc,mc,In,pc,hc,ne,jn,Lo,fc,uc,Pn,So,gc,_c,Cn,No,bc,vc,zn,Oo,wc,xc,q,Do,$c,je,yc,An,Tc,Bc,qn,Fc,Ec,kc,st,Mc,Pe,Ic,Ln,jc,Pc,Sn,Cc,zc,Ac,rt,qs,Ce,it,Nn,Vo,qc,On,Lc,Ls,P,Wo,Sc,Dn,Nc,Oc,Ro,Dc,Ba,Vc,Wc,Rc,Uo,Uc,Ho,Hc,Jc,Gc,Vn,Xc,Kc,se,Wn,Jo,Yc,Qc,Rn,Go,Zc,em,Un,Xo,tm,om,Hn,Ko,am,nm,K,Yo,sm,ze,rm,Jn,im,lm,Gn,dm,cm,mm,lt,pm,dt,Ss;return l=new Q({}),Et=new Q({}),Vt=new Q({}),Wt=new k({props:{name:"class transformers.models.beit.modeling_beit.BeitModelOutputWithPooling",anchor:"transformers.models.beit.modeling_beit.BeitModelOutputWithPooling",parameters:[{name:"last_hidden_state",val:": FloatTensor = None"},{name:"pooler_output",val:": FloatTensor = None"},{name:"hidden_states",val:": typing.Optional[typing.Tuple[torch.FloatTensor]] = None"},{name:"attentions",val:": typing.Optional[typing.Tuple[torch.FloatTensor]] = None"}],parametersDescription:[{anchor:"transformers.models.beit.modeling_beit.BeitModelOutputWithPooling.last_hidden_state",description:`<strong>last_hidden_state</strong> (<code>torch.FloatTensor</code> of shape <code>(batch_size, sequence_length, hidden_size)</code>) &#x2014;
...
</ul>`,name:"return_tensors"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/beit/feature_extraction_beit.py#L103",returnDescription:`
<p>A <a
...
None, predictions will not be resized.`,name:"target_sizes"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/beit/feature_extraction_beit.py#L232",returnDescription:`
...
`}}),st=new yt({props:{$$slots:{default:[Rh]},$$scope:{ctx:F}}}),rt=new Tt({props:{anchor:"transformers.FlaxBeitForMaskedImageModeling.__call__.example",$$slots:{default:[Uh]},$$scope:{ctx:F}}}),Vo=new Q({}),Wo=new k({props:{name:"class transformers.FlaxBeitForImageClassification",anchor:"transformers.FlaxBeitForImageClassification",parameters:[{name:"config",val:": BeitConfig"},{name:"input_shape",val:" = None"},{name:"seed",val:": int = 0"},{name:"dtype",val:": dtype = <class 'jax.numpy.float32'>"},{name:"_do_init",val:": bool = True"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.FlaxBeitForImageClassification.config",description:`<strong>config</strong> (<a href="/docs/transformers/main/en/model_doc/beit#transformers.BeitConfig">BeitConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
...
performing masked image modeling. You can find it `),Ct=a("a"),Wr=r("here"),Rr=r("."),Ur=m(),zt=a("li"),Hr=r(`As the BEiT models expect each image to be of the same size (resolution), one can use
...
each checkpoint. For example, `),Ra=a("code"),Yr=r("microsoft/beit-base-patch16-224"),Qr=r(` refers to a base-sized architecture with patch
...
pre-train a model from scratch, one needs to either set the `),Ua=a("code"),di=r("use_relative_position_bias"),ci=r(` or the
...
behavior.`),fl=m(),U=a("div"),w(ro.$$.fragment),ul=m(),xe=a("p"),gl=r("The "),_a=a("a"),_l=r("BeitModel"),bl=r(" forward method, overrides the "),nn=a("code"),vl=r("__call__"),wl=r(" special method."),xl=m(),w(Re.$$.fragment),$l=m(),w(Ue.$$.fragment),Fs=m(),$e=a("h2"),He=a("a"),sn=a("span"),w(io.$$.fragment),yl=m(),rn=a("span"),Tl=r("BeitForMaskedImageModeling"),Es=m(),te=a("div"),w(lo.$$.fragment),Bl=m(),oe=a("p"),Fl=r(`Beit Model transformer with a \u2018language\u2019 modeling head on top. BEiT does masked image modeling by predicting
...
hidden states of the patch tokens) e.g. for ImageNet.`),Oc=m(),Ro=a("p"),Dc=r("This model inherits from "),Ba=a("a"),Vc=r("FlaxPreTrainedModel"),Wc=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),Rc=m(),Uo=a("p"),Uc=r("This model is also a Flax Linen "),Ho=a("a"),Hc=r("flax.linen.Module"),Jc=r(`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),Gc=m(),Vn=a("p"),Xc=r("Finally, this model supports inherent JAX features such as:"),Kc=m(),se=a("ul"),Wn=a("li"),Jo=a("a"),Yc=r("Just-In-Time (JIT) compilation"),Qc=m(),Rn=a("li"),Go=a("a"),Zc=r("Automatic Differentiation"),em=m(),Un=a("li"),Xo=a("a"),tm=r("Vectorization"),om=m(),Hn=a("li"),Ko=a("a"),am=r("Parallelization"),nm=m(),K=a("div"),w(Yo.$$.fragment),sm=m(),ze=a("p"),rm=r("The "),Jn=a("code"),im=r("FlaxBeitPreTrainedModel"),lm=r(" forward method, overrides the "),Gn=a("code"),dm=r("__call__"),cm=r(" special method."),mm=m(),w(lt.$$.fragment),pm=m(),w(dt.$$.fragment),this.h()},l(o){const u=Mh('[data-svelte="svelte-1phssyn"]',document.head);c=n(u,"META",{name:!0,content:!0}),u.forEach(t),v=p(o),g=n(o,"H1",{class:!0});var Qo=s(g);f=n(Qo,"A",{id:!0,class:!0,href:!0});var Xn=s(f);b=n(Xn,"SPAN",{});var Kn=s(b);x(l.$$.fragment,Kn),Kn.forEach(t),Xn.forEach(t),h=p(Qo),E=n(Qo,"SPAN",{});var Yn=s(E);hr=i(Yn,"BEiT"),Yn.forEach(t),Qo.forEach(t),ls=p(o),me=n(o,"H2",{class:!0});var Zo=s(me);Ae=n(Zo,"A",{id:!0,class:!0,href:!0});var Qn=s(Ae);Da=n(Qn,"SPAN",{});var Zn=s(Da);x(Et.$$.fragment,Zn),Zn.forEach(t),Qn.forEach(t),fr=p(Zo),Va=n(Zo,"SPAN",{});var es=s(Va);ur=i(es,"Overview"),es.forEach(t),Zo.forEach(t),ds=p(o),W=n(o,"P",{});var re=s(W);gr=i(re,"The BEiT model was proposed in "),kt=n(re,"A",{href:!0,rel:!0});var ts=s(kt);_r=i(ts,"BEiT: BERT Pre-Training of Image Transformers"),ts.forEach(t),br=i(re,` by
Hangbo Bao, Li Dong and Furu Wei. Inspired by BERT, BEiT is the first paper that makes self-supervised pre-training of
Vision Transformers (ViTs) outperform supervised pre-training. Rather than pre-training the model to predict the class
...
performing masked image modeling. You can find it `),Ct=n(Ns,"A",{href:!0,rel:!0});var $m=s(Ct);Wr=i($m,"here"),$m.forEach(t),Rr=i(Ns,"."),Ns.forEach(t),Ur=p(Y),zt=n(Y,"LI",{});var Os=s(zt);Hr=i(Os,`As the BEiT models expect each image to be of the same size (resolution), one can use
...
each checkpoint. For example, `),Ra=n(Fa,"CODE",{});var Tm=s(Ra);Yr=i(Tm,"microsoft/beit-base-patch16-224"),Tm.forEach(t),Qr=i(Fa,` refers to a base-sized architecture with patch
...
relative position bias among the several self-attention layers. During fine-tuning, each layer\u2019s relative position
bias is initialized with the shared relative position bias obtained after pre-training. Note that, if one wants to
pre-train a model from scratch, one needs to either set the `),Ua=n(le,"CODE",{});var km=s(Ua);di=i(km,"use_relative_position_bias"),km.forEach(t),ci=i(le,` or the
...
position embeddings.`),le.forEach(t),Y.forEach(t),fs=p(o),qe=n(o,"IMG",{src:!0,alt:!0,width:!0}),us=p(o),St=n(o,"SMALL",{});var hm=s(St);_i=i(hm,"BEiT pre-training. Taken from the "),ma=n(hm,"A",{href:!0});var Pm=s(ma);bi=i(Pm,"original paper."),Pm.forEach(t),hm.forEach(t),gs=p(o),R=n(o,"P",{});var ct=s(R);vi=i(ct,"This model was contributed by "),Nt=n(ct,"A",{href:!0,rel:!0});var Cm=s(Nt);wi=i(Cm,"nielsr"),Cm.forEach(t),xi=i(ct,`. The JAX/FLAX version of this model was
contributed by `),Ot=n(ct,"A",{href:!0,rel:!0});var zm=s(Ot);$i=i(zm,"kamalkraj"),zm.forEach(t),yi=i(ct,". The original code can be found "),Dt=n(ct,"A",{href:!0,rel:!0});var Am=s(Dt);Ti=i(Am,"here"),Am.forEach(t),Bi=i(ct,"."),ct.forEach(t),_s=p(o),fe=n(o,"H2",{class:!0});var Ds=s(fe);Le=n(Ds,"A",{id:!0,class:!0,href:!0});var qm=s(Le);Ga=n(qm,"SPAN",{});var Lm=s(Ga);x(Vt.$$.fragment,Lm),Lm.forEach(t),qm.forEach(t),Fi=p(Ds),Xa=n(Ds,"SPAN",{});var Sm=s(Xa);Ei=i(Sm,"BEiT specific outputs"),Sm.forEach(t),Ds.forEach(t),bs=p(o),ue=n(o,"DIV",{class:!0});var Vs=s(ue);x(Wt.$$.fragment,Vs),ki=p(Vs),Rt=n(Vs,"P",{});var Ws=s(Rt);Mi=i(Ws,"Class for outputs of "),pa=n(Ws,"A",{href:!0});var Nm=s(pa);Ii=i(Nm,"BeitModel"),Nm.forEach(t),ji=i(Ws,"."),Ws.forEach(t),Vs.forEach(t),vs=p(o),ge=n(o,"DIV",{class:!0});var Rs=s(ge);x(Ut.$$.fragment,Rs),Pi=p(Rs),Ht=n(Rs,"P",{});var Us=s(Ht);Ci=i(Us,"Class for outputs of "),ha=n(Us,"A",{href:!0});var Om=s(ha);zi=i(Om,"FlaxBeitModel"),Om.forEach(t),Ai=i(Us,"."),Us.forEach(t),Rs.forEach(t),ws=p(o),_e=n(o,"H2",{class:!0});var Hs=s(_e);Se=n(Hs,"A",{id:!0,class:!0,href:!0});var Dm=s(Se);Ka=n(Dm,"SPAN",{});var Vm=s(Ka);x(Jt.$$.fragment,Vm),Vm.forEach(t),Dm.forEach(t),qi=p(Hs),Ya=n(Hs,"SPAN",{});var Wm=s(Ya);Li=i(Wm,"BeitConfig"),Wm.forEach(t),Hs.forEach(t),xs=p(o),Z=n(o,"DIV",{class:!0});var ka=s(Z);x(Gt.$$.fragment,ka),Si=p(ka),be=n(ka,"P",{});var Ma=s(be);Ni=i(Ma,"This is the configuration class to store the configuration of a "),fa=n(Ma,"A",{href:!0});var Rm=s(fa);Oi=i(Rm,"BeitModel"),Rm.forEach(t),Di=i(Ma,`. It is used to instantiate an BEiT
model according to the specified arguments, defining the model architecture. Instantiating a configuration with the
defaults will yield a similar configuration to that of the BEiT
`),Xt=n(Ma,"A",{href:!0,rel:!0});var Um=s(Xt);Vi=i(Um,"microsoft/beit-base-patch16-224-pt22k"),Um.forEach(t),Wi=i(Ma," architecture."),Ma.forEach(t),Ri=p(ka),x(Ne.$$.fragment,ka),ka.forEach(t),$s=p(o),ve=n(o,"H2",{class:!0});var Js=s(ve);Oe=n(Js,"A",{id:!0,class:!0,href:!0});var Hm=s(Oe);Qa=n(Hm,"SPAN",{});var Jm=s(Qa);x(Kt.$$.fragment,Jm),Jm.forEach(t),Hm.forEach(t),Ui=p(Js),Za=n(Js,"SPAN",{});var Gm=s(Za);Hi=i(Gm,"BeitFeatureExtractor"),Gm.forEach(t),Js.forEach(t),ys=p(o),A=n(o,"DIV",{class:!0});var de=s(A);x(Yt.$$.fragment,de),Ji=p(de),en=n(de,"P",{});var Xm=s(en);Gi=i(Xm,"Constructs a BEiT feature extractor."),Xm.forEach(t),Xi=p(de),Qt=n(de,"P",{});var Gs=s(Qt);Ki=i(Gs,"This feature extractor inherits from "),ua=n(Gs,"A",{href:!0});var Km=s(ua);Yi=i(Km,"FeatureExtractionMixin"),Km.forEach(t),Qi=i(Gs,` which contains most of
