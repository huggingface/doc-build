import{S as Cz,i as Ez,s as Pz,e as o,k as d,w as u,t as r,M as Sz,c as a,d as t,m as l,a as s,x as m,h as i,b as c,F as e,g as h,y as f,q as _,o as g,B as k,v as Az}from"../../chunks/vendor-6b77c823.js";import{T as st}from"../../chunks/Tip-39098574.js";import{D as F}from"../../chunks/Docstring-abef54e3.js";import{C as $}from"../../chunks/CodeBlock-3a8b25a8.js";import{I as X}from"../../chunks/IconCopyLink-7a11ce68.js";function Oz(C){let b,z,v,M,x;return{c(){b=o("p"),z=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),v=o("code"),M=r("Module"),x=r(`
...
adding special tokens. The special tokens depend on calling set_lang.`),m2.forEach(t),e_=l(Et),pa=a(Et,"P",{});var qh=s(pa);t_=i(qh,"An MBART sequence has the following format, where "),Hd=a(qh,"CODE",{});var f2=s(Hd);n_=i(f2,"X"),f2.forEach(t),o_=i(qh," represents the sequence:"),qh.forEach(t),a_=l(Et),ha=a(Et,"UL",{});var $h=s(ha);ua=a($h,"LI",{});var Bh=s(ua);Jd=a(Bh,"CODE",{});var _2=s(Jd);s_=i(_2,"input_ids"),_2.forEach(t),r_=i(Bh," (for encoder) "),Kd=a(Bh,"CODE",{});var g2=s(Kd);i_=i(g2,"X [eos, src_lang_code]"),g2.forEach(t),Bh.forEach(t),d_=l($h),ma=a($h,"LI",{});var jh=s(ma);Zd=a(jh,"CODE",{});var k2=s(Zd);l_=i(k2,"decoder_input_ids"),k2.forEach(t),c_=i(jh,": (for decoder) "),Yd=a(jh,"CODE",{});var b2=s(Yd);p_=i(b2,"X [eos, tgt_lang_code]"),b2.forEach(t),jh.forEach(t),$h.forEach(t),h_=l(Et),el=a(Et,"P",{});var y2=s(el);u_=i(y2,`BOS is never used. Pairs of sequences are not the expected use case, but they will be handled without a
separator.`),y2.forEach(t),Et.forEach(t),m_=l(Q),Ln=a(Q,"DIV",{class:!0});var Ch=s(Ln);m(fa.$$.fragment,Ch),f_=l(Ch),tl=a(Ch,"P",{});var v2=s(tl);__=i(v2,`Create a mask from the two sequences passed to be used in a sequence-pair classification task. mBART does not
make use of token type ids, therefore a list of zeros is returned.`),v2.forEach(t),Ch.forEach(t),g_=l(Q),Gn=a(Q,"DIV",{class:!0});var Eh=s(Gn);m(_a.$$.fragment,Eh),k_=l(Eh),nl=a(Eh,"P",{});var T2=s(nl);b_=i(T2,"Reset the special tokens to the source lang setting. No prefix and suffix=[eos, src_lang_code]."),T2.forEach(t),Eh.forEach(t),y_=l(Q),Wn=a(Q,"DIV",{class:!0});var Ph=s(Wn);m(ga.$$.fragment,Ph),v_=l(Ph),ol=a(Ph,"P",{});var w2=s(ol);T_=i(w2,"Reset the special tokens to the target language setting. No prefix and suffix=[eos, tgt_lang_code]."),w2.forEach(t),Ph.forEach(t),Q.forEach(t),Ip=l(n),rn=a(n,"H2",{class:!0});var Sh=s(rn);Un=a(Sh,"A",{id:!0,class:!0,href:!0});var M2=s(Un);al=a(M2,"SPAN",{});var x2=s(al);m(ka.$$.fragment,x2),x2.forEach(t),M2.forEach(t),w_=l(Sh),sl=a(Sh,"SPAN",{});var z2=s(sl);M_=i(z2,"MBart50Tokenizer"),z2.forEach(t),Sh.forEach(t),Np=l(n),S=a(n,"DIV",{class:!0});var H=s(S);m(ba.$$.fragment,H),x_=l(H),ya=a(H,"P",{});var Ah=s(ya);z_=i(Ah,"Construct a MBart50 tokenizer. Based on "),va=a(Ah,"A",{href:!0,rel:!0});var F2=s(va);F_=i(F2,"SentencePiece"),F2.forEach(t),q_=i(Ah,"."),Ah.forEach(t),$_=l(H),Ta=a(H,"P",{});var Oh=s(Ta);B_=i(Oh,"This tokenizer inherits from "),mi=a(Oh,"A",{href:!0});var q2=s(mi);j_=i(q2,"PreTrainedTokenizer"),q2.forEach(t),C_=i(Oh,` which contains most of the main methods. Users should refer to
this superclass for more information regarding those methods.`),Oh.forEach(t),E_=l(H),rl=a(H,"P",{});var $2=s(rl);P_=i($2,"Examples:"),$2.forEach(t),S_=l(H),m(wa.$$.fragment,H),A_=l(H),nt=a(H,"DIV",{class:!0});var zo=s(nt);m(Ma.$$.fragment,zo),O_=l(zo),xa=a(zo,"P",{});var Ih=s(xa);I_=i(Ih,`Build model inputs from a sequence or a pair of sequence for sequence classification tasks by concatenating and
adding special tokens. An MBART-50 sequence has the following format, where `),il=a(Ih,"CODE",{});var B2=s(il);N_=i(B2,"X"),B2.forEach(t),D_=i(Ih," represents the sequence:"),Ih.forEach(t),L_=l(zo),za=a(zo,"UL",{});var Nh=s(za);Fa=a(Nh,"LI",{});var Dh=s(Fa);dl=a(Dh,"CODE",{});var j2=s(dl);G_=i(j2,"input_ids"),j2.forEach(t),W_=i(Dh," (for encoder) "),ll=a(Dh,"CODE",{});var C2=s(ll);U_=i(C2,"[src_lang_code] X [eos]"),C2.forEach(t),Dh.forEach(t),R_=l(Nh),qa=a(Nh,"LI",{});var Lh=s(qa);cl=a(Lh,"CODE",{});var E2=s(cl);X_=i(E2,"labels"),E2.forEach(t),V_=i(Lh,": (for decoder) "),pl=a(Lh,"CODE",{});var P2=s(pl);Q_=i(P2,"[tgt_lang_code] X [eos]"),P2.forEach(t),Lh.forEach(t),Nh.forEach(t),H_=l(zo),hl=a(zo,"P",{});var S2=s(hl);J_=i(S2,`BOS is never used. Pairs of sequences are not the expected use case, but they will be handled without a
separator.`),S2.forEach(t),zo.forEach(t),K_=l(H),Rn=a(H,"DIV",{class:!0});var Gh=s(Rn);m($a.$$.fragment,Gh),Z_=l(Gh),ul=a(Gh,"P",{});var A2=s(ul);Y_=i(A2,"Converts a sequence of tokens (strings for sub-words) in a single string."),A2.forEach(t),Gh.forEach(t),eg=l(H),Xn=a(H,"DIV",{class:!0});var Wh=s(Xn);m(Ba.$$.fragment,Wh),tg=l(Wh),ja=a(Wh,"P",{});var Uh=s(ja);ng=i(Uh,`Retrieve sequence ids from a token list that has no special tokens added. This method is called when adding
special tokens using the tokenizer `),ml=a(Uh,"CODE",{});var O2=s(ml);og=i(O2,"prepare_for_model"),O2.forEach(t),ag=i(Uh," method."),Uh.forEach(t),Wh.forEach(t),sg=l(H),Vn=a(H,"DIV",{class:!0});var Rh=s(Vn);m(Ca.$$.fragment,Rh),rg=l(Rh),fl=a(Rh,"P",{});var I2=s(fl);ig=i(I2,"Reset the special tokens to the source lang setting. prefix=[src_lang_code] and suffix=[eos]."),I2.forEach(t),Rh.forEach(t),dg=l(H),Qn=a(H,"DIV",{class:!0});var Xh=s(Qn);m(Ea.$$.fragment,Xh),lg=l(Xh),_l=a(Xh,"P",{});var N2=s(_l);cg=i(N2,"Reset the special tokens to the target language setting. prefix=[tgt_lang_code] and suffix=[eos]."),N2.forEach(t),Xh.forEach(t),H.forEach(t),Dp=l(n),dn=a(n,"H2",{class:!0});var Vh=s(dn);Hn=a(Vh,"A",{id:!0,class:!0,href:!0});var D2=s(Hn);gl=a(D2,"SPAN",{});var L2=s(gl);m(Pa.$$.fragment,L2),L2.forEach(t),D2.forEach(t),pg=l(Vh),kl=a(Vh,"SPAN",{});var G2=s(kl);hg=i(G2,"MBart50TokenizerFast"),G2.forEach(t),Vh.forEach(t),Lp=l(n),W=a(n,"DIV",{class:!0});var fe=s(W);m(Sa.$$.fragment,fe),ug=l(fe),ln=a(fe,"P",{});var Ii=s(ln);mg=i(Ii,"Construct a \u201Cfast\u201D MBART tokenizer for mBART-50 (backed by HuggingFace\u2019s "),bl=a(Ii,"EM",{});var W2=s(bl);fg=i(W2,"tokenizers"),W2.forEach(t),_g=i(Ii,` library). Based on
`),Aa=a(Ii,"A",{href:!0,rel:!0});var U2=s(Aa);gg=i(U2,"BPE"),U2.forEach(t),kg=i(Ii,"."),Ii.forEach(t),bg=l(fe),Oa=a(fe,"P",{});var Qh=s(Oa);yg=i(Qh,"This tokenizer inherits from "),fi=a(Qh,"A",{href:!0});var R2=s(fi);vg=i(R2,"PreTrainedTokenizerFast"),R2.forEach(t),Tg=i(Qh,` which contains most of the main methods. Users should
refer to this superclass for more information regarding those methods.`),Qh.forEach(t),wg=l(fe),yl=a(fe,"P",{});var X2=s(yl);Mg=i(X2,"Examples:"),X2.forEach(t),xg=l(fe),m(Ia.$$.fragment,fe),zg=l(fe),Ae=a(fe,"DIV",{class:!0});var Pt=s(Ae);m(Na.$$.fragment,Pt),Fg=l(Pt),vl=a(Pt,"P",{});var V2=s(vl);qg=i(V2,`Build model inputs from a sequence or a pair of sequence for sequence classification tasks by concatenating and
adding special tokens. The special tokens depend on calling set_lang.`),V2.forEach(t),$g=l(Pt),Da=a(Pt,"P",{});var Hh=s(Da);Bg=i(Hh,"An MBART-50 sequence has the following format, where "),Tl=a(Hh,"CODE",{});var Q2=s(Tl);jg=i(Q2,"X"),Q2.forEach(t),Cg=i(Hh," represents the sequence:"),Hh.forEach(t),Eg=l(Pt),La=a(Pt,"UL",{});var Jh=s(La);Ga=a(Jh,"LI",{});var Kh=s(Ga);wl=a(Kh,"CODE",{});var H2=s(wl);Pg=i(H2,"input_ids"),H2.forEach(t),Sg=i(Kh," (for encoder) "),Ml=a(Kh,"CODE",{});var J2=s(Ml);Ag=i(J2,"[src_lang_code] X [eos]"),J2.forEach(t),Kh.forEach(t),Og=l(Jh),Wa=a(Jh,"LI",{});var Zh=s(Wa);xl=a(Zh,"CODE",{});var K2=s(xl);Ig=i(K2,"labels"),K2.forEach(t),Ng=i(Zh,": (for decoder) "),zl=a(Zh,"CODE",{});var Z2=s(zl);Dg=i(Z2,"[tgt_lang_code] X [eos]"),Z2.forEach(t),Zh.forEach(t),Jh.forEach(t),Lg=l(Pt),Fl=a(Pt,"P",{});var Y2=s(Fl);Gg=i(Y2,`BOS is never used. Pairs of sequences are not the expected use case, but they will be handled without a
separator.`),Y2.forEach(t),Pt.forEach(t),Wg=l(fe),Jn=a(fe,"DIV",{class:!0});var Yh=s(Jn);m(Ua.$$.fragment,Yh),Ug=l(Yh),ql=a(Yh,"P",{});var e1=s(ql);Rg=i(e1,"Reset the special tokens to the source lang setting. prefix=[src_lang_code] and suffix=[eos]."),e1.forEach(t),Yh.forEach(t),Xg=l(fe),Kn=a(fe,"DIV",{class:!0});var eu=s(Kn);m(Ra.$$.fragment,eu),Vg=l(eu),$l=a(eu,"P",{});var t1=s($l);Qg=i(t1,"Reset the special tokens to the target language setting. prefix=[src_lang_code] and suffix=[eos]."),t1.forEach(t),eu.forEach(t),fe.forEach(t),Gp=l(n),cn=a(n,"H2",{class:!0});var tu=s(cn);Zn=a(tu,"A",{id:!0,class:!0,href:!0});var n1=s(Zn);Bl=a(n1,"SPAN",{});var o1=s(Bl);m(Xa.$$.fragment,o1),o1.forEach(t),n1.forEach(t),Hg=l(tu),jl=a(tu,"SPAN",{});var a1=s(jl);Jg=i(a1,"MBartModel"),a1.forEach(t),tu.forEach(t),Wp=l(n),He=a(n,"DIV",{class:!0});var Fo=s(He);m(Va.$$.fragment,Fo),Kg=l(Fo),Qa=a(Fo,"P",{});var nu=s(Qa);Zg=i(nu,`The bare MBART Model outputting raw hidden-states without any specific head on top.
This model inherits from `),_i=a(nu,"A",{href:!0});var s1=s(_i);Yg=i(s1,"PreTrainedModel"),s1.forEach(t),ek=i(nu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),nu.forEach(t),tk=l(Fo),Ha=a(Fo,"P",{});var ou=s(Ha);nk=i(ou,"This model is also a PyTorch "),Ja=a(ou,"A",{href:!0,rel:!0});var r1=s(Ja);ok=i(r1,"torch.nn.Module"),r1.forEach(t),ak=i(ou,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),ou.forEach(t),sk=l(Fo),Oe=a(Fo,"DIV",{class:!0});var St=s(Oe);m(Ka.$$.fragment,St),rk=l(St),pn=a(St,"P",{});var Ni=s(pn);ik=i(Ni,"The "),gi=a(Ni,"A",{href:!0});var i1=s(gi);dk=i(i1,"MBartModel"),i1.forEach(t),lk=i(Ni," forward method, overrides the "),Cl=a(Ni,"CODE",{});var d1=s(Cl);ck=i(d1,"__call__"),d1.forEach(t),pk=i(Ni," special method."),Ni.forEach(t),hk=l(St),m(Yn.$$.fragment,St),uk=l(St),El=a(St,"P",{});var l1=s(El);mk=i(l1,"Example:"),l1.forEach(t),fk=l(St),m(Za.$$.fragment,St),St.forEach(t),Fo.forEach(t),Up=l(n),hn=a(n,"H2",{class:!0});var au=s(hn);eo=a(au,"A",{id:!0,class:!0,href:!0});var c1=s(eo);Pl=a(c1,"SPAN",{});var p1=s(Pl);m(Ya.$$.fragment,p1),p1.forEach(t),c1.forEach(t),_k=l(au),Sl=a(au,"SPAN",{});var h1=s(Sl);gk=i(h1,"MBartForConditionalGeneration"),h1.forEach(t),au.forEach(t),Rp=l(n),Je=a(n,"DIV",{class:!0});var qo=s(Je);m(es.$$.fragment,qo),kk=l(qo),ts=a(qo,"P",{});var su=s(ts);bk=i(su,`The MBART Model with a language modeling head. Can be used for summarization.
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),su.forEach(t),Tk=l(qo),ns=a(qo,"P",{});var ru=s(ns);wk=i(ru,"This model is also a PyTorch "),os=a(ru,"A",{href:!0,rel:!0});var m1=s(os);Mk=i(m1,"torch.nn.Module"),m1.forEach(t),xk=i(ru,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),ru.forEach(t),zk=l(qo),Y=a(qo,"DIV",{class:!0});var Ge=s(Y);m(as.$$.fragment,Ge),Fk=l(Ge),un=a(Ge,"P",{});var Di=s(un);qk=i(Di,"The "),bi=a(Di,"A",{href:!0});var f1=s(bi);$k=i(f1,"MBartForConditionalGeneration"),f1.forEach(t),Bk=i(Di," forward method, overrides the "),Al=a(Di,"CODE",{});var _1=s(Al);jk=i(_1,"__call__"),_1.forEach(t),Ck=i(Di," special method."),Di.forEach(t),Ek=l(Ge),m(to.$$.fragment,Ge),Pk=l(Ge),Ol=a(Ge,"P",{});var g1=s(Ol);Sk=i(g1,"Translation example:"),g1.forEach(t),Ak=l(Ge),m(ss.$$.fragment,Ge),Ok=l(Ge),Il=a(Ge,"P",{});var k1=s(Il);Ik=i(k1,"Mask filling example:"),k1.forEach(t),Nk=l(Ge),m(rs.$$.fragment,Ge),Ge.forEach(t),qo.forEach(t),Xp=l(n),mn=a(n,"H2",{class:!0});var iu=s(mn);no=a(iu,"A",{id:!0,class:!0,href:!0});var b1=s(no);Nl=a(b1,"SPAN",{});var y1=s(Nl);m(is.$$.fragment,y1),y1.forEach(t),b1.forEach(t),Dk=l(iu),Dl=a(iu,"SPAN",{});var v1=s(Dl);Lk=i(v1,"MBartForQuestionAnswering"),v1.forEach(t),iu.forEach(t),Vp=l(n),$e=a(n,"DIV",{class:!0});var At=s($e);m(ds.$$.fragment,At),Gk=l(At),fn=a(At,"P",{});var Li=s(fn);Wk=i(Li,`MBART Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
layer on top of the hidden-states output to compute `),Ll=a(Li,"CODE",{});var T1=s(Ll);Uk=i(T1,"span start logits"),T1.forEach(t),Rk=i(Li," and "),Gl=a(Li,"CODE",{});var w1=s(Gl);Xk=i(w1,"span end logits"),w1.forEach(t),Vk=i(Li,")."),Li.forEach(t),Qk=l(At),ls=a(At,"P",{});var du=s(ls);Hk=i(du,"This model inherits from "),yi=a(du,"A",{href:!0});var M1=s(yi);Jk=i(M1,"PreTrainedModel"),M1.forEach(t),Kk=i(du,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),du.forEach(t),Zk=l(At),cs=a(At,"P",{});var lu=s(cs);Yk=i(lu,"This model is also a PyTorch "),ps=a(lu,"A",{href:!0,rel:!0});var x1=s(ps);eb=i(x1,"torch.nn.Module"),x1.forEach(t),tb=i(lu,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),lu.forEach(t),nb=l(At),ue=a(At,"DIV",{class:!0});var at=s(ue);m(hs.$$.fragment,at),ob=l(at),_n=a(at,"P",{});var Gi=s(_n);ab=i(Gi,"The "),vi=a(Gi,"A",{href:!0});var z1=s(vi);sb=i(z1,"MBartForQuestionAnswering"),z1.forEach(t),rb=i(Gi," forward method, overrides the "),Wl=a(Gi,"CODE",{});var F1=s(Wl);ib=i(F1,"__call__"),F1.forEach(t),db=i(Gi," special method."),Gi.forEach(t),lb=l(at),m(oo.$$.fragment,at),cb=l(at),Ul=a(at,"P",{});var q1=s(Ul);pb=i(q1,"Example:"),q1.forEach(t),hb=l(at),m(us.$$.fragment,at),ub=l(at),m(ms.$$.fragment,at),at.forEach(t),At.forEach(t),Qp=l(n),gn=a(n,"H2",{class:!0});var cu=s(gn);ao=a(cu,"A",{id:!0,class:!0,href:!0});var $1=s(ao);Rl=a($1,"SPAN",{});var B1=s(Rl);m(fs.$$.fragment,B1),B1.forEach(t),$1.forEach(t),mb=l(cu),Xl=a(cu,"SPAN",{});var j1=s(Xl);fb=i(j1,"MBartForSequenceClassification"),j1.forEach(t),cu.forEach(t),Hp=l(n),Be=a(n,"DIV",{class:!0});var Ot=s(Be);m(_s.$$.fragment,Ot),_b=l(Ot),Vl=a(Ot,"P",{});var C1=s(Vl);gb=i(C1,`MBart model with a sequence classification/head on top (a linear layer on top of the pooled output) e.g. for GLUE
tasks.`),C1.forEach(t),kb=l(Ot),gs=a(Ot,"P",{});var pu=s(gs);bb=i(pu,"This model inherits from "),Ti=a(pu,"A",{href:!0});var E1=s(Ti);yb=i(E1,"PreTrainedModel"),E1.forEach(t),vb=i(pu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),pu.forEach(t),Tb=l(Ot),ks=a(Ot,"P",{});var hu=s(ks);wb=i(hu,"This model is also a PyTorch "),bs=a(hu,"A",{href:!0,rel:!0});var P1=s(bs);Mb=i(P1,"torch.nn.Module"),P1.forEach(t),xb=i(hu,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),hu.forEach(t),zb=l(Ot),L=a(Ot,"DIV",{class:!0});var ne=s(L);m(ys.$$.fragment,ne),Fb=l(ne),kn=a(ne,"P",{});var Wi=s(kn);qb=i(Wi,"The "),wi=a(Wi,"A",{href:!0});var S1=s(wi);$b=i(S1,"MBartForSequenceClassification"),S1.forEach(t),Bb=i(Wi," forward method, overrides the "),Ql=a(Wi,"CODE",{});var A1=s(Ql);jb=i(A1,"__call__"),A1.forEach(t),Cb=i(Wi," special method."),Wi.forEach(t),Eb=l(ne),m(so.$$.fragment,ne),Pb=l(ne),Hl=a(ne,"P",{});var O1=s(Hl);Sb=i(O1,"Example of single-label classification:"),O1.forEach(t),Ab=l(ne),m(vs.$$.fragment,ne),Ob=l(ne),m(Ts.$$.fragment,ne),Ib=l(ne),Jl=a(ne,"P",{});var I1=s(Jl);Nb=i(I1,"Example of multi-label classification:"),I1.forEach(t),Db=l(ne),m(ws.$$.fragment,ne),Lb=l(ne),m(Ms.$$.fragment,ne),ne.forEach(t),Ot.forEach(t),Jp=l(n),bn=a(n,"H2",{class:!0});var uu=s(bn);ro=a(uu,"A",{id:!0,class:!0,href:!0});var N1=s(ro);Kl=a(N1,"SPAN",{});var D1=s(Kl);m(xs.$$.fragment,D1),D1.forEach(t),N1.forEach(t),Gb=l(uu),Zl=a(uu,"SPAN",{});var L1=s(Zl);Wb=i(L1,"MBartForCausalLM"),L1.forEach(t),uu.forEach(t),Kp=l(n),yn=a(n,"DIV",{class:!0});var mu=s(yn);m(zs.$$.fragment,mu),Ub=l(mu),Tt=a(mu,"DIV",{class:!0});var Ui=s(Tt);m(Fs.$$.fragment,Ui),Rb=l(Ui),Yl=a(Ui,"P",{});var G1=s(Yl);Xb=i(G1,"Example:"),G1.forEach(t),Vb=l(Ui),m(qs.$$.fragment,Ui),Ui.forEach(t),mu.forEach(t),Zp=l(n),vn=a(n,"H2",{class:!0});var fu=s(vn);io=a(fu,"A",{id:!0,class:!0,href:!0});var W1=s(io);ec=a(W1,"SPAN",{});var U1=s(ec);m($s.$$.fragment,U1),U1.forEach(t),W1.forEach(t),Qb=l(fu),tc=a(fu,"SPAN",{});var R1=s(tc);Hb=i(R1,"TFMBartModel"),R1.forEach(t),fu.forEach(t),Yp=l(n),je=a(n,"DIV",{class:!0});var It=s(je);m(Bs.$$.fragment,It),Jb=l(It),js=a(It,"P",{});var _u=s(js);Kb=i(_u,`The bare MBART Model outputting raw hidden-states without any specific head on top.
This model inherits from `),Mi=a(_u,"A",{href:!0});var X1=s(Mi);Zb=i(X1,"TFPreTrainedModel"),X1.forEach(t),Yb=i(_u,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),_u.forEach(t),ey=l(It),Cs=a(It,"P",{});var gu=s(Cs);ty=i(gu,"This model is also a "),Es=a(gu,"A",{href:!0,rel:!0});var V1=s(Es);ny=i(V1,"tf.keras.Model"),V1.forEach(t),oy=i(gu,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),gu.forEach(t),ay=l(It),m(lo.$$.fragment,It),sy=l(It),Ie=a(It,"DIV",{class:!0});var Nt=s(Ie);m(Ps.$$.fragment,Nt),ry=l(Nt),Tn=a(Nt,"P",{});var Ri=s(Tn);iy=i(Ri,"The "),xi=a(Ri,"A",{href:!0});var Q1=s(xi);dy=i(Q1,"TFMBartModel"),Q1.forEach(t),ly=i(Ri," forward method, overrides the "),nc=a(Ri,"CODE",{});var H1=s(nc);cy=i(H1,"__call__"),H1.forEach(t),py=i(Ri," special method."),Ri.forEach(t),hy=l(Nt),m(co.$$.fragment,Nt),uy=l(Nt),oc=a(Nt,"P",{});var J1=s(oc);my=i(J1,"Example:"),J1.forEach(t),fy=l(Nt),m(Ss.$$.fragment,Nt),Nt.forEach(t),It.forEach(t),eh=l(n),wn=a(n,"H2",{class:!0});var ku=s(wn);po=a(ku,"A",{id:!0,class:!0,href:!0});var K1=s(po);ac=a(K1,"SPAN",{});var Z1=s(ac);m(As.$$.fragment,Z1),Z1.forEach(t),K1.forEach(t),_y=l(ku),sc=a(ku,"SPAN",{});var Y1=s(sc);gy=i(Y1,"TFMBartForConditionalGeneration"),Y1.forEach(t),ku.forEach(t),th=l(n),Ce=a(n,"DIV",{class:!0});var Dt=s(Ce);m(Os.$$.fragment,Dt),ky=l(Dt),Is=a(Dt,"P",{});var bu=s(Is);by=i(bu,`The MBART Model with a language modeling head. Can be used for summarization.
