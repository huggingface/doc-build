...
`),j=s(ye,"CODE",{});var D=a(j);Ee=i(D,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),D.forEach(t),ye.forEach(t),P.forEach(t)},m(m,E){f(m,h,E),e(h,M),f(m,u,E),f(m,g,E),e(g,$),e($,_),e(g,T),e(g,X),e(X,I),f(m,W,E),f(m,x,E),e(x,C),e(x,O),e(O,K),e(x,ae),e(x,B),e(B,$e),e(x,ge),f(m,U,E),f(m,N,E),e(N,ne),f(m,re,E),f(m,F,E),e(F,z),e(z,ie),e(z,Q),e(Q,_e),e(z,le),e(z,V),e(V,xe),e(F,Te),e(F,q),e(q,Xe),e(q,G),e(G,oe),e(q,fe),e(q,Z),e(Z,Me),e(F,me),e(F,A),e(A,ve),e(A,j),e(j,Ee)},d(m){m&&t(h),m&&t(u),m&&t(g),m&&t(W),m&&t(x),m&&t(U),m&&t(N),m&&t(re),m&&t(F)}}}function Wf(R){let h,M,u,g,$;return{c(){h=n("p"),M=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),u=n("code"),g=r("Module"),$=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(_){h=s(_,"P",{});var T=a(h);M=i(T,"Although the recipe for forward pass needs to be defined within this function, one should call the "),u=s(T,"CODE",{});var X=a(u);g=i(X,"Module"),X.forEach(t),$=i(T,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),T.forEach(t)},m(_,T){f(_,h,T),e(h,M),e(h,u),e(u,g),e(h,$)},d(_){_&&t(h)}}}function Bf(R){let h,M,u,g,$,_,T,X,I,W,x,C,O,K,ae,B,$e,ge,U,N,ne,re,F,z,ie,Q,_e,le,V,xe,Te,q,Xe,G,oe,fe,Z,Me,me,A,ve,j,Ee;return{c(){h=n("p"),M=r("TF 2.0 models accepts two formats as inputs:"),u=l(),g=n("ul"),$=n("li"),_=r("having all inputs as keyword arguments (like PyTorch models), or"),T=l(),X=n("li"),I=r("having all inputs as a list, tuple or dict in the first positional arguments."),W=l(),x=n("p"),C=r("This second option is useful when using "),O=n("code"),K=r("tf.keras.Model.fit"),ae=r(` method which currently requires having all the
tensors in the first argument of the model call function: `),B=n("code"),$e=r("model(inputs)"),ge=r("."),U=l(),N=n("p"),ne=r(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),re=l(),F=n("ul"),z=n("li"),ie=r("a single Tensor with "),Q=n("code"),_e=r("input_ids"),le=r(" only and nothing else: "),V=n("code"),xe=r("model(inputs_ids)"),Te=l(),q=n("li"),Xe=r(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),G=n("code"),oe=r("model([input_ids, attention_mask])"),fe=r(" or "),Z=n("code"),Me=r("model([input_ids, attention_mask, token_type_ids])"),me=l(),A=n("li"),ve=r(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),j=n("code"),Ee=r('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(m){h=s(m,"P",{});var E=a(h);M=i(E,"TF 2.0 models accepts two formats as inputs:"),E.forEach(t),u=d(m),g=s(m,"UL",{});var de=a(g);$=s(de,"LI",{});var be=a($);_=i(be,"having all inputs as keyword arguments (like PyTorch models), or"),be.forEach(t),T=d(de),X=s(de,"LI",{});var Be=a(X);I=i(Be,"having all inputs as a list, tuple or dict in the first positional arguments."),Be.forEach(t),de.forEach(t),W=d(m),x=s(m,"P",{});var H=a(x);C=i(H,"This second option is useful when using "),O=s(H,"CODE",{});var Ae=a(O);K=i(Ae,"tf.keras.Model.fit"),Ae.forEach(t),ae=i(H,` method which currently requires having all the
...
first positional argument :`),He.forEach(t),re=d(m),F=s(m,"UL",{});var P=a(F);z=s(P,"LI",{});var S=a(z);ie=i(S,"a single Tensor with "),Q=s(S,"CODE",{});var ze=a(Q);_e=i(ze,"input_ids"),ze.forEach(t),le=i(S," only and nothing else: "),V=s(S,"CODE",{});var we=a(V);xe=i(we,"model(inputs_ids)"),we.forEach(t),S.forEach(t),Te=d(P),q=s(P,"LI",{});var J=a(q);Xe=i(J,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),G=s(J,"CODE",{});var Ce=a(G);oe=i(Ce,"model([input_ids, attention_mask])"),Ce.forEach(t),fe=i(J," or "),Z=s(J,"CODE",{});var Ue=a(Z);Me=i(Ue,"model([input_ids, attention_mask, token_type_ids])"),Ue.forEach(t),J.forEach(t),me=d(P),A=s(P,"LI",{});var ye=a(A);ve=i(ye,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),j=s(ye,"CODE",{});var D=a(j);Ee=i(D,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),D.forEach(t),ye.forEach(t),P.forEach(t)},m(m,E){f(m,h,E),e(h,M),f(m,u,E),f(m,g,E),e(g,$),e($,_),e(g,T),e(g,X),e(X,I),f(m,W,E),f(m,x,E),e(x,C),e(x,O),e(O,K),e(x,ae),e(x,B),e(B,$e),e(x,ge),f(m,U,E),f(m,N,E),e(N,ne),f(m,re,E),f(m,F,E),e(F,z),e(z,ie),e(z,Q),e(Q,_e),e(z,le),e(z,V),e(V,xe),e(F,Te),e(F,q),e(q,Xe),e(q,G),e(G,oe),e(q,fe),e(q,Z),e(Z,Me),e(F,me),e(F,A),e(A,ve),e(A,j),e(j,Ee)},d(m){m&&t(h),m&&t(u),m&&t(g),m&&t(W),m&&t(x),m&&t(U),m&&t(N),m&&t(re),m&&t(F)}}}function Uf(R){let h,M,u,g,$;return{c(){h=n("p"),M=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),u=n("code"),g=r("Module"),$=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(_){h=s(_,"P",{});var T=a(h);M=i(T,"Although the recipe for forward pass needs to be defined within this function, one should call the "),u=s(T,"CODE",{});var X=a(u);g=i(X,"Module"),X.forEach(t),$=i(T,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),T.forEach(t)},m(_,T){f(_,h,T),e(h,M),e(h,u),e(u,g),e(h,$)},d(_){_&&t(h)}}}function Vf(R){let h,M,u,g,$,_,T,X,I,W,x,C,O,K,ae,B,$e,ge,U,N,ne,re,F,z,ie,Q,_e,le,V,xe,Te,q,Xe,G,oe,fe,Z,Me,me,A,ve,j,Ee;return{c(){h=n("p"),M=r("TF 2.0 models accepts two formats as inputs:"),u=l(),g=n("ul"),$=n("li"),_=r("having all inputs as keyword arguments (like PyTorch models), or"),T=l(),X=n("li"),I=r("having all inputs as a list, tuple or dict in the first positional arguments."),W=l(),x=n("p"),C=r("This second option is useful when using "),O=n("code"),K=r("tf.keras.Model.fit"),ae=r(` method which currently requires having all the
tensors in the first argument of the model call function: `),B=n("code"),$e=r("model(inputs)"),ge=r("."),U=l(),N=n("p"),ne=r(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),re=l(),F=n("ul"),z=n("li"),ie=r("a single Tensor with "),Q=n("code"),_e=r("input_ids"),le=r(" only and nothing else: "),V=n("code"),xe=r("model(inputs_ids)"),Te=l(),q=n("li"),Xe=r(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),G=n("code"),oe=r("model([input_ids, attention_mask])"),fe=r(" or "),Z=n("code"),Me=r("model([input_ids, attention_mask, token_type_ids])"),me=l(),A=n("li"),ve=r(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),j=n("code"),Ee=r('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(m){h=s(m,"P",{});var E=a(h);M=i(E,"TF 2.0 models accepts two formats as inputs:"),E.forEach(t),u=d(m),g=s(m,"UL",{});var de=a(g);$=s(de,"LI",{});var be=a($);_=i(be,"having all inputs as keyword arguments (like PyTorch models), or"),be.forEach(t),T=d(de),X=s(de,"LI",{});var Be=a(X);I=i(Be,"having all inputs as a list, tuple or dict in the first positional arguments."),Be.forEach(t),de.forEach(t),W=d(m),x=s(m,"P",{});var H=a(x);C=i(H,"This second option is useful when using "),O=s(H,"CODE",{});var Ae=a(O);K=i(Ae,"tf.keras.Model.fit"),Ae.forEach(t),ae=i(H,` method which currently requires having all the
...
first positional argument :`),He.forEach(t),re=d(m),F=s(m,"UL",{});var P=a(F);z=s(P,"LI",{});var S=a(z);ie=i(S,"a single Tensor with "),Q=s(S,"CODE",{});var ze=a(Q);_e=i(ze,"input_ids"),ze.forEach(t),le=i(S," only and nothing else: "),V=s(S,"CODE",{});var we=a(V);xe=i(we,"model(inputs_ids)"),we.forEach(t),S.forEach(t),Te=d(P),q=s(P,"LI",{});var J=a(q);Xe=i(J,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),G=s(J,"CODE",{});var Ce=a(G);oe=i(Ce,"model([input_ids, attention_mask])"),Ce.forEach(t),fe=i(J," or "),Z=s(J,"CODE",{});var Ue=a(Z);Me=i(Ue,"model([input_ids, attention_mask, token_type_ids])"),Ue.forEach(t),J.forEach(t),me=d(P),A=s(P,"LI",{});var ye=a(A);ve=i(ye,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),j=s(ye,"CODE",{});var D=a(j);Ee=i(D,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),D.forEach(t),ye.forEach(t),P.forEach(t)},m(m,E){f(m,h,E),e(h,M),f(m,u,E),f(m,g,E),e(g,$),e($,_),e(g,T),e(g,X),e(X,I),f(m,W,E),f(m,x,E),e(x,C),e(x,O),e(O,K),e(x,ae),e(x,B),e(B,$e),e(x,ge),f(m,U,E),f(m,N,E),e(N,ne),f(m,re,E),f(m,F,E),e(F,z),e(z,ie),e(z,Q),e(Q,_e),e(z,le),e(z,V),e(V,xe),e(F,Te),e(F,q),e(q,Xe),e(q,G),e(G,oe),e(q,fe),e(q,Z),e(Z,Me),e(F,me),e(F,A),e(A,ve),e(A,j),e(j,Ee)},d(m){m&&t(h),m&&t(u),m&&t(g),m&&t(W),m&&t(x),m&&t(U),m&&t(N),m&&t(re),m&&t(F)}}}function Rf(R){let h,M,u,g,$;return{c(){h=n("p"),M=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),u=n("code"),g=r("Module"),$=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(_){h=s(_,"P",{});var T=a(h);M=i(T,"Although the recipe for forward pass needs to be defined within this function, one should call the "),u=s(T,"CODE",{});var X=a(u);g=i(X,"Module"),X.forEach(t),$=i(T,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),T.forEach(t)},m(_,T){f(_,h,T),e(h,M),e(h,u),e(u,g),e(h,$)},d(_){_&&t(h)}}}function Kf(R){let h,M,u,g,$,_,T,X,I,W,x,C,O,K,ae,B,$e,ge,U,N,ne,re,F,z,ie,Q,_e,le,V,xe,Te,q,Xe,G,oe,fe,Z,Me,me,A,ve,j,Ee,m,E,de,be,Be,H,Ae,he,He,P,S,ze,we,J,Ce,Ue,ye,D,Kt,Da,Ye,Ia,cn,Wa,Ba,fn,Ua,Va,Gt,Ra,Ka,Ga,lt,Ya,mn,Qa,Za,hn,Ja,er,tr,Hn,or,nr,Yt,Ws,dt,Mt,Dn,Qt,sr,In,ar,Bs,De,Zt,rr,Jt,ir,eo,lr,dr,cr,to,fr,pn,mr,hr,pr,un,oo,Us,ct,Et,Wn,no,ur,Bn,gr,Vs,ft,so,_r,Un,Tr,Rs,mt,ao,vr,Vn,br,Ks,ht,ro,wr,Rn,yr,Gs,pt,io,kr,Kn,Lr,Ys,ut,Ft,Gn,lo,$r,Yn,xr,Qs,Fe,co,Xr,Qn,Mr,Er,fo,Fr,gn,qr,zr,Cr,mo,Pr,ho,jr,Or,Sr,Pe,po,Nr,gt,Ar,_n,Hr,Dr,Zn,Ir,Wr,Br,qt,Ur,Jn,Vr,Rr,uo,Zs,_t,zt,es,go,Kr,ts,Gr,Js,qe,_o,Yr,os,Qr,Zr,To,Jr,Tn,ei,ti,oi,vo,ni,bo,si,ai,ri,je,wo,ii,Tt,li,vn,di,ci,ns,fi,mi,hi,Ct,pi,ss,ui,gi,yo,ea,vt,Pt,as,ko,_i,rs,Ti,ta,se,Lo,vi,is,bi,wi,bn,wn,yi,ki,Li,Ie,$i,ls,xi,Xi,ds,Mi,Ei,cs,Fi,qi,fs,zi,Ci,Pi,$o,ji,yn,Oi,Si,Ni,xo,Ai,Xo,Hi,Di,Ii,Y,Mo,Wi,bt,Bi,kn,Ui,Vi,ms,Ri,Ki,Gi,jt,Yi,hs,Qi,Zi,Eo,Ji,Fo,el,ps,tl,ol,qo,nl,zo,oa,wt,Ot,us,Co,sl,gs,al,na,pe,Po,rl,_s,il,ll,jo,dl,Ln,cl,fl,ml,Oo,hl,So,pl,ul,gl,St,_l,Oe,No,Tl,yt,vl,$n,bl,wl,Ts,yl,kl,Ll,Nt,$l,vs,xl,Xl,Ao,sa,kt,At,bs,Ho,Ml,ws,El,aa,ue,Do,Fl,ys,ql,zl,Io,Cl,xn,Pl,jl,Ol,Wo,Sl,Bo,Nl,Al,Hl,Ht,Dl,Se,Uo,Il,Lt,Wl,Xn,Bl,Ul,ks,Vl,Rl,Kl,Dt,Gl,Ls,Yl,Ql,Vo,ra,$t,It,$s,Ro,Zl,xs,Jl,ia,ee,Ko,ed,Xs,td,od,Mn,En,nd,sd,ad,We,rd,Ms,id,ld,Es,dd,cd,Fs,fd,md,qs,hd,pd,ud,Go,gd,Fn,_d,Td,vd,Yo,bd,Qo,wd,yd,kd,Wt,Ld,ke,Zo,$d,xt,xd,qn,Xd,Md,zs,Ed,Fd,qd,Bt,zd,Cs,Cd,Pd,Jo,jd,en,la,Xt,Ut,Ps,tn,Od,js,Sd,da,on,nn,ca,sn,an,fa;return _=new Ge({}),K=new Ge({}),he=new it({props:{warning:!0,$$slots:{default:[Nf]},$$scope:{ctx:R}}}),we=new Ge({}),Kt=new te({props:{name:"class transformers.TransfoXLConfig",anchor:"transformers.TransfoXLConfig",parameters:[{name:"vocab_size",val:" = 267735"},{name:"cutoffs",val:" = [20000, 40000, 200000]"},{name:"d_model",val:" = 1024"},{name:"d_embed",val:" = 1024"},{name:"n_head",val:" = 16"},{name:"d_head",val:" = 64"},{name:"d_inner",val:" = 4096"},{name:"div_val",val:" = 4"},{name:"pre_lnorm",val:" = False"},{name:"n_layer",val:" = 18"},{name:"mem_len",val:" = 1600"},{name:"clamp_len",val:" = 1000"},{name:"same_length",val:" = True"},{name:"proj_share_all_but_first",val:" = True"},{name:"attn_type",val:" = 0"},{name:"sample_softmax",val:" = -1"},{name:"adaptive",val:" = True"},{name:"dropout",val:" = 0.1"},{name:"dropatt",val:" = 0.0"},{name:"untie_r",val:" = True"},{name:"init",val:" = 'normal'"},{name:"init_range",val:" = 0.01"},{name:"proj_init_std",val:" = 0.01"},{name:"init_std",val:" = 0.02"},{name:"layer_norm_epsilon",val:" = 1e-05"},{name:"eos_token_id",val:" = 0"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/transfo_xl/configuration_transfo_xl.py#L29",parametersDescription:[{anchor:"transformers.TransfoXLConfig.vocab_size",description:`<strong>vocab_size</strong> (<code>int</code>, <em>optional</em>, defaults to 267735) &#x2014;
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/main/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),Ht=new it({props:{$$slots:{default:[Bf]},$$scope:{ctx:R}}}),Uo=new te({props:{name:"call",anchor:"transformers.TFTransfoXLLMHeadModel.call",parameters:[{name:"input_ids",val:" = None"},{name:"mems",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"},{name:"labels",val:" = None"},{name:"training",val:" = False"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/transfo_xl/modeling_tf_transfo_xl.py#L963",parametersDescription:[{anchor:"transformers.TFTransfoXLLMHeadModel.call.input_ids",description:`<strong>input_ids</strong> (<code>tf.Tensor</code> or <code>Numpy array</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/main/en/model_doc/bert#transformers.BertTokenizer">BertTokenizer</a>. See <a href="/docs/transformers/main/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
<a href="/docs/transformers/main/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> for details.</p>
...
documentation from `),hn=n("a"),Ja=r("PretrainedConfig"),er=r(" for more information."),tr=l(),Hn=n("p"),or=r("Examples:"),nr=l(),v(Yt.$$.fragment),Ws=l(),dt=n("h2"),Mt=n("a"),Dn=n("span"),v(Qt.$$.fragment),sr=l(),In=n("span"),ar=r("TransfoXLTokenizer"),Bs=l(),De=n("div"),v(Zt.$$.fragment),rr=l(),Jt=n("p"),ir=r("Construct a Transformer-XL tokenizer adapted from Vocab class in "),eo=n("a"),lr=r(`the original
...
this superclass for more information regarding those methods.`),pr=l(),un=n("div"),v(oo.$$.fragment),Us=l(),ct=n("h2"),Et=n("a"),Wn=n("span"),v(no.$$.fragment),ur=l(),Bn=n("span"),gr=r("TransfoXL specific outputs"),Vs=l(),ft=n("div"),v(so.$$.fragment),_r=l(),Un=n("p"),Tr=r("Base class for model\u2019s outputs that may also contain a past key/values (to speed up sequential decoding)."),Rs=l(),mt=n("div"),v(ao.$$.fragment),vr=l(),Vn=n("p"),br=r("Base class for model\u2019s outputs that may also contain a past key/values (to speed up sequential decoding)."),Ks=l(),ht=n("div"),v(ro.$$.fragment),wr=l(),Rn=n("p"),yr=r("Base class for model\u2019s outputs that may also contain a past key/values (to speed up sequential decoding)."),Gs=l(),pt=n("div"),v(io.$$.fragment),kr=l(),Kn=n("p"),Lr=r("Base class for model\u2019s outputs that may also contain a past key/values (to speed up sequential decoding)."),Ys=l(),ut=n("h2"),Ft=n("a"),Gn=n("span"),v(lo.$$.fragment),$r=l(),Yn=n("span"),xr=r("TransfoXLModel"),Qs=l(),Fe=n("div"),v(co.$$.fragment),Xr=l(),Qn=n("p"),Mr=r("The bare Bert Model transformer outputting raw hidden-states without any specific head on top."),Er=l(),fo=n("p"),Fr=r("This model inherits from "),gn=n("a"),qr=r("PreTrainedModel"),zr=r(`. Check the superclass documentation for the generic methods the
...
and behavior.`),Sr=l(),Pe=n("div"),v(po.$$.fragment),Nr=l(),gt=n("p"),Ar=r("The "),_n=n("a"),Hr=r("TransfoXLModel"),Dr=r(" forward method, overrides the "),Zn=n("code"),Ir=r("__call__"),Wr=r(" special method."),Br=l(),v(qt.$$.fragment),Ur=l(),Jn=n("p"),Vr=r("Example:"),Rr=l(),v(uo.$$.fragment),Zs=l(),_t=n("h2"),zt=n("a"),es=n("span"),v(go.$$.fragment),Kr=l(),ts=n("span"),Gr=r("TransfoXLLMHeadModel"),Js=l(),qe=n("div"),v(_o.$$.fragment),Yr=l(),os=n("p"),Qr=r(`The Transformer-XL Model with a language modeling head on top (adaptive softmax with weights tied to the adaptive
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Ii=l(),Y=n("div"),v(Mo.$$.fragment),Wi=l(),bt=n("p"),Bi=r("The "),kn=n("a"),Ui=r("TransfoXLForSequenceClassification"),Vi=r(" forward method, overrides the "),ms=n("code"),Ri=r("__call__"),Ki=r(" special method."),Gi=l(),v(jt.$$.fragment),Yi=l(),hs=n("p"),Qi=r("Example of single-label classification:"),Zi=l(),v(Eo.$$.fragment),Ji=l(),v(Fo.$$.fragment),el=l(),ps=n("p"),tl=r("Example of multi-label classification:"),ol=l(),v(qo.$$.fragment),nl=l(),v(zo.$$.fragment),oa=l(),wt=n("h2"),Ot=n("a"),us=n("span"),v(Co.$$.fragment),sl=l(),gs=n("span"),al=r("TFTransfoXLModel"),na=l(),pe=n("div"),v(Po.$$.fragment),rl=l(),_s=n("p"),il=r("The bare Bert Model transformer outputting raw hidden-states without any specific head on top."),ll=l(),jo=n("p"),dl=r("This model inherits from "),Ln=n("a"),cl=r("TFPreTrainedModel"),fl=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
bpc/perplexity to 0.99 on enwiki8, 1.08 on text8, 18.3 on WikiText-103, 21.8 on One Billion Word, and 54.5 on Penn
Treebank (without finetuning). When trained only on WikiText-103, Transformer-XL manages to generate reasonably
coherent, novel text articles with thousands of tokens.`),Id.forEach(t),Dd.forEach(t),Te=d(o),q=s(o,"P",{});var Wd=a(q);Xe=i(Wd,"Tips:"),Wd.forEach(t),G=d(o),oe=s(o,"UL",{});var ma=a(oe);fe=s(ma,"LI",{});var Bd=a(fe);Z=i(Bd,`Transformer-XL uses relative sinusoidal positional embeddings. Padding can be done on the left or on the right. The
original implementation trains on SQuAD with padding on the left, therefore the padding defaults are set to left.`),Bd.forEach(t),Me=d(ma),me=s(ma,"LI",{});var Ud=a(me);A=i(Ud,"Transformer-XL is one of the few models that has no sequence length limit."),Ud.forEach(t),ma.forEach(t),ve=d(o),j=s(o,"P",{});var zn=a(j);Ee=i(zn,"This model was contributed by "),m=s(zn,"A",{href:!0,rel:!0});var Vd=a(m);E=i(Vd,"thomwolf"),Vd.forEach(t),de=i(zn,". The original code can be found "),be=s(zn,"A",{href:!0,rel:!0});var Rd=a(be);Be=i(Rd,"here"),Rd.forEach(t),H=i(zn,"."),zn.forEach(t),Ae=d(o),b(he.$$.fragment,o),He=d(o),P=s(o,"H2",{class:!0});var ha=a(P);S=s(ha,"A",{id:!0,class:!0,href:!0});var Kd=a(S);ze=s(Kd,"SPAN",{});var Gd=a(ze);b(we.$$.fragment,Gd),Gd.forEach(t),Kd.forEach(t),J=d(ha),Ce=s(ha,"SPAN",{});var Yd=a(Ce);Ue=i(Yd,"TransfoXLConfig"),Yd.forEach(t),ha.forEach(t),ye=d(o),D=s(o,"DIV",{class:!0});var Ze=a(D);b(Kt.$$.fragment,Ze),Da=d(Ze),Ye=s(Ze,"P",{});var Vt=a(Ye);Ia=i(Vt,"This is the configuration class to store the configuration of a "),cn=s(Vt,"A",{href:!0});var Qd=a(cn);Wa=i(Qd,"TransfoXLModel"),Qd.forEach(t),Ba=i(Vt," or a "),fn=s(Vt,"A",{href:!0});var Zd=a(fn);Ua=i(Zd,"TFTransfoXLModel"),Zd.forEach(t),Va=i(Vt,`. It is
used to instantiate a Transformer-XL model according to the specified arguments, defining the model architecture.
...
this superclass for more information regarding those methods.`),ga.forEach(t),pr=d(Rt),un=s(Rt,"DIV",{class:!0});var lc=a(un);b(oo.$$.fragment,lc),lc.forEach(t),Rt.forEach(t),Us=d(o),ct=s(o,"H2",{class:!0});var _a=a(ct);Et=s(_a,"A",{id:!0,class:!0,href:!0});var dc=a(Et);Wn=s(dc,"SPAN",{});var cc=a(Wn);b(no.$$.fragment,cc),cc.forEach(t),dc.forEach(t),ur=d(_a),Bn=s(_a,"SPAN",{});var fc=a(Bn);gr=i(fc,"TransfoXL specific outputs"),fc.forEach(t),_a.forEach(t),Vs=d(o),ft=s(o,"DIV",{class:!0});var Ta=a(ft);b(so.$$.fragment,Ta),_r=d(Ta),Un=s(Ta,"P",{});var mc=a(Un);Tr=i(mc,"Base class for model\u2019s outputs that may also contain a past key/values (to speed up sequential decoding)."),mc.forEach(t),Ta.forEach(t),Rs=d(o),mt=s(o,"DIV",{class:!0});var va=a(mt);b(ao.$$.fragment,va),vr=d(va),Vn=s(va,"P",{});var hc=a(Vn);br=i(hc,"Base class for model\u2019s outputs that may also contain a past key/values (to speed up sequential decoding)."),hc.forEach(t),va.forEach(t),Ks=d(o),ht=s(o,"DIV",{class:!0});var ba=a(ht);b(ro.$$.fragment,ba),wr=d(ba),Rn=s(ba,"P",{});var pc=a(Rn);yr=i(pc,"Base class for model\u2019s outputs that may also contain a past key/values (to speed up sequential decoding)."),pc.forEach(t),ba.forEach(t),Gs=d(o),pt=s(o,"DIV",{class:!0});var wa=a(pt);b(io.$$.fragment,wa),kr=d(wa),Kn=s(wa,"P",{});var uc=a(Kn);Lr=i(uc,"Base class for model\u2019s outputs that may also contain a past key/values (to speed up sequential decoding)."),uc.forEach(t),wa.forEach(t),Ys=d(o),ut=s(o,"H2",{class:!0});var ya=a(ut);Ft=s(ya,"A",{id:!0,class:!0,href:!0});var gc=a(Ft);Gn=s(gc,"SPAN",{});var _c=a(Gn);b(lo.$$.fragment,_c),_c.forEach(t),gc.forEach(t),$r=d(ya),Yn=s(ya,"SPAN",{});var Tc=a(Yn);xr=i(Tc,"TransfoXLModel"),Tc.forEach(t),ya.forEach(t),Qs=d(o),Fe=s(o,"DIV",{class:!0});var Je=a(Fe);b(co.$$.fragment,Je),Xr=d(Je),Qn=s(Je,"P",{});var vc=a(Qn);Mr=i(vc,"The bare Bert Model transformer outputting raw hidden-states without any specific head on top."),vc.forEach(t),Er=d(Je),fo=s(Je,"P",{});var ka=a(fo);Fr=i(ka,"This model inherits from "),gn=s(ka,"A",{href:!0});var bc=a(gn);qr=i(bc,"PreTrainedModel"),bc.forEach(t),zr=i(ka,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),ka.forEach(t),Cr=d(Je),mo=s(Je,"P",{});var La=a(mo);Pr=i(La,"This model is also a PyTorch "),ho=s(La,"A",{href:!0,rel:!0});var wc=a(ho);jr=i(wc,"torch.nn.Module"),wc.forEach(t),Or=i(La,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Fa.forEach(t),Ii=d(Ne),Y=s(Ne,"DIV",{class:!0});var ce=a(Y);b(Mo.$$.fragment,ce),Wi=d(ce),bt=s(ce,"P",{});var On=a(bt);Bi=i(On,"The "),kn=s(On,"A",{href:!0});var Uc=a(kn);Ui=i(Uc,"TransfoXLForSequenceClassification"),Uc.forEach(t),Vi=i(On," forward method, overrides the "),ms=s(On,"CODE",{});var Vc=a(ms);Ri=i(Vc,"__call__"),Vc.forEach(t),Ki=i(On," special method."),On.forEach(t),Gi=d(ce),b(jt.$$.fragment,ce),Yi=d(ce),hs=s(ce,"P",{});var Rc=a(hs);Qi=i(Rc,"Example of single-label classification:"),Rc.forEach(t),Zi=d(ce),b(Eo.$$.fragment,ce),Ji=d(ce),b(Fo.$$.fragment,ce),el=d(ce),ps=s(ce,"P",{});var Kc=a(ps);tl=i(Kc,"Example of multi-label classification:"),Kc.forEach(t),ol=d(ce),b(qo.$$.fragment,ce),nl=d(ce),b(zo.$$.fragment,ce),ce.forEach(t),Ne.forEach(t),oa=d(o),wt=s(o,"H2",{class:!0});var qa=a(wt);Ot=s(qa,"A",{id:!0,class:!0,href:!0});var Gc=a(Ot);us=s(Gc,"SPAN",{});var Yc=a(us);b(Co.$$.fragment,Yc),Yc.forEach(t),Gc.forEach(t),sl=d(qa),gs=s(qa,"SPAN",{});var Qc=a(gs);al=i(Qc,"TFTransfoXLModel"),Qc.forEach(t),qa.forEach(t),na=d(o),pe=s(o,"DIV",{class:!0});var Ve=a(pe);b(Po.$$.fragment,Ve),rl=d(Ve),_s=s(Ve,"P",{});var Zc=a(_s);il=i(Zc,"The bare Bert Model transformer outputting raw hidden-states without any specific head on top."),Zc.forEach(t),ll=d(Ve),jo=s(Ve,"P",{});var za=a(jo);dl=i(za,"This model inherits from "),Ln=s(za,"A",{href:!0});var Jc=a(Ln);cl=i(Jc,"TFPreTrainedModel"),Jc.forEach(t),fl=i(za,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),za.forEach(t),ml=d(Ve),Oo=s(Ve,"P",{});var Ca=a(Oo);hl=i(Ca,"This model is also a "),So=s(Ca,"A",{href:!0,rel:!0});var ef=a(So);pl=i(ef,"tf.keras.Model"),ef.forEach(t),ul=i(Ca,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
