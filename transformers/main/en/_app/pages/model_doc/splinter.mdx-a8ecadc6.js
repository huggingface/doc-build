import{S as mi,i as ui,s as fi,e as o,k as d,w as u,t as a,M as gi,c as s,d as n,m as c,a as r,x as f,h as i,b as l,F as e,g as h,y as g,q as _,o as k,B as v,v as _i}from"../../chunks/vendor-6b77c823.js";import{T as hi}from"../../chunks/Tip-39098574.js";import{D as O}from"../../chunks/Docstring-90e3aa51.js";import{C as so}from"../../chunks/CodeBlock-3a8b25a8.js";import{I as lt}from"../../chunks/IconCopyLink-7a11ce68.js";function ki(dt){let m,C,w,S,E;return{c(){m=o("p"),C=a("Although the recipe for forward pass needs to be defined within this function, one should call the "),w=o("code"),S=a("Module"),E=a(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(b){m=s(b,"P",{});var T=r(m);C=i(T,"Although the recipe for forward pass needs to be defined within this function, one should call the "),w=s(T,"CODE",{});var N=r(w);S=i(N,"Module"),N.forEach(n),E=i(T,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),T.forEach(n)},m(b,T){h(b,m,T),e(m,C),e(m,w),e(w,S),e(m,E)},d(b){b&&n(m)}}}function vi(dt){let m,C,w,S,E;return{c(){m=o("p"),C=a("Although the recipe for forward pass needs to be defined within this function, one should call the "),w=o("code"),S=a("Module"),E=a(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(b){m=s(b,"P",{});var T=r(m);C=i(T,"Although the recipe for forward pass needs to be defined within this function, one should call the "),w=s(T,"CODE",{});var N=r(w);S=i(N,"Module"),N.forEach(n),E=i(T,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),T.forEach(n)},m(b,T){h(b,m,T),e(m,C),e(m,w),e(w,S),e(m,E)},d(b){b&&n(m)}}}function wi(dt){let m,C,w,S,E,b,T,N,ro,bn,J,se,Ot,we,ao,Nt,io,yn,re,lo,be,co,po,Tn,ct,ho,Sn,pt,mo,zn,ht,uo,qn,I,ye,fo,mt,go,_o,ko,j,vo,ut,wo,bo,ft,yo,To,jt,So,zo,qo,Te,$o,Qt,xo,Eo,Ao,A,Po,Wt,Fo,Mo,Ut,Co,Io,Bt,Lo,Do,Ht,Oo,No,$n,L,jo,Se,Qo,Wo,ze,Uo,Bo,qe,Ho,Vo,xn,K,ae,Vt,$e,Jo,Jt,Ko,En,q,xe,Ro,R,Go,gt,Xo,Yo,Ee,Zo,es,ts,G,ns,_t,os,ss,kt,rs,as,is,Kt,ls,ds,Ae,An,X,ie,Rt,Pe,cs,Gt,ps,Pn,y,Fe,hs,Xt,ms,us,Me,fs,vt,gs,_s,ks,Q,Ce,vs,Yt,ws,bs,Ie,wt,ys,Zt,Ts,Ss,bt,zs,en,qs,$s,le,Le,xs,De,Es,tn,As,Ps,Fs,W,Oe,Ms,yt,Cs,Tt,Is,Ls,nn,Ds,Os,St,Ne,Fn,Y,de,on,je,Ns,sn,js,Mn,P,Qe,Qs,We,Ws,rn,Us,Bs,Hs,Ue,Vs,zt,Js,Ks,Rs,U,Be,Gs,an,Xs,Ys,He,qt,Zs,ln,er,tr,$t,nr,dn,or,Cn,Z,ce,cn,Ve,sr,pn,rr,In,F,Je,ar,Ke,ir,Re,lr,dr,cr,Ge,pr,Xe,hr,mr,ur,$,Ye,fr,ee,gr,xt,_r,kr,hn,vr,wr,br,pe,yr,mn,Tr,Sr,Ze,Ln,te,he,un,et,zr,fn,qr,Dn,M,tt,$r,ne,xr,gn,Er,Ar,_n,Pr,Fr,Mr,nt,Cr,ot,Ir,Lr,Dr,z,st,Or,oe,Nr,Et,jr,Qr,kn,Wr,Ur,Br,me,Hr,vn,Vr,Jr,rt,Kr,at,On;return b=new lt({}),we=new lt({}),$e=new lt({}),xe=new O({props:{name:"class transformers.SplinterConfig",anchor:"transformers.SplinterConfig",parameters:[{name:"vocab_size",val:" = 30522"},{name:"hidden_size",val:" = 768"},{name:"num_hidden_layers",val:" = 12"},{name:"num_attention_heads",val:" = 12"},{name:"intermediate_size",val:" = 3072"},{name:"hidden_act",val:" = 'gelu'"},{name:"hidden_dropout_prob",val:" = 0.1"},{name:"attention_probs_dropout_prob",val:" = 0.1"},{name:"max_position_embeddings",val:" = 512"},{name:"type_vocab_size",val:" = 2"},{name:"initializer_range",val:" = 0.02"},{name:"layer_norm_eps",val:" = 1e-12"},{name:"use_cache",val:" = True"},{name:"pad_token_id",val:" = 0"},{name:"question_token_id",val:" = 104"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.SplinterConfig.vocab_size",description:`<strong>vocab_size</strong> (<code>int</code>, <em>optional</em>, defaults to 30522) &#x2014;
...
The id of the <code>[QUESTION]</code> token.`,name:"question_token_id"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/splinter/configuration_splinter.py#L32"}}),Ae=new so({props:{code:`from transformers import SplinterModel, SplinterConfig
...
The context token IDs if pad_on_right, else question token IDs`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/splinter/tokenization_splinter.py#L218",returnDescription:`
...
Whether or not the token list is already formatted with special tokens for the model.`,name:"already_has_special_tokens"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/splinter/tokenization_splinter.py#L250",returnDescription:`
<p>A list of integers in the range [0, 1]: 1 for a special token, 0 for a sequence token.</p>
`,returnType:`
<p><code>List[int]</code></p>
`}}),Oe=new O({props:{name:"create_token_type_ids_from_sequences",anchor:"transformers.SplinterTokenizer.create_token_type_ids_from_sequences",parameters:[{name:"token_ids_0",val:": typing.List[int]"},{name:"token_ids_1",val:": typing.Optional[typing.List[int]] = None"}],parametersDescription:[{anchor:"transformers.SplinterTokenizer.create_token_type_ids_from_sequences.token_ids_0",description:"<strong>token_ids_0</strong> (<code>List[int]</code>) &#x2014; The first tokenized sequence.",name:"token_ids_0"},{anchor:"transformers.SplinterTokenizer.create_token_type_ids_from_sequences.token_ids_1",description:"<strong>token_ids_1</strong> (<code>List[int]</code>, <em>optional</em>) &#x2014; The second tokenized sequence.",name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/splinter/tokenization_splinter.py#L278",returnDescription:`
<p>The token type ids.</p>
`,returnType:`
<p><code>List[int]</code></p>
`}}),Ne=new O({props:{name:"save_vocabulary",anchor:"transformers.SplinterTokenizer.save_vocabulary",parameters:[{name:"save_directory",val:": str"},{name:"filename_prefix",val:": typing.Optional[str] = None"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/splinter/tokenization_splinter.py#L307"}}),je=new lt({}),Qe=new O({props:{name:"class transformers.SplinterTokenizerFast",anchor:"transformers.SplinterTokenizerFast",parameters:[{name:"vocab_file",val:" = None"},{name:"tokenizer_file",val:" = None"},{name:"do_lower_case",val:" = True"},{name:"unk_token",val:" = '[UNK]'"},{name:"sep_token",val:" = '[SEP]'"},{name:"pad_token",val:" = '[PAD]'"},{name:"cls_token",val:" = '[CLS]'"},{name:"mask_token",val:" = '[MASK]'"},{name:"question_token",val:" = '[QUESTION]'"},{name:"tokenize_chinese_chars",val:" = True"},{name:"strip_accents",val:" = None"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.SplinterTokenizerFast.vocab_file",description:`<strong>vocab_file</strong> (<code>str</code>) &#x2014;
...
The context token IDs if pad_on_right, else question token IDs`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/splinter/tokenization_splinter_fast.py#L153",returnDescription:`
<p>List of <a href="../glossary#input-ids">input IDs</a> with the appropriate special tokens.</p>
`,returnType:`
<p><code>List[int]</code></p>
...
<code>past_key_values</code>).`,name:"use_cache"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/splinter/modeling_splinter.py#L638",returnDescription:`
<p>A <a
...
the only one for which start_logits and end_logits are calculated and they will be of shape <code>(batch_size, sequence_length)</code>.`,name:"question_positions"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/splinter/modeling_splinter.py#L840",returnDescription:`
<p>A <a
...
with only 128 training examples), while maintaining competitive performance in the high-resource setting.`),zn=d(),ht=o("p"),uo=a("Tips:"),qn=d(),I=o("ul"),ye=o("li"),fo=a(`Splinter was trained to predict answers spans conditioned on a special [QUESTION] token. These tokens contextualize
...
documentation from `),kt=o("a"),rs=a("PretrainedConfig"),as=a(" for more information."),is=d(),Kt=o("p"),ls=a("Example:"),ds=d(),u(Ae.$$.fragment),An=d(),X=o("h2"),ie=o("a"),Rt=o("span"),u(Pe.$$.fragment),cs=d(),Gt=o("span"),ps=a("SplinterTokenizer"),Pn=d(),y=o("div"),u(Fe.$$.fragment),hs=d(),Xt=o("p"),ms=a("Construct a Splinter tokenizer. Based on WordPiece."),us=d(),Me=o("p"),fs=a("This tokenizer inherits from "),vt=o("a"),gs=a("PreTrainedTokenizer"),_s=a(` which contains most of the main methods. Users should refer to
this superclass for more information regarding those methods.`),ks=d(),Q=o("div"),u(Ce.$$.fragment),vs=d(),Yt=o("p"),ws=a(`Build model inputs from a pair of sequence for question answering tasks by concatenating and adding special
...
special tokens using the tokenizer `),tn=o("code"),As=a("prepare_for_model"),Ps=a(" method."),Fs=d(),W=o("div"),u(Oe.$$.fragment),Ms=d(),yt=o("p"),Cs=a("Create the token type IDs corresponding to the sequences passed. "),Tt=o("a"),Is=a(`What are token type
IDs?`),Ls=d(),nn=o("p"),Ds=a("Should be overridden in a subclass if the model has a special way of building those."),Os=d(),St=o("div"),u(Ne.$$.fragment),Fn=d(),Y=o("h2"),de=o("a"),on=o("span"),u(je.$$.fragment),Ns=d(),sn=o("span"),js=a("SplinterTokenizerFast"),Mn=d(),P=o("div"),u(Qe.$$.fragment),Qs=d(),We=o("p"),Ws=a("Construct a \u201Cfast\u201D Splinter tokenizer (backed by HuggingFace\u2019s "),rn=o("em"),Us=a("tokenizers"),Bs=a(" library). Based on WordPiece."),Hs=d(),Ue=o("p"),Vs=a("This tokenizer inherits from "),zt=o("a"),Js=a("PreTrainedTokenizerFast"),Ks=a(` which contains most of the main methods. Users should
refer to this superclass for more information regarding those methods.`),Rs=d(),U=o("div"),u(Be.$$.fragment),Gs=d(),an=o("p"),Xs=a(`Build model inputs from a pair of sequence for question answering tasks by concatenating and adding special
tokens. A Splinter sequence has the following format:`),Ys=d(),He=o("ul"),qt=o("li"),Zs=a("single sequence: "),ln=o("code"),er=a("[CLS] X [SEP]"),tr=d(),$t=o("li"),nr=a("pair of sequences for question answering: "),dn=o("code"),or=a("[CLS] question_tokens [QUESTION] . [SEP] context_tokens [SEP]"),Cn=d(),Z=o("h2"),ce=o("a"),cn=o("span"),u(Ve.$$.fragment),sr=d(),pn=o("span"),rr=a("SplinterModel"),In=d(),F=o("div"),u(Je.$$.fragment),ar=d(),Ke=o("p"),ir=a(`The bare Splinter Model transformer outputting raw hidden-states without any specific head on top.
...
Aidan N. Gomez, Lukasz Kaiser and Illia Polosukhin.`),ur=d(),$=o("div"),u(Ye.$$.fragment),fr=d(),ee=o("p"),gr=a("The "),xt=o("a"),_r=a("SplinterModel"),kr=a(" forward method, overrides the "),hn=o("code"),vr=a("__call__"),wr=a(" special method."),br=d(),u(pe.$$.fragment),yr=d(),mn=o("p"),Tr=a("Example:"),Sr=d(),u(Ze.$$.fragment),Ln=d(),te=o("h2"),he=o("a"),un=o("span"),u(et.$$.fragment),zr=d(),fn=o("span"),qr=a("SplinterForQuestionAnswering"),Dn=d(),M=o("div"),u(tt.$$.fragment),$r=d(),ne=o("p"),xr=a(`Splinter Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
...
are replaced with a special token, viewed as a question representation, that is later used during fine-tuning to select
the answer span. The resulting model obtains surprisingly good results on multiple benchmarks (e.g., 72.7 F1 on SQuAD
with only 128 training examples), while maintaining competitive performance in the high-resource setting.`),ia.forEach(n),zn=c(t),ht=s(t,"P",{});var la=r(ht);uo=i(la,"Tips:"),la.forEach(n),qn=c(t),I=s(t,"UL",{});var ue=r(I);ye=s(ue,"LI",{});var Qn=r(ye);fo=i(Qn,`Splinter was trained to predict answers spans conditioned on a special [QUESTION] token. These tokens contextualize
to question representations which are used to predict the answers. This layer is called QASS, and is the default
...
the success of your model, especially in a few-shot setting.`),Wn.forEach(n),Ao=c(ue),A=s(ue,"LI",{});var B=r(A);Po=i(B,`Please note there are two different checkpoints for each size of Splinter. Both are basically the same, except that
one also has the pretrained wights of the QASS layer (`),Wt=s(B,"EM",{});var ua=r(Wt);Fo=i(ua,"tau/splinter-base-qass"),ua.forEach(n),Mo=i(B," and "),Ut=s(B,"EM",{});var fa=r(Ut);Co=i(fa,"tau/splinter-large-qass"),fa.forEach(n),Io=i(B,`) and one
