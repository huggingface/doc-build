...
`),U=r(P,"CODE",{});var ze=i(U);pe=s(ze,"model([input_ids, attention_mask])"),ze.forEach(o),te=s(P," or "),R=r(P,"CODE",{});var ke=i(R);ue=s(ke,"model([input_ids, attention_mask, token_type_ids])"),ke.forEach(o),P.forEach(o),me=p(O),N=r(O,"LI",{});var ge=i(N);he=s(ge,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),W=r(ge,"CODE",{});var Ee=i(W);fe=s(Ee,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),Ee.forEach(o),ge.forEach(o),O.forEach(o)},m(g,x){f(g,d,x),e(d,k),f(g,_,x),f(g,m,x),e(m,b),e(b,l),e(m,h),e(m,j),e(j,re),f(g,Y,x),f(g,z,x),e(z,ae),e(z,I),e(I,Z),e(z,ne),e(z,A),e(A,ie),e(z,se),f(g,J,x),f(g,D,x),e(D,G),f(g,Q,x),f(g,F,x),e(F,q),e(q,le),e(q,H),e(H,V),e(q,ee),e(q,B),e(B,oe),e(F,de),e(F,C),e(C,ce),e(C,U),e(U,pe),e(C,te),e(C,R),e(R,ue),e(F,me),e(F,N),e(N,he),e(N,W),e(W,fe)},d(g){g&&o(d),g&&o(_),g&&o(m),g&&o(Y),g&&o(z),g&&o(J),g&&o(D),g&&o(Q),g&&o(F)}}}function Tm(E){let d,k,_,m,b;return{c(){d=a("p"),k=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),_=a("code"),m=n("Module"),b=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(l){d=r(l,"P",{});var h=i(d);k=s(h,"Although the recipe for forward pass needs to be defined within this function, one should call the "),_=r(h,"CODE",{});var j=i(_);m=s(j,"Module"),j.forEach(o),b=s(h,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),{c(){d=a("p"),k=n("Examples:"),_=c(),L(m.$$.fragment)},l(l){d=r(l,"P",{});var h=i(d);k=s(h,"Examples:"),h.forEach(o),_=p(l),w(m.$$.fragment,l)},m(l,h){f(l,d,h),e(d,k),f(l,_,h),T(m,l,h),b=!0},p:qo,i(l){b||(v(m.$$.fragment,l),b=!0)},o(l){M(m.$$.fragment,l),b=!1},d(l){l&&o(d),l&&o(_),$(m,l)}}}function Mm(E){let d,k,_,m,b,l,h,j,re,Y,z,ae,I,Z,ne,A,ie,se,J,D,G,Q,F,q,le,H,V,ee,B,oe,de,C,ce,U,pe,te,R,ue,me,N,he,W,fe;return{c(){d=a("p"),k=n("TF 2.0 models accepts two formats as inputs:"),_=c(),m=a("ul"),b=a("li"),l=n("having all inputs as keyword arguments (like PyTorch models), or"),h=c(),j=a("li"),re=n("having all inputs as a list, tuple or dict in the first positional arguments."),Y=c(),z=a("p"),ae=n("This second option is useful when using "),I=a("code"),Z=n("tf.keras.Model.fit"),ne=n(` method which currently requires having all the
tensors in the first argument of the model call function: `),A=a("code"),ie=n("model(inputs)"),se=n("."),J=c(),D=a("p"),G=n(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),Q=c(),F=a("ul"),q=a("li"),le=n("a single Tensor with "),H=a("code"),V=n("input_ids"),ee=n(" only and nothing else: "),B=a("code"),oe=n("model(inputs_ids)"),de=c(),C=a("li"),ce=n(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),U=a("code"),pe=n("model([input_ids, attention_mask])"),te=n(" or "),R=a("code"),ue=n("model([input_ids, attention_mask, token_type_ids])"),me=c(),N=a("li"),he=n(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),W=a("code"),fe=n('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(g){d=r(g,"P",{});var x=i(d);k=s(x,"TF 2.0 models accepts two formats as inputs:"),x.forEach(o),_=p(g),m=r(g,"UL",{});var X=i(m);b=r(X,"LI",{});var je=i(b);l=s(je,"having all inputs as keyword arguments (like PyTorch models), or"),je.forEach(o),h=p(X),j=r(X,"LI",{});var Me=i(j);re=s(Me,"having all inputs as a list, tuple or dict in the first positional arguments."),Me.forEach(o),X.forEach(o),Y=p(g),z=r(g,"P",{});var S=i(z);ae=s(S,"This second option is useful when using "),I=r(S,"CODE",{});var be=i(I);Z=s(be,"tf.keras.Model.fit"),be.forEach(o),ne=s(S,` method which currently requires having all the
...
<span class="hljs-meta">&gt;&gt;&gt; </span>loss = outputs.loss`}}),{c(){d=a("p"),k=n("Examples:"),_=c(),L(m.$$.fragment)},l(l){d=r(l,"P",{});var h=i(d);k=s(h,"Examples:"),h.forEach(o),_=p(l),w(m.$$.fragment,l)},m(l,h){f(l,d,h),e(d,k),f(l,_,h),T(m,l,h),b=!0},p:qo,i(l){b||(v(m.$$.fragment,l),b=!0)},o(l){M(m.$$.fragment,l),b=!1},d(l){l&&o(d),l&&o(_),$(m,l)}}}function jm(E){let d,k,_,m,b,l,h,j,re,Y,z,ae,I,Z,ne,A,ie,se,J,D,G,Q,F,q,le,H,V,ee,B,oe,de,C,ce,U,pe,te,R,ue,me,N,he,W,fe;return{c(){d=a("p"),k=n("TF 2.0 models accepts two formats as inputs:"),_=c(),m=a("ul"),b=a("li"),l=n("having all inputs as keyword arguments (like PyTorch models), or"),h=c(),j=a("li"),re=n("having all inputs as a list, tuple or dict in the first positional arguments."),Y=c(),z=a("p"),ae=n("This second option is useful when using "),I=a("code"),Z=n("tf.keras.Model.fit"),ne=n(` method which currently requires having all the
tensors in the first argument of the model call function: `),A=a("code"),ie=n("model(inputs)"),se=n("."),J=c(),D=a("p"),G=n(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),Q=c(),F=a("ul"),q=a("li"),le=n("a single Tensor with "),H=a("code"),V=n("input_ids"),ee=n(" only and nothing else: "),B=a("code"),oe=n("model(inputs_ids)"),de=c(),C=a("li"),ce=n(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),U=a("code"),pe=n("model([input_ids, attention_mask])"),te=n(" or "),R=a("code"),ue=n("model([input_ids, attention_mask, token_type_ids])"),me=c(),N=a("li"),he=n(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),W=a("code"),fe=n('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(g){d=r(g,"P",{});var x=i(d);k=s(x,"TF 2.0 models accepts two formats as inputs:"),x.forEach(o),_=p(g),m=r(g,"UL",{});var X=i(m);b=r(X,"LI",{});var je=i(b);l=s(je,"having all inputs as keyword arguments (like PyTorch models), or"),je.forEach(o),h=p(X),j=r(X,"LI",{});var Me=i(j);re=s(Me,"having all inputs as a list, tuple or dict in the first positional arguments."),Me.forEach(o),X.forEach(o),Y=p(g),z=r(g,"P",{});var S=i(z);ae=s(S,"This second option is useful when using "),I=r(S,"CODE",{});var be=i(I);Z=s(be,"tf.keras.Model.fit"),be.forEach(o),ne=s(S,` method which currently requires having all the
...
<span class="hljs-meta">&gt;&gt;&gt; </span>loss = outputs.loss
<span class="hljs-meta">&gt;&gt;&gt; </span>logits = outputs.logits`}}),{c(){d=a("p"),k=n("Examples:"),_=c(),L(m.$$.fragment)},l(l){d=r(l,"P",{});var h=i(d);k=s(h,"Examples:"),h.forEach(o),_=p(l),w(m.$$.fragment,l)},m(l,h){f(l,d,h),e(d,k),f(l,_,h),T(m,l,h),b=!0},p:qo,i(l){b||(v(m.$$.fragment,l),b=!0)},o(l){M(m.$$.fragment,l),b=!1},d(l){l&&o(d),l&&o(_),$(m,l)}}}function Em(E){let d,k,_,m,b,l,h,j,re,Y,z,ae,I,Z,ne,A,ie,se,J,D,G,Q,F,q,le,H,V,ee,B,oe,de,C,ce,U,pe,te,R,ue,me,N,he,W,fe;return{c(){d=a("p"),k=n("TF 2.0 models accepts two formats as inputs:"),_=c(),m=a("ul"),b=a("li"),l=n("having all inputs as keyword arguments (like PyTorch models), or"),h=c(),j=a("li"),re=n("having all inputs as a list, tuple or dict in the first positional arguments."),Y=c(),z=a("p"),ae=n("This second option is useful when using "),I=a("code"),Z=n("tf.keras.Model.fit"),ne=n(` method which currently requires having all the
tensors in the first argument of the model call function: `),A=a("code"),ie=n("model(inputs)"),se=n("."),J=c(),D=a("p"),G=n(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),Q=c(),F=a("ul"),q=a("li"),le=n("a single Tensor with "),H=a("code"),V=n("input_ids"),ee=n(" only and nothing else: "),B=a("code"),oe=n("model(inputs_ids)"),de=c(),C=a("li"),ce=n(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),U=a("code"),pe=n("model([input_ids, attention_mask])"),te=n(" or "),R=a("code"),ue=n("model([input_ids, attention_mask, token_type_ids])"),me=c(),N=a("li"),he=n(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),W=a("code"),fe=n('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(g){d=r(g,"P",{});var x=i(d);k=s(x,"TF 2.0 models accepts two formats as inputs:"),x.forEach(o),_=p(g),m=r(g,"UL",{});var X=i(m);b=r(X,"LI",{});var je=i(b);l=s(je,"having all inputs as keyword arguments (like PyTorch models), or"),je.forEach(o),h=p(X),j=r(X,"LI",{});var Me=i(j);re=s(Me,"having all inputs as a list, tuple or dict in the first positional arguments."),Me.forEach(o),X.forEach(o),Y=p(g),z=r(g,"P",{});var S=i(z);ae=s(S,"This second option is useful when using "),I=r(S,"CODE",{});var be=i(I);Z=s(be,"tf.keras.Model.fit"),be.forEach(o),ne=s(S,` method which currently requires having all the
...
<span class="hljs-meta">&gt;&gt;&gt; </span>loss = outputs.loss
<span class="hljs-meta">&gt;&gt;&gt; </span>logits = outputs.logits`}}),{c(){d=a("p"),k=n("Examples:"),_=c(),L(m.$$.fragment)},l(l){d=r(l,"P",{});var h=i(d);k=s(h,"Examples:"),h.forEach(o),_=p(l),w(m.$$.fragment,l)},m(l,h){f(l,d,h),e(d,k),f(l,_,h),T(m,l,h),b=!0},p:qo,i(l){b||(v(m.$$.fragment,l),b=!0)},o(l){M(m.$$.fragment,l),b=!1},d(l){l&&o(d),l&&o(_),$(m,l)}}}function Pm(E){let d,k,_,m,b,l,h,j,re,Y,z,ae,I,Z,ne,A,ie,se,J,D,G,Q,F,q,le,H,V,ee,B,oe,de,C,ce,U,pe,te,R,ue,me,N,he,W,fe,g,x,X,je,Me,S,be,Fe,$e,O,K,xe,ye,P,ze,ke,ge,Ee,Qn,Hr,Br,Os,Rr,Kr,xt,Vr,Xr,jt,Yr,Zr,Da,Ft,Aa,to,Gr,Is,Jr,Qr,Ds,ei,oi,Ua,zt,Wa,es,eo,ti,os,ni,si,Et,ai,ri,qt,ii,li,Ha,no,di,Ct,ci,pi,Pt,ui,mi,Ba,ro,Co,As,Nt,hi,Us,fi,Ra,Pe,St,gi,io,_i,ts,yi,bi,Ot,ki,Li,wi,lo,Ti,ns,vi,Mi,ss,$i,xi,ji,Po,Ka,co,No,Ws,It,Fi,Hs,zi,Va,Ne,Dt,Ei,Bs,qi,Ci,So,as,Pi,Ni,rs,Si,Oi,Ii,At,Di,is,Ai,Ui,Xa,po,Oo,Rs,Ut,Wi,Ks,Hi,Ya,Se,Wt,Bi,Vs,Ri,Ki,Io,ls,Vi,Xi,ds,Yi,Zi,Gi,Ht,Ji,cs,Qi,el,Za,uo,Do,Xs,Bt,ol,Ys,tl,Ga,Oe,Rt,nl,Kt,sl,Vt,al,rl,il,Xt,ll,Yt,dl,cl,pl,Ae,Zt,ul,mo,ml,ps,hl,fl,Zs,gl,_l,yl,Ao,bl,Uo,Ja,ho,Wo,Gs,Gt,kl,Js,Ll,Qa,Ie,Jt,wl,fo,Tl,Qs,vl,Ml,Qt,$l,xl,jl,en,Fl,on,zl,El,ql,Ue,tn,Cl,go,Pl,us,Nl,Sl,ea,Ol,Il,Dl,Ho,Al,Bo,er,_o,Ro,oa,nn,Ul,ta,Wl,or,qe,sn,Hl,an,Bl,rn,Rl,Kl,Vl,ln,Xl,dn,Yl,Zl,Gl,cn,Jl,pn,Ql,ed,od,We,un,td,yo,nd,ms,sd,ad,na,rd,id,ld,Ko,dd,Vo,tr,bo,Xo,sa,mn,cd,aa,pd,nr,Ce,hn,ud,ko,md,fn,hd,fd,gn,gd,_d,yd,_n,bd,yn,kd,Ld,wd,bn,Td,kn,vd,Md,$d,He,Ln,xd,Lo,jd,hs,Fd,zd,ra,Ed,qd,Cd,Yo,Pd,Zo,sr,wo,Go,ia,wn,Nd,la,Sd,ar,Le,Tn,Od,da,Id,Dd,vn,Ad,fs,Ud,Wd,Hd,Mn,Bd,$n,Rd,Kd,Vd,Jo,Xd,Be,xn,Yd,To,Zd,gs,Gd,Jd,ca,Qd,ec,oc,Qo,tc,et,rr,vo,ot,pa,jn,nc,ua,sc,ir,we,Fn,ac,zn,rc,ma,ic,lc,dc,En,cc,_s,pc,uc,mc,qn,hc,Cn,fc,gc,_c,tt,yc,Re,Pn,bc,Mo,kc,ys,Lc,wc,ha,Tc,vc,Mc,nt,$c,st,lr,$o,at,fa,Nn,xc,ga,jc,dr,Te,Sn,Fc,_a,zc,Ec,On,qc,bs,Cc,Pc,Nc,In,Sc,Dn,Oc,Ic,Dc,rt,Ac,Ke,An,Uc,xo,Wc,ks,Hc,Bc,ya,Rc,Kc,Vc,it,Xc,lt,cr,jo,dt,ba,Un,Yc,ka,Zc,pr,ve,Wn,Gc,La,Jc,Qc,Hn,ep,Ls,op,tp,np,Bn,sp,Rn,ap,rp,ip,ct,lp,Ve,Kn,dp,Fo,cp,ws,pp,up,wa,mp,hp,fp,pt,gp,ut,ur;return l=new De({}),A=new De({}),Ft=new oo({props:{code:`def normalize_bbox(bbox, width, height):
    return [
...
behavior.`),pl=c(),Ae=a("div"),L(Zt.$$.fragment),ul=c(),mo=a("p"),ml=n("The "),ps=a("a"),hl=n("LayoutLMModel"),fl=n(" forward method, overrides the "),Zs=a("code"),gl=n("__call__"),_l=n(" special method."),yl=c(),L(Ao.$$.fragment),bl=c(),L(Uo.$$.fragment),Ja=c(),ho=a("h2"),Wo=a("a"),Gs=a("span"),L(Gt.$$.fragment),kl=c(),Js=a("span"),Ll=n("LayoutLMForMaskedLM"),Qa=c(),Ie=a("div"),L(Jt.$$.fragment),wl=c(),fo=a("p"),Tl=n("LayoutLM Model with a "),Qs=a("code"),vl=n("language modeling"),Ml=n(` head on top.
...
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),$d=c(),He=a("div"),L(Ln.$$.fragment),xd=c(),Lo=a("p"),jd=n("The "),hs=a("a"),Fd=n("LayoutLMForTokenClassification"),zd=n(" forward method, overrides the "),ra=a("code"),Ed=n("__call__"),qd=n(" special method."),Cd=c(),L(Yo.$$.fragment),Pd=c(),L(Zo.$$.fragment),sr=c(),wo=a("h2"),Go=a("a"),ia=a("span"),L(wn.$$.fragment),Nd=c(),la=a("span"),Sd=n("TFLayoutLMModel"),ar=c(),Le=a("div"),L(Tn.$$.fragment),Od=c(),da=a("p"),Id=n("The bare LayoutLM Model transformer outputting raw hidden-states without any specific head on top."),Dd=c(),vn=a("p"),Ad=n("This model inherits from "),fs=a("a"),Ud=n("TFPreTrainedModel"),Wd=n(`. Check the superclass documentation for the generic methods the
