...
M. Hamann P. Harper, P. Martinez`}}),{c(){T(d.$$.fragment)},l(f){v(d.$$.fragment,f)},m(f,_){M(d,f,_),k=!0},p:qt,i(f){k||($(d.$$.fragment,f),k=!0)},o(f){j(d.$$.fragment,f),k=!1},d(f){x(d,f)}}}function Eg(q){let d,k,f,_,b,l,h,E,ve,ge,B,_e,K,w,ue,I,Me,he,Q,ye,ne,R,re,$e,V,be,oe,S,je,ie,se,z,C,le,X,de,xe,Y,Fe,ce,P,pe,Z,Ee,ke,W,ze,we,D,me,G,Le,ee,A,Te,N,H,qe;return{c(){d=a("p"),k=o("TensorFlow models and layers in "),f=a("code"),_=o("transformers"),b=o(" accept two formats as input:"),l=c(),h=a("ul"),E=a("li"),ve=o("having all inputs as keyword arguments (like PyTorch models), or"),ge=c(),B=a("li"),_e=o("having all inputs as a list, tuple or dict in the first positional argument."),K=c(),w=a("p"),ue=o(`The reason the second format is supported is that Keras methods prefer this format when passing inputs to models
...
about any of this, as you can just pass inputs like you would to any other Python function!`),ae.forEach(t),this.h()},h(){u(N,"href","https://keras.io/guides/making_new_layers_and_models_via_subclassing/"),u(N,"rel","nofollow")},m(m,L){g(m,d,L),e(d,k),e(d,f),e(f,_),e(d,b),g(m,l,L),g(m,h,L),e(h,E),e(E,ve),e(h,ge),e(h,B),e(B,_e),g(m,K,L),g(m,w,L),e(w,ue),e(w,I),e(I,Me),e(w,he),e(w,Q),e(Q,ye),e(w,ne),e(w,R),e(R,re),e(w,$e),e(w,V),e(V,be),e(w,oe),e(w,S),e(S,je),e(w,ie),g(m,se,L),g(m,z,L),e(z,C),e(C,le),e(C,X),e(X,de),e(C,xe),e(C,Y),e(Y,Fe),e(z,ce),e(z,P),e(P,pe),e(P,Z),e(Z,Ee),e(P,ke),e(P,W),e(W,ze),e(z,we),e(z,D),e(D,me),e(D,G),e(G,Le),g(m,ee,L),g(m,A,L),e(A,Te),e(A,N),e(N,H),e(A,qe)},d(m){m&&t(d),m&&t(l),m&&t(h),m&&t(K),m&&t(w),m&&t(se),m&&t(z),m&&t(ee),m&&t(A)}}}function zg(q){let d,k,f,_,b;return{c(){d=a("p"),k=o("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=a("code"),_=o("Module"),b=o(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(l){d=r(l,"P",{});var h=i(d);k=n(h,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=r(h,"CODE",{});var E=i(f);_=n(E,"Module"),E.forEach(t),b=n(h,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),{c(){d=a("p"),k=o("Examples:"),f=c(),T(_.$$.fragment)},l(l){d=r(l,"P",{});var h=i(d);k=n(h,"Examples:"),h.forEach(t),f=p(l),v(_.$$.fragment,l)},m(l,h){g(l,d,h),e(d,k),g(l,f,h),M(_,l,h),b=!0},p:qt,i(l){b||($(_.$$.fragment,l),b=!0)},o(l){j(_.$$.fragment,l),b=!1},d(l){l&&t(d),l&&t(f),x(_,l)}}}function Cg(q){let d,k,f,_,b,l,h,E,ve,ge,B,_e,K,w,ue,I,Me,he,Q,ye,ne,R,re,$e,V,be,oe,S,je,ie,se,z,C,le,X,de,xe,Y,Fe,ce,P,pe,Z,Ee,ke,W,ze,we,D,me,G,Le,ee,A,Te,N,H,qe;return{c(){d=a("p"),k=o("TensorFlow models and layers in "),f=a("code"),_=o("transformers"),b=o(" accept two formats as input:"),l=c(),h=a("ul"),E=a("li"),ve=o("having all inputs as keyword arguments (like PyTorch models), or"),ge=c(),B=a("li"),_e=o("having all inputs as a list, tuple or dict in the first positional argument."),K=c(),w=a("p"),ue=o(`The reason the second format is supported is that Keras methods prefer this format when passing inputs to models
and layers. Because of this support, when using methods like `),I=a("code"),Me=o("model.fit()"),he=o(` things should \u201Cjust work\u201D for you - just
pass your inputs and labels in any format that `),Q=a("code"),ye=o("model.fit()"),ne=o(` supports! If, however, you want to use the second
format outside of Keras methods like `),R=a("code"),re=o("fit()"),$e=o(" and "),V=a("code"),be=o("predict()"),oe=o(`, such as when creating your own layers or models with
the Keras `),S=a("code"),je=o("Functional"),ie=o(` API, there are three possibilities you can use to gather all the input Tensors in the first
...
<span class="hljs-meta">&gt;&gt;&gt; </span>loss = outputs.loss`}}),{c(){d=a("p"),k=o("Examples:"),f=c(),T(_.$$.fragment)},l(l){d=r(l,"P",{});var h=i(d);k=n(h,"Examples:"),h.forEach(t),f=p(l),v(_.$$.fragment,l)},m(l,h){g(l,d,h),e(d,k),g(l,f,h),M(_,l,h),b=!0},p:qt,i(l){b||($(_.$$.fragment,l),b=!0)},o(l){j(_.$$.fragment,l),b=!1},d(l){l&&t(d),l&&t(f),x(_,l)}}}function Ng(q){let d,k,f,_,b,l,h,E,ve,ge,B,_e,K,w,ue,I,Me,he,Q,ye,ne,R,re,$e,V,be,oe,S,je,ie,se,z,C,le,X,de,xe,Y,Fe,ce,P,pe,Z,Ee,ke,W,ze,we,D,me,G,Le,ee,A,Te,N,H,qe;return{c(){d=a("p"),k=o("TensorFlow models and layers in "),f=a("code"),_=o("transformers"),b=o(" accept two formats as input:"),l=c(),h=a("ul"),E=a("li"),ve=o("having all inputs as keyword arguments (like PyTorch models), or"),ge=c(),B=a("li"),_e=o("having all inputs as a list, tuple or dict in the first positional argument."),K=c(),w=a("p"),ue=o(`The reason the second format is supported is that Keras methods prefer this format when passing inputs to models
and layers. Because of this support, when using methods like `),I=a("code"),Me=o("model.fit()"),he=o(` things should \u201Cjust work\u201D for you - just
pass your inputs and labels in any format that `),Q=a("code"),ye=o("model.fit()"),ne=o(` supports! If, however, you want to use the second
format outside of Keras methods like `),R=a("code"),re=o("fit()"),$e=o(" and "),V=a("code"),be=o("predict()"),oe=o(`, such as when creating your own layers or models with
the Keras `),S=a("code"),je=o("Functional"),ie=o(` API, there are three possibilities you can use to gather all the input Tensors in the first
...
<span class="hljs-meta">&gt;&gt;&gt; </span>loss = outputs.loss
<span class="hljs-meta">&gt;&gt;&gt; </span>logits = outputs.logits`}}),{c(){d=a("p"),k=o("Examples:"),f=c(),T(_.$$.fragment)},l(l){d=r(l,"P",{});var h=i(d);k=n(h,"Examples:"),h.forEach(t),f=p(l),v(_.$$.fragment,l)},m(l,h){g(l,d,h),e(d,k),g(l,f,h),M(_,l,h),b=!0},p:qt,i(l){b||($(_.$$.fragment,l),b=!0)},o(l){j(_.$$.fragment,l),b=!1},d(l){l&&t(d),l&&t(f),x(_,l)}}}function Ig(q){let d,k,f,_,b,l,h,E,ve,ge,B,_e,K,w,ue,I,Me,he,Q,ye,ne,R,re,$e,V,be,oe,S,je,ie,se,z,C,le,X,de,xe,Y,Fe,ce,P,pe,Z,Ee,ke,W,ze,we,D,me,G,Le,ee,A,Te,N,H,qe;return{c(){d=a("p"),k=o("TensorFlow models and layers in "),f=a("code"),_=o("transformers"),b=o(" accept two formats as input:"),l=c(),h=a("ul"),E=a("li"),ve=o("having all inputs as keyword arguments (like PyTorch models), or"),ge=c(),B=a("li"),_e=o("having all inputs as a list, tuple or dict in the first positional argument."),K=c(),w=a("p"),ue=o(`The reason the second format is supported is that Keras methods prefer this format when passing inputs to models
and layers. Because of this support, when using methods like `),I=a("code"),Me=o("model.fit()"),he=o(` things should \u201Cjust work\u201D for you - just
pass your inputs and labels in any format that `),Q=a("code"),ye=o("model.fit()"),ne=o(` supports! If, however, you want to use the second
format outside of Keras methods like `),R=a("code"),re=o("fit()"),$e=o(" and "),V=a("code"),be=o("predict()"),oe=o(`, such as when creating your own layers or models with
the Keras `),S=a("code"),je=o("Functional"),ie=o(` API, there are three possibilities you can use to gather all the input Tensors in the first
...
<span class="hljs-meta">&gt;&gt;&gt; </span>loss = outputs.loss
<span class="hljs-meta">&gt;&gt;&gt; </span>logits = outputs.logits`}}),{c(){d=a("p"),k=o("Examples:"),f=c(),T(_.$$.fragment)},l(l){d=r(l,"P",{});var h=i(d);k=n(h,"Examples:"),h.forEach(t),f=p(l),v(_.$$.fragment,l)},m(l,h){g(l,d,h),e(d,k),g(l,f,h),M(_,l,h),b=!0},p:qt,i(l){b||($(_.$$.fragment,l),b=!0)},o(l){j(_.$$.fragment,l),b=!1},d(l){l&&t(d),l&&t(f),x(_,l)}}}function Bg(q){let d,k,f,_,b,l,h,E,ve,ge,B,_e,K,w,ue,I,Me,he,Q,ye,ne,R,re,$e,V,be,oe,S,je,ie,se,z,C,le,X,de,xe,Y,Fe,ce,P,pe,Z,Ee,ke,W,ze,we,D,me,G,Le,ee,A,Te,N,H,qe;return{c(){d=a("p"),k=o("TensorFlow models and layers in "),f=a("code"),_=o("transformers"),b=o(" accept two formats as input:"),l=c(),h=a("ul"),E=a("li"),ve=o("having all inputs as keyword arguments (like PyTorch models), or"),ge=c(),B=a("li"),_e=o("having all inputs as a list, tuple or dict in the first positional argument."),K=c(),w=a("p"),ue=o(`The reason the second format is supported is that Keras methods prefer this format when passing inputs to models
and layers. Because of this support, when using methods like `),I=a("code"),Me=o("model.fit()"),he=o(` things should \u201Cjust work\u201D for you - just
pass your inputs and labels in any format that `),Q=a("code"),ye=o("model.fit()"),ne=o(` supports! If, however, you want to use the second
format outside of Keras methods like `),R=a("code"),re=o("fit()"),$e=o(" and "),V=a("code"),be=o("predict()"),oe=o(`, such as when creating your own layers or models with
the Keras `),S=a("code"),je=o("Functional"),ie=o(` API, there are three possibilities you can use to gather all the input Tensors in the first
...
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-built_in">print</span>(<span class="hljs-string">&quot; &quot;</span>.join(words[start : end + <span class="hljs-number">1</span>]))
M. Hamann P. Harper, P. Martinez`}}),{c(){d=a("p"),k=o("Examples:"),f=c(),T(_.$$.fragment)},l(l){d=r(l,"P",{});var h=i(d);k=n(h,"Examples:"),h.forEach(t),f=p(l),v(_.$$.fragment,l)},m(l,h){g(l,d,h),e(d,k),g(l,f,h),M(_,l,h),b=!0},p:qt,i(l){b||($(_.$$.fragment,l),b=!0)},o(l){j(_.$$.fragment,l),b=!1},d(l){l&&t(d),l&&t(f),x(_,l)}}}function Kg(q){let d,k,f,_,b,l,h,E,ve,ge,B,_e,K,w,ue,I,Me,he,Q,ye,ne,R,re,$e,V,be,oe,S,je,ie,se,z,C,le,X,de,xe,Y,Fe,ce,P,pe,Z,Ee,ke,W,ze,we,D,me,G,Le,ee,A,Te,N,H,qe,m,L,Se,te,Ue,Be,F,We,He,Ae,Ke,Qe,O,J,Re,De,U,Ie,fe,Ce,Oe,ae,Ve,Ia,bl,kl,ii,gn,li,Js,xt,wl,ea,Ll,Tl,_n,vl,Ml,yn,$l,jl,di,Ct,xl,bn,Fl,El,kn,zl,ql,ci,Dt,uo,Sa,wn,Cl,Ua,Pl,pi,lt,Ln,Al,It,Nl,ta,Ol,Dl,Tn,Il,Sl,Ul,St,Bl,oa,Wl,Hl,na,Kl,Ql,Rl,ho,ui,Ut,mo,Ba,vn,Vl,Wa,Xl,hi,dt,Mn,Yl,Ha,Zl,Gl,fo,sa,Jl,ed,aa,td,od,nd,$n,sd,ra,ad,rd,mi,Bt,go,Ka,jn,id,Qa,ld,fi,ct,xn,dd,Ra,cd,pd,_o,ia,ud,hd,la,md,fd,gd,Fn,_d,da,yd,bd,gi,Wt,yo,Va,En,kd,Xa,wd,_i,pt,zn,Ld,qn,Td,Cn,vd,Md,$d,Pn,jd,An,xd,Fd,Ed,mt,Nn,zd,Ht,qd,ca,Cd,Pd,Ya,Ad,Nd,Od,bo,Dd,ko,yi,Kt,wo,Za,On,Id,Ga,Sd,bi,ut,Dn,Ud,Qt,Bd,Ja,Wd,Hd,In,Kd,Qd,Rd,Sn,Vd,Un,Xd,Yd,Zd,ft,Bn,Gd,Rt,Jd,pa,ec,tc,er,oc,nc,sc,Lo,ac,To,ki,Vt,vo,tr,Wn,rc,or,ic,wi,tt,Hn,lc,Kn,dc,Qn,cc,pc,uc,Rn,hc,Vn,mc,fc,gc,Xn,_c,Yn,yc,bc,kc,gt,Zn,wc,Xt,Lc,ua,Tc,vc,nr,Mc,$c,jc,Mo,xc,$o,Li,Yt,jo,sr,Gn,Fc,ar,Ec,Ti,ot,Jn,zc,Zt,qc,es,Cc,Pc,ts,Ac,Nc,Oc,os,Dc,ns,Ic,Sc,Uc,ss,Bc,as,Wc,Hc,Kc,_t,rs,Qc,Gt,Rc,ha,Vc,Xc,rr,Yc,Zc,Gc,xo,Jc,Fo,vi,Jt,Eo,ir,is,ep,lr,tp,Mi,nt,ls,op,Ft,np,ds,sp,ap,dr,rp,ip,cr,lp,dp,cp,cs,pp,ps,up,hp,mp,us,fp,hs,gp,_p,yp,rt,ms,bp,Ne,kp,pr,wp,Lp,ur,Tp,vp,hr,Mp,$p,mr,jp,xp,fr,Fp,Ep,gr,zp,qp,_r,Cp,Pp,yr,Ap,Np,Op,br,Dp,Ip,kr,Sp,Up,zo,$i,eo,qo,wr,fs,Bp,Lr,Wp,ji,Ye,gs,Hp,Tr,Kp,Qp,_s,Rp,ma,Vp,Xp,Yp,ys,Zp,bs,Gp,Jp,eu,Co,tu,yt,ks,ou,to,nu,fa,su,au,vr,ru,iu,lu,Po,du,Ao,xi,oo,No,Mr,ws,cu,$r,pu,Fi,Ze,Ls,uu,Ts,hu,jr,mu,fu,gu,vs,_u,ga,yu,bu,ku,Ms,wu,$s,Lu,Tu,vu,Oo,Mu,bt,js,$u,no,ju,_a,xu,Fu,xr,Eu,zu,qu,Do,Cu,Io,Ei,so,So,Fr,xs,Pu,Er,Au,zi,Ge,Fs,Nu,zr,Ou,Du,Es,Iu,ya,Su,Uu,Bu,zs,Wu,qs,Hu,Ku,Qu,Uo,Ru,kt,Cs,Vu,ao,Xu,ba,Yu,Zu,qr,Gu,Ju,eh,Bo,th,Wo,qi,ro,Ho,Cr,Ps,oh,Pr,nh,Ci,Je,As,sh,Ar,ah,rh,Ns,ih,ka,lh,dh,ch,Os,ph,Ds,uh,hh,mh,Ko,fh,wt,Is,gh,io,_h,wa,yh,bh,Nr,kh,wh,Lh,Qo,Th,Ro,Pi,lo,Vo,Or,Ss,vh,Dr,Mh,Ai,et,Us,$h,Et,jh,Bs,xh,Fh,Ir,Eh,zh,Sr,qh,Ch,Ph,Ws,Ah,La,Nh,Oh,Dh,Hs,Ih,Ks,Sh,Uh,Bh,Xo,Wh,Lt,Qs,Hh,co,Kh,Ta,Qh,Rh,Ur,Vh,Xh,Yh,Yo,Zh,Zo,Ni;return l=new at({}),I=new at({}),U=new ht({props:{code:`def normalize_bbox(bbox, width, height):
    return [
...
`}}),Yo=new it({props:{$$slots:{default:[Wg]},$$scope:{ctx:q}}}),Zo=new zt({props:{anchor:"transformers.TFLayoutLMForQuestionAnswering.call.example",$$slots:{default:[Hg]},$$scope:{ctx:q}}}),{c(){d=a("meta"),k=c(),f=a("h1"),_=a("a"),b=a("span"),T(l.$$.fragment),h=c(),E=a("span"),ve=o("LayoutLM"),ge=c(),B=a("a"),_e=c(),K=a("h2"),w=a("a"),ue=a("span"),T(I.$$.fragment),Me=c(),he=a("span"),Q=o("Overview"),ye=c(),ne=a("p"),R=o("The LayoutLM model was proposed in the paper "),re=a("a"),$e=o(`LayoutLM: Pre-training of Text and Layout for Document Image
...
(from 93.07 to 94.42).`),Le=c(),ee=a("p"),A=o("Tips:"),Te=c(),N=a("ul"),H=a("li"),qe=o("In addition to "),m=a("em"),L=o("input_ids"),Se=o(", "),te=a("a"),Ue=o("forward()"),Be=o(" also expects the input "),F=a("code"),We=o("bbox"),He=o(`, which are
...
`),Tn=a("a"),Il=o("microsoft/layoutlm-base-uncased"),Sl=o(" architecture."),Ul=c(),St=a("p"),Bl=o("Configuration objects inherit from "),oa=a("a"),Wl=o("BertConfig"),Hl=o(` and can be used to control the model outputs. Read the
documentation from `),na=a("a"),Kl=o("BertConfig"),Ql=o(" for more information."),Rl=c(),T(ho.$$.fragment),ui=c(),Ut=a("h2"),mo=a("a"),Ba=a("span"),T(vn.$$.fragment),Vl=c(),Wa=a("span"),Xl=o("LayoutLMTokenizer"),hi=c(),dt=a("div"),T(Mn.$$.fragment),Yl=c(),Ha=a("p"),Zl=o("Constructs a LayoutLM tokenizer."),Gl=c(),fo=a("p"),sa=a("a"),Jl=o("LayoutLMTokenizer"),ed=o(" is identical to "),aa=a("a"),td=o("BertTokenizer"),od=o(` and runs end-to-end tokenization: punctuation splitting +
wordpiece.`),nd=c(),$n=a("p"),sd=o("Refer to superclass "),ra=a("a"),ad=o("BertTokenizer"),rd=o(" for usage examples and documentation concerning parameters."),mi=c(),Bt=a("h2"),go=a("a"),Ka=a("span"),T(jn.$$.fragment),id=c(),Qa=a("span"),ld=o("LayoutLMTokenizerFast"),fi=c(),ct=a("div"),T(xn.$$.fragment),dd=c(),Ra=a("p"),cd=o("Constructs a \u201CFast\u201D LayoutLMTokenizer."),pd=c(),_o=a("p"),ia=a("a"),ud=o("LayoutLMTokenizerFast"),hd=o(" is identical to "),la=a("a"),md=o("BertTokenizerFast"),fd=o(` and runs end-to-end tokenization: punctuation
splitting + wordpiece.`),gd=c(),Fn=a("p"),_d=o("Refer to superclass "),da=a("a"),yd=o("BertTokenizerFast"),bd=o(" for usage examples and documentation concerning parameters."),gi=c(),Wt=a("h2"),yo=a("a"),Va=a("span"),T(En.$$.fragment),kd=c(),Xa=a("span"),wd=o("LayoutLMModel"),_i=c(),pt=a("div"),T(zn.$$.fragment),Ld=c(),qn=a("p"),Td=o(`The bare LayoutLM Model transformer outputting raw hidden-states without any specific head on top.
...
behavior.`),Ed=c(),mt=a("div"),T(Nn.$$.fragment),zd=c(),Ht=a("p"),qd=o("The "),ca=a("a"),Cd=o("LayoutLMModel"),Pd=o(" forward method, overrides the "),Ya=a("code"),Ad=o("__call__"),Nd=o(" special method."),Od=c(),T(bo.$$.fragment),Dd=c(),T(ko.$$.fragment),yi=c(),Kt=a("h2"),wo=a("a"),Za=a("span"),T(On.$$.fragment),Id=c(),Ga=a("span"),Sd=o("LayoutLMForMaskedLM"),bi=c(),ut=a("div"),T(Dn.$$.fragment),Ud=c(),Qt=a("p"),Bd=o("LayoutLM Model with a "),Ja=a("code"),Wd=o("language modeling"),Hd=o(` head on top.
...
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),Zd=c(),ft=a("div"),T(Bn.$$.fragment),Gd=c(),Rt=a("p"),Jd=o("The "),pa=a("a"),ec=o("LayoutLMForMaskedLM"),tc=o(" forward method, overrides the "),er=a("code"),oc=o("__call__"),nc=o(" special method."),sc=c(),T(Lo.$$.fragment),ac=c(),T(To.$$.fragment),ki=c(),Vt=a("h2"),vo=a("a"),tr=a("span"),T(Wn.$$.fragment),rc=c(),or=a("span"),ic=o("LayoutLMForSequenceClassification"),wi=c(),tt=a("div"),T(Hn.$$.fragment),lc=c(),Kn=a("p"),dc=o(`LayoutLM Model with a sequence classification head on top (a linear layer on top of the pooled output) e.g. for
...
of what it thinks the answer is (the span of the answer within the texts parsed from the image).`),Up=c(),T(zo.$$.fragment),$i=c(),eo=a("h2"),qo=a("a"),wr=a("span"),T(fs.$$.fragment),Bp=c(),Lr=a("span"),Wp=o("TFLayoutLMModel"),ji=c(),Ye=a("div"),T(gs.$$.fragment),Hp=c(),Tr=a("p"),Kp=o("The bare LayoutLM Model transformer outputting raw hidden-states without any specific head on top."),Qp=c(),_s=a("p"),Rp=o("This model inherits from "),ma=a("a"),Vp=o("TFPreTrainedModel"),Xp=o(`. Check the superclass documentation for the generic methods the
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Qu=c(),T(Uo.$$.fragment),Ru=c(),kt=a("div"),T(Cs.$$.fragment),Vu=c(),ao=a("p"),Xu=o("The "),ba=a("a"),Yu=o("TFLayoutLMForSequenceClassification"),Zu=o(" forward method, overrides the "),qr=a("code"),Gu=o("__call__"),Ju=o(" special method."),eh=c(),T(Bo.$$.fragment),th=c(),T(Wo.$$.fragment),qi=c(),ro=a("h2"),Ho=a("a"),Cr=a("span"),T(Ps.$$.fragment),oh=c(),Pr=a("span"),nh=o("TFLayoutLMForTokenClassification"),Ci=c(),Je=a("div"),T(As.$$.fragment),sh=c(),Ar=a("p"),ah=o(`LayoutLM Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g. for
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),mh=c(),T(Ko.$$.fragment),fh=c(),wt=a("div"),T(Is.$$.fragment),gh=c(),io=a("p"),_h=o("The "),wa=a("a"),yh=o("TFLayoutLMForTokenClassification"),bh=o(" forward method, overrides the "),Nr=a("code"),kh=o("__call__"),wh=o(" special method."),Lh=c(),T(Qo.$$.fragment),Th=c(),T(Ro.$$.fragment),Pi=c(),lo=a("h2"),Vo=a("a"),Or=a("span"),T(Ss.$$.fragment),vh=c(),Dr=a("span"),Mh=o("TFLayoutLMForQuestionAnswering"),Ai=c(),et=a("div"),T(Us.$$.fragment),$h=c(),Et=a("p"),jh=o(`LayoutLM Model with a span classification head on top for extractive question-answering tasks such as
`),Bs=a("a"),xh=o("DocVQA"),Fh=o(" (a linear layer on top of the final hidden-states output to compute "),Ir=a("code"),Eh=o("span start logits"),zh=o(" and "),Sr=a("code"),qh=o("span end logits"),Ch=o(")."),Ph=c(),Ws=a("p"),Ah=o("This model inherits from "),La=a("a"),Nh=o("TFPreTrainedModel"),Oh=o(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Dh=c(),Hs=a("p"),Ih=o("This model is also a "),Ks=a("a"),Sh=o("tf.keras.Model"),Uh=o(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Bh=c(),T(Xo.$$.fragment),Wh=c(),Lt=a("div"),T(Qs.$$.fragment),Hh=c(),co=a("p"),Kh=o("The "),Ta=a("a"),Qh=o("TFLayoutLMForQuestionAnswering"),Rh=o(" forward method, overrides the "),Ur=a("code"),Vh=o("__call__"),Xh=o(" special method."),Yh=c(),T(Yo.$$.fragment),Zh=c(),T(Zo.$$.fragment),this.h()},l(s){const y=yg('[data-svelte="svelte-1phssyn"]',document.head);d=r(y,"META",{name:!0,content:!0}),y.forEach(t),k=p(s),f=r(s,"H1",{class:!0});var Rs=i(f);_=r(Rs,"A",{id:!0,class:!0,href:!0});var Br=i(_);b=r(Br,"SPAN",{});var Wr=i(b);v(l.$$.fragment,Wr),Wr.forEach(t),Br.forEach(t),h=p(Rs),E=r(Rs,"SPAN",{});var Hr=i(E);ve=n(Hr,"LayoutLM"),Hr.forEach(t),Rs.forEach(t),ge=p(s),B=r(s,"A",{id:!0}),i(B).forEach(t),_e=p(s),K=r(s,"H2",{class:!0});var Vs=i(K);w=r(Vs,"A",{id:!0,class:!0,href:!0});var Kr=i(w);ue=r(Kr,"SPAN",{});var Qr=i(ue);v(I.$$.fragment,Qr),Qr.forEach(t),Kr.forEach(t),Me=p(Vs),he=r(Vs,"SPAN",{});var Rr=i(he);Q=n(Rr,"Overview"),Rr.forEach(t),Vs.forEach(t),ye=p(s),ne=r(s,"P",{});var Xs=i(ne);R=n(Xs,"The LayoutLM model was proposed in the paper "),re=r(Xs,"A",{href:!0,rel:!0});var Vr=i(re);$e=n(Vr,`LayoutLM: Pre-training of Text and Layout for Document Image
...
document-level pretraining. It achieves new state-of-the-art results in several downstream tasks, including form
understanding (from 70.72 to 79.27), receipt understanding (from 94.02 to 95.24) and document image classification
(from 93.07 to 94.42).`),ei.forEach(t),Jr.forEach(t),Le=p(s),ee=r(s,"P",{});var ti=i(ee);A=n(ti,"Tips:"),ti.forEach(t),Te=p(s),N=r(s,"UL",{});var oi=i(N);H=r(oi,"LI",{});var st=i(H);qe=n(st,"In addition to "),m=r(st,"EM",{});var ni=i(m);L=n(ni,"input_ids"),ni.forEach(t),Se=n(st,", "),te=r(st,"A",{href:!0});var si=i(te);Ue=n(si,"forward()"),si.forEach(t),Be=n(st," also expects the input "),F=r(st,"CODE",{});var Gh=i(F);We=n(Gh,"bbox"),Gh.forEach(t),He=n(st,`, which are
the bounding boxes (i.e. 2D-positions) of the input tokens. These can be obtained using an external OCR engine such
...
LayoutLM model according to the specified arguments, defining the model architecture. Instantiating a configuration
with the defaults will yield a similar configuration to that of the LayoutLM
`),Tn=r($a,"A",{href:!0,rel:!0});var hm=i(Tn);Il=n(hm,"microsoft/layoutlm-base-uncased"),hm.forEach(t),Sl=n($a," architecture."),$a.forEach(t),Ul=p(Jo),St=r(Jo,"P",{});var ja=i(St);Bl=n(ja,"Configuration objects inherit from "),oa=r(ja,"A",{href:!0});var mm=i(oa);Wl=n(mm,"BertConfig"),mm.forEach(t),Hl=n(ja,` and can be used to control the model outputs. Read the
documentation from `),na=r(ja,"A",{href:!0});var fm=i(na);Kl=n(fm,"BertConfig"),fm.forEach(t),Ql=n(ja," for more information."),ja.forEach(t),Rl=p(Jo),v(ho.$$.fragment,Jo),Jo.forEach(t),ui=p(s),Ut=r(s,"H2",{class:!0});var Di=i(Ut);mo=r(Di,"A",{id:!0,class:!0,href:!0});var gm=i(mo);Ba=r(gm,"SPAN",{});var _m=i(Ba);v(vn.$$.fragment,_m),_m.forEach(t),gm.forEach(t),Vl=p(Di),Wa=r(Di,"SPAN",{});var ym=i(Wa);Xl=n(ym,"LayoutLMTokenizer"),ym.forEach(t),Di.forEach(t),hi=p(s),dt=r(s,"DIV",{class:!0});var en=i(dt);v(Mn.$$.fragment,en),Yl=p(en),Ha=r(en,"P",{});var bm=i(Ha);Zl=n(bm,"Constructs a LayoutLM tokenizer."),bm.forEach(t),Gl=p(en),fo=r(en,"P",{});var ai=i(fo);sa=r(ai,"A",{href:!0});var km=i(sa);Jl=n(km,"LayoutLMTokenizer"),km.forEach(t),ed=n(ai," is identical to "),aa=r(ai,"A",{href:!0});var wm=i(aa);td=n(wm,"BertTokenizer"),wm.forEach(t),od=n(ai,` and runs end-to-end tokenization: punctuation splitting +
wordpiece.`),ai.forEach(t),nd=p(en),$n=r(en,"P",{});var Ii=i($n);sd=n(Ii,"Refer to superclass "),ra=r(Ii,"A",{href:!0});var Lm=i(ra);ad=n(Lm,"BertTokenizer"),Lm.forEach(t),rd=n(Ii," for usage examples and documentation concerning parameters."),Ii.forEach(t),en.forEach(t),mi=p(s),Bt=r(s,"H2",{class:!0});var Si=i(Bt);go=r(Si,"A",{id:!0,class:!0,href:!0});var Tm=i(go);Ka=r(Tm,"SPAN",{});var vm=i(Ka);v(jn.$$.fragment,vm),vm.forEach(t),Tm.forEach(t),id=p(Si),Qa=r(Si,"SPAN",{});var Mm=i(Qa);ld=n(Mm,"LayoutLMTokenizerFast"),Mm.forEach(t),Si.forEach(t),fi=p(s),ct=r(s,"DIV",{class:!0});var tn=i(ct);v(xn.$$.fragment,tn),dd=p(tn),Ra=r(tn,"P",{});var $m=i(Ra);cd=n($m,"Constructs a \u201CFast\u201D LayoutLMTokenizer."),$m.forEach(t),pd=p(tn),_o=r(tn,"P",{});var ri=i(_o);ia=r(ri,"A",{href:!0});var jm=i(ia);ud=n(jm,"LayoutLMTokenizerFast"),jm.forEach(t),hd=n(ri," is identical to "),la=r(ri,"A",{href:!0});var xm=i(la);md=n(xm,"BertTokenizerFast"),xm.forEach(t),fd=n(ri,` and runs end-to-end tokenization: punctuation
splitting + wordpiece.`),ri.forEach(t),gd=p(tn),Fn=r(tn,"P",{});var Ui=i(Fn);_d=n(Ui,"Refer to superclass "),da=r(Ui,"A",{href:!0});var Fm=i(da);yd=n(Fm,"BertTokenizerFast"),Fm.forEach(t),bd=n(Ui," for usage examples and documentation concerning parameters."),Ui.forEach(t),tn.forEach(t),gi=p(s),Wt=r(s,"H2",{class:!0});var Bi=i(Wt);yo=r(Bi,"A",{id:!0,class:!0,href:!0});var Em=i(yo);Va=r(Em,"SPAN",{});var zm=i(Va);v(En.$$.fragment,zm),zm.forEach(t),Em.forEach(t),kd=p(Bi),Xa=r(Bi,"SPAN",{});var qm=i(Xa);wd=n(qm,"LayoutLMModel"),qm.forEach(t),Bi.forEach(t),_i=p(s),pt=r(s,"DIV",{class:!0});var on=i(pt);v(zn.$$.fragment,on),Ld=p(on),qn=r(on,"P",{});var Wi=i(qn);Td=n(Wi,`The bare LayoutLM Model transformer outputting raw hidden-states without any specific head on top.
The LayoutLM model was proposed in `),Cn=r(Wi,"A",{href:!0,rel:!0});var Cm=i(Cn);vd=n(Cm,`LayoutLM: Pre-training of Text and Layout for Document Image
...
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),Hi.forEach(t),Ed=p(on),mt=r(on,"DIV",{class:!0});var nn=i(mt);v(Nn.$$.fragment,nn),zd=p(nn),Ht=r(nn,"P",{});var xa=i(Ht);qd=n(xa,"The "),ca=r(xa,"A",{href:!0});var Am=i(ca);Cd=n(Am,"LayoutLMModel"),Am.forEach(t),Pd=n(xa," forward method, overrides the "),Ya=r(xa,"CODE",{});var Nm=i(Ya);Ad=n(Nm,"__call__"),Nm.forEach(t),Nd=n(xa," special method."),xa.forEach(t),Od=p(nn),v(bo.$$.fragment,nn),Dd=p(nn),v(ko.$$.fragment,nn),nn.forEach(t),on.forEach(t),yi=p(s),Kt=r(s,"H2",{class:!0});var Ki=i(Kt);wo=r(Ki,"A",{id:!0,class:!0,href:!0});var Om=i(wo);Za=r(Om,"SPAN",{});var Dm=i(Za);v(On.$$.fragment,Dm),Dm.forEach(t),Om.forEach(t),Id=p(Ki),Ga=r(Ki,"SPAN",{});var Im=i(Ga);Sd=n(Im,"LayoutLMForMaskedLM"),Im.forEach(t),Ki.forEach(t),bi=p(s),ut=r(s,"DIV",{class:!0});var sn=i(ut);v(Dn.$$.fragment,sn),Ud=p(sn),Qt=r(sn,"P",{});var Fa=i(Qt);Bd=n(Fa,"LayoutLM Model with a "),Ja=r(Fa,"CODE",{});var Sm=i(Ja);Wd=n(Sm,"language modeling"),Sm.forEach(t),Hd=n(Fa,` head on top.
...
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),Qi.forEach(t),Zd=p(sn),ft=r(sn,"DIV",{class:!0});var an=i(ft);v(Bn.$$.fragment,an),Gd=p(an),Rt=r(an,"P",{});var Ea=i(Rt);Jd=n(Ea,"The "),pa=r(Ea,"A",{href:!0});var Wm=i(pa);ec=n(Wm,"LayoutLMForMaskedLM"),Wm.forEach(t),tc=n(Ea," forward method, overrides the "),er=r(Ea,"CODE",{});var Hm=i(er);oc=n(Hm,"__call__"),Hm.forEach(t),nc=n(Ea," special method."),Ea.forEach(t),sc=p(an),v(Lo.$$.fragment,an),ac=p(an),v(To.$$.fragment,an),an.forEach(t),sn.forEach(t),ki=p(s),Vt=r(s,"H2",{class:!0});var Ri=i(Vt);vo=r(Ri,"A",{id:!0,class:!0,href:!0});var Km=i(vo);tr=r(Km,"SPAN",{});var Qm=i(tr);v(Wn.$$.fragment,Qm),Qm.forEach(t),Km.forEach(t),rc=p(Ri),or=r(Ri,"SPAN",{});var Rm=i(or);ic=n(Rm,"LayoutLMForSequenceClassification"),Rm.forEach(t),Ri.forEach(t),wi=p(s),tt=r(s,"DIV",{class:!0});var Pt=i(tt);v(Hn.$$.fragment,Pt),lc=p(Pt),Kn=r(Pt,"P",{});var Vi=i(Kn);dc=n(Vi,`LayoutLM Model with a sequence classification head on top (a linear layer on top of the pooled output) e.g. for
...
of what it thinks the answer is (the span of the answer within the texts parsed from the image).`),$f.forEach(t),Up=p(Ot),v(zo.$$.fragment,Ot),Ot.forEach(t),Nt.forEach(t),$i=p(s),eo=r(s,"H2",{class:!0});var nl=i(eo);qo=r(nl,"A",{id:!0,class:!0,href:!0});var jf=i(qo);wr=r(jf,"SPAN",{});var xf=i(wr);v(fs.$$.fragment,xf),xf.forEach(t),jf.forEach(t),Bp=p(nl),Lr=r(nl,"SPAN",{});var Ff=i(Lr);Wp=n(Ff,"TFLayoutLMModel"),Ff.forEach(t),nl.forEach(t),ji=p(s),Ye=r(s,"DIV",{class:!0});var Tt=i(Ye);v(gs.$$.fragment,Tt),Hp=p(Tt),Tr=r(Tt,"P",{});var Ef=i(Tr);Kp=n(Ef,"The bare LayoutLM Model transformer outputting raw hidden-states without any specific head on top."),Ef.forEach(t),Qp=p(Tt),_s=r(Tt,"P",{});var sl=i(_s);Rp=n(sl,"This model inherits from "),ma=r(sl,"A",{href:!0});var zf=i(ma);Vp=n(zf,"TFPreTrainedModel"),zf.forEach(t),Xp=n(sl,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),dl.forEach(t),vu=p(vt),v(Oo.$$.fragment,vt),Mu=p(vt),bt=r(vt,"DIV",{class:!0});var pn=i(bt);v(js.$$.fragment,pn),$u=p(pn),no=r(pn,"P",{});var Aa=i(no);ju=n(Aa,"The "),_a=r(Aa,"A",{href:!0});var Uf=i(_a);xu=n(Uf,"TFLayoutLMForMaskedLM"),Uf.forEach(t),Fu=n(Aa," forward method, overrides the "),xr=r(Aa,"CODE",{});var Bf=i(xr);Eu=n(Bf,"__call__"),Bf.forEach(t),zu=n(Aa," special method."),Aa.forEach(t),qu=p(pn),v(Do.$$.fragment,pn),Cu=p(pn),v(Io.$$.fragment,pn),pn.forEach(t),vt.forEach(t),Ei=p(s),so=r(s,"H2",{class:!0});var cl=i(so);So=r(cl,"A",{id:!0,class:!0,href:!0});var Wf=i(So);Fr=r(Wf,"SPAN",{});var Hf=i(Fr);v(xs.$$.fragment,Hf),Hf.forEach(t),Wf.forEach(t),Pu=p(cl),Er=r(cl,"SPAN",{});var Kf=i(Er);Au=n(Kf,"TFLayoutLMForSequenceClassification"),Kf.forEach(t),cl.forEach(t),zi=p(s),Ge=r(s,"DIV",{class:!0});var Mt=i(Ge);v(Fs.$$.fragment,Mt),Nu=p(Mt),zr=r(Mt,"P",{});var Qf=i(zr);Ou=n(Qf,`LayoutLM Model transformer with a sequence classification/regression head on top (a linear layer on top of the
