import{S as fg,i as gg,s as _g,e as a,k as c,w,t as n,M as yg,c as r,d as t,m as p,a as i,x as L,h as s,b as u,G as e,g,y as T,q as v,o as M,B as $,v as bg,L as ut}from"../../chunks/vendor-hf-doc-builder.js";import{T as Ue}from"../../chunks/Tip-hf-doc-builder.js";import{D as _e}from"../../chunks/Docstring-hf-doc-builder.js";import{C as Ke}from"../../chunks/CodeBlock-hf-doc-builder.js";import{I as Ie}from"../../chunks/IconCopyLink-hf-doc-builder.js";import{E as pt}from"../../chunks/ExampleCodeBlock-hf-doc-builder.js";function kg(z){let d,k,_,h,b;return h=new Ke({props:{code:`from transformers import LayoutLMModel, LayoutLMConfig
...
M. Hamann P. Harper, P. Martinez`}}),{c(){w(d.$$.fragment)},l(_){L(d.$$.fragment,_)},m(_,h){T(d,_,h),k=!0},p:ut,i(_){k||(v(d.$$.fragment,_),k=!0)},o(_){M(d.$$.fragment,_),k=!1},d(_){$(d,_)}}}function qg(z){let d,k,_,h,b,l,m,j,re,X,q,ae,D,Y,ne,S,ie,se,Z,I,G,J,F,E,le,H,V,ee,Q,te,de,C,ce,U,pe,oe,B,ue,he,P,me,W,fe;return{c(){d=a("p"),k=n("TF 2.0 models accepts two formats as inputs:"),_=c(),h=a("ul"),b=a("li"),l=n("having all inputs as keyword arguments (like PyTorch models), or"),m=c(),j=a("li"),re=n("having all inputs as a list, tuple or dict in the first positional arguments."),X=c(),q=a("p"),ae=n("This second option is useful when using "),D=a("code"),Y=n("tf.keras.Model.fit"),ne=n(` method which currently requires having all the
tensors in the first argument of the model call function: `),S=a("code"),ie=n("model(inputs)"),se=n("."),Z=c(),I=a("p"),G=n(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
...
`),W=a("code"),fe=n('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(f){d=r(f,"P",{});var x=i(d);k=s(x,"TF 2.0 models accepts two formats as inputs:"),x.forEach(t),_=p(f),h=r(f,"UL",{});var K=i(h);b=r(K,"LI",{});var Me=i(b);l=s(Me,"having all inputs as keyword arguments (like PyTorch models), or"),Me.forEach(t),m=p(K),j=r(K,"LI",{});var Le=i(j);re=s(Le,"having all inputs as a list, tuple or dict in the first positional arguments."),Le.forEach(t),K.forEach(t),X=p(f),q=r(f,"P",{});var N=i(q);ae=s(N,"This second option is useful when using "),D=r(N,"CODE",{});var ke=i(D);Y=s(ke,"tf.keras.Model.fit"),ke.forEach(t),ne=s(N,` method which currently requires having all the
tensors in the first argument of the model call function: `),S=r(N,"CODE",{});var $e=i(S);ie=s($e,"model(inputs)"),$e.forEach(t),se=s(N,"."),N.forEach(t),Z=p(f),I=r(f,"P",{});var Te=i(I);G=s(Te,`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
...
`),W=r(ge,"CODE",{});var je=i(W);fe=s(je,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),je.forEach(t),ge.forEach(t),O.forEach(t)},m(f,x){g(f,d,x),e(d,k),g(f,_,x),g(f,h,x),e(h,b),e(b,l),e(h,m),e(h,j),e(j,re),g(f,X,x),g(f,q,x),e(q,ae),e(q,D),e(D,Y),e(q,ne),e(q,S),e(S,ie),e(q,se),g(f,Z,x),g(f,I,x),e(I,G),g(f,J,x),g(f,F,x),e(F,E),e(E,le),e(E,H),e(H,V),e(E,ee),e(E,Q),e(Q,te),e(F,de),e(F,C),e(C,ce),e(C,U),e(U,pe),e(C,oe),e(C,B),e(B,ue),e(F,he),e(F,P),e(P,me),e(P,W),e(W,fe)},d(f){f&&t(d),f&&t(_),f&&t(h),f&&t(X),f&&t(q),f&&t(Z),f&&t(I),f&&t(J),f&&t(F)}}}function zg(z){let d,k,_,h,b;return{c(){d=a("p"),k=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),_=a("code"),h=n("Module"),b=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(l){d=r(l,"P",{});var m=i(d);k=s(m,"Although the recipe for forward pass needs to be defined within this function, one should call the "),_=r(m,"CODE",{});var j=i(_);h=s(j,"Module"),j.forEach(t),b=s(m,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),{c(){d=a("p"),k=n("Examples:"),_=c(),w(h.$$.fragment)},l(l){d=r(l,"P",{});var m=i(d);k=s(m,"Examples:"),m.forEach(t),_=p(l),L(h.$$.fragment,l)},m(l,m){g(l,d,m),e(d,k),g(l,_,m),T(h,l,m),b=!0},p:ut,i(l){b||(v(h.$$.fragment,l),b=!0)},o(l){M(h.$$.fragment,l),b=!1},d(l){l&&t(d),l&&t(_),$(h,l)}}}function Cg(z){let d,k,_,h,b,l,m,j,re,X,q,ae,D,Y,ne,S,ie,se,Z,I,G,J,F,E,le,H,V,ee,Q,te,de,C,ce,U,pe,oe,B,ue,he,P,me,W,fe;return{c(){d=a("p"),k=n("TF 2.0 models accepts two formats as inputs:"),_=c(),h=a("ul"),b=a("li"),l=n("having all inputs as keyword arguments (like PyTorch models), or"),m=c(),j=a("li"),re=n("having all inputs as a list, tuple or dict in the first positional arguments."),X=c(),q=a("p"),ae=n("This second option is useful when using "),D=a("code"),Y=n("tf.keras.Model.fit"),ne=n(` method which currently requires having all the
tensors in the first argument of the model call function: `),S=a("code"),ie=n("model(inputs)"),se=n("."),Z=c(),I=a("p"),G=n(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),J=c(),F=a("ul"),E=a("li"),le=n("a single Tensor with "),H=a("code"),V=n("input_ids"),ee=n(" only and nothing else: "),Q=a("code"),te=n("model(inputs_ids)"),de=c(),C=a("li"),ce=n(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),U=a("code"),pe=n("model([input_ids, attention_mask])"),oe=n(" or "),B=a("code"),ue=n("model([input_ids, attention_mask, token_type_ids])"),he=c(),P=a("li"),me=n(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),W=a("code"),fe=n('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(f){d=r(f,"P",{});var x=i(d);k=s(x,"TF 2.0 models accepts two formats as inputs:"),x.forEach(t),_=p(f),h=r(f,"UL",{});var K=i(h);b=r(K,"LI",{});var Me=i(b);l=s(Me,"having all inputs as keyword arguments (like PyTorch models), or"),Me.forEach(t),m=p(K),j=r(K,"LI",{});var Le=i(j);re=s(Le,"having all inputs as a list, tuple or dict in the first positional arguments."),Le.forEach(t),K.forEach(t),X=p(f),q=r(f,"P",{});var N=i(q);ae=s(N,"This second option is useful when using "),D=r(N,"CODE",{});var ke=i(D);Y=s(ke,"tf.keras.Model.fit"),ke.forEach(t),ne=s(N,` method which currently requires having all the
...
first positional argument :`),Te.forEach(t),J=p(f),F=r(f,"UL",{});var O=i(F);E=r(O,"LI",{});var R=i(E);le=s(R,"a single Tensor with "),H=r(R,"CODE",{});var ve=i(H);V=s(ve,"input_ids"),ve.forEach(t),ee=s(R," only and nothing else: "),Q=r(R,"CODE",{});var ye=i(Q);te=s(ye,"model(inputs_ids)"),ye.forEach(t),R.forEach(t),de=p(O),C=r(O,"LI",{});var A=i(C);ce=s(A,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),U=r(A,"CODE",{});var xe=i(U);pe=s(xe,"model([input_ids, attention_mask])"),xe.forEach(t),oe=s(A," or "),B=r(A,"CODE",{});var we=i(B);ue=s(we,"model([input_ids, attention_mask, token_type_ids])"),we.forEach(t),A.forEach(t),he=p(O),P=r(O,"LI",{});var ge=i(P);me=s(ge,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),W=r(ge,"CODE",{});var je=i(W);fe=s(je,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),je.forEach(t),ge.forEach(t),O.forEach(t)},m(f,x){g(f,d,x),e(d,k),g(f,_,x),g(f,h,x),e(h,b),e(b,l),e(h,m),e(h,j),e(j,re),g(f,X,x),g(f,q,x),e(q,ae),e(q,D),e(D,Y),e(q,ne),e(q,S),e(S,ie),e(q,se),g(f,Z,x),g(f,I,x),e(I,G),g(f,J,x),g(f,F,x),e(F,E),e(E,le),e(E,H),e(H,V),e(E,ee),e(E,Q),e(Q,te),e(F,de),e(F,C),e(C,ce),e(C,U),e(U,pe),e(C,oe),e(C,B),e(B,ue),e(F,he),e(F,P),e(P,me),e(P,W),e(W,fe)},d(f){f&&t(d),f&&t(_),f&&t(h),f&&t(X),f&&t(q),f&&t(Z),f&&t(I),f&&t(J),f&&t(F)}}}function Ag(z){let d,k,_,h,b;return{c(){d=a("p"),k=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),_=a("code"),h=n("Module"),b=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(l){d=r(l,"P",{});var m=i(d);k=s(m,"Although the recipe for forward pass needs to be defined within this function, one should call the "),_=r(m,"CODE",{});var j=i(_);h=s(j,"Module"),j.forEach(t),b=s(m,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
<span class="hljs-meta">&gt;&gt;&gt; </span>loss = outputs.loss`}}),{c(){d=a("p"),k=n("Examples:"),_=c(),w(h.$$.fragment)},l(l){d=r(l,"P",{});var m=i(d);k=s(m,"Examples:"),m.forEach(t),_=p(l),L(h.$$.fragment,l)},m(l,m){g(l,d,m),e(d,k),g(l,_,m),T(h,l,m),b=!0},p:ut,i(l){b||(v(h.$$.fragment,l),b=!0)},o(l){M(h.$$.fragment,l),b=!1},d(l){l&&t(d),l&&t(_),$(h,l)}}}function Ng(z){let d,k,_,h,b,l,m,j,re,X,q,ae,D,Y,ne,S,ie,se,Z,I,G,J,F,E,le,H,V,ee,Q,te,de,C,ce,U,pe,oe,B,ue,he,P,me,W,fe;return{c(){d=a("p"),k=n("TF 2.0 models accepts two formats as inputs:"),_=c(),h=a("ul"),b=a("li"),l=n("having all inputs as keyword arguments (like PyTorch models), or"),m=c(),j=a("li"),re=n("having all inputs as a list, tuple or dict in the first positional arguments."),X=c(),q=a("p"),ae=n("This second option is useful when using "),D=a("code"),Y=n("tf.keras.Model.fit"),ne=n(` method which currently requires having all the
tensors in the first argument of the model call function: `),S=a("code"),ie=n("model(inputs)"),se=n("."),Z=c(),I=a("p"),G=n(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),J=c(),F=a("ul"),E=a("li"),le=n("a single Tensor with "),H=a("code"),V=n("input_ids"),ee=n(" only and nothing else: "),Q=a("code"),te=n("model(inputs_ids)"),de=c(),C=a("li"),ce=n(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),U=a("code"),pe=n("model([input_ids, attention_mask])"),oe=n(" or "),B=a("code"),ue=n("model([input_ids, attention_mask, token_type_ids])"),he=c(),P=a("li"),me=n(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),W=a("code"),fe=n('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(f){d=r(f,"P",{});var x=i(d);k=s(x,"TF 2.0 models accepts two formats as inputs:"),x.forEach(t),_=p(f),h=r(f,"UL",{});var K=i(h);b=r(K,"LI",{});var Me=i(b);l=s(Me,"having all inputs as keyword arguments (like PyTorch models), or"),Me.forEach(t),m=p(K),j=r(K,"LI",{});var Le=i(j);re=s(Le,"having all inputs as a list, tuple or dict in the first positional arguments."),Le.forEach(t),K.forEach(t),X=p(f),q=r(f,"P",{});var N=i(q);ae=s(N,"This second option is useful when using "),D=r(N,"CODE",{});var ke=i(D);Y=s(ke,"tf.keras.Model.fit"),ke.forEach(t),ne=s(N,` method which currently requires having all the
...
first positional argument :`),Te.forEach(t),J=p(f),F=r(f,"UL",{});var O=i(F);E=r(O,"LI",{});var R=i(E);le=s(R,"a single Tensor with "),H=r(R,"CODE",{});var ve=i(H);V=s(ve,"input_ids"),ve.forEach(t),ee=s(R," only and nothing else: "),Q=r(R,"CODE",{});var ye=i(Q);te=s(ye,"model(inputs_ids)"),ye.forEach(t),R.forEach(t),de=p(O),C=r(O,"LI",{});var A=i(C);ce=s(A,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),U=r(A,"CODE",{});var xe=i(U);pe=s(xe,"model([input_ids, attention_mask])"),xe.forEach(t),oe=s(A," or "),B=r(A,"CODE",{});var we=i(B);ue=s(we,"model([input_ids, attention_mask, token_type_ids])"),we.forEach(t),A.forEach(t),he=p(O),P=r(O,"LI",{});var ge=i(P);me=s(ge,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),W=r(ge,"CODE",{});var je=i(W);fe=s(je,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),je.forEach(t),ge.forEach(t),O.forEach(t)},m(f,x){g(f,d,x),e(d,k),g(f,_,x),g(f,h,x),e(h,b),e(b,l),e(h,m),e(h,j),e(j,re),g(f,X,x),g(f,q,x),e(q,ae),e(q,D),e(D,Y),e(q,ne),e(q,S),e(S,ie),e(q,se),g(f,Z,x),g(f,I,x),e(I,G),g(f,J,x),g(f,F,x),e(F,E),e(E,le),e(E,H),e(H,V),e(E,ee),e(E,Q),e(Q,te),e(F,de),e(F,C),e(C,ce),e(C,U),e(U,pe),e(C,oe),e(C,B),e(B,ue),e(F,he),e(F,P),e(P,me),e(P,W),e(W,fe)},d(f){f&&t(d),f&&t(_),f&&t(h),f&&t(X),f&&t(q),f&&t(Z),f&&t(I),f&&t(J),f&&t(F)}}}function Og(z){let d,k,_,h,b;return{c(){d=a("p"),k=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),_=a("code"),h=n("Module"),b=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(l){d=r(l,"P",{});var m=i(d);k=s(m,"Although the recipe for forward pass needs to be defined within this function, one should call the "),_=r(m,"CODE",{});var j=i(_);h=s(j,"Module"),j.forEach(t),b=s(m,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),m.forEach(t)},m(l,m){g(l,d,m),e(d,k),e(d,_),e(_,h),e(d,b)},d(l){l&&t(d)}}}function Dg(z){let d,k,_,h,b;return h=new Ke({props:{code:`from transformers import AutoTokenizer, TFLayoutLMForSequenceClassification
import tensorflow as tf
...
<span class="hljs-meta">&gt;&gt;&gt; </span>loss = outputs.loss
<span class="hljs-meta">&gt;&gt;&gt; </span>logits = outputs.logits`}}),{c(){d=a("p"),k=n("Examples:"),_=c(),w(h.$$.fragment)},l(l){d=r(l,"P",{});var m=i(d);k=s(m,"Examples:"),m.forEach(t),_=p(l),L(h.$$.fragment,l)},m(l,m){g(l,d,m),e(d,k),g(l,_,m),T(h,l,m),b=!0},p:ut,i(l){b||(v(h.$$.fragment,l),b=!0)},o(l){M(h.$$.fragment,l),b=!1},d(l){l&&t(d),l&&t(_),$(h,l)}}}function Ig(z){let d,k,_,h,b,l,m,j,re,X,q,ae,D,Y,ne,S,ie,se,Z,I,G,J,F,E,le,H,V,ee,Q,te,de,C,ce,U,pe,oe,B,ue,he,P,me,W,fe;return{c(){d=a("p"),k=n("TF 2.0 models accepts two formats as inputs:"),_=c(),h=a("ul"),b=a("li"),l=n("having all inputs as keyword arguments (like PyTorch models), or"),m=c(),j=a("li"),re=n("having all inputs as a list, tuple or dict in the first positional arguments."),X=c(),q=a("p"),ae=n("This second option is useful when using "),D=a("code"),Y=n("tf.keras.Model.fit"),ne=n(` method which currently requires having all the
tensors in the first argument of the model call function: `),S=a("code"),ie=n("model(inputs)"),se=n("."),Z=c(),I=a("p"),G=n(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),J=c(),F=a("ul"),E=a("li"),le=n("a single Tensor with "),H=a("code"),V=n("input_ids"),ee=n(" only and nothing else: "),Q=a("code"),te=n("model(inputs_ids)"),de=c(),C=a("li"),ce=n(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),U=a("code"),pe=n("model([input_ids, attention_mask])"),oe=n(" or "),B=a("code"),ue=n("model([input_ids, attention_mask, token_type_ids])"),he=c(),P=a("li"),me=n(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),W=a("code"),fe=n('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(f){d=r(f,"P",{});var x=i(d);k=s(x,"TF 2.0 models accepts two formats as inputs:"),x.forEach(t),_=p(f),h=r(f,"UL",{});var K=i(h);b=r(K,"LI",{});var Me=i(b);l=s(Me,"having all inputs as keyword arguments (like PyTorch models), or"),Me.forEach(t),m=p(K),j=r(K,"LI",{});var Le=i(j);re=s(Le,"having all inputs as a list, tuple or dict in the first positional arguments."),Le.forEach(t),K.forEach(t),X=p(f),q=r(f,"P",{});var N=i(q);ae=s(N,"This second option is useful when using "),D=r(N,"CODE",{});var ke=i(D);Y=s(ke,"tf.keras.Model.fit"),ke.forEach(t),ne=s(N,` method which currently requires having all the
...
first positional argument :`),Te.forEach(t),J=p(f),F=r(f,"UL",{});var O=i(F);E=r(O,"LI",{});var R=i(E);le=s(R,"a single Tensor with "),H=r(R,"CODE",{});var ve=i(H);V=s(ve,"input_ids"),ve.forEach(t),ee=s(R," only and nothing else: "),Q=r(R,"CODE",{});var ye=i(Q);te=s(ye,"model(inputs_ids)"),ye.forEach(t),R.forEach(t),de=p(O),C=r(O,"LI",{});var A=i(C);ce=s(A,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),U=r(A,"CODE",{});var xe=i(U);pe=s(xe,"model([input_ids, attention_mask])"),xe.forEach(t),oe=s(A," or "),B=r(A,"CODE",{});var we=i(B);ue=s(we,"model([input_ids, attention_mask, token_type_ids])"),we.forEach(t),A.forEach(t),he=p(O),P=r(O,"LI",{});var ge=i(P);me=s(ge,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),W=r(ge,"CODE",{});var je=i(W);fe=s(je,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),je.forEach(t),ge.forEach(t),O.forEach(t)},m(f,x){g(f,d,x),e(d,k),g(f,_,x),g(f,h,x),e(h,b),e(b,l),e(h,m),e(h,j),e(j,re),g(f,X,x),g(f,q,x),e(q,ae),e(q,D),e(D,Y),e(q,ne),e(q,S),e(S,ie),e(q,se),g(f,Z,x),g(f,I,x),e(I,G),g(f,J,x),g(f,F,x),e(F,E),e(E,le),e(E,H),e(H,V),e(E,ee),e(E,Q),e(Q,te),e(F,de),e(F,C),e(C,ce),e(C,U),e(U,pe),e(C,oe),e(C,B),e(B,ue),e(F,he),e(F,P),e(P,me),e(P,W),e(W,fe)},d(f){f&&t(d),f&&t(_),f&&t(h),f&&t(X),f&&t(q),f&&t(Z),f&&t(I),f&&t(J),f&&t(F)}}}function Sg(z){let d,k,_,h,b;return{c(){d=a("p"),k=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),_=a("code"),h=n("Module"),b=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(l){d=r(l,"P",{});var m=i(d);k=s(m,"Although the recipe for forward pass needs to be defined within this function, one should call the "),_=r(m,"CODE",{});var j=i(_);h=s(j,"Module"),j.forEach(t),b=s(m,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
<span class="hljs-meta">&gt;&gt;&gt; </span>loss = outputs.loss
<span class="hljs-meta">&gt;&gt;&gt; </span>logits = outputs.logits`}}),{c(){d=a("p"),k=n("Examples:"),_=c(),w(h.$$.fragment)},l(l){d=r(l,"P",{});var m=i(d);k=s(m,"Examples:"),m.forEach(t),_=p(l),L(h.$$.fragment,l)},m(l,m){g(l,d,m),e(d,k),g(l,_,m),T(h,l,m),b=!0},p:ut,i(l){b||(v(h.$$.fragment,l),b=!0)},o(l){M(h.$$.fragment,l),b=!1},d(l){l&&t(d),l&&t(_),$(h,l)}}}function Wg(z){let d,k,_,h,b,l,m,j,re,X,q,ae,D,Y,ne,S,ie,se,Z,I,G,J,F,E,le,H,V,ee,Q,te,de,C,ce,U,pe,oe,B,ue,he,P,me,W,fe;return{c(){d=a("p"),k=n("TF 2.0 models accepts two formats as inputs:"),_=c(),h=a("ul"),b=a("li"),l=n("having all inputs as keyword arguments (like PyTorch models), or"),m=c(),j=a("li"),re=n("having all inputs as a list, tuple or dict in the first positional arguments."),X=c(),q=a("p"),ae=n("This second option is useful when using "),D=a("code"),Y=n("tf.keras.Model.fit"),ne=n(` method which currently requires having all the
tensors in the first argument of the model call function: `),S=a("code"),ie=n("model(inputs)"),se=n("."),Z=c(),I=a("p"),G=n(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),J=c(),F=a("ul"),E=a("li"),le=n("a single Tensor with "),H=a("code"),V=n("input_ids"),ee=n(" only and nothing else: "),Q=a("code"),te=n("model(inputs_ids)"),de=c(),C=a("li"),ce=n(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),U=a("code"),pe=n("model([input_ids, attention_mask])"),oe=n(" or "),B=a("code"),ue=n("model([input_ids, attention_mask, token_type_ids])"),he=c(),P=a("li"),me=n(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),W=a("code"),fe=n('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(f){d=r(f,"P",{});var x=i(d);k=s(x,"TF 2.0 models accepts two formats as inputs:"),x.forEach(t),_=p(f),h=r(f,"UL",{});var K=i(h);b=r(K,"LI",{});var Me=i(b);l=s(Me,"having all inputs as keyword arguments (like PyTorch models), or"),Me.forEach(t),m=p(K),j=r(K,"LI",{});var Le=i(j);re=s(Le,"having all inputs as a list, tuple or dict in the first positional arguments."),Le.forEach(t),K.forEach(t),X=p(f),q=r(f,"P",{});var N=i(q);ae=s(N,"This second option is useful when using "),D=r(N,"CODE",{});var ke=i(D);Y=s(ke,"tf.keras.Model.fit"),ke.forEach(t),ne=s(N,` method which currently requires having all the
...
first positional argument :`),Te.forEach(t),J=p(f),F=r(f,"UL",{});var O=i(F);E=r(O,"LI",{});var R=i(E);le=s(R,"a single Tensor with "),H=r(R,"CODE",{});var ve=i(H);V=s(ve,"input_ids"),ve.forEach(t),ee=s(R," only and nothing else: "),Q=r(R,"CODE",{});var ye=i(Q);te=s(ye,"model(inputs_ids)"),ye.forEach(t),R.forEach(t),de=p(O),C=r(O,"LI",{});var A=i(C);ce=s(A,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),U=r(A,"CODE",{});var xe=i(U);pe=s(xe,"model([input_ids, attention_mask])"),xe.forEach(t),oe=s(A," or "),B=r(A,"CODE",{});var we=i(B);ue=s(we,"model([input_ids, attention_mask, token_type_ids])"),we.forEach(t),A.forEach(t),he=p(O),P=r(O,"LI",{});var ge=i(P);me=s(ge,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),W=r(ge,"CODE",{});var je=i(W);fe=s(je,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),je.forEach(t),ge.forEach(t),O.forEach(t)},m(f,x){g(f,d,x),e(d,k),g(f,_,x),g(f,h,x),e(h,b),e(b,l),e(h,m),e(h,j),e(j,re),g(f,X,x),g(f,q,x),e(q,ae),e(q,D),e(D,Y),e(q,ne),e(q,S),e(S,ie),e(q,se),g(f,Z,x),g(f,I,x),e(I,G),g(f,J,x),g(f,F,x),e(F,E),e(E,le),e(E,H),e(H,V),e(E,ee),e(E,Q),e(Q,te),e(F,de),e(F,C),e(C,ce),e(C,U),e(U,pe),e(C,oe),e(C,B),e(B,ue),e(F,he),e(F,P),e(P,me),e(P,W),e(W,fe)},d(f){f&&t(d),f&&t(_),f&&t(h),f&&t(X),f&&t(q),f&&t(Z),f&&t(I),f&&t(J),f&&t(F)}}}function Hg(z){let d,k,_,h,b;return{c(){d=a("p"),k=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),_=a("code"),h=n("Module"),b=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(l){d=r(l,"P",{});var m=i(d);k=s(m,"Although the recipe for forward pass needs to be defined within this function, one should call the "),_=r(m,"CODE",{});var j=i(_);h=s(j,"Module"),j.forEach(t),b=s(m,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-built_in">print</span>(<span class="hljs-string">&quot; &quot;</span>.join(words[start : end + <span class="hljs-number">1</span>]))
M. Hamann P. Harper, P. Martinez`}}),{c(){d=a("p"),k=n("Examples:"),_=c(),w(h.$$.fragment)},l(l){d=r(l,"P",{});var m=i(d);k=s(m,"Examples:"),m.forEach(t),_=p(l),L(h.$$.fragment,l)},m(l,m){g(l,d,m),e(d,k),g(l,_,m),T(h,l,m),b=!0},p:ut,i(l){b||(v(h.$$.fragment,l),b=!0)},o(l){M(h.$$.fragment,l),b=!1},d(l){l&&t(d),l&&t(_),$(h,l)}}}function Bg(z){let d,k,_,h,b,l,m,j,re,X,q,ae,D,Y,ne,S,ie,se,Z,I,G,J,F,E,le,H,V,ee,Q,te,de,C,ce,U,pe,oe,B,ue,he,P,me,W,fe,f,x,K,Me,Le,N,ke,$e,Te,O,R,ve,ye,A,xe,we,ge,je,Os,ll,dl,va,cl,pl,Yo,ul,hl,Zo,ml,fl,Vr,Go,Xr,ht,gl,Ma,_l,yl,$a,bl,kl,Yr,Jo,Zr,Ds,lt,wl,Is,Ll,Tl,en,vl,Ml,tn,$l,xl,Gr,mt,jl,on,Fl,ql,nn,zl,El,Jr,bt,Rt,xa,sn,Cl,ja,Al,ei,We,an,Pl,kt,Nl,Ss,Ol,Dl,rn,Il,Sl,Ul,wt,Wl,Us,Hl,Ql,Ws,Bl,Rl,Kl,Kt,ti,Lt,Vt,Fa,ln,Vl,qa,Xl,oi,He,dn,Yl,za,Zl,Gl,Xt,Hs,Jl,ed,Qs,td,od,nd,cn,sd,Bs,ad,rd,ni,Tt,Yt,Ea,pn,id,Ca,ld,si,Qe,un,dd,Aa,cd,pd,Zt,Rs,ud,hd,Ks,md,fd,gd,hn,_d,Vs,yd,bd,ai,vt,Gt,Pa,mn,kd,Na,wd,ri,Be,fn,Ld,gn,Td,_n,vd,Md,$d,yn,xd,bn,jd,Fd,qd,Ve,kn,zd,Mt,Ed,Xs,Cd,Ad,Oa,Pd,Nd,Od,Jt,Dd,eo,ii,$t,to,Da,wn,Id,Ia,Sd,li,Re,Ln,Ud,xt,Wd,Sa,Hd,Qd,Tn,Bd,Rd,Kd,vn,Vd,Mn,Xd,Yd,Zd,Xe,$n,Gd,jt,Jd,Ys,ec,tc,Ua,oc,nc,sc,oo,ac,no,di,Ft,so,Wa,xn,rc,Ha,ic,ci,Pe,jn,lc,Fn,dc,qn,cc,pc,uc,zn,hc,En,mc,fc,gc,Cn,_c,An,yc,bc,kc,Ye,Pn,wc,qt,Lc,Zs,Tc,vc,Qa,Mc,$c,xc,ao,jc,ro,pi,zt,io,Ba,Nn,Fc,Ra,qc,ui,Ne,On,zc,Et,Ec,Dn,Cc,Ac,In,Pc,Nc,Oc,Sn,Dc,Un,Ic,Sc,Uc,Wn,Wc,Hn,Hc,Qc,Bc,Ze,Qn,Rc,Ct,Kc,Gs,Vc,Xc,Ka,Yc,Zc,Gc,lo,Jc,co,hi,At,po,Va,Bn,ep,Xa,tp,mi,Oe,Rn,op,dt,np,Kn,sp,ap,Ya,rp,ip,Za,lp,dp,cp,Vn,pp,Xn,up,hp,mp,Yn,fp,Zn,gp,_p,yp,Se,Gn,bp,be,kp,Ga,wp,Lp,Ja,Tp,vp,er,Mp,$p,tr,xp,jp,or,Fp,qp,nr,zp,Ep,sr,Cp,Ap,ar,Pp,Np,Op,rr,Dp,Ip,ir,Sp,Up,uo,fi,Pt,ho,lr,Jn,Wp,dr,Hp,gi,qe,es,Qp,cr,Bp,Rp,ts,Kp,Js,Vp,Xp,Yp,os,Zp,ns,Gp,Jp,eu,mo,tu,Ge,ss,ou,Nt,nu,ea,su,au,pr,ru,iu,lu,fo,du,go,_i,Ot,_o,ur,as,cu,hr,pu,yi,ze,rs,uu,is,hu,mr,mu,fu,gu,ls,_u,ta,yu,bu,ku,ds,wu,cs,Lu,Tu,vu,yo,Mu,Je,ps,$u,Dt,xu,oa,ju,Fu,fr,qu,zu,Eu,bo,Cu,ko,bi,It,wo,gr,us,Au,_r,Pu,ki,Ee,hs,Nu,yr,Ou,Du,ms,Iu,na,Su,Uu,Wu,fs,Hu,gs,Qu,Bu,Ru,Lo,Ku,et,_s,Vu,St,Xu,sa,Yu,Zu,br,Gu,Ju,eh,To,th,vo,wi,Ut,Mo,kr,ys,oh,wr,nh,Li,Ce,bs,sh,Lr,ah,rh,ks,ih,aa,lh,dh,ch,ws,ph,Ls,uh,hh,mh,$o,fh,tt,Ts,gh,Wt,_h,ra,yh,bh,Tr,kh,wh,Lh,xo,Th,jo,Ti,Ht,Fo,vr,vs,vh,Mr,Mh,vi,Ae,Ms,$h,ct,xh,$s,jh,Fh,$r,qh,zh,xr,Eh,Ch,Ah,xs,Ph,ia,Nh,Oh,Dh,js,Ih,Fs,Sh,Uh,Wh,qo,Hh,ot,qs,Qh,Qt,Bh,la,Rh,Kh,jr,Vh,Xh,Yh,zo,Zh,Eo,Mi;return l=new Ie({}),S=new Ie({}),Go=new Ke({props:{code:`def normalize_bbox(bbox, width, height):
    return [
...
width, height = image.size`}}),sn=new Ie({}),an=new _e({props:{name:"class transformers.LayoutLMConfig",anchor:"transformers.LayoutLMConfig",parameters:[{name:"vocab_size",val:" = 30522"},{name:"hidden_size",val:" = 768"},{name:"num_hidden_layers",val:" = 12"},{name:"num_attention_heads",val:" = 12"},{name:"intermediate_size",val:" = 3072"},{name:"hidden_act",val:" = 'gelu'"},{name:"hidden_dropout_prob",val:" = 0.1"},{name:"attention_probs_dropout_prob",val:" = 0.1"},{name:"max_position_embeddings",val:" = 512"},{name:"type_vocab_size",val:" = 2"},{name:"initializer_range",val:" = 0.02"},{name:"layer_norm_eps",val:" = 1e-12"},{name:"pad_token_id",val:" = 0"},{name:"max_2d_position_embeddings",val:" = 1024"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.LayoutLMConfig.vocab_size",description:`<strong>vocab_size</strong> (<code>int</code>, <em>optional</em>, defaults to 30522) &#x2014;
...
just in case (e.g., 1024).`,name:"max_2d_position_embeddings"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/layoutlm/configuration_layoutlm.py#L39"}}),Kt=new pt({props:{anchor:"transformers.LayoutLMConfig.example",$$slots:{default:[kg]},$$scope:{ctx:z}}}),ln=new Ie({}),dn=new _e({props:{name:"class transformers.LayoutLMTokenizer",anchor:"transformers.LayoutLMTokenizer",parameters:[{name:"vocab_file",val:""},{name:"do_lower_case",val:" = True"},{name:"do_basic_tokenize",val:" = True"},{name:"never_split",val:" = None"},{name:"unk_token",val:" = '[UNK]'"},{name:"sep_token",val:" = '[SEP]'"},{name:"pad_token",val:" = '[PAD]'"},{name:"cls_token",val:" = '[CLS]'"},{name:"mask_token",val:" = '[MASK]'"},{name:"tokenize_chinese_chars",val:" = True"},{name:"strip_accents",val:" = None"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/layoutlm/tokenization_layoutlm.py#L50"}}),pn=new Ie({}),un=new _e({props:{name:"class transformers.LayoutLMTokenizerFast",anchor:"transformers.LayoutLMTokenizerFast",parameters:[{name:"vocab_file",val:" = None"},{name:"tokenizer_file",val:" = None"},{name:"do_lower_case",val:" = True"},{name:"unk_token",val:" = '[UNK]'"},{name:"sep_token",val:" = '[SEP]'"},{name:"pad_token",val:" = '[PAD]'"},{name:"cls_token",val:" = '[CLS]'"},{name:"mask_token",val:" = '[MASK]'"},{name:"tokenize_chinese_chars",val:" = True"},{name:"strip_accents",val:" = None"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/layoutlm/tokenization_layoutlm_fast.py#L59"}}),mn=new Ie({}),fn=new _e({props:{name:"class transformers.LayoutLMModel",anchor:"transformers.LayoutLMModel",parameters:[{name:"config",val:""}],parametersDescription:[{anchor:"transformers.LayoutLMModel.config",description:`<strong>config</strong> (<a href="/docs/transformers/main/en/model_doc/layoutlm#transformers.LayoutLMConfig">LayoutLMConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
...
`}}),ao=new Ue({props:{$$slots:{default:[Mg]},$$scope:{ctx:z}}}),ro=new pt({props:{anchor:"transformers.LayoutLMForSequenceClassification.forward.example",$$slots:{default:[$g]},$$scope:{ctx:z}}}),Nn=new Ie({}),On=new _e({props:{name:"class transformers.LayoutLMForTokenClassification",anchor:"transformers.LayoutLMForTokenClassification",parameters:[{name:"config",val:""}],parametersDescription:[{anchor:"transformers.LayoutLMForTokenClassification.config",description:`<strong>config</strong> (<a href="/docs/transformers/main/en/model_doc/layoutlm#transformers.LayoutLMConfig">LayoutLMConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
...
`}}),lo=new Ue({props:{$$slots:{default:[xg]},$$scope:{ctx:z}}}),co=new pt({props:{anchor:"transformers.LayoutLMForTokenClassification.forward.example",$$slots:{default:[jg]},$$scope:{ctx:z}}}),Bn=new Ie({}),Rn=new _e({props:{name:"class transformers.LayoutLMForQuestionAnswering",anchor:"transformers.LayoutLMForQuestionAnswering",parameters:[{name:"config",val:""},{name:"has_visual_segment_embedding",val:" = True"}],parametersDescription:[{anchor:"transformers.LayoutLMForQuestionAnswering.config",description:`<strong>config</strong> (<a href="/docs/transformers/main/en/model_doc/layoutlm#transformers.LayoutLMConfig">LayoutLMConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
...
`}}),uo=new pt({props:{anchor:"transformers.LayoutLMForQuestionAnswering.forward.example",$$slots:{default:[Fg]},$$scope:{ctx:z}}}),Jn=new Ie({}),es=new _e({props:{name:"class transformers.TFLayoutLMModel",anchor:"transformers.TFLayoutLMModel",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.TFLayoutLMModel.config",description:`<strong>config</strong> (<a href="/docs/transformers/main/en/model_doc/layoutlm#transformers.LayoutLMConfig">LayoutLMConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
...
`}}),fo=new Ue({props:{$$slots:{default:[zg]},$$scope:{ctx:z}}}),go=new pt({props:{anchor:"transformers.TFLayoutLMModel.call.example",$$slots:{default:[Eg]},$$scope:{ctx:z}}}),as=new Ie({}),rs=new _e({props:{name:"class transformers.TFLayoutLMForMaskedLM",anchor:"transformers.TFLayoutLMForMaskedLM",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.TFLayoutLMForMaskedLM.config",description:`<strong>config</strong> (<a href="/docs/transformers/main/en/model_doc/layoutlm#transformers.LayoutLMConfig">LayoutLMConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
...
`}}),bo=new Ue({props:{$$slots:{default:[Ag]},$$scope:{ctx:z}}}),ko=new pt({props:{anchor:"transformers.TFLayoutLMForMaskedLM.call.example",$$slots:{default:[Pg]},$$scope:{ctx:z}}}),us=new Ie({}),hs=new _e({props:{name:"class transformers.TFLayoutLMForSequenceClassification",anchor:"transformers.TFLayoutLMForSequenceClassification",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.TFLayoutLMForSequenceClassification.config",description:`<strong>config</strong> (<a href="/docs/transformers/main/en/model_doc/layoutlm#transformers.LayoutLMConfig">LayoutLMConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
...
`}}),xo=new Ue({props:{$$slots:{default:[Sg]},$$scope:{ctx:z}}}),jo=new pt({props:{anchor:"transformers.TFLayoutLMForTokenClassification.call.example",$$slots:{default:[Ug]},$$scope:{ctx:z}}}),vs=new Ie({}),Ms=new _e({props:{name:"class transformers.TFLayoutLMForQuestionAnswering",anchor:"transformers.TFLayoutLMForQuestionAnswering",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.TFLayoutLMForQuestionAnswering.config",description:`<strong>config</strong> (<a href="/docs/transformers/main/en/model_doc/layoutlm#transformers.LayoutLMConfig">LayoutLMConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
...
`}}),zo=new Ue({props:{$$slots:{default:[Hg]},$$scope:{ctx:z}}}),Eo=new pt({props:{anchor:"transformers.TFLayoutLMForQuestionAnswering.call.example",$$slots:{default:[Qg]},$$scope:{ctx:z}}}),{c(){d=a("meta"),k=c(),_=a("h1"),h=a("a"),b=a("span"),w(l.$$.fragment),m=c(),j=a("span"),re=n("LayoutLM"),X=c(),q=a("a"),ae=c(),D=a("h2"),Y=a("a"),ne=a("span"),w(S.$$.fragment),ie=c(),se=a("span"),Z=n("Overview"),I=c(),G=a("p"),J=n("The LayoutLM model was proposed in the paper "),F=a("a"),E=n(`LayoutLM: Pre-training of Text and Layout for Document Image
...
occurs. Those can be obtained using the Python Image Library (PIL) library for example, as follows:`),Yr=c(),w(Jo.$$.fragment),Zr=c(),Ds=a("ul"),lt=a("li"),wl=n("For a demo which shows how to fine-tune "),Is=a("a"),Ll=n("LayoutLMForTokenClassification"),Tl=n(" on the "),en=a("a"),vl=n("FUNSD dataset"),Ml=n(" (a collection of annotated forms), see "),tn=a("a"),$l=n("this notebook"),xl=n(`.
...
`),nn=a("a"),zl=n("here"),El=n("."),Jr=c(),bt=a("h2"),Rt=a("a"),xa=a("span"),w(sn.$$.fragment),Cl=c(),ja=a("span"),Al=n("LayoutLMConfig"),ei=c(),We=a("div"),w(an.$$.fragment),Pl=c(),kt=a("p"),Nl=n("This is the configuration class to store the configuration of a "),Ss=a("a"),Ol=n("LayoutLMModel"),Dl=n(`. It is used to instantiate a
LayoutLM model according to the specified arguments, defining the model architecture. Instantiating a configuration
with the defaults will yield a similar configuration to that of the LayoutLM
`),rn=a("a"),Il=n("microsoft/layoutlm-base-uncased"),Sl=n(" architecture."),Ul=c(),wt=a("p"),Wl=n("Configuration objects inherit from "),Us=a("a"),Hl=n("BertConfig"),Ql=n(` and can be used to control the model outputs. Read the
...
behavior.`),qd=c(),Ve=a("div"),w(kn.$$.fragment),zd=c(),Mt=a("p"),Ed=n("The "),Xs=a("a"),Cd=n("LayoutLMModel"),Ad=n(" forward method, overrides the "),Oa=a("code"),Pd=n("__call__"),Nd=n(" special method."),Od=c(),w(Jt.$$.fragment),Dd=c(),w(eo.$$.fragment),ii=c(),$t=a("h2"),to=a("a"),Da=a("span"),w(wn.$$.fragment),Id=c(),Ia=a("span"),Sd=n("LayoutLMForMaskedLM"),li=c(),Re=a("div"),w(Ln.$$.fragment),Ud=c(),xt=a("p"),Wd=n("LayoutLM Model with a "),Sa=a("code"),Hd=n("language modeling"),Qd=n(` head on top.
...
sequence labeling (information extraction) tasks such as the `),Dn=a("a"),Cc=n("FUNSD"),Ac=n(`
dataset and the `),In=a("a"),Pc=n("SROIE"),Nc=n(" dataset."),Oc=c(),Sn=a("p"),Dc=n("The LayoutLM model was proposed in "),Un=a("a"),Ic=n(`LayoutLM: Pre-training of Text and Layout for Document Image
...
are not taken into account for computing the loss.`),Op=c(),rr=a("p"),Dp=n("Example:"),Ip=c(),ir=a("p"),Sp=n(`In the example below, we prepare a question + context pair for the LayoutLM model. It will give us a prediction
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),vu=c(),w(yo.$$.fragment),Mu=c(),Je=a("div"),w(ps.$$.fragment),$u=c(),Dt=a("p"),xu=n("The "),oa=a("a"),ju=n("TFLayoutLMForMaskedLM"),Fu=n(" forward method, overrides the "),fr=a("code"),qu=n("__call__"),zu=n(" special method."),Eu=c(),w(bo.$$.fragment),Cu=c(),w(ko.$$.fragment),bi=c(),It=a("h2"),wo=a("a"),gr=a("span"),w(us.$$.fragment),Au=c(),_r=a("span"),Pu=n("TFLayoutLMForSequenceClassification"),ki=c(),Ee=a("div"),w(hs.$$.fragment),Nu=c(),yr=a("p"),Ou=n(`LayoutLM Model transformer with a sequence classification/regression head on top (a linear layer on top of the
pooled output) e.g. for GLUE tasks.`),Du=c(),ms=a("p"),Iu=n("This model inherits from "),na=a("a"),Su=n("TFPreTrainedModel"),Uu=n(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
training and 347 receipts for testing).`),Ps.forEach(t),he=p(Bt),P=r(Bt,"LI",{});var Ns=i(P);me=s(Ns,"document image classification: the "),W=r(Ns,"A",{href:!0,rel:!0});var Dr=i(W);fe=s(Dr,"RVL-CDIP"),Dr.forEach(t),f=s(Ns,` dataset (a collection of
400,000 images belonging to one of 16 classes).`),Ns.forEach(t),Bt.forEach(t),x=p(o),K=r(o,"P",{});var Ir=i(K);Me=s(Ir,"The abstract from the paper is the following:"),Ir.forEach(t),Le=p(o),N=r(o,"P",{});var Sr=i(N);ke=r(Sr,"EM",{});var Ur=i(ke);$e=s(Ur,`Pre-training techniques have been verified successfully in a variety of NLP tasks in recent years. Despite the
widespread use of pretraining models for NLP applications, they almost exclusively focus on text-level manipulation,
while neglecting layout and style information that is vital for document image understanding. In this paper, we propose
the LayoutLM to jointly model interactions between text and layout information across scanned document images, which is
beneficial for a great number of real-world document image understanding tasks such as information extraction from
...
document-level pretraining. It achieves new state-of-the-art results in several downstream tasks, including form
understanding (from 70.72 to 79.27), receipt understanding (from 94.02 to 95.24) and document image classification
(from 93.07 to 94.42).`),Ur.forEach(t),Sr.forEach(t),Te=p(o),O=r(o,"P",{});var Wr=i(O);R=s(Wr,"Tips:"),Wr.forEach(t),ve=p(o),ye=r(o,"UL",{});var Hr=i(ye);A=r(Hr,"LI",{});var De=i(A);xe=s(De,"In addition to "),we=r(De,"EM",{});var Qr=i(we);ge=s(Qr,"input_ids"),Qr.forEach(t),je=s(De,", "),Os=r(De,"A",{href:!0});var Br=i(Os);ll=s(Br,"forward()"),Br.forEach(t),dl=s(De," also expects the input "),va=r(De,"CODE",{});var Gh=i(va);cl=s(Gh,"bbox"),Gh.forEach(t),pl=s(De,`, which are
the bounding boxes (i.e. 2D-positions) of the input tokens. These can be obtained using an external OCR engine such
as Google\u2019s `),Yo=r(De,"A",{href:!0,rel:!0});var Jh=i(Yo);ul=s(Jh,"Tesseract"),Jh.forEach(t),hl=s(De," (there\u2019s a "),Zo=r(De,"A",{href:!0,rel:!0});var em=i(Zo);ml=s(em,"Python wrapper"),em.forEach(t),fl=s(De,` available). Each bounding box should be in (x0, y0, x1, y1) format, where
(x0, y0) corresponds to the position of the upper left corner in the bounding box, and (x1, y1) represents the
position of the lower right corner. Note that one first needs to normalize the bounding boxes to be on a 0-1000
scale. To normalize, you can use the following function:`),De.forEach(t),Hr.forEach(t),Vr=p(o),L(Go.$$.fragment,o),Xr=p(o),ht=r(o,"P",{});var da=i(ht);gl=s(da,"Here, "),Ma=r(da,"CODE",{});var tm=i(Ma);_l=s(tm,"width"),tm.forEach(t),yl=s(da," and "),$a=r(da,"CODE",{});var om=i($a);bl=s(om,"height"),om.forEach(t),kl=s(da,` correspond to the width and height of the original document in which the token
occurs. Those can be obtained using the Python Image Library (PIL) library for example, as follows:`),da.forEach(t),Yr=p(o),L(Jo.$$.fragment,o),Zr=p(o),Ds=r(o,"UL",{});var nm=i(Ds);lt=r(nm,"LI",{});var Co=i(lt);wl=s(Co,"For a demo which shows how to fine-tune "),Is=r(Co,"A",{href:!0});var sm=i(Is);Ll=s(sm,"LayoutLMForTokenClassification"),sm.forEach(t),Tl=s(Co," on the "),en=r(Co,"A",{href:!0,rel:!0});var am=i(en);vl=s(am,"FUNSD dataset"),am.forEach(t),Ml=s(Co," (a collection of annotated forms), see "),tn=r(Co,"A",{href:!0,rel:!0});var rm=i(tn);$l=s(rm,"this notebook"),rm.forEach(t),xl=s(Co,`.
...
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),Ci.forEach(t),qd=p(Oo),Ve=r(Oo,"DIV",{class:!0});var Do=i(Ve);L(kn.$$.fragment,Do),zd=p(Do),Mt=r(Do,"P",{});var ha=i(Mt);Ed=s(ha,"The "),Xs=r(ha,"A",{href:!0});var Pm=i(Xs);Cd=s(Pm,"LayoutLMModel"),Pm.forEach(t),Ad=s(ha," forward method, overrides the "),Oa=r(ha,"CODE",{});var Nm=i(Oa);Pd=s(Nm,"__call__"),Nm.forEach(t),Nd=s(ha," special method."),ha.forEach(t),Od=p(Do),L(Jt.$$.fragment,Do),Dd=p(Do),L(eo.$$.fragment,Do),Do.forEach(t),Oo.forEach(t),ii=p(o),$t=r(o,"H2",{class:!0});var Ai=i($t);to=r(Ai,"A",{id:!0,class:!0,href:!0});var Om=i(to);Da=r(Om,"SPAN",{});var Dm=i(Da);L(wn.$$.fragment,Dm),Dm.forEach(t),Om.forEach(t),Id=p(Ai),Ia=r(Ai,"SPAN",{});var Im=i(Ia);Sd=s(Im,"LayoutLMForMaskedLM"),Im.forEach(t),Ai.forEach(t),li=p(o),Re=r(o,"DIV",{class:!0});var Io=i(Re);L(Ln.$$.fragment,Io),Ud=p(Io),xt=r(Io,"P",{});var ma=i(xt);Wd=s(ma,"LayoutLM Model with a "),Sa=r(ma,"CODE",{});var Sm=i(Sa);Hd=s(Sm,"language modeling"),Sm.forEach(t),Qd=s(ma,` head on top.
...
Ming Zhou.`),ma.forEach(t),Kd=p(Io),vn=r(Io,"P",{});var Pi=i(vn);Vd=s(Pi,"This model is a PyTorch "),Mn=r(Pi,"A",{href:!0,rel:!0});var Wm=i(Mn);Xd=s(Wm,"torch.nn.Module"),Wm.forEach(t),Yd=s(Pi,` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),Pi.forEach(t),Zd=p(Io),Xe=r(Io,"DIV",{class:!0});var So=i(Xe);L($n.$$.fragment,So),Gd=p(So),jt=r(So,"P",{});var fa=i(jt);Jd=s(fa,"The "),Ys=r(fa,"A",{href:!0});var Hm=i(Ys);ec=s(Hm,"LayoutLMForMaskedLM"),Hm.forEach(t),tc=s(fa," forward method, overrides the "),Ua=r(fa,"CODE",{});var Qm=i(Ua);oc=s(Qm,"__call__"),Qm.forEach(t),nc=s(fa," special method."),fa.forEach(t),sc=p(So),L(oo.$$.fragment,So),ac=p(So),L(no.$$.fragment,So),So.forEach(t),Io.forEach(t),di=p(o),Ft=r(o,"H2",{class:!0});var Ni=i(Ft);so=r(Ni,"A",{id:!0,class:!0,href:!0});var Bm=i(so);Wa=r(Bm,"SPAN",{});var Rm=i(Wa);L(xn.$$.fragment,Rm),Rm.forEach(t),Bm.forEach(t),rc=p(Ni),Ha=r(Ni,"SPAN",{});var Km=i(Ha);ic=s(Km,"LayoutLMForSequenceClassification"),Km.forEach(t),Ni.forEach(t),ci=p(o),Pe=r(o,"DIV",{class:!0});var ft=i(Pe);L(jn.$$.fragment,ft),lc=p(ft),Fn=r(ft,"P",{});var Oi=i(Fn);dc=s(Oi,`LayoutLM Model with a sequence classification head on top (a linear layer on top of the pooled output) e.g. for
document image classification tasks such as the `),qn=r(Oi,"A",{href:!0,rel:!0});var Vm=i(qn);cc=s(Vm,"RVL-CDIP"),Vm.forEach(t),pc=s(Oi," dataset."),Oi.forEach(t),uc=p(ft),zn=r(ft,"P",{});var Di=i(zn);hc=s(Di,"The LayoutLM model was proposed in "),En=r(Di,"A",{href:!0,rel:!0});var Xm=i(En);mc=s(Xm,`LayoutLM: Pre-training of Text and Layout for Document Image
Understanding`),Xm.forEach(t),fc=s(Di,` by Yiheng Xu, Minghao Li, Lei Cui, Shaohan Huang, Furu Wei and
Ming Zhou.`),Di.forEach(t),gc=p(ft),Cn=r(ft,"P",{});var Ii=i(Cn);_c=s(Ii,"This model is a PyTorch "),An=r(Ii,"A",{href:!0,rel:!0});var Ym=i(An);yc=s(Ym,"torch.nn.Module"),Ym.forEach(t),bc=s(Ii,` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),Ii.forEach(t),kc=p(ft),Ye=r(ft,"DIV",{class:!0});var Uo=i(Ye);L(Pn.$$.fragment,Uo),wc=p(Uo),qt=r(Uo,"P",{});var ga=i(qt);Lc=s(ga,"The "),Zs=r(ga,"A",{href:!0});var Zm=i(Zs);Tc=s(Zm,"LayoutLMForSequenceClassification"),Zm.forEach(t),vc=s(ga," forward method, overrides the "),Qa=r(ga,"CODE",{});var Gm=i(Qa);Mc=s(Gm,"__call__"),Gm.forEach(t),$c=s(ga," special method."),ga.forEach(t),xc=p(Uo),L(ao.$$.fragment,Uo),jc=p(Uo),L(ro.$$.fragment,Uo),Uo.forEach(t),ft.forEach(t),pi=p(o),zt=r(o,"H2",{class:!0});var Si=i(zt);io=r(Si,"A",{id:!0,class:!0,href:!0});var Jm=i(io);Ba=r(Jm,"SPAN",{});var ef=i(Ba);L(Nn.$$.fragment,ef),ef.forEach(t),Jm.forEach(t),Fc=p(Si),Ra=r(Si,"SPAN",{});var tf=i(Ra);qc=s(tf,"LayoutLMForTokenClassification"),tf.forEach(t),Si.forEach(t),ui=p(o),Ne=r(o,"DIV",{class:!0});var gt=i(Ne);L(On.$$.fragment,gt),zc=p(gt),Et=r(gt,"P",{});var _a=i(Et);Ec=s(_a,`LayoutLM Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g. for
sequence labeling (information extraction) tasks such as the `),Dn=r(_a,"A",{href:!0,rel:!0});var of=i(Dn);Cc=s(of,"FUNSD"),of.forEach(t),Ac=s(_a,`
dataset and the `),In=r(_a,"A",{href:!0,rel:!0});var nf=i(In);Pc=s(nf,"SROIE"),nf.forEach(t),Nc=s(_a," dataset."),_a.forEach(t),Oc=p(gt),Sn=r(gt,"P",{});var Ui=i(Sn);Dc=s(Ui,"The LayoutLM model was proposed in "),Un=r(Ui,"A",{href:!0,rel:!0});var sf=i(Un);Ic=s(sf,`LayoutLM: Pre-training of Text and Layout for Document Image
...
are not taken into account for computing the loss.`),Fe.forEach(t),Op=p(yt),rr=r(yt,"P",{});var Mf=i(rr);Dp=s(Mf,"Example:"),Mf.forEach(t),Ip=p(yt),ir=r(yt,"P",{});var $f=i(ir);Sp=s($f,`In the example below, we prepare a question + context pair for the LayoutLM model. It will give us a prediction
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Gi.forEach(t),vu=p(st),L(yo.$$.fragment,st),Mu=p(st),Je=r(st,"DIV",{class:!0});var Bo=i(Je);L(ps.$$.fragment,Bo),$u=p(Bo),Dt=r(Bo,"P",{});var ka=i(Dt);xu=s(ka,"The "),oa=r(ka,"A",{href:!0});var Uf=i(oa);ju=s(Uf,"TFLayoutLMForMaskedLM"),Uf.forEach(t),Fu=s(ka," forward method, overrides the "),fr=r(ka,"CODE",{});var Wf=i(fr);qu=s(Wf,"__call__"),Wf.forEach(t),zu=s(ka," special method."),ka.forEach(t),Eu=p(Bo),L(bo.$$.fragment,Bo),Cu=p(Bo),L(ko.$$.fragment,Bo),Bo.forEach(t),st.forEach(t),bi=p(o),It=r(o,"H2",{class:!0});var Ji=i(It);wo=r(Ji,"A",{id:!0,class:!0,href:!0});var Hf=i(wo);gr=r(Hf,"SPAN",{});var Qf=i(gr);L(us.$$.fragment,Qf),Qf.forEach(t),Hf.forEach(t),Au=p(Ji),_r=r(Ji,"SPAN",{});var Bf=i(_r);Pu=s(Bf,"TFLayoutLMForSequenceClassification"),Bf.forEach(t),Ji.forEach(t),ki=p(o),Ee=r(o,"DIV",{class:!0});var at=i(Ee);L(hs.$$.fragment,at),Nu=p(at),yr=r(at,"P",{});var Rf=i(yr);Ou=s(Rf,`LayoutLM Model transformer with a sequence classification/regression head on top (a linear layer on top of the
pooled output) e.g. for GLUE tasks.`),Rf.forEach(t),Du=p(at),ms=r(at,"P",{});var el=i(ms);Iu=s(el,"This model inherits from "),na=r(el,"A",{href:!0});var Kf=i(na);Su=s(Kf,"TFPreTrainedModel"),Kf.forEach(t),Uu=s(el,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
