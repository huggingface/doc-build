import{S as Gr,i as Wr,s as Br,e as n,k as c,w as k,t as r,M as Hr,c as s,d as o,m as h,a,x as b,h as i,b as l,F as e,g as u,y as v,q as y,o as w,B as T,v as Ur,L as nn}from"../../chunks/vendor-6b77c823.js";import{T as Nr}from"../../chunks/Tip-39098574.js";import{D as W}from"../../chunks/Docstring-1088f2fb.js";import{C as qt}from"../../chunks/CodeBlock-3a8b25a8.js";import{I as at}from"../../chunks/IconCopyLink-7a11ce68.js";import{E as on}from"../../chunks/ExampleCodeBlock-5212b321.js";function Vr(E){let m,$,g,f,M;return f=new qt({props:{code:`from transformers import M2M100Model, M2M100Config
...
<span class="hljs-meta">&gt;&gt;&gt; </span>model(**model_inputs, labels=labels)  <span class="hljs-comment"># should work</span>`}}),{c(){m=n("p"),$=r("Examples:"),g=c(),k(f.$$.fragment)},l(d){m=s(d,"P",{});var _=a(m);$=i(_,"Examples:"),_.forEach(o),g=h(d),b(f.$$.fragment,d)},m(d,_){u(d,m,_),e(m,$),u(d,g,_),v(f,d,_),M=!0},p:nn,i(d){M||(y(f.$$.fragment,d),M=!0)},o(d){w(f.$$.fragment,d),M=!1},d(d){d&&o(m),d&&o(g),T(f,d)}}}function Rr(E){let m,$,g,f,M;return{c(){m=n("p"),$=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),g=n("code"),f=r("Module"),M=r(`
...
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-built_in">print</span>(tokenizer.batch_decode(gen_tokens, skip_special_tokens=<span class="hljs-literal">True</span>))`}}),{c(){m=n("p"),$=r("Translation example:"),g=c(),k(f.$$.fragment)},l(d){m=s(d,"P",{});var _=a(m);$=i(_,"Translation example:"),_.forEach(o),g=h(d),b(f.$$.fragment,d)},m(d,_){u(d,m,_),e(m,$),u(d,g,_),v(f,d,_),M=!0},p:nn,i(d){M||(y(f.$$.fragment,d),M=!0)},o(d){w(f.$$.fragment,d),M=!1},d(d){d&&o(m),d&&o(g),T(f,d)}}}function Qr(E){let m,$,g,f,M,d,_,I,sn,fo,B,Y,xt,ve,an,Et,rn,_o,ee,dn,ye,ln,cn,go,rt,hn,Mo,it,Ct,pn,ko,te,mn,we,un,fn,bo,H,oe,jt,Te,_n,Ft,gn,vo,O,Mn,Pt,kn,bn,Ot,vn,yn,St,wn,Tn,yo,C,$n,dt,zn,qn,Lt,xn,En,At,Cn,jn,Dt,Fn,Pn,wo,lt,It,On,To,$e,$o,ct,ze,Nt,Sn,Ln,x,An,Gt,Dn,In,Wt,Nn,Gn,Bt,Wn,Bn,Ht,Hn,Un,Ut,Vn,Xn,zo,qe,qo,U,ne,Vt,xe,Rn,Xt,Jn,xo,j,Ee,Kn,V,Zn,ht,Qn,Yn,Ce,es,ts,os,X,ns,pt,ss,as,mt,rs,is,ds,se,Eo,R,ae,Rt,je,ls,Jt,cs,Co,z,Fe,hs,Pe,ps,Oe,ms,us,fs,Se,_s,ut,gs,Ms,ks,re,bs,S,Le,vs,Ae,ys,Kt,ws,Ts,$s,De,Ie,Zt,zs,qs,Qt,xs,Es,Ne,Yt,Cs,js,eo,Fs,Ps,to,Os,Ss,ie,Ge,Ls,We,As,oo,Ds,Is,Ns,N,Be,Gs,ft,Ws,_t,Bs,Hs,no,Us,Vs,gt,He,jo,J,de,so,Ue,Xs,ao,Rs,Fo,F,Ve,Js,Xe,Ks,Mt,Zs,Qs,Ys,Re,ea,Je,ta,oa,na,L,Ke,sa,K,aa,kt,ra,ia,ro,da,la,ca,le,ha,ce,Po,Z,he,io,Ze,pa,lo,ma,Oo,P,Qe,ua,Ye,fa,bt,_a,ga,Ma,et,ka,tt,ba,va,ya,A,ot,wa,Q,Ta,vt,$a,za,co,qa,xa,Ea,pe,Ca,me,So;return d=new at({}),ve=new at({}),Te=new at({}),$e=new qt({props:{code:`from transformers import M2M100Config, M2M100ForConditionalGeneration, M2M100Tokenizer
...
Whether or not the model should return the last key/values attentions (not used by all models).`,name:"use_cache"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/m2m_100/configuration_m2m_100.py#L34"}}),se=new on({props:{anchor:"transformers.M2M100Config.example",$$slots:{default:[Vr]},$$scope:{ctx:E}}}),je=new at({}),Fe=new W({props:{name:"class transformers.M2M100Tokenizer",anchor:"transformers.M2M100Tokenizer",parameters:[{name:"vocab_file",val:""},{name:"spm_file",val:""},{name:"src_lang",val:" = None"},{name:"tgt_lang",val:" = None"},{name:"bos_token",val:" = '<s>'"},{name:"eos_token",val:" = '</s>'"},{name:"sep_token",val:" = '</s>'"},{name:"pad_token",val:" = '<pad>'"},{name:"unk_token",val:" = '<unk>'"},{name:"language_codes",val:" = 'm2m100'"},{name:"sp_model_kwargs",val:": typing.Union[typing.Dict[str, typing.Any], NoneType] = None"},{name:"num_madeup_words",val:" = 8"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.M2M100Tokenizer.vocab_file",description:`<strong>vocab_file</strong> (<code>str</code>) &#x2014;
...
open-source our scripts so that others may reproduce the data, evaluation, and final M2M-100 model.`),ko=c(),te=n("p"),mn=r("This model was contributed by "),we=n("a"),un=r("valhalla"),fn=r("."),bo=c(),H=n("h3"),oe=n("a"),jt=n("span"),k(Te.$$.fragment),_n=c(),Ft=n("span"),gn=r("Training and Generation"),vo=c(),O=n("p"),Mn=r(`M2M100 is a multilingual encoder-decoder (seq-to-seq) model primarily intended for translation tasks. As the model is
multilingual it expects the sequences in a certain format: A special language id token is used as prefix in both the
source and target text. The source text format is `),Pt=n("code"),kn=r("[lang_code] X [eos]"),bn=r(", where "),Ot=n("code"),vn=r("lang_code"),yn=r(` is source language
...
multilingual it expects the sequences in a certain format: A special language id token is used as prefix in both the
source and target text. The source text format is `),Pt=s(ue,"CODE",{});var Wa=a(Pt);kn=i(Wa,"[lang_code] X [eos]"),Wa.forEach(o),bn=i(ue,", where "),Ot=s(ue,"CODE",{});var Ba=a(Ot);vn=i(Ba,"lang_code"),Ba.forEach(o),yn=i(ue,` is source language
...
documentation from `),mt=s(wt,"A",{href:!0});var cr=a(mt);rs=i(cr,"PretrainedConfig"),cr.forEach(o),is=i(wt," for more information."),wt.forEach(o),ds=h(fe),b(se.$$.fragment,fe),fe.forEach(o),Eo=h(t),R=s(t,"H2",{class:!0});var Go=a(R);ae=s(Go,"A",{id:!0,class:!0,href:!0});var hr=a(ae);Rt=s(hr,"SPAN",{});var pr=a(Rt);b(je.$$.fragment,pr),pr.forEach(o),hr.forEach(o),ls=h(Go),Jt=s(Go,"SPAN",{});var mr=a(Jt);cs=i(mr,"M2M100Tokenizer"),mr.forEach(o),Go.forEach(o),Co=h(t),z=s(t,"DIV",{class:!0});var q=a(z);b(Fe.$$.fragment,q),hs=h(q),Pe=s(q,"P",{});var Wo=a(Pe);ps=i(Wo,"Construct an M2M100 tokenizer. Based on "),Oe=s(Wo,"A",{href:!0,rel:!0});var ur=a(Oe);ms=i(ur,"SentencePiece"),ur.forEach(o),us=i(Wo,"."),Wo.forEach(o),fs=h(q),Se=s(q,"P",{});var Bo=a(Se);_s=i(Bo,"This tokenizer inherits from "),ut=s(Bo,"A",{href:!0});var fr=a(ut);gs=i(fr,"PreTrainedTokenizer"),fr.forEach(o),Ms=i(Bo,` which contains most of the main methods. Users should refer to
...
special tokens using the tokenizer `),oo=s(Jo,"CODE",{});var yr=a(oo);Ds=i(yr,"prepare_for_model"),yr.forEach(o),Is=i(Jo," method."),Jo.forEach(o),Ro.forEach(o),Ns=h(q),N=s(q,"DIV",{class:!0});var Tt=a(N);b(Be.$$.fragment,Tt),Gs=h(Tt),ft=s(Tt,"P",{});var ja=a(ft);Ws=i(ja,"Create the token type IDs corresponding to the sequences passed. "),_t=s(ja,"A",{href:!0});var wr=a(_t);Bs=i(wr,`What are token type
IDs?`),wr.forEach(o),ja.forEach(o),Hs=h(Tt),no=s(Tt,"P",{});var Tr=a(no);Us=i(Tr,"Should be overridden in a subclass if the model has a special way of building those."),Tr.forEach(o),Tt.forEach(o),Vs=h(q),gt=s(q,"DIV",{class:!0});var $r=a(gt);b(He.$$.fragment,$r),$r.forEach(o),q.forEach(o),jo=h(t),J=s(t,"H2",{class:!0});var Ko=a(J);de=s(Ko,"A",{id:!0,class:!0,href:!0});var zr=a(de);so=s(zr,"SPAN",{});var qr=a(so);b(Ue.$$.fragment,qr),qr.forEach(o),zr.forEach(o),Xs=h(Ko),ao=s(Ko,"SPAN",{});var xr=a(ao);Rs=i(xr,"M2M100Model"),xr.forEach(o),Ko.forEach(o),Fo=h(t),F=s(t,"DIV",{class:!0});var ge=a(F);b(Ve.$$.fragment,ge),Js=h(ge),Xe=s(ge,"P",{});var Zo=a(Xe);Ks=i(Zo,`The bare M2M100 Model outputting raw hidden-states without any specific head on top.
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Qo.forEach(o),na=h(ge),L=s(ge,"DIV",{class:!0});var Me=a(L);b(Ke.$$.fragment,Me),sa=h(Me),K=s(Me,"P",{});var $t=a(K);aa=i($t,"The "),kt=s($t,"A",{href:!0});var jr=a(kt);ra=i(jr,"M2M100Model"),jr.forEach(o),ia=i($t," forward method, overrides the "),ro=s($t,"CODE",{});var Fr=a(ro);da=i(Fr,"__call__"),Fr.forEach(o),la=i($t," special method."),$t.forEach(o),ca=h(Me),b(le.$$.fragment,Me),ha=h(Me),b(ce.$$.fragment,Me),Me.forEach(o),ge.forEach(o),Po=h(t),Z=s(t,"H2",{class:!0});var Yo=a(Z);he=s(Yo,"A",{id:!0,class:!0,href:!0});var Pr=a(he);io=s(Pr,"SPAN",{});var Or=a(io);b(Ze.$$.fragment,Or),Or.forEach(o),Pr.forEach(o),pa=h(Yo),lo=s(Yo,"SPAN",{});var Sr=a(lo);ma=i(Sr,"M2M100ForConditionalGeneration"),Sr.forEach(o),Yo.forEach(o),Oo=h(t),P=s(t,"DIV",{class:!0});var ke=a(P);b(Qe.$$.fragment,ke),ua=h(ke),Ye=s(ke,"P",{});var en=a(Ye);fa=i(en,`The M2M100 Model with a language modeling head. Can be used for summarization.
