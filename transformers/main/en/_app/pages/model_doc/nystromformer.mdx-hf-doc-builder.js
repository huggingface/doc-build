...
<span class="hljs-meta">&gt;&gt;&gt; </span>configuration = model.config`}}),{c(){s=a("p"),f=d("Example:"),r=g(),k(m.$$.fragment)},l(n){s=i(n,"P",{});var p=l(s);f=c(p,"Example:"),p.forEach(t),r=_(n),$(m.$$.fragment,n)},m(n,p){b(n,s,p),e(s,f),b(n,r,p),w(m,n,p),y=!0},p:D,i(n){y||(v(m.$$.fragment,n),y=!0)},o(n){T(m.$$.fragment,n),y=!1},d(n){n&&t(s),n&&t(r),N(m,n)}}}function ai(F){let s,f,r,m,y;return{c(){s=a("p"),f=d("Although the recipe for forward pass needs to be defined within this function, one should call the "),r=a("code"),m=d("Module"),y=d(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(n){s=i(n,"P",{});var p=l(s);f=c(p,"Although the recipe for forward pass needs to be defined within this function, one should call the "),r=i(p,"CODE",{});var M=l(r);m=c(M,"Module"),M.forEach(t),y=c(p,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),p.forEach(t)},m(n,p){b(n,s,p),e(s,f),e(s,r),e(r,m),e(s,y)},d(n){n&&t(s)}}}function ii(F){let s,f,r,m,y;return m=new W({props:{code:`from transformers import AutoTokenizer, NystromformerModel
import torch
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),{c(){s=a("p"),f=d("Example:"),r=g(),k(m.$$.fragment)},l(n){s=i(n,"P",{});var p=l(s);f=c(p,"Example:"),p.forEach(t),r=_(n),$(m.$$.fragment,n)},m(n,p){b(n,s,p),e(s,f),b(n,r,p),w(m,n,p),y=!0},p:D,i(n){y||(v(m.$$.fragment,n),y=!0)},o(n){T(m.$$.fragment,n),y=!1},d(n){n&&t(s),n&&t(r),N(m,n)}}}function li(F){let s,f,r,m,y;return{c(){s=a("p"),f=d("Although the recipe for forward pass needs to be defined within this function, one should call the "),r=a("code"),m=d("Module"),y=d(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(n){s=i(n,"P",{});var p=l(s);f=c(p,"Although the recipe for forward pass needs to be defined within this function, one should call the "),r=i(p,"CODE",{});var M=l(r);m=c(M,"Module"),M.forEach(t),y=c(p,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),p.forEach(t)},m(n,p){b(n,s,p),e(s,f),e(s,r),e(r,m),e(s,y)},d(n){n&&t(s)}}}function di(F){let s,f,r,m,y;return m=new W({props:{code:`from transformers import AutoTokenizer, NystromformerForMaskedLM
import torch
...
`}}),{c(){s=a("p"),f=d("Example:"),r=g(),k(m.$$.fragment)},l(n){s=i(n,"P",{});var p=l(s);f=c(p,"Example:"),p.forEach(t),r=_(n),$(m.$$.fragment,n)},m(n,p){b(n,s,p),e(s,f),b(n,r,p),w(m,n,p),y=!0},p:D,i(n){y||(v(m.$$.fragment,n),y=!0)},o(n){T(m.$$.fragment,n),y=!1},d(n){n&&t(s),n&&t(r),N(m,n)}}}function ci(F){let s,f;return s=new W({props:{code:`labels = tokenizer("The capital of France is Paris.", return_tensors="pt")["input_ids"]
...
`}}),{c(){k(s.$$.fragment)},l(r){$(s.$$.fragment,r)},m(r,m){w(s,r,m),f=!0},p:D,i(r){f||(v(s.$$.fragment,r),f=!0)},o(r){T(s.$$.fragment,r),f=!1},d(r){N(s,r)}}}function mi(F){let s,f,r,m,y;return{c(){s=a("p"),f=d("Although the recipe for forward pass needs to be defined within this function, one should call the "),r=a("code"),m=d("Module"),y=d(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(n){s=i(n,"P",{});var p=l(s);f=c(p,"Although the recipe for forward pass needs to be defined within this function, one should call the "),r=i(p,"CODE",{});var M=l(r);m=c(M,"Module"),M.forEach(t),y=c(p,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),p.forEach(t)},m(n,p){b(n,s,p),e(s,f),e(s,r),e(r,m),e(s,y)},d(n){n&&t(s)}}}function pi(F){let s,f,r,m,y;return m=new W({props:{code:`import torch
...
`}}),{c(){k(s.$$.fragment)},l(r){$(s.$$.fragment,r)},m(r,m){w(s,r,m),f=!0},p:D,i(r){f||(v(s.$$.fragment,r),f=!0)},o(r){T(s.$$.fragment,r),f=!1},d(r){N(s,r)}}}function hi(F){let s,f,r,m,y;return m=new W({props:{code:`import torch
from transformers import AutoTokenizer, NystromformerForSequenceClassification
...
<span class="hljs-meta">... </span>)
<span class="hljs-meta">&gt;&gt;&gt; </span>loss = model(**inputs, labels=labels).loss
<span class="hljs-meta">&gt;&gt;&gt; </span>loss.backward()`}}),{c(){k(s.$$.fragment)},l(r){$(s.$$.fragment,r)},m(r,m){w(s,r,m),f=!0},p:D,i(r){f||(v(s.$$.fragment,r),f=!0)},o(r){T(s.$$.fragment,r),f=!1},d(r){N(s,r)}}}function gi(F){let s,f,r,m,y;return{c(){s=a("p"),f=d("Although the recipe for forward pass needs to be defined within this function, one should call the "),r=a("code"),m=d("Module"),y=d(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(n){s=i(n,"P",{});var p=l(s);f=c(p,"Although the recipe for forward pass needs to be defined within this function, one should call the "),r=i(p,"CODE",{});var M=l(r);m=c(M,"Module"),M.forEach(t),y=c(p,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),p.forEach(t)},m(n,p){b(n,s,p),e(s,f),e(s,r),e(r,m),e(s,y)},d(n){n&&t(s)}}}function _i(F){let s,f,r,m,y;return m=new W({props:{code:`from transformers import AutoTokenizer, NystromformerForMultipleChoice
import torch
...
<span class="hljs-meta">&gt;&gt;&gt; </span>logits = outputs.logits`}}),{c(){s=a("p"),f=d("Example:"),r=g(),k(m.$$.fragment)},l(n){s=i(n,"P",{});var p=l(s);f=c(p,"Example:"),p.forEach(t),r=_(n),$(m.$$.fragment,n)},m(n,p){b(n,s,p),e(s,f),b(n,r,p),w(m,n,p),y=!0},p:D,i(n){y||(v(m.$$.fragment,n),y=!0)},o(n){T(m.$$.fragment,n),y=!1},d(n){n&&t(s),n&&t(r),N(m,n)}}}function yi(F){let s,f,r,m,y;return{c(){s=a("p"),f=d("Although the recipe for forward pass needs to be defined within this function, one should call the "),r=a("code"),m=d("Module"),y=d(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(n){s=i(n,"P",{});var p=l(s);f=c(p,"Although the recipe for forward pass needs to be defined within this function, one should call the "),r=i(p,"CODE",{});var M=l(r);m=c(M,"Module"),M.forEach(t),y=c(p,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),p.forEach(t)},m(n,p){b(n,s,p),e(s,f),e(s,r),e(r,m),e(s,y)},d(n){n&&t(s)}}}function bi(F){let s,f,r,m,y;return m=new W({props:{code:`from transformers import AutoTokenizer, NystromformerForTokenClassification
import torch
...
`}}),{c(){s=a("p"),f=d("Example:"),r=g(),k(m.$$.fragment)},l(n){s=i(n,"P",{});var p=l(s);f=c(p,"Example:"),p.forEach(t),r=_(n),$(m.$$.fragment,n)},m(n,p){b(n,s,p),e(s,f),b(n,r,p),w(m,n,p),y=!0},p:D,i(n){y||(v(m.$$.fragment,n),y=!0)},o(n){T(m.$$.fragment,n),y=!1},d(n){n&&t(s),n&&t(r),N(m,n)}}}function ki(F){let s,f;return s=new W({props:{code:`labels = predicted_token_class_ids
loss = model(**inputs, labels=labels).loss
round(loss.item(), 2)
`,highlighted:`<span class="hljs-meta">&gt;&gt;&gt; </span>labels = predicted_token_class_ids
<span class="hljs-meta">&gt;&gt;&gt; </span>loss = model(**inputs, labels=labels).loss
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-built_in">round</span>(loss.item(), <span class="hljs-number">2</span>)
`}}),{c(){k(s.$$.fragment)},l(r){$(s.$$.fragment,r)},m(r,m){w(s,r,m),f=!0},p:D,i(r){f||(v(s.$$.fragment,r),f=!0)},o(r){T(s.$$.fragment,r),f=!1},d(r){N(s,r)}}}function $i(F){let s,f,r,m,y;return{c(){s=a("p"),f=d("Although the recipe for forward pass needs to be defined within this function, one should call the "),r=a("code"),m=d("Module"),y=d(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(n){s=i(n,"P",{});var p=l(s);f=c(p,"Although the recipe for forward pass needs to be defined within this function, one should call the "),r=i(p,"CODE",{});var M=l(r);m=c(M,"Module"),M.forEach(t),y=c(p,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),p.forEach(t)},m(n,p){b(n,s,p),e(s,f),e(s,r),e(r,m),e(s,y)},d(n){n&&t(s)}}}function wi(F){let s,f,r,m,y;return m=new W({props:{code:`from transformers import AutoTokenizer, NystromformerForQuestionAnswering
import torch
...
`}}),{c(){s=a("p"),f=d("Example:"),r=g(),k(m.$$.fragment)},l(n){s=i(n,"P",{});var p=l(s);f=c(p,"Example:"),p.forEach(t),r=_(n),$(m.$$.fragment,n)},m(n,p){b(n,s,p),e(s,f),b(n,r,p),w(m,n,p),y=!0},p:D,i(n){y||(v(m.$$.fragment,n),y=!0)},o(n){T(m.$$.fragment,n),y=!1},d(n){n&&t(s),n&&t(r),N(m,n)}}}function vi(F){let s,f;return s=new W({props:{code:`# target is "nice puppet"
...
<span class="hljs-meta">&gt;&gt;&gt; </span>loss = outputs.loss
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-built_in">round</span>(loss.item(), <span class="hljs-number">2</span>)
`}}),{c(){k(s.$$.fragment)},l(r){$(s.$$.fragment,r)},m(r,m){w(s,r,m),f=!0},p:D,i(r){f||(v(s.$$.fragment,r),f=!0)},o(r){T(s.$$.fragment,r),f=!1},d(r){N(s,r)}}}function Ti(F){let s,f,r,m,y,n,p,M,zn,Zt,Y,ge,lt,Je,jn,dt,Cn,Xt,_e,An,Ze,ct,En,Pn,en,Lo,On,on,Io,mt,Sn,tn,R,Ln,Xe,In,Dn,eo,Wn,Qn,nn,J,ye,pt,oo,Hn,ft,Un,sn,A,to,Bn,Z,Rn,Do,Vn,Gn,no,Kn,Yn,Jn,X,Zn,Wo,Xn,es,Qo,os,ts,ns,be,rn,ee,ke,ht,so,ss,ut,rs,an,U,ro,as,ao,is,io,ls,ds,cs,Q,lo,ms,oe,ps,Ho,fs,hs,gt,us,gs,_s,$e,ys,we,ln,te,ve,_t,co,bs,yt,ks,dn,B,mo,$s,ne,ws,bt,vs,Ts,po,Ns,Fs,Ms,q,fo,xs,se,qs,Uo,zs,js,kt,Cs,As,Es,Te,Ps,Ne,Os,Fe,cn,re,Me,$t,ho,Ss,wt,Ls,mn,E,uo,Is,vt,Ds,Ws,go,Qs,_o,Hs,Us,Bs,x,yo,Rs,ae,Vs,Bo,Gs,Ks,Tt,Ys,Js,Zs,xe,Xs,qe,er,ze,or,je,tr,Ce,pn,ie,Ae,Nt,bo,nr,Ft,sr,fn,P,ko,rr,Mt,ar,ir,$o,lr,wo,dr,cr,mr,H,vo,pr,le,fr,Ro,hr,ur,xt,gr,_r,yr,Ee,br,Pe,hn,de,Oe,qt,To,kr,zt,$r,un,O,No,wr,jt,vr,Tr,Fo,Nr,Mo,Fr,Mr,xr,z,xo,qr,ce,zr,Vo,jr,Cr,Ct,Ar,Er,Pr,Se,Or,Le,Sr,Ie,gn,me,De,At,qo,Lr,Et,Ir,_n,S,zo,Dr,pe,Wr,Pt,Qr,Hr,Ot,Ur,Br,Rr,jo,Vr,Co,Gr,Kr,Yr,j,Ao,Jr,fe,Zr,Go,Xr,ea,St,oa,ta,na,We,sa,Qe,ra,He,yn;return n=new ue({}),Je=new ue({}),oo=new ue({}),to=new L({props:{name:"class transformers.NystromformerConfig",anchor:"transformers.NystromformerConfig",parameters:[{name:"vocab_size",val:" = 30000"},{name:"hidden_size",val:" = 768"},{name:"num_hidden_layers",val:" = 12"},{name:"num_attention_heads",val:" = 12"},{name:"intermediate_size",val:" = 3072"},{name:"hidden_act",val:" = 'gelu_new'"},{name:"hidden_dropout_prob",val:" = 0.1"},{name:"attention_probs_dropout_prob",val:" = 0.1"},{name:"max_position_embeddings",val:" = 510"},{name:"type_vocab_size",val:" = 2"},{name:"segment_means_seq_len",val:" = 64"},{name:"num_landmarks",val:" = 64"},{name:"conv_kernel_size",val:" = 65"},{name:"inv_coeff_init_option",val:" = False"},{name:"initializer_range",val:" = 0.02"},{name:"layer_norm_eps",val:" = 1e-05"},{name:"pad_token_id",val:" = 1"},{name:"bos_token_id",val:" = 0"},{name:"eos_token_id",val:" = 2"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.NystromformerConfig.vocab_size",description:`<strong>vocab_size</strong> (<code>int</code>, <em>optional</em>, defaults to 30000) &#x2014;
...
loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/nystromformer/modeling_nystromformer.py#L678",returnDescription:`
<p>A <a
...
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/nystromformer/modeling_nystromformer.py#L776",returnDescription:`
<p>A <a
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/main/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/nystromformer/modeling_nystromformer.py#L860"}}),vo=new L({props:{name:"forward",anchor:"transformers.NystromformerForMultipleChoice.forward",parameters:[{name:"input_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"attention_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"token_type_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"position_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"head_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"labels",val:": typing.Optional[torch.LongTensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.NystromformerForMultipleChoice.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, num_choices, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/main/en/model_doc/auto#transformers.AutoTokenizer">AutoTokenizer</a>. See <a href="/docs/transformers/main/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/main/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
<code>input_ids</code> above)`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/nystromformer/modeling_nystromformer.py#L871",returnDescription:`
<p>A <a
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/main/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/nystromformer/modeling_nystromformer.py#L956"}}),xo=new L({props:{name:"forward",anchor:"transformers.NystromformerForTokenClassification.forward",parameters:[{name:"input_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"attention_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"token_type_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"position_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"head_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"labels",val:": typing.Optional[torch.LongTensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.NystromformerForTokenClassification.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/main/en/model_doc/auto#transformers.AutoTokenizer">AutoTokenizer</a>. See <a href="/docs/transformers/main/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/main/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/nystromformer/modeling_nystromformer.py#L968",returnDescription:`
<p>A <a
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/main/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/nystromformer/modeling_nystromformer.py#L1035"}}),Ao=new L({props:{name:"forward",anchor:"transformers.NystromformerForQuestionAnswering.forward",parameters:[{name:"input_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"attention_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"token_type_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"position_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"head_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"start_positions",val:": typing.Optional[torch.LongTensor] = None"},{name:"end_positions",val:": typing.Optional[torch.LongTensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.NystromformerForQuestionAnswering.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/main/en/model_doc/auto#transformers.AutoTokenizer">AutoTokenizer</a>. See <a href="/docs/transformers/main/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/main/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/nystromformer/modeling_nystromformer.py#L1048",returnDescription:`
<p>A <a
...
favorably relative to other efficient self-attention methods. Our code is available at this https URL.`),tn=g(),R=a("p"),Ln=d("This model was contributed by "),Xe=a("a"),In=d("novice03"),Dn=d(". The original code can be found "),eo=a("a"),Wn=d("here"),Qn=d("."),nn=g(),J=a("h2"),ye=a("a"),pt=a("span"),k(oo.$$.fragment),Hn=g(),ft=a("span"),Un=d("NystromformerConfig"),sn=g(),A=a("div"),k(to.$$.fragment),Bn=g(),Z=a("p"),Rn=d("This is the configuration class to store the configuration of a "),Do=a("a"),Vn=d("NystromformerModel"),Gn=d(`. It is used to instantiate
...
documentation from `),Qo=a("a"),os=d("PretrainedConfig"),ts=d(" for more information."),ns=g(),k(be.$$.fragment),rn=g(),ee=a("h2"),ke=a("a"),ht=a("span"),k(so.$$.fragment),ss=g(),ut=a("span"),rs=d("NystromformerModel"),an=g(),U=a("div"),k(ro.$$.fragment),as=g(),ao=a("p"),is=d(`The bare Nystr\xF6mformer Model transformer outputting raw hidden-states without any specific head on top.
This model is a PyTorch `),io=a("a"),ls=d("torch.nn.Module"),ds=d(` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),cs=g(),Q=a("div"),k(lo.$$.fragment),ms=g(),oe=a("p"),ps=d("The "),Ho=a("a"),fs=d("NystromformerModel"),hs=d(" forward method, overrides the "),gt=a("code"),us=d("__call__"),gs=d(" special method."),_s=g(),k($e.$$.fragment),ys=g(),k(we.$$.fragment),ln=g(),te=a("h2"),ve=a("a"),_t=a("span"),k(co.$$.fragment),bs=g(),yt=a("span"),ks=d("NystromformerForMaskedLM"),dn=g(),B=a("div"),k(mo.$$.fragment),$s=g(),ne=a("p"),ws=d("Nystr\xF6mformer Model with a "),bt=a("code"),vs=d("language modeling"),Ts=d(` head on top.
This model is a PyTorch `),po=a("a"),Ns=d("torch.nn.Module"),Fs=d(` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),Ms=g(),q=a("div"),k(fo.$$.fragment),xs=g(),se=a("p"),qs=d("The "),Uo=a("a"),zs=d("NystromformerForMaskedLM"),js=d(" forward method, overrides the "),kt=a("code"),Cs=d("__call__"),As=d(" special method."),Es=g(),k(Te.$$.fragment),Ps=g(),k(Ne.$$.fragment),Os=g(),k(Fe.$$.fragment),cn=g(),re=a("h2"),Me=a("a"),$t=a("span"),k(ho.$$.fragment),Ss=g(),wt=a("span"),Ls=d("NystromformerForSequenceClassification"),mn=g(),E=a("div"),k(uo.$$.fragment),Is=g(),vt=a("p"),Ds=d(`Nystr\xF6mformer Model transformer with a sequence classification/regression head on top (a linear layer on top of the
pooled output) e.g. for GLUE tasks.`),Ws=g(),go=a("p"),Qs=d("This model is a PyTorch "),_o=a("a"),Hs=d("torch.nn.Module"),Us=d(` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),Bs=g(),x=a("div"),k(yo.$$.fragment),Rs=g(),ae=a("p"),Vs=d("The "),Bo=a("a"),Gs=d("NystromformerForSequenceClassification"),Ks=d(" forward method, overrides the "),Tt=a("code"),Ys=d("__call__"),Js=d(" special method."),Zs=g(),k(xe.$$.fragment),Xs=g(),k(qe.$$.fragment),er=g(),k(ze.$$.fragment),or=g(),k(je.$$.fragment),tr=g(),k(Ce.$$.fragment),pn=g(),ie=a("h2"),Ae=a("a"),Nt=a("span"),k(bo.$$.fragment),nr=g(),Ft=a("span"),sr=d("NystromformerForMultipleChoice"),fn=g(),P=a("div"),k(ko.$$.fragment),rr=g(),Mt=a("p"),ar=d(`Nystr\xF6mformer Model with a multiple choice classification head on top (a linear layer on top of the pooled output
...
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),Yr=g(),j=a("div"),k(Ao.$$.fragment),Jr=g(),fe=a("p"),Zr=d("The "),Go=a("a"),Xr=d("NystromformerForQuestionAnswering"),ea=d(" forward method, overrides the "),St=a("code"),oa=d("__call__"),ta=d(" special method."),na=g(),k(We.$$.fragment),sa=g(),k(Qe.$$.fragment),ra=g(),k(He.$$.fragment),this.h()},l(o){const h=ni('[data-svelte="svelte-1phssyn"]',document.head);s=i(h,"META",{name:!0,content:!0}),h.forEach(t),f=_(o),r=i(o,"H1",{class:!0});var Eo=l(r);m=i(Eo,"A",{id:!0,class:!0,href:!0});var Lt=l(m);y=i(Lt,"SPAN",{});var It=l(y);$(n.$$.fragment,It),It.forEach(t),Lt.forEach(t),p=_(Eo),M=i(Eo,"SPAN",{});var Dt=l(M);zn=c(Dt,"Nystr\xF6mformer"),Dt.forEach(t),Eo.forEach(t),Zt=_(o),Y=i(o,"H2",{class:!0});var Po=l(Y);ge=i(Po,"A",{id:!0,class:!0,href:!0});var Wt=l(ge);lt=i(Wt,"SPAN",{});var Qt=l(lt);$(Je.$$.fragment,Qt),Qt.forEach(t),Wt.forEach(t),jn=_(Po),dt=i(Po,"SPAN",{});var Ht=l(dt);Cn=c(Ht,"Overview"),Ht.forEach(t),Po.forEach(t),Xt=_(o),_e=i(o,"P",{});var Oo=l(_e);An=c(Oo,"The Nystr\xF6mformer model was proposed in "),Ze=i(Oo,"A",{href:!0,rel:!0});var Ut=l(Ze);ct=i(Ut,"EM",{});var Bt=l(ct);En=c(Bt,"Nystr\xF6mformer: A Nystr\xF6m-Based Algorithm for Approximating Self-Attention"),Bt.forEach(t),Ut.forEach(t),Pn=c(Oo,` by Yunyang Xiong, Zhanpeng Zeng, Rudrasis Chakraborty, Mingxing Tan, Glenn
...
sequence length, and find that our Nystr\xF6mformer performs comparably, or in a few cases, even slightly better, than
standard self-attention. On longer sequence tasks in the Long Range Arena (LRA) benchmark, Nystr\xF6mformer performs
favorably relative to other efficient self-attention methods. Our code is available at this https URL.`),Gt.forEach(t),Vt.forEach(t),tn=_(o),R=i(o,"P",{});var he=l(R);Ln=c(he,"This model was contributed by "),Xe=i(he,"A",{href:!0,rel:!0});var Kt=l(Xe);In=c(Kt,"novice03"),Kt.forEach(t),Dn=c(he,". The original code can be found "),eo=i(he,"A",{href:!0,rel:!0});var Yt=l(eo);Wn=c(Yt,"here"),Yt.forEach(t),Qn=c(he,"."),he.forEach(t),nn=_(o),J=i(o,"H2",{class:!0});var So=l(J);ye=i(So,"A",{id:!0,class:!0,href:!0});var Jt=l(ye);pt=i(Jt,"SPAN",{});var aa=l(pt);$(oo.$$.fragment,aa),aa.forEach(t),Jt.forEach(t),Hn=_(So),ft=i(So,"SPAN",{});var ia=l(ft);Un=c(ia,"NystromformerConfig"),ia.forEach(t),So.forEach(t),sn=_(o),A=i(o,"DIV",{class:!0});var Ue=l(A);$(to.$$.fragment,Ue),Bn=_(Ue),Z=i(Ue,"P",{});var Ko=l(Z);Rn=c(Ko,"This is the configuration class to store the configuration of a "),Do=i(Ko,"A",{href:!0});var la=l(Do);Vn=c(la,"NystromformerModel"),la.forEach(t),Gn=c(Ko,`. It is used to instantiate
an Nystromformer model according to the specified arguments, defining the model architecture. Instantiating a
configuration with the defaults will yield a similar configuration to that of the Nystromformer
`),no=i(Ko,"A",{href:!0,rel:!0});var da=l(no);Kn=c(da,"uw-madison/nystromformer-512"),da.forEach(t),Yn=c(Ko," architecture."),Ko.forEach(t),Jn=_(Ue),X=i(Ue,"P",{});var Yo=l(X);Zn=c(Yo,"Configuration objects inherit from "),Wo=i(Yo,"A",{href:!0});var ca=l(Wo);Xn=c(ca,"PretrainedConfig"),ca.forEach(t),es=c(Yo,` and can be used to control the model outputs. Read the
documentation from `),Qo=i(Yo,"A",{href:!0});var ma=l(Qo);os=c(ma,"PretrainedConfig"),ma.forEach(t),ts=c(Yo," for more information."),Yo.forEach(t),ns=_(Ue),$(be.$$.fragment,Ue),Ue.forEach(t),rn=_(o),ee=i(o,"H2",{class:!0});var bn=l(ee);ke=i(bn,"A",{id:!0,class:!0,href:!0});var pa=l(ke);ht=i(pa,"SPAN",{});var fa=l(ht);$(so.$$.fragment,fa),fa.forEach(t),pa.forEach(t),ss=_(bn),ut=i(bn,"SPAN",{});var ha=l(ut);rs=c(ha,"NystromformerModel"),ha.forEach(t),bn.forEach(t),an=_(o),U=i(o,"DIV",{class:!0});var Jo=l(U);$(ro.$$.fragment,Jo),as=_(Jo),ao=i(Jo,"P",{});var kn=l(ao);is=c(kn,`The bare Nystr\xF6mformer Model transformer outputting raw hidden-states without any specific head on top.
This model is a PyTorch `),io=i(kn,"A",{href:!0,rel:!0});var ua=l(io);ls=c(ua,"torch.nn.Module"),ua.forEach(t),ds=c(kn,` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),kn.forEach(t),cs=_(Jo),Q=i(Jo,"DIV",{class:!0});var Be=l(Q);$(lo.$$.fragment,Be),ms=_(Be),oe=i(Be,"P",{});var Zo=l(oe);ps=c(Zo,"The "),Ho=i(Zo,"A",{href:!0});var ga=l(Ho);fs=c(ga,"NystromformerModel"),ga.forEach(t),hs=c(Zo," forward method, overrides the "),gt=i(Zo,"CODE",{});var _a=l(gt);us=c(_a,"__call__"),_a.forEach(t),gs=c(Zo," special method."),Zo.forEach(t),_s=_(Be),$($e.$$.fragment,Be),ys=_(Be),$(we.$$.fragment,Be),Be.forEach(t),Jo.forEach(t),ln=_(o),te=i(o,"H2",{class:!0});var $n=l(te);ve=i($n,"A",{id:!0,class:!0,href:!0});var ya=l(ve);_t=i(ya,"SPAN",{});var ba=l(_t);$(co.$$.fragment,ba),ba.forEach(t),ya.forEach(t),bs=_($n),yt=i($n,"SPAN",{});var ka=l(yt);ks=c(ka,"NystromformerForMaskedLM"),ka.forEach(t),$n.forEach(t),dn=_(o),B=i(o,"DIV",{class:!0});var Xo=l(B);$(mo.$$.fragment,Xo),$s=_(Xo),ne=i(Xo,"P",{});var et=l(ne);ws=c(et,"Nystr\xF6mformer Model with a "),bt=i(et,"CODE",{});var $a=l(bt);vs=c($a,"language modeling"),$a.forEach(t),Ts=c(et,` head on top.
This model is a PyTorch `),po=i(et,"A",{href:!0,rel:!0});var wa=l(po);Ns=c(wa,"torch.nn.Module"),wa.forEach(t),Fs=c(et,` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),et.forEach(t),Ms=_(Xo),q=i(Xo,"DIV",{class:!0});var V=l(q);$(fo.$$.fragment,V),xs=_(V),se=i(V,"P",{});var ot=l(se);qs=c(ot,"The "),Uo=i(ot,"A",{href:!0});var va=l(Uo);zs=c(va,"NystromformerForMaskedLM"),va.forEach(t),js=c(ot," forward method, overrides the "),kt=i(ot,"CODE",{});var Ta=l(kt);Cs=c(Ta,"__call__"),Ta.forEach(t),As=c(ot," special method."),ot.forEach(t),Es=_(V),$(Te.$$.fragment,V),Ps=_(V),$(Ne.$$.fragment,V),Os=_(V),$(Fe.$$.fragment,V),V.forEach(t),Xo.forEach(t),cn=_(o),re=i(o,"H2",{class:!0});var wn=l(re);Me=i(wn,"A",{id:!0,class:!0,href:!0});var Na=l(Me);$t=i(Na,"SPAN",{});var Fa=l($t);$(ho.$$.fragment,Fa),Fa.forEach(t),Na.forEach(t),Ss=_(wn),wt=i(wn,"SPAN",{});var Ma=l(wt);Ls=c(Ma,"NystromformerForSequenceClassification"),Ma.forEach(t),wn.forEach(t),mn=_(o),E=i(o,"DIV",{class:!0});var Re=l(E);$(uo.$$.fragment,Re),Is=_(Re),vt=i(Re,"P",{});var xa=l(vt);Ds=c(xa,`Nystr\xF6mformer Model transformer with a sequence classification/regression head on top (a linear layer on top of the
pooled output) e.g. for GLUE tasks.`),xa.forEach(t),Ws=_(Re),go=i(Re,"P",{});var vn=l(go);Qs=c(vn,"This model is a PyTorch "),_o=i(vn,"A",{href:!0,rel:!0});var qa=l(_o);Hs=c(qa,"torch.nn.Module"),qa.forEach(t),Us=c(vn,` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),vn.forEach(t),Bs=_(Re),x=i(Re,"DIV",{class:!0});var C=l(x);$(yo.$$.fragment,C),Rs=_(C),ae=i(C,"P",{});var tt=l(ae);Vs=c(tt,"The "),Bo=i(tt,"A",{href:!0});var za=l(Bo);Gs=c(za,"NystromformerForSequenceClassification"),za.forEach(t),Ks=c(tt," forward method, overrides the "),Tt=i(tt,"CODE",{});var ja=l(Tt);Ys=c(ja,"__call__"),ja.forEach(t),Js=c(tt," special method."),tt.forEach(t),Zs=_(C),$(xe.$$.fragment,C),Xs=_(C),$(qe.$$.fragment,C),er=_(C),$(ze.$$.fragment,C),or=_(C),$(je.$$.fragment,C),tr=_(C),$(Ce.$$.fragment,C),C.forEach(t),Re.forEach(t),pn=_(o),ie=i(o,"H2",{class:!0});var Tn=l(ie);Ae=i(Tn,"A",{id:!0,class:!0,href:!0});var Ca=l(Ae);Nt=i(Ca,"SPAN",{});var Aa=l(Nt);$(bo.$$.fragment,Aa),Aa.forEach(t),Ca.forEach(t),nr=_(Tn),Ft=i(Tn,"SPAN",{});var Ea=l(Ft);sr=c(Ea,"NystromformerForMultipleChoice"),Ea.forEach(t),Tn.forEach(t),fn=_(o),P=i(o,"DIV",{class:!0});var Ve=l(P);$(ko.$$.fragment,Ve),rr=_(Ve),Mt=i(Ve,"P",{});var Pa=l(Mt);ar=c(Pa,`Nystr\xF6mformer Model with a multiple choice classification head on top (a linear layer on top of the pooled output
