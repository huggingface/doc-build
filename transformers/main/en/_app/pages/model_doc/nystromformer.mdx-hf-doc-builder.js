...
favorably relative to other efficient self-attention methods. Our code is available at this https URL.`),tn=g(),B=a("p"),Ln=d("This model was contributed by "),Xe=a("a"),In=d("novice03"),Dn=d(". The original code can be found "),eo=a("a"),Wn=d("here"),Qn=d("."),nn=g(),J=a("h2"),ye=a("a"),pt=a("span"),k(oo.$$.fragment),Hn=g(),ft=a("span"),Vn=d("NystromformerConfig"),sn=g(),A=a("div"),k(to.$$.fragment),Un=g(),Z=a("p"),Bn=d("This is the configuration class to store the configuration of a "),Do=a("a"),Rn=d("NystromformerModel"),Gn=d(`. It is used to instantiate
...
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),Yr=g(),j=a("div"),k(Ao.$$.fragment),Jr=g(),fe=a("p"),Zr=d("The "),Go=a("a"),Xr=d("NystromformerForQuestionAnswering"),ea=d(" forward method, overrides the "),St=a("code"),oa=d("__call__"),ta=d(" special method."),na=g(),k(We.$$.fragment),sa=g(),k(Qe.$$.fragment),ra=g(),k(He.$$.fragment),this.h()},l(o){const h=ni('[data-svelte="svelte-1phssyn"]',document.head);s=i(h,"META",{name:!0,content:!0}),h.forEach(t),f=_(o),r=i(o,"H1",{class:!0});var Eo=l(r);m=i(Eo,"A",{id:!0,class:!0,href:!0});var Lt=l(m);y=i(Lt,"SPAN",{});var It=l(y);w(n.$$.fragment,It),It.forEach(t),Lt.forEach(t),p=_(Eo),F=i(Eo,"SPAN",{});var Dt=l(F);zn=c(Dt,"Nystr\xF6mformer"),Dt.forEach(t),Eo.forEach(t),Zt=_(o),Y=i(o,"H2",{class:!0});var Po=l(Y);ge=i(Po,"A",{id:!0,class:!0,href:!0});var Wt=l(ge);lt=i(Wt,"SPAN",{});var Qt=l(lt);w(Je.$$.fragment,Qt),Qt.forEach(t),Wt.forEach(t),jn=_(Po),dt=i(Po,"SPAN",{});var Ht=l(dt);Cn=c(Ht,"Overview"),Ht.forEach(t),Po.forEach(t),Xt=_(o),_e=i(o,"P",{});var Oo=l(_e);An=c(Oo,"The Nystr\xF6mformer model was proposed in "),Ze=i(Oo,"A",{href:!0,rel:!0});var Vt=l(Ze);ct=i(Vt,"EM",{});var Ut=l(ct);En=c(Ut,"Nystr\xF6mformer: A Nystr\xF6m-Based Algorithm for Approximating Self-Attention"),Ut.forEach(t),Vt.forEach(t),Pn=c(Oo,` by Yunyang Xiong, Zhanpeng Zeng, Rudrasis Chakraborty, Mingxing Tan, Glenn
Fung, Yin Li, and Vikas Singh.`),Oo.forEach(t),en=_(o),Lo=i(o,"P",{});var Bt=l(Lo);On=c(Bt,"The abstract from the paper is the following:"),Bt.forEach(t),on=_(o),Io=i(o,"P",{});var Rt=l(Io);mt=i(Rt,"EM",{});var Gt=l(mt);Sn=c(Gt,`Transformers have emerged as a powerful tool for a broad range of natural language processing tasks. A key component
that drives the impressive performance of Transformers is the self-attention mechanism that encodes the influence or
dependence of other tokens on each specific token. While beneficial, the quadratic complexity of self-attention on the
input sequence length has limited its application to longer sequences \u2014 a topic being actively studied in the
community. To address this limitation, we propose Nystr\xF6mformer \u2014 a model that exhibits favorable scalability as a
...
sequence length, and find that our Nystr\xF6mformer performs comparably, or in a few cases, even slightly better, than
standard self-attention. On longer sequence tasks in the Long Range Arena (LRA) benchmark, Nystr\xF6mformer performs
favorably relative to other efficient self-attention methods. Our code is available at this https URL.`),Gt.forEach(t),Rt.forEach(t),tn=_(o),B=i(o,"P",{});var he=l(B);Ln=c(he,"This model was contributed by "),Xe=i(he,"A",{href:!0,rel:!0});var Kt=l(Xe);In=c(Kt,"novice03"),Kt.forEach(t),Dn=c(he,". The original code can be found "),eo=i(he,"A",{href:!0,rel:!0});var Yt=l(eo);Wn=c(Yt,"here"),Yt.forEach(t),Qn=c(he,"."),he.forEach(t),nn=_(o),J=i(o,"H2",{class:!0});var So=l(J);ye=i(So,"A",{id:!0,class:!0,href:!0});var Jt=l(ye);pt=i(Jt,"SPAN",{});var aa=l(pt);w(oo.$$.fragment,aa),aa.forEach(t),Jt.forEach(t),Hn=_(So),ft=i(So,"SPAN",{});var ia=l(ft);Vn=c(ia,"NystromformerConfig"),ia.forEach(t),So.forEach(t),sn=_(o),A=i(o,"DIV",{class:!0});var Ve=l(A);w(to.$$.fragment,Ve),Un=_(Ve),Z=i(Ve,"P",{});var Ko=l(Z);Bn=c(Ko,"This is the configuration class to store the configuration of a "),Do=i(Ko,"A",{href:!0});var la=l(Do);Rn=c(la,"NystromformerModel"),la.forEach(t),Gn=c(Ko,`. It is used to instantiate
an Nystromformer model according to the specified arguments, defining the model architecture. Instantiating a
configuration with the defaults will yield a similar configuration to that of the Nystromformer
`),no=i(Ko,"A",{href:!0,rel:!0});var da=l(no);Kn=c(da,"uw-madison/nystromformer-512"),da.forEach(t),Yn=c(Ko," architecture."),Ko.forEach(t),Jn=_(Ve),X=i(Ve,"P",{});var Yo=l(X);Zn=c(Yo,"Configuration objects inherit from "),Wo=i(Yo,"A",{href:!0});var ca=l(Wo);Xn=c(ca,"PretrainedConfig"),ca.forEach(t),es=c(Yo,` and can be used to control the model outputs. Read the
documentation from `),Qo=i(Yo,"A",{href:!0});var ma=l(Qo);os=c(ma,"PretrainedConfig"),ma.forEach(t),ts=c(Yo," for more information."),Yo.forEach(t),ns=_(Ve),w(be.$$.fragment,Ve),Ve.forEach(t),rn=_(o),ee=i(o,"H2",{class:!0});var bn=l(ee);ke=i(bn,"A",{id:!0,class:!0,href:!0});var pa=l(ke);ht=i(pa,"SPAN",{});var fa=l(ht);w(so.$$.fragment,fa),fa.forEach(t),pa.forEach(t),ss=_(bn),ut=i(bn,"SPAN",{});var ha=l(ut);rs=c(ha,"NystromformerModel"),ha.forEach(t),bn.forEach(t),an=_(o),V=i(o,"DIV",{class:!0});var Jo=l(V);w(ro.$$.fragment,Jo),as=_(Jo),ao=i(Jo,"P",{});var kn=l(ao);is=c(kn,`The bare Nystr\xF6mformer Model transformer outputting raw hidden-states without any specific head on top.
This model is a PyTorch `),io=i(kn,"A",{href:!0,rel:!0});var ua=l(io);ls=c(ua,"torch.nn.Module"),ua.forEach(t),ds=c(kn,` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),kn.forEach(t),cs=_(Jo),Q=i(Jo,"DIV",{class:!0});var Ue=l(Q);w(lo.$$.fragment,Ue),ms=_(Ue),oe=i(Ue,"P",{});var Zo=l(oe);ps=c(Zo,"The "),Ho=i(Zo,"A",{href:!0});var ga=l(Ho);fs=c(ga,"NystromformerModel"),ga.forEach(t),hs=c(Zo," forward method, overrides the "),gt=i(Zo,"CODE",{});var _a=l(gt);us=c(_a,"__call__"),_a.forEach(t),gs=c(Zo," special method."),Zo.forEach(t),_s=_(Ue),w(we.$$.fragment,Ue),ys=_(Ue),w($e.$$.fragment,Ue),Ue.forEach(t),Jo.forEach(t),ln=_(o),te=i(o,"H2",{class:!0});var wn=l(te);ve=i(wn,"A",{id:!0,class:!0,href:!0});var ya=l(ve);_t=i(ya,"SPAN",{});var ba=l(_t);w(co.$$.fragment,ba),ba.forEach(t),ya.forEach(t),bs=_(wn),yt=i(wn,"SPAN",{});var ka=l(yt);ks=c(ka,"NystromformerForMaskedLM"),ka.forEach(t),wn.forEach(t),dn=_(o),U=i(o,"DIV",{class:!0});var Xo=l(U);w(mo.$$.fragment,Xo),ws=_(Xo),ne=i(Xo,"P",{});var et=l(ne);$s=c(et,"Nystr\xF6mformer Model with a "),bt=i(et,"CODE",{});var wa=l(bt);vs=c(wa,"language modeling"),wa.forEach(t),Ts=c(et,` head on top.
This model is a PyTorch `),po=i(et,"A",{href:!0,rel:!0});var $a=l(po);Ns=c($a,"torch.nn.Module"),$a.forEach(t),Ms=c(et,` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),et.forEach(t),Fs=_(Xo),q=i(Xo,"DIV",{class:!0});var R=l(q);w(fo.$$.fragment,R),xs=_(R),se=i(R,"P",{});var ot=l(se);qs=c(ot,"The "),Vo=i(ot,"A",{href:!0});var va=l(Vo);zs=c(va,"NystromformerForMaskedLM"),va.forEach(t),js=c(ot," forward method, overrides the "),kt=i(ot,"CODE",{});var Ta=l(kt);Cs=c(Ta,"__call__"),Ta.forEach(t),As=c(ot," special method."),ot.forEach(t),Es=_(R),w(Te.$$.fragment,R),Ps=_(R),w(Ne.$$.fragment,R),Os=_(R),w(Me.$$.fragment,R),R.forEach(t),Xo.forEach(t),cn=_(o),re=i(o,"H2",{class:!0});var $n=l(re);Fe=i($n,"A",{id:!0,class:!0,href:!0});var Na=l(Fe);wt=i(Na,"SPAN",{});var Ma=l(wt);w(ho.$$.fragment,Ma),Ma.forEach(t),Na.forEach(t),Ss=_($n),$t=i($n,"SPAN",{});var Fa=l($t);Ls=c(Fa,"NystromformerForSequenceClassification"),Fa.forEach(t),$n.forEach(t),mn=_(o),E=i(o,"DIV",{class:!0});var Be=l(E);w(uo.$$.fragment,Be),Is=_(Be),vt=i(Be,"P",{});var xa=l(vt);Ds=c(xa,`Nystr\xF6mformer Model transformer with a sequence classification/regression head on top (a linear layer on top of the
pooled output) e.g. for GLUE tasks.`),xa.forEach(t),Ws=_(Be),go=i(Be,"P",{});var vn=l(go);Qs=c(vn,"This model is a PyTorch "),_o=i(vn,"A",{href:!0,rel:!0});var qa=l(_o);Hs=c(qa,"torch.nn.Module"),qa.forEach(t),Vs=c(vn,` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),vn.forEach(t),Us=_(Be),x=i(Be,"DIV",{class:!0});var C=l(x);w(yo.$$.fragment,C),Bs=_(C),ae=i(C,"P",{});var tt=l(ae);Rs=c(tt,"The "),Uo=i(tt,"A",{href:!0});var za=l(Uo);Gs=c(za,"NystromformerForSequenceClassification"),za.forEach(t),Ks=c(tt," forward method, overrides the "),Tt=i(tt,"CODE",{});var ja=l(Tt);Ys=c(ja,"__call__"),ja.forEach(t),Js=c(tt," special method."),tt.forEach(t),Zs=_(C),w(xe.$$.fragment,C),Xs=_(C),w(qe.$$.fragment,C),er=_(C),w(ze.$$.fragment,C),or=_(C),w(je.$$.fragment,C),tr=_(C),w(Ce.$$.fragment,C),C.forEach(t),Be.forEach(t),pn=_(o),ie=i(o,"H2",{class:!0});var Tn=l(ie);Ae=i(Tn,"A",{id:!0,class:!0,href:!0});var Ca=l(Ae);Nt=i(Ca,"SPAN",{});var Aa=l(Nt);w(bo.$$.fragment,Aa),Aa.forEach(t),Ca.forEach(t),nr=_(Tn),Mt=i(Tn,"SPAN",{});var Ea=l(Mt);sr=c(Ea,"NystromformerForMultipleChoice"),Ea.forEach(t),Tn.forEach(t),fn=_(o),P=i(o,"DIV",{class:!0});var Re=l(P);w(ko.$$.fragment,Re),rr=_(Re),Ft=i(Re,"P",{});var Pa=l(Ft);ar=c(Pa,`Nystr\xF6mformer Model with a multiple choice classification head on top (a linear layer on top of the pooled output
