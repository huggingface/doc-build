...
the latter silently ignores them.`)},l(S){h=a(S,"P",{});var w=s(h);z=d(w,"Although the recipe for forward pass needs to be defined within this function, one should call the "),v=a(w,"CODE",{});var F=s(v);T=d(F,"Module"),F.forEach(o),B=d(w,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
`),R=a(Be,"CODE",{});var xe=s(R);De=d(xe,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),xe.forEach(o),Be.forEach(o),X.forEach(o)},m(u,q){p(u,h,q),e(h,z),p(u,v,q),p(u,T,q),e(T,B),e(B,S),e(T,w),e(T,F),e(F,Ce),p(u,ue,q),p(u,x,q),e(x,je),e(x,U),e(U,Oe),e(x,Pe),e(x,W),e(W,Le),e(x,Ne),p(u,K,q),p(u,V,q),e(V,Ie),p(u,Z,q),p(u,C,q),e(C,P),e(P,fe),e(P,ae),e(ae,$e),e(P,Q),e(P,A),e(A,Te),e(C,se),e(C,L),e(L,we),e(L,re),e(re,Ee),e(L,ee),e(L,de),e(de,le),e(C,Ae),e(C,J),e(J,Me),e(J,R),e(R,De)},d(u){u&&o(h),u&&o(v),u&&o(T),u&&o(ue),u&&o(x),u&&o(K),u&&o(V),u&&o(Z),u&&o(C)}}}function ef(Y){let h,z,v,T,B;return{c(){h=n("p"),z=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),v=n("code"),T=r("Module"),B=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(S){h=a(S,"P",{});var w=s(h);z=d(w,"Although the recipe for forward pass needs to be defined within this function, one should call the "),v=a(w,"CODE",{});var F=s(v);T=d(F,"Module"),F.forEach(o),B=d(w,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),w.forEach(o)},m(S,w){p(S,h,w),e(h,z),e(h,v),e(v,T),e(h,B)},d(S){S&&o(h)}}}function of(Y){let h,z,v,T,B,S,w,F,Ce,ue,x,je,U,Oe,Pe,W,Le,Ne,K,V,Ie,Z,C,P,fe,ae,$e,Q,A,Te,se,L,we,re,Ee,ee,de,le,Ae,J,Me,R,De;return{c(){h=n("p"),z=r("TF 2.0 models accepts two formats as inputs:"),v=l(),T=n("ul"),B=n("li"),S=r("having all inputs as keyword arguments (like PyTorch models), or"),w=l(),F=n("li"),Ce=r("having all inputs as a list, tuple or dict in the first positional arguments."),ue=l(),x=n("p"),je=r("This second option is useful when using "),U=n("code"),Oe=r("tf.keras.Model.fit"),Pe=r(` method which currently requires having all the
tensors in the first argument of the model call function: `),W=n("code"),Le=r("model(inputs)"),Ne=r("."),K=l(),V=n("p"),Ie=r(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),Z=l(),C=n("ul"),P=n("li"),fe=r("a single Tensor with "),ae=n("code"),$e=r("input_ids"),Q=r(" only and nothing else: "),A=n("code"),Te=r("model(input_ids)"),se=l(),L=n("li"),we=r(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),re=n("code"),Ee=r("model([input_ids, attention_mask])"),ee=r(" or "),de=n("code"),le=r("model([input_ids, attention_mask, token_type_ids])"),Ae=l(),J=n("li"),Me=r(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),R=n("code"),De=r('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(u){h=a(u,"P",{});var q=s(h);z=d(q,"TF 2.0 models accepts two formats as inputs:"),q.forEach(o),v=i(u),T=a(u,"UL",{});var ie=s(T);B=a(ie,"LI",{});var lo=s(B);S=d(lo,"having all inputs as keyword arguments (like PyTorch models), or"),lo.forEach(o),w=i(ie),F=a(ie,"LI",{});var Re=s(F);Ce=d(Re,"having all inputs as a list, tuple or dict in the first positional arguments."),Re.forEach(o),ie.forEach(o),ue=i(u),x=a(u,"P",{});var j=s(x);je=d(j,"This second option is useful when using "),U=a(j,"CODE",{});var io=s(U);Oe=d(io,"tf.keras.Model.fit"),io.forEach(o),Pe=d(j,` method which currently requires having all the
...
<span class="hljs-meta">&gt;&gt;&gt; </span>outputs = model.decode(decoder_input_ids, encoder_outputs)
<span class="hljs-meta">&gt;&gt;&gt; </span>logits = outputs.logits`}}),{c(){h=n("meta"),z=l(),v=n("h1"),T=n("a"),B=n("span"),f(S.$$.fragment),w=l(),F=n("span"),Ce=r("Blenderbot Small"),ue=l(),x=n("p"),je=r("Note that "),U=n("a"),Oe=r("BlenderbotSmallModel"),Pe=r(` and
...
behavior.`),fi=l(),f(Do.$$.fragment),_i=l(),ke=n("div"),f(Nt.$$.fragment),gi=l(),Bo=n("p"),bi=r("The "),In=n("a"),ki=r("TFBlenderbotSmallModel"),yi=r(" forward method, overrides the "),Oa=n("code"),vi=r("__call__"),Ti=r(" special method."),wi=l(),f(Go.$$.fragment),Si=l(),Pa=n("p"),Bi=r("Example:"),xi=l(),f(It.$$.fragment),zr=l(),xo=n("h2"),Uo=n("a"),La=n("span"),f(At.$$.fragment),zi=l(),Na=n("span"),Fi=r("TFBlenderbotSmallForConditionalGeneration"),Fr=l(),he=n("div"),f(Dt.$$.fragment),qi=l(),Gt=n("p"),$i=r(`The BLENDERBOT_SMALL Model with a language modeling head. Can be used for summarization.
...
documentation from `),qn=a(Hn,"A",{href:!0});var lm=s(qn);Sd=d(lm,"PretrainedConfig"),lm.forEach(o),Bd=d(Hn," for more information."),Hn.forEach(o),xd=i(eo),ia=a(eo,"P",{});var im=s(ia);zd=d(im,"Example:"),im.forEach(o),Fd=i(eo),_(nt.$$.fragment,eo),eo.forEach(o),fr=i(t),fo=a(t,"H2",{class:!0});var Lr=s(fo);Eo=a(Lr,"A",{id:!0,class:!0,href:!0});var cm=s(Eo);ca=a(cm,"SPAN",{});var pm=s(ca);_(at.$$.fragment,pm),pm.forEach(o),cm.forEach(o),qd=i(Lr),pa=a(Lr,"SPAN",{});var mm=s(pa);$d=d(mm,"BlenderbotSmallTokenizer"),mm.forEach(o),Lr.forEach(o),_r=i(t),G=a(t,"DIV",{class:!0});var ve=s(G);_(st.$$.fragment,ve),Ed=i(ve),ma=a(ve,"P",{});var hm=s(ma);Md=d(hm,"Constructs a Blenderbot-90M tokenizer based on BPE (Byte-Pair-Encoding)"),hm.forEach(o),Cd=i(ve),rt=a(ve,"P",{});var Nr=s(rt);jd=d(Nr,"This tokenizer inherits from "),$n=a(Nr,"A",{href:!0});var um=s($n);Od=d(um,"PreTrainedTokenizer"),um.forEach(o),Pd=d(Nr,` which contains most of the main methods. Users should refer to
...
does not make use of token type ids, therefore a list of zeros is returned.`),xm.forEach(o),Gr.forEach(o),Jn.forEach(o),kr=i(t),bo=a(t,"H2",{class:!0});var Ur=s(bo);Oo=a(Ur,"A",{id:!0,class:!0,href:!0});var zm=s(Oo);Ta=a(zm,"SPAN",{});var Fm=s(Ta);_(ft.$$.fragment,Fm),Fm.forEach(o),zm.forEach(o),pl=i(Ur),wa=a(Ur,"SPAN",{});var qm=s(wa);ml=d(qm,"BlenderbotSmallModel"),qm.forEach(o),Ur.forEach(o),yr=i(t),ze=a(t,"DIV",{class:!0});var Xo=s(ze);_(_t.$$.fragment,Xo),hl=i(Xo),gt=a(Xo,"P",{});var Wr=s(gt);ul=d(Wr,`The bare BlenderbotSmall Model outputting raw hidden-states without any specific head on top.
...
\u201D<s>I\u2019m not sure.\u201D \u2026 )`),nd.forEach(o),wh.forEach(o),Th.forEach(o),vh.forEach(o),ac=i(H),ns=a(H,"BLOCKQUOTE",{});var Bh=s(ns);as=a(Bh,"BLOCKQUOTE",{});var xh=s(as);ss=a(xh,"BLOCKQUOTE",{});var zh=s(ss);rs=a(zh,"P",{});var Fh=s(rs);sc=d(Fh,`inputs = tokenizer([NEXT_UTTERANCE], return_tensors=\u2018tf\u2019) >>> inputs.pop(\u201Ctoken_type_ids\u201D) >>>
next_reply_ids = model.generate(**inputs) >>> print(\u201CBot: \u201D, tokenizer.batch_decode(next_reply_ids,
skip_special_tokens=True)[0])`),Fh.forEach(o),zh.forEach(o),xh.forEach(o),Bh.forEach(o),H.forEach(o),so.forEach(o),qr=i(t),Fo=a(t,"H2",{class:!0});var ad=s(Fo);Ho=a(ad,"A",{id:!0,class:!0,href:!0});var qh=s(Ho);ds=a(qh,"SPAN",{});var $h=s(ds);_(Kt.$$.fragment,$h),$h.forEach(o),qh.forEach(o),rc=i(ad),ls=a(ad,"SPAN",{});var Eh=s(ls);dc=d(Eh,"FlaxBlenderbotSmallModel"),Eh.forEach(o),ad.forEach(o),$r=i(t),N=a(t,"DIV",{class:!0});var te=s(N);_(Vt.$$.fragment,te),lc=i(te),Qt=a(te,"P",{});var sd=s(Qt);ic=d(sd,`The bare BlenderbotSmall Model transformer outputting raw hidden-states without any specific head on top.
