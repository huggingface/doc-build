...
and behavior.`),$i=h(),B=n("div"),k(Gt.$$.fragment),Wi=h(),ue=n("p"),xi=a("The "),Co=n("a"),Fi=a("WhisperModel"),zi=a(" forward method, overrides the "),zn=n("code"),Ei=a("__call__"),qi=a(" special method."),Mi=h(),k(je.$$.fragment),Ci=h(),k(Se.$$.fragment),hr=h(),me=n("h2"),Ae=n("a"),En=n("span"),k(Ot.$$.fragment),Pi=h(),qn=n("span"),ji=a("WhisperForConditionalGeneration"),pr=h(),O=n("div"),k(Vt.$$.fragment),Si=h(),Ht=n("p"),Ai=a(`The Whisper Model with a language modeling head. Can be used for automatic speech recognition.
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Vi=h(),K=n("div"),k(Bt.$$.fragment),Hi=h(),fe=n("p"),Ri=a("The "),jo=n("a"),Ui=a("WhisperForConditionalGeneration"),Bi=a(" forward method, overrides the "),Mn=n("code"),Ki=a("__call__"),Ji=a(" special method."),Zi=h(),k(Ne.$$.fragment),Qi=h(),k(Ie.$$.fragment),ur=h(),_e=n("h2"),Le=n("a"),Cn=n("span"),k(Kt.$$.fragment),Xi=h(),Pn=n("span"),Yi=a("TFWhisperModel"),mr=h(),V=n("div"),k(Jt.$$.fragment),ed=h(),Zt=n("p"),td=a(`The bare Whisper Model outputting raw hidden-states without any specific head on top.
...
behavior.`),dd=h(),J=n("div"),k(Yt.$$.fragment),cd=h(),ge=n("p"),ld=a("The "),Ao=n("a"),hd=a("TFWhisperModel"),pd=a(" forward method, overrides the "),jn=n("code"),ud=a("__call__"),md=a(" special method."),fd=h(),k(De.$$.fragment),_d=h(),k(Ge.$$.fragment),fr=h(),ve=n("h2"),Oe=n("a"),Sn=n("span"),k(eo.$$.fragment),gd=h(),An=n("span"),vd=a("TFWhisperForConditionalGeneration"),_r=h(),H=n("div"),k(to.$$.fragment),bd=h(),oo=n("p"),kd=a(`The Whisper Model with a language modeling head. Can be used for automatic speech recognition.
...
the docstring of this method for more information.`),Pr.forEach(o),Cr.forEach(o),C.forEach(o),cr=p(t),pe=r(t,"H2",{class:!0});var jr=s(pe);Pe=r(jr,"A",{id:!0,class:!0,href:!0});var Lc=s(Pe);xn=r(Lc,"SPAN",{});var Dc=s(xn);w(At.$$.fragment,Dc),Dc.forEach(o),Lc.forEach(o),mi=p(jr),Fn=r(jr,"SPAN",{});var Gc=s(Fn);fi=i(Gc,"WhisperModel"),Gc.forEach(o),jr.forEach(o),lr=p(t),G=r(t,"DIV",{class:!0});var Ke=s(G);w(Nt.$$.fragment,Ke),_i=p(Ke),It=r(Ke,"P",{});var Sr=s(It);gi=i(Sr,`The bare Whisper Model outputting raw hidden-states without any specific head on top.
