...
the `),Wt=n("a"),kn=n("strong"),Ea=a("call"),qa=a("()"),Pa=a(" and "),Fo=n("a"),Ma=a("decode()"),Ca=a(" for more information."),ja=h(),Fe=n("div"),k(xt.$$.fragment),Sa=h(),Z=n("p"),Aa=a(`When used in normal mode, this method forwards all its arguments to WhisperFeatureExtractor\u2019s
...
can be reloaded using the `),zo=n("a"),Xa=a("from_pretrained()"),Ya=a(" method."),ei=h(),k(Ee.$$.fragment),ti=h(),qe=n("div"),k(Mt.$$.fragment),oi=h(),Ct=n("p"),ni=a("This method forwards all its arguments to WhisperTokenizer\u2019s "),Eo=n("a"),ri=a("batch_decode()"),si=a(`. Please
...
the docstring of this method for more information.`),dr=h(),he=n("h2"),Me=n("a"),Wn=n("span"),k(At.$$.fragment),hi=h(),xn=n("span"),pi=a("WhisperModel"),cr=h(),D=n("div"),k(Nt.$$.fragment),mi=h(),It=n("p"),ui=a(`The bare Whisper Model outputting raw hidden-states without any specific head on top.
...
and behavior.`),wi=h(),U=n("div"),k(Gt.$$.fragment),yi=h(),pe=n("p"),Ti=a("The "),Mo=n("a"),$i=a("WhisperModel"),Wi=a(" forward method, overrides the "),Fn=n("code"),xi=a("__call__"),Fi=a(" special method."),zi=h(),k(Ce.$$.fragment),Ei=h(),k(je.$$.fragment),lr=h(),me=n("h2"),Se=n("a"),zn=n("span"),k(Ot.$$.fragment),qi=h(),En=n("span"),Pi=a("WhisperForConditionalGeneration"),hr=h(),G=n("div"),k(Vt.$$.fragment),Mi=h(),Ht=n("p"),Ci=a(`The Whisper Model with a language modeling head. Can be used for automatic speech recognition.
...
documentation from `),go=r(Do,"A",{href:!0});var Yd=s(go);Es=i(Yd,"PretrainedConfig"),Yd.forEach(o),qs=i(Do," for more information."),Do.forEach(o),Ps=p(Ue),w(we.$$.fragment,Ue),Ue.forEach(o),or=p(t),ae=r(t,"H2",{class:!0});var kr=s(ae);ye=r(kr,"A",{id:!0,class:!0,href:!0});var ec=s(ye);rn=r(ec,"SPAN",{});var tc=s(rn);w(pt.$$.fragment,tc),tc.forEach(o),ec.forEach(o),Ms=p(kr),sn=r(kr,"SPAN",{});var oc=s(sn);Cs=i(oc,"WhisperTokenizer"),oc.forEach(o),kr.forEach(o),nr=p(t),P=r(t,"DIV",{class:!0});var I=s(P);w(mt.$$.fragment,I),js=p(I),an=r(I,"P",{});var nc=s(an);Ss=i(nc,"Construct an Whisper tokenizer."),nc.forEach(o),As=p(I),ut=r(I,"P",{});var wr=s(ut);Ns=i(wr,"This tokenizer inherits from "),vo=r(wr,"A",{href:!0});var rc=s(vo);Is=i(rc,"PreTrainedTokenizer"),rc.forEach(o),Ls=i(wr,` which contains some of the main methods. Users should refer to
...
the `),Wt=r(Q,"A",{href:!0});var jd=s(Wt);kn=r(jd,"STRONG",{});var xc=s(kn);Ea=i(xc,"call"),xc.forEach(o),qa=i(jd,"()"),jd.forEach(o),Pa=i(Q," and "),Fo=r(Q,"A",{href:!0});var Fc=s(Fo);Ma=i(Fc,"decode()"),Fc.forEach(o),Ca=i(Q," for more information."),Q.forEach(o),ja=p(M),Fe=r(M,"DIV",{class:!0});var Fr=s(Fe);w(xt.$$.fragment,Fr),Sa=p(Fr),Z=r(Fr,"P",{});var Be=s(Z);Aa=i(Be,`When used in normal mode, this method forwards all its arguments to WhisperFeatureExtractor\u2019s
...
`),zt=r(Be,"A",{href:!0});var Ad=s(zt);Tn=r(Ad,"STRONG",{});var qc=s(Tn);Oa=i(qc,"call"),qc.forEach(o),Va=i(Ad,"()"),Ad.forEach(o),Ha=i(Be,". Please refer to the doctsring of the above two methods for more information."),Be.forEach(o),Fr.forEach(o),Ra=p(M),Y=r(M,"DIV",{class:!0});var Ho=s(Y);w(Et.$$.fragment,Ho),Ua=p(Ho),$n=r(Ho,"P",{});var Pc=s($n);Ba=i(Pc,"Instantiate a processor associated with a pretrained model."),Pc.forEach(o),Ka=p(Ho),w(ze.$$.fragment,Ho),Ho.forEach(o),Ja=p(M),ee=r(M,"DIV",{class:!0});var Ro=s(ee);w(qt.$$.fragment,Ro),Za=p(Ro),Pt=r(Ro,"P",{});var zr=s(Pt);Qa=i(zr,`Saves the attributes of this processor (feature extractor, tokenizer\u2026) in the specified directory so that it
can be reloaded using the `),zo=r(zr,"A",{href:!0});var Mc=s(zo);Xa=i(Mc,"from_pretrained()"),Mc.forEach(o),Ya=i(zr," method."),zr.forEach(o),ei=p(Ro),w(Ee.$$.fragment,Ro),Ro.forEach(o),ti=p(M),qe=r(M,"DIV",{class:!0});var Er=s(qe);w(Mt.$$.fragment,Er),oi=p(Er),Ct=r(Er,"P",{});var qr=s(Ct);ni=i(qr,"This method forwards all its arguments to WhisperTokenizer\u2019s "),Eo=r(qr,"A",{href:!0});var Cc=s(Eo);ri=i(Cc,"batch_decode()"),Cc.forEach(o),si=i(qr,`. Please
refer to the docstring of this method for more information.`),qr.forEach(o),Er.forEach(o),ai=p(M),Pe=r(M,"DIV",{class:!0});var Pr=s(Pe);w(jt.$$.fragment,Pr),ii=p(Pr),St=r(Pr,"P",{});var Mr=s(St);di=i(Mr,"This method forwards all its arguments to WhisperTokenizer\u2019s "),qo=r(Mr,"A",{href:!0});var jc=s(qo);ci=i(jc,"decode()"),jc.forEach(o),li=i(Mr,`. Please refer to
the docstring of this method for more information.`),Mr.forEach(o),Pr.forEach(o),M.forEach(o),dr=p(t),he=r(t,"H2",{class:!0});var Cr=s(he);Me=r(Cr,"A",{id:!0,class:!0,href:!0});var Sc=s(Me);Wn=r(Sc,"SPAN",{});var Ac=s(Wn);w(At.$$.fragment,Ac),Ac.forEach(o),Sc.forEach(o),hi=p(Cr),xn=r(Cr,"SPAN",{});var Nc=s(xn);pi=i(Nc,"WhisperModel"),Nc.forEach(o),Cr.forEach(o),cr=p(t),D=r(t,"DIV",{class:!0});var Ke=s(D);w(Nt.$$.fragment,Ke),mi=p(Ke),It=r(Ke,"P",{});var jr=s(It);ui=i(jr,`The bare Whisper Model outputting raw hidden-states without any specific head on top.
