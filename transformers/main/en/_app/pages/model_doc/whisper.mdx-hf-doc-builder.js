...
methods above for more information.`),this.h()},l(P){l=r(P,"P",{});var z=s(l);b=i(z,"This class method is simply calling "),f=r(z,"A",{href:!0});var j=s(f);_=i(j,"save_pretrained()"),j.forEach(o),v=i(z,` and
`),d=r(z,"A",{href:!0});var A=s(d);u=i(A,"save_pretrained()"),A.forEach(o),x=i(z,`. Please refer to the docstrings of the
methods above for more information.`),z.forEach(o),this.h()},h(){c(f,"href","/docs/transformers/main/en/internal/image_processing_utils#transformers.FeatureExtractionMixin.save_pretrained"),c(d,"href","/docs/transformers/main/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.save_pretrained")},m(P,z){g(P,l,z),e(l,b),e(l,f),e(f,_),e(l,v),e(l,d),e(d,u),e(l,x)},d(P){P&&o(l)}}}function wl(F){let l,b,f,_,v;return{c(){l=n("p"),b=a("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=n("code"),_=a("Module"),v=a(`
