...
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),u.forEach(o)},m(d,u){g(d,l,u),e(l,b),e(l,f),e(f,_),e(l,v)},d(d){d&&o(l)}}}function ml(z){let l,b,f,_,v;return _=new Un({props:{code:`from transformers import openai/whisper-tiny, WhisperModel
import torch
...
Whether or not to return a <a href="/docs/transformers/main/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/whisper/modeling_whisper.py#L993",returnDescription:`
<p>A <a
...
only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/whisper/modeling_whisper.py#L1111",returnDescription:`
<p>A <a
...
behavior.`),od=h(),B=n("div"),k(Xt.$$.fragment),nd=h(),_e=n("p"),rd=a("The "),So=n("a"),sd=a("TFWhisperModel"),ad=a(" forward method, overrides the "),Pn=n("code"),id=a("__call__"),dd=a(" special method."),cd=h(),k(De.$$.fragment),ld=h(),k(Le.$$.fragment),ur=h(),ge=n("h2"),Ge=n("a"),Mn=n("span"),k(Yt.$$.fragment),hd=h(),jn=n("span"),pd=a("TFWhisperForConditionalGeneration"),mr=h(),V=n("div"),k(eo.$$.fragment),ud=h(),to=n("p"),md=a(`The Whisper Model with a language modeling head. Can be used for automatic speech recognition.
