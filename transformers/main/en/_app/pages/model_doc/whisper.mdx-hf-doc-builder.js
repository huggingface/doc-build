...
methods above for more information.`),z.forEach(o),this.h()},h(){c(f,"href","/docs/transformers/main/en/internal/image_processing_utils#transformers.FeatureExtractionMixin.from_pretrained")},m(P,z){g(P,l,z),e(l,b),e(l,f),e(f,_),e(l,v),e(l,d),e(d,u),e(l,x)},d(P){P&&o(l)}}}function _l(F){let l,b,f,_,v,d,u,x;return{c(){l=n("p"),b=a("This class method is simply calling "),f=n("a"),_=a("save_pretrained()"),v=a(` and
...
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),u.forEach(o)},m(d,u){g(d,l,u),e(l,b),e(l,f),e(f,_),e(l,v)},d(d){d&&o(l)}}}function vl(F){let l,b,f,_,v;return _=new Bn({props:{code:`import torch
...
`}}),Pe=new Zo({props:{$$slots:{default:[gl]},$$scope:{ctx:F}}}),je=new Hn({props:{anchor:"transformers.WhisperModel.forward.example",$$slots:{default:[vl]},$$scope:{ctx:F}}}),Ot=new oe({}),Vt=new E({props:{name:"class transformers.WhisperForConditionalGeneration",anchor:"transformers.WhisperForConditionalGeneration",parameters:[{name:"config",val:": WhisperConfig"}],parametersDescription:[{anchor:"transformers.WhisperForConditionalGeneration.config",description:`<strong>config</strong> (<a href="/docs/transformers/main/en/model_doc/whisper#transformers.WhisperConfig">WhisperConfig</a>) &#x2014;
Model configuration class with all the parameters of the model. Initializing with a config file does not
load the weights associated with the model, only the configuration. Check out the
...
documentation from `),go=n("a"),Es=a("PretrainedConfig"),qs=a(" for more information."),Cs=h(),k(we.$$.fragment),or=h(),ae=n("h2"),ye=n("a"),rn=n("span"),k(pt.$$.fragment),Ms=h(),sn=n("span"),Ps=a("WhisperTokenizer"),nr=h(),C=n("div"),k(ut.$$.fragment),js=h(),an=n("p"),Ss=a("Construct an Whisper tokenizer."),As=h(),mt=n("p"),Ns=a("This tokenizer inherits from "),vo=n("a"),Is=a("PreTrainedTokenizer"),Ls=a(` which contains some of the main methods. Users should refer to
...
the `),Wt=n("a"),kn=n("strong"),Ea=a("call"),qa=a("()"),Ca=a(" and "),Fo=n("a"),Ma=a("decode()"),Pa=a(" for more information."),ja=h(),Fe=n("div"),k(xt.$$.fragment),Sa=h(),Z=n("p"),Aa=a(`When used in normal mode, this method forwards all its arguments to WhisperFeatureExtractor\u2019s
...
`),zt=n("a"),Tn=n("strong"),Oa=a("call"),Va=a("()"),Ra=a(". Please refer to the doctsring of the above two methods for more information."),Ha=h(),Y=n("div"),k(Et.$$.fragment),Ua=h(),$n=n("p"),Ba=a("Instantiate a processor associated with a pretrained model."),Ka=h(),k(ze.$$.fragment),Ja=h(),ee=n("div"),k(qt.$$.fragment),Za=h(),Ct=n("p"),Qa=a(`Saves the attributes of this processor (feature extractor, tokenizer\u2026) in the specified directory so that it
can be reloaded using the `),zo=n("a"),Xa=a("from_pretrained()"),Ya=a(" method."),ei=h(),k(Ee.$$.fragment),ti=h(),qe=n("div"),k(Mt.$$.fragment),oi=h(),Pt=n("p"),ni=a("This method forwards all its arguments to WhisperTokenizer\u2019s "),Eo=n("a"),ri=a("batch_decode()"),si=a(`. Please
refer to the docstring of this method for more information.`),ai=h(),Ce=n("div"),k(jt.$$.fragment),ii=h(),St=n("p"),di=a("This method forwards all its arguments to WhisperTokenizer\u2019s "),qo=n("a"),ci=a("decode()"),li=a(`. Please refer to
the docstring of this method for more information.`),dr=h(),he=n("h2"),Me=n("a"),Wn=n("span"),k(At.$$.fragment),hi=h(),xn=n("span"),pi=a("WhisperModel"),cr=h(),D=n("div"),k(Nt.$$.fragment),ui=h(),It=n("p"),mi=a(`The bare Whisper Model outputting raw hidden-states without any specific head on top.
This model inherits from `),Co=n("a"),fi=a("PreTrainedModel"),_i=a(`. Check the superclass documentation for the generic methods the
...
and behavior.`),wi=h(),U=n("div"),k(Gt.$$.fragment),yi=h(),pe=n("p"),Ti=a("The "),Mo=n("a"),$i=a("WhisperModel"),Wi=a(" forward method, overrides the "),Fn=n("code"),xi=a("__call__"),Fi=a(" special method."),zi=h(),k(Pe.$$.fragment),Ei=h(),k(je.$$.fragment),lr=h(),ue=n("h2"),Se=n("a"),zn=n("span"),k(Ot.$$.fragment),qi=h(),En=n("span"),Ci=a("WhisperForConditionalGeneration"),hr=h(),G=n("div"),k(Vt.$$.fragment),Mi=h(),Rt=n("p"),Pi=a(`The Whisper Model with a language modeling head. Can be used for automatic speech recognition.
This model inherits from `),Po=n("a"),ji=a("PreTrainedModel"),Si=a(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Ai=h(),Ht=n("p"),Ni=a("This model is also a PyTorch "),Ut=n("a"),Ii=a("torch.nn.Module"),Li=a(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Di=h(),B=n("div"),k(Bt.$$.fragment),Gi=h(),me=n("p"),Oi=a("The "),jo=n("a"),Vi=a("WhisperForConditionalGeneration"),Ri=a(" forward method, overrides the "),qn=n("code"),Hi=a("__call__"),Ui=a(" special method."),Bi=h(),k(Ae.$$.fragment),Ki=h(),k(Ne.$$.fragment),pr=h(),fe=n("h2"),Ie=n("a"),Cn=n("span"),k(Kt.$$.fragment),Ji=h(),Mn=n("span"),Zi=a("TFWhisperModel"),ur=h(),O=n("div"),k(Jt.$$.fragment),Qi=h(),Zt=n("p"),Xi=a(`The bare Whisper Model outputting raw hidden-states without any specific head on top.
...
behavior.`),sd=h(),K=n("div"),k(Yt.$$.fragment),ad=h(),_e=n("p"),id=a("The "),Ao=n("a"),dd=a("TFWhisperModel"),cd=a(" forward method, overrides the "),Pn=n("code"),ld=a("__call__"),hd=a(" special method."),pd=h(),k(Le.$$.fragment),ud=h(),k(De.$$.fragment),mr=h(),ge=n("h2"),Ge=n("a"),jn=n("span"),k(eo.$$.fragment),md=h(),Sn=n("span"),fd=a("TFWhisperForConditionalGeneration"),fr=h(),V=n("div"),k(to.$$.fragment),_d=h(),oo=n("p"),gd=a(`The Whisper Model with a language modeling head. Can be used for automatic speech recognition.
...
documentation from `),go=r(Do,"A",{href:!0});var Yd=s(go);Es=i(Yd,"PretrainedConfig"),Yd.forEach(o),qs=i(Do," for more information."),Do.forEach(o),Cs=p(Ue),w(we.$$.fragment,Ue),Ue.forEach(o),or=p(t),ae=r(t,"H2",{class:!0});var kr=s(ae);ye=r(kr,"A",{id:!0,class:!0,href:!0});var ec=s(ye);rn=r(ec,"SPAN",{});var tc=s(rn);w(pt.$$.fragment,tc),tc.forEach(o),ec.forEach(o),Ms=p(kr),sn=r(kr,"SPAN",{});var oc=s(sn);Ps=i(oc,"WhisperTokenizer"),oc.forEach(o),kr.forEach(o),nr=p(t),C=r(t,"DIV",{class:!0});var I=s(C);w(ut.$$.fragment,I),js=p(I),an=r(I,"P",{});var nc=s(an);Ss=i(nc,"Construct an Whisper tokenizer."),nc.forEach(o),As=p(I),mt=r(I,"P",{});var wr=s(mt);Ns=i(wr,"This tokenizer inherits from "),vo=r(wr,"A",{href:!0});var rc=s(vo);Is=i(rc,"PreTrainedTokenizer"),rc.forEach(o),Ls=i(wr,` which contains some of the main methods. Users should refer to
...
`),zt=r(Be,"A",{href:!0});var Ad=s(zt);Tn=r(Ad,"STRONG",{});var qc=s(Tn);Oa=i(qc,"call"),qc.forEach(o),Va=i(Ad,"()"),Ad.forEach(o),Ra=i(Be,". Please refer to the doctsring of the above two methods for more information."),Be.forEach(o),Fr.forEach(o),Ha=p(M),Y=r(M,"DIV",{class:!0});var Ro=s(Y);w(Et.$$.fragment,Ro),Ua=p(Ro),$n=r(Ro,"P",{});var Cc=s($n);Ba=i(Cc,"Instantiate a processor associated with a pretrained model."),Cc.forEach(o),Ka=p(Ro),w(ze.$$.fragment,Ro),Ro.forEach(o),Ja=p(M),ee=r(M,"DIV",{class:!0});var Ho=s(ee);w(qt.$$.fragment,Ho),Za=p(Ho),Ct=r(Ho,"P",{});var zr=s(Ct);Qa=i(zr,`Saves the attributes of this processor (feature extractor, tokenizer\u2026) in the specified directory so that it
can be reloaded using the `),zo=r(zr,"A",{href:!0});var Mc=s(zo);Xa=i(Mc,"from_pretrained()"),Mc.forEach(o),Ya=i(zr," method."),zr.forEach(o),ei=p(Ho),w(Ee.$$.fragment,Ho),Ho.forEach(o),ti=p(M),qe=r(M,"DIV",{class:!0});var Er=s(qe);w(Mt.$$.fragment,Er),oi=p(Er),Pt=r(Er,"P",{});var qr=s(Pt);ni=i(qr,"This method forwards all its arguments to WhisperTokenizer\u2019s "),Eo=r(qr,"A",{href:!0});var Pc=s(Eo);ri=i(Pc,"batch_decode()"),Pc.forEach(o),si=i(qr,`. Please
refer to the docstring of this method for more information.`),qr.forEach(o),Er.forEach(o),ai=p(M),Ce=r(M,"DIV",{class:!0});var Cr=s(Ce);w(jt.$$.fragment,Cr),ii=p(Cr),St=r(Cr,"P",{});var Mr=s(St);di=i(Mr,"This method forwards all its arguments to WhisperTokenizer\u2019s "),qo=r(Mr,"A",{href:!0});var jc=s(qo);ci=i(jc,"decode()"),jc.forEach(o),li=i(Mr,`. Please refer to
the docstring of this method for more information.`),Mr.forEach(o),Cr.forEach(o),M.forEach(o),dr=p(t),he=r(t,"H2",{class:!0});var Pr=s(he);Me=r(Pr,"A",{id:!0,class:!0,href:!0});var Sc=s(Me);Wn=r(Sc,"SPAN",{});var Ac=s(Wn);w(At.$$.fragment,Ac),Ac.forEach(o),Sc.forEach(o),hi=p(Pr),xn=r(Pr,"SPAN",{});var Nc=s(xn);pi=i(Nc,"WhisperModel"),Nc.forEach(o),Pr.forEach(o),cr=p(t),D=r(t,"DIV",{class:!0});var Ke=s(D);w(Nt.$$.fragment,Ke),ui=p(Ke),It=r(Ke,"P",{});var jr=s(It);mi=i(jr,`The bare Whisper Model outputting raw hidden-states without any specific head on top.
This model inherits from `),Co=r(jr,"A",{href:!0});var Ic=s(Co);fi=i(Ic,"PreTrainedModel"),Ic.forEach(o),_i=i(jr,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Sr.forEach(o),wi=p(Ke),U=r(Ke,"DIV",{class:!0});var Je=s(U);w(Gt.$$.fragment,Je),yi=p(Je),pe=r(Je,"P",{});var Uo=s(pe);Ti=i(Uo,"The "),Mo=r(Uo,"A",{href:!0});var Dc=s(Mo);$i=i(Dc,"WhisperModel"),Dc.forEach(o),Wi=i(Uo," forward method, overrides the "),Fn=r(Uo,"CODE",{});var Gc=s(Fn);xi=i(Gc,"__call__"),Gc.forEach(o),Fi=i(Uo," special method."),Uo.forEach(o),zi=p(Je),w(Pe.$$.fragment,Je),Ei=p(Je),w(je.$$.fragment,Je),Je.forEach(o),Ke.forEach(o),lr=p(t),ue=r(t,"H2",{class:!0});var Ar=s(ue);Se=r(Ar,"A",{id:!0,class:!0,href:!0});var Oc=s(Se);zn=r(Oc,"SPAN",{});var Vc=s(zn);w(Ot.$$.fragment,Vc),Vc.forEach(o),Oc.forEach(o),qi=p(Ar),En=r(Ar,"SPAN",{});var Rc=s(En);Ci=i(Rc,"WhisperForConditionalGeneration"),Rc.forEach(o),Ar.forEach(o),hr=p(t),G=r(t,"DIV",{class:!0});var Ze=s(G);w(Vt.$$.fragment,Ze),Mi=p(Ze),Rt=r(Ze,"P",{});var Nr=s(Rt);Pi=i(Nr,`The Whisper Model with a language modeling head. Can be used for automatic speech recognition.
This model inherits from `),Po=r(Nr,"A",{href:!0});var Hc=s(Po);ji=i(Hc,"PreTrainedModel"),Hc.forEach(o),Si=i(Nr,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Ir.forEach(o),Di=p(Ze),B=r(Ze,"DIV",{class:!0});var Qe=s(B);w(Bt.$$.fragment,Qe),Gi=p(Qe),me=r(Qe,"P",{});var Bo=s(me);Oi=i(Bo,"The "),jo=r(Bo,"A",{href:!0});var Bc=s(jo);Vi=i(Bc,"WhisperForConditionalGeneration"),Bc.forEach(o),Ri=i(Bo," forward method, overrides the "),qn=r(Bo,"CODE",{});var Kc=s(qn);Hi=i(Kc,"__call__"),Kc.forEach(o),Ui=i(Bo," special method."),Bo.forEach(o),Bi=p(Qe),w(Ae.$$.fragment,Qe),Ki=p(Qe),w(Ne.$$.fragment,Qe),Qe.forEach(o),Ze.forEach(o),pr=p(t),fe=r(t,"H2",{class:!0});var Lr=s(fe);Ie=r(Lr,"A",{id:!0,class:!0,href:!0});var Jc=s(Ie);Cn=r(Jc,"SPAN",{});var Zc=s(Cn);w(Kt.$$.fragment,Zc),Zc.forEach(o),Jc.forEach(o),Ji=p(Lr),Mn=r(Lr,"SPAN",{});var Qc=s(Mn);Zi=i(Qc,"TFWhisperModel"),Qc.forEach(o),Lr.forEach(o),ur=p(t),O=r(t,"DIV",{class:!0});var Xe=s(O);w(Jt.$$.fragment,Xe),Qi=p(Xe),Zt=r(Xe,"P",{});var Dr=s(Zt);Xi=i(Dr,`The bare Whisper Model outputting raw hidden-states without any specific head on top.
