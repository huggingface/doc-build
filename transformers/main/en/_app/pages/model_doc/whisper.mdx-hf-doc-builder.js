import{S as ml,i as ul,s as fl,e as n,k as h,w as k,t as a,M as _l,c as r,d as o,m as p,a as s,x as w,h as i,b as c,G as e,g,y,q as T,o as $,B as W,v as gl,L as Bn}from"../../chunks/vendor-hf-doc-builder.js";import{T as Zo}from"../../chunks/Tip-hf-doc-builder.js";import{D as E}from"../../chunks/Docstring-hf-doc-builder.js";import{C as Kn}from"../../chunks/CodeBlock-hf-doc-builder.js";import{I as ne}from"../../chunks/IconCopyLink-hf-doc-builder.js";import{E as Un}from"../../chunks/ExampleCodeBlock-hf-doc-builder.js";function vl(F){let l,b,f,_,v;return _=new Kn({props:{code:`from transformers import WhisperConfig, WhisperModel
...
<span class="hljs-meta">&gt;&gt;&gt; </span>configuration = model.config`}}),{c(){l=n("p"),b=a("Example:"),f=h(),k(_.$$.fragment)},l(d){l=r(d,"P",{});var m=s(l);b=i(m,"Example:"),m.forEach(o),f=p(d),w(_.$$.fragment,d)},m(d,m){g(d,l,m),e(l,b),g(d,f,m),y(_,d,m),v=!0},p:Bn,i(d){v||(T(_.$$.fragment,d),v=!0)},o(d){$(_.$$.fragment,d),v=!1},d(d){d&&o(l),d&&o(f),W(_,d)}}}function bl(F){let l,b,f,_,v,d,m,x;return{c(){l=n("p"),b=a(`This class method is simply calling the feature extractor
...
methods above for more information.`),z.forEach(o),this.h()},h(){c(f,"href","/docs/transformers/main/en/main_classes/feature_extractor#transformers.FeatureExtractionMixin.from_pretrained")},m(P,z){g(P,l,z),e(l,b),e(l,f),e(f,_),e(l,v),e(l,d),e(d,m),e(l,x)},d(P){P&&o(l)}}}function kl(F){let l,b,f,_,v,d,m,x;return{c(){l=n("p"),b=a("This class method is simply calling "),f=n("a"),_=a("save_pretrained()"),v=a(` and
`),d=n("a"),m=a("save_pretrained()"),x=a(`. Please refer to the docstrings of the
...
`),d=r(z,"A",{href:!0});var A=s(d);m=i(A,"save_pretrained()"),A.forEach(o),x=i(z,`. Please refer to the docstrings of the
methods above for more information.`),z.forEach(o),this.h()},h(){c(f,"href","/docs/transformers/main/en/main_classes/feature_extractor#transformers.FeatureExtractionMixin.save_pretrained"),c(d,"href","/docs/transformers/main/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.save_pretrained")},m(P,z){g(P,l,z),e(l,b),e(l,f),e(f,_),e(l,v),e(l,d),e(d,m),e(l,x)},d(P){P&&o(l)}}}function wl(F){let l,b,f,_,v;return{c(){l=n("p"),b=a("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=n("code"),_=a("Module"),v=a(`
...
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),m.forEach(o)},m(d,m){g(d,l,m),e(l,b),e(l,f),e(f,_),e(l,v)},d(d){d&&o(l)}}}function yl(F){let l,b,f,_,v;return _=new Kn({props:{code:`import torch
...
[<span class="hljs-number">1</span>, <span class="hljs-number">2</span>, <span class="hljs-number">512</span>]`}}),{c(){l=n("p"),b=a("Example:"),f=h(),k(_.$$.fragment)},l(d){l=r(d,"P",{});var m=s(l);b=i(m,"Example:"),m.forEach(o),f=p(d),w(_.$$.fragment,d)},m(d,m){g(d,l,m),e(l,b),g(d,f,m),y(_,d,m),v=!0},p:Bn,i(d){v||(T(_.$$.fragment,d),v=!0)},o(d){$(_.$$.fragment,d),v=!1},d(d){d&&o(l),d&&o(f),W(_,d)}}}function Tl(F){let l,b,f,_,v;return{c(){l=n("p"),b=a("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=n("code"),_=a("Module"),v=a(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(d){l=r(d,"P",{});var m=s(l);b=i(m,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=r(m,"CODE",{});var x=s(f);_=i(x,"Module"),x.forEach(o),v=i(m,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),m.forEach(o)},m(d,m){g(d,l,m),e(l,b),e(l,f),e(f,_),e(l,v)},d(d){d&&o(l)}}}function $l(F){let l,b,f,_,v;return _=new Kn({props:{code:`import torch
...
<span class="hljs-string">&#x27; Mr. Quilter is the apostle of the middle classes, and we are glad to welcome his gospel.&#x27;</span>`}}),{c(){l=n("p"),b=a("Example:"),f=h(),k(_.$$.fragment)},l(d){l=r(d,"P",{});var m=s(l);b=i(m,"Example:"),m.forEach(o),f=p(d),w(_.$$.fragment,d)},m(d,m){g(d,l,m),e(l,b),g(d,f,m),y(_,d,m),v=!0},p:Bn,i(d){v||(T(_.$$.fragment,d),v=!0)},o(d){$(_.$$.fragment,d),v=!1},d(d){d&&o(l),d&&o(f),W(_,d)}}}function Wl(F){let l,b,f,_,v;return{c(){l=n("p"),b=a("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=n("code"),_=a("Module"),v=a(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(d){l=r(d,"P",{});var m=s(l);b=i(m,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=r(m,"CODE",{});var x=s(f);_=i(x,"Module"),x.forEach(o),v=i(m,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),m.forEach(o)},m(d,m){g(d,l,m),e(l,b),e(l,f),e(f,_),e(l,v)},d(d){d&&o(l)}}}function xl(F){let l,b,f,_,v;return _=new Kn({props:{code:`import tensorflow as tf
...
the latter silently ignores them.`)},l(d){l=r(d,"P",{});var m=s(l);b=i(m,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=r(m,"CODE",{});var x=s(f);_=i(x,"Module"),x.forEach(o),v=i(m,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),m.forEach(o)},m(d,m){g(d,l,m),e(l,b),e(l,f),e(f,_),e(l,v)},d(d){d&&o(l)}}}function zl(F){let l,b,f,_,v;return _=new Kn({props:{code:`import tensorflow as tf
...
<span class="hljs-meta">&gt;&gt;&gt; </span>transcription = processor.batch_decode(generated_ids, skip_special_tokens=<span class="hljs-literal">True</span>)[<span class="hljs-number">0</span>]
<span class="hljs-meta">&gt;&gt;&gt; </span>transcription
<span class="hljs-string">&#x27; Mr. Quilter is the apostle of the middle classes, and we are glad to welcome his gospel.&#x27;</span>`}}),{c(){l=n("p"),b=a("Example:"),f=h(),k(_.$$.fragment)},l(d){l=r(d,"P",{});var m=s(l);b=i(m,"Example:"),m.forEach(o),f=p(d),w(_.$$.fragment,d)},m(d,m){g(d,l,m),e(l,b),g(d,f,m),y(_,d,m),v=!0},p:Bn,i(d){v||(T(_.$$.fragment,d),v=!0)},o(d){$(_.$$.fragment,d),v=!1},d(d){d&&o(l),d&&o(f),W(_,d)}}}function El(F){let l,b,f,_,v,d,m,x,P,z,j,A,Qo,ot,Ur,Xo,Br,Jn,ke,Kr,nt,Jr,Zr,Zn,lo,Qr,Qn,ho,Yo,Xr,Xn,po,Yr,Yn,R,en,es,ts,rt,os,mo,ns,rs,ss,tn,as,is,st,ds,uo,cs,ls,er,U,hs,at,ps,ms,it,us,fs,dt,_s,gs,tr,re,we,on,ct,vs,nn,bs,or,L,lt,ks,se,ws,fo,ys,Ts,ht,$s,Ws,xs,ae,Fs,_o,zs,Es,go,qs,Ms,Cs,ye,nr,ie,Te,rn,pt,Ps,sn,js,rr,M,mt,Ss,an,As,Ns,ut,Is,vo,Ls,Ds,Gs,bo,ft,Os,$e,_t,Vs,de,Hs,dn,Rs,Us,cn,Bs,Ks,Js,X,gt,Zs,ko,Qs,wo,Xs,Ys,ln,ea,ta,yo,vt,sr,ce,We,hn,bt,oa,pn,na,ar,S,kt,ra,mn,sa,aa,wt,ia,To,da,ca,la,le,ha,un,pa,ma,fn,ua,fa,_a,xe,yt,ga,_n,va,ir,he,Fe,gn,Tt,ba,vn,ka,dr,q,$t,wa,bn,ya,Ta,N,$o,$a,Wa,Wo,xa,Fa,xo,za,Ea,Wt,kn,qa,Ma,Ca,Fo,Pa,ja,Sa,ze,xt,Aa,D,Na,wn,Ia,La,Ft,yn,Da,Ga,Oa,Tn,Va,Ha,zt,$n,Ra,Ua,Ba,Ka,Y,Et,Ja,Wn,Za,Qa,Ee,Xa,ee,qt,Ya,Mt,ei,zo,ti,oi,ni,qe,ri,Me,Ct,si,Pt,ai,Eo,ii,di,ci,Ce,jt,li,St,hi,qo,pi,mi,cr,pe,Pe,xn,At,ui,Fn,fi,lr,G,Nt,_i,It,gi,Mo,vi,bi,ki,Lt,wi,Dt,yi,Ti,$i,B,Gt,Wi,me,xi,Co,Fi,zi,zn,Ei,qi,Mi,je,Ci,Se,hr,ue,Ae,En,Ot,Pi,qn,ji,pr,O,Vt,Si,Ht,Ai,Po,Ni,Ii,Li,Rt,Di,Ut,Gi,Oi,Vi,K,Bt,Hi,fe,Ri,jo,Ui,Bi,Mn,Ki,Ji,Zi,Ne,Qi,Ie,mr,_e,Le,Cn,Kt,Xi,Pn,Yi,ur,V,Jt,ed,Zt,td,So,od,nd,rd,Qt,sd,Xt,ad,id,dd,J,Yt,cd,ge,ld,Ao,hd,pd,jn,md,ud,fd,De,_d,Ge,fr,ve,Oe,Sn,eo,gd,An,vd,_r,H,to,bd,oo,kd,No,wd,yd,Td,no,$d,ro,Wd,xd,Fd,Z,so,zd,be,Ed,Io,qd,Md,Nn,Cd,Pd,jd,Ve,Sd,He,gr;return d=new ne({}),ot=new ne({}),ct=new ne({}),lt=new E({props:{name:"class transformers.WhisperConfig",anchor:"transformers.WhisperConfig",parameters:[{name:"vocab_size",val:" = 51865"},{name:"num_mel_bins",val:" = 80"},{name:"encoder_layers",val:" = 6"},{name:"encoder_attention_heads",val:" = 4"},{name:"decoder_layers",val:" = 6"},{name:"decoder_attention_heads",val:" = 4"},{name:"decoder_ffn_dim",val:" = 1536"},{name:"encoder_ffn_dim",val:" = 1536"},{name:"encoder_layerdrop",val:" = 0.0"},{name:"decoder_layerdrop",val:" = 0.0"},{name:"decoder_start_token_id",val:" = 50257"},{name:"use_cache",val:" = True"},{name:"is_encoder_decoder",val:" = True"},{name:"activation_function",val:" = 'gelu'"},{name:"d_model",val:" = 256"},{name:"dropout",val:" = 0.0"},{name:"attention_dropout",val:" = 0.0"},{name:"activation_dropout",val:" = 0.0"},{name:"init_std",val:" = 0.02"},{name:"scale_embedding",val:" = False"},{name:"max_source_positions",val:" = 1500"},{name:"max_target_positions",val:" = 448"},{name:"pad_token_id",val:" = 50256"},{name:"bos_token_id",val:" = 50257"},{name:"eos_token_id",val:" = 50256"},{name:"tie_word_embeddings",val:" = True"},{name:"suppress_tokens",val:" = None"},{name:"begin_suppress_tokens",val:" = [220, 50256]"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.WhisperConfig.vocab_size",description:`<strong>vocab_size</strong> (<code>int</code>, <em>optional</em>, defaults to 51865) &#x2014;
...
the token for <code>&quot; &quot;</code> (<code>blank_token_id</code>) and the <code>eos_token_id</code>`,name:"begin_suppress_tokens"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/whisper/configuration_whisper.py#L53"}}),ye=new Un({props:{anchor:"transformers.WhisperConfig.example",$$slots:{default:[vl]},$$scope:{ctx:F}}}),pt=new ne({}),mt=new E({props:{name:"class transformers.WhisperTokenizer",anchor:"transformers.WhisperTokenizer",parameters:[{name:"vocab_file",val:""},{name:"merges_file",val:""},{name:"normalizer_file",val:" = None"},{name:"errors",val:" = 'replace'"},{name:"unk_token",val:" = '<|endoftext|>'"},{name:"bos_token",val:" = '<|endoftext|>'"},{name:"eos_token",val:" = '<|endoftext|>'"},{name:"pad_token",val:" = None"},{name:"add_prefix_space",val:" = False"},{name:"add_bos_token",val:" = False"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.WhisperTokenizer.vocab_file",description:`<strong>vocab_file</strong> (<code>str</code>) &#x2014;
...
<p><a
  href="/docs/transformers/main/en/main_classes/output#transformers.modeling_tf_outputs.TFSeq2SeqLMOutput"
>transformers.modeling_tf_outputs.TFSeq2SeqLMOutput</a> or <code>tuple(tf.Tensor)</code></p>
`}}),Ve=new Zo({props:{$$slots:{default:[Fl]},$$scope:{ctx:F}}}),He=new Un({props:{anchor:"transformers.TFWhisperForConditionalGeneration.call.example",$$slots:{default:[zl]},$$scope:{ctx:F}}}),{c(){l=n("meta"),b=h(),f=n("h1"),_=n("a"),v=n("span"),k(d.$$.fragment),m=h(),x=n("span"),P=a("Whisper"),z=h(),j=n("h2"),A=n("a"),Qo=n("span"),k(ot.$$.fragment),Ur=h(),Xo=n("span"),Br=a("Overview"),Jn=h(),ke=n("p"),Kr=a("The Whisper model was proposed in "),nt=n("a"),Jr=a("Robust Speech Recognition via Large-Scale Weak Supervision"),Zr=a(" by Alec Radford, Jong Wook Kim, Tao Xu, Greg Brockman, Christine McLeavey, Ilya Sutskever."),Zn=h(),lo=n("p"),Qr=a("The abstract from the paper is the following:"),Qn=h(),ho=n("p"),Yo=n("em"),Xr=a("We study the capabilities of speech processing systems trained simply to predict large amounts of transcripts of audio on the internet. When scaled to 680,000 hours of multilingual and multitask supervision, the resulting models generalize well to standard benchmarks and are often competitive with prior fully supervised results but in a zeroshot transfer setting without the need for any finetuning. When compared to humans, the models approach their accuracy and robustness. We are releasing models and inference code to serve as a foundation for further work on robust speech processing."),Xn=h(),po=n("p"),Yr=a("Tips:"),Yn=h(),R=n("ul"),en=n("li"),es=a("The model usually performs well without requiring any finetuning."),ts=h(),rt=n("li"),os=a("The architecture follows a classic encoder-decoder architecture, which means that it relies on the "),mo=n("a"),ns=a("generate()"),rs=a(" function for inference."),ss=h(),tn=n("li"),as=a("Inference is currently only implemented for short-form i.e. audio is pre-segmented into <=30s segments. Long-form (including timestamps) will be implemented in a future release."),is=h(),st=n("li"),ds=a("One can use "),uo=n("a"),cs=a("WhisperProcessor"),ls=a(" to prepare audio for the model, and decode the predicted ID\u2019s back into text."),er=h(),U=n("p"),hs=a("This model was contributed by "),at=n("a"),ps=a("Arthur Zucker"),ms=a(". The Tensorflow version of this model was contributed by "),it=n("a"),us=a("amyeroberts"),fs=a(`.
...
documentation from `),go=n("a"),qs=a("PretrainedConfig"),Ms=a(" for more information."),Cs=h(),k(ye.$$.fragment),nr=h(),ie=n("h2"),Te=n("a"),rn=n("span"),k(pt.$$.fragment),Ps=h(),sn=n("span"),js=a("WhisperTokenizer"),rr=h(),M=n("div"),k(mt.$$.fragment),Ss=h(),an=n("p"),As=a("Construct an Whisper tokenizer."),Ns=h(),ut=n("p"),Is=a("This tokenizer inherits from "),vo=n("a"),Ls=a("PreTrainedTokenizer"),Ds=a(` which contains some of the main methods. Users should refer to
the superclass for more information regarding such methods.`),Gs=h(),bo=n("div"),k(ft.$$.fragment),Os=h(),$e=n("div"),k(_t.$$.fragment),Vs=h(),de=n("p"),Hs=a(`Retrieves sequence ids from a token list that has no special tokens added. This method is called when adding
...
refer to the docstring of this method for more information.`),ci=h(),Ce=n("div"),k(jt.$$.fragment),li=h(),St=n("p"),hi=a("This method forwards all its arguments to WhisperTokenizer\u2019s "),qo=n("a"),pi=a("decode()"),mi=a(`. Please refer to
the docstring of this method for more information.`),cr=h(),pe=n("h2"),Pe=n("a"),xn=n("span"),k(At.$$.fragment),ui=h(),Fn=n("span"),fi=a("WhisperModel"),lr=h(),G=n("div"),k(Nt.$$.fragment),_i=h(),It=n("p"),gi=a(`The bare Whisper Model outputting raw hidden-states without any specific head on top.
...
and behavior.`),$i=h(),B=n("div"),k(Gt.$$.fragment),Wi=h(),me=n("p"),xi=a("The "),Co=n("a"),Fi=a("WhisperModel"),zi=a(" forward method, overrides the "),zn=n("code"),Ei=a("__call__"),qi=a(" special method."),Mi=h(),k(je.$$.fragment),Ci=h(),k(Se.$$.fragment),hr=h(),ue=n("h2"),Ae=n("a"),En=n("span"),k(Ot.$$.fragment),Pi=h(),qn=n("span"),ji=a("WhisperForConditionalGeneration"),pr=h(),O=n("div"),k(Vt.$$.fragment),Si=h(),Ht=n("p"),Ai=a(`The Whisper Model with a language modeling head. Can be used for automatic speech recognition.
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Vi=h(),K=n("div"),k(Bt.$$.fragment),Hi=h(),fe=n("p"),Ri=a("The "),jo=n("a"),Ui=a("WhisperForConditionalGeneration"),Bi=a(" forward method, overrides the "),Mn=n("code"),Ki=a("__call__"),Ji=a(" special method."),Zi=h(),k(Ne.$$.fragment),Qi=h(),k(Ie.$$.fragment),mr=h(),_e=n("h2"),Le=n("a"),Cn=n("span"),k(Kt.$$.fragment),Xi=h(),Pn=n("span"),Yi=a("TFWhisperModel"),ur=h(),V=n("div"),k(Jt.$$.fragment),ed=h(),Zt=n("p"),td=a(`The bare Whisper Model outputting raw hidden-states without any specific head on top.
...
behavior.`),dd=h(),J=n("div"),k(Yt.$$.fragment),cd=h(),ge=n("p"),ld=a("The "),Ao=n("a"),hd=a("TFWhisperModel"),pd=a(" forward method, overrides the "),jn=n("code"),md=a("__call__"),ud=a(" special method."),fd=h(),k(De.$$.fragment),_d=h(),k(Ge.$$.fragment),fr=h(),ve=n("h2"),Oe=n("a"),Sn=n("span"),k(eo.$$.fragment),gd=h(),An=n("span"),vd=a("TFWhisperForConditionalGeneration"),_r=h(),H=n("div"),k(to.$$.fragment),bd=h(),oo=n("p"),kd=a(`The Whisper Model with a language modeling head. Can be used for automatic speech recognition.
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Fd=h(),Z=n("div"),k(so.$$.fragment),zd=h(),be=n("p"),Ed=a("The "),Io=n("a"),qd=a("TFWhisperForConditionalGeneration"),Md=a(" forward method, overrides the "),Nn=n("code"),Cd=a("__call__"),Pd=a(" special method."),jd=h(),k(Ve.$$.fragment),Sd=h(),k(He.$$.fragment),this.h()},l(t){const u=_l('[data-svelte="svelte-1phssyn"]',document.head);l=r(u,"META",{name:!0,content:!0}),u.forEach(o),b=p(t),f=r(t,"H1",{class:!0});var ao=s(f);_=r(ao,"A",{id:!0,class:!0,href:!0});var In=s(_);v=r(In,"SPAN",{});var Ln=s(v);w(d.$$.fragment,Ln),Ln.forEach(o),In.forEach(o),m=p(ao),x=r(ao,"SPAN",{});var Dn=s(x);P=i(Dn,"Whisper"),Dn.forEach(o),ao.forEach(o),z=p(t),j=r(t,"H2",{class:!0});var io=s(j);A=r(io,"A",{id:!0,class:!0,href:!0});var Gn=s(A);Qo=r(Gn,"SPAN",{});var On=s(Qo);w(ot.$$.fragment,On),On.forEach(o),Gn.forEach(o),Ur=p(io),Xo=r(io,"SPAN",{});var Vn=s(Xo);Br=i(Vn,"Overview"),Vn.forEach(o),io.forEach(o),Jn=p(t),ke=r(t,"P",{});var co=s(ke);Kr=i(co,"The Whisper model was proposed in "),nt=r(co,"A",{href:!0,rel:!0});var Hn=s(nt);Jr=i(Hn,"Robust Speech Recognition via Large-Scale Weak Supervision"),Hn.forEach(o),Zr=i(co," by Alec Radford, Jong Wook Kim, Tao Xu, Greg Brockman, Christine McLeavey, Ilya Sutskever."),co.forEach(o),Zn=p(t),lo=r(t,"P",{});var Rn=s(lo);Qr=i(Rn,"The abstract from the paper is the following:"),Rn.forEach(o),Qn=p(t),ho=r(t,"P",{});var Dd=s(ho);Yo=r(Dd,"EM",{});var Gd=s(Yo);Xr=i(Gd,"We study the capabilities of speech processing systems trained simply to predict large amounts of transcripts of audio on the internet. When scaled to 680,000 hours of multilingual and multitask supervision, the resulting models generalize well to standard benchmarks and are often competitive with prior fully supervised results but in a zeroshot transfer setting without the need for any finetuning. When compared to humans, the models approach their accuracy and robustness. We are releasing models and inference code to serve as a foundation for further work on robust speech processing."),Gd.forEach(o),Dd.forEach(o),Xn=p(t),po=r(t,"P",{});var Od=s(po);Yr=i(Od,"Tips:"),Od.forEach(o),Yn=p(t),R=r(t,"UL",{});var Re=s(R);en=r(Re,"LI",{});var Vd=s(en);es=i(Vd,"The model usually performs well without requiring any finetuning."),Vd.forEach(o),ts=p(Re),rt=r(Re,"LI",{});var vr=s(rt);os=i(vr,"The architecture follows a classic encoder-decoder architecture, which means that it relies on the "),mo=r(vr,"A",{href:!0});var Hd=s(mo);ns=i(Hd,"generate()"),Hd.forEach(o),rs=i(vr," function for inference."),vr.forEach(o),ss=p(Re),tn=r(Re,"LI",{});var Rd=s(tn);as=i(Rd,"Inference is currently only implemented for short-form i.e. audio is pre-segmented into <=30s segments. Long-form (including timestamps) will be implemented in a future release."),Rd.forEach(o),is=p(Re),st=r(Re,"LI",{});var br=s(st);ds=i(br,"One can use "),uo=r(br,"A",{href:!0});var Ud=s(uo);cs=i(Ud,"WhisperProcessor"),Ud.forEach(o),ls=i(br," to prepare audio for the model, and decode the predicted ID\u2019s back into text."),br.forEach(o),Re.forEach(o),er=p(t),U=r(t,"P",{});var Ue=s(U);hs=i(Ue,"This model was contributed by "),at=r(Ue,"A",{href:!0,rel:!0});var Bd=s(at);ps=i(Bd,"Arthur Zucker"),Bd.forEach(o),ms=i(Ue,". The Tensorflow version of this model was contributed by "),it=r(Ue,"A",{href:!0,rel:!0});var Kd=s(it);us=i(Kd,"amyeroberts"),Kd.forEach(o),fs=i(Ue,`.
...
documentation from `),go=r(Do,"A",{href:!0});var oc=s(go);qs=i(oc,"PretrainedConfig"),oc.forEach(o),Ms=i(Do," for more information."),Do.forEach(o),Cs=p(Be),w(ye.$$.fragment,Be),Be.forEach(o),nr=p(t),ie=r(t,"H2",{class:!0});var wr=s(ie);Te=r(wr,"A",{id:!0,class:!0,href:!0});var nc=s(Te);rn=r(nc,"SPAN",{});var rc=s(rn);w(pt.$$.fragment,rc),rc.forEach(o),nc.forEach(o),Ps=p(wr),sn=r(wr,"SPAN",{});var sc=s(sn);js=i(sc,"WhisperTokenizer"),sc.forEach(o),wr.forEach(o),rr=p(t),M=r(t,"DIV",{class:!0});var I=s(M);w(mt.$$.fragment,I),Ss=p(I),an=r(I,"P",{});var ac=s(an);As=i(ac,"Construct an Whisper tokenizer."),ac.forEach(o),Ns=p(I),ut=r(I,"P",{});var yr=s(ut);Is=i(yr,"This tokenizer inherits from "),vo=r(yr,"A",{href:!0});var ic=s(vo);Ls=i(ic,"PreTrainedTokenizer"),ic.forEach(o),Ds=i(yr,` which contains some of the main methods. Users should refer to
the superclass for more information regarding such methods.`),yr.forEach(o),Gs=p(I),bo=r(I,"DIV",{class:!0});var dc=s(bo);w(ft.$$.fragment,dc),dc.forEach(o),Os=p(I),$e=r(I,"DIV",{class:!0});var Tr=s($e);w(_t.$$.fragment,Tr),Vs=p(Tr),de=r(Tr,"P",{});var Go=s(de);Hs=i(Go,`Retrieves sequence ids from a token list that has no special tokens added. This method is called when adding
...
IDs?`),hc.forEach(o),Ad.forEach(o),Ys=p(Oo),ln=r(Oo,"P",{});var pc=s(ln);ea=i(pc,"Should be overridden in a subclass if the model has a special way of building those."),pc.forEach(o),Oo.forEach(o),ta=p(I),yo=r(I,"DIV",{class:!0});var mc=s(yo);w(vt.$$.fragment,mc),mc.forEach(o),I.forEach(o),sr=p(t),ce=r(t,"H2",{class:!0});var $r=s(ce);We=r($r,"A",{id:!0,class:!0,href:!0});var uc=s(We);hn=r(uc,"SPAN",{});var fc=s(hn);w(bt.$$.fragment,fc),fc.forEach(o),uc.forEach(o),oa=p($r),pn=r($r,"SPAN",{});var _c=s(pn);na=i(_c,"WhisperFeatureExtractor"),_c.forEach(o),$r.forEach(o),ar=p(t),S=r(t,"DIV",{class:!0});var te=s(S);w(kt.$$.fragment,te),ra=p(te),mn=r(te,"P",{});var gc=s(mn);sa=i(gc,"Constructs a Whisper feature extractor."),gc.forEach(o),aa=p(te),wt=r(te,"P",{});var Wr=s(wt);ia=i(Wr,"This feature extractor inherits from "),To=r(Wr,"A",{href:!0});var vc=s(To);da=i(vc,"WhisperFeatureExtractor"),vc.forEach(o),ca=i(Wr,` which contains most of the main methods. Users
should refer to this superclass for more information regarding those methods.`),Wr.forEach(o),la=p(te),le=r(te,"P",{});var Vo=s(le);ha=i(Vo,"This class extracts mel-filter bank features from raw speech using a custom numpy implementation of the "),un=r(Vo,"CODE",{});var bc=s(un);pa=i(bc,"Short Time Fourier Transform"),bc.forEach(o),ma=i(Vo," which should match pytorch\u2019s "),fn=r(Vo,"CODE",{});var kc=s(fn);ua=i(kc,"torch.stft"),kc.forEach(o),fa=i(Vo," equivalent."),Vo.forEach(o),_a=p(te),xe=r(te,"DIV",{class:!0});var xr=s(xe);w(yt.$$.fragment,xr),ga=p(xr),_n=r(xr,"P",{});var wc=s(_n);va=i(wc,"Main method to featurize and prepare for the model one or several sequence(s)."),wc.forEach(o),xr.forEach(o),te.forEach(o),ir=p(t),he=r(t,"H2",{class:!0});var Fr=s(he);Fe=r(Fr,"A",{id:!0,class:!0,href:!0});var yc=s(Fe);gn=r(yc,"SPAN",{});var Tc=s(gn);w(Tt.$$.fragment,Tc),Tc.forEach(o),yc.forEach(o),ba=p(Fr),vn=r(Fr,"SPAN",{});var $c=s(vn);ka=i($c,"WhisperProcessor"),$c.forEach(o),Fr.forEach(o),dr=p(t),q=r(t,"DIV",{class:!0});var C=s(q);w($t.$$.fragment,C),wa=p(C),bn=r(C,"P",{});var Wc=s(bn);ya=i(Wc,`Constructs a Whisper processor which wraps a Whisper feature extractor and a Whisper tokenizer into a single
...
refer to the docstring of this method for more information.`),Mr.forEach(o),qr.forEach(o),ci=p(C),Ce=r(C,"DIV",{class:!0});var Cr=s(Ce);w(jt.$$.fragment,Cr),li=p(Cr),St=r(Cr,"P",{});var Pr=s(St);hi=i(Pr,"This method forwards all its arguments to WhisperTokenizer\u2019s "),qo=r(Pr,"A",{href:!0});var Ic=s(qo);pi=i(Ic,"decode()"),Ic.forEach(o),mi=i(Pr,`. Please refer to
the docstring of this method for more information.`),Pr.forEach(o),Cr.forEach(o),C.forEach(o),cr=p(t),pe=r(t,"H2",{class:!0});var jr=s(pe);Pe=r(jr,"A",{id:!0,class:!0,href:!0});var Lc=s(Pe);xn=r(Lc,"SPAN",{});var Dc=s(xn);w(At.$$.fragment,Dc),Dc.forEach(o),Lc.forEach(o),ui=p(jr),Fn=r(jr,"SPAN",{});var Gc=s(Fn);fi=i(Gc,"WhisperModel"),Gc.forEach(o),jr.forEach(o),lr=p(t),G=r(t,"DIV",{class:!0});var Ke=s(G);w(Nt.$$.fragment,Ke),_i=p(Ke),It=r(Ke,"P",{});var Sr=s(It);gi=i(Sr,`The bare Whisper Model outputting raw hidden-states without any specific head on top.
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Ar.forEach(o),$i=p(Ke),B=r(Ke,"DIV",{class:!0});var Je=s(B);w(Gt.$$.fragment,Je),Wi=p(Je),me=r(Je,"P",{});var Uo=s(me);xi=i(Uo,"The "),Co=r(Uo,"A",{href:!0});var Hc=s(Co);Fi=i(Hc,"WhisperModel"),Hc.forEach(o),zi=i(Uo," forward method, overrides the "),zn=r(Uo,"CODE",{});var Rc=s(zn);Ei=i(Rc,"__call__"),Rc.forEach(o),qi=i(Uo," special method."),Uo.forEach(o),Mi=p(Je),w(je.$$.fragment,Je),Ci=p(Je),w(Se.$$.fragment,Je),Je.forEach(o),Ke.forEach(o),hr=p(t),ue=r(t,"H2",{class:!0});var Nr=s(ue);Ae=r(Nr,"A",{id:!0,class:!0,href:!0});var Uc=s(Ae);En=r(Uc,"SPAN",{});var Bc=s(En);w(Ot.$$.fragment,Bc),Bc.forEach(o),Uc.forEach(o),Pi=p(Nr),qn=r(Nr,"SPAN",{});var Kc=s(qn);ji=i(Kc,"WhisperForConditionalGeneration"),Kc.forEach(o),Nr.forEach(o),pr=p(t),O=r(t,"DIV",{class:!0});var Ze=s(O);w(Vt.$$.fragment,Ze),Si=p(Ze),Ht=r(Ze,"P",{});var Ir=s(Ht);Ai=i(Ir,`The Whisper Model with a language modeling head. Can be used for automatic speech recognition.
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Lr.forEach(o),Vi=p(Ze),K=r(Ze,"DIV",{class:!0});var Qe=s(K);w(Bt.$$.fragment,Qe),Hi=p(Qe),fe=r(Qe,"P",{});var Bo=s(fe);Ri=i(Bo,"The "),jo=r(Bo,"A",{href:!0});var Qc=s(jo);Ui=i(Qc,"WhisperForConditionalGeneration"),Qc.forEach(o),Bi=i(Bo," forward method, overrides the "),Mn=r(Bo,"CODE",{});var Xc=s(Mn);Ki=i(Xc,"__call__"),Xc.forEach(o),Ji=i(Bo," special method."),Bo.forEach(o),Zi=p(Qe),w(Ne.$$.fragment,Qe),Qi=p(Qe),w(Ie.$$.fragment,Qe),Qe.forEach(o),Ze.forEach(o),mr=p(t),_e=r(t,"H2",{class:!0});var Dr=s(_e);Le=r(Dr,"A",{id:!0,class:!0,href:!0});var Yc=s(Le);Cn=r(Yc,"SPAN",{});var el=s(Cn);w(Kt.$$.fragment,el),el.forEach(o),Yc.forEach(o),Xi=p(Dr),Pn=r(Dr,"SPAN",{});var tl=s(Pn);Yi=i(tl,"TFWhisperModel"),tl.forEach(o),Dr.forEach(o),ur=p(t),V=r(t,"DIV",{class:!0});var Xe=s(V);w(Jt.$$.fragment,Xe),ed=p(Xe),Zt=r(Xe,"P",{});var Gr=s(Zt);td=i(Gr,`The bare Whisper Model outputting raw hidden-states without any specific head on top.
