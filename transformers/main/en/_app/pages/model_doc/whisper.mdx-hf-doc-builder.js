...
methods above for more information.`),z.forEach(o),this.h()},h(){c(f,"href","/docs/transformers/main/en/internal/image_processing_utils#transformers.FeatureExtractionMixin.from_pretrained")},m(M,z){g(M,l,z),e(l,b),e(l,f),e(f,_),e(l,v),e(l,d),e(d,m),e(l,x)},d(M){M&&o(l)}}}function _l(F){let l,b,f,_,v,d,m,x;return{c(){l=n("p"),b=a("This class method is simply calling "),f=n("a"),_=a("save_pretrained()"),v=a(` and
...
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),m.forEach(o)},m(d,m){g(d,l,m),e(l,b),e(l,f),e(f,_),e(l,v)},d(d){d&&o(l)}}}function vl(F){let l,b,f,_,v;return _=new Bn({props:{code:`from transformers import WhisperProcessor, WhisperModel
import torch
...
the docstring of this method for more information.`),dr=h(),he=n("h2"),Ce=n("a"),Wn=n("span"),k(At.$$.fragment),hi=h(),xn=n("span"),pi=a("WhisperModel"),cr=h(),D=n("div"),k(Nt.$$.fragment),mi=h(),It=n("p"),ui=a(`The bare Whisper Model outputting raw hidden-states without any specific head on top.
...
and behavior.`),wi=h(),U=n("div"),k(Gt.$$.fragment),yi=h(),pe=n("p"),Ti=a("The "),Co=n("a"),$i=a("WhisperModel"),Wi=a(" forward method, overrides the "),Fn=n("code"),xi=a("__call__"),Fi=a(" special method."),zi=h(),k(Me.$$.fragment),Ei=h(),k(je.$$.fragment),lr=h(),me=n("h2"),Se=n("a"),zn=n("span"),k(Ot.$$.fragment),qi=h(),En=n("span"),Pi=a("WhisperForConditionalGeneration"),hr=h(),G=n("div"),k(Vt.$$.fragment),Ci=h(),Rt=n("p"),Mi=a(`The Whisper Model with a language modeling head. Can be used for automatic speech recognition.
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Di=h(),B=n("div"),k(Bt.$$.fragment),Gi=h(),ue=n("p"),Oi=a("The "),jo=n("a"),Vi=a("WhisperForConditionalGeneration"),Ri=a(" forward method, overrides the "),qn=n("code"),Hi=a("__call__"),Ui=a(" special method."),Bi=h(),k(Ae.$$.fragment),Ki=h(),k(Ne.$$.fragment),pr=h(),fe=n("h2"),Ie=n("a"),Pn=n("span"),k(Kt.$$.fragment),Ji=h(),Cn=n("span"),Zi=a("TFWhisperModel"),mr=h(),O=n("div"),k(Jt.$$.fragment),Qi=h(),Zt=n("p"),Xi=a(`The bare Whisper Model outputting raw hidden-states without any specific head on top.
...
behavior.`),sd=h(),K=n("div"),k(Yt.$$.fragment),ad=h(),_e=n("p"),id=a("The "),Ao=n("a"),dd=a("TFWhisperModel"),cd=a(" forward method, overrides the "),Mn=n("code"),ld=a("__call__"),hd=a(" special method."),pd=h(),k(Le.$$.fragment),md=h(),k(De.$$.fragment),ur=h(),ge=n("h2"),Ge=n("a"),jn=n("span"),k(eo.$$.fragment),ud=h(),Sn=n("span"),fd=a("TFWhisperForConditionalGeneration"),fr=h(),V=n("div"),k(to.$$.fragment),_d=h(),oo=n("p"),gd=a(`The Whisper Model with a language modeling head. Can be used for automatic speech recognition.
...
documentation from `),go=r(Do,"A",{href:!0});var Yd=s(go);Es=i(Yd,"PretrainedConfig"),Yd.forEach(o),qs=i(Do," for more information."),Do.forEach(o),Ps=p(Ue),w(we.$$.fragment,Ue),Ue.forEach(o),or=p(t),ae=r(t,"H2",{class:!0});var kr=s(ae);ye=r(kr,"A",{id:!0,class:!0,href:!0});var ec=s(ye);rn=r(ec,"SPAN",{});var tc=s(rn);w(pt.$$.fragment,tc),tc.forEach(o),ec.forEach(o),Cs=p(kr),sn=r(kr,"SPAN",{});var oc=s(sn);Ms=i(oc,"WhisperTokenizer"),oc.forEach(o),kr.forEach(o),nr=p(t),P=r(t,"DIV",{class:!0});var I=s(P);w(mt.$$.fragment,I),js=p(I),an=r(I,"P",{});var nc=s(an);Ss=i(nc,"Construct an Whisper tokenizer."),nc.forEach(o),As=p(I),ut=r(I,"P",{});var wr=s(ut);Ns=i(wr,"This tokenizer inherits from "),vo=r(wr,"A",{href:!0});var rc=s(vo);Is=i(rc,"PreTrainedTokenizer"),rc.forEach(o),Ls=i(wr,` which contains some of the main methods. Users should refer to
