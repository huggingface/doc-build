...
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),u.forEach(o)},m(d,u){g(d,l,u),e(l,b),e(l,f),e(f,_),e(l,v)},d(d){d&&o(l)}}}function ml(F){let l,b,f,_,v;return _=new Un({props:{code:`from transformers import WhisperProcessor, WhisperModel
import torch
...
`}}),De=new Zo({props:{$$slots:{default:[gl]},$$scope:{ctx:F}}}),Le=new Rn({props:{anchor:"transformers.TFWhisperModel.call.example",$$slots:{default:[vl]},$$scope:{ctx:F}}}),Yt=new oe({}),eo=new E({props:{name:"class transformers.TFWhisperForConditionalGeneration",anchor:"transformers.TFWhisperForConditionalGeneration",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.TFWhisperForConditionalGeneration.config",description:`<strong>config</strong> (<a href="/docs/transformers/main/en/model_doc/whisper#transformers.WhisperConfig">WhisperConfig</a>) &#x2014;
Model configuration class with all the parameters of the model. Initializing with a config file does not
load the weights associated with the model, only the configuration. Check out the
<a href="/docs/transformers/main/en/main_classes/model#transformers.TFPreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/whisper/modeling_tf_whisper.py#L1211"}}),ro=new E({props:{name:"call",anchor:"transformers.TFWhisperForConditionalGeneration.call",parameters:[{name:"input_features",val:" = None"},{name:"decoder_input_ids",val:" = None"},{name:"decoder_attention_mask",val:" = None"},{name:"decoder_position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"decoder_head_mask",val:" = None"},{name:"cross_attn_head_mask",val:" = None"},{name:"encoder_outputs",val:" = None"},{name:"past_key_values",val:" = None"},{name:"decoder_inputs_embeds",val:" = None"},{name:"labels",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"},{name:"training",val:" = False"}],parametersDescription:[{anchor:"transformers.TFWhisperForConditionalGeneration.call.input_features",description:`<strong>input_features</strong> (<code>tf.Tensor</code> of shape <code>(batch_size, feature_size, sequence_length)</code>) &#x2014;
Float values of fbank features extracted from the raw speech waveform. Raw speech waveform can be obtained
by loading a <code>.flac</code> or <code>.wav</code> audio file into an array of type <code>List[float]</code> or a <code>numpy.ndarray</code>, <em>e.g.</em>
via the soundfile library (<code>pip install soundfile</code>). To prepare the array into <code>input_features</code>, the
<a href="/docs/transformers/main/en/model_doc/whisper#transformers.WhisperFeatureExtractor">WhisperFeatureExtractor</a> should be used for extracting the fbank features, padding and conversion into a
...
`),Ft=n("a"),yn=n("strong"),Da=a("call"),La=a("()"),Ga=a(". Please refer to the doctsring of the above two methods for more information."),Oa=h(),Y=n("div"),k(zt.$$.fragment),Va=h(),Tn=n("p"),Ra=a("Instantiate a processor associated with a pretrained model."),Ha=h(),k(ze.$$.fragment),Ua=h(),ee=n("div"),k(Et.$$.fragment),Ba=h(),qt=n("p"),Ka=a(`Saves the attributes of this processor (feature extractor, tokenizer\u2026) in the specified directory so that it
...
and behavior.`),vi=h(),H=n("div"),k(Lt.$$.fragment),bi=h(),pe=n("p"),ki=a("The "),Po=n("a"),wi=a("WhisperModel"),yi=a(" forward method, overrides the "),xn=n("code"),Ti=a("__call__"),$i=a(" special method."),Wi=h(),k(Me.$$.fragment),xi=h(),k(je.$$.fragment),cr=h(),ue=n("h2"),Se=n("a"),Fn=n("span"),k(Gt.$$.fragment),Fi=h(),zn=n("span"),zi=a("WhisperForConditionalGeneration"),lr=h(),G=n("div"),k(Ot.$$.fragment),Ei=h(),Vt=n("p"),qi=a(`The Whisper Model with a language modeling head. Can be used for automatic speech recognition.
...
documentation from `),_o=r(Lo,"A",{href:!0});var Jd=s(_o);xs=i(Jd,"PretrainedConfig"),Jd.forEach(o),Fs=i(Lo," for more information."),Lo.forEach(o),zs=p(He),w(we.$$.fragment,He),He.forEach(o),tr=p(t),ae=r(t,"H2",{class:!0});var br=s(ae);ye=r(br,"A",{id:!0,class:!0,href:!0});var Zd=s(ye);nn=r(Zd,"SPAN",{});var Qd=s(nn);w(ht.$$.fragment,Qd),Qd.forEach(o),Zd.forEach(o),Es=p(br),rn=r(br,"SPAN",{});var Xd=s(rn);qs=i(Xd,"WhisperTokenizer"),Xd.forEach(o),br.forEach(o),or=p(t),P=r(t,"DIV",{class:!0});var I=s(P);w(pt.$$.fragment,I),Ps=p(I),sn=r(I,"P",{});var Yd=s(sn);Cs=i(Yd,"Construct an Whisper tokenizer."),Yd.forEach(o),Ms=p(I),ut=r(I,"P",{});var kr=s(ut);js=i(kr,"This tokenizer inherits from "),go=r(kr,"A",{href:!0});var ec=s(go);Ss=i(ec,"PreTrainedTokenizer"),ec.forEach(o),As=i(kr,` which contains some of the main methods. Users should refer to
