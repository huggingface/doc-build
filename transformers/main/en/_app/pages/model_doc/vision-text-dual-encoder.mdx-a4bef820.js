import{S as Nr,i as Or,s as Br,e as n,k as d,w as _,t as r,M as Wr,c as a,d as t,m as c,a as s,x as v,h as i,b as l,F as e,g as h,y as x,q as T,o as E,B as b,v as Rr}from"../../chunks/vendor-6b77c823.js";import{T as Sr}from"../../chunks/Tip-39098574.js";import{D as U}from"../../chunks/Docstring-90e3aa51.js";import{C as ys}from"../../chunks/CodeBlock-3a8b25a8.js";import{I as $t}from"../../chunks/IconCopyLink-7a11ce68.js";function Ur(et){let p,q,g,$,A;return{c(){p=n("p"),q=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),g=n("code"),$=r("Module"),A=r(`
...
Dictionary of keyword arguments.`,name:"kwargs"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/vision_text_dual_encoder/configuration_vision_text_dual_encoder.py#L28"}}),_e=new ys({props:{code:`from transformers import ViTConfig, BertConfig, VisionTextDualEncoderConfig, VisionTextDualEncoderModel
...
`),vt=a(yo,"A",{href:!0});var rr=s(vt);ea=i(rr,"batch_decode()"),rr.forEach(t),ta=i(yo,". Please refer to the docstring of this method for more information."),yo.forEach(t),wo.forEach(t),oa=c(B),ie=a(B,"DIV",{class:!0});var Vo=s(ie);v(Ve.$$.fragment,Vo),na=c(Vo),ke=a(Vo,"P",{});var ko=s(ke);aa=i(ko,"This method forwards all its arguments to VisionTextDualEncoderTokenizer\u2019s "),xt=a(ko,"A",{href:!0});var ir=s(xt);sa=i(ir,"decode()"),ir.forEach(t),ra=i(ko,`.
...
should be fine-tuned on a downstream task, like contrastive image-text modeling.`),Fo.forEach(t),Ra=c(k),Oe=a(k,"P",{});var Io=s(Oe);Ua=i(Io,"In "),Be=a(Io,"A",{href:!0,rel:!0});var jr=s(Be);Ja=i(jr,"LiT: Zero-Shot Transfer with Locked-image Text Tuning"),jr.forEach(t),Ha=i(Io,` it is shown how
leveraging pre-trained (locked/frozen) image and text model for contrastive learning yields significant improvment
