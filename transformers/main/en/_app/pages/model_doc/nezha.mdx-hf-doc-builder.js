...
the latter silently ignores them.`)},l(o){s=l(o,"P",{});var p=d(s);g=r(p,"Although the recipe for forward pass needs to be defined within this function, one should call the "),c=l(p,"CODE",{});var F=d(c);h=r(F,"Module"),F.forEach(n),b=r(p,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
<span class="hljs-meta">&gt;&gt;&gt; </span>loss = outputs.loss
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-built_in">round</span>(loss.item(), <span class="hljs-number">2</span>)
`}}),{c(){k(s.$$.fragment)},l(c){$(s.$$.fragment,c)},m(c,h){w(s,c,h),g=!0},p:D,i(c){g||(v(s.$$.fragment,c),g=!0)},o(c){T(s.$$.fragment,c),g=!1},d(c){y(s,c)}}}function Nh(N){let s,g,c,h,b,o,p,F,ua,_s,pe,Oe,co,$t,fa,ho,ga,bs,Se,_a,wt,ba,za,zs,Pn,ka,ks,qn,po,$a,$s,te,wa,vt,va,Ta,Tt,ya,Na,ws,me,Le,mo,yt,Fa,uo,Ma,vs,Z,Nt,xa,ue,ja,Cn,Pa,qa,Ft,Ca,Ea,Aa,fe,Oa,En,Sa,La,An,Ia,Da,Ba,Ie,Ts,ge,De,fo,Mt,Wa,go,Ha,ys,M,xt,Qa,_o,Ua,Va,jt,Ra,On,Za,Ja,Ka,Pt,Ga,qt,Xa,Ya,er,Ct,tr,Et,nr,or,sr,j,ar,bo,rr,ir,zo,lr,dr,ko,cr,hr,$o,pr,mr,wo,ur,fr,vo,gr,_r,br,J,At,zr,_e,kr,Sn,$r,wr,To,vr,Tr,yr,Be,Nr,We,Ns,be,He,yo,Ot,Fr,No,Mr,Fs,q,St,xr,ze,jr,Fo,Pr,qr,Mo,Cr,Er,Ar,Lt,Or,Ln,Sr,Lr,Ir,It,Dr,Dt,Br,Wr,Hr,K,Bt,Qr,ke,Ur,In,Vr,Rr,xo,Zr,Jr,Kr,Qe,Gr,Ue,Ms,$e,Ve,jo,Wt,Xr,Po,Yr,xs,C,Ht,ei,Qt,ti,qo,ni,oi,si,Ut,ai,Dn,ri,ii,li,Vt,di,Rt,ci,hi,pi,W,Zt,mi,we,ui,Bn,fi,gi,Co,_i,bi,zi,Re,ki,Ze,$i,Je,js,ve,Ke,Eo,Jt,wi,Ao,vi,Ps,E,Kt,Ti,Gt,yi,Oo,Ni,Fi,Mi,Xt,xi,Wn,ji,Pi,qi,Yt,Ci,en,Ei,Ai,Oi,G,tn,Si,Te,Li,Hn,Ii,Di,So,Bi,Wi,Hi,Ge,Qi,Xe,qs,ye,Ye,Lo,nn,Ui,Io,Vi,Cs,A,on,Ri,Do,Zi,Ji,sn,Ki,Qn,Gi,Xi,Yi,an,el,rn,tl,nl,ol,x,ln,sl,Ne,al,Un,rl,il,Bo,ll,dl,cl,et,hl,tt,pl,nt,ml,ot,ul,st,Es,Fe,at,Wo,dn,fl,Ho,gl,As,O,cn,_l,Qo,bl,zl,hn,kl,Vn,$l,wl,vl,pn,Tl,mn,yl,Nl,Fl,X,un,Ml,Me,xl,Rn,jl,Pl,Uo,ql,Cl,El,rt,Al,it,Os,xe,lt,Vo,fn,Ol,Ro,Sl,Ss,S,gn,Ll,Zo,Il,Dl,_n,Bl,Zn,Wl,Hl,Ql,bn,Ul,zn,Vl,Rl,Zl,H,kn,Jl,je,Kl,Jn,Gl,Xl,Jo,Yl,ed,td,dt,nd,ct,od,ht,Ls,Pe,pt,Ko,$n,sd,Go,ad,Is,L,wn,rd,qe,id,Xo,ld,dd,Yo,cd,hd,pd,vn,md,Kn,ud,fd,gd,Tn,_d,yn,bd,zd,kd,Q,Nn,$d,Ce,wd,Gn,vd,Td,es,yd,Nd,Fd,mt,Md,ut,xd,ft,Ds;return o=new ee({}),$t=new ee({}),yt=new ee({}),Nt=new P({props:{name:"class transformers.NezhaConfig",anchor:"transformers.NezhaConfig",parameters:[{name:"vocab_size",val:" = 21128"},{name:"embedding_size",val:" = 128"},{name:"hidden_size",val:" = 768"},{name:"num_hidden_layers",val:" = 12"},{name:"num_attention_heads",val:" = 12"},{name:"intermediate_size",val:" = 3072"},{name:"hidden_act",val:" = 'gelu'"},{name:"hidden_dropout_prob",val:" = 0.1"},{name:"attention_probs_dropout_prob",val:" = 0.1"},{name:"max_position_embeddings",val:" = 512"},{name:"max_relative_position",val:" = 64"},{name:"type_vocab_size",val:" = 2"},{name:"initializer_range",val:" = 0.02"},{name:"layer_norm_eps",val:" = 1e-12"},{name:"classifier_dropout",val:" = 0.1"},{name:"pad_token_id",val:" = 0"},{name:"bos_token_id",val:" = 2"},{name:"eos_token_id",val:" = 3"},{name:"use_cache",val:" = True"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.NezhaConfig.vocab_size",description:`<strong>vocab_size</strong> (<code>int</code>, optional, defaults to 21128) &#x2014;
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),kd=m(),Q=i("div"),k(Nn.$$.fragment),$d=m(),Ce=i("p"),wd=a("The "),Gn=i("a"),vd=a("NezhaForQuestionAnswering"),Td=a(" forward method, overrides the "),es=i("code"),yd=a("__call__"),Nd=a(" special method."),Fd=m(),k(mt.$$.fragment),Md=m(),k(ut.$$.fragment),xd=m(),k(ft.$$.fragment),this.h()},l(t){const _=th('[data-svelte="svelte-1phssyn"]',document.head);s=l(_,"META",{name:!0,content:!0}),_.forEach(n),g=u(t),c=l(t,"H1",{class:!0});var Fn=d(c);h=l(Fn,"A",{id:!0,class:!0,href:!0});var ts=d(h);b=l(ts,"SPAN",{});var ns=d(b);$(o.$$.fragment,ns),ns.forEach(n),ts.forEach(n),p=u(Fn),F=l(Fn,"SPAN",{});var os=d(F);ua=r(os,"Nezha"),os.forEach(n),Fn.forEach(n),_s=u(t),pe=l(t,"H2",{class:!0});var Mn=d(pe);Oe=l(Mn,"A",{id:!0,class:!0,href:!0});var ss=d(Oe);co=l(ss,"SPAN",{});var as=d(co);$($t.$$.fragment,as),as.forEach(n),ss.forEach(n),fa=u(Mn),ho=l(Mn,"SPAN",{});var rs=d(ho);ga=r(rs,"Overview"),rs.forEach(n),Mn.forEach(n),bs=u(t),Se=l(t,"P",{});var xn=d(Se);_a=r(xn,"The Nezha model was proposed in "),wt=l(xn,"A",{href:!0,rel:!0});var is=d(wt);ba=r(is,"NEZHA: Neural Contextualized Representation for Chinese Language Understanding"),is.forEach(n),za=r(xn," by Junqiu Wei et al."),xn.forEach(n),zs=u(t),Pn=l(t,"P",{});var ls=d(Pn);ka=r(ls,"The abstract from the paper is the following:"),ls.forEach(n),ks=u(t),qn=l(t,"P",{});var ds=d(qn);po=l(ds,"EM",{});var cs=d(po);$a=r(cs,`The pre-trained language models have achieved great successes in various natural language understanding (NLU) tasks
due to its capacity to capture the deep contextualized information in text by pre-training on large-scale corpora.
In this technical report, we present our practice of pre-training language models named NEZHA (NEural contextualiZed
representation for CHinese lAnguage understanding) on Chinese corpora and finetuning for the Chinese NLU tasks.
The current version of NEZHA is based on BERT with a collection of proven improvements, which include Functional
...
`),$o=l(V,"CODE",{});var Hd=d($o);pr=r(Hd,"add_cross_attention"),Hd.forEach(n),mr=r(V," set to "),wo=l(V,"CODE",{});var Qd=d(wo);ur=r(Qd,"True"),Qd.forEach(n),fr=r(V,"; an "),vo=l(V,"CODE",{});var Ud=d(vo);gr=r(Ud,"encoder_hidden_states"),Ud.forEach(n),_r=r(V," is then expected as an input to the forward pass."),V.forEach(n),br=u(U),J=l(U,"DIV",{class:!0});var gt=d(J);$(At.$$.fragment,gt),zr=u(gt),_e=l(gt,"P",{});var Yn=d(_e);kr=r(Yn,"The "),Sn=l(Yn,"A",{href:!0});var Vd=d(Sn);$r=r(Vd,"NezhaModel"),Vd.forEach(n),wr=r(Yn," forward method, overrides the "),To=l(Yn,"CODE",{});var Rd=d(To);vr=r(Rd,"__call__"),Rd.forEach(n),Tr=r(Yn," special method."),Yn.forEach(n),yr=u(gt),$(Be.$$.fragment,gt),Nr=u(gt),$(We.$$.fragment,gt),gt.forEach(n),U.forEach(n),Ns=u(t),be=l(t,"H2",{class:!0});var Us=d(be);He=l(Us,"A",{id:!0,class:!0,href:!0});var Zd=d(He);yo=l(Zd,"SPAN",{});var Jd=d(yo);$(Ot.$$.fragment,Jd),Jd.forEach(n),Zd.forEach(n),Fr=u(Us),No=l(Us,"SPAN",{});var Kd=d(No);Mr=r(Kd,"NezhaForPreTraining"),Kd.forEach(n),Us.forEach(n),Fs=u(t),q=l(t,"DIV",{class:!0});var ne=d(q);$(St.$$.fragment,ne),xr=u(ne),ze=l(ne,"P",{});var eo=d(ze);jr=r(eo,"Nezha Model with two heads on top as done during the pretraining: a "),Fo=l(eo,"CODE",{});var Gd=d(Fo);Pr=r(Gd,"masked language modeling"),Gd.forEach(n),qr=r(eo," head and a "),Mo=l(eo,"CODE",{});var Xd=d(Mo);Cr=r(Xd,"next sentence prediction (classification)"),Xd.forEach(n),Er=r(eo," head."),eo.forEach(n),Ar=u(ne),Lt=l(ne,"P",{});var Vs=d(Lt);Or=r(Vs,"This model inherits from "),Ln=l(Vs,"A",{href:!0});var Yd=d(Ln);Sr=r(Yd,"PreTrainedModel"),Yd.forEach(n),Lr=r(Vs,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),sa.forEach(n),ol=u(re),x=l(re,"DIV",{class:!0});var R=d(x);$(ln.$$.fragment,R),sl=u(R),Ne=l(R,"P",{});var so=d(Ne);al=r(so,"The "),Un=l(so,"A",{href:!0});var yc=d(Un);rl=r(yc,"NezhaForSequenceClassification"),yc.forEach(n),il=r(so," forward method, overrides the "),Bo=l(so,"CODE",{});var Nc=d(Bo);ll=r(Nc,"__call__"),Nc.forEach(n),dl=r(so," special method."),so.forEach(n),cl=u(R),$(et.$$.fragment,R),hl=u(R),$(tt.$$.fragment,R),pl=u(R),$(nt.$$.fragment,R),ml=u(R),$(ot.$$.fragment,R),ul=u(R),$(st.$$.fragment,R),R.forEach(n),re.forEach(n),Es=u(t),Fe=l(t,"H2",{class:!0});var aa=d(Fe);at=l(aa,"A",{id:!0,class:!0,href:!0});var Fc=d(at);Wo=l(Fc,"SPAN",{});var Mc=d(Wo);$(dn.$$.fragment,Mc),Mc.forEach(n),Fc.forEach(n),fl=u(aa),Ho=l(aa,"SPAN",{});var xc=d(Ho);gl=r(xc,"NezhaForMultipleChoice"),xc.forEach(n),aa.forEach(n),As=u(t),O=l(t,"DIV",{class:!0});var ie=d(O);$(cn.$$.fragment,ie),_l=u(ie),Qo=l(ie,"P",{});var jc=d(Qo);bl=r(jc,`Nezha Model with a multiple choice classification head on top (a linear layer on top of the pooled output and a
