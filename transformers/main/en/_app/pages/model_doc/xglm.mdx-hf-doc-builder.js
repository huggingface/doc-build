...
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),m.forEach(t)},m(l,m){g(l,p,m),e(p,y),e(p,f),e(f,u),e(p,k)},d(l){l&&t(p)}}}function ah(X){let p,y,f,u,k;return u=new kn({props:{code:`from transformers import XGLMTokenizer, XGLMModel
import torch
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),{c(){p=n("p"),y=r("Example:"),f=d(),b(u.$$.fragment)},l(l){p=s(l,"P",{});var m=a(p);y=i(m,"Example:"),m.forEach(t),f=c(l),T(u.$$.fragment,l)},m(l,m){g(l,p,m),e(p,y),g(l,f,m),M(u,l,m),k=!0},p:_n,i(l){k||(w(u.$$.fragment,l),k=!0)},o(l){L(u.$$.fragment,l),k=!1},d(l){l&&t(p),l&&t(f),$(u,l)}}}function rh(X){let p,y,f,u,k;return{c(){p=n("p"),y=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=n("code"),u=r("Module"),k=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(l){p=s(l,"P",{});var m=a(p);y=i(m,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=s(m,"CODE",{});var x=a(f);u=i(x,"Module"),x.forEach(t),k=i(m,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),m.forEach(t)},m(l,m){g(l,p,m),e(p,y),e(p,f),e(f,u),e(p,k)},d(l){l&&t(p)}}}function ih(X){let p,y,f,u,k;return u=new kn({props:{code:`import torch
...
`),A=s(Ne,"CODE",{});var re=a(A);ge=i(re,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),re.forEach(t),Ne.forEach(t),K.forEach(t)},m(v,G){g(v,p,G),e(p,y),g(v,f,G),g(v,u,G),e(u,k),e(k,l),e(u,m),e(u,x),e(x,Fe),g(v,ce,G),g(v,z,G),e(z,ee),e(z,B),e(B,te),e(z,Ee),e(z,R),e(R,qe),e(z,ve),g(v,S,G),g(v,V,G),e(V,oe),g(v,fe,G),g(v,q,G),e(q,C),e(C,pe),e(C,ne),e(ne,ye),e(C,he),e(C,H),e(H,Ce),e(q,be),e(q,F),e(F,Pe),e(F,j),e(j,Ae),e(F,je),e(F,O),e(O,Oe),e(q,De),e(q,W),e(W,J),e(W,A),e(A,ge)},d(v){v&&t(p),v&&t(f),v&&t(u),v&&t(ce),v&&t(z),v&&t(S),v&&t(V),v&&t(fe),v&&t(q)}}}function dh(X){let p,y,f,u,k;return{c(){p=n("p"),y=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=n("code"),u=r("Module"),k=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(l){p=s(l,"P",{});var m=a(p);y=i(m,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=s(m,"CODE",{});var x=a(f);u=i(x,"Module"),x.forEach(t),k=i(m,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),m.forEach(t)},m(l,m){g(l,p,m),e(p,y),e(p,f),e(f,u),e(p,k)},d(l){l&&t(p)}}}function ch(X){let p,y,f,u,k;return u=new kn({props:{code:`from transformers import XGLMTokenizer, TFXGLMModel
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),{c(){p=n("p"),y=r("Example:"),f=d(),b(u.$$.fragment)},l(l){p=s(l,"P",{});var m=a(p);y=i(m,"Example:"),m.forEach(t),f=c(l),T(u.$$.fragment,l)},m(l,m){g(l,p,m),e(p,y),g(l,f,m),M(u,l,m),k=!0},p:_n,i(l){k||(w(u.$$.fragment,l),k=!0)},o(l){L(u.$$.fragment,l),k=!1},d(l){l&&t(p),l&&t(f),$(u,l)}}}function ph(X){let p,y,f,u,k,l,m,x,Fe,ce,z,ee,B,te,Ee,R,qe,ve,S,V,oe,fe,q,C,pe,ne,ye,he,H,Ce,be,F,Pe,j,Ae,je,O,Oe,De,W,J,A,ge;return{c(){p=n("p"),y=r("TF 2.0 models accepts two formats as inputs:"),f=d(),u=n("ul"),k=n("li"),l=r("having all inputs as keyword arguments (like PyTorch models), or"),m=d(),x=n("li"),Fe=r("having all inputs as a list, tuple or dict in the first positional arguments."),ce=d(),z=n("p"),ee=r("This second option is useful when using "),B=n("code"),te=r("tf.keras.Model.fit"),Ee=r(` method which currently requires having all the
tensors in the first argument of the model call function: `),R=n("code"),qe=r("model(inputs)"),ve=r("."),S=d(),V=n("p"),oe=r(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),fe=d(),q=n("ul"),C=n("li"),pe=r("a single Tensor with "),ne=n("code"),ye=r("input_ids"),he=r(" only and nothing else: "),H=n("code"),Ce=r("model(input_ids)"),be=d(),F=n("li"),Pe=r(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),j=n("code"),Ae=r("model([input_ids, attention_mask])"),je=r(" or "),O=n("code"),Oe=r("model([input_ids, attention_mask, token_type_ids])"),De=d(),W=n("li"),J=r(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),A=n("code"),ge=r('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(v){p=s(v,"P",{});var G=a(p);y=i(G,"TF 2.0 models accepts two formats as inputs:"),G.forEach(t),f=c(v),u=s(v,"UL",{});var se=a(u);k=s(se,"LI",{});var Qe=a(k);l=i(Qe,"having all inputs as keyword arguments (like PyTorch models), or"),Qe.forEach(t),m=c(se),x=s(se,"LI",{});var Be=a(x);Fe=i(Be,"having all inputs as a list, tuple or dict in the first positional arguments."),Be.forEach(t),se.forEach(t),ce=c(v),z=s(v,"P",{});var E=a(z);ee=i(E,"This second option is useful when using "),B=s(E,"CODE",{});var _e=a(B);te=i(_e,"tf.keras.Model.fit"),_e.forEach(t),Ee=i(E,` method which currently requires having all the
...
first positional argument :`),ae.forEach(t),fe=c(v),q=s(v,"UL",{});var K=a(q);C=s(K,"LI",{});var U=a(C);pe=i(U,"a single Tensor with "),ne=s(U,"CODE",{});var et=a(ne);ye=i(et,"input_ids"),et.forEach(t),he=i(U," only and nothing else: "),H=s(U,"CODE",{});var tt=a(H);Ce=i(tt,"model(input_ids)"),tt.forEach(t),U.forEach(t),be=c(K),F=s(K,"LI",{});var D=a(F);Pe=i(D,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),j=s(D,"CODE",{});var ot=a(j);Ae=i(ot,"model([input_ids, attention_mask])"),ot.forEach(t),je=i(D," or "),O=s(D,"CODE",{});var nt=a(O);Oe=i(nt,"model([input_ids, attention_mask, token_type_ids])"),nt.forEach(t),D.forEach(t),De=c(K),W=s(K,"LI",{});var Ne=a(W);J=i(Ne,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),A=s(Ne,"CODE",{});var re=a(A);ge=i(re,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),re.forEach(t),Ne.forEach(t),K.forEach(t)},m(v,G){g(v,p,G),e(p,y),g(v,f,G),g(v,u,G),e(u,k),e(k,l),e(u,m),e(u,x),e(x,Fe),g(v,ce,G),g(v,z,G),e(z,ee),e(z,B),e(B,te),e(z,Ee),e(z,R),e(R,qe),e(z,ve),g(v,S,G),g(v,V,G),e(V,oe),g(v,fe,G),g(v,q,G),e(q,C),e(C,pe),e(C,ne),e(ne,ye),e(C,he),e(C,H),e(H,Ce),e(q,be),e(q,F),e(F,Pe),e(F,j),e(j,Ae),e(F,je),e(F,O),e(O,Oe),e(q,De),e(q,W),e(W,J),e(W,A),e(A,ge)},d(v){v&&t(p),v&&t(f),v&&t(u),v&&t(ce),v&&t(z),v&&t(S),v&&t(V),v&&t(fe),v&&t(q)}}}function hh(X){let p,y,f,u,k;return{c(){p=n("p"),y=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=n("code"),u=r("Module"),k=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(l){p=s(l,"P",{});var m=a(p);y=i(m,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=s(m,"CODE",{});var x=a(f);u=i(x,"Module"),x.forEach(t),k=i(m,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),m.forEach(t)},m(l,m){g(l,p,m),e(p,y),e(p,f),e(f,u),e(p,k)},d(l){l&&t(p)}}}function uh(X){let p,y,f,u,k;return u=new kn({props:{code:`from transformers import XGLMTokenizer, TFXGLMForCausalLM
import tensorflow as tf
...
<span class="hljs-meta">&gt;&gt;&gt; </span>inputs = tokenizer(<span class="hljs-string">&quot;Hello, my dog is cute&quot;</span>, return_tensors=<span class="hljs-string">&quot;tf&quot;</span>)
<span class="hljs-meta">&gt;&gt;&gt; </span>outputs = model(inputs)
<span class="hljs-meta">&gt;&gt;&gt; </span>logits = outputs.logits`}}),{c(){p=n("p"),y=r("Example:"),f=d(),b(u.$$.fragment)},l(l){p=s(l,"P",{});var m=a(p);y=i(m,"Example:"),m.forEach(t),f=c(l),T(u.$$.fragment,l)},m(l,m){g(l,p,m),e(p,y),g(l,f,m),M(u,l,m),k=!0},p:_n,i(l){k||(w(u.$$.fragment,l),k=!0)},o(l){L(u.$$.fragment,l),k=!1},d(l){l&&t(p),l&&t(f),$(u,l)}}}function mh(X){let p,y,f,u,k;return{c(){p=n("p"),y=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=n("code"),u=r("Module"),k=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(l){p=s(l,"P",{});var m=a(p);y=i(m,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=s(m,"CODE",{});var x=a(f);u=i(x,"Module"),x.forEach(t),k=i(m,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),m.forEach(t)},m(l,m){g(l,p,m),e(p,y),e(p,f),e(f,u),e(p,k)},d(l){l&&t(p)}}}function fh(X){let p,y,f,u,k;return u=new kn({props:{code:`from transformers import XGLMTokenizer, FlaxXGLMModel
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),{c(){p=n("p"),y=r("Example:"),f=d(),b(u.$$.fragment)},l(l){p=s(l,"P",{});var m=a(p);y=i(m,"Example:"),m.forEach(t),f=c(l),T(u.$$.fragment,l)},m(l,m){g(l,p,m),e(p,y),g(l,f,m),M(u,l,m),k=!0},p:_n,i(l){k||(w(u.$$.fragment,l),k=!0)},o(l){L(u.$$.fragment,l),k=!1},d(l){l&&t(p),l&&t(f),$(u,l)}}}function gh(X){let p,y,f,u,k;return{c(){p=n("p"),y=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=n("code"),u=r("Module"),k=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(l){p=s(l,"P",{});var m=a(p);y=i(m,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=s(m,"CODE",{});var x=a(f);u=i(x,"Module"),x.forEach(t),k=i(m,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),m.forEach(t)},m(l,m){g(l,p,m),e(p,y),e(p,f),e(f,u),e(p,k)},d(l){l&&t(p)}}}function _h(X){let p,y,f,u,k;return u=new kn({props:{code:`from transformers import XGLMTokenizer, FlaxXGLMForCausalLM
...
`}}),Bt=new no({props:{$$slots:{default:[gh]},$$scope:{ctx:X}}}),Rt=new gn({props:{anchor:"transformers.FlaxXGLMForCausalLM.__call__.example",$$slots:{default:[_h]},$$scope:{ctx:X}}}),{c(){p=n("meta"),y=d(),f=n("h1"),u=n("a"),k=n("span"),b(l.$$.fragment),m=d(),x=n("span"),Fe=r("XGLM"),ce=d(),z=n("h2"),ee=n("a"),B=n("span"),b(te.$$.fragment),Ee=d(),R=n("span"),qe=r("Overview"),ve=d(),S=n("p"),V=r("The XGLM model was proposed in "),oe=n("a"),fe=r("Few-shot Learning with Multilingual Language Models"),q=r(`
...
adding special tokens. An XLM-RoBERTa sequence has the following format:`),Mr=d(),co=n("ul"),wn=n("li"),wr=r("single sequence: "),ts=n("code"),Lr=r("<s> X </s>"),$r=d(),Ln=n("li"),xr=r("pair of sequences: "),os=n("code"),Xr=r("<s> A </s></s> B </s>"),zr=d(),bt=n("div"),b(po.$$.fragment),Gr=d(),ho=n("p"),Fr=r(`Retrieve sequence ids from a token list that has no special tokens added. This method is called when adding
...
and `),Xn=n("a"),Rr=r("XLNetTokenizer"),Vr=r(`. Based on
`),_o=n("a"),Hr=r("BPE"),Jr=r("."),Kr=d(),ko=n("p"),Zr=r("This tokenizer inherits from "),zn=n("a"),Qr=r("PreTrainedTokenizerFast"),Yr=r(` which contains most of the main methods. Users should
...
and behavior.`),Ti=d(),$t=n("p"),Mi=r("Transformer decoder consisting of "),ms=n("em"),wi=r("config.num_layers"),Li=r(" layers. Each layer is a "),fs=n("code"),$i=r("XGLMDecoderLayer"),xi=d(),Te=n("div"),b(xo.$$.fragment),Xi=d(),it=n("p"),zi=r("The "),qn=n("a"),Gi=r("XGLMModel"),Fi=r(" forward method, overrides the "),gs=n("code"),Ei=r("__call__"),qi=r(" special method."),Ci=d(),b(xt.$$.fragment),Pi=d(),b(Xt.$$.fragment),ma=d(),lt=n("h2"),zt=n("a"),_s=n("span"),b(Xo.$$.fragment),Ai=d(),ks=n("span"),ji=r("XGLMForCausalLM"),fa=d(),de=n("div"),b(zo.$$.fragment),Oi=d(),vs=n("p"),Di=r(`The XGLM Model transformer with a language modeling head on top (linear layer with weights tied to the input
...
behavior.`),ul=d(),b(qt.$$.fragment),ml=d(),Ct=n("p"),fl=r("Transformer decoder consisting of "),Ms=n("em"),gl=r("config.num_layers"),_l=r(" layers. Each layer is a "),ws=n("code"),kl=r("TFXGLMDecoderLayer"),vl=d(),we=n("div"),b(Do.$$.fragment),yl=d(),pt=n("p"),bl=r("The "),jn=n("a"),Tl=r("TFXGLMModel"),Ml=r(" forward method, overrides the "),Ls=n("code"),wl=r("__call__"),Ll=r(" special method."),$l=d(),b(Pt.$$.fragment),xl=d(),b(At.$$.fragment),ka=d(),ht=n("h2"),jt=n("a"),$s=n("span"),b(No.$$.fragment),Xl=d(),xs=n("span"),zl=r("TFXGLMForCausalLM"),va=d(),Q=n("div"),b(Io.$$.fragment),Gl=d(),Xs=n("p"),Fl=r(`The XGLM Model transformer with a language modeling head on top (linear layer with weights tied to the input
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Nl=d(),b(Ot.$$.fragment),Il=d(),Le=n("div"),b(Bo.$$.fragment),Sl=d(),ut=n("p"),Wl=r("The "),Dn=n("a"),Ul=r("TFXGLMForCausalLM"),Bl=r(" forward method, overrides the "),zs=n("code"),Rl=r("__call__"),Vl=r(" special method."),Hl=d(),b(Dt.$$.fragment),Jl=d(),b(Nt.$$.fragment),ya=d(),mt=n("h2"),It=n("a"),Gs=n("span"),b(Ro.$$.fragment),Kl=d(),Fs=n("span"),Zl=r("FlaxXGLMModel"),ba=d(),Y=n("div"),b(Vo.$$.fragment),Ql=d(),Ho=n("p"),Yl=r(`The bare XGLM Model transformer outputting raw hidden-states without any specific head on top.
...
adding special tokens. An XLM-RoBERTa sequence has the following format:`),bc.forEach(t),Mr=c(Un),co=s(Un,"UL",{});var Xa=a(co);wn=s(Xa,"LI",{});var oc=a(wn);wr=i(oc,"single sequence: "),ts=s(oc,"CODE",{});var Tc=a(ts);Lr=i(Tc,"<s> X </s>"),Tc.forEach(t),oc.forEach(t),$r=c(Xa),Ln=s(Xa,"LI",{});var nc=a(Ln);xr=i(nc,"pair of sequences: "),os=s(nc,"CODE",{});var Mc=a(os);Xr=i(Mc,"<s> A </s></s> B </s>"),Mc.forEach(t),nc.forEach(t),Xa.forEach(t),Un.forEach(t),zr=c(ue),bt=s(ue,"DIV",{class:!0});var za=a(bt);T(po.$$.fragment,za),Gr=c(za),ho=s(za,"P",{});var Ga=a(ho);Fr=i(Ga,`Retrieve sequence ids from a token list that has no special tokens added. This method is called when adding
special tokens using the tokenizer `),ns=s(Ga,"CODE",{});var wc=a(ns);Er=i(wc,"prepare_for_model"),wc.forEach(t),qr=i(Ga," method."),Ga.forEach(t),za.forEach(t),Cr=c(ue),Tt=s(ue,"DIV",{class:!0});var Fa=a(Tt);T(uo.$$.fragment,Fa),Pr=c(Fa),ss=s(Fa,"P",{});var Lc=a(ss);Ar=i(Lc,`Create a mask from the two sequences passed to be used in a sequence-pair classification task. XLM-RoBERTa does
not make use of token type ids, therefore a list of zeros is returned.`),Lc.forEach(t),Fa.forEach(t),jr=c(ue),$n=s(ue,"DIV",{class:!0});var $c=a($n);T(mo.$$.fragment,$c),$c.forEach(t),ue.forEach(t),ca=c(o),at=s(o,"H2",{class:!0});var Ea=a(at);Mt=s(Ea,"A",{id:!0,class:!0,href:!0});var xc=a(Mt);as=s(xc,"SPAN",{});var Xc=a(as);T(fo.$$.fragment,Xc),Xc.forEach(t),xc.forEach(t),Or=c(Ea),rs=s(Ea,"SPAN",{});var zc=a(rs);Dr=i(zc,"XGLMTokenizerFast"),zc.forEach(t),Ea.forEach(t),pa=c(o),ie=s(o,"DIV",{class:!0});var He=a(ie);T(go.$$.fragment,He),Nr=c(He),ke=s(He,"P",{});var Je=a(ke);Ir=i(Je,"Construct a \u201Cfast\u201D XGLM tokenizer (backed by HuggingFace\u2019s "),is=s(Je,"EM",{});var Gc=a(is);Sr=i(Gc,"tokenizers"),Gc.forEach(t),Wr=i(Je," library). Adapted from "),xn=s(Je,"A",{href:!0});var Fc=a(xn);Ur=i(Fc,"RobertaTokenizer"),Fc.forEach(t),Br=i(Je,`
and `),Xn=s(Je,"A",{href:!0});var Ec=a(Xn);Rr=i(Ec,"XLNetTokenizer"),Ec.forEach(t),Vr=i(Je,`. Based on
`),_o=s(Je,"A",{href:!0,rel:!0});var qc=a(_o);Hr=i(qc,"BPE"),qc.forEach(t),Jr=i(Je,"."),Je.forEach(t),Kr=c(He),ko=s(He,"P",{});var qa=a(ko);Zr=i(qa,"This tokenizer inherits from "),zn=s(qa,"A",{href:!0});var Cc=a(zn);Qr=i(Cc,"PreTrainedTokenizerFast"),Cc.forEach(t),Yr=i(qa,` which contains most of the main methods. Users should
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Oa.forEach(t),Ti=c(Ke),$t=s(Ke,"P",{});var ra=a($t);Mi=i(ra,"Transformer decoder consisting of "),ms=s(ra,"EM",{});var Uc=a(ms);wi=i(Uc,"config.num_layers"),Uc.forEach(t),Li=i(ra," layers. Each layer is a "),fs=s(ra,"CODE",{});var Bc=a(fs);$i=i(Bc,"XGLMDecoderLayer"),Bc.forEach(t),ra.forEach(t),xi=c(Ke),Te=s(Ke,"DIV",{class:!0});var Jt=a(Te);T(xo.$$.fragment,Jt),Xi=c(Jt),it=s(Jt,"P",{});var Rn=a(it);zi=i(Rn,"The "),qn=s(Rn,"A",{href:!0});var Rc=a(qn);Gi=i(Rc,"XGLMModel"),Rc.forEach(t),Fi=i(Rn," forward method, overrides the "),gs=s(Rn,"CODE",{});var Vc=a(gs);Ei=i(Vc,"__call__"),Vc.forEach(t),qi=i(Rn," special method."),Rn.forEach(t),Ci=c(Jt),T(xt.$$.fragment,Jt),Pi=c(Jt),T(Xt.$$.fragment,Jt),Jt.forEach(t),Ke.forEach(t),ma=c(o),lt=s(o,"H2",{class:!0});var Da=a(lt);zt=s(Da,"A",{id:!0,class:!0,href:!0});var Hc=a(zt);_s=s(Hc,"SPAN",{});var Jc=a(_s);T(Xo.$$.fragment,Jc),Jc.forEach(t),Hc.forEach(t),Ai=c(Da),ks=s(Da,"SPAN",{});var Kc=a(ks);ji=i(Kc,"XGLMForCausalLM"),Kc.forEach(t),Da.forEach(t),fa=c(o),de=s(o,"DIV",{class:!0});var Ze=a(de);T(zo.$$.fragment,Ze),Oi=c(Ze),vs=s(Ze,"P",{});var Zc=a(vs);Di=i(Zc,`The XGLM Model transformer with a language modeling head on top (linear layer with weights tied to the input
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Wa.forEach(t),dl=c(Xe),jo=s(Xe,"P",{});var Ua=a(jo);cl=i(Ua,"This model is also a "),Oo=s(Ua,"A",{href:!0,rel:!0});var rp=a(Oo);pl=i(rp,"tf.keras.Model"),rp.forEach(t),hl=i(Ua,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Ua.forEach(t),ul=c(Xe),T(qt.$$.fragment,Xe),ml=c(Xe),Ct=s(Xe,"P",{});var ia=a(Ct);fl=i(ia,"Transformer decoder consisting of "),Ms=s(ia,"EM",{});var ip=a(Ms);gl=i(ip,"config.num_layers"),ip.forEach(t),_l=i(ia," layers. Each layer is a "),ws=s(ia,"CODE",{});var lp=a(ws);kl=i(lp,"TFXGLMDecoderLayer"),lp.forEach(t),ia.forEach(t),vl=c(Xe),we=s(Xe,"DIV",{class:!0});var Zt=a(we);T(Do.$$.fragment,Zt),yl=c(Zt),pt=s(Zt,"P",{});var Hn=a(pt);bl=i(Hn,"The "),jn=s(Hn,"A",{href:!0});var dp=a(jn);Tl=i(dp,"TFXGLMModel"),dp.forEach(t),Ml=i(Hn," forward method, overrides the "),Ls=s(Hn,"CODE",{});var cp=a(Ls);wl=i(cp,"__call__"),cp.forEach(t),Ll=i(Hn," special method."),Hn.forEach(t),$l=c(Zt),T(Pt.$$.fragment,Zt),xl=c(Zt),T(At.$$.fragment,Zt),Zt.forEach(t),Xe.forEach(t),ka=c(o),ht=s(o,"H2",{class:!0});var Ba=a(ht);jt=s(Ba,"A",{id:!0,class:!0,href:!0});var pp=a(jt);$s=s(pp,"SPAN",{});var hp=a($s);T(No.$$.fragment,hp),hp.forEach(t),pp.forEach(t),Xl=c(Ba),xs=s(Ba,"SPAN",{});var up=a(xs);zl=i(up,"TFXGLMForCausalLM"),up.forEach(t),Ba.forEach(t),va=c(o),Q=s(o,"DIV",{class:!0});var ze=a(Q);T(Io.$$.fragment,ze),Gl=c(ze),Xs=s(ze,"P",{});var mp=a(Xs);Fl=i(mp,`The XGLM Model transformer with a language modeling head on top (linear layer with weights tied to the input
embeddings).`),mp.forEach(t),El=c(ze),So=s(ze,"P",{});var Ra=a(So);ql=i(Ra,"This model inherits from "),On=s(Ra,"A",{href:!0});var fp=a(On);Cl=i(fp,"TFPreTrainedModel"),fp.forEach(t),Pl=i(Ra,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Ra.forEach(t),Al=c(ze),Wo=s(ze,"P",{});var Va=a(Wo);jl=i(Va,"This model is also a "),Uo=s(Va,"A",{href:!0,rel:!0});var gp=a(Uo);Ol=i(gp,"tf.keras.Model"),gp.forEach(t),Dl=i(Va,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Va.forEach(t),Nl=c(ze),T(Ot.$$.fragment,ze),Il=c(ze),Le=s(ze,"DIV",{class:!0});var Qt=a(Le);T(Bo.$$.fragment,Qt),Sl=c(Qt),ut=s(Qt,"P",{});var Jn=a(ut);Wl=i(Jn,"The "),Dn=s(Jn,"A",{href:!0});var _p=a(Dn);Ul=i(_p,"TFXGLMForCausalLM"),_p.forEach(t),Bl=i(Jn," forward method, overrides the "),zs=s(Jn,"CODE",{});var kp=a(zs);Rl=i(kp,"__call__"),kp.forEach(t),Vl=i(Jn," special method."),Jn.forEach(t),Hl=c(Qt),T(Dt.$$.fragment,Qt),Jl=c(Qt),T(Nt.$$.fragment,Qt),Qt.forEach(t),ze.forEach(t),ya=c(o),mt=s(o,"H2",{class:!0});var Ha=a(mt);It=s(Ha,"A",{id:!0,class:!0,href:!0});var vp=a(It);Gs=s(vp,"SPAN",{});var yp=a(Gs);T(Ro.$$.fragment,yp),yp.forEach(t),vp.forEach(t),Kl=c(Ha),Fs=s(Ha,"SPAN",{});var bp=a(Fs);Zl=i(bp,"FlaxXGLMModel"),bp.forEach(t),Ha.forEach(t),ba=c(o),Y=s(o,"DIV",{class:!0});var Ge=a(Y);T(Vo.$$.fragment,Ge),Ql=c(Ge),Ho=s(Ge,"P",{});var Ja=a(Ho);Yl=i(Ja,`The bare XGLM Model transformer outputting raw hidden-states without any specific head on top.
...
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),Ka.forEach(t),rd=c(Ge),Es=s(Ge,"P",{});var wp=a(Es);id=i(wp,"Finally, this model supports inherent JAX features such as:"),wp.forEach(t),ld=c(Ge),Se=s(Ge,"UL",{});var Yt=a(Se);qs=s(Yt,"LI",{});var Lp=a(qs);Zo=s(Lp,"A",{href:!0,rel:!0});var $p=a(Zo);dd=i($p,"Just-In-Time (JIT) compilation"),$p.forEach(t),Lp.forEach(t),cd=c(Yt),Cs=s(Yt,"LI",{});var xp=a(Cs);Qo=s(xp,"A",{href:!0,rel:!0});var Xp=a(Qo);pd=i(Xp,"Automatic Differentiation"),Xp.forEach(t),xp.forEach(t),hd=c(Yt),Ps=s(Yt,"LI",{});var zp=a(Ps);Yo=s(zp,"A",{href:!0,rel:!0});var Gp=a(Yo);ud=i(Gp,"Vectorization"),Gp.forEach(t),zp.forEach(t),md=c(Yt),As=s(Yt,"LI",{});var Fp=a(As);en=s(Fp,"A",{href:!0,rel:!0});var Ep=a(en);fd=i(Ep,"Parallelization"),Ep.forEach(t),Fp.forEach(t),Yt.forEach(t),gd=c(Ge),$e=s(Ge,"DIV",{class:!0});var eo=a($e);T(tn.$$.fragment,eo),_d=c(eo),ft=s(eo,"P",{});var Kn=a(ft);kd=i(Kn,"The "),js=s(Kn,"CODE",{});var qp=a(js);vd=i(qp,"FlaxXGLMPreTrainedModel"),qp.forEach(t),yd=i(Kn," forward method, overrides the "),Os=s(Kn,"CODE",{});var Cp=a(Os);bd=i(Cp,"__call__"),Cp.forEach(t),Td=i(Kn," special method."),Kn.forEach(t),Md=c(eo),T(St.$$.fragment,eo),wd=c(eo),T(Wt.$$.fragment,eo),eo.forEach(t),Ge.forEach(t),Ta=c(o),gt=s(o,"H2",{class:!0});var Za=a(gt);Ut=s(Za,"A",{id:!0,class:!0,href:!0});var Pp=a(Ut);Ds=s(Pp,"SPAN",{});var Ap=a(Ds);T(on.$$.fragment,Ap),Ap.forEach(t),Pp.forEach(t),Ld=c(Za),Ns=s(Za,"SPAN",{});var jp=a(Ns);$d=i(jp,"FlaxXGLMForCausalLM"),jp.forEach(t),Za.forEach(t),Ma=c(o),I=s(o,"DIV",{class:!0});var me=a(I);T(nn.$$.fragment,me),xd=c(me),Is=s(me,"P",{});var Op=a(Is);Xd=i(Op,`The XGLM Model transformer with a language modeling head on top (linear layer with weights tied to the input
embeddings).`),Op.forEach(t),zd=c(me),sn=s(me,"P",{});var Qa=a(sn);Gd=i(Qa,"This model inherits from "),In=s(Qa,"A",{href:!0});var Dp=a(In);Fd=i(Dp,"FlaxPreTrainedModel"),Dp.forEach(t),Ed=i(Qa,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
