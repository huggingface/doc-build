...
<span class="hljs-meta">&gt;&gt;&gt; </span>configuration = model.config`}}),{c(){p=n("p"),y=r("Example:"),f=d(),b(m.$$.fragment)},l(l){p=s(l,"P",{});var u=a(p);y=i(u,"Example:"),u.forEach(t),f=c(l),T(m.$$.fragment,l)},m(l,u){g(l,p,u),e(p,y),g(l,f,u),M(m,l,u),k=!0},p:Gn,i(l){k||(w(m.$$.fragment,l),k=!0)},o(l){L(m.$$.fragment,l),k=!1},d(l){l&&t(p),l&&t(f),$(m,l)}}}function sh(F){let p,y,f,m,k;return{c(){p=n("p"),y=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=n("code"),m=r("Module"),k=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(l){p=s(l,"P",{});var u=a(p);y=i(u,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=s(u,"CODE",{});var X=a(f);m=i(X,"Module"),X.forEach(t),k=i(u,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),u.forEach(t)},m(l,u){g(l,p,u),e(p,y),e(p,f),e(f,m),e(p,k)},d(l){l&&t(p)}}}function ah(F){let p,y,f,m,k;return m=new En({props:{code:`from transformers import XGLMTokenizer, XGLMModel
import torch
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),{c(){p=n("p"),y=r("Example:"),f=d(),b(m.$$.fragment)},l(l){p=s(l,"P",{});var u=a(p);y=i(u,"Example:"),u.forEach(t),f=c(l),T(m.$$.fragment,l)},m(l,u){g(l,p,u),e(p,y),g(l,f,u),M(m,l,u),k=!0},p:Gn,i(l){k||(w(m.$$.fragment,l),k=!0)},o(l){L(m.$$.fragment,l),k=!1},d(l){l&&t(p),l&&t(f),$(m,l)}}}function rh(F){let p,y,f,m,k;return{c(){p=n("p"),y=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=n("code"),m=r("Module"),k=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(l){p=s(l,"P",{});var u=a(p);y=i(u,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=s(u,"CODE",{});var X=a(f);m=i(X,"Module"),X.forEach(t),k=i(u,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),u.forEach(t)},m(l,u){g(l,p,u),e(p,y),e(p,f),e(f,m),e(p,k)},d(l){l&&t(p)}}}function ih(F){let p,y,f,m,k;return m=new En({props:{code:`import torch
...
positional argument:`),ke=d(),G=n("ul"),O=n("li"),re=r("a single Tensor with "),ie=n("code"),Qe=r("input_ids"),le=r(" only and nothing else: "),de=n("code"),Ye=r("model(input_ids)"),Ee=d(),q=n("li"),oe=r(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
...
pass your inputs and labels in any format that `),I=s(E,"CODE",{});var yt=a(I);He=i(yt,"model.fit()"),yt.forEach(t),se=i(E,` supports! If, however, you want to use the second
format outside of Keras methods like `),ae=s(E,"CODE",{});var vt=a(ae);Ke=i(vt,"fit()"),vt.forEach(t),Fe=i(E," and "),B=s(E,"CODE",{});var bt=a(B);Je=i(bt,"predict()"),bt.forEach(t),Ge=i(E,`, such as when creating your own layers or models with
...
`),he=s(rt,"CODE",{});var pt=a(he);Z=i(pt,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),pt.forEach(t),rt.forEach(t),V.forEach(t),we=c(v),A=s(v,"P",{});var C=a(A);ot=i(C,`Note that when creating models and layers with
`),S=s(C,"A",{href:!0,rel:!0});var $e=a(S);ue=i($e,"subclassing"),$e.forEach(t),nt=i(C,` then you don\u2019t need to worry
about any of this, as you can just pass inputs like you would to any other Python function!`),C.forEach(t),this.h()},h(){h(S,"href","https://keras.io/guides/making_new_layers_and_models_via_subclassing/"),h(S,"rel","nofollow")},m(v,z){g(v,p,z),e(p,y),e(p,f),e(f,m),e(p,k),g(v,l,z),g(v,u,z),e(u,X),e(X,Be),e(u,Xe),e(u,j),e(j,te),g(v,ne,z),g(v,x,z),e(x,Re),e(x,H),e(H,Ve),e(x,ze),e(x,I),e(I,He),e(x,se),e(x,ae),e(ae,Ke),e(x,Fe),e(x,B),e(B,Je),e(x,Ge),e(x,R),e(R,Me),e(x,Ze),g(v,ke,z),g(v,G,z),e(G,O),e(O,re),e(O,ie),e(ie,Qe),e(O,le),e(O,de),e(de,Ye),e(G,Ee),e(G,q),e(q,oe),e(q,K),e(K,ce),e(q,et),e(q,J),e(J,tt),e(G,Ce),e(G,P),e(P,pe),e(P,he),e(he,Z),g(v,we,z),g(v,A,z),e(A,ot),e(A,S),e(S,ue),e(A,nt)},d(v){v&&t(p),v&&t(l),v&&t(u),v&&t(ne),v&&t(x),v&&t(ke),v&&t(G),v&&t(we),v&&t(A)}}}function dh(F){let p,y,f,m,k;return{c(){p=n("p"),y=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=n("code"),m=r("Module"),k=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(l){p=s(l,"P",{});var u=a(p);y=i(u,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=s(u,"CODE",{});var X=a(f);m=i(X,"Module"),X.forEach(t),k=i(u,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),u.forEach(t)},m(l,u){g(l,p,u),e(p,y),e(p,f),e(f,m),e(p,k)},d(l){l&&t(p)}}}function ch(F){let p,y,f,m,k;return m=new En({props:{code:`from transformers import XGLMTokenizer, TFXGLMModel
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),{c(){p=n("p"),y=r("Example:"),f=d(),b(m.$$.fragment)},l(l){p=s(l,"P",{});var u=a(p);y=i(u,"Example:"),u.forEach(t),f=c(l),T(m.$$.fragment,l)},m(l,u){g(l,p,u),e(p,y),g(l,f,u),M(m,l,u),k=!0},p:Gn,i(l){k||(w(m.$$.fragment,l),k=!0)},o(l){L(m.$$.fragment,l),k=!1},d(l){l&&t(p),l&&t(f),$(m,l)}}}function ph(F){let p,y,f,m,k,l,u,X,Be,Xe,j,te,ne,x,Re,H,Ve,ze,I,He,se,ae,Ke,Fe,B,Je,Ge,R,Me,Ze,ke,G,O,re,ie,Qe,le,de,Ye,Ee,q,oe,K,ce,et,J,tt,Ce,P,pe,he,Z,we,A,ot,S,ue,nt;return{c(){p=n("p"),y=r("TensorFlow models and layers in "),f=n("code"),m=r("transformers"),k=r(" accept two formats as input:"),l=d(),u=n("ul"),X=n("li"),Be=r("having all inputs as keyword arguments (like PyTorch models), or"),Xe=d(),j=n("li"),te=r("having all inputs as a list, tuple or dict in the first positional argument."),ne=d(),x=n("p"),Re=r(`The reason the second format is supported is that Keras methods prefer this format when passing inputs to models
and layers. Because of this support, when using methods like `),H=n("code"),Ve=r("model.fit()"),ze=r(` things should \u201Cjust work\u201D for you - just
pass your inputs and labels in any format that `),I=n("code"),He=r("model.fit()"),se=r(` supports! If, however, you want to use the second
format outside of Keras methods like `),ae=n("code"),Ke=r("fit()"),Fe=r(" and "),B=n("code"),Je=r("predict()"),Ge=r(`, such as when creating your own layers or models with
the Keras `),R=n("code"),Me=r("Functional"),Ze=r(` API, there are three possibilities you can use to gather all the input Tensors in the first
...
`),he=s(rt,"CODE",{});var pt=a(he);Z=i(pt,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),pt.forEach(t),rt.forEach(t),V.forEach(t),we=c(v),A=s(v,"P",{});var C=a(A);ot=i(C,`Note that when creating models and layers with
`),S=s(C,"A",{href:!0,rel:!0});var $e=a(S);ue=i($e,"subclassing"),$e.forEach(t),nt=i(C,` then you don\u2019t need to worry
about any of this, as you can just pass inputs like you would to any other Python function!`),C.forEach(t),this.h()},h(){h(S,"href","https://keras.io/guides/making_new_layers_and_models_via_subclassing/"),h(S,"rel","nofollow")},m(v,z){g(v,p,z),e(p,y),e(p,f),e(f,m),e(p,k),g(v,l,z),g(v,u,z),e(u,X),e(X,Be),e(u,Xe),e(u,j),e(j,te),g(v,ne,z),g(v,x,z),e(x,Re),e(x,H),e(H,Ve),e(x,ze),e(x,I),e(I,He),e(x,se),e(x,ae),e(ae,Ke),e(x,Fe),e(x,B),e(B,Je),e(x,Ge),e(x,R),e(R,Me),e(x,Ze),g(v,ke,z),g(v,G,z),e(G,O),e(O,re),e(O,ie),e(ie,Qe),e(O,le),e(O,de),e(de,Ye),e(G,Ee),e(G,q),e(q,oe),e(q,K),e(K,ce),e(q,et),e(q,J),e(J,tt),e(G,Ce),e(G,P),e(P,pe),e(P,he),e(he,Z),g(v,we,z),g(v,A,z),e(A,ot),e(A,S),e(S,ue),e(A,nt)},d(v){v&&t(p),v&&t(l),v&&t(u),v&&t(ne),v&&t(x),v&&t(ke),v&&t(G),v&&t(we),v&&t(A)}}}function hh(F){let p,y,f,m,k;return{c(){p=n("p"),y=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=n("code"),m=r("Module"),k=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(l){p=s(l,"P",{});var u=a(p);y=i(u,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=s(u,"CODE",{});var X=a(f);m=i(X,"Module"),X.forEach(t),k=i(u,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),u.forEach(t)},m(l,u){g(l,p,u),e(p,y),e(p,f),e(f,m),e(p,k)},d(l){l&&t(p)}}}function uh(F){let p,y,f,m,k;return m=new En({props:{code:`from transformers import XGLMTokenizer, TFXGLMForCausalLM
import tensorflow as tf
...
<span class="hljs-meta">&gt;&gt;&gt; </span>inputs = tokenizer(<span class="hljs-string">&quot;Hello, my dog is cute&quot;</span>, return_tensors=<span class="hljs-string">&quot;tf&quot;</span>)
<span class="hljs-meta">&gt;&gt;&gt; </span>outputs = model(inputs)
<span class="hljs-meta">&gt;&gt;&gt; </span>logits = outputs.logits`}}),{c(){p=n("p"),y=r("Example:"),f=d(),b(m.$$.fragment)},l(l){p=s(l,"P",{});var u=a(p);y=i(u,"Example:"),u.forEach(t),f=c(l),T(m.$$.fragment,l)},m(l,u){g(l,p,u),e(p,y),g(l,f,u),M(m,l,u),k=!0},p:Gn,i(l){k||(w(m.$$.fragment,l),k=!0)},o(l){L(m.$$.fragment,l),k=!1},d(l){l&&t(p),l&&t(f),$(m,l)}}}function mh(F){let p,y,f,m,k;return{c(){p=n("p"),y=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=n("code"),m=r("Module"),k=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(l){p=s(l,"P",{});var u=a(p);y=i(u,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=s(u,"CODE",{});var X=a(f);m=i(X,"Module"),X.forEach(t),k=i(u,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),u.forEach(t)},m(l,u){g(l,p,u),e(p,y),e(p,f),e(f,m),e(p,k)},d(l){l&&t(p)}}}function fh(F){let p,y,f,m,k;return m=new En({props:{code:`from transformers import XGLMTokenizer, FlaxXGLMModel
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),{c(){p=n("p"),y=r("Example:"),f=d(),b(m.$$.fragment)},l(l){p=s(l,"P",{});var u=a(p);y=i(u,"Example:"),u.forEach(t),f=c(l),T(m.$$.fragment,l)},m(l,u){g(l,p,u),e(p,y),g(l,f,u),M(m,l,u),k=!0},p:Gn,i(l){k||(w(m.$$.fragment,l),k=!0)},o(l){L(m.$$.fragment,l),k=!1},d(l){l&&t(p),l&&t(f),$(m,l)}}}function gh(F){let p,y,f,m,k;return{c(){p=n("p"),y=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=n("code"),m=r("Module"),k=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(l){p=s(l,"P",{});var u=a(p);y=i(u,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=s(u,"CODE",{});var X=a(f);m=i(X,"Module"),X.forEach(t),k=i(u,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),u.forEach(t)},m(l,u){g(l,p,u),e(p,y),e(p,f),e(f,m),e(p,k)},d(l){l&&t(p)}}}function _h(F){let p,y,f,m,k;return m=new En({props:{code:`from transformers import XGLMTokenizer, FlaxXGLMForCausalLM
...
Whether or not the model should return the last key/values attentions (not used by all models).`,name:"use_cache"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/xglm/configuration_xglm.py#L29"}}),ye=new Fn({props:{anchor:"transformers.XGLMConfig.example",$$slots:{default:[nh]},$$scope:{ctx:F}}}),W=new ct({}),$e=new N({props:{name:"class transformers.XGLMTokenizer",anchor:"transformers.XGLMTokenizer",parameters:[{name:"vocab_file",val:""},{name:"bos_token",val:" = '<s>'"},{name:"eos_token",val:" = '</s>'"},{name:"sep_token",val:" = '</s>'"},{name:"cls_token",val:" = '<s>'"},{name:"unk_token",val:" = '<unk>'"},{name:"pad_token",val:" = '<pad>'"},{name:"sp_model_kwargs",val:": typing.Union[typing.Dict[str, typing.Any], NoneType] = None"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.XGLMTokenizer.vocab_file",description:`<strong>vocab_file</strong> (<code>str</code>) &#x2014;
...
`}}),so=new vo({props:{$$slots:{default:[mh]},$$scope:{ctx:F}}}),ao=new Fn({props:{anchor:"transformers.FlaxXGLMModel.__call__.example",$$slots:{default:[fh]},$$scope:{ctx:F}}}),_n=new ct({}),kn=new N({props:{name:"class transformers.FlaxXGLMForCausalLM",anchor:"transformers.FlaxXGLMForCausalLM",parameters:[{name:"config",val:": XGLMConfig"},{name:"input_shape",val:": typing.Tuple[int] = (1, 1)"},{name:"seed",val:": int = 0"},{name:"dtype",val:": dtype = <class 'jax.numpy.float32'>"},{name:"_do_init",val:": bool = True"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.FlaxXGLMForCausalLM.config",description:`<strong>config</strong> (<a href="/docs/transformers/main/en/model_doc/xglm#transformers.XGLMConfig">XGLMConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
...
`}}),io=new vo({props:{$$slots:{default:[gh]},$$scope:{ctx:F}}}),lo=new Fn({props:{anchor:"transformers.FlaxXGLMForCausalLM.__call__.example",$$slots:{default:[_h]},$$scope:{ctx:F}}}),{c(){p=n("meta"),y=d(),f=n("h1"),m=n("a"),k=n("span"),b(l.$$.fragment),u=d(),X=n("span"),Be=r("XGLM"),Xe=d(),j=n("h2"),te=n("a"),ne=n("span"),b(x.$$.fragment),Re=d(),H=n("span"),Ve=r("Overview"),ze=d(),I=n("p"),He=r("The XGLM model was proposed in "),se=n("a"),ae=r("Few-shot Learning with Multilingual Language Models"),Ke=r(`
...
in social value tasks such as hate speech detection in five languages and find it has limitations similar to comparable sized GPT-3 models.`),ke=d(),G=n("p"),O=r("This model was contributed by "),re=n("a"),ie=r("Suraj"),Qe=r(". The original code can be found "),le=n("a"),de=r("here"),Ye=r("."),Ee=d(),q=n("h2"),oe=n("a"),K=n("span"),b(ce.$$.fragment),et=d(),J=n("span"),tt=r("XGLMConfig"),Ce=d(),P=n("div"),b(pe.$$.fragment),he=d(),Z=n("p"),we=r("This is the configuration class to store the configuration of a "),A=n("a"),ot=r("XGLMModel"),S=r(`. It is used to instantiate an XGLM
model according to the specified arguments, defining the model architecture. Instantiating a configuration with the
defaults will yield a similar configuration to that of the XGLM
`),ue=n("a"),nt=r("facebook/xglm-564M"),v=r(" architecture."),z=d(),me=n("p"),Le=r("Configuration objects inherit from "),qe=n("a"),kt=r("PretrainedConfig"),E=r(` and can be used to control the model outputs. Read the
documentation from `),Pe=n("a"),yt=r("PretrainedConfig"),vt=r(" for more information."),bt=d(),b(ye.$$.fragment),V=d(),D=n("h2"),ve=n("a"),st=n("span"),b(W.$$.fragment),Tt=d(),at=n("span"),rt=r("XGLMTokenizer"),pt=d(),C=n("div"),b($e.$$.fragment),lr=d(),it=n("p"),dr=r("Adapted from "),Cn=n("a"),cr=r("RobertaTokenizer"),pr=r(" and "),qn=n("a"),hr=r("XLNetTokenizer"),ur=r(`. Based on
...
not make use of token type ids, therefore a list of zeros is returned.`),jr=d(),On=n("div"),b(Xo.$$.fragment),ka=d(),Mt=n("h2"),Dt=n("a"),fs=n("span"),b(zo.$$.fragment),Or=d(),gs=n("span"),Dr=r("XGLMTokenizerFast"),ya=d(),fe=n("div"),b(Fo.$$.fragment),Nr=d(),xe=n("p"),Ir=r("Construct a \u201Cfast\u201D XGLM tokenizer (backed by HuggingFace\u2019s "),_s=n("em"),Sr=r("tokenizers"),Wr=r(" library). Adapted from "),Dn=n("a"),Ur=r("RobertaTokenizer"),Br=r(`
...
refer to this superclass for more information regarding those methods.`),ei=d(),ut=n("div"),b(Co.$$.fragment),ti=d(),ks=n("p"),oi=r(`Build model inputs from a sequence or a pair of sequence for sequence classification tasks by concatenating and
adding special tokens. An XLM-RoBERTa sequence has the following format:`),ni=d(),qo=n("ul"),Sn=n("li"),si=r("single sequence: "),ys=n("code"),ai=r("<s> X </s>"),ri=d(),Wn=n("li"),ii=r("pair of sequences: "),vs=n("code"),li=r("<s> A </s></s> B </s>"),di=d(),Nt=n("div"),b(Po.$$.fragment),ci=d(),bs=n("p"),pi=r(`Create a mask from the two sequences passed to be used in a sequence-pair classification task. XLM-RoBERTa does
...
model according to the specified arguments, defining the model architecture. Instantiating a configuration with the
defaults will yield a similar configuration to that of the XGLM
`),ue=s(es,"A",{href:!0,rel:!0});var pc=a(ue);nt=i(pc,"facebook/xglm-564M"),pc.forEach(t),v=i(es," architecture."),es.forEach(t),z=c(co),me=s(co,"P",{});var ts=a(me);Le=i(ts,"Configuration objects inherit from "),qe=s(ts,"A",{href:!0});var hc=a(qe);kt=i(hc,"PretrainedConfig"),hc.forEach(t),E=i(ts,` and can be used to control the model outputs. Read the
documentation from `),Pe=s(ts,"A",{href:!0});var uc=a(Pe);yt=i(uc,"PretrainedConfig"),uc.forEach(t),vt=i(ts," for more information."),ts.forEach(t),bt=c(co),T(ye.$$.fragment,co),co.forEach(t),V=c(o),D=s(o,"H2",{class:!0});var qa=a(D);ve=s(qa,"A",{id:!0,class:!0,href:!0});var mc=a(ve);st=s(mc,"SPAN",{});var fc=a(st);T(W.$$.fragment,fc),fc.forEach(t),mc.forEach(t),Tt=c(qa),at=s(qa,"SPAN",{});var gc=a(at);rt=i(gc,"XGLMTokenizer"),gc.forEach(t),qa.forEach(t),pt=c(o),C=s(o,"DIV",{class:!0});var be=a(C);T($e.$$.fragment,be),lr=c(be),it=s(be,"P",{});var po=a(it);dr=i(po,"Adapted from "),Cn=s(po,"A",{href:!0});var _c=a(Cn);cr=i(_c,"RobertaTokenizer"),_c.forEach(t),pr=i(po," and "),qn=s(po,"A",{href:!0});var kc=a(qn);hr=i(kc,"XLNetTokenizer"),kc.forEach(t),ur=i(po,`. Based on
...
not make use of token type ids, therefore a list of zeros is returned.`),Lc.forEach(t),Da.forEach(t),jr=c(be),On=s(be,"DIV",{class:!0});var $c=a(On);T(Xo.$$.fragment,$c),$c.forEach(t),be.forEach(t),ka=c(o),Mt=s(o,"H2",{class:!0});var Na=a(Mt);Dt=s(Na,"A",{id:!0,class:!0,href:!0});var xc=a(Dt);fs=s(xc,"SPAN",{});var Xc=a(fs);T(zo.$$.fragment,Xc),Xc.forEach(t),xc.forEach(t),Or=c(Na),gs=s(Na,"SPAN",{});var zc=a(gs);Dr=i(zc,"XGLMTokenizerFast"),zc.forEach(t),Na.forEach(t),ya=c(o),fe=s(o,"DIV",{class:!0});var mt=a(fe);T(Fo.$$.fragment,mt),Nr=c(mt),xe=s(mt,"P",{});var ft=a(xe);Ir=i(ft,"Construct a \u201Cfast\u201D XGLM tokenizer (backed by HuggingFace\u2019s "),_s=s(ft,"EM",{});var Fc=a(_s);Sr=i(Fc,"tokenizers"),Fc.forEach(t),Wr=i(ft," library). Adapted from "),Dn=s(ft,"A",{href:!0});var Gc=a(Dn);Ur=i(Gc,"RobertaTokenizer"),Gc.forEach(t),Br=i(ft,`
...
refer to this superclass for more information regarding those methods.`),Ia.forEach(t),ei=c(mt),ut=s(mt,"DIV",{class:!0});var ns=a(ut);T(Co.$$.fragment,ns),ti=c(ns),ks=s(ns,"P",{});var Pc=a(ks);oi=i(Pc,`Build model inputs from a sequence or a pair of sequence for sequence classification tasks by concatenating and
adding special tokens. An XLM-RoBERTa sequence has the following format:`),Pc.forEach(t),ni=c(ns),qo=s(ns,"UL",{});var Sa=a(qo);Sn=s(Sa,"LI",{});var sc=a(Sn);si=i(sc,"single sequence: "),ys=s(sc,"CODE",{});var Ac=a(ys);ai=i(Ac,"<s> X </s>"),Ac.forEach(t),sc.forEach(t),ri=c(Sa),Wn=s(Sa,"LI",{});var ac=a(Wn);ii=i(ac,"pair of sequences: "),vs=s(ac,"CODE",{});var jc=a(vs);li=i(jc,"<s> A </s></s> B </s>"),jc.forEach(t),ac.forEach(t),Sa.forEach(t),ns.forEach(t),di=c(mt),Nt=s(mt,"DIV",{class:!0});var Wa=a(Nt);T(Po.$$.fragment,Wa),ci=c(Wa),bs=s(Wa,"P",{});var Oc=a(bs);pi=i(Oc,`Create a mask from the two sequences passed to be used in a sequence-pair classification task. XLM-RoBERTa does
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),tr.forEach(t),Nl=c(We),T(eo.$$.fragment,We),Il=c(We),De=s(We,"DIV",{class:!0});var fo=a(De);T(an.$$.fragment,fo),Sl=c(fo),Gt=s(fo,"P",{});var is=a(Gt);Wl=i(is,"The "),Zn=s(is,"A",{href:!0});var _p=a(Zn);Ul=i(_p,"TFXGLMForCausalLM"),_p.forEach(t),Bl=i(is," forward method, overrides the "),Ds=s(is,"CODE",{});var kp=a(Ds);Rl=i(kp,"__call__"),kp.forEach(t),Vl=i(is," special method."),is.forEach(t),Hl=c(fo),T(to.$$.fragment,fo),Kl=c(fo),T(oo.$$.fragment,fo),fo.forEach(t),We.forEach(t),Xa=c(o),Et=s(o,"H2",{class:!0});var or=a(Et);no=s(or,"A",{id:!0,class:!0,href:!0});var yp=a(no);Ns=s(yp,"SPAN",{});var vp=a(Ns);T(rn.$$.fragment,vp),vp.forEach(t),yp.forEach(t),Jl=c(or),Is=s(or,"SPAN",{});var bp=a(Is);Zl=i(bp,"FlaxXGLMModel"),bp.forEach(t),or.forEach(t),za=c(o),ee=s(o,"DIV",{class:!0});var Ue=a(ee);T(ln.$$.fragment,Ue),Ql=c(Ue),dn=s(Ue,"P",{});var nr=a(dn);Yl=i(nr,`The bare XGLM Model transformer outputting raw hidden-states without any specific head on top.
