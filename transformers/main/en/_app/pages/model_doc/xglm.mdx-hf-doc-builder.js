import{S as Qp,i as Yp,s as eh,e as n,k as d,w as b,t as r,M as th,c as s,d as t,m as c,a,x as T,h as i,b as h,G as e,g,y as M,q as w,o as L,B as $,v as oh,L as Gn}from"../../chunks/vendor-hf-doc-builder.js";import{T as vo}from"../../chunks/Tip-hf-doc-builder.js";import{D as N}from"../../chunks/Docstring-hf-doc-builder.js";import{C as En}from"../../chunks/CodeBlock-hf-doc-builder.js";import{I as ct}from"../../chunks/IconCopyLink-hf-doc-builder.js";import{E as Xn}from"../../chunks/ExampleCodeBlock-hf-doc-builder.js";function nh(X){let p,y,f,m,k;return m=new En({props:{code:`from transformers import XGLMModel, XGLMConfig
...
<span class="hljs-meta">&gt;&gt;&gt; </span>configuration = model.config`}}),{c(){p=n("p"),y=r("Example:"),f=d(),b(m.$$.fragment)},l(l){p=s(l,"P",{});var u=a(p);y=i(u,"Example:"),u.forEach(t),f=c(l),T(m.$$.fragment,l)},m(l,u){g(l,p,u),e(p,y),g(l,f,u),M(m,l,u),k=!0},p:Gn,i(l){k||(w(m.$$.fragment,l),k=!0)},o(l){L(m.$$.fragment,l),k=!1},d(l){l&&t(p),l&&t(f),$(m,l)}}}function sh(X){let p,y,f,m,k;return{c(){p=n("p"),y=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=n("code"),m=r("Module"),k=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(l){p=s(l,"P",{});var u=a(p);y=i(u,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=s(u,"CODE",{});var z=a(f);m=i(z,"Module"),z.forEach(t),k=i(u,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),u.forEach(t)},m(l,u){g(l,p,u),e(p,y),e(p,f),e(f,m),e(p,k)},d(l){l&&t(p)}}}function ah(X){let p,y,f,m,k;return m=new En({props:{code:`from transformers import XGLMTokenizer, XGLMModel
import torch
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),{c(){p=n("p"),y=r("Example:"),f=d(),b(m.$$.fragment)},l(l){p=s(l,"P",{});var u=a(p);y=i(u,"Example:"),u.forEach(t),f=c(l),T(m.$$.fragment,l)},m(l,u){g(l,p,u),e(p,y),g(l,f,u),M(m,l,u),k=!0},p:Gn,i(l){k||(w(m.$$.fragment,l),k=!0)},o(l){L(m.$$.fragment,l),k=!1},d(l){l&&t(p),l&&t(f),$(m,l)}}}function rh(X){let p,y,f,m,k;return{c(){p=n("p"),y=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=n("code"),m=r("Module"),k=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(l){p=s(l,"P",{});var u=a(p);y=i(u,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=s(u,"CODE",{});var z=a(f);m=i(z,"Module"),z.forEach(t),k=i(u,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),u.forEach(t)},m(l,u){g(l,p,u),e(p,y),e(p,f),e(f,m),e(p,k)},d(l){l&&t(p)}}}function ih(X){let p,y,f,m,k;return m=new En({props:{code:`import torch
...
<span class="hljs-meta">&gt;&gt;&gt; </span>logits = outputs.logits`}}),{c(){p=n("p"),y=r("Example:"),f=d(),b(m.$$.fragment)},l(l){p=s(l,"P",{});var u=a(p);y=i(u,"Example:"),u.forEach(t),f=c(l),T(m.$$.fragment,l)},m(l,u){g(l,p,u),e(p,y),g(l,f,u),M(m,l,u),k=!0},p:Gn,i(l){k||(w(m.$$.fragment,l),k=!0)},o(l){L(m.$$.fragment,l),k=!1},d(l){l&&t(p),l&&t(f),$(m,l)}}}function lh(X){let p,y,f,m,k,l,u,z,Be,ze,j,te,ne,x,Re,V,He,Fe,I,Ve,se,ae,Ke,Xe,B,Je,Ge,R,Me,Ze,ke,G,O,re,ie,Qe,le,de,Ye,Ee,C,oe,K,ce,et,J,tt,qe,P,pe,he,Z,we,A,ot,S,ue,nt;return{c(){p=n("p"),y=r("TensorFlow models and layers in "),f=n("code"),m=r("transformers"),k=r(" accept two formats as input:"),l=d(),u=n("ul"),z=n("li"),Be=r("having all inputs as keyword arguments (like PyTorch models), or"),ze=d(),j=n("li"),te=r("having all inputs as a list, tuple or dict in the first positional argument."),ne=d(),x=n("p"),Re=r(`The reason the second format is supported is that Keras methods prefer this format when passing inputs to models
and layers. Because of this support, when using methods like `),V=n("code"),He=r("model.fit()"),Fe=r(` things should \u201Cjust work\u201D for you - just
...
format outside of Keras methods like `),ae=n("code"),Ke=r("fit()"),Xe=r(" and "),B=n("code"),Je=r("predict()"),Ge=r(`, such as when creating your own layers or models with
...
positional argument:`),ke=d(),G=n("ul"),O=n("li"),re=r("a single Tensor with "),ie=n("code"),Qe=r("input_ids"),le=r(" only and nothing else: "),de=n("code"),Ye=r("model(input_ids)"),Ee=d(),C=n("li"),oe=r(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
...
about any of this, as you can just pass inputs like you would to any other Python function!`),this.h()},l(v){p=s(v,"P",{});var F=a(p);y=i(F,"TensorFlow models and layers in "),f=s(F,"CODE",{});var me=a(f);m=i(me,"transformers"),me.forEach(t),k=i(F," accept two formats as input:"),F.forEach(t),l=c(v),u=s(v,"UL",{});var Le=a(u);z=s(Le,"LI",{});var Ce=a(z);Be=i(Ce,"having all inputs as keyword arguments (like PyTorch models), or"),Ce.forEach(t),ze=c(Le),j=s(Le,"LI",{});var kt=a(j);te=i(kt,"having all inputs as a list, tuple or dict in the first positional argument."),kt.forEach(t),Le.forEach(t),ne=c(v),x=s(v,"P",{});var E=a(x);Re=i(E,`The reason the second format is supported is that Keras methods prefer this format when passing inputs to models
and layers. Because of this support, when using methods like `),V=s(E,"CODE",{});var Pe=a(V);He=i(Pe,"model.fit()"),Pe.forEach(t),Fe=i(E,` things should \u201Cjust work\u201D for you - just
pass your inputs and labels in any format that `),I=s(E,"CODE",{});var yt=a(I);Ve=i(yt,"model.fit()"),yt.forEach(t),se=i(E,` supports! If, however, you want to use the second
format outside of Keras methods like `),ae=s(E,"CODE",{});var vt=a(ae);Ke=i(vt,"fit()"),vt.forEach(t),Xe=i(E," and "),B=s(E,"CODE",{});var bt=a(B);Je=i(bt,"predict()"),bt.forEach(t),Ge=i(E,`, such as when creating your own layers or models with
the Keras `),R=s(E,"CODE",{});var ye=a(R);Me=i(ye,"Functional"),ye.forEach(t),Ze=i(E,` API, there are three possibilities you can use to gather all the input Tensors in the first
positional argument:`),E.forEach(t),ke=c(v),G=s(v,"UL",{});var H=a(G);O=s(H,"LI",{});var D=a(O);re=i(D,"a single Tensor with "),ie=s(D,"CODE",{});var ve=a(ie);Qe=i(ve,"input_ids"),ve.forEach(t),le=i(D," only and nothing else: "),de=s(D,"CODE",{});var st=a(de);Ye=i(st,"model(input_ids)"),st.forEach(t),D.forEach(t),Ee=c(H),C=s(H,"LI",{});var W=a(C);oe=i(W,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
...
`),he=s(rt,"CODE",{});var pt=a(he);Z=i(pt,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),pt.forEach(t),rt.forEach(t),H.forEach(t),we=c(v),A=s(v,"P",{});var q=a(A);ot=i(q,`Note that when creating models and layers with
`),S=s(q,"A",{href:!0,rel:!0});var $e=a(S);ue=i($e,"subclassing"),$e.forEach(t),nt=i(q,` then you don\u2019t need to worry
about any of this, as you can just pass inputs like you would to any other Python function!`),q.forEach(t),this.h()},h(){h(S,"href","https://keras.io/guides/making_new_layers_and_models_via_subclassing/"),h(S,"rel","nofollow")},m(v,F){g(v,p,F),e(p,y),e(p,f),e(f,m),e(p,k),g(v,l,F),g(v,u,F),e(u,z),e(z,Be),e(u,ze),e(u,j),e(j,te),g(v,ne,F),g(v,x,F),e(x,Re),e(x,V),e(V,He),e(x,Fe),e(x,I),e(I,Ve),e(x,se),e(x,ae),e(ae,Ke),e(x,Xe),e(x,B),e(B,Je),e(x,Ge),e(x,R),e(R,Me),e(x,Ze),g(v,ke,F),g(v,G,F),e(G,O),e(O,re),e(O,ie),e(ie,Qe),e(O,le),e(O,de),e(de,Ye),e(G,Ee),e(G,C),e(C,oe),e(C,K),e(K,ce),e(C,et),e(C,J),e(J,tt),e(G,qe),e(G,P),e(P,pe),e(P,he),e(he,Z),g(v,we,F),g(v,A,F),e(A,ot),e(A,S),e(S,ue),e(A,nt)},d(v){v&&t(p),v&&t(l),v&&t(u),v&&t(ne),v&&t(x),v&&t(ke),v&&t(G),v&&t(we),v&&t(A)}}}function dh(X){let p,y,f,m,k;return{c(){p=n("p"),y=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=n("code"),m=r("Module"),k=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(l){p=s(l,"P",{});var u=a(p);y=i(u,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=s(u,"CODE",{});var z=a(f);m=i(z,"Module"),z.forEach(t),k=i(u,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),u.forEach(t)},m(l,u){g(l,p,u),e(p,y),e(p,f),e(f,m),e(p,k)},d(l){l&&t(p)}}}function ch(X){let p,y,f,m,k;return m=new En({props:{code:`from transformers import XGLMTokenizer, TFXGLMModel
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),{c(){p=n("p"),y=r("Example:"),f=d(),b(m.$$.fragment)},l(l){p=s(l,"P",{});var u=a(p);y=i(u,"Example:"),u.forEach(t),f=c(l),T(m.$$.fragment,l)},m(l,u){g(l,p,u),e(p,y),g(l,f,u),M(m,l,u),k=!0},p:Gn,i(l){k||(w(m.$$.fragment,l),k=!0)},o(l){L(m.$$.fragment,l),k=!1},d(l){l&&t(p),l&&t(f),$(m,l)}}}function ph(X){let p,y,f,m,k,l,u,z,Be,ze,j,te,ne,x,Re,V,He,Fe,I,Ve,se,ae,Ke,Xe,B,Je,Ge,R,Me,Ze,ke,G,O,re,ie,Qe,le,de,Ye,Ee,C,oe,K,ce,et,J,tt,qe,P,pe,he,Z,we,A,ot,S,ue,nt;return{c(){p=n("p"),y=r("TensorFlow models and layers in "),f=n("code"),m=r("transformers"),k=r(" accept two formats as input:"),l=d(),u=n("ul"),z=n("li"),Be=r("having all inputs as keyword arguments (like PyTorch models), or"),ze=d(),j=n("li"),te=r("having all inputs as a list, tuple or dict in the first positional argument."),ne=d(),x=n("p"),Re=r(`The reason the second format is supported is that Keras methods prefer this format when passing inputs to models
and layers. Because of this support, when using methods like `),V=n("code"),He=r("model.fit()"),Fe=r(` things should \u201Cjust work\u201D for you - just
pass your inputs and labels in any format that `),I=n("code"),Ve=r("model.fit()"),se=r(` supports! If, however, you want to use the second
format outside of Keras methods like `),ae=n("code"),Ke=r("fit()"),Xe=r(" and "),B=n("code"),Je=r("predict()"),Ge=r(`, such as when creating your own layers or models with
the Keras `),R=n("code"),Me=r("Functional"),Ze=r(` API, there are three possibilities you can use to gather all the input Tensors in the first
...
`),he=s(rt,"CODE",{});var pt=a(he);Z=i(pt,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),pt.forEach(t),rt.forEach(t),H.forEach(t),we=c(v),A=s(v,"P",{});var q=a(A);ot=i(q,`Note that when creating models and layers with
`),S=s(q,"A",{href:!0,rel:!0});var $e=a(S);ue=i($e,"subclassing"),$e.forEach(t),nt=i(q,` then you don\u2019t need to worry
about any of this, as you can just pass inputs like you would to any other Python function!`),q.forEach(t),this.h()},h(){h(S,"href","https://keras.io/guides/making_new_layers_and_models_via_subclassing/"),h(S,"rel","nofollow")},m(v,F){g(v,p,F),e(p,y),e(p,f),e(f,m),e(p,k),g(v,l,F),g(v,u,F),e(u,z),e(z,Be),e(u,ze),e(u,j),e(j,te),g(v,ne,F),g(v,x,F),e(x,Re),e(x,V),e(V,He),e(x,Fe),e(x,I),e(I,Ve),e(x,se),e(x,ae),e(ae,Ke),e(x,Xe),e(x,B),e(B,Je),e(x,Ge),e(x,R),e(R,Me),e(x,Ze),g(v,ke,F),g(v,G,F),e(G,O),e(O,re),e(O,ie),e(ie,Qe),e(O,le),e(O,de),e(de,Ye),e(G,Ee),e(G,C),e(C,oe),e(C,K),e(K,ce),e(C,et),e(C,J),e(J,tt),e(G,qe),e(G,P),e(P,pe),e(P,he),e(he,Z),g(v,we,F),g(v,A,F),e(A,ot),e(A,S),e(S,ue),e(A,nt)},d(v){v&&t(p),v&&t(l),v&&t(u),v&&t(ne),v&&t(x),v&&t(ke),v&&t(G),v&&t(we),v&&t(A)}}}function hh(X){let p,y,f,m,k;return{c(){p=n("p"),y=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=n("code"),m=r("Module"),k=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(l){p=s(l,"P",{});var u=a(p);y=i(u,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=s(u,"CODE",{});var z=a(f);m=i(z,"Module"),z.forEach(t),k=i(u,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),u.forEach(t)},m(l,u){g(l,p,u),e(p,y),e(p,f),e(f,m),e(p,k)},d(l){l&&t(p)}}}function uh(X){let p,y,f,m,k;return m=new En({props:{code:`from transformers import XGLMTokenizer, TFXGLMForCausalLM
import tensorflow as tf
...
<span class="hljs-meta">&gt;&gt;&gt; </span>inputs = tokenizer(<span class="hljs-string">&quot;Hello, my dog is cute&quot;</span>, return_tensors=<span class="hljs-string">&quot;tf&quot;</span>)
<span class="hljs-meta">&gt;&gt;&gt; </span>outputs = model(inputs)
<span class="hljs-meta">&gt;&gt;&gt; </span>logits = outputs.logits`}}),{c(){p=n("p"),y=r("Example:"),f=d(),b(m.$$.fragment)},l(l){p=s(l,"P",{});var u=a(p);y=i(u,"Example:"),u.forEach(t),f=c(l),T(m.$$.fragment,l)},m(l,u){g(l,p,u),e(p,y),g(l,f,u),M(m,l,u),k=!0},p:Gn,i(l){k||(w(m.$$.fragment,l),k=!0)},o(l){L(m.$$.fragment,l),k=!1},d(l){l&&t(p),l&&t(f),$(m,l)}}}function mh(X){let p,y,f,m,k;return{c(){p=n("p"),y=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=n("code"),m=r("Module"),k=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(l){p=s(l,"P",{});var u=a(p);y=i(u,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=s(u,"CODE",{});var z=a(f);m=i(z,"Module"),z.forEach(t),k=i(u,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),u.forEach(t)},m(l,u){g(l,p,u),e(p,y),e(p,f),e(f,m),e(p,k)},d(l){l&&t(p)}}}function fh(X){let p,y,f,m,k;return m=new En({props:{code:`from transformers import XGLMTokenizer, FlaxXGLMModel
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),{c(){p=n("p"),y=r("Example:"),f=d(),b(m.$$.fragment)},l(l){p=s(l,"P",{});var u=a(p);y=i(u,"Example:"),u.forEach(t),f=c(l),T(m.$$.fragment,l)},m(l,u){g(l,p,u),e(p,y),g(l,f,u),M(m,l,u),k=!0},p:Gn,i(l){k||(w(m.$$.fragment,l),k=!0)},o(l){L(m.$$.fragment,l),k=!1},d(l){l&&t(p),l&&t(f),$(m,l)}}}function gh(X){let p,y,f,m,k;return{c(){p=n("p"),y=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=n("code"),m=r("Module"),k=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(l){p=s(l,"P",{});var u=a(p);y=i(u,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=s(u,"CODE",{});var z=a(f);m=i(z,"Module"),z.forEach(t),k=i(u,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),u.forEach(t)},m(l,u){g(l,p,u),e(p,y),e(p,f),e(f,m),e(p,k)},d(l){l&&t(p)}}}function _h(X){let p,y,f,m,k;return m=new En({props:{code:`from transformers import XGLMTokenizer, FlaxXGLMForCausalLM
...
<span class="hljs-meta">&gt;&gt;&gt; </span>next_token_logits = outputs.logits[:, -<span class="hljs-number">1</span>]`}}),{c(){p=n("p"),y=r("Example:"),f=d(),b(m.$$.fragment)},l(l){p=s(l,"P",{});var u=a(p);y=i(u,"Example:"),u.forEach(t),f=c(l),T(m.$$.fragment,l)},m(l,u){g(l,p,u),e(p,y),g(l,f,u),M(m,l,u),k=!0},p:Gn,i(l){k||(w(m.$$.fragment,l),k=!0)},o(l){L(m.$$.fragment,l),k=!1},d(l){l&&t(p),l&&t(f),$(m,l)}}}function kh(X){let p,y,f,m,k,l,u,z,Be,ze,j,te,ne,x,Re,V,He,Fe,I,Ve,se,ae,Ke,Xe,B,Je,Ge,R,Me,Ze,ke,G,O,re,ie,Qe,le,de,Ye,Ee,C,oe,K,ce,et,J,tt,qe,P,pe,he,Z,we,A,ot,S,ue,nt,v,F,me,Le,Ce,kt,E,Pe,yt,vt,bt,ye,H,D,ve,st,W,Tt,at,rt,pt,q,$e,lr,it,dr,qn,cr,pr,Cn,hr,ur,bo,mr,fr,gr,To,_r,Pn,kr,yr,vr,ht,Mo,br,cs,Tr,Mr,wo,An,wr,ps,Lr,$r,jn,xr,hs,zr,Fr,jt,Lo,Xr,$o,Gr,us,Er,qr,Cr,Ot,xo,Pr,ms,Ar,jr,On,zo,ka,Mt,Dt,fs,Fo,Or,gs,Dr,ya,fe,Xo,Nr,xe,Ir,_s,Sr,Wr,Dn,Ur,Br,Nn,Rr,Hr,Go,Vr,Kr,Jr,Eo,Zr,In,Qr,Yr,ei,ut,qo,ti,ks,oi,ni,Co,Sn,si,ys,ai,ri,Wn,ii,vs,li,di,Nt,Po,ci,bs,pi,va,wt,It,Ts,Ao,hi,Ms,ui,ba,ge,jo,mi,Oo,fi,Un,gi,_i,ki,Do,yi,No,vi,bi,Ti,St,Mi,ws,wi,Li,Ls,$i,xi,Ae,Io,zi,Lt,Fi,Bn,Xi,Gi,$s,Ei,qi,Ci,Wt,Pi,Ut,Ta,$t,Bt,xs,So,Ai,zs,ji,Ma,_e,Wo,Oi,Fs,Di,Ni,Uo,Ii,Rn,Si,Wi,Ui,Bo,Bi,Ro,Ri,Hi,Vi,je,Ho,Ki,xt,Ji,Hn,Zi,Qi,Xs,Yi,el,tl,Rt,ol,Ht,wa,zt,Vt,Gs,Vo,nl,Es,sl,La,Q,Ko,al,Jo,rl,Vn,il,ll,dl,Zo,cl,Qo,pl,hl,ul,Kt,ml,Jt,fl,qs,gl,_l,Cs,kl,yl,Oe,Yo,vl,Ft,bl,Kn,Tl,Ml,Ps,wl,Ll,$l,Zt,xl,Qt,$a,Xt,Yt,As,en,zl,js,Fl,xa,Y,tn,Xl,Os,Gl,El,on,ql,Jn,Cl,Pl,Al,nn,jl,sn,Ol,Dl,Nl,eo,Il,De,an,Sl,Gt,Wl,Zn,Ul,Bl,Ds,Rl,Hl,Vl,to,Kl,oo,za,Et,no,Ns,rn,Jl,Is,Zl,Fa,ee,ln,Ql,dn,Yl,Qn,ed,td,od,cn,nd,pn,sd,ad,rd,Ss,id,ld,lt,Ws,hn,dd,cd,Us,un,pd,hd,Bs,mn,ud,md,Rs,fn,fd,gd,Ne,gn,_d,qt,kd,Hs,yd,vd,Vs,bd,Td,Md,so,wd,ao,Xa,Ct,ro,Ks,_n,Ld,Js,$d,Ga,U,kn,xd,Zs,zd,Fd,yn,Xd,Yn,Gd,Ed,qd,vn,Cd,bn,Pd,Ad,jd,Qs,Od,Dd,dt,Ys,Tn,Nd,Id,ea,Mn,Sd,Wd,ta,wn,Ud,Bd,oa,Ln,Rd,Hd,Ie,$n,Vd,Pt,Kd,na,Jd,Zd,sa,Qd,Yd,ec,io,tc,lo,Ea;return l=new ct({}),x=new ct({}),ce=new ct({}),pe=new N({props:{name:"class transformers.XGLMConfig",anchor:"transformers.XGLMConfig",parameters:[{name:"vocab_size",val:" = 256008"},{name:"max_position_embeddings",val:" = 2048"},{name:"d_model",val:" = 1024"},{name:"ffn_dim",val:" = 4096"},{name:"num_layers",val:" = 24"},{name:"attention_heads",val:" = 16"},{name:"activation_function",val:" = 'gelu'"},{name:"dropout",val:" = 0.1"},{name:"attention_dropout",val:" = 0.1"},{name:"activation_dropout",val:" = 0.0"},{name:"layerdrop",val:" = 0.0"},{name:"init_std",val:" = 0.02"},{name:"scale_embedding",val:" = True"},{name:"use_cache",val:" = True"},{name:"decoder_start_token_id",val:" = 2"},{name:"pad_token_id",val:" = 1"},{name:"bos_token_id",val:" = 0"},{name:"eos_token_id",val:" = 2"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.XGLMConfig.vocab_size",description:`<strong>vocab_size</strong> (<code>int</code>, <em>optional</em>, defaults to 256008) &#x2014;
...
Whether or not the model should return the last key/values attentions (not used by all models).`,name:"use_cache"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/xglm/configuration_xglm.py#L29"}}),ye=new Xn({props:{anchor:"transformers.XGLMConfig.example",$$slots:{default:[nh]},$$scope:{ctx:X}}}),W=new ct({}),$e=new N({props:{name:"class transformers.XGLMTokenizer",anchor:"transformers.XGLMTokenizer",parameters:[{name:"vocab_file",val:""},{name:"bos_token",val:" = '<s>'"},{name:"eos_token",val:" = '</s>'"},{name:"sep_token",val:" = '</s>'"},{name:"cls_token",val:" = '<s>'"},{name:"unk_token",val:" = '<unk>'"},{name:"pad_token",val:" = '<pad>'"},{name:"sp_model_kwargs",val:": typing.Union[typing.Dict[str, typing.Any], NoneType] = None"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.XGLMTokenizer.vocab_file",description:`<strong>vocab_file</strong> (<code>str</code>) &#x2014;
...
Whether or not to return a <a href="/docs/transformers/main/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/xglm/modeling_xglm.py#L593",returnDescription:`
<p>A <a
...
(masked), the loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/xglm/modeling_xglm.py#L854",returnDescription:`
<p>A <a
...
`}}),Rt=new vo({props:{$$slots:{default:[rh]},$$scope:{ctx:X}}}),Ht=new Xn({props:{anchor:"transformers.XGLMForCausalLM.forward.example",$$slots:{default:[ih]},$$scope:{ctx:X}}}),Vo=new ct({}),Ko=new N({props:{name:"class transformers.TFXGLMModel",anchor:"transformers.TFXGLMModel",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.TFXGLMModel.config",description:`<strong>config</strong> (<a href="/docs/transformers/main/en/model_doc/xglm#transformers.XGLMConfig">XGLMConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
...
behaviors between training and evaluation).`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/xglm/modeling_tf_xglm.py#L789",returnDescription:`
<p>A <a
...
are ignored (masked), the loss is only computed for labels in <code>[0, ..., config.vocab_size]</code>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/xglm/modeling_tf_xglm.py#L905",returnDescription:`
<p>A <a
...
`}}),to=new vo({props:{$$slots:{default:[hh]},$$scope:{ctx:X}}}),oo=new Xn({props:{anchor:"transformers.TFXGLMForCausalLM.call.example",$$slots:{default:[uh]},$$scope:{ctx:X}}}),rn=new ct({}),ln=new N({props:{name:"class transformers.FlaxXGLMModel",anchor:"transformers.FlaxXGLMModel",parameters:[{name:"config",val:": XGLMConfig"},{name:"input_shape",val:": typing.Tuple[int] = (1, 1)"},{name:"seed",val:": int = 0"},{name:"dtype",val:": dtype = <class 'jax.numpy.float32'>"},{name:"_do_init",val:": bool = True"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.FlaxXGLMModel.config",description:`<strong>config</strong> (<a href="/docs/transformers/main/en/model_doc/xglm#transformers.XGLMConfig">XGLMConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
...
`}}),so=new vo({props:{$$slots:{default:[mh]},$$scope:{ctx:X}}}),ao=new Xn({props:{anchor:"transformers.FlaxXGLMModel.__call__.example",$$slots:{default:[fh]},$$scope:{ctx:X}}}),_n=new ct({}),kn=new N({props:{name:"class transformers.FlaxXGLMForCausalLM",anchor:"transformers.FlaxXGLMForCausalLM",parameters:[{name:"config",val:": XGLMConfig"},{name:"input_shape",val:": typing.Tuple[int] = (1, 1)"},{name:"seed",val:": int = 0"},{name:"dtype",val:": dtype = <class 'jax.numpy.float32'>"},{name:"_do_init",val:": bool = True"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.FlaxXGLMForCausalLM.config",description:`<strong>config</strong> (<a href="/docs/transformers/main/en/model_doc/xglm#transformers.XGLMConfig">XGLMConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
...
`}}),io=new vo({props:{$$slots:{default:[gh]},$$scope:{ctx:X}}}),lo=new Xn({props:{anchor:"transformers.FlaxXGLMForCausalLM.__call__.example",$$slots:{default:[_h]},$$scope:{ctx:X}}}),{c(){p=n("meta"),y=d(),f=n("h1"),m=n("a"),k=n("span"),b(l.$$.fragment),u=d(),z=n("span"),Be=r("XGLM"),ze=d(),j=n("h2"),te=n("a"),ne=n("span"),b(x.$$.fragment),Re=d(),V=n("span"),He=r("Overview"),Fe=d(),I=n("p"),Ve=r("The XGLM model was proposed in "),se=n("a"),ae=r("Few-shot Learning with Multilingual Language Models"),Ke=r(`
...
Jeff Wang, Luke Zettlemoyer, Zornitsa Kozareva, Mona Diab, Veselin Stoyanov, Xian Li.`),Xe=d(),B=n("p"),Je=r("The abstract from the paper is the following:"),Ge=d(),R=n("p"),Me=n("em"),Ze=r(`Large-scale autoregressive language models such as GPT-3 are few-shot learners that can perform a wide range of language
...
in social value tasks such as hate speech detection in five languages and find it has limitations similar to comparable sized GPT-3 models.`),ke=d(),G=n("p"),O=r("This model was contributed by "),re=n("a"),ie=r("Suraj"),Qe=r(". The original code can be found "),le=n("a"),de=r("here"),Ye=r("."),Ee=d(),C=n("h2"),oe=n("a"),K=n("span"),b(ce.$$.fragment),et=d(),J=n("span"),tt=r("XGLMConfig"),qe=d(),P=n("div"),b(pe.$$.fragment),he=d(),Z=n("p"),we=r("This is the configuration class to store the configuration of a "),A=n("a"),ot=r("XGLMModel"),S=r(`. It is used to instantiate an XGLM
model according to the specified arguments, defining the model architecture. Instantiating a configuration with the
defaults will yield a similar configuration to that of the XGLM
`),ue=n("a"),nt=r("facebook/xglm-564M"),v=r(" architecture."),F=d(),me=n("p"),Le=r("Configuration objects inherit from "),Ce=n("a"),kt=r("PretrainedConfig"),E=r(` and can be used to control the model outputs. Read the
documentation from `),Pe=n("a"),yt=r("PretrainedConfig"),vt=r(" for more information."),bt=d(),b(ye.$$.fragment),H=d(),D=n("h2"),ve=n("a"),st=n("span"),b(W.$$.fragment),Tt=d(),at=n("span"),rt=r("XGLMTokenizer"),pt=d(),q=n("div"),b($e.$$.fragment),lr=d(),it=n("p"),dr=r("Adapted from "),qn=n("a"),cr=r("RobertaTokenizer"),pr=r(" and "),Cn=n("a"),hr=r("XLNetTokenizer"),ur=r(`. Based on
`),bo=n("a"),mr=r("SentencePiece"),fr=r("."),gr=d(),To=n("p"),_r=r("This tokenizer inherits from "),Pn=n("a"),kr=r("PreTrainedTokenizer"),yr=r(` which contains most of the main methods. Users should refer to
this superclass for more information regarding those methods.`),vr=d(),ht=n("div"),b(Mo.$$.fragment),br=d(),cs=n("p"),Tr=r(`Build model inputs from a sequence or a pair of sequence for sequence classification tasks by concatenating and
adding special tokens. An XLM-RoBERTa sequence has the following format:`),Mr=d(),wo=n("ul"),An=n("li"),wr=r("single sequence: "),ps=n("code"),Lr=r("<s> X </s>"),$r=d(),jn=n("li"),xr=r("pair of sequences: "),hs=n("code"),zr=r("<s> A </s></s> B </s>"),Fr=d(),jt=n("div"),b(Lo.$$.fragment),Xr=d(),$o=n("p"),Gr=r(`Retrieve sequence ids from a token list that has no special tokens added. This method is called when adding
...
not make use of token type ids, therefore a list of zeros is returned.`),jr=d(),On=n("div"),b(zo.$$.fragment),ka=d(),Mt=n("h2"),Dt=n("a"),fs=n("span"),b(Fo.$$.fragment),Or=d(),gs=n("span"),Dr=r("XGLMTokenizerFast"),ya=d(),fe=n("div"),b(Xo.$$.fragment),Nr=d(),xe=n("p"),Ir=r("Construct a \u201Cfast\u201D XGLM tokenizer (backed by HuggingFace\u2019s "),_s=n("em"),Sr=r("tokenizers"),Wr=r(" library). Adapted from "),Dn=n("a"),Ur=r("RobertaTokenizer"),Br=r(`
and `),Nn=n("a"),Rr=r("XLNetTokenizer"),Hr=r(`. Based on
`),Go=n("a"),Vr=r("BPE"),Kr=r("."),Jr=d(),Eo=n("p"),Zr=r("This tokenizer inherits from "),In=n("a"),Qr=r("PreTrainedTokenizerFast"),Yr=r(` which contains most of the main methods. Users should
...
adding special tokens. An XLM-RoBERTa sequence has the following format:`),ni=d(),Co=n("ul"),Sn=n("li"),si=r("single sequence: "),ys=n("code"),ai=r("<s> X </s>"),ri=d(),Wn=n("li"),ii=r("pair of sequences: "),vs=n("code"),li=r("<s> A </s></s> B </s>"),di=d(),Nt=n("div"),b(Po.$$.fragment),ci=d(),bs=n("p"),pi=r(`Create a mask from the two sequences passed to be used in a sequence-pair classification task. XLM-RoBERTa does
not make use of token type ids, therefore a list of zeros is returned.`),va=d(),wt=n("h2"),It=n("a"),Ts=n("span"),b(Ao.$$.fragment),hi=d(),Ms=n("span"),ui=r("XGLMModel"),ba=d(),ge=n("div"),b(jo.$$.fragment),mi=d(),Oo=n("p"),fi=r(`The bare XGLM Model transformer outputting raw hidden-states without any specific head on top.
...
etc.)`),ki=d(),Do=n("p"),yi=r("This model is also a PyTorch "),No=n("a"),vi=r("torch.nn.Module"),bi=r(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Ti=d(),St=n("p"),Mi=r("Transformer decoder consisting of "),ws=n("em"),wi=r("config.num_layers"),Li=r(" layers. Each layer is a "),Ls=n("code"),$i=r("XGLMDecoderLayer"),xi=d(),Ae=n("div"),b(Io.$$.fragment),zi=d(),Lt=n("p"),Fi=r("The "),Bn=n("a"),Xi=r("XGLMModel"),Gi=r(" forward method, overrides the "),$s=n("code"),Ei=r("__call__"),qi=r(" special method."),Ci=d(),b(Wt.$$.fragment),Pi=d(),b(Ut.$$.fragment),Ta=d(),$t=n("h2"),Bt=n("a"),xs=n("span"),b(So.$$.fragment),Ai=d(),zs=n("span"),ji=r("XGLMForCausalLM"),Ma=d(),_e=n("div"),b(Wo.$$.fragment),Oi=d(),Fs=n("p"),Di=r(`The XGLM Model transformer with a language modeling head on top (linear layer with weights tied to the input
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Ui=d(),Bo=n("p"),Bi=r("This model is also a PyTorch "),Ro=n("a"),Ri=r("torch.nn.Module"),Hi=r(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Vi=d(),je=n("div"),b(Ho.$$.fragment),Ki=d(),xt=n("p"),Ji=r("The "),Hn=n("a"),Zi=r("XGLMForCausalLM"),Qi=r(" forward method, overrides the "),Xs=n("code"),Yi=r("__call__"),el=r(" special method."),tl=d(),b(Rt.$$.fragment),ol=d(),b(Ht.$$.fragment),wa=d(),zt=n("h2"),Vt=n("a"),Gs=n("span"),b(Vo.$$.fragment),nl=d(),Es=n("span"),sl=r("TFXGLMModel"),La=d(),Q=n("div"),b(Ko.$$.fragment),al=d(),Jo=n("p"),rl=r(`The bare XGLM Model transformer outputting raw hidden-states without any specific head on top.
...
behavior.`),ul=d(),b(Kt.$$.fragment),ml=d(),Jt=n("p"),fl=r("Transformer decoder consisting of "),qs=n("em"),gl=r("config.num_layers"),_l=r(" layers. Each layer is a "),Cs=n("code"),kl=r("TFXGLMDecoderLayer"),yl=d(),Oe=n("div"),b(Yo.$$.fragment),vl=d(),Ft=n("p"),bl=r("The "),Kn=n("a"),Tl=r("TFXGLMModel"),Ml=r(" forward method, overrides the "),Ps=n("code"),wl=r("__call__"),Ll=r(" special method."),$l=d(),b(Zt.$$.fragment),xl=d(),b(Qt.$$.fragment),$a=d(),Xt=n("h2"),Yt=n("a"),As=n("span"),b(en.$$.fragment),zl=d(),js=n("span"),Fl=r("TFXGLMForCausalLM"),xa=d(),Y=n("div"),b(tn.$$.fragment),Xl=d(),Os=n("p"),Gl=r(`The XGLM Model transformer with a language modeling head on top (linear layer with weights tied to the input
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Nl=d(),b(eo.$$.fragment),Il=d(),De=n("div"),b(an.$$.fragment),Sl=d(),Gt=n("p"),Wl=r("The "),Zn=n("a"),Ul=r("TFXGLMForCausalLM"),Bl=r(" forward method, overrides the "),Ds=n("code"),Rl=r("__call__"),Hl=r(" special method."),Vl=d(),b(to.$$.fragment),Kl=d(),b(oo.$$.fragment),za=d(),Et=n("h2"),no=n("a"),Ns=n("span"),b(rn.$$.fragment),Jl=d(),Is=n("span"),Zl=r("FlaxXGLMModel"),Fa=d(),ee=n("div"),b(ln.$$.fragment),Ql=d(),dn=n("p"),Yl=r(`The bare XGLM Model transformer outputting raw hidden-states without any specific head on top.
...
not make use of token type ids, therefore a list of zeros is returned.`),Lc.forEach(t),Da.forEach(t),jr=c(be),On=s(be,"DIV",{class:!0});var $c=a(On);T(zo.$$.fragment,$c),$c.forEach(t),be.forEach(t),ka=c(o),Mt=s(o,"H2",{class:!0});var Na=a(Mt);Dt=s(Na,"A",{id:!0,class:!0,href:!0});var xc=a(Dt);fs=s(xc,"SPAN",{});var zc=a(fs);T(Fo.$$.fragment,zc),zc.forEach(t),xc.forEach(t),Or=c(Na),gs=s(Na,"SPAN",{});var Fc=a(gs);Dr=i(Fc,"XGLMTokenizerFast"),Fc.forEach(t),Na.forEach(t),ya=c(o),fe=s(o,"DIV",{class:!0});var mt=a(fe);T(Xo.$$.fragment,mt),Nr=c(mt),xe=s(mt,"P",{});var ft=a(xe);Ir=i(ft,"Construct a \u201Cfast\u201D XGLM tokenizer (backed by HuggingFace\u2019s "),_s=s(ft,"EM",{});var Xc=a(_s);Sr=i(Xc,"tokenizers"),Xc.forEach(t),Wr=i(ft," library). Adapted from "),Dn=s(ft,"A",{href:!0});var Gc=a(Dn);Ur=i(Gc,"RobertaTokenizer"),Gc.forEach(t),Br=i(ft,`
and `),Nn=s(ft,"A",{href:!0});var Ec=a(Nn);Rr=i(Ec,"XLNetTokenizer"),Ec.forEach(t),Hr=i(ft,`. Based on
`),Go=s(ft,"A",{href:!0,rel:!0});var qc=a(Go);Vr=i(qc,"BPE"),qc.forEach(t),Kr=i(ft,"."),ft.forEach(t),Jr=c(mt),Eo=s(mt,"P",{});var Ia=a(Eo);Zr=i(Ia,"This tokenizer inherits from "),In=s(Ia,"A",{href:!0});var Cc=a(In);Qr=i(Cc,"PreTrainedTokenizerFast"),Cc.forEach(t),Yr=i(Ia,` which contains most of the main methods. Users should
...
adding special tokens. An XLM-RoBERTa sequence has the following format:`),Pc.forEach(t),ni=c(ns),Co=s(ns,"UL",{});var Sa=a(Co);Sn=s(Sa,"LI",{});var sc=a(Sn);si=i(sc,"single sequence: "),ys=s(sc,"CODE",{});var Ac=a(ys);ai=i(Ac,"<s> X </s>"),Ac.forEach(t),sc.forEach(t),ri=c(Sa),Wn=s(Sa,"LI",{});var ac=a(Wn);ii=i(ac,"pair of sequences: "),vs=s(ac,"CODE",{});var jc=a(vs);li=i(jc,"<s> A </s></s> B </s>"),jc.forEach(t),ac.forEach(t),Sa.forEach(t),ns.forEach(t),di=c(mt),Nt=s(mt,"DIV",{class:!0});var Wa=a(Nt);T(Po.$$.fragment,Wa),ci=c(Wa),bs=s(Wa,"P",{});var Oc=a(bs);pi=i(Oc,`Create a mask from the two sequences passed to be used in a sequence-pair classification task. XLM-RoBERTa does
not make use of token type ids, therefore a list of zeros is returned.`),Oc.forEach(t),Wa.forEach(t),mt.forEach(t),va=c(o),wt=s(o,"H2",{class:!0});var Ua=a(wt);It=s(Ua,"A",{id:!0,class:!0,href:!0});var Dc=a(It);Ts=s(Dc,"SPAN",{});var Nc=a(Ts);T(Ao.$$.fragment,Nc),Nc.forEach(t),Dc.forEach(t),hi=c(Ua),Ms=s(Ua,"SPAN",{});var Ic=a(Ms);ui=i(Ic,"XGLMModel"),Ic.forEach(t),Ua.forEach(t),ba=c(o),ge=s(o,"DIV",{class:!0});var gt=a(ge);T(jo.$$.fragment,gt),mi=c(gt),Oo=s(gt,"P",{});var Ba=a(Oo);fi=i(Ba,`The bare XGLM Model transformer outputting raw hidden-states without any specific head on top.
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Ba.forEach(t),ki=c(gt),Do=s(gt,"P",{});var Ra=a(Do);yi=i(Ra,"This model is also a PyTorch "),No=s(Ra,"A",{href:!0,rel:!0});var Wc=a(No);vi=i(Wc,"torch.nn.Module"),Wc.forEach(t),bi=i(Ra,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Ra.forEach(t),Ti=c(gt),St=s(gt,"P",{});var ga=a(St);Mi=i(ga,"Transformer decoder consisting of "),ws=s(ga,"EM",{});var Uc=a(ws);wi=i(Uc,"config.num_layers"),Uc.forEach(t),Li=i(ga," layers. Each layer is a "),Ls=s(ga,"CODE",{});var Bc=a(Ls);$i=i(Bc,"XGLMDecoderLayer"),Bc.forEach(t),ga.forEach(t),xi=c(gt),Ae=s(gt,"DIV",{class:!0});var ho=a(Ae);T(Io.$$.fragment,ho),zi=c(ho),Lt=s(ho,"P",{});var ss=a(Lt);Fi=i(ss,"The "),Bn=s(ss,"A",{href:!0});var Rc=a(Bn);Xi=i(Rc,"XGLMModel"),Rc.forEach(t),Gi=i(ss," forward method, overrides the "),$s=s(ss,"CODE",{});var Hc=a($s);Ei=i(Hc,"__call__"),Hc.forEach(t),qi=i(ss," special method."),ss.forEach(t),Ci=c(ho),T(Wt.$$.fragment,ho),Pi=c(ho),T(Ut.$$.fragment,ho),ho.forEach(t),gt.forEach(t),Ta=c(o),$t=s(o,"H2",{class:!0});var Ha=a($t);Bt=s(Ha,"A",{id:!0,class:!0,href:!0});var Vc=a(Bt);xs=s(Vc,"SPAN",{});var Kc=a(xs);T(So.$$.fragment,Kc),Kc.forEach(t),Vc.forEach(t),Ai=c(Ha),zs=s(Ha,"SPAN",{});var Jc=a(zs);ji=i(Jc,"XGLMForCausalLM"),Jc.forEach(t),Ha.forEach(t),Ma=c(o),_e=s(o,"DIV",{class:!0});var _t=a(_e);T(Wo.$$.fragment,_t),Oi=c(_t),Fs=s(_t,"P",{});var Zc=a(Fs);Di=i(Zc,`The XGLM Model transformer with a language modeling head on top (linear layer with weights tied to the input
embeddings).`),Zc.forEach(t),Ni=c(_t),Uo=s(_t,"P",{});var Va=a(Uo);Ii=i(Va,"This model inherits from "),Rn=s(Va,"A",{href:!0});var Qc=a(Rn);Si=i(Qc,"PreTrainedModel"),Qc.forEach(t),Wi=i(Va,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Va.forEach(t),Ui=c(_t),Bo=s(_t,"P",{});var Ka=a(Bo);Bi=i(Ka,"This model is also a PyTorch "),Ro=s(Ka,"A",{href:!0,rel:!0});var Yc=a(Ro);Ri=i(Yc,"torch.nn.Module"),Yc.forEach(t),Hi=i(Ka,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Ka.forEach(t),Vi=c(_t),je=s(_t,"DIV",{class:!0});var uo=a(je);T(Ho.$$.fragment,uo),Ki=c(uo),xt=s(uo,"P",{});var as=a(xt);Ji=i(as,"The "),Hn=s(as,"A",{href:!0});var ep=a(Hn);Zi=i(ep,"XGLMForCausalLM"),ep.forEach(t),Qi=i(as," forward method, overrides the "),Xs=s(as,"CODE",{});var tp=a(Xs);Yi=i(tp,"__call__"),tp.forEach(t),el=i(as," special method."),as.forEach(t),tl=c(uo),T(Rt.$$.fragment,uo),ol=c(uo),T(Ht.$$.fragment,uo),uo.forEach(t),_t.forEach(t),wa=c(o),zt=s(o,"H2",{class:!0});var Ja=a(zt);Vt=s(Ja,"A",{id:!0,class:!0,href:!0});var op=a(Vt);Gs=s(op,"SPAN",{});var np=a(Gs);T(Vo.$$.fragment,np),np.forEach(t),op.forEach(t),nl=c(Ja),Es=s(Ja,"SPAN",{});var sp=a(Es);sl=i(sp,"TFXGLMModel"),sp.forEach(t),Ja.forEach(t),La=c(o),Q=s(o,"DIV",{class:!0});var Se=a(Q);T(Ko.$$.fragment,Se),al=c(Se),Jo=s(Se,"P",{});var Za=a(Jo);rl=i(Za,`The bare XGLM Model transformer outputting raw hidden-states without any specific head on top.
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Qa.forEach(t),ul=c(Se),T(Kt.$$.fragment,Se),ml=c(Se),Jt=s(Se,"P",{});var _a=a(Jt);fl=i(_a,"Transformer decoder consisting of "),qs=s(_a,"EM",{});var ip=a(qs);gl=i(ip,"config.num_layers"),ip.forEach(t),_l=i(_a," layers. Each layer is a "),Cs=s(_a,"CODE",{});var lp=a(Cs);kl=i(lp,"TFXGLMDecoderLayer"),lp.forEach(t),_a.forEach(t),yl=c(Se),Oe=s(Se,"DIV",{class:!0});var mo=a(Oe);T(Yo.$$.fragment,mo),vl=c(mo),Ft=s(mo,"P",{});var rs=a(Ft);bl=i(rs,"The "),Kn=s(rs,"A",{href:!0});var dp=a(Kn);Tl=i(dp,"TFXGLMModel"),dp.forEach(t),Ml=i(rs," forward method, overrides the "),Ps=s(rs,"CODE",{});var cp=a(Ps);wl=i(cp,"__call__"),cp.forEach(t),Ll=i(rs," special method."),rs.forEach(t),$l=c(mo),T(Zt.$$.fragment,mo),xl=c(mo),T(Qt.$$.fragment,mo),mo.forEach(t),Se.forEach(t),$a=c(o),Xt=s(o,"H2",{class:!0});var Ya=a(Xt);Yt=s(Ya,"A",{id:!0,class:!0,href:!0});var pp=a(Yt);As=s(pp,"SPAN",{});var hp=a(As);T(en.$$.fragment,hp),hp.forEach(t),pp.forEach(t),zl=c(Ya),js=s(Ya,"SPAN",{});var up=a(js);Fl=i(up,"TFXGLMForCausalLM"),up.forEach(t),Ya.forEach(t),xa=c(o),Y=s(o,"DIV",{class:!0});var We=a(Y);T(tn.$$.fragment,We),Xl=c(We),Os=s(We,"P",{});var mp=a(Os);Gl=i(mp,`The XGLM Model transformer with a language modeling head on top (linear layer with weights tied to the input
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),tr.forEach(t),Nl=c(We),T(eo.$$.fragment,We),Il=c(We),De=s(We,"DIV",{class:!0});var fo=a(De);T(an.$$.fragment,fo),Sl=c(fo),Gt=s(fo,"P",{});var is=a(Gt);Wl=i(is,"The "),Zn=s(is,"A",{href:!0});var _p=a(Zn);Ul=i(_p,"TFXGLMForCausalLM"),_p.forEach(t),Bl=i(is," forward method, overrides the "),Ds=s(is,"CODE",{});var kp=a(Ds);Rl=i(kp,"__call__"),kp.forEach(t),Hl=i(is," special method."),is.forEach(t),Vl=c(fo),T(to.$$.fragment,fo),Kl=c(fo),T(oo.$$.fragment,fo),fo.forEach(t),We.forEach(t),za=c(o),Et=s(o,"H2",{class:!0});var or=a(Et);no=s(or,"A",{id:!0,class:!0,href:!0});var yp=a(no);Ns=s(yp,"SPAN",{});var vp=a(Ns);T(rn.$$.fragment,vp),vp.forEach(t),yp.forEach(t),Jl=c(or),Is=s(or,"SPAN",{});var bp=a(Is);Zl=i(bp,"FlaxXGLMModel"),bp.forEach(t),or.forEach(t),Fa=c(o),ee=s(o,"DIV",{class:!0});var Ue=a(ee);T(ln.$$.fragment,Ue),Ql=c(Ue),dn=s(Ue,"P",{});var nr=a(dn);Yl=i(nr,`The bare XGLM Model transformer outputting raw hidden-states without any specific head on top.
...
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),sr.forEach(t),rd=c(Ue),Ss=s(Ue,"P",{});var wp=a(Ss);id=i(wp,"Finally, this model supports inherent JAX features such as:"),wp.forEach(t),ld=c(Ue),lt=s(Ue,"UL",{});var go=a(lt);Ws=s(go,"LI",{});var Lp=a(Ws);hn=s(Lp,"A",{href:!0,rel:!0});var $p=a(hn);dd=i($p,"Just-In-Time (JIT) compilation"),$p.forEach(t),Lp.forEach(t),cd=c(go),Us=s(go,"LI",{});var xp=a(Us);un=s(xp,"A",{href:!0,rel:!0});var zp=a(un);pd=i(zp,"Automatic Differentiation"),zp.forEach(t),xp.forEach(t),hd=c(go),Bs=s(go,"LI",{});var Fp=a(Bs);mn=s(Fp,"A",{href:!0,rel:!0});var Xp=a(mn);ud=i(Xp,"Vectorization"),Xp.forEach(t),Fp.forEach(t),md=c(go),Rs=s(go,"LI",{});var Gp=a(Rs);fn=s(Gp,"A",{href:!0,rel:!0});var Ep=a(fn);fd=i(Ep,"Parallelization"),Ep.forEach(t),Gp.forEach(t),go.forEach(t),gd=c(Ue),Ne=s(Ue,"DIV",{class:!0});var _o=a(Ne);T(gn.$$.fragment,_o),_d=c(_o),qt=s(_o,"P",{});var ls=a(qt);kd=i(ls,"The "),Hs=s(ls,"CODE",{});var qp=a(Hs);yd=i(qp,"FlaxXGLMPreTrainedModel"),qp.forEach(t),vd=i(ls," forward method, overrides the "),Vs=s(ls,"CODE",{});var Cp=a(Vs);bd=i(Cp,"__call__"),Cp.forEach(t),Td=i(ls," special method."),ls.forEach(t),Md=c(_o),T(so.$$.fragment,_o),wd=c(_o),T(ao.$$.fragment,_o),_o.forEach(t),Ue.forEach(t),Xa=c(o),Ct=s(o,"H2",{class:!0});var ar=a(Ct);ro=s(ar,"A",{id:!0,class:!0,href:!0});var Pp=a(ro);Ks=s(Pp,"SPAN",{});var Ap=a(Ks);T(_n.$$.fragment,Ap),Ap.forEach(t),Pp.forEach(t),Ld=c(ar),Js=s(ar,"SPAN",{});var jp=a(Js);$d=i(jp,"FlaxXGLMForCausalLM"),jp.forEach(t),ar.forEach(t),Ga=c(o),U=s(o,"DIV",{class:!0});var Te=a(U);T(kn.$$.fragment,Te),xd=c(Te),Zs=s(Te,"P",{});var Op=a(Zs);zd=i(Op,`The XGLM Model transformer with a language modeling head on top (linear layer with weights tied to the input
embeddings).`),Op.forEach(t),Fd=c(Te),yn=s(Te,"P",{});var rr=a(yn);Xd=i(rr,"This model inherits from "),Yn=s(rr,"A",{href:!0});var Dp=a(Yn);Gd=i(Dp,"FlaxPreTrainedModel"),Dp.forEach(t),Ed=i(rr,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),rr.forEach(t),qd=c(Te),vn=s(Te,"P",{});var ir=a(vn);Cd=i(ir,`This model is also a Flax Linen
`),bn=s(ir,"A",{href:!0,rel:!0});var Np=a(bn);Pd=i(Np,"flax.nn.Module"),Np.forEach(t),Ad=i(ir,` subclass. Use it as a
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),ir.forEach(t),jd=c(Te),Qs=s(Te,"P",{});var Ip=a(Qs);Od=i(Ip,"Finally, this model supports inherent JAX features such as:"),Ip.forEach(t),Dd=c(Te),dt=s(Te,"UL",{});var ko=a(dt);Ys=s(ko,"LI",{});var Sp=a(Ys);Tn=s(Sp,"A",{href:!0,rel:!0});var Wp=a(Tn);Nd=i(Wp,"Just-In-Time (JIT) compilation"),Wp.forEach(t),Sp.forEach(t),Id=c(ko),ea=s(ko,"LI",{});var Up=a(ea);Mn=s(Up,"A",{href:!0,rel:!0});var Bp=a(Mn);Sd=i(Bp,"Automatic Differentiation"),Bp.forEach(t),Up.forEach(t),Wd=c(ko),ta=s(ko,"LI",{});var Rp=a(ta);wn=s(Rp,"A",{href:!0,rel:!0});var Hp=a(wn);Ud=i(Hp,"Vectorization"),Hp.forEach(t),Rp.forEach(t),Bd=c(ko),oa=s(ko,"LI",{});var Vp=a(oa);Ln=s(Vp,"A",{href:!0,rel:!0});var Kp=a(Ln);Rd=i(Kp,"Parallelization"),Kp.forEach(t),Vp.forEach(t),ko.forEach(t),Hd=c(Te),Ie=s(Te,"DIV",{class:!0});var yo=a(Ie);T($n.$$.fragment,yo),Vd=c(yo),Pt=s(yo,"P",{});var ds=a(Pt);Kd=i(ds,"The "),na=s(ds,"CODE",{});var Jp=a(na);Jd=i(Jp,"FlaxXGLMPreTrainedModel"),Jp.forEach(t),Zd=i(ds," forward method, overrides the "),sa=s(ds,"CODE",{});var Zp=a(sa);Qd=i(Zp,"__call__"),Zp.forEach(t),Yd=i(ds," special method."),ds.forEach(t),ec=c(yo),T(io.$$.fragment,yo),tc=c(yo),T(lo.$$.fragment,yo),yo.forEach(t),Te.forEach(t),this.h()},h(){h(p,"name","hf:doc:metadata"),h(p,"content",JSON.stringify(yh)),h(m,"id","xglm"),h(m,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),h(m,"href","#xglm"),h(f,"class","relative group"),h(te,"id","overview"),h(te,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),h(te,"href","#overview"),h(j,"class","relative group"),h(se,"href","https://arxiv.org/abs/2112.10668"),h(se,"rel","nofollow"),h(re,"href","https://huggingface.co/valhalla"),h(re,"rel","nofollow"),h(le,"href","https://github.com/pytorch/fairseq/tree/main/examples/xglm"),h(le,"rel","nofollow"),h(oe,"id","transformers.XGLMConfig"),h(oe,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),h(oe,"href","#transformers.XGLMConfig"),h(C,"class","relative group"),h(A,"href","/docs/transformers/main/en/model_doc/xglm#transformers.XGLMModel"),h(ue,"href","https://huggingface.co/facebook/xglm-564M"),h(ue,"rel","nofollow"),h(Ce,"href","/docs/transformers/main/en/main_classes/configuration#transformers.PretrainedConfig"),h(Pe,"href","/docs/transformers/main/en/main_classes/configuration#transformers.PretrainedConfig"),h(P,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),h(ve,"id","transformers.XGLMTokenizer"),h(ve,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),h(ve,"href","#transformers.XGLMTokenizer"),h(D,"class","relative group"),h(qn,"href","/docs/transformers/main/en/model_doc/roberta#transformers.RobertaTokenizer"),h(Cn,"href","/docs/transformers/main/en/model_doc/xlnet#transformers.XLNetTokenizer"),h(bo,"href","https://github.com/google/sentencepiece"),h(bo,"rel","nofollow"),h(Pn,"href","/docs/transformers/main/en/main_classes/tokenizer#transformers.PreTrainedTokenizer"),h(ht,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),h(jt,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),h(Ot,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),h(On,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),h(q,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),h(Dt,"id","transformers.XGLMTokenizerFast"),h(Dt,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),h(Dt,"href","#transformers.XGLMTokenizerFast"),h(Mt,"class","relative group"),h(Dn,"href","/docs/transformers/main/en/model_doc/roberta#transformers.RobertaTokenizer"),h(Nn,"href","/docs/transformers/main/en/model_doc/xlnet#transformers.XLNetTokenizer"),h(Go,"href","https://huggingface.co/docs/tokenizers/python/latest/components.html?highlight=BPE#models"),h(Go,"rel","nofollow"),h(In,"href","/docs/transformers/main/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast"),h(ut,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),h(Nt,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),h(fe,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),h(It,"id","transformers.XGLMModel"),h(It,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),h(It,"href","#transformers.XGLMModel"),h(wt,"class","relative group"),h(Un,"href","/docs/transformers/main/en/main_classes/model#transformers.PreTrainedModel"),h(No,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),h(No,"rel","nofollow"),h(Bn,"href","/docs/transformers/main/en/model_doc/xglm#transformers.XGLMModel"),h(Ae,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),h(ge,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),h(Bt,"id","transformers.XGLMForCausalLM"),h(Bt,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),h(Bt,"href","#transformers.XGLMForCausalLM"),h($t,"class","relative group"),h(Rn,"href","/docs/transformers/main/en/main_classes/model#transformers.PreTrainedModel"),h(Ro,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),h(Ro,"rel","nofollow"),h(Hn,"href","/docs/transformers/main/en/model_doc/xglm#transformers.XGLMForCausalLM"),h(je,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),h(_e,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),h(Vt,"id","transformers.TFXGLMModel"),h(Vt,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),h(Vt,"href","#transformers.TFXGLMModel"),h(zt,"class","relative group"),h(Vn,"href","/docs/transformers/main/en/main_classes/model#transformers.TFPreTrainedModel"),h(Qo,"href","https://www.tensorflow.org/api_docs/python/tf/keras/Model"),h(Qo,"rel","nofollow"),h(Kn,"href","/docs/transformers/main/en/model_doc/xglm#transformers.TFXGLMModel"),h(Oe,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),h(Q,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),h(Yt,"id","transformers.TFXGLMForCausalLM"),h(Yt,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),h(Yt,"href","#transformers.TFXGLMForCausalLM"),h(Xt,"class","relative group"),h(Jn,"href","/docs/transformers/main/en/main_classes/model#transformers.TFPreTrainedModel"),h(sn,"href","https://www.tensorflow.org/api_docs/python/tf/keras/Model"),h(sn,"rel","nofollow"),h(Zn,"href","/docs/transformers/main/en/model_doc/xglm#transformers.TFXGLMForCausalLM"),h(De,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),h(Y,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),h(no,"id","transformers.FlaxXGLMModel"),h(no,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),h(no,"href","#transformers.FlaxXGLMModel"),h(Et,"class","relative group"),h(Qn,"href","/docs/transformers/main/en/main_classes/model#transformers.FlaxPreTrainedModel"),h(pn,"href","https://flax.readthedocs.io/en/latest/_autosummary/flax.nn.module.html"),h(pn,"rel","nofollow"),h(hn,"href","https://jax.readthedocs.io/en/latest/jax.html#just-in-time-compilation-jit"),h(hn,"rel","nofollow"),h(un,"href","https://jax.readthedocs.io/en/latest/jax.html#automatic-differentiation"),h(un,"rel","nofollow"),h(mn,"href","https://jax.readthedocs.io/en/latest/jax.html#vectorization-vmap"),h(mn,"rel","nofollow"),h(fn,"href","https://jax.readthedocs.io/en/latest/jax.html#parallelization-pmap"),h(fn,"rel","nofollow"),h(Ne,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),h(ee,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),h(ro,"id","transformers.FlaxXGLMForCausalLM"),h(ro,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),h(ro,"href","#transformers.FlaxXGLMForCausalLM"),h(Ct,"class","relative group"),h(Yn,"href","/docs/transformers/main/en/main_classes/model#transformers.FlaxPreTrainedModel"),h(bn,"href","https://flax.readthedocs.io/en/latest/_autosummary/flax.nn.module.html"),h(bn,"rel","nofollow"),h(Tn,"href","https://jax.readthedocs.io/en/latest/jax.html#just-in-time-compilation-jit"),h(Tn,"rel","nofollow"),h(Mn,"href","https://jax.readthedocs.io/en/latest/jax.html#automatic-differentiation"),h(Mn,"rel","nofollow"),h(wn,"href","https://jax.readthedocs.io/en/latest/jax.html#vectorization-vmap"),h(wn,"rel","nofollow"),h(Ln,"href","https://jax.readthedocs.io/en/latest/jax.html#parallelization-pmap"),h(Ln,"rel","nofollow"),h(Ie,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),h(U,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8")},m(o,_){e(document.head,p),g(o,y,_),g(o,f,_),e(f,m),e(m,k),M(l,k,null),e(f,u),e(f,z),e(z,Be),g(o,ze,_),g(o,j,_),e(j,te),e(te,ne),M(x,ne,null),e(j,Re),e(j,V),e(V,He),g(o,Fe,_),g(o,I,_),e(I,Ve),e(I,se),e(se,ae),e(I,Ke),g(o,Xe,_),g(o,B,_),e(B,Je),g(o,Ge,_),g(o,R,_),e(R,Me),e(Me,Ze),g(o,ke,_),g(o,G,_),e(G,O),e(G,re),e(re,ie),e(G,Qe),e(G,le),e(le,de),e(G,Ye),g(o,Ee,_),g(o,C,_),e(C,oe),e(oe,K),M(ce,K,null),e(C,et),e(C,J),e(J,tt),g(o,qe,_),g(o,P,_),M(pe,P,null),e(P,he),e(P,Z),e(Z,we),e(Z,A),e(A,ot),e(Z,S),e(Z,ue),e(ue,nt),e(Z,v),e(P,F),e(P,me),e(me,Le),e(me,Ce),e(Ce,kt),e(me,E),e(me,Pe),e(Pe,yt),e(me,vt),e(P,bt),M(ye,P,null),g(o,H,_),g(o,D,_),e(D,ve),e(ve,st),M(W,st,null),e(D,Tt),e(D,at),e(at,rt),g(o,pt,_),g(o,q,_),M($e,q,null),e(q,lr),e(q,it),e(it,dr),e(it,qn),e(qn,cr),e(it,pr),e(it,Cn),e(Cn,hr),e(it,ur),e(it,bo),e(bo,mr),e(it,fr),e(q,gr),e(q,To),e(To,_r),e(To,Pn),e(Pn,kr),e(To,yr),e(q,vr),e(q,ht),M(Mo,ht,null),e(ht,br),e(ht,cs),e(cs,Tr),e(ht,Mr),e(ht,wo),e(wo,An),e(An,wr),e(An,ps),e(ps,Lr),e(wo,$r),e(wo,jn),e(jn,xr),e(jn,hs),e(hs,zr),e(q,Fr),e(q,jt),M(Lo,jt,null),e(jt,Xr),e(jt,$o),e($o,Gr),e($o,us),e(us,Er),e($o,qr),e(q,Cr),e(q,Ot),M(xo,Ot,null),e(Ot,Pr),e(Ot,ms),e(ms,Ar),e(q,jr),e(q,On),M(zo,On,null),g(o,ka,_),g(o,Mt,_),e(Mt,Dt),e(Dt,fs),M(Fo,fs,null),e(Mt,Or),e(Mt,gs),e(gs,Dr),g(o,ya,_),g(o,fe,_),M(Xo,fe,null),e(fe,Nr),e(fe,xe),e(xe,Ir),e(xe,_s),e(_s,Sr),e(xe,Wr),e(xe,Dn),e(Dn,Ur),e(xe,Br),e(xe,Nn),e(Nn,Rr),e(xe,Hr),e(xe,Go),e(Go,Vr),e(xe,Kr),e(fe,Jr),e(fe,Eo),e(Eo,Zr),e(Eo,In),e(In,Qr),e(Eo,Yr),e(fe,ei),e(fe,ut),M(qo,ut,null),e(ut,ti),e(ut,ks),e(ks,oi),e(ut,ni),e(ut,Co),e(Co,Sn),e(Sn,si),e(Sn,ys),e(ys,ai),e(Co,ri),e(Co,Wn),e(Wn,ii),e(Wn,vs),e(vs,li),e(fe,di),e(fe,Nt),M(Po,Nt,null),e(Nt,ci),e(Nt,bs),e(bs,pi),g(o,va,_),g(o,wt,_),e(wt,It),e(It,Ts),M(Ao,Ts,null),e(wt,hi),e(wt,Ms),e(Ms,ui),g(o,ba,_),g(o,ge,_),M(jo,ge,null),e(ge,mi),e(ge,Oo),e(Oo,fi),e(Oo,Un),e(Un,gi),e(Oo,_i),e(ge,ki),e(ge,Do),e(Do,yi),e(Do,No),e(No,vi),e(Do,bi),e(ge,Ti),e(ge,St),e(St,Mi),e(St,ws),e(ws,wi),e(St,Li),e(St,Ls),e(Ls,$i),e(ge,xi),e(ge,Ae),M(Io,Ae,null),e(Ae,zi),e(Ae,Lt),e(Lt,Fi),e(Lt,Bn),e(Bn,Xi),e(Lt,Gi),e(Lt,$s),e($s,Ei),e(Lt,qi),e(Ae,Ci),M(Wt,Ae,null),e(Ae,Pi),M(Ut,Ae,null),g(o,Ta,_),g(o,$t,_),e($t,Bt),e(Bt,xs),M(So,xs,null),e($t,Ai),e($t,zs),e(zs,ji),g(o,Ma,_),g(o,_e,_),M(Wo,_e,null),e(_e,Oi),e(_e,Fs),e(Fs,Di),e(_e,Ni),e(_e,Uo),e(Uo,Ii),e(Uo,Rn),e(Rn,Si),e(Uo,Wi),e(_e,Ui),e(_e,Bo),e(Bo,Bi),e(Bo,Ro),e(Ro,Ri),e(Bo,Hi),e(_e,Vi),e(_e,je),M(Ho,je,null),e(je,Ki),e(je,xt),e(xt,Ji),e(xt,Hn),e(Hn,Zi),e(xt,Qi),e(xt,Xs),e(Xs,Yi),e(xt,el),e(je,tl),M(Rt,je,null),e(je,ol),M(Ht,je,null),g(o,wa,_),g(o,zt,_),e(zt,Vt),e(Vt,Gs),M(Vo,Gs,null),e(zt,nl),e(zt,Es),e(Es,sl),g(o,La,_),g(o,Q,_),M(Ko,Q,null),e(Q,al),e(Q,Jo),e(Jo,rl),e(Jo,Vn),e(Vn,il),e(Jo,ll),e(Q,dl),e(Q,Zo),e(Zo,cl),e(Zo,Qo),e(Qo,pl),e(Zo,hl),e(Q,ul),M(Kt,Q,null),e(Q,ml),e(Q,Jt),e(Jt,fl),e(Jt,qs),e(qs,gl),e(Jt,_l),e(Jt,Cs),e(Cs,kl),e(Q,yl),e(Q,Oe),M(Yo,Oe,null),e(Oe,vl),e(Oe,Ft),e(Ft,bl),e(Ft,Kn),e(Kn,Tl),e(Ft,Ml),e(Ft,Ps),e(Ps,wl),e(Ft,Ll),e(Oe,$l),M(Zt,Oe,null),e(Oe,xl),M(Qt,Oe,null),g(o,$a,_),g(o,Xt,_),e(Xt,Yt),e(Yt,As),M(en,As,null),e(Xt,zl),e(Xt,js),e(js,Fl),g(o,xa,_),g(o,Y,_),M(tn,Y,null),e(Y,Xl),e(Y,Os),e(Os,Gl),e(Y,El),e(Y,on),e(on,ql),e(on,Jn),e(Jn,Cl),e(on,Pl),e(Y,Al),e(Y,nn),e(nn,jl),e(nn,sn),e(sn,Ol),e(nn,Dl),e(Y,Nl),M(eo,Y,null),e(Y,Il),e(Y,De),M(an,De,null),e(De,Sl),e(De,Gt),e(Gt,Wl),e(Gt,Zn),e(Zn,Ul),e(Gt,Bl),e(Gt,Ds),e(Ds,Rl),e(Gt,Hl),e(De,Vl),M(to,De,null),e(De,Kl),M(oo,De,null),g(o,za,_),g(o,Et,_),e(Et,no),e(no,Ns),M(rn,Ns,null),e(Et,Jl),e(Et,Is),e(Is,Zl),g(o,Fa,_),g(o,ee,_),M(ln,ee,null),e(ee,Ql),e(ee,dn),e(dn,Yl),e(dn,Qn),e(Qn,ed),e(dn,td),e(ee,od),e(ee,cn),e(cn,nd),e(cn,pn),e(pn,sd),e(cn,ad),e(ee,rd),e(ee,Ss),e(Ss,id),e(ee,ld),e(ee,lt),e(lt,Ws),e(Ws,hn),e(hn,dd),e(lt,cd),e(lt,Us),e(Us,un),e(un,pd),e(lt,hd),e(lt,Bs),e(Bs,mn),e(mn,ud),e(lt,md),e(lt,Rs),e(Rs,fn),e(fn,fd),e(ee,gd),e(ee,Ne),M(gn,Ne,null),e(Ne,_d),e(Ne,qt),e(qt,kd),e(qt,Hs),e(Hs,yd),e(qt,vd),e(qt,Vs),e(Vs,bd),e(qt,Td),e(Ne,Md),M(so,Ne,null),e(Ne,wd),M(ao,Ne,null),g(o,Xa,_),g(o,Ct,_),e(Ct,ro),e(ro,Ks),M(_n,Ks,null),e(Ct,Ld),e(Ct,Js),e(Js,$d),g(o,Ga,_),g(o,U,_),M(kn,U,null),e(U,xd),e(U,Zs),e(Zs,zd),e(U,Fd),e(U,yn),e(yn,Xd),e(yn,Yn),e(Yn,Gd),e(yn,Ed),e(U,qd),e(U,vn),e(vn,Cd),e(vn,bn),e(bn,Pd),e(vn,Ad),e(U,jd),e(U,Qs),e(Qs,Od),e(U,Dd),e(U,dt),e(dt,Ys),e(Ys,Tn),e(Tn,Nd),e(dt,Id),e(dt,ea),e(ea,Mn),e(Mn,Sd),e(dt,Wd),e(dt,ta),e(ta,wn),e(wn,Ud),e(dt,Bd),e(dt,oa),e(oa,Ln),e(Ln,Rd),e(U,Hd),e(U,Ie),M($n,Ie,null),e(Ie,Vd),e(Ie,Pt),e(Pt,Kd),e(Pt,na),e(na,Jd),e(Pt,Zd),e(Pt,sa),e(sa,Qd),e(Pt,Yd),e(Ie,ec),M(io,Ie,null),e(Ie,tc),M(lo,Ie,null),Ea=!0},p(o,[_]){const xn={};_&2&&(xn.$$scope={dirty:_,ctx:o}),ye.$set(xn);const aa={};_&2&&(aa.$$scope={dirty:_,ctx:o}),Wt.$set(aa);const ra={};_&2&&(ra.$$scope={dirty:_,ctx:o}),Ut.$set(ra);const ia={};_&2&&(ia.$$scope={dirty:_,ctx:o}),Rt.$set(ia);const zn={};_&2&&(zn.$$scope={dirty:_,ctx:o}),Ht.$set(zn);const la={};_&2&&(la.$$scope={dirty:_,ctx:o}),Kt.$set(la);const da={};_&2&&(da.$$scope={dirty:_,ctx:o}),Zt.$set(da);const ca={};_&2&&(ca.$$scope={dirty:_,ctx:o}),Qt.$set(ca);const Fn={};_&2&&(Fn.$$scope={dirty:_,ctx:o}),eo.$set(Fn);const pa={};_&2&&(pa.$$scope={dirty:_,ctx:o}),to.$set(pa);const ha={};_&2&&(ha.$$scope={dirty:_,ctx:o}),oo.$set(ha);const ua={};_&2&&(ua.$$scope={dirty:_,ctx:o}),so.$set(ua);const ma={};_&2&&(ma.$$scope={dirty:_,ctx:o}),ao.$set(ma);const At={};_&2&&(At.$$scope={dirty:_,ctx:o}),io.$set(At);const fa={};_&2&&(fa.$$scope={dirty:_,ctx:o}),lo.$set(fa)},i(o){Ea||(w(l.$$.fragment,o),w(x.$$.fragment,o),w(ce.$$.fragment,o),w(pe.$$.fragment,o),w(ye.$$.fragment,o),w(W.$$.fragment,o),w($e.$$.fragment,o),w(Mo.$$.fragment,o),w(Lo.$$.fragment,o),w(xo.$$.fragment,o),w(zo.$$.fragment,o),w(Fo.$$.fragment,o),w(Xo.$$.fragment,o),w(qo.$$.fragment,o),w(Po.$$.fragment,o),w(Ao.$$.fragment,o),w(jo.$$.fragment,o),w(Io.$$.fragment,o),w(Wt.$$.fragment,o),w(Ut.$$.fragment,o),w(So.$$.fragment,o),w(Wo.$$.fragment,o),w(Ho.$$.fragment,o),w(Rt.$$.fragment,o),w(Ht.$$.fragment,o),w(Vo.$$.fragment,o),w(Ko.$$.fragment,o),w(Kt.$$.fragment,o),w(Yo.$$.fragment,o),w(Zt.$$.fragment,o),w(Qt.$$.fragment,o),w(en.$$.fragment,o),w(tn.$$.fragment,o),w(eo.$$.fragment,o),w(an.$$.fragment,o),w(to.$$.fragment,o),w(oo.$$.fragment,o),w(rn.$$.fragment,o),w(ln.$$.fragment,o),w(gn.$$.fragment,o),w(so.$$.fragment,o),w(ao.$$.fragment,o),w(_n.$$.fragment,o),w(kn.$$.fragment,o),w($n.$$.fragment,o),w(io.$$.fragment,o),w(lo.$$.fragment,o),Ea=!0)},o(o){L(l.$$.fragment,o),L(x.$$.fragment,o),L(ce.$$.fragment,o),L(pe.$$.fragment,o),L(ye.$$.fragment,o),L(W.$$.fragment,o),L($e.$$.fragment,o),L(Mo.$$.fragment,o),L(Lo.$$.fragment,o),L(xo.$$.fragment,o),L(zo.$$.fragment,o),L(Fo.$$.fragment,o),L(Xo.$$.fragment,o),L(qo.$$.fragment,o),L(Po.$$.fragment,o),L(Ao.$$.fragment,o),L(jo.$$.fragment,o),L(Io.$$.fragment,o),L(Wt.$$.fragment,o),L(Ut.$$.fragment,o),L(So.$$.fragment,o),L(Wo.$$.fragment,o),L(Ho.$$.fragment,o),L(Rt.$$.fragment,o),L(Ht.$$.fragment,o),L(Vo.$$.fragment,o),L(Ko.$$.fragment,o),L(Kt.$$.fragment,o),L(Yo.$$.fragment,o),L(Zt.$$.fragment,o),L(Qt.$$.fragment,o),L(en.$$.fragment,o),L(tn.$$.fragment,o),L(eo.$$.fragment,o),L(an.$$.fragment,o),L(to.$$.fragment,o),L(oo.$$.fragment,o),L(rn.$$.fragment,o),L(ln.$$.fragment,o),L(gn.$$.fragment,o),L(so.$$.fragment,o),L(ao.$$.fragment,o),L(_n.$$.fragment,o),L(kn.$$.fragment,o),L($n.$$.fragment,o),L(io.$$.fragment,o),L(lo.$$.fragment,o),Ea=!1},d(o){t(p),o&&t(y),o&&t(f),$(l),o&&t(ze),o&&t(j),$(x),o&&t(Fe),o&&t(I),o&&t(Xe),o&&t(B),o&&t(Ge),o&&t(R),o&&t(ke),o&&t(G),o&&t(Ee),o&&t(C),$(ce),o&&t(qe),o&&t(P),$(pe),$(ye),o&&t(H),o&&t(D),$(W),o&&t(pt),o&&t(q),$($e),$(Mo),$(Lo),$(xo),$(zo),o&&t(ka),o&&t(Mt),$(Fo),o&&t(ya),o&&t(fe),$(Xo),$(qo),$(Po),o&&t(va),o&&t(wt),$(Ao),o&&t(ba),o&&t(ge),$(jo),$(Io),$(Wt),$(Ut),o&&t(Ta),o&&t($t),$(So),o&&t(Ma),o&&t(_e),$(Wo),$(Ho),$(Rt),$(Ht),o&&t(wa),o&&t(zt),$(Vo),o&&t(La),o&&t(Q),$(Ko),$(Kt),$(Yo),$(Zt),$(Qt),o&&t($a),o&&t(Xt),$(en),o&&t(xa),o&&t(Y),$(tn),$(eo),$(an),$(to),$(oo),o&&t(za),o&&t(Et),$(rn),o&&t(Fa),o&&t(ee),$(ln),$(gn),$(so),$(ao),o&&t(Xa),o&&t(Ct),$(_n),o&&t(Ga),o&&t(U),$(kn),$($n),$(io),$(lo)}}}const yh={local:"xglm",sections:[{local:"overview",title:"Overview"},{local:"transformers.XGLMConfig",title:"XGLMConfig"},{local:"transformers.XGLMTokenizer",title:"XGLMTokenizer"},{local:"transformers.XGLMTokenizerFast",title:"XGLMTokenizerFast"},{local:"transformers.XGLMModel",title:"XGLMModel"},{local:"transformers.XGLMForCausalLM",title:"XGLMForCausalLM"},{local:"transformers.TFXGLMModel",title:"TFXGLMModel"},{local:"transformers.TFXGLMForCausalLM",title:"TFXGLMForCausalLM"},{local:"transformers.FlaxXGLMModel",title:"FlaxXGLMModel"},{local:"transformers.FlaxXGLMForCausalLM",title:"FlaxXGLMForCausalLM"}],title:"XGLM"};function vh(X){return oh(()=>{new URLSearchParams(window.location.search).get("fw")}),[]}class xh extends Qp{constructor(p){super();Yp(this,p,vh,kh,eh,{})}}export{xh as default,yh as metadata};
