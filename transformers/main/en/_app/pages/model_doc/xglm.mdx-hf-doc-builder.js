import{S as Qp,i as Yp,s as eh,e as n,k as d,w as b,t as r,M as th,c as s,d as t,m as c,a,x as T,h as i,b as h,G as e,g,y as M,q as w,o as L,B as $,v as oh,L as Fn}from"../../chunks/vendor-hf-doc-builder.js";import{T as vo}from"../../chunks/Tip-hf-doc-builder.js";import{D as N}from"../../chunks/Docstring-hf-doc-builder.js";import{C as En}from"../../chunks/CodeBlock-hf-doc-builder.js";import{I as ct}from"../../chunks/IconCopyLink-hf-doc-builder.js";import{E as Gn}from"../../chunks/ExampleCodeBlock-hf-doc-builder.js";function nh(G){let p,y,f,m,k;return m=new En({props:{code:`from transformers import XGLMModel, XGLMConfig
...
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),u.forEach(t)},m(l,u){g(l,p,u),e(p,y),e(p,f),e(f,m),e(p,k)},d(l){l&&t(p)}}}function ah(G){let p,y,f,m,k;return m=new En({props:{code:`from transformers import XGLMTokenizer, XGLMModel
import torch
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),{c(){p=n("p"),y=r("Example:"),f=d(),b(m.$$.fragment)},l(l){p=s(l,"P",{});var u=a(p);y=i(u,"Example:"),u.forEach(t),f=c(l),T(m.$$.fragment,l)},m(l,u){g(l,p,u),e(p,y),g(l,f,u),M(m,l,u),k=!0},p:Fn,i(l){k||(w(m.$$.fragment,l),k=!0)},o(l){L(m.$$.fragment,l),k=!1},d(l){l&&t(p),l&&t(f),$(m,l)}}}function rh(G){let p,y,f,m,k;return{c(){p=n("p"),y=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=n("code"),m=r("Module"),k=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(l){p=s(l,"P",{});var u=a(p);y=i(u,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=s(u,"CODE",{});var z=a(f);m=i(z,"Module"),z.forEach(t),k=i(u,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),u.forEach(t)},m(l,u){g(l,p,u),e(p,y),e(p,f),e(f,m),e(p,k)},d(l){l&&t(p)}}}function ih(G){let p,y,f,m,k;return m=new En({props:{code:`import torch
...
<span class="hljs-meta">&gt;&gt;&gt; </span>logits = outputs.logits`}}),{c(){p=n("p"),y=r("Example:"),f=d(),b(m.$$.fragment)},l(l){p=s(l,"P",{});var u=a(p);y=i(u,"Example:"),u.forEach(t),f=c(l),T(m.$$.fragment,l)},m(l,u){g(l,p,u),e(p,y),g(l,f,u),M(m,l,u),k=!0},p:Fn,i(l){k||(w(m.$$.fragment,l),k=!0)},o(l){L(m.$$.fragment,l),k=!1},d(l){l&&t(p),l&&t(f),$(m,l)}}}function lh(G){let p,y,f,m,k,l,u,z,Ue,ze,j,te,ne,x,Re,V,He,Xe,I,Ve,se,ae,Ke,Ge,U,Je,Fe,R,Me,Ze,ke,F,O,re,ie,Qe,le,de,Ye,Ee,C,oe,K,ce,et,J,tt,qe,P,pe,he,Z,we,A,ot,S,ue,nt;return{c(){p=n("p"),y=r("TensorFlow models and layers in "),f=n("code"),m=r("transformers"),k=r(" accept two formats as input:"),l=d(),u=n("ul"),z=n("li"),Ue=r("having all inputs as keyword arguments (like PyTorch models), or"),ze=d(),j=n("li"),te=r("having all inputs as a list, tuple or dict in the first positional argument."),ne=d(),x=n("p"),Re=r(`The reason the second format is supported is that Keras methods prefer this format when passing inputs to models
...
format outside of Keras methods like `),ae=s(E,"CODE",{});var vt=a(ae);Ke=i(vt,"fit()"),vt.forEach(t),Ge=i(E," and "),U=s(E,"CODE",{});var bt=a(U);Je=i(bt,"predict()"),bt.forEach(t),Fe=i(E,`, such as when creating your own layers or models with
...
about any of this, as you can just pass inputs like you would to any other Python function!`),q.forEach(t),this.h()},h(){h(S,"href","https://keras.io/guides/making_new_layers_and_models_via_subclassing/"),h(S,"rel","nofollow")},m(v,X){g(v,p,X),e(p,y),e(p,f),e(f,m),e(p,k),g(v,l,X),g(v,u,X),e(u,z),e(z,Ue),e(u,ze),e(u,j),e(j,te),g(v,ne,X),g(v,x,X),e(x,Re),e(x,V),e(V,He),e(x,Xe),e(x,I),e(I,Ve),e(x,se),e(x,ae),e(ae,Ke),e(x,Ge),e(x,U),e(U,Je),e(x,Fe),e(x,R),e(R,Me),e(x,Ze),g(v,ke,X),g(v,F,X),e(F,O),e(O,re),e(O,ie),e(ie,Qe),e(O,le),e(O,de),e(de,Ye),e(F,Ee),e(F,C),e(C,oe),e(C,K),e(K,ce),e(C,et),e(C,J),e(J,tt),e(F,qe),e(F,P),e(P,pe),e(P,he),e(he,Z),g(v,we,X),g(v,A,X),e(A,ot),e(A,S),e(S,ue),e(A,nt)},d(v){v&&t(p),v&&t(l),v&&t(u),v&&t(ne),v&&t(x),v&&t(ke),v&&t(F),v&&t(we),v&&t(A)}}}function dh(G){let p,y,f,m,k;return{c(){p=n("p"),y=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=n("code"),m=r("Module"),k=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(l){p=s(l,"P",{});var u=a(p);y=i(u,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=s(u,"CODE",{});var z=a(f);m=i(z,"Module"),z.forEach(t),k=i(u,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),u.forEach(t)},m(l,u){g(l,p,u),e(p,y),e(p,f),e(f,m),e(p,k)},d(l){l&&t(p)}}}function ch(G){let p,y,f,m,k;return m=new En({props:{code:`from transformers import XGLMTokenizer, TFXGLMModel
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),{c(){p=n("p"),y=r("Example:"),f=d(),b(m.$$.fragment)},l(l){p=s(l,"P",{});var u=a(p);y=i(u,"Example:"),u.forEach(t),f=c(l),T(m.$$.fragment,l)},m(l,u){g(l,p,u),e(p,y),g(l,f,u),M(m,l,u),k=!0},p:Fn,i(l){k||(w(m.$$.fragment,l),k=!0)},o(l){L(m.$$.fragment,l),k=!1},d(l){l&&t(p),l&&t(f),$(m,l)}}}function ph(G){let p,y,f,m,k,l,u,z,Ue,ze,j,te,ne,x,Re,V,He,Xe,I,Ve,se,ae,Ke,Ge,U,Je,Fe,R,Me,Ze,ke,F,O,re,ie,Qe,le,de,Ye,Ee,C,oe,K,ce,et,J,tt,qe,P,pe,he,Z,we,A,ot,S,ue,nt;return{c(){p=n("p"),y=r("TensorFlow models and layers in "),f=n("code"),m=r("transformers"),k=r(" accept two formats as input:"),l=d(),u=n("ul"),z=n("li"),Ue=r("having all inputs as keyword arguments (like PyTorch models), or"),ze=d(),j=n("li"),te=r("having all inputs as a list, tuple or dict in the first positional argument."),ne=d(),x=n("p"),Re=r(`The reason the second format is supported is that Keras methods prefer this format when passing inputs to models
and layers. Because of this support, when using methods like `),V=n("code"),He=r("model.fit()"),Xe=r(` things should \u201Cjust work\u201D for you - just
pass your inputs and labels in any format that `),I=n("code"),Ve=r("model.fit()"),se=r(` supports! If, however, you want to use the second
format outside of Keras methods like `),ae=n("code"),Ke=r("fit()"),Ge=r(" and "),U=n("code"),Je=r("predict()"),Fe=r(`, such as when creating your own layers or models with
the Keras `),R=n("code"),Me=r("Functional"),Ze=r(` API, there are three possibilities you can use to gather all the input Tensors in the first
...
`),he=s(rt,"CODE",{});var pt=a(he);Z=i(pt,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),pt.forEach(t),rt.forEach(t),H.forEach(t),we=c(v),A=s(v,"P",{});var q=a(A);ot=i(q,`Note that when creating models and layers with
`),S=s(q,"A",{href:!0,rel:!0});var $e=a(S);ue=i($e,"subclassing"),$e.forEach(t),nt=i(q,` then you don\u2019t need to worry
about any of this, as you can just pass inputs like you would to any other Python function!`),q.forEach(t),this.h()},h(){h(S,"href","https://keras.io/guides/making_new_layers_and_models_via_subclassing/"),h(S,"rel","nofollow")},m(v,X){g(v,p,X),e(p,y),e(p,f),e(f,m),e(p,k),g(v,l,X),g(v,u,X),e(u,z),e(z,Ue),e(u,ze),e(u,j),e(j,te),g(v,ne,X),g(v,x,X),e(x,Re),e(x,V),e(V,He),e(x,Xe),e(x,I),e(I,Ve),e(x,se),e(x,ae),e(ae,Ke),e(x,Ge),e(x,U),e(U,Je),e(x,Fe),e(x,R),e(R,Me),e(x,Ze),g(v,ke,X),g(v,F,X),e(F,O),e(O,re),e(O,ie),e(ie,Qe),e(O,le),e(O,de),e(de,Ye),e(F,Ee),e(F,C),e(C,oe),e(C,K),e(K,ce),e(C,et),e(C,J),e(J,tt),e(F,qe),e(F,P),e(P,pe),e(P,he),e(he,Z),g(v,we,X),g(v,A,X),e(A,ot),e(A,S),e(S,ue),e(A,nt)},d(v){v&&t(p),v&&t(l),v&&t(u),v&&t(ne),v&&t(x),v&&t(ke),v&&t(F),v&&t(we),v&&t(A)}}}function hh(G){let p,y,f,m,k;return{c(){p=n("p"),y=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=n("code"),m=r("Module"),k=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(l){p=s(l,"P",{});var u=a(p);y=i(u,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=s(u,"CODE",{});var z=a(f);m=i(z,"Module"),z.forEach(t),k=i(u,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),u.forEach(t)},m(l,u){g(l,p,u),e(p,y),e(p,f),e(f,m),e(p,k)},d(l){l&&t(p)}}}function uh(G){let p,y,f,m,k;return m=new En({props:{code:`from transformers import XGLMTokenizer, TFXGLMForCausalLM
import tensorflow as tf
...
<span class="hljs-meta">&gt;&gt;&gt; </span>inputs = tokenizer(<span class="hljs-string">&quot;Hello, my dog is cute&quot;</span>, return_tensors=<span class="hljs-string">&quot;tf&quot;</span>)
<span class="hljs-meta">&gt;&gt;&gt; </span>outputs = model(inputs)
<span class="hljs-meta">&gt;&gt;&gt; </span>logits = outputs.logits`}}),{c(){p=n("p"),y=r("Example:"),f=d(),b(m.$$.fragment)},l(l){p=s(l,"P",{});var u=a(p);y=i(u,"Example:"),u.forEach(t),f=c(l),T(m.$$.fragment,l)},m(l,u){g(l,p,u),e(p,y),g(l,f,u),M(m,l,u),k=!0},p:Fn,i(l){k||(w(m.$$.fragment,l),k=!0)},o(l){L(m.$$.fragment,l),k=!1},d(l){l&&t(p),l&&t(f),$(m,l)}}}function mh(G){let p,y,f,m,k;return{c(){p=n("p"),y=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=n("code"),m=r("Module"),k=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(l){p=s(l,"P",{});var u=a(p);y=i(u,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=s(u,"CODE",{});var z=a(f);m=i(z,"Module"),z.forEach(t),k=i(u,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),u.forEach(t)},m(l,u){g(l,p,u),e(p,y),e(p,f),e(f,m),e(p,k)},d(l){l&&t(p)}}}function fh(G){let p,y,f,m,k;return m=new En({props:{code:`from transformers import XGLMTokenizer, FlaxXGLMModel
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),{c(){p=n("p"),y=r("Example:"),f=d(),b(m.$$.fragment)},l(l){p=s(l,"P",{});var u=a(p);y=i(u,"Example:"),u.forEach(t),f=c(l),T(m.$$.fragment,l)},m(l,u){g(l,p,u),e(p,y),g(l,f,u),M(m,l,u),k=!0},p:Fn,i(l){k||(w(m.$$.fragment,l),k=!0)},o(l){L(m.$$.fragment,l),k=!1},d(l){l&&t(p),l&&t(f),$(m,l)}}}function gh(G){let p,y,f,m,k;return{c(){p=n("p"),y=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=n("code"),m=r("Module"),k=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(l){p=s(l,"P",{});var u=a(p);y=i(u,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=s(u,"CODE",{});var z=a(f);m=i(z,"Module"),z.forEach(t),k=i(u,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),u.forEach(t)},m(l,u){g(l,p,u),e(p,y),e(p,f),e(f,m),e(p,k)},d(l){l&&t(p)}}}function _h(G){let p,y,f,m,k;return m=new En({props:{code:`from transformers import XGLMTokenizer, FlaxXGLMForCausalLM
...
Whether or not the model should return the last key/values attentions (not used by all models).`,name:"use_cache"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/xglm/configuration_xglm.py#L29"}}),ye=new Gn({props:{anchor:"transformers.XGLMConfig.example",$$slots:{default:[nh]},$$scope:{ctx:G}}}),W=new ct({}),$e=new N({props:{name:"class transformers.XGLMTokenizer",anchor:"transformers.XGLMTokenizer",parameters:[{name:"vocab_file",val:""},{name:"bos_token",val:" = '<s>'"},{name:"eos_token",val:" = '</s>'"},{name:"sep_token",val:" = '</s>'"},{name:"cls_token",val:" = '<s>'"},{name:"unk_token",val:" = '<unk>'"},{name:"pad_token",val:" = '<pad>'"},{name:"sp_model_kwargs",val:": typing.Union[typing.Dict[str, typing.Any], NoneType] = None"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.XGLMTokenizer.vocab_file",description:`<strong>vocab_file</strong> (<code>str</code>) &#x2014;
...
`}}),Wt=new vo({props:{$$slots:{default:[sh]},$$scope:{ctx:G}}}),Bt=new Gn({props:{anchor:"transformers.XGLMModel.forward.example",$$slots:{default:[ah]},$$scope:{ctx:G}}}),So=new ct({}),Wo=new N({props:{name:"class transformers.XGLMForCausalLM",anchor:"transformers.XGLMForCausalLM",parameters:[{name:"config",val:""}],parametersDescription:[{anchor:"transformers.XGLMForCausalLM.config",description:`<strong>config</strong> (<a href="/docs/transformers/main/en/model_doc/xglm#transformers.XGLMConfig">XGLMConfig</a>) &#x2014;
Model configuration class with all the parameters of the model. Initializing with a config file does not
load the weights associated with the model, only the configuration. Check out the
...
`}}),so=new vo({props:{$$slots:{default:[mh]},$$scope:{ctx:G}}}),ao=new Gn({props:{anchor:"transformers.FlaxXGLMModel.__call__.example",$$slots:{default:[fh]},$$scope:{ctx:G}}}),_n=new ct({}),kn=new N({props:{name:"class transformers.FlaxXGLMForCausalLM",anchor:"transformers.FlaxXGLMForCausalLM",parameters:[{name:"config",val:": XGLMConfig"},{name:"input_shape",val:": typing.Tuple[int] = (1, 1)"},{name:"seed",val:": int = 0"},{name:"dtype",val:": dtype = <class 'jax.numpy.float32'>"},{name:"_do_init",val:": bool = True"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.FlaxXGLMForCausalLM.config",description:`<strong>config</strong> (<a href="/docs/transformers/main/en/model_doc/xglm#transformers.XGLMConfig">XGLMConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
...
`}}),io=new vo({props:{$$slots:{default:[gh]},$$scope:{ctx:G}}}),lo=new Gn({props:{anchor:"transformers.FlaxXGLMForCausalLM.__call__.example",$$slots:{default:[_h]},$$scope:{ctx:G}}}),{c(){p=n("meta"),y=d(),f=n("h1"),m=n("a"),k=n("span"),b(l.$$.fragment),u=d(),z=n("span"),Ue=r("XGLM"),ze=d(),j=n("h2"),te=n("a"),ne=n("span"),b(x.$$.fragment),Re=d(),V=n("span"),He=r("Overview"),Xe=d(),I=n("p"),Ve=r("The XGLM model was proposed in "),se=n("a"),ae=r("Few-shot Learning with Multilingual Language Models"),Ke=r(`
...
`),ue=n("a"),nt=r("facebook/xglm-564M"),v=r(" architecture."),X=d(),me=n("p"),Le=r("Configuration objects inherit from "),Ce=n("a"),kt=r("PretrainedConfig"),E=r(` and can be used to control the model outputs. Read the
...
not make use of token type ids, therefore a list of zeros is returned.`),jr=d(),On=n("div"),b(zo.$$.fragment),ka=d(),Mt=n("h2"),Dt=n("a"),fs=n("span"),b(Xo.$$.fragment),Or=d(),gs=n("span"),Dr=r("XGLMTokenizerFast"),ya=d(),fe=n("div"),b(Go.$$.fragment),Nr=d(),xe=n("p"),Ir=r("Construct a \u201Cfast\u201D XGLM tokenizer (backed by HuggingFace\u2019s "),_s=n("em"),Sr=r("tokenizers"),Wr=r(" library). Adapted from "),Dn=n("a"),Br=r("RobertaTokenizer"),Ur=r(`
...
behavior.`),ul=d(),b(Kt.$$.fragment),ml=d(),Jt=n("p"),fl=r("Transformer decoder consisting of "),qs=n("em"),gl=r("config.num_layers"),_l=r(" layers. Each layer is a "),Cs=n("code"),kl=r("TFXGLMDecoderLayer"),yl=d(),Oe=n("div"),b(Yo.$$.fragment),vl=d(),Xt=n("p"),bl=r("The "),Kn=n("a"),Tl=r("TFXGLMModel"),Ml=r(" forward method, overrides the "),Ps=n("code"),wl=r("__call__"),Ll=r(" special method."),$l=d(),b(Zt.$$.fragment),xl=d(),b(Qt.$$.fragment),$a=d(),Gt=n("h2"),Yt=n("a"),As=n("span"),b(en.$$.fragment),zl=d(),js=n("span"),Xl=r("TFXGLMForCausalLM"),xa=d(),Y=n("div"),b(tn.$$.fragment),Gl=d(),Os=n("p"),Fl=r(`The XGLM Model transformer with a language modeling head on top (linear layer with weights tied to the input
...
not make use of token type ids, therefore a list of zeros is returned.`),Oc.forEach(t),Wa.forEach(t),mt.forEach(t),va=c(o),wt=s(o,"H2",{class:!0});var Ba=a(wt);It=s(Ba,"A",{id:!0,class:!0,href:!0});var Dc=a(It);Ts=s(Dc,"SPAN",{});var Nc=a(Ts);T(Ao.$$.fragment,Nc),Nc.forEach(t),Dc.forEach(t),hi=c(Ba),Ms=s(Ba,"SPAN",{});var Ic=a(Ms);ui=i(Ic,"XGLMModel"),Ic.forEach(t),Ba.forEach(t),ba=c(o),ge=s(o,"DIV",{class:!0});var gt=a(ge);T(jo.$$.fragment,gt),mi=c(gt),Oo=s(gt,"P",{});var Ua=a(Oo);fi=i(Ua,`The bare XGLM Model transformer outputting raw hidden-states without any specific head on top.
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Ua.forEach(t),ki=c(gt),Do=s(gt,"P",{});var Ra=a(Do);yi=i(Ra,"This model is also a PyTorch "),No=s(Ra,"A",{href:!0,rel:!0});var Wc=a(No);vi=i(Wc,"torch.nn.Module"),Wc.forEach(t),bi=i(Ra,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),tr.forEach(t),Nl=c(We),T(eo.$$.fragment,We),Il=c(We),De=s(We,"DIV",{class:!0});var fo=a(De);T(an.$$.fragment,fo),Sl=c(fo),Ft=s(fo,"P",{});var is=a(Ft);Wl=i(is,"The "),Zn=s(is,"A",{href:!0});var _p=a(Zn);Bl=i(_p,"TFXGLMForCausalLM"),_p.forEach(t),Ul=i(is," forward method, overrides the "),Ds=s(is,"CODE",{});var kp=a(Ds);Rl=i(kp,"__call__"),kp.forEach(t),Hl=i(is," special method."),is.forEach(t),Vl=c(fo),T(to.$$.fragment,fo),Kl=c(fo),T(oo.$$.fragment,fo),fo.forEach(t),We.forEach(t),za=c(o),Et=s(o,"H2",{class:!0});var or=a(Et);no=s(or,"A",{id:!0,class:!0,href:!0});var yp=a(no);Ns=s(yp,"SPAN",{});var vp=a(Ns);T(rn.$$.fragment,vp),vp.forEach(t),yp.forEach(t),Jl=c(or),Is=s(or,"SPAN",{});var bp=a(Is);Zl=i(bp,"FlaxXGLMModel"),bp.forEach(t),or.forEach(t),Xa=c(o),ee=s(o,"DIV",{class:!0});var Be=a(ee);T(ln.$$.fragment,Be),Ql=c(Be),dn=s(Be,"P",{});var nr=a(dn);Yl=i(nr,`The bare XGLM Model transformer outputting raw hidden-states without any specific head on top.
...
embeddings).`),Op.forEach(t),Xd=c(Te),yn=s(Te,"P",{});var rr=a(yn);Gd=i(rr,"This model inherits from "),Yn=s(rr,"A",{href:!0});var Dp=a(Yn);Fd=i(Dp,"FlaxPreTrainedModel"),Dp.forEach(t),Ed=i(rr,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
