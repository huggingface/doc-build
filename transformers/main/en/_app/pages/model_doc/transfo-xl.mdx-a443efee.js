...
`),j=s(ye,"CODE",{});var D=a(j);Ee=i(D,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),D.forEach(t),ye.forEach(t),P.forEach(t)},m(m,E){f(m,h,E),e(h,M),f(m,u,E),f(m,g,E),e(g,$),e($,_),e(g,T),e(g,X),e(X,I),f(m,W,E),f(m,x,E),e(x,z),e(x,O),e(O,K),e(x,ae),e(x,V),e(V,$e),e(x,ge),f(m,U,E),f(m,N,E),e(N,ne),f(m,re,E),f(m,F,E),e(F,C),e(C,ie),e(C,Q),e(Q,_e),e(C,le),e(C,B),e(B,xe),e(F,Te),e(F,q),e(q,Xe),e(q,G),e(G,oe),e(q,fe),e(q,Z),e(Z,Me),e(F,me),e(F,A),e(A,ve),e(A,j),e(j,Ee)},d(m){m&&t(h),m&&t(u),m&&t(g),m&&t(W),m&&t(x),m&&t(U),m&&t(N),m&&t(re),m&&t(F)}}}function Wf(R){let h,M,u,g,$;return{c(){h=n("p"),M=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),u=n("code"),g=r("Module"),$=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(_){h=s(_,"P",{});var T=a(h);M=i(T,"Although the recipe for forward pass needs to be defined within this function, one should call the "),u=s(T,"CODE",{});var X=a(u);g=i(X,"Module"),X.forEach(t),$=i(T,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
first positional argument :`),He.forEach(t),re=d(m),F=s(m,"UL",{});var P=a(F);C=s(P,"LI",{});var S=a(C);ie=i(S,"a single Tensor with "),Q=s(S,"CODE",{});var Ce=a(Q);_e=i(Ce,"input_ids"),Ce.forEach(t),le=i(S," only and nothing else: "),B=s(S,"CODE",{});var we=a(B);xe=i(we,"model(inputs_ids)"),we.forEach(t),S.forEach(t),Te=d(P),q=s(P,"LI",{});var J=a(q);Xe=i(J,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),G=s(J,"CODE",{});var ze=a(G);oe=i(ze,"model([input_ids, attention_mask])"),ze.forEach(t),fe=i(J," or "),Z=s(J,"CODE",{});var Ue=a(Z);Me=i(Ue,"model([input_ids, attention_mask, token_type_ids])"),Ue.forEach(t),J.forEach(t),me=d(P),A=s(P,"LI",{});var ye=a(A);ve=i(ye,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),j=s(ye,"CODE",{});var D=a(j);Ee=i(D,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),D.forEach(t),ye.forEach(t),P.forEach(t)},m(m,E){f(m,h,E),e(h,M),f(m,u,E),f(m,g,E),e(g,$),e($,_),e(g,T),e(g,X),e(X,I),f(m,W,E),f(m,x,E),e(x,z),e(x,O),e(O,K),e(x,ae),e(x,V),e(V,$e),e(x,ge),f(m,U,E),f(m,N,E),e(N,ne),f(m,re,E),f(m,F,E),e(F,C),e(C,ie),e(C,Q),e(Q,_e),e(C,le),e(C,B),e(B,xe),e(F,Te),e(F,q),e(q,Xe),e(q,G),e(G,oe),e(q,fe),e(q,Z),e(Z,Me),e(F,me),e(F,A),e(A,ve),e(A,j),e(j,Ee)},d(m){m&&t(h),m&&t(u),m&&t(g),m&&t(W),m&&t(x),m&&t(U),m&&t(N),m&&t(re),m&&t(F)}}}function Uf(R){let h,M,u,g,$;return{c(){h=n("p"),M=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),u=n("code"),g=r("Module"),$=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(_){h=s(_,"P",{});var T=a(h);M=i(T,"Although the recipe for forward pass needs to be defined within this function, one should call the "),u=s(T,"CODE",{});var X=a(u);g=i(X,"Module"),X.forEach(t),$=i(T,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
The epsilon to use in the layer normalization layers`,name:"layer_norm_epsilon"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/transfo_xl/configuration_transfo_xl.py#L29"}}),Yt=new Qe({props:{code:`from transformers import TransfoXLConfig, TransfoXLModel
...
Tuple of <code>tf.Tensor</code> (one for each layer) of shape <code>(batch_size, num_heads, sequence_length, sequence_length)</code>.</p>
<p>Attentions weights after the attention softmax, used to compute the weighted average in the self-attention
heads.`,name:"attentions"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/transfo_xl/modeling_tf_transfo_xl.py#L731"}}),lo=new Ge({}),co=new te({props:{name:"class transformers.TransfoXLModel",anchor:"transformers.TransfoXLModel",parameters:[{name:"config",val:""}],parametersDescription:[{anchor:"transformers.TransfoXLModel.config",description:`<strong>config</strong> (<a href="/docs/transformers/main/en/model_doc/transfo-xl#transformers.TransfoXLConfig">TransfoXLConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/main/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/transfo_xl/modeling_transfo_xl.py#L771"}}),po=new te({props:{name:"forward",anchor:"transformers.TransfoXLModel.forward",parameters:[{name:"input_ids",val:" = None"},{name:"mems",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],parametersDescription:[{anchor:"transformers.TransfoXLModel.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
...
Whether or not to return a <a href="/docs/transformers/main/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/transfo_xl/modeling_transfo_xl.py#L875",returnDescription:`
<p>A <a
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/main/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/transfo_xl/modeling_transfo_xl.py#L1013"}}),wo=new te({props:{name:"forward",anchor:"transformers.TransfoXLLMHeadModel.forward",parameters:[{name:"input_ids",val:" = None"},{name:"mems",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"labels",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],parametersDescription:[{anchor:"transformers.TransfoXLLMHeadModel.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/main/en/model_doc/transfo-xl#transformers.TransfoXLTokenizer">TransfoXLTokenizer</a>. See <a href="/docs/transformers/main/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/main/en/model_doc/wav2vec2_phoneme#transformers.Wav2Vec2PhonemeCTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
are ignored (masked), the loss is only computed for labels in <code>[0, ..., config.vocab_size]</code>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/transfo_xl/modeling_transfo_xl.py#L1065",returnDescription:`
<p>A <a
...
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/transfo_xl/modeling_transfo_xl.py#L1209",returnDescription:`
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/main/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/transfo_xl/modeling_tf_transfo_xl.py#L877"}}),St=new it({props:{$$slots:{default:[If]},$$scope:{ctx:R}}}),No=new te({props:{name:"call",anchor:"transformers.TFTransfoXLModel.call",parameters:[{name:"input_ids",val:" = None"},{name:"mems",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"},{name:"training",val:" = False"}],parametersDescription:[{anchor:"transformers.TFTransfoXLModel.call.input_ids",description:`<strong>input_ids</strong> (<code>tf.Tensor</code> or <code>Numpy array</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
...
behaviors between training and evaluation).`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/transfo_xl/modeling_tf_transfo_xl.py#L882",returnDescription:`
<p>A <a
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/main/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/transfo_xl/modeling_tf_transfo_xl.py#L933"}}),Ht=new it({props:{$$slots:{default:[Vf]},$$scope:{ctx:R}}}),Uo=new te({props:{name:"call",anchor:"transformers.TFTransfoXLLMHeadModel.call",parameters:[{name:"input_ids",val:" = None"},{name:"mems",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"},{name:"labels",val:" = None"},{name:"training",val:" = False"}],parametersDescription:[{anchor:"transformers.TFTransfoXLLMHeadModel.call.input_ids",description:`<strong>input_ids</strong> (<code>tf.Tensor</code> or <code>Numpy array</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/main/en/model_doc/bert#transformers.BertTokenizer">BertTokenizer</a>. See <a href="/docs/transformers/main/en/model_doc/wav2vec2_phoneme#transformers.Wav2Vec2PhonemeCTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
<a href="/docs/transformers/main/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> for details.</p>
...
Whether or not to use the model in training mode (some modules like dropout modules have different
behaviors between training and evaluation).`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/transfo_xl/modeling_tf_transfo_xl.py#L961",returnDescription:`
<p>A <a
...
Labels for computing the cross entropy classification loss. Indices should be in <code>[0, ..., config.vocab_size - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/transfo_xl/modeling_tf_transfo_xl.py#L1070",returnDescription:`
...
`),Gt=n("a"),Ra=r("transfo-xl-wt103"),Ka=r(" architecture."),Ga=l(),lt=n("p"),Ya=r("Configuration objects inherit from "),mn=n("a"),Qa=r("PretrainedConfig"),Za=r(` and can be used to control the model outputs. Read the
...
this superclass for more information regarding those methods.`),pr=l(),un=n("div"),v(oo.$$.fragment),Us=l(),ct=n("h2"),Et=n("a"),Wn=n("span"),v(no.$$.fragment),ur=l(),Vn=n("span"),gr=r("TransfoXL specific outputs"),Bs=l(),ft=n("div"),v(so.$$.fragment),_r=l(),Un=n("p"),Tr=r("Base class for model\u2019s outputs that may also contain a past key/values (to speed up sequential decoding)."),Rs=l(),mt=n("div"),v(ao.$$.fragment),vr=l(),Bn=n("p"),br=r("Base class for model\u2019s outputs that may also contain a past key/values (to speed up sequential decoding)."),Ks=l(),ht=n("div"),v(ro.$$.fragment),wr=l(),Rn=n("p"),yr=r("Base class for model\u2019s outputs that may also contain a past key/values (to speed up sequential decoding)."),Gs=l(),pt=n("div"),v(io.$$.fragment),Lr=l(),Kn=n("p"),kr=r("Base class for model\u2019s outputs that may also contain a past key/values (to speed up sequential decoding)."),Ys=l(),ut=n("h2"),Ft=n("a"),Gn=n("span"),v(lo.$$.fragment),$r=l(),Yn=n("span"),xr=r("TransfoXLModel"),Qs=l(),Fe=n("div"),v(co.$$.fragment),Xr=l(),Qn=n("p"),Mr=r("The bare Bert Model transformer outputting raw hidden-states without any specific head on top."),Er=l(),fo=n("p"),Fr=r("This model inherits from "),gn=n("a"),qr=r("PreTrainedModel"),Cr=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),zr=l(),mo=n("p"),Pr=r("This model is also a PyTorch "),ho=n("a"),jr=r("torch.nn.Module"),Or=r(` subclass.
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Ii=l(),Y=n("div"),v(Mo.$$.fragment),Wi=l(),bt=n("p"),Vi=r("The "),Ln=n("a"),Ui=r("TransfoXLForSequenceClassification"),Bi=r(" forward method, overrides the "),ms=n("code"),Ri=r("__call__"),Ki=r(" special method."),Gi=l(),v(jt.$$.fragment),Yi=l(),hs=n("p"),Qi=r("Example of single-label classification:"),Zi=l(),v(Eo.$$.fragment),Ji=l(),v(Fo.$$.fragment),el=l(),ps=n("p"),tl=r("Example of multi-label classification:"),ol=l(),v(qo.$$.fragment),nl=l(),v(Co.$$.fragment),oa=l(),wt=n("h2"),Ot=n("a"),us=n("span"),v(zo.$$.fragment),sl=l(),gs=n("span"),al=r("TFTransfoXLModel"),na=l(),pe=n("div"),v(Po.$$.fragment),rl=l(),_s=n("p"),il=r("The bare Bert Model transformer outputting raw hidden-states without any specific head on top."),ll=l(),jo=n("p"),dl=r("This model inherits from "),kn=n("a"),cl=r("TFPreTrainedModel"),fl=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
bpc/perplexity to 0.99 on enwiki8, 1.08 on text8, 18.3 on WikiText-103, 21.8 on One Billion Word, and 54.5 on Penn
Treebank (without finetuning). When trained only on WikiText-103, Transformer-XL manages to generate reasonably
coherent, novel text articles with thousands of tokens.`),Id.forEach(t),Dd.forEach(t),Te=d(o),q=s(o,"P",{});var Wd=a(q);Xe=i(Wd,"Tips:"),Wd.forEach(t),G=d(o),oe=s(o,"UL",{});var ma=a(oe);fe=s(ma,"LI",{});var Vd=a(fe);Z=i(Vd,`Transformer-XL uses relative sinusoidal positional embeddings. Padding can be done on the left or on the right. The
original implementation trains on SQuAD with padding on the left, therefore the padding defaults are set to left.`),Vd.forEach(t),Me=d(ma),me=s(ma,"LI",{});var Ud=a(me);A=i(Ud,"Transformer-XL is one of the few models that has no sequence length limit."),Ud.forEach(t),ma.forEach(t),ve=d(o),j=s(o,"P",{});var Cn=a(j);Ee=i(Cn,"This model was contributed by "),m=s(Cn,"A",{href:!0,rel:!0});var Bd=a(m);E=i(Bd,"thomwolf"),Bd.forEach(t),de=i(Cn,". The original code can be found "),be=s(Cn,"A",{href:!0,rel:!0});var Rd=a(be);Ve=i(Rd,"here"),Rd.forEach(t),H=i(Cn,"."),Cn.forEach(t),Ae=d(o),b(he.$$.fragment,o),He=d(o),P=s(o,"H2",{class:!0});var ha=a(P);S=s(ha,"A",{id:!0,class:!0,href:!0});var Kd=a(S);Ce=s(Kd,"SPAN",{});var Gd=a(Ce);b(we.$$.fragment,Gd),Gd.forEach(t),Kd.forEach(t),J=d(ha),ze=s(ha,"SPAN",{});var Yd=a(ze);Ue=i(Yd,"TransfoXLConfig"),Yd.forEach(t),ha.forEach(t),ye=d(o),D=s(o,"DIV",{class:!0});var Ze=a(D);b(Kt.$$.fragment,Ze),Da=d(Ze),Ye=s(Ze,"P",{});var Bt=a(Ye);Ia=i(Bt,"This is the configuration class to store the configuration of a "),cn=s(Bt,"A",{href:!0});var Qd=a(cn);Wa=i(Qd,"TransfoXLModel"),Qd.forEach(t),Va=i(Bt," or a "),fn=s(Bt,"A",{href:!0});var Zd=a(fn);Ua=i(Zd,"TFTransfoXLModel"),Zd.forEach(t),Ba=i(Bt,`. It is
used to instantiate a Transformer-XL model according to the specified arguments, defining the model architecture.
Instantiating a configuration with the defaults will yield a similar configuration to that of the TransfoXL
`),Gt=s(Bt,"A",{href:!0,rel:!0});var Jd=a(Gt);Ra=i(Jd,"transfo-xl-wt103"),Jd.forEach(t),Ka=i(Bt," architecture."),Bt.forEach(t),Ga=d(Ze),lt=s(Ze,"P",{});var zn=a(lt);Ya=i(zn,"Configuration objects inherit from "),mn=s(zn,"A",{href:!0});var ec=a(mn);Qa=i(ec,"PretrainedConfig"),ec.forEach(t),Za=i(zn,` and can be used to control the model outputs. Read the
documentation from `),hn=s(zn,"A",{href:!0});var tc=a(hn);Ja=i(tc,"PretrainedConfig"),tc.forEach(t),er=i(zn," for more information."),zn.forEach(t),tr=d(Ze),Hn=s(Ze,"P",{});var oc=a(Hn);or=i(oc,"Examples:"),oc.forEach(t),nr=d(Ze),b(Yt.$$.fragment,Ze),Ze.forEach(t),Ws=d(o),dt=s(o,"H2",{class:!0});var pa=a(dt);Mt=s(pa,"A",{id:!0,class:!0,href:!0});var nc=a(Mt);Dn=s(nc,"SPAN",{});var sc=a(Dn);b(Qt.$$.fragment,sc),sc.forEach(t),nc.forEach(t),sr=d(pa),In=s(pa,"SPAN",{});var ac=a(In);ar=i(ac,"TransfoXLTokenizer"),ac.forEach(t),pa.forEach(t),Vs=d(o),De=s(o,"DIV",{class:!0});var Rt=a(De);b(Zt.$$.fragment,Rt),rr=d(Rt),Jt=s(Rt,"P",{});var ua=a(Jt);ir=i(ua,"Construct a Transformer-XL tokenizer adapted from Vocab class in "),eo=s(ua,"A",{href:!0,rel:!0});var rc=a(eo);lr=i(rc,`the original
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Xa.forEach(t),ri=d(tt),je=s(tt,"DIV",{class:!0});var ot=a(je);b(wo.$$.fragment,ot),ii=d(ot),Tt=s(ot,"P",{});var jn=a(Tt);li=i(jn,"The "),vn=s(jn,"A",{href:!0});var qc=a(vn);di=i(qc,"TransfoXLLMHeadModel"),qc.forEach(t),ci=i(jn," forward method, overrides the "),ns=s(jn,"CODE",{});var Cc=a(ns);fi=i(Cc,"__call__"),Cc.forEach(t),mi=i(jn," special method."),jn.forEach(t),hi=d(ot),b(zt.$$.fragment,ot),pi=d(ot),ss=s(ot,"P",{});var zc=a(ss);ui=i(zc,"Example:"),zc.forEach(t),gi=d(ot),b(yo.$$.fragment,ot),ot.forEach(t),tt.forEach(t),ea=d(o),vt=s(o,"H2",{class:!0});var Ma=a(vt);Pt=s(Ma,"A",{id:!0,class:!0,href:!0});var Pc=a(Pt);as=s(Pc,"SPAN",{});var jc=a(as);b(Lo.$$.fragment,jc),jc.forEach(t),Pc.forEach(t),_i=d(Ma),rs=s(Ma,"SPAN",{});var Oc=a(rs);Ti=i(Oc,"TransfoXLForSequenceClassification"),Oc.forEach(t),Ma.forEach(t),ta=d(o),se=s(o,"DIV",{class:!0});var Ne=a(se);b(ko.$$.fragment,Ne),vi=d(Ne),is=s(Ne,"P",{});var Sc=a(is);bi=i(Sc,"The Transformer-XL Model transformer with a sequence classification head on top (linear layer)."),Sc.forEach(t),wi=d(Ne),bn=s(Ne,"P",{});var Nd=a(bn);wn=s(Nd,"A",{href:!0});var Nc=a(wn);yi=i(Nc,"TransfoXLForSequenceClassification"),Nc.forEach(t),Li=i(Nd,` uses the last token in order to do the classification, as other causal
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Fa.forEach(t),Ii=d(Ne),Y=s(Ne,"DIV",{class:!0});var ce=a(Y);b(Mo.$$.fragment,ce),Wi=d(ce),bt=s(ce,"P",{});var On=a(bt);Vi=i(On,"The "),Ln=s(On,"A",{href:!0});var Uc=a(Ln);Ui=i(Uc,"TransfoXLForSequenceClassification"),Uc.forEach(t),Bi=i(On," forward method, overrides the "),ms=s(On,"CODE",{});var Bc=a(ms);Ri=i(Bc,"__call__"),Bc.forEach(t),Ki=i(On," special method."),On.forEach(t),Gi=d(ce),b(jt.$$.fragment,ce),Yi=d(ce),hs=s(ce,"P",{});var Rc=a(hs);Qi=i(Rc,"Example of single-label classification:"),Rc.forEach(t),Zi=d(ce),b(Eo.$$.fragment,ce),Ji=d(ce),b(Fo.$$.fragment,ce),el=d(ce),ps=s(ce,"P",{});var Kc=a(ps);tl=i(Kc,"Example of multi-label classification:"),Kc.forEach(t),ol=d(ce),b(qo.$$.fragment,ce),nl=d(ce),b(Co.$$.fragment,ce),ce.forEach(t),Ne.forEach(t),oa=d(o),wt=s(o,"H2",{class:!0});var qa=a(wt);Ot=s(qa,"A",{id:!0,class:!0,href:!0});var Gc=a(Ot);us=s(Gc,"SPAN",{});var Yc=a(us);b(zo.$$.fragment,Yc),Yc.forEach(t),Gc.forEach(t),sl=d(qa),gs=s(qa,"SPAN",{});var Qc=a(gs);al=i(Qc,"TFTransfoXLModel"),Qc.forEach(t),qa.forEach(t),na=d(o),pe=s(o,"DIV",{class:!0});var Be=a(pe);b(Po.$$.fragment,Be),rl=d(Be),_s=s(Be,"P",{});var Zc=a(_s);il=i(Zc,"The bare Bert Model transformer outputting raw hidden-states without any specific head on top."),Zc.forEach(t),ll=d(Be),jo=s(Be,"P",{});var Ca=a(jo);dl=i(Ca,"This model inherits from "),kn=s(Ca,"A",{href:!0});var Jc=a(kn);cl=i(Jc,"TFPreTrainedModel"),Jc.forEach(t),fl=i(Ca,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Ca.forEach(t),ml=d(Be),Oo=s(Be,"P",{});var za=a(Oo);hl=i(za,"This model is also a "),So=s(za,"A",{href:!0,rel:!0});var ef=a(So);pl=i(ef,"tf.keras.Model"),ef.forEach(t),ul=i(za,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
