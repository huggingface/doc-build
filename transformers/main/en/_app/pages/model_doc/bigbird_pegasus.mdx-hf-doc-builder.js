import{S as ci,i as ui,s as pi,e as s,k as h,w as y,t as i,M as hi,c as a,d as t,m as g,a as r,x as w,h as d,b as m,G as e,g as b,y as k,q as B,o as T,B as $,v as gi,L as U}from"../../chunks/vendor-hf-doc-builder.js";import{T as $n}from"../../chunks/Tip-hf-doc-builder.js";import{D}from"../../chunks/Docstring-hf-doc-builder.js";import{C as V}from"../../chunks/CodeBlock-hf-doc-builder.js";import{I as Ne}from"../../chunks/IconCopyLink-hf-doc-builder.js";import{E as R}from"../../chunks/ExampleCodeBlock-hf-doc-builder.js";function mi(P){let l,_,c,u,v;return u=new V({props:{code:`from transformers import BigBirdPegasusConfig, BigBirdPegasusModel
...
<span class="hljs-number">0.69</span>`}}),{c(){y(l.$$.fragment)},l(c){w(l.$$.fragment,c)},m(c,u){k(l,c,u),_=!0},p:U,i(c){_||(B(l.$$.fragment,c),_=!0)},o(c){T(l.$$.fragment,c),_=!1},d(c){$(l,c)}}}function Bi(P){let l,_,c,u,v;return u=new V({props:{code:`import torch
from transformers import PegasusTokenizerFast, BigBirdPegasusForSequenceClassification
...
<span class="hljs-meta">... </span>)
<span class="hljs-meta">&gt;&gt;&gt; </span>loss = model(**inputs, labels=labels).loss
<span class="hljs-meta">&gt;&gt;&gt; </span>loss.backward()`}}),{c(){y(l.$$.fragment)},l(c){w(l.$$.fragment,c)},m(c,u){k(l,c,u),_=!0},p:U,i(c){_||(B(l.$$.fragment,c),_=!0)},o(c){T(l.$$.fragment,c),_=!1},d(c){$(l,c)}}}function $i(P){let l,_,c,u,v;return{c(){l=s("p"),_=i("Although the recipe for forward pass needs to be defined within this function, one should call the "),c=s("code"),u=i("Module"),v=i(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(n){l=a(n,"P",{});var p=r(l);_=d(p,"Although the recipe for forward pass needs to be defined within this function, one should call the "),c=a(p,"CODE",{});var z=r(c);u=d(z,"Module"),z.forEach(t),v=d(p,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-built_in">round</span>(loss.item(), <span class="hljs-number">2</span>)
<span class="hljs-number">3.96</span>`}}),{c(){y(l.$$.fragment)},l(c){w(l.$$.fragment,c)},m(c,u){k(l,c,u),_=!0},p:U,i(c){_||(B(l.$$.fragment,c),_=!0)},o(c){T(l.$$.fragment,c),_=!1},d(c){$(l,c)}}}function Fi(P){let l,_,c,u,v;return u=new V({props:{code:`from transformers import PegasusTokenizer, BigBirdPegasusForCausalLM
...
`}}),je=new R({props:{anchor:"transformers.BigBirdPegasusForCausalLM.forward.example",$$slots:{default:[Fi]},$$scope:{ctx:P}}}),{c(){l=s("meta"),_=h(),c=s("h1"),u=s("a"),v=s("span"),y(n.$$.fragment),p=h(),z=s("span"),Pn=i("BigBirdPegasus"),Ot=h(),J=s("h2"),ce=s("a"),Zo=s("span"),y(Ie.$$.fragment),qn=h(),Ko=s("span"),Fn=i("Overview"),Lt=h(),ue=s("p"),zn=i("The BigBird model was proposed in "),De=s("a"),xn=i("Big Bird: Transformers for Longer Sequences"),Cn=i(` by
...
summarization, compared to BERT or RoBERTa.`),Nt=h(),zo=s("p"),Mn=i("The abstract from the paper is the following:"),It=h(),xo=s("p"),Yo=s("em"),jn=i(`Transformers-based models, such as BERT, have been one of the most successful deep learning models for NLP.
...
`),Ke=s("a"),vs=i("google/bigbird-pegasus-large-arxiv"),ys=i(" architecture."),ws=h(),Y=s("p"),ks=i("Configuration objects inherit from "),jo=s("a"),Bs=i("PretrainedConfig"),Ts=i(` and can be used to control the model outputs. Read the
documentation from `),Eo=s("a"),$s=i("PretrainedConfig"),Ps=i(" for more information."),qs=h(),y(ge.$$.fragment),Rt=h(),X=s("h2"),me=s("a"),lt=s("span"),y(Ye.$$.fragment),Fs=h(),ct=s("span"),zs=i("BigBirdPegasusModel"),Ut=h(),O=s("div"),y(Xe.$$.fragment),xs=h(),eo=s("p"),Cs=i(`The bare BigBirdPegasus Model outputting raw hidden-states without any specific head on top.
...
library implements for all its model (such as downloading or saving, resizing the input embeddings etc.)`),ya=h(),go=s("p"),wa=i("This model is also a PyTorch "),mo=s("a"),ka=i("torch.nn.Module"),Ba=i(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Ta=h(),F=s("div"),y(fo.$$.fragment),$a=h(),se=s("p"),Pa=i("The "),Io=s("a"),qa=i("BigBirdPegasusForSequenceClassification"),Fa=i(" forward method, overrides the "),bt=s("code"),za=i("__call__"),xa=i(" special method."),Ca=h(),y(ke.$$.fragment),Ma=h(),y(Be.$$.fragment),ja=h(),y(Te.$$.fragment),Ea=h(),y($e.$$.fragment),Sa=h(),y(Pe.$$.fragment),Yt=h(),ae=s("h2"),qe=s("a"),vt=s("span"),y(_o.$$.fragment),Aa=h(),yt=s("span"),Oa=i("BigBirdPegasusForQuestionAnswering"),Xt=h(),C=s("div"),y(bo.$$.fragment),La=h(),re=s("p"),Na=i(`BigBirdPegasus Model with a span classification head on top for extractive question-answering tasks like SQuAD (a
linear layer on top of the hidden-states output to compute `),wt=s("code"),Ia=i("span start logits"),Da=i(" and "),kt=s("code"),Ga=i("span end logits"),Wa=i(")."),Qa=h(),vo=s("p"),Ha=i("This model inherits from "),Do=s("a"),Ra=i("PreTrainedModel"),Ua=i(`. Check the superclass documentation for the generic methods the
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Ya=h(),M=s("div"),y(ko.$$.fragment),Xa=h(),ie=s("p"),er=i("The "),Go=s("a"),or=i("BigBirdPegasusForQuestionAnswering"),tr=i(" forward method, overrides the "),Bt=s("code"),nr=i("__call__"),sr=i(" special method."),ar=h(),y(Fe.$$.fragment),rr=h(),y(ze.$$.fragment),ir=h(),y(xe.$$.fragment),en=h(),de=s("h2"),Ce=s("a"),Tt=s("span"),y(Bo.$$.fragment),dr=h(),$t=s("span"),lr=i("BigBirdPegasusForCausalLM"),on=h(),le=s("div"),y(To.$$.fragment),cr=h(),Me=s("div"),y($o.$$.fragment),ur=h(),y(je.$$.fragment),this.h()},l(o){const f=hi('[data-svelte="svelte-1phssyn"]',document.head);l=a(f,"META",{name:!0,content:!0}),f.forEach(t),_=g(o),c=a(o,"H1",{class:!0});var Po=r(c);u=a(Po,"A",{id:!0,class:!0,href:!0});var Pt=r(u);v=a(Pt,"SPAN",{});var qt=r(v);w(n.$$.fragment,qt),qt.forEach(t),Pt.forEach(t),p=g(Po),z=a(Po,"SPAN",{});var Ft=r(z);Pn=d(Ft,"BigBirdPegasus"),Ft.forEach(t),Po.forEach(t),Ot=g(o),J=a(o,"H2",{class:!0});var qo=r(J);ce=a(qo,"A",{id:!0,class:!0,href:!0});var zt=r(ce);Zo=a(zt,"SPAN",{});var xt=r(Zo);w(Ie.$$.fragment,xt),xt.forEach(t),zt.forEach(t),qn=g(qo),Ko=a(qo,"SPAN",{});var Ct=r(Ko);Fn=d(Ct,"Overview"),Ct.forEach(t),qo.forEach(t),Lt=g(o),ue=a(o,"P",{});var Fo=r(ue);zn=d(Fo,"The BigBird model was proposed in "),De=a(Fo,"A",{href:!0,rel:!0});var Mt=r(De);xn=d(Mt,"Big Bird: Transformers for Longer Sequences"),Mt.forEach(t),Cn=d(Fo,` by
Zaheer, Manzil and Guruganesh, Guru and Dubey, Kumar Avinava and Ainslie, Joshua and Alberti, Chris and Ontanon,
Santiago and Pham, Philip and Ravula, Anirudh and Wang, Qifan and Yang, Li and others. BigBird, is a sparse-attention
based transformer which extends Transformer based models, such as BERT to much longer sequences. In addition to sparse
attention, BigBird also applies global attention as well as random attention to the input sequence. Theoretically, it
...
library implements for all its model (such as downloading or saving, resizing the input embeddings etc.)`),_n.forEach(t),ya=g(W),go=a(W,"P",{});var bn=r(go);wa=d(bn,"This model is also a PyTorch "),mo=a(bn,"A",{href:!0,rel:!0});var Jr=r(mo);ka=d(Jr,"torch.nn.Module"),Jr.forEach(t),Ba=d(bn,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),bn.forEach(t),Ta=g(W),F=a(W,"DIV",{class:!0});var E=r(F);w(fo.$$.fragment,E),$a=g(E),se=a(E,"P",{});var Uo=r(se);Pa=d(Uo,"The "),Io=a(Uo,"A",{href:!0});var Zr=r(Io);qa=d(Zr,"BigBirdPegasusForSequenceClassification"),Zr.forEach(t),Fa=d(Uo," forward method, overrides the "),bt=a(Uo,"CODE",{});var Kr=r(bt);za=d(Kr,"__call__"),Kr.forEach(t),xa=d(Uo," special method."),Uo.forEach(t),Ca=g(E),w(ke.$$.fragment,E),Ma=g(E),w(Be.$$.fragment,E),ja=g(E),w(Te.$$.fragment,E),Ea=g(E),w($e.$$.fragment,E),Sa=g(E),w(Pe.$$.fragment,E),E.forEach(t),W.forEach(t),Yt=g(o),ae=a(o,"H2",{class:!0});var vn=r(ae);qe=a(vn,"A",{id:!0,class:!0,href:!0});var Yr=r(qe);vt=a(Yr,"SPAN",{});var Xr=r(vt);w(_o.$$.fragment,Xr),Xr.forEach(t),Yr.forEach(t),Aa=g(vn),yt=a(vn,"SPAN",{});var ei=r(yt);Oa=d(ei,"BigBirdPegasusForQuestionAnswering"),ei.forEach(t),vn.forEach(t),Xt=g(o),C=a(o,"DIV",{class:!0});var Q=r(C);w(bo.$$.fragment,Q),La=g(Q),re=a(Q,"P",{});var Vo=r(re);Na=d(Vo,`BigBirdPegasus Model with a span classification head on top for extractive question-answering tasks like SQuAD (a
linear layer on top of the hidden-states output to compute `),wt=a(Vo,"CODE",{});var oi=r(wt);Ia=d(oi,"span start logits"),oi.forEach(t),Da=d(Vo," and "),kt=a(Vo,"CODE",{});var ti=r(kt);Ga=d(ti,"span end logits"),ti.forEach(t),Wa=d(Vo,")."),Vo.forEach(t),Qa=g(Q),vo=a(Q,"P",{});var yn=r(vo);Ha=d(yn,"This model inherits from "),Do=a(yn,"A",{href:!0});var ni=r(Do);Ra=d(ni,"PreTrainedModel"),ni.forEach(t),Ua=d(yn,`. Check the superclass documentation for the generic methods the
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),wn.forEach(t),Ya=g(Q),M=a(Q,"DIV",{class:!0});var H=r(M);w(ko.$$.fragment,H),Xa=g(H),ie=a(H,"P",{});var Jo=r(ie);er=d(Jo,"The "),Go=a(Jo,"A",{href:!0});var ai=r(Go);or=d(ai,"BigBirdPegasusForQuestionAnswering"),ai.forEach(t),tr=d(Jo," forward method, overrides the "),Bt=a(Jo,"CODE",{});var ri=r(Bt);nr=d(ri,"__call__"),ri.forEach(t),sr=d(Jo," special method."),Jo.forEach(t),ar=g(H),w(Fe.$$.fragment,H),rr=g(H),w(ze.$$.fragment,H),ir=g(H),w(xe.$$.fragment,H),H.forEach(t),Q.forEach(t),en=g(o),de=a(o,"H2",{class:!0});var kn=r(de);Ce=a(kn,"A",{id:!0,class:!0,href:!0});var ii=r(Ce);Tt=a(ii,"SPAN",{});var di=r(Tt);w(Bo.$$.fragment,di),di.forEach(t),ii.forEach(t),dr=g(kn),$t=a(kn,"SPAN",{});var li=r($t);lr=d(li,"BigBirdPegasusForCausalLM"),li.forEach(t),kn.forEach(t),on=g(o),le=a(o,"DIV",{class:!0});var Bn=r(le);w(To.$$.fragment,Bn),cr=g(Bn),Me=a(Bn,"DIV",{class:!0});var Tn=r(Me);w($o.$$.fragment,Tn),ur=g(Tn),w(je.$$.fragment,Tn),Tn.forEach(t),Bn.forEach(t),this.h()},h(){m(l,"name","hf:doc:metadata"),m(l,"content",JSON.stringify(xi)),m(u,"id","bigbirdpegasus"),m(u,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),m(u,"href","#bigbirdpegasus"),m(c,"class","relative group"),m(ce,"id","overview"),m(ce,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),m(ce,"href","#overview"),m(J,"class","relative group"),m(De,"href","https://arxiv.org/abs/2007.14062"),m(De,"rel","nofollow"),m(We,"href","https://huggingface.co/blog/big-bird"),m(We,"rel","nofollow"),m(Ue,"href","https://github.com/huggingface/transformers/blob/main/src/transformers/models/pegasus/tokenization_pegasus.py"),m(Ue,"rel","nofollow"),m(Ve,"href","https://github.com/google-research/bigbird"),m(Ve,"rel","nofollow"),m(he,"id","transformers.BigBirdPegasusConfig"),m(he,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),m(he,"href","#transformers.BigBirdPegasusConfig"),m(Z,"class","relative group"),m(Mo,"href","/docs/transformers/main/en/model_doc/bigbird_pegasus#transformers.BigBirdPegasusModel"),m(Ke,"href","https://huggingface.co/google/bigbird-pegasus-large-arxiv"),m(Ke,"rel","nofollow"),m(jo,"href","/docs/transformers/main/en/main_classes/configuration#transformers.PretrainedConfig"),m(Eo,"href","/docs/transformers/main/en/main_classes/configuration#transformers.PretrainedConfig"),m(A,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),m(me,"id","transformers.BigBirdPegasusModel"),m(me,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),m(me,"href","#transformers.BigBirdPegasusModel"),m(X,"class","relative group"),m(So,"href","/docs/transformers/main/en/main_classes/model#transformers.PreTrainedModel"),m(to,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),m(to,"rel","nofollow"),m(Ao,"href","/docs/transformers/main/en/model_doc/bigbird_pegasus#transformers.BigBirdPegasusModel"),m(N,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),m(O,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),m(be,"id","transformers.BigBirdPegasusForConditionalGeneration"),m(be,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),m(be,"href","#transformers.BigBirdPegasusForConditionalGeneration"),m(oe,"class","relative group"),m(Oo,"href","/docs/transformers/main/en/main_classes/model#transformers.PreTrainedModel"),m(lo,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),m(lo,"rel","nofollow"),m(Lo,"href","/docs/transformers/main/en/model_doc/bigbird_pegasus#transformers.BigBirdPegasusForConditionalGeneration"),m(I,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),m(L,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),m(we,"id","transformers.BigBirdPegasusForSequenceClassification"),m(we,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),m(we,"href","#transformers.BigBirdPegasusForSequenceClassification"),m(ne,"class","relative group"),m(No,"href","/docs/transformers/main/en/main_classes/model#transformers.PreTrainedModel"),m(mo,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),m(mo,"rel","nofollow"),m(Io,"href","/docs/transformers/main/en/model_doc/bigbird_pegasus#transformers.BigBirdPegasusForSequenceClassification"),m(F,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),m(x,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),m(qe,"id","transformers.BigBirdPegasusForQuestionAnswering"),m(qe,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),m(qe,"href","#transformers.BigBirdPegasusForQuestionAnswering"),m(ae,"class","relative group"),m(Do,"href","/docs/transformers/main/en/main_classes/model#transformers.PreTrainedModel"),m(wo,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),m(wo,"rel","nofollow"),m(Go,"href","/docs/transformers/main/en/model_doc/bigbird_pegasus#transformers.BigBirdPegasusForQuestionAnswering"),m(M,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),m(C,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),m(Ce,"id","transformers.BigBirdPegasusForCausalLM"),m(Ce,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),m(Ce,"href","#transformers.BigBirdPegasusForCausalLM"),m(de,"class","relative group"),m(Me,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),m(le,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8")},m(o,f){e(document.head,l),b(o,_,f),b(o,c,f),e(c,u),e(u,v),k(n,v,null),e(c,p),e(c,z),e(z,Pn),b(o,Ot,f),b(o,J,f),e(J,ce),e(ce,Zo),k(Ie,Zo,null),e(J,qn),e(J,Ko),e(Ko,Fn),b(o,Lt,f),b(o,ue,f),e(ue,zn),e(ue,De),e(De,xn),e(ue,Cn),b(o,Nt,f),b(o,zo,f),e(zo,Mn),b(o,It,f),b(o,xo,f),e(xo,Yo),e(Yo,jn),b(o,Dt,f),b(o,Co,f),e(Co,En),b(o,Gt,f),b(o,q,f),e(q,Ge),e(Ge,Sn),e(Ge,We),e(We,An),e(Ge,On),e(q,Ln),e(q,S),e(S,Nn),e(S,Xo),e(Xo,In),e(S,Dn),e(S,et),e(et,Gn),e(S,Wn),e(S,ot),e(ot,Qn),e(S,Hn),e(S,tt),e(tt,Rn),e(S,Un),e(q,Vn),e(q,nt),e(nt,Jn),e(q,Zn),e(q,st),e(st,Kn),e(q,Yn),e(q,Qe),e(Qe,Xn),e(Qe,at),e(at,es),e(Qe,os),e(q,ts),e(q,He),e(He,ns),e(He,rt),e(rt,ss),e(He,as),e(q,rs),e(q,Re),e(Re,is),e(Re,Ue),e(Ue,ds),e(Re,ls),b(o,Wt,f),b(o,pe,f),e(pe,cs),e(pe,Ve),e(Ve,us),e(pe,ps),b(o,Qt,f),b(o,Z,f),e(Z,he),e(he,it),k(Je,it,null),e(Z,hs),e(Z,dt),e(dt,gs),b(o,Ht,f),b(o,A,f),k(Ze,A,null),e(A,ms),e(A,K),e(K,fs),e(K,Mo),e(Mo,_s),e(K,bs),e(K,Ke),e(Ke,vs),e(K,ys),e(A,ws),e(A,Y),e(Y,ks),e(Y,jo),e(jo,Bs),e(Y,Ts),e(Y,Eo),e(Eo,$s),e(Y,Ps),e(A,qs),k(ge,A,null),b(o,Rt,f),b(o,X,f),e(X,me),e(me,lt),k(Ye,lt,null),e(X,Fs),e(X,ct),e(ct,zs),b(o,Ut,f),b(o,O,f),k(Xe,O,null),e(O,xs),e(O,eo),e(eo,Cs),e(eo,So),e(So,Ms),e(eo,js),e(O,Es),e(O,oo),e(oo,Ss),e(oo,to),e(to,As),e(oo,Os),e(O,Ls),e(O,N),k(no,N,null),e(N,Ns),e(N,ee),e(ee,Is),e(ee,Ao),e(Ao,Ds),e(ee,Gs),e(ee,ut),e(ut,Ws),e(ee,Qs),e(N,Hs),k(fe,N,null),e(N,Rs),k(_e,N,null),b(o,Vt,f),b(o,oe,f),e(oe,be),e(be,pt),k(so,pt,null),e(oe,Us),e(oe,ht),e(ht,Vs),b(o,Jt,f),b(o,L,f),k(ao,L,null),e(L,Js),e(L,ro),e(ro,Zs),e(ro,Oo),e(Oo,Ks),e(ro,Ys),e(L,Xs),e(L,io),e(io,ea),e(io,lo),e(lo,oa),e(io,ta),e(L,na),e(L,I),k(co,I,null),e(I,sa),e(I,te),e(te,aa),e(te,Lo),e(Lo,ra),e(te,ia),e(te,gt),e(gt,da),e(te,la),e(I,ca),k(ve,I,null),e(I,ua),k(ye,I,null),b(o,Zt,f),b(o,ne,f),e(ne,we),e(we,mt),k(uo,mt,null),e(ne,pa),e(ne,ft),e(ft,ha),b(o,Kt,f),b(o,x,f),k(po,x,null),e(x,ga),e(x,_t),e(_t,ma),e(x,fa),e(x,ho),e(ho,_a),e(ho,No),e(No,ba),e(ho,va),e(x,ya),e(x,go),e(go,wa),e(go,mo),e(mo,ka),e(go,Ba),e(x,Ta),e(x,F),k(fo,F,null),e(F,$a),e(F,se),e(se,Pa),e(se,Io),e(Io,qa),e(se,Fa),e(se,bt),e(bt,za),e(se,xa),e(F,Ca),k(ke,F,null),e(F,Ma),k(Be,F,null),e(F,ja),k(Te,F,null),e(F,Ea),k($e,F,null),e(F,Sa),k(Pe,F,null),b(o,Yt,f),b(o,ae,f),e(ae,qe),e(qe,vt),k(_o,vt,null),e(ae,Aa),e(ae,yt),e(yt,Oa),b(o,Xt,f),b(o,C,f),k(bo,C,null),e(C,La),e(C,re),e(re,Na),e(re,wt),e(wt,Ia),e(re,Da),e(re,kt),e(kt,Ga),e(re,Wa),e(C,Qa),e(C,vo),e(vo,Ha),e(vo,Do),e(Do,Ra),e(vo,Ua),e(C,Va),e(C,yo),e(yo,Ja),e(yo,wo),e(wo,Za),e(yo,Ka),e(C,Ya),e(C,M),k(ko,M,null),e(M,Xa),e(M,ie),e(ie,er),e(ie,Go),e(Go,or),e(ie,tr),e(ie,Bt),e(Bt,nr),e(ie,sr),e(M,ar),k(Fe,M,null),e(M,rr),k(ze,M,null),e(M,ir),k(xe,M,null),b(o,en,f),b(o,de,f),e(de,Ce),e(Ce,Tt),k(Bo,Tt,null),e(de,dr),e(de,$t),e($t,lr),b(o,on,f),b(o,le,f),k(To,le,null),e(le,cr),e(le,Me),k($o,Me,null),e(Me,ur),k(je,Me,null),tn=!0},p(o,[f]){const Po={};f&2&&(Po.$$scope={dirty:f,ctx:o}),ge.$set(Po);const Pt={};f&2&&(Pt.$$scope={dirty:f,ctx:o}),fe.$set(Pt);const qt={};f&2&&(qt.$$scope={dirty:f,ctx:o}),_e.$set(qt);const Ft={};f&2&&(Ft.$$scope={dirty:f,ctx:o}),ve.$set(Ft);const qo={};f&2&&(qo.$$scope={dirty:f,ctx:o}),ye.$set(qo);const zt={};f&2&&(zt.$$scope={dirty:f,ctx:o}),ke.$set(zt);const xt={};f&2&&(xt.$$scope={dirty:f,ctx:o}),Be.$set(xt);const Ct={};f&2&&(Ct.$$scope={dirty:f,ctx:o}),Te.$set(Ct);const Fo={};f&2&&(Fo.$$scope={dirty:f,ctx:o}),$e.$set(Fo);const Mt={};f&2&&(Mt.$$scope={dirty:f,ctx:o}),Pe.$set(Mt);const jt={};f&2&&(jt.$$scope={dirty:f,ctx:o}),Fe.$set(jt);const Et={};f&2&&(Et.$$scope={dirty:f,ctx:o}),ze.$set(Et);const St={};f&2&&(St.$$scope={dirty:f,ctx:o}),xe.$set(St);const At={};f&2&&(At.$$scope={dirty:f,ctx:o}),je.$set(At)},i(o){tn||(B(n.$$.fragment,o),B(Ie.$$.fragment,o),B(Je.$$.fragment,o),B(Ze.$$.fragment,o),B(ge.$$.fragment,o),B(Ye.$$.fragment,o),B(Xe.$$.fragment,o),B(no.$$.fragment,o),B(fe.$$.fragment,o),B(_e.$$.fragment,o),B(so.$$.fragment,o),B(ao.$$.fragment,o),B(co.$$.fragment,o),B(ve.$$.fragment,o),B(ye.$$.fragment,o),B(uo.$$.fragment,o),B(po.$$.fragment,o),B(fo.$$.fragment,o),B(ke.$$.fragment,o),B(Be.$$.fragment,o),B(Te.$$.fragment,o),B($e.$$.fragment,o),B(Pe.$$.fragment,o),B(_o.$$.fragment,o),B(bo.$$.fragment,o),B(ko.$$.fragment,o),B(Fe.$$.fragment,o),B(ze.$$.fragment,o),B(xe.$$.fragment,o),B(Bo.$$.fragment,o),B(To.$$.fragment,o),B($o.$$.fragment,o),B(je.$$.fragment,o),tn=!0)},o(o){T(n.$$.fragment,o),T(Ie.$$.fragment,o),T(Je.$$.fragment,o),T(Ze.$$.fragment,o),T(ge.$$.fragment,o),T(Ye.$$.fragment,o),T(Xe.$$.fragment,o),T(no.$$.fragment,o),T(fe.$$.fragment,o),T(_e.$$.fragment,o),T(so.$$.fragment,o),T(ao.$$.fragment,o),T(co.$$.fragment,o),T(ve.$$.fragment,o),T(ye.$$.fragment,o),T(uo.$$.fragment,o),T(po.$$.fragment,o),T(fo.$$.fragment,o),T(ke.$$.fragment,o),T(Be.$$.fragment,o),T(Te.$$.fragment,o),T($e.$$.fragment,o),T(Pe.$$.fragment,o),T(_o.$$.fragment,o),T(bo.$$.fragment,o),T(ko.$$.fragment,o),T(Fe.$$.fragment,o),T(ze.$$.fragment,o),T(xe.$$.fragment,o),T(Bo.$$.fragment,o),T(To.$$.fragment,o),T($o.$$.fragment,o),T(je.$$.fragment,o),tn=!1},d(o){t(l),o&&t(_),o&&t(c),$(n),o&&t(Ot),o&&t(J),$(Ie),o&&t(Lt),o&&t(ue),o&&t(Nt),o&&t(zo),o&&t(It),o&&t(xo),o&&t(Dt),o&&t(Co),o&&t(Gt),o&&t(q),o&&t(Wt),o&&t(pe),o&&t(Qt),o&&t(Z),$(Je),o&&t(Ht),o&&t(A),$(Ze),$(ge),o&&t(Rt),o&&t(X),$(Ye),o&&t(Ut),o&&t(O),$(Xe),$(no),$(fe),$(_e),o&&t(Vt),o&&t(oe),$(so),o&&t(Jt),o&&t(L),$(ao),$(co),$(ve),$(ye),o&&t(Zt),o&&t(ne),$(uo),o&&t(Kt),o&&t(x),$(po),$(fo),$(ke),$(Be),$(Te),$($e),$(Pe),o&&t(Yt),o&&t(ae),$(_o),o&&t(Xt),o&&t(C),$(bo),$(ko),$(Fe),$(ze),$(xe),o&&t(en),o&&t(de),$(Bo),o&&t(on),o&&t(le),$(To),$($o),$(je)}}}const xi={local:"bigbirdpegasus",sections:[{local:"overview",title:"Overview"},{local:"transformers.BigBirdPegasusConfig",title:"BigBirdPegasusConfig"},{local:"transformers.BigBirdPegasusModel",title:"BigBirdPegasusModel"},{local:"transformers.BigBirdPegasusForConditionalGeneration",title:"BigBirdPegasusForConditionalGeneration"},{local:"transformers.BigBirdPegasusForSequenceClassification",title:"BigBirdPegasusForSequenceClassification"},{local:"transformers.BigBirdPegasusForQuestionAnswering",title:"BigBirdPegasusForQuestionAnswering"},{local:"transformers.BigBirdPegasusForCausalLM",title:"BigBirdPegasusForCausalLM"}],title:"BigBirdPegasus"};function Ci(P){return gi(()=>{new URLSearchParams(window.location.search).get("fw")}),[]}class Li extends ci{constructor(l){super();ui(this,l,Ci,zi,pi,{})}}export{Li as default,xi as metadata};
