import{S as Hu,i as Ku,s as Vu,e as n,k as l,w as f,t as r,M as Qu,c as a,d as o,m as i,a as s,x as _,h as d,b as c,F as e,g as p,y as g,q as b,o as k,B as y,v as Ju}from"../../chunks/vendor-6b77c823.js";import{T as xn}from"../../chunks/Tip-39098574.js";import{D as M}from"../../chunks/Docstring-abef54e3.js";import{C as ro}from"../../chunks/CodeBlock-3a8b25a8.js";import{I as Fe}from"../../chunks/IconCopyLink-7a11ce68.js";function Xu(Y){let h,z,v,T,B;return{c(){h=n("p"),z=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),v=n("code"),T=r("Module"),B=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(S){h=a(S,"P",{});var w=s(h);z=d(w,"Although the recipe for forward pass needs to be defined within this function, one should call the "),v=a(w,"CODE",{});var q=s(v);T=d(q,"Module"),q.forEach(o),B=d(w,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),w.forEach(o)},m(S,w){p(S,h,w),e(h,z),e(h,v),e(v,T),e(h,B)},d(S){S&&o(h)}}}function Yu(Y){let h,z,v,T,B;return{c(){h=n("p"),z=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),v=n("code"),T=r("Module"),B=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(S){h=a(S,"P",{});var w=s(h);z=d(w,"Although the recipe for forward pass needs to be defined within this function, one should call the "),v=a(w,"CODE",{});var q=s(v);T=d(q,"Module"),q.forEach(o),B=d(w,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),w.forEach(o)},m(S,w){p(S,h,w),e(h,z),e(h,v),e(v,T),e(h,B)},d(S){S&&o(h)}}}function Zu(Y){let h,z,v,T,B,S,w,q,Ce,ue,x,je,U,Oe,Pe,W,Le,Ne,K,V,Ie,Z,C,P,fe,ae,$e,Q,A,Te,se,L,we,re,Ee,ee,de,le,Ae,J,Me,R,De;return{c(){h=n("p"),z=r("TF 2.0 models accepts two formats as inputs:"),v=l(),T=n("ul"),B=n("li"),S=r("having all inputs as keyword arguments (like PyTorch models), or"),w=l(),q=n("li"),Ce=r("having all inputs as a list, tuple or dict in the first positional arguments."),ue=l(),x=n("p"),je=r("This second option is useful when using "),U=n("code"),Oe=r("tf.keras.Model.fit"),Pe=r(` method which currently requires having all the
...
`),R=a(Be,"CODE",{});var xe=s(R);De=d(xe,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),xe.forEach(o),Be.forEach(o),X.forEach(o)},m(u,F){p(u,h,F),e(h,z),p(u,v,F),p(u,T,F),e(T,B),e(B,S),e(T,w),e(T,q),e(q,Ce),p(u,ue,F),p(u,x,F),e(x,je),e(x,U),e(U,Oe),e(x,Pe),e(x,W),e(W,Le),e(x,Ne),p(u,K,F),p(u,V,F),e(V,Ie),p(u,Z,F),p(u,C,F),e(C,P),e(P,fe),e(P,ae),e(ae,$e),e(P,Q),e(P,A),e(A,Te),e(C,se),e(C,L),e(L,we),e(L,re),e(re,Ee),e(L,ee),e(L,de),e(de,le),e(C,Ae),e(C,J),e(J,Me),e(J,R),e(R,De)},d(u){u&&o(h),u&&o(v),u&&o(T),u&&o(ue),u&&o(x),u&&o(K),u&&o(V),u&&o(Z),u&&o(C)}}}function ef(Y){let h,z,v,T,B;return{c(){h=n("p"),z=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),v=n("code"),T=r("Module"),B=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(S){h=a(S,"P",{});var w=s(h);z=d(w,"Although the recipe for forward pass needs to be defined within this function, one should call the "),v=a(w,"CODE",{});var q=s(v);T=d(q,"Module"),q.forEach(o),B=d(w,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),w.forEach(o)},m(S,w){p(S,h,w),e(h,z),e(h,v),e(v,T),e(h,B)},d(S){S&&o(h)}}}function of(Y){let h,z,v,T,B,S,w,q,Ce,ue,x,je,U,Oe,Pe,W,Le,Ne,K,V,Ie,Z,C,P,fe,ae,$e,Q,A,Te,se,L,we,re,Ee,ee,de,le,Ae,J,Me,R,De;return{c(){h=n("p"),z=r("TF 2.0 models accepts two formats as inputs:"),v=l(),T=n("ul"),B=n("li"),S=r("having all inputs as keyword arguments (like PyTorch models), or"),w=l(),q=n("li"),Ce=r("having all inputs as a list, tuple or dict in the first positional arguments."),ue=l(),x=n("p"),je=r("This second option is useful when using "),U=n("code"),Oe=r("tf.keras.Model.fit"),Pe=r(` method which currently requires having all the
tensors in the first argument of the model call function: `),W=n("code"),Le=r("model(inputs)"),Ne=r("."),K=l(),V=n("p"),Ie=r(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),Z=l(),C=n("ul"),P=n("li"),fe=r("a single Tensor with "),ae=n("code"),$e=r("input_ids"),Q=r(" only and nothing else: "),A=n("code"),Te=r("model(input_ids)"),se=l(),L=n("li"),we=r(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),re=n("code"),Ee=r("model([input_ids, attention_mask])"),ee=r(" or "),de=n("code"),le=r("model([input_ids, attention_mask, token_type_ids])"),Ae=l(),J=n("li"),Me=r(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),R=n("code"),De=r('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(u){h=a(u,"P",{});var F=s(h);z=d(F,"TF 2.0 models accepts two formats as inputs:"),F.forEach(o),v=i(u),T=a(u,"UL",{});var ie=s(T);B=a(ie,"LI",{});var lo=s(B);S=d(lo,"having all inputs as keyword arguments (like PyTorch models), or"),lo.forEach(o),w=i(ie),q=a(ie,"LI",{});var Re=s(q);Ce=d(Re,"having all inputs as a list, tuple or dict in the first positional arguments."),Re.forEach(o),ie.forEach(o),ue=i(u),x=a(u,"P",{});var j=s(x);je=d(j,"This second option is useful when using "),U=a(j,"CODE",{});var io=s(U);Oe=d(io,"tf.keras.Model.fit"),io.forEach(o),Pe=d(j,` method which currently requires having all the
...
first positional argument :`),co.forEach(o),Z=i(u),C=a(u,"UL",{});var X=s(C);P=a(X,"LI",{});var D=s(P);fe=d(D,"a single Tensor with "),ae=a(D,"CODE",{});var po=s(ae);$e=d(po,"input_ids"),po.forEach(o),Q=d(D," only and nothing else: "),A=a(D,"CODE",{});var mo=s(A);Te=d(mo,"model(input_ids)"),mo.forEach(o),D.forEach(o),se=i(X),L=a(X,"LI",{});var oe=s(L);we=d(oe,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),re=a(oe,"CODE",{});var ce=s(re);Ee=d(ce,"model([input_ids, attention_mask])"),ce.forEach(o),ee=d(oe," or "),de=a(oe,"CODE",{});var _e=s(de);le=d(_e,"model([input_ids, attention_mask, token_type_ids])"),_e.forEach(o),oe.forEach(o),Ae=i(X),J=a(X,"LI",{});var Be=s(J);Me=d(Be,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),R=a(Be,"CODE",{});var xe=s(R);De=d(xe,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),xe.forEach(o),Be.forEach(o),X.forEach(o)},m(u,F){p(u,h,F),e(h,z),p(u,v,F),p(u,T,F),e(T,B),e(B,S),e(T,w),e(T,q),e(q,Ce),p(u,ue,F),p(u,x,F),e(x,je),e(x,U),e(U,Oe),e(x,Pe),e(x,W),e(W,Le),e(x,Ne),p(u,K,F),p(u,V,F),e(V,Ie),p(u,Z,F),p(u,C,F),e(C,P),e(P,fe),e(P,ae),e(ae,$e),e(P,Q),e(P,A),e(A,Te),e(C,se),e(C,L),e(L,we),e(L,re),e(re,Ee),e(L,ee),e(L,de),e(de,le),e(C,Ae),e(C,J),e(J,Me),e(J,R),e(R,De)},d(u){u&&o(h),u&&o(v),u&&o(T),u&&o(ue),u&&o(x),u&&o(K),u&&o(V),u&&o(Z),u&&o(C)}}}function tf(Y){let h,z,v,T,B;return{c(){h=n("p"),z=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),v=n("code"),T=r("Module"),B=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(S){h=a(S,"P",{});var w=s(h);z=d(w,"Although the recipe for forward pass needs to be defined within this function, one should call the "),v=a(w,"CODE",{});var q=s(v);T=d(q,"Module"),q.forEach(o),B=d(w,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),w.forEach(o)},m(S,w){p(S,h,w),e(h,z),e(h,v),e(v,T),e(h,B)},d(S){S&&o(h)}}}function nf(Y){let h,z,v,T,B;return{c(){h=n("p"),z=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),v=n("code"),T=r("Module"),B=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(S){h=a(S,"P",{});var w=s(h);z=d(w,"Although the recipe for forward pass needs to be defined within this function, one should call the "),v=a(w,"CODE",{});var q=s(v);T=d(q,"Module"),q.forEach(o),B=d(w,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),w.forEach(o)},m(S,w){p(S,h,w),e(h,z),e(h,v),e(v,T),e(h,B)},d(S){S&&o(h)}}}function af(Y){let h,z,v,T,B,S,w,q,Ce,ue,x,je,U,Oe,Pe,W,Le,Ne,K,V,Ie,Z,C,P,fe,ae,$e,Q,A,Te,se,L,we,re,Ee,ee,de,le,Ae,J,Me,R,De,u,F,ie,lo,Re,j,io,Se,co,X,D,po,mo,oe,ce,_e,Be,xe,md,la,hd,ur,pe,ot,ud,ho,fd,zn,_d,gd,tt,bd,kd,yd,uo,vd,qn,Td,wd,Fn,Sd,Bd,xd,ia,zd,qd,nt,fr,fo,Eo,ca,at,Fd,pa,$d,_r,G,st,Ed,ma,Md,Cd,rt,jd,$n,Od,Pd,Ld,He,dt,Nd,ha,Id,Ad,ua,Dd,Gd,Mo,lt,Ud,_o,Wd,fa,Rd,Hd,_a,Kd,Vd,Qd,Ke,it,Jd,En,Xd,Mn,Yd,Zd,ga,el,ol,Cn,ct,gr,go,Co,ba,pt,tl,ka,nl,br,Ge,mt,al,ht,sl,ya,rl,dl,ll,jo,ut,il,va,cl,kr,bo,Oo,Ta,ft,pl,wa,ml,yr,ze,_t,hl,gt,ul,jn,fl,_l,gl,bt,bl,kt,kl,yl,vl,ge,yt,Tl,ko,wl,On,Sl,Bl,Sa,xl,zl,ql,Po,Fl,Ba,$l,El,vt,vr,yo,Lo,xa,Tt,Ml,za,Cl,Tr,qe,wt,jl,St,Ol,Pn,Pl,Ll,Nl,Bt,Il,xt,Al,Dl,Gl,be,zt,Ul,vo,Wl,Ln,Rl,Hl,qa,Kl,Vl,Ql,No,Jl,Fa,Xl,Yl,qt,wr,To,Io,$a,Ft,Zl,Ea,ei,Sr,wo,$t,oi,Ve,Et,ti,Ma,ni,ai,Mt,Br,So,Ao,Ca,Ct,si,ja,ri,xr,me,jt,di,Ot,li,Nn,ii,ci,pi,Pt,mi,Lt,hi,ui,fi,Do,_i,ke,Nt,gi,Bo,bi,In,ki,yi,Oa,vi,Ti,wi,Go,Si,Pa,Bi,xi,It,zr,xo,Uo,La,At,zi,Na,qi,qr,he,Dt,Fi,Gt,$i,An,Ei,Mi,Ci,Ut,ji,Wt,Oi,Pi,Li,Wo,Ni,O,Rt,Ii,zo,Ai,Dn,Di,Gi,Ia,Ui,Wi,Ri,Ro,Hi,Aa,Ki,Vi,Da,Ga,Ua,Wa,Qi,Ji,Ra,Ha,Ka,Va,Xi,Yi,Qa,Ja,Xa,Ya,Zi,ec,Za,es,os,Ht,oc,ts,tc,nc,ac,ns,as,ss,rs,sc,Fr,qo,Ho,ds,Kt,rc,ls,dc,$r,N,Vt,lc,Qt,ic,Gn,cc,pc,mc,Jt,hc,Xt,uc,fc,_c,is,gc,bc,Ue,cs,Yt,kc,yc,ps,Zt,vc,Tc,ms,en,wc,Sc,hs,on,Bc,xc,Qe,tn,zc,us,qc,Fc,nn,$c,Je,an,Ec,fs,Mc,Cc,sn,jc,Xe,rn,Oc,_s,Pc,Lc,dn,Er,Fo,Ko,gs,ln,Nc,bs,Ic,Mr,I,cn,Ac,pn,Dc,Un,Gc,Uc,Wc,mn,Rc,hn,Hc,Kc,Vc,ks,Qc,Jc,We,ys,un,Xc,Yc,vs,fn,Zc,ep,Ts,_n,op,tp,ws,gn,np,ap,$,bn,sp,$o,rp,Ss,dp,lp,Bs,ip,cp,pp,Vo,mp,xs,hp,up,zs,qs,Fs,$s,fp,_p,Es,Ms,Cs,js,gp,bp,Os,Ps,Ls,Ns,kp,yp,Is,As,kn,Qo,Jo,Ds,yn,vp,Gs,Tp,wp,Us,Sp,Bp,Ws,xp,zp,Rs,Hs,Ks,Vs,qp,Fp,Qs,Js,Xs,Ys,$p,Ep,Zs,er,or,tr,Mp,Cp,nr,ar,sr,rr,jp,Op,Ye,vn,Pp,dr,Lp,Np,Tn,Ip,Ze,wn,Ap,lr,Dp,Gp,Sn,Cr;return S=new Fe({}),se=new Fe({}),xe=new Fe({}),ot=new M({props:{name:"class transformers.BlenderbotSmallConfig",anchor:"transformers.BlenderbotSmallConfig",parameters:[{name:"vocab_size",val:" = 50265"},{name:"max_position_embeddings",val:" = 512"},{name:"encoder_layers",val:" = 8"},{name:"encoder_ffn_dim",val:" = 2048"},{name:"encoder_attention_heads",val:" = 16"},{name:"decoder_layers",val:" = 8"},{name:"decoder_ffn_dim",val:" = 2048"},{name:"decoder_attention_heads",val:" = 16"},{name:"encoder_layerdrop",val:" = 0.0"},{name:"decoder_layerdrop",val:" = 0.0"},{name:"use_cache",val:" = True"},{name:"is_encoder_decoder",val:" = True"},{name:"activation_function",val:" = 'gelu'"},{name:"d_model",val:" = 512"},{name:"dropout",val:" = 0.1"},{name:"attention_dropout",val:" = 0.0"},{name:"activation_dropout",val:" = 0.0"},{name:"init_std",val:" = 0.02"},{name:"decoder_start_token_id",val:" = 1"},{name:"classifier_dropout",val:" = 0.0"},{name:"scale_embedding",val:" = False"},{name:"pad_token_id",val:" = 0"},{name:"bos_token_id",val:" = 1"},{name:"eos_token_id",val:" = 2"},{name:"forced_eos_token_id",val:" = 2"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/blenderbot_small/configuration_blenderbot_small.py#L36",parametersDescription:[{anchor:"transformers.BlenderbotSmallConfig.vocab_size",description:`<strong>vocab_size</strong> (<code>int</code>, <em>optional</em>, defaults to 50265) &#x2014;
...
`}}),No=new xn({props:{$$slots:{default:[Yu]},$$scope:{ctx:Y}}}),qt=new ro({props:{code:`from transformers import BlenderbotSmallTokenizer, BlenderbotSmallForConditionalGeneration
...
<span class="hljs-meta">&gt;&gt;&gt; </span>outputs = model.decode(decoder_input_ids, encoder_outputs)
<span class="hljs-meta">&gt;&gt;&gt; </span>logits = outputs.logits`}}),{c(){h=n("meta"),z=l(),v=n("h1"),T=n("a"),B=n("span"),f(S.$$.fragment),w=l(),q=n("span"),Ce=r("Blenderbot Small"),ue=l(),x=n("p"),je=r("Note that "),U=n("a"),Oe=r("BlenderbotSmallModel"),Pe=r(` and
...
Jing Xu, Myle Ott, Kurt Shuster, Eric M. Smith, Y-Lan Boureau, Jason Weston on 30 Apr 2020.`),Me=l(),R=n("p"),De=r("The abstract of the paper is the following:"),u=l(),F=n("p"),ie=n("em"),lo=r(`Building open-domain chatbots is a challenging area for machine learning research. While prior work has shown that
...
found `),D=n("a"),po=r("here"),mo=r(" ."),oe=l(),ce=n("h2"),_e=n("a"),Be=n("span"),f(xe.$$.fragment),md=l(),la=n("span"),hd=r("BlenderbotSmallConfig"),ur=l(),pe=n("div"),f(ot.$$.fragment),ud=l(),ho=n("p"),fd=r("This is the configuration class to store the configuration of a "),zn=n("a"),_d=r("BlenderbotSmallModel"),gd=r(`. It is used to instantiate
an BlenderbotSmall model according to the specified arguments, defining the model architecture. Instantiating a
configuration with the defaults will yield a similar configuration to that of the BlenderbotSmall
`),tt=n("a"),bd=r("facebook/blenderbot_small-90M"),kd=r(" architecture."),yd=l(),uo=n("p"),vd=r("Configuration objects inherit from "),qn=n("a"),Td=r("PretrainedConfig"),wd=r(` and can be used to control the model outputs. Read the
...
behavior.`),fi=l(),f(Do.$$.fragment),_i=l(),ke=n("div"),f(Nt.$$.fragment),gi=l(),Bo=n("p"),bi=r("The "),In=n("a"),ki=r("TFBlenderbotSmallModel"),yi=r(" forward method, overrides the "),Oa=n("code"),vi=r("__call__"),Ti=r(" special method."),wi=l(),f(Go.$$.fragment),Si=l(),Pa=n("p"),Bi=r("Example:"),xi=l(),f(It.$$.fragment),zr=l(),xo=n("h2"),Uo=n("a"),La=n("span"),f(At.$$.fragment),zi=l(),Na=n("span"),qi=r("TFBlenderbotSmallForConditionalGeneration"),qr=l(),he=n("div"),f(Dt.$$.fragment),Fi=l(),Gt=n("p"),$i=r(`The BLENDERBOT_SMALL Model with a language modeling head. Can be used for summarization.
...
jax.nn.softmax(logits[0, masked_index], axis=0) >>> values, predictions = jax.lax.top_k(probs)`),Cp=l(),nr=n("blockquote"),ar=n("blockquote"),sr=n("blockquote"),rr=n("p"),jp=r("tokenizer.decode(predictions).split()"),Op=l(),Ye=n("div"),f(vn.$$.fragment),Pp=l(),dr=n("p"),Lp=r("Example:"),Np=l(),f(Tn.$$.fragment),Ip=l(),Ze=n("div"),f(wn.$$.fragment),Ap=l(),lr=n("p"),Dp=r("Example:"),Gp=l(),f(Sn.$$.fragment),this.h()},l(t){const m=Qu('[data-svelte="svelte-1phssyn"]',document.head);h=a(m,"META",{name:!0,content:!0}),m.forEach(o),z=i(t),v=a(t,"H1",{class:!0});var Bn=s(v);T=a(Bn,"A",{id:!0,class:!0,href:!0});var ir=s(T);B=a(ir,"SPAN",{});var cr=s(B);_(S.$$.fragment,cr),cr.forEach(o),ir.forEach(o),w=i(Bn),q=a(Bn,"SPAN",{});var pr=s(q);Ce=d(pr,"Blenderbot Small"),pr.forEach(o),Bn.forEach(o),ue=i(t),x=a(t,"P",{});var ye=s(x);je=d(ye,"Note that "),U=a(ye,"A",{href:!0});var mr=s(U);Oe=d(mr,"BlenderbotSmallModel"),mr.forEach(o),Pe=d(ye,` and
...
found `),D=a(Wn,"A",{href:!0,rel:!0});var om=s(D);po=d(om,"here"),om.forEach(o),mo=d(Wn," ."),Wn.forEach(o),oe=i(t),ce=a(t,"H2",{class:!0});var Pr=s(ce);_e=a(Pr,"A",{id:!0,class:!0,href:!0});var tm=s(_e);Be=a(tm,"SPAN",{});var nm=s(Be);_(xe.$$.fragment,nm),nm.forEach(o),tm.forEach(o),md=i(Pr),la=a(Pr,"SPAN",{});var am=s(la);hd=d(am,"BlenderbotSmallConfig"),am.forEach(o),Pr.forEach(o),ur=i(t),pe=a(t,"DIV",{class:!0});var eo=s(pe);_(ot.$$.fragment,eo),ud=i(eo),ho=a(eo,"P",{});var Rn=s(ho);fd=d(Rn,"This is the configuration class to store the configuration of a "),zn=a(Rn,"A",{href:!0});var sm=s(zn);_d=d(sm,"BlenderbotSmallModel"),sm.forEach(o),gd=d(Rn,`. It is used to instantiate
an BlenderbotSmall model according to the specified arguments, defining the model architecture. Instantiating a
configuration with the defaults will yield a similar configuration to that of the BlenderbotSmall
`),tt=a(Rn,"A",{href:!0,rel:!0});var rm=s(tt);bd=d(rm,"facebook/blenderbot_small-90M"),rm.forEach(o),kd=d(Rn," architecture."),Rn.forEach(o),yd=i(eo),uo=a(eo,"P",{});var Hn=s(uo);vd=d(Hn,"Configuration objects inherit from "),qn=a(Hn,"A",{href:!0});var dm=s(qn);Td=d(dm,"PretrainedConfig"),dm.forEach(o),wd=d(Hn,` and can be used to control the model outputs. Read the
documentation from `),Fn=a(Hn,"A",{href:!0});var lm=s(Fn);Sd=d(lm,"PretrainedConfig"),lm.forEach(o),Bd=d(Hn," for more information."),Hn.forEach(o),xd=i(eo),ia=a(eo,"P",{});var im=s(ia);zd=d(im,"Example:"),im.forEach(o),qd=i(eo),_(nt.$$.fragment,eo),eo.forEach(o),fr=i(t),fo=a(t,"H2",{class:!0});var Lr=s(fo);Eo=a(Lr,"A",{id:!0,class:!0,href:!0});var cm=s(Eo);ca=a(cm,"SPAN",{});var pm=s(ca);_(at.$$.fragment,pm),pm.forEach(o),cm.forEach(o),Fd=i(Lr),pa=a(Lr,"SPAN",{});var mm=s(pa);$d=d(mm,"BlenderbotSmallTokenizer"),mm.forEach(o),Lr.forEach(o),_r=i(t),G=a(t,"DIV",{class:!0});var ve=s(G);_(st.$$.fragment,ve),Ed=i(ve),ma=a(ve,"P",{});var hm=s(ma);Md=d(hm,"Constructs a Blenderbot-90M tokenizer based on BPE (Byte-Pair-Encoding)"),hm.forEach(o),Cd=i(ve),rt=a(ve,"P",{});var Nr=s(rt);jd=d(Nr,"This tokenizer inherits from "),$n=a(Nr,"A",{href:!0});var um=s($n);Od=d(um,"PreTrainedTokenizer"),um.forEach(o),Pd=d(Nr,` which contains most of the main methods. Users should refer to
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Rr.forEach(o),vl=i(Xo),ge=a(Xo,"DIV",{class:!0});var oo=s(ge);_(yt.$$.fragment,oo),Tl=i(oo),ko=a(oo,"P",{});var Xn=s(ko);wl=d(Xn,"The "),On=a(Xn,"A",{href:!0});var Mm=s(On);Sl=d(Mm,"BlenderbotSmallModel"),Mm.forEach(o),Bl=d(Xn," forward method, overrides the "),Sa=a(Xn,"CODE",{});var Cm=s(Sa);xl=d(Cm,"__call__"),Cm.forEach(o),zl=d(Xn," special method."),Xn.forEach(o),ql=i(oo),_(Po.$$.fragment,oo),Fl=i(oo),Ba=a(oo,"P",{});var jm=s(Ba);$l=d(jm,"Example:"),jm.forEach(o),El=i(oo),_(vt.$$.fragment,oo),oo.forEach(o),Xo.forEach(o),vr=i(t),yo=a(t,"H2",{class:!0});var Hr=s(yo);Lo=a(Hr,"A",{id:!0,class:!0,href:!0});var Om=s(Lo);xa=a(Om,"SPAN",{});var Pm=s(xa);_(Tt.$$.fragment,Pm),Pm.forEach(o),Om.forEach(o),Ml=i(Hr),za=a(Hr,"SPAN",{});var Lm=s(za);Cl=d(Lm,"BlenderbotSmallForConditionalGeneration"),Lm.forEach(o),Hr.forEach(o),Tr=i(t),qe=a(t,"DIV",{class:!0});var Yo=s(qe);_(wt.$$.fragment,Yo),jl=i(Yo),St=a(Yo,"P",{});var Kr=s(St);Ol=d(Kr,`The BlenderbotSmall Model with a language modeling head. Can be used for summarization.
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Kr.forEach(o),Nl=i(Yo),Bt=a(Yo,"P",{});var Vr=s(Bt);Il=d(Vr,"This model is also a PyTorch "),xt=a(Vr,"A",{href:!0,rel:!0});var Im=s(xt);Al=d(Im,"torch.nn.Module"),Im.forEach(o),Dl=d(Vr,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Vr.forEach(o),Gl=i(Yo),be=a(Yo,"DIV",{class:!0});var to=s(be);_(zt.$$.fragment,to),Ul=i(to),vo=a(to,"P",{});var Yn=s(vo);Wl=d(Yn,"The "),Ln=a(Yn,"A",{href:!0});var Am=s(Ln);Rl=d(Am,"BlenderbotSmallForConditionalGeneration"),Am.forEach(o),Hl=d(Yn," forward method, overrides the "),qa=a(Yn,"CODE",{});var Dm=s(qa);Kl=d(Dm,"__call__"),Dm.forEach(o),Vl=d(Yn," special method."),Yn.forEach(o),Ql=i(to),_(No.$$.fragment,to),Jl=i(to),Fa=a(to,"P",{});var Gm=s(Fa);Xl=d(Gm,"Conversation example:"),Gm.forEach(o),Yl=i(to),_(qt.$$.fragment,to),to.forEach(o),Yo.forEach(o),wr=i(t),To=a(t,"H2",{class:!0});var Qr=s(To);Io=a(Qr,"A",{id:!0,class:!0,href:!0});var Um=s(Io);$a=a(Um,"SPAN",{});var Wm=s($a);_(Ft.$$.fragment,Wm),Wm.forEach(o),Um.forEach(o),Zl=i(Qr),Ea=a(Qr,"SPAN",{});var Rm=s(Ea);ei=d(Rm,"BlenderbotSmallForCausalLM"),Rm.forEach(o),Qr.forEach(o),Sr=i(t),wo=a(t,"DIV",{class:!0});var Jr=s(wo);_($t.$$.fragment,Jr),oi=i(Jr),Ve=a(Jr,"DIV",{class:!0});var Zn=s(Ve);_(Et.$$.fragment,Zn),ti=i(Zn),Ma=a(Zn,"P",{});var Hm=s(Ma);ni=d(Hm,"Example:"),Hm.forEach(o),ai=i(Zn),_(Mt.$$.fragment,Zn),Zn.forEach(o),Jr.forEach(o),Br=i(t),So=a(t,"H2",{class:!0});var Xr=s(So);Ao=a(Xr,"A",{id:!0,class:!0,href:!0});var Km=s(Ao);Ca=a(Km,"SPAN",{});var Vm=s(Ca);_(Ct.$$.fragment,Vm),Vm.forEach(o),Km.forEach(o),si=i(Xr),ja=a(Xr,"SPAN",{});var Qm=s(ja);ri=d(Qm,"TFBlenderbotSmallModel"),Qm.forEach(o),Xr.forEach(o),xr=i(t),me=a(t,"DIV",{class:!0});var no=s(me);_(jt.$$.fragment,no),di=i(no),Ot=a(no,"P",{});var Yr=s(Ot);li=d(Yr,`The bare BLENDERBOT_SMALL Model outputting raw hidden-states without any specific head on top.
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Zr.forEach(o),fi=i(no),_(Do.$$.fragment,no),_i=i(no),ke=a(no,"DIV",{class:!0});var ao=s(ke);_(Nt.$$.fragment,ao),gi=i(ao),Bo=a(ao,"P",{});var ea=s(Bo);bi=d(ea,"The "),In=a(ea,"A",{href:!0});var Ym=s(In);ki=d(Ym,"TFBlenderbotSmallModel"),Ym.forEach(o),yi=d(ea," forward method, overrides the "),Oa=a(ea,"CODE",{});var Zm=s(Oa);vi=d(Zm,"__call__"),Zm.forEach(o),Ti=d(ea," special method."),ea.forEach(o),wi=i(ao),_(Go.$$.fragment,ao),Si=i(ao),Pa=a(ao,"P",{});var eh=s(Pa);Bi=d(eh,"Example:"),eh.forEach(o),xi=i(ao),_(It.$$.fragment,ao),ao.forEach(o),no.forEach(o),zr=i(t),xo=a(t,"H2",{class:!0});var ed=s(xo);Uo=a(ed,"A",{id:!0,class:!0,href:!0});var oh=s(Uo);La=a(oh,"SPAN",{});var th=s(La);_(At.$$.fragment,th),th.forEach(o),oh.forEach(o),zi=i(ed),Na=a(ed,"SPAN",{});var nh=s(Na);qi=d(nh,"TFBlenderbotSmallForConditionalGeneration"),nh.forEach(o),ed.forEach(o),qr=i(t),he=a(t,"DIV",{class:!0});var so=s(he);_(Dt.$$.fragment,so),Fi=i(so),Gt=a(so,"P",{});var od=s(Gt);$i=d(od,`The BLENDERBOT_SMALL Model with a language modeling head. Can be used for summarization.
...
\u201D<s>I\u2019m not sure.\u201D \u2026 )`),nd.forEach(o),wh.forEach(o),Th.forEach(o),vh.forEach(o),ac=i(H),ns=a(H,"BLOCKQUOTE",{});var Bh=s(ns);as=a(Bh,"BLOCKQUOTE",{});var xh=s(as);ss=a(xh,"BLOCKQUOTE",{});var zh=s(ss);rs=a(zh,"P",{});var qh=s(rs);sc=d(qh,`inputs = tokenizer([NEXT_UTTERANCE], return_tensors=\u2018tf\u2019) >>> inputs.pop(\u201Ctoken_type_ids\u201D) >>>
next_reply_ids = model.generate(**inputs) >>> print(\u201CBot: \u201D, tokenizer.batch_decode(next_reply_ids,
skip_special_tokens=True)[0])`),qh.forEach(o),zh.forEach(o),xh.forEach(o),Bh.forEach(o),H.forEach(o),so.forEach(o),Fr=i(t),qo=a(t,"H2",{class:!0});var ad=s(qo);Ho=a(ad,"A",{id:!0,class:!0,href:!0});var Fh=s(Ho);ds=a(Fh,"SPAN",{});var $h=s(ds);_(Kt.$$.fragment,$h),$h.forEach(o),Fh.forEach(o),rc=i(ad),ls=a(ad,"SPAN",{});var Eh=s(ls);dc=d(Eh,"FlaxBlenderbotSmallModel"),Eh.forEach(o),ad.forEach(o),$r=i(t),N=a(t,"DIV",{class:!0});var te=s(N);_(Vt.$$.fragment,te),lc=i(te),Qt=a(te,"P",{});var sd=s(Qt);ic=d(sd,`The bare BlenderbotSmall Model transformer outputting raw hidden-states without any specific head on top.
...
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),rd.forEach(o),_c=i(te),is=a(te,"P",{});var jh=s(is);gc=d(jh,"Finally, this model supports inherent JAX features such as:"),jh.forEach(o),bc=i(te),Ue=a(te,"UL",{});var Zo=s(Ue);cs=a(Zo,"LI",{});var Oh=s(cs);Yt=a(Oh,"A",{href:!0,rel:!0});var Ph=s(Yt);kc=d(Ph,"Just-In-Time (JIT) compilation"),Ph.forEach(o),Oh.forEach(o),yc=i(Zo),ps=a(Zo,"LI",{});var Lh=s(ps);Zt=a(Lh,"A",{href:!0,rel:!0});var Nh=s(Zt);vc=d(Nh,"Automatic Differentiation"),Nh.forEach(o),Lh.forEach(o),Tc=i(Zo),ms=a(Zo,"LI",{});var Ih=s(ms);en=a(Ih,"A",{href:!0,rel:!0});var Ah=s(en);wc=d(Ah,"Vectorization"),Ah.forEach(o),Ih.forEach(o),Sc=i(Zo),hs=a(Zo,"LI",{});var Dh=s(hs);on=a(Dh,"A",{href:!0,rel:!0});var Gh=s(on);Bc=d(Gh,"Parallelization"),Gh.forEach(o),Dh.forEach(o),Zo.forEach(o),xc=i(te),Qe=a(te,"DIV",{class:!0});var ta=s(Qe);_(tn.$$.fragment,ta),zc=i(ta),us=a(ta,"P",{});var Uh=s(us);qc=d(Uh,"Example:"),Uh.forEach(o),Fc=i(ta),_(nn.$$.fragment,ta),ta.forEach(o),$c=i(te),Je=a(te,"DIV",{class:!0});var na=s(Je);_(an.$$.fragment,na),Ec=i(na),fs=a(na,"P",{});var Wh=s(fs);Mc=d(Wh,"Example:"),Wh.forEach(o),Cc=i(na),_(sn.$$.fragment,na),na.forEach(o),jc=i(te),Xe=a(te,"DIV",{class:!0});var aa=s(Xe);_(rn.$$.fragment,aa),Oc=i(aa),_s=a(aa,"P",{});var Rh=s(_s);Pc=d(Rh,"Example:"),Rh.forEach(o),Lc=i(aa),_(dn.$$.fragment,aa),aa.forEach(o),te.forEach(o),Er=i(t),Fo=a(t,"H2",{class:!0});var dd=s(Fo);Ko=a(dd,"A",{id:!0,class:!0,href:!0});var Hh=s(Ko);gs=a(Hh,"SPAN",{});var Kh=s(gs);_(ln.$$.fragment,Kh),Kh.forEach(o),Hh.forEach(o),Nc=i(dd),bs=a(dd,"SPAN",{});var Vh=s(bs);Ic=d(Vh,"FlaxBlenderbotForConditionalGeneration"),Vh.forEach(o),dd.forEach(o),Mr=i(t),I=a(t,"DIV",{class:!0});var ne=s(I);_(cn.$$.fragment,ne),Ac=i(ne),pn=a(ne,"P",{});var ld=s(pn);Dc=d(ld,`The BLENDERBOT_SMALL Model with a language modeling head. Can be used for summarization.
