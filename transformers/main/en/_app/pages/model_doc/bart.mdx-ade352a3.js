import{S as C1,i as A1,s as O1,e as n,k as d,w as m,t as r,M as S1,c as a,d as t,m as l,a as s,x as f,h as i,b as c,F as e,g as u,y as _,q as g,o as k,B as b,v as I1}from"../../chunks/vendor-6b77c823.js";import{T as qe}from"../../chunks/Tip-39098574.js";import{D as q}from"../../chunks/Docstring-abef54e3.js";import{C as P}from"../../chunks/CodeBlock-3a8b25a8.js";import{I as H}from"../../chunks/IconCopyLink-7a11ce68.js";function N1(j){let p,z,T,w,x;return{c(){p=n("p"),z=r("When used with "),T=n("code"),w=r("is_split_into_words=True"),x=r(", this tokenizer will add a space before each word (even the first one).")},l(v){p=a(v,"P",{});var y=s(p);z=i(y,"When used with "),T=a(y,"CODE",{});var B=s(T);w=i(B,"is_split_into_words=True"),B.forEach(t),x=i(y,", this tokenizer will add a space before each word (even the first one)."),y.forEach(t)},m(v,y){u(v,p,y),e(p,z),e(p,T),e(T,w),e(p,x)},d(v){v&&t(p)}}}function L1(j){let p,z,T,w,x,v,y,B;return{c(){p=n("p"),z=r("When used with "),T=n("code"),w=r("is_split_into_words=True"),x=r(", this tokenizer needs to be instantiated with "),v=n("code"),y=r("add_prefix_space=True"),B=r(".")},l(ae){p=a(ae,"P",{});var A=s(p);z=i(A,"When used with "),T=a(A,"CODE",{});var $=s(T);w=i($,"is_split_into_words=True"),$.forEach(t),x=i(A,", this tokenizer needs to be instantiated with "),v=a(A,"CODE",{});var ce=s(v);y=i(ce,"add_prefix_space=True"),ce.forEach(t),B=i(A,"."),A.forEach(t)},m(ae,A){u(ae,p,A),e(p,z),e(p,T),e(T,w),e(p,x),e(p,v),e(v,y),e(p,B)},d(ae){ae&&t(p)}}}function D1(j){let p,z,T,w,x;return{c(){p=n("p"),z=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),T=n("code"),w=r("Module"),x=r(`
...
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),y.forEach(t)},m(v,y){u(v,p,y),e(p,z),e(p,T),e(T,w),e(p,x)},d(v){v&&t(p)}}}function G1(j){let p,z,T,w,x;return{c(){p=n("p"),z=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),T=n("code"),w=r("Module"),x=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(v){p=a(v,"P",{});var y=s(p);z=i(y,"Although the recipe for forward pass needs to be defined within this function, one should call the "),T=a(y,"CODE",{});var B=s(T);w=i(B,"Module"),B.forEach(t),x=i(y,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),y.forEach(t)},m(v,y){u(v,p,y),e(p,z),e(p,T),e(T,w),e(p,x)},d(v){v&&t(p)}}}function W1(j){let p,z,T,w,x;return{c(){p=n("p"),z=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),T=n("code"),w=r("Module"),x=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(v){p=a(v,"P",{});var y=s(p);z=i(y,"Although the recipe for forward pass needs to be defined within this function, one should call the "),T=a(y,"CODE",{});var B=s(T);w=i(B,"Module"),B.forEach(t),x=i(y,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),y.forEach(t)},m(v,y){u(v,p,y),e(p,z),e(p,T),e(T,w),e(p,x)},d(v){v&&t(p)}}}function U1(j){let p,z,T,w,x;return{c(){p=n("p"),z=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),T=n("code"),w=r("Module"),x=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(v){p=a(v,"P",{});var y=s(p);z=i(y,"Although the recipe for forward pass needs to be defined within this function, one should call the "),T=a(y,"CODE",{});var B=s(T);w=i(B,"Module"),B.forEach(t),x=i(y,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),y.forEach(t)},m(v,y){u(v,p,y),e(p,z),e(p,T),e(T,w),e(p,x)},d(v){v&&t(p)}}}function R1(j){let p,z,T,w,x,v,y,B,ae,A,$,ce,ge,et,ke,be,tt,Ze,Q,N,Ue,se,C,O,ot,pe,he,nt,V,at,st,L,$e,ye,Ye,K,re,rt,it,J,dt,Te,Re;return{c(){p=n("p"),z=r("TF 2.0 models accepts two formats as inputs:"),T=d(),w=n("ul"),x=n("li"),v=r("having all inputs as keyword arguments (like PyTorch models), or"),y=d(),B=n("li"),ae=r("having all inputs as a list, tuple or dict in the first positional arguments."),A=d(),$=n("p"),ce=r("This second option is useful when using "),ge=n("code"),et=r("tf.keras.Model.fit"),ke=r(` method which currently requires having all the
...
`),Te=a(Je,"CODE",{});var Rt=s(Te);Re=i(Rt,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),Rt.forEach(t),Je.forEach(t),de.forEach(t)},m(F,M){u(F,p,M),e(p,z),u(F,T,M),u(F,w,M),e(w,x),e(x,v),e(w,y),e(w,B),e(B,ae),u(F,A,M),u(F,$,M),e($,ce),e($,ge),e(ge,et),e($,ke),e($,be),e(be,tt),e($,Ze),u(F,Q,M),u(F,N,M),e(N,Ue),u(F,se,M),u(F,C,M),e(C,O),e(O,ot),e(O,pe),e(pe,he),e(O,nt),e(O,V),e(V,at),e(C,st),e(C,L),e(L,$e),e(L,ye),e(ye,Ye),e(L,K),e(L,re),e(re,rt),e(C,it),e(C,J),e(J,dt),e(J,Te),e(Te,Re)},d(F){F&&t(p),F&&t(T),F&&t(w),F&&t(A),F&&t($),F&&t(Q),F&&t(N),F&&t(se),F&&t(C)}}}function H1(j){let p,z,T,w,x;return{c(){p=n("p"),z=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),T=n("code"),w=r("Module"),x=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(v){p=a(v,"P",{});var y=s(p);z=i(y,"Although the recipe for forward pass needs to be defined within this function, one should call the "),T=a(y,"CODE",{});var B=s(T);w=i(B,"Module"),B.forEach(t),x=i(y,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),y.forEach(t)},m(v,y){u(v,p,y),e(p,z),e(p,T),e(T,w),e(p,x)},d(v){v&&t(p)}}}function Q1(j){let p,z,T,w,x,v,y,B,ae,A,$,ce,ge,et,ke,be,tt,Ze,Q,N,Ue,se,C,O,ot,pe,he,nt,V,at,st,L,$e,ye,Ye,K,re,rt,it,J,dt,Te,Re;return{c(){p=n("p"),z=r("TF 2.0 models accepts two formats as inputs:"),T=d(),w=n("ul"),x=n("li"),v=r("having all inputs as keyword arguments (like PyTorch models), or"),y=d(),B=n("li"),ae=r("having all inputs as a list, tuple or dict in the first positional arguments."),A=d(),$=n("p"),ce=r("This second option is useful when using "),ge=n("code"),et=r("tf.keras.Model.fit"),ke=r(` method which currently requires having all the
tensors in the first argument of the model call function: `),be=n("code"),tt=r("model(inputs)"),Ze=r("."),Q=d(),N=n("p"),Ue=r(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),se=d(),C=n("ul"),O=n("li"),ot=r("a single Tensor with "),pe=n("code"),he=r("input_ids"),nt=r(" only and nothing else: "),V=n("code"),at=r("model(input_ids)"),st=d(),L=n("li"),$e=r(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),ye=n("code"),Ye=r("model([input_ids, attention_mask])"),K=r(" or "),re=n("code"),rt=r("model([input_ids, attention_mask, token_type_ids])"),it=d(),J=n("li"),dt=r(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),Te=n("code"),Re=r('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(F){p=a(F,"P",{});var M=s(p);z=i(M,"TF 2.0 models accepts two formats as inputs:"),M.forEach(t),T=l(F),w=a(F,"UL",{});var R=s(w);x=a(R,"LI",{});var Dt=s(x);v=i(Dt,"having all inputs as keyword arguments (like PyTorch models), or"),Dt.forEach(t),y=l(R),B=a(R,"LI",{});var He=s(B);ae=i(He,"having all inputs as a list, tuple or dict in the first positional arguments."),He.forEach(t),R.forEach(t),A=l(F),$=a(F,"P",{});var ie=s($);ce=i(ie,"This second option is useful when using "),ge=a(ie,"CODE",{});var Gt=s(ge);et=i(Gt,"tf.keras.Model.fit"),Gt.forEach(t),ke=i(ie,` method which currently requires having all the
...
first positional argument :`),Wt.forEach(t),se=l(F),C=a(F,"UL",{});var de=s(C);O=a(de,"LI",{});var ue=s(O);ot=i(ue,"a single Tensor with "),pe=a(ue,"CODE",{});var ve=s(pe);he=i(ve,"input_ids"),ve.forEach(t),nt=i(ue," only and nothing else: "),V=a(ue,"CODE",{});var je=s(V);at=i(je,"model(input_ids)"),je.forEach(t),ue.forEach(t),st=l(de),L=a(de,"LI",{});var le=s(L);$e=i(le,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),ye=a(le,"CODE",{});var Ve=s(ye);Ye=i(Ve,"model([input_ids, attention_mask])"),Ve.forEach(t),K=i(le," or "),re=a(le,"CODE",{});var Ut=s(re);rt=i(Ut,"model([input_ids, attention_mask, token_type_ids])"),Ut.forEach(t),le.forEach(t),it=l(de),J=a(de,"LI",{});var Je=s(J);dt=i(Je,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),Te=a(Je,"CODE",{});var Rt=s(Te);Re=i(Rt,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),Rt.forEach(t),Je.forEach(t),de.forEach(t)},m(F,M){u(F,p,M),e(p,z),u(F,T,M),u(F,w,M),e(w,x),e(x,v),e(w,y),e(w,B),e(B,ae),u(F,A,M),u(F,$,M),e($,ce),e($,ge),e(ge,et),e($,ke),e($,be),e(be,tt),e($,Ze),u(F,Q,M),u(F,N,M),e(N,Ue),u(F,se,M),u(F,C,M),e(C,O),e(O,ot),e(O,pe),e(pe,he),e(O,nt),e(O,V),e(V,at),e(C,st),e(C,L),e(L,$e),e(L,ye),e(ye,Ye),e(L,K),e(L,re),e(re,rt),e(C,it),e(C,J),e(J,dt),e(J,Te),e(Te,Re)},d(F){F&&t(p),F&&t(T),F&&t(w),F&&t(A),F&&t($),F&&t(Q),F&&t(N),F&&t(se),F&&t(C)}}}function V1(j){let p,z,T,w,x;return{c(){p=n("p"),z=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),T=n("code"),w=r("Module"),x=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(v){p=a(v,"P",{});var y=s(p);z=i(y,"Although the recipe for forward pass needs to be defined within this function, one should call the "),T=a(y,"CODE",{});var B=s(T);w=i(B,"Module"),B.forEach(t),x=i(y,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
the latter silently ignores them.`)},l(v){p=a(v,"P",{});var y=s(p);z=i(y,"Although the recipe for forward pass needs to be defined within this function, one should call the "),T=a(y,"CODE",{});var B=s(T);w=i(B,"Module"),B.forEach(t),x=i(y,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),y.forEach(t)},m(v,y){u(v,p,y),e(p,z),e(p,T),e(T,w),e(p,x)},d(v){v&&t(p)}}}function K1(j){let p,z,T,w,x;return{c(){p=n("p"),z=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),T=n("code"),w=r("Module"),x=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(v){p=a(v,"P",{});var y=s(p);z=i(y,"Although the recipe for forward pass needs to be defined within this function, one should call the "),T=a(y,"CODE",{});var B=s(T);w=i(B,"Module"),B.forEach(t),x=i(y,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),y.forEach(t)},m(v,y){u(v,p,y),e(p,z),e(p,T),e(T,w),e(p,x)},d(v){v&&t(p)}}}function Z1(j){let p,z,T,w,x;return{c(){p=n("p"),z=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),T=n("code"),w=r("Module"),x=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(v){p=a(v,"P",{});var y=s(p);z=i(y,"Although the recipe for forward pass needs to be defined within this function, one should call the "),T=a(y,"CODE",{});var B=s(T);w=i(B,"Module"),B.forEach(t),x=i(y,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),y.forEach(t)},m(v,y){u(v,p,y),e(p,z),e(p,T),e(T,w),e(p,x)},d(v){v&&t(p)}}}function Y1(j){let p,z,T,w,x;return{c(){p=n("p"),z=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),T=n("code"),w=r("Module"),x=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(v){p=a(v,"P",{});var y=s(p);z=i(y,"Although the recipe for forward pass needs to be defined within this function, one should call the "),T=a(y,"CODE",{});var B=s(T);w=i(B,"Module"),B.forEach(t),x=i(y,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
`}}),Ro=new qe({props:{$$slots:{default:[G1]},$$scope:{ctx:j}}}),ua=new P({props:{code:`from transformers import BartTokenizer, BartForConditionalGeneration
...
`}}),Qo=new qe({props:{$$slots:{default:[W1]},$$scope:{ctx:j}}}),Ta=new P({props:{code:`import torch
...
`}}),Jo=new qe({props:{$$slots:{default:[U1]},$$scope:{ctx:j}}}),$a=new P({props:{code:`from transformers import BartTokenizer, BartForQuestionAnswering
import torch
...
`}}),Yo=new qe({props:{$$slots:{default:[H1]},$$scope:{ctx:j}}}),La=new P({props:{code:`from transformers import BartTokenizer, TFBartModel
...
`}}),on=new qe({props:{$$slots:{default:[V1]},$$scope:{ctx:j}}}),Qa=new P({props:{code:`from transformers import BartTokenizer, TFBartForConditionalGeneration
...
`}}),an=new qe({props:{$$slots:{default:[J1]},$$scope:{ctx:j}}}),ss=new P({props:{code:`from transformers import BartTokenizer, FlaxBartModel
...
`}}),rn=new qe({props:{$$slots:{default:[X1]},$$scope:{ctx:j}}}),ys=new P({props:{code:`from transformers import BartTokenizer, FlaxBartForConditionalGeneration
...
`}}),ln=new qe({props:{$$slots:{default:[K1]},$$scope:{ctx:j}}}),Os=new P({props:{code:`from transformers import BartTokenizer, FlaxBartForSequenceClassification
...
`}}),pn=new qe({props:{$$slots:{default:[Z1]},$$scope:{ctx:j}}}),Ks=new P({props:{code:`from transformers import BartTokenizer, FlaxBartForQuestionAnswering
...
<p><a
  href="/docs/transformers/main/en/main_classes/output#transformers.modeling_flax_outputs.FlaxCausalLMOutputWithCrossAttentions"
>transformers.modeling_flax_outputs.FlaxCausalLMOutputWithCrossAttentions</a> or <code>tuple(torch.FloatTensor)</code></p>
`}}),un=new qe({props:{$$slots:{default:[Y1]},$$scope:{ctx:j}}}),hr=new P({props:{code:`from transformers import BartTokenizer, FlaxBartForCausalLM
