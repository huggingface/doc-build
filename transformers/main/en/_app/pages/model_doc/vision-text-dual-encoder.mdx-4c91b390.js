import{S as Nr,i as Br,s as Or,e as n,k as d,w as _,t as r,M as Wr,c as a,d as t,m as c,a as s,x as v,h as i,b as l,F as e,g as h,y as x,q as T,o as E,B as b,v as Rr}from"../../chunks/vendor-6b77c823.js";import{T as Sr}from"../../chunks/Tip-39098574.js";import{D as U}from"../../chunks/Docstring-abef54e3.js";import{C as ys}from"../../chunks/CodeBlock-3a8b25a8.js";import{I as Vt}from"../../chunks/IconCopyLink-7a11ce68.js";function Ur(et){let p,q,g,$,A;return{c(){p=n("p"),q=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),g=n("code"),$=r("Module"),A=r(`
...
the latter silently ignores them.`)},l(j){p=a(j,"P",{});var D=s(p);q=i(D,"Although the recipe for forward pass needs to be defined within this function, one should call the "),g=a(D,"CODE",{});var L=s(g);$=i(L,"Module"),L.forEach(t),A=i(D,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),D.forEach(t)},m(j,D){h(j,p,D),e(p,q),e(p,g),e(g,$),e(p,A)},d(j){j&&t(p)}}}function Hr(et){let p,q,g,$,A,j,D,L,Lo,no,J,ee,Dt,he,So,$t,No,ao,u,Bo,tt,Oo,Wo,Pt,Ro,Uo,ot,Jo,Ho,nt,Zo,Go,at,Xo,Ko,Mt,Qo,Yo,st,en,tn,rt,on,nn,so,te,an,fe,sn,rn,ro,H,oe,zt,ue,ln,Ct,dn,io,w,ge,cn,B,it,mn,pn,lt,hn,fn,dt,un,gn,_n,Z,vn,ct,xn,Tn,mt,En,bn,jn,Ft,wn,yn,_e,kn,ne,ve,Vn,xe,Dn,pt,$n,Pn,Mn,ae,Te,zn,Ee,Cn,ht,Fn,In,lo,G,se,It,be,An,At,qn,co,P,je,Ln,qt,Sn,Nn,M,ft,Bn,On,ut,Wn,Rn,gt,Un,Jn,Lt,Hn,Zn,_t,Gn,Xn,Kn,re,we,Qn,ye,Yn,vt,ea,ta,oa,ie,ke,na,Ve,aa,xt,sa,ra,mo,X,le,St,De,ia,Nt,la,po,y,$e,da,Pe,ca,Bt,ma,pa,ha,Me,fa,ze,ua,ga,_a,Ot,va,xa,Ce,Ta,Tt,Ea,ba,ja,Fe,wa,Ie,ya,ka,Va,z,Ae,Da,K,$a,Et,Pa,Ma,Wt,za,Ca,Fa,de,Ia,Rt,Aa,qa,qe,ho,Q,ce,Ut,Le,La,Jt,Sa,fo,f,Se,Na,Ne,Ba,Ht,Oa,Wa,Ra,Be,Ua,Oe,Ja,Ha,Za,Zt,Ga,Xa,We,Ka,bt,Qa,Ya,es,Re,ts,Ue,os,ns,as,Gt,ss,rs,S,Xt,Je,is,ls,Kt,He,ds,cs,Qt,Ze,ms,ps,Yt,Ge,hs,fs,C,Xe,us,Y,gs,jt,_s,vs,eo,xs,Ts,Es,me,bs,to,js,ws,Ke,uo;return j=new Vt({}),he=new Vt({}),ue=new Vt({}),ge=new U({props:{name:"class transformers.VisionTextDualEncoderConfig",anchor:"transformers.VisionTextDualEncoderConfig",parameters:[{name:"projection_dim",val:" = 512"},{name:"logit_scale_init_value",val:" = 2.6592"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/vision_text_dual_encoder/configuration_vision_text_dual_encoder.py#L28",parametersDescription:[{anchor:"transformers.VisionTextDualEncoderConfig.text_config_dict",description:`<strong>text_config_dict</strong> (<code>dict</code>) &#x2014;
...
<span class="hljs-meta">&gt;&gt;&gt; </span>outputs = model(**inputs)
<span class="hljs-meta">&gt;&gt;&gt; </span>logits_per_image = outputs.logits_per_image  <span class="hljs-comment"># this is the image-text similarity score</span>
<span class="hljs-meta">&gt;&gt;&gt; </span>probs = jax.nn.softmax(logits_per_image, axis=<span class="hljs-number">1</span>)  <span class="hljs-comment"># we can take the softmax to get the label probabilities</span>`}}),{c(){p=n("meta"),q=d(),g=n("h1"),$=n("a"),A=n("span"),_(j.$$.fragment),D=d(),L=n("span"),Lo=r("VisionTextDualEncoder"),no=d(),J=n("h2"),ee=n("a"),Dt=n("span"),_(he.$$.fragment),So=d(),$t=n("span"),No=r("Overview"),ao=d(),u=n("p"),Bo=r("The "),tt=n("a"),Oo=r("VisionTextDualEncoderModel"),Wo=r(` can be used to initialize a vision-text dual encoder model with
...
new zero-shot vision tasks such as image classification or retrieval.`),ro=d(),H=n("h2"),oe=n("a"),zt=n("span"),_(ue.$$.fragment),ln=d(),Ct=n("span"),dn=r("VisionTextDualEncoderConfig"),io=d(),w=n("div"),_(ge.$$.fragment),cn=d(),B=n("p"),it=n("a"),mn=r("VisionTextDualEncoderConfig"),pn=r(` is the configuration class to store the configuration of a
...
documentation from `),mt=n("a"),En=r("PretrainedConfig"),bn=r(" for more information."),jn=d(),Ft=n("p"),wn=r("Examples:"),yn=d(),_(_e.$$.fragment),kn=d(),ne=n("div"),_(ve.$$.fragment),Vn=d(),xe=n("p"),Dn=r("Instantiate a "),pt=n("a"),$n=r("VisionTextDualEncoderConfig"),Pn=r(` (or a derived class) from text model configuration and vision
model configuration.`),Mn=d(),ae=n("div"),_(Te.$$.fragment),zn=d(),Ee=n("p"),Cn=r("Serializes this instance to a Python dictionary. Override the default "),ht=n("a"),Fn=r("to_dict()"),In=r("."),lo=d(),G=n("h2"),se=n("a"),It=n("span"),_(be.$$.fragment),An=d(),At=n("span"),qn=r("VisionTextDualEncoderProcessor"),co=d(),P=n("div"),_(je.$$.fragment),Ln=d(),qt=n("p"),Sn=r(`Constructs a VisionTextDualEncoder processor which wraps a vision feature extractor and a tokenizer into a single
...
models (see the examples for more information).`),xa=d(),Ce=n("p"),Ta=r("This model inherits from "),Tt=n("a"),Ea=r("PreTrainedModel"),ba=r(`. Check the superclass documentation for the generic methods the
...
and behavior.`),Va=d(),z=n("div"),_(Ae.$$.fragment),Da=d(),K=n("p"),$a=r("The "),Et=n("a"),Pa=r("VisionTextDualEncoderModel"),Ma=r(" forward method, overrides the "),Wt=n("code"),za=r("__call__"),Ca=r(" special method."),Fa=d(),_(de.$$.fragment),Ia=d(),Rt=n("p"),Aa=r("Examples:"),qa=d(),_(qe.$$.fragment),ho=d(),Q=n("h2"),ce=n("a"),Ut=n("span"),_(Le.$$.fragment),La=d(),Jt=n("span"),Sa=r("FlaxVisionTextDualEncoderModel"),fo=d(),f=n("div"),_(Se.$$.fragment),Na=d(),Ne=n("p"),Ba=r(`This class can be used to initialize a vision-text dual encoder model with any pretrained vision autoencoding model
as the vision encoder and any pretrained text model as the text encoder. The vision and text encoders are loaded
via the `),Ht=n("code"),Oa=r("from_pretrained()"),Wa=r(`method. The projection layers are automatically added to the model and
should be fine-tuned on a downstream task, like contrastive image-text modeling.`),Ra=d(),Be=n("p"),Ua=r("In "),Oe=n("a"),Ja=r("LiT: Zero-Shot Transfer with Locked-image Text Tuning"),Ha=r(` it is shown how
leveraging pre-trained (locked/frozen) image and text model for contrastive learning yields significant improvment
...
models (see the examples for more information).`),Xa=d(),We=n("p"),Ka=r("This model inherits from "),bt=n("a"),Qa=r("PreTrainedModel"),Ya=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),es=d(),Re=n("p"),ts=r("This model is also a Flax Linen "),Ue=n("a"),os=r("flax.linen.Module"),ns=r(`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),as=d(),Gt=n("p"),ss=r("Finally, this model supports inherent JAX features such as:"),rs=d(),S=n("ul"),Xt=n("li"),Je=n("a"),is=r("Just-In-Time (JIT) compilation"),ls=d(),Kt=n("li"),He=n("a"),ds=r("Automatic Differentiation"),cs=d(),Qt=n("li"),Ze=n("a"),ms=r("Vectorization"),ps=d(),Yt=n("li"),Ge=n("a"),hs=r("Parallelization"),fs=d(),C=n("div"),_(Xe.$$.fragment),us=d(),Y=n("p"),gs=r("The "),jt=n("a"),_s=r("FlaxVisionTextDualEncoderModel"),vs=r(" forward method, overrides the "),eo=n("code"),xs=r("__call__"),Ts=r(" special method."),Es=d(),_(me.$$.fragment),bs=d(),to=n("p"),js=r("Examples:"),ws=d(),_(Ke.$$.fragment),this.h()},l(o){const m=Wr('[data-svelte="svelte-1phssyn"]',document.head);p=a(m,"META",{name:!0,content:!0}),m.forEach(t),q=c(o),g=a(o,"H1",{class:!0});var Qe=s(g);$=a(Qe,"A",{id:!0,class:!0,href:!0});var oo=s($);A=a(oo,"SPAN",{});var ks=s(A);v(j.$$.fragment,ks),ks.forEach(t),oo.forEach(t),D=c(Qe),L=a(Qe,"SPAN",{});var Vs=s(L);Lo=i(Vs,"VisionTextDualEncoder"),Vs.forEach(t),Qe.forEach(t),no=c(o),J=a(o,"H2",{class:!0});var go=s(J);ee=a(go,"A",{id:!0,class:!0,href:!0});var Ds=s(ee);Dt=a(Ds,"SPAN",{});var $s=s(Dt);v(he.$$.fragment,$s),$s.forEach(t),Ds.forEach(t),So=c(go),$t=a(go,"SPAN",{});var Ps=s($t);No=i(Ps,"Overview"),Ps.forEach(t),go.forEach(t),ao=c(o),u=a(o,"P",{});var k=s(u);Bo=i(k,"The "),tt=a(k,"A",{href:!0});var Ms=s(tt);Oo=i(Ms,"VisionTextDualEncoderModel"),Ms.forEach(t),Wo=i(k,` can be used to initialize a vision-text dual encoder model with
any pretrained vision autoencoding model as the vision encoder (`),Pt=a(k,"EM",{});var zs=s(Pt);Ro=i(zs,"e.g."),zs.forEach(t),Uo=c(k),ot=a(k,"A",{href:!0});var Cs=s(ot);Jo=i(Cs,"ViT"),Cs.forEach(t),Ho=i(k,", "),nt=a(k,"A",{href:!0});var Fs=s(nt);Zo=i(Fs,"BEiT"),Fs.forEach(t),Go=i(k,", "),at=a(k,"A",{href:!0});var Is=s(at);Xo=i(Is,"DeiT"),Is.forEach(t),Ko=i(k,") and any pretrained text autoencoding model as the text encoder ("),Mt=a(k,"EM",{});var As=s(Mt);Qo=i(As,"e.g."),As.forEach(t),Yo=c(k),st=a(k,"A",{href:!0});var qs=s(st);en=i(qs,"RoBERTa"),qs.forEach(t),tn=i(k,", "),rt=a(k,"A",{href:!0});var Ls=s(rt);on=i(Ls,"BERT"),Ls.forEach(t),nn=i(k,`). Two projection layers are added on top of both the vision and text encoder to project the output embeddings
to a shared latent space. The projection layers are randomly initialized so the model should be fine-tuned on a
downstream task. This model can be used to align the vision-text embeddings using CLIP like contrastive image-text
...
leveraging pre-trained (locked/frozen) image and text model for contrastive learning yields significant improvment on
new zero-shot vision tasks such as image classification or retrieval.`),_o.forEach(t),ro=c(o),H=a(o,"H2",{class:!0});var vo=s(H);oe=a(vo,"A",{id:!0,class:!0,href:!0});var Ns=s(oe);zt=a(Ns,"SPAN",{});var Bs=s(zt);v(ue.$$.fragment,Bs),Bs.forEach(t),Ns.forEach(t),ln=c(vo),Ct=a(vo,"SPAN",{});var Os=s(Ct);dn=i(Os,"VisionTextDualEncoderConfig"),Os.forEach(t),vo.forEach(t),io=c(o),w=a(o,"DIV",{class:!0});var F=s(w);v(ge.$$.fragment,F),cn=c(F),B=a(F,"P",{});var Ye=s(B);it=a(Ye,"A",{href:!0});var Ws=s(it);mn=i(Ws,"VisionTextDualEncoderConfig"),Ws.forEach(t),pn=i(Ye,` is the configuration class to store the configuration of a
...
specified arguments, defining the text model and vision model configs.`),Ye.forEach(t),_n=c(F),Z=a(F,"P",{});var wt=s(Z);vn=i(wt,"Configuration objects inherit from "),ct=a(wt,"A",{href:!0});var Js=s(ct);xn=i(Js,"PretrainedConfig"),Js.forEach(t),Tn=i(wt,` and can be used to control the model outputs. Read the
documentation from `),mt=a(wt,"A",{href:!0});var Hs=s(mt);En=i(Hs,"PretrainedConfig"),Hs.forEach(t),bn=i(wt," for more information."),wt.forEach(t),jn=c(F),Ft=a(F,"P",{});var Zs=s(Ft);wn=i(Zs,"Examples:"),Zs.forEach(t),yn=c(F),v(_e.$$.fragment,F),kn=c(F),ne=a(F,"DIV",{class:!0});var xo=s(ne);v(ve.$$.fragment,xo),Vn=c(xo),xe=a(xo,"P",{});var To=s(xe);Dn=i(To,"Instantiate a "),pt=a(To,"A",{href:!0});var Gs=s(pt);$n=i(Gs,"VisionTextDualEncoderConfig"),Gs.forEach(t),Pn=i(To,` (or a derived class) from text model configuration and vision
model configuration.`),To.forEach(t),xo.forEach(t),Mn=c(F),ae=a(F,"DIV",{class:!0});var Eo=s(ae);v(Te.$$.fragment,Eo),zn=c(Eo),Ee=a(Eo,"P",{});var bo=s(Ee);Cn=i(bo,"Serializes this instance to a Python dictionary. Override the default "),ht=a(bo,"A",{href:!0});var Xs=s(ht);Fn=i(Xs,"to_dict()"),Xs.forEach(t),In=i(bo,"."),bo.forEach(t),Eo.forEach(t),F.forEach(t),lo=c(o),G=a(o,"H2",{class:!0});var jo=s(G);se=a(jo,"A",{id:!0,class:!0,href:!0});var Ks=s(se);It=a(Ks,"SPAN",{});var Qs=s(It);v(be.$$.fragment,Qs),Qs.forEach(t),Ks.forEach(t),An=c(jo),At=a(jo,"SPAN",{});var Ys=s(At);qn=i(Ys,"VisionTextDualEncoderProcessor"),Ys.forEach(t),jo.forEach(t),co=c(o),P=a(o,"DIV",{class:!0});var O=s(P);v(je.$$.fragment,O),Ln=c(O),qt=a(O,"P",{});var er=s(qt);Sn=i(er,`Constructs a VisionTextDualEncoder processor which wraps a vision feature extractor and a tokenizer into a single
processor.`),er.forEach(t),Nn=c(O),M=a(O,"P",{});var N=s(M);ft=a(N,"A",{href:!0});var tr=s(ft);Bn=i(tr,"VisionTextDualEncoderProcessor"),tr.forEach(t),On=i(N," offers all the functionalities of "),ut=a(N,"A",{href:!0});var or=s(ut);Wn=i(or,"AutoFeatureExtractor"),or.forEach(t),Rn=i(N,` and
...
`),_t=a(N,"A",{href:!0});var sr=s(_t);Gn=i(sr,"decode()"),sr.forEach(t),Xn=i(N," for more information."),N.forEach(t),Kn=c(O),re=a(O,"DIV",{class:!0});var wo=s(re);v(we.$$.fragment,wo),Qn=c(wo),ye=a(wo,"P",{});var yo=s(ye);Yn=i(yo,`This method forwards all its arguments to VisionTextDualEncoderTokenizer\u2019s
`),vt=a(yo,"A",{href:!0});var rr=s(vt);ea=i(rr,"batch_decode()"),rr.forEach(t),ta=i(yo,". Please refer to the docstring of this method for more information."),yo.forEach(t),wo.forEach(t),oa=c(O),ie=a(O,"DIV",{class:!0});var ko=s(ie);v(ke.$$.fragment,ko),na=c(ko),Ve=a(ko,"P",{});var Vo=s(Ve);aa=i(Vo,"This method forwards all its arguments to VisionTextDualEncoderTokenizer\u2019s "),xt=a(Vo,"A",{href:!0});var ir=s(xt);sa=i(ir,"decode()"),ir.forEach(t),ra=i(Vo,`.
Please refer to the docstring of this method for more information.`),Vo.forEach(t),ko.forEach(t),O.forEach(t),mo=c(o),X=a(o,"H2",{class:!0});var Do=s(X);le=a(Do,"A",{id:!0,class:!0,href:!0});var lr=s(le);St=a(lr,"SPAN",{});var dr=s(St);v(De.$$.fragment,dr),dr.forEach(t),lr.forEach(t),ia=c(Do),Nt=a(Do,"SPAN",{});var cr=s(Nt);la=i(cr,"VisionTextDualEncoderModel"),cr.forEach(t),Do.forEach(t),po=c(o),y=a(o,"DIV",{class:!0});var I=s(y);v($e.$$.fragment,I),da=c(I),Pe=a(I,"P",{});var $o=s(Pe);ca=i($o,`This class can be used to initialize a vision-text dual encoder model with any pretrained vision autoencoding model
as the vision encoder and any pretrained text model as the text encoder. The vision and text encoders are loaded
...
leveraging pre-trained (locked/frozen) image and text model for contrastive learning yields significant improvment
on new zero-shot vision tasks such as image classification or retrieval.`),Po.forEach(t),_a=c(I),Ot=a(I,"P",{});var hr=s(Ot);va=i(hr,`After such a Vision-Text-Dual-Encoder model has been trained/fine-tuned, it can be saved/loaded just like any other
models (see the examples for more information).`),hr.forEach(t),xa=c(I),Ce=a(I,"P",{});var Mo=s(Ce);Ta=i(Mo,"This model inherits from "),Tt=a(Mo,"A",{href:!0});var fr=s(Tt);Ea=i(fr,"PreTrainedModel"),fr.forEach(t),ba=i(Mo,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),zo.forEach(t),Va=c(I),z=a(I,"DIV",{class:!0});var W=s(z);v(Ae.$$.fragment,W),Da=c(W),K=a(W,"P",{});var yt=s(K);$a=i(yt,"The "),Et=a(yt,"A",{href:!0});var gr=s(Et);Pa=i(gr,"VisionTextDualEncoderModel"),gr.forEach(t),Ma=i(yt," forward method, overrides the "),Wt=a(yt,"CODE",{});var _r=s(Wt);za=i(_r,"__call__"),_r.forEach(t),Ca=i(yt," special method."),yt.forEach(t),Fa=c(W),v(de.$$.fragment,W),Ia=c(W),Rt=a(W,"P",{});var vr=s(Rt);Aa=i(vr,"Examples:"),vr.forEach(t),qa=c(W),v(qe.$$.fragment,W),W.forEach(t),I.forEach(t),ho=c(o),Q=a(o,"H2",{class:!0});var Co=s(Q);ce=a(Co,"A",{id:!0,class:!0,href:!0});var xr=s(ce);Ut=a(xr,"SPAN",{});var Tr=s(Ut);v(Le.$$.fragment,Tr),Tr.forEach(t),xr.forEach(t),La=c(Co),Jt=a(Co,"SPAN",{});var Er=s(Jt);Sa=i(Er,"FlaxVisionTextDualEncoderModel"),Er.forEach(t),Co.forEach(t),fo=c(o),f=a(o,"DIV",{class:!0});var V=s(f);v(Se.$$.fragment,V),Na=c(V),Ne=a(V,"P",{});var Fo=s(Ne);Ba=i(Fo,`This class can be used to initialize a vision-text dual encoder model with any pretrained vision autoencoding model
as the vision encoder and any pretrained text model as the text encoder. The vision and text encoders are loaded
...
should be fine-tuned on a downstream task, like contrastive image-text modeling.`),Fo.forEach(t),Ra=c(V),Be=a(V,"P",{});var Io=s(Be);Ua=i(Io,"In "),Oe=a(Io,"A",{href:!0,rel:!0});var jr=s(Oe);Ja=i(jr,"LiT: Zero-Shot Transfer with Locked-image Text Tuning"),jr.forEach(t),Ha=i(Io,` it is shown how
leveraging pre-trained (locked/frozen) image and text model for contrastive learning yields significant improvment
...
models (see the examples for more information).`),wr.forEach(t),Xa=c(V),We=a(V,"P",{});var Ao=s(We);Ka=i(Ao,"This model inherits from "),bt=a(Ao,"A",{href:!0});var yr=s(bt);Qa=i(yr,"PreTrainedModel"),yr.forEach(t),Ya=i(Ao,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
