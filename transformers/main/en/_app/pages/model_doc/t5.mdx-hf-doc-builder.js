...
the latter silently ignores them.`)},l(l){p=r(l,"P",{});var u=i(p);b=s(u,"Although the recipe for forward pass needs to be defined within this function, one should call the "),g=r(u,"CODE",{});var q=i(g);_=s(q,"Module"),q.forEach(t),T=s(u,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),u.forEach(t)},m(l,u){m(l,p,u),e(p,b),e(p,g),e(g,_),e(p,T)},d(l){l&&t(p)}}}function Bw(j){let p,b,g,_,T;return _=new H({props:{code:`from transformers import T5Tokenizer, T5EncoderModel
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),{c(){p=a("p"),b=o("Example:"),g=d(),k(_.$$.fragment)},l(l){p=r(l,"P",{});var u=i(p);b=s(u,"Example:"),u.forEach(t),g=c(l),v(_.$$.fragment,l)},m(l,u){m(l,p,u),e(p,b),m(l,g,u),y(_,l,u),T=!0},p:ve,i(l){T||(w(_.$$.fragment,l),T=!0)},o(l){$(_.$$.fragment,l),T=!1},d(l){l&&t(p),l&&t(g),x(_,l)}}}function Ww(j){let p,b,g,_,T;return _=new H({props:{code:`# Here is an example of a device map on a machine with 4 GPUs using t5-3b, which has a total of 24 attention modules:
model = T5ForConditionalGeneration.from_pretrained("t5-3b")
device_map = {
    0: [0, 1, 2],
    1: [3, 4, 5, 6, 7, 8, 9],
...
model.parallelize(device_map)  <span class="hljs-comment"># Splits the model across several devices</span>
model.deparallelize()  <span class="hljs-comment"># Put the model back on cpu and cleans memory by calling torch.cuda.empty_cache()</span>`}}),{c(){p=a("p"),b=o("Example:"),g=d(),k(_.$$.fragment)},l(l){p=r(l,"P",{});var u=i(p);b=s(u,"Example:"),u.forEach(t),g=c(l),v(_.$$.fragment,l)},m(l,u){m(l,p,u),e(p,b),m(l,g,u),y(_,l,u),T=!0},p:ve,i(l){T||(w(_.$$.fragment,l),T=!0)},o(l){$(_.$$.fragment,l),T=!1},d(l){l&&t(p),l&&t(g),x(_,l)}}}function Hw(j){let p,b,g,_,T,l,u,q,Ge,qe,S,re,ie,E,Ue,K,Be,Fe,G,We,de,J,Re,Me,U,He,Ce,B,ye,Ke,ce,C,O,Pe,D,we,X,Q,$e,Ve,N,xe,ee,Ye,Ze,V,ze,Je,W,je,I,Xe,te,A,Qe,L,et,tt;return{c(){p=a("p"),b=o("TensorFlow models and layers in "),g=a("code"),_=o("transformers"),T=o(" accept two formats as input:"),l=d(),u=a("ul"),q=a("li"),Ge=o("having all inputs as keyword arguments (like PyTorch models), or"),qe=d(),S=a("li"),re=o("having all inputs as a list, tuple or dict in the first positional argument."),ie=d(),E=a("p"),Ue=o(`The reason the second format is supported is that Keras methods prefer this format when passing inputs to models
...
the Keras `),B=r(M,"CODE",{});var vt=i(B);ye=s(vt,"Functional"),vt.forEach(t),Ke=s(M,` API, there are three possibilities you can use to gather all the input Tensors in the first
...
about any of this, as you can just pass inputs like you would to any other Python function!`),_e.forEach(t),this.h()},h(){h(L,"href","https://keras.io/guides/making_new_layers_and_models_via_subclassing/"),h(L,"rel","nofollow")},m(z,F){m(z,p,F),e(p,b),e(p,g),e(g,_),e(p,T),m(z,l,F),m(z,u,F),e(u,q),e(q,Ge),e(u,qe),e(u,S),e(S,re),m(z,ie,F),m(z,E,F),e(E,Ue),e(E,K),e(K,Be),e(E,Fe),e(E,G),e(G,We),e(E,de),e(E,J),e(J,Re),e(E,Me),e(E,U),e(U,He),e(E,Ce),e(E,B),e(B,ye),e(E,Ke),m(z,ce,F),m(z,C,F),e(C,O),e(O,Pe),e(O,D),e(D,we),e(O,X),e(O,Q),e(Q,$e),e(C,Ve),e(C,N),e(N,xe),e(N,ee),e(ee,Ye),e(N,Ze),e(N,V),e(V,ze),e(C,Je),e(C,W),e(W,je),e(W,I),e(I,Xe),m(z,te,F),m(z,A,F),e(A,Qe),e(A,L),e(L,et),e(A,tt)},d(z){z&&t(p),z&&t(l),z&&t(u),z&&t(ie),z&&t(E),z&&t(ce),z&&t(C),z&&t(te),z&&t(A)}}}function Kw(j){let p,b,g,_,T;return{c(){p=a("p"),b=o("Although the recipe for forward pass needs to be defined within this function, one should call the "),g=a("code"),_=o("Module"),T=o(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(l){p=r(l,"P",{});var u=i(p);b=s(u,"Although the recipe for forward pass needs to be defined within this function, one should call the "),g=r(u,"CODE",{});var q=i(g);_=s(q,"Module"),q.forEach(t),T=s(u,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),{c(){p=a("p"),b=o("Examples:"),g=d(),k(_.$$.fragment)},l(l){p=r(l,"P",{});var u=i(p);b=s(u,"Examples:"),u.forEach(t),g=c(l),v(_.$$.fragment,l)},m(l,u){m(l,p,u),e(p,b),m(l,g,u),y(_,l,u),T=!0},p:ve,i(l){T||(w(_.$$.fragment,l),T=!0)},o(l){$(_.$$.fragment,l),T=!1},d(l){l&&t(p),l&&t(g),x(_,l)}}}function Yw(j){let p,b,g,_,T,l,u,q,Ge,qe,S,re,ie,E,Ue,K,Be,Fe,G,We,de,J,Re,Me,U,He,Ce,B,ye,Ke,ce,C,O,Pe,D,we,X,Q,$e,Ve,N,xe,ee,Ye,Ze,V,ze,Je,W,je,I,Xe,te,A,Qe,L,et,tt;return{c(){p=a("p"),b=o("TensorFlow models and layers in "),g=a("code"),_=o("transformers"),T=o(" accept two formats as input:"),l=d(),u=a("ul"),q=a("li"),Ge=o("having all inputs as keyword arguments (like PyTorch models), or"),qe=d(),S=a("li"),re=o("having all inputs as a list, tuple or dict in the first positional argument."),ie=d(),E=a("p"),Ue=o(`The reason the second format is supported is that Keras methods prefer this format when passing inputs to models
and layers. Because of this support, when using methods like `),K=a("code"),Be=o("model.fit()"),Fe=o(` things should \u201Cjust work\u201D for you - just
pass your inputs and labels in any format that `),G=a("code"),We=o("model.fit()"),de=o(` supports! If, however, you want to use the second
format outside of Keras methods like `),J=a("code"),Re=o("fit()"),Me=o(" and "),U=a("code"),He=o("predict()"),Ce=o(`, such as when creating your own layers or models with
the Keras `),B=a("code"),ye=o("Functional"),Ke=o(` API, there are three possibilities you can use to gather all the input Tensors in the first
...
`),I=r(Ee,"CODE",{});var Ae=i(I);Xe=s(Ae,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),Ae.forEach(t),Ee.forEach(t),R.forEach(t),te=c(z),A=r(z,"P",{});var _e=i(A);Qe=s(_e,`Note that when creating models and layers with
`),L=r(_e,"A",{href:!0,rel:!0});var wt=i(L);et=s(wt,"subclassing"),wt.forEach(t),tt=s(_e,` then you don\u2019t need to worry
about any of this, as you can just pass inputs like you would to any other Python function!`),_e.forEach(t),this.h()},h(){h(L,"href","https://keras.io/guides/making_new_layers_and_models_via_subclassing/"),h(L,"rel","nofollow")},m(z,F){m(z,p,F),e(p,b),e(p,g),e(g,_),e(p,T),m(z,l,F),m(z,u,F),e(u,q),e(q,Ge),e(u,qe),e(u,S),e(S,re),m(z,ie,F),m(z,E,F),e(E,Ue),e(E,K),e(K,Be),e(E,Fe),e(E,G),e(G,We),e(E,de),e(E,J),e(J,Re),e(E,Me),e(E,U),e(U,He),e(E,Ce),e(E,B),e(B,ye),e(E,Ke),m(z,ce,F),m(z,C,F),e(C,O),e(O,Pe),e(O,D),e(D,we),e(O,X),e(O,Q),e(Q,$e),e(C,Ve),e(C,N),e(N,xe),e(N,ee),e(ee,Ye),e(N,Ze),e(N,V),e(V,ze),e(C,Je),e(C,W),e(W,je),e(W,I),e(I,Xe),m(z,te,F),m(z,A,F),e(A,Qe),e(A,L),e(L,et),e(A,tt)},d(z){z&&t(p),z&&t(l),z&&t(u),z&&t(ie),z&&t(E),z&&t(ce),z&&t(C),z&&t(te),z&&t(A)}}}function Zw(j){let p,b,g,_,T;return{c(){p=a("p"),b=o("Although the recipe for forward pass needs to be defined within this function, one should call the "),g=a("code"),_=o("Module"),T=o(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(l){p=r(l,"P",{});var u=i(p);b=s(u,"Although the recipe for forward pass needs to be defined within this function, one should call the "),g=r(u,"CODE",{});var q=i(g);_=s(q,"Module"),q.forEach(t),T=s(u,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-built_in">print</span>(tokenizer.decode(outputs[<span class="hljs-number">0</span>], skip_special_tokens=<span class="hljs-literal">True</span>))
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-comment"># studies have shown that owning a dog is good for you</span>`}}),{c(){p=a("p"),b=o("Examples:"),g=d(),k(_.$$.fragment)},l(l){p=r(l,"P",{});var u=i(p);b=s(u,"Examples:"),u.forEach(t),g=c(l),v(_.$$.fragment,l)},m(l,u){m(l,p,u),e(p,b),m(l,g,u),y(_,l,u),T=!0},p:ve,i(l){T||(w(_.$$.fragment,l),T=!0)},o(l){$(_.$$.fragment,l),T=!1},d(l){l&&t(p),l&&t(g),x(_,l)}}}function Xw(j){let p,b,g,_,T,l,u,q,Ge,qe,S,re,ie,E,Ue,K,Be,Fe,G,We,de,J,Re,Me,U,He,Ce,B,ye,Ke,ce,C,O,Pe,D,we,X,Q,$e,Ve,N,xe,ee,Ye,Ze,V,ze,Je,W,je,I,Xe,te,A,Qe,L,et,tt;return{c(){p=a("p"),b=o("TensorFlow models and layers in "),g=a("code"),_=o("transformers"),T=o(" accept two formats as input:"),l=d(),u=a("ul"),q=a("li"),Ge=o("having all inputs as keyword arguments (like PyTorch models), or"),qe=d(),S=a("li"),re=o("having all inputs as a list, tuple or dict in the first positional argument."),ie=d(),E=a("p"),Ue=o(`The reason the second format is supported is that Keras methods prefer this format when passing inputs to models
and layers. Because of this support, when using methods like `),K=a("code"),Be=o("model.fit()"),Fe=o(` things should \u201Cjust work\u201D for you - just
pass your inputs and labels in any format that `),G=a("code"),We=o("model.fit()"),de=o(` supports! If, however, you want to use the second
format outside of Keras methods like `),J=a("code"),Re=o("fit()"),Me=o(" and "),U=a("code"),He=o("predict()"),Ce=o(`, such as when creating your own layers or models with
the Keras `),B=a("code"),ye=o("Functional"),Ke=o(` API, there are three possibilities you can use to gather all the input Tensors in the first
...
`),I=r(Ee,"CODE",{});var Ae=i(I);Xe=s(Ae,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),Ae.forEach(t),Ee.forEach(t),R.forEach(t),te=c(z),A=r(z,"P",{});var _e=i(A);Qe=s(_e,`Note that when creating models and layers with
`),L=r(_e,"A",{href:!0,rel:!0});var wt=i(L);et=s(wt,"subclassing"),wt.forEach(t),tt=s(_e,` then you don\u2019t need to worry
about any of this, as you can just pass inputs like you would to any other Python function!`),_e.forEach(t),this.h()},h(){h(L,"href","https://keras.io/guides/making_new_layers_and_models_via_subclassing/"),h(L,"rel","nofollow")},m(z,F){m(z,p,F),e(p,b),e(p,g),e(g,_),e(p,T),m(z,l,F),m(z,u,F),e(u,q),e(q,Ge),e(u,qe),e(u,S),e(S,re),m(z,ie,F),m(z,E,F),e(E,Ue),e(E,K),e(K,Be),e(E,Fe),e(E,G),e(G,We),e(E,de),e(E,J),e(J,Re),e(E,Me),e(E,U),e(U,He),e(E,Ce),e(E,B),e(B,ye),e(E,Ke),m(z,ce,F),m(z,C,F),e(C,O),e(O,Pe),e(O,D),e(D,we),e(O,X),e(O,Q),e(Q,$e),e(C,Ve),e(C,N),e(N,xe),e(N,ee),e(ee,Ye),e(N,Ze),e(N,V),e(V,ze),e(C,Je),e(C,W),e(W,je),e(W,I),e(I,Xe),m(z,te,F),m(z,A,F),e(A,Qe),e(A,L),e(L,et),e(A,tt)},d(z){z&&t(p),z&&t(l),z&&t(u),z&&t(ie),z&&t(E),z&&t(ce),z&&t(C),z&&t(te),z&&t(A)}}}function Qw(j){let p,b,g,_,T;return{c(){p=a("p"),b=o("Although the recipe for forward pass needs to be defined within this function, one should call the "),g=a("code"),_=o("Module"),T=o(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(l){p=r(l,"P",{});var u=i(p);b=s(u,"Although the recipe for forward pass needs to be defined within this function, one should call the "),g=r(u,"CODE",{});var q=i(g);_=s(q,"Module"),q.forEach(t),T=s(u,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
the latter silently ignores them.`)},l(l){p=r(l,"P",{});var u=i(p);b=s(u,"Although the recipe for forward pass needs to be defined within this function, one should call the "),g=r(u,"CODE",{});var q=i(g);_=s(q,"Module"),q.forEach(t),T=s(u,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),u.forEach(t)},m(l,u){m(l,p,u),e(p,b),e(p,g),e(g,_),e(p,T)},d(l){l&&t(p)}}}function c1(j){let p,b,g,_,T,l,u,q,Ge,qe,S,re,ie,E,Ue,K,Be,Fe,G,We,de,J,Re,Me,U,He,Ce,B,ye,Ke,ce,C,O,Pe,D,we,X,Q,$e,Ve,N,xe,ee,Ye,Ze,V,ze,Je,W,je,I,Xe,te,A,Qe,L,et,tt,z,F,bt,pe,nt,kt,M,Y,at,rt,Oe,vt,R,Z,it,Ne,ne,yt,lt,Ee,Ae,_e,wt,Pi,Oi,ss,bh,kh,Ni,br,as,vh,yh,ic,kr,wh,lc,Bt,Ai,Pn,Li,$h,xh,vr,zh,jh,Eh,Ii,On,Di,qh,Fh,yr,Mh,Ch,Ph,Si,Nn,Gi,Oh,Nh,wr,Ah,Lh,dc,An,Ih,rs,Dh,Sh,cc,Wt,Gh,is,Uh,Bh,ls,Wh,Rh,pc,$r,hc,tn,Ln,Ui,ds,Hh,Bi,Kh,uc,$t,Vh,Wi,Yh,Zh,Ri,Jh,Xh,Hi,Qh,eu,mc,In,tu,xr,nu,ou,fc,zr,Ki,su,_c,ge,au,Vi,ru,iu,Yi,lu,du,Zi,cu,pu,Ji,hu,uu,Xi,mu,fu,jr,_u,gu,gc,Er,Tu,Tc,cs,bc,Dn,bu,ps,ku,vu,kc,qr,Qi,yu,vc,Fr,wu,yc,hs,wc,le,$u,el,xu,zu,tl,ju,Eu,nl,qu,Fu,ol,Mu,Cu,sl,Pu,Ou,al,Nu,Au,rl,Lu,Iu,$c,Rt,Du,il,Su,Gu,ll,Uu,Bu,xc,Te,Wu,dl,Ru,Hu,cl,Ku,Vu,pl,Yu,Zu,hl,Ju,Xu,us,Qu,em,ul,tm,nm,zc,ms,jc,Mr,om,Ec,Cr,fs,sm,ml,am,rm,qc,Ht,im,_s,lm,dm,gs,cm,pm,Fc,Sn,hm,fl,um,mm,Mc,Pr,Cc,nn,Gn,_l,Ts,fm,gl,_m,Pc,xt,gm,Or,Tm,bm,bs,km,vm,ks,ym,wm,Oc,vs,Nc,dt,$m,Tl,xm,zm,bl,jm,Em,Nr,qm,Fm,kl,Mm,Cm,Ac,Ar,Pm,Lc,ys,Ic,Lr,Om,Dc,ws,Sc,Ir,Gc,on,Un,vl,$s,Nm,yl,Am,Uc,zt,Lm,xs,Im,Dm,wl,Sm,Gm,$l,Um,Bm,Bc,sn,Bn,xl,zs,Wm,zl,Rm,Wc,Dr,Hm,Rc,Wn,jl,an,Km,js,Vm,Ym,Es,Zm,Jm,Xm,El,ot,Qm,qs,ef,tf,Fs,nf,of,Ms,sf,af,Cs,rf,lf,Ps,df,cf,Hc,rn,Rn,ql,Os,pf,Fl,hf,Kc,St,Ns,uf,Gt,mf,Sr,ff,_f,Gr,gf,Tf,As,bf,kf,vf,ln,yf,Ur,wf,$f,Br,xf,zf,Vc,dn,Hn,Ml,Ls,jf,Cl,Ef,Yc,he,Is,qf,Ds,Ff,Ss,Mf,Cf,Pf,Gs,Of,Wr,Nf,Af,Lf,Kt,Us,If,Pl,Df,Sf,Bs,Rr,Gf,Ol,Uf,Bf,Hr,Wf,Nl,Rf,Hf,Kn,Ws,Kf,Rs,Vf,Al,Yf,Zf,Jf,Vn,Hs,Xf,Ll,Qf,e_,Kr,Ks,Zc,cn,Yn,Il,Vs,t_,Dl,n_,Jc,st,Ys,o_,pn,s_,Sl,a_,r_,Zs,i_,l_,d_,Js,c_,Vr,p_,h_,u_,Vt,Xs,m_,Gl,f_,__,Qs,Yr,g_,Ul,T_,b_,Zr,k_,Bl,v_,y_,Zn,ea,w_,Wl,$_,Xc,hn,Jn,Rl,ta,x_,Hl,z_,Qc,oe,na,j_,Kl,E_,q_,oa,F_,sa,M_,C_,P_,aa,O_,Jr,N_,A_,L_,ra,I_,ia,D_,S_,G_,jt,la,U_,un,B_,Xr,W_,R_,Vl,H_,K_,V_,Xn,Y_,Qn,Z_,Et,da,J_,Yl,X_,Q_,Zl,eg,tg,eo,ng,Yt,ca,og,Jl,sg,ag,to,ep,mn,no,Xl,pa,rg,Ql,ig,tp,se,ha,lg,ua,dg,ed,cg,pg,hg,ma,ug,fa,mg,fg,_g,_a,gg,Qr,Tg,bg,kg,ga,vg,Ta,yg,wg,$g,qt,ba,xg,fn,zg,ei,jg,Eg,td,qg,Fg,Mg,oo,Cg,so,Pg,Ft,ka,Og,nd,Ng,Ag,od,Lg,Ig,ao,Dg,Zt,va,Sg,sd,Gg,Ug,ro,np,_n,io,ad,ya,Bg,rd,Wg,op,ae,wa,Rg,id,Hg,Kg,$a,Vg,xa,Yg,Zg,Jg,za,Xg,ti,Qg,eT,tT,ja,nT,Ea,oT,sT,aT,Mt,qa,rT,gn,iT,ni,lT,dT,ld,cT,pT,hT,lo,uT,co,mT,Ct,Fa,fT,dd,_T,gT,cd,TT,bT,po,kT,Jt,Ma,vT,pd,yT,wT,ho,sp,Tn,uo,hd,Ca,$T,ud,xT,ap,ue,Pa,zT,md,jT,ET,Oa,qT,Na,FT,MT,CT,Aa,PT,oi,OT,NT,AT,La,LT,Ia,IT,DT,ST,mo,GT,Pt,Da,UT,bn,BT,si,WT,RT,fd,HT,KT,VT,fo,YT,_o,rp,kn,go,_d,Sa,ZT,gd,JT,ip,me,Ga,XT,Ua,QT,Td,eb,tb,nb,Ba,ob,Wa,sb,ab,rb,Ra,ib,ai,lb,db,cb,Ha,pb,Ka,hb,ub,mb,To,fb,Ot,Va,_b,vn,gb,ri,Tb,bb,bd,kb,vb,yb,bo,wb,ko,lp,yn,vo,kd,Ya,$b,vd,xb,dp,fe,Za,zb,yd,jb,Eb,Ja,qb,Xa,Fb,Mb,Cb,Qa,Pb,ii,Ob,Nb,Ab,er,Lb,tr,Ib,Db,Sb,yo,Gb,Nt,nr,Ub,wn,Bb,li,Wb,Rb,wd,Hb,Kb,Vb,wo,Yb,$o,cp,$n,xo,$d,or,Zb,xd,Jb,pp,_t,sr,Xb,At,ar,Qb,xn,ek,zd,tk,nk,jd,ok,sk,ak,zo,rk,jo,ik,Eo,rr,lk,qo,dk,Fo,ir,ck,Mo,hp,zn,Co,Ed,lr,pk,qd,hk,up,gt,dr,uk,Lt,cr,mk,jn,fk,Fd,_k,gk,Md,Tk,bk,kk,Po,vk,Oo,yk,No,pr,wk,Ao,$k,Lo,hr,xk,Io,mp,En,Do,Cd,ur,zk,Pd,jk,fp,qn,mr,Ek,Xt,fr,qk,Fn,Fk,di,Mk,Ck,Od,Pk,Ok,Nk,So,_p;return l=new be({}),E=new be({}),ds=new be({}),cs=new H({props:{code:`from transformers import T5Tokenizer, T5ForConditionalGeneration
...
behaviors between training and evaluation).`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/t5/modeling_tf_t5.py#L1161",returnDescription:`
<p>A <a
...
Labels for computing the cross entropy classification loss. Indices should be in <code>[0, ..., config.vocab_size - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/t5/modeling_tf_t5.py#L1341",returnDescription:`
<p>A <a
...
Whether or not to use the model in training mode (some modules like dropout modules have different
behaviors between training and evaluation).`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/t5/modeling_tf_t5.py#L1588",returnDescription:`
<p>A <a
...
Whether or not to return a <a href="/docs/transformers/main/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/t5/modeling_flax_t5.py#L1459"}}),So=new Dt({props:{$$slots:{default:[d1]},$$scope:{ctx:j}}}),{c(){p=a("meta"),b=d(),g=a("h1"),_=a("a"),T=a("span"),k(l.$$.fragment),u=d(),q=a("span"),Ge=o("T5"),qe=d(),S=a("h2"),re=a("a"),ie=a("span"),k(E.$$.fragment),Ue=d(),K=a("span"),Be=o("Overview"),Fe=d(),G=a("p"),We=o("The T5 model was presented in "),de=a("a"),J=o("Exploring the Limits of Transfer Learning with a Unified Text-to-Text Transformer"),Re=o(` by Colin Raffel, Noam Shazeer, Adam Roberts, Katherine Lee, Sharan Narang,
...
for summarization: `),xe=a("em"),ee=o("summarize: \u2026"),Ye=o("."),Ze=d(),V=a("li"),ze=a("p"),Je=o("T5 uses relative scalar embeddings. Encoder input padding can be done on the left and on the right."),W=d(),je=a("li"),I=a("p"),Xe=o("See the "),te=a("a"),A=o("training"),Qe=o(", "),L=a("a"),et=o("inference"),tt=o(" and "),z=a("a"),F=o("scripts"),bt=o(" sections below for all details regarding usage."),pe=d(),nt=a("p"),kt=o("T5 comes in different sizes:"),M=d(),Y=a("ul"),at=a("li"),rt=a("p"),Oe=a("a"),vt=o("t5-small"),R=d(),Z=a("li"),it=a("p"),Ne=a("a"),ne=o("t5-base"),yt=d(),lt=a("li"),Ee=a("p"),Ae=a("a"),_e=o("t5-large"),wt=d(),Pi=a("li"),Oi=a("p"),ss=a("a"),bh=o("t5-3b"),kh=d(),Ni=a("li"),br=a("p"),as=a("a"),vh=o("t5-11b"),yh=o("."),ic=d(),kr=a("p"),wh=o("Based on the original T5 model, Google has released some follow-up works:"),lc=d(),Bt=a("ul"),Ai=a("li"),Pn=a("p"),Li=a("strong"),$h=o("T5v1.1"),xh=o(`: T5v1.1 is an improved version of T5 with some architectural tweaks, and is pre-trained on C4 only without
...
to the documentation of byT5 which can be found `),wr=a("a"),Ah=o("here"),Lh=o("."),dc=d(),An=a("p"),Ih=o("All checkpoints can be found on the "),rs=a("a"),Dh=o("hub"),Sh=o("."),cc=d(),Wt=a("p"),Gh=o("This model was contributed by "),is=a("a"),Uh=o("thomwolf"),Bh=o(". The original code can be found "),ls=a("a"),Wh=o("here"),Rh=o("."),pc=d(),$r=a("a"),hc=d(),tn=a("h2"),Ln=a("a"),Ui=a("span"),k(ds.$$.fragment),Hh=d(),Bi=a("span"),Kh=o("Training"),uc=d(),$t=a("p"),Vh=o(`T5 is an encoder-decoder model and converts all NLP problems into a text-to-text format. It is trained using teacher
...
The predicted tokens will then be placed between the sentinel tokens.`),Dc=d(),k(ws.$$.fragment),Sc=d(),Ir=a("a"),Gc=d(),on=a("h2"),Un=a("a"),vl=a("span"),k($s.$$.fragment),Nm=d(),yl=a("span"),Am=o("Performance"),Uc=d(),zt=a("p"),Lm=o("If you\u2019d like a faster training and inference performance, install "),xs=a("a"),Im=o("apex"),Dm=o(" and then the model will automatically use "),wl=a("code"),Sm=o("apex.normalization.FusedRMSNorm"),Gm=o(" instead of "),$l=a("code"),Um=o("T5LayerNorm"),Bm=o(". The former uses an optimized fused kernel which is several times faster than the latter."),Bc=d(),sn=a("h2"),Bn=a("a"),xl=a("span"),k(zs.$$.fragment),Wm=d(),zl=a("span"),Rm=o("Example scripts"),Wc=d(),Dr=a("p"),Hm=o("T5 is supported by several example scripts, both for pre-training and fine-tuning."),Rc=d(),Wn=a("ul"),jl=a("li"),an=a("p"),Km=o("pre-training: the "),js=a("a"),Vm=o("run_t5_mlm_flax.py"),Ym=o(`
...
adding special tokens. A sequence has the following format:`),Sf=d(),Bs=a("ul"),Rr=a("li"),Gf=o("single sequence: "),Ol=a("code"),Uf=o("X </s>"),Bf=d(),Hr=a("li"),Wf=o("pair of sequences: "),Nl=a("code"),Rf=o("A </s> B </s>"),Hf=d(),Kn=a("div"),k(Ws.$$.fragment),Kf=d(),Rs=a("p"),Vf=o(`Retrieve sequence ids from a token list that has no special tokens added. This method is called when adding
...
adding special tokens. A sequence has the following format:`),__=d(),Qs=a("ul"),Yr=a("li"),g_=o("single sequence: "),Ul=a("code"),T_=o("X </s>"),b_=d(),Zr=a("li"),k_=o("pair of sequences: "),Bl=a("code"),v_=o("A </s> B </s>"),y_=d(),Zn=a("div"),k(ea.$$.fragment),w_=d(),Wl=a("p"),$_=o(`Create a mask from the two sequences passed to be used in a sequence-pair classification task. T5 does not make
...
it will evenly distribute blocks across all devices.`),Ig=d(),k(ao.$$.fragment),Dg=d(),Zt=a("div"),k(va.$$.fragment),Sg=d(),sd=a("p"),Gg=o("Moves the model to cpu from a model parallel state."),Ug=d(),k(ro.$$.fragment),np=d(),_n=a("h2"),io=a("a"),ad=a("span"),k(ya.$$.fragment),Bg=d(),rd=a("span"),Wg=o("T5EncoderModel"),op=d(),ae=a("div"),k(wa.$$.fragment),Rg=d(),id=a("p"),Hg=o("The bare T5 Model transformer outputting encoder\u2019s raw hidden-states without any specific head on top."),Kg=d(),$a=a("p"),Vg=o("The T5 model was proposed in "),xa=a("a"),Yg=o(`Exploring the Limits of Transfer Learning with a Unified Text-to-Text
...
behavior.`),ST=d(),k(mo.$$.fragment),GT=d(),Pt=a("div"),k(Da.$$.fragment),UT=d(),bn=a("p"),BT=o("The "),si=a("a"),WT=o("TFT5Model"),RT=o(" forward method, overrides the "),fd=a("code"),HT=o("__call__"),KT=o(" special method."),VT=d(),k(fo.$$.fragment),YT=d(),k(_o.$$.fragment),rp=d(),kn=a("h2"),go=a("a"),_d=a("span"),k(Sa.$$.fragment),ZT=d(),gd=a("span"),JT=o("TFT5ForConditionalGeneration"),ip=d(),me=a("div"),k(Ga.$$.fragment),XT=d(),Ua=a("p"),QT=o("T5 Model with a "),Td=a("code"),eb=o("language modeling"),tb=o(" head on top."),nb=d(),Ba=a("p"),ob=o("The T5 model was proposed in "),Wa=a("a"),sb=o(`Exploring the Limits of Transfer Learning with a Unified Text-to-Text
...
for summarization: `),xe=r(Cn,"EM",{});var Vd=i(xe);ee=s(Vd,"summarize: \u2026"),Vd.forEach(t),Ye=s(Cn,"."),Cn.forEach(t),Hd.forEach(t),Ze=c(Mn),V=r(Mn,"LI",{});var Yd=i(V);ze=r(Yd,"P",{});var Zd=i(ze);Je=s(Zd,"T5 uses relative scalar embeddings. Encoder input padding can be done on the left and on the right."),Zd.forEach(t),Yd.forEach(t),W=c(Mn),je=r(Mn,"LI",{});var Jd=i(je);I=r(Jd,"P",{});var Ut=i(I);Xe=s(Ut,"See the "),te=r(Ut,"A",{href:!0});var Xd=i(te);A=s(Xd,"training"),Xd.forEach(t),Qe=s(Ut,", "),L=r(Ut,"A",{href:!0});var Qd=i(L);et=s(Qd,"inference"),Qd.forEach(t),tt=s(Ut," and "),z=r(Ut,"A",{href:!0});var ec=i(z);F=s(ec,"scripts"),ec.forEach(t),bt=s(Ut," sections below for all details regarding usage."),Ut.forEach(t),Jd.forEach(t),Mn.forEach(t),pe=c(n),nt=r(n,"P",{});var tc=i(nt);kt=s(tc,"T5 comes in different sizes:"),tc.forEach(t),M=c(n),Y=r(n,"UL",{});var Tt=i(Y);at=r(Tt,"LI",{});var nc=i(at);rt=r(nc,"P",{});var oc=i(rt);Oe=r(oc,"A",{href:!0,rel:!0});var Gk=i(Oe);vt=s(Gk,"t5-small"),Gk.forEach(t),oc.forEach(t),nc.forEach(t),R=c(Tt),Z=r(Tt,"LI",{});var Uk=i(Z);it=r(Uk,"P",{});var Bk=i(it);Ne=r(Bk,"A",{href:!0,rel:!0});var Wk=i(Ne);ne=s(Wk,"t5-base"),Wk.forEach(t),Bk.forEach(t),Uk.forEach(t),yt=c(Tt),lt=r(Tt,"LI",{});var Rk=i(lt);Ee=r(Rk,"P",{});var Hk=i(Ee);Ae=r(Hk,"A",{href:!0,rel:!0});var Kk=i(Ae);_e=s(Kk,"t5-large"),Kk.forEach(t),Hk.forEach(t),Rk.forEach(t),wt=c(Tt),Pi=r(Tt,"LI",{});var Vk=i(Pi);Oi=r(Vk,"P",{});var Yk=i(Oi);ss=r(Yk,"A",{href:!0,rel:!0});var Zk=i(ss);bh=s(Zk,"t5-3b"),Zk.forEach(t),Yk.forEach(t),Vk.forEach(t),kh=c(Tt),Ni=r(Tt,"LI",{});var Jk=i(Ni);br=r(Jk,"P",{});var Ak=i(br);as=r(Ak,"A",{href:!0,rel:!0});var Xk=i(as);vh=s(Xk,"t5-11b"),Xk.forEach(t),yh=s(Ak,"."),Ak.forEach(t),Jk.forEach(t),Tt.forEach(t),ic=c(n),kr=r(n,"P",{});var Qk=i(kr);wh=s(Qk,"Based on the original T5 model, Google has released some follow-up works:"),Qk.forEach(t),lc=c(n),Bt=r(n,"UL",{});var ci=i(Bt);Ai=r(ci,"LI",{});var ev=i(Ai);Pn=r(ev,"P",{});var sc=i(Pn);Li=r(sc,"STRONG",{});var tv=i(Li);$h=s(tv,"T5v1.1"),tv.forEach(t),xh=s(sc,`: T5v1.1 is an improved version of T5 with some architectural tweaks, and is pre-trained on C4 only without
...
to the documentation of byT5 which can be found `),wr=r(rc,"A",{href:!0});var lv=i(wr);Ah=s(lv,"here"),lv.forEach(t),Lh=s(rc,"."),rc.forEach(t),rv.forEach(t),ci.forEach(t),dc=c(n),An=r(n,"P",{});var gp=i(An);Ih=s(gp,"All checkpoints can be found on the "),rs=r(gp,"A",{href:!0,rel:!0});var dv=i(rs);Dh=s(dv,"hub"),dv.forEach(t),Sh=s(gp,"."),gp.forEach(t),cc=c(n),Wt=r(n,"P",{});var pi=i(Wt);Gh=s(pi,"This model was contributed by "),is=r(pi,"A",{href:!0,rel:!0});var cv=i(is);Uh=s(cv,"thomwolf"),cv.forEach(t),Bh=s(pi,". The original code can be found "),ls=r(pi,"A",{href:!0,rel:!0});var pv=i(ls);Wh=s(pv,"here"),pv.forEach(t),Rh=s(pi,"."),pi.forEach(t),pc=c(n),$r=r(n,"A",{id:!0}),i($r).forEach(t),hc=c(n),tn=r(n,"H2",{class:!0});var Tp=i(tn);Ln=r(Tp,"A",{id:!0,class:!0,href:!0});var hv=i(Ln);Ui=r(hv,"SPAN",{});var uv=i(Ui);v(ds.$$.fragment,uv),uv.forEach(t),hv.forEach(t),Hh=c(Tp),Bi=r(Tp,"SPAN",{});var mv=i(Bi);Kh=s(mv,"Training"),mv.forEach(t),Tp.forEach(t),uc=c(n),$t=r(n,"P",{});var Go=i($t);Vh=s(Go,`T5 is an encoder-decoder model and converts all NLP problems into a text-to-text format. It is trained using teacher
forcing. This means that for training, we always need an input sequence and a corresponding target sequence. The input
sequence is fed to the model using `),Wi=r(Go,"CODE",{});var fv=i(Wi);Yh=s(fv,"input_ids"),fv.forEach(t),Zh=s(Go,`. The target sequence is shifted to the right, i.e., prepended by a
...
batches. This entails that we must pad/truncate examples to the same length. For encoder-decoder models, one
typically defines a `),il=r(hi,"CODE",{});var Dv=i(il);Su=s(Dv,"max_source_length"),Dv.forEach(t),Gu=s(hi," and "),ll=r(hi,"CODE",{});var Sv=i(ll);Uu=s(Sv,"max_target_length"),Sv.forEach(t),Bu=s(hi,`, which determine the maximum length of the
input and output sequences respectively (otherwise they are truncated). These should be carefully set depending on
the task.`),hi.forEach(t),xc=c(n),Te=r(n,"P",{});var pt=i(Te);Wu=s(pt,"In addition, we must make sure that padding token id\u2019s of the "),dl=r(pt,"CODE",{});var Gv=i(dl);Ru=s(Gv,"labels"),Gv.forEach(t),Hu=s(pt,` are not taken into account by the loss
...
of the `),pl=r(pt,"CODE",{});var Bv=i(pl);Yu=s(Bv,"CrossEntropyLoss"),Bv.forEach(t),Zu=s(pt,". In Flax, one can use the "),hl=r(pt,"CODE",{});var Wv=i(hl);Ju=s(Wv,"decoder_attention_mask"),Wv.forEach(t),Xu=s(pt,` to ignore padded tokens from
...
it can be used to predict the sentinel (masked-out) tokens during inference.
The predicted tokens will then be placed between the sentinel tokens.`),cy.forEach(t),Dc=c(n),v(ws.$$.fragment,n),Sc=c(n),Ir=r(n,"A",{id:!0}),i(Ir).forEach(t),Gc=c(n),on=r(n,"H2",{class:!0});var $p=i(on);Un=r($p,"A",{id:!0,class:!0,href:!0});var py=i(Un);vl=r(py,"SPAN",{});var hy=i(vl);v($s.$$.fragment,hy),hy.forEach(t),py.forEach(t),Nm=c($p),yl=r($p,"SPAN",{});var uy=i(yl);Am=s(uy,"Performance"),uy.forEach(t),$p.forEach(t),Uc=c(n),zt=r(n,"P",{});var Bo=i(zt);Lm=s(Bo,"If you\u2019d like a faster training and inference performance, install "),xs=r(Bo,"A",{href:!0,rel:!0});var my=i(xs);Im=s(my,"apex"),my.forEach(t),Dm=s(Bo," and then the model will automatically use "),wl=r(Bo,"CODE",{});var fy=i(wl);Sm=s(fy,"apex.normalization.FusedRMSNorm"),fy.forEach(t),Gm=s(Bo," instead of "),$l=r(Bo,"CODE",{});var _y=i($l);Um=s(_y,"T5LayerNorm"),_y.forEach(t),Bm=s(Bo,". The former uses an optimized fused kernel which is several times faster than the latter."),Bo.forEach(t),Bc=c(n),sn=r(n,"H2",{class:!0});var xp=i(sn);Bn=r(xp,"A",{id:!0,class:!0,href:!0});var gy=i(Bn);xl=r(gy,"SPAN",{});var Ty=i(xl);v(zs.$$.fragment,Ty),Ty.forEach(t),gy.forEach(t),Wm=c(xp),zl=r(xp,"SPAN",{});var by=i(zl);Rm=s(by,"Example scripts"),by.forEach(t),xp.forEach(t),Wc=c(n),Dr=r(n,"P",{});var ky=i(Dr);Hm=s(ky,"T5 is supported by several example scripts, both for pre-training and fine-tuning."),ky.forEach(t),Rc=c(n),Wn=r(n,"UL",{});var zp=i(Wn);jl=r(zp,"LI",{});var vy=i(jl);an=r(vy,"P",{});var mi=i(an);Km=s(mi,"pre-training: the "),js=r(mi,"A",{href:!0,rel:!0});var yy=i(js);Vm=s(yy,"run_t5_mlm_flax.py"),yy.forEach(t),Ym=s(mi,`
...
you to easily fine-tune T5 on custom data for summarization/translation.`),It.forEach(t),$y.forEach(t),zp.forEach(t),Hc=c(n),rn=r(n,"H2",{class:!0});var jp=i(rn);Rn=r(jp,"A",{id:!0,class:!0,href:!0});var Fy=i(Rn);ql=r(Fy,"SPAN",{});var My=i(ql);v(Os.$$.fragment,My),My.forEach(t),Fy.forEach(t),pf=c(jp),Fl=r(jp,"SPAN",{});var Cy=i(Fl);hf=s(Cy,"T5Config"),Cy.forEach(t),jp.forEach(t),Kc=c(n),St=r(n,"DIV",{class:!0});var fi=i(St);v(Ns.$$.fragment,fi),uf=c(fi),Gt=r(fi,"P",{});var Wo=i(Gt);mf=s(Wo,"This is the configuration class to store the configuration of a "),Sr=r(Wo,"A",{href:!0});var Py=i(Sr);ff=s(Py,"T5Model"),Py.forEach(t),_f=s(Wo," or a "),Gr=r(Wo,"A",{href:!0});var Oy=i(Gr);gf=s(Oy,"TFT5Model"),Oy.forEach(t),Tf=s(Wo,`. It is used to
instantiate a T5 model according to the specified arguments, defining the model architecture. Instantiating a
configuration with the defaults will yield a similar configuration to that of the T5
`),As=r(Wo,"A",{href:!0,rel:!0});var Ny=i(As);bf=s(Ny,"t5-small"),Ny.forEach(t),kf=s(Wo," architecture."),Wo.forEach(t),vf=c(fi),ln=r(fi,"P",{});var _i=i(ln);yf=s(_i,"Configuration objects inherit from "),Ur=r(_i,"A",{href:!0});var Ay=i(Ur);wf=s(Ay,"PretrainedConfig"),Ay.forEach(t),$f=s(_i,` and can be used to control the model outputs. Read the
...
this superclass for more information regarding those methods.`),Fp.forEach(t),Lf=c(ht),Kt=r(ht,"DIV",{class:!0});var gi=i(Kt);v(Us.$$.fragment,gi),If=c(gi),Pl=r(gi,"P",{});var By=i(Pl);Df=s(By,`Build model inputs from a sequence or a pair of sequence for sequence classification tasks by concatenating and
adding special tokens. A sequence has the following format:`),By.forEach(t),Sf=c(gi),Bs=r(gi,"UL",{});var Mp=i(Bs);Rr=r(Mp,"LI",{});var Lk=i(Rr);Gf=s(Lk,"single sequence: "),Ol=r(Lk,"CODE",{});var Wy=i(Ol);Uf=s(Wy,"X </s>"),Wy.forEach(t),Lk.forEach(t),Bf=c(Mp),Hr=r(Mp,"LI",{});var Ik=i(Hr);Wf=s(Ik,"pair of sequences: "),Nl=r(Ik,"CODE",{});var Ry=i(Nl);Rf=s(Ry,"A </s> B </s>"),Ry.forEach(t),Ik.forEach(t),Mp.forEach(t),gi.forEach(t),Hf=c(ht),Kn=r(ht,"DIV",{class:!0});var Cp=i(Kn);v(Ws.$$.fragment,Cp),Kf=c(Cp),Rs=r(Cp,"P",{});var Pp=i(Rs);Vf=s(Pp,`Retrieve sequence ids from a token list that has no special tokens added. This method is called when adding
...
adding special tokens. A sequence has the following format:`),t5.forEach(t),__=c(bi),Qs=r(bi,"UL",{});var Lp=i(Qs);Yr=r(Lp,"LI",{});var Dk=i(Yr);g_=s(Dk,"single sequence: "),Ul=r(Dk,"CODE",{});var n5=i(Ul);T_=s(n5,"X </s>"),n5.forEach(t),Dk.forEach(t),b_=c(Lp),Zr=r(Lp,"LI",{});var Sk=i(Zr);k_=s(Sk,"pair of sequences: "),Bl=r(Sk,"CODE",{});var o5=i(Bl);v_=s(o5,"A </s> B </s>"),o5.forEach(t),Sk.forEach(t),Lp.forEach(t),bi.forEach(t),y_=c(en),Zn=r(en,"DIV",{class:!0});var Ip=i(Zn);v(ea.$$.fragment,Ip),w_=c(Ip),Wl=r(Ip,"P",{});var s5=i(Wl);$_=s(s5,`Create a mask from the two sequences passed to be used in a sequence-pair classification task. T5 does not make
...
it will evenly distribute blocks across all devices.`),j5.forEach(t),Ig=c(Vo),v(ao.$$.fragment,Vo),Vo.forEach(t),Dg=c(De),Zt=r(De,"DIV",{class:!0});var wi=i(Zt);v(va.$$.fragment,wi),Sg=c(wi),sd=r(wi,"P",{});var E5=i(sd);Gg=s(E5,"Moves the model to cpu from a model parallel state."),E5.forEach(t),Ug=c(wi),v(ro.$$.fragment,wi),wi.forEach(t),De.forEach(t),np=c(n),_n=r(n,"H2",{class:!0});var Vp=i(_n);io=r(Vp,"A",{id:!0,class:!0,href:!0});var q5=i(io);ad=r(q5,"SPAN",{});var F5=i(ad);v(ya.$$.fragment,F5),F5.forEach(t),q5.forEach(t),Bg=c(Vp),rd=r(Vp,"SPAN",{});var M5=i(rd);Wg=s(M5,"T5EncoderModel"),M5.forEach(t),Vp.forEach(t),op=c(n),ae=r(n,"DIV",{class:!0});var Se=i(ae);v(wa.$$.fragment,Se),Rg=c(Se),id=r(Se,"P",{});var C5=i(id);Hg=s(C5,"The bare T5 Model transformer outputting encoder\u2019s raw hidden-states without any specific head on top."),C5.forEach(t),Kg=c(Se),$a=r(Se,"P",{});var Yp=i($a);Vg=s(Yp,"The T5 model was proposed in "),xa=r(Yp,"A",{href:!0,rel:!0});var P5=i(xa);Yg=s(P5,`Exploring the Limits of Transfer Learning with a Unified Text-to-Text
...
it will evenly distribute blocks across all devices.`),D5.forEach(t),bT=c(Zo),v(po.$$.fragment,Zo),Zo.forEach(t),kT=c(Se),Jt=r(Se,"DIV",{class:!0});var xi=i(Jt);v(Ma.$$.fragment,xi),vT=c(xi),pd=r(xi,"P",{});var S5=i(pd);yT=s(S5,"Moves the model to cpu from a model parallel state."),S5.forEach(t),wT=c(xi),v(ho.$$.fragment,xi),xi.forEach(t),Se.forEach(t),sp=c(n),Tn=r(n,"H2",{class:!0});var Xp=i(Tn);uo=r(Xp,"A",{id:!0,class:!0,href:!0});var G5=i(uo);hd=r(G5,"SPAN",{});var U5=i(hd);v(Ca.$$.fragment,U5),U5.forEach(t),G5.forEach(t),$T=c(Xp),ud=r(Xp,"SPAN",{});var B5=i(ud);xT=s(B5,"TFT5Model"),B5.forEach(t),Xp.forEach(t),ap=c(n),ue=r(n,"DIV",{class:!0});var ut=i(ue);v(Pa.$$.fragment,ut),zT=c(ut),md=r(ut,"P",{});var W5=i(md);jT=s(W5,"The bare T5 Model transformer outputting raw hidden-stateswithout any specific head on top."),W5.forEach(t),ET=c(ut),Oa=r(ut,"P",{});var Qp=i(Oa);qT=s(Qp,"The T5 model was proposed in "),Na=r(Qp,"A",{href:!0,rel:!0});var R5=i(Na);FT=s(R5,`Exploring the Limits of Transfer Learning with a Unified Text-to-Text
