import{S as Lm,i as Sm,s as Dm,e as n,k as l,w as v,t as s,M as Gm,c as a,d as t,m as c,a as r,x as y,h as d,b as h,G as e,g as f,y as T,q as w,o as $,B as x,v as Wm,L as nt}from"../../chunks/vendor-hf-doc-builder.js";import{T as xo}from"../../chunks/Tip-hf-doc-builder.js";import{D as P}from"../../chunks/Docstring-hf-doc-builder.js";import{C as Ve}from"../../chunks/CodeBlock-hf-doc-builder.js";import{I as ce}from"../../chunks/IconCopyLink-hf-doc-builder.js";import{E as ot}from"../../chunks/ExampleCodeBlock-hf-doc-builder.js";function Um(z){let p,k,g,u,b;return u=new Ve({props:{code:`from transformers import BlenderbotModel, BlenderbotConfig
...
<span class="hljs-meta">&gt;&gt;&gt; </span>configuration = model.config`}}),{c(){p=n("p"),k=s("Example:"),g=l(),v(u.$$.fragment)},l(i){p=a(i,"P",{});var m=r(p);k=d(m,"Example:"),m.forEach(t),g=c(i),y(u.$$.fragment,i)},m(i,m){f(i,p,m),e(p,k),f(i,g,m),T(u,i,m),b=!0},p:nt,i(i){b||(w(u.$$.fragment,i),b=!0)},o(i){$(u.$$.fragment,i),b=!1},d(i){i&&t(p),i&&t(g),x(u,i)}}}function Rm(z){let p,k,g,u,b;return{c(){p=n("p"),k=s("Although the recipe for forward pass needs to be defined within this function, one should call the "),g=n("code"),u=s("Module"),b=s(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(i){p=a(i,"P",{});var m=r(p);k=d(m,"Although the recipe for forward pass needs to be defined within this function, one should call the "),g=a(m,"CODE",{});var F=r(g);u=d(F,"Module"),F.forEach(t),b=d(m,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
[<span class="hljs-number">1</span>, <span class="hljs-number">6</span>, <span class="hljs-number">1280</span>]`}}),{c(){p=n("p"),k=s("Example:"),g=l(),v(u.$$.fragment)},l(i){p=a(i,"P",{});var m=r(p);k=d(m,"Example:"),m.forEach(t),g=c(i),y(u.$$.fragment,i)},m(i,m){f(i,p,m),e(p,k),f(i,g,m),T(u,i,m),b=!0},p:nt,i(i){b||(w(u.$$.fragment,i),b=!0)},o(i){$(u.$$.fragment,i),b=!1},d(i){i&&t(p),i&&t(g),x(u,i)}}}function Vm(z){let p,k,g,u,b;return{c(){p=n("p"),k=s("Although the recipe for forward pass needs to be defined within this function, one should call the "),g=n("code"),u=s("Module"),b=s(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(i){p=a(i,"P",{});var m=r(p);k=d(m,"Although the recipe for forward pass needs to be defined within this function, one should call the "),g=a(m,"CODE",{});var F=r(g);u=d(F,"Module"),F.forEach(t),b=d(m,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
`),U=a(re,"CODE",{});var dt=r(U);Se=d(dt,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),dt.forEach(t),re.forEach(t),V.forEach(t)},m(B,q){f(B,p,q),e(p,k),f(B,g,q),f(B,u,q),e(u,b),e(b,i),e(u,m),e(u,F),e(F,Me),f(B,pe,q),f(B,E,q),e(E,fe),e(E,te),e(te,Ce),e(E,oe),e(E,ne),e(ne,je),e(E,we),f(B,G,q),f(B,N,q),e(N,_e),f(B,R,q),f(B,M,q),e(M,j),e(j,Oe),e(j,J),e(J,Q),e(j,Pe),e(j,W),e(W,Ne),e(M,Ae),e(M,A),e(A,he),e(A,ae),e(ae,$e),e(A,ue),e(A,H),e(H,Ie),e(M,xe),e(M,C),e(C,Le),e(C,U),e(U,Se)},d(B){B&&t(p),B&&t(g),B&&t(u),B&&t(pe),B&&t(E),B&&t(G),B&&t(N),B&&t(R),B&&t(M)}}}function Xm(z){let p,k,g,u,b;return{c(){p=n("p"),k=s("Although the recipe for forward pass needs to be defined within this function, one should call the "),g=n("code"),u=s("Module"),b=s(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(i){p=a(i,"P",{});var m=r(p);k=d(m,"Although the recipe for forward pass needs to be defined within this function, one should call the "),g=a(m,"CODE",{});var F=r(g);u=d(F,"Module"),F.forEach(t),b=d(m,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),{c(){p=n("p"),k=s("Example:"),g=l(),v(u.$$.fragment)},l(i){p=a(i,"P",{});var m=r(p);k=d(m,"Example:"),m.forEach(t),g=c(i),y(u.$$.fragment,i)},m(i,m){f(i,p,m),e(p,k),f(i,g,m),T(u,i,m),b=!0},p:nt,i(i){b||(w(u.$$.fragment,i),b=!0)},o(i){$(u.$$.fragment,i),b=!1},d(i){i&&t(p),i&&t(g),x(u,i)}}}function Zm(z){let p,k,g,u,b,i,m,F,Me,pe,E,fe,te,Ce,oe,ne,je,we,G,N,_e,R,M,j,Oe,J,Q,Pe,W,Ne,Ae,A,he,ae,$e,ue,H,Ie,xe,C,Le,U,Se;return{c(){p=n("p"),k=s("TF 2.0 models accepts two formats as inputs:"),g=l(),u=n("ul"),b=n("li"),i=s("having all inputs as keyword arguments (like PyTorch models), or"),m=l(),F=n("li"),Me=s("having all inputs as a list, tuple or dict in the first positional arguments."),pe=l(),E=n("p"),fe=s("This second option is useful when using "),te=n("code"),Ce=s("tf.keras.Model.fit"),oe=s(` method which currently requires having all the
tensors in the first argument of the model call function: `),ne=n("code"),je=s("model(inputs)"),we=s("."),G=l(),N=n("p"),_e=s(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),R=l(),M=n("ul"),j=n("li"),Oe=s("a single Tensor with "),J=n("code"),Q=s("input_ids"),Pe=s(" only and nothing else: "),W=n("code"),Ne=s("model(input_ids)"),Ae=l(),A=n("li"),he=s(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),ae=n("code"),$e=s("model([input_ids, attention_mask])"),ue=s(" or "),H=n("code"),Ie=s("model([input_ids, attention_mask, token_type_ids])"),xe=l(),C=n("li"),Le=s(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),U=n("code"),Se=s('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(B){p=a(B,"P",{});var q=r(p);k=d(q,"TF 2.0 models accepts two formats as inputs:"),q.forEach(t),g=c(B),u=a(B,"UL",{});var ge=r(u);b=a(ge,"LI",{});var at=r(b);i=d(at,"having all inputs as keyword arguments (like PyTorch models), or"),at.forEach(t),m=c(ge),F=a(ge,"LI",{});var Ke=r(F);Me=d(Ke,"having all inputs as a list, tuple or dict in the first positional arguments."),Ke.forEach(t),ge.forEach(t),pe=c(B),E=a(B,"P",{});var O=r(E);fe=d(O,"This second option is useful when using "),te=a(O,"CODE",{});var me=r(te);Ce=d(me,"tf.keras.Model.fit"),me.forEach(t),oe=d(O,` method which currently requires having all the
...
the latter silently ignores them.`)},l(i){p=a(i,"P",{});var m=r(p);k=d(m,"Although the recipe for forward pass needs to be defined within this function, one should call the "),g=a(m,"CODE",{});var F=r(g);u=d(F,"Module"),F.forEach(t),b=d(m,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),m.forEach(t)},m(i,m){f(i,p,m),e(p,k),e(p,g),e(g,u),e(p,b)},d(i){i&&t(p)}}}function tf(z){let p,k,g,u,b;return{c(){p=n("p"),k=s("Although the recipe for forward pass needs to be defined within this function, one should call the "),g=n("code"),u=s("Module"),b=s(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(i){p=a(i,"P",{});var m=r(p);k=d(m,"Although the recipe for forward pass needs to be defined within this function, one should call the "),g=a(m,"CODE",{});var F=r(g);u=d(F,"Module"),F.forEach(t),b=d(m,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
<span class="hljs-meta">&gt;&gt;&gt; </span>encoder_outputs = model.encode(**inputs)`}}),{c(){p=n("p"),k=s("Example:"),g=l(),v(u.$$.fragment)},l(i){p=a(i,"P",{});var m=r(p);k=d(m,"Example:"),m.forEach(t),g=c(i),y(u.$$.fragment,i)},m(i,m){f(i,p,m),e(p,k),f(i,g,m),T(u,i,m),b=!0},p:nt,i(i){b||(w(u.$$.fragment,i),b=!0)},o(i){$(u.$$.fragment,i),b=!1},d(i){i&&t(p),i&&t(g),x(u,i)}}}function af(z){let p,k,g,u,b;return u=new Ve({props:{code:`import jax.numpy as jnp
...
the latter silently ignores them.`)},l(i){p=a(i,"P",{});var m=r(p);k=d(m,"Although the recipe for forward pass needs to be defined within this function, one should call the "),g=a(m,"CODE",{});var F=r(g);u=d(F,"Module"),F.forEach(t),b=d(m,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),m.forEach(t)},m(i,m){f(i,p,m),e(p,k),e(p,g),e(g,u),e(p,b)},d(i){i&&t(p)}}}function sf(z){let p,k,g,u,b;return u=new Ve({props:{code:`from transformers import BlenderbotTokenizer, FlaxBlenderbotForConditionalGeneration
...
<span class="hljs-meta">&gt;&gt;&gt; </span>outputs = model.decode(decoder_input_ids, encoder_outputs)
<span class="hljs-meta">&gt;&gt;&gt; </span>logits = outputs.logits`}}),{c(){p=n("p"),k=s("Example:"),g=l(),v(u.$$.fragment)},l(i){p=a(i,"P",{});var m=r(p);k=d(m,"Example:"),m.forEach(t),g=c(i),y(u.$$.fragment,i)},m(i,m){f(i,p,m),e(p,k),f(i,g,m),T(u,i,m),b=!0},p:nt,i(i){b||(w(u.$$.fragment,i),b=!0)},o(i){$(u.$$.fragment,i),b=!1},d(i){i&&t(p),i&&t(g),x(u,i)}}}function lf(z){let p,k,g,u,b,i,m,F,Me,pe,E,fe,te,Ce,oe,ne,je,we,G,N,_e,R,M,j,Oe,J,Q,Pe,W,Ne,Ae,A,he,ae,$e,ue,H,Ie,xe,C,Le,U,Se,B,q,ge,at,Ke,O,me,De,be,V,K,rt,Je,I,ke,st,re,dt,Fd,qd,Bo,Ed,zo,Md,Cd,jd,Ge,Od,za,Pd,Nd,Fa,Ad,Id,Kn,Ld,Sd,bs,it,qt,qa,Fo,Dd,Ea,Gd,ks,Jn,Wd,vs,qo,ys,lt,Et,Ma,Eo,Ud,Ca,Rd,Ts,ve,Mo,Hd,ct,Vd,Qn,Kd,Jd,Co,Qd,Xd,Yd,pt,Zd,Xn,ei,ti,Yn,oi,ni,ai,Mt,ws,ht,Ct,ja,jo,ri,Oa,si,$s,se,Oo,di,Pa,ii,li,jt,Na,ci,pi,Zn,hi,ui,mi,Po,fi,ea,_i,gi,bi,Qe,No,ki,Aa,vi,yi,Ia,ta,Ti,La,wi,xs,ut,Ot,Sa,Ao,$i,Da,xi,Bs,de,Io,Bi,Lo,zi,Ga,Fi,qi,Ei,Pt,Wa,Mi,Ci,oa,ji,Oi,Pi,So,Ni,na,Ai,Ii,Li,Xe,Do,Si,Ua,Di,Gi,Ra,aa,Wi,Ha,Ui,zs,mt,Nt,Va,Go,Ri,Ka,Hi,Fs,We,Vi,Ja,Ki,Ji,Qa,Qi,Xi,Xa,Yi,qs,ye,Wo,Zi,Uo,el,ra,tl,ol,nl,Ro,al,Ho,rl,sl,dl,Be,Vo,il,ft,ll,sa,cl,pl,Ya,hl,ul,ml,At,fl,It,Es,_t,Lt,Za,Ko,_l,er,gl,Ms,Ue,bl,da,kl,vl,tr,yl,Tl,or,wl,Cs,Te,Jo,$l,Qo,xl,ia,Bl,zl,Fl,Xo,ql,Yo,El,Ml,Cl,ze,Zo,jl,gt,Ol,la,Pl,Nl,nr,Al,Il,Ll,St,Sl,Dt,js,bt,Gt,ar,en,Dl,rr,Gl,Os,kt,tn,Wl,Wt,on,Ul,Ut,Ps,vt,Rt,sr,nn,Rl,dr,Hl,Ns,ie,an,Vl,rn,Kl,ca,Jl,Ql,Xl,sn,Yl,dn,Zl,ec,tc,Ht,oc,Fe,ln,nc,yt,ac,pa,rc,sc,ir,dc,ic,lc,Vt,cc,Kt,As,Tt,Jt,lr,cn,pc,cr,hc,Is,le,pn,uc,hn,mc,ha,fc,_c,gc,un,bc,mn,kc,vc,yc,Qt,Tc,X,fn,wc,wt,$c,ua,xc,Bc,pr,zc,Fc,qc,Xt,Ec,hr,Mc,Cc,ur,mr,fr,_r,jc,Oc,gr,br,kr,_n,Pc,vr,Nc,Ac,Ls,$t,Yt,yr,gn,Ic,Tr,Lc,Ss,L,bn,Sc,kn,Dc,ma,Gc,Wc,Uc,vn,Rc,yn,Hc,Vc,Kc,wr,Jc,Qc,Re,$r,Tn,Xc,Yc,xr,wn,Zc,ep,Br,$n,tp,op,zr,xn,np,ap,qe,Bn,rp,xt,sp,Fr,dp,ip,qr,lp,cp,pp,Zt,hp,eo,up,to,zn,mp,oo,fp,no,Fn,_p,ao,Ds,Bt,ro,Er,qn,gp,Mr,bp,Gs,S,En,kp,Mn,vp,fa,yp,Tp,wp,Cn,$p,jn,xp,Bp,zp,Cr,Fp,qp,He,jr,On,Ep,Mp,Or,Pn,Cp,jp,Pr,Nn,Op,Pp,Nr,An,Np,Ap,D,In,Ip,zt,Lp,Ar,Sp,Dp,Ir,Gp,Wp,Up,so,Rp,Lr,Hp,Vp,Sr,Dr,Gr,Wr,Kp,Jp,Ur,Rr,Hr,Vr,Qp,Xp,Kr,Jr,Qr,Xr,Yp,Zp,Yr,Zr,Ln,io,lo,es,Sn,eh,ts,th,oh,os,nh,ah,co,Dn,rh,po,sh,ho,Gn,dh,uo,Ws;return i=new ce({}),R=new ce({}),be=new ce({}),Fo=new ce({}),qo=new Ve({props:{code:`from transformers import BlenderbotTokenizer, BlenderbotForConditionalGeneration
...
Whether or not to return a <a href="/docs/transformers/main/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/blenderbot/modeling_blenderbot.py#L1127",returnDescription:`
<p>A <a
...
(masked), the loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/blenderbot/modeling_blenderbot.py#L1284",returnDescription:`
<p>A <a
...
Whether or not to return a <a href="/docs/transformers/main/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/blenderbot/modeling_blenderbot.py#L1451",returnDescription:`
<p>A <a
...
behaviors between training and evaluation).`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/blenderbot/modeling_tf_blenderbot.py#L1155",returnDescription:`
<p>A <a
...
Labels for computing the masked language modeling loss. Indices should either be in <code>[0, ..., config.vocab_size]</code> or -100 (see <code>input_ids</code> docstring). Tokens with indices set to <code>-100</code> are ignored
(masked), the loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/blenderbot/modeling_tf_blenderbot.py#L1278",returnDescription:`
<p>A <a
...
`}}),uo=new ot({props:{anchor:"transformers.FlaxBlenderbotForConditionalGeneration.decode.example",$$slots:{default:[df]},$$scope:{ctx:z}}}),{c(){p=n("meta"),k=l(),g=n("h1"),u=n("a"),b=n("span"),v(i.$$.fragment),m=l(),F=n("span"),Me=s("Blenderbot"),pe=l(),E=n("p"),fe=n("strong"),te=s("DISCLAIMER:"),Ce=s(" If you see something strange, file a "),oe=n("a"),ne=s("Github Issue"),je=s(" ."),we=l(),G=n("h2"),N=n("a"),_e=n("span"),v(R.$$.fragment),M=l(),j=n("span"),Oe=s("Overview"),J=l(),Q=n("p"),Pe=s("The Blender chatbot model was proposed in "),W=n("a"),Ne=s("Recipes for building an open-domain chatbot"),Ae=s(` Stephen Roller, Emily Dinan, Naman Goyal, Da Ju, Mary Williamson, Yinhan Liu,
...
failure cases of our models.`),xe=l(),C=n("p"),Le=s("This model was contributed by "),U=n("a"),Se=s("sshleifer"),B=s(". The authors\u2019 code can be found "),q=n("a"),ge=s("here"),at=s(" ."),Ke=l(),O=n("h2"),me=n("a"),De=n("span"),v(be.$$.fragment),V=l(),K=n("span"),rt=s("Implementation Notes"),Je=l(),I=n("ul"),ke=n("li"),st=s("Blenderbot uses a standard "),re=n("a"),dt=s("seq2seq model transformer"),Fd=s(" based architecture."),qd=l(),Bo=n("li"),Ed=s("Available checkpoints can be found in the "),zo=n("a"),Md=s("model hub"),Cd=s("."),jd=l(),Ge=n("li"),Od=s("This is the "),za=n("em"),Pd=s("default"),Nd=s(` Blenderbot model class. However, some smaller checkpoints, such as
`),Fa=n("code"),Ad=s("facebook/blenderbot_small_90M"),Id=s(`, have a different architecture and consequently should be used with
`),Kn=n("a"),Ld=s("BlenderbotSmall"),Sd=s("."),bs=l(),it=n("h2"),qt=n("a"),qa=n("span"),v(Fo.$$.fragment),Dd=l(),Ea=n("span"),Gd=s("Usage"),ks=l(),Jn=n("p"),Wd=s("Here is an example of model usage:"),vs=l(),v(qo.$$.fragment),ys=l(),lt=n("h2"),Et=n("a"),Ma=n("span"),v(Eo.$$.fragment),Ud=l(),Ca=n("span"),Rd=s("BlenderbotConfig"),Ts=l(),ve=n("div"),v(Mo.$$.fragment),Hd=l(),ct=n("p"),Vd=s("This is the configuration class to store the configuration of a "),Qn=n("a"),Kd=s("BlenderbotModel"),Jd=s(`. It is used to instantiate an
...
documentation from `),Yn=n("a"),oi=s("PretrainedConfig"),ni=s(" for more information."),ai=l(),v(Mt.$$.fragment),ws=l(),ht=n("h2"),Ct=n("a"),ja=n("span"),v(jo.$$.fragment),ri=l(),Oa=n("span"),si=s("BlenderbotTokenizer"),$s=l(),se=n("div"),v(Oo.$$.fragment),di=l(),Pa=n("p"),ii=s("Construct a Blenderbot tokenizer."),li=l(),jt=n("p"),Na=n("code"),ci=s("Blenderbot"),pi=s(" is nearly identical to "),Zn=n("a"),hi=s("RobertaTokenizer"),ui=s(` and runs end-to-end tokenization: punctuation splitting
and wordpiece. The only difference is that it doesn\u2019t add BOS token to the beginning of sequences.`),mi=l(),Po=n("p"),fi=s("Refer to superclass "),ea=n("a"),_i=s("RobertaTokenizer"),gi=s(" for usage examples and documentation concerning parameters."),bi=l(),Qe=n("div"),v(No.$$.fragment),ki=l(),Aa=n("p"),vi=s(`Build model inputs from a sequence or a pair of sequence for sequence classification tasks by concatenating and
adding special tokens. A Blenderbot sequence has the following format:`),yi=l(),Ia=n("ul"),ta=n("li"),Ti=s("single sequence: "),La=n("code"),wi=s("X </s>"),xs=l(),ut=n("h2"),Ot=n("a"),Sa=n("span"),v(Ao.$$.fragment),$i=l(),Da=n("span"),xi=s("BlenderbotTokenizerFast"),Bs=l(),de=n("div"),v(Io.$$.fragment),Bi=l(),Lo=n("p"),zi=s("Construct a \u201Cfast\u201D Blenderbot tokenizer (backed by HuggingFace\u2019s "),Ga=n("em"),Fi=s("tokenizers"),qi=s(" library)."),Ei=l(),Pt=n("p"),Wa=n("code"),Mi=s("BlenderbotFast"),Ci=s(" is nearly identical to "),oa=n("a"),ji=s("RobertaTokenizerFast"),Oi=s(` and runs end-to-end tokenization: punctuation
splitting and wordpiece. The only difference is that it doesn\u2019t add BOS token to the beginning of sequences.`),Pi=l(),So=n("p"),Ni=s("Refer to superclass "),na=n("a"),Ai=s("RobertaTokenizerFast"),Ii=s(" for usage examples and documentation concerning parameters."),Li=l(),Xe=n("div"),v(Do.$$.fragment),Si=l(),Ua=n("p"),Di=s(`Build model inputs from a sequence or a pair of sequence for sequence classification tasks by concatenating and
adding special tokens. A Blenderbot sequence has the following format:`),Gi=l(),Ra=n("ul"),aa=n("li"),Wi=s("single sequence: "),Ha=n("code"),Ui=s("X </s>"),zs=l(),mt=n("h2"),Nt=n("a"),Va=n("span"),v(Go.$$.fragment),Ri=l(),Ka=n("span"),Hi=s("BlenderbotModel"),Fs=l(),We=n("p"),Vi=s("See "),Ja=n("code"),Ki=s("transformers.BartModel"),Ji=s(" for arguments to "),Qa=n("em"),Qi=s("forward"),Xi=s(" and "),Xa=n("em"),Yi=s("generate"),qs=l(),ye=n("div"),v(Wo.$$.fragment),Zi=l(),Uo=n("p"),el=s(`The bare Blenderbot Model outputting raw hidden-states without any specific head on top.
...
and behavior.`),dl=l(),Be=n("div"),v(Vo.$$.fragment),il=l(),ft=n("p"),ll=s("The "),sa=n("a"),cl=s("BlenderbotModel"),pl=s(" forward method, overrides the "),Ya=n("code"),hl=s("__call__"),ul=s(" special method."),ml=l(),v(At.$$.fragment),fl=l(),v(It.$$.fragment),Es=l(),_t=n("h2"),Lt=n("a"),Za=n("span"),v(Ko.$$.fragment),_l=l(),er=n("span"),gl=s("BlenderbotForConditionalGeneration"),Ms=l(),Ue=n("p"),bl=s("See "),da=n("a"),kl=s("BartForConditionalGeneration"),vl=s(" for arguments to "),tr=n("em"),yl=s("forward"),Tl=s(" and "),or=n("em"),wl=s("generate"),Cs=l(),Te=n("div"),v(Jo.$$.fragment),$l=l(),Qo=n("p"),xl=s(`The Blenderbot Model with a language modeling head. Can be used for summarization.
This model inherits from `),ia=n("a"),Bl=s("PreTrainedModel"),zl=s(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Fl=l(),Xo=n("p"),ql=s("This model is also a PyTorch "),Yo=n("a"),El=s("torch.nn.Module"),Ml=s(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Cl=l(),ze=n("div"),v(Zo.$$.fragment),jl=l(),gt=n("p"),Ol=s("The "),la=n("a"),Pl=s("BlenderbotForConditionalGeneration"),Nl=s(" forward method, overrides the "),nr=n("code"),Al=s("__call__"),Il=s(" special method."),Ll=l(),v(St.$$.fragment),Sl=l(),v(Dt.$$.fragment),js=l(),bt=n("h2"),Gt=n("a"),ar=n("span"),v(en.$$.fragment),Dl=l(),rr=n("span"),Gl=s("BlenderbotForCausalLM"),Os=l(),kt=n("div"),v(tn.$$.fragment),Wl=l(),Wt=n("div"),v(on.$$.fragment),Ul=l(),v(Ut.$$.fragment),Ps=l(),vt=n("h2"),Rt=n("a"),sr=n("span"),v(nn.$$.fragment),Rl=l(),dr=n("span"),Hl=s("TFBlenderbotModel"),Ns=l(),ie=n("div"),v(an.$$.fragment),Vl=l(),rn=n("p"),Kl=s(`The bare BLENDERBOT Model outputting raw hidden-states without any specific head on top.
...
behavior.`),tc=l(),v(Ht.$$.fragment),oc=l(),Fe=n("div"),v(ln.$$.fragment),nc=l(),yt=n("p"),ac=s("The "),pa=n("a"),rc=s("TFBlenderbotModel"),sc=s(" forward method, overrides the "),ir=n("code"),dc=s("__call__"),ic=s(" special method."),lc=l(),v(Vt.$$.fragment),cc=l(),v(Kt.$$.fragment),As=l(),Tt=n("h2"),Jt=n("a"),lr=n("span"),v(cn.$$.fragment),pc=l(),cr=n("span"),hc=s("TFBlenderbotForConditionalGeneration"),Is=l(),le=n("div"),v(pn.$$.fragment),uc=l(),hn=n("p"),mc=s(`The BLENDERBOT Model with a language modeling head. Can be used for summarization.
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),gc=l(),un=n("p"),bc=s("This model is also a "),mn=n("a"),kc=s("tf.keras.Model"),vc=s(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),yc=l(),v(Qt.$$.fragment),Tc=l(),X=n("div"),v(fn.$$.fragment),wc=l(),wt=n("p"),$c=s("The "),ua=n("a"),xc=s("TFBlenderbotForConditionalGeneration"),Bc=s(" forward method, overrides the "),pr=n("code"),zc=s("__call__"),Fc=s(" special method."),qc=l(),v(Xt.$$.fragment),Ec=l(),hr=n("p"),Mc=s("Conversation example::"),Cc=l(),ur=n("blockquote"),mr=n("blockquote"),fr=n("blockquote"),_r=n("p"),jc=s(`from transformers import BlenderbotTokenizer, TFBlenderbotForConditionalGeneration >>> mname =
...
eat too many carbs.</s> `),vr=n("s"),Nc=s(`That\u2019s unfortunate. \u201D \u2026 \u201CAre they trying to lose weight or are they just trying to
be healthier?`),Ac=s(` \u201D \u2026 \u201D<s> I\u2019m not sure.\u201D \u2026 ) >>> inputs = tokenizer([NEXT_UTTERANCE], return_tensors=\u2018tf\u2019)
next_reply_ids = model.generate(**inputs) >>> print(\u201CBot: \u201D, tokenizer.batch_decode(next_reply_ids,
skip_special_tokens=True)[0])`),Ls=l(),$t=n("h2"),Yt=n("a"),yr=n("span"),v(gn.$$.fragment),Ic=l(),Tr=n("span"),Lc=s("FlaxBlenderbotModel"),Ss=l(),L=n("div"),v(bn.$$.fragment),Sc=l(),kn=n("p"),Dc=s(`The bare MBart Model transformer outputting raw hidden-states without any specific head on top.
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Uc=l(),vn=n("p"),Rc=s(`This model is also a Flax Linen
`),yn=n("a"),Hc=s("flax.nn.Module"),Vc=s(` subclass. Use it as a
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),Kc=l(),wr=n("p"),Jc=s("Finally, this model supports inherent JAX features such as:"),Qc=l(),Re=n("ul"),$r=n("li"),Tn=n("a"),Xc=s("Just-In-Time (JIT) compilation"),Yc=l(),xr=n("li"),wn=n("a"),Zc=s("Automatic Differentiation"),ep=l(),Br=n("li"),$n=n("a"),tp=s("Vectorization"),op=l(),zr=n("li"),xn=n("a"),np=s("Parallelization"),ap=l(),qe=n("div"),v(Bn.$$.fragment),rp=l(),xt=n("p"),sp=s("The "),Fr=n("code"),dp=s("FlaxBlenderbotPreTrainedModel"),ip=s(" forward method, overrides the "),qr=n("code"),lp=s("__call__"),cp=s(" special method."),pp=l(),v(Zt.$$.fragment),hp=l(),v(eo.$$.fragment),up=l(),to=n("div"),v(zn.$$.fragment),mp=l(),v(oo.$$.fragment),fp=l(),no=n("div"),v(Fn.$$.fragment),_p=l(),v(ao.$$.fragment),Ds=l(),Bt=n("h2"),ro=n("a"),Er=n("span"),v(qn.$$.fragment),gp=l(),Mr=n("span"),bp=s("FlaxBlenderbotForConditionalGeneration"),Gs=l(),S=n("div"),v(En.$$.fragment),kp=l(),Mn=n("p"),vp=s(`The Blenderbot Model with a language modeling head. Can be used for summarization.
This model inherits from `),fa=n("a"),yp=s("FlaxPreTrainedModel"),Tp=s(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),wp=l(),Cn=n("p"),$p=s(`This model is also a Flax Linen
`),jn=n("a"),xp=s("flax.nn.Module"),Bp=s(` subclass. Use it as a
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),zp=l(),Cr=n("p"),Fp=s("Finally, this model supports inherent JAX features such as:"),qp=l(),He=n("ul"),jr=n("li"),On=n("a"),Ep=s("Just-In-Time (JIT) compilation"),Mp=l(),Or=n("li"),Pn=n("a"),Cp=s("Automatic Differentiation"),jp=l(),Pr=n("li"),Nn=n("a"),Op=s("Vectorization"),Pp=l(),Nr=n("li"),An=n("a"),Np=s("Parallelization"),Ap=l(),D=n("div"),v(In.$$.fragment),Ip=l(),zt=n("p"),Lp=s("The "),Ar=n("code"),Sp=s("FlaxBlenderbotPreTrainedModel"),Dp=s(" forward method, overrides the "),Ir=n("code"),Gp=s("__call__"),Wp=s(" special method."),Up=l(),v(so.$$.fragment),Rp=l(),Lr=n("p"),Hp=s("Conversation example::"),Vp=l(),Sr=n("blockquote"),Dr=n("blockquote"),Gr=n("blockquote"),Wr=n("p"),Kp=s("from transformers import BlenderbotTokenizer, FlaxBlenderbotForConditionalGeneration, BlenderbotConfig"),Jp=l(),Ur=n("blockquote"),Rr=n("blockquote"),Hr=n("blockquote"),Vr=n("p"),Qp=s(`model = FlaxBlenderbotForConditionalGeneration.from_pretrained(\u2018facebook/blenderbot-400M-distill\u2019) >>>
...
max_length=1024, return_tensors=\u2018np\u2019)`),Zp=l(),Yr=n("blockquote"),Zr=n("blockquote"),Ln=n("blockquote"),io=n("h1"),lo=n("a"),es=n("span"),v(Sn.$$.fragment),eh=l(),ts=n("span"),th=s("Generate Reply >>> reply_ids = model.generate(inputs[\u2018input_ids\u2019], num_beams=4, max_length=5,"),oh=l(),os=n("p"),nh=s(`early_stopping=True).sequences >>> print([tokenizer.decode(g, skip_special_tokens=True,
clean_up_tokenization_spaces=False) for g in reply_ids])`),ah=l(),co=n("div"),v(Dn.$$.fragment),rh=l(),v(po.$$.fragment),sh=l(),ho=n("div"),v(Gn.$$.fragment),dh=l(),v(uo.$$.fragment),this.h()},l(o){const _=Gm('[data-svelte="svelte-1phssyn"]',document.head);p=a(_,"META",{name:!0,content:!0}),_.forEach(t),k=c(o),g=a(o,"H1",{class:!0});var Wn=r(g);u=a(Wn,"A",{id:!0,class:!0,href:!0});var ns=r(u);b=a(ns,"SPAN",{});var as=r(b);y(i.$$.fragment,as),as.forEach(t),ns.forEach(t),m=c(Wn),F=a(Wn,"SPAN",{});var rs=r(F);Me=d(rs,"Blenderbot"),rs.forEach(t),Wn.forEach(t),pe=c(o),E=a(o,"P",{});var mo=r(E);fe=a(mo,"STRONG",{});var ss=r(fe);te=d(ss,"DISCLAIMER:"),ss.forEach(t),Ce=d(mo," If you see something strange, file a "),oe=a(mo,"A",{href:!0,rel:!0});var ds=r(oe);ne=d(ds,"Github Issue"),ds.forEach(t),je=d(mo," ."),mo.forEach(t),we=c(o),G=a(o,"H2",{class:!0});var Un=r(G);N=a(Un,"A",{id:!0,class:!0,href:!0});var is=r(N);_e=a(is,"SPAN",{});var ls=r(_e);y(R.$$.fragment,ls),ls.forEach(t),is.forEach(t),M=c(Un),j=a(Un,"SPAN",{});var cs=r(j);Oe=d(cs,"Overview"),cs.forEach(t),Un.forEach(t),J=c(o),Q=a(o,"P",{});var Rn=r(Q);Pe=d(Rn,"The Blender chatbot model was proposed in "),W=a(Rn,"A",{href:!0,rel:!0});var ps=r(W);Ne=d(ps,"Recipes for building an open-domain chatbot"),ps.forEach(t),Ae=d(Rn,` Stephen Roller, Emily Dinan, Naman Goyal, Da Ju, Mary Williamson, Yinhan Liu,
...
and code publicly available. Human evaluations show our best models are superior to existing approaches in multi-turn
dialogue in terms of engagingness and humanness measurements. We then discuss the limitations of this work by analyzing
failure cases of our models.`),ms.forEach(t),us.forEach(t),xe=c(o),C=a(o,"P",{});var Ft=r(C);Le=d(Ft,"This model was contributed by "),U=a(Ft,"A",{href:!0,rel:!0});var fs=r(U);Se=d(fs,"sshleifer"),fs.forEach(t),B=d(Ft,". The authors\u2019 code can be found "),q=a(Ft,"A",{href:!0,rel:!0});var ch=r(q);ge=d(ch,"here"),ch.forEach(t),at=d(Ft," ."),Ft.forEach(t),Ke=c(o),O=a(o,"H2",{class:!0});var Us=r(O);me=a(Us,"A",{id:!0,class:!0,href:!0});var ph=r(me);De=a(ph,"SPAN",{});var hh=r(De);y(be.$$.fragment,hh),hh.forEach(t),ph.forEach(t),V=c(Us),K=a(Us,"SPAN",{});var uh=r(K);rt=d(uh,"Implementation Notes"),uh.forEach(t),Us.forEach(t),Je=c(o),I=a(o,"UL",{});var _a=r(I);ke=a(_a,"LI",{});var Rs=r(ke);st=d(Rs,"Blenderbot uses a standard "),re=a(Rs,"A",{href:!0,rel:!0});var mh=r(re);dt=d(mh,"seq2seq model transformer"),mh.forEach(t),Fd=d(Rs," based architecture."),Rs.forEach(t),qd=c(_a),Bo=a(_a,"LI",{});var Hs=r(Bo);Ed=d(Hs,"Available checkpoints can be found in the "),zo=a(Hs,"A",{href:!0,rel:!0});var fh=r(zo);Md=d(fh,"model hub"),fh.forEach(t),Cd=d(Hs,"."),Hs.forEach(t),jd=c(_a),Ge=a(_a,"LI",{});var fo=r(Ge);Od=d(fo,"This is the "),za=a(fo,"EM",{});var _h=r(za);Pd=d(_h,"default"),_h.forEach(t),Nd=d(fo,` Blenderbot model class. However, some smaller checkpoints, such as
`),Fa=a(fo,"CODE",{});var gh=r(Fa);Ad=d(gh,"facebook/blenderbot_small_90M"),gh.forEach(t),Id=d(fo,`, have a different architecture and consequently should be used with
`),Kn=a(fo,"A",{href:!0});var bh=r(Kn);Ld=d(bh,"BlenderbotSmall"),bh.forEach(t),Sd=d(fo,"."),fo.forEach(t),_a.forEach(t),bs=c(o),it=a(o,"H2",{class:!0});var Vs=r(it);qt=a(Vs,"A",{id:!0,class:!0,href:!0});var kh=r(qt);qa=a(kh,"SPAN",{});var vh=r(qa);y(Fo.$$.fragment,vh),vh.forEach(t),kh.forEach(t),Dd=c(Vs),Ea=a(Vs,"SPAN",{});var yh=r(Ea);Gd=d(yh,"Usage"),yh.forEach(t),Vs.forEach(t),ks=c(o),Jn=a(o,"P",{});var Th=r(Jn);Wd=d(Th,"Here is an example of model usage:"),Th.forEach(t),vs=c(o),y(qo.$$.fragment,o),ys=c(o),lt=a(o,"H2",{class:!0});var Ks=r(lt);Et=a(Ks,"A",{id:!0,class:!0,href:!0});var wh=r(Et);Ma=a(wh,"SPAN",{});var $h=r(Ma);y(Eo.$$.fragment,$h),$h.forEach(t),wh.forEach(t),Ud=c(Ks),Ca=a(Ks,"SPAN",{});var xh=r(Ca);Rd=d(xh,"BlenderbotConfig"),xh.forEach(t),Ks.forEach(t),Ts=c(o),ve=a(o,"DIV",{class:!0});var _o=r(ve);y(Mo.$$.fragment,_o),Hd=c(_o),ct=a(_o,"P",{});var ga=r(ct);Vd=d(ga,"This is the configuration class to store the configuration of a "),Qn=a(ga,"A",{href:!0});var Bh=r(Qn);Kd=d(Bh,"BlenderbotModel"),Bh.forEach(t),Jd=d(ga,`. It is used to instantiate an
Blenderbot model according to the specified arguments, defining the model architecture. Instantiating a
configuration with the defaults will yield a similar configuration to that of the Blenderbot
`),Co=a(ga,"A",{href:!0,rel:!0});var zh=r(Co);Qd=d(zh,"facebook/blenderbot-3B"),zh.forEach(t),Xd=d(ga," architecture."),ga.forEach(t),Yd=c(_o),pt=a(_o,"P",{});var ba=r(pt);Zd=d(ba,"Configuration objects inherit from "),Xn=a(ba,"A",{href:!0});var Fh=r(Xn);ei=d(Fh,"PretrainedConfig"),Fh.forEach(t),ti=d(ba,` and can be used to control the model outputs. Read the
documentation from `),Yn=a(ba,"A",{href:!0});var qh=r(Yn);oi=d(qh,"PretrainedConfig"),qh.forEach(t),ni=d(ba," for more information."),ba.forEach(t),ai=c(_o),y(Mt.$$.fragment,_o),_o.forEach(t),ws=c(o),ht=a(o,"H2",{class:!0});var Js=r(ht);Ct=a(Js,"A",{id:!0,class:!0,href:!0});var Eh=r(Ct);ja=a(Eh,"SPAN",{});var Mh=r(ja);y(jo.$$.fragment,Mh),Mh.forEach(t),Eh.forEach(t),ri=c(Js),Oa=a(Js,"SPAN",{});var Ch=r(Oa);si=d(Ch,"BlenderbotTokenizer"),Ch.forEach(t),Js.forEach(t),$s=c(o),se=a(o,"DIV",{class:!0});var Ye=r(se);y(Oo.$$.fragment,Ye),di=c(Ye),Pa=a(Ye,"P",{});var jh=r(Pa);ii=d(jh,"Construct a Blenderbot tokenizer."),jh.forEach(t),li=c(Ye),jt=a(Ye,"P",{});var _s=r(jt);Na=a(_s,"CODE",{});var Oh=r(Na);ci=d(Oh,"Blenderbot"),Oh.forEach(t),pi=d(_s," is nearly identical to "),Zn=a(_s,"A",{href:!0});var Ph=r(Zn);hi=d(Ph,"RobertaTokenizer"),Ph.forEach(t),ui=d(_s,` and runs end-to-end tokenization: punctuation splitting
and wordpiece. The only difference is that it doesn\u2019t add BOS token to the beginning of sequences.`),_s.forEach(t),mi=c(Ye),Po=a(Ye,"P",{});var Qs=r(Po);fi=d(Qs,"Refer to superclass "),ea=a(Qs,"A",{href:!0});var Nh=r(ea);_i=d(Nh,"RobertaTokenizer"),Nh.forEach(t),gi=d(Qs," for usage examples and documentation concerning parameters."),Qs.forEach(t),bi=c(Ye),Qe=a(Ye,"DIV",{class:!0});var ka=r(Qe);y(No.$$.fragment,ka),ki=c(ka),Aa=a(ka,"P",{});var Ah=r(Aa);vi=d(Ah,`Build model inputs from a sequence or a pair of sequence for sequence classification tasks by concatenating and
adding special tokens. A Blenderbot sequence has the following format:`),Ah.forEach(t),yi=c(ka),Ia=a(ka,"UL",{});var Ih=r(Ia);ta=a(Ih,"LI",{});var ih=r(ta);Ti=d(ih,"single sequence: "),La=a(ih,"CODE",{});var Lh=r(La);wi=d(Lh,"X </s>"),Lh.forEach(t),ih.forEach(t),Ih.forEach(t),ka.forEach(t),Ye.forEach(t),xs=c(o),ut=a(o,"H2",{class:!0});var Xs=r(ut);Ot=a(Xs,"A",{id:!0,class:!0,href:!0});var Sh=r(Ot);Sa=a(Sh,"SPAN",{});var Dh=r(Sa);y(Ao.$$.fragment,Dh),Dh.forEach(t),Sh.forEach(t),$i=c(Xs),Da=a(Xs,"SPAN",{});var Gh=r(Da);xi=d(Gh,"BlenderbotTokenizerFast"),Gh.forEach(t),Xs.forEach(t),Bs=c(o),de=a(o,"DIV",{class:!0});var Ze=r(de);y(Io.$$.fragment,Ze),Bi=c(Ze),Lo=a(Ze,"P",{});var Ys=r(Lo);zi=d(Ys,"Construct a \u201Cfast\u201D Blenderbot tokenizer (backed by HuggingFace\u2019s "),Ga=a(Ys,"EM",{});var Wh=r(Ga);Fi=d(Wh,"tokenizers"),Wh.forEach(t),qi=d(Ys," library)."),Ys.forEach(t),Ei=c(Ze),Pt=a(Ze,"P",{});var gs=r(Pt);Wa=a(gs,"CODE",{});var Uh=r(Wa);Mi=d(Uh,"BlenderbotFast"),Uh.forEach(t),Ci=d(gs," is nearly identical to "),oa=a(gs,"A",{href:!0});var Rh=r(oa);ji=d(Rh,"RobertaTokenizerFast"),Rh.forEach(t),Oi=d(gs,` and runs end-to-end tokenization: punctuation
splitting and wordpiece. The only difference is that it doesn\u2019t add BOS token to the beginning of sequences.`),gs.forEach(t),Pi=c(Ze),So=a(Ze,"P",{});var Zs=r(So);Ni=d(Zs,"Refer to superclass "),na=a(Zs,"A",{href:!0});var Hh=r(na);Ai=d(Hh,"RobertaTokenizerFast"),Hh.forEach(t),Ii=d(Zs," for usage examples and documentation concerning parameters."),Zs.forEach(t),Li=c(Ze),Xe=a(Ze,"DIV",{class:!0});var va=r(Xe);y(Do.$$.fragment,va),Si=c(va),Ua=a(va,"P",{});var Vh=r(Ua);Di=d(Vh,`Build model inputs from a sequence or a pair of sequence for sequence classification tasks by concatenating and
adding special tokens. A Blenderbot sequence has the following format:`),Vh.forEach(t),Gi=c(va),Ra=a(va,"UL",{});var Kh=r(Ra);aa=a(Kh,"LI",{});var lh=r(aa);Wi=d(lh,"single sequence: "),Ha=a(lh,"CODE",{});var Jh=r(Ha);Ui=d(Jh,"X </s>"),Jh.forEach(t),lh.forEach(t),Kh.forEach(t),va.forEach(t),Ze.forEach(t),zs=c(o),mt=a(o,"H2",{class:!0});var ed=r(mt);Nt=a(ed,"A",{id:!0,class:!0,href:!0});var Qh=r(Nt);Va=a(Qh,"SPAN",{});var Xh=r(Va);y(Go.$$.fragment,Xh),Xh.forEach(t),Qh.forEach(t),Ri=c(ed),Ka=a(ed,"SPAN",{});var Yh=r(Ka);Hi=d(Yh,"BlenderbotModel"),Yh.forEach(t),ed.forEach(t),Fs=c(o),We=a(o,"P",{});var Hn=r(We);Vi=d(Hn,"See "),Ja=a(Hn,"CODE",{});var Zh=r(Ja);Ki=d(Zh,"transformers.BartModel"),Zh.forEach(t),Ji=d(Hn," for arguments to "),Qa=a(Hn,"EM",{});var eu=r(Qa);Qi=d(eu,"forward"),eu.forEach(t),Xi=d(Hn," and "),Xa=a(Hn,"EM",{});var tu=r(Xa);Yi=d(tu,"generate"),tu.forEach(t),Hn.forEach(t),qs=c(o),ye=a(o,"DIV",{class:!0});var go=r(ye);y(Wo.$$.fragment,go),Zi=c(go),Uo=a(go,"P",{});var td=r(Uo);el=d(td,`The bare Blenderbot Model outputting raw hidden-states without any specific head on top.
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),od.forEach(t),dl=c(go),Be=a(go,"DIV",{class:!0});var bo=r(Be);y(Vo.$$.fragment,bo),il=c(bo),ft=a(bo,"P",{});var ya=r(ft);ll=d(ya,"The "),sa=a(ya,"A",{href:!0});var au=r(sa);cl=d(au,"BlenderbotModel"),au.forEach(t),pl=d(ya," forward method, overrides the "),Ya=a(ya,"CODE",{});var ru=r(Ya);hl=d(ru,"__call__"),ru.forEach(t),ul=d(ya," special method."),ya.forEach(t),ml=c(bo),y(At.$$.fragment,bo),fl=c(bo),y(It.$$.fragment,bo),bo.forEach(t),go.forEach(t),Es=c(o),_t=a(o,"H2",{class:!0});var nd=r(_t);Lt=a(nd,"A",{id:!0,class:!0,href:!0});var su=r(Lt);Za=a(su,"SPAN",{});var du=r(Za);y(Ko.$$.fragment,du),du.forEach(t),su.forEach(t),_l=c(nd),er=a(nd,"SPAN",{});var iu=r(er);gl=d(iu,"BlenderbotForConditionalGeneration"),iu.forEach(t),nd.forEach(t),Ms=c(o),Ue=a(o,"P",{});var Vn=r(Ue);bl=d(Vn,"See "),da=a(Vn,"A",{href:!0});var lu=r(da);kl=d(lu,"BartForConditionalGeneration"),lu.forEach(t),vl=d(Vn," for arguments to "),tr=a(Vn,"EM",{});var cu=r(tr);yl=d(cu,"forward"),cu.forEach(t),Tl=d(Vn," and "),or=a(Vn,"EM",{});var pu=r(or);wl=d(pu,"generate"),pu.forEach(t),Vn.forEach(t),Cs=c(o),Te=a(o,"DIV",{class:!0});var ko=r(Te);y(Jo.$$.fragment,ko),$l=c(ko),Qo=a(ko,"P",{});var ad=r(Qo);xl=d(ad,`The Blenderbot Model with a language modeling head. Can be used for summarization.
This model inherits from `),ia=a(ad,"A",{href:!0});var hu=r(ia);Bl=d(hu,"PreTrainedModel"),hu.forEach(t),zl=d(ad,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),ad.forEach(t),Fl=c(ko),Xo=a(ko,"P",{});var rd=r(Xo);ql=d(rd,"This model is also a PyTorch "),Yo=a(rd,"A",{href:!0,rel:!0});var uu=r(Yo);El=d(uu,"torch.nn.Module"),uu.forEach(t),Ml=d(rd,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),rd.forEach(t),Cl=c(ko),ze=a(ko,"DIV",{class:!0});var vo=r(ze);y(Zo.$$.fragment,vo),jl=c(vo),gt=a(vo,"P",{});var Ta=r(gt);Ol=d(Ta,"The "),la=a(Ta,"A",{href:!0});var mu=r(la);Pl=d(mu,"BlenderbotForConditionalGeneration"),mu.forEach(t),Nl=d(Ta," forward method, overrides the "),nr=a(Ta,"CODE",{});var fu=r(nr);Al=d(fu,"__call__"),fu.forEach(t),Il=d(Ta," special method."),Ta.forEach(t),Ll=c(vo),y(St.$$.fragment,vo),Sl=c(vo),y(Dt.$$.fragment,vo),vo.forEach(t),ko.forEach(t),js=c(o),bt=a(o,"H2",{class:!0});var sd=r(bt);Gt=a(sd,"A",{id:!0,class:!0,href:!0});var _u=r(Gt);ar=a(_u,"SPAN",{});var gu=r(ar);y(en.$$.fragment,gu),gu.forEach(t),_u.forEach(t),Dl=c(sd),rr=a(sd,"SPAN",{});var bu=r(rr);Gl=d(bu,"BlenderbotForCausalLM"),bu.forEach(t),sd.forEach(t),Os=c(o),kt=a(o,"DIV",{class:!0});var dd=r(kt);y(tn.$$.fragment,dd),Wl=c(dd),Wt=a(dd,"DIV",{class:!0});var id=r(Wt);y(on.$$.fragment,id),Ul=c(id),y(Ut.$$.fragment,id),id.forEach(t),dd.forEach(t),Ps=c(o),vt=a(o,"H2",{class:!0});var ld=r(vt);Rt=a(ld,"A",{id:!0,class:!0,href:!0});var ku=r(Rt);sr=a(ku,"SPAN",{});var vu=r(sr);y(nn.$$.fragment,vu),vu.forEach(t),ku.forEach(t),Rl=c(ld),dr=a(ld,"SPAN",{});var yu=r(dr);Hl=d(yu,"TFBlenderbotModel"),yu.forEach(t),ld.forEach(t),Ns=c(o),ie=a(o,"DIV",{class:!0});var et=r(ie);y(an.$$.fragment,et),Vl=c(et),rn=a(et,"P",{});var cd=r(rn);Kl=d(cd,`The bare BLENDERBOT Model outputting raw hidden-states without any specific head on top.
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),pd.forEach(t),tc=c(et),y(Ht.$$.fragment,et),oc=c(et),Fe=a(et,"DIV",{class:!0});var yo=r(Fe);y(ln.$$.fragment,yo),nc=c(yo),yt=a(yo,"P",{});var wa=r(yt);ac=d(wa,"The "),pa=a(wa,"A",{href:!0});var $u=r(pa);rc=d($u,"TFBlenderbotModel"),$u.forEach(t),sc=d(wa," forward method, overrides the "),ir=a(wa,"CODE",{});var xu=r(ir);dc=d(xu,"__call__"),xu.forEach(t),ic=d(wa," special method."),wa.forEach(t),lc=c(yo),y(Vt.$$.fragment,yo),cc=c(yo),y(Kt.$$.fragment,yo),yo.forEach(t),et.forEach(t),As=c(o),Tt=a(o,"H2",{class:!0});var hd=r(Tt);Jt=a(hd,"A",{id:!0,class:!0,href:!0});var Bu=r(Jt);lr=a(Bu,"SPAN",{});var zu=r(lr);y(cn.$$.fragment,zu),zu.forEach(t),Bu.forEach(t),pc=c(hd),cr=a(hd,"SPAN",{});var Fu=r(cr);hc=d(Fu,"TFBlenderbotForConditionalGeneration"),Fu.forEach(t),hd.forEach(t),Is=c(o),le=a(o,"DIV",{class:!0});var tt=r(le);y(pn.$$.fragment,tt),uc=c(tt),hn=a(tt,"P",{});var ud=r(hn);mc=d(ud,`The BLENDERBOT Model with a language modeling head. Can be used for summarization.
...
eat too many carbs.</s> `),vr=a(fd,"S",{});var Du=r(vr);Nc=d(Du,`That\u2019s unfortunate. \u201D \u2026 \u201CAre they trying to lose weight or are they just trying to
be healthier?`),Du.forEach(t),Ac=d(fd,` \u201D \u2026 \u201D<s> I\u2019m not sure.\u201D \u2026 ) >>> inputs = tokenizer([NEXT_UTTERANCE], return_tensors=\u2018tf\u2019)
next_reply_ids = model.generate(**inputs) >>> print(\u201CBot: \u201D, tokenizer.batch_decode(next_reply_ids,
skip_special_tokens=True)[0])`),fd.forEach(t),Su.forEach(t),Lu.forEach(t),Iu.forEach(t),Ee.forEach(t),tt.forEach(t),Ls=c(o),$t=a(o,"H2",{class:!0});var _d=r($t);Yt=a(_d,"A",{id:!0,class:!0,href:!0});var Gu=r(Yt);yr=a(Gu,"SPAN",{});var Wu=r(yr);y(gn.$$.fragment,Wu),Wu.forEach(t),Gu.forEach(t),Ic=c(_d),Tr=a(_d,"SPAN",{});var Uu=r(Tr);Lc=d(Uu,"FlaxBlenderbotModel"),Uu.forEach(t),_d.forEach(t),Ss=c(o),L=a(o,"DIV",{class:!0});var Y=r(L);y(bn.$$.fragment,Y),Sc=c(Y),kn=a(Y,"P",{});var gd=r(kn);Dc=d(gd,`The bare MBart Model transformer outputting raw hidden-states without any specific head on top.
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),gd.forEach(t),Uc=c(Y),vn=a(Y,"P",{});var bd=r(vn);Rc=d(bd,`This model is also a Flax Linen
`),yn=a(bd,"A",{href:!0,rel:!0});var Hu=r(yn);Hc=d(Hu,"flax.nn.Module"),Hu.forEach(t),Vc=d(bd,` subclass. Use it as a
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),bd.forEach(t),Kc=c(Y),wr=a(Y,"P",{});var Vu=r(wr);Jc=d(Vu,"Finally, this model supports inherent JAX features such as:"),Vu.forEach(t),Qc=c(Y),Re=a(Y,"UL",{});var To=r(Re);$r=a(To,"LI",{});var Ku=r($r);Tn=a(Ku,"A",{href:!0,rel:!0});var Ju=r(Tn);Xc=d(Ju,"Just-In-Time (JIT) compilation"),Ju.forEach(t),Ku.forEach(t),Yc=c(To),xr=a(To,"LI",{});var Qu=r(xr);wn=a(Qu,"A",{href:!0,rel:!0});var Xu=r(wn);Zc=d(Xu,"Automatic Differentiation"),Xu.forEach(t),Qu.forEach(t),ep=c(To),Br=a(To,"LI",{});var Yu=r(Br);$n=a(Yu,"A",{href:!0,rel:!0});var Zu=r($n);tp=d(Zu,"Vectorization"),Zu.forEach(t),Yu.forEach(t),op=c(To),zr=a(To,"LI",{});var em=r(zr);xn=a(em,"A",{href:!0,rel:!0});var tm=r(xn);np=d(tm,"Parallelization"),tm.forEach(t),em.forEach(t),To.forEach(t),ap=c(Y),qe=a(Y,"DIV",{class:!0});var wo=r(qe);y(Bn.$$.fragment,wo),rp=c(wo),xt=a(wo,"P",{});var xa=r(xt);sp=d(xa,"The "),Fr=a(xa,"CODE",{});var om=r(Fr);dp=d(om,"FlaxBlenderbotPreTrainedModel"),om.forEach(t),ip=d(xa," forward method, overrides the "),qr=a(xa,"CODE",{});var nm=r(qr);lp=d(nm,"__call__"),nm.forEach(t),cp=d(xa," special method."),xa.forEach(t),pp=c(wo),y(Zt.$$.fragment,wo),hp=c(wo),y(eo.$$.fragment,wo),wo.forEach(t),up=c(Y),to=a(Y,"DIV",{class:!0});var kd=r(to);y(zn.$$.fragment,kd),mp=c(kd),y(oo.$$.fragment,kd),kd.forEach(t),fp=c(Y),no=a(Y,"DIV",{class:!0});var vd=r(no);y(Fn.$$.fragment,vd),_p=c(vd),y(ao.$$.fragment,vd),vd.forEach(t),Y.forEach(t),Ds=c(o),Bt=a(o,"H2",{class:!0});var yd=r(Bt);ro=a(yd,"A",{id:!0,class:!0,href:!0});var am=r(ro);Er=a(am,"SPAN",{});var rm=r(Er);y(qn.$$.fragment,rm),rm.forEach(t),am.forEach(t),gp=c(yd),Mr=a(yd,"SPAN",{});var sm=r(Mr);bp=d(sm,"FlaxBlenderbotForConditionalGeneration"),sm.forEach(t),yd.forEach(t),Gs=c(o),S=a(o,"DIV",{class:!0});var Z=r(S);y(En.$$.fragment,Z),kp=c(Z),Mn=a(Z,"P",{});var Td=r(Mn);vp=d(Td,`The Blenderbot Model with a language modeling head. Can be used for summarization.
This model inherits from `),fa=a(Td,"A",{href:!0});var dm=r(fa);yp=d(dm,"FlaxPreTrainedModel"),dm.forEach(t),Tp=d(Td,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
