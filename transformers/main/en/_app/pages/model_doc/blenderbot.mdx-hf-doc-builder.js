import{S as Lm,i as Sm,s as Dm,e as n,k as l,w as y,t as s,M as Gm,c as a,d as t,m as c,a as r,x as v,h as d,b as h,G as e,g as f,y as T,q as w,o as $,B,v as Wm,L as _t}from"../../chunks/vendor-hf-doc-builder.js";import{T as Uo}from"../../chunks/Tip-hf-doc-builder.js";import{D as N}from"../../chunks/Docstring-hf-doc-builder.js";import{C as dt}from"../../chunks/CodeBlock-hf-doc-builder.js";import{I as Te}from"../../chunks/IconCopyLink-hf-doc-builder.js";import{E as ft}from"../../chunks/ExampleCodeBlock-hf-doc-builder.js";function Um(z){let p,k,g,m,b;return m=new dt({props:{code:`from transformers import BlenderbotModel, BlenderbotConfig
...
<span class="hljs-meta">&gt;&gt;&gt; </span>configuration = model.config`}}),{c(){p=n("p"),k=s("Example:"),g=l(),y(m.$$.fragment)},l(i){p=a(i,"P",{});var u=r(p);k=d(u,"Example:"),u.forEach(t),g=c(i),v(m.$$.fragment,i)},m(i,u){f(i,p,u),e(p,k),f(i,g,u),T(m,i,u),b=!0},p:_t,i(i){b||(w(m.$$.fragment,i),b=!0)},o(i){$(m.$$.fragment,i),b=!1},d(i){i&&t(p),i&&t(g),B(m,i)}}}function Rm(z){let p,k,g,m,b;return{c(){p=n("p"),k=s("Although the recipe for forward pass needs to be defined within this function, one should call the "),g=n("code"),m=s("Module"),b=s(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(i){p=a(i,"P",{});var u=r(p);k=d(u,"Although the recipe for forward pass needs to be defined within this function, one should call the "),g=a(u,"CODE",{});var E=r(g);m=d(E,"Module"),E.forEach(t),b=d(u,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),u.forEach(t)},m(i,u){f(i,p,u),e(p,k),e(p,g),e(g,m),e(p,b)},d(i){i&&t(p)}}}function Hm(z){let p,k,g,m,b;return m=new dt({props:{code:`from transformers import BlenderbotTokenizer, BlenderbotModel
...
[<span class="hljs-number">1</span>, <span class="hljs-number">6</span>, <span class="hljs-number">1280</span>]`}}),{c(){p=n("p"),k=s("Example:"),g=l(),y(m.$$.fragment)},l(i){p=a(i,"P",{});var u=r(p);k=d(u,"Example:"),u.forEach(t),g=c(i),v(m.$$.fragment,i)},m(i,u){f(i,p,u),e(p,k),f(i,g,u),T(m,i,u),b=!0},p:_t,i(i){b||(w(m.$$.fragment,i),b=!0)},o(i){$(m.$$.fragment,i),b=!1},d(i){i&&t(p),i&&t(g),B(m,i)}}}function Km(z){let p,k,g,m,b;return{c(){p=n("p"),k=s("Although the recipe for forward pass needs to be defined within this function, one should call the "),g=n("code"),m=s("Module"),b=s(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(i){p=a(i,"P",{});var u=r(p);k=d(u,"Although the recipe for forward pass needs to be defined within this function, one should call the "),g=a(u,"CODE",{});var E=r(g);m=d(E,"Module"),E.forEach(t),b=d(u,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),u.forEach(t)},m(i,u){f(i,p,u),e(p,k),e(p,g),e(g,m),e(p,b)},d(i){i&&t(p)}}}function Vm(z){let p,k,g,m,b;return m=new dt({props:{code:`from transformers import BlenderbotTokenizer, BlenderbotForConditionalGeneration
...
Bot:   That&#x27;s too bad. Have you tried encouraging them to change their eating habits?</span>`}}),{c(){p=n("p"),k=s("Conversation example:"),g=l(),y(m.$$.fragment)},l(i){p=a(i,"P",{});var u=r(p);k=d(u,"Conversation example:"),u.forEach(t),g=c(i),v(m.$$.fragment,i)},m(i,u){f(i,p,u),e(p,k),f(i,g,u),T(m,i,u),b=!0},p:_t,i(i){b||(w(m.$$.fragment,i),b=!0)},o(i){$(m.$$.fragment,i),b=!1},d(i){i&&t(p),i&&t(g),B(m,i)}}}function Jm(z){let p,k,g,m,b;return m=new dt({props:{code:`from transformers import BlenderbotTokenizer, BlenderbotForCausalLM
...
<span class="hljs-literal">True</span>`}}),{c(){p=n("p"),k=s("Example:"),g=l(),y(m.$$.fragment)},l(i){p=a(i,"P",{});var u=r(p);k=d(u,"Example:"),u.forEach(t),g=c(i),v(m.$$.fragment,i)},m(i,u){f(i,p,u),e(p,k),f(i,g,u),T(m,i,u),b=!0},p:_t,i(i){b||(w(m.$$.fragment,i),b=!0)},o(i){$(m.$$.fragment,i),b=!1},d(i){i&&t(p),i&&t(g),B(m,i)}}}function Qm(z){let p,k,g,m,b,i,u,E,Je,Le,A,Be,xe,F,se,de,Qe,Se,I,Y,ze,U,Xe,Fe,ie,De,Z,le,ce,Ye,qe,C,j,Ze,ee,we,Ee,pe,Ge,R,L,he,ue,et,me,fe,tt,We,O,te,K,_e,Me,P,ot,G,H,ge;return{c(){p=n("p"),k=s("TensorFlow models and layers in "),g=n("code"),m=s("transformers"),b=s(" accept two formats as input:"),i=l(),u=n("ul"),E=n("li"),Je=s("having all inputs as keyword arguments (like PyTorch models), or"),Le=l(),A=n("li"),Be=s("having all inputs as a list, tuple or dict in the first positional argument."),xe=l(),F=n("p"),se=s(`The reason the second format is supported is that Keras methods prefer this format when passing inputs to models
...
pass your inputs and labels in any format that `),I=n("code"),Y=s("model.fit()"),ze=s(` supports! If, however, you want to use the second
format outside of Keras methods like `),U=n("code"),Xe=s("fit()"),Fe=s(" and "),ie=n("code"),De=s("predict()"),Z=s(`, such as when creating your own layers or models with
...
`),K=n("code"),_e=s('model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),Me=l(),P=n("p"),ot=s(`Note that when creating models and layers with
`),G=n("a"),H=s("subclassing"),ge=s(` then you don\u2019t need to worry
about any of this, as you can just pass inputs like you would to any other Python function!`),this.h()},l(x){p=a(x,"P",{});var q=r(p);k=d(q,"TensorFlow models and layers in "),g=a(q,"CODE",{});var gt=r(g);m=d(gt,"transformers"),gt.forEach(t),b=d(q," accept two formats as input:"),q.forEach(t),i=c(x),u=a(x,"UL",{});var Ce=r(u);E=a(Ce,"LI",{});var bt=r(E);Je=d(bt,"having all inputs as keyword arguments (like PyTorch models), or"),bt.forEach(t),Le=c(Ce),A=a(Ce,"LI",{});var je=r(A);Be=d(je,"having all inputs as a list, tuple or dict in the first positional argument."),je.forEach(t),Ce.forEach(t),xe=c(x),F=a(x,"P",{});var M=r(F);se=d(M,`The reason the second format is supported is that Keras methods prefer this format when passing inputs to models
...
pass your inputs and labels in any format that `),I=a(M,"CODE",{});var kt=r(I);Y=d(kt,"model.fit()"),kt.forEach(t),ze=d(M,` supports! If, however, you want to use the second
format outside of Keras methods like `),U=a(M,"CODE",{});var yt=r(U);Xe=d(yt,"fit()"),yt.forEach(t),Fe=d(M," and "),ie=a(M,"CODE",{});var vt=r(ie);De=d(vt,"predict()"),vt.forEach(t),Z=d(M,`, such as when creating your own layers or models with
the Keras `),le=a(M,"CODE",{});var V=r(le);ce=d(V,"Functional"),V.forEach(t),Ye=d(M,` API, there are three possibilities you can use to gather all the input Tensors in the first
positional argument:`),M.forEach(t),qe=c(x),C=a(x,"UL",{});var J=r(C);j=a(J,"LI",{});var Q=r(j);Ze=d(Q,"a single Tensor with "),ee=a(Q,"CODE",{});var Tt=r(ee);we=d(Tt,"input_ids"),Tt.forEach(t),Ee=d(Q," only and nothing else: "),pe=a(Q,"CODE",{});var wt=r(pe);Ge=d(wt,"model(input_ids)"),wt.forEach(t),Q.forEach(t),R=c(J),L=a(J,"LI",{});var X=r(L);he=d(X,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),ue=a(X,"CODE",{});var $t=r(ue);et=d($t,"model([input_ids, attention_mask])"),$t.forEach(t),me=d(X," or "),fe=a(X,"CODE",{});var Bt=r(fe);tt=d(Bt,"model([input_ids, attention_mask, token_type_ids])"),Bt.forEach(t),X.forEach(t),We=c(J),O=a(J,"LI",{});var $e=r(O);te=d($e,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),K=a($e,"CODE",{});var xt=r(K);_e=d(xt,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),xt.forEach(t),$e.forEach(t),J.forEach(t),Me=c(x),P=a(x,"P",{});var Pe=r(P);ot=d(Pe,`Note that when creating models and layers with
`),G=a(Pe,"A",{href:!0,rel:!0});var it=r(G);H=d(it,"subclassing"),it.forEach(t),ge=d(Pe,` then you don\u2019t need to worry
about any of this, as you can just pass inputs like you would to any other Python function!`),Pe.forEach(t),this.h()},h(){h(G,"href","https://keras.io/guides/making_new_layers_and_models_via_subclassing/"),h(G,"rel","nofollow")},m(x,q){f(x,p,q),e(p,k),e(p,g),e(g,m),e(p,b),f(x,i,q),f(x,u,q),e(u,E),e(E,Je),e(u,Le),e(u,A),e(A,Be),f(x,xe,q),f(x,F,q),e(F,se),e(F,de),e(de,Qe),e(F,Se),e(F,I),e(I,Y),e(F,ze),e(F,U),e(U,Xe),e(F,Fe),e(F,ie),e(ie,De),e(F,Z),e(F,le),e(le,ce),e(F,Ye),f(x,qe,q),f(x,C,q),e(C,j),e(j,Ze),e(j,ee),e(ee,we),e(j,Ee),e(j,pe),e(pe,Ge),e(C,R),e(C,L),e(L,he),e(L,ue),e(ue,et),e(L,me),e(L,fe),e(fe,tt),e(C,We),e(C,O),e(O,te),e(O,K),e(K,_e),f(x,Me,q),f(x,P,q),e(P,ot),e(P,G),e(G,H),e(P,ge)},d(x){x&&t(p),x&&t(i),x&&t(u),x&&t(xe),x&&t(F),x&&t(qe),x&&t(C),x&&t(Me),x&&t(P)}}}function Xm(z){let p,k,g,m,b;return{c(){p=n("p"),k=s("Although the recipe for forward pass needs to be defined within this function, one should call the "),g=n("code"),m=s("Module"),b=s(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(i){p=a(i,"P",{});var u=r(p);k=d(u,"Although the recipe for forward pass needs to be defined within this function, one should call the "),g=a(u,"CODE",{});var E=r(g);m=d(E,"Module"),E.forEach(t),b=d(u,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),u.forEach(t)},m(i,u){f(i,p,u),e(p,k),e(p,g),e(g,m),e(p,b)},d(i){i&&t(p)}}}function Ym(z){let p,k,g,m,b;return m=new dt({props:{code:`from transformers import BlenderbotTokenizer, TFBlenderbotModel
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),{c(){p=n("p"),k=s("Example:"),g=l(),y(m.$$.fragment)},l(i){p=a(i,"P",{});var u=r(p);k=d(u,"Example:"),u.forEach(t),g=c(i),v(m.$$.fragment,i)},m(i,u){f(i,p,u),e(p,k),f(i,g,u),T(m,i,u),b=!0},p:_t,i(i){b||(w(m.$$.fragment,i),b=!0)},o(i){$(m.$$.fragment,i),b=!1},d(i){i&&t(p),i&&t(g),B(m,i)}}}function Zm(z){let p,k,g,m,b,i,u,E,Je,Le,A,Be,xe,F,se,de,Qe,Se,I,Y,ze,U,Xe,Fe,ie,De,Z,le,ce,Ye,qe,C,j,Ze,ee,we,Ee,pe,Ge,R,L,he,ue,et,me,fe,tt,We,O,te,K,_e,Me,P,ot,G,H,ge;return{c(){p=n("p"),k=s("TensorFlow models and layers in "),g=n("code"),m=s("transformers"),b=s(" accept two formats as input:"),i=l(),u=n("ul"),E=n("li"),Je=s("having all inputs as keyword arguments (like PyTorch models), or"),Le=l(),A=n("li"),Be=s("having all inputs as a list, tuple or dict in the first positional argument."),xe=l(),F=n("p"),se=s(`The reason the second format is supported is that Keras methods prefer this format when passing inputs to models
and layers. Because of this support, when using methods like `),de=n("code"),Qe=s("model.fit()"),Se=s(` things should \u201Cjust work\u201D for you - just
pass your inputs and labels in any format that `),I=n("code"),Y=s("model.fit()"),ze=s(` supports! If, however, you want to use the second
format outside of Keras methods like `),U=n("code"),Xe=s("fit()"),Fe=s(" and "),ie=n("code"),De=s("predict()"),Z=s(`, such as when creating your own layers or models with
the Keras `),le=n("code"),ce=s("Functional"),Ye=s(` API, there are three possibilities you can use to gather all the input Tensors in the first
...
`),K=a($e,"CODE",{});var xt=r(K);_e=d(xt,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),xt.forEach(t),$e.forEach(t),J.forEach(t),Me=c(x),P=a(x,"P",{});var Pe=r(P);ot=d(Pe,`Note that when creating models and layers with
`),G=a(Pe,"A",{href:!0,rel:!0});var it=r(G);H=d(it,"subclassing"),it.forEach(t),ge=d(Pe,` then you don\u2019t need to worry
about any of this, as you can just pass inputs like you would to any other Python function!`),Pe.forEach(t),this.h()},h(){h(G,"href","https://keras.io/guides/making_new_layers_and_models_via_subclassing/"),h(G,"rel","nofollow")},m(x,q){f(x,p,q),e(p,k),e(p,g),e(g,m),e(p,b),f(x,i,q),f(x,u,q),e(u,E),e(E,Je),e(u,Le),e(u,A),e(A,Be),f(x,xe,q),f(x,F,q),e(F,se),e(F,de),e(de,Qe),e(F,Se),e(F,I),e(I,Y),e(F,ze),e(F,U),e(U,Xe),e(F,Fe),e(F,ie),e(ie,De),e(F,Z),e(F,le),e(le,ce),e(F,Ye),f(x,qe,q),f(x,C,q),e(C,j),e(j,Ze),e(j,ee),e(ee,we),e(j,Ee),e(j,pe),e(pe,Ge),e(C,R),e(C,L),e(L,he),e(L,ue),e(ue,et),e(L,me),e(L,fe),e(fe,tt),e(C,We),e(C,O),e(O,te),e(O,K),e(K,_e),f(x,Me,q),f(x,P,q),e(P,ot),e(P,G),e(G,H),e(P,ge)},d(x){x&&t(p),x&&t(i),x&&t(u),x&&t(xe),x&&t(F),x&&t(qe),x&&t(C),x&&t(Me),x&&t(P)}}}function ef(z){let p,k,g,m,b;return{c(){p=n("p"),k=s("Although the recipe for forward pass needs to be defined within this function, one should call the "),g=n("code"),m=s("Module"),b=s(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(i){p=a(i,"P",{});var u=r(p);k=d(u,"Although the recipe for forward pass needs to be defined within this function, one should call the "),g=a(u,"CODE",{});var E=r(g);m=d(E,"Module"),E.forEach(t),b=d(u,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),u.forEach(t)},m(i,u){f(i,p,u),e(p,k),e(p,g),e(g,m),e(p,b)},d(i){i&&t(p)}}}function tf(z){let p,k,g,m,b;return{c(){p=n("p"),k=s("Although the recipe for forward pass needs to be defined within this function, one should call the "),g=n("code"),m=s("Module"),b=s(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(i){p=a(i,"P",{});var u=r(p);k=d(u,"Although the recipe for forward pass needs to be defined within this function, one should call the "),g=a(u,"CODE",{});var E=r(g);m=d(E,"Module"),E.forEach(t),b=d(u,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),u.forEach(t)},m(i,u){f(i,p,u),e(p,k),e(p,g),e(g,m),e(p,b)},d(i){i&&t(p)}}}function of(z){let p,k,g,m,b;return m=new dt({props:{code:`from transformers import BlenderbotTokenizer, FlaxBlenderbotModel
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),{c(){p=n("p"),k=s("Example:"),g=l(),y(m.$$.fragment)},l(i){p=a(i,"P",{});var u=r(p);k=d(u,"Example:"),u.forEach(t),g=c(i),v(m.$$.fragment,i)},m(i,u){f(i,p,u),e(p,k),f(i,g,u),T(m,i,u),b=!0},p:_t,i(i){b||(w(m.$$.fragment,i),b=!0)},o(i){$(m.$$.fragment,i),b=!1},d(i){i&&t(p),i&&t(g),B(m,i)}}}function nf(z){let p,k,g,m,b;return m=new dt({props:{code:`from transformers import BlenderbotTokenizer, FlaxBlenderbotForConditionalGeneration
...
<span class="hljs-meta">&gt;&gt;&gt; </span>encoder_outputs = model.encode(**inputs)`}}),{c(){p=n("p"),k=s("Example:"),g=l(),y(m.$$.fragment)},l(i){p=a(i,"P",{});var u=r(p);k=d(u,"Example:"),u.forEach(t),g=c(i),v(m.$$.fragment,i)},m(i,u){f(i,p,u),e(p,k),f(i,g,u),T(m,i,u),b=!0},p:_t,i(i){b||(w(m.$$.fragment,i),b=!0)},o(i){$(m.$$.fragment,i),b=!1},d(i){i&&t(p),i&&t(g),B(m,i)}}}function af(z){let p,k,g,m,b;return m=new dt({props:{code:`import jax.numpy as jnp
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_decoder_hidden_states = outputs.last_hidden_state`}}),{c(){p=n("p"),k=s("Example:"),g=l(),y(m.$$.fragment)},l(i){p=a(i,"P",{});var u=r(p);k=d(u,"Example:"),u.forEach(t),g=c(i),v(m.$$.fragment,i)},m(i,u){f(i,p,u),e(p,k),f(i,g,u),T(m,i,u),b=!0},p:_t,i(i){b||(w(m.$$.fragment,i),b=!0)},o(i){$(m.$$.fragment,i),b=!1},d(i){i&&t(p),i&&t(g),B(m,i)}}}function rf(z){let p,k,g,m,b;return{c(){p=n("p"),k=s("Although the recipe for forward pass needs to be defined within this function, one should call the "),g=n("code"),m=s("Module"),b=s(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(i){p=a(i,"P",{});var u=r(p);k=d(u,"Although the recipe for forward pass needs to be defined within this function, one should call the "),g=a(u,"CODE",{});var E=r(g);m=d(E,"Module"),E.forEach(t),b=d(u,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),u.forEach(t)},m(i,u){f(i,p,u),e(p,k),e(p,g),e(g,m),e(p,b)},d(i){i&&t(p)}}}function sf(z){let p,k,g,m,b;return m=new dt({props:{code:`from transformers import BlenderbotTokenizer, FlaxBlenderbotForConditionalGeneration
...
<span class="hljs-meta">&gt;&gt;&gt; </span>text = <span class="hljs-string">&quot;My friends are cool but they eat too many carbs.&quot;</span>
<span class="hljs-meta">&gt;&gt;&gt; </span>inputs = tokenizer(text, max_length=<span class="hljs-number">1024</span>, return_tensors=<span class="hljs-string">&quot;jax&quot;</span>)
<span class="hljs-meta">&gt;&gt;&gt; </span>encoder_outputs = model.encode(**inputs)`}}),{c(){p=n("p"),k=s("Example:"),g=l(),y(m.$$.fragment)},l(i){p=a(i,"P",{});var u=r(p);k=d(u,"Example:"),u.forEach(t),g=c(i),v(m.$$.fragment,i)},m(i,u){f(i,p,u),e(p,k),f(i,g,u),T(m,i,u),b=!0},p:_t,i(i){b||(w(m.$$.fragment,i),b=!0)},o(i){$(m.$$.fragment,i),b=!1},d(i){i&&t(p),i&&t(g),B(m,i)}}}function df(z){let p,k,g,m,b;return m=new dt({props:{code:`import jax.numpy as jnp
from transformers import BlenderbotTokenizer, FlaxBlenderbotForConditionalGeneration
...
<span class="hljs-meta">&gt;&gt;&gt; </span>outputs = model.decode(decoder_input_ids, encoder_outputs)
<span class="hljs-meta">&gt;&gt;&gt; </span>logits = outputs.logits`}}),{c(){p=n("p"),k=s("Example:"),g=l(),y(m.$$.fragment)},l(i){p=a(i,"P",{});var u=r(p);k=d(u,"Example:"),u.forEach(t),g=c(i),v(m.$$.fragment,i)},m(i,u){f(i,p,u),e(p,k),f(i,g,u),T(m,i,u),b=!0},p:_t,i(i){b||(w(m.$$.fragment,i),b=!0)},o(i){$(m.$$.fragment,i),b=!1},d(i){i&&t(p),i&&t(g),B(m,i)}}}function lf(z){let p,k,g,m,b,i,u,E,Je,Le,A,Be,xe,F,se,de,Qe,Se,I,Y,ze,U,Xe,Fe,ie,De,Z,le,ce,Ye,qe,C,j,Ze,ee,we,Ee,pe,Ge,R,L,he,ue,et,me,fe,tt,We,O,te,K,_e,Me,P,ot,G,H,ge,x,q,gt,Ce,bt,je,M,Oe,kt,yt,vt,V,J,Q,Tt,wt,X,$t,Bt,$e,xt,Pe,it,zt,Vt,Wa,Ro,Dd,Ua,Gd,Cs,pa,Wd,js,Ho,Os,Ft,Jt,Ra,Ko,Ud,Ha,Rd,Ps,Ne,Vo,Hd,qt,Kd,ha,Vd,Jd,Jo,Qd,Xd,Yd,Et,Zd,ua,ei,ti,ma,oi,ni,ai,Qt,Ns,Mt,Xt,Ka,Qo,ri,Va,si,As,be,Xo,di,Ja,ii,li,Yt,Qa,ci,pi,fa,hi,ui,mi,Yo,fi,_a,_i,gi,bi,lt,Zo,ki,Xa,yi,vi,Ya,ga,Ti,Za,wi,Is,Ct,Zt,er,en,$i,tr,Bi,Ls,ke,tn,xi,on,zi,or,Fi,qi,Ei,eo,nr,Mi,Ci,ba,ji,Oi,Pi,nn,Ni,ka,Ai,Ii,Li,ct,an,Si,ar,Di,Gi,rr,ya,Wi,sr,Ui,Ss,jt,to,dr,rn,Ri,ir,Hi,Ds,nt,Ki,lr,Vi,Ji,cr,Qi,Xi,pr,Yi,Gs,Ae,sn,Zi,dn,el,va,tl,ol,nl,ln,al,cn,rl,sl,dl,Ue,pn,il,Ot,ll,Ta,cl,pl,hr,hl,ul,ml,oo,fl,no,Ws,Pt,ao,ur,hn,_l,mr,gl,Us,at,bl,wa,kl,yl,fr,vl,Tl,_r,wl,Rs,Ie,un,$l,mn,Bl,$a,xl,zl,Fl,fn,ql,_n,El,Ml,Cl,Re,gn,jl,Nt,Ol,Ba,Pl,Nl,gr,Al,Il,Ll,ro,Sl,so,Hs,At,io,br,bn,Dl,kr,Gl,Ks,It,kn,Wl,lo,yn,Ul,co,Vs,Lt,po,yr,vn,Rl,vr,Hl,Js,ye,Tn,Kl,wn,Vl,xa,Jl,Ql,Xl,$n,Yl,Bn,Zl,ec,tc,ho,oc,He,xn,nc,St,ac,za,rc,sc,Tr,dc,ic,lc,uo,cc,mo,Qs,Dt,fo,wr,zn,pc,$r,hc,Xs,ve,Fn,uc,qn,mc,Fa,fc,_c,gc,En,bc,Mn,kc,yc,vc,_o,Tc,oe,Cn,wc,Gt,$c,qa,Bc,xc,Br,zc,Fc,qc,go,Ec,xr,Mc,Cc,zr,Fr,qr,Er,jc,Oc,Mr,Cr,jr,jn,Pc,Or,Nc,Ac,Ys,Wt,bo,Pr,On,Ic,Nr,Lc,Zs,S,Pn,Sc,Nn,Dc,Ea,Gc,Wc,Uc,An,Rc,In,Hc,Kc,Vc,Ar,Jc,Qc,rt,Ir,Ln,Xc,Yc,Lr,Sn,Zc,ep,Sr,Dn,tp,op,Dr,Gn,np,ap,Ke,Wn,rp,Ut,sp,Gr,dp,ip,Wr,lp,cp,pp,ko,hp,yo,up,vo,Un,mp,To,fp,wo,Rn,_p,$o,ed,Rt,Bo,Ur,Hn,gp,Rr,bp,td,D,Kn,kp,Vn,yp,Ma,vp,Tp,wp,Jn,$p,Qn,Bp,xp,zp,Hr,Fp,qp,st,Kr,Xn,Ep,Mp,Vr,Yn,Cp,jp,Jr,Zn,Op,Pp,Qr,ea,Np,Ap,W,ta,Ip,Ht,Lp,Xr,Sp,Dp,Yr,Gp,Wp,Up,xo,Rp,Zr,Hp,Kp,es,ts,os,ns,Vp,Jp,as,rs,ss,ds,Qp,Xp,is,ls,cs,ps,Yp,Zp,hs,us,oa,zo,Fo,ms,na,eh,fs,th,oh,_s,nh,ah,qo,aa,rh,Eo,sh,Mo,ra,dh,Co,od;return i=new Te({}),U=new Te({}),_e=new Te({}),Ro=new Te({}),Ho=new dt({props:{code:`from transformers import BlenderbotTokenizer, BlenderbotForConditionalGeneration
...
`}}),co=new ft({props:{anchor:"transformers.BlenderbotForCausalLM.forward.example",$$slots:{default:[Jm]},$$scope:{ctx:z}}}),vn=new Te({}),Tn=new N({props:{name:"class transformers.TFBlenderbotModel",anchor:"transformers.TFBlenderbotModel",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.TFBlenderbotModel.config",description:`<strong>config</strong> (<a href="/docs/transformers/main/en/model_doc/blenderbot#transformers.BlenderbotConfig">BlenderbotConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/main/en/main_classes/model#transformers.TFPreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/blenderbot/modeling_tf_blenderbot.py#L1151"}}),ho=new Uo({props:{$$slots:{default:[Qm]},$$scope:{ctx:z}}}),xn=new N({props:{name:"call",anchor:"transformers.TFBlenderbotModel.call",parameters:[{name:"input_ids",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"attention_mask",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"decoder_input_ids",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"decoder_attention_mask",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"decoder_position_ids",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"head_mask",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"decoder_head_mask",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"cross_attn_head_mask",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"encoder_outputs",val:": typing.Union[typing.Tuple, transformers.modeling_tf_outputs.TFBaseModelOutput, NoneType] = None"},{name:"past_key_values",val:": typing.Optional[typing.List[tensorflow.python.framework.ops.Tensor]] = None"},{name:"inputs_embeds",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"decoder_inputs_embeds",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"use_cache",val:": typing.Optional[bool] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"training",val:": typing.Optional[bool] = False"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.TFBlenderbotModel.call.input_ids",description:`<strong>input_ids</strong> (<code>tf.Tensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/main/en/main_classes/model#transformers.TFPreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/blenderbot/modeling_tf_blenderbot.py#L1273"}}),_o=new Uo({props:{$$slots:{default:[Zm]},$$scope:{ctx:z}}}),Cn=new N({props:{name:"call",anchor:"transformers.TFBlenderbotForConditionalGeneration.call",parameters:[{name:"input_ids",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"attention_mask",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"decoder_input_ids",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"decoder_attention_mask",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"decoder_position_ids",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"head_mask",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"decoder_head_mask",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"cross_attn_head_mask",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"encoder_outputs",val:": typing.Union[typing.Tuple, transformers.modeling_tf_outputs.TFBaseModelOutput, NoneType] = None"},{name:"past_key_values",val:": typing.Optional[typing.List[tensorflow.python.framework.ops.Tensor]] = None"},{name:"inputs_embeds",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"decoder_inputs_embeds",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"use_cache",val:": typing.Optional[bool] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"labels",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"training",val:": typing.Optional[bool] = False"}],parametersDescription:[{anchor:"transformers.TFBlenderbotForConditionalGeneration.call.input_ids",description:`<strong>input_ids</strong> (<code>tf.Tensor</code> of shape <code>({0})</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/main/en/model_doc/blenderbot#transformers.BlenderbotTokenizer">BlenderbotTokenizer</a>. See <a href="/docs/transformers/main/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/main/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
`}}),$o=new ft({props:{anchor:"transformers.FlaxBlenderbotModel.decode.example",$$slots:{default:[af]},$$scope:{ctx:z}}}),Hn=new Te({}),Kn=new N({props:{name:"class transformers.FlaxBlenderbotForConditionalGeneration",anchor:"transformers.FlaxBlenderbotForConditionalGeneration",parameters:[{name:"config",val:": BlenderbotConfig"},{name:"input_shape",val:": typing.Tuple[int] = (1, 1)"},{name:"seed",val:": int = 0"},{name:"dtype",val:": dtype = <class 'jax.numpy.float32'>"},{name:"_do_init",val:": bool = True"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.FlaxBlenderbotForConditionalGeneration.config",description:`<strong>config</strong> (<a href="/docs/transformers/main/en/model_doc/blenderbot#transformers.BlenderbotConfig">BlenderbotConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
...
`}}),Co=new ft({props:{anchor:"transformers.FlaxBlenderbotForConditionalGeneration.decode.example",$$slots:{default:[df]},$$scope:{ctx:z}}}),{c(){p=n("meta"),k=l(),g=n("h1"),m=n("a"),b=n("span"),y(i.$$.fragment),u=l(),E=n("span"),Je=s("Blenderbot"),Le=l(),A=n("p"),Be=n("strong"),xe=s("DISCLAIMER:"),F=s(" If you see something strange, file a "),se=n("a"),de=s("Github Issue"),Qe=s(" ."),Se=l(),I=n("h2"),Y=n("a"),ze=n("span"),y(U.$$.fragment),Xe=l(),Fe=n("span"),ie=s("Overview"),De=l(),Z=n("p"),le=s("The Blender chatbot model was proposed in "),ce=n("a"),Ye=s("Recipes for building an open-domain chatbot"),qe=s(` Stephen Roller, Emily Dinan, Naman Goyal, Da Ju, Mary Williamson, Yinhan Liu,
...
failure cases of our models.`),Ge=l(),R=n("p"),L=s("This model was contributed by "),he=n("a"),ue=s("sshleifer"),et=s(". The authors\u2019 code can be found "),me=n("a"),fe=s("here"),tt=s(" ."),We=l(),O=n("h2"),te=n("a"),K=n("span"),y(_e.$$.fragment),Me=l(),P=n("span"),ot=s("Implementation Notes"),G=l(),H=n("ul"),ge=n("li"),x=s("Blenderbot uses a standard "),q=n("a"),gt=s("seq2seq model transformer"),Ce=s(" based architecture."),bt=l(),je=n("li"),M=s("Available checkpoints can be found in the "),Oe=n("a"),kt=s("model hub"),yt=s("."),vt=l(),V=n("li"),J=s("This is the "),Q=n("em"),Tt=s("default"),wt=s(` Blenderbot model class. However, some smaller checkpoints, such as
`),X=n("code"),$t=s("facebook/blenderbot_small_90M"),Bt=s(`, have a different architecture and consequently should be used with
`),$e=n("a"),xt=s("BlenderbotSmall"),Pe=s("."),it=l(),zt=n("h2"),Vt=n("a"),Wa=n("span"),y(Ro.$$.fragment),Dd=l(),Ua=n("span"),Gd=s("Usage"),Cs=l(),pa=n("p"),Wd=s("Here is an example of model usage:"),js=l(),y(Ho.$$.fragment),Os=l(),Ft=n("h2"),Jt=n("a"),Ra=n("span"),y(Ko.$$.fragment),Ud=l(),Ha=n("span"),Rd=s("BlenderbotConfig"),Ps=l(),Ne=n("div"),y(Vo.$$.fragment),Hd=l(),qt=n("p"),Kd=s("This is the configuration class to store the configuration of a "),ha=n("a"),Vd=s("BlenderbotModel"),Jd=s(`. It is used to instantiate an
...
documentation from `),ma=n("a"),oi=s("PretrainedConfig"),ni=s(" for more information."),ai=l(),y(Qt.$$.fragment),Ns=l(),Mt=n("h2"),Xt=n("a"),Ka=n("span"),y(Qo.$$.fragment),ri=l(),Va=n("span"),si=s("BlenderbotTokenizer"),As=l(),be=n("div"),y(Xo.$$.fragment),di=l(),Ja=n("p"),ii=s("Construct a Blenderbot tokenizer."),li=l(),Yt=n("p"),Qa=n("code"),ci=s("Blenderbot"),pi=s(" is nearly identical to "),fa=n("a"),hi=s("RobertaTokenizer"),ui=s(` and runs end-to-end tokenization: punctuation splitting
and wordpiece. The only difference is that it doesn\u2019t add BOS token to the beginning of sequences.`),mi=l(),Yo=n("p"),fi=s("Refer to superclass "),_a=n("a"),_i=s("RobertaTokenizer"),gi=s(" for usage examples and documentation concerning parameters."),bi=l(),lt=n("div"),y(Zo.$$.fragment),ki=l(),Xa=n("p"),yi=s(`Build model inputs from a sequence or a pair of sequence for sequence classification tasks by concatenating and
adding special tokens. A Blenderbot sequence has the following format:`),vi=l(),Ya=n("ul"),ga=n("li"),Ti=s("single sequence: "),Za=n("code"),wi=s("X </s>"),Is=l(),Ct=n("h2"),Zt=n("a"),er=n("span"),y(en.$$.fragment),$i=l(),tr=n("span"),Bi=s("BlenderbotTokenizerFast"),Ls=l(),ke=n("div"),y(tn.$$.fragment),xi=l(),on=n("p"),zi=s("Construct a \u201Cfast\u201D Blenderbot tokenizer (backed by HuggingFace\u2019s "),or=n("em"),Fi=s("tokenizers"),qi=s(" library)."),Ei=l(),eo=n("p"),nr=n("code"),Mi=s("BlenderbotFast"),Ci=s(" is nearly identical to "),ba=n("a"),ji=s("RobertaTokenizerFast"),Oi=s(` and runs end-to-end tokenization: punctuation
splitting and wordpiece. The only difference is that it doesn\u2019t add BOS token to the beginning of sequences.`),Pi=l(),nn=n("p"),Ni=s("Refer to superclass "),ka=n("a"),Ai=s("RobertaTokenizerFast"),Ii=s(" for usage examples and documentation concerning parameters."),Li=l(),ct=n("div"),y(an.$$.fragment),Si=l(),ar=n("p"),Di=s(`Build model inputs from a sequence or a pair of sequence for sequence classification tasks by concatenating and
adding special tokens. A Blenderbot sequence has the following format:`),Gi=l(),rr=n("ul"),ya=n("li"),Wi=s("single sequence: "),sr=n("code"),Ui=s("X </s>"),Ss=l(),jt=n("h2"),to=n("a"),dr=n("span"),y(rn.$$.fragment),Ri=l(),ir=n("span"),Hi=s("BlenderbotModel"),Ds=l(),nt=n("p"),Ki=s("See "),lr=n("code"),Vi=s("transformers.BartModel"),Ji=s(" for arguments to "),cr=n("em"),Qi=s("forward"),Xi=s(" and "),pr=n("em"),Yi=s("generate"),Gs=l(),Ae=n("div"),y(sn.$$.fragment),Zi=l(),dn=n("p"),el=s(`The bare Blenderbot Model outputting raw hidden-states without any specific head on top.
...
and behavior.`),dl=l(),Ue=n("div"),y(pn.$$.fragment),il=l(),Ot=n("p"),ll=s("The "),Ta=n("a"),cl=s("BlenderbotModel"),pl=s(" forward method, overrides the "),hr=n("code"),hl=s("__call__"),ul=s(" special method."),ml=l(),y(oo.$$.fragment),fl=l(),y(no.$$.fragment),Ws=l(),Pt=n("h2"),ao=n("a"),ur=n("span"),y(hn.$$.fragment),_l=l(),mr=n("span"),gl=s("BlenderbotForConditionalGeneration"),Us=l(),at=n("p"),bl=s("See "),wa=n("a"),kl=s("BartForConditionalGeneration"),yl=s(" for arguments to "),fr=n("em"),vl=s("forward"),Tl=s(" and "),_r=n("em"),wl=s("generate"),Rs=l(),Ie=n("div"),y(un.$$.fragment),$l=l(),mn=n("p"),Bl=s(`The Blenderbot Model with a language modeling head. Can be used for summarization.
This model inherits from `),$a=n("a"),xl=s("PreTrainedModel"),zl=s(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Fl=l(),fn=n("p"),ql=s("This model is also a PyTorch "),_n=n("a"),El=s("torch.nn.Module"),Ml=s(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Cl=l(),Re=n("div"),y(gn.$$.fragment),jl=l(),Nt=n("p"),Ol=s("The "),Ba=n("a"),Pl=s("BlenderbotForConditionalGeneration"),Nl=s(" forward method, overrides the "),gr=n("code"),Al=s("__call__"),Il=s(" special method."),Ll=l(),y(ro.$$.fragment),Sl=l(),y(so.$$.fragment),Hs=l(),At=n("h2"),io=n("a"),br=n("span"),y(bn.$$.fragment),Dl=l(),kr=n("span"),Gl=s("BlenderbotForCausalLM"),Ks=l(),It=n("div"),y(kn.$$.fragment),Wl=l(),lo=n("div"),y(yn.$$.fragment),Ul=l(),y(co.$$.fragment),Vs=l(),Lt=n("h2"),po=n("a"),yr=n("span"),y(vn.$$.fragment),Rl=l(),vr=n("span"),Hl=s("TFBlenderbotModel"),Js=l(),ye=n("div"),y(Tn.$$.fragment),Kl=l(),wn=n("p"),Vl=s(`The bare BLENDERBOT Model outputting raw hidden-states without any specific head on top.
This model inherits from `),xa=n("a"),Jl=s("TFPreTrainedModel"),Ql=s(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Xl=l(),$n=n("p"),Yl=s("This model is also a "),Bn=n("a"),Zl=s("tf.keras.Model"),ec=s(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),tc=l(),y(ho.$$.fragment),oc=l(),He=n("div"),y(xn.$$.fragment),nc=l(),St=n("p"),ac=s("The "),za=n("a"),rc=s("TFBlenderbotModel"),sc=s(" forward method, overrides the "),Tr=n("code"),dc=s("__call__"),ic=s(" special method."),lc=l(),y(uo.$$.fragment),cc=l(),y(mo.$$.fragment),Qs=l(),Dt=n("h2"),fo=n("a"),wr=n("span"),y(zn.$$.fragment),pc=l(),$r=n("span"),hc=s("TFBlenderbotForConditionalGeneration"),Xs=l(),ve=n("div"),y(Fn.$$.fragment),uc=l(),qn=n("p"),mc=s(`The BLENDERBOT Model with a language modeling head. Can be used for summarization.
This model inherits from `),Fa=n("a"),fc=s("TFPreTrainedModel"),_c=s(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),gc=l(),En=n("p"),bc=s("This model is also a "),Mn=n("a"),kc=s("tf.keras.Model"),yc=s(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),vc=l(),y(_o.$$.fragment),Tc=l(),oe=n("div"),y(Cn.$$.fragment),wc=l(),Gt=n("p"),$c=s("The "),qa=n("a"),Bc=s("TFBlenderbotForConditionalGeneration"),xc=s(" forward method, overrides the "),Br=n("code"),zc=s("__call__"),Fc=s(" special method."),qc=l(),y(go.$$.fragment),Ec=l(),xr=n("p"),Mc=s("Conversation example::"),Cc=l(),zr=n("blockquote"),Fr=n("blockquote"),qr=n("blockquote"),Er=n("p"),jc=s(`from transformers import BlenderbotTokenizer, TFBlenderbotForConditionalGeneration >>> mname =
...
skip_special_tokens=True)[0])`),Ys=l(),Wt=n("h2"),bo=n("a"),Pr=n("span"),y(On.$$.fragment),Ic=l(),Nr=n("span"),Lc=s("FlaxBlenderbotModel"),Zs=l(),S=n("div"),y(Pn.$$.fragment),Sc=l(),Nn=n("p"),Dc=s(`The bare MBart Model transformer outputting raw hidden-states without any specific head on top.
...
`),In=n("a"),Hc=s("flax.nn.Module"),Kc=s(` subclass. Use it as a
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),Vc=l(),Ar=n("p"),Jc=s("Finally, this model supports inherent JAX features such as:"),Qc=l(),rt=n("ul"),Ir=n("li"),Ln=n("a"),Xc=s("Just-In-Time (JIT) compilation"),Yc=l(),Lr=n("li"),Sn=n("a"),Zc=s("Automatic Differentiation"),ep=l(),Sr=n("li"),Dn=n("a"),tp=s("Vectorization"),op=l(),Dr=n("li"),Gn=n("a"),np=s("Parallelization"),ap=l(),Ke=n("div"),y(Wn.$$.fragment),rp=l(),Ut=n("p"),sp=s("The "),Gr=n("code"),dp=s("FlaxBlenderbotPreTrainedModel"),ip=s(" forward method, overrides the "),Wr=n("code"),lp=s("__call__"),cp=s(" special method."),pp=l(),y(ko.$$.fragment),hp=l(),y(yo.$$.fragment),up=l(),vo=n("div"),y(Un.$$.fragment),mp=l(),y(To.$$.fragment),fp=l(),wo=n("div"),y(Rn.$$.fragment),_p=l(),y($o.$$.fragment),ed=l(),Rt=n("h2"),Bo=n("a"),Ur=n("span"),y(Hn.$$.fragment),gp=l(),Rr=n("span"),bp=s("FlaxBlenderbotForConditionalGeneration"),td=l(),D=n("div"),y(Kn.$$.fragment),kp=l(),Vn=n("p"),yp=s(`The Blenderbot Model with a language modeling head. Can be used for summarization.
...
`),Qn=n("a"),Bp=s("flax.nn.Module"),xp=s(` subclass. Use it as a
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),zp=l(),Hr=n("p"),Fp=s("Finally, this model supports inherent JAX features such as:"),qp=l(),st=n("ul"),Kr=n("li"),Xn=n("a"),Ep=s("Just-In-Time (JIT) compilation"),Mp=l(),Vr=n("li"),Yn=n("a"),Cp=s("Automatic Differentiation"),jp=l(),Jr=n("li"),Zn=n("a"),Op=s("Vectorization"),Pp=l(),Qr=n("li"),ea=n("a"),Np=s("Parallelization"),Ap=l(),W=n("div"),y(ta.$$.fragment),Ip=l(),Ht=n("p"),Lp=s("The "),Xr=n("code"),Sp=s("FlaxBlenderbotPreTrainedModel"),Dp=s(" forward method, overrides the "),Yr=n("code"),Gp=s("__call__"),Wp=s(" special method."),Up=l(),y(xo.$$.fragment),Rp=l(),Zr=n("p"),Hp=s("Conversation example::"),Kp=l(),es=n("blockquote"),ts=n("blockquote"),os=n("blockquote"),ns=n("p"),Vp=s("from transformers import BlenderbotTokenizer, FlaxBlenderbotForConditionalGeneration, BlenderbotConfig"),Jp=l(),as=n("blockquote"),rs=n("blockquote"),ss=n("blockquote"),ds=n("p"),Qp=s(`model = FlaxBlenderbotForConditionalGeneration.from_pretrained(\u2018facebook/blenderbot-400M-distill\u2019) >>>
...
max_length=1024, return_tensors=\u2018np\u2019)`),Zp=l(),hs=n("blockquote"),us=n("blockquote"),oa=n("blockquote"),zo=n("h1"),Fo=n("a"),ms=n("span"),y(na.$$.fragment),eh=l(),fs=n("span"),th=s("Generate Reply >>> reply_ids = model.generate(inputs[\u2018input_ids\u2019], num_beams=4, max_length=5,"),oh=l(),_s=n("p"),nh=s(`early_stopping=True).sequences >>> print([tokenizer.decode(g, skip_special_tokens=True,
clean_up_tokenization_spaces=False) for g in reply_ids])`),ah=l(),qo=n("div"),y(aa.$$.fragment),rh=l(),y(Eo.$$.fragment),sh=l(),Mo=n("div"),y(ra.$$.fragment),dh=l(),y(Co.$$.fragment),this.h()},l(o){const _=Gm('[data-svelte="svelte-1phssyn"]',document.head);p=a(_,"META",{name:!0,content:!0}),_.forEach(t),k=c(o),g=a(o,"H1",{class:!0});var sa=r(g);m=a(sa,"A",{id:!0,class:!0,href:!0});var gs=r(m);b=a(gs,"SPAN",{});var bs=r(b);v(i.$$.fragment,bs),bs.forEach(t),gs.forEach(t),u=c(sa),E=a(sa,"SPAN",{});var ks=r(E);Je=d(ks,"Blenderbot"),ks.forEach(t),sa.forEach(t),Le=c(o),A=a(o,"P",{});var jo=r(A);Be=a(jo,"STRONG",{});var ys=r(Be);xe=d(ys,"DISCLAIMER:"),ys.forEach(t),F=d(jo," If you see something strange, file a "),se=a(jo,"A",{href:!0,rel:!0});var vs=r(se);de=d(vs,"Github Issue"),vs.forEach(t),Qe=d(jo," ."),jo.forEach(t),Se=c(o),I=a(o,"H2",{class:!0});var da=r(I);Y=a(da,"A",{id:!0,class:!0,href:!0});var Ts=r(Y);ze=a(Ts,"SPAN",{});var ws=r(ze);v(U.$$.fragment,ws),ws.forEach(t),Ts.forEach(t),Xe=c(da),Fe=a(da,"SPAN",{});var $s=r(Fe);ie=d($s,"Overview"),$s.forEach(t),da.forEach(t),De=c(o),Z=a(o,"P",{});var ia=r(Z);le=d(ia,"The Blender chatbot model was proposed in "),ce=a(ia,"A",{href:!0,rel:!0});var Bs=r(ce);Ye=d(Bs,"Recipes for building an open-domain chatbot"),Bs.forEach(t),qe=d(ia,` Stephen Roller, Emily Dinan, Naman Goyal, Da Ju, Mary Williamson, Yinhan Liu,
Jing Xu, Myle Ott, Kurt Shuster, Eric M. Smith, Y-Lan Boureau, Jason Weston on 30 Apr 2020.`),ia.forEach(t),C=c(o),j=a(o,"P",{});var xs=r(j);Ze=d(xs,"The abstract of the paper is the following:"),xs.forEach(t),ee=c(o),we=a(o,"P",{});var zs=r(we);Ee=a(zs,"EM",{});var Fs=r(Ee);pe=d(Fs,`Building open-domain chatbots is a challenging area for machine learning research. While prior work has shown that
scaling neural models in the number of parameters and the size of the data they are trained on gives improved results,
we show that other ingredients are important for a high-performing chatbot. Good conversation requires a number of
skills that an expert conversationalist blends in a seamless way: providing engaging talking points and listening to
their partners, and displaying knowledge, empathy and personality appropriately, while maintaining a consistent
...
and code publicly available. Human evaluations show our best models are superior to existing approaches in multi-turn
dialogue in terms of engagingness and humanness measurements. We then discuss the limitations of this work by analyzing
failure cases of our models.`),Fs.forEach(t),zs.forEach(t),Ge=c(o),R=a(o,"P",{});var Kt=r(R);L=d(Kt,"This model was contributed by "),he=a(Kt,"A",{href:!0,rel:!0});var qs=r(he);ue=d(qs,"sshleifer"),qs.forEach(t),et=d(Kt,". The authors\u2019 code can be found "),me=a(Kt,"A",{href:!0,rel:!0});var ch=r(me);fe=d(ch,"here"),ch.forEach(t),tt=d(Kt," ."),Kt.forEach(t),We=c(o),O=a(o,"H2",{class:!0});var nd=r(O);te=a(nd,"A",{id:!0,class:!0,href:!0});var ph=r(te);K=a(ph,"SPAN",{});var hh=r(K);v(_e.$$.fragment,hh),hh.forEach(t),ph.forEach(t),Me=c(nd),P=a(nd,"SPAN",{});var uh=r(P);ot=d(uh,"Implementation Notes"),uh.forEach(t),nd.forEach(t),G=c(o),H=a(o,"UL",{});var Ca=r(H);ge=a(Ca,"LI",{});var ad=r(ge);x=d(ad,"Blenderbot uses a standard "),q=a(ad,"A",{href:!0,rel:!0});var mh=r(q);gt=d(mh,"seq2seq model transformer"),mh.forEach(t),Ce=d(ad," based architecture."),ad.forEach(t),bt=c(Ca),je=a(Ca,"LI",{});var rd=r(je);M=d(rd,"Available checkpoints can be found in the "),Oe=a(rd,"A",{href:!0,rel:!0});var fh=r(Oe);kt=d(fh,"model hub"),fh.forEach(t),yt=d(rd,"."),rd.forEach(t),vt=c(Ca),V=a(Ca,"LI",{});var Oo=r(V);J=d(Oo,"This is the "),Q=a(Oo,"EM",{});var _h=r(Q);Tt=d(_h,"default"),_h.forEach(t),wt=d(Oo,` Blenderbot model class. However, some smaller checkpoints, such as
`),X=a(Oo,"CODE",{});var gh=r(X);$t=d(gh,"facebook/blenderbot_small_90M"),gh.forEach(t),Bt=d(Oo,`, have a different architecture and consequently should be used with
`),$e=a(Oo,"A",{href:!0});var bh=r($e);xt=d(bh,"BlenderbotSmall"),bh.forEach(t),Pe=d(Oo,"."),Oo.forEach(t),Ca.forEach(t),it=c(o),zt=a(o,"H2",{class:!0});var sd=r(zt);Vt=a(sd,"A",{id:!0,class:!0,href:!0});var kh=r(Vt);Wa=a(kh,"SPAN",{});var yh=r(Wa);v(Ro.$$.fragment,yh),yh.forEach(t),kh.forEach(t),Dd=c(sd),Ua=a(sd,"SPAN",{});var vh=r(Ua);Gd=d(vh,"Usage"),vh.forEach(t),sd.forEach(t),Cs=c(o),pa=a(o,"P",{});var Th=r(pa);Wd=d(Th,"Here is an example of model usage:"),Th.forEach(t),js=c(o),v(Ho.$$.fragment,o),Os=c(o),Ft=a(o,"H2",{class:!0});var dd=r(Ft);Jt=a(dd,"A",{id:!0,class:!0,href:!0});var wh=r(Jt);Ra=a(wh,"SPAN",{});var $h=r(Ra);v(Ko.$$.fragment,$h),$h.forEach(t),wh.forEach(t),Ud=c(dd),Ha=a(dd,"SPAN",{});var Bh=r(Ha);Rd=d(Bh,"BlenderbotConfig"),Bh.forEach(t),dd.forEach(t),Ps=c(o),Ne=a(o,"DIV",{class:!0});var Po=r(Ne);v(Vo.$$.fragment,Po),Hd=c(Po),qt=a(Po,"P",{});var ja=r(qt);Kd=d(ja,"This is the configuration class to store the configuration of a "),ha=a(ja,"A",{href:!0});var xh=r(ha);Vd=d(xh,"BlenderbotModel"),xh.forEach(t),Jd=d(ja,`. It is used to instantiate an
Blenderbot model according to the specified arguments, defining the model architecture. Instantiating a
configuration with the defaults will yield a similar configuration to that of the Blenderbot
`),Jo=a(ja,"A",{href:!0,rel:!0});var zh=r(Jo);Qd=d(zh,"facebook/blenderbot-3B"),zh.forEach(t),Xd=d(ja," architecture."),ja.forEach(t),Yd=c(Po),Et=a(Po,"P",{});var Oa=r(Et);Zd=d(Oa,"Configuration objects inherit from "),ua=a(Oa,"A",{href:!0});var Fh=r(ua);ei=d(Fh,"PretrainedConfig"),Fh.forEach(t),ti=d(Oa,` and can be used to control the model outputs. Read the
documentation from `),ma=a(Oa,"A",{href:!0});var qh=r(ma);oi=d(qh,"PretrainedConfig"),qh.forEach(t),ni=d(Oa," for more information."),Oa.forEach(t),ai=c(Po),v(Qt.$$.fragment,Po),Po.forEach(t),Ns=c(o),Mt=a(o,"H2",{class:!0});var id=r(Mt);Xt=a(id,"A",{id:!0,class:!0,href:!0});var Eh=r(Xt);Ka=a(Eh,"SPAN",{});var Mh=r(Ka);v(Qo.$$.fragment,Mh),Mh.forEach(t),Eh.forEach(t),ri=c(id),Va=a(id,"SPAN",{});var Ch=r(Va);si=d(Ch,"BlenderbotTokenizer"),Ch.forEach(t),id.forEach(t),As=c(o),be=a(o,"DIV",{class:!0});var pt=r(be);v(Xo.$$.fragment,pt),di=c(pt),Ja=a(pt,"P",{});var jh=r(Ja);ii=d(jh,"Construct a Blenderbot tokenizer."),jh.forEach(t),li=c(pt),Yt=a(pt,"P",{});var Es=r(Yt);Qa=a(Es,"CODE",{});var Oh=r(Qa);ci=d(Oh,"Blenderbot"),Oh.forEach(t),pi=d(Es," is nearly identical to "),fa=a(Es,"A",{href:!0});var Ph=r(fa);hi=d(Ph,"RobertaTokenizer"),Ph.forEach(t),ui=d(Es,` and runs end-to-end tokenization: punctuation splitting
and wordpiece. The only difference is that it doesn\u2019t add BOS token to the beginning of sequences.`),Es.forEach(t),mi=c(pt),Yo=a(pt,"P",{});var ld=r(Yo);fi=d(ld,"Refer to superclass "),_a=a(ld,"A",{href:!0});var Nh=r(_a);_i=d(Nh,"RobertaTokenizer"),Nh.forEach(t),gi=d(ld," for usage examples and documentation concerning parameters."),ld.forEach(t),bi=c(pt),lt=a(pt,"DIV",{class:!0});var Pa=r(lt);v(Zo.$$.fragment,Pa),ki=c(Pa),Xa=a(Pa,"P",{});var Ah=r(Xa);yi=d(Ah,`Build model inputs from a sequence or a pair of sequence for sequence classification tasks by concatenating and
adding special tokens. A Blenderbot sequence has the following format:`),Ah.forEach(t),vi=c(Pa),Ya=a(Pa,"UL",{});var Ih=r(Ya);ga=a(Ih,"LI",{});var ih=r(ga);Ti=d(ih,"single sequence: "),Za=a(ih,"CODE",{});var Lh=r(Za);wi=d(Lh,"X </s>"),Lh.forEach(t),ih.forEach(t),Ih.forEach(t),Pa.forEach(t),pt.forEach(t),Is=c(o),Ct=a(o,"H2",{class:!0});var cd=r(Ct);Zt=a(cd,"A",{id:!0,class:!0,href:!0});var Sh=r(Zt);er=a(Sh,"SPAN",{});var Dh=r(er);v(en.$$.fragment,Dh),Dh.forEach(t),Sh.forEach(t),$i=c(cd),tr=a(cd,"SPAN",{});var Gh=r(tr);Bi=d(Gh,"BlenderbotTokenizerFast"),Gh.forEach(t),cd.forEach(t),Ls=c(o),ke=a(o,"DIV",{class:!0});var ht=r(ke);v(tn.$$.fragment,ht),xi=c(ht),on=a(ht,"P",{});var pd=r(on);zi=d(pd,"Construct a \u201Cfast\u201D Blenderbot tokenizer (backed by HuggingFace\u2019s "),or=a(pd,"EM",{});var Wh=r(or);Fi=d(Wh,"tokenizers"),Wh.forEach(t),qi=d(pd," library)."),pd.forEach(t),Ei=c(ht),eo=a(ht,"P",{});var Ms=r(eo);nr=a(Ms,"CODE",{});var Uh=r(nr);Mi=d(Uh,"BlenderbotFast"),Uh.forEach(t),Ci=d(Ms," is nearly identical to "),ba=a(Ms,"A",{href:!0});var Rh=r(ba);ji=d(Rh,"RobertaTokenizerFast"),Rh.forEach(t),Oi=d(Ms,` and runs end-to-end tokenization: punctuation
splitting and wordpiece. The only difference is that it doesn\u2019t add BOS token to the beginning of sequences.`),Ms.forEach(t),Pi=c(ht),nn=a(ht,"P",{});var hd=r(nn);Ni=d(hd,"Refer to superclass "),ka=a(hd,"A",{href:!0});var Hh=r(ka);Ai=d(Hh,"RobertaTokenizerFast"),Hh.forEach(t),Ii=d(hd," for usage examples and documentation concerning parameters."),hd.forEach(t),Li=c(ht),ct=a(ht,"DIV",{class:!0});var Na=r(ct);v(an.$$.fragment,Na),Si=c(Na),ar=a(Na,"P",{});var Kh=r(ar);Di=d(Kh,`Build model inputs from a sequence or a pair of sequence for sequence classification tasks by concatenating and
adding special tokens. A Blenderbot sequence has the following format:`),Kh.forEach(t),Gi=c(Na),rr=a(Na,"UL",{});var Vh=r(rr);ya=a(Vh,"LI",{});var lh=r(ya);Wi=d(lh,"single sequence: "),sr=a(lh,"CODE",{});var Jh=r(sr);Ui=d(Jh,"X </s>"),Jh.forEach(t),lh.forEach(t),Vh.forEach(t),Na.forEach(t),ht.forEach(t),Ss=c(o),jt=a(o,"H2",{class:!0});var ud=r(jt);to=a(ud,"A",{id:!0,class:!0,href:!0});var Qh=r(to);dr=a(Qh,"SPAN",{});var Xh=r(dr);v(rn.$$.fragment,Xh),Xh.forEach(t),Qh.forEach(t),Ri=c(ud),ir=a(ud,"SPAN",{});var Yh=r(ir);Hi=d(Yh,"BlenderbotModel"),Yh.forEach(t),ud.forEach(t),Ds=c(o),nt=a(o,"P",{});var la=r(nt);Ki=d(la,"See "),lr=a(la,"CODE",{});var Zh=r(lr);Vi=d(Zh,"transformers.BartModel"),Zh.forEach(t),Ji=d(la," for arguments to "),cr=a(la,"EM",{});var eu=r(cr);Qi=d(eu,"forward"),eu.forEach(t),Xi=d(la," and "),pr=a(la,"EM",{});var tu=r(pr);Yi=d(tu,"generate"),tu.forEach(t),la.forEach(t),Gs=c(o),Ae=a(o,"DIV",{class:!0});var No=r(Ae);v(sn.$$.fragment,No),Zi=c(No),dn=a(No,"P",{});var md=r(dn);el=d(md,`The bare Blenderbot Model outputting raw hidden-states without any specific head on top.
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),fd.forEach(t),dl=c(No),Ue=a(No,"DIV",{class:!0});var Ao=r(Ue);v(pn.$$.fragment,Ao),il=c(Ao),Ot=a(Ao,"P",{});var Aa=r(Ot);ll=d(Aa,"The "),Ta=a(Aa,"A",{href:!0});var au=r(Ta);cl=d(au,"BlenderbotModel"),au.forEach(t),pl=d(Aa," forward method, overrides the "),hr=a(Aa,"CODE",{});var ru=r(hr);hl=d(ru,"__call__"),ru.forEach(t),ul=d(Aa," special method."),Aa.forEach(t),ml=c(Ao),v(oo.$$.fragment,Ao),fl=c(Ao),v(no.$$.fragment,Ao),Ao.forEach(t),No.forEach(t),Ws=c(o),Pt=a(o,"H2",{class:!0});var _d=r(Pt);ao=a(_d,"A",{id:!0,class:!0,href:!0});var su=r(ao);ur=a(su,"SPAN",{});var du=r(ur);v(hn.$$.fragment,du),du.forEach(t),su.forEach(t),_l=c(_d),mr=a(_d,"SPAN",{});var iu=r(mr);gl=d(iu,"BlenderbotForConditionalGeneration"),iu.forEach(t),_d.forEach(t),Us=c(o),at=a(o,"P",{});var ca=r(at);bl=d(ca,"See "),wa=a(ca,"A",{href:!0});var lu=r(wa);kl=d(lu,"BartForConditionalGeneration"),lu.forEach(t),yl=d(ca," for arguments to "),fr=a(ca,"EM",{});var cu=r(fr);vl=d(cu,"forward"),cu.forEach(t),Tl=d(ca," and "),_r=a(ca,"EM",{});var pu=r(_r);wl=d(pu,"generate"),pu.forEach(t),ca.forEach(t),Rs=c(o),Ie=a(o,"DIV",{class:!0});var Io=r(Ie);v(un.$$.fragment,Io),$l=c(Io),mn=a(Io,"P",{});var gd=r(mn);Bl=d(gd,`The Blenderbot Model with a language modeling head. Can be used for summarization.
This model inherits from `),$a=a(gd,"A",{href:!0});var hu=r($a);xl=d(hu,"PreTrainedModel"),hu.forEach(t),zl=d(gd,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),gd.forEach(t),Fl=c(Io),fn=a(Io,"P",{});var bd=r(fn);ql=d(bd,"This model is also a PyTorch "),_n=a(bd,"A",{href:!0,rel:!0});var uu=r(_n);El=d(uu,"torch.nn.Module"),uu.forEach(t),Ml=d(bd,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),bd.forEach(t),Cl=c(Io),Re=a(Io,"DIV",{class:!0});var Lo=r(Re);v(gn.$$.fragment,Lo),jl=c(Lo),Nt=a(Lo,"P",{});var Ia=r(Nt);Ol=d(Ia,"The "),Ba=a(Ia,"A",{href:!0});var mu=r(Ba);Pl=d(mu,"BlenderbotForConditionalGeneration"),mu.forEach(t),Nl=d(Ia," forward method, overrides the "),gr=a(Ia,"CODE",{});var fu=r(gr);Al=d(fu,"__call__"),fu.forEach(t),Il=d(Ia," special method."),Ia.forEach(t),Ll=c(Lo),v(ro.$$.fragment,Lo),Sl=c(Lo),v(so.$$.fragment,Lo),Lo.forEach(t),Io.forEach(t),Hs=c(o),At=a(o,"H2",{class:!0});var kd=r(At);io=a(kd,"A",{id:!0,class:!0,href:!0});var _u=r(io);br=a(_u,"SPAN",{});var gu=r(br);v(bn.$$.fragment,gu),gu.forEach(t),_u.forEach(t),Dl=c(kd),kr=a(kd,"SPAN",{});var bu=r(kr);Gl=d(bu,"BlenderbotForCausalLM"),bu.forEach(t),kd.forEach(t),Ks=c(o),It=a(o,"DIV",{class:!0});var yd=r(It);v(kn.$$.fragment,yd),Wl=c(yd),lo=a(yd,"DIV",{class:!0});var vd=r(lo);v(yn.$$.fragment,vd),Ul=c(vd),v(co.$$.fragment,vd),vd.forEach(t),yd.forEach(t),Vs=c(o),Lt=a(o,"H2",{class:!0});var Td=r(Lt);po=a(Td,"A",{id:!0,class:!0,href:!0});var ku=r(po);yr=a(ku,"SPAN",{});var yu=r(yr);v(vn.$$.fragment,yu),yu.forEach(t),ku.forEach(t),Rl=c(Td),vr=a(Td,"SPAN",{});var vu=r(vr);Hl=d(vu,"TFBlenderbotModel"),vu.forEach(t),Td.forEach(t),Js=c(o),ye=a(o,"DIV",{class:!0});var ut=r(ye);v(Tn.$$.fragment,ut),Kl=c(ut),wn=a(ut,"P",{});var wd=r(wn);Vl=d(wd,`The bare BLENDERBOT Model outputting raw hidden-states without any specific head on top.
This model inherits from `),xa=a(wd,"A",{href:!0});var Tu=r(xa);Jl=d(Tu,"TFPreTrainedModel"),Tu.forEach(t),Ql=d(wd,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),wd.forEach(t),Xl=c(ut),$n=a(ut,"P",{});var $d=r($n);Yl=d($d,"This model is also a "),Bn=a($d,"A",{href:!0,rel:!0});var wu=r(Bn);Zl=d(wu,"tf.keras.Model"),wu.forEach(t),ec=d($d,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),$d.forEach(t),tc=c(ut),v(ho.$$.fragment,ut),oc=c(ut),He=a(ut,"DIV",{class:!0});var So=r(He);v(xn.$$.fragment,So),nc=c(So),St=a(So,"P",{});var La=r(St);ac=d(La,"The "),za=a(La,"A",{href:!0});var $u=r(za);rc=d($u,"TFBlenderbotModel"),$u.forEach(t),sc=d(La," forward method, overrides the "),Tr=a(La,"CODE",{});var Bu=r(Tr);dc=d(Bu,"__call__"),Bu.forEach(t),ic=d(La," special method."),La.forEach(t),lc=c(So),v(uo.$$.fragment,So),cc=c(So),v(mo.$$.fragment,So),So.forEach(t),ut.forEach(t),Qs=c(o),Dt=a(o,"H2",{class:!0});var Bd=r(Dt);fo=a(Bd,"A",{id:!0,class:!0,href:!0});var xu=r(fo);wr=a(xu,"SPAN",{});var zu=r(wr);v(zn.$$.fragment,zu),zu.forEach(t),xu.forEach(t),pc=c(Bd),$r=a(Bd,"SPAN",{});var Fu=r($r);hc=d(Fu,"TFBlenderbotForConditionalGeneration"),Fu.forEach(t),Bd.forEach(t),Xs=c(o),ve=a(o,"DIV",{class:!0});var mt=r(ve);v(Fn.$$.fragment,mt),uc=c(mt),qn=a(mt,"P",{});var xd=r(qn);mc=d(xd,`The BLENDERBOT Model with a language modeling head. Can be used for summarization.
This model inherits from `),Fa=a(xd,"A",{href:!0});var qu=r(Fa);fc=d(qu,"TFPreTrainedModel"),qu.forEach(t),_c=d(xd,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),xd.forEach(t),gc=c(mt),En=a(mt,"P",{});var zd=r(En);bc=d(zd,"This model is also a "),Mn=a(zd,"A",{href:!0,rel:!0});var Eu=r(Mn);kc=d(Eu,"tf.keras.Model"),Eu.forEach(t),yc=d(zd,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),zd.forEach(t),vc=c(mt),v(_o.$$.fragment,mt),Tc=c(mt),oe=a(mt,"DIV",{class:!0});var Ve=r(oe);v(Cn.$$.fragment,Ve),wc=c(Ve),Gt=a(Ve,"P",{});var Sa=r(Gt);$c=d(Sa,"The "),qa=a(Sa,"A",{href:!0});var Mu=r(qa);Bc=d(Mu,"TFBlenderbotForConditionalGeneration"),Mu.forEach(t),xc=d(Sa," forward method, overrides the "),Br=a(Sa,"CODE",{});var Cu=r(Br);zc=d(Cu,"__call__"),Cu.forEach(t),Fc=d(Sa," special method."),Sa.forEach(t),qc=c(Ve),v(go.$$.fragment,Ve),Ec=c(Ve),xr=a(Ve,"P",{});var ju=r(xr);Mc=d(ju,"Conversation example::"),ju.forEach(t),Cc=c(Ve),zr=a(Ve,"BLOCKQUOTE",{});var Ou=r(zr);Fr=a(Ou,"BLOCKQUOTE",{});var Pu=r(Fr);qr=a(Pu,"BLOCKQUOTE",{});var Nu=r(qr);Er=a(Nu,"P",{});var Au=r(Er);jc=d(Au,`from transformers import BlenderbotTokenizer, TFBlenderbotForConditionalGeneration >>> mname =
\u2018facebook/blenderbot-400M-distill\u2019 >>> model = TFBlenderbotForConditionalGeneration.from_pretrained(mname) >>>
tokenizer = BlenderbotTokenizer.from_pretrained(mname) >>> UTTERANCE = \u201CMy friends are cool but they eat too
many carbs.\u201D >>> print(\u201CHuman: \u201D, UTTERANCE) >>> inputs = tokenizer([UTTERANCE], return_tensors=\u2018tf\u2019) >>>
reply_ids = model.generate(**inputs) >>> print(\u201CBot: \u201D, tokenizer.batch_decode(reply_ids,
skip_special_tokens=True)[0])`),Au.forEach(t),Nu.forEach(t),Pu.forEach(t),Ou.forEach(t),Oc=c(Ve),Mr=a(Ve,"BLOCKQUOTE",{});var Iu=r(Mr);Cr=a(Iu,"BLOCKQUOTE",{});var Lu=r(Cr);jr=a(Lu,"BLOCKQUOTE",{});var Su=r(jr);jn=a(Su,"P",{});var Fd=r(jn);Pc=d(Fd,`REPLY = \u201CI\u2019m not sure\u201D >>> print(\u201CHuman: \u201D, REPLY) >>> NEXT_UTTERANCE = ( \u2026 \u201CMy friends are cool but they
eat too many carbs.</s> `),Or=a(Fd,"S",{});var Du=r(Or);Nc=d(Du,`That\u2019s unfortunate. \u201D \u2026 \u201CAre they trying to lose weight or are they just trying to
be healthier?`),Du.forEach(t),Ac=d(Fd,` \u201D \u2026 \u201D<s> I\u2019m not sure.\u201D \u2026 ) >>> inputs = tokenizer([NEXT_UTTERANCE], return_tensors=\u2018tf\u2019)
next_reply_ids = model.generate(**inputs) >>> print(\u201CBot: \u201D, tokenizer.batch_decode(next_reply_ids,
skip_special_tokens=True)[0])`),Fd.forEach(t),Su.forEach(t),Lu.forEach(t),Iu.forEach(t),Ve.forEach(t),mt.forEach(t),Ys=c(o),Wt=a(o,"H2",{class:!0});var qd=r(Wt);bo=a(qd,"A",{id:!0,class:!0,href:!0});var Gu=r(bo);Pr=a(Gu,"SPAN",{});var Wu=r(Pr);v(On.$$.fragment,Wu),Wu.forEach(t),Gu.forEach(t),Ic=c(qd),Nr=a(qd,"SPAN",{});var Uu=r(Nr);Lc=d(Uu,"FlaxBlenderbotModel"),Uu.forEach(t),qd.forEach(t),Zs=c(o),S=a(o,"DIV",{class:!0});var ne=r(S);v(Pn.$$.fragment,ne),Sc=c(ne),Nn=a(ne,"P",{});var Ed=r(Nn);Dc=d(Ed,`The bare MBart Model transformer outputting raw hidden-states without any specific head on top.
...
`),In=a(Md,"A",{href:!0,rel:!0});var Hu=r(In);Hc=d(Hu,"flax.nn.Module"),Hu.forEach(t),Kc=d(Md,` subclass. Use it as a
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),Md.forEach(t),Vc=c(ne),Ar=a(ne,"P",{});var Ku=r(Ar);Jc=d(Ku,"Finally, this model supports inherent JAX features such as:"),Ku.forEach(t),Qc=c(ne),rt=a(ne,"UL",{});var Do=r(rt);Ir=a(Do,"LI",{});var Vu=r(Ir);Ln=a(Vu,"A",{href:!0,rel:!0});var Ju=r(Ln);Xc=d(Ju,"Just-In-Time (JIT) compilation"),Ju.forEach(t),Vu.forEach(t),Yc=c(Do),Lr=a(Do,"LI",{});var Qu=r(Lr);Sn=a(Qu,"A",{href:!0,rel:!0});var Xu=r(Sn);Zc=d(Xu,"Automatic Differentiation"),Xu.forEach(t),Qu.forEach(t),ep=c(Do),Sr=a(Do,"LI",{});var Yu=r(Sr);Dn=a(Yu,"A",{href:!0,rel:!0});var Zu=r(Dn);tp=d(Zu,"Vectorization"),Zu.forEach(t),Yu.forEach(t),op=c(Do),Dr=a(Do,"LI",{});var em=r(Dr);Gn=a(em,"A",{href:!0,rel:!0});var tm=r(Gn);np=d(tm,"Parallelization"),tm.forEach(t),em.forEach(t),Do.forEach(t),ap=c(ne),Ke=a(ne,"DIV",{class:!0});var Go=r(Ke);v(Wn.$$.fragment,Go),rp=c(Go),Ut=a(Go,"P",{});var Da=r(Ut);sp=d(Da,"The "),Gr=a(Da,"CODE",{});var om=r(Gr);dp=d(om,"FlaxBlenderbotPreTrainedModel"),om.forEach(t),ip=d(Da," forward method, overrides the "),Wr=a(Da,"CODE",{});var nm=r(Wr);lp=d(nm,"__call__"),nm.forEach(t),cp=d(Da," special method."),Da.forEach(t),pp=c(Go),v(ko.$$.fragment,Go),hp=c(Go),v(yo.$$.fragment,Go),Go.forEach(t),up=c(ne),vo=a(ne,"DIV",{class:!0});var Cd=r(vo);v(Un.$$.fragment,Cd),mp=c(Cd),v(To.$$.fragment,Cd),Cd.forEach(t),fp=c(ne),wo=a(ne,"DIV",{class:!0});var jd=r(wo);v(Rn.$$.fragment,jd),_p=c(jd),v($o.$$.fragment,jd),jd.forEach(t),ne.forEach(t),ed=c(o),Rt=a(o,"H2",{class:!0});var Od=r(Rt);Bo=a(Od,"A",{id:!0,class:!0,href:!0});var am=r(Bo);Ur=a(am,"SPAN",{});var rm=r(Ur);v(Hn.$$.fragment,rm),rm.forEach(t),am.forEach(t),gp=c(Od),Rr=a(Od,"SPAN",{});var sm=r(Rr);bp=d(sm,"FlaxBlenderbotForConditionalGeneration"),sm.forEach(t),Od.forEach(t),td=c(o),D=a(o,"DIV",{class:!0});var ae=r(D);v(Kn.$$.fragment,ae),kp=c(ae),Vn=a(ae,"P",{});var Pd=r(Vn);yp=d(Pd,`The Blenderbot Model with a language modeling head. Can be used for summarization.
...
`),Qn=a(Nd,"A",{href:!0,rel:!0});var im=r(Qn);Bp=d(im,"flax.nn.Module"),im.forEach(t),xp=d(Nd,` subclass. Use it as a
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),Nd.forEach(t),zp=c(ae),Hr=a(ae,"P",{});var lm=r(Hr);Fp=d(lm,"Finally, this model supports inherent JAX features such as:"),lm.forEach(t),qp=c(ae),st=a(ae,"UL",{});var Wo=r(st);Kr=a(Wo,"LI",{});var cm=r(Kr);Xn=a(cm,"A",{href:!0,rel:!0});var pm=r(Xn);Ep=d(pm,"Just-In-Time (JIT) compilation"),pm.forEach(t),cm.forEach(t),Mp=c(Wo),Vr=a(Wo,"LI",{});var hm=r(Vr);Yn=a(hm,"A",{href:!0,rel:!0});var um=r(Yn);Cp=d(um,"Automatic Differentiation"),um.forEach(t),hm.forEach(t),jp=c(Wo),Jr=a(Wo,"LI",{});var mm=r(Jr);Zn=a(mm,"A",{href:!0,rel:!0});var fm=r(Zn);Op=d(fm,"Vectorization"),fm.forEach(t),mm.forEach(t),Pp=c(Wo),Qr=a(Wo,"LI",{});var _m=r(Qr);ea=a(_m,"A",{href:!0,rel:!0});var gm=r(ea);Np=d(gm,"Parallelization"),gm.forEach(t),_m.forEach(t),Wo.forEach(t),Ap=c(ae),W=a(ae,"DIV",{class:!0});var re=r(W);v(ta.$$.fragment,re),Ip=c(re),Ht=a(re,"P",{});var Ga=r(Ht);Lp=d(Ga,"The "),Xr=a(Ga,"CODE",{});var bm=r(Xr);Sp=d(bm,"FlaxBlenderbotPreTrainedModel"),bm.forEach(t),Dp=d(Ga," forward method, overrides the "),Yr=a(Ga,"CODE",{});var km=r(Yr);Gp=d(km,"__call__"),km.forEach(t),Wp=d(Ga," special method."),Ga.forEach(t),Up=c(re),v(xo.$$.fragment,re),Rp=c(re),Zr=a(re,"P",{});var ym=r(Zr);Hp=d(ym,"Conversation example::"),ym.forEach(t),Kp=c(re),es=a(re,"BLOCKQUOTE",{});var vm=r(es);ts=a(vm,"BLOCKQUOTE",{});var Tm=r(ts);os=a(Tm,"BLOCKQUOTE",{});var wm=r(os);ns=a(wm,"P",{});var $m=r(ns);Vp=d($m,"from transformers import BlenderbotTokenizer, FlaxBlenderbotForConditionalGeneration, BlenderbotConfig"),$m.forEach(t),wm.forEach(t),Tm.forEach(t),vm.forEach(t),Jp=c(re),as=a(re,"BLOCKQUOTE",{});var Bm=r(as);rs=a(Bm,"BLOCKQUOTE",{});var xm=r(rs);ss=a(xm,"BLOCKQUOTE",{});var zm=r(ss);ds=a(zm,"P",{});var Fm=r(ds);Qp=d(Fm,`model = FlaxBlenderbotForConditionalGeneration.from_pretrained(\u2018facebook/blenderbot-400M-distill\u2019) >>>
tokenizer = BlenderbotTokenizer.from_pretrained(\u2018facebook/blenderbot-400M-distill\u2019)`),Fm.forEach(t),zm.forEach(t),xm.forEach(t),Bm.forEach(t),Xp=c(re),is=a(re,"BLOCKQUOTE",{});var qm=r(is);ls=a(qm,"BLOCKQUOTE",{});var Em=r(ls);cs=a(Em,"BLOCKQUOTE",{});var Mm=r(cs);ps=a(Mm,"P",{});var Cm=r(ps);Yp=d(Cm,`UTTERANCE = \u201CMy friends are cool but they eat too many carbs.\u201D >>> inputs = tokenizer([UTTERANCE],
max_length=1024, return_tensors=\u2018np\u2019)`),Cm.forEach(t),Mm.forEach(t),Em.forEach(t),qm.forEach(t),Zp=c(re),hs=a(re,"BLOCKQUOTE",{});var jm=r(hs);us=a(jm,"BLOCKQUOTE",{});var Om=r(us);oa=a(Om,"BLOCKQUOTE",{});var Ad=r(oa);zo=a(Ad,"H1",{class:!0});var Id=r(zo);Fo=a(Id,"A",{id:!0,class:!0,href:!0});var Pm=r(Fo);ms=a(Pm,"SPAN",{});var Nm=r(ms);v(na.$$.fragment,Nm),Nm.forEach(t),Pm.forEach(t),eh=c(Id),fs=a(Id,"SPAN",{});var Am=r(fs);th=d(Am,"Generate Reply >>> reply_ids = model.generate(inputs[\u2018input_ids\u2019], num_beams=4, max_length=5,"),Am.forEach(t),Id.forEach(t),oh=c(Ad),_s=a(Ad,"P",{});var Im=r(_s);nh=d(Im,`early_stopping=True).sequences >>> print([tokenizer.decode(g, skip_special_tokens=True,
clean_up_tokenization_spaces=False) for g in reply_ids])`),Im.forEach(t),Ad.forEach(t),Om.forEach(t),jm.forEach(t),re.forEach(t),ah=c(ae),qo=a(ae,"DIV",{class:!0});var Ld=r(qo);v(aa.$$.fragment,Ld),rh=c(Ld),v(Eo.$$.fragment,Ld),Ld.forEach(t),sh=c(ae),Mo=a(ae,"DIV",{class:!0});var Sd=r(Mo);v(ra.$$.fragment,Sd),dh=c(Sd),v(Co.$$.fragment,Sd),Sd.forEach(t),ae.forEach(t),this.h()},h(){h(p,"name","hf:doc:metadata"),h(p,"content",JSON.stringify(cf)),h(m,"id","blenderbot"),h(m,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),h(m,"href","#blenderbot"),h(g,"class","relative group"),h(se,"href","https://github.com/huggingface/transformers/issues/new?assignees=&labels=&template=bug-report.md&title"),h(se,"rel","nofollow"),h(Y,"id","overview"),h(Y,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),h(Y,"href","#overview"),h(I,"class","relative group"),h(ce,"href","https://arxiv.org/pdf/2004.13637.pdf"),h(ce,"rel","nofollow"),h(he,"href","https://huggingface.co/sshleifer"),h(he,"rel","nofollow"),h(me,"href","https://github.com/facebookresearch/ParlAI"),h(me,"rel","nofollow"),h(te,"id","implementation-notes"),h(te,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),h(te,"href","#implementation-notes"),h(O,"class","relative group"),h(q,"href","https://arxiv.org/pdf/1706.03762.pdf"),h(q,"rel","nofollow"),h(Oe,"href","https://huggingface.co/models?search=blenderbot"),h(Oe,"rel","nofollow"),h($e,"href","blenderbot-small"),h(Vt,"id","usage"),h(Vt,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),h(Vt,"href","#usage"),h(zt,"class","relative group"),h(Jt,"id","transformers.BlenderbotConfig"),h(Jt,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),h(Jt,"href","#transformers.BlenderbotConfig"),h(Ft,"class","relative group"),h(ha,"href","/docs/transformers/main/en/model_doc/blenderbot#transformers.BlenderbotModel"),h(Jo,"href","https://huggingface.co/facebook/blenderbot-3B"),h(Jo,"rel","nofollow"),h(ua,"href","/docs/transformers/main/en/main_classes/configuration#transformers.PretrainedConfig"),h(ma,"href","/docs/transformers/main/en/main_classes/configuration#transformers.PretrainedConfig"),h(Ne,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),h(Xt,"id","transformers.BlenderbotTokenizer"),h(Xt,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),h(Xt,"href","#transformers.BlenderbotTokenizer"),h(Mt,"class","relative group"),h(fa,"href","/docs/transformers/main/en/model_doc/roberta#transformers.RobertaTokenizer"),h(_a,"href","/docs/transformers/main/en/model_doc/roberta#transformers.RobertaTokenizer"),h(lt,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),h(be,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),h(Zt,"id","transformers.BlenderbotTokenizerFast"),h(Zt,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),h(Zt,"href","#transformers.BlenderbotTokenizerFast"),h(Ct,"class","relative group"),h(ba,"href","/docs/transformers/main/en/model_doc/roberta#transformers.RobertaTokenizerFast"),h(ka,"href","/docs/transformers/main/en/model_doc/roberta#transformers.RobertaTokenizerFast"),h(ct,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),h(ke,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),h(to,"id","transformers.BlenderbotModel"),h(to,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),h(to,"href","#transformers.BlenderbotModel"),h(jt,"class","relative group"),h(va,"href","/docs/transformers/main/en/main_classes/model#transformers.PreTrainedModel"),h(cn,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),h(cn,"rel","nofollow"),h(Ta,"href","/docs/transformers/main/en/model_doc/blenderbot#transformers.BlenderbotModel"),h(Ue,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),h(Ae,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),h(ao,"id","transformers.BlenderbotForConditionalGeneration"),h(ao,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),h(ao,"href","#transformers.BlenderbotForConditionalGeneration"),h(Pt,"class","relative group"),h(wa,"href","/docs/transformers/main/en/model_doc/bart#transformers.BartForConditionalGeneration"),h($a,"href","/docs/transformers/main/en/main_classes/model#transformers.PreTrainedModel"),h(_n,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),h(_n,"rel","nofollow"),h(Ba,"href","/docs/transformers/main/en/model_doc/blenderbot#transformers.BlenderbotForConditionalGeneration"),h(Re,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),h(Ie,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),h(io,"id","transformers.BlenderbotForCausalLM"),h(io,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),h(io,"href","#transformers.BlenderbotForCausalLM"),h(At,"class","relative group"),h(lo,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),h(It,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),h(po,"id","transformers.TFBlenderbotModel"),h(po,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),h(po,"href","#transformers.TFBlenderbotModel"),h(Lt,"class","relative group"),h(xa,"href","/docs/transformers/main/en/main_classes/model#transformers.TFPreTrainedModel"),h(Bn,"href","https://www.tensorflow.org/api_docs/python/tf/keras/Model"),h(Bn,"rel","nofollow"),h(za,"href","/docs/transformers/main/en/model_doc/blenderbot#transformers.TFBlenderbotModel"),h(He,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),h(ye,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),h(fo,"id","transformers.TFBlenderbotForConditionalGeneration"),h(fo,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),h(fo,"href","#transformers.TFBlenderbotForConditionalGeneration"),h(Dt,"class","relative group"),h(Fa,"href","/docs/transformers/main/en/main_classes/model#transformers.TFPreTrainedModel"),h(Mn,"href","https://www.tensorflow.org/api_docs/python/tf/keras/Model"),h(Mn,"rel","nofollow"),h(qa,"href","/docs/transformers/main/en/model_doc/blenderbot#transformers.TFBlenderbotForConditionalGeneration"),h(oe,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),h(ve,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),h(bo,"id","transformers.FlaxBlenderbotModel"),h(bo,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),h(bo,"href","#transformers.FlaxBlenderbotModel"),h(Wt,"class","relative group"),h(Ea,"href","/docs/transformers/main/en/main_classes/model#transformers.FlaxPreTrainedModel"),h(In,"href","https://flax.readthedocs.io/en/latest/_autosummary/flax.nn.module.html"),h(In,"rel","nofollow"),h(Ln,"href","https://jax.readthedocs.io/en/latest/jax.html#just-in-time-compilation-jit"),h(Ln,"rel","nofollow"),h(Sn,"href","https://jax.readthedocs.io/en/latest/jax.html#automatic-differentiation"),h(Sn,"rel","nofollow"),h(Dn,"href","https://jax.readthedocs.io/en/latest/jax.html#vectorization-vmap"),h(Dn,"rel","nofollow"),h(Gn,"href","https://jax.readthedocs.io/en/latest/jax.html#parallelization-pmap"),h(Gn,"rel","nofollow"),h(Ke,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),h(vo,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),h(wo,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),h(S,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),h(Bo,"id","transformers.FlaxBlenderbotForConditionalGeneration"),h(Bo,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),h(Bo,"href","#transformers.FlaxBlenderbotForConditionalGeneration"),h(Rt,"class","relative group"),h(Ma,"href","/docs/transformers/main/en/main_classes/model#transformers.FlaxPreTrainedModel"),h(Qn,"href","https://flax.readthedocs.io/en/latest/_autosummary/flax.nn.module.html"),h(Qn,"rel","nofollow"),h(Xn,"href","https://jax.readthedocs.io/en/latest/jax.html#just-in-time-compilation-jit"),h(Xn,"rel","nofollow"),h(Yn,"href","https://jax.readthedocs.io/en/latest/jax.html#automatic-differentiation"),h(Yn,"rel","nofollow"),h(Zn,"href","https://jax.readthedocs.io/en/latest/jax.html#vectorization-vmap"),h(Zn,"rel","nofollow"),h(ea,"href","https://jax.readthedocs.io/en/latest/jax.html#parallelization-pmap"),h(ea,"rel","nofollow"),h(Fo,"id","generate-reply->>>-reply_ids-=-model.generate(inputs[\u2018input_ids\u2019],-num_beams=4,-max_length=5,"),h(Fo,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),h(Fo,"href","#generate-reply->>>-reply_ids-=-model.generate(inputs[\u2018input_ids\u2019],-num_beams=4,-max_length=5,"),h(zo,"class","relative group"),h(W,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),h(qo,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),h(Mo,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),h(D,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8")},m(o,_){e(document.head,p),f(o,k,_),f(o,g,_),e(g,m),e(m,b),T(i,b,null),e(g,u),e(g,E),e(E,Je),f(o,Le,_),f(o,A,_),e(A,Be),e(Be,xe),e(A,F),e(A,se),e(se,de),e(A,Qe),f(o,Se,_),f(o,I,_),e(I,Y),e(Y,ze),T(U,ze,null),e(I,Xe),e(I,Fe),e(Fe,ie),f(o,De,_),f(o,Z,_),e(Z,le),e(Z,ce),e(ce,Ye),e(Z,qe),f(o,C,_),f(o,j,_),e(j,Ze),f(o,ee,_),f(o,we,_),e(we,Ee),e(Ee,pe),f(o,Ge,_),f(o,R,_),e(R,L),e(R,he),e(he,ue),e(R,et),e(R,me),e(me,fe),e(R,tt),f(o,We,_),f(o,O,_),e(O,te),e(te,K),T(_e,K,null),e(O,Me),e(O,P),e(P,ot),f(o,G,_),f(o,H,_),e(H,ge),e(ge,x),e(ge,q),e(q,gt),e(ge,Ce),e(H,bt),e(H,je),e(je,M),e(je,Oe),e(Oe,kt),e(je,yt),e(H,vt),e(H,V),e(V,J),e(V,Q),e(Q,Tt),e(V,wt),e(V,X),e(X,$t),e(V,Bt),e(V,$e),e($e,xt),e(V,Pe),f(o,it,_),f(o,zt,_),e(zt,Vt),e(Vt,Wa),T(Ro,Wa,null),e(zt,Dd),e(zt,Ua),e(Ua,Gd),f(o,Cs,_),f(o,pa,_),e(pa,Wd),f(o,js,_),T(Ho,o,_),f(o,Os,_),f(o,Ft,_),e(Ft,Jt),e(Jt,Ra),T(Ko,Ra,null),e(Ft,Ud),e(Ft,Ha),e(Ha,Rd),f(o,Ps,_),f(o,Ne,_),T(Vo,Ne,null),e(Ne,Hd),e(Ne,qt),e(qt,Kd),e(qt,ha),e(ha,Vd),e(qt,Jd),e(qt,Jo),e(Jo,Qd),e(qt,Xd),e(Ne,Yd),e(Ne,Et),e(Et,Zd),e(Et,ua),e(ua,ei),e(Et,ti),e(Et,ma),e(ma,oi),e(Et,ni),e(Ne,ai),T(Qt,Ne,null),f(o,Ns,_),f(o,Mt,_),e(Mt,Xt),e(Xt,Ka),T(Qo,Ka,null),e(Mt,ri),e(Mt,Va),e(Va,si),f(o,As,_),f(o,be,_),T(Xo,be,null),e(be,di),e(be,Ja),e(Ja,ii),e(be,li),e(be,Yt),e(Yt,Qa),e(Qa,ci),e(Yt,pi),e(Yt,fa),e(fa,hi),e(Yt,ui),e(be,mi),e(be,Yo),e(Yo,fi),e(Yo,_a),e(_a,_i),e(Yo,gi),e(be,bi),e(be,lt),T(Zo,lt,null),e(lt,ki),e(lt,Xa),e(Xa,yi),e(lt,vi),e(lt,Ya),e(Ya,ga),e(ga,Ti),e(ga,Za),e(Za,wi),f(o,Is,_),f(o,Ct,_),e(Ct,Zt),e(Zt,er),T(en,er,null),e(Ct,$i),e(Ct,tr),e(tr,Bi),f(o,Ls,_),f(o,ke,_),T(tn,ke,null),e(ke,xi),e(ke,on),e(on,zi),e(on,or),e(or,Fi),e(on,qi),e(ke,Ei),e(ke,eo),e(eo,nr),e(nr,Mi),e(eo,Ci),e(eo,ba),e(ba,ji),e(eo,Oi),e(ke,Pi),e(ke,nn),e(nn,Ni),e(nn,ka),e(ka,Ai),e(nn,Ii),e(ke,Li),e(ke,ct),T(an,ct,null),e(ct,Si),e(ct,ar),e(ar,Di),e(ct,Gi),e(ct,rr),e(rr,ya),e(ya,Wi),e(ya,sr),e(sr,Ui),f(o,Ss,_),f(o,jt,_),e(jt,to),e(to,dr),T(rn,dr,null),e(jt,Ri),e(jt,ir),e(ir,Hi),f(o,Ds,_),f(o,nt,_),e(nt,Ki),e(nt,lr),e(lr,Vi),e(nt,Ji),e(nt,cr),e(cr,Qi),e(nt,Xi),e(nt,pr),e(pr,Yi),f(o,Gs,_),f(o,Ae,_),T(sn,Ae,null),e(Ae,Zi),e(Ae,dn),e(dn,el),e(dn,va),e(va,tl),e(dn,ol),e(Ae,nl),e(Ae,ln),e(ln,al),e(ln,cn),e(cn,rl),e(ln,sl),e(Ae,dl),e(Ae,Ue),T(pn,Ue,null),e(Ue,il),e(Ue,Ot),e(Ot,ll),e(Ot,Ta),e(Ta,cl),e(Ot,pl),e(Ot,hr),e(hr,hl),e(Ot,ul),e(Ue,ml),T(oo,Ue,null),e(Ue,fl),T(no,Ue,null),f(o,Ws,_),f(o,Pt,_),e(Pt,ao),e(ao,ur),T(hn,ur,null),e(Pt,_l),e(Pt,mr),e(mr,gl),f(o,Us,_),f(o,at,_),e(at,bl),e(at,wa),e(wa,kl),e(at,yl),e(at,fr),e(fr,vl),e(at,Tl),e(at,_r),e(_r,wl),f(o,Rs,_),f(o,Ie,_),T(un,Ie,null),e(Ie,$l),e(Ie,mn),e(mn,Bl),e(mn,$a),e($a,xl),e(mn,zl),e(Ie,Fl),e(Ie,fn),e(fn,ql),e(fn,_n),e(_n,El),e(fn,Ml),e(Ie,Cl),e(Ie,Re),T(gn,Re,null),e(Re,jl),e(Re,Nt),e(Nt,Ol),e(Nt,Ba),e(Ba,Pl),e(Nt,Nl),e(Nt,gr),e(gr,Al),e(Nt,Il),e(Re,Ll),T(ro,Re,null),e(Re,Sl),T(so,Re,null),f(o,Hs,_),f(o,At,_),e(At,io),e(io,br),T(bn,br,null),e(At,Dl),e(At,kr),e(kr,Gl),f(o,Ks,_),f(o,It,_),T(kn,It,null),e(It,Wl),e(It,lo),T(yn,lo,null),e(lo,Ul),T(co,lo,null),f(o,Vs,_),f(o,Lt,_),e(Lt,po),e(po,yr),T(vn,yr,null),e(Lt,Rl),e(Lt,vr),e(vr,Hl),f(o,Js,_),f(o,ye,_),T(Tn,ye,null),e(ye,Kl),e(ye,wn),e(wn,Vl),e(wn,xa),e(xa,Jl),e(wn,Ql),e(ye,Xl),e(ye,$n),e($n,Yl),e($n,Bn),e(Bn,Zl),e($n,ec),e(ye,tc),T(ho,ye,null),e(ye,oc),e(ye,He),T(xn,He,null),e(He,nc),e(He,St),e(St,ac),e(St,za),e(za,rc),e(St,sc),e(St,Tr),e(Tr,dc),e(St,ic),e(He,lc),T(uo,He,null),e(He,cc),T(mo,He,null),f(o,Qs,_),f(o,Dt,_),e(Dt,fo),e(fo,wr),T(zn,wr,null),e(Dt,pc),e(Dt,$r),e($r,hc),f(o,Xs,_),f(o,ve,_),T(Fn,ve,null),e(ve,uc),e(ve,qn),e(qn,mc),e(qn,Fa),e(Fa,fc),e(qn,_c),e(ve,gc),e(ve,En),e(En,bc),e(En,Mn),e(Mn,kc),e(En,yc),e(ve,vc),T(_o,ve,null),e(ve,Tc),e(ve,oe),T(Cn,oe,null),e(oe,wc),e(oe,Gt),e(Gt,$c),e(Gt,qa),e(qa,Bc),e(Gt,xc),e(Gt,Br),e(Br,zc),e(Gt,Fc),e(oe,qc),T(go,oe,null),e(oe,Ec),e(oe,xr),e(xr,Mc),e(oe,Cc),e(oe,zr),e(zr,Fr),e(Fr,qr),e(qr,Er),e(Er,jc),e(oe,Oc),e(oe,Mr),e(Mr,Cr),e(Cr,jr),e(jr,jn),e(jn,Pc),e(jn,Or),e(Or,Nc),e(jn,Ac),f(o,Ys,_),f(o,Wt,_),e(Wt,bo),e(bo,Pr),T(On,Pr,null),e(Wt,Ic),e(Wt,Nr),e(Nr,Lc),f(o,Zs,_),f(o,S,_),T(Pn,S,null),e(S,Sc),e(S,Nn),e(Nn,Dc),e(Nn,Ea),e(Ea,Gc),e(Nn,Wc),e(S,Uc),e(S,An),e(An,Rc),e(An,In),e(In,Hc),e(An,Kc),e(S,Vc),e(S,Ar),e(Ar,Jc),e(S,Qc),e(S,rt),e(rt,Ir),e(Ir,Ln),e(Ln,Xc),e(rt,Yc),e(rt,Lr),e(Lr,Sn),e(Sn,Zc),e(rt,ep),e(rt,Sr),e(Sr,Dn),e(Dn,tp),e(rt,op),e(rt,Dr),e(Dr,Gn),e(Gn,np),e(S,ap),e(S,Ke),T(Wn,Ke,null),e(Ke,rp),e(Ke,Ut),e(Ut,sp),e(Ut,Gr),e(Gr,dp),e(Ut,ip),e(Ut,Wr),e(Wr,lp),e(Ut,cp),e(Ke,pp),T(ko,Ke,null),e(Ke,hp),T(yo,Ke,null),e(S,up),e(S,vo),T(Un,vo,null),e(vo,mp),T(To,vo,null),e(S,fp),e(S,wo),T(Rn,wo,null),e(wo,_p),T($o,wo,null),f(o,ed,_),f(o,Rt,_),e(Rt,Bo),e(Bo,Ur),T(Hn,Ur,null),e(Rt,gp),e(Rt,Rr),e(Rr,bp),f(o,td,_),f(o,D,_),T(Kn,D,null),e(D,kp),e(D,Vn),e(Vn,yp),e(Vn,Ma),e(Ma,vp),e(Vn,Tp),e(D,wp),e(D,Jn),e(Jn,$p),e(Jn,Qn),e(Qn,Bp),e(Jn,xp),e(D,zp),e(D,Hr),e(Hr,Fp),e(D,qp),e(D,st),e(st,Kr),e(Kr,Xn),e(Xn,Ep),e(st,Mp),e(st,Vr),e(Vr,Yn),e(Yn,Cp),e(st,jp),e(st,Jr),e(Jr,Zn),e(Zn,Op),e(st,Pp),e(st,Qr),e(Qr,ea),e(ea,Np),e(D,Ap),e(D,W),T(ta,W,null),e(W,Ip),e(W,Ht),e(Ht,Lp),e(Ht,Xr),e(Xr,Sp),e(Ht,Dp),e(Ht,Yr),e(Yr,Gp),e(Ht,Wp),e(W,Up),T(xo,W,null),e(W,Rp),e(W,Zr),e(Zr,Hp),e(W,Kp),e(W,es),e(es,ts),e(ts,os),e(os,ns),e(ns,Vp),e(W,Jp),e(W,as),e(as,rs),e(rs,ss),e(ss,ds),e(ds,Qp),e(W,Xp),e(W,is),e(is,ls),e(ls,cs),e(cs,ps),e(ps,Yp),e(W,Zp),e(W,hs),e(hs,us),e(us,oa),e(oa,zo),e(zo,Fo),e(Fo,ms),T(na,ms,null),e(zo,eh),e(zo,fs),e(fs,th),e(oa,oh),e(oa,_s),e(_s,nh),e(D,ah),e(D,qo),T(aa,qo,null),e(qo,rh),T(Eo,qo,null),e(D,sh),e(D,Mo),T(ra,Mo,null),e(Mo,dh),T(Co,Mo,null),od=!0},p(o,[_]){const sa={};_&2&&(sa.$$scope={dirty:_,ctx:o}),Qt.$set(sa);const gs={};_&2&&(gs.$$scope={dirty:_,ctx:o}),oo.$set(gs);const bs={};_&2&&(bs.$$scope={dirty:_,ctx:o}),no.$set(bs);const ks={};_&2&&(ks.$$scope={dirty:_,ctx:o}),ro.$set(ks);const jo={};_&2&&(jo.$$scope={dirty:_,ctx:o}),so.$set(jo);const ys={};_&2&&(ys.$$scope={dirty:_,ctx:o}),co.$set(ys);const vs={};_&2&&(vs.$$scope={dirty:_,ctx:o}),ho.$set(vs);const da={};_&2&&(da.$$scope={dirty:_,ctx:o}),uo.$set(da);const Ts={};_&2&&(Ts.$$scope={dirty:_,ctx:o}),mo.$set(Ts);const ws={};_&2&&(ws.$$scope={dirty:_,ctx:o}),_o.$set(ws);const $s={};_&2&&($s.$$scope={dirty:_,ctx:o}),go.$set($s);const ia={};_&2&&(ia.$$scope={dirty:_,ctx:o}),ko.$set(ia);const Bs={};_&2&&(Bs.$$scope={dirty:_,ctx:o}),yo.$set(Bs);const xs={};_&2&&(xs.$$scope={dirty:_,ctx:o}),To.$set(xs);const zs={};_&2&&(zs.$$scope={dirty:_,ctx:o}),$o.$set(zs);const Fs={};_&2&&(Fs.$$scope={dirty:_,ctx:o}),xo.$set(Fs);const Kt={};_&2&&(Kt.$$scope={dirty:_,ctx:o}),Eo.$set(Kt);const qs={};_&2&&(qs.$$scope={dirty:_,ctx:o}),Co.$set(qs)},i(o){od||(w(i.$$.fragment,o),w(U.$$.fragment,o),w(_e.$$.fragment,o),w(Ro.$$.fragment,o),w(Ho.$$.fragment,o),w(Ko.$$.fragment,o),w(Vo.$$.fragment,o),w(Qt.$$.fragment,o),w(Qo.$$.fragment,o),w(Xo.$$.fragment,o),w(Zo.$$.fragment,o),w(en.$$.fragment,o),w(tn.$$.fragment,o),w(an.$$.fragment,o),w(rn.$$.fragment,o),w(sn.$$.fragment,o),w(pn.$$.fragment,o),w(oo.$$.fragment,o),w(no.$$.fragment,o),w(hn.$$.fragment,o),w(un.$$.fragment,o),w(gn.$$.fragment,o),w(ro.$$.fragment,o),w(so.$$.fragment,o),w(bn.$$.fragment,o),w(kn.$$.fragment,o),w(yn.$$.fragment,o),w(co.$$.fragment,o),w(vn.$$.fragment,o),w(Tn.$$.fragment,o),w(ho.$$.fragment,o),w(xn.$$.fragment,o),w(uo.$$.fragment,o),w(mo.$$.fragment,o),w(zn.$$.fragment,o),w(Fn.$$.fragment,o),w(_o.$$.fragment,o),w(Cn.$$.fragment,o),w(go.$$.fragment,o),w(On.$$.fragment,o),w(Pn.$$.fragment,o),w(Wn.$$.fragment,o),w(ko.$$.fragment,o),w(yo.$$.fragment,o),w(Un.$$.fragment,o),w(To.$$.fragment,o),w(Rn.$$.fragment,o),w($o.$$.fragment,o),w(Hn.$$.fragment,o),w(Kn.$$.fragment,o),w(ta.$$.fragment,o),w(xo.$$.fragment,o),w(na.$$.fragment,o),w(aa.$$.fragment,o),w(Eo.$$.fragment,o),w(ra.$$.fragment,o),w(Co.$$.fragment,o),od=!0)},o(o){$(i.$$.fragment,o),$(U.$$.fragment,o),$(_e.$$.fragment,o),$(Ro.$$.fragment,o),$(Ho.$$.fragment,o),$(Ko.$$.fragment,o),$(Vo.$$.fragment,o),$(Qt.$$.fragment,o),$(Qo.$$.fragment,o),$(Xo.$$.fragment,o),$(Zo.$$.fragment,o),$(en.$$.fragment,o),$(tn.$$.fragment,o),$(an.$$.fragment,o),$(rn.$$.fragment,o),$(sn.$$.fragment,o),$(pn.$$.fragment,o),$(oo.$$.fragment,o),$(no.$$.fragment,o),$(hn.$$.fragment,o),$(un.$$.fragment,o),$(gn.$$.fragment,o),$(ro.$$.fragment,o),$(so.$$.fragment,o),$(bn.$$.fragment,o),$(kn.$$.fragment,o),$(yn.$$.fragment,o),$(co.$$.fragment,o),$(vn.$$.fragment,o),$(Tn.$$.fragment,o),$(ho.$$.fragment,o),$(xn.$$.fragment,o),$(uo.$$.fragment,o),$(mo.$$.fragment,o),$(zn.$$.fragment,o),$(Fn.$$.fragment,o),$(_o.$$.fragment,o),$(Cn.$$.fragment,o),$(go.$$.fragment,o),$(On.$$.fragment,o),$(Pn.$$.fragment,o),$(Wn.$$.fragment,o),$(ko.$$.fragment,o),$(yo.$$.fragment,o),$(Un.$$.fragment,o),$(To.$$.fragment,o),$(Rn.$$.fragment,o),$($o.$$.fragment,o),$(Hn.$$.fragment,o),$(Kn.$$.fragment,o),$(ta.$$.fragment,o),$(xo.$$.fragment,o),$(na.$$.fragment,o),$(aa.$$.fragment,o),$(Eo.$$.fragment,o),$(ra.$$.fragment,o),$(Co.$$.fragment,o),od=!1},d(o){t(p),o&&t(k),o&&t(g),B(i),o&&t(Le),o&&t(A),o&&t(Se),o&&t(I),B(U),o&&t(De),o&&t(Z),o&&t(C),o&&t(j),o&&t(ee),o&&t(we),o&&t(Ge),o&&t(R),o&&t(We),o&&t(O),B(_e),o&&t(G),o&&t(H),o&&t(it),o&&t(zt),B(Ro),o&&t(Cs),o&&t(pa),o&&t(js),B(Ho,o),o&&t(Os),o&&t(Ft),B(Ko),o&&t(Ps),o&&t(Ne),B(Vo),B(Qt),o&&t(Ns),o&&t(Mt),B(Qo),o&&t(As),o&&t(be),B(Xo),B(Zo),o&&t(Is),o&&t(Ct),B(en),o&&t(Ls),o&&t(ke),B(tn),B(an),o&&t(Ss),o&&t(jt),B(rn),o&&t(Ds),o&&t(nt),o&&t(Gs),o&&t(Ae),B(sn),B(pn),B(oo),B(no),o&&t(Ws),o&&t(Pt),B(hn),o&&t(Us),o&&t(at),o&&t(Rs),o&&t(Ie),B(un),B(gn),B(ro),B(so),o&&t(Hs),o&&t(At),B(bn),o&&t(Ks),o&&t(It),B(kn),B(yn),B(co),o&&t(Vs),o&&t(Lt),B(vn),o&&t(Js),o&&t(ye),B(Tn),B(ho),B(xn),B(uo),B(mo),o&&t(Qs),o&&t(Dt),B(zn),o&&t(Xs),o&&t(ve),B(Fn),B(_o),B(Cn),B(go),o&&t(Ys),o&&t(Wt),B(On),o&&t(Zs),o&&t(S),B(Pn),B(Wn),B(ko),B(yo),B(Un),B(To),B(Rn),B($o),o&&t(ed),o&&t(Rt),B(Hn),o&&t(td),o&&t(D),B(Kn),B(ta),B(xo),B(na),B(aa),B(Eo),B(ra),B(Co)}}}const cf={local:"blenderbot",sections:[{local:"overview",title:"Overview"},{local:"implementation-notes",title:"Implementation Notes"},{local:"usage",title:"Usage"},{local:"transformers.BlenderbotConfig",title:"BlenderbotConfig"},{local:"transformers.BlenderbotTokenizer",title:"BlenderbotTokenizer"},{local:"transformers.BlenderbotTokenizerFast",title:"BlenderbotTokenizerFast"},{local:"transformers.BlenderbotModel",title:"BlenderbotModel"},{local:"transformers.BlenderbotForConditionalGeneration",title:"BlenderbotForConditionalGeneration"},{local:"transformers.BlenderbotForCausalLM",title:"BlenderbotForCausalLM"},{local:"transformers.TFBlenderbotModel",title:"TFBlenderbotModel"},{local:"transformers.TFBlenderbotForConditionalGeneration",title:"TFBlenderbotForConditionalGeneration"},{local:"transformers.FlaxBlenderbotModel",title:"FlaxBlenderbotModel"},{local:"transformers.FlaxBlenderbotForConditionalGeneration",title:"FlaxBlenderbotForConditionalGeneration"}],title:"Blenderbot"};function pf(z){return Wm(()=>{new URLSearchParams(window.location.search).get("fw")}),[]}class bf extends Lm{constructor(p){super();Sm(this,p,pf,lf,Dm,{})}}export{bf as default,cf as metadata};
