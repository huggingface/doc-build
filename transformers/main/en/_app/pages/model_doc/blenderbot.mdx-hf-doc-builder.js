import{S as Lm,i as Sm,s as Dm,e as n,k as l,w as y,t as s,M as Gm,c as a,d as t,m as c,a as r,x as v,h as d,b as h,G as e,g as f,y as T,q as w,o as $,B as x,v as Wm,L as nt}from"../../chunks/vendor-hf-doc-builder.js";import{T as xo}from"../../chunks/Tip-hf-doc-builder.js";import{D as P}from"../../chunks/Docstring-hf-doc-builder.js";import{C as Ke}from"../../chunks/CodeBlock-hf-doc-builder.js";import{I as ce}from"../../chunks/IconCopyLink-hf-doc-builder.js";import{E as ot}from"../../chunks/ExampleCodeBlock-hf-doc-builder.js";function Um(z){let p,k,g,u,b;return u=new Ke({props:{code:`from transformers import BlenderbotModel, BlenderbotConfig
...
the latter silently ignores them.`)},l(i){p=a(i,"P",{});var m=r(p);k=d(m,"Although the recipe for forward pass needs to be defined within this function, one should call the "),g=a(m,"CODE",{});var B=r(g);u=d(B,"Module"),B.forEach(t),b=d(m,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
`),U=n("code"),Se=s('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(F){p=a(F,"P",{});var q=r(p);k=d(q,"TF 2.0 models accepts two formats as inputs:"),q.forEach(t),g=c(F),u=a(F,"UL",{});var ge=r(u);b=a(ge,"LI",{});var at=r(b);i=d(at,"having all inputs as keyword arguments (like PyTorch models), or"),at.forEach(t),m=c(ge),B=a(ge,"LI",{});var Ve=r(B);Me=d(Ve,"having all inputs as a list, tuple or dict in the first positional arguments."),Ve.forEach(t),ge.forEach(t),pe=c(F),E=a(F,"P",{});var O=r(E);fe=d(O,"This second option is useful when using "),te=a(O,"CODE",{});var me=r(te);Ce=d(me,"tf.keras.Model.fit"),me.forEach(t),oe=d(O,` method which currently requires having all the
tensors in the first argument of the model call function: `),ne=a(O,"CODE",{});var De=r(ne);je=d(De,"model(inputs)"),De.forEach(t),we=d(O,"."),O.forEach(t),G=c(F),N=a(F,"P",{});var be=r(N);_e=d(be,`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),be.forEach(t),R=c(F),M=a(F,"UL",{});var K=r(M);j=a(K,"LI",{});var V=r(j);Oe=d(V,"a single Tensor with "),J=a(V,"CODE",{});var rt=r(J);Q=d(rt,"input_ids"),rt.forEach(t),Pe=d(V," only and nothing else: "),W=a(V,"CODE",{});var Je=r(W);Ne=d(Je,"model(input_ids)"),Je.forEach(t),V.forEach(t),Ae=c(K),A=a(K,"LI",{});var I=r(A);he=d(I,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),ae=a(I,"CODE",{});var ke=r(ae);$e=d(ke,"model([input_ids, attention_mask])"),ke.forEach(t),ue=d(I," or "),H=a(I,"CODE",{});var st=r(H);Ie=d(st,"model([input_ids, attention_mask, token_type_ids])"),st.forEach(t),I.forEach(t),xe=c(K),C=a(K,"LI",{});var re=r(C);Le=d(re,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),U=a(re,"CODE",{});var dt=r(U);Se=d(dt,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),dt.forEach(t),re.forEach(t),K.forEach(t)},m(F,q){f(F,p,q),e(p,k),f(F,g,q),f(F,u,q),e(u,b),e(b,i),e(u,m),e(u,B),e(B,Me),f(F,pe,q),f(F,E,q),e(E,fe),e(E,te),e(te,Ce),e(E,oe),e(E,ne),e(ne,je),e(E,we),f(F,G,q),f(F,N,q),e(N,_e),f(F,R,q),f(F,M,q),e(M,j),e(j,Oe),e(j,J),e(J,Q),e(j,Pe),e(j,W),e(W,Ne),e(M,Ae),e(M,A),e(A,he),e(A,ae),e(ae,$e),e(A,ue),e(A,H),e(H,Ie),e(M,xe),e(M,C),e(C,Le),e(C,U),e(U,Se)},d(F){F&&t(p),F&&t(g),F&&t(u),F&&t(pe),F&&t(E),F&&t(G),F&&t(N),F&&t(R),F&&t(M)}}}function Xm(z){let p,k,g,u,b;return{c(){p=n("p"),k=s("Although the recipe for forward pass needs to be defined within this function, one should call the "),g=n("code"),u=s("Module"),b=s(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(i){p=a(i,"P",{});var m=r(p);k=d(m,"Although the recipe for forward pass needs to be defined within this function, one should call the "),g=a(m,"CODE",{});var B=r(g);u=d(B,"Module"),B.forEach(t),b=d(m,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
the latter silently ignores them.`)},l(i){p=a(i,"P",{});var m=r(p);k=d(m,"Although the recipe for forward pass needs to be defined within this function, one should call the "),g=a(m,"CODE",{});var B=r(g);u=d(B,"Module"),B.forEach(t),b=d(m,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),m.forEach(t)},m(i,m){f(i,p,m),e(p,k),e(p,g),e(g,u),e(p,b)},d(i){i&&t(p)}}}function sf(z){let p,k,g,u,b;return u=new Ke({props:{code:`from transformers import BlenderbotTokenizer, FlaxBlenderbotForConditionalGeneration
...
<span class="hljs-meta">&gt;&gt;&gt; </span>outputs = model.decode(decoder_input_ids, encoder_outputs)
<span class="hljs-meta">&gt;&gt;&gt; </span>logits = outputs.logits`}}),{c(){p=n("p"),k=s("Example:"),g=l(),y(u.$$.fragment)},l(i){p=a(i,"P",{});var m=r(p);k=d(m,"Example:"),m.forEach(t),g=c(i),v(u.$$.fragment,i)},m(i,m){f(i,p,m),e(p,k),f(i,g,m),T(u,i,m),b=!0},p:nt,i(i){b||(w(u.$$.fragment,i),b=!0)},o(i){$(u.$$.fragment,i),b=!1},d(i){i&&t(p),i&&t(g),x(u,i)}}}function lf(z){let p,k,g,u,b,i,m,B,Me,pe,E,fe,te,Ce,oe,ne,je,we,G,N,_e,R,M,j,Oe,J,Q,Pe,W,Ne,Ae,A,he,ae,$e,ue,H,Ie,xe,C,Le,U,Se,F,q,ge,at,Ve,O,me,De,be,K,V,rt,Je,I,ke,st,re,dt,Bd,qd,Fo,Ed,zo,Md,Cd,jd,Ge,Od,za,Pd,Nd,Ba,Ad,Id,Vn,Ld,Sd,bs,it,qt,qa,Bo,Dd,Ea,Gd,ks,Jn,Wd,ys,qo,vs,lt,Et,Ma,Eo,Ud,Ca,Rd,Ts,ye,Mo,Hd,ct,Kd,Qn,Vd,Jd,Co,Qd,Xd,Yd,pt,Zd,Xn,ei,ti,Yn,oi,ni,ai,Mt,ws,ht,Ct,ja,jo,ri,Oa,si,$s,se,Oo,di,Pa,ii,li,jt,Na,ci,pi,Zn,hi,ui,mi,Po,fi,ea,_i,gi,bi,Qe,No,ki,Aa,yi,vi,Ia,ta,Ti,La,wi,xs,ut,Ot,Sa,Ao,$i,Da,xi,Fs,de,Io,Fi,Lo,zi,Ga,Bi,qi,Ei,Pt,Wa,Mi,Ci,oa,ji,Oi,Pi,So,Ni,na,Ai,Ii,Li,Xe,Do,Si,Ua,Di,Gi,Ra,aa,Wi,Ha,Ui,zs,mt,Nt,Ka,Go,Ri,Va,Hi,Bs,We,Ki,Ja,Vi,Ji,Qa,Qi,Xi,Xa,Yi,qs,ve,Wo,Zi,Uo,el,ra,tl,ol,nl,Ro,al,Ho,rl,sl,dl,Fe,Ko,il,ft,ll,sa,cl,pl,Ya,hl,ul,ml,At,fl,It,Es,_t,Lt,Za,Vo,_l,er,gl,Ms,Ue,bl,da,kl,yl,tr,vl,Tl,or,wl,Cs,Te,Jo,$l,Qo,xl,ia,Fl,zl,Bl,Xo,ql,Yo,El,Ml,Cl,ze,Zo,jl,gt,Ol,la,Pl,Nl,nr,Al,Il,Ll,St,Sl,Dt,js,bt,Gt,ar,en,Dl,rr,Gl,Os,kt,tn,Wl,Wt,on,Ul,Ut,Ps,yt,Rt,sr,nn,Rl,dr,Hl,Ns,ie,an,Kl,rn,Vl,ca,Jl,Ql,Xl,sn,Yl,dn,Zl,ec,tc,Ht,oc,Be,ln,nc,vt,ac,pa,rc,sc,ir,dc,ic,lc,Kt,cc,Vt,As,Tt,Jt,lr,cn,pc,cr,hc,Is,le,pn,uc,hn,mc,ha,fc,_c,gc,un,bc,mn,kc,yc,vc,Qt,Tc,X,fn,wc,wt,$c,ua,xc,Fc,pr,zc,Bc,qc,Xt,Ec,hr,Mc,Cc,ur,mr,fr,_r,jc,Oc,gr,br,kr,_n,Pc,yr,Nc,Ac,Ls,$t,Yt,vr,gn,Ic,Tr,Lc,Ss,L,bn,Sc,kn,Dc,ma,Gc,Wc,Uc,yn,Rc,vn,Hc,Kc,Vc,wr,Jc,Qc,Re,$r,Tn,Xc,Yc,xr,wn,Zc,ep,Fr,$n,tp,op,zr,xn,np,ap,qe,Fn,rp,xt,sp,Br,dp,ip,qr,lp,cp,pp,Zt,hp,eo,up,to,zn,mp,oo,fp,no,Bn,_p,ao,Ds,Ft,ro,Er,qn,gp,Mr,bp,Gs,S,En,kp,Mn,yp,fa,vp,Tp,wp,Cn,$p,jn,xp,Fp,zp,Cr,Bp,qp,He,jr,On,Ep,Mp,Or,Pn,Cp,jp,Pr,Nn,Op,Pp,Nr,An,Np,Ap,D,In,Ip,zt,Lp,Ar,Sp,Dp,Ir,Gp,Wp,Up,so,Rp,Lr,Hp,Kp,Sr,Dr,Gr,Wr,Vp,Jp,Ur,Rr,Hr,Kr,Qp,Xp,Vr,Jr,Qr,Xr,Yp,Zp,Yr,Zr,Ln,io,lo,es,Sn,eh,ts,th,oh,os,nh,ah,co,Dn,rh,po,sh,ho,Gn,dh,uo,Ws;return i=new ce({}),R=new ce({}),be=new ce({}),Bo=new ce({}),qo=new Ke({props:{code:`from transformers import BlenderbotTokenizer, BlenderbotForConditionalGeneration
...
failure cases of our models.`),xe=l(),C=n("p"),Le=s("This model was contributed by "),U=n("a"),Se=s("sshleifer"),F=s(". The authors\u2019 code can be found "),q=n("a"),ge=s("here"),at=s(" ."),Ve=l(),O=n("h2"),me=n("a"),De=n("span"),y(be.$$.fragment),K=l(),V=n("span"),rt=s("Implementation Notes"),Je=l(),I=n("ul"),ke=n("li"),st=s("Blenderbot uses a standard "),re=n("a"),dt=s("seq2seq model transformer"),Bd=s(" based architecture."),qd=l(),Fo=n("li"),Ed=s("Available checkpoints can be found in the "),zo=n("a"),Md=s("model hub"),Cd=s("."),jd=l(),Ge=n("li"),Od=s("This is the "),za=n("em"),Pd=s("default"),Nd=s(` Blenderbot model class. However, some smaller checkpoints, such as
`),Ba=n("code"),Ad=s("facebook/blenderbot_small_90M"),Id=s(`, have a different architecture and consequently should be used with
`),Vn=n("a"),Ld=s("BlenderbotSmall"),Sd=s("."),bs=l(),it=n("h2"),qt=n("a"),qa=n("span"),y(Bo.$$.fragment),Dd=l(),Ea=n("span"),Gd=s("Usage"),ks=l(),Jn=n("p"),Wd=s("Here is an example of model usage:"),ys=l(),y(qo.$$.fragment),vs=l(),lt=n("h2"),Et=n("a"),Ma=n("span"),y(Eo.$$.fragment),Ud=l(),Ca=n("span"),Rd=s("BlenderbotConfig"),Ts=l(),ye=n("div"),y(Mo.$$.fragment),Hd=l(),ct=n("p"),Kd=s("This is the configuration class to store the configuration of a "),Qn=n("a"),Vd=s("BlenderbotModel"),Jd=s(`. It is used to instantiate an
...
adding special tokens. A Blenderbot sequence has the following format:`),vi=l(),Ia=n("ul"),ta=n("li"),Ti=s("single sequence: "),La=n("code"),wi=s("X </s>"),xs=l(),ut=n("h2"),Ot=n("a"),Sa=n("span"),y(Ao.$$.fragment),$i=l(),Da=n("span"),xi=s("BlenderbotTokenizerFast"),Fs=l(),de=n("div"),y(Io.$$.fragment),Fi=l(),Lo=n("p"),zi=s("Construct a \u201Cfast\u201D Blenderbot tokenizer (backed by HuggingFace\u2019s "),Ga=n("em"),Bi=s("tokenizers"),qi=s(" library)."),Ei=l(),Pt=n("p"),Wa=n("code"),Mi=s("BlenderbotFast"),Ci=s(" is nearly identical to "),oa=n("a"),ji=s("RobertaTokenizerFast"),Oi=s(` and runs end-to-end tokenization: punctuation
...
adding special tokens. A Blenderbot sequence has the following format:`),Gi=l(),Ra=n("ul"),aa=n("li"),Wi=s("single sequence: "),Ha=n("code"),Ui=s("X </s>"),zs=l(),mt=n("h2"),Nt=n("a"),Ka=n("span"),y(Go.$$.fragment),Ri=l(),Va=n("span"),Hi=s("BlenderbotModel"),Bs=l(),We=n("p"),Ki=s("See "),Ja=n("code"),Vi=s("transformers.BartModel"),Ji=s(" for arguments to "),Qa=n("em"),Qi=s("forward"),Xi=s(" and "),Xa=n("em"),Yi=s("generate"),qs=l(),ve=n("div"),y(Wo.$$.fragment),Zi=l(),Uo=n("p"),el=s(`The bare Blenderbot Model outputting raw hidden-states without any specific head on top.
...
and behavior.`),dl=l(),Fe=n("div"),y(Ko.$$.fragment),il=l(),ft=n("p"),ll=s("The "),sa=n("a"),cl=s("BlenderbotModel"),pl=s(" forward method, overrides the "),Ya=n("code"),hl=s("__call__"),ul=s(" special method."),ml=l(),y(At.$$.fragment),fl=l(),y(It.$$.fragment),Es=l(),_t=n("h2"),Lt=n("a"),Za=n("span"),y(Vo.$$.fragment),_l=l(),er=n("span"),gl=s("BlenderbotForConditionalGeneration"),Ms=l(),Ue=n("p"),bl=s("See "),da=n("a"),kl=s("BartForConditionalGeneration"),yl=s(" for arguments to "),tr=n("em"),vl=s("forward"),Tl=s(" and "),or=n("em"),wl=s("generate"),Cs=l(),Te=n("div"),y(Jo.$$.fragment),$l=l(),Qo=n("p"),xl=s(`The Blenderbot Model with a language modeling head. Can be used for summarization.
This model inherits from `),ia=n("a"),Fl=s("PreTrainedModel"),zl=s(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Bl=l(),Xo=n("p"),ql=s("This model is also a PyTorch "),Yo=n("a"),El=s("torch.nn.Module"),Ml=s(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Cl=l(),ze=n("div"),y(Zo.$$.fragment),jl=l(),gt=n("p"),Ol=s("The "),la=n("a"),Pl=s("BlenderbotForConditionalGeneration"),Nl=s(" forward method, overrides the "),nr=n("code"),Al=s("__call__"),Il=s(" special method."),Ll=l(),y(St.$$.fragment),Sl=l(),y(Dt.$$.fragment),js=l(),bt=n("h2"),Gt=n("a"),ar=n("span"),y(en.$$.fragment),Dl=l(),rr=n("span"),Gl=s("BlenderbotForCausalLM"),Os=l(),kt=n("div"),y(tn.$$.fragment),Wl=l(),Wt=n("div"),y(on.$$.fragment),Ul=l(),y(Ut.$$.fragment),Ps=l(),yt=n("h2"),Rt=n("a"),sr=n("span"),y(nn.$$.fragment),Rl=l(),dr=n("span"),Hl=s("TFBlenderbotModel"),Ns=l(),ie=n("div"),y(an.$$.fragment),Kl=l(),rn=n("p"),Vl=s(`The bare BLENDERBOT Model outputting raw hidden-states without any specific head on top.
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),vc=l(),y(Qt.$$.fragment),Tc=l(),X=n("div"),y(fn.$$.fragment),wc=l(),wt=n("p"),$c=s("The "),ua=n("a"),xc=s("TFBlenderbotForConditionalGeneration"),Fc=s(" forward method, overrides the "),pr=n("code"),zc=s("__call__"),Bc=s(" special method."),qc=l(),y(Xt.$$.fragment),Ec=l(),hr=n("p"),Mc=s("Conversation example::"),Cc=l(),ur=n("blockquote"),mr=n("blockquote"),fr=n("blockquote"),_r=n("p"),jc=s(`from transformers import BlenderbotTokenizer, TFBlenderbotForConditionalGeneration >>> mname =
...
`),vn=n("a"),Hc=s("flax.nn.Module"),Kc=s(` subclass. Use it as a
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),Vc=l(),wr=n("p"),Jc=s("Finally, this model supports inherent JAX features such as:"),Qc=l(),Re=n("ul"),$r=n("li"),Tn=n("a"),Xc=s("Just-In-Time (JIT) compilation"),Yc=l(),xr=n("li"),wn=n("a"),Zc=s("Automatic Differentiation"),ep=l(),Fr=n("li"),$n=n("a"),tp=s("Vectorization"),op=l(),zr=n("li"),xn=n("a"),np=s("Parallelization"),ap=l(),qe=n("div"),y(Fn.$$.fragment),rp=l(),xt=n("p"),sp=s("The "),Br=n("code"),dp=s("FlaxBlenderbotPreTrainedModel"),ip=s(" forward method, overrides the "),qr=n("code"),lp=s("__call__"),cp=s(" special method."),pp=l(),y(Zt.$$.fragment),hp=l(),y(eo.$$.fragment),up=l(),to=n("div"),y(zn.$$.fragment),mp=l(),y(oo.$$.fragment),fp=l(),no=n("div"),y(Bn.$$.fragment),_p=l(),y(ao.$$.fragment),Ds=l(),Ft=n("h2"),ro=n("a"),Er=n("span"),y(qn.$$.fragment),gp=l(),Mr=n("span"),bp=s("FlaxBlenderbotForConditionalGeneration"),Gs=l(),S=n("div"),y(En.$$.fragment),kp=l(),Mn=n("p"),yp=s(`The Blenderbot Model with a language modeling head. Can be used for summarization.
...
`),jn=n("a"),xp=s("flax.nn.Module"),Fp=s(` subclass. Use it as a
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),zp=l(),Cr=n("p"),Bp=s("Finally, this model supports inherent JAX features such as:"),qp=l(),He=n("ul"),jr=n("li"),On=n("a"),Ep=s("Just-In-Time (JIT) compilation"),Mp=l(),Or=n("li"),Pn=n("a"),Cp=s("Automatic Differentiation"),jp=l(),Pr=n("li"),Nn=n("a"),Op=s("Vectorization"),Pp=l(),Nr=n("li"),An=n("a"),Np=s("Parallelization"),Ap=l(),D=n("div"),y(In.$$.fragment),Ip=l(),zt=n("p"),Lp=s("The "),Ar=n("code"),Sp=s("FlaxBlenderbotPreTrainedModel"),Dp=s(" forward method, overrides the "),Ir=n("code"),Gp=s("__call__"),Wp=s(" special method."),Up=l(),y(so.$$.fragment),Rp=l(),Lr=n("p"),Hp=s("Conversation example::"),Kp=l(),Sr=n("blockquote"),Dr=n("blockquote"),Gr=n("blockquote"),Wr=n("p"),Vp=s("from transformers import BlenderbotTokenizer, FlaxBlenderbotForConditionalGeneration, BlenderbotConfig"),Jp=l(),Ur=n("blockquote"),Rr=n("blockquote"),Hr=n("blockquote"),Kr=n("p"),Qp=s(`model = FlaxBlenderbotForConditionalGeneration.from_pretrained(\u2018facebook/blenderbot-400M-distill\u2019) >>>
tokenizer = BlenderbotTokenizer.from_pretrained(\u2018facebook/blenderbot-400M-distill\u2019)`),Xp=l(),Vr=n("blockquote"),Jr=n("blockquote"),Qr=n("blockquote"),Xr=n("p"),Yp=s(`UTTERANCE = \u201CMy friends are cool but they eat too many carbs.\u201D >>> inputs = tokenizer([UTTERANCE],
...
and code publicly available. Human evaluations show our best models are superior to existing approaches in multi-turn
dialogue in terms of engagingness and humanness measurements. We then discuss the limitations of this work by analyzing
failure cases of our models.`),ms.forEach(t),us.forEach(t),xe=c(o),C=a(o,"P",{});var Bt=r(C);Le=d(Bt,"This model was contributed by "),U=a(Bt,"A",{href:!0,rel:!0});var fs=r(U);Se=d(fs,"sshleifer"),fs.forEach(t),F=d(Bt,". The authors\u2019 code can be found "),q=a(Bt,"A",{href:!0,rel:!0});var ch=r(q);ge=d(ch,"here"),ch.forEach(t),at=d(Bt," ."),Bt.forEach(t),Ve=c(o),O=a(o,"H2",{class:!0});var Us=r(O);me=a(Us,"A",{id:!0,class:!0,href:!0});var ph=r(me);De=a(ph,"SPAN",{});var hh=r(De);v(be.$$.fragment,hh),hh.forEach(t),ph.forEach(t),K=c(Us),V=a(Us,"SPAN",{});var uh=r(V);rt=d(uh,"Implementation Notes"),uh.forEach(t),Us.forEach(t),Je=c(o),I=a(o,"UL",{});var _a=r(I);ke=a(_a,"LI",{});var Rs=r(ke);st=d(Rs,"Blenderbot uses a standard "),re=a(Rs,"A",{href:!0,rel:!0});var mh=r(re);dt=d(mh,"seq2seq model transformer"),mh.forEach(t),Bd=d(Rs," based architecture."),Rs.forEach(t),qd=c(_a),Fo=a(_a,"LI",{});var Hs=r(Fo);Ed=d(Hs,"Available checkpoints can be found in the "),zo=a(Hs,"A",{href:!0,rel:!0});var fh=r(zo);Md=d(fh,"model hub"),fh.forEach(t),Cd=d(Hs,"."),Hs.forEach(t),jd=c(_a),Ge=a(_a,"LI",{});var fo=r(Ge);Od=d(fo,"This is the "),za=a(fo,"EM",{});var _h=r(za);Pd=d(_h,"default"),_h.forEach(t),Nd=d(fo,` Blenderbot model class. However, some smaller checkpoints, such as
`),Ba=a(fo,"CODE",{});var gh=r(Ba);Ad=d(gh,"facebook/blenderbot_small_90M"),gh.forEach(t),Id=d(fo,`, have a different architecture and consequently should be used with
`),Vn=a(fo,"A",{href:!0});var bh=r(Vn);Ld=d(bh,"BlenderbotSmall"),bh.forEach(t),Sd=d(fo,"."),fo.forEach(t),_a.forEach(t),bs=c(o),it=a(o,"H2",{class:!0});var Ks=r(it);qt=a(Ks,"A",{id:!0,class:!0,href:!0});var kh=r(qt);qa=a(kh,"SPAN",{});var yh=r(qa);v(Bo.$$.fragment,yh),yh.forEach(t),kh.forEach(t),Dd=c(Ks),Ea=a(Ks,"SPAN",{});var vh=r(Ea);Gd=d(vh,"Usage"),vh.forEach(t),Ks.forEach(t),ks=c(o),Jn=a(o,"P",{});var Th=r(Jn);Wd=d(Th,"Here is an example of model usage:"),Th.forEach(t),ys=c(o),v(qo.$$.fragment,o),vs=c(o),lt=a(o,"H2",{class:!0});var Vs=r(lt);Et=a(Vs,"A",{id:!0,class:!0,href:!0});var wh=r(Et);Ma=a(wh,"SPAN",{});var $h=r(Ma);v(Eo.$$.fragment,$h),$h.forEach(t),wh.forEach(t),Ud=c(Vs),Ca=a(Vs,"SPAN",{});var xh=r(Ca);Rd=d(xh,"BlenderbotConfig"),xh.forEach(t),Vs.forEach(t),Ts=c(o),ye=a(o,"DIV",{class:!0});var _o=r(ye);v(Mo.$$.fragment,_o),Hd=c(_o),ct=a(_o,"P",{});var ga=r(ct);Kd=d(ga,"This is the configuration class to store the configuration of a "),Qn=a(ga,"A",{href:!0});var Fh=r(Qn);Vd=d(Fh,"BlenderbotModel"),Fh.forEach(t),Jd=d(ga,`. It is used to instantiate an
Blenderbot model according to the specified arguments, defining the model architecture. Instantiating a
configuration with the defaults will yield a similar configuration to that of the Blenderbot
`),Co=a(ga,"A",{href:!0,rel:!0});var zh=r(Co);Qd=d(zh,"facebook/blenderbot-3B"),zh.forEach(t),Xd=d(ga," architecture."),ga.forEach(t),Yd=c(_o),pt=a(_o,"P",{});var ba=r(pt);Zd=d(ba,"Configuration objects inherit from "),Xn=a(ba,"A",{href:!0});var Bh=r(Xn);ei=d(Bh,"PretrainedConfig"),Bh.forEach(t),ti=d(ba,` and can be used to control the model outputs. Read the
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),od.forEach(t),dl=c(go),Fe=a(go,"DIV",{class:!0});var bo=r(Fe);v(Ko.$$.fragment,bo),il=c(bo),ft=a(bo,"P",{});var va=r(ft);ll=d(va,"The "),sa=a(va,"A",{href:!0});var au=r(sa);cl=d(au,"BlenderbotModel"),au.forEach(t),pl=d(va," forward method, overrides the "),Ya=a(va,"CODE",{});var ru=r(Ya);hl=d(ru,"__call__"),ru.forEach(t),ul=d(va," special method."),va.forEach(t),ml=c(bo),v(At.$$.fragment,bo),fl=c(bo),v(It.$$.fragment,bo),bo.forEach(t),go.forEach(t),Es=c(o),_t=a(o,"H2",{class:!0});var nd=r(_t);Lt=a(nd,"A",{id:!0,class:!0,href:!0});var su=r(Lt);Za=a(su,"SPAN",{});var du=r(Za);v(Vo.$$.fragment,du),du.forEach(t),su.forEach(t),_l=c(nd),er=a(nd,"SPAN",{});var iu=r(er);gl=d(iu,"BlenderbotForConditionalGeneration"),iu.forEach(t),nd.forEach(t),Ms=c(o),Ue=a(o,"P",{});var Kn=r(Ue);bl=d(Kn,"See "),da=a(Kn,"A",{href:!0});var lu=r(da);kl=d(lu,"BartForConditionalGeneration"),lu.forEach(t),yl=d(Kn," for arguments to "),tr=a(Kn,"EM",{});var cu=r(tr);vl=d(cu,"forward"),cu.forEach(t),Tl=d(Kn," and "),or=a(Kn,"EM",{});var pu=r(or);wl=d(pu,"generate"),pu.forEach(t),Kn.forEach(t),Cs=c(o),Te=a(o,"DIV",{class:!0});var ko=r(Te);v(Jo.$$.fragment,ko),$l=c(ko),Qo=a(ko,"P",{});var ad=r(Qo);xl=d(ad,`The Blenderbot Model with a language modeling head. Can be used for summarization.
This model inherits from `),ia=a(ad,"A",{href:!0});var hu=r(ia);Fl=d(hu,"PreTrainedModel"),hu.forEach(t),zl=d(ad,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),ad.forEach(t),Bl=c(ko),Xo=a(ko,"P",{});var rd=r(Xo);ql=d(rd,"This model is also a PyTorch "),Yo=a(rd,"A",{href:!0,rel:!0});var uu=r(Yo);El=d(uu,"torch.nn.Module"),uu.forEach(t),Ml=d(rd,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),rd.forEach(t),Cl=c(ko),ze=a(ko,"DIV",{class:!0});var yo=r(ze);v(Zo.$$.fragment,yo),jl=c(yo),gt=a(yo,"P",{});var Ta=r(gt);Ol=d(Ta,"The "),la=a(Ta,"A",{href:!0});var mu=r(la);Pl=d(mu,"BlenderbotForConditionalGeneration"),mu.forEach(t),Nl=d(Ta," forward method, overrides the "),nr=a(Ta,"CODE",{});var fu=r(nr);Al=d(fu,"__call__"),fu.forEach(t),Il=d(Ta," special method."),Ta.forEach(t),Ll=c(yo),v(St.$$.fragment,yo),Sl=c(yo),v(Dt.$$.fragment,yo),yo.forEach(t),ko.forEach(t),js=c(o),bt=a(o,"H2",{class:!0});var sd=r(bt);Gt=a(sd,"A",{id:!0,class:!0,href:!0});var _u=r(Gt);ar=a(_u,"SPAN",{});var gu=r(ar);v(en.$$.fragment,gu),gu.forEach(t),_u.forEach(t),Dl=c(sd),rr=a(sd,"SPAN",{});var bu=r(rr);Gl=d(bu,"BlenderbotForCausalLM"),bu.forEach(t),sd.forEach(t),Os=c(o),kt=a(o,"DIV",{class:!0});var dd=r(kt);v(tn.$$.fragment,dd),Wl=c(dd),Wt=a(dd,"DIV",{class:!0});var id=r(Wt);v(on.$$.fragment,id),Ul=c(id),v(Ut.$$.fragment,id),id.forEach(t),dd.forEach(t),Ps=c(o),yt=a(o,"H2",{class:!0});var ld=r(yt);Rt=a(ld,"A",{id:!0,class:!0,href:!0});var ku=r(Rt);sr=a(ku,"SPAN",{});var yu=r(sr);v(nn.$$.fragment,yu),yu.forEach(t),ku.forEach(t),Rl=c(ld),dr=a(ld,"SPAN",{});var vu=r(dr);Hl=d(vu,"TFBlenderbotModel"),vu.forEach(t),ld.forEach(t),Ns=c(o),ie=a(o,"DIV",{class:!0});var et=r(ie);v(an.$$.fragment,et),Kl=c(et),rn=a(et,"P",{});var cd=r(rn);Vl=d(cd,`The bare BLENDERBOT Model outputting raw hidden-states without any specific head on top.
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),pd.forEach(t),tc=c(et),v(Ht.$$.fragment,et),oc=c(et),Be=a(et,"DIV",{class:!0});var vo=r(Be);v(ln.$$.fragment,vo),nc=c(vo),vt=a(vo,"P",{});var wa=r(vt);ac=d(wa,"The "),pa=a(wa,"A",{href:!0});var $u=r(pa);rc=d($u,"TFBlenderbotModel"),$u.forEach(t),sc=d(wa," forward method, overrides the "),ir=a(wa,"CODE",{});var xu=r(ir);dc=d(xu,"__call__"),xu.forEach(t),ic=d(wa," special method."),wa.forEach(t),lc=c(vo),v(Kt.$$.fragment,vo),cc=c(vo),v(Vt.$$.fragment,vo),vo.forEach(t),et.forEach(t),As=c(o),Tt=a(o,"H2",{class:!0});var hd=r(Tt);Jt=a(hd,"A",{id:!0,class:!0,href:!0});var Fu=r(Jt);lr=a(Fu,"SPAN",{});var zu=r(lr);v(cn.$$.fragment,zu),zu.forEach(t),Fu.forEach(t),pc=c(hd),cr=a(hd,"SPAN",{});var Bu=r(cr);hc=d(Bu,"TFBlenderbotForConditionalGeneration"),Bu.forEach(t),hd.forEach(t),Is=c(o),le=a(o,"DIV",{class:!0});var tt=r(le);v(pn.$$.fragment,tt),uc=c(tt),hn=a(tt,"P",{});var ud=r(hn);mc=d(ud,`The BLENDERBOT Model with a language modeling head. Can be used for summarization.
...
`),vn=a(bd,"A",{href:!0,rel:!0});var Hu=r(vn);Hc=d(Hu,"flax.nn.Module"),Hu.forEach(t),Kc=d(bd,` subclass. Use it as a
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),bd.forEach(t),Vc=c(Y),wr=a(Y,"P",{});var Ku=r(wr);Jc=d(Ku,"Finally, this model supports inherent JAX features such as:"),Ku.forEach(t),Qc=c(Y),Re=a(Y,"UL",{});var To=r(Re);$r=a(To,"LI",{});var Vu=r($r);Tn=a(Vu,"A",{href:!0,rel:!0});var Ju=r(Tn);Xc=d(Ju,"Just-In-Time (JIT) compilation"),Ju.forEach(t),Vu.forEach(t),Yc=c(To),xr=a(To,"LI",{});var Qu=r(xr);wn=a(Qu,"A",{href:!0,rel:!0});var Xu=r(wn);Zc=d(Xu,"Automatic Differentiation"),Xu.forEach(t),Qu.forEach(t),ep=c(To),Fr=a(To,"LI",{});var Yu=r(Fr);$n=a(Yu,"A",{href:!0,rel:!0});var Zu=r($n);tp=d(Zu,"Vectorization"),Zu.forEach(t),Yu.forEach(t),op=c(To),zr=a(To,"LI",{});var em=r(zr);xn=a(em,"A",{href:!0,rel:!0});var tm=r(xn);np=d(tm,"Parallelization"),tm.forEach(t),em.forEach(t),To.forEach(t),ap=c(Y),qe=a(Y,"DIV",{class:!0});var wo=r(qe);v(Fn.$$.fragment,wo),rp=c(wo),xt=a(wo,"P",{});var xa=r(xt);sp=d(xa,"The "),Br=a(xa,"CODE",{});var om=r(Br);dp=d(om,"FlaxBlenderbotPreTrainedModel"),om.forEach(t),ip=d(xa," forward method, overrides the "),qr=a(xa,"CODE",{});var nm=r(qr);lp=d(nm,"__call__"),nm.forEach(t),cp=d(xa," special method."),xa.forEach(t),pp=c(wo),v(Zt.$$.fragment,wo),hp=c(wo),v(eo.$$.fragment,wo),wo.forEach(t),up=c(Y),to=a(Y,"DIV",{class:!0});var kd=r(to);v(zn.$$.fragment,kd),mp=c(kd),v(oo.$$.fragment,kd),kd.forEach(t),fp=c(Y),no=a(Y,"DIV",{class:!0});var yd=r(no);v(Bn.$$.fragment,yd),_p=c(yd),v(ao.$$.fragment,yd),yd.forEach(t),Y.forEach(t),Ds=c(o),Ft=a(o,"H2",{class:!0});var vd=r(Ft);ro=a(vd,"A",{id:!0,class:!0,href:!0});var am=r(ro);Er=a(am,"SPAN",{});var rm=r(Er);v(qn.$$.fragment,rm),rm.forEach(t),am.forEach(t),gp=c(vd),Mr=a(vd,"SPAN",{});var sm=r(Mr);bp=d(sm,"FlaxBlenderbotForConditionalGeneration"),sm.forEach(t),vd.forEach(t),Gs=c(o),S=a(o,"DIV",{class:!0});var Z=r(S);v(En.$$.fragment,Z),kp=c(Z),Mn=a(Z,"P",{});var Td=r(Mn);yp=d(Td,`The Blenderbot Model with a language modeling head. Can be used for summarization.
...
`),jn=a(wd,"A",{href:!0,rel:!0});var im=r(jn);xp=d(im,"flax.nn.Module"),im.forEach(t),Fp=d(wd,` subclass. Use it as a
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),wd.forEach(t),zp=c(Z),Cr=a(Z,"P",{});var lm=r(Cr);Bp=d(lm,"Finally, this model supports inherent JAX features such as:"),lm.forEach(t),qp=c(Z),He=a(Z,"UL",{});var $o=r(He);jr=a($o,"LI",{});var cm=r(jr);On=a(cm,"A",{href:!0,rel:!0});var pm=r(On);Ep=d(pm,"Just-In-Time (JIT) compilation"),pm.forEach(t),cm.forEach(t),Mp=c($o),Or=a($o,"LI",{});var hm=r(Or);Pn=a(hm,"A",{href:!0,rel:!0});var um=r(Pn);Cp=d(um,"Automatic Differentiation"),um.forEach(t),hm.forEach(t),jp=c($o),Pr=a($o,"LI",{});var mm=r(Pr);Nn=a(mm,"A",{href:!0,rel:!0});var fm=r(Nn);Op=d(fm,"Vectorization"),fm.forEach(t),mm.forEach(t),Pp=c($o),Nr=a($o,"LI",{});var _m=r(Nr);An=a(_m,"A",{href:!0,rel:!0});var gm=r(An);Np=d(gm,"Parallelization"),gm.forEach(t),_m.forEach(t),$o.forEach(t),Ap=c(Z),D=a(Z,"DIV",{class:!0});var ee=r(D);v(In.$$.fragment,ee),Ip=c(ee),zt=a(ee,"P",{});var Fa=r(zt);Lp=d(Fa,"The "),Ar=a(Fa,"CODE",{});var bm=r(Ar);Sp=d(bm,"FlaxBlenderbotPreTrainedModel"),bm.forEach(t),Dp=d(Fa," forward method, overrides the "),Ir=a(Fa,"CODE",{});var km=r(Ir);Gp=d(km,"__call__"),km.forEach(t),Wp=d(Fa," special method."),Fa.forEach(t),Up=c(ee),v(so.$$.fragment,ee),Rp=c(ee),Lr=a(ee,"P",{});var ym=r(Lr);Hp=d(ym,"Conversation example::"),ym.forEach(t),Kp=c(ee),Sr=a(ee,"BLOCKQUOTE",{});var vm=r(Sr);Dr=a(vm,"BLOCKQUOTE",{});var Tm=r(Dr);Gr=a(Tm,"BLOCKQUOTE",{});var wm=r(Gr);Wr=a(wm,"P",{});var $m=r(Wr);Vp=d($m,"from transformers import BlenderbotTokenizer, FlaxBlenderbotForConditionalGeneration, BlenderbotConfig"),$m.forEach(t),wm.forEach(t),Tm.forEach(t),vm.forEach(t),Jp=c(ee),Ur=a(ee,"BLOCKQUOTE",{});var xm=r(Ur);Rr=a(xm,"BLOCKQUOTE",{});var Fm=r(Rr);Hr=a(Fm,"BLOCKQUOTE",{});var zm=r(Hr);Kr=a(zm,"P",{});var Bm=r(Kr);Qp=d(Bm,`model = FlaxBlenderbotForConditionalGeneration.from_pretrained(\u2018facebook/blenderbot-400M-distill\u2019) >>>
tokenizer = BlenderbotTokenizer.from_pretrained(\u2018facebook/blenderbot-400M-distill\u2019)`),Bm.forEach(t),zm.forEach(t),Fm.forEach(t),xm.forEach(t),Xp=c(ee),Vr=a(ee,"BLOCKQUOTE",{});var qm=r(Vr);Jr=a(qm,"BLOCKQUOTE",{});var Em=r(Jr);Qr=a(Em,"BLOCKQUOTE",{});var Mm=r(Qr);Xr=a(Mm,"P",{});var Cm=r(Xr);Yp=d(Cm,`UTTERANCE = \u201CMy friends are cool but they eat too many carbs.\u201D >>> inputs = tokenizer([UTTERANCE],
