...
`),U=n("code"),Se=s('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(B){p=a(B,"P",{});var q=r(p);k=d(q,"TF 2.0 models accepts two formats as inputs:"),q.forEach(t),g=c(B),u=a(B,"UL",{});var ge=r(u);b=a(ge,"LI",{});var at=r(b);i=d(at,"having all inputs as keyword arguments (like PyTorch models), or"),at.forEach(t),m=c(ge),F=a(ge,"LI",{});var Ve=r(F);Me=d(Ve,"having all inputs as a list, tuple or dict in the first positional arguments."),Ve.forEach(t),ge.forEach(t),pe=c(B),E=a(B,"P",{});var O=r(E);fe=d(O,"This second option is useful when using "),te=a(O,"CODE",{});var me=r(te);Ce=d(me,"tf.keras.Model.fit"),me.forEach(t),oe=d(O,` method which currently requires having all the
...
`),U=a(re,"CODE",{});var dt=r(U);Se=d(dt,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),dt.forEach(t),re.forEach(t),K.forEach(t)},m(B,q){f(B,p,q),e(p,k),f(B,g,q),f(B,u,q),e(u,b),e(b,i),e(u,m),e(u,F),e(F,Me),f(B,pe,q),f(B,E,q),e(E,fe),e(E,te),e(te,Ce),e(E,oe),e(E,ne),e(ne,je),e(E,we),f(B,G,q),f(B,N,q),e(N,_e),f(B,R,q),f(B,M,q),e(M,j),e(j,Oe),e(j,J),e(J,Q),e(j,Pe),e(j,W),e(W,Ne),e(M,Ae),e(M,A),e(A,he),e(A,ae),e(ae,$e),e(A,ue),e(A,H),e(H,Ie),e(M,xe),e(M,C),e(C,Le),e(C,U),e(U,Se)},d(B){B&&t(p),B&&t(g),B&&t(u),B&&t(pe),B&&t(E),B&&t(G),B&&t(N),B&&t(R),B&&t(M)}}}function Xm(z){let p,k,g,u,b;return{c(){p=n("p"),k=s("Although the recipe for forward pass needs to be defined within this function, one should call the "),g=n("code"),u=s("Module"),b=s(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(i){p=a(i,"P",{});var m=r(p);k=d(m,"Although the recipe for forward pass needs to be defined within this function, one should call the "),g=a(m,"CODE",{});var F=r(g);u=d(F,"Module"),F.forEach(t),b=d(m,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
<span class="hljs-meta">&gt;&gt;&gt; </span>outputs = model.decode(decoder_input_ids, encoder_outputs)
<span class="hljs-meta">&gt;&gt;&gt; </span>logits = outputs.logits`}}),{c(){p=n("p"),k=s("Example:"),g=l(),y(u.$$.fragment)},l(i){p=a(i,"P",{});var m=r(p);k=d(m,"Example:"),m.forEach(t),g=c(i),v(u.$$.fragment,i)},m(i,m){f(i,p,m),e(p,k),f(i,g,m),T(u,i,m),b=!0},p:nt,i(i){b||(w(u.$$.fragment,i),b=!0)},o(i){$(u.$$.fragment,i),b=!1},d(i){i&&t(p),i&&t(g),x(u,i)}}}function lf(z){let p,k,g,u,b,i,m,F,Me,pe,E,fe,te,Ce,oe,ne,je,we,G,N,_e,R,M,j,Oe,J,Q,Pe,W,Ne,Ae,A,he,ae,$e,ue,H,Ie,xe,C,Le,U,Se,B,q,ge,at,Ve,O,me,De,be,K,V,rt,Je,I,ke,st,re,dt,Fd,qd,Bo,Ed,zo,Md,Cd,jd,Ge,Od,za,Pd,Nd,Fa,Ad,Id,Vn,Ld,Sd,bs,it,qt,qa,Fo,Dd,Ea,Gd,ks,Jn,Wd,ys,qo,vs,lt,Et,Ma,Eo,Ud,Ca,Rd,Ts,ye,Mo,Hd,ct,Kd,Qn,Vd,Jd,Co,Qd,Xd,Yd,pt,Zd,Xn,ei,ti,Yn,oi,ni,ai,Mt,ws,ht,Ct,ja,jo,ri,Oa,si,$s,se,Oo,di,Pa,ii,li,jt,Na,ci,pi,Zn,hi,ui,mi,Po,fi,ea,_i,gi,bi,Qe,No,ki,Aa,yi,vi,Ia,ta,Ti,La,wi,xs,ut,Ot,Sa,Ao,$i,Da,xi,Bs,de,Io,Bi,Lo,zi,Ga,Fi,qi,Ei,Pt,Wa,Mi,Ci,oa,ji,Oi,Pi,So,Ni,na,Ai,Ii,Li,Xe,Do,Si,Ua,Di,Gi,Ra,aa,Wi,Ha,Ui,zs,mt,Nt,Ka,Go,Ri,Va,Hi,Fs,We,Ki,Ja,Vi,Ji,Qa,Qi,Xi,Xa,Yi,qs,ve,Wo,Zi,Uo,el,ra,tl,ol,nl,Ro,al,Ho,rl,sl,dl,Be,Ko,il,ft,ll,sa,cl,pl,Ya,hl,ul,ml,At,fl,It,Es,_t,Lt,Za,Vo,_l,er,gl,Ms,Ue,bl,da,kl,yl,tr,vl,Tl,or,wl,Cs,Te,Jo,$l,Qo,xl,ia,Bl,zl,Fl,Xo,ql,Yo,El,Ml,Cl,ze,Zo,jl,gt,Ol,la,Pl,Nl,nr,Al,Il,Ll,St,Sl,Dt,js,bt,Gt,ar,en,Dl,rr,Gl,Os,kt,tn,Wl,Wt,on,Ul,Ut,Ps,yt,Rt,sr,nn,Rl,dr,Hl,Ns,ie,an,Kl,rn,Vl,ca,Jl,Ql,Xl,sn,Yl,dn,Zl,ec,tc,Ht,oc,Fe,ln,nc,vt,ac,pa,rc,sc,ir,dc,ic,lc,Kt,cc,Vt,As,Tt,Jt,lr,cn,pc,cr,hc,Is,le,pn,uc,hn,mc,ha,fc,_c,gc,un,bc,mn,kc,yc,vc,Qt,Tc,X,fn,wc,wt,$c,ua,xc,Bc,pr,zc,Fc,qc,Xt,Ec,hr,Mc,Cc,ur,mr,fr,_r,jc,Oc,gr,br,kr,_n,Pc,yr,Nc,Ac,Ls,$t,Yt,vr,gn,Ic,Tr,Lc,Ss,L,bn,Sc,kn,Dc,ma,Gc,Wc,Uc,yn,Rc,vn,Hc,Kc,Vc,wr,Jc,Qc,Re,$r,Tn,Xc,Yc,xr,wn,Zc,ep,Br,$n,tp,op,zr,xn,np,ap,qe,Bn,rp,xt,sp,Fr,dp,ip,qr,lp,cp,pp,Zt,hp,eo,up,to,zn,mp,oo,fp,no,Fn,_p,ao,Ds,Bt,ro,Er,qn,gp,Mr,bp,Gs,S,En,kp,Mn,yp,fa,vp,Tp,wp,Cn,$p,jn,xp,Bp,zp,Cr,Fp,qp,He,jr,On,Ep,Mp,Or,Pn,Cp,jp,Pr,Nn,Op,Pp,Nr,An,Np,Ap,D,In,Ip,zt,Lp,Ar,Sp,Dp,Ir,Gp,Wp,Up,so,Rp,Lr,Hp,Kp,Sr,Dr,Gr,Wr,Vp,Jp,Ur,Rr,Hr,Kr,Qp,Xp,Vr,Jr,Qr,Xr,Yp,Zp,Yr,Zr,Ln,io,lo,es,Sn,eh,ts,th,oh,os,nh,ah,co,Dn,rh,po,sh,ho,Gn,dh,uo,Ws;return i=new ce({}),R=new ce({}),be=new ce({}),Fo=new ce({}),qo=new Ke({props:{code:`from transformers import BlenderbotTokenizer, BlenderbotForConditionalGeneration
...
adding special tokens. A Blenderbot sequence has the following format:`),Gi=l(),Ra=n("ul"),aa=n("li"),Wi=s("single sequence: "),Ha=n("code"),Ui=s("X </s>"),zs=l(),mt=n("h2"),Nt=n("a"),Ka=n("span"),y(Go.$$.fragment),Ri=l(),Va=n("span"),Hi=s("BlenderbotModel"),Fs=l(),We=n("p"),Ki=s("See "),Ja=n("code"),Vi=s("transformers.BartModel"),Ji=s(" for arguments to "),Qa=n("em"),Qi=s("forward"),Xi=s(" and "),Xa=n("em"),Yi=s("generate"),qs=l(),ve=n("div"),y(Wo.$$.fragment),Zi=l(),Uo=n("p"),el=s(`The bare Blenderbot Model outputting raw hidden-states without any specific head on top.
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),vc=l(),y(Qt.$$.fragment),Tc=l(),X=n("div"),y(fn.$$.fragment),wc=l(),wt=n("p"),$c=s("The "),ua=n("a"),xc=s("TFBlenderbotForConditionalGeneration"),Bc=s(" forward method, overrides the "),pr=n("code"),zc=s("__call__"),Fc=s(" special method."),qc=l(),y(Xt.$$.fragment),Ec=l(),hr=n("p"),Mc=s("Conversation example::"),Cc=l(),ur=n("blockquote"),mr=n("blockquote"),fr=n("blockquote"),_r=n("p"),jc=s(`from transformers import BlenderbotTokenizer, TFBlenderbotForConditionalGeneration >>> mname =
...
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),Vc=l(),wr=n("p"),Jc=s("Finally, this model supports inherent JAX features such as:"),Qc=l(),Re=n("ul"),$r=n("li"),Tn=n("a"),Xc=s("Just-In-Time (JIT) compilation"),Yc=l(),xr=n("li"),wn=n("a"),Zc=s("Automatic Differentiation"),ep=l(),Br=n("li"),$n=n("a"),tp=s("Vectorization"),op=l(),zr=n("li"),xn=n("a"),np=s("Parallelization"),ap=l(),qe=n("div"),y(Bn.$$.fragment),rp=l(),xt=n("p"),sp=s("The "),Fr=n("code"),dp=s("FlaxBlenderbotPreTrainedModel"),ip=s(" forward method, overrides the "),qr=n("code"),lp=s("__call__"),cp=s(" special method."),pp=l(),y(Zt.$$.fragment),hp=l(),y(eo.$$.fragment),up=l(),to=n("div"),y(zn.$$.fragment),mp=l(),y(oo.$$.fragment),fp=l(),no=n("div"),y(Fn.$$.fragment),_p=l(),y(ao.$$.fragment),Ds=l(),Bt=n("h2"),ro=n("a"),Er=n("span"),y(qn.$$.fragment),gp=l(),Mr=n("span"),bp=s("FlaxBlenderbotForConditionalGeneration"),Gs=l(),S=n("div"),y(En.$$.fragment),kp=l(),Mn=n("p"),yp=s(`The Blenderbot Model with a language modeling head. Can be used for summarization.
...
`),Vn=a(fo,"A",{href:!0});var bh=r(Vn);Ld=d(bh,"BlenderbotSmall"),bh.forEach(t),Sd=d(fo,"."),fo.forEach(t),_a.forEach(t),bs=c(o),it=a(o,"H2",{class:!0});var Ks=r(it);qt=a(Ks,"A",{id:!0,class:!0,href:!0});var kh=r(qt);qa=a(kh,"SPAN",{});var yh=r(qa);v(Fo.$$.fragment,yh),yh.forEach(t),kh.forEach(t),Dd=c(Ks),Ea=a(Ks,"SPAN",{});var vh=r(Ea);Gd=d(vh,"Usage"),vh.forEach(t),Ks.forEach(t),ks=c(o),Jn=a(o,"P",{});var Th=r(Jn);Wd=d(Th,"Here is an example of model usage:"),Th.forEach(t),ys=c(o),v(qo.$$.fragment,o),vs=c(o),lt=a(o,"H2",{class:!0});var Vs=r(lt);Et=a(Vs,"A",{id:!0,class:!0,href:!0});var wh=r(Et);Ma=a(wh,"SPAN",{});var $h=r(Ma);v(Eo.$$.fragment,$h),$h.forEach(t),wh.forEach(t),Ud=c(Vs),Ca=a(Vs,"SPAN",{});var xh=r(Ca);Rd=d(xh,"BlenderbotConfig"),xh.forEach(t),Vs.forEach(t),Ts=c(o),ye=a(o,"DIV",{class:!0});var _o=r(ye);v(Mo.$$.fragment,_o),Hd=c(_o),ct=a(_o,"P",{});var ga=r(ct);Kd=d(ga,"This is the configuration class to store the configuration of a "),Qn=a(ga,"A",{href:!0});var Bh=r(Qn);Vd=d(Bh,"BlenderbotModel"),Bh.forEach(t),Jd=d(ga,`. It is used to instantiate an
Blenderbot model according to the specified arguments, defining the model architecture. Instantiating a
configuration with the defaults will yield a similar configuration to that of the Blenderbot
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),pd.forEach(t),tc=c(et),v(Ht.$$.fragment,et),oc=c(et),Fe=a(et,"DIV",{class:!0});var vo=r(Fe);v(ln.$$.fragment,vo),nc=c(vo),vt=a(vo,"P",{});var wa=r(vt);ac=d(wa,"The "),pa=a(wa,"A",{href:!0});var $u=r(pa);rc=d($u,"TFBlenderbotModel"),$u.forEach(t),sc=d(wa," forward method, overrides the "),ir=a(wa,"CODE",{});var xu=r(ir);dc=d(xu,"__call__"),xu.forEach(t),ic=d(wa," special method."),wa.forEach(t),lc=c(vo),v(Kt.$$.fragment,vo),cc=c(vo),v(Vt.$$.fragment,vo),vo.forEach(t),et.forEach(t),As=c(o),Tt=a(o,"H2",{class:!0});var hd=r(Tt);Jt=a(hd,"A",{id:!0,class:!0,href:!0});var Bu=r(Jt);lr=a(Bu,"SPAN",{});var zu=r(lr);v(cn.$$.fragment,zu),zu.forEach(t),Bu.forEach(t),pc=c(hd),cr=a(hd,"SPAN",{});var Fu=r(cr);hc=d(Fu,"TFBlenderbotForConditionalGeneration"),Fu.forEach(t),hd.forEach(t),Is=c(o),le=a(o,"DIV",{class:!0});var tt=r(le);v(pn.$$.fragment,tt),uc=c(tt),hn=a(tt,"P",{});var ud=r(hn);mc=d(ud,`The BLENDERBOT Model with a language modeling head. Can be used for summarization.
...
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),bd.forEach(t),Vc=c(Y),wr=a(Y,"P",{});var Ku=r(wr);Jc=d(Ku,"Finally, this model supports inherent JAX features such as:"),Ku.forEach(t),Qc=c(Y),Re=a(Y,"UL",{});var To=r(Re);$r=a(To,"LI",{});var Vu=r($r);Tn=a(Vu,"A",{href:!0,rel:!0});var Ju=r(Tn);Xc=d(Ju,"Just-In-Time (JIT) compilation"),Ju.forEach(t),Vu.forEach(t),Yc=c(To),xr=a(To,"LI",{});var Qu=r(xr);wn=a(Qu,"A",{href:!0,rel:!0});var Xu=r(wn);Zc=d(Xu,"Automatic Differentiation"),Xu.forEach(t),Qu.forEach(t),ep=c(To),Br=a(To,"LI",{});var Yu=r(Br);$n=a(Yu,"A",{href:!0,rel:!0});var Zu=r($n);tp=d(Zu,"Vectorization"),Zu.forEach(t),Yu.forEach(t),op=c(To),zr=a(To,"LI",{});var em=r(zr);xn=a(em,"A",{href:!0,rel:!0});var tm=r(xn);np=d(tm,"Parallelization"),tm.forEach(t),em.forEach(t),To.forEach(t),ap=c(Y),qe=a(Y,"DIV",{class:!0});var wo=r(qe);v(Bn.$$.fragment,wo),rp=c(wo),xt=a(wo,"P",{});var xa=r(xt);sp=d(xa,"The "),Fr=a(xa,"CODE",{});var om=r(Fr);dp=d(om,"FlaxBlenderbotPreTrainedModel"),om.forEach(t),ip=d(xa," forward method, overrides the "),qr=a(xa,"CODE",{});var nm=r(qr);lp=d(nm,"__call__"),nm.forEach(t),cp=d(xa," special method."),xa.forEach(t),pp=c(wo),v(Zt.$$.fragment,wo),hp=c(wo),v(eo.$$.fragment,wo),wo.forEach(t),up=c(Y),to=a(Y,"DIV",{class:!0});var kd=r(to);v(zn.$$.fragment,kd),mp=c(kd),v(oo.$$.fragment,kd),kd.forEach(t),fp=c(Y),no=a(Y,"DIV",{class:!0});var yd=r(no);v(Fn.$$.fragment,yd),_p=c(yd),v(ao.$$.fragment,yd),yd.forEach(t),Y.forEach(t),Ds=c(o),Bt=a(o,"H2",{class:!0});var vd=r(Bt);ro=a(vd,"A",{id:!0,class:!0,href:!0});var am=r(ro);Er=a(am,"SPAN",{});var rm=r(Er);v(qn.$$.fragment,rm),rm.forEach(t),am.forEach(t),gp=c(vd),Mr=a(vd,"SPAN",{});var sm=r(Mr);bp=d(sm,"FlaxBlenderbotForConditionalGeneration"),sm.forEach(t),vd.forEach(t),Gs=c(o),S=a(o,"DIV",{class:!0});var Z=r(S);v(En.$$.fragment,Z),kp=c(Z),Mn=a(Z,"P",{});var Td=r(Mn);yp=d(Td,`The Blenderbot Model with a language modeling head. Can be used for summarization.
...
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),wd.forEach(t),zp=c(Z),Cr=a(Z,"P",{});var lm=r(Cr);Fp=d(lm,"Finally, this model supports inherent JAX features such as:"),lm.forEach(t),qp=c(Z),He=a(Z,"UL",{});var $o=r(He);jr=a($o,"LI",{});var cm=r(jr);On=a(cm,"A",{href:!0,rel:!0});var pm=r(On);Ep=d(pm,"Just-In-Time (JIT) compilation"),pm.forEach(t),cm.forEach(t),Mp=c($o),Or=a($o,"LI",{});var hm=r(Or);Pn=a(hm,"A",{href:!0,rel:!0});var um=r(Pn);Cp=d(um,"Automatic Differentiation"),um.forEach(t),hm.forEach(t),jp=c($o),Pr=a($o,"LI",{});var mm=r(Pr);Nn=a(mm,"A",{href:!0,rel:!0});var fm=r(Nn);Op=d(fm,"Vectorization"),fm.forEach(t),mm.forEach(t),Pp=c($o),Nr=a($o,"LI",{});var _m=r(Nr);An=a(_m,"A",{href:!0,rel:!0});var gm=r(An);Np=d(gm,"Parallelization"),gm.forEach(t),_m.forEach(t),$o.forEach(t),Ap=c(Z),D=a(Z,"DIV",{class:!0});var ee=r(D);v(In.$$.fragment,ee),Ip=c(ee),zt=a(ee,"P",{});var Ba=r(zt);Lp=d(Ba,"The "),Ar=a(Ba,"CODE",{});var bm=r(Ar);Sp=d(bm,"FlaxBlenderbotPreTrainedModel"),bm.forEach(t),Dp=d(Ba," forward method, overrides the "),Ir=a(Ba,"CODE",{});var km=r(Ir);Gp=d(km,"__call__"),km.forEach(t),Wp=d(Ba," special method."),Ba.forEach(t),Up=c(ee),v(so.$$.fragment,ee),Rp=c(ee),Lr=a(ee,"P",{});var ym=r(Lr);Hp=d(ym,"Conversation example::"),ym.forEach(t),Kp=c(ee),Sr=a(ee,"BLOCKQUOTE",{});var vm=r(Sr);Dr=a(vm,"BLOCKQUOTE",{});var Tm=r(Dr);Gr=a(Tm,"BLOCKQUOTE",{});var wm=r(Gr);Wr=a(wm,"P",{});var $m=r(Wr);Vp=d($m,"from transformers import BlenderbotTokenizer, FlaxBlenderbotForConditionalGeneration, BlenderbotConfig"),$m.forEach(t),wm.forEach(t),Tm.forEach(t),vm.forEach(t),Jp=c(ee),Ur=a(ee,"BLOCKQUOTE",{});var xm=r(Ur);Rr=a(xm,"BLOCKQUOTE",{});var Bm=r(Rr);Hr=a(Bm,"BLOCKQUOTE",{});var zm=r(Hr);Kr=a(zm,"P",{});var Fm=r(Kr);Qp=d(Fm,`model = FlaxBlenderbotForConditionalGeneration.from_pretrained(\u2018facebook/blenderbot-400M-distill\u2019) >>>
tokenizer = BlenderbotTokenizer.from_pretrained(\u2018facebook/blenderbot-400M-distill\u2019)`),Fm.forEach(t),zm.forEach(t),Bm.forEach(t),xm.forEach(t),Xp=c(ee),Vr=a(ee,"BLOCKQUOTE",{});var qm=r(Vr);Jr=a(qm,"BLOCKQUOTE",{});var Em=r(Jr);Qr=a(Em,"BLOCKQUOTE",{});var Mm=r(Qr);Xr=a(Mm,"P",{});var Cm=r(Xr);Yp=d(Cm,`UTTERANCE = \u201CMy friends are cool but they eat too many carbs.\u201D >>> inputs = tokenizer([UTTERANCE],
