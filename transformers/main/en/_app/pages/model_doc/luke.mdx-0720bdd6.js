...
the latter silently ignores them.`)},l(g){h=i(g,"P",{});var f=r(h);E=s(f,"Although the recipe for forward pass needs to be defined within this function, one should call the "),m=i(f,"CODE",{});var z=r(m);L=s(z,"Module"),z.forEach(t),w=s(f,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),f.forEach(t)},m(g,f){u(g,h,f),e(h,E),e(h,m),e(m,L),e(h,w)},d(g){g&&t(h)}}}function up(K){let h,E,m,L,w,g,f,z,Ds,Ho,le,xe,Nn,He,Bs,Dn,Ws,Vo,$e,Us,Ve,Ks,Rs,Yo,Jt,Hs,Qo,Xt,Bn,Vs,Jo,Gt,Ys,Xo,R,Wn,Ye,Qs,Zt,Js,Xs,Gs,Un,q,Zs,Kn,ea,ta,Rn,na,oa,Hn,sa,aa,Vn,ia,ra,en,da,la,ca,Qe,H,tn,pa,ha,Yn,ua,ma,Qn,fa,ga,Jn,_a,ka,ya,Je,nn,Xn,ba,va,Ta,on,Gn,La,wa,Ea,U,Zn,za,xa,ce,qe,sn,$a,qa,Xe,Fa,Ma,Ca,Fe,an,Pa,ja,Ge,Aa,Ia,Oa,rn,dn,Sa,Na,Da,O,ln,Ba,Wa,eo,Ua,Ka,to,Ra,Ha,no,Va,Ya,oo,Qa,Ja,Xa,pe,Ga,cn,Za,ei,Ze,ti,ni,oi,et,si,tt,ai,ii,Go,pn,ri,Zo,nt,es,V,di,ot,li,ci,st,pi,hi,at,ui,mi,ts,he,Me,so,it,fi,ao,gi,ns,F,rt,_i,dt,ki,hn,yi,bi,vi,ue,Ti,un,Li,wi,mn,Ei,zi,xi,io,$i,qi,lt,os,me,Ce,ro,ct,Fi,lo,Mi,ss,M,pt,Ci,co,Pi,ji,x,Ai,fn,Ii,Oi,gn,Si,Ni,_n,Di,Bi,po,Wi,Ui,ho,Ki,Ri,uo,Hi,Vi,mo,Yi,Qi,Ji,Pe,ht,Xi,fo,Gi,Zi,kn,ut,as,fe,je,go,mt,er,_o,tr,is,C,ft,nr,ko,or,sr,gt,ar,yn,ir,rr,dr,_t,lr,kt,cr,pr,hr,S,yt,ur,ge,mr,bn,fr,gr,yo,_r,kr,yr,Ae,br,bo,vr,Tr,bt,rs,_e,Ie,vo,vt,Lr,To,wr,ds,P,Tt,Er,Lo,zr,xr,Lt,$r,vn,qr,Fr,Mr,wt,Cr,Et,Pr,jr,Ar,J,zt,Ir,ke,Or,Tn,Sr,Nr,wo,Dr,Br,Wr,Oe,ls,ye,Se,Eo,xt,Ur,zo,Kr,cs,j,$t,Rr,xo,Hr,Vr,qt,Yr,Ln,Qr,Jr,Xr,Ft,Gr,Mt,Zr,ed,td,N,Ct,nd,be,od,wn,sd,ad,$o,id,rd,dd,Ne,ld,qo,cd,pd,Pt,ps,ve,De,Fo,jt,hd,Mo,ud,hs,A,At,md,Co,fd,gd,It,_d,En,kd,yd,bd,Ot,vd,St,Td,Ld,wd,D,Nt,Ed,Te,zd,zn,xd,$d,Po,qd,Fd,Md,Be,Cd,jo,Pd,jd,Dt,us,Le,We,Ao,Bt,Ad,Io,Id,ms,I,Wt,Od,Oo,Sd,Nd,Ut,Dd,xn,Bd,Wd,Ud,Kt,Kd,Rt,Rd,Hd,Vd,B,Ht,Yd,we,Qd,$n,Jd,Xd,So,Gd,Zd,el,Ue,tl,No,nl,ol,Vt,fs;return g=new ze({}),He=new ze({}),nt=new Sn({props:{code:`from transformers import LukeTokenizer, LukeModel, LukeForEntityPairClassification
...
configuration. Check out the <a href="/docs/transformers/main/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),yt=new W({props:{name:"forward",anchor:"transformers.LukeModel.forward",parameters:[{name:"input_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"attention_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"token_type_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"position_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"entity_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"entity_attention_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"entity_token_type_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"entity_position_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"head_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/luke/modeling_luke.py#L911",parametersDescription:[{anchor:"transformers.LukeModel.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
...
model. Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/main/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),zt=new W({props:{name:"forward",anchor:"transformers.LukeForMaskedLM.forward",parameters:[{name:"input_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"attention_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"token_type_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"position_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"entity_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"entity_attention_mask",val:": typing.Optional[torch.LongTensor] = None"},{name:"entity_token_type_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"entity_position_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"labels",val:": typing.Optional[torch.LongTensor] = None"},{name:"entity_labels",val:": typing.Optional[torch.LongTensor] = None"},{name:"head_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/luke/modeling_luke.py#L1168",parametersDescription:[{anchor:"transformers.LukeForMaskedLM.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/main/en/model_doc/luke#transformers.LukeTokenizer">LukeTokenizer</a>. See <a href="/docs/transformers/main/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/main/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
model. Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/main/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),Nt=new W({props:{name:"forward",anchor:"transformers.LukeForEntityPairClassification.forward",parameters:[{name:"input_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"attention_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"token_type_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"position_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"entity_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"entity_attention_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"entity_token_type_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"entity_position_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"head_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"labels",val:": typing.Optional[torch.LongTensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/luke/modeling_luke.py#L1396",parametersDescription:[{anchor:"transformers.LukeForEntityPairClassification.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/main/en/model_doc/luke#transformers.LukeTokenizer">LukeTokenizer</a>. See <a href="/docs/transformers/main/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/main/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
model. Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/main/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),Ht=new W({props:{name:"forward",anchor:"transformers.LukeForEntitySpanClassification.forward",parameters:[{name:"input_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"position_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"entity_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"entity_attention_mask",val:": typing.Optional[torch.LongTensor] = None"},{name:"entity_token_type_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"entity_position_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"entity_start_positions",val:": typing.Optional[torch.LongTensor] = None"},{name:"entity_end_positions",val:": typing.Optional[torch.LongTensor] = None"},{name:"head_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"labels",val:": typing.Optional[torch.LongTensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/luke/modeling_luke.py#L1516",parametersDescription:[{anchor:"transformers.LukeForEntitySpanClassification.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/main/en/model_doc/luke#transformers.LukeTokenizer">LukeTokenizer</a>. See <a href="/docs/transformers/main/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/main/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
documentation from `),mn=a("a"),Ei=o("PretrainedConfig"),zi=o(" for more information."),xi=l(),io=a("p"),$i=o("Examples:"),qi=l(),_(lt.$$.fragment),os=l(),me=a("h2"),Ce=a("a"),ro=a("span"),_(ct.$$.fragment),Fi=l(),lo=a("span"),Mi=o("LukeTokenizer"),ss=l(),M=a("div"),_(pt.$$.fragment),Ci=l(),co=a("p"),Pi=o("Construct a LUKE tokenizer."),ji=l(),x=a("p"),Ai=o("This tokenizer inherits from "),fn=a("a"),Ii=o("RobertaTokenizer"),Oi=o(` which contains most of the main methods. Users should refer to
this superclass for more information regarding those methods. Compared to `),gn=a("a"),Si=o("RobertaTokenizer"),Ni=o(", "),_n=a("a"),Di=o("LukeTokenizer"),Bi=o(`
also creates entity sequences, namely `),po=a("code"),Wi=o("entity_ids"),Ui=o(", "),ho=a("code"),Ki=o("entity_attention_mask"),Ri=o(", "),uo=a("code"),Hi=o("entity_token_type_ids"),Vi=o(`, and
...
masked entity prediction.`),xr=l(),Lt=a("p"),$r=o("This model inherits from "),vn=a("a"),qr=o("PreTrainedModel"),Fr=o(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Mr=l(),wt=a("p"),Cr=o("This model is also a PyTorch "),Et=a("a"),Pr=o("torch.nn.Module"),jr=o(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Ar=l(),J=a("div"),_(zt.$$.fragment),Ir=l(),ke=a("p"),Or=o("The "),Tn=a("a"),Sr=o("LukeForMaskedLM"),Nr=o(" forward method, overrides the "),wo=a("code"),Dr=o("__call__"),Br=o(" special method."),Wr=l(),_(Oe.$$.fragment),ls=l(),ye=a("h2"),Se=a("a"),Eo=a("span"),_(xt.$$.fragment),Ur=l(),zo=a("span"),Kr=o("LukeForEntityClassification"),cs=l(),j=a("div"),_($t.$$.fragment),Rr=l(),xo=a("p"),Hr=o(`The LUKE model with a classification head on top (a linear layer on top of the hidden state of the first entity
token) for entity classification tasks, such as Open Entity.`),Vr=l(),qt=a("p"),Yr=o("This model inherits from "),Ln=a("a"),Qr=o("PreTrainedModel"),Jr=o(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Xr=l(),Ft=a("p"),Gr=o("This model is also a PyTorch "),Mt=a("a"),Zr=o("torch.nn.Module"),ed=o(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),td=l(),N=a("div"),_(Ct.$$.fragment),nd=l(),be=a("p"),od=o("The "),wn=a("a"),sd=o("LukeForEntityClassification"),ad=o(" forward method, overrides the "),$o=a("code"),id=o("__call__"),rd=o(" special method."),dd=l(),_(Ne.$$.fragment),ld=l(),qo=a("p"),cd=o("Examples:"),pd=l(),_(Pt.$$.fragment),ps=l(),ve=a("h2"),De=a("a"),Fo=a("span"),_(jt.$$.fragment),hd=l(),Mo=a("span"),ud=o("LukeForEntityPairClassification"),hs=l(),A=a("div"),_(At.$$.fragment),md=l(),Co=a("p"),fd=o(`The LUKE model with a classification head on top (a linear layer on top of the hidden states of the two entity
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Vd=l(),B=a("div"),_(Ht.$$.fragment),Yd=l(),we=a("p"),Qd=o("The "),$n=a("a"),Jd=o("LukeForEntitySpanClassification"),Xd=o(" forward method, overrides the "),So=a("code"),Gd=o("__call__"),Zd=o(" special method."),el=l(),_(Ue.$$.fragment),tl=l(),No=a("p"),nl=o("Examples:"),ol=l(),_(Vt.$$.fragment),this.h()},l(n){const p=ip('[data-svelte="svelte-1phssyn"]',document.head);h=i(p,"META",{name:!0,content:!0}),p.forEach(t),E=c(n),m=i(n,"H1",{class:!0});var Yt=r(m);L=i(Yt,"A",{id:!0,class:!0,href:!0});var Do=r(L);w=i(Do,"SPAN",{});var Bo=r(w);k(g.$$.fragment,Bo),Bo.forEach(t),Do.forEach(t),f=c(Yt),z=i(Yt,"SPAN",{});var Wo=r(z);Ds=s(Wo,"LUKE"),Wo.forEach(t),Yt.forEach(t),Ho=c(n),le=i(n,"H2",{class:!0});var Qt=r(le);xe=i(Qt,"A",{id:!0,class:!0,href:!0});var rl=r(xe);Nn=i(rl,"SPAN",{});var dl=r(Nn);k(He.$$.fragment,dl),dl.forEach(t),rl.forEach(t),Bs=c(Qt),Dn=i(Qt,"SPAN",{});var ll=r(Dn);Ws=s(ll,"Overview"),ll.forEach(t),Qt.forEach(t),Vo=c(n),$e=i(n,"P",{});var gs=r($e);Us=s(gs,"The LUKE model was proposed in "),Ve=i(gs,"A",{href:!0,rel:!0});var cl=r(Ve);Ks=s(cl,"LUKE: Deep Contextualized Entity Representations with Entity-aware Self-attention"),cl.forEach(t),Rs=s(gs,` by Ikuya Yamada, Akari Asai, Hiroyuki Shindo, Hideaki Takeda and Yuji Matsumoto.
It is based on RoBERTa and adds entity embeddings as well as an entity-aware self-attention mechanism, which helps
improve performance on various downstream tasks involving reasoning about entities such as named entity recognition,
extractive and cloze-style question answering, entity typing, and relation classification.`),gs.forEach(t),Yo=c(n),Jt=i(n,"P",{});var pl=r(Jt);Hs=s(pl,"The abstract from the paper is the following:"),pl.forEach(t),Qo=c(n),Xt=i(n,"P",{});var hl=r(Xt);Bn=i(hl,"EM",{});var ul=r(Bn);Vs=s(ul,`Entity representations are useful in natural language tasks involving entities. In this paper, we propose new
pretrained contextualized representations of words and entities based on the bidirectional transformer. The proposed
model treats words and entities in a given text as independent tokens, and outputs contextualized representations of
them. Our model is trained using a new pretraining task based on the masked language model of BERT. The task involves
predicting randomly masked words and entities in a large entity-annotated corpus retrieved from Wikipedia. We also
...
using Wikipedia entities as input tokens, LUKE outputs token representations enriched by the information stored in
the embeddings of these entities. This is particularly effective for tasks requiring real-world knowledge, such as
question answering.`),al.forEach(t),ys.forEach(t),ks.forEach(t),Ea=c(Ke),U=i(Ke,"LI",{});var X=r(U);Zn=i(X,"P",{});var ql=r(Zn);za=s(ql,"There are three head models for the former use case:"),ql.forEach(t),xa=c(X),ce=i(X,"UL",{});var qn=r(ce);qe=i(qn,"LI",{});var Uo=r(qe);sn=i(Uo,"A",{href:!0});var Fl=r(sn);$a=s(Fl,"LukeForEntityClassification"),Fl.forEach(t),qa=s(Uo,`, for tasks to classify a single entity in an input text such as
entity typing, e.g. the `),Xe=i(Uo,"A",{href:!0,rel:!0});var Ml=r(Xe);Fa=s(Ml,"Open Entity dataset"),Ml.forEach(t),Ma=s(Uo,`.
This model places a linear head on top of the output entity representation.`),Uo.forEach(t),Ca=c(qn),Fe=i(qn,"LI",{});var Ko=r(Fe);an=i(Ko,"A",{href:!0});var Cl=r(an);Pa=s(Cl,"LukeForEntityPairClassification"),Cl.forEach(t),ja=s(Ko,`, for tasks to classify the relationship between two entities
...
model places a linear head on top of the concatenated output representation of the pair of given entities.`),Ko.forEach(t),Oa=c(qn),rn=i(qn,"LI",{});var il=r(rn);dn=i(il,"A",{href:!0});var jl=r(dn);Sa=s(jl,"LukeForEntitySpanClassification"),jl.forEach(t),Na=s(il,`, for tasks to classify the sequence of entity spans, such as
named entity recognition (NER). This model places a linear head on top of the output entity representations. You
can address NER using this model by inputting all possible entity spans in the text to the model.`),il.forEach(t),qn.forEach(t),Da=c(X),O=i(X,"P",{});var Q=r(O);ln=i(Q,"A",{href:!0});var Al=r(ln);Ba=s(Al,"LukeTokenizer"),Al.forEach(t),Wa=s(Q," has a "),eo=i(Q,"CODE",{});var Il=r(eo);Ua=s(Il,"task"),Il.forEach(t),Ka=s(Q,` argument, which enables you to easily create an input to these
...
`),oo=i(Q,"CODE",{});var Nl=r(oo);Qa=s(Nl,'task="entity_span_classification"'),Nl.forEach(t),Ja=s(Q,". Please refer to the example code of each head models."),Q.forEach(t),Xa=c(X),pe=i(X,"P",{});var Fn=r(pe);Ga=s(Fn,"A demo notebook on how to fine-tune "),cn=i(Fn,"A",{href:!0});var Dl=r(cn);Za=s(Dl,"LukeForEntityPairClassification"),Dl.forEach(t),ei=s(Fn,` for relation
classification can be found `),Ze=i(Fn,"A",{href:!0,rel:!0});var Bl=r(Ze);ti=s(Bl,"here"),Bl.forEach(t),ni=s(Fn,"."),Fn.forEach(t),oi=c(X),et=i(X,"P",{});var bs=r(et);si=s(bs,`There are also 3 notebooks available, which showcase how you can reproduce the results as reported in the paper with
the HuggingFace implementation of LUKE. They can be found `),tt=i(bs,"A",{href:!0,rel:!0});var Wl=r(tt);ai=s(Wl,"here"),Wl.forEach(t),ii=s(bs,"."),bs.forEach(t),X.forEach(t),Ke.forEach(t),Go=c(n),pn=i(n,"P",{});var Ul=r(pn);ri=s(Ul,"Example:"),Ul.forEach(t),Zo=c(n),k(nt.$$.fragment,n),es=c(n),V=i(n,"P",{});var Re=r(V);di=s(Re,"This model was contributed by "),ot=i(Re,"A",{href:!0,rel:!0});var Kl=r(ot);li=s(Kl,"ikuyamada"),Kl.forEach(t),ci=s(Re," and "),st=i(Re,"A",{href:!0,rel:!0});var Rl=r(st);pi=s(Rl,"nielsr"),Rl.forEach(t),hi=s(Re,". The original code can be found "),at=i(Re,"A",{href:!0,rel:!0});var Hl=r(at);ui=s(Hl,"here"),Hl.forEach(t),mi=s(Re,"."),Re.forEach(t),ts=c(n),he=i(n,"H2",{class:!0});var vs=r(he);Me=i(vs,"A",{id:!0,class:!0,href:!0});var Vl=r(Me);so=i(Vl,"SPAN",{});var Yl=r(so);k(it.$$.fragment,Yl),Yl.forEach(t),Vl.forEach(t),fi=c(vs),ao=i(vs,"SPAN",{});var Ql=r(ao);gi=s(Ql,"LukeConfig"),Ql.forEach(t),vs.forEach(t),ns=c(n),F=i(n,"DIV",{class:!0});var G=r(F);k(rt.$$.fragment,G),_i=c(G),dt=i(G,"P",{});var Ts=r(dt);ki=s(Ts,"This is the configuration class to store the configuration of a "),hn=i(Ts,"A",{href:!0});var Jl=r(hn);yi=s(Jl,"LukeModel"),Jl.forEach(t),bi=s(Ts,`. It is used to instantiate a LUKE
...
documentation from `),mn=i(Mn,"A",{href:!0});var Gl=r(mn);Ei=s(Gl,"PretrainedConfig"),Gl.forEach(t),zi=s(Mn," for more information."),Mn.forEach(t),xi=c(G),io=i(G,"P",{});var Zl=r(io);$i=s(Zl,"Examples:"),Zl.forEach(t),qi=c(G),k(lt.$$.fragment,G),G.forEach(t),os=c(n),me=i(n,"H2",{class:!0});var Ls=r(me);Ce=i(Ls,"A",{id:!0,class:!0,href:!0});var ec=r(Ce);ro=i(ec,"SPAN",{});var tc=r(ro);k(ct.$$.fragment,tc),tc.forEach(t),ec.forEach(t),Fi=c(Ls),lo=i(Ls,"SPAN",{});var nc=r(lo);Mi=s(nc,"LukeTokenizer"),nc.forEach(t),Ls.forEach(t),ss=c(n),M=i(n,"DIV",{class:!0});var Z=r(M);k(pt.$$.fragment,Z),Ci=c(Z),co=i(Z,"P",{});var oc=r(co);Pi=s(oc,"Construct a LUKE tokenizer."),oc.forEach(t),ji=c(Z),x=i(Z,"P",{});var $=r(x);Ai=s($,"This tokenizer inherits from "),fn=i($,"A",{href:!0});var sc=r(fn);Ii=s(sc,"RobertaTokenizer"),sc.forEach(t),Oi=s($,` which contains most of the main methods. Users should refer to
this superclass for more information regarding those methods. Compared to `),gn=i($,"A",{href:!0});var ac=r(gn);Si=s(ac,"RobertaTokenizer"),ac.forEach(t),Ni=s($,", "),_n=i($,"A",{href:!0});var ic=r(_n);Di=s(ic,"LukeTokenizer"),ic.forEach(t),Bi=s($,`
also creates entity sequences, namely `),po=i($,"CODE",{});var rc=r(po);Wi=s(rc,"entity_ids"),rc.forEach(t),Ui=s($,", "),ho=i($,"CODE",{});var dc=r(ho);Ki=s(dc,"entity_attention_mask"),dc.forEach(t),Ri=s($,", "),uo=i($,"CODE",{});var lc=r(uo);Hi=s(lc,"entity_token_type_ids"),lc.forEach(t),Vi=s($,`, and
...
masked entity prediction.`),Ec.forEach(t),xr=c(ne),Lt=i(ne,"P",{});var qs=r(Lt);$r=s(qs,"This model inherits from "),vn=i(qs,"A",{href:!0});var zc=r(vn);qr=s(zc,"PreTrainedModel"),zc.forEach(t),Fr=s(qs,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),qs.forEach(t),Mr=c(ne),wt=i(ne,"P",{});var Fs=r(wt);Cr=s(Fs,"This model is also a PyTorch "),Et=i(Fs,"A",{href:!0,rel:!0});var xc=r(Et);Pr=s(xc,"torch.nn.Module"),xc.forEach(t),jr=s(Fs,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Fs.forEach(t),Ar=c(ne),J=i(ne,"DIV",{class:!0});var Pn=r(J);k(zt.$$.fragment,Pn),Ir=c(Pn),ke=i(Pn,"P",{});var jn=r(ke);Or=s(jn,"The "),Tn=i(jn,"A",{href:!0});var $c=r(Tn);Sr=s($c,"LukeForMaskedLM"),$c.forEach(t),Nr=s(jn," forward method, overrides the "),wo=i(jn,"CODE",{});var qc=r(wo);Dr=s(qc,"__call__"),qc.forEach(t),Br=s(jn," special method."),jn.forEach(t),Wr=c(Pn),k(Oe.$$.fragment,Pn),Pn.forEach(t),ne.forEach(t),ls=c(n),ye=i(n,"H2",{class:!0});var Ms=r(ye);Se=i(Ms,"A",{id:!0,class:!0,href:!0});var Fc=r(Se);Eo=i(Fc,"SPAN",{});var Mc=r(Eo);k(xt.$$.fragment,Mc),Mc.forEach(t),Fc.forEach(t),Ur=c(Ms),zo=i(Ms,"SPAN",{});var Cc=r(zo);Kr=s(Cc,"LukeForEntityClassification"),Cc.forEach(t),Ms.forEach(t),cs=c(n),j=i(n,"DIV",{class:!0});var oe=r(j);k($t.$$.fragment,oe),Rr=c(oe),xo=i(oe,"P",{});var Pc=r(xo);Hr=s(Pc,`The LUKE model with a classification head on top (a linear layer on top of the hidden state of the first entity
token) for entity classification tasks, such as Open Entity.`),Pc.forEach(t),Vr=c(oe),qt=i(oe,"P",{});var Cs=r(qt);Yr=s(Cs,"This model inherits from "),Ln=i(Cs,"A",{href:!0});var jc=r(Ln);Qr=s(jc,"PreTrainedModel"),jc.forEach(t),Jr=s(Cs,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Cs.forEach(t),Xr=c(oe),Ft=i(oe,"P",{});var Ps=r(Ft);Gr=s(Ps,"This model is also a PyTorch "),Mt=i(Ps,"A",{href:!0,rel:!0});var Ac=r(Mt);Zr=s(Ac,"torch.nn.Module"),Ac.forEach(t),ed=s(Ps,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Ps.forEach(t),td=c(oe),N=i(oe,"DIV",{class:!0});var se=r(N);k(Ct.$$.fragment,se),nd=c(se),be=i(se,"P",{});var An=r(be);od=s(An,"The "),wn=i(An,"A",{href:!0});var Ic=r(wn);sd=s(Ic,"LukeForEntityClassification"),Ic.forEach(t),ad=s(An," forward method, overrides the "),$o=i(An,"CODE",{});var Oc=r($o);id=s(Oc,"__call__"),Oc.forEach(t),rd=s(An," special method."),An.forEach(t),dd=c(se),k(Ne.$$.fragment,se),ld=c(se),qo=i(se,"P",{});var Sc=r(qo);cd=s(Sc,"Examples:"),Sc.forEach(t),pd=c(se),k(Pt.$$.fragment,se),se.forEach(t),oe.forEach(t),ps=c(n),ve=i(n,"H2",{class:!0});var js=r(ve);De=i(js,"A",{id:!0,class:!0,href:!0});var Nc=r(De);Fo=i(Nc,"SPAN",{});var Dc=r(Fo);k(jt.$$.fragment,Dc),Dc.forEach(t),Nc.forEach(t),hd=c(js),Mo=i(js,"SPAN",{});var Bc=r(Mo);ud=s(Bc,"LukeForEntityPairClassification"),Bc.forEach(t),js.forEach(t),hs=c(n),A=i(n,"DIV",{class:!0});var ae=r(A);k(At.$$.fragment,ae),md=c(ae),Co=i(ae,"P",{});var Wc=r(Co);fd=s(Wc,`The LUKE model with a classification head on top (a linear layer on top of the hidden states of the two entity
tokens) for entity pair classification tasks, such as TACRED.`),Wc.forEach(t),gd=c(ae),It=i(ae,"P",{});var As=r(It);_d=s(As,"This model inherits from "),En=i(As,"A",{href:!0});var Uc=r(En);kd=s(Uc,"PreTrainedModel"),Uc.forEach(t),yd=s(As,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
