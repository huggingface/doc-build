import{S as Bf,i as zf,s as xf,e as n,k as i,w as _,t as r,M as Ff,c as a,d as t,m as l,a as s,x as g,h as d,b as c,F as e,g as p,y as b,q as k,o as y,B as v}from"../../chunks/vendor-6b77c823.js";import{T as ho}from"../../chunks/Tip-39098574.js";import{D as P}from"../../chunks/Docstring-abef54e3.js";import{C as Ke}from"../../chunks/CodeBlock-3a8b25a8.js";import{I as pe}from"../../chunks/IconCopyLink-7a11ce68.js";function $f(D){let u,x,f,T,z;return{c(){u=n("p"),x=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=n("code"),T=r("Module"),z=r(`
...
first positional argument :`),we.forEach(t),R=l(m),M=a(m,"UL",{});var K=s(M);C=a(K,"LI",{});var V=s(C);Pe=d(V,"a single Tensor with "),J=a(V,"CODE",{});var ut=s(J);Q=d(ut,"input_ids"),ut.forEach(t),Oe=d(V," only and nothing else: "),W=a(V,"CODE",{});var Je=s(W);Ne=d(Je,"model(input_ids)"),Je.forEach(t),V.forEach(t),Ae=l(K),N=a(K,"LI",{});var A=s(N);ue=d(A,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),ae=a(A,"CODE",{});var Be=s(ae);$e=d(Be,"model([input_ids, attention_mask])"),Be.forEach(t),me=d(A," or "),H=a(A,"CODE",{});var mt=s(H);Ie=d(mt,"model([input_ids, attention_mask, token_type_ids])"),mt.forEach(t),A.forEach(t),qe=l(K),E=a(K,"LI",{});var se=s(E);Le=d(se,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),U=a(se,"CODE",{});var ft=s(U);Se=d(ft,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),ft.forEach(t),se.forEach(t),K.forEach(t)},m(m,$){p(m,u,$),e(u,x),p(m,f,$),p(m,T,$),e(T,z),e(z,B),e(T,w),e(T,F),e(F,Ee),p(m,he,$),p(m,q,$),e(q,ye),e(q,te),e(te,Ce),e(q,oe),e(q,ne),e(ne,je),e(q,Fe),p(m,G,$),p(m,O,$),e(O,ve),p(m,R,$),p(m,M,$),e(M,C),e(C,Pe),e(C,J),e(J,Q),e(C,Oe),e(C,W),e(W,Ne),e(M,Ae),e(M,N),e(N,ue),e(N,ae),e(ae,$e),e(N,me),e(N,H),e(H,Ie),e(M,qe),e(M,E),e(E,Le),e(E,U),e(U,Se)},d(m){m&&t(u),m&&t(f),m&&t(T),m&&t(he),m&&t(q),m&&t(G),m&&t(O),m&&t(R),m&&t(M)}}}function jf(D){let u,x,f,T,z;return{c(){u=n("p"),x=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=n("code"),T=r("Module"),z=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(B){u=a(B,"P",{});var w=s(u);x=d(w,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=a(w,"CODE",{});var F=s(f);T=d(F,"Module"),F.forEach(t),z=d(w,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
`),Un=n("a"),Ld=r("BlenderbotSmall"),Sd=r("."),Tr=i(),_t=n("h2"),Nt=n("a"),Ea=n("span"),_(fo.$$.fragment),Dd=i(),Ca=n("span"),Gd=r("Usage"),wr=i(),Rn=n("p"),Wd=r("Here is an example of model usage:"),Br=i(),_(_o.$$.fragment),zr=i(),gt=n("h2"),At=n("a"),ja=n("span"),_(go.$$.fragment),Ud=i(),Pa=n("span"),Rd=r("BlenderbotConfig"),xr=i(),re=n("div"),_(bo.$$.fragment),Hd=i(),bt=n("p"),Kd=r("This is the configuration class to store the configuration of a "),Hn=n("a"),Vd=r("BlenderbotModel"),Jd=r(`. It is used to instantiate an
...
documentation from `),Vn=n("a"),oi=r("PretrainedConfig"),ni=r(" for more information."),ai=i(),Oa=n("p"),si=r("Example:"),ri=i(),_(yo.$$.fragment),Fr=i(),yt=n("h2"),It=n("a"),Na=n("span"),_(vo.$$.fragment),di=i(),Aa=n("span"),ii=r("BlenderbotTokenizer"),$r=i(),de=n("div"),_(To.$$.fragment),li=i(),Ia=n("p"),ci=r("Construct a Blenderbot tokenizer."),pi=i(),Lt=n("p"),La=n("code"),hi=r("Blenderbot"),ui=r(" is nearly identical to "),Jn=n("a"),mi=r("RobertaTokenizer"),fi=r(` and runs end-to-end tokenization: punctuation splitting
and wordpiece. The only difference is that it doesn\u2019t add BOS token to the beginning of sequences.`),_i=i(),wo=n("p"),gi=r("Refer to superclass "),Qn=n("a"),bi=r("RobertaTokenizer"),ki=r(" for usage examples and documentation concerning parameters."),yi=i(),Qe=n("div"),_(Bo.$$.fragment),vi=i(),Sa=n("p"),Ti=r(`Build model inputs from a sequence or a pair of sequence for sequence classification tasks by concatenating and
adding special tokens. A Blenderbot sequence has the following format:`),wi=i(),Da=n("ul"),Xn=n("li"),Bi=r("single sequence: "),Ga=n("code"),zi=r("X </s>"),qr=i(),vt=n("h2"),St=n("a"),Wa=n("span"),_(zo.$$.fragment),xi=i(),Ua=n("span"),Fi=r("BlenderbotTokenizerFast"),Mr=i(),ie=n("div"),_(xo.$$.fragment),$i=i(),Fo=n("p"),qi=r("Construct a \u201Cfast\u201D Blenderbot tokenizer (backed by HuggingFace\u2019s "),Ra=n("em"),Mi=r("tokenizers"),Ei=r(" library)."),Ci=i(),Dt=n("p"),Ha=n("code"),ji=r("BlenderbotFast"),Pi=r(" is nearly identical to "),Yn=n("a"),Oi=r("RobertaTokenizerFast"),Ni=r(` and runs end-to-end tokenization: punctuation
splitting and wordpiece. The only difference is that it doesn\u2019t add BOS token to the beginning of sequences.`),Ai=i(),$o=n("p"),Ii=r("Refer to superclass "),Zn=n("a"),Li=r("RobertaTokenizerFast"),Si=r(" for usage examples and documentation concerning parameters."),Di=i(),Xe=n("div"),_(qo.$$.fragment),Gi=i(),Ka=n("p"),Wi=r(`Build model inputs from a sequence or a pair of sequence for sequence classification tasks by concatenating and
adding special tokens. A Blenderbot sequence has the following format:`),Ui=i(),Va=n("ul"),ea=n("li"),Ri=r("single sequence: "),Ja=n("code"),Hi=r("X </s>"),Er=i(),Tt=n("h2"),Gt=n("a"),Qa=n("span"),_(Mo.$$.fragment),Ki=i(),Xa=n("span"),Vi=r("BlenderbotModel"),Cr=i(),We=n("p"),Ji=r("See "),Ya=n("code"),Qi=r("transformers.BartModel"),Xi=r(" for arguments to "),Za=n("em"),Yi=r("forward"),Zi=r(" and "),es=n("em"),el=r("generate"),jr=i(),ze=n("div"),_(Eo.$$.fragment),tl=i(),Co=n("p"),ol=r(`The bare Blenderbot Model outputting raw hidden-states without any specific head on top.
...
and behavior.`),ll=i(),_e=n("div"),_(Oo.$$.fragment),cl=i(),wt=n("p"),pl=r("The "),oa=n("a"),hl=r("BlenderbotModel"),ul=r(" forward method, overrides the "),ts=n("code"),ml=r("__call__"),fl=r(" special method."),_l=i(),_(Wt.$$.fragment),gl=i(),os=n("p"),bl=r("Example:"),kl=i(),_(No.$$.fragment),Pr=i(),Bt=n("h2"),Ut=n("a"),ns=n("span"),_(Ao.$$.fragment),yl=i(),as=n("span"),vl=r("BlenderbotForConditionalGeneration"),Or=i(),Ue=n("p"),Tl=r("See "),na=n("a"),wl=r("BartForConditionalGeneration"),Bl=r(" for arguments to "),ss=n("em"),zl=r("forward"),xl=r(" and "),rs=n("em"),Fl=r("generate"),Nr=i(),xe=n("div"),_(Io.$$.fragment),$l=i(),Lo=n("p"),ql=r(`The Blenderbot Model with a language modeling head. Can be used for summarization.
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Nl=i(),ge=n("div"),_(Go.$$.fragment),Al=i(),zt=n("p"),Il=r("The "),sa=n("a"),Ll=r("BlenderbotForConditionalGeneration"),Sl=r(" forward method, overrides the "),ds=n("code"),Dl=r("__call__"),Gl=r(" special method."),Wl=i(),_(Rt.$$.fragment),Ul=i(),is=n("p"),Rl=r("Conversation example:"),Hl=i(),_(Wo.$$.fragment),Ar=i(),xt=n("h2"),Ht=n("a"),ls=n("span"),_(Uo.$$.fragment),Kl=i(),cs=n("span"),Vl=r("BlenderbotForCausalLM"),Ir=i(),Ft=n("div"),_(Ro.$$.fragment),Jl=i(),Ye=n("div"),_(Ho.$$.fragment),Ql=i(),ps=n("p"),Xl=r("Example:"),Yl=i(),_(Ko.$$.fragment),Lr=i(),$t=n("h2"),Kt=n("a"),hs=n("span"),_(Vo.$$.fragment),Zl=i(),us=n("span"),ec=r("TFBlenderbotModel"),Sr=i(),le=n("div"),_(Jo.$$.fragment),tc=i(),Qo=n("p"),oc=r(`The bare BLENDERBOT Model outputting raw hidden-states without any specific head on top.
...
behavior.`),lc=i(),_(Vt.$$.fragment),cc=i(),be=n("div"),_(Zo.$$.fragment),pc=i(),qt=n("p"),hc=r("The "),da=n("a"),uc=r("TFBlenderbotModel"),mc=r(" forward method, overrides the "),ms=n("code"),fc=r("__call__"),_c=r(" special method."),gc=i(),_(Jt.$$.fragment),bc=i(),fs=n("p"),kc=r("Example:"),yc=i(),_(en.$$.fragment),Dr=i(),Mt=n("h2"),Qt=n("a"),_s=n("span"),_(tn.$$.fragment),vc=i(),gs=n("span"),Tc=r("TFBlenderbotForConditionalGeneration"),Gr=i(),ce=n("div"),_(on.$$.fragment),wc=i(),nn=n("p"),Bc=r(`The BLENDERBOT Model with a language modeling head. Can be used for summarization.
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Ec=i(),_(Xt.$$.fragment),Cc=i(),X=n("div"),_(rn.$$.fragment),jc=i(),Et=n("p"),Pc=r("The "),la=n("a"),Oc=r("TFBlenderbotForConditionalGeneration"),Nc=r(" forward method, overrides the "),bs=n("code"),Ac=r("__call__"),Ic=r(" special method."),Lc=i(),_(Yt.$$.fragment),Sc=i(),ks=n("p"),Dc=r("Conversation example::"),Gc=i(),ys=n("blockquote"),vs=n("blockquote"),Ts=n("blockquote"),ws=n("p"),Wc=r(`from transformers import BlenderbotTokenizer, TFBlenderbotForConditionalGeneration >>> mname =
...
skip_special_tokens=True)[0])`),Wr=i(),Ct=n("h2"),Zt=n("a"),$s=n("span"),_(ln.$$.fragment),Vc=i(),qs=n("span"),Jc=r("FlaxBlenderbotModel"),Ur=i(),I=n("div"),_(cn.$$.fragment),Qc=i(),pn=n("p"),Xc=r(`The bare MBart Model transformer outputting raw hidden-states without any specific head on top.
...
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),ap=i(),Ms=n("p"),sp=r("Finally, this model supports inherent JAX features such as:"),rp=i(),Re=n("ul"),Es=n("li"),mn=n("a"),dp=r("Just-In-Time (JIT) compilation"),ip=i(),Cs=n("li"),fn=n("a"),lp=r("Automatic Differentiation"),cp=i(),js=n("li"),_n=n("a"),pp=r("Vectorization"),hp=i(),Ps=n("li"),gn=n("a"),up=r("Parallelization"),mp=i(),ke=n("div"),_(bn.$$.fragment),fp=i(),jt=n("p"),_p=r("The "),Os=n("code"),gp=r("FlaxBlenderbotPreTrainedModel"),bp=r("forward method, overrides the "),Ns=n("code"),kp=r("__call__"),yp=r(" special method."),vp=i(),_(eo.$$.fragment),Tp=i(),As=n("p"),wp=r("Example:"),Bp=i(),_(kn.$$.fragment),zp=i(),Ze=n("div"),_(yn.$$.fragment),xp=i(),Is=n("p"),Fp=r("Example:"),$p=i(),_(vn.$$.fragment),qp=i(),et=n("div"),_(Tn.$$.fragment),Mp=i(),Ls=n("p"),Ep=r("Example:"),Cp=i(),_(wn.$$.fragment),Rr=i(),Pt=n("h2"),to=n("a"),Ss=n("span"),_(Bn.$$.fragment),jp=i(),Ds=n("span"),Pp=r("FlaxBlenderbotForConditionalGeneration"),Hr=i(),L=n("div"),_(zn.$$.fragment),Op=i(),xn=n("p"),Np=r(`The Blenderbot Model with a language modeling head. Can be used for summarization.
...
max_length=1024, return_tensors=\u2018np\u2019)`),fh=i(),ir=n("blockquote"),lr=n("blockquote"),Pn=n("blockquote"),no=n("h1"),ao=n("a"),cr=n("span"),_(On.$$.fragment),_h=i(),pr=n("span"),gh=r("Generate Reply >>> reply_ids = model.generate(inputs[\u2018input_ids\u2019], num_beams=4, max_length=5,"),bh=i(),hr=n("p"),kh=r(`early_stopping=True).sequences >>> print([tokenizer.decode(g, skip_special_tokens=True,
clean_up_tokenization_spaces=False) for g in reply_ids])`),yh=i(),tt=n("div"),_(Nn.$$.fragment),vh=i(),ur=n("p"),Th=r("Example:"),wh=i(),_(An.$$.fragment),Bh=i(),ot=n("div"),_(In.$$.fragment),zh=i(),mr=n("p"),xh=r("Example:"),Fh=i(),_(Ln.$$.fragment),this.h()},l(o){const h=Ff('[data-svelte="svelte-1phssyn"]',document.head);u=a(h,"META",{name:!0,content:!0}),h.forEach(t),x=l(o),f=a(o,"H1",{class:!0});var Sn=s(f);T=a(Sn,"A",{id:!0,class:!0,href:!0});var fr=s(T);z=a(fr,"SPAN",{});var _r=s(z);g(B.$$.fragment,_r),_r.forEach(t),fr.forEach(t),w=l(Sn),F=a(Sn,"SPAN",{});var gr=s(F);Ee=d(gr,"Blenderbot"),gr.forEach(t),Sn.forEach(t),he=l(o),q=a(o,"P",{});var so=s(q);ye=a(so,"STRONG",{});var br=s(ye);te=d(br,"DISCLAIMER:"),br.forEach(t),Ce=d(so," If you see something strange, file a "),oe=a(so,"A",{href:!0,rel:!0});var kr=s(oe);ne=d(kr,"Github Issue"),kr.forEach(t),je=d(so," ."),so.forEach(t),Fe=l(o),G=a(o,"H2",{class:!0});var Dn=s(G);O=a(Dn,"A",{id:!0,class:!0,href:!0});var Mh=s(O);ve=a(Mh,"SPAN",{});var Eh=s(ve);g(R.$$.fragment,Eh),Eh.forEach(t),Mh.forEach(t),M=l(Dn),C=a(Dn,"SPAN",{});var Ch=s(C);Pe=d(Ch,"Overview"),Ch.forEach(t),Dn.forEach(t),J=l(o),Q=a(o,"P",{});var Vr=s(Q);Oe=d(Vr,"The Blender chatbot model was proposed in "),W=a(Vr,"A",{href:!0,rel:!0});var jh=s(W);Ne=d(jh,"Recipes for building an open-domain chatbot"),jh.forEach(t),Ae=d(Vr,` Stephen Roller, Emily Dinan, Naman Goyal, Da Ju, Mary Williamson, Yinhan Liu,
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),dd.forEach(t),ll=l(io),_e=a(io,"DIV",{class:!0});var rt=s(_e);g(Oo.$$.fragment,rt),cl=l(rt),wt=a(rt,"P",{});var ba=s(wt);pl=d(ba,"The "),oa=a(ba,"A",{href:!0});var ju=s(oa);hl=d(ju,"BlenderbotModel"),ju.forEach(t),ul=d(ba," forward method, overrides the "),ts=a(ba,"CODE",{});var Pu=s(ts);ml=d(Pu,"__call__"),Pu.forEach(t),fl=d(ba," special method."),ba.forEach(t),_l=l(rt),g(Wt.$$.fragment,rt),gl=l(rt),os=a(rt,"P",{});var Ou=s(os);bl=d(Ou,"Example:"),Ou.forEach(t),kl=l(rt),g(No.$$.fragment,rt),rt.forEach(t),io.forEach(t),Pr=l(o),Bt=a(o,"H2",{class:!0});var id=s(Bt);Ut=a(id,"A",{id:!0,class:!0,href:!0});var Nu=s(Ut);ns=a(Nu,"SPAN",{});var Au=s(ns);g(Ao.$$.fragment,Au),Au.forEach(t),Nu.forEach(t),yl=l(id),as=a(id,"SPAN",{});var Iu=s(as);vl=d(Iu,"BlenderbotForConditionalGeneration"),Iu.forEach(t),id.forEach(t),Or=l(o),Ue=a(o,"P",{});var Wn=s(Ue);Tl=d(Wn,"See "),na=a(Wn,"A",{href:!0});var Lu=s(na);wl=d(Lu,"BartForConditionalGeneration"),Lu.forEach(t),Bl=d(Wn," for arguments to "),ss=a(Wn,"EM",{});var Su=s(ss);zl=d(Su,"forward"),Su.forEach(t),xl=d(Wn," and "),rs=a(Wn,"EM",{});var Du=s(rs);Fl=d(Du,"generate"),Du.forEach(t),Wn.forEach(t),Nr=l(o),xe=a(o,"DIV",{class:!0});var lo=s(xe);g(Io.$$.fragment,lo),$l=l(lo),Lo=a(lo,"P",{});var ld=s(Lo);ql=d(ld,`The Blenderbot Model with a language modeling head. Can be used for summarization.
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),cd.forEach(t),Nl=l(lo),ge=a(lo,"DIV",{class:!0});var dt=s(ge);g(Go.$$.fragment,dt),Al=l(dt),zt=a(dt,"P",{});var ka=s(zt);Il=d(ka,"The "),sa=a(ka,"A",{href:!0});var Uu=s(sa);Ll=d(Uu,"BlenderbotForConditionalGeneration"),Uu.forEach(t),Sl=d(ka," forward method, overrides the "),ds=a(ka,"CODE",{});var Ru=s(ds);Dl=d(Ru,"__call__"),Ru.forEach(t),Gl=d(ka," special method."),ka.forEach(t),Wl=l(dt),g(Rt.$$.fragment,dt),Ul=l(dt),is=a(dt,"P",{});var Hu=s(is);Rl=d(Hu,"Conversation example:"),Hu.forEach(t),Hl=l(dt),g(Wo.$$.fragment,dt),dt.forEach(t),lo.forEach(t),Ar=l(o),xt=a(o,"H2",{class:!0});var pd=s(xt);Ht=a(pd,"A",{id:!0,class:!0,href:!0});var Ku=s(Ht);ls=a(Ku,"SPAN",{});var Vu=s(ls);g(Uo.$$.fragment,Vu),Vu.forEach(t),Ku.forEach(t),Kl=l(pd),cs=a(pd,"SPAN",{});var Ju=s(cs);Vl=d(Ju,"BlenderbotForCausalLM"),Ju.forEach(t),pd.forEach(t),Ir=l(o),Ft=a(o,"DIV",{class:!0});var hd=s(Ft);g(Ro.$$.fragment,hd),Jl=l(hd),Ye=a(hd,"DIV",{class:!0});var ya=s(Ye);g(Ho.$$.fragment,ya),Ql=l(ya),ps=a(ya,"P",{});var Qu=s(ps);Xl=d(Qu,"Example:"),Qu.forEach(t),Yl=l(ya),g(Ko.$$.fragment,ya),ya.forEach(t),hd.forEach(t),Lr=l(o),$t=a(o,"H2",{class:!0});var ud=s($t);Kt=a(ud,"A",{id:!0,class:!0,href:!0});var Xu=s(Kt);hs=a(Xu,"SPAN",{});var Yu=s(hs);g(Vo.$$.fragment,Yu),Yu.forEach(t),Xu.forEach(t),Zl=l(ud),us=a(ud,"SPAN",{});var Zu=s(us);ec=d(Zu,"TFBlenderbotModel"),Zu.forEach(t),ud.forEach(t),Sr=l(o),le=a(o,"DIV",{class:!0});var it=s(le);g(Jo.$$.fragment,it),tc=l(it),Qo=a(it,"P",{});var md=s(Qo);oc=d(md,`The bare BLENDERBOT Model outputting raw hidden-states without any specific head on top.
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),fd.forEach(t),lc=l(it),g(Vt.$$.fragment,it),cc=l(it),be=a(it,"DIV",{class:!0});var lt=s(be);g(Zo.$$.fragment,lt),pc=l(lt),qt=a(lt,"P",{});var va=s(qt);hc=d(va,"The "),da=a(va,"A",{href:!0});var om=s(da);uc=d(om,"TFBlenderbotModel"),om.forEach(t),mc=d(va," forward method, overrides the "),ms=a(va,"CODE",{});var nm=s(ms);fc=d(nm,"__call__"),nm.forEach(t),_c=d(va," special method."),va.forEach(t),gc=l(lt),g(Jt.$$.fragment,lt),bc=l(lt),fs=a(lt,"P",{});var am=s(fs);kc=d(am,"Example:"),am.forEach(t),yc=l(lt),g(en.$$.fragment,lt),lt.forEach(t),it.forEach(t),Dr=l(o),Mt=a(o,"H2",{class:!0});var _d=s(Mt);Qt=a(_d,"A",{id:!0,class:!0,href:!0});var sm=s(Qt);_s=a(sm,"SPAN",{});var rm=s(_s);g(tn.$$.fragment,rm),rm.forEach(t),sm.forEach(t),vc=l(_d),gs=a(_d,"SPAN",{});var dm=s(gs);Tc=d(dm,"TFBlenderbotForConditionalGeneration"),dm.forEach(t),_d.forEach(t),Gr=l(o),ce=a(o,"DIV",{class:!0});var ct=s(ce);g(on.$$.fragment,ct),wc=l(ct),nn=a(ct,"P",{});var gd=s(nn);Bc=d(gd,`The BLENDERBOT Model with a language modeling head. Can be used for summarization.
...
next_reply_ids = model.generate(**inputs) >>> print(\u201CBot: \u201D, tokenizer.batch_decode(next_reply_ids,
skip_special_tokens=True)[0])`),kd.forEach(t),km.forEach(t),bm.forEach(t),gm.forEach(t),Me.forEach(t),ct.forEach(t),Wr=l(o),Ct=a(o,"H2",{class:!0});var yd=s(Ct);Zt=a(yd,"A",{id:!0,class:!0,href:!0});var vm=s(Zt);$s=a(vm,"SPAN",{});var Tm=s($s);g(ln.$$.fragment,Tm),Tm.forEach(t),vm.forEach(t),Vc=l(yd),qs=a(yd,"SPAN",{});var wm=s(qs);Jc=d(wm,"FlaxBlenderbotModel"),wm.forEach(t),yd.forEach(t),Ur=l(o),I=a(o,"DIV",{class:!0});var Y=s(I);g(cn.$$.fragment,Y),Qc=l(Y),pn=a(Y,"P",{});var vd=s(pn);Xc=d(vd,`The bare MBart Model transformer outputting raw hidden-states without any specific head on top.
