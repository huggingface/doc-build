...
the latter silently ignores them.`)},l(g){h=i(g,"P",{});var f=r(h);E=s(f,"Although the recipe for forward pass needs to be defined within this function, one should call the "),m=i(f,"CODE",{});var z=r(m);w=s(z,"Module"),z.forEach(t),L=s(f,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),f.forEach(t)},m(g,f){u(g,h,f),e(h,E),e(h,m),e(m,w),e(h,L)},d(g){g&&t(h)}}}function up(K){let h,E,m,w,L,g,f,z,Ds,Vo,le,xe,Nn,Ve,Ws,Dn,Us,Ho,$e,Bs,He,Ks,Rs,Yo,Jt,Vs,Qo,Xt,Wn,Hs,Jo,Gt,Ys,Xo,R,Un,Ye,Qs,Zt,Js,Xs,Gs,Bn,F,Zs,Kn,ea,ta,Rn,na,oa,Vn,sa,aa,Hn,ia,ra,en,da,la,ca,Qe,V,tn,pa,ha,Yn,ua,ma,Qn,fa,ga,Jn,_a,ka,ya,Je,nn,Xn,ba,va,Ta,on,Gn,wa,La,Ea,B,Zn,za,xa,ce,Fe,sn,$a,Fa,Xe,qa,Ca,Ma,qe,an,Pa,ja,Ge,Aa,Ia,Oa,rn,dn,Sa,Na,Da,O,ln,Wa,Ua,eo,Ba,Ka,to,Ra,Va,no,Ha,Ya,oo,Qa,Ja,Xa,pe,Ga,cn,Za,ei,Ze,ti,ni,oi,et,si,tt,ai,ii,Go,pn,ri,Zo,nt,es,H,di,ot,li,ci,st,pi,hi,at,ui,mi,ts,he,Ce,so,it,fi,ao,gi,ns,q,rt,_i,dt,ki,hn,yi,bi,vi,ue,Ti,un,wi,Li,mn,Ei,zi,xi,io,$i,Fi,lt,os,me,Me,ro,ct,qi,lo,Ci,ss,C,pt,Mi,co,Pi,ji,x,Ai,fn,Ii,Oi,gn,Si,Ni,_n,Di,Wi,po,Ui,Bi,ho,Ki,Ri,uo,Vi,Hi,mo,Yi,Qi,Ji,Pe,ht,Xi,fo,Gi,Zi,kn,ut,as,fe,je,go,mt,er,_o,tr,is,M,ft,nr,ko,or,sr,gt,ar,yn,ir,rr,dr,_t,lr,kt,cr,pr,hr,S,yt,ur,ge,mr,bn,fr,gr,yo,_r,kr,yr,Ae,br,bo,vr,Tr,bt,rs,_e,Ie,vo,vt,wr,To,Lr,ds,P,Tt,Er,wo,zr,xr,wt,$r,vn,Fr,qr,Cr,Lt,Mr,Et,Pr,jr,Ar,J,zt,Ir,ke,Or,Tn,Sr,Nr,Lo,Dr,Wr,Ur,Oe,ls,ye,Se,Eo,xt,Br,zo,Kr,cs,j,$t,Rr,xo,Vr,Hr,Ft,Yr,wn,Qr,Jr,Xr,qt,Gr,Ct,Zr,ed,td,N,Mt,nd,be,od,Ln,sd,ad,$o,id,rd,dd,Ne,ld,Fo,cd,pd,Pt,ps,ve,De,qo,jt,hd,Co,ud,hs,A,At,md,Mo,fd,gd,It,_d,En,kd,yd,bd,Ot,vd,St,Td,wd,Ld,D,Nt,Ed,Te,zd,zn,xd,$d,Po,Fd,qd,Cd,We,Md,jo,Pd,jd,Dt,us,we,Ue,Ao,Wt,Ad,Io,Id,ms,I,Ut,Od,Oo,Sd,Nd,Bt,Dd,xn,Wd,Ud,Bd,Kt,Kd,Rt,Rd,Vd,Hd,W,Vt,Yd,Le,Qd,$n,Jd,Xd,So,Gd,Zd,el,Be,tl,No,nl,ol,Ht,fs;return g=new ze({}),Ve=new ze({}),nt=new Sn({props:{code:`from transformers import LukeTokenizer, LukeModel, LukeForEntityPairClassification
...
model. Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/main/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),Vt=new U({props:{name:"forward",anchor:"transformers.LukeForEntitySpanClassification.forward",parameters:[{name:"input_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"position_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"entity_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"entity_attention_mask",val:": typing.Optional[torch.LongTensor] = None"},{name:"entity_token_type_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"entity_position_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"entity_start_positions",val:": typing.Optional[torch.LongTensor] = None"},{name:"entity_end_positions",val:": typing.Optional[torch.LongTensor] = None"},{name:"head_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"labels",val:": typing.Optional[torch.LongTensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/luke/modeling_luke.py#L1516",parametersDescription:[{anchor:"transformers.LukeForEntitySpanClassification.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/main/en/model_doc/luke#transformers.LukeTokenizer">LukeTokenizer</a>. See <a href="/docs/transformers/main/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/main/en/model_doc/wav2vec2_phoneme#transformers.Wav2Vec2PhonemeCTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
masked entity prediction.`),xr=l(),wt=a("p"),$r=o("This model inherits from "),vn=a("a"),Fr=o("PreTrainedModel"),qr=o(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),td=l(),N=a("div"),_(Mt.$$.fragment),nd=l(),be=a("p"),od=o("The "),Ln=a("a"),sd=o("LukeForEntityClassification"),ad=o(" forward method, overrides the "),$o=a("code"),id=o("__call__"),rd=o(" special method."),dd=l(),_(Ne.$$.fragment),ld=l(),Fo=a("p"),cd=o("Examples:"),pd=l(),_(Pt.$$.fragment),ps=l(),ve=a("h2"),De=a("a"),qo=a("span"),_(jt.$$.fragment),hd=l(),Co=a("span"),ud=o("LukeForEntityPairClassification"),hs=l(),A=a("div"),_(At.$$.fragment),md=l(),Mo=a("p"),fd=o(`The LUKE model with a classification head on top (a linear layer on top of the hidden states of the two entity
...
masked entity prediction.`),Ec.forEach(t),xr=c(ne),wt=i(ne,"P",{});var Fs=r(wt);$r=s(Fs,"This model inherits from "),vn=i(Fs,"A",{href:!0});var zc=r(vn);Fr=s(zc,"PreTrainedModel"),zc.forEach(t),qr=s(Fs,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
