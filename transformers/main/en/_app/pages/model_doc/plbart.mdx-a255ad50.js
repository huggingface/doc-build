import{S as Kd,i as Qd,s as Yd,e as n,k as l,w as m,t as r,M as Zd,c as a,d as o,m as c,a as s,x as f,h as i,b as d,F as e,g as h,y as g,q as _,o as b,B as k,v as el}from"../../chunks/vendor-6b77c823.js";import{T as ki}from"../../chunks/Tip-39098574.js";import{D as I}from"../../chunks/Docstring-abef54e3.js";import{C as X}from"../../chunks/CodeBlock-3a8b25a8.js";import{I as ue}from"../../chunks/IconCopyLink-7a11ce68.js";function tl(me){let u,B,v,L,z;return{c(){u=n("p"),B=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),v=n("code"),L=r("Module"),z=r(`
...
the latter silently ignores them.`)},l(T){u=a(T,"P",{});var y=s(u);B=i(y,"Although the recipe for forward pass needs to be defined within this function, one should call the "),v=a(y,"CODE",{});var j=s(v);L=i(j,"Module"),j.forEach(o),z=i(y,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),y.forEach(o)},m(T,y){h(T,u,y),e(u,B),e(u,v),e(v,L),e(u,z)},d(T){T&&o(u)}}}function al(me){let u,B,v,L,z,T,y,j,ta,an,O,io,oa,na,je,aa,sa,Fe,ra,ia,sn,Y,fe,lo,Ee,da,co,la,rn,G,ca,Me,pa,ha,po,ua,ma,dn,Mt,fa,ln,St,ho,ga,cn,R,_a,Se,ba,ka,Ae,va,Ta,pn,Z,ge,uo,Ne,ya,mo,wa,hn,F,Pa,fo,La,qa,go,za,Ba,_o,$a,xa,bo,Ca,ja,un,_e,Fa,Ie,Ea,Ma,mn,W,Sa,Oe,ko,Aa,Na,Ia,At,Oa,Da,fn,Nt,vo,Xa,gn,De,_n,It,Xe,To,Ga,Ra,ee,Wa,yo,Ha,Ua,wo,Va,Ja,bn,Ge,kn,te,be,Po,Re,Ka,Lo,Qa,vn,x,We,Ya,oe,Za,Ot,es,ts,He,os,ns,as,ne,ss,Dt,rs,is,Xt,ds,ls,cs,qo,ps,hs,Ue,Tn,ae,ke,zo,Ve,us,Bo,ms,yn,P,Je,fs,$o,gs,_s,D,bs,Gt,ks,vs,Rt,Ts,ys,Ke,ws,Ps,Ls,Qe,qs,xo,zs,Bs,$s,Co,xs,Cs,Ye,js,ve,Ze,Fs,jo,Es,Ms,N,et,Ss,tt,As,Fo,Ns,Is,Os,ot,nt,Eo,Ds,Xs,Mo,Gs,Rs,at,So,Ws,Hs,Ao,Us,Vs,No,Js,wn,se,Te,Io,st,Ks,Oo,Qs,Pn,S,rt,Ys,it,Zs,Wt,er,tr,or,dt,nr,lt,ar,sr,rr,E,ct,ir,re,dr,Ht,lr,cr,Do,pr,hr,ur,ye,mr,Xo,fr,gr,pt,Ln,ie,we,Go,ht,_r,Ro,br,qn,A,ut,kr,mt,vr,Ut,Tr,yr,wr,ft,Pr,gt,Lr,qr,zr,M,_t,Br,de,$r,Vt,xr,Cr,Wo,jr,Fr,Er,Pe,Mr,Ho,Sr,Ar,bt,zn,le,Le,Uo,kt,Nr,Vo,Ir,Bn,C,vt,Or,Jo,Dr,Xr,Tt,Gr,Jt,Rr,Wr,Hr,yt,Ur,wt,Vr,Jr,Kr,w,Pt,Qr,ce,Yr,Kt,Zr,ei,Ko,ti,oi,ni,qe,ai,Qo,si,ri,Lt,ii,qt,di,Yo,li,ci,zt,pi,Bt,$n,pe,ze,Zo,$t,hi,en,ui,xn,he,xt,mi,H,Ct,fi,tn,gi,_i,jt,Cn;return T=new ue({}),Ee=new ue({}),Ne=new ue({}),De=new X({props:{code:`from transformers import PLBartForConditionalGeneration, PLBartTokenizer
...
<span class="hljs-literal">True</span>`}}),{c(){u=n("meta"),B=l(),v=n("h1"),L=n("a"),z=n("span"),m(T.$$.fragment),y=l(),j=n("span"),ta=r("PLBart"),an=l(),O=n("p"),io=n("strong"),oa=r("DISCLAIMER:"),na=r(" If you see something strange, file a "),je=n("a"),aa=r("Github Issue"),sa=r(` and assign
...
target text format is `),_o=n("code"),$a=r("[tgt_lang_code] X [eos]"),xa=r(". "),bo=n("code"),Ca=r("bos"),ja=r(" is never used."),un=l(),_e=n("p"),Fa=r("However, for fine-tuning, in some cases no language token is provided in cases where a single language is used. Please refer to "),Ie=n("a"),Ea=r("the paper"),Ma=r(" to learn more about this."),mn=l(),W=n("p"),Sa=r("In cases where the language code is needed, The regular "),Oe=n("a"),ko=n("strong"),Aa=r("call"),Na=r("()"),Ia=r(` will encode source text format, and it should be wrapped
inside the context manager `),At=n("a"),Oa=r("as_target_tokenizer()"),Da=r(" to encode target text format."),fn=l(),Nt=n("ul"),vo=n("li"),Xa=r("Supervised training"),gn=l(),m(De.$$.fragment),_n=l(),It=n("ul"),Xe=n("li"),To=n("p"),Ga=r("Generation"),Ra=l(),ee=n("p"),Wa=r("While generating the target text set the "),yo=n("code"),Ha=r("decoder_start_token_id"),Ua=r(` to the target language id. The following
example shows how to translate Python to English using the `),wo=n("code"),Va=r("uclanlp/plbart-python-en_XX"),Ja=r(" model."),bn=l(),m(Ge.$$.fragment),kn=l(),te=n("h2"),be=n("a"),Po=n("span"),m(Re.$$.fragment),Ka=l(),Lo=n("span"),Qa=r("PLBartConfig"),vn=l(),x=n("div"),m(We.$$.fragment),Ya=l(),oe=n("p"),Za=r("This is the configuration class to store the configuration of a "),Ot=n("a"),es=r("PLBartModel"),ts=r(`. It is used to instantiate an
...
documentation from `),Xt=n("a"),ds=r("PretrainedConfig"),ls=r(" for more information."),cs=l(),qo=n("p"),ps=r("Example:"),hs=l(),m(Ue.$$.fragment),Tn=l(),ae=n("h2"),ke=n("a"),zo=n("span"),m(Ve.$$.fragment),us=l(),Bo=n("span"),ms=r("PLBartTokenizer"),yn=l(),P=n("div"),m(Je.$$.fragment),fs=l(),$o=n("p"),gs=r("Construct an PLBART tokenizer."),_s=l(),D=n("p"),bs=r("Adapted from "),Gt=n("a"),ks=r("RobertaTokenizer"),vs=r(" and "),Rt=n("a"),Ts=r("XLNetTokenizer"),ys=r(`. Based on
...
adding special tokens. An PLBART sequence has the following format, where `),Fo=n("code"),Ns=r("X"),Is=r(" represents the sequence:"),Os=l(),ot=n("ul"),nt=n("li"),Eo=n("code"),Ds=r("input_ids"),Xs=r(" (for encoder) "),Mo=n("code"),Gs=r("X [eos, src_lang_code]"),Rs=l(),at=n("li"),So=n("code"),Ws=r("decoder_input_ids"),Hs=r(": (for decoder) "),Ao=n("code"),Us=r("X [eos, tgt_lang_code]"),Vs=l(),No=n("p"),Js=r(`BOS is never used. Pairs of sequences are not the expected use case, but they will be handled without a
separator.`),wn=l(),se=n("h2"),Te=n("a"),Io=n("span"),m(st.$$.fragment),Ks=l(),Oo=n("span"),Qs=r("PLBartModel"),Pn=l(),S=n("div"),m(rt.$$.fragment),Ys=l(),it=n("p"),Zs=r(`The bare PLBART Model outputting raw hidden-states without any specific head on top.
...
target text format is `),_o=a(U,"CODE",{});var Ii=s(_o);$a=i(Ii,"[tgt_lang_code] X [eos]"),Ii.forEach(o),xa=i(U,". "),bo=a(U,"CODE",{});var Oi=s(bo);Ca=i(Oi,"bos"),Oi.forEach(o),ja=i(U," is never used."),U.forEach(o),un=c(t),_e=a(t,"P",{});var En=s(_e);Fa=i(En,"However, for fine-tuning, in some cases no language token is provided in cases where a single language is used. Please refer to "),Ie=a(En,"A",{href:!0,rel:!0});var Di=s(Ie);Ea=i(Di,"the paper"),Di.forEach(o),Ma=i(En," to learn more about this."),En.forEach(o),mn=c(t),W=a(t,"P",{});var Zt=s(W);Sa=i(Zt,"In cases where the language code is needed, The regular "),Oe=a(Zt,"A",{href:!0});var bi=s(Oe);ko=a(bi,"STRONG",{});var Xi=s(ko);Aa=i(Xi,"call"),Xi.forEach(o),Na=i(bi,"()"),bi.forEach(o),Ia=i(Zt,` will encode source text format, and it should be wrapped
inside the context manager `),At=a(Zt,"A",{href:!0});var Gi=s(At);Oa=i(Gi,"as_target_tokenizer()"),Gi.forEach(o),Da=i(Zt," to encode target text format."),Zt.forEach(o),fn=c(t),Nt=a(t,"UL",{});var Ri=s(Nt);vo=a(Ri,"LI",{});var Wi=s(vo);Xa=i(Wi,"Supervised training"),Wi.forEach(o),Ri.forEach(o),gn=c(t),f(De.$$.fragment,t),_n=c(t),It=a(t,"UL",{});var Hi=s(It);Xe=a(Hi,"LI",{});var Mn=s(Xe);To=a(Mn,"P",{});var Ui=s(To);Ga=i(Ui,"Generation"),Ui.forEach(o),Ra=c(Mn),ee=a(Mn,"P",{});var eo=s(ee);Wa=i(eo,"While generating the target text set the "),yo=a(eo,"CODE",{});var Vi=s(yo);Ha=i(Vi,"decoder_start_token_id"),Vi.forEach(o),Ua=i(eo,` to the target language id. The following
example shows how to translate Python to English using the `),wo=a(eo,"CODE",{});var Ji=s(wo);Va=i(Ji,"uclanlp/plbart-python-en_XX"),Ji.forEach(o),Ja=i(eo," model."),eo.forEach(o),Mn.forEach(o),Hi.forEach(o),bn=c(t),f(Ge.$$.fragment,t),kn=c(t),te=a(t,"H2",{class:!0});var Sn=s(te);be=a(Sn,"A",{id:!0,class:!0,href:!0});var Ki=s(be);Po=a(Ki,"SPAN",{});var Qi=s(Po);f(Re.$$.fragment,Qi),Qi.forEach(o),Ki.forEach(o),Ka=c(Sn),Lo=a(Sn,"SPAN",{});var Yi=s(Lo);Qa=i(Yi,"PLBartConfig"),Yi.forEach(o),Sn.forEach(o),vn=c(t),x=a(t,"DIV",{class:!0});var V=s(x);f(We.$$.fragment,V),Ya=c(V),oe=a(V,"P",{});var to=s(oe);Za=i(to,"This is the configuration class to store the configuration of a "),Ot=a(to,"A",{href:!0});var Zi=s(Ot);es=i(Zi,"PLBartModel"),Zi.forEach(o),ts=i(to,`. It is used to instantiate an
PLBART model according to the specified arguments, defining the model architecture. Instantiating a configuration
with the defaults will yield a similar configuration to that of the PLBART
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Jn.forEach(o),zr=c(Ce),M=a(Ce,"DIV",{class:!0});var K=s(M);f(_t.$$.fragment,K),Br=c(K),de=a(K,"P",{});var ao=s(de);$r=i(ao,"The "),Vt=a(ao,"A",{href:!0});var Fd=s(Vt);xr=i(Fd,"PLBartForConditionalGeneration"),Fd.forEach(o),Cr=i(ao," forward method, overrides the "),Wo=a(ao,"CODE",{});var Ed=s(Wo);jr=i(Ed,"__call__"),Ed.forEach(o),Fr=i(ao," special method."),ao.forEach(o),Er=c(K),f(Pe.$$.fragment,K),Mr=c(K),Ho=a(K,"P",{});var Md=s(Ho);Sr=i(Md,"Mask-filling example:"),Md.forEach(o),Ar=c(K),f(bt.$$.fragment,K),K.forEach(o),Ce.forEach(o),zn=c(t),le=a(t,"H2",{class:!0});var Kn=s(le);Le=a(Kn,"A",{id:!0,class:!0,href:!0});var Sd=s(Le);Uo=a(Sd,"SPAN",{});var Ad=s(Uo);f(kt.$$.fragment,Ad),Ad.forEach(o),Sd.forEach(o),Nr=c(Kn),Vo=a(Kn,"SPAN",{});var Nd=s(Vo);Ir=i(Nd,"PLBartForSequenceClassification"),Nd.forEach(o),Kn.forEach(o),Bn=c(t),C=a(t,"DIV",{class:!0});var Q=s(C);f(vt.$$.fragment,Q),Or=c(Q),Jo=a(Q,"P",{});var Id=s(Jo);Dr=i(Id,`PLBart model with a sequence classification/head on top (a linear layer on top of the pooled output) e.g. for code
classification.`),Id.forEach(o),Xr=c(Q),Tt=a(Q,"P",{});var Qn=s(Tt);Gr=i(Qn,"This model inherits from "),Jt=a(Qn,"A",{href:!0});var Od=s(Jt);Rr=i(Od,"PreTrainedModel"),Od.forEach(o),Wr=i(Qn,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
