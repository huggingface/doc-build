import{S as qi,i as xi,s as $i,e as a,k as i,w as f,t,M as ji,c as s,d as o,m as c,a as d,x as u,h as r,b as l,F as e,g as h,y as g,q as _,o as b,B as v,v as Pi}from"../../chunks/vendor-6b77c823.js";import{T as dd}from"../../chunks/Tip-39098574.js";import{D as O}from"../../chunks/Docstring-abef54e3.js";import{C as Me}from"../../chunks/CodeBlock-3a8b25a8.js";import{I as Gn}from"../../chunks/IconCopyLink-7a11ce68.js";function Fi(pe){let m,P,y,z,j;return{c(){m=a("p"),P=t("Although the recipe for forward pass needs to be defined within this function, one should call the "),y=a("code"),z=t("Module"),j=t(`
...
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),T.forEach(o)},m(k,T){h(k,m,T),e(m,P),e(m,y),e(y,z),e(m,j)},d(k){k&&o(m)}}}function Ci(pe){let m,P,y,z,j;return{c(){m=a("p"),P=t("Although the recipe for forward pass needs to be defined within this function, one should call the "),y=a("code"),z=t("Module"),j=t(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(k){m=s(k,"P",{});var T=d(m);P=r(T,"Although the recipe for forward pass needs to be defined within this function, one should call the "),y=s(T,"CODE",{});var F=d(y);z=r(F,"Module"),F.forEach(o),j=r(T,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),T.forEach(o)},m(k,T){h(k,m,T),e(m,P),e(m,y),e(y,z),e(m,j)},d(k){k&&o(m)}}}function Ai(pe){let m,P,y,z,j;return{c(){m=a("p"),P=t("Although the recipe for forward pass needs to be defined within this function, one should call the "),y=a("code"),z=t("Module"),j=t(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(k){m=s(k,"P",{});var T=d(m);P=r(T,"Although the recipe for forward pass needs to be defined within this function, one should call the "),y=s(T,"CODE",{});var F=d(y);z=r(F,"Module"),F.forEach(o),j=r(T,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),T.forEach(o)},m(k,T){h(k,m,T),e(m,P),e(m,y),e(y,z),e(m,j)},d(k){k&&o(m)}}}function Si(pe){let m,P,y,z,j,k,T,F,zt,Un,me,Mt,wo,qt,xt,Vn,he,$t,qe,jt,Pt,Hn,fe,Ft,Eo,Ct,At,Yn,W,St,Do,Nt,It,xe,Lt,Bt,Jn,R,Ot,Qo,Wt,Rt,Xo,Gt,Ut,Zn,$e,Kn,G,Vt,je,Ht,Yt,Pe,Jt,Zt,Qn,Q,ue,en,Fe,Kt,on,Qt,Xn,M,Ce,Xt,ge,zo,er,or,Mo,nr,tr,rr,X,ar,qo,sr,dr,xo,ir,cr,lr,nn,pr,mr,Ae,hr,_e,Se,fr,Ne,ur,$o,gr,_r,br,be,Ie,vr,ee,yr,tn,kr,Tr,rn,wr,Er,et,oe,ve,an,Le,Dr,sn,zr,ot,w,Be,Mr,ne,qr,dn,xr,$r,cn,jr,Pr,Fr,Oe,Cr,We,Ar,Sr,Nr,ln,Ir,Lr,Re,Br,jo,Or,Wr,Rr,Ge,Gr,Ue,Ur,Vr,Hr,U,Po,Yr,Jr,pn,Zr,Kr,mn,Qr,Xr,ea,C,Ve,oa,te,na,Fo,ta,ra,hn,aa,sa,da,ye,ia,fn,ca,la,He,pa,A,Ye,ma,un,ha,fa,re,ua,gn,ga,_a,_n,ba,va,ya,bn,ka,Ta,Je,nt,ae,ke,vn,Ze,wa,yn,Ea,tt,E,Ke,Da,se,za,kn,Ma,qa,Tn,xa,$a,ja,Qe,Pa,Xe,Fa,Ca,Aa,wn,Sa,Na,eo,Ia,Co,La,Ba,Oa,oo,Wa,no,Ra,Ga,Ua,V,Ao,Va,Ha,En,Ya,Ja,Dn,Za,Ka,Qa,S,to,Xa,de,es,So,os,ns,zn,ts,rs,as,Te,ss,Mn,ds,is,ro,cs,L,ao,ls,qn,ps,ms,xn,hs,fs,so,rt,ie,we,$n,io,us,jn,gs,at,D,co,_s,ce,bs,Pn,vs,ys,Fn,ks,Ts,ws,lo,Es,po,Ds,zs,Ms,Cn,qs,xs,mo,$s,No,js,Ps,Fs,ho,Cs,fo,As,Ss,Ns,H,Io,Is,Ls,An,Bs,Os,Sn,Ws,Rs,Gs,N,uo,Us,le,Vs,Lo,Hs,Ys,Nn,Js,Zs,Ks,Ee,Qs,In,Xs,ed,go,od,B,_o,nd,Ln,td,rd,Bn,ad,sd,bo,st;return k=new Gn({}),$e=new Me({props:{code:`# a workaround to load from pytorch checkpoint
...
<span class="hljs-meta">&gt;&gt;&gt; </span>model.save_pretrained(<span class="hljs-string">&quot;./bert2gpt2&quot;</span>)
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-comment"># load fine-tuned model</span>
<span class="hljs-meta">&gt;&gt;&gt; </span>model = FlaxEncoderDecoderModel.from_pretrained(<span class="hljs-string">&quot;./bert2gpt2&quot;</span>)`}}),{c(){m=a("meta"),P=i(),y=a("h1"),z=a("a"),j=a("span"),f(k.$$.fragment),T=i(),F=a("span"),zt=t("Encoder Decoder Models"),Un=i(),me=a("p"),Mt=t("The "),wo=a("a"),qt=t("EncoderDecoderModel"),xt=t(` can be used to initialize a sequence-to-sequence model with any
...
was shown in `),qe=a("a"),jt=t("Leveraging Pre-trained Checkpoints for Sequence Generation Tasks"),Pt=t(` by
...
checkpoints for a particular encoder-decoder model, a workaround is:`),Zn=i(),f($e.$$.fragment),Kn=i(),G=a("p"),Vt=t("This model was contributed by "),je=a("a"),Ht=t("thomwolf"),Yt=t(`. This model\u2019s TensorFlow and Flax versions
were contributed by `),Pe=a("a"),Jt=t("ydshieh"),Zt=t("."),Qn=i(),Q=a("h2"),ue=a("a"),en=a("span"),f(Fe.$$.fragment),Kt=i(),on=a("span"),Qt=t("EncoderDecoderConfig"),Xn=i(),M=a("div"),f(Ce.$$.fragment),Xt=i(),ge=a("p"),zo=a("a"),er=t("EncoderDecoderConfig"),or=t(" is the configuration class to store the configuration of a "),Mo=a("a"),nr=t("EncoderDecoderModel"),tr=t(`. It is
used to instantiate an Encoder Decoder model according to the specified arguments, defining the encoder and decoder
configs.`),rr=i(),X=a("p"),ar=t("Configuration objects inherit from "),qo=a("a"),sr=t("PretrainedConfig"),dr=t(` and can be used to control the model outputs. Read the
documentation from `),xo=a("a"),ir=t("PretrainedConfig"),cr=t(" for more information."),lr=i(),nn=a("p"),pr=t("Examples:"),mr=i(),f(Ae.$$.fragment),hr=i(),_e=a("div"),f(Se.$$.fragment),fr=i(),Ne=a("p"),ur=t("Instantiate a "),$o=a("a"),gr=t("EncoderDecoderConfig"),_r=t(` (or a derived class) from a pre-trained encoder model configuration and
decoder model configuration.`),br=i(),be=a("div"),f(Ie.$$.fragment),vr=i(),ee=a("p"),yr=t("Serializes this instance to a Python dictionary. Override the default "),tn=a("em"),kr=t("to_dict()"),Tr=t(" from "),rn=a("em"),wr=t("PretrainedConfig"),Er=t("."),et=i(),oe=a("h2"),ve=a("a"),an=a("span"),f(Le.$$.fragment),Dr=i(),sn=a("span"),zr=t("EncoderDecoderModel"),ot=i(),w=a("div"),f(Be.$$.fragment),Mr=i(),ne=a("p"),qr=t(`This class can be used to initialize a sequence-to-sequence model with any pretrained autoencoding model as the
encoder and any pretrained autoregressive model as the decoder. The encoder is loaded via
`),dn=a("code"),xr=t("from_pretrained()"),$r=t("function and the decoder is loaded via "),cn=a("code"),jr=t("from_pretrained()"),Pr=t(`function. Cross-attention layers are automatically added to the decoder and should be fine-tuned on a downstream
...
(see the examples for more information).`),Lr=i(),Re=a("p"),Br=t("This model inherits from "),jo=a("a"),Or=t("PreTrainedModel"),Wr=t(`. Check the superclass documentation for the generic methods the
...
:meth`),mn=a("em"),Qr=t("~transformers.AutoModelForCausalLM.from_pretrained"),Xr=t(" class method for the decoder."),ea=i(),C=a("div"),f(Ve.$$.fragment),oa=i(),te=a("p"),na=t("The "),Fo=a("a"),ta=t("EncoderDecoderModel"),ra=t(" forward method, overrides the "),hn=a("code"),aa=t("__call__"),sa=t(" special method."),da=i(),f(ye.$$.fragment),ia=i(),fn=a("p"),ca=t("Examples:"),la=i(),f(He.$$.fragment),pa=i(),A=a("div"),f(Ye.$$.fragment),ma=i(),un=a("p"),ha=t(`Instantiate an encoder and a decoder from one or two base classes of the library from pretrained model
checkpoints.`),fa=i(),re=a("p"),ua=t("The model is set in evaluation mode by default using "),gn=a("code"),ga=t("model.eval()"),_a=t(` (Dropout modules are deactivated). To train
the model, you need to first set it back in training mode with `),_n=a("code"),ba=t("model.train()"),va=t("."),ya=i(),bn=a("p"),ka=t("Example:"),Ta=i(),f(Je.$$.fragment),nt=i(),ae=a("h2"),ke=a("a"),vn=a("span"),f(Ze.$$.fragment),wa=i(),yn=a("span"),Ea=t("TFEncoderDecoderModel"),tt=i(),E=a("div"),f(Ke.$$.fragment),Da=i(),se=a("p"),za=t(`This class can be used to initialize a sequence-to-sequence model with any pretrained autoencoding model as the
encoder and any pretrained autoregressive model as the decoder. The encoder is loaded via
`),kn=a("code"),Ma=t("from_pretrained()"),qa=t("function and the decoder is loaded via "),Tn=a("code"),xa=t("from_pretrained()"),$a=t(`function. Cross-attention layers are automatically added to the decoder and should be fine-tuned on a downstream
generative task, like summarization.`),ja=i(),Qe=a("p"),Pa=t(`The effectiveness of initializing sequence-to-sequence models with pretrained checkpoints for sequence generation
...
method for the decoder.`),Qa=i(),S=a("div"),f(to.$$.fragment),Xa=i(),de=a("p"),es=t("The "),So=a("a"),os=t("TFEncoderDecoderModel"),ns=t(" forward method, overrides the "),zn=a("code"),ts=t("__call__"),rs=t(" special method."),as=i(),f(Te.$$.fragment),ss=i(),Mn=a("p"),ds=t("Examples:"),is=i(),f(ro.$$.fragment),cs=i(),L=a("div"),f(ao.$$.fragment),ls=i(),qn=a("p"),ps=t(`Instantiate an encoder and a decoder from one or two base classes of the library from pretrained model
checkpoints.`),ms=i(),xn=a("p"),hs=t("Example:"),fs=i(),f(so.$$.fragment),rt=i(),ie=a("h2"),we=a("a"),$n=a("span"),f(io.$$.fragment),us=i(),jn=a("span"),gs=t("FlaxEncoderDecoderModel"),at=i(),D=a("div"),f(co.$$.fragment),_s=i(),ce=a("p"),bs=t(`This class can be used to initialize a sequence-to-sequence model with any pretrained autoencoding model as the
encoder and any pretrained autoregressive model as the decoder. The encoder is loaded via
...
(see the examples for more information).`),xs=i(),mo=a("p"),$s=t("This model inherits from "),No=a("a"),js=t("FlaxPreTrainedModel"),Ps=t(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
encoder and :meth`),Sn=a("em"),Ws=t("~transformers.FlaxAutoModelForCausalLM.from_pretrained"),Rs=t(" class method for the decoder."),Gs=i(),N=a("div"),f(uo.$$.fragment),Us=i(),le=a("p"),Vs=t("The "),Lo=a("a"),Hs=t("FlaxEncoderDecoderModel"),Ys=t(" forward method, overrides the "),Nn=a("code"),Js=t("__call__"),Zs=t(" special method."),Ks=i(),f(Ee.$$.fragment),Qs=i(),In=a("p"),Xs=t("Examples:"),ed=i(),f(go.$$.fragment),od=i(),B=a("div"),f(_o.$$.fragment),nd=i(),Ln=a("p"),td=t(`Instantiate an encoder and a decoder from one or two base classes of the library from pretrained model
checkpoints.`),rd=i(),Bn=a("p"),ad=t("Example:"),sd=i(),f(bo.$$.fragment),this.h()},l(n){const p=ji('[data-svelte="svelte-1phssyn"]',document.head);m=s(p,"META",{name:!0,content:!0}),p.forEach(o),P=c(n),y=s(n,"H1",{class:!0});var vo=d(y);z=s(vo,"A",{id:!0,class:!0,href:!0});var On=d(z);j=s(On,"SPAN",{});var Wn=d(j);u(k.$$.fragment,Wn),Wn.forEach(o),On.forEach(o),T=c(vo),F=s(vo,"SPAN",{});var id=d(F);zt=r(id,"Encoder Decoder Models"),id.forEach(o),vo.forEach(o),Un=c(n),me=s(n,"P",{});var dt=d(me);Mt=r(dt,"The "),wo=s(dt,"A",{href:!0});var cd=d(wo);qt=r(cd,"EncoderDecoderModel"),cd.forEach(o),xt=r(dt,` can be used to initialize a sequence-to-sequence model with any
...
was shown in `),qe=s(it,"A",{href:!0,rel:!0});var ld=d(qe);jt=r(ld,"Leveraging Pre-trained Checkpoints for Sequence Generation Tasks"),ld.forEach(o),Pt=r(it,` by
...
checkpoints for a particular encoder-decoder model, a workaround is:`),Oo.forEach(o),Zn=c(n),u($e.$$.fragment,n),Kn=c(n),G=s(n,"P",{});var Wo=d(G);Vt=r(Wo,"This model was contributed by "),je=s(Wo,"A",{href:!0,rel:!0});var gd=d(je);Ht=r(gd,"thomwolf"),gd.forEach(o),Yt=r(Wo,`. This model\u2019s TensorFlow and Flax versions
were contributed by `),Pe=s(Wo,"A",{href:!0,rel:!0});var _d=d(Pe);Jt=r(_d,"ydshieh"),_d.forEach(o),Zt=r(Wo,"."),Wo.forEach(o),Qn=c(n),Q=s(n,"H2",{class:!0});var lt=d(Q);ue=s(lt,"A",{id:!0,class:!0,href:!0});var bd=d(ue);en=s(bd,"SPAN",{});var vd=d(en);u(Fe.$$.fragment,vd),vd.forEach(o),bd.forEach(o),Kt=c(lt),on=s(lt,"SPAN",{});var yd=d(on);Qt=r(yd,"EncoderDecoderConfig"),yd.forEach(o),lt.forEach(o),Xn=c(n),M=s(n,"DIV",{class:!0});var I=d(M);u(Ce.$$.fragment,I),Xt=c(I),ge=s(I,"P",{});var Rn=d(ge);zo=s(Rn,"A",{href:!0});var kd=d(zo);er=r(kd,"EncoderDecoderConfig"),kd.forEach(o),or=r(Rn," is the configuration class to store the configuration of a "),Mo=s(Rn,"A",{href:!0});var Td=d(Mo);nr=r(Td,"EncoderDecoderModel"),Td.forEach(o),tr=r(Rn,`. It is
used to instantiate an Encoder Decoder model according to the specified arguments, defining the encoder and decoder
configs.`),Rn.forEach(o),rr=c(I),X=s(I,"P",{});var Ro=d(X);ar=r(Ro,"Configuration objects inherit from "),qo=s(Ro,"A",{href:!0});var wd=d(qo);sr=r(wd,"PretrainedConfig"),wd.forEach(o),dr=r(Ro,` and can be used to control the model outputs. Read the
documentation from `),xo=s(Ro,"A",{href:!0});var Ed=d(xo);ir=r(Ed,"PretrainedConfig"),Ed.forEach(o),cr=r(Ro," for more information."),Ro.forEach(o),lr=c(I),nn=s(I,"P",{});var Dd=d(nn);pr=r(Dd,"Examples:"),Dd.forEach(o),mr=c(I),u(Ae.$$.fragment,I),hr=c(I),_e=s(I,"DIV",{class:!0});var pt=d(_e);u(Se.$$.fragment,pt),fr=c(pt),Ne=s(pt,"P",{});var mt=d(Ne);ur=r(mt,"Instantiate a "),$o=s(mt,"A",{href:!0});var zd=d($o);gr=r(zd,"EncoderDecoderConfig"),zd.forEach(o),_r=r(mt,` (or a derived class) from a pre-trained encoder model configuration and
decoder model configuration.`),mt.forEach(o),pt.forEach(o),br=c(I),be=s(I,"DIV",{class:!0});var ht=d(be);u(Ie.$$.fragment,ht),vr=c(ht),ee=s(ht,"P",{});var Go=d(ee);yr=r(Go,"Serializes this instance to a Python dictionary. Override the default "),tn=s(Go,"EM",{});var Md=d(tn);kr=r(Md,"to_dict()"),Md.forEach(o),Tr=r(Go," from "),rn=s(Go,"EM",{});var qd=d(rn);wr=r(qd,"PretrainedConfig"),qd.forEach(o),Er=r(Go,"."),Go.forEach(o),ht.forEach(o),I.forEach(o),et=c(n),oe=s(n,"H2",{class:!0});var ft=d(oe);ve=s(ft,"A",{id:!0,class:!0,href:!0});var xd=d(ve);an=s(xd,"SPAN",{});var $d=d(an);u(Le.$$.fragment,$d),$d.forEach(o),xd.forEach(o),Dr=c(ft),sn=s(ft,"SPAN",{});var jd=d(sn);zr=r(jd,"EncoderDecoderModel"),jd.forEach(o),ft.forEach(o),ot=c(n),w=s(n,"DIV",{class:!0});var q=d(w);u(Be.$$.fragment,q),Mr=c(q),ne=s(q,"P",{});var Uo=d(ne);qr=r(Uo,`This class can be used to initialize a sequence-to-sequence model with any pretrained autoencoding model as the
encoder and any pretrained autoregressive model as the decoder. The encoder is loaded via
`),dn=s(Uo,"CODE",{});var Pd=d(dn);xr=r(Pd,"from_pretrained()"),Pd.forEach(o),$r=r(Uo,"function and the decoder is loaded via "),cn=s(Uo,"CODE",{});var Fd=d(cn);jr=r(Fd,"from_pretrained()"),Fd.forEach(o),Pr=r(Uo,`function. Cross-attention layers are automatically added to the decoder and should be fine-tuned on a downstream
generative task, like summarization.`),Uo.forEach(o),Fr=c(q),Oe=s(q,"P",{});var ut=d(Oe);Cr=r(ut,`The effectiveness of initializing sequence-to-sequence models with pretrained checkpoints for sequence generation
...
Zhou, Wei Li, Peter J. Liu.`),ut.forEach(o),Nr=c(q),ln=s(q,"P",{});var Ad=d(ln);Ir=r(Ad,`After such an Encoder Decoder model has been trained/fine-tuned, it can be saved/loaded just like any other models
(see the examples for more information).`),Ad.forEach(o),Lr=c(q),Re=s(q,"P",{});var gt=d(Re);Br=r(gt,"This model inherits from "),jo=s(gt,"A",{href:!0});var Sd=d(jo);Or=r(Sd,"PreTrainedModel"),Sd.forEach(o),Wr=r(gt,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),gt.forEach(o),Rr=c(q),Ge=s(q,"P",{});var _t=d(Ge);Gr=r(_t,"This model is also a PyTorch "),Ue=s(_t,"A",{href:!0,rel:!0});var Nd=d(Ue);Ur=r(Nd,"torch.nn.Module"),Nd.forEach(o),Vr=r(_t,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),_t.forEach(o),Hr=c(q),U=s(q,"P",{});var yo=d(U);Po=s(yo,"A",{href:!0});var Id=d(Po);Yr=r(Id,"EncoderDecoderModel"),Id.forEach(o),Jr=r(yo,` is a generic model class that will be instantiated as a transformer architecture with one
of the base model classes of the library as encoder and another one as decoder when created with the
...
:meth`),mn=s(yo,"EM",{});var Bd=d(mn);Qr=r(Bd,"~transformers.AutoModelForCausalLM.from_pretrained"),Bd.forEach(o),Xr=r(yo," class method for the decoder."),yo.forEach(o),ea=c(q),C=s(q,"DIV",{class:!0});var Y=d(C);u(Ve.$$.fragment,Y),oa=c(Y),te=s(Y,"P",{});var Vo=d(te);na=r(Vo,"The "),Fo=s(Vo,"A",{href:!0});var Od=d(Fo);ta=r(Od,"EncoderDecoderModel"),Od.forEach(o),ra=r(Vo," forward method, overrides the "),hn=s(Vo,"CODE",{});var Wd=d(hn);aa=r(Wd,"__call__"),Wd.forEach(o),sa=r(Vo," special method."),Vo.forEach(o),da=c(Y),u(ye.$$.fragment,Y),ia=c(Y),fn=s(Y,"P",{});var Rd=d(fn);ca=r(Rd,"Examples:"),Rd.forEach(o),la=c(Y),u(He.$$.fragment,Y),Y.forEach(o),pa=c(q),A=s(q,"DIV",{class:!0});var J=d(A);u(Ye.$$.fragment,J),ma=c(J),un=s(J,"P",{});var Gd=d(un);ha=r(Gd,`Instantiate an encoder and a decoder from one or two base classes of the library from pretrained model
checkpoints.`),Gd.forEach(o),fa=c(J),re=s(J,"P",{});var Ho=d(re);ua=r(Ho,"The model is set in evaluation mode by default using "),gn=s(Ho,"CODE",{});var Ud=d(gn);ga=r(Ud,"model.eval()"),Ud.forEach(o),_a=r(Ho,` (Dropout modules are deactivated). To train
the model, you need to first set it back in training mode with `),_n=s(Ho,"CODE",{});var Vd=d(_n);ba=r(Vd,"model.train()"),Vd.forEach(o),va=r(Ho,"."),Ho.forEach(o),ya=c(J),bn=s(J,"P",{});var Hd=d(bn);ka=r(Hd,"Example:"),Hd.forEach(o),Ta=c(J),u(Je.$$.fragment,J),J.forEach(o),q.forEach(o),nt=c(n),ae=s(n,"H2",{class:!0});var bt=d(ae);ke=s(bt,"A",{id:!0,class:!0,href:!0});var Yd=d(ke);vn=s(Yd,"SPAN",{});var Jd=d(vn);u(Ze.$$.fragment,Jd),Jd.forEach(o),Yd.forEach(o),wa=c(bt),yn=s(bt,"SPAN",{});var Zd=d(yn);Ea=r(Zd,"TFEncoderDecoderModel"),Zd.forEach(o),bt.forEach(o),tt=c(n),E=s(n,"DIV",{class:!0});var x=d(E);u(Ke.$$.fragment,x),Da=c(x),se=s(x,"P",{});var Yo=d(se);za=r(Yo,`This class can be used to initialize a sequence-to-sequence model with any pretrained autoencoding model as the
encoder and any pretrained autoregressive model as the decoder. The encoder is loaded via
`),kn=s(Yo,"CODE",{});var Kd=d(kn);Ma=r(Kd,"from_pretrained()"),Kd.forEach(o),qa=r(Yo,"function and the decoder is loaded via "),Tn=s(Yo,"CODE",{});var Qd=d(Tn);xa=r(Qd,"from_pretrained()"),Qd.forEach(o),$a=r(Yo,`function. Cross-attention layers are automatically added to the decoder and should be fine-tuned on a downstream
generative task, like summarization.`),Yo.forEach(o),ja=c(x),Qe=s(x,"P",{});var vt=d(Qe);Pa=r(vt,`The effectiveness of initializing sequence-to-sequence models with pretrained checkpoints for sequence generation
...
Zhou, Wei Li, Peter J. Liu.`),vt.forEach(o),Aa=c(x),wn=s(x,"P",{});var ei=d(wn);Sa=r(ei,`After such an Encoder Decoder model has been trained/fine-tuned, it can be saved/loaded just like any other models
(see the examples for more information).`),ei.forEach(o),Na=c(x),eo=s(x,"P",{});var yt=d(eo);Ia=r(yt,"This model inherits from "),Co=s(yt,"A",{href:!0});var oi=d(Co);La=r(oi,"TFPreTrainedModel"),oi.forEach(o),Ba=r(yt,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),yt.forEach(o),Oa=c(x),oo=s(x,"P",{});var kt=d(oo);Wa=r(kt,"This model is also a "),no=s(kt,"A",{href:!0,rel:!0});var ni=d(no);Ra=r(ni,"tf.keras.Model"),ni.forEach(o),Ga=r(kt,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),kt.forEach(o),Ua=c(x),V=s(x,"P",{});var ko=d(V);Ao=s(ko,"A",{href:!0});var ti=d(Ao);Va=r(ti,"TFEncoderDecoderModel"),ti.forEach(o),Ha=r(ko,` is a generic model class that will be instantiated as a transformer architecture with one
of the base model classes of the library as encoder and another one as decoder when created with the
...
method for the decoder.`),ko.forEach(o),Qa=c(x),S=s(x,"DIV",{class:!0});var Z=d(S);u(to.$$.fragment,Z),Xa=c(Z),de=s(Z,"P",{});var Jo=d(de);es=r(Jo,"The "),So=s(Jo,"A",{href:!0});var si=d(So);os=r(si,"TFEncoderDecoderModel"),si.forEach(o),ns=r(Jo," forward method, overrides the "),zn=s(Jo,"CODE",{});var di=d(zn);ts=r(di,"__call__"),di.forEach(o),rs=r(Jo," special method."),Jo.forEach(o),as=c(Z),u(Te.$$.fragment,Z),ss=c(Z),Mn=s(Z,"P",{});var ii=d(Mn);ds=r(ii,"Examples:"),ii.forEach(o),is=c(Z),u(ro.$$.fragment,Z),Z.forEach(o),cs=c(x),L=s(x,"DIV",{class:!0});var De=d(L);u(ao.$$.fragment,De),ls=c(De),qn=s(De,"P",{});var ci=d(qn);ps=r(ci,`Instantiate an encoder and a decoder from one or two base classes of the library from pretrained model
checkpoints.`),ci.forEach(o),ms=c(De),xn=s(De,"P",{});var li=d(xn);hs=r(li,"Example:"),li.forEach(o),fs=c(De),u(so.$$.fragment,De),De.forEach(o),x.forEach(o),rt=c(n),ie=s(n,"H2",{class:!0});var Tt=d(ie);we=s(Tt,"A",{id:!0,class:!0,href:!0});var pi=d(we);$n=s(pi,"SPAN",{});var mi=d($n);u(io.$$.fragment,mi),mi.forEach(o),pi.forEach(o),us=c(Tt),jn=s(Tt,"SPAN",{});var hi=d(jn);gs=r(hi,"FlaxEncoderDecoderModel"),hi.forEach(o),Tt.forEach(o),at=c(n),D=s(n,"DIV",{class:!0});var $=d(D);u(co.$$.fragment,$),_s=c($),ce=s($,"P",{});var Zo=d(ce);bs=r(Zo,`This class can be used to initialize a sequence-to-sequence model with any pretrained autoencoding model as the
encoder and any pretrained autoregressive model as the decoder. The encoder is loaded via
...
(see the examples for more information).`),_i.forEach(o),xs=c($),mo=s($,"P",{});var Et=d(mo);$s=r(Et,"This model inherits from "),No=s(Et,"A",{href:!0});var bi=d(No);js=r(bi,"FlaxPreTrainedModel"),bi.forEach(o),Ps=r(Et,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
