import{S as mm,i as fm,s as um,e as a,k as d,w as b,t as r,M as gm,c as n,d as t,m as c,a as s,x as w,h as i,b as l,F as e,g as m,y,q as $,o as x,B as F,v as _m}from"../../chunks/vendor-6b77c823.js";import{T as _e}from"../../chunks/Tip-39098574.js";import{D as W}from"../../chunks/Docstring-90e3aa51.js";import{C as Ft}from"../../chunks/CodeBlock-3a8b25a8.js";import{I as ve}from"../../chunks/IconCopyLink-7a11ce68.js";function vm(M){let h,T,f,g,v;return{c(){h=a("p"),T=r(`This is a recently introduced model so the API hasn\u2019t been tested extensively. There may be some bugs or slight
...
the latter silently ignores them.`)},l(_){h=n(_,"P",{});var u=s(h);T=i(u,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=n(u,"CODE",{});var V=s(f);g=i(V,"Module"),V.forEach(t),v=i(u,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),u.forEach(t)},m(_,u){m(_,h,u),e(h,T),e(h,f),e(f,g),e(h,v)},d(_){_&&t(h)}}}function Mm(M){let h,T,f,g,v,_,u,V,he,R,k,ie,j,B,oe,C,pe,ae,E,I,z,Ie,ne,L,je,Te,Xo,tr,ss,Zo,Da,or,rs,Qo,ar,is,N,Vt,nr,Et,sr,rr,ir,Oa,lr,dr,kt,cr,Yo,hr,pr,mr,Pe,fr,Sa,ur,gr,Mt,_r,vr,Tr,Ce,br,It,wr,yr,jt,$r,xr,Fr,Ae,Vr,Pt,Er,kr,Ct,Mr,Ir,jr,Wa,Pr,ls,ea,Cr,ds,le,Ba,P,ta,Ar,qr,oa,zr,Nr,aa,Lr,Dr,Ua,Or,Sr,Ra,Wr,Br,Ha,Ur,Rr,Ja,Hr,Jr,na,Kr,Gr,Xr,Ka,sa,ra,Zr,Qr,Yr,Ga,At,ei,qt,ti,oi,ai,Xa,ia,la,ni,si,cs,be,ri,zt,ii,li,Nt,di,ci,hs,et,hi,Lt,pi,mi,ps,qe,tt,Za,Dt,fi,Qa,ui,ms,U,Ot,gi,ze,_i,da,vi,Ti,St,bi,wi,yi,Ne,$i,ca,xi,Fi,ha,Vi,Ei,ki,Ya,Mi,Ii,Wt,fs,Le,ot,en,Bt,ji,tn,Pi,us,se,Ut,Ci,on,Ai,qi,Rt,zi,pa,Ni,Li,Di,we,Ht,Oi,an,Si,Wi,at,gs,De,nt,nn,Jt,Bi,sn,Ui,_s,me,Kt,Ri,Gt,Hi,Xt,Ji,Ki,Gi,H,Zt,Xi,Oe,Zi,ma,Qi,Yi,rn,el,tl,ol,st,al,ln,nl,sl,Qt,vs,Se,rt,dn,Yt,rl,cn,il,Ts,fe,eo,ll,We,dl,hn,cl,hl,to,pl,ml,fl,J,oo,ul,Be,gl,fa,_l,vl,pn,Tl,bl,wl,it,yl,mn,$l,xl,ao,bs,Ue,lt,fn,no,Fl,un,Vl,ws,re,so,El,gn,kl,Ml,ro,Il,io,jl,Pl,Cl,K,lo,Al,Re,ql,ua,zl,Nl,_n,Ll,Dl,Ol,dt,Sl,vn,Wl,Bl,co,ys,He,ct,Tn,ho,Ul,bn,Rl,$s,D,po,Hl,wn,Jl,Kl,mo,Gl,ga,Xl,Zl,Ql,fo,Yl,uo,ed,td,od,ht,ad,G,go,nd,Je,sd,_a,rd,id,yn,ld,dd,cd,pt,hd,$n,pd,md,_o,xs,Ke,mt,xn,vo,fd,Fn,ud,Fs,O,To,gd,Vn,_d,vd,bo,Td,va,bd,wd,yd,wo,$d,yo,xd,Fd,Vd,ft,Ed,X,$o,kd,Ge,Md,Ta,Id,jd,En,Pd,Cd,Ad,ut,qd,kn,zd,Nd,xo,Vs,Xe,gt,Mn,Fo,Ld,In,Dd,Es,A,Vo,Od,jn,Sd,Wd,Eo,Bd,ba,Ud,Rd,Hd,ko,Jd,Mo,Kd,Gd,Xd,Pn,Zd,Qd,ue,Cn,Io,Yd,ec,An,jo,tc,oc,qn,Po,ac,nc,zn,Co,sc,rc,Z,Ao,ic,Ze,lc,Nn,dc,cc,Ln,hc,pc,mc,_t,fc,Dn,uc,gc,qo,ks,Qe,vt,On,zo,_c,Sn,vc,Ms,q,No,Tc,Wn,bc,wc,Lo,yc,wa,$c,xc,Fc,Do,Vc,Oo,Ec,kc,Mc,Bn,Ic,jc,ge,Un,So,Pc,Cc,Rn,Wo,Ac,qc,Hn,Bo,zc,Nc,Jn,Uo,Lc,Dc,Q,Ro,Oc,Ye,Sc,Kn,Wc,Bc,Gn,Uc,Rc,Hc,Tt,Jc,Xn,Kc,Gc,Ho,Is;return _=new ve({}),k=new _e({props:{$$slots:{default:[vm]},$$scope:{ctx:M}}}),C=new ve({}),Dt=new ve({}),Ot=new W({props:{name:"class transformers.ViTConfig",anchor:"transformers.ViTConfig",parameters:[{name:"hidden_size",val:" = 768"},{name:"num_hidden_layers",val:" = 12"},{name:"num_attention_heads",val:" = 12"},{name:"intermediate_size",val:" = 3072"},{name:"hidden_act",val:" = 'gelu'"},{name:"hidden_dropout_prob",val:" = 0.0"},{name:"attention_probs_dropout_prob",val:" = 0.0"},{name:"initializer_range",val:" = 0.02"},{name:"layer_norm_eps",val:" = 1e-12"},{name:"is_encoder_decoder",val:" = False"},{name:"image_size",val:" = 224"},{name:"patch_size",val:" = 16"},{name:"num_channels",val:" = 3"},{name:"qkv_bias",val:" = True"},{name:"encoder_stride",val:" = 16"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.ViTConfig.hidden_size",description:`<strong>hidden_size</strong> (<code>int</code>, <em>optional</em>, defaults to 768) &#x2014;
...
`}}),pt=new _e({props:{$$slots:{default:[xm]},$$scope:{ctx:M}}}),_o=new Ft({props:{code:`from transformers import ViTFeatureExtractor, TFViTModel
from datasets import load_dataset
...
behavior.`),od=d(),b(ht.$$.fragment),ad=d(),G=a("div"),b(go.$$.fragment),nd=d(),Je=a("p"),sd=r("The "),_a=a("a"),rd=r("TFViTModel"),id=r(" forward method, overrides the "),yn=a("code"),ld=r("__call__"),dd=r(" special method."),cd=d(),b(pt.$$.fragment),hd=d(),$n=a("p"),pd=r("Example:"),md=d(),b(_o.$$.fragment),xs=d(),Ke=a("h2"),mt=a("a"),xn=a("span"),b(vo.$$.fragment),fd=d(),Fn=a("span"),ud=r("TFViTForImageClassification"),Fs=d(),O=a("div"),b(To.$$.fragment),gd=d(),Vn=a("p"),_d=r(`ViT Model transformer with an image classification head on top (a linear layer on top of the final hidden state of
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Vd=d(),b(ft.$$.fragment),Ed=d(),X=a("div"),b($o.$$.fragment),kd=d(),Ge=a("p"),Md=r("The "),Ta=a("a"),Id=r("TFViTForImageClassification"),jd=r(" forward method, overrides the "),En=a("code"),Pd=r("__call__"),Cd=r(" special method."),Ad=d(),b(ut.$$.fragment),qd=d(),kn=a("p"),zd=r("Example:"),Nd=d(),b(xo.$$.fragment),Vs=d(),Xe=a("h2"),gt=a("a"),Mn=a("span"),b(Fo.$$.fragment),Ld=d(),In=a("span"),Dd=r("FlaxVitModel"),Es=d(),A=a("div"),b(Vo.$$.fragment),Od=d(),jn=a("p"),Sd=r("The bare ViT Model transformer outputting raw hidden-states without any specific head on top."),Wd=d(),Eo=a("p"),Bd=r("This model inherits from "),ba=a("a"),Ud=r("FlaxPreTrainedModel"),Rd=r(`. Check the superclass documentation for the generic methods the
...
resolution of 16x16 and fine-tuning resolution of 224x224. All checkpoints can be found on the `),Mt=n(ya,"A",{href:!0,rel:!0});var sh=s(Mt);_r=i(sh,"hub"),sh.forEach(t),vr=i(ya,"."),ya.forEach(t),Tr=c(Y),Ce=n(Y,"LI",{});var $a=s(Ce);br=i($a,"The available checkpoints are either (1) pre-trained on "),It=n($a,"A",{href:!0,rel:!0});var rh=s(It);wr=i(rh,"ImageNet-21k"),rh.forEach(t),yr=i($a,` (a collection of
...
images and 1,000 classes).`),$a.forEach(t),Fr=c(Y),Ae=n(Y,"LI",{});var xa=s(Ae);Vr=i(xa,`The Vision Transformer was pre-trained using a resolution of 224x224. During fine-tuning, it is often beneficial to
use a higher resolution than pre-training `),Pt=n(xa,"A",{href:!0,rel:!0});var lh=s(Pt);Er=i(lh,"(Touvron et al., 2019)"),lh.forEach(t),kr=i(xa,", "),Ct=n(xa,"A",{href:!0,rel:!0});var dh=s(Ct);Mr=i(dh,`(Kolesnikov
et al., 2020)`),dh.forEach(t),Ir=i(xa,`. In order to fine-tune at higher resolution, the authors perform
...
as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),Ds.forEach(t),Gi=c(Ma),H=n(Ma,"DIV",{class:!0});var $e=s(H);w(Zt.$$.fragment,$e),Xi=c($e),Oe=n($e,"P",{});var Ia=s(Oe);Zi=i(Ia,"The "),ma=n(Ia,"A",{href:!0});var Kh=s(ma);Qi=i(Kh,"ViTModel"),Kh.forEach(t),Yi=i(Ia," forward method, overrides the "),rn=n(Ia,"CODE",{});var Gh=s(rn);el=i(Gh,"__call__"),Gh.forEach(t),tl=i(Ia," special method."),Ia.forEach(t),ol=c($e),w(st.$$.fragment,$e),al=c($e),ln=n($e,"P",{});var Xh=s(ln);nl=i(Xh,"Example:"),Xh.forEach(t),sl=c($e),w(Qt.$$.fragment,$e),$e.forEach(t),Ma.forEach(t),vs=c(o),Se=n(o,"H2",{class:!0});var Os=s(Se);rt=n(Os,"A",{id:!0,class:!0,href:!0});var Zh=s(rt);dn=n(Zh,"SPAN",{});var Qh=s(dn);w(Yt.$$.fragment,Qh),Qh.forEach(t),Zh.forEach(t),rl=c(Os),cn=n(Os,"SPAN",{});var Yh=s(cn);il=i(Yh,"ViTForMaskedImageModeling"),Yh.forEach(t),Os.forEach(t),Ts=c(o),fe=n(o,"DIV",{class:!0});var ja=s(fe);w(eo.$$.fragment,ja),ll=c(ja),We=n(ja,"P",{});var Pa=s(We);dl=i(Pa,"ViT Model with a decoder on top for masked image modeling, as proposed in "),hn=n(Pa,"CODE",{});var ep=s(hn);cl=i(ep,"SimMIM <https://arxiv.org/abs/2111.09886>"),ep.forEach(t),hl=i(Pa,`__.
This model is a PyTorch `),to=n(Pa,"A",{href:!0,rel:!0});var tp=s(to);pl=i(tp,"torch.nn.Module"),tp.forEach(t),ml=i(Pa,` subclass. Use it
as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),Pa.forEach(t),fl=c(ja),J=n(ja,"DIV",{class:!0});var xe=s(J);w(oo.$$.fragment,xe),ul=c(xe),Be=n(xe,"P",{});var Ca=s(Be);gl=i(Ca,"The "),fa=n(Ca,"A",{href:!0});var op=s(fa);_l=i(op,"ViTForMaskedImageModeling"),op.forEach(t),vl=i(Ca," forward method, overrides the "),pn=n(Ca,"CODE",{});var ap=s(pn);Tl=i(ap,"__call__"),ap.forEach(t),bl=i(Ca," special method."),Ca.forEach(t),wl=c(xe),w(it.$$.fragment,xe),yl=c(xe),mn=n(xe,"P",{});var np=s(mn);$l=i(np,"Examples:"),np.forEach(t),xl=c(xe),w(ao.$$.fragment,xe),xe.forEach(t),ja.forEach(t),bs=c(o),Ue=n(o,"H2",{class:!0});var Ss=s(Ue);lt=n(Ss,"A",{id:!0,class:!0,href:!0});var sp=s(lt);fn=n(sp,"SPAN",{});var rp=s(fn);w(no.$$.fragment,rp),rp.forEach(t),sp.forEach(t),Fl=c(Ss),un=n(Ss,"SPAN",{});var ip=s(un);Vl=i(ip,"ViTForImageClassification"),ip.forEach(t),Ss.forEach(t),ws=c(o),re=n(o,"DIV",{class:!0});var yt=s(re);w(so.$$.fragment,yt),El=c(yt),gn=n(yt,"P",{});var lp=s(gn);kl=i(lp,`ViT Model transformer with an image classification head on top (a linear layer on top of the final hidden state of
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Rs.forEach(t),od=c(de),w(ht.$$.fragment,de),ad=c(de),G=n(de,"DIV",{class:!0});var Ve=s(G);w(go.$$.fragment,Ve),nd=c(Ve),Je=n(Ve,"P",{});var qa=s(Je);sd=i(qa,"The "),_a=n(qa,"A",{href:!0});var Tp=s(_a);rd=i(Tp,"TFViTModel"),Tp.forEach(t),id=i(qa," forward method, overrides the "),yn=n(qa,"CODE",{});var bp=s(yn);ld=i(bp,"__call__"),bp.forEach(t),dd=i(qa," special method."),qa.forEach(t),cd=c(Ve),w(pt.$$.fragment,Ve),hd=c(Ve),$n=n(Ve,"P",{});var wp=s($n);pd=i(wp,"Example:"),wp.forEach(t),md=c(Ve),w(_o.$$.fragment,Ve),Ve.forEach(t),de.forEach(t),xs=c(o),Ke=n(o,"H2",{class:!0});var Hs=s(Ke);mt=n(Hs,"A",{id:!0,class:!0,href:!0});var yp=s(mt);xn=n(yp,"SPAN",{});var $p=s(xn);w(vo.$$.fragment,$p),$p.forEach(t),yp.forEach(t),fd=c(Hs),Fn=n(Hs,"SPAN",{});var xp=s(Fn);ud=i(xp,"TFViTForImageClassification"),xp.forEach(t),Hs.forEach(t),Fs=c(o),O=n(o,"DIV",{class:!0});var ce=s(O);w(To.$$.fragment,ce),gd=c(ce),Vn=n(ce,"P",{});var Fp=s(Vn);_d=i(Fp,`ViT Model transformer with an image classification head on top (a linear layer on top of the final hidden state of
