...
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/mobilebert/modeling_mobilebert.py#L1254",returnDescription:`
<p>A <a
...
<code>input_ids</code> above)`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/mobilebert/modeling_mobilebert.py#L1465",returnDescription:`
<p>A <a
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/mobilebert/modeling_mobilebert.py#L1567",returnDescription:`
<p>A <a
...
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/mobilebert/modeling_mobilebert.py#L1357",returnDescription:`
<p>A <a
...
`}}),Gn=new Pe({props:{$$slots:{default:[cw]},$$scope:{ctx:E}}}),Yn=new Ee({props:{anchor:"transformers.TFMobileBertForQuestionAnswering.call.example",$$slots:{default:[pw]},$$scope:{ctx:E}}}),Jn=new Ee({props:{anchor:"transformers.TFMobileBertForQuestionAnswering.call.example-2",$$slots:{default:[mw]},$$scope:{ctx:E}}}),{c(){d=r("meta"),_=m(),c=r("h1"),p=r("a"),T=r("span"),v(l.$$.fragment),u=m(),x=r("span"),me=n("MobileBERT"),V=m(),z=r("h2"),J=r("a"),L=r("span"),v(X.$$.fragment),he=m(),D=r("span"),ue=n("Overview"),le=m(),K=r("p"),N=n("The MobileBERT model was proposed in "),ee=r("a"),G=n("MobileBERT: a Compact Task-Agnostic BERT for Resource-Limited Devices"),P=n(` by Zhiqing Sun, Hongkun Yu, Xiaodan Song, Renjie Liu, Yiming Yang, and Denny
...
splitting and wordpiece.`),um=m(),us=r("p"),fm=n("Refer to superclass "),Pa=r("a"),gm=n("BertTokenizerFast"),_m=n(" for usage examples and documentation concerning parameters."),Wd=m(),Ht=r("h2"),Ao=r("a"),Ii=r("span"),v(fs.$$.fragment),bm=m(),Li=r("span"),Tm=n("MobileBert specific outputs"),Rd=m(),Qt=r("div"),v(gs.$$.fragment),km=m(),_s=r("p"),vm=n("Output type of "),qa=r("a"),ym=n("MobileBertForPreTraining"),wm=n("."),Ud=m(),Kt=r("div"),v(bs.$$.fragment),Mm=m(),Ts=r("p"),$m=n("Output type of "),Ca=r("a"),Fm=n("TFMobileBertForPreTraining"),Bm=n("."),Hd=m(),Vt=r("h2"),Io=r("a"),Di=r("span"),v(ks.$$.fragment),Em=m(),Wi=r("span"),xm=n("MobileBertModel"),Qd=m(),je=r("div"),v(vs.$$.fragment),zm=m(),Ri=r("p"),Pm=n("The bare MobileBert Model transformer outputting raw hidden-states without any specific head on top."),qm=m(),ys=r("p"),Cm=n("This model inherits from "),ja=r("a"),jm=n("PreTrainedModel"),Nm=n(`. Check the superclass documentation for the generic methods the
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Bu=m(),Ce=r("div"),v(Zs.$$.fragment),Eu=m(),so=r("p"),xu=n("The "),Ra=r("a"),zu=n("MobileBertForSequenceClassification"),Pu=n(" forward method, overrides the "),ll=r("code"),qu=n("__call__"),Cu=n(" special method."),ju=m(),v(Xo.$$.fragment),Nu=m(),v(en.$$.fragment),Ou=m(),v(tn.$$.fragment),Su=m(),v(on.$$.fragment),Au=m(),v(nn.$$.fragment),tc=m(),ro=r("h2"),sn=r("a"),dl=r("span"),v(Xs.$$.fragment),Iu=m(),cl=r("span"),Lu=n("MobileBertForMultipleChoice"),oc=m(),Ke=r("div"),v(er.$$.fragment),Du=m(),pl=r("p"),Wu=n(`MobileBert Model with a multiple choice classification head on top (a linear layer on top of the pooled output and
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),j_=m(),v(zn.$$.fragment),N_=m(),ht=r("div"),v(Wr.$$.fragment),O_=m(),vo=r("p"),S_=n("The "),ni=r("a"),A_=n("TFMobileBertForNextSentencePrediction"),I_=n(" forward method, overrides the "),Al=r("code"),L_=n("__call__"),D_=n(" special method."),W_=m(),v(Pn.$$.fragment),R_=m(),v(qn.$$.fragment),fc=m(),yo=r("h2"),Cn=r("a"),Il=r("span"),v(Rr.$$.fragment),U_=m(),Ll=r("span"),H_=n("TFMobileBertForSequenceClassification"),gc=m(),Ie=r("div"),v(Ur.$$.fragment),Q_=m(),Dl=r("p"),K_=n(`MobileBert Model transformer with a sequence classification/regression head on top (a linear layer on top of the
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),up.forEach(t),z_=h(Tt),Lr=a(Tt,"P",{});var fp=i(Lr);P_=s(fp,"This model is also a "),Dr=a(fp,"A",{href:!0,rel:!0});var xv=i(Dr);q_=s(xv,"tf.keras.Model"),xv.forEach(t),C_=s(fp,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),fp.forEach(t),j_=h(Tt),y(zn.$$.fragment,Tt),N_=h(Tt),ht=a(Tt,"DIV",{class:!0});var rs=i(ht);y(Wr.$$.fragment,rs),O_=h(rs),vo=a(rs,"P",{});var Fi=i(vo);S_=s(Fi,"The "),ni=a(Fi,"A",{href:!0});var zv=i(ni);A_=s(zv,"TFMobileBertForNextSentencePrediction"),zv.forEach(t),I_=s(Fi," forward method, overrides the "),Al=a(Fi,"CODE",{});var Pv=i(Al);L_=s(Pv,"__call__"),Pv.forEach(t),D_=s(Fi," special method."),Fi.forEach(t),W_=h(rs),y(Pn.$$.fragment,rs),R_=h(rs),y(qn.$$.fragment,rs),rs.forEach(t),Tt.forEach(t),fc=h(o),yo=a(o,"H2",{class:!0});var gp=i(yo);Cn=a(gp,"A",{id:!0,class:!0,href:!0});var qv=i(Cn);Il=a(qv,"SPAN",{});var Cv=i(Il);y(Rr.$$.fragment,Cv),Cv.forEach(t),qv.forEach(t),U_=h(gp),Ll=a(gp,"SPAN",{});var jv=i(Ll);H_=s(jv,"TFMobileBertForSequenceClassification"),jv.forEach(t),gp.forEach(t),gc=h(o),Ie=a(o,"DIV",{class:!0});var kt=i(Ie);y(Ur.$$.fragment,kt),Q_=h(kt),Dl=a(kt,"P",{});var Nv=i(Dl);K_=s(Nv,`MobileBert Model transformer with a sequence classification/regression head on top (a linear layer on top of the
