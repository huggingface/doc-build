...
Michael Auli.`),ld.forEach(o),em=c(pe),Fa=r(pe,"P",{});var cd=i(Fa);tm=n(cd,"This model inherits from "),Wn=r(cd,"A",{href:!0});var i2=i(Wn);om=n(i2,"PreTrainedModel"),i2.forEach(o),am=n(cd,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
