...
the latter silently ignores them.`)},l(n){d=a(n,"P",{});var u=l(d);T=i(u,"Although the recipe for forward pass needs to be defined within this function, one should call the "),m=a(u,"CODE",{});var j=l(m);c=i(j,"Module"),j.forEach(t),g=i(u,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),u.forEach(t)},m(n,u){_(n,d,u),e(d,T),e(d,m),e(m,c),e(d,g)},d(n){n&&t(d)}}}function Nb(G){let d,T,m,c,g;return c=new re({props:{code:`import torch
...
<span class="hljs-meta">&gt;&gt;&gt; </span>mc_logits = outputs.mc_logits`}}),{c(){d=s("p"),T=r("Example:"),m=p(),y(c.$$.fragment)},l(n){d=a(n,"P",{});var u=l(d);T=i(u,"Example:"),u.forEach(t),m=h(n),k(c.$$.fragment,n)},m(n,u){_(n,d,u),e(d,T),_(n,m,u),w(c,n,u),g=!0},p:ae,i(n){g||($(c.$$.fragment,n),g=!0)},o(n){P(c.$$.fragment,n),g=!1},d(n){n&&t(d),n&&t(m),M(c,n)}}}function Hb(G){let d,T,m,c,g;return{c(){d=s("p"),T=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),m=s("code"),c=r("Module"),g=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(n){d=a(n,"P",{});var u=l(d);T=i(u,"Although the recipe for forward pass needs to be defined within this function, one should call the "),m=a(u,"CODE",{});var j=l(m);c=i(j,"Module"),j.forEach(t),g=i(u,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),u.forEach(t)},m(n,u){_(n,d,u),e(d,T),e(d,m),e(m,c),e(d,g)},d(n){n&&t(d)}}}function Ib(G){let d,T,m,c,g;return c=new re({props:{code:`import torch
...
<span class="hljs-number">5.28</span>`}}),{c(){y(d.$$.fragment)},l(m){k(d.$$.fragment,m)},m(m,c){w(d,m,c),T=!0},p:ae,i(m){T||($(d.$$.fragment,m),T=!0)},o(m){P(d.$$.fragment,m),T=!1},d(m){M(d,m)}}}function Ab(G){let d,T,m,c,g;return c=new re({props:{code:`import torch
from transformers import GPT2Tokenizer, GPT2ForSequenceClassification
...
`),J=s("code"),ke=r('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(v){d=a(v,"P",{});var x=l(d);T=i(x,"TF 2.0 models accepts two formats as inputs:"),x.forEach(t),m=h(v),c=a(v,"UL",{});var ne=l(c);g=a(ne,"LI",{});var Ee=l(g);n=i(Ee,"having all inputs as keyword arguments (like PyTorch models), or"),Ee.forEach(t),u=h(ne),j=a(ne,"LI",{});var Oe=l(j);Q=i(Oe,"having all inputs as a list, tuple or dict in the first positional arguments."),Oe.forEach(t),ne.forEach(t),C=h(v),F=a(v,"P",{});var I=l(F);B=i(I,"This second option is useful when using "),S=a(I,"CODE",{});var qe=l(S);Z=i(qe,"tf.keras.Model.fit"),qe.forEach(t),_e=i(I,` method which currently requires having all the
tensors in the first argument of the model call function: `),A=a(I,"CODE",{});var We=l(A);Te=i(We,"model(inputs)"),We.forEach(t),ue=i(I,"."),I.forEach(t),W=h(v),N=a(v,"P",{});var Ue=l(N);ee=i(Ue,`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),{c(){d=s("p"),T=r("Example:"),m=p(),y(c.$$.fragment)},l(n){d=a(n,"P",{});var u=l(d);T=i(u,"Example:"),u.forEach(t),m=h(n),k(c.$$.fragment,n)},m(n,u){_(n,d,u),e(d,T),_(n,m,u),w(c,n,u),g=!0},p:ae,i(n){g||($(c.$$.fragment,n),g=!0)},o(n){P(c.$$.fragment,n),g=!1},d(n){n&&t(d),n&&t(m),M(c,n)}}}function Jb(G){let d,T,m,c,g,n,u,j,Q,C,F,B,S,Z,_e,A,Te,ue,W,N,ee,te,z,q,ie,V,fe,le,O,be,ge,E,ve,U,R,de,K,ye,oe,H,ce,J,ke;return{c(){d=s("p"),T=r("TF 2.0 models accepts two formats as inputs:"),m=p(),c=s("ul"),g=s("li"),n=r("having all inputs as keyword arguments (like PyTorch models), or"),u=p(),j=s("li"),Q=r("having all inputs as a list, tuple or dict in the first positional arguments."),C=p(),F=s("p"),B=r("This second option is useful when using "),S=s("code"),Z=r("tf.keras.Model.fit"),_e=r(` method which currently requires having all the
tensors in the first argument of the model call function: `),A=s("code"),Te=r("model(inputs)"),ue=r("."),W=p(),N=s("p"),ee=r(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),te=p(),z=s("ul"),q=s("li"),ie=r("a single Tensor with "),V=s("code"),fe=r("input_ids"),le=r(" only and nothing else: "),O=s("code"),be=r("model(inputs_ids)"),ge=p(),E=s("li"),ve=r(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),U=s("code"),R=r("model([input_ids, attention_mask])"),de=r(" or "),K=s("code"),ye=r("model([input_ids, attention_mask, token_type_ids])"),oe=p(),H=s("li"),ce=r(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),J=s("code"),ke=r('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(v){d=a(v,"P",{});var x=l(d);T=i(x,"TF 2.0 models accepts two formats as inputs:"),x.forEach(t),m=h(v),c=a(v,"UL",{});var ne=l(c);g=a(ne,"LI",{});var Ee=l(g);n=i(Ee,"having all inputs as keyword arguments (like PyTorch models), or"),Ee.forEach(t),u=h(ne),j=a(ne,"LI",{});var Oe=l(j);Q=i(Oe,"having all inputs as a list, tuple or dict in the first positional arguments."),Oe.forEach(t),ne.forEach(t),C=h(v),F=a(v,"P",{});var I=l(F);B=i(I,"This second option is useful when using "),S=a(I,"CODE",{});var qe=l(S);Z=i(qe,"tf.keras.Model.fit"),qe.forEach(t),_e=i(I,` method which currently requires having all the
...
first positional argument :`),Ue.forEach(t),te=h(v),z=a(v,"UL",{});var D=l(z);q=a(D,"LI",{});var X=l(q);ie=i(X,"a single Tensor with "),V=a(X,"CODE",{});var Re=l(V);fe=i(Re,"input_ids"),Re.forEach(t),le=i(X," only and nothing else: "),O=a(X,"CODE",{});var Ce=l(O);be=i(Ce,"model(inputs_ids)"),Ce.forEach(t),X.forEach(t),ge=h(D),E=a(D,"LI",{});var Y=l(E);ve=i(Y,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),U=a(Y,"CODE",{});var Be=l(U);R=i(Be,"model([input_ids, attention_mask])"),Be.forEach(t),de=i(Y," or "),K=a(Y,"CODE",{});var De=l(K);ye=i(De,"model([input_ids, attention_mask, token_type_ids])"),De.forEach(t),Y.forEach(t),oe=h(D),H=a(D,"LI",{});var we=l(H);ce=i(we,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),J=a(we,"CODE",{});var Ve=l(J);ke=i(Ve,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),Ve.forEach(t),we.forEach(t),D.forEach(t)},m(v,x){_(v,d,x),e(d,T),_(v,m,x),_(v,c,x),e(c,g),e(g,n),e(c,u),e(c,j),e(j,Q),_(v,C,x),_(v,F,x),e(F,B),e(F,S),e(S,Z),e(F,_e),e(F,A),e(A,Te),e(F,ue),_(v,W,x),_(v,N,x),e(N,ee),_(v,te,x),_(v,z,x),e(z,q),e(q,ie),e(q,V),e(V,fe),e(q,le),e(q,O),e(O,be),e(z,ge),e(z,E),e(E,ve),e(E,U),e(U,R),e(E,de),e(E,K),e(K,ye),e(z,oe),e(z,H),e(H,ce),e(H,J),e(J,ke)},d(v){v&&t(d),v&&t(m),v&&t(c),v&&t(C),v&&t(F),v&&t(W),v&&t(N),v&&t(te),v&&t(z)}}}function Xb(G){let d,T,m,c,g;return{c(){d=s("p"),T=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),m=s("code"),c=r("Module"),g=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(n){d=a(n,"P",{});var u=l(d);T=i(u,"Although the recipe for forward pass needs to be defined within this function, one should call the "),m=a(u,"CODE",{});var j=l(m);c=i(j,"Module"),j.forEach(t),g=i(u,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
<span class="hljs-meta">&gt;&gt;&gt; </span>inputs = tokenizer(<span class="hljs-string">&quot;Hello, my dog is cute&quot;</span>, return_tensors=<span class="hljs-string">&quot;tf&quot;</span>)
<span class="hljs-meta">&gt;&gt;&gt; </span>outputs = model(inputs)
<span class="hljs-meta">&gt;&gt;&gt; </span>logits = outputs.logits`}}),{c(){d=s("p"),T=r("Example:"),m=p(),y(c.$$.fragment)},l(n){d=a(n,"P",{});var u=l(d);T=i(u,"Example:"),u.forEach(t),m=h(n),k(c.$$.fragment,n)},m(n,u){_(n,d,u),e(d,T),_(n,m,u),w(c,n,u),g=!0},p:ae,i(n){g||($(c.$$.fragment,n),g=!0)},o(n){P(c.$$.fragment,n),g=!1},d(n){n&&t(d),n&&t(m),M(c,n)}}}function Qb(G){let d,T,m,c,g,n,u,j,Q,C,F,B,S,Z,_e,A,Te,ue,W,N,ee,te,z,q,ie,V,fe,le,O,be,ge,E,ve,U,R,de,K,ye,oe,H,ce,J,ke;return{c(){d=s("p"),T=r("TF 2.0 models accepts two formats as inputs:"),m=p(),c=s("ul"),g=s("li"),n=r("having all inputs as keyword arguments (like PyTorch models), or"),u=p(),j=s("li"),Q=r("having all inputs as a list, tuple or dict in the first positional arguments."),C=p(),F=s("p"),B=r("This second option is useful when using "),S=s("code"),Z=r("tf.keras.Model.fit"),_e=r(` method which currently requires having all the
tensors in the first argument of the model call function: `),A=s("code"),Te=r("model(inputs)"),ue=r("."),W=p(),N=s("p"),ee=r(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),te=p(),z=s("ul"),q=s("li"),ie=r("a single Tensor with "),V=s("code"),fe=r("input_ids"),le=r(" only and nothing else: "),O=s("code"),be=r("model(inputs_ids)"),ge=p(),E=s("li"),ve=r(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),U=s("code"),R=r("model([input_ids, attention_mask])"),de=r(" or "),K=s("code"),ye=r("model([input_ids, attention_mask, token_type_ids])"),oe=p(),H=s("li"),ce=r(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),J=s("code"),ke=r('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(v){d=a(v,"P",{});var x=l(d);T=i(x,"TF 2.0 models accepts two formats as inputs:"),x.forEach(t),m=h(v),c=a(v,"UL",{});var ne=l(c);g=a(ne,"LI",{});var Ee=l(g);n=i(Ee,"having all inputs as keyword arguments (like PyTorch models), or"),Ee.forEach(t),u=h(ne),j=a(ne,"LI",{});var Oe=l(j);Q=i(Oe,"having all inputs as a list, tuple or dict in the first positional arguments."),Oe.forEach(t),ne.forEach(t),C=h(v),F=a(v,"P",{});var I=l(F);B=i(I,"This second option is useful when using "),S=a(I,"CODE",{});var qe=l(S);Z=i(qe,"tf.keras.Model.fit"),qe.forEach(t),_e=i(I,` method which currently requires having all the
...
first positional argument :`),Ue.forEach(t),te=h(v),z=a(v,"UL",{});var D=l(z);q=a(D,"LI",{});var X=l(q);ie=i(X,"a single Tensor with "),V=a(X,"CODE",{});var Re=l(V);fe=i(Re,"input_ids"),Re.forEach(t),le=i(X," only and nothing else: "),O=a(X,"CODE",{});var Ce=l(O);be=i(Ce,"model(inputs_ids)"),Ce.forEach(t),X.forEach(t),ge=h(D),E=a(D,"LI",{});var Y=l(E);ve=i(Y,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),U=a(Y,"CODE",{});var Be=l(U);R=i(Be,"model([input_ids, attention_mask])"),Be.forEach(t),de=i(Y," or "),K=a(Y,"CODE",{});var De=l(K);ye=i(De,"model([input_ids, attention_mask, token_type_ids])"),De.forEach(t),Y.forEach(t),oe=h(D),H=a(D,"LI",{});var we=l(H);ce=i(we,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),J=a(we,"CODE",{});var Ve=l(J);ke=i(Ve,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),Ve.forEach(t),we.forEach(t),D.forEach(t)},m(v,x){_(v,d,x),e(d,T),_(v,m,x),_(v,c,x),e(c,g),e(g,n),e(c,u),e(c,j),e(j,Q),_(v,C,x),_(v,F,x),e(F,B),e(F,S),e(S,Z),e(F,_e),e(F,A),e(A,Te),e(F,ue),_(v,W,x),_(v,N,x),e(N,ee),_(v,te,x),_(v,z,x),e(z,q),e(q,ie),e(q,V),e(V,fe),e(q,le),e(q,O),e(O,be),e(z,ge),e(z,E),e(E,ve),e(E,U),e(U,R),e(E,de),e(E,K),e(K,ye),e(z,oe),e(z,H),e(H,ce),e(H,J),e(J,ke)},d(v){v&&t(d),v&&t(m),v&&t(c),v&&t(C),v&&t(F),v&&t(W),v&&t(N),v&&t(te),v&&t(z)}}}function Zb(G){let d,T,m,c,g;return{c(){d=s("p"),T=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),m=s("code"),c=r("Module"),g=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(n){d=a(n,"P",{});var u=l(d);T=i(u,"Although the recipe for forward pass needs to be defined within this function, one should call the "),m=a(u,"CODE",{});var j=l(m);c=i(j,"Module"),j.forEach(t),g=i(u,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
first positional argument :`),Ue.forEach(t),te=h(v),z=a(v,"UL",{});var D=l(z);q=a(D,"LI",{});var X=l(q);ie=i(X,"a single Tensor with "),V=a(X,"CODE",{});var Re=l(V);fe=i(Re,"input_ids"),Re.forEach(t),le=i(X," only and nothing else: "),O=a(X,"CODE",{});var Ce=l(O);be=i(Ce,"model(inputs_ids)"),Ce.forEach(t),X.forEach(t),ge=h(D),E=a(D,"LI",{});var Y=l(E);ve=i(Y,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),U=a(Y,"CODE",{});var Be=l(U);R=i(Be,"model([input_ids, attention_mask])"),Be.forEach(t),de=i(Y," or "),K=a(Y,"CODE",{});var De=l(K);ye=i(De,"model([input_ids, attention_mask, token_type_ids])"),De.forEach(t),Y.forEach(t),oe=h(D),H=a(D,"LI",{});var we=l(H);ce=i(we,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),J=a(we,"CODE",{});var Ve=l(J);ke=i(Ve,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),Ve.forEach(t),we.forEach(t),D.forEach(t)},m(v,x){_(v,d,x),e(d,T),_(v,m,x),_(v,c,x),e(c,g),e(g,n),e(c,u),e(c,j),e(j,Q),_(v,C,x),_(v,F,x),e(F,B),e(F,S),e(S,Z),e(F,_e),e(F,A),e(A,Te),e(F,ue),_(v,W,x),_(v,N,x),e(N,ee),_(v,te,x),_(v,z,x),e(z,q),e(q,ie),e(q,V),e(V,fe),e(q,le),e(q,O),e(O,be),e(z,ge),e(z,E),e(E,ve),e(E,U),e(U,R),e(E,de),e(E,K),e(K,ye),e(z,oe),e(z,H),e(H,ce),e(H,J),e(J,ke)},d(v){v&&t(d),v&&t(m),v&&t(c),v&&t(C),v&&t(F),v&&t(W),v&&t(N),v&&t(te),v&&t(z)}}}function ov(G){let d,T,m,c,g;return{c(){d=s("p"),T=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),m=s("code"),c=r("Module"),g=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(n){d=a(n,"P",{});var u=l(d);T=i(u,"Although the recipe for forward pass needs to be defined within this function, one should call the "),m=a(u,"CODE",{});var j=l(m);c=i(j,"Module"),j.forEach(t),g=i(u,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
<span class="hljs-meta">&gt;&gt;&gt; </span>next_token_logits = outputs.logits[:, -<span class="hljs-number">1</span>]`}}),{c(){d=s("p"),T=r("Example:"),m=p(),y(c.$$.fragment)},l(n){d=a(n,"P",{});var u=l(d);T=i(u,"Example:"),u.forEach(t),m=h(n),k(c.$$.fragment,n)},m(n,u){_(n,d,u),e(d,T),_(n,m,u),w(c,n,u),g=!0},p:ae,i(n){g||($(c.$$.fragment,n),g=!0)},o(n){P(c.$$.fragment,n),g=!1},d(n){n&&t(d),n&&t(m),M(c,n)}}}function dv(G){let d,T,m,c,g,n,u,j,Q,C,F,B,S,Z,_e,A,Te,ue,W,N,ee,te,z,q,ie,V,fe,le,O,be,ge,E,ve,U,R,de,K,ye,oe,H,ce,J,ke,v,x,ne,Ee,Oe,I,qe,We,Ue,D,X,Re,Ce,Y,Be,De,we,Ve,za,hc,mc,$r,uc,fc,Ea,gc,_c,Tc,yt,bc,Pr,vc,yc,Mr,kc,wc,Cn,$c,Pc,Il,Lt,Dn,Mc,Gc,Gr,xc,jc,Sl,Gt,Fc,Ln,zc,Ec,Nn,qc,Cc,Al,Nt,go,xr,Hn,Dc,jr,Lc,Ol,at,In,Nc,kt,Hc,qa,Ic,Sc,Ca,Ac,Oc,Sn,Wc,Uc,Rc,Ht,Bc,Da,Vc,Kc,La,Jc,Xc,Yc,_o,Wl,It,To,Fr,An,Qc,zr,Zc,Ul,pe,On,ep,Er,tp,op,qr,np,sp,bo,ap,Wn,rp,Cr,ip,lp,dp,vo,cp,Un,pp,Na,hp,mp,up,Ha,Rn,Rl,St,yo,Dr,Bn,fp,Lr,gp,Bl,$e,Vn,_p,Kn,Tp,Nr,bp,vp,yp,Hr,kp,wp,ko,$p,Jn,Pp,Ir,Mp,Gp,xp,wo,jp,Xn,Fp,Ia,zp,Ep,Vl,At,$o,Sr,Yn,qp,Ar,Cp,Kl,Ot,Qn,Dp,Or,Lp,Jl,Wt,Zn,Np,Wr,Hp,Xl,Ut,Po,Ur,es,Ip,Rr,Sp,Yl,Pe,ts,Ap,Br,Op,Wp,os,Up,Sa,Rp,Bp,Vp,ns,Kp,ss,Jp,Xp,Yp,lt,as,Qp,Rt,Zp,Aa,eh,th,Vr,oh,nh,sh,Mo,ah,Go,rh,dt,rs,ih,Kr,lh,dh,Jr,ch,ph,xo,hh,xt,is,mh,Xr,uh,fh,jo,Ql,Bt,Fo,Yr,ls,gh,Qr,_h,Zl,Me,ds,Th,Zr,bh,vh,cs,yh,Oa,kh,wh,$h,ps,Ph,hs,Mh,Gh,xh,ct,ms,jh,Vt,Fh,Wa,zh,Eh,ei,qh,Ch,Dh,zo,Lh,Eo,Nh,pt,us,Hh,ti,Ih,Sh,oi,Ah,Oh,qo,Wh,jt,fs,Uh,ni,Rh,Bh,Co,ed,Kt,Do,si,gs,Vh,ai,Kh,td,Ke,_s,Jh,ri,Xh,Yh,Ts,Qh,Ua,Zh,em,tm,bs,om,vs,nm,sm,am,ht,ys,rm,Jt,im,Ra,lm,dm,ii,cm,pm,hm,Lo,mm,No,od,Xt,Ho,li,ks,um,di,fm,nd,Ge,ws,gm,ci,_m,Tm,Ba,Va,bm,vm,ym,rt,km,pi,wm,$m,hi,Pm,Mm,mi,Gm,xm,ui,jm,Fm,zm,$s,Em,Ka,qm,Cm,Dm,Ps,Lm,Ms,Nm,Hm,Im,Fe,Gs,Sm,Yt,Am,Ja,Om,Wm,fi,Um,Rm,Bm,Io,Vm,So,Km,Ao,Jm,Oo,Xm,Wo,sd,Qt,Uo,gi,xs,Ym,_i,Qm,ad,Je,js,Zm,Ti,eu,tu,Fs,ou,Xa,nu,su,au,zs,ru,Es,iu,lu,du,Xe,qs,cu,Zt,pu,Ya,hu,mu,bi,uu,fu,gu,Ro,_u,Bo,Tu,Vo,rd,eo,Ko,vi,Cs,bu,yi,vu,id,Le,Ds,yu,ki,ku,wu,Ls,$u,Qa,Pu,Mu,Gu,Ns,xu,Hs,ju,Fu,zu,Jo,Eu,mt,Is,qu,to,Cu,Za,Du,Lu,wi,Nu,Hu,Iu,Xo,Su,Yo,ld,oo,Qo,$i,Ss,Au,Pi,Ou,dd,Ne,As,Wu,Mi,Uu,Ru,Os,Bu,er,Vu,Ku,Ju,Ws,Xu,Us,Yu,Qu,Zu,Zo,ef,ut,Rs,tf,no,of,tr,nf,sf,Gi,af,rf,lf,en,df,tn,cd,so,on,xi,Bs,cf,ji,pf,pd,He,Vs,hf,Fi,mf,uf,Ks,ff,or,gf,_f,Tf,Js,bf,Xs,vf,yf,kf,nn,wf,ft,Ys,$f,ao,Pf,nr,Mf,Gf,zi,xf,jf,Ff,sn,zf,an,hd,ro,rn,Ei,Qs,Ef,qi,qf,md,he,Zs,Cf,Ci,Df,Lf,sr,ar,Nf,Hf,If,it,Sf,Di,Af,Of,Li,Wf,Uf,Ni,Rf,Bf,Hi,Vf,Kf,Jf,ea,Xf,rr,Yf,Qf,Zf,ta,eg,oa,tg,og,ng,ln,sg,Ye,na,ag,io,rg,ir,ig,lg,Ii,dg,cg,pg,dn,hg,cn,mg,pn,ud,lo,hn,Si,sa,ug,Ai,fg,fd,co,aa,gg,Oi,_g,gd,po,mn,Wi,ra,Tg,Ui,bg,_d,xe,ia,vg,Ri,yg,kg,la,wg,lr,$g,Pg,Mg,da,Gg,ca,xg,jg,Fg,Bi,zg,Eg,wt,Vi,pa,qg,Cg,Ki,ha,Dg,Lg,Ji,ma,Ng,Hg,Xi,ua,Ig,Sg,gt,fa,Ag,ho,Og,Yi,Wg,Ug,Qi,Rg,Bg,Vg,un,Kg,fn,Td,mo,gn,Zi,ga,Jg,el,Xg,bd,je,_a,Yg,tl,Qg,Zg,Ta,e_,dr,t_,o_,n_,ba,s_,va,a_,r_,i_,ol,l_,d_,$t,nl,ya,c_,p_,sl,ka,h_,m_,al,wa,u_,f_,rl,$a,g_,__,_t,Pa,T_,uo,b_,il,v_,y_,ll,k_,w_,$_,_n,P_,Tn,vd;return n=new ze({}),Z=new ze({}),Hn=new ze({}),In=new L({props:{name:"class transformers.GPT2Config",anchor:"transformers.GPT2Config",parameters:[{name:"vocab_size",val:" = 50257"},{name:"n_positions",val:" = 1024"},{name:"n_embd",val:" = 768"},{name:"n_layer",val:" = 12"},{name:"n_head",val:" = 12"},{name:"n_inner",val:" = None"},{name:"activation_function",val:" = 'gelu_new'"},{name:"resid_pdrop",val:" = 0.1"},{name:"embd_pdrop",val:" = 0.1"},{name:"attn_pdrop",val:" = 0.1"},{name:"layer_norm_epsilon",val:" = 1e-05"},{name:"initializer_range",val:" = 0.02"},{name:"summary_type",val:" = 'cls_index'"},{name:"summary_use_proj",val:" = True"},{name:"summary_activation",val:" = None"},{name:"summary_proj_to_labels",val:" = True"},{name:"summary_first_dropout",val:" = 0.1"},{name:"scale_attn_weights",val:" = True"},{name:"use_cache",val:" = True"},{name:"bos_token_id",val:" = 50256"},{name:"eos_token_id",val:" = 50256"},{name:"scale_attn_by_inverse_layer_idx",val:" = False"},{name:"reorder_and_upcast_attn",val:" = False"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.GPT2Config.vocab_size",description:`<strong>vocab_size</strong> (<code>int</code>, <em>optional</em>, defaults to 50257) &#x2014;
...
heads.`,name:"attentions"}],source:"https://github.com/huggingface/transformers/blob/vmain/src/transformers/models/gpt2/modeling_tf_gpt2.py#L564"}}),es=new ze({}),ts=new L({props:{name:"class transformers.GPT2Model",anchor:"transformers.GPT2Model",parameters:[{name:"config",val:""}],parametersDescription:[{anchor:"transformers.GPT2Model.config",description:`<strong>config</strong> (<a href="/docs/transformers/main/en/model_doc/gpt2#transformers.GPT2Config">GPT2Config</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/main/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/vmain/src/transformers/models/gpt2/modeling_gpt2.py#L667"}}),as=new L({props:{name:"forward",anchor:"transformers.GPT2Model.forward",parameters:[{name:"input_ids",val:" = None"},{name:"past_key_values",val:" = None"},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"encoder_hidden_states",val:" = None"},{name:"encoder_attention_mask",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],parametersDescription:[{anchor:"transformers.GPT2Model.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, input_ids_length)</code>) &#x2014;
...
Whether or not to return a <a href="/docs/transformers/main/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vmain/src/transformers/models/gpt2/modeling_gpt2.py#L736",returnDescription:`
<p>A <a
...
<li>gpt2-large: 36</li>
<li>gpt2-xl: 48</li>
</ul>`,name:"device_map"}],source:"https://github.com/huggingface/transformers/blob/vmain/src/transformers/models/gpt2/modeling_gpt2.py#L690"}}),xo=new se({props:{anchor:"transformers.GPT2Model.parallelize.example",$$slots:{default:[Fb]},$$scope:{ctx:G}}}),is=new L({props:{name:"deparallelize",anchor:"transformers.GPT2Model.deparallelize",parameters:[],source:"https://github.com/huggingface/transformers/blob/vmain/src/transformers/models/gpt2/modeling_gpt2.py#L710"}}),jo=new se({props:{anchor:"transformers.GPT2Model.deparallelize.example",$$slots:{default:[zb]},$$scope:{ctx:G}}}),ls=new ze({}),ds=new L({props:{name:"class transformers.GPT2LMHeadModel",anchor:"transformers.GPT2LMHeadModel",parameters:[{name:"config",val:""}],parametersDescription:[{anchor:"transformers.GPT2LMHeadModel.config",description:`<strong>config</strong> (<a href="/docs/transformers/main/en/model_doc/gpt2#transformers.GPT2Config">GPT2Config</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/main/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/vmain/src/transformers/models/gpt2/modeling_gpt2.py#L945"}}),ms=new L({props:{name:"forward",anchor:"transformers.GPT2LMHeadModel.forward",parameters:[{name:"input_ids",val:" = None"},{name:"past_key_values",val:" = None"},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"encoder_hidden_states",val:" = None"},{name:"encoder_attention_mask",val:" = None"},{name:"labels",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],parametersDescription:[{anchor:"transformers.GPT2LMHeadModel.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, input_ids_length)</code>) &#x2014;
<code>input_ids_length</code> = <code>sequence_length</code> if <code>past_key_values</code> is <code>None</code> else
<code>past_key_values[0][0].shape[-2]</code> (<code>sequence_length</code> of input past key value states). Indices of input
sequence tokens in the vocabulary.</p>
<p>If <code>past_key_values</code> is used, only <code>input_ids</code> that do not have their past calculated should be passed as
...
are ignored (masked), the loss is only computed for labels in <code>[0, ..., config.vocab_size]</code>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vmain/src/transformers/models/gpt2/modeling_gpt2.py#L1014",returnDescription:`
<p>A <a
...
`}}),zo=new Ie({props:{$$slots:{default:[Eb]},$$scope:{ctx:G}}}),Eo=new se({props:{anchor:"transformers.GPT2LMHeadModel.forward.example",$$slots:{default:[qb]},$$scope:{ctx:G}}}),us=new L({props:{name:"parallelize",anchor:"transformers.GPT2LMHeadModel.parallelize",parameters:[{name:"device_map",val:" = None"}],parametersDescription:[{anchor:"transformers.GPT2LMHeadModel.parallelize.device_map",description:`<strong>device_map</strong> (<code>Dict[int, list]</code>, optional, defaults to None) &#x2014;
A dictionary that maps attention modules to devices. Note that the embedding module and LMHead are always
automatically mapped to the first device (for esoteric reasons). That means that the first device should
have fewer attention modules mapped to it than other devices. For reference, the gpt2 models have the
following number of attention modules:</p>
...
<li>gpt2-large: 36</li>
<li>gpt2-xl: 48</li>
</ul>`,name:"device_map"}],source:"https://github.com/huggingface/transformers/blob/vmain/src/transformers/models/gpt2/modeling_gpt2.py#L960"}}),qo=new se({props:{anchor:"transformers.GPT2LMHeadModel.parallelize.example",$$slots:{default:[Cb]},$$scope:{ctx:G}}}),fs=new L({props:{name:"deparallelize",anchor:"transformers.GPT2LMHeadModel.deparallelize",parameters:[],source:"https://github.com/huggingface/transformers/blob/vmain/src/transformers/models/gpt2/modeling_gpt2.py#L972"}}),Co=new se({props:{anchor:"transformers.GPT2LMHeadModel.deparallelize.example",$$slots:{default:[Db]},$$scope:{ctx:G}}}),gs=new ze({}),_s=new L({props:{name:"class transformers.GPT2DoubleHeadsModel",anchor:"transformers.GPT2DoubleHeadsModel",parameters:[{name:"config",val:""}],parametersDescription:[{anchor:"transformers.GPT2DoubleHeadsModel.config",description:`<strong>config</strong> (<a href="/docs/transformers/main/en/model_doc/gpt2#transformers.GPT2Config">GPT2Config</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/main/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/vmain/src/transformers/models/gpt2/modeling_gpt2.py#L1114"}}),ys=new L({props:{name:"forward",anchor:"transformers.GPT2DoubleHeadsModel.forward",parameters:[{name:"input_ids",val:" = None"},{name:"past_key_values",val:" = None"},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"mc_token_ids",val:" = None"},{name:"labels",val:" = None"},{name:"mc_labels",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.GPT2DoubleHeadsModel.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, input_ids_length)</code>) &#x2014;
<code>input_ids_length</code> = <code>sequence_length</code> if <code>past_key_values</code> is <code>None</code> else
<code>past_key_values[0][0].shape[-2]</code> (<code>sequence_length</code> of input past key value states). Indices of input
sequence tokens in the vocabulary.</p>
<p>If <code>past_key_values</code> is used, only <code>input_ids</code> that do not have their past calculated should be passed as
...
where <em>num_choices</em> is the size of the second dimension of the input tensors. (see <em>input_ids</em> above)`,name:"mc_labels"}],source:"https://github.com/huggingface/transformers/blob/vmain/src/transformers/models/gpt2/modeling_gpt2.py#L1188",returnDescription:`
<p>A <a
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/main/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/vmain/src/transformers/models/gpt2/modeling_gpt2.py#L1328"}}),Gs=new L({props:{name:"forward",anchor:"transformers.GPT2ForSequenceClassification.forward",parameters:[{name:"input_ids",val:" = None"},{name:"past_key_values",val:" = None"},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"labels",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],parametersDescription:[{anchor:"transformers.GPT2ForSequenceClassification.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, input_ids_length)</code>) &#x2014;
<code>input_ids_length</code> = <code>sequence_length</code> if <code>past_key_values</code> is <code>None</code> else
<code>past_key_values[0][0].shape[-2]</code> (<code>sequence_length</code> of input past key value states). Indices of input
sequence tokens in the vocabulary.</p>
<p>If <code>past_key_values</code> is used, only <code>input_ids</code> that do not have their past calculated should be passed as
...
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vmain/src/transformers/models/gpt2/modeling_gpt2.py#L1344",returnDescription:`
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/main/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/vmain/src/transformers/models/gpt2/modeling_gpt2.py#L1456"}}),qs=new L({props:{name:"forward",anchor:"transformers.GPT2ForTokenClassification.forward",parameters:[{name:"input_ids",val:" = None"},{name:"past_key_values",val:" = None"},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"labels",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],parametersDescription:[{anchor:"transformers.GPT2ForTokenClassification.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, input_ids_length)</code>) &#x2014;
<code>input_ids_length</code> = <code>sequence_length</code> if <code>past_key_values</code> is <code>None</code> else
<code>past_key_values[0][0].shape[-2]</code> (<code>sequence_length</code> of input past key value states). Indices of input
sequence tokens in the vocabulary.</p>
<p>If <code>past_key_values</code> is used, only <code>input_ids</code> that do not have their past calculated should be passed as
...
Labels for computing the sequence classification/regression loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>. If <code>config.num_labels == 1</code> a regression loss is computed (Mean-Square loss), If
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vmain/src/transformers/models/gpt2/modeling_gpt2.py#L1478",returnDescription:`
<p>A <a
...
If set to <code>True</code>, <code>past_key_values</code> key value states are returned and can be used to speed up decoding (see
<code>past</code>). Set to <code>False</code> during training, <code>True</code> during generation`,name:"use_cache"}],source:"https://github.com/huggingface/transformers/blob/vmain/src/transformers/models/gpt2/modeling_tf_gpt2.py#L712",returnDescription:`
<p>A <a
...
Labels for computing the cross entropy classification loss. Indices should be in <code>[0, ..., config.vocab_size - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vmain/src/transformers/models/gpt2/modeling_tf_gpt2.py#L900",returnDescription:`
<p>A <a
...
Index of the classification token in each input sequence. Selected in the range <code>[0, input_ids.size(-1) - 1[</code>.`,name:"mc_token_ids"}],source:"https://github.com/huggingface/transformers/blob/vmain/src/transformers/models/gpt2/modeling_tf_gpt2.py#L1024",returnDescription:`
<p>A <a
...
Labels for computing the cross entropy classification loss. Indices should be in <code>[0, ..., config.vocab_size - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/vmain/src/transformers/models/gpt2/modeling_tf_gpt2.py#L1175",returnDescription:`
<p>A <a
...
<a href="/docs/transformers/main/en/main_classes/model#transformers.FlaxPreTrainedModel.to_bf16">to_bf16()</a>.`,name:"dtype"}],source:"https://github.com/huggingface/transformers/blob/vmain/src/transformers/models/gpt2/modeling_flax_gpt2.py#L665"}}),fa=new L({props:{name:"__call__",anchor:"transformers.FlaxGPT2Model.__call__",parameters:[{name:"input_ids",val:""},{name:"attention_mask",val:" = None"},{name:"position_ids",val:" = None"},{name:"encoder_hidden_states",val:": typing.Optional[jax._src.numpy.ndarray.ndarray] = None"},{name:"encoder_attention_mask",val:": typing.Optional[jax._src.numpy.ndarray.ndarray] = None"},{name:"params",val:": dict = None"},{name:"past_key_values",val:": dict = None"},{name:"dropout_rng",val:": PRNGKey = None"},{name:"train",val:": bool = False"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.FlaxGPT2Model.__call__.input_ids",description:`<strong>input_ids</strong> (<code>numpy.ndarray</code> of shape <code>(batch_size, input_ids_length)</code>) &#x2014;
...
Whether or not to return a <a href="/docs/transformers/main/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/vmain/src/transformers/models/gpt2/modeling_flax_gpt2.py#L458",returnDescription:`
<p>A <a
...
parameters.</strong></p>
<p>If you wish to change the dtype of the model parameters, see <a href="/docs/transformers/main/en/main_classes/model#transformers.FlaxPreTrainedModel.to_fp16">to_fp16()</a> and
<a href="/docs/transformers/main/en/main_classes/model#transformers.FlaxPreTrainedModel.to_bf16">to_bf16()</a>.`,name:"dtype"}],source:"https://github.com/huggingface/transformers/blob/vmain/src/transformers/models/gpt2/modeling_flax_gpt2.py#L743"}}),Pa=new L({props:{name:"__call__",anchor:"transformers.FlaxGPT2LMHeadModel.__call__",parameters:[{name:"input_ids",val:""},{name:"attention_mask",val:" = None"},{name:"position_ids",val:" = None"},{name:"encoder_hidden_states",val:": typing.Optional[jax._src.numpy.ndarray.ndarray] = None"},{name:"encoder_attention_mask",val:": typing.Optional[jax._src.numpy.ndarray.ndarray] = None"},{name:"params",val:": dict = None"},{name:"past_key_values",val:": dict = None"},{name:"dropout_rng",val:": PRNGKey = None"},{name:"train",val:": bool = False"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.FlaxGPT2LMHeadModel.__call__.input_ids",description:`<strong>input_ids</strong> (<code>numpy.ndarray</code> of shape <code>(batch_size, input_ids_length)</code>) &#x2014;
<code>input_ids_length</code> = <code>sequence_length</code>. Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/main/en/model_doc/gpt2#transformers.GPT2Tokenizer">GPT2Tokenizer</a>. See <a href="/docs/transformers/main/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/main/en/model_doc/wav2vec2_phoneme#transformers.Wav2Vec2PhonemeCTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
call it on some text, but since the model was not pretrained this way, it might yield a decrease in performance.`),dp=p(),y(vo.$$.fragment),cp=p(),Un=s("p"),pp=r("This tokenizer inherits from "),Na=s("a"),hp=r("PreTrainedTokenizer"),mp=r(` which contains most of the main methods. Users should refer to
this superclass for more information regarding those methods.`),up=p(),Ha=s("div"),y(Rn.$$.fragment),Rl=p(),St=s("h2"),yo=s("a"),Dr=s("span"),y(Bn.$$.fragment),fp=p(),Lr=s("span"),gp=r("GPT2TokenizerFast"),Bl=p(),$e=s("div"),y(Vn.$$.fragment),_p=p(),Kn=s("p"),Tp=r("Construct a \u201Cfast\u201D GPT-2 tokenizer (backed by HuggingFace\u2019s "),Nr=s("em"),bp=r("tokenizers"),vp=r(` library). Based on byte-level
...
it will evenly distribute blocks across all devices.`),ph=p(),y(xo.$$.fragment),hh=p(),xt=s("div"),y(is.$$.fragment),mh=p(),Xr=s("p"),uh=r("Moves the model to cpu from a model parallel state."),fh=p(),y(jo.$$.fragment),Ql=p(),Bt=s("h2"),Fo=s("a"),Yr=s("span"),y(ls.$$.fragment),gh=p(),Qr=s("span"),_h=r("GPT2LMHeadModel"),Zl=p(),Me=s("div"),y(ds.$$.fragment),Th=p(),Zr=s("p"),bh=r(`The GPT2 Model transformer with a language modeling head on top (linear layer with weights tied to the input
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),xh=p(),ct=s("div"),y(ms.$$.fragment),jh=p(),Vt=s("p"),Fh=r("The "),Wa=s("a"),zh=r("GPT2LMHeadModel"),Eh=r(" forward method, overrides the "),ei=s("code"),qh=r("__call__"),Ch=r(" special method."),Dh=p(),y(zo.$$.fragment),Lh=p(),y(Eo.$$.fragment),Nh=p(),pt=s("div"),y(us.$$.fragment),Hh=p(),ti=s("p"),Ih=r("This is an experimental feature and is a subject to change at a moment\u2019s notice."),Sh=p(),oi=s("p"),Ah=r(`Uses a device map to distribute attention modules of the model across several devices. If no device map is given,
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),am=p(),ht=s("div"),y(ys.$$.fragment),rm=p(),Jt=s("p"),im=r("The "),Ra=s("a"),lm=r("GPT2DoubleHeadsModel"),dm=r(" forward method, overrides the "),ii=s("code"),cm=r("__call__"),pm=r(" special method."),hm=p(),y(Lo.$$.fragment),mm=p(),y(No.$$.fragment),od=p(),Xt=s("h2"),Ho=s("a"),li=s("span"),y(ks.$$.fragment),um=p(),di=s("span"),fm=r("GPT2ForSequenceClassification"),nd=p(),Ge=s("div"),y(ws.$$.fragment),gm=p(),ci=s("p"),_m=r("The GPT2 Model transformer with a sequence classification head on top (linear layer)."),Tm=p(),Ba=s("p"),Va=s("a"),bm=r("GPT2ForSequenceClassification"),vm=r(` uses the last token in order to do the classification, as other causal models
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Dm=p(),Ps=s("p"),Lm=r("This model is also a PyTorch "),Ms=s("a"),Nm=r("torch.nn.Module"),Hm=r(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Im=p(),Fe=s("div"),y(Gs.$$.fragment),Sm=p(),Yt=s("p"),Am=r("The "),Ja=s("a"),Om=r("GPT2ForSequenceClassification"),Wm=r(" forward method, overrides the "),fi=s("code"),Um=r("__call__"),Rm=r(" special method."),Bm=p(),y(Io.$$.fragment),Vm=p(),y(So.$$.fragment),Km=p(),y(Ao.$$.fragment),Jm=p(),y(Oo.$$.fragment),Xm=p(),y(Wo.$$.fragment),sd=p(),Qt=s("h2"),Uo=s("a"),gi=s("span"),y(xs.$$.fragment),Ym=p(),_i=s("span"),Qm=r("GPT2ForTokenClassification"),ad=p(),Je=s("div"),y(js.$$.fragment),Zm=p(),Ti=s("p"),eu=r(`GPT2 Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g. for
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Gu=p(),Ns=s("p"),xu=r("This model is also a "),Hs=s("a"),ju=r("tf.keras.Model"),Fu=r(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),zu=p(),y(Jo.$$.fragment),Eu=p(),mt=s("div"),y(Is.$$.fragment),qu=p(),to=s("p"),Cu=r("The "),Za=s("a"),Du=r("TFGPT2Model"),Lu=r(" forward method, overrides the "),wi=s("code"),Nu=r("__call__"),Hu=r(" special method."),Iu=p(),y(Xo.$$.fragment),Su=p(),y(Yo.$$.fragment),ld=p(),oo=s("h2"),Qo=s("a"),$i=s("span"),y(Ss.$$.fragment),Au=p(),Pi=s("span"),Ou=r("TFGPT2LMHeadModel"),dd=p(),Ne=s("div"),y(As.$$.fragment),Wu=p(),Mi=s("p"),Uu=r(`The GPT2 Model transformer with a language modeling head on top (linear layer with weights tied to the input
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Zu=p(),y(Zo.$$.fragment),ef=p(),ut=s("div"),y(Rs.$$.fragment),tf=p(),no=s("p"),of=r("The "),tr=s("a"),nf=r("TFGPT2LMHeadModel"),sf=r(" forward method, overrides the "),Gi=s("code"),af=r("__call__"),rf=r(" special method."),lf=p(),y(en.$$.fragment),df=p(),y(tn.$$.fragment),cd=p(),so=s("h2"),on=s("a"),xi=s("span"),y(Bs.$$.fragment),cf=p(),ji=s("span"),pf=r("TFGPT2DoubleHeadsModel"),pd=p(),He=s("div"),y(Vs.$$.fragment),hf=p(),Fi=s("p"),mf=r(`The GPT2 Model transformer with a language modeling and a multiple-choice classification head on top e.g. for
RocStories/SWAG tasks. The two heads are two linear layers. The language modeling head has its weights tied to the
input embeddings, the classification head takes as input the input of a specified classification token index in the
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),kf=p(),y(nn.$$.fragment),wf=p(),ft=s("div"),y(Ys.$$.fragment),$f=p(),ao=s("p"),Pf=r("The "),nr=s("a"),Mf=r("TFGPT2DoubleHeadsModel"),Gf=r(" forward method, overrides the "),zi=s("code"),xf=r("__call__"),jf=r(" special method."),Ff=p(),y(sn.$$.fragment),zf=p(),y(an.$$.fragment),hd=p(),ro=s("h2"),rn=s("a"),Ei=s("span"),y(Qs.$$.fragment),Ef=p(),qi=s("span"),qf=r("TFGPT2ForSequenceClassification"),md=p(),he=s("div"),y(Zs.$$.fragment),Cf=p(),Ci=s("p"),Df=r("The GPT2 Model transformer with a sequence classification head on top (linear layer)."),Lf=p(),sr=s("p"),ar=s("a"),Nf=r("TFGPT2ForSequenceClassification"),Hf=r(` uses the last token in order to do the classification, as other causal models
...
token in a sequence. Leveraging this feature allows GPT-2 to generate syntactically coherent text as it can be
observed in the `),ce=a(ja,"EM",{});var yl=l(ce);J=i(yl,"run_generation.py"),yl.forEach(t),ke=i(ja," example script."),ja.forEach(t),v=h(Pt),x=a(Pt,"LI",{});var me=l(x);ne=i(me,"The model can take the "),Ee=a(me,"EM",{});var kl=l(Ee);Oe=i(kl,"past_key_values"),kl.forEach(t),I=i(me," (for PyTorch) or "),qe=a(me,"EM",{});var wl=l(qe);We=i(wl,"past"),wl.forEach(t),Ue=i(me,` (for TF) as input, which is the previously computed
...
call it on some text, but since the model was not pretrained this way, it might yield a decrease in performance.`),kd.forEach(t),dp=h(Se),k(vo.$$.fragment,Se),cp=h(Se),Un=a(Se,"P",{});var wd=l(Un);pp=i(wd,"This tokenizer inherits from "),Na=a(wd,"A",{href:!0});var S_=l(Na);hp=i(S_,"PreTrainedTokenizer"),S_.forEach(t),mp=i(wd,` which contains most of the main methods. Users should refer to
this superclass for more information regarding those methods.`),wd.forEach(t),up=h(Se),Ha=a(Se,"DIV",{class:!0});var A_=l(Ha);k(Rn.$$.fragment,A_),A_.forEach(t),Se.forEach(t),Rl=h(o),St=a(o,"H2",{class:!0});var $d=l(St);yo=a($d,"A",{id:!0,class:!0,href:!0});var O_=l(yo);Dr=a(O_,"SPAN",{});var W_=l(Dr);k(Bn.$$.fragment,W_),W_.forEach(t),O_.forEach(t),fp=h($d),Lr=a($d,"SPAN",{});var U_=l(Lr);gp=i(U_,"GPT2TokenizerFast"),U_.forEach(t),$d.forEach(t),Bl=h(o),$e=a(o,"DIV",{class:!0});var Qe=l($e);k(Vn.$$.fragment,Qe),_p=h(Qe),Kn=a(Qe,"P",{});var Pd=l(Kn);Tp=i(Pd,"Construct a \u201Cfast\u201D GPT-2 tokenizer (backed by HuggingFace\u2019s "),Nr=a(Pd,"EM",{});var R_=l(Nr);bp=i(R_,"tokenizers"),R_.forEach(t),vp=i(Pd,` library). Based on byte-level
...
it will evenly distribute blocks across all devices.`),d2.forEach(t),ph=h(wn),k(xo.$$.fragment,wn),wn.forEach(t),hh=h(Ze),xt=a(Ze,"DIV",{class:!0});var hr=l(xt);k(is.$$.fragment,hr),mh=h(hr),Xr=a(hr,"P",{});var c2=l(Xr);uh=i(c2,"Moves the model to cpu from a model parallel state."),c2.forEach(t),fh=h(hr),k(jo.$$.fragment,hr),hr.forEach(t),Ze.forEach(t),Ql=h(o),Bt=a(o,"H2",{class:!0});var Cd=l(Bt);Fo=a(Cd,"A",{id:!0,class:!0,href:!0});var p2=l(Fo);Yr=a(p2,"SPAN",{});var h2=l(Yr);k(ls.$$.fragment,h2),h2.forEach(t),p2.forEach(t),gh=h(Cd),Qr=a(Cd,"SPAN",{});var m2=l(Qr);_h=i(m2,"GPT2LMHeadModel"),m2.forEach(t),Cd.forEach(t),Zl=h(o),Me=a(o,"DIV",{class:!0});var et=l(Me);k(ds.$$.fragment,et),Th=h(et),Zr=a(et,"P",{});var u2=l(Zr);bh=i(u2,`The GPT2 Model transformer with a language modeling head on top (linear layer with weights tied to the input
embeddings).`),u2.forEach(t),vh=h(et),cs=a(et,"P",{});var Dd=l(cs);yh=i(Dd,"This model inherits from "),Oa=a(Dd,"A",{href:!0});var f2=l(Oa);kh=i(f2,"PreTrainedModel"),f2.forEach(t),wh=i(Dd,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Ld.forEach(t),xh=h(et),ct=a(et,"DIV",{class:!0});var $n=l(ct);k(ms.$$.fragment,$n),jh=h($n),Vt=a($n,"P",{});var mr=l(Vt);Fh=i(mr,"The "),Wa=a(mr,"A",{href:!0});var _2=l(Wa);zh=i(_2,"GPT2LMHeadModel"),_2.forEach(t),Eh=i(mr," forward method, overrides the "),ei=a(mr,"CODE",{});var T2=l(ei);qh=i(T2,"__call__"),T2.forEach(t),Ch=i(mr," special method."),mr.forEach(t),Dh=h($n),k(zo.$$.fragment,$n),Lh=h($n),k(Eo.$$.fragment,$n),$n.forEach(t),Nh=h(et),pt=a(et,"DIV",{class:!0});var Pn=l(pt);k(us.$$.fragment,Pn),Hh=h(Pn),ti=a(Pn,"P",{});var b2=l(ti);Ih=i(b2,"This is an experimental feature and is a subject to change at a moment\u2019s notice."),b2.forEach(t),Sh=h(Pn),oi=a(Pn,"P",{});var v2=l(oi);Ah=i(v2,`Uses a device map to distribute attention modules of the model across several devices. If no device map is given,
it will evenly distribute blocks across all devices.`),v2.forEach(t),Oh=h(Pn),k(qo.$$.fragment,Pn),Pn.forEach(t),Wh=h(et),jt=a(et,"DIV",{class:!0});var ur=l(jt);k(fs.$$.fragment,ur),Uh=h(ur),ni=a(ur,"P",{});var y2=l(ni);Rh=i(y2,"Moves the model to cpu from a model parallel state."),y2.forEach(t),Bh=h(ur),k(Co.$$.fragment,ur),ur.forEach(t),et.forEach(t),ed=h(o),Kt=a(o,"H2",{class:!0});var Nd=l(Kt);Do=a(Nd,"A",{id:!0,class:!0,href:!0});var k2=l(Do);si=a(k2,"SPAN",{});var w2=l(si);k(gs.$$.fragment,w2),w2.forEach(t),k2.forEach(t),Vh=h(Nd),ai=a(Nd,"SPAN",{});var $2=l(ai);Kh=i($2,"GPT2DoubleHeadsModel"),$2.forEach(t),Nd.forEach(t),td=h(o),Ke=a(o,"DIV",{class:!0});var Ft=l(Ke);k(_s.$$.fragment,Ft),Jh=h(Ft),ri=a(Ft,"P",{});var P2=l(ri);Xh=i(P2,`The GPT2 Model transformer with a language modeling and a multiple-choice classification head on top e.g. for
RocStories/SWAG tasks. The two heads are two linear layers. The language modeling head has its weights tied to the
input embeddings, the classification head takes as input the input of a specified classification token index in the
input sequence).`),P2.forEach(t),Yh=h(Ft),Ts=a(Ft,"P",{});var Hd=l(Ts);Qh=i(Hd,"This model inherits from "),Ua=a(Hd,"A",{href:!0});var M2=l(Ua);Zh=i(M2,"PreTrainedModel"),M2.forEach(t),em=i(Hd,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Hd.forEach(t),tm=h(Ft),bs=a(Ft,"P",{});var Id=l(bs);om=i(Id,"This model is also a PyTorch "),vs=a(Id,"A",{href:!0,rel:!0});var G2=l(vs);nm=i(G2,"torch.nn.Module"),G2.forEach(t),sm=i(Id,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Id.forEach(t),am=h(Ft),ht=a(Ft,"DIV",{class:!0});var Mn=l(ht);k(ys.$$.fragment,Mn),rm=h(Mn),Jt=a(Mn,"P",{});var fr=l(Jt);im=i(fr,"The "),Ra=a(fr,"A",{href:!0});var x2=l(Ra);lm=i(x2,"GPT2DoubleHeadsModel"),x2.forEach(t),dm=i(fr," forward method, overrides the "),ii=a(fr,"CODE",{});var j2=l(ii);cm=i(j2,"__call__"),j2.forEach(t),pm=i(fr," special method."),fr.forEach(t),hm=h(Mn),k(Lo.$$.fragment,Mn),mm=h(Mn),k(No.$$.fragment,Mn),Mn.forEach(t),Ft.forEach(t),od=h(o),Xt=a(o,"H2",{class:!0});var Sd=l(Xt);Ho=a(Sd,"A",{id:!0,class:!0,href:!0});var F2=l(Ho);li=a(F2,"SPAN",{});var z2=l(li);k(ks.$$.fragment,z2),z2.forEach(t),F2.forEach(t),um=h(Sd),di=a(Sd,"SPAN",{});var E2=l(di);fm=i(E2,"GPT2ForSequenceClassification"),E2.forEach(t),Sd.forEach(t),nd=h(o),Ge=a(o,"DIV",{class:!0});var tt=l(Ge);k(ws.$$.fragment,tt),gm=h(tt),ci=a(tt,"P",{});var q2=l(ci);_m=i(q2,"The GPT2 Model transformer with a sequence classification head on top (linear layer)."),q2.forEach(t),Tm=h(tt),Ba=a(tt,"P",{});var M_=l(Ba);Va=a(M_,"A",{href:!0});var C2=l(Va);bm=i(C2,"GPT2ForSequenceClassification"),C2.forEach(t),vm=i(M_,` uses the last token in order to do the classification, as other causal models
...
`),pi=a(zt,"CODE",{});var D2=l(pi);wm=i(D2,"pad_token_id"),D2.forEach(t),$m=i(zt,` is defined in the configuration, it finds the last token that is not a padding token in each row. If
no `),hi=a(zt,"CODE",{});var L2=l(hi);Pm=i(L2,"pad_token_id"),L2.forEach(t),Mm=i(zt,` is defined, it simply takes the last value in each row of the batch. Since it cannot guess the
padding tokens when `),mi=a(zt,"CODE",{});var N2=l(mi);Gm=i(N2,"inputs_embeds"),N2.forEach(t),xm=i(zt," are passed instead of "),ui=a(zt,"CODE",{});var H2=l(ui);jm=i(H2,"input_ids"),H2.forEach(t),Fm=i(zt,`, it does the same (take the last value in
each row of the batch).`),zt.forEach(t),zm=h(tt),$s=a(tt,"P",{});var Ad=l($s);Em=i(Ad,"This model inherits from "),Ka=a(Ad,"A",{href:!0});var I2=l(Ka);qm=i(I2,"PreTrainedModel"),I2.forEach(t),Cm=i(Ad,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Ad.forEach(t),Dm=h(tt),Ps=a(tt,"P",{});var Od=l(Ps);Lm=i(Od,"This model is also a PyTorch "),Ms=a(Od,"A",{href:!0,rel:!0});var S2=l(Ms);Nm=i(S2,"torch.nn.Module"),S2.forEach(t),Hm=i(Od,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Od.forEach(t),Im=h(tt),Fe=a(tt,"DIV",{class:!0});var ot=l(Fe);k(Gs.$$.fragment,ot),Sm=h(ot),Yt=a(ot,"P",{});var gr=l(Yt);Am=i(gr,"The "),Ja=a(gr,"A",{href:!0});var A2=l(Ja);Om=i(A2,"GPT2ForSequenceClassification"),A2.forEach(t),Wm=i(gr," forward method, overrides the "),fi=a(gr,"CODE",{});var O2=l(fi);Um=i(O2,"__call__"),O2.forEach(t),Rm=i(gr," special method."),gr.forEach(t),Bm=h(ot),k(Io.$$.fragment,ot),Vm=h(ot),k(So.$$.fragment,ot),Km=h(ot),k(Ao.$$.fragment,ot),Jm=h(ot),k(Oo.$$.fragment,ot),Xm=h(ot),k(Wo.$$.fragment,ot),ot.forEach(t),tt.forEach(t),sd=h(o),Qt=a(o,"H2",{class:!0});var Wd=l(Qt);Uo=a(Wd,"A",{id:!0,class:!0,href:!0});var W2=l(Uo);gi=a(W2,"SPAN",{});var U2=l(gi);k(xs.$$.fragment,U2),U2.forEach(t),W2.forEach(t),Ym=h(Wd),_i=a(Wd,"SPAN",{});var R2=l(_i);Qm=i(R2,"GPT2ForTokenClassification"),R2.forEach(t),Wd.forEach(t),ad=h(o),Je=a(o,"DIV",{class:!0});var Et=l(Je);k(js.$$.fragment,Et),Zm=h(Et),Ti=a(Et,"P",{});var B2=l(Ti);eu=i(B2,`GPT2 Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g. for
Named-Entity-Recognition (NER) tasks.`),B2.forEach(t),tu=h(Et),Fs=a(Et,"P",{});var Ud=l(Fs);ou=i(Ud,"This model inherits from "),Xa=a(Ud,"A",{href:!0});var V2=l(Xa);nu=i(V2,"PreTrainedModel"),V2.forEach(t),su=i(Ud,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Ud.forEach(t),au=h(Et),zs=a(Et,"P",{});var Rd=l(zs);ru=i(Rd,"This model is also a PyTorch "),Es=a(Rd,"A",{href:!0,rel:!0});var K2=l(Es);iu=i(K2,"torch.nn.Module"),K2.forEach(t),lu=i(Rd,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Rd.forEach(t),du=h(Et),Xe=a(Et,"DIV",{class:!0});var qt=l(Xe);k(qs.$$.fragment,qt),cu=h(qt),Zt=a(qt,"P",{});var _r=l(Zt);pu=i(_r,"The "),Ya=a(_r,"A",{href:!0});var J2=l(Ya);hu=i(J2,"GPT2ForTokenClassification"),J2.forEach(t),mu=i(_r," forward method, overrides the "),bi=a(_r,"CODE",{});var X2=l(bi);uu=i(X2,"__call__"),X2.forEach(t),fu=i(_r," special method."),_r.forEach(t),gu=h(qt),k(Ro.$$.fragment,qt),_u=h(qt),k(Bo.$$.fragment,qt),Tu=h(qt),k(Vo.$$.fragment,qt),qt.forEach(t),Et.forEach(t),rd=h(o),eo=a(o,"H2",{class:!0});var Bd=l(eo);Ko=a(Bd,"A",{id:!0,class:!0,href:!0});var Y2=l(Ko);vi=a(Y2,"SPAN",{});var Q2=l(vi);k(Cs.$$.fragment,Q2),Q2.forEach(t),Y2.forEach(t),bu=h(Bd),yi=a(Bd,"SPAN",{});var Z2=l(yi);vu=i(Z2,"TFGPT2Model"),Z2.forEach(t),Bd.forEach(t),id=h(o),Le=a(o,"DIV",{class:!0});var Tt=l(Le);k(Ds.$$.fragment,Tt),yu=h(Tt),ki=a(Tt,"P",{});var eT=l(ki);ku=i(eT,"The bare GPT2 Model transformer outputting raw hidden-states without any specific head on top."),eT.forEach(t),wu=h(Tt),Ls=a(Tt,"P",{});var Vd=l(Ls);$u=i(Vd,"This model inherits from "),Qa=a(Vd,"A",{href:!0});var tT=l(Qa);Pu=i(tT,"TFPreTrainedModel"),tT.forEach(t),Mu=i(Vd,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Vd.forEach(t),Gu=h(Tt),Ns=a(Tt,"P",{});var Kd=l(Ns);xu=i(Kd,"This model is also a "),Hs=a(Kd,"A",{href:!0,rel:!0});var oT=l(Hs);ju=i(oT,"tf.keras.Model"),oT.forEach(t),Fu=i(Kd,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Kd.forEach(t),zu=h(Tt),k(Jo.$$.fragment,Tt),Eu=h(Tt),mt=a(Tt,"DIV",{class:!0});var Gn=l(mt);k(Is.$$.fragment,Gn),qu=h(Gn),to=a(Gn,"P",{});var Tr=l(to);Cu=i(Tr,"The "),Za=a(Tr,"A",{href:!0});var nT=l(Za);Du=i(nT,"TFGPT2Model"),nT.forEach(t),Lu=i(Tr," forward method, overrides the "),wi=a(Tr,"CODE",{});var sT=l(wi);Nu=i(sT,"__call__"),sT.forEach(t),Hu=i(Tr," special method."),Tr.forEach(t),Iu=h(Gn),k(Xo.$$.fragment,Gn),Su=h(Gn),k(Yo.$$.fragment,Gn),Gn.forEach(t),Tt.forEach(t),ld=h(o),oo=a(o,"H2",{class:!0});var Jd=l(oo);Qo=a(Jd,"A",{id:!0,class:!0,href:!0});var aT=l(Qo);$i=a(aT,"SPAN",{});var rT=l($i);k(Ss.$$.fragment,rT),rT.forEach(t),aT.forEach(t),Au=h(Jd),Pi=a(Jd,"SPAN",{});var iT=l(Pi);Ou=i(iT,"TFGPT2LMHeadModel"),iT.forEach(t),Jd.forEach(t),dd=h(o),Ne=a(o,"DIV",{class:!0});var bt=l(Ne);k(As.$$.fragment,bt),Wu=h(bt),Mi=a(bt,"P",{});var lT=l(Mi);Uu=i(lT,`The GPT2 Model transformer with a language modeling head on top (linear layer with weights tied to the input
embeddings).`),lT.forEach(t),Ru=h(bt),Os=a(bt,"P",{});var Xd=l(Os);Bu=i(Xd,"This model inherits from "),er=a(Xd,"A",{href:!0});var dT=l(er);Vu=i(dT,"TFPreTrainedModel"),dT.forEach(t),Ku=i(Xd,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Xd.forEach(t),Ju=h(bt),Ws=a(bt,"P",{});var Yd=l(Ws);Xu=i(Yd,"This model is also a "),Us=a(Yd,"A",{href:!0,rel:!0});var cT=l(Us);Yu=i(cT,"tf.keras.Model"),cT.forEach(t),Qu=i(Yd,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Yd.forEach(t),Zu=h(bt),k(Zo.$$.fragment,bt),ef=h(bt),ut=a(bt,"DIV",{class:!0});var xn=l(ut);k(Rs.$$.fragment,xn),tf=h(xn),no=a(xn,"P",{});var br=l(no);of=i(br,"The "),tr=a(br,"A",{href:!0});var pT=l(tr);nf=i(pT,"TFGPT2LMHeadModel"),pT.forEach(t),sf=i(br," forward method, overrides the "),Gi=a(br,"CODE",{});var hT=l(Gi);af=i(hT,"__call__"),hT.forEach(t),rf=i(br," special method."),br.forEach(t),lf=h(xn),k(en.$$.fragment,xn),df=h(xn),k(tn.$$.fragment,xn),xn.forEach(t),bt.forEach(t),cd=h(o),so=a(o,"H2",{class:!0});var Qd=l(so);on=a(Qd,"A",{id:!0,class:!0,href:!0});var mT=l(on);xi=a(mT,"SPAN",{});var uT=l(xi);k(Bs.$$.fragment,uT),uT.forEach(t),mT.forEach(t),cf=h(Qd),ji=a(Qd,"SPAN",{});var fT=l(ji);pf=i(fT,"TFGPT2DoubleHeadsModel"),fT.forEach(t),Qd.forEach(t),pd=h(o),He=a(o,"DIV",{class:!0});var vt=l(He);k(Vs.$$.fragment,vt),hf=h(vt),Fi=a(vt,"P",{});var gT=l(Fi);mf=i(gT,`The GPT2 Model transformer with a language modeling and a multiple-choice classification head on top e.g. for
RocStories/SWAG tasks. The two heads are two linear layers. The language modeling head has its weights tied to the
input embeddings, the classification head takes as input the input of a specified classification token index in the
input sequence).`),gT.forEach(t),uf=h(vt),Ks=a(vt,"P",{});var Zd=l(Ks);ff=i(Zd,"This model inherits from "),or=a(Zd,"A",{href:!0});var _T=l(or);gf=i(_T,"TFPreTrainedModel"),_T.forEach(t),_f=i(Zd,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
