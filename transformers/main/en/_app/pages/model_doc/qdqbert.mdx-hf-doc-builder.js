import{S as wm,i as vm,s as $m,e as a,k as p,w as Q,t as n,M as Tm,c as r,d as o,m as h,a as i,x as w,h as s,b as f,G as e,g as b,y as v,q as $,o as T,B as y,v as ym,L as O}from"../../chunks/vendor-hf-doc-builder.js";import{T as xt}from"../../chunks/Tip-hf-doc-builder.js";import{D as j}from"../../chunks/Docstring-hf-doc-builder.js";import{C as M}from"../../chunks/CodeBlock-hf-doc-builder.js";import{I as J}from"../../chunks/IconCopyLink-hf-doc-builder.js";import{E as I}from"../../chunks/ExampleCodeBlock-hf-doc-builder.js";function qm(q){let d,_,c,m,k;return m=new M({props:{code:`from transformers import QDQBertModel, QDQBertConfig
...
`}}),{c(){Q(d.$$.fragment)},l(c){w(d.$$.fragment,c)},m(c,m){v(d,c,m),_=!0},p:O,i(c){_||($(d.$$.fragment,c),_=!0)},o(c){T(d.$$.fragment,c),_=!1},d(c){y(d,c)}}}function Fm(q){let d,_,c,m,k;return{c(){d=a("p"),_=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),c=a("code"),m=n("Module"),k=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(l){d=r(l,"P",{});var u=i(d);_=s(u,"Although the recipe for forward pass needs to be defined within this function, one should call the "),c=r(u,"CODE",{});var D=i(c);m=s(D,"Module"),D.forEach(o),k=s(u,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
<span class="hljs-meta">&gt;&gt;&gt; </span>loss = outputs.loss
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-built_in">round</span>(loss.item(), <span class="hljs-number">2</span>)
`}}),{c(){Q(d.$$.fragment)},l(c){w(d.$$.fragment,c)},m(c,m){v(d,c,m),_=!0},p:O,i(c){_||($(d.$$.fragment,c),_=!0)},o(c){T(d.$$.fragment,c),_=!1},d(c){y(d,c)}}}function Jm(q){let d,_,c,m,k,l,u,D,Dr,da,fe,Se,Sn,jt,zr,Ln,Br,ca,Le,Mr,Et,xr,jr,pa,tn,Er,ha,on,In,Fr,ma,nn,Pr,ua,G,On,Wn,Cr,Ar,Hn,Ie,Nr,Ft,Sr,Lr,Rn,Ir,Or,Un,Pt,Wr,Vn,Hr,Rr,Ur,Xn,Ct,Vr,sn,Xr,Jr,fa,Oe,Kr,At,Gr,Yr,ga,ge,We,Jn,Nt,Zr,Kn,ei,_a,E,ti,Gn,oi,ni,St,si,ai,Yn,ri,ii,Zn,li,di,Lt,ci,pi,ba,He,hi,es,mi,ui,ka,an,fi,Qa,It,wa,_e,Re,ts,Ot,gi,os,_i,va,rn,bi,$a,Wt,Ta,be,Ue,ns,Ht,ki,ss,Qi,ya,se,wi,Rt,vi,$i,Ut,Ti,yi,qa,Vt,Da,ke,Ve,as,Xt,qi,rs,Di,za,K,Jt,zi,Qe,Bi,ln,Mi,xi,Kt,ji,Ei,Fi,we,Pi,dn,Ci,Ai,cn,Ni,Si,Li,Xe,Ba,ve,Je,is,Gt,Ii,ls,Oi,Ma,z,Yt,Wi,ds,Hi,Ri,Zt,Ui,pn,Vi,Xi,Ji,eo,Ki,to,Gi,Yi,Zi,oo,el,no,tl,ol,nl,x,sl,cs,al,rl,ps,il,ll,hs,dl,cl,ms,pl,hl,us,ml,ul,fs,fl,gl,_l,Y,so,bl,$e,kl,hn,Ql,wl,gs,vl,$l,Tl,Ke,yl,Ge,xa,Te,Ye,_s,ao,ql,bs,Dl,ja,F,ro,zl,io,Bl,ks,Ml,xl,jl,lo,El,mn,Fl,Pl,Cl,co,Al,po,Nl,Sl,Ll,Z,ho,Il,ye,Ol,un,Wl,Hl,Qs,Rl,Ul,Vl,Ze,Xl,et,Ea,qe,tt,ws,mo,Jl,vs,Kl,Fa,P,uo,Gl,fo,Yl,$s,Zl,ed,td,go,od,fn,nd,sd,ad,_o,rd,bo,id,ld,dd,W,ko,cd,De,pd,gn,hd,md,Ts,ud,fd,gd,ot,_d,nt,bd,st,Pa,ze,at,ys,Qo,kd,qs,Qd,Ca,C,wo,wd,Ds,vd,$d,vo,Td,_n,yd,qd,Dd,$o,zd,To,Bd,Md,xd,B,yo,jd,Be,Ed,bn,Fd,Pd,zs,Cd,Ad,Nd,rt,Sd,it,Ld,lt,Id,dt,Od,ct,Aa,Me,pt,Bs,qo,Wd,Ms,Hd,Na,A,Do,Rd,zo,Ud,xs,Vd,Xd,Jd,Bo,Kd,kn,Gd,Yd,Zd,Mo,ec,xo,tc,oc,nc,ee,jo,sc,xe,ac,Qn,rc,ic,js,lc,dc,cc,ht,pc,mt,Sa,je,ut,Es,Eo,hc,Fs,mc,La,N,Fo,uc,Ps,fc,gc,Po,_c,wn,bc,kc,Qc,Co,wc,Ao,vc,$c,Tc,te,No,yc,Ee,qc,vn,Dc,zc,Cs,Bc,Mc,xc,ft,jc,gt,Ia,Fe,_t,As,So,Ec,Ns,Fc,Oa,S,Lo,Pc,Ss,Cc,Ac,Io,Nc,$n,Sc,Lc,Ic,Oo,Oc,Wo,Wc,Hc,Rc,H,Ho,Uc,Pe,Vc,Tn,Xc,Jc,Ls,Kc,Gc,Yc,bt,Zc,kt,ep,Qt,Wa,Ce,wt,Is,Ro,tp,Os,op,Ha,L,Uo,np,Ae,sp,Ws,ap,rp,Hs,ip,lp,dp,Vo,cp,yn,pp,hp,mp,Xo,up,Jo,fp,gp,_p,R,Ko,bp,Ne,kp,qn,Qp,wp,Rs,vp,$p,Tp,vt,yp,$t,qp,Tt,Ra;return l=new J({}),jt=new J({}),Nt=new J({}),It=new M({props:{code:`import pytorch_quantization.nn as quant_nn
...
`}}),rt=new xt({props:{$$slots:{default:[Fm]},$$scope:{ctx:q}}}),it=new I({props:{anchor:"transformers.QDQBertForSequenceClassification.forward.example",$$slots:{default:[Pm]},$$scope:{ctx:q}}}),lt=new I({props:{anchor:"transformers.QDQBertForSequenceClassification.forward.example-2",$$slots:{default:[Cm]},$$scope:{ctx:q}}}),dt=new I({props:{anchor:"transformers.QDQBertForSequenceClassification.forward.example-3",$$slots:{default:[Am]},$$scope:{ctx:q}}}),ct=new I({props:{anchor:"transformers.QDQBertForSequenceClassification.forward.example-4",$$slots:{default:[Nm]},$$scope:{ctx:q}}}),qo=new J({}),Do=new j({props:{name:"class transformers.QDQBertForNextSentencePrediction",anchor:"transformers.QDQBertForNextSentencePrediction",parameters:[{name:"config",val:""}],parametersDescription:[{anchor:"transformers.QDQBertForNextSentencePrediction.config",description:`<strong>config</strong> (<a href="/docs/transformers/main/en/model_doc/qdqbert#transformers.QDQBertConfig">QDQBertConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
...
`),Kt=a("a"),ji=n("bert-base-uncased"),Ei=n(" architecture."),Fi=p(),we=a("p"),Pi=n("Configuration objects inherit from "),dn=a("a"),Ci=n("PretrainedConfig"),Ai=n(` and can be used to control the model outputs. Read the
...
`),ms=a("code"),pl=n("add_cross_attention"),hl=n(" set to "),us=a("code"),ml=n("True"),ul=n("; an "),fs=a("code"),fl=n("encoder_hidden_states"),gl=n(" is then expected as an input to the forward pass."),_l=p(),Y=a("div"),Q(so.$$.fragment),bl=p(),$e=a("p"),kl=n("The "),hn=a("a"),Ql=n("QDQBertModel"),wl=n(" forward method, overrides the "),gs=a("code"),vl=n("__call__"),$l=n(" special method."),Tl=p(),Q(Ke.$$.fragment),yl=p(),Q(Ge.$$.fragment),xa=p(),Te=a("h2"),Ye=a("a"),_s=a("span"),Q(ao.$$.fragment),ql=p(),bs=a("span"),Dl=n("QDQBertLMHeadModel"),ja=p(),F=a("div"),Q(ro.$$.fragment),zl=p(),io=a("p"),Bl=n("QDQBERT Model with a "),ks=a("code"),Ml=n("language modeling"),xl=n(" head on top for CLM fine-tuning."),jl=p(),lo=a("p"),El=n("This model inherits from "),mn=a("a"),Fl=n("PreTrainedModel"),Pl=n(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Cl=p(),co=a("p"),Al=n("This model is also a PyTorch "),po=a("a"),Nl=n("torch.nn.Module"),Sl=n(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Ll=p(),Z=a("div"),Q(ho.$$.fragment),Il=p(),ye=a("p"),Ol=n("The "),un=a("a"),Wl=n("QDQBertLMHeadModel"),Hl=n(" forward method, overrides the "),Qs=a("code"),Rl=n("__call__"),Ul=n(" special method."),Vl=p(),Q(Ze.$$.fragment),Xl=p(),Q(et.$$.fragment),Ea=p(),qe=a("h2"),tt=a("a"),ws=a("span"),Q(mo.$$.fragment),Jl=p(),vs=a("span"),Kl=n("QDQBertForMaskedLM"),Fa=p(),P=a("div"),Q(uo.$$.fragment),Gl=p(),fo=a("p"),Yl=n("QDQBERT Model with a "),$s=a("code"),Zl=n("language modeling"),ed=n(" head on top."),td=p(),go=a("p"),od=n("This model inherits from "),fn=a("a"),nd=n("PreTrainedModel"),sd=n(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),nc=p(),ee=a("div"),Q(jo.$$.fragment),sc=p(),xe=a("p"),ac=n("The "),Qn=a("a"),rc=n("QDQBertForNextSentencePrediction"),ic=n(" forward method, overrides the "),js=a("code"),lc=n("__call__"),dc=n(" special method."),cc=p(),Q(ht.$$.fragment),pc=p(),Q(mt.$$.fragment),Sa=p(),je=a("h2"),ut=a("a"),Es=a("span"),Q(Eo.$$.fragment),hc=p(),Fs=a("span"),mc=n("QDQBertForMultipleChoice"),La=p(),N=a("div"),Q(Fo.$$.fragment),uc=p(),Ps=a("p"),fc=n(`Bert Model with a multiple choice classification head on top (a linear layer on top of the pooled output and a
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Tc=p(),te=a("div"),Q(No.$$.fragment),yc=p(),Ee=a("p"),qc=n("The "),vn=a("a"),Dc=n("QDQBertForMultipleChoice"),zc=n(" forward method, overrides the "),Cs=a("code"),Bc=n("__call__"),Mc=n(" special method."),xc=p(),Q(ft.$$.fragment),jc=p(),Q(gt.$$.fragment),Ia=p(),Fe=a("h2"),_t=a("a"),As=a("span"),Q(So.$$.fragment),Ec=p(),Ns=a("span"),Fc=n("QDQBertForTokenClassification"),Oa=p(),S=a("div"),Q(Lo.$$.fragment),Pc=p(),Ss=a("p"),Cc=n(`QDQBERT Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g. for
...
SQUAD task can be found at `),sn=r(Ua,"A",{href:!0});var Bp=i(sn);Xr=s(Bp,"transformers/examples/research_projects/quantization-qdqbert/"),Bp.forEach(o),Jr=s(Ua,"."),Ua.forEach(o),zp.forEach(o),ne.forEach(o),fa=h(t),Oe=r(t,"P",{});var Va=i(Oe);Kr=s(Va,"This model was contributed by "),At=r(Va,"A",{href:!0,rel:!0});var Mp=i(At);Gr=s(Mp,"shangz"),Mp.forEach(o),Yr=s(Va,"."),Va.forEach(o),ga=h(t),ge=r(t,"H3",{class:!0});var Xa=i(ge);We=r(Xa,"A",{id:!0,class:!0,href:!0});var xp=i(We);Jn=r(xp,"SPAN",{});var jp=i(Jn);w(Nt.$$.fragment,jp),jp.forEach(o),xp.forEach(o),Zr=h(Xa),Kn=r(Xa,"SPAN",{});var Ep=i(Kn);ei=s(Ep,"Set default quantizers"),Ep.forEach(o),Xa.forEach(o),_a=h(t),E=r(t,"P",{});var oe=i(E);ti=s(oe,`QDQBERT model adds fake quantization operations (pair of QuantizeLinear/DequantizeLinear ops) to BERT by
`),Gn=r(oe,"CODE",{});var Fp=i(Gn);oi=s(Fp,"TensorQuantizer"),Fp.forEach(o),ni=s(oe," in "),St=r(oe,"A",{href:!0,rel:!0});var Pp=i(St);si=s(Pp,"Pytorch Quantization Toolkit"),Pp.forEach(o),ai=s(oe,". "),Yn=r(oe,"CODE",{});var Cp=i(Yn);ri=s(Cp,"TensorQuantizer"),Cp.forEach(o),ii=s(oe,` is the module
...
QDQBERT model according to the specified arguments, defining the model architecture. Instantiating a configuration
with the defaults will yield a similar configuration to that of the BERT
`),Kt=r(zn,"A",{href:!0,rel:!0});var eh=i(Kt);ji=s(eh,"bert-base-uncased"),eh.forEach(o),Ei=s(zn," architecture."),zn.forEach(o),Fi=h(qt),we=r(qt,"P",{});var Bn=i(we);Pi=s(Bn,"Configuration objects inherit from "),dn=r(Bn,"A",{href:!0});var th=i(dn);Ci=s(th,"PretrainedConfig"),th.forEach(o),Ai=s(Bn,` and can be used to control the model outputs. Read the
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),mr.forEach(o),xd=h(le),B=r(le,"DIV",{class:!0});var X=i(B);w(yo.$$.fragment,X),jd=h(X),Be=r(X,"P",{});var En=i(Be);Ed=s(En,"The "),bn=r(En,"A",{href:!0});var Lh=i(bn);Fd=s(Lh,"QDQBertForSequenceClassification"),Lh.forEach(o),Pd=s(En," forward method, overrides the "),zs=r(En,"CODE",{});var Ih=i(zs);Cd=s(Ih,"__call__"),Ih.forEach(o),Ad=s(En," special method."),En.forEach(o),Nd=h(X),w(rt.$$.fragment,X),Sd=h(X),w(it.$$.fragment,X),Ld=h(X),w(lt.$$.fragment,X),Id=h(X),w(dt.$$.fragment,X),Od=h(X),w(ct.$$.fragment,X),X.forEach(o),le.forEach(o),Aa=h(t),Me=r(t,"H2",{class:!0});var ur=i(Me);pt=r(ur,"A",{id:!0,class:!0,href:!0});var Oh=i(pt);Bs=r(Oh,"SPAN",{});var Wh=i(Bs);w(qo.$$.fragment,Wh),Wh.forEach(o),Oh.forEach(o),Wd=h(ur),Ms=r(ur,"SPAN",{});var Hh=i(Ms);Hd=s(Hh,"QDQBertForNextSentencePrediction"),Hh.forEach(o),ur.forEach(o),Na=h(t),A=r(t,"DIV",{class:!0});var de=i(A);w(Do.$$.fragment,de),Rd=h(de),zo=r(de,"P",{});var fr=i(zo);Ud=s(fr,"Bert Model with a "),xs=r(fr,"CODE",{});var Rh=i(xs);Vd=s(Rh,"next sentence prediction (classification)"),Rh.forEach(o),Xd=s(fr," head on top."),fr.forEach(o),Jd=h(de),Bo=r(de,"P",{});var gr=i(Bo);Kd=s(gr,"This model inherits from "),kn=r(gr,"A",{href:!0});var Uh=i(kn);Gd=s(Uh,"PreTrainedModel"),Uh.forEach(o),Yd=s(gr,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),_r.forEach(o),nc=h(de),ee=r(de,"DIV",{class:!0});var Bt=i(ee);w(jo.$$.fragment,Bt),sc=h(Bt),xe=r(Bt,"P",{});var Fn=i(xe);ac=s(Fn,"The "),Qn=r(Fn,"A",{href:!0});var Xh=i(Qn);rc=s(Xh,"QDQBertForNextSentencePrediction"),Xh.forEach(o),ic=s(Fn," forward method, overrides the "),js=r(Fn,"CODE",{});var Jh=i(js);lc=s(Jh,"__call__"),Jh.forEach(o),dc=s(Fn," special method."),Fn.forEach(o),cc=h(Bt),w(ht.$$.fragment,Bt),pc=h(Bt),w(mt.$$.fragment,Bt),Bt.forEach(o),de.forEach(o),Sa=h(t),je=r(t,"H2",{class:!0});var br=i(je);ut=r(br,"A",{id:!0,class:!0,href:!0});var Kh=i(ut);Es=r(Kh,"SPAN",{});var Gh=i(Es);w(Eo.$$.fragment,Gh),Gh.forEach(o),Kh.forEach(o),hc=h(br),Fs=r(br,"SPAN",{});var Yh=i(Fs);mc=s(Yh,"QDQBertForMultipleChoice"),Yh.forEach(o),br.forEach(o),La=h(t),N=r(t,"DIV",{class:!0});var ce=i(N);w(Fo.$$.fragment,ce),uc=h(ce),Ps=r(ce,"P",{});var Zh=i(Ps);fc=s(Zh,`Bert Model with a multiple choice classification head on top (a linear layer on top of the pooled output and a
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Qr.forEach(o),Tc=h(ce),te=r(ce,"DIV",{class:!0});var Mt=i(te);w(No.$$.fragment,Mt),yc=h(Mt),Ee=r(Mt,"P",{});var Pn=i(Ee);qc=s(Pn,"The "),vn=r(Pn,"A",{href:!0});var om=i(vn);Dc=s(om,"QDQBertForMultipleChoice"),om.forEach(o),zc=s(Pn," forward method, overrides the "),Cs=r(Pn,"CODE",{});var nm=i(Cs);Bc=s(nm,"__call__"),nm.forEach(o),Mc=s(Pn," special method."),Pn.forEach(o),xc=h(Mt),w(ft.$$.fragment,Mt),jc=h(Mt),w(gt.$$.fragment,Mt),Mt.forEach(o),ce.forEach(o),Ia=h(t),Fe=r(t,"H2",{class:!0});var wr=i(Fe);_t=r(wr,"A",{id:!0,class:!0,href:!0});var sm=i(_t);As=r(sm,"SPAN",{});var am=i(As);w(So.$$.fragment,am),am.forEach(o),sm.forEach(o),Ec=h(wr),Ns=r(wr,"SPAN",{});var rm=i(Ns);Fc=s(rm,"QDQBertForTokenClassification"),rm.forEach(o),wr.forEach(o),Oa=h(t),S=r(t,"DIV",{class:!0});var pe=i(S);w(Lo.$$.fragment,pe),Pc=h(pe),Ss=r(pe,"P",{});var im=i(Ss);Cc=s(im,`QDQBERT Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g. for
