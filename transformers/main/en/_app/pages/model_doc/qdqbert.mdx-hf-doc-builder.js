...
<span class="hljs-meta">&gt;&gt;&gt; </span>loss = outputs.loss
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-built_in">round</span>(loss.item(), <span class="hljs-number">2</span>)
`}}),{c(){Q(d.$$.fragment)},l(c){w(d.$$.fragment,c)},m(c,m){v(d,c,m),_=!0},p:O,i(c){_||($(d.$$.fragment,c),_=!0)},o(c){T(d.$$.fragment,c),_=!1},d(c){y(d,c)}}}function Jm(q){let d,_,c,m,k,l,u,D,Dr,da,fe,Se,Sn,jt,zr,Ln,Br,ca,Le,Mr,Et,xr,jr,pa,tn,Er,ha,on,In,Fr,ma,nn,Cr,ua,G,On,Wn,Pr,Ar,Hn,Ie,Nr,Ft,Sr,Lr,Rn,Ir,Or,Un,Ct,Wr,Vn,Hr,Rr,Ur,Xn,Pt,Vr,sn,Xr,Jr,fa,Oe,Kr,At,Gr,Yr,ga,ge,We,Jn,Nt,Zr,Kn,ei,_a,E,ti,Gn,oi,ni,St,si,ai,Yn,ri,ii,Zn,li,di,Lt,ci,pi,ba,He,hi,es,mi,ui,ka,an,fi,Qa,It,wa,_e,Re,ts,Ot,gi,os,_i,va,rn,bi,$a,Wt,Ta,be,Ue,ns,Ht,ki,ss,Qi,ya,se,wi,Rt,vi,$i,Ut,Ti,yi,qa,Vt,Da,ke,Ve,as,Xt,qi,rs,Di,za,K,Jt,zi,Qe,Bi,ln,Mi,xi,Kt,ji,Ei,Fi,we,Ci,dn,Pi,Ai,cn,Ni,Si,Li,Xe,Ba,ve,Je,is,Gt,Ii,ls,Oi,Ma,z,Yt,Wi,ds,Hi,Ri,Zt,Ui,pn,Vi,Xi,Ji,eo,Ki,to,Gi,Yi,Zi,oo,el,no,tl,ol,nl,x,sl,cs,al,rl,ps,il,ll,hs,dl,cl,ms,pl,hl,us,ml,ul,fs,fl,gl,_l,Y,so,bl,$e,kl,hn,Ql,wl,gs,vl,$l,Tl,Ke,yl,Ge,xa,Te,Ye,_s,ao,ql,bs,Dl,ja,F,ro,zl,io,Bl,ks,Ml,xl,jl,lo,El,mn,Fl,Cl,Pl,co,Al,po,Nl,Sl,Ll,Z,ho,Il,ye,Ol,un,Wl,Hl,Qs,Rl,Ul,Vl,Ze,Xl,et,Ea,qe,tt,ws,mo,Jl,vs,Kl,Fa,C,uo,Gl,fo,Yl,$s,Zl,ed,td,go,od,fn,nd,sd,ad,_o,rd,bo,id,ld,dd,W,ko,cd,De,pd,gn,hd,md,Ts,ud,fd,gd,ot,_d,nt,bd,st,Ca,ze,at,ys,Qo,kd,qs,Qd,Pa,P,wo,wd,Ds,vd,$d,vo,Td,_n,yd,qd,Dd,$o,zd,To,Bd,Md,xd,B,yo,jd,Be,Ed,bn,Fd,Cd,zs,Pd,Ad,Nd,rt,Sd,it,Ld,lt,Id,dt,Od,ct,Aa,Me,pt,Bs,qo,Wd,Ms,Hd,Na,A,Do,Rd,zo,Ud,xs,Vd,Xd,Jd,Bo,Kd,kn,Gd,Yd,Zd,Mo,ec,xo,tc,oc,nc,ee,jo,sc,xe,ac,Qn,rc,ic,js,lc,dc,cc,ht,pc,mt,Sa,je,ut,Es,Eo,hc,Fs,mc,La,N,Fo,uc,Cs,fc,gc,Co,_c,wn,bc,kc,Qc,Po,wc,Ao,vc,$c,Tc,te,No,yc,Ee,qc,vn,Dc,zc,Ps,Bc,Mc,xc,ft,jc,gt,Ia,Fe,_t,As,So,Ec,Ns,Fc,Oa,S,Lo,Cc,Ss,Pc,Ac,Io,Nc,$n,Sc,Lc,Ic,Oo,Oc,Wo,Wc,Hc,Rc,H,Ho,Uc,Ce,Vc,Tn,Xc,Jc,Ls,Kc,Gc,Yc,bt,Zc,kt,ep,Qt,Wa,Pe,wt,Is,Ro,tp,Os,op,Ha,L,Uo,np,Ae,sp,Ws,ap,rp,Hs,ip,lp,dp,Vo,cp,yn,pp,hp,mp,Xo,up,Jo,fp,gp,_p,R,Ko,bp,Ne,kp,qn,Qp,wp,Rs,vp,$p,Tp,vt,yp,$t,qp,Tt,Ra;return l=new J({}),jt=new J({}),Nt=new J({}),It=new M({props:{code:`import pytorch_quantization.nn as quant_nn
...
`),Kt=a("a"),ji=n("bert-base-uncased"),Ei=n(" architecture."),Fi=p(),we=a("p"),Ci=n("Configuration objects inherit from "),dn=a("a"),Pi=n("PretrainedConfig"),Ai=n(` and can be used to control the model outputs. Read the
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Ll=p(),Z=a("div"),Q(ho.$$.fragment),Il=p(),ye=a("p"),Ol=n("The "),un=a("a"),Wl=n("QDQBertLMHeadModel"),Hl=n(" forward method, overrides the "),Qs=a("code"),Rl=n("__call__"),Ul=n(" special method."),Vl=p(),Q(Ze.$$.fragment),Xl=p(),Q(et.$$.fragment),Ea=p(),qe=a("h2"),tt=a("a"),ws=a("span"),Q(mo.$$.fragment),Jl=p(),vs=a("span"),Kl=n("QDQBertForMaskedLM"),Fa=p(),C=a("div"),Q(uo.$$.fragment),Gl=p(),fo=a("p"),Yl=n("QDQBERT Model with a "),$s=a("code"),Zl=n("language modeling"),ed=n(" head on top."),td=p(),go=a("p"),od=n("This model inherits from "),fn=a("a"),nd=n("PreTrainedModel"),sd=n(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Rc=p(),H=a("div"),Q(Ho.$$.fragment),Uc=p(),Ce=a("p"),Vc=n("The "),Tn=a("a"),Xc=n("QDQBertForTokenClassification"),Jc=n(" forward method, overrides the "),Ls=a("code"),Kc=n("__call__"),Gc=n(" special method."),Yc=p(),Q(bt.$$.fragment),Zc=p(),Q(kt.$$.fragment),ep=p(),Q(Qt.$$.fragment),Wa=p(),Pe=a("h2"),wt=a("a"),Is=a("span"),Q(Ro.$$.fragment),tp=p(),Os=a("span"),op=n("QDQBertForQuestionAnswering"),Ha=p(),L=a("div"),Q(Uo.$$.fragment),np=p(),Ae=a("p"),sp=n(`QDQBERT Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
...
QDQBERT model according to the specified arguments, defining the model architecture. Instantiating a configuration
with the defaults will yield a similar configuration to that of the BERT
`),Kt=r(zn,"A",{href:!0,rel:!0});var eh=i(Kt);ji=s(eh,"bert-base-uncased"),eh.forEach(o),Ei=s(zn," architecture."),zn.forEach(o),Fi=h(qt),we=r(qt,"P",{});var Bn=i(we);Ci=s(Bn,"Configuration objects inherit from "),dn=r(Bn,"A",{href:!0});var th=i(dn);Pi=s(th,"PretrainedConfig"),th.forEach(o),Ai=s(Bn,` and can be used to control the model outputs. Read the
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),_r.forEach(o),nc=h(de),ee=r(de,"DIV",{class:!0});var Bt=i(ee);w(jo.$$.fragment,Bt),sc=h(Bt),xe=r(Bt,"P",{});var Fn=i(xe);ac=s(Fn,"The "),Qn=r(Fn,"A",{href:!0});var Xh=i(Qn);rc=s(Xh,"QDQBertForNextSentencePrediction"),Xh.forEach(o),ic=s(Fn," forward method, overrides the "),js=r(Fn,"CODE",{});var Jh=i(js);lc=s(Jh,"__call__"),Jh.forEach(o),dc=s(Fn," special method."),Fn.forEach(o),cc=h(Bt),w(ht.$$.fragment,Bt),pc=h(Bt),w(mt.$$.fragment,Bt),Bt.forEach(o),de.forEach(o),Sa=h(t),je=r(t,"H2",{class:!0});var br=i(je);ut=r(br,"A",{id:!0,class:!0,href:!0});var Kh=i(ut);Es=r(Kh,"SPAN",{});var Gh=i(Es);w(Eo.$$.fragment,Gh),Gh.forEach(o),Kh.forEach(o),hc=h(br),Fs=r(br,"SPAN",{});var Yh=i(Fs);mc=s(Yh,"QDQBertForMultipleChoice"),Yh.forEach(o),br.forEach(o),La=h(t),N=r(t,"DIV",{class:!0});var ce=i(N);w(Fo.$$.fragment,ce),uc=h(ce),Cs=r(ce,"P",{});var Zh=i(Cs);fc=s(Zh,`Bert Model with a multiple choice classification head on top (a linear layer on top of the pooled output and a
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Qr.forEach(o),Tc=h(ce),te=r(ce,"DIV",{class:!0});var Mt=i(te);w(No.$$.fragment,Mt),yc=h(Mt),Ee=r(Mt,"P",{});var Cn=i(Ee);qc=s(Cn,"The "),vn=r(Cn,"A",{href:!0});var om=i(vn);Dc=s(om,"QDQBertForMultipleChoice"),om.forEach(o),zc=s(Cn," forward method, overrides the "),Ps=r(Cn,"CODE",{});var nm=i(Ps);Bc=s(nm,"__call__"),nm.forEach(o),Mc=s(Cn," special method."),Cn.forEach(o),xc=h(Mt),w(ft.$$.fragment,Mt),jc=h(Mt),w(gt.$$.fragment,Mt),Mt.forEach(o),ce.forEach(o),Ia=h(t),Fe=r(t,"H2",{class:!0});var wr=i(Fe);_t=r(wr,"A",{id:!0,class:!0,href:!0});var sm=i(_t);As=r(sm,"SPAN",{});var am=i(As);w(So.$$.fragment,am),am.forEach(o),sm.forEach(o),Ec=h(wr),Ns=r(wr,"SPAN",{});var rm=i(Ns);Fc=s(rm,"QDQBertForTokenClassification"),rm.forEach(o),wr.forEach(o),Oa=h(t),S=r(t,"DIV",{class:!0});var pe=i(S);w(Lo.$$.fragment,pe),Cc=h(pe),Ss=r(pe,"P",{});var im=i(Ss);Pc=s(im,`QDQBERT Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g. for
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),$r.forEach(o),Rc=h(pe),H=r(pe,"DIV",{class:!0});var he=i(H);w(Ho.$$.fragment,he),Uc=h(he),Ce=r(he,"P",{});var Pn=i(Ce);Vc=s(Pn,"The "),Tn=r(Pn,"A",{href:!0});var cm=i(Tn);Xc=s(cm,"QDQBertForTokenClassification"),cm.forEach(o),Jc=s(Pn," forward method, overrides the "),Ls=r(Pn,"CODE",{});var pm=i(Ls);Kc=s(pm,"__call__"),pm.forEach(o),Gc=s(Pn," special method."),Pn.forEach(o),Yc=h(he),w(bt.$$.fragment,he),Zc=h(he),w(kt.$$.fragment,he),ep=h(he),w(Qt.$$.fragment,he),he.forEach(o),pe.forEach(o),Wa=h(t),Pe=r(t,"H2",{class:!0});var Tr=i(Pe);wt=r(Tr,"A",{id:!0,class:!0,href:!0});var hm=i(wt);Is=r(hm,"SPAN",{});var mm=i(Is);w(Ro.$$.fragment,mm),mm.forEach(o),hm.forEach(o),tp=h(Tr),Os=r(Tr,"SPAN",{});var um=i(Os);op=s(um,"QDQBertForQuestionAnswering"),um.forEach(o),Tr.forEach(o),Ha=h(t),L=r(t,"DIV",{class:!0});var me=i(L);w(Uo.$$.fragment,me),np=h(me),Ae=r(me,"P",{});var An=i(Ae);sp=s(An,`QDQBERT Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
