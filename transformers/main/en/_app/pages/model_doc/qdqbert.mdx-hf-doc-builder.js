...
<span class="hljs-meta">&gt;&gt;&gt; </span>loss = outputs.loss
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-built_in">round</span>(loss.item(), <span class="hljs-number">2</span>)
`}}),{c(){Q(d.$$.fragment)},l(c){w(d.$$.fragment,c)},m(c,m){v(d,c,m),_=!0},p:I,i(c){_||($(d.$$.fragment,c),_=!0)},o(c){T(d.$$.fragment,c),_=!1},d(c){y(d,c)}}}function Jm(q){let d,_,c,m,k,l,u,D,Dr,da,fe,Ne,Nn,Ft,zr,On,Br,ca,Oe,Mr,jt,xr,Fr,pa,tn,jr,ha,on,Sn,Er,ma,nn,Pr,ua,G,In,Wn,Cr,Ar,Hn,Se,Lr,Et,Nr,Or,Rn,Sr,Ir,Un,Pt,Wr,Vn,Hr,Rr,Ur,Xn,Ct,Vr,sn,Xr,Jr,fa,Ie,Kr,At,Gr,Yr,ga,ge,We,Jn,Lt,Zr,Kn,ei,_a,j,ti,Gn,oi,ni,Nt,si,ai,Yn,ri,ii,Zn,li,di,Ot,ci,pi,ba,He,hi,es,mi,ui,ka,an,fi,Qa,St,wa,_e,Re,ts,It,gi,os,_i,va,rn,bi,$a,Wt,Ta,be,Ue,ns,Ht,ki,ss,Qi,ya,se,wi,Rt,vi,$i,Ut,Ti,yi,qa,Vt,Da,ke,Ve,as,Xt,qi,rs,Di,za,K,Jt,zi,Qe,Bi,ln,Mi,xi,Kt,Fi,ji,Ei,we,Pi,dn,Ci,Ai,cn,Li,Ni,Oi,Xe,Ba,ve,Je,is,Gt,Si,ls,Ii,Ma,z,Yt,Wi,ds,Hi,Ri,Zt,Ui,pn,Vi,Xi,Ji,eo,Ki,to,Gi,Yi,Zi,oo,el,no,tl,ol,nl,x,sl,cs,al,rl,ps,il,ll,hs,dl,cl,ms,pl,hl,us,ml,ul,fs,fl,gl,_l,Y,so,bl,$e,kl,hn,Ql,wl,gs,vl,$l,Tl,Ke,yl,Ge,xa,Te,Ye,_s,ao,ql,bs,Dl,Fa,E,ro,zl,io,Bl,ks,Ml,xl,Fl,lo,jl,mn,El,Pl,Cl,co,Al,po,Ll,Nl,Ol,Z,ho,Sl,ye,Il,un,Wl,Hl,Qs,Rl,Ul,Vl,Ze,Xl,et,ja,qe,tt,ws,mo,Jl,vs,Kl,Ea,P,uo,Gl,fo,Yl,$s,Zl,ed,td,go,od,fn,nd,sd,ad,_o,rd,bo,id,ld,dd,W,ko,cd,De,pd,gn,hd,md,Ts,ud,fd,gd,ot,_d,nt,bd,st,Pa,ze,at,ys,Qo,kd,qs,Qd,Ca,C,wo,wd,Ds,vd,$d,vo,Td,_n,yd,qd,Dd,$o,zd,To,Bd,Md,xd,B,yo,Fd,Be,jd,bn,Ed,Pd,zs,Cd,Ad,Ld,rt,Nd,it,Od,lt,Sd,dt,Id,ct,Aa,Me,pt,Bs,qo,Wd,Ms,Hd,La,A,Do,Rd,zo,Ud,xs,Vd,Xd,Jd,Bo,Kd,kn,Gd,Yd,Zd,Mo,ec,xo,tc,oc,nc,ee,Fo,sc,xe,ac,Qn,rc,ic,Fs,lc,dc,cc,ht,pc,mt,Na,Fe,ut,js,jo,hc,Es,mc,Oa,L,Eo,uc,Ps,fc,gc,Po,_c,wn,bc,kc,Qc,Co,wc,Ao,vc,$c,Tc,te,Lo,yc,je,qc,vn,Dc,zc,Cs,Bc,Mc,xc,ft,Fc,gt,Sa,Ee,_t,As,No,jc,Ls,Ec,Ia,N,Oo,Pc,Ns,Cc,Ac,So,Lc,$n,Nc,Oc,Sc,Io,Ic,Wo,Wc,Hc,Rc,H,Ho,Uc,Pe,Vc,Tn,Xc,Jc,Os,Kc,Gc,Yc,bt,Zc,kt,ep,Qt,Wa,Ce,wt,Ss,Ro,tp,Is,op,Ha,O,Uo,np,Ae,sp,Ws,ap,rp,Hs,ip,lp,dp,Vo,cp,yn,pp,hp,mp,Xo,up,Jo,fp,gp,_p,R,Ko,bp,Le,kp,qn,Qp,wp,Rs,vp,$p,Tp,vt,yp,$t,qp,Tt,Ra;return l=new J({}),Ft=new J({}),Lt=new J({}),St=new M({props:{code:`import pytorch_quantization.nn as quant_nn
...
<code>past_key_values</code>).`,name:"use_cache"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/qdqbert/modeling_qdqbert.py#L876",returnDescription:`
<p>A <a
...
If set to <code>True</code>, <code>past_key_values</code> key value states are returned and can be used to speed up decoding (see
<code>past_key_values</code>).`,name:"use_cache"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/qdqbert/modeling_qdqbert.py#L1040",returnDescription:`
<p>A <a
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/main/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/qdqbert/modeling_qdqbert.py#L1171"}}),ko=new F({props:{name:"forward",anchor:"transformers.QDQBertForMaskedLM.forward",parameters:[{name:"input_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"attention_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"token_type_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"position_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"head_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"encoder_hidden_states",val:": typing.Optional[torch.FloatTensor] = None"},{name:"encoder_attention_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"labels",val:": typing.Optional[torch.LongTensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.QDQBertForMaskedLM.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/main/en/model_doc/bert#transformers.BertTokenizer">BertTokenizer</a>. See <a href="/docs/transformers/main/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/main/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/qdqbert/modeling_qdqbert.py#L1197",returnDescription:`
<p>A <a
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/main/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/qdqbert/modeling_qdqbert.py#L1388"}}),yo=new F({props:{name:"forward",anchor:"transformers.QDQBertForSequenceClassification.forward",parameters:[{name:"input_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"attention_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"token_type_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"position_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"head_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"labels",val:": typing.Optional[torch.LongTensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.QDQBertForSequenceClassification.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/main/en/model_doc/bert#transformers.BertTokenizer">BertTokenizer</a>. See <a href="/docs/transformers/main/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/main/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/qdqbert/modeling_qdqbert.py#L1400",returnDescription:`
<p>A <a
...
`}}),rt=new xt({props:{$$slots:{default:[Em]},$$scope:{ctx:q}}}),it=new S({props:{anchor:"transformers.QDQBertForSequenceClassification.forward.example",$$slots:{default:[Pm]},$$scope:{ctx:q}}}),lt=new S({props:{anchor:"transformers.QDQBertForSequenceClassification.forward.example-2",$$slots:{default:[Cm]},$$scope:{ctx:q}}}),dt=new S({props:{anchor:"transformers.QDQBertForSequenceClassification.forward.example-3",$$slots:{default:[Am]},$$scope:{ctx:q}}}),ct=new S({props:{anchor:"transformers.QDQBertForSequenceClassification.forward.example-4",$$slots:{default:[Lm]},$$scope:{ctx:q}}}),qo=new J({}),Do=new F({props:{name:"class transformers.QDQBertForNextSentencePrediction",anchor:"transformers.QDQBertForNextSentencePrediction",parameters:[{name:"config",val:""}],parametersDescription:[{anchor:"transformers.QDQBertForNextSentencePrediction.config",description:`<strong>config</strong> (<a href="/docs/transformers/main/en/model_doc/qdqbert#transformers.QDQBertConfig">QDQBertConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/main/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/qdqbert/modeling_qdqbert.py#L1284"}}),Fo=new F({props:{name:"forward",anchor:"transformers.QDQBertForNextSentencePrediction.forward",parameters:[{name:"input_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"attention_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"token_type_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"position_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"head_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"labels",val:": typing.Optional[torch.LongTensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.QDQBertForNextSentencePrediction.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/main/en/model_doc/bert#transformers.BertTokenizer">BertTokenizer</a>. See <a href="/docs/transformers/main/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/main/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
</ul>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/qdqbert/modeling_qdqbert.py#L1294",returnDescription:`
<p>A <a
...
<code>input_ids</code> above)`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/qdqbert/modeling_qdqbert.py#L1497",returnDescription:`
<p>A <a
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/qdqbert/modeling_qdqbert.py#L1593",returnDescription:`
<p>A <a
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/main/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/qdqbert/modeling_qdqbert.py#L1660"}}),Ko=new F({props:{name:"forward",anchor:"transformers.QDQBertForQuestionAnswering.forward",parameters:[{name:"input_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"attention_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"token_type_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"position_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"head_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"start_positions",val:": typing.Optional[torch.LongTensor] = None"},{name:"end_positions",val:": typing.Optional[torch.LongTensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.QDQBertForQuestionAnswering.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/main/en/model_doc/bert#transformers.BertTokenizer">BertTokenizer</a>. See <a href="/docs/transformers/main/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/main/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/qdqbert/modeling_qdqbert.py#L1674",returnDescription:`
<p>A <a
...
more difficult to quantize, such as MobileNets and BERT-large.`),ma=p(),nn=a("p"),Pr=n("Tips:"),ua=p(),G=a("ul"),In=a("li"),Wn=a("p"),Cr=n(`QDQBERT model adds fake quantization operations (pair of QuantizeLinear/DequantizeLinear ops) to (i) linear layer
inputs and weights, (ii) matmul inputs, (iii) residual add inputs, in BERT model.`),Ar=p(),Hn=a("li"),Se=a("p"),Lr=n("QDQBERT requires the dependency of "),Et=a("a"),Nr=n("Pytorch Quantization Toolkit"),Or=n(". To install "),Rn=a("code"),Sr=n("pip install pytorch-quantization --extra-index-url https://pypi.ngc.nvidia.com"),Ir=p(),Un=a("li"),Pt=a("p"),Wr=n("QDQBERT model can be loaded from any checkpoint of HuggingFace BERT model (for example "),Vn=a("em"),Hr=n("bert-base-uncased"),Rr=n(`), and
...
`),Kt=a("a"),Fi=n("bert-base-uncased"),ji=n(" architecture."),Ei=p(),we=a("p"),Pi=n("Configuration objects inherit from "),dn=a("a"),Ci=n("PretrainedConfig"),Ai=n(` and can be used to control the model outputs. Read the
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),xd=p(),B=a("div"),Q(yo.$$.fragment),Fd=p(),Be=a("p"),jd=n("The "),bn=a("a"),Ed=n("QDQBertForSequenceClassification"),Pd=n(" forward method, overrides the "),zs=a("code"),Cd=n("__call__"),Ad=n(" special method."),Ld=p(),Q(rt.$$.fragment),Nd=p(),Q(it.$$.fragment),Od=p(),Q(lt.$$.fragment),Sd=p(),Q(dt.$$.fragment),Id=p(),Q(ct.$$.fragment),Aa=p(),Me=a("h2"),pt=a("a"),Bs=a("span"),Q(qo.$$.fragment),Wd=p(),Ms=a("span"),Hd=n("QDQBertForNextSentencePrediction"),La=p(),A=a("div"),Q(Do.$$.fragment),Rd=p(),zo=a("p"),Ud=n("Bert Model with a "),xs=a("code"),Vd=n("next sentence prediction (classification)"),Xd=n(" head on top."),Jd=p(),Bo=a("p"),Kd=n("This model inherits from "),kn=a("a"),Gd=n("PreTrainedModel"),Yd=n(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Zd=p(),Mo=a("p"),ec=n("This model is also a PyTorch "),xo=a("a"),tc=n("torch.nn.Module"),oc=n(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),nc=p(),ee=a("div"),Q(Fo.$$.fragment),sc=p(),xe=a("p"),ac=n("The "),Qn=a("a"),rc=n("QDQBertForNextSentencePrediction"),ic=n(" forward method, overrides the "),Fs=a("code"),lc=n("__call__"),dc=n(" special method."),cc=p(),Q(ht.$$.fragment),pc=p(),Q(mt.$$.fragment),Na=p(),Fe=a("h2"),ut=a("a"),js=a("span"),Q(jo.$$.fragment),hc=p(),Es=a("span"),mc=n("QDQBertForMultipleChoice"),Oa=p(),L=a("div"),Q(Eo.$$.fragment),uc=p(),Ps=a("p"),fc=n(`Bert Model with a multiple choice classification head on top (a linear layer on top of the pooled output and a
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Tc=p(),te=a("div"),Q(Lo.$$.fragment),yc=p(),je=a("p"),qc=n("The "),vn=a("a"),Dc=n("QDQBertForMultipleChoice"),zc=n(" forward method, overrides the "),Cs=a("code"),Bc=n("__call__"),Mc=n(" special method."),xc=p(),Q(ft.$$.fragment),Fc=p(),Q(gt.$$.fragment),Sa=p(),Ee=a("h2"),_t=a("a"),As=a("span"),Q(No.$$.fragment),jc=p(),Ls=a("span"),Ec=n("QDQBertForTokenClassification"),Ia=p(),N=a("div"),Q(Oo.$$.fragment),Pc=p(),Ns=a("p"),Cc=n(`QDQBERT Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g. for
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Rc=p(),H=a("div"),Q(Ho.$$.fragment),Uc=p(),Pe=a("p"),Vc=n("The "),Tn=a("a"),Xc=n("QDQBertForTokenClassification"),Jc=n(" forward method, overrides the "),Os=a("code"),Kc=n("__call__"),Gc=n(" special method."),Yc=p(),Q(bt.$$.fragment),Zc=p(),Q(kt.$$.fragment),ep=p(),Q(Qt.$$.fragment),Wa=p(),Ce=a("h2"),wt=a("a"),Ss=a("span"),Q(Ro.$$.fragment),tp=p(),Is=a("span"),op=n("QDQBertForQuestionAnswering"),Ha=p(),O=a("div"),Q(Uo.$$.fragment),np=p(),Ae=a("p"),sp=n(`QDQBERT Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
...
`),Gn=r(oe,"CODE",{});var Ep=i(Gn);oi=s(Ep,"TensorQuantizer"),Ep.forEach(o),ni=s(oe," in "),Nt=r(oe,"A",{href:!0,rel:!0});var Pp=i(Nt);si=s(Pp,"Pytorch Quantization Toolkit"),Pp.forEach(o),ai=s(oe,". "),Yn=r(oe,"CODE",{});var Cp=i(Yn);ri=s(Cp,"TensorQuantizer"),Cp.forEach(o),ii=s(oe,` is the module
...
QDQBERT model according to the specified arguments, defining the model architecture. Instantiating a configuration
with the defaults will yield a similar configuration to that of the BERT
`),Kt=r(zn,"A",{href:!0,rel:!0});var eh=i(Kt);Fi=s(eh,"bert-base-uncased"),eh.forEach(o),ji=s(zn," architecture."),zn.forEach(o),Ei=h(qt),we=r(qt,"P",{});var Bn=i(we);Pi=s(Bn,"Configuration objects inherit from "),dn=r(Bn,"A",{href:!0});var th=i(dn);Ci=s(th,"PretrainedConfig"),th.forEach(o),Ai=s(Bn,` and can be used to control the model outputs. Read the
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),mr.forEach(o),xd=h(le),B=r(le,"DIV",{class:!0});var X=i(B);w(yo.$$.fragment,X),Fd=h(X),Be=r(X,"P",{});var jn=i(Be);jd=s(jn,"The "),bn=r(jn,"A",{href:!0});var Oh=i(bn);Ed=s(Oh,"QDQBertForSequenceClassification"),Oh.forEach(o),Pd=s(jn," forward method, overrides the "),zs=r(jn,"CODE",{});var Sh=i(zs);Cd=s(Sh,"__call__"),Sh.forEach(o),Ad=s(jn," special method."),jn.forEach(o),Ld=h(X),w(rt.$$.fragment,X),Nd=h(X),w(it.$$.fragment,X),Od=h(X),w(lt.$$.fragment,X),Sd=h(X),w(dt.$$.fragment,X),Id=h(X),w(ct.$$.fragment,X),X.forEach(o),le.forEach(o),Aa=h(t),Me=r(t,"H2",{class:!0});var ur=i(Me);pt=r(ur,"A",{id:!0,class:!0,href:!0});var Ih=i(pt);Bs=r(Ih,"SPAN",{});var Wh=i(Bs);w(qo.$$.fragment,Wh),Wh.forEach(o),Ih.forEach(o),Wd=h(ur),Ms=r(ur,"SPAN",{});var Hh=i(Ms);Hd=s(Hh,"QDQBertForNextSentencePrediction"),Hh.forEach(o),ur.forEach(o),La=h(t),A=r(t,"DIV",{class:!0});var de=i(A);w(Do.$$.fragment,de),Rd=h(de),zo=r(de,"P",{});var fr=i(zo);Ud=s(fr,"Bert Model with a "),xs=r(fr,"CODE",{});var Rh=i(xs);Vd=s(Rh,"next sentence prediction (classification)"),Rh.forEach(o),Xd=s(fr," head on top."),fr.forEach(o),Jd=h(de),Bo=r(de,"P",{});var gr=i(Bo);Kd=s(gr,"This model inherits from "),kn=r(gr,"A",{href:!0});var Uh=i(kn);Gd=s(Uh,"PreTrainedModel"),Uh.forEach(o),Yd=s(gr,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),_r.forEach(o),nc=h(de),ee=r(de,"DIV",{class:!0});var Bt=i(ee);w(Fo.$$.fragment,Bt),sc=h(Bt),xe=r(Bt,"P",{});var En=i(xe);ac=s(En,"The "),Qn=r(En,"A",{href:!0});var Xh=i(Qn);rc=s(Xh,"QDQBertForNextSentencePrediction"),Xh.forEach(o),ic=s(En," forward method, overrides the "),Fs=r(En,"CODE",{});var Jh=i(Fs);lc=s(Jh,"__call__"),Jh.forEach(o),dc=s(En," special method."),En.forEach(o),cc=h(Bt),w(ht.$$.fragment,Bt),pc=h(Bt),w(mt.$$.fragment,Bt),Bt.forEach(o),de.forEach(o),Na=h(t),Fe=r(t,"H2",{class:!0});var br=i(Fe);ut=r(br,"A",{id:!0,class:!0,href:!0});var Kh=i(ut);js=r(Kh,"SPAN",{});var Gh=i(js);w(jo.$$.fragment,Gh),Gh.forEach(o),Kh.forEach(o),hc=h(br),Es=r(br,"SPAN",{});var Yh=i(Es);mc=s(Yh,"QDQBertForMultipleChoice"),Yh.forEach(o),br.forEach(o),Oa=h(t),L=r(t,"DIV",{class:!0});var ce=i(L);w(Eo.$$.fragment,ce),uc=h(ce),Ps=r(ce,"P",{});var Zh=i(Ps);fc=s(Zh,`Bert Model with a multiple choice classification head on top (a linear layer on top of the pooled output and a
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Qr.forEach(o),Tc=h(ce),te=r(ce,"DIV",{class:!0});var Mt=i(te);w(Lo.$$.fragment,Mt),yc=h(Mt),je=r(Mt,"P",{});var Pn=i(je);qc=s(Pn,"The "),vn=r(Pn,"A",{href:!0});var om=i(vn);Dc=s(om,"QDQBertForMultipleChoice"),om.forEach(o),zc=s(Pn," forward method, overrides the "),Cs=r(Pn,"CODE",{});var nm=i(Cs);Bc=s(nm,"__call__"),nm.forEach(o),Mc=s(Pn," special method."),Pn.forEach(o),xc=h(Mt),w(ft.$$.fragment,Mt),Fc=h(Mt),w(gt.$$.fragment,Mt),Mt.forEach(o),ce.forEach(o),Sa=h(t),Ee=r(t,"H2",{class:!0});var wr=i(Ee);_t=r(wr,"A",{id:!0,class:!0,href:!0});var sm=i(_t);As=r(sm,"SPAN",{});var am=i(As);w(No.$$.fragment,am),am.forEach(o),sm.forEach(o),jc=h(wr),Ls=r(wr,"SPAN",{});var rm=i(Ls);Ec=s(rm,"QDQBertForTokenClassification"),rm.forEach(o),wr.forEach(o),Ia=h(t),N=r(t,"DIV",{class:!0});var pe=i(N);w(Oo.$$.fragment,pe),Pc=h(pe),Ns=r(pe,"P",{});var im=i(Ns);Cc=s(im,`QDQBERT Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g. for
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),$r.forEach(o),Rc=h(pe),H=r(pe,"DIV",{class:!0});var he=i(H);w(Ho.$$.fragment,he),Uc=h(he),Pe=r(he,"P",{});var Cn=i(Pe);Vc=s(Cn,"The "),Tn=r(Cn,"A",{href:!0});var cm=i(Tn);Xc=s(cm,"QDQBertForTokenClassification"),cm.forEach(o),Jc=s(Cn," forward method, overrides the "),Os=r(Cn,"CODE",{});var pm=i(Os);Kc=s(pm,"__call__"),pm.forEach(o),Gc=s(Cn," special method."),Cn.forEach(o),Yc=h(he),w(bt.$$.fragment,he),Zc=h(he),w(kt.$$.fragment,he),ep=h(he),w(Qt.$$.fragment,he),he.forEach(o),pe.forEach(o),Wa=h(t),Ce=r(t,"H2",{class:!0});var Tr=i(Ce);wt=r(Tr,"A",{id:!0,class:!0,href:!0});var hm=i(wt);Ss=r(hm,"SPAN",{});var mm=i(Ss);w(Ro.$$.fragment,mm),mm.forEach(o),hm.forEach(o),tp=h(Tr),Is=r(Tr,"SPAN",{});var um=i(Is);op=s(um,"QDQBertForQuestionAnswering"),um.forEach(o),Tr.forEach(o),Ha=h(t),O=r(t,"DIV",{class:!0});var me=i(O);w(Uo.$$.fragment,me),np=h(me),Ae=r(me,"P",{});var An=i(Ae);sp=s(An,`QDQBERT Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
