import{S as ha,i as pa,s as ma,e as s,k as l,w as g,t as o,M as ua,c as a,d as n,m as c,a as i,x as _,h as r,b as d,F as e,g as p,y as b,q as v,o as k,B as T,v as fa}from"../../chunks/vendor-6b77c823.js";import{T as ca}from"../../chunks/Tip-39098574.js";import{D as Ue}from"../../chunks/Docstring-abef54e3.js";import{C as Jt}from"../../chunks/CodeBlock-3a8b25a8.js";import{I as vt}from"../../chunks/IconCopyLink-7a11ce68.js";function ga(He){let m,D,u,B,x;return{c(){m=s("p"),D=o("Although the recipe for forward pass needs to be defined within this function, one should call the "),u=s("code"),B=o("Module"),x=o(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(w){m=a(w,"P",{});var y=i(m);D=r(y,"Although the recipe for forward pass needs to be defined within this function, one should call the "),u=a(y,"CODE",{});var S=i(u);B=r(S,"Module"),S.forEach(n),x=r(y,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),y.forEach(n)},m(w,y){p(w,m,y),e(m,D),e(m,u),e(u,B),e(m,x)},d(w){w&&n(m)}}}function _a(He){let m,D,u,B,x;return{c(){m=s("p"),D=o("Although the recipe for forward pass needs to be defined within this function, one should call the "),u=s("code"),B=o("Module"),x=o(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(w){m=a(w,"P",{});var y=i(m);D=r(y,"Although the recipe for forward pass needs to be defined within this function, one should call the "),u=a(y,"CODE",{});var S=i(u);B=r(S,"Module"),S.forEach(n),x=r(y,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),y.forEach(n)},m(w,y){p(w,m,y),e(m,D),e(m,u),e(u,B),e(m,x)},d(w){w&&n(m)}}}function ba(He){let m,D,u,B,x,w,y,S,Dn,Kt,R,Y,kt,ie,Sn,Tt,Mn,Qt,M,An,Ve,Nn,Ln,de,Fn,On,Xt,Je,In,Yt,Ke,wt,Rn,Zt,Qe,Wn,en,Xe,le,Un,Ye,Hn,Vn,tn,ce,nn,Ze,he,Jn,et,Kn,Qn,on,pe,rn,tt,Xn,sn,Z,A,nt,Yn,Zn,ot,eo,to,yt,no,oo,ro,Et,so,an,N,ao,me,io,lo,ue,co,ho,dn,W,ee,Bt,fe,po,zt,mo,ln,$,ge,uo,_e,fo,$t,go,_o,bo,U,vo,rt,ko,To,st,wo,yo,Eo,Gt,Bo,zo,be,cn,H,te,qt,ve,$o,Pt,Go,hn,C,ke,qo,Te,Po,we,jo,xo,Co,ye,Do,at,So,Mo,Ao,it,Ee,pn,V,ne,jt,Be,No,xt,Lo,mn,f,ze,Fo,Ct,Oo,Io,$e,Ro,dt,Wo,Uo,Ho,Ge,Vo,qe,Jo,Ko,Qo,Pe,Xo,je,Yo,Zo,er,J,tr,lt,nr,or,xe,rr,sr,ar,E,ir,Dt,dr,lr,St,cr,hr,Mt,pr,mr,At,ur,fr,Nt,gr,_r,Lt,br,vr,kr,q,Ce,Tr,K,wr,ct,yr,Er,Ft,Br,zr,$r,oe,Gr,Ot,qr,Pr,De,un,Q,re,It,Se,jr,Rt,xr,fn,G,Me,Cr,Ae,Dr,Wt,Sr,Mr,Ar,Ne,Nr,ht,Lr,Fr,Or,Le,Ir,Fe,Rr,Wr,Ur,P,Oe,Hr,X,Vr,pt,Jr,Kr,Ut,Qr,Xr,Yr,se,Zr,Ht,es,ts,Ie,gn;return w=new vt({}),ie=new vt({}),ce=new Jt({props:{code:`# leverage checkpoints for Bert2Bert model...
...
<p>Indices can be obtained using <a href="/docs/transformers/main/en/model_doc/bert-generation#transformers.BertGenerationTokenizer">BertGenerationTokenizer</a>. See <a href="/docs/transformers/main/en/model_doc/wav2vec2#transformers.Wav2Vec2CTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
...
<span class="hljs-meta">&gt;&gt;&gt; </span>prediction_logits = outputs.logits`}}),{c(){m=s("meta"),D=l(),u=s("h1"),B=s("a"),x=s("span"),g(w.$$.fragment),y=l(),S=s("span"),Dn=o("BertGeneration"),Kt=l(),R=s("h2"),Y=s("a"),kt=s("span"),g(ie.$$.fragment),Sn=l(),Tt=s("span"),Mn=o("Overview"),Qt=l(),M=s("p"),An=o(`The BertGeneration model is a BERT model that can be leveraged for sequence-to-sequence tasks using
...
Tasks`),On=o(" by Sascha Rothe, Shashi Narayan, Aliaksei Severyn."),Xt=l(),Je=s("p"),In=o("The abstract from the paper is the following:"),Yt=l(),Ke=s("p"),wt=s("em"),Rn=o(`Unsupervised pretraining of large neural models has recently revolutionized Natural Language Processing. By
...
documentation from `),st=s("a"),wo=o("PretrainedConfig"),yo=o(" for more information."),Eo=l(),Gt=s("p"),Bo=o("Examples:"),zo=l(),g(be.$$.fragment),cn=l(),H=s("h2"),te=s("a"),qt=s("span"),g(ve.$$.fragment),$o=l(),Pt=s("span"),Go=o("BertGenerationTokenizer"),hn=l(),C=s("div"),g(ke.$$.fragment),qo=l(),Te=s("p"),Po=o("Construct a BertGeneration tokenizer. Based on "),we=s("a"),jo=o("SentencePiece"),xo=o("."),Co=l(),ye=s("p"),Do=o("This tokenizer inherits from "),at=s("a"),So=o("PreTrainedTokenizer"),Mo=o(` which contains most of the main methods. Users should refer to
...
`),At=s("code"),ur=o("add_cross_attention"),fr=o(" set to "),Nt=s("code"),gr=o("True"),_r=o("; an "),Lt=s("code"),br=o("encoder_hidden_states"),vr=o(" is then expected as an input to the forward pass."),kr=l(),q=s("div"),g(Ce.$$.fragment),Tr=l(),K=s("p"),wr=o("The "),ct=s("a"),yr=o("BertGenerationEncoder"),Er=o(" forward method, overrides the "),Ft=s("code"),Br=o("__call__"),zr=o(" special method."),$r=l(),g(oe.$$.fragment),Gr=l(),Ot=s("p"),qr=o("Example:"),Pr=l(),g(De.$$.fragment),un=l(),Q=s("h2"),re=s("a"),It=s("span"),g(Se.$$.fragment),jr=l(),Rt=s("span"),xr=o("BertGenerationDecoder"),fn=l(),G=s("div"),g(Me.$$.fragment),Cr=l(),Ae=s("p"),Dr=o("BertGeneration Model with a "),Wt=s("code"),Sr=o("language modeling"),Mr=o(" head on top for CLM fine-tuning."),Ar=l(),Ne=s("p"),Nr=o("This model inherits from "),ht=s("a"),Lr=o("PreTrainedModel"),Fr=o(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Or=l(),Le=s("p"),Ir=o("This model is also a PyTorch "),Fe=s("a"),Rr=o("torch.nn.Module"),Wr=o(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Ur=l(),P=s("div"),g(Oe.$$.fragment),Hr=l(),X=s("p"),Vr=o("The "),pt=s("a"),Jr=o("BertGenerationDecoder"),Kr=o(" forward method, overrides the "),Ut=s("code"),Qr=o("__call__"),Xr=o(" special method."),Yr=l(),g(se.$$.fragment),Zr=l(),Ht=s("p"),es=o("Example:"),ts=l(),g(Ie.$$.fragment),this.h()},l(t){const h=ua('[data-svelte="svelte-1phssyn"]',document.head);m=a(h,"META",{name:!0,content:!0}),h.forEach(n),D=c(t),u=a(t,"H1",{class:!0});var Re=i(u);B=a(Re,"A",{id:!0,class:!0,href:!0});var Vt=i(B);x=a(Vt,"SPAN",{});var ns=i(x);_(w.$$.fragment,ns),ns.forEach(n),Vt.forEach(n),y=c(Re),S=a(Re,"SPAN",{});var os=i(S);Dn=r(os,"BertGeneration"),os.forEach(n),Re.forEach(n),Kt=c(t),R=a(t,"H2",{class:!0});var _n=i(R);Y=a(_n,"A",{id:!0,class:!0,href:!0});var rs=i(Y);kt=a(rs,"SPAN",{});var ss=i(kt);_(ie.$$.fragment,ss),ss.forEach(n),rs.forEach(n),Sn=c(_n),Tt=a(_n,"SPAN",{});var as=i(Tt);Mn=r(as,"Overview"),as.forEach(n),_n.forEach(n),Qt=c(t),M=a(t,"P",{});var mt=i(M);An=r(mt,`The BertGeneration model is a BERT model that can be leveraged for sequence-to-sequence tasks using
...
Therefore, no EOS token should be added to the end of the input.`),Ts.forEach(n),kn.forEach(n),an=c(t),N=a(t,"P",{});var ut=i(N);ao=r(ut,"This model was contributed by "),me=a(ut,"A",{href:!0,rel:!0});var ws=i(me);io=r(ws,"patrickvonplaten"),ws.forEach(n),lo=r(ut,`. The original code can be
found `),ue=a(ut,"A",{href:!0,rel:!0});var ys=i(ue);co=r(ys,"here"),ys.forEach(n),ho=r(ut,"."),ut.forEach(n),dn=c(t),W=a(t,"H2",{class:!0});var Tn=i(W);ee=a(Tn,"A",{id:!0,class:!0,href:!0});var Es=i(ee);Bt=a(Es,"SPAN",{});var Bs=i(Bt);_(fe.$$.fragment,Bs),Bs.forEach(n),Es.forEach(n),po=c(Tn),zt=a(Tn,"SPAN",{});var zs=i(zt);mo=r(zs,"BertGenerationConfig"),zs.forEach(n),Tn.forEach(n),ln=c(t),$=a(t,"DIV",{class:!0});var L=i($);_(ge.$$.fragment,L),uo=c(L),_e=a(L,"P",{});var wn=i(_e);fo=r(wn,"This is the configuration class to store the configuration of a "),$t=a(wn,"CODE",{});var $s=i($t);go=r($s,"BertGenerationPreTrainedModel"),$s.forEach(n),_o=r(wn,` It is used to
instantiate a BertGeneration model according to the specified arguments, defining the model architecture.`),wn.forEach(n),bo=c(L),U=a(L,"P",{});var ft=i(U);vo=r(ft,"Configuration objects inherit from "),rt=a(ft,"A",{href:!0});var Gs=i(rt);ko=r(Gs,"PretrainedConfig"),Gs.forEach(n),To=r(ft,` and can be used to control the model outputs. Read the
documentation from `),st=a(ft,"A",{href:!0});var qs=i(st);wo=r(qs,"PretrainedConfig"),qs.forEach(n),yo=r(ft," for more information."),ft.forEach(n),Eo=c(L),Gt=a(L,"P",{});var Ps=i(Gt);Bo=r(Ps,"Examples:"),Ps.forEach(n),zo=c(L),_(be.$$.fragment,L),L.forEach(n),cn=c(t),H=a(t,"H2",{class:!0});var yn=i(H);te=a(yn,"A",{id:!0,class:!0,href:!0});var js=i(te);qt=a(js,"SPAN",{});var xs=i(qt);_(ve.$$.fragment,xs),xs.forEach(n),js.forEach(n),$o=c(yn),Pt=a(yn,"SPAN",{});var Cs=i(Pt);Go=r(Cs,"BertGenerationTokenizer"),Cs.forEach(n),yn.forEach(n),hn=c(t),C=a(t,"DIV",{class:!0});var ae=i(C);_(ke.$$.fragment,ae),qo=c(ae),Te=a(ae,"P",{});var En=i(Te);Po=r(En,"Construct a BertGeneration tokenizer. Based on "),we=a(En,"A",{href:!0,rel:!0});var Ds=i(we);jo=r(Ds,"SentencePiece"),Ds.forEach(n),xo=r(En,"."),En.forEach(n),Co=c(ae),ye=a(ae,"P",{});var Bn=i(ye);Do=r(Bn,"This tokenizer inherits from "),at=a(Bn,"A",{href:!0});var Ss=i(at);So=r(Ss,"PreTrainedTokenizer"),Ss.forEach(n),Mo=r(Bn,` which contains most of the main methods. Users should refer to
