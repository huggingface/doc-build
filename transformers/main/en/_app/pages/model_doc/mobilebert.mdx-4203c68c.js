import{S as py,i as my,s as hy,e as r,k as m,w as v,t as n,M as uy,c as a,d as t,m as h,a as i,x as y,h as s,b,F as e,g,y as w,q as M,o as $,B as F,v as fy,L as xe}from"../../chunks/vendor-6b77c823.js";import{T as Pe}from"../../chunks/Tip-39098574.js";import{D as ie}from"../../chunks/Docstring-1088f2fb.js";import{C as ze}from"../../chunks/CodeBlock-3a8b25a8.js";import{I as qe}from"../../chunks/IconCopyLink-7a11ce68.js";import{E as Ee}from"../../chunks/ExampleCodeBlock-5212b321.js";function gy(E){let d,_,c,p,T;return p=new ze({props:{code:`from transformers import MobileBertModel, MobileBertConfig
...
<span class="hljs-meta">&gt;&gt;&gt; </span>loss = outputs.loss
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-built_in">round</span>(loss.item(), <span class="hljs-number">2</span>)
<span class="hljs-number">3.98</span>`}}),{c(){v(d.$$.fragment)},l(c){y(d.$$.fragment,c)},m(c,p){w(d,c,p),_=!0},p:xe,i(c){_||(M(d.$$.fragment,c),_=!0)},o(c){$(d.$$.fragment,c),_=!1},d(c){F(d,c)}}}function Iy(E){let d,_,c,p,T,l,u,x,me,V,z,J,D,X,he,L,ue,le,K,N,ee,G,P,C,ne,U,de,se,W,fe,ce,q,ge,R,Z,re,H,_e,ae,O,pe,A,be;return{c(){d=r("p"),_=n("TF 2.0 models accepts two formats as inputs:"),c=m(),p=r("ul"),T=r("li"),l=n("having all inputs as keyword arguments (like PyTorch models), or"),u=m(),x=r("li"),me=n("having all inputs as a list, tuple or dict in the first positional arguments."),V=m(),z=r("p"),J=n("This second option is useful when using "),D=r("code"),X=n("tf.keras.Model.fit"),he=n(` method which currently requires having all the
tensors in the first argument of the model call function: `),L=r("code"),ue=n("model(inputs)"),le=n("."),K=m(),N=r("p"),ee=n(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),G=m(),P=r("ul"),C=r("li"),ne=n("a single Tensor with "),U=r("code"),de=n("input_ids"),se=n(" only and nothing else: "),W=r("code"),fe=n("model(inputs_ids)"),ce=m(),q=r("li"),ge=n(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
...
`),A=r("code"),be=n('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(f){d=a(f,"P",{});var B=i(d);_=s(B,"TF 2.0 models accepts two formats as inputs:"),B.forEach(t),c=h(f),p=a(f,"UL",{});var Y=i(p);T=a(Y,"LI",{});var ve=i(T);l=s(ve,"having all inputs as keyword arguments (like PyTorch models), or"),ve.forEach(t),u=h(Y),x=a(Y,"LI",{});var $e=i(x);me=s($e,"having all inputs as a list, tuple or dict in the first positional arguments."),$e.forEach(t),Y.forEach(t),V=h(f),z=a(f,"P",{});var S=i(z);J=s(S,"This second option is useful when using "),D=a(S,"CODE",{});var we=i(D);X=s(we,"tf.keras.Model.fit"),we.forEach(t),he=s(S,` method which currently requires having all the
tensors in the first argument of the model call function: `),L=a(S,"CODE",{});var Te=i(L);ue=s(Te,"model(inputs)"),Te.forEach(t),le=s(S,"."),S.forEach(t),K=h(f),N=a(f,"P",{});var ke=i(N);ee=s(ke,`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),ke.forEach(t),G=h(f),P=a(f,"UL",{});var j=i(P);C=a(j,"LI",{});var I=i(C);ne=s(I,"a single Tensor with "),U=a(I,"CODE",{});var Fe=i(U);de=s(Fe,"input_ids"),Fe.forEach(t),se=s(I," only and nothing else: "),W=a(I,"CODE",{});var ye=i(W);fe=s(ye,"model(inputs_ids)"),ye.forEach(t),I.forEach(t),ce=h(j),q=a(j,"LI",{});var Q=i(q);ge=s(Q,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),{c(){d=r("p"),_=n("Example:"),c=m(),v(p.$$.fragment)},l(l){d=a(l,"P",{});var u=i(d);_=s(u,"Example:"),u.forEach(t),c=h(l),y(p.$$.fragment,l)},m(l,u){g(l,d,u),e(d,_),g(l,c,u),w(p,l,u),T=!0},p:xe,i(l){T||(M(p.$$.fragment,l),T=!0)},o(l){$(p.$$.fragment,l),T=!1},d(l){l&&t(d),l&&t(c),F(p,l)}}}function Wy(E){let d,_,c,p,T,l,u,x,me,V,z,J,D,X,he,L,ue,le,K,N,ee,G,P,C,ne,U,de,se,W,fe,ce,q,ge,R,Z,re,H,_e,ae,O,pe,A,be;return{c(){d=r("p"),_=n("TF 2.0 models accepts two formats as inputs:"),c=m(),p=r("ul"),T=r("li"),l=n("having all inputs as keyword arguments (like PyTorch models), or"),u=m(),x=r("li"),me=n("having all inputs as a list, tuple or dict in the first positional arguments."),V=m(),z=r("p"),J=n("This second option is useful when using "),D=r("code"),X=n("tf.keras.Model.fit"),he=n(` method which currently requires having all the
tensors in the first argument of the model call function: `),L=r("code"),ue=n("model(inputs)"),le=n("."),K=m(),N=r("p"),ee=n(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),G=m(),P=r("ul"),C=r("li"),ne=n("a single Tensor with "),U=r("code"),de=n("input_ids"),se=n(" only and nothing else: "),W=r("code"),fe=n("model(inputs_ids)"),ce=m(),q=r("li"),ge=n(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),R=r("code"),Z=n("model([input_ids, attention_mask])"),re=n(" or "),H=r("code"),_e=n("model([input_ids, attention_mask, token_type_ids])"),ae=m(),O=r("li"),pe=n(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),A=r("code"),be=n('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(f){d=a(f,"P",{});var B=i(d);_=s(B,"TF 2.0 models accepts two formats as inputs:"),B.forEach(t),c=h(f),p=a(f,"UL",{});var Y=i(p);T=a(Y,"LI",{});var ve=i(T);l=s(ve,"having all inputs as keyword arguments (like PyTorch models), or"),ve.forEach(t),u=h(Y),x=a(Y,"LI",{});var $e=i(x);me=s($e,"having all inputs as a list, tuple or dict in the first positional arguments."),$e.forEach(t),Y.forEach(t),V=h(f),z=a(f,"P",{});var S=i(z);J=s(S,"This second option is useful when using "),D=a(S,"CODE",{});var we=i(D);X=s(we,"tf.keras.Model.fit"),we.forEach(t),he=s(S,` method which currently requires having all the
...
<span class="hljs-number">0.57</span>`}}),{c(){v(d.$$.fragment)},l(c){y(d.$$.fragment,c)},m(c,p){w(d,c,p),_=!0},p:xe,i(c){_||(M(d.$$.fragment,c),_=!0)},o(c){$(d.$$.fragment,c),_=!1},d(c){F(d,c)}}}function Gy(E){let d,_,c,p,T,l,u,x,me,V,z,J,D,X,he,L,ue,le,K,N,ee,G,P,C,ne,U,de,se,W,fe,ce,q,ge,R,Z,re,H,_e,ae,O,pe,A,be;return{c(){d=r("p"),_=n("TF 2.0 models accepts two formats as inputs:"),c=m(),p=r("ul"),T=r("li"),l=n("having all inputs as keyword arguments (like PyTorch models), or"),u=m(),x=r("li"),me=n("having all inputs as a list, tuple or dict in the first positional arguments."),V=m(),z=r("p"),J=n("This second option is useful when using "),D=r("code"),X=n("tf.keras.Model.fit"),he=n(` method which currently requires having all the
tensors in the first argument of the model call function: `),L=r("code"),ue=n("model(inputs)"),le=n("."),K=m(),N=r("p"),ee=n(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),G=m(),P=r("ul"),C=r("li"),ne=n("a single Tensor with "),U=r("code"),de=n("input_ids"),se=n(" only and nothing else: "),W=r("code"),fe=n("model(inputs_ids)"),ce=m(),q=r("li"),ge=n(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),R=r("code"),Z=n("model([input_ids, attention_mask])"),re=n(" or "),H=r("code"),_e=n("model([input_ids, attention_mask, token_type_ids])"),ae=m(),O=r("li"),pe=n(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),A=r("code"),be=n('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(f){d=a(f,"P",{});var B=i(d);_=s(B,"TF 2.0 models accepts two formats as inputs:"),B.forEach(t),c=h(f),p=a(f,"UL",{});var Y=i(p);T=a(Y,"LI",{});var ve=i(T);l=s(ve,"having all inputs as keyword arguments (like PyTorch models), or"),ve.forEach(t),u=h(Y),x=a(Y,"LI",{});var $e=i(x);me=s($e,"having all inputs as a list, tuple or dict in the first positional arguments."),$e.forEach(t),Y.forEach(t),V=h(f),z=a(f,"P",{});var S=i(z);J=s(S,"This second option is useful when using "),D=a(S,"CODE",{});var we=i(D);X=s(we,"tf.keras.Model.fit"),we.forEach(t),he=s(S,` method which currently requires having all the
...
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-comment"># the linear classifier still needs to be trained</span>
<span class="hljs-meta">&gt;&gt;&gt; </span>logits = outputs.logits`}}),{c(){d=r("p"),_=n("Example:"),c=m(),v(p.$$.fragment)},l(l){d=a(l,"P",{});var u=i(d);_=s(u,"Example:"),u.forEach(t),c=h(l),y(p.$$.fragment,l)},m(l,u){g(l,d,u),e(d,_),g(l,c,u),w(p,l,u),T=!0},p:xe,i(l){T||(M(p.$$.fragment,l),T=!0)},o(l){$(p.$$.fragment,l),T=!1},d(l){l&&t(d),l&&t(c),F(p,l)}}}function rw(E){let d,_,c,p,T,l,u,x,me,V,z,J,D,X,he,L,ue,le,K,N,ee,G,P,C,ne,U,de,se,W,fe,ce,q,ge,R,Z,re,H,_e,ae,O,pe,A,be;return{c(){d=r("p"),_=n("TF 2.0 models accepts two formats as inputs:"),c=m(),p=r("ul"),T=r("li"),l=n("having all inputs as keyword arguments (like PyTorch models), or"),u=m(),x=r("li"),me=n("having all inputs as a list, tuple or dict in the first positional arguments."),V=m(),z=r("p"),J=n("This second option is useful when using "),D=r("code"),X=n("tf.keras.Model.fit"),he=n(` method which currently requires having all the
tensors in the first argument of the model call function: `),L=r("code"),ue=n("model(inputs)"),le=n("."),K=m(),N=r("p"),ee=n(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),G=m(),P=r("ul"),C=r("li"),ne=n("a single Tensor with "),U=r("code"),de=n("input_ids"),se=n(" only and nothing else: "),W=r("code"),fe=n("model(inputs_ids)"),ce=m(),q=r("li"),ge=n(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),R=r("code"),Z=n("model([input_ids, attention_mask])"),re=n(" or "),H=r("code"),_e=n("model([input_ids, attention_mask, token_type_ids])"),ae=m(),O=r("li"),pe=n(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),A=r("code"),be=n('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(f){d=a(f,"P",{});var B=i(d);_=s(B,"TF 2.0 models accepts two formats as inputs:"),B.forEach(t),c=h(f),p=a(f,"UL",{});var Y=i(p);T=a(Y,"LI",{});var ve=i(T);l=s(ve,"having all inputs as keyword arguments (like PyTorch models), or"),ve.forEach(t),u=h(Y),x=a(Y,"LI",{});var $e=i(x);me=s($e,"having all inputs as a list, tuple or dict in the first positional arguments."),$e.forEach(t),Y.forEach(t),V=h(f),z=a(f,"P",{});var S=i(z);J=s(S,"This second option is useful when using "),D=a(S,"CODE",{});var we=i(D);X=s(we,"tf.keras.Model.fit"),we.forEach(t),he=s(S,` method which currently requires having all the
...
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-built_in">round</span>(<span class="hljs-built_in">float</span>(loss), <span class="hljs-number">2</span>)
<span class="hljs-number">0.03</span>`}}),{c(){v(d.$$.fragment)},l(c){y(d.$$.fragment,c)},m(c,p){w(d,c,p),_=!0},p:xe,i(c){_||(M(d.$$.fragment,c),_=!0)},o(c){$(d.$$.fragment,c),_=!1},d(c){F(d,c)}}}function dw(E){let d,_,c,p,T,l,u,x,me,V,z,J,D,X,he,L,ue,le,K,N,ee,G,P,C,ne,U,de,se,W,fe,ce,q,ge,R,Z,re,H,_e,ae,O,pe,A,be;return{c(){d=r("p"),_=n("TF 2.0 models accepts two formats as inputs:"),c=m(),p=r("ul"),T=r("li"),l=n("having all inputs as keyword arguments (like PyTorch models), or"),u=m(),x=r("li"),me=n("having all inputs as a list, tuple or dict in the first positional arguments."),V=m(),z=r("p"),J=n("This second option is useful when using "),D=r("code"),X=n("tf.keras.Model.fit"),he=n(` method which currently requires having all the
tensors in the first argument of the model call function: `),L=r("code"),ue=n("model(inputs)"),le=n("."),K=m(),N=r("p"),ee=n(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),G=m(),P=r("ul"),C=r("li"),ne=n("a single Tensor with "),U=r("code"),de=n("input_ids"),se=n(" only and nothing else: "),W=r("code"),fe=n("model(inputs_ids)"),ce=m(),q=r("li"),ge=n(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),R=r("code"),Z=n("model([input_ids, attention_mask])"),re=n(" or "),H=r("code"),_e=n("model([input_ids, attention_mask, token_type_ids])"),ae=m(),O=r("li"),pe=n(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),A=r("code"),be=n('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(f){d=a(f,"P",{});var B=i(d);_=s(B,"TF 2.0 models accepts two formats as inputs:"),B.forEach(t),c=h(f),p=a(f,"UL",{});var Y=i(p);T=a(Y,"LI",{});var ve=i(T);l=s(ve,"having all inputs as keyword arguments (like PyTorch models), or"),ve.forEach(t),u=h(Y),x=a(Y,"LI",{});var $e=i(x);me=s($e,"having all inputs as a list, tuple or dict in the first positional arguments."),$e.forEach(t),Y.forEach(t),V=h(f),z=a(f,"P",{});var S=i(z);J=s(S,"This second option is useful when using "),D=a(S,"CODE",{});var we=i(D);X=s(we,"tf.keras.Model.fit"),we.forEach(t),he=s(S,` method which currently requires having all the
...
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-built_in">round</span>(<span class="hljs-built_in">float</span>(loss), <span class="hljs-number">2</span>)
<span class="hljs-number">3.98</span>`}}),{c(){v(d.$$.fragment)},l(c){y(d.$$.fragment,c)},m(c,p){w(d,c,p),_=!0},p:xe,i(c){_||(M(d.$$.fragment,c),_=!0)},o(c){$(d.$$.fragment,c),_=!1},d(c){F(d,c)}}}function hw(E){let d,_,c,p,T,l,u,x,me,V,z,J,D,X,he,L,ue,le,K,N,ee,G,P,C,ne,U,de,se,W,fe,ce,q,ge,R,Z,re,H,_e,ae,O,pe,A,be,f,B,Y,ve,$e,S,we,Te,ke,j,I,Fe,ye,Q,Me,te,oe,Be,Mt,Ep,ya,xp,zp,wa,Pp,qp,is,Cp,jp,Np,Wt,Op,Ma,Sp,Ap,$a,Ip,Dp,Lp,Co,Wp,qi,Rp,Ad,Rt,jo,Ci,ls,Up,ji,Hp,Id,st,ds,Qp,Ni,Kp,Vp,No,Fa,Gp,Yp,Ba,Jp,Zp,Xp,cs,em,Ea,tm,om,Dd,Ut,Oo,Oi,ps,nm,Si,sm,Ld,rt,ms,rm,hs,am,Ai,im,lm,dm,So,xa,cm,pm,za,mm,hm,um,us,fm,Pa,gm,_m,Wd,Ht,Ao,Ii,fs,bm,Di,Tm,Rd,Qt,gs,km,_s,vm,qa,ym,wm,Ud,Kt,bs,Mm,Ts,$m,Ca,Fm,Bm,Hd,Vt,Io,Li,ks,Em,Wi,xm,Qd,je,vs,zm,Ri,Pm,qm,ys,Cm,ja,jm,Nm,Om,ws,Sm,Ms,Am,Im,Dm,Ui,$s,Lm,Wm,it,Fs,Rm,Gt,Um,Na,Hm,Qm,Hi,Km,Vm,Gm,Do,Ym,Lo,Kd,Yt,Wo,Qi,Bs,Jm,Ki,Zm,Vd,Re,Es,Xm,Jt,eh,Vi,th,oh,Gi,nh,sh,rh,xs,ah,Oa,ih,lh,dh,zs,ch,Ps,ph,mh,hh,lt,qs,uh,Zt,fh,Sa,gh,_h,Yi,bh,Th,kh,Ro,vh,Uo,Gd,Xt,Ho,Ji,Cs,yh,Zi,wh,Yd,Ue,js,Mh,Ns,$h,Xi,Fh,Bh,Eh,Os,xh,Aa,zh,Ph,qh,Ss,Ch,As,jh,Nh,Oh,Ye,Is,Sh,eo,Ah,Ia,Ih,Dh,el,Lh,Wh,Rh,Qo,Uh,Ko,Hh,Vo,Jd,to,Go,tl,Ds,Qh,ol,Kh,Zd,He,Ls,Vh,Ws,Gh,nl,Yh,Jh,Zh,Rs,Xh,Da,eu,tu,ou,Us,nu,Hs,su,ru,au,dt,Qs,iu,oo,lu,La,du,cu,sl,pu,mu,hu,Yo,uu,Jo,Xd,no,Zo,rl,Ks,fu,al,gu,ec,Qe,Vs,_u,il,bu,Tu,Gs,ku,Wa,vu,yu,wu,Ys,Mu,Js,$u,Fu,Bu,Ce,Zs,Eu,so,xu,Ra,zu,Pu,ll,qu,Cu,ju,Xo,Nu,en,Ou,tn,Su,on,Au,nn,tc,ro,sn,dl,Xs,Iu,cl,Du,oc,Ke,er,Lu,pl,Wu,Ru,tr,Uu,Ua,Hu,Qu,Ku,or,Vu,nr,Gu,Yu,Ju,ct,sr,Zu,ao,Xu,Ha,ef,tf,ml,of,nf,sf,rn,rf,an,nc,io,ln,hl,rr,af,ul,lf,sc,Ve,ar,df,fl,cf,pf,ir,mf,Qa,hf,uf,ff,lr,gf,dr,_f,bf,Tf,Je,cr,kf,lo,vf,Ka,yf,wf,gl,Mf,$f,Ff,dn,Bf,cn,Ef,pn,rc,co,mn,_l,pr,xf,bl,zf,ac,Ge,mr,Pf,po,qf,Tl,Cf,jf,kl,Nf,Of,Sf,hr,Af,Va,If,Df,Lf,ur,Wf,fr,Rf,Uf,Hf,Ze,gr,Qf,mo,Kf,Ga,Vf,Gf,vl,Yf,Jf,Zf,hn,Xf,un,eg,fn,ic,ho,gn,yl,_r,tg,wl,og,lc,Ne,br,ng,Ml,sg,rg,Tr,ag,Ya,ig,lg,dg,kr,cg,vr,pg,mg,hg,_n,ug,pt,yr,fg,uo,gg,Ja,_g,bg,$l,Tg,kg,vg,bn,yg,Tn,dc,fo,kn,Fl,wr,wg,Bl,Mg,cc,Oe,Mr,$g,go,Fg,El,Bg,Eg,xl,xg,zg,Pg,$r,qg,Za,Cg,jg,Ng,Fr,Og,Br,Sg,Ag,Ig,vn,Dg,mt,Er,Lg,_o,Wg,Xa,Rg,Ug,zl,Hg,Qg,Kg,yn,Vg,wn,pc,bo,Mn,Pl,xr,Gg,ql,Yg,mc,Se,zr,Jg,Pr,Zg,Cl,Xg,e_,t_,qr,o_,ei,n_,s_,r_,Cr,a_,jr,i_,l_,d_,$n,c_,Xe,Nr,p_,To,m_,ti,h_,u_,jl,f_,g_,__,Fn,b_,Bn,T_,En,hc,ko,xn,Nl,Or,k_,Ol,v_,uc,Ae,Sr,y_,Ar,w_,Sl,M_,$_,F_,Ir,B_,oi,E_,x_,z_,Dr,P_,Lr,q_,C_,j_,zn,N_,ht,Wr,O_,vo,S_,ni,A_,I_,Al,D_,L_,W_,Pn,R_,qn,fc,yo,Cn,Il,Rr,U_,Dl,H_,gc,Ie,Ur,Q_,Ll,K_,V_,Hr,G_,si,Y_,J_,Z_,Qr,X_,Kr,eb,tb,ob,jn,nb,et,Vr,sb,wo,rb,ri,ab,ib,Wl,lb,db,cb,Nn,pb,On,mb,Sn,_c,Mo,An,Rl,Gr,hb,Ul,ub,bc,De,Yr,fb,Hl,gb,_b,Jr,bb,ai,Tb,kb,vb,Zr,yb,Xr,wb,Mb,$b,In,Fb,ut,ea,Bb,$o,Eb,ii,xb,zb,Ql,Pb,qb,Cb,Dn,jb,Ln,Tc,Fo,Wn,Kl,ta,Nb,Vl,Ob,kc,Le,oa,Sb,Gl,Ab,Ib,na,Db,li,Lb,Wb,Rb,sa,Ub,ra,Hb,Qb,Kb,Rn,Vb,tt,aa,Gb,Bo,Yb,di,Jb,Zb,Yl,Xb,eT,tT,Un,oT,Hn,nT,Qn,vc,Eo,Kn,Jl,ia,sT,Zl,rT,yc,We,la,aT,xo,iT,Xl,lT,dT,ed,cT,pT,mT,da,hT,ci,uT,fT,gT,ca,_T,pa,bT,TT,kT,Vn,vT,ot,ma,yT,zo,wT,pi,MT,$T,td,FT,BT,ET,Gn,xT,Yn,zT,Jn,wc;return l=new qe({}),X=new qe({}),I=new qe({}),oe=new ie({props:{name:"class transformers.MobileBertConfig",anchor:"transformers.MobileBertConfig",parameters:[{name:"vocab_size",val:" = 30522"},{name:"hidden_size",val:" = 512"},{name:"num_hidden_layers",val:" = 24"},{name:"num_attention_heads",val:" = 4"},{name:"intermediate_size",val:" = 512"},{name:"hidden_act",val:" = 'relu'"},{name:"hidden_dropout_prob",val:" = 0.0"},{name:"attention_probs_dropout_prob",val:" = 0.1"},{name:"max_position_embeddings",val:" = 512"},{name:"type_vocab_size",val:" = 2"},{name:"initializer_range",val:" = 0.02"},{name:"layer_norm_eps",val:" = 1e-12"},{name:"pad_token_id",val:" = 0"},{name:"embedding_size",val:" = 128"},{name:"trigram_input",val:" = True"},{name:"use_bottleneck",val:" = True"},{name:"intra_bottleneck_size",val:" = 128"},{name:"use_bottleneck_attention",val:" = False"},{name:"key_query_shared_bottleneck",val:" = True"},{name:"num_feedforward_networks",val:" = 4"},{name:"normalization_type",val:" = 'no_norm'"},{name:"classifier_activation",val:" = True"},{name:"classifier_dropout",val:" = None"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.MobileBertConfig.vocab_size",description:`<strong>vocab_size</strong> (<code>int</code>, <em>optional</em>, defaults to 30522) &#x2014;
...
</ul>`,name:"next_sentence_label"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/mobilebert/modeling_mobilebert.py#L944",returnDescription:`
<p>A <a
...
Labels for computing the masked language modeling loss. Indices should be in <code>[-100, 0, ..., config.vocab_size]</code> (see <code>input_ids</code> docstring) Tokens with indices set to <code>-100</code> are ignored (masked), the
loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/mobilebert/modeling_mobilebert.py#L1053",returnDescription:`
<p>A <a
...
<li>0 indicates sequence B is a continuation of sequence A,</li>
<li>1 indicates sequence B is a random sequence.</li>
</ul>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/mobilebert/modeling_mobilebert.py#L1139",returnDescription:`
<p>A <a
...
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/mobilebert/modeling_mobilebert.py#L1248",returnDescription:`
<p>A <a
...
<code>input_ids</code> above)`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/mobilebert/modeling_mobilebert.py#L1459",returnDescription:`
<p>A <a
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/mobilebert/modeling_mobilebert.py#L1561",returnDescription:`
<p>A <a
...
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/mobilebert/modeling_mobilebert.py#L1351",returnDescription:`
<p>A <a
...
`}}),Gn=new Pe({props:{$$slots:{default:[cw]},$$scope:{ctx:E}}}),Yn=new Ee({props:{anchor:"transformers.TFMobileBertForQuestionAnswering.call.example",$$slots:{default:[pw]},$$scope:{ctx:E}}}),Jn=new Ee({props:{anchor:"transformers.TFMobileBertForQuestionAnswering.call.example-2",$$slots:{default:[mw]},$$scope:{ctx:E}}}),{c(){d=r("meta"),_=m(),c=r("h1"),p=r("a"),T=r("span"),v(l.$$.fragment),u=m(),x=r("span"),me=n("MobileBERT"),V=m(),z=r("h2"),J=r("a"),D=r("span"),v(X.$$.fragment),he=m(),L=r("span"),ue=n("Overview"),le=m(),K=r("p"),N=n("The MobileBERT model was proposed in "),ee=r("a"),G=n("MobileBERT: a Compact Task-Agnostic BERT for Resource-Limited Devices"),P=n(` by Zhiqing Sun, Hongkun Yu, Xiaodan Song, Renjie Liu, Yiming Yang, and Denny
...
documentation from `),$a=r("a"),Ip=n("PretrainedConfig"),Dp=n(" for more information."),Lp=m(),v(Co.$$.fragment),Wp=m(),qi=r("p"),Rp=n(`Attributes: pretrained_config_archive_map (Dict[str, str]): A dictionary containing all the available pre-trained
...
and wordpiece.`),Xp=m(),cs=r("p"),em=n("Refer to superclass "),Ea=r("a"),tm=n("BertTokenizer"),om=n(" for usage examples and documentation concerning parameters."),Dd=m(),Ut=r("h2"),Oo=r("a"),Oi=r("span"),v(ps.$$.fragment),nm=m(),Si=r("span"),sm=n("MobileBertTokenizerFast"),Ld=m(),rt=r("div"),v(ms.$$.fragment),rm=m(),hs=r("p"),am=n("Construct a \u201Cfast\u201D MobileBERT tokenizer (backed by HuggingFace\u2019s "),Ai=r("em"),im=n("tokenizers"),lm=n(" library)."),dm=m(),So=r("p"),xa=r("a"),cm=n("MobileBertTokenizerFast"),pm=n(" is identical to "),za=r("a"),mm=n("BertTokenizerFast"),hm=n(` and runs end-to-end tokenization: punctuation
splitting and wordpiece.`),um=m(),us=r("p"),fm=n("Refer to superclass "),Pa=r("a"),gm=n("BertTokenizerFast"),_m=n(" for usage examples and documentation concerning parameters."),Wd=m(),Ht=r("h2"),Ao=r("a"),Ii=r("span"),v(fs.$$.fragment),bm=m(),Di=r("span"),Tm=n("MobileBert specific outputs"),Rd=m(),Qt=r("div"),v(gs.$$.fragment),km=m(),_s=r("p"),vm=n("Output type of "),qa=r("a"),ym=n("MobileBertForPreTraining"),wm=n("."),Ud=m(),Kt=r("div"),v(bs.$$.fragment),Mm=m(),Ts=r("p"),$m=n("Output type of "),Ca=r("a"),Fm=n("TFMobileBertForPreTraining"),Bm=n("."),Hd=m(),Vt=r("h2"),Io=r("a"),Li=r("span"),v(ks.$$.fragment),Em=m(),Wi=r("span"),xm=n("MobileBertModel"),Qd=m(),je=r("div"),v(vs.$$.fragment),zm=m(),Ri=r("p"),Pm=n("The bare MobileBert Model transformer outputting raw hidden-states without any specific head on top."),qm=m(),ys=r("p"),Cm=n("This model inherits from "),ja=r("a"),jm=n("PreTrainedModel"),Nm=n(`. Check the superclass documentation for the generic methods the
...
and behavior.`),Dm=m(),Ui=r("p"),$s=r("a"),Lm=n("https://arxiv.org/pdf/2004.02984.pdf"),Wm=m(),it=r("div"),v(Fs.$$.fragment),Rm=m(),Gt=r("p"),Um=n("The "),Na=r("a"),Hm=n("MobileBertModel"),Qm=n(" forward method, overrides the "),Hi=r("code"),Km=n("__call__"),Vm=n(" special method."),Gm=m(),v(Do.$$.fragment),Ym=m(),v(Lo.$$.fragment),Kd=m(),Yt=r("h2"),Wo=r("a"),Qi=r("span"),v(Bs.$$.fragment),Jm=m(),Ki=r("span"),Zm=n("MobileBertForPreTraining"),Vd=m(),Re=r("div"),v(Es.$$.fragment),Xm=m(),Jt=r("p"),eh=n("MobileBert Model with two heads on top as done during the pretraining: a "),Vi=r("code"),th=n("masked language modeling"),oh=n(` head and a
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),hh=m(),lt=r("div"),v(qs.$$.fragment),uh=m(),Zt=r("p"),fh=n("The "),Sa=r("a"),gh=n("MobileBertForPreTraining"),_h=n(" forward method, overrides the "),Yi=r("code"),bh=n("__call__"),Th=n(" special method."),kh=m(),v(Ro.$$.fragment),vh=m(),v(Uo.$$.fragment),Gd=m(),Xt=r("h2"),Ho=r("a"),Ji=r("span"),v(Cs.$$.fragment),yh=m(),Zi=r("span"),wh=n("MobileBertForMaskedLM"),Yd=m(),Ue=r("div"),v(js.$$.fragment),Mh=m(),Ns=r("p"),$h=n("MobileBert Model with a "),Xi=r("code"),Fh=n("language modeling"),Bh=n(" head on top."),Eh=m(),Os=r("p"),xh=n("This model inherits from "),Aa=r("a"),zh=n("PreTrainedModel"),Ph=n(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),qh=m(),Ss=r("p"),Ch=n("This model is also a PyTorch "),As=r("a"),jh=n("torch.nn.Module"),Nh=n(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Oh=m(),Ye=r("div"),v(Is.$$.fragment),Sh=m(),eo=r("p"),Ah=n("The "),Ia=r("a"),Ih=n("MobileBertForMaskedLM"),Dh=n(" forward method, overrides the "),el=r("code"),Lh=n("__call__"),Wh=n(" special method."),Rh=m(),v(Qo.$$.fragment),Uh=m(),v(Ko.$$.fragment),Hh=m(),v(Vo.$$.fragment),Jd=m(),to=r("h2"),Go=r("a"),tl=r("span"),v(Ds.$$.fragment),Qh=m(),ol=r("span"),Kh=n("MobileBertForNextSentencePrediction"),Zd=m(),He=r("div"),v(Ls.$$.fragment),Vh=m(),Ws=r("p"),Gh=n("MobileBert Model with a "),nl=r("code"),Yh=n("next sentence prediction (classification)"),Jh=n(" head on top."),Zh=m(),Rs=r("p"),Xh=n("This model inherits from "),Da=r("a"),eu=n("PreTrainedModel"),tu=n(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),ou=m(),Us=r("p"),nu=n("This model is also a PyTorch "),Hs=r("a"),su=n("torch.nn.Module"),ru=n(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),au=m(),dt=r("div"),v(Qs.$$.fragment),iu=m(),oo=r("p"),lu=n("The "),La=r("a"),du=n("MobileBertForNextSentencePrediction"),cu=n(" forward method, overrides the "),sl=r("code"),pu=n("__call__"),mu=n(" special method."),hu=m(),v(Yo.$$.fragment),uu=m(),v(Jo.$$.fragment),Xd=m(),no=r("h2"),Zo=r("a"),rl=r("span"),v(Ks.$$.fragment),fu=m(),al=r("span"),gu=n("MobileBertForSequenceClassification"),ec=m(),Qe=r("div"),v(Vs.$$.fragment),_u=m(),il=r("p"),bu=n(`MobileBert Model transformer with a sequence classification/regression head on top (a linear layer on top of the
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Bu=m(),Ce=r("div"),v(Zs.$$.fragment),Eu=m(),so=r("p"),xu=n("The "),Ra=r("a"),zu=n("MobileBertForSequenceClassification"),Pu=n(" forward method, overrides the "),ll=r("code"),qu=n("__call__"),Cu=n(" special method."),ju=m(),v(Xo.$$.fragment),Nu=m(),v(en.$$.fragment),Ou=m(),v(tn.$$.fragment),Su=m(),v(on.$$.fragment),Au=m(),v(nn.$$.fragment),tc=m(),ro=r("h2"),sn=r("a"),dl=r("span"),v(Xs.$$.fragment),Iu=m(),cl=r("span"),Du=n("MobileBertForMultipleChoice"),oc=m(),Ke=r("div"),v(er.$$.fragment),Lu=m(),pl=r("p"),Wu=n(`MobileBert Model with a multiple choice classification head on top (a linear layer on top of the pooled output and
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Tf=m(),Je=r("div"),v(cr.$$.fragment),kf=m(),lo=r("p"),vf=n("The "),Ka=r("a"),yf=n("MobileBertForTokenClassification"),wf=n(" forward method, overrides the "),gl=r("code"),Mf=n("__call__"),$f=n(" special method."),Ff=m(),v(dn.$$.fragment),Bf=m(),v(cn.$$.fragment),Ef=m(),v(pn.$$.fragment),rc=m(),co=r("h2"),mn=r("a"),_l=r("span"),v(pr.$$.fragment),xf=m(),bl=r("span"),zf=n("MobileBertForQuestionAnswering"),ac=m(),Ge=r("div"),v(mr.$$.fragment),Pf=m(),po=r("p"),qf=n(`MobileBert Model with a span classification head on top for extractive question-answering tasks like SQuAD (a
linear layers on top of the hidden-states output to compute `),Tl=r("code"),Cf=n("span start logits"),jf=n(" and "),kl=r("code"),Nf=n("span end logits"),Of=n(")."),Sf=m(),hr=r("p"),Af=n("This model inherits from "),Va=r("a"),If=n("PreTrainedModel"),Df=n(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Lf=m(),ur=r("p"),Wf=n("This model is also a PyTorch "),fr=r("a"),Rf=n("torch.nn.Module"),Uf=n(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),z_=m(),Dr=r("p"),P_=n("This model is also a "),Lr=r("a"),q_=n("tf.keras.Model"),C_=n(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),j_=m(),v(zn.$$.fragment),N_=m(),ht=r("div"),v(Wr.$$.fragment),O_=m(),vo=r("p"),S_=n("The "),ni=r("a"),A_=n("TFMobileBertForNextSentencePrediction"),I_=n(" forward method, overrides the "),Al=r("code"),D_=n("__call__"),L_=n(" special method."),W_=m(),v(Pn.$$.fragment),R_=m(),v(qn.$$.fragment),fc=m(),yo=r("h2"),Cn=r("a"),Il=r("span"),v(Rr.$$.fragment),U_=m(),Dl=r("span"),H_=n("TFMobileBertForSequenceClassification"),gc=m(),Ie=r("div"),v(Ur.$$.fragment),Q_=m(),Ll=r("p"),K_=n(`MobileBert Model transformer with a sequence classification/regression head on top (a linear layer on top of the
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),$b=m(),v(In.$$.fragment),Fb=m(),ut=r("div"),v(ea.$$.fragment),Bb=m(),$o=r("p"),Eb=n("The "),ii=r("a"),xb=n("TFMobileBertForMultipleChoice"),zb=n(" forward method, overrides the "),Ql=r("code"),Pb=n("__call__"),qb=n(" special method."),Cb=m(),v(Dn.$$.fragment),jb=m(),v(Ln.$$.fragment),Tc=m(),Fo=r("h2"),Wn=r("a"),Kl=r("span"),v(ta.$$.fragment),Nb=m(),Vl=r("span"),Ob=n("TFMobileBertForTokenClassification"),kc=m(),Le=r("div"),v(oa.$$.fragment),Sb=m(),Gl=r("p"),Ab=n(`MobileBert Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g.
for Named-Entity-Recognition (NER) tasks.`),Ib=m(),na=r("p"),Db=n("This model inherits from "),li=r("a"),Lb=n("TFPreTrainedModel"),Wb=n(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
documentation from `),$a=a(qo,"A",{href:!0});var Md=i($a);Ip=s(Md,"PretrainedConfig"),Md.forEach(t),Dp=s(qo," for more information."),qo.forEach(t),Lp=h(at),y(Co.$$.fragment,at),Wp=h(at),qi=a(at,"P",{});var $d=i(qi);Rp=s($d,`Attributes: pretrained_config_archive_map (Dict[str, str]): A dictionary containing all the available pre-trained
...
and wordpiece.`),Zn.forEach(t),Xp=h(Ft),cs=a(Ft,"P",{});var Ta=i(cs);em=s(Ta,"Refer to superclass "),Ea=a(Ta,"A",{href:!0});var qd=i(Ea);tm=s(qd,"BertTokenizer"),qd.forEach(t),om=s(Ta," for usage examples and documentation concerning parameters."),Ta.forEach(t),Ft.forEach(t),Dd=h(o),Ut=a(o,"H2",{class:!0});var ka=i(Ut);Oo=a(ka,"A",{id:!0,class:!0,href:!0});var Cd=i(Oo);Oi=a(Cd,"SPAN",{});var jd=i(Oi);y(ps.$$.fragment,jd),jd.forEach(t),Cd.forEach(t),nm=h(ka),Si=a(ka,"SPAN",{});var Nd=i(Si);sm=s(Nd,"MobileBertTokenizerFast"),Nd.forEach(t),ka.forEach(t),Ld=h(o),rt=a(o,"DIV",{class:!0});var Bt=i(rt);y(ms.$$.fragment,Bt),rm=h(Bt),hs=a(Bt,"P",{});var va=i(hs);am=s(va,"Construct a \u201Cfast\u201D MobileBERT tokenizer (backed by HuggingFace\u2019s "),Ai=a(va,"EM",{});var Od=i(Ai);im=s(Od,"tokenizers"),Od.forEach(t),lm=s(va," library)."),va.forEach(t),dm=h(Bt),So=a(Bt,"P",{});var Sd=i(So);xa=a(Sd,"A",{href:!0});var PT=i(xa);cm=s(PT,"MobileBertTokenizerFast"),PT.forEach(t),pm=s(Sd," is identical to "),za=a(Sd,"A",{href:!0});var qT=i(za);mm=s(qT,"BertTokenizerFast"),qT.forEach(t),hm=s(Sd,` and runs end-to-end tokenization: punctuation
splitting and wordpiece.`),Sd.forEach(t),um=h(Bt),us=a(Bt,"P",{});var Mc=i(us);fm=s(Mc,"Refer to superclass "),Pa=a(Mc,"A",{href:!0});var CT=i(Pa);gm=s(CT,"BertTokenizerFast"),CT.forEach(t),_m=s(Mc," for usage examples and documentation concerning parameters."),Mc.forEach(t),Bt.forEach(t),Wd=h(o),Ht=a(o,"H2",{class:!0});var $c=i(Ht);Ao=a($c,"A",{id:!0,class:!0,href:!0});var jT=i(Ao);Ii=a(jT,"SPAN",{});var NT=i(Ii);y(fs.$$.fragment,NT),NT.forEach(t),jT.forEach(t),bm=h($c),Di=a($c,"SPAN",{});var OT=i(Di);Tm=s(OT,"MobileBert specific outputs"),OT.forEach(t),$c.forEach(t),Rd=h(o),Qt=a(o,"DIV",{class:!0});var Fc=i(Qt);y(gs.$$.fragment,Fc),km=h(Fc),_s=a(Fc,"P",{});var Bc=i(_s);vm=s(Bc,"Output type of "),qa=a(Bc,"A",{href:!0});var ST=i(qa);ym=s(ST,"MobileBertForPreTraining"),ST.forEach(t),wm=s(Bc,"."),Bc.forEach(t),Fc.forEach(t),Ud=h(o),Kt=a(o,"DIV",{class:!0});var Ec=i(Kt);y(bs.$$.fragment,Ec),Mm=h(Ec),Ts=a(Ec,"P",{});var xc=i(Ts);$m=s(xc,"Output type of "),Ca=a(xc,"A",{href:!0});var AT=i(Ca);Fm=s(AT,"TFMobileBertForPreTraining"),AT.forEach(t),Bm=s(xc,"."),xc.forEach(t),Ec.forEach(t),Hd=h(o),Vt=a(o,"H2",{class:!0});var zc=i(Vt);Io=a(zc,"A",{id:!0,class:!0,href:!0});var IT=i(Io);Li=a(IT,"SPAN",{});var DT=i(Li);y(ks.$$.fragment,DT),DT.forEach(t),IT.forEach(t),Em=h(zc),Wi=a(zc,"SPAN",{});var LT=i(Wi);xm=s(LT,"MobileBertModel"),LT.forEach(t),zc.forEach(t),Qd=h(o),je=a(o,"DIV",{class:!0});var ft=i(je);y(vs.$$.fragment,ft),zm=h(ft),Ri=a(ft,"P",{});var WT=i(Ri);Pm=s(WT,"The bare MobileBert Model transformer outputting raw hidden-states without any specific head on top."),WT.forEach(t),qm=h(ft),ys=a(ft,"P",{});var Pc=i(ys);Cm=s(Pc,"This model inherits from "),ja=a(Pc,"A",{href:!0});var RT=i(ja);jm=s(RT,"PreTrainedModel"),RT.forEach(t),Nm=s(Pc,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Pc.forEach(t),Om=h(ft),ws=a(ft,"P",{});var qc=i(ws);Sm=s(qc,"This model is also a PyTorch "),Ms=a(qc,"A",{href:!0,rel:!0});var UT=i(Ms);Am=s(UT,"torch.nn.Module"),UT.forEach(t),Im=s(qc,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),qc.forEach(t),Dm=h(ft),Ui=a(ft,"P",{});var HT=i(Ui);$s=a(HT,"A",{href:!0,rel:!0});var QT=i($s);Lm=s(QT,"https://arxiv.org/pdf/2004.02984.pdf"),QT.forEach(t),HT.forEach(t),Wm=h(ft),it=a(ft,"DIV",{class:!0});var Xn=i(it);y(Fs.$$.fragment,Xn),Rm=h(Xn),Gt=a(Xn,"P",{});var mi=i(Gt);Um=s(mi,"The "),Na=a(mi,"A",{href:!0});var KT=i(Na);Hm=s(KT,"MobileBertModel"),KT.forEach(t),Qm=s(mi," forward method, overrides the "),Hi=a(mi,"CODE",{});var VT=i(Hi);Km=s(VT,"__call__"),VT.forEach(t),Vm=s(mi," special method."),mi.forEach(t),Gm=h(Xn),y(Do.$$.fragment,Xn),Ym=h(Xn),y(Lo.$$.fragment,Xn),Xn.forEach(t),ft.forEach(t),Kd=h(o),Yt=a(o,"H2",{class:!0});var Cc=i(Yt);Wo=a(Cc,"A",{id:!0,class:!0,href:!0});var GT=i(Wo);Qi=a(GT,"SPAN",{});var YT=i(Qi);y(Bs.$$.fragment,YT),YT.forEach(t),GT.forEach(t),Jm=h(Cc),Ki=a(Cc,"SPAN",{});var JT=i(Ki);Zm=s(JT,"MobileBertForPreTraining"),JT.forEach(t),Cc.forEach(t),Vd=h(o),Re=a(o,"DIV",{class:!0});var Et=i(Re);y(Es.$$.fragment,Et),Xm=h(Et),Jt=a(Et,"P",{});var hi=i(Jt);eh=s(hi,"MobileBert Model with two heads on top as done during the pretraining: a "),Vi=a(hi,"CODE",{});var ZT=i(Vi);th=s(ZT,"masked language modeling"),ZT.forEach(t),oh=s(hi,` head and a
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Ic.forEach(t),Oh=h(xt),Ye=a(xt,"DIV",{class:!0});var zt=i(Ye);y(Is.$$.fragment,zt),Sh=h(zt),eo=a(zt,"P",{});var fi=i(eo);Ah=s(fi,"The "),Ia=a(fi,"A",{href:!0});var ck=i(Ia);Ih=s(ck,"MobileBertForMaskedLM"),ck.forEach(t),Dh=s(fi," forward method, overrides the "),el=a(fi,"CODE",{});var pk=i(el);Lh=s(pk,"__call__"),pk.forEach(t),Wh=s(fi," special method."),fi.forEach(t),Rh=h(zt),y(Qo.$$.fragment,zt),Uh=h(zt),y(Ko.$$.fragment,zt),Hh=h(zt),y(Vo.$$.fragment,zt),zt.forEach(t),xt.forEach(t),Jd=h(o),to=a(o,"H2",{class:!0});var Dc=i(to);Go=a(Dc,"A",{id:!0,class:!0,href:!0});var mk=i(Go);tl=a(mk,"SPAN",{});var hk=i(tl);y(Ds.$$.fragment,hk),hk.forEach(t),mk.forEach(t),Qh=h(Dc),ol=a(Dc,"SPAN",{});var uk=i(ol);Kh=s(uk,"MobileBertForNextSentencePrediction"),uk.forEach(t),Dc.forEach(t),Zd=h(o),He=a(o,"DIV",{class:!0});var Pt=i(He);y(Ls.$$.fragment,Pt),Vh=h(Pt),Ws=a(Pt,"P",{});var Lc=i(Ws);Gh=s(Lc,"MobileBert Model with a "),nl=a(Lc,"CODE",{});var fk=i(nl);Yh=s(fk,"next sentence prediction (classification)"),fk.forEach(t),Jh=s(Lc," head on top."),Lc.forEach(t),Zh=h(Pt),Rs=a(Pt,"P",{});var Wc=i(Rs);Xh=s(Wc,"This model inherits from "),Da=a(Wc,"A",{href:!0});var gk=i(Da);eu=s(gk,"PreTrainedModel"),gk.forEach(t),tu=s(Wc,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Wc.forEach(t),ou=h(Pt),Us=a(Pt,"P",{});var Rc=i(Us);nu=s(Rc,"This model is also a PyTorch "),Hs=a(Rc,"A",{href:!0,rel:!0});var _k=i(Hs);su=s(_k,"torch.nn.Module"),_k.forEach(t),ru=s(Rc,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Rc.forEach(t),au=h(Pt),dt=a(Pt,"DIV",{class:!0});var ts=i(dt);y(Qs.$$.fragment,ts),iu=h(ts),oo=a(ts,"P",{});var gi=i(oo);lu=s(gi,"The "),La=a(gi,"A",{href:!0});var bk=i(La);du=s(bk,"MobileBertForNextSentencePrediction"),bk.forEach(t),cu=s(gi," forward method, overrides the "),sl=a(gi,"CODE",{});var Tk=i(sl);pu=s(Tk,"__call__"),Tk.forEach(t),mu=s(gi," special method."),gi.forEach(t),hu=h(ts),y(Yo.$$.fragment,ts),uu=h(ts),y(Jo.$$.fragment,ts),ts.forEach(t),Pt.forEach(t),Xd=h(o),no=a(o,"H2",{class:!0});var Uc=i(no);Zo=a(Uc,"A",{id:!0,class:!0,href:!0});var kk=i(Zo);rl=a(kk,"SPAN",{});var vk=i(rl);y(Ks.$$.fragment,vk),vk.forEach(t),kk.forEach(t),fu=h(Uc),al=a(Uc,"SPAN",{});var yk=i(al);gu=s(yk,"MobileBertForSequenceClassification"),yk.forEach(t),Uc.forEach(t),ec=h(o),Qe=a(o,"DIV",{class:!0});var qt=i(Qe);y(Vs.$$.fragment,qt),_u=h(qt),il=a(qt,"P",{});var wk=i(il);bu=s(wk,`MobileBert Model transformer with a sequence classification/regression head on top (a linear layer on top of the
pooled output) e.g. for GLUE tasks.`),wk.forEach(t),Tu=h(qt),Gs=a(qt,"P",{});var Hc=i(Gs);ku=s(Hc,"This model inherits from "),Wa=a(Hc,"A",{href:!0});var Mk=i(Wa);vu=s(Mk,"PreTrainedModel"),Mk.forEach(t),yu=s(Hc,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Hc.forEach(t),wu=h(qt),Ys=a(qt,"P",{});var Qc=i(Ys);Mu=s(Qc,"This model is also a PyTorch "),Js=a(Qc,"A",{href:!0,rel:!0});var $k=i(Js);$u=s($k,"torch.nn.Module"),$k.forEach(t),Fu=s(Qc,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Qc.forEach(t),Bu=h(qt),Ce=a(qt,"DIV",{class:!0});var nt=i(Ce);y(Zs.$$.fragment,nt),Eu=h(nt),so=a(nt,"P",{});var _i=i(so);xu=s(_i,"The "),Ra=a(_i,"A",{href:!0});var Fk=i(Ra);zu=s(Fk,"MobileBertForSequenceClassification"),Fk.forEach(t),Pu=s(_i," forward method, overrides the "),ll=a(_i,"CODE",{});var Bk=i(ll);qu=s(Bk,"__call__"),Bk.forEach(t),Cu=s(_i," special method."),_i.forEach(t),ju=h(nt),y(Xo.$$.fragment,nt),Nu=h(nt),y(en.$$.fragment,nt),Ou=h(nt),y(tn.$$.fragment,nt),Su=h(nt),y(on.$$.fragment,nt),Au=h(nt),y(nn.$$.fragment,nt),nt.forEach(t),qt.forEach(t),tc=h(o),ro=a(o,"H2",{class:!0});var Kc=i(ro);sn=a(Kc,"A",{id:!0,class:!0,href:!0});var Ek=i(sn);dl=a(Ek,"SPAN",{});var xk=i(dl);y(Xs.$$.fragment,xk),xk.forEach(t),Ek.forEach(t),Iu=h(Kc),cl=a(Kc,"SPAN",{});var zk=i(cl);Du=s(zk,"MobileBertForMultipleChoice"),zk.forEach(t),Kc.forEach(t),oc=h(o),Ke=a(o,"DIV",{class:!0});var Ct=i(Ke);y(er.$$.fragment,Ct),Lu=h(Ct),pl=a(Ct,"P",{});var Pk=i(pl);Wu=s(Pk,`MobileBert Model with a multiple choice classification head on top (a linear layer on top of the pooled output and
a softmax) e.g. for RocStories/SWAG tasks.`),Pk.forEach(t),Ru=h(Ct),tr=a(Ct,"P",{});var Vc=i(tr);Uu=s(Vc,"This model inherits from "),Ua=a(Vc,"A",{href:!0});var qk=i(Ua);Hu=s(qk,"PreTrainedModel"),qk.forEach(t),Qu=s(Vc,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
for Named-Entity-Recognition (NER) tasks.`),Ik.forEach(t),pf=h(jt),ir=a(jt,"P",{});var Jc=i(ir);mf=s(Jc,"This model inherits from "),Qa=a(Jc,"A",{href:!0});var Dk=i(Qa);hf=s(Dk,"PreTrainedModel"),Dk.forEach(t),uf=s(Jc,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Jc.forEach(t),ff=h(jt),lr=a(jt,"P",{});var Zc=i(lr);gf=s(Zc,"This model is also a PyTorch "),dr=a(Zc,"A",{href:!0,rel:!0});var Lk=i(dr);_f=s(Lk,"torch.nn.Module"),Lk.forEach(t),bf=s(Zc,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Zc.forEach(t),Tf=h(jt),Je=a(jt,"DIV",{class:!0});var Nt=i(Je);y(cr.$$.fragment,Nt),kf=h(Nt),lo=a(Nt,"P",{});var Ti=i(lo);vf=s(Ti,"The "),Ka=a(Ti,"A",{href:!0});var Wk=i(Ka);yf=s(Wk,"MobileBertForTokenClassification"),Wk.forEach(t),wf=s(Ti," forward method, overrides the "),gl=a(Ti,"CODE",{});var Rk=i(gl);Mf=s(Rk,"__call__"),Rk.forEach(t),$f=s(Ti," special method."),Ti.forEach(t),Ff=h(Nt),y(dn.$$.fragment,Nt),Bf=h(Nt),y(cn.$$.fragment,Nt),Ef=h(Nt),y(pn.$$.fragment,Nt),Nt.forEach(t),jt.forEach(t),rc=h(o),co=a(o,"H2",{class:!0});var Xc=i(co);mn=a(Xc,"A",{id:!0,class:!0,href:!0});var Uk=i(mn);_l=a(Uk,"SPAN",{});var Hk=i(_l);y(pr.$$.fragment,Hk),Hk.forEach(t),Uk.forEach(t),xf=h(Xc),bl=a(Xc,"SPAN",{});var Qk=i(bl);zf=s(Qk,"MobileBertForQuestionAnswering"),Qk.forEach(t),Xc.forEach(t),ac=h(o),Ge=a(o,"DIV",{class:!0});var Ot=i(Ge);y(mr.$$.fragment,Ot),Pf=h(Ot),po=a(Ot,"P",{});var ki=i(po);qf=s(ki,`MobileBert Model with a span classification head on top for extractive question-answering tasks like SQuAD (a
linear layers on top of the hidden-states output to compute `),Tl=a(ki,"CODE",{});var Kk=i(Tl);Cf=s(Kk,"span start logits"),Kk.forEach(t),jf=s(ki," and "),kl=a(ki,"CODE",{});var Vk=i(kl);Nf=s(Vk,"span end logits"),Vk.forEach(t),Of=s(ki,")."),ki.forEach(t),Sf=h(Ot),hr=a(Ot,"P",{});var ep=i(hr);Af=s(ep,"This model inherits from "),Va=a(ep,"A",{href:!0});var Gk=i(Va);If=s(Gk,"PreTrainedModel"),Gk.forEach(t),Df=s(ep,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),ep.forEach(t),Lf=h(Ot),ur=a(Ot,"P",{});var tp=i(ur);Wf=s(tp,"This model is also a PyTorch "),fr=a(tp,"A",{href:!0,rel:!0});var Yk=i(fr);Rf=s(Yk,"torch.nn.Module"),Yk.forEach(t),Uf=s(tp,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),up.forEach(t),z_=h(Tt),Dr=a(Tt,"P",{});var fp=i(Dr);P_=s(fp,"This model is also a "),Lr=a(fp,"A",{href:!0,rel:!0});var xv=i(Lr);q_=s(xv,"tf.keras.Model"),xv.forEach(t),C_=s(fp,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),fp.forEach(t),j_=h(Tt),y(zn.$$.fragment,Tt),N_=h(Tt),ht=a(Tt,"DIV",{class:!0});var rs=i(ht);y(Wr.$$.fragment,rs),O_=h(rs),vo=a(rs,"P",{});var Fi=i(vo);S_=s(Fi,"The "),ni=a(Fi,"A",{href:!0});var zv=i(ni);A_=s(zv,"TFMobileBertForNextSentencePrediction"),zv.forEach(t),I_=s(Fi," forward method, overrides the "),Al=a(Fi,"CODE",{});var Pv=i(Al);D_=s(Pv,"__call__"),Pv.forEach(t),L_=s(Fi," special method."),Fi.forEach(t),W_=h(rs),y(Pn.$$.fragment,rs),R_=h(rs),y(qn.$$.fragment,rs),rs.forEach(t),Tt.forEach(t),fc=h(o),yo=a(o,"H2",{class:!0});var gp=i(yo);Cn=a(gp,"A",{id:!0,class:!0,href:!0});var qv=i(Cn);Il=a(qv,"SPAN",{});var Cv=i(Il);y(Rr.$$.fragment,Cv),Cv.forEach(t),qv.forEach(t),U_=h(gp),Dl=a(gp,"SPAN",{});var jv=i(Dl);H_=s(jv,"TFMobileBertForSequenceClassification"),jv.forEach(t),gp.forEach(t),gc=h(o),Ie=a(o,"DIV",{class:!0});var kt=i(Ie);y(Ur.$$.fragment,kt),Q_=h(kt),Ll=a(kt,"P",{});var Nv=i(Ll);K_=s(Nv,`MobileBert Model transformer with a sequence classification/regression head on top (a linear layer on top of the
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),vp.forEach(t),$b=h(vt),y(In.$$.fragment,vt),Fb=h(vt),ut=a(vt,"DIV",{class:!0});var as=i(ut);y(ea.$$.fragment,as),Bb=h(as),$o=a(as,"P",{});var Ei=i($o);Eb=s(Ei,"The "),ii=a(Ei,"A",{href:!0});var Qv=i(ii);xb=s(Qv,"TFMobileBertForMultipleChoice"),Qv.forEach(t),zb=s(Ei," forward method, overrides the "),Ql=a(Ei,"CODE",{});var Kv=i(Ql);Pb=s(Kv,"__call__"),Kv.forEach(t),qb=s(Ei," special method."),Ei.forEach(t),Cb=h(as),y(Dn.$$.fragment,as),jb=h(as),y(Ln.$$.fragment,as),as.forEach(t),vt.forEach(t),Tc=h(o),Fo=a(o,"H2",{class:!0});var yp=i(Fo);Wn=a(yp,"A",{id:!0,class:!0,href:!0});var Vv=i(Wn);Kl=a(Vv,"SPAN",{});var Gv=i(Kl);y(ta.$$.fragment,Gv),Gv.forEach(t),Vv.forEach(t),Nb=h(yp),Vl=a(yp,"SPAN",{});var Yv=i(Vl);Ob=s(Yv,"TFMobileBertForTokenClassification"),Yv.forEach(t),yp.forEach(t),kc=h(o),Le=a(o,"DIV",{class:!0});var yt=i(Le);y(oa.$$.fragment,yt),Sb=h(yt),Gl=a(yt,"P",{});var Jv=i(Gl);Ab=s(Jv,`MobileBert Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g.
for Named-Entity-Recognition (NER) tasks.`),Jv.forEach(t),Ib=h(yt),na=a(yt,"P",{});var wp=i(na);Db=s(wp,"This model inherits from "),li=a(wp,"A",{href:!0});var Zv=i(li);Lb=s(Zv,"TFPreTrainedModel"),Zv.forEach(t),Wb=s(wp,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Mp.forEach(t),Kb=h(yt),y(Rn.$$.fragment,yt),Vb=h(yt),tt=a(yt,"DIV",{class:!0});var Dt=i(tt);y(aa.$$.fragment,Dt),Gb=h(Dt),Bo=a(Dt,"P",{});var xi=i(Bo);Yb=s(xi,"The "),di=a(xi,"A",{href:!0});var ey=i(di);Jb=s(ey,"TFMobileBertForTokenClassification"),ey.forEach(t),Zb=s(xi," forward method, overrides the "),Yl=a(xi,"CODE",{});var ty=i(Yl);Xb=s(ty,"__call__"),ty.forEach(t),eT=s(xi," special method."),xi.forEach(t),tT=h(Dt),y(Un.$$.fragment,Dt),oT=h(Dt),y(Hn.$$.fragment,Dt),nT=h(Dt),y(Qn.$$.fragment,Dt),Dt.forEach(t),yt.forEach(t),vc=h(o),Eo=a(o,"H2",{class:!0});var $p=i(Eo);Kn=a($p,"A",{id:!0,class:!0,href:!0});var oy=i(Kn);Jl=a(oy,"SPAN",{});var ny=i(Jl);y(ia.$$.fragment,ny),ny.forEach(t),oy.forEach(t),sT=h($p),Zl=a($p,"SPAN",{});var sy=i(Zl);rT=s(sy,"TFMobileBertForQuestionAnswering"),sy.forEach(t),$p.forEach(t),yc=h(o),We=a(o,"DIV",{class:!0});var wt=i(We);y(la.$$.fragment,wt),aT=h(wt),xo=a(wt,"P",{});var zi=i(xo);iT=s(zi,`MobileBert Model with a span classification head on top for extractive question-answering tasks like SQuAD (a
