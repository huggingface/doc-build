import{S as jk,i as Sk,s as Ok,e as n,k as d,w as m,t as r,M as Ak,c as s,d as t,m as l,a,x as g,h as i,b as c,F as e,g as u,y as f,q as _,o as k,B as v,v as Ik}from"../../chunks/vendor-6b77c823.js";import{T as $o}from"../../chunks/Tip-39098574.js";import{D as C}from"../../chunks/Docstring-af1d0ae0.js";import{C as Se}from"../../chunks/CodeBlock-3a8b25a8.js";import{I as Z}from"../../chunks/IconCopyLink-7a11ce68.js";function Lk(B){let h,z,b,P,x;return{c(){h=n("p"),z=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),b=n("code"),P=r("Module"),x=r(`
...
`),oe=s(R,"CODE",{});var kt=a(oe);V=i(kt,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),kt.forEach(t),R.forEach(t),I.forEach(t)},m(y,$){u(y,h,$),e(h,z),u(y,b,$),u(y,P,$),e(P,x),e(x,w),e(P,T),e(P,F),e(F,Oe),u(y,me,$),u(y,q,$),e(q,Pe),e(q,ae),e(ae,Ae),e(q,re),e(q,ie),e(ie,Ie),e(q,Ce),u(y,N,$),u(y,O,$),e(O,xe),u(y,H,$),u(y,j,$),e(j,S),e(S,Le),e(S,Y),e(Y,ee),e(S,Ge),e(S,D),e(D,Ne),e(j,De),e(j,A),e(A,ge),e(A,de),e(de,Me),e(A,te),e(A,K),e(K,Ue),e(j,We),e(j,U),e(U,Be),e(U,oe),e(oe,V)},d(y){y&&t(h),y&&t(b),y&&t(P),y&&t(me),y&&t(q),y&&t(N),y&&t(O),y&&t(H),y&&t(j)}}}function Dk(B){let h,z,b,P,x;return{c(){h=n("p"),z=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),b=n("code"),P=r("Module"),x=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(w){h=s(w,"P",{});var T=a(h);z=i(T,"Although the recipe for forward pass needs to be defined within this function, one should call the "),b=s(T,"CODE",{});var F=a(b);P=i(F,"Module"),F.forEach(t),x=i(T,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),T.forEach(t)},m(w,T){u(w,h,T),e(h,z),e(h,b),e(b,P),e(h,x)},d(w){w&&t(h)}}}function Uk(B){let h,z,b,P,x,w,T,F,Oe,me,q,Pe,ae,Ae,re,ie,Ie,Ce,N,O,xe,H,j,S,Le,Y,ee,Ge,D,Ne,De,A,ge,de,Me,te,K,Ue,We,U,Be,oe,V;return{c(){h=n("p"),z=r("TF 2.0 models accepts two formats as inputs:"),b=d(),P=n("ul"),x=n("li"),w=r("having all inputs as keyword arguments (like PyTorch models), or"),T=d(),F=n("li"),Oe=r("having all inputs as a list, tuple or dict in the first positional arguments."),me=d(),q=n("p"),Pe=r("This second option is useful when using "),ae=n("code"),Ae=r("tf.keras.Model.fit"),re=r(` method which currently requires having all the
tensors in the first argument of the model call function: `),ie=n("code"),Ie=r("model(inputs)"),Ce=r("."),N=d(),O=n("p"),xe=r(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),H=d(),j=n("ul"),S=n("li"),Le=r("a single Tensor with "),Y=n("code"),ee=r("input_ids"),Ge=r(" only and nothing else: "),D=n("code"),Ne=r("model(input_ids)"),De=d(),A=n("li"),ge=r(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),de=n("code"),Me=r("model([input_ids, attention_mask])"),te=r(" or "),K=n("code"),Ue=r("model([input_ids, attention_mask, token_type_ids])"),We=d(),U=n("li"),Be=r(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),oe=n("code"),V=r('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(y){h=s(y,"P",{});var $=a(h);z=i($,"TF 2.0 models accepts two formats as inputs:"),$.forEach(t),b=l(y),P=s(y,"UL",{});var ze=a(P);x=s(ze,"LI",{});var mt=a(x);w=i(mt,"having all inputs as keyword arguments (like PyTorch models), or"),mt.forEach(t),T=l(ze),F=s(ze,"LI",{});var Fe=a(F);Oe=i(Fe,"having all inputs as a list, tuple or dict in the first positional arguments."),Fe.forEach(t),ze.forEach(t),me=l(y),q=s(y,"P",{});var Q=a(q);Pe=i(Q,"This second option is useful when using "),ae=s(Q,"CODE",{});var gt=a(ae);Ae=i(gt,"tf.keras.Model.fit"),gt.forEach(t),re=i(Q,` method which currently requires having all the
...
the latter silently ignores them.`)},l(w){h=s(w,"P",{});var T=a(h);z=i(T,"Although the recipe for forward pass needs to be defined within this function, one should call the "),b=s(T,"CODE",{});var F=a(b);P=i(F,"Module"),F.forEach(t),x=i(T,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),T.forEach(t)},m(w,T){u(w,h,T),e(h,z),e(h,b),e(b,P),e(h,x)},d(w){w&&t(h)}}}function Rk(B){let h,z,b,P,x,w,T,F,Oe,me,q,Pe,ae,Ae,re,ie,Ie,Ce,N,O,xe,H,j,S,Le,Y,ee,Ge,D,Ne,De,A,ge,de,Me,te,K,Ue,We,U,Be,oe,V,y,$,ze,mt,Fe,Q,gt,Ke,le,I,J,$e,ft,X,_t,Qe,R,kt,qo,Yd,el,ca,tl,ol,Ci,fe,ua,nl,sl,pa,al,rl,ha,il,dl,Eo,ll,Co,cl,ul,pl,Bt,Mo,hl,ml,jo,gl,fl,Mi,vt,Vt,ma,So,_l,ga,kl,ji,Je,Rt,Oo,vl,yl,Ao,bl,Tl,wl,fa,Pl,xl,_a,zl,Si,yt,Ht,ka,Io,Fl,va,$l,Oi,_e,ya,ba,ql,El,Ta,xs,Cl,zs,Ml,jl,Lo,wa,Sl,Ol,bt,Pa,Al,Il,xa,Ll,Gl,Go,Nl,za,Dl,Ul,Wl,Fa,Ve,Bl,$a,Vl,Rl,qa,Hl,Kl,Ea,Ql,Jl,Xl,Ca,Tt,Zl,No,Yl,ec,Ma,tc,oc,Ai,wt,Kt,ja,Do,nc,Sa,sc,Ii,Uo,Li,Pt,Qt,Oa,Wo,ac,Aa,rc,Gi,ce,Bo,ic,xt,dc,Fs,lc,cc,Vo,uc,pc,hc,zt,mc,$s,gc,fc,qs,_c,kc,vc,Ia,yc,bc,Ro,Ni,Ft,Jt,La,Ho,Tc,Ga,wc,Di,Xt,Pc,Na,xc,zc,Ui,W,Ko,Fc,Qo,$c,Jo,qc,Ec,Cc,Xo,Mc,Es,jc,Sc,Oc,je,Zo,Ac,Yo,Ic,Da,Lc,Gc,Nc,en,Cs,Dc,Ua,Uc,Wc,tn,Bc,Wa,Vc,Rc,Hc,Ba,Kc,Qc,Zt,on,Jc,Va,Xc,Zc,Yt,nn,Yc,Ra,eu,tu,eo,sn,ou,Ha,nu,Wi,$t,to,Ka,an,su,Qa,au,Bi,ue,rn,ru,qt,iu,Ja,du,lu,dn,cu,uu,pu,ln,hu,Ms,mu,gu,fu,Xe,cn,_u,Xa,ku,vu,un,js,yu,Za,bu,Tu,pn,wu,Ya,Pu,xu,zu,oo,hn,Fu,er,$u,Vi,Et,no,tr,mn,qu,or,Eu,Ri,qe,gn,Cu,fn,Mu,Ss,ju,Su,Ou,_n,Au,kn,Iu,Lu,Gu,ke,vn,Nu,Ct,Du,Os,Uu,Wu,nr,Bu,Vu,Ru,so,Hu,sr,Ku,Qu,yn,Hi,Mt,ao,ar,bn,Ju,rr,Xu,Ki,Ee,Tn,Zu,wn,Yu,As,ep,tp,op,Pn,np,xn,sp,ap,rp,ve,zn,ip,jt,dp,Is,lp,cp,ir,up,pp,hp,ro,mp,dr,gp,fp,Fn,Qi,St,io,lr,$n,_p,cr,kp,Ji,Ot,qn,vp,Ze,En,yp,ur,bp,Tp,Cn,Xi,At,lo,pr,Mn,wp,hr,Pp,Zi,pe,jn,xp,Sn,zp,Ls,Fp,$p,qp,On,Ep,An,Cp,Mp,jp,co,Sp,ye,In,Op,It,Ap,Gs,Ip,Lp,mr,Gp,Np,Dp,uo,Up,gr,Wp,Bp,Ln,Yi,Lt,po,fr,Gn,Vp,_r,Rp,ed,he,Nn,Hp,Dn,Kp,Ns,Qp,Jp,Xp,Un,Zp,Wn,Yp,eh,th,ho,oh,be,Bn,nh,Gt,sh,Ds,ah,rh,kr,ih,dh,lh,mo,ch,vr,uh,ph,Vn,td,Nt,go,yr,Rn,hh,br,mh,od,L,Hn,gh,Kn,fh,Us,_h,kh,vh,Qn,yh,Jn,bh,Th,wh,Tr,Ph,xh,Re,wr,Xn,zh,Fh,Pr,Zn,$h,qh,xr,Yn,Eh,Ch,zr,es,Mh,jh,Te,ts,Sh,Dt,Oh,Fr,Ah,Ih,$r,Lh,Gh,Nh,fo,Dh,qr,Uh,Wh,os,Bh,Ye,ns,Vh,Er,Rh,Hh,ss,Kh,et,as,Qh,Cr,Jh,Xh,rs,nd,Ut,_o,Mr,is,Zh,jr,Yh,sd,G,ds,em,ls,tm,Ws,om,nm,sm,cs,am,us,rm,im,dm,Sr,lm,cm,He,Or,ps,um,pm,Ar,hs,hm,mm,Ir,ms,gm,fm,Lr,gs,_m,km,E,fs,vm,Wt,ym,Gr,bm,Tm,Nr,wm,Pm,xm,ko,zm,Dr,Fm,$m,Ur,Wr,Br,Vr,qm,Em,Rr,Hr,Kr,Qr,Cm,Mm,Jr,Xr,Zr,Yr,jm,Sm,ei,ti,_s,vo,yo,oi,ks,Om,ni,Am,Im,si,Lm,Gm,ai,Nm,Dm,ri,ii,di,li,Um,Wm,ci,ui,pi,hi,Bm,Vm,mi,gi,fi,_i,Rm,Hm,ki,vi,yi,bi,Km,Qm,tt,vs,Jm,Ti,Xm,Zm,ys,Ym,ot,bs,eg,wi,tg,og,Ts,ad;return w=new Z({}),H=new Z({}),$e=new Z({}),So=new Z({}),Io=new Z({}),Do=new Z({}),Uo=new Se({props:{code:`from transformers import PegasusForConditionalGeneration, PegasusTokenizer
import torch
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/main/en/main_classes/model#transformers.TFPreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),ho=new $o({props:{$$slots:{default:[Uk]},$$scope:{ctx:B}}}),Bn=new C({props:{name:"call",anchor:"transformers.TFPegasusForConditionalGeneration.call",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"decoder_input_ids",val:" = None"},{name:"decoder_attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"decoder_head_mask",val:" = None"},{name:"cross_attn_head_mask",val:" = None"},{name:"encoder_outputs",val:": typing.Optional[transformers.modeling_tf_outputs.TFBaseModelOutput] = None"},{name:"past_key_values",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"decoder_inputs_embeds",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"},{name:"labels",val:" = None"},{name:"training",val:" = False"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/pegasus/modeling_tf_pegasus.py#L1283",parametersDescription:[{anchor:"transformers.TFPegasusForConditionalGeneration.call.input_ids",description:`<strong>input_ids</strong> (<code>tf.Tensor</code> of shape <code>({0})</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/main/en/model_doc/pegasus#transformers.PegasusTokenizer">PegasusTokenizer</a>. See <a href="/docs/transformers/main/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/main/en/model_doc/wav2vec2_phoneme#transformers.Wav2Vec2PhonemeCTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
