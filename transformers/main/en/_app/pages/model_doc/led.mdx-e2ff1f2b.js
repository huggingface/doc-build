import{S as Of,i as Cf,s as Af,e as n,k as d,w as f,t as r,M as Pf,c as s,d as t,m as l,a,x as _,h as i,b as c,F as e,g as h,y as g,q as T,o as v,B as b,v as Nf}from"../../chunks/vendor-6b77c823.js";import{T as go}from"../../chunks/Tip-39098574.js";import{D as $}from"../../chunks/Docstring-af1d0ae0.js";import{C as Ne}from"../../chunks/CodeBlock-3a8b25a8.js";import{I as _e}from"../../chunks/IconCopyLink-7a11ce68.js";function jf(G){let u,L,k,E,q;return{c(){u=n("p"),L=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),k=n("code"),E=r("Module"),q=r(`
...
`),re=n("code"),De=r('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(m){u=s(m,"P",{});var z=a(u);L=i(z,"TF 2.0 models accepts two formats as inputs:"),z.forEach(t),k=l(m),E=s(m,"UL",{});var ie=a(E);q=s(ie,"LI",{});var st=a(q);y=i(st,"having all inputs as keyword arguments (like PyTorch models), or"),st.forEach(t),w=l(ie),D=s(ie,"LI",{});var at=a(D);je=i(at,"having all inputs as a list, tuple or dict in the first positional arguments."),at.forEach(t),ie.forEach(t),ge=l(m),F=s(m,"P",{});var I=a(F);Y=i(I,"This second option is useful when using "),V=s(I,"CODE",{});var rt=a(V);ne=i(rt,"tf.keras.Model.fit"),rt.forEach(t),Ie=i(I,` method which currently requires having all the
tensors in the first argument of the model call function: `),R=s(I,"CODE",{});var it=a(R);Ge=i(it,"model(inputs)"),it.forEach(t),Me=i(I,"."),I.forEach(t),B=l(m),K=s(m,"P",{});var Ce=a(K);se=i(Ce,`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
...
the latter silently ignores them.`)},l(y){u=s(y,"P",{});var w=a(u);L=i(w,"Although the recipe for forward pass needs to be defined within this function, one should call the "),k=s(w,"CODE",{});var D=a(k);E=i(D,"Module"),D.forEach(t),q=i(w,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),w.forEach(t)},m(y,w){h(y,u,w),e(u,L),e(u,k),e(k,E),e(u,q)},d(y){y&&t(u)}}}function Vf(G){let u,L,k,E,q,y,w,D,je,ge,F,Y,V,ne,Ie,R,Ge,Me,B,K,se,Le,S,A,Te,ae,Se,ve,X,Be,Oe,O,Qe,ee,x,M,Q,He,We,j,Ue,re,De,m,z,ie,st,at,I,rt,it,Ce,J,de,Ae,dt,le,lt,ce,Ve,Re,Ai,Pi,Ss,Ni,ji,Ii,Fe,Gi,Os,Bi,Qi,Cs,Hi,Wi,Kn,Ui,Vi,As,Ri,Ki,Xi,Z,Ji,Ps,Zi,Yi,Ns,ed,td,Xn,od,nd,js,sd,ad,Is,rd,id,Gs,dd,ld,cd,ct,hd,Bs,pd,ud,Qs,md,fd,_d,To,gd,vo,Td,vd,bd,bo,kd,ko,wd,yd,_r,Nt,Ed,wo,qd,Ld,gr,ht,jt,Hs,yo,Dd,Ws,Fd,Tr,C,Eo,zd,pt,$d,Jn,xd,Md,qo,Sd,Od,Cd,ut,Ad,Zn,Pd,Nd,Yn,jd,Id,Gd,Us,Bd,Qd,Lo,Hd,Vs,Rs,Ks,Xs,Wd,Ud,Js,Zs,Ys,It,Gt,ea,Do,Vd,ta,Rd,Kd,oa,na,Fo,Bt,Qt,sa,zo,Xd,aa,Jd,Zd,ra,Yd,el,ia,da,la,Ht,Wt,ca,$o,tl,ha,ol,vr,mt,Ut,pa,xo,nl,ua,sl,br,N,Mo,al,ma,rl,il,Vt,es,dl,ll,ts,cl,hl,pl,So,ul,os,ml,fl,_l,Ke,Oo,gl,fa,Tl,vl,Co,ns,bl,_a,kl,wl,ss,yl,ga,El,ql,Rt,Ao,Ll,Po,Dl,Ta,Fl,zl,$l,Kt,No,xl,va,Ml,Sl,as,jo,kr,ft,Xt,ba,Io,Ol,ka,Cl,wr,ze,Go,Al,Bo,Pl,wa,Nl,jl,Il,Jt,rs,Gl,Bl,is,Ql,Hl,Wl,Qo,Ul,ds,Vl,Rl,yr,_t,Zt,ya,Ho,Kl,Ea,Xl,Er,gt,Wo,Jl,qa,Zl,qr,Tt,Uo,Yl,La,ec,Lr,vt,Vo,tc,Da,oc,Dr,bt,Ro,nc,Fa,sc,Fr,kt,Ko,ac,za,rc,zr,wt,Xo,ic,$a,dc,$r,yt,Jo,lc,xa,cc,xr,Et,Zo,hc,Ma,pc,Mr,qt,Yt,Sa,Yo,uc,Oa,mc,Sr,$e,en,fc,tn,_c,ls,gc,Tc,vc,on,bc,nn,kc,wc,yc,be,sn,Ec,Lt,qc,cs,Lc,Dc,Ca,Fc,zc,$c,eo,xc,Aa,Mc,Sc,an,Or,Dt,to,Pa,rn,Oc,Na,Cc,Cr,xe,dn,Ac,ln,Pc,hs,Nc,jc,Ic,cn,Gc,hn,Bc,Qc,Hc,H,pn,Wc,Ft,Uc,ps,Vc,Rc,ja,Kc,Xc,Jc,oo,Zc,Ia,Yc,eh,un,th,Ga,oh,nh,mn,Ar,zt,no,Ba,fn,sh,Qa,ah,Pr,he,_n,rh,Ha,ih,dh,gn,lh,us,ch,hh,ph,Tn,uh,vn,mh,fh,_h,P,bn,gh,$t,Th,ms,vh,bh,Wa,kh,wh,yh,so,Eh,Ua,qh,Lh,kn,Dh,wn,Fh,Va,zh,$h,yn,xh,En,Nr,xt,ao,Ra,qn,Mh,Ka,Sh,jr,pe,Ln,Oh,Mt,Ch,Xa,Ah,Ph,Ja,Nh,jh,Ih,Dn,Gh,fs,Bh,Qh,Hh,Fn,Wh,zn,Uh,Vh,Rh,te,$n,Kh,St,Xh,_s,Jh,Zh,Za,Yh,ep,tp,ro,op,Ya,np,sp,xn,ap,Mn,Ir,Ot,io,er,Sn,rp,tr,ip,Gr,ue,On,dp,Cn,lp,gs,cp,hp,pp,An,up,Pn,mp,fp,_p,lo,gp,ke,Nn,Tp,Ct,vp,Ts,bp,kp,or,wp,yp,Ep,co,qp,nr,Lp,Dp,jn,Br,At,ho,sr,In,Fp,ar,zp,Qr,me,Gn,$p,Bn,xp,vs,Mp,Sp,Op,Qn,Cp,Hn,Ap,Pp,Np,po,jp,we,Wn,Ip,Pt,Gp,bs,Bp,Qp,rr,Hp,Wp,Up,uo,Vp,ir,Rp,Kp,Un,Hr;return y=new _e({}),ne=new _e({}),yo=new _e({}),Eo=new $({props:{name:"class transformers.LEDConfig",anchor:"transformers.LEDConfig",parameters:[{name:"vocab_size",val:" = 50265"},{name:"max_encoder_position_embeddings",val:" = 16384"},{name:"max_decoder_position_embeddings",val:" = 1024"},{name:"encoder_layers",val:" = 12"},{name:"encoder_ffn_dim",val:" = 4096"},{name:"encoder_attention_heads",val:" = 16"},{name:"decoder_layers",val:" = 12"},{name:"decoder_ffn_dim",val:" = 4096"},{name:"decoder_attention_heads",val:" = 16"},{name:"encoder_layerdrop",val:" = 0.0"},{name:"decoder_layerdrop",val:" = 0.0"},{name:"use_cache",val:" = True"},{name:"is_encoder_decoder",val:" = True"},{name:"activation_function",val:" = 'gelu'"},{name:"d_model",val:" = 1024"},{name:"dropout",val:" = 0.1"},{name:"attention_dropout",val:" = 0.0"},{name:"activation_dropout",val:" = 0.0"},{name:"init_std",val:" = 0.02"},{name:"decoder_start_token_id",val:" = 2"},{name:"classifier_dropout",val:" = 0.0"},{name:"pad_token_id",val:" = 1"},{name:"bos_token_id",val:" = 0"},{name:"eos_token_id",val:" = 2"},{name:"attention_window",val:": typing.Union[typing.List[int], int] = 512"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/led/configuration_led.py#L31",parametersDescription:[{anchor:"transformers.LEDConfig.vocab_size",description:`<strong>vocab_size</strong> (<code>int</code>, <em>optional</em>, defaults to 50265) &#x2014;
...
<p>Global attentions weights after the attention softmax, used to compute the weighted average in the
self-attention heads. Those are the attention weights from every token with global attention to every token
in the sequence.`,name:"encoder_global_attentions"}]}}),Vo=new $({props:{name:"class transformers.models.led.modeling_led.LEDSeq2SeqLMOutput",anchor:"transformers.models.led.modeling_led.LEDSeq2SeqLMOutput",parameters:[{name:"loss",val:": typing.Optional[torch.FloatTensor] = None"},{name:"logits",val:": FloatTensor = None"},{name:"past_key_values",val:": typing.Optional[typing.List[torch.FloatTensor]] = None"},{name:"decoder_hidden_states",val:": typing.Optional[typing.Tuple[torch.FloatTensor]] = None"},{name:"decoder_attentions",val:": typing.Optional[typing.Tuple[torch.FloatTensor]] = None"},{name:"cross_attentions",val:": typing.Optional[typing.Tuple[torch.FloatTensor]] = None"},{name:"encoder_last_hidden_state",val:": typing.Optional[torch.FloatTensor] = None"},{name:"encoder_hidden_states",val:": typing.Optional[typing.Tuple[torch.FloatTensor]] = None"},{name:"encoder_attentions",val:": typing.Optional[typing.Tuple[torch.FloatTensor]] = None"},{name:"encoder_global_attentions",val:": typing.Optional[typing.Tuple[torch.FloatTensor]] = None"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/led/modeling_led.py#L1236",parametersDescription:[{anchor:"transformers.models.led.modeling_led.LEDSeq2SeqLMOutput.loss",description:`<strong>loss</strong> (<code>torch.FloatTensor</code> of shape <code>(1,)</code>, <em>optional</em>, returned when <code>labels</code> is provided) &#x2014;
...
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-comment"># probs[5] is associated with the mask token</span>`}}),{c(){u=n("meta"),L=d(),k=n("h1"),E=n("a"),q=n("span"),f(y.$$.fragment),w=d(),D=n("span"),je=r("LED"),ge=d(),F=n("h2"),Y=n("a"),V=n("span"),f(ne.$$.fragment),Ie=d(),R=n("span"),Ge=r("Overview"),Me=d(),B=n("p"),K=r("The LED model was proposed in "),se=n("a"),Le=r("Longformer: The Long-Document Transformer"),S=r(` by Iz
...
`),Ae=n("a"),dt=r("BartTokenizer"),le=r("."),lt=d(),ce=n("li"),Ve=r("LED works very well on long-range "),Re=n("em"),Ai=r("sequence-to-sequence"),Pi=r(" tasks where the "),Ss=n("code"),Ni=r("input_ids"),ji=r(` largely exceed a length of
...
gained, when `),Kn=n("a"),Ui=r("LEDTokenizer"),Vi=r(" is used with the "),As=n("code"),Ri=r("pad_to_multiple_of"),Ki=r(" argument."),Xi=d(),Z=n("li"),Ji=r("LED makes use of "),Ps=n("em"),Zi=r("global attention"),Yi=r(" by means of the "),Ns=n("code"),ed=r("global_attention_mask"),td=r(` (see
...
adding special tokens. A BART sequence has the following format:`),vl=d(),Co=n("ul"),ns=n("li"),bl=r("single sequence: "),_a=n("code"),kl=r("<s> X </s>"),wl=d(),ss=n("li"),yl=r("pair of sequences: "),ga=n("code"),El=r("<s> A </s></s> B </s>"),ql=d(),Rt=n("div"),f(Ao.$$.fragment),Ll=d(),Po=n("p"),Dl=r(`Retrieve sequence ids from a token list that has no special tokens added. This method is called when adding
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),_h=d(),P=n("div"),f(bn.$$.fragment),gh=d(),$t=n("p"),Th=r("The "),ms=n("a"),vh=r("LEDForSequenceClassification"),bh=r(" forward method, overrides the "),Wa=n("code"),kh=r("__call__"),wh=r(" special method."),yh=d(),f(so.$$.fragment),Eh=d(),Ua=n("p"),qh=r("Example of single-label classification:"),Lh=d(),f(kn.$$.fragment),Dh=d(),f(wn.$$.fragment),Fh=d(),Va=n("p"),zh=r("Example of multi-label classification:"),$h=d(),f(yn.$$.fragment),xh=d(),f(En.$$.fragment),Nr=d(),xt=n("h2"),ao=n("a"),Ra=n("span"),f(qn.$$.fragment),Mh=d(),Ka=n("span"),Sh=r("LEDForQuestionAnswering"),jr=d(),pe=n("div"),f(Ln.$$.fragment),Oh=d(),Mt=n("p"),Ch=r(`LED Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear layer
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Hh=d(),Fn=n("p"),Wh=r("This model is also a PyTorch "),zn=n("a"),Uh=r("torch.nn.Module"),Vh=r(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Rh=d(),te=n("div"),f($n.$$.fragment),Kh=d(),St=n("p"),Xh=r("The "),_s=n("a"),Jh=r("LEDForQuestionAnswering"),Zh=r(" forward method, overrides the "),Za=n("code"),Yh=r("__call__"),ep=r(" special method."),tp=d(),f(ro.$$.fragment),op=d(),Ya=n("p"),np=r("Example:"),sp=d(),f(xn.$$.fragment),ap=d(),f(Mn.$$.fragment),Ir=d(),Ot=n("h2"),io=n("a"),er=n("span"),f(Sn.$$.fragment),rp=d(),tr=n("span"),ip=r("TFLEDModel"),Gr=d(),ue=n("div"),f(On.$$.fragment),dp=d(),Cn=n("p"),lp=r(`The bare LED Model outputting raw hidden-states without any specific head on top.
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Np=d(),f(po.$$.fragment),jp=d(),we=n("div"),f(Wn.$$.fragment),Ip=d(),Pt=n("p"),Gp=r("The "),bs=n("a"),Bp=r("TFLEDForConditionalGeneration"),Qp=r(" forward method, overrides the "),rr=n("code"),Hp=r("__call__"),Wp=r(" special method."),Up=d(),f(uo.$$.fragment),Vp=d(),ir=n("p"),Rp=r("Examples:"),Kp=d(),f(Un.$$.fragment),this.h()},l(o){const p=Pf('[data-svelte="svelte-1phssyn"]',document.head);u=s(p,"META",{name:!0,content:!0}),p.forEach(t),L=l(o),k=s(o,"H1",{class:!0});var Vn=a(k);E=s(Vn,"A",{id:!0,class:!0,href:!0});var dr=a(E);q=s(dr,"SPAN",{});var lr=a(q);_(y.$$.fragment,lr),lr.forEach(t),dr.forEach(t),w=l(Vn),D=s(Vn,"SPAN",{});var cr=a(D);je=i(cr,"LED"),cr.forEach(t),Vn.forEach(t),ge=l(o),F=s(o,"H2",{class:!0});var Rn=a(F);Y=s(Rn,"A",{id:!0,class:!0,href:!0});var hr=a(Y);V=s(hr,"SPAN",{});var pr=a(V);_(ne.$$.fragment,pr),pr.forEach(t),hr.forEach(t),Ie=l(Rn),R=s(Rn,"SPAN",{});var ur=a(R);Ge=i(ur,"Overview"),ur.forEach(t),Rn.forEach(t),Me=l(o),B=s(o,"P",{});var Wr=a(B);K=i(Wr,"The LED model was proposed in "),se=s(Wr,"A",{href:!0,rel:!0});var Zp=a(se);Le=i(Zp,"Longformer: The Long-Document Transformer"),Zp.forEach(t),S=i(Wr,` by Iz
...
`),Ae=s(fe,"A",{href:!0});var lu=a(Ae);dt=i(lu,"BartTokenizer"),lu.forEach(t),le=i(fe,"."),fe.forEach(t),lt=l(ye),ce=s(ye,"LI",{});var ks=a(ce);Ve=i(ks,"LED works very well on long-range "),Re=s(ks,"EM",{});var cu=a(Re);Ai=i(cu,"sequence-to-sequence"),cu.forEach(t),Pi=i(ks," tasks where the "),Ss=s(ks,"CODE",{});var hu=a(Ss);Ni=i(hu,"input_ids"),hu.forEach(t),ji=i(ks,` largely exceed a length of
...
`),Qs=s(ws,"CODE",{});var yu=a(Qs);md=i(yu,"model.gradient_checkpointing_enable()"),yu.forEach(t),fd=i(ws,"."),ws.forEach(t),_d=l(ye),To=s(ye,"LI",{});var Ur=a(To);gd=i(Ur,"A notebook showing how to evaluate LED, can be accessed "),vo=s(Ur,"A",{href:!0,rel:!0});var Eu=a(vo);Td=i(Eu,"here"),Eu.forEach(t),vd=i(Ur,"."),Ur.forEach(t),bd=l(ye),bo=s(ye,"LI",{});var Vr=a(bo);kd=i(Vr,"A notebook showing how to fine-tune LED, can be accessed "),ko=s(Vr,"A",{href:!0,rel:!0});var qu=a(ko);wd=i(qu,"here"),qu.forEach(t),yd=i(Vr,"."),Vr.forEach(t),ye.forEach(t),_r=l(o),Nt=s(o,"P",{});var Rr=a(Nt);Ed=i(Rr,"This model was contributed by "),wo=s(Rr,"A",{href:!0,rel:!0});var Lu=a(wo);qd=i(Lu,"patrickvonplaten"),Lu.forEach(t),Ld=i(Rr,"."),Rr.forEach(t),gr=l(o),ht=s(o,"H2",{class:!0});var Kr=a(ht);jt=s(Kr,"A",{id:!0,class:!0,href:!0});var Du=a(jt);Hs=s(Du,"SPAN",{});var Fu=a(Hs);_(yo.$$.fragment,Fu),Fu.forEach(t),Du.forEach(t),Dd=l(Kr),Ws=s(Kr,"SPAN",{});var zu=a(Ws);Fd=i(zu,"LEDConfig"),zu.forEach(t),Kr.forEach(t),Tr=l(o),C=s(o,"DIV",{class:!0});var W=a(C);_(Eo.$$.fragment,W),zd=l(W),pt=s(W,"P",{});var ys=a(pt);$d=i(ys,"This is the configuration class to store the configuration of a "),Jn=s(ys,"A",{href:!0});var $u=a(Jn);xd=i($u,"LEDModel"),$u.forEach(t),Md=i(ys,`. It is used to instantiate an LED
model according to the specified arguments, defining the model architecture. Instantiating a configuration with the
defaults will yield a similar configuration to that of the LED
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),yi.forEach(t),Hc=l(_o),H=s(_o,"DIV",{class:!0});var qe=a(H);_(pn.$$.fragment,qe),Wc=l(qe),Ft=s(qe,"P",{});var Ds=a(Ft);Uc=i(Ds,"The "),ps=s(Ds,"A",{href:!0});var Vm=a(ps);Vc=i(Vm,"LEDForConditionalGeneration"),Vm.forEach(t),Rc=i(Ds," forward method, overrides the "),ja=s(Ds,"CODE",{});var Rm=a(ja);Kc=i(Rm,"__call__"),Rm.forEach(t),Xc=i(Ds," special method."),Ds.forEach(t),Jc=l(qe),_(oo.$$.fragment,qe),Zc=l(qe),Ia=s(qe,"P",{});var Km=a(Ia);Yc=i(Km,"Conditional generation example:"),Km.forEach(t),eh=l(qe),_(un.$$.fragment,qe),th=l(qe),Ga=s(qe,"P",{});var Xm=a(Ga);oh=i(Xm,"Summarization example:"),Xm.forEach(t),nh=l(qe),_(mn.$$.fragment,qe),qe.forEach(t),_o.forEach(t),Ar=l(o),zt=s(o,"H2",{class:!0});var Ei=a(zt);no=s(Ei,"A",{id:!0,class:!0,href:!0});var Jm=a(no);Ba=s(Jm,"SPAN",{});var Zm=a(Ba);_(fn.$$.fragment,Zm),Zm.forEach(t),Jm.forEach(t),sh=l(Ei),Qa=s(Ei,"SPAN",{});var Ym=a(Qa);ah=i(Ym,"LEDForSequenceClassification"),Ym.forEach(t),Ei.forEach(t),Pr=l(o),he=s(o,"DIV",{class:!0});var Ze=a(he);_(_n.$$.fragment,Ze),rh=l(Ze),Ha=s(Ze,"P",{});var ef=a(Ha);ih=i(ef,`LED model with a sequence classification/head on top (a linear layer on top of the pooled output) e.g. for GLUE
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Li.forEach(t),_h=l(Ze),P=s(Ze,"DIV",{class:!0});var U=a(P);_(bn.$$.fragment,U),gh=l(U),$t=s(U,"P",{});var Fs=a($t);Th=i(Fs,"The "),ms=s(Fs,"A",{href:!0});var nf=a(ms);vh=i(nf,"LEDForSequenceClassification"),nf.forEach(t),bh=i(Fs," forward method, overrides the "),Wa=s(Fs,"CODE",{});var sf=a(Wa);kh=i(sf,"__call__"),sf.forEach(t),wh=i(Fs," special method."),Fs.forEach(t),yh=l(U),_(so.$$.fragment,U),Eh=l(U),Ua=s(U,"P",{});var af=a(Ua);qh=i(af,"Example of single-label classification:"),af.forEach(t),Lh=l(U),_(kn.$$.fragment,U),Dh=l(U),_(wn.$$.fragment,U),Fh=l(U),Va=s(U,"P",{});var rf=a(Va);zh=i(rf,"Example of multi-label classification:"),rf.forEach(t),$h=l(U),_(yn.$$.fragment,U),xh=l(U),_(En.$$.fragment,U),U.forEach(t),Ze.forEach(t),Nr=l(o),xt=s(o,"H2",{class:!0});var Di=a(xt);ao=s(Di,"A",{id:!0,class:!0,href:!0});var df=a(ao);Ra=s(df,"SPAN",{});var lf=a(Ra);_(qn.$$.fragment,lf),lf.forEach(t),df.forEach(t),Mh=l(Di),Ka=s(Di,"SPAN",{});var cf=a(Ka);Sh=i(cf,"LEDForQuestionAnswering"),cf.forEach(t),Di.forEach(t),jr=l(o),pe=s(o,"DIV",{class:!0});var Ye=a(pe);_(Ln.$$.fragment,Ye),Oh=l(Ye),Mt=s(Ye,"P",{});var zs=a(Mt);Ch=i(zs,`LED Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear layer
