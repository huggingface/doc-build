...
the latter silently ignores them.`)},l(g){h=i(g,"P",{});var f=r(h);E=s(f,"Although the recipe for forward pass needs to be defined within this function, one should call the "),m=i(f,"CODE",{});var z=r(m);L=s(z,"Module"),z.forEach(t),w=s(f,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),f.forEach(t)},m(g,f){u(g,h,f),e(h,E),e(h,m),e(m,L),e(h,w)},d(g){g&&t(h)}}}function up(K){let h,E,m,L,w,g,f,z,Ds,Ho,le,xe,Nn,He,Ws,Dn,Us,Vo,$e,Bs,Ve,Ks,Rs,Yo,Jt,Hs,Qo,Xt,Wn,Vs,Jo,Gt,Ys,Xo,R,Un,Ye,Qs,Zt,Js,Xs,Gs,Bn,F,Zs,Kn,ea,ta,Rn,na,oa,Hn,sa,aa,Vn,ia,ra,en,da,la,ca,Qe,H,tn,pa,ha,Yn,ua,ma,Qn,fa,ga,Jn,_a,ka,ya,Je,nn,Xn,ba,va,Ta,on,Gn,La,wa,Ea,B,Zn,za,xa,ce,Fe,sn,$a,Fa,Xe,qa,Ma,Ca,qe,an,Pa,ja,Ge,Aa,Ia,Oa,rn,dn,Sa,Na,Da,O,ln,Wa,Ua,eo,Ba,Ka,to,Ra,Ha,no,Va,Ya,oo,Qa,Ja,Xa,pe,Ga,cn,Za,ei,Ze,ti,ni,oi,et,si,tt,ai,ii,Go,pn,ri,Zo,nt,es,V,di,ot,li,ci,st,pi,hi,at,ui,mi,ts,he,Me,so,it,fi,ao,gi,ns,q,rt,_i,dt,ki,hn,yi,bi,vi,ue,Ti,un,Li,wi,mn,Ei,zi,xi,io,$i,Fi,lt,os,me,Ce,ro,ct,qi,lo,Mi,ss,M,pt,Ci,co,Pi,ji,x,Ai,fn,Ii,Oi,gn,Si,Ni,_n,Di,Wi,po,Ui,Bi,ho,Ki,Ri,uo,Hi,Vi,mo,Yi,Qi,Ji,Pe,ht,Xi,fo,Gi,Zi,kn,ut,as,fe,je,go,mt,er,_o,tr,is,C,ft,nr,ko,or,sr,gt,ar,yn,ir,rr,dr,_t,lr,kt,cr,pr,hr,S,yt,ur,ge,mr,bn,fr,gr,yo,_r,kr,yr,Ae,br,bo,vr,Tr,bt,rs,_e,Ie,vo,vt,Lr,To,wr,ds,P,Tt,Er,Lo,zr,xr,Lt,$r,vn,Fr,qr,Mr,wt,Cr,Et,Pr,jr,Ar,J,zt,Ir,ke,Or,Tn,Sr,Nr,wo,Dr,Wr,Ur,Oe,ls,ye,Se,Eo,xt,Br,zo,Kr,cs,j,$t,Rr,xo,Hr,Vr,Ft,Yr,Ln,Qr,Jr,Xr,qt,Gr,Mt,Zr,ed,td,N,Ct,nd,be,od,wn,sd,ad,$o,id,rd,dd,Ne,ld,Fo,cd,pd,Pt,ps,ve,De,qo,jt,hd,Mo,ud,hs,A,At,md,Co,fd,gd,It,_d,En,kd,yd,bd,Ot,vd,St,Td,Ld,wd,D,Nt,Ed,Te,zd,zn,xd,$d,Po,Fd,qd,Md,We,Cd,jo,Pd,jd,Dt,us,Le,Ue,Ao,Wt,Ad,Io,Id,ms,I,Ut,Od,Oo,Sd,Nd,Bt,Dd,xn,Wd,Ud,Bd,Kt,Kd,Rt,Rd,Hd,Vd,W,Ht,Yd,we,Qd,$n,Jd,Xd,So,Gd,Zd,el,Be,tl,No,nl,ol,Vt,fs;return g=new ze({}),He=new ze({}),nt=new Sn({props:{code:`from transformers import LukeTokenizer, LukeModel, LukeForEntityPairClassification
...
<p><a
  href="/docs/transformers/main/en/main_classes/tokenizer#transformers.BatchEncoding"
>BatchEncoding</a></p>
`}}),ut=new U({props:{name:"save_vocabulary",anchor:"transformers.LukeTokenizer.save_vocabulary",parameters:[{name:"save_directory",val:": str"},{name:"filename_prefix",val:": typing.Optional[str] = None"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/luke/tokenization_luke.py#L1378"}}),mt=new ze({}),ft=new U({props:{name:"class transformers.LukeModel",anchor:"transformers.LukeModel",parameters:[{name:"config",val:": LukeConfig"},{name:"add_pooling_layer",val:": bool = True"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/luke/modeling_luke.py#L879",parametersDescription:[{anchor:"transformers.LukeModel.config",description:`<strong>config</strong> (<a href="/docs/transformers/main/en/model_doc/luke#transformers.LukeConfig">LukeConfig</a>) &#x2014; Model configuration class with all the parameters of the
model. Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/main/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),yt=new U({props:{name:"forward",anchor:"transformers.LukeModel.forward",parameters:[{name:"input_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"attention_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"token_type_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"position_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"entity_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"entity_attention_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"entity_token_type_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"entity_position_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"head_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/luke/modeling_luke.py#L911",parametersDescription:[{anchor:"transformers.LukeModel.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
...
model. Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/main/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),zt=new U({props:{name:"forward",anchor:"transformers.LukeForMaskedLM.forward",parameters:[{name:"input_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"attention_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"token_type_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"position_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"entity_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"entity_attention_mask",val:": typing.Optional[torch.LongTensor] = None"},{name:"entity_token_type_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"entity_position_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"labels",val:": typing.Optional[torch.LongTensor] = None"},{name:"entity_labels",val:": typing.Optional[torch.LongTensor] = None"},{name:"head_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/luke/modeling_luke.py#L1168",parametersDescription:[{anchor:"transformers.LukeForMaskedLM.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/main/en/model_doc/luke#transformers.LukeTokenizer">LukeTokenizer</a>. See <a href="/docs/transformers/main/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/main/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
model. Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/main/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),Nt=new U({props:{name:"forward",anchor:"transformers.LukeForEntityPairClassification.forward",parameters:[{name:"input_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"attention_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"token_type_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"position_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"entity_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"entity_attention_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"entity_token_type_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"entity_position_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"head_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"labels",val:": typing.Optional[torch.LongTensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/luke/modeling_luke.py#L1396",parametersDescription:[{anchor:"transformers.LukeForEntityPairClassification.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/main/en/model_doc/luke#transformers.LukeTokenizer">LukeTokenizer</a>. See <a href="/docs/transformers/main/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/main/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
model. Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/main/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),Ht=new U({props:{name:"forward",anchor:"transformers.LukeForEntitySpanClassification.forward",parameters:[{name:"input_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"position_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"entity_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"entity_attention_mask",val:": typing.Optional[torch.LongTensor] = None"},{name:"entity_token_type_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"entity_position_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"entity_start_positions",val:": typing.Optional[torch.LongTensor] = None"},{name:"entity_end_positions",val:": typing.Optional[torch.LongTensor] = None"},{name:"head_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"labels",val:": typing.Optional[torch.LongTensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/luke/modeling_luke.py#L1516",parametersDescription:[{anchor:"transformers.LukeForEntitySpanClassification.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/main/en/model_doc/luke#transformers.LukeTokenizer">LukeTokenizer</a>. See <a href="/docs/transformers/main/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/main/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
model according to the specified arguments, defining the model architecture.`),vi=l(),ue=a("p"),Ti=o("Configuration objects inherit from "),un=a("a"),Li=o("PretrainedConfig"),wi=o(` and can be used to control the model outputs. Read the
...
masked entity prediction.`),xr=l(),Lt=a("p"),$r=o("This model inherits from "),vn=a("a"),Fr=o("PreTrainedModel"),qr=o(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),td=l(),N=a("div"),_(Ct.$$.fragment),nd=l(),be=a("p"),od=o("The "),wn=a("a"),sd=o("LukeForEntityClassification"),ad=o(" forward method, overrides the "),$o=a("code"),id=o("__call__"),rd=o(" special method."),dd=l(),_(Ne.$$.fragment),ld=l(),Fo=a("p"),cd=o("Examples:"),pd=l(),_(Pt.$$.fragment),ps=l(),ve=a("h2"),De=a("a"),qo=a("span"),_(jt.$$.fragment),hd=l(),Mo=a("span"),ud=o("LukeForEntityPairClassification"),hs=l(),A=a("div"),_(At.$$.fragment),md=l(),Co=a("p"),fd=o(`The LUKE model with a classification head on top (a linear layer on top of the hidden states of the two entity
...
classification can be found `),Ze=i(qn,"A",{href:!0,rel:!0});var Wl=r(Ze);ti=s(Wl,"here"),Wl.forEach(t),ni=s(qn,"."),qn.forEach(t),oi=c(X),et=i(X,"P",{});var bs=r(et);si=s(bs,`There are also 3 notebooks available, which showcase how you can reproduce the results as reported in the paper with
the HuggingFace implementation of LUKE. They can be found `),tt=i(bs,"A",{href:!0,rel:!0});var Ul=r(tt);ai=s(Ul,"here"),Ul.forEach(t),ii=s(bs,"."),bs.forEach(t),X.forEach(t),Ke.forEach(t),Go=c(n),pn=i(n,"P",{});var Bl=r(pn);ri=s(Bl,"Example:"),Bl.forEach(t),Zo=c(n),k(nt.$$.fragment,n),es=c(n),V=i(n,"P",{});var Re=r(V);di=s(Re,"This model was contributed by "),ot=i(Re,"A",{href:!0,rel:!0});var Kl=r(ot);li=s(Kl,"ikuyamada"),Kl.forEach(t),ci=s(Re," and "),st=i(Re,"A",{href:!0,rel:!0});var Rl=r(st);pi=s(Rl,"nielsr"),Rl.forEach(t),hi=s(Re,". The original code can be found "),at=i(Re,"A",{href:!0,rel:!0});var Hl=r(at);ui=s(Hl,"here"),Hl.forEach(t),mi=s(Re,"."),Re.forEach(t),ts=c(n),he=i(n,"H2",{class:!0});var vs=r(he);Me=i(vs,"A",{id:!0,class:!0,href:!0});var Vl=r(Me);so=i(Vl,"SPAN",{});var Yl=r(so);k(it.$$.fragment,Yl),Yl.forEach(t),Vl.forEach(t),fi=c(vs),ao=i(vs,"SPAN",{});var Ql=r(ao);gi=s(Ql,"LukeConfig"),Ql.forEach(t),vs.forEach(t),ns=c(n),q=i(n,"DIV",{class:!0});var G=r(q);k(rt.$$.fragment,G),_i=c(G),dt=i(G,"P",{});var Ts=r(dt);ki=s(Ts,"This is the configuration class to store the configuration of a "),hn=i(Ts,"A",{href:!0});var Jl=r(hn);yi=s(Jl,"LukeModel"),Jl.forEach(t),bi=s(Ts,`. It is used to instantiate a LUKE
model according to the specified arguments, defining the model architecture.`),Ts.forEach(t),vi=c(G),ue=i(G,"P",{});var Mn=r(ue);Ti=s(Mn,"Configuration objects inherit from "),un=i(Mn,"A",{href:!0});var Xl=r(un);Li=s(Xl,"PretrainedConfig"),Xl.forEach(t),wi=s(Mn,` and can be used to control the model outputs. Read the
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),xs.forEach(t),hr=c(ee),S=i(ee,"DIV",{class:!0});var te=r(S);k(yt.$$.fragment,te),ur=c(te),ge=i(te,"P",{});var Cn=r(ge);mr=s(Cn,"The "),bn=i(Cn,"A",{href:!0});var yc=r(bn);fr=s(yc,"LukeModel"),yc.forEach(t),gr=s(Cn," forward method, overrides the "),yo=i(Cn,"CODE",{});var bc=r(yo);_r=s(bc,"__call__"),bc.forEach(t),kr=s(Cn," special method."),Cn.forEach(t),yr=c(te),k(Ae.$$.fragment,te),br=c(te),bo=i(te,"P",{});var vc=r(bo);vr=s(vc,"Examples:"),vc.forEach(t),Tr=c(te),k(bt.$$.fragment,te),te.forEach(t),ee.forEach(t),rs=c(n),_e=i(n,"H2",{class:!0});var $s=r(_e);Ie=i($s,"A",{id:!0,class:!0,href:!0});var Tc=r(Ie);vo=i(Tc,"SPAN",{});var Lc=r(vo);k(vt.$$.fragment,Lc),Lc.forEach(t),Tc.forEach(t),Lr=c($s),To=i($s,"SPAN",{});var wc=r(To);wr=s(wc,"LukeForMaskedLM"),wc.forEach(t),$s.forEach(t),ds=c(n),P=i(n,"DIV",{class:!0});var ne=r(P);k(Tt.$$.fragment,ne),Er=c(ne),Lo=i(ne,"P",{});var Ec=r(Lo);zr=s(Ec,`The LUKE model with a language modeling head and entity prediction head on top for masked language modeling and
masked entity prediction.`),Ec.forEach(t),xr=c(ne),Lt=i(ne,"P",{});var Fs=r(Lt);$r=s(Fs,"This model inherits from "),vn=i(Fs,"A",{href:!0});var zc=r(vn);Fr=s(zc,"PreTrainedModel"),zc.forEach(t),qr=s(Fs,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),As.forEach(t),bd=c(ae),Ot=i(ae,"P",{});var Is=r(Ot);vd=s(Is,"This model is also a PyTorch "),St=i(Is,"A",{href:!0,rel:!0});var Kc=r(St);Td=s(Kc,"torch.nn.Module"),Kc.forEach(t),Ld=s(Is,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
