import{S as Ci,i as Ai,s as Ii,e as o,k as d,w as v,t as n,M as Li,c as a,d as s,m as p,a as i,x as b,h as r,b as l,N as Ri,G as e,g as u,y as w,q as x,o as k,B as $,v as Oi,L as Mi}from"../../chunks/vendor-hf-doc-builder.js";import{T as qo}from"../../chunks/Tip-hf-doc-builder.js";import{D as U}from"../../chunks/Docstring-hf-doc-builder.js";import{C as zs}from"../../chunks/CodeBlock-hf-doc-builder.js";import{I as qe}from"../../chunks/IconCopyLink-hf-doc-builder.js";import{E as Fi}from"../../chunks/ExampleCodeBlock-hf-doc-builder.js";function Ni(C){let m,j,f,g,D;return g=new zs({props:{code:`from transformers import DonutSwinConfig, DonutSwinModel
...
PIL images.`),g.forEach(s)},m(f,g){u(f,m,g),e(m,j)},d(f){f&&s(m)}}}function Ui(C){let m,j,f,g,D,h,_,q;return{c(){m=o("p"),j=n(`This class method is simply calling the feature extractor
...
methods above for more information.`),this.h()},l(F){m=a(F,"P",{});var y=i(m);j=r(y,`This class method is simply calling the feature extractor
...
methods above for more information.`),y.forEach(s),this.h()},h(){l(f,"href","/docs/transformers/main/en/main_classes/feature_extractor#transformers.FeatureExtractionMixin.from_pretrained")},m(F,y){u(F,m,y),e(m,j),e(m,f),e(f,g),e(m,D),e(m,h),e(h,_),e(m,q)},d(F){F&&s(m)}}}function Wi(C){let m,j,f,g,D,h,_,q;return{c(){m=o("p"),j=n("This class method is simply calling "),f=o("a"),g=n("save_pretrained()"),D=n(` and
`),h=o("code"),_=n("save_pretrained"),q=n(`. Please refer to the docstrings of the methods
above for more information.`),this.h()},l(F){m=a(F,"P",{});var y=i(m);j=r(y,"This class method is simply calling "),f=a(y,"A",{href:!0});var M=i(f);g=r(M,"save_pretrained()"),M.forEach(s),D=r(y,` and
`),h=a(y,"CODE",{});var A=i(h);_=r(A,"save_pretrained"),A.forEach(s),q=r(y,`. Please refer to the docstrings of the methods
above for more information.`),y.forEach(s),this.h()},h(){l(f,"href","/docs/transformers/main/en/main_classes/feature_extractor#transformers.FeatureExtractionMixin.save_pretrained")},m(F,y){u(F,m,y),e(m,j),e(m,f),e(f,g),e(m,D),e(m,h),e(h,_),e(m,q)},d(F){F&&s(m)}}}function Hi(C){let m,j,f,g,D;return{c(){m=o("p"),j=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=o("code"),g=n("Module"),D=n(`
...
[<span class="hljs-number">1</span>, <span class="hljs-number">49</span>, <span class="hljs-number">768</span>]`}}),{c(){m=o("p"),j=n("Example:"),f=d(),v(g.$$.fragment)},l(h){m=a(h,"P",{});var _=i(m);j=r(_,"Example:"),_.forEach(s),f=p(h),b(g.$$.fragment,h)},m(h,_){u(h,m,_),e(m,j),u(h,f,_),w(g,h,_),D=!0},p:Mi,i(h){D||(x(g.$$.fragment,h),D=!0)},o(h){k(g.$$.fragment,h),D=!1},d(h){h&&s(m),h&&s(f),$(g,h)}}}function Bi(C){let m,j,f,g,D,h,_,q,F,y,M,A,Bt,Pe,Po,Jt,zo,Ss,ae,So,ze,Fo,Mo,Fs,ft,Co,Ms,gt,Gt,Ao,Cs,ne,fr,As,re,Io,_t,Lo,Ro,Is,W,Oo,Se,No,Vo,Fe,Uo,Wo,Ls,vt,Ho,Rs,ie,Me,Xo,Ce,Bo,Jo,Go,Ae,Yo,bt,Qo,Ko,Os,G,le,Yt,Ie,Zo,Qt,ea,Ns,H,ta,Kt,sa,oa,wt,aa,na,Vs,T,ra,xt,ia,la,Zt,ca,da,es,pa,ua,kt,ma,ha,$t,fa,ga,ts,_a,va,ss,ba,wa,Us,jt,os,xa,Ws,Le,Hs,Dt,as,ka,Xs,Re,Bs,yt,ns,$a,Js,Oe,Gs,ce,ja,Ne,Da,ya,Ys,Y,de,rs,Ve,Ea,is,Ta,Qs,pe,qa,Ue,Pa,za,Ks,Q,ue,ls,We,Sa,cs,Fa,Zs,I,He,Ma,K,Ca,Et,Aa,Ia,Xe,La,Ra,Oa,Z,Na,Tt,Va,Ua,qt,Wa,Ha,Xa,me,eo,ee,he,ds,Be,Ba,ps,Ja,to,L,Je,Ga,us,Ya,Qa,Ge,Ka,Pt,Za,en,tn,X,Ye,sn,ms,on,an,fe,so,te,ge,hs,Qe,nn,fs,rn,oo,E,Ke,ln,gs,cn,dn,P,zt,pn,un,St,mn,hn,_s,fn,gn,vs,_n,vn,Ze,bs,bn,wn,xn,Ft,kn,$n,jn,_e,et,Dn,N,yn,ws,En,Tn,xs,qn,Pn,ks,zn,Sn,Fn,B,tt,Mn,$s,Cn,An,ve,In,J,st,Ln,ot,Rn,Mt,On,Nn,Vn,be,Un,we,at,Wn,nt,Hn,Ct,Xn,Bn,Jn,xe,rt,Gn,it,Yn,At,Qn,Kn,ao,se,ke,js,lt,Zn,Ds,er,no,V,ct,tr,dt,sr,pt,or,ar,nr,O,ut,rr,oe,ir,It,lr,cr,ys,dr,pr,ur,$e,mr,je,ro;return h=new qe({}),Pe=new qe({}),Ie=new qe({}),Le=new zs({props:{code:`import re
...
`}}),$e=new qo({props:{$$slots:{default:[Hi]},$$scope:{ctx:C}}}),je=new Fi({props:{anchor:"transformers.DonutSwinModel.forward.example",$$slots:{default:[Xi]},$$scope:{ctx:C}}}),{c(){m=o("meta"),j=d(),f=o("h1"),g=o("a"),D=o("span"),v(h.$$.fragment),_=d(),q=o("span"),F=n("Donut"),y=d(),M=o("h2"),A=o("a"),Bt=o("span"),v(Pe.$$.fragment),Po=d(),Jt=o("span"),zo=n("Overview"),Ss=d(),ae=o("p"),So=n("The Donut model was proposed in "),ze=o("a"),Fo=n("OCR-free Document Understanding Transformer"),Mo=n(` by
...
`),Ft=o("a"),kn=n("decode()"),$n=n(" for more information."),jn=d(),_e=o("div"),v(et.$$.fragment),Dn=d(),N=o("p"),yn=n(`When used in normal mode, this method forwards all its arguments to AutoFeatureExtractor\u2019s
...
`),ks=o("code"),zn=n("__call__"),Sn=n(". Please refer to the doctsring of the above two methods for more information."),Fn=d(),B=o("div"),v(tt.$$.fragment),Mn=d(),$s=o("p"),Cn=n("Instantiate a processor associated with a pretrained model."),An=d(),v(ve.$$.fragment),In=d(),J=o("div"),v(st.$$.fragment),Ln=d(),ot=o("p"),Rn=n(`Saves the attributes of this processor (feature extractor, tokenizer\u2026) in the specified directory so that it
can be reloaded using the `),Mt=o("a"),On=n("from_pretrained()"),Nn=n(" method."),Vn=d(),v(be.$$.fragment),Un=d(),we=o("div"),v(at.$$.fragment),Wn=d(),nt=o("p"),Hn=n("This method forwards all its arguments to DonutTokenizer\u2019s "),Ct=o("a"),Xn=n("batch_decode()"),Bn=n(`. Please refer
...
`),wt=a(Rt,"A",{href:!0});var Sr=i(wt);aa=r(Sr,"generate()"),Sr.forEach(s),na=r(Rt," to autoregressively generate text given the input image."),Rt.forEach(s),Vs=p(t),T=a(t,"P",{});var z=i(T);ra=r(z,"The "),xt=a(z,"A",{href:!0});var Fr=i(xt);ia=r(Fr,"DonutFeatureExtractor"),Fr.forEach(s),la=r(z,` class is responsible for preprocessing the input image and
[`),Zt=a(z,"CODE",{});var Mr=i(Zt);ca=r(Mr,"XLMRobertaTokenizer"),Mr.forEach(s),da=r(z,"/"),es=a(z,"CODE",{});var Cr=i(es);pa=r(Cr,"XLMRobertaTokenizerFast"),Cr.forEach(s),ua=r(z,`] decodes the generated target tokens to the target string. The
...
`),Ft=a(R,"A",{href:!0});var bi=i(Ft);kn=r(bi,"decode()"),bi.forEach(s),$n=r(R," for more information."),R.forEach(s),jn=p(S),_e=a(S,"DIV",{class:!0});var xo=i(_e);b(et.$$.fragment,xo),Dn=p(xo),N=a(xo,"P",{});var Ee=i(N);yn=r(Ee,`When used in normal mode, this method forwards all its arguments to AutoFeatureExtractor\u2019s
...
`),ks=a(Ee,"CODE",{});var ki=i(ks);zn=r(ki,"__call__"),ki.forEach(s),Sn=r(Ee,". Please refer to the doctsring of the above two methods for more information."),Ee.forEach(s),xo.forEach(s),Fn=p(S),B=a(S,"DIV",{class:!0});var Ut=i(B);b(tt.$$.fragment,Ut),Mn=p(Ut),$s=a(Ut,"P",{});var $i=i($s);Cn=r($i,"Instantiate a processor associated with a pretrained model."),$i.forEach(s),An=p(Ut),b(ve.$$.fragment,Ut),Ut.forEach(s),In=p(S),J=a(S,"DIV",{class:!0});var Wt=i(J);b(st.$$.fragment,Wt),Ln=p(Wt),ot=a(Wt,"P",{});var ko=i(ot);Rn=r(ko,`Saves the attributes of this processor (feature extractor, tokenizer\u2026) in the specified directory so that it
can be reloaded using the `),Mt=a(ko,"A",{href:!0});var ji=i(Mt);On=r(ji,"from_pretrained()"),ji.forEach(s),Nn=r(ko," method."),ko.forEach(s),Vn=p(Wt),b(be.$$.fragment,Wt),Wt.forEach(s),Un=p(S),we=a(S,"DIV",{class:!0});var $o=i(we);b(at.$$.fragment,$o),Wn=p($o),nt=a($o,"P",{});var jo=i(nt);Hn=r(jo,"This method forwards all its arguments to DonutTokenizer\u2019s "),Ct=a(jo,"A",{href:!0});var Di=i(Ct);Xn=r(Di,"batch_decode()"),Di.forEach(s),Bn=r(jo,`. Please refer
