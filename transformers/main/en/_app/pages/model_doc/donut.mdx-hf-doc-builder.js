...
`),Ft=o("a"),xn=n("decode()"),$n=n(" for more information."),jn=d(),_e=o("div"),v(et.$$.fragment),Dn=d(),N=o("p"),yn=n(`When used in normal mode, this method forwards all its arguments to AutoFeatureExtractor\u2019s
...
`),xs=o("code"),zn=n("~DonutTokenizer.__call__"),Sn=n(". Please refer to the doctsring of the above two methods for more information."),Fn=d(),B=o("div"),v(tt.$$.fragment),Mn=d(),$s=o("p"),Cn=n("Instantiate a processor associated with a pretrained model."),An=d(),v(ve.$$.fragment),In=d(),J=o("div"),v(st.$$.fragment),Ln=d(),ot=o("p"),Rn=n(`Saves the attributes of this processor (feature extractor, tokenizer\u2026) in the specified directory so that it
