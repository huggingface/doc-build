...
[<span class="hljs-number">1</span>, <span class="hljs-number">49</span>, <span class="hljs-number">768</span>]`}}),{c(){m=o("p"),j=n("Example:"),f=d(),v(g.$$.fragment)},l(h){m=a(h,"P",{});var _=i(m);j=r(_,"Example:"),_.forEach(s),f=p(h),b(g.$$.fragment,h)},m(h,_){u(h,m,_),e(m,j),u(h,f,_),w(g,h,_),D=!0},p:Fi,i(h){D||(k(g.$$.fragment,h),D=!0)},o(h){x(g.$$.fragment,h),D=!1},d(h){h&&s(m),h&&s(f),$(g,h)}}}function Bi(A){let m,j,f,g,D,h,_,q,M,y,F,C,Bt,Pe,Po,Jt,zo,Ss,ae,So,ze,Mo,Fo,Ms,ft,Ao,Fs,gt,Gt,Co,As,ne,fr,Cs,re,Io,_t,Lo,Ro,Is,W,Oo,Se,No,Vo,Me,Uo,Wo,Ls,vt,Ho,Rs,ie,Fe,Xo,Ae,Bo,Jo,Go,Ce,Yo,bt,Qo,Ko,Os,G,le,Yt,Ie,Zo,Qt,ea,Ns,H,ta,Kt,sa,oa,wt,aa,na,Vs,T,ra,kt,ia,la,Zt,ca,da,es,pa,ua,xt,ma,ha,$t,fa,ga,ts,_a,va,ss,ba,wa,Us,jt,os,ka,Ws,Le,Hs,Dt,as,xa,Xs,Re,Bs,yt,ns,$a,Js,Oe,Gs,ce,ja,Ne,Da,ya,Ys,Y,de,rs,Ve,Ea,is,Ta,Qs,pe,qa,Ue,Pa,za,Ks,Q,ue,ls,We,Sa,cs,Ma,Zs,I,He,Fa,K,Aa,Et,Ca,Ia,Xe,La,Ra,Oa,Z,Na,Tt,Va,Ua,qt,Wa,Ha,Xa,me,eo,ee,he,ds,Be,Ba,ps,Ja,to,L,Je,Ga,us,Ya,Qa,Ge,Ka,Pt,Za,en,tn,X,Ye,sn,ms,on,an,fe,so,te,ge,hs,Qe,nn,fs,rn,oo,E,Ke,ln,gs,cn,dn,P,zt,pn,un,St,mn,hn,_s,fn,gn,vs,_n,vn,Ze,bs,bn,wn,kn,Mt,xn,$n,jn,_e,et,Dn,N,yn,ws,En,Tn,ks,qn,Pn,xs,zn,Sn,Mn,B,tt,Fn,$s,An,Cn,ve,In,J,st,Ln,ot,Rn,Ft,On,Nn,Vn,be,Un,we,at,Wn,nt,Hn,At,Xn,Bn,Jn,ke,rt,Gn,it,Yn,Ct,Qn,Kn,ao,se,xe,js,lt,Zn,Ds,er,no,V,ct,tr,dt,sr,pt,or,ar,nr,O,ut,rr,oe,ir,It,lr,cr,ys,dr,pr,ur,$e,mr,je,ro;return h=new qe({}),Pe=new qe({}),Ie=new qe({}),Le=new zs({props:{code:`import re
...
Whether or not to return a <a href="/docs/transformers/main/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/donut/modeling_donut_swin.py#L877",returnDescription:`
...
`}}),$e=new qo({props:{$$slots:{default:[Hi]},$$scope:{ctx:A}}}),je=new Mi({props:{anchor:"transformers.DonutSwinModel.forward.example",$$slots:{default:[Xi]},$$scope:{ctx:A}}}),{c(){m=o("meta"),j=d(),f=o("h1"),g=o("a"),D=o("span"),v(h.$$.fragment),_=d(),q=o("span"),M=n("Donut"),y=d(),F=o("h2"),C=o("a"),Bt=o("span"),v(Pe.$$.fragment),Po=d(),Jt=o("span"),zo=n("Overview"),Ss=d(),ae=o("p"),So=n("The Donut model was proposed in "),ze=o("a"),Mo=n("OCR-free Document Understanding Transformer"),Fo=n(` by
...
`),Mt=o("a"),xn=n("decode()"),$n=n(" for more information."),jn=d(),_e=o("div"),v(et.$$.fragment),Dn=d(),N=o("p"),yn=n(`When used in normal mode, this method forwards all its arguments to AutoFeatureExtractor\u2019s
...
`),xs=o("code"),zn=n("~DonutTokenizer.__call__"),Sn=n(". Please refer to the doctsring of the above two methods for more information."),Mn=d(),B=o("div"),v(tt.$$.fragment),Fn=d(),$s=o("p"),An=n("Instantiate a processor associated with a pretrained model."),Cn=d(),v(ve.$$.fragment),In=d(),J=o("div"),v(st.$$.fragment),Ln=d(),ot=o("p"),Rn=n(`Saves the attributes of this processor (feature extractor, tokenizer\u2026) in the specified directory so that it
can be reloaded using the `),Ft=o("a"),On=n("from_pretrained()"),Nn=n(" method."),Vn=d(),v(be.$$.fragment),Un=d(),we=o("div"),v(at.$$.fragment),Wn=d(),nt=o("p"),Hn=n("This method forwards all its arguments to DonutTokenizer\u2019s "),At=o("a"),Xn=n("batch_decode()"),Bn=n(`. Please refer
...
[`),Zt=a(z,"CODE",{});var Fr=i(Zt);ca=r(Fr,"XLMRobertaTokenizer"),Fr.forEach(s),da=r(z,"/"),es=a(z,"CODE",{});var Ar=i(es);pa=r(Ar,"XLMRobertaTokenizerFast"),Ar.forEach(s),ua=r(z,`] decodes the generated target tokens to the target string. The
