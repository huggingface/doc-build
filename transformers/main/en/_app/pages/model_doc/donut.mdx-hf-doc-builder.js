import{S as Ai,i as Ci,s as Ii,e as o,k as d,w as v,t as n,M as Li,c as a,d as s,m as p,a as i,x as b,h as r,b as l,N as Ri,G as e,g as u,y as w,q as k,o as x,B as $,v as Oi,L as Mi}from"../../chunks/vendor-hf-doc-builder.js";import{T as qo}from"../../chunks/Tip-hf-doc-builder.js";import{D as U}from"../../chunks/Docstring-hf-doc-builder.js";import{C as zs}from"../../chunks/CodeBlock-hf-doc-builder.js";import{I as qe}from"../../chunks/IconCopyLink-hf-doc-builder.js";import{E as Fi}from"../../chunks/ExampleCodeBlock-hf-doc-builder.js";function Ni(A){let m,j,f,g,D;return g=new zs({props:{code:`from transformers import DonutSwinConfig, DonutSwinModel
...
methods above for more information.`),y.forEach(s),this.h()},h(){l(f,"href","/docs/transformers/main/en/main_classes/feature_extractor#transformers.FeatureExtractionMixin.from_pretrained")},m(F,y){u(F,m,y),e(m,j),e(m,f),e(f,g),e(m,D),e(m,h),e(h,_),e(m,q)},d(F){F&&s(m)}}}function Wi(A){let m,j,f,g,D,h,_,q;return{c(){m=o("p"),j=n("This class method is simply calling "),f=o("a"),g=n("save_pretrained()"),D=n(` and
...
[<span class="hljs-number">1</span>, <span class="hljs-number">49</span>, <span class="hljs-number">768</span>]`}}),{c(){m=o("p"),j=n("Example:"),f=d(),v(g.$$.fragment)},l(h){m=a(h,"P",{});var _=i(m);j=r(_,"Example:"),_.forEach(s),f=p(h),b(g.$$.fragment,h)},m(h,_){u(h,m,_),e(m,j),u(h,f,_),w(g,h,_),D=!0},p:Mi,i(h){D||(k(g.$$.fragment,h),D=!0)},o(h){x(g.$$.fragment,h),D=!1},d(h){h&&s(m),h&&s(f),$(g,h)}}}function Bi(A){let m,j,f,g,D,h,_,q,F,y,M,C,Bt,Pe,Po,Jt,zo,Ss,ae,So,ze,Fo,Mo,Fs,ft,Ao,Ms,gt,Gt,Co,As,ne,fr,Cs,re,Io,_t,Lo,Ro,Is,W,Oo,Se,No,Vo,Fe,Uo,Wo,Ls,vt,Ho,Rs,ie,Me,Xo,Ae,Bo,Jo,Go,Ce,Yo,bt,Qo,Ko,Os,G,le,Yt,Ie,Zo,Qt,ea,Ns,H,ta,Kt,sa,oa,wt,aa,na,Vs,T,ra,kt,ia,la,Zt,ca,da,es,pa,ua,xt,ma,ha,$t,fa,ga,ts,_a,va,ss,ba,wa,Us,jt,os,ka,Ws,Le,Hs,Dt,as,xa,Xs,Re,Bs,yt,ns,$a,Js,Oe,Gs,ce,ja,Ne,Da,ya,Ys,Y,de,rs,Ve,Ea,is,Ta,Qs,pe,qa,Ue,Pa,za,Ks,Q,ue,ls,We,Sa,cs,Fa,Zs,I,He,Ma,K,Aa,Et,Ca,Ia,Xe,La,Ra,Oa,Z,Na,Tt,Va,Ua,qt,Wa,Ha,Xa,me,eo,ee,he,ds,Be,Ba,ps,Ja,to,L,Je,Ga,us,Ya,Qa,Ge,Ka,Pt,Za,en,tn,X,Ye,sn,ms,on,an,fe,so,te,ge,hs,Qe,nn,fs,rn,oo,E,Ke,ln,gs,cn,dn,P,zt,pn,un,St,mn,hn,_s,fn,gn,vs,_n,vn,Ze,bs,bn,wn,kn,Ft,xn,$n,jn,_e,et,Dn,N,yn,ws,En,Tn,ks,qn,Pn,xs,zn,Sn,Fn,B,tt,Mn,$s,An,Cn,ve,In,J,st,Ln,ot,Rn,Mt,On,Nn,Vn,be,Un,we,at,Wn,nt,Hn,At,Xn,Bn,Jn,ke,rt,Gn,it,Yn,Ct,Qn,Kn,ao,se,xe,js,lt,Zn,Ds,er,no,V,ct,tr,dt,sr,pt,or,ar,nr,O,ut,rr,oe,ir,It,lr,cr,ys,dr,pr,ur,$e,mr,je,ro;return h=new qe({}),Pe=new qe({}),Ie=new qe({}),Le=new zs({props:{code:`import re
...
`}}),$e=new qo({props:{$$slots:{default:[Hi]},$$scope:{ctx:A}}}),je=new Fi({props:{anchor:"transformers.DonutSwinModel.forward.example",$$slots:{default:[Xi]},$$scope:{ctx:A}}}),{c(){m=o("meta"),j=d(),f=o("h1"),g=o("a"),D=o("span"),v(h.$$.fragment),_=d(),q=o("span"),F=n("Donut"),y=d(),M=o("h2"),C=o("a"),Bt=o("span"),v(Pe.$$.fragment),Po=d(),Jt=o("span"),zo=n("Overview"),Ss=d(),ae=o("p"),So=n("The Donut model was proposed in "),ze=o("a"),Fo=n("OCR-free Document Understanding Transformer"),Mo=n(` by
...
`),xs=o("code"),zn=n("~DonutTokenizer.__call__"),Sn=n(". Please refer to the doctsring of the above two methods for more information."),Fn=d(),B=o("div"),v(tt.$$.fragment),Mn=d(),$s=o("p"),An=n("Instantiate a processor associated with a pretrained model."),Cn=d(),v(ve.$$.fragment),In=d(),J=o("div"),v(st.$$.fragment),Ln=d(),ot=o("p"),Rn=n(`Saves the attributes of this processor (feature extractor, tokenizer\u2026) in the specified directory so that it
can be reloaded using the `),Mt=o("a"),On=n("from_pretrained()"),Nn=n(" method."),Vn=d(),v(be.$$.fragment),Un=d(),we=o("div"),v(at.$$.fragment),Wn=d(),nt=o("p"),Hn=n("This method forwards all its arguments to DonutTokenizer\u2019s "),At=o("a"),Xn=n("batch_decode()"),Bn=n(`. Please refer
to the docstring of this method for more information.`),Jn=d(),ke=o("div"),v(rt.$$.fragment),Gn=d(),it=o("p"),Yn=n("This method forwards all its arguments to DonutTokenizer\u2019s "),Ct=o("a"),Qn=n("decode()"),Kn=n(`. Please refer to the
...
[`),Zt=a(z,"CODE",{});var Mr=i(Zt);ca=r(Mr,"XLMRobertaTokenizer"),Mr.forEach(s),da=r(z,"/"),es=a(z,"CODE",{});var Ar=i(es);pa=r(Ar,"XLMRobertaTokenizerFast"),Ar.forEach(s),ua=r(z,`] decodes the generated target tokens to the target string. The
...
`),xs=a(Ee,"CODE",{});var xi=i(xs);zn=r(xi,"~DonutTokenizer.__call__"),xi.forEach(s),Sn=r(Ee,". Please refer to the doctsring of the above two methods for more information."),Ee.forEach(s),ko.forEach(s),Fn=p(S),B=a(S,"DIV",{class:!0});var Ut=i(B);b(tt.$$.fragment,Ut),Mn=p(Ut),$s=a(Ut,"P",{});var $i=i($s);An=r($i,"Instantiate a processor associated with a pretrained model."),$i.forEach(s),Cn=p(Ut),b(ve.$$.fragment,Ut),Ut.forEach(s),In=p(S),J=a(S,"DIV",{class:!0});var Wt=i(J);b(st.$$.fragment,Wt),Ln=p(Wt),ot=a(Wt,"P",{});var xo=i(ot);Rn=r(xo,`Saves the attributes of this processor (feature extractor, tokenizer\u2026) in the specified directory so that it
