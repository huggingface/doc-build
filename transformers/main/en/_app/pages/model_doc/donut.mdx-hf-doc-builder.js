...
methods above for more information.`),this.h()},l(F){m=a(F,"P",{});var y=i(m);j=r(y,"This class method is simply calling "),f=a(y,"A",{href:!0});var M=i(f);g=r(M,"save_pretrained()"),M.forEach(s),D=r(y,` and
`),h=a(y,"A",{href:!0});var A=i(h);_=r(A,"save_pretrained()"),A.forEach(s),q=r(y,`. Please refer to the docstrings of the
methods above for more information.`),y.forEach(s),this.h()},h(){l(f,"href","/docs/transformers/main/en/internal/image_processing_utils#transformers.FeatureExtractionMixin.save_pretrained"),l(h,"href","/docs/transformers/main/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.save_pretrained")},m(F,y){u(F,m,y),e(m,j),e(m,f),e(f,g),e(m,D),e(m,h),e(h,_),e(m,q)},d(F){F&&s(m)}}}function Hi(C){let m,j,f,g,D;return{c(){m=o("p"),j=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=o("code"),g=n("Module"),D=n(`
...
[<span class="hljs-number">1</span>, <span class="hljs-number">49</span>, <span class="hljs-number">768</span>]`}}),{c(){m=o("p"),j=n("Example:"),f=c(),v(g.$$.fragment)},l(h){m=a(h,"P",{});var _=i(m);j=r(_,"Example:"),_.forEach(s),f=p(h),b(g.$$.fragment,h)},m(h,_){u(h,m,_),e(m,j),u(h,f,_),w(g,h,_),D=!0},p:Mi,i(h){D||(k(g.$$.fragment,h),D=!0)},o(h){x(g.$$.fragment,h),D=!1},d(h){h&&s(m),h&&s(f),$(g,h)}}}function Bi(C){let m,j,f,g,D,h,_,q,F,y,M,A,Bt,Pe,Po,Jt,zo,Ss,ae,So,ze,Fo,Mo,Fs,ft,Co,Ms,gt,Gt,Ao,Cs,ne,fr,As,re,Io,_t,Lo,Ro,Is,W,Oo,Se,No,Vo,Fe,Uo,Wo,Ls,vt,Ho,Rs,ie,Me,Xo,Ce,Bo,Jo,Go,Ae,Yo,bt,Qo,Ko,Os,G,le,Yt,Ie,Zo,Qt,ea,Ns,H,ta,Kt,sa,oa,wt,aa,na,Vs,T,ra,kt,ia,la,Zt,da,ca,es,pa,ua,xt,ma,ha,$t,fa,ga,ts,_a,va,ss,ba,wa,Us,jt,os,ka,Ws,Le,Hs,Dt,as,xa,Xs,Re,Bs,yt,ns,$a,Js,Oe,Gs,de,ja,Ne,Da,ya,Ys,Y,ce,rs,Ve,Ea,is,Ta,Qs,pe,qa,Ue,Pa,za,Ks,Q,ue,ls,We,Sa,ds,Fa,Zs,I,He,Ma,K,Ca,Et,Aa,Ia,Xe,La,Ra,Oa,Z,Na,Tt,Va,Ua,qt,Wa,Ha,Xa,me,eo,ee,he,cs,Be,Ba,ps,Ja,to,L,Je,Ga,us,Ya,Qa,Ge,Ka,Pt,Za,en,tn,X,Ye,sn,ms,on,an,fe,so,te,ge,hs,Qe,nn,fs,rn,oo,E,Ke,ln,gs,dn,cn,P,zt,pn,un,St,mn,hn,_s,fn,gn,vs,_n,vn,Ze,bs,bn,wn,kn,Ft,xn,$n,jn,_e,et,Dn,N,yn,ws,En,Tn,ks,qn,Pn,xs,zn,Sn,Fn,B,tt,Mn,$s,Cn,An,ve,In,J,st,Ln,ot,Rn,Mt,On,Nn,Vn,be,Un,we,at,Wn,nt,Hn,Ct,Xn,Bn,Jn,ke,rt,Gn,it,Yn,At,Qn,Kn,ao,se,xe,js,lt,Zn,Ds,er,no,V,dt,tr,ct,sr,pt,or,ar,nr,O,ut,rr,oe,ir,It,lr,dr,ys,cr,pr,ur,$e,mr,je,ro;return h=new qe({}),Pe=new qe({}),Ie=new qe({}),Le=new zs({props:{code:`import re
...
`}}),$e=new qo({props:{$$slots:{default:[Hi]},$$scope:{ctx:C}}}),je=new Fi({props:{anchor:"transformers.DonutSwinModel.forward.example",$$slots:{default:[Xi]},$$scope:{ctx:C}}}),{c(){m=o("meta"),j=c(),f=o("h1"),g=o("a"),D=o("span"),v(h.$$.fragment),_=c(),q=o("span"),F=n("Donut"),y=c(),M=o("h2"),A=o("a"),Bt=o("span"),v(Pe.$$.fragment),Po=c(),Jt=o("span"),zo=n("Overview"),Ss=c(),ae=o("p"),So=n("The Donut model was proposed in "),ze=o("a"),Fo=n("OCR-free Document Understanding Transformer"),Mo=n(` by
...
`),Ft=o("a"),xn=n("decode()"),$n=n(" for more information."),jn=c(),_e=o("div"),v(et.$$.fragment),Dn=c(),N=o("p"),yn=n(`When used in normal mode, this method forwards all its arguments to AutoFeatureExtractor\u2019s
...
`),xs=o("code"),zn=n("~DonutTokenizer.__call__"),Sn=n(". Please refer to the doctsring of the above two methods for more information."),Fn=c(),B=o("div"),v(tt.$$.fragment),Mn=c(),$s=o("p"),Cn=n("Instantiate a processor associated with a pretrained model."),An=c(),v(ve.$$.fragment),In=c(),J=o("div"),v(st.$$.fragment),Ln=c(),ot=o("p"),Rn=n(`Saves the attributes of this processor (feature extractor, tokenizer\u2026) in the specified directory so that it
can be reloaded using the `),Mt=o("a"),On=n("from_pretrained()"),Nn=n(" method."),Vn=c(),v(be.$$.fragment),Un=c(),we=o("div"),v(at.$$.fragment),Wn=c(),nt=o("p"),Hn=n("This method forwards all its arguments to DonutTokenizer\u2019s "),Ct=o("a"),Xn=n("batch_decode()"),Bn=n(`. Please refer
to the docstring of this method for more information.`),Jn=c(),ke=o("div"),v(rt.$$.fragment),Gn=c(),it=o("p"),Yn=n("This method forwards all its arguments to DonutTokenizer\u2019s "),At=o("a"),Qn=n("decode()"),Kn=n(`. Please refer to the
...
Geewook Kim, Teakgyu Hong, Moonbin Yim, Jeongyeon Nam, Jinyoung Park, Jinyeong Yim, Wonseok Hwang, Sangdoo Yun, Dongyoon Han, Seunghyun Park.
Donut consists of an image Transformer encoder and an autoregressive text Transformer decoder to perform document understanding
tasks such as document image classification, form understanding and visual question answering.`),io.forEach(s),Fs=p(t),ft=a(t,"P",{});var br=i(ft);Co=r(br,"The abstract from the paper is the following:"),br.forEach(s),Ms=p(t),gt=a(t,"P",{});var wr=i(gt);Gt=a(wr,"EM",{});var kr=i(Gt);Ao=r(kr,"Understanding document images (e.g., invoices) is a core but challenging task since it requires complex functions such as reading text and a holistic understanding of the document. Current Visual Document Understanding (VDU) methods outsource the task of reading text to off-the-shelf Optical Character Recognition (OCR) engines and focus on the understanding task with the OCR outputs. Although such OCR-based approaches have shown promising performance, they suffer from 1) high computational costs for using OCR; 2) inflexibility of OCR models on languages or types of document; 3) OCR error propagation to the subsequent process. To address these issues, in this paper, we introduce a novel OCR-free VDU model named Donut, which stands for Document understanding transformer. As the first step in OCR-free VDU research, we propose a simple architecture (i.e., Transformer) with a pre-training objective (i.e., cross-entropy loss). Donut is conceptually simple yet effective. Through extensive experiments and analyses, we show a simple OCR-free VDU model, Donut, achieves state-of-the-art performances on various VDU tasks in terms of both speed and accuracy. In addition, we offer a synthetic data generator that helps the model pre-training to be flexible in various languages and domains."),kr.forEach(s),wr.forEach(s),Cs=p(t),ne=a(t,"IMG",{src:!0,alt:!0,width:!0}),As=p(t),re=a(t,"SMALL",{});var lo=i(re);Io=r(lo,"Donut high-level overview. Taken from the "),_t=a(lo,"A",{href:!0});var xr=i(_t);Lo=r(xr,"original paper"),xr.forEach(s),Ro=r(lo,"."),lo.forEach(s),Is=p(t),W=a(t,"P",{});var Lt=i(W);Oo=r(Lt,"This model was contributed by "),Se=a(Lt,"A",{href:!0,rel:!0});var $r=i(Se);No=r($r,"nielsr"),$r.forEach(s),Vo=r(Lt,`. The original code can be found
...
`),wt=a(Rt,"A",{href:!0});var Sr=i(wt);aa=r(Sr,"generate()"),Sr.forEach(s),na=r(Rt," to autoregressively generate text given the input image."),Rt.forEach(s),Vs=p(t),T=a(t,"P",{});var z=i(T);ra=r(z,"The "),kt=a(z,"A",{href:!0});var Fr=i(kt);ia=r(Fr,"DonutFeatureExtractor"),Fr.forEach(s),la=r(z,` class is responsible for preprocessing the input image and
[`),Zt=a(z,"CODE",{});var Mr=i(Zt);da=r(Mr,"XLMRobertaTokenizer"),Mr.forEach(s),ca=r(z,"/"),es=a(z,"CODE",{});var Cr=i(es);pa=r(Cr,"XLMRobertaTokenizerFast"),Cr.forEach(s),ua=r(z,`] decodes the generated target tokens to the target string. The
...
`),Ft=a(R,"A",{href:!0});var bi=i(Ft);xn=r(bi,"decode()"),bi.forEach(s),$n=r(R," for more information."),R.forEach(s),jn=p(S),_e=a(S,"DIV",{class:!0});var ko=i(_e);b(et.$$.fragment,ko),Dn=p(ko),N=a(ko,"P",{});var Ee=i(N);yn=r(Ee,`When used in normal mode, this method forwards all its arguments to AutoFeatureExtractor\u2019s
...
`),xs=a(Ee,"CODE",{});var xi=i(xs);zn=r(xi,"~DonutTokenizer.__call__"),xi.forEach(s),Sn=r(Ee,". Please refer to the doctsring of the above two methods for more information."),Ee.forEach(s),ko.forEach(s),Fn=p(S),B=a(S,"DIV",{class:!0});var Ut=i(B);b(tt.$$.fragment,Ut),Mn=p(Ut),$s=a(Ut,"P",{});var $i=i($s);Cn=r($i,"Instantiate a processor associated with a pretrained model."),$i.forEach(s),An=p(Ut),b(ve.$$.fragment,Ut),Ut.forEach(s),In=p(S),J=a(S,"DIV",{class:!0});var Wt=i(J);b(st.$$.fragment,Wt),Ln=p(Wt),ot=a(Wt,"P",{});var xo=i(ot);Rn=r(xo,`Saves the attributes of this processor (feature extractor, tokenizer\u2026) in the specified directory so that it
