...
<span class="hljs-meta">&gt;&gt;&gt; </span>configuration = model.config`}}),{c(){p=n("p"),k=a("Examples:"),f=c(),v(u.$$.fragment)},l(d){p=r(d,"P",{});var m=s(p);k=i(m,"Examples:"),m.forEach(t),f=h(d),y(u.$$.fragment,d)},m(d,m){_(d,p,m),e(p,k),_(d,f,m),T(u,d,m),b=!0},p:Dt,i(d){b||(E(u.$$.fragment,d),b=!0)},o(d){w(u.$$.fragment,d),b=!1},d(d){d&&t(p),d&&t(f),$(u,d)}}}function Vu(z){let p,k,f,u,b;return{c(){p=n("p"),k=a("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=n("code"),u=a("Module"),b=a(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(d){p=r(d,"P",{});var m=s(p);k=i(m,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=r(m,"CODE",{});var M=s(f);u=i(M,"Module"),M.forEach(t),b=i(m,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),m.forEach(t)},m(d,m){_(d,p,m),e(p,k),e(p,f),e(f,u),e(p,b)},d(d){d&&t(p)}}}function Qu(z){let p,k,f,u,b;return u=new Xe({props:{code:`from transformers import BertTokenizer, ErnieModel
import torch
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),{c(){p=n("p"),k=a("Example:"),f=c(),v(u.$$.fragment)},l(d){p=r(d,"P",{});var m=s(p);k=i(m,"Example:"),m.forEach(t),f=h(d),y(u.$$.fragment,d)},m(d,m){_(d,p,m),e(p,k),_(d,f,m),T(u,d,m),b=!0},p:Dt,i(d){b||(E(u.$$.fragment,d),b=!0)},o(d){w(u.$$.fragment,d),b=!1},d(d){d&&t(p),d&&t(f),$(u,d)}}}function Uu(z){let p,k,f,u,b;return{c(){p=n("p"),k=a("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=n("code"),u=a("Module"),b=a(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(d){p=r(d,"P",{});var m=s(p);k=i(m,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=r(m,"CODE",{});var M=s(f);u=i(M,"Module"),M.forEach(t),b=i(m,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),m.forEach(t)},m(d,m){_(d,p,m),e(p,k),e(p,f),e(f,u),e(p,b)},d(d){d&&t(p)}}}function Gu(z){let p,k,f,u,b;return u=new Xe({props:{code:`from transformers import BertTokenizer, ErnieForPreTraining
import torch
...
<span class="hljs-meta">&gt;&gt;&gt; </span>seq_relationship_logits = outputs.seq_relationship_logits`}}),{c(){p=n("p"),k=a("Example:"),f=c(),v(u.$$.fragment)},l(d){p=r(d,"P",{});var m=s(p);k=i(m,"Example:"),m.forEach(t),f=h(d),y(u.$$.fragment,d)},m(d,m){_(d,p,m),e(p,k),_(d,f,m),T(u,d,m),b=!0},p:Dt,i(d){b||(E(u.$$.fragment,d),b=!0)},o(d){w(u.$$.fragment,d),b=!1},d(d){d&&t(p),d&&t(f),$(u,d)}}}function Ku(z){let p,k,f,u,b;return{c(){p=n("p"),k=a("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=n("code"),u=a("Module"),b=a(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(d){p=r(d,"P",{});var m=s(p);k=i(m,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=r(m,"CODE",{});var M=s(f);u=i(M,"Module"),M.forEach(t),b=i(m,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),m.forEach(t)},m(d,m){_(d,p,m),e(p,k),e(p,f),e(f,u),e(p,b)},d(d){d&&t(p)}}}function Ju(z){let p,k,f,u,b;return u=new Xe({props:{code:`import torch
...
<span class="hljs-meta">&gt;&gt;&gt; </span>logits = outputs.logits`}}),{c(){p=n("p"),k=a("Example:"),f=c(),v(u.$$.fragment)},l(d){p=r(d,"P",{});var m=s(p);k=i(m,"Example:"),m.forEach(t),f=h(d),y(u.$$.fragment,d)},m(d,m){_(d,p,m),e(p,k),_(d,f,m),T(u,d,m),b=!0},p:Dt,i(d){b||(E(u.$$.fragment,d),b=!0)},o(d){w(u.$$.fragment,d),b=!1},d(d){d&&t(p),d&&t(f),$(u,d)}}}function Yu(z){let p,k,f,u,b;return{c(){p=n("p"),k=a("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=n("code"),u=a("Module"),b=a(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(d){p=r(d,"P",{});var m=s(p);k=i(m,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=r(m,"CODE",{});var M=s(f);u=i(M,"Module"),M.forEach(t),b=i(m,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),m.forEach(t)},m(d,m){_(d,p,m),e(p,k),e(p,f),e(f,u),e(p,b)},d(d){d&&t(p)}}}function Xu(z){let p,k,f,u,b;return u=new Xe({props:{code:`from transformers import BertTokenizer, ErnieForMaskedLM
import torch
...
<span class="hljs-string">&#x27;paris&#x27;</span>`}}),{c(){p=n("p"),k=a("Example:"),f=c(),v(u.$$.fragment)},l(d){p=r(d,"P",{});var m=s(p);k=i(m,"Example:"),m.forEach(t),f=h(d),y(u.$$.fragment,d)},m(d,m){_(d,p,m),e(p,k),_(d,f,m),T(u,d,m),b=!0},p:Dt,i(d){b||(E(u.$$.fragment,d),b=!0)},o(d){w(u.$$.fragment,d),b=!1},d(d){d&&t(p),d&&t(f),$(u,d)}}}function Zu(z){let p,k;return p=new Xe({props:{code:`labels = tokenizer("The capital of France is Paris.", return_tensors="pt")["input_ids"]
...
<span class="hljs-number">0.88</span>`}}),{c(){v(p.$$.fragment)},l(f){y(p.$$.fragment,f)},m(f,u){T(p,f,u),k=!0},p:Dt,i(f){k||(E(p.$$.fragment,f),k=!0)},o(f){w(p.$$.fragment,f),k=!1},d(f){$(p,f)}}}function eg(z){let p,k,f,u,b;return{c(){p=n("p"),k=a("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=n("code"),u=a("Module"),b=a(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(d){p=r(d,"P",{});var m=s(p);k=i(m,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=r(m,"CODE",{});var M=s(f);u=i(M,"Module"),M.forEach(t),b=i(m,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),m.forEach(t)},m(d,m){_(d,p,m),e(p,k),e(p,f),e(f,u),e(p,b)},d(d){d&&t(p)}}}function tg(z){let p,k,f,u,b;return u=new Xe({props:{code:`from transformers import BertTokenizer, ErnieForNextSentencePrediction
import torch
...
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-keyword">assert</span> logits[<span class="hljs-number">0</span>, <span class="hljs-number">0</span>] &lt; logits[<span class="hljs-number">0</span>, <span class="hljs-number">1</span>]  <span class="hljs-comment"># next sentence was random</span>`}}),{c(){p=n("p"),k=a("Example:"),f=c(),v(u.$$.fragment)},l(d){p=r(d,"P",{});var m=s(p);k=i(m,"Example:"),m.forEach(t),f=h(d),y(u.$$.fragment,d)},m(d,m){_(d,p,m),e(p,k),_(d,f,m),T(u,d,m),b=!0},p:Dt,i(d){b||(E(u.$$.fragment,d),b=!0)},o(d){w(u.$$.fragment,d),b=!1},d(d){d&&t(p),d&&t(f),$(u,d)}}}function og(z){let p,k,f,u,b;return{c(){p=n("p"),k=a("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=n("code"),u=a("Module"),b=a(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(d){p=r(d,"P",{});var m=s(p);k=i(m,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=r(m,"CODE",{});var M=s(f);u=i(M,"Module"),M.forEach(t),b=i(m,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),m.forEach(t)},m(d,m){_(d,p,m),e(p,k),e(p,f),e(f,u),e(p,b)},d(d){d&&t(p)}}}function ng(z){let p,k,f,u,b;return{c(){p=n("p"),k=a("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=n("code"),u=a("Module"),b=a(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(d){p=r(d,"P",{});var m=s(p);k=i(m,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=r(m,"CODE",{});var M=s(f);u=i(M,"Module"),M.forEach(t),b=i(m,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),m.forEach(t)},m(d,m){_(d,p,m),e(p,k),e(p,f),e(f,u),e(p,b)},d(d){d&&t(p)}}}function rg(z){let p,k,f,u,b;return u=new Xe({props:{code:`from transformers import BertTokenizer, ErnieForMultipleChoice
import torch
...
<span class="hljs-meta">&gt;&gt;&gt; </span>loss = outputs.loss
<span class="hljs-meta">&gt;&gt;&gt; </span>logits = outputs.logits`}}),{c(){p=n("p"),k=a("Example:"),f=c(),v(u.$$.fragment)},l(d){p=r(d,"P",{});var m=s(p);k=i(m,"Example:"),m.forEach(t),f=h(d),y(u.$$.fragment,d)},m(d,m){_(d,p,m),e(p,k),_(d,f,m),T(u,d,m),b=!0},p:Dt,i(d){b||(E(u.$$.fragment,d),b=!0)},o(d){w(u.$$.fragment,d),b=!1},d(d){d&&t(p),d&&t(f),$(u,d)}}}function sg(z){let p,k,f,u,b;return{c(){p=n("p"),k=a("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=n("code"),u=a("Module"),b=a(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(d){p=r(d,"P",{});var m=s(p);k=i(m,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=r(m,"CODE",{});var M=s(f);u=i(M,"Module"),M.forEach(t),b=i(m,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),m.forEach(t)},m(d,m){_(d,p,m),e(p,k),e(p,f),e(f,u),e(p,b)},d(d){d&&t(p)}}}function ag(z){let p,k,f,u,b;return{c(){p=n("p"),k=a("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=n("code"),u=a("Module"),b=a(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(d){p=r(d,"P",{});var m=s(p);k=i(m,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=r(m,"CODE",{});var M=s(f);u=i(M,"Module"),M.forEach(t),b=i(m,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),m.forEach(t)},m(d,m){_(d,p,m),e(p,k),e(p,f),e(f,u),e(p,b)},d(d){d&&t(p)}}}function ig(z){let p,k,f,u,b,d,m,M,pi,ea,pe,Ze,Dr,Wt,mi,Wr,fi,ta,Z,ui,Ht,gi,_i,Bt,bi,ki,oa,me,et,Hr,Rt,vi,Br,yi,na,Vt,ra,fe,tt,Rr,Qt,Ti,Vr,Ei,sa,ot,Qr,ue,mn,wi,$i,fn,zi,Mi,un,Fi,xi,F,ge,gn,Pi,Ci,_n,qi,Ni,bn,Oi,Ai,_e,kn,Li,Si,vn,Ii,ji,yn,Di,Wi,be,Tn,Hi,Bi,En,Ri,Vi,wn,Qi,Ui,ke,$n,Gi,Ki,zn,Ji,Yi,Mn,Xi,Zi,ve,Fn,ed,td,xn,od,nd,Pn,rd,sd,ye,Cn,ad,id,qn,dd,ld,Nn,cd,hd,Te,On,pd,md,An,fd,ud,Ln,gd,_d,Ee,Sn,bd,kd,In,vd,yd,jn,Td,Ed,we,Dn,wd,$d,Wn,zd,Md,Hn,Fd,xd,$e,Bn,Pd,Cd,Rn,qd,Nd,Vn,Od,aa,Q,Ad,Ut,Ld,Sd,Gt,Id,jd,Kt,Dd,Wd,ia,ze,nt,Ur,Jt,Hd,Gr,Bd,da,V,Yt,Rd,X,Vd,Qn,Qd,Ud,Kr,Gd,Kd,Xt,Jd,Yd,Xd,Me,Zd,Un,el,tl,Gn,ol,nl,rl,rt,la,Fe,st,Jr,Zt,sl,Yr,al,ca,xe,eo,il,to,dl,Kn,ll,cl,ha,Pe,at,Xr,oo,hl,Zr,pl,pa,C,no,ml,es,fl,ul,ro,gl,Jn,_l,bl,kl,so,vl,ao,yl,Tl,El,io,wl,lo,$l,zl,Ml,q,Fl,ts,xl,Pl,os,Cl,ql,ns,Nl,Ol,rs,Al,Ll,ss,Sl,Il,as,jl,Dl,Wl,U,co,Hl,Ce,Bl,Yn,Rl,Vl,is,Ql,Ul,Gl,it,Kl,dt,ma,qe,lt,ds,ho,Jl,ls,Yl,fa,N,po,Xl,Ne,Zl,cs,ec,tc,hs,oc,nc,rc,mo,sc,Xn,ac,ic,dc,fo,lc,uo,cc,hc,pc,G,go,mc,Oe,fc,Zn,uc,gc,ps,_c,bc,kc,ct,vc,ht,ua,Ae,pt,ms,_o,yc,fs,Tc,ga,O,bo,Ec,ko,wc,us,$c,zc,Mc,vo,Fc,er,xc,Pc,Cc,yo,qc,To,Nc,Oc,Ac,K,Eo,Lc,Le,Sc,tr,Ic,jc,gs,Dc,Wc,Hc,mt,Bc,ft,_a,Se,ut,_s,wo,Rc,bs,Vc,ba,A,$o,Qc,zo,Uc,ks,Gc,Kc,Jc,Mo,Yc,or,Xc,Zc,eh,Fo,th,xo,oh,nh,rh,H,Po,sh,Ie,ah,nr,ih,dh,vs,lh,ch,hh,gt,ph,_t,mh,bt,ka,je,kt,ys,Co,fh,Ts,uh,va,L,qo,gh,No,_h,Es,bh,kh,vh,Oo,yh,rr,Th,Eh,wh,Ao,$h,Lo,zh,Mh,Fh,J,So,xh,De,Ph,sr,Ch,qh,ws,Nh,Oh,Ah,vt,Lh,yt,ya,We,Tt,$s,Io,Sh,zs,Ih,Ta,S,jo,jh,Ms,Dh,Wh,Do,Hh,ar,Bh,Rh,Vh,Wo,Qh,Ho,Uh,Gh,Kh,ee,Bo,Jh,He,Yh,ir,Xh,Zh,Fs,ep,tp,op,Et,Ea,Be,wt,xs,Ro,np,Ps,rp,wa,I,Vo,sp,Cs,ap,ip,Qo,dp,dr,lp,cp,hp,Uo,pp,Go,mp,fp,up,Y,Ko,gp,Re,_p,lr,bp,kp,qs,vp,yp,Tp,$t,Ep,zt,$a,Ve,Mt,Ns,Jo,wp,Os,$p,za,j,Yo,zp,As,Mp,Fp,Xo,xp,cr,Pp,Cp,qp,Zo,Np,en,Op,Ap,Lp,te,tn,Sp,Qe,Ip,hr,jp,Dp,Ls,Wp,Hp,Bp,Ft,Ma,Ue,xt,Ss,on,Rp,Is,Vp,Fa,D,nn,Qp,Ge,Up,js,Gp,Kp,Ds,Jp,Yp,Xp,rn,Zp,pr,em,tm,om,sn,nm,an,rm,sm,am,oe,dn,im,Ke,dm,mr,lm,cm,Ws,hm,pm,mm,Pt,xa;return d=new W({}),Wt=new W({}),Rt=new W({}),Vt=new Xe({props:{code:`from transformers import AutoTokenizer, AutoModel
...
<code>past_key_values</code>).`,name:"use_cache"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/ernie/modeling_ernie.py#L841",returnDescription:`
<p>A <a
...
</ul>`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/ernie/modeling_ernie.py#L1006",returnDescription:`
<p>A <a
...
If set to <code>True</code>, <code>past_key_values</code> key value states are returned and can be used to speed up decoding (see
<code>past_key_values</code>).`,name:"use_cache"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/ernie/modeling_ernie.py#L1121",returnDescription:`
<p>A <a
...
loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/ernie/modeling_ernie.py#L1265",returnDescription:`
<p>A <a
...
</ul>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/ernie/modeling_ernie.py#L1366",returnDescription:`
<p>A <a
...
<code>input_ids</code> above)`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/ernie/modeling_ernie.py#L1577",returnDescription:`
<p>A <a
...
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/ernie/modeling_ernie.py#L1755"}}),Pt=new Ye({props:{$$slots:{default:[ag]},$$scope:{ctx:z}}}),{c(){p=n("meta"),k=c(),f=n("h1"),u=n("a"),b=n("span"),v(d.$$.fragment),m=c(),M=n("span"),pi=a("ERNIE"),ea=c(),pe=n("h2"),Ze=n("a"),Dr=n("span"),v(Wt.$$.fragment),mi=c(),Wr=n("span"),fi=a("Overview"),ta=a(`
...
`),Z=n("p"),ui=a("These models are contributed by "),Ht=n("a"),gi=a("nghuyong"),_i=a(" and the official code can be found in "),Bt=n("a"),bi=a("PaddleNLP"),ki=a(" (in PaddlePaddle)."),oa=c(),me=n("h3"),et=n("a"),Hr=n("span"),v(Rt.$$.fragment),vi=c(),Br=n("span"),yi=a("How to use"),na=a(`

Take \`ernie-1.0-base-zh\` as an example:

	`),v(Vt.$$.fragment),ra=c(),fe=n("h3"),tt=n("a"),Rr=n("span"),v(Qt.$$.fragment),Ti=c(),Vr=n("span"),Ei=a("Supported Models"),sa=c(),ot=n("table"),Qr=n("thead"),ue=n("tr"),mn=n("th"),wi=a("Model Name"),$i=c(),fn=n("th"),zi=a("Language"),Mi=c(),un=n("th"),Fi=a("Description"),xi=c(),F=n("tbody"),ge=n("tr"),gn=n("td"),Pi=a("ernie-1.0-base-zh"),Ci=c(),_n=n("td"),qi=a("Chinese"),Ni=c(),bn=n("td"),Oi=a("Layer:12, Heads:12, Hidden:768"),Ai=c(),_e=n("tr"),kn=n("td"),Li=a("ernie-2.0-base-en"),Si=c(),vn=n("td"),Ii=a("English"),ji=c(),yn=n("td"),Di=a("Layer:12, Heads:12, Hidden:768"),Wi=c(),be=n("tr"),Tn=n("td"),Hi=a("ernie-2.0-large-en"),Bi=c(),En=n("td"),Ri=a("English"),Vi=c(),wn=n("td"),Qi=a("Layer:24, Heads:16, Hidden:1024"),Ui=c(),ke=n("tr"),$n=n("td"),Gi=a("ernie-3.0-base-zh"),Ki=c(),zn=n("td"),Ji=a("Chinese"),Yi=c(),Mn=n("td"),Xi=a("Layer:12, Heads:12, Hidden:768"),Zi=c(),ve=n("tr"),Fn=n("td"),ed=a("ernie-3.0-medium-zh"),td=c(),xn=n("td"),od=a("Chinese"),nd=c(),Pn=n("td"),rd=a("Layer:6, Heads:12, Hidden:768"),sd=c(),ye=n("tr"),Cn=n("td"),ad=a("ernie-3.0-mini-zh"),id=c(),qn=n("td"),dd=a("Chinese"),ld=c(),Nn=n("td"),cd=a("Layer:6, Heads:12, Hidden:384"),hd=c(),Te=n("tr"),On=n("td"),pd=a("ernie-3.0-micro-zh"),md=c(),An=n("td"),fd=a("Chinese"),ud=c(),Ln=n("td"),gd=a("Layer:4, Heads:12, Hidden:384"),_d=c(),Ee=n("tr"),Sn=n("td"),bd=a("ernie-3.0-nano-zh"),kd=c(),In=n("td"),vd=a("Chinese"),yd=c(),jn=n("td"),Td=a("Layer:4, Heads:12, Hidden:312"),Ed=c(),we=n("tr"),Dn=n("td"),wd=a("ernie-health-zh"),$d=c(),Wn=n("td"),zd=a("Chinese"),Md=c(),Hn=n("td"),Fd=a("Layer:12, Heads:12, Hidden:768"),xd=c(),$e=n("tr"),Bn=n("td"),Pd=a("ernie-gram-zh"),Cd=c(),Rn=n("td"),qd=a("Chinese"),Nd=c(),Vn=n("td"),Od=a("Layer:12, Heads:12, Hidden:768"),aa=c(),Q=n("p"),Ad=a("You can find all the supported models from huggingface\u2019s model hub: "),Ut=n("a"),Ld=a("huggingface.co/nghuyong"),Sd=a(`, and model details from paddle\u2019s official
repo: `),Gt=n("a"),Id=a("PaddleNLP"),jd=a(`
and `),Kt=n("a"),Dd=a("ERNIE"),Wd=a("."),ia=c(),ze=n("h2"),nt=n("a"),Ur=n("span"),v(Jt.$$.fragment),Hd=c(),Gr=n("span"),Bd=a("ErnieConfig"),da=c(),V=n("div"),v(Yt.$$.fragment),Rd=c(),X=n("p"),Vd=a("This is the configuration class to store the configuration of a "),Qn=n("a"),Qd=a("ErnieModel"),Ud=a(" or a "),Kr=n("code"),Gd=a("TFErnieModel"),Kd=a(`. It is used to
...
documentation from `),Gn=n("a"),ol=a("PretrainedConfig"),nl=a(" for more information."),rl=c(),v(rt.$$.fragment),la=c(),Fe=n("h2"),st=n("a"),Jr=n("span"),v(Zt.$$.fragment),sl=c(),Yr=n("span"),al=a("Ernie specific outputs"),ca=c(),xe=n("div"),v(eo.$$.fragment),il=c(),to=n("p"),dl=a("Output type of "),Kn=n("a"),ll=a("ErnieForPreTraining"),cl=a("."),ha=c(),Pe=n("h2"),at=n("a"),Xr=n("span"),v(oo.$$.fragment),hl=c(),Zr=n("span"),pl=a("ErnieModel"),pa=c(),C=n("div"),v(no.$$.fragment),ml=c(),es=n("p"),fl=a("The bare Ernie Model transformer outputting raw hidden-states without any specific head on top."),ul=c(),ro=n("p"),gl=a("This model inherits from "),Jn=n("a"),_l=a("PreTrainedModel"),bl=a(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),kl=c(),so=n("p"),vl=a("This model is also a PyTorch "),ao=n("a"),yl=a("torch.nn.Module"),Tl=a(` subclass.
...
`),rs=n("code"),Al=a("add_cross_attention"),Ll=a(" set to "),ss=n("code"),Sl=a("True"),Il=a("; an "),as=n("code"),jl=a("encoder_hidden_states"),Dl=a(" is then expected as an input to the forward pass."),Wl=c(),U=n("div"),v(co.$$.fragment),Hl=c(),Ce=n("p"),Bl=a("The "),Yn=n("a"),Rl=a("ErnieModel"),Vl=a(" forward method, overrides the "),is=n("code"),Ql=a("__call__"),Ul=a(" special method."),Gl=c(),v(it.$$.fragment),Kl=c(),v(dt.$$.fragment),ma=c(),qe=n("h2"),lt=n("a"),ds=n("span"),v(ho.$$.fragment),Jl=c(),ls=n("span"),Yl=a("ErnieForPreTraining"),fa=c(),N=n("div"),v(po.$$.fragment),Xl=c(),Ne=n("p"),Zl=a("Ernie Model with two heads on top as done during the pretraining: a "),cs=n("code"),ec=a("masked language modeling"),tc=a(" head and a "),hs=n("code"),oc=a("next sentence prediction (classification)"),nc=a(" head."),rc=c(),mo=n("p"),sc=a("This model inherits from "),Xn=n("a"),ac=a("PreTrainedModel"),ic=a(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),dc=c(),fo=n("p"),lc=a("This model is also a PyTorch "),uo=n("a"),cc=a("torch.nn.Module"),hc=a(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),pc=c(),G=n("div"),v(go.$$.fragment),mc=c(),Oe=n("p"),fc=a("The "),Zn=n("a"),uc=a("ErnieForPreTraining"),gc=a(" forward method, overrides the "),ps=n("code"),_c=a("__call__"),bc=a(" special method."),kc=c(),v(ct.$$.fragment),vc=c(),v(ht.$$.fragment),ua=c(),Ae=n("h2"),pt=n("a"),ms=n("span"),v(_o.$$.fragment),yc=c(),fs=n("span"),Tc=a("ErnieForCausalLM"),ga=c(),O=n("div"),v(bo.$$.fragment),Ec=c(),ko=n("p"),wc=a("Ernie Model with a "),us=n("code"),$c=a("language modeling"),zc=a(" head on top for CLM fine-tuning."),Mc=c(),vo=n("p"),Fc=a("This model inherits from "),er=n("a"),xc=a("PreTrainedModel"),Pc=a(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Cc=c(),yo=n("p"),qc=a("This model is also a PyTorch "),To=n("a"),Nc=a("torch.nn.Module"),Oc=a(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Ac=c(),K=n("div"),v(Eo.$$.fragment),Lc=c(),Le=n("p"),Sc=a("The "),tr=n("a"),Ic=a("ErnieForCausalLM"),jc=a(" forward method, overrides the "),gs=n("code"),Dc=a("__call__"),Wc=a(" special method."),Hc=c(),v(mt.$$.fragment),Bc=c(),v(ft.$$.fragment),_a=c(),Se=n("h2"),ut=n("a"),_s=n("span"),v(wo.$$.fragment),Rc=c(),bs=n("span"),Vc=a("ErnieForMaskedLM"),ba=c(),A=n("div"),v($o.$$.fragment),Qc=c(),zo=n("p"),Uc=a("Ernie Model with a "),ks=n("code"),Gc=a("language modeling"),Kc=a(" head on top."),Jc=c(),Mo=n("p"),Yc=a("This model inherits from "),or=n("a"),Xc=a("PreTrainedModel"),Zc=a(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),eh=c(),Fo=n("p"),th=a("This model is also a PyTorch "),xo=n("a"),oh=a("torch.nn.Module"),nh=a(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),rh=c(),H=n("div"),v(Po.$$.fragment),sh=c(),Ie=n("p"),ah=a("The "),nr=n("a"),ih=a("ErnieForMaskedLM"),dh=a(" forward method, overrides the "),vs=n("code"),lh=a("__call__"),ch=a(" special method."),hh=c(),v(gt.$$.fragment),ph=c(),v(_t.$$.fragment),mh=c(),v(bt.$$.fragment),ka=c(),je=n("h2"),kt=n("a"),ys=n("span"),v(Co.$$.fragment),fh=c(),Ts=n("span"),uh=a("ErnieForNextSentencePrediction"),va=c(),L=n("div"),v(qo.$$.fragment),gh=c(),No=n("p"),_h=a("Ernie Model with a "),Es=n("code"),bh=a("next sentence prediction (classification)"),kh=a(" head on top."),vh=c(),Oo=n("p"),yh=a("This model inherits from "),rr=n("a"),Th=a("PreTrainedModel"),Eh=a(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),up=c(),Y=n("div"),v(Ko.$$.fragment),gp=c(),Re=n("p"),_p=a("The "),lr=n("a"),bp=a("ErnieForMultipleChoice"),kp=a(" forward method, overrides the "),qs=n("code"),vp=a("__call__"),yp=a(" special method."),Tp=c(),v($t.$$.fragment),Ep=c(),v(zt.$$.fragment),$a=c(),Ve=n("h2"),Mt=n("a"),Ns=n("span"),v(Jo.$$.fragment),wp=c(),Os=n("span"),$p=a("ErnieForTokenClassification"),za=c(),j=n("div"),v(Yo.$$.fragment),zp=c(),As=n("p"),Mp=a(`Ernie Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g. for
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Lp=c(),te=n("div"),v(tn.$$.fragment),Sp=c(),Qe=n("p"),Ip=a("The "),hr=n("a"),jp=a("ErnieForTokenClassification"),Dp=a(" forward method, overrides the "),Ls=n("code"),Wp=a("__call__"),Hp=a(" special method."),Bp=c(),v(Ft.$$.fragment),Ma=c(),Ue=n("h2"),xt=n("a"),Ss=n("span"),v(on.$$.fragment),Rp=c(),Is=n("span"),Vp=a("ErnieForQuestionAnswering"),Fa=c(),D=n("div"),v(nn.$$.fragment),Qp=c(),Ge=n("p"),Up=a(`Ernie Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
...
cross-attention is added between the self-attention layers, following the architecture described in `),lo=r(Ia,"A",{href:!0,rel:!0});var bf=s(lo);$l=i(bf,`Attention is
all you need`),bf.forEach(t),zl=i(Ia,` by Ashish Vaswani, Noam Shazeer, Niki Parmar, Jakob Uszkoreit,
Llion Jones, Aidan N. Gomez, Lukasz Kaiser and Illia Polosukhin.`),Ia.forEach(t),Ml=h(B),q=r(B,"P",{});var R=s(q);Fl=i(R,"To behave as an decoder the model needs to be initialized with the "),ts=r(R,"CODE",{});var kf=s(ts);xl=i(kf,"is_decoder"),kf.forEach(t),Pl=i(R,` argument of the configuration set
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Ka.forEach(t),rh=h(se),H=r(se,"DIV",{class:!0});var ae=s(H);y(Po.$$.fragment,ae),sh=h(ae),Ie=r(ae,"P",{});var Pr=s(Ie);ah=i(Pr,"The "),nr=r(Pr,"A",{href:!0});var Jf=s(nr);ih=i(Jf,"ErnieForMaskedLM"),Jf.forEach(t),dh=i(Pr," forward method, overrides the "),vs=r(Pr,"CODE",{});var Yf=s(vs);lh=i(Yf,"__call__"),Yf.forEach(t),ch=i(Pr," special method."),Pr.forEach(t),hh=h(ae),y(gt.$$.fragment,ae),ph=h(ae),y(_t.$$.fragment,ae),mh=h(ae),y(bt.$$.fragment,ae),ae.forEach(t),se.forEach(t),ka=h(o),je=r(o,"H2",{class:!0});var Ja=s(je);kt=r(Ja,"A",{id:!0,class:!0,href:!0});var Xf=s(kt);ys=r(Xf,"SPAN",{});var Zf=s(ys);y(Co.$$.fragment,Zf),Zf.forEach(t),Xf.forEach(t),fh=h(Ja),Ts=r(Ja,"SPAN",{});var eu=s(Ts);uh=i(eu,"ErnieForNextSentencePrediction"),eu.forEach(t),Ja.forEach(t),va=h(o),L=r(o,"DIV",{class:!0});var ie=s(L);y(qo.$$.fragment,ie),gh=h(ie),No=r(ie,"P",{});var Ya=s(No);_h=i(Ya,"Ernie Model with a "),Es=r(Ya,"CODE",{});var tu=s(Es);bh=i(tu,"next sentence prediction (classification)"),tu.forEach(t),kh=i(Ya," head on top."),Ya.forEach(t),vh=h(ie),Oo=r(ie,"P",{});var Xa=s(Oo);yh=i(Xa,"This model inherits from "),rr=r(Xa,"A",{href:!0});var ou=s(rr);Th=i(ou,"PreTrainedModel"),ou.forEach(t),Eh=i(Xa,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
softmax) e.g. for RocStories/SWAG tasks.`),_u.forEach(t),ip=h(le),Qo=r(le,"P",{});var ri=s(Qo);dp=i(ri,"This model inherits from "),dr=r(ri,"A",{href:!0});var bu=s(dr);lp=i(bu,"PreTrainedModel"),bu.forEach(t),cp=i(ri,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),ri.forEach(t),hp=h(le),Uo=r(le,"P",{});var si=s(Uo);pp=i(si,"This model is also a PyTorch "),Go=r(si,"A",{href:!0,rel:!0});var ku=s(Go);mp=i(ku,"torch.nn.Module"),ku.forEach(t),fp=i(si,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),si.forEach(t),up=h(le),Y=r(le,"DIV",{class:!0});var It=s(Y);y(Ko.$$.fragment,It),gp=h(It),Re=r(It,"P",{});var Or=s(Re);_p=i(Or,"The "),lr=r(Or,"A",{href:!0});var vu=s(lr);bp=i(vu,"ErnieForMultipleChoice"),vu.forEach(t),kp=i(Or," forward method, overrides the "),qs=r(Or,"CODE",{});var yu=s(qs);vp=i(yu,"__call__"),yu.forEach(t),yp=i(Or," special method."),Or.forEach(t),Tp=h(It),y($t.$$.fragment,It),Ep=h(It),y(zt.$$.fragment,It),It.forEach(t),le.forEach(t),$a=h(o),Ve=r(o,"H2",{class:!0});var ai=s(Ve);Mt=r(ai,"A",{id:!0,class:!0,href:!0});var Tu=s(Mt);Ns=r(Tu,"SPAN",{});var Eu=s(Ns);y(Jo.$$.fragment,Eu),Eu.forEach(t),Tu.forEach(t),wp=h(ai),Os=r(ai,"SPAN",{});var wu=s(Os);$p=i(wu,"ErnieForTokenClassification"),wu.forEach(t),ai.forEach(t),za=h(o),j=r(o,"DIV",{class:!0});var ce=s(j);y(Yo.$$.fragment,ce),zp=h(ce),As=r(ce,"P",{});var $u=s(As);Mp=i($u,`Ernie Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g. for
