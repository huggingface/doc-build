import{S as ju,i as Du,s as Wu,e as n,k as c,w as v,t as a,M as Hu,c as r,d as t,m as h,a as s,x as y,h as i,b as l,G as e,g as _,y as T,q as E,o as w,B as $,v as Bu,L as Dt}from"../../chunks/vendor-hf-doc-builder.js";import{T as Ye}from"../../chunks/Tip-hf-doc-builder.js";import{D as P}from"../../chunks/Docstring-hf-doc-builder.js";import{C as Xe}from"../../chunks/CodeBlock-hf-doc-builder.js";import{I as W}from"../../chunks/IconCopyLink-hf-doc-builder.js";import{E as jt}from"../../chunks/ExampleCodeBlock-hf-doc-builder.js";function Ru(z){let p,b,f,u,k;return u=new Xe({props:{code:`from transformers import ErnieConfig, ErnieModel
...
<span class="hljs-meta">&gt;&gt;&gt; </span>configuration = model.config`}}),{c(){p=n("p"),b=a("Examples:"),f=c(),v(u.$$.fragment)},l(d){p=r(d,"P",{});var m=s(p);b=i(m,"Examples:"),m.forEach(t),f=h(d),y(u.$$.fragment,d)},m(d,m){_(d,p,m),e(p,b),_(d,f,m),T(u,d,m),k=!0},p:Dt,i(d){k||(E(u.$$.fragment,d),k=!0)},o(d){w(u.$$.fragment,d),k=!1},d(d){d&&t(p),d&&t(f),$(u,d)}}}function Qu(z){let p,b,f,u,k;return{c(){p=n("p"),b=a("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=n("code"),u=a("Module"),k=a(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(d){p=r(d,"P",{});var m=s(p);b=i(m,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=r(m,"CODE",{});var M=s(f);u=i(M,"Module"),M.forEach(t),k=i(m,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),m.forEach(t)},m(d,m){_(d,p,m),e(p,b),e(p,f),e(f,u),e(p,k)},d(d){d&&t(p)}}}function Uu(z){let p,b,f,u,k;return u=new Xe({props:{code:`from transformers import BertTokenizer, ErnieModel
import torch
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),{c(){p=n("p"),b=a("Example:"),f=c(),v(u.$$.fragment)},l(d){p=r(d,"P",{});var m=s(p);b=i(m,"Example:"),m.forEach(t),f=h(d),y(u.$$.fragment,d)},m(d,m){_(d,p,m),e(p,b),_(d,f,m),T(u,d,m),k=!0},p:Dt,i(d){k||(E(u.$$.fragment,d),k=!0)},o(d){w(u.$$.fragment,d),k=!1},d(d){d&&t(p),d&&t(f),$(u,d)}}}function Vu(z){let p,b,f,u,k;return{c(){p=n("p"),b=a("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=n("code"),u=a("Module"),k=a(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(d){p=r(d,"P",{});var m=s(p);b=i(m,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=r(m,"CODE",{});var M=s(f);u=i(M,"Module"),M.forEach(t),k=i(m,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),m.forEach(t)},m(d,m){_(d,p,m),e(p,b),e(p,f),e(f,u),e(p,k)},d(d){d&&t(p)}}}function Gu(z){let p,b,f,u,k;return u=new Xe({props:{code:`from transformers import BertTokenizer, ErnieForPreTraining
import torch
...
<span class="hljs-meta">&gt;&gt;&gt; </span>seq_relationship_logits = outputs.seq_relationship_logits`}}),{c(){p=n("p"),b=a("Example:"),f=c(),v(u.$$.fragment)},l(d){p=r(d,"P",{});var m=s(p);b=i(m,"Example:"),m.forEach(t),f=h(d),y(u.$$.fragment,d)},m(d,m){_(d,p,m),e(p,b),_(d,f,m),T(u,d,m),k=!0},p:Dt,i(d){k||(E(u.$$.fragment,d),k=!0)},o(d){w(u.$$.fragment,d),k=!1},d(d){d&&t(p),d&&t(f),$(u,d)}}}function Ku(z){let p,b,f,u,k;return{c(){p=n("p"),b=a("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=n("code"),u=a("Module"),k=a(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(d){p=r(d,"P",{});var m=s(p);b=i(m,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=r(m,"CODE",{});var M=s(f);u=i(M,"Module"),M.forEach(t),k=i(m,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),m.forEach(t)},m(d,m){_(d,p,m),e(p,b),e(p,f),e(f,u),e(p,k)},d(d){d&&t(p)}}}function Ju(z){let p,b,f,u,k;return u=new Xe({props:{code:`import torch
...
<span class="hljs-meta">&gt;&gt;&gt; </span>logits = outputs.logits`}}),{c(){p=n("p"),b=a("Example:"),f=c(),v(u.$$.fragment)},l(d){p=r(d,"P",{});var m=s(p);b=i(m,"Example:"),m.forEach(t),f=h(d),y(u.$$.fragment,d)},m(d,m){_(d,p,m),e(p,b),_(d,f,m),T(u,d,m),k=!0},p:Dt,i(d){k||(E(u.$$.fragment,d),k=!0)},o(d){w(u.$$.fragment,d),k=!1},d(d){d&&t(p),d&&t(f),$(u,d)}}}function Yu(z){let p,b,f,u,k;return{c(){p=n("p"),b=a("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=n("code"),u=a("Module"),k=a(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(d){p=r(d,"P",{});var m=s(p);b=i(m,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=r(m,"CODE",{});var M=s(f);u=i(M,"Module"),M.forEach(t),k=i(m,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),m.forEach(t)},m(d,m){_(d,p,m),e(p,b),e(p,f),e(f,u),e(p,k)},d(d){d&&t(p)}}}function Xu(z){let p,b,f,u,k;return u=new Xe({props:{code:`from transformers import BertTokenizer, ErnieForMaskedLM
import torch
...
<span class="hljs-string">&#x27;paris&#x27;</span>`}}),{c(){p=n("p"),b=a("Example:"),f=c(),v(u.$$.fragment)},l(d){p=r(d,"P",{});var m=s(p);b=i(m,"Example:"),m.forEach(t),f=h(d),y(u.$$.fragment,d)},m(d,m){_(d,p,m),e(p,b),_(d,f,m),T(u,d,m),k=!0},p:Dt,i(d){k||(E(u.$$.fragment,d),k=!0)},o(d){w(u.$$.fragment,d),k=!1},d(d){d&&t(p),d&&t(f),$(u,d)}}}function Zu(z){let p,b;return p=new Xe({props:{code:`labels = tokenizer("The capital of France is Paris.", return_tensors="pt")["input_ids"]
...
<span class="hljs-number">0.88</span>`}}),{c(){v(p.$$.fragment)},l(f){y(p.$$.fragment,f)},m(f,u){T(p,f,u),b=!0},p:Dt,i(f){b||(E(p.$$.fragment,f),b=!0)},o(f){w(p.$$.fragment,f),b=!1},d(f){$(p,f)}}}function eg(z){let p,b,f,u,k;return{c(){p=n("p"),b=a("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=n("code"),u=a("Module"),k=a(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(d){p=r(d,"P",{});var m=s(p);b=i(m,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=r(m,"CODE",{});var M=s(f);u=i(M,"Module"),M.forEach(t),k=i(m,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),m.forEach(t)},m(d,m){_(d,p,m),e(p,b),e(p,f),e(f,u),e(p,k)},d(d){d&&t(p)}}}function tg(z){let p,b,f,u,k;return u=new Xe({props:{code:`from transformers import BertTokenizer, ErnieForNextSentencePrediction
import torch
...
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-keyword">assert</span> logits[<span class="hljs-number">0</span>, <span class="hljs-number">0</span>] &lt; logits[<span class="hljs-number">0</span>, <span class="hljs-number">1</span>]  <span class="hljs-comment"># next sentence was random</span>`}}),{c(){p=n("p"),b=a("Example:"),f=c(),v(u.$$.fragment)},l(d){p=r(d,"P",{});var m=s(p);b=i(m,"Example:"),m.forEach(t),f=h(d),y(u.$$.fragment,d)},m(d,m){_(d,p,m),e(p,b),_(d,f,m),T(u,d,m),k=!0},p:Dt,i(d){k||(E(u.$$.fragment,d),k=!0)},o(d){w(u.$$.fragment,d),k=!1},d(d){d&&t(p),d&&t(f),$(u,d)}}}function og(z){let p,b,f,u,k;return{c(){p=n("p"),b=a("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=n("code"),u=a("Module"),k=a(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(d){p=r(d,"P",{});var m=s(p);b=i(m,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=r(m,"CODE",{});var M=s(f);u=i(M,"Module"),M.forEach(t),k=i(m,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),m.forEach(t)},m(d,m){_(d,p,m),e(p,b),e(p,f),e(f,u),e(p,k)},d(d){d&&t(p)}}}function ng(z){let p,b,f,u,k;return{c(){p=n("p"),b=a("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=n("code"),u=a("Module"),k=a(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(d){p=r(d,"P",{});var m=s(p);b=i(m,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=r(m,"CODE",{});var M=s(f);u=i(M,"Module"),M.forEach(t),k=i(m,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),m.forEach(t)},m(d,m){_(d,p,m),e(p,b),e(p,f),e(f,u),e(p,k)},d(d){d&&t(p)}}}function rg(z){let p,b,f,u,k;return u=new Xe({props:{code:`from transformers import BertTokenizer, ErnieForMultipleChoice
import torch
...
<span class="hljs-meta">&gt;&gt;&gt; </span>loss = outputs.loss
<span class="hljs-meta">&gt;&gt;&gt; </span>logits = outputs.logits`}}),{c(){p=n("p"),b=a("Example:"),f=c(),v(u.$$.fragment)},l(d){p=r(d,"P",{});var m=s(p);b=i(m,"Example:"),m.forEach(t),f=h(d),y(u.$$.fragment,d)},m(d,m){_(d,p,m),e(p,b),_(d,f,m),T(u,d,m),k=!0},p:Dt,i(d){k||(E(u.$$.fragment,d),k=!0)},o(d){w(u.$$.fragment,d),k=!1},d(d){d&&t(p),d&&t(f),$(u,d)}}}function sg(z){let p,b,f,u,k;return{c(){p=n("p"),b=a("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=n("code"),u=a("Module"),k=a(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(d){p=r(d,"P",{});var m=s(p);b=i(m,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=r(m,"CODE",{});var M=s(f);u=i(M,"Module"),M.forEach(t),k=i(m,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),m.forEach(t)},m(d,m){_(d,p,m),e(p,b),e(p,f),e(f,u),e(p,k)},d(d){d&&t(p)}}}function ag(z){let p,b,f,u,k;return{c(){p=n("p"),b=a("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=n("code"),u=a("Module"),k=a(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(d){p=r(d,"P",{});var m=s(p);b=i(m,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=r(m,"CODE",{});var M=s(f);u=i(M,"Module"),M.forEach(t),k=i(m,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),m.forEach(t)},m(d,m){_(d,p,m),e(p,b),e(p,f),e(f,u),e(p,k)},d(d){d&&t(p)}}}function ig(z){let p,b,f,u,k,d,m,M,pi,ea,pe,Ze,Dr,Wt,mi,Wr,fi,ta,Z,ui,Ht,gi,_i,Bt,ki,bi,oa,me,et,Hr,Rt,vi,Br,yi,na,Qt,ra,fe,tt,Rr,Ut,Ti,Qr,Ei,sa,ot,Ur,ue,mn,wi,$i,fn,zi,Mi,un,Fi,xi,F,ge,gn,Pi,Ci,_n,qi,Ni,kn,Oi,Ai,_e,bn,Li,Si,vn,Ii,ji,yn,Di,Wi,ke,Tn,Hi,Bi,En,Ri,Qi,wn,Ui,Vi,be,$n,Gi,Ki,zn,Ji,Yi,Mn,Xi,Zi,ve,Fn,ed,td,xn,od,nd,Pn,rd,sd,ye,Cn,ad,id,qn,dd,ld,Nn,cd,hd,Te,On,pd,md,An,fd,ud,Ln,gd,_d,Ee,Sn,kd,bd,In,vd,yd,jn,Td,Ed,we,Dn,wd,$d,Wn,zd,Md,Hn,Fd,xd,$e,Bn,Pd,Cd,Rn,qd,Nd,Qn,Od,aa,U,Ad,Vt,Ld,Sd,Gt,Id,jd,Kt,Dd,Wd,ia,ze,nt,Vr,Jt,Hd,Gr,Bd,da,Q,Yt,Rd,X,Qd,Un,Ud,Vd,Kr,Gd,Kd,Xt,Jd,Yd,Xd,Me,Zd,Vn,el,tl,Gn,ol,nl,rl,rt,la,Fe,st,Jr,Zt,sl,Yr,al,ca,xe,eo,il,to,dl,Kn,ll,cl,ha,Pe,at,Xr,oo,hl,Zr,pl,pa,C,no,ml,es,fl,ul,ro,gl,Jn,_l,kl,bl,so,vl,ao,yl,Tl,El,io,wl,lo,$l,zl,Ml,q,Fl,ts,xl,Pl,os,Cl,ql,ns,Nl,Ol,rs,Al,Ll,ss,Sl,Il,as,jl,Dl,Wl,V,co,Hl,Ce,Bl,Yn,Rl,Ql,is,Ul,Vl,Gl,it,Kl,dt,ma,qe,lt,ds,ho,Jl,ls,Yl,fa,N,po,Xl,Ne,Zl,cs,ec,tc,hs,oc,nc,rc,mo,sc,Xn,ac,ic,dc,fo,lc,uo,cc,hc,pc,G,go,mc,Oe,fc,Zn,uc,gc,ps,_c,kc,bc,ct,vc,ht,ua,Ae,pt,ms,_o,yc,fs,Tc,ga,O,ko,Ec,bo,wc,us,$c,zc,Mc,vo,Fc,er,xc,Pc,Cc,yo,qc,To,Nc,Oc,Ac,K,Eo,Lc,Le,Sc,tr,Ic,jc,gs,Dc,Wc,Hc,mt,Bc,ft,_a,Se,ut,_s,wo,Rc,ks,Qc,ka,A,$o,Uc,zo,Vc,bs,Gc,Kc,Jc,Mo,Yc,or,Xc,Zc,eh,Fo,th,xo,oh,nh,rh,H,Po,sh,Ie,ah,nr,ih,dh,vs,lh,ch,hh,gt,ph,_t,mh,kt,ba,je,bt,ys,Co,fh,Ts,uh,va,L,qo,gh,No,_h,Es,kh,bh,vh,Oo,yh,rr,Th,Eh,wh,Ao,$h,Lo,zh,Mh,Fh,J,So,xh,De,Ph,sr,Ch,qh,ws,Nh,Oh,Ah,vt,Lh,yt,ya,We,Tt,$s,Io,Sh,zs,Ih,Ta,S,jo,jh,Ms,Dh,Wh,Do,Hh,ar,Bh,Rh,Qh,Wo,Uh,Ho,Vh,Gh,Kh,ee,Bo,Jh,He,Yh,ir,Xh,Zh,Fs,ep,tp,op,Et,Ea,Be,wt,xs,Ro,np,Ps,rp,wa,I,Qo,sp,Cs,ap,ip,Uo,dp,dr,lp,cp,hp,Vo,pp,Go,mp,fp,up,Y,Ko,gp,Re,_p,lr,kp,bp,qs,vp,yp,Tp,$t,Ep,zt,$a,Qe,Mt,Ns,Jo,wp,Os,$p,za,j,Yo,zp,As,Mp,Fp,Xo,xp,cr,Pp,Cp,qp,Zo,Np,en,Op,Ap,Lp,te,tn,Sp,Ue,Ip,hr,jp,Dp,Ls,Wp,Hp,Bp,Ft,Ma,Ve,xt,Ss,on,Rp,Is,Qp,Fa,D,nn,Up,Ge,Vp,js,Gp,Kp,Ds,Jp,Yp,Xp,rn,Zp,pr,em,tm,om,sn,nm,an,rm,sm,am,oe,dn,im,Ke,dm,mr,lm,cm,Ws,hm,pm,mm,Pt,xa;return d=new W({}),Wt=new W({}),Rt=new W({}),Qt=new Xe({props:{code:`from transformers import AutoTokenizer, AutoModel
...
`),Z=n("p"),ui=a("These models are contributed by "),Ht=n("a"),gi=a("nghuyong"),_i=a(" and the official code can be found in "),Bt=n("a"),ki=a("PaddleNLP"),bi=a(" (in PaddlePaddle)."),oa=c(),me=n("h3"),et=n("a"),Hr=n("span"),v(Rt.$$.fragment),vi=c(),Br=n("span"),yi=a("How to use"),na=a(`

Take \`ernie-1.0-base-zh\` as an example:

	`),v(Qt.$$.fragment),ra=c(),fe=n("h3"),tt=n("a"),Rr=n("span"),v(Ut.$$.fragment),Ti=c(),Qr=n("span"),Ei=a("Supported Models"),sa=c(),ot=n("table"),Ur=n("thead"),ue=n("tr"),mn=n("th"),wi=a("Model Name"),$i=c(),fn=n("th"),zi=a("Language"),Mi=c(),un=n("th"),Fi=a("Description"),xi=c(),F=n("tbody"),ge=n("tr"),gn=n("td"),Pi=a("ernie-1.0-base-zh"),Ci=c(),_n=n("td"),qi=a("Chinese"),Ni=c(),kn=n("td"),Oi=a("Layer:12, Heads:12, Hidden:768"),Ai=c(),_e=n("tr"),bn=n("td"),Li=a("ernie-2.0-base-en"),Si=c(),vn=n("td"),Ii=a("English"),ji=c(),yn=n("td"),Di=a("Layer:12, Heads:12, Hidden:768"),Wi=c(),ke=n("tr"),Tn=n("td"),Hi=a("ernie-2.0-large-en"),Bi=c(),En=n("td"),Ri=a("English"),Qi=c(),wn=n("td"),Ui=a("Layer:24, Heads:16, Hidden:1024"),Vi=c(),be=n("tr"),$n=n("td"),Gi=a("ernie-3.0-base-zh"),Ki=c(),zn=n("td"),Ji=a("Chinese"),Yi=c(),Mn=n("td"),Xi=a("Layer:12, Heads:12, Hidden:768"),Zi=c(),ve=n("tr"),Fn=n("td"),ed=a("ernie-3.0-medium-zh"),td=c(),xn=n("td"),od=a("Chinese"),nd=c(),Pn=n("td"),rd=a("Layer:6, Heads:12, Hidden:768"),sd=c(),ye=n("tr"),Cn=n("td"),ad=a("ernie-3.0-mini-zh"),id=c(),qn=n("td"),dd=a("Chinese"),ld=c(),Nn=n("td"),cd=a("Layer:6, Heads:12, Hidden:384"),hd=c(),Te=n("tr"),On=n("td"),pd=a("ernie-3.0-micro-zh"),md=c(),An=n("td"),fd=a("Chinese"),ud=c(),Ln=n("td"),gd=a("Layer:4, Heads:12, Hidden:384"),_d=c(),Ee=n("tr"),Sn=n("td"),kd=a("ernie-3.0-nano-zh"),bd=c(),In=n("td"),vd=a("Chinese"),yd=c(),jn=n("td"),Td=a("Layer:4, Heads:12, Hidden:312"),Ed=c(),we=n("tr"),Dn=n("td"),wd=a("ernie-health-zh"),$d=c(),Wn=n("td"),zd=a("Chinese"),Md=c(),Hn=n("td"),Fd=a("Layer:12, Heads:12, Hidden:768"),xd=c(),$e=n("tr"),Bn=n("td"),Pd=a("ernie-gram-zh"),Cd=c(),Rn=n("td"),qd=a("Chinese"),Nd=c(),Qn=n("td"),Od=a("Layer:12, Heads:12, Hidden:768"),aa=c(),U=n("p"),Ad=a("You can find all the supported models from huggingface\u2019s model hub: "),Vt=n("a"),Ld=a("huggingface.co/nghuyong"),Sd=a(`, and model details from paddle\u2019s official
repo: `),Gt=n("a"),Id=a("PaddleNLP"),jd=a(`
and `),Kt=n("a"),Dd=a("ERNIE"),Wd=a("."),ia=c(),ze=n("h2"),nt=n("a"),Vr=n("span"),v(Jt.$$.fragment),Hd=c(),Gr=n("span"),Bd=a("ErnieConfig"),da=c(),Q=n("div"),v(Yt.$$.fragment),Rd=c(),X=n("p"),Qd=a("This is the configuration class to store the configuration of a "),Un=n("a"),Ud=a("ErnieModel"),Vd=a(" or a "),Kr=n("code"),Gd=a("TFErnieModel"),Kd=a(`. It is used to
...
documentation from `),Gn=n("a"),ol=a("PretrainedConfig"),nl=a(" for more information."),rl=c(),v(rt.$$.fragment),la=c(),Fe=n("h2"),st=n("a"),Jr=n("span"),v(Zt.$$.fragment),sl=c(),Yr=n("span"),al=a("Ernie specific outputs"),ca=c(),xe=n("div"),v(eo.$$.fragment),il=c(),to=n("p"),dl=a("Output type of "),Kn=n("a"),ll=a("ErnieForPreTraining"),cl=a("."),ha=c(),Pe=n("h2"),at=n("a"),Xr=n("span"),v(oo.$$.fragment),hl=c(),Zr=n("span"),pl=a("ErnieModel"),pa=c(),C=n("div"),v(no.$$.fragment),ml=c(),es=n("p"),fl=a("The bare Ernie Model transformer outputting raw hidden-states without any specific head on top."),ul=c(),ro=n("p"),gl=a("This model inherits from "),Jn=n("a"),_l=a("PreTrainedModel"),kl=a(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),bl=c(),so=n("p"),vl=a("This model is also a PyTorch "),ao=n("a"),yl=a("torch.nn.Module"),Tl=a(` subclass.
...
`),rs=n("code"),Al=a("add_cross_attention"),Ll=a(" set to "),ss=n("code"),Sl=a("True"),Il=a("; an "),as=n("code"),jl=a("encoder_hidden_states"),Dl=a(" is then expected as an input to the forward pass."),Wl=c(),V=n("div"),v(co.$$.fragment),Hl=c(),Ce=n("p"),Bl=a("The "),Yn=n("a"),Rl=a("ErnieModel"),Ql=a(" forward method, overrides the "),is=n("code"),Ul=a("__call__"),Vl=a(" special method."),Gl=c(),v(it.$$.fragment),Kl=c(),v(dt.$$.fragment),ma=c(),qe=n("h2"),lt=n("a"),ds=n("span"),v(ho.$$.fragment),Jl=c(),ls=n("span"),Yl=a("ErnieForPreTraining"),fa=c(),N=n("div"),v(po.$$.fragment),Xl=c(),Ne=n("p"),Zl=a("Ernie Model with two heads on top as done during the pretraining: a "),cs=n("code"),ec=a("masked language modeling"),tc=a(" head and a "),hs=n("code"),oc=a("next sentence prediction (classification)"),nc=a(" head."),rc=c(),mo=n("p"),sc=a("This model inherits from "),Xn=n("a"),ac=a("PreTrainedModel"),ic=a(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),dc=c(),fo=n("p"),lc=a("This model is also a PyTorch "),uo=n("a"),cc=a("torch.nn.Module"),hc=a(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),pc=c(),G=n("div"),v(go.$$.fragment),mc=c(),Oe=n("p"),fc=a("The "),Zn=n("a"),uc=a("ErnieForPreTraining"),gc=a(" forward method, overrides the "),ps=n("code"),_c=a("__call__"),kc=a(" special method."),bc=c(),v(ct.$$.fragment),vc=c(),v(ht.$$.fragment),ua=c(),Ae=n("h2"),pt=n("a"),ms=n("span"),v(_o.$$.fragment),yc=c(),fs=n("span"),Tc=a("ErnieForCausalLM"),ga=c(),O=n("div"),v(ko.$$.fragment),Ec=c(),bo=n("p"),wc=a("Ernie Model with a "),us=n("code"),$c=a("language modeling"),zc=a(" head on top for CLM fine-tuning."),Mc=c(),vo=n("p"),Fc=a("This model inherits from "),er=n("a"),xc=a("PreTrainedModel"),Pc=a(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Cc=c(),yo=n("p"),qc=a("This model is also a PyTorch "),To=n("a"),Nc=a("torch.nn.Module"),Oc=a(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Ac=c(),K=n("div"),v(Eo.$$.fragment),Lc=c(),Le=n("p"),Sc=a("The "),tr=n("a"),Ic=a("ErnieForCausalLM"),jc=a(" forward method, overrides the "),gs=n("code"),Dc=a("__call__"),Wc=a(" special method."),Hc=c(),v(mt.$$.fragment),Bc=c(),v(ft.$$.fragment),_a=c(),Se=n("h2"),ut=n("a"),_s=n("span"),v(wo.$$.fragment),Rc=c(),ks=n("span"),Qc=a("ErnieForMaskedLM"),ka=c(),A=n("div"),v($o.$$.fragment),Uc=c(),zo=n("p"),Vc=a("Ernie Model with a "),bs=n("code"),Gc=a("language modeling"),Kc=a(" head on top."),Jc=c(),Mo=n("p"),Yc=a("This model inherits from "),or=n("a"),Xc=a("PreTrainedModel"),Zc=a(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),eh=c(),Fo=n("p"),th=a("This model is also a PyTorch "),xo=n("a"),oh=a("torch.nn.Module"),nh=a(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),rh=c(),H=n("div"),v(Po.$$.fragment),sh=c(),Ie=n("p"),ah=a("The "),nr=n("a"),ih=a("ErnieForMaskedLM"),dh=a(" forward method, overrides the "),vs=n("code"),lh=a("__call__"),ch=a(" special method."),hh=c(),v(gt.$$.fragment),ph=c(),v(_t.$$.fragment),mh=c(),v(kt.$$.fragment),ba=c(),je=n("h2"),bt=n("a"),ys=n("span"),v(Co.$$.fragment),fh=c(),Ts=n("span"),uh=a("ErnieForNextSentencePrediction"),va=c(),L=n("div"),v(qo.$$.fragment),gh=c(),No=n("p"),_h=a("Ernie Model with a "),Es=n("code"),kh=a("next sentence prediction (classification)"),bh=a(" head on top."),vh=c(),Oo=n("p"),yh=a("This model inherits from "),rr=n("a"),Th=a("PreTrainedModel"),Eh=a(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),wh=c(),Ao=n("p"),$h=a("This model is also a PyTorch "),Lo=n("a"),zh=a("torch.nn.Module"),Mh=a(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Fh=c(),J=n("div"),v(So.$$.fragment),xh=c(),De=n("p"),Ph=a("The "),sr=n("a"),Ch=a("ErnieForNextSentencePrediction"),qh=a(" forward method, overrides the "),ws=n("code"),Nh=a("__call__"),Oh=a(" special method."),Ah=c(),v(vt.$$.fragment),Lh=c(),v(yt.$$.fragment),ya=c(),We=n("h2"),Tt=n("a"),$s=n("span"),v(Io.$$.fragment),Sh=c(),zs=n("span"),Ih=a("ErnieForSequenceClassification"),Ta=c(),S=n("div"),v(jo.$$.fragment),jh=c(),Ms=n("p"),Dh=a(`Ernie Model transformer with a sequence classification/regression head on top (a linear layer on top of the pooled
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Qh=c(),Wo=n("p"),Uh=a("This model is also a PyTorch "),Ho=n("a"),Vh=a("torch.nn.Module"),Gh=a(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Kh=c(),ee=n("div"),v(Bo.$$.fragment),Jh=c(),He=n("p"),Yh=a("The "),ir=n("a"),Xh=a("ErnieForSequenceClassification"),Zh=a(" forward method, overrides the "),Fs=n("code"),ep=a("__call__"),tp=a(" special method."),op=c(),v(Et.$$.fragment),Ea=c(),Be=n("h2"),wt=n("a"),xs=n("span"),v(Ro.$$.fragment),np=c(),Ps=n("span"),rp=a("ErnieForMultipleChoice"),wa=c(),I=n("div"),v(Qo.$$.fragment),sp=c(),Cs=n("p"),ap=a(`Ernie Model with a multiple choice classification head on top (a linear layer on top of the pooled output and a
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),hp=c(),Vo=n("p"),pp=a("This model is also a PyTorch "),Go=n("a"),mp=a("torch.nn.Module"),fp=a(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),up=c(),Y=n("div"),v(Ko.$$.fragment),gp=c(),Re=n("p"),_p=a("The "),lr=n("a"),kp=a("ErnieForMultipleChoice"),bp=a(" forward method, overrides the "),qs=n("code"),vp=a("__call__"),yp=a(" special method."),Tp=c(),v($t.$$.fragment),Ep=c(),v(zt.$$.fragment),$a=c(),Qe=n("h2"),Mt=n("a"),Ns=n("span"),v(Jo.$$.fragment),wp=c(),Os=n("span"),$p=a("ErnieForTokenClassification"),za=c(),j=n("div"),v(Yo.$$.fragment),zp=c(),As=n("p"),Mp=a(`Ernie Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g. for
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Lp=c(),te=n("div"),v(tn.$$.fragment),Sp=c(),Ue=n("p"),Ip=a("The "),hr=n("a"),jp=a("ErnieForTokenClassification"),Dp=a(" forward method, overrides the "),Ls=n("code"),Wp=a("__call__"),Hp=a(" special method."),Bp=c(),v(Ft.$$.fragment),Ma=c(),Ve=n("h2"),xt=n("a"),Ss=n("span"),v(on.$$.fragment),Rp=c(),Is=n("span"),Qp=a("ErnieForQuestionAnswering"),Fa=c(),D=n("div"),v(nn.$$.fragment),Up=c(),Ge=n("p"),Vp=a(`Ernie Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),am=c(),oe=n("div"),v(dn.$$.fragment),im=c(),Ke=n("p"),dm=a("The "),mr=n("a"),lm=a("ErnieForQuestionAnswering"),cm=a(" forward method, overrides the "),Ws=n("code"),hm=a("__call__"),pm=a(" special method."),mm=c(),v(Pt.$$.fragment),this.h()},l(o){const g=Hu('[data-svelte="svelte-1phssyn"]',document.head);p=r(g,"META",{name:!0,content:!0}),g.forEach(t),b=h(o),f=r(o,"H1",{class:!0});var ln=s(f);u=r(ln,"A",{id:!0,class:!0,href:!0});var Hs=s(u);k=r(Hs,"SPAN",{});var Bs=s(k);y(d.$$.fragment,Bs),Bs.forEach(t),Hs.forEach(t),m=h(ln),M=r(ln,"SPAN",{});var Rs=s(M);pi=i(Rs,"ERNIE"),Rs.forEach(t),ln.forEach(t),ea=h(o),pe=r(o,"H2",{class:!0});var cn=s(pe);Ze=r(cn,"A",{id:!0,class:!0,href:!0});var Qs=s(Ze);Dr=r(Qs,"SPAN",{});var Us=s(Dr);y(Wt.$$.fragment,Us),Us.forEach(t),Qs.forEach(t),mi=h(cn),Wr=r(cn,"SPAN",{});var Vs=s(Wr);fi=i(Vs,"Overview"),Vs.forEach(t),cn.forEach(t),ta=i(o,`

ERNIE is a series of powerful models proposed by baidu, especially in Chinese tasks,
including [ERNIE1.0](https://arxiv.org/abs/1904.09223), [ERNIE2.0](https://ojs.aaai.org/index.php/AAAI/article/view/6428),
[ERNIE3.0](https://arxiv.org/abs/2107.02137), [ERNIE-Gram](https://arxiv.org/abs/2010.12148), [ERNIE-health](https://arxiv.org/abs/2110.07244), etc.
`),Z=r(o,"P",{});var Je=s(Z);ui=i(Je,"These models are contributed by "),Ht=r(Je,"A",{href:!0,rel:!0});var Gs=s(Ht);gi=i(Gs,"nghuyong"),Gs.forEach(t),_i=i(Je," and the official code can be found in "),Bt=r(Je,"A",{href:!0,rel:!0});var Ks=s(Bt);ki=i(Ks,"PaddleNLP"),Ks.forEach(t),bi=i(Je," (in PaddlePaddle)."),Je.forEach(t),oa=h(o),me=r(o,"H3",{class:!0});var hn=s(me);et=r(hn,"A",{id:!0,class:!0,href:!0});var Js=s(et);Hr=r(Js,"SPAN",{});var Ys=s(Hr);y(Rt.$$.fragment,Ys),Ys.forEach(t),Js.forEach(t),vi=h(hn),Br=r(hn,"SPAN",{});var Xs=s(Br);yi=i(Xs,"How to use"),Xs.forEach(t),hn.forEach(t),na=i(o,`

Take \`ernie-1.0-base-zh\` as an example:

	`),y(Qt.$$.fragment,o),ra=h(o),fe=r(o,"H3",{class:!0});var pn=s(fe);tt=r(pn,"A",{id:!0,class:!0,href:!0});var Zs=s(tt);Rr=r(Zs,"SPAN",{});var fm=s(Rr);y(Ut.$$.fragment,fm),fm.forEach(t),Zs.forEach(t),Ti=h(pn),Qr=r(pn,"SPAN",{});var um=s(Qr);Ei=i(um,"Supported Models"),um.forEach(t),pn.forEach(t),sa=h(o),ot=r(o,"TABLE",{});var Pa=s(ot);Ur=r(Pa,"THEAD",{});var gm=s(Ur);ue=r(gm,"TR",{});var fr=s(ue);mn=r(fr,"TH",{align:!0});var _m=s(mn);wi=i(_m,"Model Name"),_m.forEach(t),$i=h(fr),fn=r(fr,"TH",{align:!0});var km=s(fn);zi=i(km,"Language"),km.forEach(t),Mi=h(fr),un=r(fr,"TH",{align:!0});var bm=s(un);Fi=i(bm,"Description"),bm.forEach(t),fr.forEach(t),gm.forEach(t),xi=h(Pa),F=r(Pa,"TBODY",{});var x=s(F);ge=r(x,"TR",{});var ur=s(ge);gn=r(ur,"TD",{align:!0});var vm=s(gn);Pi=i(vm,"ernie-1.0-base-zh"),vm.forEach(t),Ci=h(ur),_n=r(ur,"TD",{align:!0});var ym=s(_n);qi=i(ym,"Chinese"),ym.forEach(t),Ni=h(ur),kn=r(ur,"TD",{align:!0});var Tm=s(kn);Oi=i(Tm,"Layer:12, Heads:12, Hidden:768"),Tm.forEach(t),ur.forEach(t),Ai=h(x),_e=r(x,"TR",{});var gr=s(_e);bn=r(gr,"TD",{align:!0});var Em=s(bn);Li=i(Em,"ernie-2.0-base-en"),Em.forEach(t),Si=h(gr),vn=r(gr,"TD",{align:!0});var wm=s(vn);Ii=i(wm,"English"),wm.forEach(t),ji=h(gr),yn=r(gr,"TD",{align:!0});var $m=s(yn);Di=i($m,"Layer:12, Heads:12, Hidden:768"),$m.forEach(t),gr.forEach(t),Wi=h(x),ke=r(x,"TR",{});var _r=s(ke);Tn=r(_r,"TD",{align:!0});var zm=s(Tn);Hi=i(zm,"ernie-2.0-large-en"),zm.forEach(t),Bi=h(_r),En=r(_r,"TD",{align:!0});var Mm=s(En);Ri=i(Mm,"English"),Mm.forEach(t),Qi=h(_r),wn=r(_r,"TD",{align:!0});var Fm=s(wn);Ui=i(Fm,"Layer:24, Heads:16, Hidden:1024"),Fm.forEach(t),_r.forEach(t),Vi=h(x),be=r(x,"TR",{});var kr=s(be);$n=r(kr,"TD",{align:!0});var xm=s($n);Gi=i(xm,"ernie-3.0-base-zh"),xm.forEach(t),Ki=h(kr),zn=r(kr,"TD",{align:!0});var Pm=s(zn);Ji=i(Pm,"Chinese"),Pm.forEach(t),Yi=h(kr),Mn=r(kr,"TD",{align:!0});var Cm=s(Mn);Xi=i(Cm,"Layer:12, Heads:12, Hidden:768"),Cm.forEach(t),kr.forEach(t),Zi=h(x),ve=r(x,"TR",{});var br=s(ve);Fn=r(br,"TD",{align:!0});var qm=s(Fn);ed=i(qm,"ernie-3.0-medium-zh"),qm.forEach(t),td=h(br),xn=r(br,"TD",{align:!0});var Nm=s(xn);od=i(Nm,"Chinese"),Nm.forEach(t),nd=h(br),Pn=r(br,"TD",{align:!0});var Om=s(Pn);rd=i(Om,"Layer:6, Heads:12, Hidden:768"),Om.forEach(t),br.forEach(t),sd=h(x),ye=r(x,"TR",{});var vr=s(ye);Cn=r(vr,"TD",{align:!0});var Am=s(Cn);ad=i(Am,"ernie-3.0-mini-zh"),Am.forEach(t),id=h(vr),qn=r(vr,"TD",{align:!0});var Lm=s(qn);dd=i(Lm,"Chinese"),Lm.forEach(t),ld=h(vr),Nn=r(vr,"TD",{align:!0});var Sm=s(Nn);cd=i(Sm,"Layer:6, Heads:12, Hidden:384"),Sm.forEach(t),vr.forEach(t),hd=h(x),Te=r(x,"TR",{});var yr=s(Te);On=r(yr,"TD",{align:!0});var Im=s(On);pd=i(Im,"ernie-3.0-micro-zh"),Im.forEach(t),md=h(yr),An=r(yr,"TD",{align:!0});var jm=s(An);fd=i(jm,"Chinese"),jm.forEach(t),ud=h(yr),Ln=r(yr,"TD",{align:!0});var Dm=s(Ln);gd=i(Dm,"Layer:4, Heads:12, Hidden:384"),Dm.forEach(t),yr.forEach(t),_d=h(x),Ee=r(x,"TR",{});var Tr=s(Ee);Sn=r(Tr,"TD",{align:!0});var Wm=s(Sn);kd=i(Wm,"ernie-3.0-nano-zh"),Wm.forEach(t),bd=h(Tr),In=r(Tr,"TD",{align:!0});var Hm=s(In);vd=i(Hm,"Chinese"),Hm.forEach(t),yd=h(Tr),jn=r(Tr,"TD",{align:!0});var Bm=s(jn);Td=i(Bm,"Layer:4, Heads:12, Hidden:312"),Bm.forEach(t),Tr.forEach(t),Ed=h(x),we=r(x,"TR",{});var Er=s(we);Dn=r(Er,"TD",{align:!0});var Rm=s(Dn);wd=i(Rm,"ernie-health-zh"),Rm.forEach(t),$d=h(Er),Wn=r(Er,"TD",{align:!0});var Qm=s(Wn);zd=i(Qm,"Chinese"),Qm.forEach(t),Md=h(Er),Hn=r(Er,"TD",{align:!0});var Um=s(Hn);Fd=i(Um,"Layer:12, Heads:12, Hidden:768"),Um.forEach(t),Er.forEach(t),xd=h(x),$e=r(x,"TR",{});var wr=s($e);Bn=r(wr,"TD",{align:!0});var Vm=s(Bn);Pd=i(Vm,"ernie-gram-zh"),Vm.forEach(t),Cd=h(wr),Rn=r(wr,"TD",{align:!0});var Gm=s(Rn);qd=i(Gm,"Chinese"),Gm.forEach(t),Nd=h(wr),Qn=r(wr,"TD",{align:!0});var Km=s(Qn);Od=i(Km,"Layer:12, Heads:12, Hidden:768"),Km.forEach(t),wr.forEach(t),x.forEach(t),Pa.forEach(t),aa=h(o),U=r(o,"P",{});var Ct=s(U);Ad=i(Ct,"You can find all the supported models from huggingface\u2019s model hub: "),Vt=r(Ct,"A",{href:!0,rel:!0});var Jm=s(Vt);Ld=i(Jm,"huggingface.co/nghuyong"),Jm.forEach(t),Sd=i(Ct,`, and model details from paddle\u2019s official
repo: `),Gt=r(Ct,"A",{href:!0,rel:!0});var Ym=s(Gt);Id=i(Ym,"PaddleNLP"),Ym.forEach(t),jd=i(Ct,`
and `),Kt=r(Ct,"A",{href:!0,rel:!0});var Xm=s(Kt);Dd=i(Xm,"ERNIE"),Xm.forEach(t),Wd=i(Ct,"."),Ct.forEach(t),ia=h(o),ze=r(o,"H2",{class:!0});var Ca=s(ze);nt=r(Ca,"A",{id:!0,class:!0,href:!0});var Zm=s(nt);Vr=r(Zm,"SPAN",{});var ef=s(Vr);y(Jt.$$.fragment,ef),ef.forEach(t),Zm.forEach(t),Hd=h(Ca),Gr=r(Ca,"SPAN",{});var tf=s(Gr);Bd=i(tf,"ErnieConfig"),tf.forEach(t),Ca.forEach(t),da=h(o),Q=r(o,"DIV",{class:!0});var qt=s(Q);y(Yt.$$.fragment,qt),Rd=h(qt),X=r(qt,"P",{});var Nt=s(X);Qd=i(Nt,"This is the configuration class to store the configuration of a "),Un=r(Nt,"A",{href:!0});var of=s(Un);Ud=i(of,"ErnieModel"),of.forEach(t),Vd=i(Nt," or a "),Kr=r(Nt,"CODE",{});var nf=s(Kr);Gd=i(nf,"TFErnieModel"),nf.forEach(t),Kd=i(Nt,`. It is used to
instantiate a ERNIE model according to the specified arguments, defining the model architecture. Instantiating a
configuration with the defaults will yield a similar configuration to that of the ERNIE
`),Xt=r(Nt,"A",{href:!0,rel:!0});var rf=s(Xt);Jd=i(rf,"nghuyong/ernie-3.0-base-zh"),rf.forEach(t),Yd=i(Nt," architecture."),Nt.forEach(t),Xd=h(qt),Me=r(qt,"P",{});var $r=s(Me);Zd=i($r,"Configuration objects inherit from "),Vn=r($r,"A",{href:!0});var sf=s(Vn);el=i(sf,"PretrainedConfig"),sf.forEach(t),tl=i($r,` and can be used to control the model outputs. Read the
documentation from `),Gn=r($r,"A",{href:!0});var af=s(Gn);ol=i(af,"PretrainedConfig"),af.forEach(t),nl=i($r," for more information."),$r.forEach(t),rl=h(qt),y(rt.$$.fragment,qt),qt.forEach(t),la=h(o),Fe=r(o,"H2",{class:!0});var qa=s(Fe);st=r(qa,"A",{id:!0,class:!0,href:!0});var df=s(st);Jr=r(df,"SPAN",{});var lf=s(Jr);y(Zt.$$.fragment,lf),lf.forEach(t),df.forEach(t),sl=h(qa),Yr=r(qa,"SPAN",{});var cf=s(Yr);al=i(cf,"Ernie specific outputs"),cf.forEach(t),qa.forEach(t),ca=h(o),xe=r(o,"DIV",{class:!0});var Na=s(xe);y(eo.$$.fragment,Na),il=h(Na),to=r(Na,"P",{});var Oa=s(to);dl=i(Oa,"Output type of "),Kn=r(Oa,"A",{href:!0});var hf=s(Kn);ll=i(hf,"ErnieForPreTraining"),hf.forEach(t),cl=i(Oa,"."),Oa.forEach(t),Na.forEach(t),ha=h(o),Pe=r(o,"H2",{class:!0});var Aa=s(Pe);at=r(Aa,"A",{id:!0,class:!0,href:!0});var pf=s(at);Xr=r(pf,"SPAN",{});var mf=s(Xr);y(oo.$$.fragment,mf),mf.forEach(t),pf.forEach(t),hl=h(Aa),Zr=r(Aa,"SPAN",{});var ff=s(Zr);pl=i(ff,"ErnieModel"),ff.forEach(t),Aa.forEach(t),pa=h(o),C=r(o,"DIV",{class:!0});var B=s(C);y(no.$$.fragment,B),ml=h(B),es=r(B,"P",{});var uf=s(es);fl=i(uf,"The bare Ernie Model transformer outputting raw hidden-states without any specific head on top."),uf.forEach(t),ul=h(B),ro=r(B,"P",{});var La=s(ro);gl=i(La,"This model inherits from "),Jn=r(La,"A",{href:!0});var gf=s(Jn);_l=i(gf,"PreTrainedModel"),gf.forEach(t),kl=i(La,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),La.forEach(t),bl=h(B),so=r(B,"P",{});var Sa=s(so);vl=i(Sa,"This model is also a PyTorch "),ao=r(Sa,"A",{href:!0,rel:!0});var _f=s(ao);yl=i(_f,"torch.nn.Module"),_f.forEach(t),Tl=i(Sa,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
...
cross-attention is added between the self-attention layers, following the architecture described in `),lo=r(Ia,"A",{href:!0,rel:!0});var kf=s(lo);$l=i(kf,`Attention is
all you need`),kf.forEach(t),zl=i(Ia,` by Ashish Vaswani, Noam Shazeer, Niki Parmar, Jakob Uszkoreit,
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Wa.forEach(t),pc=h(ne),G=r(ne,"DIV",{class:!0});var At=s(G);y(go.$$.fragment,At),mc=h(At),Oe=r(At,"P",{});var Fr=s(Oe);fc=i(Fr,"The "),Zn=r(Fr,"A",{href:!0});var Of=s(Zn);uc=i(Of,"ErnieForPreTraining"),Of.forEach(t),gc=i(Fr," forward method, overrides the "),ps=r(Fr,"CODE",{});var Af=s(ps);_c=i(Af,"__call__"),Af.forEach(t),kc=i(Fr," special method."),Fr.forEach(t),bc=h(At),y(ct.$$.fragment,At),vc=h(At),y(ht.$$.fragment,At),At.forEach(t),ne.forEach(t),ua=h(o),Ae=r(o,"H2",{class:!0});var Ha=s(Ae);pt=r(Ha,"A",{id:!0,class:!0,href:!0});var Lf=s(pt);ms=r(Lf,"SPAN",{});var Sf=s(ms);y(_o.$$.fragment,Sf),Sf.forEach(t),Lf.forEach(t),yc=h(Ha),fs=r(Ha,"SPAN",{});var If=s(fs);Tc=i(If,"ErnieForCausalLM"),If.forEach(t),Ha.forEach(t),ga=h(o),O=r(o,"DIV",{class:!0});var re=s(O);y(ko.$$.fragment,re),Ec=h(re),bo=r(re,"P",{});var Ba=s(bo);wc=i(Ba,"Ernie Model with a "),us=r(Ba,"CODE",{});var jf=s(us);$c=i(jf,"language modeling"),jf.forEach(t),zc=i(Ba," head on top for CLM fine-tuning."),Ba.forEach(t),Mc=h(re),vo=r(re,"P",{});var Ra=s(vo);Fc=i(Ra,"This model inherits from "),er=r(Ra,"A",{href:!0});var Df=s(er);xc=i(Df,"PreTrainedModel"),Df.forEach(t),Pc=i(Ra,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Ra.forEach(t),Cc=h(re),yo=r(re,"P",{});var Qa=s(yo);qc=i(Qa,"This model is also a PyTorch "),To=r(Qa,"A",{href:!0,rel:!0});var Wf=s(To);Nc=i(Wf,"torch.nn.Module"),Wf.forEach(t),Oc=i(Qa,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Qa.forEach(t),Ac=h(re),K=r(re,"DIV",{class:!0});var Lt=s(K);y(Eo.$$.fragment,Lt),Lc=h(Lt),Le=r(Lt,"P",{});var xr=s(Le);Sc=i(xr,"The "),tr=r(xr,"A",{href:!0});var Hf=s(tr);Ic=i(Hf,"ErnieForCausalLM"),Hf.forEach(t),jc=i(xr," forward method, overrides the "),gs=r(xr,"CODE",{});var Bf=s(gs);Dc=i(Bf,"__call__"),Bf.forEach(t),Wc=i(xr," special method."),xr.forEach(t),Hc=h(Lt),y(mt.$$.fragment,Lt),Bc=h(Lt),y(ft.$$.fragment,Lt),Lt.forEach(t),re.forEach(t),_a=h(o),Se=r(o,"H2",{class:!0});var Ua=s(Se);ut=r(Ua,"A",{id:!0,class:!0,href:!0});var Rf=s(ut);_s=r(Rf,"SPAN",{});var Qf=s(_s);y(wo.$$.fragment,Qf),Qf.forEach(t),Rf.forEach(t),Rc=h(Ua),ks=r(Ua,"SPAN",{});var Uf=s(ks);Qc=i(Uf,"ErnieForMaskedLM"),Uf.forEach(t),Ua.forEach(t),ka=h(o),A=r(o,"DIV",{class:!0});var se=s(A);y($o.$$.fragment,se),Uc=h(se),zo=r(se,"P",{});var Va=s(zo);Vc=i(Va,"Ernie Model with a "),bs=r(Va,"CODE",{});var Vf=s(bs);Gc=i(Vf,"language modeling"),Vf.forEach(t),Kc=i(Va," head on top."),Va.forEach(t),Jc=h(se),Mo=r(se,"P",{});var Ga=s(Mo);Yc=i(Ga,"This model inherits from "),or=r(Ga,"A",{href:!0});var Gf=s(or);Xc=i(Gf,"PreTrainedModel"),Gf.forEach(t),Zc=i(Ga,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Ka.forEach(t),rh=h(se),H=r(se,"DIV",{class:!0});var ae=s(H);y(Po.$$.fragment,ae),sh=h(ae),Ie=r(ae,"P",{});var Pr=s(Ie);ah=i(Pr,"The "),nr=r(Pr,"A",{href:!0});var Jf=s(nr);ih=i(Jf,"ErnieForMaskedLM"),Jf.forEach(t),dh=i(Pr," forward method, overrides the "),vs=r(Pr,"CODE",{});var Yf=s(vs);lh=i(Yf,"__call__"),Yf.forEach(t),ch=i(Pr," special method."),Pr.forEach(t),hh=h(ae),y(gt.$$.fragment,ae),ph=h(ae),y(_t.$$.fragment,ae),mh=h(ae),y(kt.$$.fragment,ae),ae.forEach(t),se.forEach(t),ba=h(o),je=r(o,"H2",{class:!0});var Ja=s(je);bt=r(Ja,"A",{id:!0,class:!0,href:!0});var Xf=s(bt);ys=r(Xf,"SPAN",{});var Zf=s(ys);y(Co.$$.fragment,Zf),Zf.forEach(t),Xf.forEach(t),fh=h(Ja),Ts=r(Ja,"SPAN",{});var eu=s(Ts);uh=i(eu,"ErnieForNextSentencePrediction"),eu.forEach(t),Ja.forEach(t),va=h(o),L=r(o,"DIV",{class:!0});var ie=s(L);y(qo.$$.fragment,ie),gh=h(ie),No=r(ie,"P",{});var Ya=s(No);_h=i(Ya,"Ernie Model with a "),Es=r(Ya,"CODE",{});var tu=s(Es);kh=i(tu,"next sentence prediction (classification)"),tu.forEach(t),bh=i(Ya," head on top."),Ya.forEach(t),vh=h(ie),Oo=r(ie,"P",{});var Xa=s(Oo);yh=i(Xa,"This model inherits from "),rr=r(Xa,"A",{href:!0});var ou=s(rr);Th=i(ou,"PreTrainedModel"),ou.forEach(t),Eh=i(Xa,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),ti.forEach(t),Qh=h(de),Wo=r(de,"P",{});var oi=s(Wo);Uh=i(oi,"This model is also a PyTorch "),Ho=r(oi,"A",{href:!0,rel:!0});var hu=s(Ho);Vh=i(hu,"torch.nn.Module"),hu.forEach(t),Gh=i(oi,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),oi.forEach(t),Kh=h(de),ee=r(de,"DIV",{class:!0});var qr=s(ee);y(Bo.$$.fragment,qr),Jh=h(qr),He=r(qr,"P",{});var Nr=s(He);Yh=i(Nr,"The "),ir=r(Nr,"A",{href:!0});var pu=s(ir);Xh=i(pu,"ErnieForSequenceClassification"),pu.forEach(t),Zh=i(Nr," forward method, overrides the "),Fs=r(Nr,"CODE",{});var mu=s(Fs);ep=i(mu,"__call__"),mu.forEach(t),tp=i(Nr," special method."),Nr.forEach(t),op=h(qr),y(Et.$$.fragment,qr),qr.forEach(t),de.forEach(t),Ea=h(o),Be=r(o,"H2",{class:!0});var ni=s(Be);wt=r(ni,"A",{id:!0,class:!0,href:!0});var fu=s(wt);xs=r(fu,"SPAN",{});var uu=s(xs);y(Ro.$$.fragment,uu),uu.forEach(t),fu.forEach(t),np=h(ni),Ps=r(ni,"SPAN",{});var gu=s(Ps);rp=i(gu,"ErnieForMultipleChoice"),gu.forEach(t),ni.forEach(t),wa=h(o),I=r(o,"DIV",{class:!0});var le=s(I);y(Qo.$$.fragment,le),sp=h(le),Cs=r(le,"P",{});var _u=s(Cs);ap=i(_u,`Ernie Model with a multiple choice classification head on top (a linear layer on top of the pooled output and a
softmax) e.g. for RocStories/SWAG tasks.`),_u.forEach(t),ip=h(le),Uo=r(le,"P",{});var ri=s(Uo);dp=i(ri,"This model inherits from "),dr=r(ri,"A",{href:!0});var ku=s(dr);lp=i(ku,"PreTrainedModel"),ku.forEach(t),cp=i(ri,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),ri.forEach(t),hp=h(le),Vo=r(le,"P",{});var si=s(Vo);pp=i(si,"This model is also a PyTorch "),Go=r(si,"A",{href:!0,rel:!0});var bu=s(Go);mp=i(bu,"torch.nn.Module"),bu.forEach(t),fp=i(si,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),si.forEach(t),up=h(le),Y=r(le,"DIV",{class:!0});var It=s(Y);y(Ko.$$.fragment,It),gp=h(It),Re=r(It,"P",{});var Or=s(Re);_p=i(Or,"The "),lr=r(Or,"A",{href:!0});var vu=s(lr);kp=i(vu,"ErnieForMultipleChoice"),vu.forEach(t),bp=i(Or," forward method, overrides the "),qs=r(Or,"CODE",{});var yu=s(qs);vp=i(yu,"__call__"),yu.forEach(t),yp=i(Or," special method."),Or.forEach(t),Tp=h(It),y($t.$$.fragment,It),Ep=h(It),y(zt.$$.fragment,It),It.forEach(t),le.forEach(t),$a=h(o),Qe=r(o,"H2",{class:!0});var ai=s(Qe);Mt=r(ai,"A",{id:!0,class:!0,href:!0});var Tu=s(Mt);Ns=r(Tu,"SPAN",{});var Eu=s(Ns);y(Jo.$$.fragment,Eu),Eu.forEach(t),Tu.forEach(t),wp=h(ai),Os=r(ai,"SPAN",{});var wu=s(Os);$p=i(wu,"ErnieForTokenClassification"),wu.forEach(t),ai.forEach(t),za=h(o),j=r(o,"DIV",{class:!0});var ce=s(j);y(Yo.$$.fragment,ce),zp=h(ce),As=r(ce,"P",{});var $u=s(As);Mp=i($u,`Ernie Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g. for
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),di.forEach(t),Lp=h(ce),te=r(ce,"DIV",{class:!0});var Ar=s(te);y(tn.$$.fragment,Ar),Sp=h(Ar),Ue=r(Ar,"P",{});var Lr=s(Ue);Ip=i(Lr,"The "),hr=r(Lr,"A",{href:!0});var Fu=s(hr);jp=i(Fu,"ErnieForTokenClassification"),Fu.forEach(t),Dp=i(Lr," forward method, overrides the "),Ls=r(Lr,"CODE",{});var xu=s(Ls);Wp=i(xu,"__call__"),xu.forEach(t),Hp=i(Lr," special method."),Lr.forEach(t),Bp=h(Ar),y(Ft.$$.fragment,Ar),Ar.forEach(t),ce.forEach(t),Ma=h(o),Ve=r(o,"H2",{class:!0});var li=s(Ve);xt=r(li,"A",{id:!0,class:!0,href:!0});var Pu=s(xt);Ss=r(Pu,"SPAN",{});var Cu=s(Ss);y(on.$$.fragment,Cu),Cu.forEach(t),Pu.forEach(t),Rp=h(li),Is=r(li,"SPAN",{});var qu=s(Is);Qp=i(qu,"ErnieForQuestionAnswering"),qu.forEach(t),li.forEach(t),Fa=h(o),D=r(o,"DIV",{class:!0});var he=s(D);y(nn.$$.fragment,he),Up=h(he),Ge=r(he,"P",{});var Sr=s(Ge);Vp=i(Sr,`Ernie Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
