...
the latter silently ignores them.`)},l(y){p=a(y,"P",{});var j=s(p);F=n(j,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=a(j,"CODE",{});var C=s(f);M=n(C,"Module"),C.forEach(o),P=n(j,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),j.forEach(o)},m(y,j){w(y,p,j),e(p,F),e(p,f),e(f,M),e(p,P)},d(y){y&&o(p)}}}function mc(pe){let p,F,f,M,P,y,j,C,Vn,Jt,h,$n,Eo,qn,zn,rt,Pn,Fn,ko,Cn,An,xo,Sn,In,jo,Ln,Nn,Do,On,Rn,at,Bn,Gn,Mo,Wn,Un,Vo,Hn,Zn,$o,Yn,Jn,qo,Kn,Qn,Kt,me,Xn,xe,er,or,Qt,G,tr,zo,nr,rr,Po,ar,sr,Xt,Q,he,st,je,dr,dt,ir,en,z,De,cr,fe,Fo,lr,pr,Co,mr,hr,fr,X,ur,Ao,gr,_r,So,vr,br,Tr,it,wr,yr,Me,Er,ue,Ve,kr,$e,xr,Io,jr,Dr,Mr,ge,qe,Vr,ee,$r,ct,qr,zr,lt,Pr,Fr,on,oe,_e,pt,ze,Cr,mt,Ar,tn,E,Pe,Sr,te,Ir,ht,Lr,Nr,ft,Or,Rr,Br,Fe,Gr,Ce,Wr,Ur,Hr,Ae,Zr,Se,Yr,Jr,Kr,ut,Qr,Xr,Ie,ea,Lo,oa,ta,na,Le,ra,Ne,aa,sa,da,W,No,ia,ca,gt,la,pa,_t,ma,ha,fa,A,Oe,ua,ne,ga,Oo,_a,va,vt,ba,Ta,wa,ve,ya,bt,Ea,ka,Re,xa,S,Be,ja,Tt,Da,Ma,re,Va,wt,$a,qa,yt,za,Pa,Fa,Et,Ca,Aa,Ge,nn,ae,be,kt,We,Sa,xt,Ia,rn,k,Ue,La,se,Na,jt,Oa,Ra,Dt,Ba,Ga,Wa,He,Ua,Ze,Ha,Za,Ya,Ye,Ja,Je,Ka,Qa,Xa,Mt,es,os,Ke,ts,Ro,ns,rs,as,Qe,ss,Xe,ds,is,cs,U,Bo,ls,ps,Vt,ms,hs,$t,fs,us,gs,I,eo,_s,de,vs,Go,bs,Ts,qt,ws,ys,Es,Te,ks,zt,xs,js,oo,Ds,O,to,Ms,Pt,Vs,$s,Ft,qs,zs,no,an,ie,we,Ct,ro,Ps,At,Fs,sn,x,ao,Cs,ce,As,St,Ss,Is,It,Ls,Ns,Os,so,Rs,io,Bs,Gs,Ws,co,Us,lo,Hs,Zs,Ys,Lt,Js,Ks,po,Qs,Wo,Xs,ed,od,mo,td,ho,nd,rd,ad,H,Uo,sd,dd,Nt,id,cd,Ot,ld,pd,md,L,fo,hd,le,fd,Ho,ud,gd,Rt,_d,vd,bd,ye,Td,Bt,wd,yd,uo,Ed,R,go,kd,Gt,xd,jd,Wt,Dd,Md,_o,dn;return y=new Yt({}),je=new Yt({}),De=new B({props:{name:"class transformers.VisionEncoderDecoderConfig",anchor:"transformers.VisionEncoderDecoderConfig",parameters:[{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/vision_encoder_decoder/configuration_vision_encoder_decoder.py#L27",parametersDescription:[{anchor:"transformers.VisionEncoderDecoderConfig.kwargs",description:`<strong>kwargs</strong> (<em>optional</em>) &#x2014;
...
Zhoujun Li, Furu Wei.`),Qt=c(),G=r("p"),tr=t("An example of how to use a "),zo=r("a"),nr=t("VisionEncoderDecoderModel"),rr=t(" for inference can be seen in "),Po=r("a"),ar=t("TrOCR"),sr=t("."),Xt=c(),Q=r("h2"),he=r("a"),st=r("span"),u(je.$$.fragment),dr=c(),dt=r("span"),ir=t("VisionEncoderDecoderConfig"),en=c(),z=r("div"),u(De.$$.fragment),cr=c(),fe=r("p"),Fo=r("a"),lr=t("VisionEncoderDecoderConfig"),pr=t(` is the configuration class to store the configuration of a
...
for the encoder and :meth`),Ot=r("em"),ld=t("~transformers.FlaxAutoModelForCausalLM.from_pretrained"),pd=t(" class method for the decoder."),md=c(),L=r("div"),u(fo.$$.fragment),hd=c(),le=r("p"),fd=t("The "),Ho=r("a"),ud=t("FlaxVisionEncoderDecoderModel"),gd=t(" forward method, overrides the "),Rt=r("code"),_d=t("__call__"),vd=t(" special method."),bd=c(),u(ye.$$.fragment),Td=c(),Bt=r("p"),wd=t("Examples:"),yd=c(),u(uo.$$.fragment),Ed=c(),R=r("div"),u(go.$$.fragment),kd=c(),Gt=r("p"),xd=t(`Instantiate an encoder and a decoder from one or two base classes of the library from pretrained model
checkpoints.`),jd=c(),Wt=r("p"),Dd=t("Example:"),Md=c(),u(_o.$$.fragment),this.h()},l(d){const m=dc('[data-svelte="svelte-1phssyn"]',document.head);p=a(m,"META",{name:!0,content:!0}),m.forEach(o),F=l(d),f=a(d,"H1",{class:!0});var vo=s(f);M=a(vo,"A",{id:!0,class:!0,href:!0});var Ut=s(M);P=a(Ut,"SPAN",{});var Ht=s(P);g(y.$$.fragment,Ht),Ht.forEach(o),Ut.forEach(o),j=l(vo),C=a(vo,"SPAN",{});var $d=s(C);Vn=n($d,"Vision Encoder Decoder Models"),$d.forEach(o),vo.forEach(o),Jt=l(d),h=a(d,"P",{});var D=s(h);$n=n(D,"The "),Eo=a(D,"A",{href:!0});var qd=s(Eo);qn=n(qd,"VisionEncoderDecoderModel"),qd.forEach(o),zn=n(D,` can be used to initialize an image-to-text-sequence model with any
...
Zhoujun Li, Furu Wei.`),cn.forEach(o),Qt=l(d),G=a(d,"P",{});var Zo=s(G);tr=n(Zo,"An example of how to use a "),zo=a(Zo,"A",{href:!0});var Bd=s(zo);nr=n(Bd,"VisionEncoderDecoderModel"),Bd.forEach(o),rr=n(Zo," for inference can be seen in "),Po=a(Zo,"A",{href:!0});var Gd=s(Po);ar=n(Gd,"TrOCR"),Gd.forEach(o),sr=n(Zo,"."),Zo.forEach(o),Xt=l(d),Q=a(d,"H2",{class:!0});var ln=s(Q);he=a(ln,"A",{id:!0,class:!0,href:!0});var Wd=s(he);st=a(Wd,"SPAN",{});var Ud=s(st);g(je.$$.fragment,Ud),Ud.forEach(o),Wd.forEach(o),dr=l(ln),dt=a(ln,"SPAN",{});var Hd=s(dt);ir=n(Hd,"VisionEncoderDecoderConfig"),Hd.forEach(o),ln.forEach(o),en=l(d),z=a(d,"DIV",{class:!0});var N=s(z);g(De.$$.fragment,N),cr=l(N),fe=a(N,"P",{});var Zt=s(fe);Fo=a(Zt,"A",{href:!0});var Zd=s(Fo);lr=n(Zd,"VisionEncoderDecoderConfig"),Zd.forEach(o),pr=n(Zt,` is the configuration class to store the configuration of a
...
configuration and decoder model configuration.`),mn.forEach(o),pn.forEach(o),Mr=l(N),ge=a(N,"DIV",{class:!0});var hn=s(ge);g(qe.$$.fragment,hn),Vr=l(hn),ee=a(hn,"P",{});var Jo=s(ee);$r=n(Jo,"Serializes this instance to a Python dictionary. Override the default "),ct=a(Jo,"EM",{});var ei=s(ct);qr=n(ei,"to_dict()"),ei.forEach(o),zr=n(Jo," from "),lt=a(Jo,"EM",{});var oi=s(lt);Pr=n(oi,"PretrainedConfig"),oi.forEach(o),Fr=n(Jo,"."),Jo.forEach(o),hn.forEach(o),N.forEach(o),on=l(d),oe=a(d,"H2",{class:!0});var fn=s(oe);_e=a(fn,"A",{id:!0,class:!0,href:!0});var ti=s(_e);pt=a(ti,"SPAN",{});var ni=s(pt);g(ze.$$.fragment,ni),ni.forEach(o),ti.forEach(o),Cr=l(fn),mt=a(fn,"SPAN",{});var ri=s(mt);Ar=n(ri,"VisionEncoderDecoderModel"),ri.forEach(o),fn.forEach(o),tn=l(d),E=a(d,"DIV",{class:!0});var V=s(E);g(Pe.$$.fragment,V),Sr=l(V),te=a(V,"P",{});var Ko=s(te);Ir=n(Ko,`This class can be used to initialize an image-to-text-sequence model with any pretrained vision autoencoding model
as the encoder and any pretrained text autoregressive model as the decoder. The encoder is loaded via
