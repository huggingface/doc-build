import{S as mm,i as fm,s as um,e as a,k as d,w as b,t as r,M as gm,c as n,d as t,m as c,a as s,x as w,h as i,b as l,F as e,g as m,y,q as $,o as x,B as F,v as _m}from"../../chunks/vendor-6b77c823.js";import{T as _e}from"../../chunks/Tip-39098574.js";import{D as W}from"../../chunks/Docstring-abef54e3.js";import{C as Ft}from"../../chunks/CodeBlock-3a8b25a8.js";import{I as ve}from"../../chunks/IconCopyLink-7a11ce68.js";function vm(I){let h,T,f,g,v;return{c(){h=a("p"),T=r(`This is a recently introduced model so the API hasn\u2019t been tested extensively. There may be some bugs or slight
...
PIL images.`),g.forEach(t)},m(f,g){m(f,h,g),e(h,T)},d(f){f&&t(h)}}}function bm(I){let h,T,f,g,v;return{c(){h=a("p"),T=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=a("code"),g=r("Module"),v=r(`
...
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),u.forEach(t)},m(_,u){m(_,h,u),e(h,T),e(h,f),e(f,g),e(h,v)},d(_){_&&t(h)}}}function wm(I){let h,T,f,g,v;return{c(){h=a("p"),T=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=a("code"),g=r("Module"),v=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(_){h=n(_,"P",{});var u=s(h);T=i(u,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=n(u,"CODE",{});var V=s(f);g=i(V,"Module"),V.forEach(t),v=i(u,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
the latter silently ignores them.`)},l(_){h=n(_,"P",{});var u=s(h);T=i(u,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=n(u,"CODE",{});var V=s(f);g=i(V,"Module"),V.forEach(t),v=i(u,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),u.forEach(t)},m(_,u){m(_,h,u),e(h,T),e(h,f),e(f,g),e(h,v)},d(_){_&&t(h)}}}function Im(I){let h,T,f,g,v,_,u,V,he,R,k,ie,j,B,oe,C,pe,ae,E,M,z,Me,ne,L,je,Te,Xo,tr,ss,Zo,Da,or,rs,Qo,ar,is,N,Vt,nr,Et,sr,rr,ir,Oa,lr,dr,kt,cr,Yo,hr,pr,mr,Pe,fr,Sa,ur,gr,It,_r,vr,Tr,Ce,br,Mt,wr,yr,jt,$r,xr,Fr,Ae,Vr,Pt,Er,kr,Ct,Ir,Mr,jr,Wa,Pr,ls,ea,Cr,ds,le,Ba,P,ta,Ar,qr,oa,zr,Nr,aa,Lr,Dr,Ua,Or,Sr,Ra,Wr,Br,Ha,Ur,Rr,Ja,Hr,Jr,na,Kr,Gr,Xr,Ka,sa,ra,Zr,Qr,Yr,Ga,At,ei,qt,ti,oi,ai,Xa,ia,la,ni,si,cs,be,ri,zt,ii,li,Nt,di,ci,hs,et,hi,Lt,pi,mi,ps,qe,tt,Za,Dt,fi,Qa,ui,ms,U,Ot,gi,ze,_i,da,vi,Ti,St,bi,wi,yi,Ne,$i,ca,xi,Fi,ha,Vi,Ei,ki,Ya,Ii,Mi,Wt,fs,Le,ot,en,Bt,ji,tn,Pi,us,se,Ut,Ci,on,Ai,qi,Rt,zi,pa,Ni,Li,Di,we,Ht,Oi,an,Si,Wi,at,gs,De,nt,nn,Jt,Bi,sn,Ui,_s,me,Kt,Ri,Gt,Hi,Xt,Ji,Ki,Gi,H,Zt,Xi,Oe,Zi,ma,Qi,Yi,rn,el,tl,ol,st,al,ln,nl,sl,Qt,vs,Se,rt,dn,Yt,rl,cn,il,Ts,fe,eo,ll,We,dl,hn,cl,hl,to,pl,ml,fl,J,oo,ul,Be,gl,fa,_l,vl,pn,Tl,bl,wl,it,yl,mn,$l,xl,ao,bs,Ue,lt,fn,no,Fl,un,Vl,ws,re,so,El,gn,kl,Il,ro,Ml,io,jl,Pl,Cl,K,lo,Al,Re,ql,ua,zl,Nl,_n,Ll,Dl,Ol,dt,Sl,vn,Wl,Bl,co,ys,He,ct,Tn,ho,Ul,bn,Rl,$s,D,po,Hl,wn,Jl,Kl,mo,Gl,ga,Xl,Zl,Ql,fo,Yl,uo,ed,td,od,ht,ad,G,go,nd,Je,sd,_a,rd,id,yn,ld,dd,cd,pt,hd,$n,pd,md,_o,xs,Ke,mt,xn,vo,fd,Fn,ud,Fs,O,To,gd,Vn,_d,vd,bo,Td,va,bd,wd,yd,wo,$d,yo,xd,Fd,Vd,ft,Ed,X,$o,kd,Ge,Id,Ta,Md,jd,En,Pd,Cd,Ad,ut,qd,kn,zd,Nd,xo,Vs,Xe,gt,In,Fo,Ld,Mn,Dd,Es,A,Vo,Od,jn,Sd,Wd,Eo,Bd,ba,Ud,Rd,Hd,ko,Jd,Io,Kd,Gd,Xd,Pn,Zd,Qd,ue,Cn,Mo,Yd,ec,An,jo,tc,oc,qn,Po,ac,nc,zn,Co,sc,rc,Z,Ao,ic,Ze,lc,Nn,dc,cc,Ln,hc,pc,mc,_t,fc,Dn,uc,gc,qo,ks,Qe,vt,On,zo,_c,Sn,vc,Is,q,No,Tc,Wn,bc,wc,Lo,yc,wa,$c,xc,Fc,Do,Vc,Oo,Ec,kc,Ic,Bn,Mc,jc,ge,Un,So,Pc,Cc,Rn,Wo,Ac,qc,Hn,Bo,zc,Nc,Jn,Uo,Lc,Dc,Q,Ro,Oc,Ye,Sc,Kn,Wc,Bc,Gn,Uc,Rc,Hc,Tt,Jc,Xn,Kc,Gc,Ho,Ms;return _=new ve({}),k=new _e({props:{$$slots:{default:[vm]},$$scope:{ctx:I}}}),C=new ve({}),Dt=new ve({}),Ot=new W({props:{name:"class transformers.ViTConfig",anchor:"transformers.ViTConfig",parameters:[{name:"hidden_size",val:" = 768"},{name:"num_hidden_layers",val:" = 12"},{name:"num_attention_heads",val:" = 12"},{name:"intermediate_size",val:" = 3072"},{name:"hidden_act",val:" = 'gelu'"},{name:"hidden_dropout_prob",val:" = 0.0"},{name:"attention_probs_dropout_prob",val:" = 0.0"},{name:"initializer_range",val:" = 0.02"},{name:"layer_norm_eps",val:" = 1e-12"},{name:"is_encoder_decoder",val:" = False"},{name:"image_size",val:" = 224"},{name:"patch_size",val:" = 16"},{name:"num_channels",val:" = 3"},{name:"qkv_bias",val:" = True"},{name:"encoder_stride",val:" = 16"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/vit/configuration_vit.py#L35",parametersDescription:[{anchor:"transformers.ViTConfig.hidden_size",description:`<strong>hidden_size</strong> (<code>int</code>, <em>optional</em>, defaults to 768) &#x2014;
...
`}}),st=new _e({props:{$$slots:{default:[bm]},$$scope:{ctx:I}}}),Qt=new Ft({props:{code:`from transformers import ViTFeatureExtractor, ViTModel
import torch
...
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-built_in">print</span>(<span class="hljs-string">&quot;Predicted class:&quot;</span>, model.config.id2label[predicted_class_idx.item()])`}}),{c(){h=a("meta"),T=d(),f=a("h1"),g=a("a"),v=a("span"),b(_.$$.fragment),u=d(),V=a("span"),he=r("Vision Transformer (ViT)"),R=d(),b(k.$$.fragment),ie=d(),j=a("h2"),B=a("a"),oe=a("span"),b(C.$$.fragment),pe=d(),ae=a("span"),E=r("Overview"),M=d(),z=a("p"),Me=r("The Vision Transformer (ViT) model was proposed in "),ne=a("a"),L=r(`An Image is Worth 16x16 Words: Transformers for Image Recognition
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Vd=d(),b(ft.$$.fragment),Ed=d(),X=a("div"),b($o.$$.fragment),kd=d(),Ge=a("p"),Id=r("The "),Ta=a("a"),Md=r("TFViTForImageClassification"),jd=r(" forward method, overrides the "),En=a("code"),Pd=r("__call__"),Cd=r(" special method."),Ad=d(),b(ut.$$.fragment),qd=d(),kn=a("p"),zd=r("Examples:"),Nd=d(),b(xo.$$.fragment),Vs=d(),Xe=a("h2"),gt=a("a"),In=a("span"),b(Fo.$$.fragment),Ld=d(),Mn=a("span"),Dd=r("FlaxVitModel"),Es=d(),A=a("div"),b(Vo.$$.fragment),Od=d(),jn=a("p"),Sd=r("The bare ViT Model transformer outputting raw hidden-states without any specific head on top."),Wd=d(),Eo=a("p"),Bd=r("This model inherits from "),ba=a("a"),Ud=r("FlaxPreTrainedModel"),Rd=r(`. Check the superclass documentation for the generic methods the
...
general usage and behavior.`),Xd=d(),Pn=a("p"),Zd=r("Finally, this model supports inherent JAX features such as:"),Qd=d(),ue=a("ul"),Cn=a("li"),Mo=a("a"),Yd=r("Just-In-Time (JIT) compilation"),ec=d(),An=a("li"),jo=a("a"),tc=r("Automatic Differentiation"),oc=d(),qn=a("li"),Po=a("a"),ac=r("Vectorization"),nc=d(),zn=a("li"),Co=a("a"),sc=r("Parallelization"),rc=d(),Z=a("div"),b(Ao.$$.fragment),ic=d(),Ze=a("p"),lc=r("The "),Nn=a("code"),dc=r("FlaxViTPreTrainedModel"),cc=r(" forward method, overrides the "),Ln=a("code"),hc=r("__call__"),pc=r(" special method."),mc=d(),b(_t.$$.fragment),fc=d(),Dn=a("p"),uc=r("Examples:"),gc=d(),b(qo.$$.fragment),ks=d(),Qe=a("h2"),vt=a("a"),On=a("span"),b(zo.$$.fragment),_c=d(),Sn=a("span"),vc=r("FlaxViTForImageClassification"),Is=d(),q=a("div"),b(No.$$.fragment),Tc=d(),Wn=a("p"),bc=r(`ViT Model transformer with an image classification head on top (a linear layer on top of the final hidden state of
...
resolution of 16x16 and fine-tuning resolution of 224x224. All checkpoints can be found on the `),It=n(ya,"A",{href:!0,rel:!0});var sh=s(It);_r=i(sh,"hub"),sh.forEach(t),vr=i(ya,"."),ya.forEach(t),Tr=c(Y),Ce=n(Y,"LI",{});var $a=s(Ce);br=i($a,"The available checkpoints are either (1) pre-trained on "),Mt=n($a,"A",{href:!0,rel:!0});var rh=s(Mt);wr=i(rh,"ImageNet-21k"),rh.forEach(t),yr=i($a,` (a collection of
...
found `),Nt=n(Fa,"A",{href:!0,rel:!0});var kh=s(Nt);di=i(kh,"here"),kh.forEach(t),ci=i(Fa,"."),Fa.forEach(t),hs=c(o),et=n(o,"P",{});var As=s(et);hi=i(As,"Note that we converted the weights from Ross Wightman\u2019s "),Lt=n(As,"A",{href:!0,rel:!0});var Ih=s(Lt);pi=i(Ih,"timm library"),Ih.forEach(t),mi=i(As,`, who already converted the weights from JAX to PyTorch. Credits
go to him!`),As.forEach(t),ps=c(o),qe=n(o,"H2",{class:!0});var qs=s(qe);tt=n(qs,"A",{id:!0,class:!0,href:!0});var Mh=s(tt);Za=n(Mh,"SPAN",{});var jh=s(Za);w(Dt.$$.fragment,jh),jh.forEach(t),Mh.forEach(t),fi=c(qs),Qa=n(qs,"SPAN",{});var Ph=s(Qa);ui=i(Ph,"ViTConfig"),Ph.forEach(t),qs.forEach(t),ms=c(o),U=n(o,"DIV",{class:!0});var ye=s(U);w(Ot.$$.fragment,ye),gi=c(ye),ze=n(ye,"P",{});var Va=s(ze);_i=i(Va,"This is the configuration class to store the configuration of a "),da=n(Va,"A",{href:!0});var Ch=s(da);vi=i(Ch,"ViTModel"),Ch.forEach(t),Ti=i(Va,`. It is used to instantiate an ViT
model according to the specified arguments, defining the model architecture. Instantiating a configuration with the
defaults will yield a similar configuration to that of the ViT
