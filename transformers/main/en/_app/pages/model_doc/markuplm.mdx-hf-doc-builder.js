import{S as N2,i as S2,s as B2,e as a,k as l,w as k,t as o,M as R2,c as r,d as t,m as d,a as i,x as v,h as n,b as c,N as W2,G as e,g as u,y as b,q as M,o as w,B as y,v as U2,L as Qs}from"../../chunks/vendor-hf-doc-builder.js";import{T as vc}from"../../chunks/Tip-hf-doc-builder.js";import{D as z}from"../../chunks/Docstring-hf-doc-builder.js";import{C as Te}from"../../chunks/CodeBlock-hf-doc-builder.js";import{I as xe}from"../../chunks/IconCopyLink-hf-doc-builder.js";import{E as Vs}from"../../chunks/ExampleCodeBlock-hf-doc-builder.js";function H2(P){let m,T,_,g,x;return g=new Te({props:{code:`from transformers import MarkupLMModel, MarkupLMConfig
...
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),f.forEach(t)},m(p,f){u(p,m,f),e(m,T),e(m,_),e(_,g),e(m,x)},d(p){p&&t(m)}}}function X2(P){let m,T,_,g,x;return g=new Te({props:{code:`from transformers import MarkupLMProcessor, MarkupLMModel
...
[<span class="hljs-number">1</span>, <span class="hljs-number">4</span>, <span class="hljs-number">768</span>]`}}),{c(){m=a("p"),T=o("Examples:"),_=l(),k(g.$$.fragment)},l(p){m=r(p,"P",{});var f=i(m);T=n(f,"Examples:"),f.forEach(t),_=d(p),v(g.$$.fragment,p)},m(p,f){u(p,m,f),e(m,T),u(p,_,f),b(g,p,f),x=!0},p:Qs,i(p){x||(M(g.$$.fragment,p),x=!0)},o(p){w(g.$$.fragment,p),x=!1},d(p){p&&t(m),p&&t(_),y(g,p)}}}function G2(P){let m,T,_,g,x;return{c(){m=a("p"),T=o("Although the recipe for forward pass needs to be defined within this function, one should call the "),_=a("code"),g=o("Module"),x=o(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(p){m=r(p,"P",{});var f=i(m);T=n(f,"Although the recipe for forward pass needs to be defined within this function, one should call the "),_=r(f,"CODE",{});var G=i(_);g=n(G,"Module"),G.forEach(t),x=n(f,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),f.forEach(t)},m(p,f){u(p,m,f),e(m,T),e(m,_),e(_,g),e(m,x)},d(p){p&&t(m)}}}function K2(P){let m,T,_,g,x;return g=new Te({props:{code:`from transformers import AutoProcessor, AutoModelForSequenceClassification
import torch
...
<span class="hljs-meta">&gt;&gt;&gt; </span>logits = outputs.logits`}}),{c(){m=a("p"),T=o("Examples:"),_=l(),k(g.$$.fragment)},l(p){m=r(p,"P",{});var f=i(m);T=n(f,"Examples:"),f.forEach(t),_=d(p),v(g.$$.fragment,p)},m(p,f){u(p,m,f),e(m,T),u(p,_,f),b(g,p,f),x=!0},p:Qs,i(p){x||(M(g.$$.fragment,p),x=!0)},o(p){w(g.$$.fragment,p),x=!1},d(p){p&&t(m),p&&t(_),y(g,p)}}}function Y2(P){let m,T,_,g,x;return{c(){m=a("p"),T=o("Although the recipe for forward pass needs to be defined within this function, one should call the "),_=a("code"),g=o("Module"),x=o(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(p){m=r(p,"P",{});var f=i(m);T=n(f,"Although the recipe for forward pass needs to be defined within this function, one should call the "),_=r(f,"CODE",{});var G=i(_);g=n(G,"Module"),G.forEach(t),x=n(f,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),f.forEach(t)},m(p,f){u(p,m,f),e(m,T),e(m,_),e(_,g),e(m,x)},d(p){p&&t(m)}}}function J2(P){let m,T,_,g,x;return g=new Te({props:{code:`from transformers import AutoProcessor, AutoModelForTokenClassification
import torch
...
<span class="hljs-meta">&gt;&gt;&gt; </span>loss = outputs.loss
<span class="hljs-meta">&gt;&gt;&gt; </span>logits = outputs.logits`}}),{c(){m=a("p"),T=o("Examples:"),_=l(),k(g.$$.fragment)},l(p){m=r(p,"P",{});var f=i(m);T=n(f,"Examples:"),f.forEach(t),_=d(p),v(g.$$.fragment,p)},m(p,f){u(p,m,f),e(m,T),u(p,_,f),b(g,p,f),x=!0},p:Qs,i(p){x||(M(g.$$.fragment,p),x=!0)},o(p){w(g.$$.fragment,p),x=!1},d(p){p&&t(m),p&&t(_),y(g,p)}}}function Z2(P){let m,T,_,g,x;return{c(){m=a("p"),T=o("Although the recipe for forward pass needs to be defined within this function, one should call the "),_=a("code"),g=o("Module"),x=o(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(p){m=r(p,"P",{});var f=i(m);T=n(f,"Although the recipe for forward pass needs to be defined within this function, one should call the "),_=r(f,"CODE",{});var G=i(_);g=n(G,"Module"),G.forEach(t),x=n(f,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
<p><a
  href="/docs/transformers/main/en/main_classes/feature_extractor#transformers.BatchFeature"
>BatchFeature</a></p>
`}}),_t=new Vs({props:{anchor:"transformers.MarkupLMFeatureExtractor.__call__.example",$$slots:{default:[V2]},$$scope:{ctx:P}}}),jo=new xe({}),Co=new z({props:{name:"class transformers.MarkupLMTokenizer",anchor:"transformers.MarkupLMTokenizer",parameters:[{name:"vocab_file",val:""},{name:"merges_file",val:""},{name:"tags_dict",val:""},{name:"errors",val:" = 'replace'"},{name:"bos_token",val:" = '<s>'"},{name:"eos_token",val:" = '</s>'"},{name:"sep_token",val:" = '</s>'"},{name:"cls_token",val:" = '<s>'"},{name:"unk_token",val:" = '<unk>'"},{name:"pad_token",val:" = '<pad>'"},{name:"mask_token",val:" = '<mask>'"},{name:"add_prefix_space",val:" = False"},{name:"max_depth",val:" = 50"},{name:"max_width",val:" = 1000"},{name:"pad_width",val:" = 1001"},{name:"pad_token_label",val:" = -100"},{name:"only_label_first_subword",val:" = True"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.MarkupLMTokenizer.vocab_file",description:`<strong>vocab_file</strong> (<code>str</code>) &#x2014;
...
configuration. Check out the <a href="/docs/transformers/main/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/markuplm/modeling_markuplm.py#L807"}}),nn=new z({props:{name:"forward",anchor:"transformers.MarkupLMModel.forward",parameters:[{name:"input_ids",val:" = None"},{name:"xpath_tags_seq",val:" = None"},{name:"xpath_subs_seq",val:" = None"},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],parametersDescription:[{anchor:"transformers.MarkupLMModel.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
...
`}}),St=new vc({props:{$$slots:{default:[Q2]},$$scope:{ctx:P}}}),Bt=new Vs({props:{anchor:"transformers.MarkupLMModel.forward.example",$$slots:{default:[X2]},$$scope:{ctx:P}}}),sn=new xe({}),an=new z({props:{name:"class transformers.MarkupLMForSequenceClassification",anchor:"transformers.MarkupLMForSequenceClassification",parameters:[{name:"config",val:""}],parametersDescription:[{anchor:"transformers.MarkupLMForSequenceClassification.config",description:`<strong>config</strong> (<a href="/docs/transformers/main/en/model_doc/markuplm#transformers.MarkupLMConfig">MarkupLMConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/main/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/markuplm/modeling_markuplm.py#L1200"}}),dn=new z({props:{name:"forward",anchor:"transformers.MarkupLMForSequenceClassification.forward",parameters:[{name:"input_ids",val:": typing.Optional[torch.Tensor] = None"},{name:"xpath_tags_seq",val:": typing.Optional[torch.Tensor] = None"},{name:"xpath_subs_seq",val:": typing.Optional[torch.Tensor] = None"},{name:"attention_mask",val:": typing.Optional[torch.Tensor] = None"},{name:"token_type_ids",val:": typing.Optional[torch.Tensor] = None"},{name:"position_ids",val:": typing.Optional[torch.Tensor] = None"},{name:"head_mask",val:": typing.Optional[torch.Tensor] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.Tensor] = None"},{name:"labels",val:": typing.Optional[torch.Tensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.MarkupLMForSequenceClassification.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/main/en/model_doc/markuplm#transformers.MarkupLMTokenizer">MarkupLMTokenizer</a>. See <a href="/docs/transformers/main/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/main/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/markuplm/modeling_markuplm.py#L1217",returnDescription:`
<p>A <a
...
`}}),Wt=new vc({props:{$$slots:{default:[G2]},$$scope:{ctx:P}}}),Ut=new Vs({props:{anchor:"transformers.MarkupLMForSequenceClassification.forward.example",$$slots:{default:[K2]},$$scope:{ctx:P}}}),cn=new xe({}),pn=new z({props:{name:"class transformers.MarkupLMForTokenClassification",anchor:"transformers.MarkupLMForTokenClassification",parameters:[{name:"config",val:""}],parametersDescription:[{anchor:"transformers.MarkupLMForTokenClassification.config",description:`<strong>config</strong> (<a href="/docs/transformers/main/en/model_doc/markuplm#transformers.MarkupLMConfig">MarkupLMConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/main/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/markuplm/modeling_markuplm.py#L1094"}}),un=new z({props:{name:"forward",anchor:"transformers.MarkupLMForTokenClassification.forward",parameters:[{name:"input_ids",val:": typing.Optional[torch.Tensor] = None"},{name:"xpath_tags_seq",val:": typing.Optional[torch.Tensor] = None"},{name:"xpath_subs_seq",val:": typing.Optional[torch.Tensor] = None"},{name:"attention_mask",val:": typing.Optional[torch.Tensor] = None"},{name:"token_type_ids",val:": typing.Optional[torch.Tensor] = None"},{name:"position_ids",val:": typing.Optional[torch.Tensor] = None"},{name:"head_mask",val:": typing.Optional[torch.Tensor] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.Tensor] = None"},{name:"labels",val:": typing.Optional[torch.Tensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.MarkupLMForTokenClassification.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/main/en/model_doc/markuplm#transformers.MarkupLMTokenizer">MarkupLMTokenizer</a>. See <a href="/docs/transformers/main/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/main/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/markuplm/modeling_markuplm.py#L1110",returnDescription:`
<p>A <a
...
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/markuplm/modeling_markuplm.py#L986",returnDescription:`
<p>A <a
...
`}}),Gt=new vc({props:{$$slots:{default:[Z2]},$$scope:{ctx:P}}}),Kt=new Vs({props:{anchor:"transformers.MarkupLMForQuestionAnswering.forward.example",$$slots:{default:[ex]},$$scope:{ctx:P}}}),{c(){m=a("meta"),T=l(),_=a("h1"),g=a("a"),x=a("span"),k(p.$$.fragment),f=l(),G=a("span"),bc=o("MarkupLM"),Jl=l(),Se=a("h2"),ct=a("a"),Xs=a("span"),k(ro.$$.fragment),Mc=l(),Gs=a("span"),wc=o("Overview"),Zl=l(),qe=a("p"),yc=o("The MarkupLM model was proposed in "),io=a("a"),xc=o(`MarkupLM: Pre-training of Text and Markup Language for Visually-rich Document
...
documentation from `),ts=r(Cs,"A",{href:!0});var ZM=i(ts);Ih=n(ZM,"BertConfig"),ZM.forEach(t),Nh=n(Cs," for more information."),Cs.forEach(t),Sh=d(Yt),v(ft.$$.fragment,Yt),Yt.forEach(t),jd=d(s),Ve=r(s,"H2",{class:!0});var Zd=i(Ve);gt=r(Zd,"A",{id:!0,class:!0,href:!0});var e1=i(gt);xa=r(e1,"SPAN",{});var t1=i(xa);v(qo.$$.fragment,t1),t1.forEach(t),e1.forEach(t),Bh=d(Zd),Ta=r(Zd,"SPAN",{});var o1=i(Ta);Rh=n(o1,"MarkupLMFeatureExtractor"),o1.forEach(t),Zd.forEach(t),Cd=d(s),pe=r(s,"DIV",{class:!0});var Jt=i(pe);v($o.$$.fragment,Jt),Wh=d(Jt),Ea=r(Jt,"P",{});var n1=i(Ea);Uh=n(n1,`Constructs a MarkupLM feature extractor. This can be used to get a list of nodes and corresponding xpaths from HTML
...
Users should refer to this superclass for more information regarding those methods.`),ee.forEach(t),_u=d(we),Pe=r(we,"DIV",{class:!0});var Ds=i(Pe);v(Po.$$.fragment,Ds),ku=d(Ds),Oa=r(Ds,"P",{});var g1=i(Oa);vu=n(g1,`Build model inputs from a sequence or a pair of sequence for sequence classification tasks by concatenating and
adding special tokens. A RoBERTa sequence has the following format:`),g1.forEach(t),bu=d(Ds),Do=r(Ds,"UL",{});var oc=i(Do);ss=r(oc,"LI",{});var jb=i(ss);Mu=n(jb,"single sequence: "),Aa=r(jb,"CODE",{});var _1=i(Aa);wu=n(_1,"<s> X </s>"),_1.forEach(t),jb.forEach(t),yu=d(oc),as=r(oc,"LI",{});var Cb=i(as);xu=n(Cb,"pair of sequences: "),Ia=r(Cb,"CODE",{});var k1=i(Ia);Tu=n(k1,"<s> A </s></s> B </s>"),k1.forEach(t),Cb.forEach(t),oc.forEach(t),Ds.forEach(t),Eu=d(we),rs=r(we,"DIV",{class:!0});var v1=i(rs);v(Oo.$$.fragment,v1),v1.forEach(t),Lu=d(we),vt=r(we,"DIV",{class:!0});var nc=i(vt);v(Ao.$$.fragment,nc),qu=d(nc),Na=r(nc,"P",{});var b1=i(Na);$u=n(b1,`Create a mask from the two sequences passed to be used in a sequence-pair classification task. RoBERTa does not
make use of token type ids, therefore a list of zeros is returned.`),b1.forEach(t),nc.forEach(t),Fu=d(we),is=r(we,"DIV",{class:!0});var M1=i(is);v(Io.$$.fragment,M1),M1.forEach(t),we.forEach(t),Od=d(s),Xe=r(s,"H2",{class:!0});var sc=i(Xe);bt=r(sc,"A",{id:!0,class:!0,href:!0});var w1=i(bt);Sa=r(w1,"SPAN",{});var y1=i(Sa);v(No.$$.fragment,y1),y1.forEach(t),w1.forEach(t),zu=d(sc),Ba=r(sc,"SPAN",{});var x1=i(Ba);ju=n(x1,"MarkupLMTokenizerFast"),x1.forEach(t),sc.forEach(t),Ad=d(s),j=r(s,"DIV",{class:!0});var H=i(j);v(So.$$.fragment,H),Cu=d(H),Ra=r(H,"P",{});var T1=i(Ra);Pu=n(T1,"Construct a MarkupLM tokenizer. Based on byte-level Byte-Pair-Encoding (BPE)."),T1.forEach(t),Du=d(H),B=r(H,"P",{});var ne=i(B);ls=r(ne,"A",{href:!0});var E1=i(ls);Ou=n(E1,"MarkupLMTokenizerFast"),E1.forEach(t),Au=n(ne," can be used to turn HTML strings into to token-level "),Wa=r(ne,"CODE",{});var L1=i(Wa);Iu=n(L1,"input_ids"),L1.forEach(t),Nu=n(ne,", "),Ua=r(ne,"CODE",{});var q1=i(Ua);Su=n(q1,"attention_mask"),q1.forEach(t),Bu=n(ne,`,
...
contains most of the main methods.`),ne.forEach(t),Ku=d(H),Xa=r(H,"P",{});var C1=i(Xa);Yu=n(C1,"Users should refer to this superclass for more information regarding those methods."),C1.forEach(t),Ju=d(H),R=r(H,"DIV",{class:!0});var re=i(R);v(Bo.$$.fragment,re),Zu=d(re),O=r(re,"P",{});var V=i(O);em=n(V,"add_special_tokens ("),Ga=r(V,"CODE",{});var P1=i(Ga);tm=n(P1,"bool"),P1.forEach(t),om=n(V,", "),Ka=r(V,"EM",{});var D1=i(Ka);nm=n(D1,"optional"),D1.forEach(t),sm=n(V,", defaults to "),Ya=r(V,"CODE",{});var O1=i(Ya);am=n(O1,"True"),O1.forEach(t),rm=n(V,`):
Whether or not to encode the sequences with the special tokens relative to their model.
padding (`),Ja=r(V,"CODE",{});var A1=i(Ja);im=n(A1,"bool"),A1.forEach(t),lm=n(V,", "),Za=r(V,"CODE",{});var I1=i(Za);dm=n(I1,"str"),I1.forEach(t),cm=n(V," or "),cs=r(V,"A",{href:!0});var N1=i(cs);pm=n(N1,"PaddingStrategy"),N1.forEach(t),hm=n(V,", "),er=r(V,"EM",{});var S1=i(er);um=n(S1,"optional"),S1.forEach(t),mm=n(V,", defaults to "),tr=r(V,"CODE",{});var B1=i(tr);fm=n(B1,"False"),B1.forEach(t),gm=n(V,`):
Activates and controls padding. Accepts the following values:`),V.forEach(t),_m=d(re),Y=r(re,"UL",{});var ie=i(Y);or=r(ie,"LI",{});var R1=i(or);Mt=r(R1,"P",{});var Il=i(Mt);nr=r(Il,"CODE",{});var W1=i(nr);km=n(W1,"True"),W1.forEach(t),vm=n(Il," or "),sr=r(Il,"CODE",{});var U1=i(sr);bm=n(U1,"'longest'"),U1.forEach(t),Mm=n(Il,`: Pad to the longest sequence in the batch (or no padding if only a single
sequence if provided).`),Il.forEach(t),R1.forEach(t),wm=d(ie),ar=r(ie,"LI",{});var H1=i(ar);wt=r(H1,"P",{});var Nl=i(wt);rr=r(Nl,"CODE",{});var V1=i(rr);ym=n(V1,"'max_length'"),V1.forEach(t),xm=n(Nl,": Pad to a maximum length specified with the argument "),ir=r(Nl,"CODE",{});var Q1=i(ir);Tm=n(Q1,"max_length"),Q1.forEach(t),Em=n(Nl,` or to the maximum
...
lengths).
truncation (`),pr=r(se,"CODE",{});var Y1=i(pr);jm=n(Y1,"bool"),Y1.forEach(t),Cm=n(se,", "),hr=r(se,"CODE",{});var J1=i(hr);Pm=n(J1,"str"),J1.forEach(t),Dm=n(se," or "),ps=r(se,"A",{href:!0});var Z1=i(ps);Om=n(Z1,"TruncationStrategy"),Z1.forEach(t),Am=n(se,", "),ur=r(se,"EM",{});var ew=i(ur);Im=n(ew,"optional"),ew.forEach(t),Nm=n(se,", defaults to "),mr=r(se,"CODE",{});var tw=i(mr);Sm=n(tw,"False"),tw.forEach(t),Bm=n(se,`):
...
returned to provide some overlap between truncated and overflowing sequences. The value of this
argument defines the number of overlapping tokens.
is_split_into_words (`),Dr=r(q,"CODE",{});var ww=i(Dr);Lf=n(ww,"bool"),ww.forEach(t),qf=n(q,", "),Or=r(q,"EM",{});var yw=i(Or);$f=n(yw,"optional"),yw.forEach(t),Ff=n(q,", defaults to "),Ar=r(q,"CODE",{});var xw=i(Ar);zf=n(xw,"False"),xw.forEach(t),jf=n(q,`):
Whether or not the input is already pre-tokenized (e.g., split into words). If set to `),Ir=r(q,"CODE",{});var Tw=i(Ir);Cf=n(Tw,"True"),Tw.forEach(t),Pf=n(q,`, the
tokenizer assumes the input is already split into words (for instance, by splitting it on whitespace)
which it will tokenize. This is useful for NER or token classification.
pad_to_multiple_of (`),Nr=r(q,"CODE",{});var Ew=i(Nr);Df=n(Ew,"int"),Ew.forEach(t),Of=n(q,", "),Sr=r(q,"EM",{});var Lw=i(Sr);Af=n(Lw,"optional"),Lw.forEach(t),If=n(q,`):
If set will pad the sequence to a multiple of the provided value. This is especially useful to enable
the use of Tensor Cores on NVIDIA hardware with compute capability >= 7.5 (Volta).
