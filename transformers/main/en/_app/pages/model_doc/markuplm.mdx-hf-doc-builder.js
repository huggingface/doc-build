...
returned to provide some overlap between truncated and overflowing sequences. The value of this
argument defines the number of overlapping tokens.
pad_to_multiple_of (`),Di=r($,"CODE",{});var Ty=i(Di);z_=n(Ty,"int"),Ty.forEach(t),j_=n($,", "),Ai=r($,"EM",{});var Ey=i(Ai);C_=n(Ey,"optional"),Ey.forEach(t),P_=n($,`):
If set will pad the sequence to a multiple of the provided value. This is especially useful to enable
the use of Tensor Cores on NVIDIA hardware with compute capability >= 7.5 (Volta).
return_tensors (`),Ii=r($,"CODE",{});var Ly=i(Ii);D_=n(Ly,"str"),Ly.forEach(t),A_=n($," or "),fs=r($,"A",{href:!0});var qy=i(fs);I_=n(qy,"TensorType"),qy.forEach(t),O_=n($,", "),Oi=r($,"EM",{});var $y=i(Oi);N_=n($y,"optional"),$y.forEach(t),S_=n($,`):
If set, will return tensors instead of list of python integers. Acceptable values are:`),$.forEach(t),fy.forEach(t),B_=d(N),Ni=r(N,"LI",{});var Fy=i(Ni);jt=r(Fy,"P",{});var Gl=i(jt);Si=r(Gl,"CODE",{});var zy=i(Si);R_=n(zy,"'tf'"),zy.forEach(t),W_=n(Gl,": Return TensorFlow "),Bi=r(Gl,"CODE",{});var jy=i(Bi);U_=n(jy,"tf.constant"),jy.forEach(t),H_=n(Gl," objects."),Gl.forEach(t),Fy.forEach(t),V_=d(N),Ri=r(N,"LI",{});var Cy=i(Ri);Ct=r(Cy,"P",{});var Kl=i(Ct);Wi=r(Kl,"CODE",{});var Py=i(Wi);Q_=n(Py,"'pt'"),Py.forEach(t),X_=n(Kl,": Return PyTorch "),Ui=r(Kl,"CODE",{});var Dy=i(Ui);G_=n(Dy,"torch.Tensor"),Dy.forEach(t),K_=n(Kl," objects."),Kl.forEach(t),Cy.forEach(t),Y_=d(N),Hi=r(N,"LI",{});var Ay=i(Hi);Pt=r(Ay,"P",{});var Yl=i(Pt);Vi=r(Yl,"CODE",{});var Iy=i(Vi);J_=n(Iy,"'np'"),Iy.forEach(t),Z_=n(Yl,": Return Numpy "),Qi=r(Yl,"CODE",{});var Oy=i(Qi);ek=n(Oy,"np.ndarray"),Oy.forEach(t),tk=n(Yl," objects."),Yl.forEach(t),Ay.forEach(t),N.forEach(t),re.forEach(t),ok=d(H),Ie=r(H,"DIV",{class:!0});var Is=i(Ie);v(Ro.$$.fragment,Is),nk=d(Is),Xi=r(Is,"P",{});var Ny=i(Xi);sk=n(Ny,`Build model inputs from a sequence or a pair of sequence for sequence classification tasks by concatenating and
adding special tokens. A RoBERTa sequence has the following format:`),Ny.forEach(t),ak=d(Is),Wo=r(Is,"UL",{});var ac=i(Wo);gs=r(ac,"LI",{});var Pb=i(gs);rk=n(Pb,"single sequence: "),Gi=r(Pb,"CODE",{});var Sy=i(Gi);ik=n(Sy,"<s> X </s>"),Sy.forEach(t),Pb.forEach(t),lk=d(ac),_s=r(ac,"LI",{});var Db=i(_s);dk=n(Db,"pair of sequences: "),Ki=r(Db,"CODE",{});var By=i(Ki);ck=n(By,"<s> A </s></s> B </s>"),By.forEach(t),Db.forEach(t),ac.forEach(t),Is.forEach(t),pk=d(H),Dt=r(H,"DIV",{class:!0});var rc=i(Dt);v(Uo.$$.fragment,rc),hk=d(rc),Yi=r(rc,"P",{});var Ry=i(Yi);uk=n(Ry,`Create a mask from the two sequences passed to be used in a sequence-pair classification task. RoBERTa does not
make use of token type ids, therefore a list of zeros is returned.`),Ry.forEach(t),rc.forEach(t),mk=d(H),At=r(H,"DIV",{class:!0});var ic=i(At);v(Ho.$$.fragment,ic),fk=d(ic),Vo=r(ic,"P",{});var lc=i(Vo);gk=n(lc,`Tokenize and prepare for the model a sequence or a pair of sequences. .. warning:: This method is deprecated,
`),Ji=r(lc,"CODE",{});var Wy=i(Ji);_k=n(Wy,"__call__"),Wy.forEach(t),kk=n(lc," should be used instead."),lc.forEach(t),ic.forEach(t),vk=d(H),It=r(H,"DIV",{class:!0});var dc=i(It);v(Qo.$$.fragment,dc),bk=d(dc),Zi=r(dc,"P",{});var Uy=i(Zi);Mk=n(Uy,`Given the xpath expression of one particular node (like \u201C/html/body/div/li[1]/div/span[2]\u201D), return a list of
tag IDs and corresponding subscripts, taking into account max depth.`),Uy.forEach(t),dc.forEach(t),H.forEach(t),Od=d(s),Ke=r(s,"H2",{class:!0});var cc=i(Ke);Ot=r(cc,"A",{id:!0,class:!0,href:!0});var Hy=i(Ot);el=r(Hy,"SPAN",{});var Vy=i(el);v(Xo.$$.fragment,Vy),Vy.forEach(t),Hy.forEach(t),wk=d(cc),tl=r(cc,"SPAN",{});var Qy=i(tl);yk=n(Qy,"MarkupLMProcessor"),Qy.forEach(t),cc.forEach(t),Nd=d(s),te=r(s,"DIV",{class:!0});var Ne=i(te);v(Go.$$.fragment,Ne),xk=d(Ne),ol=r(Ne,"P",{});var Xy=i(ol);Tk=n(Xy,`Constructs a MarkupLM processor which combines a MarkupLM feature extractor and a MarkupLM tokenizer into a single
processor.`),Xy.forEach(t),Ek=d(Ne),ks=r(Ne,"P",{});var Ab=i(ks);vs=r(Ab,"A",{href:!0});var Gy=i(vs);Lk=n(Gy,"MarkupLMProcessor"),Gy.forEach(t),qk=n(Ab," offers all the functionalities you need to prepare data for the model."),Ab.forEach(t),$k=d(Ne),O=r(Ne,"P",{});var X=i(O);Fk=n(X,"It first uses "),bs=r(X,"A",{href:!0});var Ky=i(bs);zk=n(Ky,"MarkupLMFeatureExtractor"),Ky.forEach(t),jk=n(X,` to extract nodes and corresponding xpaths from one or more HTML strings.
Next, these are provided to `),Ms=r(X,"A",{href:!0});var Yy=i(Ms);Ck=n(Yy,"MarkupLMTokenizer"),Yy.forEach(t),Pk=n(X," or "),ws=r(X,"A",{href:!0});var Jy=i(ws);Dk=n(Jy,"MarkupLMTokenizerFast"),Jy.forEach(t),Ak=n(X,`, which turns them into token-level
`),nl=r(X,"CODE",{});var Zy=i(nl);Ik=n(Zy,"input_ids"),Zy.forEach(t),Ok=n(X,", "),sl=r(X,"CODE",{});var e2=i(sl);Nk=n(e2,"attention_mask"),e2.forEach(t),Sk=n(X,", "),al=r(X,"CODE",{});var t2=i(al);Bk=n(t2,"token_type_ids"),t2.forEach(t),Rk=n(X,", "),rl=r(X,"CODE",{});var o2=i(rl);Wk=n(o2,"xpath_tags_seq"),o2.forEach(t),Uk=n(X," and "),il=r(X,"CODE",{});var n2=i(il);Hk=n(n2,"xpath_subs_seq"),n2.forEach(t),Vk=n(X,"."),X.forEach(t),Qk=d(Ne),fe=r(Ne,"DIV",{class:!0});var Zt=i(fe);v(Ko.$$.fragment,Zt),Xk=d(Zt),oe=r(Zt,"P",{});var ye=i(oe);Gk=n(ye,"This method first forwards the "),ll=r(ye,"CODE",{});var s2=i(ll);Kk=n(s2,"html_strings"),s2.forEach(t),Yk=n(ye," argument to "),Yo=r(ye,"A",{href:!0});var Ib=i(Yo);dl=r(Ib,"STRONG",{});var a2=i(dl);Jk=n(a2,"call"),a2.forEach(t),Zk=n(Ib,"()"),Ib.forEach(t),ev=n(ye,`. Next, it
