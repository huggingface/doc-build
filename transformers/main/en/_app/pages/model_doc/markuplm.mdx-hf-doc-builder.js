import{S as Ny,i as Sy,s as Ry,e as a,k as l,w as k,t as o,M as By,c as r,d as t,m as d,a as i,x as v,h as n,b as c,N as Wy,G as e,g as m,y as b,q as M,o as w,B as y,v as Uy,L as Qs}from"../../chunks/vendor-hf-doc-builder.js";import{T as vc}from"../../chunks/Tip-hf-doc-builder.js";import{D as z}from"../../chunks/Docstring-hf-doc-builder.js";import{C as Te}from"../../chunks/CodeBlock-hf-doc-builder.js";import{I as xe}from"../../chunks/IconCopyLink-hf-doc-builder.js";import{E as Vs}from"../../chunks/ExampleCodeBlock-hf-doc-builder.js";function Hy(P){let u,T,_,g,x;return g=new Te({props:{code:`from transformers import MarkupLMModel, MarkupLMConfig
...
<span class="hljs-meta">&gt;&gt;&gt; </span>configuration = model.config`}}),{c(){u=a("p"),T=o("Examples:"),_=l(),k(g.$$.fragment)},l(p){u=r(p,"P",{});var f=i(u);T=n(f,"Examples:"),f.forEach(t),_=d(p),v(g.$$.fragment,p)},m(p,f){m(p,u,f),e(u,T),m(p,_,f),b(g,p,f),x=!0},p:Qs,i(p){x||(M(g.$$.fragment,p),x=!0)},o(p){w(g.$$.fragment,p),x=!1},d(p){p&&t(u),p&&t(_),y(g,p)}}}function Vy(P){let u,T,_,g,x;return g=new Te({props:{code:`from transformers import MarkupLMFeatureExtractor
...
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-built_in">print</span>(encoding.keys())
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-comment"># dict_keys([&#x27;nodes&#x27;, &#x27;xpaths&#x27;])</span>`}}),{c(){u=a("p"),T=o("Examples:"),_=l(),k(g.$$.fragment)},l(p){u=r(p,"P",{});var f=i(u);T=n(f,"Examples:"),f.forEach(t),_=d(p),v(g.$$.fragment,p)},m(p,f){m(p,u,f),e(u,T),m(p,_,f),b(g,p,f),x=!0},p:Qs,i(p){x||(M(g.$$.fragment,p),x=!0)},o(p){w(g.$$.fragment,p),x=!1},d(p){p&&t(u),p&&t(_),y(g,p)}}}function Qy(P){let u,T,_,g,x;return{c(){u=a("p"),T=o("Although the recipe for forward pass needs to be defined within this function, one should call the "),_=a("code"),g=o("Module"),x=o(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(p){u=r(p,"P",{});var f=i(u);T=n(f,"Although the recipe for forward pass needs to be defined within this function, one should call the "),_=r(f,"CODE",{});var G=i(_);g=n(G,"Module"),G.forEach(t),x=n(f,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),f.forEach(t)},m(p,f){m(p,u,f),e(u,T),e(u,_),e(_,g),e(u,x)},d(p){p&&t(u)}}}function Xy(P){let u,T,_,g,x;return g=new Te({props:{code:`from transformers import MarkupLMProcessor, MarkupLMModel
...
[<span class="hljs-number">1</span>, <span class="hljs-number">4</span>, <span class="hljs-number">768</span>]`}}),{c(){u=a("p"),T=o("Examples:"),_=l(),k(g.$$.fragment)},l(p){u=r(p,"P",{});var f=i(u);T=n(f,"Examples:"),f.forEach(t),_=d(p),v(g.$$.fragment,p)},m(p,f){m(p,u,f),e(u,T),m(p,_,f),b(g,p,f),x=!0},p:Qs,i(p){x||(M(g.$$.fragment,p),x=!0)},o(p){w(g.$$.fragment,p),x=!1},d(p){p&&t(u),p&&t(_),y(g,p)}}}function Gy(P){let u,T,_,g,x;return{c(){u=a("p"),T=o("Although the recipe for forward pass needs to be defined within this function, one should call the "),_=a("code"),g=o("Module"),x=o(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(p){u=r(p,"P",{});var f=i(u);T=n(f,"Although the recipe for forward pass needs to be defined within this function, one should call the "),_=r(f,"CODE",{});var G=i(_);g=n(G,"Module"),G.forEach(t),x=n(f,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),f.forEach(t)},m(p,f){m(p,u,f),e(u,T),e(u,_),e(_,g),e(u,x)},d(p){p&&t(u)}}}function Ky(P){let u,T,_,g,x;return g=new Te({props:{code:`from transformers import AutoProcessor, AutoModelForSequenceClassification
import torch
...
<span class="hljs-meta">&gt;&gt;&gt; </span>logits = outputs.logits`}}),{c(){u=a("p"),T=o("Examples:"),_=l(),k(g.$$.fragment)},l(p){u=r(p,"P",{});var f=i(u);T=n(f,"Examples:"),f.forEach(t),_=d(p),v(g.$$.fragment,p)},m(p,f){m(p,u,f),e(u,T),m(p,_,f),b(g,p,f),x=!0},p:Qs,i(p){x||(M(g.$$.fragment,p),x=!0)},o(p){w(g.$$.fragment,p),x=!1},d(p){p&&t(u),p&&t(_),y(g,p)}}}function Yy(P){let u,T,_,g,x;return{c(){u=a("p"),T=o("Although the recipe for forward pass needs to be defined within this function, one should call the "),_=a("code"),g=o("Module"),x=o(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(p){u=r(p,"P",{});var f=i(u);T=n(f,"Although the recipe for forward pass needs to be defined within this function, one should call the "),_=r(f,"CODE",{});var G=i(_);g=n(G,"Module"),G.forEach(t),x=n(f,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),f.forEach(t)},m(p,f){m(p,u,f),e(u,T),e(u,_),e(_,g),e(u,x)},d(p){p&&t(u)}}}function Jy(P){let u,T,_,g,x;return g=new Te({props:{code:`from transformers import AutoProcessor, AutoModelForTokenClassification
import torch
...
<span class="hljs-meta">&gt;&gt;&gt; </span>loss = outputs.loss
<span class="hljs-meta">&gt;&gt;&gt; </span>logits = outputs.logits`}}),{c(){u=a("p"),T=o("Examples:"),_=l(),k(g.$$.fragment)},l(p){u=r(p,"P",{});var f=i(u);T=n(f,"Examples:"),f.forEach(t),_=d(p),v(g.$$.fragment,p)},m(p,f){m(p,u,f),e(u,T),m(p,_,f),b(g,p,f),x=!0},p:Qs,i(p){x||(M(g.$$.fragment,p),x=!0)},o(p){w(g.$$.fragment,p),x=!1},d(p){p&&t(u),p&&t(_),y(g,p)}}}function Zy(P){let u,T,_,g,x;return{c(){u=a("p"),T=o("Although the recipe for forward pass needs to be defined within this function, one should call the "),_=a("code"),g=o("Module"),x=o(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(p){u=r(p,"P",{});var f=i(u);T=n(f,"Although the recipe for forward pass needs to be defined within this function, one should call the "),_=r(f,"CODE",{});var G=i(_);g=n(G,"Module"),G.forEach(t),x=n(f,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),f.forEach(t)},m(p,f){m(p,u,f),e(u,T),e(u,_),e(_,g),e(u,x)},d(p){p&&t(u)}}}function ex(P){let u,T,_,g,x;return g=new Te({props:{code:`from transformers import MarkupLMProcessor, MarkupLMForQuestionAnswering
import torch
...
<span class="hljs-string">&#x27;Niels&#x27;</span>`}}),{c(){u=a("p"),T=o("Examples:"),_=l(),k(g.$$.fragment)},l(p){u=r(p,"P",{});var f=i(u);T=n(f,"Examples:"),f.forEach(t),_=d(p),v(g.$$.fragment,p)},m(p,f){m(p,u,f),e(u,T),m(p,_,f),b(g,p,f),x=!0},p:Qs,i(p){x||(M(g.$$.fragment,p),x=!0)},o(p){w(g.$$.fragment,p),x=!1},d(p){p&&t(u),p&&t(_),y(g,p)}}}function tx(P){let u,T,_,g,x,p,f,G,bc,Jl,Se,ct,Xs,ro,Mc,Gs,wc,Zl,qe,yc,io,xc,Tc,yn,Ec,Lc,ed,xn,qc,td,pt,Tn,lo,$c,Fc,zc,En,co,jc,Cc,od,Ln,Pc,nd,qn,Ks,Dc,sd,$n,Ac,ad,$e,le,Ic,Ys,Oc,Nc,Fn,Sc,Rc,Js,Bc,Wc,Zs,Uc,Hc,Vc,Re,Qc,zn,Xc,Gc,jn,Kc,Yc,Jc,po,Zc,ho,ep,tp,rd,ht,Ob,id,mo,op,Cn,np,ld,Fe,sp,uo,ap,rp,fo,ip,lp,dd,Be,mt,ea,go,dp,ta,cp,cd,J,pp,Pn,hp,mp,Dn,up,fp,An,gp,_p,In,kp,vp,oa,bp,Mp,pd,_o,hd,F,wp,On,yp,xp,Nn,Tp,Ep,Sn,Lp,qp,Rn,$p,Fp,na,zp,jp,sa,Cp,Pp,aa,Dp,Ap,ra,Ip,Op,ia,Np,Sp,la,Rp,Bp,md,de,Bn,Wp,Up,ko,Hp,Vp,Wn,Qp,Xp,Un,Gp,Kp,ud,Hn,Yp,fd,Vn,da,Jp,gd,Qn,Zp,_d,vo,kd,Xn,ca,eh,vd,ze,th,pa,oh,nh,ha,sh,ah,bd,bo,Md,Gn,ma,rh,wd,Z,ih,Mo,lh,dh,ua,ch,ph,fa,hh,mh,ga,uh,fh,_a,gh,_h,yd,wo,xd,Kn,ka,kh,Td,Yn,vh,Ed,yo,Ld,Jn,va,bh,qd,je,Mh,ba,wh,yh,Ma,xh,Th,$d,xo,Fd,We,ut,wa,To,Eh,ya,Lh,zd,ce,Eo,qh,Ue,$h,Zn,Fh,zh,Lo,jh,Ch,Ph,He,Dh,es,Ah,Ih,ts,Oh,Nh,Sh,ft,jd,Ve,gt,xa,qo,Rh,Ta,Bh,Cd,pe,$o,Wh,Ea,Uh,Hh,Fo,Vh,La,Qh,Xh,Gh,Ce,zo,Kh,qa,Yh,Jh,_t,Pd,Qe,kt,$a,jo,Zh,Fa,em,Dd,K,Co,tm,S,om,os,nm,sm,za,am,rm,ja,im,lm,Ca,dm,cm,Pa,pm,hm,Da,mm,um,ns,fm,gm,_m,Pe,Po,km,Aa,vm,bm,Do,ss,Mm,Ia,wm,ym,as,xm,Oa,Tm,Em,rs,Ao,Lm,vt,Io,qm,Na,$m,Fm,is,Oo,Ad,Xe,bt,Sa,No,zm,Ra,jm,Id,j,So,Cm,Ba,Pm,Dm,R,ls,Am,Im,Wa,Om,Nm,Ua,Sm,Rm,Ha,Bm,Wm,Va,Um,Hm,Qa,Vm,Qm,ds,Xm,Gm,Km,Xa,Ym,Jm,B,Ro,Zm,A,eu,Ga,tu,ou,Ka,nu,su,Ya,au,ru,Ja,iu,lu,Za,du,cu,cs,pu,hu,er,mu,uu,tr,fu,gu,_u,Y,or,Mt,nr,ku,vu,sr,bu,Mu,wu,ar,wt,rr,yu,xu,ir,Tu,Eu,Lu,lr,W,dr,qu,$u,cr,Fu,zu,pr,ju,Cu,hr,Pu,Du,ps,Au,Iu,mr,Ou,Nu,ur,Su,Ru,Bu,fr,De,gr,Wu,Uu,_r,Hu,Vu,kr,Qu,Xu,Gu,vr,yt,br,Ku,Yu,Mr,Ju,Zu,ef,wr,xt,yr,tf,of,xr,nf,sf,af,Tr,ue,Er,rf,lf,Lr,df,cf,qr,pf,hf,$r,mf,uf,ff,E,gf,Fr,_f,kf,zr,vf,bf,jr,Mf,wf,Cr,yf,xf,Pr,Tf,Ef,Dr,Lf,qf,Ar,$f,Ff,Ir,zf,jf,Or,Cf,Pf,Nr,Df,Af,Sr,If,Of,Rr,Nf,Sf,hs,Rf,Bf,Br,Wf,Uf,Hf,Ge,Tt,Wr,Vf,Qf,Ur,Xf,Gf,Kf,Et,Hr,Yf,Jf,Vr,Zf,eg,tg,Lt,Qr,og,ng,Xr,sg,ag,rg,I,ig,Gr,lg,dg,Kr,cg,pg,Yr,hg,mg,Jr,ug,fg,Zr,gg,_g,ms,kg,vg,ei,bg,Mg,ti,wg,yg,xg,C,oi,qt,ni,Tg,Eg,si,Lg,qg,$g,ai,$t,ri,Fg,zg,ii,jg,Cg,Pg,li,U,di,Dg,Ag,ci,Ig,Og,pi,Ng,Sg,hi,Rg,Bg,us,Wg,Ug,mi,Hg,Vg,ui,Qg,Xg,Gg,fi,Ae,gi,Kg,Yg,_i,Jg,Zg,ki,e_,t_,o_,vi,Ft,bi,n_,s_,Mi,a_,r_,i_,wi,zt,yi,l_,d_,xi,c_,p_,h_,Ti,L,Ei,m_,u_,Li,f_,g_,qi,__,k_,$i,v_,b_,Fi,M_,w_,zi,y_,x_,ji,T_,E_,Ci,L_,q_,Pi,$_,F_,Di,z_,j_,Ai,C_,P_,Ii,D_,A_,fs,I_,O_,Oi,N_,S_,R_,Ni,jt,Si,B_,W_,Ri,U_,H_,V_,Bi,Ct,Wi,Q_,X_,Ui,G_,K_,Y_,Hi,Pt,Vi,J_,Z_,Qi,ek,tk,ok,Ie,Bo,nk,Xi,sk,ak,Wo,gs,rk,Gi,ik,lk,_s,dk,Ki,ck,pk,Dt,Uo,hk,Yi,mk,uk,At,Ho,fk,Vo,gk,Ji,_k,kk,vk,It,Qo,bk,Zi,Mk,Od,Ke,Ot,el,Xo,wk,tl,yk,Nd,te,Go,xk,ol,Tk,Ek,ks,vs,Lk,qk,$k,O,Fk,bs,zk,jk,Ms,Ck,Pk,ws,Dk,Ak,nl,Ik,Ok,sl,Nk,Sk,al,Rk,Bk,rl,Wk,Uk,il,Hk,Vk,Qk,fe,Ko,Xk,oe,Gk,ll,Kk,Yk,Yo,dl,Jk,Zk,ev,cl,tv,ov,pl,nv,sv,hl,av,rv,iv,Jo,lv,ml,dv,cv,pv,ul,hv,Sd,Ye,Nt,fl,Zo,mv,gl,uv,Rd,Ee,en,fv,tn,gv,on,_v,kv,vv,ge,nn,bv,Je,Mv,ys,wv,yv,_l,xv,Tv,Ev,St,Lv,Rt,Bd,Ze,Bt,kl,sn,qv,vl,$v,Wd,he,an,Fv,bl,zv,jv,rn,Cv,ln,Pv,Dv,Av,_e,dn,Iv,et,Ov,xs,Nv,Sv,Ml,Rv,Bv,Wv,Wt,Uv,Ut,Ud,tt,Ht,wl,cn,Hv,yl,Vv,Hd,Le,pn,Qv,ot,Xv,xl,Gv,Kv,hn,Yv,Jv,Zv,ke,mn,eb,nt,tb,Ts,ob,nb,Tl,sb,ab,rb,Vt,ib,Qt,Vd,st,Xt,El,un,lb,Ll,db,Qd,me,fn,cb,at,pb,ql,hb,mb,$l,ub,fb,gb,gn,_b,_n,kb,vb,bb,ve,kn,Mb,rt,wb,Es,yb,xb,Fl,Tb,Eb,Lb,Gt,qb,Kt,Xd;return p=new xe({}),ro=new xe({}),go=new xe({}),_o=new Te({props:{code:`from transformers import MarkupLMFeatureExtractor, MarkupLMTokenizerFast, MarkupLMProcessor
...
<p>Indices can be obtained using <a href="/docs/transformers/main/en/model_doc/markuplm#transformers.MarkupLMTokenizer">MarkupLMTokenizer</a>. See <a href="/docs/transformers/main/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
...
`}}),St=new vc({props:{$$slots:{default:[Qy]},$$scope:{ctx:P}}}),Rt=new Vs({props:{anchor:"transformers.MarkupLMModel.forward.example",$$slots:{default:[Xy]},$$scope:{ctx:P}}}),sn=new xe({}),an=new z({props:{name:"class transformers.MarkupLMForSequenceClassification",anchor:"transformers.MarkupLMForSequenceClassification",parameters:[{name:"config",val:""}],parametersDescription:[{anchor:"transformers.MarkupLMForSequenceClassification.config",description:`<strong>config</strong> (<a href="/docs/transformers/main/en/model_doc/markuplm#transformers.MarkupLMConfig">MarkupLMConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/main/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/markuplm/modeling_markuplm.py#L1082"}}),mn=new z({props:{name:"forward",anchor:"transformers.MarkupLMForTokenClassification.forward",parameters:[{name:"input_ids",val:" = None"},{name:"xpath_tags_seq",val:" = None"},{name:"xpath_subs_seq",val:" = None"},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"labels",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],parametersDescription:[{anchor:"transformers.MarkupLMForTokenClassification.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/main/en/model_doc/markuplm#transformers.MarkupLMTokenizer">MarkupLMTokenizer</a>. See <a href="/docs/transformers/main/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/main/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
`}}),Gt=new vc({props:{$$slots:{default:[Zy]},$$scope:{ctx:P}}}),Kt=new Vs({props:{anchor:"transformers.MarkupLMForQuestionAnswering.forward.example",$$slots:{default:[ex]},$$scope:{ctx:P}}}),{c(){u=a("meta"),T=l(),_=a("h1"),g=a("a"),x=a("span"),k(p.$$.fragment),f=l(),G=a("span"),bc=o("MarkupLM"),Jl=l(),Se=a("h2"),ct=a("a"),Xs=a("span"),k(ro.$$.fragment),Mc=l(),Gs=a("span"),wc=o("Overview"),Zl=l(),qe=a("p"),yc=o("The MarkupLM model was proposed in "),io=a("a"),xc=o(`MarkupLM: Pre-training of Text and Markup Language for Visually-rich Document
...
tasks. The pre-trained model and code will be publicly available.`),sd=l(),$n=a("p"),Ac=o("Tips:"),ad=l(),$e=a("ul"),le=a("li"),Ic=o("In addition to "),Ys=a("code"),Oc=o("input_ids"),Nc=o(", "),Fn=a("a"),Sc=o("forward()"),Rc=o(" expects 2 additional inputs, namely "),Js=a("code"),Bc=o("xpath_tags_seq"),Wc=o(" and "),Zs=a("code"),Uc=o("xpath_subs_seq"),Hc=o(`.
These are the XPATH tags and subscripts respectively for each token in the input sequence.`),Vc=l(),Re=a("li"),Qc=o("One can use "),zn=a("a"),Xc=o("MarkupLMProcessor"),Gc=o(" to prepare all data for the model. Refer to the "),jn=a("a"),Kc=o("usage guide"),Yc=o(" for more info."),Jc=l(),po=a("li"),Zc=o("Demo notebooks can be found "),ho=a("a"),ep=o("here"),tp=o("."),rd=l(),ht=a("img"),id=l(),mo=a("small"),op=o("MarkupLM architecture. Taken from the "),Cn=a("a"),np=o("original paper."),ld=l(),Fe=a("p"),sp=o("This model was contributed by "),uo=a("a"),ap=o("nielsr"),rp=o(". The original code can be found "),fo=a("a"),ip=o("here"),lp=o("."),dd=l(),Be=a("h2"),mt=a("a"),ea=a("span"),k(go.$$.fragment),dp=l(),ta=a("span"),cp=o("Usage: MarkupLMProcessor"),cd=l(),J=a("p"),pp=o("The easiest way to prepare data for the model is to use "),Pn=a("a"),hp=o("MarkupLMProcessor"),mp=o(`, which internally combines a feature extractor
(`),Dn=a("a"),up=o("MarkupLMFeatureExtractor"),fp=o(") and a tokenizer ("),An=a("a"),gp=o("MarkupLMTokenizer"),_p=o(" or "),In=a("a"),kp=o("MarkupLMTokenizerFast"),vp=o(`). The feature extractor is
...
xpaths are then provided to `),Sn=a("a"),Lp=o("MarkupLMTokenizer"),qp=o(" or "),Rn=a("a"),$p=o("MarkupLMTokenizerFast"),Fp=o(`, which converts them
...
Optionally, one can provide node labels to the processor, which are turned into token-level `),la=a("code"),Rp=o("labels"),Bp=o("."),md=l(),de=a("p"),Bn=a("a"),Wp=o("MarkupLMFeatureExtractor"),Up=o(" uses "),ko=a("a"),Hp=o("Beautiful Soup"),Vp=o(`, a Python library for
pulling data out of HTML and XML files, under the hood. Note that you can still use your own parsing solution of
choice, and provide the nodes and xpaths yourself to `),Wn=a("a"),Qp=o("MarkupLMTokenizer"),Xp=o(" or "),Un=a("a"),Gp=o("MarkupLMTokenizerFast"),Kp=o("."),ud=l(),Hn=a("p"),Yp=o(`In total, there are 5 use cases that are supported by the processor. Below, we list them all. Note that each of these
...
provide the nodes and corresponding xpaths themselves to the processor, and make sure to set `),pa=a("code"),oh=o("parse_html"),nh=o(" to "),ha=a("code"),sh=o("False"),ah=o("."),bd=l(),k(bo.$$.fragment),Md=l(),Gn=a("p"),ma=a("strong"),rh=o("Use case 3: token classification (training), parse_html=False"),wd=l(),Z=a("p"),ih=o("For token classification tasks (such as "),Mo=a("a"),lh=o("SWDE"),dh=o(`), one can also provide the
corresponding node labels in order to train a model. The processor will then convert these into token-level `),ua=a("code"),ch=o("labels"),ph=o(`.
By default, it will only label the first wordpiece of a word, and label the remaining wordpieces with -100, which is the
`),fa=a("code"),hh=o("ignore_index"),mh=o(` of PyTorch\u2019s CrossEntropyLoss. In case you want all wordpieces of a word to be labeled, you can
initialize the tokenizer with `),ga=a("code"),uh=o("only_label_first_subword"),fh=o(" set to "),_a=a("code"),gh=o("False"),_h=o("."),yd=l(),k(wo.$$.fragment),xd=l(),Kn=a("p"),ka=a("strong"),kh=o("Use case 4: web page question answering (inference), parse_html=True"),Td=l(),Yn=a("p"),vh=o(`For question answering tasks on web pages, you can provide a question to the processor. By default, the
processor will use the feature extractor to get all nodes and xpaths, and create [CLS] question tokens [SEP] word tokens [SEP].`),Ed=l(),k(yo.$$.fragment),Ld=l(),Jn=a("p"),va=a("strong"),bh=o("Use case 5: web page question answering (inference), parse_html=False"),qd=l(),je=a("p"),Mh=o(`For question answering tasks (such as WebSRC), you can provide a question to the processor. If you have extracted
all nodes and xpaths yourself, you can provide them directly to the processor. Make sure to set `),ba=a("code"),wh=o("parse_html"),yh=o(" to "),Ma=a("code"),xh=o("False"),Th=o("."),$d=l(),k(xo.$$.fragment),Fd=l(),We=a("h2"),ut=a("a"),wa=a("span"),k(To.$$.fragment),Eh=l(),ya=a("span"),Lh=o("MarkupLMConfig"),zd=l(),ce=a("div"),k(Eo.$$.fragment),qh=l(),Ue=a("p"),$h=o("This is the configuration class to store the configuration of a "),Zn=a("a"),Fh=o("MarkupLMModel"),zh=o(`. It is used to instantiate a
...
`),Lo=a("a"),jh=o("microsoft/markuplm-base"),Ch=o(" architecture."),Ph=l(),He=a("p"),Dh=o("Configuration objects inherit from "),es=a("a"),Ah=o("BertConfig"),Ih=o(` and can be used to control the model outputs. Read the
documentation from `),ts=a("a"),Oh=o("BertConfig"),Nh=o(" for more information."),Sh=l(),k(ft.$$.fragment),jd=l(),Ve=a("h2"),gt=a("a"),xa=a("span"),k(qo.$$.fragment),Rh=l(),Ta=a("span"),Bh=o("MarkupLMFeatureExtractor"),Cd=l(),pe=a("div"),k($o.$$.fragment),Wh=l(),Ea=a("p"),Uh=o(`Constructs a MarkupLM feature extractor. This can be used to get a list of nodes and corresponding xpaths from HTML
...
of the main methods. Users should refer to this superclass for more information regarding those methods.`),Gh=l(),Ce=a("div"),k(zo.$$.fragment),Kh=l(),qa=a("p"),Yh=o("Main method to prepare for the model one or several HTML strings."),Jh=l(),k(_t.$$.fragment),Pd=l(),Qe=a("h2"),kt=a("a"),$a=a("span"),k(jo.$$.fragment),Zh=l(),Fa=a("span"),em=o("MarkupLMTokenizer"),Dd=l(),K=a("div"),k(Co.$$.fragment),tm=l(),S=a("p"),om=o("Construct a MarkupLM tokenizer. Based on byte-level Byte-Pair-Encoding (BPE). "),os=a("a"),nm=o("MarkupLMTokenizer"),sm=o(` can be used to
turn HTML strings into to token-level `),za=a("code"),am=o("input_ids"),rm=o(", "),ja=a("code"),im=o("attention_mask"),lm=o(", "),Ca=a("code"),dm=o("token_type_ids"),cm=o(", "),Pa=a("code"),pm=o("xpath_tags_seq"),hm=o(` and
`),Da=a("code"),mm=o("xpath_tags_seq"),um=o(". This tokenizer inherits from "),ns=a("a"),fm=o("PreTrainedTokenizer"),gm=o(` which contains most of the main methods.
Users should refer to this superclass for more information regarding those methods.`),_m=l(),Pe=a("div"),k(Po.$$.fragment),km=l(),Aa=a("p"),vm=o(`Build model inputs from a sequence or a pair of sequence for sequence classification tasks by concatenating and
adding special tokens. A RoBERTa sequence has the following format:`),bm=l(),Do=a("ul"),ss=a("li"),Mm=o("single sequence: "),Ia=a("code"),wm=o("<s> X </s>"),ym=l(),as=a("li"),xm=o("pair of sequences: "),Oa=a("code"),Tm=o("<s> A </s></s> B </s>"),Em=l(),rs=a("div"),k(Ao.$$.fragment),Lm=l(),vt=a("div"),k(Io.$$.fragment),qm=l(),Na=a("p"),$m=o(`Create a mask from the two sequences passed to be used in a sequence-pair classification task. RoBERTa does not
make use of token type ids, therefore a list of zeros is returned.`),Fm=l(),is=a("div"),k(Oo.$$.fragment),Ad=l(),Xe=a("h2"),bt=a("a"),Sa=a("span"),k(No.$$.fragment),zm=l(),Ra=a("span"),jm=o("MarkupLMTokenizerFast"),Id=l(),j=a("div"),k(So.$$.fragment),Cm=l(),Ba=a("p"),Pm=o("Construct a MarkupLM tokenizer. Based on byte-level Byte-Pair-Encoding (BPE)."),Dm=l(),R=a("p"),ls=a("a"),Am=o("MarkupLMTokenizerFast"),Im=o(" can be used to turn HTML strings into to token-level "),Wa=a("code"),Om=o("input_ids"),Nm=o(", "),Ua=a("code"),Sm=o("attention_mask"),Rm=o(`,
`),Ha=a("code"),Bm=o("token_type_ids"),Wm=o(", "),Va=a("code"),Um=o("xpath_tags_seq"),Hm=o(" and "),Qa=a("code"),Vm=o("xpath_tags_seq"),Qm=o(". This tokenizer inherits from "),ds=a("a"),Xm=o("PreTrainedTokenizer"),Gm=o(` which
contains most of the main methods.`),Km=l(),Xa=a("p"),Ym=o("Users should refer to this superclass for more information regarding those methods."),Jm=l(),B=a("div"),k(Ro.$$.fragment),Zm=l(),A=a("p"),eu=o("add_special_tokens ("),Ga=a("code"),tu=o("bool"),ou=o(", "),Ka=a("em"),nu=o("optional"),su=o(", defaults to "),Ya=a("code"),au=o("True"),ru=o(`):
Whether or not to encode the sequences with the special tokens relative to their model.
padding (`),Ja=a("code"),iu=o("bool"),lu=o(", "),Za=a("code"),du=o("str"),cu=o(" or "),cs=a("a"),pu=o("PaddingStrategy"),hu=o(", "),er=a("em"),mu=o("optional"),uu=o(", defaults to "),tr=a("code"),fu=o("False"),gu=o(`):
Activates and controls padding. Accepts the following values:`),_u=l(),Y=a("ul"),or=a("li"),Mt=a("p"),nr=a("code"),ku=o("True"),vu=o(" or "),sr=a("code"),bu=o("'longest'"),Mu=o(`: Pad to the longest sequence in the batch (or no padding if only a single
sequence if provided).`),wu=l(),ar=a("li"),wt=a("p"),rr=a("code"),yu=o("'max_length'"),xu=o(": Pad to a maximum length specified with the argument "),ir=a("code"),Tu=o("max_length"),Eu=o(` or to the maximum
acceptable input length for the model if that argument is not provided.`),Lu=l(),lr=a("li"),W=a("p"),dr=a("code"),qu=o("False"),$u=o(" or "),cr=a("code"),Fu=o("'do_not_pad'"),zu=o(` (default): No padding (i.e., can output a batch with sequences of different
lengths).
truncation (`),pr=a("code"),ju=o("bool"),Cu=o(", "),hr=a("code"),Pu=o("str"),Du=o(" or "),ps=a("a"),Au=o("TruncationStrategy"),Iu=o(", "),mr=a("em"),Ou=o("optional"),Nu=o(", defaults to "),ur=a("code"),Su=o("False"),Ru=o(`):
Activates and controls truncation. Accepts the following values:`),Bu=l(),fr=a("li"),De=a("p"),gr=a("code"),Wu=o("True"),Uu=o(" or "),_r=a("code"),Hu=o("'longest_first'"),Vu=o(": Truncate to a maximum length specified with the argument "),kr=a("code"),Qu=o("max_length"),Xu=o(` or
to the maximum acceptable input length for the model if that argument is not provided. This will
truncate token by token, removing a token from the longest sequence in the pair if a pair of
sequences (or a batch of pairs) is provided.`),Gu=l(),vr=a("li"),yt=a("p"),br=a("code"),Ku=o("'only_first'"),Yu=o(": Truncate to a maximum length specified with the argument "),Mr=a("code"),Ju=o("max_length"),Zu=o(` or to the
maximum acceptable input length for the model if that argument is not provided. This will only
...
maximum acceptable input length for the model if that argument is not provided. This will only
truncate the second sequence of a pair if a pair of sequences (or a batch of pairs) is provided.`),af=l(),Tr=a("li"),ue=a("p"),Er=a("code"),rf=o("False"),lf=o(" or "),Lr=a("code"),df=o("'do_not_truncate'"),cf=o(` (default): No truncation (i.e., can output batch with sequence lengths
greater than the model maximum admissible input size).
max_length (`),qr=a("code"),pf=o("int"),hf=o(", "),$r=a("em"),mf=o("optional"),uf=o(`):
...
lengths).
truncation (`),pi=a("code"),Ng=o("bool"),Sg=o(", "),hi=a("code"),Rg=o("str"),Bg=o(" or "),us=a("a"),Wg=o("TruncationStrategy"),Ug=o(", "),mi=a("em"),Hg=o("optional"),Vg=o(", defaults to "),ui=a("code"),Qg=o("False"),Xg=o(`):
...
maximum acceptable input length for the model if that argument is not provided. This will only
truncate the second sequence of a pair if a pair of sequences (or a batch of pairs) is provided.`),h_=l(),Ti=a("li"),L=a("p"),Ei=a("code"),m_=o("False"),u_=o(" or "),Li=a("code"),f_=o("'do_not_truncate'"),g_=o(` (default): No truncation (i.e., can output batch with sequence lengths
greater than the model maximum admissible input size).
...
If set, will return tensors instead of list of python integers. Acceptable values are:`),R_=l(),Ni=a("li"),jt=a("p"),Si=a("code"),B_=o("'tf'"),W_=o(": Return TensorFlow "),Ri=a("code"),U_=o("tf.constant"),H_=o(" objects."),V_=l(),Bi=a("li"),Ct=a("p"),Wi=a("code"),Q_=o("'pt'"),X_=o(": Return PyTorch "),Ui=a("code"),G_=o("torch.Tensor"),K_=o(" objects."),Y_=l(),Hi=a("li"),Pt=a("p"),Vi=a("code"),J_=o("'np'"),Z_=o(": Return Numpy "),Qi=a("code"),ek=o("np.ndarray"),tk=o(" objects."),ok=l(),Ie=a("div"),k(Bo.$$.fragment),nk=l(),Xi=a("p"),sk=o(`Build model inputs from a sequence or a pair of sequence for sequence classification tasks by concatenating and
adding special tokens. A RoBERTa sequence has the following format:`),ak=l(),Wo=a("ul"),gs=a("li"),rk=o("single sequence: "),Gi=a("code"),ik=o("<s> X </s>"),lk=l(),_s=a("li"),dk=o("pair of sequences: "),Ki=a("code"),ck=o("<s> A </s></s> B </s>"),pk=l(),Dt=a("div"),k(Uo.$$.fragment),hk=l(),Yi=a("p"),mk=o(`Create a mask from the two sequences passed to be used in a sequence-pair classification task. RoBERTa does not
make use of token type ids, therefore a list of zeros is returned.`),uk=l(),At=a("div"),k(Ho.$$.fragment),fk=l(),Vo=a("p"),gk=o(`Tokenize and prepare for the model a sequence or a pair of sequences. .. warning:: This method is deprecated,
...
`),nl=a("code"),Ik=o("input_ids"),Ok=o(", "),sl=a("code"),Nk=o("attention_mask"),Sk=o(", "),al=a("code"),Rk=o("token_type_ids"),Bk=o(", "),rl=a("code"),Wk=o("xpath_tags_seq"),Uk=o(" and "),il=a("code"),Hk=o("xpath_subs_seq"),Vk=o("."),Qk=l(),fe=a("div"),k(Ko.$$.fragment),Xk=l(),oe=a("p"),Gk=o("This method first forwards the "),ll=a("code"),Kk=o("html_strings"),Yk=o(" argument to "),Yo=a("a"),dl=a("strong"),Jk=o("call"),Zk=o("()"),ev=o(`. Next, it
...
state-of-the-art results on 2 important benchmarks:`),Sb.forEach(t),td=d(s),pt=r(s,"UL",{});var Gd=i(pt);Tn=r(Gd,"LI",{});var $b=i(Tn);lo=r($b,"A",{href:!0,rel:!0});var Rb=i(lo);$c=n(Rb,"WebSRC"),Rb.forEach(t),Fc=n($b,", a dataset for Web-Based Structual Reading Comprehension (a bit like SQuAD but for web pages)"),$b.forEach(t),zc=d(Gd),En=r(Gd,"LI",{});var Fb=i(En);co=r(Fb,"A",{href:!0,rel:!0});var Bb=i(co);jc=n(Bb,"SWDE"),Bb.forEach(t),Cc=n(Fb,`, a dataset
...
HTML/XML-based documents, where text and markup information is jointly pre-trained. Experiment results show that the
pre-trained MarkupLM significantly outperforms the existing strong baseline models on several document understanding
tasks. The pre-trained model and code will be publicly available.`),Hb.forEach(t),Ub.forEach(t),sd=d(s),$n=r(s,"P",{});var Vb=i($n);Ac=n(Vb,"Tips:"),Vb.forEach(t),ad=d(s),$e=r(s,"UL",{});var Ls=i($e);le=r(Ls,"LI",{});var Oe=i(le);Ic=n(Oe,"In addition to "),Ys=r(Oe,"CODE",{});var Qb=i(Ys);Oc=n(Qb,"input_ids"),Qb.forEach(t),Nc=n(Oe,", "),Fn=r(Oe,"A",{href:!0});var Xb=i(Fn);Sc=n(Xb,"forward()"),Xb.forEach(t),Rc=n(Oe," expects 2 additional inputs, namely "),Js=r(Oe,"CODE",{});var Gb=i(Js);Bc=n(Gb,"xpath_tags_seq"),Gb.forEach(t),Wc=n(Oe," and "),Zs=r(Oe,"CODE",{});var Kb=i(Zs);Uc=n(Kb,"xpath_subs_seq"),Kb.forEach(t),Hc=n(Oe,`.
These are the XPATH tags and subscripts respectively for each token in the input sequence.`),Oe.forEach(t),Vc=d(Ls),Re=r(Ls,"LI",{});var qs=i(Re);Qc=n(qs,"One can use "),zn=r(qs,"A",{href:!0});var Yb=i(zn);Xc=n(Yb,"MarkupLMProcessor"),Yb.forEach(t),Gc=n(qs," to prepare all data for the model. Refer to the "),jn=r(qs,"A",{href:!0});var Jb=i(jn);Kc=n(Jb,"usage guide"),Jb.forEach(t),Yc=n(qs," for more info."),qs.forEach(t),Jc=d(Ls),po=r(Ls,"LI",{});var Kd=i(po);Zc=n(Kd,"Demo notebooks can be found "),ho=r(Kd,"A",{href:!0,rel:!0});var Zb=i(ho);ep=n(Zb,"here"),Zb.forEach(t),tp=n(Kd,"."),Kd.forEach(t),Ls.forEach(t),rd=d(s),ht=r(s,"IMG",{src:!0,alt:!0,width:!0}),id=d(s),mo=r(s,"SMALL",{});var zb=i(mo);op=n(zb,"MarkupLM architecture. Taken from the "),Cn=r(zb,"A",{href:!0});var eM=i(Cn);np=n(eM,"original paper."),eM.forEach(t),zb.forEach(t),ld=d(s),Fe=r(s,"P",{});var $s=i(Fe);sp=n($s,"This model was contributed by "),uo=r($s,"A",{href:!0,rel:!0});var tM=i(uo);ap=n(tM,"nielsr"),tM.forEach(t),rp=n($s,". The original code can be found "),fo=r($s,"A",{href:!0,rel:!0});var oM=i(fo);ip=n(oM,"here"),oM.forEach(t),lp=n($s,"."),$s.forEach(t),dd=d(s),Be=r(s,"H2",{class:!0});var Yd=i(Be);mt=r(Yd,"A",{id:!0,class:!0,href:!0});var nM=i(mt);ea=r(nM,"SPAN",{});var sM=i(ea);v(go.$$.fragment,sM),sM.forEach(t),nM.forEach(t),dp=d(Yd),ta=r(Yd,"SPAN",{});var aM=i(ta);cp=n(aM,"Usage: MarkupLMProcessor"),aM.forEach(t),Yd.forEach(t),cd=d(s),J=r(s,"P",{});var be=i(J);pp=n(be,"The easiest way to prepare data for the model is to use "),Pn=r(be,"A",{href:!0});var rM=i(Pn);hp=n(rM,"MarkupLMProcessor"),rM.forEach(t),mp=n(be,`, which internally combines a feature extractor
(`),Dn=r(be,"A",{href:!0});var iM=i(Dn);up=n(iM,"MarkupLMFeatureExtractor"),iM.forEach(t),fp=n(be,") and a tokenizer ("),An=r(be,"A",{href:!0});var lM=i(An);gp=n(lM,"MarkupLMTokenizer"),lM.forEach(t),_p=n(be," or "),In=r(be,"A",{href:!0});var dM=i(In);kp=n(dM,"MarkupLMTokenizerFast"),dM.forEach(t),vp=n(be,`). The feature extractor is
used to extract all nodes and xpaths from the HTML strings, which are then provided to the tokenizer, which turns them into the
...
xpaths are then provided to `),Sn=r(D,"A",{href:!0});var mM=i(Sn);Lp=n(mM,"MarkupLMTokenizer"),mM.forEach(t),qp=n(D," or "),Rn=r(D,"A",{href:!0});var uM=i(Rn);$p=n(uM,"MarkupLMTokenizerFast"),uM.forEach(t),Fp=n(D,`, which converts them
...
Optionally, one can provide node labels to the processor, which are turned into token-level `),la=r(D,"CODE",{});var bM=i(la);Rp=n(bM,"labels"),bM.forEach(t),Bp=n(D,"."),D.forEach(t),md=d(s),de=r(s,"P",{});var lt=i(de);Bn=r(lt,"A",{href:!0});var MM=i(Bn);Wp=n(MM,"MarkupLMFeatureExtractor"),MM.forEach(t),Up=n(lt," uses "),ko=r(lt,"A",{href:!0,rel:!0});var wM=i(ko);Hp=n(wM,"Beautiful Soup"),wM.forEach(t),Vp=n(lt,`, a Python library for
pulling data out of HTML and XML files, under the hood. Note that you can still use your own parsing solution of
choice, and provide the nodes and xpaths yourself to `),Wn=r(lt,"A",{href:!0});var yM=i(Wn);Qp=n(yM,"MarkupLMTokenizer"),yM.forEach(t),Xp=n(lt," or "),Un=r(lt,"A",{href:!0});var xM=i(Un);Gp=n(xM,"MarkupLMTokenizerFast"),xM.forEach(t),Kp=n(lt,"."),lt.forEach(t),ud=d(s),Hn=r(s,"P",{});var TM=i(Hn);Yp=n(TM,`In total, there are 5 use cases that are supported by the processor. Below, we list them all. Note that each of these
...
provide the nodes and corresponding xpaths themselves to the processor, and make sure to set `),pa=r(Fs,"CODE",{});var zM=i(pa);oh=n(zM,"parse_html"),zM.forEach(t),nh=n(Fs," to "),ha=r(Fs,"CODE",{});var jM=i(ha);sh=n(jM,"False"),jM.forEach(t),ah=n(Fs,"."),Fs.forEach(t),bd=d(s),v(bo.$$.fragment,s),Md=d(s),Gn=r(s,"P",{});var CM=i(Gn);ma=r(CM,"STRONG",{});var PM=i(ma);rh=n(PM,"Use case 3: token classification (training), parse_html=False"),PM.forEach(t),CM.forEach(t),wd=d(s),Z=r(s,"P",{});var Me=i(Z);ih=n(Me,"For token classification tasks (such as "),Mo=r(Me,"A",{href:!0,rel:!0});var DM=i(Mo);lh=n(DM,"SWDE"),DM.forEach(t),dh=n(Me,`), one can also provide the
corresponding node labels in order to train a model. The processor will then convert these into token-level `),ua=r(Me,"CODE",{});var AM=i(ua);ch=n(AM,"labels"),AM.forEach(t),ph=n(Me,`.
By default, it will only label the first wordpiece of a word, and label the remaining wordpieces with -100, which is the
`),fa=r(Me,"CODE",{});var IM=i(fa);hh=n(IM,"ignore_index"),IM.forEach(t),mh=n(Me,` of PyTorch\u2019s CrossEntropyLoss. In case you want all wordpieces of a word to be labeled, you can
initialize the tokenizer with `),ga=r(Me,"CODE",{});var OM=i(ga);uh=n(OM,"only_label_first_subword"),OM.forEach(t),fh=n(Me," set to "),_a=r(Me,"CODE",{});var NM=i(_a);gh=n(NM,"False"),NM.forEach(t),_h=n(Me,"."),Me.forEach(t),yd=d(s),v(wo.$$.fragment,s),xd=d(s),Kn=r(s,"P",{});var SM=i(Kn);ka=r(SM,"STRONG",{});var RM=i(ka);kh=n(RM,"Use case 4: web page question answering (inference), parse_html=True"),RM.forEach(t),SM.forEach(t),Td=d(s),Yn=r(s,"P",{});var BM=i(Yn);vh=n(BM,`For question answering tasks on web pages, you can provide a question to the processor. By default, the
processor will use the feature extractor to get all nodes and xpaths, and create [CLS] question tokens [SEP] word tokens [SEP].`),BM.forEach(t),Ed=d(s),v(yo.$$.fragment,s),Ld=d(s),Jn=r(s,"P",{});var WM=i(Jn);va=r(WM,"STRONG",{});var UM=i(va);bh=n(UM,"Use case 5: web page question answering (inference), parse_html=False"),UM.forEach(t),WM.forEach(t),qd=d(s),je=r(s,"P",{});var zs=i(je);Mh=n(zs,`For question answering tasks (such as WebSRC), you can provide a question to the processor. If you have extracted
all nodes and xpaths yourself, you can provide them directly to the processor. Make sure to set `),ba=r(zs,"CODE",{});var HM=i(ba);wh=n(HM,"parse_html"),HM.forEach(t),yh=n(zs," to "),Ma=r(zs,"CODE",{});var VM=i(Ma);xh=n(VM,"False"),VM.forEach(t),Th=n(zs,"."),zs.forEach(t),$d=d(s),v(xo.$$.fragment,s),Fd=d(s),We=r(s,"H2",{class:!0});var Jd=i(We);ut=r(Jd,"A",{id:!0,class:!0,href:!0});var QM=i(ut);wa=r(QM,"SPAN",{});var XM=i(wa);v(To.$$.fragment,XM),XM.forEach(t),QM.forEach(t),Eh=d(Jd),ya=r(Jd,"SPAN",{});var GM=i(ya);Lh=n(GM,"MarkupLMConfig"),GM.forEach(t),Jd.forEach(t),zd=d(s),ce=r(s,"DIV",{class:!0});var Yt=i(ce);v(Eo.$$.fragment,Yt),qh=d(Yt),Ue=r(Yt,"P",{});var js=i(Ue);$h=n(js,"This is the configuration class to store the configuration of a "),Zn=r(js,"A",{href:!0});var KM=i(Zn);Fh=n(KM,"MarkupLMModel"),KM.forEach(t),zh=n(js,`. It is used to instantiate a
MarkupLM model according to the specified arguments, defining the model architecture. Instantiating a configuration
with the defaults will yield a similar configuration to that of the MarkupLM
`),Lo=r(js,"A",{href:!0,rel:!0});var YM=i(Lo);jh=n(YM,"microsoft/markuplm-base"),YM.forEach(t),Ch=n(js," architecture."),js.forEach(t),Ph=d(Yt),He=r(Yt,"P",{});var Cs=i(He);Dh=n(Cs,"Configuration objects inherit from "),es=r(Cs,"A",{href:!0});var JM=i(es);Ah=n(JM,"BertConfig"),JM.forEach(t),Ih=n(Cs,` and can be used to control the model outputs. Read the
documentation from `),ts=r(Cs,"A",{href:!0});var ZM=i(ts);Oh=n(ZM,"BertConfig"),ZM.forEach(t),Nh=n(Cs," for more information."),Cs.forEach(t),Sh=d(Yt),v(ft.$$.fragment,Yt),Yt.forEach(t),jd=d(s),Ve=r(s,"H2",{class:!0});var Zd=i(Ve);gt=r(Zd,"A",{id:!0,class:!0,href:!0});var e1=i(gt);xa=r(e1,"SPAN",{});var t1=i(xa);v(qo.$$.fragment,t1),t1.forEach(t),e1.forEach(t),Rh=d(Zd),Ta=r(Zd,"SPAN",{});var o1=i(Ta);Bh=n(o1,"MarkupLMFeatureExtractor"),o1.forEach(t),Zd.forEach(t),Cd=d(s),pe=r(s,"DIV",{class:!0});var Jt=i(pe);v($o.$$.fragment,Jt),Wh=d(Jt),Ea=r(Jt,"P",{});var n1=i(Ea);Uh=n(n1,`Constructs a MarkupLM feature extractor. This can be used to get a list of nodes and corresponding xpaths from HTML
...
of the main methods. Users should refer to this superclass for more information regarding those methods.`),ec.forEach(t),Gh=d(Jt),Ce=r(Jt,"DIV",{class:!0});var Ps=i(Ce);v(zo.$$.fragment,Ps),Kh=d(Ps),qa=r(Ps,"P",{});var a1=i(qa);Yh=n(a1,"Main method to prepare for the model one or several HTML strings."),a1.forEach(t),Jh=d(Ps),v(_t.$$.fragment,Ps),Ps.forEach(t),Jt.forEach(t),Pd=d(s),Qe=r(s,"H2",{class:!0});var tc=i(Qe);kt=r(tc,"A",{id:!0,class:!0,href:!0});var r1=i(kt);$a=r(r1,"SPAN",{});var i1=i($a);v(jo.$$.fragment,i1),i1.forEach(t),r1.forEach(t),Zh=d(tc),Fa=r(tc,"SPAN",{});var l1=i(Fa);em=n(l1,"MarkupLMTokenizer"),l1.forEach(t),tc.forEach(t),Dd=d(s),K=r(s,"DIV",{class:!0});var we=i(K);v(Co.$$.fragment,we),tm=d(we),S=r(we,"P",{});var ee=i(S);om=n(ee,"Construct a MarkupLM tokenizer. Based on byte-level Byte-Pair-Encoding (BPE). "),os=r(ee,"A",{href:!0});var d1=i(os);nm=n(d1,"MarkupLMTokenizer"),d1.forEach(t),sm=n(ee,` can be used to
turn HTML strings into to token-level `),za=r(ee,"CODE",{});var c1=i(za);am=n(c1,"input_ids"),c1.forEach(t),rm=n(ee,", "),ja=r(ee,"CODE",{});var p1=i(ja);im=n(p1,"attention_mask"),p1.forEach(t),lm=n(ee,", "),Ca=r(ee,"CODE",{});var h1=i(Ca);dm=n(h1,"token_type_ids"),h1.forEach(t),cm=n(ee,", "),Pa=r(ee,"CODE",{});var m1=i(Pa);pm=n(m1,"xpath_tags_seq"),m1.forEach(t),hm=n(ee,` and
`),Da=r(ee,"CODE",{});var u1=i(Da);mm=n(u1,"xpath_tags_seq"),u1.forEach(t),um=n(ee,". This tokenizer inherits from "),ns=r(ee,"A",{href:!0});var f1=i(ns);fm=n(f1,"PreTrainedTokenizer"),f1.forEach(t),gm=n(ee,` which contains most of the main methods.
Users should refer to this superclass for more information regarding those methods.`),ee.forEach(t),_m=d(we),Pe=r(we,"DIV",{class:!0});var Ds=i(Pe);v(Po.$$.fragment,Ds),km=d(Ds),Aa=r(Ds,"P",{});var g1=i(Aa);vm=n(g1,`Build model inputs from a sequence or a pair of sequence for sequence classification tasks by concatenating and
adding special tokens. A RoBERTa sequence has the following format:`),g1.forEach(t),bm=d(Ds),Do=r(Ds,"UL",{});var oc=i(Do);ss=r(oc,"LI",{});var jb=i(ss);Mm=n(jb,"single sequence: "),Ia=r(jb,"CODE",{});var _1=i(Ia);wm=n(_1,"<s> X </s>"),_1.forEach(t),jb.forEach(t),ym=d(oc),as=r(oc,"LI",{});var Cb=i(as);xm=n(Cb,"pair of sequences: "),Oa=r(Cb,"CODE",{});var k1=i(Oa);Tm=n(k1,"<s> A </s></s> B </s>"),k1.forEach(t),Cb.forEach(t),oc.forEach(t),Ds.forEach(t),Em=d(we),rs=r(we,"DIV",{class:!0});var v1=i(rs);v(Ao.$$.fragment,v1),v1.forEach(t),Lm=d(we),vt=r(we,"DIV",{class:!0});var nc=i(vt);v(Io.$$.fragment,nc),qm=d(nc),Na=r(nc,"P",{});var b1=i(Na);$m=n(b1,`Create a mask from the two sequences passed to be used in a sequence-pair classification task. RoBERTa does not
make use of token type ids, therefore a list of zeros is returned.`),b1.forEach(t),nc.forEach(t),Fm=d(we),is=r(we,"DIV",{class:!0});var M1=i(is);v(Oo.$$.fragment,M1),M1.forEach(t),we.forEach(t),Ad=d(s),Xe=r(s,"H2",{class:!0});var sc=i(Xe);bt=r(sc,"A",{id:!0,class:!0,href:!0});var w1=i(bt);Sa=r(w1,"SPAN",{});var y1=i(Sa);v(No.$$.fragment,y1),y1.forEach(t),w1.forEach(t),zm=d(sc),Ra=r(sc,"SPAN",{});var x1=i(Ra);jm=n(x1,"MarkupLMTokenizerFast"),x1.forEach(t),sc.forEach(t),Id=d(s),j=r(s,"DIV",{class:!0});var H=i(j);v(So.$$.fragment,H),Cm=d(H),Ba=r(H,"P",{});var T1=i(Ba);Pm=n(T1,"Construct a MarkupLM tokenizer. Based on byte-level Byte-Pair-Encoding (BPE)."),T1.forEach(t),Dm=d(H),R=r(H,"P",{});var ne=i(R);ls=r(ne,"A",{href:!0});var E1=i(ls);Am=n(E1,"MarkupLMTokenizerFast"),E1.forEach(t),Im=n(ne," can be used to turn HTML strings into to token-level "),Wa=r(ne,"CODE",{});var L1=i(Wa);Om=n(L1,"input_ids"),L1.forEach(t),Nm=n(ne,", "),Ua=r(ne,"CODE",{});var q1=i(Ua);Sm=n(q1,"attention_mask"),q1.forEach(t),Rm=n(ne,`,
`),Ha=r(ne,"CODE",{});var $1=i(Ha);Bm=n($1,"token_type_ids"),$1.forEach(t),Wm=n(ne,", "),Va=r(ne,"CODE",{});var F1=i(Va);Um=n(F1,"xpath_tags_seq"),F1.forEach(t),Hm=n(ne," and "),Qa=r(ne,"CODE",{});var z1=i(Qa);Vm=n(z1,"xpath_tags_seq"),z1.forEach(t),Qm=n(ne,". This tokenizer inherits from "),ds=r(ne,"A",{href:!0});var j1=i(ds);Xm=n(j1,"PreTrainedTokenizer"),j1.forEach(t),Gm=n(ne,` which
contains most of the main methods.`),ne.forEach(t),Km=d(H),Xa=r(H,"P",{});var C1=i(Xa);Ym=n(C1,"Users should refer to this superclass for more information regarding those methods."),C1.forEach(t),Jm=d(H),B=r(H,"DIV",{class:!0});var re=i(B);v(Ro.$$.fragment,re),Zm=d(re),A=r(re,"P",{});var V=i(A);eu=n(V,"add_special_tokens ("),Ga=r(V,"CODE",{});var P1=i(Ga);tu=n(P1,"bool"),P1.forEach(t),ou=n(V,", "),Ka=r(V,"EM",{});var D1=i(Ka);nu=n(D1,"optional"),D1.forEach(t),su=n(V,", defaults to "),Ya=r(V,"CODE",{});var A1=i(Ya);au=n(A1,"True"),A1.forEach(t),ru=n(V,`):
Whether or not to encode the sequences with the special tokens relative to their model.
padding (`),Ja=r(V,"CODE",{});var I1=i(Ja);iu=n(I1,"bool"),I1.forEach(t),lu=n(V,", "),Za=r(V,"CODE",{});var O1=i(Za);du=n(O1,"str"),O1.forEach(t),cu=n(V," or "),cs=r(V,"A",{href:!0});var N1=i(cs);pu=n(N1,"PaddingStrategy"),N1.forEach(t),hu=n(V,", "),er=r(V,"EM",{});var S1=i(er);mu=n(S1,"optional"),S1.forEach(t),uu=n(V,", defaults to "),tr=r(V,"CODE",{});var R1=i(tr);fu=n(R1,"False"),R1.forEach(t),gu=n(V,`):
Activates and controls padding. Accepts the following values:`),V.forEach(t),_u=d(re),Y=r(re,"UL",{});var ie=i(Y);or=r(ie,"LI",{});var B1=i(or);Mt=r(B1,"P",{});var Ol=i(Mt);nr=r(Ol,"CODE",{});var W1=i(nr);ku=n(W1,"True"),W1.forEach(t),vu=n(Ol," or "),sr=r(Ol,"CODE",{});var U1=i(sr);bu=n(U1,"'longest'"),U1.forEach(t),Mu=n(Ol,`: Pad to the longest sequence in the batch (or no padding if only a single
sequence if provided).`),Ol.forEach(t),B1.forEach(t),wu=d(ie),ar=r(ie,"LI",{});var H1=i(ar);wt=r(H1,"P",{});var Nl=i(wt);rr=r(Nl,"CODE",{});var V1=i(rr);yu=n(V1,"'max_length'"),V1.forEach(t),xu=n(Nl,": Pad to a maximum length specified with the argument "),ir=r(Nl,"CODE",{});var Q1=i(ir);Tu=n(Q1,"max_length"),Q1.forEach(t),Eu=n(Nl,` or to the maximum
acceptable input length for the model if that argument is not provided.`),Nl.forEach(t),H1.forEach(t),Lu=d(ie),lr=r(ie,"LI",{});var X1=i(lr);W=r(X1,"P",{});var se=i(W);dr=r(se,"CODE",{});var G1=i(dr);qu=n(G1,"False"),G1.forEach(t),$u=n(se," or "),cr=r(se,"CODE",{});var K1=i(cr);Fu=n(K1,"'do_not_pad'"),K1.forEach(t),zu=n(se,` (default): No padding (i.e., can output a batch with sequences of different
lengths).
truncation (`),pr=r(se,"CODE",{});var Y1=i(pr);ju=n(Y1,"bool"),Y1.forEach(t),Cu=n(se,", "),hr=r(se,"CODE",{});var J1=i(hr);Pu=n(J1,"str"),J1.forEach(t),Du=n(se," or "),ps=r(se,"A",{href:!0});var Z1=i(ps);Au=n(Z1,"TruncationStrategy"),Z1.forEach(t),Iu=n(se,", "),mr=r(se,"EM",{});var ew=i(mr);Ou=n(ew,"optional"),ew.forEach(t),Nu=n(se,", defaults to "),ur=r(se,"CODE",{});var tw=i(ur);Su=n(tw,"False"),tw.forEach(t),Ru=n(se,`):
Activates and controls truncation. Accepts the following values:`),se.forEach(t),X1.forEach(t),Bu=d(ie),fr=r(ie,"LI",{});var ow=i(fr);De=r(ow,"P",{});var Mn=i(De);gr=r(Mn,"CODE",{});var nw=i(gr);Wu=n(nw,"True"),nw.forEach(t),Uu=n(Mn," or "),_r=r(Mn,"CODE",{});var sw=i(_r);Hu=n(sw,"'longest_first'"),sw.forEach(t),Vu=n(Mn,": Truncate to a maximum length specified with the argument "),kr=r(Mn,"CODE",{});var aw=i(kr);Qu=n(aw,"max_length"),aw.forEach(t),Xu=n(Mn,` or
to the maximum acceptable input length for the model if that argument is not provided. This will
truncate token by token, removing a token from the longest sequence in the pair if a pair of
sequences (or a batch of pairs) is provided.`),Mn.forEach(t),ow.forEach(t),Gu=d(ie),vr=r(ie,"LI",{});var rw=i(vr);yt=r(rw,"P",{});var Sl=i(yt);br=r(Sl,"CODE",{});var iw=i(br);Ku=n(iw,"'only_first'"),iw.forEach(t),Yu=n(Sl,": Truncate to a maximum length specified with the argument "),Mr=r(Sl,"CODE",{});var lw=i(Mr);Ju=n(lw,"max_length"),lw.forEach(t),Zu=n(Sl,` or to the
maximum acceptable input length for the model if that argument is not provided. This will only
truncate the first sequence of a pair if a pair of sequences (or a batch of pairs) is provided.`),Sl.forEach(t),rw.forEach(t),ef=d(ie),wr=r(ie,"LI",{});var dw=i(wr);xt=r(dw,"P",{});var Rl=i(xt);yr=r(Rl,"CODE",{});var cw=i(yr);tf=n(cw,"'only_second'"),cw.forEach(t),of=n(Rl,": Truncate to a maximum length specified with the argument "),xr=r(Rl,"CODE",{});var pw=i(xr);nf=n(pw,"max_length"),pw.forEach(t),sf=n(Rl,` or to the
maximum acceptable input length for the model if that argument is not provided. This will only
truncate the second sequence of a pair if a pair of sequences (or a batch of pairs) is provided.`),Rl.forEach(t),dw.forEach(t),af=d(ie),Tr=r(ie,"LI",{});var hw=i(Tr);ue=r(hw,"P",{});var dt=i(ue);Er=r(dt,"CODE",{});var mw=i(Er);rf=n(mw,"False"),mw.forEach(t),lf=n(dt," or "),Lr=r(dt,"CODE",{});var uw=i(Lr);df=n(uw,"'do_not_truncate'"),uw.forEach(t),cf=n(dt,` (default): No truncation (i.e., can output batch with sequence lengths
greater than the model maximum admissible input size).
max_length (`),qr=r(dt,"CODE",{});var fw=i(qr);pf=n(fw,"int"),fw.forEach(t),hf=n(dt,", "),$r=r(dt,"EM",{});var gw=i($r);mf=n(gw,"optional"),gw.forEach(t),uf=n(dt,`):
...
If set will pad the sequence to a multiple of the provided value. This is especially useful to enable
the use of Tensor Cores on NVIDIA hardware with compute capability >= 7.5 (Volta).
return_tensors (`),Rr=r(q,"CODE",{});var qw=i(Rr);Nf=n(qw,"str"),qw.forEach(t),Sf=n(q," or "),hs=r(q,"A",{href:!0});var $w=i(hs);Rf=n($w,"TensorType"),$w.forEach(t),Bf=n(q,", "),Br=r(q,"EM",{});var Fw=i(Br);Wf=n(Fw,"optional"),Fw.forEach(t),Uf=n(q,`):
If set, will return tensors instead of list of python integers. Acceptable values are:`),q.forEach(t),Hf=d(re),Ge=r(re,"UL",{});var As=i(Ge);Tt=r(As,"LI",{});var Bl=i(Tt);Wr=r(Bl,"CODE",{});var zw=i(Wr);Vf=n(zw,"'tf'"),zw.forEach(t),Qf=n(Bl,": Return TensorFlow "),Ur=r(Bl,"CODE",{});var jw=i(Ur);Xf=n(jw,"tf.constant"),jw.forEach(t),Gf=n(Bl," objects."),Bl.forEach(t),Kf=d(As),Et=r(As,"LI",{});var Wl=i(Et);Hr=r(Wl,"CODE",{});var Cw=i(Hr);Yf=n(Cw,"'pt'"),Cw.forEach(t),Jf=n(Wl,": Return PyTorch "),Vr=r(Wl,"CODE",{});var Pw=i(Vr);Zf=n(Pw,"torch.Tensor"),Pw.forEach(t),eg=n(Wl," objects."),Wl.forEach(t),tg=d(As),Lt=r(As,"LI",{});var Ul=i(Lt);Qr=r(Ul,"CODE",{});var Dw=i(Qr);og=n(Dw,"'np'"),Dw.forEach(t),ng=n(Ul,": Return Numpy "),Xr=r(Ul,"CODE",{});var Aw=i(Xr);sg=n(Aw,"np.ndarray"),Aw.forEach(t),ag=n(Ul," objects."),Ul.forEach(t),As.forEach(t),rg=d(re),I=r(re,"P",{});var Q=i(I);ig=n(Q,"add_special_tokens ("),Gr=r(Q,"CODE",{});var Iw=i(Gr);lg=n(Iw,"bool"),Iw.forEach(t),dg=n(Q,", "),Kr=r(Q,"EM",{});var Ow=i(Kr);cg=n(Ow,"optional"),Ow.forEach(t),pg=n(Q,", defaults to "),Yr=r(Q,"CODE",{});var Nw=i(Yr);hg=n(Nw,"True"),Nw.forEach(t),mg=n(Q,`):
Whether or not to encode the sequences with the special tokens relative to their model.
padding (`),Jr=r(Q,"CODE",{});var Sw=i(Jr);ug=n(Sw,"bool"),Sw.forEach(t),fg=n(Q,", "),Zr=r(Q,"CODE",{});var Rw=i(Zr);gg=n(Rw,"str"),Rw.forEach(t),_g=n(Q," or "),ms=r(Q,"A",{href:!0});var Bw=i(ms);kg=n(Bw,"PaddingStrategy"),Bw.forEach(t),vg=n(Q,", "),ei=r(Q,"EM",{});var Ww=i(ei);bg=n(Ww,"optional"),Ww.forEach(t),Mg=n(Q,", defaults to "),ti=r(Q,"CODE",{});var Uw=i(ti);wg=n(Uw,"False"),Uw.forEach(t),yg=n(Q,`):
...
lengths).
truncation (`),pi=r(ae,"CODE",{});var e2=i(pi);Ng=n(e2,"bool"),e2.forEach(t),Sg=n(ae,", "),hi=r(ae,"CODE",{});var t2=i(hi);Rg=n(t2,"str"),t2.forEach(t),Bg=n(ae," or "),us=r(ae,"A",{href:!0});var o2=i(us);Wg=n(o2,"TruncationStrategy"),o2.forEach(t),Ug=n(ae,", "),mi=r(ae,"EM",{});var n2=i(mi);Hg=n(n2,"optional"),n2.forEach(t),Vg=n(ae,", defaults to "),ui=r(ae,"CODE",{});var s2=i(ui);Qg=n(s2,"False"),s2.forEach(t),Xg=n(ae,`):
...
If set, will return tensors instead of list of python integers. Acceptable values are:`),$.forEach(t),f2.forEach(t),R_=d(N),Ni=r(N,"LI",{});var F2=i(Ni);jt=r(F2,"P",{});var Gl=i(jt);Si=r(Gl,"CODE",{});var z2=i(Si);B_=n(z2,"'tf'"),z2.forEach(t),W_=n(Gl,": Return TensorFlow "),Ri=r(Gl,"CODE",{});var j2=i(Ri);U_=n(j2,"tf.constant"),j2.forEach(t),H_=n(Gl," objects."),Gl.forEach(t),F2.forEach(t),V_=d(N),Bi=r(N,"LI",{});var C2=i(Bi);Ct=r(C2,"P",{});var Kl=i(Ct);Wi=r(Kl,"CODE",{});var P2=i(Wi);Q_=n(P2,"'pt'"),P2.forEach(t),X_=n(Kl,": Return PyTorch "),Ui=r(Kl,"CODE",{});var D2=i(Ui);G_=n(D2,"torch.Tensor"),D2.forEach(t),K_=n(Kl," objects."),Kl.forEach(t),C2.forEach(t),Y_=d(N),Hi=r(N,"LI",{});var A2=i(Hi);Pt=r(A2,"P",{});var Yl=i(Pt);Vi=r(Yl,"CODE",{});var I2=i(Vi);J_=n(I2,"'np'"),I2.forEach(t),Z_=n(Yl,": Return Numpy "),Qi=r(Yl,"CODE",{});var O2=i(Qi);ek=n(O2,"np.ndarray"),O2.forEach(t),tk=n(Yl," objects."),Yl.forEach(t),A2.forEach(t),N.forEach(t),re.forEach(t),ok=d(H),Ie=r(H,"DIV",{class:!0});var Is=i(Ie);v(Bo.$$.fragment,Is),nk=d(Is),Xi=r(Is,"P",{});var N2=i(Xi);sk=n(N2,`Build model inputs from a sequence or a pair of sequence for sequence classification tasks by concatenating and
adding special tokens. A RoBERTa sequence has the following format:`),N2.forEach(t),ak=d(Is),Wo=r(Is,"UL",{});var ac=i(Wo);gs=r(ac,"LI",{});var Pb=i(gs);rk=n(Pb,"single sequence: "),Gi=r(Pb,"CODE",{});var S2=i(Gi);ik=n(S2,"<s> X </s>"),S2.forEach(t),Pb.forEach(t),lk=d(ac),_s=r(ac,"LI",{});var Db=i(_s);dk=n(Db,"pair of sequences: "),Ki=r(Db,"CODE",{});var R2=i(Ki);ck=n(R2,"<s> A </s></s> B </s>"),R2.forEach(t),Db.forEach(t),ac.forEach(t),Is.forEach(t),pk=d(H),Dt=r(H,"DIV",{class:!0});var rc=i(Dt);v(Uo.$$.fragment,rc),hk=d(rc),Yi=r(rc,"P",{});var B2=i(Yi);mk=n(B2,`Create a mask from the two sequences passed to be used in a sequence-pair classification task. RoBERTa does not
make use of token type ids, therefore a list of zeros is returned.`),B2.forEach(t),rc.forEach(t),uk=d(H),At=r(H,"DIV",{class:!0});var ic=i(At);v(Ho.$$.fragment,ic),fk=d(ic),Vo=r(ic,"P",{});var lc=i(Vo);gk=n(lc,`Tokenize and prepare for the model a sequence or a pair of sequences. .. warning:: This method is deprecated,
...
returns the output.`),ye.forEach(t),iv=d(Zt),Jo=r(Zt,"P",{});var pc=i(Jo);lv=n(pc,"Optionally, one can also provide a "),ml=r(pc,"CODE",{});var dy=i(ml);dv=n(dy,"text"),dy.forEach(t),cv=n(pc," argument which is passed along as first sequence."),pc.forEach(t),pv=d(Zt),ul=r(Zt,"P",{});var cy=i(ul);hv=n(cy,"Please refer to the docstring of the above two methods for more information."),cy.forEach(t),Zt.forEach(t),Ne.forEach(t),Sd=d(s),Ye=r(s,"H2",{class:!0});var hc=i(Ye);Nt=r(hc,"A",{id:!0,class:!0,href:!0});var py=i(Nt);fl=r(py,"SPAN",{});var hy=i(fl);v(Zo.$$.fragment,hy),hy.forEach(t),py.forEach(t),mv=d(hc),gl=r(hc,"SPAN",{});var my=i(gl);uv=n(my,"MarkupLMModel"),my.forEach(t),hc.forEach(t),Rd=d(s),Ee=r(s,"DIV",{class:!0});var Os=i(Ee);v(en.$$.fragment,Os),fv=d(Os),tn=r(Os,"P",{});var mc=i(tn);gv=n(mc,`The bare MarkupLM Model transformer outputting raw hidden-states without any specific head on top.
This model is a PyTorch `),on=r(mc,"A",{href:!0,rel:!0});var uy=i(on);_v=n(uy,"torch.nn.Module"),uy.forEach(t),kv=n(mc,` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),mc.forEach(t),vv=d(Os),ge=r(Os,"DIV",{class:!0});var eo=i(ge);v(nn.$$.fragment,eo),bv=d(eo),Je=r(eo,"P",{});var Ns=i(Je);Mv=n(Ns,"The "),ys=r(Ns,"A",{href:!0});var fy=i(ys);wv=n(fy,"MarkupLMModel"),fy.forEach(t),yv=n(Ns," forward method, overrides the "),_l=r(Ns,"CODE",{});var gy=i(_l);xv=n(gy,"__call__"),gy.forEach(t),Tv=n(Ns," special method."),Ns.forEach(t),Ev=d(eo),v(St.$$.fragment,eo),Lv=d(eo),v(Rt.$$.fragment,eo),eo.forEach(t),Os.forEach(t),Bd=d(s),Ze=r(s,"H2",{class:!0});var uc=i(Ze);Bt=r(uc,"A",{id:!0,class:!0,href:!0});var _y=i(Bt);kl=r(_y,"SPAN",{});var ky=i(kl);v(sn.$$.fragment,ky),ky.forEach(t),_y.forEach(t),qv=d(uc),vl=r(uc,"SPAN",{});var vy=i(vl);$v=n(vy,"MarkupLMForSequenceClassification"),vy.forEach(t),uc.forEach(t),Wd=d(s),he=r(s,"DIV",{class:!0});var to=i(he);v(an.$$.fragment,to),Fv=d(to),bl=r(to,"P",{});var by=i(bl);zv=n(by,`MarkupLM Model transformer with a sequence classification/regression head on top (a linear layer on top of the
...
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),fc.forEach(t),Av=d(to),_e=r(to,"DIV",{class:!0});var oo=i(_e);v(dn.$$.fragment,oo),Iv=d(oo),et=r(oo,"P",{});var Ss=i(et);Ov=n(Ss,"The "),xs=r(Ss,"A",{href:!0});var wy=i(xs);Nv=n(wy,"MarkupLMForSequenceClassification"),wy.forEach(t),Sv=n(Ss," forward method, overrides the "),Ml=r(Ss,"CODE",{});var yy=i(Ml);Rv=n(yy,"__call__"),yy.forEach(t),Bv=n(Ss," special method."),Ss.forEach(t),Wv=d(oo),v(Wt.$$.fragment,oo),Uv=d(oo),v(Ut.$$.fragment,oo),oo.forEach(t),to.forEach(t),Ud=d(s),tt=r(s,"H2",{class:!0});var gc=i(tt);Ht=r(gc,"A",{id:!0,class:!0,href:!0});var xy=i(Ht);wl=r(xy,"SPAN",{});var Ty=i(wl);v(cn.$$.fragment,Ty),Ty.forEach(t),xy.forEach(t),Hv=d(gc),yl=r(gc,"SPAN",{});var Ey=i(yl);Vv=n(Ey,"MarkupLMForTokenClassification"),Ey.forEach(t),gc.forEach(t),Hd=d(s),Le=r(s,"DIV",{class:!0});var Rs=i(Le);v(pn.$$.fragment,Rs),Qv=d(Rs),ot=r(Rs,"P",{});var Bs=i(ot);Xv=n(Bs,"MarkupLM Model with a "),xl=r(Bs,"CODE",{});var Ly=i(xl);Gv=n(Ly,"token_classification"),Ly.forEach(t),Kv=n(Bs,` head on top.
This model is a PyTorch `),hn=r(Bs,"A",{href:!0,rel:!0});var qy=i(hn);Yv=n(qy,"torch.nn.Module"),qy.forEach(t),Jv=n(Bs,` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),Bs.forEach(t),Zv=d(Rs),ke=r(Rs,"DIV",{class:!0});var no=i(ke);v(mn.$$.fragment,no),eb=d(no),nt=r(no,"P",{});var Ws=i(nt);tb=n(Ws,"The "),Ts=r(Ws,"A",{href:!0});var $y=i(Ts);ob=n($y,"MarkupLMForTokenClassification"),$y.forEach(t),nb=n(Ws," forward method, overrides the "),Tl=r(Ws,"CODE",{});var Fy=i(Tl);sb=n(Fy,"__call__"),Fy.forEach(t),ab=n(Ws," special method."),Ws.forEach(t),rb=d(no),v(Vt.$$.fragment,no),ib=d(no),v(Qt.$$.fragment,no),no.forEach(t),Rs.forEach(t),Vd=d(s),st=r(s,"H2",{class:!0});var _c=i(st);Xt=r(_c,"A",{id:!0,class:!0,href:!0});var zy=i(Xt);El=r(zy,"SPAN",{});var jy=i(El);v(un.$$.fragment,jy),jy.forEach(t),zy.forEach(t),lb=d(_c),Ll=r(_c,"SPAN",{});var Cy=i(Ll);db=n(Cy,"MarkupLMForQuestionAnswering"),Cy.forEach(t),_c.forEach(t),Qd=d(s),me=r(s,"DIV",{class:!0});var so=i(me);v(fn.$$.fragment,so),cb=d(so),at=r(so,"P",{});var Us=i(at);pb=n(Us,`MarkupLM Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
layers on top of the hidden-states output to compute `),ql=r(Us,"CODE",{});var Py=i(ql);hb=n(Py,"span start logits"),Py.forEach(t),mb=n(Us," and "),$l=r(Us,"CODE",{});var Dy=i($l);ub=n(Dy,"span end logits"),Dy.forEach(t),fb=n(Us,")."),Us.forEach(t),gb=d(so),gn=r(so,"P",{});var kc=i(gn);_b=n(kc,"This model is a PyTorch "),_n=r(kc,"A",{href:!0,rel:!0});var Ay=i(_n);kb=n(Ay,"torch.nn.Module"),Ay.forEach(t),vb=n(kc,` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),kc.forEach(t),bb=d(so),ve=r(so,"DIV",{class:!0});var ao=i(ve);v(kn.$$.fragment,ao),Mb=d(ao),rt=r(ao,"P",{});var Hs=i(rt);wb=n(Hs,"The "),Es=r(Hs,"A",{href:!0});var Iy=i(Es);yb=n(Iy,"MarkupLMForQuestionAnswering"),Iy.forEach(t),xb=n(Hs," forward method, overrides the "),Fl=r(Hs,"CODE",{});var Oy=i(Fl);Tb=n(Oy,"__call__"),Oy.forEach(t),Eb=n(Hs," special method."),Hs.forEach(t),Lb=d(ao),v(Gt.$$.fragment,ao),qb=d(ao),v(Kt.$$.fragment,ao),ao.forEach(t),so.forEach(t),this.h()},h(){c(u,"name","hf:doc:metadata"),c(u,"content",JSON.stringify(ox)),c(g,"id","markuplm"),c(g,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(g,"href","#markuplm"),c(_,"class","relative group"),c(ct,"id","overview"),c(ct,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(ct,"href","#overview"),c(Se,"class","relative group"),c(io,"href","https://arxiv.org/abs/2110.08518"),c(io,"rel","nofollow"),c(yn,"href","layoutlm"),c(lo,"href","https://x-lance.github.io/WebSRC/"),c(lo,"rel","nofollow"),c(co,"href","https://www.researchgate.net/publication/221299838_From_one_tree_to_a_forest_a_unified_solution_for_structured_web_data_extraction"),c(co,"rel","nofollow"),c(Fn,"href","/docs/transformers/main/en/model_doc/markuplm#transformers.MarkupLMModel.forward"),c(zn,"href","/docs/transformers/main/en/model_doc/markuplm#transformers.MarkupLMProcessor"),c(jn,"href","#usage-markuplmprocessor"),c(ho,"href","https://github.com/NielsRogge/Transformers-Tutorials/tree/master/MarkupLM"),c(ho,"rel","nofollow"),Wy(ht.src,Ob="https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/transformers/model_doc/markuplm_architecture.jpg")||c(ht,"src",Ob),c(ht,"alt","drawing"),c(ht,"width","600"),c(Cn,"href","https://arxiv.org/abs/2110.08518"),c(uo,"href","https://huggingface.co/nielsr"),c(uo,"rel","nofollow"),c(fo,"href","https://github.com/microsoft/unilm/tree/master/markuplm"),c(fo,"rel","nofollow"),c(mt,"id","usage-markuplmprocessor"),c(mt,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(mt,"href","#usage-markuplmprocessor"),c(Be,"class","relative group"),c(Pn,"href","/docs/transformers/main/en/model_doc/markuplm#transformers.MarkupLMProcessor"),c(Dn,"href","/docs/transformers/main/en/model_doc/markuplm#transformers.MarkupLMFeatureExtractor"),c(An,"href","/docs/transformers/main/en/model_doc/markuplm#transformers.MarkupLMTokenizer"),c(In,"href","/docs/transformers/main/en/model_doc/markuplm#transformers.MarkupLMTokenizerFast"),c(On,"href","/docs/transformers/main/en/model_doc/markuplm#transformers.MarkupLMProcessor"),c(Nn,"href","/docs/transformers/main/en/model_doc/markuplm#transformers.MarkupLMFeatureExtractor"),c(Sn,"href","/docs/transformers/main/en/model_doc/markuplm#transformers.MarkupLMTokenizer"),c(Rn,"href","/docs/transformers/main/en/model_doc/markuplm#transformers.MarkupLMTokenizerFast"),c(Bn,"href","/docs/transformers/main/en/model_doc/markuplm#transformers.MarkupLMFeatureExtractor"),c(ko,"href","https://www.crummy.com/software/BeautifulSoup/bs4/doc/"),c(ko,"rel","nofollow"),c(Wn,"href","/docs/transformers/main/en/model_doc/markuplm#transformers.MarkupLMTokenizer"),c(Un,"href","/docs/transformers/main/en/model_doc/markuplm#transformers.MarkupLMTokenizerFast"),c(Mo,"href","https://paperswithcode.com/dataset/swde"),c(Mo,"rel","nofollow"),c(ut,"id","transformers.MarkupLMConfig"),c(ut,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(ut,"href","#transformers.MarkupLMConfig"),c(We,"class","relative group"),c(Zn,"href","/docs/transformers/main/en/model_doc/markuplm#transformers.MarkupLMModel"),c(Lo,"href","https://huggingface.co/microsoft/markuplm-base"),c(Lo,"rel","nofollow"),c(es,"href","/docs/transformers/main/en/model_doc/bert#transformers.BertConfig"),c(ts,"href","/docs/transformers/main/en/model_doc/bert#transformers.BertConfig"),c(ce,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),c(gt,"id","transformers.MarkupLMFeatureExtractor"),c(gt,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(gt,"href","#transformers.MarkupLMFeatureExtractor"),c(Ve,"class","relative group"),c(Ce,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),c(pe,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),c(kt,"id","transformers.MarkupLMTokenizer"),c(kt,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(kt,"href","#transformers.MarkupLMTokenizer"),c(Qe,"class","relative group"),c(os,"href","/docs/transformers/main/en/model_doc/markuplm#transformers.MarkupLMTokenizer"),c(ns,"href","/docs/transformers/main/en/main_classes/tokenizer#transformers.PreTrainedTokenizer"),c(Pe,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),c(rs,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),c(vt,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),c(is,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),c(K,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),c(bt,"id","transformers.MarkupLMTokenizerFast"),c(bt,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(bt,"href","#transformers.MarkupLMTokenizerFast"),c(Xe,"class","relative group"),c(ls,"href","/docs/transformers/main/en/model_doc/markuplm#transformers.MarkupLMTokenizerFast"),c(ds,"href","/docs/transformers/main/en/main_classes/tokenizer#transformers.PreTrainedTokenizer"),c(cs,"href","/docs/transformers/main/en/internal/file_utils#transformers.utils.PaddingStrategy"),c(ps,"href","/docs/transformers/main/en/internal/tokenization_utils#transformers.tokenization_utils_base.TruncationStrategy"),c(hs,"href","/docs/transformers/main/en/internal/file_utils#transformers.TensorType"),c(ms,"href","/docs/transformers/main/en/internal/file_utils#transformers.utils.PaddingStrategy"),c(us,"href","/docs/transformers/main/en/internal/tokenization_utils#transformers.tokenization_utils_base.TruncationStrategy"),c(fs,"href","/docs/transformers/main/en/internal/file_utils#transformers.TensorType"),c(B,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),c(Ie,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),c(Dt,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),c(At,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),c(It,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),c(j,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),c(Ot,"id","transformers.MarkupLMProcessor"),c(Ot,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(Ot,"href","#transformers.MarkupLMProcessor"),c(Ke,"class","relative group"),c(vs,"href","/docs/transformers/main/en/model_doc/markuplm#transformers.MarkupLMProcessor"),c(bs,"href","/docs/transformers/main/en/model_doc/markuplm#transformers.MarkupLMFeatureExtractor"),c(Ms,"href","/docs/transformers/main/en/model_doc/markuplm#transformers.MarkupLMTokenizer"),c(ws,"href","/docs/transformers/main/en/model_doc/markuplm#transformers.MarkupLMTokenizerFast"),c(Yo,"href","/docs/transformers/main/en/model_doc/markuplm#transformers.MarkupLMFeatureExtractor.__call__"),c(fe,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),c(te,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),c(Nt,"id","transformers.MarkupLMModel"),c(Nt,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(Nt,"href","#transformers.MarkupLMModel"),c(Ye,"class","relative group"),c(on,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),c(on,"rel","nofollow"),c(ys,"href","/docs/transformers/main/en/model_doc/markuplm#transformers.MarkupLMModel"),c(ge,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),c(Ee,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),c(Bt,"id","transformers.MarkupLMForSequenceClassification"),c(Bt,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(Bt,"href","#transformers.MarkupLMForSequenceClassification"),c(Ze,"class","relative group"),c(ln,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),c(ln,"rel","nofollow"),c(xs,"href","/docs/transformers/main/en/model_doc/markuplm#transformers.MarkupLMForSequenceClassification"),c(_e,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),c(he,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),c(Ht,"id","transformers.MarkupLMForTokenClassification"),c(Ht,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(Ht,"href","#transformers.MarkupLMForTokenClassification"),c(tt,"class","relative group"),c(hn,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),c(hn,"rel","nofollow"),c(Ts,"href","/docs/transformers/main/en/model_doc/markuplm#transformers.MarkupLMForTokenClassification"),c(ke,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),c(Le,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),c(Xt,"id","transformers.MarkupLMForQuestionAnswering"),c(Xt,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(Xt,"href","#transformers.MarkupLMForQuestionAnswering"),c(st,"class","relative group"),c(_n,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),c(_n,"rel","nofollow"),c(Es,"href","/docs/transformers/main/en/model_doc/markuplm#transformers.MarkupLMForQuestionAnswering"),c(ve,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),c(me,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8")},m(s,h){e(document.head,u),m(s,T,h),m(s,_,h),e(_,g),e(g,x),b(p,x,null),e(_,f),e(_,G),e(G,bc),m(s,Jl,h),m(s,Se,h),e(Se,ct),e(ct,Xs),b(ro,Xs,null),e(Se,Mc),e(Se,Gs),e(Gs,wc),m(s,Zl,h),m(s,qe,h),e(qe,yc),e(qe,io),e(io,xc),e(qe,Tc),e(qe,yn),e(yn,Ec),e(qe,Lc),m(s,ed,h),m(s,xn,h),e(xn,qc),m(s,td,h),m(s,pt,h),e(pt,Tn),e(Tn,lo),e(lo,$c),e(Tn,Fc),e(pt,zc),e(pt,En),e(En,co),e(co,jc),e(En,Cc),m(s,od,h),m(s,Ln,h),e(Ln,Pc),m(s,nd,h),m(s,qn,h),e(qn,Ks),e(Ks,Dc),m(s,sd,h),m(s,$n,h),e($n,Ac),m(s,ad,h),m(s,$e,h),e($e,le),e(le,Ic),e(le,Ys),e(Ys,Oc),e(le,Nc),e(le,Fn),e(Fn,Sc),e(le,Rc),e(le,Js),e(Js,Bc),e(le,Wc),e(le,Zs),e(Zs,Uc),e(le,Hc),e($e,Vc),e($e,Re),e(Re,Qc),e(Re,zn),e(zn,Xc),e(Re,Gc),e(Re,jn),e(jn,Kc),e(Re,Yc),e($e,Jc),e($e,po),e(po,Zc),e(po,ho),e(ho,ep),e(po,tp),m(s,rd,h),m(s,ht,h),m(s,id,h),m(s,mo,h),e(mo,op),e(mo,Cn),e(Cn,np),m(s,ld,h),m(s,Fe,h),e(Fe,sp),e(Fe,uo),e(uo,ap),e(Fe,rp),e(Fe,fo),e(fo,ip),e(Fe,lp),m(s,dd,h),m(s,Be,h),e(Be,mt),e(mt,ea),b(go,ea,null),e(Be,dp),e(Be,ta),e(ta,cp),m(s,cd,h),m(s,J,h),e(J,pp),e(J,Pn),e(Pn,hp),e(J,mp),e(J,Dn),e(Dn,up),e(J,fp),e(J,An),e(An,gp),e(J,_p),e(J,In),e(In,kp),e(J,vp),e(J,oa),e(oa,bp),e(J,Mp),m(s,pd,h),b(_o,s,h),m(s,hd,h),m(s,F,h),e(F,wp),e(F,On),e(On,yp),e(F,xp),e(F,Nn),e(Nn,Tp),e(F,Ep),e(F,Sn),e(Sn,Lp),e(F,qp),e(F,Rn),e(Rn,$p),e(F,Fp),e(F,na),e(na,zp),e(F,jp),e(F,sa),e(sa,Cp),e(F,Pp),e(F,aa),e(aa,Dp),e(F,Ap),e(F,ra),e(ra,Ip),e(F,Op),e(F,ia),e(ia,Np),e(F,Sp),e(F,la),e(la,Rp),e(F,Bp),m(s,md,h),m(s,de,h),e(de,Bn),e(Bn,Wp),e(de,Up),e(de,ko),e(ko,Hp),e(de,Vp),e(de,Wn),e(Wn,Qp),e(de,Xp),e(de,Un),e(Un,Gp),e(de,Kp),m(s,ud,h),m(s,Hn,h),e(Hn,Yp),m(s,fd,h),m(s,Vn,h),e(Vn,da),e(da,Jp),m(s,gd,h),m(s,Qn,h),e(Qn,Zp),m(s,_d,h),b(vo,s,h),m(s,kd,h),m(s,Xn,h),e(Xn,ca),e(ca,eh),m(s,vd,h),m(s,ze,h),e(ze,th),e(ze,pa),e(pa,oh),e(ze,nh),e(ze,ha),e(ha,sh),e(ze,ah),m(s,bd,h),b(bo,s,h),m(s,Md,h),m(s,Gn,h),e(Gn,ma),e(ma,rh),m(s,wd,h),m(s,Z,h),e(Z,ih),e(Z,Mo),e(Mo,lh),e(Z,dh),e(Z,ua),e(ua,ch),e(Z,ph),e(Z,fa),e(fa,hh),e(Z,mh),e(Z,ga),e(ga,uh),e(Z,fh),e(Z,_a),e(_a,gh),e(Z,_h),m(s,yd,h),b(wo,s,h),m(s,xd,h),m(s,Kn,h),e(Kn,ka),e(ka,kh),m(s,Td,h),m(s,Yn,h),e(Yn,vh),m(s,Ed,h),b(yo,s,h),m(s,Ld,h),m(s,Jn,h),e(Jn,va),e(va,bh),m(s,qd,h),m(s,je,h),e(je,Mh),e(je,ba),e(ba,wh),e(je,yh),e(je,Ma),e(Ma,xh),e(je,Th),m(s,$d,h),b(xo,s,h),m(s,Fd,h),m(s,We,h),e(We,ut),e(ut,wa),b(To,wa,null),e(We,Eh),e(We,ya),e(ya,Lh),m(s,zd,h),m(s,ce,h),b(Eo,ce,null),e(ce,qh),e(ce,Ue),e(Ue,$h),e(Ue,Zn),e(Zn,Fh),e(Ue,zh),e(Ue,Lo),e(Lo,jh),e(Ue,Ch),e(ce,Ph),e(ce,He),e(He,Dh),e(He,es),e(es,Ah),e(He,Ih),e(He,ts),e(ts,Oh),e(He,Nh),e(ce,Sh),b(ft,ce,null),m(s,jd,h),m(s,Ve,h),e(Ve,gt),e(gt,xa),b(qo,xa,null),e(Ve,Rh),e(Ve,Ta),e(Ta,Bh),m(s,Cd,h),m(s,pe,h),b($o,pe,null),e(pe,Wh),e(pe,Ea),e(Ea,Uh),e(pe,Hh),e(pe,Fo),e(Fo,Vh),e(Fo,La),e(La,Qh),e(Fo,Xh),e(pe,Gh),e(pe,Ce),b(zo,Ce,null),e(Ce,Kh),e(Ce,qa),e(qa,Yh),e(Ce,Jh),b(_t,Ce,null),m(s,Pd,h),m(s,Qe,h),e(Qe,kt),e(kt,$a),b(jo,$a,null),e(Qe,Zh),e(Qe,Fa),e(Fa,em),m(s,Dd,h),m(s,K,h),b(Co,K,null),e(K,tm),e(K,S),e(S,om),e(S,os),e(os,nm),e(S,sm),e(S,za),e(za,am),e(S,rm),e(S,ja),e(ja,im),e(S,lm),e(S,Ca),e(Ca,dm),e(S,cm),e(S,Pa),e(Pa,pm),e(S,hm),e(S,Da),e(Da,mm),e(S,um),e(S,ns),e(ns,fm),e(S,gm),e(K,_m),e(K,Pe),b(Po,Pe,null),e(Pe,km),e(Pe,Aa),e(Aa,vm),e(Pe,bm),e(Pe,Do),e(Do,ss),e(ss,Mm),e(ss,Ia),e(Ia,wm),e(Do,ym),e(Do,as),e(as,xm),e(as,Oa),e(Oa,Tm),e(K,Em),e(K,rs),b(Ao,rs,null),e(K,Lm),e(K,vt),b(Io,vt,null),e(vt,qm),e(vt,Na),e(Na,$m),e(K,Fm),e(K,is),b(Oo,is,null),m(s,Ad,h),m(s,Xe,h),e(Xe,bt),e(bt,Sa),b(No,Sa,null),e(Xe,zm),e(Xe,Ra),e(Ra,jm),m(s,Id,h),m(s,j,h),b(So,j,null),e(j,Cm),e(j,Ba),e(Ba,Pm),e(j,Dm),e(j,R),e(R,ls),e(ls,Am),e(R,Im),e(R,Wa),e(Wa,Om),e(R,Nm),e(R,Ua),e(Ua,Sm),e(R,Rm),e(R,Ha),e(Ha,Bm),e(R,Wm),e(R,Va),e(Va,Um),e(R,Hm),e(R,Qa),e(Qa,Vm),e(R,Qm),e(R,ds),e(ds,Xm),e(R,Gm),e(j,Km),e(j,Xa),e(Xa,Ym),e(j,Jm),e(j,B),b(Ro,B,null),e(B,Zm),e(B,A),e(A,eu),e(A,Ga),e(Ga,tu),e(A,ou),e(A,Ka),e(Ka,nu),e(A,su),e(A,Ya),e(Ya,au),e(A,ru),e(A,Ja),e(Ja,iu),e(A,lu),e(A,Za),e(Za,du),e(A,cu),e(A,cs),e(cs,pu),e(A,hu),e(A,er),e(er,mu),e(A,uu),e(A,tr),e(tr,fu),e(A,gu),e(B,_u),e(B,Y),e(Y,or),e(or,Mt),e(Mt,nr),e(nr,ku),e(Mt,vu),e(Mt,sr),e(sr,bu),e(Mt,Mu),e(Y,wu),e(Y,ar),e(ar,wt),e(wt,rr),e(rr,yu),e(wt,xu),e(wt,ir),e(ir,Tu),e(wt,Eu),e(Y,Lu),e(Y,lr),e(lr,W),e(W,dr),e(dr,qu),e(W,$u),e(W,cr),e(cr,Fu),e(W,zu),e(W,pr),e(pr,ju),e(W,Cu),e(W,hr),e(hr,Pu),e(W,Du),e(W,ps),e(ps,Au),e(W,Iu),e(W,mr),e(mr,Ou),e(W,Nu),e(W,ur),e(ur,Su),e(W,Ru),e(Y,Bu),e(Y,fr),e(fr,De),e(De,gr),e(gr,Wu),e(De,Uu),e(De,_r),e(_r,Hu),e(De,Vu),e(De,kr),e(kr,Qu),e(De,Xu),e(Y,Gu),e(Y,vr),e(vr,yt),e(yt,br),e(br,Ku),e(yt,Yu),e(yt,Mr),e(Mr,Ju),e(yt,Zu),e(Y,ef),e(Y,wr),e(wr,xt),e(xt,yr),e(yr,tf),e(xt,of),e(xt,xr),e(xr,nf),e(xt,sf),e(Y,af),e(Y,Tr),e(Tr,ue),e(ue,Er),e(Er,rf),e(ue,lf),e(ue,Lr),e(Lr,df),e(ue,cf),e(ue,qr),e(qr,pf),e(ue,hf),e(ue,$r),e($r,mf),e(ue,uf),e(B,ff),e(B,E),e(E,gf),e(E,Fr),e(Fr,_f),e(E,kf),e(E,zr),e(zr,vf),e(E,bf),e(E,jr),e(jr,Mf),e(E,wf),e(E,Cr),e(Cr,yf),e(E,xf),e(E,Pr),e(Pr,Tf),e(E,Ef),e(E,Dr),e(Dr,Lf),e(E,qf),e(E,Ar),e(Ar,$f),e(E,Ff),e(E,Ir),e(Ir,zf),e(E,jf),e(E,Or),e(Or,Cf),e(E,Pf),e(E,Nr),e(Nr,Df),e(E,Af),e(E,Sr),e(Sr,If),e(E,Of),e(E,Rr),e(Rr,Nf),e(E,Sf),e(E,hs),e(hs,Rf),e(E,Bf),e(E,Br),e(Br,Wf),e(E,Uf),e(B,Hf),e(B,Ge),e(Ge,Tt),e(Tt,Wr),e(Wr,Vf),e(Tt,Qf),e(Tt,Ur),e(Ur,Xf),e(Tt,Gf),e(Ge,Kf),e(Ge,Et),e(Et,Hr),e(Hr,Yf),e(Et,Jf),e(Et,Vr),e(Vr,Zf),e(Et,eg),e(Ge,tg),e(Ge,Lt),e(Lt,Qr),e(Qr,og),e(Lt,ng),e(Lt,Xr),e(Xr,sg),e(Lt,ag),e(B,rg),e(B,I),e(I,ig),e(I,Gr),e(Gr,lg),e(I,dg),e(I,Kr),e(Kr,cg),e(I,pg),e(I,Yr),e(Yr,hg),e(I,mg),e(I,Jr),e(Jr,ug),e(I,fg),e(I,Zr),e(Zr,gg),e(I,_g),e(I,ms),e(ms,kg),e(I,vg),e(I,ei),e(ei,bg),e(I,Mg),e(I,ti),e(ti,wg),e(I,yg),e(B,xg),e(B,C),e(C,oi),e(oi,qt),e(qt,ni),e(ni,Tg),e(qt,Eg),e(qt,si),e(si,Lg),e(qt,qg),e(C,$g),e(C,ai),e(ai,$t),e($t,ri),e(ri,Fg),e($t,zg),e($t,ii),e(ii,jg),e($t,Cg),e(C,Pg),e(C,li),e(li,U),e(U,di),e(di,Dg),e(U,Ag),e(U,ci),e(ci,Ig),e(U,Og),e(U,pi),e(pi,Ng),e(U,Sg),e(U,hi),e(hi,Rg),e(U,Bg),e(U,us),e(us,Wg),e(U,Ug),e(U,mi),e(mi,Hg),e(U,Vg),e(U,ui),e(ui,Qg),e(U,Xg),e(C,Gg),e(C,fi),e(fi,Ae),e(Ae,gi),e(gi,Kg),e(Ae,Yg),e(Ae,_i),e(_i,Jg),e(Ae,Zg),e(Ae,ki),e(ki,e_),e(Ae,t_),e(C,o_),e(C,vi),e(vi,Ft),e(Ft,bi),e(bi,n_),e(Ft,s_),e(Ft,Mi),e(Mi,a_),e(Ft,r_),e(C,i_),e(C,wi),e(wi,zt),e(zt,yi),e(yi,l_),e(zt,d_),e(zt,xi),e(xi,c_),e(zt,p_),e(C,h_),e(C,Ti),e(Ti,L),e(L,Ei),e(Ei,m_),e(L,u_),e(L,Li),e(Li,f_),e(L,g_),e(L,qi),e(qi,__),e(L,k_),e(L,$i),e($i,v_),e(L,b_),e(L,Fi),e(Fi,M_),e(L,w_),e(L,zi),e(zi,y_),e(L,x_),e(L,ji),e(ji,T_),e(L,E_),e(L,Ci),e(Ci,L_),e(L,q_),e(L,Pi),e(Pi,$_),e(L,F_),e(L,Di),e(Di,z_),e(L,j_),e(L,Ai),e(Ai,C_),e(L,P_),e(L,Ii),e(Ii,D_),e(L,A_),e(L,fs),e(fs,I_),e(L,O_),e(L,Oi),e(Oi,N_),e(L,S_),e(C,R_),e(C,Ni),e(Ni,jt),e(jt,Si),e(Si,B_),e(jt,W_),e(jt,Ri),e(Ri,U_),e(jt,H_),e(C,V_),e(C,Bi),e(Bi,Ct),e(Ct,Wi),e(Wi,Q_),e(Ct,X_),e(Ct,Ui),e(Ui,G_),e(Ct,K_),e(C,Y_),e(C,Hi),e(Hi,Pt),e(Pt,Vi),e(Vi,J_),e(Pt,Z_),e(Pt,Qi),e(Qi,ek),e(Pt,tk),e(j,ok),e(j,Ie),b(Bo,Ie,null),e(Ie,nk),e(Ie,Xi),e(Xi,sk),e(Ie,ak),e(Ie,Wo),e(Wo,gs),e(gs,rk),e(gs,Gi),e(Gi,ik),e(Wo,lk),e(Wo,_s),e(_s,dk),e(_s,Ki),e(Ki,ck),e(j,pk),e(j,Dt),b(Uo,Dt,null),e(Dt,hk),e(Dt,Yi),e(Yi,mk),e(j,uk),e(j,At),b(Ho,At,null),e(At,fk),e(At,Vo),e(Vo,gk),e(Vo,Ji),e(Ji,_k),e(Vo,kk),e(j,vk),e(j,It),b(Qo,It,null),e(It,bk),e(It,Zi),e(Zi,Mk),m(s,Od,h),m(s,Ke,h),e(Ke,Ot),e(Ot,el),b(Xo,el,null),e(Ke,wk),e(Ke,tl),e(tl,yk),m(s,Nd,h),m(s,te,h),b(Go,te,null),e(te,xk),e(te,ol),e(ol,Tk),e(te,Ek),e(te,ks),e(ks,vs),e(vs,Lk),e(ks,qk),e(te,$k),e(te,O),e(O,Fk),e(O,bs),e(bs,zk),e(O,jk),e(O,Ms),e(Ms,Ck),e(O,Pk),e(O,ws),e(ws,Dk),e(O,Ak),e(O,nl),e(nl,Ik),e(O,Ok),e(O,sl),e(sl,Nk),e(O,Sk),e(O,al),e(al,Rk),e(O,Bk),e(O,rl),e(rl,Wk),e(O,Uk),e(O,il),e(il,Hk),e(O,Vk),e(te,Qk),e(te,fe),b(Ko,fe,null),e(fe,Xk),e(fe,oe),e(oe,Gk),e(oe,ll),e(ll,Kk),e(oe,Yk),e(oe,Yo),e(Yo,dl),e(dl,Jk),e(Yo,Zk),e(oe,ev),e(oe,cl),e(cl,tv),e(oe,ov),e(oe,pl),e(pl,nv),e(oe,sv),e(oe,hl),e(hl,av),e(oe,rv),e(fe,iv),e(fe,Jo),e(Jo,lv),e(Jo,ml),e(ml,dv),e(Jo,cv),e(fe,pv),e(fe,ul),e(ul,hv),m(s,Sd,h),m(s,Ye,h),e(Ye,Nt),e(Nt,fl),b(Zo,fl,null),e(Ye,mv),e(Ye,gl),e(gl,uv),m(s,Rd,h),m(s,Ee,h),b(en,Ee,null),e(Ee,fv),e(Ee,tn),e(tn,gv),e(tn,on),e(on,_v),e(tn,kv),e(Ee,vv),e(Ee,ge),b(nn,ge,null),e(ge,bv),e(ge,Je),e(Je,Mv),e(Je,ys),e(ys,wv),e(Je,yv),e(Je,_l),e(_l,xv),e(Je,Tv),e(ge,Ev),b(St,ge,null),e(ge,Lv),b(Rt,ge,null),m(s,Bd,h),m(s,Ze,h),e(Ze,Bt),e(Bt,kl),b(sn,kl,null),e(Ze,qv),e(Ze,vl),e(vl,$v),m(s,Wd,h),m(s,he,h),b(an,he,null),e(he,Fv),e(he,bl),e(bl,zv),e(he,jv),e(he,rn),e(rn,Cv),e(rn,ln),e(ln,Pv),e(rn,Dv),e(he,Av),e(he,_e),b(dn,_e,null),e(_e,Iv),e(_e,et),e(et,Ov),e(et,xs),e(xs,Nv),e(et,Sv),e(et,Ml),e(Ml,Rv),e(et,Bv),e(_e,Wv),b(Wt,_e,null),e(_e,Uv),b(Ut,_e,null),m(s,Ud,h),m(s,tt,h),e(tt,Ht),e(Ht,wl),b(cn,wl,null),e(tt,Hv),e(tt,yl),e(yl,Vv),m(s,Hd,h),m(s,Le,h),b(pn,Le,null),e(Le,Qv),e(Le,ot),e(ot,Xv),e(ot,xl),e(xl,Gv),e(ot,Kv),e(ot,hn),e(hn,Yv),e(ot,Jv),e(Le,Zv),e(Le,ke),b(mn,ke,null),e(ke,eb),e(ke,nt),e(nt,tb),e(nt,Ts),e(Ts,ob),e(nt,nb),e(nt,Tl),e(Tl,sb),e(nt,ab),e(ke,rb),b(Vt,ke,null),e(ke,ib),b(Qt,ke,null),m(s,Vd,h),m(s,st,h),e(st,Xt),e(Xt,El),b(un,El,null),e(st,lb),e(st,Ll),e(Ll,db),m(s,Qd,h),m(s,me,h),b(fn,me,null),e(me,cb),e(me,at),e(at,pb),e(at,ql),e(ql,hb),e(at,mb),e(at,$l),e($l,ub),e(at,fb),e(me,gb),e(me,gn),e(gn,_b),e(gn,_n),e(_n,kb),e(gn,vb),e(me,bb),e(me,ve),b(kn,ve,null),e(ve,Mb),e(ve,rt),e(rt,wb),e(rt,Es),e(Es,yb),e(rt,xb),e(rt,Fl),e(Fl,Tb),e(rt,Eb),e(ve,Lb),b(Gt,ve,null),e(ve,qb),b(Kt,ve,null),Xd=!0},p(s,[h]){const vn={};h&2&&(vn.$$scope={dirty:h,ctx:s}),ft.$set(vn);const zl={};h&2&&(zl.$$scope={dirty:h,ctx:s}),_t.$set(zl);const jl={};h&2&&(jl.$$scope={dirty:h,ctx:s}),St.$set(jl);const Cl={};h&2&&(Cl.$$scope={dirty:h,ctx:s}),Rt.$set(Cl);const bn={};h&2&&(bn.$$scope={dirty:h,ctx:s}),Wt.$set(bn);const Pl={};h&2&&(Pl.$$scope={dirty:h,ctx:s}),Ut.$set(Pl);const Dl={};h&2&&(Dl.$$scope={dirty:h,ctx:s}),Vt.$set(Dl);const Al={};h&2&&(Al.$$scope={dirty:h,ctx:s}),Qt.$set(Al);const it={};h&2&&(it.$$scope={dirty:h,ctx:s}),Gt.$set(it);const Il={};h&2&&(Il.$$scope={dirty:h,ctx:s}),Kt.$set(Il)},i(s){Xd||(M(p.$$.fragment,s),M(ro.$$.fragment,s),M(go.$$.fragment,s),M(_o.$$.fragment,s),M(vo.$$.fragment,s),M(bo.$$.fragment,s),M(wo.$$.fragment,s),M(yo.$$.fragment,s),M(xo.$$.fragment,s),M(To.$$.fragment,s),M(Eo.$$.fragment,s),M(ft.$$.fragment,s),M(qo.$$.fragment,s),M($o.$$.fragment,s),M(zo.$$.fragment,s),M(_t.$$.fragment,s),M(jo.$$.fragment,s),M(Co.$$.fragment,s),M(Po.$$.fragment,s),M(Ao.$$.fragment,s),M(Io.$$.fragment,s),M(Oo.$$.fragment,s),M(No.$$.fragment,s),M(So.$$.fragment,s),M(Ro.$$.fragment,s),M(Bo.$$.fragment,s),M(Uo.$$.fragment,s),M(Ho.$$.fragment,s),M(Qo.$$.fragment,s),M(Xo.$$.fragment,s),M(Go.$$.fragment,s),M(Ko.$$.fragment,s),M(Zo.$$.fragment,s),M(en.$$.fragment,s),M(nn.$$.fragment,s),M(St.$$.fragment,s),M(Rt.$$.fragment,s),M(sn.$$.fragment,s),M(an.$$.fragment,s),M(dn.$$.fragment,s),M(Wt.$$.fragment,s),M(Ut.$$.fragment,s),M(cn.$$.fragment,s),M(pn.$$.fragment,s),M(mn.$$.fragment,s),M(Vt.$$.fragment,s),M(Qt.$$.fragment,s),M(un.$$.fragment,s),M(fn.$$.fragment,s),M(kn.$$.fragment,s),M(Gt.$$.fragment,s),M(Kt.$$.fragment,s),Xd=!0)},o(s){w(p.$$.fragment,s),w(ro.$$.fragment,s),w(go.$$.fragment,s),w(_o.$$.fragment,s),w(vo.$$.fragment,s),w(bo.$$.fragment,s),w(wo.$$.fragment,s),w(yo.$$.fragment,s),w(xo.$$.fragment,s),w(To.$$.fragment,s),w(Eo.$$.fragment,s),w(ft.$$.fragment,s),w(qo.$$.fragment,s),w($o.$$.fragment,s),w(zo.$$.fragment,s),w(_t.$$.fragment,s),w(jo.$$.fragment,s),w(Co.$$.fragment,s),w(Po.$$.fragment,s),w(Ao.$$.fragment,s),w(Io.$$.fragment,s),w(Oo.$$.fragment,s),w(No.$$.fragment,s),w(So.$$.fragment,s),w(Ro.$$.fragment,s),w(Bo.$$.fragment,s),w(Uo.$$.fragment,s),w(Ho.$$.fragment,s),w(Qo.$$.fragment,s),w(Xo.$$.fragment,s),w(Go.$$.fragment,s),w(Ko.$$.fragment,s),w(Zo.$$.fragment,s),w(en.$$.fragment,s),w(nn.$$.fragment,s),w(St.$$.fragment,s),w(Rt.$$.fragment,s),w(sn.$$.fragment,s),w(an.$$.fragment,s),w(dn.$$.fragment,s),w(Wt.$$.fragment,s),w(Ut.$$.fragment,s),w(cn.$$.fragment,s),w(pn.$$.fragment,s),w(mn.$$.fragment,s),w(Vt.$$.fragment,s),w(Qt.$$.fragment,s),w(un.$$.fragment,s),w(fn.$$.fragment,s),w(kn.$$.fragment,s),w(Gt.$$.fragment,s),w(Kt.$$.fragment,s),Xd=!1},d(s){t(u),s&&t(T),s&&t(_),y(p),s&&t(Jl),s&&t(Se),y(ro),s&&t(Zl),s&&t(qe),s&&t(ed),s&&t(xn),s&&t(td),s&&t(pt),s&&t(od),s&&t(Ln),s&&t(nd),s&&t(qn),s&&t(sd),s&&t($n),s&&t(ad),s&&t($e),s&&t(rd),s&&t(ht),s&&t(id),s&&t(mo),s&&t(ld),s&&t(Fe),s&&t(dd),s&&t(Be),y(go),s&&t(cd),s&&t(J),s&&t(pd),y(_o,s),s&&t(hd),s&&t(F),s&&t(md),s&&t(de),s&&t(ud),s&&t(Hn),s&&t(fd),s&&t(Vn),s&&t(gd),s&&t(Qn),s&&t(_d),y(vo,s),s&&t(kd),s&&t(Xn),s&&t(vd),s&&t(ze),s&&t(bd),y(bo,s),s&&t(Md),s&&t(Gn),s&&t(wd),s&&t(Z),s&&t(yd),y(wo,s),s&&t(xd),s&&t(Kn),s&&t(Td),s&&t(Yn),s&&t(Ed),y(yo,s),s&&t(Ld),s&&t(Jn),s&&t(qd),s&&t(je),s&&t($d),y(xo,s),s&&t(Fd),s&&t(We),y(To),s&&t(zd),s&&t(ce),y(Eo),y(ft),s&&t(jd),s&&t(Ve),y(qo),s&&t(Cd),s&&t(pe),y($o),y(zo),y(_t),s&&t(Pd),s&&t(Qe),y(jo),s&&t(Dd),s&&t(K),y(Co),y(Po),y(Ao),y(Io),y(Oo),s&&t(Ad),s&&t(Xe),y(No),s&&t(Id),s&&t(j),y(So),y(Ro),y(Bo),y(Uo),y(Ho),y(Qo),s&&t(Od),s&&t(Ke),y(Xo),s&&t(Nd),s&&t(te),y(Go),y(Ko),s&&t(Sd),s&&t(Ye),y(Zo),s&&t(Rd),s&&t(Ee),y(en),y(nn),y(St),y(Rt),s&&t(Bd),s&&t(Ze),y(sn),s&&t(Wd),s&&t(he),y(an),y(dn),y(Wt),y(Ut),s&&t(Ud),s&&t(tt),y(cn),s&&t(Hd),s&&t(Le),y(pn),y(mn),y(Vt),y(Qt),s&&t(Vd),s&&t(st),y(un),s&&t(Qd),s&&t(me),y(fn),y(kn),y(Gt),y(Kt)}}}const ox={local:"markuplm",sections:[{local:"overview",title:"Overview"},{local:"usage-markuplmprocessor",title:"Usage: MarkupLMProcessor"},{local:"transformers.MarkupLMConfig",title:"MarkupLMConfig"},{local:"transformers.MarkupLMFeatureExtractor",title:"MarkupLMFeatureExtractor"},{local:"transformers.MarkupLMTokenizer",title:"MarkupLMTokenizer"},{local:"transformers.MarkupLMTokenizerFast",title:"MarkupLMTokenizerFast"},{local:"transformers.MarkupLMProcessor",title:"MarkupLMProcessor"},{local:"transformers.MarkupLMModel",title:"MarkupLMModel"},{local:"transformers.MarkupLMForSequenceClassification",title:"MarkupLMForSequenceClassification"},{local:"transformers.MarkupLMForTokenClassification",title:"MarkupLMForTokenClassification"},{local:"transformers.MarkupLMForQuestionAnswering",title:"MarkupLMForQuestionAnswering"}],title:"MarkupLM"};function nx(P){return Uy(()=>{new URLSearchParams(window.location.search).get("fw")}),[]}class cx extends Ny{constructor(u){super();Sy(this,u,nx,tx,Ry,{})}}export{cx as default,ox as metadata};
