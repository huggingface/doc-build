...
the latter silently ignores them.`)},l(n){d=a(n,"P",{});var f=r(d);_=l(f,"Although the recipe for forward pass needs to be defined within this function, one should call the "),p=a(f,"CODE",{});var x=r(p);m=l(x,"Module"),x.forEach(o),T=l(f,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),f.forEach(o)},m(n,f){v(n,d,f),e(d,_),e(d,p),e(p,m),e(d,T)},d(n){n&&o(d)}}}function Vl(N){let d,_,p,m,T;return m=new Q({props:{code:`from transformers import GPT2Tokenizer, FlaxGPTNeoModel
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),{c(){d=s("p"),_=i("Example:"),p=h(),b(m.$$.fragment)},l(n){d=a(n,"P",{});var f=r(d);_=l(f,"Example:"),f.forEach(o),p=u(n),y(m.$$.fragment,n)},m(n,f){v(n,d,f),e(d,_),v(n,p,f),k(m,n,f),T=!0},p:ge,i(n){T||($(m.$$.fragment,n),T=!0)},o(n){P(m.$$.fragment,n),T=!1},d(n){n&&o(d),n&&o(p),w(m,n)}}}function Ul(N){let d,_,p,m,T;return{c(){d=s("p"),_=i("Although the recipe for forward pass needs to be defined within this function, one should call the "),p=s("code"),m=i("Module"),T=i(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(n){d=a(n,"P",{});var f=r(d);_=l(f,"Although the recipe for forward pass needs to be defined within this function, one should call the "),p=a(f,"CODE",{});var x=r(p);m=l(x,"Module"),x.forEach(o),T=l(f,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
<p>Indices can be obtained using <code>GPTNeoTokenizer</code>. See <a href="/docs/transformers/main/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
...
Whether or not to return a <a href="/docs/transformers/main/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/gpt_neo/modeling_gpt_neo.py#L492",returnDescription:`
<p>A <a
...
`}}),Pe=new hn({props:{$$slots:{default:[jl]},$$scope:{ctx:N}}}),we=new fe({props:{anchor:"transformers.GPTNeoModel.forward.example",$$slots:{default:[Al]},$$scope:{ctx:N}}}),dt=new me({}),ct=new U({props:{name:"class transformers.GPTNeoForCausalLM",anchor:"transformers.GPTNeoForCausalLM",parameters:[{name:"config",val:""}],parametersDescription:[{anchor:"transformers.GPTNeoForCausalLM.config",description:`<strong>config</strong> (<a href="/docs/transformers/main/en/model_doc/gpt_neo#transformers.GPTNeoConfig">GPTNeoConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/main/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/gpt_neo/modeling_gpt_neo.py#L660"}}),mt=new U({props:{name:"forward",anchor:"transformers.GPTNeoForCausalLM.forward",parameters:[{name:"input_ids",val:": typing.Optional[torch.Tensor] = None"},{name:"past_key_values",val:": typing.Optional[typing.Tuple[torch.FloatTensor]] = None"},{name:"attention_mask",val:": typing.Optional[torch.Tensor] = None"},{name:"token_type_ids",val:": typing.Optional[torch.Tensor] = None"},{name:"position_ids",val:": typing.Optional[torch.Tensor] = None"},{name:"head_mask",val:": typing.Optional[torch.Tensor] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.Tensor] = None"},{name:"labels",val:": typing.Optional[torch.Tensor] = None"},{name:"use_cache",val:": typing.Optional[bool] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.GPTNeoForCausalLM.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, input_ids_length)</code>) &#x2014;
<code>input_ids_length</code> = <code>sequence_length</code> if <code>past_key_values</code> is <code>None</code> else
<code>past_key_values[0][0].shape[-2]</code> (<code>sequence_length</code> of input past key value states). Indices of input
sequence tokens in the vocabulary.</p>
<p>If <code>past_key_values</code> is used, only <code>input_ids</code> that do not have their past calculated should be passed as
...
are ignored (masked), the loss is only computed for labels in <code>[0, ..., config.vocab_size]</code>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/gpt_neo/modeling_gpt_neo.py#L710",returnDescription:`
<p>A <a
...
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/gpt_neo/modeling_gpt_neo.py#L825",returnDescription:`
...
`),ot=s("a"),bs=i("EleutherAI/gpt-neo-1.3B"),ys=i(" architecture."),ks=h(),oe=s("p"),$s=i("Configuration objects inherit from "),Ut=s("a"),Ps=i("PretrainedConfig"),ws=i(` and can be used to control the model outputs. Read the
...
and behavior.`),Ds=h(),O=s("div"),b(lt.$$.fragment),Bs=h(),se=s("p"),Ws=i("The "),Xt=s("a"),Hs=i("GPTNeoModel"),Vs=i(" forward method, overrides the "),ko=s("code"),Us=i("__call__"),Js=i(" special method."),Rs=h(),b(Pe.$$.fragment),Xs=h(),b(we.$$.fragment),Pn=h(),ae=s("h2"),Ne=s("a"),$o=s("span"),b(dt.$$.fragment),Ks=h(),Po=s("span"),Qs=i("GPTNeoForCausalLM"),wn=h(),q=s("div"),b(ct.$$.fragment),Ys=h(),wo=s("p"),Zs=i(`The GPT Neo Model transformer with a language modeling head on top (linear layer with weights tied to the input
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Ba=h(),C=s("div"),b(bt.$$.fragment),Wa=h(),le=s("p"),Ha=i("The "),to=s("a"),Va=i("GPTNeoForSequenceClassification"),Ua=i(" forward method, overrides the "),zo=s("code"),Ja=i("__call__"),Ra=i(" special method."),Xa=h(),b(Fe.$$.fragment),Ka=h(),b(Ce.$$.fragment),Qa=h(),b(Ee.$$.fragment),Ya=h(),b(qe.$$.fragment),Za=h(),b(ze.$$.fragment),Gn=h(),de=s("h2"),je=s("a"),jo=s("span"),b(yt.$$.fragment),er=h(),Ao=s("span"),tr=i("FlaxGPTNeoModel"),Mn=h(),M=s("div"),b(kt.$$.fragment),or=h(),Io=s("p"),nr=i("The bare GPTNeo Model transformer outputting raw hidden-states without any specific head on top."),sr=h(),$t=s("p"),ar=i("This model inherits from "),oo=s("a"),rr=i("FlaxPreTrainedModel"),ir=i(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),lr=h(),Pt=s("p"),dr=i(`This model is also a Flax Linen
`),wt=s("a"),cr=i("flax.nn.Module"),pr=i(` subclass. Use it as a
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),hr=h(),Lo=s("p"),ur=i("Finally, this model supports inherent JAX features such as:"),mr=h(),H=s("ul"),So=s("li"),Nt=s("a"),fr=i("Just-In-Time (JIT) compilation"),gr=h(),Oo=s("li"),xt=s("a"),_r=i("Automatic Differentiation"),Tr=h(),Do=s("li"),Gt=s("a"),vr=i("Vectorization"),br=h(),Bo=s("li"),Mt=s("a"),yr=i("Parallelization"),kr=h(),B=s("div"),b(Ft.$$.fragment),$r=h(),ce=s("p"),Pr=i("The "),Wo=s("code"),wr=i("FlaxGPTNeoPreTrainedModel"),Nr=i(" forward method, overrides the "),Ho=s("code"),xr=i("__call__"),Gr=i(" special method."),Mr=h(),b(Ae.$$.fragment),Fr=h(),b(Ie.$$.fragment),Fn=h(),pe=s("h2"),Le=s("a"),Vo=s("span"),b(Ct.$$.fragment),Cr=h(),Uo=s("span"),Er=i("FlaxGPTNeoForCausalLM"),Cn=h(),F=s("div"),b(Et.$$.fragment),qr=h(),Jo=s("p"),zr=i(`The GPTNeo Model transformer with a language modeling head on top (linear layer with weights tied to the input
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Ln.forEach(o),Ds=u(R),O=a(R,"DIV",{class:!0});var Be=r(O);y(lt.$$.fragment,Be),Bs=u(Be),se=a(Be,"P",{});var ro=r(se);Ws=l(ro,"The "),Xt=a(ro,"A",{href:!0});var Ni=r(Xt);Hs=l(Ni,"GPTNeoModel"),Ni.forEach(o),Vs=l(ro," forward method, overrides the "),ko=a(ro,"CODE",{});var xi=r(ko);Us=l(xi,"__call__"),xi.forEach(o),Js=l(ro," special method."),ro.forEach(o),Rs=u(Be),y(Pe.$$.fragment,Be),Xs=u(Be),y(we.$$.fragment,Be),Be.forEach(o),R.forEach(o),Pn=u(t),ae=a(t,"H2",{class:!0});var Sn=r(ae);Ne=a(Sn,"A",{id:!0,class:!0,href:!0});var Gi=r(Ne);$o=a(Gi,"SPAN",{});var Mi=r($o);y(dt.$$.fragment,Mi),Mi.forEach(o),Gi.forEach(o),Ks=u(Sn),Po=a(Sn,"SPAN",{});var Fi=r(Po);Qs=l(Fi,"GPTNeoForCausalLM"),Fi.forEach(o),Sn.forEach(o),wn=u(t),q=a(t,"DIV",{class:!0});var X=r(q);y(ct.$$.fragment,X),Ys=u(X),wo=a(X,"P",{});var Ci=r(wo);Zs=l(Ci,`The GPT Neo Model transformer with a language modeling head on top (linear layer with weights tied to the input
...
each row of the batch).`),K.forEach(o),za=u(z),_t=a(z,"P",{});var Wn=r(_t);ja=l(Wn,"This model inherits from "),eo=a(Wn,"A",{href:!0});var Vi=r(eo);Aa=l(Vi,"PreTrainedModel"),Vi.forEach(o),Ia=l(Wn,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Wn.forEach(o),La=u(z),Tt=a(z,"P",{});var Hn=r(Tt);Sa=l(Hn,"This model is also a PyTorch "),vt=a(Hn,"A",{href:!0,rel:!0});var Ui=r(vt);Oa=l(Ui,"torch.nn.Module"),Ui.forEach(o),Da=l(Hn,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Hn.forEach(o),Ba=u(z),C=a(z,"DIV",{class:!0});var j=r(C);y(bt.$$.fragment,j),Wa=u(j),le=a(j,"P",{});var lo=r(le);Ha=l(lo,"The "),to=a(lo,"A",{href:!0});var Ji=r(to);Va=l(Ji,"GPTNeoForSequenceClassification"),Ji.forEach(o),Ua=l(lo," forward method, overrides the "),zo=a(lo,"CODE",{});var Ri=r(zo);Ja=l(Ri,"__call__"),Ri.forEach(o),Ra=l(lo," special method."),lo.forEach(o),Xa=u(j),y(Fe.$$.fragment,j),Ka=u(j),y(Ce.$$.fragment,j),Qa=u(j),y(Ee.$$.fragment,j),Ya=u(j),y(qe.$$.fragment,j),Za=u(j),y(ze.$$.fragment,j),j.forEach(o),z.forEach(o),Gn=u(t),de=a(t,"H2",{class:!0});var Vn=r(de);je=a(Vn,"A",{id:!0,class:!0,href:!0});var Xi=r(je);jo=a(Xi,"SPAN",{});var Ki=r(jo);y(yt.$$.fragment,Ki),Ki.forEach(o),Xi.forEach(o),er=u(Vn),Ao=a(Vn,"SPAN",{});var Qi=r(Ao);tr=l(Qi,"FlaxGPTNeoModel"),Qi.forEach(o),Vn.forEach(o),Mn=u(t),M=a(t,"DIV",{class:!0});var A=r(M);y(kt.$$.fragment,A),or=u(A),Io=a(A,"P",{});var Yi=r(Io);nr=l(Yi,"The bare GPTNeo Model transformer outputting raw hidden-states without any specific head on top."),Yi.forEach(o),sr=u(A),$t=a(A,"P",{});var Un=r($t);ar=l(Un,"This model inherits from "),oo=a(Un,"A",{href:!0});var Zi=r(oo);rr=l(Zi,"FlaxPreTrainedModel"),Zi.forEach(o),ir=l(Un,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Un.forEach(o),lr=u(A),Pt=a(A,"P",{});var Jn=r(Pt);dr=l(Jn,`This model is also a Flax Linen
`),wt=a(Jn,"A",{href:!0,rel:!0});var el=r(wt);cr=l(el,"flax.nn.Module"),el.forEach(o),pr=l(Jn,` subclass. Use it as a
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),Jn.forEach(o),hr=u(A),Lo=a(A,"P",{});var tl=r(Lo);ur=l(tl,"Finally, this model supports inherent JAX features such as:"),tl.forEach(o),mr=u(A),H=a(A,"UL",{});var He=r(H);So=a(He,"LI",{});var ol=r(So);Nt=a(ol,"A",{href:!0,rel:!0});var nl=r(Nt);fr=l(nl,"Just-In-Time (JIT) compilation"),nl.forEach(o),ol.forEach(o),gr=u(He),Oo=a(He,"LI",{});var sl=r(Oo);xt=a(sl,"A",{href:!0,rel:!0});var al=r(xt);_r=l(al,"Automatic Differentiation"),al.forEach(o),sl.forEach(o),Tr=u(He),Do=a(He,"LI",{});var rl=r(Do);Gt=a(rl,"A",{href:!0,rel:!0});var il=r(Gt);vr=l(il,"Vectorization"),il.forEach(o),rl.forEach(o),br=u(He),Bo=a(He,"LI",{});var ll=r(Bo);Mt=a(ll,"A",{href:!0,rel:!0});var dl=r(Mt);yr=l(dl,"Parallelization"),dl.forEach(o),ll.forEach(o),He.forEach(o),kr=u(A),B=a(A,"DIV",{class:!0});var Ve=r(B);y(Ft.$$.fragment,Ve),$r=u(Ve),ce=a(Ve,"P",{});var co=r(ce);Pr=l(co,"The "),Wo=a(co,"CODE",{});var cl=r(Wo);wr=l(cl,"FlaxGPTNeoPreTrainedModel"),cl.forEach(o),Nr=l(co," forward method, overrides the "),Ho=a(co,"CODE",{});var pl=r(Ho);xr=l(pl,"__call__"),pl.forEach(o),Gr=l(co," special method."),co.forEach(o),Mr=u(Ve),y(Ae.$$.fragment,Ve),Fr=u(Ve),y(Ie.$$.fragment,Ve),Ve.forEach(o),A.forEach(o),Fn=u(t),pe=a(t,"H2",{class:!0});var Rn=r(pe);Le=a(Rn,"A",{id:!0,class:!0,href:!0});var hl=r(Le);Vo=a(hl,"SPAN",{});var ul=r(Vo);y(Ct.$$.fragment,ul),ul.forEach(o),hl.forEach(o),Cr=u(Rn),Uo=a(Rn,"SPAN",{});var ml=r(Uo);Er=l(ml,"FlaxGPTNeoForCausalLM"),ml.forEach(o),Rn.forEach(o),Cn=u(t),F=a(t,"DIV",{class:!0});var I=r(F);y(Et.$$.fragment,I),qr=u(I),Jo=a(I,"P",{});var fl=r(Jo);zr=l(fl,`The GPTNeo Model transformer with a language modeling head on top (linear layer with weights tied to the input
