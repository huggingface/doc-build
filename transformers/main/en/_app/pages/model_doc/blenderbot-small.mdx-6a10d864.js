import{S as Hu,i as Ku,s as Vu,e as n,k as l,w as f,t as r,M as Qu,c as a,d as o,m as i,a as s,x as _,h as d,b as c,F as e,g as p,y as g,q as b,o as k,B as y,v as Ju}from"../../chunks/vendor-6b77c823.js";import{T as Bn}from"../../chunks/Tip-39098574.js";import{D as M}from"../../chunks/Docstring-17b815d9.js";import{C as ro}from"../../chunks/CodeBlock-3a8b25a8.js";import{I as qe}from"../../chunks/IconCopyLink-7a11ce68.js";function Xu(Y){let h,z,v,T,x;return{c(){h=n("p"),z=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),v=n("code"),T=r("Module"),x=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(S){h=a(S,"P",{});var w=s(h);z=d(w,"Although the recipe for forward pass needs to be defined within this function, one should call the "),v=a(w,"CODE",{});var F=s(v);T=d(F,"Module"),F.forEach(o),x=d(w,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),w.forEach(o)},m(S,w){p(S,h,w),e(h,z),e(h,v),e(v,T),e(h,x)},d(S){S&&o(h)}}}function Yu(Y){let h,z,v,T,x;return{c(){h=n("p"),z=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),v=n("code"),T=r("Module"),x=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(S){h=a(S,"P",{});var w=s(h);z=d(w,"Although the recipe for forward pass needs to be defined within this function, one should call the "),v=a(w,"CODE",{});var F=s(v);T=d(F,"Module"),F.forEach(o),x=d(w,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),w.forEach(o)},m(S,w){p(S,h,w),e(h,z),e(h,v),e(v,T),e(h,x)},d(S){S&&o(h)}}}function Zu(Y){let h,z,v,T,x,S,w,F,Ce,ue,B,je,U,Oe,Pe,W,Le,Ne,K,V,Ie,Z,C,P,fe,ae,$e,Q,A,Te,se,L,we,re,Ee,ee,de,le,Ae,J,Me,R,De;return{c(){h=n("p"),z=r("TF 2.0 models accepts two formats as inputs:"),v=l(),T=n("ul"),x=n("li"),S=r("having all inputs as keyword arguments (like PyTorch models), or"),w=l(),F=n("li"),Ce=r("having all inputs as a list, tuple or dict in the first positional arguments."),ue=l(),B=n("p"),je=r("This second option is useful when using "),U=n("code"),Oe=r("tf.keras.Model.fit"),Pe=r(` method which currently requires having all the
...
`),re=a(oe,"CODE",{});var ce=s(re);Ee=d(ce,"model([input_ids, attention_mask])"),ce.forEach(o),ee=d(oe," or "),de=a(oe,"CODE",{});var _e=s(de);le=d(_e,"model([input_ids, attention_mask, token_type_ids])"),_e.forEach(o),oe.forEach(o),Ae=i(X),J=a(X,"LI",{});var xe=s(J);Me=d(xe,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),R=a(xe,"CODE",{});var Be=s(R);De=d(Be,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),Be.forEach(o),xe.forEach(o),X.forEach(o)},m(u,q){p(u,h,q),e(h,z),p(u,v,q),p(u,T,q),e(T,x),e(x,S),e(T,w),e(T,F),e(F,Ce),p(u,ue,q),p(u,B,q),e(B,je),e(B,U),e(U,Oe),e(B,Pe),e(B,W),e(W,Le),e(B,Ne),p(u,K,q),p(u,V,q),e(V,Ie),p(u,Z,q),p(u,C,q),e(C,P),e(P,fe),e(P,ae),e(ae,$e),e(P,Q),e(P,A),e(A,Te),e(C,se),e(C,L),e(L,we),e(L,re),e(re,Ee),e(L,ee),e(L,de),e(de,le),e(C,Ae),e(C,J),e(J,Me),e(J,R),e(R,De)},d(u){u&&o(h),u&&o(v),u&&o(T),u&&o(ue),u&&o(B),u&&o(K),u&&o(V),u&&o(Z),u&&o(C)}}}function ef(Y){let h,z,v,T,x;return{c(){h=n("p"),z=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),v=n("code"),T=r("Module"),x=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(S){h=a(S,"P",{});var w=s(h);z=d(w,"Although the recipe for forward pass needs to be defined within this function, one should call the "),v=a(w,"CODE",{});var F=s(v);T=d(F,"Module"),F.forEach(o),x=d(w,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),w.forEach(o)},m(S,w){p(S,h,w),e(h,z),e(h,v),e(v,T),e(h,x)},d(S){S&&o(h)}}}function of(Y){let h,z,v,T,x,S,w,F,Ce,ue,B,je,U,Oe,Pe,W,Le,Ne,K,V,Ie,Z,C,P,fe,ae,$e,Q,A,Te,se,L,we,re,Ee,ee,de,le,Ae,J,Me,R,De;return{c(){h=n("p"),z=r("TF 2.0 models accepts two formats as inputs:"),v=l(),T=n("ul"),x=n("li"),S=r("having all inputs as keyword arguments (like PyTorch models), or"),w=l(),F=n("li"),Ce=r("having all inputs as a list, tuple or dict in the first positional arguments."),ue=l(),B=n("p"),je=r("This second option is useful when using "),U=n("code"),Oe=r("tf.keras.Model.fit"),Pe=r(` method which currently requires having all the
tensors in the first argument of the model call function: `),W=n("code"),Le=r("model(inputs)"),Ne=r("."),K=l(),V=n("p"),Ie=r(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),Z=l(),C=n("ul"),P=n("li"),fe=r("a single Tensor with "),ae=n("code"),$e=r("input_ids"),Q=r(" only and nothing else: "),A=n("code"),Te=r("model(input_ids)"),se=l(),L=n("li"),we=r(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),re=n("code"),Ee=r("model([input_ids, attention_mask])"),ee=r(" or "),de=n("code"),le=r("model([input_ids, attention_mask, token_type_ids])"),Ae=l(),J=n("li"),Me=r(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),R=n("code"),De=r('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(u){h=a(u,"P",{});var q=s(h);z=d(q,"TF 2.0 models accepts two formats as inputs:"),q.forEach(o),v=i(u),T=a(u,"UL",{});var ie=s(T);x=a(ie,"LI",{});var lo=s(x);S=d(lo,"having all inputs as keyword arguments (like PyTorch models), or"),lo.forEach(o),w=i(ie),F=a(ie,"LI",{});var Re=s(F);Ce=d(Re,"having all inputs as a list, tuple or dict in the first positional arguments."),Re.forEach(o),ie.forEach(o),ue=i(u),B=a(u,"P",{});var j=s(B);je=d(j,"This second option is useful when using "),U=a(j,"CODE",{});var io=s(U);Oe=d(io,"tf.keras.Model.fit"),io.forEach(o),Pe=d(j,` method which currently requires having all the
...
first positional argument :`),co.forEach(o),Z=i(u),C=a(u,"UL",{});var X=s(C);P=a(X,"LI",{});var D=s(P);fe=d(D,"a single Tensor with "),ae=a(D,"CODE",{});var po=s(ae);$e=d(po,"input_ids"),po.forEach(o),Q=d(D," only and nothing else: "),A=a(D,"CODE",{});var mo=s(A);Te=d(mo,"model(input_ids)"),mo.forEach(o),D.forEach(o),se=i(X),L=a(X,"LI",{});var oe=s(L);we=d(oe,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),re=a(oe,"CODE",{});var ce=s(re);Ee=d(ce,"model([input_ids, attention_mask])"),ce.forEach(o),ee=d(oe," or "),de=a(oe,"CODE",{});var _e=s(de);le=d(_e,"model([input_ids, attention_mask, token_type_ids])"),_e.forEach(o),oe.forEach(o),Ae=i(X),J=a(X,"LI",{});var xe=s(J);Me=d(xe,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),R=a(xe,"CODE",{});var Be=s(R);De=d(Be,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),Be.forEach(o),xe.forEach(o),X.forEach(o)},m(u,q){p(u,h,q),e(h,z),p(u,v,q),p(u,T,q),e(T,x),e(x,S),e(T,w),e(T,F),e(F,Ce),p(u,ue,q),p(u,B,q),e(B,je),e(B,U),e(U,Oe),e(B,Pe),e(B,W),e(W,Le),e(B,Ne),p(u,K,q),p(u,V,q),e(V,Ie),p(u,Z,q),p(u,C,q),e(C,P),e(P,fe),e(P,ae),e(ae,$e),e(P,Q),e(P,A),e(A,Te),e(C,se),e(C,L),e(L,we),e(L,re),e(re,Ee),e(L,ee),e(L,de),e(de,le),e(C,Ae),e(C,J),e(J,Me),e(J,R),e(R,De)},d(u){u&&o(h),u&&o(v),u&&o(T),u&&o(ue),u&&o(B),u&&o(K),u&&o(V),u&&o(Z),u&&o(C)}}}function tf(Y){let h,z,v,T,x;return{c(){h=n("p"),z=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),v=n("code"),T=r("Module"),x=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(S){h=a(S,"P",{});var w=s(h);z=d(w,"Although the recipe for forward pass needs to be defined within this function, one should call the "),v=a(w,"CODE",{});var F=s(v);T=d(F,"Module"),F.forEach(o),x=d(w,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),w.forEach(o)},m(S,w){p(S,h,w),e(h,z),e(h,v),e(v,T),e(h,x)},d(S){S&&o(h)}}}function nf(Y){let h,z,v,T,x;return{c(){h=n("p"),z=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),v=n("code"),T=r("Module"),x=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(S){h=a(S,"P",{});var w=s(h);z=d(w,"Although the recipe for forward pass needs to be defined within this function, one should call the "),v=a(w,"CODE",{});var F=s(v);T=d(F,"Module"),F.forEach(o),x=d(w,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),w.forEach(o)},m(S,w){p(S,h,w),e(h,z),e(h,v),e(v,T),e(h,x)},d(S){S&&o(h)}}}function af(Y){let h,z,v,T,x,S,w,F,Ce,ue,B,je,U,Oe,Pe,W,Le,Ne,K,V,Ie,Z,C,P,fe,ae,$e,Q,A,Te,se,L,we,re,Ee,ee,de,le,Ae,J,Me,R,De,u,q,ie,lo,Re,j,io,Se,co,X,D,po,mo,oe,ce,_e,xe,Be,md,la,hd,ur,pe,ot,ud,ho,fd,zn,_d,gd,tt,bd,kd,yd,uo,vd,Fn,Td,wd,qn,Sd,xd,Bd,ia,zd,Fd,nt,fr,fo,Eo,ca,at,qd,pa,$d,_r,G,st,Ed,ma,Md,Cd,rt,jd,$n,Od,Pd,Ld,He,dt,Nd,ha,Id,Ad,ua,Dd,Gd,Mo,lt,Ud,_o,Wd,fa,Rd,Hd,_a,Kd,Vd,Qd,Ke,it,Jd,En,Xd,Mn,Yd,Zd,ga,el,ol,Cn,ct,gr,go,Co,ba,pt,tl,ka,nl,br,Ge,mt,al,ht,sl,ya,rl,dl,ll,jo,ut,il,va,cl,kr,bo,Oo,Ta,ft,pl,wa,ml,yr,ze,_t,hl,gt,ul,jn,fl,_l,gl,bt,bl,kt,kl,yl,vl,ge,yt,Tl,ko,wl,On,Sl,xl,Sa,Bl,zl,Fl,Po,ql,xa,$l,El,vt,vr,yo,Lo,Ba,Tt,Ml,za,Cl,Tr,Fe,wt,jl,St,Ol,Pn,Pl,Ll,Nl,xt,Il,Bt,Al,Dl,Gl,be,zt,Ul,vo,Wl,Ln,Rl,Hl,Fa,Kl,Vl,Ql,No,Jl,qa,Xl,Yl,Ft,wr,To,Io,$a,qt,Zl,Ea,ei,Sr,wo,$t,oi,Ve,Et,ti,Ma,ni,ai,Mt,xr,So,Ao,Ca,Ct,si,ja,ri,Br,me,jt,di,Ot,li,Nn,ii,ci,pi,Pt,mi,Lt,hi,ui,fi,Do,_i,ke,Nt,gi,xo,bi,In,ki,yi,Oa,vi,Ti,wi,Go,Si,Pa,xi,Bi,It,zr,Bo,Uo,La,At,zi,Na,Fi,Fr,he,Dt,qi,Gt,$i,An,Ei,Mi,Ci,Ut,ji,Wt,Oi,Pi,Li,Wo,Ni,O,Rt,Ii,zo,Ai,Dn,Di,Gi,Ia,Ui,Wi,Ri,Ro,Hi,Aa,Ki,Vi,Da,Ga,Ua,Wa,Qi,Ji,Ra,Ha,Ka,Va,Xi,Yi,Qa,Ja,Xa,Ya,Zi,ec,Za,es,os,Ht,oc,ts,tc,nc,ac,ns,as,ss,rs,sc,qr,Fo,Ho,ds,Kt,rc,ls,dc,$r,N,Vt,lc,Qt,ic,Gn,cc,pc,mc,Jt,hc,Xt,uc,fc,_c,is,gc,bc,Ue,cs,Yt,kc,yc,ps,Zt,vc,Tc,ms,en,wc,Sc,hs,on,xc,Bc,Qe,tn,zc,us,Fc,qc,nn,$c,Je,an,Ec,fs,Mc,Cc,sn,jc,Xe,rn,Oc,_s,Pc,Lc,dn,Er,qo,Ko,gs,ln,Nc,bs,Ic,Mr,I,cn,Ac,pn,Dc,Un,Gc,Uc,Wc,mn,Rc,hn,Hc,Kc,Vc,ks,Qc,Jc,We,ys,un,Xc,Yc,vs,fn,Zc,ep,Ts,_n,op,tp,ws,gn,np,ap,$,bn,sp,$o,rp,Ss,dp,lp,xs,ip,cp,pp,Vo,mp,Bs,hp,up,zs,Fs,qs,$s,fp,_p,Es,Ms,Cs,js,gp,bp,Os,Ps,Ls,Ns,kp,yp,Is,As,kn,Qo,Jo,Ds,yn,vp,Gs,Tp,wp,Us,Sp,xp,Ws,Bp,zp,Rs,Hs,Ks,Vs,Fp,qp,Qs,Js,Xs,Ys,$p,Ep,Zs,er,or,tr,Mp,Cp,nr,ar,sr,rr,jp,Op,Ye,vn,Pp,dr,Lp,Np,Tn,Ip,Ze,wn,Ap,lr,Dp,Gp,Sn,Cr;return S=new qe({}),se=new qe({}),Be=new qe({}),ot=new M({props:{name:"class transformers.BlenderbotSmallConfig",anchor:"transformers.BlenderbotSmallConfig",parameters:[{name:"vocab_size",val:" = 50265"},{name:"max_position_embeddings",val:" = 512"},{name:"encoder_layers",val:" = 8"},{name:"encoder_ffn_dim",val:" = 2048"},{name:"encoder_attention_heads",val:" = 16"},{name:"decoder_layers",val:" = 8"},{name:"decoder_ffn_dim",val:" = 2048"},{name:"decoder_attention_heads",val:" = 16"},{name:"encoder_layerdrop",val:" = 0.0"},{name:"decoder_layerdrop",val:" = 0.0"},{name:"use_cache",val:" = True"},{name:"is_encoder_decoder",val:" = True"},{name:"activation_function",val:" = 'gelu'"},{name:"d_model",val:" = 512"},{name:"dropout",val:" = 0.1"},{name:"attention_dropout",val:" = 0.0"},{name:"activation_dropout",val:" = 0.0"},{name:"init_std",val:" = 0.02"},{name:"decoder_start_token_id",val:" = 1"},{name:"classifier_dropout",val:" = 0.0"},{name:"scale_embedding",val:" = False"},{name:"pad_token_id",val:" = 0"},{name:"bos_token_id",val:" = 1"},{name:"eos_token_id",val:" = 2"},{name:"forced_eos_token_id",val:" = 2"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.BlenderbotSmallConfig.vocab_size",description:`<strong>vocab_size</strong> (<code>int</code>, <em>optional</em>, defaults to 50265) &#x2014;
...
<code>eos_token_id</code>.`,name:"forced_eos_token_id"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/blenderbot_small/configuration_blenderbot_small.py#L36"}}),nt=new ro({props:{code:`from transformers import BlenderbotSmallModel, BlenderbotSmallConfig
...
Whether or not the token list is already formatted with special tokens for the model.`,name:"already_has_special_tokens"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/tokenization_utils.py#L842",returnDescription:`
...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/blenderbot_small/tokenization_blenderbot_small_fast.py#L96",returnDescription:`
<p>List of zeros.</p>
`,returnType:`
<p><code>List[int]</code></p>
...
(masked), the loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/blenderbot_small/modeling_blenderbot_small.py#L1246",returnDescription:`
<p>A <a
...
behaviors between training and evaluation).`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/blenderbot_small/modeling_tf_blenderbot_small.py#L1123",returnDescription:`
<p>A <a
...
Labels for computing the masked language modeling loss. Indices should either be in <code>[0, ..., config.vocab_size]</code> or -100 (see <code>input_ids</code> docstring). Tokens with indices set to <code>-100</code> are ignored
(masked), the loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/blenderbot_small/modeling_tf_blenderbot_small.py#L1231",returnDescription:`
<p>A <a
...
Whether or not to return a <a href="/docs/transformers/main/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/blenderbot_small/modeling_flax_blenderbot_small.py#L960",returnDescription:`
<p>A <a
...
Whether or not to return a <a href="/docs/transformers/main/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/main/src/transformers/models/blenderbot_small/modeling_flax_blenderbot_small.py#L1295",returnDescription:`
<p>A <a
...
<span class="hljs-meta">&gt;&gt;&gt; </span>outputs = model.decode(decoder_input_ids, encoder_outputs)
<span class="hljs-meta">&gt;&gt;&gt; </span>logits = outputs.logits`}}),{c(){h=n("meta"),z=l(),v=n("h1"),T=n("a"),x=n("span"),f(S.$$.fragment),w=l(),F=n("span"),Ce=r("Blenderbot Small"),ue=l(),B=n("p"),je=r("Note that "),U=n("a"),Oe=r("BlenderbotSmallModel"),Pe=r(` and
...
found `),D=n("a"),po=r("here"),mo=r(" ."),oe=l(),ce=n("h2"),_e=n("a"),xe=n("span"),f(Be.$$.fragment),md=l(),la=n("span"),hd=r("BlenderbotSmallConfig"),ur=l(),pe=n("div"),f(ot.$$.fragment),ud=l(),ho=n("p"),fd=r("This is the configuration class to store the configuration of a "),zn=n("a"),_d=r("BlenderbotSmallModel"),gd=r(`. It is used to instantiate
...
does not make use of token type ids, therefore a list of zeros is returned.`),kr=l(),bo=n("h2"),Oo=n("a"),Ta=n("span"),f(ft.$$.fragment),pl=l(),wa=n("span"),ml=r("BlenderbotSmallModel"),yr=l(),ze=n("div"),f(_t.$$.fragment),hl=l(),gt=n("p"),ul=r(`The bare BlenderbotSmall Model outputting raw hidden-states without any specific head on top.
...
and behavior.`),vl=l(),ge=n("div"),f(yt.$$.fragment),Tl=l(),ko=n("p"),wl=r("The "),On=n("a"),Sl=r("BlenderbotSmallModel"),xl=r(" forward method, overrides the "),Sa=n("code"),Bl=r("__call__"),zl=r(" special method."),Fl=l(),f(Po.$$.fragment),ql=l(),xa=n("p"),$l=r("Example:"),El=l(),f(vt.$$.fragment),vr=l(),yo=n("h2"),Lo=n("a"),Ba=n("span"),f(Tt.$$.fragment),Ml=l(),za=n("span"),Cl=r("BlenderbotSmallForConditionalGeneration"),Tr=l(),Fe=n("div"),f(wt.$$.fragment),jl=l(),St=n("p"),Ol=r(`The BlenderbotSmall Model with a language modeling head. Can be used for summarization.
This model inherits from `),Pn=n("a"),Pl=r("PreTrainedModel"),Ll=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Nl=l(),xt=n("p"),Il=r("This model is also a PyTorch "),Bt=n("a"),Al=r("torch.nn.Module"),Dl=r(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Gl=l(),be=n("div"),f(zt.$$.fragment),Ul=l(),vo=n("p"),Wl=r("The "),Ln=n("a"),Rl=r("BlenderbotSmallForConditionalGeneration"),Hl=r(" forward method, overrides the "),Fa=n("code"),Kl=r("__call__"),Vl=r(" special method."),Ql=l(),f(No.$$.fragment),Jl=l(),qa=n("p"),Xl=r("Conversation example:"),Yl=l(),f(Ft.$$.fragment),wr=l(),To=n("h2"),Io=n("a"),$a=n("span"),f(qt.$$.fragment),Zl=l(),Ea=n("span"),ei=r("BlenderbotSmallForCausalLM"),Sr=l(),wo=n("div"),f($t.$$.fragment),oi=l(),Ve=n("div"),f(Et.$$.fragment),ti=l(),Ma=n("p"),ni=r("Example:"),ai=l(),f(Mt.$$.fragment),xr=l(),So=n("h2"),Ao=n("a"),Ca=n("span"),f(Ct.$$.fragment),si=l(),ja=n("span"),ri=r("TFBlenderbotSmallModel"),Br=l(),me=n("div"),f(jt.$$.fragment),di=l(),Ot=n("p"),li=r(`The bare BLENDERBOT_SMALL Model outputting raw hidden-states without any specific head on top.
...
behavior.`),fi=l(),f(Do.$$.fragment),_i=l(),ke=n("div"),f(Nt.$$.fragment),gi=l(),xo=n("p"),bi=r("The "),In=n("a"),ki=r("TFBlenderbotSmallModel"),yi=r(" forward method, overrides the "),Oa=n("code"),vi=r("__call__"),Ti=r(" special method."),wi=l(),f(Go.$$.fragment),Si=l(),Pa=n("p"),xi=r("Example:"),Bi=l(),f(It.$$.fragment),zr=l(),Bo=n("h2"),Uo=n("a"),La=n("span"),f(At.$$.fragment),zi=l(),Na=n("span"),Fi=r("TFBlenderbotSmallForConditionalGeneration"),Fr=l(),he=n("div"),f(Dt.$$.fragment),qi=l(),Gt=n("p"),$i=r(`The BLENDERBOT_SMALL Model with a language modeling head. Can be used for summarization.
...
tokenizer([ARTICLE_TO_SUMMARIZE], max_length=1024, return_tensors=\u2018np\u2019)`),yp=l(),Is=n("blockquote"),As=n("blockquote"),kn=n("blockquote"),Qo=n("h1"),Jo=n("a"),Ds=n("span"),f(yn.$$.fragment),vp=l(),Gs=n("span"),Tp=r("Generate Summary >>> summary_ids = model.generate(inputs[\u2018input_ids\u2019]).sequences >>>"),wp=l(),Us=n("p"),Sp=r("print(tokenizer.batch_decode(summary_ids, skip_special_tokens=True, clean_up_tokenization_spaces=False))"),xp=l(),Ws=n("p"),Bp=r("Mask filling example:"),zp=l(),Rs=n("blockquote"),Hs=n("blockquote"),Ks=n("blockquote"),Vs=n("p"),Fp=r(`from transformers import BlenderbotSmallTokenizer, FlaxBlenderbotSmallForConditionalGeneration >>>
...
jax.nn.softmax(logits[0, masked_index], axis=0) >>> values, predictions = jax.lax.top_k(probs)`),Cp=l(),nr=n("blockquote"),ar=n("blockquote"),sr=n("blockquote"),rr=n("p"),jp=r("tokenizer.decode(predictions).split()"),Op=l(),Ye=n("div"),f(vn.$$.fragment),Pp=l(),dr=n("p"),Lp=r("Example:"),Np=l(),f(Tn.$$.fragment),Ip=l(),Ze=n("div"),f(wn.$$.fragment),Ap=l(),lr=n("p"),Dp=r("Example:"),Gp=l(),f(Sn.$$.fragment),this.h()},l(t){const m=Qu('[data-svelte="svelte-1phssyn"]',document.head);h=a(m,"META",{name:!0,content:!0}),m.forEach(o),z=i(t),v=a(t,"H1",{class:!0});var xn=s(v);T=a(xn,"A",{id:!0,class:!0,href:!0});var ir=s(T);x=a(ir,"SPAN",{});var cr=s(x);_(S.$$.fragment,cr),cr.forEach(o),ir.forEach(o),w=i(xn),F=a(xn,"SPAN",{});var pr=s(F);Ce=d(pr,"Blenderbot Small"),pr.forEach(o),xn.forEach(o),ue=i(t),B=a(t,"P",{});var ye=s(B);je=d(ye,"Note that "),U=a(ye,"A",{href:!0});var mr=s(U);Oe=d(mr,"BlenderbotSmallModel"),mr.forEach(o),Pe=d(ye,` and
...
found `),D=a(Wn,"A",{href:!0,rel:!0});var om=s(D);po=d(om,"here"),om.forEach(o),mo=d(Wn," ."),Wn.forEach(o),oe=i(t),ce=a(t,"H2",{class:!0});var Pr=s(ce);_e=a(Pr,"A",{id:!0,class:!0,href:!0});var tm=s(_e);xe=a(tm,"SPAN",{});var nm=s(xe);_(Be.$$.fragment,nm),nm.forEach(o),tm.forEach(o),md=i(Pr),la=a(Pr,"SPAN",{});var am=s(la);hd=d(am,"BlenderbotSmallConfig"),am.forEach(o),Pr.forEach(o),ur=i(t),pe=a(t,"DIV",{class:!0});var eo=s(pe);_(ot.$$.fragment,eo),ud=i(eo),ho=a(eo,"P",{});var Rn=s(ho);fd=d(Rn,"This is the configuration class to store the configuration of a "),zn=a(Rn,"A",{href:!0});var sm=s(zn);_d=d(sm,"BlenderbotSmallModel"),sm.forEach(o),gd=d(Rn,`. It is used to instantiate
an BlenderbotSmall model according to the specified arguments, defining the model architecture. Instantiating a
configuration with the defaults will yield a similar configuration to that of the BlenderbotSmall
...
documentation from `),qn=a(Hn,"A",{href:!0});var lm=s(qn);Sd=d(lm,"PretrainedConfig"),lm.forEach(o),xd=d(Hn," for more information."),Hn.forEach(o),Bd=i(eo),ia=a(eo,"P",{});var im=s(ia);zd=d(im,"Example:"),im.forEach(o),Fd=i(eo),_(nt.$$.fragment,eo),eo.forEach(o),fr=i(t),fo=a(t,"H2",{class:!0});var Lr=s(fo);Eo=a(Lr,"A",{id:!0,class:!0,href:!0});var cm=s(Eo);ca=a(cm,"SPAN",{});var pm=s(ca);_(at.$$.fragment,pm),pm.forEach(o),cm.forEach(o),qd=i(Lr),pa=a(Lr,"SPAN",{});var mm=s(pa);$d=d(mm,"BlenderbotSmallTokenizer"),mm.forEach(o),Lr.forEach(o),_r=i(t),G=a(t,"DIV",{class:!0});var ve=s(G);_(st.$$.fragment,ve),Ed=i(ve),ma=a(ve,"P",{});var hm=s(ma);Md=d(hm,"Constructs a Blenderbot-90M tokenizer based on BPE (Byte-Pair-Encoding)"),hm.forEach(o),Cd=i(ve),rt=a(ve,"P",{});var Nr=s(rt);jd=d(Nr,"This tokenizer inherits from "),$n=a(Nr,"A",{href:!0});var um=s($n);Od=d(um,"PreTrainedTokenizer"),um.forEach(o),Pd=d(Nr,` which contains most of the main methods. Users should refer to
...
adding special tokens.`),fm.forEach(o),Ad=i(Kn),ua=a(Kn,"P",{});var _m=s(ua);Dd=d(_m,"This implementation does not add special tokens and this method should be overridden in a subclass."),_m.forEach(o),Kn.forEach(o),Gd=i(ve),Mo=a(ve,"DIV",{class:!0});var Ir=s(Mo);_(lt.$$.fragment,Ir),Ud=i(Ir),_o=a(Ir,"P",{});var Vn=s(_o);Wd=d(Vn,`Retrieves sequence ids from a token list that has no special tokens added. This method is called when adding
special tokens using the tokenizer `),fa=a(Vn,"CODE",{});var gm=s(fa);Rd=d(gm,"prepare_for_model"),gm.forEach(o),Hd=d(Vn," or "),_a=a(Vn,"CODE",{});var bm=s(_a);Kd=d(bm,"encode_plus"),bm.forEach(o),Vd=d(Vn," methods."),Vn.forEach(o),Ir.forEach(o),Qd=i(ve),Ke=a(ve,"DIV",{class:!0});var Qn=s(Ke);_(it.$$.fragment,Qn),Jd=i(Qn),En=a(Qn,"P",{});var Up=s(En);Xd=d(Up,"Create the token type IDs corresponding to the sequences passed. "),Mn=a(Up,"A",{href:!0});var km=s(Mn);Yd=d(km,`What are token type
IDs?`),km.forEach(o),Up.forEach(o),Zd=i(Qn),ga=a(Qn,"P",{});var ym=s(ga);el=d(ym,"Should be overridden in a subclass if the model has a special way of building those."),ym.forEach(o),Qn.forEach(o),ol=i(ve),Cn=a(ve,"DIV",{class:!0});var vm=s(Cn);_(ct.$$.fragment,vm),vm.forEach(o),ve.forEach(o),gr=i(t),go=a(t,"H2",{class:!0});var Ar=s(go);Co=a(Ar,"A",{id:!0,class:!0,href:!0});var Tm=s(Co);ba=a(Tm,"SPAN",{});var wm=s(ba);_(pt.$$.fragment,wm),wm.forEach(o),Tm.forEach(o),tl=i(Ar),ka=a(Ar,"SPAN",{});var Sm=s(ka);nl=d(Sm,"BlenderbotSmallTokenizerFast"),Sm.forEach(o),Ar.forEach(o),br=i(t),Ge=a(t,"DIV",{class:!0});var Jn=s(Ge);_(mt.$$.fragment,Jn),al=i(Jn),ht=a(Jn,"P",{});var Dr=s(ht);sl=d(Dr,"Construct a \u201Cfast\u201D BlenderbotSmall tokenizer (backed by HuggingFace\u2019s "),ya=a(Dr,"EM",{});var xm=s(ya);rl=d(xm,"tokenizers"),xm.forEach(o),dl=d(Dr," library)."),Dr.forEach(o),ll=i(Jn),jo=a(Jn,"DIV",{class:!0});var Gr=s(jo);_(ut.$$.fragment,Gr),il=i(Gr),va=a(Gr,"P",{});var Bm=s(va);cl=d(Bm,`Create a mask from the two sequences passed to be used in a sequence-pair classification task. BlenderbotSmall
does not make use of token type ids, therefore a list of zeros is returned.`),Bm.forEach(o),Gr.forEach(o),Jn.forEach(o),kr=i(t),bo=a(t,"H2",{class:!0});var Ur=s(bo);Oo=a(Ur,"A",{id:!0,class:!0,href:!0});var zm=s(Oo);Ta=a(zm,"SPAN",{});var Fm=s(Ta);_(ft.$$.fragment,Fm),Fm.forEach(o),zm.forEach(o),pl=i(Ur),wa=a(Ur,"SPAN",{});var qm=s(wa);ml=d(qm,"BlenderbotSmallModel"),qm.forEach(o),Ur.forEach(o),yr=i(t),ze=a(t,"DIV",{class:!0});var Xo=s(ze);_(_t.$$.fragment,Xo),hl=i(Xo),gt=a(Xo,"P",{});var Wr=s(gt);ul=d(Wr,`The bare BlenderbotSmall Model outputting raw hidden-states without any specific head on top.
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Kr.forEach(o),Nl=i(Yo),xt=a(Yo,"P",{});var Vr=s(xt);Il=d(Vr,"This model is also a PyTorch "),Bt=a(Vr,"A",{href:!0,rel:!0});var Im=s(Bt);Al=d(Im,"torch.nn.Module"),Im.forEach(o),Dl=d(Vr,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Vr.forEach(o),Gl=i(Yo),be=a(Yo,"DIV",{class:!0});var to=s(be);_(zt.$$.fragment,to),Ul=i(to),vo=a(to,"P",{});var Yn=s(vo);Wl=d(Yn,"The "),Ln=a(Yn,"A",{href:!0});var Am=s(Ln);Rl=d(Am,"BlenderbotSmallForConditionalGeneration"),Am.forEach(o),Hl=d(Yn," forward method, overrides the "),Fa=a(Yn,"CODE",{});var Dm=s(Fa);Kl=d(Dm,"__call__"),Dm.forEach(o),Vl=d(Yn," special method."),Yn.forEach(o),Ql=i(to),_(No.$$.fragment,to),Jl=i(to),qa=a(to,"P",{});var Gm=s(qa);Xl=d(Gm,"Conversation example:"),Gm.forEach(o),Yl=i(to),_(Ft.$$.fragment,to),to.forEach(o),Yo.forEach(o),wr=i(t),To=a(t,"H2",{class:!0});var Qr=s(To);Io=a(Qr,"A",{id:!0,class:!0,href:!0});var Um=s(Io);$a=a(Um,"SPAN",{});var Wm=s($a);_(qt.$$.fragment,Wm),Wm.forEach(o),Um.forEach(o),Zl=i(Qr),Ea=a(Qr,"SPAN",{});var Rm=s(Ea);ei=d(Rm,"BlenderbotSmallForCausalLM"),Rm.forEach(o),Qr.forEach(o),Sr=i(t),wo=a(t,"DIV",{class:!0});var Jr=s(wo);_($t.$$.fragment,Jr),oi=i(Jr),Ve=a(Jr,"DIV",{class:!0});var Zn=s(Ve);_(Et.$$.fragment,Zn),ti=i(Zn),Ma=a(Zn,"P",{});var Hm=s(Ma);ni=d(Hm,"Example:"),Hm.forEach(o),ai=i(Zn),_(Mt.$$.fragment,Zn),Zn.forEach(o),Jr.forEach(o),xr=i(t),So=a(t,"H2",{class:!0});var Xr=s(So);Ao=a(Xr,"A",{id:!0,class:!0,href:!0});var Km=s(Ao);Ca=a(Km,"SPAN",{});var Vm=s(Ca);_(Ct.$$.fragment,Vm),Vm.forEach(o),Km.forEach(o),si=i(Xr),ja=a(Xr,"SPAN",{});var Qm=s(ja);ri=d(Qm,"TFBlenderbotSmallModel"),Qm.forEach(o),Xr.forEach(o),Br=i(t),me=a(t,"DIV",{class:!0});var no=s(me);_(jt.$$.fragment,no),di=i(no),Ot=a(no,"P",{});var Yr=s(Ot);li=d(Yr,`The bare BLENDERBOT_SMALL Model outputting raw hidden-states without any specific head on top.
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Zr.forEach(o),fi=i(no),_(Do.$$.fragment,no),_i=i(no),ke=a(no,"DIV",{class:!0});var ao=s(ke);_(Nt.$$.fragment,ao),gi=i(ao),xo=a(ao,"P",{});var ea=s(xo);bi=d(ea,"The "),In=a(ea,"A",{href:!0});var Ym=s(In);ki=d(Ym,"TFBlenderbotSmallModel"),Ym.forEach(o),yi=d(ea," forward method, overrides the "),Oa=a(ea,"CODE",{});var Zm=s(Oa);vi=d(Zm,"__call__"),Zm.forEach(o),Ti=d(ea," special method."),ea.forEach(o),wi=i(ao),_(Go.$$.fragment,ao),Si=i(ao),Pa=a(ao,"P",{});var eh=s(Pa);xi=d(eh,"Example:"),eh.forEach(o),Bi=i(ao),_(It.$$.fragment,ao),ao.forEach(o),no.forEach(o),zr=i(t),Bo=a(t,"H2",{class:!0});var ed=s(Bo);Uo=a(ed,"A",{id:!0,class:!0,href:!0});var oh=s(Uo);La=a(oh,"SPAN",{});var th=s(La);_(At.$$.fragment,th),th.forEach(o),oh.forEach(o),zi=i(ed),Na=a(ed,"SPAN",{});var nh=s(Na);Fi=d(nh,"TFBlenderbotSmallForConditionalGeneration"),nh.forEach(o),ed.forEach(o),Fr=i(t),he=a(t,"DIV",{class:!0});var so=s(he);_(Dt.$$.fragment,so),qi=i(so),Gt=a(so,"P",{});var od=s(Gt);$i=d(od,`The BLENDERBOT_SMALL Model with a language modeling head. Can be used for summarization.
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),td.forEach(o),Li=i(so),_(Wo.$$.fragment,so),Ni=i(so),O=a(so,"DIV",{class:!0});var H=s(O);_(Rt.$$.fragment,H),Ii=i(H),zo=a(H,"P",{});var oa=s(zo);Ai=d(oa,"The "),Dn=a(oa,"A",{href:!0});var rh=s(Dn);Di=d(rh,"TFBlenderbotSmallForConditionalGeneration"),rh.forEach(o),Gi=d(oa," forward method, overrides the "),Ia=a(oa,"CODE",{});var dh=s(Ia);Ui=d(dh,"__call__"),dh.forEach(o),Wi=d(oa," special method."),oa.forEach(o),Ri=i(H),_(Ro.$$.fragment,H),Hi=i(H),Aa=a(H,"P",{});var lh=s(Aa);Ki=d(lh,"Conversation example::"),lh.forEach(o),Vi=i(H),Da=a(H,"BLOCKQUOTE",{});var ih=s(Da);Ga=a(ih,"BLOCKQUOTE",{});var ch=s(Ga);Ua=a(ch,"BLOCKQUOTE",{});var ph=s(Ua);Wa=a(ph,"P",{});var mh=s(Wa);Qi=d(mh,`from transformers import BlenderbotSmallTokenizer, TFBlenderbotSmallForConditionalGeneration >>> mname =
\u2018facebook/blenderbot_small-90M\u2019 >>> model = BlenderbotSmallForConditionalGeneration.from_pretrained(mname) >>>
tokenizer = BlenderbotSmallTokenizer.from_pretrained(mname)`),mh.forEach(o),ph.forEach(o),ch.forEach(o),ih.forEach(o),Ji=i(H),Ra=a(H,"BLOCKQUOTE",{});var hh=s(Ra);Ha=a(hh,"BLOCKQUOTE",{});var uh=s(Ha);Ka=a(uh,"BLOCKQUOTE",{});var fh=s(Ka);Va=a(fh,"P",{});var _h=s(Va);Xi=d(_h,`UTTERANCE = \u201CMy friends are cool but they eat too many carbs.\u201D >>> print(\u201CHuman: \u201D, UTTERANCE) >>> inputs =
tokenizer([UTTERANCE], return_tensors=\u2018tf\u2019)`),_h.forEach(o),fh.forEach(o),uh.forEach(o),hh.forEach(o),Yi=i(H),Qa=a(H,"BLOCKQUOTE",{});var gh=s(Qa);Ja=a(gh,"BLOCKQUOTE",{});var bh=s(Ja);Xa=a(bh,"BLOCKQUOTE",{});var kh=s(Xa);Ya=a(kh,"P",{});var yh=s(Ya);Zi=d(yh,`reply_ids = model.generate(**inputs) >>> print(\u201CBot: \u201D, tokenizer.batch_decode(reply_ids,
...
\u201D<s>I\u2019m not sure.\u201D \u2026 )`),nd.forEach(o),wh.forEach(o),Th.forEach(o),vh.forEach(o),ac=i(H),ns=a(H,"BLOCKQUOTE",{});var xh=s(ns);as=a(xh,"BLOCKQUOTE",{});var Bh=s(as);ss=a(Bh,"BLOCKQUOTE",{});var zh=s(ss);rs=a(zh,"P",{});var Fh=s(rs);sc=d(Fh,`inputs = tokenizer([NEXT_UTTERANCE], return_tensors=\u2018tf\u2019) >>> inputs.pop(\u201Ctoken_type_ids\u201D) >>>
next_reply_ids = model.generate(**inputs) >>> print(\u201CBot: \u201D, tokenizer.batch_decode(next_reply_ids,
skip_special_tokens=True)[0])`),Fh.forEach(o),zh.forEach(o),Bh.forEach(o),xh.forEach(o),H.forEach(o),so.forEach(o),qr=i(t),Fo=a(t,"H2",{class:!0});var ad=s(Fo);Ho=a(ad,"A",{id:!0,class:!0,href:!0});var qh=s(Ho);ds=a(qh,"SPAN",{});var $h=s(ds);_(Kt.$$.fragment,$h),$h.forEach(o),qh.forEach(o),rc=i(ad),ls=a(ad,"SPAN",{});var Eh=s(ls);dc=d(Eh,"FlaxBlenderbotSmallModel"),Eh.forEach(o),ad.forEach(o),$r=i(t),N=a(t,"DIV",{class:!0});var te=s(N);_(Vt.$$.fragment,te),lc=i(te),Qt=a(te,"P",{});var sd=s(Qt);ic=d(sd,`The bare BlenderbotSmall Model transformer outputting raw hidden-states without any specific head on top.
...
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),rd.forEach(o),_c=i(te),is=a(te,"P",{});var jh=s(is);gc=d(jh,"Finally, this model supports inherent JAX features such as:"),jh.forEach(o),bc=i(te),Ue=a(te,"UL",{});var Zo=s(Ue);cs=a(Zo,"LI",{});var Oh=s(cs);Yt=a(Oh,"A",{href:!0,rel:!0});var Ph=s(Yt);kc=d(Ph,"Just-In-Time (JIT) compilation"),Ph.forEach(o),Oh.forEach(o),yc=i(Zo),ps=a(Zo,"LI",{});var Lh=s(ps);Zt=a(Lh,"A",{href:!0,rel:!0});var Nh=s(Zt);vc=d(Nh,"Automatic Differentiation"),Nh.forEach(o),Lh.forEach(o),Tc=i(Zo),ms=a(Zo,"LI",{});var Ih=s(ms);en=a(Ih,"A",{href:!0,rel:!0});var Ah=s(en);wc=d(Ah,"Vectorization"),Ah.forEach(o),Ih.forEach(o),Sc=i(Zo),hs=a(Zo,"LI",{});var Dh=s(hs);on=a(Dh,"A",{href:!0,rel:!0});var Gh=s(on);xc=d(Gh,"Parallelization"),Gh.forEach(o),Dh.forEach(o),Zo.forEach(o),Bc=i(te),Qe=a(te,"DIV",{class:!0});var ta=s(Qe);_(tn.$$.fragment,ta),zc=i(ta),us=a(ta,"P",{});var Uh=s(us);Fc=d(Uh,"Example:"),Uh.forEach(o),qc=i(ta),_(nn.$$.fragment,ta),ta.forEach(o),$c=i(te),Je=a(te,"DIV",{class:!0});var na=s(Je);_(an.$$.fragment,na),Ec=i(na),fs=a(na,"P",{});var Wh=s(fs);Mc=d(Wh,"Example:"),Wh.forEach(o),Cc=i(na),_(sn.$$.fragment,na),na.forEach(o),jc=i(te),Xe=a(te,"DIV",{class:!0});var aa=s(Xe);_(rn.$$.fragment,aa),Oc=i(aa),_s=a(aa,"P",{});var Rh=s(_s);Pc=d(Rh,"Example:"),Rh.forEach(o),Lc=i(aa),_(dn.$$.fragment,aa),aa.forEach(o),te.forEach(o),Er=i(t),qo=a(t,"H2",{class:!0});var dd=s(qo);Ko=a(dd,"A",{id:!0,class:!0,href:!0});var Hh=s(Ko);gs=a(Hh,"SPAN",{});var Kh=s(gs);_(ln.$$.fragment,Kh),Kh.forEach(o),Hh.forEach(o),Nc=i(dd),bs=a(dd,"SPAN",{});var Vh=s(bs);Ic=d(Vh,"FlaxBlenderbotForConditionalGeneration"),Vh.forEach(o),dd.forEach(o),Mr=i(t),I=a(t,"DIV",{class:!0});var ne=s(I);_(cn.$$.fragment,ne),Ac=i(ne),pn=a(ne,"P",{});var ld=s(pn);Dc=d(ld,`The BLENDERBOT_SMALL Model with a language modeling head. Can be used for summarization.
This model inherits from `),Un=a(ld,"A",{href:!0});var Qh=s(Un);Gc=d(Qh,"FlaxPreTrainedModel"),Qh.forEach(o),Uc=d(ld,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
tokenizer([ARTICLE_TO_SUMMARIZE], max_length=1024, return_tensors=\u2018np\u2019)`),yu.forEach(o),ku.forEach(o),bu.forEach(o),gu.forEach(o),yp=i(E),Is=a(E,"BLOCKQUOTE",{});var vu=s(Is);As=a(vu,"BLOCKQUOTE",{});var Tu=s(As);kn=a(Tu,"BLOCKQUOTE",{});var cd=s(kn);Qo=a(cd,"H1",{class:!0});var pd=s(Qo);Jo=a(pd,"A",{id:!0,class:!0,href:!0});var wu=s(Jo);Ds=a(wu,"SPAN",{});var Su=s(Ds);_(yn.$$.fragment,Su),Su.forEach(o),wu.forEach(o),vp=i(pd),Gs=a(pd,"SPAN",{});var xu=s(Gs);Tp=d(xu,"Generate Summary >>> summary_ids = model.generate(inputs[\u2018input_ids\u2019]).sequences >>>"),xu.forEach(o),pd.forEach(o),wp=i(cd),Us=a(cd,"P",{});var Bu=s(Us);Sp=d(Bu,"print(tokenizer.batch_decode(summary_ids, skip_special_tokens=True, clean_up_tokenization_spaces=False))"),Bu.forEach(o),cd.forEach(o),Tu.forEach(o),vu.forEach(o),xp=i(E),Ws=a(E,"P",{});var zu=s(Ws);Bp=d(zu,"Mask filling example:"),zu.forEach(o),zp=i(E),Rs=a(E,"BLOCKQUOTE",{});var Fu=s(Rs);Hs=a(Fu,"BLOCKQUOTE",{});var qu=s(Hs);Ks=a(qu,"BLOCKQUOTE",{});var $u=s(Ks);Vs=a($u,"P",{});var Eu=s(Vs);Fp=d(Eu,`from transformers import BlenderbotSmallTokenizer, FlaxBlenderbotSmallForConditionalGeneration >>>
tokenizer = BlenderbotSmallTokenizer.from_pretrained(\u2018facebook/blenderbot_small-90M\u2019) >>> TXT = \u201CMy friends are
