...
the latter silently ignores them.`)},l(g){h=i(g,"P",{});var f=r(h);L=s(f,"Although the recipe for forward pass needs to be defined within this function, one should call the "),m=i(f,"CODE",{});var z=r(m);w=s(z,"Module"),z.forEach(t),E=s(f,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),f.forEach(t)},m(g,f){u(g,h,f),e(h,L),e(h,m),e(m,w),e(h,E)},d(g){g&&t(h)}}}function hp(U){let h,L,m,w,E,g,f,z,Ds,Ho,le,xe,Nn,He,Bs,Dn,Ws,Vo,$e,Us,Ve,Ks,Rs,Yo,Jt,Hs,Qo,Xt,Bn,Vs,Jo,Gt,Ys,Xo,R,Wn,Ye,Qs,Zt,Js,Xs,Gs,Un,q,Zs,Kn,ea,ta,Rn,na,oa,Hn,sa,aa,Vn,ia,ra,en,da,la,ca,Qe,H,tn,pa,ha,Yn,ua,ma,Qn,fa,ga,Jn,_a,ka,ya,Je,nn,Xn,ba,va,Ta,on,Gn,wa,La,Ea,K,Zn,za,xa,ce,qe,sn,$a,qa,Xe,Fa,Ca,Ma,Fe,an,Pa,ja,Ge,Aa,Ia,Oa,rn,dn,Sa,Na,Da,O,ln,Ba,Wa,eo,Ua,Ka,to,Ra,Ha,no,Va,Ya,oo,Qa,Ja,Xa,pe,Ga,cn,Za,ei,Ze,ti,ni,oi,et,si,tt,ai,ii,Go,pn,ri,Zo,nt,es,V,di,ot,li,ci,st,pi,hi,at,ui,mi,ts,he,Ce,so,it,fi,ao,gi,ns,F,rt,_i,dt,ki,hn,yi,bi,vi,ue,Ti,un,wi,Li,mn,Ei,zi,xi,io,$i,qi,lt,os,me,Me,ro,ct,Fi,lo,Ci,ss,C,pt,Mi,co,Pi,ji,x,Ai,fn,Ii,Oi,gn,Si,Ni,_n,Di,Bi,po,Wi,Ui,ho,Ki,Ri,uo,Hi,Vi,mo,Yi,Qi,Ji,Pe,ht,Xi,fo,Gi,Zi,kn,ut,as,fe,je,go,mt,er,_o,tr,is,M,ft,nr,ko,or,sr,gt,ar,yn,ir,rr,dr,_t,lr,kt,cr,pr,hr,S,yt,ur,ge,mr,bn,fr,gr,yo,_r,kr,yr,Ae,br,bo,vr,Tr,bt,rs,_e,Ie,vo,vt,wr,To,Lr,ds,P,Tt,Er,wo,zr,xr,wt,$r,vn,qr,Fr,Cr,Lt,Mr,Et,Pr,jr,Ar,J,zt,Ir,ke,Or,Tn,Sr,Nr,Lo,Dr,Br,Wr,Oe,ls,ye,Se,Eo,xt,Ur,zo,Kr,cs,j,$t,Rr,xo,Hr,Vr,qt,Yr,wn,Qr,Jr,Xr,Ft,Gr,Ct,Zr,ed,td,N,Mt,nd,be,od,Ln,sd,ad,$o,id,rd,dd,Ne,ld,qo,cd,pd,Pt,ps,ve,De,Fo,jt,hd,Co,ud,hs,A,At,md,Mo,fd,gd,It,_d,En,kd,yd,bd,Ot,vd,St,Td,wd,Ld,D,Nt,Ed,Te,zd,zn,xd,$d,Po,qd,Fd,Cd,Be,Md,jo,Pd,jd,Dt,us,we,We,Ao,Bt,Ad,Io,Id,ms,I,Wt,Od,Oo,Sd,Nd,Ut,Dd,xn,Bd,Wd,Ud,Kt,Kd,Rt,Rd,Hd,Vd,B,Ht,Yd,Le,Qd,$n,Jd,Xd,So,Gd,Zd,el,Ue,tl,No,nl,ol,Vt,fs;return g=new ze({}),He=new ze({}),nt=new Sn({props:{code:`from transformers import LukeTokenizer, LukeModel, LukeForEntityPairClassification
...
`}}),Ae=new Ro({props:{$$slots:{default:[rp]},$$scope:{ctx:U}}}),bt=new Sn({props:{code:`from transformers import LukeTokenizer, LukeModel
...
documentation from `),mn=a("a"),Ei=o("PretrainedConfig"),zi=o(" for more information."),xi=l(),io=a("p"),$i=o("Examples:"),qi=l(),_(lt.$$.fragment),os=l(),me=a("h2"),Me=a("a"),ro=a("span"),_(ct.$$.fragment),Fi=l(),lo=a("span"),Ci=o("LukeTokenizer"),ss=l(),C=a("div"),_(pt.$$.fragment),Mi=l(),co=a("p"),Pi=o("Construct a LUKE tokenizer."),ji=l(),x=a("p"),Ai=o("This tokenizer inherits from "),fn=a("a"),Ii=o("RobertaTokenizer"),Oi=o(` which contains most of the main methods. Users should refer to
...
masked entity prediction.`),xr=l(),wt=a("p"),$r=o("This model inherits from "),vn=a("a"),qr=o("PreTrainedModel"),Fr=o(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Cr=l(),Lt=a("p"),Mr=o("This model is also a PyTorch "),Et=a("a"),Pr=o("torch.nn.Module"),jr=o(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Ar=l(),J=a("div"),_(zt.$$.fragment),Ir=l(),ke=a("p"),Or=o("The "),Tn=a("a"),Sr=o("LukeForMaskedLM"),Nr=o(" forward method, overrides the "),Lo=a("code"),Dr=o("__call__"),Br=o(" special method."),Wr=l(),_(Oe.$$.fragment),ls=l(),ye=a("h2"),Se=a("a"),Eo=a("span"),_(xt.$$.fragment),Ur=l(),zo=a("span"),Kr=o("LukeForEntityClassification"),cs=l(),j=a("div"),_($t.$$.fragment),Rr=l(),xo=a("p"),Hr=o(`The LUKE model with a classification head on top (a linear layer on top of the hidden state of the first entity
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Xr=l(),Ft=a("p"),Gr=o("This model is also a PyTorch "),Ct=a("a"),Zr=o("torch.nn.Module"),ed=o(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),td=l(),N=a("div"),_(Mt.$$.fragment),nd=l(),be=a("p"),od=o("The "),Ln=a("a"),sd=o("LukeForEntityClassification"),ad=o(" forward method, overrides the "),$o=a("code"),id=o("__call__"),rd=o(" special method."),dd=l(),_(Ne.$$.fragment),ld=l(),qo=a("p"),cd=o("Examples:"),pd=l(),_(Pt.$$.fragment),ps=l(),ve=a("h2"),De=a("a"),Fo=a("span"),_(jt.$$.fragment),hd=l(),Co=a("span"),ud=o("LukeForEntityPairClassification"),hs=l(),A=a("div"),_(At.$$.fragment),md=l(),Mo=a("p"),fd=o(`The LUKE model with a classification head on top (a linear layer on top of the hidden states of the two entity
...
using Wikipedia entities as input tokens, LUKE outputs token representations enriched by the information stored in
the embeddings of these entities. This is particularly effective for tasks requiring real-world knowledge, such as
question answering.`),al.forEach(t),ys.forEach(t),ks.forEach(t),Ea=c(Ke),K=i(Ke,"LI",{});var X=r(K);Zn=i(X,"P",{});var ql=r(Zn);za=s(ql,"There are three head models for the former use case:"),ql.forEach(t),xa=c(X),ce=i(X,"UL",{});var qn=r(ce);qe=i(qn,"LI",{});var Uo=r(qe);sn=i(Uo,"A",{href:!0});var Fl=r(sn);$a=s(Fl,"LukeForEntityClassification"),Fl.forEach(t),qa=s(Uo,`, for tasks to classify a single entity in an input text such as
entity typing, e.g. the `),Xe=i(Uo,"A",{href:!0,rel:!0});var Cl=r(Xe);Fa=s(Cl,"Open Entity dataset"),Cl.forEach(t),Ca=s(Uo,`.
This model places a linear head on top of the output entity representation.`),Uo.forEach(t),Ma=c(qn),Fe=i(qn,"LI",{});var Ko=r(Fe);an=i(Ko,"A",{href:!0});var Ml=r(an);Pa=s(Ml,"LukeForEntityPairClassification"),Ml.forEach(t),ja=s(Ko,`, for tasks to classify the relationship between two entities
...
masked entity prediction.`),Ec.forEach(t),xr=c(ne),wt=i(ne,"P",{});var qs=r(wt);$r=s(qs,"This model inherits from "),vn=i(qs,"A",{href:!0});var zc=r(vn);qr=s(zc,"PreTrainedModel"),zc.forEach(t),Fr=s(qs,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),qs.forEach(t),Cr=c(ne),Lt=i(ne,"P",{});var Fs=r(Lt);Mr=s(Fs,"This model is also a PyTorch "),Et=i(Fs,"A",{href:!0,rel:!0});var xc=r(Et);Pr=s(xc,"torch.nn.Module"),xc.forEach(t),jr=s(Fs,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Fs.forEach(t),Ar=c(ne),J=i(ne,"DIV",{class:!0});var Pn=r(J);k(zt.$$.fragment,Pn),Ir=c(Pn),ke=i(Pn,"P",{});var jn=r(ke);Or=s(jn,"The "),Tn=i(jn,"A",{href:!0});var $c=r(Tn);Sr=s($c,"LukeForMaskedLM"),$c.forEach(t),Nr=s(jn," forward method, overrides the "),Lo=i(jn,"CODE",{});var qc=r(Lo);Dr=s(qc,"__call__"),qc.forEach(t),Br=s(jn," special method."),jn.forEach(t),Wr=c(Pn),k(Oe.$$.fragment,Pn),Pn.forEach(t),ne.forEach(t),ls=c(n),ye=i(n,"H2",{class:!0});var Cs=r(ye);Se=i(Cs,"A",{id:!0,class:!0,href:!0});var Fc=r(Se);Eo=i(Fc,"SPAN",{});var Cc=r(Eo);k(xt.$$.fragment,Cc),Cc.forEach(t),Fc.forEach(t),Ur=c(Cs),zo=i(Cs,"SPAN",{});var Mc=r(zo);Kr=s(Mc,"LukeForEntityClassification"),Mc.forEach(t),Cs.forEach(t),cs=c(n),j=i(n,"DIV",{class:!0});var oe=r(j);k($t.$$.fragment,oe),Rr=c(oe),xo=i(oe,"P",{});var Pc=r(xo);Hr=s(Pc,`The LUKE model with a classification head on top (a linear layer on top of the hidden state of the first entity
token) for entity classification tasks, such as Open Entity.`),Pc.forEach(t),Vr=c(oe),qt=i(oe,"P",{});var Ms=r(qt);Yr=s(Ms,"This model inherits from "),wn=i(Ms,"A",{href:!0});var jc=r(wn);Qr=s(jc,"PreTrainedModel"),jc.forEach(t),Jr=s(Ms,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Ms.forEach(t),Xr=c(oe),Ft=i(oe,"P",{});var Ps=r(Ft);Gr=s(Ps,"This model is also a PyTorch "),Ct=i(Ps,"A",{href:!0,rel:!0});var Ac=r(Ct);Zr=s(Ac,"torch.nn.Module"),Ac.forEach(t),ed=s(Ps,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Ps.forEach(t),td=c(oe),N=i(oe,"DIV",{class:!0});var se=r(N);k(Mt.$$.fragment,se),nd=c(se),be=i(se,"P",{});var An=r(be);od=s(An,"The "),Ln=i(An,"A",{href:!0});var Ic=r(Ln);sd=s(Ic,"LukeForEntityClassification"),Ic.forEach(t),ad=s(An," forward method, overrides the "),$o=i(An,"CODE",{});var Oc=r($o);id=s(Oc,"__call__"),Oc.forEach(t),rd=s(An," special method."),An.forEach(t),dd=c(se),k(Ne.$$.fragment,se),ld=c(se),qo=i(se,"P",{});var Sc=r(qo);cd=s(Sc,"Examples:"),Sc.forEach(t),pd=c(se),k(Pt.$$.fragment,se),se.forEach(t),oe.forEach(t),ps=c(n),ve=i(n,"H2",{class:!0});var js=r(ve);De=i(js,"A",{id:!0,class:!0,href:!0});var Nc=r(De);Fo=i(Nc,"SPAN",{});var Dc=r(Fo);k(jt.$$.fragment,Dc),Dc.forEach(t),Nc.forEach(t),hd=c(js),Co=i(js,"SPAN",{});var Bc=r(Co);ud=s(Bc,"LukeForEntityPairClassification"),Bc.forEach(t),js.forEach(t),hs=c(n),A=i(n,"DIV",{class:!0});var ae=r(A);k(At.$$.fragment,ae),md=c(ae),Mo=i(ae,"P",{});var Wc=r(Mo);fd=s(Wc,`The LUKE model with a classification head on top (a linear layer on top of the hidden states of the two entity
