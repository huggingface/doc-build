...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/v4.19.3/src/transformers/models/blenderbot_small/tokenization_blenderbot_small_fast.py#L96",returnDescription:`
<p>List of zeros.</p>
`,returnType:`
<p><code>List[int]</code></p>
...
elements depending on the configuration (<a
  href="/docs/transformers/v4.19.3/en/model_doc/blenderbot-small#transformers.BlenderbotSmallConfig"
...
(masked), the loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.19.3/src/transformers/models/blenderbot_small/modeling_blenderbot_small.py#L1246",returnDescription:`
<p>A <a
...
behaviors between training and evaluation).`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/v4.19.3/src/transformers/models/blenderbot_small/modeling_tf_blenderbot_small.py#L1123",returnDescription:`
<p>A <a
...
Labels for computing the masked language modeling loss. Indices should either be in <code>[0, ..., config.vocab_size]</code> or -100 (see <code>input_ids</code> docstring). Tokens with indices set to <code>-100</code> are ignored
(masked), the loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.19.3/src/transformers/models/blenderbot_small/modeling_tf_blenderbot_small.py#L1231",returnDescription:`
<p>A <a
...
Whether or not to return a <a href="/docs/transformers/v4.19.3/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/v4.19.3/src/transformers/models/blenderbot_small/modeling_flax_blenderbot_small.py#L972",returnDescription:`
<p>A <a
...
Whether or not to return a <a href="/docs/transformers/v4.19.3/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/v4.19.3/src/transformers/models/blenderbot_small/modeling_flax_blenderbot_small.py#L1035",returnDescription:`
<p>A <a
...
Whether or not to return a <a href="/docs/transformers/v4.19.3/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/v4.19.3/src/transformers/models/blenderbot_small/modeling_flax_blenderbot_small.py#L1307",returnDescription:`
<p>A <a
...
`}}),at=new Je({props:{anchor:"transformers.FlaxBlenderbotSmallForConditionalGeneration.decode.example",$$slots:{default:[Fh]},$$scope:{ctx:z}}}),{c(){p=n("meta"),k=i(),f=n("h1"),u=n("a"),b=n("span"),v(d.$$.fragment),h=i(),F=n("span"),Ce=r("Blenderbot Small"),ue=i(),B=n("p"),je=r("Note that "),W=n("a"),Oe=r("BlenderbotSmallModel"),Pe=r(` and
...
special tokens using the tokenizer `),ma=n("code"),Ul=r("prepare_for_model"),Wl=r(" or "),ua=n("code"),Rl=r("encode_plus"),Hl=r(" methods."),Kl=i(),Ke=n("div"),v(vt.$$.fragment),Vl=i(),On=n("p"),Ql=r("Create the token type IDs corresponding to the sequences passed. "),Pn=n("a"),Jl=r(`What are token type
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Nd=i(),Ee=n("div"),v(Lt.$$.fragment),Id=i(),uo=n("p"),Ad=r("The "),Dn=n("a"),Dd=r("BlenderbotSmallForConditionalGeneration"),Gd=r(" forward method, overrides the "),$a=n("code"),Ud=r("__call__"),Wd=r(" special method."),Rd=i(),v(Mo.$$.fragment),Hd=i(),v(Co.$$.fragment),kr=i(),ho=n("h2"),jo=n("a"),Sa=n("span"),v(Nt.$$.fragment),Kd=i(),xa=n("span"),Vd=r("BlenderbotSmallForCausalLM"),vr=i(),fo=n("div"),v(It.$$.fragment),Qd=i(),Oo=n("div"),v(At.$$.fragment),Jd=i(),v(Po.$$.fragment),yr=i(),_o=n("h2"),Lo=n("a"),Ba=n("span"),v(Dt.$$.fragment),Xd=i(),za=n("span"),Yd=r("TFBlenderbotSmallModel"),Tr=i(),pe=n("div"),v(Gt.$$.fragment),Zd=i(),Ut=n("p"),ei=r(`The bare BLENDERBOT_SMALL Model outputting raw hidden-states without any specific head on top.
...
jax.nn.softmax(logits[0, masked_index], axis=0) >>> values, predictions = jax.lax.top_k(probs)`),gp=i(),Ks=n("blockquote"),Vs=n("blockquote"),Qs=n("blockquote"),Js=n("p"),bp=r("tokenizer.decode(predictions).split()"),kp=i(),ot=n("div"),v(Sn.$$.fragment),vp=i(),v(tt.$$.fragment),yp=i(),nt=n("div"),v(xn.$$.fragment),Tp=i(),v(at.$$.fragment),this.h()},l(t){const g=ph('[data-svelte="svelte-1phssyn"]',document.head);p=a(g,"META",{name:!0,content:!0}),g.forEach(o),k=c(t),f=a(t,"H1",{class:!0});var Bn=s(f);u=a(Bn,"A",{id:!0,class:!0,href:!0});var Xs=s(u);b=a(Xs,"SPAN",{});var Ys=s(b);y(d.$$.fragment,Ys),Ys.forEach(o),Xs.forEach(o),h=c(Bn),F=a(Bn,"SPAN",{});var Zs=s(F);Ce=l(Zs,"Blenderbot Small"),Zs.forEach(o),Bn.forEach(o),ue=c(t),B=a(t,"P",{});var _e=s(B);je=l(_e,"Note that "),W=a(_e,"A",{href:!0});var er=s(W);Oe=l(er,"BlenderbotSmallModel"),er.forEach(o),Pe=l(_e,` and
