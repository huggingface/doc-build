import{S as Qu,i as wu,s as $u,e as r,k as p,w as v,t as n,M as Tu,c as a,d as o,m as h,a as i,x as Q,h as s,b as f,G as e,g as b,y as w,q as $,o as T,B as y,v as yu,L as O}from"../../chunks/vendor-hf-doc-builder.js";import{T as xt}from"../../chunks/Tip-hf-doc-builder.js";import{D as j}from"../../chunks/Docstring-hf-doc-builder.js";import{C as M}from"../../chunks/CodeBlock-hf-doc-builder.js";import{I as J}from"../../chunks/IconCopyLink-hf-doc-builder.js";import{E as I}from"../../chunks/ExampleCodeBlock-hf-doc-builder.js";function qu(q){let d,_,c,u,k;return u=new M({props:{code:`from transformers import QDQBertModel, QDQBertConfig
...
`}}),{c(){v(d.$$.fragment)},l(c){Q(d.$$.fragment,c)},m(c,u){w(d,c,u),_=!0},p:O,i(c){_||($(d.$$.fragment,c),_=!0)},o(c){T(d.$$.fragment,c),_=!1},d(c){y(d,c)}}}function Fu(q){let d,_,c,u,k;return{c(){d=r("p"),_=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),c=r("code"),u=n("Module"),k=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(l){d=a(l,"P",{});var m=i(d);_=s(m,"Although the recipe for forward pass needs to be defined within this function, one should call the "),c=a(m,"CODE",{});var D=i(c);u=s(D,"Module"),D.forEach(o),k=s(m,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
`}}),{c(){v(d.$$.fragment)},l(c){Q(d.$$.fragment,c)},m(c,u){w(d,c,u),_=!0},p:O,i(c){_||($(d.$$.fragment,c),_=!0)},o(c){T(d.$$.fragment,c),_=!1},d(c){y(d,c)}}}function Au(q){let d,_,c,u,k;return u=new M({props:{code:`import torch
from transformers import BertTokenizer, QDQBertForSequenceClassification
...
<span class="hljs-meta">... </span>)
<span class="hljs-meta">&gt;&gt;&gt; </span>loss = model(**inputs, labels=labels).loss
<span class="hljs-meta">&gt;&gt;&gt; </span>loss.backward()`}}),{c(){v(d.$$.fragment)},l(c){Q(d.$$.fragment,c)},m(c,u){w(d,c,u),_=!0},p:O,i(c){_||($(d.$$.fragment,c),_=!0)},o(c){T(d.$$.fragment,c),_=!1},d(c){y(d,c)}}}function Su(q){let d,_,c,u,k;return{c(){d=r("p"),_=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),c=r("code"),u=n("Module"),k=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(l){d=a(l,"P",{});var m=i(d);_=s(m,"Although the recipe for forward pass needs to be defined within this function, one should call the "),c=a(m,"CODE",{});var D=i(c);u=s(D,"Module"),D.forEach(o),k=s(m,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
`}}),{c(){d=r("p"),_=n("Example:"),c=p(),v(u.$$.fragment)},l(l){d=a(l,"P",{});var m=i(d);_=s(m,"Example:"),m.forEach(o),c=h(l),Q(u.$$.fragment,l)},m(l,m){b(l,d,m),e(d,_),b(l,c,m),w(u,l,m),k=!0},p:O,i(l){k||($(u.$$.fragment,l),k=!0)},o(l){T(u.$$.fragment,l),k=!1},d(l){l&&o(d),l&&o(c),y(u,l)}}}function Ru(q){let d,_;return d=new M({props:{code:`labels = predicted_token_class_ids
loss = model(**inputs, labels=labels).loss
round(loss.item(), 2)
`,highlighted:`<span class="hljs-meta">&gt;&gt;&gt; </span>labels = predicted_token_class_ids
<span class="hljs-meta">&gt;&gt;&gt; </span>loss = model(**inputs, labels=labels).loss
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-built_in">round</span>(loss.item(), <span class="hljs-number">2</span>)
`}}),{c(){v(d.$$.fragment)},l(c){Q(d.$$.fragment,c)},m(c,u){w(d,c,u),_=!0},p:O,i(c){_||($(d.$$.fragment,c),_=!0)},o(c){T(d.$$.fragment,c),_=!1},d(c){y(d,c)}}}function Uu(q){let d,_,c,u,k;return{c(){d=r("p"),_=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),c=r("code"),u=n("Module"),k=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(l){d=a(l,"P",{});var m=i(d);_=s(m,"Although the recipe for forward pass needs to be defined within this function, one should call the "),c=a(m,"CODE",{});var D=i(c);u=s(D,"Module"),D.forEach(o),k=s(m,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
`}}),{c(){d=r("p"),_=n("Example:"),c=p(),v(u.$$.fragment)},l(l){d=a(l,"P",{});var m=i(d);_=s(m,"Example:"),m.forEach(o),c=h(l),Q(u.$$.fragment,l)},m(l,m){b(l,d,m),e(d,_),b(l,c,m),w(u,l,m),k=!0},p:O,i(l){k||($(u.$$.fragment,l),k=!0)},o(l){T(u.$$.fragment,l),k=!1},d(l){l&&o(d),l&&o(c),y(u,l)}}}function Xu(q){let d,_;return d=new M({props:{code:`# target is "nice puppet"
...
<span class="hljs-meta">&gt;&gt;&gt; </span>loss = outputs.loss
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-built_in">round</span>(loss.item(), <span class="hljs-number">2</span>)
`}}),{c(){v(d.$$.fragment)},l(c){Q(d.$$.fragment,c)},m(c,u){w(d,c,u),_=!0},p:O,i(c){_||($(d.$$.fragment,c),_=!0)},o(c){T(d.$$.fragment,c),_=!1},d(c){y(d,c)}}}function Ju(q){let d,_,c,u,k,l,m,D,Da,dr,fe,Se,Sn,jt,za,Ln,Ba,cr,Le,Ma,Et,xa,ja,pr,tn,Ea,hr,on,In,Fa,ur,nn,Pa,mr,G,On,Wn,Ca,Aa,Hn,Ie,Na,Ft,Sa,La,Rn,Ia,Oa,Un,Pt,Wa,Vn,Ha,Ra,Ua,Xn,Ct,Va,sn,Xa,Ja,fr,Oe,Ka,At,Ga,Ya,gr,ge,We,Jn,Nt,Za,Kn,ei,_r,E,ti,Gn,oi,ni,St,si,ri,Yn,ai,ii,Zn,li,di,Lt,ci,pi,br,He,hi,es,ui,mi,kr,rn,fi,vr,It,Qr,_e,Re,ts,Ot,gi,os,_i,wr,an,bi,$r,Wt,Tr,be,Ue,ns,Ht,ki,ss,vi,yr,se,Qi,Rt,wi,$i,Ut,Ti,yi,qr,Vt,Dr,ke,Ve,rs,Xt,qi,as,Di,zr,K,Jt,zi,ve,Bi,ln,Mi,xi,Kt,ji,Ei,Fi,Qe,Pi,dn,Ci,Ai,cn,Ni,Si,Li,Xe,Br,we,Je,is,Gt,Ii,ls,Oi,Mr,z,Yt,Wi,ds,Hi,Ri,Zt,Ui,pn,Vi,Xi,Ji,eo,Ki,to,Gi,Yi,Zi,oo,el,no,tl,ol,nl,x,sl,cs,rl,al,ps,il,ll,hs,dl,cl,us,pl,hl,ms,ul,ml,fs,fl,gl,_l,Y,so,bl,$e,kl,hn,vl,Ql,gs,wl,$l,Tl,Ke,yl,Ge,xr,Te,Ye,_s,ro,ql,bs,Dl,jr,F,ao,zl,io,Bl,ks,Ml,xl,jl,lo,El,un,Fl,Pl,Cl,co,Al,po,Nl,Sl,Ll,Z,ho,Il,ye,Ol,mn,Wl,Hl,vs,Rl,Ul,Vl,Ze,Xl,et,Er,qe,tt,Qs,uo,Jl,ws,Kl,Fr,P,mo,Gl,fo,Yl,$s,Zl,ed,td,go,od,fn,nd,sd,rd,_o,ad,bo,id,ld,dd,W,ko,cd,De,pd,gn,hd,ud,Ts,md,fd,gd,ot,_d,nt,bd,st,Pr,ze,rt,ys,vo,kd,qs,vd,Cr,C,Qo,Qd,Ds,wd,$d,wo,Td,_n,yd,qd,Dd,$o,zd,To,Bd,Md,xd,B,yo,jd,Be,Ed,bn,Fd,Pd,zs,Cd,Ad,Nd,at,Sd,it,Ld,lt,Id,dt,Od,ct,Ar,Me,pt,Bs,qo,Wd,Ms,Hd,Nr,A,Do,Rd,zo,Ud,xs,Vd,Xd,Jd,Bo,Kd,kn,Gd,Yd,Zd,Mo,ec,xo,tc,oc,nc,ee,jo,sc,xe,rc,vn,ac,ic,js,lc,dc,cc,ht,pc,ut,Sr,je,mt,Es,Eo,hc,Fs,uc,Lr,N,Fo,mc,Ps,fc,gc,Po,_c,Qn,bc,kc,vc,Co,Qc,Ao,wc,$c,Tc,te,No,yc,Ee,qc,wn,Dc,zc,Cs,Bc,Mc,xc,ft,jc,gt,Ir,Fe,_t,As,So,Ec,Ns,Fc,Or,S,Lo,Pc,Ss,Cc,Ac,Io,Nc,$n,Sc,Lc,Ic,Oo,Oc,Wo,Wc,Hc,Rc,H,Ho,Uc,Pe,Vc,Tn,Xc,Jc,Ls,Kc,Gc,Yc,bt,Zc,kt,ep,vt,Wr,Ce,Qt,Is,Ro,tp,Os,op,Hr,L,Uo,np,Ae,sp,Ws,rp,ap,Hs,ip,lp,dp,Vo,cp,yn,pp,hp,up,Xo,mp,Jo,fp,gp,_p,R,Ko,bp,Ne,kp,qn,vp,Qp,Rs,wp,$p,Tp,wt,yp,$t,qp,Tt,Rr;return l=new J({}),jt=new J({}),Nt=new J({}),It=new M({props:{code:`import pytorch_quantization.nn as quant_nn
...
<code>inputs_ids</code> passed when calling <a href="/docs/transformers/v4.20.1/en/model_doc/qdqbert#transformers.QDQBertModel">QDQBertModel</a>.`,name:"vocab_size"},{anchor:"transformers.QDQBertConfig.hidden_size",description:`<strong>hidden_size</strong> (<code>int</code>, <em>optional</em>, defaults to 768) &#x2014;
...
<code>past_key_values</code>).`,name:"use_cache"}],source:"https://github.com/huggingface/transformers/blob/v4.20.1/src/transformers/models/qdqbert/modeling_qdqbert.py#L880",returnDescription:`
<p>A <a
...
elements depending on the configuration (<a
  href="/docs/transformers/v4.20.1/en/model_doc/qdqbert#transformers.QDQBertConfig"
...
If set to <code>True</code>, <code>past_key_values</code> key value states are returned and can be used to speed up decoding (see
<code>past_key_values</code>).`,name:"use_cache"}],source:"https://github.com/huggingface/transformers/blob/v4.20.1/src/transformers/models/qdqbert/modeling_qdqbert.py#L1044",returnDescription:`
<p>A <a
...
loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.20.1/src/transformers/models/qdqbert/modeling_qdqbert.py#L1195",returnDescription:`
<p>A <a
...
`}}),ot=new xt({props:{$$slots:{default:[xu]},$$scope:{ctx:q}}}),nt=new I({props:{anchor:"transformers.QDQBertForMaskedLM.forward.example",$$slots:{default:[ju]},$$scope:{ctx:q}}}),st=new I({props:{anchor:"transformers.QDQBertForMaskedLM.forward.example-2",$$slots:{default:[Eu]},$$scope:{ctx:q}}}),vo=new J({}),Qo=new j({props:{name:"class transformers.QDQBertForSequenceClassification",anchor:"transformers.QDQBertForSequenceClassification",parameters:[{name:"config",val:""}],parametersDescription:[{anchor:"transformers.QDQBertForSequenceClassification.config",description:`<strong>config</strong> (<a href="/docs/transformers/v4.20.1/en/model_doc/qdqbert#transformers.QDQBertConfig">QDQBertConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
...
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.20.1/src/transformers/models/qdqbert/modeling_qdqbert.py#L1396",returnDescription:`
<p>A <a
...
</ul>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.20.1/src/transformers/models/qdqbert/modeling_qdqbert.py#L1290",returnDescription:`
<p>A <a
...
<code>input_ids</code> above)`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.20.1/src/transformers/models/qdqbert/modeling_qdqbert.py#L1493",returnDescription:`
<p>A <a
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.20.1/src/transformers/models/qdqbert/modeling_qdqbert.py#L1589",returnDescription:`
<p>A <a
...
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/v4.20.1/src/transformers/models/qdqbert/modeling_qdqbert.py#L1670",returnDescription:`
<p>A <a
...
SQUAD task can be found at `),sn=r("a"),Xa=n("transformers/examples/research_projects/quantization-qdqbert/"),Ja=n("."),fr=p(),Oe=r("p"),Ka=n("This model was contributed by "),At=r("a"),Ga=n("shangz"),Ya=n("."),gr=p(),ge=r("h3"),We=r("a"),Jn=r("span"),v(Nt.$$.fragment),Za=p(),Kn=r("span"),ei=n("Set default quantizers"),_r=p(),E=r("p"),ti=n(`QDQBERT model adds fake quantization operations (pair of QuantizeLinear/DequantizeLinear ops) to BERT by
...
Quantization Toolkit userguide`),pi=n(" for more details."),br=p(),He=r("p"),hi=n("Before creating QDQBERT model, one has to set the default "),es=r("code"),ui=n("QuantDescriptor"),mi=n(" defining default tensor quantizers."),kr=p(),rn=r("p"),fi=n("Example:"),vr=p(),v(It.$$.fragment),Qr=p(),_e=r("h3"),Re=r("a"),ts=r("span"),v(Ot.$$.fragment),gi=p(),os=r("span"),_i=n("Calibration"),wr=p(),an=r("p"),bi=n(`Calibration is the terminology of passing data samples to the quantizer and deciding the best scaling factors for
...
`),Kt=r("a"),ji=n("bert-base-uncased"),Ei=n(" architecture."),Fi=p(),Qe=r("p"),Pi=n("Configuration objects inherit from "),dn=r("a"),Ci=n("PretrainedConfig"),Ai=n(` and can be used to control the model outputs. Read the
documentation from `),cn=r("a"),Ni=n("PretrainedConfig"),Si=n(" for more information."),Li=p(),v(Xe.$$.fragment),Br=p(),we=r("h2"),Je=r("a"),is=r("span"),v(Gt.$$.fragment),Ii=p(),ls=r("span"),Oi=n("QDQBertModel"),Mr=p(),z=r("div"),v(Yt.$$.fragment),Wi=p(),ds=r("p"),Hi=n("The bare QDQBERT Model transformer outputting raw hidden-states without any specific head on top."),Ri=p(),Zt=r("p"),Ui=n("This model inherits from "),pn=r("a"),Vi=n("PreTrainedModel"),Xi=n(`. Check the superclass documentation for the generic methods the
...
`),us=r("code"),pl=n("add_cross_attention"),hl=n(" set to "),ms=r("code"),ul=n("True"),ml=n("; an "),fs=r("code"),fl=n("encoder_hidden_states"),gl=n(" is then expected as an input to the forward pass."),_l=p(),Y=r("div"),v(so.$$.fragment),bl=p(),$e=r("p"),kl=n("The "),hn=r("a"),vl=n("QDQBertModel"),Ql=n(" forward method, overrides the "),gs=r("code"),wl=n("__call__"),$l=n(" special method."),Tl=p(),v(Ke.$$.fragment),yl=p(),v(Ge.$$.fragment),xr=p(),Te=r("h2"),Ye=r("a"),_s=r("span"),v(ro.$$.fragment),ql=p(),bs=r("span"),Dl=n("QDQBertLMHeadModel"),jr=p(),F=r("div"),v(ao.$$.fragment),zl=p(),io=r("p"),Bl=n("QDQBERT Model with a "),ks=r("code"),Ml=n("language modeling"),xl=n(" head on top for CLM fine-tuning."),jl=p(),lo=r("p"),El=n("This model inherits from "),un=r("a"),Fl=n("PreTrainedModel"),Pl=n(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Cl=p(),co=r("p"),Al=n("This model is also a PyTorch "),po=r("a"),Nl=n("torch.nn.Module"),Sl=n(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Ll=p(),Z=r("div"),v(ho.$$.fragment),Il=p(),ye=r("p"),Ol=n("The "),mn=r("a"),Wl=n("QDQBertLMHeadModel"),Hl=n(" forward method, overrides the "),vs=r("code"),Rl=n("__call__"),Ul=n(" special method."),Vl=p(),v(Ze.$$.fragment),Xl=p(),v(et.$$.fragment),Er=p(),qe=r("h2"),tt=r("a"),Qs=r("span"),v(uo.$$.fragment),Jl=p(),ws=r("span"),Kl=n("QDQBertForMaskedLM"),Fr=p(),P=r("div"),v(mo.$$.fragment),Gl=p(),fo=r("p"),Yl=n("QDQBERT Model with a "),$s=r("code"),Zl=n("language modeling"),ed=n(" head on top."),td=p(),go=r("p"),od=n("This model inherits from "),fn=r("a"),nd=n("PreTrainedModel"),sd=n(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),xd=p(),B=r("div"),v(yo.$$.fragment),jd=p(),Be=r("p"),Ed=n("The "),bn=r("a"),Fd=n("QDQBertForSequenceClassification"),Pd=n(" forward method, overrides the "),zs=r("code"),Cd=n("__call__"),Ad=n(" special method."),Nd=p(),v(at.$$.fragment),Sd=p(),v(it.$$.fragment),Ld=p(),v(lt.$$.fragment),Id=p(),v(dt.$$.fragment),Od=p(),v(ct.$$.fragment),Ar=p(),Me=r("h2"),pt=r("a"),Bs=r("span"),v(qo.$$.fragment),Wd=p(),Ms=r("span"),Hd=n("QDQBertForNextSentencePrediction"),Nr=p(),A=r("div"),v(Do.$$.fragment),Rd=p(),zo=r("p"),Ud=n("Bert Model with a "),xs=r("code"),Vd=n("next sentence prediction (classification)"),Xd=n(" head on top."),Jd=p(),Bo=r("p"),Kd=n("This model inherits from "),kn=r("a"),Gd=n("PreTrainedModel"),Yd=n(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Zd=p(),Mo=r("p"),ec=n("This model is also a PyTorch "),xo=r("a"),tc=n("torch.nn.Module"),oc=n(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),nc=p(),ee=r("div"),v(jo.$$.fragment),sc=p(),xe=r("p"),rc=n("The "),vn=r("a"),ac=n("QDQBertForNextSentencePrediction"),ic=n(" forward method, overrides the "),js=r("code"),lc=n("__call__"),dc=n(" special method."),cc=p(),v(ht.$$.fragment),pc=p(),v(ut.$$.fragment),Sr=p(),je=r("h2"),mt=r("a"),Es=r("span"),v(Eo.$$.fragment),hc=p(),Fs=r("span"),uc=n("QDQBertForMultipleChoice"),Lr=p(),N=r("div"),v(Fo.$$.fragment),mc=p(),Ps=r("p"),fc=n(`Bert Model with a multiple choice classification head on top (a linear layer on top of the pooled output and a
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Tc=p(),te=r("div"),v(No.$$.fragment),yc=p(),Ee=r("p"),qc=n("The "),wn=r("a"),Dc=n("QDQBertForMultipleChoice"),zc=n(" forward method, overrides the "),Cs=r("code"),Bc=n("__call__"),Mc=n(" special method."),xc=p(),v(ft.$$.fragment),jc=p(),v(gt.$$.fragment),Ir=p(),Fe=r("h2"),_t=r("a"),As=r("span"),v(So.$$.fragment),Ec=p(),Ns=r("span"),Fc=n("QDQBertForTokenClassification"),Or=p(),S=r("div"),v(Lo.$$.fragment),Pc=p(),Ss=r("p"),Cc=n(`QDQBERT Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g. for
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Rc=p(),H=r("div"),v(Ho.$$.fragment),Uc=p(),Pe=r("p"),Vc=n("The "),Tn=r("a"),Xc=n("QDQBertForTokenClassification"),Jc=n(" forward method, overrides the "),Ls=r("code"),Kc=n("__call__"),Gc=n(" special method."),Yc=p(),v(bt.$$.fragment),Zc=p(),v(kt.$$.fragment),ep=p(),v(vt.$$.fragment),Wr=p(),Ce=r("h2"),Qt=r("a"),Is=r("span"),v(Ro.$$.fragment),tp=p(),Os=r("span"),op=n("QDQBertForQuestionAnswering"),Hr=p(),L=r("div"),v(Uo.$$.fragment),np=p(),Ae=r("p"),sp=n(`QDQBERT Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),_p=p(),R=r("div"),v(Ko.$$.fragment),bp=p(),Ne=r("p"),kp=n("The "),qn=r("a"),vp=n("QDQBertForQuestionAnswering"),Qp=n(" forward method, overrides the "),Rs=r("code"),wp=n("__call__"),$p=n(" special method."),Tp=p(),v(wt.$$.fragment),yp=p(),v($t.$$.fragment),qp=p(),v(Tt.$$.fragment),this.h()},l(t){const g=Tu('[data-svelte="svelte-1phssyn"]',document.head);d=a(g,"META",{name:!0,content:!0}),g.forEach(o),_=h(t),c=a(t,"H1",{class:!0});var Go=i(c);u=a(Go,"A",{id:!0,class:!0,href:!0});var Us=i(u);k=a(Us,"SPAN",{});var Vs=i(k);Q(l.$$.fragment,Vs),Vs.forEach(o),Us.forEach(o),m=h(Go),D=a(Go,"SPAN",{});var Xs=i(D);Da=s(Xs,"QDQBERT"),Xs.forEach(o),Go.forEach(o),dr=h(t),fe=a(t,"H2",{class:!0});var Yo=i(fe);Se=a(Yo,"A",{id:!0,class:!0,href:!0});var Js=i(Se);Sn=a(Js,"SPAN",{});var Ks=i(Sn);Q(jt.$$.fragment,Ks),Ks.forEach(o),Js.forEach(o),za=h(Yo),Ln=a(Yo,"SPAN",{});var Gs=i(Ln);Ba=s(Gs,"Overview"),Gs.forEach(o),Yo.forEach(o),cr=h(t),Le=a(t,"P",{});var Zo=i(Le);Ma=s(Zo,"The QDQBERT model can be referenced in "),Et=a(Zo,"A",{href:!0,rel:!0});var Ys=i(Et);xa=s(Ys,`Integer Quantization for Deep Learning Inference: Principles and Empirical
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),aa.forEach(o),Ll=h(re),Z=a(re,"DIV",{class:!0});var zt=i(Z);Q(ho.$$.fragment,zt),Il=h(zt),ye=a(zt,"P",{});var xn=i(ye);Ol=s(xn,"The "),mn=a(xn,"A",{href:!0});var Th=i(mn);Wl=s(Th,"QDQBertLMHeadModel"),Th.forEach(o),Hl=s(xn," forward method, overrides the "),vs=a(xn,"CODE",{});var yh=i(vs);Rl=s(yh,"__call__"),yh.forEach(o),Ul=s(xn," special method."),xn.forEach(o),Vl=h(zt),Q(Ze.$$.fragment,zt),Xl=h(zt),Q(et.$$.fragment,zt),zt.forEach(o),re.forEach(o),Er=h(t),qe=a(t,"H2",{class:!0});var ia=i(qe);tt=a(ia,"A",{id:!0,class:!0,href:!0});var qh=i(tt);Qs=a(qh,"SPAN",{});var Dh=i(Qs);Q(uo.$$.fragment,Dh),Dh.forEach(o),qh.forEach(o),Jl=h(ia),ws=a(ia,"SPAN",{});var zh=i(ws);Kl=s(zh,"QDQBertForMaskedLM"),zh.forEach(o),ia.forEach(o),Fr=h(t),P=a(t,"DIV",{class:!0});var ae=i(P);Q(mo.$$.fragment,ae),Gl=h(ae),fo=a(ae,"P",{});var la=i(fo);Yl=s(la,"QDQBERT Model with a "),$s=a(la,"CODE",{});var Bh=i($s);Zl=s(Bh,"language modeling"),Bh.forEach(o),ed=s(la," head on top."),la.forEach(o),td=h(ae),go=a(ae,"P",{});var da=i(go);od=s(da,"This model inherits from "),fn=a(da,"A",{href:!0});var Mh=i(fn);nd=s(Mh,"PreTrainedModel"),Mh.forEach(o),sd=s(da,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),ca.forEach(o),dd=h(ae),W=a(ae,"DIV",{class:!0});var ie=i(W);Q(ko.$$.fragment,ie),cd=h(ie),De=a(ie,"P",{});var jn=i(De);pd=s(jn,"The "),gn=a(jn,"A",{href:!0});var jh=i(gn);hd=s(jh,"QDQBertForMaskedLM"),jh.forEach(o),ud=s(jn," forward method, overrides the "),Ts=a(jn,"CODE",{});var Eh=i(Ts);md=s(Eh,"__call__"),Eh.forEach(o),fd=s(jn," special method."),jn.forEach(o),gd=h(ie),Q(ot.$$.fragment,ie),_d=h(ie),Q(nt.$$.fragment,ie),bd=h(ie),Q(st.$$.fragment,ie),ie.forEach(o),ae.forEach(o),Pr=h(t),ze=a(t,"H2",{class:!0});var pa=i(ze);rt=a(pa,"A",{id:!0,class:!0,href:!0});var Fh=i(rt);ys=a(Fh,"SPAN",{});var Ph=i(ys);Q(vo.$$.fragment,Ph),Ph.forEach(o),Fh.forEach(o),kd=h(pa),qs=a(pa,"SPAN",{});var Ch=i(qs);vd=s(Ch,"QDQBertForSequenceClassification"),Ch.forEach(o),pa.forEach(o),Cr=h(t),C=a(t,"DIV",{class:!0});var le=i(C);Q(Qo.$$.fragment,le),Qd=h(le),Ds=a(le,"P",{});var Ah=i(Ds);wd=s(Ah,`Bert Model transformer with a sequence classification/regression head on top (a linear layer on top of the pooled
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),_a.forEach(o),nc=h(de),ee=a(de,"DIV",{class:!0});var Bt=i(ee);Q(jo.$$.fragment,Bt),sc=h(Bt),xe=a(Bt,"P",{});var Fn=i(xe);rc=s(Fn,"The "),vn=a(Fn,"A",{href:!0});var Xh=i(vn);ac=s(Xh,"QDQBertForNextSentencePrediction"),Xh.forEach(o),ic=s(Fn," forward method, overrides the "),js=a(Fn,"CODE",{});var Jh=i(js);lc=s(Jh,"__call__"),Jh.forEach(o),dc=s(Fn," special method."),Fn.forEach(o),cc=h(Bt),Q(ht.$$.fragment,Bt),pc=h(Bt),Q(ut.$$.fragment,Bt),Bt.forEach(o),de.forEach(o),Sr=h(t),je=a(t,"H2",{class:!0});var ba=i(je);mt=a(ba,"A",{id:!0,class:!0,href:!0});var Kh=i(mt);Es=a(Kh,"SPAN",{});var Gh=i(Es);Q(Eo.$$.fragment,Gh),Gh.forEach(o),Kh.forEach(o),hc=h(ba),Fs=a(ba,"SPAN",{});var Yh=i(Fs);uc=s(Yh,"QDQBertForMultipleChoice"),Yh.forEach(o),ba.forEach(o),Lr=h(t),N=a(t,"DIV",{class:!0});var ce=i(N);Q(Fo.$$.fragment,ce),mc=h(ce),Ps=a(ce,"P",{});var Zh=i(Ps);fc=s(Zh,`Bert Model with a multiple choice classification head on top (a linear layer on top of the pooled output and a
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),va.forEach(o),Tc=h(ce),te=a(ce,"DIV",{class:!0});var Mt=i(te);Q(No.$$.fragment,Mt),yc=h(Mt),Ee=a(Mt,"P",{});var Pn=i(Ee);qc=s(Pn,"The "),wn=a(Pn,"A",{href:!0});var ou=i(wn);Dc=s(ou,"QDQBertForMultipleChoice"),ou.forEach(o),zc=s(Pn," forward method, overrides the "),Cs=a(Pn,"CODE",{});var nu=i(Cs);Bc=s(nu,"__call__"),nu.forEach(o),Mc=s(Pn," special method."),Pn.forEach(o),xc=h(Mt),Q(ft.$$.fragment,Mt),jc=h(Mt),Q(gt.$$.fragment,Mt),Mt.forEach(o),ce.forEach(o),Ir=h(t),Fe=a(t,"H2",{class:!0});var Qa=i(Fe);_t=a(Qa,"A",{id:!0,class:!0,href:!0});var su=i(_t);As=a(su,"SPAN",{});var ru=i(As);Q(So.$$.fragment,ru),ru.forEach(o),su.forEach(o),Ec=h(Qa),Ns=a(Qa,"SPAN",{});var au=i(Ns);Fc=s(au,"QDQBertForTokenClassification"),au.forEach(o),Qa.forEach(o),Or=h(t),S=a(t,"DIV",{class:!0});var pe=i(S);Q(Lo.$$.fragment,pe),Pc=h(pe),Ss=a(pe,"P",{});var iu=i(Ss);Cc=s(iu,`QDQBERT Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g. for
