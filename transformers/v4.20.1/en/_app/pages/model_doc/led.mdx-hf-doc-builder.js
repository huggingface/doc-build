...
first positional argument :`),be=c(),O=a("ul"),j=a("li"),ue=n("a single Tensor with "),oe=a("code"),$e=n("input_ids"),me=n(" only and nothing else: "),U=a("code"),Be=n("model(input_ids)"),De=c(),C=a("li"),Ge=n(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),{c(){l=a("p"),v=n("Example:"),p=c(),T(u.$$.fragment)},l(i){l=r(i,"P",{});var f=d(l);v=s(f,"Example:"),f.forEach(t),p=h(i),k(u.$$.fragment,i)},m(i,f){g(i,l,f),e(l,v),g(i,p,f),w(u,i,f),b=!0},p:je,i(i){b||(y(u.$$.fragment,i),b=!0)},o(i){E(u.$$.fragment,i),b=!1},d(i){i&&t(l),i&&t(p),L(u,i)}}}function hm($){let l,v,p,u,b,i,f,D,Pe,pe,F,Z,H,ee,Ne,W,Ie,qe,I,R,te,be,O,j,ue,oe,$e,me,U,Be,De,C,Ge,K,M,S,B,Qe,He,P,We,ne,Te;return{c(){l=a("p"),v=n("TF 2.0 models accepts two formats as inputs:"),p=c(),u=a("ul"),b=a("li"),i=n("having all inputs as keyword arguments (like PyTorch models), or"),f=c(),D=a("li"),Pe=n("having all inputs as a list, tuple or dict in the first positional arguments."),pe=c(),F=a("p"),Z=n("This second option is useful when using "),H=a("code"),ee=n("tf.keras.Model.fit"),Ne=n(` method which currently requires having all the
tensors in the first argument of the model call function: `),W=a("code"),Ie=n("model(inputs)"),qe=n("."),I=c(),R=a("p"),te=n(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),be=c(),O=a("ul"),j=a("li"),ue=n("a single Tensor with "),oe=a("code"),$e=n("input_ids"),me=n(" only and nothing else: "),U=a("code"),Be=n("model(input_ids)"),De=c(),C=a("li"),Ge=n(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),K=a("code"),M=n("model([input_ids, attention_mask])"),S=n(" or "),B=a("code"),Qe=n("model([input_ids, attention_mask, token_type_ids])"),He=c(),P=a("li"),We=n(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),ne=a("code"),Te=n('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(q){l=r(q,"P",{});var z=d(l);v=s(z,"TF 2.0 models accepts two formats as inputs:"),z.forEach(t),p=h(q),u=r(q,"UL",{});var se=d(u);b=r(se,"LI",{});var nt=d(b);i=s(nt,"having all inputs as keyword arguments (like PyTorch models), or"),nt.forEach(t),f=h(se),D=r(se,"LI",{});var st=d(D);Pe=s(st,"having all inputs as a list, tuple or dict in the first positional arguments."),st.forEach(t),se.forEach(t),pe=h(q),F=r(q,"P",{});var N=d(F);Z=s(N,"This second option is useful when using "),H=r(N,"CODE",{});var at=d(H);ee=s(at,"tf.keras.Model.fit"),at.forEach(t),Ne=s(N,` method which currently requires having all the
...
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-comment"># probs[5] is associated with the mask token</span>`}}),{c(){l=a("p"),v=n("Examples:"),p=c(),T(u.$$.fragment)},l(i){l=r(i,"P",{});var f=d(l);v=s(f,"Examples:"),f.forEach(t),p=h(i),k(u.$$.fragment,i)},m(i,f){g(i,l,f),e(l,v),g(i,p,f),w(u,i,f),b=!0},p:je,i(i){b||(y(u.$$.fragment,i),b=!0)},o(i){E(u.$$.fragment,i),b=!1},d(i){i&&t(l),i&&t(p),L(u,i)}}}function mm($){let l,v,p,u,b,i,f,D,Pe,pe,F,Z,H,ee,Ne,W,Ie,qe,I,R,te,be,O,j,ue,oe,$e,me,U,Be,De,C,Ge,K,M,S,B,Qe,He,P,We,ne,Te,q,z,se,nt,st,N,at,rt,Fe,V,ae,ze,dt,re,it,de,Re,Ue,rd,dd,qs,id,ld,cd,ke,hd,$s,pd,ud,Ds,md,fd,Qn,_d,gd,Fs,vd,bd,Td,X,kd,zs,wd,yd,xs,Ed,Ld,Hn,qd,$d,Ms,Dd,Fd,Ss,zd,xd,Os,Md,Sd,Od,Ve,Cd,Cs,jd,Ad,js,Pd,Nd,As,Id,Bd,Gd,$o,Qd,Do,Hd,Wd,Rd,Fo,Ud,zo,Vd,Xd,Wa,jt,Jd,xo,Zd,Kd,Ra,lt,At,Ps,Mo,Yd,Ns,ei,Ua,we,So,ti,ct,oi,Wn,ni,si,Oo,ai,ri,di,ht,ii,Rn,li,ci,Un,hi,pi,ui,Pt,Va,pt,Nt,Is,Co,mi,Bs,fi,Xa,A,jo,_i,Gs,gi,vi,It,Vn,bi,Ti,Xn,ki,wi,yi,Ao,Ei,Jn,Li,qi,$i,Xe,Po,Di,Qs,Fi,zi,No,Zn,xi,Hs,Mi,Si,Kn,Oi,Ws,Ci,ji,Bt,Io,Ai,Bo,Pi,Rs,Ni,Ii,Bi,Gt,Go,Gi,Us,Qi,Hi,Yn,Qo,Ja,ut,Qt,Vs,Ho,Wi,Xs,Ri,Za,ye,Wo,Ui,Ro,Vi,Js,Xi,Ji,Zi,Ht,es,Ki,Yi,ts,el,tl,ol,Uo,nl,os,sl,al,Ka,mt,Wt,Zs,Vo,rl,Ks,dl,Ya,ft,Xo,il,Ys,ll,er,_t,Jo,cl,ea,hl,tr,gt,Zo,pl,ta,ul,or,vt,Ko,ml,oa,fl,nr,bt,Yo,_l,na,gl,sr,Tt,en,vl,sa,bl,ar,kt,tn,Tl,aa,kl,rr,wt,on,wl,ra,yl,dr,yt,Rt,da,nn,El,ia,Ll,ir,Ee,sn,ql,an,$l,ns,Dl,Fl,zl,rn,xl,dn,Ml,Sl,Ol,xe,ln,Cl,Et,jl,ss,Al,Pl,la,Nl,Il,Bl,Ut,Gl,Vt,lr,Lt,Xt,ca,cn,Ql,ha,Hl,cr,Le,hn,Wl,pn,Rl,as,Ul,Vl,Xl,un,Jl,mn,Zl,Kl,Yl,fe,fn,ec,qt,tc,rs,oc,nc,pa,sc,ac,rc,Jt,dc,Zt,ic,Kt,hr,$t,Yt,ua,_n,lc,ma,cc,pr,ie,gn,hc,fa,pc,uc,vn,mc,ds,fc,_c,gc,bn,vc,Tn,bc,Tc,kc,G,kn,wc,Dt,yc,is,Ec,Lc,_a,qc,$c,Dc,eo,Fc,to,zc,oo,xc,no,Mc,so,ur,Ft,ao,ga,wn,Sc,va,Oc,mr,le,yn,Cc,zt,jc,ba,Ac,Pc,Ta,Nc,Ic,Bc,En,Gc,ls,Qc,Hc,Wc,Ln,Rc,qn,Uc,Vc,Xc,_e,$n,Jc,xt,Zc,cs,Kc,Yc,ka,eh,th,oh,ro,nh,io,sh,lo,fr,Mt,co,wa,Dn,ah,ya,rh,_r,ce,Fn,dh,zn,ih,hs,lh,ch,hh,xn,ph,Mn,uh,mh,fh,ho,_h,Me,Sn,gh,St,vh,ps,bh,Th,Ea,kh,wh,yh,po,Eh,uo,gr,Ot,mo,La,On,Lh,qa,qh,vr,he,Cn,$h,jn,Dh,us,Fh,zh,xh,An,Mh,Pn,Sh,Oh,Ch,fo,jh,Se,Nn,Ah,Ct,Ph,ms,Nh,Ih,$a,Bh,Gh,Qh,_o,Hh,go,br;return i=new Oe({}),ee=new Oe({}),Mo=new Oe({}),So=new x({props:{name:"class transformers.LEDConfig",anchor:"transformers.LEDConfig",parameters:[{name:"vocab_size",val:" = 50265"},{name:"max_encoder_position_embeddings",val:" = 16384"},{name:"max_decoder_position_embeddings",val:" = 1024"},{name:"encoder_layers",val:" = 12"},{name:"encoder_ffn_dim",val:" = 4096"},{name:"encoder_attention_heads",val:" = 16"},{name:"decoder_layers",val:" = 12"},{name:"decoder_ffn_dim",val:" = 4096"},{name:"decoder_attention_heads",val:" = 16"},{name:"encoder_layerdrop",val:" = 0.0"},{name:"decoder_layerdrop",val:" = 0.0"},{name:"use_cache",val:" = True"},{name:"is_encoder_decoder",val:" = True"},{name:"activation_function",val:" = 'gelu'"},{name:"d_model",val:" = 1024"},{name:"dropout",val:" = 0.1"},{name:"attention_dropout",val:" = 0.0"},{name:"activation_dropout",val:" = 0.0"},{name:"init_std",val:" = 0.02"},{name:"decoder_start_token_id",val:" = 2"},{name:"classifier_dropout",val:" = 0.0"},{name:"pad_token_id",val:" = 1"},{name:"bos_token_id",val:" = 0"},{name:"eos_token_id",val:" = 2"},{name:"attention_window",val:": typing.Union[typing.List[int], int] = 512"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.LEDConfig.vocab_size",description:`<strong>vocab_size</strong> (<code>int</code>, <em>optional</em>, defaults to 50265) &#x2014;
...
Whether or not the model should return the last key/values attentions (not used by all models)`,name:"use_cache"}],source:"https://github.com/huggingface/transformers/blob/v4.20.1/src/transformers/models/led/configuration_led.py#L31"}}),Pt=new Ce({props:{anchor:"transformers.LEDConfig.example",$$slots:{default:[Vu]},$$scope:{ctx:$}}}),Co=new Oe({}),jo=new x({props:{name:"class transformers.LEDTokenizer",anchor:"transformers.LEDTokenizer",parameters:[{name:"vocab_file",val:""},{name:"merges_file",val:""},{name:"errors",val:" = 'replace'"},{name:"bos_token",val:" = '<s>'"},{name:"eos_token",val:" = '</s>'"},{name:"sep_token",val:" = '</s>'"},{name:"cls_token",val:" = '<s>'"},{name:"unk_token",val:" = '<unk>'"},{name:"pad_token",val:" = '<pad>'"},{name:"mask_token",val:" = '<mask>'"},{name:"add_prefix_space",val:" = False"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/v4.20.1/src/transformers/models/led/tokenization_led.py#L43"}}),Po=new x({props:{name:"build_inputs_with_special_tokens",anchor:"transformers.LEDTokenizer.build_inputs_with_special_tokens",parameters:[{name:"token_ids_0",val:": typing.List[int]"},{name:"token_ids_1",val:": typing.Optional[typing.List[int]] = None"}],parametersDescription:[{anchor:"transformers.LEDTokenizer.build_inputs_with_special_tokens.token_ids_0",description:`<strong>token_ids_0</strong> (<code>List[int]</code>) &#x2014;
...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/v4.20.1/src/transformers/models/bart/tokenization_bart.py#L338",returnDescription:`
...
Whether or not the token list is already formatted with special tokens for the model.`,name:"already_has_special_tokens"}],source:"https://github.com/huggingface/transformers/blob/v4.20.1/src/transformers/models/bart/tokenization_bart.py#L363",returnDescription:`
...
<p>Global attentions weights after the attention softmax, used to compute the weighted average in the
self-attention heads. Those are the attention weights from every token with global attention to every token
in the sequence.`,name:"encoder_global_attentions"}],source:"https://github.com/huggingface/transformers/blob/v4.20.1/src/transformers/models/led/modeling_tf_led.py#L1408"}}),on=new x({props:{name:"class transformers.models.led.modeling_tf_led.TFLEDSeq2SeqLMOutput",anchor:"transformers.models.led.modeling_tf_led.TFLEDSeq2SeqLMOutput",parameters:[{name:"loss",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"logits",val:": Tensor = None"},{name:"past_key_values",val:": typing.Optional[typing.List[tensorflow.python.framework.ops.Tensor]] = None"},{name:"decoder_hidden_states",val:": typing.Optional[typing.Tuple[tensorflow.python.framework.ops.Tensor]] = None"},{name:"decoder_attentions",val:": typing.Optional[typing.Tuple[tensorflow.python.framework.ops.Tensor]] = None"},{name:"cross_attentions",val:": typing.Optional[typing.Tuple[tensorflow.python.framework.ops.Tensor]] = None"},{name:"encoder_last_hidden_state",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"encoder_hidden_states",val:": typing.Optional[typing.Tuple[tensorflow.python.framework.ops.Tensor]] = None"},{name:"encoder_attentions",val:": typing.Optional[typing.Tuple[tensorflow.python.framework.ops.Tensor]] = None"},{name:"encoder_global_attentions",val:": typing.Optional[typing.Tuple[tensorflow.python.framework.ops.Tensor]] = None"}],parametersDescription:[{anchor:"transformers.models.led.modeling_tf_led.TFLEDSeq2SeqLMOutput.loss",description:`<strong>loss</strong> (<code>tf.Tensor</code> of shape <code>(1,)</code>, <em>optional</em>, returned when <code>labels</code> is provided) &#x2014;
...
<p>Indices can be obtained using <code>LedTokenizer</code>. See <a href="/docs/transformers/v4.20.1/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/v4.20.1/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
Whether or not to return a <a href="/docs/transformers/v4.20.1/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/v4.20.1/src/transformers/models/led/modeling_led.py#L2201",returnDescription:`
<p>A <a
...
elements depending on the configuration (<a
  href="/docs/transformers/v4.20.1/en/model_doc/led#transformers.LEDConfig"
...
(masked), the loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.20.1/src/transformers/models/led/modeling_led.py#L2341",returnDescription:`
<p>A <a
...
Labels for computing the sequence classification/regression loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>. If <code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.20.1/src/transformers/models/led/modeling_led.py#L2503",returnDescription:`
<p>A <a
...
Positions are clamped to the length of the sequence (<em>sequence_length</em>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/v4.20.1/src/transformers/models/led/modeling_led.py#L2630",returnDescription:`
<p>A <a
...
behaviors between training and evaluation).`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/v4.20.1/src/transformers/models/led/modeling_tf_led.py#L2244",returnDescription:`
<p>A <a
  href="/docs/transformers/v4.20.1/en/model_doc/led#transformers.models.led.modeling_tf_led.TFLEDSeq2SeqModelOutput"
...
Whether or not to use the model in training mode (some modules like dropout modules have different
behaviors between training and evaluation).`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/v4.20.1/src/transformers/models/led/modeling_tf_led.py#L2353",returnDescription:`
<p>A <a
  href="/docs/transformers/v4.20.1/en/model_doc/led#transformers.models.led.modeling_tf_led.TFLEDSeq2SeqLMOutput"
...
documentation from `),Un=a("a"),hi=n("PretrainedConfig"),pi=n(" for more information."),ui=c(),T(Pt.$$.fragment),Va=c(),pt=a("h2"),Nt=a("a"),Is=a("span"),T(Co.$$.fragment),mi=c(),Bs=a("span"),fi=n("LEDTokenizer"),Xa=c(),A=a("div"),T(jo.$$.fragment),_i=c(),Gs=a("p"),gi=n("Construct a LED tokenizer."),vi=c(),It=a("p"),Vn=a("a"),bi=n("LEDTokenizer"),Ti=n(" is identical to "),Xn=a("a"),ki=n("BartTokenizer"),wi=n(` and runs end-to-end tokenization: punctuation splitting and
...
adding special tokens. A BART sequence has the following format:`),zi=c(),No=a("ul"),Zn=a("li"),xi=n("single sequence: "),Hs=a("code"),Mi=n("<s> X </s>"),Si=c(),Kn=a("li"),Oi=n("pair of sequences: "),Ws=a("code"),Ci=n("<s> A </s></s> B </s>"),ji=c(),Bt=a("div"),T(Io.$$.fragment),Ai=c(),Bo=a("p"),Pi=n(`Retrieve sequence ids from a token list that has no special tokens added. This method is called when adding
special tokens using the tokenizer `),Rs=a("code"),Ni=n("prepare_for_model"),Ii=n(" method."),Bi=c(),Gt=a("div"),T(Go.$$.fragment),Gi=c(),Us=a("p"),Qi=n(`Create a mask from the two sequences passed to be used in a sequence-pair classification task. BART does not
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for general usage and behavior.`),Ol=c(),xe=a("div"),T(ln.$$.fragment),Cl=c(),Et=a("p"),jl=n("The "),ss=a("a"),Al=n("LEDModel"),Pl=n(" forward method, overrides the "),la=a("code"),Nl=n("__call__"),Il=n(" special method."),Bl=c(),T(Ut.$$.fragment),Gl=c(),T(Vt.$$.fragment),lr=c(),Lt=a("h2"),Xt=a("a"),ca=a("span"),T(cn.$$.fragment),Ql=c(),ha=a("span"),Hl=n("LEDForConditionalGeneration"),cr=c(),Le=a("div"),T(hn.$$.fragment),Wl=c(),pn=a("p"),Rl=n(`The LED Model with a language modeling head. Can be used for summarization.
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for general usage and behavior.`),kc=c(),G=a("div"),T(kn.$$.fragment),wc=c(),Dt=a("p"),yc=n("The "),is=a("a"),Ec=n("LEDForSequenceClassification"),Lc=n(" forward method, overrides the "),_a=a("code"),qc=n("__call__"),$c=n(" special method."),Dc=c(),T(eo.$$.fragment),Fc=c(),T(to.$$.fragment),zc=c(),T(oo.$$.fragment),xc=c(),T(no.$$.fragment),Mc=c(),T(so.$$.fragment),ur=c(),Ft=a("h2"),ao=a("a"),ga=a("span"),T(wn.$$.fragment),Sc=c(),va=a("span"),Oc=n("LEDForQuestionAnswering"),mr=c(),le=a("div"),T(yn.$$.fragment),Cc=c(),zt=a("p"),jc=n(`LED Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear layer
on top of the hidden-states output to compute `),ba=a("code"),Ac=n("span start logits"),Pc=n(" and "),Ta=a("code"),Nc=n("span end logits"),Ic=n(")."),Bc=c(),En=a("p"),Gc=n("This model inherits from "),ls=a("a"),Qc=n("PreTrainedModel"),Hc=n(`. See the superclass documentation for the generic methods the library
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Ch=c(),T(fo.$$.fragment),jh=c(),Se=a("div"),T(Nn.$$.fragment),Ah=c(),Ct=a("p"),Ph=n("The "),ms=a("a"),Nh=n("TFLEDForConditionalGeneration"),Ih=n(" forward method, overrides the "),$a=a("code"),Bh=n("__call__"),Gh=n(" special method."),Qh=c(),T(_o.$$.fragment),Hh=c(),T(go.$$.fragment),this.h()},l(o){const _=Ru('[data-svelte="svelte-1phssyn"]',document.head);l=r(_,"META",{name:!0,content:!0}),_.forEach(t),v=h(o),p=r(o,"H1",{class:!0});var In=d(p);u=r(In,"A",{id:!0,class:!0,href:!0});var Da=d(u);b=r(Da,"SPAN",{});var Fa=d(b);k(i.$$.fragment,Fa),Fa.forEach(t),Da.forEach(t),f=h(In),D=r(In,"SPAN",{});var za=d(D);Pe=s(za,"LED"),za.forEach(t),In.forEach(t),pe=h(o),F=r(o,"H2",{class:!0});var Bn=d(F);Z=r(Bn,"A",{id:!0,class:!0,href:!0});var xa=d(Z);H=r(xa,"SPAN",{});var Ma=d(H);k(ee.$$.fragment,Ma),Ma.forEach(t),xa.forEach(t),Ne=h(Bn),W=r(Bn,"SPAN",{});var Sa=d(W);Ie=s(Sa,"Overview"),Sa.forEach(t),Bn.forEach(t),qe=h(o),I=r(o,"P",{});var Gn=d(I);R=s(Gn,"The LED model was proposed in "),te=r(Gn,"A",{href:!0,rel:!0});var Oa=d(te);be=s(Oa,"Longformer: The Long-Document Transformer"),Oa.forEach(t),O=s(Gn,` by Iz
...
`),P=r(Q,"A",{href:!0});var Ia=d(P);We=s(Ia,"BartForConditionalGeneration"),Ia.forEach(t),ne=s(Q," exchanging the traditional "),Te=r(Q,"EM",{});var Ba=d(Te);q=s(Ba,"self-attention"),Ba.forEach(t),z=s(Q,` layer with
