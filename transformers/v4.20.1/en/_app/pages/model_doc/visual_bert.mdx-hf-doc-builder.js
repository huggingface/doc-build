...
the latter silently ignores them.`)},l(r){d=s(r,"P",{});var u=a(d);b=l(u,"Although the recipe for forward pass needs to be defined within this function, one should call the "),g=s(u,"CODE",{});var x=a(g);m=l(x,"Module"),x.forEach(o),v=l(u,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),u.forEach(o)},m(r,u){_(r,d,u),e(d,b),e(d,g),e(g,m),e(d,v)},d(r){r&&o(d)}}}function Td(B){let d,b,g,m,v;return m=new Ke({props:{code:`
...
the latter silently ignores them.`)},l(r){d=s(r,"P",{});var u=a(d);b=l(u,"Although the recipe for forward pass needs to be defined within this function, one should call the "),g=s(u,"CODE",{});var x=a(g);m=l(x,"Module"),x.forEach(o),v=l(u,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),u.forEach(o)},m(r,u){_(r,d,u),e(d,b),e(d,g),e(g,m),e(d,v)},d(r){r&&o(d)}}}function wd(B){let d,b,g,m,v;return m=new Ke({props:{code:`
...
the latter silently ignores them.`)},l(r){d=s(r,"P",{});var u=a(d);b=l(u,"Although the recipe for forward pass needs to be defined within this function, one should call the "),g=s(u,"CODE",{});var x=a(g);m=l(x,"Module"),x.forEach(o),v=l(u,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),u.forEach(o)},m(r,u){_(r,d,u),e(d,b),e(d,g),e(g,m),e(d,v)},d(r){r&&o(d)}}}function Vd(B){let d,b,g,m,v;return m=new Ke({props:{code:`
...
the latter silently ignores them.`)},l(r){d=s(r,"P",{});var u=a(d);b=l(u,"Although the recipe for forward pass needs to be defined within this function, one should call the "),g=s(u,"CODE",{});var x=a(g);m=l(x,"Module"),x.forEach(o),v=l(u,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),u.forEach(o)},m(r,u){_(r,d,u),e(d,b),e(d,g),e(g,m),e(d,v)},d(r){r&&o(d)}}}function xd(B){let d,b,g,m,v;return m=new Ke({props:{code:`
...
the latter silently ignores them.`)},l(r){d=s(r,"P",{});var u=a(d);b=l(u,"Although the recipe for forward pass needs to be defined within this function, one should call the "),g=s(u,"CODE",{});var x=a(g);m=l(x,"Module"),x.forEach(o),v=l(u,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),u.forEach(o)},m(r,u){_(r,d,u),e(d,b),e(d,g),e(g,m),e(d,v)},d(r){r&&o(d)}}}function Fd(B){let d,b,g,m,v;return m=new Ke({props:{code:`
...
the latter silently ignores them.`)},l(r){d=s(r,"P",{});var u=a(d);b=l(u,"Although the recipe for forward pass needs to be defined within this function, one should call the "),g=s(u,"CODE",{});var x=a(g);m=l(x,"Module"),x.forEach(o),v=l(u,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),u.forEach(o)},m(r,u){_(r,d,u),e(d,b),e(d,g),e(g,m),e(d,v)},d(r){r&&o(d)}}}function Ed(B){let d,b,g,m,v;return m=new Ke({props:{code:`
...
outputs = model(**inputs, labels=labels)
loss = outputs.loss
scores = outputs.logits`}}),{c(){d=n("p"),b=i("Example:"),g=p(),k(m.$$.fragment)},l(r){d=s(r,"P",{});var u=a(d);b=l(u,"Example:"),u.forEach(o),g=h(r),T(m.$$.fragment,r)},m(r,u){_(r,d,u),e(d,b),_(r,g,u),y(m,r,u),v=!0},p:Gt,i(r){v||(w(m.$$.fragment,r),v=!0)},o(r){$(m.$$.fragment,r),v=!1},d(r){r&&o(d),r&&o(g),V(m,r)}}}function Pd(B){let d,b,g,m,v,r,u,x,xs,Bn,J,me,Mo,Ge,qs,jo,Fs,xn,fe,zs,Je,Es,Ps,qn,Jt,Ms,Fn,Yt,Ao,js,zn,Xt,As,En,ge,Co,Ye,Cs,Zt,Ls,Os,Rs,Lo,Oo,Ns,Pn,Y,_e,Ro,Xe,Is,No,Ds,Mn,eo,Ss,jn,to,Ws,An,ve,Qs,oo,Hs,Us,Cn,be,Io,no,Ze,Ks,Gs,Js,Do,so,et,Ys,Xs,Ln,ke,Zs,ao,ea,ta,On,tt,Rn,D,oa,ot,na,sa,nt,aa,ra,Nn,X,Te,So,st,ia,Wo,la,In,j,at,da,Z,ca,ro,ua,pa,rt,ha,ma,fa,ee,ga,io,_a,va,lo,ba,ka,Ta,ye,Dn,te,we,Qo,it,ya,Ho,wa,Sn,q,lt,$a,dt,Va,co,Ba,xa,qa,ct,Fa,ut,za,Ea,Pa,pt,Ma,ht,ja,Aa,Ca,C,mt,La,oe,Oa,uo,Ra,Na,Uo,Ia,Da,Sa,$e,Wa,Ve,Wn,ne,Be,Ko,ft,Qa,Go,Ha,Qn,F,gt,Ua,se,Ka,Jo,Ga,Ja,Yo,Ya,Xa,Za,_t,er,po,tr,or,nr,vt,sr,bt,ar,rr,ir,L,kt,lr,ae,dr,ho,cr,ur,Xo,pr,hr,mr,xe,fr,qe,Hn,re,Fe,Zo,Tt,gr,en,_r,Un,z,yt,vr,tn,br,kr,wt,Tr,mo,yr,wr,$r,$t,Vr,Vt,Br,xr,qr,O,Bt,Fr,ie,zr,fo,Er,Pr,on,Mr,jr,Ar,ze,Cr,Ee,Kn,le,Pe,nn,xt,Lr,sn,Or,Gn,E,qt,Rr,an,Nr,Ir,Ft,Dr,go,Sr,Wr,Qr,zt,Hr,Et,Ur,Kr,Gr,R,Pt,Jr,de,Yr,_o,Xr,Zr,rn,ei,ti,oi,Me,ni,je,Jn,ce,Ae,ln,Mt,si,dn,ai,Yn,P,jt,ri,cn,ii,li,At,di,vo,ci,ui,pi,Ct,hi,Lt,mi,fi,gi,N,Ot,_i,ue,vi,bo,bi,ki,un,Ti,yi,wi,Ce,$i,Le,Xn,pe,Oe,pn,Rt,Vi,hn,Bi,Zn,M,Nt,xi,mn,qi,Fi,It,zi,ko,Ei,Pi,Mi,Dt,ji,St,Ai,Ci,Li,I,Wt,Oi,he,Ri,To,Ni,Ii,fn,Di,Si,Wi,Re,Qi,Ne,es;return r=new G({}),Ge=new G({}),Xe=new G({}),tt=new Ke({props:{code:`import torch
...
the <code>inputs_ids</code> passed when calling <a href="/docs/transformers/v4.20.1/en/model_doc/visual_bert#transformers.VisualBertModel">VisualBertModel</a>. Vocabulary size of the model. Defines the
different tokens that can be represented by the <code>inputs_ids</code> passed to the forward method of
<a href="/docs/transformers/v4.20.1/en/model_doc/visual_bert#transformers.VisualBertModel">VisualBertModel</a>.`,name:"vocab_size"},{anchor:"transformers.VisualBertConfig.hidden_size",description:`<strong>hidden_size</strong> (<code>int</code>, <em>optional</em>, defaults to 768) &#x2014;
...
elements depending on the configuration (<a
  href="/docs/transformers/v4.20.1/en/model_doc/visual_bert#transformers.VisualBertConfig"
...
</ul>`,name:"sentence_image_labels"}],source:"https://github.com/huggingface/transformers/blob/v4.20.1/src/transformers/models/visual_bert/modeling_visual_bert.py#L889",returnDescription:`
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/v4.20.1/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/v4.20.1/src/transformers/models/visual_bert/modeling_visual_bert.py#L1175"}}),Bt=new A({props:{name:"forward",anchor:"transformers.VisualBertForQuestionAnswering.forward",parameters:[{name:"input_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"attention_mask",val:": typing.Optional[torch.LongTensor] = None"},{name:"token_type_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"position_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"head_mask",val:": typing.Optional[torch.LongTensor] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"visual_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"visual_attention_mask",val:": typing.Optional[torch.LongTensor] = None"},{name:"visual_token_type_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"image_text_alignment",val:": typing.Optional[torch.LongTensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"labels",val:": typing.Optional[torch.LongTensor] = None"}],parametersDescription:[{anchor:"transformers.VisualBertForQuestionAnswering.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/v4.20.1/en/model_doc/bert#transformers.BertTokenizer">BertTokenizer</a>. See <a href="/docs/transformers/v4.20.1/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/v4.20.1/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/v4.20.1/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/v4.20.1/src/transformers/models/visual_bert/modeling_visual_bert.py#L1022"}}),Pt=new A({props:{name:"forward",anchor:"transformers.VisualBertForMultipleChoice.forward",parameters:[{name:"input_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"attention_mask",val:": typing.Optional[torch.LongTensor] = None"},{name:"token_type_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"position_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"head_mask",val:": typing.Optional[torch.LongTensor] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"visual_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"visual_attention_mask",val:": typing.Optional[torch.LongTensor] = None"},{name:"visual_token_type_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"image_text_alignment",val:": typing.Optional[torch.LongTensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"labels",val:": typing.Optional[torch.LongTensor] = None"}],parametersDescription:[{anchor:"transformers.VisualBertForMultipleChoice.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, num_choices, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/v4.20.1/en/model_doc/bert#transformers.BertTokenizer">BertTokenizer</a>. See <a href="/docs/transformers/v4.20.1/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/v4.20.1/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
<code>input_ids</code> above)`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.20.1/src/transformers/models/visual_bert/modeling_visual_bert.py#L1033",returnDescription:`
<p>A <a
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/v4.20.1/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/v4.20.1/src/transformers/models/visual_bert/modeling_visual_bert.py#L1461"}}),Wt=new A({props:{name:"forward",anchor:"transformers.VisualBertForRegionToPhraseAlignment.forward",parameters:[{name:"input_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"attention_mask",val:": typing.Optional[torch.LongTensor] = None"},{name:"token_type_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"position_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"head_mask",val:": typing.Optional[torch.LongTensor] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"visual_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"visual_attention_mask",val:": typing.Optional[torch.LongTensor] = None"},{name:"visual_token_type_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"image_text_alignment",val:": typing.Optional[torch.LongTensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"region_to_phrase_position",val:": typing.Optional[torch.LongTensor] = None"},{name:"labels",val:": typing.Optional[torch.LongTensor] = None"}],parametersDescription:[{anchor:"transformers.VisualBertForRegionToPhraseAlignment.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/v4.20.1/en/model_doc/bert#transformers.BertTokenizer">BertTokenizer</a>. See <a href="/docs/transformers/v4.20.1/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/v4.20.1/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
outputs from the attention layer.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.20.1/src/transformers/models/visual_bert/modeling_visual_bert.py#L1473",returnDescription:`
<p>A <a
  href="/docs/transformers/v4.20.1/en/main_classes/output#transformers.modeling_outputs.SequenceClassifierOutput"
>transformers.modeling_outputs.SequenceClassifierOutput</a> or a tuple of
<code>torch.FloatTensor</code> (if <code>return_dict=False</code> is passed or when <code>config.return_dict=False</code>) comprising various
...
<p><a
  href="/docs/transformers/v4.20.1/en/main_classes/output#transformers.modeling_outputs.SequenceClassifierOutput"
>transformers.modeling_outputs.SequenceClassifierOutput</a> or <code>tuple(torch.FloatTensor)</code></p>
`}}),Re=new Po({props:{$$slots:{default:[zd]},$$scope:{ctx:B}}}),Ne=new Kt({props:{anchor:"transformers.VisualBertForRegionToPhraseAlignment.forward.example",$$slots:{default:[Ed]},$$scope:{ctx:B}}}),{c(){d=n("meta"),b=p(),g=n("h1"),m=n("a"),v=n("span"),k(r.$$.fragment),u=p(),x=n("span"),xs=i("VisualBERT"),Bn=p(),J=n("h2"),me=n("a"),Mo=n("span"),k(Ge.$$.fragment),qs=p(),jo=n("span"),Fs=i("Overview"),xn=p(),fe=n("p"),zs=i("The VisualBERT model was proposed in "),Je=n("a"),Es=i("VisualBERT: A Simple and Performant Baseline for Vision and Language"),Ps=i(` by Liunian Harold Li, Mark Yatskar, Da Yin, Cho-Jui Hsieh, Kai-Wei Chang.
VisualBERT is a neural network trained on a variety of (image, text) pairs.`),qn=p(),Jt=n("p"),Ms=i("The abstract from the paper is the following:"),Fn=p(),Yt=n("p"),Ao=n("em"),js=i(`We propose VisualBERT, a simple and flexible framework for modeling a broad range of vision-and-language tasks.
...
verbs and image regions corresponding to their arguments.`),zn=p(),Xt=n("p"),As=i("Tips:"),En=p(),ge=n("ol"),Co=n("li"),Ye=n("p"),Cs=i("Most of the checkpoints provided work with the "),Zt=n("a"),Ls=i("VisualBertForPreTraining"),Os=i(` configuration. Other
...
projects, and the states can be loaded directly into the detector provided.`),Pn=p(),Y=n("h2"),_e=n("a"),Ro=n("span"),k(Xe.$$.fragment),Is=p(),No=n("span"),Ds=i("Usage"),Mn=p(),eo=n("p"),Ss=i(`VisualBERT is a multi-modal vision and language model. It can be used for visual question answering, multiple choice,
...
dimension.`),jn=p(),to=n("p"),Ws=i(`To feed images to the model, each image is passed through a pre-trained object detector and the regions and the
...
appropriately for the textual and visual parts.`),An=p(),ve=n("p"),Qs=i("The "),oo=n("a"),Hs=i("BertTokenizer"),Us=i(` is used to encode the text. A custom detector/feature extractor must be used
...
etc.)`),qa=p(),ct=n("p"),Fa=i("This model is also a PyTorch "),ut=n("a"),za=i("torch.nn.Module"),Ea=i(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Pa=p(),pt=n("p"),Ma=i("The model can behave as an encoder (with only self-attention) following the architecture described in "),ht=n("a"),ja=i(`Attention is
all you need`),Aa=i(` by Ashish Vaswani, Noam Shazeer, Niki Parmar, Jakob Uszkoreit,
Llion Jones, Aidan N. Gomez, Lukasz Kaiser and Illia Polosukhin.`),Ca=p(),C=n("div"),k(mt.$$.fragment),La=p(),oe=n("p"),Oa=i("The "),uo=n("a"),Ra=i("VisualBertModel"),Na=i(" forward method, overrides the "),Uo=n("code"),Ia=i("__call__"),Da=i(" special method."),Sa=p(),k($e.$$.fragment),Wa=p(),k(Ve.$$.fragment),Wn=p(),ne=n("h2"),Be=n("a"),Ko=n("span"),k(ft.$$.fragment),Qa=p(),Go=n("span"),Ha=i("VisualBertForPreTraining"),Qn=p(),F=n("div"),k(gt.$$.fragment),Ua=p(),se=n("p"),Ka=i("VisualBert Model with two heads on top as done during the pretraining: a "),Jo=n("code"),Ga=i("masked language modeling"),Ja=i(` head and a
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),ir=p(),L=n("div"),k(kt.$$.fragment),lr=p(),ae=n("p"),dr=i("The "),ho=n("a"),cr=i("VisualBertForPreTraining"),ur=i(" forward method, overrides the "),Xo=n("code"),pr=i("__call__"),hr=i(" special method."),mr=p(),k(xe.$$.fragment),fr=p(),k(qe.$$.fragment),Hn=p(),re=n("h2"),Fe=n("a"),Zo=n("span"),k(Tt.$$.fragment),gr=p(),en=n("span"),_r=i("VisualBertForQuestionAnswering"),Un=p(),z=n("div"),k(yt.$$.fragment),vr=p(),tn=n("p"),br=i(`VisualBert Model with a classification/regression head on top (a dropout and a linear layer on top of the pooled
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),$r=p(),$t=n("p"),Vr=i("This model is also a PyTorch "),Vt=n("a"),Br=i("torch.nn.Module"),xr=i(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),qr=p(),O=n("div"),k(Bt.$$.fragment),Fr=p(),ie=n("p"),zr=i("The "),fo=n("a"),Er=i("VisualBertForQuestionAnswering"),Pr=i(" forward method, overrides the "),on=n("code"),Mr=i("__call__"),jr=i(" special method."),Ar=p(),k(ze.$$.fragment),Cr=p(),k(Ee.$$.fragment),Kn=p(),le=n("h2"),Pe=n("a"),nn=n("span"),k(xt.$$.fragment),Lr=p(),sn=n("span"),Or=i("VisualBertForMultipleChoice"),Gn=p(),E=n("div"),k(qt.$$.fragment),Rr=p(),an=n("p"),Nr=i(`VisualBert Model with a multiple choice classification head on top (a linear layer on top of the pooled output and
a softmax) e.g. for VCR tasks.`),Ir=p(),Ft=n("p"),Dr=i("This model inherits from "),go=n("a"),Sr=i("PreTrainedModel"),Wr=i(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Qr=p(),zt=n("p"),Hr=i("This model is also a PyTorch "),Et=n("a"),Ur=i("torch.nn.Module"),Kr=i(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Gr=p(),R=n("div"),k(Pt.$$.fragment),Jr=p(),de=n("p"),Yr=i("The "),_o=n("a"),Xr=i("VisualBertForMultipleChoice"),Zr=i(" forward method, overrides the "),rn=n("code"),ei=i("__call__"),ti=i(" special method."),oi=p(),k(Me.$$.fragment),ni=p(),k(je.$$.fragment),Jn=p(),ce=n("h2"),Ae=n("a"),ln=n("span"),k(Mt.$$.fragment),si=p(),dn=n("span"),ai=i("VisualBertForVisualReasoning"),Yn=p(),P=n("div"),k(jt.$$.fragment),ri=p(),cn=n("p"),ii=i(`VisualBert Model with a sequence classification head on top (a dropout and a linear layer on top of the pooled
output) for Visual Reasoning e.g. for NLVR task.`),li=p(),At=n("p"),di=i("This model inherits from "),vo=n("a"),ci=i("PreTrainedModel"),ui=i(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),pi=p(),Ct=n("p"),hi=i("This model is also a PyTorch "),Lt=n("a"),mi=i("torch.nn.Module"),fi=i(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),gi=p(),N=n("div"),k(Ot.$$.fragment),_i=p(),ue=n("p"),vi=i("The "),bo=n("a"),bi=i("VisualBertForVisualReasoning"),ki=i(" forward method, overrides the "),un=n("code"),Ti=i("__call__"),yi=i(" special method."),wi=p(),k(Ce.$$.fragment),$i=p(),k(Le.$$.fragment),Xn=p(),pe=n("h2"),Oe=n("a"),pn=n("span"),k(Rt.$$.fragment),Vi=p(),hn=n("span"),Bi=i("VisualBertForRegionToPhraseAlignment"),Zn=p(),M=n("div"),k(Nt.$$.fragment),xi=p(),mn=n("p"),qi=i(`VisualBert Model with a Masked Language Modeling head and an attention layer on top for Region-to-Phrase Alignment
e.g. for Flickr30 Entities task.`),Fi=p(),It=n("p"),zi=i("This model inherits from "),ko=n("a"),Ei=i("PreTrainedModel"),Pi=i(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Mi=p(),Dt=n("p"),ji=i("This model is also a PyTorch "),St=n("a"),Ai=i("torch.nn.Module"),Ci=i(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Li=p(),I=n("div"),k(Wt.$$.fragment),Oi=p(),he=n("p"),Ri=i("The "),To=n("a"),Ni=i("VisualBertForRegionToPhraseAlignment"),Ii=i(" forward method, overrides the "),fn=n("code"),Di=i("__call__"),Si=i(" special method."),Wi=p(),k(Re.$$.fragment),Qi=p(),k(Ne.$$.fragment),this.h()},l(t){const f=_d('[data-svelte="svelte-1phssyn"]',document.head);d=s(f,"META",{name:!0,content:!0}),f.forEach(o),b=h(t),g=s(t,"H1",{class:!0});var Qt=a(g);m=s(Qt,"A",{id:!0,class:!0,href:!0});var gn=a(m);v=s(gn,"SPAN",{});var _n=a(v);T(r.$$.fragment,_n),_n.forEach(o),gn.forEach(o),u=h(Qt),x=s(Qt,"SPAN",{});var vn=a(x);xs=l(vn,"VisualBERT"),vn.forEach(o),Qt.forEach(o),Bn=h(t),J=s(t,"H2",{class:!0});var Ht=a(J);me=s(Ht,"A",{id:!0,class:!0,href:!0});var bn=a(me);Mo=s(bn,"SPAN",{});var kn=a(Mo);T(Ge.$$.fragment,kn),kn.forEach(o),bn.forEach(o),qs=h(Ht),jo=s(Ht,"SPAN",{});var Tn=a(jo);Fs=l(Tn,"Overview"),Tn.forEach(o),Ht.forEach(o),xn=h(t),fe=s(t,"P",{});var Ut=a(fe);zs=l(Ut,"The VisualBERT model was proposed in "),Je=s(Ut,"A",{href:!0,rel:!0});var yn=a(Je);Es=l(yn,"VisualBERT: A Simple and Performant Baseline for Vision and Language"),yn.forEach(o),Ps=l(Ut,` by Liunian Harold Li, Mark Yatskar, Da Yin, Cho-Jui Hsieh, Kai-Wei Chang.
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),ds.forEach(o),qa=h(S),ct=s(S,"P",{});var cs=a(ct);Fa=l(cs,"This model is also a PyTorch "),ut=s(cs,"A",{href:!0,rel:!0});var wl=a(ut);za=l(wl,"torch.nn.Module"),wl.forEach(o),Ea=l(cs,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),cs.forEach(o),Pa=h(S),pt=s(S,"P",{});var us=a(pt);Ma=l(us,"The model can behave as an encoder (with only self-attention) following the architecture described in "),ht=s(us,"A",{href:!0,rel:!0});var $l=a(ht);ja=l($l,`Attention is
all you need`),$l.forEach(o),Aa=l(us,` by Ashish Vaswani, Noam Shazeer, Niki Parmar, Jakob Uszkoreit,
Llion Jones, Aidan N. Gomez, Lukasz Kaiser and Illia Polosukhin.`),us.forEach(o),Ca=h(S),C=s(S,"DIV",{class:!0});var De=a(C);T(mt.$$.fragment,De),La=h(De),oe=s(De,"P",{});var Vo=a(oe);Oa=l(Vo,"The "),uo=s(Vo,"A",{href:!0});var Vl=a(uo);Ra=l(Vl,"VisualBertModel"),Vl.forEach(o),Na=l(Vo," forward method, overrides the "),Uo=s(Vo,"CODE",{});var Bl=a(Uo);Ia=l(Bl,"__call__"),Bl.forEach(o),Da=l(Vo," special method."),Vo.forEach(o),Sa=h(De),T($e.$$.fragment,De),Wa=h(De),T(Ve.$$.fragment,De),De.forEach(o),S.forEach(o),Wn=h(t),ne=s(t,"H2",{class:!0});var ps=a(ne);Be=s(ps,"A",{id:!0,class:!0,href:!0});var xl=a(Be);Ko=s(xl,"SPAN",{});var ql=a(Ko);T(ft.$$.fragment,ql),ql.forEach(o),xl.forEach(o),Qa=h(ps),Go=s(ps,"SPAN",{});var Fl=a(Go);Ha=l(Fl,"VisualBertForPreTraining"),Fl.forEach(o),ps.forEach(o),Qn=h(t),F=s(t,"DIV",{class:!0});var W=a(F);T(gt.$$.fragment,W),Ua=h(W),se=s(W,"P",{});var Bo=a(se);Ka=l(Bo,"VisualBert Model with two heads on top as done during the pretraining: a "),Jo=s(Bo,"CODE",{});var zl=a(Jo);Ga=l(zl,"masked language modeling"),zl.forEach(o),Ja=l(Bo,` head and a
`),Yo=s(Bo,"CODE",{});var El=a(Yo);Ya=l(El,"sentence-image prediction (classification)"),El.forEach(o),Xa=l(Bo," head."),Bo.forEach(o),Za=h(W),_t=s(W,"P",{});var hs=a(_t);er=l(hs,"This model inherits from "),po=s(hs,"A",{href:!0});var Pl=a(po);tr=l(Pl,"PreTrainedModel"),Pl.forEach(o),or=l(hs,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),ms.forEach(o),ir=h(W),L=s(W,"DIV",{class:!0});var Se=a(L);T(kt.$$.fragment,Se),lr=h(Se),ae=s(Se,"P",{});var xo=a(ae);dr=l(xo,"The "),ho=s(xo,"A",{href:!0});var jl=a(ho);cr=l(jl,"VisualBertForPreTraining"),jl.forEach(o),ur=l(xo," forward method, overrides the "),Xo=s(xo,"CODE",{});var Al=a(Xo);pr=l(Al,"__call__"),Al.forEach(o),hr=l(xo," special method."),xo.forEach(o),mr=h(Se),T(xe.$$.fragment,Se),fr=h(Se),T(qe.$$.fragment,Se),Se.forEach(o),W.forEach(o),Hn=h(t),re=s(t,"H2",{class:!0});var fs=a(re);Fe=s(fs,"A",{id:!0,class:!0,href:!0});var Cl=a(Fe);Zo=s(Cl,"SPAN",{});var Ll=a(Zo);T(Tt.$$.fragment,Ll),Ll.forEach(o),Cl.forEach(o),gr=h(fs),en=s(fs,"SPAN",{});var Ol=a(en);_r=l(Ol,"VisualBertForQuestionAnswering"),Ol.forEach(o),fs.forEach(o),Un=h(t),z=s(t,"DIV",{class:!0});var Q=a(z);T(yt.$$.fragment,Q),vr=h(Q),tn=s(Q,"P",{});var Rl=a(tn);br=l(Rl,`VisualBert Model with a classification/regression head on top (a dropout and a linear layer on top of the pooled
...
output) for Visual Reasoning e.g. for NLVR task.`),td.forEach(o),li=h(U),At=s(U,"P",{});var ys=a(At);di=l(ys,"This model inherits from "),vo=s(ys,"A",{href:!0});var od=a(vo);ci=l(od,"PreTrainedModel"),od.forEach(o),ui=l(ys,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),ws.forEach(o),gi=h(U),N=s(U,"DIV",{class:!0});var He=a(N);T(Ot.$$.fragment,He),_i=h(He),ue=s(He,"P",{});var zo=a(ue);vi=l(zo,"The "),bo=s(zo,"A",{href:!0});var sd=a(bo);bi=l(sd,"VisualBertForVisualReasoning"),sd.forEach(o),ki=l(zo," forward method, overrides the "),un=s(zo,"CODE",{});var ad=a(un);Ti=l(ad,"__call__"),ad.forEach(o),yi=l(zo," special method."),zo.forEach(o),wi=h(He),T(Ce.$$.fragment,He),$i=h(He),T(Le.$$.fragment,He),He.forEach(o),U.forEach(o),Xn=h(t),pe=s(t,"H2",{class:!0});var $s=a(pe);Oe=s($s,"A",{id:!0,class:!0,href:!0});var rd=a(Oe);pn=s(rd,"SPAN",{});var id=a(pn);T(Rt.$$.fragment,id),id.forEach(o),rd.forEach(o),Vi=h($s),hn=s($s,"SPAN",{});var ld=a(hn);Bi=l(ld,"VisualBertForRegionToPhraseAlignment"),ld.forEach(o),$s.forEach(o),Zn=h(t),M=s(t,"DIV",{class:!0});var K=a(M);T(Nt.$$.fragment,K),xi=h(K),mn=s(K,"P",{});var dd=a(mn);qi=l(dd,`VisualBert Model with a Masked Language Modeling head and an attention layer on top for Region-to-Phrase Alignment
