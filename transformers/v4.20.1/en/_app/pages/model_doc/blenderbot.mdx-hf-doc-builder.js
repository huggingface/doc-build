import{S as Lm,i as Sm,s as Dm,e as n,k as l,w as k,t as a,M as Gm,c as r,d as t,m as c,a as s,x as y,h as d,b as u,G as e,g as f,y as T,q as w,o as $,B,v as Wm,L as nt}from"../../chunks/vendor-hf-doc-builder.js";import{T as Bo}from"../../chunks/Tip-hf-doc-builder.js";import{D as P}from"../../chunks/Docstring-hf-doc-builder.js";import{C as Ke}from"../../chunks/CodeBlock-hf-doc-builder.js";import{I as ce}from"../../chunks/IconCopyLink-hf-doc-builder.js";import{E as ot}from"../../chunks/ExampleCodeBlock-hf-doc-builder.js";function Um(z){let p,v,g,h,b;return h=new Ke({props:{code:`from transformers import BlenderbotModel, BlenderbotConfig
...
<span class="hljs-meta">&gt;&gt;&gt; </span>configuration = model.config`}}),{c(){p=n("p"),v=a("Example:"),g=l(),k(h.$$.fragment)},l(i){p=r(i,"P",{});var m=s(p);v=d(m,"Example:"),m.forEach(t),g=c(i),y(h.$$.fragment,i)},m(i,m){f(i,p,m),e(p,v),f(i,g,m),T(h,i,m),b=!0},p:nt,i(i){b||(w(h.$$.fragment,i),b=!0)},o(i){$(h.$$.fragment,i),b=!1},d(i){i&&t(p),i&&t(g),B(h,i)}}}function Rm(z){let p,v,g,h,b;return{c(){p=n("p"),v=a("Although the recipe for forward pass needs to be defined within this function, one should call the "),g=n("code"),h=a("Module"),b=a(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(i){p=r(i,"P",{});var m=s(p);v=d(m,"Although the recipe for forward pass needs to be defined within this function, one should call the "),g=r(m,"CODE",{});var F=s(g);h=d(F,"Module"),F.forEach(t),b=d(m,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),m.forEach(t)},m(i,m){f(i,p,m),e(p,v),e(p,g),e(g,h),e(p,b)},d(i){i&&t(p)}}}function Hm(z){let p,v,g,h,b;return h=new Ke({props:{code:`from transformers import BlenderbotTokenizer, BlenderbotModel
...
[<span class="hljs-number">1</span>, <span class="hljs-number">6</span>, <span class="hljs-number">1280</span>]`}}),{c(){p=n("p"),v=a("Example:"),g=l(),k(h.$$.fragment)},l(i){p=r(i,"P",{});var m=s(p);v=d(m,"Example:"),m.forEach(t),g=c(i),y(h.$$.fragment,i)},m(i,m){f(i,p,m),e(p,v),f(i,g,m),T(h,i,m),b=!0},p:nt,i(i){b||(w(h.$$.fragment,i),b=!0)},o(i){$(h.$$.fragment,i),b=!1},d(i){i&&t(p),i&&t(g),B(h,i)}}}function Km(z){let p,v,g,h,b;return{c(){p=n("p"),v=a("Although the recipe for forward pass needs to be defined within this function, one should call the "),g=n("code"),h=a("Module"),b=a(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(i){p=r(i,"P",{});var m=s(p);v=d(m,"Although the recipe for forward pass needs to be defined within this function, one should call the "),g=r(m,"CODE",{});var F=s(g);h=d(F,"Module"),F.forEach(t),b=d(m,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),m.forEach(t)},m(i,m){f(i,p,m),e(p,v),e(p,g),e(g,h),e(p,b)},d(i){i&&t(p)}}}function Vm(z){let p,v,g,h,b;return h=new Ke({props:{code:`from transformers import BlenderbotTokenizer, BlenderbotForConditionalGeneration
...
Bot:   That&#x27;s too bad. Have you tried encouraging them to change their eating habits?</span>`}}),{c(){p=n("p"),v=a("Conversation example:"),g=l(),k(h.$$.fragment)},l(i){p=r(i,"P",{});var m=s(p);v=d(m,"Conversation example:"),m.forEach(t),g=c(i),y(h.$$.fragment,i)},m(i,m){f(i,p,m),e(p,v),f(i,g,m),T(h,i,m),b=!0},p:nt,i(i){b||(w(h.$$.fragment,i),b=!0)},o(i){$(h.$$.fragment,i),b=!1},d(i){i&&t(p),i&&t(g),B(h,i)}}}function Jm(z){let p,v,g,h,b;return h=new Ke({props:{code:`from transformers import BlenderbotTokenizer, BlenderbotForCausalLM
...
<span class="hljs-literal">True</span>`}}),{c(){p=n("p"),v=a("Example:"),g=l(),k(h.$$.fragment)},l(i){p=r(i,"P",{});var m=s(p);v=d(m,"Example:"),m.forEach(t),g=c(i),y(h.$$.fragment,i)},m(i,m){f(i,p,m),e(p,v),f(i,g,m),T(h,i,m),b=!0},p:nt,i(i){b||(w(h.$$.fragment,i),b=!0)},o(i){$(h.$$.fragment,i),b=!1},d(i){i&&t(p),i&&t(g),B(h,i)}}}function Qm(z){let p,v,g,h,b,i,m,F,Me,pe,E,fe,te,Ce,oe,ne,je,we,G,N,_e,R,M,j,Oe,J,Q,Pe,W,Ne,Ae,A,ue,re,$e,he,H,Ie,Be,C,Le,U,Se;return{c(){p=n("p"),v=a("TF 2.0 models accepts two formats as inputs:"),g=l(),h=n("ul"),b=n("li"),i=a("having all inputs as keyword arguments (like PyTorch models), or"),m=l(),F=n("li"),Me=a("having all inputs as a list, tuple or dict in the first positional arguments."),pe=l(),E=n("p"),fe=a("This second option is useful when using "),te=n("code"),Ce=a("tf.keras.Model.fit"),oe=a(` method which currently requires having all the
...
first positional argument :`),R=l(),M=n("ul"),j=n("li"),Oe=a("a single Tensor with "),J=n("code"),Q=a("input_ids"),Pe=a(" only and nothing else: "),W=n("code"),Ne=a("model(input_ids)"),Ae=l(),A=n("li"),ue=a(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),re=n("code"),$e=a("model([input_ids, attention_mask])"),he=a(" or "),H=n("code"),Ie=a("model([input_ids, attention_mask, token_type_ids])"),Be=l(),C=n("li"),Le=a(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),U=n("code"),Se=a('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(x){p=r(x,"P",{});var q=s(p);v=d(q,"TF 2.0 models accepts two formats as inputs:"),q.forEach(t),g=c(x),h=r(x,"UL",{});var ge=s(h);b=r(ge,"LI",{});var rt=s(b);i=d(rt,"having all inputs as keyword arguments (like PyTorch models), or"),rt.forEach(t),m=c(ge),F=r(ge,"LI",{});var Ve=s(F);Me=d(Ve,"having all inputs as a list, tuple or dict in the first positional arguments."),Ve.forEach(t),ge.forEach(t),pe=c(x),E=r(x,"P",{});var O=s(E);fe=d(O,"This second option is useful when using "),te=r(O,"CODE",{});var me=s(te);Ce=d(me,"tf.keras.Model.fit"),me.forEach(t),oe=d(O,` method which currently requires having all the
tensors in the first argument of the model call function: `),ne=r(O,"CODE",{});var De=s(ne);je=d(De,"model(inputs)"),De.forEach(t),we=d(O,"."),O.forEach(t),G=c(x),N=r(x,"P",{});var be=s(N);_e=d(be,`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),be.forEach(t),R=c(x),M=r(x,"UL",{});var K=s(M);j=r(K,"LI",{});var V=s(j);Oe=d(V,"a single Tensor with "),J=r(V,"CODE",{});var st=s(J);Q=d(st,"input_ids"),st.forEach(t),Pe=d(V," only and nothing else: "),W=r(V,"CODE",{});var Je=s(W);Ne=d(Je,"model(input_ids)"),Je.forEach(t),V.forEach(t),Ae=c(K),A=r(K,"LI",{});var I=s(A);ue=d(I,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),re=r(I,"CODE",{});var ve=s(re);$e=d(ve,"model([input_ids, attention_mask])"),ve.forEach(t),he=d(I," or "),H=r(I,"CODE",{});var at=s(H);Ie=d(at,"model([input_ids, attention_mask, token_type_ids])"),at.forEach(t),I.forEach(t),Be=c(K),C=r(K,"LI",{});var se=s(C);Le=d(se,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),U=r(se,"CODE",{});var dt=s(U);Se=d(dt,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),dt.forEach(t),se.forEach(t),K.forEach(t)},m(x,q){f(x,p,q),e(p,v),f(x,g,q),f(x,h,q),e(h,b),e(b,i),e(h,m),e(h,F),e(F,Me),f(x,pe,q),f(x,E,q),e(E,fe),e(E,te),e(te,Ce),e(E,oe),e(E,ne),e(ne,je),e(E,we),f(x,G,q),f(x,N,q),e(N,_e),f(x,R,q),f(x,M,q),e(M,j),e(j,Oe),e(j,J),e(J,Q),e(j,Pe),e(j,W),e(W,Ne),e(M,Ae),e(M,A),e(A,ue),e(A,re),e(re,$e),e(A,he),e(A,H),e(H,Ie),e(M,Be),e(M,C),e(C,Le),e(C,U),e(U,Se)},d(x){x&&t(p),x&&t(g),x&&t(h),x&&t(pe),x&&t(E),x&&t(G),x&&t(N),x&&t(R),x&&t(M)}}}function Xm(z){let p,v,g,h,b;return{c(){p=n("p"),v=a("Although the recipe for forward pass needs to be defined within this function, one should call the "),g=n("code"),h=a("Module"),b=a(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(i){p=r(i,"P",{});var m=s(p);v=d(m,"Although the recipe for forward pass needs to be defined within this function, one should call the "),g=r(m,"CODE",{});var F=s(g);h=d(F,"Module"),F.forEach(t),b=d(m,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),m.forEach(t)},m(i,m){f(i,p,m),e(p,v),e(p,g),e(g,h),e(p,b)},d(i){i&&t(p)}}}function Ym(z){let p,v,g,h,b;return h=new Ke({props:{code:`from transformers import BlenderbotTokenizer, TFBlenderbotModel
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),{c(){p=n("p"),v=a("Example:"),g=l(),k(h.$$.fragment)},l(i){p=r(i,"P",{});var m=s(p);v=d(m,"Example:"),m.forEach(t),g=c(i),y(h.$$.fragment,i)},m(i,m){f(i,p,m),e(p,v),f(i,g,m),T(h,i,m),b=!0},p:nt,i(i){b||(w(h.$$.fragment,i),b=!0)},o(i){$(h.$$.fragment,i),b=!1},d(i){i&&t(p),i&&t(g),B(h,i)}}}function Zm(z){let p,v,g,h,b,i,m,F,Me,pe,E,fe,te,Ce,oe,ne,je,we,G,N,_e,R,M,j,Oe,J,Q,Pe,W,Ne,Ae,A,ue,re,$e,he,H,Ie,Be,C,Le,U,Se;return{c(){p=n("p"),v=a("TF 2.0 models accepts two formats as inputs:"),g=l(),h=n("ul"),b=n("li"),i=a("having all inputs as keyword arguments (like PyTorch models), or"),m=l(),F=n("li"),Me=a("having all inputs as a list, tuple or dict in the first positional arguments."),pe=l(),E=n("p"),fe=a("This second option is useful when using "),te=n("code"),Ce=a("tf.keras.Model.fit"),oe=a(` method which currently requires having all the
tensors in the first argument of the model call function: `),ne=n("code"),je=a("model(inputs)"),we=a("."),G=l(),N=n("p"),_e=a(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),R=l(),M=n("ul"),j=n("li"),Oe=a("a single Tensor with "),J=n("code"),Q=a("input_ids"),Pe=a(" only and nothing else: "),W=n("code"),Ne=a("model(input_ids)"),Ae=l(),A=n("li"),ue=a(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),re=n("code"),$e=a("model([input_ids, attention_mask])"),he=a(" or "),H=n("code"),Ie=a("model([input_ids, attention_mask, token_type_ids])"),Be=l(),C=n("li"),Le=a(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),U=n("code"),Se=a('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(x){p=r(x,"P",{});var q=s(p);v=d(q,"TF 2.0 models accepts two formats as inputs:"),q.forEach(t),g=c(x),h=r(x,"UL",{});var ge=s(h);b=r(ge,"LI",{});var rt=s(b);i=d(rt,"having all inputs as keyword arguments (like PyTorch models), or"),rt.forEach(t),m=c(ge),F=r(ge,"LI",{});var Ve=s(F);Me=d(Ve,"having all inputs as a list, tuple or dict in the first positional arguments."),Ve.forEach(t),ge.forEach(t),pe=c(x),E=r(x,"P",{});var O=s(E);fe=d(O,"This second option is useful when using "),te=r(O,"CODE",{});var me=s(te);Ce=d(me,"tf.keras.Model.fit"),me.forEach(t),oe=d(O,` method which currently requires having all the
...
first positional argument :`),be.forEach(t),R=c(x),M=r(x,"UL",{});var K=s(M);j=r(K,"LI",{});var V=s(j);Oe=d(V,"a single Tensor with "),J=r(V,"CODE",{});var st=s(J);Q=d(st,"input_ids"),st.forEach(t),Pe=d(V," only and nothing else: "),W=r(V,"CODE",{});var Je=s(W);Ne=d(Je,"model(input_ids)"),Je.forEach(t),V.forEach(t),Ae=c(K),A=r(K,"LI",{});var I=s(A);ue=d(I,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),re=r(I,"CODE",{});var ve=s(re);$e=d(ve,"model([input_ids, attention_mask])"),ve.forEach(t),he=d(I," or "),H=r(I,"CODE",{});var at=s(H);Ie=d(at,"model([input_ids, attention_mask, token_type_ids])"),at.forEach(t),I.forEach(t),Be=c(K),C=r(K,"LI",{});var se=s(C);Le=d(se,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),U=r(se,"CODE",{});var dt=s(U);Se=d(dt,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),dt.forEach(t),se.forEach(t),K.forEach(t)},m(x,q){f(x,p,q),e(p,v),f(x,g,q),f(x,h,q),e(h,b),e(b,i),e(h,m),e(h,F),e(F,Me),f(x,pe,q),f(x,E,q),e(E,fe),e(E,te),e(te,Ce),e(E,oe),e(E,ne),e(ne,je),e(E,we),f(x,G,q),f(x,N,q),e(N,_e),f(x,R,q),f(x,M,q),e(M,j),e(j,Oe),e(j,J),e(J,Q),e(j,Pe),e(j,W),e(W,Ne),e(M,Ae),e(M,A),e(A,ue),e(A,re),e(re,$e),e(A,he),e(A,H),e(H,Ie),e(M,Be),e(M,C),e(C,Le),e(C,U),e(U,Se)},d(x){x&&t(p),x&&t(g),x&&t(h),x&&t(pe),x&&t(E),x&&t(G),x&&t(N),x&&t(R),x&&t(M)}}}function ef(z){let p,v,g,h,b;return{c(){p=n("p"),v=a("Although the recipe for forward pass needs to be defined within this function, one should call the "),g=n("code"),h=a("Module"),b=a(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(i){p=r(i,"P",{});var m=s(p);v=d(m,"Although the recipe for forward pass needs to be defined within this function, one should call the "),g=r(m,"CODE",{});var F=s(g);h=d(F,"Module"),F.forEach(t),b=d(m,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),m.forEach(t)},m(i,m){f(i,p,m),e(p,v),e(p,g),e(g,h),e(p,b)},d(i){i&&t(p)}}}function tf(z){let p,v,g,h,b;return{c(){p=n("p"),v=a("Although the recipe for forward pass needs to be defined within this function, one should call the "),g=n("code"),h=a("Module"),b=a(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(i){p=r(i,"P",{});var m=s(p);v=d(m,"Although the recipe for forward pass needs to be defined within this function, one should call the "),g=r(m,"CODE",{});var F=s(g);h=d(F,"Module"),F.forEach(t),b=d(m,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),m.forEach(t)},m(i,m){f(i,p,m),e(p,v),e(p,g),e(g,h),e(p,b)},d(i){i&&t(p)}}}function of(z){let p,v,g,h,b;return h=new Ke({props:{code:`from transformers import BlenderbotTokenizer, FlaxBlenderbotModel
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),{c(){p=n("p"),v=a("Example:"),g=l(),k(h.$$.fragment)},l(i){p=r(i,"P",{});var m=s(p);v=d(m,"Example:"),m.forEach(t),g=c(i),y(h.$$.fragment,i)},m(i,m){f(i,p,m),e(p,v),f(i,g,m),T(h,i,m),b=!0},p:nt,i(i){b||(w(h.$$.fragment,i),b=!0)},o(i){$(h.$$.fragment,i),b=!1},d(i){i&&t(p),i&&t(g),B(h,i)}}}function nf(z){let p,v,g,h,b;return h=new Ke({props:{code:`from transformers import BlenderbotTokenizer, FlaxBlenderbotForConditionalGeneration
...
<span class="hljs-meta">&gt;&gt;&gt; </span>encoder_outputs = model.encode(**inputs)`}}),{c(){p=n("p"),v=a("Example:"),g=l(),k(h.$$.fragment)},l(i){p=r(i,"P",{});var m=s(p);v=d(m,"Example:"),m.forEach(t),g=c(i),y(h.$$.fragment,i)},m(i,m){f(i,p,m),e(p,v),f(i,g,m),T(h,i,m),b=!0},p:nt,i(i){b||(w(h.$$.fragment,i),b=!0)},o(i){$(h.$$.fragment,i),b=!1},d(i){i&&t(p),i&&t(g),B(h,i)}}}function rf(z){let p,v,g,h,b;return h=new Ke({props:{code:`import jax.numpy as jnp
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_decoder_hidden_states = outputs.last_hidden_state`}}),{c(){p=n("p"),v=a("Example:"),g=l(),k(h.$$.fragment)},l(i){p=r(i,"P",{});var m=s(p);v=d(m,"Example:"),m.forEach(t),g=c(i),y(h.$$.fragment,i)},m(i,m){f(i,p,m),e(p,v),f(i,g,m),T(h,i,m),b=!0},p:nt,i(i){b||(w(h.$$.fragment,i),b=!0)},o(i){$(h.$$.fragment,i),b=!1},d(i){i&&t(p),i&&t(g),B(h,i)}}}function sf(z){let p,v,g,h,b;return{c(){p=n("p"),v=a("Although the recipe for forward pass needs to be defined within this function, one should call the "),g=n("code"),h=a("Module"),b=a(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(i){p=r(i,"P",{});var m=s(p);v=d(m,"Although the recipe for forward pass needs to be defined within this function, one should call the "),g=r(m,"CODE",{});var F=s(g);h=d(F,"Module"),F.forEach(t),b=d(m,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),m.forEach(t)},m(i,m){f(i,p,m),e(p,v),e(p,g),e(g,h),e(p,b)},d(i){i&&t(p)}}}function af(z){let p,v,g,h,b;return h=new Ke({props:{code:`from transformers import BlenderbotTokenizer, FlaxBlenderbotForConditionalGeneration
...
<span class="hljs-meta">&gt;&gt;&gt; </span>text = <span class="hljs-string">&quot;My friends are cool but they eat too many carbs.&quot;</span>
<span class="hljs-meta">&gt;&gt;&gt; </span>inputs = tokenizer(text, max_length=<span class="hljs-number">1024</span>, return_tensors=<span class="hljs-string">&quot;jax&quot;</span>)
<span class="hljs-meta">&gt;&gt;&gt; </span>encoder_outputs = model.encode(**inputs)`}}),{c(){p=n("p"),v=a("Example:"),g=l(),k(h.$$.fragment)},l(i){p=r(i,"P",{});var m=s(p);v=d(m,"Example:"),m.forEach(t),g=c(i),y(h.$$.fragment,i)},m(i,m){f(i,p,m),e(p,v),f(i,g,m),T(h,i,m),b=!0},p:nt,i(i){b||(w(h.$$.fragment,i),b=!0)},o(i){$(h.$$.fragment,i),b=!1},d(i){i&&t(p),i&&t(g),B(h,i)}}}function df(z){let p,v,g,h,b;return h=new Ke({props:{code:`import jax.numpy as jnp
from transformers import BlenderbotTokenizer, FlaxBlenderbotForConditionalGeneration
...
<span class="hljs-meta">&gt;&gt;&gt; </span>outputs = model.decode(decoder_input_ids, encoder_outputs)
<span class="hljs-meta">&gt;&gt;&gt; </span>logits = outputs.logits`}}),{c(){p=n("p"),v=a("Example:"),g=l(),k(h.$$.fragment)},l(i){p=r(i,"P",{});var m=s(p);v=d(m,"Example:"),m.forEach(t),g=c(i),y(h.$$.fragment,i)},m(i,m){f(i,p,m),e(p,v),f(i,g,m),T(h,i,m),b=!0},p:nt,i(i){b||(w(h.$$.fragment,i),b=!0)},o(i){$(h.$$.fragment,i),b=!1},d(i){i&&t(p),i&&t(g),B(h,i)}}}function lf(z){let p,v,g,h,b,i,m,F,Me,pe,E,fe,te,Ce,oe,ne,je,we,G,N,_e,R,M,j,Oe,J,Q,Pe,W,Ne,Ae,A,ue,re,$e,he,H,Ie,Be,C,Le,U,Se,x,q,ge,rt,Ve,O,me,De,be,K,V,st,Je,I,ve,at,se,dt,Fd,qd,xo,Ed,zo,Md,Cd,jd,Ge,Od,zr,Pd,Nd,Fr,Ad,Id,Vn,Ld,Sd,ba,it,qt,qr,Fo,Dd,Er,Gd,va,Jn,Wd,ka,qo,ya,lt,Et,Mr,Eo,Ud,Cr,Rd,Ta,ke,Mo,Hd,ct,Kd,Qn,Vd,Jd,Co,Qd,Xd,Yd,pt,Zd,Xn,ei,ti,Yn,oi,ni,ri,Mt,wa,ut,Ct,jr,jo,si,Or,ai,$a,ae,Oo,di,Pr,ii,li,jt,Nr,ci,pi,Zn,ui,hi,mi,Po,fi,er,_i,gi,bi,Qe,No,vi,Ar,ki,yi,Ir,tr,Ti,Lr,wi,Ba,ht,Ot,Sr,Ao,$i,Dr,Bi,xa,de,Io,xi,Lo,zi,Gr,Fi,qi,Ei,Pt,Wr,Mi,Ci,or,ji,Oi,Pi,So,Ni,nr,Ai,Ii,Li,Xe,Do,Si,Ur,Di,Gi,Rr,rr,Wi,Hr,Ui,za,mt,Nt,Kr,Go,Ri,Vr,Hi,Fa,We,Ki,Jr,Vi,Ji,Qr,Qi,Xi,Xr,Yi,qa,ye,Wo,Zi,Uo,el,sr,tl,ol,nl,Ro,rl,Ho,sl,al,dl,xe,Ko,il,ft,ll,ar,cl,pl,Yr,ul,hl,ml,At,fl,It,Ea,_t,Lt,Zr,Vo,_l,es,gl,Ma,Ue,bl,dr,vl,kl,ts,yl,Tl,os,wl,Ca,Te,Jo,$l,Qo,Bl,ir,xl,zl,Fl,Xo,ql,Yo,El,Ml,Cl,ze,Zo,jl,gt,Ol,lr,Pl,Nl,ns,Al,Il,Ll,St,Sl,Dt,ja,bt,Gt,rs,en,Dl,ss,Gl,Oa,vt,tn,Wl,Wt,on,Ul,Ut,Pa,kt,Rt,as,nn,Rl,ds,Hl,Na,ie,rn,Kl,sn,Vl,cr,Jl,Ql,Xl,an,Yl,dn,Zl,ec,tc,Ht,oc,Fe,ln,nc,yt,rc,pr,sc,ac,is,dc,ic,lc,Kt,cc,Vt,Aa,Tt,Jt,ls,cn,pc,cs,uc,Ia,le,pn,hc,un,mc,ur,fc,_c,gc,hn,bc,mn,vc,kc,yc,Qt,Tc,X,fn,wc,wt,$c,hr,Bc,xc,ps,zc,Fc,qc,Xt,Ec,us,Mc,Cc,hs,ms,fs,_s,jc,Oc,gs,bs,vs,_n,Pc,ks,Nc,Ac,La,$t,Yt,ys,gn,Ic,Ts,Lc,Sa,L,bn,Sc,vn,Dc,mr,Gc,Wc,Uc,kn,Rc,yn,Hc,Kc,Vc,ws,Jc,Qc,Re,$s,Tn,Xc,Yc,Bs,wn,Zc,ep,xs,$n,tp,op,zs,Bn,np,rp,qe,xn,sp,Bt,ap,Fs,dp,ip,qs,lp,cp,pp,Zt,up,eo,hp,to,zn,mp,oo,fp,no,Fn,_p,ro,Da,xt,so,Es,qn,gp,Ms,bp,Ga,S,En,vp,Mn,kp,fr,yp,Tp,wp,Cn,$p,jn,Bp,xp,zp,Cs,Fp,qp,He,js,On,Ep,Mp,Os,Pn,Cp,jp,Ps,Nn,Op,Pp,Ns,An,Np,Ap,D,In,Ip,zt,Lp,As,Sp,Dp,Is,Gp,Wp,Up,ao,Rp,Ls,Hp,Kp,Ss,Ds,Gs,Ws,Vp,Jp,Us,Rs,Hs,Ks,Qp,Xp,Vs,Js,Qs,Xs,Yp,Zp,Ys,Zs,Ln,io,lo,ea,Sn,eu,ta,tu,ou,oa,nu,ru,co,Dn,su,po,au,uo,Gn,du,ho,Wa;return i=new ce({}),R=new ce({}),be=new ce({}),Fo=new ce({}),qo=new Ke({props:{code:`from transformers import BlenderbotTokenizer, BlenderbotForConditionalGeneration
...
Will be ignored`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/v4.20.1/src/transformers/models/blenderbot/tokenization_blenderbot_fast.py#L61",returnDescription:`
<p>list of <a href="../glossary#input-ids">input IDs</a> with the appropriate special tokens.</p>
`,returnType:`
<p><code>List[int]</code></p>
...
elements depending on the configuration (<a
  href="/docs/transformers/v4.20.1/en/model_doc/blenderbot#transformers.BlenderbotConfig"
...
(masked), the loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.20.1/src/transformers/models/blenderbot/modeling_blenderbot.py#L1284",returnDescription:`
<p>A <a
...
Whether or not to return a <a href="/docs/transformers/v4.20.1/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/v4.20.1/src/transformers/models/blenderbot/modeling_blenderbot.py#L1451",returnDescription:`
<p>A <a
...
behaviors between training and evaluation).`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/v4.20.1/src/transformers/models/blenderbot/modeling_tf_blenderbot.py#L1155",returnDescription:`
<p>A <a
...
Labels for computing the masked language modeling loss. Indices should either be in <code>[0, ..., config.vocab_size]</code> or -100 (see <code>input_ids</code> docstring). Tokens with indices set to <code>-100</code> are ignored
(masked), the loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.20.1/src/transformers/models/blenderbot/modeling_tf_blenderbot.py#L1278",returnDescription:`
<p>A <a
...
`}}),ho=new ot({props:{anchor:"transformers.FlaxBlenderbotForConditionalGeneration.decode.example",$$slots:{default:[df]},$$scope:{ctx:z}}}),{c(){p=n("meta"),v=l(),g=n("h1"),h=n("a"),b=n("span"),k(i.$$.fragment),m=l(),F=n("span"),Me=a("Blenderbot"),pe=l(),E=n("p"),fe=n("strong"),te=a("DISCLAIMER:"),Ce=a(" If you see something strange, file a "),oe=n("a"),ne=a("Github Issue"),je=a(" ."),we=l(),G=n("h2"),N=n("a"),_e=n("span"),k(R.$$.fragment),M=l(),j=n("span"),Oe=a("Overview"),J=l(),Q=n("p"),Pe=a("The Blender chatbot model was proposed in "),W=n("a"),Ne=a("Recipes for building an open-domain chatbot"),Ae=a(` Stephen Roller, Emily Dinan, Naman Goyal, Da Ju, Mary Williamson, Yinhan Liu,
Jing Xu, Myle Ott, Kurt Shuster, Eric M. Smith, Y-Lan Boureau, Jason Weston on 30 Apr 2020.`),A=l(),ue=n("p"),re=a("The abstract of the paper is the following:"),$e=l(),he=n("p"),H=n("em"),Ie=a(`Building open-domain chatbots is a challenging area for machine learning research. While prior work has shown that
...
documentation from `),Yn=n("a"),oi=a("PretrainedConfig"),ni=a(" for more information."),ri=l(),k(Mt.$$.fragment),wa=l(),ut=n("h2"),Ct=n("a"),jr=n("span"),k(jo.$$.fragment),si=l(),Or=n("span"),ai=a("BlenderbotTokenizer"),$a=l(),ae=n("div"),k(Oo.$$.fragment),di=l(),Pr=n("p"),ii=a("Construct a Blenderbot tokenizer."),li=l(),jt=n("p"),Nr=n("code"),ci=a("Blenderbot"),pi=a(" is nearly identical to "),Zn=n("a"),ui=a("RobertaTokenizer"),hi=a(` and runs end-to-end tokenization: punctuation splitting
...
adding special tokens. A Blenderbot sequence has the following format:`),Gi=l(),Rr=n("ul"),rr=n("li"),Wi=a("single sequence: "),Hr=n("code"),Ui=a("X </s>"),za=l(),mt=n("h2"),Nt=n("a"),Kr=n("span"),k(Go.$$.fragment),Ri=l(),Vr=n("span"),Hi=a("BlenderbotModel"),Fa=l(),We=n("p"),Ki=a("See "),Jr=n("code"),Vi=a("transformers.BartModel"),Ji=a(" for arguments to "),Qr=n("em"),Qi=a("forward"),Xi=a(" and "),Xr=n("em"),Yi=a("generate"),qa=l(),ye=n("div"),k(Wo.$$.fragment),Zi=l(),Uo=n("p"),el=a(`The bare Blenderbot Model outputting raw hidden-states without any specific head on top.
...
and behavior.`),dl=l(),xe=n("div"),k(Ko.$$.fragment),il=l(),ft=n("p"),ll=a("The "),ar=n("a"),cl=a("BlenderbotModel"),pl=a(" forward method, overrides the "),Yr=n("code"),ul=a("__call__"),hl=a(" special method."),ml=l(),k(At.$$.fragment),fl=l(),k(It.$$.fragment),Ea=l(),_t=n("h2"),Lt=n("a"),Zr=n("span"),k(Vo.$$.fragment),_l=l(),es=n("span"),gl=a("BlenderbotForConditionalGeneration"),Ma=l(),Ue=n("p"),bl=a("See "),dr=n("a"),vl=a("BartForConditionalGeneration"),kl=a(" for arguments to "),ts=n("em"),yl=a("forward"),Tl=a(" and "),os=n("em"),wl=a("generate"),Ca=l(),Te=n("div"),k(Jo.$$.fragment),$l=l(),Qo=n("p"),Bl=a(`The Blenderbot Model with a language modeling head. Can be used for summarization.
This model inherits from `),ir=n("a"),xl=a("PreTrainedModel"),zl=a(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
behavior.`),tc=l(),k(Ht.$$.fragment),oc=l(),Fe=n("div"),k(ln.$$.fragment),nc=l(),yt=n("p"),rc=a("The "),pr=n("a"),sc=a("TFBlenderbotModel"),ac=a(" forward method, overrides the "),is=n("code"),dc=a("__call__"),ic=a(" special method."),lc=l(),k(Kt.$$.fragment),cc=l(),k(Vt.$$.fragment),Aa=l(),Tt=n("h2"),Jt=n("a"),ls=n("span"),k(cn.$$.fragment),pc=l(),cs=n("span"),uc=a("TFBlenderbotForConditionalGeneration"),Ia=l(),le=n("div"),k(pn.$$.fragment),hc=l(),un=n("p"),mc=a(`The BLENDERBOT Model with a language modeling head. Can be used for summarization.
This model inherits from `),ur=n("a"),fc=a("TFPreTrainedModel"),_c=a(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),gc=l(),hn=n("p"),bc=a("This model is also a "),mn=n("a"),vc=a("tf.keras.Model"),kc=a(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),yc=l(),k(Qt.$$.fragment),Tc=l(),X=n("div"),k(fn.$$.fragment),wc=l(),wt=n("p"),$c=a("The "),hr=n("a"),Bc=a("TFBlenderbotForConditionalGeneration"),xc=a(" forward method, overrides the "),ps=n("code"),zc=a("__call__"),Fc=a(" special method."),qc=l(),k(Xt.$$.fragment),Ec=l(),us=n("p"),Mc=a("Conversation example::"),Cc=l(),hs=n("blockquote"),ms=n("blockquote"),fs=n("blockquote"),_s=n("p"),jc=a(`from transformers import BlenderbotTokenizer, TFBlenderbotForConditionalGeneration >>> mname =
...
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),Vc=l(),ws=n("p"),Jc=a("Finally, this model supports inherent JAX features such as:"),Qc=l(),Re=n("ul"),$s=n("li"),Tn=n("a"),Xc=a("Just-In-Time (JIT) compilation"),Yc=l(),Bs=n("li"),wn=n("a"),Zc=a("Automatic Differentiation"),ep=l(),xs=n("li"),$n=n("a"),tp=a("Vectorization"),op=l(),zs=n("li"),Bn=n("a"),np=a("Parallelization"),rp=l(),qe=n("div"),k(xn.$$.fragment),sp=l(),Bt=n("p"),ap=a("The "),Fs=n("code"),dp=a("FlaxBlenderbotPreTrainedModel"),ip=a(" forward method, overrides the "),qs=n("code"),lp=a("__call__"),cp=a(" special method."),pp=l(),k(Zt.$$.fragment),up=l(),k(eo.$$.fragment),hp=l(),to=n("div"),k(zn.$$.fragment),mp=l(),k(oo.$$.fragment),fp=l(),no=n("div"),k(Fn.$$.fragment),_p=l(),k(ro.$$.fragment),Da=l(),xt=n("h2"),so=n("a"),Es=n("span"),k(qn.$$.fragment),gp=l(),Ms=n("span"),bp=a("FlaxBlenderbotForConditionalGeneration"),Ga=l(),S=n("div"),k(En.$$.fragment),vp=l(),Mn=n("p"),kp=a(`The Blenderbot Model with a language modeling head. Can be used for summarization.
...
`),jn=n("a"),Bp=a("flax.nn.Module"),xp=a(` subclass. Use it as a
...
max_length=1024, return_tensors=\u2018np\u2019)`),Zp=l(),Ys=n("blockquote"),Zs=n("blockquote"),Ln=n("blockquote"),io=n("h1"),lo=n("a"),ea=n("span"),k(Sn.$$.fragment),eu=l(),ta=n("span"),tu=a("Generate Reply >>> reply_ids = model.generate(inputs[\u2018input_ids\u2019], num_beams=4, max_length=5,"),ou=l(),oa=n("p"),nu=a(`early_stopping=True).sequences >>> print([tokenizer.decode(g, skip_special_tokens=True,
clean_up_tokenization_spaces=False) for g in reply_ids])`),ru=l(),co=n("div"),k(Dn.$$.fragment),su=l(),k(po.$$.fragment),au=l(),uo=n("div"),k(Gn.$$.fragment),du=l(),k(ho.$$.fragment),this.h()},l(o){const _=Gm('[data-svelte="svelte-1phssyn"]',document.head);p=r(_,"META",{name:!0,content:!0}),_.forEach(t),v=c(o),g=r(o,"H1",{class:!0});var Wn=s(g);h=r(Wn,"A",{id:!0,class:!0,href:!0});var na=s(h);b=r(na,"SPAN",{});var ra=s(b);y(i.$$.fragment,ra),ra.forEach(t),na.forEach(t),m=c(Wn),F=r(Wn,"SPAN",{});var sa=s(F);Me=d(sa,"Blenderbot"),sa.forEach(t),Wn.forEach(t),pe=c(o),E=r(o,"P",{});var mo=s(E);fe=r(mo,"STRONG",{});var aa=s(fe);te=d(aa,"DISCLAIMER:"),aa.forEach(t),Ce=d(mo," If you see something strange, file a "),oe=r(mo,"A",{href:!0,rel:!0});var da=s(oe);ne=d(da,"Github Issue"),da.forEach(t),je=d(mo," ."),mo.forEach(t),we=c(o),G=r(o,"H2",{class:!0});var Un=s(G);N=r(Un,"A",{id:!0,class:!0,href:!0});var ia=s(N);_e=r(ia,"SPAN",{});var la=s(_e);y(R.$$.fragment,la),la.forEach(t),ia.forEach(t),M=c(Un),j=r(Un,"SPAN",{});var ca=s(j);Oe=d(ca,"Overview"),ca.forEach(t),Un.forEach(t),J=c(o),Q=r(o,"P",{});var Rn=s(Q);Pe=d(Rn,"The Blender chatbot model was proposed in "),W=r(Rn,"A",{href:!0,rel:!0});var pa=s(W);Ne=d(pa,"Recipes for building an open-domain chatbot"),pa.forEach(t),Ae=d(Rn,` Stephen Roller, Emily Dinan, Naman Goyal, Da Ju, Mary Williamson, Yinhan Liu,
Jing Xu, Myle Ott, Kurt Shuster, Eric M. Smith, Y-Lan Boureau, Jason Weston on 30 Apr 2020.`),Rn.forEach(t),A=c(o),ue=r(o,"P",{});var ua=s(ue);re=d(ua,"The abstract of the paper is the following:"),ua.forEach(t),$e=c(o),he=r(o,"P",{});var ha=s(he);H=r(ha,"EM",{});var ma=s(H);Ie=d(ma,`Building open-domain chatbots is a challenging area for machine learning research. While prior work has shown that
scaling neural models in the number of parameters and the size of the data they are trained on gives improved results,
we show that other ingredients are important for a high-performing chatbot. Good conversation requires a number of
skills that an expert conversationalist blends in a seamless way: providing engaging talking points and listening to
their partners, and displaying knowledge, empathy and personality appropriately, while maintaining a consistent
...
and code publicly available. Human evaluations show our best models are superior to existing approaches in multi-turn
dialogue in terms of engagingness and humanness measurements. We then discuss the limitations of this work by analyzing
failure cases of our models.`),ma.forEach(t),ha.forEach(t),Be=c(o),C=r(o,"P",{});var Ft=s(C);Le=d(Ft,"This model was contributed by "),U=r(Ft,"A",{href:!0,rel:!0});var fa=s(U);Se=d(fa,"sshleifer"),fa.forEach(t),x=d(Ft,". The authors\u2019 code can be found "),q=r(Ft,"A",{href:!0,rel:!0});var cu=s(q);ge=d(cu,"here"),cu.forEach(t),rt=d(Ft," ."),Ft.forEach(t),Ve=c(o),O=r(o,"H2",{class:!0});var Ua=s(O);me=r(Ua,"A",{id:!0,class:!0,href:!0});var pu=s(me);De=r(pu,"SPAN",{});var uu=s(De);y(be.$$.fragment,uu),uu.forEach(t),pu.forEach(t),K=c(Ua),V=r(Ua,"SPAN",{});var hu=s(V);st=d(hu,"Implementation Notes"),hu.forEach(t),Ua.forEach(t),Je=c(o),I=r(o,"UL",{});var _r=s(I);ve=r(_r,"LI",{});var Ra=s(ve);at=d(Ra,"Blenderbot uses a standard "),se=r(Ra,"A",{href:!0,rel:!0});var mu=s(se);dt=d(mu,"seq2seq model transformer"),mu.forEach(t),Fd=d(Ra," based architecture."),Ra.forEach(t),qd=c(_r),xo=r(_r,"LI",{});var Ha=s(xo);Ed=d(Ha,"Available checkpoints can be found in the "),zo=r(Ha,"A",{href:!0,rel:!0});var fu=s(zo);Md=d(fu,"model hub"),fu.forEach(t),Cd=d(Ha,"."),Ha.forEach(t),jd=c(_r),Ge=r(_r,"LI",{});var fo=s(Ge);Od=d(fo,"This is the "),zr=r(fo,"EM",{});var _u=s(zr);Pd=d(_u,"default"),_u.forEach(t),Nd=d(fo,` Blenderbot model class. However, some smaller checkpoints, such as
`),Fr=r(fo,"CODE",{});var gu=s(Fr);Ad=d(gu,"facebook/blenderbot_small_90M"),gu.forEach(t),Id=d(fo,`, have a different architecture and consequently should be used with
`),Vn=r(fo,"A",{href:!0});var bu=s(Vn);Ld=d(bu,"BlenderbotSmall"),bu.forEach(t),Sd=d(fo,"."),fo.forEach(t),_r.forEach(t),ba=c(o),it=r(o,"H2",{class:!0});var Ka=s(it);qt=r(Ka,"A",{id:!0,class:!0,href:!0});var vu=s(qt);qr=r(vu,"SPAN",{});var ku=s(qr);y(Fo.$$.fragment,ku),ku.forEach(t),vu.forEach(t),Dd=c(Ka),Er=r(Ka,"SPAN",{});var yu=s(Er);Gd=d(yu,"Usage"),yu.forEach(t),Ka.forEach(t),va=c(o),Jn=r(o,"P",{});var Tu=s(Jn);Wd=d(Tu,"Here is an example of model usage:"),Tu.forEach(t),ka=c(o),y(qo.$$.fragment,o),ya=c(o),lt=r(o,"H2",{class:!0});var Va=s(lt);Et=r(Va,"A",{id:!0,class:!0,href:!0});var wu=s(Et);Mr=r(wu,"SPAN",{});var $u=s(Mr);y(Eo.$$.fragment,$u),$u.forEach(t),wu.forEach(t),Ud=c(Va),Cr=r(Va,"SPAN",{});var Bu=s(Cr);Rd=d(Bu,"BlenderbotConfig"),Bu.forEach(t),Va.forEach(t),Ta=c(o),ke=r(o,"DIV",{class:!0});var _o=s(ke);y(Mo.$$.fragment,_o),Hd=c(_o),ct=r(_o,"P",{});var gr=s(ct);Kd=d(gr,"This is the configuration class to store the configuration of a "),Qn=r(gr,"A",{href:!0});var xu=s(Qn);Vd=d(xu,"BlenderbotModel"),xu.forEach(t),Jd=d(gr,`. It is used to instantiate an
Blenderbot model according to the specified arguments, defining the model architecture. Instantiating a
configuration with the defaults will yield a similar configuration to that of the Blenderbot
`),Co=r(gr,"A",{href:!0,rel:!0});var zu=s(Co);Qd=d(zu,"facebook/blenderbot-3B"),zu.forEach(t),Xd=d(gr," architecture."),gr.forEach(t),Yd=c(_o),pt=r(_o,"P",{});var br=s(pt);Zd=d(br,"Configuration objects inherit from "),Xn=r(br,"A",{href:!0});var Fu=s(Xn);ei=d(Fu,"PretrainedConfig"),Fu.forEach(t),ti=d(br,` and can be used to control the model outputs. Read the
documentation from `),Yn=r(br,"A",{href:!0});var qu=s(Yn);oi=d(qu,"PretrainedConfig"),qu.forEach(t),ni=d(br," for more information."),br.forEach(t),ri=c(_o),y(Mt.$$.fragment,_o),_o.forEach(t),wa=c(o),ut=r(o,"H2",{class:!0});var Ja=s(ut);Ct=r(Ja,"A",{id:!0,class:!0,href:!0});var Eu=s(Ct);jr=r(Eu,"SPAN",{});var Mu=s(jr);y(jo.$$.fragment,Mu),Mu.forEach(t),Eu.forEach(t),si=c(Ja),Or=r(Ja,"SPAN",{});var Cu=s(Or);ai=d(Cu,"BlenderbotTokenizer"),Cu.forEach(t),Ja.forEach(t),$a=c(o),ae=r(o,"DIV",{class:!0});var Ye=s(ae);y(Oo.$$.fragment,Ye),di=c(Ye),Pr=r(Ye,"P",{});var ju=s(Pr);ii=d(ju,"Construct a Blenderbot tokenizer."),ju.forEach(t),li=c(Ye),jt=r(Ye,"P",{});var _a=s(jt);Nr=r(_a,"CODE",{});var Ou=s(Nr);ci=d(Ou,"Blenderbot"),Ou.forEach(t),pi=d(_a," is nearly identical to "),Zn=r(_a,"A",{href:!0});var Pu=s(Zn);ui=d(Pu,"RobertaTokenizer"),Pu.forEach(t),hi=d(_a,` and runs end-to-end tokenization: punctuation splitting
and wordpiece. The only difference is that it doesn\u2019t add BOS token to the beginning of sequences.`),_a.forEach(t),mi=c(Ye),Po=r(Ye,"P",{});var Qa=s(Po);fi=d(Qa,"Refer to superclass "),er=r(Qa,"A",{href:!0});var Nu=s(er);_i=d(Nu,"RobertaTokenizer"),Nu.forEach(t),gi=d(Qa," for usage examples and documentation concerning parameters."),Qa.forEach(t),bi=c(Ye),Qe=r(Ye,"DIV",{class:!0});var vr=s(Qe);y(No.$$.fragment,vr),vi=c(vr),Ar=r(vr,"P",{});var Au=s(Ar);ki=d(Au,`Build model inputs from a sequence or a pair of sequence for sequence classification tasks by concatenating and
adding special tokens. A Blenderbot sequence has the following format:`),Au.forEach(t),yi=c(vr),Ir=r(vr,"UL",{});var Iu=s(Ir);tr=r(Iu,"LI",{});var iu=s(tr);Ti=d(iu,"single sequence: "),Lr=r(iu,"CODE",{});var Lu=s(Lr);wi=d(Lu,"X </s>"),Lu.forEach(t),iu.forEach(t),Iu.forEach(t),vr.forEach(t),Ye.forEach(t),Ba=c(o),ht=r(o,"H2",{class:!0});var Xa=s(ht);Ot=r(Xa,"A",{id:!0,class:!0,href:!0});var Su=s(Ot);Sr=r(Su,"SPAN",{});var Du=s(Sr);y(Ao.$$.fragment,Du),Du.forEach(t),Su.forEach(t),$i=c(Xa),Dr=r(Xa,"SPAN",{});var Gu=s(Dr);Bi=d(Gu,"BlenderbotTokenizerFast"),Gu.forEach(t),Xa.forEach(t),xa=c(o),de=r(o,"DIV",{class:!0});var Ze=s(de);y(Io.$$.fragment,Ze),xi=c(Ze),Lo=r(Ze,"P",{});var Ya=s(Lo);zi=d(Ya,"Construct a \u201Cfast\u201D Blenderbot tokenizer (backed by HuggingFace\u2019s "),Gr=r(Ya,"EM",{});var Wu=s(Gr);Fi=d(Wu,"tokenizers"),Wu.forEach(t),qi=d(Ya," library)."),Ya.forEach(t),Ei=c(Ze),Pt=r(Ze,"P",{});var ga=s(Pt);Wr=r(ga,"CODE",{});var Uu=s(Wr);Mi=d(Uu,"BlenderbotFast"),Uu.forEach(t),Ci=d(ga," is nearly identical to "),or=r(ga,"A",{href:!0});var Ru=s(or);ji=d(Ru,"RobertaTokenizerFast"),Ru.forEach(t),Oi=d(ga,` and runs end-to-end tokenization: punctuation
splitting and wordpiece. The only difference is that it doesn\u2019t add BOS token to the beginning of sequences.`),ga.forEach(t),Pi=c(Ze),So=r(Ze,"P",{});var Za=s(So);Ni=d(Za,"Refer to superclass "),nr=r(Za,"A",{href:!0});var Hu=s(nr);Ai=d(Hu,"RobertaTokenizerFast"),Hu.forEach(t),Ii=d(Za," for usage examples and documentation concerning parameters."),Za.forEach(t),Li=c(Ze),Xe=r(Ze,"DIV",{class:!0});var kr=s(Xe);y(Do.$$.fragment,kr),Si=c(kr),Ur=r(kr,"P",{});var Ku=s(Ur);Di=d(Ku,`Build model inputs from a sequence or a pair of sequence for sequence classification tasks by concatenating and
adding special tokens. A Blenderbot sequence has the following format:`),Ku.forEach(t),Gi=c(kr),Rr=r(kr,"UL",{});var Vu=s(Rr);rr=r(Vu,"LI",{});var lu=s(rr);Wi=d(lu,"single sequence: "),Hr=r(lu,"CODE",{});var Ju=s(Hr);Ui=d(Ju,"X </s>"),Ju.forEach(t),lu.forEach(t),Vu.forEach(t),kr.forEach(t),Ze.forEach(t),za=c(o),mt=r(o,"H2",{class:!0});var ed=s(mt);Nt=r(ed,"A",{id:!0,class:!0,href:!0});var Qu=s(Nt);Kr=r(Qu,"SPAN",{});var Xu=s(Kr);y(Go.$$.fragment,Xu),Xu.forEach(t),Qu.forEach(t),Ri=c(ed),Vr=r(ed,"SPAN",{});var Yu=s(Vr);Hi=d(Yu,"BlenderbotModel"),Yu.forEach(t),ed.forEach(t),Fa=c(o),We=r(o,"P",{});var Hn=s(We);Ki=d(Hn,"See "),Jr=r(Hn,"CODE",{});var Zu=s(Jr);Vi=d(Zu,"transformers.BartModel"),Zu.forEach(t),Ji=d(Hn," for arguments to "),Qr=r(Hn,"EM",{});var eh=s(Qr);Qi=d(eh,"forward"),eh.forEach(t),Xi=d(Hn," and "),Xr=r(Hn,"EM",{});var th=s(Xr);Yi=d(th,"generate"),th.forEach(t),Hn.forEach(t),qa=c(o),ye=r(o,"DIV",{class:!0});var go=s(ye);y(Wo.$$.fragment,go),Zi=c(go),Uo=r(go,"P",{});var td=s(Uo);el=d(td,`The bare Blenderbot Model outputting raw hidden-states without any specific head on top.
This model inherits from `),sr=r(td,"A",{href:!0});var oh=s(sr);tl=d(oh,"PreTrainedModel"),oh.forEach(t),ol=d(td,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),td.forEach(t),nl=c(go),Ro=r(go,"P",{});var od=s(Ro);rl=d(od,"This model is also a PyTorch "),Ho=r(od,"A",{href:!0,rel:!0});var nh=s(Ho);sl=d(nh,"torch.nn.Module"),nh.forEach(t),al=d(od,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),od.forEach(t),dl=c(go),xe=r(go,"DIV",{class:!0});var bo=s(xe);y(Ko.$$.fragment,bo),il=c(bo),ft=r(bo,"P",{});var yr=s(ft);ll=d(yr,"The "),ar=r(yr,"A",{href:!0});var rh=s(ar);cl=d(rh,"BlenderbotModel"),rh.forEach(t),pl=d(yr," forward method, overrides the "),Yr=r(yr,"CODE",{});var sh=s(Yr);ul=d(sh,"__call__"),sh.forEach(t),hl=d(yr," special method."),yr.forEach(t),ml=c(bo),y(At.$$.fragment,bo),fl=c(bo),y(It.$$.fragment,bo),bo.forEach(t),go.forEach(t),Ea=c(o),_t=r(o,"H2",{class:!0});var nd=s(_t);Lt=r(nd,"A",{id:!0,class:!0,href:!0});var ah=s(Lt);Zr=r(ah,"SPAN",{});var dh=s(Zr);y(Vo.$$.fragment,dh),dh.forEach(t),ah.forEach(t),_l=c(nd),es=r(nd,"SPAN",{});var ih=s(es);gl=d(ih,"BlenderbotForConditionalGeneration"),ih.forEach(t),nd.forEach(t),Ma=c(o),Ue=r(o,"P",{});var Kn=s(Ue);bl=d(Kn,"See "),dr=r(Kn,"A",{href:!0});var lh=s(dr);vl=d(lh,"BartForConditionalGeneration"),lh.forEach(t),kl=d(Kn," for arguments to "),ts=r(Kn,"EM",{});var ch=s(ts);yl=d(ch,"forward"),ch.forEach(t),Tl=d(Kn," and "),os=r(Kn,"EM",{});var ph=s(os);wl=d(ph,"generate"),ph.forEach(t),Kn.forEach(t),Ca=c(o),Te=r(o,"DIV",{class:!0});var vo=s(Te);y(Jo.$$.fragment,vo),$l=c(vo),Qo=r(vo,"P",{});var rd=s(Qo);Bl=d(rd,`The Blenderbot Model with a language modeling head. Can be used for summarization.
This model inherits from `),ir=r(rd,"A",{href:!0});var uh=s(ir);xl=d(uh,"PreTrainedModel"),uh.forEach(t),zl=d(rd,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),rd.forEach(t),Fl=c(vo),Xo=r(vo,"P",{});var sd=s(Xo);ql=d(sd,"This model is also a PyTorch "),Yo=r(sd,"A",{href:!0,rel:!0});var hh=s(Yo);El=d(hh,"torch.nn.Module"),hh.forEach(t),Ml=d(sd,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),sd.forEach(t),Cl=c(vo),ze=r(vo,"DIV",{class:!0});var ko=s(ze);y(Zo.$$.fragment,ko),jl=c(ko),gt=r(ko,"P",{});var Tr=s(gt);Ol=d(Tr,"The "),lr=r(Tr,"A",{href:!0});var mh=s(lr);Pl=d(mh,"BlenderbotForConditionalGeneration"),mh.forEach(t),Nl=d(Tr," forward method, overrides the "),ns=r(Tr,"CODE",{});var fh=s(ns);Al=d(fh,"__call__"),fh.forEach(t),Il=d(Tr," special method."),Tr.forEach(t),Ll=c(ko),y(St.$$.fragment,ko),Sl=c(ko),y(Dt.$$.fragment,ko),ko.forEach(t),vo.forEach(t),ja=c(o),bt=r(o,"H2",{class:!0});var ad=s(bt);Gt=r(ad,"A",{id:!0,class:!0,href:!0});var _h=s(Gt);rs=r(_h,"SPAN",{});var gh=s(rs);y(en.$$.fragment,gh),gh.forEach(t),_h.forEach(t),Dl=c(ad),ss=r(ad,"SPAN",{});var bh=s(ss);Gl=d(bh,"BlenderbotForCausalLM"),bh.forEach(t),ad.forEach(t),Oa=c(o),vt=r(o,"DIV",{class:!0});var dd=s(vt);y(tn.$$.fragment,dd),Wl=c(dd),Wt=r(dd,"DIV",{class:!0});var id=s(Wt);y(on.$$.fragment,id),Ul=c(id),y(Ut.$$.fragment,id),id.forEach(t),dd.forEach(t),Pa=c(o),kt=r(o,"H2",{class:!0});var ld=s(kt);Rt=r(ld,"A",{id:!0,class:!0,href:!0});var vh=s(Rt);as=r(vh,"SPAN",{});var kh=s(as);y(nn.$$.fragment,kh),kh.forEach(t),vh.forEach(t),Rl=c(ld),ds=r(ld,"SPAN",{});var yh=s(ds);Hl=d(yh,"TFBlenderbotModel"),yh.forEach(t),ld.forEach(t),Na=c(o),ie=r(o,"DIV",{class:!0});var et=s(ie);y(rn.$$.fragment,et),Kl=c(et),sn=r(et,"P",{});var cd=s(sn);Vl=d(cd,`The bare BLENDERBOT Model outputting raw hidden-states without any specific head on top.
This model inherits from `),cr=r(cd,"A",{href:!0});var Th=s(cr);Jl=d(Th,"TFPreTrainedModel"),Th.forEach(t),Ql=d(cd,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),cd.forEach(t),Xl=c(et),an=r(et,"P",{});var pd=s(an);Yl=d(pd,"This model is also a "),dn=r(pd,"A",{href:!0,rel:!0});var wh=s(dn);Zl=d(wh,"tf.keras.Model"),wh.forEach(t),ec=d(pd,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),pd.forEach(t),tc=c(et),y(Ht.$$.fragment,et),oc=c(et),Fe=r(et,"DIV",{class:!0});var yo=s(Fe);y(ln.$$.fragment,yo),nc=c(yo),yt=r(yo,"P",{});var wr=s(yt);rc=d(wr,"The "),pr=r(wr,"A",{href:!0});var $h=s(pr);sc=d($h,"TFBlenderbotModel"),$h.forEach(t),ac=d(wr," forward method, overrides the "),is=r(wr,"CODE",{});var Bh=s(is);dc=d(Bh,"__call__"),Bh.forEach(t),ic=d(wr," special method."),wr.forEach(t),lc=c(yo),y(Kt.$$.fragment,yo),cc=c(yo),y(Vt.$$.fragment,yo),yo.forEach(t),et.forEach(t),Aa=c(o),Tt=r(o,"H2",{class:!0});var ud=s(Tt);Jt=r(ud,"A",{id:!0,class:!0,href:!0});var xh=s(Jt);ls=r(xh,"SPAN",{});var zh=s(ls);y(cn.$$.fragment,zh),zh.forEach(t),xh.forEach(t),pc=c(ud),cs=r(ud,"SPAN",{});var Fh=s(cs);uc=d(Fh,"TFBlenderbotForConditionalGeneration"),Fh.forEach(t),ud.forEach(t),Ia=c(o),le=r(o,"DIV",{class:!0});var tt=s(le);y(pn.$$.fragment,tt),hc=c(tt),un=r(tt,"P",{});var hd=s(un);mc=d(hd,`The BLENDERBOT Model with a language modeling head. Can be used for summarization.
This model inherits from `),ur=r(hd,"A",{href:!0});var qh=s(ur);fc=d(qh,"TFPreTrainedModel"),qh.forEach(t),_c=d(hd,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),hd.forEach(t),gc=c(tt),hn=r(tt,"P",{});var md=s(hn);bc=d(md,"This model is also a "),mn=r(md,"A",{href:!0,rel:!0});var Eh=s(mn);vc=d(Eh,"tf.keras.Model"),Eh.forEach(t),kc=d(md,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),md.forEach(t),yc=c(tt),y(Qt.$$.fragment,tt),Tc=c(tt),X=r(tt,"DIV",{class:!0});var Ee=s(X);y(fn.$$.fragment,Ee),wc=c(Ee),wt=r(Ee,"P",{});var $r=s(wt);$c=d($r,"The "),hr=r($r,"A",{href:!0});var Mh=s(hr);Bc=d(Mh,"TFBlenderbotForConditionalGeneration"),Mh.forEach(t),xc=d($r," forward method, overrides the "),ps=r($r,"CODE",{});var Ch=s(ps);zc=d(Ch,"__call__"),Ch.forEach(t),Fc=d($r," special method."),$r.forEach(t),qc=c(Ee),y(Xt.$$.fragment,Ee),Ec=c(Ee),us=r(Ee,"P",{});var jh=s(us);Mc=d(jh,"Conversation example::"),jh.forEach(t),Cc=c(Ee),hs=r(Ee,"BLOCKQUOTE",{});var Oh=s(hs);ms=r(Oh,"BLOCKQUOTE",{});var Ph=s(ms);fs=r(Ph,"BLOCKQUOTE",{});var Nh=s(fs);_s=r(Nh,"P",{});var Ah=s(_s);jc=d(Ah,`from transformers import BlenderbotTokenizer, TFBlenderbotForConditionalGeneration >>> mname =
\u2018facebook/blenderbot-400M-distill\u2019 >>> model = TFBlenderbotForConditionalGeneration.from_pretrained(mname) >>>
tokenizer = BlenderbotTokenizer.from_pretrained(mname) >>> UTTERANCE = \u201CMy friends are cool but they eat too
many carbs.\u201D >>> print(\u201CHuman: \u201D, UTTERANCE) >>> inputs = tokenizer([UTTERANCE], return_tensors=\u2018tf\u2019) >>>
reply_ids = model.generate(**inputs) >>> print(\u201CBot: \u201D, tokenizer.batch_decode(reply_ids,
skip_special_tokens=True)[0])`),Ah.forEach(t),Nh.forEach(t),Ph.forEach(t),Oh.forEach(t),Oc=c(Ee),gs=r(Ee,"BLOCKQUOTE",{});var Ih=s(gs);bs=r(Ih,"BLOCKQUOTE",{});var Lh=s(bs);vs=r(Lh,"BLOCKQUOTE",{});var Sh=s(vs);_n=r(Sh,"P",{});var fd=s(_n);Pc=d(fd,`REPLY = \u201CI\u2019m not sure\u201D >>> print(\u201CHuman: \u201D, REPLY) >>> NEXT_UTTERANCE = ( \u2026 \u201CMy friends are cool but they
eat too many carbs.</s> `),ks=r(fd,"S",{});var Dh=s(ks);Nc=d(Dh,`That\u2019s unfortunate. \u201D \u2026 \u201CAre they trying to lose weight or are they just trying to
be healthier?`),Dh.forEach(t),Ac=d(fd,` \u201D \u2026 \u201D<s> I\u2019m not sure.\u201D \u2026 ) >>> inputs = tokenizer([NEXT_UTTERANCE], return_tensors=\u2018tf\u2019)
next_reply_ids = model.generate(**inputs) >>> print(\u201CBot: \u201D, tokenizer.batch_decode(next_reply_ids,
skip_special_tokens=True)[0])`),fd.forEach(t),Sh.forEach(t),Lh.forEach(t),Ih.forEach(t),Ee.forEach(t),tt.forEach(t),La=c(o),$t=r(o,"H2",{class:!0});var _d=s($t);Yt=r(_d,"A",{id:!0,class:!0,href:!0});var Gh=s(Yt);ys=r(Gh,"SPAN",{});var Wh=s(ys);y(gn.$$.fragment,Wh),Wh.forEach(t),Gh.forEach(t),Ic=c(_d),Ts=r(_d,"SPAN",{});var Uh=s(Ts);Lc=d(Uh,"FlaxBlenderbotModel"),Uh.forEach(t),_d.forEach(t),Sa=c(o),L=r(o,"DIV",{class:!0});var Y=s(L);y(bn.$$.fragment,Y),Sc=c(Y),vn=r(Y,"P",{});var gd=s(vn);Dc=d(gd,`The bare MBart Model transformer outputting raw hidden-states without any specific head on top.
This model inherits from `),mr=r(gd,"A",{href:!0});var Rh=s(mr);Gc=d(Rh,"FlaxPreTrainedModel"),Rh.forEach(t),Wc=d(gd,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),gd.forEach(t),Uc=c(Y),kn=r(Y,"P",{});var bd=s(kn);Rc=d(bd,`This model is also a Flax Linen
`),yn=r(bd,"A",{href:!0,rel:!0});var Hh=s(yn);Hc=d(Hh,"flax.nn.Module"),Hh.forEach(t),Kc=d(bd,` subclass. Use it as a
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),bd.forEach(t),Vc=c(Y),ws=r(Y,"P",{});var Kh=s(ws);Jc=d(Kh,"Finally, this model supports inherent JAX features such as:"),Kh.forEach(t),Qc=c(Y),Re=r(Y,"UL",{});var To=s(Re);$s=r(To,"LI",{});var Vh=s($s);Tn=r(Vh,"A",{href:!0,rel:!0});var Jh=s(Tn);Xc=d(Jh,"Just-In-Time (JIT) compilation"),Jh.forEach(t),Vh.forEach(t),Yc=c(To),Bs=r(To,"LI",{});var Qh=s(Bs);wn=r(Qh,"A",{href:!0,rel:!0});var Xh=s(wn);Zc=d(Xh,"Automatic Differentiation"),Xh.forEach(t),Qh.forEach(t),ep=c(To),xs=r(To,"LI",{});var Yh=s(xs);$n=r(Yh,"A",{href:!0,rel:!0});var Zh=s($n);tp=d(Zh,"Vectorization"),Zh.forEach(t),Yh.forEach(t),op=c(To),zs=r(To,"LI",{});var em=s(zs);Bn=r(em,"A",{href:!0,rel:!0});var tm=s(Bn);np=d(tm,"Parallelization"),tm.forEach(t),em.forEach(t),To.forEach(t),rp=c(Y),qe=r(Y,"DIV",{class:!0});var wo=s(qe);y(xn.$$.fragment,wo),sp=c(wo),Bt=r(wo,"P",{});var Br=s(Bt);ap=d(Br,"The "),Fs=r(Br,"CODE",{});var om=s(Fs);dp=d(om,"FlaxBlenderbotPreTrainedModel"),om.forEach(t),ip=d(Br," forward method, overrides the "),qs=r(Br,"CODE",{});var nm=s(qs);lp=d(nm,"__call__"),nm.forEach(t),cp=d(Br," special method."),Br.forEach(t),pp=c(wo),y(Zt.$$.fragment,wo),up=c(wo),y(eo.$$.fragment,wo),wo.forEach(t),hp=c(Y),to=r(Y,"DIV",{class:!0});var vd=s(to);y(zn.$$.fragment,vd),mp=c(vd),y(oo.$$.fragment,vd),vd.forEach(t),fp=c(Y),no=r(Y,"DIV",{class:!0});var kd=s(no);y(Fn.$$.fragment,kd),_p=c(kd),y(ro.$$.fragment,kd),kd.forEach(t),Y.forEach(t),Da=c(o),xt=r(o,"H2",{class:!0});var yd=s(xt);so=r(yd,"A",{id:!0,class:!0,href:!0});var rm=s(so);Es=r(rm,"SPAN",{});var sm=s(Es);y(qn.$$.fragment,sm),sm.forEach(t),rm.forEach(t),gp=c(yd),Ms=r(yd,"SPAN",{});var am=s(Ms);bp=d(am,"FlaxBlenderbotForConditionalGeneration"),am.forEach(t),yd.forEach(t),Ga=c(o),S=r(o,"DIV",{class:!0});var Z=s(S);y(En.$$.fragment,Z),vp=c(Z),Mn=r(Z,"P",{});var Td=s(Mn);kp=d(Td,`The Blenderbot Model with a language modeling head. Can be used for summarization.
...
`),jn=r(wd,"A",{href:!0,rel:!0});var im=s(jn);Bp=d(im,"flax.nn.Module"),im.forEach(t),xp=d(wd,` subclass. Use it as a
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),wd.forEach(t),zp=c(Z),Cs=r(Z,"P",{});var lm=s(Cs);Fp=d(lm,"Finally, this model supports inherent JAX features such as:"),lm.forEach(t),qp=c(Z),He=r(Z,"UL",{});var $o=s(He);js=r($o,"LI",{});var cm=s(js);On=r(cm,"A",{href:!0,rel:!0});var pm=s(On);Ep=d(pm,"Just-In-Time (JIT) compilation"),pm.forEach(t),cm.forEach(t),Mp=c($o),Os=r($o,"LI",{});var um=s(Os);Pn=r(um,"A",{href:!0,rel:!0});var hm=s(Pn);Cp=d(hm,"Automatic Differentiation"),hm.forEach(t),um.forEach(t),jp=c($o),Ps=r($o,"LI",{});var mm=s(Ps);Nn=r(mm,"A",{href:!0,rel:!0});var fm=s(Nn);Op=d(fm,"Vectorization"),fm.forEach(t),mm.forEach(t),Pp=c($o),Ns=r($o,"LI",{});var _m=s(Ns);An=r(_m,"A",{href:!0,rel:!0});var gm=s(An);Np=d(gm,"Parallelization"),gm.forEach(t),_m.forEach(t),$o.forEach(t),Ap=c(Z),D=r(Z,"DIV",{class:!0});var ee=s(D);y(In.$$.fragment,ee),Ip=c(ee),zt=r(ee,"P",{});var xr=s(zt);Lp=d(xr,"The "),As=r(xr,"CODE",{});var bm=s(As);Sp=d(bm,"FlaxBlenderbotPreTrainedModel"),bm.forEach(t),Dp=d(xr," forward method, overrides the "),Is=r(xr,"CODE",{});var vm=s(Is);Gp=d(vm,"__call__"),vm.forEach(t),Wp=d(xr," special method."),xr.forEach(t),Up=c(ee),y(ao.$$.fragment,ee),Rp=c(ee),Ls=r(ee,"P",{});var km=s(Ls);Hp=d(km,"Conversation example::"),km.forEach(t),Kp=c(ee),Ss=r(ee,"BLOCKQUOTE",{});var ym=s(Ss);Ds=r(ym,"BLOCKQUOTE",{});var Tm=s(Ds);Gs=r(Tm,"BLOCKQUOTE",{});var wm=s(Gs);Ws=r(wm,"P",{});var $m=s(Ws);Vp=d($m,"from transformers import BlenderbotTokenizer, FlaxBlenderbotForConditionalGeneration, BlenderbotConfig"),$m.forEach(t),wm.forEach(t),Tm.forEach(t),ym.forEach(t),Jp=c(ee),Us=r(ee,"BLOCKQUOTE",{});var Bm=s(Us);Rs=r(Bm,"BLOCKQUOTE",{});var xm=s(Rs);Hs=r(xm,"BLOCKQUOTE",{});var zm=s(Hs);Ks=r(zm,"P",{});var Fm=s(Ks);Qp=d(Fm,`model = FlaxBlenderbotForConditionalGeneration.from_pretrained(\u2018facebook/blenderbot-400M-distill\u2019) >>>
tokenizer = BlenderbotTokenizer.from_pretrained(\u2018facebook/blenderbot-400M-distill\u2019)`),Fm.forEach(t),zm.forEach(t),xm.forEach(t),Bm.forEach(t),Xp=c(ee),Vs=r(ee,"BLOCKQUOTE",{});var qm=s(Vs);Js=r(qm,"BLOCKQUOTE",{});var Em=s(Js);Qs=r(Em,"BLOCKQUOTE",{});var Mm=s(Qs);Xs=r(Mm,"P",{});var Cm=s(Xs);Yp=d(Cm,`UTTERANCE = \u201CMy friends are cool but they eat too many carbs.\u201D >>> inputs = tokenizer([UTTERANCE],
max_length=1024, return_tensors=\u2018np\u2019)`),Cm.forEach(t),Mm.forEach(t),Em.forEach(t),qm.forEach(t),Zp=c(ee),Ys=r(ee,"BLOCKQUOTE",{});var jm=s(Ys);Zs=r(jm,"BLOCKQUOTE",{});var Om=s(Zs);Ln=r(Om,"BLOCKQUOTE",{});var $d=s(Ln);io=r($d,"H1",{class:!0});var Bd=s(io);lo=r(Bd,"A",{id:!0,class:!0,href:!0});var Pm=s(lo);ea=r(Pm,"SPAN",{});var Nm=s(ea);y(Sn.$$.fragment,Nm),Nm.forEach(t),Pm.forEach(t),eu=c(Bd),ta=r(Bd,"SPAN",{});var Am=s(ta);tu=d(Am,"Generate Reply >>> reply_ids = model.generate(inputs[\u2018input_ids\u2019], num_beams=4, max_length=5,"),Am.forEach(t),Bd.forEach(t),ou=c($d),oa=r($d,"P",{});var Im=s(oa);nu=d(Im,`early_stopping=True).sequences >>> print([tokenizer.decode(g, skip_special_tokens=True,
clean_up_tokenization_spaces=False) for g in reply_ids])`),Im.forEach(t),$d.forEach(t),Om.forEach(t),jm.forEach(t),ee.forEach(t),ru=c(Z),co=r(Z,"DIV",{class:!0});var xd=s(co);y(Dn.$$.fragment,xd),su=c(xd),y(po.$$.fragment,xd),xd.forEach(t),au=c(Z),uo=r(Z,"DIV",{class:!0});var zd=s(uo);y(Gn.$$.fragment,zd),du=c(zd),y(ho.$$.fragment,zd),zd.forEach(t),Z.forEach(t),this.h()},h(){u(p,"name","hf:doc:metadata"),u(p,"content",JSON.stringify(cf)),u(h,"id","blenderbot"),u(h,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),u(h,"href","#blenderbot"),u(g,"class","relative group"),u(oe,"href","https://github.com/huggingface/transformers/issues/new?assignees=&labels=&template=bug-report.md&title"),u(oe,"rel","nofollow"),u(N,"id","overview"),u(N,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),u(N,"href","#overview"),u(G,"class","relative group"),u(W,"href","https://arxiv.org/pdf/2004.13637.pdf"),u(W,"rel","nofollow"),u(U,"href","https://huggingface.co/sshleifer"),u(U,"rel","nofollow"),u(q,"href","https://github.com/facebookresearch/ParlAI"),u(q,"rel","nofollow"),u(me,"id","implementation-notes"),u(me,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),u(me,"href","#implementation-notes"),u(O,"class","relative group"),u(se,"href","https://arxiv.org/pdf/1706.03762.pdf"),u(se,"rel","nofollow"),u(zo,"href","https://huggingface.co/models?search=blenderbot"),u(zo,"rel","nofollow"),u(Vn,"href","blenderbot-small"),u(qt,"id","usage"),u(qt,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),u(qt,"href","#usage"),u(it,"class","relative group"),u(Et,"id","transformers.BlenderbotConfig"),u(Et,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),u(Et,"href","#transformers.BlenderbotConfig"),u(lt,"class","relative group"),u(Qn,"href","/docs/transformers/v4.20.1/en/model_doc/blenderbot#transformers.BlenderbotModel"),u(Co,"href","https://huggingface.co/facebook/blenderbot-3B"),u(Co,"rel","nofollow"),u(Xn,"href","/docs/transformers/v4.20.1/en/main_classes/configuration#transformers.PretrainedConfig"),u(Yn,"href","/docs/transformers/v4.20.1/en/main_classes/configuration#transformers.PretrainedConfig"),u(ke,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),u(Ct,"id","transformers.BlenderbotTokenizer"),u(Ct,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),u(Ct,"href","#transformers.BlenderbotTokenizer"),u(ut,"class","relative group"),u(Zn,"href","/docs/transformers/v4.20.1/en/model_doc/roberta#transformers.RobertaTokenizer"),u(er,"href","/docs/transformers/v4.20.1/en/model_doc/roberta#transformers.RobertaTokenizer"),u(Qe,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),u(ae,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),u(Ot,"id","transformers.BlenderbotTokenizerFast"),u(Ot,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),u(Ot,"href","#transformers.BlenderbotTokenizerFast"),u(ht,"class","relative group"),u(or,"href","/docs/transformers/v4.20.1/en/model_doc/roberta#transformers.RobertaTokenizerFast"),u(nr,"href","/docs/transformers/v4.20.1/en/model_doc/roberta#transformers.RobertaTokenizerFast"),u(Xe,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),u(de,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),u(Nt,"id","transformers.BlenderbotModel"),u(Nt,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),u(Nt,"href","#transformers.BlenderbotModel"),u(mt,"class","relative group"),u(sr,"href","/docs/transformers/v4.20.1/en/main_classes/model#transformers.PreTrainedModel"),u(Ho,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),u(Ho,"rel","nofollow"),u(ar,"href","/docs/transformers/v4.20.1/en/model_doc/blenderbot#transformers.BlenderbotModel"),u(xe,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),u(ye,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),u(Lt,"id","transformers.BlenderbotForConditionalGeneration"),u(Lt,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),u(Lt,"href","#transformers.BlenderbotForConditionalGeneration"),u(_t,"class","relative group"),u(dr,"href","/docs/transformers/v4.20.1/en/model_doc/bart#transformers.BartForConditionalGeneration"),u(ir,"href","/docs/transformers/v4.20.1/en/main_classes/model#transformers.PreTrainedModel"),u(Yo,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),u(Yo,"rel","nofollow"),u(lr,"href","/docs/transformers/v4.20.1/en/model_doc/blenderbot#transformers.BlenderbotForConditionalGeneration"),u(ze,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),u(Te,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),u(Gt,"id","transformers.BlenderbotForCausalLM"),u(Gt,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),u(Gt,"href","#transformers.BlenderbotForCausalLM"),u(bt,"class","relative group"),u(Wt,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),u(vt,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),u(Rt,"id","transformers.TFBlenderbotModel"),u(Rt,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),u(Rt,"href","#transformers.TFBlenderbotModel"),u(kt,"class","relative group"),u(cr,"href","/docs/transformers/v4.20.1/en/main_classes/model#transformers.TFPreTrainedModel"),u(dn,"href","https://www.tensorflow.org/api_docs/python/tf/keras/Model"),u(dn,"rel","nofollow"),u(pr,"href","/docs/transformers/v4.20.1/en/model_doc/blenderbot#transformers.TFBlenderbotModel"),u(Fe,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),u(ie,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),u(Jt,"id","transformers.TFBlenderbotForConditionalGeneration"),u(Jt,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),u(Jt,"href","#transformers.TFBlenderbotForConditionalGeneration"),u(Tt,"class","relative group"),u(ur,"href","/docs/transformers/v4.20.1/en/main_classes/model#transformers.TFPreTrainedModel"),u(mn,"href","https://www.tensorflow.org/api_docs/python/tf/keras/Model"),u(mn,"rel","nofollow"),u(hr,"href","/docs/transformers/v4.20.1/en/model_doc/blenderbot#transformers.TFBlenderbotForConditionalGeneration"),u(X,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),u(le,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),u(Yt,"id","transformers.FlaxBlenderbotModel"),u(Yt,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),u(Yt,"href","#transformers.FlaxBlenderbotModel"),u($t,"class","relative group"),u(mr,"href","/docs/transformers/v4.20.1/en/main_classes/model#transformers.FlaxPreTrainedModel"),u(yn,"href","https://flax.readthedocs.io/en/latest/_autosummary/flax.nn.module.html"),u(yn,"rel","nofollow"),u(Tn,"href","https://jax.readthedocs.io/en/latest/jax.html#just-in-time-compilation-jit"),u(Tn,"rel","nofollow"),u(wn,"href","https://jax.readthedocs.io/en/latest/jax.html#automatic-differentiation"),u(wn,"rel","nofollow"),u($n,"href","https://jax.readthedocs.io/en/latest/jax.html#vectorization-vmap"),u($n,"rel","nofollow"),u(Bn,"href","https://jax.readthedocs.io/en/latest/jax.html#parallelization-pmap"),u(Bn,"rel","nofollow"),u(qe,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),u(to,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),u(no,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),u(L,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),u(so,"id","transformers.FlaxBlenderbotForConditionalGeneration"),u(so,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),u(so,"href","#transformers.FlaxBlenderbotForConditionalGeneration"),u(xt,"class","relative group"),u(fr,"href","/docs/transformers/v4.20.1/en/main_classes/model#transformers.FlaxPreTrainedModel"),u(jn,"href","https://flax.readthedocs.io/en/latest/_autosummary/flax.nn.module.html"),u(jn,"rel","nofollow"),u(On,"href","https://jax.readthedocs.io/en/latest/jax.html#just-in-time-compilation-jit"),u(On,"rel","nofollow"),u(Pn,"href","https://jax.readthedocs.io/en/latest/jax.html#automatic-differentiation"),u(Pn,"rel","nofollow"),u(Nn,"href","https://jax.readthedocs.io/en/latest/jax.html#vectorization-vmap"),u(Nn,"rel","nofollow"),u(An,"href","https://jax.readthedocs.io/en/latest/jax.html#parallelization-pmap"),u(An,"rel","nofollow"),u(lo,"id","generate-reply->>>-reply_ids-=-model.generate(inputs[\u2018input_ids\u2019],-num_beams=4,-max_length=5,"),u(lo,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),u(lo,"href","#generate-reply->>>-reply_ids-=-model.generate(inputs[\u2018input_ids\u2019],-num_beams=4,-max_length=5,"),u(io,"class","relative group"),u(D,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),u(co,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),u(uo,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),u(S,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8")},m(o,_){e(document.head,p),f(o,v,_),f(o,g,_),e(g,h),e(h,b),T(i,b,null),e(g,m),e(g,F),e(F,Me),f(o,pe,_),f(o,E,_),e(E,fe),e(fe,te),e(E,Ce),e(E,oe),e(oe,ne),e(E,je),f(o,we,_),f(o,G,_),e(G,N),e(N,_e),T(R,_e,null),e(G,M),e(G,j),e(j,Oe),f(o,J,_),f(o,Q,_),e(Q,Pe),e(Q,W),e(W,Ne),e(Q,Ae),f(o,A,_),f(o,ue,_),e(ue,re),f(o,$e,_),f(o,he,_),e(he,H),e(H,Ie),f(o,Be,_),f(o,C,_),e(C,Le),e(C,U),e(U,Se),e(C,x),e(C,q),e(q,ge),e(C,rt),f(o,Ve,_),f(o,O,_),e(O,me),e(me,De),T(be,De,null),e(O,K),e(O,V),e(V,st),f(o,Je,_),f(o,I,_),e(I,ve),e(ve,at),e(ve,se),e(se,dt),e(ve,Fd),e(I,qd),e(I,xo),e(xo,Ed),e(xo,zo),e(zo,Md),e(xo,Cd),e(I,jd),e(I,Ge),e(Ge,Od),e(Ge,zr),e(zr,Pd),e(Ge,Nd),e(Ge,Fr),e(Fr,Ad),e(Ge,Id),e(Ge,Vn),e(Vn,Ld),e(Ge,Sd),f(o,ba,_),f(o,it,_),e(it,qt),e(qt,qr),T(Fo,qr,null),e(it,Dd),e(it,Er),e(Er,Gd),f(o,va,_),f(o,Jn,_),e(Jn,Wd),f(o,ka,_),T(qo,o,_),f(o,ya,_),f(o,lt,_),e(lt,Et),e(Et,Mr),T(Eo,Mr,null),e(lt,Ud),e(lt,Cr),e(Cr,Rd),f(o,Ta,_),f(o,ke,_),T(Mo,ke,null),e(ke,Hd),e(ke,ct),e(ct,Kd),e(ct,Qn),e(Qn,Vd),e(ct,Jd),e(ct,Co),e(Co,Qd),e(ct,Xd),e(ke,Yd),e(ke,pt),e(pt,Zd),e(pt,Xn),e(Xn,ei),e(pt,ti),e(pt,Yn),e(Yn,oi),e(pt,ni),e(ke,ri),T(Mt,ke,null),f(o,wa,_),f(o,ut,_),e(ut,Ct),e(Ct,jr),T(jo,jr,null),e(ut,si),e(ut,Or),e(Or,ai),f(o,$a,_),f(o,ae,_),T(Oo,ae,null),e(ae,di),e(ae,Pr),e(Pr,ii),e(ae,li),e(ae,jt),e(jt,Nr),e(Nr,ci),e(jt,pi),e(jt,Zn),e(Zn,ui),e(jt,hi),e(ae,mi),e(ae,Po),e(Po,fi),e(Po,er),e(er,_i),e(Po,gi),e(ae,bi),e(ae,Qe),T(No,Qe,null),e(Qe,vi),e(Qe,Ar),e(Ar,ki),e(Qe,yi),e(Qe,Ir),e(Ir,tr),e(tr,Ti),e(tr,Lr),e(Lr,wi),f(o,Ba,_),f(o,ht,_),e(ht,Ot),e(Ot,Sr),T(Ao,Sr,null),e(ht,$i),e(ht,Dr),e(Dr,Bi),f(o,xa,_),f(o,de,_),T(Io,de,null),e(de,xi),e(de,Lo),e(Lo,zi),e(Lo,Gr),e(Gr,Fi),e(Lo,qi),e(de,Ei),e(de,Pt),e(Pt,Wr),e(Wr,Mi),e(Pt,Ci),e(Pt,or),e(or,ji),e(Pt,Oi),e(de,Pi),e(de,So),e(So,Ni),e(So,nr),e(nr,Ai),e(So,Ii),e(de,Li),e(de,Xe),T(Do,Xe,null),e(Xe,Si),e(Xe,Ur),e(Ur,Di),e(Xe,Gi),e(Xe,Rr),e(Rr,rr),e(rr,Wi),e(rr,Hr),e(Hr,Ui),f(o,za,_),f(o,mt,_),e(mt,Nt),e(Nt,Kr),T(Go,Kr,null),e(mt,Ri),e(mt,Vr),e(Vr,Hi),f(o,Fa,_),f(o,We,_),e(We,Ki),e(We,Jr),e(Jr,Vi),e(We,Ji),e(We,Qr),e(Qr,Qi),e(We,Xi),e(We,Xr),e(Xr,Yi),f(o,qa,_),f(o,ye,_),T(Wo,ye,null),e(ye,Zi),e(ye,Uo),e(Uo,el),e(Uo,sr),e(sr,tl),e(Uo,ol),e(ye,nl),e(ye,Ro),e(Ro,rl),e(Ro,Ho),e(Ho,sl),e(Ro,al),e(ye,dl),e(ye,xe),T(Ko,xe,null),e(xe,il),e(xe,ft),e(ft,ll),e(ft,ar),e(ar,cl),e(ft,pl),e(ft,Yr),e(Yr,ul),e(ft,hl),e(xe,ml),T(At,xe,null),e(xe,fl),T(It,xe,null),f(o,Ea,_),f(o,_t,_),e(_t,Lt),e(Lt,Zr),T(Vo,Zr,null),e(_t,_l),e(_t,es),e(es,gl),f(o,Ma,_),f(o,Ue,_),e(Ue,bl),e(Ue,dr),e(dr,vl),e(Ue,kl),e(Ue,ts),e(ts,yl),e(Ue,Tl),e(Ue,os),e(os,wl),f(o,Ca,_),f(o,Te,_),T(Jo,Te,null),e(Te,$l),e(Te,Qo),e(Qo,Bl),e(Qo,ir),e(ir,xl),e(Qo,zl),e(Te,Fl),e(Te,Xo),e(Xo,ql),e(Xo,Yo),e(Yo,El),e(Xo,Ml),e(Te,Cl),e(Te,ze),T(Zo,ze,null),e(ze,jl),e(ze,gt),e(gt,Ol),e(gt,lr),e(lr,Pl),e(gt,Nl),e(gt,ns),e(ns,Al),e(gt,Il),e(ze,Ll),T(St,ze,null),e(ze,Sl),T(Dt,ze,null),f(o,ja,_),f(o,bt,_),e(bt,Gt),e(Gt,rs),T(en,rs,null),e(bt,Dl),e(bt,ss),e(ss,Gl),f(o,Oa,_),f(o,vt,_),T(tn,vt,null),e(vt,Wl),e(vt,Wt),T(on,Wt,null),e(Wt,Ul),T(Ut,Wt,null),f(o,Pa,_),f(o,kt,_),e(kt,Rt),e(Rt,as),T(nn,as,null),e(kt,Rl),e(kt,ds),e(ds,Hl),f(o,Na,_),f(o,ie,_),T(rn,ie,null),e(ie,Kl),e(ie,sn),e(sn,Vl),e(sn,cr),e(cr,Jl),e(sn,Ql),e(ie,Xl),e(ie,an),e(an,Yl),e(an,dn),e(dn,Zl),e(an,ec),e(ie,tc),T(Ht,ie,null),e(ie,oc),e(ie,Fe),T(ln,Fe,null),e(Fe,nc),e(Fe,yt),e(yt,rc),e(yt,pr),e(pr,sc),e(yt,ac),e(yt,is),e(is,dc),e(yt,ic),e(Fe,lc),T(Kt,Fe,null),e(Fe,cc),T(Vt,Fe,null),f(o,Aa,_),f(o,Tt,_),e(Tt,Jt),e(Jt,ls),T(cn,ls,null),e(Tt,pc),e(Tt,cs),e(cs,uc),f(o,Ia,_),f(o,le,_),T(pn,le,null),e(le,hc),e(le,un),e(un,mc),e(un,ur),e(ur,fc),e(un,_c),e(le,gc),e(le,hn),e(hn,bc),e(hn,mn),e(mn,vc),e(hn,kc),e(le,yc),T(Qt,le,null),e(le,Tc),e(le,X),T(fn,X,null),e(X,wc),e(X,wt),e(wt,$c),e(wt,hr),e(hr,Bc),e(wt,xc),e(wt,ps),e(ps,zc),e(wt,Fc),e(X,qc),T(Xt,X,null),e(X,Ec),e(X,us),e(us,Mc),e(X,Cc),e(X,hs),e(hs,ms),e(ms,fs),e(fs,_s),e(_s,jc),e(X,Oc),e(X,gs),e(gs,bs),e(bs,vs),e(vs,_n),e(_n,Pc),e(_n,ks),e(ks,Nc),e(_n,Ac),f(o,La,_),f(o,$t,_),e($t,Yt),e(Yt,ys),T(gn,ys,null),e($t,Ic),e($t,Ts),e(Ts,Lc),f(o,Sa,_),f(o,L,_),T(bn,L,null),e(L,Sc),e(L,vn),e(vn,Dc),e(vn,mr),e(mr,Gc),e(vn,Wc),e(L,Uc),e(L,kn),e(kn,Rc),e(kn,yn),e(yn,Hc),e(kn,Kc),e(L,Vc),e(L,ws),e(ws,Jc),e(L,Qc),e(L,Re),e(Re,$s),e($s,Tn),e(Tn,Xc),e(Re,Yc),e(Re,Bs),e(Bs,wn),e(wn,Zc),e(Re,ep),e(Re,xs),e(xs,$n),e($n,tp),e(Re,op),e(Re,zs),e(zs,Bn),e(Bn,np),e(L,rp),e(L,qe),T(xn,qe,null),e(qe,sp),e(qe,Bt),e(Bt,ap),e(Bt,Fs),e(Fs,dp),e(Bt,ip),e(Bt,qs),e(qs,lp),e(Bt,cp),e(qe,pp),T(Zt,qe,null),e(qe,up),T(eo,qe,null),e(L,hp),e(L,to),T(zn,to,null),e(to,mp),T(oo,to,null),e(L,fp),e(L,no),T(Fn,no,null),e(no,_p),T(ro,no,null),f(o,Da,_),f(o,xt,_),e(xt,so),e(so,Es),T(qn,Es,null),e(xt,gp),e(xt,Ms),e(Ms,bp),f(o,Ga,_),f(o,S,_),T(En,S,null),e(S,vp),e(S,Mn),e(Mn,kp),e(Mn,fr),e(fr,yp),e(Mn,Tp),e(S,wp),e(S,Cn),e(Cn,$p),e(Cn,jn),e(jn,Bp),e(Cn,xp),e(S,zp),e(S,Cs),e(Cs,Fp),e(S,qp),e(S,He),e(He,js),e(js,On),e(On,Ep),e(He,Mp),e(He,Os),e(Os,Pn),e(Pn,Cp),e(He,jp),e(He,Ps),e(Ps,Nn),e(Nn,Op),e(He,Pp),e(He,Ns),e(Ns,An),e(An,Np),e(S,Ap),e(S,D),T(In,D,null),e(D,Ip),e(D,zt),e(zt,Lp),e(zt,As),e(As,Sp),e(zt,Dp),e(zt,Is),e(Is,Gp),e(zt,Wp),e(D,Up),T(ao,D,null),e(D,Rp),e(D,Ls),e(Ls,Hp),e(D,Kp),e(D,Ss),e(Ss,Ds),e(Ds,Gs),e(Gs,Ws),e(Ws,Vp),e(D,Jp),e(D,Us),e(Us,Rs),e(Rs,Hs),e(Hs,Ks),e(Ks,Qp),e(D,Xp),e(D,Vs),e(Vs,Js),e(Js,Qs),e(Qs,Xs),e(Xs,Yp),e(D,Zp),e(D,Ys),e(Ys,Zs),e(Zs,Ln),e(Ln,io),e(io,lo),e(lo,ea),T(Sn,ea,null),e(io,eu),e(io,ta),e(ta,tu),e(Ln,ou),e(Ln,oa),e(oa,nu),e(S,ru),e(S,co),T(Dn,co,null),e(co,su),T(po,co,null),e(S,au),e(S,uo),T(Gn,uo,null),e(uo,du),T(ho,uo,null),Wa=!0},p(o,[_]){const Wn={};_&2&&(Wn.$$scope={dirty:_,ctx:o}),Mt.$set(Wn);const na={};_&2&&(na.$$scope={dirty:_,ctx:o}),At.$set(na);const ra={};_&2&&(ra.$$scope={dirty:_,ctx:o}),It.$set(ra);const sa={};_&2&&(sa.$$scope={dirty:_,ctx:o}),St.$set(sa);const mo={};_&2&&(mo.$$scope={dirty:_,ctx:o}),Dt.$set(mo);const aa={};_&2&&(aa.$$scope={dirty:_,ctx:o}),Ut.$set(aa);const da={};_&2&&(da.$$scope={dirty:_,ctx:o}),Ht.$set(da);const Un={};_&2&&(Un.$$scope={dirty:_,ctx:o}),Kt.$set(Un);const ia={};_&2&&(ia.$$scope={dirty:_,ctx:o}),Vt.$set(ia);const la={};_&2&&(la.$$scope={dirty:_,ctx:o}),Qt.$set(la);const ca={};_&2&&(ca.$$scope={dirty:_,ctx:o}),Xt.$set(ca);const Rn={};_&2&&(Rn.$$scope={dirty:_,ctx:o}),Zt.$set(Rn);const pa={};_&2&&(pa.$$scope={dirty:_,ctx:o}),eo.$set(pa);const ua={};_&2&&(ua.$$scope={dirty:_,ctx:o}),oo.$set(ua);const ha={};_&2&&(ha.$$scope={dirty:_,ctx:o}),ro.$set(ha);const ma={};_&2&&(ma.$$scope={dirty:_,ctx:o}),ao.$set(ma);const Ft={};_&2&&(Ft.$$scope={dirty:_,ctx:o}),po.$set(Ft);const fa={};_&2&&(fa.$$scope={dirty:_,ctx:o}),ho.$set(fa)},i(o){Wa||(w(i.$$.fragment,o),w(R.$$.fragment,o),w(be.$$.fragment,o),w(Fo.$$.fragment,o),w(qo.$$.fragment,o),w(Eo.$$.fragment,o),w(Mo.$$.fragment,o),w(Mt.$$.fragment,o),w(jo.$$.fragment,o),w(Oo.$$.fragment,o),w(No.$$.fragment,o),w(Ao.$$.fragment,o),w(Io.$$.fragment,o),w(Do.$$.fragment,o),w(Go.$$.fragment,o),w(Wo.$$.fragment,o),w(Ko.$$.fragment,o),w(At.$$.fragment,o),w(It.$$.fragment,o),w(Vo.$$.fragment,o),w(Jo.$$.fragment,o),w(Zo.$$.fragment,o),w(St.$$.fragment,o),w(Dt.$$.fragment,o),w(en.$$.fragment,o),w(tn.$$.fragment,o),w(on.$$.fragment,o),w(Ut.$$.fragment,o),w(nn.$$.fragment,o),w(rn.$$.fragment,o),w(Ht.$$.fragment,o),w(ln.$$.fragment,o),w(Kt.$$.fragment,o),w(Vt.$$.fragment,o),w(cn.$$.fragment,o),w(pn.$$.fragment,o),w(Qt.$$.fragment,o),w(fn.$$.fragment,o),w(Xt.$$.fragment,o),w(gn.$$.fragment,o),w(bn.$$.fragment,o),w(xn.$$.fragment,o),w(Zt.$$.fragment,o),w(eo.$$.fragment,o),w(zn.$$.fragment,o),w(oo.$$.fragment,o),w(Fn.$$.fragment,o),w(ro.$$.fragment,o),w(qn.$$.fragment,o),w(En.$$.fragment,o),w(In.$$.fragment,o),w(ao.$$.fragment,o),w(Sn.$$.fragment,o),w(Dn.$$.fragment,o),w(po.$$.fragment,o),w(Gn.$$.fragment,o),w(ho.$$.fragment,o),Wa=!0)},o(o){$(i.$$.fragment,o),$(R.$$.fragment,o),$(be.$$.fragment,o),$(Fo.$$.fragment,o),$(qo.$$.fragment,o),$(Eo.$$.fragment,o),$(Mo.$$.fragment,o),$(Mt.$$.fragment,o),$(jo.$$.fragment,o),$(Oo.$$.fragment,o),$(No.$$.fragment,o),$(Ao.$$.fragment,o),$(Io.$$.fragment,o),$(Do.$$.fragment,o),$(Go.$$.fragment,o),$(Wo.$$.fragment,o),$(Ko.$$.fragment,o),$(At.$$.fragment,o),$(It.$$.fragment,o),$(Vo.$$.fragment,o),$(Jo.$$.fragment,o),$(Zo.$$.fragment,o),$(St.$$.fragment,o),$(Dt.$$.fragment,o),$(en.$$.fragment,o),$(tn.$$.fragment,o),$(on.$$.fragment,o),$(Ut.$$.fragment,o),$(nn.$$.fragment,o),$(rn.$$.fragment,o),$(Ht.$$.fragment,o),$(ln.$$.fragment,o),$(Kt.$$.fragment,o),$(Vt.$$.fragment,o),$(cn.$$.fragment,o),$(pn.$$.fragment,o),$(Qt.$$.fragment,o),$(fn.$$.fragment,o),$(Xt.$$.fragment,o),$(gn.$$.fragment,o),$(bn.$$.fragment,o),$(xn.$$.fragment,o),$(Zt.$$.fragment,o),$(eo.$$.fragment,o),$(zn.$$.fragment,o),$(oo.$$.fragment,o),$(Fn.$$.fragment,o),$(ro.$$.fragment,o),$(qn.$$.fragment,o),$(En.$$.fragment,o),$(In.$$.fragment,o),$(ao.$$.fragment,o),$(Sn.$$.fragment,o),$(Dn.$$.fragment,o),$(po.$$.fragment,o),$(Gn.$$.fragment,o),$(ho.$$.fragment,o),Wa=!1},d(o){t(p),o&&t(v),o&&t(g),B(i),o&&t(pe),o&&t(E),o&&t(we),o&&t(G),B(R),o&&t(J),o&&t(Q),o&&t(A),o&&t(ue),o&&t($e),o&&t(he),o&&t(Be),o&&t(C),o&&t(Ve),o&&t(O),B(be),o&&t(Je),o&&t(I),o&&t(ba),o&&t(it),B(Fo),o&&t(va),o&&t(Jn),o&&t(ka),B(qo,o),o&&t(ya),o&&t(lt),B(Eo),o&&t(Ta),o&&t(ke),B(Mo),B(Mt),o&&t(wa),o&&t(ut),B(jo),o&&t($a),o&&t(ae),B(Oo),B(No),o&&t(Ba),o&&t(ht),B(Ao),o&&t(xa),o&&t(de),B(Io),B(Do),o&&t(za),o&&t(mt),B(Go),o&&t(Fa),o&&t(We),o&&t(qa),o&&t(ye),B(Wo),B(Ko),B(At),B(It),o&&t(Ea),o&&t(_t),B(Vo),o&&t(Ma),o&&t(Ue),o&&t(Ca),o&&t(Te),B(Jo),B(Zo),B(St),B(Dt),o&&t(ja),o&&t(bt),B(en),o&&t(Oa),o&&t(vt),B(tn),B(on),B(Ut),o&&t(Pa),o&&t(kt),B(nn),o&&t(Na),o&&t(ie),B(rn),B(Ht),B(ln),B(Kt),B(Vt),o&&t(Aa),o&&t(Tt),B(cn),o&&t(Ia),o&&t(le),B(pn),B(Qt),B(fn),B(Xt),o&&t(La),o&&t($t),B(gn),o&&t(Sa),o&&t(L),B(bn),B(xn),B(Zt),B(eo),B(zn),B(oo),B(Fn),B(ro),o&&t(Da),o&&t(xt),B(qn),o&&t(Ga),o&&t(S),B(En),B(In),B(ao),B(Sn),B(Dn),B(po),B(Gn),B(ho)}}}const cf={local:"blenderbot",sections:[{local:"overview",title:"Overview"},{local:"implementation-notes",title:"Implementation Notes"},{local:"usage",title:"Usage"},{local:"transformers.BlenderbotConfig",title:"BlenderbotConfig"},{local:"transformers.BlenderbotTokenizer",title:"BlenderbotTokenizer"},{local:"transformers.BlenderbotTokenizerFast",title:"BlenderbotTokenizerFast"},{local:"transformers.BlenderbotModel",title:"BlenderbotModel"},{local:"transformers.BlenderbotForConditionalGeneration",title:"BlenderbotForConditionalGeneration"},{local:"transformers.BlenderbotForCausalLM",title:"BlenderbotForCausalLM"},{local:"transformers.TFBlenderbotModel",title:"TFBlenderbotModel"},{local:"transformers.TFBlenderbotForConditionalGeneration",title:"TFBlenderbotForConditionalGeneration"},{local:"transformers.FlaxBlenderbotModel",title:"FlaxBlenderbotModel"},{local:"transformers.FlaxBlenderbotForConditionalGeneration",title:"FlaxBlenderbotForConditionalGeneration"}],title:"Blenderbot"};function pf(z){return Wm(()=>{new URLSearchParams(window.location.search).get("fw")}),[]}class bf extends Lm{constructor(p){super();Sm(this,p,pf,lf,Dm,{})}}export{bf as default,cf as metadata};
