...
</ul>`,name:"return_tensors"}],source:"https://github.com/huggingface/transformers/blob/v4.20.1/src/transformers/models/layoutlmv3/feature_extraction_layoutlmv3.py#L143",returnDescription:`
<p>A <a
...
<li><strong>words</strong> \u2014 Optional words as identified by Tesseract OCR (only when <a
  href="/docs/transformers/v4.20.1/en/model_doc/layoutlmv3#transformers.LayoutLMv3FeatureExtractor"
...
<p>Indices can be obtained using <a href="/docs/transformers/v4.20.1/en/model_doc/layoutlmv2#transformers.LayoutLMv2Tokenizer">LayoutLMv2Tokenizer</a>. See <a href="/docs/transformers/v4.20.1/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
...
elements depending on the configuration (<a
  href="/docs/transformers/v4.20.1/en/model_doc/layoutlmv3#transformers.LayoutLMv3Config"
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.20.1/src/transformers/models/layoutlmv3/modeling_layoutlmv3.py#L976",returnDescription:`
<p>A <a
...
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/v4.20.1/src/transformers/models/layoutlmv3/modeling_layoutlmv3.py#L1085",returnDescription:`
<p>A <a
...
`),Oo=s("a"),ll=n("LayoutLMv3FeatureExtractor"),dl=n(" was initialized with "),Wn=s("code"),cl=n("apply_ocr"),ul=n(" set to "),Un=s("code"),ml=n("True"),pl=n(`, it passes the obtained words and
...
`),Oo=r($,"A",{href:!0});var Fu=i(Oo);ll=a(Fu,"LayoutLMv3FeatureExtractor"),Fu.forEach(t),dl=a($," was initialized with "),Wn=r($,"CODE",{});var Pu=i(Wn);cl=a(Pu,"apply_ocr"),Pu.forEach(t),ul=a($," set to "),Un=r($,"CODE",{});var Cu=i(Un);ml=a(Cu,"True"),Cu.forEach(t),pl=a($,`, it passes the obtained words and
...
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),fs.forEach(t),dd=u(et),H=r(et,"DIV",{class:!0});var tt=i(H);b(Gt.$$.fragment,tt),cd=u(tt),be=r(tt,"P",{});var tn=i(be);ud=a(tn,"The "),Wo=r(tn,"A",{href:!0});var om=i(Wo);md=a(om,"LayoutLMv3ForSequenceClassification"),om.forEach(t),pd=a(tn," forward method, overrides the "),ra=r(tn,"CODE",{});var nm=i(ra);hd=a(nm,"__call__"),nm.forEach(t),fd=a(tn," special method."),tn.forEach(t),gd=u(tt),b(Be.$$.fragment,tt),_d=u(tt),b(We.$$.fragment,tt),tt.forEach(t),et.forEach(t),Va=u(o),Le=r(o,"H2",{class:!0});var gs=i(Le);Ue=r(gs,"A",{id:!0,class:!0,href:!0});var am=i(Ue);ia=r(am,"SPAN",{});var sm=i(ia);b(Xt.$$.fragment,sm),sm.forEach(t),am.forEach(t),vd=u(gs),la=r(gs,"SPAN",{});var rm=i(la);yd=a(rm,"LayoutLMv3ForTokenClassification"),rm.forEach(t),gs.forEach(t),Ha=u(o),B=r(o,"DIV",{class:!0});var ot=i(B);b(Yt.$$.fragment,ot),bd=u(ot),W=r(ot,"P",{});var ie=i(W);Ld=a(ie,`LayoutLMv3 Model with a token classification head on top (a linear layer on top of the final hidden states) e.g.
