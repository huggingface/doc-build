...
<span class="hljs-meta">&gt;&gt;&gt; </span>configuration = model.config`}}),{c(){n=a("p"),g=l("Example:"),c=u(),k(m.$$.fragment)},l(s){n=r(s,"P",{});var p=i(n);g=d(p,"Example:"),p.forEach(t),c=f(s),$(m.$$.fragment,s)},m(s,p){v(s,n,p),e(n,g),v(s,c,p),w(m,s,p),b=!0},p:ee,i(s){b||(y(m.$$.fragment,s),b=!0)},o(s){T(m.$$.fragment,s),b=!1},d(s){s&&t(n),s&&t(c),B(m,s)}}}function Ti(C){let n,g,c,m,b;return{c(){n=a("p"),g=l("Although the recipe for forward pass needs to be defined within this function, one should call the "),c=a("code"),m=l("Module"),b=l(`
...
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),p.forEach(t)},m(s,p){v(s,n,p),e(n,g),e(n,c),e(c,m),e(n,b)},d(s){s&&t(n)}}}function Bi(C){let n,g,c,m,b;return m=new oe({props:{code:`from transformers import BloomTokenizer, BloomModel
import torch
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),{c(){n=a("p"),g=l("Example:"),c=u(),k(m.$$.fragment)},l(s){n=r(s,"P",{});var p=i(n);g=d(p,"Example:"),p.forEach(t),c=f(s),$(m.$$.fragment,s)},m(s,p){v(s,n,p),e(n,g),v(s,c,p),w(m,s,p),b=!0},p:ee,i(s){b||(y(m.$$.fragment,s),b=!0)},o(s){T(m.$$.fragment,s),b=!1},d(s){s&&t(n),s&&t(c),B(m,s)}}}function Ci(C){let n,g,c,m,b;return m=new oe({props:{code:`from transformers import BloomTokenizerFast
...
[15496, 995]
<span class="hljs-meta">&gt;&gt;&gt;</span> <span class="language-python">tokenizer(<span class="hljs-string">&quot; Hello world&quot;</span>)[<span class="hljs-string">&#x27;input_ids&#x27;</span>]</span>
[18435, 995]`}}),{c(){n=a("p"),g=l("be encoded differently whether it is at the beginning of the sentence (without space) or not:"),c=u(),k(m.$$.fragment)},l(s){n=r(s,"P",{});var p=i(n);g=d(p,"be encoded differently whether it is at the beginning of the sentence (without space) or not:"),p.forEach(t),c=f(s),$(m.$$.fragment,s)},m(s,p){v(s,n,p),e(n,g),v(s,c,p),w(m,s,p),b=!0},p:ee,i(s){b||(y(m.$$.fragment,s),b=!0)},o(s){T(m.$$.fragment,s),b=!1},d(s){s&&t(n),s&&t(c),B(m,s)}}}function Fi(C){let n,g,c,m,b,s,p,F;return{c(){n=a("p"),g=l("When used with "),c=a("code"),m=l("is_split_into_words=True"),b=l(", this tokenizer needs to be instantiated with "),s=a("code"),p=l("add_prefix_space=True"),F=l(".")},l(te){n=r(te,"P",{});var O=i(n);g=d(O,"When used with "),c=r(O,"CODE",{});var H=i(c);m=d(H,"is_split_into_words=True"),H.forEach(t),b=d(O,", this tokenizer needs to be instantiated with "),s=r(O,"CODE",{});var R=i(s);p=d(R,"add_prefix_space=True"),R.forEach(t),F=d(O,"."),O.forEach(t)},m(te,O){v(te,n,O),e(n,g),e(n,c),e(c,m),e(n,b),e(n,s),e(s,p),e(n,F)},d(te){te&&t(n)}}}function zi(C){let n,g,c,m,b;return{c(){n=a("p"),g=l("Although the recipe for forward pass needs to be defined within this function, one should call the "),c=a("code"),m=l("Module"),b=l(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(s){n=r(s,"P",{});var p=i(n);g=d(p,"Although the recipe for forward pass needs to be defined within this function, one should call the "),c=r(p,"CODE",{});var F=i(c);m=d(F,"Module"),F.forEach(t),b=d(p,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),p.forEach(t)},m(s,p){v(s,n,p),e(n,g),e(n,c),e(c,m),e(n,b)},d(s){s&&t(n)}}}function xi(C){let n,g,c,m,b;return m=new oe({props:{code:`import torch
...
<span class="hljs-meta">&gt;&gt;&gt; </span>logits = outputs.logits`}}),{c(){n=a("p"),g=l("Example:"),c=u(),k(m.$$.fragment)},l(s){n=r(s,"P",{});var p=i(n);g=d(p,"Example:"),p.forEach(t),c=f(s),$(m.$$.fragment,s)},m(s,p){v(s,n,p),e(n,g),v(s,c,p),w(m,s,p),b=!0},p:ee,i(s){b||(y(m.$$.fragment,s),b=!0)},o(s){T(m.$$.fragment,s),b=!1},d(s){s&&t(n),s&&t(c),B(m,s)}}}function qi(C){let n,g,c,m,b;return{c(){n=a("p"),g=l("Although the recipe for forward pass needs to be defined within this function, one should call the "),c=a("code"),m=l("Module"),b=l(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(s){n=r(s,"P",{});var p=i(n);g=d(p,"Although the recipe for forward pass needs to be defined within this function, one should call the "),c=r(p,"CODE",{});var F=i(c);m=d(F,"Module"),F.forEach(t),b=d(p,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),p.forEach(t)},m(s,p){v(s,n,p),e(n,g),e(n,c),e(c,m),e(n,b)},d(s){s&&t(n)}}}function Mi(C){let n,g,c,m,b;return m=new oe({props:{code:`import torch
...
`}}),{c(){n=a("p"),g=l("Example of single-label classification:"),c=u(),k(m.$$.fragment)},l(s){n=r(s,"P",{});var p=i(n);g=d(p,"Example of single-label classification:"),p.forEach(t),c=f(s),$(m.$$.fragment,s)},m(s,p){v(s,n,p),e(n,g),v(s,c,p),w(m,s,p),b=!0},p:ee,i(s){b||(y(m.$$.fragment,s),b=!0)},o(s){T(m.$$.fragment,s),b=!1},d(s){s&&t(n),s&&t(c),B(m,s)}}}function Ei(C){let n,g;return n=new oe({props:{code:`# To train a model on \`num_labels\` classes, you can pass \`num_labels=num_labels\` to \`.from_pretrained(...)\`
...
`}}),{c(){k(n.$$.fragment)},l(c){$(n.$$.fragment,c)},m(c,m){w(n,c,m),g=!0},p:ee,i(c){g||(y(n.$$.fragment,c),g=!0)},o(c){T(n.$$.fragment,c),g=!1},d(c){B(n,c)}}}function ji(C){let n,g,c,m,b;return m=new oe({props:{code:`import torch
from transformers import BloomTokenizer, BloomForSequenceClassification
...
<span class="hljs-meta">&gt;&gt;&gt; </span>predicted_class_id = logits.argmax().item()
<span class="hljs-meta">&gt;&gt;&gt; </span>model.config.id2label[predicted_class_id]
`}}),{c(){n=a("p"),g=l("Example of multi-label classification:"),c=u(),k(m.$$.fragment)},l(s){n=r(s,"P",{});var p=i(n);g=d(p,"Example of multi-label classification:"),p.forEach(t),c=f(s),$(m.$$.fragment,s)},m(s,p){v(s,n,p),e(n,g),v(s,c,p),w(m,s,p),b=!0},p:ee,i(s){b||(y(m.$$.fragment,s),b=!0)},o(s){T(m.$$.fragment,s),b=!1},d(s){s&&t(n),s&&t(c),B(m,s)}}}function Pi(C){let n,g;return n=new oe({props:{code:`# To train a model on \`num_labels\` classes, you can pass \`num_labels=num_labels\` to \`.from_pretrained(...)\`
num_labels = len(model.config.id2label)
...
<span class="hljs-meta">... </span>)
<span class="hljs-meta">&gt;&gt;&gt; </span>loss = model(**inputs, labels=labels).loss
<span class="hljs-meta">&gt;&gt;&gt; </span>loss.backward()`}}),{c(){k(n.$$.fragment)},l(c){$(n.$$.fragment,c)},m(c,m){w(n,c,m),g=!0},p:ee,i(c){g||(y(n.$$.fragment,c),g=!0)},o(c){T(n.$$.fragment,c),g=!1},d(c){B(n,c)}}}function Si(C){let n,g,c,m,b;return{c(){n=a("p"),g=l("Although the recipe for forward pass needs to be defined within this function, one should call the "),c=a("code"),m=l("Module"),b=l(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(s){n=r(s,"P",{});var p=i(n);g=d(p,"Although the recipe for forward pass needs to be defined within this function, one should call the "),c=r(p,"CODE",{});var F=i(c);m=d(F,"Module"),F.forEach(t),b=d(p,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),p.forEach(t)},m(s,p){v(s,n,p),e(n,g),e(n,c),e(c,m),e(n,b)},d(s){s&&t(n)}}}function Ai(C){let n,g,c,m,b;return m=new oe({props:{code:`from transformers import BloomTokenizer, BloomForTokenClassification
import torch
...
`}}),{c(){n=a("p"),g=l("Example:"),c=u(),k(m.$$.fragment)},l(s){n=r(s,"P",{});var p=i(n);g=d(p,"Example:"),p.forEach(t),c=f(s),$(m.$$.fragment,s)},m(s,p){v(s,n,p),e(n,g),v(s,c,p),w(m,s,p),b=!0},p:ee,i(s){b||(y(m.$$.fragment,s),b=!0)},o(s){T(m.$$.fragment,s),b=!1},d(s){s&&t(n),s&&t(c),B(m,s)}}}function Ii(C){let n,g;return n=new oe({props:{code:`labels = predicted_token_class_ids
loss = model(**inputs, labels=labels).loss
round(loss.item(), 2)
`,highlighted:`<span class="hljs-meta">&gt;&gt;&gt; </span>labels = predicted_token_class_ids
<span class="hljs-meta">&gt;&gt;&gt; </span>loss = model(**inputs, labels=labels).loss
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-built_in">round</span>(loss.item(), <span class="hljs-number">2</span>)
`}}),{c(){k(n.$$.fragment)},l(c){$(n.$$.fragment,c)},m(c,m){w(n,c,m),g=!0},p:ee,i(c){g||(y(n.$$.fragment,c),g=!0)},o(c){T(n.$$.fragment,c),g=!1},d(c){B(n,c)}}}function Ni(C){let n,g,c,m,b,s,p,F,te,O,H,R,Xo,De,ws,Zo,ys,Ut,fe,Ts,We,Bs,Cs,Vt,M,et,He,Fs,zs,ot,Ue,xs,qs,tt,Ve,Ms,Es,st,Re,js,Ps,nt,Ge,Ss,As,Mo,Ye,Is,Ns,Rt,se,ge,at,Je,Ls,rt,Os,Gt,D,Ke,Ds,ne,Ws,Eo,Hs,Us,Qe,Vs,Rs,Gs,ae,Ys,jo,Js,Ks,Po,Qs,Xs,Zs,_e,Yt,re,be,it,Xe,en,lt,on,Jt,E,Ze,tn,dt,sn,nn,eo,an,So,rn,ln,dn,oo,cn,to,mn,pn,hn,U,so,un,ie,fn,Ao,gn,_n,ct,bn,vn,kn,ve,$n,ke,Kt,le,$e,mt,no,wn,pt,yn,Qt,z,ao,Tn,ro,Bn,ht,Cn,Fn,zn,ut,xn,qn,we,Mn,io,En,ft,jn,Pn,Sn,ye,An,lo,In,Io,Nn,Ln,Xt,de,Te,gt,co,On,_t,Dn,Zt,j,mo,Wn,bt,Hn,Un,po,Vn,No,Rn,Gn,Yn,ho,Jn,uo,Kn,Qn,Xn,V,fo,Zn,ce,ea,Lo,oa,ta,vt,sa,na,aa,Be,ra,Ce,es,me,Fe,kt,go,ia,$t,la,os,x,_o,da,wt,ca,ma,Oo,Do,pa,ha,ua,W,fa,yt,ga,_a,Tt,ba,va,Bt,ka,$a,Ct,wa,ya,Ta,bo,Ba,Wo,Ca,Fa,za,vo,xa,ko,qa,Ma,Ea,q,$o,ja,pe,Pa,Ho,Sa,Aa,Ft,Ia,Na,La,ze,Oa,xe,Da,qe,Wa,Me,Ha,Ee,ts,he,je,zt,wo,Ua,xt,Va,ss,P,yo,Ra,qt,Ga,Ya,To,Ja,Uo,Ka,Qa,Xa,Bo,Za,Co,er,or,tr,A,Fo,sr,ue,nr,Vo,ar,rr,Mt,ir,lr,dr,Pe,cr,Se,mr,Ae,ns;return s=new Oe({}),De=new Oe({}),Je=new Oe({}),Ke=new X({props:{name:"class transformers.BloomConfig",anchor:"transformers.BloomConfig",parameters:[{name:"vocab_size",val:" = 250880"},{name:"hidden_size",val:" = 64"},{name:"n_layer",val:" = 2"},{name:"n_head",val:" = 8"},{name:"masked_softmax_fusion",val:" = True"},{name:"layer_norm_epsilon",val:" = 1e-05"},{name:"initializer_range",val:" = 0.02"},{name:"use_cache",val:" = False"},{name:"bos_token_id",val:" = 1"},{name:"eos_token_id",val:" = 2"},{name:"apply_residual_connection_post_layernorm",val:" = False"},{name:"hidden_dropout",val:" = 0.0"},{name:"attention_dropout",val:" = 0.0"},{name:"attention_softmax_in_fp32",val:" = True"},{name:"pretraining_tp",val:" = 1"},{name:"dtype",val:" = 'bfloat16'"},{name:"slow_but_exact",val:" = False"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.BloomConfig.vocab_size",description:`<strong>vocab_size</strong> (<code>int</code>, <em>optional</em>, defaults to 50257) &#x2014;
Vocabulary size of the Bloom model. Defines the number of different tokens that can be represented by the
<code>inputs_ids</code> passed when calling <a href="/docs/transformers/v4.20.1/en/model_doc/bloom#transformers.BloomModel">BloomModel</a>.`,name:"vocab_size"},{anchor:"transformers.BloomConfig.hidden_size",description:`<strong>hidden_size</strong> (<code>int</code>, <em>optional</em>, defaults to 768) &#x2014;
...
elements depending on the configuration (<a
  href="/docs/transformers/v4.20.1/en/model_doc/bloom#transformers.BloomConfig"
...
Whether or not the post-processing step should trim offsets to avoid including whitespaces.`,name:"trim_offsets"}],source:"https://github.com/huggingface/transformers/blob/v4.20.1/src/transformers/models/bloom/tokenization_bloom_fast.py#L59"}}),we=new Z({props:{anchor:"transformers.BloomTokenizerFast.example",$$slots:{default:[Ci]},$$scope:{ctx:C}}}),ye=new Ht({props:{$$slots:{default:[Fi]},$$scope:{ctx:C}}}),co=new Oe({}),mo=new X({props:{name:"class transformers.BloomForCausalLM",anchor:"transformers.BloomForCausalLM",parameters:[{name:"config",val:""}],parametersDescription:[{anchor:"transformers.BloomForCausalLM.config",description:`<strong>config</strong> (<a href="/docs/transformers/v4.20.1/en/model_doc/bloom#transformers.BloomConfig">BloomConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/v4.20.1/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/v4.20.1/src/transformers/models/bloom/modeling_bloom.py#L849"}}),fo=new X({props:{name:"forward",anchor:"transformers.BloomForCausalLM.forward",parameters:[{name:"input_ids",val:" = None"},{name:"past_key_values",val:" = None"},{name:"attention_mask",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"labels",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],parametersDescription:[{anchor:"transformers.BloomForCausalLM.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, input_ids_length)</code>) &#x2014;
<code>input_ids_length</code> = <code>sequence_length</code> if <code>past_key_values</code> is <code>None</code> else
<code>past_key_values[0][0].shape[-2]</code> (<code>sequence_length</code> of input past key value states). Indices of input
sequence tokens in the vocabulary.</p>
<p>If <code>past_key_values</code> is used, only <code>input_ids</code> that do not have their past calculated should be passed as
...
are ignored (masked), the loss is only computed for labels in <code>[0, ..., config.vocab_size]</code>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.20.1/src/transformers/models/bloom/modeling_bloom.py#L890",returnDescription:`
<p>A <a
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/v4.20.1/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/v4.20.1/src/transformers/models/bloom/modeling_bloom.py#L984"}}),$o=new X({props:{name:"forward",anchor:"transformers.BloomForSequenceClassification.forward",parameters:[{name:"input_ids",val:" = None"},{name:"past_key_values",val:" = None"},{name:"attention_mask",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"labels",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],parametersDescription:[{anchor:"transformers.BloomForSequenceClassification.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, input_ids_length)</code>) &#x2014;
<code>input_ids_length</code> = <code>sequence_length</code> if <code>past_key_values</code> is <code>None</code> else
<code>past_key_values[0][0].shape[-2]</code> (<code>sequence_length</code> of input past key value states). Indices of input
sequence tokens in the vocabulary.</p>
<p>If <code>past_key_values</code> is used, only <code>input_ids</code> that do not have their past calculated should be passed as
...
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.20.1/src/transformers/models/bloom/modeling_bloom.py#L996",returnDescription:`
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/v4.20.1/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/v4.20.1/src/transformers/models/bloom/modeling_bloom.py#L1105"}}),Fo=new X({props:{name:"forward",anchor:"transformers.BloomForTokenClassification.forward",parameters:[{name:"input_ids",val:" = None"},{name:"past_key_values",val:" = None"},{name:"attention_mask",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"labels",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],parametersDescription:[{anchor:"transformers.BloomForTokenClassification.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, input_ids_length)</code>) &#x2014;
<code>input_ids_length</code> = <code>sequence_length</code> if <code>past_key_values</code> is <code>None</code> else
<code>past_key_values[0][0].shape[-2]</code> (<code>sequence_length</code> of input past key value states). Indices of input
sequence tokens in the vocabulary.</p>
<p>If <code>past_key_values</code> is used, only <code>input_ids</code> that do not have their past calculated should be passed as
...
Labels for computing the sequence classification/regression loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>. If <code>config.num_labels == 1</code> a regression loss is computed (Mean-Square loss), If
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.20.1/src/transformers/models/bloom/modeling_bloom.py#L1125",returnDescription:`
<p>A <a
...
`}}),Pe=new Ht({props:{$$slots:{default:[Si]},$$scope:{ctx:C}}}),Se=new Z({props:{anchor:"transformers.BloomForTokenClassification.forward.example",$$slots:{default:[Ai]},$$scope:{ctx:C}}}),Ae=new Z({props:{anchor:"transformers.BloomForTokenClassification.forward.example-2",$$slots:{default:[Ii]},$$scope:{ctx:C}}}),{c(){n=a("meta"),g=u(),c=a("h1"),m=a("a"),b=a("span"),k(s.$$.fragment),p=u(),F=a("span"),te=l("BLOOM"),O=u(),H=a("h2"),R=a("a"),Xo=a("span"),k(De.$$.fragment),ws=u(),Zo=a("span"),ys=l("Overview"),Ut=u(),fe=a("p"),Ts=l("The BLOOM model has been proposed with its various versions through the "),We=a("a"),Bs=l("BigScience Workshop"),Cs=l(`. BigScience is inspired by other open science initiatives where researchers have pooled their time and resources to collectively achieve a higher impact.
...
Several smaller versions of the models have been trained on the same dataset. BLOOM is available in the following versions:`),Vt=u(),M=a("ul"),et=a("li"),He=a("a"),Fs=l("bloom-350m"),zs=u(),ot=a("li"),Ue=a("a"),xs=l("bloom-760m"),qs=u(),tt=a("li"),Ve=a("a"),Ms=l("bloom-1b3"),Es=u(),st=a("li"),Re=a("a"),js=l("bloom-2b5"),Ps=u(),nt=a("li"),Ge=a("a"),Ss=l("bloom-6b3"),As=u(),Mo=a("li"),Ye=a("a"),Is=l("bloom"),Ns=l(" (175B parameters)"),Rt=u(),se=a("h2"),ge=a("a"),at=a("span"),k(Je.$$.fragment),Ls=u(),rt=a("span"),Os=l("BloomConfig"),Gt=u(),D=a("div"),k(Ke.$$.fragment),Ds=u(),ne=a("p"),Ws=l("This is the configuration class to store the configuration of a "),Eo=a("a"),Hs=l("BloomModel"),Us=l(`. It is used to instantiate a Bloom
...
and behavior.`),hn=u(),U=a("div"),k(so.$$.fragment),un=u(),ie=a("p"),fn=l("The "),Ao=a("a"),gn=l("BloomModel"),_n=l(" forward method, overrides the "),ct=a("code"),bn=l("__call__"),vn=l(" special method."),kn=u(),k(ve.$$.fragment),$n=u(),k(ke.$$.fragment),Kt=u(),le=a("h2"),$e=a("a"),mt=a("span"),k(no.$$.fragment),wn=u(),pt=a("span"),yn=l("BloomTokenizerFast"),Qt=u(),z=a("div"),k(ao.$$.fragment),Tn=u(),ro=a("p"),Bn=l("Construct a \u201Cfast\u201D Bloom tokenizer (backed by HuggingFace\u2019s "),ht=a("em"),Cn=l("tokenizers"),Fn=l(` library). Based on byte-level
...
the model was not pretrained this way, it might yield a decrease in performance.`),Sn=u(),k(ye.$$.fragment),An=u(),lo=a("p"),In=l("This tokenizer inherits from "),Io=a("a"),Nn=l("PreTrainedTokenizerFast"),Ln=l(` which contains most of the main methods. Users should
refer to this superclass for more information regarding those methods.`),Xt=u(),de=a("h2"),Te=a("a"),gt=a("span"),k(co.$$.fragment),On=u(),_t=a("span"),Dn=l("BloomForCausalLM"),Zt=u(),j=a("div"),k(mo.$$.fragment),Wn=u(),bt=a("p"),Hn=l(`The Bloom Model transformer with a language modeling head on top (linear layer with weights tied to the input
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Ea=u(),q=a("div"),k($o.$$.fragment),ja=u(),pe=a("p"),Pa=l("The "),Ho=a("a"),Sa=l("BloomForSequenceClassification"),Aa=l(" forward method, overrides the "),Ft=a("code"),Ia=l("__call__"),Na=l(" special method."),La=u(),k(ze.$$.fragment),Oa=u(),k(xe.$$.fragment),Da=u(),k(qe.$$.fragment),Wa=u(),k(Me.$$.fragment),Ha=u(),k(Ee.$$.fragment),ts=u(),he=a("h2"),je=a("a"),zt=a("span"),k(wo.$$.fragment),Ua=u(),xt=a("span"),Va=l("BloomForTokenClassification"),ss=u(),P=a("div"),k(yo.$$.fragment),Ra=u(),qt=a("p"),Ga=l(`Bloom Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g. for
...
library implements for all its model (such as downloading or saving, resizing the input embeddings etc.)`),_s.forEach(t),za=f(N),vo=r(N,"P",{});var bs=i(vo);xa=d(bs,"This model is also a PyTorch "),ko=r(bs,"A",{href:!0,rel:!0});var ii=i(ko);qa=d(ii,"torch.nn.Module"),ii.forEach(t),Ma=d(bs,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),bs.forEach(t),Ea=f(N),q=r(N,"DIV",{class:!0});var L=i(q);$($o.$$.fragment,L),ja=f(L),pe=r(L,"P",{});var Ko=i(pe);Pa=d(Ko,"The "),Ho=r(Ko,"A",{href:!0});var li=i(Ho);Sa=d(li,"BloomForSequenceClassification"),li.forEach(t),Aa=d(Ko," forward method, overrides the "),Ft=r(Ko,"CODE",{});var di=i(Ft);Ia=d(di,"__call__"),di.forEach(t),Na=d(Ko," special method."),Ko.forEach(t),La=f(L),$(ze.$$.fragment,L),Oa=f(L),$(xe.$$.fragment,L),Da=f(L),$(qe.$$.fragment,L),Wa=f(L),$(Me.$$.fragment,L),Ha=f(L),$(Ee.$$.fragment,L),L.forEach(t),N.forEach(t),ts=f(o),he=r(o,"H2",{class:!0});var vs=i(he);je=r(vs,"A",{id:!0,class:!0,href:!0});var ci=i(je);zt=r(ci,"SPAN",{});var mi=i(zt);$(wo.$$.fragment,mi),mi.forEach(t),ci.forEach(t),Ua=f(vs),xt=r(vs,"SPAN",{});var pi=i(xt);Va=d(pi,"BloomForTokenClassification"),pi.forEach(t),vs.forEach(t),ss=f(o),P=r(o,"DIV",{class:!0});var K=i(P);$(yo.$$.fragment,K),Ra=f(K),qt=r(K,"P",{});var hi=i(qt);Ga=d(hi,`Bloom Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g. for
