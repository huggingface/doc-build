...
<span class="hljs-meta">&gt;&gt;&gt; </span>outputs = model.decode(decoder_input_ids, encoder_outputs)
<span class="hljs-meta">&gt;&gt;&gt; </span>logits = outputs.logits`}}),{c(){l=r("p"),b=a("Example:"),m=u(),v(p.$$.fragment)},l(n){l=d(n,"P",{});var c=i(l);b=s(c,"Example:"),c.forEach(o),m=h(n),k(p.$$.fragment,n)},m(n,c){T(n,l,c),e(l,b),T(n,m,c),y(p,n,c),_=!0},p:me,i(n){_||(w(p.$$.fragment,n),_=!0)},o(n){$(p.$$.fragment,n),_=!1},d(n){n&&o(l),n&&o(m),x(p,n)}}}function _l(z){let l,b,m,p,_,n,c,L,la,bn,ee,ge,fo,Ke,ca,_o,pa,vn,fe,ua,Ze,ha,ma,kn,Yt,ga,yn,Rt,To,fa,wn,Jt,_a,$n,C,O,Vt,Ta,ba,Kt,va,ka,bo,ya,wa,vo,$a,xa,ko,za,La,yo,qa,ja,Fa,Qe,Ma,wo,Ea,Ca,Oa,Xe,Pa,$o,Ga,Sa,Aa,j,Na,xo,Ia,Da,zo,Ba,Wa,Lo,Ua,Ha,qo,Ya,Ra,jo,Ja,Va,Fo,Ka,Za,Qa,q,Mo,Xa,es,Eo,ts,os,Co,ns,as,Oo,ss,rs,Po,ds,is,Go,ls,cs,So,ps,us,hs,et,ms,tt,gs,fs,xn,ot,zn,Q,_s,nt,Ts,bs,at,vs,ks,Ln,te,_e,Ao,st,ys,No,ws,qn,K,rt,$s,Z,xs,Zt,zs,Ls,Qt,qs,js,dt,Fs,Ms,Es,oe,Cs,Xt,Os,Ps,eo,Gs,Ss,jn,ne,Te,Io,it,As,Do,Ns,Fn,F,lt,Is,Bo,Ds,Bs,ct,Ws,pt,Us,Hs,Ys,ut,Rs,to,Js,Vs,Ks,ht,Zs,mt,Qs,Xs,er,D,gt,tr,ae,or,oo,nr,ar,Wo,sr,rr,dr,be,ir,ve,Mn,se,ke,Uo,ft,lr,Ho,cr,En,M,_t,pr,Tt,ur,Yo,hr,mr,gr,bt,fr,vt,_r,Tr,br,kt,vr,no,kr,yr,wr,yt,$r,wt,xr,zr,Lr,B,$t,qr,re,jr,ao,Fr,Mr,Ro,Er,Cr,Or,ye,Pr,we,Cn,de,$e,Jo,xt,Gr,Vo,Sr,On,E,zt,Ar,Ko,Nr,Ir,Lt,Dr,qt,Br,Wr,Ur,jt,Hr,so,Yr,Rr,Jr,Ft,Vr,Mt,Kr,Zr,Qr,W,Et,Xr,ie,ed,ro,td,od,Zo,nd,ad,sd,xe,rd,ze,Pn,le,Le,Qo,Ct,dd,Xo,id,Gn,A,Ot,ld,U,Pt,cd,ce,pd,en,ud,hd,tn,md,gd,fd,qe,_d,je,Td,Fe,Gt,bd,Me,vd,Ee,St,kd,Ce,Sn,pe,Oe,on,At,yd,nn,wd,An,N,Nt,$d,H,It,xd,ue,zd,an,Ld,qd,sn,jd,Fd,Md,Pe,Ed,Ge,Cd,Se,Dt,Od,Ae,Pd,Ne,Bt,Gd,Ie,Nn;return n=new Ve({}),Ke=new Ve({}),ot=new X({props:{code:`import evaluate
...
and behavior.`),er=u(),D=r("div"),v(gt.$$.fragment),tr=u(),ae=r("p"),or=a("The "),oo=r("a"),nr=a("LongT5Model"),ar=a(" forward method, overrides the "),Wo=r("code"),sr=a("__call__"),rr=a(" special method."),dr=u(),v(be.$$.fragment),ir=u(),v(ve.$$.fragment),Mn=u(),se=r("h2"),ke=r("a"),Uo=r("span"),v(ft.$$.fragment),lr=u(),Ho=r("span"),cr=a("LongT5ForConditionalGeneration"),En=u(),M=r("div"),v(_t.$$.fragment),pr=u(),Tt=r("p"),ur=a("LONGT5 Model with a "),Yo=r("code"),hr=a("language modeling"),mr=a(" head on top."),gr=u(),bt=r("p"),fr=a("The LongT5 model was proposed in "),vt=r("a"),_r=a(`LongT5: Efficient Text-To-Text Transformer for Long
...
documentation from `),eo=d(co,"A",{href:!0});var mi=i(eo);Gs=s(mi,"PretrainedConfig"),mi.forEach(o),Ss=s(co," for more information."),co.forEach(o),lo.forEach(o),jn=h(t),ne=d(t,"H2",{class:!0});var Un=i(ne);Te=d(Un,"A",{id:!0,class:!0,href:!0});var gi=i(Te);Io=d(gi,"SPAN",{});var fi=i(Io);k(it.$$.fragment,fi),fi.forEach(o),gi.forEach(o),As=h(Un),Do=d(Un,"SPAN",{});var _i=i(Do);Ns=s(_i,"LongT5Model"),_i.forEach(o),Un.forEach(o),Fn=h(t),F=d(t,"DIV",{class:!0});var R=i(F);k(lt.$$.fragment,R),Is=h(R),Bo=d(R,"P",{});var Ti=i(Bo);Ds=s(Ti,"The bare LONGT5 Model transformer outputting raw hidden-states without any specific head on top."),Ti.forEach(o),Bs=h(R),ct=d(R,"P",{});var Hn=i(ct);Ws=s(Hn,"The LongT5 model was proposed in "),pt=d(Hn,"A",{href:!0,rel:!0});var bi=i(pt);Us=s(bi,`LongT5: Efficient Text-To-Text Transformer for Long
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Rn.forEach(o),er=h(R),D=d(R,"DIV",{class:!0});var Be=i(D);k(gt.$$.fragment,Be),tr=h(Be),ae=d(Be,"P",{});var po=i(ae);or=s(po,"The "),oo=d(po,"A",{href:!0});var yi=i(oo);nr=s(yi,"LongT5Model"),yi.forEach(o),ar=s(po," forward method, overrides the "),Wo=d(po,"CODE",{});var wi=i(Wo);sr=s(wi,"__call__"),wi.forEach(o),rr=s(po," special method."),po.forEach(o),dr=h(Be),k(be.$$.fragment,Be),ir=h(Be),k(ve.$$.fragment,Be),Be.forEach(o),R.forEach(o),Mn=h(t),se=d(t,"H2",{class:!0});var Jn=i(se);ke=d(Jn,"A",{id:!0,class:!0,href:!0});var $i=i(ke);Uo=d($i,"SPAN",{});var xi=i(Uo);k(ft.$$.fragment,xi),xi.forEach(o),$i.forEach(o),lr=h(Jn),Ho=d(Jn,"SPAN",{});var zi=i(Ho);cr=s(zi,"LongT5ForConditionalGeneration"),zi.forEach(o),Jn.forEach(o),En=h(t),M=d(t,"DIV",{class:!0});var J=i(M);k(_t.$$.fragment,J),pr=h(J),Tt=d(J,"P",{});var Vn=i(Tt);ur=s(Vn,"LONGT5 Model with a "),Yo=d(Vn,"CODE",{});var Li=i(Yo);hr=s(Li,"language modeling"),Li.forEach(o),mr=s(Vn," head on top."),Vn.forEach(o),gr=h(J),bt=d(J,"P",{});var Kn=i(bt);fr=s(Kn,"The LongT5 model was proposed in "),vt=d(Kn,"A",{href:!0,rel:!0});var qi=i(vt);_r=s(qi,`LongT5: Efficient Text-To-Text Transformer for Long
Sequences`),qi.forEach(o),Tr=s(Kn,` by Mandy Guo, Joshua Ainslie, David Uthus, Santiago Ontanon, Jianmo
Ni, Yun-Hsuan Sung and Yinfei Yang. It\u2019s an encoder-decoder transformer pre-trained in a text-to-text denoising
generative setting. LongT5 model is an extension of T5 model, and it enables using one of the two different
efficient attention mechanisms - (1) Local attention, or (2) Transient-Global attention.`),Kn.forEach(o),br=h(J),kt=d(J,"P",{});var Zn=i(kt);vr=s(Zn,"This model inherits from "),no=d(Zn,"A",{href:!0});var ji=i(no);kr=s(ji,"PreTrainedModel"),ji.forEach(o),yr=s(Zn,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
