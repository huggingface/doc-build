import{S as pT,i as fT,s as gT,e as r,k as c,w as v,t as n,Y as Oo,M as uT,c as a,d as t,m,a as i,x as T,h as s,Z as Po,b as _,G as e,g as f,y,q as $,o as L,B as x,v as _T,L as je}from"../../chunks/vendor-hf-doc-builder.js";import{T as Ae}from"../../chunks/Tip-hf-doc-builder.js";import{D as W}from"../../chunks/Docstring-hf-doc-builder.js";import{C as Le}from"../../chunks/CodeBlock-hf-doc-builder.js";import{I as Oe}from"../../chunks/IconCopyLink-hf-doc-builder.js";import{E as Ce}from"../../chunks/ExampleCodeBlock-hf-doc-builder.js";function wT(M){let l,k,h,p,b;return p=new Le({props:{code:`from transformers import LongformerConfig, LongformerModel
...
first positional argument :`),Fe.forEach(t),X=m(w),q=a(w,"UL",{});var O=i(q);j=a(O,"LI",{});var V=i(j);ne=s(V,"a single Tensor with "),U=a(V,"CODE",{});var Me=i(U);de=s(Me,"input_ids"),Me.forEach(t),se=s(V," only and nothing else: "),B=a(V,"CODE",{});var ye=i(B);ge=s(ye,"model(inputs_ids)"),ye.forEach(t),V.forEach(t),ce=m(O),C=a(O,"LI",{});var I=i(C);ue=s(I,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),Q=a(I,"CODE",{});var ke=i(Q);re=s(ke,"model([input_ids, attention_mask])"),ke.forEach(t),K=s(I," or "),H=a(I,"CODE",{});var ve=i(H);ae=s(ve,"model([input_ids, attention_mask, token_type_ids])"),ve.forEach(t),I.forEach(t),_e=m(O),N=a(O,"LI",{});var oe=i(N);ie=s(oe,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),R=a(oe,"CODE",{});var Ee=i(R);we=s(Ee,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),Ee.forEach(t),oe.forEach(t),O.forEach(t)},m(w,F){f(w,l,F),e(l,k),f(w,h,F),f(w,p,F),e(p,b),e(b,d),e(p,u),e(p,E),e(E,he),f(w,J,F),f(w,z,F),e(z,Z),e(z,S),e(S,ee),e(z,pe),e(z,D),e(D,fe),e(z,le),f(w,G,F),f(w,P,F),e(P,te),f(w,X,F),f(w,q,F),e(q,j),e(j,ne),e(j,U),e(U,de),e(j,se),e(j,B),e(B,ge),e(q,ce),e(q,C),e(C,ue),e(C,Q),e(Q,re),e(C,K),e(C,H),e(H,ae),e(q,_e),e(q,N),e(N,ie),e(N,R),e(R,we)},d(w){w&&t(l),w&&t(h),w&&t(p),w&&t(J),w&&t(z),w&&t(G),w&&t(P),w&&t(X),w&&t(q)}}}function ST(M){let l,k,h,p,b;return{c(){l=r("p"),k=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),h=r("code"),p=n("Module"),b=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(d){l=a(d,"P",{});var u=i(l);k=s(u,"Although the recipe for forward pass needs to be defined within this function, one should call the "),h=a(u,"CODE",{});var E=i(h);p=s(E,"Module"),E.forEach(t),b=s(u,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
first positional argument :`),Fe.forEach(t),X=m(w),q=a(w,"UL",{});var O=i(q);j=a(O,"LI",{});var V=i(j);ne=s(V,"a single Tensor with "),U=a(V,"CODE",{});var Me=i(U);de=s(Me,"input_ids"),Me.forEach(t),se=s(V," only and nothing else: "),B=a(V,"CODE",{});var ye=i(B);ge=s(ye,"model(inputs_ids)"),ye.forEach(t),V.forEach(t),ce=m(O),C=a(O,"LI",{});var I=i(C);ue=s(I,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),Q=a(I,"CODE",{});var ke=i(Q);re=s(ke,"model([input_ids, attention_mask])"),ke.forEach(t),K=s(I," or "),H=a(I,"CODE",{});var ve=i(H);ae=s(ve,"model([input_ids, attention_mask, token_type_ids])"),ve.forEach(t),I.forEach(t),_e=m(O),N=a(O,"LI",{});var oe=i(N);ie=s(oe,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),R=a(oe,"CODE",{});var Ee=i(R);we=s(Ee,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),Ee.forEach(t),oe.forEach(t),O.forEach(t)},m(w,F){f(w,l,F),e(l,k),f(w,h,F),f(w,p,F),e(p,b),e(b,d),e(p,u),e(p,E),e(E,he),f(w,J,F),f(w,z,F),e(z,Z),e(z,S),e(S,ee),e(z,pe),e(z,D),e(D,fe),e(z,le),f(w,G,F),f(w,P,F),e(P,te),f(w,X,F),f(w,q,F),e(q,j),e(j,ne),e(j,U),e(U,de),e(j,se),e(j,B),e(B,ge),e(q,ce),e(q,C),e(C,ue),e(C,Q),e(Q,re),e(C,K),e(C,H),e(H,ae),e(q,_e),e(q,N),e(N,ie),e(N,R),e(R,we)},d(w){w&&t(l),w&&t(h),w&&t(p),w&&t(J),w&&t(z),w&&t(G),w&&t(P),w&&t(X),w&&t(q)}}}function QT(M){let l,k,h,p,b;return{c(){l=r("p"),k=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),h=r("code"),p=n("Module"),b=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(d){l=a(d,"P",{});var u=i(l);k=s(u,"Although the recipe for forward pass needs to be defined within this function, one should call the "),h=a(u,"CODE",{});var E=i(h);p=s(E,"Module"),E.forEach(t),b=s(u,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
first positional argument :`),Fe.forEach(t),X=m(w),q=a(w,"UL",{});var O=i(q);j=a(O,"LI",{});var V=i(j);ne=s(V,"a single Tensor with "),U=a(V,"CODE",{});var Me=i(U);de=s(Me,"input_ids"),Me.forEach(t),se=s(V," only and nothing else: "),B=a(V,"CODE",{});var ye=i(B);ge=s(ye,"model(inputs_ids)"),ye.forEach(t),V.forEach(t),ce=m(O),C=a(O,"LI",{});var I=i(C);ue=s(I,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),Q=a(I,"CODE",{});var ke=i(Q);re=s(ke,"model([input_ids, attention_mask])"),ke.forEach(t),K=s(I," or "),H=a(I,"CODE",{});var ve=i(H);ae=s(ve,"model([input_ids, attention_mask, token_type_ids])"),ve.forEach(t),I.forEach(t),_e=m(O),N=a(O,"LI",{});var oe=i(N);ie=s(oe,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),R=a(oe,"CODE",{});var Ee=i(R);we=s(Ee,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),Ee.forEach(t),oe.forEach(t),O.forEach(t)},m(w,F){f(w,l,F),e(l,k),f(w,h,F),f(w,p,F),e(p,b),e(b,d),e(p,u),e(p,E),e(E,he),f(w,J,F),f(w,z,F),e(z,Z),e(z,S),e(S,ee),e(z,pe),e(z,D),e(D,fe),e(z,le),f(w,G,F),f(w,P,F),e(P,te),f(w,X,F),f(w,q,F),e(q,j),e(j,ne),e(j,U),e(U,de),e(j,se),e(j,B),e(B,ge),e(q,ce),e(q,C),e(C,ue),e(C,Q),e(Q,re),e(C,K),e(C,H),e(H,ae),e(q,_e),e(q,N),e(N,ie),e(N,R),e(R,we)},d(w){w&&t(l),w&&t(h),w&&t(p),w&&t(J),w&&t(z),w&&t(G),w&&t(P),w&&t(X),w&&t(q)}}}function VT(M){let l,k,h,p,b;return{c(){l=r("p"),k=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),h=r("code"),p=n("Module"),b=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(d){l=a(d,"P",{});var u=i(l);k=s(u,"Although the recipe for forward pass needs to be defined within this function, one should call the "),h=a(u,"CODE",{});var E=i(h);p=s(E,"Module"),E.forEach(t),b=s(u,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
first positional argument :`),Fe.forEach(t),X=m(w),q=a(w,"UL",{});var O=i(q);j=a(O,"LI",{});var V=i(j);ne=s(V,"a single Tensor with "),U=a(V,"CODE",{});var Me=i(U);de=s(Me,"input_ids"),Me.forEach(t),se=s(V," only and nothing else: "),B=a(V,"CODE",{});var ye=i(B);ge=s(ye,"model(inputs_ids)"),ye.forEach(t),V.forEach(t),ce=m(O),C=a(O,"LI",{});var I=i(C);ue=s(I,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),Q=a(I,"CODE",{});var ke=i(Q);re=s(ke,"model([input_ids, attention_mask])"),ke.forEach(t),K=s(I," or "),H=a(I,"CODE",{});var ve=i(H);ae=s(ve,"model([input_ids, attention_mask, token_type_ids])"),ve.forEach(t),I.forEach(t),_e=m(O),N=a(O,"LI",{});var oe=i(N);ie=s(oe,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),R=a(oe,"CODE",{});var Ee=i(R);we=s(Ee,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),Ee.forEach(t),oe.forEach(t),O.forEach(t)},m(w,F){f(w,l,F),e(l,k),f(w,h,F),f(w,p,F),e(p,b),e(b,d),e(p,u),e(p,E),e(E,he),f(w,J,F),f(w,z,F),e(z,Z),e(z,S),e(S,ee),e(z,pe),e(z,D),e(D,fe),e(z,le),f(w,G,F),f(w,P,F),e(P,te),f(w,X,F),f(w,q,F),e(q,j),e(j,ne),e(j,U),e(U,de),e(j,se),e(j,B),e(B,ge),e(q,ce),e(q,C),e(C,ue),e(C,Q),e(Q,re),e(C,K),e(C,H),e(H,ae),e(q,_e),e(q,N),e(N,ie),e(N,R),e(R,we)},d(w){w&&t(l),w&&t(h),w&&t(p),w&&t(J),w&&t(z),w&&t(G),w&&t(P),w&&t(X),w&&t(q)}}}function XT(M){let l,k,h,p,b;return{c(){l=r("p"),k=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),h=r("code"),p=n("Module"),b=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(d){l=a(d,"P",{});var u=i(l);k=s(u,"Although the recipe for forward pass needs to be defined within this function, one should call the "),h=a(u,"CODE",{});var E=i(h);p=s(E,"Module"),E.forEach(t),b=s(u,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
first positional argument :`),Fe.forEach(t),X=m(w),q=a(w,"UL",{});var O=i(q);j=a(O,"LI",{});var V=i(j);ne=s(V,"a single Tensor with "),U=a(V,"CODE",{});var Me=i(U);de=s(Me,"input_ids"),Me.forEach(t),se=s(V," only and nothing else: "),B=a(V,"CODE",{});var ye=i(B);ge=s(ye,"model(inputs_ids)"),ye.forEach(t),V.forEach(t),ce=m(O),C=a(O,"LI",{});var I=i(C);ue=s(I,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),Q=a(I,"CODE",{});var ke=i(Q);re=s(ke,"model([input_ids, attention_mask])"),ke.forEach(t),K=s(I," or "),H=a(I,"CODE",{});var ve=i(H);ae=s(ve,"model([input_ids, attention_mask, token_type_ids])"),ve.forEach(t),I.forEach(t),_e=m(O),N=a(O,"LI",{});var oe=i(N);ie=s(oe,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),R=a(oe,"CODE",{});var Ee=i(R);we=s(Ee,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),Ee.forEach(t),oe.forEach(t),O.forEach(t)},m(w,F){f(w,l,F),e(l,k),f(w,h,F),f(w,p,F),e(p,b),e(b,d),e(p,u),e(p,E),e(E,he),f(w,J,F),f(w,z,F),e(z,Z),e(z,S),e(S,ee),e(z,pe),e(z,D),e(D,fe),e(z,le),f(w,G,F),f(w,P,F),e(P,te),f(w,X,F),f(w,q,F),e(q,j),e(j,ne),e(j,U),e(U,de),e(j,se),e(j,B),e(B,ge),e(q,ce),e(q,C),e(C,ue),e(C,Q),e(Q,re),e(C,K),e(C,H),e(H,ae),e(q,_e),e(q,N),e(N,ie),e(N,R),e(R,we)},d(w){w&&t(l),w&&t(h),w&&t(p),w&&t(J),w&&t(z),w&&t(G),w&&t(P),w&&t(X),w&&t(q)}}}function ty(M){let l,k,h,p,b;return{c(){l=r("p"),k=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),h=r("code"),p=n("Module"),b=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(d){l=a(d,"P",{});var u=i(l);k=s(u,"Although the recipe for forward pass needs to be defined within this function, one should call the "),h=a(u,"CODE",{});var E=i(h);p=s(E,"Module"),E.forEach(t),b=s(u,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
<p>Indices can be obtained using <a href="/docs/transformers/v4.20.1/en/model_doc/longformer#transformers.LongformerTokenizer">LongformerTokenizer</a>. See <a href="/docs/transformers/v4.20.1/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
...
<p>A <a
  href="/docs/transformers/v4.20.1/en/model_doc/longformer#transformers.models.longformer.modeling_longformer.LongformerBaseModelOutputWithPooling"
...
elements depending on the configuration (<a
  href="/docs/transformers/v4.20.1/en/model_doc/longformer#transformers.LongformerConfig"
...
Used to hide legacy arguments that have been deprecated.`,name:"kwargs"}],source:"https://github.com/huggingface/transformers/blob/v4.20.1/src/transformers/models/longformer/modeling_longformer.py#L1759",returnDescription:`
<p>A <a
  href="/docs/transformers/v4.20.1/en/model_doc/longformer#transformers.models.longformer.modeling_longformer.LongformerMaskedLMOutput"
...
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.20.1/src/transformers/models/longformer/modeling_longformer.py#L1868",returnDescription:`
<p>A <a
  href="/docs/transformers/v4.20.1/en/model_doc/longformer#transformers.models.longformer.modeling_longformer.LongformerSequenceClassifierOutput"
...
<code>input_ids</code> above)`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.20.1/src/transformers/models/longformer/modeling_longformer.py#L2223",returnDescription:`
<p>A <a
  href="/docs/transformers/v4.20.1/en/model_doc/longformer#transformers.models.longformer.modeling_longformer.LongformerMultipleChoiceModelOutput"
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.20.1/src/transformers/models/longformer/modeling_longformer.py#L2137",returnDescription:`
<p>A <a
  href="/docs/transformers/v4.20.1/en/model_doc/longformer#transformers.models.longformer.modeling_longformer.LongformerTokenClassifierOutput"
...
`}}),mn=new Ae({props:{$$slots:{default:[qT]},$$scope:{ctx:M}}}),hn=new Ce({props:{anchor:"transformers.LongformerForTokenClassification.forward.example",$$slots:{default:[CT]},$$scope:{ctx:M}}}),pn=new Ce({props:{anchor:"transformers.LongformerForTokenClassification.forward.example-2",$$slots:{default:[jT]},$$scope:{ctx:M}}}),Zs=new Oe({}),er=new W({props:{name:"class transformers.LongformerForQuestionAnswering",anchor:"transformers.LongformerForQuestionAnswering",parameters:[{name:"config",val:""}],parametersDescription:[{anchor:"transformers.LongformerForQuestionAnswering.config",description:`<strong>config</strong> (<a href="/docs/transformers/v4.20.1/en/model_doc/longformer#transformers.LongformerConfig">LongformerConfig</a>) &#x2014; Model configuration class with all the parameters of the
model. Initializing with a config file does not load the weights associated with the model, only the
...
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/v4.20.1/src/transformers/models/longformer/modeling_longformer.py#L1996",returnDescription:`
<p>A <a
  href="/docs/transformers/v4.20.1/en/model_doc/longformer#transformers.models.longformer.modeling_longformer.LongformerQuestionAnsweringModelOutput"
...
behaviors between training and evaluation).`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/v4.20.1/src/transformers/models/longformer/modeling_tf_longformer.py#L2033"}}),kn=new Ae({props:{$$slots:{default:[AT]},$$scope:{ctx:M}}}),pr=new Oe({}),fr=new W({props:{name:"class transformers.TFLongformerForMaskedLM",anchor:"transformers.TFLongformerForMaskedLM",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.TFLongformerForMaskedLM.config",description:`<strong>config</strong> (<a href="/docs/transformers/v4.20.1/en/model_doc/longformer#transformers.LongformerConfig">LongformerConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
...
Labels for computing the masked language modeling loss. Indices should be in <code>[-100, 0, ..., config.vocab_size]</code> (see <code>input_ids</code> docstring) Tokens with indices set to <code>-100</code> are ignored (masked), the
loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.20.1/src/transformers/models/longformer/modeling_tf_longformer.py#L2101",returnDescription:`
<p>A <a
  href="/docs/transformers/v4.20.1/en/model_doc/longformer#transformers.models.longformer.modeling_tf_longformer.TFLongformerMaskedLMOutput"
...
Labels for position (index) of the end of the labelled span for computing the token classification loss.
Positions are clamped to the length of the sequence (<em>sequence_length</em>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/v4.20.1/src/transformers/models/longformer/modeling_tf_longformer.py#L2196",returnDescription:`
<p>A <a
  href="/docs/transformers/v4.20.1/en/model_doc/longformer#transformers.models.longformer.modeling_tf_longformer.TFLongformerQuestionAnsweringModelOutput"
...
Whether or not to use the model in training mode (some modules like dropout modules have different
behaviors between training and evaluation).`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/v4.20.1/src/transformers/models/longformer/modeling_tf_longformer.py#L2347",returnDescription:`
<p>A <a
  href="/docs/transformers/v4.20.1/en/model_doc/longformer#transformers.models.longformer.modeling_tf_longformer.TFLongformerSequenceClassifierOutput"
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.20.1/src/transformers/models/longformer/modeling_tf_longformer.py#L2587",returnDescription:`
<p>A <a
  href="/docs/transformers/v4.20.1/en/model_doc/longformer#transformers.models.longformer.modeling_tf_longformer.TFLongformerTokenClassifierOutput"
...
where <code>num_choices</code> is the size of the second dimension of the input tensors. (See <code>input_ids</code> above)`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.20.1/src/transformers/models/longformer/modeling_tf_longformer.py#L2456",returnDescription:`
<p>A <a
  href="/docs/transformers/v4.20.1/en/model_doc/longformer#transformers.models.longformer.modeling_tf_longformer.TFLongformerMultipleChoiceModelOutput"
...
trained and should be used as follows:`),Bd=c(),v(Jn.$$.fragment),Wd=c(),Pt=r("h2"),Do=r("a"),pi=r("span"),v(Xn.$$.fragment),Th=c(),fi=r("span"),yh=n("LongformerConfig"),Qd=c(),He=r("div"),v(Yn.$$.fragment),$h=c(),Nt=r("p"),Lh=n("This is the configuration class to store the configuration of a "),Yr=r("a"),xh=n("LongformerModel"),Fh=n(" or a "),Zr=r("a"),Mh=n("TFLongformerModel"),Eh=n(`. It
...
length 4,096.`),Nh=c(),It=r("p"),Ah=n("The "),ta=r("a"),Ih=n("LongformerConfig"),Sh=n(" class directly inherits "),oa=r("a"),Dh=n("RobertaConfig"),Bh=n(`. It reuses the same defaults. Please check the
parent class for more information.`),Wh=c(),v(Bo.$$.fragment),Ud=c(),St=r("h2"),Wo=r("a"),gi=r("span"),v(es.$$.fragment),Qh=c(),ui=r("span"),Uh=n("LongformerTokenizer"),Hd=c(),gt=r("div"),v(ts.$$.fragment),Hh=c(),_i=r("p"),Rh=n("Construct a Longformer tokenizer."),Vh=c(),Qo=r("p"),na=r("a"),Gh=n("LongformerTokenizer"),Kh=n(" is identical to "),sa=r("a"),Jh=n("RobertaTokenizer"),Xh=n(`. Refer to the superclass for usage examples and
...
kernel to be memory and compute efficient.`),lf=c(),rt=r("div"),v(Fs.$$.fragment),df=c(),so=r("p"),cf=n("The "),da=r("a"),mf=n("LongformerModel"),hf=n(" forward method, overrides the "),Bi=r("code"),pf=n("__call__"),ff=n(" special method."),gf=c(),v(Go.$$.fragment),uf=c(),v(Ko.$$.fragment),mc=c(),ro=r("h2"),Jo=r("a"),Wi=r("span"),v(Ms.$$.fragment),_f=c(),Qi=r("span"),wf=n("LongformerForMaskedLM"),hc=c(),Re=r("div"),v(Es.$$.fragment),kf=c(),zs=r("p"),bf=n("Longformer Model with a "),Ui=r("code"),vf=n("language modeling"),Tf=n(" head on top."),yf=c(),qs=r("p"),$f=n("This model inherits from "),ca=r("a"),Lf=n("PreTrainedModel"),xf=n(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Ff=c(),Cs=r("p"),Mf=n("This model is also a PyTorch "),js=r("a"),Ef=n("torch.nn.Module"),zf=n(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),qf=c(),Qe=r("div"),v(Os.$$.fragment),Cf=c(),ao=r("p"),jf=n("The "),ma=r("a"),Of=n("LongformerForMaskedLM"),Pf=n(" forward method, overrides the "),Hi=r("code"),Nf=n("__call__"),Af=n(" special method."),If=c(),v(Xo.$$.fragment),Sf=c(),v(Yo.$$.fragment),Df=c(),Ri=r("p"),Bf=n("Let\u2019s try a very long input."),Wf=c(),v(Zo.$$.fragment),pc=c(),io=r("h2"),en=r("a"),Vi=r("span"),v(Ps.$$.fragment),Qf=c(),Gi=r("span"),Uf=n("LongformerForSequenceClassification"),fc=c(),Ve=r("div"),v(Ns.$$.fragment),Hf=c(),Ki=r("p"),Rf=n(`Longformer Model transformer with a sequence classification/regression head on top (a linear layer on top of the
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),tg=c(),Ne=r("div"),v(Ds.$$.fragment),og=c(),lo=r("p"),ng=n("The "),pa=r("a"),sg=n("LongformerForSequenceClassification"),rg=n(" forward method, overrides the "),Ji=r("code"),ag=n("__call__"),ig=n(" special method."),lg=c(),v(tn.$$.fragment),dg=c(),v(on.$$.fragment),cg=c(),v(nn.$$.fragment),mg=c(),v(sn.$$.fragment),hg=c(),v(rn.$$.fragment),gc=c(),co=r("h2"),an=r("a"),Xi=r("span"),v(Bs.$$.fragment),pg=c(),Yi=r("span"),fg=n("LongformerForMultipleChoice"),uc=c(),Ge=r("div"),v(Ws.$$.fragment),gg=c(),Zi=r("p"),ug=n(`Longformer Model with a multiple choice classification head on top (a linear layer on top of the pooled output and
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),ak=c(),v(Bn.$$.fragment),ik=c(),lt=r("div"),v(Qr.$$.fragment),lk=c(),zo=r("p"),dk=n("The "),Ca=r("a"),ck=n("TFLongformerForMultipleChoice"),mk=n(" forward method, overrides the "),Pl=r("code"),hk=n("__call__"),pk=n(" special method."),fk=c(),v(Wn.$$.fragment),gk=c(),v(Qn.$$.fragment),this.h()},l(o){const g=uT('[data-svelte="svelte-1phssyn"]',document.head);l=a(g,"META",{name:!0,content:!0}),g.forEach(t),k=m(o),h=a(o,"H1",{class:!0});var Ur=i(h);p=a(Ur,"A",{id:!0,class:!0,href:!0});var Nl=i(p);b=a(Nl,"SPAN",{});var Al=i(b);T(d.$$.fragment,Al),Al.forEach(t),Nl.forEach(t),u=m(Ur),E=a(Ur,"SPAN",{});var Il=i(E);he=s(Il,"Longformer"),Il.forEach(t),Ur.forEach(t),J=m(o),z=a(o,"H2",{class:!0});var Hr=i(z);Z=a(Hr,"A",{id:!0,class:!0,href:!0});var Sl=i(Z);S=a(Sl,"SPAN",{});var Dl=i(S);T(ee.$$.fragment,Dl),Dl.forEach(t),Sl.forEach(t),pe=m(Hr),D=a(Hr,"SPAN",{});var Bl=i(D);fe=s(Bl,"Overview"),Bl.forEach(t),Hr.forEach(t),le=m(o),G=a(o,"P",{});var Rr=i(G);P=s(Rr,"The Longformer model was presented in "),te=a(Rr,"A",{href:!0,rel:!0});var Wl=i(te);X=s(Wl,"Longformer: The Long-Document Transformer"),Wl.forEach(t),q=s(Rr," by Iz Beltagy, Matthew E. Peters, Arman Cohan."),Rr.forEach(t),j=m(o),ne=a(o,"P",{});var Ql=i(ne);U=s(Ql,"The abstract from the paper is the following:"),Ql.forEach(t),de=m(o),se=a(o,"P",{});var Ul=i(se);B=a(Ul,"EM",{});var Hl=i(B);ge=s(Hl,`Transformer-based models are unable to process long sequences due to their self-attention operation, which scales
quadratically with the sequence length. To address this limitation, we introduce the Longformer with an attention
mechanism that scales linearly with sequence length, making it easy to process documents of thousands of tokens or
longer. Longformer\u2019s attention mechanism is a drop-in replacement for the standard self-attention and combines a local
windowed attention with a task motivated global attention. Following prior work on long-sequence transformers, we
...
trained and should be used as follows:`),md.forEach(t),Bd=m(o),T(Jn.$$.fragment,o),Wd=m(o),Pt=a(o,"H2",{class:!0});var Ac=i(Pt);Do=a(Ac,"A",{id:!0,class:!0,href:!0});var yk=i(Do);pi=a(yk,"SPAN",{});var $k=i(pi);T(Xn.$$.fragment,$k),$k.forEach(t),yk.forEach(t),Th=m(Ac),fi=a(Ac,"SPAN",{});var Lk=i(fi);yh=s(Lk,"LongformerConfig"),Lk.forEach(t),Ac.forEach(t),Qd=m(o),He=a(o,"DIV",{class:!0});var Tt=i(He);T(Yn.$$.fragment,Tt),$h=m(Tt),Nt=a(Tt,"P",{});var ja=i(Nt);Lh=s(ja,"This is the configuration class to store the configuration of a "),Yr=a(ja,"A",{href:!0});var xk=i(Yr);xh=s(xk,"LongformerModel"),xk.forEach(t),Fh=s(ja," or a "),Zr=a(ja,"A",{href:!0});var Fk=i(Zr);Mh=s(Fk,"TFLongformerModel"),Fk.forEach(t),Eh=s(ja,`. It
...
attention are more relevant for autoregressive language modeling than finetuning on downstream tasks. Future
release will add support for autoregressive attention, but the support for dilated attention requires a custom CUDA
kernel to be memory and compute efficient.`),rm.forEach(t),lf=m(nt),rt=a(nt,"DIV",{class:!0});var Un=i(rt);T(Fs.$$.fragment,Un),df=m(Un),so=a(Un,"P",{});var Sa=i(so);cf=s(Sa,"The "),da=a(Sa,"A",{href:!0});var ub=i(da);mf=s(ub,"LongformerModel"),ub.forEach(t),hf=s(Sa," forward method, overrides the "),Bi=a(Sa,"CODE",{});var _b=i(Bi);pf=s(_b,"__call__"),_b.forEach(t),ff=s(Sa," special method."),Sa.forEach(t),gf=m(Un),T(Go.$$.fragment,Un),uf=m(Un),T(Ko.$$.fragment,Un),Un.forEach(t),nt.forEach(t),mc=m(o),ro=a(o,"H2",{class:!0});var am=i(ro);Jo=a(am,"A",{id:!0,class:!0,href:!0});var wb=i(Jo);Wi=a(wb,"SPAN",{});var kb=i(Wi);T(Ms.$$.fragment,kb),kb.forEach(t),wb.forEach(t),_f=m(am),Qi=a(am,"SPAN",{});var bb=i(Qi);wf=s(bb,"LongformerForMaskedLM"),bb.forEach(t),am.forEach(t),hc=m(o),Re=a(o,"DIV",{class:!0});var yt=i(Re);T(Es.$$.fragment,yt),kf=m(yt),zs=a(yt,"P",{});var im=i(zs);bf=s(im,"Longformer Model with a "),Ui=a(im,"CODE",{});var vb=i(Ui);vf=s(vb,"language modeling"),vb.forEach(t),Tf=s(im," head on top."),im.forEach(t),yf=m(yt),qs=a(yt,"P",{});var lm=i(qs);$f=s(lm,"This model inherits from "),ca=a(lm,"A",{href:!0});var Tb=i(ca);Lf=s(Tb,"PreTrainedModel"),Tb.forEach(t),xf=s(lm,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),dm.forEach(t),qf=m(yt),Qe=a(yt,"DIV",{class:!0});var dt=i(Qe);T(Os.$$.fragment,dt),Cf=m(dt),ao=a(dt,"P",{});var Da=i(ao);jf=s(Da,"The "),ma=a(Da,"A",{href:!0});var $b=i(ma);Of=s($b,"LongformerForMaskedLM"),$b.forEach(t),Pf=s(Da," forward method, overrides the "),Hi=a(Da,"CODE",{});var Lb=i(Hi);Nf=s(Lb,"__call__"),Lb.forEach(t),Af=s(Da," special method."),Da.forEach(t),If=m(dt),T(Xo.$$.fragment,dt),Sf=m(dt),T(Yo.$$.fragment,dt),Df=m(dt),Ri=a(dt,"P",{});var xb=i(Ri);Bf=s(xb,"Let\u2019s try a very long input."),xb.forEach(t),Wf=m(dt),T(Zo.$$.fragment,dt),dt.forEach(t),yt.forEach(t),pc=m(o),io=a(o,"H2",{class:!0});var cm=i(io);en=a(cm,"A",{id:!0,class:!0,href:!0});var Fb=i(en);Vi=a(Fb,"SPAN",{});var Mb=i(Vi);T(Ps.$$.fragment,Mb),Mb.forEach(t),Fb.forEach(t),Qf=m(cm),Gi=a(cm,"SPAN",{});var Eb=i(Gi);Uf=s(Eb,"LongformerForSequenceClassification"),Eb.forEach(t),cm.forEach(t),fc=m(o),Ve=a(o,"DIV",{class:!0});var $t=i(Ve);T(Ns.$$.fragment,$t),Hf=m($t),Ki=a($t,"P",{});var zb=i(Ki);Rf=s(zb,`Longformer Model transformer with a sequence classification/regression head on top (a linear layer on top of the
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),hm.forEach(t),tg=m($t),Ne=a($t,"DIV",{class:!0});var st=i(Ne);T(Ds.$$.fragment,st),og=m(st),lo=a(st,"P",{});var Ba=i(lo);ng=s(Ba,"The "),pa=a(Ba,"A",{href:!0});var jb=i(pa);sg=s(jb,"LongformerForSequenceClassification"),jb.forEach(t),rg=s(Ba," forward method, overrides the "),Ji=a(Ba,"CODE",{});var Ob=i(Ji);ag=s(Ob,"__call__"),Ob.forEach(t),ig=s(Ba," special method."),Ba.forEach(t),lg=m(st),T(tn.$$.fragment,st),dg=m(st),T(on.$$.fragment,st),cg=m(st),T(nn.$$.fragment,st),mg=m(st),T(sn.$$.fragment,st),hg=m(st),T(rn.$$.fragment,st),st.forEach(t),$t.forEach(t),gc=m(o),co=a(o,"H2",{class:!0});var pm=i(co);an=a(pm,"A",{id:!0,class:!0,href:!0});var Pb=i(an);Xi=a(Pb,"SPAN",{});var Nb=i(Xi);T(Bs.$$.fragment,Nb),Nb.forEach(t),Pb.forEach(t),pg=m(pm),Yi=a(pm,"SPAN",{});var Ab=i(Yi);fg=s(Ab,"LongformerForMultipleChoice"),Ab.forEach(t),pm.forEach(t),uc=m(o),Ge=a(o,"DIV",{class:!0});var Lt=i(Ge);T(Ws.$$.fragment,Lt),gg=m(Lt),Zi=a(Lt,"P",{});var Ib=i(Zi);ug=s(Ib,`Longformer Model with a multiple choice classification head on top (a linear layer on top of the pooled output and
a softmax) e.g. for RocStories/SWAG tasks.`),Ib.forEach(t),_g=m(Lt),Qs=a(Lt,"P",{});var fm=i(Qs);wg=s(fm,"This model inherits from "),fa=a(fm,"A",{href:!0});var Sb=i(fa);kg=s(Sb,"PreTrainedModel"),Sb.forEach(t),bg=s(fm,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),gm.forEach(t),Lg=m(Lt),at=a(Lt,"DIV",{class:!0});var Hn=i(at);T(Rs.$$.fragment,Hn),xg=m(Hn),mo=a(Hn,"P",{});var Wa=i(mo);Fg=s(Wa,"The "),ga=a(Wa,"A",{href:!0});var Bb=i(ga);Mg=s(Bb,"LongformerForMultipleChoice"),Bb.forEach(t),Eg=s(Wa," forward method, overrides the "),el=a(Wa,"CODE",{});var Wb=i(el);zg=s(Wb,"__call__"),Wb.forEach(t),qg=s(Wa," special method."),Wa.forEach(t),Cg=m(Hn),T(ln.$$.fragment,Hn),jg=m(Hn),T(dn.$$.fragment,Hn),Hn.forEach(t),Lt.forEach(t),_c=m(o),ho=a(o,"H2",{class:!0});var um=i(ho);cn=a(um,"A",{id:!0,class:!0,href:!0});var Qb=i(cn);tl=a(Qb,"SPAN",{});var Ub=i(tl);T(Vs.$$.fragment,Ub),Ub.forEach(t),Qb.forEach(t),Og=m(um),ol=a(um,"SPAN",{});var Hb=i(ol);Pg=s(Hb,"LongformerForTokenClassification"),Hb.forEach(t),um.forEach(t),wc=m(o),Ke=a(o,"DIV",{class:!0});var xt=i(Ke);T(Gs.$$.fragment,xt),Ng=m(xt),nl=a(xt,"P",{});var Rb=i(nl);Ag=s(Rb,`Longformer Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g.
for Named-Entity-Recognition (NER) tasks.`),Rb.forEach(t),Ig=m(xt),Ks=a(xt,"P",{});var _m=i(Ks);Sg=s(_m,"This model inherits from "),ua=a(_m,"A",{href:!0});var Vb=i(ua);Dg=s(Vb,"PreTrainedModel"),Vb.forEach(t),Bg=s(_m,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),_m.forEach(t),Wg=m(xt),Js=a(xt,"P",{});var wm=i(Js);Qg=s(wm,"This model is also a PyTorch "),Xs=a(wm,"A",{href:!0,rel:!0});var Gb=i(Xs);Ug=s(Gb,"torch.nn.Module"),Gb.forEach(t),Hg=s(wm,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),wm.forEach(t),Rg=m(xt),Ye=a(xt,"DIV",{class:!0});var Ft=i(Ye);T(Ys.$$.fragment,Ft),Vg=m(Ft),po=a(Ft,"P",{});var Qa=i(po);Gg=s(Qa,"The "),_a=a(Qa,"A",{href:!0});var Kb=i(_a);Kg=s(Kb,"LongformerForTokenClassification"),Kb.forEach(t),Jg=s(Qa," forward method, overrides the "),sl=a(Qa,"CODE",{});var Jb=i(sl);Xg=s(Jb,"__call__"),Jb.forEach(t),Yg=s(Qa," special method."),Qa.forEach(t),Zg=m(Ft),T(mn.$$.fragment,Ft),eu=m(Ft),T(hn.$$.fragment,Ft),tu=m(Ft),T(pn.$$.fragment,Ft),Ft.forEach(t),xt.forEach(t),kc=m(o),fo=a(o,"H2",{class:!0});var km=i(fo);fn=a(km,"A",{id:!0,class:!0,href:!0});var Xb=i(fn);rl=a(Xb,"SPAN",{});var Yb=i(rl);T(Zs.$$.fragment,Yb),Yb.forEach(t),Xb.forEach(t),ou=m(km),al=a(km,"SPAN",{});var Zb=i(al);nu=s(Zb,"LongformerForQuestionAnswering"),Zb.forEach(t),km.forEach(t),bc=m(o),Je=a(o,"DIV",{class:!0});var Mt=i(Je);T(er.$$.fragment,Mt),su=m(Mt),go=a(Mt,"P",{});var Ua=i(go);ru=s(Ua,`Longformer Model with a span classification head on top for extractive question-answering tasks like SQuAD /
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),$m.forEach(t),Su=m(Ue),T(wn.$$.fragment,Ue),Du=m(Ue),wo=a(Ue,"P",{});var Ra=i(wo);Bu=s(Ra,"This class copies code from "),va=a(Ra,"A",{href:!0});var hv=i(va);Wu=s(hv,"TFRobertaModel"),hv.forEach(t),Qu=s(Ra,` and overwrites standard self-attention with longformer
self-attention to provide the ability to process long sequences following the self-attention approach described in
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),qm.forEach(t),B_=m(mt),yr=a(mt,"P",{});var Cm=i(yr);W_=s(Cm,"This model is also a "),$r=a(Cm,"A",{href:!0,rel:!0});var qv=i($r);Q_=s(qv,"tf.keras.Model"),qv.forEach(t),U_=s(Cm,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Pm.forEach(t),fw=m(ht),T(qn.$$.fragment,ht),gw=m(ht),tt=a(ht,"DIV",{class:!0});var qt=i(tt);T(qr.$$.fragment,qt),uw=m(qt),xo=a(qt,"P",{});var Ya=i(xo);_w=s(Ya,"The "),Ma=a(Ya,"A",{href:!0});var Dv=i(Ma);ww=s(Dv,"TFLongformerForSequenceClassification"),Dv.forEach(t),kw=s(Ya," forward method, overrides the "),Fl=a(Ya,"CODE",{});var Bv=i(Fl);bw=s(Bv,"__call__"),Bv.forEach(t),vw=s(Ya," special method."),Ya.forEach(t),Tw=m(qt),T(Cn.$$.fragment,qt),yw=m(qt),T(jn.$$.fragment,qt),$w=m(qt),T(On.$$.fragment,qt),qt.forEach(t),ht.forEach(t),Ec=m(o),Fo=a(o,"H2",{class:!0});var Nm=i(Fo);Pn=a(Nm,"A",{id:!0,class:!0,href:!0});var Wv=i(Pn);Ml=a(Wv,"SPAN",{});var Qv=i(Ml);T(Cr.$$.fragment,Qv),Qv.forEach(t),Wv.forEach(t),Lw=m(Nm),El=a(Nm,"SPAN",{});var Uv=i(El);xw=s(Uv,"TFLongformerForTokenClassification"),Uv.forEach(t),Nm.forEach(t),zc=m(o),Be=a(o,"DIV",{class:!0});var pt=i(Be);T(jr.$$.fragment,pt),Fw=m(pt),zl=a(pt,"P",{});var Hv=i(zl);Mw=s(Hv,`Longformer Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g.
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Im.forEach(t),Aw=m(pt),T(Nn.$$.fragment,pt),Iw=m(pt),ot=a(pt,"DIV",{class:!0});var Ct=i(ot);T(Ar.$$.fragment,Ct),Sw=m(Ct),Mo=a(Ct,"P",{});var Za=i(Mo);Dw=s(Za,"The "),za=a(Za,"A",{href:!0});var Gv=i(za);Bw=s(Gv,"TFLongformerForTokenClassification"),Gv.forEach(t),Ww=s(Za," forward method, overrides the "),ql=a(Za,"CODE",{});var Kv=i(ql);Qw=s(Kv,"__call__"),Kv.forEach(t),Uw=s(Za," special method."),Za.forEach(t),Hw=m(Ct),T(An.$$.fragment,Ct),Rw=m(Ct),T(In.$$.fragment,Ct),Vw=m(Ct),T(Sn.$$.fragment,Ct),Ct.forEach(t),pt.forEach(t),qc=m(o),Eo=a(o,"H2",{class:!0});var Sm=i(Eo);Dn=a(Sm,"A",{id:!0,class:!0,href:!0});var Jv=i(Dn);Cl=a(Jv,"SPAN",{});var Xv=i(Cl);T(Ir.$$.fragment,Xv),Xv.forEach(t),Jv.forEach(t),Gw=m(Sm),jl=a(Sm,"SPAN",{});var Yv=i(jl);Kw=s(Yv,"TFLongformerForMultipleChoice"),Yv.forEach(t),Sm.forEach(t),Cc=m(o),We=a(o,"DIV",{class:!0});var ft=i(We);T(Sr.$$.fragment,ft),Jw=m(ft),Ol=a(ft,"P",{});var Zv=i(Ol);Xw=s(Zv,`Longformer Model with a multiple choice classification head on top (a linear layer on top of the pooled output and
