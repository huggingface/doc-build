import{S as Y1,i as Z1,s as J1,e as a,k as d,w as b,t as o,M as X1,c as r,d as t,m as c,a as i,x as k,h as s,b as h,G as e,g as m,y,q as w,o as $,B as x,v as Q1,L as ge}from"../../chunks/vendor-hf-doc-builder.js";import{T as wt}from"../../chunks/Tip-hf-doc-builder.js";import{D as C}from"../../chunks/Docstring-hf-doc-builder.js";import{C as S}from"../../chunks/CodeBlock-hf-doc-builder.js";import{I as be}from"../../chunks/IconCopyLink-hf-doc-builder.js";import{E as _e}from"../../chunks/ExampleCodeBlock-hf-doc-builder.js";function e5(j){let p,v,g,u,T;return{c(){p=a("p"),v=o("Although the recipe for forward pass needs to be defined within this function, one should call the "),g=a("code"),u=o("Module"),T=o(`
...
model.parallelize(device_map)  <span class="hljs-comment"># Splits the model across several devices</span>
model.deparallelize()  <span class="hljs-comment"># Put the model back on cpu and cleans memory by calling torch.cuda.empty_cache()</span>`}}),{c(){p=a("p"),v=o("Example:"),g=d(),b(u.$$.fragment)},l(l){p=r(l,"P",{});var _=i(p);v=s(_,"Example:"),_.forEach(t),g=c(l),k(u.$$.fragment,l)},m(l,_){m(l,p,_),e(p,v),m(l,g,_),y(u,l,_),T=!0},p:ge,i(l){T||(w(u.$$.fragment,l),T=!0)},o(l){$(u.$$.fragment,l),T=!1},d(l){l&&t(p),l&&t(g),x(u,l)}}}function h5(j){let p,v,g,u,T,l,_,q,qe,se,E,ee,G,ae,Ee,U,Fe,ke,B,A,re,pe,M,N,he,K,ye,ue,W,Me,we,P,Ce,H,V,Te,O,Pe,ve,I,Ne,R,Oe;return{c(){p=a("p"),v=o("TF 2.0 models accepts two formats as inputs:"),g=d(),u=a("ul"),T=a("li"),l=o("having all inputs as keyword arguments (like PyTorch models), or"),_=d(),q=a("li"),qe=o("having all inputs as a list, tuple or dict in the first positional arguments."),se=d(),E=a("p"),ee=o("This second option is useful when using "),G=a("code"),ae=o("tf.keras.Model.fit"),Ee=o(` method which currently requires having all the
tensors in the first argument of the model call function: `),U=a("code"),Fe=o("model(inputs)"),ke=o("."),B=d(),A=a("p"),re=o(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
...
tensors in the first argument of the model call function: `),U=r(D,"CODE",{});var ne=i(U);Fe=s(ne,"model(inputs)"),ne.forEach(t),ke=s(D,"."),D.forEach(t),B=c(z),A=r(z,"P",{});var tt=i(A);re=s(tt,`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
...
`),R=r(Ie,"CODE",{});var st=i(R);Oe=s(st,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),st.forEach(t),Ie.forEach(t),L.forEach(t)},m(z,F){m(z,p,F),e(p,v),m(z,g,F),m(z,u,F),e(u,T),e(T,l),e(u,_),e(u,q),e(q,qe),m(z,se,F),m(z,E,F),e(E,ee),e(E,G),e(G,ae),e(E,Ee),e(E,U),e(U,Fe),e(E,ke),m(z,B,F),m(z,A,F),e(A,re),m(z,pe,F),m(z,M,F),e(M,N),e(N,he),e(N,K),e(K,ye),e(N,ue),e(N,W),e(W,Me),e(M,we),e(M,P),e(P,Ce),e(P,H),e(H,V),e(P,Te),e(P,O),e(O,Pe),e(M,ve),e(M,I),e(I,Ne),e(I,R),e(R,Oe)},d(z){z&&t(p),z&&t(g),z&&t(u),z&&t(se),z&&t(E),z&&t(B),z&&t(A),z&&t(pe),z&&t(M)}}}function u5(j){let p,v,g,u,T;return{c(){p=a("p"),v=o("Although the recipe for forward pass needs to be defined within this function, one should call the "),g=a("code"),u=o("Module"),T=o(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(l){p=r(l,"P",{});var _=i(p);v=s(_,"Although the recipe for forward pass needs to be defined within this function, one should call the "),g=r(_,"CODE",{});var q=i(g);u=s(q,"Module"),q.forEach(t),T=s(_,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),{c(){p=a("p"),v=o("Examples:"),g=d(),b(u.$$.fragment)},l(l){p=r(l,"P",{});var _=i(p);v=s(_,"Examples:"),_.forEach(t),g=c(l),k(u.$$.fragment,l)},m(l,_){m(l,p,_),e(p,v),m(l,g,_),y(u,l,_),T=!0},p:ge,i(l){T||(w(u.$$.fragment,l),T=!0)},o(l){$(u.$$.fragment,l),T=!1},d(l){l&&t(p),l&&t(g),x(u,l)}}}function f5(j){let p,v,g,u,T,l,_,q,qe,se,E,ee,G,ae,Ee,U,Fe,ke,B,A,re,pe,M,N,he,K,ye,ue,W,Me,we,P,Ce,H,V,Te,O,Pe,ve,I,Ne,R,Oe;return{c(){p=a("p"),v=o("TF 2.0 models accepts two formats as inputs:"),g=d(),u=a("ul"),T=a("li"),l=o("having all inputs as keyword arguments (like PyTorch models), or"),_=d(),q=a("li"),qe=o("having all inputs as a list, tuple or dict in the first positional arguments."),se=d(),E=a("p"),ee=o("This second option is useful when using "),G=a("code"),ae=o("tf.keras.Model.fit"),Ee=o(` method which currently requires having all the
tensors in the first argument of the model call function: `),U=a("code"),Fe=o("model(inputs)"),ke=o("."),B=d(),A=a("p"),re=o(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),pe=d(),M=a("ul"),N=a("li"),he=o("a single Tensor with "),K=a("code"),ye=o("input_ids"),ue=o(" only and nothing else: "),W=a("code"),Me=o("model(inputs_ids)"),we=d(),P=a("li"),Ce=o(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),H=a("code"),V=o("model([input_ids, attention_mask])"),Te=o(" or "),O=a("code"),Pe=o("model([input_ids, attention_mask, token_type_ids])"),ve=d(),I=a("li"),Ne=o(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),R=a("code"),Oe=o('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(z){p=r(z,"P",{});var F=i(p);v=s(F,"TF 2.0 models accepts two formats as inputs:"),F.forEach(t),g=c(z),u=r(z,"UL",{});var te=i(u);T=r(te,"LI",{});var Ge=i(T);l=s(Ge,"having all inputs as keyword arguments (like PyTorch models), or"),Ge.forEach(t),_=c(te),q=r(te,"LI",{});var et=i(q);qe=s(et,"having all inputs as a list, tuple or dict in the first positional arguments."),et.forEach(t),te.forEach(t),se=c(z),E=r(z,"P",{});var D=i(E);ee=s(D,"This second option is useful when using "),G=r(D,"CODE",{});var Ue=i(G);ae=s(Ue,"tf.keras.Model.fit"),Ue.forEach(t),Ee=s(D,` method which currently requires having all the
...
first positional argument :`),tt.forEach(t),pe=c(z),M=r(z,"UL",{});var L=i(M);N=r(L,"LI",{});var Y=i(N);he=s(Y,"a single Tensor with "),K=r(Y,"CODE",{});var nt=i(K);ye=s(nt,"input_ids"),nt.forEach(t),ue=s(Y," only and nothing else: "),W=r(Y,"CODE",{});var Le=i(W);Me=s(Le,"model(inputs_ids)"),Le.forEach(t),Y.forEach(t),we=c(L),P=r(L,"LI",{});var Z=i(P);Ce=s(Z,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),H=r(Z,"CODE",{});var ot=i(H);V=s(ot,"model([input_ids, attention_mask])"),ot.forEach(t),Te=s(Z," or "),O=r(Z,"CODE",{});var Ae=i(O);Pe=s(Ae,"model([input_ids, attention_mask, token_type_ids])"),Ae.forEach(t),Z.forEach(t),ve=c(L),I=r(L,"LI",{});var Ie=i(I);Ne=s(Ie,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),R=r(Ie,"CODE",{});var st=i(R);Oe=s(st,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),st.forEach(t),Ie.forEach(t),L.forEach(t)},m(z,F){m(z,p,F),e(p,v),m(z,g,F),m(z,u,F),e(u,T),e(T,l),e(u,_),e(u,q),e(q,qe),m(z,se,F),m(z,E,F),e(E,ee),e(E,G),e(G,ae),e(E,Ee),e(E,U),e(U,Fe),e(E,ke),m(z,B,F),m(z,A,F),e(A,re),m(z,pe,F),m(z,M,F),e(M,N),e(N,he),e(N,K),e(K,ye),e(N,ue),e(N,W),e(W,Me),e(M,we),e(M,P),e(P,Ce),e(P,H),e(H,V),e(P,Te),e(P,O),e(O,Pe),e(M,ve),e(M,I),e(I,Ne),e(I,R),e(R,Oe)},d(z){z&&t(p),z&&t(g),z&&t(u),z&&t(se),z&&t(E),z&&t(B),z&&t(A),z&&t(pe),z&&t(M)}}}function _5(j){let p,v,g,u,T;return{c(){p=a("p"),v=o("Although the recipe for forward pass needs to be defined within this function, one should call the "),g=a("code"),u=o("Module"),T=o(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(l){p=r(l,"P",{});var _=i(p);v=s(_,"Although the recipe for forward pass needs to be defined within this function, one should call the "),g=r(_,"CODE",{});var q=i(g);u=s(q,"Module"),q.forEach(t),T=s(_,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-built_in">print</span>(tokenizer.decode(outputs[<span class="hljs-number">0</span>], skip_special_tokens=<span class="hljs-literal">True</span>))
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-comment"># studies have shown that owning a dog is good for you</span>`}}),{c(){p=a("p"),v=o("Examples:"),g=d(),b(u.$$.fragment)},l(l){p=r(l,"P",{});var _=i(p);v=s(_,"Examples:"),_.forEach(t),g=c(l),k(u.$$.fragment,l)},m(l,_){m(l,p,_),e(p,v),m(l,g,_),y(u,l,_),T=!0},p:ge,i(l){T||(w(u.$$.fragment,l),T=!0)},o(l){$(u.$$.fragment,l),T=!1},d(l){l&&t(p),l&&t(g),x(u,l)}}}function T5(j){let p,v,g,u,T,l,_,q,qe,se,E,ee,G,ae,Ee,U,Fe,ke,B,A,re,pe,M,N,he,K,ye,ue,W,Me,we,P,Ce,H,V,Te,O,Pe,ve,I,Ne,R,Oe;return{c(){p=a("p"),v=o("TF 2.0 models accepts two formats as inputs:"),g=d(),u=a("ul"),T=a("li"),l=o("having all inputs as keyword arguments (like PyTorch models), or"),_=d(),q=a("li"),qe=o("having all inputs as a list, tuple or dict in the first positional arguments."),se=d(),E=a("p"),ee=o("This second option is useful when using "),G=a("code"),ae=o("tf.keras.Model.fit"),Ee=o(` method which currently requires having all the
tensors in the first argument of the model call function: `),U=a("code"),Fe=o("model(inputs)"),ke=o("."),B=d(),A=a("p"),re=o(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),pe=d(),M=a("ul"),N=a("li"),he=o("a single Tensor with "),K=a("code"),ye=o("input_ids"),ue=o(" only and nothing else: "),W=a("code"),Me=o("model(inputs_ids)"),we=d(),P=a("li"),Ce=o(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),H=a("code"),V=o("model([input_ids, attention_mask])"),Te=o(" or "),O=a("code"),Pe=o("model([input_ids, attention_mask, token_type_ids])"),ve=d(),I=a("li"),Ne=o(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),R=a("code"),Oe=o('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(z){p=r(z,"P",{});var F=i(p);v=s(F,"TF 2.0 models accepts two formats as inputs:"),F.forEach(t),g=c(z),u=r(z,"UL",{});var te=i(u);T=r(te,"LI",{});var Ge=i(T);l=s(Ge,"having all inputs as keyword arguments (like PyTorch models), or"),Ge.forEach(t),_=c(te),q=r(te,"LI",{});var et=i(q);qe=s(et,"having all inputs as a list, tuple or dict in the first positional arguments."),et.forEach(t),te.forEach(t),se=c(z),E=r(z,"P",{});var D=i(E);ee=s(D,"This second option is useful when using "),G=r(D,"CODE",{});var Ue=i(G);ae=s(Ue,"tf.keras.Model.fit"),Ue.forEach(t),Ee=s(D,` method which currently requires having all the
...
first positional argument :`),tt.forEach(t),pe=c(z),M=r(z,"UL",{});var L=i(M);N=r(L,"LI",{});var Y=i(N);he=s(Y,"a single Tensor with "),K=r(Y,"CODE",{});var nt=i(K);ye=s(nt,"input_ids"),nt.forEach(t),ue=s(Y," only and nothing else: "),W=r(Y,"CODE",{});var Le=i(W);Me=s(Le,"model(inputs_ids)"),Le.forEach(t),Y.forEach(t),we=c(L),P=r(L,"LI",{});var Z=i(P);Ce=s(Z,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),H=r(Z,"CODE",{});var ot=i(H);V=s(ot,"model([input_ids, attention_mask])"),ot.forEach(t),Te=s(Z," or "),O=r(Z,"CODE",{});var Ae=i(O);Pe=s(Ae,"model([input_ids, attention_mask, token_type_ids])"),Ae.forEach(t),Z.forEach(t),ve=c(L),I=r(L,"LI",{});var Ie=i(I);Ne=s(Ie,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),R=r(Ie,"CODE",{});var st=i(R);Oe=s(st,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),st.forEach(t),Ie.forEach(t),L.forEach(t)},m(z,F){m(z,p,F),e(p,v),m(z,g,F),m(z,u,F),e(u,T),e(T,l),e(u,_),e(u,q),e(q,qe),m(z,se,F),m(z,E,F),e(E,ee),e(E,G),e(G,ae),e(E,Ee),e(E,U),e(U,Fe),e(E,ke),m(z,B,F),m(z,A,F),e(A,re),m(z,pe,F),m(z,M,F),e(M,N),e(N,he),e(N,K),e(K,ye),e(N,ue),e(N,W),e(W,Me),e(M,we),e(M,P),e(P,Ce),e(P,H),e(H,V),e(P,Te),e(P,O),e(O,Pe),e(M,ve),e(M,I),e(I,Ne),e(I,R),e(R,Oe)},d(z){z&&t(p),z&&t(g),z&&t(u),z&&t(se),z&&t(E),z&&t(B),z&&t(A),z&&t(pe),z&&t(M)}}}function v5(j){let p,v,g,u,T;return{c(){p=a("p"),v=o("Although the recipe for forward pass needs to be defined within this function, one should call the "),g=a("code"),u=o("Module"),T=o(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(l){p=r(l,"P",{});var _=i(p);v=s(_,"Although the recipe for forward pass needs to be defined within this function, one should call the "),g=r(_,"CODE",{});var q=i(g);u=s(q,"Module"),q.forEach(t),T=s(_,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
<span class="hljs-meta">&gt;&gt;&gt; </span>outputs = model.decode(decoder_input_ids, encoder_outputs)
<span class="hljs-meta">&gt;&gt;&gt; </span>logits = outputs.logits`}}),{c(){p=a("p"),v=o("Example:"),g=d(),b(u.$$.fragment)},l(l){p=r(l,"P",{});var _=i(p);v=s(_,"Example:"),_.forEach(t),g=c(l),k(u.$$.fragment,l)},m(l,_){m(l,p,_),e(p,v),m(l,g,_),y(u,l,_),T=!0},p:ge,i(l){T||(w(u.$$.fragment,l),T=!0)},o(l){$(u.$$.fragment,l),T=!1},d(l){l&&t(p),l&&t(g),x(u,l)}}}function E5(j){let p,v,g,u,T,l,_,q,qe,se,E,ee,G,ae,Ee,U,Fe,ke,B,A,re,pe,M,N,he,K,ye,ue,W,Me,we,P,Ce,H,V,Te,O,Pe,ve,I,Ne,R,Oe,z,F,te,Ge,et,D,Ue,ne,tt,L,Y,nt,Le,Z,ot,Ae,Ie,st,Ld,Ka,Hp,Ad,Be,ri,ii,Po,Vp,Kp,li,di,No,Yp,Zp,ci,pi,Oo,Jp,Xp,hi,ui,Lo,Qp,eh,mi,Ya,Ao,th,nh,Id,Za,oh,Dd,$t,fi,cn,_i,sh,ah,Ja,rh,ih,lh,gi,pn,Ti,dh,ch,Xa,ph,hh,uh,vi,hn,bi,mh,fh,Qa,_h,gh,Sd,un,Th,Io,vh,bh,Gd,xt,kh,Do,yh,wh,So,$h,xh,Ud,er,Bd,Ot,mn,ki,Go,zh,yi,jh,Wd,at,qh,wi,Eh,Fh,$i,Mh,Ch,xi,Ph,Nh,Rd,fn,Oh,tr,Lh,Ah,Hd,nr,zi,Ih,Vd,me,Dh,ji,Sh,Gh,qi,Uh,Bh,Ei,Wh,Rh,Fi,Hh,Vh,Mi,Kh,Yh,or,Zh,Jh,Kd,sr,Xh,Yd,Uo,Zd,_n,Qh,Bo,eu,tu,Jd,ar,Ci,nu,Xd,rr,ou,Qd,Wo,ec,oe,su,Pi,au,ru,Ni,iu,lu,Oi,du,cu,Li,pu,hu,Ai,uu,mu,Ii,fu,_u,Di,gu,Tu,tc,zt,vu,Si,bu,ku,Gi,yu,wu,nc,fe,$u,Ui,xu,zu,Bi,ju,qu,Wi,Eu,Fu,Ri,Mu,Cu,Ro,Pu,Nu,Hi,Ou,Lu,oc,Ho,sc,ir,Au,ac,lr,Vo,Iu,Vi,Du,Su,rc,jt,Gu,Ko,Uu,Bu,Yo,Wu,Ru,ic,gn,Hu,Ki,Vu,Ku,lc,dr,dc,Lt,Tn,Yi,Zo,Yu,Zi,Zu,cc,rt,Ju,cr,Xu,Qu,Jo,em,tm,Xo,nm,om,pc,Qo,hc,We,sm,Ji,am,rm,Xi,im,lm,pr,dm,cm,Qi,pm,hm,uc,hr,um,mc,es,fc,ur,mm,_c,ts,gc,mr,Tc,At,vn,el,ns,fm,tl,_m,vc,it,gm,os,Tm,vm,nl,bm,km,ol,ym,wm,bc,It,bn,sl,ss,$m,al,xm,kc,fr,zm,yc,kn,rl,Dt,jm,as,qm,Em,rs,Fm,Mm,Cm,il,De,Pm,is,Nm,Om,ls,Lm,Am,ds,Im,Dm,cs,Sm,Gm,ps,Um,Bm,wc,St,yn,ll,hs,Wm,dl,Rm,$c,bt,us,Hm,kt,Vm,_r,Km,Ym,gr,Zm,Jm,ms,Xm,Qm,ef,Gt,tf,Tr,nf,of,vr,sf,af,xc,Ut,wn,cl,fs,rf,pl,lf,zc,ie,_s,df,gs,cf,Ts,pf,hf,uf,vs,mf,br,ff,_f,gf,qt,bs,Tf,hl,vf,bf,ks,kr,kf,ul,yf,wf,yr,$f,ml,xf,zf,$n,ys,jf,ws,qf,fl,Ef,Ff,Mf,xn,$s,Cf,_l,Pf,Nf,wr,xs,jc,Bt,zn,gl,zs,Of,Tl,Lf,qc,Se,js,Af,Wt,If,vl,Df,Sf,qs,Gf,Uf,Bf,Es,Wf,$r,Rf,Hf,Vf,Et,Fs,Kf,bl,Yf,Zf,Ms,xr,Jf,kl,Xf,Qf,zr,e_,yl,t_,n_,jn,Cs,o_,wl,s_,Ec,Rt,qn,$l,Ps,a_,xl,r_,Fc,J,Ns,i_,zl,l_,d_,Os,c_,Ls,p_,h_,u_,As,m_,jr,f_,__,g_,Is,T_,Ds,v_,b_,k_,lt,Ss,y_,Ht,w_,qr,$_,x_,jl,z_,j_,q_,En,E_,Fn,F_,dt,Gs,M_,ql,C_,P_,El,N_,O_,Mn,L_,Ft,Us,A_,Fl,I_,D_,Cn,Mc,Vt,Pn,Ml,Bs,S_,Cl,G_,Cc,X,Ws,U_,Rs,B_,Pl,W_,R_,H_,Hs,V_,Vs,K_,Y_,Z_,Ks,J_,Er,X_,Q_,eg,Ys,tg,Zs,ng,og,sg,ct,Js,ag,Kt,rg,Fr,ig,lg,Nl,dg,cg,pg,Nn,hg,On,ug,pt,Xs,mg,Ol,fg,_g,Ll,gg,Tg,Ln,vg,Mt,Qs,bg,Al,kg,yg,An,Pc,Yt,In,Il,ea,wg,Dl,$g,Nc,Q,ta,xg,Sl,zg,jg,na,qg,oa,Eg,Fg,Mg,sa,Cg,Mr,Pg,Ng,Og,aa,Lg,ra,Ag,Ig,Dg,ht,ia,Sg,Zt,Gg,Cr,Ug,Bg,Gl,Wg,Rg,Hg,Dn,Vg,Sn,Kg,ut,la,Yg,Ul,Zg,Jg,Bl,Xg,Qg,Gn,eT,Ct,da,tT,Wl,nT,oT,Un,Oc,Jt,Bn,Rl,ca,sT,Hl,aT,Lc,le,pa,rT,Vl,iT,lT,ha,dT,ua,cT,pT,hT,ma,uT,Pr,mT,fT,_T,fa,gT,_a,TT,vT,bT,Wn,kT,mt,ga,yT,Xt,wT,Nr,$T,xT,Kl,zT,jT,qT,Rn,ET,Hn,Ac,Qt,Vn,Yl,Ta,FT,Zl,MT,Ic,de,va,CT,ba,PT,Jl,NT,OT,LT,ka,AT,ya,IT,DT,ST,wa,GT,Or,UT,BT,WT,$a,RT,xa,HT,VT,KT,Kn,YT,ft,za,ZT,en,JT,Lr,XT,QT,Xl,ev,tv,nv,Yn,ov,Zn,Dc,tn,Jn,Ql,ja,sv,ed,av,Sc,ce,qa,rv,td,iv,lv,Ea,dv,Fa,cv,pv,hv,Ma,uv,Ar,mv,fv,_v,Ca,gv,Pa,Tv,vv,bv,Xn,kv,_t,Na,yv,nn,wv,Ir,$v,xv,nd,zv,jv,qv,Qn,Ev,eo,Gc,on,to,od,Oa,Fv,sd,Mv,Uc,Je,La,Cv,gt,Aa,Pv,sn,Nv,ad,Ov,Lv,rd,Av,Iv,Dv,no,Sv,oo,Gv,so,Ia,Uv,ao,Bv,ro,Da,Wv,io,Bc,an,lo,id,Sa,Rv,ld,Hv,Wc,Xe,Ga,Vv,Tt,Ua,Kv,rn,Yv,dd,Zv,Jv,cd,Xv,Qv,eb,co,tb,po,nb,ho,Ba,ob,uo,sb,mo,Wa,ab,fo,Rc;return l=new be({}),ae=new be({}),Go=new be({}),Uo=new S({props:{code:`from transformers import T5Tokenizer, T5ForConditionalGeneration
...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/v4.20.1/src/transformers/models/t5/tokenization_t5.py#L249",returnDescription:`
...
Whether or not the token list is already formatted with special tokens for the model.`,name:"already_has_special_tokens"}],source:"https://github.com/huggingface/transformers/blob/v4.20.1/src/transformers/models/t5/tokenization_t5.py#L188",returnDescription:`
...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/v4.20.1/src/transformers/models/t5/tokenization_t5.py#L227",returnDescription:`
<p>List of zeros.</p>
`,returnType:`
<p><code>List[int]</code></p>
`}}),xs=new C({props:{name:"save_vocabulary",anchor:"transformers.T5Tokenizer.save_vocabulary",parameters:[{name:"save_directory",val:": str"},{name:"filename_prefix",val:": typing.Optional[str] = None"}],source:"https://github.com/huggingface/transformers/blob/v4.20.1/src/transformers/models/t5/tokenization_t5.py#L324"}}),zs=new be({}),js=new C({props:{name:"class transformers.T5TokenizerFast",anchor:"transformers.T5TokenizerFast",parameters:[{name:"vocab_file",val:" = None"},{name:"tokenizer_file",val:" = None"},{name:"eos_token",val:" = '</s>'"},{name:"unk_token",val:" = '<unk>'"},{name:"pad_token",val:" = '<pad>'"},{name:"extra_ids",val:" = 100"},{name:"additional_special_tokens",val:" = None"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.T5TokenizerFast.vocab_file",description:`<strong>vocab_file</strong> (<code>str</code>) &#x2014;
<a href="https://github.com/google/sentencepiece" rel="nofollow">SentencePiece</a> file (generally has a <em>.spm</em> extension) that
...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/v4.20.1/src/transformers/models/t5/tokenization_t5_fast.py#L191",returnDescription:`
<p>List of <a href="../glossary#input-ids">input IDs</a> with the appropriate special tokens.</p>
`,returnType:`
<p><code>List[int]</code></p>
...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/v4.20.1/src/transformers/models/t5/tokenization_t5_fast.py#L217",returnDescription:`
<p>List of zeros.</p>
`,returnType:`
<p><code>List[int]</code></p>
...
<p>Indices can be obtained using <a href="/docs/transformers/v4.20.1/en/model_doc/t5#transformers.T5Tokenizer">T5Tokenizer</a>. See <a href="/docs/transformers/v4.20.1/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/v4.20.1/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for detail.</p>
...
Whether or not to return a <a href="/docs/transformers/v4.20.1/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/v4.20.1/src/transformers/models/t5/modeling_t5.py#L1343",returnDescription:`
<p>A <a
...
elements depending on the configuration (<a
  href="/docs/transformers/v4.20.1/en/model_doc/t5#transformers.T5Config"
...
labels in <code>[0, ..., config.vocab_size]</code>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.20.1/src/transformers/models/t5/modeling_t5.py#L1537",returnDescription:`
<p>A <a
...
Whether or not to return a <a href="/docs/transformers/v4.20.1/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/v4.20.1/src/transformers/models/t5/modeling_t5.py#L1808",returnDescription:`
<p>A <a
...
<li>t5-3b: 24</li>
<li>t5-11b: 24</li>
</ul>`,name:"device_map"}],source:"https://github.com/huggingface/transformers/blob/v4.20.1/src/transformers/models/t5/modeling_t5.py#L1771"}}),Gn=new _e({props:{anchor:"transformers.T5EncoderModel.parallelize.example",$$slots:{default:[c5]},$$scope:{ctx:j}}}),da=new C({props:{name:"deparallelize",anchor:"transformers.T5EncoderModel.deparallelize",parameters:[],source:"https://github.com/huggingface/transformers/blob/v4.20.1/src/transformers/models/t5/modeling_t5.py#L1782"}}),Un=new _e({props:{anchor:"transformers.T5EncoderModel.deparallelize.example",$$slots:{default:[p5]},$$scope:{ctx:j}}}),ca=new be({}),pa=new C({props:{name:"class transformers.TFT5Model",anchor:"transformers.TFT5Model",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.TFT5Model.config",description:`<strong>config</strong> (<a href="/docs/transformers/v4.20.1/en/model_doc/t5#transformers.T5Config">T5Config</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
...
behaviors between training and evaluation).`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/v4.20.1/src/transformers/models/t5/modeling_tf_t5.py#L1137",returnDescription:`
<p>A <a
...
Labels for computing the cross entropy classification loss. Indices should be in <code>[0, ..., config.vocab_size - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.20.1/src/transformers/models/t5/modeling_tf_t5.py#L1313",returnDescription:`
<p>A <a
...
Indices of input sequence tokens in the vocabulary. T5 is a model with relative position embeddings so you
should be able to pad the inputs on the right or the left.</p>
<p>Indices can be obtained using <a href="/docs/transformers/v4.20.1/en/model_doc/t5#transformers.T5Tokenizer">T5Tokenizer</a>. See <a href="/docs/transformers/v4.20.1/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
<a href="/docs/transformers/v4.20.1/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> for details.</p>
...
Whether or not to use the model in training mode (some modules like dropout modules have different
behaviors between training and evaluation).`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/v4.20.1/src/transformers/models/t5/modeling_tf_t5.py#L1624",returnDescription:`
<p>A <a
...
<p>If <code>past_key_values</code> are used, the user can optionally input only the last <code>decoder_input_ids</code> (those that
don&#x2019;t have their past key value states given to this model) of shape <code>(batch_size, 1)</code> instead of all
<code>decoder_input_ids</code> of shape <code>(batch_size, sequence_length)</code>.`,name:"past_key_values"}],source:"https://github.com/huggingface/transformers/blob/v4.20.1/src/transformers/models/t5/modeling_flax_t5.py#L955",returnDescription:`
<p>A <a
...
to the documentation of byT5 which can be found `),Qa=a("a"),_h=o("here"),gh=o("."),Sd=d(),un=a("p"),Th=o("All checkpoints can be found on the "),Io=a("a"),vh=o("hub"),bh=o("."),Gd=d(),xt=a("p"),kh=o("This model was contributed by "),Do=a("a"),yh=o("thomwolf"),wh=o(". The original code can be found "),So=a("a"),$h=o("here"),xh=o("."),Ud=d(),er=a("a"),Bd=d(),Ot=a("h2"),mn=a("a"),ki=a("span"),b(Go.$$.fragment),zh=d(),yi=a("span"),jh=o("Training"),Wd=d(),at=a("p"),qh=o(`T5 is an encoder-decoder model and converts all NLP problems into a text-to-text format. It is trained using teacher
...
processed as follows:`),Yd=d(),b(Uo.$$.fragment),Zd=d(),_n=a("p"),Qh=o("If you\u2019re interested in pre-training T5 on a new corpus, check out the "),Bo=a("a"),eu=o("run_t5_mlm_flax.py"),tu=o(` script in the Examples
...
the model as follows:`),Qd=d(),b(Wo.$$.fragment),ec=d(),oe=a("p"),su=o("As you can see, only 2 inputs are required for the model in order to compute a loss: "),Pi=a("code"),au=o("input_ids"),ru=o(` (which are the
...
generation works in general in encoder-decoder models.`),pc=d(),b(Qo.$$.fragment),hc=d(),We=a("p"),sm=o("Note that T5 uses the "),Ji=a("code"),am=o("pad_token_id"),rm=o(" as the "),Xi=a("code"),im=o("decoder_start_token_id"),lm=o(`, so when doing generation without using
...
use of token type ids, therefore a list of zeros is returned.`),Nf=d(),wr=a("div"),b(xs.$$.fragment),jc=d(),Bt=a("h2"),zn=a("a"),gl=a("span"),b(zs.$$.fragment),Of=d(),Tl=a("span"),Lf=o("T5TokenizerFast"),qc=d(),Se=a("div"),b(js.$$.fragment),Af=d(),Wt=a("p"),If=o("Construct a \u201Cfast\u201D T5 tokenizer (backed by HuggingFace\u2019s "),vl=a("em"),Df=o("tokenizers"),Sf=o(` library). Based on
...
it will evenly distribute blocks across all devices.`),O_=d(),b(Mn.$$.fragment),L_=d(),Ft=a("div"),b(Us.$$.fragment),A_=d(),Fl=a("p"),I_=o("Moves the model to cpu from a model parallel state."),D_=d(),b(Cn.$$.fragment),Mc=d(),Vt=a("h2"),Pn=a("a"),Ml=a("span"),b(Bs.$$.fragment),S_=d(),Cl=a("span"),G_=o("T5ForConditionalGeneration"),Cc=d(),X=a("div"),b(Ws.$$.fragment),U_=d(),Rs=a("p"),B_=o("T5 Model with a "),Pl=a("code"),W_=o("language modeling"),R_=o(" head on top."),H_=d(),Hs=a("p"),V_=o("The T5 model was proposed in "),Vs=a("a"),K_=o(`Exploring the Limits of Transfer Learning with a Unified Text-to-Text
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Dg=d(),ht=a("div"),b(ia.$$.fragment),Sg=d(),Zt=a("p"),Gg=o("The "),Cr=a("a"),Ug=o("T5EncoderModel"),Bg=o(" forward method, overrides the "),Gl=a("code"),Wg=o("__call__"),Rg=o(" special method."),Hg=d(),b(Dn.$$.fragment),Vg=d(),b(Sn.$$.fragment),Kg=d(),ut=a("div"),b(la.$$.fragment),Yg=d(),Ul=a("p"),Zg=o("This is an experimental feature and is a subject to change at a moment\u2019s notice."),Jg=d(),Bl=a("p"),Xg=o(`Uses a device map to distribute attention modules of the model across several devices. If no device map is given,
it will evenly distribute blocks across all devices.`),Qg=d(),b(Gn.$$.fragment),eT=d(),Ct=a("div"),b(da.$$.fragment),tT=d(),Wl=a("p"),nT=o("Moves the model to cpu from a model parallel state."),oT=d(),b(Un.$$.fragment),Oc=d(),Jt=a("h2"),Bn=a("a"),Rl=a("span"),b(ca.$$.fragment),sT=d(),Hl=a("span"),aT=o("TFT5Model"),Lc=d(),le=a("div"),b(pa.$$.fragment),rT=d(),Vl=a("p"),iT=o("The bare T5 Model transformer outputting raw hidden-stateswithout any specific head on top."),lT=d(),ha=a("p"),dT=o("The T5 model was proposed in "),ua=a("a"),cT=o(`Exploring the Limits of Transfer Learning with a Unified Text-to-Text
...
to the documentation of byT5 which can be found `),Qa=r(Od,"A",{href:!0});var Pb=i(Qa);_h=s(Pb,"here"),Pb.forEach(t),gh=s(Od,"."),Od.forEach(t),Mb.forEach(t),Dr.forEach(t),Sd=c(n),un=r(n,"P",{});var Hc=i(un);Th=s(Hc,"All checkpoints can be found on the "),Io=r(Hc,"A",{href:!0,rel:!0});var Nb=i(Io);vh=s(Nb,"hub"),Nb.forEach(t),bh=s(Hc,"."),Hc.forEach(t),Gd=c(n),xt=r(n,"P",{});var Sr=i(xt);kh=s(Sr,"This model was contributed by "),Do=r(Sr,"A",{href:!0,rel:!0});var Ob=i(Do);yh=s(Ob,"thomwolf"),Ob.forEach(t),wh=s(Sr,". The original code can be found "),So=r(Sr,"A",{href:!0,rel:!0});var Lb=i(So);$h=s(Lb,"here"),Lb.forEach(t),xh=s(Sr,"."),Sr.forEach(t),Ud=c(n),er=r(n,"A",{id:!0}),i(er).forEach(t),Bd=c(n),Ot=r(n,"H2",{class:!0});var Vc=i(Ot);mn=r(Vc,"A",{id:!0,class:!0,href:!0});var Ab=i(mn);ki=r(Ab,"SPAN",{});var Ib=i(ki);k(Go.$$.fragment,Ib),Ib.forEach(t),Ab.forEach(t),zh=c(Vc),yi=r(Vc,"SPAN",{});var Db=i(yi);jh=s(Db,"Training"),Db.forEach(t),Vc.forEach(t),Wd=c(n),at=r(n,"P",{});var _o=i(at);qh=s(_o,`T5 is an encoder-decoder model and converts all NLP problems into a text-to-text format. It is trained using teacher
forcing. This means that for training, we always need an input sequence and a corresponding target sequence. The input
...
start-sequence token. T5 can be trained / fine-tuned both in a supervised and unsupervised fashion.`),_o.forEach(t),Rd=c(n),fn=r(n,"P",{});var Kc=i(fn);Oh=s(Kc,"One can use "),tr=r(Kc,"A",{href:!0});var Bb=i(tr);Lh=s(Bb,"T5ForConditionalGeneration"),Bb.forEach(t),Ah=s(Kc,` (or the Tensorflow/Flax variant), which includes the
language modeling head on top of the decoder.`),Kc.forEach(t),Hd=c(n),nr=r(n,"UL",{});var Wb=i(nr);zi=r(Wb,"LI",{});var Rb=i(zi);Ih=s(Rb,"Unsupervised denoising training"),Rb.forEach(t),Wb.forEach(t),Vd=c(n),me=r(n,"P",{});var Re=i(me);Dh=s(Re,"In this setup, spans of the input sequence are masked by so-called sentinel tokens ("),ji=r(Re,"EM",{});var Hb=i(ji);Sh=s(Hb,"a.k.a"),Hb.forEach(t),Gh=s(Re,` unique mask tokens) and
the output sequence is formed as a concatenation of the same sentinel tokens and the `),qi=r(Re,"EM",{});var Vb=i(qi);Uh=s(Vb,"real"),Vb.forEach(t),Bh=s(Re,` masked tokens. Each
sentinel token represents a unique mask token for this sentence and should start with `),Ei=r(Re,"CODE",{});var Kb=i(Ei);Wh=s(Kb,"<extra_id_0>"),Kb.forEach(t),Rh=s(Re,`,
...
processed as follows:`),Xb.forEach(t),Yd=c(n),k(Uo.$$.fragment,n),Zd=c(n),_n=r(n,"P",{});var Yc=i(_n);Qh=s(Yc,"If you\u2019re interested in pre-training T5 on a new corpus, check out the "),Bo=r(Yc,"A",{href:!0,rel:!0});var Qb=i(Bo);eu=s(Qb,"run_t5_mlm_flax.py"),Qb.forEach(t),tu=s(Yc,` script in the Examples
...
Suppose that we want to fine-tune the model for translation for example, and we have a training example: the input
sequence \u201CThe house is wonderful.\u201D and output sequence \u201CDas Haus ist wunderbar.\u201D, then they should be prepared for
the model as follows:`),nk.forEach(t),Qd=c(n),k(Wo.$$.fragment,n),ec=c(n),oe=r(n,"P",{});var $e=i(oe);su=s($e,"As you can see, only 2 inputs are required for the model in order to compute a loss: "),Pi=r($e,"CODE",{});var ok=i(Pi);au=s(ok,"input_ids"),ok.forEach(t),ru=s($e,` (which are the
...
optimizer. Typically, 1e-4 and 3e-4 work well for most problems (classification, summarization, translation, question
answering, question generation). Note that T5 was pre-trained using the AdaFactor optimizer.`),Zc.forEach(t),vk.forEach(t),rc=c(n),jt=r(n,"P",{});var Ur=i(jt);Gu=s(Ur,"According to "),Ko=r(Ur,"A",{href:!0,rel:!0});var kk=i(Ko);Uu=s(kk,"this forum post"),kk.forEach(t),Bu=s(Ur,`, task prefixes matter when
(1) doing multi-task training (2) your task is similar or related to one of the supervised tasks used in T5\u2019s
...
(`),cs=r(vt,"A",{href:!0,rel:!0});var Qk=i(cs);Sm=s(Qk,"PyTorch"),Qk.forEach(t),Gm=s(vt," and "),ps=r(vt,"A",{href:!0,rel:!0});var ey=i(ps);Um=s(ey,"Tensorflow"),ey.forEach(t),Bm=s(vt,`). These scripts allow
you to easily fine-tune T5 on custom data for summarization/translation.`),vt.forEach(t),Yk.forEach(t),tp.forEach(t),wc=c(n),St=r(n,"H2",{class:!0});var np=i(St);yn=r(np,"A",{id:!0,class:!0,href:!0});var ty=i(yn);ll=r(ty,"SPAN",{});var ny=i(ll);k(hs.$$.fragment,ny),ny.forEach(t),ty.forEach(t),Wm=c(np),dl=r(np,"SPAN",{});var oy=i(dl);Rm=s(oy,"T5Config"),oy.forEach(t),np.forEach(t),$c=c(n),bt=r(n,"DIV",{class:!0});var Wr=i(bt);k(us.$$.fragment,Wr),Hm=c(Wr),kt=r(Wr,"P",{});var vo=i(kt);Vm=s(vo,"This is the configuration class to store the configuration of a "),_r=r(vo,"A",{href:!0});var sy=i(_r);Km=s(sy,"T5Model"),sy.forEach(t),Ym=s(vo," or a "),gr=r(vo,"A",{href:!0});var ay=i(gr);Zm=s(ay,"TFT5Model"),ay.forEach(t),Jm=s(vo,`. It is used to
instantiate a T5 model according to the specified arguments, defining the model architecture. Instantiating a
configuration with the defaults will yield a similar configuration to that of the T5
`),ms=r(vo,"A",{href:!0,rel:!0});var ry=i(ms);Xm=s(ry,"t5-small"),ry.forEach(t),Qm=s(vo," architecture."),vo.forEach(t),ef=c(Wr),Gt=r(Wr,"P",{});var Rr=i(Gt);tf=s(Rr,"Configuration objects inherit from "),Tr=r(Rr,"A",{href:!0});var iy=i(Tr);nf=s(iy,"PretrainedConfig"),iy.forEach(t),of=s(Rr,` and can be used to control the model outputs. Read the
documentation from `),vr=r(Rr,"A",{href:!0});var ly=i(vr);sf=s(ly,"PretrainedConfig"),ly.forEach(t),af=s(Rr," for more information."),Rr.forEach(t),Wr.forEach(t),xc=c(n),Ut=r(n,"H2",{class:!0});var op=i(Ut);wn=r(op,"A",{id:!0,class:!0,href:!0});var dy=i(wn);cl=r(dy,"SPAN",{});var cy=i(cl);k(fs.$$.fragment,cy),cy.forEach(t),dy.forEach(t),rf=c(op),pl=r(op,"SPAN",{});var py=i(pl);lf=s(py,"T5Tokenizer"),py.forEach(t),op.forEach(t),zc=c(n),ie=r(n,"DIV",{class:!0});var Ve=i(ie);k(_s.$$.fragment,Ve),df=c(Ve),gs=r(Ve,"P",{});var sp=i(gs);cf=s(sp,"Construct a T5 tokenizer. Based on "),Ts=r(sp,"A",{href:!0,rel:!0});var hy=i(Ts);pf=s(hy,"SentencePiece"),hy.forEach(t),hf=s(sp,"."),sp.forEach(t),uf=c(Ve),vs=r(Ve,"P",{});var ap=i(vs);mf=s(ap,"This tokenizer inherits from "),br=r(ap,"A",{href:!0});var uy=i(br);ff=s(uy,"PreTrainedTokenizer"),uy.forEach(t),_f=s(ap,` which contains most of the main methods. Users should refer to
...
use of token type ids, therefore a list of zeros is returned.`),Ty.forEach(t),dp.forEach(t),Nf=c(Ve),wr=r(Ve,"DIV",{class:!0});var vy=i(wr);k(xs.$$.fragment,vy),vy.forEach(t),Ve.forEach(t),jc=c(n),Bt=r(n,"H2",{class:!0});var cp=i(Bt);zn=r(cp,"A",{id:!0,class:!0,href:!0});var by=i(zn);gl=r(by,"SPAN",{});var ky=i(gl);k(zs.$$.fragment,ky),ky.forEach(t),by.forEach(t),Of=c(cp),Tl=r(cp,"SPAN",{});var yy=i(Tl);Lf=s(yy,"T5TokenizerFast"),yy.forEach(t),cp.forEach(t),qc=c(n),Se=r(n,"DIV",{class:!0});var Nt=i(Se);k(js.$$.fragment,Nt),Af=c(Nt),Wt=r(Nt,"P",{});var Vr=i(Wt);If=s(Vr,"Construct a \u201Cfast\u201D T5 tokenizer (backed by HuggingFace\u2019s "),vl=r(Vr,"EM",{});var wy=i(vl);Df=s(wy,"tokenizers"),wy.forEach(t),Sf=s(Vr,` library). Based on
...
it will evenly distribute blocks across all devices.`),Sy.forEach(t),O_=c(ko),k(Mn.$$.fragment,ko),ko.forEach(t),L_=c(xe),Ft=r(xe,"DIV",{class:!0});var Zr=i(Ft);k(Us.$$.fragment,Zr),A_=c(Zr),Fl=r(Zr,"P",{});var Gy=i(Fl);I_=s(Gy,"Moves the model to cpu from a model parallel state."),Gy.forEach(t),D_=c(Zr),k(Cn.$$.fragment,Zr),Zr.forEach(t),xe.forEach(t),Mc=c(n),Vt=r(n,"H2",{class:!0});var Tp=i(Vt);Pn=r(Tp,"A",{id:!0,class:!0,href:!0});var Uy=i(Pn);Ml=r(Uy,"SPAN",{});var By=i(Ml);k(Bs.$$.fragment,By),By.forEach(t),Uy.forEach(t),S_=c(Tp),Cl=r(Tp,"SPAN",{});var Wy=i(Cl);G_=s(Wy,"T5ForConditionalGeneration"),Wy.forEach(t),Tp.forEach(t),Cc=c(n),X=r(n,"DIV",{class:!0});var ze=i(X);k(Ws.$$.fragment,ze),U_=c(ze),Rs=r(ze,"P",{});var vp=i(Rs);B_=s(vp,"T5 Model with a "),Pl=r(vp,"CODE",{});var Ry=i(Pl);W_=s(Ry,"language modeling"),Ry.forEach(t),R_=s(vp," head on top."),vp.forEach(t),H_=c(ze),Hs=r(ze,"P",{});var bp=i(Hs);V_=s(bp,"The T5 model was proposed in "),Vs=r(bp,"A",{href:!0,rel:!0});var Hy=i(Vs);K_=s(Hy,`Exploring the Limits of Transfer Learning with a Unified Text-to-Text
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),zp.forEach(t),Dg=c(je),ht=r(je,"DIV",{class:!0});var $o=i(ht);k(ia.$$.fragment,$o),Sg=c($o),Zt=r($o,"P",{});var Qr=i(Zt);Gg=s(Qr,"The "),Cr=r(Qr,"A",{href:!0});var i1=i(Cr);Ug=s(i1,"T5EncoderModel"),i1.forEach(t),Bg=s(Qr," forward method, overrides the "),Gl=r(Qr,"CODE",{});var l1=i(Gl);Wg=s(l1,"__call__"),l1.forEach(t),Rg=s(Qr," special method."),Qr.forEach(t),Hg=c($o),k(Dn.$$.fragment,$o),Vg=c($o),k(Sn.$$.fragment,$o),$o.forEach(t),Kg=c(je),ut=r(je,"DIV",{class:!0});var xo=i(ut);k(la.$$.fragment,xo),Yg=c(xo),Ul=r(xo,"P",{});var d1=i(Ul);Zg=s(d1,"This is an experimental feature and is a subject to change at a moment\u2019s notice."),d1.forEach(t),Jg=c(xo),Bl=r(xo,"P",{});var c1=i(Bl);Xg=s(c1,`Uses a device map to distribute attention modules of the model across several devices. If no device map is given,
it will evenly distribute blocks across all devices.`),c1.forEach(t),Qg=c(xo),k(Gn.$$.fragment,xo),xo.forEach(t),eT=c(je),Ct=r(je,"DIV",{class:!0});var ei=i(Ct);k(da.$$.fragment,ei),tT=c(ei),Wl=r(ei,"P",{});var p1=i(Wl);nT=s(p1,"Moves the model to cpu from a model parallel state."),p1.forEach(t),oT=c(ei),k(Un.$$.fragment,ei),ei.forEach(t),je.forEach(t),Oc=c(n),Jt=r(n,"H2",{class:!0});var jp=i(Jt);Bn=r(jp,"A",{id:!0,class:!0,href:!0});var h1=i(Bn);Rl=r(h1,"SPAN",{});var u1=i(Rl);k(ca.$$.fragment,u1),u1.forEach(t),h1.forEach(t),sT=c(jp),Hl=r(jp,"SPAN",{});var m1=i(Hl);aT=s(m1,"TFT5Model"),m1.forEach(t),jp.forEach(t),Lc=c(n),le=r(n,"DIV",{class:!0});var Ke=i(le);k(pa.$$.fragment,Ke),rT=c(Ke),Vl=r(Ke,"P",{});var f1=i(Vl);iT=s(f1,"The bare T5 Model transformer outputting raw hidden-stateswithout any specific head on top."),f1.forEach(t),lT=c(Ke),ha=r(Ke,"P",{});var qp=i(ha);dT=s(qp,"The T5 model was proposed in "),ua=r(qp,"A",{href:!0,rel:!0});var _1=i(ua);cT=s(_1,`Exploring the Limits of Transfer Learning with a Unified Text-to-Text
