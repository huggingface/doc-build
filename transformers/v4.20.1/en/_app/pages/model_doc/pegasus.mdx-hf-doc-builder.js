...
`),de=s(X,"CODE",{});var dt=a(de);ze=i(dt,"model([input_ids, attention_mask])"),dt.forEach(t),te=i(X," or "),V=s(X,"CODE",{});var Xe=a(V);Ue=i(Xe,"model([input_ids, attention_mask, token_type_ids])"),Xe.forEach(t),X.forEach(t),Be=c(L),B=s(L,"LI",{});var H=a(B);We=i(H,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),oe=s(H,"CODE",{});var lt=a(oe);R=i(lt,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),lt.forEach(t),H.forEach(t),L.forEach(t)},m(x,q){f(x,p,q),e(p,v),f(x,_,q),f(x,h,q),e(h,k),e(k,d),e(h,m),e(h,F),e(F,Oe),f(x,he,q),f(x,E,q),e(E,ke),e(E,ae),e(ae,Ae),e(E,re),e(E,ie),e(ie,Ie),e(E,xe),f(x,D,q),f(x,A,q),e(A,ve),f(x,K,q),f(x,S,q),e(S,O),e(O,Le),e(O,Y),e(Y,ee),e(O,Ge),e(O,U),e(U,Ne),e(S,De),e(S,I),e(I,me),e(I,de),e(de,ze),e(I,te),e(I,V),e(V,Ue),e(S,Be),e(S,B),e(B,We),e(B,oe),e(oe,R)},d(x){x&&t(p),x&&t(_),x&&t(h),x&&t(he),x&&t(E),x&&t(D),x&&t(A),x&&t(K),x&&t(S)}}}function nk(z){let p,v,_,h,k;return{c(){p=n("p"),v=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),_=n("code"),h=r("Module"),k=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(d){p=s(d,"P",{});var m=a(p);v=i(m,"Although the recipe for forward pass needs to be defined within this function, one should call the "),_=s(m,"CODE",{});var F=a(_);h=i(F,"Module"),F.forEach(t),k=i(m,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),{c(){p=n("p"),v=r("Example:"),_=l(),b(h.$$.fragment)},l(d){p=s(d,"P",{});var m=a(p);v=i(m,"Example:"),m.forEach(t),_=c(d),y(h.$$.fragment,d)},m(d,m){f(d,p,m),e(p,v),f(d,_,m),T(h,d,m),k=!0},p:Qe,i(d){k||(w(h.$$.fragment,d),k=!0)},o(d){P(h.$$.fragment,d),k=!1},d(d){d&&t(p),d&&t(_),$(h,d)}}}function ak(z){let p,v,_,h,k,d,m,F,Oe,he,E,ke,ae,Ae,re,ie,Ie,xe,D,A,ve,K,S,O,Le,Y,ee,Ge,U,Ne,De,I,me,de,ze,te,V,Ue,Be,B,We,oe,R;return{c(){p=n("p"),v=r("TF 2.0 models accepts two formats as inputs:"),_=l(),h=n("ul"),k=n("li"),d=r("having all inputs as keyword arguments (like PyTorch models), or"),m=l(),F=n("li"),Oe=r("having all inputs as a list, tuple or dict in the first positional arguments."),he=l(),E=n("p"),ke=r("This second option is useful when using "),ae=n("code"),Ae=r("tf.keras.Model.fit"),re=r(` method which currently requires having all the
tensors in the first argument of the model call function: `),ie=n("code"),Ie=r("model(inputs)"),xe=r("."),D=l(),A=n("p"),ve=r(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),K=l(),S=n("ul"),O=n("li"),Le=r("a single Tensor with "),Y=n("code"),ee=r("input_ids"),Ge=r(" only and nothing else: "),U=n("code"),Ne=r("model(input_ids)"),De=l(),I=n("li"),me=r(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),de=n("code"),ze=r("model([input_ids, attention_mask])"),te=r(" or "),V=n("code"),Ue=r("model([input_ids, attention_mask, token_type_ids])"),Be=l(),B=n("li"),We=r(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),oe=n("code"),R=r('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(x){p=s(x,"P",{});var q=a(p);v=i(q,"TF 2.0 models accepts two formats as inputs:"),q.forEach(t),_=c(x),h=s(x,"UL",{});var be=a(h);k=s(be,"LI",{});var at=a(k);d=i(at,"having all inputs as keyword arguments (like PyTorch models), or"),at.forEach(t),m=c(be),F=s(be,"LI",{});var ye=a(F);Oe=i(ye,"having all inputs as a list, tuple or dict in the first positional arguments."),ye.forEach(t),be.forEach(t),he=c(x),E=s(x,"P",{});var Q=a(E);ke=i(Q,"This second option is useful when using "),ae=s(Q,"CODE",{});var rt=a(ae);Ae=i(rt,"tf.keras.Model.fit"),rt.forEach(t),re=i(Q,` method which currently requires having all the
...
<span class="hljs-meta">&gt;&gt;&gt; </span>outputs = model.decode(decoder_input_ids, encoder_outputs)
<span class="hljs-meta">&gt;&gt;&gt; </span>logits = outputs.logits`}}),{c(){p=n("p"),v=r("Example:"),_=l(),b(h.$$.fragment)},l(d){p=s(d,"P",{});var m=a(p);v=i(m,"Example:"),m.forEach(t),_=c(d),y(h.$$.fragment,d)},m(d,m){f(d,p,m),e(p,v),f(d,_,m),T(h,d,m),k=!0},p:Qe,i(d){k||(w(h.$$.fragment,d),k=!0)},o(d){P(h.$$.fragment,d),k=!1},d(d){d&&t(p),d&&t(_),$(h,d)}}}function fk(z){let p,v,_,h,k,d,m,F,Oe,he,E,ke,ae,Ae,re,ie,Ie,xe,D,A,ve,K,S,O,Le,Y,ee,Ge,U,Ne,De,I,me,de,ze,te,V,Ue,Be,B,We,oe,R,x,q,be,at,ye,Q,rt,Je,le,L,J,Te,it,X,dt,Xe,H,lt,Bo,Zd,Yd,la,el,tl,zi,fe,ca,ol,nl,ua,sl,al,pa,rl,il,Wo,dl,Ro,ll,cl,ul,At,Ho,pl,hl,Ko,ml,fl,Fi,ct,It,ha,Vo,gl,ma,_l,qi,Ze,Lt,Qo,kl,vl,Jo,bl,yl,Tl,fa,wl,Pl,ga,$l,Ei,ut,Gt,_a,Xo,xl,ka,zl,Mi,ge,va,ba,Fl,ql,ya,Es,El,Ms,Ml,Cl,Zo,Ta,jl,Sl,pt,wa,Ol,Al,Pa,Il,Ll,Yo,Gl,$a,Nl,Dl,Ul,xa,Re,Bl,za,Wl,Rl,Fa,Hl,Kl,qa,Vl,Ql,Jl,Ea,ht,Xl,en,Zl,Yl,Ma,ec,tc,Ci,mt,Nt,Ca,tn,oc,ja,nc,ji,on,Si,ft,Dt,Sa,nn,sc,Oa,ac,Oi,we,sn,rc,gt,ic,Cs,dc,lc,an,cc,uc,pc,_t,hc,js,mc,fc,Ss,gc,_c,kc,Ut,Ai,kt,Bt,Aa,rn,vc,Ia,bc,Ii,Wt,yc,La,Tc,wc,Li,W,dn,Pc,ln,$c,cn,xc,zc,Fc,un,qc,Os,Ec,Mc,Cc,Fe,pn,jc,hn,Sc,Ga,Oc,Ac,Ic,mn,As,Lc,Na,Gc,Nc,fn,Dc,Da,Uc,Bc,Wc,Ua,Rc,Hc,Rt,gn,Kc,Ba,Vc,Qc,Ht,_n,Jc,Wa,Xc,Zc,Kt,kn,Yc,Ra,eu,Gi,vt,Vt,Ha,vn,tu,Ka,ou,Ni,ce,bn,nu,bt,su,Va,au,ru,yn,iu,du,lu,Tn,cu,Is,uu,pu,hu,Ye,wn,mu,Qa,fu,gu,Pn,Ls,_u,Ja,ku,vu,$n,bu,Xa,yu,Tu,wu,Qt,xn,Pu,Za,$u,Di,yt,Jt,Ya,zn,xu,er,zu,Ui,Pe,Fn,Fu,qn,qu,Gs,Eu,Mu,Cu,En,ju,Mn,Su,Ou,Au,qe,Cn,Iu,Tt,Lu,Ns,Gu,Nu,tr,Du,Uu,Bu,Xt,Wu,Zt,Bi,wt,Yt,or,jn,Ru,nr,Hu,Wi,$e,Sn,Ku,On,Vu,Ds,Qu,Ju,Xu,An,Zu,In,Yu,ep,tp,Ee,Ln,op,Pt,np,Us,sp,ap,sr,rp,ip,dp,eo,lp,to,Ri,$t,oo,ar,Gn,cp,rr,up,Hi,xt,Nn,pp,no,Dn,hp,so,Ki,zt,ao,ir,Un,mp,dr,fp,Vi,ue,Bn,gp,Wn,_p,Bs,kp,vp,bp,Rn,yp,Hn,Tp,wp,Pp,ro,$p,Me,Kn,xp,Ft,zp,Ws,Fp,qp,lr,Ep,Mp,Cp,io,jp,lo,Qi,qt,co,cr,Vn,Sp,ur,Op,Ji,pe,Qn,Ap,Jn,Ip,Rs,Lp,Gp,Np,Xn,Dp,Zn,Up,Bp,Wp,uo,Rp,Ce,Yn,Hp,Et,Kp,Hs,Vp,Qp,pr,Jp,Xp,Zp,po,Yp,ho,Xi,Mt,mo,hr,es,eh,mr,th,Zi,G,ts,oh,os,nh,Ks,sh,ah,rh,ns,ih,ss,dh,lh,ch,fr,uh,ph,He,gr,as,hh,mh,_r,rs,fh,gh,kr,is,_h,kh,vr,ds,vh,bh,je,ls,yh,Ct,Th,br,wh,Ph,yr,$h,xh,zh,fo,Fh,go,qh,_o,cs,Eh,ko,Mh,vo,us,Ch,bo,Yi,jt,yo,Tr,ps,jh,wr,Sh,ed,N,hs,Oh,ms,Ah,Vs,Ih,Lh,Gh,fs,Nh,gs,Dh,Uh,Bh,Pr,Wh,Rh,Ke,$r,_s,Hh,Kh,xr,ks,Vh,Qh,zr,vs,Jh,Xh,Fr,bs,Zh,Yh,M,ys,em,St,tm,qr,om,nm,Er,sm,am,rm,To,im,Mr,dm,lm,Cr,jr,Sr,Or,cm,um,Ar,Ir,Lr,Gr,pm,hm,Nr,Dr,Ur,Br,mm,fm,Wr,Rr,Ts,wo,Po,Hr,ws,gm,Kr,_m,km,Vr,vm,bm,Qr,ym,Tm,Jr,Xr,Zr,Yr,wm,Pm,ei,ti,oi,ni,$m,xm,si,ai,ri,ii,zm,Fm,di,li,ci,ui,qm,Em,$o,Ps,Mm,xo,Cm,zo,$s,jm,Fo,td;return d=new Z({}),K=new Z({}),Te=new Z({}),Vo=new Z({}),Xo=new Z({}),tn=new Z({}),on=new Se({props:{code:`from transformers import PegasusForConditionalGeneration, PegasusTokenizer
import torch
...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/v4.20.1/src/transformers/models/pegasus/tokenization_pegasus.py#L258",returnDescription:`
...
elements depending on the configuration (<a
  href="/docs/transformers/v4.20.1/en/model_doc/pegasus#transformers.PegasusConfig"
...
(masked), the loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.20.1/src/transformers/models/pegasus/modeling_pegasus.py#L1357",returnDescription:`
<p>A <a
...
Whether or not to return a <a href="/docs/transformers/v4.20.1/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/v4.20.1/src/transformers/models/pegasus/modeling_pegasus.py#L1549",returnDescription:`
<p>A <a
...
behaviors between training and evaluation).`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/v4.20.1/src/transformers/models/pegasus/modeling_tf_pegasus.py#L1193",returnDescription:`
<p>A <a
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/v4.20.1/en/main_classes/model#transformers.TFPreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/v4.20.1/src/transformers/models/pegasus/modeling_tf_pegasus.py#L1268"}}),uo=new Uo({props:{$$slots:{default:[ak]},$$scope:{ctx:z}}}),Yn=new C({props:{name:"call",anchor:"transformers.TFPegasusForConditionalGeneration.call",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"decoder_input_ids",val:" = None"},{name:"decoder_attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"decoder_head_mask",val:" = None"},{name:"cross_attn_head_mask",val:" = None"},{name:"encoder_outputs",val:": typing.Optional[transformers.modeling_tf_outputs.TFBaseModelOutput] = None"},{name:"past_key_values",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"decoder_inputs_embeds",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"},{name:"labels",val:" = None"},{name:"training",val:" = False"}],parametersDescription:[{anchor:"transformers.TFPegasusForConditionalGeneration.call.input_ids",description:`<strong>input_ids</strong> (<code>tf.Tensor</code> of shape <code>({0})</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/v4.20.1/en/model_doc/pegasus#transformers.PegasusTokenizer">PegasusTokenizer</a>. See <a href="/docs/transformers/v4.20.1/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/v4.20.1/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
Labels for computing the masked language modeling loss. Indices should either be in <code>[0, ..., config.vocab_size]</code> or -100 (see <code>input_ids</code> docstring). Tokens with indices set to <code>-100</code> are ignored
(masked), the loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.20.1/src/transformers/models/pegasus/modeling_tf_pegasus.py#L1301",returnDescription:`
<p>A <a
...
Whether or not to return a <a href="/docs/transformers/v4.20.1/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/v4.20.1/src/transformers/models/pegasus/modeling_flax_pegasus.py#L1163",returnDescription:`
<p>A <a
...
Whether or not to return a <a href="/docs/transformers/v4.20.1/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/v4.20.1/src/transformers/models/pegasus/modeling_flax_pegasus.py#L986",returnDescription:`
<p>A <a
...
Whether or not to return a <a href="/docs/transformers/v4.20.1/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/v4.20.1/src/transformers/models/pegasus/modeling_flax_pegasus.py#L1049",returnDescription:`
<p>A <a
...
Whether or not to return a <a href="/docs/transformers/v4.20.1/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/v4.20.1/src/transformers/models/pegasus/modeling_flax_pegasus.py#L1319",returnDescription:`
<p>A <a
...
on the XSUM dataset. Data download instructions at `),Jo=n("a"),bl=r("examples/pytorch/summarization/"),yl=r("."),Tl=l(),fa=n("li"),wl=r("FP16 is not supported (help/ideas on this appreciated!)."),Pl=l(),ga=n("li"),$l=r("The adafactor optimizer is recommended for pegasus fine-tuning."),Ei=l(),ut=n("h2"),Gt=n("a"),_a=n("span"),b(Xo.$$.fragment),xl=l(),ka=n("span"),zl=r("Implementation Notes"),Mi=l(),ge=n("ul"),va=n("li"),ba=n("p"),Fl=r("All models are transformer encoder-decoders with 16 layers in each component."),ql=l(),ya=n("li"),Es=n("p"),El=r("The implementation is completely inherited from "),Ms=n("a"),Ml=r("BartForConditionalGeneration"),Cl=l(),Zo=n("li"),Ta=n("p"),jl=r("Some key configuration differences:"),Sl=l(),pt=n("ul"),wa=n("li"),Ol=r("static, sinusoidal position embeddings"),Al=l(),Pa=n("li"),Il=r("the model starts generating with pad_token_id (which has 0 token_embedding) as the prefix."),Ll=l(),Yo=n("li"),Gl=r("more beams are used ("),$a=n("code"),Nl=r("num_beams=8"),Dl=r(")"),Ul=l(),xa=n("li"),Re=n("p"),Bl=r("All pretrained pegasus checkpoints are the same besides three attributes: "),za=n("code"),Wl=r("tokenizer.model_max_length"),Rl=r(` (maximum
...
and adding special tokens. A PEGASUS sequence has the following format, where `),Ga=n("code"),Oc=r("X"),Ac=r(" represents the sequence:"),Ic=l(),mn=n("ul"),As=n("li"),Lc=r("single sequence: "),Na=n("code"),Gc=r("X </s>"),Nc=l(),fn=n("li"),Dc=r("pair of sequences: "),Da=n("code"),Uc=r("A B </s>"),Bc=r(" (not intended use)"),Wc=l(),Ua=n("p"),Rc=r(`BOS is never used. Pairs of sequences are not the expected use case, but they will be handled without a
separator.`),Hc=l(),Rt=n("div"),b(gn.$$.fragment),Kc=l(),Ba=n("p"),Vc=r("Converts a sequence of tokens (string) in a single string."),Qc=l(),Ht=n("div"),b(_n.$$.fragment),Jc=l(),Wa=n("p"),Xc=r("Get list where entries are [1] if a token is [eos] or [pad] else 0."),Zc=l(),Kt=n("div"),b(kn.$$.fragment),Yc=l(),Ra=n("p"),eu=r("Just EOS"),Gi=l(),vt=n("h2"),Vt=n("a"),Ha=n("span"),b(vn.$$.fragment),tu=l(),Ka=n("span"),ou=r("PegasusTokenizerFast"),Ni=l(),ce=n("div"),b(bn.$$.fragment),nu=l(),bt=n("p"),su=r("Construct a \u201Cfast\u201D PEGASUS tokenizer (backed by HuggingFace\u2019s "),Va=n("em"),au=r("tokenizers"),ru=r(` library). Based on
...
and behavior.`),Au=l(),qe=n("div"),b(Cn.$$.fragment),Iu=l(),Tt=n("p"),Lu=r("The "),Ns=n("a"),Gu=r("PegasusModel"),Nu=r(" forward method, overrides the "),tr=n("code"),Du=r("__call__"),Uu=r(" special method."),Bu=l(),b(Xt.$$.fragment),Wu=l(),b(Zt.$$.fragment),Bi=l(),wt=n("h2"),Yt=n("a"),or=n("span"),b(jn.$$.fragment),Ru=l(),nr=n("span"),Hu=r("PegasusForConditionalGeneration"),Wi=l(),$e=n("div"),b(Sn.$$.fragment),Ku=l(),On=n("p"),Vu=r(`The PEGASUS Model with a language modeling head. Can be used for summarization.
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),tp=l(),Ee=n("div"),b(Ln.$$.fragment),op=l(),Pt=n("p"),np=r("The "),Us=n("a"),sp=r("PegasusForConditionalGeneration"),ap=r(" forward method, overrides the "),sr=n("code"),rp=r("__call__"),ip=r(" special method."),dp=l(),b(eo.$$.fragment),lp=l(),b(to.$$.fragment),Ri=l(),$t=n("h2"),oo=n("a"),ar=n("span"),b(Gn.$$.fragment),cp=l(),rr=n("span"),up=r("PegasusForCausalLM"),Hi=l(),xt=n("div"),b(Nn.$$.fragment),pp=l(),no=n("div"),b(Dn.$$.fragment),hp=l(),b(so.$$.fragment),Ki=l(),zt=n("h2"),ao=n("a"),ir=n("span"),b(Un.$$.fragment),mp=l(),dr=n("span"),fp=r("TFPegasusModel"),Vi=l(),ue=n("div"),b(Bn.$$.fragment),gp=l(),Wn=n("p"),_p=r(`The bare PEGASUS Model outputting raw hidden-states without any specific head on top.
This model inherits from `),Bs=n("a"),kp=r("TFPreTrainedModel"),vp=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),bp=l(),Rn=n("p"),yp=r("This model is also a "),Hn=n("a"),Tp=r("tf.keras.Model"),wp=r(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Pp=l(),b(ro.$$.fragment),$p=l(),Me=n("div"),b(Kn.$$.fragment),xp=l(),Ft=n("p"),zp=r("The "),Ws=n("a"),Fp=r("TFPegasusModel"),qp=r(" forward method, overrides the "),lr=n("code"),Ep=r("__call__"),Mp=r(" special method."),Cp=l(),b(io.$$.fragment),jp=l(),b(lo.$$.fragment),Qi=l(),qt=n("h2"),co=n("a"),cr=n("span"),b(Vn.$$.fragment),Sp=l(),ur=n("span"),Op=r("TFPegasusForConditionalGeneration"),Ji=l(),pe=n("div"),b(Qn.$$.fragment),Ap=l(),Jn=n("p"),Ip=r(`The PEGASUS Model with a language modeling head. Can be used for summarization.
This model inherits from `),Rs=n("a"),Lp=r("TFPreTrainedModel"),Gp=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Np=l(),Xn=n("p"),Dp=r("This model is also a "),Zn=n("a"),Up=r("tf.keras.Model"),Bp=r(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Wp=l(),b(uo.$$.fragment),Rp=l(),Ce=n("div"),b(Yn.$$.fragment),Hp=l(),Et=n("p"),Kp=r("The "),Hs=n("a"),Vp=r("TFPegasusForConditionalGeneration"),Qp=r(" forward method, overrides the "),pr=n("code"),Jp=r("__call__"),Xp=r(" special method."),Zp=l(),b(po.$$.fragment),Yp=l(),b(ho.$$.fragment),Xi=l(),Mt=n("h2"),mo=n("a"),hr=n("span"),b(es.$$.fragment),eh=l(),mr=n("span"),th=r("FlaxPegasusModel"),Zi=l(),G=n("div"),b(ts.$$.fragment),oh=l(),os=n("p"),nh=r(`The bare Pegasus Model transformer outputting raw hidden-states without any specific head on top.
...
This model inherits from `),Gs=s(xd,"A",{href:!0});var ng=a(Gs);Eu=i(ng,"PreTrainedModel"),ng.forEach(t),Mu=i(xd,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
This model inherits from `),Rs=s(Ld,"A",{href:!0});var zg=a(Rs);Lp=i(zg,"TFPreTrainedModel"),zg.forEach(t),Gp=i(Ld,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Ld.forEach(t),Np=c(st),Xn=s(st,"P",{});var Gd=a(Xn);Dp=i(Gd,"This model is also a "),Zn=s(Gd,"A",{href:!0,rel:!0});var Fg=a(Zn);Up=i(Fg,"tf.keras.Model"),Fg.forEach(t),Bp=i(Gd,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Gd.forEach(t),Wp=c(st),y(uo.$$.fragment,st),Rp=c(st),Ce=s(st,"DIV",{class:!0});var Lo=a(Ce);y(Yn.$$.fragment,Lo),Hp=c(Lo),Et=s(Lo,"P",{});var ra=a(Et);Kp=i(ra,"The "),Hs=s(ra,"A",{href:!0});var qg=a(Hs);Vp=i(qg,"TFPegasusForConditionalGeneration"),qg.forEach(t),Qp=i(ra," forward method, overrides the "),pr=s(ra,"CODE",{});var Eg=a(pr);Jp=i(Eg,"__call__"),Eg.forEach(t),Xp=i(ra," special method."),ra.forEach(t),Zp=c(Lo),y(po.$$.fragment,Lo),Yp=c(Lo),y(ho.$$.fragment,Lo),Lo.forEach(t),st.forEach(t),Xi=c(o),Mt=s(o,"H2",{class:!0});var Nd=a(Mt);mo=s(Nd,"A",{id:!0,class:!0,href:!0});var Mg=a(mo);hr=s(Mg,"SPAN",{});var Cg=a(hr);y(es.$$.fragment,Cg),Cg.forEach(t),Mg.forEach(t),eh=c(Nd),mr=s(Nd,"SPAN",{});var jg=a(mr);th=i(jg,"FlaxPegasusModel"),jg.forEach(t),Nd.forEach(t),Zi=c(o),G=s(o,"DIV",{class:!0});var ne=a(G);y(ts.$$.fragment,ne),oh=c(ne),os=s(ne,"P",{});var Dd=a(os);nh=i(Dd,`The bare Pegasus Model transformer outputting raw hidden-states without any specific head on top.
...
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),Ud.forEach(t),ch=c(ne),fr=s(ne,"P",{});var Ag=a(fr);uh=i(Ag,"Finally, this model supports inherent JAX features such as:"),Ag.forEach(t),ph=c(ne),He=s(ne,"UL",{});var Go=a(He);gr=s(Go,"LI",{});var Ig=a(gr);as=s(Ig,"A",{href:!0,rel:!0});var Lg=a(as);hh=i(Lg,"Just-In-Time (JIT) compilation"),Lg.forEach(t),Ig.forEach(t),mh=c(Go),_r=s(Go,"LI",{});var Gg=a(_r);rs=s(Gg,"A",{href:!0,rel:!0});var Ng=a(rs);fh=i(Ng,"Automatic Differentiation"),Ng.forEach(t),Gg.forEach(t),gh=c(Go),kr=s(Go,"LI",{});var Dg=a(kr);is=s(Dg,"A",{href:!0,rel:!0});var Ug=a(is);_h=i(Ug,"Vectorization"),Ug.forEach(t),Dg.forEach(t),kh=c(Go),vr=s(Go,"LI",{});var Bg=a(vr);ds=s(Bg,"A",{href:!0,rel:!0});var Wg=a(ds);vh=i(Wg,"Parallelization"),Wg.forEach(t),Bg.forEach(t),Go.forEach(t),bh=c(ne),je=s(ne,"DIV",{class:!0});var No=a(je);y(ls.$$.fragment,No),yh=c(No),Ct=s(No,"P",{});var ia=a(Ct);Th=i(ia,"The "),br=s(ia,"CODE",{});var Rg=a(br);wh=i(Rg,"FlaxPegasusPreTrainedModel"),Rg.forEach(t),Ph=i(ia," forward method, overrides the "),yr=s(ia,"CODE",{});var Hg=a(yr);$h=i(Hg,"__call__"),Hg.forEach(t),xh=i(ia," special method."),ia.forEach(t),zh=c(No),y(fo.$$.fragment,No),Fh=c(No),y(go.$$.fragment,No),No.forEach(t),qh=c(ne),_o=s(ne,"DIV",{class:!0});var Bd=a(_o);y(cs.$$.fragment,Bd),Eh=c(Bd),y(ko.$$.fragment,Bd),Bd.forEach(t),Mh=c(ne),vo=s(ne,"DIV",{class:!0});var Wd=a(vo);y(us.$$.fragment,Wd),Ch=c(Wd),y(bo.$$.fragment,Wd),Wd.forEach(t),ne.forEach(t),Yi=c(o),jt=s(o,"H2",{class:!0});var Rd=a(jt);yo=s(Rd,"A",{id:!0,class:!0,href:!0});var Kg=a(yo);Tr=s(Kg,"SPAN",{});var Vg=a(Tr);y(ps.$$.fragment,Vg),Vg.forEach(t),Kg.forEach(t),jh=c(Rd),wr=s(Rd,"SPAN",{});var Qg=a(wr);Sh=i(Qg,"FlaxPegasusForConditionalGeneration"),Qg.forEach(t),Rd.forEach(t),ed=c(o),N=s(o,"DIV",{class:!0});var se=a(N);y(hs.$$.fragment,se),Oh=c(se),ms=s(se,"P",{});var Hd=a(ms);Ah=i(Hd,`The PEGASUS Model with a language modeling head. Can be used for summarization.
