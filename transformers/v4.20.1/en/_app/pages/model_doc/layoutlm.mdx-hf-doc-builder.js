...
<span class="hljs-meta">&gt;&gt;&gt; </span>loss = outputs.loss
<span class="hljs-meta">&gt;&gt;&gt; </span>logits = outputs.logits`}}),{c(){d=a("p"),k=n("Examples:"),_=c(),L(h.$$.fragment)},l(l){d=r(l,"P",{});var m=i(d);k=s(m,"Examples:"),m.forEach(o),_=p(l),v(h.$$.fragment,l)},m(l,m){f(l,d,m),e(d,k),f(l,_,m),w(h,l,m),b=!0},p:qo,i(l){b||(T(h.$$.fragment,l),b=!0)},o(l){M(h.$$.fragment,l),b=!1},d(l){l&&o(d),l&&o(_),$(h,l)}}}function Ph(E){let d,k,_,h,b,l,m,j,re,Y,z,ae,I,Z,ne,A,ie,se,J,D,G,Q,F,q,le,H,V,ee,B,oe,de,C,ce,U,pe,te,R,ue,he,N,me,W,fe,g,x,X,je,Me,S,be,Fe,$e,O,K,xe,ye,P,ze,ke,ge,Ee,Qn,Hr,Br,Os,Rr,Kr,xt,Vr,Xr,jt,Yr,Zr,Da,Ft,Aa,to,Gr,Is,Jr,Qr,Ds,ei,oi,Ua,zt,Wa,es,eo,ti,os,ni,si,Et,ai,ri,qt,ii,li,Ha,no,di,Ct,ci,pi,Pt,ui,hi,Ba,ro,Co,As,Nt,mi,Us,fi,Ra,Pe,St,gi,io,_i,ts,yi,bi,Ot,ki,Li,vi,lo,wi,ns,Ti,Mi,ss,$i,xi,ji,Po,Ka,co,No,Ws,It,Fi,Hs,zi,Va,Ne,Dt,Ei,Bs,qi,Ci,So,as,Pi,Ni,rs,Si,Oi,Ii,At,Di,is,Ai,Ui,Xa,po,Oo,Rs,Ut,Wi,Ks,Hi,Ya,Se,Wt,Bi,Vs,Ri,Ki,Io,ls,Vi,Xi,ds,Yi,Zi,Gi,Ht,Ji,cs,Qi,el,Za,uo,Do,Xs,Bt,ol,Ys,tl,Ga,Oe,Rt,nl,Kt,sl,Vt,al,rl,il,Xt,ll,Yt,dl,cl,pl,Ae,Zt,ul,ho,hl,ps,ml,fl,Zs,gl,_l,yl,Ao,bl,Uo,Ja,mo,Wo,Gs,Gt,kl,Js,Ll,Qa,Ie,Jt,vl,fo,wl,Qs,Tl,Ml,Qt,$l,xl,jl,en,Fl,on,zl,El,ql,Ue,tn,Cl,go,Pl,us,Nl,Sl,ea,Ol,Il,Dl,Ho,Al,Bo,er,_o,Ro,oa,nn,Ul,ta,Wl,or,qe,sn,Hl,an,Bl,rn,Rl,Kl,Vl,ln,Xl,dn,Yl,Zl,Gl,cn,Jl,pn,Ql,ed,od,We,un,td,yo,nd,hs,sd,ad,na,rd,id,ld,Ko,dd,Vo,tr,bo,Xo,sa,hn,cd,aa,pd,nr,Ce,mn,ud,ko,hd,fn,md,fd,gn,gd,_d,yd,_n,bd,yn,kd,Ld,vd,bn,wd,kn,Td,Md,$d,He,Ln,xd,Lo,jd,ms,Fd,zd,ra,Ed,qd,Cd,Yo,Pd,Zo,sr,vo,Go,ia,vn,Nd,la,Sd,ar,Le,wn,Od,da,Id,Dd,Tn,Ad,fs,Ud,Wd,Hd,Mn,Bd,$n,Rd,Kd,Vd,Jo,Xd,Be,xn,Yd,wo,Zd,gs,Gd,Jd,ca,Qd,ec,oc,Qo,tc,et,rr,To,ot,pa,jn,nc,ua,sc,ir,ve,Fn,ac,zn,rc,ha,ic,lc,dc,En,cc,_s,pc,uc,hc,qn,mc,Cn,fc,gc,_c,tt,yc,Re,Pn,bc,Mo,kc,ys,Lc,vc,ma,wc,Tc,Mc,nt,$c,st,lr,$o,at,fa,Nn,xc,ga,jc,dr,we,Sn,Fc,_a,zc,Ec,On,qc,bs,Cc,Pc,Nc,In,Sc,Dn,Oc,Ic,Dc,rt,Ac,Ke,An,Uc,xo,Wc,ks,Hc,Bc,ya,Rc,Kc,Vc,it,Xc,lt,cr,jo,dt,ba,Un,Yc,ka,Zc,pr,Te,Wn,Gc,La,Jc,Qc,Hn,ep,Ls,op,tp,np,Bn,sp,Rn,ap,rp,ip,ct,lp,Ve,Kn,dp,Fo,cp,vs,pp,up,va,hp,mp,fp,pt,gp,ut,ur;return l=new De({}),A=new De({}),Ft=new oo({props:{code:`def normalize_bbox(bbox, width, height):
    return [
...
`),Ot=a("a"),ki=n("microsoft/layoutlm-base-uncased"),Li=n(" architecture."),vi=c(),lo=a("p"),wi=n("Configuration objects inherit from "),ns=a("a"),Ti=n("BertConfig"),Mi=n(` and can be used to control the model outputs. Read the
...
behavior.`),pl=c(),Ae=a("div"),L(Zt.$$.fragment),ul=c(),ho=a("p"),hl=n("The "),ps=a("a"),ml=n("LayoutLMModel"),fl=n(" forward method, overrides the "),Zs=a("code"),gl=n("__call__"),_l=n(" special method."),yl=c(),L(Ao.$$.fragment),bl=c(),L(Uo.$$.fragment),Ja=c(),mo=a("h2"),Wo=a("a"),Gs=a("span"),L(Gt.$$.fragment),kl=c(),Js=a("span"),Ll=n("LayoutLMForMaskedLM"),Qa=c(),Ie=a("div"),L(Jt.$$.fragment),vl=c(),fo=a("p"),wl=n("LayoutLM Model with a "),Qs=a("code"),Tl=n("language modeling"),Ml=n(` head on top.
...
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),$d=c(),He=a("div"),L(Ln.$$.fragment),xd=c(),Lo=a("p"),jd=n("The "),ms=a("a"),Fd=n("LayoutLMForTokenClassification"),zd=n(" forward method, overrides the "),ra=a("code"),Ed=n("__call__"),qd=n(" special method."),Cd=c(),L(Yo.$$.fragment),Pd=c(),L(Zo.$$.fragment),sr=c(),vo=a("h2"),Go=a("a"),ia=a("span"),L(vn.$$.fragment),Nd=c(),la=a("span"),Sd=n("TFLayoutLMModel"),ar=c(),Le=a("div"),L(wn.$$.fragment),Od=c(),da=a("p"),Id=n("The bare LayoutLM Model transformer outputting raw hidden-states without any specific head on top."),Dd=c(),Tn=a("p"),Ad=n("This model inherits from "),fs=a("a"),Ud=n("TFPreTrainedModel"),Wd=n(`. Check the superclass documentation for the generic methods the
...
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),Fr.forEach(o),$d=p(ao),He=r(ao,"DIV",{class:!0});var vt=i(He);v(Ln.$$.fragment,vt),xd=p(vt),Lo=r(vt,"P",{});var qs=i(Lo);jd=s(qs,"The "),ms=r(qs,"A",{href:!0});var ju=i(ms);Fd=s(ju,"LayoutLMForTokenClassification"),ju.forEach(o),zd=s(qs," forward method, overrides the "),ra=r(qs,"CODE",{});var Fu=i(ra);Ed=s(Fu,"__call__"),Fu.forEach(o),qd=s(qs," special method."),qs.forEach(o),Cd=p(vt),v(Yo.$$.fragment,vt),Pd=p(vt),v(Zo.$$.fragment,vt),vt.forEach(o),ao.forEach(o),sr=p(t),vo=r(t,"H2",{class:!0});var zr=i(vo);Go=r(zr,"A",{id:!0,class:!0,href:!0});var zu=i(Go);ia=r(zu,"SPAN",{});var Eu=i(ia);v(vn.$$.fragment,Eu),Eu.forEach(o),zu.forEach(o),Nd=p(zr),la=r(zr,"SPAN",{});var qu=i(la);Sd=s(qu,"TFLayoutLMModel"),qu.forEach(o),zr.forEach(o),ar=p(t),Le=r(t,"DIV",{class:!0});var Ye=i(Le);v(wn.$$.fragment,Ye),Od=p(Ye),da=r(Ye,"P",{});var Cu=i(da);Id=s(Cu,"The bare LayoutLM Model transformer outputting raw hidden-states without any specific head on top."),Cu.forEach(o),Dd=p(Ye),Tn=r(Ye,"P",{});var Er=i(Tn);Ad=s(Er,"This model inherits from "),fs=r(Er,"A",{href:!0});var Pu=i(fs);Ud=s(Pu,"TFPreTrainedModel"),Pu.forEach(o),Wd=s(Er,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Sr.forEach(o),_c=p(Ze),v(tt.$$.fragment,Ze),yc=p(Ze),Re=r(Ze,"DIV",{class:!0});var Tt=i(Re);v(Pn.$$.fragment,Tt),bc=p(Tt),Mo=r(Tt,"P",{});var Ps=i(Mo);kc=s(Ps,"The "),ys=r(Ps,"A",{href:!0});var Bu=i(ys);Lc=s(Bu,"TFLayoutLMForMaskedLM"),Bu.forEach(o),vc=s(Ps," forward method, overrides the "),ma=r(Ps,"CODE",{});var Ru=i(ma);wc=s(Ru,"__call__"),Ru.forEach(o),Tc=s(Ps," special method."),Ps.forEach(o),Mc=p(Tt),v(nt.$$.fragment,Tt),$c=p(Tt),v(st.$$.fragment,Tt),Tt.forEach(o),Ze.forEach(o),lr=p(t),$o=r(t,"H2",{class:!0});var Or=i($o);at=r(Or,"A",{id:!0,class:!0,href:!0});var Ku=i(at);fa=r(Ku,"SPAN",{});var Vu=i(fa);v(Nn.$$.fragment,Vu),Vu.forEach(o),Ku.forEach(o),xc=p(Or),ga=r(Or,"SPAN",{});var Xu=i(ga);jc=s(Xu,"TFLayoutLMForSequenceClassification"),Xu.forEach(o),Or.forEach(o),dr=p(t),we=r(t,"DIV",{class:!0});var Ge=i(we);v(Sn.$$.fragment,Ge),Fc=p(Ge),_a=r(Ge,"P",{});var Yu=i(_a);zc=s(Yu,`LayoutLM Model transformer with a sequence classification/regression head on top (a linear layer on top of the
