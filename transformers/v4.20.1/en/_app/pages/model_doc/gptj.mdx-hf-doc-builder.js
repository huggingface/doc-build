...
`),N=a("code"),_e=n("model([input_ids, attention_mask])"),de=n(" or "),O=a("code"),U=n("model([input_ids, attention_mask, token_type_ids])"),Te=h(),z=a("li"),ve=n(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),R=a("code"),ne=n('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(y){d=r(y,"P",{});var x=i(d);T=s(x,"TF 2.0 models accepts two formats as inputs:"),x.forEach(t),c=u(y),p=r(y,"UL",{});var V=i(p);v=r(V,"LI",{});var ze=i(v);l=s(ze,"having all inputs as keyword arguments (like PyTorch models), or"),ze.forEach(t),m=u(V),G=r(V,"LI",{});var Ce=i(G);he=s(Ce,"having all inputs as a list, tuple or dict in the first positional arguments."),Ce.forEach(t),V.forEach(t),K=u(y),J=r(y,"P",{});var C=i(J);X=s(C,"This second option is useful when using "),D=r(C,"CODE",{});var Ae=i(D);Z=s(Ae,"tf.keras.Model.fit"),Ae.forEach(t),ue=s(C,` method which currently requires having all the
tensors in the first argument of the model call function: `),W=r(C,"CODE",{});var Le=i(W);me=s(Le,"model(inputs)"),Le.forEach(t),re=s(C,"."),C.forEach(t),I=u(y),L=r(y,"P",{});var Me=i(L);ee=s(Me,`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
...
`),N=r(S,"CODE",{});var Ie=i(N);_e=s(Ie,"model([input_ids, attention_mask])"),Ie.forEach(t),de=s(S," or "),O=r(S,"CODE",{});var ye=i(O);U=s(ye,"model([input_ids, attention_mask, token_type_ids])"),ye.forEach(t),S.forEach(t),Te=u(A),z=r(A,"LI",{});var ke=i(z);ve=s(ke,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),R=r(ke,"CODE",{});var Ne=i(R);ne=s(Ne,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),Ne.forEach(t),ke.forEach(t),A.forEach(t)},m(y,x){g(y,d,x),e(d,T),g(y,c,x),g(y,p,x),e(p,v),e(v,l),e(p,m),e(p,G),e(G,he),g(y,K,x),g(y,J,x),e(J,X),e(J,D),e(D,Z),e(J,ue),e(J,W),e(W,me),e(J,re),g(y,I,x),g(y,L,x),e(L,ee),g(y,te,x),g(y,E,x),e(E,M),e(M,fe),e(M,Q),e(Q,ie),e(M,Y),e(M,H),e(H,oe),e(E,ge),e(E,q),e(q,le),e(q,N),e(N,_e),e(q,de),e(q,O),e(O,U),e(E,Te),e(E,z),e(z,ve),e(z,R),e(R,ne)},d(y){y&&t(d),y&&t(c),y&&t(p),y&&t(K),y&&t(J),y&&t(I),y&&t(L),y&&t(te),y&&t(E)}}}function jf(j){let d,T,c,p,v;return{c(){d=a("p"),T=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),c=a("code"),p=n("Module"),v=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(l){d=r(l,"P",{});var m=i(d);T=s(m,"Although the recipe for forward pass needs to be defined within this function, one should call the "),c=r(m,"CODE",{});var G=i(c);p=s(G,"Module"),G.forEach(t),v=s(m,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),{c(){d=a("p"),T=n("Example:"),c=h(),k(p.$$.fragment)},l(l){d=r(l,"P",{});var m=i(d);T=s(m,"Example:"),m.forEach(t),c=u(l),b(p.$$.fragment,l)},m(l,m){g(l,d,m),e(d,T),g(l,c,m),w(p,l,m),v=!0},p:Ee,i(l){v||($(p.$$.fragment,l),v=!0)},o(l){P(p.$$.fragment,l),v=!1},d(l){l&&t(d),l&&t(c),F(p,l)}}}function xf(j){let d,T,c,p,v,l,m,G,he,K,J,X,D,Z,ue,W,me,re,I,L,ee,te,E,M,fe,Q,ie,Y,H,oe,ge,q,le,N,_e,de,O,U,Te,z,ve,R,ne;return{c(){d=a("p"),T=n("TF 2.0 models accepts two formats as inputs:"),c=h(),p=a("ul"),v=a("li"),l=n("having all inputs as keyword arguments (like PyTorch models), or"),m=h(),G=a("li"),he=n("having all inputs as a list, tuple or dict in the first positional arguments."),K=h(),J=a("p"),X=n("This second option is useful when using "),D=a("code"),Z=n("tf.keras.Model.fit"),ue=n(` method which currently requires having all the
tensors in the first argument of the model call function: `),W=a("code"),me=n("model(inputs)"),re=n("."),I=h(),L=a("p"),ee=n(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),te=h(),E=a("ul"),M=a("li"),fe=n("a single Tensor with "),Q=a("code"),ie=n("input_ids"),Y=n(" only and nothing else: "),H=a("code"),oe=n("model(inputs_ids)"),ge=h(),q=a("li"),le=n(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),N=a("code"),_e=n("model([input_ids, attention_mask])"),de=n(" or "),O=a("code"),U=n("model([input_ids, attention_mask, token_type_ids])"),Te=h(),z=a("li"),ve=n(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),R=a("code"),ne=n('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(y){d=r(y,"P",{});var x=i(d);T=s(x,"TF 2.0 models accepts two formats as inputs:"),x.forEach(t),c=u(y),p=r(y,"UL",{});var V=i(p);v=r(V,"LI",{});var ze=i(v);l=s(ze,"having all inputs as keyword arguments (like PyTorch models), or"),ze.forEach(t),m=u(V),G=r(V,"LI",{});var Ce=i(G);he=s(Ce,"having all inputs as a list, tuple or dict in the first positional arguments."),Ce.forEach(t),V.forEach(t),K=u(y),J=r(y,"P",{});var C=i(J);X=s(C,"This second option is useful when using "),D=r(C,"CODE",{});var Ae=i(D);Z=s(Ae,"tf.keras.Model.fit"),Ae.forEach(t),ue=s(C,` method which currently requires having all the
...
<span class="hljs-meta">&gt;&gt;&gt; </span>inputs = tokenizer(<span class="hljs-string">&quot;Hello, my dog is cute&quot;</span>, return_tensors=<span class="hljs-string">&quot;tf&quot;</span>)
<span class="hljs-meta">&gt;&gt;&gt; </span>outputs = model(inputs)
<span class="hljs-meta">&gt;&gt;&gt; </span>logits = outputs.logits`}}),{c(){d=a("p"),T=n("Example:"),c=h(),k(p.$$.fragment)},l(l){d=r(l,"P",{});var m=i(d);T=s(m,"Example:"),m.forEach(t),c=u(l),b(p.$$.fragment,l)},m(l,m){g(l,d,m),e(d,T),g(l,c,m),w(p,l,m),v=!0},p:Ee,i(l){v||($(p.$$.fragment,l),v=!0)},o(l){P(p.$$.fragment,l),v=!1},d(l){l&&t(d),l&&t(c),F(p,l)}}}function Mf(j){let d,T,c,p,v,l,m,G,he,K,J,X,D,Z,ue,W,me,re,I,L,ee,te,E,M,fe,Q,ie,Y,H,oe,ge,q,le,N,_e,de,O,U,Te,z,ve,R,ne;return{c(){d=a("p"),T=n("TF 2.0 models accepts two formats as inputs:"),c=h(),p=a("ul"),v=a("li"),l=n("having all inputs as keyword arguments (like PyTorch models), or"),m=h(),G=a("li"),he=n("having all inputs as a list, tuple or dict in the first positional arguments."),K=h(),J=a("p"),X=n("This second option is useful when using "),D=a("code"),Z=n("tf.keras.Model.fit"),ue=n(` method which currently requires having all the
tensors in the first argument of the model call function: `),W=a("code"),me=n("model(inputs)"),re=n("."),I=h(),L=a("p"),ee=n(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),te=h(),E=a("ul"),M=a("li"),fe=n("a single Tensor with "),Q=a("code"),ie=n("input_ids"),Y=n(" only and nothing else: "),H=a("code"),oe=n("model(inputs_ids)"),ge=h(),q=a("li"),le=n(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),N=a("code"),_e=n("model([input_ids, attention_mask])"),de=n(" or "),O=a("code"),U=n("model([input_ids, attention_mask, token_type_ids])"),Te=h(),z=a("li"),ve=n(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),R=a("code"),ne=n('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(y){d=r(y,"P",{});var x=i(d);T=s(x,"TF 2.0 models accepts two formats as inputs:"),x.forEach(t),c=u(y),p=r(y,"UL",{});var V=i(p);v=r(V,"LI",{});var ze=i(v);l=s(ze,"having all inputs as keyword arguments (like PyTorch models), or"),ze.forEach(t),m=u(V),G=r(V,"LI",{});var Ce=i(G);he=s(Ce,"having all inputs as a list, tuple or dict in the first positional arguments."),Ce.forEach(t),V.forEach(t),K=u(y),J=r(y,"P",{});var C=i(J);X=s(C,"This second option is useful when using "),D=r(C,"CODE",{});var Ae=i(D);Z=s(Ae,"tf.keras.Model.fit"),Ae.forEach(t),ue=s(C,` method which currently requires having all the
...
the latter silently ignores them.`)},l(l){d=r(l,"P",{});var m=i(d);T=s(m,"Although the recipe for forward pass needs to be defined within this function, one should call the "),c=r(m,"CODE",{});var G=i(c);p=s(G,"Module"),G.forEach(t),v=s(m,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),m.forEach(t)},m(l,m){g(l,d,m),e(d,T),e(d,c),e(c,p),e(d,v)},d(l){l&&t(d)}}}function zf(j){let d,T,c,p,v;return p=new pe({props:{code:`from transformers import GPTJTokenizer, TFGPTJForSequenceClassification
import tensorflow as tf
...
`}}),{c(){k(d.$$.fragment)},l(c){b(d.$$.fragment,c)},m(c,p){w(d,c,p),T=!0},p:Ee,i(c){T||($(d.$$.fragment,c),T=!0)},o(c){P(d.$$.fragment,c),T=!1},d(c){F(d,c)}}}function Af(j){let d,T,c,p,v,l,m,G,he,K,J,X,D,Z,ue,W,me,re,I,L,ee,te,E,M,fe,Q,ie,Y,H,oe,ge,q,le,N,_e,de,O,U,Te,z,ve,R,ne;return{c(){d=a("p"),T=n("TF 2.0 models accepts two formats as inputs:"),c=h(),p=a("ul"),v=a("li"),l=n("having all inputs as keyword arguments (like PyTorch models), or"),m=h(),G=a("li"),he=n("having all inputs as a list, tuple or dict in the first positional arguments."),K=h(),J=a("p"),X=n("This second option is useful when using "),D=a("code"),Z=n("tf.keras.Model.fit"),ue=n(` method which currently requires having all the
tensors in the first argument of the model call function: `),W=a("code"),me=n("model(inputs)"),re=n("."),I=h(),L=a("p"),ee=n(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),te=h(),E=a("ul"),M=a("li"),fe=n("a single Tensor with "),Q=a("code"),ie=n("input_ids"),Y=n(" only and nothing else: "),H=a("code"),oe=n("model(inputs_ids)"),ge=h(),q=a("li"),le=n(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),N=a("code"),_e=n("model([input_ids, attention_mask])"),de=n(" or "),O=a("code"),U=n("model([input_ids, attention_mask, token_type_ids])"),Te=h(),z=a("li"),ve=n(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),R=a("code"),ne=n('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(y){d=r(y,"P",{});var x=i(d);T=s(x,"TF 2.0 models accepts two formats as inputs:"),x.forEach(t),c=u(y),p=r(y,"UL",{});var V=i(p);v=r(V,"LI",{});var ze=i(v);l=s(ze,"having all inputs as keyword arguments (like PyTorch models), or"),ze.forEach(t),m=u(V),G=r(V,"LI",{});var Ce=i(G);he=s(Ce,"having all inputs as a list, tuple or dict in the first positional arguments."),Ce.forEach(t),V.forEach(t),K=u(y),J=r(y,"P",{});var C=i(J);X=s(C,"This second option is useful when using "),D=r(C,"CODE",{});var Ae=i(D);Z=s(Ae,"tf.keras.Model.fit"),Ae.forEach(t),ue=s(C,` method which currently requires having all the
...
<span class="hljs-meta">&gt;&gt;&gt; </span>next_token_logits = outputs.logits[:, -<span class="hljs-number">1</span>]`}}),{c(){d=a("p"),T=n("Example:"),c=h(),k(p.$$.fragment)},l(l){d=r(l,"P",{});var m=i(d);T=s(m,"Example:"),m.forEach(t),c=u(l),b(p.$$.fragment,l)},m(l,m){g(l,d,m),e(d,T),g(l,c,m),w(p,l,m),v=!0},p:Ee,i(l){v||($(p.$$.fragment,l),v=!0)},o(l){P(p.$$.fragment,l),v=!1},d(l){l&&t(d),l&&t(c),F(p,l)}}}function Uf(j){let d,T,c,p,v,l,m,G,he,K,J,X,D,Z,ue,W,me,re,I,L,ee,te,E,M,fe,Q,ie,Y,H,oe,ge,q,le,N,_e,de,O,U,Te,z,ve,R,ne,y,x,V,ze,Ce,C,Ae,Le,Me,A,B,ce,Pe,S,Ie,ye,ke,Ne,ta,ct,Ni,Ro,Oi,Si,oa,Di,Wi,na,Ui,Bi,Lr,bt,Ht,sa,Vo,Qi,aa,Hi,Ir,Rt,Ri,_s,Vi,Ki,Nr,Ko,Or,Ts,Xi,Sr,Xo,Dr,wt,Vt,ra,Yo,Yi,ia,Zi,Wr,pt,Zo,el,Re,tl,vs,ol,nl,en,sl,al,ys,rl,il,ks,ll,dl,cl,Kt,Ur,$t,Xt,la,tn,pl,da,hl,Br,ht,on,ul,nn,ml,sn,fl,gl,_l,et,an,Tl,Pt,vl,bs,yl,kl,ca,bl,wl,$l,Yt,Pl,Zt,Qr,Ft,eo,pa,rn,Fl,ha,jl,Hr,Ve,ln,Gl,ua,xl,Jl,dn,El,cn,Ml,ql,zl,tt,pn,Cl,jt,Al,ws,Ll,Il,ma,Nl,Ol,Sl,to,Dl,oo,Rr,Gt,no,fa,hn,Wl,ga,Ul,Vr,Fe,un,Bl,_a,Ql,Hl,$s,Ps,Rl,Vl,Kl,Ke,Xl,Ta,Yl,Zl,va,ed,td,ya,od,nd,ka,sd,ad,rd,mn,id,fn,ld,dd,cd,$e,gn,pd,xt,hd,Fs,ud,md,ba,fd,gd,_d,so,Td,ao,vd,ro,yd,io,kd,lo,Kr,Jt,co,wa,_n,bd,$a,wd,Xr,Xe,Tn,$d,Et,Pd,Pa,Fd,jd,Fa,Gd,xd,Jd,vn,Ed,yn,Md,qd,zd,Oe,kn,Cd,Mt,Ad,js,Ld,Id,ja,Nd,Od,Sd,po,Dd,ho,Wd,uo,Yr,qt,mo,Ga,bn,Ud,xa,Bd,Zr,je,wn,Qd,Ja,Hd,Rd,$n,Vd,Gs,Kd,Xd,Yd,Pn,Zd,Fn,ec,tc,oc,fo,nc,ot,jn,sc,zt,ac,xs,rc,ic,Ea,lc,dc,cc,go,pc,_o,ei,Ct,To,Ma,Gn,hc,qa,uc,ti,Ge,xn,mc,za,fc,gc,Jn,_c,Js,Tc,vc,yc,En,kc,Mn,bc,wc,$c,vo,Pc,nt,qn,Fc,At,jc,Es,Gc,xc,Ca,Jc,Ec,Mc,yo,qc,ko,oi,Lt,bo,Aa,zn,zc,La,Cc,ni,se,Cn,Ac,Ia,Lc,Ic,Ms,qs,Nc,Oc,Sc,Ye,Dc,Na,Wc,Uc,Oa,Bc,Qc,Sa,Hc,Rc,Da,Vc,Kc,Xc,An,Yc,zs,Zc,ep,tp,Ln,op,In,np,sp,ap,wo,rp,Se,Nn,ip,It,lp,Cs,dp,cp,Wa,pp,hp,up,$o,mp,Po,fp,Fo,si,Nt,jo,Ua,On,gp,Ba,_p,ai,xe,Sn,Tp,Ot,vp,Qa,yp,kp,Ha,bp,wp,$p,Dn,Pp,As,Fp,jp,Gp,Wn,xp,Un,Jp,Ep,Mp,Go,qp,De,Bn,zp,St,Cp,Ls,Ap,Lp,Ra,Ip,Np,Op,xo,Sp,Jo,Dp,Eo,ri,Dt,Mo,Va,Qn,Wp,Ka,Up,ii,be,Hn,Bp,Xa,Qp,Hp,Rn,Rp,Is,Vp,Kp,Xp,Vn,Yp,Kn,Zp,eh,th,Ya,oh,nh,ut,Za,Xn,sh,ah,er,Yn,rh,ih,tr,Zn,lh,dh,or,es,ch,ph,st,ts,hh,Wt,uh,nr,mh,fh,sr,gh,_h,Th,qo,vh,zo,li,Ut,Co,ar,os,yh,rr,kh,di,we,ns,bh,ir,wh,$h,ss,Ph,Ns,Fh,jh,Gh,as,xh,rs,Jh,Eh,Mh,lr,qh,zh,mt,dr,is,Ch,Ah,cr,ls,Lh,Ih,pr,ds,Nh,Oh,hr,cs,Sh,Dh,at,ps,Wh,Bt,Uh,ur,Bh,Qh,mr,Hh,Rh,Vh,Ao,Kh,Lo,ci;return l=new He({}),Z=new He({}),A=new pe({props:{code:`from transformers import GPTJForCausalLM
import torch
...
<code>inputs_ids</code> passed when calling <a href="/docs/transformers/v4.20.1/en/model_doc/gptj#transformers.GPTJModel">GPTJModel</a>.`,name:"vocab_size"},{anchor:"transformers.GPTJConfig.n_positions",description:`<strong>n_positions</strong> (<code>int</code>, <em>optional</em>, defaults to 2048) &#x2014;
...
Whether or not to return a <a href="/docs/transformers/v4.20.1/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/v4.20.1/src/transformers/models/gptj/modeling_gptj.py#L532",returnDescription:`
<p>A <a
...
elements depending on the configuration (<a
  href="/docs/transformers/v4.20.1/en/model_doc/gptj#transformers.GPTJConfig"
...
are ignored (masked), the loss is only computed for labels in <code>[0, ..., config.vocab_size]</code>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.20.1/src/transformers/models/gptj/modeling_gptj.py#L786",returnDescription:`
<p>A <a
...
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.20.1/src/transformers/models/gptj/modeling_gptj.py#L908",returnDescription:`
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/v4.20.1/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/v4.20.1/src/transformers/models/gptj/modeling_gptj.py#L1019"}}),kn=new ae({props:{name:"forward",anchor:"transformers.GPTJForQuestionAnswering.forward",parameters:[{name:"input_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"attention_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"token_type_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"position_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"head_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"start_positions",val:": typing.Optional[torch.LongTensor] = None"},{name:"end_positions",val:": typing.Optional[torch.LongTensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.GPTJForQuestionAnswering.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <code>GPTJTokenizer</code>. See <a href="/docs/transformers/v4.20.1/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/v4.20.1/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/v4.20.1/src/transformers/models/gptj/modeling_gptj.py#L1035",returnDescription:`
<p>A <a
...
<p>Indices can be obtained using <code>GPTJTokenizer</code>. See <a href="/docs/transformers/v4.20.1/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
...
Whether or not to return a <a href="/docs/transformers/v4.20.1/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple. This argument can be used
...
<code>past</code>). Set to <code>False</code> during training, <code>True</code> during generation`,name:"use_cache"}],source:"https://github.com/huggingface/transformers/blob/v4.20.1/src/transformers/models/gptj/modeling_tf_gptj.py#L653",returnDescription:`
<p>A <a
...
Labels for language modeling. Note that the labels <strong>are shifted</strong> inside the model, i.e. you can set
<code>labels = input_ids</code> Indices are selected in <code>[-100, 0, ..., config.vocab_size]</code> All labels set to <code>-100</code>
are ignored (masked), the loss is only computed for labels in <code>[0, ..., config.vocab_size]</code>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.20.1/src/transformers/models/gptj/modeling_tf_gptj.py#L760",returnDescription:`
<p>A <a
...
Labels for computing the sequence classification/regression loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>. If <code>config.num_labels == 1</code> a regression loss is computed (Mean-Square loss), If
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.20.1/src/transformers/models/gptj/modeling_tf_gptj.py#L864",returnDescription:`
<p>A <a
...
Labels for position (index) of the end of the labelled span for computing the token classification loss.
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/v4.20.1/src/transformers/models/gptj/modeling_tf_gptj.py#L987",returnDescription:`
<p>A <a
...
causal language model trained on `),M=a("a"),fe=n("the Pile"),Q=n(" dataset."),ie=h(),Y=a("p"),H=n("This model was contributed by "),oe=a("a"),ge=n("Stella Biderman"),q=n("."),le=h(),N=a("p"),_e=n("Tips:"),de=h(),O=a("ul"),U=a("li"),Te=n("To load "),z=a("a"),ve=n("GPT-J"),R=n(` in float32 one would need at least 2x model size CPU
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),$c=h(),k(vo.$$.fragment),Pc=h(),nt=a("div"),k(qn.$$.fragment),Fc=h(),At=a("p"),jc=n("The "),Es=a("a"),Gc=n("TFGPTJForCausalLM"),xc=n(" forward method, overrides the "),Ca=a("code"),Jc=n("__call__"),Ec=n(" special method."),Mc=h(),k(yo.$$.fragment),qc=h(),k(ko.$$.fragment),oi=h(),Lt=a("h2"),bo=a("a"),Aa=a("span"),k(zn.$$.fragment),zc=h(),La=a("span"),Cc=n("TFGPTJForSequenceClassification"),ni=h(),se=a("div"),k(Cn.$$.fragment),Ac=h(),Ia=a("p"),Lc=n("The GPT-J Model transformer with a sequence classification head on top (linear layer)."),Ic=h(),Ms=a("p"),qs=a("a"),Nc=n("GPTJForSequenceClassification"),Oc=n(` uses the last token in order to do the classification, as other causal models
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),ap=h(),k(wo.$$.fragment),rp=h(),Se=a("div"),k(Nn.$$.fragment),ip=h(),It=a("p"),lp=n("The "),Cs=a("a"),dp=n("TFGPTJForSequenceClassification"),cp=n(" forward method, overrides the "),Wa=a("code"),pp=n("__call__"),hp=n(" special method."),up=h(),k($o.$$.fragment),mp=h(),k(Po.$$.fragment),fp=h(),k(Fo.$$.fragment),si=h(),Nt=a("h2"),jo=a("a"),Ua=a("span"),k(On.$$.fragment),gp=h(),Ba=a("span"),_p=n("TFGPTJForQuestionAnswering"),ai=h(),xe=a("div"),k(Sn.$$.fragment),Tp=h(),Ot=a("p"),vp=n(`The GPT-J Model transformer with a span classification head on top for extractive question-answering tasks like
SQuAD (a linear layers on top of the hidden-states output to compute `),Qa=a("code"),yp=n("span start logits"),kp=n(" and "),Ha=a("code"),bp=n("span end logits"),wp=n(")."),$p=h(),Dn=a("p"),Pp=n("This model inherits from "),As=a("a"),Fp=n("TFPreTrainedModel"),jp=n(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),Ti.forEach(t),cd=u(rt),$e=r(rt,"DIV",{class:!0});var We=i($e);b(gn.$$.fragment,We),pd=u(We),xt=r(We,"P",{});var Bs=i(xt);hd=s(Bs,"The "),Fs=r(Bs,"A",{href:!0});var qu=i(Fs);ud=s(qu,"GPTJForSequenceClassification"),qu.forEach(t),md=s(Bs," forward method, overrides the "),ba=r(Bs,"CODE",{});var zu=i(ba);fd=s(zu,"__call__"),zu.forEach(t),gd=s(Bs," special method."),Bs.forEach(t),_d=u(We),b(so.$$.fragment,We),Td=u(We),b(ao.$$.fragment,We),vd=u(We),b(ro.$$.fragment,We),yd=u(We),b(io.$$.fragment,We),kd=u(We),b(lo.$$.fragment,We),We.forEach(t),rt.forEach(t),Kr=u(o),Jt=r(o,"H2",{class:!0});var vi=i(Jt);co=r(vi,"A",{id:!0,class:!0,href:!0});var Cu=i(co);wa=r(Cu,"SPAN",{});var Au=i(wa);b(_n.$$.fragment,Au),Au.forEach(t),Cu.forEach(t),bd=u(vi),$a=r(vi,"SPAN",{});var Lu=i($a);wd=s(Lu,"GPTJForQuestionAnswering"),Lu.forEach(t),vi.forEach(t),Xr=u(o),Xe=r(o,"DIV",{class:!0});var So=i(Xe);b(Tn.$$.fragment,So),$d=u(So),Et=r(So,"P",{});var Qs=i(Et);Pd=s(Qs,`The GPT-J Model transformer with a span classification head on top for extractive question-answering tasks like
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Fi.forEach(t),$c=u(lt),b(vo.$$.fragment,lt),Pc=u(lt),nt=r(lt,"DIV",{class:!0});var Wo=i(nt);b(qn.$$.fragment,Wo),Fc=u(Wo),At=r(Wo,"P",{});var Vs=i(At);jc=s(Vs,"The "),Es=r(Vs,"A",{href:!0});var nm=i(Es);Gc=s(nm,"TFGPTJForCausalLM"),nm.forEach(t),xc=s(Vs," forward method, overrides the "),Ca=r(Vs,"CODE",{});var sm=i(Ca);Jc=s(sm,"__call__"),sm.forEach(t),Ec=s(Vs," special method."),Vs.forEach(t),Mc=u(Wo),b(yo.$$.fragment,Wo),qc=u(Wo),b(ko.$$.fragment,Wo),Wo.forEach(t),lt.forEach(t),oi=u(o),Lt=r(o,"H2",{class:!0});var ji=i(Lt);bo=r(ji,"A",{id:!0,class:!0,href:!0});var am=i(bo);Aa=r(am,"SPAN",{});var rm=i(Aa);b(zn.$$.fragment,rm),rm.forEach(t),am.forEach(t),zc=u(ji),La=r(ji,"SPAN",{});var im=i(La);Cc=s(im,"TFGPTJForSequenceClassification"),im.forEach(t),ji.forEach(t),ni=u(o),se=r(o,"DIV",{class:!0});var qe=i(se);b(Cn.$$.fragment,qe),Ac=u(qe),Ia=r(qe,"P",{});var lm=i(Ia);Lc=s(lm,"The GPT-J Model transformer with a sequence classification head on top (linear layer)."),lm.forEach(t),Ic=u(qe),Ms=r(qe,"P",{});var Yh=i(Ms);qs=r(Yh,"A",{href:!0});var dm=i(qs);Nc=s(dm,"GPTJForSequenceClassification"),dm.forEach(t),Oc=s(Yh,` uses the last token in order to do the classification, as other causal models
...
no `),Oa=r(vt,"CODE",{});var pm=i(Oa);Bc=s(pm,"pad_token_id"),pm.forEach(t),Qc=s(vt,` is defined, it simply takes the last value in each row of the batch. Since it cannot guess the
...
each row of the batch).`),vt.forEach(t),Xc=u(qe),An=r(qe,"P",{});var Gi=i(An);Yc=s(Gi,"This model inherits from "),zs=r(Gi,"A",{href:!0});var mm=i(zs);Zc=s(mm,"TFPreTrainedModel"),mm.forEach(t),ep=s(Gi,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),xi.forEach(t),ap=u(qe),b(wo.$$.fragment,qe),rp=u(qe),Se=r(qe,"DIV",{class:!0});var yt=i(Se);b(Nn.$$.fragment,yt),ip=u(yt),It=r(yt,"P",{});var Ks=i(It);lp=s(Ks,"The "),Cs=r(Ks,"A",{href:!0});var gm=i(Cs);dp=s(gm,"TFGPTJForSequenceClassification"),gm.forEach(t),cp=s(Ks," forward method, overrides the "),Wa=r(Ks,"CODE",{});var _m=i(Wa);pp=s(_m,"__call__"),_m.forEach(t),hp=s(Ks," special method."),Ks.forEach(t),up=u(yt),b($o.$$.fragment,yt),mp=u(yt),b(Po.$$.fragment,yt),fp=u(yt),b(Fo.$$.fragment,yt),yt.forEach(t),qe.forEach(t),si=u(o),Nt=r(o,"H2",{class:!0});var Ji=i(Nt);jo=r(Ji,"A",{id:!0,class:!0,href:!0});var Tm=i(jo);Ua=r(Tm,"SPAN",{});var vm=i(Ua);b(On.$$.fragment,vm),vm.forEach(t),Tm.forEach(t),gp=u(Ji),Ba=r(Ji,"SPAN",{});var ym=i(Ba);_p=s(ym,"TFGPTJForQuestionAnswering"),ym.forEach(t),Ji.forEach(t),ai=u(o),xe=r(o,"DIV",{class:!0});var dt=i(xe);b(Sn.$$.fragment,dt),Tp=u(dt),Ot=r(dt,"P",{});var Xs=i(Ot);vp=s(Xs,`The GPT-J Model transformer with a span classification head on top for extractive question-answering tasks like
