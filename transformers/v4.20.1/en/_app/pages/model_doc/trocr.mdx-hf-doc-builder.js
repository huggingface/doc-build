...
above for more information.`),R.forEach(r),this.h()},h(){l(u,"href","/docs/transformers/v4.20.1/en/main_classes/feature_extractor#transformers.FeatureExtractionMixin.save_pretrained")},m(j,R){f(j,p,R),e(p,E),e(p,u),e(u,g),e(p,T),e(p,m),e(m,_),e(p,D)},d(j){j&&r(p)}}}function bi(S){let p,E,u,g,T;return g=new Bs({props:{code:`from transformers import (
    TrOCRConfig,
    TrOCRProcessor,
    TrOCRForCausalLM,
    ViTConfig,
...
<span class="hljs-string">&#x27;industry, &quot; Mr. Brown commented icily. &quot; Let us have a&#x27;</span>`}}),{c(){p=s("p"),E=o("Example:"),u=c(),C(g.$$.fragment)},l(m){p=n(m,"P",{});var _=i(p);E=a(_,"Example:"),_.forEach(r),u=h(m),w(g.$$.fragment,m)},m(m,_){f(m,p,_),e(p,E),f(m,u,_),k(g,m,_),T=!0},p:ci,i(m){T||($(g.$$.fragment,m),T=!0)},o(m){y(g.$$.fragment,m),T=!1},d(m){m&&r(p),m&&r(u),O(g,m)}}}function Ci(S){let p,E,u,g,T,m,_,D,j,R,z,F,zt,$e,ro,Lt,oo,ur,W,ao,ye,so,no,Oe,io,lo,gr,st,co,_r,nt,Ft,ho,vr,re,Us,Tr,oe,mo,it,fo,po,br,ae,uo,Dt,go,_o,Cr,H,vo,Re,To,bo,Ee,Co,wo,wr,lt,ko,kr,B,xe,$o,Pe,yo,Oo,Ro,I,Eo,Me,xo,Po,je,Mo,jo,ze,zo,Lo,Fo,Le,Do,dt,qo,Ao,$r,J,se,qt,Fe,Io,At,Vo,yr,U,No,It,So,Wo,ct,Ho,Bo,Or,v,Uo,Vt,Go,Xo,Nt,Zo,Jo,St,Yo,Ko,Wt,Qo,ea,ht,ta,ra,Ht,oa,aa,Bt,sa,na,Ut,ia,la,Gt,da,ca,Rr,mt,Xt,ha,Er,De,xr,ne,ma,qe,fa,pa,Pr,Y,ie,Zt,Ae,ua,Jt,ga,Mr,q,Ie,_a,K,va,ft,Ta,ba,Ve,Ca,wa,ka,Q,$a,pt,ya,Oa,ut,Ra,Ea,xa,le,jr,ee,de,Yt,Ne,Pa,Kt,Ma,zr,b,Se,ja,Qt,za,La,P,gt,Fa,Da,er,qa,Aa,tr,Ia,Va,rr,Na,Sa,or,Wa,Ha,We,ar,Ba,Ua,Ga,_t,Xa,Za,Ja,ce,He,Ya,V,Ka,sr,Qa,es,vt,ts,rs,nr,os,as,ss,G,Be,ns,ir,is,ls,he,ds,X,Ue,cs,Ge,hs,Tt,ms,fs,ps,me,us,fe,Xe,gs,Ze,_s,bt,vs,Ts,bs,pe,Je,Cs,Ye,ws,Ct,ks,$s,ys,ue,Ke,Os,lr,Rs,Lr,te,ge,dr,Qe,Es,cr,xs,Fr,A,et,Ps,N,Ms,wt,js,zs,hr,Ls,Fs,kt,Ds,qs,As,tt,Is,rt,Vs,Ns,Ss,_e,ot,Ws,ve,Dr;return m=new jt({}),$e=new jt({}),Fe=new jt({}),De=new Bs({props:{code:`from transformers import TrOCRProcessor, VisionEncoderDecoderModel
import requests 
from PIL import Image
...
An instance of [<code>RobertaTokenizer</code>/<code>XLMRobertaTokenizer</code>]. The tokenizer is a required input.`,name:"tokenizer"}],source:"https://github.com/huggingface/transformers/blob/v4.20.1/src/transformers/models/trocr/processing_trocr.py#L23"}}),He=new Z({props:{name:"__call__",anchor:"transformers.TrOCRProcessor.__call__",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/v4.20.1/src/transformers/models/trocr/processing_trocr.py#L44"}}),Be=new Z({props:{name:"from_pretrained",anchor:"transformers.TrOCRProcessor.from_pretrained",parameters:[{name:"pretrained_model_name_or_path",val:""},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.TrOCRProcessor.from_pretrained.pretrained_model_name_or_path",description:`<strong>pretrained_model_name_or_path</strong> (<code>str</code> or <code>os.PathLike</code>) &#x2014;
...
provide it.</p>
<p>Indices can be obtained using <code>TrOCRTokenizer</code>. See <a href="/docs/transformers/v4.20.1/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
...
tasks.`),vr=c(),re=s("img"),Tr=c(),oe=s("small"),mo=o("TrOCR architecture. Taken from the "),it=s("a"),fo=o("original paper"),po=o("."),br=c(),ae=s("p"),uo=o("Please refer to the "),Dt=s("code"),go=o("VisionEncoderDecoder"),_o=o(" class on how to use this model."),Cr=c(),H=s("p"),vo=o("This model was contributed by "),Re=s("a"),To=o("nielsr"),bo=o(`. The original code can be found
