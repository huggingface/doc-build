import{S as dh,i as ih,s as ch,e as n,k as i,w as v,t as r,M as ph,c as a,d as o,m as c,a as s,x as y,h as l,b as m,G as e,g as _,y as T,q as w,o as $,B as S,v as mh,L as Xe}from"../../chunks/vendor-hf-doc-builder.js";import{T as qn}from"../../chunks/Tip-hf-doc-builder.js";import{D as C}from"../../chunks/Docstring-hf-doc-builder.js";import{C as Ye}from"../../chunks/CodeBlock-hf-doc-builder.js";import{I as xe}from"../../chunks/IconCopyLink-hf-doc-builder.js";import{E as Je}from"../../chunks/ExampleCodeBlock-hf-doc-builder.js";function uh(B){let p,k,f,u,b;return u=new Ye({props:{code:`from transformers import BlenderbotSmallModel, BlenderbotSmallConfig
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),{c(){p=n("p"),k=r("Example:"),f=i(),v(u.$$.fragment)},l(d){p=a(d,"P",{});var h=s(p);k=l(h,"Example:"),h.forEach(o),f=c(d),y(u.$$.fragment,d)},m(d,h){_(d,p,h),e(p,k),_(d,f,h),T(u,d,h),b=!0},p:Xe,i(d){b||(w(u.$$.fragment,d),b=!0)},o(d){$(u.$$.fragment,d),b=!1},d(d){d&&o(p),d&&o(f),S(u,d)}}}function Th(B){let p,k,f,u,b,d,h,F,Ce,ue,z,je,W,Oe,Pe,R,Le,Ne,Q,V,Ie,Z,j,L,he,ae,ze,J,D,be,se,N,ke,re,Be,ee,le,de,Ae,X,Fe,H,De;return{c(){p=n("p"),k=r("TF 2.0 models accepts two formats as inputs:"),f=i(),u=n("ul"),b=n("li"),d=r("having all inputs as keyword arguments (like PyTorch models), or"),h=i(),F=n("li"),Ce=r("having all inputs as a list, tuple or dict in the first positional arguments."),ue=i(),z=n("p"),je=r("This second option is useful when using "),W=n("code"),Oe=r("tf.keras.Model.fit"),Pe=r(` method which currently requires having all the
tensors in the first argument of the model call function: `),R=n("code"),Le=r("model(inputs)"),Ne=r("."),Q=i(),V=n("p"),Ie=r(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),Z=i(),j=n("ul"),L=n("li"),he=r("a single Tensor with "),ae=n("code"),ze=r("input_ids"),J=r(" only and nothing else: "),D=n("code"),be=r("model(input_ids)"),se=i(),N=n("li"),ke=r(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),re=n("code"),Be=r("model([input_ids, attention_mask])"),ee=r(" or "),le=n("code"),de=r("model([input_ids, attention_mask, token_type_ids])"),Ae=i(),X=n("li"),Fe=r(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),H=n("code"),De=r('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(x){p=a(x,"P",{});var q=s(p);k=l(q,"TF 2.0 models accepts two formats as inputs:"),q.forEach(o),f=c(x),u=a(x,"UL",{});var ie=s(u);b=a(ie,"LI",{});var Ze=s(b);d=l(Ze,"having all inputs as keyword arguments (like PyTorch models), or"),Ze.forEach(o),h=c(ie),F=a(ie,"LI",{});var Re=s(F);Ce=l(Re,"having all inputs as a list, tuple or dict in the first positional arguments."),Re.forEach(o),ie.forEach(o),ue=c(x),z=a(x,"P",{});var O=s(z);je=l(O,"This second option is useful when using "),W=a(O,"CODE",{});var eo=s(W);Oe=l(eo,"tf.keras.Model.fit"),eo.forEach(o),Pe=l(O,` method which currently requires having all the
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_decoder_hidden_states = outputs.last_hidden_state`}}),{c(){p=n("p"),k=r("Example:"),f=i(),v(u.$$.fragment)},l(d){p=a(d,"P",{});var h=s(p);k=l(h,"Example:"),h.forEach(o),f=c(d),y(u.$$.fragment,d)},m(d,h){_(d,p,h),e(p,k),_(d,f,h),T(u,d,h),b=!0},p:Xe,i(d){b||(w(u.$$.fragment,d),b=!0)},o(d){$(u.$$.fragment,d),b=!1},d(d){d&&o(p),d&&o(f),S(u,d)}}}function zh(B){let p,k,f,u,b;return{c(){p=n("p"),k=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=n("code"),u=r("Module"),b=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(d){p=a(d,"P",{});var h=s(p);k=l(h,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=a(h,"CODE",{});var F=s(f);u=l(F,"Module"),F.forEach(o),b=l(h,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
<span class="hljs-meta">&gt;&gt;&gt; </span>outputs = model.decode(decoder_input_ids, encoder_outputs)
<span class="hljs-meta">&gt;&gt;&gt; </span>logits = outputs.logits`}}),{c(){p=n("p"),k=r("Example:"),f=i(),v(u.$$.fragment)},l(d){p=a(d,"P",{});var h=s(p);k=l(h,"Example:"),h.forEach(o),f=c(d),y(u.$$.fragment,d)},m(d,h){_(d,p,h),e(p,k),_(d,f,h),T(u,d,h),b=!0},p:Xe,i(d){b||(w(u.$$.fragment,d),b=!0)},o(d){$(u.$$.fragment,d),b=!1},d(d){d&&o(p),d&&o(f),S(u,d)}}}function qh(B){let p,k,f,u,b,d,h,F,Ce,ue,z,je,W,Oe,Pe,R,Le,Ne,Q,V,Ie,Z,j,L,he,ae,ze,J,D,be,se,N,ke,re,Be,ee,le,de,Ae,X,Fe,H,De,x,q,ie,Ze,Re,O,eo,ve,oo,Y,G,to,no,oe,ce,fe,ye,Te,ml,ra,ul,cr,we,ut,hl,ao,fl,En,_l,gl,ht,bl,kl,vl,so,yl,Mn,Tl,wl,Cn,$l,Sl,xl,wo,pr,ro,$o,la,ft,zl,da,Bl,mr,U,_t,Fl,ia,ql,El,gt,Ml,jn,Cl,jl,Ol,He,bt,Pl,ca,Ll,Nl,pa,Il,Al,So,kt,Dl,lo,Gl,ma,Ul,Wl,ua,Rl,Hl,Kl,Ke,vt,Ql,On,Vl,Pn,Jl,Xl,ha,Yl,Zl,Ln,yt,ur,io,xo,fa,Tt,ed,_a,od,hr,Ge,wt,td,$t,nd,ga,ad,sd,rd,zo,St,ld,ba,dd,fr,co,Bo,ka,xt,id,va,cd,_r,$e,zt,pd,Bt,md,Nn,ud,hd,fd,Ft,_d,qt,gd,bd,kd,qe,Et,vd,po,yd,In,Td,wd,ya,$d,Sd,xd,Fo,zd,qo,gr,mo,Eo,Ta,Mt,Bd,wa,Fd,br,Se,Ct,qd,jt,Ed,An,Md,Cd,jd,Ot,Od,Pt,Pd,Ld,Nd,Ee,Lt,Id,uo,Ad,Dn,Dd,Gd,$a,Ud,Wd,Rd,Mo,Hd,Co,kr,ho,jo,Sa,Nt,Kd,xa,Qd,vr,fo,It,Vd,Oo,At,Jd,Po,yr,_o,Lo,za,Dt,Xd,Ba,Yd,Tr,pe,Gt,Zd,Ut,ei,Gn,oi,ti,ni,Wt,ai,Rt,si,ri,li,No,di,Me,Ht,ii,go,ci,Un,pi,mi,Fa,ui,hi,fi,Io,_i,Ao,wr,bo,Do,qa,Kt,gi,Ea,bi,$r,me,Qt,ki,Vt,vi,Wn,yi,Ti,wi,Jt,$i,Xt,Si,xi,zi,Go,Bi,P,Yt,Fi,ko,qi,Rn,Ei,Mi,Ma,Ci,ji,Oi,Uo,Pi,Ca,Li,Ni,ja,Oa,Pa,La,Ii,Ai,Na,Ia,Aa,Da,Di,Gi,Ga,Ua,Wa,Ra,Ui,Wi,Ha,Ka,Qa,Zt,Ri,Va,Hi,Ki,Qi,Ja,Xa,Ya,Za,Vi,Sr,vo,Wo,es,en,Ji,os,Xi,xr,I,on,Yi,tn,Zi,Hn,ec,oc,tc,nn,nc,an,ac,sc,rc,ts,lc,dc,Ue,ns,sn,ic,cc,as,rn,pc,mc,ss,ln,uc,hc,rs,dn,fc,_c,Ro,cn,gc,Ho,bc,Ko,pn,kc,Qo,vc,Vo,mn,yc,Jo,zr,yo,Xo,ls,un,Tc,ds,wc,Br,A,hn,$c,fn,Sc,Kn,xc,zc,Bc,_n,Fc,gn,qc,Ec,Mc,is,Cc,jc,We,cs,bn,Oc,Pc,ps,kn,Lc,Nc,ms,vn,Ic,Ac,us,yn,Dc,Gc,E,Tn,Uc,To,Wc,hs,Rc,Hc,fs,Kc,Qc,Vc,Yo,Jc,_s,Xc,Yc,gs,bs,ks,vs,Zc,ep,ys,Ts,ws,$s,op,tp,Ss,xs,zs,Bs,np,ap,Fs,qs,wn,Zo,et,Es,$n,sp,Ms,rp,lp,Cs,dp,ip,js,cp,pp,Os,Ps,Ls,Ns,mp,up,Is,As,Ds,Gs,hp,fp,Us,Ws,Rs,Hs,_p,gp,Ks,Qs,Vs,Js,bp,kp,ot,Sn,vp,tt,yp,nt,xn,Tp,at,Fr;return d=new xe({}),se=new xe({}),Te=new xe({}),ut=new C({props:{name:"class transformers.BlenderbotSmallConfig",anchor:"transformers.BlenderbotSmallConfig",parameters:[{name:"vocab_size",val:" = 50265"},{name:"max_position_embeddings",val:" = 512"},{name:"encoder_layers",val:" = 8"},{name:"encoder_ffn_dim",val:" = 2048"},{name:"encoder_attention_heads",val:" = 16"},{name:"decoder_layers",val:" = 8"},{name:"decoder_ffn_dim",val:" = 2048"},{name:"decoder_attention_heads",val:" = 16"},{name:"encoder_layerdrop",val:" = 0.0"},{name:"decoder_layerdrop",val:" = 0.0"},{name:"use_cache",val:" = True"},{name:"is_encoder_decoder",val:" = True"},{name:"activation_function",val:" = 'gelu'"},{name:"d_model",val:" = 512"},{name:"dropout",val:" = 0.1"},{name:"attention_dropout",val:" = 0.0"},{name:"activation_dropout",val:" = 0.0"},{name:"init_std",val:" = 0.02"},{name:"decoder_start_token_id",val:" = 1"},{name:"classifier_dropout",val:" = 0.0"},{name:"scale_embedding",val:" = False"},{name:"pad_token_id",val:" = 0"},{name:"bos_token_id",val:" = 1"},{name:"eos_token_id",val:" = 2"},{name:"forced_eos_token_id",val:" = 2"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.BlenderbotSmallConfig.vocab_size",description:`<strong>vocab_size</strong> (<code>int</code>, <em>optional</em>, defaults to 50265) &#x2014;
...
it.</p>
<p>Indices can be obtained using <a href="/docs/transformers/v4.20.1/en/model_doc/blenderbot-small#transformers.BlenderbotSmallTokenizer">BlenderbotSmallTokenizer</a>. See <a href="/docs/transformers/v4.20.1/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
...
documentation from `),Cn=n("a"),$l=r("PretrainedConfig"),Sl=r(" for more information."),xl=i(),v(wo.$$.fragment),pr=i(),ro=n("h2"),$o=n("a"),la=n("span"),v(ft.$$.fragment),zl=i(),da=n("span"),Bl=r("BlenderbotSmallTokenizer"),mr=i(),U=n("div"),v(_t.$$.fragment),Fl=i(),ia=n("p"),ql=r("Constructs a Blenderbot-90M tokenizer based on BPE (Byte-Pair-Encoding)"),El=i(),gt=n("p"),Ml=r("This tokenizer inherits from "),jn=n("a"),Cl=r("PreTrainedTokenizer"),jl=r(` which contains most of the main methods. Users should refer to
...
IDs?`),Xl=i(),ha=n("p"),Yl=r("Should be overridden in a subclass if the model has a special way of building those."),Zl=i(),Ln=n("div"),v(yt.$$.fragment),ur=i(),io=n("h2"),xo=n("a"),fa=n("span"),v(Tt.$$.fragment),ed=i(),_a=n("span"),od=r("BlenderbotSmallTokenizerFast"),hr=i(),Ge=n("div"),v(wt.$$.fragment),td=i(),$t=n("p"),nd=r("Construct a \u201Cfast\u201D BlenderbotSmall tokenizer (backed by HuggingFace\u2019s "),ga=n("em"),ad=r("tokenizers"),sd=r(" library)."),rd=i(),zo=n("div"),v(St.$$.fragment),ld=i(),ba=n("p"),dd=r(`Create a mask from the two sequences passed to be used in a sequence-pair classification task. BlenderbotSmall
does not make use of token type ids, therefore a list of zeros is returned.`),fr=i(),co=n("h2"),Bo=n("a"),ka=n("span"),v(xt.$$.fragment),id=i(),va=n("span"),cd=r("BlenderbotSmallModel"),_r=i(),$e=n("div"),v(zt.$$.fragment),pd=i(),Bt=n("p"),md=r(`The bare BlenderbotSmall Model outputting raw hidden-states without any specific head on top.
...
and behavior.`),kd=i(),qe=n("div"),v(Et.$$.fragment),vd=i(),po=n("p"),yd=r("The "),In=n("a"),Td=r("BlenderbotSmallModel"),wd=r(" forward method, overrides the "),ya=n("code"),$d=r("__call__"),Sd=r(" special method."),xd=i(),v(Fo.$$.fragment),zd=i(),v(qo.$$.fragment),gr=i(),mo=n("h2"),Eo=n("a"),Ta=n("span"),v(Mt.$$.fragment),Bd=i(),wa=n("span"),Fd=r("BlenderbotSmallForConditionalGeneration"),br=i(),Se=n("div"),v(Ct.$$.fragment),qd=i(),jt=n("p"),Ed=r(`The BlenderbotSmall Model with a language modeling head. Can be used for summarization.
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Nd=i(),Ee=n("div"),v(Lt.$$.fragment),Id=i(),uo=n("p"),Ad=r("The "),Dn=n("a"),Dd=r("BlenderbotSmallForConditionalGeneration"),Gd=r(" forward method, overrides the "),$a=n("code"),Ud=r("__call__"),Wd=r(" special method."),Rd=i(),v(Mo.$$.fragment),Hd=i(),v(Co.$$.fragment),kr=i(),ho=n("h2"),jo=n("a"),Sa=n("span"),v(Nt.$$.fragment),Kd=i(),xa=n("span"),Qd=r("BlenderbotSmallForCausalLM"),vr=i(),fo=n("div"),v(It.$$.fragment),Vd=i(),Oo=n("div"),v(At.$$.fragment),Jd=i(),v(Po.$$.fragment),yr=i(),_o=n("h2"),Lo=n("a"),za=n("span"),v(Dt.$$.fragment),Xd=i(),Ba=n("span"),Yd=r("TFBlenderbotSmallModel"),Tr=i(),pe=n("div"),v(Gt.$$.fragment),Zd=i(),Ut=n("p"),ei=r(`The bare BLENDERBOT_SMALL Model outputting raw hidden-states without any specific head on top.
...
behavior.`),li=i(),v(No.$$.fragment),di=i(),Me=n("div"),v(Ht.$$.fragment),ii=i(),go=n("p"),ci=r("The "),Un=n("a"),pi=r("TFBlenderbotSmallModel"),mi=r(" forward method, overrides the "),Fa=n("code"),ui=r("__call__"),hi=r(" special method."),fi=i(),v(Io.$$.fragment),_i=i(),v(Ao.$$.fragment),wr=i(),bo=n("h2"),Do=n("a"),qa=n("span"),v(Kt.$$.fragment),gi=i(),Ea=n("span"),bi=r("TFBlenderbotSmallForConditionalGeneration"),$r=i(),me=n("div"),v(Qt.$$.fragment),ki=i(),Vt=n("p"),vi=r(`The BLENDERBOT_SMALL Model with a language modeling head. Can be used for summarization.
...
tokenizer = BlenderbotSmallTokenizer.from_pretrained(\u2018facebook/blenderbot_small-90M\u2019)`),tp=i(),Ss=n("blockquote"),xs=n("blockquote"),zs=n("blockquote"),Bs=n("p"),np=r(`ARTICLE_TO_SUMMARIZE = \u201CMy friends are cool but they eat too many carbs.\u201D >>> inputs =
...
and code publicly available. Human evaluations show our best models are superior to existing approaches in multi-turn
dialogue in terms of engagingness and humanness measurements. We then discuss the limitations of this work by analyzing
failure cases of our models.`),Sp.forEach(o),$p.forEach(o),Re=c(t),O=a(t,"P",{});var Qn=s(O);eo=l(Qn,"This model was contributed by "),ve=a(Qn,"A",{href:!0,rel:!0});var xp=s(ve);oo=l(xp,"patrickvonplaten"),xp.forEach(o),Y=l(Qn,`. The authors\u2019 code can be
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Ir.forEach(o),kd=c(rt),qe=a(rt,"DIV",{class:!0});var lt=s(qe);y(Et.$$.fragment,lt),vd=c(lt),po=a(lt,"P",{});var oa=s(po);yd=l(oa,"The "),In=a(oa,"A",{href:!0});var nm=s(In);Td=l(nm,"BlenderbotSmallModel"),nm.forEach(o),wd=l(oa," forward method, overrides the "),ya=a(oa,"CODE",{});var am=s(ya);$d=l(am,"__call__"),am.forEach(o),Sd=l(oa," special method."),oa.forEach(o),xd=c(lt),y(Fo.$$.fragment,lt),zd=c(lt),y(qo.$$.fragment,lt),lt.forEach(o),rt.forEach(o),gr=c(t),mo=a(t,"H2",{class:!0});var Ar=s(mo);Eo=a(Ar,"A",{id:!0,class:!0,href:!0});var sm=s(Eo);Ta=a(sm,"SPAN",{});var rm=s(Ta);y(Mt.$$.fragment,rm),rm.forEach(o),sm.forEach(o),Bd=c(Ar),wa=a(Ar,"SPAN",{});var lm=s(wa);Fd=l(lm,"BlenderbotSmallForConditionalGeneration"),lm.forEach(o),Ar.forEach(o),br=c(t),Se=a(t,"DIV",{class:!0});var dt=s(Se);y(Ct.$$.fragment,dt),qd=c(dt),jt=a(dt,"P",{});var Dr=s(jt);Ed=l(Dr,`The BlenderbotSmall Model with a language modeling head. Can be used for summarization.
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Jr.forEach(o),wi=c(Ve),Jt=a(Ve,"P",{});var Xr=s(Jt);$i=l(Xr,"This model is also a "),Xt=a(Xr,"A",{href:!0,rel:!0});var xm=s(Xt);Si=l(xm,"tf.keras.Model"),xm.forEach(o),xi=l(Xr,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
...
next_reply_ids = model.generate(**inputs) >>> print(\u201CBot: \u201D, tokenizer.batch_decode(next_reply_ids,
skip_special_tokens=True)[0])`),Vm.forEach(o),Qm.forEach(o),Km.forEach(o),Hm.forEach(o),K.forEach(o),Ve.forEach(o),Sr=c(t),vo=a(t,"H2",{class:!0});var Zr=s(vo);Wo=a(Zr,"A",{id:!0,class:!0,href:!0});var Jm=s(Wo);es=a(Jm,"SPAN",{});var Xm=s(es);y(en.$$.fragment,Xm),Xm.forEach(o),Jm.forEach(o),Ji=c(Zr),os=a(Zr,"SPAN",{});var Ym=s(os);Xi=l(Ym,"FlaxBlenderbotSmallModel"),Ym.forEach(o),Zr.forEach(o),xr=c(t),I=a(t,"DIV",{class:!0});var te=s(I);y(on.$$.fragment,te),Yi=c(te),tn=a(te,"P",{});var el=s(tn);Zi=l(el,`The bare BlenderbotSmall Model transformer outputting raw hidden-states without any specific head on top.
