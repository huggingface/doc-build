import{S as qi,i as Fi,s as zi,e as r,k as g,w,t as d,M as ji,c as i,d as t,m as _,a as l,x as v,h as c,b as f,N as Ci,G as e,g as b,y as $,q as y,o as T,B as Y,v as Ai,L as S}from"../../chunks/vendor-hf-doc-builder.js";import{T as ft}from"../../chunks/Tip-hf-doc-builder.js";import{D as O}from"../../chunks/Docstring-hf-doc-builder.js";import{C as P}from"../../chunks/CodeBlock-hf-doc-builder.js";import{I as we}from"../../chunks/IconCopyLink-hf-doc-builder.js";import{E}from"../../chunks/ExampleCodeBlock-hf-doc-builder.js";function Oi(M){let n,u,a,p,k;return p=new P({props:{code:`from transformers import YosoModel, YosoConfig
...
<span class="hljs-meta">&gt;&gt;&gt; </span>predicted_class_id = logits.argmax().item()
<span class="hljs-meta">&gt;&gt;&gt; </span>model.config.id2label[predicted_class_id]
`}}),{c(){n=r("p"),u=d("Example of multi-label classification:"),a=g(),w(p.$$.fragment)},l(s){n=i(s,"P",{});var h=l(n);u=c(h,"Example of multi-label classification:"),h.forEach(t),a=_(s),v(p.$$.fragment,s)},m(s,h){b(s,n,h),e(n,u),b(s,a,h),$(p,s,h),k=!0},p:S,i(s){k||(y(p.$$.fragment,s),k=!0)},o(s){T(p.$$.fragment,s),k=!1},d(s){s&&t(n),s&&t(a),Y(p,s)}}}function Bi(M){let n,u;return n=new P({props:{code:`# To train a model on \`num_labels\` classes, you can pass \`num_labels=num_labels\` to \`.from_pretrained(...)\`
num_labels = len(model.config.id2label)
...
<span class="hljs-meta">... </span>)
<span class="hljs-meta">&gt;&gt;&gt; </span>loss = model(**inputs, labels=labels).loss
<span class="hljs-meta">&gt;&gt;&gt; </span>loss.backward()`}}),{c(){w(n.$$.fragment)},l(a){v(n.$$.fragment,a)},m(a,p){$(n,a,p),u=!0},p:S,i(a){u||(y(n.$$.fragment,a),u=!0)},o(a){T(n.$$.fragment,a),u=!1},d(a){Y(n,a)}}}function Qi(M){let n,u,a,p,k;return{c(){n=r("p"),u=d("Although the recipe for forward pass needs to be defined within this function, one should call the "),a=r("code"),p=d("Module"),k=d(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(s){n=i(s,"P",{});var h=l(n);u=c(h,"Although the recipe for forward pass needs to be defined within this function, one should call the "),a=i(h,"CODE",{});var x=l(a);p=c(x,"Module"),x.forEach(t),k=c(h,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
<span class="hljs-meta">&gt;&gt;&gt; </span>loss = outputs.loss
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-built_in">round</span>(loss.item(), <span class="hljs-number">2</span>)
`}}),{c(){w(n.$$.fragment)},l(a){v(n.$$.fragment,a)},m(a,p){$(n,a,p),u=!0},p:S,i(a){u||(y(n.$$.fragment,a),u=!0)},o(a){T(n.$$.fragment,a),u=!1},d(a){Y(n,a)}}}function Xi(M){let n,u,a,p,k,s,h,x,Hs,is,Z,ve,gt,oo,Bs,_t,Qs,ls,X,Us,to,Rs,Vs,Gs,ds,No,Ks,cs,Io,bt,Js,ps,Do,Zs,hs,R,kt,Xs,en,ee,on,wt,tn,sn,vt,nn,an,rn,oe,ln,$t,dn,cn,yt,pn,hn,ms,$e,zr,us,ye,mn,Wo,un,fn,fs,V,gn,so,_n,bn,no,kn,wn,gs,te,Te,Tt,ao,vn,Yt,$n,_s,A,ro,yn,se,Tn,Ho,Yn,Mn,io,xn,qn,Fn,ne,zn,Bo,jn,Cn,Qo,An,On,En,Ye,bs,ae,Me,Mt,lo,Sn,xt,Pn,ks,I,co,Ln,po,Nn,ho,In,Dn,Wn,L,mo,Hn,re,Bn,Uo,Qn,Un,qt,Rn,Vn,Gn,xe,Kn,qe,ws,ie,Fe,Ft,uo,Jn,zt,Zn,vs,D,fo,Xn,le,ea,jt,oa,ta,go,sa,na,aa,F,_o,ra,de,ia,Ro,la,da,Ct,ca,pa,ha,ze,ma,je,ua,Ce,$s,ce,Ae,At,bo,fa,Ot,ga,ys,W,ko,_a,wo,ba,vo,ka,wa,va,q,$o,$a,pe,ya,Vo,Ta,Ya,Et,Ma,xa,qa,Oe,Fa,Ee,za,Se,ja,Pe,Ca,Le,Ts,he,Ne,St,yo,Aa,Pt,Oa,Ys,H,To,Ea,Yo,Sa,Mo,Pa,La,Na,N,xo,Ia,me,Da,Go,Wa,Ha,Lt,Ba,Qa,Ua,Ie,Ra,De,Ms,ue,We,Nt,qo,Va,It,Ga,xs,B,Fo,Ka,zo,Ja,jo,Za,Xa,er,z,Co,or,fe,tr,Ko,sr,nr,Dt,ar,rr,ir,He,lr,Be,dr,Qe,qs,ge,Ue,Wt,Ao,cr,Ht,pr,Fs,Q,Oo,hr,U,mr,Bt,ur,fr,Qt,gr,_r,Eo,br,kr,wr,j,So,vr,_e,$r,Jo,yr,Tr,Ut,Yr,Mr,xr,Re,qr,Ve,Fr,Ge,zs;return s=new we({}),oo=new we({}),ao=new we({}),ro=new O({props:{name:"class transformers.YosoConfig",anchor:"transformers.YosoConfig",parameters:[{name:"vocab_size",val:" = 50265"},{name:"hidden_size",val:" = 768"},{name:"num_hidden_layers",val:" = 12"},{name:"num_attention_heads",val:" = 12"},{name:"intermediate_size",val:" = 3072"},{name:"hidden_act",val:" = 'gelu'"},{name:"hidden_dropout_prob",val:" = 0.1"},{name:"attention_probs_dropout_prob",val:" = 0.1"},{name:"max_position_embeddings",val:" = 4096"},{name:"type_vocab_size",val:" = 1"},{name:"initializer_range",val:" = 0.02"},{name:"layer_norm_eps",val:" = 1e-12"},{name:"position_embedding_type",val:" = 'absolute'"},{name:"use_expectation",val:" = True"},{name:"hash_code_len",val:" = 9"},{name:"num_hash",val:" = 64"},{name:"conv_window",val:" = None"},{name:"use_fast_hash",val:" = True"},{name:"lsh_backward",val:" = True"},{name:"pad_token_id",val:" = 1"},{name:"bos_token_id",val:" = 0"},{name:"eos_token_id",val:" = 2"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.YosoConfig.vocab_size",description:`<strong>vocab_size</strong> (<code>int</code>, <em>optional</em>, defaults to 50265) &#x2014;
Vocabulary size of the YOSO model. Defines the number of different tokens that can be represented by the
<code>inputs_ids</code> passed when calling <a href="/docs/transformers/v4.20.1/en/model_doc/yoso#transformers.YosoModel">YosoModel</a>.`,name:"vocab_size"},{anchor:"transformers.YosoConfig.hidden_size",description:`<strong>hidden_size</strong> (<code>int</code>, <em>optional</em>, defaults to 768) &#x2014;
...
Whether or not to perform backpropagation using Locality Sensitive Hashing.`,name:"lsh_backward"}],source:"https://github.com/huggingface/transformers/blob/v4.20.1/src/transformers/models/yoso/configuration_yoso.py#L29"}}),Ye=new E({props:{anchor:"transformers.YosoConfig.example",$$slots:{default:[Oi]},$$scope:{ctx:M}}}),lo=new we({}),co=new O({props:{name:"class transformers.YosoModel",anchor:"transformers.YosoModel",parameters:[{name:"config",val:""}],parametersDescription:[{anchor:"transformers.YosoModel.config",description:`<strong>config</strong> (<a href="/docs/transformers/v4.20.1/en/model_doc/yoso#transformers.YosoConfig">YosoConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/v4.20.1/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/v4.20.1/src/transformers/models/yoso/modeling_yoso.py#L744"}}),mo=new O({props:{name:"forward",anchor:"transformers.YosoModel.forward",parameters:[{name:"input_ids",val:": typing.Optional[torch.Tensor] = None"},{name:"attention_mask",val:": typing.Optional[torch.Tensor] = None"},{name:"token_type_ids",val:": typing.Optional[torch.Tensor] = None"},{name:"position_ids",val:": typing.Optional[torch.Tensor] = None"},{name:"head_mask",val:": typing.Optional[torch.Tensor] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.Tensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.YosoModel.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/v4.20.1/en/model_doc/auto#transformers.AutoTokenizer">AutoTokenizer</a>. See <a href="/docs/transformers/v4.20.1/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
...
Whether or not to return a <a href="/docs/transformers/v4.20.1/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/v4.20.1/src/transformers/models/yoso/modeling_yoso.py#L769",returnDescription:`
<p>A <a
...
elements depending on the configuration (<a
  href="/docs/transformers/v4.20.1/en/model_doc/yoso#transformers.YosoConfig"
...
loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.20.1/src/transformers/models/yoso/modeling_yoso.py#L872",returnDescription:`
<p>A <a
...
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.20.1/src/transformers/models/yoso/modeling_yoso.py#L968",returnDescription:`
<p>A <a
...
<code>input_ids</code> above)`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.20.1/src/transformers/models/yoso/modeling_yoso.py#L1061",returnDescription:`
<p>A <a
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/v4.20.1/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/v4.20.1/src/transformers/models/yoso/modeling_yoso.py#L1142"}}),Co=new O({props:{name:"forward",anchor:"transformers.YosoForTokenClassification.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"labels",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],parametersDescription:[{anchor:"transformers.YosoForTokenClassification.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/v4.20.1/en/model_doc/auto#transformers.AutoTokenizer">AutoTokenizer</a>. See <a href="/docs/transformers/v4.20.1/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/v4.20.1/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.20.1/src/transformers/models/yoso/modeling_yoso.py#L1154",returnDescription:`
<p>A <a
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/v4.20.1/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/v4.20.1/src/transformers/models/yoso/modeling_yoso.py#L1228"}}),So=new O({props:{name:"forward",anchor:"transformers.YosoForQuestionAnswering.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"start_positions",val:" = None"},{name:"end_positions",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],parametersDescription:[{anchor:"transformers.YosoForQuestionAnswering.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/v4.20.1/en/model_doc/auto#transformers.AutoTokenizer">AutoTokenizer</a>. See <a href="/docs/transformers/v4.20.1/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/v4.20.1/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/v4.20.1/src/transformers/models/yoso/modeling_yoso.py#L1241",returnDescription:`
<p>A <a
...
`}}),Re=new ft({props:{$$slots:{default:[Ki]},$$scope:{ctx:M}}}),Ve=new E({props:{anchor:"transformers.YosoForQuestionAnswering.forward.example",$$slots:{default:[Ji]},$$scope:{ctx:M}}}),Ge=new E({props:{anchor:"transformers.YosoForQuestionAnswering.forward.example-2",$$slots:{default:[Zi]},$$scope:{ctx:M}}}),{c(){n=r("meta"),u=g(),a=r("h1"),p=r("a"),k=r("span"),w(s.$$.fragment),h=g(),x=r("span"),Hs=d("YOSO"),is=g(),Z=r("h2"),ve=r("a"),gt=r("span"),w(oo.$$.fragment),Bs=g(),_t=r("span"),Qs=d("Overview"),ls=g(),X=r("p"),Us=d("The YOSO model was proposed in "),to=r("a"),Rs=d("You Only Sample (Almost) Once: Linear Cost Self-Attention Via Bernoulli Sampling"),Vs=r("br"),Gs=d(`
...
does not require compiling CUDA kernels.`),ms=g(),$e=r("img"),us=g(),ye=r("small"),mn=d("YOSO Attention Algorithm. Taken from the "),Wo=r("a"),un=d("original paper"),fn=d("."),fs=g(),V=r("p"),gn=d("This model was contributed by "),so=r("a"),_n=d("novice03"),bn=d(". The original code can be found "),no=r("a"),kn=d("here"),wn=d("."),gs=g(),te=r("h2"),Te=r("a"),Tt=r("span"),w(ao.$$.fragment),vn=g(),Yt=r("span"),$n=d("YosoConfig"),_s=g(),A=r("div"),w(ro.$$.fragment),yn=g(),se=r("p"),Tn=d("This is the configuration class to store the configuration of a "),Ho=r("a"),Yn=d("YosoModel"),Mn=d(`. It is used to instantiate an YOSO
...
does not require compiling CUDA kernels.`),Zo.forEach(t),be.forEach(t),ms=_(o),$e=i(o,"IMG",{src:!0,alt:!0,width:!0}),us=_(o),ye=i(o,"SMALL",{});var js=l(ye);mn=c(js,"YOSO Attention Algorithm. Taken from the "),Wo=i(js,"A",{href:!0});var Ar=l(Wo);un=c(Ar,"original paper"),Ar.forEach(t),fn=c(js,"."),js.forEach(t),fs=_(o),V=i(o,"P",{});var Xo=l(V);gn=c(Xo,"This model was contributed by "),so=i(Xo,"A",{href:!0,rel:!0});var Or=l(so);_n=c(Or,"novice03"),Or.forEach(t),bn=c(Xo,". The original code can be found "),no=i(Xo,"A",{href:!0,rel:!0});var Er=l(no);kn=c(Er,"here"),Er.forEach(t),wn=c(Xo,"."),Xo.forEach(t),gs=_(o),te=i(o,"H2",{class:!0});var Cs=l(te);Te=i(Cs,"A",{id:!0,class:!0,href:!0});var Sr=l(Te);Tt=i(Sr,"SPAN",{});var Pr=l(Tt);v(ao.$$.fragment,Pr),Pr.forEach(t),Sr.forEach(t),vn=_(Cs),Yt=i(Cs,"SPAN",{});var Lr=l(Yt);$n=c(Lr,"YosoConfig"),Lr.forEach(t),Cs.forEach(t),_s=_(o),A=i(o,"DIV",{class:!0});var Je=l(A);v(ro.$$.fragment,Je),yn=_(Je),se=i(Je,"P",{});var et=l(se);Tn=c(et,"This is the configuration class to store the configuration of a "),Ho=i(et,"A",{href:!0});var Nr=l(Ho);Yn=c(Nr,"YosoModel"),Nr.forEach(t),Mn=c(et,`. It is used to instantiate an YOSO
model according to the specified arguments, defining the model architecture. Instantiating a configuration with the
defaults will yield a similar configuration to that of the YOSO
...
documentation from `),Qo=i(ot,"A",{href:!0});var Wr=l(Qo);An=c(Wr,"PretrainedConfig"),Wr.forEach(t),On=c(ot," for more information."),ot.forEach(t),En=_(Je),v(Ye.$$.fragment,Je),Je.forEach(t),bs=_(o),ae=i(o,"H2",{class:!0});var As=l(ae);Me=i(As,"A",{id:!0,class:!0,href:!0});var Hr=l(Me);Mt=i(Hr,"SPAN",{});var Br=l(Mt);v(lo.$$.fragment,Br),Br.forEach(t),Hr.forEach(t),Sn=_(As),xt=i(As,"SPAN",{});var Qr=l(xt);Pn=c(Qr,"YosoModel"),Qr.forEach(t),As.forEach(t),ks=_(o),I=i(o,"DIV",{class:!0});var tt=l(I);v(co.$$.fragment,tt),Ln=_(tt),po=i(tt,"P",{});var Os=l(po);Nn=c(Os,`The bare YOSO Model transformer outputting raw hidden-states without any specific head on top.
This model is a PyTorch `),ho=i(Os,"A",{href:!0,rel:!0});var Ur=l(ho);In=c(Ur,"torch.nn.Module"),Ur.forEach(t),Dn=c(Os,` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),Os.forEach(t),Wn=_(tt),L=i(tt,"DIV",{class:!0});var Ze=l(L);v(mo.$$.fragment,Ze),Hn=_(Ze),re=i(Ze,"P",{});var st=l(re);Bn=c(st,"The "),Uo=i(st,"A",{href:!0});var Rr=l(Uo);Qn=c(Rr,"YosoModel"),Rr.forEach(t),Un=c(st," forward method, overrides the "),qt=i(st,"CODE",{});var Vr=l(qt);Rn=c(Vr,"__call__"),Vr.forEach(t),Vn=c(st," special method."),st.forEach(t),Gn=_(Ze),v(xe.$$.fragment,Ze),Kn=_(Ze),v(qe.$$.fragment,Ze),Ze.forEach(t),tt.forEach(t),ws=_(o),ie=i(o,"H2",{class:!0});var Es=l(ie);Fe=i(Es,"A",{id:!0,class:!0,href:!0});var Gr=l(Fe);Ft=i(Gr,"SPAN",{});var Kr=l(Ft);v(uo.$$.fragment,Kr),Kr.forEach(t),Gr.forEach(t),Jn=_(Es),zt=i(Es,"SPAN",{});var Jr=l(zt);Zn=c(Jr,"YosoForMaskedLM"),Jr.forEach(t),Es.forEach(t),vs=_(o),D=i(o,"DIV",{class:!0});var nt=l(D);v(fo.$$.fragment,nt),Xn=_(nt),le=i(nt,"P",{});var at=l(le);ea=c(at,"YOSO Model with a "),jt=i(at,"CODE",{});var Zr=l(jt);oa=c(Zr,"language modeling"),Zr.forEach(t),ta=c(at,` head on top.
This model is a PyTorch `),go=i(at,"A",{href:!0,rel:!0});var Xr=l(go);sa=c(Xr,"torch.nn.Module"),Xr.forEach(t),na=c(at,` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),at.forEach(t),aa=_(nt),F=i(nt,"DIV",{class:!0});var G=l(F);v(_o.$$.fragment,G),ra=_(G),de=i(G,"P",{});var rt=l(de);ia=c(rt,"The "),Ro=i(rt,"A",{href:!0});var ei=l(Ro);la=c(ei,"YosoForMaskedLM"),ei.forEach(t),da=c(rt," forward method, overrides the "),Ct=i(rt,"CODE",{});var oi=l(Ct);ca=c(oi,"__call__"),oi.forEach(t),pa=c(rt," special method."),rt.forEach(t),ha=_(G),v(ze.$$.fragment,G),ma=_(G),v(je.$$.fragment,G),ua=_(G),v(Ce.$$.fragment,G),G.forEach(t),nt.forEach(t),$s=_(o),ce=i(o,"H2",{class:!0});var Ss=l(ce);Ae=i(Ss,"A",{id:!0,class:!0,href:!0});var ti=l(Ae);At=i(ti,"SPAN",{});var si=l(At);v(bo.$$.fragment,si),si.forEach(t),ti.forEach(t),fa=_(Ss),Ot=i(Ss,"SPAN",{});var ni=l(Ot);ga=c(ni,"YosoForSequenceClassification"),ni.forEach(t),Ss.forEach(t),ys=_(o),W=i(o,"DIV",{class:!0});var it=l(W);v(ko.$$.fragment,it),_a=_(it),wo=i(it,"P",{});var Ps=l(wo);ba=c(Ps,`YOSO Model transformer with a sequence classification/regression head on top (a linear layer on top of
the pooled output) e.g. for GLUE tasks.
This model is a PyTorch `),vo=i(Ps,"A",{href:!0,rel:!0});var ai=l(vo);ka=c(ai,"torch.nn.Module"),ai.forEach(t),wa=c(Ps,` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),Ps.forEach(t),va=_(it),q=i(it,"DIV",{class:!0});var C=l(q);v($o.$$.fragment,C),$a=_(C),pe=i(C,"P",{});var lt=l(pe);ya=c(lt,"The "),Vo=i(lt,"A",{href:!0});var ri=l(Vo);Ta=c(ri,"YosoForSequenceClassification"),ri.forEach(t),Ya=c(lt," forward method, overrides the "),Et=i(lt,"CODE",{});var ii=l(Et);Ma=c(ii,"__call__"),ii.forEach(t),xa=c(lt," special method."),lt.forEach(t),qa=_(C),v(Oe.$$.fragment,C),Fa=_(C),v(Ee.$$.fragment,C),za=_(C),v(Se.$$.fragment,C),ja=_(C),v(Pe.$$.fragment,C),Ca=_(C),v(Le.$$.fragment,C),C.forEach(t),it.forEach(t),Ts=_(o),he=i(o,"H2",{class:!0});var Ls=l(he);Ne=i(Ls,"A",{id:!0,class:!0,href:!0});var li=l(Ne);St=i(li,"SPAN",{});var di=l(St);v(yo.$$.fragment,di),di.forEach(t),li.forEach(t),Aa=_(Ls),Pt=i(Ls,"SPAN",{});var ci=l(Pt);Oa=c(ci,"YosoForMultipleChoice"),ci.forEach(t),Ls.forEach(t),Ys=_(o),H=i(o,"DIV",{class:!0});var dt=l(H);v(To.$$.fragment,dt),Ea=_(dt),Yo=i(dt,"P",{});var Ns=l(Yo);Sa=c(Ns,`YOSO Model with a multiple choice classification head on top (a linear layer on top of
the pooled output and a softmax) e.g. for RocStories/SWAG tasks.
This model is a PyTorch `),Mo=i(Ns,"A",{href:!0,rel:!0});var pi=l(Mo);Pa=c(pi,"torch.nn.Module"),pi.forEach(t),La=c(Ns,` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),Ns.forEach(t),Na=_(dt),N=i(dt,"DIV",{class:!0});var Xe=l(N);v(xo.$$.fragment,Xe),Ia=_(Xe),me=i(Xe,"P",{});var ct=l(me);Da=c(ct,"The "),Go=i(ct,"A",{href:!0});var hi=l(Go);Wa=c(hi,"YosoForMultipleChoice"),hi.forEach(t),Ha=c(ct," forward method, overrides the "),Lt=i(ct,"CODE",{});var mi=l(Lt);Ba=c(mi,"__call__"),mi.forEach(t),Qa=c(ct," special method."),ct.forEach(t),Ua=_(Xe),v(Ie.$$.fragment,Xe),Ra=_(Xe),v(De.$$.fragment,Xe),Xe.forEach(t),dt.forEach(t),Ms=_(o),ue=i(o,"H2",{class:!0});var Is=l(ue);We=i(Is,"A",{id:!0,class:!0,href:!0});var ui=l(We);Nt=i(ui,"SPAN",{});var fi=l(Nt);v(qo.$$.fragment,fi),fi.forEach(t),ui.forEach(t),Va=_(Is),It=i(Is,"SPAN",{});var gi=l(It);Ga=c(gi,"YosoForTokenClassification"),gi.forEach(t),Is.forEach(t),xs=_(o),B=i(o,"DIV",{class:!0});var pt=l(B);v(Fo.$$.fragment,pt),Ka=_(pt),zo=i(pt,"P",{});var Ds=l(zo);Ja=c(Ds,`YOSO Model with a token classification head on top (a linear layer on top of
the hidden-states output) e.g. for Named-Entity-Recognition (NER) tasks.
This model is a PyTorch `),jo=i(Ds,"A",{href:!0,rel:!0});var _i=l(jo);Za=c(_i,"torch.nn.Module"),_i.forEach(t),Xa=c(Ds,` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),Ds.forEach(t),er=_(pt),z=i(pt,"DIV",{class:!0});var K=l(z);v(Co.$$.fragment,K),or=_(K),fe=i(K,"P",{});var ht=l(fe);tr=c(ht,"The "),Ko=i(ht,"A",{href:!0});var bi=l(Ko);sr=c(bi,"YosoForTokenClassification"),bi.forEach(t),nr=c(ht," forward method, overrides the "),Dt=i(ht,"CODE",{});var ki=l(Dt);ar=c(ki,"__call__"),ki.forEach(t),rr=c(ht," special method."),ht.forEach(t),ir=_(K),v(He.$$.fragment,K),lr=_(K),v(Be.$$.fragment,K),dr=_(K),v(Qe.$$.fragment,K),K.forEach(t),pt.forEach(t),qs=_(o),ge=i(o,"H2",{class:!0});var Ws=l(ge);Ue=i(Ws,"A",{id:!0,class:!0,href:!0});var wi=l(Ue);Wt=i(wi,"SPAN",{});var vi=l(Wt);v(Ao.$$.fragment,vi),vi.forEach(t),wi.forEach(t),cr=_(Ws),Ht=i(Ws,"SPAN",{});var $i=l(Ht);pr=c($i,"YosoForQuestionAnswering"),$i.forEach(t),Ws.forEach(t),Fs=_(o),Q=i(o,"DIV",{class:!0});var mt=l(Q);v(Oo.$$.fragment,mt),hr=_(mt),U=i(mt,"P",{});var eo=l(U);mr=c(eo,`YOSO Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
