import{S as Fi,i as qi,s as zi,e as r,k as g,w,t as d,M as ji,c as i,d as t,m as _,a as l,x as v,h as c,b as f,N as Ci,G as e,g as b,y as $,q as y,o as T,B as Y,v as Ai,L as S}from"../../chunks/vendor-hf-doc-builder.js";import{T as ft}from"../../chunks/Tip-hf-doc-builder.js";import{D as O}from"../../chunks/Docstring-hf-doc-builder.js";import{C as P}from"../../chunks/CodeBlock-hf-doc-builder.js";import{I as we}from"../../chunks/IconCopyLink-hf-doc-builder.js";import{E}from"../../chunks/ExampleCodeBlock-hf-doc-builder.js";function Oi(M){let n,u,a,p,k;return p=new P({props:{code:`from transformers import YosoModel, YosoConfig
...
<span class="hljs-meta">&gt;&gt;&gt; </span>loss = outputs.loss
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-built_in">round</span>(loss.item(), <span class="hljs-number">2</span>)
`}}),{c(){w(n.$$.fragment)},l(a){v(n.$$.fragment,a)},m(a,p){$(n,a,p),u=!0},p:S,i(a){u||(y(n.$$.fragment,a),u=!0)},o(a){T(n.$$.fragment,a),u=!1},d(a){Y(n,a)}}}function Xi(M){let n,u,a,p,k,s,h,x,Hs,is,Z,ve,gt,oo,Qs,_t,Us,ls,X,Bs,to,Rs,Vs,Gs,ds,No,Ks,cs,Io,bt,Js,ps,Do,Zs,hs,R,kt,Xs,en,ee,on,wt,tn,sn,vt,nn,an,rn,oe,ln,$t,dn,cn,yt,pn,hn,ms,$e,zr,us,ye,mn,Wo,un,fn,fs,V,gn,so,_n,bn,no,kn,wn,gs,te,Te,Tt,ao,vn,Yt,$n,_s,A,ro,yn,se,Tn,Ho,Yn,Mn,io,xn,Fn,qn,ne,zn,Qo,jn,Cn,Uo,An,On,En,Ye,bs,ae,Me,Mt,lo,Sn,xt,Pn,ks,I,co,Ln,po,Nn,ho,In,Dn,Wn,L,mo,Hn,re,Qn,Bo,Un,Bn,Ft,Rn,Vn,Gn,xe,Kn,Fe,ws,ie,qe,qt,uo,Jn,zt,Zn,vs,D,fo,Xn,le,ea,jt,oa,ta,go,sa,na,aa,q,_o,ra,de,ia,Ro,la,da,Ct,ca,pa,ha,ze,ma,je,ua,Ce,$s,ce,Ae,At,bo,fa,Ot,ga,ys,W,ko,_a,wo,ba,vo,ka,wa,va,F,$o,$a,pe,ya,Vo,Ta,Ya,Et,Ma,xa,Fa,Oe,qa,Ee,za,Se,ja,Pe,Ca,Le,Ts,he,Ne,St,yo,Aa,Pt,Oa,Ys,H,To,Ea,Yo,Sa,Mo,Pa,La,Na,N,xo,Ia,me,Da,Go,Wa,Ha,Lt,Qa,Ua,Ba,Ie,Ra,De,Ms,ue,We,Nt,Fo,Va,It,Ga,xs,Q,qo,Ka,zo,Ja,jo,Za,Xa,er,z,Co,or,fe,tr,Ko,sr,nr,Dt,ar,rr,ir,He,lr,Qe,dr,Ue,Fs,ge,Be,Wt,Ao,cr,Ht,pr,qs,U,Oo,hr,B,mr,Qt,ur,fr,Ut,gr,_r,Eo,br,kr,wr,j,So,vr,_e,$r,Jo,yr,Tr,Bt,Yr,Mr,xr,Re,Fr,Ve,qr,Ge,zs;return s=new we({}),oo=new we({}),ao=new we({}),ro=new O({props:{name:"class transformers.YosoConfig",anchor:"transformers.YosoConfig",parameters:[{name:"vocab_size",val:" = 50265"},{name:"hidden_size",val:" = 768"},{name:"num_hidden_layers",val:" = 12"},{name:"num_attention_heads",val:" = 12"},{name:"intermediate_size",val:" = 3072"},{name:"hidden_act",val:" = 'gelu'"},{name:"hidden_dropout_prob",val:" = 0.1"},{name:"attention_probs_dropout_prob",val:" = 0.1"},{name:"max_position_embeddings",val:" = 4096"},{name:"type_vocab_size",val:" = 1"},{name:"initializer_range",val:" = 0.02"},{name:"layer_norm_eps",val:" = 1e-12"},{name:"position_embedding_type",val:" = 'absolute'"},{name:"use_expectation",val:" = True"},{name:"hash_code_len",val:" = 9"},{name:"num_hash",val:" = 64"},{name:"conv_window",val:" = None"},{name:"use_fast_hash",val:" = True"},{name:"lsh_backward",val:" = True"},{name:"pad_token_id",val:" = 1"},{name:"bos_token_id",val:" = 0"},{name:"eos_token_id",val:" = 2"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.YosoConfig.vocab_size",description:`<strong>vocab_size</strong> (<code>int</code>, <em>optional</em>, defaults to 50265) &#x2014;
...
documentation from `),Uo=i(ot,"A",{href:!0});var Wr=l(Uo);An=c(Wr,"PretrainedConfig"),Wr.forEach(t),On=c(ot," for more information."),ot.forEach(t),En=_(Je),v(Ye.$$.fragment,Je),Je.forEach(t),bs=_(o),ae=i(o,"H2",{class:!0});var As=l(ae);Me=i(As,"A",{id:!0,class:!0,href:!0});var Hr=l(Me);Mt=i(Hr,"SPAN",{});var Qr=l(Mt);v(lo.$$.fragment,Qr),Qr.forEach(t),Hr.forEach(t),Sn=_(As),xt=i(As,"SPAN",{});var Ur=l(xt);Pn=c(Ur,"YosoModel"),Ur.forEach(t),As.forEach(t),ks=_(o),I=i(o,"DIV",{class:!0});var tt=l(I);v(co.$$.fragment,tt),Ln=_(tt),po=i(tt,"P",{});var Os=l(po);Nn=c(Os,`The bare YOSO Model transformer outputting raw hidden-states without any specific head on top.
