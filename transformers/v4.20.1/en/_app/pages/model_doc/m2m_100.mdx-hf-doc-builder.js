...
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-built_in">print</span>(tokenizer.batch_decode(gen_tokens, skip_special_tokens=<span class="hljs-literal">True</span>))`}}),{c(){m=n("p"),$=r("Translation example:"),g=c(),M(f.$$.fragment)},l(d){m=s(d,"P",{});var _=a(m);$=i(_,"Translation example:"),_.forEach(o),g=h(d),v(f.$$.fragment,d)},m(d,_){u(d,m,_),e(m,$),u(d,g,_),b(f,d,_),k=!0},p:nn,i(d){k||(y(f.$$.fragment,d),k=!0)},o(d){T(f.$$.fragment,d),k=!1},d(d){d&&o(m),d&&o(g),w(f,d)}}}function Qr(E){let m,$,g,f,k,d,_,I,sn,fo,B,Y,xt,be,an,Et,rn,_o,ee,dn,ye,ln,cn,go,rt,hn,ko,it,Ct,pn,Mo,te,mn,Te,un,fn,vo,H,oe,Ft,we,_n,jt,gn,bo,O,kn,Pt,Mn,vn,Ot,bn,yn,St,Tn,wn,yo,C,$n,dt,zn,qn,At,xn,En,Dt,Cn,Fn,Lt,jn,Pn,To,lt,It,On,wo,$e,$o,ct,ze,Nt,Sn,An,x,Dn,Gt,Ln,In,Wt,Nn,Gn,Bt,Wn,Bn,Ht,Hn,Un,Ut,Vn,Xn,zo,qe,qo,U,ne,Vt,xe,Rn,Xt,Jn,xo,F,Ee,Kn,V,Zn,ht,Qn,Yn,Ce,es,ts,os,X,ns,pt,ss,as,mt,rs,is,ds,se,Eo,R,ae,Rt,Fe,ls,Jt,cs,Co,z,je,hs,Pe,ps,Oe,ms,us,fs,Se,_s,ut,gs,ks,Ms,re,vs,S,Ae,bs,De,ys,Kt,Ts,ws,$s,Le,Ie,Zt,zs,qs,Qt,xs,Es,Ne,Yt,Cs,Fs,eo,js,Ps,to,Os,Ss,ie,Ge,As,We,Ds,oo,Ls,Is,Ns,N,Be,Gs,ft,Ws,_t,Bs,Hs,no,Us,Vs,gt,He,Fo,J,de,so,Ue,Xs,ao,Rs,jo,j,Ve,Js,Xe,Ks,kt,Zs,Qs,Ys,Re,ea,Je,ta,oa,na,A,Ke,sa,K,aa,Mt,ra,ia,ro,da,la,ca,le,ha,ce,Po,Z,he,io,Ze,pa,lo,ma,Oo,P,Qe,ua,Ye,fa,vt,_a,ga,ka,et,Ma,tt,va,ba,ya,D,ot,Ta,Q,wa,bt,$a,za,co,qa,xa,Ea,pe,Ca,me,So;return d=new at({}),be=new at({}),we=new at({}),$e=new qt({props:{code:`
...
<code>inputs_ids</code> passed when calling <a href="/docs/transformers/v4.20.1/en/model_doc/m2m_100#transformers.M2M100Model">M2M100Model</a> or`,name:"vocab_size"},{anchor:"transformers.M2M100Config.d_model",description:`<strong>d_model</strong> (<code>int</code>, <em>optional</em>, defaults to 1024) &#x2014;
...
Whether or not the model should return the last key/values attentions (not used by all models).`,name:"use_cache"}],source:"https://github.com/huggingface/transformers/blob/v4.20.1/src/transformers/models/m2m_100/configuration_m2m_100.py#L34"}}),se=new on({props:{anchor:"transformers.M2M100Config.example",$$slots:{default:[Vr]},$$scope:{ctx:E}}}),Fe=new at({}),je=new W({props:{name:"class transformers.M2M100Tokenizer",anchor:"transformers.M2M100Tokenizer",parameters:[{name:"vocab_file",val:""},{name:"spm_file",val:""},{name:"src_lang",val:" = None"},{name:"tgt_lang",val:" = None"},{name:"bos_token",val:" = '<s>'"},{name:"eos_token",val:" = '</s>'"},{name:"sep_token",val:" = '</s>'"},{name:"pad_token",val:" = '<pad>'"},{name:"unk_token",val:" = '<unk>'"},{name:"language_codes",val:" = 'm2m100'"},{name:"sp_model_kwargs",val:": typing.Union[typing.Dict[str, typing.Any], NoneType] = None"},{name:"num_madeup_words",val:" = 8"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.M2M100Tokenizer.vocab_file",description:`<strong>vocab_file</strong> (<code>str</code>) &#x2014;
...
</ul>`,name:"sp_model_kwargs"}],source:"https://github.com/huggingface/transformers/blob/v4.20.1/src/transformers/models/m2m_100/tokenization_m2m_100.py#L65"}}),re=new on({props:{anchor:"transformers.M2M100Tokenizer.example",$$slots:{default:[Xr]},$$scope:{ctx:E}}}),Ae=new W({props:{name:"build_inputs_with_special_tokens",anchor:"transformers.M2M100Tokenizer.build_inputs_with_special_tokens",parameters:[{name:"token_ids_0",val:": typing.List[int]"},{name:"token_ids_1",val:": typing.Optional[typing.List[int]] = None"}],parametersDescription:[{anchor:"transformers.M2M100Tokenizer.build_inputs_with_special_tokens.token_ids_0",description:`<strong>token_ids_0</strong> (<code>List[int]</code>) &#x2014;
...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/v4.20.1/src/transformers/models/m2m_100/tokenization_m2m_100.py#L258",returnDescription:`
...
Whether or not the token list is already formatted with special tokens for the model.`,name:"already_has_special_tokens"}],source:"https://github.com/huggingface/transformers/blob/v4.20.1/src/transformers/models/m2m_100/tokenization_m2m_100.py#L228",returnDescription:`
...
elements depending on the configuration (<a
  href="/docs/transformers/v4.20.1/en/model_doc/m2m_100#transformers.M2M100Config"
...
(masked), the loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.20.1/src/transformers/models/m2m_100/modeling_m2m_100.py#L1279",returnDescription:`
<p>A <a
...
and behavior.`),na=c(),A=n("div"),M(Ke.$$.fragment),sa=c(),K=n("p"),aa=r("The "),Mt=n("a"),ra=r("M2M100Model"),ia=r(" forward method, overrides the "),ro=n("code"),da=r("__call__"),la=r(" special method."),ca=c(),M(le.$$.fragment),ha=c(),M(ce.$$.fragment),Po=c(),Z=n("h2"),he=n("a"),io=n("span"),M(Ze.$$.fragment),pa=c(),lo=n("span"),ma=r("M2M100ForConditionalGeneration"),Oo=c(),P=n("div"),M(Qe.$$.fragment),ua=c(),Ye=n("p"),fa=r(`The M2M100 Model with a language modeling head. Can be used for summarization.
...
to create high quality models. Our focus on non-English-Centric models brings gains of more than 10 BLEU when directly
translating between non-English directions while performing competitively to the best single systems of WMT. We
open-source our scripts so that others may reproduce the data, evaluation, and final M2M-100 model.`),Da.forEach(o),Aa.forEach(o),Mo=h(t),te=s(t,"P",{});var Do=a(te);mn=i(Do,"This model was contributed by "),Te=s(Do,"A",{href:!0,rel:!0});var La=a(Te);un=i(La,"valhalla"),La.forEach(o),fn=i(Do,"."),Do.forEach(o),vo=h(t),H=s(t,"H3",{class:!0});var Lo=a(H);oe=s(Lo,"A",{id:!0,class:!0,href:!0});var Ia=a(oe);Ft=s(Ia,"SPAN",{});var Na=a(Ft);v(we.$$.fragment,Na),Na.forEach(o),Ia.forEach(o),_n=h(Lo),jt=s(Lo,"SPAN",{});var Ga=a(jt);gn=i(Ga,"Training and Generation"),Ga.forEach(o),Lo.forEach(o),bo=h(t),O=s(t,"P",{});var ue=a(O);kn=i(ue,`M2M100 is a multilingual encoder-decoder (seq-to-seq) model primarily intended for translation tasks. As the model is
multilingual it expects the sequences in a certain format: A special language id token is used as prefix in both the
...
Hindi to French and Chinese to English using the `),Ut=s(L,"EM",{});var nr=a(Ut);Vn=i(nr,"facebook/m2m100_418M"),nr.forEach(o),Xn=i(L," checkpoint."),L.forEach(o),Io.forEach(o),Za.forEach(o),zo=h(t),v(qe.$$.fragment,t),qo=h(t),U=s(t,"H2",{class:!0});var No=a(U);ne=s(No,"A",{id:!0,class:!0,href:!0});var sr=a(ne);Vt=s(sr,"SPAN",{});var ar=a(Vt);v(xe.$$.fragment,ar),ar.forEach(o),sr.forEach(o),Rn=h(No),Xt=s(No,"SPAN",{});var rr=a(Xt);Jn=i(rr,"M2M100Config"),rr.forEach(o),No.forEach(o),xo=h(t),F=s(t,"DIV",{class:!0});var fe=a(F);v(Ee.$$.fragment,fe),Kn=h(fe),V=s(fe,"P",{});var yt=a(V);Zn=i(yt,"This is the configuration class to store the configuration of a "),ht=s(yt,"A",{href:!0});var ir=a(ht);Qn=i(ir,"M2M100Model"),ir.forEach(o),Yn=i(yt,`. It is used to instantiate an
M2M100 model according to the specified arguments, defining the model architecture. Instantiating a configuration
with the defaults will yield a similar configuration to that of the M2M100
...
this superclass for more information regarding those methods.`),Bo.forEach(o),Ms=h(q),v(re.$$.fragment,q),vs=h(q),S=s(q,"DIV",{class:!0});var _e=a(S);v(Ae.$$.fragment,_e),bs=h(_e),De=s(_e,"P",{});var Ho=a(De);ys=i(Ho,`Build model inputs from a sequence or a pair of sequence for sequence classification tasks by concatenating and
...
separator.`),br.forEach(o),_e.forEach(o),Ss=h(q),ie=s(q,"DIV",{class:!0});var Ro=a(ie);v(Ge.$$.fragment,Ro),As=h(Ro),We=s(Ro,"P",{});var Jo=a(We);Ds=i(Jo,`Retrieve sequence ids from a token list that has no special tokens added. This method is called when adding
special tokens using the tokenizer `),oo=s(Jo,"CODE",{});var yr=a(oo);Ls=i(yr,"prepare_for_model"),yr.forEach(o),Is=i(Jo," method."),Jo.forEach(o),Ro.forEach(o),Ns=h(q),N=s(q,"DIV",{class:!0});var wt=a(N);v(Be.$$.fragment,wt),Gs=h(wt),ft=s(wt,"P",{});var Fa=a(ft);Ws=i(Fa,"Create the token type IDs corresponding to the sequences passed. "),_t=s(Fa,"A",{href:!0});var Tr=a(_t);Bs=i(Tr,`What are token type
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),en.forEach(o),ka=h(Me),et=s(Me,"P",{});var tn=a(et);Ma=i(tn,"This model is also a PyTorch "),tt=s(tn,"A",{href:!0,rel:!0});var Dr=a(tt);va=i(Dr,"torch.nn.Module"),Dr.forEach(o),ba=i(tn,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),tn.forEach(o),ya=h(Me),D=s(Me,"DIV",{class:!0});var ve=a(D);v(ot.$$.fragment,ve),Ta=h(ve),Q=s(ve,"P",{});var zt=a(Q);wa=i(zt,"The "),bt=s(zt,"A",{href:!0});var Lr=a(bt);$a=i(Lr,"M2M100ForConditionalGeneration"),Lr.forEach(o),za=i(zt," forward method, overrides the "),co=s(zt,"CODE",{});var Ir=a(co);qa=i(Ir,"__call__"),Ir.forEach(o),xa=i(zt," special method."),zt.forEach(o),Ea=h(ve),v(pe.$$.fragment,ve),Ca=h(ve),v(me.$$.fragment,ve),ve.forEach(o),Me.forEach(o),this.h()},h(){l(m,"name","hf:doc:metadata"),l(m,"content",JSON.stringify(Yr)),l(f,"id","m2m100"),l(f,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),l(f,"href","#m2m100"),l(g,"class","relative group"),l(Y,"id","overview"),l(Y,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),l(Y,"href","#overview"),l(B,"class","relative group"),l(ye,"href","https://arxiv.org/abs/2010.11125"),l(ye,"rel","nofollow"),l(Te,"href","https://huggingface.co/valhalla"),l(Te,"rel","nofollow"),l(oe,"id","training-and-generation"),l(oe,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),l(oe,"href","#training-and-generation"),l(H,"class","relative group"),l(dt,"href","/docs/transformers/v4.20.1/en/model_doc/m2m_100#transformers.M2M100Tokenizer"),l(ne,"id","transformers.M2M100Config"),l(ne,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),l(ne,"href","#transformers.M2M100Config"),l(U,"class","relative group"),l(ht,"href","/docs/transformers/v4.20.1/en/model_doc/m2m_100#transformers.M2M100Model"),l(Ce,"href","https://huggingface.co/facebook/m2m100_418M"),l(Ce,"rel","nofollow"),l(pt,"href","/docs/transformers/v4.20.1/en/main_classes/configuration#transformers.PretrainedConfig"),l(mt,"href","/docs/transformers/v4.20.1/en/main_classes/configuration#transformers.PretrainedConfig"),l(F,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),l(ae,"id","transformers.M2M100Tokenizer"),l(ae,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),l(ae,"href","#transformers.M2M100Tokenizer"),l(R,"class","relative group"),l(Oe,"href","https://github.com/google/sentencepiece"),l(Oe,"rel","nofollow"),l(ut,"href","/docs/transformers/v4.20.1/en/main_classes/tokenizer#transformers.PreTrainedTokenizer"),l(S,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),l(ie,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),l(_t,"href","../glossary#token-type-ids"),l(N,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),l(gt,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),l(z,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),l(de,"id","transformers.M2M100Model"),l(de,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),l(de,"href","#transformers.M2M100Model"),l(J,"class","relative group"),l(kt,"href","/docs/transformers/v4.20.1/en/main_classes/model#transformers.PreTrainedModel"),l(Je,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),l(Je,"rel","nofollow"),l(Mt,"href","/docs/transformers/v4.20.1/en/model_doc/m2m_100#transformers.M2M100Model"),l(A,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),l(j,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),l(he,"id","transformers.M2M100ForConditionalGeneration"),l(he,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),l(he,"href","#transformers.M2M100ForConditionalGeneration"),l(Z,"class","relative group"),l(vt,"href","/docs/transformers/v4.20.1/en/main_classes/model#transformers.PreTrainedModel"),l(tt,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),l(tt,"rel","nofollow"),l(bt,"href","/docs/transformers/v4.20.1/en/model_doc/m2m_100#transformers.M2M100ForConditionalGeneration"),l(D,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),l(P,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8")},m(t,p){e(document.head,m),u(t,$,p),u(t,g,p),e(g,f),e(f,k),b(d,k,null),e(g,_),e(g,I),e(I,sn),u(t,fo,p),u(t,B,p),e(B,Y),e(Y,xt),b(be,xt,null),e(B,an),e(B,Et),e(Et,rn),u(t,_o,p),u(t,ee,p),e(ee,dn),e(ee,ye),e(ye,ln),e(ee,cn),u(t,go,p),u(t,rt,p),e(rt,hn),u(t,ko,p),u(t,it,p),e(it,Ct),e(Ct,pn),u(t,Mo,p),u(t,te,p),e(te,mn),e(te,Te),e(Te,un),e(te,fn),u(t,vo,p),u(t,H,p),e(H,oe),e(oe,Ft),b(we,Ft,null),e(H,_n),e(H,jt),e(jt,gn),u(t,bo,p),u(t,O,p),e(O,kn),e(O,Pt),e(Pt,Mn),e(O,vn),e(O,Ot),e(Ot,bn),e(O,yn),e(O,St),e(St,Tn),e(O,wn),u(t,yo,p),u(t,C,p),e(C,$n),e(C,dt),e(dt,zn),e(C,qn),e(C,At),e(At,xn),e(C,En),e(C,Dt),e(Dt,Cn),e(C,Fn),e(C,Lt),e(Lt,jn),e(C,Pn),u(t,To,p),u(t,lt,p),e(lt,It),e(It,On),u(t,wo,p),b($e,t,p),u(t,$o,p),u(t,ct,p),e(ct,ze),e(ze,Nt),e(Nt,Sn),e(ze,An),e(ze,x),e(x,Dn),e(x,Gt),e(Gt,Ln),e(x,In),e(x,Wt),e(Wt,Nn),e(x,Gn),e(x,Bt),e(Bt,Wn),e(x,Bn),e(x,Ht),e(Ht,Hn),e(x,Un),e(x,Ut),e(Ut,Vn),e(x,Xn),u(t,zo,p),b(qe,t,p),u(t,qo,p),u(t,U,p),e(U,ne),e(ne,Vt),b(xe,Vt,null),e(U,Rn),e(U,Xt),e(Xt,Jn),u(t,xo,p),u(t,F,p),b(Ee,F,null),e(F,Kn),e(F,V),e(V,Zn),e(V,ht),e(ht,Qn),e(V,Yn),e(V,Ce),e(Ce,es),e(V,ts),e(F,os),e(F,X),e(X,ns),e(X,pt),e(pt,ss),e(X,as),e(X,mt),e(mt,rs),e(X,is),e(F,ds),b(se,F,null),u(t,Eo,p),u(t,R,p),e(R,ae),e(ae,Rt),b(Fe,Rt,null),e(R,ls),e(R,Jt),e(Jt,cs),u(t,Co,p),u(t,z,p),b(je,z,null),e(z,hs),e(z,Pe),e(Pe,ps),e(Pe,Oe),e(Oe,ms),e(Pe,us),e(z,fs),e(z,Se),e(Se,_s),e(Se,ut),e(ut,gs),e(Se,ks),e(z,Ms),b(re,z,null),e(z,vs),e(z,S),b(Ae,S,null),e(S,bs),e(S,De),e(De,ys),e(De,Kt),e(Kt,Ts),e(De,ws),e(S,$s),e(S,Le),e(Le,Ie),e(Ie,Zt),e(Zt,zs),e(Ie,qs),e(Ie,Qt),e(Qt,xs),e(Le,Es),e(Le,Ne),e(Ne,Yt),e(Yt,Cs),e(Ne,Fs),e(Ne,eo),e(eo,js),e(S,Ps),e(S,to),e(to,Os),e(z,Ss),e(z,ie),b(Ge,ie,null),e(ie,As),e(ie,We),e(We,Ds),e(We,oo),e(oo,Ls),e(We,Is),e(z,Ns),e(z,N),b(Be,N,null),e(N,Gs),e(N,ft),e(ft,Ws),e(ft,_t),e(_t,Bs),e(N,Hs),e(N,no),e(no,Us),e(z,Vs),e(z,gt),b(He,gt,null),u(t,Fo,p),u(t,J,p),e(J,de),e(de,so),b(Ue,so,null),e(J,Xs),e(J,ao),e(ao,Rs),u(t,jo,p),u(t,j,p),b(Ve,j,null),e(j,Js),e(j,Xe),e(Xe,Ks),e(Xe,kt),e(kt,Zs),e(Xe,Qs),e(j,Ys),e(j,Re),e(Re,ea),e(Re,Je),e(Je,ta),e(Re,oa),e(j,na),e(j,A),b(Ke,A,null),e(A,sa),e(A,K),e(K,aa),e(K,Mt),e(Mt,ra),e(K,ia),e(K,ro),e(ro,da),e(K,la),e(A,ca),b(le,A,null),e(A,ha),b(ce,A,null),u(t,Po,p),u(t,Z,p),e(Z,he),e(he,io),b(Ze,io,null),e(Z,pa),e(Z,lo),e(lo,ma),u(t,Oo,p),u(t,P,p),b(Qe,P,null),e(P,ua),e(P,Ye),e(Ye,fa),e(Ye,vt),e(vt,_a),e(Ye,ga),e(P,ka),e(P,et),e(et,Ma),e(et,tt),e(tt,va),e(et,ba),e(P,ya),e(P,D),b(ot,D,null),e(D,Ta),e(D,Q),e(Q,wa),e(Q,bt),e(bt,$a),e(Q,za),e(Q,co),e(co,qa),e(Q,xa),e(D,Ea),b(pe,D,null),e(D,Ca),b(me,D,null),So=!0},p(t,[p]){const nt={};p&2&&(nt.$$scope={dirty:p,ctx:t}),se.$set(nt);const ho={};p&2&&(ho.$$scope={dirty:p,ctx:t}),re.$set(ho);const po={};p&2&&(po.$$scope={dirty:p,ctx:t}),le.$set(po);const mo={};p&2&&(mo.$$scope={dirty:p,ctx:t}),ce.$set(mo);const st={};p&2&&(st.$$scope={dirty:p,ctx:t}),pe.$set(st);const uo={};p&2&&(uo.$$scope={dirty:p,ctx:t}),me.$set(uo)},i(t){So||(y(d.$$.fragment,t),y(be.$$.fragment,t),y(we.$$.fragment,t),y($e.$$.fragment,t),y(qe.$$.fragment,t),y(xe.$$.fragment,t),y(Ee.$$.fragment,t),y(se.$$.fragment,t),y(Fe.$$.fragment,t),y(je.$$.fragment,t),y(re.$$.fragment,t),y(Ae.$$.fragment,t),y(Ge.$$.fragment,t),y(Be.$$.fragment,t),y(He.$$.fragment,t),y(Ue.$$.fragment,t),y(Ve.$$.fragment,t),y(Ke.$$.fragment,t),y(le.$$.fragment,t),y(ce.$$.fragment,t),y(Ze.$$.fragment,t),y(Qe.$$.fragment,t),y(ot.$$.fragment,t),y(pe.$$.fragment,t),y(me.$$.fragment,t),So=!0)},o(t){T(d.$$.fragment,t),T(be.$$.fragment,t),T(we.$$.fragment,t),T($e.$$.fragment,t),T(qe.$$.fragment,t),T(xe.$$.fragment,t),T(Ee.$$.fragment,t),T(se.$$.fragment,t),T(Fe.$$.fragment,t),T(je.$$.fragment,t),T(re.$$.fragment,t),T(Ae.$$.fragment,t),T(Ge.$$.fragment,t),T(Be.$$.fragment,t),T(He.$$.fragment,t),T(Ue.$$.fragment,t),T(Ve.$$.fragment,t),T(Ke.$$.fragment,t),T(le.$$.fragment,t),T(ce.$$.fragment,t),T(Ze.$$.fragment,t),T(Qe.$$.fragment,t),T(ot.$$.fragment,t),T(pe.$$.fragment,t),T(me.$$.fragment,t),So=!1},d(t){o(m),t&&o($),t&&o(g),w(d),t&&o(fo),t&&o(B),w(be),t&&o(_o),t&&o(ee),t&&o(go),t&&o(rt),t&&o(ko),t&&o(it),t&&o(Mo),t&&o(te),t&&o(vo),t&&o(H),w(we),t&&o(bo),t&&o(O),t&&o(yo),t&&o(C),t&&o(To),t&&o(lt),t&&o(wo),w($e,t),t&&o($o),t&&o(ct),t&&o(zo),w(qe,t),t&&o(qo),t&&o(U),w(xe),t&&o(xo),t&&o(F),w(Ee),w(se),t&&o(Eo),t&&o(R),w(Fe),t&&o(Co),t&&o(z),w(je),w(re),w(Ae),w(Ge),w(Be),w(He),t&&o(Fo),t&&o(J),w(Ue),t&&o(jo),t&&o(j),w(Ve),w(Ke),w(le),w(ce),t&&o(Po),t&&o(Z),w(Ze),t&&o(Oo),t&&o(P),w(Qe),w(ot),w(pe),w(me)}}}const Yr={local:"m2m100",sections:[{local:"overview",sections:[{local:"training-and-generation",title:"Training and Generation"}],title:"Overview"},{local:"transformers.M2M100Config",title:"M2M100Config"},{local:"transformers.M2M100Tokenizer",title:"M2M100Tokenizer"},{local:"transformers.M2M100Model",title:"M2M100Model"},{local:"transformers.M2M100ForConditionalGeneration",title:"M2M100ForConditionalGeneration"}],title:"M2M100"};function ei(E){return Ur(()=>{new URLSearchParams(window.location.search).get("fw")}),[]}class ii extends Gr{constructor(m){super();Wr(this,m,ei,Qr,Br,{})}}export{ii as default,Yr as metadata};
