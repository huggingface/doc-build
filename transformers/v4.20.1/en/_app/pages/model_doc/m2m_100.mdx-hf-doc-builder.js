import{S as Gr,i as Br,s as Wr,e as n,k as c,w as M,t as r,M as Hr,c as s,d as o,m as h,a,x as v,h as i,b as l,G as e,g as u,y as b,q as y,o as T,B as w,v as Ur,L as nn}from"../../chunks/vendor-hf-doc-builder.js";import{T as Nr}from"../../chunks/Tip-hf-doc-builder.js";import{D as B}from"../../chunks/Docstring-hf-doc-builder.js";import{C as qt}from"../../chunks/CodeBlock-hf-doc-builder.js";import{I as at}from"../../chunks/IconCopyLink-hf-doc-builder.js";import{E as on}from"../../chunks/ExampleCodeBlock-hf-doc-builder.js";function Vr(E){let m,$,g,f,k;return f=new qt({props:{code:`from transformers import M2M100Model, M2M100Config
...
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-built_in">print</span>(tokenizer.batch_decode(gen_tokens, skip_special_tokens=<span class="hljs-literal">True</span>))`}}),{c(){m=n("p"),$=r("Translation example:"),g=c(),M(f.$$.fragment)},l(d){m=s(d,"P",{});var _=a(m);$=i(_,"Translation example:"),_.forEach(o),g=h(d),v(f.$$.fragment,d)},m(d,_){u(d,m,_),e(m,$),u(d,g,_),b(f,d,_),k=!0},p:nn,i(d){k||(y(f.$$.fragment,d),k=!0)},o(d){T(f.$$.fragment,d),k=!1},d(d){d&&o(m),d&&o(g),w(f,d)}}}function Qr(E){let m,$,g,f,k,d,_,I,sn,fo,W,Y,xt,be,an,Et,rn,_o,ee,dn,ye,ln,cn,go,rt,hn,ko,it,Ct,pn,Mo,te,mn,Te,un,fn,vo,H,oe,jt,we,_n,Pt,gn,bo,O,kn,Ft,Mn,vn,Ot,bn,yn,St,Tn,wn,yo,C,$n,dt,zn,qn,Lt,xn,En,At,Cn,jn,Dt,Pn,Fn,To,lt,It,On,wo,$e,$o,ct,ze,Nt,Sn,Ln,x,An,Gt,Dn,In,Bt,Nn,Gn,Wt,Bn,Wn,Ht,Hn,Un,Ut,Vn,Xn,zo,qe,qo,U,ne,Vt,xe,Rn,Xt,Jn,xo,j,Ee,Kn,V,Zn,ht,Qn,Yn,Ce,es,ts,os,X,ns,pt,ss,as,mt,rs,is,ds,se,Eo,R,ae,Rt,je,ls,Jt,cs,Co,z,Pe,hs,Fe,ps,Oe,ms,us,fs,Se,_s,ut,gs,ks,Ms,re,vs,S,Le,bs,Ae,ys,Kt,Ts,ws,$s,De,Ie,Zt,zs,qs,Qt,xs,Es,Ne,Yt,Cs,js,eo,Ps,Fs,to,Os,Ss,ie,Ge,Ls,Be,As,oo,Ds,Is,Ns,N,We,Gs,ft,Bs,_t,Ws,Hs,no,Us,Vs,gt,He,jo,J,de,so,Ue,Xs,ao,Rs,Po,P,Ve,Js,Xe,Ks,kt,Zs,Qs,Ys,Re,ea,Je,ta,oa,na,L,Ke,sa,K,aa,Mt,ra,ia,ro,da,la,ca,le,ha,ce,Fo,Z,he,io,Ze,pa,lo,ma,Oo,F,Qe,ua,Ye,fa,vt,_a,ga,ka,et,Ma,tt,va,ba,ya,A,ot,Ta,Q,wa,bt,$a,za,co,qa,xa,Ea,pe,Ca,me,So;return d=new at({}),be=new at({}),we=new at({}),$e=new qt({props:{code:`from transformers import M2M100Config, M2M100ForConditionalGeneration, M2M100Tokenizer
...
Whether or not the model should return the last key/values attentions (not used by all models).`,name:"use_cache"}],source:"https://github.com/huggingface/transformers/blob/v4.20.1/src/transformers/models/m2m_100/configuration_m2m_100.py#L34"}}),se=new on({props:{anchor:"transformers.M2M100Config.example",$$slots:{default:[Vr]},$$scope:{ctx:E}}}),je=new at({}),Pe=new B({props:{name:"class transformers.M2M100Tokenizer",anchor:"transformers.M2M100Tokenizer",parameters:[{name:"vocab_file",val:""},{name:"spm_file",val:""},{name:"src_lang",val:" = None"},{name:"tgt_lang",val:" = None"},{name:"bos_token",val:" = '<s>'"},{name:"eos_token",val:" = '</s>'"},{name:"sep_token",val:" = '</s>'"},{name:"pad_token",val:" = '<pad>'"},{name:"unk_token",val:" = '<unk>'"},{name:"language_codes",val:" = 'm2m100'"},{name:"sp_model_kwargs",val:": typing.Union[typing.Dict[str, typing.Any], NoneType] = None"},{name:"num_madeup_words",val:" = 8"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.M2M100Tokenizer.vocab_file",description:`<strong>vocab_file</strong> (<code>str</code>) &#x2014;
...
</ul>`,name:"sp_model_kwargs"}],source:"https://github.com/huggingface/transformers/blob/v4.20.1/src/transformers/models/m2m_100/tokenization_m2m_100.py#L65"}}),re=new on({props:{anchor:"transformers.M2M100Tokenizer.example",$$slots:{default:[Xr]},$$scope:{ctx:E}}}),Le=new B({props:{name:"build_inputs_with_special_tokens",anchor:"transformers.M2M100Tokenizer.build_inputs_with_special_tokens",parameters:[{name:"token_ids_0",val:": typing.List[int]"},{name:"token_ids_1",val:": typing.Optional[typing.List[int]] = None"}],parametersDescription:[{anchor:"transformers.M2M100Tokenizer.build_inputs_with_special_tokens.token_ids_0",description:`<strong>token_ids_0</strong> (<code>List[int]</code>) &#x2014;
...
`}}),pe=new Nr({props:{$$slots:{default:[Kr]},$$scope:{ctx:E}}}),me=new on({props:{anchor:"transformers.M2M100ForConditionalGeneration.forward.example",$$slots:{default:[Zr]},$$scope:{ctx:E}}}),{c(){m=n("meta"),$=c(),g=n("h1"),f=n("a"),k=n("span"),M(d.$$.fragment),_=c(),I=n("span"),sn=r("M2M100"),fo=c(),W=n("h2"),Y=n("a"),xt=n("span"),M(be.$$.fragment),an=c(),Et=n("span"),rn=r("Overview"),_o=c(),ee=n("p"),dn=r("The M2M100 model was proposed in "),ye=n("a"),ln=r("Beyond English-Centric Multilingual Machine Translation"),cn=r(` by Angela Fan, Shruti Bhosale, Holger Schwenk, Zhiyi Ma, Ahmed El-Kishky,
...
and behavior.`),na=c(),L=n("div"),M(Ke.$$.fragment),sa=c(),K=n("p"),aa=r("The "),Mt=n("a"),ra=r("M2M100Model"),ia=r(" forward method, overrides the "),ro=n("code"),da=r("__call__"),la=r(" special method."),ca=c(),M(le.$$.fragment),ha=c(),M(ce.$$.fragment),Fo=c(),Z=n("h2"),he=n("a"),io=n("span"),M(Ze.$$.fragment),pa=c(),lo=n("span"),ma=r("M2M100ForConditionalGeneration"),Oo=c(),F=n("div"),M(Qe.$$.fragment),ua=c(),Ye=n("p"),fa=r(`The M2M100 Model with a language modeling head. Can be used for summarization.
...
documentation from `),mt=s(Tt,"A",{href:!0});var cr=a(mt);rs=i(cr,"PretrainedConfig"),cr.forEach(o),is=i(Tt," for more information."),Tt.forEach(o),ds=h(fe),v(se.$$.fragment,fe),fe.forEach(o),Eo=h(t),R=s(t,"H2",{class:!0});var Go=a(R);ae=s(Go,"A",{id:!0,class:!0,href:!0});var hr=a(ae);Rt=s(hr,"SPAN",{});var pr=a(Rt);v(je.$$.fragment,pr),pr.forEach(o),hr.forEach(o),ls=h(Go),Jt=s(Go,"SPAN",{});var mr=a(Jt);cs=i(mr,"M2M100Tokenizer"),mr.forEach(o),Go.forEach(o),Co=h(t),z=s(t,"DIV",{class:!0});var q=a(z);v(Pe.$$.fragment,q),hs=h(q),Fe=s(q,"P",{});var Bo=a(Fe);ps=i(Bo,"Construct an M2M100 tokenizer. Based on "),Oe=s(Bo,"A",{href:!0,rel:!0});var ur=a(Oe);ms=i(ur,"SentencePiece"),ur.forEach(o),us=i(Bo,"."),Bo.forEach(o),fs=h(q),Se=s(q,"P",{});var Wo=a(Se);_s=i(Wo,"This tokenizer inherits from "),ut=s(Wo,"A",{href:!0});var fr=a(ut);gs=i(fr,"PreTrainedTokenizer"),fr.forEach(o),ks=i(Wo,` which contains most of the main methods. Users should refer to
this superclass for more information regarding those methods.`),Wo.forEach(o),Ms=h(q),v(re.$$.fragment,q),vs=h(q),S=s(q,"DIV",{class:!0});var _e=a(S);v(Le.$$.fragment,_e),bs=h(_e),Ae=s(_e,"P",{});var Ho=a(Ae);ys=i(Ho,`Build model inputs from a sequence or a pair of sequence for sequence classification tasks by concatenating and
adding special tokens. An MBART sequence has the following format, where `),Kt=s(Ho,"CODE",{});var _r=a(Kt);Ts=i(_r,"X"),_r.forEach(o),ws=i(Ho," represents the sequence:"),Ho.forEach(o),$s=h(_e),De=s(_e,"UL",{});var Uo=a(De);Ie=s(Uo,"LI",{});var Vo=a(Ie);Zt=s(Vo,"CODE",{});var gr=a(Zt);zs=i(gr,"input_ids"),gr.forEach(o),qs=i(Vo," (for encoder) "),Qt=s(Vo,"CODE",{});var kr=a(Qt);xs=i(kr,"X [eos, src_lang_code]"),kr.forEach(o),Vo.forEach(o),Es=h(Uo),Ne=s(Uo,"LI",{});var Xo=a(Ne);Yt=s(Xo,"CODE",{});var Mr=a(Yt);Cs=i(Mr,"decoder_input_ids"),Mr.forEach(o),js=i(Xo,": (for decoder) "),eo=s(Xo,"CODE",{});var vr=a(eo);Ps=i(vr,"X [eos, tgt_lang_code]"),vr.forEach(o),Xo.forEach(o),Uo.forEach(o),Fs=h(_e),to=s(_e,"P",{});var br=a(to);Os=i(br,`BOS is never used. Pairs of sequences are not the expected use case, but they will be handled without a
separator.`),br.forEach(o),_e.forEach(o),Ss=h(q),ie=s(q,"DIV",{class:!0});var Ro=a(ie);v(Ge.$$.fragment,Ro),Ls=h(Ro),Be=s(Ro,"P",{});var Jo=a(Be);As=i(Jo,`Retrieve sequence ids from a token list that has no special tokens added. This method is called when adding
special tokens using the tokenizer `),oo=s(Jo,"CODE",{});var yr=a(oo);Ds=i(yr,"prepare_for_model"),yr.forEach(o),Is=i(Jo," method."),Jo.forEach(o),Ro.forEach(o),Ns=h(q),N=s(q,"DIV",{class:!0});var wt=a(N);v(We.$$.fragment,wt),Gs=h(wt),ft=s(wt,"P",{});var ja=a(ft);Bs=i(ja,"Create the token type IDs corresponding to the sequences passed. "),_t=s(ja,"A",{href:!0});var Tr=a(_t);Ws=i(Tr,`What are token type
IDs?`),Tr.forEach(o),ja.forEach(o),Hs=h(wt),no=s(wt,"P",{});var wr=a(no);Us=i(wr,"Should be overridden in a subclass if the model has a special way of building those."),wr.forEach(o),wt.forEach(o),Vs=h(q),gt=s(q,"DIV",{class:!0});var $r=a(gt);v(He.$$.fragment,$r),$r.forEach(o),q.forEach(o),jo=h(t),J=s(t,"H2",{class:!0});var Ko=a(J);de=s(Ko,"A",{id:!0,class:!0,href:!0});var zr=a(de);so=s(zr,"SPAN",{});var qr=a(so);v(Ue.$$.fragment,qr),qr.forEach(o),zr.forEach(o),Xs=h(Ko),ao=s(Ko,"SPAN",{});var xr=a(ao);Rs=i(xr,"M2M100Model"),xr.forEach(o),Ko.forEach(o),Po=h(t),P=s(t,"DIV",{class:!0});var ge=a(P);v(Ve.$$.fragment,ge),Js=h(ge),Xe=s(ge,"P",{});var Zo=a(Xe);Ks=i(Zo,`The bare M2M100 Model outputting raw hidden-states without any specific head on top.
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Qo.forEach(o),na=h(ge),L=s(ge,"DIV",{class:!0});var ke=a(L);v(Ke.$$.fragment,ke),sa=h(ke),K=s(ke,"P",{});var $t=a(K);aa=i($t,"The "),Mt=s($t,"A",{href:!0});var jr=a(Mt);ra=i(jr,"M2M100Model"),jr.forEach(o),ia=i($t," forward method, overrides the "),ro=s($t,"CODE",{});var Pr=a(ro);da=i(Pr,"__call__"),Pr.forEach(o),la=i($t," special method."),$t.forEach(o),ca=h(ke),v(le.$$.fragment,ke),ha=h(ke),v(ce.$$.fragment,ke),ke.forEach(o),ge.forEach(o),Fo=h(t),Z=s(t,"H2",{class:!0});var Yo=a(Z);he=s(Yo,"A",{id:!0,class:!0,href:!0});var Fr=a(he);io=s(Fr,"SPAN",{});var Or=a(io);v(Ze.$$.fragment,Or),Or.forEach(o),Fr.forEach(o),pa=h(Yo),lo=s(Yo,"SPAN",{});var Sr=a(lo);ma=i(Sr,"M2M100ForConditionalGeneration"),Sr.forEach(o),Yo.forEach(o),Oo=h(t),F=s(t,"DIV",{class:!0});var Me=a(F);v(Qe.$$.fragment,Me),ua=h(Me),Ye=s(Me,"P",{});var en=a(Ye);fa=i(en,`The M2M100 Model with a language modeling head. Can be used for summarization.
