import{S as tn,i as nn,s as on,e as o,k as p,w as M,t as r,M as sn,c as s,d as n,m as u,a as i,x as $,h as a,b as l,G as t,g as d,y as P,L as rn,q as A,o as N,B as I,v as an}from"../../chunks/vendor-hf-doc-builder.js";import{D as xt}from"../../chunks/Docstring-hf-doc-builder.js";import{C as en}from"../../chunks/CodeBlock-hf-doc-builder.js";import{I as qt}from"../../chunks/IconCopyLink-hf-doc-builder.js";function ln(zt){let k,fe,y,w,ae,U,We,le,Ke,ge,v,T,ce,S,Re,de,De,_e,f,Fe,W,Oe,Be,K,je,Xe,ke,V,Ce,ye,G,Ye,ve,J,pe,He,be,Q,Ve,we,R,Te,L,Ge,Z,Je,Qe,Le,D,xe,x,Ze,ee,et,tt,qe,g,nt,F,ot,st,O,it,rt,ze,b,q,ue,B,at,me,lt,Ee,m,j,ct,h,dt,te,pt,ut,ne,mt,ht,X,ft,gt,_t,C,kt,oe,yt,vt,bt,z,Y,wt,he,Tt,Lt,se,H,Me;return U=new qt({}),S=new qt({}),R=new en({props:{code:"",highlighted:`<span class="hljs-keyword">from</span> transformers <span class="hljs-keyword">import</span> LukeModel
...
**kwargs &#x2014; passed to the <code>self.tokenize()</code> method`,name:"verbose"}],source:"https://github.com/huggingface/transformers/blob/v4.20.1/src/transformers/models/mluke/tokenization_mluke.py#L367",returnDescription:`
<p>A <a
...
<p><a
  href="/docs/transformers/v4.20.1/en/main_classes/tokenizer#transformers.BatchEncoding"
>BatchEncoding</a></p>
`}}),H=new xt({props:{name:"save_vocabulary",anchor:"transformers.MLukeTokenizer.save_vocabulary",parameters:[{name:"save_directory",val:": str"},{name:"filename_prefix",val:": typing.Optional[str] = None"}],source:"https://github.com/huggingface/transformers/blob/v4.20.1/src/transformers/models/mluke/tokenization_mluke.py#L1495"}}),{c(){k=o("meta"),fe=p(),y=o("h1"),w=o("a"),ae=o("span"),M(U.$$.fragment),We=p(),le=o("span"),Ke=r("mLUKE"),ge=p(),v=o("h2"),T=o("a"),ce=o("span"),M(S.$$.fragment),Re=p(),de=o("span"),De=r("Overview"),_e=p(),f=o("p"),Fe=r("The mLUKE model was proposed in "),W=o("a"),Oe=r("mLUKE: The Power of Entity Representations in Multilingual Pretrained Language Models"),Be=r(` by Ryokan Ri, Ikuya Yamada, and Yoshimasa Tsuruoka. It\u2019s a multilingual extension
...
classification, cloze-style knowledge completion.`),ye=p(),G=o("p"),Ye=r("The abstract from the paper is the following:"),ve=p(),J=o("p"),pe=o("em"),He=r(`Recent studies have shown that multilingual pretrained language models can be effectively improved with cross-lingual
...
knowledge more likely than using only word representations.`),be=p(),Q=o("p"),Ve=r("One can directly plug in the weights of mLUKE into a LUKE model, like so:"),we=p(),M(R.$$.fragment),Te=p(),L=o("p"),Ge=r("Note that mLUKE has its own tokenizer, "),Z=o("a"),Je=r("MLukeTokenizer"),Qe=r(". You can initialize it as follows:"),Le=p(),M(D.$$.fragment),xe=p(),x=o("p"),Ze=r("As mLUKE\u2019s architecture is equivalent to that of LUKE, one can refer to "),ee=o("a"),et=r("LUKE\u2019s documentation page"),tt=r(` for all
tips, code examples and notebooks.`),qe=p(),g=o("p"),nt=r("This model was contributed by "),F=o("a"),ot=r("ryo0634"),st=r(". The original code can be found "),O=o("a"),it=r("here"),rt=r("."),ze=p(),b=o("h2"),q=o("a"),ue=o("span"),M(B.$$.fragment),at=p(),me=o("span"),lt=r("MLukeTokenizer"),Ee=p(),m=o("div"),M(j.$$.fragment),ct=p(),h=o("p"),dt=r("Adapted from "),te=o("a"),pt=r("XLMRobertaTokenizer"),ut=r(" and "),ne=o("a"),mt=r("LukeTokenizer"),ht=r(`. Based on
...
this superclass for more information regarding those methods.`),bt=p(),z=o("div"),M(Y.$$.fragment),wt=p(),he=o("p"),Tt=r(`Main method to tokenize and prepare for the model one or several sequence(s) or one or several pair(s) of
sequences, depending on the task you want to prepare them for.`),Lt=p(),se=o("div"),M(H.$$.fragment),this.h()},l(e){const c=sn('[data-svelte="svelte-1phssyn"]',document.head);k=s(c,"META",{name:!0,content:!0}),c.forEach(n),fe=u(e),y=s(e,"H1",{class:!0});var $e=i(y);w=s($e,"A",{id:!0,class:!0,href:!0});var Et=i(w);ae=s(Et,"SPAN",{});var Mt=i(ae);$(U.$$.fragment,Mt),Mt.forEach(n),Et.forEach(n),We=u($e),le=s($e,"SPAN",{});var $t=i(le);Ke=a($t,"mLUKE"),$t.forEach(n),$e.forEach(n),ge=u(e),v=s(e,"H2",{class:!0});var Pe=i(v);T=s(Pe,"A",{id:!0,class:!0,href:!0});var Pt=i(T);ce=s(Pt,"SPAN",{});var At=i(ce);$(S.$$.fragment,At),At.forEach(n),Pt.forEach(n),Re=u(Pe),de=s(Pe,"SPAN",{});var Nt=i(de);De=a(Nt,"Overview"),Nt.forEach(n),Pe.forEach(n),_e=u(e),f=s(e,"P",{});var ie=i(f);Fe=a(ie,"The mLUKE model was proposed in "),W=s(ie,"A",{href:!0,rel:!0});var It=i(W);Oe=a(It,"mLUKE: The Power of Entity Representations in Multilingual Pretrained Language Models"),It.forEach(n),Be=a(ie,` by Ryokan Ri, Ikuya Yamada, and Yoshimasa Tsuruoka. It\u2019s a multilingual extension
...
involving reasoning about entities such as named entity recognition, extractive question answering, relation
classification, cloze-style knowledge completion.`),St.forEach(n),ye=u(e),G=s(e,"P",{});var Wt=i(G);Ye=a(Wt,"The abstract from the paper is the following:"),Wt.forEach(n),ve=u(e),J=s(e,"P",{});var Kt=i(J);pe=s(Kt,"EM",{});var Rt=i(pe);He=a(Rt,`Recent studies have shown that multilingual pretrained language models can be effectively improved with cross-lingual
alignment information from Wikipedia entities. However, existing methods only exploit entity information in pretraining
and do not explicitly use entities in downstream tasks. In this study, we explore the effectiveness of leveraging
entity representations for downstream cross-lingual tasks. We train a multilingual language model with 24 languages
with entity representations and show the model consistently outperforms word-based pretrained models in various
