import{S as ql,i as Nl,s as Sl,e as n,k as m,w as x,t as r,M as Ol,c as s,d as o,m as p,a,x as w,h as i,b as c,N as Dl,G as e,g as _,y as k,q as T,o as y,B as $,v as Bl,L as vo}from"../../chunks/vendor-hf-doc-builder.js";import{T as go}from"../../chunks/Tip-hf-doc-builder.js";import{D as j}from"../../chunks/Docstring-hf-doc-builder.js";import{C as bo}from"../../chunks/CodeBlock-hf-doc-builder.js";import{I as G}from"../../chunks/IconCopyLink-hf-doc-builder.js";import{E as _o}from"../../chunks/ExampleCodeBlock-hf-doc-builder.js";function Wl(V){let d,b,g,h,v;return h=new bo({props:{code:`from transformers import ViLTModel, ViLTConfig
...
<span class="hljs-meta">... </span>    encoding = processor(image, text, return_tensors=<span class="hljs-string">&quot;pt&quot;</span>)
<span class="hljs-meta">... </span>    outputs = model(**encoding)
<span class="hljs-meta">... </span>    scores[text] = outputs.logits[<span class="hljs-number">0</span>, :].item()`}}),{c(){d=n("p"),b=r("Examples:"),g=m(),x(h.$$.fragment)},l(l){d=s(l,"P",{});var f=a(d);b=i(f,"Examples:"),f.forEach(o),g=p(l),w(h.$$.fragment,l)},m(l,f){_(l,d,f),e(d,b),_(l,g,f),k(h,l,f),v=!0},p:vo,i(l){v||(T(h.$$.fragment,l),v=!0)},o(l){y(h.$$.fragment,l),v=!1},d(l){l&&o(d),l&&o(g),$(h,l)}}}function td(V){let d,b,g,h,v,l,f,F,cs,wn,J,fe,xo,Ye,ms,wo,ps,kn,ue,hs,et,fs,us,Tn,Nt,gs,yn,St,ko,_s,$n,Ot,vs,Vn,C,tt,bs,ot,xs,ws,ks,B,Ts,To,ys,$s,yo,Vs,Fs,Dt,js,Es,Ms,X,Ps,$o,Is,zs,Bt,As,Ls,Cs,Vo,qs,Fn,ge,xi,jn,_e,Ns,Wt,Ss,Os,En,U,Ds,nt,Bs,Ws,st,Rs,Qs,Mn,Z,ve,Fo,at,Us,jo,Hs,Pn,M,rt,Ks,Y,Gs,Eo,Js,Xs,it,Zs,Ys,ea,ee,ta,Rt,oa,na,Qt,sa,aa,ra,be,In,te,xe,Mo,lt,ia,Po,la,zn,P,dt,da,Io,ca,ma,ct,pa,Ut,ha,fa,ua,H,mt,ga,zo,_a,va,we,An,oe,ke,Ao,pt,ba,Lo,xa,Ln,I,ht,wa,Co,ka,Ta,E,Ht,ya,$a,Kt,Va,Fa,Gt,ja,Ea,ft,qo,Ma,Pa,Ia,No,za,Aa,La,K,ut,Ca,ne,qa,Te,Na,So,Sa,Oa,Da,ye,Ba,Oo,Wa,Ra,Qa,Ua,Do,Ha,Cn,se,$e,Bo,gt,Ka,Wo,Ga,qn,W,_t,Ja,vt,Xa,Ro,Za,Ya,er,q,bt,tr,ae,or,Jt,nr,sr,Qo,ar,rr,ir,Ve,lr,Fe,Nn,re,je,Uo,xt,dr,Ho,cr,Sn,z,wt,mr,Ko,pr,hr,kt,fr,Go,ur,gr,_r,N,Tt,vr,ie,br,Xt,xr,wr,Jo,kr,Tr,yr,Ee,$r,Me,On,le,Pe,Xo,yt,Vr,Zo,Fr,Dn,A,$t,jr,Yo,Er,Mr,Vt,Pr,en,Ir,zr,Ar,S,Ft,Lr,de,Cr,Zt,qr,Nr,tn,Sr,Or,Dr,Ie,Br,ze,Bn,ce,Ae,on,jt,Wr,nn,Rr,Wn,R,Et,Qr,sn,Ur,Hr,O,Mt,Kr,me,Gr,Yt,Jr,Xr,an,Zr,Yr,ei,Le,ti,Ce,Rn,pe,qe,rn,Pt,oi,ln,ni,Qn,L,It,si,dn,ai,ri,zt,ii,cn,li,di,ci,D,At,mi,he,pi,eo,hi,fi,mn,ui,gi,_i,Ne,vi,Se,Un;return l=new G({}),Ye=new G({}),at=new G({}),rt=new j({props:{name:"class transformers.ViltConfig",anchor:"transformers.ViltConfig",parameters:[{name:"vocab_size",val:" = 30522"},{name:"type_vocab_size",val:" = 2"},{name:"modality_type_vocab_size",val:" = 2"},{name:"max_position_embeddings",val:" = 40"},{name:"hidden_size",val:" = 768"},{name:"num_hidden_layers",val:" = 12"},{name:"num_attention_heads",val:" = 12"},{name:"intermediate_size",val:" = 3072"},{name:"hidden_act",val:" = 'gelu'"},{name:"hidden_dropout_prob",val:" = 0.0"},{name:"attention_probs_dropout_prob",val:" = 0.0"},{name:"initializer_range",val:" = 0.02"},{name:"layer_norm_eps",val:" = 1e-12"},{name:"is_encoder_decoder",val:" = False"},{name:"image_size",val:" = 384"},{name:"patch_size",val:" = 32"},{name:"num_channels",val:" = 3"},{name:"qkv_bias",val:" = True"},{name:"max_image_length",val:" = -1"},{name:"tie_word_embeddings",val:" = False"},{name:"num_images",val:" = -1"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.ViltConfig.vocab_size",description:`<strong>vocab_size</strong> (<code>int</code>, <em>optional</em>, defaults to 30522) &#x2014;
Vocabulary size of the text part of the model. Defines the number of different tokens that can be
represented by the <code>inputs_ids</code> passed when calling <a href="/docs/transformers/v4.20.1/en/model_doc/vilt#transformers.ViltModel">ViltModel</a>.`,name:"vocab_size"},{anchor:"transformers.ViltConfig.type_vocab_size",description:`<strong>type_vocab_size</strong> (<code>int</code>, <em>optional</em>, defaults to 2) &#x2014;
The vocabulary size of the <code>token_type_ids</code> passed when calling <a href="/docs/transformers/v4.20.1/en/model_doc/vilt#transformers.ViltModel">ViltModel</a>. This is used when encoding
...
The vocabulary size of the modalities passed when calling <a href="/docs/transformers/v4.20.1/en/model_doc/vilt#transformers.ViltModel">ViltModel</a>. This is used after concatening the
...
</ul>`,name:"pad_and_return_pixel_mask"},{anchor:"transformers.ViltFeatureExtractor.__call__.return_tensors",description:`<strong>return_tensors</strong> (<code>str</code> or <a href="/docs/transformers/v4.20.1/en/internal/file_utils#transformers.TensorType">TensorType</a>, <em>optional</em>, defaults to <code>&apos;np&apos;</code>) &#x2014;
...
</ul>`,name:"return_tensors"}],source:"https://github.com/huggingface/transformers/blob/v4.20.1/src/transformers/models/vilt/feature_extraction_vilt.py#L181",returnDescription:`
<p>A <a
  href="/docs/transformers/v4.20.1/en/main_classes/feature_extractor#transformers.BatchFeature"
...
Pixel values. Pixel values can be obtained using <a href="/docs/transformers/v4.20.1/en/model_doc/vilt#transformers.ViltFeatureExtractor">ViltFeatureExtractor</a>. See
...
Whether or not to return a <a href="/docs/transformers/v4.20.1/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/v4.20.1/src/transformers/models/vilt/modeling_vilt.py#L761",returnDescription:`
<p>A <a
...
elements depending on the configuration (<a
  href="/docs/transformers/v4.20.1/en/model_doc/vilt#transformers.ViltConfig"
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/v4.20.1/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/v4.20.1/src/transformers/models/vilt/modeling_vilt.py#L898"}}),Tt=new j({props:{name:"forward",anchor:"transformers.ViltForMaskedLM.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"pixel_values",val:" = None"},{name:"pixel_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"image_embeds",val:" = None"},{name:"labels",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],parametersDescription:[{anchor:"transformers.ViltForMaskedLM.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. Indices can be obtained using <a href="/docs/transformers/v4.20.1/en/model_doc/bert#transformers.BertTokenizer">BertTokenizer</a>. See
<a href="/docs/transformers/v4.20.1/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and <a href="/docs/transformers/v4.20.1/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details. <a href="../glossary#input-ids">What are input
...
loss is only computed for the tokens with labels in <em>[0, &#x2026;, config.vocab_size]</em>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.20.1/src/transformers/models/vilt/modeling_vilt.py#L914",returnDescription:`
<p>A <a
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/v4.20.1/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/v4.20.1/src/transformers/models/vilt/modeling_vilt.py#L1070"}}),Ft=new j({props:{name:"forward",anchor:"transformers.ViltForQuestionAnswering.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"pixel_values",val:" = None"},{name:"pixel_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"image_embeds",val:" = None"},{name:"labels",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],parametersDescription:[{anchor:"transformers.ViltForQuestionAnswering.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>({0})</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. Indices can be obtained using <a href="/docs/transformers/v4.20.1/en/model_doc/bert#transformers.BertTokenizer">BertTokenizer</a>. See
<a href="/docs/transformers/v4.20.1/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and <a href="/docs/transformers/v4.20.1/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details. <a href="../glossary#input-ids">What are input
...
answers are applicable, where 1.0 is the highest score.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.20.1/src/transformers/models/vilt/modeling_vilt.py#L1088",returnDescription:`
<p>A <a
...
Whether or not to return a <a href="/docs/transformers/v4.20.1/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/v4.20.1/src/transformers/models/vilt/modeling_vilt.py#L1280"}}),Mt=new j({props:{name:"forward",anchor:"transformers.ViltForImagesAndTextClassification.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"pixel_values",val:" = None"},{name:"pixel_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"image_embeds",val:" = None"},{name:"labels",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],parametersDescription:[{anchor:"transformers.ViltForImagesAndTextClassification.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>({0})</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. Indices can be obtained using <a href="/docs/transformers/v4.20.1/en/model_doc/bert#transformers.BertTokenizer">BertTokenizer</a>. See
<a href="/docs/transformers/v4.20.1/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and <a href="/docs/transformers/v4.20.1/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details. <a href="../glossary#input-ids">What are input
...
Binary classification labels.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.20.1/src/transformers/models/vilt/modeling_vilt.py#L1299",returnDescription:`
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/v4.20.1/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/v4.20.1/src/transformers/models/vilt/modeling_vilt.py#L1181"}}),At=new j({props:{name:"forward",anchor:"transformers.ViltForImageAndTextRetrieval.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"pixel_values",val:" = None"},{name:"pixel_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"image_embeds",val:" = None"},{name:"labels",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],parametersDescription:[{anchor:"transformers.ViltForImageAndTextRetrieval.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>({0})</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. Indices can be obtained using <a href="/docs/transformers/v4.20.1/en/model_doc/bert#transformers.BertTokenizer">BertTokenizer</a>. See
<a href="/docs/transformers/v4.20.1/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and <a href="/docs/transformers/v4.20.1/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details. <a href="../glossary#input-ids">What are input
...
Labels are currently not supported.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.20.1/src/transformers/models/vilt/modeling_vilt.py#L1193",returnDescription:`
<p>A <a
  href="/docs/transformers/v4.20.1/en/main_classes/output#transformers.modeling_outputs.SequenceClassifierOutput"
>transformers.modeling_outputs.SequenceClassifierOutput</a> or a tuple of
<code>torch.FloatTensor</code> (if <code>return_dict=False</code> is passed or when <code>config.return_dict=False</code>) comprising various
...
times faster than previous VLP models, yet with competitive or better downstream task performance.`),$n=m(),Ot=n("p"),vs=r("Tips:"),Vn=m(),C=n("ul"),tt=n("li"),bs=r("The quickest way to get started with ViLT is by checking the "),ot=n("a"),xs=r("example notebooks"),ws=r(`
(which showcase both inference and fine-tuning on custom data).`),ks=m(),B=n("li"),Ts=r("ViLT is a model that takes both "),To=n("code"),ys=r("pixel_values"),$s=r(" and "),yo=n("code"),Vs=r("input_ids"),Fs=r(" as input. One can use "),Dt=n("a"),js=r("ViltProcessor"),Es=r(` to prepare data for the model.
...
which pixel values are real and which are padding. `),Bt=n("a"),As=r("ViltProcessor"),Ls=r(" automatically creates this for you."),Cs=m(),Vo=n("li"),qs=r(`The design of ViLT is very similar to that of a standard Vision Transformer (ViT). The only difference is that the model includes
additional embedding layers for the language modality.`),Fn=m(),ge=n("img"),jn=m(),_e=n("small"),Ns=r("ViLT architecture. Taken from the "),Wt=n("a"),Ss=r("original paper"),Os=r("."),En=m(),U=n("p"),Ds=r("This model was contributed by "),nt=n("a"),Bs=r("nielsr"),Ws=r(". The original code can be found "),st=n("a"),Rs=r("here"),Qs=r("."),Mn=m(),Z=n("h2"),ve=n("a"),Fo=n("span"),x(at.$$.fragment),Us=m(),jo=n("span"),Hs=r("ViltConfig"),Pn=m(),M=n("div"),x(rt.$$.fragment),Ks=m(),Y=n("p"),Gs=r("This is the configuration class to store the configuration of a "),Eo=n("code"),Js=r("ViLTModel"),Xs=r(`. It is used to instantiate an ViLT
...
documentation from `),Qt=n("a"),sa=r("PretrainedConfig"),aa=r(" for more information."),ra=m(),x(be.$$.fragment),In=m(),te=n("h2"),xe=n("a"),Mo=n("span"),x(lt.$$.fragment),ia=m(),Po=n("span"),la=r("ViltFeatureExtractor"),zn=m(),P=n("div"),x(dt.$$.fragment),da=m(),Io=n("p"),ca=r("Constructs a ViLT feature extractor."),ma=m(),ct=n("p"),pa=r("This feature extractor inherits from "),Ut=n("a"),ha=r("FeatureExtractionMixin"),fa=r(` which contains most of the main methods. Users
should refer to this superclass for more information regarding those methods.`),ua=m(),H=n("div"),x(mt.$$.fragment),ga=m(),zo=n("p"),_a=r("Main method to prepare for the model one or several image(s)."),va=m(),x(we.$$.fragment),An=m(),oe=n("h2"),ke=n("a"),Ao=n("span"),x(pt.$$.fragment),ba=m(),Lo=n("span"),xa=r("ViltProcessor"),Ln=m(),I=n("div"),x(ht.$$.fragment),wa=m(),Co=n("p"),ka=r("Constructs a ViLT processor which wraps a BERT tokenizer and ViLT feature extractor into a single processor."),Ta=m(),E=n("p"),Ht=n("a"),ya=r("ViltProcessor"),$a=r(" offers all the functionalities of "),Kt=n("a"),Va=r("ViltFeatureExtractor"),Fa=r(" and "),Gt=n("a"),ja=r("BertTokenizerFast"),Ea=r(`. See the
docstring of `),ft=n("a"),qo=n("strong"),Ma=r("call"),Pa=r("()"),Ia=r(" and "),No=n("code"),za=r("decode()"),Aa=r(" for more information."),La=m(),K=n("div"),x(ut.$$.fragment),Ca=m(),ne=n("p"),qa=r("This method uses "),Te=n("a"),Na=r("ViltFeatureExtractor."),So=n("strong"),Sa=r("call"),Oa=r("()"),Da=r(` method to prepare image(s) for the model, and
`),ye=n("a"),Ba=r("BertTokenizerFast."),Oo=n("strong"),Wa=r("call"),Ra=r("()"),Qa=r(" to prepare text for the model."),Ua=m(),Do=n("p"),Ha=r("Please refer to the docstring of the above two methods for more information."),Cn=m(),se=n("h2"),$e=n("a"),Bo=n("span"),x(gt.$$.fragment),Ka=m(),Wo=n("span"),Ga=r("ViltModel"),qn=m(),W=n("div"),x(_t.$$.fragment),Ja=m(),vt=n("p"),Xa=r(`The bare ViLT Model transformer outputting raw hidden-states without any specific head on top.
...
behavior.`),er=m(),q=n("div"),x(bt.$$.fragment),tr=m(),ae=n("p"),or=r("The "),Jt=n("a"),nr=r("ViltModel"),sr=r(" forward method, overrides the "),Qo=n("code"),ar=r("__call__"),rr=r(" special method."),ir=m(),x(Ve.$$.fragment),lr=m(),x(Fe.$$.fragment),Nn=m(),re=n("h2"),je=n("a"),Uo=n("span"),x(xt.$$.fragment),dr=m(),Ho=n("span"),cr=r("ViltForMaskedLM"),Sn=m(),z=n("div"),x(wt.$$.fragment),mr=m(),Ko=n("p"),pr=r("ViLT Model with a language modeling head on top as done during pretraining."),hr=m(),kt=n("p"),fr=r("This model is a PyTorch "),Go=n("code"),ur=r("torch.nn.Module <https://pytorch.org/docs/stable/nn.html#torch.nn.Module>"),gr=r(`_ subclass. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),_r=m(),N=n("div"),x(Tt.$$.fragment),vr=m(),ie=n("p"),br=r("The "),Xt=n("a"),xr=r("ViltForMaskedLM"),wr=r(" forward method, overrides the "),Jo=n("code"),kr=r("__call__"),Tr=r(" special method."),yr=m(),x(Ee.$$.fragment),$r=m(),x(Me.$$.fragment),On=m(),le=n("h2"),Pe=n("a"),Xo=n("span"),x(yt.$$.fragment),Vr=m(),Zo=n("span"),Fr=r("ViltForQuestionAnswering"),Dn=m(),A=n("div"),x($t.$$.fragment),jr=m(),Yo=n("p"),Er=r(`Vilt Model transformer with a classifier head on top (a linear layer on top of the final hidden state of the [CLS]
...
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),Ar=m(),S=n("div"),x(Ft.$$.fragment),Lr=m(),de=n("p"),Cr=r("The "),Zt=n("a"),qr=r("ViltForQuestionAnswering"),Nr=r(" forward method, overrides the "),tn=n("code"),Sr=r("__call__"),Or=r(" special method."),Dr=m(),x(Ie.$$.fragment),Br=m(),x(ze.$$.fragment),Bn=m(),ce=n("h2"),Ae=n("a"),on=n("span"),x(jt.$$.fragment),Wr=m(),nn=n("span"),Rr=r("ViltForImagesAndTextClassification"),Wn=m(),R=n("div"),x(Et.$$.fragment),Qr=m(),sn=n("p"),Ur=r("Vilt Model transformer with a classifier head on top for natural language visual reasoning, e.g. NLVR2."),Hr=m(),O=n("div"),x(Mt.$$.fragment),Kr=m(),me=n("p"),Gr=r("The "),Yt=n("a"),Jr=r("ViltForImagesAndTextClassification"),Xr=r(" forward method, overrides the "),an=n("code"),Zr=r("__call__"),Yr=r(" special method."),ei=m(),x(Le.$$.fragment),ti=m(),x(Ce.$$.fragment),Rn=m(),pe=n("h2"),qe=n("a"),rn=n("span"),x(Pt.$$.fragment),oi=m(),ln=n("span"),ni=r("ViltForImageAndTextRetrieval"),Qn=m(),L=n("div"),x(It.$$.fragment),si=m(),dn=n("p"),ai=r(`Vilt Model transformer with a classifier head on top (a linear layer on top of the final hidden state of the [CLS]
...
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),ci=m(),D=n("div"),x(At.$$.fragment),mi=m(),he=n("p"),pi=r("The "),eo=n("a"),hi=r("ViltForImageAndTextRetrieval"),fi=r(" forward method, overrides the "),mn=n("code"),ui=r("__call__"),gi=r(" special method."),_i=m(),x(Ne.$$.fragment),vi=m(),x(Se.$$.fragment),this.h()},l(t){const u=Ol('[data-svelte="svelte-1phssyn"]',document.head);d=s(u,"META",{name:!0,content:!0}),u.forEach(o),b=p(t),g=s(t,"H1",{class:!0});var Lt=a(g);h=s(Lt,"A",{id:!0,class:!0,href:!0});var pn=a(h);v=s(pn,"SPAN",{});var hn=a(v);w(l.$$.fragment,hn),hn.forEach(o),pn.forEach(o),f=p(Lt),F=s(Lt,"SPAN",{});var fn=a(F);cs=i(fn,"ViLT"),fn.forEach(o),Lt.forEach(o),wn=p(t),J=s(t,"H2",{class:!0});var Ct=a(J);fe=s(Ct,"A",{id:!0,class:!0,href:!0});var un=a(fe);xo=s(un,"SPAN",{});var gn=a(xo);w(Ye.$$.fragment,gn),gn.forEach(o),un.forEach(o),ms=p(Ct),wo=s(Ct,"SPAN",{});var _n=a(wo);ps=i(_n,"Overview"),_n.forEach(o),Ct.forEach(o),kn=p(t),ue=s(t,"P",{});var qt=a(ue);hs=i(qt,"The ViLT model was proposed in "),et=s(qt,"A",{href:!0,rel:!0});var vn=a(et);fs=i(vn,"ViLT: Vision-and-Language Transformer Without Convolution or Region Supervision"),vn.forEach(o),us=i(qt,`
by Wonjae Kim, Bokyung Son, Ildoo Kim. ViLT incorporates text embeddings into a Vision Transformer (ViT), allowing it to have a minimal design
for Vision-and-Language Pre-training (VLP).`),qt.forEach(o),Tn=p(t),Nt=s(t,"P",{});var bn=a(Nt);gs=i(bn,"The abstract from the paper is the following:"),bn.forEach(o),yn=p(t),St=s(t,"P",{});var xn=a(St);ko=s(xn,"EM",{});var wi=a(ko);_s=i(wi,`Vision-and-Language Pre-training (VLP) has improved performance on various joint vision-and-language downstream tasks.
Current approaches to VLP heavily rely on image feature extraction processes, most of which involve region supervision
(e.g., object detection) and the convolutional architecture (e.g., ResNet). Although disregarded in the literature, we
find it problematic in terms of both (1) efficiency/speed, that simply extracting input features requires much more
computation than the multimodal interaction steps; and (2) expressive power, as it is upper bounded to the expressive
...
which pixel values are real and which are padding. `),Bt=s(to,"A",{href:!0});var ji=a(Bt);As=i(ji,"ViltProcessor"),ji.forEach(o),Ls=i(to," automatically creates this for you."),to.forEach(o),Cs=p(Oe),Vo=s(Oe,"LI",{});var Ei=a(Vo);qs=i(Ei,`The design of ViLT is very similar to that of a standard Vision Transformer (ViT). The only difference is that the model includes
additional embedding layers for the language modality.`),Ei.forEach(o),Oe.forEach(o),Fn=p(t),ge=s(t,"IMG",{src:!0,alt:!0,width:!0}),jn=p(t),_e=s(t,"SMALL",{});var Kn=a(_e);Ns=i(Kn,"ViLT architecture. Taken from the "),Wt=s(Kn,"A",{href:!0});var Mi=a(Wt);Ss=i(Mi,"original paper"),Mi.forEach(o),Os=i(Kn,"."),Kn.forEach(o),En=p(t),U=s(t,"P",{});var oo=a(U);Ds=i(oo,"This model was contributed by "),nt=s(oo,"A",{href:!0,rel:!0});var Pi=a(nt);Bs=i(Pi,"nielsr"),Pi.forEach(o),Ws=i(oo,". The original code can be found "),st=s(oo,"A",{href:!0,rel:!0});var Ii=a(st);Rs=i(Ii,"here"),Ii.forEach(o),Qs=i(oo,"."),oo.forEach(o),Mn=p(t),Z=s(t,"H2",{class:!0});var Gn=a(Z);ve=s(Gn,"A",{id:!0,class:!0,href:!0});var zi=a(ve);Fo=s(zi,"SPAN",{});var Ai=a(Fo);w(at.$$.fragment,Ai),Ai.forEach(o),zi.forEach(o),Us=p(Gn),jo=s(Gn,"SPAN",{});var Li=a(jo);Hs=i(Li,"ViltConfig"),Li.forEach(o),Gn.forEach(o),Pn=p(t),M=s(t,"DIV",{class:!0});var Be=a(M);w(rt.$$.fragment,Be),Ks=p(Be),Y=s(Be,"P",{});var no=a(Y);Gs=i(no,"This is the configuration class to store the configuration of a "),Eo=s(no,"CODE",{});var Ci=a(Eo);Js=i(Ci,"ViLTModel"),Ci.forEach(o),Xs=i(no,`. It is used to instantiate an ViLT
model according to the specified arguments, defining the model architecture. Instantiating a configuration with the
defaults will yield a similar configuration to that of the ViLT
`),it=s(no,"A",{href:!0,rel:!0});var qi=a(it);Zs=i(qi,"dandelin/vilt-b32-mlm"),qi.forEach(o),Ys=i(no," architecture."),no.forEach(o),ea=p(Be),ee=s(Be,"P",{});var so=a(ee);ta=i(so,"Configuration objects inherit from "),Rt=s(so,"A",{href:!0});var Ni=a(Rt);oa=i(Ni,"PretrainedConfig"),Ni.forEach(o),na=i(so,` and can be used to control the model outputs. Read the
documentation from `),Qt=s(so,"A",{href:!0});var Si=a(Qt);sa=i(Si,"PretrainedConfig"),Si.forEach(o),aa=i(so," for more information."),so.forEach(o),ra=p(Be),w(be.$$.fragment,Be),Be.forEach(o),In=p(t),te=s(t,"H2",{class:!0});var Jn=a(te);xe=s(Jn,"A",{id:!0,class:!0,href:!0});var Oi=a(xe);Mo=s(Oi,"SPAN",{});var Di=a(Mo);w(lt.$$.fragment,Di),Di.forEach(o),Oi.forEach(o),ia=p(Jn),Po=s(Jn,"SPAN",{});var Bi=a(Po);la=i(Bi,"ViltFeatureExtractor"),Bi.forEach(o),Jn.forEach(o),zn=p(t),P=s(t,"DIV",{class:!0});var We=a(P);w(dt.$$.fragment,We),da=p(We),Io=s(We,"P",{});var Wi=a(Io);ca=i(Wi,"Constructs a ViLT feature extractor."),Wi.forEach(o),ma=p(We),ct=s(We,"P",{});var Xn=a(ct);pa=i(Xn,"This feature extractor inherits from "),Ut=s(Xn,"A",{href:!0});var Ri=a(Ut);ha=i(Ri,"FeatureExtractionMixin"),Ri.forEach(o),fa=i(Xn,` which contains most of the main methods. Users
should refer to this superclass for more information regarding those methods.`),Xn.forEach(o),ua=p(We),H=s(We,"DIV",{class:!0});var ao=a(H);w(mt.$$.fragment,ao),ga=p(ao),zo=s(ao,"P",{});var Qi=a(zo);_a=i(Qi,"Main method to prepare for the model one or several image(s)."),Qi.forEach(o),va=p(ao),w(we.$$.fragment,ao),ao.forEach(o),We.forEach(o),An=p(t),oe=s(t,"H2",{class:!0});var Zn=a(oe);ke=s(Zn,"A",{id:!0,class:!0,href:!0});var Ui=a(ke);Ao=s(Ui,"SPAN",{});var Hi=a(Ao);w(pt.$$.fragment,Hi),Hi.forEach(o),Ui.forEach(o),ba=p(Zn),Lo=s(Zn,"SPAN",{});var Ki=a(Lo);xa=i(Ki,"ViltProcessor"),Ki.forEach(o),Zn.forEach(o),Ln=p(t),I=s(t,"DIV",{class:!0});var Re=a(I);w(ht.$$.fragment,Re),wa=p(Re),Co=s(Re,"P",{});var Gi=a(Co);ka=i(Gi,"Constructs a ViLT processor which wraps a BERT tokenizer and ViLT feature extractor into a single processor."),Gi.forEach(o),Ta=p(Re),E=s(Re,"P",{});var Q=a(E);Ht=s(Q,"A",{href:!0});var Ji=a(Ht);ya=i(Ji,"ViltProcessor"),Ji.forEach(o),$a=i(Q," offers all the functionalities of "),Kt=s(Q,"A",{href:!0});var Xi=a(Kt);Va=i(Xi,"ViltFeatureExtractor"),Xi.forEach(o),Fa=i(Q," and "),Gt=s(Q,"A",{href:!0});var Zi=a(Gt);ja=i(Zi,"BertTokenizerFast"),Zi.forEach(o),Ea=i(Q,`. See the
docstring of `),ft=s(Q,"A",{href:!0});var bi=a(ft);qo=s(bi,"STRONG",{});var Yi=a(qo);Ma=i(Yi,"call"),Yi.forEach(o),Pa=i(bi,"()"),bi.forEach(o),Ia=i(Q," and "),No=s(Q,"CODE",{});var el=a(No);za=i(el,"decode()"),el.forEach(o),Aa=i(Q," for more information."),Q.forEach(o),La=p(Re),K=s(Re,"DIV",{class:!0});var ro=a(K);w(ut.$$.fragment,ro),Ca=p(ro),ne=s(ro,"P",{});var io=a(ne);qa=i(io,"This method uses "),Te=s(io,"A",{href:!0});var Yn=a(Te);Na=i(Yn,"ViltFeatureExtractor."),So=s(Yn,"STRONG",{});var tl=a(So);Sa=i(tl,"call"),tl.forEach(o),Oa=i(Yn,"()"),Yn.forEach(o),Da=i(io,` method to prepare image(s) for the model, and
`),ye=s(io,"A",{href:!0});var es=a(ye);Ba=i(es,"BertTokenizerFast."),Oo=s(es,"STRONG",{});var ol=a(Oo);Wa=i(ol,"call"),ol.forEach(o),Ra=i(es,"()"),es.forEach(o),Qa=i(io," to prepare text for the model."),io.forEach(o),Ua=p(ro),Do=s(ro,"P",{});var nl=a(Do);Ha=i(nl,"Please refer to the docstring of the above two methods for more information."),nl.forEach(o),ro.forEach(o),Re.forEach(o),Cn=p(t),se=s(t,"H2",{class:!0});var ts=a(se);$e=s(ts,"A",{id:!0,class:!0,href:!0});var sl=a($e);Bo=s(sl,"SPAN",{});var al=a(Bo);w(gt.$$.fragment,al),al.forEach(o),sl.forEach(o),Ka=p(ts),Wo=s(ts,"SPAN",{});var rl=a(Wo);Ga=i(rl,"ViltModel"),rl.forEach(o),ts.forEach(o),qn=p(t),W=s(t,"DIV",{class:!0});var lo=a(W);w(_t.$$.fragment,lo),Ja=p(lo),vt=s(lo,"P",{});var os=a(vt);Xa=i(os,`The bare ViLT Model transformer outputting raw hidden-states without any specific head on top.
...
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),os.forEach(o),er=p(lo),q=s(lo,"DIV",{class:!0});var Qe=a(q);w(bt.$$.fragment,Qe),tr=p(Qe),ae=s(Qe,"P",{});var co=a(ae);or=i(co,"The "),Jt=s(co,"A",{href:!0});var ll=a(Jt);nr=i(ll,"ViltModel"),ll.forEach(o),sr=i(co," forward method, overrides the "),Qo=s(co,"CODE",{});var dl=a(Qo);ar=i(dl,"__call__"),dl.forEach(o),rr=i(co," special method."),co.forEach(o),ir=p(Qe),w(Ve.$$.fragment,Qe),lr=p(Qe),w(Fe.$$.fragment,Qe),Qe.forEach(o),lo.forEach(o),Nn=p(t),re=s(t,"H2",{class:!0});var ns=a(re);je=s(ns,"A",{id:!0,class:!0,href:!0});var cl=a(je);Uo=s(cl,"SPAN",{});var ml=a(Uo);w(xt.$$.fragment,ml),ml.forEach(o),cl.forEach(o),dr=p(ns),Ho=s(ns,"SPAN",{});var pl=a(Ho);cr=i(pl,"ViltForMaskedLM"),pl.forEach(o),ns.forEach(o),Sn=p(t),z=s(t,"DIV",{class:!0});var Ue=a(z);w(wt.$$.fragment,Ue),mr=p(Ue),Ko=s(Ue,"P",{});var hl=a(Ko);pr=i(hl,"ViLT Model with a language modeling head on top as done during pretraining."),hl.forEach(o),hr=p(Ue),kt=s(Ue,"P",{});var ss=a(kt);fr=i(ss,"This model is a PyTorch "),Go=s(ss,"CODE",{});var fl=a(Go);ur=i(fl,"torch.nn.Module <https://pytorch.org/docs/stable/nn.html#torch.nn.Module>"),fl.forEach(o),gr=i(ss,`_ subclass. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),ss.forEach(o),_r=p(Ue),N=s(Ue,"DIV",{class:!0});var He=a(N);w(Tt.$$.fragment,He),vr=p(He),ie=s(He,"P",{});var mo=a(ie);br=i(mo,"The "),Xt=s(mo,"A",{href:!0});var ul=a(Xt);xr=i(ul,"ViltForMaskedLM"),ul.forEach(o),wr=i(mo," forward method, overrides the "),Jo=s(mo,"CODE",{});var gl=a(Jo);kr=i(gl,"__call__"),gl.forEach(o),Tr=i(mo," special method."),mo.forEach(o),yr=p(He),w(Ee.$$.fragment,He),$r=p(He),w(Me.$$.fragment,He),He.forEach(o),Ue.forEach(o),On=p(t),le=s(t,"H2",{class:!0});var as=a(le);Pe=s(as,"A",{id:!0,class:!0,href:!0});var _l=a(Pe);Xo=s(_l,"SPAN",{});var vl=a(Xo);w(yt.$$.fragment,vl),vl.forEach(o),_l.forEach(o),Vr=p(as),Zo=s(as,"SPAN",{});var bl=a(Zo);Fr=i(bl,"ViltForQuestionAnswering"),bl.forEach(o),as.forEach(o),Dn=p(t),A=s(t,"DIV",{class:!0});var Ke=a(A);w($t.$$.fragment,Ke),jr=p(Ke),Yo=s(Ke,"P",{});var xl=a(Yo);Er=i(xl,`Vilt Model transformer with a classifier head on top (a linear layer on top of the final hidden state of the [CLS]
token) for visual question answering, e.g. for VQAv2.`),xl.forEach(o),Mr=p(Ke),Vt=s(Ke,"P",{});var rs=a(Vt);Pr=i(rs,"This model is a PyTorch "),en=s(rs,"CODE",{});var wl=a(en);Ir=i(wl,"torch.nn.Module <https://pytorch.org/docs/stable/nn.html#torch.nn.Module>"),wl.forEach(o),zr=i(rs,`_ subclass. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),rs.forEach(o),Ar=p(Ke),S=s(Ke,"DIV",{class:!0});var Ge=a(S);w(Ft.$$.fragment,Ge),Lr=p(Ge),de=s(Ge,"P",{});var po=a(de);Cr=i(po,"The "),Zt=s(po,"A",{href:!0});var kl=a(Zt);qr=i(kl,"ViltForQuestionAnswering"),kl.forEach(o),Nr=i(po," forward method, overrides the "),tn=s(po,"CODE",{});var Tl=a(tn);Sr=i(Tl,"__call__"),Tl.forEach(o),Or=i(po," special method."),po.forEach(o),Dr=p(Ge),w(Ie.$$.fragment,Ge),Br=p(Ge),w(ze.$$.fragment,Ge),Ge.forEach(o),Ke.forEach(o),Bn=p(t),ce=s(t,"H2",{class:!0});var is=a(ce);Ae=s(is,"A",{id:!0,class:!0,href:!0});var yl=a(Ae);on=s(yl,"SPAN",{});var $l=a(on);w(jt.$$.fragment,$l),$l.forEach(o),yl.forEach(o),Wr=p(is),nn=s(is,"SPAN",{});var Vl=a(nn);Rr=i(Vl,"ViltForImagesAndTextClassification"),Vl.forEach(o),is.forEach(o),Wn=p(t),R=s(t,"DIV",{class:!0});var ho=a(R);w(Et.$$.fragment,ho),Qr=p(ho),sn=s(ho,"P",{});var Fl=a(sn);Ur=i(Fl,"Vilt Model transformer with a classifier head on top for natural language visual reasoning, e.g. NLVR2."),Fl.forEach(o),Hr=p(ho),O=s(ho,"DIV",{class:!0});var Je=a(O);w(Mt.$$.fragment,Je),Kr=p(Je),me=s(Je,"P",{});var fo=a(me);Gr=i(fo,"The "),Yt=s(fo,"A",{href:!0});var jl=a(Yt);Jr=i(jl,"ViltForImagesAndTextClassification"),jl.forEach(o),Xr=i(fo," forward method, overrides the "),an=s(fo,"CODE",{});var El=a(an);Zr=i(El,"__call__"),El.forEach(o),Yr=i(fo," special method."),fo.forEach(o),ei=p(Je),w(Le.$$.fragment,Je),ti=p(Je),w(Ce.$$.fragment,Je),Je.forEach(o),ho.forEach(o),Rn=p(t),pe=s(t,"H2",{class:!0});var ls=a(pe);qe=s(ls,"A",{id:!0,class:!0,href:!0});var Ml=a(qe);rn=s(Ml,"SPAN",{});var Pl=a(rn);w(Pt.$$.fragment,Pl),Pl.forEach(o),Ml.forEach(o),oi=p(ls),ln=s(ls,"SPAN",{});var Il=a(ln);ni=i(Il,"ViltForImageAndTextRetrieval"),Il.forEach(o),ls.forEach(o),Qn=p(t),L=s(t,"DIV",{class:!0});var Xe=a(L);w(It.$$.fragment,Xe),si=p(Xe),dn=s(Xe,"P",{});var zl=a(dn);ai=i(zl,`Vilt Model transformer with a classifier head on top (a linear layer on top of the final hidden state of the [CLS]
