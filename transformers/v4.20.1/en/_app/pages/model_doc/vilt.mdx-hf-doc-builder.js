import{S as ql,i as Nl,s as Sl,e as s,k as m,w as x,t as r,M as Ol,c as n,d as o,m as p,a,x as w,h as i,b as c,N as Dl,G as e,g as _,y as k,q as T,o as y,B as $,v as Wl,L as vo}from"../../chunks/vendor-hf-doc-builder.js";import{T as go}from"../../chunks/Tip-hf-doc-builder.js";import{D as j}from"../../chunks/Docstring-hf-doc-builder.js";import{C as bo}from"../../chunks/CodeBlock-hf-doc-builder.js";import{I as G}from"../../chunks/IconCopyLink-hf-doc-builder.js";import{E as _o}from"../../chunks/ExampleCodeBlock-hf-doc-builder.js";function Rl(V){let d,b,g,h,v;return h=new bo({props:{code:`from transformers import ViLTModel, ViLTConfig
...
<span class="hljs-meta">... </span>    encoding = processor(image, text, return_tensors=<span class="hljs-string">&quot;pt&quot;</span>)
<span class="hljs-meta">... </span>    outputs = model(**encoding)
<span class="hljs-meta">... </span>    scores[text] = outputs.logits[<span class="hljs-number">0</span>, :].item()`}}),{c(){d=s("p"),b=r("Examples:"),g=m(),x(h.$$.fragment)},l(l){d=n(l,"P",{});var f=a(d);b=i(f,"Examples:"),f.forEach(o),g=p(l),w(h.$$.fragment,l)},m(l,f){_(l,d,f),e(d,b),_(l,g,f),k(h,l,f),v=!0},p:vo,i(l){v||(T(h.$$.fragment,l),v=!0)},o(l){y(h.$$.fragment,l),v=!1},d(l){l&&o(d),l&&o(g),$(h,l)}}}function td(V){let d,b,g,h,v,l,f,F,cn,xs,J,fe,xo,Ye,mn,wo,pn,ws,ue,hn,et,fn,un,ks,Nt,gn,Ts,St,ko,_n,ys,Ot,vn,$s,C,tt,bn,ot,xn,wn,kn,W,Tn,To,yn,$n,yo,Vn,Fn,Dt,jn,En,Mn,X,Pn,$o,In,zn,Wt,An,Ln,Cn,Vo,qn,Vs,ge,xi,Fs,_e,Nn,Rt,Sn,On,js,U,Dn,st,Wn,Rn,nt,Bn,Qn,Es,Z,ve,Fo,at,Un,jo,Hn,Ms,M,rt,Kn,Y,Gn,Eo,Jn,Xn,it,Zn,Yn,ea,ee,ta,Bt,oa,sa,Qt,na,aa,ra,be,Ps,te,xe,Mo,lt,ia,Po,la,Is,P,dt,da,Io,ca,ma,ct,pa,Ut,ha,fa,ua,H,mt,ga,zo,_a,va,we,zs,oe,ke,Ao,pt,ba,Lo,xa,As,I,ht,wa,Co,ka,Ta,E,Ht,ya,$a,Kt,Va,Fa,Gt,ja,Ea,ft,qo,Ma,Pa,Ia,No,za,Aa,La,K,ut,Ca,se,qa,Te,Na,So,Sa,Oa,Da,ye,Wa,Oo,Ra,Ba,Qa,Ua,Do,Ha,Ls,ne,$e,Wo,gt,Ka,Ro,Ga,Cs,R,_t,Ja,vt,Xa,Bo,Za,Ya,er,q,bt,tr,ae,or,Jt,sr,nr,Qo,ar,rr,ir,Ve,lr,Fe,qs,re,je,Uo,xt,dr,Ho,cr,Ns,z,wt,mr,Ko,pr,hr,kt,fr,Go,ur,gr,_r,N,Tt,vr,ie,br,Xt,xr,wr,Jo,kr,Tr,yr,Ee,$r,Me,Ss,le,Pe,Xo,yt,Vr,Zo,Fr,Os,A,$t,jr,Yo,Er,Mr,Vt,Pr,es,Ir,zr,Ar,S,Ft,Lr,de,Cr,Zt,qr,Nr,ts,Sr,Or,Dr,Ie,Wr,ze,Ds,ce,Ae,os,jt,Rr,ss,Br,Ws,B,Et,Qr,ns,Ur,Hr,O,Mt,Kr,me,Gr,Yt,Jr,Xr,as,Zr,Yr,ei,Le,ti,Ce,Rs,pe,qe,rs,Pt,oi,is,si,Bs,L,It,ni,ls,ai,ri,zt,ii,ds,li,di,ci,D,At,mi,he,pi,eo,hi,fi,cs,ui,gi,_i,Ne,vi,Se,Qs;return l=new G({}),Ye=new G({}),at=new G({}),rt=new j({props:{name:"class transformers.ViltConfig",anchor:"transformers.ViltConfig",parameters:[{name:"vocab_size",val:" = 30522"},{name:"type_vocab_size",val:" = 2"},{name:"modality_type_vocab_size",val:" = 2"},{name:"max_position_embeddings",val:" = 40"},{name:"hidden_size",val:" = 768"},{name:"num_hidden_layers",val:" = 12"},{name:"num_attention_heads",val:" = 12"},{name:"intermediate_size",val:" = 3072"},{name:"hidden_act",val:" = 'gelu'"},{name:"hidden_dropout_prob",val:" = 0.0"},{name:"attention_probs_dropout_prob",val:" = 0.0"},{name:"initializer_range",val:" = 0.02"},{name:"layer_norm_eps",val:" = 1e-12"},{name:"is_encoder_decoder",val:" = False"},{name:"image_size",val:" = 384"},{name:"patch_size",val:" = 32"},{name:"num_channels",val:" = 3"},{name:"qkv_bias",val:" = True"},{name:"max_image_length",val:" = -1"},{name:"tie_word_embeddings",val:" = False"},{name:"num_images",val:" = -1"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.ViltConfig.vocab_size",description:`<strong>vocab_size</strong> (<code>int</code>, <em>optional</em>, defaults to 30522) &#x2014;
...
times faster than previous VLP models, yet with competitive or better downstream task performance.`),ys=m(),Ot=s("p"),vn=r("Tips:"),$s=m(),C=s("ul"),tt=s("li"),bn=r("The quickest way to get started with ViLT is by checking the "),ot=s("a"),xn=r("example notebooks"),wn=r(`
...
additional embedding layers for the language modality.`),Vs=m(),ge=s("img"),Fs=m(),_e=s("small"),Nn=r("ViLT architecture. Taken from the "),Rt=s("a"),Sn=r("original paper"),On=r("."),js=m(),U=s("p"),Dn=r("This model was contributed by "),st=s("a"),Wn=r("nielsr"),Rn=r(". The original code can be found "),nt=s("a"),Bn=r("here"),Qn=r("."),Es=m(),Z=s("h2"),ve=s("a"),Fo=s("span"),x(at.$$.fragment),Un=m(),jo=s("span"),Hn=r("ViltConfig"),Ms=m(),M=s("div"),x(rt.$$.fragment),Kn=m(),Y=s("p"),Gn=r("This is the configuration class to store the configuration of a "),Eo=s("code"),Jn=r("ViLTModel"),Xn=r(`. It is used to instantiate an ViLT
...
documentation from `),Qt=s("a"),na=r("PretrainedConfig"),aa=r(" for more information."),ra=m(),x(be.$$.fragment),Ps=m(),te=s("h2"),xe=s("a"),Mo=s("span"),x(lt.$$.fragment),ia=m(),Po=s("span"),la=r("ViltFeatureExtractor"),Is=m(),P=s("div"),x(dt.$$.fragment),da=m(),Io=s("p"),ca=r("Constructs a ViLT feature extractor."),ma=m(),ct=s("p"),pa=r("This feature extractor inherits from "),Ut=s("a"),ha=r("FeatureExtractionMixin"),fa=r(` which contains most of the main methods. Users
should refer to this superclass for more information regarding those methods.`),ua=m(),H=s("div"),x(mt.$$.fragment),ga=m(),zo=s("p"),_a=r("Main method to prepare for the model one or several image(s)."),va=m(),x(we.$$.fragment),zs=m(),oe=s("h2"),ke=s("a"),Ao=s("span"),x(pt.$$.fragment),ba=m(),Lo=s("span"),xa=r("ViltProcessor"),As=m(),I=s("div"),x(ht.$$.fragment),wa=m(),Co=s("p"),ka=r("Constructs a ViLT processor which wraps a BERT tokenizer and ViLT feature extractor into a single processor."),Ta=m(),E=s("p"),Ht=s("a"),ya=r("ViltProcessor"),$a=r(" offers all the functionalities of "),Kt=s("a"),Va=r("ViltFeatureExtractor"),Fa=r(" and "),Gt=s("a"),ja=r("BertTokenizerFast"),Ea=r(`. See the
docstring of `),ft=s("a"),qo=s("strong"),Ma=r("call"),Pa=r("()"),Ia=r(" and "),No=s("code"),za=r("decode()"),Aa=r(" for more information."),La=m(),K=s("div"),x(ut.$$.fragment),Ca=m(),se=s("p"),qa=r("This method uses "),Te=s("a"),Na=r("ViltFeatureExtractor."),So=s("strong"),Sa=r("call"),Oa=r("()"),Da=r(` method to prepare image(s) for the model, and
`),ye=s("a"),Wa=r("BertTokenizerFast."),Oo=s("strong"),Ra=r("call"),Ba=r("()"),Qa=r(" to prepare text for the model."),Ua=m(),Do=s("p"),Ha=r("Please refer to the docstring of the above two methods for more information."),Ls=m(),ne=s("h2"),$e=s("a"),Wo=s("span"),x(gt.$$.fragment),Ka=m(),Ro=s("span"),Ga=r("ViltModel"),Cs=m(),R=s("div"),x(_t.$$.fragment),Ja=m(),vt=s("p"),Xa=r(`The bare ViLT Model transformer outputting raw hidden-states without any specific head on top.
...
behavior.`),er=m(),q=s("div"),x(bt.$$.fragment),tr=m(),ae=s("p"),or=r("The "),Jt=s("a"),sr=r("ViltModel"),nr=r(" forward method, overrides the "),Qo=s("code"),ar=r("__call__"),rr=r(" special method."),ir=m(),x(Ve.$$.fragment),lr=m(),x(Fe.$$.fragment),qs=m(),re=s("h2"),je=s("a"),Uo=s("span"),x(xt.$$.fragment),dr=m(),Ho=s("span"),cr=r("ViltForMaskedLM"),Ns=m(),z=s("div"),x(wt.$$.fragment),mr=m(),Ko=s("p"),pr=r("ViLT Model with a language modeling head on top as done during pretraining."),hr=m(),kt=s("p"),fr=r("This model is a PyTorch "),Go=s("code"),ur=r("torch.nn.Module <https://pytorch.org/docs/stable/nn.html#torch.nn.Module>"),gr=r(`_ subclass. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),_r=m(),N=s("div"),x(Tt.$$.fragment),vr=m(),ie=s("p"),br=r("The "),Xt=s("a"),xr=r("ViltForMaskedLM"),wr=r(" forward method, overrides the "),Jo=s("code"),kr=r("__call__"),Tr=r(" special method."),yr=m(),x(Ee.$$.fragment),$r=m(),x(Me.$$.fragment),Ss=m(),le=s("h2"),Pe=s("a"),Xo=s("span"),x(yt.$$.fragment),Vr=m(),Zo=s("span"),Fr=r("ViltForQuestionAnswering"),Os=m(),A=s("div"),x($t.$$.fragment),jr=m(),Yo=s("p"),Er=r(`Vilt Model transformer with a classifier head on top (a linear layer on top of the final hidden state of the [CLS]
...
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),Ar=m(),S=s("div"),x(Ft.$$.fragment),Lr=m(),de=s("p"),Cr=r("The "),Zt=s("a"),qr=r("ViltForQuestionAnswering"),Nr=r(" forward method, overrides the "),ts=s("code"),Sr=r("__call__"),Or=r(" special method."),Dr=m(),x(Ie.$$.fragment),Wr=m(),x(ze.$$.fragment),Ds=m(),ce=s("h2"),Ae=s("a"),os=s("span"),x(jt.$$.fragment),Rr=m(),ss=s("span"),Br=r("ViltForImagesAndTextClassification"),Ws=m(),B=s("div"),x(Et.$$.fragment),Qr=m(),ns=s("p"),Ur=r("Vilt Model transformer with a classifier head on top for natural language visual reasoning, e.g. NLVR2."),Hr=m(),O=s("div"),x(Mt.$$.fragment),Kr=m(),me=s("p"),Gr=r("The "),Yt=s("a"),Jr=r("ViltForImagesAndTextClassification"),Xr=r(" forward method, overrides the "),as=s("code"),Zr=r("__call__"),Yr=r(" special method."),ei=m(),x(Le.$$.fragment),ti=m(),x(Ce.$$.fragment),Rs=m(),pe=s("h2"),qe=s("a"),rs=s("span"),x(Pt.$$.fragment),oi=m(),is=s("span"),si=r("ViltForImageAndTextRetrieval"),Bs=m(),L=s("div"),x(It.$$.fragment),ni=m(),ls=s("p"),ai=r(`Vilt Model transformer with a classifier head on top (a linear layer on top of the final hidden state of the [CLS]
...
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),ci=m(),D=s("div"),x(At.$$.fragment),mi=m(),he=s("p"),pi=r("The "),eo=s("a"),hi=r("ViltForImageAndTextRetrieval"),fi=r(" forward method, overrides the "),cs=s("code"),ui=r("__call__"),gi=r(" special method."),_i=m(),x(Ne.$$.fragment),vi=m(),x(Se.$$.fragment),this.h()},l(t){const u=Ol('[data-svelte="svelte-1phssyn"]',document.head);d=n(u,"META",{name:!0,content:!0}),u.forEach(o),b=p(t),g=n(t,"H1",{class:!0});var Lt=a(g);h=n(Lt,"A",{id:!0,class:!0,href:!0});var ms=a(h);v=n(ms,"SPAN",{});var ps=a(v);w(l.$$.fragment,ps),ps.forEach(o),ms.forEach(o),f=p(Lt),F=n(Lt,"SPAN",{});var hs=a(F);cn=i(hs,"ViLT"),hs.forEach(o),Lt.forEach(o),xs=p(t),J=n(t,"H2",{class:!0});var Ct=a(J);fe=n(Ct,"A",{id:!0,class:!0,href:!0});var fs=a(fe);xo=n(fs,"SPAN",{});var us=a(xo);w(Ye.$$.fragment,us),us.forEach(o),fs.forEach(o),mn=p(Ct),wo=n(Ct,"SPAN",{});var gs=a(wo);pn=i(gs,"Overview"),gs.forEach(o),Ct.forEach(o),ws=p(t),ue=n(t,"P",{});var qt=a(ue);hn=i(qt,"The ViLT model was proposed in "),et=n(qt,"A",{href:!0,rel:!0});var _s=a(et);fn=i(_s,"ViLT: Vision-and-Language Transformer Without Convolution or Region Supervision"),_s.forEach(o),un=i(qt,`
by Wonjae Kim, Bokyung Son, Ildoo Kim. ViLT incorporates text embeddings into a Vision Transformer (ViT), allowing it to have a minimal design
for Vision-and-Language Pre-training (VLP).`),qt.forEach(o),ks=p(t),Nt=n(t,"P",{});var vs=a(Nt);gn=i(vs,"The abstract from the paper is the following:"),vs.forEach(o),Ts=p(t),St=n(t,"P",{});var bs=a(St);ko=n(bs,"EM",{});var wi=a(ko);_n=i(wi,`Vision-and-Language Pre-training (VLP) has improved performance on various joint vision-and-language downstream tasks.
Current approaches to VLP heavily rely on image feature extraction processes, most of which involve region supervision
(e.g., object detection) and the convolutional architecture (e.g., ResNet). Although disregarded in the literature, we
find it problematic in terms of both (1) efficiency/speed, that simply extracting input features requires much more
computation than the multimodal interaction steps; and (2) expressive power, as it is upper bounded to the expressive
...
documentation from `),Qt=n(no,"A",{href:!0});var Si=a(Qt);na=i(Si,"PretrainedConfig"),Si.forEach(o),aa=i(no," for more information."),no.forEach(o),ra=p(We),w(be.$$.fragment,We),We.forEach(o),Ps=p(t),te=n(t,"H2",{class:!0});var Gs=a(te);xe=n(Gs,"A",{id:!0,class:!0,href:!0});var Oi=a(xe);Mo=n(Oi,"SPAN",{});var Di=a(Mo);w(lt.$$.fragment,Di),Di.forEach(o),Oi.forEach(o),ia=p(Gs),Po=n(Gs,"SPAN",{});var Wi=a(Po);la=i(Wi,"ViltFeatureExtractor"),Wi.forEach(o),Gs.forEach(o),Is=p(t),P=n(t,"DIV",{class:!0});var Re=a(P);w(dt.$$.fragment,Re),da=p(Re),Io=n(Re,"P",{});var Ri=a(Io);ca=i(Ri,"Constructs a ViLT feature extractor."),Ri.forEach(o),ma=p(Re),ct=n(Re,"P",{});var Js=a(ct);pa=i(Js,"This feature extractor inherits from "),Ut=n(Js,"A",{href:!0});var Bi=a(Ut);ha=i(Bi,"FeatureExtractionMixin"),Bi.forEach(o),fa=i(Js,` which contains most of the main methods. Users
should refer to this superclass for more information regarding those methods.`),Js.forEach(o),ua=p(Re),H=n(Re,"DIV",{class:!0});var ao=a(H);w(mt.$$.fragment,ao),ga=p(ao),zo=n(ao,"P",{});var Qi=a(zo);_a=i(Qi,"Main method to prepare for the model one or several image(s)."),Qi.forEach(o),va=p(ao),w(we.$$.fragment,ao),ao.forEach(o),Re.forEach(o),zs=p(t),oe=n(t,"H2",{class:!0});var Xs=a(oe);ke=n(Xs,"A",{id:!0,class:!0,href:!0});var Ui=a(ke);Ao=n(Ui,"SPAN",{});var Hi=a(Ao);w(pt.$$.fragment,Hi),Hi.forEach(o),Ui.forEach(o),ba=p(Xs),Lo=n(Xs,"SPAN",{});var Ki=a(Lo);xa=i(Ki,"ViltProcessor"),Ki.forEach(o),Xs.forEach(o),As=p(t),I=n(t,"DIV",{class:!0});var Be=a(I);w(ht.$$.fragment,Be),wa=p(Be),Co=n(Be,"P",{});var Gi=a(Co);ka=i(Gi,"Constructs a ViLT processor which wraps a BERT tokenizer and ViLT feature extractor into a single processor."),Gi.forEach(o),Ta=p(Be),E=n(Be,"P",{});var Q=a(E);Ht=n(Q,"A",{href:!0});var Ji=a(Ht);ya=i(Ji,"ViltProcessor"),Ji.forEach(o),$a=i(Q," offers all the functionalities of "),Kt=n(Q,"A",{href:!0});var Xi=a(Kt);Va=i(Xi,"ViltFeatureExtractor"),Xi.forEach(o),Fa=i(Q," and "),Gt=n(Q,"A",{href:!0});var Zi=a(Gt);ja=i(Zi,"BertTokenizerFast"),Zi.forEach(o),Ea=i(Q,`. See the
docstring of `),ft=n(Q,"A",{href:!0});var bi=a(ft);qo=n(bi,"STRONG",{});var Yi=a(qo);Ma=i(Yi,"call"),Yi.forEach(o),Pa=i(bi,"()"),bi.forEach(o),Ia=i(Q," and "),No=n(Q,"CODE",{});var el=a(No);za=i(el,"decode()"),el.forEach(o),Aa=i(Q," for more information."),Q.forEach(o),La=p(Be),K=n(Be,"DIV",{class:!0});var ro=a(K);w(ut.$$.fragment,ro),Ca=p(ro),se=n(ro,"P",{});var io=a(se);qa=i(io,"This method uses "),Te=n(io,"A",{href:!0});var Zs=a(Te);Na=i(Zs,"ViltFeatureExtractor."),So=n(Zs,"STRONG",{});var tl=a(So);Sa=i(tl,"call"),tl.forEach(o),Oa=i(Zs,"()"),Zs.forEach(o),Da=i(io,` method to prepare image(s) for the model, and
`),ye=n(io,"A",{href:!0});var Ys=a(ye);Wa=i(Ys,"BertTokenizerFast."),Oo=n(Ys,"STRONG",{});var ol=a(Oo);Ra=i(ol,"call"),ol.forEach(o),Ba=i(Ys,"()"),Ys.forEach(o),Qa=i(io," to prepare text for the model."),io.forEach(o),Ua=p(ro),Do=n(ro,"P",{});var sl=a(Do);Ha=i(sl,"Please refer to the docstring of the above two methods for more information."),sl.forEach(o),ro.forEach(o),Be.forEach(o),Ls=p(t),ne=n(t,"H2",{class:!0});var en=a(ne);$e=n(en,"A",{id:!0,class:!0,href:!0});var nl=a($e);Wo=n(nl,"SPAN",{});var al=a(Wo);w(gt.$$.fragment,al),al.forEach(o),nl.forEach(o),Ka=p(en),Ro=n(en,"SPAN",{});var rl=a(Ro);Ga=i(rl,"ViltModel"),rl.forEach(o),en.forEach(o),Cs=p(t),R=n(t,"DIV",{class:!0});var lo=a(R);w(_t.$$.fragment,lo),Ja=p(lo),vt=n(lo,"P",{});var tn=a(vt);Xa=i(tn,`The bare ViLT Model transformer outputting raw hidden-states without any specific head on top.
...
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),tn.forEach(o),er=p(lo),q=n(lo,"DIV",{class:!0});var Qe=a(q);w(bt.$$.fragment,Qe),tr=p(Qe),ae=n(Qe,"P",{});var co=a(ae);or=i(co,"The "),Jt=n(co,"A",{href:!0});var ll=a(Jt);sr=i(ll,"ViltModel"),ll.forEach(o),nr=i(co," forward method, overrides the "),Qo=n(co,"CODE",{});var dl=a(Qo);ar=i(dl,"__call__"),dl.forEach(o),rr=i(co," special method."),co.forEach(o),ir=p(Qe),w(Ve.$$.fragment,Qe),lr=p(Qe),w(Fe.$$.fragment,Qe),Qe.forEach(o),lo.forEach(o),qs=p(t),re=n(t,"H2",{class:!0});var on=a(re);je=n(on,"A",{id:!0,class:!0,href:!0});var cl=a(je);Uo=n(cl,"SPAN",{});var ml=a(Uo);w(xt.$$.fragment,ml),ml.forEach(o),cl.forEach(o),dr=p(on),Ho=n(on,"SPAN",{});var pl=a(Ho);cr=i(pl,"ViltForMaskedLM"),pl.forEach(o),on.forEach(o),Ns=p(t),z=n(t,"DIV",{class:!0});var Ue=a(z);w(wt.$$.fragment,Ue),mr=p(Ue),Ko=n(Ue,"P",{});var hl=a(Ko);pr=i(hl,"ViLT Model with a language modeling head on top as done during pretraining."),hl.forEach(o),hr=p(Ue),kt=n(Ue,"P",{});var sn=a(kt);fr=i(sn,"This model is a PyTorch "),Go=n(sn,"CODE",{});var fl=a(Go);ur=i(fl,"torch.nn.Module <https://pytorch.org/docs/stable/nn.html#torch.nn.Module>"),fl.forEach(o),gr=i(sn,`_ subclass. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),sn.forEach(o),_r=p(Ue),N=n(Ue,"DIV",{class:!0});var He=a(N);w(Tt.$$.fragment,He),vr=p(He),ie=n(He,"P",{});var mo=a(ie);br=i(mo,"The "),Xt=n(mo,"A",{href:!0});var ul=a(Xt);xr=i(ul,"ViltForMaskedLM"),ul.forEach(o),wr=i(mo," forward method, overrides the "),Jo=n(mo,"CODE",{});var gl=a(Jo);kr=i(gl,"__call__"),gl.forEach(o),Tr=i(mo," special method."),mo.forEach(o),yr=p(He),w(Ee.$$.fragment,He),$r=p(He),w(Me.$$.fragment,He),He.forEach(o),Ue.forEach(o),Ss=p(t),le=n(t,"H2",{class:!0});var nn=a(le);Pe=n(nn,"A",{id:!0,class:!0,href:!0});var _l=a(Pe);Xo=n(_l,"SPAN",{});var vl=a(Xo);w(yt.$$.fragment,vl),vl.forEach(o),_l.forEach(o),Vr=p(nn),Zo=n(nn,"SPAN",{});var bl=a(Zo);Fr=i(bl,"ViltForQuestionAnswering"),bl.forEach(o),nn.forEach(o),Os=p(t),A=n(t,"DIV",{class:!0});var Ke=a(A);w($t.$$.fragment,Ke),jr=p(Ke),Yo=n(Ke,"P",{});var xl=a(Yo);Er=i(xl,`Vilt Model transformer with a classifier head on top (a linear layer on top of the final hidden state of the [CLS]
token) for visual question answering, e.g. for VQAv2.`),xl.forEach(o),Mr=p(Ke),Vt=n(Ke,"P",{});var an=a(Vt);Pr=i(an,"This model is a PyTorch "),es=n(an,"CODE",{});var wl=a(es);Ir=i(wl,"torch.nn.Module <https://pytorch.org/docs/stable/nn.html#torch.nn.Module>"),wl.forEach(o),zr=i(an,`_ subclass. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),an.forEach(o),Ar=p(Ke),S=n(Ke,"DIV",{class:!0});var Ge=a(S);w(Ft.$$.fragment,Ge),Lr=p(Ge),de=n(Ge,"P",{});var po=a(de);Cr=i(po,"The "),Zt=n(po,"A",{href:!0});var kl=a(Zt);qr=i(kl,"ViltForQuestionAnswering"),kl.forEach(o),Nr=i(po," forward method, overrides the "),ts=n(po,"CODE",{});var Tl=a(ts);Sr=i(Tl,"__call__"),Tl.forEach(o),Or=i(po," special method."),po.forEach(o),Dr=p(Ge),w(Ie.$$.fragment,Ge),Wr=p(Ge),w(ze.$$.fragment,Ge),Ge.forEach(o),Ke.forEach(o),Ds=p(t),ce=n(t,"H2",{class:!0});var rn=a(ce);Ae=n(rn,"A",{id:!0,class:!0,href:!0});var yl=a(Ae);os=n(yl,"SPAN",{});var $l=a(os);w(jt.$$.fragment,$l),$l.forEach(o),yl.forEach(o),Rr=p(rn),ss=n(rn,"SPAN",{});var Vl=a(ss);Br=i(Vl,"ViltForImagesAndTextClassification"),Vl.forEach(o),rn.forEach(o),Ws=p(t),B=n(t,"DIV",{class:!0});var ho=a(B);w(Et.$$.fragment,ho),Qr=p(ho),ns=n(ho,"P",{});var Fl=a(ns);Ur=i(Fl,"Vilt Model transformer with a classifier head on top for natural language visual reasoning, e.g. NLVR2."),Fl.forEach(o),Hr=p(ho),O=n(ho,"DIV",{class:!0});var Je=a(O);w(Mt.$$.fragment,Je),Kr=p(Je),me=n(Je,"P",{});var fo=a(me);Gr=i(fo,"The "),Yt=n(fo,"A",{href:!0});var jl=a(Yt);Jr=i(jl,"ViltForImagesAndTextClassification"),jl.forEach(o),Xr=i(fo," forward method, overrides the "),as=n(fo,"CODE",{});var El=a(as);Zr=i(El,"__call__"),El.forEach(o),Yr=i(fo," special method."),fo.forEach(o),ei=p(Je),w(Le.$$.fragment,Je),ti=p(Je),w(Ce.$$.fragment,Je),Je.forEach(o),ho.forEach(o),Rs=p(t),pe=n(t,"H2",{class:!0});var ln=a(pe);qe=n(ln,"A",{id:!0,class:!0,href:!0});var Ml=a(qe);rs=n(Ml,"SPAN",{});var Pl=a(rs);w(Pt.$$.fragment,Pl),Pl.forEach(o),Ml.forEach(o),oi=p(ln),is=n(ln,"SPAN",{});var Il=a(is);si=i(Il,"ViltForImageAndTextRetrieval"),Il.forEach(o),ln.forEach(o),Bs=p(t),L=n(t,"DIV",{class:!0});var Xe=a(L);w(It.$$.fragment,Xe),ni=p(Xe),ls=n(Xe,"P",{});var zl=a(ls);ai=i(zl,`Vilt Model transformer with a classifier head on top (a linear layer on top of the final hidden state of the [CLS]
