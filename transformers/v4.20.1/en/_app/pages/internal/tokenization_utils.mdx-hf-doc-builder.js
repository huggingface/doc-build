import{S as Sm,i as Cm,s as Om,e as r,k as d,w as k,t as o,M as Wm,c as s,d as t,m as l,a,x as b,h as n,b as m,G as e,g as P,y as v,q as T,o as y,B as w,v as jm,L as ks}from"../../chunks/vendor-hf-doc-builder.js";import{T as Pr}from"../../chunks/Tip-hf-doc-builder.js";import{D as q}from"../../chunks/Docstring-hf-doc-builder.js";import{C as bs}from"../../chunks/CodeBlock-hf-doc-builder.js";import{I as gs}from"../../chunks/IconCopyLink-hf-doc-builder.js";import{E as _s}from"../../chunks/ExampleCodeBlock-hf-doc-builder.js";function Rm(E){let p,$,f,h,x;return{c(){p=r("p"),$=o("This method is deprecated, "),f=r("code"),h=o("__call__"),x=o(" should be used instead.")},l(c){p=s(c,"P",{});var g=a(p);$=n(g,"This method is deprecated, "),f=s(g,"CODE",{});var L=a(f);h=n(L,"__call__"),L.forEach(t),x=n(g," should be used instead."),g.forEach(t)},m(c,g){P(c,p,g),e(p,$),e(p,f),e(f,h),e(p,x)},d(c){c&&t(p)}}}function Um(E){let p,$,f,h,x;return{c(){p=r("p"),$=o("This method is deprecated, "),f=r("code"),h=o("__call__"),x=o(" should be used instead.")},l(c){p=s(c,"P",{});var g=a(p);$=n(g,"This method is deprecated, "),f=s(g,"CODE",{});var L=a(f);h=n(L,"__call__"),L.forEach(t),x=n(g," should be used instead."),g.forEach(t)},m(c,g){P(c,p,g),e(p,$),e(p,f),e(f,h),e(p,x)},d(c){c&&t(p)}}}function Mm(E){let p,$,f,h,x;return{c(){p=r("p"),$=o("Passing "),f=r("code"),h=o("use_auth_token=True"),x=o(" is required when you want to use a private model.")},l(c){p=s(c,"P",{});var g=a(p);$=n(g,"Passing "),f=s(g,"CODE",{});var L=a(f);h=n(L,"use_auth_token=True"),L.forEach(t),x=n(g," is required when you want to use a private model."),g.forEach(t)},m(c,g){P(c,p,g),e(p,$),e(p,f),e(f,h),e(p,x)},d(c){c&&t(p)}}}function Vm(E){let p,$,f,h,x;return h=new bs({props:{code:`
...
<span class="hljs-keyword">assert</span> tokenizer.unk_token == <span class="hljs-string">&quot;&lt;unk&gt;&quot;</span>`}}),{c(){p=r("p"),$=o("Examples:"),f=d(),k(h.$$.fragment)},l(c){p=s(c,"P",{});var g=a(p);$=n(g,"Examples:"),g.forEach(t),f=l(c),b(h.$$.fragment,c)},m(c,g){P(c,p,g),e(p,$),P(c,f,g),v(h,c,g),x=!0},p:ks,i(c){x||(T(h.$$.fragment,c),x=!0)},o(c){y(h.$$.fragment,c),x=!1},d(c){c&&t(p),c&&t(f),w(h,c)}}}function Gm(E){let p,$,f,h,x,c,g,L;return{c(){p=r("p"),$=o("If the "),f=r("code"),h=o("encoded_inputs"),x=o(` passed are dictionary of numpy arrays, PyTorch tensors or TensorFlow tensors, the
...
PyTorch tensors, you will lose the specific device of your tensors however.`)},l(ge){p=s(ge,"P",{});var W=a(p);$=n(W,"If the "),f=s(W,"CODE",{});var D=a(f);h=n(D,"encoded_inputs"),D.forEach(t),x=n(W,` passed are dictionary of numpy arrays, PyTorch tensors or TensorFlow tensors, the
...
PyTorch tensors, you will lose the specific device of your tensors however.`),W.forEach(t)},m(ge,W){P(ge,p,W),e(p,$),e(p,f),e(f,h),e(p,x),e(p,c),e(c,g),e(p,L)},d(ge){ge&&t(p)}}}function Hm(E){let p,$,f,h,x;return h=new bs({props:{code:`
...
<span class="hljs-keyword">assert</span> tokenizer.cls_token == <span class="hljs-string">&quot;&lt;CLS&gt;&quot;</span>`}}),{c(){p=r("p"),$=o("Examples:"),f=d(),k(h.$$.fragment)},l(c){p=s(c,"P",{});var g=a(p);$=n(g,"Examples:"),g.forEach(t),f=l(c),b(h.$$.fragment,c)},m(c,g){P(c,p,g),e(p,$),P(c,f,g),v(h,c,g),x=!0},p:ks,i(c){x||(T(h.$$.fragment,c),x=!0)},o(c){y(h.$$.fragment,c),x=!1},d(c){c&&t(p),c&&t(f),w(h,c)}}}function Jm(E){let p,$,f,h,x;return h=new bs({props:{code:"",highlighted:`<span class="hljs-comment"># Let&#x27;s see how to increase the vocabulary of Bert model and tokenizer</span>
...
<span class="hljs-built_in">print</span>(<span class="hljs-string">&quot;We have added&quot;</span>, num_added_toks, <span class="hljs-string">&quot;tokens&quot;</span>)
<span class="hljs-comment"># Notice: resize_token_embeddings expect to receive the full size of the new vocabulary, i.e., the length of the tokenizer.</span>
model.resize_token_embeddings(<span class="hljs-built_in">len</span>(tokenizer))`}}),{c(){p=r("p"),$=o("Examples:"),f=d(),k(h.$$.fragment)},l(c){p=s(c,"P",{});var g=a(p);$=n(g,"Examples:"),g.forEach(t),f=l(c),b(h.$$.fragment,c)},m(c,g){P(c,p,g),e(p,$),P(c,f,g),v(h,c,g),x=!0},p:ks,i(c){x||(T(h.$$.fragment,c),x=!0)},o(c){y(h.$$.fragment,c),x=!1},d(c){c&&t(p),c&&t(f),w(h,c)}}}function Km(E){let p,$,f,h,x,c,g,L,ge,W,D,no,ro,vs,Ts,so,ys,ws,ao,zs,xs,io,$s,Ps,qr,lo,qs,Er,_e,Le,So,st,Es,Co,Bs,Br,u,at,Ls,ke,Ds,co,Is,Ns,po,As,Fs,Ss,Oo,Cs,Os,Wo,Ws,js,I,Z,jo,Rs,Us,Ro,Ms,Vs,Uo,Gs,Hs,Xs,F,Mo,Ys,Js,Vo,Ks,Qs,Go,Zs,ea,Ho,ta,oa,Xo,na,ra,sa,M,Yo,aa,ia,Jo,da,la,Ko,ca,pa,Qo,ma,ha,ua,S,Zo,fa,ga,en,_a,ka,tn,ba,va,on,Ta,ya,mo,wa,za,xa,De,nn,$a,Pa,rn,qa,Ea,Ba,V,sn,La,Da,an,Ia,Na,dn,Aa,Fa,ln,Sa,Ca,Oa,G,cn,Wa,ja,pn,Ra,Ua,mn,Ma,Va,hn,Ga,Ha,Xa,Ie,it,Ya,un,Ja,Ka,Ne,dt,Qa,fn,Za,ei,Ae,lt,ti,gn,oi,ni,ee,ct,ri,_n,si,ai,Fe,ii,te,pt,di,kn,li,ci,bn,pi,mi,Se,mt,hi,vn,ui,fi,Ce,ht,gi,ut,_i,Tn,ki,bi,vi,oe,ft,Ti,ho,yi,uo,wi,zi,yn,xi,$i,ne,gt,Pi,wn,qi,Ei,_t,Bi,zn,Li,Di,Ii,re,kt,Ni,xn,Ai,Fi,bt,Si,$n,Ci,Oi,Wi,se,vt,ji,Pn,Ri,Ui,Oe,Mi,H,Tt,Vi,yt,Gi,fo,Hi,Xi,Yi,We,Ji,je,Ki,Re,wt,Qi,be,Zi,qn,ed,td,En,od,nd,rd,ae,zt,sd,Bn,ad,id,ie,Ln,dd,ld,Dn,cd,pd,In,md,hd,ud,X,xt,fd,Nn,gd,_d,J,kd,An,bd,vd,Fn,Td,yd,Sn,wd,zd,xd,Ue,$d,Me,$t,Pd,j,qd,Cn,Ed,Bd,On,Ld,Dd,Wn,Id,Nd,jn,Ad,Fd,Sd,Ve,Pt,Cd,Rn,Od,Wd,de,qt,jd,Et,Rd,Un,Ud,Md,Vd,Ge,Gd,le,Bt,Hd,Lt,Xd,Mn,Yd,Jd,Kd,He,Qd,Y,Dt,Zd,Vn,el,tl,It,ol,Gn,nl,rl,sl,Nt,al,Hn,il,dl,ll,ce,At,cl,Xn,pl,ml,Ft,hl,Yn,ul,fl,gl,Xe,St,_l,Ct,kl,Jn,bl,vl,Tl,Ye,Ot,yl,Kn,wl,Lr,ve,Je,Qn,Wt,zl,Zn,xl,Dr,A,jt,$l,Te,Pl,go,ql,El,_o,Bl,Ll,Dl,B,Rt,Il,er,Nl,Al,tr,Fl,Sl,Ut,Cl,ko,Ol,Wl,jl,Mt,Rl,or,Ul,Ml,Vl,Vt,nr,Gl,Hl,Gt,Xl,rr,Yl,Jl,Kl,R,Ql,bo,Zl,ec,sr,tc,oc,ar,nc,rc,ir,sc,ac,ic,Ke,dc,C,Ht,lc,dr,cc,pc,lr,mc,hc,Xt,uc,vo,fc,gc,_c,Qe,kc,pe,Yt,bc,ye,vc,cr,Tc,yc,pr,wc,zc,xc,mr,$c,Ir,we,Ze,hr,Jt,Pc,ur,qc,Nr,ze,Kt,Ec,xe,Bc,fr,Lc,Dc,et,Ic,gr,Nc,Ac,Fc,Ar,$e,Qt,Sc,_r,Cc,Fr,Pe,Zt,Oc,kr,Wc,Sr;return c=new gs({}),st=new gs({}),at=new q({props:{name:"class transformers.PreTrainedTokenizerBase",anchor:"transformers.PreTrainedTokenizerBase",parameters:[{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.PreTrainedTokenizerBase.model_max_length",description:`<strong>model_max_length</strong> (<code>int</code>, <em>optional</em>) &#x2014;
The maximum length (in number of tokens) for the inputs to the transformer model. When the tokenizer is
loaded with <a href="/docs/transformers/v4.20.1/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.from_pretrained">from_pretrained()</a>, this will be set to the
...
lengths).</li>
</ul>`,name:"padding"},{anchor:"transformers.PreTrainedTokenizerBase.__call__.truncation",description:`<strong>truncation</strong> (<code>bool</code>, <code>str</code> or <a href="/docs/transformers/v4.20.1/en/internal/tokenization_utils#transformers.tokenization_utils_base.TruncationStrategy">TruncationStrategy</a>, <em>optional</em>, defaults to <code>False</code>) &#x2014;
...
<p>This is only available on fast tokenizers inheriting from <a href="/docs/transformers/v4.20.1/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast">PreTrainedTokenizerFast</a>, if using
...
**kwargs &#x2014; passed to the <code>self.tokenize()</code> method`,name:"verbose"}],source:"https://github.com/huggingface/transformers/blob/v4.20.1/src/transformers/tokenization_utils_base.py#L2409",returnDescription:`
<p>A <a
  href="/docs/transformers/v4.20.1/en/main_classes/tokenizer#transformers.BatchEncoding"
...
Whether or not to print more information and warnings.
**kwargs &#x2014; passed to the <code>self.tokenize()</code> method`,name:"verbose"}],source:"https://github.com/huggingface/transformers/blob/v4.20.1/src/transformers/tokenization_utils_base.py#L2632",returnDescription:`
<p>A <a
  href="/docs/transformers/v4.20.1/en/main_classes/tokenizer#transformers.BatchEncoding"
>BatchEncoding</a> with the following fields:</p>
<ul>
...
<p>**kwargs &#x2014; Passed along to the <code>.tokenize()</code> method.`,name:"return_tensors"}],source:"https://github.com/huggingface/transformers/blob/v4.20.1/src/transformers/tokenization_utils_base.py#L2219",returnDescription:`
...
Whether or not to print more information and warnings.
**kwargs &#x2014; passed to the <code>self.tokenize()</code> method`,name:"verbose"}],source:"https://github.com/huggingface/transformers/blob/v4.20.1/src/transformers/tokenization_utils_base.py#L2536",returnDescription:`
<p>A <a
  href="/docs/transformers/v4.20.1/en/main_classes/tokenizer#transformers.BatchEncoding"
>BatchEncoding</a> with the following fields:</p>
<ul>
...
using the <a href="/docs/transformers/v4.20.1/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.save_pretrained">save_pretrained()</a> method, e.g.,
...
Whether or not the token list is already formatted with special tokens for the model.`,name:"already_has_special_tokens"}],source:"https://github.com/huggingface/transformers/blob/v4.20.1/src/transformers/tokenization_utils_base.py#L3361",returnDescription:`
<p>1 for a special token, 0 for a sequence token.</p>
`,returnType:`
<p>A list of integers in the range [0, 1]</p>
`}}),zt=new q({props:{name:"get_vocab",anchor:"transformers.PreTrainedTokenizerBase.get_vocab",parameters:[],source:"https://github.com/huggingface/transformers/blob/v4.20.1/src/transformers/tokenization_utils_base.py#L1537",returnDescription:`
<p>The vocabulary.</p>
`,returnType:`
<p><code>Dict[str, int]</code></p>
`}}),xt=new q({props:{name:"pad",anchor:"transformers.PreTrainedTokenizerBase.pad",parameters:[{name:"encoded_inputs",val:": typing.Union[transformers.tokenization_utils_base.BatchEncoding, typing.List[transformers.tokenization_utils_base.BatchEncoding], typing.Dict[str, typing.List[int]], typing.Dict[str, typing.List[typing.List[int]]], typing.List[typing.Dict[str, typing.List[int]]]]"},{name:"padding",val:": typing.Union[bool, str, transformers.utils.generic.PaddingStrategy] = True"},{name:"max_length",val:": typing.Optional[int] = None"},{name:"pad_to_multiple_of",val:": typing.Optional[int] = None"},{name:"return_attention_mask",val:": typing.Optional[bool] = None"},{name:"return_tensors",val:": typing.Union[str, transformers.utils.generic.TensorType, NoneType] = None"},{name:"verbose",val:": bool = True"}],parametersDescription:[{anchor:"transformers.PreTrainedTokenizerBase.pad.encoded_inputs",description:`<strong>encoded_inputs</strong> (<a href="/docs/transformers/v4.20.1/en/main_classes/tokenizer#transformers.BatchEncoding">BatchEncoding</a>, list of <a href="/docs/transformers/v4.20.1/en/main_classes/tokenizer#transformers.BatchEncoding">BatchEncoding</a>, <code>Dict[str, List[int]]</code>, <code>Dict[str, List[List[int]]</code> or <code>List[Dict[str, List[int]]]</code>) &#x2014;
Tokenized inputs. Can represent one input (<a href="/docs/transformers/v4.20.1/en/main_classes/tokenizer#transformers.BatchEncoding">BatchEncoding</a> or <code>Dict[str, List[int]]</code>) or a batch of
tokenized inputs (list of <a href="/docs/transformers/v4.20.1/en/main_classes/tokenizer#transformers.BatchEncoding">BatchEncoding</a>, <em>Dict[str, List[List[int]]]</em> or <em>List[Dict[str,
...
the note above for the return type.`,name:"encoded_inputs"},{anchor:"transformers.PreTrainedTokenizerBase.pad.padding",description:`<strong>padding</strong> (<code>bool</code>, <code>str</code> or <a href="/docs/transformers/v4.20.1/en/internal/file_utils#transformers.utils.PaddingStrategy">PaddingStrategy</a>, <em>optional</em>, defaults to <code>True</code>) &#x2014;
...
Whether or not to print more information and warnings.
**kwargs &#x2014; passed to the <code>self.tokenize()</code> method`,name:"verbose"}],source:"https://github.com/huggingface/transformers/blob/v4.20.1/src/transformers/tokenization_utils_base.py#L2936",returnDescription:`
<p>A <a
  href="/docs/transformers/v4.20.1/en/main_classes/tokenizer#transformers.BatchEncoding"
>BatchEncoding</a> with the following fields:</p>
<ul>
...
<li><code>False</code> or <code>&apos;do_not_pad&apos;</code> (default): No padding (i.e., can output a batch with sequences of different
lengths).</li>
</ul>`,name:"padding"},{anchor:"transformers.PreTrainedTokenizerBase.prepare_seq2seq_batch.return_tensors",description:`<strong>return_tensors</strong> (<code>str</code> or <a href="/docs/transformers/v4.20.1/en/internal/file_utils#transformers.TensorType">TensorType</a>, <em>optional</em>) &#x2014;
If set, will return tensors instead of list of python integers. Acceptable values are:</p>
<ul>
<li><code>&apos;tf&apos;</code>: Return TensorFlow <code>tf.constant</code> objects.</li>
<li><code>&apos;pt&apos;</code>: Return PyTorch <code>torch.Tensor</code> objects.</li>
<li><code>&apos;np&apos;</code>: Return Numpy <code>np.ndarray</code> objects.</li>
</ul>`,name:"return_tensors"},{anchor:"transformers.PreTrainedTokenizerBase.prepare_seq2seq_batch.truncation",description:`<strong>truncation</strong> (<code>bool</code>, <code>str</code> or <a href="/docs/transformers/v4.20.1/en/internal/tokenization_utils#transformers.tokenization_utils_base.TruncationStrategy">TruncationStrategy</a>, <em>optional</em>, defaults to <code>True</code>) &#x2014;
Activates and controls truncation. Accepts the following values:</p>
<ul>
<li><code>True</code> or <code>&apos;longest_first&apos;</code>: Truncate to a maximum length specified with the argument <code>max_length</code> or
to the maximum acceptable input length for the model if that argument is not provided. This will
...
</ul>`,name:"truncation"}],source:"https://github.com/huggingface/transformers/blob/v4.20.1/src/transformers/tokenization_utils_base.py#L3471",returnDescription:`
<p>A <a
  href="/docs/transformers/v4.20.1/en/main_classes/tokenizer#transformers.BatchEncoding"
>BatchEncoding</a> with the following fields:</p>
<ul>
...
<code>repo_url</code> is not specified.`,name:"use_auth_token"}],source:"https://github.com/huggingface/transformers/blob/v4.20.1/src/transformers/utils/hub.py#L855",returnDescription:`
...
folder. Pass along <code>temp_dir=True</code> to use a temporary directory instead.</p>
					...
					</div>`,name:"push_to_hub"}],source:"https://github.com/huggingface/transformers/blob/v4.20.1/src/transformers/tokenization_utils_base.py#L2018",returnDescription:`
<p>The files saved.</p>
`,returnType:`
...
An optional prefix to add to the named of the saved files.`,name:"filename_prefix"}],source:"https://github.com/huggingface/transformers/blob/v4.20.1/src/transformers/tokenization_utils_base.py#L2181",returnDescription:`
...
<a href="/docs/transformers/v4.20.1/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.__call__"><strong>call</strong>()</a>`,name:"kwargs"}],source:"https://github.com/huggingface/transformers/blob/v4.20.1/src/transformers/tokenization_utils_base.py#L2199",returnDescription:`
...
sequence returned. The value of this argument defines the number of additional tokens.`,name:"stride"}],source:"https://github.com/huggingface/transformers/blob/v4.20.1/src/transformers/tokenization_utils_base.py#L3072",returnDescription:`
...
or `),Qo=r("code"),ma=o("None"),ha=o(" if the model has no maximum input size."),ua=d(),S=r("li"),Zo=r("strong"),fa=o("pretrained_init_configuration"),ga=o(" ("),en=r("code"),_a=o("Dict[str, Dict[str, Any]]"),ka=o(`) \u2014 A dictionary with, as keys, the
...
adding special tokens.`),ci=d(),bn=r("p"),pi=o("This implementation does not add special tokens and this method should be overridden in a subclass."),mi=d(),Se=r("div"),k(mt.$$.fragment),hi=d(),vn=r("p"),ui=o("Clean up a list of simple English tokenization artifacts like spaces before punctuations and abbreviated forms."),fi=d(),Ce=r("div"),k(ht.$$.fragment),gi=d(),ut=r("p"),_i=o("Converts a sequence of tokens in a single string. The most simple way to do it is "),Tn=r("code"),ki=o('" ".join(tokens)'),bi=o(` but we
...
matrix of the model so that its embedding matrix matches the tokenizer.`),hc=d(),Xt=r("p"),uc=o("In order to do that, please use the "),vo=r("a"),fc=o("resize_token_embeddings()"),gc=o(" method."),_c=d(),k(Qe.$$.fragment),kc=d(),pe=r("div"),k(Yt.$$.fragment),bc=d(),ye=r("p"),vc=o("Make sure that all the special tokens attributes of the tokenizer ("),cr=r("code"),Tc=o("tokenizer.mask_token"),yc=o(`,
`),pr=r("code"),wc=o("tokenizer.cls_token"),zc=o(", etc.) are in the vocabulary."),xc=d(),mr=r("p"),$c=o("Add the missing ones to the vocabulary if needed."),Ir=d(),we=r("h2"),Ze=r("a"),hr=r("span"),k(Jt.$$.fragment),Pc=d(),ur=r("span"),qc=o("Enums and namedtuples"),Nr=d(),ze=r("div"),k(Kt.$$.fragment),Ec=d(),xe=r("p"),Bc=o("Possible values for the "),fr=r("code"),Lc=o("truncation"),Dc=o(" argument in "),et=r("a"),Ic=o("PreTrainedTokenizerBase."),gr=r("strong"),Nc=o("call"),Ac=o("()"),Fc=o(`. Useful for tab-completion in
...
`),io=s(U,"A",{href:!0});var xr=a(io);$s=n(xr,"SpecialTokensMixin"),xr.forEach(t),Ps=n(U,"."),U.forEach(t),qr=l(i),lo=s(i,"P",{});var Rc=a(lo);qs=n(Rc,"Most of those are only useful if you are studying the code of the tokenizers in the library."),Rc.forEach(t),Er=l(i),_e=s(i,"H2",{class:!0});var Cr=a(_e);Le=s(Cr,"A",{id:!0,class:!0,href:!0});var Uc=a(Le);So=s(Uc,"SPAN",{});var Mc=a(So);b(st.$$.fragment,Mc),Mc.forEach(t),Uc.forEach(t),Es=l(Cr),Co=s(Cr,"SPAN",{});var Vc=a(Co);Bs=n(Vc,"PreTrainedTokenizerBase"),Vc.forEach(t),Cr.forEach(t),Br=l(i),u=s(i,"DIV",{class:!0});var _=a(u);b(at.$$.fragment,_),Ls=l(_),ke=s(_,"P",{});var To=a(ke);Ds=n(To,"Base class for "),co=s(To,"A",{href:!0});var Gc=a(co);Is=n(Gc,"PreTrainedTokenizer"),Gc.forEach(t),Ns=n(To," and "),po=s(To,"A",{href:!0});var Hc=a(po);As=n(Hc,"PreTrainedTokenizerFast"),Hc.forEach(t),Fs=n(To,"."),To.forEach(t),Ss=l(_),Oo=s(_,"P",{});var Xc=a(Oo);Cs=n(Xc,"Handles shared (mostly boiler plate) methods for those two classes."),Xc.forEach(t),Os=l(_),Wo=s(_,"P",{});var Yc=a(Wo);Ws=n(Yc,"Class attributes (overridden by derived classes)"),Yc.forEach(t),js=l(_),I=s(_,"UL",{});var O=a(I);Z=s(O,"LI",{});var to=a(Z);jo=s(to,"STRONG",{});var Jc=a(jo);Rs=n(Jc,"vocab_files_names"),Jc.forEach(t),Us=n(to," ("),Ro=s(to,"CODE",{});var Kc=a(Ro);Ms=n(Kc,"Dict[str, str]"),Kc.forEach(t),Vs=n(to,") \u2014 A dictionary with, as keys, the "),Uo=s(to,"CODE",{});var Qc=a(Uo);Gs=n(Qc,"__init__"),Qc.forEach(t),Hs=n(to,` keyword name of each
vocabulary file required by the model, and as associated values, the filename for saving the associated file
...
of the pretrained models, and as associated values, the maximum length of the sequence inputs of this model,
or `),Qo=s(qe,"CODE",{});var ip=a(Qo);ma=n(ip,"None"),ip.forEach(t),ha=n(qe," if the model has no maximum input size."),qe.forEach(t),ua=l(O),S=s(O,"LI",{});var Q=a(S);Zo=s(Q,"STRONG",{});var dp=a(Zo);fa=n(dp,"pretrained_init_configuration"),dp.forEach(t),ga=n(Q," ("),en=s(Q,"CODE",{});var lp=a(en);_a=n(lp,"Dict[str, Dict[str, Any]]"),lp.forEach(t),ka=n(Q,`) \u2014 A dictionary with, as keys, the
...
applied. Should be `),mn=s(Be,"CODE",{});var Tp=a(mn);Ma=n(Tp,"'right'"),Tp.forEach(t),Va=n(Be," or "),hn=s(Be,"CODE",{});var yp=a(hn);Ga=n(yp,"'left'"),yp.forEach(t),Ha=n(Be,"."),Be.forEach(t),O.forEach(t),Xa=l(_),Ie=s(_,"DIV",{class:!0});var Or=a(Ie);b(it.$$.fragment,Or),Ya=l(Or),un=s(Or,"P",{});var wp=a(un);Ja=n(wp,`Main method to tokenize and prepare for the model one or several sequence(s) or one or several pair(s) of
sequences.`),wp.forEach(t),Or.forEach(t),Ka=l(_),Ne=s(_,"DIV",{class:!0});var Wr=a(Ne);b(dt.$$.fragment,Wr),Qa=l(Wr),fn=s(Wr,"P",{});var zp=a(fn);Za=n(zp,`Temporarily sets the tokenizer for encoding the targets. Useful for tokenizer associated to
sequence-to-sequence models that need a slightly different processing for the labels.`),zp.forEach(t),Wr.forEach(t),ei=l(_),Ae=s(_,"DIV",{class:!0});var jr=a(Ae);b(lt.$$.fragment,jr),ti=l(jr),gn=s(jr,"P",{});var xp=a(gn);oi=n(xp,"Convert a list of lists of token ids into a list of strings by calling decode."),xp.forEach(t),jr.forEach(t),ni=l(_),ee=s(_,"DIV",{class:!0});var yo=a(ee);b(ct.$$.fragment,yo),ri=l(yo),_n=s(yo,"P",{});var $p=a(_n);si=n($p,"Tokenize and prepare for the model a list of sequences or a list of pairs of sequences."),$p.forEach(t),ai=l(yo),b(Fe.$$.fragment,yo),yo.forEach(t),ii=l(_),te=s(_,"DIV",{class:!0});var wo=a(te);b(pt.$$.fragment,wo),di=l(wo),kn=s(wo,"P",{});var Pp=a(kn);li=n(Pp,`Build model inputs from a sequence or a pair of sequence for sequence classification tasks by concatenating and
adding special tokens.`),Pp.forEach(t),ci=l(wo),bn=s(wo,"P",{});var qp=a(bn);pi=n(qp,"This implementation does not add special tokens and this method should be overridden in a subclass."),qp.forEach(t),wo.forEach(t),mi=l(_),Se=s(_,"DIV",{class:!0});var Rr=a(Se);b(mt.$$.fragment,Rr),hi=l(Rr),vn=s(Rr,"P",{});var Ep=a(vn);ui=n(Ep,"Clean up a list of simple English tokenization artifacts like spaces before punctuations and abbreviated forms."),Ep.forEach(t),Rr.forEach(t),fi=l(_),Ce=s(_,"DIV",{class:!0});var Ur=a(Ce);b(ht.$$.fragment,Ur),gi=l(Ur),ut=s(Ur,"P",{});var Mr=a(ut);_i=n(Mr,"Converts a sequence of tokens in a single string. The most simple way to do it is "),Tn=s(Mr,"CODE",{});var Bp=a(Tn);ki=n(Bp,'" ".join(tokens)'),Bp.forEach(t),bi=n(Mr,` but we
often want to remove sub-word tokenization artifacts at the same time.`),Mr.forEach(t),Ur.forEach(t),vi=l(_),oe=s(_,"DIV",{class:!0});var zo=a(oe);b(ft.$$.fragment,zo),Ti=l(zo),ho=s(zo,"P",{});var jc=a(ho);yi=n(jc,"Create the token type IDs corresponding to the sequences passed. "),uo=s(jc,"A",{href:!0});var Lp=a(uo);wi=n(Lp,`What are token type
IDs?`),Lp.forEach(t),jc.forEach(t),zi=l(zo),yn=s(zo,"P",{});var Dp=a(yn);xi=n(Dp,"Should be overridden in a subclass if the model has a special way of building those."),Dp.forEach(t),zo.forEach(t),$i=l(_),ne=s(_,"DIV",{class:!0});var xo=a(ne);b(gt.$$.fragment,xo),Pi=l(xo),wn=s(xo,"P",{});var Ip=a(wn);qi=n(Ip,`Converts a sequence of ids in a string, using the tokenizer and vocabulary with options to remove special
tokens and clean up tokenization spaces.`),Ip.forEach(t),Ei=l(xo),_t=s(xo,"P",{});var Vr=a(_t);Bi=n(Vr,"Similar to doing "),zn=s(Vr,"CODE",{});var Np=a(zn);Li=n(Np,"self.convert_tokens_to_string(self.convert_ids_to_tokens(token_ids))"),Np.forEach(t),Di=n(Vr,"."),Vr.forEach(t),xo.forEach(t),Ii=l(_),re=s(_,"DIV",{class:!0});var $o=a(re);b(kt.$$.fragment,$o),Ni=l($o),xn=s($o,"P",{});var Ap=a(xn);Ai=n(Ap,"Converts a string to a sequence of ids (integer), using the tokenizer and vocabulary."),Ap.forEach(t),Fi=l($o),bt=s($o,"P",{});var Gr=a(bt);Si=n(Gr,"Same as doing "),$n=s(Gr,"CODE",{});var Fp=a($n);Ci=n(Fp,"self.convert_tokens_to_ids(self.tokenize(text))"),Fp.forEach(t),Oi=n(Gr,"."),Gr.forEach(t),$o.forEach(t),Wi=l(_),se=s(_,"DIV",{class:!0});var Po=a(se);b(vt.$$.fragment,Po),ji=l(Po),Pn=s(Po,"P",{});var Sp=a(Pn);Ri=n(Sp,"Tokenize and prepare for the model a sequence or a pair of sequences."),Sp.forEach(t),Ui=l(Po),b(Oe.$$.fragment,Po),Po.forEach(t),Mi=l(_),H=s(_,"DIV",{class:!0});var tt=a(H);b(Tt.$$.fragment,tt),Vi=l(tt),yt=s(tt,"P",{});var Hr=a(yt);Gi=n(Hr,"Instantiate a "),fo=s(Hr,"A",{href:!0});var Cp=a(fo);Hi=n(Cp,"PreTrainedTokenizerBase"),Cp.forEach(t),Xi=n(Hr,` (or a derived class) from a predefined
tokenizer.`),Hr.forEach(t),Yi=l(tt),b(We.$$.fragment,tt),Ji=l(tt),b(je.$$.fragment,tt),tt.forEach(t),Ki=l(_),Re=s(_,"DIV",{class:!0});var Xr=a(Re);b(wt.$$.fragment,Xr),Qi=l(Xr),be=s(Xr,"P",{});var qo=a(be);Zi=n(qo,`Retrieves sequence ids from a token list that has no special tokens added. This method is called when adding
special tokens using the tokenizer `),qn=s(qo,"CODE",{});var Op=a(qn);ed=n(Op,"prepare_for_model"),Op.forEach(t),td=n(qo," or "),En=s(qo,"CODE",{});var Wp=a(En);od=n(Wp,"encode_plus"),Wp.forEach(t),nd=n(qo," methods."),qo.forEach(t),Xr.forEach(t),rd=l(_),ae=s(_,"DIV",{class:!0});var Eo=a(ae);b(zt.$$.fragment,Eo),sd=l(Eo),Bn=s(Eo,"P",{});var jp=a(Bn);ad=n(jp,"Returns the vocabulary as a dictionary of token to index."),jp.forEach(t),id=l(Eo),ie=s(Eo,"P",{});var oo=a(ie);Ln=s(oo,"CODE",{});var Rp=a(Ln);dd=n(Rp,"tokenizer.get_vocab()[token]"),Rp.forEach(t),ld=n(oo," is equivalent to "),Dn=s(oo,"CODE",{});var Up=a(Dn);cd=n(Up,"tokenizer.convert_tokens_to_ids(token)"),Up.forEach(t),pd=n(oo," when "),In=s(oo,"CODE",{});var Mp=a(In);md=n(Mp,"token"),Mp.forEach(t),hd=n(oo,` is in the
...
instance, modifying `),Hn=s(es,"CODE",{});var rm=a(Hn);il=n(rm,"tokenizer.do_lower_case"),rm.forEach(t),dl=n(es," after creation)."),es.forEach(t),rt.forEach(t),ll=l(_),ce=s(_,"DIV",{class:!0});var Do=a(ce);b(At.$$.fragment,Do),cl=l(Do),Xn=s(Do,"P",{});var sm=a(Xn);pl=n(sm,"Save only the vocabulary of the tokenizer (vocabulary + added tokens)."),sm.forEach(t),ml=l(Do),Ft=s(Do,"P",{});var ts=a(Ft);hl=n(ts,`This method won\u2019t save the configuration and special token mappings of the tokenizer. Use
`),Yn=s(ts,"CODE",{});var am=a(Yn);ul=n(am,"_save_pretrained()"),am.forEach(t),fl=n(ts," to save the whole state of the tokenizer."),ts.forEach(t),Do.forEach(t),gl=l(_),Xe=s(_,"DIV",{class:!0});var os=a(Xe);b(St.$$.fragment,os),_l=l(os),Ct=s(os,"P",{});var ns=a(Ct);kl=n(ns,"Converts a string in a sequence of tokens, replacing unknown tokens with the "),Jn=s(ns,"CODE",{});var im=a(Jn);bl=n(im,"unk_token"),im.forEach(t),vl=n(ns,"."),ns.forEach(t),os.forEach(t),Tl=l(_),Ye=s(_,"DIV",{class:!0});var rs=a(Ye);b(Ot.$$.fragment,rs),yl=l(rs),Kn=s(rs,"P",{});var dm=a(Kn);wl=n(dm,"Truncates a sequence pair in-place following the strategy."),dm.forEach(t),rs.forEach(t),_.forEach(t),Lr=l(i),ve=s(i,"H2",{class:!0});var ss=a(ve);Je=s(ss,"A",{id:!0,class:!0,href:!0});var lm=a(Je);Qn=s(lm,"SPAN",{});var cm=a(Qn);b(Wt.$$.fragment,cm),cm.forEach(t),lm.forEach(t),zl=l(ss),Zn=s(ss,"SPAN",{});var pm=a(Zn);xl=n(pm,"SpecialTokensMixin"),pm.forEach(t),ss.forEach(t),Dr=l(i),A=s(i,"DIV",{class:!0});var he=a(A);b(jt.$$.fragment,he),$l=l(he),Te=s(he,"P",{});var Io=a(Te);Pl=n(Io,"A mixin derived by "),go=s(Io,"A",{href:!0});var mm=a(go);ql=n(mm,"PreTrainedTokenizer"),mm.forEach(t),El=n(Io," and "),_o=s(Io,"A",{href:!0});var hm=a(_o);Bl=n(hm,"PreTrainedTokenizerFast"),hm.forEach(t),Ll=n(Io,` to handle specific behaviors related to
special tokens. In particular, this class hold the attributes which can be used to directly access these special
