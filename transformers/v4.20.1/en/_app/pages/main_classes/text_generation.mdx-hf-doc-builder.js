...
should be prefixed with *decoder</em>*.`,name:"exponential_decay_length_penalty"}],source:"https://github.com/huggingface/transformers/blob/v4.20.1/src/transformers/generation_utils.py#L844",returnDescription:`
<p>A <a
  href="/docs/transformers/v4.20.1/en/main_classes/output#transformers.utils.ModelOutput"
...
<ul>
<li><a
  href="/docs/transformers/v4.20.1/en/internal/generation_utils#transformers.generation_utils.GreedySearchDecoderOnlyOutput"
>GreedySearchDecoderOnlyOutput</a>,</li>
<li><a
  href="/docs/transformers/v4.20.1/en/internal/generation_utils#transformers.generation_utils.SampleDecoderOnlyOutput"
>SampleDecoderOnlyOutput</a>,</li>
<li><a
  href="/docs/transformers/v4.20.1/en/internal/generation_utils#transformers.generation_utils.BeamSearchDecoderOnlyOutput"
>BeamSearchDecoderOnlyOutput</a>,</li>
<li><a
  href="/docs/transformers/v4.20.1/en/internal/generation_utils#transformers.generation_utils.BeamSampleDecoderOnlyOutput"
...
<ul>
<li><a
  href="/docs/transformers/v4.20.1/en/internal/generation_utils#transformers.generation_utils.GreedySearchEncoderDecoderOutput"
>GreedySearchEncoderDecoderOutput</a>,</li>
<li><a
  href="/docs/transformers/v4.20.1/en/internal/generation_utils#transformers.generation_utils.SampleEncoderDecoderOutput"
>SampleEncoderDecoderOutput</a>,</li>
<li><a
  href="/docs/transformers/v4.20.1/en/internal/generation_utils#transformers.generation_utils.BeamSearchEncoderDecoderOutput"
>BeamSearchEncoderDecoderOutput</a>,</li>
<li><a
  href="/docs/transformers/v4.20.1/en/internal/generation_utils#transformers.generation_utils.BeamSampleEncoderDecoderOutput"
...
An instance of <a href="/docs/transformers/v4.20.1/en/internal/generation_utils#transformers.LogitsProcessorList">LogitsProcessorList</a>. List of instances of class derived from <a href="/docs/transformers/v4.20.1/en/internal/generation_utils#transformers.LogitsProcessor">LogitsProcessor</a>
...
An instance of <a href="/docs/transformers/v4.20.1/en/internal/generation_utils#transformers.StoppingCriteriaList">StoppingCriteriaList</a>. List of instances of class derived from <a href="/docs/transformers/v4.20.1/en/internal/generation_utils#transformers.StoppingCriteria">StoppingCriteria</a>
...
If model is an encoder-decoder model the kwargs should include <code>encoder_outputs</code>.`,name:"synced_gpus"}],source:"https://github.com/huggingface/transformers/blob/v4.20.1/src/transformers/generation_utils.py#L1532",returnDescription:`
<p><a
  href="/docs/transformers/v4.20.1/en/internal/generation_utils#transformers.generation_utils.GreedySearchDecoderOnlyOutput"
...
An instance of <a href="/docs/transformers/v4.20.1/en/internal/generation_utils#transformers.LogitsProcessorList">LogitsProcessorList</a>. List of instances of class derived from <a href="/docs/transformers/v4.20.1/en/internal/generation_utils#transformers.LogitsWarper">LogitsWarper</a> used
...
an encoder-decoder model the kwargs should include <code>encoder_outputs</code>.`,name:"synced_gpus"}],source:"https://github.com/huggingface/transformers/blob/v4.20.1/src/transformers/generation_utils.py#L1765",returnDescription:`
<p><a
  href="/docs/transformers/v4.20.1/en/internal/generation_utils#transformers.generation_utils.SampleDecoderOnlyOutput"
...
An derived instance of <a href="/docs/transformers/v4.20.1/en/internal/generation_utils#transformers.BeamScorer">BeamScorer</a> that defines how beam hypotheses are constructed, stored and
sorted during generation. For more information, the documentation of <a href="/docs/transformers/v4.20.1/en/internal/generation_utils#transformers.BeamScorer">BeamScorer</a> should be read.`,name:"beam_scorer"},{anchor:"transformers.generation_utils.GenerationMixin.beam_search.logits_processor",description:`<strong>logits_processor</strong> (<code>LogitsProcessorList</code>, <em>optional</em>) &#x2014;
An instance of <a href="/docs/transformers/v4.20.1/en/internal/generation_utils#transformers.LogitsProcessorList">LogitsProcessorList</a>. List of instances of class derived from <a href="/docs/transformers/v4.20.1/en/internal/generation_utils#transformers.LogitsProcessor">LogitsProcessor</a>
...
model_kwargs &#x2014;
Additional model specific kwargs will be forwarded to the <code>forward</code> function of the model. If model is
an encoder-decoder model the kwargs should include <code>encoder_outputs</code>.`,name:"synced_gpus"}],source:"https://github.com/huggingface/transformers/blob/v4.20.1/src/transformers/generation_utils.py#L2022",returnDescription:`
...
A derived instance of <a href="/docs/transformers/v4.20.1/en/internal/generation_utils#transformers.BeamScorer">BeamScorer</a> that defines how beam hypotheses are constructed, stored and
sorted during generation. For more information, the documentation of <a href="/docs/transformers/v4.20.1/en/internal/generation_utils#transformers.BeamScorer">BeamScorer</a> should be read.`,name:"beam_scorer"},{anchor:"transformers.generation_utils.GenerationMixin.beam_sample.logits_processor",description:`<strong>logits_processor</strong> (<code>LogitsProcessorList</code>, <em>optional</em>) &#x2014;
An instance of <a href="/docs/transformers/v4.20.1/en/internal/generation_utils#transformers.LogitsProcessorList">LogitsProcessorList</a>. List of instances of class derived from <a href="/docs/transformers/v4.20.1/en/internal/generation_utils#transformers.LogitsProcessor">LogitsProcessor</a>
...
model_kwargs &#x2014;
Additional model specific kwargs will be forwarded to the <code>forward</code> function of the model. If model is
an encoder-decoder model the kwargs should include <code>encoder_outputs</code>.`,name:"synced_gpus"}],source:"https://github.com/huggingface/transformers/blob/v4.20.1/src/transformers/generation_utils.py#L2330",returnDescription:`
<p><a
  href="/docs/transformers/v4.20.1/en/internal/generation_utils#transformers.generation_utils.BeamSampleDecoderOnlyOutput"
...
An derived instance of <a href="/docs/transformers/v4.20.1/en/internal/generation_utils#transformers.BeamScorer">BeamScorer</a> that defines how beam hypotheses are constructed, stored and
sorted during generation. For more information, the documentation of <a href="/docs/transformers/v4.20.1/en/internal/generation_utils#transformers.BeamScorer">BeamScorer</a> should be read.`,name:"beam_scorer"},{anchor:"transformers.generation_utils.GenerationMixin.group_beam_search.logits_processor",description:`<strong>logits_processor</strong> (<code>LogitsProcessorList</code>, <em>optional</em>) &#x2014;
An instance of <a href="/docs/transformers/v4.20.1/en/internal/generation_utils#transformers.LogitsProcessorList">LogitsProcessorList</a>. List of instances of class derived from <a href="/docs/transformers/v4.20.1/en/internal/generation_utils#transformers.LogitsProcessor">LogitsProcessor</a>
...
model is an encoder-decoder model the kwargs should include <code>encoder_outputs</code>.`,name:"synced_gpus"}],source:"https://github.com/huggingface/transformers/blob/v4.20.1/src/transformers/generation_utils.py#L2648",returnDescription:`
<p><a
  href="/docs/transformers/v4.20.1/en/internal/generation_utils#transformers.generation_utils.BeamSearchDecoderOnlyOutput"
...
documentation of <a href="/docs/transformers/v4.20.1/en/internal/generation_utils#transformers.ConstrainedBeamSearchScorer">ConstrainedBeamSearchScorer</a> should be read.`,name:"constrained_beam_scorer"},{anchor:"transformers.generation_utils.GenerationMixin.constrained_beam_search.logits_processor",description:`<strong>logits_processor</strong> (<code>LogitsProcessorList</code>, <em>optional</em>) &#x2014;
An instance of <a href="/docs/transformers/v4.20.1/en/internal/generation_utils#transformers.LogitsProcessorList">LogitsProcessorList</a>. List of instances of class derived from <a href="/docs/transformers/v4.20.1/en/internal/generation_utils#transformers.LogitsProcessor">LogitsProcessor</a>
...
model_kwargs &#x2014;
Additional model specific kwargs will be forwarded to the <code>forward</code> function of the model. If model is
an encoder-decoder model the kwargs should include <code>encoder_outputs</code>.`,name:"synced_gpus"}],source:"https://github.com/huggingface/transformers/blob/v4.20.1/src/transformers/generation_utils.py#L3011",returnDescription:`
<p><code>generation_utilsBeamSearchDecoderOnlyOutput</code>, <a
  href="/docs/transformers/v4.20.1/en/internal/generation_utils#transformers.generation_utils.BeamSearchEncoderDecoderOutput"
>BeamSearchEncoderDecoderOutput</a> or
<code>torch.LongTensor</code>: A <code>torch.LongTensor</code> containing the generated tokens (default behaviour) or a
...
Additional model specific kwargs will be forwarded to the <code>forward</code> function of the model.`,name:"forced_eos_token_id"}],source:"https://github.com/huggingface/transformers/blob/v4.20.1/src/transformers/generation_tf_utils.py#L366",returnDescription:`
<p>A <a
  href="/docs/transformers/v4.20.1/en/main_classes/output#transformers.utils.ModelOutput"
...
Additional model specific kwargs will be forwarded to the <code>forward</code> function of the model. If the model
is an encoder-decoder model, encoder specific kwargs should not be prefixed and decoder specific kwargs
should be prefixed with *decoder</em>*. Also accepts <code>encoder_outputs</code> to skip encoder part.`,name:"params"}],source:"https://github.com/huggingface/transformers/blob/v4.20.1/src/transformers/generation_flax_utils.py#L162",returnDescription:`
<p><a
  href="/docs/transformers/v4.20.1/en/main_classes/output#transformers.utils.ModelOutput"
>ModelOutput</a>.</p>
`}}),ht=new Jp({props:{warning:!0,$$slots:{default:[um]},$$scope:{ctx:$}}}),ft=new ge({props:{anchor:"transformers.generation_flax_utils.FlaxGenerationMixin.generate.example",$$slots:{default:[_m]},$$scope:{ctx:$}}}),{c(){d=a("meta"),f=m(),u=a("h1"),c=a("a"),_=a("span"),v(s.$$.fragment),p=m(),C=a("span"),S=t("Generation"),I=m(),q=a("p"),P=t("Each framework has a generate method for auto-regressive text generation implemented in their respective "),w=a("code"),Le=t("GenerationMixin"),$e=t(" class:"),he=m(),fe=a("ul"),we=a("li"),Is=t("PyTorch "),tn=a("a"),Bs=t("generate()"),Ws=t(" is implemented in "),nn=a("a"),Hs=t("GenerationMixin"),Rs=t("."),Us=m(),Te=a("li"),Vs=t("TensorFlow "),on=a("a"),Ks=t("generate()"),Zs=t(" is implemented in "),sn=a("a"),Xs=t("TFGenerationMixin"),Js=t("."),Qs=m(),Ee=a("li"),Ys=t("Flax/JAX "),an=a("a"),ea=t("generate()"),ta=t(" is implemented in "),rn=a("a"),na=t("FlaxGenerationMixin"),oa=t("."),_s=m(),Oe=a("h2"),nt=a("a"),Pn=a("span"),v(xt.$$.fragment),sa=m(),Dn=a("span"),aa=t("GenerationMixin"),hs=m(),T=a("div"),v(vt.$$.fragment),ra=m(),kt=a("p"),ia=t("A class containing all functions for auto-regressive text generation, to be used as a mixin in "),ln=a("a"),la=t("PreTrainedModel"),da=t("."),ca=m(),yt=a("p"),pa=t("The class exposes "),dn=a("a"),ma=t("generate()"),ga=t(", which can be used for:"),ua=m(),D=a("ul"),B=a("li"),zn=a("em"),_a=t("greedy decoding"),ha=t(" by calling "),cn=a("a"),fa=t("greedy_search()"),ba=t(" if "),Nn=a("code"),xa=t("num_beams=1"),va=t(` and
`),Cn=a("code"),ka=t("do_sample=False"),ya=t("."),ja=m(),W=a("li"),In=a("em"),Ma=t("multinomial sampling"),La=t(" by calling "),pn=a("a"),$a=t("sample()"),wa=t(" if "),Bn=a("code"),Ta=t("num_beams=1"),Ea=t(` and
...
generation methods for text-decoder, text-to-text, speech-to-text, and vision-to-text models:`),fr=m(),z=a("ul"),K=a("li"),oo=a("em"),br=t("greedy decoding"),xr=t(" by calling "),hn=a("a"),vr=t("greedy_search()"),kr=t(" if "),so=a("code"),yr=t("num_beams=1"),jr=t(` and
...
`),ko=a("code"),_i=t("force_words_ids!=None"),hi=t("."),fi=m(),v(ot.$$.fragment),bi=m(),Mt=a("p"),xi=t("Most of these parameters are explained in more detail in "),Lt=a("a"),vi=t(`this blog
post`),ki=t("."),yi=m(),yo=a("p"),ji=t("Examples:"),Mi=m(),v(st.$$.fragment),Li=m(),v(at.$$.fragment),$i=m(),v(rt.$$.fragment),wi=m(),be=a("div"),v($t.$$.fragment),Ti=m(),wt=a("p"),Ei=t("Generates sequences of token ids for models with a language modeling head using "),jo=a("strong"),Oi=t("greedy decoding"),Gi=t(` and can be
used for text-decoder, text-to-text, speech-to-text, and vision-to-text models.`),Si=m(),v(it.$$.fragment),qi=m(),xe=a("div"),v(Tt.$$.fragment),Fi=m(),Et=a("p"),Ai=t("Generates sequences of token ids for models with a language modeling head using "),Mo=a("strong"),Pi=t("multinomial sampling"),Di=t(` and
can be used for text-decoder, text-to-text, speech-to-text, and vision-to-text models.`),zi=m(),v(lt.$$.fragment),Ni=m(),ve=a("div"),v(Ot.$$.fragment),Ci=m(),Gt=a("p"),Ii=t("Generates sequences of token ids for models with a language modeling head using "),Lo=a("strong"),Bi=t("beam search decoding"),Wi=t(` and
can be used for text-decoder, text-to-text, speech-to-text, and vision-to-text models.`),Hi=m(),v(dt.$$.fragment),Ri=m(),ke=a("div"),v(St.$$.fragment),Ui=m(),qt=a("p"),Vi=t("Generates sequences of token ids for models with a language modeling head using "),$o=a("strong"),Ki=t(`beam search multinomial
sampling`),Zi=t(" and can be used for text-decoder, text-to-text, speech-to-text, and vision-to-text models."),Xi=m(),v(ct.$$.fragment),Ji=m(),ye=a("div"),v(Ft.$$.fragment),Qi=m(),At=a("p"),Yi=t("Generates sequences of token ids for models with a language modeling head using "),wo=a("strong"),el=t(`diverse beam search
decoding`),tl=t(" and can be used for text-decoder, text-to-text, speech-to-text, and vision-to-text models."),nl=m(),v(pt.$$.fragment),ol=m(),je=a("div"),v(Pt.$$.fragment),sl=m(),Dt=a("p"),al=t("Generates sequences of token ids for models with a language modeling head using "),To=a("strong"),rl=t(`constrained beam search
decoding`),il=t(" and can be used for text-decoder, text-to-text, speech-to-text, and vision-to-text models."),ll=m(),v(mt.$$.fragment),fs=m(),Ge=a("h2"),gt=a("a"),Eo=a("span"),v(zt.$$.fragment),dl=m(),Oo=a("span"),cl=t("TFGenerationMixin"),bs=m(),pe=a("div"),v(Nt.$$.fragment),pl=m(),Ct=a("p"),ml=t("A class containing all of the functions supporting generation, to be used as a mixin in "),yn=a("a"),gl=t("TFPreTrainedModel"),ul=t("."),_l=m(),F=a("div"),v(It.$$.fragment),hl=m(),Go=a("p"),fl=t(`Generates sequences for models with a language modeling head. The method currently supports greedy decoding,
...
code`),kl=t("."),yl=m(),me=a("p"),jl=t("Apart from "),So=a("code"),Ml=t("input_ids"),Ll=t(" and "),qo=a("code"),$l=t("attention_mask"),wl=t(`, all the arguments below will default to the value of the attribute
...
post`),ql=t("."),Fl=m(),v(ut.$$.fragment),xs=m(),Se=a("h2"),_t=a("a"),Fo=a("span"),v(Ut.$$.fragment),Al=m(),Ao=a("span"),Pl=t("FlaxGenerationMixin"),vs=m(),N=a("div"),v(Vt.$$.fragment),Dl=m(),Kt=a("p"),zl=t(`A class containing all functions for auto-regressive text generation, to be used as a mixin in
...
and `),Vo=a("code"),hd=t("do_sample=False"),fd=t("."),bd=m(),A=a("div"),v(Xt.$$.fragment),xd=m(),Ko=a("p"),vd=t(`Generates sequences of token ids for models with a language modeling head. The method supports the following
generation methods for text-decoder, text-to-text, speech-to-text, and vision-to-text models:`),kd=m(),Fe=a("ul"),oe=a("li"),Zo=a("em"),yd=t("greedy decoding"),jd=t(" by calling "),Xo=a("code"),Md=t("_greedy_search()"),Ld=t(` if
...
`),ko=r(Ze,"CODE",{});var tp=i(ko);_i=n(tp,"force_words_ids!=None"),tp.forEach(o),hi=n(Ze,"."),Ze.forEach(o),ie.forEach(o),fi=g(G),k(ot.$$.fragment,G),bi=g(G),Mt=r(G,"P",{});var Ls=i(Mt);xi=n(Ls,"Most of these parameters are explained in more detail in "),Lt=r(Ls,"A",{href:!0,rel:!0});var np=i(Lt);vi=n(np,`this blog
post`),np.forEach(o),ki=n(Ls,"."),Ls.forEach(o),yi=g(G),yo=r(G,"P",{});var op=i(yo);ji=n(op,"Examples:"),op.forEach(o),Mi=g(G),k(st.$$.fragment,G),Li=g(G),k(at.$$.fragment,G),$i=g(G),k(rt.$$.fragment,G),G.forEach(o),wi=g(O),be=r(O,"DIV",{class:!0});var wn=i(be);k($t.$$.fragment,wn),Ti=g(wn),wt=r(wn,"P",{});var $s=i(wt);Ei=n($s,"Generates sequences of token ids for models with a language modeling head using "),jo=r($s,"STRONG",{});var sp=i(jo);Oi=n(sp,"greedy decoding"),sp.forEach(o),Gi=n($s,` and can be
used for text-decoder, text-to-text, speech-to-text, and vision-to-text models.`),$s.forEach(o),Si=g(wn),k(it.$$.fragment,wn),wn.forEach(o),qi=g(O),xe=r(O,"DIV",{class:!0});var Tn=i(xe);k(Tt.$$.fragment,Tn),Fi=g(Tn),Et=r(Tn,"P",{});var ws=i(Et);Ai=n(ws,"Generates sequences of token ids for models with a language modeling head using "),Mo=r(ws,"STRONG",{});var ap=i(Mo);Pi=n(ap,"multinomial sampling"),ap.forEach(o),Di=n(ws,` and
can be used for text-decoder, text-to-text, speech-to-text, and vision-to-text models.`),ws.forEach(o),zi=g(Tn),k(lt.$$.fragment,Tn),Tn.forEach(o),Ni=g(O),ve=r(O,"DIV",{class:!0});var En=i(ve);k(Ot.$$.fragment,En),Ci=g(En),Gt=r(En,"P",{});var Ts=i(Gt);Ii=n(Ts,"Generates sequences of token ids for models with a language modeling head using "),Lo=r(Ts,"STRONG",{});var rp=i(Lo);Bi=n(rp,"beam search decoding"),rp.forEach(o),Wi=n(Ts,` and
can be used for text-decoder, text-to-text, speech-to-text, and vision-to-text models.`),Ts.forEach(o),Hi=g(En),k(dt.$$.fragment,En),En.forEach(o),Ri=g(O),ke=r(O,"DIV",{class:!0});var On=i(ke);k(St.$$.fragment,On),Ui=g(On),qt=r(On,"P",{});var Es=i(qt);Vi=n(Es,"Generates sequences of token ids for models with a language modeling head using "),$o=r(Es,"STRONG",{});var ip=i($o);Ki=n(ip,`beam search multinomial
sampling`),ip.forEach(o),Zi=n(Es," and can be used for text-decoder, text-to-text, speech-to-text, and vision-to-text models."),Es.forEach(o),Xi=g(On),k(ct.$$.fragment,On),On.forEach(o),Ji=g(O),ye=r(O,"DIV",{class:!0});var Gn=i(ye);k(Ft.$$.fragment,Gn),Qi=g(Gn),At=r(Gn,"P",{});var Os=i(At);Yi=n(Os,"Generates sequences of token ids for models with a language modeling head using "),wo=r(Os,"STRONG",{});var lp=i(wo);el=n(lp,`diverse beam search
decoding`),lp.forEach(o),tl=n(Os," and can be used for text-decoder, text-to-text, speech-to-text, and vision-to-text models."),Os.forEach(o),nl=g(Gn),k(pt.$$.fragment,Gn),Gn.forEach(o),ol=g(O),je=r(O,"DIV",{class:!0});var Sn=i(je);k(Pt.$$.fragment,Sn),sl=g(Sn),Dt=r(Sn,"P",{});var Gs=i(Dt);al=n(Gs,"Generates sequences of token ids for models with a language modeling head using "),To=r(Gs,"STRONG",{});var dp=i(To);rl=n(dp,`constrained beam search
decoding`),dp.forEach(o),il=n(Gs," and can be used for text-decoder, text-to-text, speech-to-text, and vision-to-text models."),Gs.forEach(o),ll=g(Sn),k(mt.$$.fragment,Sn),Sn.forEach(o),O.forEach(o),fs=g(l),Ge=r(l,"H2",{class:!0});var Ss=i(Ge);gt=r(Ss,"A",{id:!0,class:!0,href:!0});var cp=i(gt);Eo=r(cp,"SPAN",{});var pp=i(Eo);k(zt.$$.fragment,pp),pp.forEach(o),cp.forEach(o),dl=g(Ss),Oo=r(Ss,"SPAN",{});var mp=i(Oo);cl=n(mp,"TFGenerationMixin"),mp.forEach(o),Ss.forEach(o),bs=g(l),pe=r(l,"DIV",{class:!0});var qn=i(pe);k(Nt.$$.fragment,qn),pl=g(qn),Ct=r(qn,"P",{});var qs=i(Ct);ml=n(qs,"A class containing all of the functions supporting generation, to be used as a mixin in "),yn=r(qs,"A",{href:!0});var gp=i(yn);gl=n(gp,"TFPreTrainedModel"),gp.forEach(o),ul=n(qs,"."),qs.forEach(o),_l=g(qn),F=r(qn,"DIV",{class:!0});var le=i(F);k(It.$$.fragment,le),hl=g(le),Go=r(le,"P",{});var up=i(Go);fl=n(up,`Generates sequences for models with a language modeling head. The method currently supports greedy decoding,
...
code`),_p.forEach(o),kl=n(Fs,"."),Fs.forEach(o),yl=g(le),me=r(le,"P",{});var bt=i(me);jl=n(bt,"Apart from "),So=r(bt,"CODE",{});var hp=i(So);Ml=n(hp,"input_ids"),hp.forEach(o),Ll=n(bt," and "),qo=r(bt,"CODE",{});var fp=i(qo);$l=n(fp,"attention_mask"),fp.forEach(o),wl=n(bt,`, all the arguments below will default to the value of the attribute
...
post`),xp.forEach(o),ql=n(As,"."),As.forEach(o),Fl=g(le),k(ut.$$.fragment,le),le.forEach(o),qn.forEach(o),xs=g(l),Se=r(l,"H2",{class:!0});var Ps=i(Se);_t=r(Ps,"A",{id:!0,class:!0,href:!0});var vp=i(_t);Fo=r(vp,"SPAN",{});var kp=i(Fo);k(Ut.$$.fragment,kp),kp.forEach(o),vp.forEach(o),Al=g(Ps),Ao=r(Ps,"SPAN",{});var yp=i(Ao);Pl=n(yp,"FlaxGenerationMixin"),yp.forEach(o),Ps.forEach(o),vs=g(l),N=r(l,"DIV",{class:!0});var Me=i(N);k(Vt.$$.fragment,Me),Dl=g(Me),Kt=r(Me,"P",{});var Ds=i(Kt);zl=n(Ds,`A class containing all functions for auto-regressive text generation, to be used as a mixin in
...
and `),Vo=r(Qe,"CODE",{});var Pp=i(Vo);hd=n(Pp,"do_sample=False"),Pp.forEach(o),fd=n(Qe,"."),Qe.forEach(o),Fn.forEach(o),bd=g(Me),A=r(Me,"DIV",{class:!0});var de=i(A);k(Xt.$$.fragment,de),xd=g(de),Ko=r(de,"P",{});var Dp=i(Ko);vd=n(Dp,`Generates sequences of token ids for models with a language modeling head. The method supports the following
generation methods for text-decoder, text-to-text, speech-to-text, and vision-to-text models:`),Dp.forEach(o),kd=g(de),Fe=r(de,"UL",{});var An=i(Fe);oe=r(An,"LI",{});var Ye=i(oe);Zo=r(Ye,"EM",{});var zp=i(Zo);yd=n(zp,"greedy decoding"),zp.forEach(o),jd=n(Ye," by calling "),Xo=r(Ye,"CODE",{});var Np=i(Xo);Md=n(Np,"_greedy_search()"),Np.forEach(o),Ld=n(Ye,` if
...
and `),rs=r(tt,"CODE",{});var Zp=i(rs);Ud=n(Zp,"do_sample=False"),Zp.forEach(o),Vd=n(tt,"."),tt.forEach(o),An.forEach(o),Kd=g(de),k(ht.$$.fragment,de),Zd=g(de),Jt=r(de,"P",{});var Ns=i(Jt);Xd=n(Ns,"Most of these parameters are explained in more detail in "),Qt=r(Ns,"A",{href:!0,rel:!0});var Xp=i(Qt);Jd=n(Xp,`this blog
post`),Xp.forEach(o),Qd=n(Ns,"."),Ns.forEach(o),Yd=g(de),k(ft.$$.fragment,de),de.forEach(o),Me.forEach(o),this.h()},h(){h(d,"name","hf:doc:metadata"),h(d,"content",JSON.stringify(fm)),h(c,"id","generation"),h(c,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),h(c,"href","#generation"),h(u,"class","relative group"),h(tn,"href","/docs/transformers/v4.20.1/en/main_classes/text_generation#transformers.generation_utils.GenerationMixin.generate"),h(nn,"href","/docs/transformers/v4.20.1/en/main_classes/text_generation#transformers.generation_utils.GenerationMixin"),h(on,"href","/docs/transformers/v4.20.1/en/main_classes/text_generation#transformers.generation_tf_utils.TFGenerationMixin.generate"),h(sn,"href","/docs/transformers/v4.20.1/en/main_classes/text_generation#transformers.generation_tf_utils.TFGenerationMixin"),h(an,"href","/docs/transformers/v4.20.1/en/main_classes/text_generation#transformers.generation_flax_utils.FlaxGenerationMixin.generate"),h(rn,"href","/docs/transformers/v4.20.1/en/main_classes/text_generation#transformers.generation_flax_utils.FlaxGenerationMixin"),h(nt,"id","transformers.generation_utils.GenerationMixin"),h(nt,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),h(nt,"href","#transformers.generation_utils.GenerationMixin"),h(Oe,"class","relative group"),h(ln,"href","/docs/transformers/v4.20.1/en/main_classes/model#transformers.PreTrainedModel"),h(dn,"href","/docs/transformers/v4.20.1/en/main_classes/text_generation#transformers.generation_utils.GenerationMixin.generate"),h(cn,"href","/docs/transformers/v4.20.1/en/main_classes/text_generation#transformers.generation_utils.GenerationMixin.greedy_search"),h(pn,"href","/docs/transformers/v4.20.1/en/main_classes/text_generation#transformers.generation_utils.GenerationMixin.sample"),h(mn,"href","/docs/transformers/v4.20.1/en/main_classes/text_generation#transformers.generation_utils.GenerationMixin.beam_search"),h(gn,"href","/docs/transformers/v4.20.1/en/main_classes/text_generation#transformers.generation_utils.GenerationMixin.beam_sample"),h(un,"href","/docs/transformers/v4.20.1/en/main_classes/text_generation#transformers.generation_utils.GenerationMixin.group_beam_search"),h(_n,"href","/docs/transformers/v4.20.1/en/main_classes/text_generation#transformers.generation_utils.GenerationMixin.constrained_beam_search"),h(hn,"href","/docs/transformers/v4.20.1/en/main_classes/text_generation#transformers.generation_utils.GenerationMixin.greedy_search"),h(fn,"href","/docs/transformers/v4.20.1/en/main_classes/text_generation#transformers.generation_utils.GenerationMixin.sample"),h(bn,"href","/docs/transformers/v4.20.1/en/main_classes/text_generation#transformers.generation_utils.GenerationMixin.beam_search"),h(xn,"href","/docs/transformers/v4.20.1/en/main_classes/text_generation#transformers.generation_utils.GenerationMixin.beam_sample"),h(vn,"href","/docs/transformers/v4.20.1/en/main_classes/text_generation#transformers.generation_utils.GenerationMixin.group_beam_search"),h(kn,"href","/docs/transformers/v4.20.1/en/main_classes/text_generation#transformers.generation_utils.GenerationMixin.constrained_beam_search"),h(Lt,"href","https://huggingface.co/blog/how-to-generate"),h(Lt,"rel","nofollow"),h(E,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),h(be,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),h(xe,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),h(ve,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),h(ke,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),h(ye,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),h(je,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),h(T,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),h(gt,"id","transformers.generation_tf_utils.TFGenerationMixin"),h(gt,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),h(gt,"href","#transformers.generation_tf_utils.TFGenerationMixin"),h(Ge,"class","relative group"),h(yn,"href","/docs/transformers/v4.20.1/en/main_classes/model#transformers.TFPreTrainedModel"),h(Wt,"href","https://github.com/facebookresearch/XLM/blob/9e6f6814d17be4fe5b15f2e6c43eb2b2d76daeb4/src/model/transformer.py#L529"),h(Wt,"rel","nofollow"),h(jn,"href","/docs/transformers/v4.20.1/en/main_classes/configuration#transformers.PretrainedConfig"),h(Rt,"href","https://huggingface.co/blog/how-to-generate"),h(Rt,"rel","nofollow"),h(F,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),h(pe,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),h(_t,"id","transformers.generation_flax_utils.FlaxGenerationMixin"),h(_t,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),h(_t,"href","#transformers.generation_flax_utils.FlaxGenerationMixin"),h(Se,"class","relative group"),h(Mn,"href","/docs/transformers/v4.20.1/en/main_classes/model#transformers.FlaxPreTrainedModel"),h(Ln,"href","/docs/transformers/v4.20.1/en/main_classes/text_generation#transformers.generation_flax_utils.FlaxGenerationMixin.generate"),h(Qt,"href","https://huggingface.co/blog/how-to-generate"),h(Qt,"rel","nofollow"),h(A,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),h(N,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8")},m(l,b){e(document.head,d),x(l,f,b),x(l,u,b),e(u,c),e(c,_),y(s,_,null),e(u,p),e(u,C),e(C,S),x(l,I,b),x(l,q,b),e(q,P),e(q,w),e(w,Le),e(q,$e),x(l,he,b),x(l,fe,b),e(fe,we),e(we,Is),e(we,tn),e(tn,Bs),e(we,Ws),e(we,nn),e(nn,Hs),e(we,Rs),e(fe,Us),e(fe,Te),e(Te,Vs),e(Te,on),e(on,Ks),e(Te,Zs),e(Te,sn),e(sn,Xs),e(Te,Js),e(fe,Qs),e(fe,Ee),e(Ee,Ys),e(Ee,an),e(an,ea),e(Ee,ta),e(Ee,rn),e(rn,na),e(Ee,oa),x(l,_s,b),x(l,Oe,b),e(Oe,nt),e(nt,Pn),y(xt,Pn,null),e(Oe,sa),e(Oe,Dn),e(Dn,aa),x(l,hs,b),x(l,T,b),y(vt,T,null),e(T,ra),e(T,kt),e(kt,ia),e(kt,ln),e(ln,la),e(kt,da),e(T,ca),e(T,yt),e(yt,pa),e(yt,dn),e(dn,ma),e(yt,ga),e(T,ua),e(T,D),e(D,B),e(B,zn),e(zn,_a),e(B,ha),e(B,cn),e(cn,fa),e(B,ba),e(B,Nn),e(Nn,xa),e(B,va),e(B,Cn),e(Cn,ka),e(B,ya),e(D,ja),e(D,W),e(W,In),e(In,Ma),e(W,La),e(W,pn),e(pn,$a),e(W,wa),e(W,Bn),e(Bn,Ta),e(W,Ea),e(W,Wn),e(Wn,Oa),e(W,Ga),e(D,Sa),e(D,H),e(H,Hn),e(Hn,qa),e(H,Fa),e(H,mn),e(mn,Aa),e(H,Pa),e(H,Rn),e(Rn,Da),e(H,za),e(H,Un),e(Un,Na),e(H,Ca),e(D,Ia),e(D,R),e(R,Vn),e(Vn,Ba),e(R,Wa),e(R,gn),e(gn,Ha),e(R,Ra),e(R,Kn),e(Kn,Ua),e(R,Va),e(R,Zn),e(Zn,Ka),e(R,Za),e(D,Xa),e(D,U),e(U,Xn),e(Xn,Ja),e(U,Qa),e(U,un),e(un,Ya),e(U,er),e(U,Jn),e(Jn,tr),e(U,nr),e(U,Qn),e(Qn,or),e(U,sr),e(D,ar),e(D,V),e(V,Yn),e(Yn,rr),e(V,ir),e(V,_n),e(_n,lr),e(V,dr),e(V,eo),e(eo,cr),e(V,pr),e(V,to),e(to,mr),e(V,gr),e(T,ur),e(T,E),y(jt,E,null),e(E,_r),e(E,no),e(no,hr),e(E,fr),e(E,z),e(z,K),e(K,oo),e(oo,br),e(K,xr),e(K,hn),e(hn,vr),e(K,kr),e(K,so),e(so,yr),e(K,jr),e(K,ao),e(ao,Mr),e(K,Lr),e(z,$r),e(z,Z),e(Z,ro),e(ro,wr),e(Z,Tr),e(Z,fn),e(fn,Er),e(Z,Or),e(Z,io),e(io,Gr),e(Z,Sr),e(Z,lo),e(lo,qr),e(Z,Fr),e(z,Ar),e(z,X),e(X,co),e(co,Pr),e(X,Dr),e(X,bn),e(bn,zr),e(X,Nr),e(X,po),e(po,Cr),e(X,Ir),e(X,mo),e(mo,Br),e(X,Wr),e(z,Hr),e(z,J),e(J,go),e(go,Rr),e(J,Ur),e(J,xn),e(xn,Vr),e(J,Kr),e(J,uo),e(uo,Zr),e(J,Xr),e(J,_o),e(_o,Jr),e(J,Qr),e(z,Yr),e(z,Q),e(Q,ho),e(ho,ei),e(Q,ti),e(Q,vn),e(vn,ni),e(Q,oi),e(Q,fo),e(fo,si),e(Q,ai),e(Q,bo),e(bo,ri),e(Q,ii),e(z,li),e(z,Y),e(Y,xo),e(xo,di),e(Y,ci),e(Y,kn),e(kn,pi),e(Y,mi),e(Y,vo),e(vo,gi),e(Y,ui),e(Y,ko),e(ko,_i),e(Y,hi),e(E,fi),y(ot,E,null),e(E,bi),e(E,Mt),e(Mt,xi),e(Mt,Lt),e(Lt,vi),e(Mt,ki),e(E,yi),e(E,yo),e(yo,ji),e(E,Mi),y(st,E,null),e(E,Li),y(at,E,null),e(E,$i),y(rt,E,null),e(T,wi),e(T,be),y($t,be,null),e(be,Ti),e(be,wt),e(wt,Ei),e(wt,jo),e(jo,Oi),e(wt,Gi),e(be,Si),y(it,be,null),e(T,qi),e(T,xe),y(Tt,xe,null),e(xe,Fi),e(xe,Et),e(Et,Ai),e(Et,Mo),e(Mo,Pi),e(Et,Di),e(xe,zi),y(lt,xe,null),e(T,Ni),e(T,ve),y(Ot,ve,null),e(ve,Ci),e(ve,Gt),e(Gt,Ii),e(Gt,Lo),e(Lo,Bi),e(Gt,Wi),e(ve,Hi),y(dt,ve,null),e(T,Ri),e(T,ke),y(St,ke,null),e(ke,Ui),e(ke,qt),e(qt,Vi),e(qt,$o),e($o,Ki),e(qt,Zi),e(ke,Xi),y(ct,ke,null),e(T,Ji),e(T,ye),y(Ft,ye,null),e(ye,Qi),e(ye,At),e(At,Yi),e(At,wo),e(wo,el),e(At,tl),e(ye,nl),y(pt,ye,null),e(T,ol),e(T,je),y(Pt,je,null),e(je,sl),e(je,Dt),e(Dt,al),e(Dt,To),e(To,rl),e(Dt,il),e(je,ll),y(mt,je,null),x(l,fs,b),x(l,Ge,b),e(Ge,gt),e(gt,Eo),y(zt,Eo,null),e(Ge,dl),e(Ge,Oo),e(Oo,cl),x(l,bs,b),x(l,pe,b),y(Nt,pe,null),e(pe,pl),e(pe,Ct),e(Ct,ml),e(Ct,yn),e(yn,gl),e(Ct,ul),e(pe,_l),e(pe,F),y(It,F,null),e(F,hl),e(F,Go),e(Go,fl),e(F,bl),e(F,Bt),e(Bt,xl),e(Bt,Wt),e(Wt,vl),e(Bt,kl),e(F,yl),e(F,me),e(me,jl),e(me,So),e(So,Ml),e(me,Ll),e(me,qo),e(qo,$l),e(me,wl),e(me,jn),e(jn,Tl),e(me,El),e(F,Ol),e(F,Ht),e(Ht,Gl),e(Ht,Rt),e(Rt,Sl),e(Ht,ql),e(F,Fl),y(ut,F,null),x(l,xs,b),x(l,Se,b),e(Se,_t),e(_t,Fo),y(Ut,Fo,null),e(Se,Al),e(Se,Ao),e(Ao,Pl),x(l,vs,b),x(l,N,b),y(Vt,N,null),e(N,Dl),e(N,Kt),e(Kt,zl),e(Kt,Mn),e(Mn,Nl),e(Kt,Cl),e(N,Il),e(N,Zt),e(Zt,Bl),e(Zt,Ln),e(Ln,Wl),e(Zt,Hl),e(N,Rl),e(N,qe),e(qe,ee),e(ee,Po),e(Po,Ul),e(ee,Vl),e(ee,Do),e(Do,Kl),e(ee,Zl),e(ee,zo),e(zo,Xl),e(ee,Jl),e(ee,No),e(No,Ql),e(ee,Yl),e(qe,ed),e(qe,te),e(te,Co),e(Co,td),e(te,nd),e(te,Io),e(Io,od),e(te,sd),e(te,Bo),e(Bo,ad),e(te,rd),e(te,Wo),e(Wo,id),e(te,ld),e(qe,dd),e(qe,ne),e(ne,Ho),e(Ho,cd),e(ne,pd),e(ne,Ro),e(Ro,md),e(ne,gd),e(ne,Uo),e(Uo,ud),e(ne,_d),e(ne,Vo),e(Vo,hd),e(ne,fd),e(N,bd),e(N,A),y(Xt,A,null),e(A,xd),e(A,Ko),e(Ko,vd),e(A,kd),e(A,Fe),e(Fe,oe),e(oe,Zo),e(Zo,yd),e(oe,jd),e(oe,Xo),e(Xo,Md),e(oe,Ld),e(oe,Jo),e(Jo,$d),e(oe,wd),e(oe,Qo),e(Qo,Td),e(oe,Ed),e(Fe,Od),e(Fe,se),e(se,Yo),e(Yo,Gd),e(se,Sd),e(se,es),e(es,qd),e(se,Fd),e(se,ts),e(ts,Ad),e(se,Pd),e(se,ns),e(ns,Dd),e(se,zd),e(Fe,Nd),e(Fe,ae),e(ae,os),e(os,Cd),e(ae,Id),e(ae,ss),e(ss,Bd),e(ae,Wd),e(ae,as),e(as,Hd),e(ae,Rd),e(ae,rs),e(rs,Ud),e(ae,Vd),e(A,Kd),y(ht,A,null),e(A,Zd),e(A,Jt),e(Jt,Xd),e(Jt,Qt),e(Qt,Jd),e(Jt,Qd),e(A,Yd),y(ft,A,null),ks=!0},p(l,[b]){const Yt={};b&2&&(Yt.$$scope={dirty:b,ctx:l}),ot.$set(Yt);const is={};b&2&&(is.$$scope={dirty:b,ctx:l}),st.$set(is);const ls={};b&2&&(ls.$$scope={dirty:b,ctx:l}),at.$set(ls);const ds={};b&2&&(ds.$$scope={dirty:b,ctx:l}),rt.$set(ds);const en={};b&2&&(en.$$scope={dirty:b,ctx:l}),it.$set(en);const cs={};b&2&&(cs.$$scope={dirty:b,ctx:l}),lt.$set(cs);const Ae={};b&2&&(Ae.$$scope={dirty:b,ctx:l}),dt.$set(Ae);const Pe={};b&2&&(Pe.$$scope={dirty:b,ctx:l}),ct.$set(Pe);const ps={};b&2&&(ps.$$scope={dirty:b,ctx:l}),pt.$set(ps);const ms={};b&2&&(ms.$$scope={dirty:b,ctx:l}),mt.$set(ms);const De={};b&2&&(De.$$scope={dirty:b,ctx:l}),ut.$set(De);const gs={};b&2&&(gs.$$scope={dirty:b,ctx:l}),ht.$set(gs);const us={};b&2&&(us.$$scope={dirty:b,ctx:l}),ft.$set(us)},i(l){ks||(j(s.$$.fragment,l),j(xt.$$.fragment,l),j(vt.$$.fragment,l),j(jt.$$.fragment,l),j(ot.$$.fragment,l),j(st.$$.fragment,l),j(at.$$.fragment,l),j(rt.$$.fragment,l),j($t.$$.fragment,l),j(it.$$.fragment,l),j(Tt.$$.fragment,l),j(lt.$$.fragment,l),j(Ot.$$.fragment,l),j(dt.$$.fragment,l),j(St.$$.fragment,l),j(ct.$$.fragment,l),j(Ft.$$.fragment,l),j(pt.$$.fragment,l),j(Pt.$$.fragment,l),j(mt.$$.fragment,l),j(zt.$$.fragment,l),j(Nt.$$.fragment,l),j(It.$$.fragment,l),j(ut.$$.fragment,l),j(Ut.$$.fragment,l),j(Vt.$$.fragment,l),j(Xt.$$.fragment,l),j(ht.$$.fragment,l),j(ft.$$.fragment,l),ks=!0)},o(l){M(s.$$.fragment,l),M(xt.$$.fragment,l),M(vt.$$.fragment,l),M(jt.$$.fragment,l),M(ot.$$.fragment,l),M(st.$$.fragment,l),M(at.$$.fragment,l),M(rt.$$.fragment,l),M($t.$$.fragment,l),M(it.$$.fragment,l),M(Tt.$$.fragment,l),M(lt.$$.fragment,l),M(Ot.$$.fragment,l),M(dt.$$.fragment,l),M(St.$$.fragment,l),M(ct.$$.fragment,l),M(Ft.$$.fragment,l),M(pt.$$.fragment,l),M(Pt.$$.fragment,l),M(mt.$$.fragment,l),M(zt.$$.fragment,l),M(Nt.$$.fragment,l),M(It.$$.fragment,l),M(ut.$$.fragment,l),M(Ut.$$.fragment,l),M(Vt.$$.fragment,l),M(Xt.$$.fragment,l),M(ht.$$.fragment,l),M(ft.$$.fragment,l),ks=!1},d(l){o(d),l&&o(f),l&&o(u),L(s),l&&o(I),l&&o(q),l&&o(he),l&&o(fe),l&&o(_s),l&&o(Oe),L(xt),l&&o(hs),l&&o(T),L(vt),L(jt),L(ot),L(st),L(at),L(rt),L($t),L(it),L(Tt),L(lt),L(Ot),L(dt),L(St),L(ct),L(Ft),L(pt),L(Pt),L(mt),l&&o(fs),l&&o(Ge),L(zt),l&&o(bs),l&&o(pe),L(Nt),L(It),L(ut),l&&o(xs),l&&o(Se),L(Ut),l&&o(vs),l&&o(N),L(Vt),L(Xt),L(ht),L(ft)}}}const fm={local:"generation",sections:[{local:"transformers.generation_utils.GenerationMixin",title:"GenerationMixin"},{local:"transformers.generation_tf_utils.TFGenerationMixin",title:"TFGenerationMixin"},{local:"transformers.generation_flax_utils.FlaxGenerationMixin",title:"FlaxGenerationMixin"}],title:"Generation"};function bm($){return nm(()=>{new URLSearchParams(window.location.search).get("fw")}),[]}class Lm extends Qp{constructor(d){super();Yp(this,d,bm,hm,em,{})}}export{Lm as default,fm as metadata};
