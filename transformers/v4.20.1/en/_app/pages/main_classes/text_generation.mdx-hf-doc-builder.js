...
used for text-decoder, text-to-text, speech-to-text, and vision-to-text models.`),ws.forEach(o),qi=g($n),k(it.$$.fragment,$n),$n.forEach(o),Si=g(O),xe=r(O,"DIV",{class:!0});var Tn=i(xe);k(Tt.$$.fragment,Tn),Fi=g(Tn),Et=r(Tn,"P",{});var $s=i(Et);zi=n($s,"Generates sequences of token ids for models with a language modeling head using "),Mo=r($s,"STRONG",{});var ap=i(Mo);Ai=n(ap,"multinomial sampling"),ap.forEach(o),Pi=n($s,` and
