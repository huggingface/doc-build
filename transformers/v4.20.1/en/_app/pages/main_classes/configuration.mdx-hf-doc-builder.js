import{S as Es,i as xs,s as Ts,e as r,k as d,w as y,t as o,M as Ds,c as a,d as t,m as l,a as s,x as w,h as n,b as g,G as e,g as x,y as $,q as k,o as P,B as C,v as js,L as Ps}from"../../chunks/vendor-hf-doc-builder.js";import{T as $a}from"../../chunks/Tip-hf-doc-builder.js";import{D as T}from"../../chunks/Docstring-hf-doc-builder.js";import{C as Cs}from"../../chunks/CodeBlock-hf-doc-builder.js";import{I as $s}from"../../chunks/IconCopyLink-hf-doc-builder.js";import{E as ks}from"../../chunks/ExampleCodeBlock-hf-doc-builder.js";function zs(z){let f,b,p,u,E;return{c(){f=r("p"),b=o(`A configuration file can be loaded and saved to disk. Loading the configuration file and using this file to
initialize a model does `),p=r("strong"),u=o("not"),E=o(" load the model weights. It only affects the model\u2019s configuration.")},l(c){f=a(c,"P",{});var _=s(f);b=n(_,`A configuration file can be loaded and saved to disk. Loading the configuration file and using this file to
initialize a model does `),p=a(_,"STRONG",{});var q=s(p);u=n(q,"not"),q.forEach(t),E=n(_," load the model weights. It only affects the model\u2019s configuration."),_.forEach(t)},m(c,_){x(c,f,_),e(f,b),e(f,p),e(p,u),e(f,E)},d(c){c&&t(f)}}}function As(z){let f,b,p,u,E;return u=new Cs({props:{code:`
...
config.push_to_hub(<span class="hljs-string">&quot;my-finetuned-bert&quot;</span>, repo_url=<span class="hljs-string">&quot;https://huggingface.co/sgugger/my-finetuned-bert&quot;</span>)`}}),{c(){f=r("p"),b=o("Examples:"),p=d(),y(u.$$.fragment)},l(c){f=a(c,"P",{});var _=s(f);b=n(_,"Examples:"),_.forEach(t),p=l(c),w(u.$$.fragment,c)},m(c,_){x(c,f,_),e(f,b),x(c,p,_),$(u,c,_),E=!0},p:Ps,i(c){E||(k(u.$$.fragment,c),E=!0)},o(c){P(u.$$.fragment,c),E=!1},d(c){c&&t(f),c&&t(p),C(u,c)}}}function Os(z){let f,b,p,u,E;return{c(){f=r("p"),b=o("Passing "),p=r("code"),u=o("use_auth_token=True"),E=o(" is required when you want to use a private model.")},l(c){f=a(c,"P",{});var _=s(f);b=n(_,"Passing "),p=a(_,"CODE",{});var q=s(p);u=n(q,"use_auth_token=True"),q.forEach(t),E=n(_," is required when you want to use a private model."),_.forEach(t)},m(c,_){x(c,f,_),e(f,b),e(f,p),e(p,u),e(f,E)},d(c){c&&t(f)}}}function qs(z){let f,b,p,u,E;return u=new Cs({props:{code:`# We can't instantiate directly the base class *PretrainedConfig* so let's show the examples on a
...
<span class="hljs-keyword">assert</span> config.output_attentions == <span class="hljs-literal">True</span>
<span class="hljs-keyword">assert</span> unused_kwargs == {<span class="hljs-string">&quot;foo&quot;</span>: <span class="hljs-literal">False</span>}`}}),{c(){f=r("p"),b=o("Examples:"),p=d(),y(u.$$.fragment)},l(c){f=a(c,"P",{});var _=s(f);b=n(_,"Examples:"),_.forEach(t),p=l(c),w(u.$$.fragment,c)},m(c,_){x(c,f,_),e(f,b),x(c,p,_),$(u,c,_),E=!0},p:Ps,i(c){E||(k(u.$$.fragment,c),E=!0)},o(c){P(u.$$.fragment,c),E=!1},d(c){c&&t(f),c&&t(p),C(u,c)}}}function Ss(z){let f,b;return{c(){f=r("p"),b=o("This API is experimental and may have some slight breaking changes in the next releases.")},l(p){f=a(p,"P",{});var u=s(f);b=n(u,"This API is experimental and may have some slight breaking changes in the next releases."),u.forEach(t)},m(p,u){x(p,f,u),e(f,b)},d(p){p&&t(f)}}}function Fs(z){let f,b,p,u,E,c,_,q,Do,ao,H,jo,Ge,zo,Ao,so,D,Oo,dt,qo,So,lt,Fo,Io,ct,Lo,No,ft,Wo,Mo,io,R,G,mt,$e,Vo,ht,Bo,lo,m,ke,Ro,pt,Uo,Jo,X,Ho,ut,Go,Xo,S,W,gt,Ko,Qo,_t,Yo,Zo,Xe,en,tn,on,j,bt,nn,rn,vt,an,sn,Ke,dn,ln,Qe,cn,fn,Ye,mn,hn,pn,K,yt,un,gn,wt,_n,bn,vn,Q,$t,yn,wn,kt,$n,kn,Pn,Pt,Cn,En,F,Y,Ct,xn,Tn,Et,Dn,jn,zn,Z,xt,An,On,Tt,qn,Sn,Fn,ee,Dt,In,Ln,jt,Nn,Wn,Mn,te,zt,Vn,Bn,At,Rn,Un,Jn,M,Pe,Hn,Ce,Gn,Ot,Xn,Kn,Qn,oe,Yn,ne,Ee,Zn,I,er,qt,tr,or,St,nr,rr,Ft,ar,sr,ir,re,xe,dr,Te,lr,Ze,cr,fr,mr,ae,De,hr,je,pr,et,ur,gr,_r,A,ze,br,Ae,vr,tt,yr,wr,$r,se,kr,ie,Pr,de,Oe,Cr,L,Er,It,xr,Tr,ot,Dr,jr,Lt,zr,Ar,Or,V,qe,qr,Se,Sr,Nt,Fr,Ir,Lr,le,Nr,ce,Fe,Wr,U,Mr,Wt,Vr,Br,nt,Rr,Ur,Jr,fe,Ie,Hr,Mt,Gr,Xr,me,Le,Kr,Vt,Qr,Yr,he,Ne,Zr,Bt,ea,ta,pe,We,oa,Rt,na,ra,ue,Me,aa,Ve,sa,Ut,ia,da,la,O,Be,ca,Re,fa,Jt,ma,ha,pa,J,ua,Ht,ga,_a,Gt,ba,va,ya,Xt,wa,co;return c=new $s({}),$e=new $s({}),ke=new T({props:{name:"class transformers.PretrainedConfig",anchor:"transformers.PretrainedConfig",parameters:[{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.PretrainedConfig.name_or_path",description:`<strong>name_or_path</strong> (<code>str</code>, <em>optional</em>, defaults to <code>&quot;&quot;</code>) &#x2014;
Store the string that was passed to <a href="/docs/transformers/v4.20.1/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">PreTrainedModel.from_pretrained()</a> or
<a href="/docs/transformers/v4.20.1/en/main_classes/model#transformers.TFPreTrainedModel.from_pretrained">TFPreTrainedModel.from_pretrained()</a> as <code>pretrained_model_name_or_path</code> if the configuration was created
...
that can be used as decoder models within the <a href="/docs/transformers/v4.20.1/en/model_doc/encoder-decoder#transformers.EncoderDecoderModel">EncoderDecoderModel</a> class, which consists of all models
...
Forward Chunking work?</a>.`,name:"chunk_size_feed_forward"}],source:"https://github.com/huggingface/transformers/blob/v4.20.1/src/transformers/configuration_utils.py#L54",parameterGroups:[{title:"Parameters for sequence generation",parametersDescription:`
<ul>
...
Path to the JSON file containing the parameters.`,name:"json_file"}],source:"https://github.com/huggingface/transformers/blob/v4.20.1/src/transformers/configuration_utils.py#L714",returnDescription:`
...
<a href="/docs/transformers/v4.20.1/en/main_classes/configuration#transformers.PretrainedConfig.save_pretrained">save_pretrained()</a> method, e.g., <code>./my_model_directory/</code>.</li>
...
by the <code>return_unused_kwargs</code> keyword parameter.`,name:"kwargs"}],source:"https://github.com/huggingface/transformers/blob/v4.20.1/src/transformers/configuration_utils.py#L452",returnDescription:`
...
The identifier of the pre-trained checkpoint from which we want the dictionary of parameters.`,name:"pretrained_model_name_or_path"}],source:"https://github.com/huggingface/transformers/blob/v4.20.1/src/transformers/configuration_utils.py#L535",returnDescription:`
...
<p>kwargs &#x2014;
Additional key word arguments passed along to the <a href="/docs/transformers/v4.20.1/en/main_classes/model#transformers.utils.PushToHubMixin.push_to_hub">push_to_hub()</a> method.`,name:"push_to_hub"}],source:"https://github.com/huggingface/transformers/blob/v4.20.1/src/transformers/configuration_utils.py#L406"}}),Ie=new T({props:{name:"to_dict",anchor:"transformers.PretrainedConfig.to_dict",parameters:[],source:"https://github.com/huggingface/transformers/blob/v4.20.1/src/transformers/configuration_utils.py#L774",returnDescription:`
<p>Dictionary of all the attributes that make up this configuration instance.</p>
`,returnType:`
<p><code>Dict[str, Any]</code></p>
`}}),Le=new T({props:{name:"to_diff_dict",anchor:"transformers.PretrainedConfig.to_diff_dict",parameters:[],source:"https://github.com/huggingface/transformers/blob/v4.20.1/src/transformers/configuration_utils.py#L742",returnDescription:`
<p>Dictionary of all the attributes that make up this configuration instance,</p>
`,returnType:`
<p><code>Dict[str, Any]</code></p>
...
`),ft=r("code"),Wo=o("vocab_size"),Mo=o("."),io=d(),R=r("h2"),G=r("a"),mt=r("span"),y($e.$$.fragment),Vo=d(),ht=r("span"),Bo=o("PretrainedConfig"),lo=d(),m=r("div"),y(ke.$$.fragment),Ro=d(),pt=r("p"),Uo=o(`Base class for all configuration classes. Handles a few parameters common to all models\u2019 configurations as well as
methods for loading/downloading/saving configurations.`),Jo=d(),y(X.$$.fragment),Ho=d(),ut=r("p"),Go=o("Class attributes (overridden by derived classes):"),Xo=d(),S=r("ul"),W=r("li"),gt=r("strong"),Ko=o("model_type"),Qo=o(" ("),_t=r("code"),Yo=o("str"),Zo=o(`) \u2014 An identifier for the model type, serialized into the JSON file, and used to recreate
the correct object in `),Xe=r("a"),en=o("AutoConfig"),tn=o("."),on=d(),j=r("li"),bt=r("strong"),nn=o("is_composition"),rn=o(" ("),vt=r("code"),an=o("bool"),sn=o(`) \u2014 Whether the config class is composed of multiple sub-configs. In this case the
config has to be initialized from two or more configs of type `),Ke=r("a"),dn=o("PretrainedConfig"),ln=o(` like:
`),Qe=r("a"),cn=o("EncoderDecoderConfig"),fn=o(" or "),Ye=r("a"),mn=o("~RagConfig"),hn=o("."),pn=d(),K=r("li"),yt=r("strong"),un=o("keys_to_ignore_at_inference"),gn=o(" ("),wt=r("code"),_n=o("List[str]"),bn=o(`) \u2014 A list of keys to ignore by default when looking at dictionary
outputs of the model during inference.`),vn=d(),Q=r("li"),$t=r("strong"),yn=o("attribute_map"),wn=o(" ("),kt=r("code"),$n=o("Dict[str, str]"),kn=o(`) \u2014 A dict that maps model specific attribute names to the standardized
...
model.`),Mn=d(),te=r("li"),zt=r("strong"),Vn=o("num_hidden_layers"),Bn=o(" ("),At=r("code"),Rn=o("int"),Un=o(") \u2014 The number of blocks in the model."),Jn=d(),M=r("div"),y(Pe.$$.fragment),Hn=d(),Ce=r("p"),Gn=o(`Upload the configuration file to the \u{1F917} Model Hub while synchronizing a local clone of the repo in
`),Ot=r("code"),Xn=o("repo_path_or_name"),Kn=o("."),Qn=d(),y(oe.$$.fragment),Yn=d(),ne=r("div"),y(Ee.$$.fragment),Zn=d(),I=r("p"),er=o("Checks whether the passed dictionary and its nested dicts have a "),qt=r("em"),tr=o("torch_dtype"),or=o(` key and if it\u2019s not None,
...
string, which can then be stored in the json format.`),ir=d(),re=r("div"),y(xe.$$.fragment),dr=d(),Te=r("p"),lr=o("Instantiates a "),Ze=r("a"),cr=o("PretrainedConfig"),fr=o(" from a Python dictionary of parameters."),mr=d(),ae=r("div"),y(De.$$.fragment),hr=d(),je=r("p"),pr=o("Instantiates a "),et=r("a"),ur=o("PretrainedConfig"),gr=o(" from the path to a JSON file of parameters."),_r=d(),A=r("div"),y(ze.$$.fragment),br=d(),Ae=r("p"),vr=o("Instantiate a "),tt=r("a"),yr=o("PretrainedConfig"),wr=o(" (or a derived class) from a pretrained model configuration."),$r=d(),y(se.$$.fragment),kr=d(),y(ie.$$.fragment),Pr=d(),de=r("div"),y(Oe.$$.fragment),Cr=d(),L=r("p"),Er=o("From a "),It=r("code"),xr=o("pretrained_model_name_or_path"),Tr=o(`, resolve to a dictionary of parameters, to be used for instantiating a
`),ot=r("a"),Dr=o("PretrainedConfig"),jr=o(" using "),Lt=r("code"),zr=o("from_dict"),Ar=o("."),Or=d(),V=r("div"),y(qe.$$.fragment),qr=d(),Se=r("p"),Sr=o(`Register this class with a given auto class. This should only be used for custom configurations as the ones in
the library are already mapped with `),Nt=r("code"),Fr=o("AutoConfig"),Ir=o("."),Lr=d(),y(le.$$.fragment),Nr=d(),ce=r("div"),y(Fe.$$.fragment),Wr=d(),U=r("p"),Mr=o("Save a configuration object to the directory "),Wt=r("code"),Vr=o("save_directory"),Br=o(`, so that it can be re-loaded using the
`),nt=r("a"),Rr=o("from_pretrained()"),Ur=o(" class method."),Jr=d(),fe=r("div"),y(Ie.$$.fragment),Hr=d(),Mt=r("p"),Gr=o("Serializes this instance to a Python dictionary."),Xr=d(),me=r("div"),y(Le.$$.fragment),Kr=d(),Vt=r("p"),Qr=o(`Removes all attributes from config which correspond to the default config attributes for better readability and
serializes to a Python dictionary.`),Yr=d(),he=r("div"),y(Ne.$$.fragment),Zr=d(),Bt=r("p"),ea=o("Save this instance to a JSON file."),ta=d(),pe=r("div"),y(We.$$.fragment),oa=d(),Rt=r("p"),na=o("Serializes this instance to a JSON string."),ra=d(),ue=r("div"),y(Me.$$.fragment),aa=d(),Ve=r("p"),sa=o("Updates attributes of this class with attributes from "),Ut=r("code"),ia=o("config_dict"),da=o("."),la=d(),O=r("div"),y(Be.$$.fragment),ca=d(),Re=r("p"),fa=o("Updates attributes of this class with attributes from "),Jt=r("code"),ma=o("update_str"),ha=o("."),pa=d(),J=r("p"),ua=o("The expected format is ints, floats and strings as is, and for booleans use "),Ht=r("code"),ga=o("true"),_a=o(" or "),Gt=r("code"),ba=o("false"),va=o(`. For example:
\u201Cn_embd=10,resid_pdrop=0.2,scale_attn_weights=false,summary_type=cls_index\u201D`),ya=d(),Xt=r("p"),wa=o("The keys to change have to already exist in the config object."),this.h()},l(i){const v=Ds('[data-svelte="svelte-1phssyn"]',document.head);f=a(v,"META",{name:!0,content:!0}),v.forEach(t),b=l(i),p=a(i,"H1",{class:!0});var Ue=s(p);u=a(Ue,"A",{id:!0,class:!0,href:!0});var Kt=s(u);E=a(Kt,"SPAN",{});var Qt=s(E);w(c.$$.fragment,Qt),Qt.forEach(t),Kt.forEach(t),_=l(Ue),q=a(Ue,"SPAN",{});var Yt=s(q);Do=n(Yt,"Configuration"),Yt.forEach(t),Ue.forEach(t),ao=l(i),H=a(i,"P",{});var Je=s(H);jo=n(Je,"The base class "),Ge=a(Je,"A",{href:!0});var ka=s(Ge);zo=n(ka,"PretrainedConfig"),ka.forEach(t),Ao=n(Je,` implements the common methods for loading/saving a configuration
either from a local file or directory, or from a pretrained model configuration provided by the library (downloaded
from HuggingFace\u2019s AWS S3 repository).`),Je.forEach(t),so=l(i),D=a(i,"P",{});var B=s(D);Oo=n(B,`Each derived config class implements model specific attributes. Common attributes present in all config classes are:
`),dt=a(B,"CODE",{});var Pa=s(dt);qo=n(Pa,"hidden_size"),Pa.forEach(t),So=n(B,", "),lt=a(B,"CODE",{});var Ca=s(lt);Fo=n(Ca,"num_attention_heads"),Ca.forEach(t),Io=n(B,", and "),ct=a(B,"CODE",{});var Ea=s(ct);Lo=n(Ea,"num_hidden_layers"),Ea.forEach(t),No=n(B,`. Text models further implement:
`),ft=a(B,"CODE",{});var xa=s(ft);Wo=n(xa,"vocab_size"),xa.forEach(t),Mo=n(B,"."),B.forEach(t),io=l(i),R=a(i,"H2",{class:!0});var fo=s(R);G=a(fo,"A",{id:!0,class:!0,href:!0});var Ta=s(G);mt=a(Ta,"SPAN",{});var Da=s(mt);w($e.$$.fragment,Da),Da.forEach(t),Ta.forEach(t),Vo=l(fo),ht=a(fo,"SPAN",{});var ja=s(ht);Bo=n(ja,"PretrainedConfig"),ja.forEach(t),fo.forEach(t),lo=l(i),m=a(i,"DIV",{class:!0});var h=s(m);w(ke.$$.fragment,h),Ro=l(h),pt=a(h,"P",{});var za=s(pt);Uo=n(za,`Base class for all configuration classes. Handles a few parameters common to all models\u2019 configurations as well as
methods for loading/downloading/saving configurations.`),za.forEach(t),Jo=l(h),w(X.$$.fragment,h),Ho=l(h),ut=a(h,"P",{});var Aa=s(ut);Go=n(Aa,"Class attributes (overridden by derived classes):"),Aa.forEach(t),Xo=l(h),S=a(h,"UL",{});var ge=s(S);W=a(ge,"LI",{});var He=s(W);gt=a(He,"STRONG",{});var Oa=s(gt);Ko=n(Oa,"model_type"),Oa.forEach(t),Qo=n(He," ("),_t=a(He,"CODE",{});var qa=s(_t);Yo=n(qa,"str"),qa.forEach(t),Zo=n(He,`) \u2014 An identifier for the model type, serialized into the JSON file, and used to recreate
the correct object in `),Xe=a(He,"A",{href:!0});var Sa=s(Xe);en=n(Sa,"AutoConfig"),Sa.forEach(t),tn=n(He,"."),He.forEach(t),on=l(ge),j=a(ge,"LI",{});var N=s(j);bt=a(N,"STRONG",{});var Fa=s(bt);nn=n(Fa,"is_composition"),Fa.forEach(t),rn=n(N," ("),vt=a(N,"CODE",{});var Ia=s(vt);an=n(Ia,"bool"),Ia.forEach(t),sn=n(N,`) \u2014 Whether the config class is composed of multiple sub-configs. In this case the
...
`),Qe=a(N,"A",{href:!0});var Na=s(Qe);cn=n(Na,"EncoderDecoderConfig"),Na.forEach(t),fn=n(N," or "),Ye=a(N,"A",{href:!0});var Wa=s(Ye);mn=n(Wa,"~RagConfig"),Wa.forEach(t),hn=n(N,"."),N.forEach(t),pn=l(ge),K=a(ge,"LI",{});var Zt=s(K);yt=a(Zt,"STRONG",{});var Ma=s(yt);un=n(Ma,"keys_to_ignore_at_inference"),Ma.forEach(t),gn=n(Zt," ("),wt=a(Zt,"CODE",{});var Va=s(wt);_n=n(Va,"List[str]"),Va.forEach(t),bn=n(Zt,`) \u2014 A list of keys to ignore by default when looking at dictionary
outputs of the model during inference.`),Zt.forEach(t),vn=l(ge),Q=a(ge,"LI",{});var eo=s(Q);$t=a(eo,"STRONG",{});var Ba=s($t);yn=n(Ba,"attribute_map"),Ba.forEach(t),wn=n(eo," ("),kt=a(eo,"CODE",{});var Ra=s(kt);$n=n(Ra,"Dict[str, str]"),Ra.forEach(t),kn=n(eo,`) \u2014 A dict that maps model specific attribute names to the standardized
naming of attributes.`),eo.forEach(t),ge.forEach(t),Pn=l(h),Pt=a(h,"P",{});var Ua=s(Pt);Cn=n(Ua,"Common attributes (present in all subclasses):"),Ua.forEach(t),En=l(h),F=a(h,"UL",{});var _e=s(F);Y=a(_e,"LI",{});var to=s(Y);Ct=a(to,"STRONG",{});var Ja=s(Ct);xn=n(Ja,"vocab_size"),Ja.forEach(t),Tn=n(to," ("),Et=a(to,"CODE",{});var Ha=s(Et);Dn=n(Ha,"int"),Ha.forEach(t),jn=n(to,`) \u2014 The number of tokens in the vocabulary, which is also the first dimension of the
...
string, which can then be stored in the json format.`),be.forEach(t),ho.forEach(t),ir=l(h),re=a(h,"DIV",{class:!0});var po=s(re);w(xe.$$.fragment,po),dr=l(po),Te=a(po,"P",{});var uo=s(Te);lr=n(uo,"Instantiates a "),Ze=a(uo,"A",{href:!0});var rs=s(Ze);cr=n(rs,"PretrainedConfig"),rs.forEach(t),fr=n(uo," from a Python dictionary of parameters."),uo.forEach(t),po.forEach(t),mr=l(h),ae=a(h,"DIV",{class:!0});var go=s(ae);w(De.$$.fragment,go),hr=l(go),je=a(go,"P",{});var _o=s(je);pr=n(_o,"Instantiates a "),et=a(_o,"A",{href:!0});var as=s(et);ur=n(as,"PretrainedConfig"),as.forEach(t),gr=n(_o," from the path to a JSON file of parameters."),_o.forEach(t),go.forEach(t),_r=l(h),A=a(h,"DIV",{class:!0});var ve=s(A);w(ze.$$.fragment,ve),br=l(ve),Ae=a(ve,"P",{});var bo=s(Ae);vr=n(bo,"Instantiate a "),tt=a(bo,"A",{href:!0});var ss=s(tt);yr=n(ss,"PretrainedConfig"),ss.forEach(t),wr=n(bo," (or a derived class) from a pretrained model configuration."),bo.forEach(t),$r=l(ve),w(se.$$.fragment,ve),kr=l(ve),w(ie.$$.fragment,ve),ve.forEach(t),Pr=l(h),de=a(h,"DIV",{class:!0});var vo=s(de);w(Oe.$$.fragment,vo),Cr=l(vo),L=a(vo,"P",{});var ye=s(L);Er=n(ye,"From a "),It=a(ye,"CODE",{});var is=s(It);xr=n(is,"pretrained_model_name_or_path"),is.forEach(t),Tr=n(ye,`, resolve to a dictionary of parameters, to be used for instantiating a
`),ot=a(ye,"A",{href:!0});var ds=s(ot);Dr=n(ds,"PretrainedConfig"),ds.forEach(t),jr=n(ye," using "),Lt=a(ye,"CODE",{});var ls=s(Lt);zr=n(ls,"from_dict"),ls.forEach(t),Ar=n(ye,"."),ye.forEach(t),vo.forEach(t),Or=l(h),V=a(h,"DIV",{class:!0});var at=s(V);w(qe.$$.fragment,at),qr=l(at),Se=a(at,"P",{});var yo=s(Se);Sr=n(yo,`Register this class with a given auto class. This should only be used for custom configurations as the ones in
the library are already mapped with `),Nt=a(yo,"CODE",{});var cs=s(Nt);Fr=n(cs,"AutoConfig"),cs.forEach(t),Ir=n(yo,"."),yo.forEach(t),Lr=l(at),w(le.$$.fragment,at),at.forEach(t),Nr=l(h),ce=a(h,"DIV",{class:!0});var wo=s(ce);w(Fe.$$.fragment,wo),Wr=l(wo),U=a(wo,"P",{});var st=s(U);Mr=n(st,"Save a configuration object to the directory "),Wt=a(st,"CODE",{});var fs=s(Wt);Vr=n(fs,"save_directory"),fs.forEach(t),Br=n(st,`, so that it can be re-loaded using the
`),nt=a(st,"A",{href:!0});var ms=s(nt);Rr=n(ms,"from_pretrained()"),ms.forEach(t),Ur=n(st," class method."),st.forEach(t),wo.forEach(t),Jr=l(h),fe=a(h,"DIV",{class:!0});var $o=s(fe);w(Ie.$$.fragment,$o),Hr=l($o),Mt=a($o,"P",{});var hs=s(Mt);Gr=n(hs,"Serializes this instance to a Python dictionary."),hs.forEach(t),$o.forEach(t),Xr=l(h),me=a(h,"DIV",{class:!0});var ko=s(me);w(Le.$$.fragment,ko),Kr=l(ko),Vt=a(ko,"P",{});var ps=s(Vt);Qr=n(ps,`Removes all attributes from config which correspond to the default config attributes for better readability and
serializes to a Python dictionary.`),ps.forEach(t),ko.forEach(t),Yr=l(h),he=a(h,"DIV",{class:!0});var Po=s(he);w(Ne.$$.fragment,Po),Zr=l(Po),Bt=a(Po,"P",{});var us=s(Bt);ea=n(us,"Save this instance to a JSON file."),us.forEach(t),Po.forEach(t),ta=l(h),pe=a(h,"DIV",{class:!0});var Co=s(pe);w(We.$$.fragment,Co),oa=l(Co),Rt=a(Co,"P",{});var gs=s(Rt);na=n(gs,"Serializes this instance to a JSON string."),gs.forEach(t),Co.forEach(t),ra=l(h),ue=a(h,"DIV",{class:!0});var Eo=s(ue);w(Me.$$.fragment,Eo),aa=l(Eo),Ve=a(Eo,"P",{});var xo=s(Ve);sa=n(xo,"Updates attributes of this class with attributes from "),Ut=a(xo,"CODE",{});var _s=s(Ut);ia=n(_s,"config_dict"),_s.forEach(t),da=n(xo,"."),xo.forEach(t),Eo.forEach(t),la=l(h),O=a(h,"DIV",{class:!0});var we=s(O);w(Be.$$.fragment,we),ca=l(we),Re=a(we,"P",{});var To=s(Re);fa=n(To,"Updates attributes of this class with attributes from "),Jt=a(To,"CODE",{});var bs=s(Jt);ma=n(bs,"update_str"),bs.forEach(t),ha=n(To,"."),To.forEach(t),pa=l(we),J=a(we,"P",{});var it=s(J);ua=n(it,"The expected format is ints, floats and strings as is, and for booleans use "),Ht=a(it,"CODE",{});var vs=s(Ht);ga=n(vs,"true"),vs.forEach(t),_a=n(it," or "),Gt=a(it,"CODE",{});var ys=s(Gt);ba=n(ys,"false"),ys.forEach(t),va=n(it,`. For example:
\u201Cn_embd=10,resid_pdrop=0.2,scale_attn_weights=false,summary_type=cls_index\u201D`),it.forEach(t),ya=l(we),Xt=a(we,"P",{});var ws=s(Xt);wa=n(ws,"The keys to change have to already exist in the config object."),ws.forEach(t),we.forEach(t),h.forEach(t),this.h()},h(){g(f,"name","hf:doc:metadata"),g(f,"content",JSON.stringify(Is)),g(u,"id","configuration"),g(u,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),g(u,"href","#configuration"),g(p,"class","relative group"),g(Ge,"href","/docs/transformers/v4.20.1/en/main_classes/configuration#transformers.PretrainedConfig"),g(G,"id","transformers.PretrainedConfig"),g(G,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),g(G,"href","#transformers.PretrainedConfig"),g(R,"class","relative group"),g(Xe,"href","/docs/transformers/v4.20.1/en/model_doc/auto#transformers.AutoConfig"),g(Ke,"href","/docs/transformers/v4.20.1/en/main_classes/configuration#transformers.PretrainedConfig"),g(Qe,"href","/docs/transformers/v4.20.1/en/model_doc/encoder-decoder#transformers.EncoderDecoderConfig"),g(Ye,"href","/docs/transformers/v4.20.1/en/model_doc/rag#transformers.RagConfig"),g(M,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),g(ne,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),g(Ze,"href","/docs/transformers/v4.20.1/en/main_classes/configuration#transformers.PretrainedConfig"),g(re,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),g(et,"href","/docs/transformers/v4.20.1/en/main_classes/configuration#transformers.PretrainedConfig"),g(ae,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),g(tt,"href","/docs/transformers/v4.20.1/en/main_classes/configuration#transformers.PretrainedConfig"),g(A,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),g(ot,"href","/docs/transformers/v4.20.1/en/main_classes/configuration#transformers.PretrainedConfig"),g(de,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),g(V,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),g(nt,"href","/docs/transformers/v4.20.1/en/main_classes/configuration#transformers.PretrainedConfig.from_pretrained"),g(ce,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),g(fe,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),g(me,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),g(he,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),g(pe,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),g(ue,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),g(O,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),g(m,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8")},m(i,v){e(document.head,f),x(i,b,v),x(i,p,v),e(p,u),e(u,E),$(c,E,null),e(p,_),e(p,q),e(q,Do),x(i,ao,v),x(i,H,v),e(H,jo),e(H,Ge),e(Ge,zo),e(H,Ao),x(i,so,v),x(i,D,v),e(D,Oo),e(D,dt),e(dt,qo),e(D,So),e(D,lt),e(lt,Fo),e(D,Io),e(D,ct),e(ct,Lo),e(D,No),e(D,ft),e(ft,Wo),e(D,Mo),x(i,io,v),x(i,R,v),e(R,G),e(G,mt),$($e,mt,null),e(R,Vo),e(R,ht),e(ht,Bo),x(i,lo,v),x(i,m,v),$(ke,m,null),e(m,Ro),e(m,pt),e(pt,Uo),e(m,Jo),$(X,m,null),e(m,Ho),e(m,ut),e(ut,Go),e(m,Xo),e(m,S),e(S,W),e(W,gt),e(gt,Ko),e(W,Qo),e(W,_t),e(_t,Yo),e(W,Zo),e(W,Xe),e(Xe,en),e(W,tn),e(S,on),e(S,j),e(j,bt),e(bt,nn),e(j,rn),e(j,vt),e(vt,an),e(j,sn),e(j,Ke),e(Ke,dn),e(j,ln),e(j,Qe),e(Qe,cn),e(j,fn),e(j,Ye),e(Ye,mn),e(j,hn),e(S,pn),e(S,K),e(K,yt),e(yt,un),e(K,gn),e(K,wt),e(wt,_n),e(K,bn),e(S,vn),e(S,Q),e(Q,$t),e($t,yn),e(Q,wn),e(Q,kt),e(kt,$n),e(Q,kn),e(m,Pn),e(m,Pt),e(Pt,Cn),e(m,En),e(m,F),e(F,Y),e(Y,Ct),e(Ct,xn),e(Y,Tn),e(Y,Et),e(Et,Dn),e(Y,jn),e(F,zn),e(F,Z),e(Z,xt),e(xt,An),e(Z,On),e(Z,Tt),e(Tt,qn),e(Z,Sn),e(F,Fn),e(F,ee),e(ee,Dt),e(Dt,In),e(ee,Ln),e(ee,jt),e(jt,Nn),e(ee,Wn),e(F,Mn),e(F,te),e(te,zt),e(zt,Vn),e(te,Bn),e(te,At),e(At,Rn),e(te,Un),e(m,Jn),e(m,M),$(Pe,M,null),e(M,Hn),e(M,Ce),e(Ce,Gn),e(Ce,Ot),e(Ot,Xn),e(Ce,Kn),e(M,Qn),$(oe,M,null),e(m,Yn),e(m,ne),$(Ee,ne,null),e(ne,Zn),e(ne,I),e(I,er),e(I,qt),e(qt,tr),e(I,or),e(I,St),e(St,nr),e(I,rr),e(I,Ft),e(Ft,ar),e(I,sr),e(m,ir),e(m,re),$(xe,re,null),e(re,dr),e(re,Te),e(Te,lr),e(Te,Ze),e(Ze,cr),e(Te,fr),e(m,mr),e(m,ae),$(De,ae,null),e(ae,hr),e(ae,je),e(je,pr),e(je,et),e(et,ur),e(je,gr),e(m,_r),e(m,A),$(ze,A,null),e(A,br),e(A,Ae),e(Ae,vr),e(Ae,tt),e(tt,yr),e(Ae,wr),e(A,$r),$(se,A,null),e(A,kr),$(ie,A,null),e(m,Pr),e(m,de),$(Oe,de,null),e(de,Cr),e(de,L),e(L,Er),e(L,It),e(It,xr),e(L,Tr),e(L,ot),e(ot,Dr),e(L,jr),e(L,Lt),e(Lt,zr),e(L,Ar),e(m,Or),e(m,V),$(qe,V,null),e(V,qr),e(V,Se),e(Se,Sr),e(Se,Nt),e(Nt,Fr),e(Se,Ir),e(V,Lr),$(le,V,null),e(m,Nr),e(m,ce),$(Fe,ce,null),e(ce,Wr),e(ce,U),e(U,Mr),e(U,Wt),e(Wt,Vr),e(U,Br),e(U,nt),e(nt,Rr),e(U,Ur),e(m,Jr),e(m,fe),$(Ie,fe,null),e(fe,Hr),e(fe,Mt),e(Mt,Gr),e(m,Xr),e(m,me),$(Le,me,null),e(me,Kr),e(me,Vt),e(Vt,Qr),e(m,Yr),e(m,he),$(Ne,he,null),e(he,Zr),e(he,Bt),e(Bt,ea),e(m,ta),e(m,pe),$(We,pe,null),e(pe,oa),e(pe,Rt),e(Rt,na),e(m,ra),e(m,ue),$(Me,ue,null),e(ue,aa),e(ue,Ve),e(Ve,sa),e(Ve,Ut),e(Ut,ia),e(Ve,da),e(m,la),e(m,O),$(Be,O,null),e(O,ca),e(O,Re),e(Re,fa),e(Re,Jt),e(Jt,ma),e(Re,ha),e(O,pa),e(O,J),e(J,ua),e(J,Ht),e(Ht,ga),e(J,_a),e(J,Gt),e(Gt,ba),e(J,va),e(O,ya),e(O,Xt),e(Xt,wa),co=!0},p(i,[v]){const Ue={};v&2&&(Ue.$$scope={dirty:v,ctx:i}),X.$set(Ue);const Kt={};v&2&&(Kt.$$scope={dirty:v,ctx:i}),oe.$set(Kt);const Qt={};v&2&&(Qt.$$scope={dirty:v,ctx:i}),se.$set(Qt);const Yt={};v&2&&(Yt.$$scope={dirty:v,ctx:i}),ie.$set(Yt);const Je={};v&2&&(Je.$$scope={dirty:v,ctx:i}),le.$set(Je)},i(i){co||(k(c.$$.fragment,i),k($e.$$.fragment,i),k(ke.$$.fragment,i),k(X.$$.fragment,i),k(Pe.$$.fragment,i),k(oe.$$.fragment,i),k(Ee.$$.fragment,i),k(xe.$$.fragment,i),k(De.$$.fragment,i),k(ze.$$.fragment,i),k(se.$$.fragment,i),k(ie.$$.fragment,i),k(Oe.$$.fragment,i),k(qe.$$.fragment,i),k(le.$$.fragment,i),k(Fe.$$.fragment,i),k(Ie.$$.fragment,i),k(Le.$$.fragment,i),k(Ne.$$.fragment,i),k(We.$$.fragment,i),k(Me.$$.fragment,i),k(Be.$$.fragment,i),co=!0)},o(i){P(c.$$.fragment,i),P($e.$$.fragment,i),P(ke.$$.fragment,i),P(X.$$.fragment,i),P(Pe.$$.fragment,i),P(oe.$$.fragment,i),P(Ee.$$.fragment,i),P(xe.$$.fragment,i),P(De.$$.fragment,i),P(ze.$$.fragment,i),P(se.$$.fragment,i),P(ie.$$.fragment,i),P(Oe.$$.fragment,i),P(qe.$$.fragment,i),P(le.$$.fragment,i),P(Fe.$$.fragment,i),P(Ie.$$.fragment,i),P(Le.$$.fragment,i),P(Ne.$$.fragment,i),P(We.$$.fragment,i),P(Me.$$.fragment,i),P(Be.$$.fragment,i),co=!1},d(i){t(f),i&&t(b),i&&t(p),C(c),i&&t(ao),i&&t(H),i&&t(so),i&&t(D),i&&t(io),i&&t(R),C($e),i&&t(lo),i&&t(m),C(ke),C(X),C(Pe),C(oe),C(Ee),C(xe),C(De),C(ze),C(se),C(ie),C(Oe),C(qe),C(le),C(Fe),C(Ie),C(Le),C(Ne),C(We),C(Me),C(Be)}}}const Is={local:"configuration",sections:[{local:"transformers.PretrainedConfig",title:"PretrainedConfig"}],title:"Configuration"};function Ls(z){return js(()=>{new URLSearchParams(window.location.search).get("fw")}),[]}class Us extends Es{constructor(f){super();xs(this,f,Ls,Fs,Ts,{})}}export{Us as default,Is as metadata};
