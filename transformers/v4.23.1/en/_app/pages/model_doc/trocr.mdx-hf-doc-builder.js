...
<span class="hljs-string">&#x27;industry, &quot; Mr. Brown commented icily. &quot; Let us have a&#x27;</span>`}}),{c(){p=s("p"),E=r("Example:"),u=c(),C(g.$$.fragment)},l(m){p=n(m,"P",{});var _=i(p);E=a(_,"Example:"),_.forEach(o),u=h(m),w(g.$$.fragment,m)},m(m,_){f(m,p,_),e(p,E),f(m,u,_),k(g,m,_),T=!0},p:oi,i(m){T||(O(g.$$.fragment,m),T=!0)},o(m){$(g.$$.fragment,m),T=!1},d(m){m&&o(p),m&&o(u),R(g,m)}}}function fi(S){let p,E,u,g,T,m,_,D,j,b,z,F,Pt,ke,Qo,Mt,er,fo,W,tr,Oe,or,rr,$e,ar,sr,po,rt,nr,uo,at,jt,ir,go,oe,Is,_o,re,lr,st,dr,cr,vo,ae,hr,zt,mr,fr,To,B,pr,Re,ur,gr,ye,_r,vr,bo,nt,Tr,Co,H,Ee,br,xe,Cr,wr,kr,I,Or,Pe,$r,Rr,Me,yr,Er,je,xr,Pr,Mr,ze,jr,it,zr,Lr,wo,Z,se,Lt,Le,Fr,Ft,Dr,ko,G,qr,Dt,Ar,Ir,lt,Vr,Nr,Oo,v,Sr,qt,Wr,Br,At,Hr,Gr,It,Xr,Ur,Vt,Zr,Jr,dt,Yr,Kr,Nt,Qr,ea,St,ta,oa,Wt,ra,aa,Bt,sa,na,$o,ct,Ht,ia,Ro,Fe,yo,ne,la,De,da,ca,Eo,J,ie,Gt,qe,ha,Xt,ma,xo,q,Ae,fa,Y,pa,ht,ua,ga,Ie,_a,va,Ta,K,ba,mt,Ca,wa,ft,ka,Oa,$a,le,Po,Q,de,Ut,Ve,Ra,Zt,ya,Mo,y,Ne,Ea,Jt,xa,Pa,P,pt,Ma,ja,Yt,za,La,Kt,Fa,Da,Qt,qa,Aa,eo,Ia,Va,Se,to,Na,Sa,Wa,ut,Ba,Ha,Ga,ce,We,Xa,V,Ua,oo,Za,Ja,ro,Ya,Ka,ao,Qa,es,ts,X,Be,os,so,rs,as,he,ss,U,He,ns,Ge,is,gt,ls,ds,cs,me,hs,fe,Xe,ms,Ue,fs,_t,ps,us,gs,pe,Ze,_s,Je,vs,vt,Ts,bs,jo,ee,ue,no,Ye,Cs,io,ws,zo,A,Ke,ks,N,Os,Tt,$s,Rs,lo,ys,Es,bt,xs,Ps,Ms,Qe,js,et,zs,Ls,Fs,ge,tt,Ds,_e,Lo;return m=new xt({}),ke=new xt({}),Le=new xt({}),Fe=new As({props:{code:`from transformers import TrOCRProcessor, VisionEncoderDecoderModel
import requests 
from PIL import Image
...
<code>inputs_ids</code> passed when calling <a href="/docs/transformers/v4.23.1/en/model_doc/trocr#transformers.TrOCRForCausalLM">TrOCRForCausalLM</a>.`,name:"vocab_size"},{anchor:"transformers.TrOCRConfig.d_model",description:`<strong>d_model</strong> (<code>int</code>, <em>optional</em>, defaults to 1024) &#x2014;
...
namespace).
kwargs &#x2014;
Additional key word arguments passed along to the <a href="/docs/transformers/v4.23.1/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.push_to_hub">push_to_hub()</a> method.`,name:"push_to_hub"}],source:"https://github.com/huggingface/transformers/blob/v4.23.1/src/transformers/processing_utils.py#L94"}}),me=new ei({props:{$$slots:{default:[hi]},$$scope:{ctx:S}}}),Xe=new te({props:{name:"batch_decode",anchor:"transformers.TrOCRProcessor.batch_decode",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/v4.23.1/src/transformers/models/trocr/processing_trocr.py#L79"}}),Ze=new te({props:{name:"decode",anchor:"transformers.TrOCRProcessor.decode",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/v4.23.1/src/transformers/models/trocr/processing_trocr.py#L86"}}),Ye=new xt({}),Ke=new te({props:{name:"class transformers.TrOCRForCausalLM",anchor:"transformers.TrOCRForCausalLM",parameters:[{name:"config",val:""}],parametersDescription:[{anchor:"transformers.TrOCRForCausalLM.config",description:`<strong>config</strong> (<a href="/docs/transformers/v4.23.1/en/model_doc/trocr#transformers.TrOCRConfig">TrOCRConfig</a>) &#x2014;
Model configuration class with all the parameters of the model. Initializing with a config file does not
load the weights associated with the model, only the configuration. Check out the
<a href="/docs/transformers/v4.23.1/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/v4.23.1/src/transformers/models/trocr/modeling_trocr.py#L787"}}),tt=new te({props:{name:"forward",anchor:"transformers.TrOCRForCausalLM.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"encoder_hidden_states",val:" = None"},{name:"encoder_attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"cross_attn_head_mask",val:" = None"},{name:"past_key_values",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"labels",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],parametersDescription:[{anchor:"transformers.TrOCRForCausalLM.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. Padding will be ignored by default should you
provide it.</p>
<p>Indices can be obtained using <code>TrOCRTokenizer</code>. See <a href="/docs/transformers/v4.23.1/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
...
elements depending on the configuration (<a
  href="/docs/transformers/v4.23.1/en/model_doc/trocr#transformers.TrOCRConfig"
...
tasks.`),go=c(),oe=s("img"),_o=c(),re=s("small"),lr=r("TrOCR architecture. Taken from the "),st=s("a"),dr=r("original paper"),cr=r("."),vo=c(),ae=s("p"),hr=r("Please refer to the "),zt=s("code"),mr=r("VisionEncoderDecoder"),fr=r(" class on how to use this model."),To=c(),B=s("p"),pr=r("This model was contributed by "),Re=s("a"),ur=r("nielsr"),gr=r(`. The original code can be found
`),ye=s("a"),_r=r("here"),vr=r("."),bo=c(),nt=s("p"),Tr=r("Tips:"),Co=c(),H=s("ul"),Ee=s("li"),br=r("The quickest way to get started with TrOCR is by checking the "),xe=s("a"),Cr=r(`tutorial
...
on both printed (e.g. the `),Pe=s("a"),$r=r("SROIE dataset"),Rr=r(" and handwritten (e.g. the "),Me=s("a"),yr=r(`IAM
...
into a single instance to both extract the input features and decode the predicted token ids.`),$o=c(),ct=s("ul"),Ht=s("li"),ia=r("Step-by-step Optical Character Recognition (OCR)"),Ro=c(),C(Fe.$$.fragment),yo=c(),ne=s("p"),la=r("See the "),De=s("a"),da=r("model hub"),ca=r(" to look for TrOCR checkpoints."),Eo=c(),J=s("h2"),ie=s("a"),Gt=s("span"),C(qe.$$.fragment),ha=c(),Xt=s("span"),ma=r("TrOCRConfig"),xo=c(),q=s("div"),C(Ae.$$.fragment),fa=c(),Y=s("p"),pa=r("This is the configuration class to store the configuration of a "),ht=s("a"),ua=r("TrOCRForCausalLM"),ga=r(`. It is used to instantiate an
...
documentation from `),ft=s("a"),ka=r("PretrainedConfig"),Oa=r(" for more information."),$a=c(),C(le.$$.fragment),Po=c(),Q=s("h2"),de=s("a"),Ut=s("span"),C(Ve.$$.fragment),Ra=c(),Zt=s("span"),ya=r("TrOCRProcessor"),Mo=c(),y=s("div"),C(Ne.$$.fragment),Ea=c(),Jt=s("p"),xa=r("Constructs a TrOCR processor which wraps a vision feature extractor and a TrOCR tokenizer into a single processor."),Pa=c(),P=s("p"),pt=s("a"),Ma=r("TrOCRProcessor"),ja=r(" offers all the functionalities of ["),Yt=s("code"),za=r("ViTFeatureExtractor"),La=r("/"),Kt=s("code"),Fa=r("DeiTFeatureExtractor"),Da=r(`] and
...
on both printed (e.g. the `),Pe=n(ve,"A",{href:!0,rel:!0});var en=i(Pe);$r=a(en,"SROIE dataset"),en.forEach(o),Rr=a(ve," and handwritten (e.g. the "),Me=n(ve,"A",{href:!0,rel:!0});var tn=i(Me);yr=a(tn,`IAM
...
`),ao=n(be,"CODE",{});var Sn=i(ao);Qa=a(Sn,"~TrOCRTokenizer.__call__"),Sn.forEach(o),es=a(be,". Please refer to the doctsring of the above two methods for more information."),be.forEach(o),Bo.forEach(o),ts=h(M),X=n(M,"DIV",{class:!0});var yt=i(X);w(Be.$$.fragment,yt),os=h(yt),so=n(yt,"P",{});var Wn=i(so);rs=a(Wn,"Instantiate a processor associated with a pretrained model."),Wn.forEach(o),as=h(yt),w(he.$$.fragment,yt),yt.forEach(o),ss=h(M),U=n(M,"DIV",{class:!0});var Et=i(U);w(He.$$.fragment,Et),ns=h(Et),Ge=n(Et,"P",{});var Ho=i(Ge);is=a(Ho,`Saves the attributes of this processor (feature extractor, tokenizer\u2026) in the specified directory so that it
