...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/v4.23.1/src/transformers/models/xlm_roberta/tokenization_xlm_roberta.py#L202",returnDescription:`
...
Whether or not the token list is already formatted with special tokens for the model.`,name:"already_has_special_tokens"}],source:"https://github.com/huggingface/transformers/blob/v4.23.1/src/transformers/models/xlm_roberta/tokenization_xlm_roberta.py#L228",returnDescription:`
...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/v4.23.1/src/transformers/models/xlm_roberta/tokenization_xlm_roberta.py#L256",returnDescription:`
<p>List of zeros.</p>
`,returnType:`
<p><code>List[int]</code></p>
`}}),ma=new A({props:{name:"save_vocabulary",anchor:"transformers.XLMRobertaTokenizer.save_vocabulary",parameters:[{name:"save_directory",val:": str"},{name:"filename_prefix",val:": typing.Optional[str] = None"}],source:"https://github.com/huggingface/transformers/blob/v4.23.1/src/transformers/models/xlm_roberta/tokenization_xlm_roberta.py#L313"}}),fa=new Be({}),ga=new A({props:{name:"class transformers.XLMRobertaTokenizerFast",anchor:"transformers.XLMRobertaTokenizerFast",parameters:[{name:"vocab_file",val:" = None"},{name:"tokenizer_file",val:" = None"},{name:"bos_token",val:" = '<s>'"},{name:"eos_token",val:" = '</s>'"},{name:"sep_token",val:" = '</s>'"},{name:"cls_token",val:" = '<s>'"},{name:"unk_token",val:" = '<unk>'"},{name:"pad_token",val:" = '<pad>'"},{name:"mask_token",val:" = '<mask>'"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.XLMRobertaTokenizerFast.vocab_file",description:`<strong>vocab_file</strong> (<code>str</code>) &#x2014;
...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/v4.23.1/src/transformers/models/xlm_roberta/tokenization_xlm_roberta_fast.py#L171",returnDescription:`
<p>List of <a href="../glossary#input-ids">input IDs</a> with the appropriate special tokens.</p>
`,returnType:`
<p><code>List[int]</code></p>
...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/v4.23.1/src/transformers/models/xlm_roberta/tokenization_xlm_roberta_fast.py#L197",returnDescription:`
<p>List of zeros.</p>
`,returnType:`
<p><code>List[int]</code></p>
...
<code>past_key_values</code>).`,name:"use_cache"}],source:"https://github.com/huggingface/transformers/blob/v4.23.1/src/transformers/models/roberta/modeling_roberta.py#L734",returnDescription:`
<p>A <a
...
elements depending on the configuration (<a
  href="/docs/transformers/v4.23.1/en/model_doc/roberta#transformers.RobertaConfig"
...
If set to <code>True</code>, <code>past_key_values</code> key value states are returned and can be used to speed up decoding (see
<code>past_key_values</code>).`,name:"use_cache"}],source:"https://github.com/huggingface/transformers/blob/v4.23.1/src/transformers/models/roberta/modeling_roberta.py#L901",returnDescription:`
<p>A <a
...
model. Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/v4.23.1/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/v4.23.1/src/transformers/models/xlm_roberta/modeling_xlm_roberta.py#L91"}}),Wa=new A({props:{name:"forward",anchor:"transformers.XLMRobertaForMaskedLM.forward",parameters:[{name:"input_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"attention_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"token_type_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"position_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"head_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"encoder_hidden_states",val:": typing.Optional[torch.FloatTensor] = None"},{name:"encoder_attention_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"labels",val:": typing.Optional[torch.LongTensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.XLMRobertaForMaskedLM.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/v4.23.1/en/model_doc/roberta#transformers.RobertaTokenizer">RobertaTokenizer</a>. See <a href="/docs/transformers/v4.23.1/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/v4.23.1/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
Used to hide legacy arguments that have been deprecated.`,name:"kwargs"}],source:"https://github.com/huggingface/transformers/blob/v4.23.1/src/transformers/models/roberta/modeling_roberta.py#L1056",returnDescription:`
<p>A <a
...
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.23.1/src/transformers/models/roberta/modeling_roberta.py#L1172",returnDescription:`
<p>A <a
...
model. Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/v4.23.1/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/v4.23.1/src/transformers/models/xlm_roberta/modeling_xlm_roberta.py#L123"}}),sr=new A({props:{name:"forward",anchor:"transformers.XLMRobertaForMultipleChoice.forward",parameters:[{name:"input_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"token_type_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"attention_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"labels",val:": typing.Optional[torch.LongTensor] = None"},{name:"position_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"head_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.XLMRobertaForMultipleChoice.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, num_choices, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/v4.23.1/en/model_doc/roberta#transformers.RobertaTokenizer">RobertaTokenizer</a>. See <a href="/docs/transformers/v4.23.1/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/v4.23.1/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
<code>input_ids</code> above)`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.23.1/src/transformers/models/roberta/modeling_roberta.py#L1271",returnDescription:`
<p>A <a
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.23.1/src/transformers/models/roberta/modeling_roberta.py#L1369",returnDescription:`
<p>A <a
...
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/v4.23.1/src/transformers/models/roberta/modeling_roberta.py#L1474",returnDescription:`
<p>A <a
...
If set to <code>True</code>, <code>past_key_values</code> key value states are returned and can be used to speed up decoding (see
<code>past_key_values</code>). Set to <code>False</code> during training, <code>True</code> during generation`,name:"use_cache"}],source:"https://github.com/huggingface/transformers/blob/v4.23.1/src/transformers/models/roberta/modeling_tf_roberta.py#L929",returnDescription:`
<p>A <a
...
Labels for computing the masked language modeling loss. Indices should be in <code>[-100, 0, ..., config.vocab_size]</code> (see <code>input_ids</code> docstring) Tokens with indices set to <code>-100</code> are ignored (masked), the
loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.23.1/src/transformers/models/roberta/modeling_tf_roberta.py#L1085",returnDescription:`
<p>A <a
...
Labels for computing the sequence classification/regression loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>. If <code>config.num_labels == 1</code> a regression loss is computed (Mean-Square loss), If
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.23.1/src/transformers/models/roberta/modeling_tf_roberta.py#L1344",returnDescription:`
<p>A <a
...
where <code>num_choices</code> is the size of the second dimension of the input tensors. (See <code>input_ids</code> above)`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.23.1/src/transformers/models/roberta/modeling_tf_roberta.py#L1441",returnDescription:`
<p>A <a
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.23.1/src/transformers/models/roberta/modeling_tf_roberta.py#L1556",returnDescription:`
<p>A <a
...
Labels for position (index) of the end of the labelled span for computing the token classification loss.
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/v4.23.1/src/transformers/models/roberta/modeling_tf_roberta.py#L1642",returnDescription:`
<p>A <a
...
Whether or not to return a <a href="/docs/transformers/v4.23.1/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/v4.23.1/src/transformers/models/roberta/modeling_flax_roberta.py#L815",returnDescription:`
<p>A <a
...
model. Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/v4.23.1/en/main_classes/model#transformers.FlaxPreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/v4.23.1/src/transformers/models/xlm_roberta/modeling_flax_xlm_roberta.py#L81"}}),Ri=new A({props:{name:"__call__",anchor:"transformers.FlaxXLMRobertaForMaskedLM.__call__",parameters:[{name:"input_ids",val:""},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"encoder_hidden_states",val:" = None"},{name:"encoder_attention_mask",val:" = None"},{name:"params",val:": dict = None"},{name:"dropout_rng",val:": PRNGKey = None"},{name:"train",val:": bool = False"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"past_key_values",val:": dict = None"}],parametersDescription:[{anchor:"transformers.FlaxXLMRobertaForMaskedLM.__call__.input_ids",description:`<strong>input_ids</strong> (<code>numpy.ndarray</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/v4.23.1/en/model_doc/bert#transformers.BertTokenizer">BertTokenizer</a>. See <a href="/docs/transformers/v4.23.1/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/v4.23.1/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
model. Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/v4.23.1/en/main_classes/model#transformers.FlaxPreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/v4.23.1/src/transformers/models/xlm_roberta/modeling_flax_xlm_roberta.py#L129"}}),il=new A({props:{name:"__call__",anchor:"transformers.FlaxXLMRobertaForTokenClassification.__call__",parameters:[{name:"input_ids",val:""},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"encoder_hidden_states",val:" = None"},{name:"encoder_attention_mask",val:" = None"},{name:"params",val:": dict = None"},{name:"dropout_rng",val:": PRNGKey = None"},{name:"train",val:": bool = False"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"past_key_values",val:": dict = None"}],parametersDescription:[{anchor:"transformers.FlaxXLMRobertaForTokenClassification.__call__.input_ids",description:`<strong>input_ids</strong> (<code>numpy.ndarray</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/v4.23.1/en/model_doc/bert#transformers.BertTokenizer">BertTokenizer</a>. See <a href="/docs/transformers/v4.23.1/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/v4.23.1/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
model. Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/v4.23.1/en/main_classes/model#transformers.FlaxPreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/v4.23.1/src/transformers/models/xlm_roberta/modeling_flax_xlm_roberta.py#L145"}}),bl=new A({props:{name:"__call__",anchor:"transformers.FlaxXLMRobertaForQuestionAnswering.__call__",parameters:[{name:"input_ids",val:""},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"encoder_hidden_states",val:" = None"},{name:"encoder_attention_mask",val:" = None"},{name:"params",val:": dict = None"},{name:"dropout_rng",val:": PRNGKey = None"},{name:"train",val:": bool = False"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"past_key_values",val:": dict = None"}],parametersDescription:[{anchor:"transformers.FlaxXLMRobertaForQuestionAnswering.__call__.input_ids",description:`<strong>input_ids</strong> (<code>numpy.ndarray</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/v4.23.1/en/model_doc/bert#transformers.BertTokenizer">BertTokenizer</a>. See <a href="/docs/transformers/v4.23.1/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/v4.23.1/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
alongside usage examples.`),Gv=c(),Lt=s("div"),y(Cr.$$.fragment),Yv=c(),Qo=s("p"),Zv=o("The "),gd=s("a"),ey=o("TFRobertaForMaskedLM"),ty=o(" forward method, overrides the "),ip=s("code"),oy=o("__call__"),ny=o(" special method."),sy=c(),y(ns.$$.fragment),ay=c(),y(ss.$$.fragment),ry=c(),y(as.$$.fragment),qu=c(),Ho=s("h2"),rs=s("a"),lp=s("span"),y(jr.$$.fragment),iy=c(),dp=s("span"),ly=o("TFXLMRobertaForSequenceClassification"),Cu=c(),rt=s("div"),y(Xr.$$.fragment),dy=c(),cp=s("p"),cy=o(`XLM-RoBERTa Model transformer with a sequence classification/regression head on top (a linear layer on top of the
pooled output) e.g. for GLUE tasks.`),py=c(),Pr=s("p"),hy=o("This model inherits from "),_d=s("a"),uy=o("TFPreTrainedModel"),my=o(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
alongside usage examples.`),Gy=c(),Ht=s("div"),y(Hr.$$.fragment),Yy=c(),Jo=s("p"),Zy=o("The "),Td=s("a"),eT=o("TFRobertaForMultipleChoice"),tT=o(" forward method, overrides the "),fp=s("code"),oT=o("__call__"),nT=o(" special method."),sT=c(),y(us.$$.fragment),aT=c(),y(ms.$$.fragment),Pu=c(),Go=s("h2"),fs=s("a"),gp=s("span"),y(Kr.$$.fragment),rT=c(),_p=s("span"),iT=o("TFXLMRobertaForTokenClassification"),Au=c(),lt=s("div"),y(Vr.$$.fragment),lT=c(),bp=s("p"),dT=o(`XLM-RoBERTa Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g.
for Named-Entity-Recognition (NER) tasks.`),cT=c(),Jr=s("p"),pT=o("This model inherits from "),wd=s("a"),hT=o("TFPreTrainedModel"),uT=o(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),mT=c(),Gr=s("p"),fT=o("This model is also a "),Yr=s("a"),gT=o("tf.keras.Model"),_T=o(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
...
documentation alongside usage examples.`),wT=c(),zt=s("div"),y(ei.$$.fragment),$T=c(),Yo=s("p"),MT=o("The "),Md=s("a"),FT=o("TFRobertaForTokenClassification"),xT=o(" forward method, overrides the "),kp=s("code"),RT=o("__call__"),LT=o(" special method."),ET=c(),y(_s.$$.fragment),zT=c(),y(bs.$$.fragment),qT=c(),y(ks.$$.fragment),Ou=c(),Zo=s("h2"),vs=s("a"),vp=s("span"),y(ti.$$.fragment),CT=c(),yp=s("span"),jT=o("TFXLMRobertaForQuestionAnswering"),Nu=c(),dt=s("div"),y(oi.$$.fragment),XT=c(),en=s("p"),PT=o(`XLM-RoBERTa Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
...
documentation alongside usage examples.`),ew=c(),qt=s("div"),y(ii.$$.fragment),tw=c(),tn=s("p"),ow=o("The "),xd=s("a"),nw=o("TFRobertaForQuestionAnswering"),sw=o(" forward method, overrides the "),Mp=s("code"),aw=o("__call__"),rw=o(" special method."),iw=c(),y(Ts.$$.fragment),lw=c(),y(ws.$$.fragment),dw=c(),y($s.$$.fragment),Iu=c(),on=s("h2"),Ms=s("a"),Fp=s("span"),y(li.$$.fragment),cw=c(),xp=s("span"),pw=o("FlaxXLMRobertaModel"),Du=c(),ct=s("div"),y(di.$$.fragment),hw=c(),ci=s("p"),uw=o(`The bare XLM-RoBERTa Model transformer outputting raw hidden-states without any specific head on top.
This model inherits from `),Rd=s("a"),mw=o("FlaxPreTrainedModel"),fw=o(`. Check the superclass documentation for the generic methods the
...
general usage and behavior.`),vw=c(),Rp=s("p"),yw=o("Finally, this model supports inherent JAX features such as:"),Tw=c(),lo=s("ul"),Lp=s("li"),ui=s("a"),ww=o("Just-In-Time (JIT) compilation"),$w=c(),Ep=s("li"),mi=s("a"),Mw=o("Automatic Differentiation"),Fw=c(),zp=s("li"),fi=s("a"),xw=o("Vectorization"),Rw=c(),qp=s("li"),gi=s("a"),Lw=o("Parallelization"),Ew=c(),_i=s("p"),zw=o("This class overrides "),Ld=s("a"),qw=o("FlaxRobertaModel"),Cw=o(`. Please check the superclass for the appropriate documentation alongside
usage examples.`),jw=c(),Kt=s("div"),y(bi.$$.fragment),Xw=c(),nn=s("p"),Pw=o("The "),Cp=s("code"),Aw=o("FlaxRobertaPreTrainedModel"),Ow=o(" forward method, overrides the "),jp=s("code"),Nw=o("__call__"),Iw=o(" special method."),Dw=c(),y(Fs.$$.fragment),Sw=c(),y(xs.$$.fragment),Su=c(),sn=s("h2"),Rs=s("a"),Xp=s("span"),y(ki.$$.fragment),Bw=c(),Pp=s("span"),Ww=o("FlaxXLMRobertaForMaskedLM"),Bu=c(),pt=s("div"),y(vi.$$.fragment),Uw=c(),an=s("p"),Qw=o("XLM-RoBERTa Model with a "),Ap=s("code"),Hw=o("language modeling"),Kw=o(` head on top.
...
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),Gw=c(),yi=s("p"),Yw=o("This model is also a Flax Linen "),Ti=s("a"),Zw=o("flax.linen.Module"),e1=o(`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),t1=c(),Op=s("p"),o1=o("Finally, this model supports inherent JAX features such as:"),n1=c(),co=s("ul"),Np=s("li"),wi=s("a"),s1=o("Just-In-Time (JIT) compilation"),a1=c(),Ip=s("li"),$i=s("a"),r1=o("Automatic Differentiation"),i1=c(),Dp=s("li"),Mi=s("a"),l1=o("Vectorization"),d1=c(),Sp=s("li"),Fi=s("a"),c1=o("Parallelization"),p1=c(),xi=s("p"),h1=o("This class overrides "),zd=s("a"),u1=o("FlaxRobertaForMaskedLM"),m1=o(`. Please check the superclass for the appropriate documentation
alongside usage examples.`),f1=c(),Vt=s("div"),y(Ri.$$.fragment),g1=c(),rn=s("p"),_1=o("The "),Bp=s("code"),b1=o("FlaxRobertaPreTrainedModel"),k1=o(" forward method, overrides the "),Wp=s("code"),v1=o("__call__"),y1=o(" special method."),T1=c(),y(Ls.$$.fragment),w1=c(),y(Es.$$.fragment),Wu=c(),ln=s("h2"),zs=s("a"),Up=s("span"),y(Li.$$.fragment),$1=c(),Qp=s("span"),M1=o("FlaxXLMRobertaForSequenceClassification"),Uu=c(),Ze=s("div"),y(Ei.$$.fragment),F1=c(),Hp=s("p"),x1=o(`XLM-RoBERTa Model transformer with a sequence classification/regression head on top (a linear layer on top of the
pooled output) e.g. for GLUE tasks.`),R1=c(),zi=s("p"),L1=o("This model inherits from "),qd=s("a"),E1=o("FlaxPreTrainedModel"),z1=o(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),q1=c(),qi=s("p"),C1=o("This model is also a Flax Linen "),Ci=s("a"),j1=o("flax.linen.Module"),X1=o(`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),P1=c(),Kp=s("p"),A1=o("Finally, this model supports inherent JAX features such as:"),O1=c(),po=s("ul"),Vp=s("li"),ji=s("a"),N1=o("Just-In-Time (JIT) compilation"),I1=c(),Jp=s("li"),Xi=s("a"),D1=o("Automatic Differentiation"),S1=c(),Gp=s("li"),Pi=s("a"),B1=o("Vectorization"),W1=c(),Yp=s("li"),Ai=s("a"),U1=o("Parallelization"),Q1=c(),Oi=s("p"),H1=o("This class overrides "),Cd=s("a"),K1=o("FlaxRobertaForSequenceClassification"),V1=o(`. Please check the superclass for the appropriate
documentation alongside usage examples.`),J1=c(),Jt=s("div"),y(Ni.$$.fragment),G1=c(),dn=s("p"),Y1=o("The "),Zp=s("code"),Z1=o("FlaxRobertaPreTrainedModel"),e2=o(" forward method, overrides the "),eh=s("code"),t2=o("__call__"),o2=o(" special method."),n2=c(),y(qs.$$.fragment),s2=c(),y(Cs.$$.fragment),Qu=c(),cn=s("h2"),js=s("a"),th=s("span"),y(Ii.$$.fragment),a2=c(),oh=s("span"),r2=o("FlaxXLMRobertaForMultipleChoice"),Hu=c(),et=s("div"),y(Di.$$.fragment),i2=c(),nh=s("p"),l2=o(`XLM-RoBERTa Model with a multiple choice classification head on top (a linear layer on top of the pooled output and
a softmax) e.g. for RocStories/SWAG tasks.`),d2=c(),Si=s("p"),c2=o("This model inherits from "),jd=s("a"),p2=o("FlaxPreTrainedModel"),h2=o(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),u2=c(),Bi=s("p"),m2=o("This model is also a Flax Linen "),Wi=s("a"),f2=o("flax.linen.Module"),g2=o(`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),_2=c(),sh=s("p"),b2=o("Finally, this model supports inherent JAX features such as:"),k2=c(),ho=s("ul"),ah=s("li"),Ui=s("a"),v2=o("Just-In-Time (JIT) compilation"),y2=c(),rh=s("li"),Qi=s("a"),T2=o("Automatic Differentiation"),w2=c(),ih=s("li"),Hi=s("a"),$2=o("Vectorization"),M2=c(),lh=s("li"),Ki=s("a"),F2=o("Parallelization"),x2=c(),Vi=s("p"),R2=o("This class overrides "),Xd=s("a"),L2=o("FlaxRobertaForMultipleChoice"),E2=o(`. Please check the superclass for the appropriate
documentation alongside usage examples.`),z2=c(),Gt=s("div"),y(Ji.$$.fragment),q2=c(),pn=s("p"),C2=o("The "),dh=s("code"),j2=o("FlaxRobertaPreTrainedModel"),X2=o(" forward method, overrides the "),ch=s("code"),P2=o("__call__"),A2=o(" special method."),O2=c(),y(Xs.$$.fragment),N2=c(),y(Ps.$$.fragment),Ku=c(),hn=s("h2"),As=s("a"),ph=s("span"),y(Gi.$$.fragment),I2=c(),hh=s("span"),D2=o("FlaxXLMRobertaForTokenClassification"),Vu=c(),tt=s("div"),y(Yi.$$.fragment),S2=c(),uh=s("p"),B2=o(`XLM-RoBERTa Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g.
for Named-Entity-Recognition (NER) tasks.`),W2=c(),Zi=s("p"),U2=o("This model inherits from "),Pd=s("a"),Q2=o("FlaxPreTrainedModel"),H2=o(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),K2=c(),el=s("p"),V2=o("This model is also a Flax Linen "),tl=s("a"),J2=o("flax.linen.Module"),G2=o(`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),Y2=c(),mh=s("p"),Z2=o("Finally, this model supports inherent JAX features such as:"),e$=c(),uo=s("ul"),fh=s("li"),ol=s("a"),t$=o("Just-In-Time (JIT) compilation"),o$=c(),gh=s("li"),nl=s("a"),n$=o("Automatic Differentiation"),s$=c(),_h=s("li"),sl=s("a"),a$=o("Vectorization"),r$=c(),bh=s("li"),al=s("a"),i$=o("Parallelization"),l$=c(),rl=s("p"),d$=o("This class overrides "),Ad=s("a"),c$=o("FlaxRobertaForTokenClassification"),p$=o(`. Please check the superclass for the appropriate
documentation alongside usage examples.`),h$=c(),Yt=s("div"),y(il.$$.fragment),u$=c(),un=s("p"),m$=o("The "),kh=s("code"),f$=o("FlaxRobertaPreTrainedModel"),g$=o(" forward method, overrides the "),vh=s("code"),_$=o("__call__"),b$=o(" special method."),k$=c(),y(Os.$$.fragment),v$=c(),y(Ns.$$.fragment),Ju=c(),mn=s("h2"),Is=s("a"),yh=s("span"),y(ll.$$.fragment),y$=c(),Th=s("span"),T$=o("FlaxXLMRobertaForQuestionAnswering"),Gu=c(),ot=s("div"),y(dl.$$.fragment),w$=c(),fn=s("p"),$$=o(`XLM-RoBERTa Model with a span classification head on top for extractive question-answering tasks like SQuAD (a
linear layers on top of the hidden-states output to compute `),wh=s("code"),M$=o("span start logits"),F$=o(" and "),$h=s("code"),x$=o("span end logits"),R$=o(")."),L$=c(),cl=s("p"),E$=o("This model inherits from "),Od=s("a"),z$=o("FlaxPreTrainedModel"),q$=o(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),C$=c(),pl=s("p"),j$=o("This model is also a Flax Linen "),hl=s("a"),X$=o("flax.linen.Module"),P$=o(`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),A$=c(),Mh=s("p"),O$=o("Finally, this model supports inherent JAX features such as:"),N$=c(),mo=s("ul"),Fh=s("li"),ul=s("a"),I$=o("Just-In-Time (JIT) compilation"),D$=c(),xh=s("li"),ml=s("a"),S$=o("Automatic Differentiation"),B$=c(),Rh=s("li"),fl=s("a"),W$=o("Vectorization"),U$=c(),Lh=s("li"),gl=s("a"),Q$=o("Parallelization"),H$=c(),_l=s("p"),K$=o("This class overrides "),Nd=s("a"),V$=o("FlaxRobertaForQuestionAnswering"),J$=o(`. Please check the superclass for the appropriate
documentation alongside usage examples.`),G$=c(),Zt=s("div"),y(bl.$$.fragment),Y$=c(),gn=s("p"),Z$=o("The "),Eh=s("code"),eM=o("FlaxRobertaPreTrainedModel"),tM=o(" forward method, overrides the "),zh=s("code"),oM=o("__call__"),nM=o(" special method."),sM=c(),y(Ds.$$.fragment),aM=c(),y(Ss.$$.fragment),this.h()},l(i){const b=j4('[data-svelte="svelte-1phssyn"]',document.head);d=a(b,"META",{name:!0,content:!0}),b.forEach(t),g=p(i),h=a(i,"H1",{class:!0});var kl=r(h);f=a(kl,"A",{id:!0,class:!0,href:!0});var qh=r(f);k=a(qh,"SPAN",{});var Ch=r(k);T(l.$$.fragment,Ch),Ch.forEach(t),qh.forEach(t),u=p(kl),L=a(kl,"SPAN",{});var jh=r(L);$e=n(jh,"XLM-RoBERTa"),jh.forEach(t),kl.forEach(t),be=p(i),O=a(i,"H2",{class:!0});var vl=r(O);re=a(vl,"A",{id:!0,class:!0,href:!0});var Xh=r(re);te=a(Xh,"SPAN",{});var Ph=r(te);T(R.$$.fragment,Ph),Ph.forEach(t),Xh.forEach(t),Me=p(vl),U=a(vl,"SPAN",{});var Ah=r(U);Fe=n(Ah,"Overview"),Ah.forEach(t),vl.forEach(t),ke=p(i),D=a(i,"P",{});var yl=r(D);xe=n(yl,"The XLM-RoBERTa model was proposed in "),de=a(yl,"A",{href:!0,rel:!0});var Oh=r(de);H=n(Oh,"Unsupervised Cross-lingual Representation Learning at Scale"),Oh.forEach(t),Re=n(yl,` by Alexis Conneau, Kartikay Khandelwal, Naman Goyal, Vishrav Chaudhary, Guillaume
Wenzek, Francisco Guzm\xE1n, Edouard Grave, Myle Ott, Luke Zettlemoyer and Veselin Stoyanov. It is based on Facebook\u2019s
RoBERTa model released in 2019. It is a large multi-lingual language model, trained on 2.5TB of filtered CommonCrawl
...
alongside usage examples.`),Dm.forEach(t),Gv=p(Xt),Lt=a(Xt,"DIV",{class:!0});var wo=r(Lt);T(Cr.$$.fragment,wo),Yv=p(wo),Qo=a(wo,"P",{});var Yd=r(Qo);Zv=n(Yd,"The "),gd=a(Yd,"A",{href:!0});var QF=r(gd);ey=n(QF,"TFRobertaForMaskedLM"),QF.forEach(t),ty=n(Yd," forward method, overrides the "),ip=a(Yd,"CODE",{});var HF=r(ip);oy=n(HF,"__call__"),HF.forEach(t),ny=n(Yd," special method."),Yd.forEach(t),sy=p(wo),T(ns.$$.fragment,wo),ay=p(wo),T(ss.$$.fragment,wo),ry=p(wo),T(as.$$.fragment,wo),wo.forEach(t),Xt.forEach(t),qu=p(i),Ho=a(i,"H2",{class:!0});var Sm=r(Ho);rs=a(Sm,"A",{id:!0,class:!0,href:!0});var KF=r(rs);lp=a(KF,"SPAN",{});var VF=r(lp);T(jr.$$.fragment,VF),VF.forEach(t),KF.forEach(t),iy=p(Sm),dp=a(Sm,"SPAN",{});var JF=r(dp);ly=n(JF,"TFXLMRobertaForSequenceClassification"),JF.forEach(t),Sm.forEach(t),Cu=p(i),rt=a(i,"DIV",{class:!0});var Pt=r(rt);T(Xr.$$.fragment,Pt),dy=p(Pt),cp=a(Pt,"P",{});var GF=r(cp);cy=n(GF,`XLM-RoBERTa Model transformer with a sequence classification/regression head on top (a linear layer on top of the
pooled output) e.g. for GLUE tasks.`),GF.forEach(t),py=p(Pt),Pr=a(Pt,"P",{});var Bm=r(Pr);hy=n(Bm,"This model inherits from "),_d=a(Bm,"A",{href:!0});var YF=r(_d);uy=n(YF,"TFPreTrainedModel"),YF.forEach(t),my=n(Bm,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Bm.forEach(t),fy=p(Pt),Ar=a(Pt,"P",{});var Wm=r(Ar);gy=n(Wm,"This model is also a "),Or=a(Wm,"A",{href:!0,rel:!0});var ZF=r(Or);_y=n(ZF,"tf.keras.Model"),ZF.forEach(t),by=n(Wm,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Wm.forEach(t),ky=p(Pt),T(is.$$.fragment,Pt),vy=p(Pt),Nr=a(Pt,"P",{});var Um=r(Nr);yy=n(Um,"This class overrides "),bd=a(Um,"A",{href:!0});var e0=r(bd);Ty=n(e0,"TFRobertaForSequenceClassification"),e0.forEach(t),wy=n(Um,`. Please check the superclass for the appropriate
documentation alongside usage examples.`),Um.forEach(t),$y=p(Pt),Et=a(Pt,"DIV",{class:!0});var $o=r(Et);T(Ir.$$.fragment,$o),My=p($o),Ko=a($o,"P",{});var Zd=r(Ko);Fy=n(Zd,"The "),kd=a(Zd,"A",{href:!0});var t0=r(kd);xy=n(t0,"TFRobertaForSequenceClassification"),t0.forEach(t),Ry=n(Zd," forward method, overrides the "),pp=a(Zd,"CODE",{});var o0=r(pp);Ly=n(o0,"__call__"),o0.forEach(t),Ey=n(Zd," special method."),Zd.forEach(t),zy=p($o),T(ls.$$.fragment,$o),qy=p($o),T(ds.$$.fragment,$o),Cy=p($o),T(cs.$$.fragment,$o),$o.forEach(t),Pt.forEach(t),ju=p(i),Vo=a(i,"H2",{class:!0});var Qm=r(Vo);ps=a(Qm,"A",{id:!0,class:!0,href:!0});var n0=r(ps);hp=a(n0,"SPAN",{});var s0=r(hp);T(Dr.$$.fragment,s0),s0.forEach(t),n0.forEach(t),jy=p(Qm),up=a(Qm,"SPAN",{});var a0=r(up);Xy=n(a0,"TFXLMRobertaForMultipleChoice"),a0.forEach(t),Qm.forEach(t),Xu=p(i),it=a(i,"DIV",{class:!0});var At=r(it);T(Sr.$$.fragment,At),Py=p(At),mp=a(At,"P",{});var r0=r(mp);Ay=n(r0,`Roberta Model with a multiple choice classification head on top (a linear layer on top of the pooled output and a
softmax) e.g. for RocStories/SWAG tasks.`),r0.forEach(t),Oy=p(At),Br=a(At,"P",{});var Hm=r(Br);Ny=n(Hm,"This model inherits from "),vd=a(Hm,"A",{href:!0});var i0=r(vd);Iy=n(i0,"TFPreTrainedModel"),i0.forEach(t),Dy=n(Hm,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Hm.forEach(t),Sy=p(At),Wr=a(At,"P",{});var Km=r(Wr);By=n(Km,"This model is also a "),Ur=a(Km,"A",{href:!0,rel:!0});var l0=r(Ur);Wy=n(l0,"tf.keras.Model"),l0.forEach(t),Uy=n(Km,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Km.forEach(t),Qy=p(At),T(hs.$$.fragment,At),Hy=p(At),Qr=a(At,"P",{});var Vm=r(Qr);Ky=n(Vm,"This class overrides "),yd=a(Vm,"A",{href:!0});var d0=r(yd);Vy=n(d0,"TFRobertaForMultipleChoice"),d0.forEach(t),Jy=n(Vm,`. Please check the superclass for the appropriate documentation
alongside usage examples.`),Vm.forEach(t),Gy=p(At),Ht=a(At,"DIV",{class:!0});var Hs=r(Ht);T(Hr.$$.fragment,Hs),Yy=p(Hs),Jo=a(Hs,"P",{});var ec=r(Jo);Zy=n(ec,"The "),Td=a(ec,"A",{href:!0});var c0=r(Td);eT=n(c0,"TFRobertaForMultipleChoice"),c0.forEach(t),tT=n(ec," forward method, overrides the "),fp=a(ec,"CODE",{});var p0=r(fp);oT=n(p0,"__call__"),p0.forEach(t),nT=n(ec," special method."),ec.forEach(t),sT=p(Hs),T(us.$$.fragment,Hs),aT=p(Hs),T(ms.$$.fragment,Hs),Hs.forEach(t),At.forEach(t),Pu=p(i),Go=a(i,"H2",{class:!0});var Jm=r(Go);fs=a(Jm,"A",{id:!0,class:!0,href:!0});var h0=r(fs);gp=a(h0,"SPAN",{});var u0=r(gp);T(Kr.$$.fragment,u0),u0.forEach(t),h0.forEach(t),rT=p(Jm),_p=a(Jm,"SPAN",{});var m0=r(_p);iT=n(m0,"TFXLMRobertaForTokenClassification"),m0.forEach(t),Jm.forEach(t),Au=p(i),lt=a(i,"DIV",{class:!0});var Ot=r(lt);T(Vr.$$.fragment,Ot),lT=p(Ot),bp=a(Ot,"P",{});var f0=r(bp);dT=n(f0,`XLM-RoBERTa Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g.
for Named-Entity-Recognition (NER) tasks.`),f0.forEach(t),cT=p(Ot),Jr=a(Ot,"P",{});var Gm=r(Jr);pT=n(Gm,"This model inherits from "),wd=a(Gm,"A",{href:!0});var g0=r(wd);hT=n(g0,"TFPreTrainedModel"),g0.forEach(t),uT=n(Gm,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Gm.forEach(t),mT=p(Ot),Gr=a(Ot,"P",{});var Ym=r(Gr);fT=n(Ym,"This model is also a "),Yr=a(Ym,"A",{href:!0,rel:!0});var _0=r(Yr);gT=n(_0,"tf.keras.Model"),_0.forEach(t),_T=n(Ym,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Ym.forEach(t),bT=p(Ot),T(gs.$$.fragment,Ot),kT=p(Ot),Zr=a(Ot,"P",{});var Zm=r(Zr);vT=n(Zm,"This class overrides "),$d=a(Zm,"A",{href:!0});var b0=r($d);yT=n(b0,"TFRobertaForTokenClassification"),b0.forEach(t),TT=n(Zm,`. Please check the superclass for the appropriate
documentation alongside usage examples.`),Zm.forEach(t),wT=p(Ot),zt=a(Ot,"DIV",{class:!0});var Mo=r(zt);T(ei.$$.fragment,Mo),$T=p(Mo),Yo=a(Mo,"P",{});var tc=r(Yo);MT=n(tc,"The "),Md=a(tc,"A",{href:!0});var k0=r(Md);FT=n(k0,"TFRobertaForTokenClassification"),k0.forEach(t),xT=n(tc," forward method, overrides the "),kp=a(tc,"CODE",{});var v0=r(kp);RT=n(v0,"__call__"),v0.forEach(t),LT=n(tc," special method."),tc.forEach(t),ET=p(Mo),T(_s.$$.fragment,Mo),zT=p(Mo),T(bs.$$.fragment,Mo),qT=p(Mo),T(ks.$$.fragment,Mo),Mo.forEach(t),Ot.forEach(t),Ou=p(i),Zo=a(i,"H2",{class:!0});var ef=r(Zo);vs=a(ef,"A",{id:!0,class:!0,href:!0});var y0=r(vs);vp=a(y0,"SPAN",{});var T0=r(vp);T(ti.$$.fragment,T0),T0.forEach(t),y0.forEach(t),CT=p(ef),yp=a(ef,"SPAN",{});var w0=r(yp);jT=n(w0,"TFXLMRobertaForQuestionAnswering"),w0.forEach(t),ef.forEach(t),Nu=p(i),dt=a(i,"DIV",{class:!0});var Nt=r(dt);T(oi.$$.fragment,Nt),XT=p(Nt),en=a(Nt,"P",{});var oc=r(en);PT=n(oc,`XLM-RoBERTa Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
...
documentation alongside usage examples.`),nf.forEach(t),ew=p(Nt),qt=a(Nt,"DIV",{class:!0});var Fo=r(qt);T(ii.$$.fragment,Fo),tw=p(Fo),tn=a(Fo,"P",{});var nc=r(tn);ow=n(nc,"The "),xd=a(nc,"A",{href:!0});var L0=r(xd);nw=n(L0,"TFRobertaForQuestionAnswering"),L0.forEach(t),sw=n(nc," forward method, overrides the "),Mp=a(nc,"CODE",{});var E0=r(Mp);aw=n(E0,"__call__"),E0.forEach(t),rw=n(nc," special method."),nc.forEach(t),iw=p(Fo),T(Ts.$$.fragment,Fo),lw=p(Fo),T(ws.$$.fragment,Fo),dw=p(Fo),T($s.$$.fragment,Fo),Fo.forEach(t),Nt.forEach(t),Iu=p(i),on=a(i,"H2",{class:!0});var sf=r(on);Ms=a(sf,"A",{id:!0,class:!0,href:!0});var z0=r(Ms);Fp=a(z0,"SPAN",{});var q0=r(Fp);T(li.$$.fragment,q0),q0.forEach(t),z0.forEach(t),cw=p(sf),xp=a(sf,"SPAN",{});var C0=r(xp);pw=n(C0,"FlaxXLMRobertaModel"),C0.forEach(t),sf.forEach(t),Du=p(i),ct=a(i,"DIV",{class:!0});var It=r(ct);T(di.$$.fragment,It),hw=p(It),ci=a(It,"P",{});var af=r(ci);uw=n(af,`The bare XLM-RoBERTa Model transformer outputting raw hidden-states without any specific head on top.
This model inherits from `),Rd=a(af,"A",{href:!0});var j0=r(Rd);mw=n(j0,"FlaxPreTrainedModel"),j0.forEach(t),fw=n(af,`. Check the superclass documentation for the generic methods the
