...
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-built_in">print</span>(model.config.id2label[predicted_label])
tabby, tabby cat`}}),{c(){d=s("p"),v=i("Example:"),p=f(),b(h.$$.fragment)},l(a){d=r(a,"P",{});var c=n(d);v=l(c,"Example:"),c.forEach(o),p=u(a),w(h.$$.fragment,a)},m(a,c){T(a,d,c),e(d,v),T(a,p,c),$(h,a,c),_=!0},p:je,i(a){_||(y(h.$$.fragment,a),_=!0)},o(a){D(h.$$.fragment,a),_=!1},d(a){a&&o(d),a&&o(p),F(h,a)}}}function hh(k){let d,v,p,h,_,a,c,x,hr,_s,Pe,Ts,ne,qe,la,$t,pr,da,mr,vs,W,fr,yt,ur,gr,Fo,_r,Tr,Dt,vr,br,bs,ko,wr,ws,xo,ca,$r,$s,Io,yr,ys,q,ha,Dr,Fr,ie,kr,Mo,xr,Ir,Eo,Mr,Er,jr,pa,Cr,Pr,ma,qr,zr,I,Ar,jo,Nr,Or,Co,Lr,Wr,fa,Sr,Vr,ua,Br,Hr,ga,Ur,Rr,_a,Jr,Gr,Po,Kr,Xr,Ds,ae,Zr,Ft,Qr,Yr,kt,en,tn,Fs,le,ze,Ta,xt,on,va,an,ks,z,It,sn,de,rn,qo,nn,ln,Mt,dn,cn,hn,ce,pn,zo,mn,fn,Ao,un,gn,_n,Ae,xs,he,Ne,ba,Et,Tn,wa,vn,Is,A,jt,bn,$a,wn,$n,Ct,yn,No,Dn,Fn,kn,se,Pt,xn,ya,In,Mn,Oe,Ms,pe,Le,Da,qt,En,Fa,jn,Es,Q,zt,Cn,At,Pn,Nt,qn,zn,An,S,Ot,Nn,me,On,Oo,Ln,Wn,ka,Sn,Vn,Bn,We,Hn,Se,js,fe,Ve,xa,Lt,Un,Ia,Rn,Cs,P,Wt,Jn,St,Gn,Vt,Kn,Xn,Zn,Be,Qn,Bt,Yn,Ht,ei,ti,oi,V,Ut,ai,ue,si,Lo,ri,ni,Ma,ii,li,di,He,ci,Ue,Ps,ge,Re,Ea,Rt,hi,ja,pi,qs,N,Jt,mi,Ca,fi,ui,Gt,gi,Kt,_i,Ti,vi,B,Xt,bi,_e,wi,Wo,$i,yi,Pa,Di,Fi,ki,Je,xi,Ge,zs,Te,Ke,qa,Zt,Ii,za,Mi,As,E,Qt,Ei,Aa,ji,Ci,Na,Pi,qi,Oa,zi,Ai,Yt,Ni,eo,Oi,Li,Wi,H,to,Si,ve,Vi,So,Bi,Hi,La,Ui,Ri,Ji,Xe,Gi,Ze,Ns,be,Qe,Wa,oo,Ki,Sa,Xi,Os,Y,ao,Zi,so,Qi,ro,Yi,el,tl,U,no,ol,we,al,Vo,sl,rl,Va,nl,il,ll,Ye,dl,et,Ls,$e,tt,Ba,io,cl,Ha,hl,Ws,ee,lo,pl,ye,ml,co,fl,ul,ho,gl,_l,Tl,R,po,vl,De,bl,Bo,wl,$l,Ua,yl,Dl,Fl,ot,kl,at,Ss,Fe,st,Ra,mo,xl,Ja,Il,Vs,O,fo,Ml,Ga,El,jl,uo,Cl,go,Pl,ql,zl,J,_o,Al,ke,Nl,Ho,Ol,Ll,Ka,Wl,Sl,Vl,rt,Bl,nt,Bs,xe,it,Xa,To,Hl,Za,Ul,Hs,j,vo,Rl,Qa,Jl,Gl,Ya,Kl,Xl,es,Zl,Ql,bo,Yl,wo,ed,td,od,G,$o,ad,Ie,sd,Uo,rd,nd,ts,id,ld,dd,lt,cd,dt,Us;return a=new Z({}),Pe=new oe({props:{$$slots:{default:[Uc]},$$scope:{ctx:k}}}),$t=new Z({}),xt=new Z({}),It=new M({props:{name:"class transformers.DeiTConfig",anchor:"transformers.DeiTConfig",parameters:[{name:"hidden_size",val:" = 768"},{name:"num_hidden_layers",val:" = 12"},{name:"num_attention_heads",val:" = 12"},{name:"intermediate_size",val:" = 3072"},{name:"hidden_act",val:" = 'gelu'"},{name:"hidden_dropout_prob",val:" = 0.0"},{name:"attention_probs_dropout_prob",val:" = 0.0"},{name:"initializer_range",val:" = 0.02"},{name:"layer_norm_eps",val:" = 1e-12"},{name:"is_encoder_decoder",val:" = False"},{name:"image_size",val:" = 224"},{name:"patch_size",val:" = 16"},{name:"num_channels",val:" = 3"},{name:"qkv_bias",val:" = True"},{name:"encoder_stride",val:" = 16"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.DeiTConfig.hidden_size",description:`<strong>hidden_size</strong> (<code>int</code>, <em>optional</em>, defaults to 768) &#x2014;
...
</ul>`,name:"return_tensors"}],source:"https://github.com/huggingface/transformers/blob/v4.23.1/src/transformers/models/deit/feature_extraction_deit.py#L91",returnDescription:`
<p>A <a
...
Whether or not to return a <a href="/docs/transformers/v4.23.1/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/v4.23.1/src/transformers/models/deit/modeling_deit.py#L480",returnDescription:`
<p>A <a
...
elements depending on the configuration (<a
  href="/docs/transformers/v4.23.1/en/model_doc/deit#transformers.DeiTConfig"
...
Boolean masked positions. Indicates which patches are masked (1) and which aren&#x2019;t (0).`,name:"bool_masked_pos"}],source:"https://github.com/huggingface/transformers/blob/v4.23.1/src/transformers/models/deit/modeling_deit.py#L585",returnDescription:`
<p>A <a
...
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.23.1/src/transformers/models/deit/modeling_deit.py#L692",returnDescription:`
<p>A <a
...
Whether or not to return a <a href="/docs/transformers/v4.23.1/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/v4.23.1/src/transformers/models/deit/modeling_deit.py#L846",returnDescription:`
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/v4.23.1/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/v4.23.1/src/transformers/models/deit/modeling_tf_deit.py#L641"}}),no=new M({props:{name:"call",anchor:"transformers.TFDeiTModel.call",parameters:[{name:"pixel_values",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"bool_masked_pos",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"head_mask",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"training",val:": bool = False"}],parametersDescription:[{anchor:"transformers.TFDeiTModel.call.pixel_values",description:`<strong>pixel_values</strong> (<code>tf.Tensor</code> of shape <code>(batch_size, num_channels, height, width)</code>) &#x2014;
Pixel values. Pixel values can be obtained using <a href="/docs/transformers/v4.23.1/en/model_doc/deit#transformers.DeiTFeatureExtractor">DeiTFeatureExtractor</a>. See
...
Whether or not to return a <a href="/docs/transformers/v4.23.1/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/v4.23.1/src/transformers/models/deit/modeling_tf_deit.py#L651",returnDescription:`
<p>A <a
...
Boolean masked positions. Indicates which patches are masked (1) and which aren&#x2019;t (0).`,name:"bool_masked_pos"}],source:"https://github.com/huggingface/transformers/blob/v4.23.1/src/transformers/models/deit/modeling_tf_deit.py#L768",returnDescription:`
<p>A <a
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/v4.23.1/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/v4.23.1/src/transformers/models/deit/modeling_tf_deit.py#L882"}}),_o=new M({props:{name:"call",anchor:"transformers.TFDeiTForImageClassification.call",parameters:[{name:"pixel_values",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"head_mask",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"labels",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"training",val:": bool = False"}],parametersDescription:[{anchor:"transformers.TFDeiTForImageClassification.call.pixel_values",description:`<strong>pixel_values</strong> (<code>tf.Tensor</code> of shape <code>(batch_size, num_channels, height, width)</code>) &#x2014;
Pixel values. Pixel values can be obtained using <a href="/docs/transformers/v4.23.1/en/model_doc/deit#transformers.DeiTFeatureExtractor">DeiTFeatureExtractor</a>. See
...
Labels for computing the image classification/regression loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>. If <code>config.num_labels == 1</code> a regression loss is computed (Mean-Square loss), If
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.23.1/src/transformers/models/deit/modeling_tf_deit.py#L896",returnDescription:`
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/v4.23.1/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/v4.23.1/src/transformers/models/deit/modeling_tf_deit.py#L990"}}),$o=new M({props:{name:"call",anchor:"transformers.TFDeiTForImageClassificationWithTeacher.call",parameters:[{name:"pixel_values",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"head_mask",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"training",val:": bool = False"}],parametersDescription:[{anchor:"transformers.TFDeiTForImageClassificationWithTeacher.call.pixel_values",description:`<strong>pixel_values</strong> (<code>tf.Tensor</code> of shape <code>(batch_size, num_channels, height, width)</code>) &#x2014;
Pixel values. Pixel values can be obtained using <a href="/docs/transformers/v4.23.1/en/model_doc/deit#transformers.DeiTFeatureExtractor">DeiTFeatureExtractor</a>. See
...
Whether or not to return a <a href="/docs/transformers/v4.23.1/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/v4.23.1/src/transformers/models/deit/modeling_tf_deit.py#L1009",returnDescription:`
...
`),fa=s("em"),Sr=i("facebook/deit-tiny-patch16-224"),Vr=i(", "),ua=s("em"),Br=i("facebook/deit-small-patch16-224"),Hr=i(", "),ga=s("em"),Ur=i("facebook/deit-base-patch16-224"),Rr=i(` and
...
behavior.`),An=f(),S=s("div"),b(Ot.$$.fragment),Nn=f(),me=s("p"),On=i("The "),Oo=s("a"),Ln=i("DeiTModel"),Wn=i(" forward method, overrides the "),ka=s("code"),Sn=i("__call__"),Vn=i(" special method."),Bn=f(),b(We.$$.fragment),Hn=f(),b(Se.$$.fragment),js=f(),fe=s("h2"),Ve=s("a"),xa=s("span"),b(Lt.$$.fragment),Un=f(),Ia=s("span"),Rn=i("DeiTForMaskedImageModeling"),Cs=f(),P=s("div"),b(Wt.$$.fragment),Jn=f(),St=s("p"),Gn=i("DeiT Model with a decoder on top for masked image modeling, as proposed in "),Vt=s("a"),Kn=i("SimMIM"),Xn=i("."),Zn=f(),b(Be.$$.fragment),Qn=f(),Bt=s("p"),Yn=i("This model is a PyTorch "),Ht=s("a"),ei=i("torch.nn.Module"),ti=i(` subclass. Use it
as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),oi=f(),V=s("div"),b(Ut.$$.fragment),ai=f(),ue=s("p"),si=i("The "),Lo=s("a"),ri=i("DeiTForMaskedImageModeling"),ni=i(" forward method, overrides the "),Ma=s("code"),ii=i("__call__"),li=i(" special method."),di=f(),b(He.$$.fragment),ci=f(),b(Ue.$$.fragment),Ps=f(),ge=s("h2"),Re=s("a"),Ea=s("span"),b(Rt.$$.fragment),hi=f(),ja=s("span"),pi=i("DeiTForImageClassification"),qs=f(),N=s("div"),b(Jt.$$.fragment),mi=f(),Ca=s("p"),fi=i(`DeiT Model transformer with an image classification head on top (a linear layer on top of the final hidden state of
...
as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),Wi=f(),H=s("div"),b(to.$$.fragment),Si=f(),ve=s("p"),Vi=i("The "),So=s("a"),Bi=i("DeiTForImageClassificationWithTeacher"),Hi=i(" forward method, overrides the "),La=s("code"),Ui=i("__call__"),Ri=i(" special method."),Ji=f(),b(Xe.$$.fragment),Gi=f(),b(Ze.$$.fragment),Ns=f(),be=s("h2"),Qe=s("a"),Wa=s("span"),b(oo.$$.fragment),Ki=f(),Sa=s("span"),Xi=i("TFDeiTModel"),Os=f(),Y=s("div"),b(ao.$$.fragment),Zi=f(),so=s("p"),Qi=i(`The bare DeiT Model transformer outputting raw hidden-states without any specific head on top.
This model is a TensorFlow
`),ro=s("a"),Yi=i("tf.keras.layers.Layer"),el=i(`. Use it as a regular
TensorFlow Module and refer to the TensorFlow documentation for all matter related to general usage and behavior.`),tl=f(),U=s("div"),b(no.$$.fragment),ol=f(),we=s("p"),al=i("The "),Vo=s("a"),sl=i("TFDeiTModel"),rl=i(" forward method, overrides the "),Va=s("code"),nl=i("__call__"),il=i(" special method."),ll=f(),b(Ye.$$.fragment),dl=f(),b(et.$$.fragment),Ls=f(),$e=s("h2"),tt=s("a"),Ba=s("span"),b(io.$$.fragment),cl=f(),Ha=s("span"),hl=i("TFDeiTForMaskedImageModeling"),Ws=f(),ee=s("div"),b(lo.$$.fragment),pl=f(),ye=s("p"),ml=i("DeiT Model with a decoder on top for masked image modeling, as proposed in "),co=s("a"),fl=i("SimMIM"),ul=i(`.
This model is a TensorFlow
`),ho=s("a"),gl=i("tf.keras.layers.Layer"),_l=i(`. Use it as a regular
TensorFlow Module and refer to the TensorFlow documentation for all matter related to general usage and behavior.`),Tl=f(),R=s("div"),b(po.$$.fragment),vl=f(),De=s("p"),bl=i("The "),Bo=s("a"),wl=i("TFDeiTForMaskedImageModeling"),$l=i(" forward method, overrides the "),Ua=s("code"),yl=i("__call__"),Dl=i(" special method."),Fl=f(),b(ot.$$.fragment),kl=f(),b(at.$$.fragment),Ss=f(),Fe=s("h2"),st=s("a"),Ra=s("span"),b(mo.$$.fragment),xl=f(),Ja=s("span"),Il=i("TFDeiTForImageClassification"),Vs=f(),O=s("div"),b(fo.$$.fragment),Ml=f(),Ga=s("p"),El=i(`DeiT Model transformer with an image classification head on top (a linear layer on top of the final hidden state of
...
TensorFlow Module and refer to the TensorFlow documentation for all matter related to general usage and behavior.`),zl=f(),J=s("div"),b(_o.$$.fragment),Al=f(),ke=s("p"),Nl=i("The "),Ho=s("a"),Ol=i("TFDeiTForImageClassification"),Ll=i(" forward method, overrides the "),Ka=s("code"),Wl=i("__call__"),Sl=i(" special method."),Vl=f(),b(rt.$$.fragment),Bl=f(),b(nt.$$.fragment),Bs=f(),xe=s("h2"),it=s("a"),Xa=s("span"),b(To.$$.fragment),Hl=f(),Za=s("span"),Ul=i("TFDeiTForImageClassificationWithTeacher"),Hs=f(),j=s("div"),b(vo.$$.fragment),Rl=f(),Qa=s("p"),Jl=i(`DeiT Model transformer with image classification heads on top (a linear layer on top of the final hidden state of
...
augmentation, optimization, and regularization were used in order to simulate training on a much larger dataset
(while only using ImageNet-1k for pre-training). There are 4 variants available (in 3 different sizes):
`),fa=r(C,"EM",{});var gd=n(fa);Sr=l(gd,"facebook/deit-tiny-patch16-224"),gd.forEach(o),Vr=l(C,", "),ua=r(C,"EM",{});var _d=n(ua);Br=l(_d,"facebook/deit-small-patch16-224"),_d.forEach(o),Hr=l(C,", "),ga=r(C,"EM",{});var Td=n(ga);Ur=l(Td,"facebook/deit-base-patch16-224"),Td.forEach(o),Rr=l(C,` and
...
prepare images for the model.`),C.forEach(o),L.forEach(o),Ds=u(t),ae=r(t,"P",{});var Ro=n(ae);Zr=l(Ro,"This model was contributed by "),Ft=r(Ro,"A",{href:!0,rel:!0});var wd=n(Ft);Qr=l(wd,"nielsr"),wd.forEach(o),Yr=l(Ro,". The TensorFlow version of this model was added by "),kt=r(Ro,"A",{href:!0,rel:!0});var $d=n(kt);en=l($d,"amyeroberts"),$d.forEach(o),tn=l(Ro,"."),Ro.forEach(o),Fs=u(t),le=r(t,"H2",{class:!0});var Rs=n(le);ze=r(Rs,"A",{id:!0,class:!0,href:!0});var yd=n(ze);Ta=r(yd,"SPAN",{});var Dd=n(Ta);w(xt.$$.fragment,Dd),Dd.forEach(o),yd.forEach(o),on=u(Rs),va=r(Rs,"SPAN",{});var Fd=n(va);an=l(Fd,"DeiTConfig"),Fd.forEach(o),Rs.forEach(o),ks=u(t),z=r(t,"DIV",{class:!0});var ct=n(z);w(It.$$.fragment,ct),sn=u(ct),de=r(ct,"P",{});var Jo=n(de);rn=l(Jo,"This is the configuration class to store the configuration of a "),qo=r(Jo,"A",{href:!0});var kd=n(qo);nn=l(kd,"DeiTModel"),kd.forEach(o),ln=l(Jo,`. It is used to instantiate an DeiT
model according to the specified arguments, defining the model architecture. Instantiating a configuration with the
defaults will yield a similar configuration to that of the DeiT
...
as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),Xs.forEach(o),An=u(Xo),S=r(Xo,"DIV",{class:!0});var pt=n(S);w(Ot.$$.fragment,pt),Nn=u(pt),me=r(pt,"P",{});var Zo=n(me);On=l(Zo,"The "),Oo=r(Zo,"A",{href:!0});var Wd=n(Oo);Ln=l(Wd,"DeiTModel"),Wd.forEach(o),Wn=l(Zo," forward method, overrides the "),ka=r(Zo,"CODE",{});var Sd=n(ka);Sn=l(Sd,"__call__"),Sd.forEach(o),Vn=l(Zo," special method."),Zo.forEach(o),Bn=u(pt),w(We.$$.fragment,pt),Hn=u(pt),w(Se.$$.fragment,pt),pt.forEach(o),Xo.forEach(o),js=u(t),fe=r(t,"H2",{class:!0});var Zs=n(fe);Ve=r(Zs,"A",{id:!0,class:!0,href:!0});var Vd=n(Ve);xa=r(Vd,"SPAN",{});var Bd=n(xa);w(Lt.$$.fragment,Bd),Bd.forEach(o),Vd.forEach(o),Un=u(Zs),Ia=r(Zs,"SPAN",{});var Hd=n(Ia);Rn=l(Hd,"DeiTForMaskedImageModeling"),Hd.forEach(o),Zs.forEach(o),Cs=u(t),P=r(t,"DIV",{class:!0});var re=n(P);w(Wt.$$.fragment,re),Jn=u(re),St=r(re,"P",{});var Qs=n(St);Gn=l(Qs,"DeiT Model with a decoder on top for masked image modeling, as proposed in "),Vt=r(Qs,"A",{href:!0,rel:!0});var Ud=n(Vt);Kn=l(Ud,"SimMIM"),Ud.forEach(o),Xn=l(Qs,"."),Qs.forEach(o),Zn=u(re),w(Be.$$.fragment,re),Qn=u(re),Bt=r(re,"P",{});var Ys=n(Bt);Yn=l(Ys,"This model is a PyTorch "),Ht=r(Ys,"A",{href:!0,rel:!0});var Rd=n(Ht);ei=l(Rd,"torch.nn.Module"),Rd.forEach(o),ti=l(Ys,` subclass. Use it
as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),Ys.forEach(o),oi=u(re),V=r(re,"DIV",{class:!0});var mt=n(V);w(Ut.$$.fragment,mt),ai=u(mt),ue=r(mt,"P",{});var Qo=n(ue);si=l(Qo,"The "),Lo=r(Qo,"A",{href:!0});var Jd=n(Lo);ri=l(Jd,"DeiTForMaskedImageModeling"),Jd.forEach(o),ni=l(Qo," forward method, overrides the "),Ma=r(Qo,"CODE",{});var Gd=n(Ma);ii=l(Gd,"__call__"),Gd.forEach(o),li=l(Qo," special method."),Qo.forEach(o),di=u(mt),w(He.$$.fragment,mt),ci=u(mt),w(Ue.$$.fragment,mt),mt.forEach(o),re.forEach(o),Ps=u(t),ge=r(t,"H2",{class:!0});var er=n(ge);Re=r(er,"A",{id:!0,class:!0,href:!0});var Kd=n(Re);Ea=r(Kd,"SPAN",{});var Xd=n(Ea);w(Rt.$$.fragment,Xd),Xd.forEach(o),Kd.forEach(o),hi=u(er),ja=r(er,"SPAN",{});var Zd=n(ja);pi=l(Zd,"DeiTForImageClassification"),Zd.forEach(o),er.forEach(o),qs=u(t),N=r(t,"DIV",{class:!0});var ft=n(N);w(Jt.$$.fragment,ft),mi=u(ft),Ca=r(ft,"P",{});var Qd=n(Ca);fi=l(Qd,`DeiT Model transformer with an image classification head on top (a linear layer on top of the final hidden state of
