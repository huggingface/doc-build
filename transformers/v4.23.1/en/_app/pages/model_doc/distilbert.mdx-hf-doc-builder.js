import{S as Z2,i as eD,s as tD,e as r,k as h,w,t as o,M as oD,c as a,d as t,m as u,a as i,x as T,h as s,b as m,G as e,g as _,y as $,q as y,o as D,B as F,v as sD,L as fe}from"../../chunks/vendor-hf-doc-builder.js";import{T as Le}from"../../chunks/Tip-hf-doc-builder.js";import{D as Z}from"../../chunks/Docstring-hf-doc-builder.js";import{C as me}from"../../chunks/CodeBlock-hf-doc-builder.js";import{I as Qe}from"../../chunks/IconCopyLink-hf-doc-builder.js";import{E as ue}from"../../chunks/ExampleCodeBlock-hf-doc-builder.js";function nD(E){let d,g,c,f,b;return f=new me({props:{code:`from transformers import DistilBertModel, DistilBertConfig
...
elements depending on the configuration (<a
  href="/docs/transformers/v4.23.1/en/model_doc/distilbert#transformers.DistilBertConfig"
...
loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.23.1/src/transformers/models/distilbert/modeling_distilbert.py#L623",returnDescription:`
<p>A <a
...
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.23.1/src/transformers/models/distilbert/modeling_distilbert.py#L721",returnDescription:`
<p>A <a
...
<code>input_ids</code> above)`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.23.1/src/transformers/models/distilbert/modeling_distilbert.py#L1049",returnDescription:`
<p>A <a
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.23.1/src/transformers/models/distilbert/modeling_distilbert.py#L954",returnDescription:`
<p>A <a
...
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/v4.23.1/src/transformers/models/distilbert/modeling_distilbert.py#L837",returnDescription:`
<p>A <a
...
behaviors between training and evaluation).`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/v4.23.1/src/transformers/models/distilbert/modeling_tf_distilbert.py#L542",returnDescription:`
<p>A <a
...
Labels for computing the masked language modeling loss. Indices should be in <code>[-100, 0, ..., config.vocab_size]</code> (see <code>input_ids</code> docstring) Tokens with indices set to <code>-100</code> are ignored (masked), the
loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.23.1/src/transformers/models/distilbert/modeling_tf_distilbert.py#L644",returnDescription:`
<p>A <a
...
Labels for computing the sequence classification/regression loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>. If <code>config.num_labels == 1</code> a regression loss is computed (Mean-Square loss), If
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.23.1/src/transformers/models/distilbert/modeling_tf_distilbert.py#L731",returnDescription:`
<p>A <a
...
where <code>num_choices</code> is the size of the second dimension of the input tensors. (See <code>input_ids</code> above)`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.23.1/src/transformers/models/distilbert/modeling_tf_distilbert.py#L903",returnDescription:`
<p>A <a
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.23.1/src/transformers/models/distilbert/modeling_tf_distilbert.py#L812",returnDescription:`
<p>A <a
...
Labels for position (index) of the end of the labelled span for computing the token classification loss.
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/v4.23.1/src/transformers/models/distilbert/modeling_tf_distilbert.py#L1013",returnDescription:`
<p>A <a
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Uh.forEach(t),_g=u(mo),bt=a(mo,"DIV",{class:!0});var go=i(bt);T(Ar.$$.fragment,go),vg=u(go),qo=a(go,"P",{});var jl=i(qo);bg=s(jl,"The "),al=a(jl,"A",{href:!0});var Y$=i(al);kg=s(Y$,"DistilBertForTokenClassification"),Y$.forEach(t),wg=s(jl," forward method, overrides the "),bd=a(jl,"CODE",{});var Z$=i(bd);Tg=s(Z$,"__call__"),Z$.forEach(t),$g=s(jl," special method."),jl.forEach(t),yg=u(go),T(Ps.$$.fragment,go),Dg=u(go),T(qs.$$.fragment,go),Fg=u(go),T(As.$$.fragment,go),go.forEach(t),mo.forEach(t),th=u(n),Ao=a(n,"H2",{class:!0});var Kh=i(Ao);Os=a(Kh,"A",{id:!0,class:!0,href:!0});var e1=i(Os);kd=a(e1,"SPAN",{});var t1=i(kd);T(Or.$$.fragment,t1),t1.forEach(t),e1.forEach(t),Bg=u(Kh),wd=a(Kh,"SPAN",{});var o1=i(wd);Eg=s(o1,"DistilBertForQuestionAnswering"),o1.forEach(t),Kh.forEach(t),oh=u(n),_t=a(n,"DIV",{class:!0});var _o=i(_t);T(Nr.$$.fragment,_o),xg=u(_o),Oo=a(_o,"P",{});var zl=i(Oo);Mg=s(zl,`DistilBert Model with a span classification head on top for extractive question-answering tasks like SQuAD (a
linear layers on top of the hidden-states output to compute `),Td=a(zl,"CODE",{});var s1=i(Td);jg=s(s1,"span start logits"),s1.forEach(t),zg=s(zl," and "),$d=a(zl,"CODE",{});var n1=i($d);Cg=s(n1,"span end logits"),n1.forEach(t),Pg=s(zl,")."),zl.forEach(t),qg=u(_o),Ir=a(_o,"P",{});var Hh=i(Ir);Ag=s(Hh,"This model inherits from "),il=a(Hh,"A",{href:!0});var r1=i(il);Og=s(r1,"PreTrainedModel"),r1.forEach(t),Ng=s(Hh,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Hh.forEach(t),Ig=u(_o),Lr=a(_o,"P",{});var Vh=i(Lr);Lg=s(Vh,"This model is also a PyTorch "),Sr=a(Vh,"A",{href:!0,rel:!0});var a1=i(Sr);Sg=s(a1,"torch.nn.Module"),a1.forEach(t),Wg=s(Vh,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Vh.forEach(t),Qg=u(_o),kt=a(_o,"DIV",{class:!0});var vo=i(kt);T(Wr.$$.fragment,vo),Rg=u(vo),No=a(vo,"P",{});var Cl=i(No);Ug=s(Cl,"The "),ll=a(Cl,"A",{href:!0});var i1=i(ll);Kg=s(i1,"DistilBertForQuestionAnswering"),i1.forEach(t),Hg=s(Cl," forward method, overrides the "),yd=a(Cl,"CODE",{});var l1=i(yd);Vg=s(l1,"__call__"),l1.forEach(t),Jg=s(Cl," special method."),Cl.forEach(t),Gg=u(vo),T(Ns.$$.fragment,vo),Xg=u(vo),T(Is.$$.fragment,vo),Yg=u(vo),T(Ls.$$.fragment,vo),vo.forEach(t),_o.forEach(t),sh=u(n),Io=a(n,"H2",{class:!0});var Jh=i(Io);Ss=a(Jh,"A",{id:!0,class:!0,href:!0});var d1=i(Ss);Dd=a(d1,"SPAN",{});var c1=i(Dd);T(Qr.$$.fragment,c1),c1.forEach(t),d1.forEach(t),Zg=u(Jh),Fd=a(Jh,"SPAN",{});var p1=i(Fd);e_=s(p1,"TFDistilBertModel"),p1.forEach(t),Jh.forEach(t),nh=u(n),at=a(n,"DIV",{class:!0});var Rt=i(at);T(Rr.$$.fragment,Rt),t_=u(Rt),Bd=a(Rt,"P",{});var h1=i(Bd);o_=s(h1,"The bare DistilBERT encoder/transformer outputting raw hidden-states without any specific head on top."),h1.forEach(t),s_=u(Rt),Ur=a(Rt,"P",{});var Gh=i(Ur);n_=s(Gh,"This model inherits from "),dl=a(Gh,"A",{href:!0});var u1=i(dl);r_=s(u1,"TFPreTrainedModel"),u1.forEach(t),a_=s(Gh,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Gh.forEach(t),i_=u(Rt),Kr=a(Rt,"P",{});var Xh=i(Kr);l_=s(Xh,"This model is also a "),Hr=a(Xh,"A",{href:!0,rel:!0});var f1=i(Hr);d_=s(f1,"tf.keras.Model"),f1.forEach(t),c_=s(Xh,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Xh.forEach(t),p_=u(Rt),T(Ws.$$.fragment,Rt),h_=u(Rt),At=a(Rt,"DIV",{class:!0});var Nn=i(At);T(Vr.$$.fragment,Nn),u_=u(Nn),Lo=a(Nn,"P",{});var Pl=i(Lo);f_=s(Pl,"The "),cl=a(Pl,"A",{href:!0});var m1=i(cl);m_=s(m1,"TFDistilBertModel"),m1.forEach(t),g_=s(Pl," forward method, overrides the "),Ed=a(Pl,"CODE",{});var g1=i(Ed);__=s(g1,"__call__"),g1.forEach(t),v_=s(Pl," special method."),Pl.forEach(t),b_=u(Nn),T(Qs.$$.fragment,Nn),k_=u(Nn),T(Rs.$$.fragment,Nn),Nn.forEach(t),Rt.forEach(t),rh=u(n),So=a(n,"H2",{class:!0});var Yh=i(So);Us=a(Yh,"A",{id:!0,class:!0,href:!0});var _1=i(Us);xd=a(_1,"SPAN",{});var v1=i(xd);T(Jr.$$.fragment,v1),v1.forEach(t),_1.forEach(t),w_=u(Yh),Md=a(Yh,"SPAN",{});var b1=i(Md);T_=s(b1,"TFDistilBertForMaskedLM"),b1.forEach(t),Yh.forEach(t),ah=u(n),it=a(n,"DIV",{class:!0});var Ut=i(it);T(Gr.$$.fragment,Ut),$_=u(Ut),Xr=a(Ut,"P",{});var Zh=i(Xr);y_=s(Zh,"DistilBert Model with a "),jd=a(Zh,"CODE",{});var k1=i(jd);D_=s(k1,"masked language modeling"),k1.forEach(t),F_=s(Zh," head on top."),Zh.forEach(t),B_=u(Ut),Yr=a(Ut,"P",{});var eu=i(Yr);E_=s(eu,"This model inherits from "),pl=a(eu,"A",{href:!0});var w1=i(pl);x_=s(w1,"TFPreTrainedModel"),w1.forEach(t),M_=s(eu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),eu.forEach(t),j_=u(Ut),Zr=a(Ut,"P",{});var tu=i(Zr);z_=s(tu,"This model is also a "),ea=a(tu,"A",{href:!0,rel:!0});var T1=i(ea);C_=s(T1,"tf.keras.Model"),T1.forEach(t),P_=s(tu,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),tu.forEach(t),q_=u(Ut),T(Ks.$$.fragment,Ut),A_=u(Ut),wt=a(Ut,"DIV",{class:!0});var bo=i(wt);T(ta.$$.fragment,bo),O_=u(bo),Wo=a(bo,"P",{});var ql=i(Wo);N_=s(ql,"The "),hl=a(ql,"A",{href:!0});var $1=i(hl);I_=s($1,"TFDistilBertForMaskedLM"),$1.forEach(t),L_=s(ql," forward method, overrides the "),zd=a(ql,"CODE",{});var y1=i(zd);S_=s(y1,"__call__"),y1.forEach(t),W_=s(ql," special method."),ql.forEach(t),Q_=u(bo),T(Hs.$$.fragment,bo),R_=u(bo),T(Vs.$$.fragment,bo),U_=u(bo),T(Js.$$.fragment,bo),bo.forEach(t),Ut.forEach(t),ih=u(n),Qo=a(n,"H2",{class:!0});var ou=i(Qo);Gs=a(ou,"A",{id:!0,class:!0,href:!0});var D1=i(Gs);Cd=a(D1,"SPAN",{});var F1=i(Cd);T(oa.$$.fragment,F1),F1.forEach(t),D1.forEach(t),K_=u(ou),Pd=a(ou,"SPAN",{});var B1=i(Pd);H_=s(B1,"TFDistilBertForSequenceClassification"),B1.forEach(t),ou.forEach(t),lh=u(n),lt=a(n,"DIV",{class:!0});var Kt=i(lt);T(sa.$$.fragment,Kt),V_=u(Kt),qd=a(Kt,"P",{});var E1=i(qd);J_=s(E1,`DistilBert Model transformer with a sequence classification/regression head on top (a linear layer on top of the
pooled output) e.g. for GLUE tasks.`),E1.forEach(t),G_=u(Kt),na=a(Kt,"P",{});var su=i(na);X_=s(su,"This model inherits from "),ul=a(su,"A",{href:!0});var x1=i(ul);Y_=s(x1,"TFPreTrainedModel"),x1.forEach(t),Z_=s(su,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),su.forEach(t),ev=u(Kt),ra=a(Kt,"P",{});var nu=i(ra);tv=s(nu,"This model is also a "),aa=a(nu,"A",{href:!0,rel:!0});var M1=i(aa);ov=s(M1,"tf.keras.Model"),M1.forEach(t),sv=s(nu,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),nu.forEach(t),nv=u(Kt),T(Xs.$$.fragment,Kt),rv=u(Kt),Tt=a(Kt,"DIV",{class:!0});var ko=i(Tt);T(ia.$$.fragment,ko),av=u(ko),Ro=a(ko,"P",{});var Al=i(Ro);iv=s(Al,"The "),fl=a(Al,"A",{href:!0});var j1=i(fl);lv=s(j1,"TFDistilBertForSequenceClassification"),j1.forEach(t),dv=s(Al," forward method, overrides the "),Ad=a(Al,"CODE",{});var z1=i(Ad);cv=s(z1,"__call__"),z1.forEach(t),pv=s(Al," special method."),Al.forEach(t),hv=u(ko),T(Ys.$$.fragment,ko),uv=u(ko),T(Zs.$$.fragment,ko),fv=u(ko),T(en.$$.fragment,ko),ko.forEach(t),Kt.forEach(t),dh=u(n),Uo=a(n,"H2",{class:!0});var ru=i(Uo);tn=a(ru,"A",{id:!0,class:!0,href:!0});var C1=i(tn);Od=a(C1,"SPAN",{});var P1=i(Od);T(la.$$.fragment,P1),P1.forEach(t),C1.forEach(t),mv=u(ru),Nd=a(ru,"SPAN",{});var q1=i(Nd);gv=s(q1,"TFDistilBertForMultipleChoice"),q1.forEach(t),ru.forEach(t),ch=u(n),dt=a(n,"DIV",{class:!0});var Ht=i(dt);T(da.$$.fragment,Ht),_v=u(Ht),Id=a(Ht,"P",{});var A1=i(Id);vv=s(A1,`DistilBert Model with a multiple choice classification head on top (a linear layer on top of the pooled output and
a softmax) e.g. for RocStories/SWAG tasks.`),A1.forEach(t),bv=u(Ht),ca=a(Ht,"P",{});var au=i(ca);kv=s(au,"This model inherits from "),ml=a(au,"A",{href:!0});var O1=i(ml);wv=s(O1,"TFPreTrainedModel"),O1.forEach(t),Tv=s(au,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),au.forEach(t),$v=u(Ht),pa=a(Ht,"P",{});var iu=i(pa);yv=s(iu,"This model is also a "),ha=a(iu,"A",{href:!0,rel:!0});var N1=i(ha);Dv=s(N1,"tf.keras.Model"),N1.forEach(t),Fv=s(iu,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),iu.forEach(t),Bv=u(Ht),T(on.$$.fragment,Ht),Ev=u(Ht),Ot=a(Ht,"DIV",{class:!0});var In=i(Ot);T(ua.$$.fragment,In),xv=u(In),Ko=a(In,"P",{});var Ol=i(Ko);Mv=s(Ol,"The "),gl=a(Ol,"A",{href:!0});var I1=i(gl);jv=s(I1,"TFDistilBertForMultipleChoice"),I1.forEach(t),zv=s(Ol," forward method, overrides the "),Ld=a(Ol,"CODE",{});var L1=i(Ld);Cv=s(L1,"__call__"),L1.forEach(t),Pv=s(Ol," special method."),Ol.forEach(t),qv=u(In),T(sn.$$.fragment,In),Av=u(In),T(nn.$$.fragment,In),In.forEach(t),Ht.forEach(t),ph=u(n),Ho=a(n,"H2",{class:!0});var lu=i(Ho);rn=a(lu,"A",{id:!0,class:!0,href:!0});var S1=i(rn);Sd=a(S1,"SPAN",{});var W1=i(Sd);T(fa.$$.fragment,W1),W1.forEach(t),S1.forEach(t),Ov=u(lu),Wd=a(lu,"SPAN",{});var Q1=i(Wd);Nv=s(Q1,"TFDistilBertForTokenClassification"),Q1.forEach(t),lu.forEach(t),hh=u(n),ct=a(n,"DIV",{class:!0});var Vt=i(ct);T(ma.$$.fragment,Vt),Iv=u(Vt),Qd=a(Vt,"P",{});var R1=i(Qd);Lv=s(R1,`DistilBert Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g.
for Named-Entity-Recognition (NER) tasks.`),R1.forEach(t),Sv=u(Vt),ga=a(Vt,"P",{});var du=i(ga);Wv=s(du,"This model inherits from "),_l=a(du,"A",{href:!0});var U1=i(_l);Qv=s(U1,"TFPreTrainedModel"),U1.forEach(t),Rv=s(du,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),du.forEach(t),Uv=u(Vt),_a=a(Vt,"P",{});var cu=i(_a);Kv=s(cu,"This model is also a "),va=a(cu,"A",{href:!0,rel:!0});var K1=i(va);Hv=s(K1,"tf.keras.Model"),K1.forEach(t),Vv=s(cu,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),cu.forEach(t),Jv=u(Vt),T(an.$$.fragment,Vt),Gv=u(Vt),$t=a(Vt,"DIV",{class:!0});var wo=i($t);T(ba.$$.fragment,wo),Xv=u(wo),Vo=a(wo,"P",{});var Nl=i(Vo);Yv=s(Nl,"The "),vl=a(Nl,"A",{href:!0});var H1=i(vl);Zv=s(H1,"TFDistilBertForTokenClassification"),H1.forEach(t),eb=s(Nl," forward method, overrides the "),Rd=a(Nl,"CODE",{});var V1=i(Rd);tb=s(V1,"__call__"),V1.forEach(t),ob=s(Nl," special method."),Nl.forEach(t),sb=u(wo),T(ln.$$.fragment,wo),nb=u(wo),T(dn.$$.fragment,wo),rb=u(wo),T(cn.$$.fragment,wo),wo.forEach(t),Vt.forEach(t),uh=u(n),Jo=a(n,"H2",{class:!0});var pu=i(Jo);pn=a(pu,"A",{id:!0,class:!0,href:!0});var J1=i(pn);Ud=a(J1,"SPAN",{});var G1=i(Ud);T(ka.$$.fragment,G1),G1.forEach(t),J1.forEach(t),ab=u(pu),Kd=a(pu,"SPAN",{});var X1=i(Kd);ib=s(X1,"TFDistilBertForQuestionAnswering"),X1.forEach(t),pu.forEach(t),fh=u(n),pt=a(n,"DIV",{class:!0});var Jt=i(pt);T(wa.$$.fragment,Jt),lb=u(Jt),Go=a(Jt,"P",{});var Il=i(Go);db=s(Il,`DistilBert Model with a span classification head on top for extractive question-answering tasks like SQuAD (a
linear layer on top of the hidden-states output to compute `),Hd=a(Il,"CODE",{});var Y1=i(Hd);cb=s(Y1,"span start logits"),Y1.forEach(t),pb=s(Il," and "),Vd=a(Il,"CODE",{});var Z1=i(Vd);hb=s(Z1,"span end logits"),Z1.forEach(t),ub=s(Il,")."),Il.forEach(t),fb=u(Jt),Ta=a(Jt,"P",{});var hu=i(Ta);mb=s(hu,"This model inherits from "),bl=a(hu,"A",{href:!0});var ey=i(bl);gb=s(ey,"TFPreTrainedModel"),ey.forEach(t),_b=s(hu,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
