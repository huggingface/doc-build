...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/v4.23.1/src/transformers/models/roberta/tokenization_roberta.py#L344",returnDescription:`
...
Whether or not the token list is already formatted with special tokens for the model.`,name:"already_has_special_tokens"}],source:"https://github.com/huggingface/transformers/blob/v4.23.1/src/transformers/models/roberta/tokenization_roberta.py#L369",returnDescription:`
...
model. Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/v4.23.1/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/v4.23.1/src/transformers/models/roberta/modeling_roberta.py#L875"}}),mr=new O({props:{name:"forward",anchor:"transformers.RobertaForCausalLM.forward",parameters:[{name:"input_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"attention_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"token_type_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"position_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"head_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"encoder_hidden_states",val:": typing.Optional[torch.FloatTensor] = None"},{name:"encoder_attention_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"labels",val:": typing.Optional[torch.LongTensor] = None"},{name:"past_key_values",val:": typing.Tuple[typing.Tuple[torch.FloatTensor]] = None"},{name:"use_cache",val:": typing.Optional[bool] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.RobertaForCausalLM.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/v4.23.1/en/model_doc/roberta#transformers.RobertaTokenizer">RobertaTokenizer</a>. See <a href="/docs/transformers/v4.23.1/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/v4.23.1/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
model. Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/v4.23.1/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/v4.23.1/src/transformers/models/roberta/modeling_roberta.py#L1158"}}),Er=new O({props:{name:"forward",anchor:"transformers.RobertaForSequenceClassification.forward",parameters:[{name:"input_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"attention_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"token_type_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"position_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"head_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"labels",val:": typing.Optional[torch.LongTensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.RobertaForSequenceClassification.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/v4.23.1/en/model_doc/roberta#transformers.RobertaTokenizer">RobertaTokenizer</a>. See <a href="/docs/transformers/v4.23.1/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/v4.23.1/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
model. Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/v4.23.1/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/v4.23.1/src/transformers/models/roberta/modeling_roberta.py#L1351"}}),Dr=new O({props:{name:"forward",anchor:"transformers.RobertaForTokenClassification.forward",parameters:[{name:"input_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"attention_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"token_type_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"position_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"head_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"labels",val:": typing.Optional[torch.LongTensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.RobertaForTokenClassification.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/v4.23.1/en/model_doc/roberta#transformers.RobertaTokenizer">RobertaTokenizer</a>. See <a href="/docs/transformers/v4.23.1/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/v4.23.1/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
Labels for computing the cross entropy classification loss. Indices should be in <code>[0, ..., config.vocab_size - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.23.1/src/transformers/models/roberta/modeling_tf_roberta.py#L1186",returnDescription:`
<p>A <a
...
model. Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/v4.23.1/en/main_classes/model#transformers.FlaxPreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/v4.23.1/src/transformers/models/roberta/modeling_flax_roberta.py#L1057"}}),dl=new O({props:{name:"__call__",anchor:"transformers.FlaxRobertaForMaskedLM.__call__",parameters:[{name:"input_ids",val:""},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"encoder_hidden_states",val:" = None"},{name:"encoder_attention_mask",val:" = None"},{name:"params",val:": dict = None"},{name:"dropout_rng",val:": PRNGKey = None"},{name:"train",val:": bool = False"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"past_key_values",val:": dict = None"}],parametersDescription:[{anchor:"transformers.FlaxRobertaForMaskedLM.__call__.input_ids",description:`<strong>input_ids</strong> (<code>numpy.ndarray</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/v4.23.1/en/model_doc/bert#transformers.BertTokenizer">BertTokenizer</a>. See <a href="/docs/transformers/v4.23.1/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/v4.23.1/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
model. Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/v4.23.1/en/main_classes/model#transformers.FlaxPreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/v4.23.1/src/transformers/models/roberta/modeling_flax_roberta.py#L1130"}}),kl=new O({props:{name:"__call__",anchor:"transformers.FlaxRobertaForSequenceClassification.__call__",parameters:[{name:"input_ids",val:""},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"encoder_hidden_states",val:" = None"},{name:"encoder_attention_mask",val:" = None"},{name:"params",val:": dict = None"},{name:"dropout_rng",val:": PRNGKey = None"},{name:"train",val:": bool = False"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"past_key_values",val:": dict = None"}],parametersDescription:[{anchor:"transformers.FlaxRobertaForSequenceClassification.__call__.input_ids",description:`<strong>input_ids</strong> (<code>numpy.ndarray</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/v4.23.1/en/model_doc/bert#transformers.BertTokenizer">BertTokenizer</a>. See <a href="/docs/transformers/v4.23.1/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/v4.23.1/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
model. Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/v4.23.1/en/main_classes/model#transformers.FlaxPreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/v4.23.1/src/transformers/models/roberta/modeling_flax_roberta.py#L1212"}}),Ml=new O({props:{name:"__call__",anchor:"transformers.FlaxRobertaForMultipleChoice.__call__",parameters:[{name:"input_ids",val:""},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"encoder_hidden_states",val:" = None"},{name:"encoder_attention_mask",val:" = None"},{name:"params",val:": dict = None"},{name:"dropout_rng",val:": PRNGKey = None"},{name:"train",val:": bool = False"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"past_key_values",val:": dict = None"}],parametersDescription:[{anchor:"transformers.FlaxRobertaForMultipleChoice.__call__.input_ids",description:`<strong>input_ids</strong> (<code>numpy.ndarray</code> of shape <code>(batch_size, num_choices, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/v4.23.1/en/model_doc/bert#transformers.BertTokenizer">BertTokenizer</a>. See <a href="/docs/transformers/v4.23.1/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/v4.23.1/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
model. Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/v4.23.1/en/main_classes/model#transformers.FlaxPreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/v4.23.1/src/transformers/models/roberta/modeling_flax_roberta.py#L1373"}}),Vl=new O({props:{name:"__call__",anchor:"transformers.FlaxRobertaForQuestionAnswering.__call__",parameters:[{name:"input_ids",val:""},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"encoder_hidden_states",val:" = None"},{name:"encoder_attention_mask",val:" = None"},{name:"params",val:": dict = None"},{name:"dropout_rng",val:": PRNGKey = None"},{name:"train",val:": bool = False"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"past_key_values",val:": dict = None"}],parametersDescription:[{anchor:"transformers.FlaxRobertaForQuestionAnswering.__call__.input_ids",description:`<strong>input_ids</strong> (<code>numpy.ndarray</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/v4.23.1/en/model_doc/bert#transformers.BertTokenizer">BertTokenizer</a>. See <a href="/docs/transformers/v4.23.1/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/v4.23.1/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),t1=h(),Ai=a("p"),o1=n("This model is also a Flax Linen "),Oi=a("a"),n1=n("flax.linen.Module"),s1=n(`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),a1=h(),th=a("p"),r1=n("Finally, this model supports inherent JAX features such as:"),i1=h(),po=a("ul"),oh=a("li"),Ni=a("a"),l1=n("Just-In-Time (JIT) compilation"),d1=h(),nh=a("li"),Ii=a("a"),c1=n("Automatic Differentiation"),p1=h(),sh=a("li"),Di=a("a"),h1=n("Vectorization"),u1=h(),ah=a("li"),Si=a("a"),f1=n("Parallelization"),m1=h(),Gt=a("div"),y(Bi.$$.fragment),g1=h(),bn=a("p"),_1=n("The "),rh=a("code"),b1=n("FlaxRobertaPreTrainedModel"),k1=n(" forward method, overrides the "),ih=a("code"),v1=n("__call__"),y1=n(" special method."),w1=h(),y(Xs.$$.fragment),T1=h(),y(Ys.$$.fragment),Of=h(),kn=a("h2"),Zs=a("a"),lh=a("span"),y(Wi.$$.fragment),$1=h(),dh=a("span"),F1=n("FlaxRobertaForCausalLM"),Nf=h(),st=a("div"),y(Ui.$$.fragment),x1=h(),ch=a("p"),R1=n(`Roberta Model with a language modeling head on top (a linear layer on top of the hidden-states output) e.g for
autoregressive tasks.`),E1=h(),Hi=a("p"),M1=n("This model inherits from "),Kd=a("a"),z1=n("FlaxPreTrainedModel"),j1=n(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),C1=h(),Qi=a("p"),q1=n("This model is also a Flax Linen "),Ki=a("a"),P1=n("flax.linen.Module"),L1=n(`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),A1=h(),ph=a("p"),O1=n("Finally, this model supports inherent JAX features such as:"),N1=h(),ho=a("ul"),hh=a("li"),Ji=a("a"),I1=n("Just-In-Time (JIT) compilation"),D1=h(),uh=a("li"),Vi=a("a"),S1=n("Automatic Differentiation"),B1=h(),fh=a("li"),Gi=a("a"),W1=n("Vectorization"),U1=h(),mh=a("li"),Xi=a("a"),H1=n("Parallelization"),Q1=h(),Xt=a("div"),y(Yi.$$.fragment),K1=h(),vn=a("p"),J1=n("The "),gh=a("code"),V1=n("FlaxRobertaPreTrainedModel"),G1=n(" forward method, overrides the "),_h=a("code"),X1=n("__call__"),Y1=n(" special method."),Z1=h(),y(ea.$$.fragment),e$=h(),y(ta.$$.fragment),If=h(),yn=a("h2"),oa=a("a"),bh=a("span"),y(Zi.$$.fragment),t$=h(),kh=a("span"),o$=n("FlaxRobertaForMaskedLM"),Df=h(),at=a("div"),y(el.$$.fragment),n$=h(),tl=a("p"),s$=n("RoBERTa Model with a "),vh=a("code"),a$=n("language modeling"),r$=n(" head on top."),i$=h(),ol=a("p"),l$=n("This model inherits from "),Jd=a("a"),d$=n("FlaxPreTrainedModel"),c$=n(`. Check the superclass documentation for the generic methods the
...
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),Q$=h(),jh=a("p"),K$=n("Finally, this model supports inherent JAX features such as:"),J$=h(),fo=a("ul"),Ch=a("li"),ml=a("a"),V$=n("Just-In-Time (JIT) compilation"),G$=h(),qh=a("li"),gl=a("a"),X$=n("Automatic Differentiation"),Y$=h(),Ph=a("li"),_l=a("a"),Z$=n("Vectorization"),e2=h(),Lh=a("li"),bl=a("a"),t2=n("Parallelization"),o2=h(),Zt=a("div"),y(kl.$$.fragment),n2=h(),$n=a("p"),s2=n("The "),Ah=a("code"),a2=n("FlaxRobertaPreTrainedModel"),r2=n(" forward method, overrides the "),Oh=a("code"),i2=n("__call__"),l2=n(" special method."),d2=h(),y(ra.$$.fragment),c2=h(),y(ia.$$.fragment),Wf=h(),Fn=a("h2"),la=a("a"),Nh=a("span"),y(vl.$$.fragment),p2=h(),Ih=a("span"),h2=n("FlaxRobertaForMultipleChoice"),Uf=h(),it=a("div"),y(yl.$$.fragment),u2=h(),Dh=a("p"),f2=n(`Roberta Model with a multiple choice classification head on top (a linear layer on top of the pooled output and a
softmax) e.g. for RocStories/SWAG tasks.`),m2=h(),wl=a("p"),g2=n("This model inherits from "),Gd=a("a"),_2=n("FlaxPreTrainedModel"),b2=n(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),k2=h(),Tl=a("p"),v2=n("This model is also a Flax Linen "),$l=a("a"),y2=n("flax.linen.Module"),w2=n(`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),T2=h(),Sh=a("p"),$2=n("Finally, this model supports inherent JAX features such as:"),F2=h(),mo=a("ul"),Bh=a("li"),Fl=a("a"),x2=n("Just-In-Time (JIT) compilation"),R2=h(),Wh=a("li"),xl=a("a"),E2=n("Automatic Differentiation"),M2=h(),Uh=a("li"),Rl=a("a"),z2=n("Vectorization"),j2=h(),Hh=a("li"),El=a("a"),C2=n("Parallelization"),q2=h(),eo=a("div"),y(Ml.$$.fragment),P2=h(),xn=a("p"),L2=n("The "),Qh=a("code"),A2=n("FlaxRobertaPreTrainedModel"),O2=n(" forward method, overrides the "),Kh=a("code"),N2=n("__call__"),I2=n(" special method."),D2=h(),y(da.$$.fragment),S2=h(),y(ca.$$.fragment),Hf=h(),Rn=a("h2"),pa=a("a"),Jh=a("span"),y(zl.$$.fragment),B2=h(),Vh=a("span"),W2=n("FlaxRobertaForTokenClassification"),Qf=h(),lt=a("div"),y(jl.$$.fragment),U2=h(),Gh=a("p"),H2=n(`Roberta Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g. for
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Hm.forEach(t),AT=u(lo),w(Qs.$$.fragment,lo),OT=u(lo),qt=r(lo,"DIV",{class:!0});var Po=i(qt);w(Ci.$$.fragment,Po),NT=u(Po),gn=r(Po,"P",{});var _c=i(gn);IT=s(_c,"The "),Hd=r(_c,"A",{href:!0});var y4=i(Hd);DT=s(y4,"TFRobertaForQuestionAnswering"),y4.forEach(t),ST=s(_c," forward method, overrides the "),Xp=r(_c,"CODE",{});var w4=i(Xp);BT=s(w4,"__call__"),w4.forEach(t),WT=s(_c," special method."),_c.forEach(t),UT=u(Po),w(Ks.$$.fragment,Po),HT=u(Po),w(Js.$$.fragment,Po),QT=u(Po),w(Vs.$$.fragment,Po),Po.forEach(t),lo.forEach(t),Lf=u(o),_n=r(o,"H2",{class:!0});var Qm=i(_n);Gs=r(Qm,"A",{id:!0,class:!0,href:!0});var T4=i(Gs);Yp=r(T4,"SPAN",{});var $4=i(Yp);w(qi.$$.fragment,$4),$4.forEach(t),T4.forEach(t),KT=u(Qm),Zp=r(Qm,"SPAN",{});var F4=i(Zp);JT=s(F4,"FlaxRobertaModel"),F4.forEach(t),Qm.forEach(t),Af=u(o),nt=r(o,"DIV",{class:!0});var At=i(nt);w(Pi.$$.fragment,At),VT=u(At),eh=r(At,"P",{});var x4=i(eh);GT=s(x4,"The bare RoBERTa Model transformer outputting raw hidden-states without any specific head on top."),x4.forEach(t),XT=u(At),Li=r(At,"P",{});var Km=i(Li);YT=s(Km,"This model inherits from "),Qd=r(Km,"A",{href:!0});var R4=i(Qd);ZT=s(R4,"FlaxPreTrainedModel"),R4.forEach(t),e1=s(Km,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),Km.forEach(t),t1=u(At),Ai=r(At,"P",{});var Jm=i(Ai);o1=s(Jm,"This model is also a Flax Linen "),Oi=r(Jm,"A",{href:!0,rel:!0});var E4=i(Oi);n1=s(E4,"flax.linen.Module"),E4.forEach(t),s1=s(Jm,`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),Jm.forEach(t),a1=u(At),th=r(At,"P",{});var M4=i(th);r1=s(M4,"Finally, this model supports inherent JAX features such as:"),M4.forEach(t),i1=u(At),po=r(At,"UL",{});var Ta=i(po);oh=r(Ta,"LI",{});var z4=i(oh);Ni=r(z4,"A",{href:!0,rel:!0});var j4=i(Ni);l1=s(j4,"Just-In-Time (JIT) compilation"),j4.forEach(t),z4.forEach(t),d1=u(Ta),nh=r(Ta,"LI",{});var C4=i(nh);Ii=r(C4,"A",{href:!0,rel:!0});var q4=i(Ii);c1=s(q4,"Automatic Differentiation"),q4.forEach(t),C4.forEach(t),p1=u(Ta),sh=r(Ta,"LI",{});var P4=i(sh);Di=r(P4,"A",{href:!0,rel:!0});var L4=i(Di);h1=s(L4,"Vectorization"),L4.forEach(t),P4.forEach(t),u1=u(Ta),ah=r(Ta,"LI",{});var A4=i(ah);Si=r(A4,"A",{href:!0,rel:!0});var O4=i(Si);f1=s(O4,"Parallelization"),O4.forEach(t),A4.forEach(t),Ta.forEach(t),m1=u(At),Gt=r(At,"DIV",{class:!0});var $a=i(Gt);w(Bi.$$.fragment,$a),g1=u($a),bn=r($a,"P",{});var bc=i(bn);_1=s(bc,"The "),rh=r(bc,"CODE",{});var N4=i(rh);b1=s(N4,"FlaxRobertaPreTrainedModel"),N4.forEach(t),k1=s(bc," forward method, overrides the "),ih=r(bc,"CODE",{});var I4=i(ih);v1=s(I4,"__call__"),I4.forEach(t),y1=s(bc," special method."),bc.forEach(t),w1=u($a),w(Xs.$$.fragment,$a),T1=u($a),w(Ys.$$.fragment,$a),$a.forEach(t),At.forEach(t),Of=u(o),kn=r(o,"H2",{class:!0});var Vm=i(kn);Zs=r(Vm,"A",{id:!0,class:!0,href:!0});var D4=i(Zs);lh=r(D4,"SPAN",{});var S4=i(lh);w(Wi.$$.fragment,S4),S4.forEach(t),D4.forEach(t),$1=u(Vm),dh=r(Vm,"SPAN",{});var B4=i(dh);F1=s(B4,"FlaxRobertaForCausalLM"),B4.forEach(t),Vm.forEach(t),Nf=u(o),st=r(o,"DIV",{class:!0});var Ot=i(st);w(Ui.$$.fragment,Ot),x1=u(Ot),ch=r(Ot,"P",{});var W4=i(ch);R1=s(W4,`Roberta Model with a language modeling head on top (a linear layer on top of the hidden-states output) e.g for
autoregressive tasks.`),W4.forEach(t),E1=u(Ot),Hi=r(Ot,"P",{});var Gm=i(Hi);M1=s(Gm,"This model inherits from "),Kd=r(Gm,"A",{href:!0});var U4=i(Kd);z1=s(U4,"FlaxPreTrainedModel"),U4.forEach(t),j1=s(Gm,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),Gm.forEach(t),C1=u(Ot),Qi=r(Ot,"P",{});var Xm=i(Qi);q1=s(Xm,"This model is also a Flax Linen "),Ki=r(Xm,"A",{href:!0,rel:!0});var H4=i(Ki);P1=s(H4,"flax.linen.Module"),H4.forEach(t),L1=s(Xm,`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),Xm.forEach(t),A1=u(Ot),ph=r(Ot,"P",{});var Q4=i(ph);O1=s(Q4,"Finally, this model supports inherent JAX features such as:"),Q4.forEach(t),N1=u(Ot),ho=r(Ot,"UL",{});var Fa=i(ho);hh=r(Fa,"LI",{});var K4=i(hh);Ji=r(K4,"A",{href:!0,rel:!0});var J4=i(Ji);I1=s(J4,"Just-In-Time (JIT) compilation"),J4.forEach(t),K4.forEach(t),D1=u(Fa),uh=r(Fa,"LI",{});var V4=i(uh);Vi=r(V4,"A",{href:!0,rel:!0});var G4=i(Vi);S1=s(G4,"Automatic Differentiation"),G4.forEach(t),V4.forEach(t),B1=u(Fa),fh=r(Fa,"LI",{});var X4=i(fh);Gi=r(X4,"A",{href:!0,rel:!0});var Y4=i(Gi);W1=s(Y4,"Vectorization"),Y4.forEach(t),X4.forEach(t),U1=u(Fa),mh=r(Fa,"LI",{});var Z4=i(mh);Xi=r(Z4,"A",{href:!0,rel:!0});var eR=i(Xi);H1=s(eR,"Parallelization"),eR.forEach(t),Z4.forEach(t),Fa.forEach(t),Q1=u(Ot),Xt=r(Ot,"DIV",{class:!0});var xa=i(Xt);w(Yi.$$.fragment,xa),K1=u(xa),vn=r(xa,"P",{});var kc=i(vn);J1=s(kc,"The "),gh=r(kc,"CODE",{});var tR=i(gh);V1=s(tR,"FlaxRobertaPreTrainedModel"),tR.forEach(t),G1=s(kc," forward method, overrides the "),_h=r(kc,"CODE",{});var oR=i(_h);X1=s(oR,"__call__"),oR.forEach(t),Y1=s(kc," special method."),kc.forEach(t),Z1=u(xa),w(ea.$$.fragment,xa),e$=u(xa),w(ta.$$.fragment,xa),xa.forEach(t),Ot.forEach(t),If=u(o),yn=r(o,"H2",{class:!0});var Ym=i(yn);oa=r(Ym,"A",{id:!0,class:!0,href:!0});var nR=i(oa);bh=r(nR,"SPAN",{});var sR=i(bh);w(Zi.$$.fragment,sR),sR.forEach(t),nR.forEach(t),t$=u(Ym),kh=r(Ym,"SPAN",{});var aR=i(kh);o$=s(aR,"FlaxRobertaForMaskedLM"),aR.forEach(t),Ym.forEach(t),Df=u(o),at=r(o,"DIV",{class:!0});var Nt=i(at);w(el.$$.fragment,Nt),n$=u(Nt),tl=r(Nt,"P",{});var Zm=i(tl);s$=s(Zm,"RoBERTa Model with a "),vh=r(Zm,"CODE",{});var rR=i(vh);a$=s(rR,"language modeling"),rR.forEach(t),r$=s(Zm," head on top."),Zm.forEach(t),i$=u(Nt),ol=r(Nt,"P",{});var eg=i(ol);l$=s(eg,"This model inherits from "),Jd=r(eg,"A",{href:!0});var iR=i(Jd);d$=s(iR,"FlaxPreTrainedModel"),iR.forEach(t),c$=s(eg,`. Check the superclass documentation for the generic methods the
...
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),sg.forEach(t),Q$=u(It),jh=r(It,"P",{});var xR=i(jh);K$=s(xR,"Finally, this model supports inherent JAX features such as:"),xR.forEach(t),J$=u(It),fo=r(It,"UL",{});var Ma=i(fo);Ch=r(Ma,"LI",{});var RR=i(Ch);ml=r(RR,"A",{href:!0,rel:!0});var ER=i(ml);V$=s(ER,"Just-In-Time (JIT) compilation"),ER.forEach(t),RR.forEach(t),G$=u(Ma),qh=r(Ma,"LI",{});var MR=i(qh);gl=r(MR,"A",{href:!0,rel:!0});var zR=i(gl);X$=s(zR,"Automatic Differentiation"),zR.forEach(t),MR.forEach(t),Y$=u(Ma),Ph=r(Ma,"LI",{});var jR=i(Ph);_l=r(jR,"A",{href:!0,rel:!0});var CR=i(_l);Z$=s(CR,"Vectorization"),CR.forEach(t),jR.forEach(t),e2=u(Ma),Lh=r(Ma,"LI",{});var qR=i(Lh);bl=r(qR,"A",{href:!0,rel:!0});var PR=i(bl);t2=s(PR,"Parallelization"),PR.forEach(t),qR.forEach(t),Ma.forEach(t),o2=u(It),Zt=r(It,"DIV",{class:!0});var za=i(Zt);w(kl.$$.fragment,za),n2=u(za),$n=r(za,"P",{});var yc=i($n);s2=s(yc,"The "),Ah=r(yc,"CODE",{});var LR=i(Ah);a2=s(LR,"FlaxRobertaPreTrainedModel"),LR.forEach(t),r2=s(yc," forward method, overrides the "),Oh=r(yc,"CODE",{});var AR=i(Oh);i2=s(AR,"__call__"),AR.forEach(t),l2=s(yc," special method."),yc.forEach(t),d2=u(za),w(ra.$$.fragment,za),c2=u(za),w(ia.$$.fragment,za),za.forEach(t),It.forEach(t),Wf=u(o),Fn=r(o,"H2",{class:!0});var ag=i(Fn);la=r(ag,"A",{id:!0,class:!0,href:!0});var OR=i(la);Nh=r(OR,"SPAN",{});var NR=i(Nh);w(vl.$$.fragment,NR),NR.forEach(t),OR.forEach(t),p2=u(ag),Ih=r(ag,"SPAN",{});var IR=i(Ih);h2=s(IR,"FlaxRobertaForMultipleChoice"),IR.forEach(t),ag.forEach(t),Uf=u(o),it=r(o,"DIV",{class:!0});var Dt=i(it);w(yl.$$.fragment,Dt),u2=u(Dt),Dh=r(Dt,"P",{});var DR=i(Dh);f2=s(DR,`Roberta Model with a multiple choice classification head on top (a linear layer on top of the pooled output and a
softmax) e.g. for RocStories/SWAG tasks.`),DR.forEach(t),m2=u(Dt),wl=r(Dt,"P",{});var rg=i(wl);g2=s(rg,"This model inherits from "),Gd=r(rg,"A",{href:!0});var SR=i(Gd);_2=s(SR,"FlaxPreTrainedModel"),SR.forEach(t),b2=s(rg,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),rg.forEach(t),k2=u(Dt),Tl=r(Dt,"P",{});var ig=i(Tl);v2=s(ig,"This model is also a Flax Linen "),$l=r(ig,"A",{href:!0,rel:!0});var BR=i($l);y2=s(BR,"flax.linen.Module"),BR.forEach(t),w2=s(ig,`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),ig.forEach(t),T2=u(Dt),Sh=r(Dt,"P",{});var WR=i(Sh);$2=s(WR,"Finally, this model supports inherent JAX features such as:"),WR.forEach(t),F2=u(Dt),mo=r(Dt,"UL",{});var ja=i(mo);Bh=r(ja,"LI",{});var UR=i(Bh);Fl=r(UR,"A",{href:!0,rel:!0});var HR=i(Fl);x2=s(HR,"Just-In-Time (JIT) compilation"),HR.forEach(t),UR.forEach(t),R2=u(ja),Wh=r(ja,"LI",{});var QR=i(Wh);xl=r(QR,"A",{href:!0,rel:!0});var KR=i(xl);E2=s(KR,"Automatic Differentiation"),KR.forEach(t),QR.forEach(t),M2=u(ja),Uh=r(ja,"LI",{});var JR=i(Uh);Rl=r(JR,"A",{href:!0,rel:!0});var VR=i(Rl);z2=s(VR,"Vectorization"),VR.forEach(t),JR.forEach(t),j2=u(ja),Hh=r(ja,"LI",{});var GR=i(Hh);El=r(GR,"A",{href:!0,rel:!0});var XR=i(El);C2=s(XR,"Parallelization"),XR.forEach(t),GR.forEach(t),ja.forEach(t),q2=u(Dt),eo=r(Dt,"DIV",{class:!0});var Ca=i(eo);w(Ml.$$.fragment,Ca),P2=u(Ca),xn=r(Ca,"P",{});var wc=i(xn);L2=s(wc,"The "),Qh=r(wc,"CODE",{});var YR=i(Qh);A2=s(YR,"FlaxRobertaPreTrainedModel"),YR.forEach(t),O2=s(wc," forward method, overrides the "),Kh=r(wc,"CODE",{});var ZR=i(Kh);N2=s(ZR,"__call__"),ZR.forEach(t),I2=s(wc," special method."),wc.forEach(t),D2=u(Ca),w(da.$$.fragment,Ca),S2=u(Ca),w(ca.$$.fragment,Ca),Ca.forEach(t),Dt.forEach(t),Hf=u(o),Rn=r(o,"H2",{class:!0});var lg=i(Rn);pa=r(lg,"A",{id:!0,class:!0,href:!0});var eE=i(pa);Jh=r(eE,"SPAN",{});var tE=i(Jh);w(zl.$$.fragment,tE),tE.forEach(t),eE.forEach(t),B2=u(lg),Vh=r(lg,"SPAN",{});var oE=i(Vh);W2=s(oE,"FlaxRobertaForTokenClassification"),oE.forEach(t),lg.forEach(t),Qf=u(o),lt=r(o,"DIV",{class:!0});var St=i(lt);w(jl.$$.fragment,St),U2=u(St),Gh=r(St,"P",{});var nE=i(Gh);H2=s(nE,`Roberta Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g. for
Named-Entity-Recognition (NER) tasks.`),nE.forEach(t),Q2=u(St),Cl=r(St,"P",{});var dg=i(Cl);K2=s(dg,"This model inherits from "),Xd=r(dg,"A",{href:!0});var sE=i(Xd);J2=s(sE,"FlaxPreTrainedModel"),sE.forEach(t),V2=s(dg,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),dg.forEach(t),G2=u(St),ql=r(St,"P",{});var cg=i(ql);X2=s(cg,"This model is also a Flax Linen "),Pl=r(cg,"A",{href:!0,rel:!0});var aE=i(Pl);Y2=s(aE,"flax.linen.Module"),aE.forEach(t),Z2=s(cg,`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
