...
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-built_in">print</span>(<span class="hljs-string">&quot;Predicted class:&quot;</span>, model.config.id2label[predicted_class_idx.item()])`}}),{c(){d=n("p"),T=a("Example:"),m=h(),w(u.$$.fragment)},l(l){d=r(l,"P",{});var p=i(d);T=s(p,"Example:"),p.forEach(t),m=f(l),y(u.$$.fragment,l)},m(l,p){_(l,d,p),e(d,T),_(l,m,p),$(u,l,p),v=!0},p:zo,i(l){v||(x(u.$$.fragment,l),v=!0)},o(l){E(u.$$.fragment,l),v=!1},d(l){l&&t(d),l&&t(m),k(u,l)}}}function If(V){let d,T,m,u,v,l,p,F,z,C,q,D,ne,I,Re,Q,He,Ce,U,Ke,re,ie,Je,Pe,X,Ge,Ae,Z,Ee,Xe,ve,A,L,qe,P,le,Ze,H,Qe,Ye,O,ke,de,et,ce,pe,Te,tt,Y,ot,S,at,he,W,st,N,nt,rt,b,M,ut,ee,gt,_t,j,vt,Tt,bt,fe,wt,B,me,yt,Fe,ue,$t,xt,Ve,Et,be,we,Qc,Kn,Do,Sr,Za,Wr,Jn,Qa,Br,Gn,ze,As,R,Ya,Ur,Rr,es,Hr,Kr,ts,Jr,Gr,qs,Xr,Zr,zs,Qr,Yr,Ns,ei,ti,Ds,oi,ai,os,si,ni,ri,Ls,as,ss,ii,li,di,Os,Lo,ci,Oo,pi,hi,fi,Ss,ns,rs,mi,ui,Xn,pt,gi,So,_i,vi,Wo,Ti,bi,Zn,Rt,wi,Bo,yi,$i,Qn,kt,Ht,Ws,Uo,xi,Bs,Ei,Yn,Ie,Ro,ki,Ft,Fi,is,Vi,Ii,Ho,Mi,ji,Ci,Vt,Pi,ls,Ai,qi,ds,zi,Ni,Di,Kt,er,It,Jt,Us,Ko,Li,Rs,Oi,tr,Me,Jo,Si,Hs,Wi,Bi,Go,Ui,cs,Ri,Hi,Ki,ht,Xo,Ji,Ks,Gi,Xi,Gt,or,Mt,Xt,Js,Zo,Zi,Gs,Qi,ar,it,Qo,Yi,Yo,el,ea,tl,ol,al,Ne,ta,sl,jt,nl,ps,rl,il,Xs,ll,dl,cl,Zt,pl,Qt,sr,Ct,Yt,Zs,oa,hl,Qs,fl,nr,ge,aa,ml,sa,ul,na,gl,_l,vl,eo,Tl,ra,bl,ia,wl,yl,$l,De,la,xl,Pt,El,hs,kl,Fl,Ys,Vl,Il,Ml,to,jl,oo,rr,At,ao,en,da,Cl,tn,Pl,ir,_e,ca,Al,on,ql,zl,so,Nl,pa,Dl,ha,Ll,Ol,Sl,Le,fa,Wl,qt,Bl,fs,Ul,Rl,an,Hl,Kl,Jl,no,Gl,ro,lr,zt,io,sn,ma,Xl,nn,Zl,dr,te,ua,Ql,rn,Yl,ed,ga,td,ms,od,ad,sd,_a,nd,va,rd,id,ld,lo,dd,Oe,Ta,cd,Nt,pd,us,hd,fd,ln,md,ud,gd,co,_d,po,cr,Dt,ho,dn,ba,vd,cn,Td,pr,K,wa,bd,pn,wd,yd,fo,$d,ya,xd,gs,Ed,kd,Fd,$a,Vd,xa,Id,Md,jd,mo,Cd,Se,Ea,Pd,Lt,Ad,_s,qd,zd,hn,Nd,Dd,Ld,uo,Od,go,hr,Ot,_o,fn,ka,Sd,mn,Wd,fr,J,Fa,Bd,un,Ud,Rd,Va,Hd,vs,Kd,Jd,Gd,Ia,Xd,Ma,Zd,Qd,Yd,gn,ec,tc,lt,_n,ja,oc,ac,vn,Ca,sc,nc,Tn,Pa,rc,ic,bn,Aa,lc,dc,We,qa,cc,St,pc,wn,hc,fc,yn,mc,uc,gc,vo,_c,To,mr,Wt,bo,$n,za,vc,xn,Tc,ur,G,Na,bc,En,wc,yc,Da,$c,Ts,xc,Ec,kc,La,Fc,Oa,Vc,Ic,Mc,kn,jc,Cc,dt,Fn,Sa,Pc,Ac,Vn,Wa,qc,zc,In,Ba,Nc,Dc,Mn,Ua,Lc,Oc,Be,Ra,Sc,Bt,Wc,jn,Bc,Uc,Cn,Rc,Hc,Kc,wo,Jc,yo,gr;return l=new ct({}),I=new ct({}),Uo=new ct({}),Ro=new se({props:{name:"class transformers.ViTConfig",anchor:"transformers.ViTConfig",parameters:[{name:"hidden_size",val:" = 768"},{name:"num_hidden_layers",val:" = 12"},{name:"num_attention_heads",val:" = 12"},{name:"intermediate_size",val:" = 3072"},{name:"hidden_act",val:" = 'gelu'"},{name:"hidden_dropout_prob",val:" = 0.0"},{name:"attention_probs_dropout_prob",val:" = 0.0"},{name:"initializer_range",val:" = 0.02"},{name:"layer_norm_eps",val:" = 1e-12"},{name:"is_encoder_decoder",val:" = False"},{name:"image_size",val:" = 224"},{name:"patch_size",val:" = 16"},{name:"num_channels",val:" = 3"},{name:"qkv_bias",val:" = True"},{name:"encoder_stride",val:" = 16"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.ViTConfig.hidden_size",description:`<strong>hidden_size</strong> (<code>int</code>, <em>optional</em>, defaults to 768) &#x2014;
...
</ul>`,name:"return_tensors"}],source:"https://github.com/huggingface/transformers/blob/v4.23.1/src/transformers/models/vit/feature_extraction_vit.py#L82",returnDescription:`
<p>A <a
...
Whether or not to return a <a href="/docs/transformers/v4.23.1/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/v4.23.1/src/transformers/models/vit/modeling_vit.py#L526",returnDescription:`
<p>A <a
...
elements depending on the configuration (<a
  href="/docs/transformers/v4.23.1/en/model_doc/vit#transformers.ViTConfig"
...
Boolean masked positions. Indicates which patches are masked (1) and which aren&#x2019;t (0).`,name:"bool_masked_pos"}],source:"https://github.com/huggingface/transformers/blob/v4.23.1/src/transformers/models/vit/modeling_vit.py#L633",returnDescription:`
<p>A <a
...
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.23.1/src/transformers/models/vit/modeling_vit.py#L750",returnDescription:`
<p>A <a
...
behaviors between training and evaluation).`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/v4.23.1/src/transformers/models/vit/modeling_tf_vit.py#L670",returnDescription:`
<p>A <a
...
Labels for computing the image classification/regression loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>. If <code>config.num_labels == 1</code> a regression loss is computed (Mean-Square loss), If
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.23.1/src/transformers/models/vit/modeling_tf_vit.py#L764",returnDescription:`
<p>A <a
...
parameters.</strong></p>
<p>If you wish to change the dtype of the model parameters, see <a href="/docs/transformers/v4.23.1/en/main_classes/model#transformers.FlaxPreTrainedModel.to_fp16">to_fp16()</a> and
<a href="/docs/transformers/v4.23.1/en/main_classes/model#transformers.FlaxPreTrainedModel.to_bf16">to_bf16()</a>.`,name:"dtype"}],source:"https://github.com/huggingface/transformers/blob/v4.23.1/src/transformers/models/vit/modeling_flax_vit.py#L641"}}),Ra=new se({props:{name:"__call__",anchor:"transformers.FlaxViTForImageClassification.__call__",parameters:[{name:"pixel_values",val:""},{name:"params",val:": dict = None"},{name:"dropout_rng",val:": PRNGKey = None"},{name:"train",val:": bool = False"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],source:"https://github.com/huggingface/transformers/blob/v4.23.1/src/transformers/models/vit/modeling_flax_vit.py#L473",returnDescription:`
<p>A <a
...
improvement of 2% to training from scratch, but still 4% behind supervised pre-training.`),be=h(),we=n("img"),Kn=h(),Do=n("small"),Sr=a("ViT architecture. Taken from the "),Za=n("a"),Wr=a("original paper."),Jn=h(),Qa=n("p"),Br=a("Following the original Vision Transformer, some follow-up works have been made:"),Gn=h(),ze=n("ul"),As=n("li"),R=n("p"),Ya=n("a"),Ur=a("DeiT"),Rr=a(` (Data-efficient Image Transformers) by Facebook AI. DeiT models are distilled vision transformers.
...
found `),Wo=n("a"),Ti=a("here"),bi=a("."),Zn=h(),Rt=n("p"),wi=a("Note that we converted the weights from Ross Wightman\u2019s "),Bo=n("a"),yi=a("timm library"),$i=a(`, who already converted the weights from JAX to PyTorch. Credits
go to him!`),Qn=h(),kt=n("h2"),Ht=n("a"),Ws=n("span"),w(Uo.$$.fragment),xi=h(),Bs=n("span"),Ei=a("ViTConfig"),Yn=h(),Ie=n("div"),w(Ro.$$.fragment),ki=h(),Ft=n("p"),Fi=a("This is the configuration class to store the configuration of a "),is=n("a"),Vi=a("ViTModel"),Ii=a(`. It is used to instantiate an ViT
...
documentation from `),ds=n("a"),zi=a("PretrainedConfig"),Ni=a(" for more information."),Di=h(),w(Kt.$$.fragment),er=h(),It=n("h2"),Jt=n("a"),Us=n("span"),w(Ko.$$.fragment),Li=h(),Rs=n("span"),Oi=a("ViTFeatureExtractor"),tr=h(),Me=n("div"),w(Jo.$$.fragment),Si=h(),Hs=n("p"),Wi=a("Constructs a ViT feature extractor."),Bi=h(),Go=n("p"),Ui=a("This feature extractor inherits from "),cs=n("a"),Ri=a("FeatureExtractionMixin"),Hi=a(` which contains most of the main methods. Users
...
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),Mc=h(),kn=n("p"),jc=a("Finally, this model supports inherent JAX features such as:"),Cc=h(),dt=n("ul"),Fn=n("li"),Sa=n("a"),Pc=a("Just-In-Time (JIT) compilation"),Ac=h(),Vn=n("li"),Wa=n("a"),qc=a("Automatic Differentiation"),zc=h(),In=n("li"),Ba=n("a"),Nc=a("Vectorization"),Dc=h(),Mn=n("li"),Ua=n("a"),Lc=a("Parallelization"),Oc=h(),Be=n("div"),w(Ra.$$.fragment),Sc=h(),Bt=n("p"),Wc=a("The "),jn=n("code"),Bc=a("FlaxViTPreTrainedModel"),Uc=a(" forward method, overrides the "),Cn=n("code"),Rc=a("__call__"),Hc=a(" special method."),Kc=h(),w(wo.$$.fragment),Jc=h(),w(yo.$$.fragment),this.h()},l(o){const g=sf('[data-svelte="svelte-1phssyn"]',document.head);d=r(g,"META",{name:!0,content:!0}),g.forEach(t),T=f(o),m=r(o,"H1",{class:!0});var Ha=i(m);u=r(Ha,"A",{id:!0,class:!0,href:!0});var Pn=i(u);v=r(Pn,"SPAN",{});var An=i(v);y(l.$$.fragment,An),An.forEach(t),Pn.forEach(t),p=f(Ha),F=r(Ha,"SPAN",{});var qn=i(F);z=s(qn,"Vision Transformer (ViT)"),qn.forEach(t),Ha.forEach(t),C=f(o),q=r(o,"H2",{class:!0});var Ka=i(q);D=r(Ka,"A",{id:!0,class:!0,href:!0});var zn=i(D);ne=r(zn,"SPAN",{});var Nn=i(ne);y(I.$$.fragment,Nn),Nn.forEach(t),zn.forEach(t),Re=f(Ka),Q=r(Ka,"SPAN",{});var Dn=i(Q);He=s(Dn,"Overview"),Dn.forEach(t),Ka.forEach(t),Ce=f(o),U=r(o,"P",{});var Ja=i(U);Ke=s(Ja,"The Vision Transformer (ViT) model was proposed in "),re=r(Ja,"A",{href:!0,rel:!0});var Ln=i(re);ie=s(Ln,`An Image is Worth 16x16 Words: Transformers for Image Recognition
...
data and transferred to multiple mid-sized or small image recognition benchmarks (ImageNet, CIFAR-100, VTAB, etc.),
Vision Transformer (ViT) attains excellent results compared to state-of-the-art convolutional networks while requiring
substantially fewer computational resources to train.`),Wn.forEach(t),Sn.forEach(t),ve=f(o),A=r(o,"P",{});var Bn=i(A);L=s(Bn,"Tips:"),Bn.forEach(t),qe=f(o),P=r(o,"UL",{});var oe=i(P);le=r(oe,"LI",{});var Ga=i(le);Ze=s(Ga,"Demo notebooks regarding inference as well as fine-tuning ViT on custom data can be found "),H=r(Ga,"A",{href:!0,rel:!0});var Un=i(H);Qe=s(Un,"here"),Un.forEach(t),Ye=s(Ga,"."),Ga.forEach(t),O=f(oe),ke=r(oe,"LI",{});var Rn=i(ke);de=s(Rn,`To feed images to the Transformer encoder, each image is split into a sequence of fixed-size non-overlapping patches,
which are then linearly embedded. A [CLS] token is added to serve as representation of an entire image, which can be
used for classification. The authors also add absolute position embeddings, and feed the resulting sequence of
vectors to a standard Transformer encoder.`),Rn.forEach(t),et=f(oe),ce=r(oe,"LI",{});var Xa=i(ce);pe=s(Xa,`As the Vision Transformer expects each image to be of the same size (resolution), one can use
`),Te=r(Xa,"A",{href:!0});var Hn=i(Te);tt=s(Hn,"ViTFeatureExtractor"),Hn.forEach(t),Y=s(Xa," to resize (or rescale) and normalize images for the model."),Xa.forEach(t),ot=f(oe),S=r(oe,"LI",{});var Ut=i(S);at=s(Ut,`Both the patch resolution and image resolution used during pre-training or fine-tuning are reflected in the name of
each checkpoint. For example, `),he=r(Ut,"CODE",{});var Yc=i(he);W=s(Yc,"google/vit-base-patch16-224"),Yc.forEach(t),st=s(Ut,` refers to a base-sized architecture with patch
resolution of 16x16 and fine-tuning resolution of 224x224. All checkpoints can be found on the `),N=r(Ut,"A",{href:!0,rel:!0});var ep=i(N);nt=s(ep,"hub"),ep.forEach(t),rt=s(Ut,"."),Ut.forEach(t),b=f(oe),M=r(oe,"LI",{});var bs=i(M);ut=s(bs,"The available checkpoints are either (1) pre-trained on "),ee=r(bs,"A",{href:!0,rel:!0});var tp=i(ee);gt=s(tp,"ImageNet-21k"),tp.forEach(t),_t=s(bs,` (a collection of
...
an experiment with a self-supervised pre-training objective, namely masked patched prediction (inspired by masked
language modeling). With this approach, the smaller ViT-B/16 model achieves 79.9% accuracy on ImageNet, a significant
improvement of 2% to training from scratch, but still 4% behind supervised pre-training.`),np.forEach(t),oe.forEach(t),be=f(o),we=r(o,"IMG",{src:!0,alt:!0,width:!0}),Kn=f(o),Do=r(o,"SMALL",{});var Gc=i(Do);Sr=s(Gc,"ViT architecture. Taken from the "),Za=r(Gc,"A",{href:!0});var rp=i(Za);Wr=s(rp,"original paper."),rp.forEach(t),Gc.forEach(t),Jn=f(o),Qa=r(o,"P",{});var ip=i(Qa);Br=s(ip,"Following the original Vision Transformer, some follow-up works have been made:"),ip.forEach(t),Gn=f(o),ze=r(o,"UL",{});var $o=i(ze);As=r($o,"LI",{});var lp=i(As);R=r(lp,"P",{});var ae=i(R);Ya=r(ae,"A",{href:!0});var dp=i(Ya);Ur=s(dp,"DeiT"),dp.forEach(t),Rr=s(ae,` (Data-efficient Image Transformers) by Facebook AI. DeiT models are distilled vision transformers.
...
found `),Wo=r(ys,"A",{href:!0,rel:!0});var xp=i(Wo);Ti=s(xp,"here"),xp.forEach(t),bi=s(ys,"."),ys.forEach(t),Zn=f(o),Rt=r(o,"P",{});var vr=i(Rt);wi=s(vr,"Note that we converted the weights from Ross Wightman\u2019s "),Bo=r(vr,"A",{href:!0,rel:!0});var Ep=i(Bo);yi=s(Ep,"timm library"),Ep.forEach(t),$i=s(vr,`, who already converted the weights from JAX to PyTorch. Credits
go to him!`),vr.forEach(t),Qn=f(o),kt=r(o,"H2",{class:!0});var Tr=i(kt);Ht=r(Tr,"A",{id:!0,class:!0,href:!0});var kp=i(Ht);Ws=r(kp,"SPAN",{});var Fp=i(Ws);y(Uo.$$.fragment,Fp),Fp.forEach(t),kp.forEach(t),xi=f(Tr),Bs=r(Tr,"SPAN",{});var Vp=i(Bs);Ei=s(Vp,"ViTConfig"),Vp.forEach(t),Tr.forEach(t),Yn=f(o),Ie=r(o,"DIV",{class:!0});var xo=i(Ie);y(Ro.$$.fragment,xo),ki=f(xo),Ft=r(xo,"P",{});var $s=i(Ft);Fi=s($s,"This is the configuration class to store the configuration of a "),is=r($s,"A",{href:!0});var Ip=i(is);Vi=s(Ip,"ViTModel"),Ip.forEach(t),Ii=s($s,`. It is used to instantiate an ViT
model according to the specified arguments, defining the model architecture. Instantiating a configuration with the
defaults will yield a similar configuration to that of the ViT
...
documentation from `),ds=r(xs,"A",{href:!0});var Cp=i(ds);zi=s(Cp,"PretrainedConfig"),Cp.forEach(t),Ni=s(xs," for more information."),xs.forEach(t),Di=f(xo),y(Kt.$$.fragment,xo),xo.forEach(t),er=f(o),It=r(o,"H2",{class:!0});var br=i(It);Jt=r(br,"A",{id:!0,class:!0,href:!0});var Pp=i(Jt);Us=r(Pp,"SPAN",{});var Ap=i(Us);y(Ko.$$.fragment,Ap),Ap.forEach(t),Pp.forEach(t),Li=f(br),Rs=r(br,"SPAN",{});var qp=i(Rs);Oi=s(qp,"ViTFeatureExtractor"),qp.forEach(t),br.forEach(t),tr=f(o),Me=r(o,"DIV",{class:!0});var Eo=i(Me);y(Jo.$$.fragment,Eo),Si=f(Eo),Hs=r(Eo,"P",{});var zp=i(Hs);Wi=s(zp,"Constructs a ViT feature extractor."),zp.forEach(t),Bi=f(Eo),Go=r(Eo,"P",{});var wr=i(Go);Ui=s(wr,"This feature extractor inherits from "),cs=r(wr,"A",{href:!0});var Np=i(cs);Ri=s(Np,"FeatureExtractionMixin"),Np.forEach(t),Hi=s(wr,` which contains most of the main methods. Users
...
as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),Vr.forEach(t),Sl=f(mt),Le=r(mt,"DIV",{class:!0});var Vo=i(Le);y(fa.$$.fragment,Vo),Wl=f(Vo),qt=r(Vo,"P",{});var Is=i(qt);Bl=s(Is,"The "),fs=r(Is,"A",{href:!0});var ah=i(fs);Ul=s(ah,"ViTForImageClassification"),ah.forEach(t),Rl=s(Is," forward method, overrides the "),an=r(Is,"CODE",{});var sh=i(an);Hl=s(sh,"__call__"),sh.forEach(t),Kl=s(Is," special method."),Is.forEach(t),Jl=f(Vo),y(no.$$.fragment,Vo),Gl=f(Vo),y(ro.$$.fragment,Vo),Vo.forEach(t),mt.forEach(t),lr=f(o),zt=r(o,"H2",{class:!0});var Ir=i(zt);io=r(Ir,"A",{id:!0,class:!0,href:!0});var nh=i(io);sn=r(nh,"SPAN",{});var rh=i(sn);y(ma.$$.fragment,rh),rh.forEach(t),nh.forEach(t),Xl=f(Ir),nn=r(Ir,"SPAN",{});var ih=i(nn);Zl=s(ih,"TFViTModel"),ih.forEach(t),Ir.forEach(t),dr=f(o),te=r(o,"DIV",{class:!0});var Ue=i(te);y(ua.$$.fragment,Ue),Ql=f(Ue),rn=r(Ue,"P",{});var lh=i(rn);Yl=s(lh,"The bare ViT Model transformer outputting raw hidden-states without any specific head on top."),lh.forEach(t),ed=f(Ue),ga=r(Ue,"P",{});var Mr=i(ga);td=s(Mr,"This model inherits from "),ms=r(Mr,"A",{href:!0});var dh=i(ms);od=s(dh,"TFPreTrainedModel"),dh.forEach(t),ad=s(Mr,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Mr.forEach(t),sd=f(Ue),_a=r(Ue,"P",{});var jr=i(_a);nd=s(jr,"This model is also a "),va=r(jr,"A",{href:!0,rel:!0});var ch=i(va);rd=s(ch,"tf.keras.Model"),ch.forEach(t),id=s(jr,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),jr.forEach(t),ld=f(Ue),y(lo.$$.fragment,Ue),dd=f(Ue),Oe=r(Ue,"DIV",{class:!0});var Io=i(Oe);y(Ta.$$.fragment,Io),cd=f(Io),Nt=r(Io,"P",{});var Ms=i(Nt);pd=s(Ms,"The "),us=r(Ms,"A",{href:!0});var ph=i(us);hd=s(ph,"TFViTModel"),ph.forEach(t),fd=s(Ms," forward method, overrides the "),ln=r(Ms,"CODE",{});var hh=i(ln);md=s(hh,"__call__"),hh.forEach(t),ud=s(Ms," special method."),Ms.forEach(t),gd=f(Io),y(co.$$.fragment,Io),_d=f(Io),y(po.$$.fragment,Io),Io.forEach(t),Ue.forEach(t),cr=f(o),Dt=r(o,"H2",{class:!0});var Cr=i(Dt);ho=r(Cr,"A",{id:!0,class:!0,href:!0});var fh=i(ho);dn=r(fh,"SPAN",{});var mh=i(dn);y(ba.$$.fragment,mh),mh.forEach(t),fh.forEach(t),vd=f(Cr),cn=r(Cr,"SPAN",{});var uh=i(cn);Td=s(uh,"TFViTForImageClassification"),uh.forEach(t),Cr.forEach(t),pr=f(o),K=r(o,"DIV",{class:!0});var ye=i(K);y(wa.$$.fragment,ye),bd=f(ye),pn=r(ye,"P",{});var gh=i(pn);wd=s(gh,`ViT Model transformer with an image classification head on top (a linear layer on top of the final hidden state of
