...
the latter silently ignores them.`)},l(i){d=r(i,"P",{});var p=l(d);v=n(p,"Although the recipe for forward pass needs to be defined within this function, one should call the "),c=r(p,"CODE",{});var x=l(c);m=n(x,"Module"),x.forEach(t),y=n(p,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),p.forEach(t)},m(i,p){g(i,d,p),e(d,v),e(d,c),e(c,m),e(d,y)},d(i){i&&t(d)}}}function El(F){let d,v,c,m,y;return m=new Yt({props:{code:`from transformers import Wav2Vec2Processor, HubertModel
...
the latter silently ignores them.`)},l(i){d=r(i,"P",{});var p=l(d);v=n(p,"Although the recipe for forward pass needs to be defined within this function, one should call the "),c=r(p,"CODE",{});var x=l(c);m=n(x,"Module"),x.forEach(t),y=n(p,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),p.forEach(t)},m(i,p){g(i,d,p),e(d,v),e(d,c),e(c,m),e(d,y)},d(i){i&&t(d)}}}function Fl(F){let d,v,c,m,y;return m=new Yt({props:{code:`from transformers import Wav2Vec2Processor, HubertForCTC
from datasets import load_dataset
import torch
...
the latter silently ignores them.`)},l(i){d=r(i,"P",{});var p=l(d);v=n(p,"Although the recipe for forward pass needs to be defined within this function, one should call the "),c=r(p,"CODE",{});var x=l(c);m=n(x,"Module"),x.forEach(t),y=n(p,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),p.forEach(t)},m(i,p){g(i,d,p),e(d,v),e(d,c),e(c,m),e(d,y)},d(i){i&&t(d)}}}function Ml(F){let d,v,c,m,y;return m=new Yt({props:{code:`from transformers import Wav2Vec2FeatureExtractor, HubertForSequenceClassification
from datasets import load_dataset
import torch
...
`),ae=a("code"),$e=s("model([input_values, attention_mask])"),Q=s(" or "),re=a("code"),le=s("model([input_values, attention_mask, token_type_ids])"),Ue=u(),K=a("li"),Ce=s(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),A=a("code"),Z=s('model({"input_values": input_values, "token_type_ids": token_type_ids})'),ie=u(),P=a("p"),Ke=s(`Note that when creating models and layers with
`),I=a("a"),Ye=s("subclassing"),He=s(` then you don\u2019t need to worry
about any of this, as you can just pass inputs like you would to any other Python function!`),this.h()},l(b){d=r(b,"P",{});var j=l(d);v=n(j,"TensorFlow models and layers in "),c=r(j,"CODE",{});var ot=l(c);m=n(ot,"transformers"),ot.forEach(t),y=n(j," accept two formats as input:"),j.forEach(t),i=h(b),p=r(b,"UL",{});var N=l(p);x=r(N,"LI",{});var st=l(x);De=n(st,"having all inputs as keyword arguments (like PyTorch models), or"),st.forEach(t),ve=h(N),D=r(N,"LI",{});var Ee=l(D);J=n(Ee,"having all inputs as a list, tuple or dict in the first positional argument."),Ee.forEach(t),N.forEach(t),ee=h(b),E=r(b,"P",{});var q=l(E);ze=n(q,`The reason the second format is supported is that Keras methods prefer this format when passing inputs to models
and layers. Because of this support, when using methods like `),U=r(q,"CODE",{});var nt=l(U);Ae=n(nt,"model.fit()"),nt.forEach(t),ye=n(q,` things should \u201Cjust work\u201D for you - just
pass your inputs and labels in any format that `),L=r(q,"CODE",{});var be=l(L);Ie=n(be,"model.fit()"),be.forEach(t),te=n(q,` supports! If, however, you want to use the second
format outside of Keras methods like `),oe=r(q,"CODE",{});var at=l(oe);Le=n(at,"fit()"),at.forEach(t),we=n(q," and "),B=r(q,"CODE",{});var rt=l(B);We=n(rt,"predict()"),rt.forEach(t),Te=n(q,`, such as when creating your own layers or models with
the Keras `),R=r(q,"CODE",{});var lt=l(R);ge=n(lt,"Functional"),lt.forEach(t),Ne=n(q,` API, there are three possibilities you can use to gather all the input Tensors in the first
positional argument:`),q.forEach(t),he=h(b),M=r(b,"UL",{});var O=l(M);z=r(O,"LI",{});var de=l(z);ke=n(de,"a single Tensor with "),W=r(de,"CODE",{});var je=l(W);_e=n(je,"input_values"),je.forEach(t),Be=n(de," only and nothing else: "),se=r(de,"CODE",{});var it=l(se);ne=n(it,"model(input_values)"),it.forEach(t),de.forEach(t),Re=h(O),S=r(O,"LI",{});var ce=l(S);Ve=n(ce,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),ae=r(ce,"CODE",{});var Fe=l(ae);$e=n(Fe,"model([input_values, attention_mask])"),Fe.forEach(t),Q=n(ce," or "),re=r(ce,"CODE",{});var dt=l(re);le=n(dt,"model([input_values, attention_mask, token_type_ids])"),dt.forEach(t),ce.forEach(t),Ue=h(O),K=r(O,"LI",{});var Ge=l(K);Ce=n(Ge,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),A=r(Ge,"CODE",{});var ct=l(A);Z=n(ct,'model({"input_values": input_values, "token_type_ids": token_type_ids})'),ct.forEach(t),Ge.forEach(t),O.forEach(t),ie=h(b),P=r(b,"P",{});var V=l(P);Ke=n(V,`Note that when creating models and layers with
`),I=r(V,"A",{href:!0,rel:!0});var Je=l(I);Ye=n(Je,"subclassing"),Je.forEach(t),He=n(V,` then you don\u2019t need to worry
...
the latter silently ignores them.`)},l(i){d=r(i,"P",{});var p=l(d);v=n(p,"Although the recipe for forward pass needs to be defined within this function, one should call the "),c=r(p,"CODE",{});var x=l(c);m=n(x,"Module"),x.forEach(t),y=n(p,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),p.forEach(t)},m(i,p){g(i,d,p),e(d,v),e(d,c),e(c,m),e(d,y)},d(i){i&&t(d)}}}function Dl(F){let d,v,c,m,y;return m=new Yt({props:{code:`from transformers import Wav2Vec2Processor, TFHubertModel
from datasets import load_dataset
import soundfile as sf
...
the latter silently ignores them.`)},l(i){d=r(i,"P",{});var p=l(d);v=n(p,"Although the recipe for forward pass needs to be defined within this function, one should call the "),c=r(p,"CODE",{});var x=l(c);m=n(x,"Module"),x.forEach(t),y=n(p,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),p.forEach(t)},m(i,p){g(i,d,p),e(d,v),e(d,c),e(c,m),e(d,y)},d(i){i&&t(d)}}}function Il(F){let d,v,c,m,y;return m=new Yt({props:{code:`import tensorflow as tf
...
<code>inputs_ids</code> passed when calling <a href="/docs/transformers/v4.23.1/en/model_doc/hubert#transformers.HubertModel">HubertModel</a>. Vocabulary size of the model. Defines the different
...
instance of <a href="/docs/transformers/v4.23.1/en/model_doc/hubert#transformers.HubertForCTC">HubertForCTC</a>.`,name:"ctc_loss_reduction"},{anchor:"transformers.HubertConfig.ctc_zero_infinity",description:`<strong>ctc_zero_infinity</strong> (<code>bool</code>, <em>optional</em>, defaults to <code>False</code>) &#x2014;
Whether to zero infinite losses and the associated gradients of <code>torch.nn.CTCLoss</code>. Infinite losses mainly
occur when the inputs are too short to be aligned to the targets. Only relevant when training an instance
of <a href="/docs/transformers/v4.23.1/en/model_doc/hubert#transformers.HubertForCTC">HubertForCTC</a>.`,name:"ctc_zero_infinity"},{anchor:"transformers.HubertConfig.use_weighted_layer_sum",description:`<strong>use_weighted_layer_sum</strong> (<code>bool</code>, <em>optional</em>, defaults to <code>False</code>) &#x2014;
...
elements depending on the configuration (<a
  href="/docs/transformers/v4.23.1/en/model_doc/hubert#transformers.HubertConfig"
...
`}}),kt=new Do({props:{$$slots:{default:[Hl]},$$scope:{ctx:F}}}),$t=new Ut({props:{anchor:"transformers.HubertModel.forward.example",$$slots:{default:[El]},$$scope:{ctx:F}}}),so=new Vt({}),no=new Xe({props:{name:"class transformers.HubertForCTC",anchor:"transformers.HubertForCTC",parameters:[{name:"config",val:""}],parametersDescription:[{anchor:"transformers.HubertForCTC.config",description:`<strong>config</strong> (<a href="/docs/transformers/v4.23.1/en/model_doc/hubert#transformers.HubertConfig">HubertConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
...
All labels set to <code>-100</code> are ignored (masked), the loss is only computed for labels in <code>[0, ..., config.vocab_size - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.23.1/src/transformers/models/hubert/modeling_hubert.py#L1139",returnDescription:`
<p>A <a
...
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.23.1/src/transformers/models/hubert/modeling_hubert.py#L1274",returnDescription:`
<p>A <a
...
`}}),xt=new Do({props:{$$slots:{default:[ql]},$$scope:{ctx:F}}}),qt=new Ut({props:{anchor:"transformers.HubertForSequenceClassification.forward.example",$$slots:{default:[Ml]},$$scope:{ctx:F}}}),Mt=new Ut({props:{anchor:"transformers.HubertForSequenceClassification.forward.example-2",$$slots:{default:[Pl]},$$scope:{ctx:F}}}),vo=new Vt({}),yo=new Xe({props:{name:"class transformers.TFHubertModel",anchor:"transformers.TFHubertModel",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.TFHubertModel.config",description:`<strong>config</strong> (<a href="/docs/transformers/v4.23.1/en/model_doc/hubert#transformers.HubertConfig">HubertConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/v4.23.1/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/v4.23.1/src/transformers/models/hubert/modeling_tf_hubert.py#L1428"}}),St=new Do({props:{$$slots:{default:[Sl]},$$scope:{ctx:F}}}),$o=new Xe({props:{name:"call",anchor:"transformers.TFHubertModel.call",parameters:[{name:"input_values",val:": Tensor"},{name:"attention_mask",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"token_type_ids",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"position_ids",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"head_mask",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"inputs_embeds",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"training",val:": bool = False"}],parametersDescription:[{anchor:"transformers.TFHubertModel.call.input_values",description:`<strong>input_values</strong> (<code>np.ndarray</code>, <code>tf.Tensor</code>, <code>List[tf.Tensor]</code> \`<code>Dict[str, tf.Tensor]</code> or <code>Dict[str, np.ndarray]</code> and each example must have the shape <code>({0})</code>) &#x2014;
...
behaviors between training and evaluation).`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/v4.23.1/src/transformers/models/hubert/modeling_tf_hubert.py#L1434",returnDescription:`
<p>A <a
...
`}}),Ot=new Do({props:{$$slots:{default:[Ol]},$$scope:{ctx:F}}}),Dt=new Ut({props:{anchor:"transformers.TFHubertModel.call.example",$$slots:{default:[Dl]},$$scope:{ctx:F}}}),Co=new Vt({}),Ho=new Xe({props:{name:"class transformers.TFHubertForCTC",anchor:"transformers.TFHubertForCTC",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.TFHubertForCTC.config",description:`<strong>config</strong> (<a href="/docs/transformers/v4.23.1/en/model_doc/hubert#transformers.HubertConfig">HubertConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/v4.23.1/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/v4.23.1/src/transformers/models/hubert/modeling_tf_hubert.py#L1527"}}),At=new Do({props:{$$slots:{default:[zl]},$$scope:{ctx:F}}}),qo=new Xe({props:{name:"call",anchor:"transformers.TFHubertForCTC.call",parameters:[{name:"input_values",val:": Tensor"},{name:"attention_mask",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"token_type_ids",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"position_ids",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"head_mask",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"inputs_embeds",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"labels",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"training",val:": typing.Optional[bool] = False"}],parametersDescription:[{anchor:"transformers.TFHubertForCTC.call.input_values",description:`<strong>input_values</strong> (<code>np.ndarray</code>, <code>tf.Tensor</code>, <code>List[tf.Tensor]</code> \`<code>Dict[str, tf.Tensor]</code> or <code>Dict[str, np.ndarray]</code> and each example must have the shape <code>({0})</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/v4.23.1/en/model_doc/bert#transformers.BertTokenizer">BertTokenizer</a>. See <a href="/docs/transformers/v4.23.1/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
<a href="/docs/transformers/v4.23.1/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> for details.</p>
...
the loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.23.1/src/transformers/models/hubert/modeling_tf_hubert.py#L1554",returnDescription:`
<p>A <a
...
using `),S=a("a"),Ve=s("Wav2Vec2CTCTokenizer"),ae=s("."),$e=u(),Q=a("p"),re=s("This model was contributed by "),le=a("a"),Ue=s("patrickvonplaten"),K=s("."),Ce=u(),A=a("h2"),Z=a("a"),ie=a("span"),w(P.$$.fragment),Ke=u(),I=a("span"),Ye=s("HubertConfig"),He=u(),b=a("div"),w(j.$$.fragment),ot=u(),N=a("p"),st=s("This is the configuration class to store the configuration of a "),Ee=a("a"),q=s("HubertModel"),nt=s(`. It is used to instantiate an
...
`),be=a("a"),at=s("facebook/hubert-base-ls960"),rt=s(" architecture."),lt=u(),O=a("p"),de=s("Configuration objects inherit from "),je=a("a"),it=s("PretrainedConfig"),ce=s(` and can be used to control the model outputs. Read the
...
library implements for all its model (such as downloading or saving etc.).`),Rn=u(),lo=a("p"),Vn=s("This model is a PyTorch "),io=a("a"),Un=s("torch.nn.Module"),Kn=s(` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),Yn=u(),me=a("div"),w(co.$$.fragment),Gn=u(),ft=a("p"),Xn=s("The "),Lo=a("a"),Jn=s("HubertForCTC"),Qn=s(" forward method, overrides the "),ls=a("code"),Zn=s("__call__"),ea=s(" special method."),ta=u(),w(Ht.$$.fragment),oa=u(),w(Et.$$.fragment),sa=u(),w(jt.$$.fragment),Ss=u(),gt=a("h2"),Ft=a("a"),is=a("span"),w(po.$$.fragment),na=u(),ds=a("span"),aa=s("HubertForSequenceClassification"),Os=u(),Y=a("div"),w(uo.$$.fragment),ra=u(),cs=a("p"),la=s(`Hubert Model with a sequence classification head on top (a linear layer over the pooled output) for tasks like
SUPERB Keyword Spotting.`),ia=u(),ho=a("p"),da=s("Hubert was proposed in "),mo=a("a"),ca=s(`HuBERT: Self-Supervised Speech Representation Learning by Masked Prediction of Hidden
...
Salakhutdinov, Abdelrahman Mohamed.`),So.forEach(t),we=h(o),B=r(o,"P",{});var Es=l(B);We=n(Es,"The abstract from the paper is the following:"),Es.forEach(t),Te=h(o),R=r(o,"P",{});var js=l(R);ge=r(js,"EM",{});var Fs=l(ge);Ne=n(Fs,`Self-supervised approaches for speech representation learning are challenged by three unique problems: (1) there are
multiple sound units in each input utterance, (2) there is no lexicon of input sound units during the pre-training
phase, and (3) sound units have variable lengths with no explicit segmentation. To deal with these three problems, we
propose the Hidden-Unit BERT (HuBERT) approach for self-supervised speech representation learning, which utilizes an
offline clustering step to provide aligned target labels for a BERT-like prediction loss. A key ingredient of our
...
state-of-the-art wav2vec 2.0 performance on the Librispeech (960h) and Libri-light (60,000h) benchmarks with 10min, 1h,
10h, 100h, and 960h fine-tuning subsets. Using a 1B parameter model, HuBERT shows up to 19% and 13% relative WER
reduction on the more challenging dev-other and test-other evaluation subsets.`),Fs.forEach(t),js.forEach(t),he=h(o),M=r(o,"P",{});var xs=l(M);z=n(xs,"Tips:"),xs.forEach(t),ke=h(o),W=r(o,"UL",{});var Oo=l(W);_e=r(Oo,"LI",{});var Tr=l(_e);Be=n(Tr,"Hubert is a speech model that accepts a float array corresponding to the raw waveform of the speech signal."),Tr.forEach(t),se=h(Oo),ne=r(Oo,"LI",{});var Ws=l(ne);Re=n(Ws,`Hubert model was fine-tuned using connectionist temporal classification (CTC) so the model output has to be decoded
