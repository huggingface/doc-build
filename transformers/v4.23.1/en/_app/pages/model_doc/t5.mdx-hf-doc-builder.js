...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/v4.23.1/src/transformers/models/t5/tokenization_t5.py#L249",returnDescription:`
...
Whether or not the token list is already formatted with special tokens for the model.`,name:"already_has_special_tokens"}],source:"https://github.com/huggingface/transformers/blob/v4.23.1/src/transformers/models/t5/tokenization_t5.py#L188",returnDescription:`
...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/v4.23.1/src/transformers/models/t5/tokenization_t5.py#L227",returnDescription:`
<p>List of zeros.</p>
`,returnType:`
<p><code>List[int]</code></p>
...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/v4.23.1/src/transformers/models/t5/tokenization_t5_fast.py#L191",returnDescription:`
<p>List of <a href="../glossary#input-ids">input IDs</a> with the appropriate special tokens.</p>
`,returnType:`
<p><code>List[int]</code></p>
...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/v4.23.1/src/transformers/models/t5/tokenization_t5_fast.py#L217",returnDescription:`
<p>List of zeros.</p>
`,returnType:`
<p><code>List[int]</code></p>
...
<p>Indices can be obtained using <a href="/docs/transformers/v4.23.1/en/model_doc/mt5#transformers.T5Tokenizer">T5Tokenizer</a>. See <a href="/docs/transformers/v4.23.1/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/v4.23.1/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for detail.</p>
...
Whether or not to return a <a href="/docs/transformers/v4.23.1/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/v4.23.1/src/transformers/models/t5/modeling_t5.py#L1350",returnDescription:`
<p>A <a
...
elements depending on the configuration (<a
  href="/docs/transformers/v4.23.1/en/model_doc/t5#transformers.T5Config"
...
labels in <code>[0, ..., config.vocab_size]</code>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.23.1/src/transformers/models/t5/modeling_t5.py#L1547",returnDescription:`
<p>A <a
...
Whether or not to return a <a href="/docs/transformers/v4.23.1/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/v4.23.1/src/transformers/models/t5/modeling_t5.py#L1818",returnDescription:`
<p>A <a
...
behaviors between training and evaluation).`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/v4.23.1/src/transformers/models/t5/modeling_tf_t5.py#L1161",returnDescription:`
<p>A <a
...
Labels for computing the cross entropy classification loss. Indices should be in <code>[0, ..., config.vocab_size - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.23.1/src/transformers/models/t5/modeling_tf_t5.py#L1341",returnDescription:`
<p>A <a
...
Whether or not to use the model in training mode (some modules like dropout modules have different
behaviors between training and evaluation).`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/v4.23.1/src/transformers/models/t5/modeling_tf_t5.py#L1588",returnDescription:`
<p>A <a
...
<p>If <code>past_key_values</code> are used, the user can optionally input only the last <code>decoder_input_ids</code> (those that
don&#x2019;t have their past key value states given to this model) of shape <code>(batch_size, 1)</code> instead of all
<code>decoder_input_ids</code> of shape <code>(batch_size, sequence_length)</code>.`,name:"past_key_values"}],source:"https://github.com/huggingface/transformers/blob/v4.23.1/src/transformers/models/t5/modeling_flax_t5.py#L987",returnDescription:`
<p>A <a
...
`),Zs=r(Ti,"A",{href:!0,rel:!0});var Qy=i(Zs);i_=s(Qy,"Unigram"),Qy.forEach(t),l_=s(Ti,"."),Ti.forEach(t),d_=c(en),Js=r(en,"P",{});var Ap=i(Js);c_=s(Ap,"This tokenizer inherits from "),Vr=r(Ap,"A",{href:!0});var e1=i(Vr);p_=s(e1,"PreTrainedTokenizerFast"),e1.forEach(t),h_=s(Ap,` which contains most of the main methods. Users should
refer to this superclass for more information regarding those methods.`),Ap.forEach(t),u_=c(en),Vt=r(en,"DIV",{class:!0});var vi=i(Vt);k(Xs.$$.fragment,vi),m_=c(vi),Gl=r(vi,"P",{});var t1=i(Gl);f_=s(t1,`Build model inputs from a sequence or a pair of sequence for sequence classification tasks by concatenating and
adding special tokens. A sequence has the following format:`),t1.forEach(t),__=c(vi),Qs=r(vi,"UL",{});var Lp=i(Qs);Yr=r(Lp,"LI",{});var Db=i(Yr);g_=s(Db,"single sequence: "),Ul=r(Db,"CODE",{});var n1=i(Ul);T_=s(n1,"X </s>"),n1.forEach(t),Db.forEach(t),v_=c(Lp),Zr=r(Lp,"LI",{});var Sb=i(Zr);b_=s(Sb,"pair of sequences: "),Bl=r(Sb,"CODE",{});var o1=i(Bl);k_=s(o1,"A </s> B </s>"),o1.forEach(t),Sb.forEach(t),Lp.forEach(t),vi.forEach(t),y_=c(en),Zn=r(en,"DIV",{class:!0});var Ip=i(Zn);k(ea.$$.fragment,Ip),w_=c(Ip),Wl=r(Ip,"P",{});var s1=i(Wl);$_=s(s1,`Create a mask from the two sequences passed to be used in a sequence-pair classification task. T5 does not make
use of token type ids, therefore a list of zeros is returned.`),s1.forEach(t),Ip.forEach(t),en.forEach(t),Xc=c(n),hn=r(n,"H2",{class:!0});var Dp=i(hn);Jn=r(Dp,"A",{id:!0,class:!0,href:!0});var a1=i(Jn);Rl=r(a1,"SPAN",{});var r1=i(Rl);k(ta.$$.fragment,r1),r1.forEach(t),a1.forEach(t),x_=c(Dp),Hl=r(Dp,"SPAN",{});var i1=i(Hl);z_=s(i1,"T5Model"),i1.forEach(t),Dp.forEach(t),Qc=c(n),oe=r(n,"DIV",{class:!0});var Ie=i(oe);k(na.$$.fragment,Ie),j_=c(Ie),Kl=r(Ie,"P",{});var l1=i(Kl);E_=s(l1,"The bare T5 Model transformer outputting raw hidden-states without any specific head on top."),l1.forEach(t),q_=c(Ie),oa=r(Ie,"P",{});var Sp=i(oa);F_=s(Sp,"The T5 model was proposed in "),sa=r(Sp,"A",{href:!0,rel:!0});var d1=i(sa);M_=s(d1,`Exploring the Limits of Transfer Learning with a Unified Text-to-Text
Transformer`),d1.forEach(t),C_=s(Sp,` by Colin Raffel, Noam Shazeer, Adam Roberts, Katherine Lee, Sharan
Narang, Michael Matena, Yanqi Zhou, Wei Li, Peter J. Liu. It\u2019s an encoder decoder transformer pre-trained in a
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Up.forEach(t),G_=c(Ie),jt=r(Ie,"DIV",{class:!0});var Ro=i(jt);k(la.$$.fragment,Ro),U_=c(Ro),un=r(Ro,"P",{});var bi=i(un);B_=s(bi,"The "),Xr=r(bi,"A",{href:!0});var h1=i(Xr);W_=s(h1,"T5Model"),h1.forEach(t),R_=s(bi," forward method, overrides the "),Vl=r(bi,"CODE",{});var u1=i(Vl);H_=s(u1,"__call__"),u1.forEach(t),K_=s(bi," special method."),bi.forEach(t),V_=c(Ro),k(Xn.$$.fragment,Ro),Y_=c(Ro),k(Qn.$$.fragment,Ro),Ro.forEach(t),Z_=c(Ie),Et=r(Ie,"DIV",{class:!0});var Ho=i(Et);k(da.$$.fragment,Ho),J_=c(Ho),Yl=r(Ho,"P",{});var m1=i(Yl);X_=s(m1,"This is an experimental feature and is a subject to change at a moment\u2019s notice."),m1.forEach(t),Q_=c(Ho),Zl=r(Ho,"P",{});var f1=i(Zl);eg=s(f1,`Uses a device map to distribute attention modules of the model across several devices. If no device map is given,
it will evenly distribute blocks across all devices.`),f1.forEach(t),tg=c(Ho),k(eo.$$.fragment,Ho),Ho.forEach(t),ng=c(Ie),Yt=r(Ie,"DIV",{class:!0});var ki=i(Yt);k(ca.$$.fragment,ki),og=c(ki),Jl=r(ki,"P",{});var _1=i(Jl);sg=s(_1,"Moves the model to cpu from a model parallel state."),_1.forEach(t),ag=c(ki),k(to.$$.fragment,ki),ki.forEach(t),Ie.forEach(t),ep=c(n),mn=r(n,"H2",{class:!0});var Bp=i(mn);no=r(Bp,"A",{id:!0,class:!0,href:!0});var g1=i(no);Xl=r(g1,"SPAN",{});var T1=i(Xl);k(pa.$$.fragment,T1),T1.forEach(t),g1.forEach(t),rg=c(Bp),Ql=r(Bp,"SPAN",{});var v1=i(Ql);ig=s(v1,"T5ForConditionalGeneration"),v1.forEach(t),Bp.forEach(t),tp=c(n),se=r(n,"DIV",{class:!0});var De=i(se);k(ha.$$.fragment,De),lg=c(De),ua=r(De,"P",{});var Wp=i(ua);dg=s(Wp,"T5 Model with a "),ed=r(Wp,"CODE",{});var b1=i(ed);cg=s(b1,"language modeling"),b1.forEach(t),pg=s(Wp," head on top."),Wp.forEach(t),hg=c(De),ma=r(De,"P",{});var Rp=i(ma);ug=s(Rp,"The T5 model was proposed in "),fa=r(Rp,"A",{href:!0,rel:!0});var k1=i(fa);mg=s(k1,`Exploring the Limits of Transfer Learning with a Unified Text-to-Text
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Hp.forEach(t),bg=c(De),ga=r(De,"P",{});var Kp=i(ga);kg=s(Kp,"This model is also a PyTorch "),Ta=r(Kp,"A",{href:!0,rel:!0});var w1=i(Ta);yg=s(w1,"torch.nn.Module"),w1.forEach(t),wg=s(Kp,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Kp.forEach(t),$g=c(De),qt=r(De,"DIV",{class:!0});var Ko=i(qt);k(va.$$.fragment,Ko),xg=c(Ko),fn=r(Ko,"P",{});var yi=i(fn);zg=s(yi,"The "),ei=r(yi,"A",{href:!0});var $1=i(ei);jg=s($1,"T5ForConditionalGeneration"),$1.forEach(t),Eg=s(yi," forward method, overrides the "),td=r(yi,"CODE",{});var x1=i(td);qg=s(x1,"__call__"),x1.forEach(t),Fg=s(yi," special method."),yi.forEach(t),Mg=c(Ko),k(oo.$$.fragment,Ko),Cg=c(Ko),k(so.$$.fragment,Ko),Ko.forEach(t),Pg=c(De),Ft=r(De,"DIV",{class:!0});var Vo=i(Ft);k(ba.$$.fragment,Vo),Og=c(Vo),nd=r(Vo,"P",{});var z1=i(nd);Ng=s(z1,"This is an experimental feature and is a subject to change at a moment\u2019s notice."),z1.forEach(t),Ag=c(Vo),od=r(Vo,"P",{});var j1=i(od);Lg=s(j1,`Uses a device map to distribute attention modules of the model across several devices. If no device map is given,
it will evenly distribute blocks across all devices.`),j1.forEach(t),Ig=c(Vo),k(ao.$$.fragment,Vo),Vo.forEach(t),Dg=c(De),Zt=r(De,"DIV",{class:!0});var wi=i(Zt);k(ka.$$.fragment,wi),Sg=c(wi),sd=r(wi,"P",{});var E1=i(sd);Gg=s(E1,"Moves the model to cpu from a model parallel state."),E1.forEach(t),Ug=c(wi),k(ro.$$.fragment,wi),wi.forEach(t),De.forEach(t),np=c(n),_n=r(n,"H2",{class:!0});var Vp=i(_n);io=r(Vp,"A",{id:!0,class:!0,href:!0});var q1=i(io);ad=r(q1,"SPAN",{});var F1=i(ad);k(ya.$$.fragment,F1),F1.forEach(t),q1.forEach(t),Bg=c(Vp),rd=r(Vp,"SPAN",{});var M1=i(rd);Wg=s(M1,"T5EncoderModel"),M1.forEach(t),Vp.forEach(t),op=c(n),ae=r(n,"DIV",{class:!0});var Se=i(ae);k(wa.$$.fragment,Se),Rg=c(Se),id=r(Se,"P",{});var C1=i(id);Hg=s(C1,"The bare T5 Model transformer outputting encoder\u2019s raw hidden-states without any specific head on top."),C1.forEach(t),Kg=c(Se),$a=r(Se,"P",{});var Yp=i($a);Vg=s(Yp,"The T5 model was proposed in "),xa=r(Yp,"A",{href:!0,rel:!0});var P1=i(xa);Yg=s(P1,`Exploring the Limits of Transfer Learning with a Unified Text-to-Text
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Jp.forEach(t),aT=c(Se),Mt=r(Se,"DIV",{class:!0});var Yo=i(Mt);k(qa.$$.fragment,Yo),rT=c(Yo),gn=r(Yo,"P",{});var $i=i(gn);iT=s($i,"The "),ni=r($i,"A",{href:!0});var A1=i(ni);lT=s(A1,"T5EncoderModel"),A1.forEach(t),dT=s($i," forward method, overrides the "),ld=r($i,"CODE",{});var L1=i(ld);cT=s(L1,"__call__"),L1.forEach(t),pT=s($i," special method."),$i.forEach(t),hT=c(Yo),k(lo.$$.fragment,Yo),uT=c(Yo),k(co.$$.fragment,Yo),Yo.forEach(t),mT=c(Se),Ct=r(Se,"DIV",{class:!0});var Zo=i(Ct);k(Fa.$$.fragment,Zo),fT=c(Zo),dd=r(Zo,"P",{});var I1=i(dd);_T=s(I1,"This is an experimental feature and is a subject to change at a moment\u2019s notice."),I1.forEach(t),gT=c(Zo),cd=r(Zo,"P",{});var D1=i(cd);TT=s(D1,`Uses a device map to distribute attention modules of the model across several devices. If no device map is given,
it will evenly distribute blocks across all devices.`),D1.forEach(t),vT=c(Zo),k(po.$$.fragment,Zo),Zo.forEach(t),bT=c(Se),Jt=r(Se,"DIV",{class:!0});var xi=i(Jt);k(Ma.$$.fragment,xi),kT=c(xi),pd=r(xi,"P",{});var S1=i(pd);yT=s(S1,"Moves the model to cpu from a model parallel state."),S1.forEach(t),wT=c(xi),k(ho.$$.fragment,xi),xi.forEach(t),Se.forEach(t),sp=c(n),Tn=r(n,"H2",{class:!0});var Xp=i(Tn);uo=r(Xp,"A",{id:!0,class:!0,href:!0});var G1=i(uo);hd=r(G1,"SPAN",{});var U1=i(hd);k(Ca.$$.fragment,U1),U1.forEach(t),G1.forEach(t),$T=c(Xp),ud=r(Xp,"SPAN",{});var B1=i(ud);xT=s(B1,"TFT5Model"),B1.forEach(t),Xp.forEach(t),ap=c(n),ue=r(n,"DIV",{class:!0});var ut=i(ue);k(Pa.$$.fragment,ut),zT=c(ut),md=r(ut,"P",{});var W1=i(md);jT=s(W1,"The bare T5 Model transformer outputting raw hidden-stateswithout any specific head on top."),W1.forEach(t),ET=c(ut),Oa=r(ut,"P",{});var Qp=i(Oa);qT=s(Qp,"The T5 model was proposed in "),Na=r(Qp,"A",{href:!0,rel:!0});var R1=i(Na);FT=s(R1,`Exploring the Limits of Transfer Learning with a Unified Text-to-Text
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),eh.forEach(t),AT=c(ut),La=r(ut,"P",{});var th=i(La);LT=s(th,"This model is also a "),Ia=r(th,"A",{href:!0,rel:!0});var K1=i(Ia);IT=s(K1,"tf.keras.Model"),K1.forEach(t),DT=s(th,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),th.forEach(t),ST=c(ut),k(mo.$$.fragment,ut),GT=c(ut),Pt=r(ut,"DIV",{class:!0});var Jo=i(Pt);k(Da.$$.fragment,Jo),UT=c(Jo),vn=r(Jo,"P",{});var zi=i(vn);BT=s(zi,"The "),si=r(zi,"A",{href:!0});var V1=i(si);WT=s(V1,"TFT5Model"),V1.forEach(t),RT=s(zi," forward method, overrides the "),fd=r(zi,"CODE",{});var Y1=i(fd);HT=s(Y1,"__call__"),Y1.forEach(t),KT=s(zi," special method."),zi.forEach(t),VT=c(Jo),k(fo.$$.fragment,Jo),YT=c(Jo),k(_o.$$.fragment,Jo),Jo.forEach(t),ut.forEach(t),rp=c(n),bn=r(n,"H2",{class:!0});var nh=i(bn);go=r(nh,"A",{id:!0,class:!0,href:!0});var Z1=i(go);_d=r(Z1,"SPAN",{});var J1=i(_d);k(Sa.$$.fragment,J1),J1.forEach(t),Z1.forEach(t),ZT=c(nh),gd=r(nh,"SPAN",{});var X1=i(gd);JT=s(X1,"TFT5ForConditionalGeneration"),X1.forEach(t),nh.forEach(t),ip=c(n),me=r(n,"DIV",{class:!0});var mt=i(me);k(Ga.$$.fragment,mt),XT=c(mt),Ua=r(mt,"P",{});var oh=i(Ua);QT=s(oh,"T5 Model with a "),Td=r(oh,"CODE",{});var Q1=i(Td);ev=s(Q1,"language modeling"),Q1.forEach(t),tv=s(oh," head on top."),oh.forEach(t),nv=c(mt),Ba=r(mt,"P",{});var sh=i(Ba);ov=s(sh,"The T5 model was proposed in "),Wa=r(sh,"A",{href:!0,rel:!0});var e5=i(Wa);sv=s(e5,`Exploring the Limits of Transfer Learning with a Unified Text-to-Text
