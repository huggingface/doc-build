...
<span class="hljs-meta">&gt;&gt;&gt; </span>configuration = model.config`}}),{c(){m=a("p"),E=r("Example:"),u=l(),g(_.$$.fragment)},l(f){m=n(f,"P",{});var S=i(m);E=s(S,"Example:"),S.forEach(o),u=d(f),v(_.$$.fragment,f)},m(f,S){h(f,m,S),e(m,E),h(f,u,S),T(_,f,S),w=!0},p:Hi,i(f){w||(x(_.$$.fragment,f),w=!0)},o(f){k(_.$$.fragment,f),w=!1},d(f){f&&o(m),f&&o(u),b(_,f)}}}function Zi(H){let m,E,u,_,w,f,S,D;return{c(){m=a("p"),E=r(`This class method is simply calling the feature extractor
`),u=a("a"),_=r("from_pretrained()"),w=r(` and the tokenizer
`),f=a("code"),S=r("~tokenization_utils_base.PreTrainedTokenizer.from_pretrained"),D=r(` methods. Please refer to the docstrings of the
methods above for more information.`),this.h()},l(q){m=n(q,"P",{});var $=i(m);E=s($,`This class method is simply calling the feature extractor
`),u=n($,"A",{href:!0});var M=i(u);_=s(M,"from_pretrained()"),M.forEach(o),w=s($,` and the tokenizer
`),f=n($,"CODE",{});var F=i(f);S=s(F,"~tokenization_utils_base.PreTrainedTokenizer.from_pretrained"),F.forEach(o),D=s($,` methods. Please refer to the docstrings of the
methods above for more information.`),$.forEach(o),this.h()},h(){c(u,"href","/docs/transformers/v4.23.1/en/main_classes/feature_extractor#transformers.FeatureExtractionMixin.from_pretrained")},m(q,$){h(q,m,$),e(m,E),e(m,u),e(u,_),e(m,w),e(m,f),e(f,S),e(m,D)},d(q){q&&o(m)}}}function ec(H){let m,E,u,_,w,f,S,D;return{c(){m=a("p"),E=r("This class method is simply calling "),u=a("a"),_=r("save_pretrained()"),w=r(` and
`),f=a("code"),S=r("~tokenization_utils_base.PreTrainedTokenizer.save_pretrained"),D=r(`. Please refer to the docstrings of the methods
above for more information.`),this.h()},l(q){m=n(q,"P",{});var $=i(m);E=s($,"This class method is simply calling "),u=n($,"A",{href:!0});var M=i(u);_=s(M,"save_pretrained()"),M.forEach(o),w=s($,` and
`),f=n($,"CODE",{});var F=i(f);S=s(F,"~tokenization_utils_base.PreTrainedTokenizer.save_pretrained"),F.forEach(o),D=s($,`. Please refer to the docstrings of the methods
above for more information.`),$.forEach(o),this.h()},h(){c(u,"href","/docs/transformers/v4.23.1/en/main_classes/feature_extractor#transformers.FeatureExtractionMixin.save_pretrained")},m(q,$){h(q,m,$),e(m,E),e(m,u),e(u,_),e(m,w),e(m,f),e(f,S),e(m,D)},d(q){q&&o(m)}}}function tc(H){let m,E,u,_,w;return _=new $r({props:{code:`from transformers import (
...
the <code>inputs_ids</code> passed when calling <a href="/docs/transformers/v4.23.1/en/model_doc/speech_to_text#transformers.Speech2TextModel">Speech2TextModel</a>`,name:"vocab_size"},{anchor:"transformers.Speech2Text2Config.d_model",description:`<strong>d_model</strong> (<code>int</code>, <em>optional</em>, defaults to 1024) &#x2014;
...
`,returnType:`
<p><code>str</code></p>
`}}),Ke=new V({props:{name:"save_vocabulary",anchor:"transformers.Speech2Text2Tokenizer.save_vocabulary",parameters:[{name:"save_directory",val:": str"},{name:"filename_prefix",val:": typing.Optional[str] = None"}],source:"https://github.com/huggingface/transformers/blob/v4.23.1/src/transformers/models/speech_to_text_2/tokenization_speech_to_text_2.py#L241"}}),Qe=new ut({}),Xe=new V({props:{name:"class transformers.Speech2Text2Processor",anchor:"transformers.Speech2Text2Processor",parameters:[{name:"feature_extractor",val:""},{name:"tokenizer",val:""}],parametersDescription:[{anchor:"transformers.Speech2Text2Processor.feature_extractor",description:`<strong>feature_extractor</strong> (<code>AutoFeatureExtractor</code>) &#x2014;
...
An instance of <a href="/docs/transformers/v4.23.1/en/model_doc/speech_to_text_2#transformers.Speech2Text2Tokenizer">Speech2Text2Tokenizer</a>. The tokenizer is a required input.`,name:"tokenizer"}],source:"https://github.com/huggingface/transformers/blob/v4.23.1/src/transformers/models/speech_to_text_2/processing_speech_to_text_2.py#L24"}}),et=new V({props:{name:"__call__",anchor:"transformers.Speech2Text2Processor.__call__",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/v4.23.1/src/transformers/models/speech_to_text_2/processing_speech_to_text_2.py#L46"}}),ot=new V({props:{name:"from_pretrained",anchor:"transformers.Speech2Text2Processor.from_pretrained",parameters:[{name:"pretrained_model_name_or_path",val:""},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.Speech2Text2Processor.from_pretrained.pretrained_model_name_or_path",description:`<strong>pretrained_model_name_or_path</strong> (<code>str</code> or <code>os.PathLike</code>) &#x2014;
...
elements depending on the configuration (<a
  href="/docs/transformers/v4.23.1/en/model_doc/speech_to_text_2#transformers.Speech2Text2Config"
...
the `),qe=a("a"),es=r("official models"),ts=r(" ."),os=l(),Me=a("li"),rs=r("Speech2Text2 is always used within the "),kt=a("a"),ss=r("SpeechEncoderDecoder"),as=r(" framework."),ns=l(),Fe=a("li"),is=r("Speech2Text2\u2019s tokenizer is based on "),Ae=a("a"),cs=r("fastBPE"),ls=r("."),Wo=l(),Z=a("h2"),ce=a("a"),so=a("span"),g(Le.$$.fragment),ds=l(),ao=a("span"),ps=r("Inference"),Io=l(),Y=a("p"),hs=r("Speech2Text2\u2019s "),bt=a("a"),fs=r("SpeechEncoderDecoderModel"),ms=r(` model accepts raw waveform input values from speech and
...
documentation from `),Mt=a("a"),Js=r("PretrainedConfig"),Gs=r(" for more information."),Ys=l(),g(pe.$$.fragment),Go=l(),re=a("h2"),he=a("a"),ho=a("span"),g(Re.$$.fragment),Ks=l(),fo=a("span"),Qs=r("Speech2TextTokenizer"),Yo=l(),P=a("div"),g(Ue.$$.fragment),Xs=l(),mo=a("p"),Zs=r("Constructs a Speech2Text2Tokenizer."),ea=l(),He=a("p"),ta=r("This tokenizer inherits from "),Ft=a("a"),oa=r("PreTrainedTokenizer"),ra=r(` which contains some of the main methods. Users should refer to
...
the superclass for more information regarding such methods.`),hr.forEach(o),sa=d(O),fe=n(O,"DIV",{class:!0});var fr=i(fe);v(Je.$$.fragment,fr),aa=d(fr),uo=n(fr,"P",{});var gi=i(uo);na=s(gi,"Convert a list of lists of token ids into a list of strings by calling decode."),gi.forEach(o),fr.forEach(o),ia=d(O),K=n(O,"DIV",{class:!0});var Kt=i(K);v(Ge.$$.fragment,Kt),ca=d(Kt),_o=n(Kt,"P",{});var vi=i(_o);la=s(vi,`Converts a sequence of ids in a string, using the tokenizer and vocabulary with options to remove special
