...
<em>inputs_ids</em> passed to the forward method of <a href="/docs/transformers/v4.23.1/en/model_doc/markuplm#transformers.MarkupLMModel">MarkupLMModel</a>.`,name:"vocab_size"},{anchor:"transformers.MarkupLMConfig.hidden_size",description:`<strong>hidden_size</strong> (<code>int</code>, <em>optional</em>, defaults to 768) &#x2014;
...
The maximum depth in xpath.`,name:"max_depth"}],source:"https://github.com/huggingface/transformers/blob/v4.23.1/src/transformers/models/markuplm/configuration_markuplm.py#L30"}}),ft=new Vs({props:{anchor:"transformers.MarkupLMConfig.example",$$slots:{default:[Hy]},$$scope:{ctx:P}}}),qo=new xe({}),$o=new z({props:{name:"class transformers.MarkupLMFeatureExtractor",anchor:"transformers.MarkupLMFeatureExtractor",parameters:[{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/v4.23.1/src/transformers/models/markuplm/feature_extraction_markuplm.py#L33"}}),zo=new z({props:{name:"__call__",anchor:"transformers.MarkupLMFeatureExtractor.__call__",parameters:[{name:"html_strings",val:""}],parametersDescription:[{anchor:"transformers.MarkupLMFeatureExtractor.__call__.html_strings",description:`<strong>html_strings</strong> (<code>str</code>, <code>List[str]</code>) &#x2014;
The HTML string or batch of HTML strings from which to extract nodes and corresponding xpaths.`,name:"html_strings"}],source:"https://github.com/huggingface/transformers/blob/v4.23.1/src/transformers/models/markuplm/feature_extraction_markuplm.py#L99",returnDescription:`
<p>A <a
...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/v4.23.1/src/transformers/models/markuplm/tokenization_markuplm.py#L423",returnDescription:`
...
Whether or not the token list is already formatted with special tokens for the model.`,name:"special"}],source:"https://github.com/huggingface/transformers/blob/v4.23.1/src/transformers/models/markuplm/tokenization_markuplm.py#L461",returnDescription:`
...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/v4.23.1/src/transformers/models/markuplm/tokenization_markuplm.py#L486",returnDescription:`
<p>List of zeros.</p>
`,returnType:`
<p><code>List[int]</code></p>
...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/v4.23.1/src/transformers/models/markuplm/tokenization_markuplm_fast.py#L878",returnDescription:`
<p>List of <a href="../glossary#input-ids">input IDs</a> with the appropriate special tokens.</p>
`,returnType:`
<p><code>List[int]</code></p>
...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/v4.23.1/src/transformers/models/markuplm/tokenization_markuplm_fast.py#L900",returnDescription:`
<p>List of zeros.</p>
`,returnType:`
<p><code>List[int]</code></p>
...
Whether or not to use <code>MarkupLMFeatureExtractor</code> to parse HTML strings into nodes and corresponding xpaths.`,name:"parse_html"}],source:"https://github.com/huggingface/transformers/blob/v4.23.1/src/transformers/models/markuplm/processing_markuplm.py#L25"}}),Ko=new z({props:{name:"__call__",anchor:"transformers.MarkupLMProcessor.__call__",parameters:[{name:"html_strings",val:" = None"},{name:"nodes",val:" = None"},{name:"xpaths",val:" = None"},{name:"node_labels",val:" = None"},{name:"questions",val:" = None"},{name:"add_special_tokens",val:": bool = True"},{name:"padding",val:": typing.Union[bool, str, transformers.utils.generic.PaddingStrategy] = False"},{name:"truncation",val:": typing.Union[bool, str, transformers.tokenization_utils_base.TruncationStrategy] = False"},{name:"max_length",val:": typing.Optional[int] = None"},{name:"stride",val:": int = 0"},{name:"pad_to_multiple_of",val:": typing.Optional[int] = None"},{name:"return_token_type_ids",val:": typing.Optional[bool] = None"},{name:"return_attention_mask",val:": typing.Optional[bool] = None"},{name:"return_overflowing_tokens",val:": bool = False"},{name:"return_special_tokens_mask",val:": bool = False"},{name:"return_offsets_mapping",val:": bool = False"},{name:"return_length",val:": bool = False"},{name:"verbose",val:": bool = True"},{name:"return_tensors",val:": typing.Union[str, transformers.utils.generic.TensorType, NoneType] = None"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/v4.23.1/src/transformers/models/markuplm/processing_markuplm.py#L48"}}),Zo=new xe({}),en=new z({props:{name:"class transformers.MarkupLMModel",anchor:"transformers.MarkupLMModel",parameters:[{name:"config",val:""},{name:"add_pooling_layer",val:" = True"}],parametersDescription:[{anchor:"transformers.MarkupLMModel.config",description:`<strong>config</strong> (<a href="/docs/transformers/v4.23.1/en/model_doc/markuplm#transformers.MarkupLMConfig">MarkupLMConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/v4.23.1/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/v4.23.1/src/transformers/models/markuplm/modeling_markuplm.py#L800"}}),nn=new z({props:{name:"forward",anchor:"transformers.MarkupLMModel.forward",parameters:[{name:"input_ids",val:" = None"},{name:"xpath_tags_seq",val:" = None"},{name:"xpath_subs_seq",val:" = None"},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],parametersDescription:[{anchor:"transformers.MarkupLMModel.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/v4.23.1/en/model_doc/markuplm#transformers.MarkupLMTokenizer">MarkupLMTokenizer</a>. See <a href="/docs/transformers/v4.23.1/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
...
elements depending on the configuration (<a
  href="/docs/transformers/v4.23.1/en/model_doc/markuplm#transformers.MarkupLMConfig"
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/v4.23.1/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/v4.23.1/src/transformers/models/markuplm/modeling_markuplm.py#L1188"}}),dn=new z({props:{name:"forward",anchor:"transformers.MarkupLMForSequenceClassification.forward",parameters:[{name:"input_ids",val:" = None"},{name:"xpath_tags_seq",val:" = None"},{name:"xpath_subs_seq",val:" = None"},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"labels",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],parametersDescription:[{anchor:"transformers.MarkupLMForSequenceClassification.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/v4.23.1/en/model_doc/markuplm#transformers.MarkupLMTokenizer">MarkupLMTokenizer</a>. See <a href="/docs/transformers/v4.23.1/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/v4.23.1/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.23.1/src/transformers/models/markuplm/modeling_markuplm.py#L1205",returnDescription:`
<p>A <a
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/v4.23.1/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/v4.23.1/src/transformers/models/markuplm/modeling_markuplm.py#L1082"}}),un=new z({props:{name:"forward",anchor:"transformers.MarkupLMForTokenClassification.forward",parameters:[{name:"input_ids",val:" = None"},{name:"xpath_tags_seq",val:" = None"},{name:"xpath_subs_seq",val:" = None"},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"labels",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],parametersDescription:[{anchor:"transformers.MarkupLMForTokenClassification.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/v4.23.1/en/model_doc/markuplm#transformers.MarkupLMTokenizer">MarkupLMTokenizer</a>. See <a href="/docs/transformers/v4.23.1/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/v4.23.1/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.23.1/src/transformers/models/markuplm/modeling_markuplm.py#L1098",returnDescription:`
<p>A <a
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/v4.23.1/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/v4.23.1/src/transformers/models/markuplm/modeling_markuplm.py#L960"}}),kn=new z({props:{name:"forward",anchor:"transformers.MarkupLMForQuestionAnswering.forward",parameters:[{name:"input_ids",val:" = None"},{name:"xpath_tags_seq",val:" = None"},{name:"xpath_subs_seq",val:" = None"},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"start_positions",val:" = None"},{name:"end_positions",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],parametersDescription:[{anchor:"transformers.MarkupLMForQuestionAnswering.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/v4.23.1/en/model_doc/markuplm#transformers.MarkupLMTokenizer">MarkupLMTokenizer</a>. See <a href="/docs/transformers/v4.23.1/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/v4.23.1/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/v4.23.1/src/transformers/models/markuplm/modeling_markuplm.py#L974",returnDescription:`
<p>A <a
...
lengths).
truncation (`),pr=r(se,"CODE",{});var Y1=i(pr);jm=n(Y1,"bool"),Y1.forEach(t),Cm=n(se,", "),hr=r(se,"CODE",{});var J1=i(hr);Pm=n(J1,"str"),J1.forEach(t),Dm=n(se," or "),ps=r(se,"A",{href:!0});var Z1=i(ps);Am=n(Z1,"TruncationStrategy"),Z1.forEach(t),Im=n(se,", "),ur=r(se,"EM",{});var e2=i(ur);Om=n(e2,"optional"),e2.forEach(t),Nm=n(se,", defaults to "),mr=r(se,"CODE",{});var t2=i(mr);Sm=n(t2,"False"),t2.forEach(t),Bm=n(se,`):
Activates and controls truncation. Accepts the following values:`),se.forEach(t),X1.forEach(t),Rm=d(ie),fr=r(ie,"LI",{});var o2=i(fr);De=r(o2,"P",{});var Mn=i(De);gr=r(Mn,"CODE",{});var n2=i(gr);Wm=n(n2,"True"),n2.forEach(t),Um=n(Mn," or "),_r=r(Mn,"CODE",{});var s2=i(_r);Hm=n(s2,"'longest_first'"),s2.forEach(t),Vm=n(Mn,": Truncate to a maximum length specified with the argument "),kr=r(Mn,"CODE",{});var a2=i(kr);Qm=n(a2,"max_length"),a2.forEach(t),Xm=n(Mn,` or
to the maximum acceptable input length for the model if that argument is not provided. This will
truncate token by token, removing a token from the longest sequence in the pair if a pair of
sequences (or a batch of pairs) is provided.`),Mn.forEach(t),o2.forEach(t),Gm=d(ie),vr=r(ie,"LI",{});var r2=i(vr);yt=r(r2,"P",{});var Sl=i(yt);br=r(Sl,"CODE",{});var i2=i(br);Km=n(i2,"'only_first'"),i2.forEach(t),Ym=n(Sl,": Truncate to a maximum length specified with the argument "),Mr=r(Sl,"CODE",{});var l2=i(Mr);Jm=n(l2,"max_length"),l2.forEach(t),Zm=n(Sl,` or to the
maximum acceptable input length for the model if that argument is not provided. This will only
truncate the first sequence of a pair if a pair of sequences (or a batch of pairs) is provided.`),Sl.forEach(t),r2.forEach(t),ef=d(ie),wr=r(ie,"LI",{});var d2=i(wr);xt=r(d2,"P",{});var Bl=i(xt);yr=r(Bl,"CODE",{});var c2=i(yr);tf=n(c2,"'only_second'"),c2.forEach(t),of=n(Bl,": Truncate to a maximum length specified with the argument "),xr=r(Bl,"CODE",{});var p2=i(xr);nf=n(p2,"max_length"),p2.forEach(t),sf=n(Bl,` or to the
maximum acceptable input length for the model if that argument is not provided. This will only
truncate the second sequence of a pair if a pair of sequences (or a batch of pairs) is provided.`),Bl.forEach(t),d2.forEach(t),af=d(ie),Tr=r(ie,"LI",{});var h2=i(Tr);me=r(h2,"P",{});var dt=i(me);Er=r(dt,"CODE",{});var u2=i(Er);rf=n(u2,"False"),u2.forEach(t),lf=n(dt," or "),Lr=r(dt,"CODE",{});var m2=i(Lr);df=n(m2,"'do_not_truncate'"),m2.forEach(t),cf=n(dt,` (default): No truncation (i.e., can output batch with sequence lengths
greater than the model maximum admissible input size).
max_length (`),qr=r(dt,"CODE",{});var f2=i(qr);pf=n(f2,"int"),f2.forEach(t),hf=n(dt,", "),$r=r(dt,"EM",{});var g2=i($r);uf=n(g2,"optional"),g2.forEach(t),mf=n(dt,`):
Controls the maximum length to use by one of the truncation/padding parameters.`),dt.forEach(t),h2.forEach(t),ie.forEach(t),ff=d(re),E=r(re,"P",{});var q=i(E);gf=n(q,"If left unset or set to "),Fr=r(q,"CODE",{});var _2=i(Fr);_f=n(_2,"None"),_2.forEach(t),kf=n(q,`, this will use the predefined model maximum length if a maximum length
is required by one of the truncation/padding parameters. If the model has no specific maximum input
length (like XLNet) truncation/padding to a maximum length will be deactivated.
stride (`),zr=r(q,"CODE",{});var k2=i(zr);vf=n(k2,"int"),k2.forEach(t),bf=n(q,", "),jr=r(q,"EM",{});var v2=i(jr);Mf=n(v2,"optional"),v2.forEach(t),wf=n(q,`, defaults to 0):
If set to a number along with `),Cr=r(q,"CODE",{});var b2=i(Cr);yf=n(b2,"max_length"),b2.forEach(t),xf=n(q,`, the overflowing tokens returned when
`),Pr=r(q,"CODE",{});var M2=i(Pr);Tf=n(M2,"return_overflowing_tokens=True"),M2.forEach(t),Ef=n(q,` will contain some tokens from the end of the truncated sequence
returned to provide some overlap between truncated and overflowing sequences. The value of this
argument defines the number of overlapping tokens.
is_split_into_words (`),Dr=r(q,"CODE",{});var w2=i(Dr);Lf=n(w2,"bool"),w2.forEach(t),qf=n(q,", "),Ar=r(q,"EM",{});var y2=i(Ar);$f=n(y2,"optional"),y2.forEach(t),Ff=n(q,", defaults to "),Ir=r(q,"CODE",{});var x2=i(Ir);zf=n(x2,"False"),x2.forEach(t),jf=n(q,`):
Whether or not the input is already pre-tokenized (e.g., split into words). If set to `),Or=r(q,"CODE",{});var T2=i(Or);Cf=n(T2,"True"),T2.forEach(t),Pf=n(q,`, the
tokenizer assumes the input is already split into words (for instance, by splitting it on whitespace)
which it will tokenize. This is useful for NER or token classification.
pad_to_multiple_of (`),Nr=r(q,"CODE",{});var E2=i(Nr);Df=n(E2,"int"),E2.forEach(t),Af=n(q,", "),Sr=r(q,"EM",{});var L2=i(Sr);If=n(L2,"optional"),L2.forEach(t),Of=n(q,`):
If set will pad the sequence to a multiple of the provided value. This is especially useful to enable
the use of Tensor Cores on NVIDIA hardware with compute capability >= 7.5 (Volta).
return_tensors (`),Br=r(q,"CODE",{});var q2=i(Br);Nf=n(q2,"str"),q2.forEach(t),Sf=n(q," or "),hs=r(q,"A",{href:!0});var $2=i(hs);Bf=n($2,"TensorType"),$2.forEach(t),Rf=n(q,", "),Rr=r(q,"EM",{});var F2=i(Rr);Wf=n(F2,"optional"),F2.forEach(t),Uf=n(q,`):
If set, will return tensors instead of list of python integers. Acceptable values are:`),q.forEach(t),Hf=d(re),Ge=r(re,"UL",{});var As=i(Ge);Tt=r(As,"LI",{});var Rl=i(Tt);Wr=r(Rl,"CODE",{});var z2=i(Wr);Vf=n(z2,"'tf'"),z2.forEach(t),Qf=n(Rl,": Return TensorFlow "),Ur=r(Rl,"CODE",{});var j2=i(Ur);Xf=n(j2,"tf.constant"),j2.forEach(t),Gf=n(Rl," objects."),Rl.forEach(t),Kf=d(As),Et=r(As,"LI",{});var Wl=i(Et);Hr=r(Wl,"CODE",{});var C2=i(Hr);Yf=n(C2,"'pt'"),C2.forEach(t),Jf=n(Wl,": Return PyTorch "),Vr=r(Wl,"CODE",{});var P2=i(Vr);Zf=n(P2,"torch.Tensor"),P2.forEach(t),eg=n(Wl," objects."),Wl.forEach(t),tg=d(As),Lt=r(As,"LI",{});var Ul=i(Lt);Qr=r(Ul,"CODE",{});var D2=i(Qr);og=n(D2,"'np'"),D2.forEach(t),ng=n(Ul,": Return Numpy "),Xr=r(Ul,"CODE",{});var A2=i(Xr);sg=n(A2,"np.ndarray"),A2.forEach(t),ag=n(Ul," objects."),Ul.forEach(t),As.forEach(t),rg=d(re),I=r(re,"P",{});var Q=i(I);ig=n(Q,"add_special_tokens ("),Gr=r(Q,"CODE",{});var I2=i(Gr);lg=n(I2,"bool"),I2.forEach(t),dg=n(Q,", "),Kr=r(Q,"EM",{});var O2=i(Kr);cg=n(O2,"optional"),O2.forEach(t),pg=n(Q,", defaults to "),Yr=r(Q,"CODE",{});var N2=i(Yr);hg=n(N2,"True"),N2.forEach(t),ug=n(Q,`):
Whether or not to encode the sequences with the special tokens relative to their model.
padding (`),Jr=r(Q,"CODE",{});var S2=i(Jr);mg=n(S2,"bool"),S2.forEach(t),fg=n(Q,", "),Zr=r(Q,"CODE",{});var B2=i(Zr);gg=n(B2,"str"),B2.forEach(t),_g=n(Q," or "),us=r(Q,"A",{href:!0});var R2=i(us);kg=n(R2,"PaddingStrategy"),R2.forEach(t),vg=n(Q,", "),ei=r(Q,"EM",{});var W2=i(ei);bg=n(W2,"optional"),W2.forEach(t),Mg=n(Q,", defaults to "),ti=r(Q,"CODE",{});var U2=i(ti);wg=n(U2,"False"),U2.forEach(t),yg=n(Q,`):
Activates and controls padding. Accepts the following values:`),Q.forEach(t),xg=d(re),C=r(re,"UL",{});var N=i(C);oi=r(N,"LI",{});var H2=i(oi);qt=r(H2,"P",{});var Hl=i(qt);ni=r(Hl,"CODE",{});var V2=i(ni);Tg=n(V2,"True"),V2.forEach(t),Eg=n(Hl," or "),si=r(Hl,"CODE",{});var Q2=i(si);Lg=n(Q2,"'longest'"),Q2.forEach(t),qg=n(Hl,`: Pad to the longest sequence in the batch (or no padding if only a single
sequence if provided).`),Hl.forEach(t),H2.forEach(t),$g=d(N),ai=r(N,"LI",{});var X2=i(ai);$t=r(X2,"P",{});var Vl=i($t);ri=r(Vl,"CODE",{});var G2=i(ri);Fg=n(G2,"'max_length'"),G2.forEach(t),zg=n(Vl,": Pad to a maximum length specified with the argument "),ii=r(Vl,"CODE",{});var K2=i(ii);jg=n(K2,"max_length"),K2.forEach(t),Cg=n(Vl,` or to the maximum
acceptable input length for the model if that argument is not provided.`),Vl.forEach(t),X2.forEach(t),Pg=d(N),li=r(N,"LI",{});var Y2=i(li);U=r(Y2,"P",{});var ae=i(U);di=r(ae,"CODE",{});var J2=i(di);Dg=n(J2,"False"),J2.forEach(t),Ag=n(ae," or "),ci=r(ae,"CODE",{});var Z2=i(ci);Ig=n(Z2,"'do_not_pad'"),Z2.forEach(t),Og=n(ae,` (default): No padding (i.e., can output a batch with sequences of different
lengths).
