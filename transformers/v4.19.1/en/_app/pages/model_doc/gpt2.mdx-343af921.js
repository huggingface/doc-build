import{S as Tv,i as vv,s as bv,e as s,k as p,w as y,t as r,M as yv,c as a,d as t,m as h,a as l,x as k,h as i,b as f,F as e,g as _,y as w,q as $,o as P,B as M,v as kv,L as ae}from"../../chunks/vendor-6b77c823.js";import{T as He}from"../../chunks/Tip-39098574.js";import{D as L}from"../../chunks/Docstring-1088f2fb.js";import{C as re}from"../../chunks/CodeBlock-3a8b25a8.js";import{I as ze}from"../../chunks/IconCopyLink-7a11ce68.js";import{E as se}from"../../chunks/ExampleCodeBlock-5212b321.js";function wv(G){let d,T,u,c,g;return c=new re({props:{code:`from transformers import GPT2Model, GPT2Config
...
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),m.forEach(t)},m(n,m){_(n,d,m),e(d,T),e(d,u),e(u,c),e(d,g)},d(n){n&&t(d)}}}function jv(G){let d,T,u,c,g;return c=new re({props:{code:`from transformers import GPT2Tokenizer, GPT2Model
import torch
...
`),J=s("code"),ke=r('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(b){d=a(b,"P",{});var x=l(d);T=i(x,"TF 2.0 models accepts two formats as inputs:"),x.forEach(t),u=h(b),c=a(b,"UL",{});var ne=l(c);g=a(ne,"LI",{});var Ee=l(g);n=i(Ee,"having all inputs as keyword arguments (like PyTorch models), or"),Ee.forEach(t),m=h(ne),j=a(ne,"LI",{});var Ae=l(j);Q=i(Ae,"having all inputs as a list, tuple or dict in the first positional arguments."),Ae.forEach(t),ne.forEach(t),C=h(b),F=a(b,"P",{});var H=l(F);R=i(H,"This second option is useful when using "),I=a(H,"CODE",{});var qe=l(I);Z=i(qe,"tf.keras.Model.fit"),qe.forEach(t),_e=i(H,` method which currently requires having all the
...
`),J=a(we,"CODE",{});var Ve=l(J);ke=i(Ve,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),Ve.forEach(t),we.forEach(t),D.forEach(t)},m(b,x){_(b,d,x),e(d,T),_(b,u,x),_(b,c,x),e(c,g),e(g,n),e(c,m),e(c,j),e(j,Q),_(b,C,x),_(b,F,x),e(F,R),e(F,I),e(I,Z),e(F,_e),e(F,S),e(S,Te),e(F,me),_(b,W,x),_(b,O,x),e(O,ee),_(b,te,x),_(b,z,x),e(z,q),e(q,ie),e(q,V),e(V,fe),e(q,le),e(q,A),e(A,ve),e(z,ge),e(z,E),e(E,be),e(E,U),e(U,B),e(E,de),e(E,K),e(K,ye),e(z,oe),e(z,N),e(N,ce),e(N,J),e(J,ke)},d(b){b&&t(d),b&&t(u),b&&t(c),b&&t(C),b&&t(F),b&&t(W),b&&t(O),b&&t(te),b&&t(z)}}}function Vv(G){let d,T,u,c,g;return{c(){d=s("p"),T=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),u=s("code"),c=r("Module"),g=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(n){d=a(n,"P",{});var m=l(d);T=i(m,"Although the recipe for forward pass needs to be defined within this function, one should call the "),u=a(m,"CODE",{});var j=l(u);c=i(j,"Module"),j.forEach(t),g=i(m,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),{c(){d=s("p"),T=r("Example:"),u=p(),y(c.$$.fragment)},l(n){d=a(n,"P",{});var m=l(d);T=i(m,"Example:"),m.forEach(t),u=h(n),k(c.$$.fragment,n)},m(n,m){_(n,d,m),e(d,T),_(n,u,m),w(c,n,m),g=!0},p:ae,i(n){g||($(c.$$.fragment,n),g=!0)},o(n){P(c.$$.fragment,n),g=!1},d(n){n&&t(d),n&&t(u),M(c,n)}}}function Jv(G){let d,T,u,c,g,n,m,j,Q,C,F,R,I,Z,_e,S,Te,me,W,O,ee,te,z,q,ie,V,fe,le,A,ve,ge,E,be,U,B,de,K,ye,oe,N,ce,J,ke;return{c(){d=s("p"),T=r("TF 2.0 models accepts two formats as inputs:"),u=p(),c=s("ul"),g=s("li"),n=r("having all inputs as keyword arguments (like PyTorch models), or"),m=p(),j=s("li"),Q=r("having all inputs as a list, tuple or dict in the first positional arguments."),C=p(),F=s("p"),R=r("This second option is useful when using "),I=s("code"),Z=r("tf.keras.Model.fit"),_e=r(` method which currently requires having all the
tensors in the first argument of the model call function: `),S=s("code"),Te=r("model(inputs)"),me=r("."),W=p(),O=s("p"),ee=r(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),te=p(),z=s("ul"),q=s("li"),ie=r("a single Tensor with "),V=s("code"),fe=r("input_ids"),le=r(" only and nothing else: "),A=s("code"),ve=r("model(inputs_ids)"),ge=p(),E=s("li"),be=r(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),U=s("code"),B=r("model([input_ids, attention_mask])"),de=r(" or "),K=s("code"),ye=r("model([input_ids, attention_mask, token_type_ids])"),oe=p(),N=s("li"),ce=r(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),J=s("code"),ke=r('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(b){d=a(b,"P",{});var x=l(d);T=i(x,"TF 2.0 models accepts two formats as inputs:"),x.forEach(t),u=h(b),c=a(b,"UL",{});var ne=l(c);g=a(ne,"LI",{});var Ee=l(g);n=i(Ee,"having all inputs as keyword arguments (like PyTorch models), or"),Ee.forEach(t),m=h(ne),j=a(ne,"LI",{});var Ae=l(j);Q=i(Ae,"having all inputs as a list, tuple or dict in the first positional arguments."),Ae.forEach(t),ne.forEach(t),C=h(b),F=a(b,"P",{});var H=l(F);R=i(H,"This second option is useful when using "),I=a(H,"CODE",{});var qe=l(I);Z=i(qe,"tf.keras.Model.fit"),qe.forEach(t),_e=i(H,` method which currently requires having all the
...
first positional argument :`),Ue.forEach(t),te=h(b),z=a(b,"UL",{});var D=l(z);q=a(D,"LI",{});var X=l(q);ie=i(X,"a single Tensor with "),V=a(X,"CODE",{});var Be=l(V);fe=i(Be,"input_ids"),Be.forEach(t),le=i(X," only and nothing else: "),A=a(X,"CODE",{});var Ce=l(A);ve=i(Ce,"model(inputs_ids)"),Ce.forEach(t),X.forEach(t),ge=h(D),E=a(D,"LI",{});var Y=l(E);be=i(Y,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),U=a(Y,"CODE",{});var Re=l(U);B=i(Re,"model([input_ids, attention_mask])"),Re.forEach(t),de=i(Y," or "),K=a(Y,"CODE",{});var De=l(K);ye=i(De,"model([input_ids, attention_mask, token_type_ids])"),De.forEach(t),Y.forEach(t),oe=h(D),N=a(D,"LI",{});var we=l(N);ce=i(we,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),J=a(we,"CODE",{});var Ve=l(J);ke=i(Ve,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),Ve.forEach(t),we.forEach(t),D.forEach(t)},m(b,x){_(b,d,x),e(d,T),_(b,u,x),_(b,c,x),e(c,g),e(g,n),e(c,m),e(c,j),e(j,Q),_(b,C,x),_(b,F,x),e(F,R),e(F,I),e(I,Z),e(F,_e),e(F,S),e(S,Te),e(F,me),_(b,W,x),_(b,O,x),e(O,ee),_(b,te,x),_(b,z,x),e(z,q),e(q,ie),e(q,V),e(V,fe),e(q,le),e(q,A),e(A,ve),e(z,ge),e(z,E),e(E,be),e(E,U),e(U,B),e(E,de),e(E,K),e(K,ye),e(z,oe),e(z,N),e(N,ce),e(N,J),e(J,ke)},d(b){b&&t(d),b&&t(u),b&&t(c),b&&t(C),b&&t(F),b&&t(W),b&&t(O),b&&t(te),b&&t(z)}}}function Xv(G){let d,T,u,c,g;return{c(){d=s("p"),T=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),u=s("code"),c=r("Module"),g=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(n){d=a(n,"P",{});var m=l(d);T=i(m,"Although the recipe for forward pass needs to be defined within this function, one should call the "),u=a(m,"CODE",{});var j=l(u);c=i(j,"Module"),j.forEach(t),g=i(m,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
<span class="hljs-meta">&gt;&gt;&gt; </span>inputs = tokenizer(<span class="hljs-string">&quot;Hello, my dog is cute&quot;</span>, return_tensors=<span class="hljs-string">&quot;tf&quot;</span>)
<span class="hljs-meta">&gt;&gt;&gt; </span>outputs = model(inputs)
<span class="hljs-meta">&gt;&gt;&gt; </span>logits = outputs.logits`}}),{c(){d=s("p"),T=r("Example:"),u=p(),y(c.$$.fragment)},l(n){d=a(n,"P",{});var m=l(d);T=i(m,"Example:"),m.forEach(t),u=h(n),k(c.$$.fragment,n)},m(n,m){_(n,d,m),e(d,T),_(n,u,m),w(c,n,m),g=!0},p:ae,i(n){g||($(c.$$.fragment,n),g=!0)},o(n){P(c.$$.fragment,n),g=!1},d(n){n&&t(d),n&&t(u),M(c,n)}}}function Qv(G){let d,T,u,c,g,n,m,j,Q,C,F,R,I,Z,_e,S,Te,me,W,O,ee,te,z,q,ie,V,fe,le,A,ve,ge,E,be,U,B,de,K,ye,oe,N,ce,J,ke;return{c(){d=s("p"),T=r("TF 2.0 models accepts two formats as inputs:"),u=p(),c=s("ul"),g=s("li"),n=r("having all inputs as keyword arguments (like PyTorch models), or"),m=p(),j=s("li"),Q=r("having all inputs as a list, tuple or dict in the first positional arguments."),C=p(),F=s("p"),R=r("This second option is useful when using "),I=s("code"),Z=r("tf.keras.Model.fit"),_e=r(` method which currently requires having all the
tensors in the first argument of the model call function: `),S=s("code"),Te=r("model(inputs)"),me=r("."),W=p(),O=s("p"),ee=r(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),te=p(),z=s("ul"),q=s("li"),ie=r("a single Tensor with "),V=s("code"),fe=r("input_ids"),le=r(" only and nothing else: "),A=s("code"),ve=r("model(inputs_ids)"),ge=p(),E=s("li"),be=r(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),U=s("code"),B=r("model([input_ids, attention_mask])"),de=r(" or "),K=s("code"),ye=r("model([input_ids, attention_mask, token_type_ids])"),oe=p(),N=s("li"),ce=r(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),J=s("code"),ke=r('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(b){d=a(b,"P",{});var x=l(d);T=i(x,"TF 2.0 models accepts two formats as inputs:"),x.forEach(t),u=h(b),c=a(b,"UL",{});var ne=l(c);g=a(ne,"LI",{});var Ee=l(g);n=i(Ee,"having all inputs as keyword arguments (like PyTorch models), or"),Ee.forEach(t),m=h(ne),j=a(ne,"LI",{});var Ae=l(j);Q=i(Ae,"having all inputs as a list, tuple or dict in the first positional arguments."),Ae.forEach(t),ne.forEach(t),C=h(b),F=a(b,"P",{});var H=l(F);R=i(H,"This second option is useful when using "),I=a(H,"CODE",{});var qe=l(I);Z=i(qe,"tf.keras.Model.fit"),qe.forEach(t),_e=i(H,` method which currently requires having all the
...
first positional argument :`),Ue.forEach(t),te=h(b),z=a(b,"UL",{});var D=l(z);q=a(D,"LI",{});var X=l(q);ie=i(X,"a single Tensor with "),V=a(X,"CODE",{});var Be=l(V);fe=i(Be,"input_ids"),Be.forEach(t),le=i(X," only and nothing else: "),A=a(X,"CODE",{});var Ce=l(A);ve=i(Ce,"model(inputs_ids)"),Ce.forEach(t),X.forEach(t),ge=h(D),E=a(D,"LI",{});var Y=l(E);be=i(Y,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),U=a(Y,"CODE",{});var Re=l(U);B=i(Re,"model([input_ids, attention_mask])"),Re.forEach(t),de=i(Y," or "),K=a(Y,"CODE",{});var De=l(K);ye=i(De,"model([input_ids, attention_mask, token_type_ids])"),De.forEach(t),Y.forEach(t),oe=h(D),N=a(D,"LI",{});var we=l(N);ce=i(we,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),J=a(we,"CODE",{});var Ve=l(J);ke=i(Ve,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),Ve.forEach(t),we.forEach(t),D.forEach(t)},m(b,x){_(b,d,x),e(d,T),_(b,u,x),_(b,c,x),e(c,g),e(g,n),e(c,m),e(c,j),e(j,Q),_(b,C,x),_(b,F,x),e(F,R),e(F,I),e(I,Z),e(F,_e),e(F,S),e(S,Te),e(F,me),_(b,W,x),_(b,O,x),e(O,ee),_(b,te,x),_(b,z,x),e(z,q),e(q,ie),e(q,V),e(V,fe),e(q,le),e(q,A),e(A,ve),e(z,ge),e(z,E),e(E,be),e(E,U),e(U,B),e(E,de),e(E,K),e(K,ye),e(z,oe),e(z,N),e(N,ce),e(N,J),e(J,ke)},d(b){b&&t(d),b&&t(u),b&&t(c),b&&t(C),b&&t(F),b&&t(W),b&&t(O),b&&t(te),b&&t(z)}}}function Zv(G){let d,T,u,c,g;return{c(){d=s("p"),T=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),u=s("code"),c=r("Module"),g=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(n){d=a(n,"P",{});var m=l(d);T=i(m,"Although the recipe for forward pass needs to be defined within this function, one should call the "),u=a(m,"CODE",{});var j=l(u);c=i(j,"Module"),j.forEach(t),g=i(m,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
first positional argument :`),Ue.forEach(t),te=h(b),z=a(b,"UL",{});var D=l(z);q=a(D,"LI",{});var X=l(q);ie=i(X,"a single Tensor with "),V=a(X,"CODE",{});var Be=l(V);fe=i(Be,"input_ids"),Be.forEach(t),le=i(X," only and nothing else: "),A=a(X,"CODE",{});var Ce=l(A);ve=i(Ce,"model(inputs_ids)"),Ce.forEach(t),X.forEach(t),ge=h(D),E=a(D,"LI",{});var Y=l(E);be=i(Y,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),U=a(Y,"CODE",{});var Re=l(U);B=i(Re,"model([input_ids, attention_mask])"),Re.forEach(t),de=i(Y," or "),K=a(Y,"CODE",{});var De=l(K);ye=i(De,"model([input_ids, attention_mask, token_type_ids])"),De.forEach(t),Y.forEach(t),oe=h(D),N=a(D,"LI",{});var we=l(N);ce=i(we,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),J=a(we,"CODE",{});var Ve=l(J);ke=i(Ve,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),Ve.forEach(t),we.forEach(t),D.forEach(t)},m(b,x){_(b,d,x),e(d,T),_(b,u,x),_(b,c,x),e(c,g),e(g,n),e(c,m),e(c,j),e(j,Q),_(b,C,x),_(b,F,x),e(F,R),e(F,I),e(I,Z),e(F,_e),e(F,S),e(S,Te),e(F,me),_(b,W,x),_(b,O,x),e(O,ee),_(b,te,x),_(b,z,x),e(z,q),e(q,ie),e(q,V),e(V,fe),e(q,le),e(q,A),e(A,ve),e(z,ge),e(z,E),e(E,be),e(E,U),e(U,B),e(E,de),e(E,K),e(K,ye),e(z,oe),e(z,N),e(N,ce),e(N,J),e(J,ke)},d(b){b&&t(d),b&&t(u),b&&t(c),b&&t(C),b&&t(F),b&&t(W),b&&t(O),b&&t(te),b&&t(z)}}}function ob(G){let d,T,u,c,g;return{c(){d=s("p"),T=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),u=s("code"),c=r("Module"),g=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(n){d=a(n,"P",{});var m=l(d);T=i(m,"Although the recipe for forward pass needs to be defined within this function, one should call the "),u=a(m,"CODE",{});var j=l(u);c=i(j,"Module"),j.forEach(t),g=i(m,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
<span class="hljs-meta">&gt;&gt;&gt; </span>next_token_logits = outputs.logits[:, -<span class="hljs-number">1</span>]`}}),{c(){d=s("p"),T=r("Example:"),u=p(),y(c.$$.fragment)},l(n){d=a(n,"P",{});var m=l(d);T=i(m,"Example:"),m.forEach(t),u=h(n),k(c.$$.fragment,n)},m(n,m){_(n,d,m),e(d,T),_(n,u,m),w(c,n,m),g=!0},p:ae,i(n){g||($(c.$$.fragment,n),g=!0)},o(n){P(c.$$.fragment,n),g=!1},d(n){n&&t(d),n&&t(u),M(c,n)}}}function db(G){let d,T,u,c,g,n,m,j,Q,C,F,R,I,Z,_e,S,Te,me,W,O,ee,te,z,q,ie,V,fe,le,A,ve,ge,E,be,U,B,de,K,ye,oe,N,ce,J,ke,b,x,ne,Ee,Ae,H,qe,We,Ue,D,X,Be,Ce,Y,Re,De,we,Ve,za,hc,uc,$r,mc,fc,Ea,gc,_c,Tc,yt,vc,Pr,bc,yc,Mr,kc,wc,Cn,$c,Pc,Hl,Lt,Dn,Mc,Gc,Gr,xc,jc,Il,Gt,Fc,Ln,zc,Ec,On,qc,Cc,Sl,Ot,go,xr,Nn,Dc,jr,Lc,Al,at,Hn,Oc,kt,Nc,qa,Hc,Ic,Ca,Sc,Ac,In,Wc,Uc,Bc,Nt,Rc,Da,Vc,Kc,La,Jc,Xc,Yc,_o,Wl,Ht,To,Fr,Sn,Qc,zr,Zc,Ul,pe,An,ep,Er,tp,op,qr,np,sp,vo,ap,Wn,rp,Cr,ip,lp,dp,bo,cp,Un,pp,Oa,hp,up,mp,Na,Bn,Bl,It,yo,Dr,Rn,fp,Lr,gp,Rl,$e,Vn,_p,Kn,Tp,Or,vp,bp,yp,Nr,kp,wp,ko,$p,Jn,Pp,Hr,Mp,Gp,xp,wo,jp,Xn,Fp,Ha,zp,Ep,Vl,St,$o,Ir,Yn,qp,Sr,Cp,Kl,At,Qn,Dp,Ar,Lp,Jl,Wt,Zn,Op,Wr,Np,Xl,Ut,Po,Ur,es,Hp,Br,Ip,Yl,Pe,ts,Sp,Rr,Ap,Wp,os,Up,Ia,Bp,Rp,Vp,ns,Kp,ss,Jp,Xp,Yp,lt,as,Qp,Bt,Zp,Sa,eh,th,Vr,oh,nh,sh,Mo,ah,Go,rh,dt,rs,ih,Kr,lh,dh,Jr,ch,ph,xo,hh,xt,is,uh,Xr,mh,fh,jo,Ql,Rt,Fo,Yr,ls,gh,Qr,_h,Zl,Me,ds,Th,Zr,vh,bh,cs,yh,Aa,kh,wh,$h,ps,Ph,hs,Mh,Gh,xh,ct,us,jh,Vt,Fh,Wa,zh,Eh,ei,qh,Ch,Dh,zo,Lh,Eo,Oh,pt,ms,Nh,ti,Hh,Ih,oi,Sh,Ah,qo,Wh,jt,fs,Uh,ni,Bh,Rh,Co,ed,Kt,Do,si,gs,Vh,ai,Kh,td,Ke,_s,Jh,ri,Xh,Yh,Ts,Qh,Ua,Zh,eu,tu,vs,ou,bs,nu,su,au,ht,ys,ru,Jt,iu,Ba,lu,du,ii,cu,pu,hu,Lo,uu,Oo,od,Xt,No,li,ks,mu,di,fu,nd,Ge,ws,gu,ci,_u,Tu,Ra,Va,vu,bu,yu,rt,ku,pi,wu,$u,hi,Pu,Mu,ui,Gu,xu,mi,ju,Fu,zu,$s,Eu,Ka,qu,Cu,Du,Ps,Lu,Ms,Ou,Nu,Hu,Fe,Gs,Iu,Yt,Su,Ja,Au,Wu,fi,Uu,Bu,Ru,Ho,Vu,Io,Ku,So,Ju,Ao,Xu,Wo,sd,Qt,Uo,gi,xs,Yu,_i,Qu,ad,Je,js,Zu,Ti,em,tm,Fs,om,Xa,nm,sm,am,zs,rm,Es,im,lm,dm,Xe,qs,cm,Zt,pm,Ya,hm,um,vi,mm,fm,gm,Bo,_m,Ro,Tm,Vo,rd,eo,Ko,bi,Cs,vm,yi,bm,id,Le,Ds,ym,ki,km,wm,Ls,$m,Qa,Pm,Mm,Gm,Os,xm,Ns,jm,Fm,zm,Jo,Em,ut,Hs,qm,to,Cm,Za,Dm,Lm,wi,Om,Nm,Hm,Xo,Im,Yo,ld,oo,Qo,$i,Is,Sm,Pi,Am,dd,Oe,Ss,Wm,Mi,Um,Bm,As,Rm,er,Vm,Km,Jm,Ws,Xm,Us,Ym,Qm,Zm,Zo,ef,mt,Bs,tf,no,of,tr,nf,sf,Gi,af,rf,lf,en,df,tn,cd,so,on,xi,Rs,cf,ji,pf,pd,Ne,Vs,hf,Fi,uf,mf,Ks,ff,or,gf,_f,Tf,Js,vf,Xs,bf,yf,kf,nn,wf,ft,Ys,$f,ao,Pf,nr,Mf,Gf,zi,xf,jf,Ff,sn,zf,an,hd,ro,rn,Ei,Qs,Ef,qi,qf,ud,he,Zs,Cf,Ci,Df,Lf,sr,ar,Of,Nf,Hf,it,If,Di,Sf,Af,Li,Wf,Uf,Oi,Bf,Rf,Ni,Vf,Kf,Jf,ea,Xf,rr,Yf,Qf,Zf,ta,eg,oa,tg,og,ng,ln,sg,Ye,na,ag,io,rg,ir,ig,lg,Hi,dg,cg,pg,dn,hg,cn,ug,pn,md,lo,hn,Ii,sa,mg,Si,fg,fd,co,aa,gg,Ai,_g,gd,po,un,Wi,ra,Tg,Ui,vg,_d,xe,ia,bg,Bi,yg,kg,la,wg,lr,$g,Pg,Mg,da,Gg,ca,xg,jg,Fg,Ri,zg,Eg,wt,Vi,pa,qg,Cg,Ki,ha,Dg,Lg,Ji,ua,Og,Ng,Xi,ma,Hg,Ig,gt,fa,Sg,ho,Ag,Yi,Wg,Ug,Qi,Bg,Rg,Vg,mn,Kg,fn,Td,uo,gn,Zi,ga,Jg,el,Xg,vd,je,_a,Yg,tl,Qg,Zg,Ta,e_,dr,t_,o_,n_,va,s_,ba,a_,r_,i_,ol,l_,d_,$t,nl,ya,c_,p_,sl,ka,h_,u_,al,wa,m_,f_,rl,$a,g_,__,_t,Pa,T_,mo,v_,il,b_,y_,ll,k_,w_,$_,_n,P_,Tn,bd;return n=new ze({}),Z=new ze({}),Nn=new ze({}),Hn=new L({props:{name:"class transformers.GPT2Config",anchor:"transformers.GPT2Config",parameters:[{name:"vocab_size",val:" = 50257"},{name:"n_positions",val:" = 1024"},{name:"n_embd",val:" = 768"},{name:"n_layer",val:" = 12"},{name:"n_head",val:" = 12"},{name:"n_inner",val:" = None"},{name:"activation_function",val:" = 'gelu_new'"},{name:"resid_pdrop",val:" = 0.1"},{name:"embd_pdrop",val:" = 0.1"},{name:"attn_pdrop",val:" = 0.1"},{name:"layer_norm_epsilon",val:" = 1e-05"},{name:"initializer_range",val:" = 0.02"},{name:"summary_type",val:" = 'cls_index'"},{name:"summary_use_proj",val:" = True"},{name:"summary_activation",val:" = None"},{name:"summary_proj_to_labels",val:" = True"},{name:"summary_first_dropout",val:" = 0.1"},{name:"scale_attn_weights",val:" = True"},{name:"use_cache",val:" = True"},{name:"bos_token_id",val:" = 50256"},{name:"eos_token_id",val:" = 50256"},{name:"scale_attn_by_inverse_layer_idx",val:" = False"},{name:"reorder_and_upcast_attn",val:" = False"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.GPT2Config.vocab_size",description:`<strong>vocab_size</strong> (<code>int</code>, <em>optional</em>, defaults to 50257) &#x2014;
...
Argument used when doing sequence summary, used in the models <a href="/docs/transformers/v4.19.1/en/model_doc/gpt2#transformers.GPT2DoubleHeadsModel">GPT2DoubleHeadsModel</a> and
<a href="/docs/transformers/v4.19.1/en/model_doc/gpt2#transformers.TFGPT2DoubleHeadsModel">TFGPT2DoubleHeadsModel</a>.</p>
...
<a href="/docs/transformers/v4.19.1/en/model_doc/gpt2#transformers.GPT2DoubleHeadsModel">GPT2DoubleHeadsModel</a>.</p>
...
other word. (GPT2 tokenizer detect beginning of words by the preceding space).`,name:"add_prefix_space"}],source:"https://github.com/huggingface/transformers/blob/v4.19.1/src/transformers/models/gpt2/tokenization_gpt2.py#L104"}}),vo=new se({props:{anchor:"transformers.GPT2Tokenizer.example",$$slots:{default:[$v]},$$scope:{ctx:G}}}),bo=new He({props:{$$slots:{default:[Pv]},$$scope:{ctx:G}}}),Bn=new L({props:{name:"save_vocabulary",anchor:"transformers.GPT2Tokenizer.save_vocabulary",parameters:[{name:"save_directory",val:": str"},{name:"filename_prefix",val:": typing.Optional[str] = None"}],source:"https://github.com/huggingface/transformers/blob/v4.19.1/src/transformers/models/gpt2/tokenization_gpt2.py#L288"}}),Rn=new ze({}),Vn=new L({props:{name:"class transformers.GPT2TokenizerFast",anchor:"transformers.GPT2TokenizerFast",parameters:[{name:"vocab_file",val:" = None"},{name:"merges_file",val:" = None"},{name:"tokenizer_file",val:" = None"},{name:"unk_token",val:" = '<|endoftext|>'"},{name:"bos_token",val:" = '<|endoftext|>'"},{name:"eos_token",val:" = '<|endoftext|>'"},{name:"add_prefix_space",val:" = False"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.GPT2TokenizerFast.vocab_file",description:`<strong>vocab_file</strong> (<code>str</code>) &#x2014;
...
<p>Indices can be obtained using <a href="/docs/transformers/v4.19.1/en/model_doc/gpt2#transformers.GPT2Tokenizer">GPT2Tokenizer</a>. See <a href="/docs/transformers/v4.19.1/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
...
Whether or not to return a <a href="/docs/transformers/v4.19.1/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/v4.19.1/src/transformers/models/gpt2/modeling_gpt2.py#L736",returnDescription:`
<p>A <a
...
elements depending on the configuration (<a
  href="/docs/transformers/v4.19.1/en/model_doc/gpt2#transformers.GPT2Config"
...
`}}),Mo=new He({props:{$$slots:{default:[xv]},$$scope:{ctx:G}}}),Go=new se({props:{anchor:"transformers.GPT2Model.forward.example",$$slots:{default:[jv]},$$scope:{ctx:G}}}),rs=new L({props:{name:"parallelize",anchor:"transformers.GPT2Model.parallelize",parameters:[{name:"device_map",val:" = None"}],parametersDescription:[{anchor:"transformers.GPT2Model.parallelize.device_map",description:`<strong>device_map</strong> (<code>Dict[int, list]</code>, optional, defaults to None) &#x2014;
...
<li>gpt2-large: 36</li>
<li>gpt2-xl: 48</li>
</ul>`,name:"device_map"}],source:"https://github.com/huggingface/transformers/blob/v4.19.1/src/transformers/models/gpt2/modeling_gpt2.py#L690"}}),xo=new se({props:{anchor:"transformers.GPT2Model.parallelize.example",$$slots:{default:[Fv]},$$scope:{ctx:G}}}),is=new L({props:{name:"deparallelize",anchor:"transformers.GPT2Model.deparallelize",parameters:[],source:"https://github.com/huggingface/transformers/blob/v4.19.1/src/transformers/models/gpt2/modeling_gpt2.py#L710"}}),jo=new se({props:{anchor:"transformers.GPT2Model.deparallelize.example",$$slots:{default:[zv]},$$scope:{ctx:G}}}),ls=new ze({}),ds=new L({props:{name:"class transformers.GPT2LMHeadModel",anchor:"transformers.GPT2LMHeadModel",parameters:[{name:"config",val:""}],parametersDescription:[{anchor:"transformers.GPT2LMHeadModel.config",description:`<strong>config</strong> (<a href="/docs/transformers/v4.19.1/en/model_doc/gpt2#transformers.GPT2Config">GPT2Config</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/v4.19.1/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/v4.19.1/src/transformers/models/gpt2/modeling_gpt2.py#L945"}}),us=new L({props:{name:"forward",anchor:"transformers.GPT2LMHeadModel.forward",parameters:[{name:"input_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"past_key_values",val:": typing.Optional[typing.Tuple[typing.Tuple[torch.Tensor]]] = None"},{name:"attention_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"token_type_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"position_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"head_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"encoder_hidden_states",val:": typing.Optional[torch.Tensor] = None"},{name:"encoder_attention_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"labels",val:": typing.Optional[torch.LongTensor] = None"},{name:"use_cache",val:": typing.Optional[bool] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.GPT2LMHeadModel.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, input_ids_length)</code>) &#x2014;
<code>input_ids_length</code> = <code>sequence_length</code> if <code>past_key_values</code> is <code>None</code> else
<code>past_key_values[0][0].shape[-2]</code> (<code>sequence_length</code> of input past key value states). Indices of input
sequence tokens in the vocabulary.</p>
<p>If <code>past_key_values</code> is used, only <code>input_ids</code> that do not have their past calculated should be passed as
...
are ignored (masked), the loss is only computed for labels in <code>[0, ..., config.vocab_size]</code>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.19.1/src/transformers/models/gpt2/modeling_gpt2.py#L1014",returnDescription:`
<p>A <a
...
<li>gpt2-large: 36</li>
<li>gpt2-xl: 48</li>
</ul>`,name:"device_map"}],source:"https://github.com/huggingface/transformers/blob/v4.19.1/src/transformers/models/gpt2/modeling_gpt2.py#L960"}}),qo=new se({props:{anchor:"transformers.GPT2LMHeadModel.parallelize.example",$$slots:{default:[Cv]},$$scope:{ctx:G}}}),fs=new L({props:{name:"deparallelize",anchor:"transformers.GPT2LMHeadModel.deparallelize",parameters:[],source:"https://github.com/huggingface/transformers/blob/v4.19.1/src/transformers/models/gpt2/modeling_gpt2.py#L972"}}),Co=new se({props:{anchor:"transformers.GPT2LMHeadModel.deparallelize.example",$$slots:{default:[Dv]},$$scope:{ctx:G}}}),gs=new ze({}),_s=new L({props:{name:"class transformers.GPT2DoubleHeadsModel",anchor:"transformers.GPT2DoubleHeadsModel",parameters:[{name:"config",val:""}],parametersDescription:[{anchor:"transformers.GPT2DoubleHeadsModel.config",description:`<strong>config</strong> (<a href="/docs/transformers/v4.19.1/en/model_doc/gpt2#transformers.GPT2Config">GPT2Config</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/v4.19.1/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/v4.19.1/src/transformers/models/gpt2/modeling_gpt2.py#L1114"}}),ys=new L({props:{name:"forward",anchor:"transformers.GPT2DoubleHeadsModel.forward",parameters:[{name:"input_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"past_key_values",val:": typing.Optional[typing.Tuple[typing.Tuple[torch.Tensor]]] = None"},{name:"attention_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"token_type_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"position_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"head_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"mc_token_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"labels",val:": typing.Optional[torch.LongTensor] = None"},{name:"mc_labels",val:": typing.Optional[torch.LongTensor] = None"},{name:"use_cache",val:": typing.Optional[bool] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.GPT2DoubleHeadsModel.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, input_ids_length)</code>) &#x2014;
<code>input_ids_length</code> = <code>sequence_length</code> if <code>past_key_values</code> is <code>None</code> else
<code>past_key_values[0][0].shape[-2]</code> (<code>sequence_length</code> of input past key value states). Indices of input
sequence tokens in the vocabulary.</p>
<p>If <code>past_key_values</code> is used, only <code>input_ids</code> that do not have their past calculated should be passed as
...
where <em>num_choices</em> is the size of the second dimension of the input tensors. (see <em>input_ids</em> above)`,name:"mc_labels"}],source:"https://github.com/huggingface/transformers/blob/v4.19.1/src/transformers/models/gpt2/modeling_gpt2.py#L1188",returnDescription:`
<p>A <a
  href="/docs/transformers/v4.19.1/en/model_doc/gpt2#transformers.models.gpt2.modeling_gpt2.GPT2DoubleHeadsModelOutput"
...
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.19.1/src/transformers/models/gpt2/modeling_gpt2.py#L1344",returnDescription:`
...
Labels for computing the sequence classification/regression loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>. If <code>config.num_labels == 1</code> a regression loss is computed (Mean-Square loss), If
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.19.1/src/transformers/models/gpt2/modeling_gpt2.py#L1478",returnDescription:`
<p>A <a
...
<p>Indices can be obtained using <a href="/docs/transformers/v4.19.1/en/model_doc/gpt2#transformers.GPT2Tokenizer">GPT2Tokenizer</a>. See <a href="/docs/transformers/v4.19.1/en/model_doc/wav2vec2_phoneme#transformers.Wav2Vec2PhonemeCTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
...
If set to <code>True</code>, <code>past_key_values</code> key value states are returned and can be used to speed up decoding (see
<code>past</code>). Set to <code>False</code> during training, <code>True</code> during generation`,name:"use_cache"}],source:"https://github.com/huggingface/transformers/blob/v4.19.1/src/transformers/models/gpt2/modeling_tf_gpt2.py#L712",returnDescription:`
<p>A <a
...
Labels for computing the cross entropy classification loss. Indices should be in <code>[0, ..., config.vocab_size - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.19.1/src/transformers/models/gpt2/modeling_tf_gpt2.py#L900",returnDescription:`
<p>A <a
...
Index of the classification token in each input sequence. Selected in the range <code>[0, input_ids.size(-1) - 1[</code>.`,name:"mc_token_ids"}],source:"https://github.com/huggingface/transformers/blob/v4.19.1/src/transformers/models/gpt2/modeling_tf_gpt2.py#L1024",returnDescription:`
<p>A <a
  href="/docs/transformers/v4.19.1/en/model_doc/gpt2#transformers.models.gpt2.modeling_tf_gpt2.TFGPT2DoubleHeadsModelOutput"
...
Labels for computing the cross entropy classification loss. Indices should be in <code>[0, ..., config.vocab_size - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.19.1/src/transformers/models/gpt2/modeling_tf_gpt2.py#L1175",returnDescription:`
<p>A <a
  href="/docs/transformers/v4.19.1/en/model_doc/gpt2#transformers.modeling_tf_outputs.TFSequenceClassifierOutputWithPast"
...
<a href="/docs/transformers/v4.19.1/en/main_classes/model#transformers.FlaxPreTrainedModel.to_bf16">to_bf16()</a>.`,name:"dtype"}],source:"https://github.com/huggingface/transformers/blob/v4.19.1/src/transformers/models/gpt2/modeling_flax_gpt2.py#L665"}}),fa=new L({props:{name:"__call__",anchor:"transformers.FlaxGPT2Model.__call__",parameters:[{name:"input_ids",val:""},{name:"attention_mask",val:" = None"},{name:"position_ids",val:" = None"},{name:"encoder_hidden_states",val:": typing.Optional[jax._src.numpy.ndarray.ndarray] = None"},{name:"encoder_attention_mask",val:": typing.Optional[jax._src.numpy.ndarray.ndarray] = None"},{name:"params",val:": dict = None"},{name:"past_key_values",val:": dict = None"},{name:"dropout_rng",val:": PRNGKey = None"},{name:"train",val:": bool = False"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.FlaxGPT2Model.__call__.input_ids",description:`<strong>input_ids</strong> (<code>numpy.ndarray</code> of shape <code>(batch_size, input_ids_length)</code>) &#x2014;
...
Whether or not to return a <a href="/docs/transformers/v4.19.1/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/v4.19.1/src/transformers/models/gpt2/modeling_flax_gpt2.py#L458",returnDescription:`
<p>A <a
...
parameters.</strong></p>
<p>If you wish to change the dtype of the model parameters, see <a href="/docs/transformers/v4.19.1/en/main_classes/model#transformers.FlaxPreTrainedModel.to_fp16">to_fp16()</a> and
<a href="/docs/transformers/v4.19.1/en/main_classes/model#transformers.FlaxPreTrainedModel.to_bf16">to_bf16()</a>.`,name:"dtype"}],source:"https://github.com/huggingface/transformers/blob/v4.19.1/src/transformers/models/gpt2/modeling_flax_gpt2.py#L743"}}),Pa=new L({props:{name:"__call__",anchor:"transformers.FlaxGPT2LMHeadModel.__call__",parameters:[{name:"input_ids",val:""},{name:"attention_mask",val:" = None"},{name:"position_ids",val:" = None"},{name:"encoder_hidden_states",val:": typing.Optional[jax._src.numpy.ndarray.ndarray] = None"},{name:"encoder_attention_mask",val:": typing.Optional[jax._src.numpy.ndarray.ndarray] = None"},{name:"params",val:": dict = None"},{name:"past_key_values",val:": dict = None"},{name:"dropout_rng",val:": PRNGKey = None"},{name:"train",val:": bool = False"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.FlaxGPT2LMHeadModel.__call__.input_ids",description:`<strong>input_ids</strong> (<code>numpy.ndarray</code> of shape <code>(batch_size, input_ids_length)</code>) &#x2014;
<code>input_ids_length</code> = <code>sequence_length</code>. Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/v4.19.1/en/model_doc/gpt2#transformers.GPT2Tokenizer">GPT2Tokenizer</a>. See <a href="/docs/transformers/v4.19.1/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/v4.19.1/en/model_doc/wav2vec2_phoneme#transformers.Wav2Vec2PhonemeCTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
10X the amount of data.`),ge=p(),E=s("p"),be=r("Tips:"),U=p(),B=s("ul"),de=s("li"),K=r(`GPT-2 is a model with absolute position embeddings so it\u2019s usually advised to pad the inputs on the right rather than
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),au=p(),ht=s("div"),y(ys.$$.fragment),ru=p(),Jt=s("p"),iu=r("The "),Ba=s("a"),lu=r("GPT2DoubleHeadsModel"),du=r(" forward method, overrides the "),ii=s("code"),cu=r("__call__"),pu=r(" special method."),hu=p(),y(Lo.$$.fragment),uu=p(),y(Oo.$$.fragment),od=p(),Xt=s("h2"),No=s("a"),li=s("span"),y(ks.$$.fragment),mu=p(),di=s("span"),fu=r("GPT2ForSequenceClassification"),nd=p(),Ge=s("div"),y(ws.$$.fragment),gu=p(),ci=s("p"),_u=r("The GPT2 Model transformer with a sequence classification head on top (linear layer)."),Tu=p(),Ra=s("p"),Va=s("a"),vu=r("GPT2ForSequenceClassification"),bu=r(` uses the last token in order to do the classification, as other causal models
...
text. The diversity of the dataset causes this simple goal to contain naturally occurring demonstrations of many tasks
across diverse domains. GPT-2 is a direct scale-up of GPT, with more than 10X the parameters and trained on more than
10X the amount of data.`),Tl.forEach(t),_l.forEach(t),ge=h(o),E=a(o,"P",{});var vl=l(E);be=i(vl,"Tips:"),vl.forEach(t),U=h(o),B=a(o,"UL",{});var Pt=l(B);de=a(Pt,"LI",{});var bl=l(de);K=i(bl,`GPT-2 is a model with absolute position embeddings so it\u2019s usually advised to pad the inputs on the right rather than
the left.`),bl.forEach(t),ye=h(Pt),oe=a(Pt,"LI",{});var ja=l(oe);N=i(ja,`GPT-2 was trained with a causal language modeling (CLM) objective and is therefore powerful at predicting the next
token in a sequence. Leveraging this feature allows GPT-2 to generate syntactically coherent text as it can be
observed in the `),ce=a(ja,"EM",{});var yl=l(ce);J=i(yl,"run_generation.py"),yl.forEach(t),ke=i(ja," example script."),ja.forEach(t),b=h(Pt),x=a(Pt,"LI",{});var ue=l(x);ne=i(ue,"The model can take the "),Ee=a(ue,"EM",{});var kl=l(Ee);Ae=i(kl,"past_key_values"),kl.forEach(t),H=i(ue," (for PyTorch) or "),qe=a(ue,"EM",{});var wl=l(qe);We=i(wl,"past"),wl.forEach(t),Ue=i(ue,` (for TF) as input, which is the previously computed
...
it will evenly distribute blocks across all devices.`),dT.forEach(t),ph=h(wn),k(xo.$$.fragment,wn),wn.forEach(t),hh=h(Ze),xt=a(Ze,"DIV",{class:!0});var hr=l(xt);k(is.$$.fragment,hr),uh=h(hr),Xr=a(hr,"P",{});var cT=l(Xr);mh=i(cT,"Moves the model to cpu from a model parallel state."),cT.forEach(t),fh=h(hr),k(jo.$$.fragment,hr),hr.forEach(t),Ze.forEach(t),Ql=h(o),Rt=a(o,"H2",{class:!0});var Cd=l(Rt);Fo=a(Cd,"A",{id:!0,class:!0,href:!0});var pT=l(Fo);Yr=a(pT,"SPAN",{});var hT=l(Yr);k(ls.$$.fragment,hT),hT.forEach(t),pT.forEach(t),gh=h(Cd),Qr=a(Cd,"SPAN",{});var uT=l(Qr);_h=i(uT,"GPT2LMHeadModel"),uT.forEach(t),Cd.forEach(t),Zl=h(o),Me=a(o,"DIV",{class:!0});var et=l(Me);k(ds.$$.fragment,et),Th=h(et),Zr=a(et,"P",{});var mT=l(Zr);vh=i(mT,`The GPT2 Model transformer with a language modeling head on top (linear layer with weights tied to the input
embeddings).`),mT.forEach(t),bh=h(et),cs=a(et,"P",{});var Dd=l(cs);yh=i(Dd,"This model inherits from "),Aa=a(Dd,"A",{href:!0});var fT=l(Aa);kh=i(fT,"PreTrainedModel"),fT.forEach(t),wh=i(Dd,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Bd.forEach(t),dm=h(Et),Xe=a(Et,"DIV",{class:!0});var qt=l(Xe);k(qs.$$.fragment,qt),cm=h(qt),Zt=a(qt,"P",{});var _r=l(Zt);pm=i(_r,"The "),Ya=a(_r,"A",{href:!0});var JT=l(Ya);hm=i(JT,"GPT2ForTokenClassification"),JT.forEach(t),um=i(_r," forward method, overrides the "),vi=a(_r,"CODE",{});var XT=l(vi);mm=i(XT,"__call__"),XT.forEach(t),fm=i(_r," special method."),_r.forEach(t),gm=h(qt),k(Bo.$$.fragment,qt),_m=h(qt),k(Ro.$$.fragment,qt),Tm=h(qt),k(Vo.$$.fragment,qt),qt.forEach(t),Et.forEach(t),rd=h(o),eo=a(o,"H2",{class:!0});var Rd=l(eo);Ko=a(Rd,"A",{id:!0,class:!0,href:!0});var YT=l(Ko);bi=a(YT,"SPAN",{});var QT=l(bi);k(Cs.$$.fragment,QT),QT.forEach(t),YT.forEach(t),vm=h(Rd),yi=a(Rd,"SPAN",{});var ZT=l(yi);bm=i(ZT,"TFGPT2Model"),ZT.forEach(t),Rd.forEach(t),id=h(o),Le=a(o,"DIV",{class:!0});var Tt=l(Le);k(Ds.$$.fragment,Tt),ym=h(Tt),ki=a(Tt,"P",{});var e2=l(ki);km=i(e2,"The bare GPT2 Model transformer outputting raw hidden-states without any specific head on top."),e2.forEach(t),wm=h(Tt),Ls=a(Tt,"P",{});var Vd=l(Ls);$m=i(Vd,"This model inherits from "),Qa=a(Vd,"A",{href:!0});var t2=l(Qa);Pm=i(t2,"TFPreTrainedModel"),t2.forEach(t),Mm=i(Vd,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Kd.forEach(t),zm=h(Tt),k(Jo.$$.fragment,Tt),Em=h(Tt),ut=a(Tt,"DIV",{class:!0});var Gn=l(ut);k(Hs.$$.fragment,Gn),qm=h(Gn),to=a(Gn,"P",{});var Tr=l(to);Cm=i(Tr,"The "),Za=a(Tr,"A",{href:!0});var n2=l(Za);Dm=i(n2,"TFGPT2Model"),n2.forEach(t),Lm=i(Tr," forward method, overrides the "),wi=a(Tr,"CODE",{});var s2=l(wi);Om=i(s2,"__call__"),s2.forEach(t),Nm=i(Tr," special method."),Tr.forEach(t),Hm=h(Gn),k(Xo.$$.fragment,Gn),Im=h(Gn),k(Yo.$$.fragment,Gn),Gn.forEach(t),Tt.forEach(t),ld=h(o),oo=a(o,"H2",{class:!0});var Jd=l(oo);Qo=a(Jd,"A",{id:!0,class:!0,href:!0});var a2=l(Qo);$i=a(a2,"SPAN",{});var r2=l($i);k(Is.$$.fragment,r2),r2.forEach(t),a2.forEach(t),Sm=h(Jd),Pi=a(Jd,"SPAN",{});var i2=l(Pi);Am=i(i2,"TFGPT2LMHeadModel"),i2.forEach(t),Jd.forEach(t),dd=h(o),Oe=a(o,"DIV",{class:!0});var vt=l(Oe);k(Ss.$$.fragment,vt),Wm=h(vt),Mi=a(vt,"P",{});var l2=l(Mi);Um=i(l2,`The GPT2 Model transformer with a language modeling head on top (linear layer with weights tied to the input
embeddings).`),l2.forEach(t),Bm=h(vt),As=a(vt,"P",{});var Xd=l(As);Rm=i(Xd,"This model inherits from "),er=a(Xd,"A",{href:!0});var d2=l(er);Vm=i(d2,"TFPreTrainedModel"),d2.forEach(t),Km=i(Xd,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Xd.forEach(t),Jm=h(vt),Ws=a(vt,"P",{});var Yd=l(Ws);Xm=i(Yd,"This model is also a "),Us=a(Yd,"A",{href:!0,rel:!0});var c2=l(Us);Ym=i(c2,"tf.keras.Model"),c2.forEach(t),Qm=i(Yd,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Yd.forEach(t),Zm=h(vt),k(Zo.$$.fragment,vt),ef=h(vt),mt=a(vt,"DIV",{class:!0});var xn=l(mt);k(Bs.$$.fragment,xn),tf=h(xn),no=a(xn,"P",{});var vr=l(no);of=i(vr,"The "),tr=a(vr,"A",{href:!0});var p2=l(tr);nf=i(p2,"TFGPT2LMHeadModel"),p2.forEach(t),sf=i(vr," forward method, overrides the "),Gi=a(vr,"CODE",{});var h2=l(Gi);af=i(h2,"__call__"),h2.forEach(t),rf=i(vr," special method."),vr.forEach(t),lf=h(xn),k(en.$$.fragment,xn),df=h(xn),k(tn.$$.fragment,xn),xn.forEach(t),vt.forEach(t),cd=h(o),so=a(o,"H2",{class:!0});var Qd=l(so);on=a(Qd,"A",{id:!0,class:!0,href:!0});var u2=l(on);xi=a(u2,"SPAN",{});var m2=l(xi);k(Rs.$$.fragment,m2),m2.forEach(t),u2.forEach(t),cf=h(Qd),ji=a(Qd,"SPAN",{});var f2=l(ji);pf=i(f2,"TFGPT2DoubleHeadsModel"),f2.forEach(t),Qd.forEach(t),pd=h(o),Ne=a(o,"DIV",{class:!0});var bt=l(Ne);k(Vs.$$.fragment,bt),hf=h(bt),Fi=a(bt,"P",{});var g2=l(Fi);uf=i(g2,`The GPT2 Model transformer with a language modeling and a multiple-choice classification head on top e.g. for
RocStories/SWAG tasks. The two heads are two linear layers. The language modeling head has its weights tied to the
input embeddings, the classification head takes as input the input of a specified classification token index in the
input sequence).`),g2.forEach(t),mf=h(bt),Ks=a(bt,"P",{});var Zd=l(Ks);ff=i(Zd,"This model inherits from "),or=a(Zd,"A",{href:!0});var _2=l(or);gf=i(_2,"TFPreTrainedModel"),_2.forEach(t),_f=i(Zd,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
