import{S as Yy,i as Zy,s as Jy,e as a,k as d,w as b,t as o,M as Xy,c as r,d as t,m as c,a as i,x as k,h as s,b as h,F as e,g as m,y,q as w,o as $,B as x,v as Qy,L as ge}from"../../chunks/vendor-6b77c823.js";import{T as wt}from"../../chunks/Tip-39098574.js";import{D as C}from"../../chunks/Docstring-1088f2fb.js";import{C as S}from"../../chunks/CodeBlock-3a8b25a8.js";import{I as be}from"../../chunks/IconCopyLink-7a11ce68.js";import{E as _e}from"../../chunks/ExampleCodeBlock-5212b321.js";function e5(j){let p,v,g,u,T;return{c(){p=a("p"),v=o("Although the recipe for forward pass needs to be defined within this function, one should call the "),g=a("code"),u=o("Module"),T=o(`
...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/v4.19.1/src/transformers/models/t5/tokenization_t5.py#L243",returnDescription:`
...
Whether or not the token list is already formatted with special tokens for the model.`,name:"already_has_special_tokens"}],source:"https://github.com/huggingface/transformers/blob/v4.19.1/src/transformers/models/t5/tokenization_t5.py#L183",returnDescription:`
...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/v4.19.1/src/transformers/models/t5/tokenization_t5.py#L221",returnDescription:`
<p>List of zeros.</p>
`,returnType:`
<p><code>List[int]</code></p>
...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/v4.19.1/src/transformers/models/t5/tokenization_t5_fast.py#L186",returnDescription:`
<p>List of <a href="../glossary#input-ids">input IDs</a> with the appropriate special tokens.</p>
`,returnType:`
<p><code>List[int]</code></p>
...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/v4.19.1/src/transformers/models/t5/tokenization_t5_fast.py#L212",returnDescription:`
<p>List of zeros.</p>
`,returnType:`
<p><code>List[int]</code></p>
...
<p>Indices can be obtained using <a href="/docs/transformers/v4.19.1/en/model_doc/mt5#transformers.T5Tokenizer">T5Tokenizer</a>. See <a href="/docs/transformers/v4.19.1/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/v4.19.1/en/model_doc/wav2vec2_phoneme#transformers.Wav2Vec2PhonemeCTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for detail.</p>
...
Whether or not to return a <a href="/docs/transformers/v4.19.1/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/v4.19.1/src/transformers/models/t5/modeling_t5.py#L1345",returnDescription:`
<p>A <a
...
elements depending on the configuration (<a
  href="/docs/transformers/v4.19.1/en/model_doc/t5#transformers.T5Config"
...
labels in <code>[0, ..., config.vocab_size]</code>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.19.1/src/transformers/models/t5/modeling_t5.py#L1539",returnDescription:`
<p>A <a
...
Whether or not to return a <a href="/docs/transformers/v4.19.1/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/v4.19.1/src/transformers/models/t5/modeling_t5.py#L1810",returnDescription:`
<p>A <a
...
behaviors between training and evaluation).`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/v4.19.1/src/transformers/models/t5/modeling_tf_t5.py#L1134",returnDescription:`
<p>A <a
...
Labels for computing the cross entropy classification loss. Indices should be in <code>[0, ..., config.vocab_size - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.19.1/src/transformers/models/t5/modeling_tf_t5.py#L1309",returnDescription:`
<p>A <a
...
Indices of input sequence tokens in the vocabulary. T5 is a model with relative position embeddings so you
should be able to pad the inputs on the right or the left.</p>
<p>Indices can be obtained using <a href="/docs/transformers/v4.19.1/en/model_doc/mt5#transformers.T5Tokenizer">T5Tokenizer</a>. See <a href="/docs/transformers/v4.19.1/en/model_doc/wav2vec2_phoneme#transformers.Wav2Vec2PhonemeCTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
<a href="/docs/transformers/v4.19.1/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> for details.</p>
...
Whether or not to use the model in training mode (some modules like dropout modules have different
behaviors between training and evaluation).`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/v4.19.1/src/transformers/models/t5/modeling_tf_t5.py#L1618",returnDescription:`
<p>A <a
...
<p>If <code>past_key_values</code> are used, the user can optionally input only the last <code>decoder_input_ids</code> (those that
don&#x2019;t have their past key value states given to this model) of shape <code>(batch_size, 1)</code> instead of all
<code>decoder_input_ids</code> of shape <code>(batch_size, sequence_length)</code>.`,name:"past_key_values"}],source:"https://github.com/huggingface/transformers/blob/v4.19.1/src/transformers/models/t5/modeling_flax_t5.py#L958",returnDescription:`
<p>A <a
...
(`),cs=r(vt,"A",{href:!0,rel:!0});var Qk=i(cs);Sm=s(Qk,"PyTorch"),Qk.forEach(t),Gm=s(vt," and "),ps=r(vt,"A",{href:!0,rel:!0});var e1=i(ps);Um=s(e1,"Tensorflow"),e1.forEach(t),Wm=s(vt,`). These scripts allow
you to easily fine-tune T5 on custom data for summarization/translation.`),vt.forEach(t),Yk.forEach(t),tp.forEach(t),wc=c(n),St=r(n,"H2",{class:!0});var np=i(St);yn=r(np,"A",{id:!0,class:!0,href:!0});var t1=i(yn);ll=r(t1,"SPAN",{});var n1=i(ll);k(hs.$$.fragment,n1),n1.forEach(t),t1.forEach(t),Bm=c(np),dl=r(np,"SPAN",{});var o1=i(dl);Rm=s(o1,"T5Config"),o1.forEach(t),np.forEach(t),$c=c(n),bt=r(n,"DIV",{class:!0});var Br=i(bt);k(us.$$.fragment,Br),Hm=c(Br),kt=r(Br,"P",{});var vo=i(kt);Vm=s(vo,"This is the configuration class to store the configuration of a "),_r=r(vo,"A",{href:!0});var s1=i(_r);Km=s(s1,"T5Model"),s1.forEach(t),Ym=s(vo," or a "),gr=r(vo,"A",{href:!0});var a1=i(gr);Zm=s(a1,"TFT5Model"),a1.forEach(t),Jm=s(vo,`. It is used to
instantiate a T5 model according to the specified arguments, defining the model architecture. Instantiating a
configuration with the defaults will yield a similar configuration to that of the T5
`),ms=r(vo,"A",{href:!0,rel:!0});var r1=i(ms);Xm=s(r1,"t5-small"),r1.forEach(t),Qm=s(vo," architecture."),vo.forEach(t),ef=c(Br),Gt=r(Br,"P",{});var Rr=i(Gt);tf=s(Rr,"Configuration objects inherit from "),Tr=r(Rr,"A",{href:!0});var i1=i(Tr);nf=s(i1,"PretrainedConfig"),i1.forEach(t),of=s(Rr,` and can be used to control the model outputs. Read the
documentation from `),vr=r(Rr,"A",{href:!0});var l1=i(vr);sf=s(l1,"PretrainedConfig"),l1.forEach(t),af=s(Rr," for more information."),Rr.forEach(t),Br.forEach(t),xc=c(n),Ut=r(n,"H2",{class:!0});var op=i(Ut);wn=r(op,"A",{id:!0,class:!0,href:!0});var d1=i(wn);cl=r(d1,"SPAN",{});var c1=i(cl);k(fs.$$.fragment,c1),c1.forEach(t),d1.forEach(t),rf=c(op),pl=r(op,"SPAN",{});var p1=i(pl);lf=s(p1,"T5Tokenizer"),p1.forEach(t),op.forEach(t),zc=c(n),ie=r(n,"DIV",{class:!0});var Ve=i(ie);k(_s.$$.fragment,Ve),df=c(Ve),gs=r(Ve,"P",{});var sp=i(gs);cf=s(sp,"Construct a T5 tokenizer. Based on "),Ts=r(sp,"A",{href:!0,rel:!0});var h1=i(Ts);pf=s(h1,"SentencePiece"),h1.forEach(t),hf=s(sp,"."),sp.forEach(t),uf=c(Ve),vs=r(Ve,"P",{});var ap=i(vs);mf=s(ap,"This tokenizer inherits from "),br=r(ap,"A",{href:!0});var u1=i(br);ff=s(u1,"PreTrainedTokenizer"),u1.forEach(t),_f=s(ap,` which contains most of the main methods. Users should refer to
this superclass for more information regarding those methods.`),ap.forEach(t),gf=c(Ve),qt=r(Ve,"DIV",{class:!0});var Hr=i(qt);k(bs.$$.fragment,Hr),Tf=c(Hr),hl=r(Hr,"P",{});var m1=i(hl);vf=s(m1,`Build model inputs from a sequence or a pair of sequence for sequence classification tasks by concatenating and
adding special tokens. A sequence has the following format:`),m1.forEach(t),bf=c(Hr),ks=r(Hr,"UL",{});var rp=i(ks);kr=r(rp,"LI",{});var ib=i(kr);kf=s(ib,"single sequence: "),ul=r(ib,"CODE",{});var f1=i(ul);yf=s(f1,"X </s>"),f1.forEach(t),ib.forEach(t),wf=c(rp),yr=r(rp,"LI",{});var lb=i(yr);$f=s(lb,"pair of sequences: "),ml=r(lb,"CODE",{});var _1=i(ml);xf=s(_1,"A </s> B </s>"),_1.forEach(t),lb.forEach(t),rp.forEach(t),Hr.forEach(t),zf=c(Ve),$n=r(Ve,"DIV",{class:!0});var ip=i($n);k(ys.$$.fragment,ip),jf=c(ip),ws=r(ip,"P",{});var lp=i(ws);qf=s(lp,`Retrieve sequence ids from a token list that has no special tokens added. This method is called when adding
...
use of token type ids, therefore a list of zeros is returned.`),T1.forEach(t),dp.forEach(t),Nf=c(Ve),wr=r(Ve,"DIV",{class:!0});var v1=i(wr);k(xs.$$.fragment,v1),v1.forEach(t),Ve.forEach(t),jc=c(n),Wt=r(n,"H2",{class:!0});var cp=i(Wt);zn=r(cp,"A",{id:!0,class:!0,href:!0});var b1=i(zn);gl=r(b1,"SPAN",{});var k1=i(gl);k(zs.$$.fragment,k1),k1.forEach(t),b1.forEach(t),Of=c(cp),Tl=r(cp,"SPAN",{});var y1=i(Tl);Lf=s(y1,"T5TokenizerFast"),y1.forEach(t),cp.forEach(t),qc=c(n),Se=r(n,"DIV",{class:!0});var Nt=i(Se);k(js.$$.fragment,Nt),Af=c(Nt),Bt=r(Nt,"P",{});var Vr=i(Bt);If=s(Vr,"Construct a \u201Cfast\u201D T5 tokenizer (backed by HuggingFace\u2019s "),vl=r(Vr,"EM",{});var w1=i(vl);Df=s(w1,"tokenizers"),w1.forEach(t),Sf=s(Vr,` library). Based on
...
refer to this superclass for more information regarding those methods.`),pp.forEach(t),Vf=c(Nt),Et=r(Nt,"DIV",{class:!0});var Kr=i(Et);k(Fs.$$.fragment,Kr),Kf=c(Kr),bl=r(Kr,"P",{});var z1=i(bl);Yf=s(z1,`Build model inputs from a sequence or a pair of sequence for sequence classification tasks by concatenating and
adding special tokens. A sequence has the following format:`),z1.forEach(t),Zf=c(Kr),Ms=r(Kr,"UL",{});var hp=i(Ms);xr=r(hp,"LI",{});var db=i(xr);Jf=s(db,"single sequence: "),kl=r(db,"CODE",{});var j1=i(kl);Xf=s(j1,"X </s>"),j1.forEach(t),db.forEach(t),Qf=c(hp),zr=r(hp,"LI",{});var cb=i(zr);e_=s(cb,"pair of sequences: "),yl=r(cb,"CODE",{});var q1=i(yl);t_=s(q1,"A </s> B </s>"),q1.forEach(t),cb.forEach(t),hp.forEach(t),Kr.forEach(t),n_=c(Nt),jn=r(Nt,"DIV",{class:!0});var up=i(jn);k(Cs.$$.fragment,up),o_=c(up),wl=r(up,"P",{});var E1=i(wl);s_=s(E1,`Create a mask from the two sequences passed to be used in a sequence-pair classification task. T5 does not make
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),_p.forEach(t),g_=c(xe),Is=r(xe,"P",{});var gp=i(Is);T_=s(gp,"This model is also a PyTorch "),Ds=r(gp,"A",{href:!0,rel:!0});var L1=i(Ds);v_=s(L1,"torch.nn.Module"),L1.forEach(t),b_=s(gp,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),gp.forEach(t),k_=c(xe),lt=r(xe,"DIV",{class:!0});var bo=i(lt);k(Ss.$$.fragment,bo),y_=c(bo),Ht=r(bo,"P",{});var Yr=i(Ht);w_=s(Yr,"The "),qr=r(Yr,"A",{href:!0});var A1=i(qr);$_=s(A1,"T5Model"),A1.forEach(t),x_=s(Yr," forward method, overrides the "),jl=r(Yr,"CODE",{});var I1=i(jl);z_=s(I1,"__call__"),I1.forEach(t),j_=s(Yr," special method."),Yr.forEach(t),q_=c(bo),k(En.$$.fragment,bo),E_=c(bo),k(Fn.$$.fragment,bo),bo.forEach(t),F_=c(xe),dt=r(xe,"DIV",{class:!0});var ko=i(dt);k(Gs.$$.fragment,ko),M_=c(ko),ql=r(ko,"P",{});var D1=i(ql);C_=s(D1,"This is an experimental feature and is a subject to change at a moment\u2019s notice."),D1.forEach(t),P_=c(ko),El=r(ko,"P",{});var S1=i(El);N_=s(S1,`Uses a device map to distribute attention modules of the model across several devices. If no device map is given,
it will evenly distribute blocks across all devices.`),S1.forEach(t),O_=c(ko),k(Mn.$$.fragment,ko),ko.forEach(t),L_=c(xe),Ft=r(xe,"DIV",{class:!0});var Zr=i(Ft);k(Us.$$.fragment,Zr),A_=c(Zr),Fl=r(Zr,"P",{});var G1=i(Fl);I_=s(G1,"Moves the model to cpu from a model parallel state."),G1.forEach(t),D_=c(Zr),k(Cn.$$.fragment,Zr),Zr.forEach(t),xe.forEach(t),Mc=c(n),Vt=r(n,"H2",{class:!0});var Tp=i(Vt);Pn=r(Tp,"A",{id:!0,class:!0,href:!0});var U1=i(Pn);Ml=r(U1,"SPAN",{});var W1=i(Ml);k(Ws.$$.fragment,W1),W1.forEach(t),U1.forEach(t),S_=c(Tp),Cl=r(Tp,"SPAN",{});var B1=i(Cl);G_=s(B1,"T5ForConditionalGeneration"),B1.forEach(t),Tp.forEach(t),Cc=c(n),X=r(n,"DIV",{class:!0});var ze=i(X);k(Bs.$$.fragment,ze),U_=c(ze),Rs=r(ze,"P",{});var vp=i(Rs);W_=s(vp,"T5 Model with a "),Pl=r(vp,"CODE",{});var R1=i(Pl);B_=s(R1,"language modeling"),R1.forEach(t),R_=s(vp," head on top."),vp.forEach(t),H_=c(ze),Hs=r(ze,"P",{});var bp=i(Hs);V_=s(bp,"The T5 model was proposed in "),Vs=r(bp,"A",{href:!0,rel:!0});var H1=i(Vs);K_=s(H1,`Exploring the Limits of Transfer Learning with a Unified Text-to-Text
Transformer`),H1.forEach(t),Y_=s(bp,` by Colin Raffel, Noam Shazeer, Adam Roberts, Katherine Lee, Sharan
Narang, Michael Matena, Yanqi Zhou, Wei Li, Peter J. Liu. It\u2019s an encoder decoder transformer pre-trained in a
text-to-text denoising generative setting.`),bp.forEach(t),Z_=c(ze),Ks=r(ze,"P",{});var kp=i(Ks);J_=s(kp,"This model inherits from "),Er=r(kp,"A",{href:!0});var V1=i(Er);X_=s(V1,"PreTrainedModel"),V1.forEach(t),Q_=s(kp,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Ep.forEach(t),_T=c(Ke),fa=r(Ke,"P",{});var Fp=i(fa);gT=s(Fp,"This model is also a "),_a=r(Fp,"A",{href:!0,rel:!0});var Ty=i(_a);TT=s(Ty,"tf.keras.Model"),Ty.forEach(t),vT=s(Fp,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Fp.forEach(t),bT=c(Ke),k(Bn.$$.fragment,Ke),kT=c(Ke),mt=r(Ke,"DIV",{class:!0});var zo=i(mt);k(ga.$$.fragment,zo),yT=c(zo),Xt=r(zo,"P",{});var ti=i(Xt);wT=s(ti,"The "),Nr=r(ti,"A",{href:!0});var vy=i(Nr);$T=s(vy,"TFT5Model"),vy.forEach(t),xT=s(ti," forward method, overrides the "),Kl=r(ti,"CODE",{});var by=i(Kl);zT=s(by,"__call__"),by.forEach(t),jT=s(ti," special method."),ti.forEach(t),qT=c(zo),k(Rn.$$.fragment,zo),ET=c(zo),k(Hn.$$.fragment,zo),zo.forEach(t),Ke.forEach(t),Ac=c(n),Qt=r(n,"H2",{class:!0});var Mp=i(Qt);Vn=r(Mp,"A",{id:!0,class:!0,href:!0});var ky=i(Vn);Yl=r(ky,"SPAN",{});var yy=i(Yl);k(Ta.$$.fragment,yy),yy.forEach(t),ky.forEach(t),FT=c(Mp),Zl=r(Mp,"SPAN",{});var wy=i(Zl);MT=s(wy,"TFT5ForConditionalGeneration"),wy.forEach(t),Mp.forEach(t),Ic=c(n),de=r(n,"DIV",{class:!0});var Ye=i(de);k(va.$$.fragment,Ye),CT=c(Ye),ba=r(Ye,"P",{});var Cp=i(ba);PT=s(Cp,"T5 Model with a "),Jl=r(Cp,"CODE",{});var $y=i(Jl);NT=s($y,"language modeling"),$y.forEach(t),OT=s(Cp," head on top."),Cp.forEach(t),LT=c(Ye),ka=r(Ye,"P",{});var Pp=i(ka);AT=s(Pp,"The T5 model was proposed in "),ya=r(Pp,"A",{href:!0,rel:!0});var xy=i(ya);IT=s(xy,`Exploring the Limits of Transfer Learning with a Unified Text-to-Text
