...
<span class="hljs-meta">&gt;&gt;&gt; </span>model.save_pretrained(<span class="hljs-string">&quot;./vit-gpt2&quot;</span>)
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-comment"># load fine-tuned model</span>
<span class="hljs-meta">&gt;&gt;&gt; </span>model = FlaxVisionEncoderDecoderModel.from_pretrained(<span class="hljs-string">&quot;./vit-gpt2&quot;</span>)`}}),{c(){h=a("p"),x=n("Example:"),_=l(),b(f.$$.fragment)},l(i){h=s(i,"P",{});var u=d(h);x=r(u,"Example:"),u.forEach(t),_=p(i),w(f.$$.fragment,i)},m(i,u){g(i,h,u),e(h,x),g(i,_,u),E(f,i,u),v=!0},p:mt,i(i){v||(T(f.$$.fragment,i),v=!0)},o(i){y(f.$$.fragment,i),v=!1},d(i){i&&t(h),i&&t(_),k(f,i)}}}function dh(F){let h,x,_,f,v,i,u,I,qa,yr,ne,ye,fn,to,Fa,gn,za,kr,$,Pa,ht,Aa,Ca,un,Sa,Ia,ft,La,Na,gt,Oa,Ra,ut,Ba,Ga,_t,Wa,Ha,_n,Ua,Za,vt,Ya,Ja,bt,Ka,Qa,wt,Xa,es,Et,os,ts,xr,ke,ns,no,rs,as,$r,xe,ss,Tt,ds,is,jr,J,cs,yt,ls,ps,kt,ms,hs,Mr,re,$e,vn,ro,fs,ao,gs,bn,us,_s,Vr,Z,xt,vs,bs,$t,ws,Es,wn,Ts,ys,Dr,so,qr,ae,je,En,io,ks,co,xs,Tn,$s,js,Fr,M,jt,Ms,Vs,yn,Ds,qs,Mt,Fs,zs,kn,Ps,As,xn,Cs,Ss,$n,Is,Ls,Vt,Ns,Os,Me,Rs,jn,Bs,Gs,Mn,Ws,Hs,Dt,Us,Zs,zr,lo,Pr,se,Ve,Vn,po,Ys,mo,Js,Dn,Ks,Qs,Ar,L,Xs,qn,ed,od,qt,td,nd,Fn,rd,ad,Cr,De,sd,zn,dd,id,Sr,ho,Ir,de,qe,Pn,fo,cd,go,ld,An,pd,md,Lr,ie,Cn,hd,fd,Sn,gd,ud,Nr,uo,Or,ce,Fe,In,_o,_d,Ln,vd,Rr,N,bd,Nn,wd,Ed,On,Td,yd,Rn,kd,xd,Br,vo,Gr,K,$d,bo,jd,Md,wo,Vd,Dd,Wr,le,ze,Bn,Eo,qd,Gn,Fd,Hr,S,To,zd,Pe,Ft,Pd,Ad,zt,Cd,Sd,Id,pe,Ld,Pt,Nd,Od,At,Rd,Bd,Gd,Ae,Wd,Ce,yo,Hd,ko,Ud,Ct,Zd,Yd,Jd,Se,xo,Kd,me,Qd,Wn,Xd,ei,Hn,oi,ti,Ur,he,Ie,Un,$o,ni,Zn,ri,Zr,V,jo,ai,fe,si,St,di,ii,It,ci,li,pi,Mo,mi,Vo,hi,fi,gi,Do,ui,qo,_i,vi,bi,Yn,wi,Ei,Fo,Ti,Lt,yi,ki,xi,zo,$i,Po,ji,Mi,Vi,Q,Nt,Di,qi,Jn,Fi,zi,Kn,Pi,Ai,Ci,O,Ao,Si,ge,Ii,Ot,Li,Ni,Qn,Oi,Ri,Bi,Le,Gi,Ne,Wi,R,Co,Hi,Xn,Ui,Zi,ue,Yi,er,Ji,Ki,or,Qi,Xi,ec,Oe,Yr,_e,Re,tr,So,oc,nr,tc,Jr,D,Io,nc,ve,rc,Rt,ac,sc,Bt,dc,ic,cc,Lo,lc,No,pc,mc,hc,Oo,fc,Ro,gc,uc,_c,rr,vc,bc,Bo,wc,Gt,Ec,Tc,yc,Go,kc,Wo,xc,$c,jc,X,Wt,Mc,Vc,Ht,Dc,qc,Ut,Fc,zc,Pc,B,Ho,Ac,be,Cc,Zt,Sc,Ic,ar,Lc,Nc,Oc,Be,Rc,Ge,Bc,ee,Uo,Gc,sr,Wc,Hc,We,Kr,we,He,dr,Zo,Uc,ir,Zc,Qr,q,Yo,Yc,Ee,Jc,Yt,Kc,Qc,Jt,Xc,el,ol,Jo,tl,Ko,nl,rl,al,Qo,sl,Xo,dl,il,cl,cr,ll,pl,et,ml,Kt,hl,fl,gl,ot,ul,tt,_l,vl,bl,oe,Qt,wl,El,lr,Tl,yl,pr,kl,xl,$l,G,nt,jl,Te,Ml,Xt,Vl,Dl,mr,ql,Fl,zl,Ue,Pl,Ze,Al,te,rt,Cl,hr,Sl,Il,Ye,Xr;return i=new Y({}),to=new Y({}),ro=new Y({}),so=new U({props:{code:`from transformers import BertConfig, ViTConfig, VisionEncoderDecoderConfig, VisionEncoderDecoderModel
...
</ul>`,name:"kwargs"}],source:"https://github.com/huggingface/transformers/blob/v4.21.0/src/transformers/models/vision_encoder_decoder/configuration_vision_encoder_decoder.py#L27"}}),Ae=new pt({props:{anchor:"transformers.VisionEncoderDecoderConfig.example",$$slots:{default:[Km]},$$scope:{ctx:F}}}),yo=new H({props:{name:"from_encoder_decoder_configs",anchor:"transformers.VisionEncoderDecoderConfig.from_encoder_decoder_configs",parameters:[{name:"encoder_config",val:": PretrainedConfig"},{name:"decoder_config",val:": PretrainedConfig"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/v4.21.0/src/transformers/models/vision_encoder_decoder/configuration_vision_encoder_decoder.py#L93",returnDescription:`
<p>An instance of a configuration object</p>
`,returnType:`
<p><a
  href="/docs/transformers/v4.21.0/en/model_doc/vision-encoder-decoder#transformers.VisionEncoderDecoderConfig"
>VisionEncoderDecoderConfig</a></p>
`}}),xo=new H({props:{name:"to_dict",anchor:"transformers.VisionEncoderDecoderConfig.to_dict",parameters:[],source:"https://github.com/huggingface/transformers/blob/v4.21.0/src/transformers/models/vision_encoder_decoder/configuration_vision_encoder_decoder.py#L110",returnDescription:`
...
</ul>`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/v4.21.0/src/transformers/models/vision_encoder_decoder/modeling_vision_encoder_decoder.py#L401",returnDescription:`
<p>A <a
...
<li>Without a prefix which will be input as <code>**encoder_kwargs</code> for the encoder forward function.</li>
<li>With a <em>decoder_</em> prefix which will be input as <code>**decoder_kwargs</code> for the decoder forward function.</li>
</ul>`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/v4.21.0/src/transformers/models/vision_encoder_decoder/modeling_tf_vision_encoder_decoder.py#L514",returnDescription:`
<p>A <a
...
If set to <code>True</code>, the model will return a <code>FlaxSeq2SeqLMOutput</code> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/v4.21.0/src/transformers/models/vision_encoder_decoder/modeling_flax_vision_encoder_decoder.py#L599",returnDescription:`
<p>A <a
...
and the default `),wn=a("code"),Ts=n("BertForCausalLM"),ys=n(" configuration for the decoder."),Dr=l(),b(so.$$.fragment),qr=l(),ae=a("h2"),je=a("a"),En=a("span"),b(io.$$.fragment),ks=l(),co=a("span"),xs=n("Initialising "),Tn=a("code"),$s=n("VisionEncoderDecoderModel"),js=n(" from a pretrained encoder and a pretrained decoder."),Fr=l(),M=a("p"),jt=a("a"),Ms=n("VisionEncoderDecoderModel"),Vs=n(" can be initialized from a pretrained encoder checkpoint and a pretrained decoder checkpoint. Note that any pretrained Transformer-based vision model, "),yn=a("em"),Ds=n("e.g."),qs=l(),Mt=a("a"),Fs=n("Swin"),zs=n(", can serve as the encoder and both pretrained auto-encoding models, "),kn=a("em"),Ps=n("e.g."),As=n(" BERT, pretrained causal language models, "),xn=a("em"),Cs=n("e.g."),Ss=n(" GPT2, as well as the pretrained decoder part of sequence-to-sequence models, "),$n=a("em"),Is=n("e.g."),Ls=n(` decoder of BART, can be used as the decoder.
...
were contributed by `),wo=a("a"),Vd=n("ydshieh"),Dd=n("."),Wr=l(),le=a("h2"),ze=a("a"),Bn=a("span"),b(Eo.$$.fragment),qd=l(),Gn=a("span"),Fd=n("VisionEncoderDecoderConfig"),Hr=l(),S=a("div"),b(To.$$.fragment),zd=l(),Pe=a("p"),Ft=a("a"),Pd=n("VisionEncoderDecoderConfig"),Ad=n(` is the configuration class to store the configuration of a
`),zt=a("a"),Cd=n("VisionEncoderDecoderModel"),Sd=n(`. It is used to instantiate a Vision-Encoder-Text-Decoder model according to the
...
etc.)`),xi=l(),zo=a("p"),$i=n("This model is also a PyTorch "),Po=a("a"),ji=n("torch.nn.Module"),Mi=n(` subclass.
...
for the encoder and :meth`),pr=a("em"),kl=n("~transformers.FlaxAutoModelForCausalLM.from_pretrained"),xl=n(" class method for the decoder."),$l=l(),G=a("div"),b(nt.$$.fragment),jl=l(),Te=a("p"),Ml=n("The "),Xt=a("a"),Vl=n("FlaxVisionEncoderDecoderModel"),Dl=n(" forward method, overrides the "),mr=a("code"),ql=n("__call__"),Fl=n(" special method."),zl=l(),b(Ue.$$.fragment),Pl=l(),b(Ze.$$.fragment),Al=l(),te=a("div"),b(rt.$$.fragment),Cl=l(),hr=a("p"),Sl=n(`Instantiate an encoder and a decoder from one or two base classes of the library from pretrained model
checkpoints.`),Il=l(),b(Ye.$$.fragment),this.h()},l(o){const m=Ym('[data-svelte="svelte-1phssyn"]',document.head);h=s(m,"META",{name:!0,content:!0}),m.forEach(t),x=p(o),_=s(o,"H1",{class:!0});var at=d(_);f=s(at,"A",{id:!0,class:!0,href:!0});var fr=d(f);v=s(fr,"SPAN",{});var gr=d(v);w(i.$$.fragment,gr),gr.forEach(t),fr.forEach(t),u=p(at),I=s(at,"SPAN",{});var ur=d(I);qa=r(ur,"Vision Encoder Decoder Models"),ur.forEach(t),at.forEach(t),yr=p(o),ne=s(o,"H2",{class:!0});var st=d(ne);ye=s(st,"A",{id:!0,class:!0,href:!0});var _r=d(ye);fn=s(_r,"SPAN",{});var vr=d(fn);w(to.$$.fragment,vr),vr.forEach(t),_r.forEach(t),Fa=p(st),gn=s(st,"SPAN",{});var br=d(gn);za=r(br,"Overview"),br.forEach(t),st.forEach(t),kr=p(o),$=s(o,"P",{});var j=d($);Pa=r(j,"The "),ht=s(j,"A",{href:!0});var wr=d(ht);Aa=r(wr,"VisionEncoderDecoderModel"),wr.forEach(t),Ca=r(j,` can be used to initialize an image-to-text model with any
...
were contributed by `),wo=s(on,"A",{href:!0,rel:!0});var Lp=d(wo);Vd=r(Lp,"ydshieh"),Lp.forEach(t),Dd=r(on,"."),on.forEach(t),Wr=p(o),le=s(o,"H2",{class:!0});var ma=d(le);ze=s(ma,"A",{id:!0,class:!0,href:!0});var Np=d(ze);Bn=s(Np,"SPAN",{});var Op=d(Bn);w(Eo.$$.fragment,Op),Op.forEach(t),Np.forEach(t),qd=p(ma),Gn=s(ma,"SPAN",{});var Rp=d(Gn);Fd=r(Rp,"VisionEncoderDecoderConfig"),Rp.forEach(t),ma.forEach(t),Hr=p(o),S=s(o,"DIV",{class:!0});var W=d(S);w(To.$$.fragment,W),zd=p(W),Pe=s(W,"P",{});var Tr=d(Pe);Ft=s(Tr,"A",{href:!0});var Bp=d(Ft);Pd=r(Bp,"VisionEncoderDecoderConfig"),Bp.forEach(t),Ad=r(Tr,` is the configuration class to store the configuration of a
`),zt=s(Tr,"A",{href:!0});var Gp=d(zt);Cd=r(Gp,"VisionEncoderDecoderModel"),Gp.forEach(t),Sd=r(Tr,`. It is used to instantiate a Vision-Encoder-Text-Decoder model according to the
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),ba.forEach(t),xi=p(P),zo=s(P,"P",{});var wa=d(zo);$i=r(wa,"This model is also a PyTorch "),Po=s(wa,"A",{href:!0,rel:!0});var am=d(Po);ji=r(am,"torch.nn.Module"),am.forEach(t),Mi=r(wa,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
...
checkpoints.`),Vm.forEach(t),Hc=p(ln),w(We.$$.fragment,ln),ln.forEach(t),A.forEach(t),Kr=p(o),we=s(o,"H2",{class:!0});var $a=d(we);He=s($a,"A",{id:!0,class:!0,href:!0});var Dm=d(He);dr=s(Dm,"SPAN",{});var qm=d(dr);w(Zo.$$.fragment,qm),qm.forEach(t),Dm.forEach(t),Uc=p($a),ir=s($a,"SPAN",{});var Fm=d(ir);Zc=r(Fm,"FlaxVisionEncoderDecoderModel"),Fm.forEach(t),$a.forEach(t),Qr=p(o),q=s(o,"DIV",{class:!0});var C=d(q);w(Yo.$$.fragment,C),Yc=p(C),Ee=s(C,"P",{});var pn=d(Ee);Jc=r(pn,`This class can be used to initialize an image-to-text-sequence model with any pretrained vision autoencoding model
as the encoder and any pretrained text autoregressive model as the decoder. The encoder is loaded via
