import{S as Vp,i as Gp,s as Up,e as a,k as l,w as v,t as n,M as Hp,c as s,d as t,m as p,a as d,x as y,h as r,b as c,G as e,g as u,y as k,q as w,o as E,B as T,v as Zp,L as ct}from"../../chunks/vendor-hf-doc-builder.js";import{T as Jc}from"../../chunks/Tip-hf-doc-builder.js";import{D as V}from"../../chunks/Docstring-hf-doc-builder.js";import{C as G}from"../../chunks/CodeBlock-hf-doc-builder.js";import{I as H}from"../../chunks/IconCopyLink-hf-doc-builder.js";import{E as it}from"../../chunks/ExampleCodeBlock-hf-doc-builder.js";function Yp(q){let h,$,_,f,b;return f=new G({props:{code:`from transformers import BertConfig, EncoderDecoderConfig, EncoderDecoderModel
...
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),g.forEach(t)},m(i,g){u(i,h,g),e(h,$),e(h,_),e(_,f),e(h,b)},d(i){i&&t(h)}}}function Kp(q){let h,$,_,f,b;return f=new G({props:{code:`from transformers import EncoderDecoderModel, BertTokenizer
import torch
...
<span class="hljs-meta">&gt;&gt;&gt; </span>generated = model.generate(input_ids)`}}),{c(){h=a("p"),$=n("Examples:"),_=l(),v(f.$$.fragment)},l(i){h=s(i,"P",{});var g=d(h);$=r(g,"Examples:"),g.forEach(t),_=p(i),y(f.$$.fragment,i)},m(i,g){u(i,h,g),e(h,$),u(i,_,g),k(f,i,g),b=!0},p:ct,i(i){b||(w(f.$$.fragment,i),b=!0)},o(i){E(f.$$.fragment,i),b=!1},d(i){i&&t(h),i&&t(_),T(f,i)}}}function Qp(q){let h,$,_,f,b;return f=new G({props:{code:`from transformers import EncoderDecoderModel
...
the latter silently ignores them.`)},l(i){h=s(i,"P",{});var g=d(h);$=r(g,"Although the recipe for forward pass needs to be defined within this function, one should call the "),_=s(g,"CODE",{});var S=d(_);f=r(S,"Module"),S.forEach(t),b=r(g,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),g.forEach(t)},m(i,g){u(i,h,g),e(h,$),e(h,_),e(_,f),e(h,b)},d(i){i&&t(h)}}}function em(q){let h,$,_,f,b;return f=new G({props:{code:`from transformers import TFEncoderDecoderModel, BertTokenizer
...
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-comment"># generation</span>
<span class="hljs-meta">&gt;&gt;&gt; </span>generated = model.generate(input_ids, decoder_start_token_id=model.config.decoder.bos_token_id)`}}),{c(){h=a("p"),$=n("Examples:"),_=l(),v(f.$$.fragment)},l(i){h=s(i,"P",{});var g=d(h);$=r(g,"Examples:"),g.forEach(t),_=p(i),y(f.$$.fragment,i)},m(i,g){u(i,h,g),e(h,$),u(i,_,g),k(f,i,g),b=!0},p:ct,i(i){b||(w(f.$$.fragment,i),b=!0)},o(i){E(f.$$.fragment,i),b=!1},d(i){i&&t(h),i&&t(_),T(f,i)}}}function om(q){let h,$,_,f,b;return f=new G({props:{code:`from transformers import TFEncoderDecoderModel
...
<span class="hljs-meta">&gt;&gt;&gt; </span>model.save_pretrained(<span class="hljs-string">&quot;./bert2gpt2&quot;</span>)
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-comment"># load fine-tuned model</span>
<span class="hljs-meta">&gt;&gt;&gt; </span>model = TFEncoderDecoderModel.from_pretrained(<span class="hljs-string">&quot;./bert2gpt2&quot;</span>)`}}),{c(){h=a("p"),$=n("Example:"),_=l(),v(f.$$.fragment)},l(i){h=s(i,"P",{});var g=d(h);$=r(g,"Example:"),g.forEach(t),_=p(i),y(f.$$.fragment,i)},m(i,g){u(i,h,g),e(h,$),u(i,_,g),k(f,i,g),b=!0},p:ct,i(i){b||(w(f.$$.fragment,i),b=!0)},o(i){E(f.$$.fragment,i),b=!1},d(i){i&&t(h),i&&t(_),T(f,i)}}}function tm(q){let h,$,_,f,b;return{c(){h=a("p"),$=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),_=a("code"),f=n("Module"),b=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(i){h=s(i,"P",{});var g=d(h);$=r(g,"Although the recipe for forward pass needs to be defined within this function, one should call the "),_=s(g,"CODE",{});var S=d(_);f=r(S,"Module"),S.forEach(t),b=r(g,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),g.forEach(t)},m(i,g){u(i,h,g),e(h,$),e(h,_),e(_,f),e(h,b)},d(i){i&&t(h)}}}function nm(q){let h,$,_,f,b;return f=new G({props:{code:`from transformers import FlaxEncoderDecoderModel, BertTokenizer, GPT2Tokenizer
...
<span class="hljs-meta">&gt;&gt;&gt; </span>model.save_pretrained(<span class="hljs-string">&quot;./bert2gpt2&quot;</span>)
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-comment"># load fine-tuned model</span>
<span class="hljs-meta">&gt;&gt;&gt; </span>model = FlaxEncoderDecoderModel.from_pretrained(<span class="hljs-string">&quot;./bert2gpt2&quot;</span>)`}}),{c(){h=a("p"),$=n("Example:"),_=l(),v(f.$$.fragment)},l(i){h=s(i,"P",{});var g=d(h);$=r(g,"Example:"),g.forEach(t),_=p(i),y(f.$$.fragment,i)},m(i,g){u(i,h,g),e(h,$),u(i,_,g),k(f,i,g),b=!0},p:ct,i(i){b||(w(f.$$.fragment,i),b=!0)},o(i){E(f.$$.fragment,i),b=!1},d(i){i&&t(h),i&&t(_),T(f,i)}}}function am(q){let h,$,_,f,b,i,g,S,ga,cr,te,we,en,to,_a,on,ba,lr,Ee,va,lt,ya,ka,pr,Te,wa,no,Ea,Ta,mr,$e,$a,pt,Ma,Da,hr,Z,ja,mt,xa,qa,ro,za,Fa,fr,ne,Me,tn,ao,Pa,so,Aa,nn,Ca,Sa,ur,U,ht,Na,Ia,ft,La,Ba,rn,Oa,Ra,gr,io,_r,re,De,an,co,Wa,lo,Va,sn,Ga,Ua,br,M,ut,Ha,Za,dn,Ya,Ja,cn,Ka,Qa,ln,Xa,es,pn,os,ts,gt,ns,rs,je,as,mn,ss,ds,hn,is,cs,_t,ls,ps,vr,po,yr,ae,xe,fn,mo,ms,ho,hs,un,fs,us,kr,I,gs,gn,_s,bs,bt,vs,ys,_n,ks,ws,wr,qe,Es,bn,Ts,$s,Er,fo,Tr,se,ze,vn,uo,Ms,go,Ds,yn,js,xs,$r,de,kn,qs,zs,wn,Fs,Ps,Mr,_o,Dr,ie,Fe,En,bo,As,Tn,Cs,jr,N,Ss,$n,Ns,Is,Mn,Ls,Bs,Dn,Os,Rs,jn,Ws,Vs,xr,vo,qr,Pe,Gs,yo,Us,Hs,zr,Y,Zs,ko,Ys,Js,wo,Ks,Qs,Fr,ce,Ae,xn,Eo,Xs,qn,ed,Pr,C,To,od,Ce,vt,td,nd,yt,rd,ad,sd,le,dd,kt,id,cd,wt,ld,pd,md,Se,hd,Ne,$o,fd,Mo,ud,Et,gd,_d,bd,Ie,Do,vd,pe,yd,zn,kd,wd,Fn,Ed,Td,Ar,me,Le,Pn,jo,$d,An,Md,Cr,D,xo,Dd,he,jd,Tt,xd,qd,$t,zd,Fd,Pd,qo,Ad,zo,Cd,Sd,Nd,Cn,Id,Ld,Fo,Bd,Mt,Od,Rd,Wd,Po,Vd,Ao,Gd,Ud,Hd,J,Dt,Zd,Yd,Sn,Jd,Kd,Nn,Qd,Xd,ei,L,Co,oi,fe,ti,jt,ni,ri,In,ai,si,di,Be,ii,Oe,ci,B,So,li,Ln,pi,mi,ue,hi,Bn,fi,ui,On,gi,_i,bi,Re,Sr,ge,We,Rn,No,vi,Wn,yi,Nr,j,Io,ki,_e,wi,xt,Ei,Ti,qt,$i,Mi,Di,Lo,ji,Bo,xi,qi,zi,Vn,Fi,Pi,Oo,Ai,zt,Ci,Si,Ni,Ro,Ii,Wo,Li,Bi,Oi,K,Ft,Ri,Wi,Pt,Vi,Gi,At,Ui,Hi,Zi,O,Vo,Yi,be,Ji,Ct,Ki,Qi,Gn,Xi,ec,oc,Ve,tc,Ge,nc,Q,Go,rc,Un,ac,sc,Ue,Ir,ve,He,Hn,Uo,dc,Zn,ic,Lr,x,Ho,cc,ye,lc,St,pc,mc,Nt,hc,fc,uc,Zo,gc,Yo,_c,bc,vc,Yn,yc,kc,Jo,wc,It,Ec,Tc,$c,Ko,Mc,Qo,Dc,jc,xc,X,Lt,qc,zc,Jn,Fc,Pc,Kn,Ac,Cc,Sc,R,Xo,Nc,ke,Ic,Bt,Lc,Bc,Qn,Oc,Rc,Wc,Ze,Vc,Ye,Gc,ee,et,Uc,Xn,Hc,Zc,Je,Br;return i=new H({}),to=new H({}),ao=new H({}),io=new G({props:{code:`from transformers import BertConfig, EncoderDecoderConfig, EncoderDecoderModel
...
<span class="hljs-meta">&gt;&gt;&gt; </span>model.config = _model.config`}}),bo=new H({}),vo=new G({props:{code:`from transformers import BertTokenizer, EncoderDecoderModel
...
<ul>
<li><strong>encoder</strong> (<a href="/docs/transformers/v4.21.0/en/main_classes/configuration#transformers.PretrainedConfig">PretrainedConfig</a>, <em>optional</em>) &#x2014; An instance of a configuration object that defines
the encoder config.</li>
<li><strong>decoder</strong> (<a href="/docs/transformers/v4.21.0/en/main_classes/configuration#transformers.PretrainedConfig">PretrainedConfig</a>, <em>optional</em>) &#x2014; An instance of a configuration object that defines
the decoder config.</li>
</ul>`,name:"kwargs"}],source:"https://github.com/huggingface/transformers/blob/v4.21.0/src/transformers/models/encoder_decoder/configuration_encoder_decoder.py#L26"}}),Se=new it({props:{anchor:"transformers.EncoderDecoderConfig.example",$$slots:{default:[Yp]},$$scope:{ctx:q}}}),$o=new V({props:{name:"from_encoder_decoder_configs",anchor:"transformers.EncoderDecoderConfig.from_encoder_decoder_configs",parameters:[{name:"encoder_config",val:": PretrainedConfig"},{name:"decoder_config",val:": PretrainedConfig"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/v4.21.0/src/transformers/models/encoder_decoder/configuration_encoder_decoder.py#L91",returnDescription:`
<p>An instance of a configuration object</p>
`,returnType:`
<p><a
  href="/docs/transformers/v4.21.0/en/model_doc/encoder-decoder#transformers.EncoderDecoderConfig"
>EncoderDecoderConfig</a></p>
`}}),Do=new V({props:{name:"to_dict",anchor:"transformers.EncoderDecoderConfig.to_dict",parameters:[],source:"https://github.com/huggingface/transformers/blob/v4.21.0/src/transformers/models/encoder_decoder/configuration_encoder_decoder.py#L108",returnDescription:`
...
<p>Indices can be obtained using <a href="/docs/transformers/v4.21.0/en/main_classes/tokenizer#transformers.PreTrainedTokenizer">PreTrainedTokenizer</a>. See <a href="/docs/transformers/v4.21.0/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
...
</ul>`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/v4.21.0/src/transformers/models/encoder_decoder/modeling_encoder_decoder.py#L430",returnDescription:`
<p>A <a
...
<a href="/docs/transformers/v4.21.0/en/main_classes/model#transformers.PreTrainedModel.save_pretrained">save_pretrained()</a>, e.g., <code>./my_model_directory/</code>.</li>
...
<a href="/docs/transformers/v4.21.0/en/main_classes/tokenizer#transformers.PreTrainedTokenizer">PreTrainedTokenizer</a>. See <a href="/docs/transformers/v4.21.0/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and <a href="/docs/transformers/v4.21.0/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for
...
</ul>`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/v4.21.0/src/transformers/models/encoder_decoder/modeling_tf_encoder_decoder.py#L495",returnDescription:`
<p>A <a
  href="/docs/transformers/v4.21.0/en/main_classes/output#transformers.modeling_tf_outputs.TFSeq2SeqLMOutput"
...
user or organization name, like <code>dbmdz/bert-base-german-cased</code>.</li>
<li>A path to a <em>directory</em> containing model weights saved using
<a href="/docs/transformers/v4.21.0/en/main_classes/model#transformers.TFPreTrainedModel.save_pretrained">save_pretrained()</a>, e.g., <code>./my_model_directory/</code>.</li>
...
If set to <code>True</code>, the model will return a <code>FlaxSeq2SeqLMOutput</code> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/v4.21.0/src/transformers/models/encoder_decoder/modeling_flax_encoder_decoder.py#L628",returnDescription:`
<p>A <a
  href="/docs/transformers/v4.21.0/en/main_classes/output#transformers.modeling_flax_outputs.FlaxSeq2SeqLMOutput"
...
user or organization name, like <code>dbmdz/bert-base-german-cased</code>.</li>
<li>A path to a <em>directory</em> containing model weights saved using
<a href="/docs/transformers/v4.21.0/en/main_classes/model#transformers.FlaxPreTrainedModel.save_pretrained">save_pretrained()</a>, e.g., <code>./my_model_directory/</code>.</li>
...
<p>Behaves differently depending on whether a <code>config</code> is provided or automatically loaded.`,name:"kwargs"}],source:"https://github.com/huggingface/transformers/blob/v4.21.0/src/transformers/models/encoder_decoder/modeling_flax_encoder_decoder.py#L760"}}),Je=new it({props:{anchor:"transformers.FlaxEncoderDecoderModel.from_encoder_decoder_pretrained.example",$$slots:{default:[rm]},$$scope:{ctx:q}}}),{c(){h=a("meta"),$=l(),_=a("h1"),f=a("a"),b=a("span"),v(i.$$.fragment),g=l(),S=a("span"),ga=n("Encoder Decoder Models"),cr=l(),te=a("h2"),we=a("a"),en=a("span"),v(to.$$.fragment),_a=l(),on=a("span"),ba=n("Overview"),lr=l(),Ee=a("p"),va=n("The "),lt=a("a"),ya=n("EncoderDecoderModel"),ka=n(` can be used to initialize a sequence-to-sequence model with any
...
and decoder for a summarization model as was shown in: `),ro=a("a"),za=n("Text Summarization with Pretrained Encoders"),Fa=n(" by Yang Liu and Mirella Lapata."),fr=l(),ne=a("h2"),Me=a("a"),tn=a("span"),v(ao.$$.fragment),Pa=l(),so=a("span"),Aa=n("Randomly initializing "),nn=a("code"),Ca=n("EncoderDecoderModel"),Sa=n(" from model configurations."),ur=l(),U=a("p"),ht=a("a"),Na=n("EncoderDecoderModel"),Ia=n(" can be randomly initialized from an encoder and a decoder config. In the following example, we show how to do this using the default "),ft=a("a"),La=n("BertModel"),Ba=n(" configuration for the encoder and the default "),rn=a("code"),Oa=n("BertForCausalLM"),Ra=n(" configuration for the decoder."),gr=l(),v(io.$$.fragment),_r=l(),re=a("h2"),De=a("a"),an=a("span"),v(co.$$.fragment),Wa=l(),lo=a("span"),Va=n("Initialising "),sn=a("code"),Ga=n("EncoderDecoderModel"),Ua=n(" from a pretrained encoder and a pretrained decoder."),br=l(),M=a("p"),ut=a("a"),Ha=n("EncoderDecoderModel"),Za=n(" can be initialized from a pretrained encoder checkpoint and a pretrained decoder checkpoint. Note that any pretrained auto-encoding model, "),dn=a("em"),Ya=n("e.g."),Ja=n(" BERT, can serve as the encoder and both pretrained auto-encoding models, "),cn=a("em"),Ka=n("e.g."),Qa=n(" BERT, pretrained causal language models, "),ln=a("em"),Xa=n("e.g."),es=n(" GPT2, as well as the pretrained decoder part of sequence-to-sequence models, "),pn=a("em"),os=n("e.g."),ts=n(` decoder of BART, can be used as the decoder.
...
To do so, the `),hn=a("code"),is=n("EncoderDecoderModel"),cs=n(" class provides a "),_t=a("a"),ls=n("EncoderDecoderModel.from_encoder_decoder_pretrained()"),ps=n(" method."),vr=l(),v(po.$$.fragment),yr=l(),ae=a("h2"),xe=a("a"),fn=a("span"),v(mo.$$.fragment),ms=l(),ho=a("span"),hs=n("Loading an existing "),un=a("code"),fs=n("EncoderDecoderModel"),us=n(" checkpoint and perform inference."),kr=l(),I=a("p"),gs=n("To load fine-tuned checkpoints of the "),gn=a("code"),_s=n("EncoderDecoderModel"),bs=n(" class, "),bt=a("a"),vs=n("EncoderDecoderModel"),ys=n(" provides the "),_n=a("code"),ks=n("from_pretrained(...)"),ws=n(" method just like any other model architecture in Transformers."),wr=l(),qe=a("p"),Es=n("To perform inference, one uses the "),bn=a("code"),Ts=n("generate"),$s=n(" method, which allows to autoregressively generate text. This method supports various forms of decoding, such as greedy, beam search and multinomial sampling."),Er=l(),v(fo.$$.fragment),Tr=l(),se=a("h2"),ze=a("a"),vn=a("span"),v(uo.$$.fragment),Ms=l(),go=a("span"),Ds=n("Loading a PyTorch checkpoint into "),yn=a("code"),js=n("TFEncoderDecoderModel"),xs=n("."),$r=l(),de=a("p"),kn=a("code"),qs=n("TFEncoderDecoderModel.from_pretrained()"),zs=n(` currently doesn\u2019t support initializing the model from a
pytorch checkpoint. Passing `),wn=a("code"),Fs=n("from_pt=True"),Ps=n(` to this method will throw an exception. If there are only pytorch
checkpoints for a particular encoder-decoder model, a workaround is:`),Mr=l(),v(_o.$$.fragment),Dr=l(),ie=a("h2"),Fe=a("a"),En=a("span"),v(bo.$$.fragment),As=l(),Tn=a("span"),Cs=n("Training"),jr=l(),N=a("p"),Ss=n(`Once the model is created, it can be fine-tuned similar to BART, T5 or any other encoder-decoder model.
...
target sequence).`),xr=l(),v(vo.$$.fragment),qr=l(),Pe=a("p"),Gs=n("Detailed "),yo=a("a"),Us=n("colab"),Hs=n(" for training."),zr=l(),Y=a("p"),Zs=n("This model was contributed by "),ko=a("a"),Ys=n("thomwolf"),Js=n(`. This model\u2019s TensorFlow and Flax versions
were contributed by `),wo=a("a"),Ks=n("ydshieh"),Qs=n("."),Fr=l(),ce=a("h2"),Ae=a("a"),xn=a("span"),v(Eo.$$.fragment),Xs=l(),qn=a("span"),ed=n("EncoderDecoderConfig"),Pr=l(),C=a("div"),v(To.$$.fragment),od=l(),Ce=a("p"),vt=a("a"),td=n("EncoderDecoderConfig"),nd=n(" is the configuration class to store the configuration of a "),yt=a("a"),rd=n("EncoderDecoderModel"),ad=n(`. It is
...
documentation from `),wt=a("a"),ld=n("PretrainedConfig"),pd=n(" for more information."),md=l(),v(Se.$$.fragment),hd=l(),Ne=a("div"),v($o.$$.fragment),fd=l(),Mo=a("p"),ud=n("Instantiate a "),Et=a("a"),gd=n("EncoderDecoderConfig"),_d=n(` (or a derived class) from a pre-trained encoder model configuration and
decoder model configuration.`),bd=l(),Ie=a("div"),v(Do.$$.fragment),vd=l(),pe=a("p"),yd=n("Serializes this instance to a Python dictionary. Override the default "),zn=a("em"),kd=n("to_dict()"),wd=n(" from "),Fn=a("em"),Ed=n("PretrainedConfig"),Td=n("."),Ar=l(),me=a("h2"),Le=a("a"),Pn=a("span"),v(jo.$$.fragment),$d=l(),An=a("span"),Md=n("EncoderDecoderModel"),Cr=l(),D=a("div"),v(xo.$$.fragment),Dd=l(),he=a("p"),jd=n(`This class can be used to initialize a sequence-to-sequence model with any pretrained autoencoding model as the
encoder and any pretrained autoregressive model as the decoder. The encoder is loaded via
`),Tt=a("a"),xd=n("from_pretrained()"),qd=n(" function and the decoder is loaded via "),$t=a("a"),zd=n("from_pretrained()"),Fd=n(`
function. Cross-attention layers are automatically added to the decoder and should be fine-tuned on a downstream
generative task, like summarization.`),Pd=l(),qo=a("p"),Ad=n(`The effectiveness of initializing sequence-to-sequence models with pretrained checkpoints for sequence generation
...
(see the examples for more information).`),Ld=l(),Fo=a("p"),Bd=n("This model inherits from "),Mt=a("a"),Od=n("PreTrainedModel"),Rd=n(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Wd=l(),Po=a("p"),Vd=n("This model is also a PyTorch "),Ao=a("a"),Gd=n("torch.nn.Module"),Ud=n(` subclass.
...
:meth`),Nn=a("em"),Qd=n("~transformers.AutoModelForCausalLM.from_pretrained"),Xd=n(" class method for the decoder."),ei=l(),L=a("div"),v(Co.$$.fragment),oi=l(),fe=a("p"),ti=n("The "),jt=a("a"),ni=n("EncoderDecoderModel"),ri=n(" forward method, overrides the "),In=a("code"),ai=n("__call__"),si=n(" special method."),di=l(),v(Be.$$.fragment),ii=l(),v(Oe.$$.fragment),ci=l(),B=a("div"),v(So.$$.fragment),li=l(),Ln=a("p"),pi=n(`Instantiate an encoder and a decoder from one or two base classes of the library from pretrained model
...
the model, you need to first set it back in training mode with `),On=a("code"),gi=n("model.train()"),_i=n("."),bi=l(),v(Re.$$.fragment),Sr=l(),ge=a("h2"),We=a("a"),Rn=a("span"),v(No.$$.fragment),vi=l(),Wn=a("span"),yi=n("TFEncoderDecoderModel"),Nr=l(),j=a("div"),v(Io.$$.fragment),ki=l(),_e=a("p"),wi=n(`This class can be used to initialize a sequence-to-sequence model with any pretrained autoencoding model as the
encoder and any pretrained autoregressive model as the decoder. The encoder is loaded via
...
Zhou, Wei Li, Peter J. Liu.`),zi=l(),Vn=a("p"),Fi=n(`After such an Encoder Decoder model has been trained/fine-tuned, it can be saved/loaded just like any other models
(see the examples for more information).`),Pi=l(),Oo=a("p"),Ai=n("This model inherits from "),zt=a("a"),Ci=n("TFPreTrainedModel"),Si=n(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Ni=l(),Ro=a("p"),Ii=n("This model is also a "),Wo=a("a"),Li=n("tf.keras.Model"),Bi=n(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Oi=l(),K=a("p"),Ft=a("a"),Ri=n("TFEncoderDecoderModel"),Wi=n(` is a generic model class that will be instantiated as a transformer architecture with one
of the base model classes of the library as encoder and another one as decoder when created with the
`),Pt=a("a"),Vi=n("from_pretrained()"),Gi=n(" class method for the encoder and "),At=a("a"),Ui=n("from_pretrained()"),Hi=n(` class
method for the decoder.`),Zi=l(),O=a("div"),v(Vo.$$.fragment),Yi=l(),be=a("p"),Ji=n("The "),Ct=a("a"),Ki=n("TFEncoderDecoderModel"),Qi=n(" forward method, overrides the "),Gn=a("code"),Xi=n("__call__"),ec=n(" special method."),oc=l(),v(Ve.$$.fragment),tc=l(),v(Ge.$$.fragment),nc=l(),Q=a("div"),v(Go.$$.fragment),rc=l(),Un=a("p"),ac=n(`Instantiate an encoder and a decoder from one or two base classes of the library from pretrained model
checkpoints.`),sc=l(),v(Ue.$$.fragment),Ir=l(),ve=a("h2"),He=a("a"),Hn=a("span"),v(Uo.$$.fragment),dc=l(),Zn=a("span"),ic=n("FlaxEncoderDecoderModel"),Lr=l(),x=a("div"),v(Ho.$$.fragment),cc=l(),ye=a("p"),lc=n(`This class can be used to initialize a sequence-to-sequence model with any pretrained autoencoding model as the
encoder and any pretrained autoregressive model as the decoder. The encoder is loaded via
...
Tasks`),bc=n(` by Sascha Rothe, Shashi Narayan, Aliaksei Severyn. Michael Matena, Yanqi
Zhou, Wei Li, Peter J. Liu.`),vc=l(),Yn=a("p"),yc=n(`After such an Encoder Decoder model has been trained/fine-tuned, it can be saved/loaded just like any other models
...
decoder module when created with the :meth`),Jn=a("em"),Fc=n("~transformers.FlaxAutoModel.from_pretrained"),Pc=n(` class method for the
encoder and :meth`),Kn=a("em"),Ac=n("~transformers.FlaxAutoModelForCausalLM.from_pretrained"),Cc=n(" class method for the decoder."),Sc=l(),R=a("div"),v(Xo.$$.fragment),Nc=l(),ke=a("p"),Ic=n("The "),Bt=a("a"),Lc=n("FlaxEncoderDecoderModel"),Bc=n(" forward method, overrides the "),Qn=a("code"),Oc=n("__call__"),Rc=n(" special method."),Wc=l(),v(Ze.$$.fragment),Vc=l(),v(Ye.$$.fragment),Gc=l(),ee=a("div"),v(et.$$.fragment),Uc=l(),Xn=a("p"),Hc=n(`Instantiate an encoder and a decoder from one or two base classes of the library from pretrained model
checkpoints.`),Zc=l(),v(Je.$$.fragment),this.h()},l(o){const m=Hp('[data-svelte="svelte-1phssyn"]',document.head);h=s(m,"META",{name:!0,content:!0}),m.forEach(t),$=p(o),_=s(o,"H1",{class:!0});var ot=d(_);f=s(ot,"A",{id:!0,class:!0,href:!0});var er=d(f);b=s(er,"SPAN",{});var or=d(b);y(i.$$.fragment,or),or.forEach(t),er.forEach(t),g=p(ot),S=s(ot,"SPAN",{});var tr=d(S);ga=r(tr,"Encoder Decoder Models"),tr.forEach(t),ot.forEach(t),cr=p(o),te=s(o,"H2",{class:!0});var tt=d(te);we=s(tt,"A",{id:!0,class:!0,href:!0});var nr=d(we);en=s(nr,"SPAN",{});var rr=d(en);y(to.$$.fragment,rr),rr.forEach(t),nr.forEach(t),_a=p(tt),on=s(tt,"SPAN",{});var ar=d(on);ba=r(ar,"Overview"),ar.forEach(t),tt.forEach(t),lr=p(o),Ee=s(o,"P",{});var nt=d(Ee);va=r(nt,"The "),lt=s(nt,"A",{href:!0});var sr=d(lt);ya=r(sr,"EncoderDecoderModel"),sr.forEach(t),ka=r(nt,` can be used to initialize a sequence-to-sequence model with any
...
To do so, the `),hn=s(z,"CODE",{});var _l=d(hn);is=r(_l,"EncoderDecoderModel"),_l.forEach(t),cs=r(z," class provides a "),_t=s(z,"A",{href:!0});var bl=d(_t);ls=r(bl,"EncoderDecoderModel.from_encoder_decoder_pretrained()"),bl.forEach(t),ps=r(z," method."),z.forEach(t),vr=p(o),y(po.$$.fragment,o),yr=p(o),ae=s(o,"H2",{class:!0});var Hr=d(ae);xe=s(Hr,"A",{id:!0,class:!0,href:!0});var vl=d(xe);fn=s(vl,"SPAN",{});var yl=d(fn);y(mo.$$.fragment,yl),yl.forEach(t),vl.forEach(t),ms=p(Hr),ho=s(Hr,"SPAN",{});var Zr=d(ho);hs=r(Zr,"Loading an existing "),un=s(Zr,"CODE",{});var kl=d(un);fs=r(kl,"EncoderDecoderModel"),kl.forEach(t),us=r(Zr," checkpoint and perform inference."),Zr.forEach(t),Hr.forEach(t),kr=p(o),I=s(o,"P",{});var Ke=d(I);gs=r(Ke,"To load fine-tuned checkpoints of the "),gn=s(Ke,"CODE",{});var wl=d(gn);_s=r(wl,"EncoderDecoderModel"),wl.forEach(t),bs=r(Ke," class, "),bt=s(Ke,"A",{href:!0});var El=d(bt);vs=r(El,"EncoderDecoderModel"),El.forEach(t),ys=r(Ke," provides the "),_n=s(Ke,"CODE",{});var Tl=d(_n);ks=r(Tl,"from_pretrained(...)"),Tl.forEach(t),ws=r(Ke," method just like any other model architecture in Transformers."),Ke.forEach(t),wr=p(o),qe=s(o,"P",{});var Yr=d(qe);Es=r(Yr,"To perform inference, one uses the "),bn=s(Yr,"CODE",{});var $l=d(bn);Ts=r($l,"generate"),$l.forEach(t),$s=r(Yr," method, which allows to autoregressively generate text. This method supports various forms of decoding, such as greedy, beam search and multinomial sampling."),Yr.forEach(t),Er=p(o),y(fo.$$.fragment,o),Tr=p(o),se=s(o,"H2",{class:!0});var Jr=d(se);ze=s(Jr,"A",{id:!0,class:!0,href:!0});var Ml=d(ze);vn=s(Ml,"SPAN",{});var Dl=d(vn);y(uo.$$.fragment,Dl),Dl.forEach(t),Ml.forEach(t),Ms=p(Jr),go=s(Jr,"SPAN",{});var Kr=d(go);Ds=r(Kr,"Loading a PyTorch checkpoint into "),yn=s(Kr,"CODE",{});var jl=d(yn);js=r(jl,"TFEncoderDecoderModel"),jl.forEach(t),xs=r(Kr,"."),Kr.forEach(t),Jr.forEach(t),$r=p(o),de=s(o,"P",{});var dr=d(de);kn=s(dr,"CODE",{});var xl=d(kn);qs=r(xl,"TFEncoderDecoderModel.from_pretrained()"),xl.forEach(t),zs=r(dr,` currently doesn\u2019t support initializing the model from a
pytorch checkpoint. Passing `),wn=s(dr,"CODE",{});var ql=d(wn);Fs=r(ql,"from_pt=True"),ql.forEach(t),Ps=r(dr,` to this method will throw an exception. If there are only pytorch
checkpoints for a particular encoder-decoder model, a workaround is:`),dr.forEach(t),Mr=p(o),y(_o.$$.fragment,o),Dr=p(o),ie=s(o,"H2",{class:!0});var Qr=d(ie);Fe=s(Qr,"A",{id:!0,class:!0,href:!0});var zl=d(Fe);En=s(zl,"SPAN",{});var Fl=d(En);y(bo.$$.fragment,Fl),Fl.forEach(t),zl.forEach(t),As=p(Qr),Tn=s(Qr,"SPAN",{});var Pl=d(Tn);Cs=r(Pl,"Training"),Pl.forEach(t),Qr.forEach(t),jr=p(o),N=s(o,"P",{});var oe=d(N);Ss=r(oe,`Once the model is created, it can be fine-tuned similar to BART, T5 or any other encoder-decoder model.
...
target sequence).`),oe.forEach(t),xr=p(o),y(vo.$$.fragment,o),qr=p(o),Pe=s(o,"P",{});var Xr=d(Pe);Gs=r(Xr,"Detailed "),yo=s(Xr,"A",{href:!0,rel:!0});var Il=d(yo);Us=r(Il,"colab"),Il.forEach(t),Hs=r(Xr," for training."),Xr.forEach(t),zr=p(o),Y=s(o,"P",{});var Rt=d(Y);Zs=r(Rt,"This model was contributed by "),ko=s(Rt,"A",{href:!0,rel:!0});var Ll=d(ko);Ys=r(Ll,"thomwolf"),Ll.forEach(t),Js=r(Rt,`. This model\u2019s TensorFlow and Flax versions
were contributed by `),wo=s(Rt,"A",{href:!0,rel:!0});var Bl=d(wo);Ks=r(Bl,"ydshieh"),Bl.forEach(t),Qs=r(Rt,"."),Rt.forEach(t),Fr=p(o),ce=s(o,"H2",{class:!0});var ea=d(ce);Ae=s(ea,"A",{id:!0,class:!0,href:!0});var Ol=d(Ae);xn=s(Ol,"SPAN",{});var Rl=d(xn);y(Eo.$$.fragment,Rl),Rl.forEach(t),Ol.forEach(t),Xs=p(ea),qn=s(ea,"SPAN",{});var Wl=d(qn);ed=r(Wl,"EncoderDecoderConfig"),Wl.forEach(t),ea.forEach(t),Pr=p(o),C=s(o,"DIV",{class:!0});var W=d(C);y(To.$$.fragment,W),od=p(W),Ce=s(W,"P",{});var ir=d(Ce);vt=s(ir,"A",{href:!0});var Vl=d(vt);td=r(Vl,"EncoderDecoderConfig"),Vl.forEach(t),nd=r(ir," is the configuration class to store the configuration of a "),yt=s(ir,"A",{href:!0});var Gl=d(yt);rd=r(Gl,"EncoderDecoderModel"),Gl.forEach(t),ad=r(ir,`. It is
used to instantiate an Encoder Decoder model according to the specified arguments, defining the encoder and decoder
...
decoder model configuration.`),ta.forEach(t),oa.forEach(t),bd=p(W),Ie=s(W,"DIV",{class:!0});var na=d(Ie);y(Do.$$.fragment,na),vd=p(na),pe=s(na,"P",{});var Vt=d(pe);yd=r(Vt,"Serializes this instance to a Python dictionary. Override the default "),zn=s(Vt,"EM",{});var Yl=d(zn);kd=r(Yl,"to_dict()"),Yl.forEach(t),wd=r(Vt," from "),Fn=s(Vt,"EM",{});var Jl=d(Fn);Ed=r(Jl,"PretrainedConfig"),Jl.forEach(t),Td=r(Vt,"."),Vt.forEach(t),na.forEach(t),W.forEach(t),Ar=p(o),me=s(o,"H2",{class:!0});var ra=d(me);Le=s(ra,"A",{id:!0,class:!0,href:!0});var Kl=d(Le);Pn=s(Kl,"SPAN",{});var Ql=d(Pn);y(jo.$$.fragment,Ql),Ql.forEach(t),Kl.forEach(t),$d=p(ra),An=s(ra,"SPAN",{});var Xl=d(An);Md=r(Xl,"EncoderDecoderModel"),Xl.forEach(t),ra.forEach(t),Cr=p(o),D=s(o,"DIV",{class:!0});var F=d(D);y(xo.$$.fragment,F),Dd=p(F),he=s(F,"P",{});var Gt=d(he);jd=r(Gt,`This class can be used to initialize a sequence-to-sequence model with any pretrained autoencoding model as the
encoder and any pretrained autoregressive model as the decoder. The encoder is loaded via
`),Tt=s(Gt,"A",{href:!0});var ep=d(Tt);xd=r(ep,"from_pretrained()"),ep.forEach(t),qd=r(Gt," function and the decoder is loaded via "),$t=s(Gt,"A",{href:!0});var op=d($t);zd=r(op,"from_pretrained()"),op.forEach(t),Fd=r(Gt,`
function. Cross-attention layers are automatically added to the decoder and should be fine-tuned on a downstream
generative task, like summarization.`),Gt.forEach(t),Pd=p(F),qo=s(F,"P",{});var aa=d(qo);Ad=r(aa,`The effectiveness of initializing sequence-to-sequence models with pretrained checkpoints for sequence generation
...
Zhou, Wei Li, Peter J. Liu.`),aa.forEach(t),Nd=p(F),Cn=s(F,"P",{});var np=d(Cn);Id=r(np,`After such an Encoder Decoder model has been trained/fine-tuned, it can be saved/loaded just like any other models
(see the examples for more information).`),np.forEach(t),Ld=p(F),Fo=s(F,"P",{});var sa=d(Fo);Bd=r(sa,"This model inherits from "),Mt=s(sa,"A",{href:!0});var rp=d(Mt);Od=r(rp,"PreTrainedModel"),rp.forEach(t),Rd=r(sa,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),sa.forEach(t),Wd=p(F),Po=s(F,"P",{});var da=d(Po);Vd=r(da,"This model is also a PyTorch "),Ao=s(da,"A",{href:!0,rel:!0});var ap=d(Ao);Gd=r(ap,"torch.nn.Module"),ap.forEach(t),Ud=r(da,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),da.forEach(t),Hd=p(F),J=s(F,"P",{});var at=d(J);Dt=s(at,"A",{href:!0});var sp=d(Dt);Zd=r(sp,"EncoderDecoderModel"),sp.forEach(t),Yd=r(at,` is a generic model class that will be instantiated as a transformer architecture with one
of the base model classes of the library as encoder and another one as decoder when created with the
...
:meth`),Nn=s(at,"EM",{});var ip=d(Nn);Qd=r(ip,"~transformers.AutoModelForCausalLM.from_pretrained"),ip.forEach(t),Xd=r(at," class method for the decoder."),at.forEach(t),ei=p(F),L=s(F,"DIV",{class:!0});var Qe=d(L);y(Co.$$.fragment,Qe),oi=p(Qe),fe=s(Qe,"P",{});var Ut=d(fe);ti=r(Ut,"The "),jt=s(Ut,"A",{href:!0});var cp=d(jt);ni=r(cp,"EncoderDecoderModel"),cp.forEach(t),ri=r(Ut," forward method, overrides the "),In=s(Ut,"CODE",{});var lp=d(In);ai=r(lp,"__call__"),lp.forEach(t),si=r(Ut," special method."),Ut.forEach(t),di=p(Qe),y(Be.$$.fragment,Qe),ii=p(Qe),y(Oe.$$.fragment,Qe),Qe.forEach(t),ci=p(F),B=s(F,"DIV",{class:!0});var Xe=d(B);y(So.$$.fragment,Xe),li=p(Xe),Ln=s(Xe,"P",{});var pp=d(Ln);pi=r(pp,`Instantiate an encoder and a decoder from one or two base classes of the library from pretrained model
...
the model, you need to first set it back in training mode with `),On=s(Ht,"CODE",{});var hp=d(On);gi=r(hp,"model.train()"),hp.forEach(t),_i=r(Ht,"."),Ht.forEach(t),bi=p(Xe),y(Re.$$.fragment,Xe),Xe.forEach(t),F.forEach(t),Sr=p(o),ge=s(o,"H2",{class:!0});var ia=d(ge);We=s(ia,"A",{id:!0,class:!0,href:!0});var fp=d(We);Rn=s(fp,"SPAN",{});var up=d(Rn);y(No.$$.fragment,up),up.forEach(t),fp.forEach(t),vi=p(ia),Wn=s(ia,"SPAN",{});var gp=d(Wn);yi=r(gp,"TFEncoderDecoderModel"),gp.forEach(t),ia.forEach(t),Nr=p(o),j=s(o,"DIV",{class:!0});var P=d(j);y(Io.$$.fragment,P),ki=p(P),_e=s(P,"P",{});var Zt=d(_e);wi=r(Zt,`This class can be used to initialize a sequence-to-sequence model with any pretrained autoencoding model as the
encoder and any pretrained autoregressive model as the decoder. The encoder is loaded via
`),xt=s(Zt,"A",{href:!0});var _p=d(xt);Ei=r(_p,"from_pretrained()"),_p.forEach(t),Ti=r(Zt," function and the decoder is loaded via "),qt=s(Zt,"A",{href:!0});var bp=d(qt);$i=r(bp,"from_pretrained()"),bp.forEach(t),Mi=r(Zt,`
function. Cross-attention layers are automatically added to the decoder and should be fine-tuned on a downstream
generative task, like summarization.`),Zt.forEach(t),Di=p(P),Lo=s(P,"P",{});var ca=d(Lo);ji=r(ca,`The effectiveness of initializing sequence-to-sequence models with pretrained checkpoints for sequence generation
tasks was shown in `),Bo=s(ca,"A",{href:!0,rel:!0});var vp=d(Bo);xi=r(vp,`Leveraging Pre-trained Checkpoints for Sequence Generation
Tasks`),vp.forEach(t),qi=r(ca,` by Sascha Rothe, Shashi Narayan, Aliaksei Severyn. Michael Matena, Yanqi
Zhou, Wei Li, Peter J. Liu.`),ca.forEach(t),zi=p(P),Vn=s(P,"P",{});var yp=d(Vn);Fi=r(yp,`After such an Encoder Decoder model has been trained/fine-tuned, it can be saved/loaded just like any other models
(see the examples for more information).`),yp.forEach(t),Pi=p(P),Oo=s(P,"P",{});var la=d(Oo);Ai=r(la,"This model inherits from "),zt=s(la,"A",{href:!0});var kp=d(zt);Ci=r(kp,"TFPreTrainedModel"),kp.forEach(t),Si=r(la,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),la.forEach(t),Ni=p(P),Ro=s(P,"P",{});var pa=d(Ro);Ii=r(pa,"This model is also a "),Wo=s(pa,"A",{href:!0,rel:!0});var wp=d(Wo);Li=r(wp,"tf.keras.Model"),wp.forEach(t),Bi=r(pa,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),pa.forEach(t),Oi=p(P),K=s(P,"P",{});var st=d(K);Ft=s(st,"A",{href:!0});var Ep=d(Ft);Ri=r(Ep,"TFEncoderDecoderModel"),Ep.forEach(t),Wi=r(st,` is a generic model class that will be instantiated as a transformer architecture with one
of the base model classes of the library as encoder and another one as decoder when created with the
`),Pt=s(st,"A",{href:!0});var Tp=d(Pt);Vi=r(Tp,"from_pretrained()"),Tp.forEach(t),Gi=r(st," class method for the encoder and "),At=s(st,"A",{href:!0});var $p=d(At);Ui=r($p,"from_pretrained()"),$p.forEach(t),Hi=r(st,` class
method for the decoder.`),st.forEach(t),Zi=p(P),O=s(P,"DIV",{class:!0});var eo=d(O);y(Vo.$$.fragment,eo),Yi=p(eo),be=s(eo,"P",{});var Yt=d(be);Ji=r(Yt,"The "),Ct=s(Yt,"A",{href:!0});var Mp=d(Ct);Ki=r(Mp,"TFEncoderDecoderModel"),Mp.forEach(t),Qi=r(Yt," forward method, overrides the "),Gn=s(Yt,"CODE",{});var Dp=d(Gn);Xi=r(Dp,"__call__"),Dp.forEach(t),ec=r(Yt," special method."),Yt.forEach(t),oc=p(eo),y(Ve.$$.fragment,eo),tc=p(eo),y(Ge.$$.fragment,eo),eo.forEach(t),nc=p(P),Q=s(P,"DIV",{class:!0});var Jt=d(Q);y(Go.$$.fragment,Jt),rc=p(Jt),Un=s(Jt,"P",{});var jp=d(Un);ac=r(jp,`Instantiate an encoder and a decoder from one or two base classes of the library from pretrained model
checkpoints.`),jp.forEach(t),sc=p(Jt),y(Ue.$$.fragment,Jt),Jt.forEach(t),P.forEach(t),Ir=p(o),ve=s(o,"H2",{class:!0});var ma=d(ve);He=s(ma,"A",{id:!0,class:!0,href:!0});var xp=d(He);Hn=s(xp,"SPAN",{});var qp=d(Hn);y(Uo.$$.fragment,qp),qp.forEach(t),xp.forEach(t),dc=p(ma),Zn=s(ma,"SPAN",{});var zp=d(Zn);ic=r(zp,"FlaxEncoderDecoderModel"),zp.forEach(t),ma.forEach(t),Lr=p(o),x=s(o,"DIV",{class:!0});var A=d(x);y(Ho.$$.fragment,A),cc=p(A),ye=s(A,"P",{});var Kt=d(ye);lc=r(Kt,`This class can be used to initialize a sequence-to-sequence model with any pretrained autoencoding model as the
encoder and any pretrained autoregressive model as the decoder. The encoder is loaded via
`),St=s(Kt,"A",{href:!0});var Fp=d(St);pc=r(Fp,"from_pretrained()"),Fp.forEach(t),mc=r(Kt," function and the decoder is loaded via "),Nt=s(Kt,"A",{href:!0});var Pp=d(Nt);hc=r(Pp,"from_pretrained()"),Pp.forEach(t),fc=r(Kt,`
function. Cross-attention layers are automatically added to the decoder and should be fine-tuned on a downstream
...
Tasks`),Ap.forEach(t),bc=r(ha,` by Sascha Rothe, Shashi Narayan, Aliaksei Severyn. Michael Matena, Yanqi
Zhou, Wei Li, Peter J. Liu.`),ha.forEach(t),vc=p(A),Yn=s(A,"P",{});var Cp=d(Yn);yc=r(Cp,`After such an Encoder Decoder model has been trained/fine-tuned, it can be saved/loaded just like any other models
...
the module (flax.nn.Module) of one of the base model classes of the library as encoder module and another one as
decoder module when created with the :meth`),Jn=s(dt,"EM",{});var Lp=d(Jn);Fc=r(Lp,"~transformers.FlaxAutoModel.from_pretrained"),Lp.forEach(t),Pc=r(dt,` class method for the
