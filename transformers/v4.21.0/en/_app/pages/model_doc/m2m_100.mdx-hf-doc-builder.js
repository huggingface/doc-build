import{S as Gr,i as Wr,s as Br,e as n,k as c,w as M,t as r,M as Hr,c as s,d as o,m as h,a,x as v,h as i,b as l,G as e,g as u,y as b,q as y,o as T,B as w,v as Ur,L as nn}from"../../chunks/vendor-hf-doc-builder.js";import{T as Nr}from"../../chunks/Tip-hf-doc-builder.js";import{D as W}from"../../chunks/Docstring-hf-doc-builder.js";import{C as qt}from"../../chunks/CodeBlock-hf-doc-builder.js";import{I as at}from"../../chunks/IconCopyLink-hf-doc-builder.js";import{E as on}from"../../chunks/ExampleCodeBlock-hf-doc-builder.js";function Vr(E){let m,$,g,f,k;return f=new qt({props:{code:`from transformers import M2M100Model, M2M100Config
...
<span class="hljs-meta">&gt;&gt;&gt; </span>configuration = model.config`}}),{c(){m=n("p"),$=r("Example:"),g=c(),M(f.$$.fragment)},l(d){m=s(d,"P",{});var _=a(m);$=i(_,"Example:"),_.forEach(o),g=h(d),v(f.$$.fragment,d)},m(d,_){u(d,m,_),e(m,$),u(d,g,_),b(f,d,_),k=!0},p:nn,i(d){k||(y(f.$$.fragment,d),k=!0)},o(d){T(f.$$.fragment,d),k=!1},d(d){d&&o(m),d&&o(g),w(f,d)}}}function Xr(E){let m,$,g,f,k;return f=new qt({props:{code:`from transformers import M2M100Tokenizer
...
<span class="hljs-meta">&gt;&gt;&gt; </span>model(**model_inputs, labels=labels)  <span class="hljs-comment"># should work</span>`}}),{c(){m=n("p"),$=r("Examples:"),g=c(),M(f.$$.fragment)},l(d){m=s(d,"P",{});var _=a(m);$=i(_,"Examples:"),_.forEach(o),g=h(d),v(f.$$.fragment,d)},m(d,_){u(d,m,_),e(m,$),u(d,g,_),b(f,d,_),k=!0},p:nn,i(d){k||(y(f.$$.fragment,d),k=!0)},o(d){T(f.$$.fragment,d),k=!1},d(d){d&&o(m),d&&o(g),w(f,d)}}}function Rr(E){let m,$,g,f,k;return{c(){m=n("p"),$=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),g=n("code"),f=r("Module"),k=r(`
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),{c(){m=n("p"),$=r("Example:"),g=c(),M(f.$$.fragment)},l(d){m=s(d,"P",{});var _=a(m);$=i(_,"Example:"),_.forEach(o),g=h(d),v(f.$$.fragment,d)},m(d,_){u(d,m,_),e(m,$),u(d,g,_),b(f,d,_),k=!0},p:nn,i(d){k||(y(f.$$.fragment,d),k=!0)},o(d){T(f.$$.fragment,d),k=!1},d(d){d&&o(m),d&&o(g),w(f,d)}}}function Kr(E){let m,$,g,f,k;return{c(){m=n("p"),$=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),g=n("code"),f=r("Module"),k=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(d){m=s(d,"P",{});var _=a(m);$=i(_,"Although the recipe for forward pass needs to be defined within this function, one should call the "),g=s(_,"CODE",{});var I=a(g);f=i(I,"Module"),I.forEach(o),k=i(_,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-built_in">print</span>(tokenizer.batch_decode(gen_tokens, skip_special_tokens=<span class="hljs-literal">True</span>))`}}),{c(){m=n("p"),$=r("Translation example:"),g=c(),M(f.$$.fragment)},l(d){m=s(d,"P",{});var _=a(m);$=i(_,"Translation example:"),_.forEach(o),g=h(d),v(f.$$.fragment,d)},m(d,_){u(d,m,_),e(m,$),u(d,g,_),b(f,d,_),k=!0},p:nn,i(d){k||(y(f.$$.fragment,d),k=!0)},o(d){T(f.$$.fragment,d),k=!1},d(d){d&&o(m),d&&o(g),w(f,d)}}}function Qr(E){let m,$,g,f,k,d,_,I,sn,fo,B,Y,xt,be,an,Et,rn,_o,ee,dn,ye,ln,cn,go,rt,hn,ko,it,Ct,pn,Mo,te,mn,Te,un,fn,vo,H,oe,Ft,we,_n,jt,gn,bo,O,kn,Pt,Mn,vn,Ot,bn,yn,St,Tn,wn,yo,C,$n,dt,zn,qn,Lt,xn,En,At,Cn,Fn,Dt,jn,Pn,To,lt,It,On,wo,$e,$o,ct,ze,Nt,Sn,Ln,x,An,Gt,Dn,In,Wt,Nn,Gn,Bt,Wn,Bn,Ht,Hn,Un,Ut,Vn,Xn,zo,qe,qo,U,ne,Vt,xe,Rn,Xt,Jn,xo,F,Ee,Kn,V,Zn,ht,Qn,Yn,Ce,es,ts,os,X,ns,pt,ss,as,mt,rs,is,ds,se,Eo,R,ae,Rt,Fe,ls,Jt,cs,Co,z,je,hs,Pe,ps,Oe,ms,us,fs,Se,_s,ut,gs,ks,Ms,re,vs,S,Le,bs,Ae,ys,Kt,Ts,ws,$s,De,Ie,Zt,zs,qs,Qt,xs,Es,Ne,Yt,Cs,Fs,eo,js,Ps,to,Os,Ss,ie,Ge,Ls,We,As,oo,Ds,Is,Ns,N,Be,Gs,ft,Ws,_t,Bs,Hs,no,Us,Vs,gt,He,Fo,J,de,so,Ue,Xs,ao,Rs,jo,j,Ve,Js,Xe,Ks,kt,Zs,Qs,Ys,Re,ea,Je,ta,oa,na,L,Ke,sa,K,aa,Mt,ra,ia,ro,da,la,ca,le,ha,ce,Po,Z,he,io,Ze,pa,lo,ma,Oo,P,Qe,ua,Ye,fa,vt,_a,ga,ka,et,Ma,tt,va,ba,ya,A,ot,Ta,Q,wa,bt,$a,za,co,qa,xa,Ea,pe,Ca,me,So;return d=new at({}),be=new at({}),we=new at({}),$e=new qt({props:{code:`from transformers import M2M100Config, M2M100ForConditionalGeneration, M2M100Tokenizer
...
<code>inputs_ids</code> passed when calling <a href="/docs/transformers/v4.21.0/en/model_doc/m2m_100#transformers.M2M100Model">M2M100Model</a> or`,name:"vocab_size"},{anchor:"transformers.M2M100Config.d_model",description:`<strong>d_model</strong> (<code>int</code>, <em>optional</em>, defaults to 1024) &#x2014;
...
Whether or not the model should return the last key/values attentions (not used by all models).`,name:"use_cache"}],source:"https://github.com/huggingface/transformers/blob/v4.21.0/src/transformers/models/m2m_100/configuration_m2m_100.py#L34"}}),se=new on({props:{anchor:"transformers.M2M100Config.example",$$slots:{default:[Vr]},$$scope:{ctx:E}}}),Fe=new at({}),je=new W({props:{name:"class transformers.M2M100Tokenizer",anchor:"transformers.M2M100Tokenizer",parameters:[{name:"vocab_file",val:""},{name:"spm_file",val:""},{name:"src_lang",val:" = None"},{name:"tgt_lang",val:" = None"},{name:"bos_token",val:" = '<s>'"},{name:"eos_token",val:" = '</s>'"},{name:"sep_token",val:" = '</s>'"},{name:"pad_token",val:" = '<pad>'"},{name:"unk_token",val:" = '<unk>'"},{name:"language_codes",val:" = 'm2m100'"},{name:"sp_model_kwargs",val:": typing.Union[typing.Dict[str, typing.Any], NoneType] = None"},{name:"num_madeup_words",val:" = 8"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.M2M100Tokenizer.vocab_file",description:`<strong>vocab_file</strong> (<code>str</code>) &#x2014;
...
</ul>`,name:"sp_model_kwargs"}],source:"https://github.com/huggingface/transformers/blob/v4.21.0/src/transformers/models/m2m_100/tokenization_m2m_100.py#L65"}}),re=new on({props:{anchor:"transformers.M2M100Tokenizer.example",$$slots:{default:[Xr]},$$scope:{ctx:E}}}),Le=new W({props:{name:"build_inputs_with_special_tokens",anchor:"transformers.M2M100Tokenizer.build_inputs_with_special_tokens",parameters:[{name:"token_ids_0",val:": typing.List[int]"},{name:"token_ids_1",val:": typing.Optional[typing.List[int]] = None"}],parametersDescription:[{anchor:"transformers.M2M100Tokenizer.build_inputs_with_special_tokens.token_ids_0",description:`<strong>token_ids_0</strong> (<code>List[int]</code>) &#x2014;
...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/v4.21.0/src/transformers/models/m2m_100/tokenization_m2m_100.py#L258",returnDescription:`
...
Whether or not the token list is already formatted with special tokens for the model.`,name:"already_has_special_tokens"}],source:"https://github.com/huggingface/transformers/blob/v4.21.0/src/transformers/models/m2m_100/tokenization_m2m_100.py#L228",returnDescription:`
...
elements depending on the configuration (<a
  href="/docs/transformers/v4.21.0/en/model_doc/m2m_100#transformers.M2M100Config"
...
(masked), the loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.21.0/src/transformers/models/m2m_100/modeling_m2m_100.py#L1277",returnDescription:`
<p>A <a
...
`}}),pe=new Nr({props:{$$slots:{default:[Kr]},$$scope:{ctx:E}}}),me=new on({props:{anchor:"transformers.M2M100ForConditionalGeneration.forward.example",$$slots:{default:[Zr]},$$scope:{ctx:E}}}),{c(){m=n("meta"),$=c(),g=n("h1"),f=n("a"),k=n("span"),M(d.$$.fragment),_=c(),I=n("span"),sn=r("M2M100"),fo=c(),B=n("h2"),Y=n("a"),xt=n("span"),M(be.$$.fragment),an=c(),Et=n("span"),rn=r("Overview"),_o=c(),ee=n("p"),dn=r("The M2M100 model was proposed in "),ye=n("a"),ln=r("Beyond English-Centric Multilingual Machine Translation"),cn=r(` by Angela Fan, Shruti Bhosale, Holger Schwenk, Zhiyi Ma, Ahmed El-Kishky,
...
documentation from `),mt=n("a"),rs=r("PretrainedConfig"),is=r(" for more information."),ds=c(),M(se.$$.fragment),Eo=c(),R=n("h2"),ae=n("a"),Rt=n("span"),M(Fe.$$.fragment),ls=c(),Jt=n("span"),cs=r("M2M100Tokenizer"),Co=c(),z=n("div"),M(je.$$.fragment),hs=c(),Pe=n("p"),ps=r("Construct an M2M100 tokenizer. Based on "),Oe=n("a"),ms=r("SentencePiece"),us=r("."),fs=c(),Se=n("p"),_s=r("This tokenizer inherits from "),ut=n("a"),gs=r("PreTrainedTokenizer"),ks=r(` which contains most of the main methods. Users should refer to
this superclass for more information regarding those methods.`),Ms=c(),M(re.$$.fragment),vs=c(),S=n("div"),M(Le.$$.fragment),bs=c(),Ae=n("p"),ys=r(`Build model inputs from a sequence or a pair of sequence for sequence classification tasks by concatenating and
...
and behavior.`),na=c(),L=n("div"),M(Ke.$$.fragment),sa=c(),K=n("p"),aa=r("The "),Mt=n("a"),ra=r("M2M100Model"),ia=r(" forward method, overrides the "),ro=n("code"),da=r("__call__"),la=r(" special method."),ca=c(),M(le.$$.fragment),ha=c(),M(ce.$$.fragment),Po=c(),Z=n("h2"),he=n("a"),io=n("span"),M(Ze.$$.fragment),pa=c(),lo=n("span"),ma=r("M2M100ForConditionalGeneration"),Oo=c(),P=n("div"),M(Qe.$$.fragment),ua=c(),Ye=n("p"),fa=r(`The M2M100 Model with a language modeling head. Can be used for summarization.
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),ya=c(),A=n("div"),M(ot.$$.fragment),Ta=c(),Q=n("p"),wa=r("The "),bt=n("a"),$a=r("M2M100ForConditionalGeneration"),za=r(" forward method, overrides the "),co=n("code"),qa=r("__call__"),xa=r(" special method."),Ea=c(),M(pe.$$.fragment),Ca=c(),M(me.$$.fragment),this.h()},l(t){const p=Hr('[data-svelte="svelte-1phssyn"]',document.head);m=s(p,"META",{name:!0,content:!0}),p.forEach(o),$=h(t),g=s(t,"H1",{class:!0});var nt=a(g);f=s(nt,"A",{id:!0,class:!0,href:!0});var ho=a(f);k=s(ho,"SPAN",{});var po=a(k);v(d.$$.fragment,po),po.forEach(o),ho.forEach(o),_=h(nt),I=s(nt,"SPAN",{});var mo=a(I);sn=i(mo,"M2M100"),mo.forEach(o),nt.forEach(o),fo=h(t),B=s(t,"H2",{class:!0});var st=a(B);Y=s(st,"A",{id:!0,class:!0,href:!0});var uo=a(Y);xt=s(uo,"SPAN",{});var ja=a(xt);v(be.$$.fragment,ja),ja.forEach(o),uo.forEach(o),an=h(st),Et=s(st,"SPAN",{});var Pa=a(Et);rn=i(Pa,"Overview"),Pa.forEach(o),st.forEach(o),_o=h(t),ee=s(t,"P",{});var Lo=a(ee);dn=i(Lo,"The M2M100 model was proposed in "),ye=s(Lo,"A",{href:!0,rel:!0});var Oa=a(ye);ln=i(Oa,"Beyond English-Centric Multilingual Machine Translation"),Oa.forEach(o),cn=i(Lo,` by Angela Fan, Shruti Bhosale, Holger Schwenk, Zhiyi Ma, Ahmed El-Kishky,
Siddharth Goyal, Mandeep Baines, Onur Celebi, Guillaume Wenzek, Vishrav Chaudhary, Naman Goyal, Tom Birch, Vitaliy
Liptchinsky, Sergey Edunov, Edouard Grave, Michael Auli, Armand Joulin.`),Lo.forEach(o),go=h(t),rt=s(t,"P",{});var Sa=a(rt);hn=i(Sa,"The abstract from the paper is the following:"),Sa.forEach(o),ko=h(t),it=s(t,"P",{});var La=a(it);Ct=s(La,"EM",{});var Aa=a(Ct);pn=i(Aa,`Existing work in translation demonstrated the potential of massively multilingual machine translation by training a
single model able to translate between any pair of languages. However, much of this work is English-Centric by training
only on data which was translated from or to English. While this is supported by large sources of training data, it
does not reflect translation needs worldwide. In this work, we create a true Many-to-Many multilingual translation
model that can translate directly between any pair of 100 languages. We build and open source a training dataset that
...
to create high quality models. Our focus on non-English-Centric models brings gains of more than 10 BLEU when directly
translating between non-English directions while performing competitively to the best single systems of WMT. We
open-source our scripts so that others may reproduce the data, evaluation, and final M2M-100 model.`),Aa.forEach(o),La.forEach(o),Mo=h(t),te=s(t,"P",{});var Ao=a(te);mn=i(Ao,"This model was contributed by "),Te=s(Ao,"A",{href:!0,rel:!0});var Da=a(Te);un=i(Da,"valhalla"),Da.forEach(o),fn=i(Ao,"."),Ao.forEach(o),vo=h(t),H=s(t,"H3",{class:!0});var Do=a(H);oe=s(Do,"A",{id:!0,class:!0,href:!0});var Ia=a(oe);Ft=s(Ia,"SPAN",{});var Na=a(Ft);v(we.$$.fragment,Na),Na.forEach(o),Ia.forEach(o),_n=h(Do),jt=s(Do,"SPAN",{});var Ga=a(jt);gn=i(Ga,"Training and Generation"),Ga.forEach(o),Do.forEach(o),bo=h(t),O=s(t,"P",{});var ue=a(O);kn=i(ue,`M2M100 is a multilingual encoder-decoder (seq-to-seq) model primarily intended for translation tasks. As the model is
multilingual it expects the sequences in a certain format: A special language id token is used as prefix in both the
...
documentation from `),mt=s(Tt,"A",{href:!0});var cr=a(mt);rs=i(cr,"PretrainedConfig"),cr.forEach(o),is=i(Tt," for more information."),Tt.forEach(o),ds=h(fe),v(se.$$.fragment,fe),fe.forEach(o),Eo=h(t),R=s(t,"H2",{class:!0});var Go=a(R);ae=s(Go,"A",{id:!0,class:!0,href:!0});var hr=a(ae);Rt=s(hr,"SPAN",{});var pr=a(Rt);v(Fe.$$.fragment,pr),pr.forEach(o),hr.forEach(o),ls=h(Go),Jt=s(Go,"SPAN",{});var mr=a(Jt);cs=i(mr,"M2M100Tokenizer"),mr.forEach(o),Go.forEach(o),Co=h(t),z=s(t,"DIV",{class:!0});var q=a(z);v(je.$$.fragment,q),hs=h(q),Pe=s(q,"P",{});var Wo=a(Pe);ps=i(Wo,"Construct an M2M100 tokenizer. Based on "),Oe=s(Wo,"A",{href:!0,rel:!0});var ur=a(Oe);ms=i(ur,"SentencePiece"),ur.forEach(o),us=i(Wo,"."),Wo.forEach(o),fs=h(q),Se=s(q,"P",{});var Bo=a(Se);_s=i(Bo,"This tokenizer inherits from "),ut=s(Bo,"A",{href:!0});var fr=a(ut);gs=i(fr,"PreTrainedTokenizer"),fr.forEach(o),ks=i(Bo,` which contains most of the main methods. Users should refer to
this superclass for more information regarding those methods.`),Bo.forEach(o),Ms=h(q),v(re.$$.fragment,q),vs=h(q),S=s(q,"DIV",{class:!0});var _e=a(S);v(Le.$$.fragment,_e),bs=h(_e),Ae=s(_e,"P",{});var Ho=a(Ae);ys=i(Ho,`Build model inputs from a sequence or a pair of sequence for sequence classification tasks by concatenating and
adding special tokens. An MBART sequence has the following format, where `),Kt=s(Ho,"CODE",{});var _r=a(Kt);Ts=i(_r,"X"),_r.forEach(o),ws=i(Ho," represents the sequence:"),Ho.forEach(o),$s=h(_e),De=s(_e,"UL",{});var Uo=a(De);Ie=s(Uo,"LI",{});var Vo=a(Ie);Zt=s(Vo,"CODE",{});var gr=a(Zt);zs=i(gr,"input_ids"),gr.forEach(o),qs=i(Vo," (for encoder) "),Qt=s(Vo,"CODE",{});var kr=a(Qt);xs=i(kr,"X [eos, src_lang_code]"),kr.forEach(o),Vo.forEach(o),Es=h(Uo),Ne=s(Uo,"LI",{});var Xo=a(Ne);Yt=s(Xo,"CODE",{});var Mr=a(Yt);Cs=i(Mr,"decoder_input_ids"),Mr.forEach(o),Fs=i(Xo,": (for decoder) "),eo=s(Xo,"CODE",{});var vr=a(eo);js=i(vr,"X [eos, tgt_lang_code]"),vr.forEach(o),Xo.forEach(o),Uo.forEach(o),Ps=h(_e),to=s(_e,"P",{});var br=a(to);Os=i(br,`BOS is never used. Pairs of sequences are not the expected use case, but they will be handled without a
...
special tokens using the tokenizer `),oo=s(Jo,"CODE",{});var yr=a(oo);Ds=i(yr,"prepare_for_model"),yr.forEach(o),Is=i(Jo," method."),Jo.forEach(o),Ro.forEach(o),Ns=h(q),N=s(q,"DIV",{class:!0});var wt=a(N);v(Be.$$.fragment,wt),Gs=h(wt),ft=s(wt,"P",{});var Fa=a(ft);Ws=i(Fa,"Create the token type IDs corresponding to the sequences passed. "),_t=s(Fa,"A",{href:!0});var Tr=a(_t);Bs=i(Tr,`What are token type
IDs?`),Tr.forEach(o),Fa.forEach(o),Hs=h(wt),no=s(wt,"P",{});var wr=a(no);Us=i(wr,"Should be overridden in a subclass if the model has a special way of building those."),wr.forEach(o),wt.forEach(o),Vs=h(q),gt=s(q,"DIV",{class:!0});var $r=a(gt);v(He.$$.fragment,$r),$r.forEach(o),q.forEach(o),Fo=h(t),J=s(t,"H2",{class:!0});var Ko=a(J);de=s(Ko,"A",{id:!0,class:!0,href:!0});var zr=a(de);so=s(zr,"SPAN",{});var qr=a(so);v(Ue.$$.fragment,qr),qr.forEach(o),zr.forEach(o),Xs=h(Ko),ao=s(Ko,"SPAN",{});var xr=a(ao);Rs=i(xr,"M2M100Model"),xr.forEach(o),Ko.forEach(o),jo=h(t),j=s(t,"DIV",{class:!0});var ge=a(j);v(Ve.$$.fragment,ge),Js=h(ge),Xe=s(ge,"P",{});var Zo=a(Xe);Ks=i(Zo,`The bare M2M100 Model outputting raw hidden-states without any specific head on top.
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Qo.forEach(o),na=h(ge),L=s(ge,"DIV",{class:!0});var ke=a(L);v(Ke.$$.fragment,ke),sa=h(ke),K=s(ke,"P",{});var $t=a(K);aa=i($t,"The "),Mt=s($t,"A",{href:!0});var Fr=a(Mt);ra=i(Fr,"M2M100Model"),Fr.forEach(o),ia=i($t," forward method, overrides the "),ro=s($t,"CODE",{});var jr=a(ro);da=i(jr,"__call__"),jr.forEach(o),la=i($t," special method."),$t.forEach(o),ca=h(ke),v(le.$$.fragment,ke),ha=h(ke),v(ce.$$.fragment,ke),ke.forEach(o),ge.forEach(o),Po=h(t),Z=s(t,"H2",{class:!0});var Yo=a(Z);he=s(Yo,"A",{id:!0,class:!0,href:!0});var Pr=a(he);io=s(Pr,"SPAN",{});var Or=a(io);v(Ze.$$.fragment,Or),Or.forEach(o),Pr.forEach(o),pa=h(Yo),lo=s(Yo,"SPAN",{});var Sr=a(lo);ma=i(Sr,"M2M100ForConditionalGeneration"),Sr.forEach(o),Yo.forEach(o),Oo=h(t),P=s(t,"DIV",{class:!0});var Me=a(P);v(Qe.$$.fragment,Me),ua=h(Me),Ye=s(Me,"P",{});var en=a(Ye);fa=i(en,`The M2M100 Model with a language modeling head. Can be used for summarization.
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),en.forEach(o),ka=h(Me),et=s(Me,"P",{});var tn=a(et);Ma=i(tn,"This model is also a PyTorch "),tt=s(tn,"A",{href:!0,rel:!0});var Ar=a(tt);va=i(Ar,"torch.nn.Module"),Ar.forEach(o),ba=i(tn,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),tn.forEach(o),ya=h(Me),A=s(Me,"DIV",{class:!0});var ve=a(A);v(ot.$$.fragment,ve),Ta=h(ve),Q=s(ve,"P",{});var zt=a(Q);wa=i(zt,"The "),bt=s(zt,"A",{href:!0});var Dr=a(bt);$a=i(Dr,"M2M100ForConditionalGeneration"),Dr.forEach(o),za=i(zt," forward method, overrides the "),co=s(zt,"CODE",{});var Ir=a(co);qa=i(Ir,"__call__"),Ir.forEach(o),xa=i(zt," special method."),zt.forEach(o),Ea=h(ve),v(pe.$$.fragment,ve),Ca=h(ve),v(me.$$.fragment,ve),ve.forEach(o),Me.forEach(o),this.h()},h(){l(m,"name","hf:doc:metadata"),l(m,"content",JSON.stringify(Yr)),l(f,"id","m2m100"),l(f,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),l(f,"href","#m2m100"),l(g,"class","relative group"),l(Y,"id","overview"),l(Y,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),l(Y,"href","#overview"),l(B,"class","relative group"),l(ye,"href","https://arxiv.org/abs/2010.11125"),l(ye,"rel","nofollow"),l(Te,"href","https://huggingface.co/valhalla"),l(Te,"rel","nofollow"),l(oe,"id","training-and-generation"),l(oe,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),l(oe,"href","#training-and-generation"),l(H,"class","relative group"),l(dt,"href","/docs/transformers/v4.21.0/en/model_doc/m2m_100#transformers.M2M100Tokenizer"),l(ne,"id","transformers.M2M100Config"),l(ne,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),l(ne,"href","#transformers.M2M100Config"),l(U,"class","relative group"),l(ht,"href","/docs/transformers/v4.21.0/en/model_doc/m2m_100#transformers.M2M100Model"),l(Ce,"href","https://huggingface.co/facebook/m2m100_418M"),l(Ce,"rel","nofollow"),l(pt,"href","/docs/transformers/v4.21.0/en/main_classes/configuration#transformers.PretrainedConfig"),l(mt,"href","/docs/transformers/v4.21.0/en/main_classes/configuration#transformers.PretrainedConfig"),l(F,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),l(ae,"id","transformers.M2M100Tokenizer"),l(ae,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),l(ae,"href","#transformers.M2M100Tokenizer"),l(R,"class","relative group"),l(Oe,"href","https://github.com/google/sentencepiece"),l(Oe,"rel","nofollow"),l(ut,"href","/docs/transformers/v4.21.0/en/main_classes/tokenizer#transformers.PreTrainedTokenizer"),l(S,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),l(ie,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),l(_t,"href","../glossary#token-type-ids"),l(N,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),l(gt,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),l(z,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),l(de,"id","transformers.M2M100Model"),l(de,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),l(de,"href","#transformers.M2M100Model"),l(J,"class","relative group"),l(kt,"href","/docs/transformers/v4.21.0/en/main_classes/model#transformers.PreTrainedModel"),l(Je,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),l(Je,"rel","nofollow"),l(Mt,"href","/docs/transformers/v4.21.0/en/model_doc/m2m_100#transformers.M2M100Model"),l(L,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),l(j,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),l(he,"id","transformers.M2M100ForConditionalGeneration"),l(he,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),l(he,"href","#transformers.M2M100ForConditionalGeneration"),l(Z,"class","relative group"),l(vt,"href","/docs/transformers/v4.21.0/en/main_classes/model#transformers.PreTrainedModel"),l(tt,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),l(tt,"rel","nofollow"),l(bt,"href","/docs/transformers/v4.21.0/en/model_doc/m2m_100#transformers.M2M100ForConditionalGeneration"),l(A,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),l(P,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8")},m(t,p){e(document.head,m),u(t,$,p),u(t,g,p),e(g,f),e(f,k),b(d,k,null),e(g,_),e(g,I),e(I,sn),u(t,fo,p),u(t,B,p),e(B,Y),e(Y,xt),b(be,xt,null),e(B,an),e(B,Et),e(Et,rn),u(t,_o,p),u(t,ee,p),e(ee,dn),e(ee,ye),e(ye,ln),e(ee,cn),u(t,go,p),u(t,rt,p),e(rt,hn),u(t,ko,p),u(t,it,p),e(it,Ct),e(Ct,pn),u(t,Mo,p),u(t,te,p),e(te,mn),e(te,Te),e(Te,un),e(te,fn),u(t,vo,p),u(t,H,p),e(H,oe),e(oe,Ft),b(we,Ft,null),e(H,_n),e(H,jt),e(jt,gn),u(t,bo,p),u(t,O,p),e(O,kn),e(O,Pt),e(Pt,Mn),e(O,vn),e(O,Ot),e(Ot,bn),e(O,yn),e(O,St),e(St,Tn),e(O,wn),u(t,yo,p),u(t,C,p),e(C,$n),e(C,dt),e(dt,zn),e(C,qn),e(C,Lt),e(Lt,xn),e(C,En),e(C,At),e(At,Cn),e(C,Fn),e(C,Dt),e(Dt,jn),e(C,Pn),u(t,To,p),u(t,lt,p),e(lt,It),e(It,On),u(t,wo,p),b($e,t,p),u(t,$o,p),u(t,ct,p),e(ct,ze),e(ze,Nt),e(Nt,Sn),e(ze,Ln),e(ze,x),e(x,An),e(x,Gt),e(Gt,Dn),e(x,In),e(x,Wt),e(Wt,Nn),e(x,Gn),e(x,Bt),e(Bt,Wn),e(x,Bn),e(x,Ht),e(Ht,Hn),e(x,Un),e(x,Ut),e(Ut,Vn),e(x,Xn),u(t,zo,p),b(qe,t,p),u(t,qo,p),u(t,U,p),e(U,ne),e(ne,Vt),b(xe,Vt,null),e(U,Rn),e(U,Xt),e(Xt,Jn),u(t,xo,p),u(t,F,p),b(Ee,F,null),e(F,Kn),e(F,V),e(V,Zn),e(V,ht),e(ht,Qn),e(V,Yn),e(V,Ce),e(Ce,es),e(V,ts),e(F,os),e(F,X),e(X,ns),e(X,pt),e(pt,ss),e(X,as),e(X,mt),e(mt,rs),e(X,is),e(F,ds),b(se,F,null),u(t,Eo,p),u(t,R,p),e(R,ae),e(ae,Rt),b(Fe,Rt,null),e(R,ls),e(R,Jt),e(Jt,cs),u(t,Co,p),u(t,z,p),b(je,z,null),e(z,hs),e(z,Pe),e(Pe,ps),e(Pe,Oe),e(Oe,ms),e(Pe,us),e(z,fs),e(z,Se),e(Se,_s),e(Se,ut),e(ut,gs),e(Se,ks),e(z,Ms),b(re,z,null),e(z,vs),e(z,S),b(Le,S,null),e(S,bs),e(S,Ae),e(Ae,ys),e(Ae,Kt),e(Kt,Ts),e(Ae,ws),e(S,$s),e(S,De),e(De,Ie),e(Ie,Zt),e(Zt,zs),e(Ie,qs),e(Ie,Qt),e(Qt,xs),e(De,Es),e(De,Ne),e(Ne,Yt),e(Yt,Cs),e(Ne,Fs),e(Ne,eo),e(eo,js),e(S,Ps),e(S,to),e(to,Os),e(z,Ss),e(z,ie),b(Ge,ie,null),e(ie,Ls),e(ie,We),e(We,As),e(We,oo),e(oo,Ds),e(We,Is),e(z,Ns),e(z,N),b(Be,N,null),e(N,Gs),e(N,ft),e(ft,Ws),e(ft,_t),e(_t,Bs),e(N,Hs),e(N,no),e(no,Us),e(z,Vs),e(z,gt),b(He,gt,null),u(t,Fo,p),u(t,J,p),e(J,de),e(de,so),b(Ue,so,null),e(J,Xs),e(J,ao),e(ao,Rs),u(t,jo,p),u(t,j,p),b(Ve,j,null),e(j,Js),e(j,Xe),e(Xe,Ks),e(Xe,kt),e(kt,Zs),e(Xe,Qs),e(j,Ys),e(j,Re),e(Re,ea),e(Re,Je),e(Je,ta),e(Re,oa),e(j,na),e(j,L),b(Ke,L,null),e(L,sa),e(L,K),e(K,aa),e(K,Mt),e(Mt,ra),e(K,ia),e(K,ro),e(ro,da),e(K,la),e(L,ca),b(le,L,null),e(L,ha),b(ce,L,null),u(t,Po,p),u(t,Z,p),e(Z,he),e(he,io),b(Ze,io,null),e(Z,pa),e(Z,lo),e(lo,ma),u(t,Oo,p),u(t,P,p),b(Qe,P,null),e(P,ua),e(P,Ye),e(Ye,fa),e(Ye,vt),e(vt,_a),e(Ye,ga),e(P,ka),e(P,et),e(et,Ma),e(et,tt),e(tt,va),e(et,ba),e(P,ya),e(P,A),b(ot,A,null),e(A,Ta),e(A,Q),e(Q,wa),e(Q,bt),e(bt,$a),e(Q,za),e(Q,co),e(co,qa),e(Q,xa),e(A,Ea),b(pe,A,null),e(A,Ca),b(me,A,null),So=!0},p(t,[p]){const nt={};p&2&&(nt.$$scope={dirty:p,ctx:t}),se.$set(nt);const ho={};p&2&&(ho.$$scope={dirty:p,ctx:t}),re.$set(ho);const po={};p&2&&(po.$$scope={dirty:p,ctx:t}),le.$set(po);const mo={};p&2&&(mo.$$scope={dirty:p,ctx:t}),ce.$set(mo);const st={};p&2&&(st.$$scope={dirty:p,ctx:t}),pe.$set(st);const uo={};p&2&&(uo.$$scope={dirty:p,ctx:t}),me.$set(uo)},i(t){So||(y(d.$$.fragment,t),y(be.$$.fragment,t),y(we.$$.fragment,t),y($e.$$.fragment,t),y(qe.$$.fragment,t),y(xe.$$.fragment,t),y(Ee.$$.fragment,t),y(se.$$.fragment,t),y(Fe.$$.fragment,t),y(je.$$.fragment,t),y(re.$$.fragment,t),y(Le.$$.fragment,t),y(Ge.$$.fragment,t),y(Be.$$.fragment,t),y(He.$$.fragment,t),y(Ue.$$.fragment,t),y(Ve.$$.fragment,t),y(Ke.$$.fragment,t),y(le.$$.fragment,t),y(ce.$$.fragment,t),y(Ze.$$.fragment,t),y(Qe.$$.fragment,t),y(ot.$$.fragment,t),y(pe.$$.fragment,t),y(me.$$.fragment,t),So=!0)},o(t){T(d.$$.fragment,t),T(be.$$.fragment,t),T(we.$$.fragment,t),T($e.$$.fragment,t),T(qe.$$.fragment,t),T(xe.$$.fragment,t),T(Ee.$$.fragment,t),T(se.$$.fragment,t),T(Fe.$$.fragment,t),T(je.$$.fragment,t),T(re.$$.fragment,t),T(Le.$$.fragment,t),T(Ge.$$.fragment,t),T(Be.$$.fragment,t),T(He.$$.fragment,t),T(Ue.$$.fragment,t),T(Ve.$$.fragment,t),T(Ke.$$.fragment,t),T(le.$$.fragment,t),T(ce.$$.fragment,t),T(Ze.$$.fragment,t),T(Qe.$$.fragment,t),T(ot.$$.fragment,t),T(pe.$$.fragment,t),T(me.$$.fragment,t),So=!1},d(t){o(m),t&&o($),t&&o(g),w(d),t&&o(fo),t&&o(B),w(be),t&&o(_o),t&&o(ee),t&&o(go),t&&o(rt),t&&o(ko),t&&o(it),t&&o(Mo),t&&o(te),t&&o(vo),t&&o(H),w(we),t&&o(bo),t&&o(O),t&&o(yo),t&&o(C),t&&o(To),t&&o(lt),t&&o(wo),w($e,t),t&&o($o),t&&o(ct),t&&o(zo),w(qe,t),t&&o(qo),t&&o(U),w(xe),t&&o(xo),t&&o(F),w(Ee),w(se),t&&o(Eo),t&&o(R),w(Fe),t&&o(Co),t&&o(z),w(je),w(re),w(Le),w(Ge),w(Be),w(He),t&&o(Fo),t&&o(J),w(Ue),t&&o(jo),t&&o(j),w(Ve),w(Ke),w(le),w(ce),t&&o(Po),t&&o(Z),w(Ze),t&&o(Oo),t&&o(P),w(Qe),w(ot),w(pe),w(me)}}}const Yr={local:"m2m100",sections:[{local:"overview",sections:[{local:"training-and-generation",title:"Training and Generation"}],title:"Overview"},{local:"transformers.M2M100Config",title:"M2M100Config"},{local:"transformers.M2M100Tokenizer",title:"M2M100Tokenizer"},{local:"transformers.M2M100Model",title:"M2M100Model"},{local:"transformers.M2M100ForConditionalGeneration",title:"M2M100ForConditionalGeneration"}],title:"M2M100"};function ei(E){return Ur(()=>{new URLSearchParams(window.location.search).get("fw")}),[]}class ii extends Gr{constructor(m){super();Wr(this,m,ei,Qr,Br,{})}}export{ii as default,Yr as metadata};
