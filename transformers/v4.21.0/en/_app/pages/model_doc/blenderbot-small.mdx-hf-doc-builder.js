import{S as dh,i as ih,s as ch,e as n,k as i,w as v,t as r,M as ph,c as a,d as o,m as c,a as s,x as y,h as l,b as m,G as e,g as _,y as T,q as w,o as S,B as $,v as mh,L as Xe}from"../../chunks/vendor-hf-doc-builder.js";import{T as qn}from"../../chunks/Tip-hf-doc-builder.js";import{D as C}from"../../chunks/Docstring-hf-doc-builder.js";import{C as Ye}from"../../chunks/CodeBlock-hf-doc-builder.js";import{I as xe}from"../../chunks/IconCopyLink-hf-doc-builder.js";import{E as Je}from"../../chunks/ExampleCodeBlock-hf-doc-builder.js";function uh(B){let p,k,f,u,b;return u=new Ye({props:{code:`from transformers import BlenderbotSmallModel, BlenderbotSmallConfig
...
[<span class="hljs-number">1</span>, <span class="hljs-number">3</span>, <span class="hljs-number">512</span>]`}}),{c(){p=n("p"),k=r("Example:"),f=i(),v(u.$$.fragment)},l(d){p=a(d,"P",{});var h=s(p);k=l(h,"Example:"),h.forEach(o),f=c(d),y(u.$$.fragment,d)},m(d,h){_(d,p,h),e(p,k),_(d,f,h),T(u,d,h),b=!0},p:Xe,i(d){b||(w(u.$$.fragment,d),b=!0)},o(d){S(u.$$.fragment,d),b=!1},d(d){d&&o(p),d&&o(f),$(u,d)}}}function _h(B){let p,k,f,u,b;return{c(){p=n("p"),k=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=n("code"),u=r("Module"),b=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(d){p=a(d,"P",{});var h=s(p);k=l(h,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=a(h,"CODE",{});var F=s(f);u=l(F,"Module"),F.forEach(o),b=l(h,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
tensors in the first argument of the model call function: `),R=a(O,"CODE",{});var ve=s(R);Le=l(ve,"model(inputs)"),ve.forEach(o),Ne=l(O,"."),O.forEach(o),Q=c(x),V=a(x,"P",{});var oo=s(V);Ie=l(oo,`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
...
`),H=a(ye,"CODE",{});var Te=s(H);De=l(Te,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),Te.forEach(o),ye.forEach(o),Y.forEach(o)},m(x,q){_(x,p,q),e(p,k),_(x,f,q),_(x,u,q),e(u,b),e(b,d),e(u,h),e(u,F),e(F,Ce),_(x,ue,q),_(x,z,q),e(z,je),e(z,W),e(W,Oe),e(z,Pe),e(z,R),e(R,Le),e(z,Ne),_(x,Q,q),_(x,V,q),e(V,Ie),_(x,Z,q),_(x,j,q),e(j,L),e(L,he),e(L,ae),e(ae,ze),e(L,J),e(L,D),e(D,be),e(j,se),e(j,N),e(N,ke),e(N,re),e(re,Be),e(N,ee),e(N,le),e(le,de),e(j,Ae),e(j,X),e(X,Fe),e(X,H),e(H,De)},d(x){x&&o(p),x&&o(f),x&&o(u),x&&o(ue),x&&o(z),x&&o(Q),x&&o(V),x&&o(Z),x&&o(j)}}}function vh(B){let p,k,f,u,b;return{c(){p=n("p"),k=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=n("code"),u=r("Module"),b=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(d){p=a(d,"P",{});var h=s(p);k=l(h,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=a(h,"CODE",{});var F=s(f);u=l(F,"Module"),F.forEach(o),b=l(h,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),h.forEach(o)},m(d,h){_(d,p,h),e(p,k),e(p,f),e(f,u),e(p,b)},d(d){d&&o(p)}}}function yh(B){let p,k,f,u,b;return u=new Ye({props:{code:`from transformers import BlenderbotSmallTokenizer, TFBlenderbotSmallModel
...
<span class="hljs-meta">&gt;&gt;&gt; </span>encoder_outputs = model.encode(**inputs)`}}),{c(){p=n("p"),k=r("Example:"),f=i(),v(u.$$.fragment)},l(d){p=a(d,"P",{});var h=s(p);k=l(h,"Example:"),h.forEach(o),f=c(d),y(u.$$.fragment,d)},m(d,h){_(d,p,h),e(p,k),_(d,f,h),T(u,d,h),b=!0},p:Xe,i(d){b||(w(u.$$.fragment,d),b=!0)},o(d){S(u.$$.fragment,d),b=!1},d(d){d&&o(p),d&&o(f),$(u,d)}}}function xh(B){let p,k,f,u,b;return u=new Ye({props:{code:`import jax.numpy as jnp
...
<span class="hljs-meta">&gt;&gt;&gt; </span>outputs = model.decode(decoder_input_ids, encoder_outputs)
<span class="hljs-meta">&gt;&gt;&gt; </span>logits = outputs.logits`}}),{c(){p=n("p"),k=r("Example:"),f=i(),v(u.$$.fragment)},l(d){p=a(d,"P",{});var h=s(p);k=l(h,"Example:"),h.forEach(o),f=c(d),y(u.$$.fragment,d)},m(d,h){_(d,p,h),e(p,k),_(d,f,h),T(u,d,h),b=!0},p:Xe,i(d){b||(w(u.$$.fragment,d),b=!0)},o(d){S(u.$$.fragment,d),b=!1},d(d){d&&o(p),d&&o(f),$(u,d)}}}function qh(B){let p,k,f,u,b,d,h,F,Ce,ue,z,je,W,Oe,Pe,R,Le,Ne,Q,V,Ie,Z,j,L,he,ae,ze,J,D,be,se,N,ke,re,Be,ee,le,de,Ae,X,Fe,H,De,x,q,ie,Ze,Re,O,eo,ve,oo,Y,G,to,no,oe,ce,fe,ye,Te,ml,ra,ul,cr,we,ut,hl,ao,fl,En,_l,gl,ht,bl,kl,vl,so,yl,Mn,Tl,wl,Cn,Sl,$l,xl,wo,pr,ro,So,la,ft,zl,da,Bl,mr,U,_t,Fl,ia,ql,El,gt,Ml,jn,Cl,jl,Ol,He,bt,Pl,ca,Ll,Nl,pa,Il,Al,$o,kt,Dl,lo,Gl,ma,Ul,Wl,ua,Rl,Hl,Kl,Ke,vt,Ql,On,Vl,Pn,Jl,Xl,ha,Yl,Zl,Ln,yt,ur,io,xo,fa,Tt,ed,_a,od,hr,Ge,wt,td,St,nd,ga,ad,sd,rd,zo,$t,ld,ba,dd,fr,co,Bo,ka,xt,id,va,cd,_r,Se,zt,pd,Bt,md,Nn,ud,hd,fd,Ft,_d,qt,gd,bd,kd,qe,Et,vd,po,yd,In,Td,wd,ya,Sd,$d,xd,Fo,zd,qo,gr,mo,Eo,Ta,Mt,Bd,wa,Fd,br,$e,Ct,qd,jt,Ed,An,Md,Cd,jd,Ot,Od,Pt,Pd,Ld,Nd,Ee,Lt,Id,uo,Ad,Dn,Dd,Gd,Sa,Ud,Wd,Rd,Mo,Hd,Co,kr,ho,jo,$a,Nt,Kd,xa,Qd,vr,fo,It,Vd,Oo,At,Jd,Po,yr,_o,Lo,za,Dt,Xd,Ba,Yd,Tr,pe,Gt,Zd,Ut,ei,Gn,oi,ti,ni,Wt,ai,Rt,si,ri,li,No,di,Me,Ht,ii,go,ci,Un,pi,mi,Fa,ui,hi,fi,Io,_i,Ao,wr,bo,Do,qa,Kt,gi,Ea,bi,Sr,me,Qt,ki,Vt,vi,Wn,yi,Ti,wi,Jt,Si,Xt,$i,xi,zi,Go,Bi,P,Yt,Fi,ko,qi,Rn,Ei,Mi,Ma,Ci,ji,Oi,Uo,Pi,Ca,Li,Ni,ja,Oa,Pa,La,Ii,Ai,Na,Ia,Aa,Da,Di,Gi,Ga,Ua,Wa,Ra,Ui,Wi,Ha,Ka,Qa,Zt,Ri,Va,Hi,Ki,Qi,Ja,Xa,Ya,Za,Vi,$r,vo,Wo,es,en,Ji,os,Xi,xr,I,on,Yi,tn,Zi,Hn,ec,oc,tc,nn,nc,an,ac,sc,rc,ts,lc,dc,Ue,ns,sn,ic,cc,as,rn,pc,mc,ss,ln,uc,hc,rs,dn,fc,_c,Ro,cn,gc,Ho,bc,Ko,pn,kc,Qo,vc,Vo,mn,yc,Jo,zr,yo,Xo,ls,un,Tc,ds,wc,Br,A,hn,Sc,fn,$c,Kn,xc,zc,Bc,_n,Fc,gn,qc,Ec,Mc,is,Cc,jc,We,cs,bn,Oc,Pc,ps,kn,Lc,Nc,ms,vn,Ic,Ac,us,yn,Dc,Gc,E,Tn,Uc,To,Wc,hs,Rc,Hc,fs,Kc,Qc,Vc,Yo,Jc,_s,Xc,Yc,gs,bs,ks,vs,Zc,ep,ys,Ts,ws,Ss,op,tp,$s,xs,zs,Bs,np,ap,Fs,qs,wn,Zo,et,Es,Sn,sp,Ms,rp,lp,Cs,dp,ip,js,cp,pp,Os,Ps,Ls,Ns,mp,up,Is,As,Ds,Gs,hp,fp,Us,Ws,Rs,Hs,_p,gp,Ks,Qs,Vs,Js,bp,kp,ot,$n,vp,tt,yp,nt,xn,Tp,at,Fr;return d=new xe({}),se=new xe({}),Te=new xe({}),ut=new C({props:{name:"class transformers.BlenderbotSmallConfig",anchor:"transformers.BlenderbotSmallConfig",parameters:[{name:"vocab_size",val:" = 50265"},{name:"max_position_embeddings",val:" = 512"},{name:"encoder_layers",val:" = 8"},{name:"encoder_ffn_dim",val:" = 2048"},{name:"encoder_attention_heads",val:" = 16"},{name:"decoder_layers",val:" = 8"},{name:"decoder_ffn_dim",val:" = 2048"},{name:"decoder_attention_heads",val:" = 16"},{name:"encoder_layerdrop",val:" = 0.0"},{name:"decoder_layerdrop",val:" = 0.0"},{name:"use_cache",val:" = True"},{name:"is_encoder_decoder",val:" = True"},{name:"activation_function",val:" = 'gelu'"},{name:"d_model",val:" = 512"},{name:"dropout",val:" = 0.1"},{name:"attention_dropout",val:" = 0.0"},{name:"activation_dropout",val:" = 0.0"},{name:"init_std",val:" = 0.02"},{name:"decoder_start_token_id",val:" = 1"},{name:"classifier_dropout",val:" = 0.0"},{name:"scale_embedding",val:" = False"},{name:"pad_token_id",val:" = 0"},{name:"bos_token_id",val:" = 1"},{name:"eos_token_id",val:" = 2"},{name:"forced_eos_token_id",val:" = 2"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.BlenderbotSmallConfig.vocab_size",description:`<strong>vocab_size</strong> (<code>int</code>, <em>optional</em>, defaults to 50265) &#x2014;
...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/v4.21.0/src/transformers/models/blenderbot_small/tokenization_blenderbot_small_fast.py#L98",returnDescription:`
<p>List of zeros.</p>
`,returnType:`
<p><code>List[int]</code></p>
...
elements depending on the configuration (<a
  href="/docs/transformers/v4.21.0/en/model_doc/blenderbot-small#transformers.BlenderbotSmallConfig"
...
(masked), the loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.21.0/src/transformers/models/blenderbot_small/modeling_blenderbot_small.py#L1251",returnDescription:`
<p>A <a
...
behaviors between training and evaluation).`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/v4.21.0/src/transformers/models/blenderbot_small/modeling_tf_blenderbot_small.py#L1156",returnDescription:`
<p>A <a
  href="/docs/transformers/v4.21.0/en/main_classes/output#transformers.modeling_tf_outputs.TFSeq2SeqModelOutput"
...
Labels for computing the masked language modeling loss. Indices should either be in <code>[0, ..., config.vocab_size]</code> or -100 (see <code>input_ids</code> docstring). Tokens with indices set to <code>-100</code> are ignored
(masked), the loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.21.0/src/transformers/models/blenderbot_small/modeling_tf_blenderbot_small.py#L1266",returnDescription:`
<p>A <a
...
Whether or not to return a <a href="/docs/transformers/v4.21.0/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/v4.21.0/src/transformers/models/blenderbot_small/modeling_flax_blenderbot_small.py#L972",returnDescription:`
<p>A <a
...
Whether or not to return a <a href="/docs/transformers/v4.21.0/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/v4.21.0/src/transformers/models/blenderbot_small/modeling_flax_blenderbot_small.py#L1035",returnDescription:`
<p>A <a
  href="/docs/transformers/v4.21.0/en/main_classes/output#transformers.modeling_flax_outputs.FlaxBaseModelOutputWithPastAndCrossAttentions"
...
Whether or not to return a <a href="/docs/transformers/v4.21.0/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/v4.21.0/src/transformers/models/blenderbot_small/modeling_flax_blenderbot_small.py#L1307",returnDescription:`
<p>A <a
...
`}}),at=new Je({props:{anchor:"transformers.FlaxBlenderbotSmallForConditionalGeneration.decode.example",$$slots:{default:[Fh]},$$scope:{ctx:B}}}),{c(){p=n("meta"),k=i(),f=n("h1"),u=n("a"),b=n("span"),v(d.$$.fragment),h=i(),F=n("span"),Ce=r("Blenderbot Small"),ue=i(),z=n("p"),je=r("Note that "),W=n("a"),Oe=r("BlenderbotSmallModel"),Pe=r(` and
...
`),he=n("a"),ae=r("BlenderbotForConditionalGeneration"),ze=i(),J=n("h2"),D=n("a"),be=n("span"),v(se.$$.fragment),N=i(),ke=n("span"),re=r("Overview"),Be=i(),ee=n("p"),le=r("The Blender chatbot model was proposed in "),de=n("a"),Ae=r("Recipes for building an open-domain chatbot"),X=r(` Stephen Roller, Emily Dinan, Naman Goyal, Da Ju, Mary Williamson, Yinhan Liu,
...
found `),G=n("a"),to=r("here"),no=r(" ."),oe=i(),ce=n("h2"),fe=n("a"),ye=n("span"),v(Te.$$.fragment),ml=i(),ra=n("span"),ul=r("BlenderbotSmallConfig"),cr=i(),we=n("div"),v(ut.$$.fragment),hl=i(),ao=n("p"),fl=r("This is the configuration class to store the configuration of a "),En=n("a"),_l=r("BlenderbotSmallModel"),gl=r(`. It is used to instantiate
an BlenderbotSmall model according to the specified arguments, defining the model architecture. Instantiating a
configuration with the defaults will yield a similar configuration to that of the BlenderbotSmall
`),ht=n("a"),bl=r("facebook/blenderbot_small-90M"),kl=r(" architecture."),vl=i(),so=n("p"),yl=r("Configuration objects inherit from "),Mn=n("a"),Tl=r("PretrainedConfig"),wl=r(` and can be used to control the model outputs. Read the
documentation from `),Cn=n("a"),Sl=r("PretrainedConfig"),$l=r(" for more information."),xl=i(),v(wo.$$.fragment),pr=i(),ro=n("h2"),So=n("a"),la=n("span"),v(ft.$$.fragment),zl=i(),da=n("span"),Bl=r("BlenderbotSmallTokenizer"),mr=i(),U=n("div"),v(_t.$$.fragment),Fl=i(),ia=n("p"),ql=r("Constructs a Blenderbot-90M tokenizer based on BPE (Byte-Pair-Encoding)"),El=i(),gt=n("p"),Ml=r("This tokenizer inherits from "),jn=n("a"),Cl=r("PreTrainedTokenizer"),jl=r(` which contains most of the main methods. Users should refer to
...
adding special tokens.`),Nl=i(),pa=n("p"),Il=r("This implementation does not add special tokens and this method should be overridden in a subclass."),Al=i(),$o=n("div"),v(kt.$$.fragment),Dl=i(),lo=n("p"),Gl=r(`Retrieves sequence ids from a token list that has no special tokens added. This method is called when adding
special tokens using the tokenizer `),ma=n("code"),Ul=r("prepare_for_model"),Wl=r(" or "),ua=n("code"),Rl=r("encode_plus"),Hl=r(" methods."),Kl=i(),Ke=n("div"),v(vt.$$.fragment),Ql=i(),On=n("p"),Vl=r("Create the token type IDs corresponding to the sequences passed. "),Pn=n("a"),Jl=r(`What are token type
IDs?`),Xl=i(),ha=n("p"),Yl=r("Should be overridden in a subclass if the model has a special way of building those."),Zl=i(),Ln=n("div"),v(yt.$$.fragment),ur=i(),io=n("h2"),xo=n("a"),fa=n("span"),v(Tt.$$.fragment),ed=i(),_a=n("span"),od=r("BlenderbotSmallTokenizerFast"),hr=i(),Ge=n("div"),v(wt.$$.fragment),td=i(),St=n("p"),nd=r("Construct a \u201Cfast\u201D BlenderbotSmall tokenizer (backed by HuggingFace\u2019s "),ga=n("em"),ad=r("tokenizers"),sd=r(" library)."),rd=i(),zo=n("div"),v($t.$$.fragment),ld=i(),ba=n("p"),dd=r(`Create a mask from the two sequences passed to be used in a sequence-pair classification task. BlenderbotSmall
does not make use of token type ids, therefore a list of zeros is returned.`),fr=i(),co=n("h2"),Bo=n("a"),ka=n("span"),v(xt.$$.fragment),id=i(),va=n("span"),cd=r("BlenderbotSmallModel"),_r=i(),Se=n("div"),v(zt.$$.fragment),pd=i(),Bt=n("p"),md=r(`The bare BlenderbotSmall Model outputting raw hidden-states without any specific head on top.
...
and behavior.`),kd=i(),qe=n("div"),v(Et.$$.fragment),vd=i(),po=n("p"),yd=r("The "),In=n("a"),Td=r("BlenderbotSmallModel"),wd=r(" forward method, overrides the "),ya=n("code"),Sd=r("__call__"),$d=r(" special method."),xd=i(),v(Fo.$$.fragment),zd=i(),v(qo.$$.fragment),gr=i(),mo=n("h2"),Eo=n("a"),Ta=n("span"),v(Mt.$$.fragment),Bd=i(),wa=n("span"),Fd=r("BlenderbotSmallForConditionalGeneration"),br=i(),$e=n("div"),v(Ct.$$.fragment),qd=i(),jt=n("p"),Ed=r(`The BlenderbotSmall Model with a language modeling head. Can be used for summarization.
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Nd=i(),Ee=n("div"),v(Lt.$$.fragment),Id=i(),uo=n("p"),Ad=r("The "),Dn=n("a"),Dd=r("BlenderbotSmallForConditionalGeneration"),Gd=r(" forward method, overrides the "),Sa=n("code"),Ud=r("__call__"),Wd=r(" special method."),Rd=i(),v(Mo.$$.fragment),Hd=i(),v(Co.$$.fragment),kr=i(),ho=n("h2"),jo=n("a"),$a=n("span"),v(Nt.$$.fragment),Kd=i(),xa=n("span"),Qd=r("BlenderbotSmallForCausalLM"),vr=i(),fo=n("div"),v(It.$$.fragment),Vd=i(),Oo=n("div"),v(At.$$.fragment),Jd=i(),v(Po.$$.fragment),yr=i(),_o=n("h2"),Lo=n("a"),za=n("span"),v(Dt.$$.fragment),Xd=i(),Ba=n("span"),Yd=r("TFBlenderbotSmallModel"),Tr=i(),pe=n("div"),v(Gt.$$.fragment),Zd=i(),Ut=n("p"),ei=r(`The bare BLENDERBOT_SMALL Model outputting raw hidden-states without any specific head on top.
...
behavior.`),li=i(),v(No.$$.fragment),di=i(),Me=n("div"),v(Ht.$$.fragment),ii=i(),go=n("p"),ci=r("The "),Un=n("a"),pi=r("TFBlenderbotSmallModel"),mi=r(" forward method, overrides the "),Fa=n("code"),ui=r("__call__"),hi=r(" special method."),fi=i(),v(Io.$$.fragment),_i=i(),v(Ao.$$.fragment),wr=i(),bo=n("h2"),Do=n("a"),qa=n("span"),v(Kt.$$.fragment),gi=i(),Ea=n("span"),bi=r("TFBlenderbotSmallForConditionalGeneration"),Sr=i(),me=n("div"),v(Qt.$$.fragment),ki=i(),Vt=n("p"),vi=r(`The BLENDERBOT_SMALL Model with a language modeling head. Can be used for summarization.
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),zi=i(),v(Go.$$.fragment),Bi=i(),P=n("div"),v(Yt.$$.fragment),Fi=i(),ko=n("p"),qi=r("The "),Rn=n("a"),Ei=r("TFBlenderbotSmallForConditionalGeneration"),Mi=r(" forward method, overrides the "),Ma=n("code"),Ci=r("__call__"),ji=r(" special method."),Oi=i(),v(Uo.$$.fragment),Pi=i(),Ca=n("p"),Li=r("Conversation example::"),Ni=i(),ja=n("blockquote"),Oa=n("blockquote"),Pa=n("blockquote"),La=n("p"),Ii=r(`from transformers import BlenderbotSmallTokenizer, TFBlenderbotSmallForConditionalGeneration >>> mname =
...
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),rc=i(),ts=n("p"),lc=r("Finally, this model supports inherent JAX features such as:"),dc=i(),Ue=n("ul"),ns=n("li"),sn=n("a"),ic=r("Just-In-Time (JIT) compilation"),cc=i(),as=n("li"),rn=n("a"),pc=r("Automatic Differentiation"),mc=i(),ss=n("li"),ln=n("a"),uc=r("Vectorization"),hc=i(),rs=n("li"),dn=n("a"),fc=r("Parallelization"),_c=i(),Ro=n("div"),v(cn.$$.fragment),gc=i(),v(Ho.$$.fragment),bc=i(),Ko=n("div"),v(pn.$$.fragment),kc=i(),v(Qo.$$.fragment),vc=i(),Vo=n("div"),v(mn.$$.fragment),yc=i(),v(Jo.$$.fragment),zr=i(),yo=n("h2"),Xo=n("a"),ls=n("span"),v(un.$$.fragment),Tc=i(),ds=n("span"),wc=r("FlaxBlenderbotForConditionalGeneration"),Br=i(),A=n("div"),v(hn.$$.fragment),Sc=i(),fn=n("p"),$c=r(`The BLENDERBOT_SMALL Model with a language modeling head. Can be used for summarization.
...
tokenizer([ARTICLE_TO_SUMMARIZE], max_length=1024, return_tensors=\u2018np\u2019)`),ap=i(),Fs=n("blockquote"),qs=n("blockquote"),wn=n("blockquote"),Zo=n("h1"),et=n("a"),Es=n("span"),v(Sn.$$.fragment),sp=i(),Ms=n("span"),rp=r("Generate Summary >>> summary_ids = model.generate(inputs[\u2018input_ids\u2019]).sequences >>>"),lp=i(),Cs=n("p"),dp=r("print(tokenizer.batch_decode(summary_ids, skip_special_tokens=True, clean_up_tokenization_spaces=False))"),ip=i(),js=n("p"),cp=r("Mask filling example:"),pp=i(),Os=n("blockquote"),Ps=n("blockquote"),Ls=n("blockquote"),Ns=n("p"),mp=r(`from transformers import BlenderbotSmallTokenizer, FlaxBlenderbotSmallForConditionalGeneration >>>
...
jax.nn.softmax(logits[0, masked_index], axis=0) >>> values, predictions = jax.lax.top_k(probs)`),gp=i(),Ks=n("blockquote"),Qs=n("blockquote"),Vs=n("blockquote"),Js=n("p"),bp=r("tokenizer.decode(predictions).split()"),kp=i(),ot=n("div"),v($n.$$.fragment),vp=i(),v(tt.$$.fragment),yp=i(),nt=n("div"),v(xn.$$.fragment),Tp=i(),v(at.$$.fragment),this.h()},l(t){const g=ph('[data-svelte="svelte-1phssyn"]',document.head);p=a(g,"META",{name:!0,content:!0}),g.forEach(o),k=c(t),f=a(t,"H1",{class:!0});var zn=s(f);u=a(zn,"A",{id:!0,class:!0,href:!0});var Xs=s(u);b=a(Xs,"SPAN",{});var Ys=s(b);y(d.$$.fragment,Ys),Ys.forEach(o),Xs.forEach(o),h=c(zn),F=a(zn,"SPAN",{});var Zs=s(F);Ce=l(Zs,"Blenderbot Small"),Zs.forEach(o),zn.forEach(o),ue=c(t),z=a(t,"P",{});var _e=s(z);je=l(_e,"Note that "),W=a(_e,"A",{href:!0});var er=s(W);Oe=l(er,"BlenderbotSmallModel"),er.forEach(o),Pe=l(_e,` and
...
adding special tokens.`),Ap.forEach(o),Nl=c(Xn),pa=a(Xn,"P",{});var Dp=s(pa);Il=l(Dp,"This implementation does not add special tokens and this method should be overridden in a subclass."),Dp.forEach(o),Xn.forEach(o),Al=c(ge),$o=a(ge,"DIV",{class:!0});var Cr=s($o);y(kt.$$.fragment,Cr),Dl=c(Cr),lo=a(Cr,"P",{});var Yn=s(lo);Gl=l(Yn,`Retrieves sequence ids from a token list that has no special tokens added. This method is called when adding
special tokens using the tokenizer `),ma=a(Yn,"CODE",{});var Gp=s(ma);Ul=l(Gp,"prepare_for_model"),Gp.forEach(o),Wl=l(Yn," or "),ua=a(Yn,"CODE",{});var Up=s(ua);Rl=l(Up,"encode_plus"),Up.forEach(o),Hl=l(Yn," methods."),Yn.forEach(o),Cr.forEach(o),Kl=c(ge),Ke=a(ge,"DIV",{class:!0});var Zn=s(Ke);y(vt.$$.fragment,Zn),Ql=c(Zn),On=a(Zn,"P",{});var wp=s(On);Vl=l(wp,"Create the token type IDs corresponding to the sequences passed. "),Pn=a(wp,"A",{href:!0});var Wp=s(Pn);Jl=l(Wp,`What are token type
IDs?`),Wp.forEach(o),wp.forEach(o),Xl=c(Zn),ha=a(Zn,"P",{});var Rp=s(ha);Yl=l(Rp,"Should be overridden in a subclass if the model has a special way of building those."),Rp.forEach(o),Zn.forEach(o),Zl=c(ge),Ln=a(ge,"DIV",{class:!0});var Hp=s(Ln);y(yt.$$.fragment,Hp),Hp.forEach(o),ge.forEach(o),ur=c(t),io=a(t,"H2",{class:!0});var jr=s(io);xo=a(jr,"A",{id:!0,class:!0,href:!0});var Kp=s(xo);fa=a(Kp,"SPAN",{});var Qp=s(fa);y(Tt.$$.fragment,Qp),Qp.forEach(o),Kp.forEach(o),ed=c(jr),_a=a(jr,"SPAN",{});var Vp=s(_a);od=l(Vp,"BlenderbotSmallTokenizerFast"),Vp.forEach(o),jr.forEach(o),hr=c(t),Ge=a(t,"DIV",{class:!0});var ea=s(Ge);y(wt.$$.fragment,ea),td=c(ea),St=a(ea,"P",{});var Or=s(St);nd=l(Or,"Construct a \u201Cfast\u201D BlenderbotSmall tokenizer (backed by HuggingFace\u2019s "),ga=a(Or,"EM",{});var Jp=s(ga);ad=l(Jp,"tokenizers"),Jp.forEach(o),sd=l(Or," library)."),Or.forEach(o),rd=c(ea),zo=a(ea,"DIV",{class:!0});var Pr=s(zo);y($t.$$.fragment,Pr),ld=c(Pr),ba=a(Pr,"P",{});var Xp=s(ba);dd=l(Xp,`Create a mask from the two sequences passed to be used in a sequence-pair classification task. BlenderbotSmall
does not make use of token type ids, therefore a list of zeros is returned.`),Xp.forEach(o),Pr.forEach(o),ea.forEach(o),fr=c(t),co=a(t,"H2",{class:!0});var Lr=s(co);Bo=a(Lr,"A",{id:!0,class:!0,href:!0});var Yp=s(Bo);ka=a(Yp,"SPAN",{});var Zp=s(ka);y(xt.$$.fragment,Zp),Zp.forEach(o),Yp.forEach(o),id=c(Lr),va=a(Lr,"SPAN",{});var em=s(va);cd=l(em,"BlenderbotSmallModel"),em.forEach(o),Lr.forEach(o),_r=c(t),Se=a(t,"DIV",{class:!0});var rt=s(Se);y(zt.$$.fragment,rt),pd=c(rt),Bt=a(rt,"P",{});var Nr=s(Bt);md=l(Nr,`The bare BlenderbotSmall Model outputting raw hidden-states without any specific head on top.
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Ir.forEach(o),kd=c(rt),qe=a(rt,"DIV",{class:!0});var lt=s(qe);y(Et.$$.fragment,lt),vd=c(lt),po=a(lt,"P",{});var oa=s(po);yd=l(oa,"The "),In=a(oa,"A",{href:!0});var nm=s(In);Td=l(nm,"BlenderbotSmallModel"),nm.forEach(o),wd=l(oa," forward method, overrides the "),ya=a(oa,"CODE",{});var am=s(ya);Sd=l(am,"__call__"),am.forEach(o),$d=l(oa," special method."),oa.forEach(o),xd=c(lt),y(Fo.$$.fragment,lt),zd=c(lt),y(qo.$$.fragment,lt),lt.forEach(o),rt.forEach(o),gr=c(t),mo=a(t,"H2",{class:!0});var Ar=s(mo);Eo=a(Ar,"A",{id:!0,class:!0,href:!0});var sm=s(Eo);Ta=a(sm,"SPAN",{});var rm=s(Ta);y(Mt.$$.fragment,rm),rm.forEach(o),sm.forEach(o),Bd=c(Ar),wa=a(Ar,"SPAN",{});var lm=s(wa);Fd=l(lm,"BlenderbotSmallForConditionalGeneration"),lm.forEach(o),Ar.forEach(o),br=c(t),$e=a(t,"DIV",{class:!0});var dt=s($e);y(Ct.$$.fragment,dt),qd=c(dt),jt=a(dt,"P",{});var Dr=s(jt);Ed=l(Dr,`The BlenderbotSmall Model with a language modeling head. Can be used for summarization.
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Gr.forEach(o),Nd=c(dt),Ee=a(dt,"DIV",{class:!0});var it=s(Ee);y(Lt.$$.fragment,it),Id=c(it),uo=a(it,"P",{});var ta=s(uo);Ad=l(ta,"The "),Dn=a(ta,"A",{href:!0});var cm=s(Dn);Dd=l(cm,"BlenderbotSmallForConditionalGeneration"),cm.forEach(o),Gd=l(ta," forward method, overrides the "),Sa=a(ta,"CODE",{});var pm=s(Sa);Ud=l(pm,"__call__"),pm.forEach(o),Wd=l(ta," special method."),ta.forEach(o),Rd=c(it),y(Mo.$$.fragment,it),Hd=c(it),y(Co.$$.fragment,it),it.forEach(o),dt.forEach(o),kr=c(t),ho=a(t,"H2",{class:!0});var Ur=s(ho);jo=a(Ur,"A",{id:!0,class:!0,href:!0});var mm=s(jo);$a=a(mm,"SPAN",{});var um=s($a);y(Nt.$$.fragment,um),um.forEach(o),mm.forEach(o),Kd=c(Ur),xa=a(Ur,"SPAN",{});var hm=s(xa);Qd=l(hm,"BlenderbotSmallForCausalLM"),hm.forEach(o),Ur.forEach(o),vr=c(t),fo=a(t,"DIV",{class:!0});var Wr=s(fo);y(It.$$.fragment,Wr),Vd=c(Wr),Oo=a(Wr,"DIV",{class:!0});var Rr=s(Oo);y(At.$$.fragment,Rr),Jd=c(Rr),y(Po.$$.fragment,Rr),Rr.forEach(o),Wr.forEach(o),yr=c(t),_o=a(t,"H2",{class:!0});var Hr=s(_o);Lo=a(Hr,"A",{id:!0,class:!0,href:!0});var fm=s(Lo);za=a(fm,"SPAN",{});var _m=s(za);y(Dt.$$.fragment,_m),_m.forEach(o),fm.forEach(o),Xd=c(Hr),Ba=a(Hr,"SPAN",{});var gm=s(Ba);Yd=l(gm,"TFBlenderbotSmallModel"),gm.forEach(o),Hr.forEach(o),Tr=c(t),pe=a(t,"DIV",{class:!0});var Qe=s(pe);y(Gt.$$.fragment,Qe),Zd=c(Qe),Ut=a(Qe,"P",{});var Kr=s(Ut);ei=l(Kr,`The bare BLENDERBOT_SMALL Model outputting raw hidden-states without any specific head on top.
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Qr.forEach(o),li=c(Qe),y(No.$$.fragment,Qe),di=c(Qe),Me=a(Qe,"DIV",{class:!0});var ct=s(Me);y(Ht.$$.fragment,ct),ii=c(ct),go=a(ct,"P",{});var na=s(go);ci=l(na,"The "),Un=a(na,"A",{href:!0});var vm=s(Un);pi=l(vm,"TFBlenderbotSmallModel"),vm.forEach(o),mi=l(na," forward method, overrides the "),Fa=a(na,"CODE",{});var ym=s(Fa);ui=l(ym,"__call__"),ym.forEach(o),hi=l(na," special method."),na.forEach(o),fi=c(ct),y(Io.$$.fragment,ct),_i=c(ct),y(Ao.$$.fragment,ct),ct.forEach(o),Qe.forEach(o),wr=c(t),bo=a(t,"H2",{class:!0});var Vr=s(bo);Do=a(Vr,"A",{id:!0,class:!0,href:!0});var Tm=s(Do);qa=a(Tm,"SPAN",{});var wm=s(qa);y(Kt.$$.fragment,wm),wm.forEach(o),Tm.forEach(o),gi=c(Vr),Ea=a(Vr,"SPAN",{});var Sm=s(Ea);bi=l(Sm,"TFBlenderbotSmallForConditionalGeneration"),Sm.forEach(o),Vr.forEach(o),Sr=c(t),me=a(t,"DIV",{class:!0});var Ve=s(me);y(Qt.$$.fragment,Ve),ki=c(Ve),Vt=a(Ve,"P",{});var Jr=s(Vt);vi=l(Jr,`The BLENDERBOT_SMALL Model with a language modeling head. Can be used for summarization.
This model inherits from `),Wn=a(Jr,"A",{href:!0});var $m=s(Wn);yi=l($m,"TFPreTrainedModel"),$m.forEach(o),Ti=l(Jr,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Xr.forEach(o),zi=c(Ve),y(Go.$$.fragment,Ve),Bi=c(Ve),P=a(Ve,"DIV",{class:!0});var K=s(P);y(Yt.$$.fragment,K),Fi=c(K),ko=a(K,"P",{});var aa=s(ko);qi=l(aa,"The "),Rn=a(aa,"A",{href:!0});var zm=s(Rn);Ei=l(zm,"TFBlenderbotSmallForConditionalGeneration"),zm.forEach(o),Mi=l(aa," forward method, overrides the "),Ma=a(aa,"CODE",{});var Bm=s(Ma);Ci=l(Bm,"__call__"),Bm.forEach(o),ji=l(aa," special method."),aa.forEach(o),Oi=c(K),y(Uo.$$.fragment,K),Pi=c(K),Ca=a(K,"P",{});var Fm=s(Ca);Li=l(Fm,"Conversation example::"),Fm.forEach(o),Ni=c(K),ja=a(K,"BLOCKQUOTE",{});var qm=s(ja);Oa=a(qm,"BLOCKQUOTE",{});var Em=s(Oa);Pa=a(Em,"BLOCKQUOTE",{});var Mm=s(Pa);La=a(Mm,"P",{});var Cm=s(La);Ii=l(Cm,`from transformers import BlenderbotSmallTokenizer, TFBlenderbotSmallForConditionalGeneration >>> mname =
\u2018facebook/blenderbot_small-90M\u2019 >>> model = BlenderbotSmallForConditionalGeneration.from_pretrained(mname) >>>
...
next_reply_ids = model.generate(**inputs) >>> print(\u201CBot: \u201D, tokenizer.batch_decode(next_reply_ids,
skip_special_tokens=True)[0])`),Vm.forEach(o),Qm.forEach(o),Km.forEach(o),Hm.forEach(o),K.forEach(o),Ve.forEach(o),$r=c(t),vo=a(t,"H2",{class:!0});var Zr=s(vo);Wo=a(Zr,"A",{id:!0,class:!0,href:!0});var Jm=s(Wo);es=a(Jm,"SPAN",{});var Xm=s(es);y(en.$$.fragment,Xm),Xm.forEach(o),Jm.forEach(o),Ji=c(Zr),os=a(Zr,"SPAN",{});var Ym=s(os);Xi=l(Ym,"FlaxBlenderbotSmallModel"),Ym.forEach(o),Zr.forEach(o),xr=c(t),I=a(t,"DIV",{class:!0});var te=s(I);y(on.$$.fragment,te),Yi=c(te),tn=a(te,"P",{});var el=s(tn);Zi=l(el,`The bare BlenderbotSmall Model transformer outputting raw hidden-states without any specific head on top.
