...
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),f.forEach(t)},m(i,f){g(i,l,f),e(l,v),e(l,p),e(p,u),e(l,b)},d(i){i&&t(l)}}}function Ju($){let l,v,p,u,b;return u=new Ae({props:{code:`from transformers import LEDTokenizer, LEDModel
import torch
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),{c(){l=a("p"),v=n("Example:"),p=c(),T(u.$$.fragment)},l(i){l=r(i,"P",{});var f=d(l);v=s(f,"Example:"),f.forEach(t),p=h(i),k(u.$$.fragment,i)},m(i,f){g(i,l,f),e(l,v),g(i,p,f),w(u,i,f),b=!0},p:je,i(i){b||(y(u.$$.fragment,i),b=!0)},o(i){E(u.$$.fragment,i),b=!1},d(i){i&&t(l),i&&t(p),L(u,i)}}}function Zu($){let l,v,p,u,b;return{c(){l=a("p"),v=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),p=a("code"),u=n("Module"),b=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(i){l=r(i,"P",{});var f=d(l);v=s(f,"Although the recipe for forward pass needs to be defined within this function, one should call the "),p=r(f,"CODE",{});var D=d(p);u=s(D,"Module"),D.forEach(t),b=s(f,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),f.forEach(t)},m(i,f){g(i,l,f),e(l,v),e(l,p),e(p,u),e(l,b)},d(i){i&&t(l)}}}function Ku($){let l,v,p,u,b;return u=new Ae({props:{code:`from transformers import LEDTokenizer, LEDForConditionalGeneration
...
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-built_in">print</span>(tokenizer.decode(summary_ids[<span class="hljs-number">0</span>], skip_special_tokens=<span class="hljs-literal">True</span>, clean_up_tokenization_spaces=<span class="hljs-literal">True</span>))`}}),{c(){l=a("p"),v=n("Summarization example:"),p=c(),T(u.$$.fragment)},l(i){l=r(i,"P",{});var f=d(l);v=s(f,"Summarization example:"),f.forEach(t),p=h(i),k(u.$$.fragment,i)},m(i,f){g(i,l,f),e(l,v),g(i,p,f),w(u,i,f),b=!0},p:je,i(i){b||(y(u.$$.fragment,i),b=!0)},o(i){E(u.$$.fragment,i),b=!1},d(i){i&&t(l),i&&t(p),L(u,i)}}}function em($){let l,v,p,u,b;return{c(){l=a("p"),v=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),p=a("code"),u=n("Module"),b=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(i){l=r(i,"P",{});var f=d(l);v=s(f,"Although the recipe for forward pass needs to be defined within this function, one should call the "),p=r(f,"CODE",{});var D=d(p);u=s(D,"Module"),D.forEach(t),b=s(f,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),f.forEach(t)},m(i,f){g(i,l,f),e(l,v),e(l,p),e(p,u),e(l,b)},d(i){i&&t(l)}}}function tm($){let l,v,p,u,b;return u=new Ae({props:{code:`import torch
...
`}}),{c(){T(l.$$.fragment)},l(p){k(l.$$.fragment,p)},m(p,u){w(l,p,u),v=!0},p:je,i(p){v||(y(l.$$.fragment,p),v=!0)},o(p){E(l.$$.fragment,p),v=!1},d(p){L(l,p)}}}function nm($){let l,v,p,u,b;return u=new Ae({props:{code:`import torch
from transformers import LEDTokenizer, LEDForSequenceClassification
...
<span class="hljs-meta">... </span>)
<span class="hljs-meta">&gt;&gt;&gt; </span>loss = model(**inputs, labels=labels).loss
<span class="hljs-meta">&gt;&gt;&gt; </span>loss.backward()`}}),{c(){T(l.$$.fragment)},l(p){k(l.$$.fragment,p)},m(p,u){w(l,p,u),v=!0},p:je,i(p){v||(y(l.$$.fragment,p),v=!0)},o(p){E(l.$$.fragment,p),v=!1},d(p){L(l,p)}}}function am($){let l,v,p,u,b;return{c(){l=a("p"),v=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),p=a("code"),u=n("Module"),b=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(i){l=r(i,"P",{});var f=d(l);v=s(f,"Although the recipe for forward pass needs to be defined within this function, one should call the "),p=r(f,"CODE",{});var D=d(p);u=s(D,"Module"),D.forEach(t),b=s(f,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),f.forEach(t)},m(i,f){g(i,l,f),e(l,v),e(l,p),e(p,u),e(l,b)},d(i){i&&t(l)}}}function rm($){let l,v,p,u,b;return u=new Ae({props:{code:`from transformers import LEDTokenizer, LEDForQuestionAnswering
import torch
...
`}}),{c(){l=a("p"),v=n("Example:"),p=c(),T(u.$$.fragment)},l(i){l=r(i,"P",{});var f=d(l);v=s(f,"Example:"),f.forEach(t),p=h(i),k(u.$$.fragment,i)},m(i,f){g(i,l,f),e(l,v),g(i,p,f),w(u,i,f),b=!0},p:je,i(i){b||(y(u.$$.fragment,i),b=!0)},o(i){E(u.$$.fragment,i),b=!1},d(i){i&&t(l),i&&t(p),L(u,i)}}}function dm($){let l,v;return l=new Ae({props:{code:`# target is "nice puppet"
...
first positional argument :`),be=c(),O=a("ul"),j=a("li"),ue=n("a single Tensor with "),oe=a("code"),$e=n("input_ids"),me=n(" only and nothing else: "),U=a("code"),Ge=n("model(input_ids)"),De=c(),C=a("li"),Be=n(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
...
`),ne=r(Re,"CODE",{});var Ue=d(ne);Te=s(Ue,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),Ue.forEach(t),Re.forEach(t),V.forEach(t)},m(q,z){g(q,l,z),e(l,v),g(q,p,z),g(q,u,z),e(u,b),e(b,i),e(u,f),e(u,D),e(D,Pe),g(q,pe,z),g(q,F,z),e(F,Z),e(F,H),e(H,ee),e(F,Ne),e(F,W),e(W,Ie),e(F,qe),g(q,I,z),g(q,R,z),e(R,te),g(q,be,z),g(q,O,z),e(O,j),e(j,ue),e(j,oe),e(oe,$e),e(j,me),e(j,U),e(U,Ge),e(O,De),e(O,C),e(C,Be),e(C,K),e(K,M),e(C,S),e(C,G),e(G,Qe),e(O,He),e(O,P),e(P,We),e(P,ne),e(ne,Te)},d(q){q&&t(l),q&&t(p),q&&t(u),q&&t(pe),q&&t(F),q&&t(I),q&&t(R),q&&t(be),q&&t(O)}}}function lm($){let l,v,p,u,b;return{c(){l=a("p"),v=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),p=a("code"),u=n("Module"),b=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(i){l=r(i,"P",{});var f=d(l);v=s(f,"Although the recipe for forward pass needs to be defined within this function, one should call the "),p=r(f,"CODE",{});var D=d(p);u=s(D,"Module"),D.forEach(t),b=s(f,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),f.forEach(t)},m(i,f){g(i,l,f),e(l,v),e(l,p),e(p,u),e(l,b)},d(i){i&&t(l)}}}function cm($){let l,v,p,u,b;return u=new Ae({props:{code:`from transformers import LEDTokenizer, TFLEDModel
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),{c(){l=a("p"),v=n("Example:"),p=c(),T(u.$$.fragment)},l(i){l=r(i,"P",{});var f=d(l);v=s(f,"Example:"),f.forEach(t),p=h(i),k(u.$$.fragment,i)},m(i,f){g(i,l,f),e(l,v),g(i,p,f),w(u,i,f),b=!0},p:je,i(i){b||(y(u.$$.fragment,i),b=!0)},o(i){E(u.$$.fragment,i),b=!1},d(i){i&&t(l),i&&t(p),L(u,i)}}}function hm($){let l,v,p,u,b,i,f,D,Pe,pe,F,Z,H,ee,Ne,W,Ie,qe,I,R,te,be,O,j,ue,oe,$e,me,U,Ge,De,C,Be,K,M,S,G,Qe,He,P,We,ne,Te;return{c(){l=a("p"),v=n("TF 2.0 models accepts two formats as inputs:"),p=c(),u=a("ul"),b=a("li"),i=n("having all inputs as keyword arguments (like PyTorch models), or"),f=c(),D=a("li"),Pe=n("having all inputs as a list, tuple or dict in the first positional arguments."),pe=c(),F=a("p"),Z=n("This second option is useful when using "),H=a("code"),ee=n("tf.keras.Model.fit"),Ne=n(` method which currently requires having all the
tensors in the first argument of the model call function: `),W=a("code"),Ie=n("model(inputs)"),qe=n("."),I=c(),R=a("p"),te=n(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),be=c(),O=a("ul"),j=a("li"),ue=n("a single Tensor with "),oe=a("code"),$e=n("input_ids"),me=n(" only and nothing else: "),U=a("code"),Ge=n("model(input_ids)"),De=c(),C=a("li"),Be=n(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),K=a("code"),M=n("model([input_ids, attention_mask])"),S=n(" or "),G=a("code"),Qe=n("model([input_ids, attention_mask, token_type_ids])"),He=c(),P=a("li"),We=n(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),ne=a("code"),Te=n('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(q){l=r(q,"P",{});var z=d(l);v=s(z,"TF 2.0 models accepts two formats as inputs:"),z.forEach(t),p=h(q),u=r(q,"UL",{});var se=d(u);b=r(se,"LI",{});var nt=d(b);i=s(nt,"having all inputs as keyword arguments (like PyTorch models), or"),nt.forEach(t),f=h(se),D=r(se,"LI",{});var st=d(D);Pe=s(st,"having all inputs as a list, tuple or dict in the first positional arguments."),st.forEach(t),se.forEach(t),pe=h(q),F=r(q,"P",{});var N=d(F);Z=s(N,"This second option is useful when using "),H=r(N,"CODE",{});var at=d(H);ee=s(at,"tf.keras.Model.fit"),at.forEach(t),Ne=s(N,` method which currently requires having all the
...
first positional argument :`),Fe.forEach(t),be=h(q),O=r(q,"UL",{});var V=d(O);j=r(V,"LI",{});var ae=d(j);ue=s(ae,"a single Tensor with "),oe=r(ae,"CODE",{});var ze=d(oe);$e=s(ze,"input_ids"),ze.forEach(t),me=s(ae," only and nothing else: "),U=r(ae,"CODE",{});var dt=d(U);Ge=s(dt,"model(input_ids)"),dt.forEach(t),ae.forEach(t),De=h(V),C=r(V,"LI",{});var re=d(C);Be=s(re,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),K=r(re,"CODE",{});var it=d(K);M=s(it,"model([input_ids, attention_mask])"),it.forEach(t),S=s(re," or "),G=r(re,"CODE",{});var de=d(G);Qe=s(de,"model([input_ids, attention_mask, token_type_ids])"),de.forEach(t),re.forEach(t),He=h(V),P=r(V,"LI",{});var Re=d(P);We=s(Re,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),ne=r(Re,"CODE",{});var Ue=d(ne);Te=s(Ue,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),Ue.forEach(t),Re.forEach(t),V.forEach(t)},m(q,z){g(q,l,z),e(l,v),g(q,p,z),g(q,u,z),e(u,b),e(b,i),e(u,f),e(u,D),e(D,Pe),g(q,pe,z),g(q,F,z),e(F,Z),e(F,H),e(H,ee),e(F,Ne),e(F,W),e(W,Ie),e(F,qe),g(q,I,z),g(q,R,z),e(R,te),g(q,be,z),g(q,O,z),e(O,j),e(j,ue),e(j,oe),e(oe,$e),e(j,me),e(j,U),e(U,Ge),e(O,De),e(O,C),e(C,Be),e(C,K),e(K,M),e(C,S),e(C,G),e(G,Qe),e(O,He),e(O,P),e(P,We),e(P,ne),e(ne,Te)},d(q){q&&t(l),q&&t(p),q&&t(u),q&&t(pe),q&&t(F),q&&t(I),q&&t(R),q&&t(be),q&&t(O)}}}function pm($){let l,v,p,u,b;return{c(){l=a("p"),v=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),p=a("code"),u=n("Module"),b=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(i){l=r(i,"P",{});var f=d(l);v=s(f,"Although the recipe for forward pass needs to be defined within this function, one should call the "),p=r(f,"CODE",{});var D=d(p);u=s(D,"Module"),D.forEach(t),b=s(f,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),f.forEach(t)},m(i,f){g(i,l,f),e(l,v),e(l,p),e(p,u),e(l,b)},d(i){i&&t(l)}}}function um($){let l,v,p,u,b;return u=new Ae({props:{code:`from transformers import LEDTokenizer, TFLEDForConditionalGeneration
import tensorflow as tf
...
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-comment"># probs[5] is associated with the mask token</span>`}}),{c(){l=a("p"),v=n("Examples:"),p=c(),T(u.$$.fragment)},l(i){l=r(i,"P",{});var f=d(l);v=s(f,"Examples:"),f.forEach(t),p=h(i),k(u.$$.fragment,i)},m(i,f){g(i,l,f),e(l,v),g(i,p,f),w(u,i,f),b=!0},p:je,i(i){b||(y(u.$$.fragment,i),b=!0)},o(i){E(u.$$.fragment,i),b=!1},d(i){i&&t(l),i&&t(p),L(u,i)}}}function mm($){let l,v,p,u,b,i,f,D,Pe,pe,F,Z,H,ee,Ne,W,Ie,qe,I,R,te,be,O,j,ue,oe,$e,me,U,Ge,De,C,Be,K,M,S,G,Qe,He,P,We,ne,Te,q,z,se,nt,st,N,at,rt,Fe,V,ae,ze,dt,re,it,de,Re,Ue,rd,dd,qs,id,ld,cd,ke,hd,$s,pd,ud,Ds,md,fd,Qn,_d,gd,Fs,vd,bd,Td,X,kd,zs,wd,yd,xs,Ed,Ld,Hn,qd,$d,Ms,Dd,Fd,Ss,zd,xd,Os,Md,Sd,Od,Ve,Cd,Cs,jd,Ad,js,Pd,Nd,As,Id,Gd,Bd,$o,Qd,Do,Hd,Wd,Rd,Fo,Ud,zo,Vd,Xd,Wa,jt,Jd,xo,Zd,Kd,Ra,lt,At,Ps,Mo,Yd,Ns,ei,Ua,we,So,ti,ct,oi,Wn,ni,si,Oo,ai,ri,di,ht,ii,Rn,li,ci,Un,hi,pi,ui,Pt,Va,pt,Nt,Is,Co,mi,Gs,fi,Xa,A,jo,_i,Bs,gi,vi,It,Vn,bi,Ti,Xn,ki,wi,yi,Ao,Ei,Jn,Li,qi,$i,Xe,Po,Di,Qs,Fi,zi,No,Zn,xi,Hs,Mi,Si,Kn,Oi,Ws,Ci,ji,Gt,Io,Ai,Go,Pi,Rs,Ni,Ii,Gi,Bt,Bo,Bi,Us,Qi,Hi,Yn,Qo,Ja,ut,Qt,Vs,Ho,Wi,Xs,Ri,Za,ye,Wo,Ui,Ro,Vi,Js,Xi,Ji,Zi,Ht,es,Ki,Yi,ts,el,tl,ol,Uo,nl,os,sl,al,Ka,mt,Wt,Zs,Vo,rl,Ks,dl,Ya,ft,Xo,il,Ys,ll,er,_t,Jo,cl,ea,hl,tr,gt,Zo,pl,ta,ul,or,vt,Ko,ml,oa,fl,nr,bt,Yo,_l,na,gl,sr,Tt,en,vl,sa,bl,ar,kt,tn,Tl,aa,kl,rr,wt,on,wl,ra,yl,dr,yt,Rt,da,nn,El,ia,Ll,ir,Ee,sn,ql,an,$l,ns,Dl,Fl,zl,rn,xl,dn,Ml,Sl,Ol,xe,ln,Cl,Et,jl,ss,Al,Pl,la,Nl,Il,Gl,Ut,Bl,Vt,lr,Lt,Xt,ca,cn,Ql,ha,Hl,cr,Le,hn,Wl,pn,Rl,as,Ul,Vl,Xl,un,Jl,mn,Zl,Kl,Yl,fe,fn,ec,qt,tc,rs,oc,nc,pa,sc,ac,rc,Jt,dc,Zt,ic,Kt,hr,$t,Yt,ua,_n,lc,ma,cc,pr,ie,gn,hc,fa,pc,uc,vn,mc,ds,fc,_c,gc,bn,vc,Tn,bc,Tc,kc,B,kn,wc,Dt,yc,is,Ec,Lc,_a,qc,$c,Dc,eo,Fc,to,zc,oo,xc,no,Mc,so,ur,Ft,ao,ga,wn,Sc,va,Oc,mr,le,yn,Cc,zt,jc,ba,Ac,Pc,Ta,Nc,Ic,Gc,En,Bc,ls,Qc,Hc,Wc,Ln,Rc,qn,Uc,Vc,Xc,_e,$n,Jc,xt,Zc,cs,Kc,Yc,ka,eh,th,oh,ro,nh,io,sh,lo,fr,Mt,co,wa,Dn,ah,ya,rh,_r,ce,Fn,dh,zn,ih,hs,lh,ch,hh,xn,ph,Mn,uh,mh,fh,ho,_h,Me,Sn,gh,St,vh,ps,bh,Th,Ea,kh,wh,yh,po,Eh,uo,gr,Ot,mo,La,On,Lh,qa,qh,vr,he,Cn,$h,jn,Dh,us,Fh,zh,xh,An,Mh,Pn,Sh,Oh,Ch,fo,jh,Se,Nn,Ah,Ct,Ph,ms,Nh,Ih,$a,Gh,Bh,Qh,_o,Hh,go,br;return i=new Oe({}),ee=new Oe({}),Mo=new Oe({}),So=new x({props:{name:"class transformers.LEDConfig",anchor:"transformers.LEDConfig",parameters:[{name:"vocab_size",val:" = 50265"},{name:"max_encoder_position_embeddings",val:" = 16384"},{name:"max_decoder_position_embeddings",val:" = 1024"},{name:"encoder_layers",val:" = 12"},{name:"encoder_ffn_dim",val:" = 4096"},{name:"encoder_attention_heads",val:" = 16"},{name:"decoder_layers",val:" = 12"},{name:"decoder_ffn_dim",val:" = 4096"},{name:"decoder_attention_heads",val:" = 16"},{name:"encoder_layerdrop",val:" = 0.0"},{name:"decoder_layerdrop",val:" = 0.0"},{name:"use_cache",val:" = True"},{name:"is_encoder_decoder",val:" = True"},{name:"activation_function",val:" = 'gelu'"},{name:"d_model",val:" = 1024"},{name:"dropout",val:" = 0.1"},{name:"attention_dropout",val:" = 0.0"},{name:"activation_dropout",val:" = 0.0"},{name:"init_std",val:" = 0.02"},{name:"decoder_start_token_id",val:" = 2"},{name:"classifier_dropout",val:" = 0.0"},{name:"pad_token_id",val:" = 1"},{name:"bos_token_id",val:" = 0"},{name:"eos_token_id",val:" = 2"},{name:"attention_window",val:": typing.Union[typing.List[int], int] = 512"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.LEDConfig.vocab_size",description:`<strong>vocab_size</strong> (<code>int</code>, <em>optional</em>, defaults to 50265) &#x2014;
...
Whether or not the model should return the last key/values attentions (not used by all models)`,name:"use_cache"}],source:"https://github.com/huggingface/transformers/blob/v4.21.0/src/transformers/models/led/configuration_led.py#L31"}}),Pt=new Ce({props:{anchor:"transformers.LEDConfig.example",$$slots:{default:[Vu]},$$scope:{ctx:$}}}),Co=new Oe({}),jo=new x({props:{name:"class transformers.LEDTokenizer",anchor:"transformers.LEDTokenizer",parameters:[{name:"vocab_file",val:""},{name:"merges_file",val:""},{name:"errors",val:" = 'replace'"},{name:"bos_token",val:" = '<s>'"},{name:"eos_token",val:" = '</s>'"},{name:"sep_token",val:" = '</s>'"},{name:"cls_token",val:" = '<s>'"},{name:"unk_token",val:" = '<unk>'"},{name:"pad_token",val:" = '<pad>'"},{name:"mask_token",val:" = '<mask>'"},{name:"add_prefix_space",val:" = False"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/v4.21.0/src/transformers/models/led/tokenization_led.py#L43"}}),Po=new x({props:{name:"build_inputs_with_special_tokens",anchor:"transformers.LEDTokenizer.build_inputs_with_special_tokens",parameters:[{name:"token_ids_0",val:": typing.List[int]"},{name:"token_ids_1",val:": typing.Optional[typing.List[int]] = None"}],parametersDescription:[{anchor:"transformers.LEDTokenizer.build_inputs_with_special_tokens.token_ids_0",description:`<strong>token_ids_0</strong> (<code>List[int]</code>) &#x2014;
...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/v4.21.0/src/transformers/models/bart/tokenization_bart.py#L338",returnDescription:`
...
Whether or not the token list is already formatted with special tokens for the model.`,name:"already_has_special_tokens"}],source:"https://github.com/huggingface/transformers/blob/v4.21.0/src/transformers/models/bart/tokenization_bart.py#L363",returnDescription:`
...
<p>Global attentions weights after the attention softmax, used to compute the weighted average in the
self-attention heads. Those are the attention weights from every token with global attention to every token
in the sequence.`,name:"encoder_global_attentions"}],source:"https://github.com/huggingface/transformers/blob/v4.21.0/src/transformers/models/led/modeling_tf_led.py#L1411"}}),on=new x({props:{name:"class transformers.models.led.modeling_tf_led.TFLEDSeq2SeqLMOutput",anchor:"transformers.models.led.modeling_tf_led.TFLEDSeq2SeqLMOutput",parameters:[{name:"loss",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"logits",val:": Tensor = None"},{name:"past_key_values",val:": typing.Optional[typing.List[tensorflow.python.framework.ops.Tensor]] = None"},{name:"decoder_hidden_states",val:": typing.Optional[typing.Tuple[tensorflow.python.framework.ops.Tensor]] = None"},{name:"decoder_attentions",val:": typing.Optional[typing.Tuple[tensorflow.python.framework.ops.Tensor]] = None"},{name:"cross_attentions",val:": typing.Optional[typing.Tuple[tensorflow.python.framework.ops.Tensor]] = None"},{name:"encoder_last_hidden_state",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"encoder_hidden_states",val:": typing.Optional[typing.Tuple[tensorflow.python.framework.ops.Tensor]] = None"},{name:"encoder_attentions",val:": typing.Optional[typing.Tuple[tensorflow.python.framework.ops.Tensor]] = None"},{name:"encoder_global_attentions",val:": typing.Optional[typing.Tuple[tensorflow.python.framework.ops.Tensor]] = None"}],parametersDescription:[{anchor:"transformers.models.led.modeling_tf_led.TFLEDSeq2SeqLMOutput.loss",description:`<strong>loss</strong> (<code>tf.Tensor</code> of shape <code>(1,)</code>, <em>optional</em>, returned when <code>labels</code> is provided) &#x2014;
...
<p>Indices can be obtained using <code>LedTokenizer</code>. See <a href="/docs/transformers/v4.21.0/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/v4.21.0/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
Whether or not to return a <a href="/docs/transformers/v4.21.0/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/v4.21.0/src/transformers/models/led/modeling_led.py#L2201",returnDescription:`
<p>A <a
  href="/docs/transformers/v4.21.0/en/main_classes/output#transformers.modeling_outputs.Seq2SeqModelOutput"
>transformers.modeling_outputs.Seq2SeqModelOutput</a> or a tuple of
<code>torch.FloatTensor</code> (if <code>return_dict=False</code> is passed or when <code>config.return_dict=False</code>) comprising various
elements depending on the configuration (<a
  href="/docs/transformers/v4.21.0/en/model_doc/led#transformers.LEDConfig"
...
(masked), the loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.21.0/src/transformers/models/led/modeling_led.py#L2341",returnDescription:`
<p>A <a
  href="/docs/transformers/v4.21.0/en/main_classes/output#transformers.modeling_outputs.Seq2SeqLMOutput"
...
Labels for computing the sequence classification/regression loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>. If <code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.21.0/src/transformers/models/led/modeling_led.py#L2503",returnDescription:`
<p>A <a
  href="/docs/transformers/v4.21.0/en/main_classes/output#transformers.modeling_outputs.Seq2SeqSequenceClassifierOutput"
...
Positions are clamped to the length of the sequence (<em>sequence_length</em>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/v4.21.0/src/transformers/models/led/modeling_led.py#L2630",returnDescription:`
<p>A <a
  href="/docs/transformers/v4.21.0/en/main_classes/output#transformers.modeling_outputs.Seq2SeqQuestionAnsweringModelOutput"
...
behaviors between training and evaluation).`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/v4.21.0/src/transformers/models/led/modeling_tf_led.py#L2247",returnDescription:`
<p>A <a
  href="/docs/transformers/v4.21.0/en/model_doc/led#transformers.models.led.modeling_tf_led.TFLEDSeq2SeqModelOutput"
...
Whether or not to use the model in training mode (some modules like dropout modules have different
behaviors between training and evaluation).`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/v4.21.0/src/transformers/models/led/modeling_tf_led.py#L2358",returnDescription:`
<p>A <a
  href="/docs/transformers/v4.21.0/en/model_doc/led#transformers.models.led.modeling_tf_led.TFLEDSeq2SeqLMOutput"
...
`}}),_o=new qo({props:{$$slots:{default:[pm]},$$scope:{ctx:$}}}),go=new Ce({props:{anchor:"transformers.TFLEDForConditionalGeneration.call.example",$$slots:{default:[um]},$$scope:{ctx:$}}}),{c(){l=a("meta"),v=c(),p=a("h1"),u=a("a"),b=a("span"),T(i.$$.fragment),f=c(),D=a("span"),Pe=n("LED"),pe=c(),F=a("h2"),Z=a("a"),H=a("span"),T(ee.$$.fragment),Ne=c(),W=a("span"),Ie=n("Overview"),qe=c(),I=a("p"),R=n("The LED model was proposed in "),te=a("a"),be=n("Longformer: The Long-Document Transformer"),O=n(` by Iz
...
`),P=a("a"),We=n("BartForConditionalGeneration"),ne=n(" exchanging the traditional "),Te=a("em"),q=n("self-attention"),z=n(` layer with
...
gained, when `),Qn=a("a"),_d=n("LEDTokenizer"),gd=n(" is used with the "),Fs=a("code"),vd=n("pad_to_multiple_of"),bd=n(" argument."),Td=c(),X=a("li"),kd=n("LED makes use of "),zs=a("em"),wd=n("global attention"),yd=n(" by means of the "),xs=a("code"),Ed=n("global_attention_mask"),Ld=n(` (see
...
documentation from `),Un=a("a"),hi=n("PretrainedConfig"),pi=n(" for more information."),ui=c(),T(Pt.$$.fragment),Va=c(),pt=a("h2"),Nt=a("a"),Is=a("span"),T(Co.$$.fragment),mi=c(),Gs=a("span"),fi=n("LEDTokenizer"),Xa=c(),A=a("div"),T(jo.$$.fragment),_i=c(),Bs=a("p"),gi=n("Construct a LED tokenizer."),vi=c(),It=a("p"),Vn=a("a"),bi=n("LEDTokenizer"),Ti=n(" is identical to "),Xn=a("a"),ki=n("BartTokenizer"),wi=n(` and runs end-to-end tokenization: punctuation splitting and
wordpiece.`),yi=c(),Ao=a("p"),Ei=n("Refer to superclass "),Jn=a("a"),Li=n("BartTokenizer"),qi=n(" for usage examples and documentation concerning parameters."),$i=c(),Xe=a("div"),T(Po.$$.fragment),Di=c(),Qs=a("p"),Fi=n(`Build model inputs from a sequence or a pair of sequence for sequence classification tasks by concatenating and
adding special tokens. A BART sequence has the following format:`),zi=c(),No=a("ul"),Zn=a("li"),xi=n("single sequence: "),Hs=a("code"),Mi=n("<s> X </s>"),Si=c(),Kn=a("li"),Oi=n("pair of sequences: "),Ws=a("code"),Ci=n("<s> A </s></s> B </s>"),ji=c(),Gt=a("div"),T(Io.$$.fragment),Ai=c(),Go=a("p"),Pi=n(`Retrieve sequence ids from a token list that has no special tokens added. This method is called when adding
special tokens using the tokenizer `),Rs=a("code"),Ni=n("prepare_for_model"),Ii=n(" method."),Gi=c(),Bt=a("div"),T(Bo.$$.fragment),Bi=c(),Us=a("p"),Qi=n(`Create a mask from the two sequences passed to be used in a sequence-pair classification task. BART does not
make use of token type ids, therefore a list of zeros is returned.`),Hi=c(),Yn=a("div"),T(Qo.$$.fragment),Ja=c(),ut=a("h2"),Qt=a("a"),Vs=a("span"),T(Ho.$$.fragment),Wi=c(),Xs=a("span"),Ri=n("LEDTokenizerFast"),Za=c(),ye=a("div"),T(Wo.$$.fragment),Ui=c(),Ro=a("p"),Vi=n("Construct a \u201Cfast\u201D LED tokenizer (backed by HuggingFace\u2019s "),Js=a("em"),Xi=n("tokenizers"),Ji=n(" library)."),Zi=c(),Ht=a("p"),es=a("a"),Ki=n("LEDTokenizerFast"),Yi=n(" is identical to "),ts=a("a"),el=n("BartTokenizerFast"),tl=n(` and runs end-to-end tokenization: punctuation splitting
and wordpiece.`),ol=c(),Uo=a("p"),nl=n("Refer to superclass "),os=a("a"),sl=n("BartTokenizerFast"),al=n(" for usage examples and documentation concerning parameters."),Ka=c(),mt=a("h2"),Wt=a("a"),Zs=a("span"),T(Vo.$$.fragment),rl=c(),Ks=a("span"),dl=n("LED specific outputs"),Ya=c(),ft=a("div"),T(Xo.$$.fragment),il=c(),Ys=a("p"),ll=n("Base class for LEDEncoder\u2019s outputs, with potential hidden states, local and global attentions."),er=c(),_t=a("div"),T(Jo.$$.fragment),cl=c(),ea=a("p"),hl=n(`Base class for model encoder\u2019s outputs that also contains : pre-computed hidden states that can speed up sequential
decoding.`),tr=c(),gt=a("div"),T(Zo.$$.fragment),pl=c(),ta=a("p"),ul=n("Base class for sequence-to-sequence language models outputs."),or=c(),vt=a("div"),T(Ko.$$.fragment),ml=c(),oa=a("p"),fl=n("Base class for outputs of sequence-to-sequence sentence classification models."),nr=c(),bt=a("div"),T(Yo.$$.fragment),_l=c(),na=a("p"),gl=n("Base class for outputs of sequence-to-sequence question answering models."),sr=c(),Tt=a("div"),T(en.$$.fragment),vl=c(),sa=a("p"),bl=n("Base class for Longformer\u2019s outputs, with potential hidden states, local and global attentions."),ar=c(),kt=a("div"),T(tn.$$.fragment),Tl=c(),aa=a("p"),kl=n(`Base class for model encoder\u2019s outputs that also contains : pre-computed hidden states that can speed up sequential
decoding.`),rr=c(),wt=a("div"),T(on.$$.fragment),wl=c(),ra=a("p"),yl=n("Base class for sequence-to-sequence language models outputs."),dr=c(),yt=a("h2"),Rt=a("a"),da=a("span"),T(nn.$$.fragment),El=c(),ia=a("span"),Ll=n("LEDModel"),ir=c(),Ee=a("div"),T(sn.$$.fragment),ql=c(),an=a("p"),$l=n(`The bare LED Model outputting raw hidden-states without any specific head on top.
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for general usage and behavior.`),Ol=c(),xe=a("div"),T(ln.$$.fragment),Cl=c(),Et=a("p"),jl=n("The "),ss=a("a"),Al=n("LEDModel"),Pl=n(" forward method, overrides the "),la=a("code"),Nl=n("__call__"),Il=n(" special method."),Gl=c(),T(Ut.$$.fragment),Bl=c(),T(Vt.$$.fragment),lr=c(),Lt=a("h2"),Xt=a("a"),ca=a("span"),T(cn.$$.fragment),Ql=c(),ha=a("span"),Hl=n("LEDForConditionalGeneration"),cr=c(),Le=a("div"),T(hn.$$.fragment),Wl=c(),pn=a("p"),Rl=n(`The LED Model with a language modeling head. Can be used for summarization.
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for general usage and behavior.`),Yl=c(),fe=a("div"),T(fn.$$.fragment),ec=c(),qt=a("p"),tc=n("The "),rs=a("a"),oc=n("LEDForConditionalGeneration"),nc=n(" forward method, overrides the "),pa=a("code"),sc=n("__call__"),ac=n(" special method."),rc=c(),T(Jt.$$.fragment),dc=c(),T(Zt.$$.fragment),ic=c(),T(Kt.$$.fragment),hr=c(),$t=a("h2"),Yt=a("a"),ua=a("span"),T(_n.$$.fragment),lc=c(),ma=a("span"),cc=n("LEDForSequenceClassification"),pr=c(),ie=a("div"),T(gn.$$.fragment),hc=c(),fa=a("p"),pc=n(`LED model with a sequence classification/head on top (a linear layer on top of the pooled output) e.g. for GLUE
tasks.`),uc=c(),vn=a("p"),mc=n("This model inherits from "),ds=a("a"),fc=n("PreTrainedModel"),_c=n(`. See the superclass documentation for the generic methods the library
implements for all its models (such as downloading or saving, resizing the input embeddings, pruning heads etc.)`),gc=c(),bn=a("p"),vc=n("This model is also a PyTorch "),Tn=a("a"),bc=n("torch.nn.Module"),Tc=n(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for general usage and behavior.`),kc=c(),B=a("div"),T(kn.$$.fragment),wc=c(),Dt=a("p"),yc=n("The "),is=a("a"),Ec=n("LEDForSequenceClassification"),Lc=n(" forward method, overrides the "),_a=a("code"),qc=n("__call__"),$c=n(" special method."),Dc=c(),T(eo.$$.fragment),Fc=c(),T(to.$$.fragment),zc=c(),T(oo.$$.fragment),xc=c(),T(no.$$.fragment),Mc=c(),T(so.$$.fragment),ur=c(),Ft=a("h2"),ao=a("a"),ga=a("span"),T(wn.$$.fragment),Sc=c(),va=a("span"),Oc=n("LEDForQuestionAnswering"),mr=c(),le=a("div"),T(yn.$$.fragment),Cc=c(),zt=a("p"),jc=n(`LED Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear layer
on top of the hidden-states output to compute `),ba=a("code"),Ac=n("span start logits"),Pc=n(" and "),Ta=a("code"),Nc=n("span end logits"),Ic=n(")."),Gc=c(),En=a("p"),Bc=n("This model inherits from "),ls=a("a"),Qc=n("PreTrainedModel"),Hc=n(`. See the superclass documentation for the generic methods the library
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for general usage and behavior.`),Xc=c(),_e=a("div"),T($n.$$.fragment),Jc=c(),xt=a("p"),Zc=n("The "),cs=a("a"),Kc=n("LEDForQuestionAnswering"),Yc=n(" forward method, overrides the "),ka=a("code"),eh=n("__call__"),th=n(" special method."),oh=c(),T(ro.$$.fragment),nh=c(),T(io.$$.fragment),sh=c(),T(lo.$$.fragment),fr=c(),Mt=a("h2"),co=a("a"),wa=a("span"),T(Dn.$$.fragment),ah=c(),ya=a("span"),rh=n("TFLEDModel"),_r=c(),ce=a("div"),T(Fn.$$.fragment),dh=c(),zn=a("p"),ih=n(`The bare LED Model outputting raw hidden-states without any specific head on top.
...
behavior.`),fh=c(),T(ho.$$.fragment),_h=c(),Me=a("div"),T(Sn.$$.fragment),gh=c(),St=a("p"),vh=n("The "),ps=a("a"),bh=n("TFLEDModel"),Th=n(" forward method, overrides the "),Ea=a("code"),kh=n("__call__"),wh=n(" special method."),yh=c(),T(po.$$.fragment),Eh=c(),T(uo.$$.fragment),gr=c(),Ot=a("h2"),mo=a("a"),La=a("span"),T(On.$$.fragment),Lh=c(),qa=a("span"),qh=n("TFLEDForConditionalGeneration"),vr=c(),he=a("div"),T(Cn.$$.fragment),$h=c(),jn=a("p"),Dh=n(`The LED Model with a language modeling head. Can be used for summarization.
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Ch=c(),T(fo.$$.fragment),jh=c(),Se=a("div"),T(Nn.$$.fragment),Ah=c(),Ct=a("p"),Ph=n("The "),ms=a("a"),Nh=n("TFLEDForConditionalGeneration"),Ih=n(" forward method, overrides the "),$a=a("code"),Gh=n("__call__"),Bh=n(" special method."),Qh=c(),T(_o.$$.fragment),Hh=c(),T(go.$$.fragment),this.h()},l(o){const _=Ru('[data-svelte="svelte-1phssyn"]',document.head);l=r(_,"META",{name:!0,content:!0}),_.forEach(t),v=h(o),p=r(o,"H1",{class:!0});var In=d(p);u=r(In,"A",{id:!0,class:!0,href:!0});var Da=d(u);b=r(Da,"SPAN",{});var Fa=d(b);k(i.$$.fragment,Fa),Fa.forEach(t),Da.forEach(t),f=h(In),D=r(In,"SPAN",{});var za=d(D);Pe=s(za,"LED"),za.forEach(t),In.forEach(t),pe=h(o),F=r(o,"H2",{class:!0});var Gn=d(F);Z=r(Gn,"A",{id:!0,class:!0,href:!0});var xa=d(Z);H=r(xa,"SPAN",{});var Ma=d(H);k(ee.$$.fragment,Ma),Ma.forEach(t),xa.forEach(t),Ne=h(Gn),W=r(Gn,"SPAN",{});var Sa=d(W);Ie=s(Sa,"Overview"),Sa.forEach(t),Gn.forEach(t),qe=h(o),I=r(o,"P",{});var Bn=d(I);R=s(Bn,"The LED model was proposed in "),te=r(Bn,"A",{href:!0,rel:!0});var Oa=d(te);be=s(Oa,"Longformer: The Long-Document Transformer"),Oa.forEach(t),O=s(Bn,` by Iz
...
`),P=r(Q,"A",{href:!0});var Ia=d(P);We=s(Ia,"BartForConditionalGeneration"),Ia.forEach(t),ne=s(Q," exchanging the traditional "),Te=r(Q,"EM",{});var Ga=d(Te);q=s(Ga,"self-attention"),Ga.forEach(t),z=s(Q,` layer with
...
`),Ss=r(ge,"CODE",{});var rp=d(Ss);zd=s(rp,"<s>"),rp.forEach(t),xd=s(ge," token. For question answering, it is advised to put "),Os=r(ge,"EM",{});var dp=d(Os);Md=s(dp,"global attention"),dp.forEach(t),Sd=s(ge," on all tokens of the question."),ge.forEach(t),Od=h(J),Ve=r(J,"LI",{});var vo=d(Ve);Cd=s(vo,"To fine-tune LED on all 16384, "),Cs=r(vo,"EM",{});var ip=d(Cs);jd=s(ip,"gradient checkpointing"),ip.forEach(t),Ad=s(vo,` can be enabled in case training leads to out-of-memory (OOM)
errors. This can be done by executing `),js=r(vo,"CODE",{});var lp=d(js);Pd=s(lp,"model.gradient_checkpointing_enable()"),lp.forEach(t),Nd=s(vo,`.
Moreover, the `),As=r(vo,"CODE",{});var cp=d(As);Id=s(cp,"use_cache=False"),cp.forEach(t),Gd=s(vo,`
flag can be used to disable the caching mechanism to save memory.`),vo.forEach(t),Bd=h(J),$o=r(J,"LI",{});var Tr=d($o);Qd=s(Tr,"A notebook showing how to evaluate LED, can be accessed "),Do=r(Tr,"A",{href:!0,rel:!0});var hp=d(Do);Hd=s(hp,"here"),hp.forEach(t),Wd=s(Tr,"."),Tr.forEach(t),Rd=h(J),Fo=r(J,"LI",{});var kr=d(Fo);Ud=s(kr,"A notebook showing how to fine-tune LED, can be accessed "),zo=r(kr,"A",{href:!0,rel:!0});var pp=d(zo);Vd=s(pp,"here"),pp.forEach(t),Xd=s(kr,"."),kr.forEach(t),J.forEach(t),Wa=h(o),jt=r(o,"P",{});var wr=d(jt);Jd=s(wr,"This model was contributed by "),xo=r(wr,"A",{href:!0,rel:!0});var up=d(xo);Zd=s(up,"patrickvonplaten"),up.forEach(t),Kd=s(wr,"."),wr.forEach(t),Ra=h(o),lt=r(o,"H2",{class:!0});var yr=d(lt);At=r(yr,"A",{id:!0,class:!0,href:!0});var mp=d(At);Ps=r(mp,"SPAN",{});var fp=d(Ps);k(Mo.$$.fragment,fp),fp.forEach(t),mp.forEach(t),Yd=h(yr),Ns=r(yr,"SPAN",{});var _p=d(Ns);ei=s(_p,"LEDConfig"),_p.forEach(t),yr.forEach(t),Ua=h(o),we=r(o,"DIV",{class:!0});var bo=d(we);k(So.$$.fragment,bo),ti=h(bo),ct=r(bo,"P",{});var _s=d(ct);oi=s(_s,"This is the configuration class to store the configuration of a "),Wn=r(_s,"A",{href:!0});var gp=d(Wn);ni=s(gp,"LEDModel"),gp.forEach(t),si=s(_s,`. It is used to instantiate an LED
model according to the specified arguments, defining the model architecture. Instantiating a configuration with the
defaults will yield a similar configuration to that of the LED
`),Oo=r(_s,"A",{href:!0,rel:!0});var vp=d(Oo);ai=s(vp,"allenai/led-base-16384"),vp.forEach(t),ri=s(_s," architecture."),_s.forEach(t),di=h(bo),ht=r(bo,"P",{});var gs=d(ht);ii=s(gs,"Configuration objects inherit from "),Rn=r(gs,"A",{href:!0});var bp=d(Rn);li=s(bp,"PretrainedConfig"),bp.forEach(t),ci=s(gs,` and can be used to control the model outputs. Read the
documentation from `),Un=r(gs,"A",{href:!0});var Tp=d(Un);hi=s(Tp,"PretrainedConfig"),Tp.forEach(t),pi=s(gs," for more information."),gs.forEach(t),ui=h(bo),k(Pt.$$.fragment,bo),bo.forEach(t),Va=h(o),pt=r(o,"H2",{class:!0});var Er=d(pt);Nt=r(Er,"A",{id:!0,class:!0,href:!0});var kp=d(Nt);Is=r(kp,"SPAN",{});var wp=d(Is);k(Co.$$.fragment,wp),wp.forEach(t),kp.forEach(t),mi=h(Er),Gs=r(Er,"SPAN",{});var yp=d(Gs);fi=s(yp,"LEDTokenizer"),yp.forEach(t),Er.forEach(t),Xa=h(o),A=r(o,"DIV",{class:!0});var Y=d(A);k(jo.$$.fragment,Y),_i=h(Y),Bs=r(Y,"P",{});var Ep=d(Bs);gi=s(Ep,"Construct a LED tokenizer."),Ep.forEach(t),vi=h(Y),It=r(Y,"P",{});var Qa=d(It);Vn=r(Qa,"A",{href:!0});var Lp=d(Vn);bi=s(Lp,"LEDTokenizer"),Lp.forEach(t),Ti=s(Qa," is identical to "),Xn=r(Qa,"A",{href:!0});var qp=d(Xn);ki=s(qp,"BartTokenizer"),qp.forEach(t),wi=s(Qa,` and runs end-to-end tokenization: punctuation splitting and
wordpiece.`),Qa.forEach(t),yi=h(Y),Ao=r(Y,"P",{});var Lr=d(Ao);Ei=s(Lr,"Refer to superclass "),Jn=r(Lr,"A",{href:!0});var $p=d(Jn);Li=s($p,"BartTokenizer"),$p.forEach(t),qi=s(Lr," for usage examples and documentation concerning parameters."),Lr.forEach(t),$i=h(Y),Xe=r(Y,"DIV",{class:!0});var vs=d(Xe);k(Po.$$.fragment,vs),Di=h(vs),Qs=r(vs,"P",{});var Dp=d(Qs);Fi=s(Dp,`Build model inputs from a sequence or a pair of sequence for sequence classification tasks by concatenating and
adding special tokens. A BART sequence has the following format:`),Dp.forEach(t),zi=h(vs),No=r(vs,"UL",{});var qr=d(No);Zn=r(qr,"LI",{});var Wh=d(Zn);xi=s(Wh,"single sequence: "),Hs=r(Wh,"CODE",{});var Fp=d(Hs);Mi=s(Fp,"<s> X </s>"),Fp.forEach(t),Wh.forEach(t),Si=h(qr),Kn=r(qr,"LI",{});var Rh=d(Kn);Oi=s(Rh,"pair of sequences: "),Ws=r(Rh,"CODE",{});var zp=d(Ws);Ci=s(zp,"<s> A </s></s> B </s>"),zp.forEach(t),Rh.forEach(t),qr.forEach(t),vs.forEach(t),ji=h(Y),Gt=r(Y,"DIV",{class:!0});var $r=d(Gt);k(Io.$$.fragment,$r),Ai=h($r),Go=r($r,"P",{});var Dr=d(Go);Pi=s(Dr,`Retrieve sequence ids from a token list that has no special tokens added. This method is called when adding
...
make use of token type ids, therefore a list of zeros is returned.`),Mp.forEach(t),Fr.forEach(t),Hi=h(Y),Yn=r(Y,"DIV",{class:!0});var Sp=d(Yn);k(Qo.$$.fragment,Sp),Sp.forEach(t),Y.forEach(t),Ja=h(o),ut=r(o,"H2",{class:!0});var zr=d(ut);Qt=r(zr,"A",{id:!0,class:!0,href:!0});var Op=d(Qt);Vs=r(Op,"SPAN",{});var Cp=d(Vs);k(Ho.$$.fragment,Cp),Cp.forEach(t),Op.forEach(t),Wi=h(zr),Xs=r(zr,"SPAN",{});var jp=d(Xs);Ri=s(jp,"LEDTokenizerFast"),jp.forEach(t),zr.forEach(t),Za=h(o),ye=r(o,"DIV",{class:!0});var To=d(ye);k(Wo.$$.fragment,To),Ui=h(To),Ro=r(To,"P",{});var xr=d(Ro);Vi=s(xr,"Construct a \u201Cfast\u201D LED tokenizer (backed by HuggingFace\u2019s "),Js=r(xr,"EM",{});var Ap=d(Js);Xi=s(Ap,"tokenizers"),Ap.forEach(t),Ji=s(xr," library)."),xr.forEach(t),Zi=h(To),Ht=r(To,"P",{});var Ha=d(Ht);es=r(Ha,"A",{href:!0});var Pp=d(es);Ki=s(Pp,"LEDTokenizerFast"),Pp.forEach(t),Yi=s(Ha," is identical to "),ts=r(Ha,"A",{href:!0});var Np=d(ts);el=s(Np,"BartTokenizerFast"),Np.forEach(t),tl=s(Ha,` and runs end-to-end tokenization: punctuation splitting
and wordpiece.`),Ha.forEach(t),ol=h(To),Uo=r(To,"P",{});var Mr=d(Uo);nl=s(Mr,"Refer to superclass "),os=r(Mr,"A",{href:!0});var Ip=d(os);sl=s(Ip,"BartTokenizerFast"),Ip.forEach(t),al=s(Mr," for usage examples and documentation concerning parameters."),Mr.forEach(t),To.forEach(t),Ka=h(o),mt=r(o,"H2",{class:!0});var Sr=d(mt);Wt=r(Sr,"A",{id:!0,class:!0,href:!0});var Gp=d(Wt);Zs=r(Gp,"SPAN",{});var Bp=d(Zs);k(Vo.$$.fragment,Bp),Bp.forEach(t),Gp.forEach(t),rl=h(Sr),Ks=r(Sr,"SPAN",{});var Qp=d(Ks);dl=s(Qp,"LED specific outputs"),Qp.forEach(t),Sr.forEach(t),Ya=h(o),ft=r(o,"DIV",{class:!0});var Or=d(ft);k(Xo.$$.fragment,Or),il=h(Or),Ys=r(Or,"P",{});var Hp=d(Ys);ll=s(Hp,"Base class for LEDEncoder\u2019s outputs, with potential hidden states, local and global attentions."),Hp.forEach(t),Or.forEach(t),er=h(o),_t=r(o,"DIV",{class:!0});var Cr=d(_t);k(Jo.$$.fragment,Cr),cl=h(Cr),ea=r(Cr,"P",{});var Wp=d(ea);hl=s(Wp,`Base class for model encoder\u2019s outputs that also contains : pre-computed hidden states that can speed up sequential
decoding.`),Wp.forEach(t),Cr.forEach(t),tr=h(o),gt=r(o,"DIV",{class:!0});var jr=d(gt);k(Zo.$$.fragment,jr),pl=h(jr),ta=r(jr,"P",{});var Rp=d(ta);ul=s(Rp,"Base class for sequence-to-sequence language models outputs."),Rp.forEach(t),jr.forEach(t),or=h(o),vt=r(o,"DIV",{class:!0});var Ar=d(vt);k(Ko.$$.fragment,Ar),ml=h(Ar),oa=r(Ar,"P",{});var Up=d(oa);fl=s(Up,"Base class for outputs of sequence-to-sequence sentence classification models."),Up.forEach(t),Ar.forEach(t),nr=h(o),bt=r(o,"DIV",{class:!0});var Pr=d(bt);k(Yo.$$.fragment,Pr),_l=h(Pr),na=r(Pr,"P",{});var Vp=d(na);gl=s(Vp,"Base class for outputs of sequence-to-sequence question answering models."),Vp.forEach(t),Pr.forEach(t),sr=h(o),Tt=r(o,"DIV",{class:!0});var Nr=d(Tt);k(en.$$.fragment,Nr),vl=h(Nr),sa=r(Nr,"P",{});var Xp=d(sa);bl=s(Xp,"Base class for Longformer\u2019s outputs, with potential hidden states, local and global attentions."),Xp.forEach(t),Nr.forEach(t),ar=h(o),kt=r(o,"DIV",{class:!0});var Ir=d(kt);k(tn.$$.fragment,Ir),Tl=h(Ir),aa=r(Ir,"P",{});var Jp=d(aa);kl=s(Jp,`Base class for model encoder\u2019s outputs that also contains : pre-computed hidden states that can speed up sequential
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for general usage and behavior.`),Ur.forEach(t),Yl=h(yo),fe=r(yo,"DIV",{class:!0});var Ze=d(fe);k(fn.$$.fragment,Ze),ec=h(Ze),qt=r(Ze,"P",{});var Ts=d(qt);tc=s(Ts,"The "),rs=r(Ts,"A",{href:!0});var cu=d(rs);oc=s(cu,"LEDForConditionalGeneration"),cu.forEach(t),nc=s(Ts," forward method, overrides the "),pa=r(Ts,"CODE",{});var hu=d(pa);sc=s(hu,"__call__"),hu.forEach(t),ac=s(Ts," special method."),Ts.forEach(t),rc=h(Ze),k(Jt.$$.fragment,Ze),dc=h(Ze),k(Zt.$$.fragment,Ze),ic=h(Ze),k(Kt.$$.fragment,Ze),Ze.forEach(t),yo.forEach(t),hr=h(o),$t=r(o,"H2",{class:!0});var Vr=d($t);Yt=r(Vr,"A",{id:!0,class:!0,href:!0});var pu=d(Yt);ua=r(pu,"SPAN",{});var uu=d(ua);k(_n.$$.fragment,uu),uu.forEach(t),pu.forEach(t),lc=h(Vr),ma=r(Vr,"SPAN",{});var mu=d(ma);cc=s(mu,"LEDForSequenceClassification"),mu.forEach(t),Vr.forEach(t),pr=h(o),ie=r(o,"DIV",{class:!0});var Ke=d(ie);k(gn.$$.fragment,Ke),hc=h(Ke),fa=r(Ke,"P",{});var fu=d(fa);pc=s(fu,`LED model with a sequence classification/head on top (a linear layer on top of the pooled output) e.g. for GLUE
tasks.`),fu.forEach(t),uc=h(Ke),vn=r(Ke,"P",{});var Xr=d(vn);mc=s(Xr,"This model inherits from "),ds=r(Xr,"A",{href:!0});var _u=d(ds);fc=s(_u,"PreTrainedModel"),_u.forEach(t),_c=s(Xr,`. See the superclass documentation for the generic methods the library
implements for all its models (such as downloading or saving, resizing the input embeddings, pruning heads etc.)`),Xr.forEach(t),gc=h(Ke),bn=r(Ke,"P",{});var Jr=d(bn);vc=s(Jr,"This model is also a PyTorch "),Tn=r(Jr,"A",{href:!0,rel:!0});var gu=d(Tn);bc=s(gu,"torch.nn.Module"),gu.forEach(t),Tc=s(Jr,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for general usage and behavior.`),Jr.forEach(t),kc=h(Ke),B=r(Ke,"DIV",{class:!0});var ve=d(B);k(kn.$$.fragment,ve),wc=h(ve),Dt=r(ve,"P",{});var ks=d(Dt);yc=s(ks,"The "),is=r(ks,"A",{href:!0});var vu=d(is);Ec=s(vu,"LEDForSequenceClassification"),vu.forEach(t),Lc=s(ks," forward method, overrides the "),_a=r(ks,"CODE",{});var bu=d(_a);qc=s(bu,"__call__"),bu.forEach(t),$c=s(ks," special method."),ks.forEach(t),Dc=h(ve),k(eo.$$.fragment,ve),Fc=h(ve),k(to.$$.fragment,ve),zc=h(ve),k(oo.$$.fragment,ve),xc=h(ve),k(no.$$.fragment,ve),Mc=h(ve),k(so.$$.fragment,ve),ve.forEach(t),Ke.forEach(t),ur=h(o),Ft=r(o,"H2",{class:!0});var Zr=d(Ft);ao=r(Zr,"A",{id:!0,class:!0,href:!0});var Tu=d(ao);ga=r(Tu,"SPAN",{});var ku=d(ga);k(wn.$$.fragment,ku),ku.forEach(t),Tu.forEach(t),Sc=h(Zr),va=r(Zr,"SPAN",{});var wu=d(va);Oc=s(wu,"LEDForQuestionAnswering"),wu.forEach(t),Zr.forEach(t),mr=h(o),le=r(o,"DIV",{class:!0});var Ye=d(le);k(yn.$$.fragment,Ye),Cc=h(Ye),zt=r(Ye,"P",{});var ws=d(zt);jc=s(ws,`LED Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear layer
on top of the hidden-states output to compute `),ba=r(ws,"CODE",{});var yu=d(ba);Ac=s(yu,"span start logits"),yu.forEach(t),Pc=s(ws," and "),Ta=r(ws,"CODE",{});var Eu=d(Ta);Nc=s(Eu,"span end logits"),Eu.forEach(t),Ic=s(ws,")."),ws.forEach(t),Gc=h(Ye),En=r(Ye,"P",{});var Kr=d(En);Bc=s(Kr,"This model inherits from "),ls=r(Kr,"A",{href:!0});var Lu=d(ls);Qc=s(Lu,"PreTrainedModel"),Lu.forEach(t),Hc=s(Kr,`. See the superclass documentation for the generic methods the library
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),od.forEach(t),fh=h(tt),k(ho.$$.fragment,tt),_h=h(tt),Me=r(tt,"DIV",{class:!0});var Eo=d(Me);k(Sn.$$.fragment,Eo),gh=h(Eo),St=r(Eo,"P",{});var Es=d(St);vh=s(Es,"The "),ps=r(Es,"A",{href:!0});var Ou=d(ps);bh=s(Ou,"TFLEDModel"),Ou.forEach(t),Th=s(Es," forward method, overrides the "),Ea=r(Es,"CODE",{});var Cu=d(Ea);kh=s(Cu,"__call__"),Cu.forEach(t),wh=s(Es," special method."),Es.forEach(t),yh=h(Eo),k(po.$$.fragment,Eo),Eh=h(Eo),k(uo.$$.fragment,Eo),Eo.forEach(t),tt.forEach(t),gr=h(o),Ot=r(o,"H2",{class:!0});var nd=d(Ot);mo=r(nd,"A",{id:!0,class:!0,href:!0});var ju=d(mo);La=r(ju,"SPAN",{});var Au=d(La);k(On.$$.fragment,Au),Au.forEach(t),ju.forEach(t),Lh=h(nd),qa=r(nd,"SPAN",{});var Pu=d(qa);qh=s(Pu,"TFLEDForConditionalGeneration"),Pu.forEach(t),nd.forEach(t),vr=h(o),he=r(o,"DIV",{class:!0});var ot=d(he);k(Cn.$$.fragment,ot),$h=h(ot),jn=r(ot,"P",{});var sd=d(jn);Dh=s(sd,`The LED Model with a language modeling head. Can be used for summarization.
