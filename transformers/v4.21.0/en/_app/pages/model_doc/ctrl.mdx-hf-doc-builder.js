...
<span class="hljs-meta">&gt;&gt;&gt; </span>configuration = model.config`}}),{c(){d=a("p"),v=n("Examples:"),c=h(),b(p.$$.fragment)},l(l){d=r(l,"P",{});var m=i(d);v=s(m,"Examples:"),m.forEach(t),c=u(l),k(p.$$.fragment,l)},m(l,m){g(l,d,m),e(d,v),g(l,c,m),w(p,l,m),y=!0},p:Ye,i(l){y||(C(p.$$.fragment,l),y=!0)},o(l){$(p.$$.fragment,l),y=!1},d(l){l&&t(d),l&&t(c),L(p,l)}}}function wc(M){let d,v,c,p,y;return{c(){d=a("p"),v=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),c=a("code"),p=n("Module"),y=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(l){d=r(l,"P",{});var m=i(d);v=s(m,"Although the recipe for forward pass needs to be defined within this function, one should call the "),c=r(m,"CODE",{});var E=i(c);p=s(E,"Module"),E.forEach(t),y=s(m,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),m.forEach(t)},m(l,m){g(l,d,m),e(d,v),e(d,c),e(c,p),e(d,y)},d(l){l&&t(d)}}}function Cc(M){let d,v,c,p,y;return p=new Ze({props:{code:`from transformers import CTRLTokenizer, CTRLModel
import torch
...
[<span class="hljs-number">1</span>, <span class="hljs-number">5</span>, <span class="hljs-number">1280</span>]`}}),{c(){d=a("p"),v=n("Example:"),c=h(),b(p.$$.fragment)},l(l){d=r(l,"P",{});var m=i(d);v=s(m,"Example:"),m.forEach(t),c=u(l),k(p.$$.fragment,l)},m(l,m){g(l,d,m),e(d,v),g(l,c,m),w(p,l,m),y=!0},p:Ye,i(l){y||(C(p.$$.fragment,l),y=!0)},o(l){$(p.$$.fragment,l),y=!1},d(l){l&&t(d),l&&t(c),L(p,l)}}}function $c(M){let d,v,c,p,y;return{c(){d=a("p"),v=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),c=a("code"),p=n("Module"),y=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(l){d=r(l,"P",{});var m=i(d);v=s(m,"Although the recipe for forward pass needs to be defined within this function, one should call the "),c=r(m,"CODE",{});var E=i(c);p=s(E,"Module"),E.forEach(t),y=s(m,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),m.forEach(t)},m(l,m){g(l,d,m),e(d,v),e(d,c),e(c,p),e(d,y)},d(l){l&&t(d)}}}function Lc(M){let d,v,c,p,y;return p=new Ze({props:{code:`import torch
...
the latter silently ignores them.`)},l(l){d=r(l,"P",{});var m=i(d);v=s(m,"Although the recipe for forward pass needs to be defined within this function, one should call the "),c=r(m,"CODE",{});var E=i(c);p=s(E,"Module"),E.forEach(t),y=s(m,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),m.forEach(t)},m(l,m){g(l,d,m),e(d,v),e(d,c),e(c,p),e(d,y)},d(l){l&&t(d)}}}function Mc(M){let d,v,c,p,y;return p=new Ze({props:{code:`import torch
...
<span class="hljs-string">&#x27;LABEL_0&#x27;</span>`}}),{c(){d=a("p"),v=n("Example of single-label classification:"),c=h(),b(p.$$.fragment)},l(l){d=r(l,"P",{});var m=i(d);v=s(m,"Example of single-label classification:"),m.forEach(t),c=u(l),k(p.$$.fragment,l)},m(l,m){g(l,d,m),e(d,v),g(l,c,m),w(p,l,m),y=!0},p:Ye,i(l){y||(C(p.$$.fragment,l),y=!0)},o(l){$(p.$$.fragment,l),y=!1},d(l){l&&t(d),l&&t(c),L(p,l)}}}function Fc(M){let d,v;return d=new Ze({props:{code:`import torch
...
<span class="hljs-meta">&gt;&gt;&gt; </span>predicted_class_id = logits.argmax().item()
<span class="hljs-meta">&gt;&gt;&gt; </span>model.config.id2label[predicted_class_id]
<span class="hljs-string">&#x27;LABEL_0&#x27;</span>`}}),{c(){d=a("p"),v=n("Example of multi-label classification:"),c=h(),b(p.$$.fragment)},l(l){d=r(l,"P",{});var m=i(d);v=s(m,"Example of multi-label classification:"),m.forEach(t),c=u(l),k(p.$$.fragment,l)},m(l,m){g(l,d,m),e(d,v),g(l,c,m),w(p,l,m),y=!0},p:Ye,i(l){y||(C(p.$$.fragment,l),y=!0)},o(l){$(p.$$.fragment,l),y=!1},d(l){l&&t(d),l&&t(c),L(p,l)}}}function qc(M){let d,v;return d=new Ze({props:{code:`# To train a model on \`num_labels\` classes, you can pass \`num_labels=num_labels\` to \`.from_pretrained(...)\`
num_labels = len(model.config.id2label)
model = CTRLForSequenceClassification.from_pretrained("ctrl", num_labels=num_labels)
...
`),K=a("code"),be=n('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(_){d=r(_,"P",{});var R=i(d);v=s(R,"TF 2.0 models accepts two formats as inputs:"),R.forEach(t),c=u(_),p=r(_,"UL",{});var re=i(p);y=r(re,"LI",{});var Se=i(y);l=s(Se,"having all inputs as keyword arguments (like PyTorch models), or"),Se.forEach(t),m=u(re),E=r(re,"LI",{});var ue=i(E);fe=s(ue,"having all inputs as a list, tuple or dict in the first positional arguments."),ue.forEach(t),re.forEach(t),Q=u(_),F=r(_,"P",{});var I=i(F);J=s(I,"This second option is useful when using "),A=r(I,"CODE",{});var Me=i(A);Y=s(Me,"tf.keras.Model.fit"),Me.forEach(t),ge=s(I,` method which currently requires having all the
tensors in the first argument of the model call function: `),H=r(I,"CODE",{});var Oe=i(H);_e=s(Oe,"model(inputs)"),Oe.forEach(t),ce=s(I,"."),I.forEach(t),P=u(_),S=r(_,"P",{});var Ne=i(S);Z=s(Ne,`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),Ne.forEach(t),oe=u(_),q=r(_,"UL",{});var D=i(q);z=r(D,"LI",{});var j=i(z);Te=s(j,"a single Tensor with "),B=r(j,"CODE",{});var Ie=i(B);pe=s(Ie,"input_ids"),Ie.forEach(t),ne=s(j," only and nothing else: "),V=r(j,"CODE",{});var Fe=i(V);he=s(Fe,"model(inputs_ids)"),Fe.forEach(t),j.forEach(t),se=u(D),x=r(D,"LI",{});var G=i(x);ve=s(G,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),W=r(G,"CODE",{});var De=i(W);ae=s(De,"model([input_ids, attention_mask])"),De.forEach(t),ye=s(G," or "),U=r(G,"CODE",{});var Ee=i(U);O=s(Ee,"model([input_ids, attention_mask, token_type_ids])"),Ee.forEach(t),G.forEach(t),ee=u(D),N=r(D,"LI",{});var ke=i(N);te=s(ke,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),K=r(ke,"CODE",{});var Ae=i(K);be=s(Ae,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),Ae.forEach(t),ke.forEach(t),D.forEach(t)},m(_,R){g(_,d,R),e(d,v),g(_,c,R),g(_,p,R),e(p,y),e(y,l),e(p,m),e(p,E),e(E,fe),g(_,Q,R),g(_,F,R),e(F,J),e(F,A),e(A,Y),e(F,ge),e(F,H),e(H,_e),e(F,ce),g(_,P,R),g(_,S,R),e(S,Z),g(_,oe,R),g(_,q,R),e(q,z),e(z,Te),e(z,B),e(B,pe),e(z,ne),e(z,V),e(V,he),e(q,se),e(q,x),e(x,ve),e(x,W),e(W,ae),e(x,ye),e(x,U),e(U,O),e(q,ee),e(q,N),e(N,te),e(N,K),e(K,be)},d(_){_&&t(d),_&&t(c),_&&t(p),_&&t(Q),_&&t(F),_&&t(P),_&&t(S),_&&t(oe),_&&t(q)}}}function xc(M){let d,v,c,p,y;return{c(){d=a("p"),v=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),c=a("code"),p=n("Module"),y=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(l){d=r(l,"P",{});var m=i(d);v=s(m,"Although the recipe for forward pass needs to be defined within this function, one should call the "),c=r(m,"CODE",{});var E=i(c);p=s(E,"Module"),E.forEach(t),y=s(m,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),m.forEach(t)},m(l,m){g(l,d,m),e(d,v),e(d,c),e(c,p),e(d,y)},d(l){l&&t(d)}}}function jc(M){let d,v,c,p,y;return p=new Ze({props:{code:`from transformers import CTRLTokenizer, TFCTRLModel
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),{c(){d=a("p"),v=n("Example:"),c=h(),b(p.$$.fragment)},l(l){d=r(l,"P",{});var m=i(d);v=s(m,"Example:"),m.forEach(t),c=u(l),k(p.$$.fragment,l)},m(l,m){g(l,d,m),e(d,v),g(l,c,m),w(p,l,m),y=!0},p:Ye,i(l){y||(C(p.$$.fragment,l),y=!0)},o(l){$(p.$$.fragment,l),y=!1},d(l){l&&t(d),l&&t(c),L(p,l)}}}function Pc(M){let d,v,c,p,y,l,m,E,fe,Q,F,J,A,Y,ge,H,_e,ce,P,S,Z,oe,q,z,Te,B,pe,ne,V,he,se,x,ve,W,ae,ye,U,O,ee,N,te,K,be;return{c(){d=a("p"),v=n("TF 2.0 models accepts two formats as inputs:"),c=h(),p=a("ul"),y=a("li"),l=n("having all inputs as keyword arguments (like PyTorch models), or"),m=h(),E=a("li"),fe=n("having all inputs as a list, tuple or dict in the first positional arguments."),Q=h(),F=a("p"),J=n("This second option is useful when using "),A=a("code"),Y=n("tf.keras.Model.fit"),ge=n(` method which currently requires having all the
tensors in the first argument of the model call function: `),H=a("code"),_e=n("model(inputs)"),ce=n("."),P=h(),S=a("p"),Z=n(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),oe=h(),q=a("ul"),z=a("li"),Te=n("a single Tensor with "),B=a("code"),pe=n("input_ids"),ne=n(" only and nothing else: "),V=a("code"),he=n("model(inputs_ids)"),se=h(),x=a("li"),ve=n(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),W=a("code"),ae=n("model([input_ids, attention_mask])"),ye=n(" or "),U=a("code"),O=n("model([input_ids, attention_mask, token_type_ids])"),ee=h(),N=a("li"),te=n(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),K=a("code"),be=n('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(_){d=r(_,"P",{});var R=i(d);v=s(R,"TF 2.0 models accepts two formats as inputs:"),R.forEach(t),c=u(_),p=r(_,"UL",{});var re=i(p);y=r(re,"LI",{});var Se=i(y);l=s(Se,"having all inputs as keyword arguments (like PyTorch models), or"),Se.forEach(t),m=u(re),E=r(re,"LI",{});var ue=i(E);fe=s(ue,"having all inputs as a list, tuple or dict in the first positional arguments."),ue.forEach(t),re.forEach(t),Q=u(_),F=r(_,"P",{});var I=i(F);J=s(I,"This second option is useful when using "),A=r(I,"CODE",{});var Me=i(A);Y=s(Me,"tf.keras.Model.fit"),Me.forEach(t),ge=s(I,` method which currently requires having all the
...
the latter silently ignores them.`)},l(l){d=r(l,"P",{});var m=i(d);v=s(m,"Although the recipe for forward pass needs to be defined within this function, one should call the "),c=r(m,"CODE",{});var E=i(c);p=s(E,"Module"),E.forEach(t),y=s(m,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),m.forEach(t)},m(l,m){g(l,d,m),e(d,v),e(d,c),e(c,p),e(d,y)},d(l){l&&t(d)}}}function Oc(M){let d,v,c,p,y;return p=new Ze({props:{code:`from transformers import CTRLTokenizer, TFCTRLLMHeadModel
import tensorflow as tf
...
<span class="hljs-meta">&gt;&gt;&gt; </span>inputs = tokenizer(<span class="hljs-string">&quot;Hello, my dog is cute&quot;</span>, return_tensors=<span class="hljs-string">&quot;tf&quot;</span>)
<span class="hljs-meta">&gt;&gt;&gt; </span>outputs = model(inputs)
<span class="hljs-meta">&gt;&gt;&gt; </span>logits = outputs.logits`}}),{c(){d=a("p"),v=n("Example:"),c=h(),b(p.$$.fragment)},l(l){d=r(l,"P",{});var m=i(d);v=s(m,"Example:"),m.forEach(t),c=u(l),k(p.$$.fragment,l)},m(l,m){g(l,d,m),e(d,v),g(l,c,m),w(p,l,m),y=!0},p:Ye,i(l){y||(C(p.$$.fragment,l),y=!0)},o(l){$(p.$$.fragment,l),y=!1},d(l){l&&t(d),l&&t(c),L(p,l)}}}function Nc(M){let d,v,c,p,y,l,m,E,fe,Q,F,J,A,Y,ge,H,_e,ce,P,S,Z,oe,q,z,Te,B,pe,ne,V,he,se,x,ve,W,ae,ye,U,O,ee,N,te,K,be;return{c(){d=a("p"),v=n("TF 2.0 models accepts two formats as inputs:"),c=h(),p=a("ul"),y=a("li"),l=n("having all inputs as keyword arguments (like PyTorch models), or"),m=h(),E=a("li"),fe=n("having all inputs as a list, tuple or dict in the first positional arguments."),Q=h(),F=a("p"),J=n("This second option is useful when using "),A=a("code"),Y=n("tf.keras.Model.fit"),ge=n(` method which currently requires having all the
tensors in the first argument of the model call function: `),H=a("code"),_e=n("model(inputs)"),ce=n("."),P=h(),S=a("p"),Z=n(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),oe=h(),q=a("ul"),z=a("li"),Te=n("a single Tensor with "),B=a("code"),pe=n("input_ids"),ne=n(" only and nothing else: "),V=a("code"),he=n("model(inputs_ids)"),se=h(),x=a("li"),ve=n(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),W=a("code"),ae=n("model([input_ids, attention_mask])"),ye=n(" or "),U=a("code"),O=n("model([input_ids, attention_mask, token_type_ids])"),ee=h(),N=a("li"),te=n(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),K=a("code"),be=n('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(_){d=r(_,"P",{});var R=i(d);v=s(R,"TF 2.0 models accepts two formats as inputs:"),R.forEach(t),c=u(_),p=r(_,"UL",{});var re=i(p);y=r(re,"LI",{});var Se=i(y);l=s(Se,"having all inputs as keyword arguments (like PyTorch models), or"),Se.forEach(t),m=u(re),E=r(re,"LI",{});var ue=i(E);fe=s(ue,"having all inputs as a list, tuple or dict in the first positional arguments."),ue.forEach(t),re.forEach(t),Q=u(_),F=r(_,"P",{});var I=i(F);J=s(I,"This second option is useful when using "),A=r(I,"CODE",{});var Me=i(A);Y=s(Me,"tf.keras.Model.fit"),Me.forEach(t),ge=s(I,` method which currently requires having all the
...
the latter silently ignores them.`)},l(l){d=r(l,"P",{});var m=i(d);v=s(m,"Although the recipe for forward pass needs to be defined within this function, one should call the "),c=r(m,"CODE",{});var E=i(c);p=s(E,"Module"),E.forEach(t),y=s(m,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),m.forEach(t)},m(l,m){g(l,d,m),e(d,v),e(d,c),e(c,p),e(d,y)},d(l){l&&t(d)}}}function Dc(M){let d,v,c,p,y;return p=new Ze({props:{code:`from transformers import CTRLTokenizer, TFCTRLForSequenceClassification
import tensorflow as tf
...
Whether or not the model should return the last key/values attentions (not used by all models).`,name:"use_cache"}],source:"https://github.com/huggingface/transformers/blob/v4.21.0/src/transformers/models/ctrl/configuration_ctrl.py#L26"}}),Lt=new Qe({props:{anchor:"transformers.CTRLConfig.example",$$slots:{default:[kc]},$$scope:{ctx:M}}}),ho=new it({}),uo=new Re({props:{name:"class transformers.CTRLTokenizer",anchor:"transformers.CTRLTokenizer",parameters:[{name:"vocab_file",val:""},{name:"merges_file",val:""},{name:"unk_token",val:" = '<unk>'"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.CTRLTokenizer.vocab_file",description:`<strong>vocab_file</strong> (<code>str</code>) &#x2014;
...
<p>Indices can be obtained using <a href="/docs/transformers/v4.21.0/en/model_doc/ctrl#transformers.CTRLTokenizer">CTRLTokenizer</a>. See <a href="/docs/transformers/v4.21.0/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
...
Whether or not to return a <a href="/docs/transformers/v4.21.0/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/v4.21.0/src/transformers/models/ctrl/modeling_ctrl.py#L352",returnDescription:`
<p>A <a
  href="/docs/transformers/v4.21.0/en/main_classes/output#transformers.modeling_outputs.BaseModelOutputWithPast"
>transformers.modeling_outputs.BaseModelOutputWithPast</a> or a tuple of
<code>torch.FloatTensor</code> (if <code>return_dict=False</code> is passed or when <code>config.return_dict=False</code>) comprising various
elements depending on the configuration (<a
  href="/docs/transformers/v4.21.0/en/model_doc/ctrl#transformers.CTRLConfig"
...
are ignored (masked), the loss is only computed for labels in <code>[0, ..., config.vocab_size]</code>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.21.0/src/transformers/models/ctrl/modeling_ctrl.py#L531",returnDescription:`
<p>A <a
  href="/docs/transformers/v4.21.0/en/main_classes/output#transformers.modeling_outputs.CausalLMOutputWithPast"
...
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.21.0/src/transformers/models/ctrl/modeling_ctrl.py#L657",returnDescription:`
<p>A <a
...
behaviors between training and evaluation).`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/v4.21.0/src/transformers/models/ctrl/modeling_tf_ctrl.py#L522",returnDescription:`
<p>A <a
  href="/docs/transformers/v4.21.0/en/main_classes/output#transformers.modeling_tf_outputs.TFBaseModelOutputWithPast"
...
Labels for computing the cross entropy classification loss. Indices should be in <code>[0, ..., config.vocab_size - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.21.0/src/transformers/models/ctrl/modeling_tf_ctrl.py#L636",returnDescription:`
<p>A <a
  href="/docs/transformers/v4.21.0/en/main_classes/output#transformers.modeling_tf_outputs.TFCausalLMOutputWithPast"
...
Labels for computing the cross entropy classification loss. Indices should be in <code>[0, ..., config.vocab_size - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.21.0/src/transformers/models/ctrl/modeling_tf_ctrl.py#L747",returnDescription:`
<p>A <a
...
the left.`),Se=h(),ue=a("li"),I=n(`CTRL was trained with a causal language modeling (CLM) objective and is therefore powerful at predicting the next
...
documentation from `),rn=a("a"),Ia=n("PretrainedConfig"),Da=n(" for more information."),Aa=h(),b(Lt.$$.fragment),js=h(),ct=a("h2"),Rt=a("a"),On=a("span"),b(ho.$$.fragment),Ha=h(),Nn=a("span"),Wa=n("CTRLTokenizer"),Ps=h(),je=a("div"),b(uo.$$.fragment),Ua=h(),In=a("p"),Ba=n("Construct a CTRL tokenizer. Based on Byte-Pair-Encoding."),Va=h(),mo=a("p"),Ka=n("This tokenizer inherits from "),ln=a("a"),Ga=n("PreTrainedTokenizer"),Xa=n(` which contains most of the main methods. Users should refer to
...
and behavior.`),dr=h(),He=a("div"),b(bo.$$.fragment),cr=h(),ht=a("p"),pr=n("The "),pn=a("a"),hr=n("CTRLModel"),ur=n(" forward method, overrides the "),Wn=a("code"),mr=n("__call__"),fr=n(" special method."),gr=h(),b(Ft.$$.fragment),_r=h(),b(Et.$$.fragment),Ns=h(),ut=a("h2"),qt=a("a"),Un=a("span"),b(ko.$$.fragment),Tr=h(),Bn=a("span"),vr=n("CTRLLMHeadModel"),Is=h(),Ce=a("div"),b(wo.$$.fragment),yr=h(),Vn=a("p"),br=n(`The CTRL Model transformer with a language modeling head on top (linear layer with weights tied to the input
...
no `),us=a("code"),yl=n("pad_token_id"),bl=n(` is defined, it simply takes the last value in each row of the batch. Since it cannot guess the
padding tokens when `),ms=a("code"),kl=n("inputs_embeds"),wl=n(" are passed instead of "),fs=a("code"),Cl=n("input_ids"),$l=n(`, it does the same (take the last value in
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),jl=h(),b(Xt.$$.fragment),Pl=h(),qe=a("div"),b(Qo.$$.fragment),Sl=h(),kt=a("p"),Ol=n("The "),Cn=a("a"),Nl=n("TFCTRLForSequenceClassification"),Il=n(" forward method, overrides the "),gs=a("code"),Dl=n("__call__"),Al=n(" special method."),Hl=h(),b(Jt.$$.fragment),Wl=h(),b(Qt.$$.fragment),Ul=h(),b(Yt.$$.fragment),this.h()},l(o){const T=yc('[data-svelte="svelte-1phssyn"]',document.head);d=r(T,"META",{name:!0,content:!0}),T.forEach(t),v=u(o),c=r(o,"H1",{class:!0});var Yo=i(c);p=r(Yo,"A",{id:!0,class:!0,href:!0});var _s=i(p);y=r(_s,"SPAN",{});var Ts=i(y);k(l.$$.fragment,Ts),Ts.forEach(t),_s.forEach(t),m=u(Yo),E=r(Yo,"SPAN",{});var vs=i(E);fe=s(vs,"CTRL"),vs.forEach(t),Yo.forEach(t),Q=u(o),F=r(o,"H2",{class:!0});var Zo=i(F);J=r(Zo,"A",{id:!0,class:!0,href:!0});var ys=i(J);A=r(ys,"SPAN",{});var bs=i(A);k(Y.$$.fragment,bs),bs.forEach(t),ys.forEach(t),ge=u(Zo),H=r(Zo,"SPAN",{});var ks=i(H);_e=s(ks,"Overview"),ks.forEach(t),Zo.forEach(t),ce=u(o),P=r(o,"P",{});var wt=i(P);S=s(wt,"CTRL model was proposed in "),Z=r(wt,"A",{href:!0,rel:!0});var ws=i(Z);oe=s(ws,"CTRL: A Conditional Transformer Language Model for Controllable Generation"),ws.forEach(t),q=s(wt," by Nitish Shirish Keskar"),z=r(wt,"EM",{});var Cs=i(z);Te=s(Cs,", Bryan McCann"),Cs.forEach(t),B=s(wt,`, Lav R. Varshney, Caiming Xiong and
Richard Socher. It\u2019s a causal (unidirectional) transformer pre-trained using language modeling on a very large corpus
of ~140 GB of text data with the first token reserved as a control code (such as Links, Books, Wikipedia etc.).`),wt.forEach(t),pe=u(o),ne=r(o,"P",{});var $s=i(ne);V=s($s,"The abstract from the paper is the following:"),$s.forEach(t),he=u(o),se=r(o,"P",{});var Ls=i(se);x=r(Ls,"EM",{});var Rs=i(x);ve=s(Rs,`Large-scale language models show promising text generation capabilities, but users cannot easily control particular
aspects of the generated text. We release CTRL, a 1.63 billion-parameter conditional transformer language model,
trained to condition on control codes that govern style, content, and task-specific behavior. Control codes were
derived from structure that naturally co-occurs with raw text, preserving the advantages of unsupervised learning while
providing more explicit control over text generation. These codes also allow CTRL to predict which parts of the
training data are most likely given a sequence. This provides a potential method for analyzing large amounts of data
via model-based source attribution.`),Rs.forEach(t),Ls.forEach(t),W=u(o),ae=r(o,"P",{});var Ms=i(ae);ye=s(Ms,"Tips:"),Ms.forEach(t),U=u(o),O=r(o,"UL",{});var Je=i(O);ee=r(Je,"LI",{});var en=i(ee);N=s(en,`CTRL makes use of control codes to generate text: it requires generations to be started by certain words, sentences
...
the left.`),Es.forEach(t),Se=u(Je),ue=r(Je,"LI",{});var tn=i(ue);I=s(tn,`CTRL was trained with a causal language modeling (CLM) objective and is therefore powerful at predicting the next
token in a sequence. Leveraging this feature allows CTRL to generate syntactically coherent text as it can be
observed in the `),Me=r(tn,"EM",{});var Vl=i(Me);Oe=s(Vl,"run_generation.py"),Vl.forEach(t),Ne=s(tn," example script."),tn.forEach(t),D=u(Je),j=r(Je,"LI",{});var tt=i(j);Ie=s(tt,"The PyTorch models can take the "),Fe=r(tt,"CODE",{});var Kl=i(Fe);G=s(Kl,"past_key_values"),Kl.forEach(t),De=s(tt,` as input, which is the previously computed key/value attention pairs.
...
method for more information on the usage of this argument.`),tt.forEach(t),Je.forEach(t),qs=u(o),et=r(o,"P",{});var $n=i(et);ya=s($n,"This model was contributed by "),ro=r($n,"A",{href:!0,rel:!0});var Yl=i(ro);ba=s(Yl,"keskarnitishr"),Yl.forEach(t),ka=s($n,`. The original code can be found
`),io=r($n,"A",{href:!0,rel:!0});var Zl=i(io);wa=s(Zl,"here"),Zl.forEach(t),Ca=s($n,"."),$n.forEach(t),zs=u(o),lt=r(o,"H2",{class:!0});var Xs=i(lt);$t=r(Xs,"A",{id:!0,class:!0,href:!0});var ed=i($t);Pn=r(ed,"SPAN",{});var td=i(Pn);k(lo.$$.fragment,td),td.forEach(t),ed.forEach(t),$a=u(Xs),Sn=r(Xs,"SPAN",{});var od=i(Sn);La=s(od,"CTRLConfig"),od.forEach(t),Xs.forEach(t),xs=u(o),xe=r(o,"DIV",{class:!0});var Zt=i(xe);k(co.$$.fragment,Zt),Ra=u(Zt),Xe=r(Zt,"P",{});var eo=i(Xe);Ma=s(eo,"This is the configuration class to store the configuration of a "),nn=r(eo,"A",{href:!0});var nd=i(nn);Fa=s(nd,"CTRLModel"),nd.forEach(t),Ea=s(eo," or a "),sn=r(eo,"A",{href:!0});var sd=i(sn);qa=s(sd,"TFCTRLModel"),sd.forEach(t),za=s(eo,`. It is used to
instantiate a CTRL model according to the specified arguments, defining the model architecture. Instantiating a
configuration with the defaults will yield a similar configuration to that of the
`),po=r(eo,"A",{href:!0,rel:!0});var ad=i(po);xa=s(ad,"ctrl"),ad.forEach(t),ja=s(eo," architecture from SalesForce."),eo.forEach(t),Pa=u(Zt),dt=r(Zt,"P",{});var Ln=i(dt);Sa=s(Ln,"Configuration objects inherit from "),an=r(Ln,"A",{href:!0});var rd=i(an);Oa=s(rd,"PretrainedConfig"),rd.forEach(t),Na=s(Ln,` and can be used to control the model outputs. Read the
documentation from `),rn=r(Ln,"A",{href:!0});var id=i(rn);Ia=s(id,"PretrainedConfig"),id.forEach(t),Da=s(Ln," for more information."),Ln.forEach(t),Aa=u(Zt),k(Lt.$$.fragment,Zt),Zt.forEach(t),js=u(o),ct=r(o,"H2",{class:!0});var Js=i(ct);Rt=r(Js,"A",{id:!0,class:!0,href:!0});var ld=i(Rt);On=r(ld,"SPAN",{});var dd=i(On);k(ho.$$.fragment,dd),dd.forEach(t),ld.forEach(t),Ha=u(Js),Nn=r(Js,"SPAN",{});var cd=i(Nn);Wa=s(cd,"CTRLTokenizer"),cd.forEach(t),Js.forEach(t),Ps=u(o),je=r(o,"DIV",{class:!0});var to=i(je);k(uo.$$.fragment,to),Ua=u(to),In=r(to,"P",{});var pd=i(In);Ba=s(pd,"Construct a CTRL tokenizer. Based on Byte-Pair-Encoding."),pd.forEach(t),Va=u(to),mo=r(to,"P",{});var Qs=i(mo);Ka=s(Qs,"This tokenizer inherits from "),ln=r(Qs,"A",{href:!0});var hd=i(ln);Ga=s(hd,"PreTrainedTokenizer"),hd.forEach(t),Xa=s(Qs,` which contains most of the main methods. Users should refer to
this superclass for more information regarding those methods.`),Qs.forEach(t),Ja=u(to),dn=r(to,"DIV",{class:!0});var ud=i(dn);k(fo.$$.fragment,ud),ud.forEach(t),to.forEach(t),Ss=u(o),pt=r(o,"H2",{class:!0});var Ys=i(pt);Mt=r(Ys,"A",{id:!0,class:!0,href:!0});var md=i(Mt);Dn=r(md,"SPAN",{});var fd=i(Dn);k(go.$$.fragment,fd),fd.forEach(t),md.forEach(t),Qa=u(Ys),An=r(Ys,"SPAN",{});var gd=i(An);Ya=s(gd,"CTRLModel"),gd.forEach(t),Ys.forEach(t),Os=u(o),we=r(o,"DIV",{class:!0});var ot=i(we);k(_o.$$.fragment,ot),Za=u(ot),Hn=r(ot,"P",{});var _d=i(Hn);er=s(_d,"The bare CTRL Model transformer outputting raw hidden-states without any specific head on top."),_d.forEach(t),tr=u(ot),To=r(ot,"P",{});var Zs=i(To);or=s(Zs,"This model inherits from "),cn=r(Zs,"A",{href:!0});var Td=i(cn);nr=s(Td,"PreTrainedModel"),Td.forEach(t),sr=s(Zs,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Zs.forEach(t),ar=u(ot),vo=r(ot,"P",{});var ea=i(vo);rr=s(ea,"This model is also a PyTorch "),yo=r(ea,"A",{href:!0,rel:!0});var vd=i(yo);ir=s(vd,"torch.nn.Module"),vd.forEach(t),lr=s(ea,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),ea.forEach(t),dr=u(ot),He=r(ot,"DIV",{class:!0});var oo=i(He);k(bo.$$.fragment,oo),cr=u(oo),ht=r(oo,"P",{});var Rn=i(ht);pr=s(Rn,"The "),pn=r(Rn,"A",{href:!0});var yd=i(pn);hr=s(yd,"CTRLModel"),yd.forEach(t),ur=s(Rn," forward method, overrides the "),Wn=r(Rn,"CODE",{});var bd=i(Wn);mr=s(bd,"__call__"),bd.forEach(t),fr=s(Rn," special method."),Rn.forEach(t),gr=u(oo),k(Ft.$$.fragment,oo),_r=u(oo),k(Et.$$.fragment,oo),oo.forEach(t),ot.forEach(t),Ns=u(o),ut=r(o,"H2",{class:!0});var ta=i(ut);qt=r(ta,"A",{id:!0,class:!0,href:!0});var kd=i(qt);Un=r(kd,"SPAN",{});var wd=i(Un);k(ko.$$.fragment,wd),wd.forEach(t),kd.forEach(t),Tr=u(ta),Bn=r(ta,"SPAN",{});var Cd=i(Bn);vr=s(Cd,"CTRLLMHeadModel"),Cd.forEach(t),ta.forEach(t),Is=u(o),Ce=r(o,"DIV",{class:!0});var nt=i(Ce);k(wo.$$.fragment,nt),yr=u(nt),Vn=r(nt,"P",{});var $d=i(Vn);br=s($d,`The CTRL Model transformer with a language modeling head on top (linear layer with weights tied to the input
embeddings).`),$d.forEach(t),kr=u(nt),Co=r(nt,"P",{});var oa=i(Co);wr=s(oa,"This model inherits from "),hn=r(oa,"A",{href:!0});var Ld=i(hn);Cr=s(Ld,"PreTrainedModel"),Ld.forEach(t),$r=s(oa,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),na.forEach(t),Er=u(nt),We=r(nt,"DIV",{class:!0});var no=i(We);k(Ro.$$.fragment,no),qr=u(no),mt=r(no,"P",{});var Mn=i(mt);zr=s(Mn,"The "),un=r(Mn,"A",{href:!0});var Md=i(un);xr=s(Md,"CTRLLMHeadModel"),Md.forEach(t),jr=s(Mn," forward method, overrides the "),Kn=r(Mn,"CODE",{});var Fd=i(Kn);Pr=s(Fd,"__call__"),Fd.forEach(t),Sr=s(Mn," special method."),Mn.forEach(t),Or=u(no),k(zt.$$.fragment,no),Nr=u(no),k(xt.$$.fragment,no),no.forEach(t),nt.forEach(t),Ds=u(o),ft=r(o,"H2",{class:!0});var sa=i(ft);jt=r(sa,"A",{id:!0,class:!0,href:!0});var Ed=i(jt);Gn=r(Ed,"SPAN",{});var qd=i(Gn);k(Mo.$$.fragment,qd),qd.forEach(t),Ed.forEach(t),Ir=u(sa),Xn=r(sa,"SPAN",{});var zd=i(Xn);Dr=s(zd,"CTRLForSequenceClassification"),zd.forEach(t),sa.forEach(t),As=u(o),$e=r(o,"DIV",{class:!0});var st=i($e);k(Fo.$$.fragment,st),Ar=u(st),Le=r(st,"P",{});var Ve=i(Le);Hr=s(Ve,`The CTRL Model transformer with a sequence classification head on top (linear layer).
`),mn=r(Ve,"A",{href:!0});var xd=i(mn);Wr=s(xd,"CTRLForSequenceClassification"),xd.forEach(t),Ur=s(Ve,` uses the last token in order to do the classification, as other causal models
(e.g. GPT-2) do. Since it does classification on the last token, it requires to know the position of the last
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),aa.forEach(t),ni=u(st),qo=r(st,"P",{});var ra=i(qo);si=s(ra,"This model is also a PyTorch "),zo=r(ra,"A",{href:!0,rel:!0});var Id=i(zo);ai=s(Id,"torch.nn.Module"),Id.forEach(t),ri=s(ra,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),ra.forEach(t),ii=u(st),ie=r(st,"DIV",{class:!0});var ze=i(ie);k(xo.$$.fragment,ze),li=u(ze),gt=r(ze,"P",{});var Fn=i(gt);di=s(Fn,"The "),gn=r(Fn,"A",{href:!0});var Dd=i(gn);ci=s(Dd,"CTRLForSequenceClassification"),Dd.forEach(t),pi=s(Fn," forward method, overrides the "),es=r(Fn,"CODE",{});var Ad=i(es);hi=s(Ad,"__call__"),Ad.forEach(t),ui=s(Fn," special method."),Fn.forEach(t),mi=u(ze),k(Pt.$$.fragment,ze),fi=u(ze),k(St.$$.fragment,ze),gi=u(ze),k(Ot.$$.fragment,ze),_i=u(ze),k(Nt.$$.fragment,ze),Ti=u(ze),k(It.$$.fragment,ze),ze.forEach(t),st.forEach(t),Hs=u(o),_t=r(o,"H2",{class:!0});var ia=i(_t);Dt=r(ia,"A",{id:!0,class:!0,href:!0});var Hd=i(Dt);ts=r(Hd,"SPAN",{});var Wd=i(ts);k(jo.$$.fragment,Wd),Wd.forEach(t),Hd.forEach(t),vi=u(ia),os=r(ia,"SPAN",{});var Ud=i(os);yi=s(Ud,"TFCTRLModel"),Ud.forEach(t),ia.forEach(t),Ws=u(o),le=r(o,"DIV",{class:!0});var Ke=i(le);k(Po.$$.fragment,Ke),bi=u(Ke),ns=r(Ke,"P",{});var Bd=i(ns);ki=s(Bd,"The bare CTRL Model transformer outputting raw hidden-states without any specific head on top."),Bd.forEach(t),wi=u(Ke),So=r(Ke,"P",{});var la=i(So);Ci=s(la,"This model inherits from "),_n=r(la,"A",{href:!0});var Vd=i(_n);$i=s(Vd,"TFPreTrainedModel"),Vd.forEach(t),Li=s(la,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),la.forEach(t),Ri=u(Ke),Oo=r(Ke,"P",{});var da=i(Oo);Mi=s(da,"This model is also a "),No=r(da,"A",{href:!0,rel:!0});var Kd=i(No);Fi=s(Kd,"tf.keras.Model"),Kd.forEach(t),Ei=s(da,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),da.forEach(t),qi=u(Ke),k(At.$$.fragment,Ke),zi=u(Ke),Ue=r(Ke,"DIV",{class:!0});var so=i(Ue);k(Io.$$.fragment,so),xi=u(so),Tt=r(so,"P",{});var En=i(Tt);ji=s(En,"The "),Tn=r(En,"A",{href:!0});var Gd=i(Tn);Pi=s(Gd,"TFCTRLModel"),Gd.forEach(t),Si=s(En," forward method, overrides the "),ss=r(En,"CODE",{});var Xd=i(ss);Oi=s(Xd,"__call__"),Xd.forEach(t),Ni=s(En," special method."),En.forEach(t),Ii=u(so),k(Ht.$$.fragment,so),Di=u(so),k(Wt.$$.fragment,so),so.forEach(t),Ke.forEach(t),Us=u(o),vt=r(o,"H2",{class:!0});var ca=i(vt);Ut=r(ca,"A",{id:!0,class:!0,href:!0});var Jd=i(Ut);as=r(Jd,"SPAN",{});var Qd=i(as);k(Do.$$.fragment,Qd),Qd.forEach(t),Jd.forEach(t),Ai=u(ca),rs=r(ca,"SPAN",{});var Yd=i(rs);Hi=s(Yd,"TFCTRLLMHeadModel"),Yd.forEach(t),ca.forEach(t),Bs=u(o),de=r(o,"DIV",{class:!0});var Ge=i(de);k(Ao.$$.fragment,Ge),Wi=u(Ge),is=r(Ge,"P",{});var Zd=i(is);Ui=s(Zd,`The CTRL Model transformer with a language modeling head on top (linear layer with weights tied to the input
embeddings).`),Zd.forEach(t),Bi=u(Ge),Ho=r(Ge,"P",{});var pa=i(Ho);Vi=s(pa,"This model inherits from "),vn=r(pa,"A",{href:!0});var ec=i(vn);Ki=s(ec,"TFPreTrainedModel"),ec.forEach(t),Gi=s(pa,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),pa.forEach(t),Xi=u(Ge),Wo=r(Ge,"P",{});var ha=i(Wo);Ji=s(ha,"This model is also a "),Uo=r(ha,"A",{href:!0,rel:!0});var tc=i(Uo);Qi=s(tc,"tf.keras.Model"),tc.forEach(t),Yi=s(ha,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),ha.forEach(t),Zi=u(Ge),k(Bt.$$.fragment,Ge),el=u(Ge),Be=r(Ge,"DIV",{class:!0});var ao=i(Be);k(Bo.$$.fragment,ao),tl=u(ao),yt=r(ao,"P",{});var qn=i(yt);ol=s(qn,"The "),yn=r(qn,"A",{href:!0});var oc=i(yn);nl=s(oc,"TFCTRLLMHeadModel"),oc.forEach(t),sl=s(qn," forward method, overrides the "),ls=r(qn,"CODE",{});var nc=i(ls);al=s(nc,"__call__"),nc.forEach(t),rl=s(qn," special method."),qn.forEach(t),il=u(ao),k(Vt.$$.fragment,ao),ll=u(ao),k(Kt.$$.fragment,ao),ao.forEach(t),Ge.forEach(t),Vs=u(o),bt=r(o,"H2",{class:!0});var ua=i(bt);Gt=r(ua,"A",{id:!0,class:!0,href:!0});var sc=i(Gt);ds=r(sc,"SPAN",{});var ac=i(ds);k(Vo.$$.fragment,ac),ac.forEach(t),sc.forEach(t),dl=u(ua),cs=r(ua,"SPAN",{});var rc=i(cs);cl=s(rc,"TFCTRLForSequenceClassification"),rc.forEach(t),ua.forEach(t),Ks=u(o),X=r(o,"DIV",{class:!0});var me=i(X);k(Ko.$$.fragment,me),pl=u(me),ps=r(me,"P",{});var ic=i(ps);hl=s(ic,"The CTRL Model transformer with a sequence classification head on top (linear layer)."),ic.forEach(t),ul=u(me),bn=r(me,"P",{});var Bl=i(bn);kn=r(Bl,"A",{href:!0});var lc=i(kn);ml=s(lc,"TFCTRLForSequenceClassification"),lc.forEach(t),fl=s(Bl,` uses the last token in order to do the classification, as other causal models
(e.g. GPT-1, GPT-2) do.`),Bl.forEach(t),gl=u(me),Pe=r(me,"P",{});var at=i(Pe);_l=s(at,`Since it does classification on the last token, it requires to know the position of the last token. If a
...
no `),us=r(at,"CODE",{});var cc=i(us);yl=s(cc,"pad_token_id"),cc.forEach(t),bl=s(at,` is defined, it simply takes the last value in each row of the batch. Since it cannot guess the
padding tokens when `),ms=r(at,"CODE",{});var pc=i(ms);kl=s(pc,"inputs_embeds"),pc.forEach(t),wl=s(at," are passed instead of "),fs=r(at,"CODE",{});var hc=i(fs);Cl=s(hc,"input_ids"),hc.forEach(t),$l=s(at,`, it does the same (take the last value in
each row of the batch).`),at.forEach(t),Ll=u(me),Go=r(me,"P",{});var ma=i(Go);Rl=s(ma,"This model inherits from "),wn=r(ma,"A",{href:!0});var uc=i(wn);Ml=s(uc,"TFPreTrainedModel"),uc.forEach(t),Fl=s(ma,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
