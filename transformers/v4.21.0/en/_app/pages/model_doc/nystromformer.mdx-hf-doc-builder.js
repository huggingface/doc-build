import{S as ei,i as oi,s as ti,e as a,k as g,w as k,t as d,M as si,c as i,d as t,m as _,a as l,x as v,h as c,b as u,G as e,g as b,y as $,q as w,o as T,B as N,v as ni,L as D}from"../../chunks/vendor-hf-doc-builder.js";import{T as it}from"../../chunks/Tip-hf-doc-builder.js";import{D as L}from"../../chunks/Docstring-hf-doc-builder.js";import{C as W}from"../../chunks/CodeBlock-hf-doc-builder.js";import{I as ue}from"../../chunks/IconCopyLink-hf-doc-builder.js";import{E as I}from"../../chunks/ExampleCodeBlock-hf-doc-builder.js";function ri(F){let n,f,r,m,y;return m=new W({props:{code:`from transformers import NystromformerModel, NystromformerConfig
...
<span class="hljs-meta">&gt;&gt;&gt; </span>configuration = model.config`}}),{c(){n=a("p"),f=d("Example:"),r=g(),k(m.$$.fragment)},l(s){n=i(s,"P",{});var p=l(n);f=c(p,"Example:"),p.forEach(t),r=_(s),v(m.$$.fragment,s)},m(s,p){b(s,n,p),e(n,f),b(s,r,p),$(m,s,p),y=!0},p:D,i(s){y||(w(m.$$.fragment,s),y=!0)},o(s){T(m.$$.fragment,s),y=!1},d(s){s&&t(n),s&&t(r),N(m,s)}}}function ai(F){let n,f,r,m,y;return{c(){n=a("p"),f=d("Although the recipe for forward pass needs to be defined within this function, one should call the "),r=a("code"),m=d("Module"),y=d(`
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),{c(){n=a("p"),f=d("Example:"),r=g(),k(m.$$.fragment)},l(s){n=i(s,"P",{});var p=l(n);f=c(p,"Example:"),p.forEach(t),r=_(s),v(m.$$.fragment,s)},m(s,p){b(s,n,p),e(n,f),b(s,r,p),$(m,s,p),y=!0},p:D,i(s){y||(w(m.$$.fragment,s),y=!0)},o(s){T(m.$$.fragment,s),y=!1},d(s){s&&t(n),s&&t(r),N(m,s)}}}function li(F){let n,f,r,m,y;return{c(){n=a("p"),f=d("Although the recipe for forward pass needs to be defined within this function, one should call the "),r=a("code"),m=d("Module"),y=d(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(s){n=i(s,"P",{});var p=l(n);f=c(p,"Although the recipe for forward pass needs to be defined within this function, one should call the "),r=i(p,"CODE",{});var M=l(r);m=c(M,"Module"),M.forEach(t),y=c(p,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
`}}),{c(){n=a("p"),f=d("Example:"),r=g(),k(m.$$.fragment)},l(s){n=i(s,"P",{});var p=l(n);f=c(p,"Example:"),p.forEach(t),r=_(s),v(m.$$.fragment,s)},m(s,p){b(s,n,p),e(n,f),b(s,r,p),$(m,s,p),y=!0},p:D,i(s){y||(w(m.$$.fragment,s),y=!0)},o(s){T(m.$$.fragment,s),y=!1},d(s){s&&t(n),s&&t(r),N(m,s)}}}function ci(F){let n,f;return n=new W({props:{code:`labels = tokenizer("The capital of France is Paris.", return_tensors="pt")["input_ids"]
...
`}}),{c(){k(n.$$.fragment)},l(r){v(n.$$.fragment,r)},m(r,m){$(n,r,m),f=!0},p:D,i(r){f||(w(n.$$.fragment,r),f=!0)},o(r){T(n.$$.fragment,r),f=!1},d(r){N(n,r)}}}function mi(F){let n,f,r,m,y;return{c(){n=a("p"),f=d("Although the recipe for forward pass needs to be defined within this function, one should call the "),r=a("code"),m=d("Module"),y=d(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(s){n=i(s,"P",{});var p=l(n);f=c(p,"Although the recipe for forward pass needs to be defined within this function, one should call the "),r=i(p,"CODE",{});var M=l(r);m=c(M,"Module"),M.forEach(t),y=c(p,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
`}}),{c(){n=a("p"),f=d("Example of single-label classification:"),r=g(),k(m.$$.fragment)},l(s){n=i(s,"P",{});var p=l(n);f=c(p,"Example of single-label classification:"),p.forEach(t),r=_(s),v(m.$$.fragment,s)},m(s,p){b(s,n,p),e(n,f),b(s,r,p),$(m,s,p),y=!0},p:D,i(s){y||(w(m.$$.fragment,s),y=!0)},o(s){T(m.$$.fragment,s),y=!1},d(s){s&&t(n),s&&t(r),N(m,s)}}}function fi(F){let n,f;return n=new W({props:{code:`# To train a model on \`num_labels\` classes, you can pass \`num_labels=num_labels\` to \`.from_pretrained(...)\`
...
`}}),{c(){k(n.$$.fragment)},l(r){v(n.$$.fragment,r)},m(r,m){$(n,r,m),f=!0},p:D,i(r){f||(w(n.$$.fragment,r),f=!0)},o(r){T(n.$$.fragment,r),f=!1},d(r){N(n,r)}}}function hi(F){let n,f,r,m,y;return m=new W({props:{code:`import torch
from transformers import AutoTokenizer, NystromformerForSequenceClassification
...
<span class="hljs-meta">&gt;&gt;&gt; </span>predicted_class_id = logits.argmax().item()
<span class="hljs-meta">&gt;&gt;&gt; </span>model.config.id2label[predicted_class_id]
`}}),{c(){n=a("p"),f=d("Example of multi-label classification:"),r=g(),k(m.$$.fragment)},l(s){n=i(s,"P",{});var p=l(n);f=c(p,"Example of multi-label classification:"),p.forEach(t),r=_(s),v(m.$$.fragment,s)},m(s,p){b(s,n,p),e(n,f),b(s,r,p),$(m,s,p),y=!0},p:D,i(s){y||(w(m.$$.fragment,s),y=!0)},o(s){T(m.$$.fragment,s),y=!1},d(s){s&&t(n),s&&t(r),N(m,s)}}}function ui(F){let n,f;return n=new W({props:{code:`# To train a model on \`num_labels\` classes, you can pass \`num_labels=num_labels\` to \`.from_pretrained(...)\`
num_labels = len(model.config.id2label)
...
<span class="hljs-meta">... </span>)
<span class="hljs-meta">&gt;&gt;&gt; </span>loss = model(**inputs, labels=labels).loss
<span class="hljs-meta">&gt;&gt;&gt; </span>loss.backward()`}}),{c(){k(n.$$.fragment)},l(r){v(n.$$.fragment,r)},m(r,m){$(n,r,m),f=!0},p:D,i(r){f||(w(n.$$.fragment,r),f=!0)},o(r){T(n.$$.fragment,r),f=!1},d(r){N(n,r)}}}function gi(F){let n,f,r,m,y;return{c(){n=a("p"),f=d("Although the recipe for forward pass needs to be defined within this function, one should call the "),r=a("code"),m=d("Module"),y=d(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(s){n=i(s,"P",{});var p=l(n);f=c(p,"Although the recipe for forward pass needs to be defined within this function, one should call the "),r=i(p,"CODE",{});var M=l(r);m=c(M,"Module"),M.forEach(t),y=c(p,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
<span class="hljs-meta">&gt;&gt;&gt; </span>logits = outputs.logits`}}),{c(){n=a("p"),f=d("Example:"),r=g(),k(m.$$.fragment)},l(s){n=i(s,"P",{});var p=l(n);f=c(p,"Example:"),p.forEach(t),r=_(s),v(m.$$.fragment,s)},m(s,p){b(s,n,p),e(n,f),b(s,r,p),$(m,s,p),y=!0},p:D,i(s){y||(w(m.$$.fragment,s),y=!0)},o(s){T(m.$$.fragment,s),y=!1},d(s){s&&t(n),s&&t(r),N(m,s)}}}function yi(F){let n,f,r,m,y;return{c(){n=a("p"),f=d("Although the recipe for forward pass needs to be defined within this function, one should call the "),r=a("code"),m=d("Module"),y=d(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(s){n=i(s,"P",{});var p=l(n);f=c(p,"Although the recipe for forward pass needs to be defined within this function, one should call the "),r=i(p,"CODE",{});var M=l(r);m=c(M,"Module"),M.forEach(t),y=c(p,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
`}}),{c(){n=a("p"),f=d("Example:"),r=g(),k(m.$$.fragment)},l(s){n=i(s,"P",{});var p=l(n);f=c(p,"Example:"),p.forEach(t),r=_(s),v(m.$$.fragment,s)},m(s,p){b(s,n,p),e(n,f),b(s,r,p),$(m,s,p),y=!0},p:D,i(s){y||(w(m.$$.fragment,s),y=!0)},o(s){T(m.$$.fragment,s),y=!1},d(s){s&&t(n),s&&t(r),N(m,s)}}}function ki(F){let n,f;return n=new W({props:{code:`labels = predicted_token_class_ids
loss = model(**inputs, labels=labels).loss
round(loss.item(), 2)
`,highlighted:`<span class="hljs-meta">&gt;&gt;&gt; </span>labels = predicted_token_class_ids
<span class="hljs-meta">&gt;&gt;&gt; </span>loss = model(**inputs, labels=labels).loss
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-built_in">round</span>(loss.item(), <span class="hljs-number">2</span>)
`}}),{c(){k(n.$$.fragment)},l(r){v(n.$$.fragment,r)},m(r,m){$(n,r,m),f=!0},p:D,i(r){f||(w(n.$$.fragment,r),f=!0)},o(r){T(n.$$.fragment,r),f=!1},d(r){N(n,r)}}}function vi(F){let n,f,r,m,y;return{c(){n=a("p"),f=d("Although the recipe for forward pass needs to be defined within this function, one should call the "),r=a("code"),m=d("Module"),y=d(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(s){n=i(s,"P",{});var p=l(n);f=c(p,"Although the recipe for forward pass needs to be defined within this function, one should call the "),r=i(p,"CODE",{});var M=l(r);m=c(M,"Module"),M.forEach(t),y=c(p,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),p.forEach(t)},m(s,p){b(s,n,p),e(n,f),e(n,r),e(r,m),e(n,y)},d(s){s&&t(n)}}}function $i(F){let n,f,r,m,y;return m=new W({props:{code:`from transformers import AutoTokenizer, NystromformerForQuestionAnswering
import torch
...
`}}),{c(){n=a("p"),f=d("Example:"),r=g(),k(m.$$.fragment)},l(s){n=i(s,"P",{});var p=l(n);f=c(p,"Example:"),p.forEach(t),r=_(s),v(m.$$.fragment,s)},m(s,p){b(s,n,p),e(n,f),b(s,r,p),$(m,s,p),y=!0},p:D,i(s){y||(w(m.$$.fragment,s),y=!0)},o(s){T(m.$$.fragment,s),y=!1},d(s){s&&t(n),s&&t(r),N(m,s)}}}function wi(F){let n,f;return n=new W({props:{code:`# target is "nice puppet"
...
<p>Indices can be obtained using <a href="/docs/transformers/v4.21.0/en/model_doc/auto#transformers.AutoTokenizer">AutoTokenizer</a>. See <a href="/docs/transformers/v4.21.0/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
...
elements depending on the configuration (<a
  href="/docs/transformers/v4.21.0/en/model_doc/nystromformer#transformers.NystromformerConfig"
...
loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.21.0/src/transformers/models/nystromformer/modeling_nystromformer.py#L680",returnDescription:`
<p>A <a
...
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.21.0/src/transformers/models/nystromformer/modeling_nystromformer.py#L778",returnDescription:`
<p>A <a
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/v4.21.0/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/v4.21.0/src/transformers/models/nystromformer/modeling_nystromformer.py#L862"}}),wo=new L({props:{name:"forward",anchor:"transformers.NystromformerForMultipleChoice.forward",parameters:[{name:"input_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"attention_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"token_type_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"position_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"head_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"labels",val:": typing.Optional[torch.LongTensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.NystromformerForMultipleChoice.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, num_choices, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/v4.21.0/en/model_doc/auto#transformers.AutoTokenizer">AutoTokenizer</a>. See <a href="/docs/transformers/v4.21.0/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/v4.21.0/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
<code>input_ids</code> above)`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.21.0/src/transformers/models/nystromformer/modeling_nystromformer.py#L873",returnDescription:`
<p>A <a
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.21.0/src/transformers/models/nystromformer/modeling_nystromformer.py#L970",returnDescription:`
<p>A <a
...
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/v4.21.0/src/transformers/models/nystromformer/modeling_nystromformer.py#L1050",returnDescription:`
<p>A <a
...
behavior.`),cn=g(),Q=a("div"),k(lo.$$.fragment),mn=g(),oe=a("p"),pn=d("The "),Ho=a("a"),fn=d("NystromformerModel"),hn=d(" forward method, overrides the "),gt=a("code"),un=d("__call__"),gn=d(" special method."),_n=g(),k(ve.$$.fragment),yn=g(),k($e.$$.fragment),is=g(),te=a("h2"),we=a("a"),_t=a("span"),k(co.$$.fragment),bn=g(),yt=a("span"),kn=d("NystromformerForMaskedLM"),ls=g(),B=a("div"),k(mo.$$.fragment),vn=g(),se=a("p"),$n=d("Nystr\xF6mformer Model with a "),bt=a("code"),wn=d("language modeling"),Tn=d(` head on top.
This model is a PyTorch `),po=a("a"),Nn=d("torch.nn.Module"),Fn=d(` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),Mn=g(),q=a("div"),k(fo.$$.fragment),xn=g(),ne=a("p"),qn=d("The "),Uo=a("a"),zn=d("NystromformerForMaskedLM"),jn=d(" forward method, overrides the "),kt=a("code"),Cn=d("__call__"),An=d(" special method."),En=g(),k(Te.$$.fragment),Pn=g(),k(Ne.$$.fragment),On=g(),k(Fe.$$.fragment),ds=g(),re=a("h2"),Me=a("a"),vt=a("span"),k(ho.$$.fragment),Sn=g(),$t=a("span"),Ln=d("NystromformerForSequenceClassification"),cs=g(),E=a("div"),k(uo.$$.fragment),In=g(),wt=a("p"),Dn=d(`Nystr\xF6mformer Model transformer with a sequence classification/regression head on top (a linear layer on top of the
...
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),mr=g(),H=a("div"),k(wo.$$.fragment),pr=g(),le=a("p"),fr=d("The "),Ro=a("a"),hr=d("NystromformerForMultipleChoice"),ur=d(" forward method, overrides the "),xt=a("code"),gr=d("__call__"),_r=d(" special method."),yr=g(),k(Ee.$$.fragment),br=g(),k(Pe.$$.fragment),fs=g(),de=a("h2"),Oe=a("a"),qt=a("span"),k(To.$$.fragment),kr=g(),zt=a("span"),vr=d("NystromformerForTokenClassification"),hs=g(),O=a("div"),k(No.$$.fragment),$r=g(),jt=a("p"),wr=d(`Nystr\xF6mformer Model with a token classification head on top (a linear layer on top of the hidden-states output)
...
documentation from `),Qo=i(Yo,"A",{href:!0});var ma=l(Qo);en=c(ma,"PretrainedConfig"),ma.forEach(t),on=c(Yo," for more information."),Yo.forEach(t),tn=_(Ue),v(be.$$.fragment,Ue),Ue.forEach(t),rs=_(o),ee=i(o,"H2",{class:!0});var ys=l(ee);ke=i(ys,"A",{id:!0,class:!0,href:!0});var pa=l(ke);ht=i(pa,"SPAN",{});var fa=l(ht);v(no.$$.fragment,fa),fa.forEach(t),pa.forEach(t),sn=_(ys),ut=i(ys,"SPAN",{});var ha=l(ut);nn=c(ha,"NystromformerModel"),ha.forEach(t),ys.forEach(t),as=_(o),U=i(o,"DIV",{class:!0});var Jo=l(U);v(ro.$$.fragment,Jo),rn=_(Jo),ao=i(Jo,"P",{});var bs=l(ao);an=c(bs,`The bare Nystr\xF6mformer Model transformer outputting raw hidden-states without any specific head on top.
This model is a PyTorch `),io=i(bs,"A",{href:!0,rel:!0});var ua=l(io);ln=c(ua,"torch.nn.Module"),ua.forEach(t),dn=c(bs,` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),bs.forEach(t),cn=_(Jo),Q=i(Jo,"DIV",{class:!0});var Be=l(Q);v(lo.$$.fragment,Be),mn=_(Be),oe=i(Be,"P",{});var Zo=l(oe);pn=c(Zo,"The "),Ho=i(Zo,"A",{href:!0});var ga=l(Ho);fn=c(ga,"NystromformerModel"),ga.forEach(t),hn=c(Zo," forward method, overrides the "),gt=i(Zo,"CODE",{});var _a=l(gt);un=c(_a,"__call__"),_a.forEach(t),gn=c(Zo," special method."),Zo.forEach(t),_n=_(Be),v(ve.$$.fragment,Be),yn=_(Be),v($e.$$.fragment,Be),Be.forEach(t),Jo.forEach(t),is=_(o),te=i(o,"H2",{class:!0});var ks=l(te);we=i(ks,"A",{id:!0,class:!0,href:!0});var ya=l(we);_t=i(ya,"SPAN",{});var ba=l(_t);v(co.$$.fragment,ba),ba.forEach(t),ya.forEach(t),bn=_(ks),yt=i(ks,"SPAN",{});var ka=l(yt);kn=c(ka,"NystromformerForMaskedLM"),ka.forEach(t),ks.forEach(t),ls=_(o),B=i(o,"DIV",{class:!0});var Xo=l(B);v(mo.$$.fragment,Xo),vn=_(Xo),se=i(Xo,"P",{});var et=l(se);$n=c(et,"Nystr\xF6mformer Model with a "),bt=i(et,"CODE",{});var va=l(bt);wn=c(va,"language modeling"),va.forEach(t),Tn=c(et,` head on top.
This model is a PyTorch `),po=i(et,"A",{href:!0,rel:!0});var $a=l(po);Nn=c($a,"torch.nn.Module"),$a.forEach(t),Fn=c(et,` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),et.forEach(t),Mn=_(Xo),q=i(Xo,"DIV",{class:!0});var V=l(q);v(fo.$$.fragment,V),xn=_(V),ne=i(V,"P",{});var ot=l(ne);qn=c(ot,"The "),Uo=i(ot,"A",{href:!0});var wa=l(Uo);zn=c(wa,"NystromformerForMaskedLM"),wa.forEach(t),jn=c(ot," forward method, overrides the "),kt=i(ot,"CODE",{});var Ta=l(kt);Cn=c(Ta,"__call__"),Ta.forEach(t),An=c(ot," special method."),ot.forEach(t),En=_(V),v(Te.$$.fragment,V),Pn=_(V),v(Ne.$$.fragment,V),On=_(V),v(Fe.$$.fragment,V),V.forEach(t),Xo.forEach(t),ds=_(o),re=i(o,"H2",{class:!0});var vs=l(re);Me=i(vs,"A",{id:!0,class:!0,href:!0});var Na=l(Me);vt=i(Na,"SPAN",{});var Fa=l(vt);v(ho.$$.fragment,Fa),Fa.forEach(t),Na.forEach(t),Sn=_(vs),$t=i(vs,"SPAN",{});var Ma=l($t);Ln=c(Ma,"NystromformerForSequenceClassification"),Ma.forEach(t),vs.forEach(t),cs=_(o),E=i(o,"DIV",{class:!0});var Re=l(E);v(uo.$$.fragment,Re),In=_(Re),wt=i(Re,"P",{});var xa=l(wt);Dn=c(xa,`Nystr\xF6mformer Model transformer with a sequence classification/regression head on top (a linear layer on top of the
pooled output) e.g. for GLUE tasks.`),xa.forEach(t),Wn=_(Re),go=i(Re,"P",{});var $s=l(go);Qn=c($s,"This model is a PyTorch "),_o=i($s,"A",{href:!0,rel:!0});var qa=l(_o);Hn=c(qa,"torch.nn.Module"),qa.forEach(t),Un=c($s,` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),$s.forEach(t),Bn=_(Re),x=i(Re,"DIV",{class:!0});var C=l(x);v(yo.$$.fragment,C),Rn=_(C),ae=i(C,"P",{});var tt=l(ae);Vn=c(tt,"The "),Bo=i(tt,"A",{href:!0});var za=l(Bo);Gn=c(za,"NystromformerForSequenceClassification"),za.forEach(t),Kn=c(tt," forward method, overrides the "),Tt=i(tt,"CODE",{});var ja=l(Tt);Yn=c(ja,"__call__"),ja.forEach(t),Jn=c(tt," special method."),tt.forEach(t),Zn=_(C),v(xe.$$.fragment,C),Xn=_(C),v(qe.$$.fragment,C),er=_(C),v(ze.$$.fragment,C),or=_(C),v(je.$$.fragment,C),tr=_(C),v(Ce.$$.fragment,C),C.forEach(t),Re.forEach(t),ms=_(o),ie=i(o,"H2",{class:!0});var ws=l(ie);Ae=i(ws,"A",{id:!0,class:!0,href:!0});var Ca=l(Ae);Nt=i(Ca,"SPAN",{});var Aa=l(Nt);v(bo.$$.fragment,Aa),Aa.forEach(t),Ca.forEach(t),sr=_(ws),Ft=i(ws,"SPAN",{});var Ea=l(Ft);nr=c(Ea,"NystromformerForMultipleChoice"),Ea.forEach(t),ws.forEach(t),ps=_(o),P=i(o,"DIV",{class:!0});var Ve=l(P);v(ko.$$.fragment,Ve),rr=_(Ve),Mt=i(Ve,"P",{});var Pa=l(Mt);ar=c(Pa,`Nystr\xF6mformer Model with a multiple choice classification head on top (a linear layer on top of the pooled output
and a softmax) e.g. for RocStories/SWAG tasks.`),Pa.forEach(t),ir=_(Ve),vo=i(Ve,"P",{});var Ts=l(vo);lr=c(Ts,"This model is a PyTorch "),$o=i(Ts,"A",{href:!0,rel:!0});var Oa=l($o);dr=c(Oa,"torch.nn.Module"),Oa.forEach(t),cr=c(Ts,` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),Ts.forEach(t),mr=_(Ve),H=i(Ve,"DIV",{class:!0});var Ge=l(H);v(wo.$$.fragment,Ge),pr=_(Ge),le=i(Ge,"P",{});var st=l(le);fr=c(st,"The "),Ro=i(st,"A",{href:!0});var Sa=l(Ro);hr=c(Sa,"NystromformerForMultipleChoice"),Sa.forEach(t),ur=c(st," forward method, overrides the "),xt=i(st,"CODE",{});var La=l(xt);gr=c(La,"__call__"),La.forEach(t),_r=c(st," special method."),st.forEach(t),yr=_(Ge),v(Ee.$$.fragment,Ge),br=_(Ge),v(Pe.$$.fragment,Ge),Ge.forEach(t),Ve.forEach(t),fs=_(o),de=i(o,"H2",{class:!0});var Ns=l(de);Oe=i(Ns,"A",{id:!0,class:!0,href:!0});var Ia=l(Oe);qt=i(Ia,"SPAN",{});var Da=l(qt);v(To.$$.fragment,Da),Da.forEach(t),Ia.forEach(t),kr=_(Ns),zt=i(Ns,"SPAN",{});var Wa=l(zt);vr=c(Wa,"NystromformerForTokenClassification"),Wa.forEach(t),Ns.forEach(t),hs=_(o),O=i(o,"DIV",{class:!0});var Ke=l(O);v(No.$$.fragment,Ke),$r=_(Ke),jt=i(Ke,"P",{});var Qa=l(jt);wr=c(Qa,`Nystr\xF6mformer Model with a token classification head on top (a linear layer on top of the hidden-states output)
...
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),Fs.forEach(t),xr=_(Ke),z=i(Ke,"DIV",{class:!0});var G=l(z);v(xo.$$.fragment,G),qr=_(G),ce=i(G,"P",{});var nt=l(ce);zr=c(nt,"The "),Vo=i(nt,"A",{href:!0});var Ua=l(Vo);jr=c(Ua,"NystromformerForTokenClassification"),Ua.forEach(t),Cr=c(nt," forward method, overrides the "),Ct=i(nt,"CODE",{});var Ba=l(Ct);Ar=c(Ba,"__call__"),Ba.forEach(t),Er=c(nt," special method."),nt.forEach(t),Pr=_(G),v(Se.$$.fragment,G),Or=_(G),v(Le.$$.fragment,G),Sr=_(G),v(Ie.$$.fragment,G),G.forEach(t),Ke.forEach(t),us=_(o),me=i(o,"H2",{class:!0});var Ms=l(me);De=i(Ms,"A",{id:!0,class:!0,href:!0});var Ra=l(De);At=i(Ra,"SPAN",{});var Va=l(At);v(qo.$$.fragment,Va),Va.forEach(t),Ra.forEach(t),Lr=_(Ms),Et=i(Ms,"SPAN",{});var Ga=l(Et);Ir=c(Ga,"NystromformerForQuestionAnswering"),Ga.forEach(t),Ms.forEach(t),gs=_(o),S=i(o,"DIV",{class:!0});var Ye=l(S);v(zo.$$.fragment,Ye),Dr=_(Ye),pe=i(Ye,"P",{});var rt=l(pe);Wr=c(rt,`Nystr\xF6mformer Model with a span classification head on top for extractive question-answering tasks like SQuAD (a
