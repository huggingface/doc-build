...
`),R=r(ke,"CODE",{});var Ne=i(R);ne=s(Ne,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),Ne.forEach(t),ke.forEach(t),A.forEach(t)},m(y,x){g(y,d,x),e(d,T),g(y,c,x),g(y,p,x),e(p,v),e(v,l),e(p,m),e(p,G),e(G,he),g(y,K,x),g(y,J,x),e(J,X),e(J,D),e(D,Z),e(J,ue),e(J,W),e(W,me),e(J,re),g(y,I,x),g(y,L,x),e(L,ee),g(y,te,x),g(y,E,x),e(E,M),e(M,fe),e(M,B),e(B,ie),e(M,Y),e(M,H),e(H,oe),e(E,ge),e(E,q),e(q,le),e(q,N),e(N,_e),e(q,de),e(q,O),e(O,U),e(E,Te),e(E,z),e(z,ve),e(z,R),e(R,ne)},d(y){y&&t(d),y&&t(c),y&&t(p),y&&t(K),y&&t(J),y&&t(I),y&&t(L),y&&t(te),y&&t(E)}}}function jf(j){let d,T,c,p,v;return{c(){d=a("p"),T=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),c=a("code"),p=n("Module"),v=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(l){d=r(l,"P",{});var m=i(d);T=s(m,"Although the recipe for forward pass needs to be defined within this function, one should call the "),c=r(m,"CODE",{});var G=i(c);p=s(G,"Module"),G.forEach(t),v=s(m,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),{c(){d=a("p"),T=n("Example:"),c=h(),k(p.$$.fragment)},l(l){d=r(l,"P",{});var m=i(d);T=s(m,"Example:"),m.forEach(t),c=u(l),b(p.$$.fragment,l)},m(l,m){g(l,d,m),e(d,T),g(l,c,m),w(p,l,m),v=!0},p:Ee,i(l){v||($(p.$$.fragment,l),v=!0)},o(l){P(p.$$.fragment,l),v=!1},d(l){l&&t(d),l&&t(c),F(p,l)}}}function xf(j){let d,T,c,p,v,l,m,G,he,K,J,X,D,Z,ue,W,me,re,I,L,ee,te,E,M,fe,B,ie,Y,H,oe,ge,q,le,N,_e,de,O,U,Te,z,ve,R,ne;return{c(){d=a("p"),T=n("TF 2.0 models accepts two formats as inputs:"),c=h(),p=a("ul"),v=a("li"),l=n("having all inputs as keyword arguments (like PyTorch models), or"),m=h(),G=a("li"),he=n("having all inputs as a list, tuple or dict in the first positional arguments."),K=h(),J=a("p"),X=n("This second option is useful when using "),D=a("code"),Z=n("tf.keras.Model.fit"),ue=n(` method which currently requires having all the
tensors in the first argument of the model call function: `),W=a("code"),me=n("model(inputs)"),re=n("."),I=h(),L=a("p"),ee=n(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),te=h(),E=a("ul"),M=a("li"),fe=n("a single Tensor with "),B=a("code"),ie=n("input_ids"),Y=n(" only and nothing else: "),H=a("code"),oe=n("model(inputs_ids)"),ge=h(),q=a("li"),le=n(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),N=a("code"),_e=n("model([input_ids, attention_mask])"),de=n(" or "),O=a("code"),U=n("model([input_ids, attention_mask, token_type_ids])"),Te=h(),z=a("li"),ve=n(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),R=a("code"),ne=n('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(y){d=r(y,"P",{});var x=i(d);T=s(x,"TF 2.0 models accepts two formats as inputs:"),x.forEach(t),c=u(y),p=r(y,"UL",{});var V=i(p);v=r(V,"LI",{});var ze=i(v);l=s(ze,"having all inputs as keyword arguments (like PyTorch models), or"),ze.forEach(t),m=u(V),G=r(V,"LI",{});var Ce=i(G);he=s(Ce,"having all inputs as a list, tuple or dict in the first positional arguments."),Ce.forEach(t),V.forEach(t),K=u(y),J=r(y,"P",{});var C=i(J);X=s(C,"This second option is useful when using "),D=r(C,"CODE",{});var Ae=i(D);Z=s(Ae,"tf.keras.Model.fit"),Ae.forEach(t),ue=s(C,` method which currently requires having all the
...
<span class="hljs-meta">&gt;&gt;&gt; </span>inputs = tokenizer(<span class="hljs-string">&quot;Hello, my dog is cute&quot;</span>, return_tensors=<span class="hljs-string">&quot;tf&quot;</span>)
<span class="hljs-meta">&gt;&gt;&gt; </span>outputs = model(inputs)
<span class="hljs-meta">&gt;&gt;&gt; </span>logits = outputs.logits`}}),{c(){d=a("p"),T=n("Example:"),c=h(),k(p.$$.fragment)},l(l){d=r(l,"P",{});var m=i(d);T=s(m,"Example:"),m.forEach(t),c=u(l),b(p.$$.fragment,l)},m(l,m){g(l,d,m),e(d,T),g(l,c,m),w(p,l,m),v=!0},p:Ee,i(l){v||($(p.$$.fragment,l),v=!0)},o(l){P(p.$$.fragment,l),v=!1},d(l){l&&t(d),l&&t(c),F(p,l)}}}function Mf(j){let d,T,c,p,v,l,m,G,he,K,J,X,D,Z,ue,W,me,re,I,L,ee,te,E,M,fe,B,ie,Y,H,oe,ge,q,le,N,_e,de,O,U,Te,z,ve,R,ne;return{c(){d=a("p"),T=n("TF 2.0 models accepts two formats as inputs:"),c=h(),p=a("ul"),v=a("li"),l=n("having all inputs as keyword arguments (like PyTorch models), or"),m=h(),G=a("li"),he=n("having all inputs as a list, tuple or dict in the first positional arguments."),K=h(),J=a("p"),X=n("This second option is useful when using "),D=a("code"),Z=n("tf.keras.Model.fit"),ue=n(` method which currently requires having all the
tensors in the first argument of the model call function: `),W=a("code"),me=n("model(inputs)"),re=n("."),I=h(),L=a("p"),ee=n(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),te=h(),E=a("ul"),M=a("li"),fe=n("a single Tensor with "),B=a("code"),ie=n("input_ids"),Y=n(" only and nothing else: "),H=a("code"),oe=n("model(inputs_ids)"),ge=h(),q=a("li"),le=n(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),N=a("code"),_e=n("model([input_ids, attention_mask])"),de=n(" or "),O=a("code"),U=n("model([input_ids, attention_mask, token_type_ids])"),Te=h(),z=a("li"),ve=n(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),R=a("code"),ne=n('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(y){d=r(y,"P",{});var x=i(d);T=s(x,"TF 2.0 models accepts two formats as inputs:"),x.forEach(t),c=u(y),p=r(y,"UL",{});var V=i(p);v=r(V,"LI",{});var ze=i(v);l=s(ze,"having all inputs as keyword arguments (like PyTorch models), or"),ze.forEach(t),m=u(V),G=r(V,"LI",{});var Ce=i(G);he=s(Ce,"having all inputs as a list, tuple or dict in the first positional arguments."),Ce.forEach(t),V.forEach(t),K=u(y),J=r(y,"P",{});var C=i(J);X=s(C,"This second option is useful when using "),D=r(C,"CODE",{});var Ae=i(D);Z=s(Ae,"tf.keras.Model.fit"),Ae.forEach(t),ue=s(C,` method which currently requires having all the
...
`}}),{c(){k(d.$$.fragment)},l(c){b(d.$$.fragment,c)},m(c,p){w(d,c,p),T=!0},p:Ee,i(c){T||($(d.$$.fragment,c),T=!0)},o(c){P(d.$$.fragment,c),T=!1},d(c){F(d,c)}}}function Af(j){let d,T,c,p,v,l,m,G,he,K,J,X,D,Z,ue,W,me,re,I,L,ee,te,E,M,fe,B,ie,Y,H,oe,ge,q,le,N,_e,de,O,U,Te,z,ve,R,ne;return{c(){d=a("p"),T=n("TF 2.0 models accepts two formats as inputs:"),c=h(),p=a("ul"),v=a("li"),l=n("having all inputs as keyword arguments (like PyTorch models), or"),m=h(),G=a("li"),he=n("having all inputs as a list, tuple or dict in the first positional arguments."),K=h(),J=a("p"),X=n("This second option is useful when using "),D=a("code"),Z=n("tf.keras.Model.fit"),ue=n(` method which currently requires having all the
tensors in the first argument of the model call function: `),W=a("code"),me=n("model(inputs)"),re=n("."),I=h(),L=a("p"),ee=n(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),te=h(),E=a("ul"),M=a("li"),fe=n("a single Tensor with "),B=a("code"),ie=n("input_ids"),Y=n(" only and nothing else: "),H=a("code"),oe=n("model(inputs_ids)"),ge=h(),q=a("li"),le=n(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),N=a("code"),_e=n("model([input_ids, attention_mask])"),de=n(" or "),O=a("code"),U=n("model([input_ids, attention_mask, token_type_ids])"),Te=h(),z=a("li"),ve=n(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),R=a("code"),ne=n('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(y){d=r(y,"P",{});var x=i(d);T=s(x,"TF 2.0 models accepts two formats as inputs:"),x.forEach(t),c=u(y),p=r(y,"UL",{});var V=i(p);v=r(V,"LI",{});var ze=i(v);l=s(ze,"having all inputs as keyword arguments (like PyTorch models), or"),ze.forEach(t),m=u(V),G=r(V,"LI",{});var Ce=i(G);he=s(Ce,"having all inputs as a list, tuple or dict in the first positional arguments."),Ce.forEach(t),V.forEach(t),K=u(y),J=r(y,"P",{});var C=i(J);X=s(C,"This second option is useful when using "),D=r(C,"CODE",{});var Ae=i(D);Z=s(Ae,"tf.keras.Model.fit"),Ae.forEach(t),ue=s(C,` method which currently requires having all the
...
<span class="hljs-meta">&gt;&gt;&gt; </span>next_token_logits = outputs.logits[:, -<span class="hljs-number">1</span>]`}}),{c(){d=a("p"),T=n("Example:"),c=h(),k(p.$$.fragment)},l(l){d=r(l,"P",{});var m=i(d);T=s(m,"Example:"),m.forEach(t),c=u(l),b(p.$$.fragment,l)},m(l,m){g(l,d,m),e(d,T),g(l,c,m),w(p,l,m),v=!0},p:Ee,i(l){v||($(p.$$.fragment,l),v=!0)},o(l){P(p.$$.fragment,l),v=!1},d(l){l&&t(d),l&&t(c),F(p,l)}}}function Uf(j){let d,T,c,p,v,l,m,G,he,K,J,X,D,Z,ue,W,me,re,I,L,ee,te,E,M,fe,B,ie,Y,H,oe,ge,q,le,N,_e,de,O,U,Te,z,ve,R,ne,y,x,V,ze,Ce,C,Ae,Le,Me,A,Q,ce,Pe,S,Ie,ye,ke,Ne,ta,ct,Ni,Ro,Oi,Si,oa,Di,Wi,na,Ui,Qi,Lr,bt,Ht,sa,Vo,Bi,aa,Hi,Ir,Rt,Ri,_s,Vi,Ki,Nr,Ko,Or,Ts,Xi,Sr,Xo,Dr,wt,Vt,ra,Yo,Yi,ia,Zi,Wr,pt,Zo,el,Re,tl,vs,ol,nl,en,sl,al,ys,rl,il,ks,ll,dl,cl,Kt,Ur,$t,Xt,la,tn,pl,da,hl,Qr,ht,on,ul,nn,ml,sn,fl,gl,_l,et,an,Tl,Pt,vl,bs,yl,kl,ca,bl,wl,$l,Yt,Pl,Zt,Br,Ft,eo,pa,rn,Fl,ha,jl,Hr,Ve,ln,Gl,ua,xl,Jl,dn,El,cn,Ml,ql,zl,tt,pn,Cl,jt,Al,ws,Ll,Il,ma,Nl,Ol,Sl,to,Dl,oo,Rr,Gt,no,fa,hn,Wl,ga,Ul,Vr,Fe,un,Ql,_a,Bl,Hl,$s,Ps,Rl,Vl,Kl,Ke,Xl,Ta,Yl,Zl,va,ed,td,ya,od,nd,ka,sd,ad,rd,mn,id,fn,ld,dd,cd,$e,gn,pd,xt,hd,Fs,ud,md,ba,fd,gd,_d,so,Td,ao,vd,ro,yd,io,kd,lo,Kr,Jt,co,wa,_n,bd,$a,wd,Xr,Xe,Tn,$d,Et,Pd,Pa,Fd,jd,Fa,Gd,xd,Jd,vn,Ed,yn,Md,qd,zd,Oe,kn,Cd,Mt,Ad,js,Ld,Id,ja,Nd,Od,Sd,po,Dd,ho,Wd,uo,Yr,qt,mo,Ga,bn,Ud,xa,Qd,Zr,je,wn,Bd,Ja,Hd,Rd,$n,Vd,Gs,Kd,Xd,Yd,Pn,Zd,Fn,ec,tc,oc,fo,nc,ot,jn,sc,zt,ac,xs,rc,ic,Ea,lc,dc,cc,go,pc,_o,ei,Ct,To,Ma,Gn,hc,qa,uc,ti,Ge,xn,mc,za,fc,gc,Jn,_c,Js,Tc,vc,yc,En,kc,Mn,bc,wc,$c,vo,Pc,nt,qn,Fc,At,jc,Es,Gc,xc,Ca,Jc,Ec,Mc,yo,qc,ko,oi,Lt,bo,Aa,zn,zc,La,Cc,ni,se,Cn,Ac,Ia,Lc,Ic,Ms,qs,Nc,Oc,Sc,Ye,Dc,Na,Wc,Uc,Oa,Qc,Bc,Sa,Hc,Rc,Da,Vc,Kc,Xc,An,Yc,zs,Zc,ep,tp,Ln,op,In,np,sp,ap,wo,rp,Se,Nn,ip,It,lp,Cs,dp,cp,Wa,pp,hp,up,$o,mp,Po,fp,Fo,si,Nt,jo,Ua,On,gp,Qa,_p,ai,xe,Sn,Tp,Ot,vp,Ba,yp,kp,Ha,bp,wp,$p,Dn,Pp,As,Fp,jp,Gp,Wn,xp,Un,Jp,Ep,Mp,Go,qp,De,Qn,zp,St,Cp,Ls,Ap,Lp,Ra,Ip,Np,Op,xo,Sp,Jo,Dp,Eo,ri,Dt,Mo,Va,Bn,Wp,Ka,Up,ii,be,Hn,Qp,Xa,Bp,Hp,Rn,Rp,Is,Vp,Kp,Xp,Vn,Yp,Kn,Zp,eh,th,Ya,oh,nh,ut,Za,Xn,sh,ah,er,Yn,rh,ih,tr,Zn,lh,dh,or,es,ch,ph,st,ts,hh,Wt,uh,nr,mh,fh,sr,gh,_h,Th,qo,vh,zo,li,Ut,Co,ar,os,yh,rr,kh,di,we,ns,bh,ir,wh,$h,ss,Ph,Ns,Fh,jh,Gh,as,xh,rs,Jh,Eh,Mh,lr,qh,zh,mt,dr,is,Ch,Ah,cr,ls,Lh,Ih,pr,ds,Nh,Oh,hr,cs,Sh,Dh,at,ps,Wh,Qt,Uh,ur,Qh,Bh,mr,Hh,Rh,Vh,Ao,Kh,Lo,ci;return l=new He({}),Z=new He({}),A=new pe({props:{code:`from transformers import GPTJForCausalLM
import torch
...
<code>inputs_ids</code> passed when calling <a href="/docs/transformers/v4.21.0/en/model_doc/gptj#transformers.GPTJModel">GPTJModel</a>.`,name:"vocab_size"},{anchor:"transformers.GPTJConfig.n_positions",description:`<strong>n_positions</strong> (<code>int</code>, <em>optional</em>, defaults to 2048) &#x2014;
...
Whether or not to return a <a href="/docs/transformers/v4.21.0/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/v4.21.0/src/transformers/models/gptj/modeling_gptj.py#L537",returnDescription:`
<p>A <a
...
elements depending on the configuration (<a
  href="/docs/transformers/v4.21.0/en/model_doc/gptj#transformers.GPTJConfig"
...
are ignored (masked), the loss is only computed for labels in <code>[0, ..., config.vocab_size]</code>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.21.0/src/transformers/models/gptj/modeling_gptj.py#L791",returnDescription:`
<p>A <a
...
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.21.0/src/transformers/models/gptj/modeling_gptj.py#L913",returnDescription:`
...
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/v4.21.0/src/transformers/models/gptj/modeling_gptj.py#L1040",returnDescription:`
<p>A <a
...
<p>Indices can be obtained using <code>GPTJTokenizer</code>. See <a href="/docs/transformers/v4.21.0/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
...
Whether or not to return a <a href="/docs/transformers/v4.21.0/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple. This argument can be used
...
<code>past</code>). Set to <code>False</code> during training, <code>True</code> during generation`,name:"use_cache"}],source:"https://github.com/huggingface/transformers/blob/v4.21.0/src/transformers/models/gptj/modeling_tf_gptj.py#L650",returnDescription:`
<p>A <a
...
Labels for language modeling. Note that the labels <strong>are shifted</strong> inside the model, i.e. you can set
<code>labels = input_ids</code> Indices are selected in <code>[-100, 0, ..., config.vocab_size]</code> All labels set to <code>-100</code>
are ignored (masked), the loss is only computed for labels in <code>[0, ..., config.vocab_size]</code>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.21.0/src/transformers/models/gptj/modeling_tf_gptj.py#L754",returnDescription:`
<p>A <a
...
Labels for computing the sequence classification/regression loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>. If <code>config.num_labels == 1</code> a regression loss is computed (Mean-Square loss), If
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.21.0/src/transformers/models/gptj/modeling_tf_gptj.py#L858",returnDescription:`
<p>A <a
  href="/docs/transformers/v4.21.0/en/model_doc/gpt2#transformers.modeling_tf_outputs.TFSequenceClassifierOutputWithPast"
...
Labels for position (index) of the end of the labelled span for computing the token classification loss.
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/v4.21.0/src/transformers/models/gptj/modeling_tf_gptj.py#L981",returnDescription:`
<p>A <a
...
causal language model trained on `),M=a("a"),fe=n("the Pile"),B=n(" dataset."),ie=h(),Y=a("p"),H=n("This model was contributed by "),oe=a("a"),ge=n("Stella Biderman"),q=n("."),le=h(),N=a("p"),_e=n("Tips:"),de=h(),O=a("ul"),U=a("li"),Te=n("To load "),z=a("a"),ve=n("GPT-J"),R=n(` in float32 one would need at least 2x model size CPU
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),ap=h(),k(wo.$$.fragment),rp=h(),Se=a("div"),k(Nn.$$.fragment),ip=h(),It=a("p"),lp=n("The "),Cs=a("a"),dp=n("TFGPTJForSequenceClassification"),cp=n(" forward method, overrides the "),Wa=a("code"),pp=n("__call__"),hp=n(" special method."),up=h(),k($o.$$.fragment),mp=h(),k(Po.$$.fragment),fp=h(),k(Fo.$$.fragment),si=h(),Nt=a("h2"),jo=a("a"),Ua=a("span"),k(On.$$.fragment),gp=h(),Qa=a("span"),_p=n("TFGPTJForQuestionAnswering"),ai=h(),xe=a("div"),k(Sn.$$.fragment),Tp=h(),Ot=a("p"),vp=n(`The GPT-J Model transformer with a span classification head on top for extractive question-answering tasks like
