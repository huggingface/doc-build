import{S as cm,i as pm,s as hm,e as a,k as m,w as k,t as r,M as mm,c as i,d as o,m as g,a as l,x as M,h as s,b as f,G as e,g as b,y as T,q as w,o as $,B as y,v as gm,L as j}from"../../chunks/vendor-hf-doc-builder.js";import{T as We}from"../../chunks/Tip-hf-doc-builder.js";import{D as P}from"../../chunks/Docstring-hf-doc-builder.js";import{C as z}from"../../chunks/CodeBlock-hf-doc-builder.js";import{I as te}from"../../chunks/IconCopyLink-hf-doc-builder.js";import{E}from"../../chunks/ExampleCodeBlock-hf-doc-builder.js";function um(B){let d,_,c,h,v;return h=new z({props:{code:`from transformers import MegatronBertModel, MegatronBertConfig
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),{c(){d=a("p"),_=r("Example:"),c=m(),k(h.$$.fragment)},l(n){d=i(n,"P",{});var p=l(d);_=s(p,"Example:"),p.forEach(o),c=g(n),M(h.$$.fragment,n)},m(n,p){b(n,d,p),e(d,_),b(n,c,p),T(h,n,p),v=!0},p:j,i(n){v||(w(h.$$.fragment,n),v=!0)},o(n){$(h.$$.fragment,n),v=!1},d(n){n&&o(d),n&&o(c),y(h,n)}}}function bm(B){let d,_,c,h,v;return{c(){d=a("p"),_=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),c=a("code"),h=r("Module"),v=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(n){d=i(n,"P",{});var p=l(d);_=s(p,"Although the recipe for forward pass needs to be defined within this function, one should call the "),c=i(p,"CODE",{});var F=l(c);h=s(F,"Module"),F.forEach(o),v=s(p,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
`}}),{c(){k(d.$$.fragment)},l(c){M(d.$$.fragment,c)},m(c,h){T(d,c,h),_=!0},p:j,i(c){_||(w(d.$$.fragment,c),_=!0)},o(c){$(d.$$.fragment,c),_=!1},d(c){y(d,c)}}}function Mm(B){let d,_,c,h,v;return{c(){d=a("p"),_=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),c=a("code"),h=r("Module"),v=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(n){d=i(n,"P",{});var p=l(d);_=s(p,"Although the recipe for forward pass needs to be defined within this function, one should call the "),c=i(p,"CODE",{});var F=l(c);h=s(F,"Module"),F.forEach(o),v=s(p,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),p.forEach(o)},m(n,p){b(n,d,p),e(d,_),e(d,c),e(c,h),e(d,v)},d(n){n&&o(d)}}}function Tm(B){let d,_,c,h,v;return h=new z({props:{code:`from transformers import BertTokenizer, MegatronBertForCausalLM, MegatronBertConfig
import torch
...
<span class="hljs-meta">&gt;&gt;&gt; </span>prediction_logits = outputs.logits`}}),{c(){d=a("p"),_=r("Example:"),c=m(),k(h.$$.fragment)},l(n){d=i(n,"P",{});var p=l(d);_=s(p,"Example:"),p.forEach(o),c=g(n),M(h.$$.fragment,n)},m(n,p){b(n,d,p),e(d,_),b(n,c,p),T(h,n,p),v=!0},p:j,i(n){v||(w(h.$$.fragment,n),v=!0)},o(n){$(h.$$.fragment,n),v=!1},d(n){n&&o(d),n&&o(c),y(h,n)}}}function wm(B){let d,_,c,h,v;return{c(){d=a("p"),_=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),c=a("code"),h=r("Module"),v=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(n){d=i(n,"P",{});var p=l(d);_=s(p,"Although the recipe for forward pass needs to be defined within this function, one should call the "),c=i(p,"CODE",{});var F=l(c);h=s(F,"Module"),F.forEach(o),v=s(p,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
`}}),{c(){d=a("p"),_=r("Example of single-label classification:"),c=m(),k(h.$$.fragment)},l(n){d=i(n,"P",{});var p=l(d);_=s(p,"Example of single-label classification:"),p.forEach(o),c=g(n),M(h.$$.fragment,n)},m(n,p){b(n,d,p),e(d,_),b(n,c,p),T(h,n,p),v=!0},p:j,i(n){v||(w(h.$$.fragment,n),v=!0)},o(n){$(h.$$.fragment,n),v=!1},d(n){n&&o(d),n&&o(c),y(h,n)}}}function xm(B){let d,_;return d=new z({props:{code:`# To train a model on \`num_labels\` classes, you can pass \`num_labels=num_labels\` to \`.from_pretrained(...)\`
...
`}}),{c(){k(d.$$.fragment)},l(c){M(d.$$.fragment,c)},m(c,h){T(d,c,h),_=!0},p:j,i(c){_||(w(d.$$.fragment,c),_=!0)},o(c){$(d.$$.fragment,c),_=!1},d(c){y(d,c)}}}function Pm(B){let d,_,c,h,v;return h=new z({props:{code:`import torch
from transformers import BertTokenizer, MegatronBertForSequenceClassification
...
<span class="hljs-meta">&gt;&gt;&gt; </span>predicted_class_id = logits.argmax().item()
<span class="hljs-meta">&gt;&gt;&gt; </span>model.config.id2label[predicted_class_id]
`}}),{c(){d=a("p"),_=r("Example of multi-label classification:"),c=m(),k(h.$$.fragment)},l(n){d=i(n,"P",{});var p=l(d);_=s(p,"Example of multi-label classification:"),p.forEach(o),c=g(n),M(h.$$.fragment,n)},m(n,p){b(n,d,p),e(d,_),b(n,c,p),T(h,n,p),v=!0},p:j,i(n){v||(w(h.$$.fragment,n),v=!0)},o(n){$(h.$$.fragment,n),v=!1},d(n){n&&o(d),n&&o(c),y(h,n)}}}function qm(B){let d,_;return d=new z({props:{code:`# To train a model on \`num_labels\` classes, you can pass \`num_labels=num_labels\` to \`.from_pretrained(...)\`
num_labels = len(model.config.id2label)
...
<span class="hljs-meta">... </span>)
<span class="hljs-meta">&gt;&gt;&gt; </span>loss = model(**inputs, labels=labels).loss
<span class="hljs-meta">&gt;&gt;&gt; </span>loss.backward()`}}),{c(){k(d.$$.fragment)},l(c){M(d.$$.fragment,c)},m(c,h){T(d,c,h),_=!0},p:j,i(c){_||(w(d.$$.fragment,c),_=!0)},o(c){$(d.$$.fragment,c),_=!1},d(c){y(d,c)}}}function Cm(B){let d,_,c,h,v;return{c(){d=a("p"),_=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),c=a("code"),h=r("Module"),v=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(n){d=i(n,"P",{});var p=l(d);_=s(p,"Although the recipe for forward pass needs to be defined within this function, one should call the "),c=i(p,"CODE",{});var F=l(c);h=s(F,"Module"),F.forEach(o),v=s(p,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
`}}),{c(){d=a("p"),_=r("Example:"),c=m(),k(h.$$.fragment)},l(n){d=i(n,"P",{});var p=l(d);_=s(p,"Example:"),p.forEach(o),c=g(n),M(h.$$.fragment,n)},m(n,p){b(n,d,p),e(d,_),b(n,c,p),T(h,n,p),v=!0},p:j,i(n){v||(w(h.$$.fragment,n),v=!0)},o(n){$(h.$$.fragment,n),v=!1},d(n){n&&o(d),n&&o(c),y(h,n)}}}function Am(B){let d,_;return d=new z({props:{code:`labels = predicted_token_class_ids
loss = model(**inputs, labels=labels).loss
round(loss.item(), 2)
`,highlighted:`<span class="hljs-meta">&gt;&gt;&gt; </span>labels = predicted_token_class_ids
<span class="hljs-meta">&gt;&gt;&gt; </span>loss = model(**inputs, labels=labels).loss
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-built_in">round</span>(loss.item(), <span class="hljs-number">2</span>)
`}}),{c(){k(d.$$.fragment)},l(c){M(d.$$.fragment,c)},m(c,h){T(d,c,h),_=!0},p:j,i(c){_||(w(d.$$.fragment,c),_=!0)},o(c){$(d.$$.fragment,c),_=!1},d(c){y(d,c)}}}function Lm(B){let d,_,c,h,v;return{c(){d=a("p"),_=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),c=a("code"),h=r("Module"),v=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(n){d=i(n,"P",{});var p=l(d);_=s(p,"Although the recipe for forward pass needs to be defined within this function, one should call the "),c=i(p,"CODE",{});var F=l(c);h=s(F,"Module"),F.forEach(o),v=s(p,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
`}}),{c(){d=a("p"),_=r("Example:"),c=m(),k(h.$$.fragment)},l(n){d=i(n,"P",{});var p=l(d);_=s(p,"Example:"),p.forEach(o),c=g(n),M(h.$$.fragment,n)},m(n,p){b(n,d,p),e(d,_),b(n,c,p),T(h,n,p),v=!0},p:j,i(n){v||(w(h.$$.fragment,n),v=!0)},o(n){$(h.$$.fragment,n),v=!1},d(n){n&&o(d),n&&o(c),y(h,n)}}}function Nm(B){let d,_;return d=new z({props:{code:`# target is "nice puppet"
...
<span class="hljs-meta">&gt;&gt;&gt; </span>loss = outputs.loss
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-built_in">round</span>(loss.item(), <span class="hljs-number">2</span>)
`}}),{c(){k(d.$$.fragment)},l(c){M(d.$$.fragment,c)},m(c,h){T(d,c,h),_=!0},p:j,i(c){_||(w(d.$$.fragment,c),_=!0)},o(c){$(d.$$.fragment,c),_=!1},d(c){y(d,c)}}}function Im(B){let d,_,c,h,v,n,p,F,$a,ls,fe,Re,Gn,Et,ya,Qn,Ba,ds,He,Fa,jt,za,xa,cs,nn,Pa,ps,rn,Vn,qa,hs,sn,Ca,ms,Ue,Ea,Ot,ja,Oa,gs,oe,Aa,At,La,Sa,Lt,Na,Ia,us,an,Da,fs,ln,Wa,_s,St,bs,dn,Ra,vs,Nt,ks,cn,Ha,Ms,ne,Ua,Jn,Ga,Qa,Kn,Va,Ja,Ts,It,ws,Dt,$s,re,Ka,Wt,Ya,Xa,Rt,Za,ei,ys,_e,Ge,Yn,Ht,ti,Xn,oi,Bs,J,Ut,ni,be,ri,pn,si,ai,Gt,ii,li,di,ve,ci,hn,pi,hi,mn,mi,gi,ui,Qe,Fs,ke,Ve,Zn,Qt,fi,er,_i,zs,x,Vt,bi,tr,vi,ki,Jt,Mi,gn,Ti,wi,$i,Kt,yi,Yt,Bi,Fi,zi,Xt,xi,Zt,Pi,qi,Ci,C,Ei,or,ji,Oi,nr,Ai,Li,rr,Si,Ni,sr,Ii,Di,ar,Wi,Ri,ir,Hi,Ui,Gi,K,eo,Qi,Me,Vi,un,Ji,Ki,lr,Yi,Xi,Zi,Je,el,Ke,xs,Te,Ye,dr,to,tl,cr,ol,Ps,O,oo,nl,no,rl,pr,sl,al,il,ro,ll,fn,dl,cl,pl,so,hl,ao,ml,gl,ul,R,io,fl,we,_l,_n,bl,vl,hr,kl,Ml,Tl,Xe,wl,Ze,$l,et,qs,$e,tt,mr,lo,yl,gr,Bl,Cs,A,co,Fl,po,zl,ur,xl,Pl,ql,ho,Cl,bn,El,jl,Ol,mo,Al,go,Ll,Sl,Nl,Y,uo,Il,ye,Dl,vn,Wl,Rl,fr,Hl,Ul,Gl,ot,Ql,nt,Es,Be,rt,_r,fo,Vl,br,Jl,js,L,_o,Kl,bo,Yl,vr,Xl,Zl,ed,vo,td,kn,od,nd,rd,ko,sd,Mo,ad,id,ld,X,To,dd,Fe,cd,Mn,pd,hd,kr,md,gd,ud,st,fd,at,Os,ze,it,Mr,wo,_d,Tr,bd,As,S,$o,vd,xe,kd,wr,Md,Td,$r,wd,$d,yd,yo,Bd,Tn,Fd,zd,xd,Bo,Pd,Fo,qd,Cd,Ed,Z,zo,jd,Pe,Od,wn,Ad,Ld,yr,Sd,Nd,Id,lt,Dd,dt,Ls,qe,ct,Br,xo,Wd,Fr,Rd,Ss,N,Po,Hd,zr,Ud,Gd,qo,Qd,$n,Vd,Jd,Kd,Co,Yd,Eo,Xd,Zd,ec,q,jo,tc,Ce,oc,yn,nc,rc,xr,sc,ac,ic,pt,lc,ht,dc,mt,cc,gt,pc,ut,Ns,Ee,ft,Pr,Oo,hc,qr,mc,Is,I,Ao,gc,Cr,uc,fc,Lo,_c,Bn,bc,vc,kc,So,Mc,No,Tc,wc,$c,ee,Io,yc,je,Bc,Fn,Fc,zc,Er,xc,Pc,qc,_t,Cc,bt,Ds,Oe,vt,jr,Do,Ec,Or,jc,Ws,D,Wo,Oc,Ar,Ac,Lc,Ro,Sc,zn,Nc,Ic,Dc,Ho,Wc,Uo,Rc,Hc,Uc,H,Go,Gc,Ae,Qc,xn,Vc,Jc,Lr,Kc,Yc,Xc,kt,Zc,Mt,ep,Tt,Rs,Le,wt,Sr,Qo,tp,Nr,op,Hs,W,Vo,np,Se,rp,Ir,sp,ap,Dr,ip,lp,dp,Jo,cp,Pn,pp,hp,mp,Ko,gp,Yo,up,fp,_p,U,Xo,bp,Ne,vp,qn,kp,Mp,Wr,Tp,wp,$p,$t,yp,yt,Bp,Bt,Us;return n=new te({}),Et=new te({}),St=new z({props:{code:`wget --content-disposition https://api.ngc.nvidia.com/v2/models/nvidia/megatron_bert_345m/versions/v0.1_uncased/zip
...
<code>past_key_values</code>).`,name:"use_cache"}],source:"https://github.com/huggingface/transformers/blob/v4.21.0/src/transformers/models/megatron_bert/modeling_megatron_bert.py#L873",returnDescription:`
<p>A <a
...
elements depending on the configuration (<a
  href="/docs/transformers/v4.21.0/en/model_doc/megatron-bert#transformers.MegatronBertConfig"
...
loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.21.0/src/transformers/models/megatron_bert/modeling_megatron_bert.py#L1287",returnDescription:`
<p>A <a
...
If set to <code>True</code>, <code>past_key_values</code> key value states are returned and can be used to speed up decoding (see
<code>past_key_values</code>).`,name:"use_cache"}],source:"https://github.com/huggingface/transformers/blob/v4.21.0/src/transformers/models/megatron_bert/modeling_megatron_bert.py#L1138",returnDescription:`
<p>A <a
...
</ul>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.21.0/src/transformers/models/megatron_bert/modeling_megatron_bert.py#L1384",returnDescription:`
<p>A <a
...
Used to hide legacy arguments that have been deprecated.`,name:"kwargs"}],source:"https://github.com/huggingface/transformers/blob/v4.21.0/src/transformers/models/megatron_bert/modeling_megatron_bert.py#L1027",returnDescription:`
...
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.21.0/src/transformers/models/megatron_bert/modeling_megatron_bert.py#L1490",returnDescription:`
<p>A <a
...
<code>input_ids</code> above)`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.21.0/src/transformers/models/megatron_bert/modeling_megatron_bert.py#L1587",returnDescription:`
<p>A <a
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.21.0/src/transformers/models/megatron_bert/modeling_megatron_bert.py#L1685",returnDescription:`
<p>A <a
...
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/v4.21.0/src/transformers/models/megatron_bert/modeling_megatron_bert.py#L1766",returnDescription:`
<p>A <a
...
`),Kn=a("code"),Va=r("megatron_bert_345m_v0_1_{cased, uncased}.zip"),Ja=r(" and that the commands are run from inside that folder:"),Ts=m(),k(It.$$.fragment),ws=m(),k(Dt.$$.fragment),$s=m(),re=a("p"),Ka=r("This model was contributed by "),Wt=a("a"),Ya=r("jdemouth"),Xa=r(". The original code can be found "),Rt=a("a"),Za=r("here"),ei=r(`. That repository contains a multi-GPU and multi-node implementation of the
...
documentation from `),mn=a("a"),mi=r("PretrainedConfig"),gi=r(" for more information."),ui=m(),k(Qe.$$.fragment),Fs=m(),ke=a("h2"),Ve=a("a"),Zn=a("span"),k(Qt.$$.fragment),fi=m(),er=a("span"),_i=r("MegatronBertModel"),zs=m(),x=a("div"),k(Vt.$$.fragment),bi=m(),tr=a("p"),vi=r("The bare MegatronBert Model transformer outputting raw hidden-states without any specific head on top."),ki=m(),Jt=a("p"),Mi=r("This model inherits from "),gn=a("a"),Ti=r("PreTrainedModel"),wi=r(`. Check the superclass documentation for the generic methods the
...
`),sr=a("code"),Ii=r("add_cross_attention"),Di=r(" set to "),ar=a("code"),Wi=r("True"),Ri=r("; an "),ir=a("code"),Hi=r("encoder_hidden_states"),Ui=r(" is then expected as an input to the forward pass."),Gi=m(),K=a("div"),k(eo.$$.fragment),Qi=m(),Me=a("p"),Vi=r("The "),un=a("a"),Ji=r("MegatronBertModel"),Ki=r(" forward method, overrides the "),lr=a("code"),Yi=r("__call__"),Xi=r(" special method."),Zi=m(),k(Je.$$.fragment),el=m(),k(Ke.$$.fragment),xs=m(),Te=a("h2"),Ye=a("a"),dr=a("span"),k(to.$$.fragment),tl=m(),cr=a("span"),ol=r("MegatronBertForMaskedLM"),Ps=m(),O=a("div"),k(oo.$$.fragment),nl=m(),no=a("p"),rl=r("MegatronBert Model with a "),pr=a("code"),sl=r("language modeling"),al=r(" head on top."),il=m(),ro=a("p"),ll=r("This model inherits from "),fn=a("a"),dl=r("PreTrainedModel"),cl=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),pl=m(),so=a("p"),hl=r("This model is also a PyTorch "),ao=a("a"),ml=r("torch.nn.Module"),gl=r(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),ul=m(),R=a("div"),k(io.$$.fragment),fl=m(),we=a("p"),_l=r("The "),_n=a("a"),bl=r("MegatronBertForMaskedLM"),vl=r(" forward method, overrides the "),hr=a("code"),kl=r("__call__"),Ml=r(" special method."),Tl=m(),k(Xe.$$.fragment),wl=m(),k(Ze.$$.fragment),$l=m(),k(et.$$.fragment),qs=m(),$e=a("h2"),tt=a("a"),mr=a("span"),k(lo.$$.fragment),yl=m(),gr=a("span"),Bl=r("MegatronBertForCausalLM"),Cs=m(),A=a("div"),k(co.$$.fragment),Fl=m(),po=a("p"),zl=r("MegatronBert Model with a "),ur=a("code"),xl=r("language modeling"),Pl=r(" head on top for CLM fine-tuning."),ql=m(),ho=a("p"),Cl=r("This model inherits from "),bn=a("a"),El=r("PreTrainedModel"),jl=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),ld=m(),X=a("div"),k(To.$$.fragment),dd=m(),Fe=a("p"),cd=r("The "),Mn=a("a"),pd=r("MegatronBertForNextSentencePrediction"),hd=r(" forward method, overrides the "),kr=a("code"),md=r("__call__"),gd=r(" special method."),ud=m(),k(st.$$.fragment),fd=m(),k(at.$$.fragment),Os=m(),ze=a("h2"),it=a("a"),Mr=a("span"),k(wo.$$.fragment),_d=m(),Tr=a("span"),bd=r("MegatronBertForPreTraining"),As=m(),S=a("div"),k($o.$$.fragment),vd=m(),xe=a("p"),kd=r("MegatronBert Model with two heads on top as done during the pretraining: a "),wr=a("code"),Md=r("masked language modeling"),Td=r(` head and a
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),kc=m(),So=a("p"),Mc=r("This model is also a PyTorch "),No=a("a"),Tc=r("torch.nn.Module"),wc=r(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Uc=m(),H=a("div"),k(Go.$$.fragment),Gc=m(),Ae=a("p"),Qc=r("The "),xn=a("a"),Vc=r("MegatronBertForTokenClassification"),Jc=r(" forward method, overrides the "),Lr=a("code"),Kc=r("__call__"),Yc=r(" special method."),Xc=m(),k(kt.$$.fragment),Zc=m(),k(Mt.$$.fragment),ep=m(),k(Tt.$$.fragment),Rs=m(),Le=a("h2"),wt=a("a"),Sr=a("span"),k(Qo.$$.fragment),tp=m(),Nr=a("span"),op=r("MegatronBertForQuestionAnswering"),Hs=m(),W=a("div"),k(Vo.$$.fragment),np=m(),Se=a("p"),rp=r(`MegatronBert Model with a span classification head on top for extractive question-answering tasks like SQuAD (a
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),fa.forEach(o),kc=g(pe),So=i(pe,"P",{});var _a=l(So);Mc=s(_a,"This model is also a PyTorch "),No=i(_a,"A",{href:!0,rel:!0});var Hh=l(No);Tc=s(Hh,"torch.nn.Module"),Hh.forEach(o),wc=s(_a,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
