...
`),j=s(ie,"CODE",{});var ue=a(j);he=i(ue,'model({"input_ids": input_ids, "attention_mask": attention_mask})'),ue.forEach(t),ie.forEach(t),A.forEach(t)},m(u,F){_(u,l,F),e(l,g),_(u,c,F),_(u,p,F),e(p,v),e(v,d),e(p,f),e(p,z),e(z,le),_(u,B,F),_(u,E,F),e(E,X),e(E,D),e(D,J),e(E,de),e(E,W),e(W,ce),e(E,se),_(u,U,F),_(u,O,F),e(O,Y),_(u,V,F),_(u,q,F),e(q,x),e(x,Z),e(x,H),e(H,ae),e(x,ee),e(x,R),e(R,re),e(q,te),e(q,C),e(C,pe),e(C,Q),e(Q,oe),e(q,me),e(q,L),e(L,ne),e(L,j),e(j,he)},d(u){u&&t(l),u&&t(c),u&&t(p),u&&t(B),u&&t(E),u&&t(U),u&&t(O),u&&t(V),u&&t(q)}}}function M_(y){let l,g,c,p,v;return{c(){l=n("p"),g=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),c=n("code"),p=r("Module"),v=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(d){l=s(d,"P",{});var f=a(l);g=i(f,"Although the recipe for forward pass needs to be defined within this function, one should call the "),c=s(f,"CODE",{});var z=a(c);p=i(z,"Module"),z.forEach(t),v=i(f,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),{c(){l=n("p"),g=r("Example:"),c=m(),T(p.$$.fragment)},l(d){l=s(d,"P",{});var f=a(l);g=i(f,"Example:"),f.forEach(t),c=h(d),M(p.$$.fragment,d)},m(d,f){_(d,l,f),e(l,g),_(d,c,f),$(p,d,f),v=!0},p:be,i(d){v||(w(p.$$.fragment,d),v=!0)},o(d){P(p.$$.fragment,d),v=!1},d(d){d&&t(l),d&&t(c),N(p,d)}}}function w_(y){let l,g,c,p,v,d,f,z,le,B,E,X,D,J,de,W,ce,se,U,O,Y,V,q,x,Z,H,ae,ee,R,re,te,C,pe,Q,oe,me,L,ne,j,he;return{c(){l=n("p"),g=r("TF 2.0 models accepts two formats as inputs:"),c=m(),p=n("ul"),v=n("li"),d=r("having all inputs as keyword arguments (like PyTorch models), or"),f=m(),z=n("li"),le=r("having all inputs as a list, tuple or dict in the first positional arguments."),B=m(),E=n("p"),X=r("This second option is useful when using "),D=n("code"),J=r("tf.keras.Model.fit"),de=r(` method which currently requires having all the
tensors in the first argument of the model call function: `),W=n("code"),ce=r("model(inputs)"),se=r("."),U=m(),O=n("p"),Y=r(`If you choose this second option, there are three possibilities you can use to gather all the input Tensor in the
first positional argument :`),V=m(),q=n("ul"),x=n("li"),Z=r("a single Tensor with "),H=n("code"),ae=r("input_ids"),ee=r(" only and nothing else: "),R=n("code"),re=r("model(inputs_ids)"),te=m(),C=n("li"),pe=r(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),Q=n("code"),oe=r("model([input_ids, attention_mask])"),me=m(),L=n("li"),ne=r(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),j=n("code"),he=r('model({"input_ids": input_ids, "attention_mask": attention_mask})')},l(u){l=s(u,"P",{});var F=a(l);g=i(F,"TF 2.0 models accepts two formats as inputs:"),F.forEach(t),c=h(u),p=s(u,"UL",{});var K=a(p);v=s(K,"LI",{});var _e=a(v);d=i(_e,"having all inputs as keyword arguments (like PyTorch models), or"),_e.forEach(t),f=h(K),z=s(K,"LI",{});var Me=a(z);le=i(Me,"having all inputs as a list, tuple or dict in the first positional arguments."),Me.forEach(t),K.forEach(t),B=h(u),E=s(u,"P",{});var I=a(E);X=i(I,"This second option is useful when using "),D=s(I,"CODE",{});var ke=a(D);J=i(ke,"tf.keras.Model.fit"),ke.forEach(t),de=i(I,` method which currently requires having all the
...
first positional argument :`),we.forEach(t),V=h(u),q=s(u,"UL",{});var A=a(q);x=s(A,"LI",{});var S=a(x);Z=i(S,"a single Tensor with "),H=s(S,"CODE",{});var Pe=a(H);ae=i(Pe,"input_ids"),Pe.forEach(t),ee=i(S," only and nothing else: "),R=s(S,"CODE",{});var ge=a(R);re=i(ge,"model(inputs_ids)"),ge.forEach(t),S.forEach(t),te=h(A),C=s(A,"LI",{});var fe=a(C);pe=i(fe,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),Q=s(fe,"CODE",{});var Ne=a(Q);oe=i(Ne,"model([input_ids, attention_mask])"),Ne.forEach(t),fe.forEach(t),me=h(A),L=s(A,"LI",{});var ie=a(L);ne=i(ie,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),j=s(ie,"CODE",{});var ue=a(j);he=i(ue,'model({"input_ids": input_ids, "attention_mask": attention_mask})'),ue.forEach(t),ie.forEach(t),A.forEach(t)},m(u,F){_(u,l,F),e(l,g),_(u,c,F),_(u,p,F),e(p,v),e(v,d),e(p,f),e(p,z),e(z,le),_(u,B,F),_(u,E,F),e(E,X),e(E,D),e(D,J),e(E,de),e(E,W),e(W,ce),e(E,se),_(u,U,F),_(u,O,F),e(O,Y),_(u,V,F),_(u,q,F),e(q,x),e(x,Z),e(x,H),e(H,ae),e(x,ee),e(x,R),e(R,re),e(q,te),e(q,C),e(C,pe),e(C,Q),e(Q,oe),e(q,me),e(q,L),e(L,ne),e(L,j),e(j,he)},d(u){u&&t(l),u&&t(c),u&&t(p),u&&t(B),u&&t(E),u&&t(U),u&&t(O),u&&t(V),u&&t(q)}}}function P_(y){let l,g,c,p,v;return{c(){l=n("p"),g=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),c=n("code"),p=r("Module"),v=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(d){l=s(d,"P",{});var f=a(l);g=i(f,"Although the recipe for forward pass needs to be defined within this function, one should call the "),c=s(f,"CODE",{});var z=a(c);p=i(z,"Module"),z.forEach(t),v=i(f,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
`}}),{c(){T(l.$$.fragment)},l(c){M(l.$$.fragment,c)},m(c,p){$(l,c,p),g=!0},p:be,i(c){g||(w(l.$$.fragment,c),g=!0)},o(c){P(l.$$.fragment,c),g=!1},d(c){N(l,c)}}}function F_(y){let l,g,c,p,v,d,f,z,le,B,E,X,D,J,de,W,ce,se,U,O,Y,V,q,x,Z,H,ae,ee,R,re,te,C,pe,Q,oe,me,L,ne,j,he;return{c(){l=n("p"),g=r("TF 2.0 models accepts two formats as inputs:"),c=m(),p=n("ul"),v=n("li"),d=r("having all inputs as keyword arguments (like PyTorch models), or"),f=m(),z=n("li"),le=r("having all inputs as a list, tuple or dict in the first positional arguments."),B=m(),E=n("p"),X=r("This second option is useful when using "),D=n("code"),J=r("tf.keras.Model.fit"),de=r(` method which currently requires having all the
tensors in the first argument of the model call function: `),W=n("code"),ce=r("model(inputs)"),se=r("."),U=m(),O=n("p"),Y=r(`If you choose this second option, there are three possibilities you can use to gather all the input Tensor in the
first positional argument :`),V=m(),q=n("ul"),x=n("li"),Z=r("a single Tensor with "),H=n("code"),ae=r("input_ids"),ee=r(" only and nothing else: "),R=n("code"),re=r("model(inputs_ids)"),te=m(),C=n("li"),pe=r(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),Q=n("code"),oe=r("model([input_ids, attention_mask])"),me=m(),L=n("li"),ne=r(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),j=n("code"),he=r('model({"input_ids": input_ids, "attention_mask": attention_mask})')},l(u){l=s(u,"P",{});var F=a(l);g=i(F,"TF 2.0 models accepts two formats as inputs:"),F.forEach(t),c=h(u),p=s(u,"UL",{});var K=a(p);v=s(K,"LI",{});var _e=a(v);d=i(_e,"having all inputs as keyword arguments (like PyTorch models), or"),_e.forEach(t),f=h(K),z=s(K,"LI",{});var Me=a(z);le=i(Me,"having all inputs as a list, tuple or dict in the first positional arguments."),Me.forEach(t),K.forEach(t),B=h(u),E=s(u,"P",{});var I=a(E);X=i(I,"This second option is useful when using "),D=s(I,"CODE",{});var ke=a(D);J=i(ke,"tf.keras.Model.fit"),ke.forEach(t),de=i(I,` method which currently requires having all the
...
first positional argument :`),we.forEach(t),V=h(u),q=s(u,"UL",{});var A=a(q);x=s(A,"LI",{});var S=a(x);Z=i(S,"a single Tensor with "),H=s(S,"CODE",{});var Pe=a(H);ae=i(Pe,"input_ids"),Pe.forEach(t),ee=i(S," only and nothing else: "),R=s(S,"CODE",{});var ge=a(R);re=i(ge,"model(inputs_ids)"),ge.forEach(t),S.forEach(t),te=h(A),C=s(A,"LI",{});var fe=a(C);pe=i(fe,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),Q=s(fe,"CODE",{});var Ne=a(Q);oe=i(Ne,"model([input_ids, attention_mask])"),Ne.forEach(t),fe.forEach(t),me=h(A),L=s(A,"LI",{});var ie=a(L);ne=i(ie,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),j=s(ie,"CODE",{});var ue=a(j);he=i(ue,'model({"input_ids": input_ids, "attention_mask": attention_mask})'),ue.forEach(t),ie.forEach(t),A.forEach(t)},m(u,F){_(u,l,F),e(l,g),_(u,c,F),_(u,p,F),e(p,v),e(v,d),e(p,f),e(p,z),e(z,le),_(u,B,F),_(u,E,F),e(E,X),e(E,D),e(D,J),e(E,de),e(E,W),e(W,ce),e(E,se),_(u,U,F),_(u,O,F),e(O,Y),_(u,V,F),_(u,q,F),e(q,x),e(x,Z),e(x,H),e(H,ae),e(x,ee),e(x,R),e(R,re),e(q,te),e(q,C),e(C,pe),e(C,Q),e(Q,oe),e(q,me),e(q,L),e(L,ne),e(L,j),e(j,he)},d(u){u&&t(l),u&&t(c),u&&t(p),u&&t(B),u&&t(E),u&&t(U),u&&t(O),u&&t(V),u&&t(q)}}}function z_(y){let l,g,c,p,v;return{c(){l=n("p"),g=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),c=n("code"),p=r("Module"),v=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(d){l=s(d,"P",{});var f=a(l);g=i(f,"Although the recipe for forward pass needs to be defined within this function, one should call the "),c=s(f,"CODE",{});var z=a(c);p=i(z,"Module"),z.forEach(t),v=i(f,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
`}}),{c(){T(l.$$.fragment)},l(c){M(l.$$.fragment,c)},m(c,p){$(l,c,p),g=!0},p:be,i(c){g||(w(l.$$.fragment,c),g=!0)},o(c){P(l.$$.fragment,c),g=!1},d(c){N(l,c)}}}function x_(y){let l,g,c,p,v,d,f,z,le,B,E,X,D,J,de,W,ce,se,U,O,Y,V,q,x,Z,H,ae,ee,R,re,te,C,pe,Q,oe,me,L,ne,j,he;return{c(){l=n("p"),g=r("TF 2.0 models accepts two formats as inputs:"),c=m(),p=n("ul"),v=n("li"),d=r("having all inputs as keyword arguments (like PyTorch models), or"),f=m(),z=n("li"),le=r("having all inputs as a list, tuple or dict in the first positional arguments."),B=m(),E=n("p"),X=r("This second option is useful when using "),D=n("code"),J=r("tf.keras.Model.fit"),de=r(` method which currently requires having all the
tensors in the first argument of the model call function: `),W=n("code"),ce=r("model(inputs)"),se=r("."),U=m(),O=n("p"),Y=r(`If you choose this second option, there are three possibilities you can use to gather all the input Tensor in the
first positional argument :`),V=m(),q=n("ul"),x=n("li"),Z=r("a single Tensor with "),H=n("code"),ae=r("input_ids"),ee=r(" only and nothing else: "),R=n("code"),re=r("model(inputs_ids)"),te=m(),C=n("li"),pe=r(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),Q=n("code"),oe=r("model([input_ids, attention_mask])"),me=m(),L=n("li"),ne=r(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),j=n("code"),he=r('model({"input_ids": input_ids, "attention_mask": attention_mask})')},l(u){l=s(u,"P",{});var F=a(l);g=i(F,"TF 2.0 models accepts two formats as inputs:"),F.forEach(t),c=h(u),p=s(u,"UL",{});var K=a(p);v=s(K,"LI",{});var _e=a(v);d=i(_e,"having all inputs as keyword arguments (like PyTorch models), or"),_e.forEach(t),f=h(K),z=s(K,"LI",{});var Me=a(z);le=i(Me,"having all inputs as a list, tuple or dict in the first positional arguments."),Me.forEach(t),K.forEach(t),B=h(u),E=s(u,"P",{});var I=a(E);X=i(I,"This second option is useful when using "),D=s(I,"CODE",{});var ke=a(D);J=i(ke,"tf.keras.Model.fit"),ke.forEach(t),de=i(I,` method which currently requires having all the
...
first positional argument :`),we.forEach(t),V=h(u),q=s(u,"UL",{});var A=a(q);x=s(A,"LI",{});var S=a(x);Z=i(S,"a single Tensor with "),H=s(S,"CODE",{});var Pe=a(H);ae=i(Pe,"input_ids"),Pe.forEach(t),ee=i(S," only and nothing else: "),R=s(S,"CODE",{});var ge=a(R);re=i(ge,"model(inputs_ids)"),ge.forEach(t),S.forEach(t),te=h(A),C=s(A,"LI",{});var fe=a(C);pe=i(fe,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),Q=s(fe,"CODE",{});var Ne=a(Q);oe=i(Ne,"model([input_ids, attention_mask])"),Ne.forEach(t),fe.forEach(t),me=h(A),L=s(A,"LI",{});var ie=a(L);ne=i(ie,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),j=s(ie,"CODE",{});var ue=a(j);he=i(ue,'model({"input_ids": input_ids, "attention_mask": attention_mask})'),ue.forEach(t),ie.forEach(t),A.forEach(t)},m(u,F){_(u,l,F),e(l,g),_(u,c,F),_(u,p,F),e(p,v),e(v,d),e(p,f),e(p,z),e(z,le),_(u,B,F),_(u,E,F),e(E,X),e(E,D),e(D,J),e(E,de),e(E,W),e(W,ce),e(E,se),_(u,U,F),_(u,O,F),e(O,Y),_(u,V,F),_(u,q,F),e(q,x),e(x,Z),e(x,H),e(H,ae),e(x,ee),e(x,R),e(R,re),e(q,te),e(q,C),e(C,pe),e(C,Q),e(Q,oe),e(q,me),e(q,L),e(L,ne),e(L,j),e(j,he)},d(u){u&&t(l),u&&t(c),u&&t(p),u&&t(B),u&&t(E),u&&t(U),u&&t(O),u&&t(V),u&&t(q)}}}function C_(y){let l,g,c,p,v;return{c(){l=n("p"),g=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),c=n("code"),p=r("Module"),v=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(d){l=s(d,"P",{});var f=a(l);g=i(f,"Although the recipe for forward pass needs to be defined within this function, one should call the "),c=s(f,"CODE",{});var z=a(c);p=i(z,"Module"),z.forEach(t),v=i(f,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-comment"># the linear classifier still needs to be trained</span>
<span class="hljs-meta">&gt;&gt;&gt; </span>logits = outputs.logits`}}),{c(){l=n("p"),g=r("Example:"),c=m(),T(p.$$.fragment)},l(d){l=s(d,"P",{});var f=a(l);g=i(f,"Example:"),f.forEach(t),c=h(d),M(p.$$.fragment,d)},m(d,f){_(d,l,f),e(l,g),_(d,c,f),$(p,d,f),v=!0},p:be,i(d){v||(w(p.$$.fragment,d),v=!0)},o(d){P(p.$$.fragment,d),v=!1},d(d){d&&t(l),d&&t(c),N(p,d)}}}function L_(y){let l,g,c,p,v,d,f,z,le,B,E,X,D,J,de,W,ce,se,U,O,Y,V,q,x,Z,H,ae,ee,R,re,te,C,pe,Q,oe,me,L,ne,j,he;return{c(){l=n("p"),g=r("TF 2.0 models accepts two formats as inputs:"),c=m(),p=n("ul"),v=n("li"),d=r("having all inputs as keyword arguments (like PyTorch models), or"),f=m(),z=n("li"),le=r("having all inputs as a list, tuple or dict in the first positional arguments."),B=m(),E=n("p"),X=r("This second option is useful when using "),D=n("code"),J=r("tf.keras.Model.fit"),de=r(` method which currently requires having all the
tensors in the first argument of the model call function: `),W=n("code"),ce=r("model(inputs)"),se=r("."),U=m(),O=n("p"),Y=r(`If you choose this second option, there are three possibilities you can use to gather all the input Tensor in the
first positional argument :`),V=m(),q=n("ul"),x=n("li"),Z=r("a single Tensor with "),H=n("code"),ae=r("input_ids"),ee=r(" only and nothing else: "),R=n("code"),re=r("model(inputs_ids)"),te=m(),C=n("li"),pe=r(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),Q=n("code"),oe=r("model([input_ids, attention_mask])"),me=m(),L=n("li"),ne=r(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),j=n("code"),he=r('model({"input_ids": input_ids, "attention_mask": attention_mask})')},l(u){l=s(u,"P",{});var F=a(l);g=i(F,"TF 2.0 models accepts two formats as inputs:"),F.forEach(t),c=h(u),p=s(u,"UL",{});var K=a(p);v=s(K,"LI",{});var _e=a(v);d=i(_e,"having all inputs as keyword arguments (like PyTorch models), or"),_e.forEach(t),f=h(K),z=s(K,"LI",{});var Me=a(z);le=i(Me,"having all inputs as a list, tuple or dict in the first positional arguments."),Me.forEach(t),K.forEach(t),B=h(u),E=s(u,"P",{});var I=a(E);X=i(I,"This second option is useful when using "),D=s(I,"CODE",{});var ke=a(D);J=i(ke,"tf.keras.Model.fit"),ke.forEach(t),de=i(I,` method which currently requires having all the
...
first positional argument :`),we.forEach(t),V=h(u),q=s(u,"UL",{});var A=a(q);x=s(A,"LI",{});var S=a(x);Z=i(S,"a single Tensor with "),H=s(S,"CODE",{});var Pe=a(H);ae=i(Pe,"input_ids"),Pe.forEach(t),ee=i(S," only and nothing else: "),R=s(S,"CODE",{});var ge=a(R);re=i(ge,"model(inputs_ids)"),ge.forEach(t),S.forEach(t),te=h(A),C=s(A,"LI",{});var fe=a(C);pe=i(fe,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),Q=s(fe,"CODE",{});var Ne=a(Q);oe=i(Ne,"model([input_ids, attention_mask])"),Ne.forEach(t),fe.forEach(t),me=h(A),L=s(A,"LI",{});var ie=a(L);ne=i(ie,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),j=s(ie,"CODE",{});var ue=a(j);he=i(ue,'model({"input_ids": input_ids, "attention_mask": attention_mask})'),ue.forEach(t),ie.forEach(t),A.forEach(t)},m(u,F){_(u,l,F),e(l,g),_(u,c,F),_(u,p,F),e(p,v),e(v,d),e(p,f),e(p,z),e(z,le),_(u,B,F),_(u,E,F),e(E,X),e(E,D),e(D,J),e(E,de),e(E,W),e(W,ce),e(E,se),_(u,U,F),_(u,O,F),e(O,Y),_(u,V,F),_(u,q,F),e(q,x),e(x,Z),e(x,H),e(H,ae),e(x,ee),e(x,R),e(R,re),e(q,te),e(q,C),e(C,pe),e(C,Q),e(Q,oe),e(q,me),e(q,L),e(L,ne),e(L,j),e(j,he)},d(u){u&&t(l),u&&t(c),u&&t(p),u&&t(B),u&&t(E),u&&t(U),u&&t(O),u&&t(V),u&&t(q)}}}function A_(y){let l,g,c,p,v;return{c(){l=n("p"),g=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),c=n("code"),p=r("Module"),v=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(d){l=s(d,"P",{});var f=a(l);g=i(f,"Although the recipe for forward pass needs to be defined within this function, one should call the "),c=s(f,"CODE",{});var z=a(c);p=i(z,"Module"),z.forEach(t),v=i(f,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-built_in">round</span>(<span class="hljs-built_in">float</span>(loss), <span class="hljs-number">2</span>)
`}}),{c(){T(l.$$.fragment)},l(c){M(l.$$.fragment,c)},m(c,p){$(l,c,p),g=!0},p:be,i(c){g||(w(l.$$.fragment,c),g=!0)},o(c){P(l.$$.fragment,c),g=!1},d(c){N(l,c)}}}function S_(y){let l,g,c,p,v,d,f,z,le,B,E,X,D,J,de,W,ce,se,U,O,Y,V,q,x,Z,H,ae,ee,R,re,te,C,pe,Q,oe,me,L,ne,j,he;return{c(){l=n("p"),g=r("TF 2.0 models accepts two formats as inputs:"),c=m(),p=n("ul"),v=n("li"),d=r("having all inputs as keyword arguments (like PyTorch models), or"),f=m(),z=n("li"),le=r("having all inputs as a list, tuple or dict in the first positional arguments."),B=m(),E=n("p"),X=r("This second option is useful when using "),D=n("code"),J=r("tf.keras.Model.fit"),de=r(` method which currently requires having all the
tensors in the first argument of the model call function: `),W=n("code"),ce=r("model(inputs)"),se=r("."),U=m(),O=n("p"),Y=r(`If you choose this second option, there are three possibilities you can use to gather all the input Tensor in the
first positional argument :`),V=m(),q=n("ul"),x=n("li"),Z=r("a single Tensor with "),H=n("code"),ae=r("input_ids"),ee=r(" only and nothing else: "),R=n("code"),re=r("model(inputs_ids)"),te=m(),C=n("li"),pe=r(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),Q=n("code"),oe=r("model([input_ids, attention_mask])"),me=m(),L=n("li"),ne=r(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),j=n("code"),he=r('model({"input_ids": input_ids, "attention_mask": attention_mask})')},l(u){l=s(u,"P",{});var F=a(l);g=i(F,"TF 2.0 models accepts two formats as inputs:"),F.forEach(t),c=h(u),p=s(u,"UL",{});var K=a(p);v=s(K,"LI",{});var _e=a(v);d=i(_e,"having all inputs as keyword arguments (like PyTorch models), or"),_e.forEach(t),f=h(K),z=s(K,"LI",{});var Me=a(z);le=i(Me,"having all inputs as a list, tuple or dict in the first positional arguments."),Me.forEach(t),K.forEach(t),B=h(u),E=s(u,"P",{});var I=a(E);X=i(I,"This second option is useful when using "),D=s(I,"CODE",{});var ke=a(D);J=i(ke,"tf.keras.Model.fit"),ke.forEach(t),de=i(I,` method which currently requires having all the
...
first positional argument :`),we.forEach(t),V=h(u),q=s(u,"UL",{});var A=a(q);x=s(A,"LI",{});var S=a(x);Z=i(S,"a single Tensor with "),H=s(S,"CODE",{});var Pe=a(H);ae=i(Pe,"input_ids"),Pe.forEach(t),ee=i(S," only and nothing else: "),R=s(S,"CODE",{});var ge=a(R);re=i(ge,"model(inputs_ids)"),ge.forEach(t),S.forEach(t),te=h(A),C=s(A,"LI",{});var fe=a(C);pe=i(fe,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),Q=s(fe,"CODE",{});var Ne=a(Q);oe=i(Ne,"model([input_ids, attention_mask])"),Ne.forEach(t),fe.forEach(t),me=h(A),L=s(A,"LI",{});var ie=a(L);ne=i(ie,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),j=s(ie,"CODE",{});var ue=a(j);he=i(ue,'model({"input_ids": input_ids, "attention_mask": attention_mask})'),ue.forEach(t),ie.forEach(t),A.forEach(t)},m(u,F){_(u,l,F),e(l,g),_(u,c,F),_(u,p,F),e(p,v),e(v,d),e(p,f),e(p,z),e(z,le),_(u,B,F),_(u,E,F),e(E,X),e(E,D),e(D,J),e(E,de),e(E,W),e(W,ce),e(E,se),_(u,U,F),_(u,O,F),e(O,Y),_(u,V,F),_(u,q,F),e(q,x),e(x,Z),e(x,H),e(H,ae),e(x,ee),e(x,R),e(R,re),e(q,te),e(q,C),e(C,pe),e(C,Q),e(Q,oe),e(q,me),e(q,L),e(L,ne),e(L,j),e(j,he)},d(u){u&&t(l),u&&t(c),u&&t(p),u&&t(B),u&&t(E),u&&t(U),u&&t(O),u&&t(V),u&&t(q)}}}function D_(y){let l,g,c,p,v;return{c(){l=n("p"),g=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),c=n("code"),p=r("Module"),v=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(d){l=s(d,"P",{});var f=a(l);g=i(f,"Although the recipe for forward pass needs to be defined within this function, one should call the "),c=s(f,"CODE",{});var z=a(c);p=i(z,"Module"),z.forEach(t),v=i(f,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/v4.21.0/src/transformers/models/mpnet/tokenization_mpnet.py#L231",returnDescription:`
...
Set to True if the token list is already formatted with special tokens for the model`,name:"already_has_special_tokens"}],source:"https://github.com/huggingface/transformers/blob/v4.21.0/src/transformers/models/mpnet/tokenization_mpnet.py#L256",returnDescription:`
...
Optional second list of IDs for sequence pairs`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/v4.21.0/src/transformers/models/mpnet/tokenization_mpnet_fast.py#L191",returnDescription:`
<p>List of zeros.</p>
`,returnType:`
<p><code>List[int]</code></p>
...
configuration. Check out the <a href="/docs/transformers/v4.21.0/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/v4.21.0/src/transformers/models/mpnet/modeling_mpnet.py#L483"}}),On=new G({props:{name:"forward",anchor:"transformers.MPNetModel.forward",parameters:[{name:"input_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"attention_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"position_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"head_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.MPNetModel.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/v4.21.0/en/model_doc/mpnet#transformers.MPNetTokenizer">MPNetTokenizer</a>. See <a href="/docs/transformers/v4.21.0/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
...
elements depending on the configuration (<a
  href="/docs/transformers/v4.21.0/en/model_doc/mpnet#transformers.MPNetConfig"
...
`}}),mo=new Fe({props:{$$slots:{default:[n_]},$$scope:{ctx:y}}}),ho=new ve({props:{anchor:"transformers.MPNetModel.forward.example",$$slots:{default:[s_]},$$scope:{ctx:y}}}),In=new Ae({}),Sn=new G({props:{name:"class transformers.MPNetForMaskedLM",anchor:"transformers.MPNetForMaskedLM",parameters:[{name:"config",val:""}],source:"https://github.com/huggingface/transformers/blob/v4.21.0/src/transformers/models/mpnet/modeling_mpnet.py#L576"}}),Dn=new G({props:{name:"forward",anchor:"transformers.MPNetForMaskedLM.forward",parameters:[{name:"input_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"attention_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"position_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"head_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"labels",val:": typing.Optional[torch.LongTensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.MPNetForMaskedLM.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/v4.21.0/en/model_doc/mpnet#transformers.MPNetTokenizer">MPNetTokenizer</a>. See <a href="/docs/transformers/v4.21.0/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/v4.21.0/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.21.0/src/transformers/models/mpnet/modeling_mpnet.py#L595",returnDescription:`
<p>A <a
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/v4.21.0/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/v4.21.0/src/transformers/models/mpnet/modeling_mpnet.py#L685"}}),Bn=new G({props:{name:"forward",anchor:"transformers.MPNetForSequenceClassification.forward",parameters:[{name:"input_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"attention_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"position_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"head_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"labels",val:": typing.Optional[torch.LongTensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.MPNetForSequenceClassification.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/v4.21.0/en/model_doc/mpnet#transformers.MPNetTokenizer">MPNetTokenizer</a>. See <a href="/docs/transformers/v4.21.0/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/v4.21.0/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.21.0/src/transformers/models/mpnet/modeling_mpnet.py#L698",returnDescription:`
<p>A <a
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/v4.21.0/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/v4.21.0/src/transformers/models/mpnet/modeling_mpnet.py#L780"}}),Yn=new G({props:{name:"forward",anchor:"transformers.MPNetForMultipleChoice.forward",parameters:[{name:"input_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"attention_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"position_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"head_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"labels",val:": typing.Optional[torch.LongTensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.MPNetForMultipleChoice.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, num_choices, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/v4.21.0/en/model_doc/mpnet#transformers.MPNetTokenizer">MPNetTokenizer</a>. See <a href="/docs/transformers/v4.21.0/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/v4.21.0/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
<code>input_ids</code> above)`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.21.0/src/transformers/models/mpnet/modeling_mpnet.py#L793",returnDescription:`
<p>A <a
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.21.0/src/transformers/models/mpnet/modeling_mpnet.py#L886",returnDescription:`
<p>A <a
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/v4.21.0/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/v4.21.0/src/transformers/models/mpnet/modeling_mpnet.py#L971"}}),cs=new G({props:{name:"forward",anchor:"transformers.MPNetForQuestionAnswering.forward",parameters:[{name:"input_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"attention_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"position_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"head_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"start_positions",val:": typing.Optional[torch.LongTensor] = None"},{name:"end_positions",val:": typing.Optional[torch.LongTensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.MPNetForQuestionAnswering.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/v4.21.0/en/model_doc/mpnet#transformers.MPNetTokenizer">MPNetTokenizer</a>. See <a href="/docs/transformers/v4.21.0/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/v4.21.0/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/v4.21.0/src/transformers/models/mpnet/modeling_mpnet.py#L985",returnDescription:`
<p>A <a
...
behaviors between training and evaluation).`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/v4.21.0/src/transformers/models/mpnet/modeling_tf_mpnet.py#L669",returnDescription:`
<p>A <a
...
Labels for computing the masked language modeling loss. Indices should be in <code>[-100, 0, ..., config.vocab_size]</code> (see <code>input_ids</code> docstring) Tokens with indices set to <code>-100</code> are ignored (masked), the
loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.21.0/src/transformers/models/mpnet/modeling_tf_mpnet.py#L784",returnDescription:`
<p>A <a
...
Labels for computing the sequence classification/regression loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>. If <code>config.num_labels == 1</code> a regression loss is computed (Mean-Square loss), If
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.21.0/src/transformers/models/mpnet/modeling_tf_mpnet.py#L889",returnDescription:`
<p>A <a
...
where <code>num_choices</code> is the size of the second dimension of the input tensors. (See <code>input_ids</code> above)`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.21.0/src/transformers/models/mpnet/modeling_tf_mpnet.py#L979",returnDescription:`
<p>A <a
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.21.0/src/transformers/models/mpnet/modeling_tf_mpnet.py#L1090",returnDescription:`
<p>A <a
...
Labels for position (index) of the end of the labelled span for computing the token classification loss.
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/v4.21.0/src/transformers/models/mpnet/modeling_tf_mpnet.py#L1172",returnDescription:`
<p>A <a
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Qc=m(),ye=n("div"),T(Bn.$$.fragment),Hc=m(),Lt=n("p"),Rc=r("The "),fa=n("a"),Uc=r("MPNetForSequenceClassification"),Bc=r(" forward method, overrides the "),_r=n("code"),Vc=r("__call__"),Kc=r(" special method."),Xc=m(),T(vo.$$.fragment),Gc=m(),T(bo.$$.fragment),Jc=m(),T(To.$$.fragment),Yc=m(),T(Mo.$$.fragment),Zc=m(),T($o.$$.fragment),Qi=m(),At=n("h2"),wo=n("a"),kr=n("span"),T(Vn.$$.fragment),ep=m(),vr=n("span"),tp=r("MPNetForMultipleChoice"),Hi=m(),Se=n("div"),T(Kn.$$.fragment),op=m(),br=n("p"),np=r(`MPNet Model with a multiple choice classification head on top (a linear layer on top of the pooled output and a
...
behavior.`),ym=m(),T(Ao.$$.fragment),Fm=m(),tt=n("div"),T(gs.$$.fragment),zm=m(),Rt=n("p"),Em=r("The "),Ma=n("a"),qm=r("TFMPNetModel"),xm=r(" forward method, overrides the "),jr=n("code"),Cm=r("__call__"),jm=r(" special method."),Lm=m(),T(Oo.$$.fragment),Am=m(),T(Io.$$.fragment),Gi=m(),Ut=n("h2"),So=n("a"),Lr=n("span"),T(_s.$$.fragment),Om=m(),Ar=n("span"),Im=r("TFMPNetForMaskedLM"),Ji=m(),qe=n("div"),T(ks.$$.fragment),Sm=m(),vs=n("p"),Dm=r("MPNet Model with a "),Or=n("code"),Wm=r("language modeling"),Qm=r(" head on top."),Hm=m(),bs=n("p"),Rm=r("This model inherits from "),$a=n("a"),Um=r("TFPreTrainedModel"),Bm=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),bh=m(),T(Uo.$$.fragment),Th=m(),Ve=n("div"),T(zs.$$.fragment),Mh=m(),Kt=n("p"),$h=r("The "),Na=n("a"),wh=r("TFMPNetForSequenceClassification"),Ph=r(" forward method, overrides the "),Qr=n("code"),Nh=r("__call__"),yh=r(" special method."),Fh=m(),T(Bo.$$.fragment),zh=m(),T(Vo.$$.fragment),Eh=m(),T(Ko.$$.fragment),el=m(),Xt=n("h2"),Xo=n("a"),Hr=n("span"),T(Es.$$.fragment),qh=m(),Rr=n("span"),xh=r("TFMPNetForMultipleChoice"),tl=m(),Ce=n("div"),T(qs.$$.fragment),Ch=m(),Ur=n("p"),jh=r(`MPNet Model with a multiple choice classification head on top (a linear layer on top of the pooled output and a
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Sf=m(),T(an.$$.fragment),Df=m(),Xe=n("div"),T(Vs.$$.fragment),Wf=m(),to=n("p"),Qf=r("The "),xa=n("a"),Hf=r("TFMPNetForQuestionAnswering"),Rf=r(" forward method, overrides the "),ti=n("code"),Uf=r("__call__"),Bf=r(" special method."),Vf=m(),T(rn.$$.fragment),Kf=m(),T(ln.$$.fragment),Xf=m(),T(dn.$$.fragment),this.h()},l(o){const k=e_('[data-svelte="svelte-1phssyn"]',document.head);l=s(k,"META",{name:!0,content:!0}),k.forEach(t),g=h(o),c=s(o,"H1",{class:!0});var Ks=a(c);p=s(Ks,"A",{id:!0,class:!0,href:!0});var oi=a(p);v=s(oi,"SPAN",{});var ni=a(v);M(d.$$.fragment,ni),ni.forEach(t),oi.forEach(t),f=h(Ks),z=s(Ks,"SPAN",{});var si=a(z);le=i(si,"MPNet"),si.forEach(t),Ks.forEach(t),B=h(o),E=s(o,"H2",{class:!0});var Xs=a(E);X=s(Xs,"A",{id:!0,class:!0,href:!0});var ai=a(X);D=s(ai,"SPAN",{});var ri=a(D);M(J.$$.fragment,ri),ri.forEach(t),ai.forEach(t),de=h(Xs),W=s(Xs,"SPAN",{});var ii=a(W);ce=i(ii,"Overview"),ii.forEach(t),Xs.forEach(t),se=h(o),U=s(o,"P",{});var Gs=a(U);O=i(Gs,"The MPNet model was proposed in "),Y=s(Gs,"A",{href:!0,rel:!0});var li=a(Y);V=i(li,"MPNet: Masked and Permuted Pre-training for Language Understanding"),li.forEach(t),q=i(Gs," by Kaitao Song, Xu Tan, Tao Qin, Jianfeng Lu, Tie-Yan Liu."),Gs.forEach(t),x=h(o),Z=s(o,"P",{});var di=a(Z);H=i(di,`MPNet adopts a novel pre-training method, named masked and permuted language modeling, to inherit the advantages of
