...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),{c(){l=o("p"),v=s("Examples:"),d=c(),y(u.$$.fragment)},l(p){l=n(p,"P",{});var g=r(l);v=a(g,"Examples:"),g.forEach(t),d=h(p),q(u.$$.fragment,p)},m(p,g){m(p,l,g),e(l,v),m(p,d,g),j(u,p,g),T=!0},p:ut,i(p){T||($(u.$$.fragment,p),T=!0)},o(p){E(u.$$.fragment,p),T=!1},d(p){p&&t(l),p&&t(d),F(u,p)}}}function Bk(P){let l,v,d,u,T,p,g,A,k,N,x,U,B,V,R,K,re,W,L,w,M,G,C,O,ee,te,ce,oe,se,S,Q,H,X,I,Y,ge,ue,_e,me,ne,qe,ie,be;return{c(){l=o("p"),v=s("TF 2.0 models accepts two formats as inputs:"),d=c(),u=o("ul"),T=o("li"),p=s("having all inputs as keyword arguments (like PyTorch models), or"),g=c(),A=o("li"),k=s("having all inputs as a list, tuple or dict in the first positional arguments."),N=c(),x=o("p"),U=s("This second option is useful when using "),B=o("code"),V=s("tf.keras.Model.fit"),R=s(` method which currently requires having all the
tensors in the first argument of the model call function: `),K=o("code"),re=s("model(inputs)"),W=s("."),L=c(),w=o("p"),M=s(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),G=c(),C=o("ul"),O=o("li"),ee=s("a single Tensor with "),te=o("code"),ce=s("input_ids"),oe=s(" only and nothing else: "),se=o("code"),S=s("model(inputs_ids)"),Q=c(),H=o("li"),X=s(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),I=o("code"),Y=s("model([input_ids, attention_mask])"),ge=s(" or "),ue=o("code"),_e=s("model([input_ids, attention_mask, token_type_ids])"),me=c(),ne=o("li"),qe=s(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),ie=o("code"),be=s('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(b){l=n(b,"P",{});var D=r(l);v=a(D,"TF 2.0 models accepts two formats as inputs:"),D.forEach(t),d=h(b),u=n(b,"UL",{});var ve=r(u);T=n(ve,"LI",{});var xe=r(T);p=a(xe,"having all inputs as keyword arguments (like PyTorch models), or"),xe.forEach(t),g=h(ve),A=n(ve,"LI",{});var we=r(A);k=a(we,"having all inputs as a list, tuple or dict in the first positional arguments."),we.forEach(t),ve.forEach(t),N=h(b),x=n(b,"P",{});var le=r(x);U=a(le,"This second option is useful when using "),B=n(le,"CODE",{});var ze=r(B);V=a(ze,"tf.keras.Model.fit"),ze.forEach(t),R=a(le,` method which currently requires having all the
...
first positional argument :`),Z.forEach(t),G=h(b),C=n(b,"UL",{});var de=r(C);O=n(de,"LI",{});var pe=r(O);ee=a(pe,"a single Tensor with "),te=n(pe,"CODE",{});var De=r(te);ce=a(De,"input_ids"),De.forEach(t),oe=a(pe," only and nothing else: "),se=n(pe,"CODE",{});var je=r(se);S=a(je,"model(inputs_ids)"),je.forEach(t),pe.forEach(t),Q=h(de),H=n(de,"LI",{});var Te=r(H);X=a(Te,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),I=n(Te,"CODE",{});var Ne=r(I);Y=a(Ne,"model([input_ids, attention_mask])"),Ne.forEach(t),ge=a(Te," or "),ue=n(Te,"CODE",{});var ke=r(ue);_e=a(ke,"model([input_ids, attention_mask, token_type_ids])"),ke.forEach(t),Te.forEach(t),me=h(de),ne=n(de,"LI",{});var Ae=r(ne);qe=a(Ae,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),ie=n(Ae,"CODE",{});var Oe=r(ie);be=a(Oe,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),Oe.forEach(t),Ae.forEach(t),de.forEach(t)},m(b,D){m(b,l,D),e(l,v),m(b,d,D),m(b,u,D),e(u,T),e(T,p),e(u,g),e(u,A),e(A,k),m(b,N,D),m(b,x,D),e(x,U),e(x,B),e(B,V),e(x,R),e(x,K),e(K,re),e(x,W),m(b,L,D),m(b,w,D),e(w,M),m(b,G,D),m(b,C,D),e(C,O),e(O,ee),e(O,te),e(te,ce),e(O,oe),e(O,se),e(se,S),e(C,Q),e(C,H),e(H,X),e(H,I),e(I,Y),e(H,ge),e(H,ue),e(ue,_e),e(C,me),e(C,ne),e(ne,qe),e(ne,ie),e(ie,be)},d(b){b&&t(l),b&&t(d),b&&t(u),b&&t(N),b&&t(x),b&&t(L),b&&t(w),b&&t(G),b&&t(C)}}}function Vk(P){let l,v,d,u,T;return{c(){l=o("p"),v=s("Although the recipe for forward pass needs to be defined within this function, one should call the "),d=o("code"),u=s("Module"),T=s(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(p){l=n(p,"P",{});var g=r(l);v=a(g,"Although the recipe for forward pass needs to be defined within this function, one should call the "),d=n(g,"CODE",{});var A=r(d);u=a(A,"Module"),A.forEach(t),T=a(g,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
<span class="hljs-meta">&gt;&gt;&gt; </span>outputs = model(**inputs, labels=labels)
<span class="hljs-meta">&gt;&gt;&gt; </span>logits = outputs.logits`}}),{c(){l=o("p"),v=s("Examples:"),d=c(),y(u.$$.fragment)},l(p){l=n(p,"P",{});var g=r(l);v=a(g,"Examples:"),g.forEach(t),d=h(p),q(u.$$.fragment,p)},m(p,g){m(p,l,g),e(l,v),m(p,d,g),j(u,p,g),T=!0},p:ut,i(p){T||($(u.$$.fragment,p),T=!0)},o(p){E(u.$$.fragment,p),T=!1},d(p){p&&t(l),p&&t(d),F(u,p)}}}function Yk(P){let l,v,d,u,T,p,g,A,k,N,x,U,B,V,R,K,re,W,L,w,M,G,C,O,ee,te,ce,oe,se,S,Q,H,X,I,Y,ge,ue,_e,me,ne,qe,ie,be;return{c(){l=o("p"),v=s("TF 2.0 models accepts two formats as inputs:"),d=c(),u=o("ul"),T=o("li"),p=s("having all inputs as keyword arguments (like PyTorch models), or"),g=c(),A=o("li"),k=s("having all inputs as a list, tuple or dict in the first positional arguments."),N=c(),x=o("p"),U=s("This second option is useful when using "),B=o("code"),V=s("tf.keras.Model.fit"),R=s(` method which currently requires having all the
tensors in the first argument of the model call function: `),K=o("code"),re=s("model(inputs)"),W=s("."),L=c(),w=o("p"),M=s(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),G=c(),C=o("ul"),O=o("li"),ee=s("a single Tensor with "),te=o("code"),ce=s("input_ids"),oe=s(" only and nothing else: "),se=o("code"),S=s("model(inputs_ids)"),Q=c(),H=o("li"),X=s(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),I=o("code"),Y=s("model([input_ids, attention_mask])"),ge=s(" or "),ue=o("code"),_e=s("model([input_ids, attention_mask, token_type_ids])"),me=c(),ne=o("li"),qe=s(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),ie=o("code"),be=s('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(b){l=n(b,"P",{});var D=r(l);v=a(D,"TF 2.0 models accepts two formats as inputs:"),D.forEach(t),d=h(b),u=n(b,"UL",{});var ve=r(u);T=n(ve,"LI",{});var xe=r(T);p=a(xe,"having all inputs as keyword arguments (like PyTorch models), or"),xe.forEach(t),g=h(ve),A=n(ve,"LI",{});var we=r(A);k=a(we,"having all inputs as a list, tuple or dict in the first positional arguments."),we.forEach(t),ve.forEach(t),N=h(b),x=n(b,"P",{});var le=r(x);U=a(le,"This second option is useful when using "),B=n(le,"CODE",{});var ze=r(B);V=a(ze,"tf.keras.Model.fit"),ze.forEach(t),R=a(le,` method which currently requires having all the
...
first positional argument :`),Z.forEach(t),G=h(b),C=n(b,"UL",{});var de=r(C);O=n(de,"LI",{});var pe=r(O);ee=a(pe,"a single Tensor with "),te=n(pe,"CODE",{});var De=r(te);ce=a(De,"input_ids"),De.forEach(t),oe=a(pe," only and nothing else: "),se=n(pe,"CODE",{});var je=r(se);S=a(je,"model(inputs_ids)"),je.forEach(t),pe.forEach(t),Q=h(de),H=n(de,"LI",{});var Te=r(H);X=a(Te,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),I=n(Te,"CODE",{});var Ne=r(I);Y=a(Ne,"model([input_ids, attention_mask])"),Ne.forEach(t),ge=a(Te," or "),ue=n(Te,"CODE",{});var ke=r(ue);_e=a(ke,"model([input_ids, attention_mask, token_type_ids])"),ke.forEach(t),Te.forEach(t),me=h(de),ne=n(de,"LI",{});var Ae=r(ne);qe=a(Ae,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),ie=n(Ae,"CODE",{});var Oe=r(ie);be=a(Oe,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),Oe.forEach(t),Ae.forEach(t),de.forEach(t)},m(b,D){m(b,l,D),e(l,v),m(b,d,D),m(b,u,D),e(u,T),e(T,p),e(u,g),e(u,A),e(A,k),m(b,N,D),m(b,x,D),e(x,U),e(x,B),e(B,V),e(x,R),e(x,K),e(K,re),e(x,W),m(b,L,D),m(b,w,D),e(w,M),m(b,G,D),m(b,C,D),e(C,O),e(O,ee),e(O,te),e(te,ce),e(O,oe),e(O,se),e(se,S),e(C,Q),e(C,H),e(H,X),e(H,I),e(I,Y),e(H,ge),e(H,ue),e(ue,_e),e(C,me),e(C,ne),e(ne,qe),e(ne,ie),e(ie,be)},d(b){b&&t(l),b&&t(d),b&&t(u),b&&t(N),b&&t(x),b&&t(L),b&&t(w),b&&t(G),b&&t(C)}}}function Jk(P){let l,v,d,u,T;return{c(){l=o("p"),v=s("Although the recipe for forward pass needs to be defined within this function, one should call the "),d=o("code"),u=s("Module"),T=s(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(p){l=n(p,"P",{});var g=r(l);v=a(g,"Although the recipe for forward pass needs to be defined within this function, one should call the "),d=n(g,"CODE",{});var A=r(d);u=a(A,"Module"),A.forEach(t),T=a(g,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
<span class="hljs-meta">&gt;&gt;&gt; </span>outputs = model(**inputs, labels=labels)
<span class="hljs-meta">&gt;&gt;&gt; </span>loss = outputs.loss
<span class="hljs-meta">&gt;&gt;&gt; </span>logits = outputs.logits`}}),{c(){l=o("p"),v=s("Examples:"),d=c(),y(u.$$.fragment)},l(p){l=n(p,"P",{});var g=r(l);v=a(g,"Examples:"),g.forEach(t),d=h(p),q(u.$$.fragment,p)},m(p,g){m(p,l,g),e(l,v),m(p,d,g),j(u,p,g),T=!0},p:ut,i(p){T||($(u.$$.fragment,p),T=!0)},o(p){E(u.$$.fragment,p),T=!1},d(p){p&&t(l),p&&t(d),F(u,p)}}}function Zk(P){let l,v,d,u,T,p,g,A,k,N,x,U,B,V,R,K,re,W,L,w,M,G,C,O,ee,te,ce,oe,se,S,Q,H,X,I,Y,ge,ue,_e,me,ne,qe,ie,be;return{c(){l=o("p"),v=s("TF 2.0 models accepts two formats as inputs:"),d=c(),u=o("ul"),T=o("li"),p=s("having all inputs as keyword arguments (like PyTorch models), or"),g=c(),A=o("li"),k=s("having all inputs as a list, tuple or dict in the first positional arguments."),N=c(),x=o("p"),U=s("This second option is useful when using "),B=o("code"),V=s("tf.keras.Model.fit"),R=s(` method which currently requires having all the
tensors in the first argument of the model call function: `),K=o("code"),re=s("model(inputs)"),W=s("."),L=c(),w=o("p"),M=s(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),G=c(),C=o("ul"),O=o("li"),ee=s("a single Tensor with "),te=o("code"),ce=s("input_ids"),oe=s(" only and nothing else: "),se=o("code"),S=s("model(inputs_ids)"),Q=c(),H=o("li"),X=s(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),I=o("code"),Y=s("model([input_ids, attention_mask])"),ge=s(" or "),ue=o("code"),_e=s("model([input_ids, attention_mask, token_type_ids])"),me=c(),ne=o("li"),qe=s(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),ie=o("code"),be=s('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(b){l=n(b,"P",{});var D=r(l);v=a(D,"TF 2.0 models accepts two formats as inputs:"),D.forEach(t),d=h(b),u=n(b,"UL",{});var ve=r(u);T=n(ve,"LI",{});var xe=r(T);p=a(xe,"having all inputs as keyword arguments (like PyTorch models), or"),xe.forEach(t),g=h(ve),A=n(ve,"LI",{});var we=r(A);k=a(we,"having all inputs as a list, tuple or dict in the first positional arguments."),we.forEach(t),ve.forEach(t),N=h(b),x=n(b,"P",{});var le=r(x);U=a(le,"This second option is useful when using "),B=n(le,"CODE",{});var ze=r(B);V=a(ze,"tf.keras.Model.fit"),ze.forEach(t),R=a(le,` method which currently requires having all the
...
first positional argument :`),Z.forEach(t),G=h(b),C=n(b,"UL",{});var de=r(C);O=n(de,"LI",{});var pe=r(O);ee=a(pe,"a single Tensor with "),te=n(pe,"CODE",{});var De=r(te);ce=a(De,"input_ids"),De.forEach(t),oe=a(pe," only and nothing else: "),se=n(pe,"CODE",{});var je=r(se);S=a(je,"model(inputs_ids)"),je.forEach(t),pe.forEach(t),Q=h(de),H=n(de,"LI",{});var Te=r(H);X=a(Te,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),I=n(Te,"CODE",{});var Ne=r(I);Y=a(Ne,"model([input_ids, attention_mask])"),Ne.forEach(t),ge=a(Te," or "),ue=n(Te,"CODE",{});var ke=r(ue);_e=a(ke,"model([input_ids, attention_mask, token_type_ids])"),ke.forEach(t),Te.forEach(t),me=h(de),ne=n(de,"LI",{});var Ae=r(ne);qe=a(Ae,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),ie=n(Ae,"CODE",{});var Oe=r(ie);be=a(Oe,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),Oe.forEach(t),Ae.forEach(t),de.forEach(t)},m(b,D){m(b,l,D),e(l,v),m(b,d,D),m(b,u,D),e(u,T),e(T,p),e(u,g),e(u,A),e(A,k),m(b,N,D),m(b,x,D),e(x,U),e(x,B),e(B,V),e(x,R),e(x,K),e(K,re),e(x,W),m(b,L,D),m(b,w,D),e(w,M),m(b,G,D),m(b,C,D),e(C,O),e(O,ee),e(O,te),e(te,ce),e(O,oe),e(O,se),e(se,S),e(C,Q),e(C,H),e(H,X),e(H,I),e(I,Y),e(H,ge),e(H,ue),e(ue,_e),e(C,me),e(C,ne),e(ne,qe),e(ne,ie),e(ie,be)},d(b){b&&t(l),b&&t(d),b&&t(u),b&&t(N),b&&t(x),b&&t(L),b&&t(w),b&&t(G),b&&t(C)}}}function ey(P){let l,v,d,u,T;return{c(){l=o("p"),v=s("Although the recipe for forward pass needs to be defined within this function, one should call the "),d=o("code"),u=s("Module"),T=s(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(p){l=n(p,"P",{});var g=r(l);v=a(g,"Although the recipe for forward pass needs to be defined within this function, one should call the "),d=n(g,"CODE",{});var A=r(d);u=a(A,"Module"),A.forEach(t),T=a(g,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
<span class="hljs-meta">&gt;&gt;&gt; </span>logits = outputs.logits
<span class="hljs-meta">&gt;&gt;&gt; </span>logits_aggregation = outputs.logits_aggregation`}}),{c(){l=o("p"),v=s("Examples:"),d=c(),y(u.$$.fragment)},l(p){l=n(p,"P",{});var g=r(l);v=a(g,"Examples:"),g.forEach(t),d=h(p),q(u.$$.fragment,p)},m(p,g){m(p,l,g),e(l,v),m(p,d,g),j(u,p,g),T=!0},p:ut,i(p){T||($(u.$$.fragment,p),T=!0)},o(p){E(u.$$.fragment,p),T=!1},d(p){p&&t(l),p&&t(d),F(u,p)}}}function sy(P){let l,v,d,u,T,p,g,A,k,N,x,U,B,V,R,K,re,W,L,w,M,G,C,O,ee,te,ce,oe,se,S,Q,H,X,I,Y,ge,ue,_e,me,ne,qe,ie,be,b,D,ve,xe,we,le,ze,Me,Z,de,pe,De,je,Te,Ne,ke,Ae,Oe,Ze,Ps,Ss,mt,ft,ca,gt,_t,Ds,tt,Ns,Os,Ke,Pe,Ls,kt,ye,yt,qt,Qs,jt,$t,Is,Et,cs,Bt,Ft,hs,Ye,$e,Ws,At,ae,ot,Vt,Hs,xt,Jt,Us,zt,Ct,Rs,Mt,Xt,Gs,Pt,Zt,Bs,St,Vs,Le,Dt,es,Ks,Nt,ts,Ys,ss,Ue,as,Ee,os,nt,Js,Ot,Lt,Xs,Zs,Re,ea,ns,rs,et,Qt,z,J,ya,ta,qa,ha,It,st,sa,rt,ja,aa,$a,ua,Ie,is,us,Ge,Ea,ma,ms,oa,ls,fa,fe,Fa,fs,Aa,xa,ga,Tt,na,ds,za,Fe,Ca,ra,Ma,Pa,Sa,he,Da,ia,Na,Oa,_a,gs,La,Ta,Ce,la,Wt,da,el,Sc,Dc,tl,sl,Nc,Oc,al,ol,Lc,Qc,Qa,Ia,nl,Ic,Wc,rl,Hc,Uc,il,Rc,Gc,Wa,ll,Bc,Vc,dl,Kc,Yc,pl,Jc,Xc,Ha,cl,Zc,eh,hl,th,sh,ul,ah,op,vo,np,bo,oh,vn,nh,rh,rp,wo,ih,bn,lh,dh,ip,Rr,ml,ph,lp,ko,ch,wn,hh,uh,dp,We,Gr,fl,mh,fh,gh,Br,gl,_h,Th,vh,Vr,_l,bh,wh,kh,Kr,Tl,yh,qh,jh,Yr,vl,$h,Eh,Fh,Jr,bl,Ah,xh,zh,Xr,wl,Ch,Mh,Ph,Zr,kl,Sh,Dh,Nh,ei,yl,Oh,Lh,pp,vt,Qh,kn,Ih,Wh,yn,Hh,Uh,ql,Rh,Gh,jl,Bh,Vh,$l,Kh,Yh,cp,ti,El,Jh,hp,yo,up,Se,Xh,Fl,Zh,eu,Al,tu,su,xl,au,ou,zl,nu,ru,Cl,iu,lu,Ml,du,pu,si,cu,hu,qn,uu,mu,jn,fu,gu,mp,ai,_u,fp,qo,gp,Ua,jo,Pl,$n,Tu,Sl,vu,_p,$o,Tp,bt,bu,Dl,wu,ku,Nl,yu,qu,Ol,ju,$u,En,Eu,Fu,Fn,Au,xu,vp,Ra,Eo,Ll,An,zu,Ql,Cu,bp,Ga,xn,Mu,zn,Pu,oi,Su,Du,wp,Ba,Fo,Il,Cn,Nu,Wl,Ou,kp,Ht,Mn,Lu,Va,Qu,ni,Iu,Wu,Pn,Hu,Uu,Ru,Ka,Gu,Hl,Bu,Vu,ri,Ku,Yu,Ju,Sn,Xu,Dn,Zu,em,tm,Ao,yp,Ya,xo,Ul,Nn,sm,Rl,am,qp,Be,On,om,Gl,nm,rm,Qe,im,ii,lm,dm,li,pm,cm,Bl,hm,um,Vl,mm,fm,Kl,gm,_m,Yl,Tm,vm,Jl,bm,wm,Xl,km,ym,Zl,qm,jm,$m,it,ed,Em,Fm,td,Am,xm,sd,zm,Cm,ad,Mm,Pm,od,Sm,Dm,nd,Nm,Om,rd,Lm,Qm,di,pi,Im,Wm,Hm,zo,Ln,Um,id,Rm,Gm,va,Qn,Bm,In,Vm,ci,Km,Ym,Jm,Wn,Xm,Hn,Zm,ef,tf,hi,Un,jp,Ja,Co,ld,Rn,sf,dd,af,$p,lt,Gn,of,Bn,nf,ui,rf,lf,df,Vn,pf,Kn,cf,hf,uf,Yn,mf,mi,ff,gf,_f,Jn,Tf,Xn,vf,bf,wf,_s,Zn,kf,Xa,yf,fi,qf,jf,pd,$f,Ef,Ff,Mo,Af,Po,Ep,Za,So,cd,er,xf,hd,zf,Fp,ps,tr,Cf,eo,Mf,ud,Pf,Sf,gi,Df,Nf,Of,sr,Lf,ar,Qf,If,Wf,Ts,or,Hf,to,Uf,_i,Rf,Gf,md,Bf,Vf,Kf,Do,Yf,No,Ap,so,Oo,fd,nr,Jf,gd,Xf,xp,Ut,rr,Zf,_d,eg,tg,ir,sg,Ti,ag,og,ng,lr,rg,dr,ig,lg,dg,vs,pr,pg,ao,cg,vi,hg,ug,Td,mg,fg,gg,Lo,_g,Qo,zp,oo,Io,vd,cr,Tg,bd,vg,Cp,Rt,hr,bg,no,wg,wd,kg,yg,kd,qg,jg,$g,ur,Eg,bi,Fg,Ag,xg,mr,zg,fr,Cg,Mg,Pg,bs,gr,Sg,ro,Dg,wi,Ng,Og,yd,Lg,Qg,Ig,Wo,Wg,Ho,Mp,io,Uo,qd,_r,Hg,jd,Ug,Pp,dt,Tr,Rg,$d,Gg,Bg,vr,Vg,ki,Kg,Yg,Jg,br,Xg,wr,Zg,e_,t_,Ro,s_,ws,kr,a_,lo,o_,yi,n_,r_,Ed,i_,l_,d_,Go,p_,Bo,Sp,po,Vo,Fd,yr,c_,Ad,h_,Dp,pt,qr,u_,jr,m_,xd,f_,g_,__,$r,T_,qi,v_,b_,w_,Er,k_,Fr,y_,q_,j_,Ko,$_,ks,Ar,E_,co,F_,ji,A_,x_,zd,z_,C_,M_,Yo,P_,Jo,Np,ho,Xo,Cd,xr,S_,Md,D_,Op,ct,zr,N_,Pd,O_,L_,Cr,Q_,$i,I_,W_,H_,Mr,U_,Pr,R_,G_,B_,Zo,V_,ys,Sr,K_,uo,Y_,Ei,J_,X_,Sd,Z_,eT,tT,en,sT,tn,Lp,mo,sn,Dd,Dr,aT,Nd,oT,Qp,ht,Nr,nT,fo,rT,Od,iT,lT,Ld,dT,pT,cT,Or,hT,Fi,uT,mT,fT,Lr,gT,Qr,_T,TT,vT,an,bT,qs,Ir,wT,go,kT,Ai,yT,qT,Qd,jT,$T,ET,on,FT,nn,Ip;return p=new Gt({}),V=new Gt({}),rt=new Gt({}),vo=new Pc({props:{pytorch:!0,tensorflow:!0,jax:!1,$$slots:{tensorflow:[kk],pytorch:[bk]},$$scope:{ctx:P}}}),yo=new Pc({props:{pytorch:!0,tensorflow:!0,jax:!1,$$slots:{tensorflow:[$k],pytorch:[qk]},$$scope:{ctx:P}}}),qo=new Pc({props:{pytorch:!0,tensorflow:!0,jax:!1,$$slots:{tensorflow:[xk],pytorch:[Fk]},$$scope:{ctx:P}}}),$n=new Gt({}),$o=new Pc({props:{pytorch:!0,tensorflow:!0,jax:!1,$$slots:{tensorflow:[Pk],pytorch:[Ck]},$$scope:{ctx:P}}}),An=new Gt({}),xn=new He({props:{name:"class transformers.models.tapas.modeling_tapas.TableQuestionAnsweringOutput",anchor:"transformers.models.tapas.modeling_tapas.TableQuestionAnsweringOutput",parameters:[{name:"loss",val:": typing.Optional[torch.FloatTensor] = None"},{name:"logits",val:": FloatTensor = None"},{name:"logits_aggregation",val:": FloatTensor = None"},{name:"hidden_states",val:": typing.Optional[typing.Tuple[torch.FloatTensor]] = None"},{name:"attentions",val:": typing.Optional[typing.Tuple[torch.FloatTensor]] = None"}],parametersDescription:[{anchor:"transformers.models.tapas.modeling_tapas.TableQuestionAnsweringOutput.loss",description:`<strong>loss</strong> (<code>torch.FloatTensor</code> of shape <code>(1,)</code>, <em>optional</em>, returned when <code>labels</code> (and possibly <code>answer</code>, <code>aggregation_labels</code>, <code>numeric_values</code> and <code>numeric_values_scale</code> are provided)) &#x2014;
...
this threshold will be selected.`,name:"cell_classification_threshold"}],source:"https://github.com/huggingface/transformers/blob/v4.21.0/src/transformers/models/tapas/tokenization_tapas.py#L1939",returnDescription:`
<ul>
...
`}}),Un=new He({props:{name:"save_vocabulary",anchor:"transformers.TapasTokenizer.save_vocabulary",parameters:[{name:"save_directory",val:": str"},{name:"filename_prefix",val:": typing.Optional[str] = None"}],source:"https://github.com/huggingface/transformers/blob/v4.21.0/src/transformers/models/tapas/tokenization_tapas.py#L444"}}),Rn=new Gt({}),Gn=new He({props:{name:"class transformers.TapasModel",anchor:"transformers.TapasModel",parameters:[{name:"config",val:""},{name:"add_pooling_layer",val:" = True"}],parametersDescription:[{anchor:"transformers.TapasModel.config",description:`<strong>config</strong> (<a href="/docs/transformers/v4.21.0/en/model_doc/tapas#transformers.TapasConfig">TapasConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/v4.21.0/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/v4.21.0/src/transformers/models/tapas/modeling_tapas.py#L853"}}),Zn=new He({props:{name:"forward",anchor:"transformers.TapasModel.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"encoder_hidden_states",val:" = None"},{name:"encoder_attention_mask",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],parametersDescription:[{anchor:"transformers.TapasModel.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. Indices can be obtained using <a href="/docs/transformers/v4.21.0/en/model_doc/tapas#transformers.TapasTokenizer">TapasTokenizer</a>. See
<a href="/docs/transformers/v4.21.0/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and <a href="/docs/transformers/v4.21.0/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
Token indices that encode tabular structure. Indices can be obtained using <a href="/docs/transformers/v4.21.0/en/model_doc/tapas#transformers.TapasTokenizer">TapasTokenizer</a>. See this
...
<code>reset_position_index_per_cell</code> of <a href="/docs/transformers/v4.21.0/en/model_doc/tapas#transformers.TapasConfig">TapasConfig</a> is set to <code>True</code>, relative position embeddings will be
...
Whether or not to return a <a href="/docs/transformers/v4.21.0/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/v4.21.0/src/transformers/models/tapas/modeling_tapas.py#L891",returnDescription:`
<p>A <a
  href="/docs/transformers/v4.21.0/en/main_classes/output#transformers.modeling_outputs.BaseModelOutputWithPooling"
>transformers.modeling_outputs.BaseModelOutputWithPooling</a> or a tuple of
<code>torch.FloatTensor</code> (if <code>return_dict=False</code> is passed or when <code>config.return_dict=False</code>) comprising various
elements depending on the configuration (<a
  href="/docs/transformers/v4.21.0/en/model_doc/tapas#transformers.TapasConfig"
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/v4.21.0/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/v4.21.0/src/transformers/models/tapas/modeling_tapas.py#L1006"}}),or=new He({props:{name:"forward",anchor:"transformers.TapasForMaskedLM.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"encoder_hidden_states",val:" = None"},{name:"encoder_attention_mask",val:" = None"},{name:"labels",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.TapasForMaskedLM.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. Indices can be obtained using <a href="/docs/transformers/v4.21.0/en/model_doc/tapas#transformers.TapasTokenizer">TapasTokenizer</a>. See
<a href="/docs/transformers/v4.21.0/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and <a href="/docs/transformers/v4.21.0/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.21.0/src/transformers/models/tapas/modeling_tapas.py#L1025",returnDescription:`
<p>A <a
...
&#x201C;classification_class_index&#x201D; in the original implementation.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.21.0/src/transformers/models/tapas/modeling_tapas.py#L1478",returnDescription:`
<p>A <a
...
answer appearing in the table. Can be obtained using <a href="/docs/transformers/v4.21.0/en/model_doc/tapas#transformers.TapasTokenizer">TapasTokenizer</a>.</p>
<ul>
...
<a href="/docs/transformers/v4.21.0/en/model_doc/tapas#transformers.TapasTokenizer">TapasTokenizer</a>. Only required in case of weak supervision for aggregation (WTQ) to calculate the
...
Scale of the numeric values of every token. Can be obtained using <a href="/docs/transformers/v4.21.0/en/model_doc/tapas#transformers.TapasTokenizer">TapasTokenizer</a>. Only required in case
of weak supervision for aggregation (WTQ) to calculate the regression loss.`,name:"numeric_values_scale"}],source:"https://github.com/huggingface/transformers/blob/v4.21.0/src/transformers/models/tapas/modeling_tapas.py#L1156",returnDescription:`
<p>A <a
  href="/docs/transformers/v4.21.0/en/model_doc/tapas#transformers.models.tapas.modeling_tapas.TableQuestionAnsweringOutput"
...
behaviors between training and evaluation).`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/v4.21.0/src/transformers/models/tapas/modeling_tf_tapas.py#L980",returnDescription:`
<p>A <a
  href="/docs/transformers/v4.21.0/en/main_classes/output#transformers.modeling_tf_outputs.TFBaseModelOutputWithPooling"
...
Labels for computing the masked language modeling loss. Indices should be in <code>[-100, 0, ..., config.vocab_size]</code> (see <code>input_ids</code> docstring) Tokens with indices set to <code>-100</code> are ignored (masked), the
loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.21.0/src/transformers/models/tapas/modeling_tf_tapas.py#L1065",returnDescription:`
<p>A <a
...
Labels for computing the sequence classification/regression loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>. If <code>config.num_labels == 1</code> a regression loss is computed (Mean-Square loss), If
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy). Note: this is called
&#x201C;classification_class_index&#x201D; in the original implementation.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.21.0/src/transformers/models/tapas/modeling_tf_tapas.py#L1602",returnDescription:`
<p>A <a
...
Scale of the numeric values of every token. Can be obtained using <a href="/docs/transformers/v4.21.0/en/model_doc/tapas#transformers.TapasTokenizer">TapasTokenizer</a>. Only required in case
of weak supervision for aggregation (WTQ) to calculate the regression loss.`,name:"numeric_values_scale"}],source:"https://github.com/huggingface/transformers/blob/v4.21.0/src/transformers/models/tapas/modeling_tf_tapas.py#L1277",returnDescription:`
...
behavior.`),t_=c(),y(Ro.$$.fragment),s_=c(),ws=o("div"),y(kr.$$.fragment),a_=c(),lo=o("p"),o_=s("The "),yi=o("a"),n_=s("TFTapasModel"),r_=s(" forward method, overrides the "),Ed=o("code"),i_=s("__call__"),l_=s(" special method."),d_=c(),y(Go.$$.fragment),p_=c(),y(Bo.$$.fragment),Sp=c(),po=o("h2"),Vo=o("a"),Fd=o("span"),y(yr.$$.fragment),c_=c(),Ad=o("span"),h_=s("TFTapasForMaskedLM"),Dp=c(),pt=o("div"),y(qr.$$.fragment),u_=c(),jr=o("p"),m_=s("Tapas Model with a "),xd=o("code"),f_=s("language modeling"),g_=s(" head on top."),__=c(),$r=o("p"),T_=s("This model inherits from "),qi=o("a"),v_=s("TFPreTrainedModel"),b_=s(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
implementation. Original implementation available at `),Dn=n(ac,"A",{href:!0,rel:!0});var Fb=r(Dn);Zu=a(Fb,"https://github.com/google-research/tapas/tree/master"),Fb.forEach(t),em=a(ac,"."),ac.forEach(t),tm=h(ba),q(Ao.$$.fragment,ba),ba.forEach(t),yp=h(i),Ya=n(i,"H2",{class:!0});var oc=r(Ya);xo=n(oc,"A",{id:!0,class:!0,href:!0});var Ab=r(xo);Ul=n(Ab,"SPAN",{});var xb=r(Ul);q(Nn.$$.fragment,xb),xb.forEach(t),Ab.forEach(t),sm=h(oc),Rl=n(oc,"SPAN",{});var zb=r(Rl);am=a(zb,"TapasTokenizer"),zb.forEach(t),oc.forEach(t),qp=h(i),Be=n(i,"DIV",{class:!0});var wt=r(Be);q(On.$$.fragment,wt),om=h(wt),Gl=n(wt,"P",{});var Cb=r(Gl);nm=a(Cb,`Construct a TAPAS tokenizer. Based on WordPiece. Flattens a table and one or more related sentences to be used by
...
encode tabular structure. To be more precise, it adds 7 token type ids, in the following order: `),Bl=n(Xe,"CODE",{});var Sb=r(Bl);hm=a(Sb,"segment_ids"),Sb.forEach(t),um=a(Xe,`,
...
special tokens and padding. Tokens of column headers are also 0.`),Ub.forEach(t),Cm=h(Yt),ad=n(Yt,"LI",{});var Rb=r(ad);Mm=a(Rb,`prev_labels: indicate whether a token was (part of) an answer to the previous question (1) or not (0). Useful in
a conversational setup (such as SQA).`),Rb.forEach(t),Pm=h(Yt),od=n(Yt,"LI",{});var Gb=r(od);Sm=a(Gb,`column_ranks: indicate the rank of a table token relative to a column, if applicable. For example, if you have a
column \u201Cnumber of movies\u201D with values 87, 53 and 69, then the column ranks of these tokens are 3, 1 and 2
respectively. 0 for all question tokens, special tokens and padding.`),Gb.forEach(t),Dm=h(Yt),nd=n(Yt,"LI",{});var Bb=r(nd);Nm=a(Bb,`inv_column_ranks: indicate the inverse rank of a table token relative to a column, if applicable. For example, if
you have a column \u201Cnumber of movies\u201D with values 87, 53 and 69, then the inverse column ranks of these tokens are
1, 3 and 2 respectively. 0 for all question tokens, special tokens and padding.`),Bb.forEach(t),Om=h(Yt),rd=n(Yt,"LI",{});var Vb=r(rd);Lm=a(Vb,`numeric_relations: indicate numeric relations between the question and the tokens of the table. 0 for all
...
wordpiece.`),OT.forEach(t),Hm=h(wt),zo=n(wt,"DIV",{class:!0});var nc=r(zo);q(Ln.$$.fragment,nc),Um=h(nc),id=n(nc,"P",{});var Yb=r(id);Rm=a(Yb,"Main method to tokenize and prepare for the model one or several sequence(s) related to a table."),Yb.forEach(t),nc.forEach(t),Gm=h(wt),va=n(wt,"DIV",{class:!0});var Wi=r(va);q(Qn.$$.fragment,Wi),Bm=h(Wi),In=n(Wi,"P",{});var rc=r(In);Vm=a(rc,"Converts logits of "),ci=n(rc,"A",{href:!0});var Jb=r(ci);Km=a(Jb,"TapasForQuestionAnswering"),Jb.forEach(t),Ym=a(rc,` to actual predicted answer coordinates and optional
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),_c.forEach(t),dg=h(wa),vs=n(wa,"DIV",{class:!0});var hn=r(vs);q(pr.$$.fragment,hn),pg=h(hn),ao=n(hn,"P",{});var Gi=r(ao);cg=a(Gi,"The "),vi=n(Gi,"A",{href:!0});var yw=r(vi);hg=a(yw,"TapasForSequenceClassification"),yw.forEach(t),ug=a(Gi," forward method, overrides the "),Td=n(Gi,"CODE",{});var qw=r(Td);mg=a(qw,"__call__"),qw.forEach(t),fg=a(Gi," special method."),Gi.forEach(t),gg=h(hn),q(Lo.$$.fragment,hn),_g=h(hn),q(Qo.$$.fragment,hn),hn.forEach(t),wa.forEach(t),zp=h(i),oo=n(i,"H2",{class:!0});var Tc=r(oo);Io=n(Tc,"A",{id:!0,class:!0,href:!0});var jw=r(Io);vd=n(jw,"SPAN",{});var $w=r(vd);q(cr.$$.fragment,$w),$w.forEach(t),jw.forEach(t),Tg=h(Tc),bd=n(Tc,"SPAN",{});var Ew=r(bd);vg=a(Ew,"TapasForQuestionAnswering"),Ew.forEach(t),Tc.forEach(t),Cp=h(i),Rt=n(i,"DIV",{class:!0});var ka=r(Rt);q(hr.$$.fragment,ka),bg=h(ka),no=n(ka,"P",{});var Bi=r(no);wg=a(Bi,`Tapas Model with a cell selection head and optional aggregation head on top for question-answering tasks on tables
...
SQA, WTQ or WikiSQL-supervised tasks.`),Bi.forEach(t),$g=h(ka),ur=n(ka,"P",{});var vc=r(ur);Eg=a(vc,"This model inherits from "),bi=n(vc,"A",{href:!0});var xw=r(bi);Fg=a(xw,"PreTrainedModel"),xw.forEach(t),Ag=a(vc,`. Check the superclass documentation for the generic methods the
library implements for all its models (such as downloading or saving, resizing the input embeddings, pruning heads
