...
<span class="hljs-meta">&gt;&gt;&gt; </span>outputs = model(**inputs)
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_state = outputs.last_hidden_state
<span class="hljs-meta">&gt;&gt;&gt; </span>pooled_output = outputs.pooler_output  <span class="hljs-comment"># pooled CLS states</span>`}}),{c(){d=s("p"),b=i("Examples:"),u=m(),P(p.$$.fragment)},l(n){d=r(n,"P",{});var c=a(d);b=l(c,"Examples:"),c.forEach(o),u=f(n),$(p.$$.fragment,n)},m(n,c){v(n,d,c),e(d,b),v(n,u,c),T(p,n,c),_=!0},p:S,i(n){_||(I(p.$$.fragment,n),_=!0)},o(n){y(p.$$.fragment,n),_=!1},d(n){n&&o(d),n&&o(u),C(p,n)}}}function D_(x){let d,b,u,p,_,n,c,L,dn,Ue,j,ne,Ie,ye,cn,Ce,pn,Ft,Z,Fe,xe,qt,H,Q,qe,Re,Dt,De,Le,mn,Ot,O,se,ke,we,fn,Me,hn,At,Y,un,Oe,re;return{c(){d=s("p"),b=i("TF 2.0 models accepts two formats as inputs:"),u=m(),p=s("ul"),_=s("li"),n=i("having all inputs as keyword arguments (like PyTorch models), or"),c=m(),L=s("li"),dn=i("having all inputs as a list, tuple or dict in the first positional arguments."),Ue=m(),j=s("p"),ne=i("This second option is useful when using "),Ie=s("code"),ye=i("tf.keras.Model.fit"),cn=i(` method which currently requires having all the
tensors in the first argument of the model call function: `),Ce=s("code"),pn=i("model(inputs)"),Ft=i("."),Z=m(),Fe=s("p"),xe=i(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
...
`),Oe=s("code"),re=i('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(w){d=r(w,"P",{});var z=a(d);b=l(z,"TF 2.0 models accepts two formats as inputs:"),z.forEach(o),u=f(w),p=r(w,"UL",{});var Nt=a(p);_=r(Nt,"LI",{});var Xs=a(_);n=l(Xs,"having all inputs as keyword arguments (like PyTorch models), or"),Xs.forEach(o),c=f(Nt),L=r(Nt,"LI",{});var gn=a(L);dn=l(gn,"having all inputs as a list, tuple or dict in the first positional arguments."),gn.forEach(o),Nt.forEach(o),Ue=f(w),j=r(w,"P",{});var M=a(j);ne=l(M,"This second option is useful when using "),Ie=r(M,"CODE",{});var Zs=a(Ie);ye=l(Zs,"tf.keras.Model.fit"),Zs.forEach(o),cn=l(M,` method which currently requires having all the
tensors in the first argument of the model call function: `),Ce=r(M,"CODE",{});var He=a(Ce);pn=l(He,"model(inputs)"),He.forEach(o),Ft=l(M,"."),M.forEach(o),Z=f(w),Fe=r(w,"P",{});var Qs=a(Fe);xe=l(Qs,`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
...
<span class="hljs-meta">&gt;&gt;&gt; </span>outputs = model(**inputs)
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_state = outputs.last_hidden_state
<span class="hljs-meta">&gt;&gt;&gt; </span>pooler_output = outputs.pooler_output  <span class="hljs-comment"># pooled CLS states</span>`}}),{c(){d=s("p"),b=i("Example:"),u=m(),P(p.$$.fragment)},l(n){d=r(n,"P",{});var c=a(d);b=l(c,"Example:"),c.forEach(o),u=f(n),$(p.$$.fragment,n)},m(n,c){v(n,d,c),e(d,b),v(n,u,c),T(p,n,c),_=!0},p:S,i(n){_||(I(p.$$.fragment,n),_=!0)},o(n){y(p.$$.fragment,n),_=!1},d(n){n&&o(d),n&&o(u),C(p,n)}}}function tv(x){let d,b,u,p,_,n,c,L,dn,Ue,j,ne,Ie,ye,cn,Ce,pn,Ft,Z,Fe,xe,qt,H,Q,qe,Re,Dt,De,Le,mn,Ot,O,se,ke,we,fn,Me,hn,At,Y,un,Oe,re,w,z,Nt,Xs,gn,M,Zs,He,Qs,Ae,ae,Ys,er,ie,tr,or,Ne,nr,hd,sr,ud,gd,rr,_d,vd,Ri,_n,Hi,Ve,bd,vn,Pd,$d,bn,Td,Id,Ki,Ke,Vt,aa,Pn,yd,ia,Cd,Gi,ee,$n,xd,St,ar,Ld,kd,ir,wd,Md,Ed,Ge,jd,lr,zd,Fd,dr,qd,Dd,Od,Wt,Tn,Ad,In,Nd,cr,Vd,Sd,Ji,Je,Bt,la,yn,Wd,da,Bd,Xi,te,Cn,Ud,Xe,Rd,pr,Hd,Kd,xn,Gd,Jd,Xd,Ze,Zd,mr,Qd,Yd,fr,ec,tc,oc,Ut,Zi,Qe,Rt,ca,Ln,nc,pa,sc,Qi,oe,kn,rc,Ye,ac,hr,ic,lc,wn,dc,cc,pc,et,mc,ur,fc,hc,gr,uc,gc,_c,Ht,Yi,tt,Kt,ma,Mn,vc,fa,bc,el,F,En,Pc,ha,$c,Tc,jn,Ic,_r,yc,Cc,xc,le,zn,Lc,ua,kc,wc,ga,vr,Mc,_a,Ec,jc,va,zc,Fc,Gt,Fn,qc,qn,Dc,ba,Oc,Ac,Nc,Jt,Dn,Vc,Pa,Sc,Wc,br,On,tl,ot,Xt,$a,An,Bc,Ta,Uc,ol,B,Nn,Rc,Vn,Hc,Ia,Kc,Gc,Jc,Sn,Xc,Pr,Zc,Qc,Yc,de,Wn,ep,ya,tp,op,Ca,$r,np,xa,sp,rp,La,ap,ip,Zt,Bn,lp,ka,dp,nl,nt,Qt,wa,Un,cp,Ma,pp,sl,Ee,Rn,mp,Ea,fp,hp,Hn,up,Tr,gp,_p,rl,st,Yt,ja,Kn,vp,za,bp,al,U,Gn,Pp,Fa,$p,Tp,K,Ir,Ip,yp,yr,Cp,xp,Cr,Lp,kp,qa,wp,Mp,xr,Ep,jp,zp,eo,Jn,Fp,Xn,qp,Lr,Dp,Op,Ap,to,Zn,Np,Qn,Vp,kr,Sp,Wp,il,rt,oo,Da,Yn,Bp,Oa,Up,ll,R,es,Rp,ts,Hp,os,Kp,Gp,Jp,ce,ns,Xp,at,Zp,wr,Qp,Yp,Aa,em,tm,om,no,nm,so,sm,pe,ss,rm,it,am,Mr,im,lm,Na,dm,cm,pm,ro,mm,ao,fm,me,rs,hm,lt,um,Er,gm,_m,Va,vm,bm,Pm,io,$m,lo,dl,dt,co,Sa,as,Tm,Wa,Im,cl,ct,is,ym,fe,ls,Cm,pt,xm,jr,Lm,km,Ba,wm,Mm,Em,po,jm,mo,pl,mt,fo,Ua,ds,zm,Ra,Fm,ml,ft,cs,qm,he,ps,Dm,ht,Om,zr,Am,Nm,Ha,Vm,Sm,Wm,ho,Bm,uo,fl,ut,go,Ka,ms,Um,Ga,Rm,hl,q,fs,Hm,hs,Km,Fr,Gm,Jm,Xm,us,Zm,gs,Qm,Ym,ef,_o,tf,ue,_s,of,gt,nf,qr,sf,rf,Ja,af,lf,df,vo,cf,bo,pf,ge,vs,mf,_t,ff,Dr,hf,uf,Xa,gf,_f,vf,Po,bf,$o,Pf,_e,bs,$f,vt,Tf,Or,If,yf,Za,Cf,xf,Lf,To,kf,Io,ul,bt,yo,Qa,Ps,wf,Ya,Mf,gl,Pt,$s,Ef,ve,Ts,jf,$t,zf,Ar,Ff,qf,ei,Df,Of,Af,Co,Nf,xo,_l,Tt,Lo,ti,Is,Vf,oi,Sf,vl,It,ys,Wf,be,Cs,Bf,yt,Uf,Nr,Rf,Hf,ni,Kf,Gf,Jf,ko,Xf,wo,bl,Ct,Mo,si,xs,Zf,ri,Qf,Pl,E,Ls,Yf,ks,eh,Vr,th,oh,nh,ws,sh,Ms,rh,ah,ih,ai,lh,dh,je,ii,Es,ch,ph,li,js,mh,fh,di,zs,hh,uh,ci,Fs,gh,_h,Pe,qs,vh,xt,bh,pi,Ph,$h,mi,Th,Ih,yh,Eo,Ch,jo,xh,zo,Ds,Lh,Fo,kh,qo,Os,wh,Do,$l,Lt,Oo,fi,As,Mh,hi,Eh,Tl,kt,Ns,jh,$e,Vs,zh,wt,Fh,ui,qh,Dh,gi,Oh,Ah,Nh,Ao,Vh,No,Il,Mt,Vo,_i,Ss,Sh,vi,Wh,yl,Et,Ws,Bh,Te,Bs,Uh,jt,Rh,bi,Hh,Kh,Pi,Gh,Jh,Xh,So,Zh,Wo,Cl;return n=new D({}),ye=new D({}),we=new D({}),_n=new A({props:{code:`from PIL import Image
import requests
...
Dictionary of configuration options used to initialize <a href="/docs/transformers/v4.21.0/en/model_doc/clip#transformers.CLIPTextConfig">CLIPTextConfig</a>.`,name:"text_config_dict"},{anchor:"transformers.CLIPConfig.vision_config_dict",description:`<strong>vision_config_dict</strong> (<code>dict</code>, <em>optional</em>) &#x2014;
...
Dictionary of keyword arguments.`,name:"kwargs"}],source:"https://github.com/huggingface/transformers/blob/v4.21.0/src/transformers/models/clip/configuration_clip.py#L247"}}),Tn=new k({props:{name:"from_text_vision_configs",anchor:"transformers.CLIPConfig.from_text_vision_configs",parameters:[{name:"text_config",val:": CLIPTextConfig"},{name:"vision_config",val:": CLIPVisionConfig"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/v4.21.0/src/transformers/models/clip/configuration_clip.py#L296",returnDescription:`
<p>An instance of a configuration object</p>
`,returnType:`
<p><a
  href="/docs/transformers/v4.21.0/en/model_doc/clip#transformers.CLIPConfig"
>CLIPConfig</a></p>
...
the <code>inputs_ids</code> passed when calling <a href="/docs/transformers/v4.21.0/en/model_doc/clip#transformers.CLIPModel">CLIPModel</a>.`,name:"vocab_size"},{anchor:"transformers.CLIPTextConfig.hidden_size",description:`<strong>hidden_size</strong> (<code>int</code>, <em>optional</em>, defaults to 512) &#x2014;
...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/v4.21.0/src/transformers/models/clip/tokenization_clip.py#L186",returnDescription:`
...
Whether or not the token list is already formatted with special tokens for the model.`,name:"already_has_special_tokens"}],source:"https://github.com/huggingface/transformers/blob/v4.21.0/src/transformers/models/clip/tokenization_clip.py#L213",returnDescription:`
...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/v4.21.0/src/transformers/models/clip/tokenization_clip.py#L241",returnDescription:`
<p>List of zeros.</p>
`,returnType:`
<p><code>List[int]</code></p>
...
The end of sequence token.`,name:"eos_token"}],source:"https://github.com/huggingface/transformers/blob/v4.21.0/src/transformers/models/clip/tokenization_clip_fast.py#L50"}}),Wn=new k({props:{name:"build_inputs_with_special_tokens",anchor:"transformers.CLIPTokenizerFast.build_inputs_with_special_tokens",parameters:[{name:"token_ids_0",val:": typing.List[int]"},{name:"token_ids_1",val:": typing.Optional[typing.List[int]] = None"}],parametersDescription:[{anchor:"transformers.CLIPTokenizerFast.build_inputs_with_special_tokens.token_ids_0",description:`<strong>token_ids_0</strong> (<code>List[int]</code>) &#x2014;
...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/v4.21.0/src/transformers/models/clip/tokenization_clip_fast.py#L123",returnDescription:`
<p>List of <a href="../glossary#input-ids">input IDs</a> with the appropriate special tokens.</p>
`,returnType:`
<p><code>List[int]</code></p>
...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/v4.21.0/src/transformers/models/clip/tokenization_clip_fast.py#L150",returnDescription:`
<p>List of zeros.</p>
`,returnType:`
<p><code>List[int]</code></p>
...
<a href="/docs/transformers/v4.21.0/en/model_doc/clip#transformers.CLIPFeatureExtractor">CLIPFeatureExtractor</a>. See <code>CLIPFeatureExtractor.__call__()</code> for details.`,name:"pixel_values"},{anchor:"transformers.CLIPModel.forward.return_loss",description:`<strong>return_loss</strong> (<code>bool</code>, <em>optional</em>) &#x2014;
...
Whether or not to return a <a href="/docs/transformers/v4.21.0/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/v4.21.0/src/transformers/models/clip/modeling_clip.py#L980",returnDescription:`
...
<li><strong>text_embeds(<code>torch.FloatTensor</code></strong> of shape <code>(batch_size, output_dim</code>) \u2014 The text embeddings obtained by applying the projection layer to the pooled output of <a
  href="/docs/transformers/v4.21.0/en/model_doc/clip#transformers.CLIPTextModel"
>CLIPTextModel</a>.</li>
<li><strong>image_embeds(<code>torch.FloatTensor</code></strong> of shape <code>(batch_size, output_dim</code>) \u2014 The image embeddings obtained by applying the projection layer to the pooled output of <a
  href="/docs/transformers/v4.21.0/en/model_doc/clip#transformers.CLIPVisionModel"
...
Whether or not to return a <a href="/docs/transformers/v4.21.0/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/v4.21.0/src/transformers/models/clip/modeling_clip.py#L884",returnDescription:`
...
Whether or not to return a <a href="/docs/transformers/v4.21.0/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/v4.21.0/src/transformers/models/clip/modeling_clip.py#L931",returnDescription:`
...
Whether or not to return a <a href="/docs/transformers/v4.21.0/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/v4.21.0/src/transformers/models/clip/modeling_clip.py#L700",returnDescription:`
<p>A <a
...
`}}),po=new X({props:{$$slots:{default:[j_]},$$scope:{ctx:x}}}),mo=new V({props:{anchor:"transformers.CLIPTextModel.forward.example",$$slots:{default:[z_]},$$scope:{ctx:x}}}),ds=new D({}),cs=new k({props:{name:"class transformers.CLIPVisionModel",anchor:"transformers.CLIPVisionModel",parameters:[{name:"config",val:": CLIPVisionConfig"}],source:"https://github.com/huggingface/transformers/blob/v4.21.0/src/transformers/models/clip/modeling_clip.py#L796"}}),ps=new k({props:{name:"forward",anchor:"transformers.CLIPVisionModel.forward",parameters:[{name:"pixel_values",val:": typing.Optional[torch.FloatTensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.CLIPVisionModel.forward.pixel_values",description:`<strong>pixel_values</strong> (<code>torch.FloatTensor</code> of shape <code>(batch_size, num_channels, height, width)</code>) &#x2014;
Pixel values. Padding will be ignored by default should you provide it. Pixel values can be obtained using
...
Whether or not to return a <a href="/docs/transformers/v4.21.0/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/v4.21.0/src/transformers/models/clip/modeling_clip.py#L809",returnDescription:`
<p>A <a
  href="/docs/transformers/v4.21.0/en/main_classes/output#transformers.modeling_outputs.BaseModelOutputWithPooling"
>transformers.modeling_outputs.BaseModelOutputWithPooling</a> or a tuple of
<code>torch.FloatTensor</code> (if <code>return_dict=False</code> is passed or when <code>config.return_dict=False</code>) comprising various
...
Pixel values. Pixel values can be obtained using <a href="/docs/transformers/v4.21.0/en/model_doc/clip#transformers.CLIPFeatureExtractor">CLIPFeatureExtractor</a>. See
...
behaviors between training and evaluation).`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/v4.21.0/src/transformers/models/clip/modeling_tf_clip.py#L1341",returnDescription:`
...
<li><strong>text_embeds(<code>tf.Tensor</code></strong> of shape <code>(batch_size, output_dim</code>) \u2014 The text embeddings obtained by applying the projection layer to the pooled output of <a
  href="/docs/transformers/v4.21.0/en/model_doc/clip#transformers.TFCLIPTextModel"
...
<a
  href="/docs/transformers/v4.21.0/en/model_doc/clip#transformers.TFCLIPVisionModel"
...
Whether or not to use the model in training mode (some modules like dropout modules have different
behaviors between training and evaluation).`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/v4.21.0/src/transformers/models/clip/modeling_tf_clip.py#L1259",returnDescription:`
...
Whether or not to use the model in training mode (some modules like dropout modules have different
behaviors between training and evaluation).`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/v4.21.0/src/transformers/models/clip/modeling_tf_clip.py#L1299",returnDescription:`
...
Whether or not to use the model in training mode (some modules like dropout modules have different
behaviors between training and evaluation).`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/v4.21.0/src/transformers/models/clip/modeling_tf_clip.py#L1048",returnDescription:`
<p>A <a
...
Whether or not to use the model in training mode (some modules like dropout modules have different
behaviors between training and evaluation).`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/v4.21.0/src/transformers/models/clip/modeling_tf_clip.py#L1156",returnDescription:`
<p>A <a
  href="/docs/transformers/v4.21.0/en/main_classes/output#transformers.modeling_tf_outputs.TFBaseModelOutputWithPooling"
>transformers.modeling_tf_outputs.TFBaseModelOutputWithPooling</a> or a tuple of <code>tf.Tensor</code> (if
<code>return_dict=False</code> is passed or when <code>config.return_dict=False</code>) comprising various elements depending on the
...
<a href="/docs/transformers/v4.21.0/en/main_classes/model#transformers.FlaxPreTrainedModel.to_bf16">to_bf16()</a>.`,name:"dtype"}],source:"https://github.com/huggingface/transformers/blob/v4.21.0/src/transformers/models/clip/modeling_flax_clip.py#L1148"}}),qs=new k({props:{name:"__call__",anchor:"transformers.FlaxCLIPModel.__call__",parameters:[{name:"input_ids",val:""},{name:"pixel_values",val:""},{name:"attention_mask",val:" = None"},{name:"position_ids",val:" = None"},{name:"params",val:": dict = None"},{name:"dropout_rng",val:": PRNGKey = None"},{name:"train",val:": bool = False"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.FlaxCLIPModel.__call__.input_ids",description:`<strong>input_ids</strong> (<code>numpy.ndarray</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. Padding will be ignored by default should you provide
it.</p>
<p>Indices can be obtained using <a href="/docs/transformers/v4.21.0/en/model_doc/clip#transformers.CLIPTokenizer">CLIPTokenizer</a>. See <a href="/docs/transformers/v4.21.0/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/v4.21.0/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
<a
  href="/docs/transformers/v4.21.0/en/model_doc/clip#transformers.FlaxCLIPTextModel"
...
<a
  href="/docs/transformers/v4.21.0/en/model_doc/clip#transformers.FlaxCLIPVisionModel"
...
<p>Indices can be obtained using <a href="/docs/transformers/v4.21.0/en/model_doc/clip#transformers.CLIPTokenizer">CLIPTokenizer</a>. See <a href="/docs/transformers/v4.21.0/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/v4.21.0/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
<p><a href="../glossary#input-ids">What are input IDs?</a>`,name:"input_ids"}],source:"https://github.com/huggingface/transformers/blob/v4.21.0/src/transformers/models/clip/modeling_flax_clip.py#L822",returnDescription:`
<p>The text embeddings obtained by applying
the projection layer to the pooled output of <a
  href="/docs/transformers/v4.21.0/en/model_doc/clip#transformers.FlaxCLIPTextModel"
...
`}}),Do=new V({props:{anchor:"transformers.FlaxCLIPModel.get_image_features.example",$$slots:{default:[X_]},$$scope:{ctx:x}}}),As=new D({}),Ns=new k({props:{name:"class transformers.FlaxCLIPTextModel",anchor:"transformers.FlaxCLIPTextModel",parameters:[{name:"config",val:": CLIPTextConfig"},{name:"input_shape",val:" = (1, 1)"},{name:"seed",val:": int = 0"},{name:"dtype",val:": dtype = <class 'jax.numpy.float32'>"},{name:"_do_init",val:": bool = True"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/v4.21.0/src/transformers/models/clip/modeling_flax_clip.py#L969"}}),Vs=new k({props:{name:"__call__",anchor:"transformers.FlaxCLIPTextModel.__call__",parameters:[{name:"input_ids",val:""},{name:"attention_mask",val:" = None"},{name:"position_ids",val:" = None"},{name:"params",val:": dict = None"},{name:"dropout_rng",val:": PRNGKey = None"},{name:"train",val:": bool = False"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.FlaxCLIPTextModel.__call__.input_ids",description:`<strong>input_ids</strong> (<code>numpy.ndarray</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. Padding will be ignored by default should you provide
it.</p>
<p>Indices can be obtained using <a href="/docs/transformers/v4.21.0/en/model_doc/clip#transformers.CLIPTokenizer">CLIPTokenizer</a>. See <a href="/docs/transformers/v4.21.0/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/v4.21.0/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
Whether or not to return a <a href="/docs/transformers/v4.21.0/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/v4.21.0/src/transformers/models/clip/modeling_flax_clip.py#L622",returnDescription:`
<p>A <a
...
`}}),Ao=new X({props:{$$slots:{default:[Z_]},$$scope:{ctx:x}}}),No=new V({props:{anchor:"transformers.FlaxCLIPTextModel.__call__.example",$$slots:{default:[Q_]},$$scope:{ctx:x}}}),Ss=new D({}),Ws=new k({props:{name:"class transformers.FlaxCLIPVisionModel",anchor:"transformers.FlaxCLIPVisionModel",parameters:[{name:"config",val:": CLIPVisionConfig"},{name:"input_shape",val:": typing.Optional[typing.Tuple] = None"},{name:"seed",val:": int = 0"},{name:"dtype",val:": dtype = <class 'jax.numpy.float32'>"},{name:"_do_init",val:": bool = True"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/v4.21.0/src/transformers/models/clip/modeling_flax_clip.py#L1022"}}),Bs=new k({props:{name:"__call__",anchor:"transformers.FlaxCLIPVisionModel.__call__",parameters:[{name:"pixel_values",val:""},{name:"params",val:": dict = None"},{name:"dropout_rng",val:": PRNGKey = None"},{name:"train",val:": bool = False"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.FlaxCLIPVisionModel.__call__.pixel_values",description:`<strong>pixel_values</strong> (<code>numpy.ndarray</code> of shape <code>(batch_size, num_channels, height, width)</code>) &#x2014;
Pixel values. Padding will be ignored by default should you provide it. Pixel values can be obtained using
...
Whether or not to return a <a href="/docs/transformers/v4.21.0/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/v4.21.0/src/transformers/models/clip/modeling_flax_clip.py#L702",returnDescription:`
<p>A <a
  href="/docs/transformers/v4.21.0/en/main_classes/output#transformers.modeling_flax_outputs.FlaxBaseModelOutputWithPooling"
>transformers.modeling_flax_outputs.FlaxBaseModelOutputWithPooling</a> or a tuple of
<code>torch.FloatTensor</code> (if <code>return_dict=False</code> is passed or when <code>config.return_dict=False</code>) comprising various
...
documentation from `),dr=s("a"),qd=i("PretrainedConfig"),Dd=i(" for more information."),Od=m(),Wt=s("div"),P(Tn.$$.fragment),Ad=m(),In=s("p"),Nd=i("Instantiate a "),cr=s("a"),Vd=i("CLIPConfig"),Sd=i(` (or a derived class) from clip text model configuration and clip vision model
configuration.`),Ji=m(),Je=s("h2"),Bt=s("a"),la=s("span"),P(yn.$$.fragment),Wd=m(),da=s("span"),Bd=i("CLIPTextConfig"),Xi=m(),te=s("div"),P(Cn.$$.fragment),Ud=m(),Xe=s("p"),Rd=i("This is the configuration class to store the configuration of a "),pr=s("a"),Hd=i("CLIPModel"),Kd=i(`. It is used to instantiate an CLIP
...
special tokens using the tokenizer `),ba=s("code"),Oc=i("prepare_for_model"),Ac=i(" method."),Nc=m(),Jt=s("div"),P(Dn.$$.fragment),Vc=m(),Pa=s("p"),Sc=i(`Create a mask from the two sequences passed. CLIP does not make use of token type ids, therefore a list of
zeros is returned.`),Wc=m(),br=s("div"),P(On.$$.fragment),tl=m(),ot=s("h2"),Xt=s("a"),$a=s("span"),P(An.$$.fragment),Bc=m(),Ta=s("span"),Uc=i("CLIPTokenizerFast"),ol=m(),B=s("div"),P(Nn.$$.fragment),Rc=m(),Vn=s("p"),Hc=i("Construct a \u201Cfast\u201D CLIP tokenizer (backed by HuggingFace\u2019s "),Ia=s("em"),Kc=i("tokenizers"),Gc=i(` library). Based on byte-level
...
refer to this superclass for more information regarding those methods.`),Yc=m(),de=s("div"),P(Wn.$$.fragment),ep=m(),ya=s("p"),tp=i(`Build model inputs from a sequence or a pair of sequence for sequence classification tasks by concatenating and
adding special tokens. A CLIP sequence has the following format:`),op=m(),Ca=s("ul"),$r=s("li"),np=i("single sequence: "),xa=s("code"),sp=i("<|startoftext|> X <|endoftext|>"),rp=m(),La=s("p"),ap=i("Pairs of sequences are not the expected use case, but they will be handled without a separator."),ip=m(),Zt=s("div"),P(Bn.$$.fragment),lp=m(),ka=s("p"),dp=i(`Create a mask from the two sequences passed. CLIP does not make use of token type ids, therefore a list of
...
should refer to this superclass for more information regarding those methods.`),rl=m(),st=s("h2"),Yt=s("a"),ja=s("span"),P(Kn.$$.fragment),vp=m(),za=s("span"),bp=i("CLIPProcessor"),al=m(),U=s("div"),P(Gn.$$.fragment),Pp=m(),Fa=s("p"),$p=i("Constructs a CLIP processor which wraps a CLIP feature extractor and a CLIP tokenizer into a single processor."),Tp=m(),K=s("p"),Ir=s("a"),Ip=i("CLIPProcessor"),yp=i(" offers all the functionalities of "),yr=s("a"),Cp=i("CLIPFeatureExtractor"),xp=i(" and "),Cr=s("a"),Lp=i("CLIPTokenizerFast"),kp=i(`. See the
...
refer to the docstring of this method for more information.`),Ap=m(),to=s("div"),P(Zn.$$.fragment),Np=m(),Qn=s("p"),Vp=i("This method forwards all its arguments to CLIPTokenizerFast\u2019s "),kr=s("a"),Sp=i("decode()"),Wp=i(`. Please refer to
...
behavior.`),Jp=m(),ce=s("div"),P(ns.$$.fragment),Xp=m(),at=s("p"),Zp=i("The "),wr=s("a"),Qp=i("CLIPModel"),Yp=i(" forward method, overrides the "),Aa=s("code"),em=i("__call__"),tm=i(" special method."),om=m(),P(no.$$.fragment),nm=m(),P(so.$$.fragment),sm=m(),pe=s("div"),P(ss.$$.fragment),rm=m(),it=s("p"),am=i("The "),Mr=s("a"),im=i("CLIPModel"),lm=i(" forward method, overrides the "),Na=s("code"),dm=i("__call__"),cm=i(" special method."),pm=m(),P(ro.$$.fragment),mm=m(),P(ao.$$.fragment),fm=m(),me=s("div"),P(rs.$$.fragment),hm=m(),lt=s("p"),um=i("The "),Er=s("a"),gm=i("CLIPModel"),_m=i(" forward method, overrides the "),Va=s("code"),vm=i("__call__"),bm=i(" special method."),Pm=m(),P(io.$$.fragment),$m=m(),P(lo.$$.fragment),dl=m(),dt=s("h2"),co=s("a"),Sa=s("span"),P(as.$$.fragment),Tm=m(),Wa=s("span"),Im=i("CLIPTextModel"),cl=m(),ct=s("div"),P(is.$$.fragment),ym=m(),fe=s("div"),P(ls.$$.fragment),Cm=m(),pt=s("p"),xm=i("The "),jr=s("a"),Lm=i("CLIPTextModel"),km=i(" forward method, overrides the "),Ba=s("code"),wm=i("__call__"),Mm=i(" special method."),Em=m(),P(po.$$.fragment),jm=m(),P(mo.$$.fragment),pl=m(),mt=s("h2"),fo=s("a"),Ua=s("span"),P(ds.$$.fragment),zm=m(),Ra=s("span"),Fm=i("CLIPVisionModel"),ml=m(),ft=s("div"),P(cs.$$.fragment),qm=m(),he=s("div"),P(ps.$$.fragment),Dm=m(),ht=s("p"),Om=i("The "),zr=s("a"),Am=i("CLIPVisionModel"),Nm=i(" forward method, overrides the "),Ha=s("code"),Vm=i("__call__"),Sm=i(" special method."),Wm=m(),P(ho.$$.fragment),Bm=m(),P(uo.$$.fragment),fl=m(),ut=s("h2"),go=s("a"),Ka=s("span"),P(ms.$$.fragment),Um=m(),Ga=s("span"),Rm=i("TFCLIPModel"),hl=m(),q=s("div"),P(fs.$$.fragment),Hm=m(),hs=s("p"),Km=i("This model inherits from "),Fr=s("a"),Gm=i("TFPreTrainedModel"),Jm=i(`. Check the superclass documentation for the generic methods the
...
documentation from `),dr=r(Sr,"A",{href:!0});var au=a(dr);qd=l(au,"PretrainedConfig"),au.forEach(o),Dd=l(Sr," for more information."),Sr.forEach(o),Od=f(Bo),Wt=r(Bo,"DIV",{class:!0});var xl=a(Wt);$(Tn.$$.fragment,xl),Ad=f(xl),In=r(xl,"P",{});var Ll=a(In);Nd=l(Ll,"Instantiate a "),cr=r(Ll,"A",{href:!0});var iu=a(cr);Vd=l(iu,"CLIPConfig"),iu.forEach(o),Sd=l(Ll,` (or a derived class) from clip text model configuration and clip vision model
configuration.`),Ll.forEach(o),xl.forEach(o),Bo.forEach(o),Ji=f(t),Je=r(t,"H2",{class:!0});var kl=a(Je);Bt=r(kl,"A",{id:!0,class:!0,href:!0});var lu=a(Bt);la=r(lu,"SPAN",{});var du=a(la);$(yn.$$.fragment,du),du.forEach(o),lu.forEach(o),Wd=f(kl),da=r(kl,"SPAN",{});var cu=a(da);Bd=l(cu,"CLIPTextConfig"),cu.forEach(o),kl.forEach(o),Xi=f(t),te=r(t,"DIV",{class:!0});var Uo=a(te);$(Cn.$$.fragment,Uo),Ud=f(Uo),Xe=r(Uo,"P",{});var Wr=a(Xe);Rd=l(Wr,"This is the configuration class to store the configuration of a "),pr=r(Wr,"A",{href:!0});var pu=a(pr);Hd=l(pu,"CLIPModel"),pu.forEach(o),Kd=l(Wr,`. It is used to instantiate an CLIP
model according to the specified arguments, defining the model architecture. Instantiating a configuration with the
defaults will yield a similar configuration to that of the CLIP
...
documentation from `),gr=r(Rr,"A",{href:!0});var $u=a(gr);uc=l($u,"PretrainedConfig"),$u.forEach(o),gc=l(Rr," for more information."),Rr.forEach(o),_c=f(Ro),$(Ht.$$.fragment,Ro),Ro.forEach(o),Yi=f(t),tt=r(t,"H2",{class:!0});var Ml=a(tt);Kt=r(Ml,"A",{id:!0,class:!0,href:!0});var Tu=a(Kt);ma=r(Tu,"SPAN",{});var Iu=a(ma);$(Mn.$$.fragment,Iu),Iu.forEach(o),Tu.forEach(o),vc=f(Ml),fa=r(Ml,"SPAN",{});var yu=a(fa);bc=l(yu,"CLIPTokenizer"),yu.forEach(o),Ml.forEach(o),el=f(t),F=r(t,"DIV",{class:!0});var G=a(F);$(En.$$.fragment,G),Pc=f(G),ha=r(G,"P",{});var Cu=a(ha);$c=l(Cu,"Construct a CLIP tokenizer. Based on byte-level Byte-Pair-Encoding."),Cu.forEach(o),Tc=f(G),jn=r(G,"P",{});var El=a(jn);Ic=l(El,"This tokenizer inherits from "),_r=r(El,"A",{href:!0});var xu=a(_r);yc=l(xu,"PreTrainedTokenizer"),xu.forEach(o),Cc=l(El,` which contains most of the main methods. Users should refer to
...
special tokens using the tokenizer `),ba=r(zl,"CODE",{});var Eu=a(ba);Oc=l(Eu,"prepare_for_model"),Eu.forEach(o),Ac=l(zl," method."),zl.forEach(o),jl.forEach(o),Nc=f(G),Jt=r(G,"DIV",{class:!0});var Fl=a(Jt);$(Dn.$$.fragment,Fl),Vc=f(Fl),Pa=r(Fl,"P",{});var ju=a(Pa);Sc=l(ju,`Create a mask from the two sequences passed. CLIP does not make use of token type ids, therefore a list of
zeros is returned.`),ju.forEach(o),Fl.forEach(o),Wc=f(G),br=r(G,"DIV",{class:!0});var zu=a(br);$(On.$$.fragment,zu),zu.forEach(o),G.forEach(o),tl=f(t),ot=r(t,"H2",{class:!0});var ql=a(ot);Xt=r(ql,"A",{id:!0,class:!0,href:!0});var Fu=a(Xt);$a=r(Fu,"SPAN",{});var qu=a($a);$(An.$$.fragment,qu),qu.forEach(o),Fu.forEach(o),Bc=f(ql),Ta=r(ql,"SPAN",{});var Du=a(Ta);Uc=l(Du,"CLIPTokenizerFast"),Du.forEach(o),ql.forEach(o),ol=f(t),B=r(t,"DIV",{class:!0});var Se=a(B);$(Nn.$$.fragment,Se),Rc=f(Se),Vn=r(Se,"P",{});var Dl=a(Vn);Hc=l(Dl,"Construct a \u201Cfast\u201D CLIP tokenizer (backed by HuggingFace\u2019s "),Ia=r(Dl,"EM",{});var Ou=a(Ia);Kc=l(Ou,"tokenizers"),Ou.forEach(o),Gc=l(Dl,` library). Based on byte-level
...
refer to this superclass for more information regarding those methods.`),Ol.forEach(o),Yc=f(Se),de=r(Se,"DIV",{class:!0});var Ko=a(de);$(Wn.$$.fragment,Ko),ep=f(Ko),ya=r(Ko,"P",{});var Nu=a(ya);tp=l(Nu,`Build model inputs from a sequence or a pair of sequence for sequence classification tasks by concatenating and
adding special tokens. A CLIP sequence has the following format:`),Nu.forEach(o),op=f(Ko),Ca=r(Ko,"UL",{});var Vu=a(Ca);$r=r(Vu,"LI",{});var Yh=a($r);np=l(Yh,"single sequence: "),xa=r(Yh,"CODE",{});var Su=a(xa);sp=l(Su,"<|startoftext|> X <|endoftext|>"),Su.forEach(o),Yh.forEach(o),Vu.forEach(o),rp=f(Ko),La=r(Ko,"P",{});var Wu=a(La);ap=l(Wu,"Pairs of sequences are not the expected use case, but they will be handled without a separator."),Wu.forEach(o),Ko.forEach(o),ip=f(Se),Zt=r(Se,"DIV",{class:!0});var Al=a(Zt);$(Bn.$$.fragment,Al),lp=f(Al),ka=r(Al,"P",{});var Bu=a(ka);dp=l(Bu,`Create a mask from the two sequences passed. CLIP does not make use of token type ids, therefore a list of
zeros is returned.`),Bu.forEach(o),Al.forEach(o),Se.forEach(o),nl=f(t),nt=r(t,"H2",{class:!0});var Nl=a(nt);Qt=r(Nl,"A",{id:!0,class:!0,href:!0});var Uu=a(Qt);wa=r(Uu,"SPAN",{});var Ru=a(wa);$(Un.$$.fragment,Ru),Ru.forEach(o),Uu.forEach(o),cp=f(Nl),Ma=r(Nl,"SPAN",{});var Hu=a(Ma);pp=l(Hu,"CLIPFeatureExtractor"),Hu.forEach(o),Nl.forEach(o),sl=f(t),Ee=r(t,"DIV",{class:!0});var Hr=a(Ee);$(Rn.$$.fragment,Hr),mp=f(Hr),Ea=r(Hr,"P",{});var Ku=a(Ea);fp=l(Ku,"Constructs a CLIP feature extractor."),Ku.forEach(o),hp=f(Hr),Hn=r(Hr,"P",{});var Vl=a(Hn);up=l(Vl,"This feature extractor inherits from "),Tr=r(Vl,"A",{href:!0});var Gu=a(Tr);gp=l(Gu,"FeatureExtractionMixin"),Gu.forEach(o),_p=l(Vl,` which contains most of the main methods. Users
should refer to this superclass for more information regarding those methods.`),Vl.forEach(o),Hr.forEach(o),rl=f(t),st=r(t,"H2",{class:!0});var Sl=a(st);Yt=r(Sl,"A",{id:!0,class:!0,href:!0});var Ju=a(Yt);ja=r(Ju,"SPAN",{});var Xu=a(ja);$(Kn.$$.fragment,Xu),Xu.forEach(o),Ju.forEach(o),vp=f(Sl),za=r(Sl,"SPAN",{});var Zu=a(za);bp=l(Zu,"CLIPProcessor"),Zu.forEach(o),Sl.forEach(o),al=f(t),U=r(t,"DIV",{class:!0});var We=a(U);$(Gn.$$.fragment,We),Pp=f(We),Fa=r(We,"P",{});var Qu=a(Fa);$p=l(Qu,"Constructs a CLIP processor which wraps a CLIP feature extractor and a CLIP tokenizer into a single processor."),Qu.forEach(o),Tp=f(We),K=r(We,"P",{});var ze=a(K);Ir=r(ze,"A",{href:!0});var Yu=a(Ir);Ip=l(Yu,"CLIPProcessor"),Yu.forEach(o),yp=l(ze," offers all the functionalities of "),yr=r(ze,"A",{href:!0});var eg=a(yr);Cp=l(eg,"CLIPFeatureExtractor"),eg.forEach(o),xp=l(ze," and "),Cr=r(ze,"A",{href:!0});var tg=a(Cr);Lp=l(tg,"CLIPTokenizerFast"),tg.forEach(o),kp=l(ze,`. See the
...
refer to the docstring of this method for more information.`),Bl.forEach(o),Wl.forEach(o),Ap=f(We),to=r(We,"DIV",{class:!0});var Ul=a(to);$(Zn.$$.fragment,Ul),Np=f(Ul),Qn=r(Ul,"P",{});var Rl=a(Qn);Vp=l(Rl,"This method forwards all its arguments to CLIPTokenizerFast\u2019s "),kr=r(Rl,"A",{href:!0});var rg=a(kr);Sp=l(rg,"decode()"),rg.forEach(o),Wp=l(Rl,`. Please refer to
