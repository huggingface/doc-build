import{S as Pr,i as Mr,s as zr,e as n,k as c,w as T,t as r,M as Cr,c as s,d as t,m,a,x as b,h as i,b as l,G as e,g as _,y as E,q as $,o as j,B as w,v as Fr,L as xa}from"../../chunks/vendor-hf-doc-builder.js";import{T as Dr}from"../../chunks/Tip-hf-doc-builder.js";import{D as R}from"../../chunks/Docstring-hf-doc-builder.js";import{C as Ta}from"../../chunks/CodeBlock-hf-doc-builder.js";import{I as Pt}from"../../chunks/IconCopyLink-hf-doc-builder.js";import{E as va}from"../../chunks/ExampleCodeBlock-hf-doc-builder.js";function Ir(I){let p,x,g,f,v;return f=new Ta({props:{code:`from transformers import ViTConfig, BertConfig, VisionTextDualEncoderConfig, VisionTextDualEncoderModel
...
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),h.forEach(t)},m(d,h){_(d,p,h),e(p,x),e(p,g),e(g,f),e(p,v)},d(d){d&&t(p)}}}function qr(I){let p,x,g,f,v;return f=new Ta({props:{code:`from PIL import Image
import requests
...
<span class="hljs-meta">&gt;&gt;&gt; </span>outputs = model(**inputs)
<span class="hljs-meta">&gt;&gt;&gt; </span>logits_per_image = outputs.logits_per_image  <span class="hljs-comment"># this is the image-text similarity score</span>
<span class="hljs-meta">&gt;&gt;&gt; </span>probs = jax.nn.softmax(logits_per_image, axis=<span class="hljs-number">1</span>)  <span class="hljs-comment"># we can take the softmax to get the label probabilities</span>`}}),{c(){p=n("p"),x=r("Examples:"),g=c(),T(f.$$.fragment)},l(d){p=s(d,"P",{});var h=a(p);x=i(h,"Examples:"),h.forEach(t),g=m(d),b(f.$$.fragment,d)},m(d,h){_(d,p,h),e(p,x),_(d,g,h),E(f,d,h),v=!0},p:xa,i(d){v||($(f.$$.fragment,d),v=!0)},o(d){j(f.$$.fragment,d),v=!1},d(d){d&&t(p),d&&t(g),w(f,d)}}}function Nr(I){let p,x,g,f,v,d,h,S,qo,no,U,Y,Mt,_e,Lo,zt,So,so,k,No,ot,Oo,Bo,Ct,Wo,Ro,nt,Uo,Jo,st,Ho,Zo,at,Go,Xo,Ft,Ko,Qo,rt,Yo,en,it,tn,on,ao,ee,nn,ve,sn,an,ro,J,te,It,xe,rn,At,ln,io,M,Te,dn,B,lt,cn,mn,dt,pn,fn,ct,hn,un,gn,H,_n,mt,vn,xn,pt,Tn,bn,En,oe,$n,ne,be,jn,Ee,wn,ft,yn,kn,Vn,se,$e,Dn,je,Pn,ht,Mn,zn,lo,Z,ae,qt,we,Cn,Lt,Fn,co,z,ye,In,St,An,qn,C,ut,Ln,Sn,gt,Nn,On,_t,Bn,Wn,Nt,Rn,Un,vt,Jn,Hn,Zn,re,ke,Gn,Ve,Xn,xt,Kn,Qn,Yn,ie,De,es,Pe,ts,Tt,os,ns,mo,G,le,Ot,Me,ss,Bt,as,po,V,ze,rs,Ce,is,bt,ls,ds,cs,Fe,ms,Ie,ps,fs,hs,Wt,us,gs,Ae,_s,Et,vs,xs,Ts,qe,bs,Le,Es,$s,js,A,Se,ws,X,ys,$t,ks,Vs,Rt,Ds,Ps,Ms,de,zs,ce,fo,K,me,Ut,Ne,Cs,Jt,Fs,ho,y,Oe,Is,Be,As,jt,qs,Ls,Ss,We,Ns,Re,Os,Bs,Ws,Ht,Rs,Us,Ue,Js,wt,Hs,Zs,Gs,Je,Xs,He,Ks,Qs,Ys,Zt,ea,ta,N,Gt,Ze,oa,na,Xt,Ge,sa,aa,Kt,Xe,ra,ia,Qt,Ke,la,da,q,Qe,ca,Q,ma,yt,pa,fa,Yt,ha,ua,ga,pe,_a,fe,uo;return d=new Pt({}),_e=new Pt({}),xe=new Pt({}),Te=new R({props:{name:"class transformers.VisionTextDualEncoderConfig",anchor:"transformers.VisionTextDualEncoderConfig",parameters:[{name:"projection_dim",val:" = 512"},{name:"logit_scale_init_value",val:" = 2.6592"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.VisionTextDualEncoderConfig.text_config_dict",description:`<strong>text_config_dict</strong> (<code>dict</code>) &#x2014;
...
Dictionary of keyword arguments.`,name:"kwargs"}],source:"https://github.com/huggingface/transformers/blob/v4.21.0/src/transformers/models/vision_text_dual_encoder/configuration_vision_text_dual_encoder.py#L28"}}),oe=new va({props:{anchor:"transformers.VisionTextDualEncoderConfig.example",$$slots:{default:[Ir]},$$scope:{ctx:I}}}),be=new R({props:{name:"from_vision_text_configs",anchor:"transformers.VisionTextDualEncoderConfig.from_vision_text_configs",parameters:[{name:"vision_config",val:": PretrainedConfig"},{name:"text_config",val:": PretrainedConfig"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/v4.21.0/src/transformers/models/vision_text_dual_encoder/configuration_vision_text_dual_encoder.py#L105",returnDescription:`
<p>An instance of a configuration object</p>
`,returnType:`
<p><a
  href="/docs/transformers/v4.21.0/en/model_doc/vision-text-dual-encoder#transformers.VisionTextDualEncoderConfig"
>VisionTextDualEncoderConfig</a></p>
`}}),$e=new R({props:{name:"to_dict",anchor:"transformers.VisionTextDualEncoderConfig.to_dict",parameters:[],source:"https://github.com/huggingface/transformers/blob/v4.21.0/src/transformers/models/vision_text_dual_encoder/configuration_vision_text_dual_encoder.py#L117",returnDescription:`
...
The feature extractor is a required input.`,name:"feature_extractor"},{anchor:"transformers.VisionTextDualEncoderProcessor.tokenizer",description:`<strong>tokenizer</strong> (<a href="/docs/transformers/v4.21.0/en/main_classes/tokenizer#transformers.PreTrainedTokenizer">PreTrainedTokenizer</a>) &#x2014;
The tokenizer is a required input.`,name:"tokenizer"}],source:"https://github.com/huggingface/transformers/blob/v4.21.0/src/transformers/models/vision_text_dual_encoder/processing_vision_text_dual_encoder.py#L23"}}),ke=new R({props:{name:"batch_decode",anchor:"transformers.VisionTextDualEncoderProcessor.batch_decode",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/v4.21.0/src/transformers/models/vision_text_dual_encoder/processing_vision_text_dual_encoder.py#L98"}}),De=new R({props:{name:"decode",anchor:"transformers.VisionTextDualEncoderProcessor.decode",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/v4.21.0/src/transformers/models/vision_text_dual_encoder/processing_vision_text_dual_encoder.py#L105"}}),Me=new Pt({}),ze=new R({props:{name:"class transformers.VisionTextDualEncoderModel",anchor:"transformers.VisionTextDualEncoderModel",parameters:[{name:"config",val:": typing.Optional[transformers.models.vision_text_dual_encoder.configuration_vision_text_dual_encoder.VisionTextDualEncoderConfig] = None"},{name:"vision_model",val:": typing.Optional[transformers.modeling_utils.PreTrainedModel] = None"},{name:"text_model",val:": typing.Optional[transformers.modeling_utils.PreTrainedModel] = None"}],parametersDescription:[{anchor:"transformers.VisionTextDualEncoderModel.config",description:`<strong>config</strong> (<a href="/docs/transformers/v4.21.0/en/model_doc/vision-encoder-decoder#transformers.VisionEncoderDecoderConfig">VisionEncoderDecoderConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/v4.21.0/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/v4.21.0/src/transformers/models/vision_text_dual_encoder/modeling_vision_text_dual_encoder.py#L162"}}),Se=new R({props:{name:"forward",anchor:"transformers.VisionTextDualEncoderModel.forward",parameters:[{name:"input_ids",val:" = None"},{name:"pixel_values",val:" = None"},{name:"attention_mask",val:" = None"},{name:"position_ids",val:" = None"},{name:"return_loss",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],parametersDescription:[{anchor:"transformers.VisionTextDualEncoderModel.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
...
a feature extractor (e.g. if you use ViT as the encoder, you should use <a href="/docs/transformers/v4.21.0/en/model_doc/vit#transformers.ViTFeatureExtractor">ViTFeatureExtractor</a>). See
<a href="/docs/transformers/v4.21.0/en/model_doc/vit#transformers.ViTFeatureExtractor.__call__">ViTFeatureExtractor.<strong>call</strong>()</a> for details.`,name:"pixel_values"},{anchor:"transformers.VisionTextDualEncoderModel.forward.return_loss",description:`<strong>return_loss</strong> (<code>bool</code>, <em>optional</em>) &#x2014;
...
Whether or not to return a <a href="/docs/transformers/v4.21.0/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/v4.21.0/src/transformers/models/vision_text_dual_encoder/modeling_vision_text_dual_encoder.py#L294",returnDescription:`
...
should be fine-tuned on a downstream task, like contrastive image-text modeling.`),cs=c(),Fe=n("p"),ms=r("In "),Ie=n("a"),ps=r("LiT: Zero-Shot Transfer with Locked-image Text Tuning"),fs=r(` it is shown how
...
and behavior.`),js=c(),A=n("div"),T(Se.$$.fragment),ws=c(),X=n("p"),ys=r("The "),$t=n("a"),ks=r("VisionTextDualEncoderModel"),Vs=r(" forward method, overrides the "),Rt=n("code"),Ds=r("__call__"),Ps=r(" special method."),Ms=c(),T(de.$$.fragment),zs=c(),T(ce.$$.fragment),fo=c(),K=n("h2"),me=n("a"),Ut=n("span"),T(Ne.$$.fragment),Cs=c(),Jt=n("span"),Fs=r("FlaxVisionTextDualEncoderModel"),ho=c(),y=n("div"),T(Oe.$$.fragment),Is=c(),Be=n("p"),As=r(`This class can be used to initialize a vision-text dual encoder model with any pretrained vision autoencoding model
as the vision encoder and any pretrained text model as the text encoder. The vision and text encoders are loaded
...
general usage and behavior.`),Ys=c(),Zt=n("p"),ea=r("Finally, this model supports inherent JAX features such as:"),ta=c(),N=n("ul"),Gt=n("li"),Ze=n("a"),oa=r("Just-In-Time (JIT) compilation"),na=c(),Xt=n("li"),Ge=n("a"),sa=r("Automatic Differentiation"),aa=c(),Kt=n("li"),Xe=n("a"),ra=r("Vectorization"),ia=c(),Qt=n("li"),Ke=n("a"),la=r("Parallelization"),da=c(),q=n("div"),T(Qe.$$.fragment),ca=c(),Q=n("p"),ma=r("The "),yt=n("a"),pa=r("FlaxVisionTextDualEncoderModel"),fa=r(" forward method, overrides the "),Yt=n("code"),ha=r("__call__"),ua=r(" special method."),ga=c(),T(pe.$$.fragment),_a=c(),T(fe.$$.fragment),this.h()},l(o){const u=Cr('[data-svelte="svelte-1phssyn"]',document.head);p=s(u,"META",{name:!0,content:!0}),u.forEach(t),x=m(o),g=s(o,"H1",{class:!0});var Ye=a(g);f=s(Ye,"A",{id:!0,class:!0,href:!0});var eo=a(f);v=s(eo,"SPAN",{});var to=a(v);b(d.$$.fragment,to),to.forEach(t),eo.forEach(t),h=m(Ye),S=s(Ye,"SPAN",{});var oo=a(S);qo=i(oo,"VisionTextDualEncoder"),oo.forEach(t),Ye.forEach(t),no=m(o),U=s(o,"H2",{class:!0});var et=a(U);Y=s(et,"A",{id:!0,class:!0,href:!0});var ba=a(Y);Mt=s(ba,"SPAN",{});var Ea=a(Mt);b(_e.$$.fragment,Ea),Ea.forEach(t),ba.forEach(t),Lo=m(et),zt=s(et,"SPAN",{});var $a=a(zt);So=i($a,"Overview"),$a.forEach(t),et.forEach(t),so=m(o),k=s(o,"P",{});var D=a(k);No=i(D,"The "),ot=s(D,"A",{href:!0});var ja=a(ot);Oo=i(ja,"VisionTextDualEncoderModel"),ja.forEach(t),Bo=i(D,` can be used to initialize a vision-text dual encoder model with
any pretrained vision autoencoding model as the vision encoder (`),Ct=s(D,"EM",{});var wa=a(Ct);Wo=i(wa,"e.g."),wa.forEach(t),Ro=m(D),nt=s(D,"A",{href:!0});var ya=a(nt);Uo=i(ya,"ViT"),ya.forEach(t),Jo=i(D,", "),st=s(D,"A",{href:!0});var ka=a(st);Ho=i(ka,"BEiT"),ka.forEach(t),Zo=i(D,", "),at=s(D,"A",{href:!0});var Va=a(at);Go=i(Va,"DeiT"),Va.forEach(t),Xo=i(D,") and any pretrained text autoencoding model as the text encoder ("),Ft=s(D,"EM",{});var Da=a(Ft);Ko=i(Da,"e.g."),Da.forEach(t),Qo=m(D),rt=s(D,"A",{href:!0});var Pa=a(rt);Yo=i(Pa,"RoBERTa"),Pa.forEach(t),en=i(D,", "),it=s(D,"A",{href:!0});var Ma=a(it);tn=i(Ma,"BERT"),Ma.forEach(t),on=i(D,`). Two projection layers are added on top of both the vision and text encoder to project the output embeddings
to a shared latent space. The projection layers are randomly initialized so the model should be fine-tuned on a
downstream task. This model can be used to align the vision-text embeddings using CLIP like contrastive image-text
...
leveraging pre-trained (locked/frozen) image and text model for contrastive learning yields significant improvment on
new zero-shot vision tasks such as image classification or retrieval.`),go.forEach(t),ro=m(o),J=s(o,"H2",{class:!0});var _o=a(J);te=s(_o,"A",{id:!0,class:!0,href:!0});var Ca=a(te);It=s(Ca,"SPAN",{});var Fa=a(It);b(xe.$$.fragment,Fa),Fa.forEach(t),Ca.forEach(t),rn=m(_o),At=s(_o,"SPAN",{});var Ia=a(At);ln=i(Ia,"VisionTextDualEncoderConfig"),Ia.forEach(t),_o.forEach(t),io=m(o),M=s(o,"DIV",{class:!0});var L=a(M);b(Te.$$.fragment,L),dn=m(L),B=s(L,"P",{});var tt=a(B);lt=s(tt,"A",{href:!0});var Aa=a(lt);cn=i(Aa,"VisionTextDualEncoderConfig"),Aa.forEach(t),mn=i(tt,` is the configuration class to store the configuration of a
...
documentation from `),pt=s(kt,"A",{href:!0});var Na=a(pt);Tn=i(Na,"PretrainedConfig"),Na.forEach(t),bn=i(kt," for more information."),kt.forEach(t),En=m(L),b(oe.$$.fragment,L),$n=m(L),ne=s(L,"DIV",{class:!0});var vo=a(ne);b(be.$$.fragment,vo),jn=m(vo),Ee=s(vo,"P",{});var xo=a(Ee);wn=i(xo,"Instantiate a "),ft=s(xo,"A",{href:!0});var Oa=a(ft);yn=i(Oa,"VisionTextDualEncoderConfig"),Oa.forEach(t),kn=i(xo,` (or a derived class) from text model configuration and vision
model configuration.`),xo.forEach(t),vo.forEach(t),Vn=m(L),se=s(L,"DIV",{class:!0});var To=a(se);b($e.$$.fragment,To),Dn=m(To),je=s(To,"P",{});var bo=a(je);Pn=i(bo,"Serializes this instance to a Python dictionary. Override the default "),ht=s(bo,"A",{href:!0});var Ba=a(ht);Mn=i(Ba,"to_dict()"),Ba.forEach(t),zn=i(bo,"."),bo.forEach(t),To.forEach(t),L.forEach(t),lo=m(o),Z=s(o,"H2",{class:!0});var Eo=a(Z);ae=s(Eo,"A",{id:!0,class:!0,href:!0});var Wa=a(ae);qt=s(Wa,"SPAN",{});var Ra=a(qt);b(we.$$.fragment,Ra),Ra.forEach(t),Wa.forEach(t),Cn=m(Eo),Lt=s(Eo,"SPAN",{});var Ua=a(Lt);Fn=i(Ua,"VisionTextDualEncoderProcessor"),Ua.forEach(t),Eo.forEach(t),co=m(o),z=s(o,"DIV",{class:!0});var W=a(z);b(ye.$$.fragment,W),In=m(W),St=s(W,"P",{});var Ja=a(St);An=i(Ja,`Constructs a VisionTextDualEncoder processor which wraps a vision feature extractor and a tokenizer into a single
processor.`),Ja.forEach(t),qn=m(W),C=s(W,"P",{});var O=a(C);ut=s(O,"A",{href:!0});var Ha=a(ut);Ln=i(Ha,"VisionTextDualEncoderProcessor"),Ha.forEach(t),Sn=i(O," offers all the functionalities of "),gt=s(O,"A",{href:!0});var Za=a(gt);Nn=i(Za,"AutoFeatureExtractor"),Za.forEach(t),On=i(O,` and
...
`),vt=s(O,"A",{href:!0});var Ka=a(vt);Jn=i(Ka,"decode()"),Ka.forEach(t),Hn=i(O," for more information."),O.forEach(t),Zn=m(W),re=s(W,"DIV",{class:!0});var $o=a(re);b(ke.$$.fragment,$o),Gn=m($o),Ve=s($o,"P",{});var jo=a(Ve);Xn=i(jo,`This method forwards all its arguments to VisionTextDualEncoderTokenizer\u2019s
`),xt=s(jo,"A",{href:!0});var Qa=a(xt);Kn=i(Qa,"batch_decode()"),Qa.forEach(t),Qn=i(jo,". Please refer to the docstring of this method for more information."),jo.forEach(t),$o.forEach(t),Yn=m(W),ie=s(W,"DIV",{class:!0});var wo=a(ie);b(De.$$.fragment,wo),es=m(wo),Pe=s(wo,"P",{});var yo=a(Pe);ts=i(yo,"This method forwards all its arguments to VisionTextDualEncoderTokenizer\u2019s "),Tt=s(yo,"A",{href:!0});var Ya=a(Tt);os=i(Ya,"decode()"),Ya.forEach(t),ns=i(yo,`.
Please refer to the docstring of this method for more information.`),yo.forEach(t),wo.forEach(t),W.forEach(t),mo=m(o),G=s(o,"H2",{class:!0});var ko=a(G);le=s(ko,"A",{id:!0,class:!0,href:!0});var er=a(le);Ot=s(er,"SPAN",{});var tr=a(Ot);b(Me.$$.fragment,tr),tr.forEach(t),er.forEach(t),ss=m(ko),Bt=s(ko,"SPAN",{});var or=a(Bt);as=i(or,"VisionTextDualEncoderModel"),or.forEach(t),ko.forEach(t),po=m(o),V=s(o,"DIV",{class:!0});var F=a(V);b(ze.$$.fragment,F),rs=m(F),Ce=s(F,"P",{});var Vo=a(Ce);is=i(Vo,`This class can be used to initialize a vision-text dual encoder model with any pretrained vision autoencoding model
as the vision encoder and any pretrained text model as the text encoder. The vision and text encoders are loaded
...
should be fine-tuned on a downstream task, like contrastive image-text modeling.`),Vo.forEach(t),cs=m(F),Fe=s(F,"P",{});var Do=a(Fe);ms=i(Do,"In "),Ie=s(Do,"A",{href:!0,rel:!0});var sr=a(Ie);ps=i(sr,"LiT: Zero-Shot Transfer with Locked-image Text Tuning"),sr.forEach(t),fs=i(Do,` it is shown how
leveraging pre-trained (locked/frozen) image and text model for contrastive learning yields significant improvment
on new zero-shot vision tasks such as image classification or retrieval.`),Do.forEach(t),hs=m(F),Wt=s(F,"P",{});var ar=a(Wt);us=i(ar,`After such a Vision-Text-Dual-Encoder model has been trained/fine-tuned, it can be saved/loaded just like any other
models (see the examples for more information).`),ar.forEach(t),gs=m(F),Ae=s(F,"P",{});var Po=a(Ae);_s=i(Po,"This model inherits from "),Et=s(Po,"A",{href:!0});var rr=a(Et);vs=i(rr,"PreTrainedModel"),rr.forEach(t),xs=i(Po,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Po.forEach(t),Ts=m(F),qe=s(F,"P",{});var Mo=a(qe);bs=i(Mo,"This model is also a PyTorch "),Le=s(Mo,"A",{href:!0,rel:!0});var ir=a(Le);Es=i(ir,"torch.nn.Module"),ir.forEach(t),$s=i(Mo,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Mo.forEach(t),js=m(F),A=s(F,"DIV",{class:!0});var he=a(A);b(Se.$$.fragment,he),ws=m(he),X=s(he,"P",{});var Vt=a(X);ys=i(Vt,"The "),$t=s(Vt,"A",{href:!0});var lr=a($t);ks=i(lr,"VisionTextDualEncoderModel"),lr.forEach(t),Vs=i(Vt," forward method, overrides the "),Rt=s(Vt,"CODE",{});var dr=a(Rt);Ds=i(dr,"__call__"),dr.forEach(t),Ps=i(Vt," special method."),Vt.forEach(t),Ms=m(he),b(de.$$.fragment,he),zs=m(he),b(ce.$$.fragment,he),he.forEach(t),F.forEach(t),fo=m(o),K=s(o,"H2",{class:!0});var zo=a(K);me=s(zo,"A",{id:!0,class:!0,href:!0});var cr=a(me);Ut=s(cr,"SPAN",{});var mr=a(Ut);b(Ne.$$.fragment,mr),mr.forEach(t),cr.forEach(t),Cs=m(zo),Jt=s(zo,"SPAN",{});var pr=a(Jt);Fs=i(pr,"FlaxVisionTextDualEncoderModel"),pr.forEach(t),zo.forEach(t),ho=m(o),y=s(o,"DIV",{class:!0});var P=a(y);b(Oe.$$.fragment,P),Is=m(P),Be=s(P,"P",{});var Co=a(Be);As=i(Co,`This class can be used to initialize a vision-text dual encoder model with any pretrained vision autoencoding model
as the vision encoder and any pretrained text model as the text encoder. The vision and text encoders are loaded
