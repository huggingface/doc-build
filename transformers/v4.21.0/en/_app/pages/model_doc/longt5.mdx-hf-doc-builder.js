...
<span class="hljs-meta">&gt;&gt;&gt; </span>outputs = model.decode(decoder_input_ids, encoder_outputs)
<span class="hljs-meta">&gt;&gt;&gt; </span>logits = outputs.logits`}}),{c(){l=r("p"),b=a("Example:"),m=u(),v(p.$$.fragment)},l(n){l=d(n,"P",{});var c=i(l);b=s(c,"Example:"),c.forEach(o),m=h(n),k(p.$$.fragment,n)},m(n,c){T(n,l,c),e(l,b),T(n,m,c),y(p,n,c),_=!0},p:me,i(n){_||(w(p.$$.fragment,n),_=!0)},o(n){$(p.$$.fragment,n),_=!1},d(n){n&&o(l),n&&o(m),x(p,n)}}}function _l(z){let l,b,m,p,_,n,c,L,la,bn,ee,ge,fo,Ke,ca,_o,pa,vn,fe,ua,Ze,ha,ma,kn,Yt,ga,yn,Rt,To,fa,wn,Jt,_a,$n,C,O,Vt,Ta,ba,Kt,va,ka,bo,ya,wa,vo,$a,xa,ko,za,La,yo,Fa,qa,ja,Qe,Ma,wo,Ea,Ca,Oa,Xe,Pa,$o,Ga,Sa,Aa,q,Na,xo,Ia,Da,zo,Wa,Ba,Lo,Ua,Ha,Fo,Ya,Ra,qo,Ja,Va,jo,Ka,Za,Qa,F,Mo,Xa,es,Eo,ts,os,Co,ns,as,Oo,ss,rs,Po,ds,is,Go,ls,cs,So,ps,us,hs,et,ms,tt,gs,fs,xn,ot,zn,Q,_s,nt,Ts,bs,at,vs,ks,Ln,te,_e,Ao,st,ys,No,ws,Fn,K,rt,$s,Z,xs,Zt,zs,Ls,Qt,Fs,qs,dt,js,Ms,Es,oe,Cs,Xt,Os,Ps,eo,Gs,Ss,qn,ne,Te,Io,it,As,Do,Ns,jn,j,lt,Is,Wo,Ds,Ws,ct,Bs,pt,Us,Hs,Ys,ut,Rs,to,Js,Vs,Ks,ht,Zs,mt,Qs,Xs,er,D,gt,tr,ae,or,oo,nr,ar,Bo,sr,rr,dr,be,ir,ve,Mn,se,ke,Uo,ft,lr,Ho,cr,En,M,_t,pr,Tt,ur,Yo,hr,mr,gr,bt,fr,vt,_r,Tr,br,kt,vr,no,kr,yr,wr,yt,$r,wt,xr,zr,Lr,W,$t,Fr,re,qr,ao,jr,Mr,Ro,Er,Cr,Or,ye,Pr,we,Cn,de,$e,Jo,xt,Gr,Vo,Sr,On,E,zt,Ar,Ko,Nr,Ir,Lt,Dr,Ft,Wr,Br,Ur,qt,Hr,so,Yr,Rr,Jr,jt,Vr,Mt,Kr,Zr,Qr,B,Et,Xr,ie,ed,ro,td,od,Zo,nd,ad,sd,xe,rd,ze,Pn,le,Le,Qo,Ct,dd,Xo,id,Gn,A,Ot,ld,U,Pt,cd,ce,pd,en,ud,hd,tn,md,gd,fd,Fe,_d,qe,Td,je,Gt,bd,Me,vd,Ee,St,kd,Ce,Sn,pe,Oe,on,At,yd,nn,wd,An,N,Nt,$d,H,It,xd,ue,zd,an,Ld,Fd,sn,qd,jd,Md,Pe,Ed,Ge,Cd,Se,Dt,Od,Ae,Pd,Ne,Wt,Gd,Ie,Nn;return n=new Ve({}),Ke=new Ve({}),ot=new X({props:{code:`import evaluate
...
<code>inputs_ids</code> passed when calling <a href="/docs/transformers/v4.21.0/en/model_doc/longt5#transformers.LongT5Model">LongT5Model</a>.`,name:"vocab_size"},{anchor:"transformers.LongT5Config.d_model",description:`<strong>d_model</strong> (<code>int</code>, <em>optional</em>, defaults to 512) &#x2014;
...
Whether or not the model should return the last key/values attentions (not used by all models).`,name:"use_cache"}],source:"https://github.com/huggingface/transformers/blob/v4.21.0/src/transformers/models/longt5/configuration_longt5.py#L33"}}),it=new Ve({}),lt=new G({props:{name:"class transformers.LongT5Model",anchor:"transformers.LongT5Model",parameters:[{name:"config",val:": LongT5Config"}],parametersDescription:[{anchor:"transformers.LongT5Model.config",description:`<strong>config</strong> (<a href="/docs/transformers/v4.21.0/en/model_doc/longt5#transformers.LongT5Config">LongT5Config</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/v4.21.0/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/v4.21.0/src/transformers/models/longt5/modeling_longt5.py#L1725"}}),gt=new G({props:{name:"forward",anchor:"transformers.LongT5Model.forward",parameters:[{name:"input_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"attention_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"decoder_input_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"decoder_attention_mask",val:": typing.Optional[torch.BoolTensor] = None"},{name:"head_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"decoder_head_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"cross_attn_head_mask",val:": typing.Optional[torch.Tensor] = None"},{name:"encoder_outputs",val:": typing.Optional[typing.Tuple[typing.Tuple[torch.FloatTensor]]] = None"},{name:"past_key_values",val:": typing.Optional[typing.Tuple[typing.Tuple[torch.FloatTensor]]] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.Tensor] = None"},{name:"decoder_inputs_embeds",val:": typing.Optional[torch.Tensor] = None"},{name:"use_cache",val:": typing.Optional[bool] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.LongT5Model.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. LongT5 is a model with relative position embeddings so
you should be able to pad the inputs on both the right and the left.</p>
<p>Indices can be obtained using <a href="/docs/transformers/v4.21.0/en/model_doc/mt5#transformers.T5Tokenizer">T5Tokenizer</a>. See <a href="/docs/transformers/v4.21.0/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/v4.21.0/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for detail.</p>
...
elements depending on the configuration (<a
  href="/docs/transformers/v4.21.0/en/model_doc/longt5#transformers.LongT5Config"
...
labels in <code>[0, ..., config.vocab_size]</code>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.21.0/src/transformers/models/longt5/modeling_longt5.py#L1931",returnDescription:`
<p>A <a
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/v4.21.0/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/v4.21.0/src/transformers/models/longt5/modeling_longt5.py#L2120"}}),Et=new G({props:{name:"forward",anchor:"transformers.LongT5EncoderModel.forward",parameters:[{name:"input_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"attention_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"head_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.LongT5EncoderModel.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. LongT5 is a model with relative position embeddings so
you should be able to pad the inputs on both the right and the left.</p>
<p>Indices can be obtained using <a href="/docs/transformers/v4.21.0/en/model_doc/mt5#transformers.T5Tokenizer">T5Tokenizer</a>. See <a href="/docs/transformers/v4.21.0/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/v4.21.0/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for detail.</p>
...
Whether or not to return a <a href="/docs/transformers/v4.21.0/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/v4.21.0/src/transformers/models/longt5/modeling_longt5.py#L2155",returnDescription:`
<p>A <a
...
<p>If <code>past_key_values</code> are used, the user can optionally input only the last <code>decoder_input_ids</code> (those that
don&#x2019;t have their past key value states given to this model) of shape <code>(batch_size, 1)</code> instead of all
<code>decoder_input_ids</code> of shape <code>(batch_size, sequence_length)</code>.`,name:"past_key_values"}],source:"https://github.com/huggingface/transformers/blob/v4.21.0/src/transformers/models/longt5/modeling_flax_longt5.py#L1695",returnDescription:`
<p>A <a
...
Transient-Global attention.`),kn=u(),Yt=r("p"),ga=a("The abstract from the paper is the following:"),yn=u(),Rt=r("p"),To=r("em"),fa=a(`Recent work has shown that either (1) increasing the input length or (2) increasing model size can improve the
...
The original code can be found `),at=r("a"),vs=a("here"),ks=a("."),Ln=u(),te=r("h2"),_e=r("a"),Ao=r("span"),v(st.$$.fragment),ys=u(),No=r("span"),ws=a("LongT5Config"),Fn=u(),K=r("div"),v(rt.$$.fragment),$s=u(),Z=r("p"),xs=a("This is the configuration class to store the configuration of a "),Zt=r("a"),zs=a("LongT5Model"),Ls=a(" or a "),Qt=r("a"),Fs=a("FlaxLongT5Model"),qs=a(`. It is
...
documentation from `),eo=r("a"),Gs=a("PretrainedConfig"),Ss=a(" for more information."),qn=u(),ne=r("h2"),Te=r("a"),Io=r("span"),v(it.$$.fragment),As=u(),Do=r("span"),Ns=a("LongT5Model"),jn=u(),j=r("div"),v(lt.$$.fragment),Is=u(),Wo=r("p"),Ds=a("The bare LONGT5 Model transformer outputting raw hidden-states without any specific head on top."),Ws=u(),ct=r("p"),Bs=a("The LongT5 model was proposed in "),pt=r("a"),Us=a(`LongT5: Efficient Text-To-Text Transformer for Long
...
and behavior.`),er=u(),D=r("div"),v(gt.$$.fragment),tr=u(),ae=r("p"),or=a("The "),oo=r("a"),nr=a("LongT5Model"),ar=a(" forward method, overrides the "),Bo=r("code"),sr=a("__call__"),rr=a(" special method."),dr=u(),v(be.$$.fragment),ir=u(),v(ve.$$.fragment),Mn=u(),se=r("h2"),ke=r("a"),Uo=r("span"),v(ft.$$.fragment),lr=u(),Ho=r("span"),cr=a("LongT5ForConditionalGeneration"),En=u(),M=r("div"),v(_t.$$.fragment),pr=u(),Tt=r("p"),ur=a("LONGT5 Model with a "),Yo=r("code"),hr=a("language modeling"),mr=a(" head on top."),gr=u(),bt=r("p"),fr=a("The LongT5 model was proposed in "),vt=r("a"),_r=a(`LongT5: Efficient Text-To-Text Transformer for Long
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Qr=u(),B=r("div"),v(Et.$$.fragment),Xr=u(),ie=r("p"),ed=a("The "),ro=r("a"),td=a("LongT5EncoderModel"),od=a(" forward method, overrides the "),Zo=r("code"),nd=a("__call__"),ad=a(" special method."),sd=u(),v(xe.$$.fragment),rd=u(),v(ze.$$.fragment),Pn=u(),le=r("h2"),Le=r("a"),Qo=r("span"),v(Ct.$$.fragment),dd=u(),Xo=r("span"),id=a("FlaxLongT5Model"),Gn=u(),A=r("div"),v(Ot.$$.fragment),ld=u(),U=r("div"),v(Pt.$$.fragment),cd=u(),ce=r("p"),pd=a("The "),en=r("code"),ud=a("FlaxLongT5PreTrainedModel"),hd=a(" forward method, overrides the "),tn=r("code"),md=a("__call__"),gd=a(" special method."),fd=u(),v(Fe.$$.fragment),_d=u(),v(qe.$$.fragment),Td=u(),je=r("div"),v(Gt.$$.fragment),bd=u(),v(Me.$$.fragment),vd=u(),Ee=r("div"),v(St.$$.fragment),kd=u(),v(Ce.$$.fragment),Sn=u(),pe=r("h2"),Oe=r("a"),on=r("span"),v(At.$$.fragment),yd=u(),nn=r("span"),wd=a("FlaxLongT5ForConditionalGeneration"),An=u(),N=r("div"),v(Nt.$$.fragment),$d=u(),H=r("div"),v(It.$$.fragment),xd=u(),ue=r("p"),zd=a("The "),an=r("code"),Ld=a("FlaxLongT5PreTrainedModel"),Fd=a(" forward method, overrides the "),sn=r("code"),qd=a("__call__"),jd=a(" special method."),Md=u(),v(Pe.$$.fragment),Ed=u(),v(Ge.$$.fragment),Cd=u(),Se=r("div"),v(Dt.$$.fragment),Od=u(),v(Ae.$$.fragment),Pd=u(),Ne=r("div"),v(Wt.$$.fragment),Gd=u(),v(Ie.$$.fragment),this.h()},l(t){const f=tl('[data-svelte="svelte-1phssyn"]',document.head);l=d(f,"META",{name:!0,content:!0}),f.forEach(o),b=h(t),m=d(t,"H1",{class:!0});var Bt=i(m);p=d(Bt,"A",{id:!0,class:!0,href:!0});var rn=i(p);_=d(rn,"SPAN",{});var dn=i(_);k(n.$$.fragment,dn),dn.forEach(o),rn.forEach(o),c=h(Bt),L=d(Bt,"SPAN",{});var ln=i(L);la=s(ln,"LongT5"),ln.forEach(o),Bt.forEach(o),bn=h(t),ee=d(t,"H2",{class:!0});var Ut=i(ee);ge=d(Ut,"A",{id:!0,class:!0,href:!0});var cn=i(ge);fo=d(cn,"SPAN",{});var pn=i(fo);k(Ke.$$.fragment,pn),pn.forEach(o),cn.forEach(o),ca=h(Ut),_o=d(Ut,"SPAN",{});var un=i(_o);pa=s(un,"Overview"),un.forEach(o),Ut.forEach(o),vn=h(t),fe=d(t,"P",{});var Ht=i(fe);ua=s(Ht,"The LongT5 model was proposed in "),Ze=d(Ht,"A",{href:!0,rel:!0});var hn=i(Ze);ha=s(hn,"LongT5: Efficient Text-To-Text Transformer for Long Sequences"),hn.forEach(o),ma=s(Ht,`
by Mandy Guo, Joshua Ainslie, David Uthus, Santiago Ontanon, Jianmo Ni, Yun-Hsuan Sung and Yinfei Yang. It\u2019s an
encoder-decoder transformer pre-trained in a text-to-text denoising generative setting. LongT5 model is an extension of
T5 model, and it enables using one of the two different efficient attention mechanisms - (1) Local attention, or (2)
Transient-Global attention.`),Ht.forEach(o),kn=h(t),Yt=d(t,"P",{});var mn=i(Yt);ga=s(mn,"The abstract from the paper is the following:"),mn.forEach(o),yn=h(t),Rt=d(t,"P",{});var gn=i(Rt);To=d(gn,"EM",{});var fn=i(To);fa=s(fn,`Recent work has shown that either (1) increasing the input length or (2) increasing model size can improve the
performance of Transformer-based neural models. In this paper, we present a new model, called LongT5, with which we
explore the effects of scaling both the input length and model size at the same time. Specifically, we integrated
attention ideas from long-input transformers (ETC), and adopted pre-training strategies from summarization pre-training
(PEGASUS) into the scalable T5 architecture. The result is a new attention mechanism we call {\\em Transient Global}
...
encoder `),bo=d(I,"EM",{});var Nd=i(bo);ya=s(Nd,"self-attention"),Nd.forEach(o),wa=s(I," layer with efficient either "),vo=d(I,"EM",{});var Id=i(vo);$a=s(Id,"local"),Id.forEach(o),xa=s(I," attention or "),ko=d(I,"EM",{});var Dd=i(ko);za=s(Dd,"transient-global"),Dd.forEach(o),La=s(I," ("),yo=d(I,"EM",{});var Wd=i(yo);Fa=s(Wd,"tglobal"),Wd.forEach(o),qa=s(I,") attention."),I.forEach(o),ja=h(Y),Qe=d(Y,"LI",{});var In=i(Qe);Ma=s(In,`Unlike the T5 model, LongT5 does not use a task prefix. Furthermore, it uses a different pre-training objective
...
documentation from `),eo=d(co,"A",{href:!0});var mi=i(eo);Gs=s(mi,"PretrainedConfig"),mi.forEach(o),Ss=s(co," for more information."),co.forEach(o),lo.forEach(o),qn=h(t),ne=d(t,"H2",{class:!0});var Un=i(ne);Te=d(Un,"A",{id:!0,class:!0,href:!0});var gi=i(Te);Io=d(gi,"SPAN",{});var fi=i(Io);k(it.$$.fragment,fi),fi.forEach(o),gi.forEach(o),As=h(Un),Do=d(Un,"SPAN",{});var _i=i(Do);Ns=s(_i,"LongT5Model"),_i.forEach(o),Un.forEach(o),jn=h(t),j=d(t,"DIV",{class:!0});var R=i(j);k(lt.$$.fragment,R),Is=h(R),Wo=d(R,"P",{});var Ti=i(Wo);Ds=s(Ti,"The bare LONGT5 Model transformer outputting raw hidden-states without any specific head on top."),Ti.forEach(o),Ws=h(R),ct=d(R,"P",{});var Hn=i(ct);Bs=s(Hn,"The LongT5 model was proposed in "),pt=d(Hn,"A",{href:!0,rel:!0});var bi=i(pt);Us=s(bi,`LongT5: Efficient Text-To-Text Transformer for Long
Sequences`),bi.forEach(o),Hs=s(Hn,` by Mandy Guo, Joshua Ainslie, David Uthus, Santiago Ontanon, Jianmo
Ni, Yun-Hsuan Sung and Yinfei Yang. It\u2019s an encoder-decoder transformer pre-trained in a text-to-text denoising
generative setting. LongT5 model is an extension of T5 model, and it enables using one of the two different
efficient attention mechanisms - (1) Local attention, or (2) Transient-Global attention.`),Hn.forEach(o),Ys=h(R),ut=d(R,"P",{});var Yn=i(ut);Rs=s(Yn,"This model inherits from "),to=d(Yn,"A",{href:!0});var vi=i(to);Js=s(vi,"PreTrainedModel"),vi.forEach(o),Vs=s(Yn,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Rn.forEach(o),er=h(R),D=d(R,"DIV",{class:!0});var We=i(D);k(gt.$$.fragment,We),tr=h(We),ae=d(We,"P",{});var po=i(ae);or=s(po,"The "),oo=d(po,"A",{href:!0});var yi=i(oo);nr=s(yi,"LongT5Model"),yi.forEach(o),ar=s(po," forward method, overrides the "),Bo=d(po,"CODE",{});var wi=i(Bo);sr=s(wi,"__call__"),wi.forEach(o),rr=s(po," special method."),po.forEach(o),dr=h(We),k(be.$$.fragment,We),ir=h(We),k(ve.$$.fragment,We),We.forEach(o),R.forEach(o),Mn=h(t),se=d(t,"H2",{class:!0});var Jn=i(se);ke=d(Jn,"A",{id:!0,class:!0,href:!0});var $i=i(ke);Uo=d($i,"SPAN",{});var xi=i(Uo);k(ft.$$.fragment,xi),xi.forEach(o),$i.forEach(o),lr=h(Jn),Ho=d(Jn,"SPAN",{});var zi=i(Ho);cr=s(zi,"LongT5ForConditionalGeneration"),zi.forEach(o),Jn.forEach(o),En=h(t),M=d(t,"DIV",{class:!0});var J=i(M);k(_t.$$.fragment,J),pr=h(J),Tt=d(J,"P",{});var Vn=i(Tt);ur=s(Vn,"LONGT5 Model with a "),Yo=d(Vn,"CODE",{});var Li=i(Yo);hr=s(Li,"language modeling"),Li.forEach(o),mr=s(Vn," head on top."),Vn.forEach(o),gr=h(J),bt=d(J,"P",{});var Kn=i(bt);fr=s(Kn,"The LongT5 model was proposed in "),vt=d(Kn,"A",{href:!0,rel:!0});var Fi=i(vt);_r=s(Fi,`LongT5: Efficient Text-To-Text Transformer for Long
Sequences`),Fi.forEach(o),Tr=s(Kn,` by Mandy Guo, Joshua Ainslie, David Uthus, Santiago Ontanon, Jianmo
Ni, Yun-Hsuan Sung and Yinfei Yang. It\u2019s an encoder-decoder transformer pre-trained in a text-to-text denoising
generative setting. LongT5 model is an extension of T5 model, and it enables using one of the two different
efficient attention mechanisms - (1) Local attention, or (2) Transient-Global attention.`),Kn.forEach(o),br=h(J),kt=d(J,"P",{});var Zn=i(kt);vr=s(Zn,"This model inherits from "),no=d(Zn,"A",{href:!0});var qi=i(no);kr=s(qi,"PreTrainedModel"),qi.forEach(o),yr=s(Zn,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Zn.forEach(o),wr=h(J),yt=d(J,"P",{});var Qn=i(yt);$r=s(Qn,"This model is also a PyTorch "),wt=d(Qn,"A",{href:!0,rel:!0});var ji=i(wt);xr=s(ji,"torch.nn.Module"),ji.forEach(o),zr=s(Qn,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Qn.forEach(o),Lr=h(J),W=d(J,"DIV",{class:!0});var Be=i(W);k($t.$$.fragment,Be),Fr=h(Be),re=d(Be,"P",{});var uo=i(re);qr=s(uo,"The "),ao=d(uo,"A",{href:!0});var Mi=i(ao);jr=s(Mi,"LongT5ForConditionalGeneration"),Mi.forEach(o),Mr=s(uo," forward method, overrides the "),Ro=d(uo,"CODE",{});var Ei=i(Ro);Er=s(Ei,"__call__"),Ei.forEach(o),Cr=s(uo," special method."),uo.forEach(o),Or=h(Be),k(ye.$$.fragment,Be),Pr=h(Be),k(we.$$.fragment,Be),Be.forEach(o),J.forEach(o),Cn=h(t),de=d(t,"H2",{class:!0});var Xn=i(de);$e=d(Xn,"A",{id:!0,class:!0,href:!0});var Ci=i($e);Jo=d(Ci,"SPAN",{});var Oi=i(Jo);k(xt.$$.fragment,Oi),Oi.forEach(o),Ci.forEach(o),Gr=h(Xn),Vo=d(Xn,"SPAN",{});var Pi=i(Vo);Sr=s(Pi,"LongT5EncoderModel"),Pi.forEach(o),Xn.forEach(o),On=h(t),E=d(t,"DIV",{class:!0});var V=i(E);k(zt.$$.fragment,V),Ar=h(V),Ko=d(V,"P",{});var Gi=i(Ko);Nr=s(Gi,"The bare LONGT5 Model transformer outputting encoder\u2019s raw hidden-states without any specific head on top."),Gi.forEach(o),Ir=h(V),Lt=d(V,"P",{});var ea=i(Lt);Dr=s(ea,"The LongT5 model was proposed in "),Ft=d(ea,"A",{href:!0,rel:!0});var Si=i(Ft);Wr=s(Si,`LongT5: Efficient Text-To-Text Transformer for Long
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),oa.forEach(o),Qr=h(V),B=d(V,"DIV",{class:!0});var Ue=i(B);k(Et.$$.fragment,Ue),Xr=h(Ue),ie=d(Ue,"P",{});var ho=i(ie);ed=s(ho,"The "),ro=d(ho,"A",{href:!0});var Ii=i(ro);td=s(Ii,"LongT5EncoderModel"),Ii.forEach(o),od=s(ho," forward method, overrides the "),Zo=d(ho,"CODE",{});var Di=i(Zo);nd=s(Di,"__call__"),Di.forEach(o),ad=s(ho," special method."),ho.forEach(o),sd=h(Ue),k(xe.$$.fragment,Ue),rd=h(Ue),k(ze.$$.fragment,Ue),Ue.forEach(o),V.forEach(o),Pn=h(t),le=d(t,"H2",{class:!0});var na=i(le);Le=d(na,"A",{id:!0,class:!0,href:!0});var Wi=i(Le);Qo=d(Wi,"SPAN",{});var Bi=i(Qo);k(Ct.$$.fragment,Bi),Bi.forEach(o),Wi.forEach(o),dd=h(na),Xo=d(na,"SPAN",{});var Ui=i(Xo);id=s(Ui,"FlaxLongT5Model"),Ui.forEach(o),na.forEach(o),Gn=h(t),A=d(t,"DIV",{class:!0});var He=i(A);k(Ot.$$.fragment,He),ld=h(He),U=d(He,"DIV",{class:!0});var Ye=i(U);k(Pt.$$.fragment,Ye),cd=h(Ye),ce=d(Ye,"P",{});var mo=i(ce);pd=s(mo,"The "),en=d(mo,"CODE",{});var Hi=i(en);ud=s(Hi,"FlaxLongT5PreTrainedModel"),Hi.forEach(o),hd=s(mo," forward method, overrides the "),tn=d(mo,"CODE",{});var Yi=i(tn);md=s(Yi,"__call__"),Yi.forEach(o),gd=s(mo," special method."),mo.forEach(o),fd=h(Ye),k(Fe.$$.fragment,Ye),_d=h(Ye),k(qe.$$.fragment,Ye),Ye.forEach(o),Td=h(He),je=d(He,"DIV",{class:!0});var aa=i(je);k(Gt.$$.fragment,aa),bd=h(aa),k(Me.$$.fragment,aa),aa.forEach(o),vd=h(He),Ee=d(He,"DIV",{class:!0});var sa=i(Ee);k(St.$$.fragment,sa),kd=h(sa),k(Ce.$$.fragment,sa),sa.forEach(o),He.forEach(o),Sn=h(t),pe=d(t,"H2",{class:!0});var ra=i(pe);Oe=d(ra,"A",{id:!0,class:!0,href:!0});var Ri=i(Oe);on=d(Ri,"SPAN",{});var Ji=i(on);k(At.$$.fragment,Ji),Ji.forEach(o),Ri.forEach(o),yd=h(ra),nn=d(ra,"SPAN",{});var Vi=i(nn);wd=s(Vi,"FlaxLongT5ForConditionalGeneration"),Vi.forEach(o),ra.forEach(o),An=h(t),N=d(t,"DIV",{class:!0});var Re=i(N);k(Nt.$$.fragment,Re),$d=h(Re),H=d(Re,"DIV",{class:!0});var Je=i(H);k(It.$$.fragment,Je),xd=h(Je),ue=d(Je,"P",{});var go=i(ue);zd=s(go,"The "),an=d(go,"CODE",{});var Ki=i(an);Ld=s(Ki,"FlaxLongT5PreTrainedModel"),Ki.forEach(o),Fd=s(go," forward method, overrides the "),sn=d(go,"CODE",{});var Zi=i(sn);qd=s(Zi,"__call__"),Zi.forEach(o),jd=s(go," special method."),go.forEach(o),Md=h(Je),k(Pe.$$.fragment,Je),Ed=h(Je),k(Ge.$$.fragment,Je),Je.forEach(o),Cd=h(Re),Se=d(Re,"DIV",{class:!0});var da=i(Se);k(Dt.$$.fragment,da),Od=h(da),k(Ae.$$.fragment,da),da.forEach(o),Pd=h(Re),Ne=d(Re,"DIV",{class:!0});var ia=i(Ne);k(Wt.$$.fragment,ia),Gd=h(ia),k(Ie.$$.fragment,ia),ia.forEach(o),Re.forEach(o),this.h()},h(){g(l,"name","hf:doc:metadata"),g(l,"content",JSON.stringify(Tl)),g(p,"id","longt5"),g(p,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),g(p,"href","#longt5"),g(m,"class","relative group"),g(ge,"id","overview"),g(ge,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),g(ge,"href","#overview"),g(ee,"class","relative group"),g(Ze,"href","https://arxiv.org/abs/2112.07916"),g(Ze,"rel","nofollow"),g(Vt,"href","/docs/transformers/v4.21.0/en/model_doc/longt5#transformers.LongT5ForConditionalGeneration"),g(Kt,"href","/docs/transformers/v4.21.0/en/model_doc/t5#transformers.T5ForConditionalGeneration"),g(tt,"href","https://huggingface.co/datasets/scientific_papers"),g(tt,"rel","nofollow"),g(nt,"href","https://huggingface.co/stancld"),g(nt,"rel","nofollow"),g(at,"href","https://github.com/google-research/longt5"),g(at,"rel","nofollow"),g(_e,"id","transformers.LongT5Config"),g(_e,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),g(_e,"href","#transformers.LongT5Config"),g(te,"class","relative group"),g(Zt,"href","/docs/transformers/v4.21.0/en/model_doc/longt5#transformers.LongT5Model"),g(Qt,"href","/docs/transformers/v4.21.0/en/model_doc/longt5#transformers.FlaxLongT5Model"),g(dt,"href","https://huggingface.co/google/long-t5-local-base"),g(dt,"rel","nofollow"),g(Xt,"href","/docs/transformers/v4.21.0/en/main_classes/configuration#transformers.PretrainedConfig"),g(eo,"href","/docs/transformers/v4.21.0/en/main_classes/configuration#transformers.PretrainedConfig"),g(K,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),g(Te,"id","transformers.LongT5Model"),g(Te,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),g(Te,"href","#transformers.LongT5Model"),g(ne,"class","relative group"),g(pt,"href","https://arxiv.org/abs/2112.07916"),g(pt,"rel","nofollow"),g(to,"href","/docs/transformers/v4.21.0/en/main_classes/model#transformers.PreTrainedModel"),g(mt,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),g(mt,"rel","nofollow"),g(oo,"href","/docs/transformers/v4.21.0/en/model_doc/longt5#transformers.LongT5Model"),g(D,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),g(j,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),g(ke,"id","transformers.LongT5ForConditionalGeneration"),g(ke,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),g(ke,"href","#transformers.LongT5ForConditionalGeneration"),g(se,"class","relative group"),g(vt,"href","https://arxiv.org/abs/2112.07916"),g(vt,"rel","nofollow"),g(no,"href","/docs/transformers/v4.21.0/en/main_classes/model#transformers.PreTrainedModel"),g(wt,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),g(wt,"rel","nofollow"),g(ao,"href","/docs/transformers/v4.21.0/en/model_doc/longt5#transformers.LongT5ForConditionalGeneration"),g(W,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),g(M,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),g($e,"id","transformers.LongT5EncoderModel"),g($e,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),g($e,"href","#transformers.LongT5EncoderModel"),g(de,"class","relative group"),g(Ft,"href","https://arxiv.org/abs/2112.07916"),g(Ft,"rel","nofollow"),g(so,"href","/docs/transformers/v4.21.0/en/main_classes/model#transformers.PreTrainedModel"),g(Mt,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),g(Mt,"rel","nofollow"),g(ro,"href","/docs/transformers/v4.21.0/en/model_doc/longt5#transformers.LongT5EncoderModel"),g(B,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),g(E,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),g(Le,"id","transformers.FlaxLongT5Model"),g(Le,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),g(Le,"href","#transformers.FlaxLongT5Model"),g(le,"class","relative group"),g(U,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),g(je,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),g(Ee,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),g(A,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),g(Oe,"id","transformers.FlaxLongT5ForConditionalGeneration"),g(Oe,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),g(Oe,"href","#transformers.FlaxLongT5ForConditionalGeneration"),g(pe,"class","relative group"),g(H,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),g(Se,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),g(Ne,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),g(N,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8")},m(t,f){e(document.head,l),T(t,b,f),T(t,m,f),e(m,p),e(p,_),y(n,_,null),e(m,c),e(m,L),e(L,la),T(t,bn,f),T(t,ee,f),e(ee,ge),e(ge,fo),y(Ke,fo,null),e(ee,ca),e(ee,_o),e(_o,pa),T(t,vn,f),T(t,fe,f),e(fe,ua),e(fe,Ze),e(Ze,ha),e(fe,ma),T(t,kn,f),T(t,Yt,f),e(Yt,ga),T(t,yn,f),T(t,Rt,f),e(Rt,To),e(To,fa),T(t,wn,f),T(t,Jt,f),e(Jt,_a),T(t,$n,f),T(t,C,f),e(C,O),e(O,Vt),e(Vt,Ta),e(O,ba),e(O,Kt),e(Kt,va),e(O,ka),e(O,bo),e(bo,ya),e(O,wa),e(O,vo),e(vo,$a),e(O,xa),e(O,ko),e(ko,za),e(O,La),e(O,yo),e(yo,Fa),e(O,qa),e(C,ja),e(C,Qe),e(Qe,Ma),e(Qe,wo),e(wo,Ea),e(Qe,Ca),e(C,Oa),e(C,Xe),e(Xe,Pa),e(Xe,$o),e($o,Ga),e(Xe,Sa),e(C,Aa),e(C,q),e(q,Na),e(q,xo),e(xo,Ia),e(q,Da),e(q,zo),e(zo,Wa),e(q,Ba),e(q,Lo),e(Lo,Ua),e(q,Ha),e(q,Fo),e(Fo,Ya),e(q,Ra),e(q,qo),e(qo,Ja),e(q,Va),e(q,jo),e(jo,Ka),e(q,Za),e(C,Qa),e(C,F),e(F,Mo),e(Mo,Xa),e(F,es),e(F,Eo),e(Eo,ts),e(F,os),e(F,Co),e(Co,ns),e(F,as),e(F,Oo),e(Oo,ss),e(F,rs),e(F,Po),e(Po,ds),e(F,is),e(F,Go),e(Go,ls),e(F,cs),e(F,So),e(So,ps),e(F,us),e(C,hs),e(C,et),e(et,ms),e(et,tt),e(tt,gs),e(et,fs),T(t,xn,f),y(ot,t,f),T(t,zn,f),T(t,Q,f),e(Q,_s),e(Q,nt),e(nt,Ts),e(Q,bs),e(Q,at),e(at,vs),e(Q,ks),T(t,Ln,f),T(t,te,f),e(te,_e),e(_e,Ao),y(st,Ao,null),e(te,ys),e(te,No),e(No,ws),T(t,Fn,f),T(t,K,f),y(rt,K,null),e(K,$s),e(K,Z),e(Z,xs),e(Z,Zt),e(Zt,zs),e(Z,Ls),e(Z,Qt),e(Qt,Fs),e(Z,qs),e(Z,dt),e(dt,js),e(Z,Ms),e(K,Es),e(K,oe),e(oe,Cs),e(oe,Xt),e(Xt,Os),e(oe,Ps),e(oe,eo),e(eo,Gs),e(oe,Ss),T(t,qn,f),T(t,ne,f),e(ne,Te),e(Te,Io),y(it,Io,null),e(ne,As),e(ne,Do),e(Do,Ns),T(t,jn,f),T(t,j,f),y(lt,j,null),e(j,Is),e(j,Wo),e(Wo,Ds),e(j,Ws),e(j,ct),e(ct,Bs),e(ct,pt),e(pt,Us),e(ct,Hs),e(j,Ys),e(j,ut),e(ut,Rs),e(ut,to),e(to,Js),e(ut,Vs),e(j,Ks),e(j,ht),e(ht,Zs),e(ht,mt),e(mt,Qs),e(ht,Xs),e(j,er),e(j,D),y(gt,D,null),e(D,tr),e(D,ae),e(ae,or),e(ae,oo),e(oo,nr),e(ae,ar),e(ae,Bo),e(Bo,sr),e(ae,rr),e(D,dr),y(be,D,null),e(D,ir),y(ve,D,null),T(t,Mn,f),T(t,se,f),e(se,ke),e(ke,Uo),y(ft,Uo,null),e(se,lr),e(se,Ho),e(Ho,cr),T(t,En,f),T(t,M,f),y(_t,M,null),e(M,pr),e(M,Tt),e(Tt,ur),e(Tt,Yo),e(Yo,hr),e(Tt,mr),e(M,gr),e(M,bt),e(bt,fr),e(bt,vt),e(vt,_r),e(bt,Tr),e(M,br),e(M,kt),e(kt,vr),e(kt,no),e(no,kr),e(kt,yr),e(M,wr),e(M,yt),e(yt,$r),e(yt,wt),e(wt,xr),e(yt,zr),e(M,Lr),e(M,W),y($t,W,null),e(W,Fr),e(W,re),e(re,qr),e(re,ao),e(ao,jr),e(re,Mr),e(re,Ro),e(Ro,Er),e(re,Cr),e(W,Or),y(ye,W,null),e(W,Pr),y(we,W,null),T(t,Cn,f),T(t,de,f),e(de,$e),e($e,Jo),y(xt,Jo,null),e(de,Gr),e(de,Vo),e(Vo,Sr),T(t,On,f),T(t,E,f),y(zt,E,null),e(E,Ar),e(E,Ko),e(Ko,Nr),e(E,Ir),e(E,Lt),e(Lt,Dr),e(Lt,Ft),e(Ft,Wr),e(Lt,Br),e(E,Ur),e(E,qt),e(qt,Hr),e(qt,so),e(so,Yr),e(qt,Rr),e(E,Jr),e(E,jt),e(jt,Vr),e(jt,Mt),e(Mt,Kr),e(jt,Zr),e(E,Qr),e(E,B),y(Et,B,null),e(B,Xr),e(B,ie),e(ie,ed),e(ie,ro),e(ro,td),e(ie,od),e(ie,Zo),e(Zo,nd),e(ie,ad),e(B,sd),y(xe,B,null),e(B,rd),y(ze,B,null),T(t,Pn,f),T(t,le,f),e(le,Le),e(Le,Qo),y(Ct,Qo,null),e(le,dd),e(le,Xo),e(Xo,id),T(t,Gn,f),T(t,A,f),y(Ot,A,null),e(A,ld),e(A,U),y(Pt,U,null),e(U,cd),e(U,ce),e(ce,pd),e(ce,en),e(en,ud),e(ce,hd),e(ce,tn),e(tn,md),e(ce,gd),e(U,fd),y(Fe,U,null),e(U,_d),y(qe,U,null),e(A,Td),e(A,je),y(Gt,je,null),e(je,bd),y(Me,je,null),e(A,vd),e(A,Ee),y(St,Ee,null),e(Ee,kd),y(Ce,Ee,null),T(t,Sn,f),T(t,pe,f),e(pe,Oe),e(Oe,on),y(At,on,null),e(pe,yd),e(pe,nn),e(nn,wd),T(t,An,f),T(t,N,f),y(Nt,N,null),e(N,$d),e(N,H),y(It,H,null),e(H,xd),e(H,ue),e(ue,zd),e(ue,an),e(an,Ld),e(ue,Fd),e(ue,sn),e(sn,qd),e(ue,jd),e(H,Md),y(Pe,H,null),e(H,Ed),y(Ge,H,null),e(N,Cd),e(N,Se),y(Dt,Se,null),e(Se,Od),y(Ae,Se,null),e(N,Pd),e(N,Ne),y(Wt,Ne,null),e(Ne,Gd),y(Ie,Ne,null),Nn=!0},p(t,[f]){const Bt={};f&2&&(Bt.$$scope={dirty:f,ctx:t}),be.$set(Bt);const rn={};f&2&&(rn.$$scope={dirty:f,ctx:t}),ve.$set(rn);const dn={};f&2&&(dn.$$scope={dirty:f,ctx:t}),ye.$set(dn);const ln={};f&2&&(ln.$$scope={dirty:f,ctx:t}),we.$set(ln);const Ut={};f&2&&(Ut.$$scope={dirty:f,ctx:t}),xe.$set(Ut);const cn={};f&2&&(cn.$$scope={dirty:f,ctx:t}),ze.$set(cn);const pn={};f&2&&(pn.$$scope={dirty:f,ctx:t}),Fe.$set(pn);const un={};f&2&&(un.$$scope={dirty:f,ctx:t}),qe.$set(un);const Ht={};f&2&&(Ht.$$scope={dirty:f,ctx:t}),Me.$set(Ht);const hn={};f&2&&(hn.$$scope={dirty:f,ctx:t}),Ce.$set(hn);const mn={};f&2&&(mn.$$scope={dirty:f,ctx:t}),Pe.$set(mn);const gn={};f&2&&(gn.$$scope={dirty:f,ctx:t}),Ge.$set(gn);const fn={};f&2&&(fn.$$scope={dirty:f,ctx:t}),Ae.$set(fn);const _n={};f&2&&(_n.$$scope={dirty:f,ctx:t}),Ie.$set(_n)},i(t){Nn||(w(n.$$.fragment,t),w(Ke.$$.fragment,t),w(ot.$$.fragment,t),w(st.$$.fragment,t),w(rt.$$.fragment,t),w(it.$$.fragment,t),w(lt.$$.fragment,t),w(gt.$$.fragment,t),w(be.$$.fragment,t),w(ve.$$.fragment,t),w(ft.$$.fragment,t),w(_t.$$.fragment,t),w($t.$$.fragment,t),w(ye.$$.fragment,t),w(we.$$.fragment,t),w(xt.$$.fragment,t),w(zt.$$.fragment,t),w(Et.$$.fragment,t),w(xe.$$.fragment,t),w(ze.$$.fragment,t),w(Ct.$$.fragment,t),w(Ot.$$.fragment,t),w(Pt.$$.fragment,t),w(Fe.$$.fragment,t),w(qe.$$.fragment,t),w(Gt.$$.fragment,t),w(Me.$$.fragment,t),w(St.$$.fragment,t),w(Ce.$$.fragment,t),w(At.$$.fragment,t),w(Nt.$$.fragment,t),w(It.$$.fragment,t),w(Pe.$$.fragment,t),w(Ge.$$.fragment,t),w(Dt.$$.fragment,t),w(Ae.$$.fragment,t),w(Wt.$$.fragment,t),w(Ie.$$.fragment,t),Nn=!0)},o(t){$(n.$$.fragment,t),$(Ke.$$.fragment,t),$(ot.$$.fragment,t),$(st.$$.fragment,t),$(rt.$$.fragment,t),$(it.$$.fragment,t),$(lt.$$.fragment,t),$(gt.$$.fragment,t),$(be.$$.fragment,t),$(ve.$$.fragment,t),$(ft.$$.fragment,t),$(_t.$$.fragment,t),$($t.$$.fragment,t),$(ye.$$.fragment,t),$(we.$$.fragment,t),$(xt.$$.fragment,t),$(zt.$$.fragment,t),$(Et.$$.fragment,t),$(xe.$$.fragment,t),$(ze.$$.fragment,t),$(Ct.$$.fragment,t),$(Ot.$$.fragment,t),$(Pt.$$.fragment,t),$(Fe.$$.fragment,t),$(qe.$$.fragment,t),$(Gt.$$.fragment,t),$(Me.$$.fragment,t),$(St.$$.fragment,t),$(Ce.$$.fragment,t),$(At.$$.fragment,t),$(Nt.$$.fragment,t),$(It.$$.fragment,t),$(Pe.$$.fragment,t),$(Ge.$$.fragment,t),$(Dt.$$.fragment,t),$(Ae.$$.fragment,t),$(Wt.$$.fragment,t),$(Ie.$$.fragment,t),Nn=!1},d(t){o(l),t&&o(b),t&&o(m),x(n),t&&o(bn),t&&o(ee),x(Ke),t&&o(vn),t&&o(fe),t&&o(kn),t&&o(Yt),t&&o(yn),t&&o(Rt),t&&o(wn),t&&o(Jt),t&&o($n),t&&o(C),t&&o(xn),x(ot,t),t&&o(zn),t&&o(Q),t&&o(Ln),t&&o(te),x(st),t&&o(Fn),t&&o(K),x(rt),t&&o(qn),t&&o(ne),x(it),t&&o(jn),t&&o(j),x(lt),x(gt),x(be),x(ve),t&&o(Mn),t&&o(se),x(ft),t&&o(En),t&&o(M),x(_t),x($t),x(ye),x(we),t&&o(Cn),t&&o(de),x(xt),t&&o(On),t&&o(E),x(zt),x(Et),x(xe),x(ze),t&&o(Pn),t&&o(le),x(Ct),t&&o(Gn),t&&o(A),x(Ot),x(Pt),x(Fe),x(qe),x(Gt),x(Me),x(St),x(Ce),t&&o(Sn),t&&o(pe),x(At),t&&o(An),t&&o(N),x(Nt),x(It),x(Pe),x(Ge),x(Dt),x(Ae),x(Wt),x(Ie)}}}const Tl={local:"longt5",sections:[{local:"overview",title:"Overview"},{local:"transformers.LongT5Config",title:"LongT5Config"},{local:"transformers.LongT5Model",title:"LongT5Model"},{local:"transformers.LongT5ForConditionalGeneration",title:"LongT5ForConditionalGeneration"},{local:"transformers.LongT5EncoderModel",title:"LongT5EncoderModel"},{local:"transformers.FlaxLongT5Model",title:"FlaxLongT5Model"},{local:"transformers.FlaxLongT5ForConditionalGeneration",title:"FlaxLongT5ForConditionalGeneration"}],title:"LongT5"};function bl(z){return ol(()=>{new URLSearchParams(window.location.search).get("fw")}),[]}class zl extends Qi{constructor(l){super();Xi(this,l,bl,_l,el,{})}}export{zl as default,Tl as metadata};
