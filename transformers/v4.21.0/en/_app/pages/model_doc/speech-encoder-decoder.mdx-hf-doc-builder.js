...
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-comment"># load fine-tuned model</span>
<span class="hljs-meta">&gt;&gt;&gt; </span>model = FlaxSpeechEncoderDecoderModel.from_pretrained(<span class="hljs-string">&quot;./wav2vec2-2-bart-large&quot;</span>)`}}),{c(){m=a("p"),S=n("Example:"),_=l(),b(f.$$.fragment)},l(c){m=s(c,"P",{});var g=d(m);S=r(g,"Example:"),g.forEach(t),_=p(c),y(f.$$.fragment,c)},m(c,g){u(c,m,g),e(m,S),u(c,_,g),w(f,c,g),v=!0},p:sn,i(c){v||(E(f.$$.fragment,c),v=!0)},o(c){k(f.$$.fragment,c),v=!1},d(c){c&&t(m),c&&t(_),$(f,c)}}}function Di(z){let m,S,_,f,v,c,g,O,Xn,dn,A,er,xo,or,tr,lt,nr,rr,jo,ar,sr,To,dr,cr,cn,R,ir,pt,lr,pr,Fe,hr,mr,ln,H,fr,Mo,ur,gr,Do,_r,vr,pn,Y,pe,ht,Le,br,Ne,yr,mt,wr,Er,hn,B,qo,kr,$r,Po,Sr,xr,ft,jr,Tr,mn,Ve,fn,Z,he,ut,We,Mr,Ie,Dr,gt,qr,Pr,un,x,zo,zr,Ar,_t,Cr,Fr,Ao,Lr,Nr,Co,Vr,Wr,vt,Ir,Or,bt,Br,Rr,yt,Hr,Gr,Fo,Ur,Jr,me,Yr,wt,Zr,Kr,Et,Qr,Xr,Lo,ea,oa,gn,Oe,_n,K,fe,kt,Be,ta,Re,na,$t,ra,aa,vn,F,sa,St,da,ca,No,ia,la,xt,pa,ha,bn,ue,ma,jt,fa,ua,yn,He,wn,Q,ge,Tt,Ge,ga,Mt,_a,En,L,va,Dt,ba,ya,qt,wa,Ea,Pt,ka,$a,kn,Ue,$n,X,_e,zt,Je,Sa,At,xa,Sn,P,Ye,ja,ve,Vo,Ta,Ma,Wo,Da,qa,Pa,ee,za,Io,Aa,Ca,Oo,Fa,La,Na,be,Va,ye,Ze,Wa,Ke,Ia,Bo,Oa,Ba,Ra,we,Qe,Ha,oe,Ga,Ct,Ua,Ja,Ft,Ya,Za,xn,te,Ee,Lt,Xe,Ka,Nt,Qa,jn,j,eo,Xa,ne,es,Ro,os,ts,Ho,ns,rs,as,oo,ss,to,ds,cs,is,no,ls,ro,ps,hs,ms,Vt,fs,us,ao,gs,Go,_s,vs,bs,so,ys,co,ws,Es,ks,G,Uo,$s,Ss,Wt,xs,js,It,Ts,Ms,Ds,N,io,qs,re,Ps,Jo,zs,As,Ot,Cs,Fs,Ls,ke,Ns,$e,Vs,V,lo,Ws,Bt,Is,Os,ae,Bs,Rt,Rs,Hs,Ht,Gs,Us,Js,Se,Tn,se,xe,Gt,po,Ys,Ut,Zs,Mn,T,ho,Ks,de,Qs,Yo,Xs,ed,Zo,od,td,nd,mo,rd,fo,ad,sd,dd,uo,cd,go,id,ld,pd,Jt,hd,md,_o,fd,Ko,ud,gd,_d,vo,vd,bo,bd,yd,wd,U,Qo,Ed,kd,Yt,$d,Sd,Zt,xd,jd,Td,W,yo,Md,ce,Dd,Xo,qd,Pd,Kt,zd,Ad,Cd,je,Fd,Te,Ld,J,wo,Nd,Qt,Vd,Wd,Me,Dn;return c=new Ce({}),Le=new Ce({}),Ve=new le({props:{code:`from transformers import BertConfig, Wav2Vec2Config, SpeechEncoderDecoderConfig, SpeechEncoderDecoderModel
...
</ul>`,name:"kwargs"}],source:"https://github.com/huggingface/transformers/blob/v4.21.0/src/transformers/models/speech_encoder_decoder/configuration_speech_encoder_decoder.py#L27"}}),be=new an({props:{anchor:"transformers.SpeechEncoderDecoderConfig.example",$$slots:{default:[ki]},$$scope:{ctx:z}}}),Ze=new ie({props:{name:"from_encoder_decoder_configs",anchor:"transformers.SpeechEncoderDecoderConfig.from_encoder_decoder_configs",parameters:[{name:"encoder_config",val:": PretrainedConfig"},{name:"decoder_config",val:": PretrainedConfig"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/v4.21.0/src/transformers/models/speech_encoder_decoder/configuration_speech_encoder_decoder.py#L93",returnDescription:`
<p>An instance of a configuration object</p>
`,returnType:`
<p><a
  href="/docs/transformers/v4.21.0/en/model_doc/speech-encoder-decoder#transformers.SpeechEncoderDecoderConfig"
>SpeechEncoderDecoderConfig</a></p>
`}}),Qe=new ie({props:{name:"to_dict",anchor:"transformers.SpeechEncoderDecoderConfig.to_dict",parameters:[],source:"https://github.com/huggingface/transformers/blob/v4.21.0/src/transformers/models/speech_encoder_decoder/configuration_speech_encoder_decoder.py#L110",returnDescription:`
...
library (<em>pip install soundfile</em>). To prepare the array into <em>inputs</em>, either the <a href="/docs/transformers/v4.21.0/en/model_doc/wav2vec2#transformers.Wav2Vec2Processor">Wav2Vec2Processor</a> or
<a href="/docs/transformers/v4.21.0/en/model_doc/speech_to_text#transformers.Speech2TextProcessor">Speech2TextProcessor</a> should be used for padding and conversion into a tensor of type
...
<a href="/docs/transformers/v4.21.0/en/model_doc/speech_to_text#transformers.Speech2TextFeatureExtractor">Speech2TextFeatureExtractor</a> should be used for extracting the fbank features, padding and conversion
...
</ul>`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/v4.21.0/src/transformers/models/speech_encoder_decoder/modeling_speech_encoder_decoder.py#L442",returnDescription:`
<p>A <a
...
<p>Behaves differently depending on whether a <code>config</code> is provided or automatically loaded.`,name:"kwargs"}],source:"https://github.com/huggingface/transformers/blob/v4.21.0/src/transformers/models/speech_encoder_decoder/modeling_speech_encoder_decoder.py#L287"}}),Se=new an({props:{anchor:"transformers.SpeechEncoderDecoderModel.from_encoder_decoder_pretrained.example",$$slots:{default:[xi]},$$scope:{ctx:z}}}),po=new Ce({}),ho=new ie({props:{name:"class transformers.FlaxSpeechEncoderDecoderModel",anchor:"transformers.FlaxSpeechEncoderDecoderModel",parameters:[{name:"config",val:": SpeechEncoderDecoderConfig"},{name:"input_shape",val:": typing.Optional[typing.Tuple] = None"},{name:"seed",val:": int = 0"},{name:"dtype",val:": dtype = <class 'jax.numpy.float32'>"},{name:"_do_init",val:": bool = True"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.FlaxSpeechEncoderDecoderModel.config",description:`<strong>config</strong> (<a href="/docs/transformers/v4.21.0/en/model_doc/speech-encoder-decoder#transformers.SpeechEncoderDecoderConfig">SpeechEncoderDecoderConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
...
If set to <code>True</code>, the model will return a <code>FlaxSeq2SeqLMOutput</code> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/v4.21.0/src/transformers/models/speech_encoder_decoder/modeling_flax_speech_encoder_decoder.py#L662",returnDescription:`
<p>A <a
...
and the default `),ft=a("code"),jr=n("BertForCausalLM"),Tr=n(" configuration for the decoder."),mn=l(),b(Ve.$$.fragment),fn=l(),Z=a("h2"),he=a("a"),ut=a("span"),b(We.$$.fragment),Mr=l(),Ie=a("span"),Dr=n("Initialising "),gt=a("code"),qr=n("SpeechEncoderDecoderModel"),Pr=n(" from a pretrained encoder and a pretrained decoder."),un=l(),x=a("p"),zo=a("a"),zr=n("SpeechEncoderDecoderModel"),Ar=n(" can be initialized from a pretrained encoder checkpoint and a pretrained decoder checkpoint. Note that any pretrained Transformer-based speech model, "),_t=a("em"),Cr=n("e.g."),Fr=l(),Ao=a("a"),Lr=n("Wav2Vec2"),Nr=n(", "),Co=a("a"),Vr=n("Hubert"),Wr=n(" can serve as the encoder and both pretrained auto-encoding models, "),vt=a("em"),Ir=n("e.g."),Or=n(" BERT, pretrained causal language models, "),bt=a("em"),Br=n("e.g."),Rr=n(" GPT2, as well as the pretrained decoder part of sequence-to-sequence models, "),yt=a("em"),Hr=n("e.g."),Gr=n(` decoder of BART, can be used as the decoder.
...
speech inputs) and `),qt=a("code"),wa=n("labels"),Ea=n(" (which are the "),Pt=a("code"),ka=n("input_ids"),$a=n(" of the encoded target sequence)."),kn=l(),b(Ue.$$.fragment),$n=l(),X=a("h2"),_e=a("a"),zt=a("span"),b(Je.$$.fragment),Sa=l(),At=a("span"),xa=n("SpeechEncoderDecoderConfig"),Sn=l(),P=a("div"),b(Ye.$$.fragment),ja=l(),ve=a("p"),Vo=a("a"),Ta=n("SpeechEncoderDecoderConfig"),Ma=n(` is the configuration class to store the configuration of a
`),Wo=a("a"),Da=n("SpeechEncoderDecoderModel"),qa=n(`. It is used to instantiate an Encoder Decoder model according to the specified
arguments, defining the encoder and decoder configs.`),Pa=l(),ee=a("p"),za=n("Configuration objects inherit from "),Io=a("a"),Aa=n("PretrainedConfig"),Ca=n(` and can be used to control the model outputs. Read the
...
configuration and decoder model configuration.`),Ra=l(),we=a("div"),b(Qe.$$.fragment),Ha=l(),oe=a("p"),Ga=n("Serializes this instance to a Python dictionary. Override the default "),Ct=a("em"),Ua=n("to_dict()"),Ja=n(" from "),Ft=a("em"),Ya=n("PretrainedConfig"),Za=n("."),xn=l(),te=a("h2"),Ee=a("a"),Lt=a("span"),b(Xe.$$.fragment),Ka=l(),Nt=a("span"),Qa=n("SpeechEncoderDecoderModel"),jn=l(),j=a("div"),b(eo.$$.fragment),Xa=l(),ne=a("p"),es=n(`This class can be used to initialize a speech-sequence-to-text-sequence model with any pretrained speech
...
:meth`),It=a("em"),Ts=n("~transformers.AutoModelForCausalLM.from_pretrained"),Ms=n(" class method for the decoder."),Ds=l(),N=a("div"),b(io.$$.fragment),qs=l(),re=a("p"),Ps=n("The "),Jo=a("a"),zs=n("SpeechEncoderDecoderModel"),As=n(" forward method, overrides the "),Ot=a("code"),Cs=n("__call__"),Fs=n(" special method."),Ls=l(),b(ke.$$.fragment),Ns=l(),b($e.$$.fragment),Vs=l(),V=a("div"),b(lo.$$.fragment),Ws=l(),Bt=a("p"),Is=n(`Instantiate an encoder and a decoder from one or two base classes of the library from pretrained model
...
speech inputs) and `),qt=s(qe,"CODE",{});var Sc=d(qt);wa=r(Sc,"labels"),Sc.forEach(t),Ea=r(qe," (which are the "),Pt=s(qe,"CODE",{});var xc=d(Pt);ka=r(xc,"input_ids"),xc.forEach(t),$a=r(qe," of the encoded target sequence)."),qe.forEach(t),kn=p(o),y(Ue.$$.fragment,o),$n=p(o),X=s(o,"H2",{class:!0});var Vn=d(X);_e=s(Vn,"A",{id:!0,class:!0,href:!0});var jc=d(_e);zt=s(jc,"SPAN",{});var Tc=d(zt);y(Je.$$.fragment,Tc),Tc.forEach(t),jc.forEach(t),Sa=p(Vn),At=s(Vn,"SPAN",{});var Mc=d(At);xa=r(Mc,"SpeechEncoderDecoderConfig"),Mc.forEach(t),Vn.forEach(t),Sn=p(o),P=s(o,"DIV",{class:!0});var I=d(P);y(Ye.$$.fragment,I),ja=p(I),ve=s(I,"P",{});var rn=d(ve);Vo=s(rn,"A",{href:!0});var Dc=d(Vo);Ta=r(Dc,"SpeechEncoderDecoderConfig"),Dc.forEach(t),Ma=r(rn,` is the configuration class to store the configuration of a
...
arguments, defining the encoder and decoder configs.`),rn.forEach(t),Pa=p(I),ee=s(I,"P",{});var tt=d(ee);za=r(tt,"Configuration objects inherit from "),Io=s(tt,"A",{href:!0});var Pc=d(Io);Aa=r(Pc,"PretrainedConfig"),Pc.forEach(t),Ca=r(tt,` and can be used to control the model outputs. Read the
