import{S as hi,i as mi,s as fi,e as s,k as c,w as C,t as o,M as pi,c as n,d as r,m as h,a as i,x as w,h as a,b as l,N as ui,G as e,g as f,y as k,q as $,o as y,B as O,v as gi,L as ci}from"../../chunks/vendor-hf-doc-builder.js";import{T as li}from"../../chunks/Tip-hf-doc-builder.js";import{D as Z}from"../../chunks/Docstring-hf-doc-builder.js";import{C as Hs}from"../../chunks/CodeBlock-hf-doc-builder.js";import{I as jt}from"../../chunks/IconCopyLink-hf-doc-builder.js";import{E as di}from"../../chunks/ExampleCodeBlock-hf-doc-builder.js";function _i(S){let p,E,u,g,T;return g=new Hs({props:{code:`from transformers import TrOCRForCausalLM, TrOCRConfig
...
<span class="hljs-meta">&gt;&gt;&gt; </span>configuration = model.config`}}),{c(){p=s("p"),E=o("Example:"),u=c(),C(g.$$.fragment)},l(m){p=n(m,"P",{});var _=i(p);E=a(_,"Example:"),_.forEach(r),u=h(m),w(g.$$.fragment,m)},m(m,_){f(m,p,_),e(p,E),f(m,u,_),k(g,m,_),T=!0},p:ci,i(m){T||($(g.$$.fragment,m),T=!0)},o(m){y(g.$$.fragment,m),T=!1},d(m){m&&r(p),m&&r(u),O(g,m)}}}function vi(S){let p,E,u,g,T,m,_,D;return{c(){p=s("p"),E=o(`This class method is simply calling the feature extractor
...
methods above for more information.`),this.h()},l(j){p=n(j,"P",{});var R=i(p);E=a(R,`This class method is simply calling the feature extractor
...
methods above for more information.`),R.forEach(r),this.h()},h(){l(u,"href","/docs/transformers/v4.21.0/en/main_classes/feature_extractor#transformers.FeatureExtractionMixin.from_pretrained")},m(j,R){f(j,p,R),e(p,E),e(p,u),e(u,g),e(p,T),e(p,m),e(m,_),e(p,D)},d(j){j&&r(p)}}}function Ti(S){let p,E,u,g,T,m,_,D;return{c(){p=s("p"),E=o("This class method is simply calling "),u=s("a"),g=o("save_pretrained()"),T=o(` and
`),m=s("code"),_=o("save_pretrained"),D=o(`. Please refer to the docstrings of the methods
above for more information.`),this.h()},l(j){p=n(j,"P",{});var R=i(p);E=a(R,"This class method is simply calling "),u=n(R,"A",{href:!0});var z=i(u);g=a(z,"save_pretrained()"),z.forEach(r),T=a(R,` and
`),m=n(R,"CODE",{});var F=i(m);_=a(F,"save_pretrained"),F.forEach(r),D=a(R,`. Please refer to the docstrings of the methods
above for more information.`),R.forEach(r),this.h()},h(){l(u,"href","/docs/transformers/v4.21.0/en/main_classes/feature_extractor#transformers.FeatureExtractionMixin.save_pretrained")},m(j,R){f(j,p,R),e(p,E),e(p,u),e(u,g),e(p,T),e(p,m),e(m,_),e(p,D)},d(j){j&&r(p)}}}function bi(S){let p,E,u,g,T;return g=new Hs({props:{code:`from transformers import (
    TrOCRConfig,
    TrOCRProcessor,
    TrOCRForCausalLM,
    ViTConfig,
...
<span class="hljs-string">&#x27;industry, &quot; Mr. Brown commented icily. &quot; Let us have a&#x27;</span>`}}),{c(){p=s("p"),E=o("Example:"),u=c(),C(g.$$.fragment)},l(m){p=n(m,"P",{});var _=i(p);E=a(_,"Example:"),_.forEach(r),u=h(m),w(g.$$.fragment,m)},m(m,_){f(m,p,_),e(p,E),f(m,u,_),k(g,m,_),T=!0},p:ci,i(m){T||($(g.$$.fragment,m),T=!0)},o(m){y(g.$$.fragment,m),T=!1},d(m){m&&r(p),m&&r(u),O(g,m)}}}function Ci(S){let p,E,u,g,T,m,_,D,j,R,z,F,zt,$e,ro,Lt,oo,ur,W,ao,ye,so,no,Oe,io,lo,gr,st,co,_r,nt,Ft,ho,vr,re,Us,Tr,oe,mo,it,fo,po,br,ae,uo,Dt,go,_o,Cr,B,vo,Re,To,bo,Ee,Co,wo,wr,lt,ko,kr,H,xe,$o,Pe,yo,Oo,Ro,I,Eo,Me,xo,Po,je,Mo,jo,ze,zo,Lo,Fo,Le,Do,dt,qo,Ao,$r,J,se,qt,Fe,Io,At,Vo,yr,U,No,It,So,Wo,ct,Bo,Ho,Or,v,Uo,Vt,Go,Xo,Nt,Zo,Jo,St,Yo,Ko,Wt,Qo,ea,ht,ta,ra,Bt,oa,aa,Ht,sa,na,Ut,ia,la,Gt,da,ca,Rr,mt,Xt,ha,Er,De,xr,ne,ma,qe,fa,pa,Pr,Y,ie,Zt,Ae,ua,Jt,ga,Mr,q,Ie,_a,K,va,ft,Ta,ba,Ve,Ca,wa,ka,Q,$a,pt,ya,Oa,ut,Ra,Ea,xa,le,jr,ee,de,Yt,Ne,Pa,Kt,Ma,zr,b,Se,ja,Qt,za,La,P,gt,Fa,Da,er,qa,Aa,tr,Ia,Va,rr,Na,Sa,or,Wa,Ba,We,ar,Ha,Ua,Ga,_t,Xa,Za,Ja,ce,Be,Ya,V,Ka,sr,Qa,es,vt,ts,rs,nr,os,as,ss,G,He,ns,ir,is,ls,he,ds,X,Ue,cs,Ge,hs,Tt,ms,fs,ps,me,us,fe,Xe,gs,Ze,_s,bt,vs,Ts,bs,pe,Je,Cs,Ye,ws,Ct,ks,$s,ys,ue,Ke,Os,lr,Rs,Lr,te,ge,dr,Qe,Es,cr,xs,Fr,A,et,Ps,N,Ms,wt,js,zs,hr,Ls,Fs,kt,Ds,qs,As,tt,Is,rt,Vs,Ns,Ss,_e,ot,Ws,ve,Dr;return m=new jt({}),$e=new jt({}),Fe=new jt({}),De=new Hs({props:{code:`from transformers import TrOCRProcessor, VisionEncoderDecoderModel
import requests 
from PIL import Image
...
<code>inputs_ids</code> passed when calling <a href="/docs/transformers/v4.21.0/en/model_doc/trocr#transformers.TrOCRForCausalLM">TrOCRForCausalLM</a>.`,name:"vocab_size"},{anchor:"transformers.TrOCRConfig.d_model",description:`<strong>d_model</strong> (<code>int</code>, <em>optional</em>, defaults to 1024) &#x2014;
...
An instance of [<code>RobertaTokenizer</code>/<code>XLMRobertaTokenizer</code>]. The tokenizer is a required input.`,name:"tokenizer"}],source:"https://github.com/huggingface/transformers/blob/v4.21.0/src/transformers/models/trocr/processing_trocr.py#L23"}}),Be=new Z({props:{name:"__call__",anchor:"transformers.TrOCRProcessor.__call__",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/v4.21.0/src/transformers/models/trocr/processing_trocr.py#L44"}}),He=new Z({props:{name:"from_pretrained",anchor:"transformers.TrOCRProcessor.from_pretrained",parameters:[{name:"pretrained_model_name_or_path",val:""},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.TrOCRProcessor.from_pretrained.pretrained_model_name_or_path",description:`<strong>pretrained_model_name_or_path</strong> (<code>str</code> or <code>os.PathLike</code>) &#x2014;
...
<a href="/docs/transformers/v4.21.0/en/main_classes/feature_extractor#transformers.FeatureExtractionMixin.from_pretrained">from_pretrained()</a> and
...
<p>kwargs &#x2014;
Additional key word arguments passed along to the <a href="/docs/transformers/v4.21.0/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.push_to_hub">push_to_hub()</a> method.`,name:"push_to_hub"}],source:"https://github.com/huggingface/transformers/blob/v4.21.0/src/transformers/processing_utils.py#L94"}}),me=new li({props:{$$slots:{default:[Ti]},$$scope:{ctx:S}}}),Xe=new Z({props:{name:"batch_decode",anchor:"transformers.TrOCRProcessor.batch_decode",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/v4.21.0/src/transformers/models/trocr/processing_trocr.py#L53"}}),Je=new Z({props:{name:"decode",anchor:"transformers.TrOCRProcessor.decode",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/v4.21.0/src/transformers/models/trocr/processing_trocr.py#L60"}}),Ke=new Z({props:{name:"as_target_processor",anchor:"transformers.TrOCRProcessor.as_target_processor",parameters:[],source:"https://github.com/huggingface/transformers/blob/v4.21.0/src/transformers/models/trocr/processing_trocr.py#L67"}}),Qe=new jt({}),et=new Z({props:{name:"class transformers.TrOCRForCausalLM",anchor:"transformers.TrOCRForCausalLM",parameters:[{name:"config",val:""}],parametersDescription:[{anchor:"transformers.TrOCRForCausalLM.config",description:`<strong>config</strong> (<a href="/docs/transformers/v4.21.0/en/model_doc/trocr#transformers.TrOCRConfig">TrOCRConfig</a>) &#x2014;
Model configuration class with all the parameters of the model. Initializing with a config file does not
load the weights associated with the model, only the configuration. Check out the
<a href="/docs/transformers/v4.21.0/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/v4.21.0/src/transformers/models/trocr/modeling_trocr.py#L782"}}),ot=new Z({props:{name:"forward",anchor:"transformers.TrOCRForCausalLM.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"encoder_hidden_states",val:" = None"},{name:"encoder_attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"cross_attn_head_mask",val:" = None"},{name:"past_key_values",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"labels",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],parametersDescription:[{anchor:"transformers.TrOCRForCausalLM.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. Padding will be ignored by default should you
provide it.</p>
<p>Indices can be obtained using <code>TrOCRTokenizer</code>. See <a href="/docs/transformers/v4.21.0/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
...
elements depending on the configuration (<a
  href="/docs/transformers/v4.21.0/en/model_doc/trocr#transformers.TrOCRConfig"
