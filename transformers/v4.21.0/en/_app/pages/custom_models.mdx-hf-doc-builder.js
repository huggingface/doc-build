...
superclass.`),Ws=c(),D=l("p"),Da=o("Defining a "),Gt=l("code"),Fa=o("model_type"),Sa=o(" for your configuration (here "),Ut=l("code"),Ba=o('model_type="resnet"'),Ha=o(`) is not mandatory, unless you want to
...
hash of any commit.`),Fo=c(),X=l("h2"),ue=l("a"),Es=l("span"),p(Ye.$$.fragment),Yl=c(),js=l("span"),zl=o("Registering a model with custom code to the auto classes"),So=c(),vt=l("p"),Gl=o(`If you are writing a library that extends \u{1F917} Transformers, you may want to extend the auto classes to include your own
model. This is different from pushing the code to the Hub in the sense that users will need to import your library to
get the custom models (contrarily to automatically downloading the model code from the Hub).`),Bo=c(),L=l("p"),Ul=o("As long as your config has a "),Cs=l("code"),Kl=o("model_type"),Vl=o(` attribute that is different from existing model types, and that your model
...
superclass.`),Pt.forEach(s),Ws=d(e),D=r(e,"P",{});var At=i(D);Da=a(At,"Defining a "),Gt=r(At,"CODE",{});var Er=i(Gt);Fa=a(Er,"model_type"),Er.forEach(s),Sa=a(At," for your configuration (here "),Ut=r(At,"CODE",{});var jr=i(Ut);Ba=a(jr,'model_type="resnet"'),jr.forEach(s),Ha=a(At,`) is not mandatory, unless you want to
...
hash of any commit.`),Ti.forEach(s),Fo=d(e),X=r(e,"H2",{class:!0});var ta=i(X);ue=r(ta,"A",{id:!0,class:!0,href:!0});var Mi=i(ue);Es=r(Mi,"SPAN",{});var Ri=i(Es);_(Ye.$$.fragment,Ri),Ri.forEach(s),Mi.forEach(s),Yl=d(ta),js=r(ta,"SPAN",{});var qi=i(js);zl=a(qi,"Registering a model with custom code to the auto classes"),qi.forEach(s),ta.forEach(s),So=d(e),vt=r(e,"P",{});var Ii=i(vt);Gl=a(Ii,`If you are writing a library that extends \u{1F917} Transformers, you may want to extend the auto classes to include your own
model. This is different from pushing the code to the Hub in the sense that users will need to import your library to
get the custom models (contrarily to automatically downloading the model code from the Hub).`),Ii.forEach(s),Bo=d(e),L=r(e,"P",{});var Nt=i(L);Ul=a(Nt,"As long as your config has a "),Cs=r(Nt,"CODE",{});var Ni=i(Cs);Kl=a(Ni,"model_type"),Ni.forEach(s),Vl=a(Nt,` attribute that is different from existing model types, and that your model
