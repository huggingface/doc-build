import{S as As,i as Os,s as qs,e as r,k as d,w as p,t as o,L as Ss,c as a,d as t,m as c,a as s,x as _,h as n,b as m,J as e,g as z,y as b,q as y,o as v,B as w}from"../../../chunks/vendor-9e2b328e.js";import{T as Ta}from"../../../chunks/Tip-76f97a76.js";import{D as E}from"../../../chunks/Docstring-50fd6873.js";import{C as js}from"../../../chunks/CodeBlock-b9ff96e9.js";import{I as zs}from"../../../chunks/IconCopyLink-fd0e58fd.js";import"../../../chunks/CopyButton-4b97cbf7.js";function Fs(B){let h,P,u,g,j;return{c(){h=r("p"),P=o(`A configuration file can be loaded and saved to disk. Loading the configuration file and using this file to
...
that can be used as decoder models within the <a href="/docs/transformers/doc-build-test/en/model_doc/encoder-decoder#transformers.EncoderDecoderModel">EncoderDecoderModel</a> class, which consists of all models
...
Whether the model should return a <a
  href="/docs/transformers/doc-build-test/en/main_classes/output#transformers.file_utils.ModelOutput"
...
`,returnType:`
<p><a
  href="/docs/transformers/doc-build-test/en/main_classes/configuration#transformers.PretrainedConfig"
>PretrainedConfig</a></p>
`}}),De=new E({props:{name:"from\\_json\\_file",anchor:"transformers.PretrainedConfig.from_json_file",parameters:[{name:"json_file",val:": typing.Union[str, os.PathLike]"}],source:"https://github.com/huggingface/transformers/blob/doc-build-test/src/transformers/configuration_utils.py#L690",parametersDescription:[{anchor:"transformers.PretrainedConfig.from_json_file.json_file",description:`<strong>json_file</strong> (<code>str</code> or <code>os.PathLike</code>) &#x2014;
...
<a href="/docs/transformers/doc-build-test/en/main_classes/configuration#transformers.PretrainedConfig.save_pretrained">save_pretrained()</a> method, e.g., <code>./my_model_directory/</code>.</li>
...
<p>kwargs &#x2014;
Additional key word arguments passed along to the <a href="/docs/transformers/doc-build-test/en/main_classes/model#transformers.file_utils.PushToHubMixin.push_to_hub">push_to_hub()</a> method.`,name:"push_to_hub"}]}}),Le=new E({props:{name:"to\\_dict",anchor:"transformers.PretrainedConfig.to_dict",parameters:[],source:"https://github.com/huggingface/transformers/blob/doc-build-test/src/transformers/configuration_utils.py#L750",returnDescription:`
<p>Dictionary of all the attributes that make up this configuration instance.</p>
`,returnType:`
<p><code>Dict[str, Any]</code></p>
`}}),Ne=new E({props:{name:"to\\_diff\\_dict",anchor:"transformers.PretrainedConfig.to_diff_dict",parameters:[],source:"https://github.com/huggingface/transformers/blob/doc-build-test/src/transformers/configuration_utils.py#L718",returnDescription:`
<p>Dictionary of all the attributes that make up this configuration instance,</p>
`,returnType:`
<p><code>Dict[str, Any]</code></p>
`}}),Me=new E({props:{name:"to\\_json\\_file",anchor:"transformers.PretrainedConfig.to_json_file",parameters:[{name:"json_file_path",val:": typing.Union[str, os.PathLike]"},{name:"use_diff",val:": bool = True"}],source:"https://github.com/huggingface/transformers/blob/doc-build-test/src/transformers/configuration_utils.py#L788",parametersDescription:[{anchor:"transformers.PretrainedConfig.to_json_file.json_file_path",description:`<strong>json_file_path</strong> (<code>str</code> or <code>os.PathLike</code>) &#x2014;
...
`),lt=r("code"),Wo=o("vocab_size"),Ho=o("."),io=d(),J=r("h2"),X=r("a"),ft=r("span"),p(we.$$.fragment),Vo=d(),ht=r("span"),Bo=o("PretrainedConfig"),co=d(),l=r("div"),p($e.$$.fragment),Jo=d(),mt=r("p"),Ro=o(`Base class for all configuration classes. Handles a few parameters common to all models\u2019 configurations as well as
methods for loading/downloading/saving configurations.`),Uo=d(),p(K.$$.fragment),Go=d(),ut=r("p"),Xo=o("Class attributes (overridden by derived classes):"),Ko=d(),S=r("ul"),M=r("li"),gt=r("strong"),Qo=o("model_type"),Yo=o(" ("),pt=r("code"),Zo=o("str"),en=o(`) \u2014 An identifier for the model type, serialized into the JSON file, and used to recreate
...
model.`),Hn=d(),oe=r("li"),jt=r("strong"),Vn=o("num_hidden_layers"),Bn=o(" ("),zt=r("code"),Jn=o("int"),Rn=o(") \u2014 The number of blocks in the model."),Un=d(),A=r("div"),p(ke.$$.fragment),Gn=d(),Pe=r("p"),Xn=o(`Upload the configuration file to the \u{1F917} Model Hub while synchronizing a local clone of the repo in
...
the library are already mapped with `),Mt=r("code"),Wr=o("AutoConfig"),Hr=o("."),Vr=d(),p(de.$$.fragment),Br=d(),ce=r("div"),p(Ie.$$.fragment),Jr=d(),R=r("p"),Rr=o("Save a configuration object to the directory "),Wt=r("code"),Ur=o("save_directory"),Gr=o(`, so that it can be re-loaded using the
...
serializes to a Python dictionary.`),na=d(),he=r("div"),p(Me.$$.fragment),ra=d(),Bt=r("p"),aa=o("Save this instance to a JSON file."),sa=d(),me=r("div"),p(We.$$.fragment),ia=d(),Jt=r("p"),da=o("Serializes this instance to a JSON string."),ca=d(),ue=r("div"),p(He.$$.fragment),la=d(),Ve=r("p"),fa=o("Updates attributes of this class with attributes from "),Rt=r("code"),ha=o("config_dict"),ma=o("."),ua=d(),O=r("div"),p(Be.$$.fragment),ga=d(),Je=r("p"),pa=o("Updates attributes of this class with attributes from "),Ut=r("code"),_a=o("update_str"),ba=o("."),ya=d(),U=r("p"),va=o("The expected format is ints, floats and strings as is, and for booleans use "),Gt=r("code"),wa=o("true"),$a=o(" or "),Xt=r("code"),ka=o("false"),Pa=o(`. For example:
\u201Cn_embd=10,resid_pdrop=0.2,scale_attn_weights=false,summary_type=cls_index\u201D`),Ca=d(),Kt=r("p"),Ea=o("The keys to change have to already exist in the config object."),this.h()},l(i){const $=Ss('[data-svelte="svelte-1phssyn"]',document.head);h=a($,"META",{name:!0,content:!0}),$.forEach(t),P=c(i),u=a(i,"H1",{class:!0});var Re=s(u);g=a(Re,"A",{id:!0,class:!0,href:!0});var Qt=s(g);j=a(Qt,"SPAN",{});var Yt=s(j);_(k.$$.fragment,Yt),Yt.forEach(t),Qt.forEach(t),C=c(Re),q=a(Re,"SPAN",{});var xa=s(q);jo=n(xa,"Configuration"),xa.forEach(t),Re.forEach(t),ao=c(i),G=a(i,"P",{});var fo=s(G);zo=n(fo,"The base class "),Ge=a(fo,"A",{href:!0});var Da=s(Ge);Ao=n(Da,"PretrainedConfig"),Da.forEach(t),Oo=n(fo,` implements the common methods for loading/saving a configuration
either from a local file or directory, or from a pretrained model configuration provided by the library (downloaded
...
`),Qe=a(N,"A",{href:!0});var Ja=s(Qe);fn=n(Ja,"EncoderDecoderConfig"),Ja.forEach(t),hn=n(N," or "),Ye=a(N,"A",{href:!0});var Ra=s(Ye);mn=n(Ra,"~RagConfig"),Ra.forEach(t),un=n(N,"."),N.forEach(t),gn=c(ge),Q=a(ge,"LI",{});var Zt=s(Q);yt=a(Zt,"STRONG",{});var Ua=s(yt);pn=n(Ua,"keys_to_ignore_at_inference"),Ua.forEach(t),_n=n(Zt," ("),vt=a(Zt,"CODE",{});var Ga=s(vt);bn=n(Ga,"List[str]"),Ga.forEach(t),yn=n(Zt,`) \u2014 A list of keys to ignore by default when looking at dictionary
