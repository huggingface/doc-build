...
model = AutoModel.from_config(config)
engine = deepspeed.initialize(model=model, config_params=ds_config, ...)`}}),Vr=new y({}),Yr=new rj({props:{name:"class transformers.deepspeed.HfDeepSpeedConfig",anchor:"transformers.deepspeed.HfDeepSpeedConfig",parameters:[{name:"config_file_or_dict",val:""}],source:"https://github.com/huggingface/transformers/blob/doc-build-test/src/transformers/deepspeed.py#L40",parametersDescription:[{anchor:"transformers.deepspeed.HfDeepSpeedConfig.config_file_or_dict",description:"<strong>config_file_or_dict</strong> (<code>Union[str, Dict]</code>) &#x2014; path to DeepSpeed config file or dict.",name:"config_file_or_dict"}]}}),Kr=new rj({props:{name:"del\\_config\\_sub\\_tree",anchor:"transformers.deepspeed.HfDeepSpeedConfig.del_config_sub_tree",parameters:[{name:"ds_key_long",val:""},{name:"must_exist",val:" = False"}],source:"https://github.com/huggingface/transformers/blob/doc-build-test/src/transformers/deepspeed.py#L114"}}),Jr=new rj({props:{name:"get\\_value",anchor:"transformers.deepspeed.HfDeepSpeedConfig.get_value",parameters:[{name:"ds_key_long",val:""},{name:"default",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/doc-build-test/src/transformers/deepspeed.py#L105"}}),Qr=new rj({props:{name:"is\\_false",anchor:"transformers.deepspeed.HfDeepSpeedConfig.is_false",parameters:[{name:"ds_key_long",val:""}],source:"https://github.com/huggingface/transformers/blob/doc-build-test/src/transformers/deepspeed.py#L146"}}),ep=new rj({props:{name:"is\\_true",anchor:"transformers.deepspeed.HfDeepSpeedConfig.is_true",parameters:[{name:"ds_key_long",val:""}],source:"https://github.com/huggingface/transformers/blob/doc-build-test/src/transformers/deepspeed.py#L137"}}),sp=new y({}),tp=new g({props:{code:`#!/usr/bin/env python
...
configuration.`),eb=u(),qa=o("p"),VD=a("For example, for "),P_=o("code"),YD=a("WarmupDecayLR"),KD=a(", you can use the following entry:"),sb=u(),f(Sl.$$.fragment),tb=u(),H=o("p"),JD=a("and "),z_=o("code"),XD=a("total_num_steps"),QD=a(", "),D_=o("code"),eO=a("warmup_max_lr"),sO=a(", "),O_=o("code"),tO=a("warmup_num_steps"),aO=a(" and "),T_=o("code"),nO=a("total_num_steps"),oO=a(" will be set at loading time."),ab=u(),lu=o("a"),nb=u(),Ls=o("h3"),Ea=o("a"),A_=o("span"),f(Cl.$$.fragment),lO=u(),S_=o("span"),rO=a("fp32 Precision"),ob=u(),ru=o("p"),pO=a("Deepspeed supports the full fp32 and the fp16 mixed precision."),lb=u(),$a=o("p"),iO=a(`Because of the much reduced memory needs and faster speed one gets with the fp16 mixed precision, the only time you
...
the full fp32 mode, by explicitly disabling the otherwise default fp16 mixed precision mode with:`),rb=u(),f(xl.$$.fragment),pb=u(),ka=o("p"),hO=a(`If you\u2019re using the Ampere-architecture based GPU, pytorch version 1.7 and higher will automatically switch to using
...
instructions on how to disable this automatic conversion if for some reason you prefer not to use it.`),ib=u(),pu=o("a"),ub=u(),Ms=o("h3"),Pa=o("a"),x_=o("span"),f(Il.$$.fragment),mO=u(),R_=o("span"),_O=a("Automatic Mixed Precision"),cb=u(),iu=o("p"),vO=a("You can use automatic mixed precision with either a pytorch-like AMP way or the apex-like way:"),hb=u(),uu=o("p"),jO=a("To configure pytorch AMP-like mode set:"),fb=u(),f(Ul.$$.fragment),db=u(),Qe=o("p"),gO=a("and the "),cu=o("a"),yO=a("Trainer"),wO=a(` will automatically enable or disable it based on the value of
`),I_=o("code"),bO=a("args.fp16_backend"),qO=a(". The rest of config values are up to you."),mb=u(),za=o("p"),EO=a("This mode gets enabled when "),U_=o("code"),$O=a("--fp16 --fp16_backend amp"),kO=a(" command line args are passed."),_b=u(),hu=o("p"),PO=a("You can also enable/disable this mode explicitly:"),vb=u(),f(Gl.$$.fragment),jb=u(),Da=o("p"),zO=a("But then you\u2019re on your own synchronizing the "),fu=o("a"),DO=a("Trainer"),OO=a(` command line arguments and the DeepSpeed
configuration.`),gb=u(),Oa=o("p"),TO=a("Here is the "),Ll=o("a"),AO=a("documentation"),SO=a("."),yb=u(),du=o("p"),CO=a("To configure apex AMP-like mode set:"),wb=u(),f(Ml.$$.fragment),bb=u(),ne=o("p"),xO=a("and the "),mu=o("a"),RO=a("Trainer"),IO=a(" will automatically configure it based on the values of "),G_=o("code"),UO=a("args.fp16_backend"),GO=a(` and
`),L_=o("code"),LO=a("args.fp16_opt_level"),MO=a("."),qb=u(),Ta=o("p"),ZO=a("This mode gets enabled when "),M_=o("code"),NO=a("--fp16 --fp16_backend apex --fp16_opt_level 01"),HO=a(" command line args are passed."),Eb=u(),_u=o("p"),BO=a("You can also configure this mode explicitly:"),$b=u(),f(Zl.$$.fragment),kb=u(),Aa=o("p"),WO=a("But then you\u2019re on your own synchronizing the "),vu=o("a"),FO=a("Trainer"),VO=a(` command line arguments and the DeepSpeed
configuration.`),Pb=u(),Sa=o("p"),YO=a("Here is the "),Nl=o("a"),KO=a("documentation"),JO=a("."),zb=u(),ju=o("a"),Db=u(),Zs=o("h3"),Ca=o("a"),Z_=o("span"),f(Hl.$$.fragment),XO=u(),N_=o("span"),QO=a("Batch Size"),Ob=u(),gu=o("p"),eT=a("To configure batch size, use:"),Tb=u(),f(Bl.$$.fragment),Ab=u(),x=o("p"),sT=a("and the "),yu=o("a"),tT=a("Trainer"),aT=a(" will automatically set "),H_=o("code"),nT=a("train_micro_batch_size_per_gpu"),oT=a(` to the value of
`),B_=o("code"),lT=a("args.per_device_train_batch_size"),rT=a(" and "),W_=o("code"),pT=a("train_batch_size"),iT=a(" to "),F_=o("code"),uT=a("args.world_size * args.per_device_train_batch_size * args.gradient_accumulation_steps"),cT=a("."),Sb=u(),wu=o("p"),hT=a("You can also set the values explicitly:"),Cb=u(),f(Wl.$$.fragment),xb=u(),xa=o("p"),fT=a("But then you\u2019re on your own synchronizing the "),bu=o("a"),dT=a("Trainer"),mT=a(` command line arguments and the DeepSpeed
configuration.`),Rb=u(),qu=o("a"),Ib=u(),Ns=o("h3"),Ra=o("a"),V_=o("span"),f(Fl.$$.fragment),_T=u(),Y_=o("span"),vT=a("Gradient Accumulation"),Ub=u(),Eu=o("p"),jT=a("To configure gradient accumulation set:"),Gb=u(),f(Vl.$$.fragment),Lb=u(),es=o("p"),gT=a("and the "),$u=o("a"),yT=a("Trainer"),wT=a(" will automatically set it to the value of "),K_=o("code"),bT=a("args.gradient_accumulation_steps"),qT=a("."),Mb=u(),ku=o("p"),ET=a("You can also set the value explicitly:"),Zb=u(),f(Yl.$$.fragment),Nb=u(),Ia=o("p"),$T=a("But then you\u2019re on your own synchronizing the "),Pu=o("a"),kT=a("Trainer"),PT=a(` command line arguments and the DeepSpeed
configuration.`),Hb=u(),zu=o("a"),Bb=u(),Hs=o("h3"),Ua=o("a"),J_=o("span"),f(Kl.$$.fragment),zT=u(),X_=o("span"),DT=a("Gradient Clipping"),Wb=u(),Du=o("p"),OT=a("To configure gradient gradient clipping set:"),Fb=u(),f(Jl.$$.fragment),Vb=u(),ss=o("p"),TT=a("and the "),Ou=o("a"),AT=a("Trainer"),ST=a(" will automatically set it to the value of "),Q_=o("code"),CT=a("args.max_grad_norm"),xT=a("."),Yb=u(),Tu=o("p"),RT=a("You can also set the value explicitly:"),Kb=u(),f(Xl.$$.fragment),Jb=u(),Ga=o("p"),IT=a("But then you\u2019re on your own synchronizing the "),Au=o("a"),UT=a("Trainer"),GT=a(` command line arguments and the DeepSpeed
configuration.`),Xb=u(),Su=o("a"),Qb=u(),Bs=o("h3"),La=o("a"),e1=o("span"),f(Ql.$$.fragment),LT=u(),s1=o("span"),MT=a("Getting The Model Weights Out"),e2=u(),Ma=o("p"),ZT=a(`As long as you continue training and resuming using DeepSpeed you don\u2019t need to worry about anything. DeepSpeed stores
...
pattern), and are saved under the normal checkpoint.`),s2=u(),Cu=o("p"),a1=o("strong"),BT=a("FP16 Weights:"),t2=u(),Za=o("p"),WT=a("When a model is saved under ZeRO-2, you end up having the normal "),n1=o("code"),FT=a("pytorch_model.bin"),VT=a(` file with the model weights, but
they are only the fp16 version of the weights.`),a2=u(),B=o("p"),YT=a(`Under ZeRO-3, things are much more complicated, since the model weights are partitioned out over multiple GPUs,
...
won\u2019t be possible to load it back.`),n2=u(),f(er.$$.fragment),o2=u(),xu=o("p"),i1=o("strong"),nA=a("FP32 Weights:"),l2=u(),Na=o("p"),oA=a(`While the fp16 weights are fine for resuming training, if you finished finetuning your model and want to upload it to
...
memory it can be done in the same training script. The following sections will discuss both approaches.`),r2=u(),Ru=o("p"),u1=o("strong"),pA=a("Live FP32 Weights Recovery:"),p2=u(),Iu=o("p"),iA=a("This approach may not work if you model is large and you have little free CPU memory left, at the end of the training."),i2=u(),Uu=o("p"),uA=a("If you have saved at least one checkpoint, and you want to use the latest one, you can do the following:"),u2=u(),f(tr.$$.fragment),c2=u(),ts=o("p"),cA=a("If you\u2019re using the "),c1=o("code"),hA=a("--load_best_model_at_end"),fA=a(" class:"),h1=o("em"),dA=a("~transformers.TrainingArguments"),mA=a(` argument (to track the best
checkpoint), then you can finish the training by first saving the final model explicitly and then do the same as above:`),h2=u(),f(ar.$$.fragment),f2=u(),f(Ha.$$.fragment),d2=u(),Ba=o("p"),_A=a("Of course, you don\u2019t have to use class:"),f1=o("em"),vA=a("~transformers.Trainer"),jA=a(` and you can adjust the examples above to your own
trainer.`),m2=u(),Wa=o("p"),gA=a("If for some reason you want more refinement, you can also extract the fp32 "),d1=o("code"),yA=a("state_dict"),wA=a(` of the weights and apply
these yourself as is shown in the following example:`),_2=u(),f(nr.$$.fragment),v2=u(),Gu=o("p"),m1=o("strong"),bA=a("Offline FP32 Weights Recovery:"),j2=u(),as=o("p"),qA=a("DeepSpeed creates a special conversion script "),_1=o("code"),EA=a("zero_to_fp32.py"),$A=a(` which it places in the top-level of the checkpoint
folder. Using this script you can extract the weights at any point. The script is standalone and you no longer need to
have the configuration file or a `),v1=o("code"),kA=a("Trainer"),PA=a(" to do the extraction."),g2=u(),Lu=o("p"),zA=a("Let\u2019s say your checkpoint folder looks like this:"),y2=u(),f(or.$$.fragment),w2=u(),Fa=o("p"),DA=a("In this example there is just one DeepSpeed checkpoint sub-folder "),j1=o("em"),OA=a("global_step1"),TA=a(`. Therefore to reconstruct the fp32
weights just run:`),b2=u(),f(lr.$$.fragment),q2=u(),Va=o("p"),AA=a("This is it. "),g1=o("code"),SA=a("pytorch_model.bin"),CA=a(" will now contain the full fp32 model weights consolidated from multiple GPUs."),E2=u(),Mu=o("p"),xA=a("The script will automatically be able to handle either a ZeRO-2 or ZeRO-3 checkpoint."),$2=u(),rr=o("p"),y1=o("code"),RA=a("python zero_to_fp32.py -h"),IA=a(" will give you usage details."),k2=u(),ns=o("p"),UA=a("The script will auto-discover the deepspeed sub-folder using the contents of the file "),w1=o("code"),GA=a("latest"),LA=a(`, which in the current
example will contain `),b1=o("code"),MA=a("global_step1"),ZA=a("."),P2=u(),Zu=o("p"),NA=a("Note: currently the script requires 2x general RAM of the final fp32 model weights."),z2=u(),Ws=o("h3"),Ya=o("a"),q1=o("span"),f(pr.$$.fragment),HA=u(),E1=o("span"),BA=a("ZeRO-3 and Infinity Nuances"),D2=u(),Nu=o("p"),WA=a("ZeRO-3 is quite different from ZeRO-2 because of its param sharding feature."),O2=u(),Hu=o("p"),FA=a("ZeRO-Infinity further extends ZeRO-3 to support NVMe memory and multiple other speed and scalability improvements."),T2=u(),Bu=o("p"),VA=a(`While all the efforts were made for things to just work without needing any special changes to your models, in certain
circumstances you may find the following information to be needed.`),A2=u(),Fs=o("h4"),Ka=o("a"),$1=o("span"),f(ir.$$.fragment),YA=u(),k1=o("span"),KA=a("Constructing Massive Models"),S2=u(),Ja=o("p"),JA=a(`DeepSpeed/ZeRO-3 can handle models with Trillions of parameters which may not fit onto the existing RAM. In such cases,
...
context manager (which is also a function decorator), like so:`),C2=u(),f(ur.$$.fragment),x2=u(),Wu=o("p"),eS=a("As you can see this gives you a randomly initialized model."),R2=u(),k=o("p"),sS=a("If you want to use a pretrained model, "),z1=o("code"),tS=a("model_class.from_pretrained"),aS=a(` will activate this feature as long as
...
`),A1=o("code"),dS=a("from_pretrained"),mS=a(". Here is an example of a possible sequence:"),I2=u(),f(cr.$$.fragment),U2=u(),Xa=o("p"),_S=a("If you\u2019re using the official example scripts and your command line arguments include "),S1=o("code"),vS=a("--deepspeed ds_config.json"),jS=a(`
with ZeRO-3 config enabled, then everything is already done for you, since this is how example scripts are written.`),G2=u(),Yu=o("p"),gS=a("Note: If the fp16 weights of the model can\u2019t fit onto the memory of a single GPU this feature must be used."),L2=u(),Qa=o("p"),yS=a("For full details on this method and other related features please refer to "),hr=o("a"),wS=a("Constructing Massive Models"),bS=a("."),M2=u(),oe=o("p"),qS=a("Also when loading fp16-pretrained models, you will want to tell "),C1=o("code"),ES=a("from_pretrained"),$S=a(` to use
`),x1=o("code"),kS=a("torch_dtype=torch.float16"),PS=a(". For details, please, see "),Ku=o("a"),zS=a("from_pretrained-torch-dtype"),DS=a("."),Z2=u(),Vs=o("h4"),en=o("a"),R1=o("span"),f(fr.$$.fragment),OS=u(),I1=o("span"),TS=a("Gathering Parameters"),N2=u(),dr=o("p"),AS=a(`Under ZeRO-3 on multiple GPUs no single GPU has all the parameters unless it\u2019s the parameters for the currently
executing layer. So if you need to access all parameters from all layers at once there is a specific method to do it.
Most likely you won\u2019t need it, but if you do please refer to `),mr=o("a"),SS=a("Gathering Parameters"),H2=u(),sn=o("p"),CS=a(`We do however use it internally in several places, one such example is when loading pretrained model weights in
...
limitations.`),B2=u(),Ju=o("p"),IS=a("Also under ZeRO-3, if you write your own code and run into a model parameter weight that looks like:"),W2=u(),f(_r.$$.fragment),F2=u(),os=o("p"),US=a("stress on "),G1=o("code"),GS=a("tensor([1.])"),LS=a(", or if you get an error where it says the parameter is of size "),L1=o("code"),MS=a("1"),ZS=a(`, instead of some much
larger multi-dimensional shape, this means that the parameter is partitioned and what you see is a ZeRO-3 placeholder.`),V2=u(),Xu=o("a"),Y2=u(),Ys=o("h3"),tn=o("a"),M1=o("span"),f(vr.$$.fragment),NS=u(),Z1=o("span"),HS=a("ZeRO Inference"),K2=u(),Qu=o("p"),BS=a(`ZeRO Inference uses the same config as ZeRO-3 Training. You just don\u2019t need the optimizer and scheduler sections. In
fact you can leave these in the config file if you want to share the same one with the training. They will just be
ignored.`),J2=u(),an=o("p"),WS=a("Otherwise you just need to pass the usual "),ec=o("a"),FS=a("TrainingArguments"),VS=a(" arguments. For example:"),X2=u(),f(jr.$$.fragment),Q2=u(),sc=o("p"),YS=a(`The only important thing is that you need to use a ZeRO-3 configuration, since ZeRO-2 provides no benefit whatsoever
...
the full fp32 mode, by explicitly disabling the otherwise default fp16 mixed precision mode with:`),Rq.forEach(t),rb=c(e),d(xl.$$.fragment,e),pb=c(e),ka=l(e,"P",{});var Iq=r(ka);hO=n(Iq,`If you\u2019re using the Ampere-architecture based GPU, pytorch version 1.7 and higher will automatically switch to using
the much more efficient tf32 format for some operations, but the results will still be in fp32. For details and
...
pattern), and are saved under the normal checkpoint.`),Xq.forEach(t),s2=c(e),Cu=l(e,"P",{});var lB=r(Cu);a1=l(lB,"STRONG",{});var rB=r(a1);BT=n(rB,"FP16 Weights:"),rB.forEach(t),lB.forEach(t),t2=c(e),Za=l(e,"P",{});var Qq=r(Za);WT=n(Qq,"When a model is saved under ZeRO-2, you end up having the normal "),n1=l(Qq,"CODE",{});var pB=r(n1);FT=n(pB,"pytorch_model.bin"),pB.forEach(t),VT=n(Qq,` file with the model weights, but
they are only the fp16 version of the weights.`),Qq.forEach(t),a2=c(e),B=l(e,"P",{});var ds=r(B);YT=n(ds,`Under ZeRO-3, things are much more complicated, since the model weights are partitioned out over multiple GPUs,
...
won\u2019t be possible to load it back.`),ds.forEach(t),n2=c(e),d(er.$$.fragment,e),o2=c(e),xu=l(e,"P",{});var fB=r(xu);i1=l(fB,"STRONG",{});var dB=r(i1);nA=n(dB,"FP32 Weights:"),dB.forEach(t),fB.forEach(t),l2=c(e),Na=l(e,"P",{});var eE=r(Na);oA=n(eE,`While the fp16 weights are fine for resuming training, if you finished finetuning your model and want to upload it to
...
large models it won\u2019t be possible to load it on one GPU and then spread it out to multiple GPUs, due to memory
limitations.`),cE.forEach(t),B2=c(e),Ju=l(e,"P",{});var cW=r(Ju);IS=n(cW,"Also under ZeRO-3, if you write your own code and run into a model parameter weight that looks like:"),cW.forEach(t),W2=c(e),d(_r.$$.fragment,e),F2=c(e),os=l(e,"P",{});var bh=r(os);US=n(bh,"stress on "),G1=l(bh,"CODE",{});var hW=r(G1);GS=n(hW,"tensor([1.])"),hW.forEach(t),LS=n(bh,", or if you get an error where it says the parameter is of size "),L1=l(bh,"CODE",{});var fW=r(L1);MS=n(fW,"1"),fW.forEach(t),ZS=n(bh,`, instead of some much
larger multi-dimensional shape, this means that the parameter is partitioned and what you see is a ZeRO-3 placeholder.`),bh.forEach(t),V2=c(e),Xu=l(e,"A",{id:!0}),r(Xu).forEach(t),Y2=c(e),Ys=l(e,"H3",{class:!0});var hE=r(Ys);tn=l(hE,"A",{id:!0,class:!0,href:!0});var dW=r(tn);M1=l(dW,"SPAN",{});var mW=r(M1);d(vr.$$.fragment,mW),mW.forEach(t),dW.forEach(t),NS=c(hE),Z1=l(hE,"SPAN",{});var _W=r(Z1);HS=n(_W,"ZeRO Inference"),_W.forEach(t),hE.forEach(t),K2=c(e),Qu=l(e,"P",{});var vW=r(Qu);BS=n(vW,`ZeRO Inference uses the same config as ZeRO-3 Training. You just don\u2019t need the optimizer and scheduler sections. In
fact you can leave these in the config file if you want to share the same one with the training. They will just be
ignored.`),vW.forEach(t),J2=c(e),an=l(e,"P",{});var fE=r(an);WS=n(fE,"Otherwise you just need to pass the usual "),ec=l(fE,"A",{href:!0});var jW=r(ec);FS=n(jW,"TrainingArguments"),jW.forEach(t),VS=n(fE," arguments. For example:"),fE.forEach(t),X2=c(e),d(jr.$$.fragment,e),Q2=c(e),sc=l(e,"P",{});var gW=r(sc);YS=n(gW,`The only important thing is that you need to use a ZeRO-3 configuration, since ZeRO-2 provides no benefit whatsoever
