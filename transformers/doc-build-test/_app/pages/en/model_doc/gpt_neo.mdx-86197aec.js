import{S as Ql,i as Yl,s as Zl,e as n,k as d,w as _,t as r,L as ed,c as s,d as o,m as c,a,x as T,h as i,b as l,J as e,g as u,y as v,q as b,o as y,B as P}from"../../../chunks/vendor-9e2b328e.js";import{T as rn}from"../../../chunks/Tip-76f97a76.js";import{D as V}from"../../../chunks/Docstring-50fd6873.js";import{C as je}from"../../../chunks/CodeBlock-b9ff96e9.js";import{I as _e}from"../../../chunks/IconCopyLink-fd0e58fd.js";import"../../../chunks/CopyButton-4b97cbf7.js";function td(O){let p,w,m,k,N;return{c(){p=n("p"),w=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),m=n("code"),k=r("Module"),N=r(`
...
the latter silently ignores them.`)},l(g){p=s(g,"P",{});var f=a(p);w=i(f,"Although the recipe for forward pass needs to be defined within this function, one should call the "),m=s(f,"CODE",{});var $=a(m);k=i($,"Module"),$.forEach(o),N=i(f,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),f.forEach(o)},m(g,f){u(g,p,f),e(p,w),e(p,m),e(m,k),e(p,N)},d(g){g&&o(p)}}}function rd(O){let p,w,m,k,N,g,f,$,Jn,ln,oe,Te,ro,Ae,Rn,io,Xn,dn,J,Kn,Ie,Qn,Yn,Le,Zn,es,cn,Lt,ts,pn,ve,os,Se,ns,ss,hn,ne,be,lo,De,as,co,rs,un,ye,is,po,ls,ds,mn,Be,fn,se,Pe,ho,Oe,cs,uo,ps,gn,E,We,hs,ae,us,St,ms,fs,He,gs,_s,Ts,re,vs,Dt,bs,ys,Bt,Ps,ks,ws,mo,Ns,$s,Ue,_n,ie,ke,fo,Ve,Gs,go,xs,Tn,z,Je,Ms,_o,Fs,Es,Re,zs,Ot,Cs,qs,js,Xe,As,Ke,Is,Ls,Ss,q,Qe,Ds,le,Bs,Wt,Os,Ws,To,Hs,Us,Vs,we,Js,vo,Rs,Xs,Ye,vn,de,Ne,bo,Ze,Ks,yo,Qs,bn,C,et,Ys,Po,Zs,ea,tt,ta,Ht,oa,na,sa,ot,aa,nt,ra,ia,la,j,st,da,ce,ca,Ut,pa,ha,ko,ua,ma,fa,$e,ga,wo,_a,Ta,at,yn,pe,Ge,No,rt,va,$o,ba,Pn,G,it,ya,Go,Pa,ka,Vt,Jt,wa,Na,$a,W,Ga,xo,xa,Ma,Mo,Fa,Ea,Fo,za,Ca,Eo,qa,ja,Aa,lt,Ia,Rt,La,Sa,Da,dt,Ba,ct,Oa,Wa,Ha,F,pt,Ua,he,Va,Xt,Ja,Ra,zo,Xa,Ka,Qa,xe,Ya,Co,Za,er,ht,tr,qo,or,nr,ut,kn,ue,Me,jo,mt,sr,Ao,ar,wn,x,ft,rr,Io,ir,lr,gt,dr,Kt,cr,pr,hr,_t,ur,Tt,mr,fr,gr,Lo,_r,Tr,H,So,vt,vr,br,Do,bt,yr,Pr,Bo,yt,kr,wr,Oo,Pt,Nr,$r,A,kt,Gr,me,xr,Wo,Mr,Fr,Ho,Er,zr,Cr,Fe,qr,Uo,jr,Ar,wt,Nn,fe,Ee,Vo,Nt,Ir,Jo,Lr,$n,M,$t,Sr,Ro,Dr,Br,Gt,Or,Qt,Wr,Hr,Ur,xt,Vr,Mt,Jr,Rr,Xr,Xo,Kr,Qr,U,Ko,Ft,Yr,Zr,Qo,Et,ei,ti,Yo,zt,oi,ni,Zo,Ct,si,ai,I,qt,ri,ge,ii,en,li,di,tn,ci,pi,hi,ze,ui,on,mi,fi,jt,Gn;return g=new _e({}),Ae=new _e({}),De=new _e({}),Be=new je({props:{code:`from transformers import GPTNeoForCausalLM, GPT2Tokenizer
...
<span class="hljs-meta">&gt;&gt;&gt; </span>configuration = model.config`}}),Ve=new _e({}),Je=new V({props:{name:"class transformers.GPTNeoModel",anchor:"transformers.GPTNeoModel",parameters:[{name:"config",val:""}],source:"https://github.com/huggingface/transformers/blob/doc-build-test/src/transformers/models/gpt_neo/modeling_gpt_neo.py#L475",parametersDescription:[{anchor:"transformers.GPTNeoModel.config",description:`<strong>config</strong> (<a href="/docs/transformers/doc-build-test/en/model_doc/gpt_neo#transformers.GPTNeoConfig">GPTNeoConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/doc-build-test/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),Qe=new V({props:{name:"forward",anchor:"transformers.GPTNeoModel.forward",parameters:[{name:"input_ids",val:" = None"},{name:"past_key_values",val:" = None"},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/doc-build-test/src/transformers/models/gpt_neo/modeling_gpt_neo.py#L496",parametersDescription:[{anchor:"transformers.GPTNeoModel.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, input_ids_length)</code>) &#x2014;
...
<p>Indices can be obtained using <code>GPTNeoTokenizer</code>. See <a href="/docs/transformers/doc-build-test/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
...
elements depending on the configuration (<a
  href="/docs/transformers/doc-build-test/en/model_doc/gpt_neo#transformers.GPTNeoConfig"
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),Ze=new _e({}),et=new V({props:{name:"class transformers.GPTNeoForCausalLM",anchor:"transformers.GPTNeoForCausalLM",parameters:[{name:"config",val:""}],source:"https://github.com/huggingface/transformers/blob/doc-build-test/src/transformers/models/gpt_neo/modeling_gpt_neo.py#L663",parametersDescription:[{anchor:"transformers.GPTNeoForCausalLM.config",description:`<strong>config</strong> (<a href="/docs/transformers/doc-build-test/en/model_doc/gpt_neo#transformers.GPTNeoConfig">GPTNeoConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/doc-build-test/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),st=new V({props:{name:"forward",anchor:"transformers.GPTNeoForCausalLM.forward",parameters:[{name:"input_ids",val:" = None"},{name:"past_key_values",val:" = None"},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"labels",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/doc-build-test/src/transformers/models/gpt_neo/modeling_gpt_neo.py#L713",parametersDescription:[{anchor:"transformers.GPTNeoForCausalLM.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, input_ids_length)</code>) &#x2014;
<code>input_ids_length</code> = <code>sequence_length</code> if <code>past_key_values</code> is <code>None</code> else
<code>past_key_values[0][0].shape[-2]</code> (<code>sequence_length</code> of input past key value states). Indices of input
sequence tokens in the vocabulary.</p>
<p>If <code>past_key_values</code> is used, only <code>input_ids</code> that do not have their past calculated should be passed as
...
<a href="/docs/transformers/doc-build-test/en/main_classes/model#transformers.FlaxPreTrainedModel.to_bf16">to_bf16()</a>.`,name:"dtype"}]}}),kt=new V({props:{name:"\\_\\_call\\_\\_",anchor:"transformers.FlaxGPTNeoPreTrainedModel.__call__",parameters:[{name:"input_ids",val:""},{name:"attention_mask",val:" = None"},{name:"position_ids",val:" = None"},{name:"params",val:": dict = None"},{name:"past_key_values",val:": dict = None"},{name:"dropout_rng",val:": PRNGKey = None"},{name:"train",val:": bool = False"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],source:"https://github.com/huggingface/transformers/blob/doc-build-test/src/transformers/models/gpt_neo/modeling_flax_gpt_neo.py#L391",parametersDescription:[{anchor:"transformers.FlaxGPTNeoPreTrainedModel.__call__.input_ids",description:`<strong>input_ids</strong> (<code>numpy.ndarray</code> of shape <code>(batch_size, input_ids_length)</code>) &#x2014;
...
256 tokens.`),pn=d(),ve=n("p"),os=r("This model was contributed by "),Se=n("a"),ns=r("valhalla"),ss=r("."),hn=d(),ne=n("h3"),be=n("a"),lo=n("span"),_(De.$$.fragment),as=d(),co=n("span"),rs=r("Generation"),un=d(),ye=n("p"),is=r("The "),po=n("code"),ls=r("generate()"),ds=r(" method can be used to generate text using GPT Neo model."),mn=d(),_(Be.$$.fragment),fn=d(),se=n("h2"),Pe=n("a"),ho=n("span"),_(Oe.$$.fragment),cs=d(),uo=n("span"),ps=r("GPTNeoConfig"),gn=d(),E=n("div"),_(We.$$.fragment),hs=d(),ae=n("p"),us=r("This is the configuration class to store the configuration of a "),St=n("a"),ms=r("GPTNeoModel"),fs=r(`. It is used to instantiate a GPT
...
`),He=n("a"),gs=r("gpt-neo-1.3B"),_s=r(" architecture."),Ts=d(),re=n("p"),vs=r("Configuration objects inherit from "),Dt=n("a"),bs=r("PretrainedConfig"),ys=r(` and can be used to control the model outputs. Read the
documentation from `),Bt=n("a"),Ps=r("PretrainedConfig"),ks=r(" for more information."),ws=d(),mo=n("p"),Ns=r("Example:"),$s=d(),_(Ue.$$.fragment),_n=d(),ie=n("h2"),ke=n("a"),fo=n("span"),_(Ve.$$.fragment),Gs=d(),go=n("span"),xs=r("GPTNeoModel"),Tn=d(),z=n("div"),_(Je.$$.fragment),Ms=d(),_o=n("p"),Fs=r("The bare GPT Neo Model transformer outputting raw hidden-states without any specific head on top."),Es=d(),Re=n("p"),zs=r("This model inherits from "),Ot=n("a"),Cs=r("PreTrainedModel"),qs=r(`. Check the superclass documentation for the generic methods the
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),la=d(),j=n("div"),_(st.$$.fragment),da=d(),ce=n("p"),ca=r("The "),Ut=n("a"),pa=r("GPTNeoForCausalLM"),ha=r(" forward method, overrides the "),ko=n("code"),ua=r("__call__"),ma=r(" special method."),fa=d(),_($e.$$.fragment),ga=d(),wo=n("p"),_a=r("Example:"),Ta=d(),_(at.$$.fragment),yn=d(),pe=n("h2"),Ge=n("a"),No=n("span"),_(rt.$$.fragment),va=d(),$o=n("span"),ba=r("GPTNeoForSequenceClassification"),Pn=d(),G=n("div"),_(it.$$.fragment),ya=d(),Go=n("p"),Pa=r("The GPTNeo Model transformer with a sequence classification head on top (linear layer)."),ka=d(),Vt=n("p"),Jt=n("a"),wa=r("GPTNeoForSequenceClassification"),Na=r(` uses the last token in order to do the classification, as other causal models
...
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),gr=d(),Lo=n("p"),_r=r("Finally, this model supports inherent JAX features such as:"),Tr=d(),H=n("ul"),So=n("li"),vt=n("a"),vr=r("Just-In-Time (JIT) compilation"),br=d(),Do=n("li"),bt=n("a"),yr=r("Automatic Differentiation"),Pr=d(),Bo=n("li"),yt=n("a"),kr=r("Vectorization"),wr=d(),Oo=n("li"),Pt=n("a"),Nr=r("Parallelization"),$r=d(),A=n("div"),_(kt.$$.fragment),Gr=d(),me=n("p"),xr=r("The "),Wo=n("code"),Mr=r("FlaxGPTNeoPreTrainedModel"),Fr=r("forward method, overrides the "),Ho=n("code"),Er=r("__call__"),zr=r(" special method."),Cr=d(),_(Fe.$$.fragment),qr=d(),Uo=n("p"),jr=r("Example:"),Ar=d(),_(wt.$$.fragment),Nn=d(),fe=n("h2"),Ee=n("a"),Vo=n("span"),_(Nt.$$.fragment),Ir=d(),Jo=n("span"),Lr=r("FlaxGPTNeoForCausalLM"),$n=d(),M=n("div"),_($t.$$.fragment),Sr=d(),Ro=n("p"),Dr=r(`The GPTNeo Model transformer with a language modeling head on top (linear layer with weights tied to the input
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),In.forEach(o),la=c(Q),j=s(Q,"DIV",{class:!0});var Y=a(j);T(st.$$.fragment,Y),da=c(Y),ce=s(Y,"P",{});var oo=a(ce);ca=i(oo,"The "),Ut=s(oo,"A",{href:!0});var Qi=a(Ut);pa=i(Qi,"GPTNeoForCausalLM"),Qi.forEach(o),ha=i(oo," forward method, overrides the "),ko=s(oo,"CODE",{});var Yi=a(ko);ua=i(Yi,"__call__"),Yi.forEach(o),ma=i(oo," special method."),oo.forEach(o),fa=c(Y),T($e.$$.fragment,Y),ga=c(Y),wo=s(Y,"P",{});var Zi=a(wo);_a=i(Zi,"Example:"),Zi.forEach(o),Ta=c(Y),T(at.$$.fragment,Y),Y.forEach(o),Q.forEach(o),yn=c(t),pe=s(t,"H2",{class:!0});var Ln=a(pe);Ge=s(Ln,"A",{id:!0,class:!0,href:!0});var el=a(Ge);No=s(el,"SPAN",{});var tl=a(No);T(rt.$$.fragment,tl),tl.forEach(o),el.forEach(o),va=c(Ln),$o=s(Ln,"SPAN",{});var ol=a($o);ba=i(ol,"GPTNeoForSequenceClassification"),ol.forEach(o),Ln.forEach(o),Pn=c(t),G=s(t,"DIV",{class:!0});var L=a(G);T(it.$$.fragment,L),ya=c(L),Go=s(L,"P",{});var nl=a(Go);Pa=i(nl,"The GPTNeo Model transformer with a sequence classification head on top (linear layer)."),nl.forEach(o),ka=c(L),Vt=s(L,"P",{});var gi=a(Vt);Jt=s(gi,"A",{href:!0});var sl=a(Jt);wa=i(sl,"GPTNeoForSequenceClassification"),sl.forEach(o),Na=i(gi,` uses the last token in order to do the classification, as other causal models
