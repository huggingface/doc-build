...
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),_.forEach(t)},m(b,_){h(b,p,_),e(p,y),e(p,f),e(f,g),e(p,v)},d(b){b&&t(p)}}}function Ki(A){let p,y,f,g,v;return{c(){p=a("p"),y=s("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=a("code"),g=s("Module"),v=s(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(b){p=r(b,"P",{});var _=i(p);y=n(_,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=r(_,"CODE",{});var E=i(f);g=n(E,"Module"),E.forEach(t),v=n(_,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),_.forEach(t)},m(b,_){h(b,p,_),e(p,y),e(p,f),e(f,g),e(p,v)},d(b){b&&t(p)}}}function Yi(A){let p,y,f,g,v;return{c(){p=a("p"),y=s("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=a("code"),g=s("Module"),v=s(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(b){p=r(b,"P",{});var _=i(p);y=n(_,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=r(_,"CODE",{});var E=i(f);g=n(E,"Module"),E.forEach(t),v=n(_,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),_.forEach(t)},m(b,_){h(b,p,_),e(p,y),e(p,f),e(f,g),e(p,v)},d(b){b&&t(p)}}}function Gi(A){let p,y,f,g,v,b,_,E,Fe,de,F,K,O,Q,qe,I,Me,we,D,L,Z,_e,q,x,ce,ee,Te,pe,W,xe,ke,M,Pe,Y,G,be,te,Se,oe,N,ue,se,ze;return{c(){p=a("p"),y=s("TF 2.0 models accepts two formats as inputs:"),f=l(),g=a("ul"),v=a("li"),b=s("having all inputs as keyword arguments (like PyTorch models), or"),_=l(),E=a("li"),Fe=s("having all inputs as a list, tuple or dict in the first positional arguments."),de=l(),F=a("p"),K=s("This second option is useful when using "),O=a("code"),Q=s("tf.keras.Model.fit"),qe=s(` method which currently requires having all the
...
`),Y=a("code"),G=s("model([input_values, attention_mask])"),be=s(" or "),te=a("code"),Se=s("model([input_values, attention_mask, token_type_ids])"),oe=l(),N=a("li"),ue=s(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),se=a("code"),ze=s('model({"input_values": input_values, "token_type_ids": token_type_ids})')},l(u){p=r(u,"P",{});var w=i(p);y=n(w,"TF 2.0 models accepts two formats as inputs:"),w.forEach(t),f=d(u),g=r(u,"UL",{});var ve=i(g);v=r(ve,"LI",{});var ye=i(v);b=n(ye,"having all inputs as keyword arguments (like PyTorch models), or"),ye.forEach(t),_=d(ve),E=r(ve,"LI",{});var Ue=i(E);Fe=n(Ue,"having all inputs as a list, tuple or dict in the first positional arguments."),Ue.forEach(t),ve.forEach(t),de=d(u),F=r(u,"P",{});var B=i(F);K=n(B,"This second option is useful when using "),O=r(B,"CODE",{});var Oe=i(O);Q=n(Oe,"tf.keras.Model.fit"),Oe.forEach(t),qe=n(B,` method which currently requires having all the
tensors in the first argument of the model call function: `),I=r(B,"CODE",{});var ne=i(I);Me=n(ne,"model(inputs)"),ne.forEach(t),we=n(B,"."),B.forEach(t),D=d(u),L=r(u,"P",{});var he=i(L);Z=n(he,`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),he.forEach(t),_e=d(u),q=r(u,"UL",{});var S=i(q);x=r(S,"LI",{});var z=i(x);ce=n(z,"a single Tensor with "),ee=r(z,"CODE",{});var Ke=i(ee);Te=n(Ke,"input_values"),Ke.forEach(t),pe=n(z," only and nothing else: "),W=r(z,"CODE",{});var De=i(W);xe=n(De,"model(inputs_ids)"),De.forEach(t),z.forEach(t),ke=d(S),M=r(S,"LI",{});var ae=i(M);Pe=n(ae,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),Y=r(ae,"CODE",{});var Ie=i(Y);G=n(Ie,"model([input_values, attention_mask])"),Ie.forEach(t),be=n(ae," or "),te=r(ae,"CODE",{});var P=i(te);Se=n(P,"model([input_values, attention_mask, token_type_ids])"),P.forEach(t),ae.forEach(t),oe=d(S),N=r(S,"LI",{});var re=i(N);ue=n(re,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),se=r(re,"CODE",{});var Ye=i(se);ze=n(Ye,'model({"input_values": input_values, "token_type_ids": token_type_ids})'),Ye.forEach(t),re.forEach(t),S.forEach(t)},m(u,w){h(u,p,w),e(p,y),h(u,f,w),h(u,g,w),e(g,v),e(v,b),e(g,_),e(g,E),e(E,Fe),h(u,de,w),h(u,F,w),e(F,K),e(F,O),e(O,Q),e(F,qe),e(F,I),e(I,Me),e(F,we),h(u,D,w),h(u,L,w),e(L,Z),h(u,_e,w),h(u,q,w),e(q,x),e(x,ce),e(x,ee),e(ee,Te),e(x,pe),e(x,W),e(W,xe),e(q,ke),e(q,M),e(M,Pe),e(M,Y),e(Y,G),e(M,be),e(M,te),e(te,Se),e(q,oe),e(q,N),e(N,ue),e(N,se),e(se,ze)},d(u){u&&t(p),u&&t(f),u&&t(g),u&&t(de),u&&t(F),u&&t(D),u&&t(L),u&&t(_e),u&&t(q)}}}function Ji(A){let p,y,f,g,v;return{c(){p=a("p"),y=s("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=a("code"),g=s("Module"),v=s(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(b){p=r(b,"P",{});var _=i(p);y=n(_,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=r(_,"CODE",{});var E=i(f);g=n(E,"Module"),E.forEach(t),v=n(_,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),_.forEach(t)},m(b,_){h(b,p,_),e(p,y),e(p,f),e(f,g),e(p,v)},d(b){b&&t(p)}}}function Xi(A){let p,y,f,g,v,b,_,E,Fe,de,F,K,O,Q,qe,I,Me,we,D,L,Z,_e,q,x,ce,ee,Te,pe,W,xe,ke,M,Pe,Y,G,be,te,Se,oe,N,ue,se,ze;return{c(){p=a("p"),y=s("TF 2.0 models accepts two formats as inputs:"),f=l(),g=a("ul"),v=a("li"),b=s("having all inputs as keyword arguments (like PyTorch models), or"),_=l(),E=a("li"),Fe=s("having all inputs as a list, tuple or dict in the first positional arguments."),de=l(),F=a("p"),K=s("This second option is useful when using "),O=a("code"),Q=s("tf.keras.Model.fit"),qe=s(` method which currently requires having all the
tensors in the first argument of the model call function: `),I=a("code"),Me=s("model(inputs)"),we=s("."),D=l(),L=a("p"),Z=s(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),_e=l(),q=a("ul"),x=a("li"),ce=s("a single Tensor with "),ee=a("code"),Te=s("input_values"),pe=s(" only and nothing else: "),W=a("code"),xe=s("model(inputs_ids)"),ke=l(),M=a("li"),Pe=s(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),Y=a("code"),G=s("model([input_values, attention_mask])"),be=s(" or "),te=a("code"),Se=s("model([input_values, attention_mask, token_type_ids])"),oe=l(),N=a("li"),ue=s(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),se=a("code"),ze=s('model({"input_values": input_values, "token_type_ids": token_type_ids})')},l(u){p=r(u,"P",{});var w=i(p);y=n(w,"TF 2.0 models accepts two formats as inputs:"),w.forEach(t),f=d(u),g=r(u,"UL",{});var ve=i(g);v=r(ve,"LI",{});var ye=i(v);b=n(ye,"having all inputs as keyword arguments (like PyTorch models), or"),ye.forEach(t),_=d(ve),E=r(ve,"LI",{});var Ue=i(E);Fe=n(Ue,"having all inputs as a list, tuple or dict in the first positional arguments."),Ue.forEach(t),ve.forEach(t),de=d(u),F=r(u,"P",{});var B=i(F);K=n(B,"This second option is useful when using "),O=r(B,"CODE",{});var Oe=i(O);Q=n(Oe,"tf.keras.Model.fit"),Oe.forEach(t),qe=n(B,` method which currently requires having all the
...
first positional argument :`),he.forEach(t),_e=d(u),q=r(u,"UL",{});var S=i(q);x=r(S,"LI",{});var z=i(x);ce=n(z,"a single Tensor with "),ee=r(z,"CODE",{});var Ke=i(ee);Te=n(Ke,"input_values"),Ke.forEach(t),pe=n(z," only and nothing else: "),W=r(z,"CODE",{});var De=i(W);xe=n(De,"model(inputs_ids)"),De.forEach(t),z.forEach(t),ke=d(S),M=r(S,"LI",{});var ae=i(M);Pe=n(ae,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),Y=r(ae,"CODE",{});var Ie=i(Y);G=n(Ie,"model([input_values, attention_mask])"),Ie.forEach(t),be=n(ae," or "),te=r(ae,"CODE",{});var P=i(te);Se=n(P,"model([input_values, attention_mask, token_type_ids])"),P.forEach(t),ae.forEach(t),oe=d(S),N=r(S,"LI",{});var re=i(N);ue=n(re,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),se=r(re,"CODE",{});var Ye=i(se);ze=n(Ye,'model({"input_values": input_values, "token_type_ids": token_type_ids})'),Ye.forEach(t),re.forEach(t),S.forEach(t)},m(u,w){h(u,p,w),e(p,y),h(u,f,w),h(u,g,w),e(g,v),e(v,b),e(g,_),e(g,E),e(E,Fe),h(u,de,w),h(u,F,w),e(F,K),e(F,O),e(O,Q),e(F,qe),e(F,I),e(I,Me),e(F,we),h(u,D,w),h(u,L,w),e(L,Z),h(u,_e,w),h(u,q,w),e(q,x),e(x,ce),e(x,ee),e(ee,Te),e(x,pe),e(x,W),e(W,xe),e(q,ke),e(q,M),e(M,Pe),e(M,Y),e(Y,G),e(M,be),e(M,te),e(te,Se),e(q,oe),e(q,N),e(N,ue),e(N,se),e(se,ze)},d(u){u&&t(p),u&&t(f),u&&t(g),u&&t(de),u&&t(F),u&&t(D),u&&t(L),u&&t(_e),u&&t(q)}}}function Qi(A){let p,y,f,g,v;return{c(){p=a("p"),y=s("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=a("code"),g=s("Module"),v=s(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(b){p=r(b,"P",{});var _=i(p);y=n(_,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=r(_,"CODE",{});var E=i(f);g=n(E,"Module"),E.forEach(t),v=n(_,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),_.forEach(t)},m(b,_){h(b,p,_),e(p,y),e(p,f),e(f,g),e(p,v)},d(b){b&&t(p)}}}function Zi(A){let p,y,f,g,v,b,_,E,Fe,de,F,K,O,Q,qe,I,Me,we,D,L,Z,_e,q,x,ce,ee,Te,pe,W,xe,ke,M,Pe,Y,G,be,te,Se,oe,N,ue,se,ze,u,w,ve,ye,Ue,B,Oe,ne,he,S,z,Ke,De,ae,Ie,P,re,Ye,Ge,Ys,_o,Gs,Js,Tt,Xs,Qs,Zs,Je,en,bo,tn,on,vo,sn,nn,an,Oo,rn,ln,kt,ms,Xe,lt,Io,$t,dn,Lo,cn,fs,ie,Ct,pn,Ht,un,jt,hn,mn,fn,Et,gn,yo,_n,bn,vn,Ft,yn,qt,wn,Tn,kn,me,Mt,$n,Qe,Cn,wo,Hn,jn,Wo,En,Fn,qn,dt,Mn,No,xn,Pn,xt,gs,Ze,ct,Bo,Pt,Sn,Ro,zn,_s,le,St,Dn,et,An,Vo,On,In,zt,Ln,Wn,Nn,Dt,Bn,To,Rn,Vn,Un,At,Kn,Ot,Yn,Gn,Jn,J,It,Xn,tt,Qn,ko,Zn,ea,Uo,ta,oa,sa,pt,na,Ko,aa,ra,Lt,ia,Wt,bs,ot,ut,Yo,Nt,la,Go,da,vs,R,Bt,ca,Jo,pa,ua,Rt,ha,Vt,ma,fa,ga,Ut,_a,$o,ba,va,ya,Kt,wa,Yt,Ta,ka,$a,X,Gt,Ca,st,Ha,Co,ja,Ea,Xo,Fa,qa,Ma,ht,xa,Qo,Pa,Sa,Jt,za,Xt,ys,nt,mt,Zo,Qt,Da,es,Aa,ws,V,Zt,Oa,ts,Ia,La,eo,Wa,Ho,Na,Ba,Ra,to,Va,oo,Ua,Ka,Ya,ft,Ga,fe,so,Ja,at,Xa,jo,Qa,Za,os,er,tr,or,gt,sr,ss,nr,ar,no,Ts,rt,_t,ns,ao,rr,as,ir,ks,U,ro,lr,io,dr,rs,cr,pr,ur,lo,hr,Eo,mr,fr,gr,co,_r,po,br,vr,yr,bt,wr,ge,uo,Tr,it,kr,Fo,$r,Cr,is,Hr,jr,Er,vt,Fr,ls,qr,Mr,ho,$s;return b=new wt({}),Q=new wt({}),z=new wt({}),re=new Ae({props:{name:"class transformers.HubertConfig",anchor:"transformers.HubertConfig",parameters:[{name:"vocab_size",val:" = 32"},{name:"hidden_size",val:" = 768"},{name:"num_hidden_layers",val:" = 12"},{name:"num_attention_heads",val:" = 12"},{name:"intermediate_size",val:" = 3072"},{name:"hidden_act",val:" = 'gelu'"},{name:"hidden_dropout",val:" = 0.1"},{name:"activation_dropout",val:" = 0.1"},{name:"attention_dropout",val:" = 0.1"},{name:"feat_proj_layer_norm",val:" = True"},{name:"feat_proj_dropout",val:" = 0.0"},{name:"final_dropout",val:" = 0.1"},{name:"layerdrop",val:" = 0.1"},{name:"initializer_range",val:" = 0.02"},{name:"layer_norm_eps",val:" = 1e-05"},{name:"feat_extract_norm",val:" = 'group'"},{name:"feat_extract_activation",val:" = 'gelu'"},{name:"conv_dim",val:" = (512, 512, 512, 512, 512, 512, 512)"},{name:"conv_stride",val:" = (5, 2, 2, 2, 2, 2, 2)"},{name:"conv_kernel",val:" = (10, 3, 3, 3, 3, 2, 2)"},{name:"conv_bias",val:" = False"},{name:"num_conv_pos_embeddings",val:" = 128"},{name:"num_conv_pos_embedding_groups",val:" = 16"},{name:"do_stable_layer_norm",val:" = False"},{name:"apply_spec_augment",val:" = True"},{name:"mask_time_prob",val:" = 0.05"},{name:"mask_time_length",val:" = 10"},{name:"mask_time_min_masks",val:" = 2"},{name:"mask_feature_prob",val:" = 0.0"},{name:"mask_feature_length",val:" = 10"},{name:"mask_feature_min_masks",val:" = 0"},{name:"ctc_loss_reduction",val:" = 'sum'"},{name:"ctc_zero_infinity",val:" = False"},{name:"use_weighted_layer_sum",val:" = False"},{name:"classifier_proj_size",val:" = 256"},{name:"pad_token_id",val:" = 0"},{name:"bos_token_id",val:" = 1"},{name:"eos_token_id",val:" = 2"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/doc-build-test/src/transformers/models/hubert/configuration_hubert.py#L29",parametersDescription:[{anchor:"transformers.HubertConfig.vocab_size",description:`<strong>vocab_size</strong> (<code>int</code>, <em>optional</em>, defaults to 32) &#x2014;
Vocabulary size of the Hubert model. Defines the number of different tokens that can be represented by the
<code>inputs_ids</code> passed when calling <a href="/docs/transformers/doc-build-test/en/model_doc/hubert#transformers.HubertModel">HubertModel</a>. Vocabulary size of the model. Defines the different
...
instance of <a href="/docs/transformers/doc-build-test/en/model_doc/hubert#transformers.HubertForCTC">HubertForCTC</a>.`,name:"ctc_loss_reduction"},{anchor:"transformers.HubertConfig.ctc_zero_infinity",description:`<strong>ctc_zero_infinity</strong> (<code>bool</code>, <em>optional</em>, defaults to <code>False</code>) &#x2014;
Whether to zero infinite losses and the associated gradients of <code>torch.nn.CTCLoss</code>. Infinite losses mainly
occur when the inputs are too short to be aligned to the targets. Only relevant when training an instance
of <a href="/docs/transformers/doc-build-test/en/model_doc/hubert#transformers.HubertForCTC">HubertForCTC</a>.`,name:"ctc_zero_infinity"},{anchor:"transformers.HubertConfig.use_weighted_layer_sum",description:`<strong>use_weighted_layer_sum</strong> (<code>bool</code>, <em>optional</em>, defaults to <code>False</code>) &#x2014;
...
elements depending on the configuration (<a
  href="/docs/transformers/doc-build-test/en/model_doc/hubert#transformers.HubertConfig"
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/doc-build-test/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),Gt=new Ae({props:{name:"forward",anchor:"transformers.HubertForSequenceClassification.forward",parameters:[{name:"input_values",val:""},{name:"attention_mask",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"},{name:"labels",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/doc-build-test/src/transformers/models/hubert/modeling_hubert.py#L1262",parametersDescription:[{anchor:"transformers.HubertForSequenceClassification.forward.input_values",description:`<strong>input_values</strong> (<code>torch.FloatTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Float values of input raw speech waveform. Values can be obtained by loading a <em>.flac</em> or <em>.wav</em> audio file
into an array of type <em>List[float]</em> or a <em>numpy.ndarray</em>, <em>e.g.</em> via the soundfile library (<em>pip install
soundfile</em>). To prepare the array into <em>input_values</em>, the <a href="/docs/transformers/doc-build-test/en/model_doc/wav2vec2#transformers.Wav2Vec2Processor">Wav2Vec2Processor</a> should be used for padding
...
`}}),ht=new go({props:{$$slots:{default:[Yi]},$$scope:{ctx:A}}}),Jt=new yt({props:{code:`from transformers import Wav2Vec2FeatureExtractor, HubertForSequenceClassification
from datasets import load_dataset
import torch
...
<span class="hljs-meta">&gt;&gt;&gt; </span>loss = model(**inputs).loss
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-built_in">round</span>(loss.item(), <span class="hljs-number">2</span>)
<span class="hljs-number">8.53</span>`}}),Qt=new wt({}),Zt=new Ae({props:{name:"class transformers.TFHubertModel",anchor:"transformers.TFHubertModel",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/doc-build-test/src/transformers/models/hubert/modeling_tf_hubert.py#L1402",parametersDescription:[{anchor:"transformers.TFHubertModel.config",description:`<strong>config</strong> (<a href="/docs/transformers/doc-build-test/en/model_doc/hubert#transformers.HubertConfig">HubertConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/doc-build-test/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),ft=new go({props:{$$slots:{default:[Gi]},$$scope:{ctx:A}}}),so=new Ae({props:{name:"call",anchor:"transformers.TFHubertModel.call",parameters:[{name:"input_values",val:": Tensor"},{name:"attention_mask",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"token_type_ids",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"position_ids",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"head_mask",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"inputs_embeds",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"training",val:": bool = False"}],source:"https://github.com/huggingface/transformers/blob/doc-build-test/src/transformers/models/hubert/modeling_tf_hubert.py#L1408",parametersDescription:[{anchor:"transformers.TFHubertModel.call.input_values",description:`<strong>input_values</strong> (<code>np.ndarray</code>, <code>tf.Tensor</code>, <code>List[tf.Tensor]</code> \`<code>Dict[str, tf.Tensor]</code> or <code>Dict[str, np.ndarray]</code> and each example must have the shape <code>({0})</code>) &#x2014;
...
<span class="hljs-meta">&gt;&gt;&gt; </span>hidden_states = model(input_values).last_hidden_state`}}),ao=new wt({}),ro=new Ae({props:{name:"class transformers.TFHubertForCTC",anchor:"transformers.TFHubertForCTC",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/doc-build-test/src/transformers/models/hubert/modeling_tf_hubert.py#L1500",parametersDescription:[{anchor:"transformers.TFHubertForCTC.config",description:`<strong>config</strong> (<a href="/docs/transformers/doc-build-test/en/model_doc/hubert#transformers.HubertConfig">HubertConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/doc-build-test/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),bt=new go({props:{$$slots:{default:[Xi]},$$scope:{ctx:A}}}),uo=new Ae({props:{name:"call",anchor:"transformers.TFHubertForCTC.call",parameters:[{name:"input_values",val:": Tensor"},{name:"attention_mask",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"token_type_ids",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"position_ids",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"head_mask",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"inputs_embeds",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"labels",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"training",val:": typing.Optional[bool] = False"}],source:"https://github.com/huggingface/transformers/blob/doc-build-test/src/transformers/models/hubert/modeling_tf_hubert.py#L1527",parametersDescription:[{anchor:"transformers.TFHubertForCTC.call.input_values",description:`<strong>input_values</strong> (<code>np.ndarray</code>, <code>tf.Tensor</code>, <code>List[tf.Tensor]</code> \`<code>Dict[str, tf.Tensor]</code> or <code>Dict[str, np.ndarray]</code> and each example must have the shape <code>({0})</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/doc-build-test/en/model_doc/bert#transformers.BertTokenizer">BertTokenizer</a>. See <a href="/docs/transformers/doc-build-test/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
<a href="/docs/transformers/doc-build-test/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> for details.</p>
...
`}}),vt=new go({props:{$$slots:{default:[Qi]},$$scope:{ctx:A}}}),ho=new yt({props:{code:`import tensorflow as tf
...
using `),ue=a("a"),se=s("Wav2Vec2CTCTokenizer"),ze=s("."),u=l(),w=a("p"),ve=s("This model was contributed by "),ye=a("a"),Ue=s("patrickvonplaten"),B=s("."),Oe=l(),ne=a("h2"),he=a("a"),S=a("span"),T(z.$$.fragment),Ke=l(),De=a("span"),ae=s("HubertConfig"),Ie=l(),P=a("div"),T(re.$$.fragment),Ye=l(),Ge=a("p"),Ys=s("This is the configuration class to store the configuration of a "),_o=a("a"),Gs=s("HubertModel"),Js=s(`. It is used to instantiate an
...
documentation from `),vo=a("a"),sn=s("PretrainedConfig"),nn=s(" for more information."),an=l(),Oo=a("p"),rn=s("Example:"),ln=l(),T(kt.$$.fragment),ms=l(),Xe=a("h2"),lt=a("a"),Io=a("span"),T($t.$$.fragment),dn=l(),Lo=a("span"),cn=s("HubertModel"),fs=l(),ie=a("div"),T(Ct.$$.fragment),pn=l(),Ht=a("p"),un=s(`The bare Hubert Model transformer outputting raw hidden-states without any specific head on top.
Hubert was proposed in `),jt=a("a"),hn=s(`HuBERT: Self-Supervised Speech Representation Learning by Masked Prediction of Hidden
...
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),$a=l(),X=a("div"),T(Gt.$$.fragment),Ca=l(),st=a("p"),Ha=s("The "),Co=a("a"),ja=s("HubertForSequenceClassification"),Ea=s(" forward method, overrides the "),Xo=a("code"),Fa=s("__call__"),qa=s(" special method."),Ma=l(),T(ht.$$.fragment),xa=l(),Qo=a("p"),Pa=s("Example:"),Sa=l(),T(Jt.$$.fragment),za=l(),T(Xt.$$.fragment),ys=l(),nt=a("h2"),mt=a("a"),Zo=a("span"),T(Qt.$$.fragment),Da=l(),es=a("span"),Aa=s("TFHubertModel"),ws=l(),V=a("div"),T(Zt.$$.fragment),Oa=l(),ts=a("p"),Ia=s("The bare TFHubert Model transformer outputing raw hidden-states without any specific head on top."),La=l(),eo=a("p"),Wa=s("This model inherits from "),Ho=a("a"),Na=s("TFPreTrainedModel"),Ba=s(`. Check the superclass documentation for the generic methods the
...
using `),ue=r(js,"A",{href:!0});var Ir=i(ue);se=n(Ir,"Wav2Vec2CTCTokenizer"),Ir.forEach(t),ze=n(js,"."),js.forEach(t),Hs.forEach(t),u=d(o),w=r(o,"P",{});var Es=i(w);ve=n(Es,"This model was contributed by "),ye=r(Es,"A",{href:!0,rel:!0});var Lr=i(ye);Ue=n(Lr,"patrickvonplaten"),Lr.forEach(t),B=n(Es,"."),Es.forEach(t),Oe=d(o),ne=r(o,"H2",{class:!0});var Fs=i(ne);he=r(Fs,"A",{id:!0,class:!0,href:!0});var Wr=i(he);S=r(Wr,"SPAN",{});var Nr=i(S);k(z.$$.fragment,Nr),Nr.forEach(t),Wr.forEach(t),Ke=d(Fs),De=r(Fs,"SPAN",{});var Br=i(De);ae=n(Br,"HubertConfig"),Br.forEach(t),Fs.forEach(t),Ie=d(o),P=r(o,"DIV",{class:!0});var Le=i(P);k(re.$$.fragment,Le),Ye=d(Le),Ge=r(Le,"P",{});var qo=i(Ge);Ys=n(qo,"This is the configuration class to store the configuration of a "),_o=r(qo,"A",{href:!0});var Rr=i(_o);Gs=n(Rr,"HubertModel"),Rr.forEach(t),Js=n(qo,`. It is used to instantiate an
Hubert model according to the specified arguments, defining the model architecture. Instantiating a configuration
with the defaults will yield a similar configuration to that of the Hubert
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Ks.forEach(t),yr=d(Ee),k(bt.$$.fragment,Ee),wr=d(Ee),ge=r(Ee,"DIV",{class:!0});var Ve=i(ge);k(uo.$$.fragment,Ve),Tr=d(Ve),it=r(Ve,"P",{});var Ao=i(it);kr=n(Ao,"The "),Fo=r(Ao,"A",{href:!0});var Ii=i(Fo);$r=n(Ii,"TFHubertForCTC"),Ii.forEach(t),Cr=n(Ao," forward method, overrides the "),is=r(Ao,"CODE",{});var Li=i(is);Hr=n(Li,"__call__"),Li.forEach(t),jr=n(Ao," special method."),Ao.forEach(t),Er=d(Ve),k(vt.$$.fragment,Ve),Fr=d(Ve),ls=r(Ve,"P",{});var Wi=i(ls);qr=n(Wi,"Example:"),Wi.forEach(t),Mr=d(Ve),k(ho.$$.fragment,Ve),Ve.forEach(t),Ee.forEach(t),this.h()},h(){c(p,"name","hf:doc:metadata"),c(p,"content",JSON.stringify(el)),c(g,"id","hubert"),c(g,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(g,"href","#hubert"),c(f,"class","relative group"),c(K,"id","overview"),c(K,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(K,"href","#overview"),c(F,"class","relative group"),c(Z,"href","https://arxiv.org/abs/2106.07447"),c(Z,"rel","nofollow"),c(ue,"href","/docs/transformers/doc-build-test/en/model_doc/wav2vec2#transformers.Wav2Vec2CTCTokenizer"),c(ye,"href","https://huggingface.co/patrickvonplaten"),c(ye,"rel","nofollow"),c(he,"id","transformers.HubertConfig"),c(he,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(he,"href","#transformers.HubertConfig"),c(ne,"class","relative group"),c(_o,"href","/docs/transformers/doc-build-test/en/model_doc/hubert#transformers.HubertModel"),c(Tt,"href","https://huggingface.co/facebook/hubert-base-ls960"),c(Tt,"rel","nofollow"),c(bo,"href","/docs/transformers/doc-build-test/en/main_classes/configuration#transformers.PretrainedConfig"),c(vo,"href","/docs/transformers/doc-build-test/en/main_classes/configuration#transformers.PretrainedConfig"),c(P,"class","docstring"),c(lt,"id","transformers.HubertModel"),c(lt,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(lt,"href","#transformers.HubertModel"),c(Xe,"class","relative group"),c(jt,"href","https://arxiv.org/abs/2106.07447"),c(jt,"rel","nofollow"),c(yo,"href","/docs/transformers/doc-build-test/en/main_classes/model#transformers.PreTrainedModel"),c(qt,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),c(qt,"rel","nofollow"),c(wo,"href","/docs/transformers/doc-build-test/en/model_doc/hubert#transformers.HubertModel"),c(me,"class","docstring"),c(ie,"class","docstring"),c(ct,"id","transformers.HubertForCTC"),c(ct,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(ct,"href","#transformers.HubertForCTC"),c(Ze,"class","relative group"),c(zt,"href","https://arxiv.org/abs/2106.07447"),c(zt,"rel","nofollow"),c(To,"href","/docs/transformers/doc-build-test/en/main_classes/model#transformers.PreTrainedModel"),c(Ot,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),c(Ot,"rel","nofollow"),c(ko,"href","/docs/transformers/doc-build-test/en/model_doc/hubert#transformers.HubertForCTC"),c(J,"class","docstring"),c(le,"class","docstring"),c(ut,"id","transformers.HubertForSequenceClassification"),c(ut,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(ut,"href","#transformers.HubertForSequenceClassification"),c(ot,"class","relative group"),c(Vt,"href","https://arxiv.org/abs/2106.07447"),c(Vt,"rel","nofollow"),c($o,"href","/docs/transformers/doc-build-test/en/main_classes/model#transformers.PreTrainedModel"),c(Yt,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),c(Yt,"rel","nofollow"),c(Co,"href","/docs/transformers/doc-build-test/en/model_doc/hubert#transformers.HubertForSequenceClassification"),c(X,"class","docstring"),c(R,"class","docstring"),c(mt,"id","transformers.TFHubertModel"),c(mt,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(mt,"href","#transformers.TFHubertModel"),c(nt,"class","relative group"),c(Ho,"href","/docs/transformers/doc-build-test/en/main_classes/model#transformers.TFPreTrainedModel"),c(oo,"href","https://www.tensorflow.org/api_docs/python/tf/keras/Model"),c(oo,"rel","nofollow"),c(jo,"href","/docs/transformers/doc-build-test/en/model_doc/hubert#transformers.TFHubertModel"),c(fe,"class","docstring"),c(V,"class","docstring"),c(_t,"id","transformers.TFHubertForCTC"),c(_t,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(_t,"href","#transformers.TFHubertForCTC"),c(rt,"class","relative group"),c(Eo,"href","/docs/transformers/doc-build-test/en/main_classes/model#transformers.TFPreTrainedModel"),c(po,"href","https://www.tensorflow.org/api_docs/python/tf/keras/Model"),c(po,"rel","nofollow"),c(Fo,"href","/docs/transformers/doc-build-test/en/model_doc/hubert#transformers.TFHubertForCTC"),c(ge,"class","docstring"),c(U,"class","docstring")},m(o,m){e(document.head,p),h(o,y,m),h(o,f,m),e(f,g),e(g,v),$(b,v,null),e(f,_),e(f,E),e(E,Fe),h(o,de,m),h(o,F,m),e(F,K),e(K,O),$(Q,O,null),e(F,qe),e(F,I),e(I,Me),h(o,we,m),h(o,D,m),e(D,L),e(D,Z),e(Z,_e),e(D,q),h(o,x,m),h(o,ce,m),e(ce,ee),h(o,Te,m),h(o,pe,m),e(pe,W),e(W,xe),h(o,ke,m),h(o,M,m),e(M,Pe),h(o,Y,m),h(o,G,m),e(G,be),e(be,te),e(G,Se),e(G,oe),e(oe,N),e(oe,ue),e(ue,se),e(oe,ze),h(o,u,m),h(o,w,m),e(w,ve),e(w,ye),e(ye,Ue),e(w,B),h(o,Oe,m),h(o,ne,m),e(ne,he),e(he,S),$(z,S,null),e(ne,Ke),e(ne,De),e(De,ae),h(o,Ie,m),h(o,P,m),$(re,P,null),e(P,Ye),e(P,Ge),e(Ge,Ys),e(Ge,_o),e(_o,Gs),e(Ge,Js),e(Ge,Tt),e(Tt,Xs),e(Ge,Qs),e(P,Zs),e(P,Je),e(Je,en),e(Je,bo),e(bo,tn),e(Je,on),e(Je,vo),e(vo,sn),e(Je,nn),e(P,an),e(P,Oo),e(Oo,rn),e(P,ln),$(kt,P,null),h(o,ms,m),h(o,Xe,m),e(Xe,lt),e(lt,Io),$($t,Io,null),e(Xe,dn),e(Xe,Lo),e(Lo,cn),h(o,fs,m),h(o,ie,m),$(Ct,ie,null),e(ie,pn),e(ie,Ht),e(Ht,un),e(Ht,jt),e(jt,hn),e(Ht,mn),e(ie,fn),e(ie,Et),e(Et,gn),e(Et,yo),e(yo,_n),e(Et,bn),e(ie,vn),e(ie,Ft),e(Ft,yn),e(Ft,qt),e(qt,wn),e(Ft,Tn),e(ie,kn),e(ie,me),$(Mt,me,null),e(me,$n),e(me,Qe),e(Qe,Cn),e(Qe,wo),e(wo,Hn),e(Qe,jn),e(Qe,Wo),e(Wo,En),e(Qe,Fn),e(me,qn),$(dt,me,null),e(me,Mn),e(me,No),e(No,xn),e(me,Pn),$(xt,me,null),h(o,gs,m),h(o,Ze,m),e(Ze,ct),e(ct,Bo),$(Pt,Bo,null),e(Ze,Sn),e(Ze,Ro),e(Ro,zn),h(o,_s,m),h(o,le,m),$(St,le,null),e(le,Dn),e(le,et),e(et,An),e(et,Vo),e(Vo,On),e(et,In),e(et,zt),e(zt,Ln),e(et,Wn),e(le,Nn),e(le,Dt),e(Dt,Bn),e(Dt,To),e(To,Rn),e(Dt,Vn),e(le,Un),e(le,At),e(At,Kn),e(At,Ot),e(Ot,Yn),e(At,Gn),e(le,Jn),e(le,J),$(It,J,null),e(J,Xn),e(J,tt),e(tt,Qn),e(tt,ko),e(ko,Zn),e(tt,ea),e(tt,Uo),e(Uo,ta),e(tt,oa),e(J,sa),$(pt,J,null),e(J,na),e(J,Ko),e(Ko,aa),e(J,ra),$(Lt,J,null),e(J,ia),$(Wt,J,null),h(o,bs,m),h(o,ot,m),e(ot,ut),e(ut,Yo),$(Nt,Yo,null),e(ot,la),e(ot,Go),e(Go,da),h(o,vs,m),h(o,R,m),$(Bt,R,null),e(R,ca),e(R,Jo),e(Jo,pa),e(R,ua),e(R,Rt),e(Rt,ha),e(Rt,Vt),e(Vt,ma),e(Rt,fa),e(R,ga),e(R,Ut),e(Ut,_a),e(Ut,$o),e($o,ba),e(Ut,va),e(R,ya),e(R,Kt),e(Kt,wa),e(Kt,Yt),e(Yt,Ta),e(Kt,ka),e(R,$a),e(R,X),$(Gt,X,null),e(X,Ca),e(X,st),e(st,Ha),e(st,Co),e(Co,ja),e(st,Ea),e(st,Xo),e(Xo,Fa),e(st,qa),e(X,Ma),$(ht,X,null),e(X,xa),e(X,Qo),e(Qo,Pa),e(X,Sa),$(Jt,X,null),e(X,za),$(Xt,X,null),h(o,ys,m),h(o,nt,m),e(nt,mt),e(mt,Zo),$(Qt,Zo,null),e(nt,Da),e(nt,es),e(es,Aa),h(o,ws,m),h(o,V,m),$(Zt,V,null),e(V,Oa),e(V,ts),e(ts,Ia),e(V,La),e(V,eo),e(eo,Wa),e(eo,Ho),e(Ho,Na),e(eo,Ba),e(V,Ra),e(V,to),e(to,Va),e(to,oo),e(oo,Ua),e(to,Ka),e(V,Ya),$(ft,V,null),e(V,Ga),e(V,fe),$(so,fe,null),e(fe,Ja),e(fe,at),e(at,Xa),e(at,jo),e(jo,Qa),e(at,Za),e(at,os),e(os,er),e(at,tr),e(fe,or),$(gt,fe,null),e(fe,sr),e(fe,ss),e(ss,nr),e(fe,ar),$(no,fe,null),h(o,Ts,m),h(o,rt,m),e(rt,_t),e(_t,ns),$(ao,ns,null),e(rt,rr),e(rt,as),e(as,ir),h(o,ks,m),h(o,U,m),$(ro,U,null),e(U,lr),e(U,io),e(io,dr),e(io,rs),e(rs,cr),e(io,pr),e(U,ur),e(U,lo),e(lo,hr),e(lo,Eo),e(Eo,mr),e(lo,fr),e(U,gr),e(U,co),e(co,_r),e(co,po),e(po,br),e(co,vr),e(U,yr),$(bt,U,null),e(U,wr),e(U,ge),$(uo,ge,null),e(ge,Tr),e(ge,it),e(it,kr),e(it,Fo),e(Fo,$r),e(it,Cr),e(it,is),e(is,Hr),e(it,jr),e(ge,Er),$(vt,ge,null),e(ge,Fr),e(ge,ls),e(ls,qr),e(ge,Mr),$(ho,ge,null),$s=!0},p(o,[m]){const mo={};m&2&&(mo.$$scope={dirty:m,ctx:o}),dt.$set(mo);const ds={};m&2&&(ds.$$scope={dirty:m,ctx:o}),pt.$set(ds);const cs={};m&2&&(cs.$$scope={dirty:m,ctx:o}),ht.$set(cs);const ps={};m&2&&(ps.$$scope={dirty:m,ctx:o}),ft.$set(ps);const fo={};m&2&&(fo.$$scope={dirty:m,ctx:o}),gt.$set(fo);const us={};m&2&&(us.$$scope={dirty:m,ctx:o}),bt.$set(us);const hs={};m&2&&(hs.$$scope={dirty:m,ctx:o}),vt.$set(hs)},i(o){$s||(C(b.$$.fragment,o),C(Q.$$.fragment,o),C(z.$$.fragment,o),C(re.$$.fragment,o),C(kt.$$.fragment,o),C($t.$$.fragment,o),C(Ct.$$.fragment,o),C(Mt.$$.fragment,o),C(dt.$$.fragment,o),C(xt.$$.fragment,o),C(Pt.$$.fragment,o),C(St.$$.fragment,o),C(It.$$.fragment,o),C(pt.$$.fragment,o),C(Lt.$$.fragment,o),C(Wt.$$.fragment,o),C(Nt.$$.fragment,o),C(Bt.$$.fragment,o),C(Gt.$$.fragment,o),C(ht.$$.fragment,o),C(Jt.$$.fragment,o),C(Xt.$$.fragment,o),C(Qt.$$.fragment,o),C(Zt.$$.fragment,o),C(ft.$$.fragment,o),C(so.$$.fragment,o),C(gt.$$.fragment,o),C(no.$$.fragment,o),C(ao.$$.fragment,o),C(ro.$$.fragment,o),C(bt.$$.fragment,o),C(uo.$$.fragment,o),C(vt.$$.fragment,o),C(ho.$$.fragment,o),$s=!0)},o(o){H(b.$$.fragment,o),H(Q.$$.fragment,o),H(z.$$.fragment,o),H(re.$$.fragment,o),H(kt.$$.fragment,o),H($t.$$.fragment,o),H(Ct.$$.fragment,o),H(Mt.$$.fragment,o),H(dt.$$.fragment,o),H(xt.$$.fragment,o),H(Pt.$$.fragment,o),H(St.$$.fragment,o),H(It.$$.fragment,o),H(pt.$$.fragment,o),H(Lt.$$.fragment,o),H(Wt.$$.fragment,o),H(Nt.$$.fragment,o),H(Bt.$$.fragment,o),H(Gt.$$.fragment,o),H(ht.$$.fragment,o),H(Jt.$$.fragment,o),H(Xt.$$.fragment,o),H(Qt.$$.fragment,o),H(Zt.$$.fragment,o),H(ft.$$.fragment,o),H(so.$$.fragment,o),H(gt.$$.fragment,o),H(no.$$.fragment,o),H(ao.$$.fragment,o),H(ro.$$.fragment,o),H(bt.$$.fragment,o),H(uo.$$.fragment,o),H(vt.$$.fragment,o),H(ho.$$.fragment,o),$s=!1},d(o){t(p),o&&t(y),o&&t(f),j(b),o&&t(de),o&&t(F),j(Q),o&&t(we),o&&t(D),o&&t(x),o&&t(ce),o&&t(Te),o&&t(pe),o&&t(ke),o&&t(M),o&&t(Y),o&&t(G),o&&t(u),o&&t(w),o&&t(Oe),o&&t(ne),j(z),o&&t(Ie),o&&t(P),j(re),j(kt),o&&t(ms),o&&t(Xe),j($t),o&&t(fs),o&&t(ie),j(Ct),j(Mt),j(dt),j(xt),o&&t(gs),o&&t(Ze),j(Pt),o&&t(_s),o&&t(le),j(St),j(It),j(pt),j(Lt),j(Wt),o&&t(bs),o&&t(ot),j(Nt),o&&t(vs),o&&t(R),j(Bt),j(Gt),j(ht),j(Jt),j(Xt),o&&t(ys),o&&t(nt),j(Qt),o&&t(ws),o&&t(V),j(Zt),j(ft),j(so),j(gt),j(no),o&&t(Ts),o&&t(rt),j(ao),o&&t(ks),o&&t(U),j(ro),j(bt),j(uo),j(vt),j(ho)}}}const el={local:"hubert",sections:[{local:"overview",title:"Overview"},{local:"transformers.HubertConfig",title:"HubertConfig"},{local:"transformers.HubertModel",title:"HubertModel"},{local:"transformers.HubertForCTC",title:"HubertForCTC"},{local:"transformers.HubertForSequenceClassification",title:"HubertForSequenceClassification"},{local:"transformers.TFHubertModel",title:"TFHubertModel"},{local:"transformers.TFHubertForCTC",title:"TFHubertForCTC"}],title:"Hubert"};function tl(A,p,y){let{fw:f}=p;return A.$$set=g=>{"fw"in g&&y(0,f=g.fw)},[f]}class ll extends Ni{constructor(p){super();Bi(this,p,tl,Zi,Ri,{fw:0})}}export{ll as default,el as metadata};
