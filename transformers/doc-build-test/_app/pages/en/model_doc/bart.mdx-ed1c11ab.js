import{S as XT,i as KT,s as ZT,e as n,k as d,w as m,t as r,L as YT,c as a,d as t,m as l,a as s,x as f,h as i,b as c,J as e,g as h,y as _,q as g,o as b,B as k}from"../../../chunks/vendor-9e2b328e.js";import{T as De}from"../../../chunks/Tip-76f97a76.js";import{D as F}from"../../../chunks/Docstring-50fd6873.js";import{C as P}from"../../../chunks/CodeBlock-b9ff96e9.js";import{I as J}from"../../../chunks/IconCopyLink-fd0e58fd.js";import"../../../chunks/CopyButton-4b97cbf7.js";function ew(j){let p,q,y,w,x;return{c(){p=n("p"),q=r("When used with "),y=n("code"),w=r("is_split_into_words=True"),x=r(", this tokenizer will add a space before each word (even the first one).")},l(T){p=a(T,"P",{});var v=s(p);q=i(v,"When used with "),y=a(v,"CODE",{});var B=s(y);w=i(B,"is_split_into_words=True"),B.forEach(t),x=i(v,", this tokenizer will add a space before each word (even the first one)."),v.forEach(t)},m(T,v){h(T,p,v),e(p,q),e(p,y),e(y,w),e(p,x)},d(T){T&&t(p)}}}function tw(j){let p,q,y,w,x,T,v,B;return{c(){p=n("p"),q=r("When used with "),y=n("code"),w=r("is_split_into_words=True"),x=r(", this tokenizer needs to be instantiated with "),T=n("code"),v=r("add_prefix_space=True"),B=r(".")},l(ne){p=a(ne,"P",{});var A=s(p);q=i(A,"When used with "),y=a(A,"CODE",{});var $=s(y);w=i($,"is_split_into_words=True"),$.forEach(t),x=i(A,", this tokenizer needs to be instantiated with "),T=a(A,"CODE",{});var le=s(T);v=i(le,"add_prefix_space=True"),le.forEach(t),B=i(A,"."),A.forEach(t)},m(ne,A){h(ne,p,A),e(p,q),e(p,y),e(y,w),e(p,x),e(p,T),e(T,v),e(p,B)},d(ne){ne&&t(p)}}}function ow(j){let p,q,y,w,x;return{c(){p=n("p"),q=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),y=n("code"),w=r("Module"),x=r(`
...
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),v.forEach(t)},m(T,v){h(T,p,v),e(p,q),e(p,y),e(y,w),e(p,x)},d(T){T&&t(p)}}}function nw(j){let p,q,y,w,x;return{c(){p=n("p"),q=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),y=n("code"),w=r("Module"),x=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(T){p=a(T,"P",{});var v=s(p);q=i(v,"Although the recipe for forward pass needs to be defined within this function, one should call the "),y=a(v,"CODE",{});var B=s(y);w=i(B,"Module"),B.forEach(t),x=i(v,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),v.forEach(t)},m(T,v){h(T,p,v),e(p,q),e(p,y),e(y,w),e(p,x)},d(T){T&&t(p)}}}function aw(j){let p,q,y,w,x;return{c(){p=n("p"),q=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),y=n("code"),w=r("Module"),x=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(T){p=a(T,"P",{});var v=s(p);q=i(v,"Although the recipe for forward pass needs to be defined within this function, one should call the "),y=a(v,"CODE",{});var B=s(y);w=i(B,"Module"),B.forEach(t),x=i(v,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),v.forEach(t)},m(T,v){h(T,p,v),e(p,q),e(p,y),e(y,w),e(p,x)},d(T){T&&t(p)}}}function sw(j){let p,q,y,w,x;return{c(){p=n("p"),q=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),y=n("code"),w=r("Module"),x=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(T){p=a(T,"P",{});var v=s(p);q=i(v,"Although the recipe for forward pass needs to be defined within this function, one should call the "),y=a(v,"CODE",{});var B=s(y);w=i(B,"Module"),B.forEach(t),x=i(v,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),v.forEach(t)},m(T,v){h(T,p,v),e(p,q),e(p,y),e(y,w),e(p,x)},d(T){T&&t(p)}}}function rw(j){let p,q,y,w,x,T,v,B,ne,A,$,le,_e,Ke,ge,be,Ze,Je,H,N,Le,ae,C,S,Ye,ce,pe,et,Q,tt,ot,D,Be,ke,Xe,X,se,nt,at,V,st,ye,Ge;return{c(){p=n("p"),q=r("TF 2.0 models accepts two formats as inputs:"),y=d(),w=n("ul"),x=n("li"),T=r("having all inputs as keyword arguments (like PyTorch models), or"),v=d(),B=n("li"),ne=r("having all inputs as a list, tuple or dict in the first positional arguments."),A=d(),$=n("p"),le=r("This second option is useful when using "),_e=n("code"),Ke=r("tf.keras.Model.fit"),ge=r(` method which currently requires having all the
tensors in the first argument of the model call function: `),be=n("code"),Ze=r("model(inputs)"),Je=r("."),H=d(),N=n("p"),Le=r(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
...
`),ke=n("code"),Xe=r("model([input_ids, attention_mask])"),X=r(" or "),se=n("code"),nt=r("model([input_ids, attention_mask, token_type_ids])"),at=d(),V=n("li"),st=r(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
...
tensors in the first argument of the model call function: `),be=a(re,"CODE",{});var Re=s(be);Ze=i(Re,"model(inputs)"),Re.forEach(t),Je=i(re,"."),re.forEach(t),H=l(z),N=a(z,"P",{});var Ot=s(N);Le=i(Ot,`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),Ot.forEach(t),ae=l(z),C=a(z,"UL",{});var ie=s(C);S=a(ie,"LI",{});var ue=s(S);Ye=i(ue,"a single Tensor with "),ce=a(ue,"CODE",{});var ve=s(ce);pe=i(ve,"input_ids"),ve.forEach(t),et=i(ue," only and nothing else: "),Q=a(ue,"CODE",{});var Fe=s(Q);tt=i(Fe,"model(input_ids)"),Fe.forEach(t),ue.forEach(t),ot=l(ie),D=a(ie,"LI",{});var de=s(D);Be=i(de,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),ke=a(de,"CODE",{});var Ue=s(ke);Xe=i(Ue,"model([input_ids, attention_mask])"),Ue.forEach(t),X=i(de," or "),se=a(de,"CODE",{});var Nt=s(se);nt=i(Nt,"model([input_ids, attention_mask, token_type_ids])"),Nt.forEach(t),de.forEach(t),at=l(ie),V=a(ie,"LI",{});var He=s(V);st=i(He,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),ye=a(He,"CODE",{});var Dt=s(ye);Ge=i(Dt,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),Dt.forEach(t),He.forEach(t),ie.forEach(t)},m(z,M){h(z,p,M),e(p,q),h(z,y,M),h(z,w,M),e(w,x),e(x,T),e(w,v),e(w,B),e(B,ne),h(z,A,M),h(z,$,M),e($,le),e($,_e),e(_e,Ke),e($,ge),e($,be),e(be,Ze),e($,Je),h(z,H,M),h(z,N,M),e(N,Le),h(z,ae,M),h(z,C,M),e(C,S),e(S,Ye),e(S,ce),e(ce,pe),e(S,et),e(S,Q),e(Q,tt),e(C,ot),e(C,D),e(D,Be),e(D,ke),e(ke,Xe),e(D,X),e(D,se),e(se,nt),e(C,at),e(C,V),e(V,st),e(V,ye),e(ye,Ge)},d(z){z&&t(p),z&&t(y),z&&t(w),z&&t(A),z&&t($),z&&t(H),z&&t(N),z&&t(ae),z&&t(C)}}}function iw(j){let p,q,y,w,x;return{c(){p=n("p"),q=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),y=n("code"),w=r("Module"),x=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(T){p=a(T,"P",{});var v=s(p);q=i(v,"Although the recipe for forward pass needs to be defined within this function, one should call the "),y=a(v,"CODE",{});var B=s(y);w=i(B,"Module"),B.forEach(t),x=i(v,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),v.forEach(t)},m(T,v){h(T,p,v),e(p,q),e(p,y),e(y,w),e(p,x)},d(T){T&&t(p)}}}function dw(j){let p,q,y,w,x,T,v,B,ne,A,$,le,_e,Ke,ge,be,Ze,Je,H,N,Le,ae,C,S,Ye,ce,pe,et,Q,tt,ot,D,Be,ke,Xe,X,se,nt,at,V,st,ye,Ge;return{c(){p=n("p"),q=r("TF 2.0 models accepts two formats as inputs:"),y=d(),w=n("ul"),x=n("li"),T=r("having all inputs as keyword arguments (like PyTorch models), or"),v=d(),B=n("li"),ne=r("having all inputs as a list, tuple or dict in the first positional arguments."),A=d(),$=n("p"),le=r("This second option is useful when using "),_e=n("code"),Ke=r("tf.keras.Model.fit"),ge=r(` method which currently requires having all the
tensors in the first argument of the model call function: `),be=n("code"),Ze=r("model(inputs)"),Je=r("."),H=d(),N=n("p"),Le=r(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),ae=d(),C=n("ul"),S=n("li"),Ye=r("a single Tensor with "),ce=n("code"),pe=r("input_ids"),et=r(" only and nothing else: "),Q=n("code"),tt=r("model(input_ids)"),ot=d(),D=n("li"),Be=r(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),ke=n("code"),Xe=r("model([input_ids, attention_mask])"),X=r(" or "),se=n("code"),nt=r("model([input_ids, attention_mask, token_type_ids])"),at=d(),V=n("li"),st=r(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),ye=n("code"),Ge=r('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(z){p=a(z,"P",{});var M=s(p);q=i(M,"TF 2.0 models accepts two formats as inputs:"),M.forEach(t),y=l(z),w=a(z,"UL",{});var U=s(w);x=a(U,"LI",{});var St=s(x);T=i(St,"having all inputs as keyword arguments (like PyTorch models), or"),St.forEach(t),v=l(U),B=a(U,"LI",{});var We=s(B);ne=i(We,"having all inputs as a list, tuple or dict in the first positional arguments."),We.forEach(t),U.forEach(t),A=l(z),$=a(z,"P",{});var re=s($);le=i(re,"This second option is useful when using "),_e=a(re,"CODE",{});var It=s(_e);Ke=i(It,"tf.keras.Model.fit"),It.forEach(t),ge=i(re,` method which currently requires having all the
...
first positional argument :`),Ot.forEach(t),ae=l(z),C=a(z,"UL",{});var ie=s(C);S=a(ie,"LI",{});var ue=s(S);Ye=i(ue,"a single Tensor with "),ce=a(ue,"CODE",{});var ve=s(ce);pe=i(ve,"input_ids"),ve.forEach(t),et=i(ue," only and nothing else: "),Q=a(ue,"CODE",{});var Fe=s(Q);tt=i(Fe,"model(input_ids)"),Fe.forEach(t),ue.forEach(t),ot=l(ie),D=a(ie,"LI",{});var de=s(D);Be=i(de,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),ke=a(de,"CODE",{});var Ue=s(ke);Xe=i(Ue,"model([input_ids, attention_mask])"),Ue.forEach(t),X=i(de," or "),se=a(de,"CODE",{});var Nt=s(se);nt=i(Nt,"model([input_ids, attention_mask, token_type_ids])"),Nt.forEach(t),de.forEach(t),at=l(ie),V=a(ie,"LI",{});var He=s(V);st=i(He,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),ye=a(He,"CODE",{});var Dt=s(ye);Ge=i(Dt,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),Dt.forEach(t),He.forEach(t),ie.forEach(t)},m(z,M){h(z,p,M),e(p,q),h(z,y,M),h(z,w,M),e(w,x),e(x,T),e(w,v),e(w,B),e(B,ne),h(z,A,M),h(z,$,M),e($,le),e($,_e),e(_e,Ke),e($,ge),e($,be),e(be,Ze),e($,Je),h(z,H,M),h(z,N,M),e(N,Le),h(z,ae,M),h(z,C,M),e(C,S),e(S,Ye),e(S,ce),e(ce,pe),e(S,et),e(S,Q),e(Q,tt),e(C,ot),e(C,D),e(D,Be),e(D,ke),e(ke,Xe),e(D,X),e(D,se),e(se,nt),e(C,at),e(C,V),e(V,st),e(V,ye),e(ye,Ge)},d(z){z&&t(p),z&&t(y),z&&t(w),z&&t(A),z&&t($),z&&t(H),z&&t(N),z&&t(ae),z&&t(C)}}}function lw(j){let p,q,y,w,x;return{c(){p=n("p"),q=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),y=n("code"),w=r("Module"),x=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(T){p=a(T,"P",{});var v=s(p);q=i(v,"Although the recipe for forward pass needs to be defined within this function, one should call the "),y=a(v,"CODE",{});var B=s(y);w=i(B,"Module"),B.forEach(t),x=i(v,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),v.forEach(t)},m(T,v){h(T,p,v),e(p,q),e(p,y),e(y,w),e(p,x)},d(T){T&&t(p)}}}function cw(j){let p,q,y,w,x;return{c(){p=n("p"),q=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),y=n("code"),w=r("Module"),x=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(T){p=a(T,"P",{});var v=s(p);q=i(v,"Although the recipe for forward pass needs to be defined within this function, one should call the "),y=a(v,"CODE",{});var B=s(y);w=i(B,"Module"),B.forEach(t),x=i(v,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),v.forEach(t)},m(T,v){h(T,p,v),e(p,q),e(p,y),e(y,w),e(p,x)},d(T){T&&t(p)}}}function pw(j){let p,q,y,w,x;return{c(){p=n("p"),q=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),y=n("code"),w=r("Module"),x=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(T){p=a(T,"P",{});var v=s(p);q=i(v,"Although the recipe for forward pass needs to be defined within this function, one should call the "),y=a(v,"CODE",{});var B=s(y);w=i(B,"Module"),B.forEach(t),x=i(v,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),v.forEach(t)},m(T,v){h(T,p,v),e(p,q),e(p,y),e(y,w),e(p,x)},d(T){T&&t(p)}}}function uw(j){let p,q,y,w,x;return{c(){p=n("p"),q=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),y=n("code"),w=r("Module"),x=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(T){p=a(T,"P",{});var v=s(p);q=i(v,"Although the recipe for forward pass needs to be defined within this function, one should call the "),y=a(v,"CODE",{});var B=s(y);w=i(B,"Module"),B.forEach(t),x=i(v,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),v.forEach(t)},m(T,v){h(T,p,v),e(p,q),e(p,y),e(y,w),e(p,x)},d(T){T&&t(p)}}}function hw(j){let p,q,y,w,x;return{c(){p=n("p"),q=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),y=n("code"),w=r("Module"),x=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(T){p=a(T,"P",{});var v=s(p);q=i(v,"Although the recipe for forward pass needs to be defined within this function, one should call the "),y=a(v,"CODE",{});var B=s(y);w=i(B,"Module"),B.forEach(t),x=i(v,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),v.forEach(t)},m(T,v){h(T,p,v),e(p,q),e(p,y),e(y,w),e(p,x)},d(T){T&&t(p)}}}function mw(j){let p,q,y,w,x,T,v,B,ne,A,$,le,_e,Ke,ge,be,Ze,Je,H,N,Le,ae,C,S,Ye,ce,pe,et,Q,tt,ot,D,Be,ke,Xe,X,se,nt,at,V,st,ye,Ge,z,M,U,St,We,re,It,Re,Ot,ie,ue,ve,Fe,de,Ue,Nt,He,Dt,yl,ut,un,Xc,hn,Kc,Zc,Yc,rt,ep,Qs,tp,op,Yr,np,ap,mn,sp,rp,ip,vo,fn,dp,lp,_n,cp,pp,vl,Lt,To,ei,gn,up,ti,hp,Tl,$e,it,mp,oi,fp,_p,Vs,gp,bp,Js,kp,yp,vp,Gt,Tp,Xs,wp,xp,ni,zp,qp,Bp,Wt,Fp,ai,$p,jp,si,Mp,Ep,Pp,Ks,Zs,Cp,Ap,Sp,Rt,Ip,ri,Op,Np,ii,Dp,Lp,wl,Ut,wo,di,bn,Gp,li,Wp,xl,ht,Rp,ci,Up,Hp,pi,Qp,Vp,zl,kn,ql,Ht,xo,ui,yn,Jp,hi,Xp,Bl,Te,vn,Kp,Qt,Zp,Ys,Yp,eu,Tn,tu,ou,nu,Vt,au,er,su,ru,tr,iu,du,lu,mi,cu,pu,wn,Fl,Jt,zo,fi,xn,uu,_i,hu,$l,E,zn,mu,gi,fu,_u,bi,gu,bu,qn,ku,Bn,yu,ki,vu,Tu,wu,qo,xu,Fn,zu,or,qu,Bu,Fu,mt,$n,$u,yi,ju,Mu,jn,nr,Eu,vi,Pu,Cu,ar,Au,Ti,Su,Iu,Bo,Mn,Ou,wi,Nu,Du,Fo,En,Lu,xi,Gu,Wu,$o,Pn,Ru,Cn,Uu,zi,Hu,Qu,jl,Xt,jo,qi,An,Vu,Bi,Ju,Ml,G,Sn,Xu,In,Ku,Fi,Zu,Yu,eh,$i,th,oh,On,nh,Nn,ah,ji,sh,rh,ih,Mo,dh,Dn,lh,sr,ch,ph,uh,Eo,Ln,hh,Mi,mh,El,Kt,Po,Ei,Gn,fh,Pi,_h,Pl,Qe,Wn,gh,Rn,bh,rr,kh,yh,vh,Un,Th,Hn,wh,xh,zh,je,Qn,qh,Zt,Bh,ir,Fh,$h,Ci,jh,Mh,Eh,Co,Ph,Ai,Ch,Ah,Vn,Cl,Yt,Ao,Si,Jn,Sh,Ii,Ih,Al,Ve,Xn,Oh,Kn,Nh,dr,Dh,Lh,Gh,Zn,Wh,Yn,Rh,Uh,Hh,K,ea,Qh,eo,Vh,lr,Jh,Xh,Oi,Kh,Zh,Yh,So,em,Ni,tm,om,ta,nm,Di,am,sm,oa,Sl,to,Io,Li,na,rm,Gi,im,Il,we,aa,dm,Wi,lm,cm,sa,pm,cr,um,hm,mm,ra,fm,ia,_m,gm,bm,Z,da,km,oo,ym,pr,vm,Tm,Ri,wm,xm,zm,Oo,qm,Ui,Bm,Fm,la,$m,Hi,jm,Mm,ca,Ol,no,No,Qi,pa,Em,Vi,Pm,Nl,xe,ua,Cm,ao,Am,Ji,Sm,Im,Xi,Om,Nm,Dm,ha,Lm,ur,Gm,Wm,Rm,ma,Um,fa,Hm,Qm,Vm,Me,_a,Jm,so,Xm,hr,Km,Zm,Ki,Ym,ef,tf,Do,of,Zi,nf,af,ga,Dl,ro,Lo,Yi,ba,sf,ed,rf,Ll,ka,ft,ya,df,td,lf,cf,va,Gl,io,Go,od,Ta,pf,nd,uf,Wl,ze,wa,hf,xa,mf,mr,ff,_f,gf,za,bf,qa,kf,yf,vf,Wo,Tf,Ee,Ba,wf,lo,xf,fr,zf,qf,ad,Bf,Ff,$f,Ro,jf,sd,Mf,Ef,Fa,Rl,co,Uo,rd,$a,Pf,id,Cf,Ul,qe,ja,Af,Ma,Sf,_r,If,Of,Nf,Ea,Df,Pa,Lf,Gf,Wf,Ho,Rf,Y,Ca,Uf,po,Hf,gr,Qf,Vf,dd,Jf,Xf,Kf,Qo,Zf,ld,Yf,e_,Aa,t_,cd,o_,n_,Sa,Hl,uo,Vo,pd,Ia,a_,ud,s_,Ql,W,Oa,r_,Na,i_,br,d_,l_,c_,Da,p_,La,u_,h_,m_,hd,f_,__,dt,md,Ga,g_,b_,fd,Wa,k_,y_,_d,Ra,v_,T_,gd,Ua,w_,x_,Pe,Ha,z_,ho,q_,bd,B_,F_,kd,$_,j_,M_,Jo,E_,yd,P_,C_,Qa,A_,_t,Va,S_,vd,I_,O_,Ja,N_,gt,Xa,D_,Td,L_,G_,Ka,Vl,mo,Xo,wd,Za,W_,xd,R_,Jl,R,Ya,U_,es,H_,kr,Q_,V_,J_,ts,X_,os,K_,Z_,Y_,zd,eg,tg,lt,qd,ns,og,ng,Bd,as,ag,sg,Fd,ss,rg,ig,$d,rs,dg,lg,ee,is,cg,fo,pg,jd,ug,hg,Md,mg,fg,_g,Ko,gg,Ed,bg,kg,ds,yg,Pd,vg,Tg,ls,wg,bt,cs,xg,Cd,zg,qg,ps,Bg,kt,us,Fg,Ad,$g,jg,hs,Xl,_o,Zo,Sd,ms,Mg,Id,Eg,Kl,I,fs,Pg,Od,Cg,Ag,_s,Sg,yr,Ig,Og,Ng,gs,Dg,bs,Lg,Gg,Wg,Nd,Rg,Ug,ct,Dd,ks,Hg,Qg,Ld,ys,Vg,Jg,Gd,vs,Xg,Kg,Wd,Ts,Zg,Yg,Ce,ws,eb,go,tb,Rd,ob,nb,Ud,ab,sb,rb,Yo,ib,Hd,db,lb,xs,cb,yt,zs,pb,Qd,ub,hb,qs,mb,vt,Bs,fb,Vd,_b,gb,Fs,Zl,bo,en,Jd,$s,bb,Xd,kb,Yl,O,js,yb,ko,vb,Kd,Tb,wb,Zd,xb,zb,qb,Ms,Bb,vr,Fb,$b,jb,Es,Mb,Ps,Eb,Pb,Cb,Yd,Ab,Sb,pt,el,Cs,Ib,Ob,tl,As,Nb,Db,ol,Ss,Lb,Gb,nl,Is,Wb,Rb,Ae,Os,Ub,yo,Hb,al,Qb,Vb,sl,Jb,Xb,Kb,tn,Zb,rl,Yb,ek,Ns,tk,Tt,Ds,ok,il,nk,ak,Ls,sk,wt,Gs,rk,dl,ik,dk,Ws,ec;return T=new J({}),ae=new J({}),Ue=new J({}),gn=new J({}),bn=new J({}),kn=new P({props:{code:`from transformers import BartForConditionalGeneration, BartTokenizer
...
`,returnType:`
<p><code>List[int]</code></p>
`}}),Pn=new F({props:{name:"get\\_special\\_tokens\\_mask",anchor:"transformers.BartTokenizer.get_special_tokens_mask",parameters:[{name:"token_ids_0",val:": typing.List[int]"},{name:"token_ids_1",val:": typing.Optional[typing.List[int]] = None"},{name:"already_has_special_tokens",val:": bool = False"}],source:"https://github.com/huggingface/transformers/blob/doc-build-test/src/transformers/models/bart/tokenization_bart.py#L363",parametersDescription:[{anchor:"transformers.BartTokenizer.get_special_tokens_mask.token_ids_0",description:`<strong>token_ids_0</strong> (<code>List[int]</code>) &#x2014;
...
[0, 31414, 232, 2]
<span class="hljs-meta">&gt;&gt;&gt;</span> <span class="language-python">tokenizer(<span class="hljs-string">&quot; Hello world&quot;</span>)[<span class="hljs-string">&#x27;input_ids&#x27;</span>]</span>
[0, 20920, 232, 2]`}}),Mo=new De({props:{$$slots:{default:[tw]},$$scope:{ctx:j}}}),Ln=new F({props:{name:"create\\_token\\_type\\_ids\\_from\\_sequences",anchor:"transformers.BartTokenizerFast.create_token_type_ids_from_sequences",parameters:[{name:"token_ids_0",val:": typing.List[int]"},{name:"token_ids_1",val:": typing.Optional[typing.List[int]] = None"}],source:"https://github.com/huggingface/transformers/blob/doc-build-test/src/transformers/models/bart/tokenization_bart_fast.py#L282",parametersDescription:[{anchor:"transformers.BartTokenizerFast.create_token_type_ids_from_sequences.token_ids_0",description:`<strong>token_ids_0</strong> (<code>List[int]</code>) &#x2014;
...
`,returnType:`
<p><code>List[int]</code></p>
`}}),Gn=new J({}),Wn=new F({props:{name:"class transformers.BartModel",anchor:"transformers.BartModel",parameters:[{name:"config",val:": BartConfig"}],source:"https://github.com/huggingface/transformers/blob/doc-build-test/src/transformers/models/bart/modeling_bart.py#L1123",parametersDescription:[{anchor:"transformers.BartModel.config",description:`<strong>config</strong> (<a href="/docs/transformers/doc-build-test/en/model_doc/bart#transformers.BartConfig">BartConfig</a>) &#x2014;
Model configuration class with all the parameters of the model. Initializing with a config file does not
load the weights associated with the model, only the configuration. Check out the
<a href="/docs/transformers/doc-build-test/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),Qn=new F({props:{name:"forward",anchor:"transformers.BartModel.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"decoder_input_ids",val:" = None"},{name:"decoder_attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"decoder_head_mask",val:" = None"},{name:"cross_attn_head_mask",val:" = None"},{name:"encoder_outputs",val:" = None"},{name:"past_key_values",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"decoder_inputs_embeds",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/doc-build-test/src/transformers/models/bart/modeling_bart.py#L1150",parametersDescription:[{anchor:"transformers.BartModel.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. Padding will be ignored by default should you provide
it.</p>
<p>Indices can be obtained using <a href="/docs/transformers/doc-build-test/en/model_doc/bart#transformers.BartTokenizer">BartTokenizer</a>. See <a href="/docs/transformers/doc-build-test/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
...
elements depending on the configuration (<a
  href="/docs/transformers/doc-build-test/en/model_doc/bart#transformers.BartConfig"
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),Jn=new J({}),Xn=new F({props:{name:"class transformers.BartForConditionalGeneration",anchor:"transformers.BartForConditionalGeneration",parameters:[{name:"config",val:": BartConfig"}],source:"https://github.com/huggingface/transformers/blob/doc-build-test/src/transformers/models/bart/modeling_bart.py#L1249",parametersDescription:[{anchor:"transformers.BartForConditionalGeneration.config",description:`<strong>config</strong> (<a href="/docs/transformers/doc-build-test/en/model_doc/bart#transformers.BartConfig">BartConfig</a>) &#x2014;
Model configuration class with all the parameters of the model. Initializing with a config file does not
load the weights associated with the model, only the configuration. Check out the
<a href="/docs/transformers/doc-build-test/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),ea=new F({props:{name:"forward",anchor:"transformers.BartForConditionalGeneration.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"decoder_input_ids",val:" = None"},{name:"decoder_attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"decoder_head_mask",val:" = None"},{name:"cross_attn_head_mask",val:" = None"},{name:"encoder_outputs",val:" = None"},{name:"past_key_values",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"decoder_inputs_embeds",val:" = None"},{name:"labels",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/doc-build-test/src/transformers/models/bart/modeling_bart.py#L1288",parametersDescription:[{anchor:"transformers.BartForConditionalGeneration.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. Padding will be ignored by default should you provide
it.</p>
<p>Indices can be obtained using <a href="/docs/transformers/doc-build-test/en/model_doc/bart#transformers.BartTokenizer">BartTokenizer</a>. See <a href="/docs/transformers/doc-build-test/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/doc-build-test/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
<span class="hljs-meta">&gt;&gt;&gt; </span>tokenizer.decode(predictions).split()`}}),na=new J({}),aa=new F({props:{name:"class transformers.BartForSequenceClassification",anchor:"transformers.BartForSequenceClassification",parameters:[{name:"config",val:": BartConfig"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/doc-build-test/src/transformers/models/bart/modeling_bart.py#L1418",parametersDescription:[{anchor:"transformers.BartForSequenceClassification.config",description:`<strong>config</strong> (<a href="/docs/transformers/doc-build-test/en/model_doc/bart#transformers.BartConfig">BartConfig</a>) &#x2014;
Model configuration class with all the parameters of the model. Initializing with a config file does not
load the weights associated with the model, only the configuration. Check out the
<a href="/docs/transformers/doc-build-test/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),da=new F({props:{name:"forward",anchor:"transformers.BartForSequenceClassification.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"decoder_input_ids",val:" = None"},{name:"decoder_attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"decoder_head_mask",val:" = None"},{name:"cross_attn_head_mask",val:" = None"},{name:"encoder_outputs",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"decoder_inputs_embeds",val:" = None"},{name:"labels",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/doc-build-test/src/transformers/models/bart/modeling_bart.py#L1431",parametersDescription:[{anchor:"transformers.BartForSequenceClassification.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. Padding will be ignored by default should you provide
it.</p>
<p>Indices can be obtained using <a href="/docs/transformers/doc-build-test/en/model_doc/bart#transformers.BartTokenizer">BartTokenizer</a>. See <a href="/docs/transformers/doc-build-test/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/doc-build-test/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
<span class="hljs-meta">&gt;&gt;&gt; </span>outputs = model(**inputs, labels=labels)
<span class="hljs-meta">&gt;&gt;&gt; </span>loss = outputs.loss
<span class="hljs-meta">&gt;&gt;&gt; </span>logits = outputs.logits`}}),pa=new J({}),ua=new F({props:{name:"class transformers.BartForQuestionAnswering",anchor:"transformers.BartForQuestionAnswering",parameters:[{name:"config",val:""}],source:"https://github.com/huggingface/transformers/blob/doc-build-test/src/transformers/models/bart/modeling_bart.py#L1543",parametersDescription:[{anchor:"transformers.BartForQuestionAnswering.config",description:`<strong>config</strong> (<a href="/docs/transformers/doc-build-test/en/model_doc/bart#transformers.BartConfig">BartConfig</a>) &#x2014;
Model configuration class with all the parameters of the model. Initializing with a config file does not
load the weights associated with the model, only the configuration. Check out the
<a href="/docs/transformers/doc-build-test/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),_a=new F({props:{name:"forward",anchor:"transformers.BartForQuestionAnswering.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"decoder_input_ids",val:" = None"},{name:"decoder_attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"decoder_head_mask",val:" = None"},{name:"cross_attn_head_mask",val:" = None"},{name:"encoder_outputs",val:" = None"},{name:"start_positions",val:" = None"},{name:"end_positions",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"decoder_inputs_embeds",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/doc-build-test/src/transformers/models/bart/modeling_bart.py#L1555",parametersDescription:[{anchor:"transformers.BartForQuestionAnswering.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. Padding will be ignored by default should you provide
it.</p>
<p>Indices can be obtained using <a href="/docs/transformers/doc-build-test/en/model_doc/bart#transformers.BartTokenizer">BartTokenizer</a>. See <a href="/docs/transformers/doc-build-test/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/doc-build-test/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
<span class="hljs-meta">&gt;&gt;&gt; </span>end_scores = outputs.end_logits`}}),ba=new J({}),ya=new F({props:{name:"forward",anchor:"transformers.BartForCausalLM.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"encoder_hidden_states",val:" = None"},{name:"encoder_attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"cross_attn_head_mask",val:" = None"},{name:"past_key_values",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"labels",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/doc-build-test/src/transformers/models/bart/modeling_bart.py#L1702",parametersDescription:[{anchor:"transformers.BartForCausalLM.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
...
<span class="hljs-meta">&gt;&gt;&gt; </span>logits = outputs.logits`}}),Ta=new J({}),wa=new F({props:{name:"class transformers.TFBartModel",anchor:"transformers.TFBartModel",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/doc-build-test/src/transformers/models/bart/modeling_tf_bart.py#L1187",parametersDescription:[{anchor:"transformers.TFBartModel.config",description:`<strong>config</strong> (<a href="/docs/transformers/doc-build-test/en/model_doc/bart#transformers.BartConfig">BartConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/doc-build-test/en/main_classes/model#transformers.TFPreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),Wo=new De({props:{$$slots:{default:[rw]},$$scope:{ctx:j}}}),Ba=new F({props:{name:"call",anchor:"transformers.TFBartModel.call",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"decoder_input_ids",val:" = None"},{name:"decoder_attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"decoder_head_mask",val:" = None"},{name:"cross_attn_head_mask",val:" = None"},{name:"encoder_outputs",val:": typing.Union[typing.Tuple, transformers.modeling_tf_outputs.TFBaseModelOutput, NoneType] = None"},{name:"past_key_values",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"decoder_inputs_embeds",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"},{name:"training",val:" = False"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/doc-build-test/src/transformers/models/bart/modeling_tf_bart.py#L1202",parametersDescription:[{anchor:"transformers.TFBartModel.call.input_ids",description:`<strong>input_ids</strong> (<code>tf.Tensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),$a=new J({}),ja=new F({props:{name:"class transformers.TFBartForConditionalGeneration",anchor:"transformers.TFBartForConditionalGeneration",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/doc-build-test/src/transformers/models/bart/modeling_tf_bart.py#L1296",parametersDescription:[{anchor:"transformers.TFBartForConditionalGeneration.config",description:`<strong>config</strong> (<a href="/docs/transformers/doc-build-test/en/model_doc/bart#transformers.BartConfig">BartConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/doc-build-test/en/main_classes/model#transformers.TFPreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),Ho=new De({props:{$$slots:{default:[dw]},$$scope:{ctx:j}}}),Ca=new F({props:{name:"call",anchor:"transformers.TFBartForConditionalGeneration.call",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"decoder_input_ids",val:" = None"},{name:"decoder_attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"decoder_head_mask",val:" = None"},{name:"cross_attn_head_mask",val:" = None"},{name:"encoder_outputs",val:": typing.Optional[transformers.modeling_tf_outputs.TFBaseModelOutput] = None"},{name:"past_key_values",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"decoder_inputs_embeds",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"},{name:"labels",val:" = None"},{name:"training",val:" = False"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/doc-build-test/src/transformers/models/bart/modeling_tf_bart.py#L1331",parametersDescription:[{anchor:"transformers.TFBartForConditionalGeneration.call.input_ids",description:`<strong>input_ids</strong> (<code>tf.Tensor</code> of shape <code>({0})</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/doc-build-test/en/model_doc/bert#transformers.BertTokenizer">BertTokenizer</a>. See <a href="/docs/transformers/doc-build-test/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/doc-build-test/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
parameters.</strong></p>
<p>If you wish to change the dtype of the model parameters, see <a href="/docs/transformers/doc-build-test/en/main_classes/model#transformers.FlaxPreTrainedModel.to_fp16">to_fp16()</a> and
<a href="/docs/transformers/doc-build-test/en/main_classes/model#transformers.FlaxPreTrainedModel.to_bf16">to_bf16()</a>.`,name:"dtype"}]}}),is=new F({props:{name:"\\_\\_call\\_\\_",anchor:"transformers.FlaxBartPreTrainedModel.__call__",parameters:[{name:"input_ids",val:": ndarray"},{name:"attention_mask",val:": typing.Optional[jax._src.numpy.lax_numpy.ndarray] = None"},{name:"decoder_input_ids",val:": typing.Optional[jax._src.numpy.lax_numpy.ndarray] = None"},{name:"decoder_attention_mask",val:": typing.Optional[jax._src.numpy.lax_numpy.ndarray] = None"},{name:"position_ids",val:": typing.Optional[jax._src.numpy.lax_numpy.ndarray] = None"},{name:"decoder_position_ids",val:": typing.Optional[jax._src.numpy.lax_numpy.ndarray] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"train",val:": bool = False"},{name:"params",val:": dict = None"},{name:"dropout_rng",val:": PRNGKey = None"}],source:"https://github.com/huggingface/transformers/blob/doc-build-test/src/transformers/models/bart/modeling_flax_bart.py#L1179",parametersDescription:[{anchor:"transformers.FlaxBartPreTrainedModel.__call__.input_ids",description:`<strong>input_ids</strong> (<code>jnp.ndarray</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. Padding will be ignored by default should you provide
it.</p>
<p>Indices can be obtained using <a href="/docs/transformers/doc-build-test/en/model_doc/bart#transformers.BartTokenizer">BartTokenizer</a>. See <a href="/docs/transformers/doc-build-test/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/doc-build-test/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
<span class="hljs-meta">&gt;&gt;&gt; </span>text = <span class="hljs-string">&quot;My friends are cool but they eat too many carbs.&quot;</span>
<span class="hljs-meta">&gt;&gt;&gt; </span>inputs = tokenizer(text, max_length=<span class="hljs-number">1024</span>, return_tensors=<span class="hljs-string">&quot;jax&quot;</span>)
<span class="hljs-meta">&gt;&gt;&gt; </span>encoder_outputs = model.encode(**inputs)`}}),us=new F({props:{name:"decode",anchor:"transformers.FlaxBartForConditionalGeneration.decode",parameters:[{name:"decoder_input_ids",val:""},{name:"encoder_outputs",val:""},{name:"encoder_attention_mask",val:": typing.Optional[jax._src.numpy.lax_numpy.ndarray] = None"},{name:"decoder_attention_mask",val:": typing.Optional[jax._src.numpy.lax_numpy.ndarray] = None"},{name:"decoder_position_ids",val:": typing.Optional[jax._src.numpy.lax_numpy.ndarray] = None"},{name:"past_key_values",val:": dict = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"train",val:": bool = False"},{name:"params",val:": dict = None"},{name:"dropout_rng",val:": PRNGKey = None"}],source:"https://github.com/huggingface/transformers/blob/doc-build-test/src/transformers/models/bart/modeling_flax_bart.py#L1334",parametersDescription:[{anchor:"transformers.FlaxBartForConditionalGeneration.decode.decoder_input_ids",description:`<strong>decoder_input_ids</strong> (<code>jnp.ndarray</code> of shape <code>(batch_size, target_sequence_length)</code>) &#x2014;
Indices of decoder input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/doc-build-test/en/model_doc/bart#transformers.BartTokenizer">BartTokenizer</a>. See <a href="/docs/transformers/doc-build-test/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/doc-build-test/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
<p><a href="../glossary#decoder-input-ids">What are decoder input IDs?</a></p>
...
`}}),hs=new P({props:{code:`import jax.numpy as jnp
from transformers import BartTokenizer, FlaxBartForConditionalGeneration
...
parameters.</strong></p>
<p>If you wish to change the dtype of the model parameters, see <a href="/docs/transformers/doc-build-test/en/main_classes/model#transformers.FlaxPreTrainedModel.to_fp16">to_fp16()</a> and
<a href="/docs/transformers/doc-build-test/en/main_classes/model#transformers.FlaxPreTrainedModel.to_bf16">to_bf16()</a>.`,name:"dtype"}]}}),ws=new F({props:{name:"\\_\\_call\\_\\_",anchor:"transformers.FlaxBartPreTrainedModel.__call__",parameters:[{name:"input_ids",val:": ndarray"},{name:"attention_mask",val:": typing.Optional[jax._src.numpy.lax_numpy.ndarray] = None"},{name:"decoder_input_ids",val:": typing.Optional[jax._src.numpy.lax_numpy.ndarray] = None"},{name:"decoder_attention_mask",val:": typing.Optional[jax._src.numpy.lax_numpy.ndarray] = None"},{name:"position_ids",val:": typing.Optional[jax._src.numpy.lax_numpy.ndarray] = None"},{name:"decoder_position_ids",val:": typing.Optional[jax._src.numpy.lax_numpy.ndarray] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"train",val:": bool = False"},{name:"params",val:": dict = None"},{name:"dropout_rng",val:": PRNGKey = None"}],source:"https://github.com/huggingface/transformers/blob/doc-build-test/src/transformers/models/bart/modeling_flax_bart.py#L1179",parametersDescription:[{anchor:"transformers.FlaxBartPreTrainedModel.__call__.input_ids",description:`<strong>input_ids</strong> (<code>jnp.ndarray</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. Padding will be ignored by default should you provide
it.</p>
<p>Indices can be obtained using <a href="/docs/transformers/doc-build-test/en/model_doc/bart#transformers.BartTokenizer">BartTokenizer</a>. See <a href="/docs/transformers/doc-build-test/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/doc-build-test/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
`}}),Yo=new De({props:{$$slots:{default:[uw]},$$scope:{ctx:j}}}),xs=new P({props:{code:`from transformers import BartTokenizer, FlaxBartForSequenceClassification
...
parameters.</strong></p>
<p>If you wish to change the dtype of the model parameters, see <a href="/docs/transformers/doc-build-test/en/main_classes/model#transformers.FlaxPreTrainedModel.to_fp16">to_fp16()</a> and
<a href="/docs/transformers/doc-build-test/en/main_classes/model#transformers.FlaxPreTrainedModel.to_bf16">to_bf16()</a>.`,name:"dtype"}]}}),Os=new F({props:{name:"\\_\\_call\\_\\_",anchor:"transformers.FlaxBartPreTrainedModel.__call__",parameters:[{name:"input_ids",val:": ndarray"},{name:"attention_mask",val:": typing.Optional[jax._src.numpy.lax_numpy.ndarray] = None"},{name:"decoder_input_ids",val:": typing.Optional[jax._src.numpy.lax_numpy.ndarray] = None"},{name:"decoder_attention_mask",val:": typing.Optional[jax._src.numpy.lax_numpy.ndarray] = None"},{name:"position_ids",val:": typing.Optional[jax._src.numpy.lax_numpy.ndarray] = None"},{name:"decoder_position_ids",val:": typing.Optional[jax._src.numpy.lax_numpy.ndarray] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"train",val:": bool = False"},{name:"params",val:": dict = None"},{name:"dropout_rng",val:": PRNGKey = None"}],source:"https://github.com/huggingface/transformers/blob/doc-build-test/src/transformers/models/bart/modeling_flax_bart.py#L1179",parametersDescription:[{anchor:"transformers.FlaxBartPreTrainedModel.__call__.input_ids",description:`<strong>input_ids</strong> (<code>jnp.ndarray</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. Padding will be ignored by default should you provide
it.</p>
<p>Indices can be obtained using <a href="/docs/transformers/doc-build-test/en/model_doc/bart#transformers.BartTokenizer">BartTokenizer</a>. See <a href="/docs/transformers/doc-build-test/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/doc-build-test/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
`}}),tn=new De({props:{$$slots:{default:[hw]},$$scope:{ctx:j}}}),Ns=new P({props:{code:`from transformers import BartTokenizer, FlaxBartForQuestionAnswering
...
<span class="hljs-meta">&gt;&gt;&gt; </span>outputs = model.decode(decoder_input_ids, encoder_outputs)
<span class="hljs-meta">&gt;&gt;&gt; </span>last_decoder_hidden_states = outputs.last_hidden_state`}}),{c(){p=n("meta"),q=d(),y=n("h1"),w=n("a"),x=n("span"),m(T.$$.fragment),v=d(),B=n("span"),ne=r("BART"),A=d(),$=n("p"),le=n("strong"),_e=r("DISCLAIMER:"),Ke=r(" If you see something strange, file a "),ge=n("a"),be=r("Github Issue"),Ze=r(` and assign
...
Ghazvininejad, Abdelrahman Mohamed, Omer Levy, Ves Stoyanov and Luke Zettlemoyer on 29 Oct, 2019.`),D=d(),Be=n("p"),ke=r("According to the abstract,"),Xe=d(),X=n("ul"),se=n("li"),nt=r(`Bart uses a standard seq2seq/machine translation architecture with a bidirectional encoder (like BERT) and a
...
of up to 6 ROUGE.`),M=d(),U=n("p"),St=r("This model was contributed by "),We=n("a"),re=r("sshleifer"),It=r(". The Authors\u2019 code can be found "),Re=n("a"),Ot=r("here"),ie=r("."),ue=d(),ve=n("h3"),Fe=n("a"),de=n("span"),m(Ue.$$.fragment),Nt=d(),He=n("span"),Dt=r("Examples"),yl=d(),ut=n("ul"),un=n("li"),Xc=r(`Examples and scripts for fine-tuning BART and other models for sequence to sequence tasks can be found in
`),hn=n("a"),Kc=r("examples/pytorch/summarization/"),Zc=r("."),Yc=d(),rt=n("li"),ep=r("An example of how to train "),Qs=n("a"),tp=r("BartForConditionalGeneration"),op=r(" with a Hugging Face "),Yr=n("code"),np=r("datasets"),ap=r(`
object can be found in this `),mn=n("a"),sp=r("forum discussion"),rp=r("."),ip=d(),vo=n("li"),fn=n("a"),dp=r("Distilled checkpoints"),lp=r(" are described in this "),_n=n("a"),cp=r("paper"),pp=r("."),vl=d(),Lt=n("h2"),To=n("a"),ei=n("span"),m(gn.$$.fragment),up=d(),ti=n("span"),hp=r("Implementation Notes"),Tl=d(),$e=n("ul"),it=n("li"),mp=r("Bart doesn\u2019t use "),oi=n("code"),fp=r("token_type_ids"),_p=r(" for sequence classification. Use "),Vs=n("a"),gp=r("BartTokenizer"),bp=r(` or
`),Js=n("a"),kp=r("encode()"),yp=r(" to get the proper splitting."),vp=d(),Gt=n("li"),Tp=r("The forward pass of "),Xs=n("a"),wp=r("BartModel"),xp=r(" will create the "),ni=n("code"),zp=r("decoder_input_ids"),qp=r(` if they are not passed.
...
mask-filling tasks.`),wl=d(),Ut=n("h2"),wo=n("a"),di=n("span"),m(bn.$$.fragment),Gp=d(),li=n("span"),Wp=r("Mask Filling"),xl=d(),ht=n("p"),Rp=r("The "),ci=n("code"),Up=r("facebook/bart-base"),Hp=r(" and "),pi=n("code"),Qp=r("facebook/bart-large"),Vp=r(" checkpoints can be used to fill multi-token masks."),zl=d(),m(kn.$$.fragment),ql=d(),Ht=n("h2"),xo=n("a"),ui=n("span"),m(yn.$$.fragment),Jp=d(),hi=n("span"),Xp=r("BartConfig"),Bl=d(),Te=n("div"),m(vn.$$.fragment),Kp=d(),Qt=n("p"),Zp=r("This is the configuration class to store the configuration of a "),Ys=n("a"),Yp=r("BartModel"),eu=r(`. It is used to instantiate a BART
model according to the specified arguments, defining the model architecture. Instantiating a configuration with the
defaults will yield a similar configuration to that of the BART
`),Tn=n("a"),tu=r("facebook/bart-large"),ou=r(" architecture."),nu=d(),Vt=n("p"),au=r("Configuration objects inherit from "),er=n("a"),su=r("PretrainedConfig"),ru=r(` and can be used to control the model outputs. Read the
documentation from `),tr=n("a"),iu=r("PretrainedConfig"),du=r(" for more information."),lu=d(),mi=n("p"),cu=r("Example:"),pu=d(),m(wn.$$.fragment),Fl=d(),Jt=n("h2"),zo=n("a"),fi=n("span"),m(xn.$$.fragment),uu=d(),_i=n("span"),hu=r("BartTokenizer"),$l=d(),E=n("div"),m(zn.$$.fragment),mu=d(),gi=n("p"),fu=r("Constructs a BART tokenizer, which is smilar to the ROBERTa tokenizer, using byte-level Byte-Pair-Encoding."),_u=d(),bi=n("p"),gu=r(`This tokenizer has been trained to treat spaces like parts of the tokens (a bit like sentencepiece) so a word will
be encoded differently whether it is at the beginning of the sentence (without space) or not:`),bu=d(),m(qn.$$.fragment),ku=d(),Bn=n("p"),yu=r("You can get around that behavior by passing "),ki=n("code"),vu=r("add_prefix_space=True"),Tu=r(` when instantiating this tokenizer or when you
call it on some text, but since the model was not pretrained this way, it might yield a decrease in performance.`),wu=d(),m(qo.$$.fragment),xu=d(),Fn=n("p"),zu=r("This tokenizer inherits from "),or=n("a"),qu=r("PreTrainedTokenizer"),Bu=r(` which contains most of the main methods. Users should refer to
this superclass for more information regarding those methods.`),Fu=d(),mt=n("div"),m($n.$$.fragment),$u=d(),yi=n("p"),ju=r(`Build model inputs from a sequence or a pair of sequence for sequence classification tasks by concatenating and
adding special tokens. A BART sequence has the following format:`),Mu=d(),jn=n("ul"),nr=n("li"),Eu=r("single sequence: "),vi=n("code"),Pu=r("<s> X </s>"),Cu=d(),ar=n("li"),Au=r("pair of sequences: "),Ti=n("code"),Su=r("<s> A </s></s> B </s>"),Iu=d(),Bo=n("div"),m(Mn.$$.fragment),Ou=d(),wi=n("p"),Nu=r("Converts a sequence of tokens (string) in a single string."),Du=d(),Fo=n("div"),m(En.$$.fragment),Lu=d(),xi=n("p"),Gu=r(`Create a mask from the two sequences passed to be used in a sequence-pair classification task. BART does not
make use of token type ids, therefore a list of zeros is returned.`),Wu=d(),$o=n("div"),m(Pn.$$.fragment),Ru=d(),Cn=n("p"),Uu=r(`Retrieve sequence ids from a token list that has no special tokens added. This method is called when adding
special tokens using the tokenizer `),zi=n("code"),Hu=r("prepare_for_model"),Qu=r(" method."),jl=d(),Xt=n("h2"),jo=n("a"),qi=n("span"),m(An.$$.fragment),Vu=d(),Bi=n("span"),Ju=r("BartTokenizerFast"),Ml=d(),G=n("div"),m(Sn.$$.fragment),Xu=d(),In=n("p"),Ku=r("Construct a \u201Cfast\u201D BART tokenizer (backed by HuggingFace\u2019s "),Fi=n("em"),Zu=r("tokenizers"),Yu=r(` library), derived from the GPT-2 tokenizer,
using byte-level Byte-Pair-Encoding.`),eh=d(),$i=n("p"),th=r(`This tokenizer has been trained to treat spaces like parts of the tokens (a bit like sentencepiece) so a word will
be encoded differently whether it is at the beginning of the sentence (without space) or not:`),oh=d(),m(On.$$.fragment),nh=d(),Nn=n("p"),ah=r("You can get around that behavior by passing "),ji=n("code"),sh=r("add_prefix_space=True"),rh=r(` when instantiating this tokenizer or when you
call it on some text, but since the model was not pretrained this way, it might yield a decrease in performance.`),ih=d(),m(Mo.$$.fragment),dh=d(),Dn=n("p"),lh=r("This tokenizer inherits from "),sr=n("a"),ch=r("PreTrainedTokenizerFast"),ph=r(` which contains most of the main methods. Users should
refer to this superclass for more information regarding those methods.`),uh=d(),Eo=n("div"),m(Ln.$$.fragment),hh=d(),Mi=n("p"),mh=r(`Create a mask from the two sequences passed to be used in a sequence-pair classification task. BART does not
make use of token type ids, therefore a list of zeros is returned.`),El=d(),Kt=n("h2"),Po=n("a"),Ei=n("span"),m(Gn.$$.fragment),fh=d(),Pi=n("span"),_h=r("BartModel"),Pl=d(),Qe=n("div"),m(Wn.$$.fragment),gh=d(),Rn=n("p"),bh=r(`The bare BART Model outputting raw hidden-states without any specific head on top.
This model inherits from `),rr=n("a"),kh=r("PreTrainedModel"),yh=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),vh=d(),Un=n("p"),Th=r("This model is also a PyTorch "),Hn=n("a"),wh=r("torch.nn.Module"),xh=r(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),zh=d(),je=n("div"),m(Qn.$$.fragment),qh=d(),Zt=n("p"),Bh=r("The "),ir=n("a"),Fh=r("BartModel"),$h=r(" forward method, overrides the "),Ci=n("code"),jh=r("__call__"),Mh=r(" special method."),Eh=d(),m(Co.$$.fragment),Ph=d(),Ai=n("p"),Ch=r("Example:"),Ah=d(),m(Vn.$$.fragment),Cl=d(),Yt=n("h2"),Ao=n("a"),Si=n("span"),m(Jn.$$.fragment),Sh=d(),Ii=n("span"),Ih=r("BartForConditionalGeneration"),Al=d(),Ve=n("div"),m(Xn.$$.fragment),Oh=d(),Kn=n("p"),Nh=r(`The BART Model with a language modeling head. Can be used for summarization.
This model inherits from `),dr=n("a"),Dh=r("PreTrainedModel"),Lh=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Gh=d(),Zn=n("p"),Wh=r("This model is also a PyTorch "),Yn=n("a"),Rh=r("torch.nn.Module"),Uh=r(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Hh=d(),K=n("div"),m(ea.$$.fragment),Qh=d(),eo=n("p"),Vh=r("The "),lr=n("a"),Jh=r("BartForConditionalGeneration"),Xh=r(" forward method, overrides the "),Oi=n("code"),Kh=r("__call__"),Zh=r(" special method."),Yh=d(),m(So.$$.fragment),em=d(),Ni=n("p"),tm=r("Summarization example:"),om=d(),m(ta.$$.fragment),nm=d(),Di=n("p"),am=r("Mask filling example:"),sm=d(),m(oa.$$.fragment),Sl=d(),to=n("h2"),Io=n("a"),Li=n("span"),m(na.$$.fragment),rm=d(),Gi=n("span"),im=r("BartForSequenceClassification"),Il=d(),we=n("div"),m(aa.$$.fragment),dm=d(),Wi=n("p"),lm=r(`Bart model with a sequence classification/head on top (a linear layer on top of the pooled output) e.g. for GLUE
tasks.`),cm=d(),sa=n("p"),pm=r("This model inherits from "),cr=n("a"),um=r("PreTrainedModel"),hm=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),mm=d(),ra=n("p"),fm=r("This model is also a PyTorch "),ia=n("a"),_m=r("torch.nn.Module"),gm=r(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),bm=d(),Z=n("div"),m(da.$$.fragment),km=d(),oo=n("p"),ym=r("The "),pr=n("a"),vm=r("BartForSequenceClassification"),Tm=r(" forward method, overrides the "),Ri=n("code"),wm=r("__call__"),xm=r(" special method."),zm=d(),m(Oo.$$.fragment),qm=d(),Ui=n("p"),Bm=r("Example of single-label classification:"),Fm=d(),m(la.$$.fragment),$m=d(),Hi=n("p"),jm=r("Example of multi-label classification:"),Mm=d(),m(ca.$$.fragment),Ol=d(),no=n("h2"),No=n("a"),Qi=n("span"),m(pa.$$.fragment),Em=d(),Vi=n("span"),Pm=r("BartForQuestionAnswering"),Nl=d(),xe=n("div"),m(ua.$$.fragment),Cm=d(),ao=n("p"),Am=r(`BART Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
layer on top of the hidden-states output to compute `),Ji=n("code"),Sm=r("span start logits"),Im=r(" and "),Xi=n("code"),Om=r("span end logits"),Nm=r(")."),Dm=d(),ha=n("p"),Lm=r("This model inherits from "),ur=n("a"),Gm=r("PreTrainedModel"),Wm=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Rm=d(),ma=n("p"),Um=r("This model is also a PyTorch "),fa=n("a"),Hm=r("torch.nn.Module"),Qm=r(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Vm=d(),Me=n("div"),m(_a.$$.fragment),Jm=d(),so=n("p"),Xm=r("The "),hr=n("a"),Km=r("BartForQuestionAnswering"),Zm=r(" forward method, overrides the "),Ki=n("code"),Ym=r("__call__"),ef=r(" special method."),tf=d(),m(Do.$$.fragment),of=d(),Zi=n("p"),nf=r("Example:"),af=d(),m(ga.$$.fragment),Dl=d(),ro=n("h2"),Lo=n("a"),Yi=n("span"),m(ba.$$.fragment),sf=d(),ed=n("span"),rf=r("BartForCausalLM"),Ll=d(),ka=n("div"),ft=n("div"),m(ya.$$.fragment),df=d(),td=n("p"),lf=r("Example:"),cf=d(),m(va.$$.fragment),Gl=d(),io=n("h2"),Go=n("a"),od=n("span"),m(Ta.$$.fragment),pf=d(),nd=n("span"),uf=r("TFBartModel"),Wl=d(),ze=n("div"),m(wa.$$.fragment),hf=d(),xa=n("p"),mf=r(`The bare BART Model outputting raw hidden-states without any specific head on top.
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),gf=d(),za=n("p"),bf=r("This model is also a "),qa=n("a"),kf=r("tf.keras.Model"),yf=r(` subclass. Use it
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Wf=d(),m(Ho.$$.fragment),Rf=d(),Y=n("div"),m(Ca.$$.fragment),Uf=d(),po=n("p"),Hf=r("The "),gr=n("a"),Qf=r("TFBartForConditionalGeneration"),Vf=r(" forward method, overrides the "),dd=n("code"),Jf=r("__call__"),Xf=r(" special method."),Kf=d(),m(Qo.$$.fragment),Zf=d(),ld=n("p"),Yf=r("Summarization example:"),e_=d(),m(Aa.$$.fragment),t_=d(),cd=n("p"),o_=r("Mask filling example:"),n_=d(),m(Sa.$$.fragment),Hl=d(),uo=n("h2"),Vo=n("a"),pd=n("span"),m(Ia.$$.fragment),a_=d(),ud=n("span"),s_=r("FlaxBartModel"),Ql=d(),W=n("div"),m(Oa.$$.fragment),r_=d(),Na=n("p"),i_=r(`The bare Bart Model transformer outputting raw hidden-states without any specific head on top.
This model inherits from `),br=n("a"),d_=r("FlaxPreTrainedModel"),l_=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),c_=d(),Da=n("p"),p_=r(`This model is also a Flax Linen
`),La=n("a"),u_=r("flax.nn.Module"),h_=r(` subclass. Use it as a
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),m_=d(),hd=n("p"),f_=r("Finally, this model supports inherent JAX features such as:"),__=d(),dt=n("ul"),md=n("li"),Ga=n("a"),g_=r("Just-In-Time (JIT) compilation"),b_=d(),fd=n("li"),Wa=n("a"),k_=r("Automatic Differentiation"),y_=d(),_d=n("li"),Ra=n("a"),v_=r("Vectorization"),T_=d(),gd=n("li"),Ua=n("a"),w_=r("Parallelization"),x_=d(),Pe=n("div"),m(Ha.$$.fragment),z_=d(),ho=n("p"),q_=r("The "),bd=n("code"),B_=r("FlaxBartPreTrainedModel"),F_=r("forward method, overrides the "),kd=n("code"),$_=r("__call__"),j_=r(" special method."),M_=d(),m(Jo.$$.fragment),E_=d(),yd=n("p"),P_=r("Example:"),C_=d(),m(Qa.$$.fragment),A_=d(),_t=n("div"),m(Va.$$.fragment),S_=d(),vd=n("p"),I_=r("Example:"),O_=d(),m(Ja.$$.fragment),N_=d(),gt=n("div"),m(Xa.$$.fragment),D_=d(),Td=n("p"),L_=r("Example:"),G_=d(),m(Ka.$$.fragment),Vl=d(),mo=n("h2"),Xo=n("a"),wd=n("span"),m(Za.$$.fragment),W_=d(),xd=n("span"),R_=r("FlaxBartForConditionalGeneration"),Jl=d(),R=n("div"),m(Ya.$$.fragment),U_=d(),es=n("p"),H_=r(`The BART Model with a language modeling head. Can be used for summarization.
This model inherits from `),kr=n("a"),Q_=r("FlaxPreTrainedModel"),V_=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),J_=d(),ts=n("p"),X_=r(`This model is also a Flax Linen
`),os=n("a"),K_=r("flax.nn.Module"),Z_=r(` subclass. Use it as a
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),Y_=d(),zd=n("p"),eg=r("Finally, this model supports inherent JAX features such as:"),tg=d(),lt=n("ul"),qd=n("li"),ns=n("a"),og=r("Just-In-Time (JIT) compilation"),ng=d(),Bd=n("li"),as=n("a"),ag=r("Automatic Differentiation"),sg=d(),Fd=n("li"),ss=n("a"),rg=r("Vectorization"),ig=d(),$d=n("li"),rs=n("a"),dg=r("Parallelization"),lg=d(),ee=n("div"),m(is.$$.fragment),cg=d(),fo=n("p"),pg=r("The "),jd=n("code"),ug=r("FlaxBartPreTrainedModel"),hg=r("forward method, overrides the "),Md=n("code"),mg=r("__call__"),fg=r(" special method."),_g=d(),m(Ko.$$.fragment),gg=d(),Ed=n("p"),bg=r("Summarization example:"),kg=d(),m(ds.$$.fragment),yg=d(),Pd=n("p"),vg=r("Mask filling example:"),Tg=d(),m(ls.$$.fragment),wg=d(),bt=n("div"),m(cs.$$.fragment),xg=d(),Cd=n("p"),zg=r("Example:"),qg=d(),m(ps.$$.fragment),Bg=d(),kt=n("div"),m(us.$$.fragment),Fg=d(),Ad=n("p"),$g=r("Example:"),jg=d(),m(hs.$$.fragment),Xl=d(),_o=n("h2"),Zo=n("a"),Sd=n("span"),m(ms.$$.fragment),Mg=d(),Id=n("span"),Eg=r("FlaxBartForSequenceClassification"),Kl=d(),I=n("div"),m(fs.$$.fragment),Pg=d(),Od=n("p"),Cg=r(`Bart model with a sequence classification/head on top (a linear layer on top of the pooled output) e.g. for GLUE
...
`),bs=n("a"),Lg=r("flax.nn.Module"),Gg=r(` subclass. Use it as a
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),Wg=d(),Nd=n("p"),Rg=r("Finally, this model supports inherent JAX features such as:"),Ug=d(),ct=n("ul"),Dd=n("li"),ks=n("a"),Hg=r("Just-In-Time (JIT) compilation"),Qg=d(),Ld=n("li"),ys=n("a"),Vg=r("Automatic Differentiation"),Jg=d(),Gd=n("li"),vs=n("a"),Xg=r("Vectorization"),Kg=d(),Wd=n("li"),Ts=n("a"),Zg=r("Parallelization"),Yg=d(),Ce=n("div"),m(ws.$$.fragment),eb=d(),go=n("p"),tb=r("The "),Rd=n("code"),ob=r("FlaxBartPreTrainedModel"),nb=r("forward method, overrides the "),Ud=n("code"),ab=r("__call__"),sb=r(" special method."),rb=d(),m(Yo.$$.fragment),ib=d(),Hd=n("p"),db=r("Example:"),lb=d(),m(xs.$$.fragment),cb=d(),yt=n("div"),m(zs.$$.fragment),pb=d(),Qd=n("p"),ub=r("Example:"),hb=d(),m(qs.$$.fragment),mb=d(),vt=n("div"),m(Bs.$$.fragment),fb=d(),Vd=n("p"),_b=r("Example:"),gb=d(),m(Fs.$$.fragment),Zl=d(),bo=n("h2"),en=n("a"),Jd=n("span"),m($s.$$.fragment),bb=d(),Xd=n("span"),kb=r("FlaxBartForQuestionAnswering"),Yl=d(),O=n("div"),m(js.$$.fragment),yb=d(),ko=n("p"),vb=r(`BART Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
layer on top of the hidden-states output to compute `),Kd=n("code"),Tb=r("span start logits"),wb=r(" and "),Zd=n("code"),xb=r("span end logits"),zb=r(")."),qb=d(),Ms=n("p"),Bb=r("This model inherits from "),vr=n("a"),Fb=r("FlaxPreTrainedModel"),$b=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),jb=d(),Es=n("p"),Mb=r(`This model is also a Flax Linen
`),Ps=n("a"),Eb=r("flax.nn.Module"),Pb=r(` subclass. Use it as a
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),Cb=d(),Yd=n("p"),Ab=r("Finally, this model supports inherent JAX features such as:"),Sb=d(),pt=n("ul"),el=n("li"),Cs=n("a"),Ib=r("Just-In-Time (JIT) compilation"),Ob=d(),tl=n("li"),As=n("a"),Nb=r("Automatic Differentiation"),Db=d(),ol=n("li"),Ss=n("a"),Lb=r("Vectorization"),Gb=d(),nl=n("li"),Is=n("a"),Wb=r("Parallelization"),Rb=d(),Ae=n("div"),m(Os.$$.fragment),Ub=d(),yo=n("p"),Hb=r("The "),al=n("code"),Qb=r("FlaxBartPreTrainedModel"),Vb=r("forward method, overrides the "),sl=n("code"),Jb=r("__call__"),Xb=r(" special method."),Kb=d(),m(tn.$$.fragment),Zb=d(),rl=n("p"),Yb=r("Example:"),ek=d(),m(Ns.$$.fragment),tk=d(),Tt=n("div"),m(Ds.$$.fragment),ok=d(),il=n("p"),nk=r("Example:"),ak=d(),m(Ls.$$.fragment),sk=d(),wt=n("div"),m(Gs.$$.fragment),rk=d(),dl=n("p"),ik=r("Example:"),dk=d(),m(Ws.$$.fragment),this.h()},l(o){const u=YT('[data-svelte="svelte-1phssyn"]',document.head);p=a(u,"META",{name:!0,content:!0}),u.forEach(t),q=l(o),y=a(o,"H1",{class:!0});var Rs=s(y);w=a(Rs,"A",{id:!0,class:!0,href:!0});var ll=s(w);x=a(ll,"SPAN",{});var cl=s(x);f(T.$$.fragment,cl),cl.forEach(t),ll.forEach(t),v=l(Rs),B=a(Rs,"SPAN",{});var pl=s(B);ne=i(pl,"BART"),pl.forEach(t),Rs.forEach(t),A=l(o),$=a(o,"P",{});var on=s($);le=a(on,"STRONG",{});var ul=s(le);_e=i(ul,"DISCLAIMER:"),ul.forEach(t),Ke=i(on," If you see something strange, file a "),ge=a(on,"A",{href:!0,rel:!0});var hl=s(ge);be=i(hl,"Github Issue"),hl.forEach(t),Ze=i(on,` and assign
...
Ghazvininejad, Abdelrahman Mohamed, Omer Levy, Ves Stoyanov and Luke Zettlemoyer on 29 Oct, 2019.`),Hs.forEach(t),D=l(o),Be=a(o,"P",{});var bl=s(Be);ke=i(bl,"According to the abstract,"),bl.forEach(t),Xe=l(o),X=a(o,"UL",{});var Tr=s(X);se=a(Tr,"LI",{});var uk=s(se);nt=i(uk,`Bart uses a standard seq2seq/machine translation architecture with a bidirectional encoder (like BERT) and a
left-to-right decoder (like GPT).`),uk.forEach(t),at=l(Tr),V=a(Tr,"LI",{});var hk=s(V);st=i(hk,`The pretraining task involves randomly shuffling the order of the original sentences and a novel in-filling scheme,
where spans of text are replaced with a single mask token.`),hk.forEach(t),ye=l(Tr),Ge=a(Tr,"LI",{});var mk=s(Ge);z=i(mk,`BART is particularly effective when fine tuned for text generation but also works well for comprehension tasks. It
matches the performance of RoBERTa with comparable training resources on GLUE and SQuAD, achieves new
state-of-the-art results on a range of abstractive dialogue, question answering, and summarization tasks, with gains
of up to 6 ROUGE.`),mk.forEach(t),Tr.forEach(t),M=l(o),U=a(o,"P",{});var wr=s(U);St=i(wr,"This model was contributed by "),We=a(wr,"A",{href:!0,rel:!0});var fk=s(We);re=i(fk,"sshleifer"),fk.forEach(t),It=i(wr,". The Authors\u2019 code can be found "),Re=a(wr,"A",{href:!0,rel:!0});var _k=s(Re);Ot=i(_k,"here"),_k.forEach(t),ie=i(wr,"."),wr.forEach(t),ue=l(o),ve=a(o,"H3",{class:!0});var tc=s(ve);Fe=a(tc,"A",{id:!0,class:!0,href:!0});var gk=s(Fe);de=a(gk,"SPAN",{});var bk=s(de);f(Ue.$$.fragment,bk),bk.forEach(t),gk.forEach(t),Nt=l(tc),He=a(tc,"SPAN",{});var kk=s(He);Dt=i(kk,"Examples"),kk.forEach(t),tc.forEach(t),yl=l(o),ut=a(o,"UL",{});var xr=s(ut);un=a(xr,"LI",{});var oc=s(un);Xc=i(oc,`Examples and scripts for fine-tuning BART and other models for sequence to sequence tasks can be found in
`),hn=a(oc,"A",{href:!0,rel:!0});var yk=s(hn);Kc=i(yk,"examples/pytorch/summarization/"),yk.forEach(t),Zc=i(oc,"."),oc.forEach(t),Yc=l(xr),rt=a(xr,"LI",{});var nn=s(rt);ep=i(nn,"An example of how to train "),Qs=a(nn,"A",{href:!0});var vk=s(Qs);tp=i(vk,"BartForConditionalGeneration"),vk.forEach(t),op=i(nn," with a Hugging Face "),Yr=a(nn,"CODE",{});var Tk=s(Yr);np=i(Tk,"datasets"),Tk.forEach(t),ap=i(nn,`
object can be found in this `),mn=a(nn,"A",{href:!0,rel:!0});var wk=s(mn);sp=i(wk,"forum discussion"),wk.forEach(t),rp=i(nn,"."),nn.forEach(t),ip=l(xr),vo=a(xr,"LI",{});var kl=s(vo);fn=a(kl,"A",{href:!0,rel:!0});var xk=s(fn);dp=i(xk,"Distilled checkpoints"),xk.forEach(t),lp=i(kl," are described in this "),_n=a(kl,"A",{href:!0,rel:!0});var zk=s(_n);cp=i(zk,"paper"),zk.forEach(t),pp=i(kl,"."),kl.forEach(t),xr.forEach(t),vl=l(o),Lt=a(o,"H2",{class:!0});var nc=s(Lt);To=a(nc,"A",{id:!0,class:!0,href:!0});var qk=s(To);ei=a(qk,"SPAN",{});var Bk=s(ei);f(gn.$$.fragment,Bk),Bk.forEach(t),qk.forEach(t),up=l(nc),ti=a(nc,"SPAN",{});var Fk=s(ti);hp=i(Fk,"Implementation Notes"),Fk.forEach(t),nc.forEach(t),Tl=l(o),$e=a(o,"UL",{});var xt=s($e);it=a(xt,"LI",{});var an=s(it);mp=i(an,"Bart doesn\u2019t use "),oi=a(an,"CODE",{});var $k=s(oi);fp=i($k,"token_type_ids"),$k.forEach(t),_p=i(an," for sequence classification. Use "),Vs=a(an,"A",{href:!0});var jk=s(Vs);gp=i(jk,"BartTokenizer"),jk.forEach(t),bp=i(an,` or
`),Js=a(an,"A",{href:!0});var Mk=s(Js);kp=i(Mk,"encode()"),Mk.forEach(t),yp=i(an," to get the proper splitting."),an.forEach(t),vp=l(xt),Gt=a(xt,"LI",{});var zr=s(Gt);Tp=i(zr,"The forward pass of "),Xs=a(zr,"A",{href:!0});var Ek=s(Xs);wp=i(Ek,"BartModel"),Ek.forEach(t),xp=i(zr," will create the "),ni=a(zr,"CODE",{});var Pk=s(ni);zp=i(Pk,"decoder_input_ids"),Pk.forEach(t),qp=i(zr,` if they are not passed.
...
`),ai=a(qr,"CODE",{});var Ck=s(ai);$p=i(Ck,"force_bos_token_to_be_generated=True"),Ck.forEach(t),jp=i(qr,`. This only works, however, if the string you pass to
`),si=a(qr,"CODE",{});var Ak=s(si);Mp=i(Ak,"fairseq.encode"),Ak.forEach(t),Ep=i(qr," starts with a space."),qr.forEach(t),Pp=l(xt),Ks=a(xt,"LI",{});var lk=s(Ks);Zs=a(lk,"A",{href:!0});var Sk=s(Zs);Cp=i(Sk,"generate()"),Sk.forEach(t),Ap=i(lk,` should be used for conditional generation tasks like
summarization, see the example in that docstrings.`),lk.forEach(t),Sp=l(xt),Rt=a(xt,"LI",{});var Br=s(Rt);Ip=i(Br,"Models that load the "),ri=a(Br,"EM",{});var Ik=s(ri);Op=i(Ik,"facebook/bart-large-cnn"),Ik.forEach(t),Np=i(Br," weights will not have a "),ii=a(Br,"CODE",{});var Ok=s(ii);Dp=i(Ok,"mask_token_id"),Ok.forEach(t),Lp=i(Br,`, or be able to perform
mask-filling tasks.`),Br.forEach(t),xt.forEach(t),wl=l(o),Ut=a(o,"H2",{class:!0});var ac=s(Ut);wo=a(ac,"A",{id:!0,class:!0,href:!0});var Nk=s(wo);di=a(Nk,"SPAN",{});var Dk=s(di);f(bn.$$.fragment,Dk),Dk.forEach(t),Nk.forEach(t),Gp=l(ac),li=a(ac,"SPAN",{});var Lk=s(li);Wp=i(Lk,"Mask Filling"),Lk.forEach(t),ac.forEach(t),xl=l(o),ht=a(o,"P",{});var Fr=s(ht);Rp=i(Fr,"The "),ci=a(Fr,"CODE",{});var Gk=s(ci);Up=i(Gk,"facebook/bart-base"),Gk.forEach(t),Hp=i(Fr," and "),pi=a(Fr,"CODE",{});var Wk=s(pi);Qp=i(Wk,"facebook/bart-large"),Wk.forEach(t),Vp=i(Fr," checkpoints can be used to fill multi-token masks."),Fr.forEach(t),zl=l(o),f(kn.$$.fragment,o),ql=l(o),Ht=a(o,"H2",{class:!0});var sc=s(Ht);xo=a(sc,"A",{id:!0,class:!0,href:!0});var Rk=s(xo);ui=a(Rk,"SPAN",{});var Uk=s(ui);f(yn.$$.fragment,Uk),Uk.forEach(t),Rk.forEach(t),Jp=l(sc),hi=a(sc,"SPAN",{});var Hk=s(hi);Xp=i(Hk,"BartConfig"),Hk.forEach(t),sc.forEach(t),Bl=l(o),Te=a(o,"DIV",{class:!0});var zt=s(Te);f(vn.$$.fragment,zt),Kp=l(zt),Qt=a(zt,"P",{});var $r=s(Qt);Zp=i($r,"This is the configuration class to store the configuration of a "),Ys=a($r,"A",{href:!0});var Qk=s(Ys);Yp=i(Qk,"BartModel"),Qk.forEach(t),eu=i($r,`. It is used to instantiate a BART
model according to the specified arguments, defining the model architecture. Instantiating a configuration with the
defaults will yield a similar configuration to that of the BART
`),Tn=a($r,"A",{href:!0,rel:!0});var Vk=s(Tn);tu=i(Vk,"facebook/bart-large"),Vk.forEach(t),ou=i($r," architecture."),$r.forEach(t),nu=l(zt),Vt=a(zt,"P",{});var jr=s(Vt);au=i(jr,"Configuration objects inherit from "),er=a(jr,"A",{href:!0});var Jk=s(er);su=i(Jk,"PretrainedConfig"),Jk.forEach(t),ru=i(jr,` and can be used to control the model outputs. Read the
documentation from `),tr=a(jr,"A",{href:!0});var Xk=s(tr);iu=i(Xk,"PretrainedConfig"),Xk.forEach(t),du=i(jr," for more information."),jr.forEach(t),lu=l(zt),mi=a(zt,"P",{});var Kk=s(mi);cu=i(Kk,"Example:"),Kk.forEach(t),pu=l(zt),f(wn.$$.fragment,zt),zt.forEach(t),Fl=l(o),Jt=a(o,"H2",{class:!0});var rc=s(Jt);zo=a(rc,"A",{id:!0,class:!0,href:!0});var Zk=s(zo);fi=a(Zk,"SPAN",{});var Yk=s(fi);f(xn.$$.fragment,Yk),Yk.forEach(t),Zk.forEach(t),uu=l(rc),_i=a(rc,"SPAN",{});var ey=s(_i);hu=i(ey,"BartTokenizer"),ey.forEach(t),rc.forEach(t),$l=l(o),E=a(o,"DIV",{class:!0});var L=s(E);f(zn.$$.fragment,L),mu=l(L),gi=a(L,"P",{});var ty=s(gi);fu=i(ty,"Constructs a BART tokenizer, which is smilar to the ROBERTa tokenizer, using byte-level Byte-Pair-Encoding."),ty.forEach(t),_u=l(L),bi=a(L,"P",{});var oy=s(bi);gu=i(oy,`This tokenizer has been trained to treat spaces like parts of the tokens (a bit like sentencepiece) so a word will
be encoded differently whether it is at the beginning of the sentence (without space) or not:`),oy.forEach(t),bu=l(L),f(qn.$$.fragment,L),ku=l(L),Bn=a(L,"P",{});var ic=s(Bn);yu=i(ic,"You can get around that behavior by passing "),ki=a(ic,"CODE",{});var ny=s(ki);vu=i(ny,"add_prefix_space=True"),ny.forEach(t),Tu=i(ic,` when instantiating this tokenizer or when you
call it on some text, but since the model was not pretrained this way, it might yield a decrease in performance.`),ic.forEach(t),wu=l(L),f(qo.$$.fragment,L),xu=l(L),Fn=a(L,"P",{});var dc=s(Fn);zu=i(dc,"This tokenizer inherits from "),or=a(dc,"A",{href:!0});var ay=s(or);qu=i(ay,"PreTrainedTokenizer"),ay.forEach(t),Bu=i(dc,` which contains most of the main methods. Users should refer to
this superclass for more information regarding those methods.`),dc.forEach(t),Fu=l(L),mt=a(L,"DIV",{class:!0});var Mr=s(mt);f($n.$$.fragment,Mr),$u=l(Mr),yi=a(Mr,"P",{});var sy=s(yi);ju=i(sy,`Build model inputs from a sequence or a pair of sequence for sequence classification tasks by concatenating and
adding special tokens. A BART sequence has the following format:`),sy.forEach(t),Mu=l(Mr),jn=a(Mr,"UL",{});var lc=s(jn);nr=a(lc,"LI",{});var ck=s(nr);Eu=i(ck,"single sequence: "),vi=a(ck,"CODE",{});var ry=s(vi);Pu=i(ry,"<s> X </s>"),ry.forEach(t),ck.forEach(t),Cu=l(lc),ar=a(lc,"LI",{});var pk=s(ar);Au=i(pk,"pair of sequences: "),Ti=a(pk,"CODE",{});var iy=s(Ti);Su=i(iy,"<s> A </s></s> B </s>"),iy.forEach(t),pk.forEach(t),lc.forEach(t),Mr.forEach(t),Iu=l(L),Bo=a(L,"DIV",{class:!0});var cc=s(Bo);f(Mn.$$.fragment,cc),Ou=l(cc),wi=a(cc,"P",{});var dy=s(wi);Nu=i(dy,"Converts a sequence of tokens (string) in a single string."),dy.forEach(t),cc.forEach(t),Du=l(L),Fo=a(L,"DIV",{class:!0});var pc=s(Fo);f(En.$$.fragment,pc),Lu=l(pc),xi=a(pc,"P",{});var ly=s(xi);Gu=i(ly,`Create a mask from the two sequences passed to be used in a sequence-pair classification task. BART does not
make use of token type ids, therefore a list of zeros is returned.`),ly.forEach(t),pc.forEach(t),Wu=l(L),$o=a(L,"DIV",{class:!0});var uc=s($o);f(Pn.$$.fragment,uc),Ru=l(uc),Cn=a(uc,"P",{});var hc=s(Cn);Uu=i(hc,`Retrieve sequence ids from a token list that has no special tokens added. This method is called when adding
special tokens using the tokenizer `),zi=a(hc,"CODE",{});var cy=s(zi);Hu=i(cy,"prepare_for_model"),cy.forEach(t),Qu=i(hc," method."),hc.forEach(t),uc.forEach(t),L.forEach(t),jl=l(o),Xt=a(o,"H2",{class:!0});var mc=s(Xt);jo=a(mc,"A",{id:!0,class:!0,href:!0});var py=s(jo);qi=a(py,"SPAN",{});var uy=s(qi);f(An.$$.fragment,uy),uy.forEach(t),py.forEach(t),Vu=l(mc),Bi=a(mc,"SPAN",{});var hy=s(Bi);Ju=i(hy,"BartTokenizerFast"),hy.forEach(t),mc.forEach(t),Ml=l(o),G=a(o,"DIV",{class:!0});var he=s(G);f(Sn.$$.fragment,he),Xu=l(he),In=a(he,"P",{});var fc=s(In);Ku=i(fc,"Construct a \u201Cfast\u201D BART tokenizer (backed by HuggingFace\u2019s "),Fi=a(fc,"EM",{});var my=s(Fi);Zu=i(my,"tokenizers"),my.forEach(t),Yu=i(fc,` library), derived from the GPT-2 tokenizer,
using byte-level Byte-Pair-Encoding.`),fc.forEach(t),eh=l(he),$i=a(he,"P",{});var fy=s($i);th=i(fy,`This tokenizer has been trained to treat spaces like parts of the tokens (a bit like sentencepiece) so a word will
be encoded differently whether it is at the beginning of the sentence (without space) or not:`),fy.forEach(t),oh=l(he),f(On.$$.fragment,he),nh=l(he),Nn=a(he,"P",{});var _c=s(Nn);ah=i(_c,"You can get around that behavior by passing "),ji=a(_c,"CODE",{});var _y=s(ji);sh=i(_y,"add_prefix_space=True"),_y.forEach(t),rh=i(_c,` when instantiating this tokenizer or when you
call it on some text, but since the model was not pretrained this way, it might yield a decrease in performance.`),_c.forEach(t),ih=l(he),f(Mo.$$.fragment,he),dh=l(he),Dn=a(he,"P",{});var gc=s(Dn);lh=i(gc,"This tokenizer inherits from "),sr=a(gc,"A",{href:!0});var gy=s(sr);ch=i(gy,"PreTrainedTokenizerFast"),gy.forEach(t),ph=i(gc,` which contains most of the main methods. Users should
refer to this superclass for more information regarding those methods.`),gc.forEach(t),uh=l(he),Eo=a(he,"DIV",{class:!0});var bc=s(Eo);f(Ln.$$.fragment,bc),hh=l(bc),Mi=a(bc,"P",{});var by=s(Mi);mh=i(by,`Create a mask from the two sequences passed to be used in a sequence-pair classification task. BART does not
make use of token type ids, therefore a list of zeros is returned.`),by.forEach(t),bc.forEach(t),he.forEach(t),El=l(o),Kt=a(o,"H2",{class:!0});var kc=s(Kt);Po=a(kc,"A",{id:!0,class:!0,href:!0});var ky=s(Po);Ei=a(ky,"SPAN",{});var yy=s(Ei);f(Gn.$$.fragment,yy),yy.forEach(t),ky.forEach(t),fh=l(kc),Pi=a(kc,"SPAN",{});var vy=s(Pi);_h=i(vy,"BartModel"),vy.forEach(t),kc.forEach(t),Pl=l(o),Qe=a(o,"DIV",{class:!0});var sn=s(Qe);f(Wn.$$.fragment,sn),gh=l(sn),Rn=a(sn,"P",{});var yc=s(Rn);bh=i(yc,`The bare BART Model outputting raw hidden-states without any specific head on top.
This model inherits from `),rr=a(yc,"A",{href:!0});var Ty=s(rr);kh=i(Ty,"PreTrainedModel"),Ty.forEach(t),yh=i(yc,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),yc.forEach(t),vh=l(sn),Un=a(sn,"P",{});var vc=s(Un);Th=i(vc,"This model is also a PyTorch "),Hn=a(vc,"A",{href:!0,rel:!0});var wy=s(Hn);wh=i(wy,"torch.nn.Module"),wy.forEach(t),xh=i(vc,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),vc.forEach(t),zh=l(sn),je=a(sn,"DIV",{class:!0});var qt=s(je);f(Qn.$$.fragment,qt),qh=l(qt),Zt=a(qt,"P",{});var Er=s(Zt);Bh=i(Er,"The "),ir=a(Er,"A",{href:!0});var xy=s(ir);Fh=i(xy,"BartModel"),xy.forEach(t),$h=i(Er," forward method, overrides the "),Ci=a(Er,"CODE",{});var zy=s(Ci);jh=i(zy,"__call__"),zy.forEach(t),Mh=i(Er," special method."),Er.forEach(t),Eh=l(qt),f(Co.$$.fragment,qt),Ph=l(qt),Ai=a(qt,"P",{});var qy=s(Ai);Ch=i(qy,"Example:"),qy.forEach(t),Ah=l(qt),f(Vn.$$.fragment,qt),qt.forEach(t),sn.forEach(t),Cl=l(o),Yt=a(o,"H2",{class:!0});var Tc=s(Yt);Ao=a(Tc,"A",{id:!0,class:!0,href:!0});var By=s(Ao);Si=a(By,"SPAN",{});var Fy=s(Si);f(Jn.$$.fragment,Fy),Fy.forEach(t),By.forEach(t),Sh=l(Tc),Ii=a(Tc,"SPAN",{});var $y=s(Ii);Ih=i($y,"BartForConditionalGeneration"),$y.forEach(t),Tc.forEach(t),Al=l(o),Ve=a(o,"DIV",{class:!0});var rn=s(Ve);f(Xn.$$.fragment,rn),Oh=l(rn),Kn=a(rn,"P",{});var wc=s(Kn);Nh=i(wc,`The BART Model with a language modeling head. Can be used for summarization.
This model inherits from `),dr=a(wc,"A",{href:!0});var jy=s(dr);Dh=i(jy,"PreTrainedModel"),jy.forEach(t),Lh=i(wc,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),wc.forEach(t),Gh=l(rn),Zn=a(rn,"P",{});var xc=s(Zn);Wh=i(xc,"This model is also a PyTorch "),Yn=a(xc,"A",{href:!0,rel:!0});var My=s(Yn);Rh=i(My,"torch.nn.Module"),My.forEach(t),Uh=i(xc,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),xc.forEach(t),Hh=l(rn),K=a(rn,"DIV",{class:!0});var Se=s(K);f(ea.$$.fragment,Se),Qh=l(Se),eo=a(Se,"P",{});var Pr=s(eo);Vh=i(Pr,"The "),lr=a(Pr,"A",{href:!0});var Ey=s(lr);Jh=i(Ey,"BartForConditionalGeneration"),Ey.forEach(t),Xh=i(Pr," forward method, overrides the "),Oi=a(Pr,"CODE",{});var Py=s(Oi);Kh=i(Py,"__call__"),Py.forEach(t),Zh=i(Pr," special method."),Pr.forEach(t),Yh=l(Se),f(So.$$.fragment,Se),em=l(Se),Ni=a(Se,"P",{});var Cy=s(Ni);tm=i(Cy,"Summarization example:"),Cy.forEach(t),om=l(Se),f(ta.$$.fragment,Se),nm=l(Se),Di=a(Se,"P",{});var Ay=s(Di);am=i(Ay,"Mask filling example:"),Ay.forEach(t),sm=l(Se),f(oa.$$.fragment,Se),Se.forEach(t),rn.forEach(t),Sl=l(o),to=a(o,"H2",{class:!0});var zc=s(to);Io=a(zc,"A",{id:!0,class:!0,href:!0});var Sy=s(Io);Li=a(Sy,"SPAN",{});var Iy=s(Li);f(na.$$.fragment,Iy),Iy.forEach(t),Sy.forEach(t),rm=l(zc),Gi=a(zc,"SPAN",{});var Oy=s(Gi);im=i(Oy,"BartForSequenceClassification"),Oy.forEach(t),zc.forEach(t),Il=l(o),we=a(o,"DIV",{class:!0});var Bt=s(we);f(aa.$$.fragment,Bt),dm=l(Bt),Wi=a(Bt,"P",{});var Ny=s(Wi);lm=i(Ny,`Bart model with a sequence classification/head on top (a linear layer on top of the pooled output) e.g. for GLUE
tasks.`),Ny.forEach(t),cm=l(Bt),sa=a(Bt,"P",{});var qc=s(sa);pm=i(qc,"This model inherits from "),cr=a(qc,"A",{href:!0});var Dy=s(cr);um=i(Dy,"PreTrainedModel"),Dy.forEach(t),hm=i(qc,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),jc.forEach(t),Vm=l(Ft),Me=a(Ft,"DIV",{class:!0});var $t=s(Me);f(_a.$$.fragment,$t),Jm=l($t),so=a($t,"P",{});var Sr=s(so);Xm=i(Sr,"The "),hr=a(Sr,"A",{href:!0});var Yy=s(hr);Km=i(Yy,"BartForQuestionAnswering"),Yy.forEach(t),Zm=i(Sr," forward method, overrides the "),Ki=a(Sr,"CODE",{});var ev=s(Ki);Ym=i(ev,"__call__"),ev.forEach(t),ef=i(Sr," special method."),Sr.forEach(t),tf=l($t),f(Do.$$.fragment,$t),of=l($t),Zi=a($t,"P",{});var tv=s(Zi);nf=i(tv,"Example:"),tv.forEach(t),af=l($t),f(ga.$$.fragment,$t),$t.forEach(t),Ft.forEach(t),Dl=l(o),ro=a(o,"H2",{class:!0});var Mc=s(ro);Lo=a(Mc,"A",{id:!0,class:!0,href:!0});var ov=s(Lo);Yi=a(ov,"SPAN",{});var nv=s(Yi);f(ba.$$.fragment,nv),nv.forEach(t),ov.forEach(t),sf=l(Mc),ed=a(Mc,"SPAN",{});var av=s(ed);rf=i(av,"BartForCausalLM"),av.forEach(t),Mc.forEach(t),Ll=l(o),ka=a(o,"DIV",{class:!0});var sv=s(ka);ft=a(sv,"DIV",{class:!0});var Ir=s(ft);f(ya.$$.fragment,Ir),df=l(Ir),td=a(Ir,"P",{});var rv=s(td);lf=i(rv,"Example:"),rv.forEach(t),cf=l(Ir),f(va.$$.fragment,Ir),Ir.forEach(t),sv.forEach(t),Gl=l(o),io=a(o,"H2",{class:!0});var Ec=s(io);Go=a(Ec,"A",{id:!0,class:!0,href:!0});var iv=s(Go);od=a(iv,"SPAN",{});var dv=s(od);f(Ta.$$.fragment,dv),dv.forEach(t),iv.forEach(t),pf=l(Ec),nd=a(Ec,"SPAN",{});var lv=s(nd);uf=i(lv,"TFBartModel"),lv.forEach(t),Ec.forEach(t),Wl=l(o),ze=a(o,"DIV",{class:!0});var jt=s(ze);f(wa.$$.fragment,jt),hf=l(jt),xa=a(jt,"P",{});var Pc=s(xa);mf=i(Pc,`The bare BART Model outputting raw hidden-states without any specific head on top.
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Pc.forEach(t),gf=l(jt),za=a(jt,"P",{});var Cc=s(za);bf=i(Cc,"This model is also a "),qa=a(Cc,"A",{href:!0,rel:!0});var pv=s(qa);kf=i(pv,"tf.keras.Model"),pv.forEach(t),yf=i(Cc,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Cc.forEach(t),vf=l(jt),f(Wo.$$.fragment,jt),Tf=l(jt),Ee=a(jt,"DIV",{class:!0});var Mt=s(Ee);f(Ba.$$.fragment,Mt),wf=l(Mt),lo=a(Mt,"P",{});var Or=s(lo);xf=i(Or,"The "),fr=a(Or,"A",{href:!0});var uv=s(fr);zf=i(uv,"TFBartModel"),uv.forEach(t),qf=i(Or," forward method, overrides the "),ad=a(Or,"CODE",{});var hv=s(ad);Bf=i(hv,"__call__"),hv.forEach(t),Ff=i(Or," special method."),Or.forEach(t),$f=l(Mt),f(Ro.$$.fragment,Mt),jf=l(Mt),sd=a(Mt,"P",{});var mv=s(sd);Mf=i(mv,"Example:"),mv.forEach(t),Ef=l(Mt),f(Fa.$$.fragment,Mt),Mt.forEach(t),jt.forEach(t),Rl=l(o),co=a(o,"H2",{class:!0});var Ac=s(co);Uo=a(Ac,"A",{id:!0,class:!0,href:!0});var fv=s(Uo);rd=a(fv,"SPAN",{});var _v=s(rd);f($a.$$.fragment,_v),_v.forEach(t),fv.forEach(t),Pf=l(Ac),id=a(Ac,"SPAN",{});var gv=s(id);Cf=i(gv,"TFBartForConditionalGeneration"),gv.forEach(t),Ac.forEach(t),Ul=l(o),qe=a(o,"DIV",{class:!0});var Et=s(qe);f(ja.$$.fragment,Et),Af=l(Et),Ma=a(Et,"P",{});var Sc=s(Ma);Sf=i(Sc,`The BART Model with a language modeling head. Can be used for summarization.
This model inherits from `),_r=a(Sc,"A",{href:!0});var bv=s(_r);If=i(bv,"TFPreTrainedModel"),bv.forEach(t),Of=i(Sc,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Sc.forEach(t),Nf=l(Et),Ea=a(Et,"P",{});var Ic=s(Ea);Df=i(Ic,"This model is also a "),Pa=a(Ic,"A",{href:!0,rel:!0});var kv=s(Pa);Lf=i(kv,"tf.keras.Model"),kv.forEach(t),Gf=i(Ic,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Ic.forEach(t),Wf=l(Et),f(Ho.$$.fragment,Et),Rf=l(Et),Y=a(Et,"DIV",{class:!0});var Oe=s(Y);f(Ca.$$.fragment,Oe),Uf=l(Oe),po=a(Oe,"P",{});var Nr=s(po);Hf=i(Nr,"The "),gr=a(Nr,"A",{href:!0});var yv=s(gr);Qf=i(yv,"TFBartForConditionalGeneration"),yv.forEach(t),Vf=i(Nr," forward method, overrides the "),dd=a(Nr,"CODE",{});var vv=s(dd);Jf=i(vv,"__call__"),vv.forEach(t),Xf=i(Nr," special method."),Nr.forEach(t),Kf=l(Oe),f(Qo.$$.fragment,Oe),Zf=l(Oe),ld=a(Oe,"P",{});var Tv=s(ld);Yf=i(Tv,"Summarization example:"),Tv.forEach(t),e_=l(Oe),f(Aa.$$.fragment,Oe),t_=l(Oe),cd=a(Oe,"P",{});var wv=s(cd);o_=i(wv,"Mask filling example:"),wv.forEach(t),n_=l(Oe),f(Sa.$$.fragment,Oe),Oe.forEach(t),Et.forEach(t),Hl=l(o),uo=a(o,"H2",{class:!0});var Oc=s(uo);Vo=a(Oc,"A",{id:!0,class:!0,href:!0});var xv=s(Vo);pd=a(xv,"SPAN",{});var zv=s(pd);f(Ia.$$.fragment,zv),zv.forEach(t),xv.forEach(t),a_=l(Oc),ud=a(Oc,"SPAN",{});var qv=s(ud);s_=i(qv,"FlaxBartModel"),qv.forEach(t),Oc.forEach(t),Ql=l(o),W=a(o,"DIV",{class:!0});var me=s(W);f(Oa.$$.fragment,me),r_=l(me),Na=a(me,"P",{});var Nc=s(Na);i_=i(Nc,`The bare Bart Model transformer outputting raw hidden-states without any specific head on top.
This model inherits from `),br=a(Nc,"A",{href:!0});var Bv=s(br);d_=i(Bv,"FlaxPreTrainedModel"),Bv.forEach(t),l_=i(Nc,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Nc.forEach(t),c_=l(me),Da=a(me,"P",{});var Dc=s(Da);p_=i(Dc,`This model is also a Flax Linen
`),La=a(Dc,"A",{href:!0,rel:!0});var Fv=s(La);u_=i(Fv,"flax.nn.Module"),Fv.forEach(t),h_=i(Dc,` subclass. Use it as a
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),Dc.forEach(t),m_=l(me),hd=a(me,"P",{});var $v=s(hd);f_=i($v,"Finally, this model supports inherent JAX features such as:"),$v.forEach(t),__=l(me),dt=a(me,"UL",{});var dn=s(dt);md=a(dn,"LI",{});var jv=s(md);Ga=a(jv,"A",{href:!0,rel:!0});var Mv=s(Ga);g_=i(Mv,"Just-In-Time (JIT) compilation"),Mv.forEach(t),jv.forEach(t),b_=l(dn),fd=a(dn,"LI",{});var Ev=s(fd);Wa=a(Ev,"A",{href:!0,rel:!0});var Pv=s(Wa);k_=i(Pv,"Automatic Differentiation"),Pv.forEach(t),Ev.forEach(t),y_=l(dn),_d=a(dn,"LI",{});var Cv=s(_d);Ra=a(Cv,"A",{href:!0,rel:!0});var Av=s(Ra);v_=i(Av,"Vectorization"),Av.forEach(t),Cv.forEach(t),T_=l(dn),gd=a(dn,"LI",{});var Sv=s(gd);Ua=a(Sv,"A",{href:!0,rel:!0});var Iv=s(Ua);w_=i(Iv,"Parallelization"),Iv.forEach(t),Sv.forEach(t),dn.forEach(t),x_=l(me),Pe=a(me,"DIV",{class:!0});var Pt=s(Pe);f(Ha.$$.fragment,Pt),z_=l(Pt),ho=a(Pt,"P",{});var Dr=s(ho);q_=i(Dr,"The "),bd=a(Dr,"CODE",{});var Ov=s(bd);B_=i(Ov,"FlaxBartPreTrainedModel"),Ov.forEach(t),F_=i(Dr,"forward method, overrides the "),kd=a(Dr,"CODE",{});var Nv=s(kd);$_=i(Nv,"__call__"),Nv.forEach(t),j_=i(Dr," special method."),Dr.forEach(t),M_=l(Pt),f(Jo.$$.fragment,Pt),E_=l(Pt),yd=a(Pt,"P",{});var Dv=s(yd);P_=i(Dv,"Example:"),Dv.forEach(t),C_=l(Pt),f(Qa.$$.fragment,Pt),Pt.forEach(t),A_=l(me),_t=a(me,"DIV",{class:!0});var Lr=s(_t);f(Va.$$.fragment,Lr),S_=l(Lr),vd=a(Lr,"P",{});var Lv=s(vd);I_=i(Lv,"Example:"),Lv.forEach(t),O_=l(Lr),f(Ja.$$.fragment,Lr),Lr.forEach(t),N_=l(me),gt=a(me,"DIV",{class:!0});var Gr=s(gt);f(Xa.$$.fragment,Gr),D_=l(Gr),Td=a(Gr,"P",{});var Gv=s(Td);L_=i(Gv,"Example:"),Gv.forEach(t),G_=l(Gr),f(Ka.$$.fragment,Gr),Gr.forEach(t),me.forEach(t),Vl=l(o),mo=a(o,"H2",{class:!0});var Lc=s(mo);Xo=a(Lc,"A",{id:!0,class:!0,href:!0});var Wv=s(Xo);wd=a(Wv,"SPAN",{});var Rv=s(wd);f(Za.$$.fragment,Rv),Rv.forEach(t),Wv.forEach(t),W_=l(Lc),xd=a(Lc,"SPAN",{});var Uv=s(xd);R_=i(Uv,"FlaxBartForConditionalGeneration"),Uv.forEach(t),Lc.forEach(t),Jl=l(o),R=a(o,"DIV",{class:!0});var fe=s(R);f(Ya.$$.fragment,fe),U_=l(fe),es=a(fe,"P",{});var Gc=s(es);H_=i(Gc,`The BART Model with a language modeling head. Can be used for summarization.
This model inherits from `),kr=a(Gc,"A",{href:!0});var Hv=s(kr);Q_=i(Hv,"FlaxPreTrainedModel"),Hv.forEach(t),V_=i(Gc,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),Wc.forEach(t),Y_=l(fe),zd=a(fe,"P",{});var Vv=s(zd);eg=i(Vv,"Finally, this model supports inherent JAX features such as:"),Vv.forEach(t),tg=l(fe),lt=a(fe,"UL",{});var ln=s(lt);qd=a(ln,"LI",{});var Jv=s(qd);ns=a(Jv,"A",{href:!0,rel:!0});var Xv=s(ns);og=i(Xv,"Just-In-Time (JIT) compilation"),Xv.forEach(t),Jv.forEach(t),ng=l(ln),Bd=a(ln,"LI",{});var Kv=s(Bd);as=a(Kv,"A",{href:!0,rel:!0});var Zv=s(as);ag=i(Zv,"Automatic Differentiation"),Zv.forEach(t),Kv.forEach(t),sg=l(ln),Fd=a(ln,"LI",{});var Yv=s(Fd);ss=a(Yv,"A",{href:!0,rel:!0});var eT=s(ss);rg=i(eT,"Vectorization"),eT.forEach(t),Yv.forEach(t),ig=l(ln),$d=a(ln,"LI",{});var tT=s($d);rs=a(tT,"A",{href:!0,rel:!0});var oT=s(rs);dg=i(oT,"Parallelization"),oT.forEach(t),tT.forEach(t),ln.forEach(t),lg=l(fe),ee=a(fe,"DIV",{class:!0});var Ne=s(ee);f(is.$$.fragment,Ne),cg=l(Ne),fo=a(Ne,"P",{});var Wr=s(fo);pg=i(Wr,"The "),jd=a(Wr,"CODE",{});var nT=s(jd);ug=i(nT,"FlaxBartPreTrainedModel"),nT.forEach(t),hg=i(Wr,"forward method, overrides the "),Md=a(Wr,"CODE",{});var aT=s(Md);mg=i(aT,"__call__"),aT.forEach(t),fg=i(Wr," special method."),Wr.forEach(t),_g=l(Ne),f(Ko.$$.fragment,Ne),gg=l(Ne),Ed=a(Ne,"P",{});var sT=s(Ed);bg=i(sT,"Summarization example:"),sT.forEach(t),kg=l(Ne),f(ds.$$.fragment,Ne),yg=l(Ne),Pd=a(Ne,"P",{});var rT=s(Pd);vg=i(rT,"Mask filling example:"),rT.forEach(t),Tg=l(Ne),f(ls.$$.fragment,Ne),Ne.forEach(t),wg=l(fe),bt=a(fe,"DIV",{class:!0});var Rr=s(bt);f(cs.$$.fragment,Rr),xg=l(Rr),Cd=a(Rr,"P",{});var iT=s(Cd);zg=i(iT,"Example:"),iT.forEach(t),qg=l(Rr),f(ps.$$.fragment,Rr),Rr.forEach(t),Bg=l(fe),kt=a(fe,"DIV",{class:!0});var Ur=s(kt);f(us.$$.fragment,Ur),Fg=l(Ur),Ad=a(Ur,"P",{});var dT=s(Ad);$g=i(dT,"Example:"),dT.forEach(t),jg=l(Ur),f(hs.$$.fragment,Ur),Ur.forEach(t),fe.forEach(t),Xl=l(o),_o=a(o,"H2",{class:!0});var Rc=s(_o);Zo=a(Rc,"A",{id:!0,class:!0,href:!0});var lT=s(Zo);Sd=a(lT,"SPAN",{});var cT=s(Sd);f(ms.$$.fragment,cT),cT.forEach(t),lT.forEach(t),Mg=l(Rc),Id=a(Rc,"SPAN",{});var pT=s(Id);Eg=i(pT,"FlaxBartForSequenceClassification"),pT.forEach(t),Rc.forEach(t),Kl=l(o),I=a(o,"DIV",{class:!0});var te=s(I);f(fs.$$.fragment,te),Pg=l(te),Od=a(te,"P",{});var uT=s(Od);Cg=i(uT,`Bart model with a sequence classification/head on top (a linear layer on top of the pooled output) e.g. for GLUE
tasks.`),uT.forEach(t),Ag=l(te),_s=a(te,"P",{});var Uc=s(_s);Sg=i(Uc,"This model inherits from "),yr=a(Uc,"A",{href:!0});var hT=s(yr);Ig=i(hT,"FlaxPreTrainedModel"),hT.forEach(t),Og=i(Uc,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Uc.forEach(t),Ng=l(te),gs=a(te,"P",{});var Hc=s(gs);Dg=i(Hc,`This model is also a Flax Linen
`),bs=a(Hc,"A",{href:!0,rel:!0});var mT=s(bs);Lg=i(mT,"flax.nn.Module"),mT.forEach(t),Gg=i(Hc,` subclass. Use it as a
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),Hc.forEach(t),Wg=l(te),Nd=a(te,"P",{});var fT=s(Nd);Rg=i(fT,"Finally, this model supports inherent JAX features such as:"),fT.forEach(t),Ug=l(te),ct=a(te,"UL",{});var cn=s(ct);Dd=a(cn,"LI",{});var _T=s(Dd);ks=a(_T,"A",{href:!0,rel:!0});var gT=s(ks);Hg=i(gT,"Just-In-Time (JIT) compilation"),gT.forEach(t),_T.forEach(t),Qg=l(cn),Ld=a(cn,"LI",{});var bT=s(Ld);ys=a(bT,"A",{href:!0,rel:!0});var kT=s(ys);Vg=i(kT,"Automatic Differentiation"),kT.forEach(t),bT.forEach(t),Jg=l(cn),Gd=a(cn,"LI",{});var yT=s(Gd);vs=a(yT,"A",{href:!0,rel:!0});var vT=s(vs);Xg=i(vT,"Vectorization"),vT.forEach(t),yT.forEach(t),Kg=l(cn),Wd=a(cn,"LI",{});var TT=s(Wd);Ts=a(TT,"A",{href:!0,rel:!0});var wT=s(Ts);Zg=i(wT,"Parallelization"),wT.forEach(t),TT.forEach(t),cn.forEach(t),Yg=l(te),Ce=a(te,"DIV",{class:!0});var Ct=s(Ce);f(ws.$$.fragment,Ct),eb=l(Ct),go=a(Ct,"P",{});var Hr=s(go);tb=i(Hr,"The "),Rd=a(Hr,"CODE",{});var xT=s(Rd);ob=i(xT,"FlaxBartPreTrainedModel"),xT.forEach(t),nb=i(Hr,"forward method, overrides the "),Ud=a(Hr,"CODE",{});var zT=s(Ud);ab=i(zT,"__call__"),zT.forEach(t),sb=i(Hr," special method."),Hr.forEach(t),rb=l(Ct),f(Yo.$$.fragment,Ct),ib=l(Ct),Hd=a(Ct,"P",{});var qT=s(Hd);db=i(qT,"Example:"),qT.forEach(t),lb=l(Ct),f(xs.$$.fragment,Ct),Ct.forEach(t),cb=l(te),yt=a(te,"DIV",{class:!0});var Qr=s(yt);f(zs.$$.fragment,Qr),pb=l(Qr),Qd=a(Qr,"P",{});var BT=s(Qd);ub=i(BT,"Example:"),BT.forEach(t),hb=l(Qr),f(qs.$$.fragment,Qr),Qr.forEach(t),mb=l(te),vt=a(te,"DIV",{class:!0});var Vr=s(vt);f(Bs.$$.fragment,Vr),fb=l(Vr),Vd=a(Vr,"P",{});var FT=s(Vd);_b=i(FT,"Example:"),FT.forEach(t),gb=l(Vr),f(Fs.$$.fragment,Vr),Vr.forEach(t),te.forEach(t),Zl=l(o),bo=a(o,"H2",{class:!0});var Qc=s(bo);en=a(Qc,"A",{id:!0,class:!0,href:!0});var $T=s(en);Jd=a($T,"SPAN",{});var jT=s(Jd);f($s.$$.fragment,jT),jT.forEach(t),$T.forEach(t),bb=l(Qc),Xd=a(Qc,"SPAN",{});var MT=s(Xd);kb=i(MT,"FlaxBartForQuestionAnswering"),MT.forEach(t),Qc.forEach(t),Yl=l(o),O=a(o,"DIV",{class:!0});var oe=s(O);f(js.$$.fragment,oe),yb=l(oe),ko=a(oe,"P",{});var Jr=s(ko);vb=i(Jr,`BART Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
layer on top of the hidden-states output to compute `),Kd=a(Jr,"CODE",{});var ET=s(Kd);Tb=i(ET,"span start logits"),ET.forEach(t),wb=i(Jr," and "),Zd=a(Jr,"CODE",{});var PT=s(Zd);xb=i(PT,"span end logits"),PT.forEach(t),zb=i(Jr,")."),Jr.forEach(t),qb=l(oe),Ms=a(oe,"P",{});var Vc=s(Ms);Bb=i(Vc,"This model inherits from "),vr=a(Vc,"A",{href:!0});var CT=s(vr);Fb=i(CT,"FlaxPreTrainedModel"),CT.forEach(t),$b=i(Vc,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Vc.forEach(t),jb=l(oe),Es=a(oe,"P",{});var Jc=s(Es);Mb=i(Jc,`This model is also a Flax Linen
`),Ps=a(Jc,"A",{href:!0,rel:!0});var AT=s(Ps);Eb=i(AT,"flax.nn.Module"),AT.forEach(t),Pb=i(Jc,` subclass. Use it as a
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),Jc.forEach(t),Cb=l(oe),Yd=a(oe,"P",{});var ST=s(Yd);Ab=i(ST,"Finally, this model supports inherent JAX features such as:"),ST.forEach(t),Sb=l(oe),pt=a(oe,"UL",{});var pn=s(pt);el=a(pn,"LI",{});var IT=s(el);Cs=a(IT,"A",{href:!0,rel:!0});var OT=s(Cs);Ib=i(OT,"Just-In-Time (JIT) compilation"),OT.forEach(t),IT.forEach(t),Ob=l(pn),tl=a(pn,"LI",{});var NT=s(tl);As=a(NT,"A",{href:!0,rel:!0});var DT=s(As);Nb=i(DT,"Automatic Differentiation"),DT.forEach(t),NT.forEach(t),Db=l(pn),ol=a(pn,"LI",{});var LT=s(ol);Ss=a(LT,"A",{href:!0,rel:!0});var GT=s(Ss);Lb=i(GT,"Vectorization"),GT.forEach(t),LT.forEach(t),Gb=l(pn),nl=a(pn,"LI",{});var WT=s(nl);Is=a(WT,"A",{href:!0,rel:!0});var RT=s(Is);Wb=i(RT,"Parallelization"),RT.forEach(t),WT.forEach(t),pn.forEach(t),Rb=l(oe),Ae=a(oe,"DIV",{class:!0});var At=s(Ae);f(Os.$$.fragment,At),Ub=l(At),yo=a(At,"P",{});var Xr=s(yo);Hb=i(Xr,"The "),al=a(Xr,"CODE",{});var UT=s(al);Qb=i(UT,"FlaxBartPreTrainedModel"),UT.forEach(t),Vb=i(Xr,"forward method, overrides the "),sl=a(Xr,"CODE",{});var HT=s(sl);Jb=i(HT,"__call__"),HT.forEach(t),Xb=i(Xr," special method."),Xr.forEach(t),Kb=l(At),f(tn.$$.fragment,At),Zb=l(At),rl=a(At,"P",{});var QT=s(rl);Yb=i(QT,"Example:"),QT.forEach(t),ek=l(At),f(Ns.$$.fragment,At),At.forEach(t),tk=l(oe),Tt=a(oe,"DIV",{class:!0});var Kr=s(Tt);f(Ds.$$.fragment,Kr),ok=l(Kr),il=a(Kr,"P",{});var VT=s(il);nk=i(VT,"Example:"),VT.forEach(t),ak=l(Kr),f(Ls.$$.fragment,Kr),Kr.forEach(t),sk=l(oe),wt=a(oe,"DIV",{class:!0});var Zr=s(wt);f(Gs.$$.fragment,Zr),rk=l(Zr),dl=a(Zr,"P",{});var JT=s(dl);ik=i(JT,"Example:"),JT.forEach(t),dk=l(Zr),f(Ws.$$.fragment,Zr),Zr.forEach(t),oe.forEach(t),this.h()},h(){c(p,"name","hf:doc:metadata"),c(p,"content",JSON.stringify(fw)),c(w,"id","bart"),c(w,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(w,"href","#bart"),c(y,"class","relative group"),c(ge,"href","https://github.com/huggingface/transformers/issues/new?assignees=&labels=&template=bug-report.md&title"),c(ge,"rel","nofollow"),c(N,"id","overview"),c(N,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(N,"href","#overview"),c(H,"class","relative group"),c(Q,"href","https://arxiv.org/abs/1910.13461"),c(Q,"rel","nofollow"),c(We,"href","https://huggingface.co/sshleifer"),c(We,"rel","nofollow"),c(Re,"href","https://github.com/pytorch/fairseq/tree/master/examples/bart"),c(Re,"rel","nofollow"),c(Fe,"id","examples"),c(Fe,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(Fe,"href","#examples"),c(ve,"class","relative group"),c(hn,"href","https://github.com/huggingface/transformers/tree/master/examples/pytorch/summarization/README.md"),c(hn,"rel","nofollow"),c(Qs,"href","/docs/transformers/doc-build-test/en/model_doc/bart#transformers.BartForConditionalGeneration"),c(mn,"href","https://discuss.huggingface.co/t/train-bart-for-conditional-generation-e-g-summarization/1904"),c(mn,"rel","nofollow"),c(fn,"href","https://huggingface.co/models?search=distilbart"),c(fn,"rel","nofollow"),c(_n,"href","https://arxiv.org/abs/2010.13002"),c(_n,"rel","nofollow"),c(To,"id","implementation-notes"),c(To,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(To,"href","#implementation-notes"),c(Lt,"class","relative group"),c(Vs,"href","/docs/transformers/doc-build-test/en/model_doc/bart#transformers.BartTokenizer"),c(Js,"href","/docs/transformers/doc-build-test/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode"),c(Xs,"href","/docs/transformers/doc-build-test/en/model_doc/bart#transformers.BartModel"),c(Zs,"href","/docs/transformers/doc-build-test/en/main_classes/model#transformers.generation_utils.GenerationMixin.generate"),c(wo,"id","mask-filling"),c(wo,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(wo,"href","#mask-filling"),c(Ut,"class","relative group"),c(xo,"id","transformers.BartConfig"),c(xo,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(xo,"href","#transformers.BartConfig"),c(Ht,"class","relative group"),c(Ys,"href","/docs/transformers/doc-build-test/en/model_doc/bart#transformers.BartModel"),c(Tn,"href","https://huggingface.co/facebook/bart-large"),c(Tn,"rel","nofollow"),c(er,"href","/docs/transformers/doc-build-test/en/main_classes/configuration#transformers.PretrainedConfig"),c(tr,"href","/docs/transformers/doc-build-test/en/main_classes/configuration#transformers.PretrainedConfig"),c(Te,"class","docstring"),c(zo,"id","transformers.BartTokenizer"),c(zo,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(zo,"href","#transformers.BartTokenizer"),c(Jt,"class","relative group"),c(or,"href","/docs/transformers/doc-build-test/en/main_classes/tokenizer#transformers.PreTrainedTokenizer"),c(mt,"class","docstring"),c(Bo,"class","docstring"),c(Fo,"class","docstring"),c($o,"class","docstring"),c(E,"class","docstring"),c(jo,"id","transformers.BartTokenizerFast"),c(jo,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(jo,"href","#transformers.BartTokenizerFast"),c(Xt,"class","relative group"),c(sr,"href","/docs/transformers/doc-build-test/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast"),c(Eo,"class","docstring"),c(G,"class","docstring"),c(Po,"id","transformers.BartModel"),c(Po,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(Po,"href","#transformers.BartModel"),c(Kt,"class","relative group"),c(rr,"href","/docs/transformers/doc-build-test/en/main_classes/model#transformers.PreTrainedModel"),c(Hn,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),c(Hn,"rel","nofollow"),c(ir,"href","/docs/transformers/doc-build-test/en/model_doc/bart#transformers.BartModel"),c(je,"class","docstring"),c(Qe,"class","docstring"),c(Ao,"id","transformers.BartForConditionalGeneration"),c(Ao,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(Ao,"href","#transformers.BartForConditionalGeneration"),c(Yt,"class","relative group"),c(dr,"href","/docs/transformers/doc-build-test/en/main_classes/model#transformers.PreTrainedModel"),c(Yn,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),c(Yn,"rel","nofollow"),c(lr,"href","/docs/transformers/doc-build-test/en/model_doc/bart#transformers.BartForConditionalGeneration"),c(K,"class","docstring"),c(Ve,"class","docstring"),c(Io,"id","transformers.BartForSequenceClassification"),c(Io,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(Io,"href","#transformers.BartForSequenceClassification"),c(to,"class","relative group"),c(cr,"href","/docs/transformers/doc-build-test/en/main_classes/model#transformers.PreTrainedModel"),c(ia,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),c(ia,"rel","nofollow"),c(pr,"href","/docs/transformers/doc-build-test/en/model_doc/bart#transformers.BartForSequenceClassification"),c(Z,"class","docstring"),c(we,"class","docstring"),c(No,"id","transformers.BartForQuestionAnswering"),c(No,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(No,"href","#transformers.BartForQuestionAnswering"),c(no,"class","relative group"),c(ur,"href","/docs/transformers/doc-build-test/en/main_classes/model#transformers.PreTrainedModel"),c(fa,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),c(fa,"rel","nofollow"),c(hr,"href","/docs/transformers/doc-build-test/en/model_doc/bart#transformers.BartForQuestionAnswering"),c(Me,"class","docstring"),c(xe,"class","docstring"),c(Lo,"id","transformers.BartForCausalLM"),c(Lo,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(Lo,"href","#transformers.BartForCausalLM"),c(ro,"class","relative group"),c(ft,"class","docstring"),c(ka,"class","docstring"),c(Go,"id","transformers.TFBartModel"),c(Go,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(Go,"href","#transformers.TFBartModel"),c(io,"class","relative group"),c(mr,"href","/docs/transformers/doc-build-test/en/main_classes/model#transformers.TFPreTrainedModel"),c(qa,"href","https://www.tensorflow.org/api_docs/python/tf/keras/Model"),c(qa,"rel","nofollow"),c(fr,"href","/docs/transformers/doc-build-test/en/model_doc/bart#transformers.TFBartModel"),c(Ee,"class","docstring"),c(ze,"class","docstring"),c(Uo,"id","transformers.TFBartForConditionalGeneration"),c(Uo,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(Uo,"href","#transformers.TFBartForConditionalGeneration"),c(co,"class","relative group"),c(_r,"href","/docs/transformers/doc-build-test/en/main_classes/model#transformers.TFPreTrainedModel"),c(Pa,"href","https://www.tensorflow.org/api_docs/python/tf/keras/Model"),c(Pa,"rel","nofollow"),c(gr,"href","/docs/transformers/doc-build-test/en/model_doc/bart#transformers.TFBartForConditionalGeneration"),c(Y,"class","docstring"),c(qe,"class","docstring"),c(Vo,"id","transformers.FlaxBartModel"),c(Vo,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(Vo,"href","#transformers.FlaxBartModel"),c(uo,"class","relative group"),c(br,"href","/docs/transformers/doc-build-test/en/main_classes/model#transformers.FlaxPreTrainedModel"),c(La,"href","https://flax.readthedocs.io/en/latest/_autosummary/flax.nn.module.html"),c(La,"rel","nofollow"),c(Ga,"href","https://jax.readthedocs.io/en/latest/jax.html#just-in-time-compilation-jit"),c(Ga,"rel","nofollow"),c(Wa,"href","https://jax.readthedocs.io/en/latest/jax.html#automatic-differentiation"),c(Wa,"rel","nofollow"),c(Ra,"href","https://jax.readthedocs.io/en/latest/jax.html#vectorization-vmap"),c(Ra,"rel","nofollow"),c(Ua,"href","https://jax.readthedocs.io/en/latest/jax.html#parallelization-pmap"),c(Ua,"rel","nofollow"),c(Pe,"class","docstring"),c(_t,"class","docstring"),c(gt,"class","docstring"),c(W,"class","docstring"),c(Xo,"id","transformers.FlaxBartForConditionalGeneration"),c(Xo,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(Xo,"href","#transformers.FlaxBartForConditionalGeneration"),c(mo,"class","relative group"),c(kr,"href","/docs/transformers/doc-build-test/en/main_classes/model#transformers.FlaxPreTrainedModel"),c(os,"href","https://flax.readthedocs.io/en/latest/_autosummary/flax.nn.module.html"),c(os,"rel","nofollow"),c(ns,"href","https://jax.readthedocs.io/en/latest/jax.html#just-in-time-compilation-jit"),c(ns,"rel","nofollow"),c(as,"href","https://jax.readthedocs.io/en/latest/jax.html#automatic-differentiation"),c(as,"rel","nofollow"),c(ss,"href","https://jax.readthedocs.io/en/latest/jax.html#vectorization-vmap"),c(ss,"rel","nofollow"),c(rs,"href","https://jax.readthedocs.io/en/latest/jax.html#parallelization-pmap"),c(rs,"rel","nofollow"),c(ee,"class","docstring"),c(bt,"class","docstring"),c(kt,"class","docstring"),c(R,"class","docstring"),c(Zo,"id","transformers.FlaxBartForSequenceClassification"),c(Zo,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(Zo,"href","#transformers.FlaxBartForSequenceClassification"),c(_o,"class","relative group"),c(yr,"href","/docs/transformers/doc-build-test/en/main_classes/model#transformers.FlaxPreTrainedModel"),c(bs,"href","https://flax.readthedocs.io/en/latest/_autosummary/flax.nn.module.html"),c(bs,"rel","nofollow"),c(ks,"href","https://jax.readthedocs.io/en/latest/jax.html#just-in-time-compilation-jit"),c(ks,"rel","nofollow"),c(ys,"href","https://jax.readthedocs.io/en/latest/jax.html#automatic-differentiation"),c(ys,"rel","nofollow"),c(vs,"href","https://jax.readthedocs.io/en/latest/jax.html#vectorization-vmap"),c(vs,"rel","nofollow"),c(Ts,"href","https://jax.readthedocs.io/en/latest/jax.html#parallelization-pmap"),c(Ts,"rel","nofollow"),c(Ce,"class","docstring"),c(yt,"class","docstring"),c(vt,"class","docstring"),c(I,"class","docstring"),c(en,"id","transformers.FlaxBartForQuestionAnswering"),c(en,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(en,"href","#transformers.FlaxBartForQuestionAnswering"),c(bo,"class","relative group"),c(vr,"href","/docs/transformers/doc-build-test/en/main_classes/model#transformers.FlaxPreTrainedModel"),c(Ps,"href","https://flax.readthedocs.io/en/latest/_autosummary/flax.nn.module.html"),c(Ps,"rel","nofollow"),c(Cs,"href","https://jax.readthedocs.io/en/latest/jax.html#just-in-time-compilation-jit"),c(Cs,"rel","nofollow"),c(As,"href","https://jax.readthedocs.io/en/latest/jax.html#automatic-differentiation"),c(As,"rel","nofollow"),c(Ss,"href","https://jax.readthedocs.io/en/latest/jax.html#vectorization-vmap"),c(Ss,"rel","nofollow"),c(Is,"href","https://jax.readthedocs.io/en/latest/jax.html#parallelization-pmap"),c(Is,"rel","nofollow"),c(Ae,"class","docstring"),c(Tt,"class","docstring"),c(wt,"class","docstring"),c(O,"class","docstring")},m(o,u){e(document.head,p),h(o,q,u),h(o,y,u),e(y,w),e(w,x),_(T,x,null),e(y,v),e(y,B),e(B,ne),h(o,A,u),h(o,$,u),e($,le),e(le,_e),e($,Ke),e($,ge),e(ge,be),e($,Ze),h(o,Je,u),h(o,H,u),e(H,N),e(N,Le),_(ae,Le,null),e(H,C),e(H,S),e(S,Ye),h(o,ce,u),h(o,pe,u),e(pe,et),e(pe,Q),e(Q,tt),e(pe,ot),h(o,D,u),h(o,Be,u),e(Be,ke),h(o,Xe,u),h(o,X,u),e(X,se),e(se,nt),e(X,at),e(X,V),e(V,st),e(X,ye),e(X,Ge),e(Ge,z),h(o,M,u),h(o,U,u),e(U,St),e(U,We),e(We,re),e(U,It),e(U,Re),e(Re,Ot),e(U,ie),h(o,ue,u),h(o,ve,u),e(ve,Fe),e(Fe,de),_(Ue,de,null),e(ve,Nt),e(ve,He),e(He,Dt),h(o,yl,u),h(o,ut,u),e(ut,un),e(un,Xc),e(un,hn),e(hn,Kc),e(un,Zc),e(ut,Yc),e(ut,rt),e(rt,ep),e(rt,Qs),e(Qs,tp),e(rt,op),e(rt,Yr),e(Yr,np),e(rt,ap),e(rt,mn),e(mn,sp),e(rt,rp),e(ut,ip),e(ut,vo),e(vo,fn),e(fn,dp),e(vo,lp),e(vo,_n),e(_n,cp),e(vo,pp),h(o,vl,u),h(o,Lt,u),e(Lt,To),e(To,ei),_(gn,ei,null),e(Lt,up),e(Lt,ti),e(ti,hp),h(o,Tl,u),h(o,$e,u),e($e,it),e(it,mp),e(it,oi),e(oi,fp),e(it,_p),e(it,Vs),e(Vs,gp),e(it,bp),e(it,Js),e(Js,kp),e(it,yp),e($e,vp),e($e,Gt),e(Gt,Tp),e(Gt,Xs),e(Xs,wp),e(Gt,xp),e(Gt,ni),e(ni,zp),e(Gt,qp),e($e,Bp),e($e,Wt),e(Wt,Fp),e(Wt,ai),e(ai,$p),e(Wt,jp),e(Wt,si),e(si,Mp),e(Wt,Ep),e($e,Pp),e($e,Ks),e(Ks,Zs),e(Zs,Cp),e(Ks,Ap),e($e,Sp),e($e,Rt),e(Rt,Ip),e(Rt,ri),e(ri,Op),e(Rt,Np),e(Rt,ii),e(ii,Dp),e(Rt,Lp),h(o,wl,u),h(o,Ut,u),e(Ut,wo),e(wo,di),_(bn,di,null),e(Ut,Gp),e(Ut,li),e(li,Wp),h(o,xl,u),h(o,ht,u),e(ht,Rp),e(ht,ci),e(ci,Up),e(ht,Hp),e(ht,pi),e(pi,Qp),e(ht,Vp),h(o,zl,u),_(kn,o,u),h(o,ql,u),h(o,Ht,u),e(Ht,xo),e(xo,ui),_(yn,ui,null),e(Ht,Jp),e(Ht,hi),e(hi,Xp),h(o,Bl,u),h(o,Te,u),_(vn,Te,null),e(Te,Kp),e(Te,Qt),e(Qt,Zp),e(Qt,Ys),e(Ys,Yp),e(Qt,eu),e(Qt,Tn),e(Tn,tu),e(Qt,ou),e(Te,nu),e(Te,Vt),e(Vt,au),e(Vt,er),e(er,su),e(Vt,ru),e(Vt,tr),e(tr,iu),e(Vt,du),e(Te,lu),e(Te,mi),e(mi,cu),e(Te,pu),_(wn,Te,null),h(o,Fl,u),h(o,Jt,u),e(Jt,zo),e(zo,fi),_(xn,fi,null),e(Jt,uu),e(Jt,_i),e(_i,hu),h(o,$l,u),h(o,E,u),_(zn,E,null),e(E,mu),e(E,gi),e(gi,fu),e(E,_u),e(E,bi),e(bi,gu),e(E,bu),_(qn,E,null),e(E,ku),e(E,Bn),e(Bn,yu),e(Bn,ki),e(ki,vu),e(Bn,Tu),e(E,wu),_(qo,E,null),e(E,xu),e(E,Fn),e(Fn,zu),e(Fn,or),e(or,qu),e(Fn,Bu),e(E,Fu),e(E,mt),_($n,mt,null),e(mt,$u),e(mt,yi),e(yi,ju),e(mt,Mu),e(mt,jn),e(jn,nr),e(nr,Eu),e(nr,vi),e(vi,Pu),e(jn,Cu),e(jn,ar),e(ar,Au),e(ar,Ti),e(Ti,Su),e(E,Iu),e(E,Bo),_(Mn,Bo,null),e(Bo,Ou),e(Bo,wi),e(wi,Nu),e(E,Du),e(E,Fo),_(En,Fo,null),e(Fo,Lu),e(Fo,xi),e(xi,Gu),e(E,Wu),e(E,$o),_(Pn,$o,null),e($o,Ru),e($o,Cn),e(Cn,Uu),e(Cn,zi),e(zi,Hu),e(Cn,Qu),h(o,jl,u),h(o,Xt,u),e(Xt,jo),e(jo,qi),_(An,qi,null),e(Xt,Vu),e(Xt,Bi),e(Bi,Ju),h(o,Ml,u),h(o,G,u),_(Sn,G,null),e(G,Xu),e(G,In),e(In,Ku),e(In,Fi),e(Fi,Zu),e(In,Yu),e(G,eh),e(G,$i),e($i,th),e(G,oh),_(On,G,null),e(G,nh),e(G,Nn),e(Nn,ah),e(Nn,ji),e(ji,sh),e(Nn,rh),e(G,ih),_(Mo,G,null),e(G,dh),e(G,Dn),e(Dn,lh),e(Dn,sr),e(sr,ch),e(Dn,ph),e(G,uh),e(G,Eo),_(Ln,Eo,null),e(Eo,hh),e(Eo,Mi),e(Mi,mh),h(o,El,u),h(o,Kt,u),e(Kt,Po),e(Po,Ei),_(Gn,Ei,null),e(Kt,fh),e(Kt,Pi),e(Pi,_h),h(o,Pl,u),h(o,Qe,u),_(Wn,Qe,null),e(Qe,gh),e(Qe,Rn),e(Rn,bh),e(Rn,rr),e(rr,kh),e(Rn,yh),e(Qe,vh),e(Qe,Un),e(Un,Th),e(Un,Hn),e(Hn,wh),e(Un,xh),e(Qe,zh),e(Qe,je),_(Qn,je,null),e(je,qh),e(je,Zt),e(Zt,Bh),e(Zt,ir),e(ir,Fh),e(Zt,$h),e(Zt,Ci),e(Ci,jh),e(Zt,Mh),e(je,Eh),_(Co,je,null),e(je,Ph),e(je,Ai),e(Ai,Ch),e(je,Ah),_(Vn,je,null),h(o,Cl,u),h(o,Yt,u),e(Yt,Ao),e(Ao,Si),_(Jn,Si,null),e(Yt,Sh),e(Yt,Ii),e(Ii,Ih),h(o,Al,u),h(o,Ve,u),_(Xn,Ve,null),e(Ve,Oh),e(Ve,Kn),e(Kn,Nh),e(Kn,dr),e(dr,Dh),e(Kn,Lh),e(Ve,Gh),e(Ve,Zn),e(Zn,Wh),e(Zn,Yn),e(Yn,Rh),e(Zn,Uh),e(Ve,Hh),e(Ve,K),_(ea,K,null),e(K,Qh),e(K,eo),e(eo,Vh),e(eo,lr),e(lr,Jh),e(eo,Xh),e(eo,Oi),e(Oi,Kh),e(eo,Zh),e(K,Yh),_(So,K,null),e(K,em),e(K,Ni),e(Ni,tm),e(K,om),_(ta,K,null),e(K,nm),e(K,Di),e(Di,am),e(K,sm),_(oa,K,null),h(o,Sl,u),h(o,to,u),e(to,Io),e(Io,Li),_(na,Li,null),e(to,rm),e(to,Gi),e(Gi,im),h(o,Il,u),h(o,we,u),_(aa,we,null),e(we,dm),e(we,Wi),e(Wi,lm),e(we,cm),e(we,sa),e(sa,pm),e(sa,cr),e(cr,um),e(sa,hm),e(we,mm),e(we,ra),e(ra,fm),e(ra,ia),e(ia,_m),e(ra,gm),e(we,bm),e(we,Z),_(da,Z,null),e(Z,km),e(Z,oo),e(oo,ym),e(oo,pr),e(pr,vm),e(oo,Tm),e(oo,Ri),e(Ri,wm),e(oo,xm),e(Z,zm),_(Oo,Z,null),e(Z,qm),e(Z,Ui),e(Ui,Bm),e(Z,Fm),_(la,Z,null),e(Z,$m),e(Z,Hi),e(Hi,jm),e(Z,Mm),_(ca,Z,null),h(o,Ol,u),h(o,no,u),e(no,No),e(No,Qi),_(pa,Qi,null),e(no,Em),e(no,Vi),e(Vi,Pm),h(o,Nl,u),h(o,xe,u),_(ua,xe,null),e(xe,Cm),e(xe,ao),e(ao,Am),e(ao,Ji),e(Ji,Sm),e(ao,Im),e(ao,Xi),e(Xi,Om),e(ao,Nm),e(xe,Dm),e(xe,ha),e(ha,Lm),e(ha,ur),e(ur,Gm),e(ha,Wm),e(xe,Rm),e(xe,ma),e(ma,Um),e(ma,fa),e(fa,Hm),e(ma,Qm),e(xe,Vm),e(xe,Me),_(_a,Me,null),e(Me,Jm),e(Me,so),e(so,Xm),e(so,hr),e(hr,Km),e(so,Zm),e(so,Ki),e(Ki,Ym),e(so,ef),e(Me,tf),_(Do,Me,null),e(Me,of),e(Me,Zi),e(Zi,nf),e(Me,af),_(ga,Me,null),h(o,Dl,u),h(o,ro,u),e(ro,Lo),e(Lo,Yi),_(ba,Yi,null),e(ro,sf),e(ro,ed),e(ed,rf),h(o,Ll,u),h(o,ka,u),e(ka,ft),_(ya,ft,null),e(ft,df),e(ft,td),e(td,lf),e(ft,cf),_(va,ft,null),h(o,Gl,u),h(o,io,u),e(io,Go),e(Go,od),_(Ta,od,null),e(io,pf),e(io,nd),e(nd,uf),h(o,Wl,u),h(o,ze,u),_(wa,ze,null),e(ze,hf),e(ze,xa),e(xa,mf),e(xa,mr),e(mr,ff),e(xa,_f),e(ze,gf),e(ze,za),e(za,bf),e(za,qa),e(qa,kf),e(za,yf),e(ze,vf),_(Wo,ze,null),e(ze,Tf),e(ze,Ee),_(Ba,Ee,null),e(Ee,wf),e(Ee,lo),e(lo,xf),e(lo,fr),e(fr,zf),e(lo,qf),e(lo,ad),e(ad,Bf),e(lo,Ff),e(Ee,$f),_(Ro,Ee,null),e(Ee,jf),e(Ee,sd),e(sd,Mf),e(Ee,Ef),_(Fa,Ee,null),h(o,Rl,u),h(o,co,u),e(co,Uo),e(Uo,rd),_($a,rd,null),e(co,Pf),e(co,id),e(id,Cf),h(o,Ul,u),h(o,qe,u),_(ja,qe,null),e(qe,Af),e(qe,Ma),e(Ma,Sf),e(Ma,_r),e(_r,If),e(Ma,Of),e(qe,Nf),e(qe,Ea),e(Ea,Df),e(Ea,Pa),e(Pa,Lf),e(Ea,Gf),e(qe,Wf),_(Ho,qe,null),e(qe,Rf),e(qe,Y),_(Ca,Y,null),e(Y,Uf),e(Y,po),e(po,Hf),e(po,gr),e(gr,Qf),e(po,Vf),e(po,dd),e(dd,Jf),e(po,Xf),e(Y,Kf),_(Qo,Y,null),e(Y,Zf),e(Y,ld),e(ld,Yf),e(Y,e_),_(Aa,Y,null),e(Y,t_),e(Y,cd),e(cd,o_),e(Y,n_),_(Sa,Y,null),h(o,Hl,u),h(o,uo,u),e(uo,Vo),e(Vo,pd),_(Ia,pd,null),e(uo,a_),e(uo,ud),e(ud,s_),h(o,Ql,u),h(o,W,u),_(Oa,W,null),e(W,r_),e(W,Na),e(Na,i_),e(Na,br),e(br,d_),e(Na,l_),e(W,c_),e(W,Da),e(Da,p_),e(Da,La),e(La,u_),e(Da,h_),e(W,m_),e(W,hd),e(hd,f_),e(W,__),e(W,dt),e(dt,md),e(md,Ga),e(Ga,g_),e(dt,b_),e(dt,fd),e(fd,Wa),e(Wa,k_),e(dt,y_),e(dt,_d),e(_d,Ra),e(Ra,v_),e(dt,T_),e(dt,gd),e(gd,Ua),e(Ua,w_),e(W,x_),e(W,Pe),_(Ha,Pe,null),e(Pe,z_),e(Pe,ho),e(ho,q_),e(ho,bd),e(bd,B_),e(ho,F_),e(ho,kd),e(kd,$_),e(ho,j_),e(Pe,M_),_(Jo,Pe,null),e(Pe,E_),e(Pe,yd),e(yd,P_),e(Pe,C_),_(Qa,Pe,null),e(W,A_),e(W,_t),_(Va,_t,null),e(_t,S_),e(_t,vd),e(vd,I_),e(_t,O_),_(Ja,_t,null),e(W,N_),e(W,gt),_(Xa,gt,null),e(gt,D_),e(gt,Td),e(Td,L_),e(gt,G_),_(Ka,gt,null),h(o,Vl,u),h(o,mo,u),e(mo,Xo),e(Xo,wd),_(Za,wd,null),e(mo,W_),e(mo,xd),e(xd,R_),h(o,Jl,u),h(o,R,u),_(Ya,R,null),e(R,U_),e(R,es),e(es,H_),e(es,kr),e(kr,Q_),e(es,V_),e(R,J_),e(R,ts),e(ts,X_),e(ts,os),e(os,K_),e(ts,Z_),e(R,Y_),e(R,zd),e(zd,eg),e(R,tg),e(R,lt),e(lt,qd),e(qd,ns),e(ns,og),e(lt,ng),e(lt,Bd),e(Bd,as),e(as,ag),e(lt,sg),e(lt,Fd),e(Fd,ss),e(ss,rg),e(lt,ig),e(lt,$d),e($d,rs),e(rs,dg),e(R,lg),e(R,ee),_(is,ee,null),e(ee,cg),e(ee,fo),e(fo,pg),e(fo,jd),e(jd,ug),e(fo,hg),e(fo,Md),e(Md,mg),e(fo,fg),e(ee,_g),_(Ko,ee,null),e(ee,gg),e(ee,Ed),e(Ed,bg),e(ee,kg),_(ds,ee,null),e(ee,yg),e(ee,Pd),e(Pd,vg),e(ee,Tg),_(ls,ee,null),e(R,wg),e(R,bt),_(cs,bt,null),e(bt,xg),e(bt,Cd),e(Cd,zg),e(bt,qg),_(ps,bt,null),e(R,Bg),e(R,kt),_(us,kt,null),e(kt,Fg),e(kt,Ad),e(Ad,$g),e(kt,jg),_(hs,kt,null),h(o,Xl,u),h(o,_o,u),e(_o,Zo),e(Zo,Sd),_(ms,Sd,null),e(_o,Mg),e(_o,Id),e(Id,Eg),h(o,Kl,u),h(o,I,u),_(fs,I,null),e(I,Pg),e(I,Od),e(Od,Cg),e(I,Ag),e(I,_s),e(_s,Sg),e(_s,yr),e(yr,Ig),e(_s,Og),e(I,Ng),e(I,gs),e(gs,Dg),e(gs,bs),e(bs,Lg),e(gs,Gg),e(I,Wg),e(I,Nd),e(Nd,Rg),e(I,Ug),e(I,ct),e(ct,Dd),e(Dd,ks),e(ks,Hg),e(ct,Qg),e(ct,Ld),e(Ld,ys),e(ys,Vg),e(ct,Jg),e(ct,Gd),e(Gd,vs),e(vs,Xg),e(ct,Kg),e(ct,Wd),e(Wd,Ts),e(Ts,Zg),e(I,Yg),e(I,Ce),_(ws,Ce,null),e(Ce,eb),e(Ce,go),e(go,tb),e(go,Rd),e(Rd,ob),e(go,nb),e(go,Ud),e(Ud,ab),e(go,sb),e(Ce,rb),_(Yo,Ce,null),e(Ce,ib),e(Ce,Hd),e(Hd,db),e(Ce,lb),_(xs,Ce,null),e(I,cb),e(I,yt),_(zs,yt,null),e(yt,pb),e(yt,Qd),e(Qd,ub),e(yt,hb),_(qs,yt,null),e(I,mb),e(I,vt),_(Bs,vt,null),e(vt,fb),e(vt,Vd),e(Vd,_b),e(vt,gb),_(Fs,vt,null),h(o,Zl,u),h(o,bo,u),e(bo,en),e(en,Jd),_($s,Jd,null),e(bo,bb),e(bo,Xd),e(Xd,kb),h(o,Yl,u),h(o,O,u),_(js,O,null),e(O,yb),e(O,ko),e(ko,vb),e(ko,Kd),e(Kd,Tb),e(ko,wb),e(ko,Zd),e(Zd,xb),e(ko,zb),e(O,qb),e(O,Ms),e(Ms,Bb),e(Ms,vr),e(vr,Fb),e(Ms,$b),e(O,jb),e(O,Es),e(Es,Mb),e(Es,Ps),e(Ps,Eb),e(Es,Pb),e(O,Cb),e(O,Yd),e(Yd,Ab),e(O,Sb),e(O,pt),e(pt,el),e(el,Cs),e(Cs,Ib),e(pt,Ob),e(pt,tl),e(tl,As),e(As,Nb),e(pt,Db),e(pt,ol),e(ol,Ss),e(Ss,Lb),e(pt,Gb),e(pt,nl),e(nl,Is),e(Is,Wb),e(O,Rb),e(O,Ae),_(Os,Ae,null),e(Ae,Ub),e(Ae,yo),e(yo,Hb),e(yo,al),e(al,Qb),e(yo,Vb),e(yo,sl),e(sl,Jb),e(yo,Xb),e(Ae,Kb),_(tn,Ae,null),e(Ae,Zb),e(Ae,rl),e(rl,Yb),e(Ae,ek),_(Ns,Ae,null),e(O,tk),e(O,Tt),_(Ds,Tt,null),e(Tt,ok),e(Tt,il),e(il,nk),e(Tt,ak),_(Ls,Tt,null),e(O,sk),e(O,wt),_(Gs,wt,null),e(wt,rk),e(wt,dl),e(dl,ik),e(wt,dk),_(Ws,wt,null),ec=!0},p(o,[u]){const Rs={};u&2&&(Rs.$$scope={dirty:u,ctx:o}),qo.$set(Rs);const ll={};u&2&&(ll.$$scope={dirty:u,ctx:o}),Mo.$set(ll);const cl={};u&2&&(cl.$$scope={dirty:u,ctx:o}),Co.$set(cl);const pl={};u&2&&(pl.$$scope={dirty:u,ctx:o}),So.$set(pl);const on={};u&2&&(on.$$scope={dirty:u,ctx:o}),Oo.$set(on);const ul={};u&2&&(ul.$$scope={dirty:u,ctx:o}),Do.$set(ul);const hl={};u&2&&(hl.$$scope={dirty:u,ctx:o}),Wo.$set(hl);const Us={};u&2&&(Us.$$scope={dirty:u,ctx:o}),Ro.$set(Us);const ml={};u&2&&(ml.$$scope={dirty:u,ctx:o}),Ho.$set(ml);const fl={};u&2&&(fl.$$scope={dirty:u,ctx:o}),Qo.$set(fl);const _l={};u&2&&(_l.$$scope={dirty:u,ctx:o}),Jo.$set(_l);const Hs={};u&2&&(Hs.$$scope={dirty:u,ctx:o}),Ko.$set(Hs);const gl={};u&2&&(gl.$$scope={dirty:u,ctx:o}),Yo.$set(gl);const bl={};u&2&&(bl.$$scope={dirty:u,ctx:o}),tn.$set(bl)},i(o){ec||(g(T.$$.fragment,o),g(ae.$$.fragment,o),g(Ue.$$.fragment,o),g(gn.$$.fragment,o),g(bn.$$.fragment,o),g(kn.$$.fragment,o),g(yn.$$.fragment,o),g(vn.$$.fragment,o),g(wn.$$.fragment,o),g(xn.$$.fragment,o),g(zn.$$.fragment,o),g(qn.$$.fragment,o),g(qo.$$.fragment,o),g($n.$$.fragment,o),g(Mn.$$.fragment,o),g(En.$$.fragment,o),g(Pn.$$.fragment,o),g(An.$$.fragment,o),g(Sn.$$.fragment,o),g(On.$$.fragment,o),g(Mo.$$.fragment,o),g(Ln.$$.fragment,o),g(Gn.$$.fragment,o),g(Wn.$$.fragment,o),g(Qn.$$.fragment,o),g(Co.$$.fragment,o),g(Vn.$$.fragment,o),g(Jn.$$.fragment,o),g(Xn.$$.fragment,o),g(ea.$$.fragment,o),g(So.$$.fragment,o),g(ta.$$.fragment,o),g(oa.$$.fragment,o),g(na.$$.fragment,o),g(aa.$$.fragment,o),g(da.$$.fragment,o),g(Oo.$$.fragment,o),g(la.$$.fragment,o),g(ca.$$.fragment,o),g(pa.$$.fragment,o),g(ua.$$.fragment,o),g(_a.$$.fragment,o),g(Do.$$.fragment,o),g(ga.$$.fragment,o),g(ba.$$.fragment,o),g(ya.$$.fragment,o),g(va.$$.fragment,o),g(Ta.$$.fragment,o),g(wa.$$.fragment,o),g(Wo.$$.fragment,o),g(Ba.$$.fragment,o),g(Ro.$$.fragment,o),g(Fa.$$.fragment,o),g($a.$$.fragment,o),g(ja.$$.fragment,o),g(Ho.$$.fragment,o),g(Ca.$$.fragment,o),g(Qo.$$.fragment,o),g(Aa.$$.fragment,o),g(Sa.$$.fragment,o),g(Ia.$$.fragment,o),g(Oa.$$.fragment,o),g(Ha.$$.fragment,o),g(Jo.$$.fragment,o),g(Qa.$$.fragment,o),g(Va.$$.fragment,o),g(Ja.$$.fragment,o),g(Xa.$$.fragment,o),g(Ka.$$.fragment,o),g(Za.$$.fragment,o),g(Ya.$$.fragment,o),g(is.$$.fragment,o),g(Ko.$$.fragment,o),g(ds.$$.fragment,o),g(ls.$$.fragment,o),g(cs.$$.fragment,o),g(ps.$$.fragment,o),g(us.$$.fragment,o),g(hs.$$.fragment,o),g(ms.$$.fragment,o),g(fs.$$.fragment,o),g(ws.$$.fragment,o),g(Yo.$$.fragment,o),g(xs.$$.fragment,o),g(zs.$$.fragment,o),g(qs.$$.fragment,o),g(Bs.$$.fragment,o),g(Fs.$$.fragment,o),g($s.$$.fragment,o),g(js.$$.fragment,o),g(Os.$$.fragment,o),g(tn.$$.fragment,o),g(Ns.$$.fragment,o),g(Ds.$$.fragment,o),g(Ls.$$.fragment,o),g(Gs.$$.fragment,o),g(Ws.$$.fragment,o),ec=!0)},o(o){b(T.$$.fragment,o),b(ae.$$.fragment,o),b(Ue.$$.fragment,o),b(gn.$$.fragment,o),b(bn.$$.fragment,o),b(kn.$$.fragment,o),b(yn.$$.fragment,o),b(vn.$$.fragment,o),b(wn.$$.fragment,o),b(xn.$$.fragment,o),b(zn.$$.fragment,o),b(qn.$$.fragment,o),b(qo.$$.fragment,o),b($n.$$.fragment,o),b(Mn.$$.fragment,o),b(En.$$.fragment,o),b(Pn.$$.fragment,o),b(An.$$.fragment,o),b(Sn.$$.fragment,o),b(On.$$.fragment,o),b(Mo.$$.fragment,o),b(Ln.$$.fragment,o),b(Gn.$$.fragment,o),b(Wn.$$.fragment,o),b(Qn.$$.fragment,o),b(Co.$$.fragment,o),b(Vn.$$.fragment,o),b(Jn.$$.fragment,o),b(Xn.$$.fragment,o),b(ea.$$.fragment,o),b(So.$$.fragment,o),b(ta.$$.fragment,o),b(oa.$$.fragment,o),b(na.$$.fragment,o),b(aa.$$.fragment,o),b(da.$$.fragment,o),b(Oo.$$.fragment,o),b(la.$$.fragment,o),b(ca.$$.fragment,o),b(pa.$$.fragment,o),b(ua.$$.fragment,o),b(_a.$$.fragment,o),b(Do.$$.fragment,o),b(ga.$$.fragment,o),b(ba.$$.fragment,o),b(ya.$$.fragment,o),b(va.$$.fragment,o),b(Ta.$$.fragment,o),b(wa.$$.fragment,o),b(Wo.$$.fragment,o),b(Ba.$$.fragment,o),b(Ro.$$.fragment,o),b(Fa.$$.fragment,o),b($a.$$.fragment,o),b(ja.$$.fragment,o),b(Ho.$$.fragment,o),b(Ca.$$.fragment,o),b(Qo.$$.fragment,o),b(Aa.$$.fragment,o),b(Sa.$$.fragment,o),b(Ia.$$.fragment,o),b(Oa.$$.fragment,o),b(Ha.$$.fragment,o),b(Jo.$$.fragment,o),b(Qa.$$.fragment,o),b(Va.$$.fragment,o),b(Ja.$$.fragment,o),b(Xa.$$.fragment,o),b(Ka.$$.fragment,o),b(Za.$$.fragment,o),b(Ya.$$.fragment,o),b(is.$$.fragment,o),b(Ko.$$.fragment,o),b(ds.$$.fragment,o),b(ls.$$.fragment,o),b(cs.$$.fragment,o),b(ps.$$.fragment,o),b(us.$$.fragment,o),b(hs.$$.fragment,o),b(ms.$$.fragment,o),b(fs.$$.fragment,o),b(ws.$$.fragment,o),b(Yo.$$.fragment,o),b(xs.$$.fragment,o),b(zs.$$.fragment,o),b(qs.$$.fragment,o),b(Bs.$$.fragment,o),b(Fs.$$.fragment,o),b($s.$$.fragment,o),b(js.$$.fragment,o),b(Os.$$.fragment,o),b(tn.$$.fragment,o),b(Ns.$$.fragment,o),b(Ds.$$.fragment,o),b(Ls.$$.fragment,o),b(Gs.$$.fragment,o),b(Ws.$$.fragment,o),ec=!1},d(o){t(p),o&&t(q),o&&t(y),k(T),o&&t(A),o&&t($),o&&t(Je),o&&t(H),k(ae),o&&t(ce),o&&t(pe),o&&t(D),o&&t(Be),o&&t(Xe),o&&t(X),o&&t(M),o&&t(U),o&&t(ue),o&&t(ve),k(Ue),o&&t(yl),o&&t(ut),o&&t(vl),o&&t(Lt),k(gn),o&&t(Tl),o&&t($e),o&&t(wl),o&&t(Ut),k(bn),o&&t(xl),o&&t(ht),o&&t(zl),k(kn,o),o&&t(ql),o&&t(Ht),k(yn),o&&t(Bl),o&&t(Te),k(vn),k(wn),o&&t(Fl),o&&t(Jt),k(xn),o&&t($l),o&&t(E),k(zn),k(qn),k(qo),k($n),k(Mn),k(En),k(Pn),o&&t(jl),o&&t(Xt),k(An),o&&t(Ml),o&&t(G),k(Sn),k(On),k(Mo),k(Ln),o&&t(El),o&&t(Kt),k(Gn),o&&t(Pl),o&&t(Qe),k(Wn),k(Qn),k(Co),k(Vn),o&&t(Cl),o&&t(Yt),k(Jn),o&&t(Al),o&&t(Ve),k(Xn),k(ea),k(So),k(ta),k(oa),o&&t(Sl),o&&t(to),k(na),o&&t(Il),o&&t(we),k(aa),k(da),k(Oo),k(la),k(ca),o&&t(Ol),o&&t(no),k(pa),o&&t(Nl),o&&t(xe),k(ua),k(_a),k(Do),k(ga),o&&t(Dl),o&&t(ro),k(ba),o&&t(Ll),o&&t(ka),k(ya),k(va),o&&t(Gl),o&&t(io),k(Ta),o&&t(Wl),o&&t(ze),k(wa),k(Wo),k(Ba),k(Ro),k(Fa),o&&t(Rl),o&&t(co),k($a),o&&t(Ul),o&&t(qe),k(ja),k(Ho),k(Ca),k(Qo),k(Aa),k(Sa),o&&t(Hl),o&&t(uo),k(Ia),o&&t(Ql),o&&t(W),k(Oa),k(Ha),k(Jo),k(Qa),k(Va),k(Ja),k(Xa),k(Ka),o&&t(Vl),o&&t(mo),k(Za),o&&t(Jl),o&&t(R),k(Ya),k(is),k(Ko),k(ds),k(ls),k(cs),k(ps),k(us),k(hs),o&&t(Xl),o&&t(_o),k(ms),o&&t(Kl),o&&t(I),k(fs),k(ws),k(Yo),k(xs),k(zs),k(qs),k(Bs),k(Fs),o&&t(Zl),o&&t(bo),k($s),o&&t(Yl),o&&t(O),k(js),k(Os),k(tn),k(Ns),k(Ds),k(Ls),k(Gs),k(Ws)}}}const fw={local:"bart",sections:[{local:"overview",sections:[{local:"examples",title:"Examples"}],title:"Overview"},{local:"implementation-notes",title:"Implementation Notes"},{local:"mask-filling",title:"Mask Filling"},{local:"transformers.BartConfig",title:"BartConfig"},{local:"transformers.BartTokenizer",title:"BartTokenizer"},{local:"transformers.BartTokenizerFast",title:"BartTokenizerFast"},{local:"transformers.BartModel",title:"BartModel"},{local:"transformers.BartForConditionalGeneration",title:"BartForConditionalGeneration"},{local:"transformers.BartForSequenceClassification",title:"BartForSequenceClassification"},{local:"transformers.BartForQuestionAnswering",title:"BartForQuestionAnswering"},{local:"transformers.BartForCausalLM",title:"BartForCausalLM"},{local:"transformers.TFBartModel",title:"TFBartModel"},{local:"transformers.TFBartForConditionalGeneration",title:"TFBartForConditionalGeneration"},{local:"transformers.FlaxBartModel",title:"FlaxBartModel"},{local:"transformers.FlaxBartForConditionalGeneration",title:"FlaxBartForConditionalGeneration"},{local:"transformers.FlaxBartForSequenceClassification",title:"FlaxBartForSequenceClassification"},{local:"transformers.FlaxBartForQuestionAnswering",title:"FlaxBartForQuestionAnswering"}],title:"BART"};function _w(j,p,q){let{fw:y}=p;return j.$$set=w=>{"fw"in w&&q(0,y=w.fw)},[y]}class ww extends XT{constructor(p){super();KT(this,p,_w,mw,ZT,{fw:0})}}export{ww as default,fw as metadata};
