...
the latter silently ignores them.`)},l(g){m=a(g,"P",{});var _=s(m);T=i(_,"Although the recipe for forward pass needs to be defined within this function, one should call the "),p=a(_,"CODE",{});var M=s(p);u=i(M,"Module"),M.forEach(o),E=i(_,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),_.forEach(o)},m(g,_){f(g,m,_),t(m,T),t(m,p),t(p,u),t(m,E)},d(g){g&&o(m)}}}function Wn(ee){let m,T,p,u,E,g,_,M,kt,at,q,U,De,te,jt,We,Mt,st,z,At,oe,Pt,Ft,It,rt,$e,qt,it,Te,He,zt,lt,xe,Ot,dt,Ce,ne,Nt,Ee,Lt,Dt,ct,V,Zo,ht,K,Wt,ke,Ht,Bt,ft,P,Ut,ae,Vt,Kt,se,Yt,Zt,mt,O,Y,Be,re,Rt,Ue,Gt,pt,k,ie,Jt,N,Qt,je,Xt,eo,le,to,oo,no,L,ao,Me,so,ro,Ae,io,lo,co,de,ut,D,Z,Ve,ce,ho,Ke,fo,gt,A,he,mo,fe,po,me,uo,go,_o,x,pe,wo,W,vo,Pe,bo,So,Ye,yo,$o,To,R,xo,Ze,Co,Eo,ue,_t,H,G,Re,ge,ko,Ge,jo,wt,j,_e,Mo,Je,Ao,Po,we,Fo,ve,Io,qo,zo,C,be,Oo,B,No,Fe,Lo,Do,Qe,Wo,Ho,Bo,J,Uo,Xe,Vo,Ko,Se,vt;return g=new nt({}),te=new nt({}),re=new nt({}),ie=new ot({props:{name:"class transformers.SwinConfig",anchor:"transformers.SwinConfig",parameters:[{name:"image_size",val:" = 224"},{name:"patch_size",val:" = 4"},{name:"num_channels",val:" = 3"},{name:"embed_dim",val:" = 96"},{name:"depths",val:" = [2, 2, 6, 2]"},{name:"num_heads",val:" = [3, 6, 12, 24]"},{name:"window_size",val:" = 7"},{name:"mlp_ratio",val:" = 4.0"},{name:"qkv_bias",val:" = True"},{name:"hidden_dropout_prob",val:" = 0.0"},{name:"attention_probs_dropout_prob",val:" = 0.0"},{name:"drop_path_rate",val:" = 0.1"},{name:"hidden_act",val:" = 'gelu'"},{name:"use_absolute_embeddings",val:" = False"},{name:"patch_norm",val:" = True"},{name:"initializer_range",val:" = 0.02"},{name:"layer_norm_eps",val:" = 1e-05"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/doc-build-test/src/transformers/models/swin/configuration_swin.py#L29",parametersDescription:[{anchor:"transformers.SwinConfig.image_size",description:`<strong>image_size</strong> (<code>int</code>, <em>optional</em>, defaults to 224) &#x2014;
...
<span class="hljs-meta">&gt;&gt;&gt; </span>configuration = model.config`}}),ce=new nt({}),he=new ot({props:{name:"class transformers.SwinModel",anchor:"transformers.SwinModel",parameters:[{name:"config",val:""},{name:"add_pooling_layer",val:" = True"}],source:"https://github.com/huggingface/transformers/blob/doc-build-test/src/transformers/models/swin/modeling_swin.py#L671",parametersDescription:[{anchor:"transformers.SwinModel.config",description:`<strong>config</strong> (<a href="/docs/transformers/doc-build-test/en/model_doc/swin#transformers.SwinConfig">SwinConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/doc-build-test/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),pe=new ot({props:{name:"forward",anchor:"transformers.SwinModel.forward",parameters:[{name:"pixel_values",val:" = None"},{name:"head_mask",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/doc-build-test/src/transformers/models/swin/modeling_swin.py#L698",parametersDescription:[{anchor:"transformers.SwinModel.forward.pixel_values",description:`<strong>pixel_values</strong> (<code>torch.FloatTensor</code> of shape <code>(batch_size, num_channels, height, width)</code>) &#x2014;
Pixel values. Pixel values can be obtained using <a href="/docs/transformers/doc-build-test/en/model_doc/auto#transformers.AutoFeatureExtractor">AutoFeatureExtractor</a>. See
...
elements depending on the configuration (<a
  href="/docs/transformers/doc-build-test/en/model_doc/swin#transformers.SwinConfig"
...
[<span class="hljs-number">1</span>, <span class="hljs-number">49</span>, <span class="hljs-number">768</span>]`}}),ge=new nt({}),_e=new ot({props:{name:"class transformers.SwinForImageClassification",anchor:"transformers.SwinForImageClassification",parameters:[{name:"config",val:""}],source:"https://github.com/huggingface/transformers/blob/doc-build-test/src/transformers/models/swin/modeling_swin.py#L767",parametersDescription:[{anchor:"transformers.SwinForImageClassification.config",description:`<strong>config</strong> (<a href="/docs/transformers/doc-build-test/en/model_doc/swin#transformers.SwinConfig">SwinConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/doc-build-test/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),be=new ot({props:{name:"forward",anchor:"transformers.SwinForImageClassification.forward",parameters:[{name:"pixel_values",val:" = None"},{name:"head_mask",val:" = None"},{name:"labels",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/doc-build-test/src/transformers/models/swin/modeling_swin.py#L782",parametersDescription:[{anchor:"transformers.SwinForImageClassification.forward.pixel_values",description:`<strong>pixel_values</strong> (<code>torch.FloatTensor</code> of shape <code>(batch_size, num_channels, height, width)</code>) &#x2014;
Pixel values. Pixel values can be obtained using <a href="/docs/transformers/doc-build-test/en/model_doc/auto#transformers.AutoFeatureExtractor">AutoFeatureExtractor</a>. See
...
The hierarchical design and the shifted window approach also prove beneficial for all-MLP architectures.`),lt=c(),xe=n("p"),Ot=r("Tips:"),dt=c(),Ce=n("ul"),ne=n("li"),Nt=r("One can use the "),Ee=n("a"),Lt=r("AutoFeatureExtractor"),Dt=r(" API to prepare images for the model."),ct=c(),V=n("img"),ht=c(),K=n("small"),Wt=r("Swin Transformer architecture. Taken from the "),ke=n("a"),Ht=r("original paper"),Bt=r("."),ft=c(),P=n("p"),Ut=r("This model was contributed by "),ae=n("a"),Vt=r("novice03"),Kt=r(". The original code can be found "),se=n("a"),Yt=r("here"),Zt=r("."),mt=c(),O=n("h2"),Y=n("a"),Be=n("span"),w(re.$$.fragment),Rt=c(),Ue=n("span"),Gt=r("SwinConfig"),pt=c(),k=n("div"),w(ie.$$.fragment),Jt=c(),N=n("p"),Qt=r("This is the configuration class to store the configuration of a "),je=n("a"),Xt=r("SwinModel"),eo=r(`. It is used to instantiate a Swin
...
documentation from `),Ae=n("a"),io=r("PretrainedConfig"),lo=r(" for more information."),co=c(),w(de.$$.fragment),ut=c(),D=n("h2"),Z=n("a"),Ve=n("span"),w(ce.$$.fragment),ho=c(),Ke=n("span"),fo=r("SwinModel"),gt=c(),A=n("div"),w(he.$$.fragment),mo=c(),fe=n("p"),po=r(`The bare Swin Model transformer outputting raw hidden-states without any specific head on top.
This model is a PyTorch `),me=n("a"),uo=r("torch.nn.Module"),go=r(` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),_o=c(),x=n("div"),w(pe.$$.fragment),wo=c(),W=n("p"),vo=r("The "),Pe=n("a"),bo=r("SwinModel"),So=r(" forward method, overrides the "),Ye=n("code"),yo=r("__call__"),$o=r(" special method."),To=c(),w(R.$$.fragment),xo=c(),Ze=n("p"),Co=r("Example:"),Eo=c(),w(ue.$$.fragment),_t=c(),H=n("h2"),G=n("a"),Re=n("span"),w(ge.$$.fragment),ko=c(),Ge=n("span"),jo=r("SwinForImageClassification"),wt=c(),j=n("div"),w(_e.$$.fragment),Mo=c(),Je=n("p"),Ao=r(`Swin Model transformer with an image classification head on top (a linear layer on top of the final hidden state of
