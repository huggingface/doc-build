import{S as Mk,i as jk,s as Ck,e as n,k as d,w as f,t as r,L as Sk,c as s,d as t,m as l,a,x as g,h as i,b as c,J as e,g as u,y as _,q as k,o as v,B as b}from"../../../chunks/vendor-9e2b328e.js";import{T as $o}from"../../../chunks/Tip-76f97a76.js";import{D as j}from"../../../chunks/Docstring-50fd6873.js";import{C as Se}from"../../../chunks/CodeBlock-b9ff96e9.js";import{I as Z}from"../../../chunks/IconCopyLink-fd0e58fd.js";import"../../../chunks/CopyButton-4b97cbf7.js";function Ak(G){let h,z,y,T,x;return{c(){h=n("p"),z=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),y=n("code"),T=r("Module"),x=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(w){h=s(w,"P",{});var P=a(h);z=i(P,"Although the recipe for forward pass needs to be defined within this function, one should call the "),y=s(P,"CODE",{});var $=a(y);T=i($,"Module"),$.forEach(t),x=i(P,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),P.forEach(t)},m(w,P){u(w,h,P),e(h,z),e(h,y),e(y,T),e(h,x)},d(w){w&&t(h)}}}function Ik(G){let h,z,y,T,x;return{c(){h=n("p"),z=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),y=n("code"),T=r("Module"),x=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(w){h=s(w,"P",{});var P=a(h);z=i(P,"Although the recipe for forward pass needs to be defined within this function, one should call the "),y=s(P,"CODE",{});var $=a(y);T=i($,"Module"),$.forEach(t),x=i(P,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),P.forEach(t)},m(w,P){u(w,h,P),e(h,z),e(h,y),e(y,T),e(h,x)},d(w){w&&t(h)}}}function Ok(G){let h,z,y,T,x,w,P,$,Ae,me,F,we,ae,Ie,re,ie,Oe,Me,D,A,xe,K,C,S,Le,Y,ee,Ne,U,Ge,De,I,fe,de,je,te,V,Ue,Be,B,We,oe,H;return{c(){h=n("p"),z=r("TF 2.0 models accepts two formats as inputs:"),y=d(),T=n("ul"),x=n("li"),w=r("having all inputs as keyword arguments (like PyTorch models), or"),P=d(),$=n("li"),Ae=r("having all inputs as a list, tuple or dict in the first positional arguments."),me=d(),F=n("p"),we=r("This second option is useful when using "),ae=n("code"),Ie=r("tf.keras.Model.fit"),re=r(` method which currently requires having all the
...
`),oe=s(R,"CODE",{});var kt=a(oe);H=i(kt,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),kt.forEach(t),R.forEach(t),O.forEach(t)},m(m,q){u(m,h,q),e(h,z),u(m,y,q),u(m,T,q),e(T,x),e(x,w),e(T,P),e(T,$),e($,Ae),u(m,me,q),u(m,F,q),e(F,we),e(F,ae),e(ae,Ie),e(F,re),e(F,ie),e(ie,Oe),e(F,Me),u(m,D,q),u(m,A,q),e(A,xe),u(m,K,q),u(m,C,q),e(C,S),e(S,Le),e(S,Y),e(Y,ee),e(S,Ne),e(S,U),e(U,Ge),e(C,De),e(C,I),e(I,fe),e(I,de),e(de,je),e(I,te),e(I,V),e(V,Ue),e(C,Be),e(C,B),e(B,We),e(B,oe),e(oe,H)},d(m){m&&t(h),m&&t(y),m&&t(T),m&&t(me),m&&t(F),m&&t(D),m&&t(A),m&&t(K),m&&t(C)}}}function Lk(G){let h,z,y,T,x;return{c(){h=n("p"),z=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),y=n("code"),T=r("Module"),x=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(w){h=s(w,"P",{});var P=a(h);z=i(P,"Although the recipe for forward pass needs to be defined within this function, one should call the "),y=s(P,"CODE",{});var $=a(y);T=i($,"Module"),$.forEach(t),x=i(P,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),P.forEach(t)},m(w,P){u(w,h,P),e(h,z),e(h,y),e(y,T),e(h,x)},d(w){w&&t(h)}}}function Nk(G){let h,z,y,T,x,w,P,$,Ae,me,F,we,ae,Ie,re,ie,Oe,Me,D,A,xe,K,C,S,Le,Y,ee,Ne,U,Ge,De,I,fe,de,je,te,V,Ue,Be,B,We,oe,H;return{c(){h=n("p"),z=r("TF 2.0 models accepts two formats as inputs:"),y=d(),T=n("ul"),x=n("li"),w=r("having all inputs as keyword arguments (like PyTorch models), or"),P=d(),$=n("li"),Ae=r("having all inputs as a list, tuple or dict in the first positional arguments."),me=d(),F=n("p"),we=r("This second option is useful when using "),ae=n("code"),Ie=r("tf.keras.Model.fit"),re=r(` method which currently requires having all the
tensors in the first argument of the model call function: `),ie=n("code"),Oe=r("model(inputs)"),Me=r("."),D=d(),A=n("p"),xe=r(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),K=d(),C=n("ul"),S=n("li"),Le=r("a single Tensor with "),Y=n("code"),ee=r("input_ids"),Ne=r(" only and nothing else: "),U=n("code"),Ge=r("model(input_ids)"),De=d(),I=n("li"),fe=r(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),de=n("code"),je=r("model([input_ids, attention_mask])"),te=r(" or "),V=n("code"),Ue=r("model([input_ids, attention_mask, token_type_ids])"),Be=d(),B=n("li"),We=r(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),oe=n("code"),H=r('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(m){h=s(m,"P",{});var q=a(h);z=i(q,"TF 2.0 models accepts two formats as inputs:"),q.forEach(t),y=l(m),T=s(m,"UL",{});var ze=a(T);x=s(ze,"LI",{});var mt=a(x);w=i(mt,"having all inputs as keyword arguments (like PyTorch models), or"),mt.forEach(t),P=l(ze),$=s(ze,"LI",{});var $e=a($);Ae=i($e,"having all inputs as a list, tuple or dict in the first positional arguments."),$e.forEach(t),ze.forEach(t),me=l(m),F=s(m,"P",{});var Q=a(F);we=i(Q,"This second option is useful when using "),ae=s(Q,"CODE",{});var ft=a(ae);Ie=i(ft,"tf.keras.Model.fit"),ft.forEach(t),re=i(Q,` method which currently requires having all the
...
first positional argument :`),le.forEach(t),K=l(m),C=s(m,"UL",{});var O=a(C);S=s(O,"LI",{});var J=a(S);Le=i(J,"a single Tensor with "),Y=s(J,"CODE",{});var qe=a(Y);ee=i(qe,"input_ids"),qe.forEach(t),Ne=i(J," only and nothing else: "),U=s(J,"CODE",{});var gt=a(U);Ge=i(gt,"model(input_ids)"),gt.forEach(t),J.forEach(t),De=l(O),I=s(O,"LI",{});var X=a(I);fe=i(X,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),de=s(X,"CODE",{});var _t=a(de);je=i(_t,"model([input_ids, attention_mask])"),_t.forEach(t),te=i(X," or "),V=s(X,"CODE",{});var Qe=a(V);Ue=i(Qe,"model([input_ids, attention_mask, token_type_ids])"),Qe.forEach(t),X.forEach(t),Be=l(O),B=s(O,"LI",{});var R=a(B);We=i(R,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),oe=s(R,"CODE",{});var kt=a(oe);H=i(kt,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),kt.forEach(t),R.forEach(t),O.forEach(t)},m(m,q){u(m,h,q),e(h,z),u(m,y,q),u(m,T,q),e(T,x),e(x,w),e(T,P),e(T,$),e($,Ae),u(m,me,q),u(m,F,q),e(F,we),e(F,ae),e(ae,Ie),e(F,re),e(F,ie),e(ie,Oe),e(F,Me),u(m,D,q),u(m,A,q),e(A,xe),u(m,K,q),u(m,C,q),e(C,S),e(S,Le),e(S,Y),e(Y,ee),e(S,Ne),e(S,U),e(U,Ge),e(C,De),e(C,I),e(I,fe),e(I,de),e(de,je),e(I,te),e(I,V),e(V,Ue),e(C,Be),e(C,B),e(B,We),e(B,oe),e(oe,H)},d(m){m&&t(h),m&&t(y),m&&t(T),m&&t(me),m&&t(F),m&&t(D),m&&t(A),m&&t(K),m&&t(C)}}}function Gk(G){let h,z,y,T,x;return{c(){h=n("p"),z=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),y=n("code"),T=r("Module"),x=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(w){h=s(w,"P",{});var P=a(h);z=i(P,"Although the recipe for forward pass needs to be defined within this function, one should call the "),y=s(P,"CODE",{});var $=a(y);T=i($,"Module"),$.forEach(t),x=i(P,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),P.forEach(t)},m(w,P){u(w,h,P),e(h,z),e(h,y),e(y,T),e(h,x)},d(w){w&&t(h)}}}function Dk(G){let h,z,y,T,x;return{c(){h=n("p"),z=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),y=n("code"),T=r("Module"),x=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(w){h=s(w,"P",{});var P=a(h);z=i(P,"Although the recipe for forward pass needs to be defined within this function, one should call the "),y=s(P,"CODE",{});var $=a(y);T=i($,"Module"),$.forEach(t),x=i(P,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),P.forEach(t)},m(w,P){u(w,h,P),e(h,z),e(h,y),e(y,T),e(h,x)},d(w){w&&t(h)}}}function Uk(G){let h,z,y,T,x;return{c(){h=n("p"),z=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),y=n("code"),T=r("Module"),x=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(w){h=s(w,"P",{});var P=a(h);z=i(P,"Although the recipe for forward pass needs to be defined within this function, one should call the "),y=s(P,"CODE",{});var $=a(y);T=i($,"Module"),$.forEach(t),x=i(P,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),P.forEach(t)},m(w,P){u(w,h,P),e(h,z),e(h,y),e(y,T),e(h,x)},d(w){w&&t(h)}}}function Bk(G){let h,z,y,T,x,w,P,$,Ae,me,F,we,ae,Ie,re,ie,Oe,Me,D,A,xe,K,C,S,Le,Y,ee,Ne,U,Ge,De,I,fe,de,je,te,V,Ue,Be,B,We,oe,H,m,q,ze,mt,$e,Q,ft,Ve,le,O,J,qe,gt,X,_t,Qe,R,kt,qo,Xd,Zd,la,Yd,el,Ei,ge,ca,tl,ol,ua,nl,sl,pa,al,rl,Fo,il,Eo,dl,ll,cl,Bt,Mo,ul,pl,jo,hl,ml,Mi,vt,Wt,ha,Co,fl,ma,gl,ji,Je,Ht,So,_l,kl,Ao,vl,bl,yl,fa,Tl,Pl,ga,wl,Ci,bt,Rt,_a,Io,xl,ka,zl,Si,_e,va,ba,$l,ql,ya,ws,Fl,xs,El,Ml,Oo,Ta,jl,Cl,yt,Pa,Sl,Al,wa,Il,Ol,Lo,Ll,xa,Nl,Gl,Dl,za,He,Ul,$a,Bl,Wl,qa,Hl,Rl,Fa,Kl,Vl,Ql,Ea,Tt,Jl,No,Xl,Zl,Ma,Yl,ec,Ai,Pt,Kt,ja,Go,tc,Ca,oc,Ii,Do,Oi,wt,Vt,Sa,Uo,nc,Aa,sc,Li,ce,Bo,ac,xt,rc,zs,ic,dc,Wo,lc,cc,uc,zt,pc,$s,hc,mc,qs,fc,gc,_c,Ia,kc,vc,Ho,Ni,$t,Qt,Oa,Ro,bc,La,yc,Gi,Jt,Tc,Na,Pc,wc,Di,W,Ko,xc,Vo,zc,Qo,$c,qc,Fc,Jo,Ec,Fs,Mc,jc,Cc,Ce,Xo,Sc,Zo,Ac,Ga,Ic,Oc,Lc,Yo,Es,Nc,Da,Gc,Dc,en,Uc,Ua,Bc,Wc,Hc,Ba,Rc,Kc,Xt,tn,Vc,Wa,Qc,Jc,Zt,on,Xc,Ha,Zc,Yc,Yt,nn,eu,Ra,tu,Ui,qt,eo,Ka,sn,ou,Va,nu,Bi,ue,an,su,Ft,au,Qa,ru,iu,rn,du,lu,cu,dn,uu,Ms,pu,hu,mu,Xe,ln,fu,Ja,gu,_u,cn,js,ku,Xa,vu,bu,un,yu,Za,Tu,Pu,wu,to,pn,xu,Ya,zu,Wi,Et,oo,er,hn,$u,tr,qu,Hi,Fe,mn,Fu,fn,Eu,Cs,Mu,ju,Cu,gn,Su,_n,Au,Iu,Ou,ke,kn,Lu,Mt,Nu,Ss,Gu,Du,or,Uu,Bu,Wu,no,Hu,nr,Ru,Ku,vn,Ri,jt,so,sr,bn,Vu,ar,Qu,Ki,Ee,yn,Ju,Tn,Xu,As,Zu,Yu,ep,Pn,tp,wn,op,np,sp,ve,xn,ap,Ct,rp,Is,ip,dp,rr,lp,cp,up,ao,pp,ir,hp,mp,zn,Vi,St,ro,dr,$n,fp,lr,gp,Qi,qn,Ze,Fn,_p,cr,kp,vp,En,Ji,At,io,ur,Mn,bp,pr,yp,Xi,pe,jn,Tp,Cn,Pp,Os,wp,xp,zp,Sn,$p,An,qp,Fp,Ep,lo,Mp,be,In,jp,It,Cp,Ls,Sp,Ap,hr,Ip,Op,Lp,co,Np,mr,Gp,Dp,On,Zi,Ot,uo,fr,Ln,Up,gr,Bp,Yi,he,Nn,Wp,Gn,Hp,Ns,Rp,Kp,Vp,Dn,Qp,Un,Jp,Xp,Zp,po,Yp,ye,Bn,eh,Lt,th,Gs,oh,nh,_r,sh,ah,rh,ho,ih,kr,dh,lh,Wn,ed,Nt,mo,vr,Hn,ch,br,uh,td,L,Rn,ph,Kn,hh,Ds,mh,fh,gh,Vn,_h,Qn,kh,vh,bh,yr,yh,Th,Re,Tr,Jn,Ph,wh,Pr,Xn,xh,zh,wr,Zn,$h,qh,xr,Yn,Fh,Eh,Te,es,Mh,Gt,jh,zr,Ch,Sh,$r,Ah,Ih,Oh,fo,Lh,qr,Nh,Gh,ts,Dh,Ye,os,Uh,Fr,Bh,Wh,ns,Hh,et,ss,Rh,Er,Kh,Vh,as,od,Dt,go,Mr,rs,Qh,jr,Jh,nd,N,is,Xh,ds,Zh,Us,Yh,em,tm,ls,om,cs,nm,sm,am,Cr,rm,im,Ke,Sr,us,dm,lm,Ar,ps,cm,um,Ir,hs,pm,hm,Or,ms,mm,fm,E,fs,gm,Ut,_m,Lr,km,vm,Nr,bm,ym,Tm,_o,Pm,Gr,wm,xm,Dr,Ur,Br,Wr,zm,$m,Hr,Rr,Kr,Vr,qm,Fm,Qr,Jr,Xr,Zr,Em,Mm,Yr,ei,gs,ko,vo,ti,_s,jm,oi,Cm,Sm,ni,Am,Im,si,Om,Lm,ai,ri,ii,di,Nm,Gm,li,ci,ui,pi,Dm,Um,hi,mi,fi,gi,Bm,Wm,_i,ki,vi,bi,Hm,Rm,tt,ks,Km,yi,Vm,Qm,vs,Jm,ot,bs,Xm,Ti,Zm,Ym,ys,sd;return w=new Z({}),K=new Z({}),qe=new Z({}),Co=new Z({}),Io=new Z({}),Go=new Z({}),Do=new Se({props:{code:`from transformers import PegasusForConditionalGeneration, PegasusTokenizer
import torch
...
`,returnType:`
<p><code>List[int]</code></p>
`}}),pn=new j({props:{name:"get\\_special\\_tokens\\_mask",anchor:"transformers.PegasusTokenizerFast.get_special_tokens_mask",parameters:[{name:"token_ids_0",val:": typing.List"},{name:"token_ids_1",val:": typing.Optional[typing.List] = None"},{name:"already_has_special_tokens",val:": bool = False"}],source:"https://github.com/huggingface/transformers/blob/doc-build-test/src/transformers/models/pegasus/tokenization_pegasus_fast.py#L165"}}),hn=new Z({}),mn=new j({props:{name:"class transformers.PegasusModel",anchor:"transformers.PegasusModel",parameters:[{name:"config",val:": PegasusConfig"}],source:"https://github.com/huggingface/transformers/blob/doc-build-test/src/transformers/models/pegasus/modeling_pegasus.py#L1133",parametersDescription:[{anchor:"transformers.PegasusModel.config",description:`<strong>config</strong> (<a href="/docs/transformers/doc-build-test/en/model_doc/pegasus#transformers.PegasusConfig">PegasusConfig</a>) &#x2014;
Model configuration class with all the parameters of the model. Initializing with a config file does not
load the weights associated with the model, only the configuration. Check out the
<a href="/docs/transformers/doc-build-test/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),kn=new j({props:{name:"forward",anchor:"transformers.PegasusModel.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"decoder_input_ids",val:" = None"},{name:"decoder_attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"decoder_head_mask",val:" = None"},{name:"cross_attn_head_mask",val:" = None"},{name:"encoder_outputs",val:" = None"},{name:"past_key_values",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"decoder_inputs_embeds",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/doc-build-test/src/transformers/models/pegasus/modeling_pegasus.py#L1183",parametersDescription:[{anchor:"transformers.PegasusModel.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. Padding will be ignored by default should you provide
it.</p>
<p>Indices can be obtained using <a href="/docs/transformers/doc-build-test/en/model_doc/pegasus#transformers.PegasusTokenizer">PegasusTokenizer</a>. See <a href="/docs/transformers/doc-build-test/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
...
elements depending on the configuration (<a
  href="/docs/transformers/doc-build-test/en/model_doc/pegasus#transformers.PegasusConfig"
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),bn=new Z({}),yn=new j({props:{name:"class transformers.PegasusForConditionalGeneration",anchor:"transformers.PegasusForConditionalGeneration",parameters:[{name:"config",val:": PegasusConfig"}],source:"https://github.com/huggingface/transformers/blob/doc-build-test/src/transformers/models/pegasus/modeling_pegasus.py#L1282",parametersDescription:[{anchor:"transformers.PegasusForConditionalGeneration.config",description:`<strong>config</strong> (<a href="/docs/transformers/doc-build-test/en/model_doc/pegasus#transformers.PegasusConfig">PegasusConfig</a>) &#x2014;
Model configuration class with all the parameters of the model. Initializing with a config file does not
load the weights associated with the model, only the configuration. Check out the
<a href="/docs/transformers/doc-build-test/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),xn=new j({props:{name:"forward",anchor:"transformers.PegasusForConditionalGeneration.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"decoder_input_ids",val:" = None"},{name:"decoder_attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"decoder_head_mask",val:" = None"},{name:"cross_attn_head_mask",val:" = None"},{name:"encoder_outputs",val:" = None"},{name:"past_key_values",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"decoder_inputs_embeds",val:" = None"},{name:"labels",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/doc-build-test/src/transformers/models/pegasus/modeling_pegasus.py#L1350",parametersDescription:[{anchor:"transformers.PegasusForConditionalGeneration.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. Padding will be ignored by default should you provide
it.</p>
<p>Indices can be obtained using <a href="/docs/transformers/doc-build-test/en/model_doc/pegasus#transformers.PegasusTokenizer">PegasusTokenizer</a>. See <a href="/docs/transformers/doc-build-test/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/doc-build-test/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),Ln=new Z({}),Nn=new j({props:{name:"class transformers.TFPegasusForConditionalGeneration",anchor:"transformers.TFPegasusForConditionalGeneration",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/doc-build-test/src/transformers/models/pegasus/modeling_tf_pegasus.py#L1332",parametersDescription:[{anchor:"transformers.TFPegasusForConditionalGeneration.config",description:`<strong>config</strong> (<a href="/docs/transformers/doc-build-test/en/model_doc/pegasus#transformers.PegasusConfig">PegasusConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/doc-build-test/en/main_classes/model#transformers.TFPreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),po=new $o({props:{$$slots:{default:[Nk]},$$scope:{ctx:G}}}),Bn=new j({props:{name:"call",anchor:"transformers.TFPegasusForConditionalGeneration.call",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"decoder_input_ids",val:" = None"},{name:"decoder_attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"decoder_head_mask",val:" = None"},{name:"cross_attn_head_mask",val:" = None"},{name:"encoder_outputs",val:": typing.Optional[transformers.modeling_tf_outputs.TFBaseModelOutput] = None"},{name:"past_key_values",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"decoder_inputs_embeds",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"},{name:"labels",val:" = None"},{name:"training",val:" = False"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/doc-build-test/src/transformers/models/pegasus/modeling_tf_pegasus.py#L1365",parametersDescription:[{anchor:"transformers.TFPegasusForConditionalGeneration.call.input_ids",description:`<strong>input_ids</strong> (<code>tf.Tensor</code> of shape <code>({0})</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/doc-build-test/en/model_doc/pegasus#transformers.PegasusTokenizer">PegasusTokenizer</a>. See <a href="/docs/transformers/doc-build-test/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/doc-build-test/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
`}}),ys=new Se({props:{code:`import jax.numpy as jnp
from transformers import PegasusTokenizer, FlaxPegasusForConditionalGeneration
...
<span class="hljs-meta">&gt;&gt;&gt; </span>outputs = model.decode(decoder_input_ids, encoder_outputs)
<span class="hljs-meta">&gt;&gt;&gt; </span>logits = outputs.logits`}}),{c(){h=n("meta"),z=d(),y=n("h1"),T=n("a"),x=n("span"),f(w.$$.fragment),P=d(),$=n("span"),Ae=r("Pegasus"),me=d(),F=n("p"),we=n("strong"),ae=r("DISCLAIMER:"),Ie=r(" If you see something strange, file a "),re=n("a"),ie=r("Github Issue"),Oe=r(`
...
on the XSUM dataset. Data download instructions at `),Ao=n("a"),vl=r("examples/pytorch/summarization/"),bl=r("."),yl=d(),fa=n("li"),Tl=r("FP16 is not supported (help/ideas on this appreciated!)."),Pl=d(),ga=n("li"),wl=r("The adafactor optimizer is recommended for pegasus fine-tuning."),Ci=d(),bt=n("h2"),Rt=n("a"),_a=n("span"),f(Io.$$.fragment),xl=d(),ka=n("span"),zl=r("Implementation Notes"),Si=d(),_e=n("ul"),va=n("li"),ba=n("p"),$l=r("All models are transformer encoder-decoders with 16 layers in each component."),ql=d(),ya=n("li"),ws=n("p"),Fl=r("The implementation is completely inherited from "),xs=n("a"),El=r("BartForConditionalGeneration"),Ml=d(),Oo=n("li"),Ta=n("p"),jl=r("Some key configuration differences:"),Cl=d(),yt=n("ul"),Pa=n("li"),Sl=r("static, sinusoidal position embeddings"),Al=d(),wa=n("li"),Il=r("the model starts generating with pad_token_id (which has 0 token_embedding) as the prefix."),Ol=d(),Lo=n("li"),Ll=r("more beams are used ("),xa=n("code"),Nl=r("num_beams=8"),Gl=r(")"),Dl=d(),za=n("li"),He=n("p"),Ul=r("All pretrained pegasus checkpoints are the same besides three attributes: "),$a=n("code"),Bl=r("tokenizer.model_max_length"),Wl=r(` (maximum
...
and behavior.`),Ou=d(),ke=n("div"),f(kn.$$.fragment),Lu=d(),Mt=n("p"),Nu=r("The "),Ss=n("a"),Gu=r("PegasusModel"),Du=r(" forward method, overrides the "),or=n("code"),Uu=r("__call__"),Bu=r(" special method."),Wu=d(),f(no.$$.fragment),Hu=d(),nr=n("p"),Ru=r("Example:"),Ku=d(),f(vn.$$.fragment),Ri=d(),jt=n("h2"),so=n("a"),sr=n("span"),f(bn.$$.fragment),Vu=d(),ar=n("span"),Qu=r("PegasusForConditionalGeneration"),Ki=d(),Ee=n("div"),f(yn.$$.fragment),Ju=d(),Tn=n("p"),Xu=r(`The PEGASUS Model with a language modeling head. Can be used for summarization.
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Zp=d(),f(po.$$.fragment),Yp=d(),ye=n("div"),f(Bn.$$.fragment),eh=d(),Lt=n("p"),th=r("The "),Gs=n("a"),oh=r("TFPegasusForConditionalGeneration"),nh=r(" forward method, overrides the "),_r=n("code"),sh=r("__call__"),ah=r(" special method."),rh=d(),f(ho.$$.fragment),ih=d(),kr=n("p"),dh=r("Summarization example:"),lh=d(),f(Wn.$$.fragment),ed=d(),Nt=n("h2"),mo=n("a"),vr=n("span"),f(Hn.$$.fragment),ch=d(),br=n("span"),uh=r("FlaxPegasusModel"),td=d(),L=n("div"),f(Rn.$$.fragment),ph=d(),Kn=n("p"),hh=r(`The bare Pegasus Model transformer outputting raw hidden-states without any specific head on top.
...
jax.nn.softmax(logits[0, masked_index], axis=0) >>> values, predictions = jax.lax.top_k(probs)`),Wm=d(),_i=n("blockquote"),ki=n("blockquote"),vi=n("blockquote"),bi=n("p"),Hm=r("tokenizer.decode(predictions).split()"),Rm=d(),tt=n("div"),f(ks.$$.fragment),Km=d(),yi=n("p"),Vm=r("Example:"),Qm=d(),f(vs.$$.fragment),Jm=d(),ot=n("div"),f(bs.$$.fragment),Xm=d(),Ti=n("p"),Zm=r("Example:"),Ym=d(),f(ys.$$.fragment),this.h()},l(o){const p=Sk('[data-svelte="svelte-1phssyn"]',document.head);h=s(p,"META",{name:!0,content:!0}),p.forEach(t),z=l(o),y=s(o,"H1",{class:!0});var Ts=a(y);T=s(Ts,"A",{id:!0,class:!0,href:!0});var Pi=a(T);x=s(Pi,"SPAN",{});var wi=a(x);g(w.$$.fragment,wi),wi.forEach(t),Pi.forEach(t),P=l(Ts),$=s(Ts,"SPAN",{});var xi=a($);Ae=i(xi,"Pegasus"),xi.forEach(t),Ts.forEach(t),me=l(o),F=s(o,"P",{});var bo=a(F);we=s(bo,"STRONG",{});var zi=a(we);ae=i(zi,"DISCLAIMER:"),zi.forEach(t),Ie=i(bo," If you see something strange, file a "),re=s(bo,"A",{href:!0,rel:!0});var $i=a(re);ie=i($i,"Github Issue"),$i.forEach(t),Oe=i(bo,`
...
`),la=s(Ws,"EM",{});var _f=a(la);Yd=i(_f,"pegasus-large"),_f.forEach(t),el=i(Ws,", whence the other checkpoints are fine-tuned:"),Ws.forEach(t),Ei=l(o),ge=s(o,"UL",{});var nt=a(ge);ca=s(nt,"LI",{});var kf=a(ca);tl=i(kf,"Each checkpoint is 2.2 GB on disk and 568M parameters."),kf.forEach(t),ol=l(nt),ua=s(nt,"LI",{});var vf=a(ua);nl=i(vf,"FP16 is not supported (help/ideas on this appreciated!)."),vf.forEach(t),sl=l(nt),pa=s(nt,"LI",{});var bf=a(pa);al=i(bf,"Summarizing xsum in fp32 takes about 400ms/sample, with default parameters on a v100 GPU."),bf.forEach(t),rl=l(nt),Fo=s(nt,"LI",{});var dd=a(Fo);il=i(dd,"Full replication results and correctly pre-processed data can be found in this "),Eo=s(dd,"A",{href:!0,rel:!0});var yf=a(Eo);dl=i(yf,"Issue"),yf.forEach(t),ll=i(dd,"."),dd.forEach(t),cl=l(nt),Bt=s(nt,"LI",{});var qi=a(Bt);Mo=s(qi,"A",{href:!0,rel:!0});var Tf=a(Mo);ul=i(Tf,"Distilled checkpoints"),Tf.forEach(t),pl=i(qi," are described in this "),jo=s(qi,"A",{href:!0,rel:!0});var Pf=a(jo);hl=i(Pf,"paper"),Pf.forEach(t),ml=i(qi,"."),qi.forEach(t),nt.forEach(t),Mi=l(o),vt=s(o,"H3",{class:!0});var ld=a(vt);Wt=s(ld,"A",{id:!0,class:!0,href:!0});var wf=a(Wt);ha=s(wf,"SPAN",{});var xf=a(ha);g(Co.$$.fragment,xf),xf.forEach(t),wf.forEach(t),fl=l(ld),ma=s(ld,"SPAN",{});var zf=a(ma);gl=i(zf,"Examples"),zf.forEach(t),ld.forEach(t),ji=l(o),Je=s(o,"UL",{});var Hs=a(Je);Ht=s(Hs,"LI",{});var Fi=a(Ht);So=s(Fi,"A",{href:!0,rel:!0});var $f=a(So);_l=i($f,"Script"),$f.forEach(t),kl=i(Fi,` to fine-tune pegasus
on the XSUM dataset. Data download instructions at `),Ao=s(Fi,"A",{href:!0,rel:!0});var qf=a(Ao);vl=i(qf,"examples/pytorch/summarization/"),qf.forEach(t),bl=i(Fi,"."),Fi.forEach(t),yl=l(Hs),fa=s(Hs,"LI",{});var Ff=a(fa);Tl=i(Ff,"FP16 is not supported (help/ideas on this appreciated!)."),Ff.forEach(t),Pl=l(Hs),ga=s(Hs,"LI",{});var Ef=a(ga);wl=i(Ef,"The adafactor optimizer is recommended for pegasus fine-tuning."),Ef.forEach(t),Hs.forEach(t),Ci=l(o),bt=s(o,"H2",{class:!0});var cd=a(bt);Rt=s(cd,"A",{id:!0,class:!0,href:!0});var Mf=a(Rt);_a=s(Mf,"SPAN",{});var jf=a(_a);g(Io.$$.fragment,jf),jf.forEach(t),Mf.forEach(t),xl=l(cd),ka=s(cd,"SPAN",{});var Cf=a(ka);zl=i(Cf,"Implementation Notes"),Cf.forEach(t),cd.forEach(t),Si=l(o),_e=s(o,"UL",{});var st=a(_e);va=s(st,"LI",{});var Sf=a(va);ba=s(Sf,"P",{});var Af=a(ba);$l=i(Af,"All models are transformer encoder-decoders with 16 layers in each component."),Af.forEach(t),Sf.forEach(t),ql=l(st),ya=s(st,"LI",{});var If=a(ya);ws=s(If,"P",{});var ef=a(ws);Fl=i(ef,"The implementation is completely inherited from "),xs=s(ef,"A",{href:!0});var Of=a(xs);El=i(Of,"BartForConditionalGeneration"),Of.forEach(t),ef.forEach(t),If.forEach(t),Ml=l(st),Oo=s(st,"LI",{});var ud=a(Oo);Ta=s(ud,"P",{});var Lf=a(Ta);jl=i(Lf,"Some key configuration differences:"),Lf.forEach(t),Cl=l(ud),yt=s(ud,"UL",{});var Rs=a(yt);Pa=s(Rs,"LI",{});var Nf=a(Pa);Sl=i(Nf,"static, sinusoidal position embeddings"),Nf.forEach(t),Al=l(Rs),wa=s(Rs,"LI",{});var Gf=a(wa);Il=i(Gf,"the model starts generating with pad_token_id (which has 0 token_embedding) as the prefix."),Gf.forEach(t),Ol=l(Rs),Lo=s(Rs,"LI",{});var pd=a(Lo);Ll=i(pd,"more beams are used ("),xa=s(pd,"CODE",{});var Df=a(xa);Nl=i(Df,"num_beams=8"),Df.forEach(t),Gl=i(pd,")"),pd.forEach(t),Rs.forEach(t),ud.forEach(t),Dl=l(st),za=s(st,"LI",{});var Uf=a(za);He=s(Uf,"P",{});var yo=a(He);Ul=i(yo,"All pretrained pegasus checkpoints are the same besides three attributes: "),$a=s(yo,"CODE",{});var Bf=a($a);Bl=i(Bf,"tokenizer.model_max_length"),Bf.forEach(t),Wl=i(yo,` (maximum
input size), `),qa=s(yo,"CODE",{});var Wf=a(qa);Hl=i(Wf,"max_length"),Wf.forEach(t),Rl=i(yo," (the maximum number of tokens to generate) and "),Fa=s(yo,"CODE",{});var Hf=a(Fa);Kl=i(Hf,"length_penalty"),Hf.forEach(t),Vl=i(yo,"."),yo.forEach(t),Uf.forEach(t),Ql=l(st),Ea=s(st,"LI",{});var Rf=a(Ea);Tt=s(Rf,"P",{});var Ks=a(Tt);Jl=i(Ks,"The code to convert checkpoints trained in the author\u2019s "),No=s(Ks,"A",{href:!0,rel:!0});var Kf=a(No);Xl=i(Kf,"repo"),Kf.forEach(t),Zl=i(Ks,` can be
...
and adding special tokens. A PEGASUS sequence has the following format, where `),Ga=s(vd,"CODE",{});var pg=a(Ga);Ic=i(pg,"X"),pg.forEach(t),Oc=i(vd," represents the sequence:"),vd.forEach(t),Lc=l(To),Yo=s(To,"UL",{});var bd=a(Yo);Es=s(bd,"LI",{});var tf=a(Es);Nc=i(tf,"single sequence: "),Da=s(tf,"CODE",{});var hg=a(Da);Gc=i(hg,"X </s>"),hg.forEach(t),tf.forEach(t),Dc=l(bd),en=s(bd,"LI",{});var yd=a(en);Uc=i(yd,"pair of sequences: "),Ua=s(yd,"CODE",{});var mg=a(Ua);Bc=i(mg,"A B </s>"),mg.forEach(t),Wc=i(yd," (not intended use)"),yd.forEach(t),bd.forEach(t),Hc=l(To),Ba=s(To,"P",{});var fg=a(Ba);Rc=i(fg,`BOS is never used. Pairs of sequences are not the expected use case, but they will be handled without a
separator.`),fg.forEach(t),To.forEach(t),Kc=l(Pe),Xt=s(Pe,"DIV",{class:!0});var Td=a(Xt);g(tn.$$.fragment,Td),Vc=l(Td),Wa=s(Td,"P",{});var gg=a(Wa);Qc=i(gg,"Converts a sequence of tokens (string) in a single string."),gg.forEach(t),Td.forEach(t),Jc=l(Pe),Zt=s(Pe,"DIV",{class:!0});var Pd=a(Zt);g(on.$$.fragment,Pd),Xc=l(Pd),Ha=s(Pd,"P",{});var _g=a(Ha);Zc=i(_g,"Get list where entries are [1] if a token is [eos] or [pad] else 0."),_g.forEach(t),Pd.forEach(t),Yc=l(Pe),Yt=s(Pe,"DIV",{class:!0});var wd=a(Yt);g(nn.$$.fragment,wd),eu=l(wd),Ra=s(wd,"P",{});var kg=a(Ra);tu=i(kg,"Just EOS"),kg.forEach(t),wd.forEach(t),Pe.forEach(t),Ui=l(o),qt=s(o,"H2",{class:!0});var xd=a(qt);eo=s(xd,"A",{id:!0,class:!0,href:!0});var vg=a(eo);Ka=s(vg,"SPAN",{});var bg=a(Ka);g(sn.$$.fragment,bg),bg.forEach(t),vg.forEach(t),ou=l(xd),Va=s(xd,"SPAN",{});var yg=a(Va);nu=i(yg,"PegasusTokenizerFast"),yg.forEach(t),xd.forEach(t),Bi=l(o),ue=s(o,"DIV",{class:!0});var rt=a(ue);g(an.$$.fragment,rt),su=l(rt),Ft=s(rt,"P",{});var Js=a(Ft);au=i(Js,"Construct a \u201Cfast\u201D PEGASUS tokenizer (backed by HuggingFace\u2019s "),Qa=s(Js,"EM",{});var Tg=a(Qa);ru=i(Tg,"tokenizers"),Tg.forEach(t),iu=i(Js,` library). Based on
