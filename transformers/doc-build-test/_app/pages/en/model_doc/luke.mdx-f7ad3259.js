...
the latter silently ignores them.`)},l(g){h=i(g,"P",{});var f=r(h);L=s(f,"Although the recipe for forward pass needs to be defined within this function, one should call the "),m=i(f,"CODE",{});var z=r(m);w=s(z,"Module"),z.forEach(t),E=s(f,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),f.forEach(t)},m(g,f){u(g,h,f),e(h,L),e(h,m),e(m,w),e(h,E)},d(g){g&&t(h)}}}function cp(O){let h,L,m,w,E,g,f,z,Ds,Ro,le,xe,Sn,He,Bs,Nn,Ws,Ho,$e,Os,Ve,Us,Ks,Vo,Jt,Rs,Yo,Qt,Dn,Hs,Jo,Xt,Vs,Qo,R,Bn,Ye,Ys,Gt,Js,Qs,Xs,Wn,q,Gs,On,Zs,ea,Un,ta,na,Kn,oa,sa,Rn,aa,ia,Zt,ra,da,la,Je,H,en,ca,pa,Hn,ha,ua,Vn,ma,fa,Yn,ga,_a,ka,Qe,tn,Jn,ya,ba,va,nn,Qn,Ta,wa,La,U,Xn,Ea,za,ce,qe,on,xa,$a,Xe,qa,Ca,Ma,Ce,sn,Fa,Pa,Ge,ja,Aa,Ia,an,rn,Sa,Na,Da,S,dn,Ba,Wa,Gn,Oa,Ua,Zn,Ka,Ra,eo,Ha,Va,to,Ya,Ja,Qa,pe,Xa,ln,Ga,Za,Ze,ei,ti,ni,et,oi,tt,si,ai,Xo,cn,ii,Go,nt,Zo,V,ri,ot,di,li,st,ci,pi,at,hi,ui,es,he,Me,no,it,mi,oo,fi,ts,C,rt,gi,dt,_i,pn,ki,yi,bi,ue,vi,hn,Ti,wi,un,Li,Ei,zi,so,xi,$i,lt,ns,me,Fe,ao,ct,qi,io,Ci,os,M,pt,Mi,ro,Fi,Pi,x,ji,mn,Ai,Ii,fn,Si,Ni,gn,Di,Bi,lo,Wi,Oi,co,Ui,Ki,po,Ri,Hi,ho,Vi,Yi,Ji,Pe,ht,Qi,uo,Xi,Gi,mo,ss,fe,je,fo,ut,Zi,go,er,as,F,mt,tr,_o,nr,or,ft,sr,_n,ar,ir,rr,gt,dr,_t,lr,cr,pr,N,kt,hr,ge,ur,kn,mr,fr,ko,gr,_r,kr,Ae,yr,yo,br,vr,yt,is,_e,Ie,bo,bt,Tr,vo,wr,rs,P,vt,Lr,To,Er,zr,Tt,xr,yn,$r,qr,Cr,wt,Mr,Lt,Fr,Pr,jr,Q,Et,Ar,ke,Ir,bn,Sr,Nr,wo,Dr,Br,Wr,Se,ds,ye,Ne,Lo,zt,Or,Eo,Ur,ls,j,xt,Kr,zo,Rr,Hr,$t,Vr,vn,Yr,Jr,Qr,qt,Xr,Ct,Gr,Zr,ed,D,Mt,td,be,nd,Tn,od,sd,xo,ad,id,rd,De,dd,$o,ld,cd,Ft,cs,ve,Be,qo,Pt,pd,Co,hd,ps,A,jt,ud,Mo,md,fd,At,gd,wn,_d,kd,yd,It,bd,St,vd,Td,wd,B,Nt,Ld,Te,Ed,Ln,zd,xd,Fo,$d,qd,Cd,We,Md,Po,Fd,Pd,Dt,hs,we,Oe,jo,Bt,jd,Ao,Ad,us,I,Wt,Id,Io,Sd,Nd,Ot,Dd,En,Bd,Wd,Od,Ut,Ud,Kt,Kd,Rd,Hd,W,Rt,Vd,Le,Yd,zn,Jd,Qd,So,Xd,Gd,Zd,Ue,el,No,tl,nl,Ht,ms;return g=new ze({}),He=new ze({}),nt=new In({props:{code:`from transformers import LukeTokenizer, LukeModel, LukeForEntityPairClassification
...
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-built_in">print</span>(<span class="hljs-string">&quot;Predicted class:&quot;</span>, model.config.id2label[predicted_class_idx])`}}),it=new ze({}),rt=new K({props:{name:"class transformers.LukeConfig",anchor:"transformers.LukeConfig",parameters:[{name:"vocab_size",val:" = 50267"},{name:"entity_vocab_size",val:" = 500000"},{name:"hidden_size",val:" = 768"},{name:"entity_emb_size",val:" = 256"},{name:"num_hidden_layers",val:" = 12"},{name:"num_attention_heads",val:" = 12"},{name:"intermediate_size",val:" = 3072"},{name:"hidden_act",val:" = 'gelu'"},{name:"hidden_dropout_prob",val:" = 0.1"},{name:"attention_probs_dropout_prob",val:" = 0.1"},{name:"max_position_embeddings",val:" = 512"},{name:"type_vocab_size",val:" = 2"},{name:"initializer_range",val:" = 0.02"},{name:"layer_norm_eps",val:" = 1e-12"},{name:"use_entity_aware_attention",val:" = True"},{name:"pad_token_id",val:" = 1"},{name:"bos_token_id",val:" = 0"},{name:"eos_token_id",val:" = 2"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/doc-build-test/src/transformers/models/luke/configuration_luke.py#L29",parametersDescription:[{anchor:"transformers.LukeConfig.vocab_size",description:`<strong>vocab_size</strong> (<code>int</code>, <em>optional</em>, defaults to 30522) &#x2014;
Vocabulary size of the LUKE model. Defines the number of different tokens that can be represented by the
<code>inputs_ids</code> passed when calling <a href="/docs/transformers/doc-build-test/en/model_doc/luke#transformers.LukeModel">LukeModel</a>.`,name:"vocab_size"},{anchor:"transformers.LukeConfig.entity_vocab_size",description:`<strong>entity_vocab_size</strong> (<code>int</code>, <em>optional</em>, defaults to 500000) &#x2014;
Entity vocabulary size of the LUKE model. Defines the number of different entities that can be represented
by the <code>entity_ids</code> passed when calling <a href="/docs/transformers/doc-build-test/en/model_doc/luke#transformers.LukeModel">LukeModel</a>.`,name:"entity_vocab_size"},{anchor:"transformers.LukeConfig.hidden_size",description:`<strong>hidden_size</strong> (<code>int</code>, <em>optional</em>, defaults to 768) &#x2014;
...
<p><a
  href="/docs/transformers/doc-build-test/en/main_classes/tokenizer#transformers.BatchEncoding"
>BatchEncoding</a></p>
`}}),ut=new ze({}),mt=new K({props:{name:"class transformers.LukeModel",anchor:"transformers.LukeModel",parameters:[{name:"config",val:""},{name:"add_pooling_layer",val:" = True"}],source:"https://github.com/huggingface/transformers/blob/doc-build-test/src/transformers/models/luke/modeling_luke.py#L879",parametersDescription:[{anchor:"transformers.LukeModel.config",description:`<strong>config</strong> (<a href="/docs/transformers/doc-build-test/en/model_doc/luke#transformers.LukeConfig">LukeConfig</a>) &#x2014; Model configuration class with all the parameters of the
model. Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/doc-build-test/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),kt=new K({props:{name:"forward",anchor:"transformers.LukeModel.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"entity_ids",val:" = None"},{name:"entity_attention_mask",val:" = None"},{name:"entity_token_type_ids",val:" = None"},{name:"entity_position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/doc-build-test/src/transformers/models/luke/modeling_luke.py#L911",parametersDescription:[{anchor:"transformers.LukeModel.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/doc-build-test/en/model_doc/luke#transformers.LukeTokenizer">LukeTokenizer</a>. See <a href="/docs/transformers/doc-build-test/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
...
elements depending on the configuration (<a
  href="/docs/transformers/doc-build-test/en/model_doc/luke#transformers.LukeConfig"
...
<span class="hljs-meta">&gt;&gt;&gt; </span>outputs = model(**encoding)
<span class="hljs-meta">&gt;&gt;&gt; </span>word_last_hidden_state = outputs.last_hidden_state
<span class="hljs-meta">&gt;&gt;&gt; </span>entity_last_hidden_state = outputs.entity_last_hidden_state`}}),bt=new ze({}),vt=new K({props:{name:"class transformers.LukeForMaskedLM",anchor:"transformers.LukeForMaskedLM",parameters:[{name:"config",val:""}],source:"https://github.com/huggingface/transformers/blob/doc-build-test/src/transformers/models/luke/modeling_luke.py#L1132",parametersDescription:[{anchor:"transformers.LukeForMaskedLM.config",description:`<strong>config</strong> (<a href="/docs/transformers/doc-build-test/en/model_doc/luke#transformers.LukeConfig">LukeConfig</a>) &#x2014; Model configuration class with all the parameters of the
model. Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/doc-build-test/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),Et=new K({props:{name:"forward",anchor:"transformers.LukeForMaskedLM.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"entity_ids",val:" = None"},{name:"entity_attention_mask",val:" = None"},{name:"entity_token_type_ids",val:" = None"},{name:"entity_position_ids",val:" = None"},{name:"labels",val:" = None"},{name:"entity_labels",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/doc-build-test/src/transformers/models/luke/modeling_luke.py#L1168",parametersDescription:[{anchor:"transformers.LukeForMaskedLM.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/doc-build-test/en/model_doc/luke#transformers.LukeTokenizer">LukeTokenizer</a>. See <a href="/docs/transformers/doc-build-test/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/doc-build-test/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
Predicted <span class="hljs-keyword">class</span>: person`}}),Pt=new ze({}),jt=new K({props:{name:"class transformers.LukeForEntityPairClassification",anchor:"transformers.LukeForEntityPairClassification",parameters:[{name:"config",val:""}],source:"https://github.com/huggingface/transformers/blob/doc-build-test/src/transformers/models/luke/modeling_luke.py#L1383",parametersDescription:[{anchor:"transformers.LukeForEntityPairClassification.config",description:`<strong>config</strong> (<a href="/docs/transformers/doc-build-test/en/model_doc/luke#transformers.LukeConfig">LukeConfig</a>) &#x2014; Model configuration class with all the parameters of the
model. Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/doc-build-test/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),Nt=new K({props:{name:"forward",anchor:"transformers.LukeForEntityPairClassification.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"entity_ids",val:" = None"},{name:"entity_attention_mask",val:" = None"},{name:"entity_token_type_ids",val:" = None"},{name:"entity_position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"labels",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/doc-build-test/src/transformers/models/luke/modeling_luke.py#L1396",parametersDescription:[{anchor:"transformers.LukeForEntityPairClassification.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/doc-build-test/en/model_doc/luke#transformers.LukeTokenizer">LukeTokenizer</a>. See <a href="/docs/transformers/doc-build-test/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/doc-build-test/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
<span class="hljs-meta">&gt;&gt;&gt; </span>predicted_class_idx = logits.argmax(-<span class="hljs-number">1</span>).item()
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-built_in">print</span>(<span class="hljs-string">&quot;Predicted class:&quot;</span>, model.config.id2label[predicted_class_idx])
Predicted <span class="hljs-keyword">class</span>: per:cities_of_residence`}}),Bt=new ze({}),Wt=new K({props:{name:"class transformers.LukeForEntitySpanClassification",anchor:"transformers.LukeForEntitySpanClassification",parameters:[{name:"config",val:""}],source:"https://github.com/huggingface/transformers/blob/doc-build-test/src/transformers/models/luke/modeling_luke.py#L1503",parametersDescription:[{anchor:"transformers.LukeForEntitySpanClassification.config",description:`<strong>config</strong> (<a href="/docs/transformers/doc-build-test/en/model_doc/luke#transformers.LukeConfig">LukeConfig</a>) &#x2014; Model configuration class with all the parameters of the
model. Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/doc-build-test/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),Rt=new K({props:{name:"forward",anchor:"transformers.LukeForEntitySpanClassification.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"entity_ids",val:" = None"},{name:"entity_attention_mask",val:" = None"},{name:"entity_token_type_ids",val:" = None"},{name:"entity_position_ids",val:" = None"},{name:"entity_start_positions",val:" = None"},{name:"entity_end_positions",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"labels",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/doc-build-test/src/transformers/models/luke/modeling_luke.py#L1516",parametersDescription:[{anchor:"transformers.LukeForEntitySpanClassification.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/doc-build-test/en/model_doc/luke#transformers.LukeTokenizer">LukeTokenizer</a>. See <a href="/docs/transformers/doc-build-test/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/doc-build-test/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
model according to the specified arguments, defining the model architecture.`),bi=l(),ue=a("p"),vi=o("Configuration objects inherit from "),hn=a("a"),Ti=o("PretrainedConfig"),wi=o(` and can be used to control the model outputs. Read the
...
`),ho=a("code"),Vi=o("entity_position_ids"),Yi=o(" to be used by the LUKE model."),Ji=l(),Pe=a("div"),_(ht.$$.fragment),Qi=l(),uo=a("p"),Xi=o(`Main method to tokenize and prepare for the model one or several sequence(s) or one or several pair(s) of
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Cr=l(),wt=a("p"),Mr=o("This model is also a PyTorch "),Lt=a("a"),Fr=o("torch.nn.Module"),Pr=o(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),jr=l(),Q=a("div"),_(Et.$$.fragment),Ar=l(),ke=a("p"),Ir=o("The "),bn=a("a"),Sr=o("LukeForMaskedLM"),Nr=o(" forward method, overrides the "),wo=a("code"),Dr=o("__call__"),Br=o(" special method."),Wr=l(),_(Se.$$.fragment),ds=l(),ye=a("h2"),Ne=a("a"),Lo=a("span"),_(zt.$$.fragment),Or=l(),Eo=a("span"),Ur=o("LukeForEntityClassification"),ls=l(),j=a("div"),_(xt.$$.fragment),Kr=l(),zo=a("p"),Rr=o(`The LUKE model with a classification head on top (a linear layer on top of the hidden state of the first entity
token) for entity classification tasks, such as Open Entity.`),Hr=l(),$t=a("p"),Vr=o("This model inherits from "),vn=a("a"),Yr=o("PreTrainedModel"),Jr=o(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Qr=l(),qt=a("p"),Xr=o("This model is also a PyTorch "),Ct=a("a"),Gr=o("torch.nn.Module"),Zr=o(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),ed=l(),D=a("div"),_(Mt.$$.fragment),td=l(),be=a("p"),nd=o("The "),Tn=a("a"),od=o("LukeForEntityClassification"),sd=o(" forward method, overrides the "),xo=a("code"),ad=o("__call__"),id=o(" special method."),rd=l(),_(De.$$.fragment),dd=l(),$o=a("p"),ld=o("Examples:"),cd=l(),_(Ft.$$.fragment),cs=l(),ve=a("h2"),Be=a("a"),qo=a("span"),_(Pt.$$.fragment),pd=l(),Co=a("span"),hd=o("LukeForEntityPairClassification"),ps=l(),A=a("div"),_(jt.$$.fragment),ud=l(),Mo=a("p"),md=o(`The LUKE model with a classification head on top (a linear layer on top of the hidden states of the two entity
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),wd=l(),B=a("div"),_(Nt.$$.fragment),Ld=l(),Te=a("p"),Ed=o("The "),Ln=a("a"),zd=o("LukeForEntityPairClassification"),xd=o(" forward method, overrides the "),Fo=a("code"),$d=o("__call__"),qd=o(" special method."),Cd=l(),_(We.$$.fragment),Md=l(),Po=a("p"),Fd=o("Examples:"),Pd=l(),_(Dt.$$.fragment),hs=l(),we=a("h2"),Oe=a("a"),jo=a("span"),_(Bt.$$.fragment),jd=l(),Ao=a("span"),Ad=o("LukeForEntitySpanClassification"),us=l(),I=a("div"),_(Wt.$$.fragment),Id=l(),Io=a("p"),Sd=o(`The LUKE model with a span classification head on top (a linear layer on top of the hidden states output) for tasks
...
state-of-the-art results on five well-known datasets: Open Entity (entity typing), TACRED (relation classification),
CoNLL-2003 (named entity recognition), ReCoRD (cloze-style question answering), and SQuAD 1.1 (extractive question
answering).`),hl.forEach(t),pl.forEach(t),Jo=c(n),Xt=i(n,"P",{});var ul=r(Xt);Vs=s(ul,"Tips:"),ul.forEach(t),Qo=c(n),R=i(n,"UL",{});var Ke=r(R);Bn=i(Ke,"LI",{});var ml=r(Bn);Ye=i(ml,"P",{});var gs=r(Ye);Ys=s(gs,"This implementation is the same as "),Gt=i(gs,"A",{href:!0});var fl=r(Gt);Js=s(fl,"RobertaModel"),fl.forEach(t),Qs=s(gs,` with the addition of entity embeddings as well
...
`),Kn=i(Y,"CODE",{});var yl=r(Kn);oa=s(yl,"entity_token_type_ids"),yl.forEach(t),sa=s(Y," and "),Rn=i(Y,"CODE",{});var bl=r(Rn);aa=s(bl,"entity_position_ids"),bl.forEach(t),ia=s(Y,` as extra input. You can obtain those using
`),Zt=i(Y,"A",{href:!0});var vl=r(Zt);ra=s(vl,"LukeTokenizer"),vl.forEach(t),da=s(Y,"."),Y.forEach(t),gl.forEach(t),la=c(Ke),Je=i(Ke,"LI",{});var _s=r(Je);H=i(_s,"P",{});var Ee=r(H);en=i(Ee,"A",{href:!0});var Tl=r(en);ca=s(Tl,"LukeTokenizer"),Tl.forEach(t),pa=s(Ee," takes "),Hn=i(Ee,"CODE",{});var wl=r(Hn);ha=s(wl,"entities"),wl.forEach(t),ua=s(Ee," and "),Vn=i(Ee,"CODE",{});var Ll=r(Vn);ma=s(Ll,"entity_spans"),Ll.forEach(t),fa=s(Ee,` (character-based start and end
...
Wikipedia entities. The brief description when inputting these entities are as follows:`),Ee.forEach(t),ka=c(_s),Qe=i(_s,"UL",{});var ks=r(Qe);tn=i(ks,"LI",{});var ol=r(tn);Jn=i(ol,"EM",{});var zl=r(Jn);ya=s(zl,"Inputting [MASK] entities to compute entity representations"),zl.forEach(t),ba=s(ol,`: The [MASK] entity is used to mask entities to be
predicted during pretraining. When LUKE receives the [MASK] entity, it tries to predict the original entity by
gathering the information about the entity from the input text. Therefore, the [MASK] entity can be used to address
downstream tasks requiring the information of entities in text such as entity typing, relation classification, and
named entity recognition.`),ol.forEach(t),va=c(ks),nn=i(ks,"LI",{});var sl=r(nn);Qn=i(sl,"EM",{});var xl=r(Qn);Ta=s(xl,"Inputting Wikipedia entities to compute knowledge-enhanced token representations"),xl.forEach(t),wa=s(sl,`: LUKE learns rich information
(or knowledge) about Wikipedia entities during pretraining and stores the information in its entity embedding. By
using Wikipedia entities as input tokens, LUKE outputs token representations enriched by the information stored in
the embeddings of these entities. This is particularly effective for tasks requiring real-world knowledge, such as
...
the HuggingFace implementation of LUKE. They can be found `),tt=i(ys,"A",{href:!0,rel:!0});var Wl=r(tt);si=s(Wl,"here"),Wl.forEach(t),ai=s(ys,"."),ys.forEach(t),X.forEach(t),Ke.forEach(t),Xo=c(n),cn=i(n,"P",{});var Ol=r(cn);ii=s(Ol,"Example:"),Ol.forEach(t),Go=c(n),k(nt.$$.fragment,n),Zo=c(n),V=i(n,"P",{});var Re=r(V);ri=s(Re,"This model was contributed by "),ot=i(Re,"A",{href:!0,rel:!0});var Ul=r(ot);di=s(Ul,"ikuyamada"),Ul.forEach(t),li=s(Re," and "),st=i(Re,"A",{href:!0,rel:!0});var Kl=r(st);ci=s(Kl,"nielsr"),Kl.forEach(t),pi=s(Re,". The original code can be found "),at=i(Re,"A",{href:!0,rel:!0});var Rl=r(at);hi=s(Rl,"here"),Rl.forEach(t),ui=s(Re,"."),Re.forEach(t),es=c(n),he=i(n,"H2",{class:!0});var bs=r(he);Me=i(bs,"A",{id:!0,class:!0,href:!0});var Hl=r(Me);no=i(Hl,"SPAN",{});var Vl=r(no);k(it.$$.fragment,Vl),Vl.forEach(t),Hl.forEach(t),mi=c(bs),oo=i(bs,"SPAN",{});var Yl=r(oo);fi=s(Yl,"LukeConfig"),Yl.forEach(t),bs.forEach(t),ts=c(n),C=i(n,"DIV",{class:!0});var G=r(C);k(rt.$$.fragment,G),gi=c(G),dt=i(G,"P",{});var vs=r(dt);_i=s(vs,"This is the configuration class to store the configuration of a "),pn=i(vs,"A",{href:!0});var Jl=r(pn);ki=s(Jl,"LukeModel"),Jl.forEach(t),yi=s(vs,`. It is used to instantiate a LUKE
model according to the specified arguments, defining the model architecture.`),vs.forEach(t),bi=c(G),ue=i(G,"P",{});var qn=r(ue);vi=s(qn,"Configuration objects inherit from "),hn=i(qn,"A",{href:!0});var Ql=r(hn);Ti=s(Ql,"PretrainedConfig"),Ql.forEach(t),wi=s(qn,` and can be used to control the model outputs. Read the
...
`),ho=i($,"CODE",{});var lc=r(ho);Vi=s(lc,"entity_position_ids"),lc.forEach(t),Yi=s($," to be used by the LUKE model."),$.forEach(t),Ji=c(Z),Pe=i(Z,"DIV",{class:!0});var ws=r(Pe);k(ht.$$.fragment,ws),Qi=c(ws),uo=i(ws,"P",{});var cc=r(uo);Xi=s(cc,`Main method to tokenize and prepare for the model one or several sequence(s) or one or several pair(s) of
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),$s.forEach(t),Cr=c(ne),wt=i(ne,"P",{});var qs=r(wt);Mr=s(qs,"This model is also a PyTorch "),Lt=i(qs,"A",{href:!0,rel:!0});var Ec=r(Lt);Fr=s(Ec,"torch.nn.Module"),Ec.forEach(t),Pr=s(qs,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),qs.forEach(t),jr=c(ne),Q=i(ne,"DIV",{class:!0});var Mn=r(Q);k(Et.$$.fragment,Mn),Ar=c(Mn),ke=i(Mn,"P",{});var Fn=r(ke);Ir=s(Fn,"The "),bn=i(Fn,"A",{href:!0});var zc=r(bn);Sr=s(zc,"LukeForMaskedLM"),zc.forEach(t),Nr=s(Fn," forward method, overrides the "),wo=i(Fn,"CODE",{});var xc=r(wo);Dr=s(xc,"__call__"),xc.forEach(t),Br=s(Fn," special method."),Fn.forEach(t),Wr=c(Mn),k(Se.$$.fragment,Mn),Mn.forEach(t),ne.forEach(t),ds=c(n),ye=i(n,"H2",{class:!0});var Cs=r(ye);Ne=i(Cs,"A",{id:!0,class:!0,href:!0});var $c=r(Ne);Lo=i($c,"SPAN",{});var qc=r(Lo);k(zt.$$.fragment,qc),qc.forEach(t),$c.forEach(t),Or=c(Cs),Eo=i(Cs,"SPAN",{});var Cc=r(Eo);Ur=s(Cc,"LukeForEntityClassification"),Cc.forEach(t),Cs.forEach(t),ls=c(n),j=i(n,"DIV",{class:!0});var oe=r(j);k(xt.$$.fragment,oe),Kr=c(oe),zo=i(oe,"P",{});var Mc=r(zo);Rr=s(Mc,`The LUKE model with a classification head on top (a linear layer on top of the hidden state of the first entity
token) for entity classification tasks, such as Open Entity.`),Mc.forEach(t),Hr=c(oe),$t=i(oe,"P",{});var Ms=r($t);Vr=s(Ms,"This model inherits from "),vn=i(Ms,"A",{href:!0});var Fc=r(vn);Yr=s(Fc,"PreTrainedModel"),Fc.forEach(t),Jr=s(Ms,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Ms.forEach(t),Qr=c(oe),qt=i(oe,"P",{});var Fs=r(qt);Xr=s(Fs,"This model is also a PyTorch "),Ct=i(Fs,"A",{href:!0,rel:!0});var Pc=r(Ct);Gr=s(Pc,"torch.nn.Module"),Pc.forEach(t),Zr=s(Fs,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Fs.forEach(t),ed=c(oe),D=i(oe,"DIV",{class:!0});var se=r(D);k(Mt.$$.fragment,se),td=c(se),be=i(se,"P",{});var Pn=r(be);nd=s(Pn,"The "),Tn=i(Pn,"A",{href:!0});var jc=r(Tn);od=s(jc,"LukeForEntityClassification"),jc.forEach(t),sd=s(Pn," forward method, overrides the "),xo=i(Pn,"CODE",{});var Ac=r(xo);ad=s(Ac,"__call__"),Ac.forEach(t),id=s(Pn," special method."),Pn.forEach(t),rd=c(se),k(De.$$.fragment,se),dd=c(se),$o=i(se,"P",{});var Ic=r($o);ld=s(Ic,"Examples:"),Ic.forEach(t),cd=c(se),k(Ft.$$.fragment,se),se.forEach(t),oe.forEach(t),cs=c(n),ve=i(n,"H2",{class:!0});var Ps=r(ve);Be=i(Ps,"A",{id:!0,class:!0,href:!0});var Sc=r(Be);qo=i(Sc,"SPAN",{});var Nc=r(qo);k(Pt.$$.fragment,Nc),Nc.forEach(t),Sc.forEach(t),pd=c(Ps),Co=i(Ps,"SPAN",{});var Dc=r(Co);hd=s(Dc,"LukeForEntityPairClassification"),Dc.forEach(t),Ps.forEach(t),ps=c(n),A=i(n,"DIV",{class:!0});var ae=r(A);k(jt.$$.fragment,ae),ud=c(ae),Mo=i(ae,"P",{});var Bc=r(Mo);md=s(Bc,`The LUKE model with a classification head on top (a linear layer on top of the hidden states of the two entity
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),js.forEach(t),yd=c(ae),It=i(ae,"P",{});var As=r(It);bd=s(As,"This model is also a PyTorch "),St=i(As,"A",{href:!0,rel:!0});var Oc=r(St);vd=s(Oc,"torch.nn.Module"),Oc.forEach(t),Td=s(As,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
...
such as named entity recognition.`),Jc.forEach(t),Nd=c(re),Ot=i(re,"P",{});var Ss=r(Ot);Dd=s(Ss,"This model inherits from "),En=i(Ss,"A",{href:!0});var Qc=r(En);Bd=s(Qc,"PreTrainedModel"),Qc.forEach(t),Wd=s(Ss,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
