import{S as e1,i as t1,s as o1,e as a,k as l,w as k,t as n,W as Po,L as n1,c as r,d as t,m as d,a as i,x as b,h as s,X as jo,b as c,J as e,g as h,y as v,q as T,o as y,B as L}from"../../../chunks/vendor-9e2b328e.js";import{T as je}from"../../../chunks/Tip-76f97a76.js";import{D as S}from"../../../chunks/Docstring-50fd6873.js";import{C as rt}from"../../../chunks/CodeBlock-b9ff96e9.js";import{I as ze}from"../../../chunks/IconCopyLink-fd0e58fd.js";import"../../../chunks/CopyButton-4b97cbf7.js";function s1(W){let p,x,g,u,$;return{c(){p=a("p"),x=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),g=a("code"),u=n("Module"),$=n(`
...
tensors in the first argument of the model call function: `),H=r(O,"CODE",{});var xe=i(H);he=s(xe,"model(inputs)"),xe.forEach(t),ae=s(O,"."),O.forEach(t),R=d(m),P=r(m,"P",{});var ve=i(P);se=s(ve,`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),ve.forEach(t),K=d(m),z=r(m,"UL",{});var A=i(z);q=r(A,"LI",{});var V=i(q);me=s(V,"a single Tensor with "),D=r(V,"CODE",{});var Te=i(D);Y=s(Te,"input_ids"),Te.forEach(t),fe=s(V," only and nothing else: "),I=r(V,"CODE",{});var le=i(I);pe=s(le,"model(inputs_ids)"),le.forEach(t),V.forEach(t),ge=d(A),C=r(A,"LI",{});var G=i(C);ee=s(G,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
...
`),B=r(we,"CODE",{});var be=i(B);oe=s(be,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),be.forEach(t),we.forEach(t),A.forEach(t)},m(m,F){h(m,p,F),e(p,x),h(m,g,F),h(m,u,F),e(u,$),e($,w),e(u,_),e(u,M),e(M,de),h(m,X,F),h(m,E,F),e(E,ne),e(E,Q),e(Q,ce),e(E,Z),e(E,H),e(H,he),e(E,ae),h(m,R,F),h(m,P,F),e(P,se),h(m,K,F),h(m,z,F),e(z,q),e(q,me),e(q,D),e(D,Y),e(q,fe),e(q,I),e(I,pe),e(z,ge),e(z,C),e(C,ee),e(C,U),e(U,re),e(C,te),e(C,N),e(N,ue),e(z,ie),e(z,j),e(j,_e),e(j,B),e(B,oe)},d(m){m&&t(p),m&&t(g),m&&t(u),m&&t(X),m&&t(E),m&&t(R),m&&t(P),m&&t(K),m&&t(z)}}}function h1(W){let p,x,g,u,$;return{c(){p=a("p"),x=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),g=a("code"),u=n("Module"),$=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(w){p=r(w,"P",{});var _=i(p);x=s(_,"Although the recipe for forward pass needs to be defined within this function, one should call the "),g=r(_,"CODE",{});var M=i(g);u=s(M,"Module"),M.forEach(t),$=s(_,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
the latter silently ignores them.`)},l(w){p=r(w,"P",{});var _=i(p);x=s(_,"Although the recipe for forward pass needs to be defined within this function, one should call the "),g=r(_,"CODE",{});var M=i(g);u=s(M,"Module"),M.forEach(t),$=s(_,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),_.forEach(t)},m(w,_){h(w,p,_),e(p,x),e(p,g),e(g,u),e(p,$)},d(w){w&&t(p)}}}function b1(W){let p,x,g,u,$,w,_,M,de,X,E,ne,Q,ce,Z,H,he,ae,R,P,se,K,z,q,me,D,Y,fe,I,pe,ge,C,ee,U,re,te,N,ue,ie,j,_e,B,oe;return{c(){p=a("p"),x=n("TF 2.0 models accepts two formats as inputs:"),g=l(),u=a("ul"),$=a("li"),w=n("having all inputs as keyword arguments (like PyTorch models), or"),_=l(),M=a("li"),de=n("having all inputs as a list, tuple or dict in the first positional arguments."),X=l(),E=a("p"),ne=n("This second option is useful when using "),Q=a("code"),ce=n("tf.keras.Model.fit"),Z=n(` method which currently requires having all the
tensors in the first argument of the model call function: `),H=a("code"),he=n("model(inputs)"),ae=n("."),R=l(),P=a("p"),se=n(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),K=l(),z=a("ul"),q=a("li"),me=n("a single Tensor with "),D=a("code"),Y=n("input_ids"),fe=n(" only and nothing else: "),I=a("code"),pe=n("model(inputs_ids)"),ge=l(),C=a("li"),ee=n(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),U=a("code"),re=n("model([input_ids, attention_mask])"),te=n(" or "),N=a("code"),ue=n("model([input_ids, attention_mask, token_type_ids])"),ie=l(),j=a("li"),_e=n(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),B=a("code"),oe=n('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(m){p=r(m,"P",{});var F=i(p);x=s(F,"TF 2.0 models accepts two formats as inputs:"),F.forEach(t),g=d(m),u=r(m,"UL",{});var J=i(u);$=r(J,"LI",{});var Le=i($);w=s(Le,"having all inputs as keyword arguments (like PyTorch models), or"),Le.forEach(t),_=d(J),M=r(J,"LI",{});var $e=i(M);de=s($e,"having all inputs as a list, tuple or dict in the first positional arguments."),$e.forEach(t),J.forEach(t),X=d(m),E=r(m,"P",{});var O=i(E);ne=s(O,"This second option is useful when using "),Q=r(O,"CODE",{});var Fe=i(Q);ce=s(Fe,"tf.keras.Model.fit"),Fe.forEach(t),Z=s(O,` method which currently requires having all the
...
configuration. Check out the <a href="/docs/transformers/doc-build-test/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),rs=new S({props:{name:"forward",anchor:"transformers.LongformerModel.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"global_attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/doc-build-test/src/transformers/models/longformer/modeling_longformer.py#L1597",parametersDescription:[{anchor:"transformers.LongformerModel.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
...
<p>A <a
  href="/docs/transformers/doc-build-test/en/model_doc/longformer#transformers.models.longformer.modeling_longformer.LongformerBaseModelOutputWithPooling"
...
elements depending on the configuration (<a
  href="/docs/transformers/doc-build-test/en/model_doc/longformer#transformers.LongformerConfig"
...
<p>A <a
  href="/docs/transformers/doc-build-test/en/model_doc/longformer#transformers.models.longformer.modeling_longformer.LongformerMaskedLMOutput"
...
model. Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/doc-build-test/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),vs=new S({props:{name:"forward",anchor:"transformers.LongformerForSequenceClassification.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"global_attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"labels",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/doc-build-test/src/transformers/models/longformer/modeling_longformer.py#L1845",parametersDescription:[{anchor:"transformers.LongformerForSequenceClassification.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/doc-build-test/en/model_doc/longformer#transformers.LongformerTokenizer">LongformerTokenizer</a>. See <a href="/docs/transformers/doc-build-test/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/doc-build-test/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
<p>A <a
  href="/docs/transformers/doc-build-test/en/model_doc/longformer#transformers.models.longformer.modeling_longformer.LongformerSequenceClassifierOutput"
...
model. Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/doc-build-test/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),Es=new S({props:{name:"forward",anchor:"transformers.LongformerForMultipleChoice.forward",parameters:[{name:"input_ids",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"global_attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"labels",val:" = None"},{name:"position_ids",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/doc-build-test/src/transformers/models/longformer/modeling_longformer.py#L2192",parametersDescription:[{anchor:"transformers.LongformerForMultipleChoice.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, num_choices, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/doc-build-test/en/model_doc/longformer#transformers.LongformerTokenizer">LongformerTokenizer</a>. See <a href="/docs/transformers/doc-build-test/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/doc-build-test/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
<p>A <a
  href="/docs/transformers/doc-build-test/en/model_doc/longformer#transformers.models.longformer.modeling_longformer.LongformerMultipleChoiceModelOutput"
...
model. Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/doc-build-test/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),As=new S({props:{name:"forward",anchor:"transformers.LongformerForTokenClassification.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"global_attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"labels",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/doc-build-test/src/transformers/models/longformer/modeling_longformer.py#L2111",parametersDescription:[{anchor:"transformers.LongformerForTokenClassification.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/doc-build-test/en/model_doc/longformer#transformers.LongformerTokenizer">LongformerTokenizer</a>. See <a href="/docs/transformers/doc-build-test/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/doc-build-test/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
<p>A <a
  href="/docs/transformers/doc-build-test/en/model_doc/longformer#transformers.models.longformer.modeling_longformer.LongformerTokenClassifierOutput"
...
model. Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/doc-build-test/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),Qs=new S({props:{name:"forward",anchor:"transformers.LongformerForQuestionAnswering.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"global_attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"start_positions",val:" = None"},{name:"end_positions",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/doc-build-test/src/transformers/models/longformer/modeling_longformer.py#L1971",parametersDescription:[{anchor:"transformers.LongformerForQuestionAnswering.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/doc-build-test/en/model_doc/longformer#transformers.LongformerTokenizer">LongformerTokenizer</a>. See <a href="/docs/transformers/doc-build-test/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/doc-build-test/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
<p>A <a
  href="/docs/transformers/doc-build-test/en/model_doc/longformer#transformers.models.longformer.modeling_longformer.LongformerQuestionAnsweringModelOutput"
...
<p>A <a
  href="/docs/transformers/doc-build-test/en/model_doc/longformer#transformers.models.longformer.modeling_tf_longformer.TFLongformerMaskedLMOutput"
...
are not taken into account for computing the loss.`,name:"end_positions"}],returnDescription:`
<p>A <a
  href="/docs/transformers/doc-build-test/en/model_doc/longformer#transformers.models.longformer.modeling_tf_longformer.TFLongformerQuestionAnsweringModelOutput"
...
<p>A <a
  href="/docs/transformers/doc-build-test/en/model_doc/longformer#transformers.models.longformer.modeling_tf_longformer.TFLongformerSequenceClassifierOutput"
...
`}}),un=new je({props:{$$slots:{default:[_1]},$$scope:{ctx:W}}}),ba=new rt({props:{code:`from transformers import LongformerTokenizer, TFLongformerForSequenceClassification
import tensorflow as tf
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],returnDescription:`
<p>A <a
  href="/docs/transformers/doc-build-test/en/model_doc/longformer#transformers.models.longformer.modeling_tf_longformer.TFLongformerTokenClassifierOutput"
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/doc-build-test/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),vn=new je({props:{$$slots:{default:[b1]},$$scope:{ctx:W}}}),Pa=new S({props:{name:"call",anchor:"transformers.TFLongformerForMultipleChoice.call",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"global_attention_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"},{name:"labels",val:" = None"},{name:"training",val:" = False"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/doc-build-test/src/transformers/models/longformer/modeling_tf_longformer.py#L2508",parametersDescription:[{anchor:"transformers.TFLongformerForMultipleChoice.call.input_ids",description:`<strong>input_ids</strong> (<code>tf.Tensor</code> of shape <code>(batch_size, num_choices, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/doc-build-test/en/model_doc/longformer#transformers.LongformerTokenizer">LongformerTokenizer</a>. See <a href="/docs/transformers/doc-build-test/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
<a href="/docs/transformers/doc-build-test/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> for details.</p>
...
<p>A <a
  href="/docs/transformers/doc-build-test/en/model_doc/longformer#transformers.models.longformer.modeling_tf_longformer.TFLongformerMultipleChoiceModelOutput"
...
`}}),Tn=new je({props:{$$slots:{default:[v1]},$$scope:{ctx:W}}}),ja=new rt({props:{code:`from transformers import LongformerTokenizer, TFLongformerForMultipleChoice
import tensorflow as tf
...
`),ve=a("code"),A=n("</s>"),V=n(")."),Te=l(),le=a("p"),G=n("This model was contributed by "),ke=a("a"),Me=n("beltagy"),we=n(". The Authors\u2019 code can be found "),be=a("a"),Oh=n("here"),Ah=n("."),sd=l(),jt=a("h2"),Oo=a("a"),Vr=a("span"),k($n.$$.fragment),Ih=l(),Gr=a("span"),Nh=n("Longformer Self Attention"),ad=l(),ye=a("p"),Sh=n(`Longformer self attention employs self attention on both a \u201Clocal\u201D context and a \u201Cglobal\u201D context. Most tokens only
...
`),ti=a("code"),em=n("global_attention_mask"),tm=n(":"),wd=l(),Ao=a("ul"),oi=a("li"),om=n("0: the token attends \u201Clocally\u201D,"),nm=l(),ni=a("li"),sm=n("1: the token attends \u201Cglobally\u201D."),kd=l(),Io=a("p"),am=n("For more information please also refer to "),Na=a("a"),rm=n("forward()"),im=n(" method."),bd=l(),Ve=a("p"),lm=n(`Using Longformer self attention, the memory and time complexity of the query-key matmul operation, which usually
represents the memory and time bottleneck, can be reduced from `),vd=new Po,Td=n(` to
...
trained and should be used as follows:`),Cd=l(),k(Mn.$$.fragment),Pd=l(),It=a("h2"),Do=a("a"),ri=a("span"),k(En.$$.fragment),wm=l(),ii=a("span"),km=n("LongformerConfig"),jd=l(),Oe=a("div"),k(zn.$$.fragment),bm=l(),Nt=a("p"),vm=n("This is the configuration class to store the configuration of a "),Ba=a("a"),Tm=n("LongformerModel"),ym=n(" or a "),Wa=a("a"),Lm=n("TFLongformerModel"),$m=n(`. It
...
kernel to be memory and compute efficient.`),rp=l(),Ge=a("div"),k(rs.$$.fragment),ip=l(),ro=a("p"),lp=n("The "),Ya=a("a"),dp=n("LongformerModel"),cp=n(" forward method, overrides the "),Oi=a("code"),hp=n("__call__"),mp=n(" special method."),fp=l(),k(Vo.$$.fragment),pp=l(),Ai=a("p"),gp=n("Examples:"),up=l(),k(is.$$.fragment),oc=l(),io=a("h2"),Go=a("a"),Ii=a("span"),k(ls.$$.fragment),_p=l(),Ni=a("span"),wp=n("LongformerForMaskedLM"),nc=l(),We=a("div"),k(ds.$$.fragment),kp=l(),cs=a("p"),bp=n("Longformer Model with a "),Si=a("code"),vp=n("language modeling"),Tp=n(" head on top."),yp=l(),hs=a("p"),Lp=n("This model inherits from "),Za=a("a"),$p=n("PreTrainedModel"),Fp=n(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Jp=l(),ks=a("p"),Xp=n("This model is also a PyTorch "),bs=a("a"),Yp=n("torch.nn.Module"),Zp=n(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),eg=l(),Ce=a("div"),k(vs.$$.fragment),tg=l(),ho=a("p"),og=n("The "),or=a("a"),ng=n("LongformerForSequenceClassification"),sg=n(" forward method, overrides the "),Ri=a("code"),ag=n("__call__"),rg=n(" special method."),ig=l(),k(Xo.$$.fragment),lg=l(),Ui=a("p"),dg=n("Example of single-label classification:"),cg=l(),k(Ts.$$.fragment),hg=l(),Vi=a("p"),mg=n("Example of multi-label classification:"),fg=l(),k(ys.$$.fragment),rc=l(),mo=a("h2"),Yo=a("a"),Gi=a("span"),k(Ls.$$.fragment),pg=l(),Ki=a("span"),gg=n("LongformerForMultipleChoice"),ic=l(),He=a("div"),k($s.$$.fragment),ug=l(),Ji=a("p"),_g=n(`Longformer Model with a multiple choice classification head on top (a linear layer on top of the pooled output and
a softmax) e.g. for RocStories/SWAG tasks.`),wg=l(),Fs=a("p"),kg=n("This model inherits from "),nr=a("a"),bg=n("PreTrainedModel"),vg=n(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),wu=l(),Bs=a("p"),ku=n("This model is also a PyTorch "),Ws=a("a"),bu=n("torch.nn.Module"),vu=n(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
...
behavior.`),Ru=l(),k(an.$$.fragment),Uu=l(),bo=a("p"),Vu=n("This class copies code from "),cr=a("a"),Gu=n("TFRobertaModel"),Ku=n(` and overwrites standard self-attention with longformer
...
attention are more relevant for autoregressive language modeling than finetuning on downstream tasks. Future
release will add support for autoregressive attention, but the support for dilated attention requires a custom CUDA
kernel to be memory and compute efficient.`),o_=l(),_t=a("div"),k(Ys.$$.fragment),n_=l(),vo=a("p"),s_=n("The "),hr=a("a"),a_=n("TFLongformerModel"),r_=n(" forward method, overrides the "),pl=a("code"),i_=n("__call__"),l_=n(" special method."),d_=l(),k(rn.$$.fragment),pc=l(),To=a("h2"),ln=a("a"),gl=a("span"),k(Zs.$$.fragment),c_=l(),ul=a("span"),h_=n("TFLongformerForMaskedLM"),gc=l(),Ae=a("div"),k(ea.$$.fragment),m_=l(),ta=a("p"),f_=n("Longformer Model with a "),_l=a("code"),p_=n("language modeling"),g_=n(" head on top."),u_=l(),oa=a("p"),__=n("This model inherits from "),mr=a("a"),w_=n("TFPreTrainedModel"),k_=n(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),b_=l(),na=a("p"),v_=n("This model is also a "),sa=a("a"),T_=n("tf.keras.Model"),y_=n(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),L_=l(),k(dn.$$.fragment),$_=l(),Ze=a("div"),k(aa.$$.fragment),F_=l(),yo=a("p"),x_=n("The "),fr=a("a"),M_=n("TFLongformerForMaskedLM"),E_=n(" forward method, overrides the "),wl=a("code"),z_=n("__call__"),q_=n(" special method."),C_=l(),k(cn.$$.fragment),P_=l(),kl=a("p"),j_=n("Example:"),O_=l(),k(ra.$$.fragment),uc=l(),Lo=a("h2"),hn=a("a"),bl=a("span"),k(ia.$$.fragment),A_=l(),vl=a("span"),I_=n("TFLongformerForQuestionAnswering"),_c=l(),Ie=a("div"),k(la.$$.fragment),N_=l(),$o=a("p"),S_=n(`Longformer Model with a span classification head on top for extractive question-answering tasks like SQuAD /
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),ww=l(),_a=a("p"),kw=n("This model is also a "),wa=a("a"),bw=n("tf.keras.Model"),vw=n(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Tw=l(),k(gn.$$.fragment),yw=l(),tt=a("div"),k(ka.$$.fragment),Lw=l(),Mo=a("p"),$w=n("The "),_r=a("a"),Fw=n("TFLongformerForSequenceClassification"),xw=n(" forward method, overrides the "),El=a("code"),Mw=n("__call__"),Ew=n(" special method."),zw=l(),k(un.$$.fragment),qw=l(),zl=a("p"),Cw=n("Example:"),Pw=l(),k(ba.$$.fragment),bc=l(),Eo=a("h2"),_n=a("a"),ql=a("span"),k(va.$$.fragment),jw=l(),Cl=a("span"),Ow=n("TFLongformerForTokenClassification"),vc=l(),Se=a("div"),k(Ta.$$.fragment),Aw=l(),Pl=a("p"),Iw=n(`Longformer Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g.
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Uw=l(),k(wn.$$.fragment),Vw=l(),ot=a("div"),k(Fa.$$.fragment),Gw=l(),zo=a("p"),Kw=n("The "),kr=a("a"),Jw=n("TFLongformerForTokenClassification"),Xw=n(" forward method, overrides the "),jl=a("code"),Yw=n("__call__"),Zw=n(" special method."),ek=l(),k(kn.$$.fragment),tk=l(),Ol=a("p"),ok=n("Example:"),nk=l(),k(xa.$$.fragment),Tc=l(),qo=a("h2"),bn=a("a"),Al=a("span"),k(Ma.$$.fragment),sk=l(),Il=a("span"),ak=n("TFLongformerForMultipleChoice"),yc=l(),De=a("div"),k(Ea.$$.fragment),rk=l(),Nl=a("p"),ik=n(`Longformer Model with a multiple choice classification head on top (a linear layer on top of the pooled output and
a softmax) e.g. for RocStories/SWAG tasks.`),lk=l(),za=a("p"),dk=n("This model inherits from "),br=a("a"),ck=n("TFPreTrainedModel"),hk=n(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),mk=l(),qa=a("p"),fk=n("This model is also a "),Ca=a("a"),pk=n("tf.keras.Model"),gk=n(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),uk=l(),k(vn.$$.fragment),_k=l(),nt=a("div"),k(Pa.$$.fragment),wk=l(),Co=a("p"),kk=n("The "),vr=a("a"),bk=n("TFLongformerForMultipleChoice"),vk=n(" forward method, overrides the "),Sl=a("code"),Tk=n("__call__"),yk=n(" special method."),Lk=l(),k(Tn.$$.fragment),$k=l(),Dl=a("p"),Fk=n("Example:"),xk=l(),k(ja.$$.fragment),this.h()},l(o){const f=n1('[data-svelte="svelte-1phssyn"]',document.head);p=r(f,"META",{name:!0,content:!0}),f.forEach(t),x=d(o),g=r(o,"H1",{class:!0});var Oa=i(g);u=r(Oa,"A",{id:!0,class:!0,href:!0});var Bl=i(u);$=r(Bl,"SPAN",{});var Wl=i($);b(w.$$.fragment,Wl),Wl.forEach(t),Bl.forEach(t),_=d(Oa),M=r(Oa,"SPAN",{});var Ql=i(M);de=s(Ql,"Longformer"),Ql.forEach(t),Oa.forEach(t),X=d(o),E=r(o,"P",{});var yn=i(E);ne=r(yn,"STRONG",{});var Hl=i(ne);Q=s(Hl,"DISCLAIMER:"),Hl.forEach(t),ce=s(yn," This model is still a work in progress, if you see something strange, file a "),Z=r(yn,"A",{href:!0,rel:!0});var Rl=i(Z);H=s(Rl,"Github Issue"),Rl.forEach(t),he=s(yn,"."),yn.forEach(t),ae=d(o),R=r(o,"H2",{class:!0});var Aa=i(R);P=r(Aa,"A",{id:!0,class:!0,href:!0});var Ul=i(P);se=r(Ul,"SPAN",{});var Vl=i(se);b(K.$$.fragment,Vl),Vl.forEach(t),Ul.forEach(t),z=d(Aa),q=r(Aa,"SPAN",{});var Gl=i(q);me=s(Gl,"Overview"),Gl.forEach(t),Aa.forEach(t),D=d(o),Y=r(o,"P",{});var Ia=i(Y);fe=s(Ia,"The Longformer model was presented in "),I=r(Ia,"A",{href:!0,rel:!0});var Kl=i(I);pe=s(Kl,"Longformer: The Long-Document Transformer"),Kl.forEach(t),ge=s(Ia," by Iz Beltagy, Matthew E. Peters, Arman Cohan."),Ia.forEach(t),C=d(o),ee=r(o,"P",{});var Jl=i(ee);U=s(Jl,"The abstract from the paper is the following:"),Jl.forEach(t),re=d(o),te=r(o,"P",{});var Xl=i(te);N=r(Xl,"EM",{});var Yl=i(N);ue=s(Yl,`Transformer-based models are unable to process long sequences due to their self-attention operation, which scales
quadratically with the sequence length. To address this limitation, we introduce the Longformer with an attention
mechanism that scales linearly with sequence length, making it easy to process documents of thousands of tokens or
longer. Longformer\u2019s attention mechanism is a drop-in replacement for the standard self-attention and combines a local
windowed attention with a task motivated global attention. Following prior work on long-sequence transformers, we
...
`),ti=r(Lr,"CODE",{});var Wk=i(ti);em=s(Wk,"global_attention_mask"),Wk.forEach(t),tm=s(Lr,":"),Lr.forEach(t),wd=d(o),Ao=r(o,"UL",{});var Fc=i(Ao);oi=r(Fc,"LI",{});var Qk=i(oi);om=s(Qk,"0: the token attends \u201Clocally\u201D,"),Qk.forEach(t),nm=d(Fc),ni=r(Fc,"LI",{});var Hk=i(ni);sm=s(Hk,"1: the token attends \u201Cglobally\u201D."),Hk.forEach(t),Fc.forEach(t),kd=d(o),Io=r(o,"P",{});var xc=i(Io);am=s(xc,"For more information please also refer to "),Na=r(xc,"A",{href:!0});var Rk=i(Na);rm=s(Rk,"forward()"),Rk.forEach(t),im=s(xc," method."),xc.forEach(t),bd=d(o),Ve=r(o,"P",{});var wt=i(Ve);lm=s(wt,`Using Longformer self attention, the memory and time complexity of the query-key matmul operation, which usually
represents the memory and time bottleneck, can be reduced from `),vd=jo(wt),Td=s(wt,` to
`),yd=jo(wt),Ld=s(wt,", with "),$d=jo(wt),Fd=s(wt," being the sequence length and "),xd=jo(wt),Md=s(wt,` being the average window
size. It is assumed that the number of \u201Cglobally\u201D attending tokens is insignificant as compared to the number of
\u201Clocally\u201D attending tokens.`),wt.forEach(t),Ed=d(o),No=r(o,"P",{});var Mc=i(No);dm=s(Mc,"For more information, please refer to the official "),Fn=r(Mc,"A",{href:!0,rel:!0});var Uk=i(Fn);cm=s(Uk,"paper"),Uk.forEach(t),hm=s(Mc,"."),Mc.forEach(t),zd=d(o),Ot=r(o,"H2",{class:!0});var Ec=i(Ot);So=r(Ec,"A",{id:!0,class:!0,href:!0});var Vk=i(So);si=r(Vk,"SPAN",{});var Gk=i(si);b(xn.$$.fragment,Gk),Gk.forEach(t),Vk.forEach(t),mm=d(Ec),ai=r(Ec,"SPAN",{});var Kk=i(ai);fm=s(Kk,"Training"),Kk.forEach(t),Ec.forEach(t),qd=d(o),At=r(o,"P",{});var td=i(At);Sa=r(td,"A",{href:!0});var Jk=i(Sa);pm=s(Jk,"LongformerForMaskedLM"),Jk.forEach(t),gm=s(td," is trained the exact same way "),Da=r(td,"A",{href:!0});var Xk=i(Da);um=s(Xk,"RobertaForMaskedLM"),Xk.forEach(t),_m=s(td,` is
trained and should be used as follows:`),td.forEach(t),Cd=d(o),b(Mn.$$.fragment,o),Pd=d(o),It=r(o,"H2",{class:!0});var zc=i(It);Do=r(zc,"A",{id:!0,class:!0,href:!0});var Yk=i(Do);ri=r(Yk,"SPAN",{});var Zk=i(ri);b(En.$$.fragment,Zk),Zk.forEach(t),Yk.forEach(t),wm=d(zc),ii=r(zc,"SPAN",{});var eb=i(ii);km=s(eb,"LongformerConfig"),eb.forEach(t),zc.forEach(t),jd=d(o),Oe=r(o,"DIV",{class:!0});var it=i(Oe);b(zn.$$.fragment,it),bm=d(it),Nt=r(it,"P",{});var $r=i(Nt);vm=s($r,"This is the configuration class to store the configuration of a "),Ba=r($r,"A",{href:!0});var tb=i(Ba);Tm=s(tb,"LongformerModel"),tb.forEach(t),ym=s($r," or a "),Wa=r($r,"A",{href:!0});var ob=i(Wa);Lm=s(ob,"TFLongformerModel"),ob.forEach(t),$m=s($r,`. It
is used to instantiate a Longformer model according to the specified arguments, defining the model architecture.`),$r.forEach(t),Fm=d(it),St=r(it,"P",{});var Fr=i(St);xm=s(Fr,"This is the configuration class to store the configuration of a "),Qa=r(Fr,"A",{href:!0});var nb=i(Qa);Mm=s(nb,"LongformerModel"),nb.forEach(t),Em=s(Fr,`. It is used to instantiate an
Longformer model according to the specified arguments, defining the model architecture. Instantiating a
configuration with the defaults will yield a similar configuration to that of the RoBERTa
`),qn=r(Fr,"A",{href:!0,rel:!0});var sb=i(qn);zm=s(sb,"roberta-base"),sb.forEach(t),qm=s(Fr," architecture with a sequence length 4,096."),Fr.forEach(t),Cm=d(it),Dt=r(it,"P",{});var xr=i(Dt);Pm=s(xr,"The "),Ha=r(xr,"A",{href:!0});var ab=i(Ha);jm=s(ab,"LongformerConfig"),ab.forEach(t),Om=s(xr," class directly inherits "),Ra=r(xr,"A",{href:!0});var rb=i(Ra);Am=s(rb,"RobertaConfig"),rb.forEach(t),Im=s(xr,`. It reuses the same defaults. Please check the
parent class for more information.`),xr.forEach(t),Nm=d(it),li=r(it,"P",{});var ib=i(li);Sm=s(ib,"Example:"),ib.forEach(t),Dm=d(it),b(Cn.$$.fragment,it),it.forEach(t),Od=d(o),Bt=r(o,"H2",{class:!0});var qc=i(Bt);Bo=r(qc,"A",{id:!0,class:!0,href:!0});var lb=i(Bo);di=r(lb,"SPAN",{});var db=i(di);b(Pn.$$.fragment,db),db.forEach(t),lb.forEach(t),Bm=d(qc),ci=r(qc,"SPAN",{});var cb=i(ci);Wm=s(cb,"LongformerTokenizer"),cb.forEach(t),qc.forEach(t),Ad=d(o),ft=r(o,"DIV",{class:!0});var Mr=i(ft);b(jn.$$.fragment,Mr),Qm=d(Mr),hi=r(Mr,"P",{});var hb=i(hi);Hm=s(hb,"Construct a Longformer tokenizer."),hb.forEach(t),Rm=d(Mr),Wo=r(Mr,"P",{});var od=i(Wo);Ua=r(od,"A",{href:!0});var mb=i(Ua);Um=s(mb,"LongformerTokenizer"),mb.forEach(t),Vm=s(od," is identical to "),Va=r(od,"A",{href:!0});var fb=i(Va);Gm=s(fb,"RobertaTokenizer"),fb.forEach(t),Km=s(od,`. Refer to the superclass for usage examples and
documentation concerning parameters.`),od.forEach(t),Mr.forEach(t),Id=d(o),Wt=r(o,"H2",{class:!0});var Cc=i(Wt);Qo=r(Cc,"A",{id:!0,class:!0,href:!0});var pb=i(Qo);mi=r(pb,"SPAN",{});var gb=i(mi);b(On.$$.fragment,gb),gb.forEach(t),pb.forEach(t),Jm=d(Cc),fi=r(Cc,"SPAN",{});var ub=i(fi);Xm=s(ub,"LongformerTokenizerFast"),ub.forEach(t),Cc.forEach(t),Nd=d(o),pt=r(o,"DIV",{class:!0});var Er=i(pt);b(An.$$.fragment,Er),Ym=d(Er),In=r(Er,"P",{});var Pc=i(In);Zm=s(Pc,"Construct a \u201Cfast\u201D Longformer tokenizer (backed by HuggingFace\u2019s "),pi=r(Pc,"EM",{});var _b=i(pi);ef=s(_b,"tokenizers"),_b.forEach(t),tf=s(Pc," library)."),Pc.forEach(t),of=d(Er),Ho=r(Er,"P",{});var nd=i(Ho);Ga=r(nd,"A",{href:!0});var wb=i(Ga);nf=s(wb,"LongformerTokenizerFast"),wb.forEach(t),sf=s(nd," is identical to "),Ka=r(nd,"A",{href:!0});var kb=i(Ka);af=s(kb,"RobertaTokenizerFast"),kb.forEach(t),rf=s(nd,`. Refer to the superclass for usage examples
and documentation concerning parameters.`),nd.forEach(t),Er.forEach(t),Sd=d(o),Qt=r(o,"H2",{class:!0});var jc=i(Qt);Ro=r(jc,"A",{id:!0,class:!0,href:!0});var bb=i(Ro);gi=r(bb,"SPAN",{});var vb=i(gi);b(Nn.$$.fragment,vb),vb.forEach(t),bb.forEach(t),lf=d(jc),ui=r(jc,"SPAN",{});var Tb=i(ui);df=s(Tb,"Longformer specific outputs"),Tb.forEach(t),jc.forEach(t),Dd=d(o),Ht=r(o,"DIV",{class:!0});var Oc=i(Ht);b(Sn.$$.fragment,Oc),cf=d(Oc),_i=r(Oc,"P",{});var yb=i(_i);hf=s(yb,"Base class for Longformer\u2019s outputs, with potential hidden states, local and global attentions."),yb.forEach(t),Oc.forEach(t),Bd=d(o),Rt=r(o,"DIV",{class:!0});var Ac=i(Rt);b(Dn.$$.fragment,Ac),mf=d(Ac),wi=r(Ac,"P",{});var Lb=i(wi);ff=s(Lb,"Base class for Longformer\u2019s outputs that also contains a pooling of the last hidden states."),Lb.forEach(t),Ac.forEach(t),Wd=d(o),Ut=r(o,"DIV",{class:!0});var Ic=i(Ut);b(Bn.$$.fragment,Ic),pf=d(Ic),ki=r(Ic,"P",{});var $b=i(ki);gf=s($b,"Base class for masked language models outputs."),$b.forEach(t),Ic.forEach(t),Qd=d(o),Vt=r(o,"DIV",{class:!0});var Nc=i(Vt);b(Wn.$$.fragment,Nc),uf=d(Nc),bi=r(Nc,"P",{});var Fb=i(bi);_f=s(Fb,"Base class for outputs of question answering Longformer models."),Fb.forEach(t),Nc.forEach(t),Hd=d(o),Gt=r(o,"DIV",{class:!0});var Sc=i(Gt);b(Qn.$$.fragment,Sc),wf=d(Sc),vi=r(Sc,"P",{});var xb=i(vi);kf=s(xb,"Base class for outputs of sentence classification models."),xb.forEach(t),Sc.forEach(t),Rd=d(o),Kt=r(o,"DIV",{class:!0});var Dc=i(Kt);b(Hn.$$.fragment,Dc),bf=d(Dc),Ti=r(Dc,"P",{});var Mb=i(Ti);vf=s(Mb,"Base class for outputs of multiple choice Longformer models."),Mb.forEach(t),Dc.forEach(t),Ud=d(o),Jt=r(o,"DIV",{class:!0});var Bc=i(Jt);b(Rn.$$.fragment,Bc),Tf=d(Bc),yi=r(Bc,"P",{});var Eb=i(yi);yf=s(Eb,"Base class for outputs of token classification models."),Eb.forEach(t),Bc.forEach(t),Vd=d(o),Xt=r(o,"DIV",{class:!0});var Wc=i(Xt);b(Un.$$.fragment,Wc),Lf=d(Wc),Li=r(Wc,"P",{});var zb=i(Li);$f=s(zb,"Base class for Longformer\u2019s outputs, with potential hidden states, local and global attentions."),zb.forEach(t),Wc.forEach(t),Gd=d(o),Yt=r(o,"DIV",{class:!0});var Qc=i(Yt);b(Vn.$$.fragment,Qc),Ff=d(Qc),$i=r(Qc,"P",{});var qb=i($i);xf=s(qb,"Base class for Longformer\u2019s outputs that also contains a pooling of the last hidden states."),qb.forEach(t),Qc.forEach(t),Kd=d(o),Zt=r(o,"DIV",{class:!0});var Hc=i(Zt);b(Gn.$$.fragment,Hc),Mf=d(Hc),Fi=r(Hc,"P",{});var Cb=i(Fi);Ef=s(Cb,"Base class for masked language models outputs."),Cb.forEach(t),Hc.forEach(t),Jd=d(o),eo=r(o,"DIV",{class:!0});var Rc=i(eo);b(Kn.$$.fragment,Rc),zf=d(Rc),xi=r(Rc,"P",{});var Pb=i(xi);qf=s(Pb,"Base class for outputs of question answering Longformer models."),Pb.forEach(t),Rc.forEach(t),Xd=d(o),to=r(o,"DIV",{class:!0});var Uc=i(to);b(Jn.$$.fragment,Uc),Cf=d(Uc),Mi=r(Uc,"P",{});var jb=i(Mi);Pf=s(jb,"Base class for outputs of sentence classification models."),jb.forEach(t),Uc.forEach(t),Yd=d(o),oo=r(o,"DIV",{class:!0});var Vc=i(oo);b(Xn.$$.fragment,Vc),jf=d(Vc),Ei=r(Vc,"P",{});var Ob=i(Ei);Of=s(Ob,"Base class for outputs of multiple choice models."),Ob.forEach(t),Vc.forEach(t),Zd=d(o),no=r(o,"DIV",{class:!0});var Gc=i(no);b(Yn.$$.fragment,Gc),Af=d(Gc),zi=r(Gc,"P",{});var Ab=i(zi);If=s(Ab,"Base class for outputs of token classification models."),Ab.forEach(t),Gc.forEach(t),ec=d(o),so=r(o,"H2",{class:!0});var Kc=i(so);Uo=r(Kc,"A",{id:!0,class:!0,href:!0});var Ib=i(Uo);qi=r(Ib,"SPAN",{});var Nb=i(qi);b(Zn.$$.fragment,Nb),Nb.forEach(t),Ib.forEach(t),Nf=d(Kc),Ci=r(Kc,"SPAN",{});var Sb=i(Ci);Sf=s(Sb,"LongformerModel"),Sb.forEach(t),Kc.forEach(t),tc=d(o),qe=r(o,"DIV",{class:!0});var st=i(qe);b(es.$$.fragment,st),Df=d(st),Pi=r(st,"P",{});var Db=i(Pi);Bf=s(Db,"The bare Longformer Model outputting raw hidden-states without any specific head on top."),Db.forEach(t),Wf=d(st),ts=r(st,"P",{});var Jc=i(ts);Qf=s(Jc,"This model inherits from "),Ja=r(Jc,"A",{href:!0});var Bb=i(Ja);Hf=s(Bb,"PreTrainedModel"),Bb.forEach(t),Rf=s(Jc,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Jc.forEach(t),Uf=d(st),os=r(st,"P",{});var Xc=i(os);Vf=s(Xc,"This model is also a PyTorch "),ns=r(Xc,"A",{href:!0,rel:!0});var Wb=i(ns);Gf=s(Wb,"torch.nn.Module"),Wb.forEach(t),Kf=s(Xc,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Xc.forEach(t),Jf=d(st),ao=r(st,"P",{});var zr=i(ao);Xf=s(zr,"This class copied code from "),Xa=r(zr,"A",{href:!0});var Qb=i(Xa);Yf=s(Qb,"RobertaModel"),Qb.forEach(t),Zf=s(zr,` and overwrote standard self-attention with longformer self-attention
to provide the ability to process long sequences following the self-attention approach described in `),ss=r(zr,"A",{href:!0,rel:!0});var Hb=i(ss);ep=s(Hb,`Longformer:
the Long-Document Transformer`),Hb.forEach(t),tp=s(zr,` by Iz Beltagy, Matthew E. Peters, and Arman Cohan.
Longformer self-attention combines a local (sliding window) and global attention to extend to long documents
without the O(n^2) increase in memory and compute.`),zr.forEach(t),op=d(st),as=r(st,"P",{});var Yc=i(as);np=s(Yc,"The self-attention module "),ji=r(Yc,"CODE",{});var Rb=i(ji);sp=s(Rb,"LongformerSelfAttention"),Rb.forEach(t),ap=s(Yc,` implemented here supports the combination of local and global
attention but it lacks support for autoregressive attention and dilated attention. Autoregressive and dilated
attention are more relevant for autoregressive language modeling than finetuning on downstream tasks. Future
release will add support for autoregressive attention, but the support for dilated attention requires a custom CUDA
kernel to be memory and compute efficient.`),Yc.forEach(t),rp=d(st),Ge=r(st,"DIV",{class:!0});var kt=i(Ge);b(rs.$$.fragment,kt),ip=d(kt),ro=r(kt,"P",{});var qr=i(ro);lp=s(qr,"The "),Ya=r(qr,"A",{href:!0});var Ub=i(Ya);dp=s(Ub,"LongformerModel"),Ub.forEach(t),cp=s(qr," forward method, overrides the "),Oi=r(qr,"CODE",{});var Vb=i(Oi);hp=s(Vb,"__call__"),Vb.forEach(t),mp=s(qr," special method."),qr.forEach(t),fp=d(kt),b(Vo.$$.fragment,kt),pp=d(kt),Ai=r(kt,"P",{});var Gb=i(Ai);gp=s(Gb,"Examples:"),Gb.forEach(t),up=d(kt),b(is.$$.fragment,kt),kt.forEach(t),st.forEach(t),oc=d(o),io=r(o,"H2",{class:!0});var Zc=i(io);Go=r(Zc,"A",{id:!0,class:!0,href:!0});var Kb=i(Go);Ii=r(Kb,"SPAN",{});var Jb=i(Ii);b(ls.$$.fragment,Jb),Jb.forEach(t),Kb.forEach(t),_p=d(Zc),Ni=r(Zc,"SPAN",{});var Xb=i(Ni);wp=s(Xb,"LongformerForMaskedLM"),Xb.forEach(t),Zc.forEach(t),nc=d(o),We=r(o,"DIV",{class:!0});var bt=i(We);b(ds.$$.fragment,bt),kp=d(bt),cs=r(bt,"P",{});var eh=i(cs);bp=s(eh,"Longformer Model with a "),Si=r(eh,"CODE",{});var Yb=i(Si);vp=s(Yb,"language modeling"),Yb.forEach(t),Tp=s(eh," head on top."),eh.forEach(t),yp=d(bt),hs=r(bt,"P",{});var th=i(hs);Lp=s(th,"This model inherits from "),Za=r(th,"A",{href:!0});var Zb=i(Za);$p=s(Zb,"PreTrainedModel"),Zb.forEach(t),Fp=s(th,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),th.forEach(t),xp=d(bt),ms=r(bt,"P",{});var oh=i(ms);Mp=s(oh,"This model is also a PyTorch "),fs=r(oh,"A",{href:!0,rel:!0});var ev=i(fs);Ep=s(ev,"torch.nn.Module"),ev.forEach(t),zp=s(oh,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),oh.forEach(t),qp=d(bt),Ke=r(bt,"DIV",{class:!0});var vt=i(Ke);b(ps.$$.fragment,vt),Cp=d(vt),lo=r(vt,"P",{});var Cr=i(lo);Pp=s(Cr,"The "),er=r(Cr,"A",{href:!0});var tv=i(er);jp=s(tv,"LongformerForMaskedLM"),tv.forEach(t),Op=s(Cr," forward method, overrides the "),Di=r(Cr,"CODE",{});var ov=i(Di);Ap=s(ov,"__call__"),ov.forEach(t),Ip=s(Cr," special method."),Cr.forEach(t),Np=d(vt),b(Ko.$$.fragment,vt),Sp=d(vt),Bi=r(vt,"P",{});var nv=i(Bi);Dp=s(nv,"Examples:"),nv.forEach(t),Bp=d(vt),b(gs.$$.fragment,vt),vt.forEach(t),bt.forEach(t),sc=d(o),co=r(o,"H2",{class:!0});var nh=i(co);Jo=r(nh,"A",{id:!0,class:!0,href:!0});var sv=i(Jo);Wi=r(sv,"SPAN",{});var av=i(Wi);b(us.$$.fragment,av),av.forEach(t),sv.forEach(t),Wp=d(nh),Qi=r(nh,"SPAN",{});var rv=i(Qi);Qp=s(rv,"LongformerForSequenceClassification"),rv.forEach(t),nh.forEach(t),ac=d(o),Qe=r(o,"DIV",{class:!0});var Tt=i(Qe);b(_s.$$.fragment,Tt),Hp=d(Tt),Hi=r(Tt,"P",{});var iv=i(Hi);Rp=s(iv,`Longformer Model transformer with a sequence classification/regression head on top (a linear layer on top of the
pooled output) e.g. for GLUE tasks.`),iv.forEach(t),Up=d(Tt),ws=r(Tt,"P",{});var sh=i(ws);Vp=s(sh,"This model inherits from "),tr=r(sh,"A",{href:!0});var lv=i(tr);Gp=s(lv,"PreTrainedModel"),lv.forEach(t),Kp=s(sh,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),sh.forEach(t),Jp=d(Tt),ks=r(Tt,"P",{});var ah=i(ks);Xp=s(ah,"This model is also a PyTorch "),bs=r(ah,"A",{href:!0,rel:!0});var dv=i(bs);Yp=s(dv,"torch.nn.Module"),dv.forEach(t),Zp=s(ah,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),ah.forEach(t),eg=d(Tt),Ce=r(Tt,"DIV",{class:!0});var at=i(Ce);b(vs.$$.fragment,at),tg=d(at),ho=r(at,"P",{});var Pr=i(ho);og=s(Pr,"The "),or=r(Pr,"A",{href:!0});var cv=i(or);ng=s(cv,"LongformerForSequenceClassification"),cv.forEach(t),sg=s(Pr," forward method, overrides the "),Ri=r(Pr,"CODE",{});var hv=i(Ri);ag=s(hv,"__call__"),hv.forEach(t),rg=s(Pr," special method."),Pr.forEach(t),ig=d(at),b(Xo.$$.fragment,at),lg=d(at),Ui=r(at,"P",{});var mv=i(Ui);dg=s(mv,"Example of single-label classification:"),mv.forEach(t),cg=d(at),b(Ts.$$.fragment,at),hg=d(at),Vi=r(at,"P",{});var fv=i(Vi);mg=s(fv,"Example of multi-label classification:"),fv.forEach(t),fg=d(at),b(ys.$$.fragment,at),at.forEach(t),Tt.forEach(t),rc=d(o),mo=r(o,"H2",{class:!0});var rh=i(mo);Yo=r(rh,"A",{id:!0,class:!0,href:!0});var pv=i(Yo);Gi=r(pv,"SPAN",{});var gv=i(Gi);b(Ls.$$.fragment,gv),gv.forEach(t),pv.forEach(t),pg=d(rh),Ki=r(rh,"SPAN",{});var uv=i(Ki);gg=s(uv,"LongformerForMultipleChoice"),uv.forEach(t),rh.forEach(t),ic=d(o),He=r(o,"DIV",{class:!0});var yt=i(He);b($s.$$.fragment,yt),ug=d(yt),Ji=r(yt,"P",{});var _v=i(Ji);_g=s(_v,`Longformer Model with a multiple choice classification head on top (a linear layer on top of the pooled output and
a softmax) e.g. for RocStories/SWAG tasks.`),_v.forEach(t),wg=d(yt),Fs=r(yt,"P",{});var ih=i(Fs);kg=s(ih,"This model inherits from "),nr=r(ih,"A",{href:!0});var wv=i(nr);bg=s(wv,"PreTrainedModel"),wv.forEach(t),vg=s(ih,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),ih.forEach(t),Tg=d(yt),xs=r(yt,"P",{});var lh=i(xs);yg=s(lh,"This model is also a PyTorch "),Ms=r(lh,"A",{href:!0,rel:!0});var kv=i(Ms);Lg=s(kv,"torch.nn.Module"),kv.forEach(t),$g=s(lh,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),lh.forEach(t),Fg=d(yt),Je=r(yt,"DIV",{class:!0});var Lt=i(Je);b(Es.$$.fragment,Lt),xg=d(Lt),fo=r(Lt,"P",{});var jr=i(fo);Mg=s(jr,"The "),sr=r(jr,"A",{href:!0});var bv=i(sr);Eg=s(bv,"LongformerForMultipleChoice"),bv.forEach(t),zg=s(jr," forward method, overrides the "),Xi=r(jr,"CODE",{});var vv=i(Xi);qg=s(vv,"__call__"),vv.forEach(t),Cg=s(jr," special method."),jr.forEach(t),Pg=d(Lt),b(Zo.$$.fragment,Lt),jg=d(Lt),Yi=r(Lt,"P",{});var Tv=i(Yi);Og=s(Tv,"Example:"),Tv.forEach(t),Ag=d(Lt),b(zs.$$.fragment,Lt),Lt.forEach(t),yt.forEach(t),lc=d(o),po=r(o,"H2",{class:!0});var dh=i(po);en=r(dh,"A",{id:!0,class:!0,href:!0});var yv=i(en);Zi=r(yv,"SPAN",{});var Lv=i(Zi);b(qs.$$.fragment,Lv),Lv.forEach(t),yv.forEach(t),Ig=d(dh),el=r(dh,"SPAN",{});var $v=i(el);Ng=s($v,"LongformerForTokenClassification"),$v.forEach(t),dh.forEach(t),dc=d(o),Re=r(o,"DIV",{class:!0});var $t=i(Re);b(Cs.$$.fragment,$t),Sg=d($t),tl=r($t,"P",{});var Fv=i(tl);Dg=s(Fv,`Longformer Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g.
for Named-Entity-Recognition (NER) tasks.`),Fv.forEach(t),Bg=d($t),Ps=r($t,"P",{});var ch=i(Ps);Wg=s(ch,"This model inherits from "),ar=r(ch,"A",{href:!0});var xv=i(ar);Qg=s(xv,"PreTrainedModel"),xv.forEach(t),Hg=s(ch,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),ch.forEach(t),Rg=d($t),js=r($t,"P",{});var hh=i(js);Ug=s(hh,"This model is also a PyTorch "),Os=r(hh,"A",{href:!0,rel:!0});var Mv=i(Os);Vg=s(Mv,"torch.nn.Module"),Mv.forEach(t),Gg=s(hh,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),hh.forEach(t),Kg=d($t),Xe=r($t,"DIV",{class:!0});var Ft=i(Xe);b(As.$$.fragment,Ft),Jg=d(Ft),go=r(Ft,"P",{});var Or=i(go);Xg=s(Or,"The "),rr=r(Or,"A",{href:!0});var Ev=i(rr);Yg=s(Ev,"LongformerForTokenClassification"),Ev.forEach(t),Zg=s(Or," forward method, overrides the "),ol=r(Or,"CODE",{});var zv=i(ol);eu=s(zv,"__call__"),zv.forEach(t),tu=s(Or," special method."),Or.forEach(t),ou=d(Ft),b(tn.$$.fragment,Ft),nu=d(Ft),nl=r(Ft,"P",{});var qv=i(nl);su=s(qv,"Example:"),qv.forEach(t),au=d(Ft),b(Is.$$.fragment,Ft),Ft.forEach(t),$t.forEach(t),cc=d(o),uo=r(o,"H2",{class:!0});var mh=i(uo);on=r(mh,"A",{id:!0,class:!0,href:!0});var Cv=i(on);sl=r(Cv,"SPAN",{});var Pv=i(sl);b(Ns.$$.fragment,Pv),Pv.forEach(t),Cv.forEach(t),ru=d(mh),al=r(mh,"SPAN",{});var jv=i(al);iu=s(jv,"LongformerForQuestionAnswering"),jv.forEach(t),mh.forEach(t),hc=d(o),Ue=r(o,"DIV",{class:!0});var xt=i(Ue);b(Ss.$$.fragment,xt),lu=d(xt),_o=r(xt,"P",{});var Ar=i(_o);du=s(Ar,`Longformer Model with a span classification head on top for extractive question-answering tasks like SQuAD /
TriviaQA (a linear layers on top of the hidden-states output to compute `),rl=r(Ar,"CODE",{});var Ov=i(rl);cu=s(Ov,"span start logits"),Ov.forEach(t),hu=s(Ar," and "),il=r(Ar,"CODE",{});var Av=i(il);mu=s(Av,"span end logits"),Av.forEach(t),fu=s(Ar,")."),Ar.forEach(t),pu=d(xt),Ds=r(xt,"P",{});var fh=i(Ds);gu=s(fh,"This model inherits from "),ir=r(fh,"A",{href:!0});var Iv=i(ir);uu=s(Iv,"PreTrainedModel"),Iv.forEach(t),_u=s(fh,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),fh.forEach(t),wu=d(xt),Bs=r(xt,"P",{});var ph=i(Bs);ku=s(ph,"This model is also a PyTorch "),Ws=r(ph,"A",{href:!0,rel:!0});var Nv=i(Ws);bu=s(Nv,"torch.nn.Module"),Nv.forEach(t),vu=s(ph,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),ph.forEach(t),Tu=d(xt),Ye=r(xt,"DIV",{class:!0});var Mt=i(Ye);b(Qs.$$.fragment,Mt),yu=d(Mt),wo=r(Mt,"P",{});var Ir=i(wo);Lu=s(Ir,"The "),lr=r(Ir,"A",{href:!0});var Sv=i(lr);$u=s(Sv,"LongformerForQuestionAnswering"),Sv.forEach(t),Fu=s(Ir," forward method, overrides the "),ll=r(Ir,"CODE",{});var Dv=i(ll);xu=s(Dv,"__call__"),Dv.forEach(t),Mu=s(Ir," special method."),Ir.forEach(t),Eu=d(Mt),b(nn.$$.fragment,Mt),zu=d(Mt),dl=r(Mt,"P",{});var Bv=i(dl);qu=s(Bv,"Examples:"),Bv.forEach(t),Cu=d(Mt),b(Hs.$$.fragment,Mt),Mt.forEach(t),xt.forEach(t),mc=d(o),ko=r(o,"H2",{class:!0});var gh=i(ko);sn=r(gh,"A",{id:!0,class:!0,href:!0});var Wv=i(sn);cl=r(Wv,"SPAN",{});var Qv=i(cl);b(Rs.$$.fragment,Qv),Qv.forEach(t),Wv.forEach(t),Pu=d(gh),hl=r(gh,"SPAN",{});var Hv=i(hl);ju=s(Hv,"TFLongformerModel"),Hv.forEach(t),gh.forEach(t),fc=d(o),Ee=r(o,"DIV",{class:!0});var Be=i(Ee);b(Us.$$.fragment,Be),Ou=d(Be),ml=r(Be,"P",{});var Rv=i(ml);Au=s(Rv,"The bare Longformer Model outputting raw hidden-states without any specific head on top."),Rv.forEach(t),Iu=d(Be),Vs=r(Be,"P",{});var uh=i(Vs);Nu=s(uh,"This model inherits from "),dr=r(uh,"A",{href:!0});var Uv=i(dr);Su=s(Uv,"TFPreTrainedModel"),Uv.forEach(t),Du=s(uh,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),uh.forEach(t),Bu=d(Be),Gs=r(Be,"P",{});var _h=i(Gs);Wu=s(_h,"This model is also a "),Ks=r(_h,"A",{href:!0,rel:!0});var Vv=i(Ks);Qu=s(Vv,"tf.keras.Model"),Vv.forEach(t),Hu=s(_h,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),_h.forEach(t),Ru=d(Be),b(an.$$.fragment,Be),Uu=d(Be),bo=r(Be,"P",{});var Nr=i(bo);Vu=s(Nr,"This class copies code from "),cr=r(Nr,"A",{href:!0});var Gv=i(cr);Gu=s(Gv,"TFRobertaModel"),Gv.forEach(t),Ku=s(Nr,` and overwrites standard self-attention with longformer
self-attention to provide the ability to process long sequences following the self-attention approach described in
`),Js=r(Nr,"A",{href:!0,rel:!0});var Kv=i(Js);Ju=s(Kv,"Longformer: the Long-Document Transformer"),Kv.forEach(t),Xu=s(Nr,` by Iz Beltagy, Matthew E. Peters, and
Arman Cohan. Longformer self-attention combines a local (sliding window) and global attention to extend to long
documents without the O(n^2) increase in memory and compute.`),Nr.forEach(t),Yu=d(Be),Xs=r(Be,"P",{});var wh=i(Xs);Zu=s(wh,"The self-attention module "),fl=r(wh,"CODE",{});var Jv=i(fl);e_=s(Jv,"TFLongformerSelfAttention"),Jv.forEach(t),t_=s(wh,` implemented here supports the combination of local and global
attention but it lacks support for autoregressive attention and dilated attention. Autoregressive and dilated
attention are more relevant for autoregressive language modeling than finetuning on downstream tasks. Future
release will add support for autoregressive attention, but the support for dilated attention requires a custom CUDA
kernel to be memory and compute efficient.`),wh.forEach(t),o_=d(Be),_t=r(Be,"DIV",{class:!0});var Sr=i(_t);b(Ys.$$.fragment,Sr),n_=d(Sr),vo=r(Sr,"P",{});var Dr=i(vo);s_=s(Dr,"The "),hr=r(Dr,"A",{href:!0});var Xv=i(hr);a_=s(Xv,"TFLongformerModel"),Xv.forEach(t),r_=s(Dr," forward method, overrides the "),pl=r(Dr,"CODE",{});var Yv=i(pl);i_=s(Yv,"__call__"),Yv.forEach(t),l_=s(Dr," special method."),Dr.forEach(t),d_=d(Sr),b(rn.$$.fragment,Sr),Sr.forEach(t),Be.forEach(t),pc=d(o),To=r(o,"H2",{class:!0});var kh=i(To);ln=r(kh,"A",{id:!0,class:!0,href:!0});var Zv=i(ln);gl=r(Zv,"SPAN",{});var eT=i(gl);b(Zs.$$.fragment,eT),eT.forEach(t),Zv.forEach(t),c_=d(kh),ul=r(kh,"SPAN",{});var tT=i(ul);h_=s(tT,"TFLongformerForMaskedLM"),tT.forEach(t),kh.forEach(t),gc=d(o),Ae=r(o,"DIV",{class:!0});var lt=i(Ae);b(ea.$$.fragment,lt),m_=d(lt),ta=r(lt,"P",{});var bh=i(ta);f_=s(bh,"Longformer Model with a "),_l=r(bh,"CODE",{});var oT=i(_l);p_=s(oT,"language modeling"),oT.forEach(t),g_=s(bh," head on top."),bh.forEach(t),u_=d(lt),oa=r(lt,"P",{});var vh=i(oa);__=s(vh,"This model inherits from "),mr=r(vh,"A",{href:!0});var nT=i(mr);w_=s(nT,"TFPreTrainedModel"),nT.forEach(t),k_=s(vh,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),vh.forEach(t),b_=d(lt),na=r(lt,"P",{});var Th=i(na);v_=s(Th,"This model is also a "),sa=r(Th,"A",{href:!0,rel:!0});var sT=i(sa);T_=s(sT,"tf.keras.Model"),sT.forEach(t),y_=s(Th,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Th.forEach(t),L_=d(lt),b(dn.$$.fragment,lt),$_=d(lt),Ze=r(lt,"DIV",{class:!0});var Et=i(Ze);b(aa.$$.fragment,Et),F_=d(Et),yo=r(Et,"P",{});var Br=i(yo);x_=s(Br,"The "),fr=r(Br,"A",{href:!0});var aT=i(fr);M_=s(aT,"TFLongformerForMaskedLM"),aT.forEach(t),E_=s(Br," forward method, overrides the "),wl=r(Br,"CODE",{});var rT=i(wl);z_=s(rT,"__call__"),rT.forEach(t),q_=s(Br," special method."),Br.forEach(t),C_=d(Et),b(cn.$$.fragment,Et),P_=d(Et),kl=r(Et,"P",{});var iT=i(kl);j_=s(iT,"Example:"),iT.forEach(t),O_=d(Et),b(ra.$$.fragment,Et),Et.forEach(t),lt.forEach(t),uc=d(o),Lo=r(o,"H2",{class:!0});var yh=i(Lo);hn=r(yh,"A",{id:!0,class:!0,href:!0});var lT=i(hn);bl=r(lT,"SPAN",{});var dT=i(bl);b(ia.$$.fragment,dT),dT.forEach(t),lT.forEach(t),A_=d(yh),vl=r(yh,"SPAN",{});var cT=i(vl);I_=s(cT,"TFLongformerForQuestionAnswering"),cT.forEach(t),yh.forEach(t),_c=d(o),Ie=r(o,"DIV",{class:!0});var dt=i(Ie);b(la.$$.fragment,dt),N_=d(dt),$o=r(dt,"P",{});var Wr=i($o);S_=s(Wr,`Longformer Model with a span classification head on top for extractive question-answering tasks like SQuAD /
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),$h.forEach(t),Y_=d(dt),b(mn.$$.fragment,dt),Z_=d(dt),et=r(dt,"DIV",{class:!0});var zt=i(et);b(ma.$$.fragment,zt),ew=d(zt),Fo=r(zt,"P",{});var Qr=i(Fo);tw=s(Qr,"The "),gr=r(Qr,"A",{href:!0});var gT=i(gr);ow=s(gT,"TFLongformerForQuestionAnswering"),gT.forEach(t),nw=s(Qr," forward method, overrides the "),Ll=r(Qr,"CODE",{});var uT=i(Ll);sw=s(uT,"__call__"),uT.forEach(t),aw=s(Qr," special method."),Qr.forEach(t),rw=d(zt),b(fn.$$.fragment,zt),iw=d(zt),$l=r(zt,"P",{});var _T=i($l);lw=s(_T,"Example:"),_T.forEach(t),dw=d(zt),b(fa.$$.fragment,zt),zt.forEach(t),dt.forEach(t),wc=d(o),xo=r(o,"H2",{class:!0});var Fh=i(xo);pn=r(Fh,"A",{id:!0,class:!0,href:!0});var wT=i(pn);Fl=r(wT,"SPAN",{});var kT=i(Fl);b(pa.$$.fragment,kT),kT.forEach(t),wT.forEach(t),cw=d(Fh),xl=r(Fh,"SPAN",{});var bT=i(xl);hw=s(bT,"TFLongformerForSequenceClassification"),bT.forEach(t),Fh.forEach(t),kc=d(o),Ne=r(o,"DIV",{class:!0});var ct=i(Ne);b(ga.$$.fragment,ct),mw=d(ct),Ml=r(ct,"P",{});var vT=i(Ml);fw=s(vT,`Longformer Model transformer with a sequence classification/regression head on top (a linear layer on top of the
pooled output) e.g. for GLUE tasks.`),vT.forEach(t),pw=d(ct),ua=r(ct,"P",{});var xh=i(ua);gw=s(xh,"This model inherits from "),ur=r(xh,"A",{href:!0});var TT=i(ur);uw=s(TT,"TFPreTrainedModel"),TT.forEach(t),_w=s(xh,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),xh.forEach(t),ww=d(ct),_a=r(ct,"P",{});var Mh=i(_a);kw=s(Mh,"This model is also a "),wa=r(Mh,"A",{href:!0,rel:!0});var yT=i(wa);bw=s(yT,"tf.keras.Model"),yT.forEach(t),vw=s(Mh,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Mh.forEach(t),Tw=d(ct),b(gn.$$.fragment,ct),yw=d(ct),tt=r(ct,"DIV",{class:!0});var qt=i(tt);b(ka.$$.fragment,qt),Lw=d(qt),Mo=r(qt,"P",{});var Hr=i(Mo);$w=s(Hr,"The "),_r=r(Hr,"A",{href:!0});var LT=i(_r);Fw=s(LT,"TFLongformerForSequenceClassification"),LT.forEach(t),xw=s(Hr," forward method, overrides the "),El=r(Hr,"CODE",{});var $T=i(El);Mw=s($T,"__call__"),$T.forEach(t),Ew=s(Hr," special method."),Hr.forEach(t),zw=d(qt),b(un.$$.fragment,qt),qw=d(qt),zl=r(qt,"P",{});var FT=i(zl);Cw=s(FT,"Example:"),FT.forEach(t),Pw=d(qt),b(ba.$$.fragment,qt),qt.forEach(t),ct.forEach(t),bc=d(o),Eo=r(o,"H2",{class:!0});var Eh=i(Eo);_n=r(Eh,"A",{id:!0,class:!0,href:!0});var xT=i(_n);ql=r(xT,"SPAN",{});var MT=i(ql);b(va.$$.fragment,MT),MT.forEach(t),xT.forEach(t),jw=d(Eh),Cl=r(Eh,"SPAN",{});var ET=i(Cl);Ow=s(ET,"TFLongformerForTokenClassification"),ET.forEach(t),Eh.forEach(t),vc=d(o),Se=r(o,"DIV",{class:!0});var ht=i(Se);b(Ta.$$.fragment,ht),Aw=d(ht),Pl=r(ht,"P",{});var zT=i(Pl);Iw=s(zT,`Longformer Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g.
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),qh.forEach(t),Uw=d(ht),b(wn.$$.fragment,ht),Vw=d(ht),ot=r(ht,"DIV",{class:!0});var Ct=i(ot);b(Fa.$$.fragment,Ct),Gw=d(Ct),zo=r(Ct,"P",{});var Rr=i(zo);Kw=s(Rr,"The "),kr=r(Rr,"A",{href:!0});var PT=i(kr);Jw=s(PT,"TFLongformerForTokenClassification"),PT.forEach(t),Xw=s(Rr," forward method, overrides the "),jl=r(Rr,"CODE",{});var jT=i(jl);Yw=s(jT,"__call__"),jT.forEach(t),Zw=s(Rr," special method."),Rr.forEach(t),ek=d(Ct),b(kn.$$.fragment,Ct),tk=d(Ct),Ol=r(Ct,"P",{});var OT=i(Ol);ok=s(OT,"Example:"),OT.forEach(t),nk=d(Ct),b(xa.$$.fragment,Ct),Ct.forEach(t),ht.forEach(t),Tc=d(o),qo=r(o,"H2",{class:!0});var Ch=i(qo);bn=r(Ch,"A",{id:!0,class:!0,href:!0});var AT=i(bn);Al=r(AT,"SPAN",{});var IT=i(Al);b(Ma.$$.fragment,IT),IT.forEach(t),AT.forEach(t),sk=d(Ch),Il=r(Ch,"SPAN",{});var NT=i(Il);ak=s(NT,"TFLongformerForMultipleChoice"),NT.forEach(t),Ch.forEach(t),yc=d(o),De=r(o,"DIV",{class:!0});var mt=i(De);b(Ea.$$.fragment,mt),rk=d(mt),Nl=r(mt,"P",{});var ST=i(Nl);ik=s(ST,`Longformer Model with a multiple choice classification head on top (a linear layer on top of the pooled output and
a softmax) e.g. for RocStories/SWAG tasks.`),ST.forEach(t),lk=d(mt),za=r(mt,"P",{});var Ph=i(za);dk=s(Ph,"This model inherits from "),br=r(Ph,"A",{href:!0});var DT=i(br);ck=s(DT,"TFPreTrainedModel"),DT.forEach(t),hk=s(Ph,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),jh.forEach(t),uk=d(mt),b(vn.$$.fragment,mt),_k=d(mt),nt=r(mt,"DIV",{class:!0});var Pt=i(nt);b(Pa.$$.fragment,Pt),wk=d(Pt),Co=r(Pt,"P",{});var Ur=i(Co);kk=s(Ur,"The "),vr=r(Ur,"A",{href:!0});var WT=i(vr);bk=s(WT,"TFLongformerForMultipleChoice"),WT.forEach(t),vk=s(Ur," forward method, overrides the "),Sl=r(Ur,"CODE",{});var QT=i(Sl);Tk=s(QT,"__call__"),QT.forEach(t),yk=s(Ur," special method."),Ur.forEach(t),Lk=d(Pt),b(Tn.$$.fragment,Pt),$k=d(Pt),Dl=r(Pt,"P",{});var HT=i(Dl);Fk=s(HT,"Example:"),HT.forEach(t),xk=d(Pt),b(ja.$$.fragment,Pt),Pt.forEach(t),mt.forEach(t),this.h()},h(){c(p,"name","hf:doc:metadata"),c(p,"content",JSON.stringify(y1)),c(u,"id","longformer"),c(u,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(u,"href","#longformer"),c(g,"class","relative group"),c(Z,"href","https://github.com/huggingface/transformers/issues/new?assignees=&labels=&template=bug-report.md&title"),c(Z,"rel","nofollow"),c(P,"id","overview"),c(P,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(P,"href","#overview"),c(R,"class","relative group"),c(I,"href","https://arxiv.org/pdf/2004.05150.pdf"),c(I,"rel","nofollow"),c(ke,"href","https://huggingface.co/beltagy"),c(ke,"rel","nofollow"),c(be,"href","https://github.com/allenai/longformer"),c(be,"rel","nofollow"),c(Oo,"id","longformer-self-attention"),c(Oo,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(Oo,"href","#longformer-self-attention"),c(jt,"class","relative group"),rd.a=id,ld.a=dd,cd.a=hd,md.a=fd,gd.a=ud,c(Na,"href","/docs/transformers/doc-build-test/en/model_doc/longformer#transformers.LongformerModel.forward"),vd.a=Td,yd.a=Ld,$d.a=Fd,xd.a=Md,c(Fn,"href","https://arxiv.org/pdf/2004.05150.pdf"),c(Fn,"rel","nofollow"),c(So,"id","training"),c(So,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(So,"href","#training"),c(Ot,"class","relative group"),c(Sa,"href","/docs/transformers/doc-build-test/en/model_doc/longformer#transformers.LongformerForMaskedLM"),c(Da,"href","/docs/transformers/doc-build-test/en/model_doc/roberta#transformers.RobertaForMaskedLM"),c(Do,"id","transformers.LongformerConfig"),c(Do,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(Do,"href","#transformers.LongformerConfig"),c(It,"class","relative group"),c(Ba,"href","/docs/transformers/doc-build-test/en/model_doc/longformer#transformers.LongformerModel"),c(Wa,"href","/docs/transformers/doc-build-test/en/model_doc/longformer#transformers.TFLongformerModel"),c(Qa,"href","/docs/transformers/doc-build-test/en/model_doc/longformer#transformers.LongformerModel"),c(qn,"href","https://huggingface.co/roberta-base"),c(qn,"rel","nofollow"),c(Ha,"href","/docs/transformers/doc-build-test/en/model_doc/longformer#transformers.LongformerConfig"),c(Ra,"href","/docs/transformers/doc-build-test/en/model_doc/roberta#transformers.RobertaConfig"),c(Oe,"class","docstring"),c(Bo,"id","transformers.LongformerTokenizer"),c(Bo,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(Bo,"href","#transformers.LongformerTokenizer"),c(Bt,"class","relative group"),c(Ua,"href","/docs/transformers/doc-build-test/en/model_doc/longformer#transformers.LongformerTokenizer"),c(Va,"href","/docs/transformers/doc-build-test/en/model_doc/roberta#transformers.RobertaTokenizer"),c(ft,"class","docstring"),c(Qo,"id","transformers.LongformerTokenizerFast"),c(Qo,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(Qo,"href","#transformers.LongformerTokenizerFast"),c(Wt,"class","relative group"),c(Ga,"href","/docs/transformers/doc-build-test/en/model_doc/longformer#transformers.LongformerTokenizerFast"),c(Ka,"href","/docs/transformers/doc-build-test/en/model_doc/roberta#transformers.RobertaTokenizerFast"),c(pt,"class","docstring"),c(Ro,"id","transformers.models.longformer.modeling_longformer.LongformerBaseModelOutput"),c(Ro,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(Ro,"href","#transformers.models.longformer.modeling_longformer.LongformerBaseModelOutput"),c(Qt,"class","relative group"),c(Ht,"class","docstring"),c(Rt,"class","docstring"),c(Ut,"class","docstring"),c(Vt,"class","docstring"),c(Gt,"class","docstring"),c(Kt,"class","docstring"),c(Jt,"class","docstring"),c(Xt,"class","docstring"),c(Yt,"class","docstring"),c(Zt,"class","docstring"),c(eo,"class","docstring"),c(to,"class","docstring"),c(oo,"class","docstring"),c(no,"class","docstring"),c(Uo,"id","transformers.LongformerModel"),c(Uo,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(Uo,"href","#transformers.LongformerModel"),c(so,"class","relative group"),c(Ja,"href","/docs/transformers/doc-build-test/en/main_classes/model#transformers.PreTrainedModel"),c(ns,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),c(ns,"rel","nofollow"),c(Xa,"href","/docs/transformers/doc-build-test/en/model_doc/roberta#transformers.RobertaModel"),c(ss,"href","https://arxiv.org/abs/2004.05150"),c(ss,"rel","nofollow"),c(Ya,"href","/docs/transformers/doc-build-test/en/model_doc/longformer#transformers.LongformerModel"),c(Ge,"class","docstring"),c(qe,"class","docstring"),c(Go,"id","transformers.LongformerForMaskedLM"),c(Go,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(Go,"href","#transformers.LongformerForMaskedLM"),c(io,"class","relative group"),c(Za,"href","/docs/transformers/doc-build-test/en/main_classes/model#transformers.PreTrainedModel"),c(fs,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),c(fs,"rel","nofollow"),c(er,"href","/docs/transformers/doc-build-test/en/model_doc/longformer#transformers.LongformerForMaskedLM"),c(Ke,"class","docstring"),c(We,"class","docstring"),c(Jo,"id","transformers.LongformerForSequenceClassification"),c(Jo,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(Jo,"href","#transformers.LongformerForSequenceClassification"),c(co,"class","relative group"),c(tr,"href","/docs/transformers/doc-build-test/en/main_classes/model#transformers.PreTrainedModel"),c(bs,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),c(bs,"rel","nofollow"),c(or,"href","/docs/transformers/doc-build-test/en/model_doc/longformer#transformers.LongformerForSequenceClassification"),c(Ce,"class","docstring"),c(Qe,"class","docstring"),c(Yo,"id","transformers.LongformerForMultipleChoice"),c(Yo,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(Yo,"href","#transformers.LongformerForMultipleChoice"),c(mo,"class","relative group"),c(nr,"href","/docs/transformers/doc-build-test/en/main_classes/model#transformers.PreTrainedModel"),c(Ms,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),c(Ms,"rel","nofollow"),c(sr,"href","/docs/transformers/doc-build-test/en/model_doc/longformer#transformers.LongformerForMultipleChoice"),c(Je,"class","docstring"),c(He,"class","docstring"),c(en,"id","transformers.LongformerForTokenClassification"),c(en,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(en,"href","#transformers.LongformerForTokenClassification"),c(po,"class","relative group"),c(ar,"href","/docs/transformers/doc-build-test/en/main_classes/model#transformers.PreTrainedModel"),c(Os,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),c(Os,"rel","nofollow"),c(rr,"href","/docs/transformers/doc-build-test/en/model_doc/longformer#transformers.LongformerForTokenClassification"),c(Xe,"class","docstring"),c(Re,"class","docstring"),c(on,"id","transformers.LongformerForQuestionAnswering"),c(on,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(on,"href","#transformers.LongformerForQuestionAnswering"),c(uo,"class","relative group"),c(ir,"href","/docs/transformers/doc-build-test/en/main_classes/model#transformers.PreTrainedModel"),c(Ws,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),c(Ws,"rel","nofollow"),c(lr,"href","/docs/transformers/doc-build-test/en/model_doc/longformer#transformers.LongformerForQuestionAnswering"),c(Ye,"class","docstring"),c(Ue,"class","docstring"),c(sn,"id","transformers.TFLongformerModel"),c(sn,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(sn,"href","#transformers.TFLongformerModel"),c(ko,"class","relative group"),c(dr,"href","/docs/transformers/doc-build-test/en/main_classes/model#transformers.TFPreTrainedModel"),c(Ks,"href","https://www.tensorflow.org/api_docs/python/tf/keras/Model"),c(Ks,"rel","nofollow"),c(cr,"href","/docs/transformers/doc-build-test/en/model_doc/roberta#transformers.TFRobertaModel"),c(Js,"href","https://arxiv.org/abs/2004.05150"),c(Js,"rel","nofollow"),c(hr,"href","/docs/transformers/doc-build-test/en/model_doc/longformer#transformers.TFLongformerModel"),c(_t,"class","docstring"),c(Ee,"class","docstring"),c(ln,"id","transformers.TFLongformerForMaskedLM"),c(ln,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(ln,"href","#transformers.TFLongformerForMaskedLM"),c(To,"class","relative group"),c(mr,"href","/docs/transformers/doc-build-test/en/main_classes/model#transformers.TFPreTrainedModel"),c(sa,"href","https://www.tensorflow.org/api_docs/python/tf/keras/Model"),c(sa,"rel","nofollow"),c(fr,"href","/docs/transformers/doc-build-test/en/model_doc/longformer#transformers.TFLongformerForMaskedLM"),c(Ze,"class","docstring"),c(Ae,"class","docstring"),c(hn,"id","transformers.TFLongformerForQuestionAnswering"),c(hn,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(hn,"href","#transformers.TFLongformerForQuestionAnswering"),c(Lo,"class","relative group"),c(pr,"href","/docs/transformers/doc-build-test/en/main_classes/model#transformers.TFPreTrainedModel"),c(ha,"href","https://www.tensorflow.org/api_docs/python/tf/keras/Model"),c(ha,"rel","nofollow"),c(gr,"href","/docs/transformers/doc-build-test/en/model_doc/longformer#transformers.TFLongformerForQuestionAnswering"),c(et,"class","docstring"),c(Ie,"class","docstring"),c(pn,"id","transformers.TFLongformerForSequenceClassification"),c(pn,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(pn,"href","#transformers.TFLongformerForSequenceClassification"),c(xo,"class","relative group"),c(ur,"href","/docs/transformers/doc-build-test/en/main_classes/model#transformers.TFPreTrainedModel"),c(wa,"href","https://www.tensorflow.org/api_docs/python/tf/keras/Model"),c(wa,"rel","nofollow"),c(_r,"href","/docs/transformers/doc-build-test/en/model_doc/longformer#transformers.TFLongformerForSequenceClassification"),c(tt,"class","docstring"),c(Ne,"class","docstring"),c(_n,"id","transformers.TFLongformerForTokenClassification"),c(_n,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(_n,"href","#transformers.TFLongformerForTokenClassification"),c(Eo,"class","relative group"),c(wr,"href","/docs/transformers/doc-build-test/en/main_classes/model#transformers.TFPreTrainedModel"),c($a,"href","https://www.tensorflow.org/api_docs/python/tf/keras/Model"),c($a,"rel","nofollow"),c(kr,"href","/docs/transformers/doc-build-test/en/model_doc/longformer#transformers.TFLongformerForTokenClassification"),c(ot,"class","docstring"),c(Se,"class","docstring"),c(bn,"id","transformers.TFLongformerForMultipleChoice"),c(bn,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(bn,"href","#transformers.TFLongformerForMultipleChoice"),c(qo,"class","relative group"),c(br,"href","/docs/transformers/doc-build-test/en/main_classes/model#transformers.TFPreTrainedModel"),c(Ca,"href","https://www.tensorflow.org/api_docs/python/tf/keras/Model"),c(Ca,"rel","nofollow"),c(vr,"href","/docs/transformers/doc-build-test/en/model_doc/longformer#transformers.TFLongformerForMultipleChoice"),c(nt,"class","docstring"),c(De,"class","docstring")},m(o,f){e(document.head,p),h(o,x,f),h(o,g,f),e(g,u),e(u,$),v(w,$,null),e(g,_),e(g,M),e(M,de),h(o,X,f),h(o,E,f),e(E,ne),e(ne,Q),e(E,ce),e(E,Z),e(Z,H),e(E,he),h(o,ae,f),h(o,R,f),e(R,P),e(P,se),v(K,se,null),e(R,z),e(R,q),e(q,me),h(o,D,f),h(o,Y,f),e(Y,fe),e(Y,I),e(I,pe),e(Y,ge),h(o,C,f),h(o,ee,f),e(ee,U),h(o,re,f),h(o,te,f),e(te,N),e(N,ue),h(o,ie,f),h(o,j,f),e(j,_e),h(o,B,f),h(o,oe,f),e(oe,m),e(m,F),e(m,J),e(J,Le),e(m,$e),e(m,O),e(O,Fe),e(m,xe),e(m,ve),e(ve,A),e(m,V),h(o,Te,f),h(o,le,f),e(le,G),e(le,ke),e(ke,Me),e(le,we),e(le,be),e(be,Oh),e(le,Ah),h(o,sd,f),h(o,jt,f),e(jt,Oo),e(Oo,Vr),v($n,Vr,null),e(jt,Ih),e(jt,Gr),e(Gr,Nh),h(o,ad,f),h(o,ye,f),e(ye,Sh),rd.m(RT,ye),e(ye,id),ld.m(UT,ye),e(ye,dd),cd.m(VT,ye),e(ye,hd),e(ye,Kr),e(Kr,Dh),e(ye,Bh),e(ye,Jr),e(Jr,Wh),e(ye,Qh),e(ye,Xr),e(Xr,Hh),e(ye,Rh),md.m(GT,ye),e(ye,fd),e(ye,Yr),e(Yr,Uh),e(ye,Vh),h(o,pd,f),h(o,gt,f),e(gt,Gh),gd.m(KT,gt),e(gt,ud),e(gt,Zr),e(Zr,Kh),e(gt,Jh),h(o,_d,f),h(o,ut,f),e(ut,Xh),e(ut,ei),e(ei,Yh),e(ut,Zh),e(ut,ti),e(ti,em),e(ut,tm),h(o,wd,f),h(o,Ao,f),e(Ao,oi),e(oi,om),e(Ao,nm),e(Ao,ni),e(ni,sm),h(o,kd,f),h(o,Io,f),e(Io,am),e(Io,Na),e(Na,rm),e(Io,im),h(o,bd,f),h(o,Ve,f),e(Ve,lm),vd.m(JT,Ve),e(Ve,Td),yd.m(XT,Ve),e(Ve,Ld),$d.m(YT,Ve),e(Ve,Fd),xd.m(ZT,Ve),e(Ve,Md),h(o,Ed,f),h(o,No,f),e(No,dm),e(No,Fn),e(Fn,cm),e(No,hm),h(o,zd,f),h(o,Ot,f),e(Ot,So),e(So,si),v(xn,si,null),e(Ot,mm),e(Ot,ai),e(ai,fm),h(o,qd,f),h(o,At,f),e(At,Sa),e(Sa,pm),e(At,gm),e(At,Da),e(Da,um),e(At,_m),h(o,Cd,f),v(Mn,o,f),h(o,Pd,f),h(o,It,f),e(It,Do),e(Do,ri),v(En,ri,null),e(It,wm),e(It,ii),e(ii,km),h(o,jd,f),h(o,Oe,f),v(zn,Oe,null),e(Oe,bm),e(Oe,Nt),e(Nt,vm),e(Nt,Ba),e(Ba,Tm),e(Nt,ym),e(Nt,Wa),e(Wa,Lm),e(Nt,$m),e(Oe,Fm),e(Oe,St),e(St,xm),e(St,Qa),e(Qa,Mm),e(St,Em),e(St,qn),e(qn,zm),e(St,qm),e(Oe,Cm),e(Oe,Dt),e(Dt,Pm),e(Dt,Ha),e(Ha,jm),e(Dt,Om),e(Dt,Ra),e(Ra,Am),e(Dt,Im),e(Oe,Nm),e(Oe,li),e(li,Sm),e(Oe,Dm),v(Cn,Oe,null),h(o,Od,f),h(o,Bt,f),e(Bt,Bo),e(Bo,di),v(Pn,di,null),e(Bt,Bm),e(Bt,ci),e(ci,Wm),h(o,Ad,f),h(o,ft,f),v(jn,ft,null),e(ft,Qm),e(ft,hi),e(hi,Hm),e(ft,Rm),e(ft,Wo),e(Wo,Ua),e(Ua,Um),e(Wo,Vm),e(Wo,Va),e(Va,Gm),e(Wo,Km),h(o,Id,f),h(o,Wt,f),e(Wt,Qo),e(Qo,mi),v(On,mi,null),e(Wt,Jm),e(Wt,fi),e(fi,Xm),h(o,Nd,f),h(o,pt,f),v(An,pt,null),e(pt,Ym),e(pt,In),e(In,Zm),e(In,pi),e(pi,ef),e(In,tf),e(pt,of),e(pt,Ho),e(Ho,Ga),e(Ga,nf),e(Ho,sf),e(Ho,Ka),e(Ka,af),e(Ho,rf),h(o,Sd,f),h(o,Qt,f),e(Qt,Ro),e(Ro,gi),v(Nn,gi,null),e(Qt,lf),e(Qt,ui),e(ui,df),h(o,Dd,f),h(o,Ht,f),v(Sn,Ht,null),e(Ht,cf),e(Ht,_i),e(_i,hf),h(o,Bd,f),h(o,Rt,f),v(Dn,Rt,null),e(Rt,mf),e(Rt,wi),e(wi,ff),h(o,Wd,f),h(o,Ut,f),v(Bn,Ut,null),e(Ut,pf),e(Ut,ki),e(ki,gf),h(o,Qd,f),h(o,Vt,f),v(Wn,Vt,null),e(Vt,uf),e(Vt,bi),e(bi,_f),h(o,Hd,f),h(o,Gt,f),v(Qn,Gt,null),e(Gt,wf),e(Gt,vi),e(vi,kf),h(o,Rd,f),h(o,Kt,f),v(Hn,Kt,null),e(Kt,bf),e(Kt,Ti),e(Ti,vf),h(o,Ud,f),h(o,Jt,f),v(Rn,Jt,null),e(Jt,Tf),e(Jt,yi),e(yi,yf),h(o,Vd,f),h(o,Xt,f),v(Un,Xt,null),e(Xt,Lf),e(Xt,Li),e(Li,$f),h(o,Gd,f),h(o,Yt,f),v(Vn,Yt,null),e(Yt,Ff),e(Yt,$i),e($i,xf),h(o,Kd,f),h(o,Zt,f),v(Gn,Zt,null),e(Zt,Mf),e(Zt,Fi),e(Fi,Ef),h(o,Jd,f),h(o,eo,f),v(Kn,eo,null),e(eo,zf),e(eo,xi),e(xi,qf),h(o,Xd,f),h(o,to,f),v(Jn,to,null),e(to,Cf),e(to,Mi),e(Mi,Pf),h(o,Yd,f),h(o,oo,f),v(Xn,oo,null),e(oo,jf),e(oo,Ei),e(Ei,Of),h(o,Zd,f),h(o,no,f),v(Yn,no,null),e(no,Af),e(no,zi),e(zi,If),h(o,ec,f),h(o,so,f),e(so,Uo),e(Uo,qi),v(Zn,qi,null),e(so,Nf),e(so,Ci),e(Ci,Sf),h(o,tc,f),h(o,qe,f),v(es,qe,null),e(qe,Df),e(qe,Pi),e(Pi,Bf),e(qe,Wf),e(qe,ts),e(ts,Qf),e(ts,Ja),e(Ja,Hf),e(ts,Rf),e(qe,Uf),e(qe,os),e(os,Vf),e(os,ns),e(ns,Gf),e(os,Kf),e(qe,Jf),e(qe,ao),e(ao,Xf),e(ao,Xa),e(Xa,Yf),e(ao,Zf),e(ao,ss),e(ss,ep),e(ao,tp),e(qe,op),e(qe,as),e(as,np),e(as,ji),e(ji,sp),e(as,ap),e(qe,rp),e(qe,Ge),v(rs,Ge,null),e(Ge,ip),e(Ge,ro),e(ro,lp),e(ro,Ya),e(Ya,dp),e(ro,cp),e(ro,Oi),e(Oi,hp),e(ro,mp),e(Ge,fp),v(Vo,Ge,null),e(Ge,pp),e(Ge,Ai),e(Ai,gp),e(Ge,up),v(is,Ge,null),h(o,oc,f),h(o,io,f),e(io,Go),e(Go,Ii),v(ls,Ii,null),e(io,_p),e(io,Ni),e(Ni,wp),h(o,nc,f),h(o,We,f),v(ds,We,null),e(We,kp),e(We,cs),e(cs,bp),e(cs,Si),e(Si,vp),e(cs,Tp),e(We,yp),e(We,hs),e(hs,Lp),e(hs,Za),e(Za,$p),e(hs,Fp),e(We,xp),e(We,ms),e(ms,Mp),e(ms,fs),e(fs,Ep),e(ms,zp),e(We,qp),e(We,Ke),v(ps,Ke,null),e(Ke,Cp),e(Ke,lo),e(lo,Pp),e(lo,er),e(er,jp),e(lo,Op),e(lo,Di),e(Di,Ap),e(lo,Ip),e(Ke,Np),v(Ko,Ke,null),e(Ke,Sp),e(Ke,Bi),e(Bi,Dp),e(Ke,Bp),v(gs,Ke,null),h(o,sc,f),h(o,co,f),e(co,Jo),e(Jo,Wi),v(us,Wi,null),e(co,Wp),e(co,Qi),e(Qi,Qp),h(o,ac,f),h(o,Qe,f),v(_s,Qe,null),e(Qe,Hp),e(Qe,Hi),e(Hi,Rp),e(Qe,Up),e(Qe,ws),e(ws,Vp),e(ws,tr),e(tr,Gp),e(ws,Kp),e(Qe,Jp),e(Qe,ks),e(ks,Xp),e(ks,bs),e(bs,Yp),e(ks,Zp),e(Qe,eg),e(Qe,Ce),v(vs,Ce,null),e(Ce,tg),e(Ce,ho),e(ho,og),e(ho,or),e(or,ng),e(ho,sg),e(ho,Ri),e(Ri,ag),e(ho,rg),e(Ce,ig),v(Xo,Ce,null),e(Ce,lg),e(Ce,Ui),e(Ui,dg),e(Ce,cg),v(Ts,Ce,null),e(Ce,hg),e(Ce,Vi),e(Vi,mg),e(Ce,fg),v(ys,Ce,null),h(o,rc,f),h(o,mo,f),e(mo,Yo),e(Yo,Gi),v(Ls,Gi,null),e(mo,pg),e(mo,Ki),e(Ki,gg),h(o,ic,f),h(o,He,f),v($s,He,null),e(He,ug),e(He,Ji),e(Ji,_g),e(He,wg),e(He,Fs),e(Fs,kg),e(Fs,nr),e(nr,bg),e(Fs,vg),e(He,Tg),e(He,xs),e(xs,yg),e(xs,Ms),e(Ms,Lg),e(xs,$g),e(He,Fg),e(He,Je),v(Es,Je,null),e(Je,xg),e(Je,fo),e(fo,Mg),e(fo,sr),e(sr,Eg),e(fo,zg),e(fo,Xi),e(Xi,qg),e(fo,Cg),e(Je,Pg),v(Zo,Je,null),e(Je,jg),e(Je,Yi),e(Yi,Og),e(Je,Ag),v(zs,Je,null),h(o,lc,f),h(o,po,f),e(po,en),e(en,Zi),v(qs,Zi,null),e(po,Ig),e(po,el),e(el,Ng),h(o,dc,f),h(o,Re,f),v(Cs,Re,null),e(Re,Sg),e(Re,tl),e(tl,Dg),e(Re,Bg),e(Re,Ps),e(Ps,Wg),e(Ps,ar),e(ar,Qg),e(Ps,Hg),e(Re,Rg),e(Re,js),e(js,Ug),e(js,Os),e(Os,Vg),e(js,Gg),e(Re,Kg),e(Re,Xe),v(As,Xe,null),e(Xe,Jg),e(Xe,go),e(go,Xg),e(go,rr),e(rr,Yg),e(go,Zg),e(go,ol),e(ol,eu),e(go,tu),e(Xe,ou),v(tn,Xe,null),e(Xe,nu),e(Xe,nl),e(nl,su),e(Xe,au),v(Is,Xe,null),h(o,cc,f),h(o,uo,f),e(uo,on),e(on,sl),v(Ns,sl,null),e(uo,ru),e(uo,al),e(al,iu),h(o,hc,f),h(o,Ue,f),v(Ss,Ue,null),e(Ue,lu),e(Ue,_o),e(_o,du),e(_o,rl),e(rl,cu),e(_o,hu),e(_o,il),e(il,mu),e(_o,fu),e(Ue,pu),e(Ue,Ds),e(Ds,gu),e(Ds,ir),e(ir,uu),e(Ds,_u),e(Ue,wu),e(Ue,Bs),e(Bs,ku),e(Bs,Ws),e(Ws,bu),e(Bs,vu),e(Ue,Tu),e(Ue,Ye),v(Qs,Ye,null),e(Ye,yu),e(Ye,wo),e(wo,Lu),e(wo,lr),e(lr,$u),e(wo,Fu),e(wo,ll),e(ll,xu),e(wo,Mu),e(Ye,Eu),v(nn,Ye,null),e(Ye,zu),e(Ye,dl),e(dl,qu),e(Ye,Cu),v(Hs,Ye,null),h(o,mc,f),h(o,ko,f),e(ko,sn),e(sn,cl),v(Rs,cl,null),e(ko,Pu),e(ko,hl),e(hl,ju),h(o,fc,f),h(o,Ee,f),v(Us,Ee,null),e(Ee,Ou),e(Ee,ml),e(ml,Au),e(Ee,Iu),e(Ee,Vs),e(Vs,Nu),e(Vs,dr),e(dr,Su),e(Vs,Du),e(Ee,Bu),e(Ee,Gs),e(Gs,Wu),e(Gs,Ks),e(Ks,Qu),e(Gs,Hu),e(Ee,Ru),v(an,Ee,null),e(Ee,Uu),e(Ee,bo),e(bo,Vu),e(bo,cr),e(cr,Gu),e(bo,Ku),e(bo,Js),e(Js,Ju),e(bo,Xu),e(Ee,Yu),e(Ee,Xs),e(Xs,Zu),e(Xs,fl),e(fl,e_),e(Xs,t_),e(Ee,o_),e(Ee,_t),v(Ys,_t,null),e(_t,n_),e(_t,vo),e(vo,s_),e(vo,hr),e(hr,a_),e(vo,r_),e(vo,pl),e(pl,i_),e(vo,l_),e(_t,d_),v(rn,_t,null),h(o,pc,f),h(o,To,f),e(To,ln),e(ln,gl),v(Zs,gl,null),e(To,c_),e(To,ul),e(ul,h_),h(o,gc,f),h(o,Ae,f),v(ea,Ae,null),e(Ae,m_),e(Ae,ta),e(ta,f_),e(ta,_l),e(_l,p_),e(ta,g_),e(Ae,u_),e(Ae,oa),e(oa,__),e(oa,mr),e(mr,w_),e(oa,k_),e(Ae,b_),e(Ae,na),e(na,v_),e(na,sa),e(sa,T_),e(na,y_),e(Ae,L_),v(dn,Ae,null),e(Ae,$_),e(Ae,Ze),v(aa,Ze,null),e(Ze,F_),e(Ze,yo),e(yo,x_),e(yo,fr),e(fr,M_),e(yo,E_),e(yo,wl),e(wl,z_),e(yo,q_),e(Ze,C_),v(cn,Ze,null),e(Ze,P_),e(Ze,kl),e(kl,j_),e(Ze,O_),v(ra,Ze,null),h(o,uc,f),h(o,Lo,f),e(Lo,hn),e(hn,bl),v(ia,bl,null),e(Lo,A_),e(Lo,vl),e(vl,I_),h(o,_c,f),h(o,Ie,f),v(la,Ie,null),e(Ie,N_),e(Ie,$o),e($o,S_),e($o,Tl),e(Tl,D_),e($o,B_),e($o,yl),e(yl,W_),e($o,Q_),e(Ie,H_),e(Ie,da),e(da,R_),e(da,pr),e(pr,U_),e(da,V_),e(Ie,G_),e(Ie,ca),e(ca,K_),e(ca,ha),e(ha,J_),e(ca,X_),e(Ie,Y_),v(mn,Ie,null),e(Ie,Z_),e(Ie,et),v(ma,et,null),e(et,ew),e(et,Fo),e(Fo,tw),e(Fo,gr),e(gr,ow),e(Fo,nw),e(Fo,Ll),e(Ll,sw),e(Fo,aw),e(et,rw),v(fn,et,null),e(et,iw),e(et,$l),e($l,lw),e(et,dw),v(fa,et,null),h(o,wc,f),h(o,xo,f),e(xo,pn),e(pn,Fl),v(pa,Fl,null),e(xo,cw),e(xo,xl),e(xl,hw),h(o,kc,f),h(o,Ne,f),v(ga,Ne,null),e(Ne,mw),e(Ne,Ml),e(Ml,fw),e(Ne,pw),e(Ne,ua),e(ua,gw),e(ua,ur),e(ur,uw),e(ua,_w),e(Ne,ww),e(Ne,_a),e(_a,kw),e(_a,wa),e(wa,bw),e(_a,vw),e(Ne,Tw),v(gn,Ne,null),e(Ne,yw),e(Ne,tt),v(ka,tt,null),e(tt,Lw),e(tt,Mo),e(Mo,$w),e(Mo,_r),e(_r,Fw),e(Mo,xw),e(Mo,El),e(El,Mw),e(Mo,Ew),e(tt,zw),v(un,tt,null),e(tt,qw),e(tt,zl),e(zl,Cw),e(tt,Pw),v(ba,tt,null),h(o,bc,f),h(o,Eo,f),e(Eo,_n),e(_n,ql),v(va,ql,null),e(Eo,jw),e(Eo,Cl),e(Cl,Ow),h(o,vc,f),h(o,Se,f),v(Ta,Se,null),e(Se,Aw),e(Se,Pl),e(Pl,Iw),e(Se,Nw),e(Se,ya),e(ya,Sw),e(ya,wr),e(wr,Dw),e(ya,Bw),e(Se,Ww),e(Se,La),e(La,Qw),e(La,$a),e($a,Hw),e(La,Rw),e(Se,Uw),v(wn,Se,null),e(Se,Vw),e(Se,ot),v(Fa,ot,null),e(ot,Gw),e(ot,zo),e(zo,Kw),e(zo,kr),e(kr,Jw),e(zo,Xw),e(zo,jl),e(jl,Yw),e(zo,Zw),e(ot,ek),v(kn,ot,null),e(ot,tk),e(ot,Ol),e(Ol,ok),e(ot,nk),v(xa,ot,null),h(o,Tc,f),h(o,qo,f),e(qo,bn),e(bn,Al),v(Ma,Al,null),e(qo,sk),e(qo,Il),e(Il,ak),h(o,yc,f),h(o,De,f),v(Ea,De,null),e(De,rk),e(De,Nl),e(Nl,ik),e(De,lk),e(De,za),e(za,dk),e(za,br),e(br,ck),e(za,hk),e(De,mk),e(De,qa),e(qa,fk),e(qa,Ca),e(Ca,pk),e(qa,gk),e(De,uk),v(vn,De,null),e(De,_k),e(De,nt),v(Pa,nt,null),e(nt,wk),e(nt,Co),e(Co,kk),e(Co,vr),e(vr,bk),e(Co,vk),e(Co,Sl),e(Sl,Tk),e(Co,yk),e(nt,Lk),v(Tn,nt,null),e(nt,$k),e(nt,Dl),e(Dl,Fk),e(nt,xk),v(ja,nt,null),Lc=!0},p(o,[f]){const Oa={};f&2&&(Oa.$$scope={dirty:f,ctx:o}),Vo.$set(Oa);const Bl={};f&2&&(Bl.$$scope={dirty:f,ctx:o}),Ko.$set(Bl);const Wl={};f&2&&(Wl.$$scope={dirty:f,ctx:o}),Xo.$set(Wl);const Ql={};f&2&&(Ql.$$scope={dirty:f,ctx:o}),Zo.$set(Ql);const yn={};f&2&&(yn.$$scope={dirty:f,ctx:o}),tn.$set(yn);const Hl={};f&2&&(Hl.$$scope={dirty:f,ctx:o}),nn.$set(Hl);const Rl={};f&2&&(Rl.$$scope={dirty:f,ctx:o}),an.$set(Rl);const Aa={};f&2&&(Aa.$$scope={dirty:f,ctx:o}),rn.$set(Aa);const Ul={};f&2&&(Ul.$$scope={dirty:f,ctx:o}),dn.$set(Ul);const Vl={};f&2&&(Vl.$$scope={dirty:f,ctx:o}),cn.$set(Vl);const Gl={};f&2&&(Gl.$$scope={dirty:f,ctx:o}),mn.$set(Gl);const Ia={};f&2&&(Ia.$$scope={dirty:f,ctx:o}),fn.$set(Ia);const Kl={};f&2&&(Kl.$$scope={dirty:f,ctx:o}),gn.$set(Kl);const Jl={};f&2&&(Jl.$$scope={dirty:f,ctx:o}),un.$set(Jl);const Xl={};f&2&&(Xl.$$scope={dirty:f,ctx:o}),wn.$set(Xl);const Yl={};f&2&&(Yl.$$scope={dirty:f,ctx:o}),kn.$set(Yl);const Zl={};f&2&&(Zl.$$scope={dirty:f,ctx:o}),vn.$set(Zl);const ed={};f&2&&(ed.$$scope={dirty:f,ctx:o}),Tn.$set(ed)},i(o){Lc||(T(w.$$.fragment,o),T(K.$$.fragment,o),T($n.$$.fragment,o),T(xn.$$.fragment,o),T(Mn.$$.fragment,o),T(En.$$.fragment,o),T(zn.$$.fragment,o),T(Cn.$$.fragment,o),T(Pn.$$.fragment,o),T(jn.$$.fragment,o),T(On.$$.fragment,o),T(An.$$.fragment,o),T(Nn.$$.fragment,o),T(Sn.$$.fragment,o),T(Dn.$$.fragment,o),T(Bn.$$.fragment,o),T(Wn.$$.fragment,o),T(Qn.$$.fragment,o),T(Hn.$$.fragment,o),T(Rn.$$.fragment,o),T(Un.$$.fragment,o),T(Vn.$$.fragment,o),T(Gn.$$.fragment,o),T(Kn.$$.fragment,o),T(Jn.$$.fragment,o),T(Xn.$$.fragment,o),T(Yn.$$.fragment,o),T(Zn.$$.fragment,o),T(es.$$.fragment,o),T(rs.$$.fragment,o),T(Vo.$$.fragment,o),T(is.$$.fragment,o),T(ls.$$.fragment,o),T(ds.$$.fragment,o),T(ps.$$.fragment,o),T(Ko.$$.fragment,o),T(gs.$$.fragment,o),T(us.$$.fragment,o),T(_s.$$.fragment,o),T(vs.$$.fragment,o),T(Xo.$$.fragment,o),T(Ts.$$.fragment,o),T(ys.$$.fragment,o),T(Ls.$$.fragment,o),T($s.$$.fragment,o),T(Es.$$.fragment,o),T(Zo.$$.fragment,o),T(zs.$$.fragment,o),T(qs.$$.fragment,o),T(Cs.$$.fragment,o),T(As.$$.fragment,o),T(tn.$$.fragment,o),T(Is.$$.fragment,o),T(Ns.$$.fragment,o),T(Ss.$$.fragment,o),T(Qs.$$.fragment,o),T(nn.$$.fragment,o),T(Hs.$$.fragment,o),T(Rs.$$.fragment,o),T(Us.$$.fragment,o),T(an.$$.fragment,o),T(Ys.$$.fragment,o),T(rn.$$.fragment,o),T(Zs.$$.fragment,o),T(ea.$$.fragment,o),T(dn.$$.fragment,o),T(aa.$$.fragment,o),T(cn.$$.fragment,o),T(ra.$$.fragment,o),T(ia.$$.fragment,o),T(la.$$.fragment,o),T(mn.$$.fragment,o),T(ma.$$.fragment,o),T(fn.$$.fragment,o),T(fa.$$.fragment,o),T(pa.$$.fragment,o),T(ga.$$.fragment,o),T(gn.$$.fragment,o),T(ka.$$.fragment,o),T(un.$$.fragment,o),T(ba.$$.fragment,o),T(va.$$.fragment,o),T(Ta.$$.fragment,o),T(wn.$$.fragment,o),T(Fa.$$.fragment,o),T(kn.$$.fragment,o),T(xa.$$.fragment,o),T(Ma.$$.fragment,o),T(Ea.$$.fragment,o),T(vn.$$.fragment,o),T(Pa.$$.fragment,o),T(Tn.$$.fragment,o),T(ja.$$.fragment,o),Lc=!0)},o(o){y(w.$$.fragment,o),y(K.$$.fragment,o),y($n.$$.fragment,o),y(xn.$$.fragment,o),y(Mn.$$.fragment,o),y(En.$$.fragment,o),y(zn.$$.fragment,o),y(Cn.$$.fragment,o),y(Pn.$$.fragment,o),y(jn.$$.fragment,o),y(On.$$.fragment,o),y(An.$$.fragment,o),y(Nn.$$.fragment,o),y(Sn.$$.fragment,o),y(Dn.$$.fragment,o),y(Bn.$$.fragment,o),y(Wn.$$.fragment,o),y(Qn.$$.fragment,o),y(Hn.$$.fragment,o),y(Rn.$$.fragment,o),y(Un.$$.fragment,o),y(Vn.$$.fragment,o),y(Gn.$$.fragment,o),y(Kn.$$.fragment,o),y(Jn.$$.fragment,o),y(Xn.$$.fragment,o),y(Yn.$$.fragment,o),y(Zn.$$.fragment,o),y(es.$$.fragment,o),y(rs.$$.fragment,o),y(Vo.$$.fragment,o),y(is.$$.fragment,o),y(ls.$$.fragment,o),y(ds.$$.fragment,o),y(ps.$$.fragment,o),y(Ko.$$.fragment,o),y(gs.$$.fragment,o),y(us.$$.fragment,o),y(_s.$$.fragment,o),y(vs.$$.fragment,o),y(Xo.$$.fragment,o),y(Ts.$$.fragment,o),y(ys.$$.fragment,o),y(Ls.$$.fragment,o),y($s.$$.fragment,o),y(Es.$$.fragment,o),y(Zo.$$.fragment,o),y(zs.$$.fragment,o),y(qs.$$.fragment,o),y(Cs.$$.fragment,o),y(As.$$.fragment,o),y(tn.$$.fragment,o),y(Is.$$.fragment,o),y(Ns.$$.fragment,o),y(Ss.$$.fragment,o),y(Qs.$$.fragment,o),y(nn.$$.fragment,o),y(Hs.$$.fragment,o),y(Rs.$$.fragment,o),y(Us.$$.fragment,o),y(an.$$.fragment,o),y(Ys.$$.fragment,o),y(rn.$$.fragment,o),y(Zs.$$.fragment,o),y(ea.$$.fragment,o),y(dn.$$.fragment,o),y(aa.$$.fragment,o),y(cn.$$.fragment,o),y(ra.$$.fragment,o),y(ia.$$.fragment,o),y(la.$$.fragment,o),y(mn.$$.fragment,o),y(ma.$$.fragment,o),y(fn.$$.fragment,o),y(fa.$$.fragment,o),y(pa.$$.fragment,o),y(ga.$$.fragment,o),y(gn.$$.fragment,o),y(ka.$$.fragment,o),y(un.$$.fragment,o),y(ba.$$.fragment,o),y(va.$$.fragment,o),y(Ta.$$.fragment,o),y(wn.$$.fragment,o),y(Fa.$$.fragment,o),y(kn.$$.fragment,o),y(xa.$$.fragment,o),y(Ma.$$.fragment,o),y(Ea.$$.fragment,o),y(vn.$$.fragment,o),y(Pa.$$.fragment,o),y(Tn.$$.fragment,o),y(ja.$$.fragment,o),Lc=!1},d(o){t(p),o&&t(x),o&&t(g),L(w),o&&t(X),o&&t(E),o&&t(ae),o&&t(R),L(K),o&&t(D),o&&t(Y),o&&t(C),o&&t(ee),o&&t(re),o&&t(te),o&&t(ie),o&&t(j),o&&t(B),o&&t(oe),o&&t(Te),o&&t(le),o&&t(sd),o&&t(jt),L($n),o&&t(ad),o&&t(ye),o&&t(pd),o&&t(gt),o&&t(_d),o&&t(ut),o&&t(wd),o&&t(Ao),o&&t(kd),o&&t(Io),o&&t(bd),o&&t(Ve),o&&t(Ed),o&&t(No),o&&t(zd),o&&t(Ot),L(xn),o&&t(qd),o&&t(At),o&&t(Cd),L(Mn,o),o&&t(Pd),o&&t(It),L(En),o&&t(jd),o&&t(Oe),L(zn),L(Cn),o&&t(Od),o&&t(Bt),L(Pn),o&&t(Ad),o&&t(ft),L(jn),o&&t(Id),o&&t(Wt),L(On),o&&t(Nd),o&&t(pt),L(An),o&&t(Sd),o&&t(Qt),L(Nn),o&&t(Dd),o&&t(Ht),L(Sn),o&&t(Bd),o&&t(Rt),L(Dn),o&&t(Wd),o&&t(Ut),L(Bn),o&&t(Qd),o&&t(Vt),L(Wn),o&&t(Hd),o&&t(Gt),L(Qn),o&&t(Rd),o&&t(Kt),L(Hn),o&&t(Ud),o&&t(Jt),L(Rn),o&&t(Vd),o&&t(Xt),L(Un),o&&t(Gd),o&&t(Yt),L(Vn),o&&t(Kd),o&&t(Zt),L(Gn),o&&t(Jd),o&&t(eo),L(Kn),o&&t(Xd),o&&t(to),L(Jn),o&&t(Yd),o&&t(oo),L(Xn),o&&t(Zd),o&&t(no),L(Yn),o&&t(ec),o&&t(so),L(Zn),o&&t(tc),o&&t(qe),L(es),L(rs),L(Vo),L(is),o&&t(oc),o&&t(io),L(ls),o&&t(nc),o&&t(We),L(ds),L(ps),L(Ko),L(gs),o&&t(sc),o&&t(co),L(us),o&&t(ac),o&&t(Qe),L(_s),L(vs),L(Xo),L(Ts),L(ys),o&&t(rc),o&&t(mo),L(Ls),o&&t(ic),o&&t(He),L($s),L(Es),L(Zo),L(zs),o&&t(lc),o&&t(po),L(qs),o&&t(dc),o&&t(Re),L(Cs),L(As),L(tn),L(Is),o&&t(cc),o&&t(uo),L(Ns),o&&t(hc),o&&t(Ue),L(Ss),L(Qs),L(nn),L(Hs),o&&t(mc),o&&t(ko),L(Rs),o&&t(fc),o&&t(Ee),L(Us),L(an),L(Ys),L(rn),o&&t(pc),o&&t(To),L(Zs),o&&t(gc),o&&t(Ae),L(ea),L(dn),L(aa),L(cn),L(ra),o&&t(uc),o&&t(Lo),L(ia),o&&t(_c),o&&t(Ie),L(la),L(mn),L(ma),L(fn),L(fa),o&&t(wc),o&&t(xo),L(pa),o&&t(kc),o&&t(Ne),L(ga),L(gn),L(ka),L(un),L(ba),o&&t(bc),o&&t(Eo),L(va),o&&t(vc),o&&t(Se),L(Ta),L(wn),L(Fa),L(kn),L(xa),o&&t(Tc),o&&t(qo),L(Ma),o&&t(yc),o&&t(De),L(Ea),L(vn),L(Pa),L(Tn),L(ja)}}}const y1={local:"longformer",sections:[{local:"overview",title:"Overview"},{local:"longformer-self-attention",title:"Longformer Self Attention"},{local:"training",title:"Training"},{local:"transformers.LongformerConfig",title:"LongformerConfig"},{local:"transformers.LongformerTokenizer",title:"LongformerTokenizer"},{local:"transformers.LongformerTokenizerFast",title:"LongformerTokenizerFast"},{local:"transformers.models.longformer.modeling_longformer.LongformerBaseModelOutput",title:"Longformer specific outputs"},{local:"transformers.LongformerModel",title:"LongformerModel"},{local:"transformers.LongformerForMaskedLM",title:"LongformerForMaskedLM"},{local:"transformers.LongformerForSequenceClassification",title:"LongformerForSequenceClassification"},{local:"transformers.LongformerForMultipleChoice",title:"LongformerForMultipleChoice"},{local:"transformers.LongformerForTokenClassification",title:"LongformerForTokenClassification"},{local:"transformers.LongformerForQuestionAnswering",title:"LongformerForQuestionAnswering"},{local:"transformers.TFLongformerModel",title:"TFLongformerModel"},{local:"transformers.TFLongformerForMaskedLM",title:"TFLongformerForMaskedLM"},{local:"transformers.TFLongformerForQuestionAnswering",title:"TFLongformerForQuestionAnswering"},{local:"transformers.TFLongformerForSequenceClassification",title:"TFLongformerForSequenceClassification"},{local:"transformers.TFLongformerForTokenClassification",title:"TFLongformerForTokenClassification"},{local:"transformers.TFLongformerForMultipleChoice",title:"TFLongformerForMultipleChoice"}],title:"Longformer"};function L1(W,p,x){let{fw:g}=p;return W.$$set=u=>{"fw"in u&&x(0,g=u.fw)},[g]}class q1 extends e1{constructor(p){super();t1(this,p,L1,T1,o1,{fw:0})}}export{q1 as default,y1 as metadata};
