...
</ul>`,name:"return_tensors"}],source:"https://github.com/huggingface/transformers/blob/v4.22.2/src/transformers/models/donut/feature_extraction_donut.py#L125",returnDescription:`
<p>A <a
...
An instance of [<code>XLMRobertaTokenizer</code>/<code>XLMRobertaTokenizerFast</code>]. The tokenizer is a required input.`,name:"tokenizer"}],source:"https://github.com/huggingface/transformers/blob/v4.22.2/src/transformers/models/donut/processing_donut.py#L25"}}),et=new U({props:{name:"__call__",anchor:"transformers.DonutProcessor.__call__",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/v4.22.2/src/transformers/models/donut/processing_donut.py#L48"}}),tt=new U({props:{name:"from_pretrained",anchor:"transformers.DonutProcessor.from_pretrained",parameters:[{name:"pretrained_model_name_or_path",val:""},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.DonutProcessor.from_pretrained.pretrained_model_name_or_path",description:`<strong>pretrained_model_name_or_path</strong> (<code>str</code> or <code>os.PathLike</code>) &#x2014;
...
namespace).
kwargs &#x2014;
Additional key word arguments passed along to the <a href="/docs/transformers/v4.22.2/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.push_to_hub">push_to_hub()</a> method.`,name:"push_to_hub"}],source:"https://github.com/huggingface/transformers/blob/v4.22.2/src/transformers/processing_utils.py#L94"}}),be=new qo({props:{$$slots:{default:[Wi]},$$scope:{ctx:F}}}),at=new U({props:{name:"batch_decode",anchor:"transformers.DonutProcessor.batch_decode",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/v4.22.2/src/transformers/models/donut/processing_donut.py#L81"}}),rt=new U({props:{name:"decode",anchor:"transformers.DonutProcessor.decode",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/v4.22.2/src/transformers/models/donut/processing_donut.py#L88"}}),lt=new qe({}),ct=new U({props:{name:"class transformers.DonutSwinModel",anchor:"transformers.DonutSwinModel",parameters:[{name:"config",val:""},{name:"add_pooling_layer",val:" = True"},{name:"use_mask_token",val:" = False"}],parametersDescription:[{anchor:"transformers.DonutSwinModel.config",description:`<strong>config</strong> (<a href="/docs/transformers/v4.22.2/en/model_doc/donut#transformers.DonutSwinConfig">DonutSwinConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/v4.22.2/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/v4.22.2/src/transformers/models/donut/modeling_donut_swin.py#L852"}}),ut=new U({props:{name:"forward",anchor:"transformers.DonutSwinModel.forward",parameters:[{name:"pixel_values",val:": typing.Optional[torch.FloatTensor] = None"},{name:"bool_masked_pos",val:": typing.Optional[torch.BoolTensor] = None"},{name:"head_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.DonutSwinModel.forward.pixel_values",description:`<strong>pixel_values</strong> (<code>torch.FloatTensor</code> of shape <code>(batch_size, num_channels, height, width)</code>) &#x2014;
...
elements depending on the configuration (<a
  href="/docs/transformers/v4.22.2/en/model_doc/donut#transformers.DonutSwinConfig"
...
`),Ct=o("a"),kn=n("decode()"),$n=n(" for more information."),jn=d(),_e=o("div"),v(et.$$.fragment),Dn=d(),N=o("p"),yn=n(`When used in normal mode, this method forwards all its arguments to AutoFeatureExtractor\u2019s
...
`),ks=o("code"),zn=n("__call__"),Sn=n(". Please refer to the doctsring of the above two methods for more information."),Cn=d(),B=o("div"),v(tt.$$.fragment),Mn=d(),$s=o("p"),Fn=n("Instantiate a processor associated with a pretrained model."),An=d(),v(ve.$$.fragment),In=d(),J=o("div"),v(st.$$.fragment),Ln=d(),ot=o("p"),Rn=n(`Saves the attributes of this processor (feature extractor, tokenizer\u2026) in the specified directory so that it
...
`),wt=a(Rt,"A",{href:!0});var Sr=i(wt);aa=r(Sr,"generate()"),Sr.forEach(s),na=r(Rt," to autoregressively generate text given the input image."),Rt.forEach(s),Vs=p(t),T=a(t,"P",{});var z=i(T);ra=r(z,"The "),xt=a(z,"A",{href:!0});var Cr=i(xt);ia=r(Cr,"DonutFeatureExtractor"),Cr.forEach(s),la=r(z,` class is responsible for preprocessing the input image and
...
`),Ct=a(R,"A",{href:!0});var bi=i(Ct);kn=r(bi,"decode()"),bi.forEach(s),$n=r(R," for more information."),R.forEach(s),jn=p(S),_e=a(S,"DIV",{class:!0});var xo=i(_e);b(et.$$.fragment,xo),Dn=p(xo),N=a(xo,"P",{});var Ee=i(N);yn=r(Ee,`When used in normal mode, this method forwards all its arguments to AutoFeatureExtractor\u2019s
...
`),ks=a(Ee,"CODE",{});var ki=i(ks);zn=r(ki,"__call__"),ki.forEach(s),Sn=r(Ee,". Please refer to the doctsring of the above two methods for more information."),Ee.forEach(s),xo.forEach(s),Cn=p(S),B=a(S,"DIV",{class:!0});var Ut=i(B);b(tt.$$.fragment,Ut),Mn=p(Ut),$s=a(Ut,"P",{});var $i=i($s);Fn=r($i,"Instantiate a processor associated with a pretrained model."),$i.forEach(s),An=p(Ut),b(ve.$$.fragment,Ut),Ut.forEach(s),In=p(S),J=a(S,"DIV",{class:!0});var Wt=i(J);b(st.$$.fragment,Wt),Ln=p(Wt),ot=a(Wt,"P",{});var ko=i(ot);Rn=r(ko,`Saves the attributes of this processor (feature extractor, tokenizer\u2026) in the specified directory so that it
