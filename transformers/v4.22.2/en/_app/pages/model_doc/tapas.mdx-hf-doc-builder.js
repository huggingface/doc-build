...
`),d=o("a"),g=s("torch-scatter"),v=s(" dependency:"),p=c(),j(f.$$.fragment),x=c(),k=o("p"),W=s("Of course, you don\u2019t necessarily have to follow one of these three ways in which TAPAS was fine-tuned. You can also experiment by defining any hyperparameters you want when initializing "),O=o("a"),G=s("TapasConfig"),ae=s(", and then create a "),w=o("a"),J=s("TapasForQuestionAnswering"),Z=s(" based on that configuration. For example, if you have a dataset that has both conversational questions and questions that might involve aggregation, then you can do it this way. Here\u2019s an example:"),de=c(),j(U.$$.fragment),this.h()},l(y){l=n(y,"P",{});var C=r(l);T=a(C,`Initializing a model with a pre-trained base and randomly initialized classification heads from the hub can be done as shown below. Be sure to have installed the
`),d=n(C,"A",{href:!0,rel:!0});var B=r(d);g=a(B,"torch-scatter"),B.forEach(t),v=a(C," dependency:"),C.forEach(t),p=h(y),q(f.$$.fragment,y),x=h(y),k=n(y,"P",{});var ee=r(k);W=a(ee,"Of course, you don\u2019t necessarily have to follow one of these three ways in which TAPAS was fine-tuned. You can also experiment by defining any hyperparameters you want when initializing "),O=n(ee,"A",{href:!0});var pe=r(O);G=a(pe,"TapasConfig"),pe.forEach(t),ae=a(ee,", and then create a "),w=n(ee,"A",{href:!0});var R=r(w);J=a(R,"TapasForQuestionAnswering"),R.forEach(t),Z=a(ee," based on that configuration. For example, if you have a dataset that has both conversational questions and questions that might involve aggregation, then you can do it this way. Here\u2019s an example:"),ee.forEach(t),de=h(y),q(U.$$.fragment,y),this.h()},h(){m(d,"href","https://github.com/rusty1s/pytorch_scatter"),m(d,"rel","nofollow"),m(O,"href","/docs/transformers/v4.22.2/en/model_doc/tapas#transformers.TapasConfig"),m(w,"href","/docs/transformers/v4.22.2/en/model_doc/tapas#transformers.TapasForQuestionAnswering")},m(y,C){u(y,l,C),e(l,T),e(l,d),e(d,g),e(l,v),u(y,p,C),$(f,y,C),u(y,x,C),u(y,k,C),e(k,W),e(k,O),e(O,G),e(k,ae),e(k,w),e(w,J),e(k,Z),u(y,de,C),$(U,y,C),N=!0},p:Ft,i(y){N||(E(f.$$.fragment,y),E(U.$$.fragment,y),N=!0)},o(y){F(f.$$.fragment,y),F(U.$$.fragment,y),N=!1},d(y){y&&t(l),y&&t(p),A(f,y),y&&t(x),y&&t(k),y&&t(de),A(U,y)}}}function by(P){let l,T;return l=new Tn({props:{$$slots:{default:[vy]},$$scope:{ctx:P}}}),{c(){j(l.$$.fragment)},l(d){q(l.$$.fragment,d)},m(d,g){$(l,d,g),T=!0},p(d,g){const v={};g&2&&(v.$$scope={dirty:g,ctx:d}),l.$set(v)},i(d){T||(E(l.$$.fragment,d),T=!0)},o(d){F(l.$$.fragment,d),T=!1},d(d){A(l,d)}}}function wy(P){let l,T,d,g,v,p,f,x,k,W,O,G,ae,w,J,Z,de,U,N;return f=new ht({props:{code:`from transformers import TapasConfig, TFTapasForQuestionAnswering
...
<span class="hljs-meta">&gt;&gt;&gt; </span>config = TapasConfig(num_aggregation_labels=<span class="hljs-number">3</span>, average_logits_per_cell=<span class="hljs-literal">True</span>)
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-comment"># initializing the pre-trained base sized model with our custom classification heads</span>
<span class="hljs-meta">&gt;&gt;&gt; </span>model = TFTapasForQuestionAnswering.from_pretrained(<span class="hljs-string">&quot;google/tapas-base&quot;</span>, config=config)`}}),{c(){l=o("p"),T=s("Initializing a model with a pre-trained base and randomly initialized classification heads from the hub can be done as shown below. Be sure to have installed the "),d=o("a"),g=s("tensorflow_probability"),v=s(" dependency:"),p=c(),j(f.$$.fragment),x=c(),k=o("p"),W=s("Of course, you don\u2019t necessarily have to follow one of these three ways in which TAPAS was fine-tuned. You can also experiment by defining any hyperparameters you want when initializing "),O=o("a"),G=s("TapasConfig"),ae=s(", and then create a "),w=o("a"),J=s("TFTapasForQuestionAnswering"),Z=s(" based on that configuration. For example, if you have a dataset that has both conversational questions and questions that might involve aggregation, then you can do it this way. Here\u2019s an example:"),de=c(),j(U.$$.fragment),this.h()},l(y){l=n(y,"P",{});var C=r(l);T=a(C,"Initializing a model with a pre-trained base and randomly initialized classification heads from the hub can be done as shown below. Be sure to have installed the "),d=n(C,"A",{href:!0,rel:!0});var B=r(d);g=a(B,"tensorflow_probability"),B.forEach(t),v=a(C," dependency:"),C.forEach(t),p=h(y),q(f.$$.fragment,y),x=h(y),k=n(y,"P",{});var ee=r(k);W=a(ee,"Of course, you don\u2019t necessarily have to follow one of these three ways in which TAPAS was fine-tuned. You can also experiment by defining any hyperparameters you want when initializing "),O=n(ee,"A",{href:!0});var pe=r(O);G=a(pe,"TapasConfig"),pe.forEach(t),ae=a(ee,", and then create a "),w=n(ee,"A",{href:!0});var R=r(w);J=a(R,"TFTapasForQuestionAnswering"),R.forEach(t),Z=a(ee," based on that configuration. For example, if you have a dataset that has both conversational questions and questions that might involve aggregation, then you can do it this way. Here\u2019s an example:"),ee.forEach(t),de=h(y),q(U.$$.fragment,y),this.h()},h(){m(d,"href","https://github.com/tensorflow/probability"),m(d,"rel","nofollow"),m(O,"href","/docs/transformers/v4.22.2/en/model_doc/tapas#transformers.TapasConfig"),m(w,"href","/docs/transformers/v4.22.2/en/model_doc/tapas#transformers.TFTapasForQuestionAnswering")},m(y,C){u(y,l,C),e(l,T),e(l,d),e(d,g),e(l,v),u(y,p,C),$(f,y,C),u(y,x,C),u(y,k,C),e(k,W),e(k,O),e(O,G),e(k,ae),e(k,w),e(w,J),e(k,Z),u(y,de,C),$(U,y,C),N=!0},p:Ft,i(y){N||(E(f.$$.fragment,y),E(U.$$.fragment,y),N=!0)},o(y){F(f.$$.fragment,y),F(U.$$.fragment,y),N=!1},d(y){y&&t(l),y&&t(p),A(f,y),y&&t(x),y&&t(k),y&&t(de),A(U,y)}}}function yy(P){let l,T;return l=new Tn({props:{$$slots:{default:[wy]},$$scope:{ctx:P}}}),{c(){j(l.$$.fragment)},l(d){q(l.$$.fragment,d)},m(d,g){$(l,d,g),T=!0},p(d,g){const v={};g&2&&(v.$$scope={dirty:g,ctx:d}),l.$set(v)},i(d){T||(E(l.$$.fragment,d),T=!0)},o(d){F(l.$$.fragment,d),T=!1},d(d){A(l,d)}}}function ky(P){let l,T,d,g,v,p,f,x,k,W,O,G,ae,w,J,Z,de,U,N,y,C,B,ee,pe,R,ge,he,X,_e,D,L,I,M,K,H,we,xe,ue,fe,Ae,se,ke,Te,Pe,Ce,je,Me,$e,ce,Se,ye,Y,qe,V,We,oe,He,Ue,b,S,Ve,ve,Ye,Je,Q,Le,ot,Qe,Ie,Xe,le,Ee,Ze,ze,ne,et,Be,re,Re,Fe,tt,Pt,Mt,Ws,St,vs,ts,Dt,bs,ut,De,Hs,Ot,ie,vt,ss,Us,Nt,ns,Bs,Lt,Qt,Rs,It,rs,Gs,Wt,is,Ks,Ht,Vs,st,Ut,ls,Ys,Bt,ds,Js,ps,lt,cs,Oe,hs,bt,Xs,Rt,Gt,Zs,ea,dt,ta,us,ms,gt,Kt;return lt=new ht({props:{code:`from transformers import TapasTokenizer
import pandas as pd
...
<span class="hljs-meta">&gt;&gt;&gt; </span>train_dataloader = torch.utils.data.DataLoader(train_dataset, batch_size=<span class="hljs-number">32</span>)`}}),{c(){l=o("p"),T=s("Third, given that you\u2019ve prepared your data in this TSV/CSV format (and corresponding CSV files containing the tabular data), you can then use "),d=o("a"),g=s("TapasTokenizer"),v=s(" to convert table-question pairs into "),p=o("code"),f=s("input_ids"),x=s(", "),k=o("code"),W=s("attention_mask"),O=s(", "),G=o("code"),ae=s("token_type_ids"),w=s(" and so on. Again, based on which of the three cases you picked above, "),J=o("a"),Z=s("TapasForQuestionAnswering"),de=s(` requires different
inputs to be fine-tuned:`),U=c(),N=o("table"),y=o("thead"),C=o("tr"),B=o("th"),ee=o("strong"),pe=s("Task"),R=c(),ge=o("th"),he=o("strong"),X=s("Required inputs"),_e=c(),D=o("tbody"),L=o("tr"),I=o("td"),M=s("Conversational"),K=c(),H=o("td"),we=o("code"),xe=s("input_ids"),ue=s(", "),fe=o("code"),Ae=s("attention_mask"),se=s(", "),ke=o("code"),Te=s("token_type_ids"),Pe=s(", "),Ce=o("code"),je=s("labels"),Me=c(),$e=o("tr"),ce=o("td"),Se=s("Weak supervision for aggregation"),ye=c(),Y=o("td"),qe=o("code"),V=s("input_ids"),We=s(", "),oe=o("code"),He=s("attention_mask"),Ue=s(", "),b=o("code"),S=s("token_type_ids"),Ve=s(", "),ve=o("code"),Ye=s("labels"),Je=s(", "),Q=o("code"),Le=s("numeric_values"),ot=s(", "),Qe=o("code"),Ie=s("numeric_values_scale"),Xe=s(", "),le=o("code"),Ee=s("float_answer"),Ze=c(),ze=o("tr"),ne=o("td"),et=s("Strong supervision for aggregation"),Be=c(),re=o("td"),Re=o("code"),Fe=s("input ids"),tt=s(", "),Pt=o("code"),Mt=s("attention mask"),Ws=s(", "),St=o("code"),vs=s("token type ids"),ts=s(", "),Dt=o("code"),bs=s("labels"),ut=s(", "),De=o("code"),Hs=s("aggregation_labels"),Ot=c(),ie=o("p"),vt=o("a"),ss=s("TapasTokenizer"),Us=s(" creates the "),Nt=o("code"),ns=s("labels"),Bs=s(", "),Lt=o("code"),Qt=s("numeric_values"),Rs=s(" and "),It=o("code"),rs=s("numeric_values_scale"),Gs=s(" based on the "),Wt=o("code"),is=s("answer_coordinates"),Ks=s(" and "),Ht=o("code"),Vs=s("answer_text"),st=s(" columns of the TSV file. The "),Ut=o("code"),ls=s("float_answer"),Ys=s(" and "),Bt=o("code"),ds=s("aggregation_labels"),Js=s(" are already in the TSV file of step 2. Here\u2019s an example:"),ps=c(),j(lt.$$.fragment),cs=c(),Oe=o("p"),hs=s("Note that "),bt=o("a"),Xs=s("TapasTokenizer"),Rt=s(" expects the data of the table to be "),Gt=o("strong"),Zs=s("text-only"),ea=s(". You can use "),dt=o("code"),ta=s(".astype(str)"),us=s(` on a dataframe to turn it into text-only data.
Of course, this only shows how to encode a single training example. It is advised to create a dataloader to iterate over batches:`),ms=c(),j(gt.$$.fragment),this.h()},l(z){l=n(z,"P",{});var te=r(l);T=a(te,"Third, given that you\u2019ve prepared your data in this TSV/CSV format (and corresponding CSV files containing the tabular data), you can then use "),d=n(te,"A",{href:!0});var ka=r(d);g=a(ka,"TapasTokenizer"),ka.forEach(t),v=a(te," to convert table-question pairs into "),p=n(te,"CODE",{});var sa=r(p);f=a(sa,"input_ids"),sa.forEach(t),x=a(te,", "),k=n(te,"CODE",{});var ja=r(k);W=a(ja,"attention_mask"),ja.forEach(t),O=a(te,", "),G=n(te,"CODE",{});var ha=r(G);ae=a(ha,"token_type_ids"),ha.forEach(t),w=a(te," and so on. Again, based on which of the three cases you picked above, "),J=n(te,"A",{href:!0});var Vt=r(J);Z=a(Vt,"TapasForQuestionAnswering"),Vt.forEach(t),de=a(te,` requires different
inputs to be fine-tuned:`),te.forEach(t),U=h(z),N=n(z,"TABLE",{});var _t=r(N);y=n(_t,"THEAD",{});var aa=r(y);C=n(aa,"TR",{});var wt=r(C);B=n(wt,"TH",{});var qa=r(B);ee=n(qa,"STRONG",{});var oa=r(ee);pe=a(oa,"Task"),oa.forEach(t),qa.forEach(t),R=h(wt),ge=n(wt,"TH",{});var $a=r(ge);he=n($a,"STRONG",{});var ua=r(he);X=a(ua,"Required inputs"),ua.forEach(t),$a.forEach(t),wt.forEach(t),aa.forEach(t),_e=h(_t),D=n(_t,"TBODY",{});var nt=r(D);L=n(nt,"TR",{});var fs=r(L);I=n(fs,"TD",{});var ws=r(I);M=a(ws,"Conversational"),ws.forEach(t),K=h(fs),H=n(fs,"TD",{});var pt=r(H);we=n(pt,"CODE",{});var Ea=r(we);xe=a(Ea,"input_ids"),Ea.forEach(t),ue=a(pt,", "),fe=n(pt,"CODE",{});var ma=r(fe);Ae=a(ma,"attention_mask"),ma.forEach(t),se=a(pt,", "),ke=n(pt,"CODE",{});var ys=r(ke);Te=a(ys,"token_type_ids"),ys.forEach(t),Pe=a(pt,", "),Ce=n(pt,"CODE",{});var na=r(Ce);je=a(na,"labels"),na.forEach(t),pt.forEach(t),fs.forEach(t),Me=h(nt),$e=n(nt,"TR",{});var gs=r($e);ce=n(gs,"TD",{});var fa=r(ce);Se=a(fa,"Weak supervision for aggregation"),fa.forEach(t),ye=h(gs),Y=n(gs,"TD",{});var be=r(Y);qe=n(be,"CODE",{});var Fa=r(qe);V=a(Fa,"input_ids"),Fa.forEach(t),We=a(be,", "),oe=n(be,"CODE",{});var ks=r(oe);He=a(ks,"attention_mask"),ks.forEach(t),Ue=a(be,", "),b=n(be,"CODE",{});var Aa=r(b);S=a(Aa,"token_type_ids"),Aa.forEach(t),Ve=a(be,", "),ve=n(be,"CODE",{});var xa=r(ve);Ye=a(xa,"labels"),xa.forEach(t),Je=a(be,", "),Q=n(be,"CODE",{});var ga=r(Q);Le=a(ga,"numeric_values"),ga.forEach(t),ot=a(be,", "),Qe=n(be,"CODE",{});var At=r(Qe);Ie=a(At,"numeric_values_scale"),At.forEach(t),Xe=a(be,", "),le=n(be,"CODE",{});var ra=r(le);Ee=a(ra,"float_answer"),ra.forEach(t),be.forEach(t),gs.forEach(t),Ze=h(nt),ze=n(nt,"TR",{});var _s=r(ze);ne=n(_s,"TD",{});var za=r(ne);et=a(za,"Strong supervision for aggregation"),za.forEach(t),Be=h(_s),re=n(_s,"TD",{});var Ne=r(re);Re=n(Ne,"CODE",{});var Ca=r(Re);Fe=a(Ca,"input ids"),Ca.forEach(t),tt=a(Ne,", "),Pt=n(Ne,"CODE",{});var ia=r(Pt);Mt=a(ia,"attention mask"),ia.forEach(t),Ws=a(Ne,", "),St=n(Ne,"CODE",{});var Pa=r(St);vs=a(Pa,"token type ids"),Pa.forEach(t),ts=a(Ne,", "),Dt=n(Ne,"CODE",{});var Ma=r(Dt);bs=a(Ma,"labels"),Ma.forEach(t),ut=a(Ne,", "),De=n(Ne,"CODE",{});var Sa=r(De);Hs=a(Sa,"aggregation_labels"),Sa.forEach(t),Ne.forEach(t),_s.forEach(t),nt.forEach(t),_t.forEach(t),Ot=h(z),ie=n(z,"P",{});var me=r(ie);vt=n(me,"A",{href:!0});var Da=r(vt);ss=a(Da,"TapasTokenizer"),Da.forEach(t),Us=a(me," creates the "),Nt=n(me,"CODE",{});var la=r(Nt);ns=a(la,"labels"),la.forEach(t),Bs=a(me,", "),Lt=n(me,"CODE",{});var Oa=r(Lt);Qt=a(Oa,"numeric_values"),Oa.forEach(t),Rs=a(me," and "),It=n(me,"CODE",{});var Na=r(It);rs=a(Na,"numeric_values_scale"),Na.forEach(t),Gs=a(me," based on the "),Wt=n(me,"CODE",{});var _a=r(Wt);is=a(_a,"answer_coordinates"),_a.forEach(t),Ks=a(me," and "),Ht=n(me,"CODE",{});var js=r(Ht);Vs=a(js,"answer_text"),js.forEach(t),st=a(me," columns of the TSV file. The "),Ut=n(me,"CODE",{});var La=r(Ut);ls=a(La,"float_answer"),La.forEach(t),Ys=a(me," and "),Bt=n(me,"CODE",{});var Ta=r(Bt);ds=a(Ta,"aggregation_labels"),Ta.forEach(t),Js=a(me," are already in the TSV file of step 2. Here\u2019s an example:"),me.forEach(t),ps=h(z),q(lt.$$.fragment,z),cs=h(z),Oe=n(z,"P",{});var Ge=r(Oe);hs=a(Ge,"Note that "),bt=n(Ge,"A",{href:!0});var da=r(bt);Xs=a(da,"TapasTokenizer"),da.forEach(t),Rt=a(Ge," expects the data of the table to be "),Gt=n(Ge,"STRONG",{});var Yt=r(Gt);Zs=a(Yt,"text-only"),Yt.forEach(t),ea=a(Ge,". You can use "),dt=n(Ge,"CODE",{});var pa=r(dt);ta=a(pa,".astype(str)"),pa.forEach(t),us=a(Ge,` on a dataframe to turn it into text-only data.
Of course, this only shows how to encode a single training example. It is advised to create a dataloader to iterate over batches:`),Ge.forEach(t),ms=h(z),q(gt.$$.fragment,z),this.h()},h(){m(d,"href","/docs/transformers/v4.22.2/en/model_doc/tapas#transformers.TapasTokenizer"),m(J,"href","/docs/transformers/v4.22.2/en/model_doc/tapas#transformers.TapasForQuestionAnswering"),m(vt,"href","/docs/transformers/v4.22.2/en/model_doc/tapas#transformers.TapasTokenizer"),m(bt,"href","/docs/transformers/v4.22.2/en/model_doc/tapas#transformers.TapasTokenizer")},m(z,te){u(z,l,te),e(l,T),e(l,d),e(d,g),e(l,v),e(l,p),e(p,f),e(l,x),e(l,k),e(k,W),e(l,O),e(l,G),e(G,ae),e(l,w),e(l,J),e(J,Z),e(l,de),u(z,U,te),u(z,N,te),e(N,y),e(y,C),e(C,B),e(B,ee),e(ee,pe),e(C,R),e(C,ge),e(ge,he),e(he,X),e(N,_e),e(N,D),e(D,L),e(L,I),e(I,M),e(L,K),e(L,H),e(H,we),e(we,xe),e(H,ue),e(H,fe),e(fe,Ae),e(H,se),e(H,ke),e(ke,Te),e(H,Pe),e(H,Ce),e(Ce,je),e(D,Me),e(D,$e),e($e,ce),e(ce,Se),e($e,ye),e($e,Y),e(Y,qe),e(qe,V),e(Y,We),e(Y,oe),e(oe,He),e(Y,Ue),e(Y,b),e(b,S),e(Y,Ve),e(Y,ve),e(ve,Ye),e(Y,Je),e(Y,Q),e(Q,Le),e(Y,ot),e(Y,Qe),e(Qe,Ie),e(Y,Xe),e(Y,le),e(le,Ee),e(D,Ze),e(D,ze),e(ze,ne),e(ne,et),e(ze,Be),e(ze,re),e(re,Re),e(Re,Fe),e(re,tt),e(re,Pt),e(Pt,Mt),e(re,Ws),e(re,St),e(St,vs),e(re,ts),e(re,Dt),e(Dt,bs),e(re,ut),e(re,De),e(De,Hs),u(z,Ot,te),u(z,ie,te),e(ie,vt),e(vt,ss),e(ie,Us),e(ie,Nt),e(Nt,ns),e(ie,Bs),e(ie,Lt),e(Lt,Qt),e(ie,Rs),e(ie,It),e(It,rs),e(ie,Gs),e(ie,Wt),e(Wt,is),e(ie,Ks),e(ie,Ht),e(Ht,Vs),e(ie,st),e(ie,Ut),e(Ut,ls),e(ie,Ys),e(ie,Bt),e(Bt,ds),e(ie,Js),u(z,ps,te),$(lt,z,te),u(z,cs,te),u(z,Oe,te),e(Oe,hs),e(Oe,bt),e(bt,Xs),e(Oe,Rt),e(Oe,Gt),e(Gt,Zs),e(Oe,ea),e(Oe,dt),e(dt,ta),e(Oe,us),u(z,ms,te),$(gt,z,te),Kt=!0},p:Ft,i(z){Kt||(E(lt.$$.fragment,z),E(gt.$$.fragment,z),Kt=!0)},o(z){F(lt.$$.fragment,z),F(gt.$$.fragment,z),Kt=!1},d(z){z&&t(l),z&&t(U),z&&t(N),z&&t(Ot),z&&t(ie),z&&t(ps),A(lt,z),z&&t(cs),z&&t(Oe),z&&t(ms),A(gt,z)}}}function jy(P){let l,T;return l=new Tn({props:{$$slots:{default:[ky]},$$scope:{ctx:P}}}),{c(){j(l.$$.fragment)},l(d){q(l.$$.fragment,d)},m(d,g){$(l,d,g),T=!0},p(d,g){const v={};g&2&&(v.$$scope={dirty:g,ctx:d}),l.$set(v)},i(d){T||(E(l.$$.fragment,d),T=!0)},o(d){F(l.$$.fragment,d),T=!1},d(d){A(l,d)}}}function qy(P){let l,T,d,g,v,p,f,x,k,W,O,G,ae,w,J,Z,de,U,N,y,C,B,ee,pe,R,ge,he,X,_e,D,L,I,M,K,H,we,xe,ue,fe,Ae,se,ke,Te,Pe,Ce,je,Me,$e,ce,Se,ye,Y,qe,V,We,oe,He,Ue,b,S,Ve,ve,Ye,Je,Q,Le,ot,Qe,Ie,Xe,le,Ee,Ze,ze,ne,et,Be,re,Re,Fe,tt,Pt,Mt,Ws,St,vs,ts,Dt,bs,ut,De,Hs,Ot,ie,vt,ss,Us,Nt,ns,Bs,Lt,Qt,Rs,It,rs,Gs,Wt,is,Ks,Ht,Vs,st,Ut,ls,Ys,Bt,ds,Js,ps,lt,cs,Oe,hs,bt,Xs,Rt,Gt,Zs,ea,dt,ta,us,ms,gt,Kt;return lt=new ht({props:{code:`from transformers import TapasTokenizer
import pandas as pd
...
<span class="hljs-meta">... </span>    tf.TensorSpec(shape=(<span class="hljs-number">512</span>,), dtype=tf.float32),
<span class="hljs-meta">... </span>)
<span class="hljs-meta">&gt;&gt;&gt; </span>train_dataloader = tf.data.Dataset.from_generator(train_dataset, output_signature=output_signature).batch(<span class="hljs-number">32</span>)`}}),{c(){l=o("p"),T=s("Third, given that you\u2019ve prepared your data in this TSV/CSV format (and corresponding CSV files containing the tabular data), you can then use "),d=o("a"),g=s("TapasTokenizer"),v=s(" to convert table-question pairs into "),p=o("code"),f=s("input_ids"),x=s(", "),k=o("code"),W=s("attention_mask"),O=s(", "),G=o("code"),ae=s("token_type_ids"),w=s(" and so on. Again, based on which of the three cases you picked above, "),J=o("a"),Z=s("TFTapasForQuestionAnswering"),de=s(` requires different
inputs to be fine-tuned:`),U=c(),N=o("table"),y=o("thead"),C=o("tr"),B=o("th"),ee=o("strong"),pe=s("Task"),R=c(),ge=o("th"),he=o("strong"),X=s("Required inputs"),_e=c(),D=o("tbody"),L=o("tr"),I=o("td"),M=s("Conversational"),K=c(),H=o("td"),we=o("code"),xe=s("input_ids"),ue=s(", "),fe=o("code"),Ae=s("attention_mask"),se=s(", "),ke=o("code"),Te=s("token_type_ids"),Pe=s(", "),Ce=o("code"),je=s("labels"),Me=c(),$e=o("tr"),ce=o("td"),Se=s("Weak supervision for aggregation"),ye=c(),Y=o("td"),qe=o("code"),V=s("input_ids"),We=s(", "),oe=o("code"),He=s("attention_mask"),Ue=s(", "),b=o("code"),S=s("token_type_ids"),Ve=s(", "),ve=o("code"),Ye=s("labels"),Je=s(", "),Q=o("code"),Le=s("numeric_values"),ot=s(", "),Qe=o("code"),Ie=s("numeric_values_scale"),Xe=s(", "),le=o("code"),Ee=s("float_answer"),Ze=c(),ze=o("tr"),ne=o("td"),et=s("Strong supervision for aggregation"),Be=c(),re=o("td"),Re=o("code"),Fe=s("input ids"),tt=s(", "),Pt=o("code"),Mt=s("attention mask"),Ws=s(", "),St=o("code"),vs=s("token type ids"),ts=s(", "),Dt=o("code"),bs=s("labels"),ut=s(", "),De=o("code"),Hs=s("aggregation_labels"),Ot=c(),ie=o("p"),vt=o("a"),ss=s("TapasTokenizer"),Us=s(" creates the "),Nt=o("code"),ns=s("labels"),Bs=s(", "),Lt=o("code"),Qt=s("numeric_values"),Rs=s(" and "),It=o("code"),rs=s("numeric_values_scale"),Gs=s(" based on the "),Wt=o("code"),is=s("answer_coordinates"),Ks=s(" and "),Ht=o("code"),Vs=s("answer_text"),st=s(" columns of the TSV file. The "),Ut=o("code"),ls=s("float_answer"),Ys=s(" and "),Bt=o("code"),ds=s("aggregation_labels"),Js=s(" are already in the TSV file of step 2. Here\u2019s an example:"),ps=c(),j(lt.$$.fragment),cs=c(),Oe=o("p"),hs=s("Note that "),bt=o("a"),Xs=s("TapasTokenizer"),Rt=s(" expects the data of the table to be "),Gt=o("strong"),Zs=s("text-only"),ea=s(". You can use "),dt=o("code"),ta=s(".astype(str)"),us=s(` on a dataframe to turn it into text-only data.
...
inputs to be fine-tuned:`),te.forEach(t),U=h(z),N=n(z,"TABLE",{});var _t=r(N);y=n(_t,"THEAD",{});var aa=r(y);C=n(aa,"TR",{});var wt=r(C);B=n(wt,"TH",{});var qa=r(B);ee=n(qa,"STRONG",{});var oa=r(ee);pe=a(oa,"Task"),oa.forEach(t),qa.forEach(t),R=h(wt),ge=n(wt,"TH",{});var $a=r(ge);he=n($a,"STRONG",{});var ua=r(he);X=a(ua,"Required inputs"),ua.forEach(t),$a.forEach(t),wt.forEach(t),aa.forEach(t),_e=h(_t),D=n(_t,"TBODY",{});var nt=r(D);L=n(nt,"TR",{});var fs=r(L);I=n(fs,"TD",{});var ws=r(I);M=a(ws,"Conversational"),ws.forEach(t),K=h(fs),H=n(fs,"TD",{});var pt=r(H);we=n(pt,"CODE",{});var Ea=r(we);xe=a(Ea,"input_ids"),Ea.forEach(t),ue=a(pt,", "),fe=n(pt,"CODE",{});var ma=r(fe);Ae=a(ma,"attention_mask"),ma.forEach(t),se=a(pt,", "),ke=n(pt,"CODE",{});var ys=r(ke);Te=a(ys,"token_type_ids"),ys.forEach(t),Pe=a(pt,", "),Ce=n(pt,"CODE",{});var na=r(Ce);je=a(na,"labels"),na.forEach(t),pt.forEach(t),fs.forEach(t),Me=h(nt),$e=n(nt,"TR",{});var gs=r($e);ce=n(gs,"TD",{});var fa=r(ce);Se=a(fa,"Weak supervision for aggregation"),fa.forEach(t),ye=h(gs),Y=n(gs,"TD",{});var be=r(Y);qe=n(be,"CODE",{});var Fa=r(qe);V=a(Fa,"input_ids"),Fa.forEach(t),We=a(be,", "),oe=n(be,"CODE",{});var ks=r(oe);He=a(ks,"attention_mask"),ks.forEach(t),Ue=a(be,", "),b=n(be,"CODE",{});var Aa=r(b);S=a(Aa,"token_type_ids"),Aa.forEach(t),Ve=a(be,", "),ve=n(be,"CODE",{});var xa=r(ve);Ye=a(xa,"labels"),xa.forEach(t),Je=a(be,", "),Q=n(be,"CODE",{});var ga=r(Q);Le=a(ga,"numeric_values"),ga.forEach(t),ot=a(be,", "),Qe=n(be,"CODE",{});var At=r(Qe);Ie=a(At,"numeric_values_scale"),At.forEach(t),Xe=a(be,", "),le=n(be,"CODE",{});var ra=r(le);Ee=a(ra,"float_answer"),ra.forEach(t),be.forEach(t),gs.forEach(t),Ze=h(nt),ze=n(nt,"TR",{});var _s=r(ze);ne=n(_s,"TD",{});var za=r(ne);et=a(za,"Strong supervision for aggregation"),za.forEach(t),Be=h(_s),re=n(_s,"TD",{});var Ne=r(re);Re=n(Ne,"CODE",{});var Ca=r(Re);Fe=a(Ca,"input ids"),Ca.forEach(t),tt=a(Ne,", "),Pt=n(Ne,"CODE",{});var ia=r(Pt);Mt=a(ia,"attention mask"),ia.forEach(t),Ws=a(Ne,", "),St=n(Ne,"CODE",{});var Pa=r(St);vs=a(Pa,"token type ids"),Pa.forEach(t),ts=a(Ne,", "),Dt=n(Ne,"CODE",{});var Ma=r(Dt);bs=a(Ma,"labels"),Ma.forEach(t),ut=a(Ne,", "),De=n(Ne,"CODE",{});var Sa=r(De);Hs=a(Sa,"aggregation_labels"),Sa.forEach(t),Ne.forEach(t),_s.forEach(t),nt.forEach(t),_t.forEach(t),Ot=h(z),ie=n(z,"P",{});var me=r(ie);vt=n(me,"A",{href:!0});var Da=r(vt);ss=a(Da,"TapasTokenizer"),Da.forEach(t),Us=a(me," creates the "),Nt=n(me,"CODE",{});var la=r(Nt);ns=a(la,"labels"),la.forEach(t),Bs=a(me,", "),Lt=n(me,"CODE",{});var Oa=r(Lt);Qt=a(Oa,"numeric_values"),Oa.forEach(t),Rs=a(me," and "),It=n(me,"CODE",{});var Na=r(It);rs=a(Na,"numeric_values_scale"),Na.forEach(t),Gs=a(me," based on the "),Wt=n(me,"CODE",{});var _a=r(Wt);is=a(_a,"answer_coordinates"),_a.forEach(t),Ks=a(me," and "),Ht=n(me,"CODE",{});var js=r(Ht);Vs=a(js,"answer_text"),js.forEach(t),st=a(me," columns of the TSV file. The "),Ut=n(me,"CODE",{});var La=r(Ut);ls=a(La,"float_answer"),La.forEach(t),Ys=a(me," and "),Bt=n(me,"CODE",{});var Ta=r(Bt);ds=a(Ta,"aggregation_labels"),Ta.forEach(t),Js=a(me," are already in the TSV file of step 2. Here\u2019s an example:"),me.forEach(t),ps=h(z),q(lt.$$.fragment,z),cs=h(z),Oe=n(z,"P",{});var Ge=r(Oe);hs=a(Ge,"Note that "),bt=n(Ge,"A",{href:!0});var da=r(bt);Xs=a(da,"TapasTokenizer"),da.forEach(t),Rt=a(Ge," expects the data of the table to be "),Gt=n(Ge,"STRONG",{});var Yt=r(Gt);Zs=a(Yt,"text-only"),Yt.forEach(t),ea=a(Ge,". You can use "),dt=n(Ge,"CODE",{});var pa=r(dt);ta=a(pa,".astype(str)"),pa.forEach(t),us=a(Ge,` on a dataframe to turn it into text-only data.
Of course, this only shows how to encode a single training example. It is advised to create a dataloader to iterate over batches:`),Ge.forEach(t),ms=h(z),q(gt.$$.fragment,z),this.h()},h(){m(d,"href","/docs/transformers/v4.22.2/en/model_doc/tapas#transformers.TapasTokenizer"),m(J,"href","/docs/transformers/v4.22.2/en/model_doc/tapas#transformers.TFTapasForQuestionAnswering"),m(vt,"href","/docs/transformers/v4.22.2/en/model_doc/tapas#transformers.TapasTokenizer"),m(bt,"href","/docs/transformers/v4.22.2/en/model_doc/tapas#transformers.TapasTokenizer")},m(z,te){u(z,l,te),e(l,T),e(l,d),e(d,g),e(l,v),e(l,p),e(p,f),e(l,x),e(l,k),e(k,W),e(l,O),e(l,G),e(G,ae),e(l,w),e(l,J),e(J,Z),e(l,de),u(z,U,te),u(z,N,te),e(N,y),e(y,C),e(C,B),e(B,ee),e(ee,pe),e(C,R),e(C,ge),e(ge,he),e(he,X),e(N,_e),e(N,D),e(D,L),e(L,I),e(I,M),e(L,K),e(L,H),e(H,we),e(we,xe),e(H,ue),e(H,fe),e(fe,Ae),e(H,se),e(H,ke),e(ke,Te),e(H,Pe),e(H,Ce),e(Ce,je),e(D,Me),e(D,$e),e($e,ce),e(ce,Se),e($e,ye),e($e,Y),e(Y,qe),e(qe,V),e(Y,We),e(Y,oe),e(oe,He),e(Y,Ue),e(Y,b),e(b,S),e(Y,Ve),e(Y,ve),e(ve,Ye),e(Y,Je),e(Y,Q),e(Q,Le),e(Y,ot),e(Y,Qe),e(Qe,Ie),e(Y,Xe),e(Y,le),e(le,Ee),e(D,Ze),e(D,ze),e(ze,ne),e(ne,et),e(ze,Be),e(ze,re),e(re,Re),e(Re,Fe),e(re,tt),e(re,Pt),e(Pt,Mt),e(re,Ws),e(re,St),e(St,vs),e(re,ts),e(re,Dt),e(Dt,bs),e(re,ut),e(re,De),e(De,Hs),u(z,Ot,te),u(z,ie,te),e(ie,vt),e(vt,ss),e(ie,Us),e(ie,Nt),e(Nt,ns),e(ie,Bs),e(ie,Lt),e(Lt,Qt),e(ie,Rs),e(ie,It),e(It,rs),e(ie,Gs),e(ie,Wt),e(Wt,is),e(ie,Ks),e(ie,Ht),e(Ht,Vs),e(ie,st),e(ie,Ut),e(Ut,ls),e(ie,Ys),e(ie,Bt),e(Bt,ds),e(ie,Js),u(z,ps,te),$(lt,z,te),u(z,cs,te),u(z,Oe,te),e(Oe,hs),e(Oe,bt),e(bt,Xs),e(Oe,Rt),e(Oe,Gt),e(Gt,Zs),e(Oe,ea),e(Oe,dt),e(dt,ta),e(Oe,us),u(z,ms,te),$(gt,z,te),Kt=!0},p:Ft,i(z){Kt||(E(lt.$$.fragment,z),E(gt.$$.fragment,z),Kt=!0)},o(z){F(lt.$$.fragment,z),F(gt.$$.fragment,z),Kt=!1},d(z){z&&t(l),z&&t(U),z&&t(N),z&&t(Ot),z&&t(ie),z&&t(ps),A(lt,z),z&&t(cs),z&&t(Oe),z&&t(ms),A(gt,z)}}}function $y(P){let l,T;return l=new Tn({props:{$$slots:{default:[qy]},$$scope:{ctx:P}}}),{c(){j(l.$$.fragment)},l(d){q(l.$$.fragment,d)},m(d,g){$(l,d,g),T=!0},p(d,g){const v={};g&2&&(v.$$scope={dirty:g,ctx:d}),l.$set(v)},i(d){T||(E(l.$$.fragment,d),T=!0)},o(d){F(l.$$.fragment,d),T=!1},d(d){A(l,d)}}}function Ey(P){let l,T,d,g,v,p,f,x;return f=new ht({props:{code:`from transformers import TapasConfig, TapasForQuestionAnswering, AdamW
...
<span class="hljs-meta">... </span>        optimizer.step()`}}),{c(){l=o("p"),T=s("You can then fine-tune "),d=o("a"),g=s("TapasForQuestionAnswering"),v=s(" as follows (shown here for the weak supervision for aggregation case):"),p=c(),j(f.$$.fragment),this.h()},l(k){l=n(k,"P",{});var W=r(l);T=a(W,"You can then fine-tune "),d=n(W,"A",{href:!0});var O=r(d);g=a(O,"TapasForQuestionAnswering"),O.forEach(t),v=a(W," as follows (shown here for the weak supervision for aggregation case):"),W.forEach(t),p=h(k),q(f.$$.fragment,k),this.h()},h(){m(d,"href","/docs/transformers/v4.22.2/en/model_doc/tapas#transformers.TapasForQuestionAnswering")},m(k,W){u(k,l,W),e(l,T),e(l,d),e(d,g),e(l,v),u(k,p,W),$(f,k,W),x=!0},p:Ft,i(k){x||(E(f.$$.fragment,k),x=!0)},o(k){F(f.$$.fragment,k),x=!1},d(k){k&&t(l),k&&t(p),A(f,k)}}}function Fy(P){let l,T;return l=new Tn({props:{$$slots:{default:[Ey]},$$scope:{ctx:P}}}),{c(){j(l.$$.fragment)},l(d){q(l.$$.fragment,d)},m(d,g){$(l,d,g),T=!0},p(d,g){const v={};g&2&&(v.$$scope={dirty:g,ctx:d}),l.$set(v)},i(d){T||(E(l.$$.fragment,d),T=!0)},o(d){F(l.$$.fragment,d),T=!1},d(d){A(l,d)}}}function Ay(P){let l,T,d,g,v,p,f,x;return f=new ht({props:{code:`import tensorflow as tf
...
<span class="hljs-meta">... </span>        optimizer.apply_gradients(<span class="hljs-built_in">zip</span>(grads, model.trainable_weights))`}}),{c(){l=o("p"),T=s("You can then fine-tune "),d=o("a"),g=s("TFTapasForQuestionAnswering"),v=s(" as follows (shown here for the weak supervision for aggregation case):"),p=c(),j(f.$$.fragment),this.h()},l(k){l=n(k,"P",{});var W=r(l);T=a(W,"You can then fine-tune "),d=n(W,"A",{href:!0});var O=r(d);g=a(O,"TFTapasForQuestionAnswering"),O.forEach(t),v=a(W," as follows (shown here for the weak supervision for aggregation case):"),W.forEach(t),p=h(k),q(f.$$.fragment,k),this.h()},h(){m(d,"href","/docs/transformers/v4.22.2/en/model_doc/tapas#transformers.TFTapasForQuestionAnswering")},m(k,W){u(k,l,W),e(l,T),e(l,d),e(d,g),e(l,v),u(k,p,W),$(f,k,W),x=!0},p:Ft,i(k){x||(E(f.$$.fragment,k),x=!0)},o(k){F(f.$$.fragment,k),x=!1},d(k){k&&t(l),k&&t(p),A(f,k)}}}function xy(P){let l,T;return l=new Tn({props:{$$slots:{default:[Ay]},$$scope:{ctx:P}}}),{c(){j(l.$$.fragment)},l(d){q(l.$$.fragment,d)},m(d,g){$(l,d,g),T=!0},p(d,g){const v={};g&2&&(v.$$scope={dirty:g,ctx:d}),l.$set(v)},i(d){T||(E(l.$$.fragment,d),T=!0)},o(d){F(l.$$.fragment,d),T=!1},d(d){A(l,d)}}}function zy(P){let l,T,d,g,v,p,f,x,k,W,O,G,ae,w,J,Z,de,U,N,y,C,B,ee,pe,R,ge,he,X,_e,D,L,I;return L=new ht({props:{code:`from transformers import TapasTokenizer, TapasForQuestionAnswering
import pandas as pd
...
Predicted answer: SUM &gt; <span class="hljs-number">87</span>, <span class="hljs-number">53</span>, <span class="hljs-number">69</span>`}}),{c(){l=o("p"),T=s("Here we explain how you can use "),d=o("a"),g=s("TapasForQuestionAnswering"),v=s(" or "),p=o("a"),f=s("TFTapasForQuestionAnswering"),x=s(" for inference (i.e. making predictions on new data). For inference, only "),k=o("code"),W=s("input_ids"),O=s(", "),G=o("code"),ae=s("attention_mask"),w=s(" and "),J=o("code"),Z=s("token_type_ids"),de=s(" (which you can obtain using "),U=o("a"),N=s("TapasTokenizer"),y=s(") have to be provided to the model to obtain the logits. Next, you can use the handy "),C=o("code"),B=s("convert_logits_to_predictions"),ee=s(" method to convert these into predicted coordinates and optional aggregation indices."),pe=c(),R=o("p"),ge=s("However, note that inference is "),he=o("strong"),X=s("different"),_e=s(" depending on whether or not the setup is conversational. In a non-conversational set-up, inference can be done in parallel on all table-question pairs of a batch. Here\u2019s an example of that:"),D=c(),j(L.$$.fragment),this.h()},l(M){l=n(M,"P",{});var K=r(l);T=a(K,"Here we explain how you can use "),d=n(K,"A",{href:!0});var H=r(d);g=a(H,"TapasForQuestionAnswering"),H.forEach(t),v=a(K," or "),p=n(K,"A",{href:!0});var we=r(p);f=a(we,"TFTapasForQuestionAnswering"),we.forEach(t),x=a(K," for inference (i.e. making predictions on new data). For inference, only "),k=n(K,"CODE",{});var xe=r(k);W=a(xe,"input_ids"),xe.forEach(t),O=a(K,", "),G=n(K,"CODE",{});var ue=r(G);ae=a(ue,"attention_mask"),ue.forEach(t),w=a(K," and "),J=n(K,"CODE",{});var fe=r(J);Z=a(fe,"token_type_ids"),fe.forEach(t),de=a(K," (which you can obtain using "),U=n(K,"A",{href:!0});var Ae=r(U);N=a(Ae,"TapasTokenizer"),Ae.forEach(t),y=a(K,") have to be provided to the model to obtain the logits. Next, you can use the handy "),C=n(K,"CODE",{});var se=r(C);B=a(se,"convert_logits_to_predictions"),se.forEach(t),ee=a(K," method to convert these into predicted coordinates and optional aggregation indices."),K.forEach(t),pe=h(M),R=n(M,"P",{});var ke=r(R);ge=a(ke,"However, note that inference is "),he=n(ke,"STRONG",{});var Te=r(he);X=a(Te,"different"),Te.forEach(t),_e=a(ke," depending on whether or not the setup is conversational. In a non-conversational set-up, inference can be done in parallel on all table-question pairs of a batch. Here\u2019s an example of that:"),ke.forEach(t),D=h(M),q(L.$$.fragment,M),this.h()},h(){m(d,"href","/docs/transformers/v4.22.2/en/model_doc/tapas#transformers.TapasForQuestionAnswering"),m(p,"href","/docs/transformers/v4.22.2/en/model_doc/tapas#transformers.TFTapasForQuestionAnswering"),m(U,"href","/docs/transformers/v4.22.2/en/model_doc/tapas#transformers.TapasTokenizer")},m(M,K){u(M,l,K),e(l,T),e(l,d),e(d,g),e(l,v),e(l,p),e(p,f),e(l,x),e(l,k),e(k,W),e(l,O),e(l,G),e(G,ae),e(l,w),e(l,J),e(J,Z),e(l,de),e(l,U),e(U,N),e(l,y),e(l,C),e(C,B),e(l,ee),u(M,pe,K),u(M,R,K),e(R,ge),e(R,he),e(he,X),e(R,_e),u(M,D,K),$(L,M,K),I=!0},p:Ft,i(M){I||(E(L.$$.fragment,M),I=!0)},o(M){F(L.$$.fragment,M),I=!1},d(M){M&&t(l),M&&t(pe),M&&t(R),M&&t(D),A(L,M)}}}function Cy(P){let l,T;return l=new Tn({props:{$$slots:{default:[zy]},$$scope:{ctx:P}}}),{c(){j(l.$$.fragment)},l(d){q(l.$$.fragment,d)},m(d,g){$(l,d,g),T=!0},p(d,g){const v={};g&2&&(v.$$scope={dirty:g,ctx:d}),l.$set(v)},i(d){T||(E(l.$$.fragment,d),T=!0)},o(d){F(l.$$.fragment,d),T=!1},d(d){A(l,d)}}}function Py(P){let l,T,d,g,v,p,f,x,k,W,O,G,ae,w,J,Z,de,U,N,y,C,B,ee,pe,R,ge,he,X,_e;return X=new ht({props:{code:`from transformers import TapasTokenizer, TFTapasForQuestionAnswering
import pandas as pd
...
Predicted answer: COUNT &gt; <span class="hljs-number">69</span>
What <span class="hljs-keyword">is</span> the total number of movies?
Predicted answer: SUM &gt; <span class="hljs-number">87</span>, <span class="hljs-number">53</span>, <span class="hljs-number">69</span>`}}),{c(){l=o("p"),T=s("Here we explain how you can use "),d=o("a"),g=s("TFTapasForQuestionAnswering"),v=s(" for inference (i.e. making predictions on new data). For inference, only "),p=o("code"),f=s("input_ids"),x=s(", "),k=o("code"),W=s("attention_mask"),O=s(" and "),G=o("code"),ae=s("token_type_ids"),w=s(" (which you can obtain using "),J=o("a"),Z=s("TapasTokenizer"),de=s(") have to be provided to the model to obtain the logits. Next, you can use the handy "),U=o("code"),N=s("convert_logits_to_predictions"),y=s(" method to convert these into predicted coordinates and optional aggregation indices."),C=c(),B=o("p"),ee=s("However, note that inference is "),pe=o("strong"),R=s("different"),ge=s(" depending on whether or not the setup is conversational. In a non-conversational set-up, inference can be done in parallel on all table-question pairs of a batch. Here\u2019s an example of that:"),he=c(),j(X.$$.fragment),this.h()},l(D){l=n(D,"P",{});var L=r(l);T=a(L,"Here we explain how you can use "),d=n(L,"A",{href:!0});var I=r(d);g=a(I,"TFTapasForQuestionAnswering"),I.forEach(t),v=a(L," for inference (i.e. making predictions on new data). For inference, only "),p=n(L,"CODE",{});var M=r(p);f=a(M,"input_ids"),M.forEach(t),x=a(L,", "),k=n(L,"CODE",{});var K=r(k);W=a(K,"attention_mask"),K.forEach(t),O=a(L," and "),G=n(L,"CODE",{});var H=r(G);ae=a(H,"token_type_ids"),H.forEach(t),w=a(L," (which you can obtain using "),J=n(L,"A",{href:!0});var we=r(J);Z=a(we,"TapasTokenizer"),we.forEach(t),de=a(L,") have to be provided to the model to obtain the logits. Next, you can use the handy "),U=n(L,"CODE",{});var xe=r(U);N=a(xe,"convert_logits_to_predictions"),xe.forEach(t),y=a(L," method to convert these into predicted coordinates and optional aggregation indices."),L.forEach(t),C=h(D),B=n(D,"P",{});var ue=r(B);ee=a(ue,"However, note that inference is "),pe=n(ue,"STRONG",{});var fe=r(pe);R=a(fe,"different"),fe.forEach(t),ge=a(ue," depending on whether or not the setup is conversational. In a non-conversational set-up, inference can be done in parallel on all table-question pairs of a batch. Here\u2019s an example of that:"),ue.forEach(t),he=h(D),q(X.$$.fragment,D),this.h()},h(){m(d,"href","/docs/transformers/v4.22.2/en/model_doc/tapas#transformers.TFTapasForQuestionAnswering"),m(J,"href","/docs/transformers/v4.22.2/en/model_doc/tapas#transformers.TapasTokenizer")},m(D,L){u(D,l,L),e(l,T),e(l,d),e(d,g),e(l,v),e(l,p),e(p,f),e(l,x),e(l,k),e(k,W),e(l,O),e(l,G),e(G,ae),e(l,w),e(l,J),e(J,Z),e(l,de),e(l,U),e(U,N),e(l,y),u(D,C,L),u(D,B,L),e(B,ee),e(B,pe),e(pe,R),e(B,ge),u(D,he,L),$(X,D,L),_e=!0},p:Ft,i(D){_e||(E(X.$$.fragment,D),_e=!0)},o(D){F(X.$$.fragment,D),_e=!1},d(D){D&&t(l),D&&t(C),D&&t(B),D&&t(he),A(X,D)}}}function My(P){let l,T;return l=new Tn({props:{$$slots:{default:[Py]},$$scope:{ctx:P}}}),{c(){j(l.$$.fragment)},l(d){q(l.$$.fragment,d)},m(d,g){$(l,d,g),T=!0},p(d,g){const v={};g&2&&(v.$$scope={dirty:g,ctx:d}),l.$set(v)},i(d){T||(E(l.$$.fragment,d),T=!0)},o(d){F(l.$$.fragment,d),T=!1},d(d){A(l,d)}}}function Sy(P){let l,T,d,g,v;return g=new ht({props:{code:`from transformers import TapasModel, TapasConfig
...
<span class="hljs-meta">&gt;&gt;&gt; </span>configuration = model.config`}}),{c(){l=o("p"),T=s("Example:"),d=c(),j(g.$$.fragment)},l(p){l=n(p,"P",{});var f=r(l);T=a(f,"Example:"),f.forEach(t),d=h(p),q(g.$$.fragment,p)},m(p,f){u(p,l,f),e(l,T),u(p,d,f),$(g,p,f),v=!0},p:Ft,i(p){v||(E(g.$$.fragment,p),v=!0)},o(p){F(g.$$.fragment,p),v=!1},d(p){p&&t(l),p&&t(d),A(g,p)}}}function Dy(P){let l,T,d,g,v;return{c(){l=o("p"),T=s("Although the recipe for forward pass needs to be defined within this function, one should call the "),d=o("code"),g=s("Module"),v=s(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(p){l=n(p,"P",{});var f=r(l);T=a(f,"Although the recipe for forward pass needs to be defined within this function, one should call the "),d=n(f,"CODE",{});var x=r(d);g=a(x,"Module"),x.forEach(t),v=a(f,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),f.forEach(t)},m(p,f){u(p,l,f),e(l,T),e(l,d),e(d,g),e(l,v)},d(p){p&&t(l)}}}function Oy(P){let l,T,d,g,v;return g=new ht({props:{code:`from transformers import TapasTokenizer, TapasModel
import pandas as pd
...
the latter silently ignores them.`)},l(p){l=n(p,"P",{});var f=r(l);T=a(f,"Although the recipe for forward pass needs to be defined within this function, one should call the "),d=n(f,"CODE",{});var x=r(d);g=a(x,"Module"),x.forEach(t),v=a(f,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),f.forEach(t)},m(p,f){u(p,l,f),e(l,T),e(l,d),e(d,g),e(l,v)},d(p){p&&t(l)}}}function Ly(P){let l,T,d,g,v;return g=new ht({props:{code:`from transformers import TapasTokenizer, TapasForMaskedLM
import pandas as pd
...
the latter silently ignores them.`)},l(p){l=n(p,"P",{});var f=r(l);T=a(f,"Although the recipe for forward pass needs to be defined within this function, one should call the "),d=n(f,"CODE",{});var x=r(d);g=a(x,"Module"),x.forEach(t),v=a(f,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),f.forEach(t)},m(p,f){u(p,l,f),e(l,T),e(l,d),e(d,g),e(l,v)},d(p){p&&t(l)}}}function Iy(P){let l,T,d,g,v;return g=new ht({props:{code:`from transformers import TapasTokenizer, TapasForSequenceClassification
import torch
import pandas as pd
...
the latter silently ignores them.`)},l(p){l=n(p,"P",{});var f=r(l);T=a(f,"Although the recipe for forward pass needs to be defined within this function, one should call the "),d=n(f,"CODE",{});var x=r(d);g=a(x,"Module"),x.forEach(t),v=a(f,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),f.forEach(t)},m(p,f){u(p,l,f),e(l,T),e(l,d),e(d,g),e(l,v)},d(p){p&&t(l)}}}function Hy(P){let l,T,d,g,v;return g=new ht({props:{code:`from transformers import TapasTokenizer, TapasForQuestionAnswering
import pandas as pd
...
<span class="hljs-meta">&gt;&gt;&gt; </span>logits_aggregation = outputs.logits_aggregation`}}),{c(){l=o("p"),T=s("Examples:"),d=c(),j(g.$$.fragment)},l(p){l=n(p,"P",{});var f=r(l);T=a(f,"Examples:"),f.forEach(t),d=h(p),q(g.$$.fragment,p)},m(p,f){u(p,l,f),e(l,T),u(p,d,f),$(g,p,f),v=!0},p:Ft,i(p){v||(E(g.$$.fragment,p),v=!0)},o(p){F(g.$$.fragment,p),v=!1},d(p){p&&t(l),p&&t(d),A(g,p)}}}function Uy(P){let l,T,d,g,v,p,f,x,k,W,O,G,ae,w,J,Z,de,U,N,y,C,B,ee,pe,R,ge,he,X,_e,D,L,I,M,K,H,we,xe,ue,fe,Ae,se,ke,Te,Pe,Ce,je,Me,$e,ce,Se,ye,Y,qe,V,We,oe,He,Ue;return{c(){l=o("p"),T=s("TensorFlow models and layers in "),d=o("code"),g=s("transformers"),v=s(" accept two formats as input:"),p=c(),f=o("ul"),x=o("li"),k=s("having all inputs as keyword arguments (like PyTorch models), or"),W=c(),O=o("li"),G=s("having all inputs as a list, tuple or dict in the first positional argument."),ae=c(),w=o("p"),J=s(`The reason the second format is supported is that Keras methods prefer this format when passing inputs to models
...
positional argument:`),L=c(),I=o("ul"),M=o("li"),K=s("a single Tensor with "),H=o("code"),we=s("input_ids"),xe=s(" only and nothing else: "),ue=o("code"),fe=s("model(input_ids)"),Ae=c(),se=o("li"),ke=s(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
...
about any of this, as you can just pass inputs like you would to any other Python function!`),this.h()},l(b){l=n(b,"P",{});var S=r(l);T=a(S,"TensorFlow models and layers in "),d=n(S,"CODE",{});var Ve=r(d);g=a(Ve,"transformers"),Ve.forEach(t),v=a(S," accept two formats as input:"),S.forEach(t),p=h(b),f=n(b,"UL",{});var ve=r(f);x=n(ve,"LI",{});var Ye=r(x);k=a(Ye,"having all inputs as keyword arguments (like PyTorch models), or"),Ye.forEach(t),W=h(ve),O=n(ve,"LI",{});var Je=r(O);G=a(Je,"having all inputs as a list, tuple or dict in the first positional argument."),Je.forEach(t),ve.forEach(t),ae=h(b),w=n(b,"P",{});var Q=r(w);J=a(Q,`The reason the second format is supported is that Keras methods prefer this format when passing inputs to models
...
positional argument:`),Q.forEach(t),L=h(b),I=n(b,"UL",{});var le=r(I);M=n(le,"LI",{});var Ee=r(M);K=a(Ee,"a single Tensor with "),H=n(Ee,"CODE",{});var Ze=r(H);we=a(Ze,"input_ids"),Ze.forEach(t),xe=a(Ee," only and nothing else: "),ue=n(Ee,"CODE",{});var ze=r(ue);fe=a(ze,"model(input_ids)"),ze.forEach(t),Ee.forEach(t),Ae=h(le),se=n(le,"LI",{});var ne=r(se);ke=a(ne,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
...
`),ye=n(re,"CODE",{});var Re=r(ye);Y=a(Re,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),Re.forEach(t),re.forEach(t),le.forEach(t),qe=h(b),V=n(b,"P",{});var Fe=r(V);We=a(Fe,`Note that when creating models and layers with
`),oe=n(Fe,"A",{href:!0,rel:!0});var tt=r(oe);He=a(tt,"subclassing"),tt.forEach(t),Ue=a(Fe,` then you don\u2019t need to worry
about any of this, as you can just pass inputs like you would to any other Python function!`),Fe.forEach(t),this.h()},h(){m(oe,"href","https://keras.io/guides/making_new_layers_and_models_via_subclassing/"),m(oe,"rel","nofollow")},m(b,S){u(b,l,S),e(l,T),e(l,d),e(d,g),e(l,v),u(b,p,S),u(b,f,S),e(f,x),e(x,k),e(f,W),e(f,O),e(O,G),u(b,ae,S),u(b,w,S),e(w,J),e(w,Z),e(Z,de),e(w,U),e(w,N),e(N,y),e(w,C),e(w,B),e(B,ee),e(w,pe),e(w,R),e(R,ge),e(w,he),e(w,X),e(X,_e),e(w,D),u(b,L,S),u(b,I,S),e(I,M),e(M,K),e(M,H),e(H,we),e(M,xe),e(M,ue),e(ue,fe),e(I,Ae),e(I,se),e(se,ke),e(se,Te),e(Te,Pe),e(se,Ce),e(se,je),e(je,Me),e(I,$e),e(I,ce),e(ce,Se),e(ce,ye),e(ye,Y),u(b,qe,S),u(b,V,S),e(V,We),e(V,oe),e(oe,He),e(V,Ue)},d(b){b&&t(l),b&&t(p),b&&t(f),b&&t(ae),b&&t(w),b&&t(L),b&&t(I),b&&t(qe),b&&t(V)}}}function By(P){let l,T,d,g,v;return{c(){l=o("p"),T=s("Although the recipe for forward pass needs to be defined within this function, one should call the "),d=o("code"),g=s("Module"),v=s(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(p){l=n(p,"P",{});var f=r(l);T=a(f,"Although the recipe for forward pass needs to be defined within this function, one should call the "),d=n(f,"CODE",{});var x=r(d);g=a(x,"Module"),x.forEach(t),v=a(f,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),f.forEach(t)},m(p,f){u(p,l,f),e(l,T),e(l,d),e(d,g),e(l,v)},d(p){p&&t(l)}}}function Ry(P){let l,T,d,g,v;return g=new ht({props:{code:`from transformers import TapasTokenizer, TapasModel
import pandas as pd
...
`),ye=n(re,"CODE",{});var Re=r(ye);Y=a(Re,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),Re.forEach(t),re.forEach(t),le.forEach(t),qe=h(b),V=n(b,"P",{});var Fe=r(V);We=a(Fe,`Note that when creating models and layers with
`),oe=n(Fe,"A",{href:!0,rel:!0});var tt=r(oe);He=a(tt,"subclassing"),tt.forEach(t),Ue=a(Fe,` then you don\u2019t need to worry
about any of this, as you can just pass inputs like you would to any other Python function!`),Fe.forEach(t),this.h()},h(){m(oe,"href","https://keras.io/guides/making_new_layers_and_models_via_subclassing/"),m(oe,"rel","nofollow")},m(b,S){u(b,l,S),e(l,T),e(l,d),e(d,g),e(l,v),u(b,p,S),u(b,f,S),e(f,x),e(x,k),e(f,W),e(f,O),e(O,G),u(b,ae,S),u(b,w,S),e(w,J),e(w,Z),e(Z,de),e(w,U),e(w,N),e(N,y),e(w,C),e(w,B),e(B,ee),e(w,pe),e(w,R),e(R,ge),e(w,he),e(w,X),e(X,_e),e(w,D),u(b,L,S),u(b,I,S),e(I,M),e(M,K),e(M,H),e(H,we),e(M,xe),e(M,ue),e(ue,fe),e(I,Ae),e(I,se),e(se,ke),e(se,Te),e(Te,Pe),e(se,Ce),e(se,je),e(je,Me),e(I,$e),e(I,ce),e(ce,Se),e(ce,ye),e(ye,Y),u(b,qe,S),u(b,V,S),e(V,We),e(V,oe),e(oe,He),e(V,Ue)},d(b){b&&t(l),b&&t(p),b&&t(f),b&&t(ae),b&&t(w),b&&t(L),b&&t(I),b&&t(qe),b&&t(V)}}}function Ky(P){let l,T,d,g,v;return{c(){l=o("p"),T=s("Although the recipe for forward pass needs to be defined within this function, one should call the "),d=o("code"),g=s("Module"),v=s(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(p){l=n(p,"P",{});var f=r(l);T=a(f,"Although the recipe for forward pass needs to be defined within this function, one should call the "),d=n(f,"CODE",{});var x=r(d);g=a(x,"Module"),x.forEach(t),v=a(f,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),f.forEach(t)},m(p,f){u(p,l,f),e(l,T),e(l,d),e(d,g),e(l,v)},d(p){p&&t(l)}}}function Vy(P){let l,T,d,g,v;return g=new ht({props:{code:`from transformers import TapasTokenizer, TapasForMaskedLM
import pandas as pd
...
`),ye=n(re,"CODE",{});var Re=r(ye);Y=a(Re,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),Re.forEach(t),re.forEach(t),le.forEach(t),qe=h(b),V=n(b,"P",{});var Fe=r(V);We=a(Fe,`Note that when creating models and layers with
`),oe=n(Fe,"A",{href:!0,rel:!0});var tt=r(oe);He=a(tt,"subclassing"),tt.forEach(t),Ue=a(Fe,` then you don\u2019t need to worry
about any of this, as you can just pass inputs like you would to any other Python function!`),Fe.forEach(t),this.h()},h(){m(oe,"href","https://keras.io/guides/making_new_layers_and_models_via_subclassing/"),m(oe,"rel","nofollow")},m(b,S){u(b,l,S),e(l,T),e(l,d),e(d,g),e(l,v),u(b,p,S),u(b,f,S),e(f,x),e(x,k),e(f,W),e(f,O),e(O,G),u(b,ae,S),u(b,w,S),e(w,J),e(w,Z),e(Z,de),e(w,U),e(w,N),e(N,y),e(w,C),e(w,B),e(B,ee),e(w,pe),e(w,R),e(R,ge),e(w,he),e(w,X),e(X,_e),e(w,D),u(b,L,S),u(b,I,S),e(I,M),e(M,K),e(M,H),e(H,we),e(M,xe),e(M,ue),e(ue,fe),e(I,Ae),e(I,se),e(se,ke),e(se,Te),e(Te,Pe),e(se,Ce),e(se,je),e(je,Me),e(I,$e),e(I,ce),e(ce,Se),e(ce,ye),e(ye,Y),u(b,qe,S),u(b,V,S),e(V,We),e(V,oe),e(oe,He),e(V,Ue)},d(b){b&&t(l),b&&t(p),b&&t(f),b&&t(ae),b&&t(w),b&&t(L),b&&t(I),b&&t(qe),b&&t(V)}}}function Jy(P){let l,T,d,g,v;return{c(){l=o("p"),T=s("Although the recipe for forward pass needs to be defined within this function, one should call the "),d=o("code"),g=s("Module"),v=s(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(p){l=n(p,"P",{});var f=r(l);T=a(f,"Although the recipe for forward pass needs to be defined within this function, one should call the "),d=n(f,"CODE",{});var x=r(d);g=a(x,"Module"),x.forEach(t),v=a(f,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),f.forEach(t)},m(p,f){u(p,l,f),e(l,T),e(l,d),e(d,g),e(l,v)},d(p){p&&t(l)}}}function Xy(P){let l,T,d,g,v;return g=new ht({props:{code:`from transformers import TapasTokenizer, TapasForSequenceClassification
...
`),ye=n(re,"CODE",{});var Re=r(ye);Y=a(Re,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),Re.forEach(t),re.forEach(t),le.forEach(t),qe=h(b),V=n(b,"P",{});var Fe=r(V);We=a(Fe,`Note that when creating models and layers with
`),oe=n(Fe,"A",{href:!0,rel:!0});var tt=r(oe);He=a(tt,"subclassing"),tt.forEach(t),Ue=a(Fe,` then you don\u2019t need to worry
about any of this, as you can just pass inputs like you would to any other Python function!`),Fe.forEach(t),this.h()},h(){m(oe,"href","https://keras.io/guides/making_new_layers_and_models_via_subclassing/"),m(oe,"rel","nofollow")},m(b,S){u(b,l,S),e(l,T),e(l,d),e(d,g),e(l,v),u(b,p,S),u(b,f,S),e(f,x),e(x,k),e(f,W),e(f,O),e(O,G),u(b,ae,S),u(b,w,S),e(w,J),e(w,Z),e(Z,de),e(w,U),e(w,N),e(N,y),e(w,C),e(w,B),e(B,ee),e(w,pe),e(w,R),e(R,ge),e(w,he),e(w,X),e(X,_e),e(w,D),u(b,L,S),u(b,I,S),e(I,M),e(M,K),e(M,H),e(H,we),e(M,xe),e(M,ue),e(ue,fe),e(I,Ae),e(I,se),e(se,ke),e(se,Te),e(Te,Pe),e(se,Ce),e(se,je),e(je,Me),e(I,$e),e(I,ce),e(ce,Se),e(ce,ye),e(ye,Y),u(b,qe,S),u(b,V,S),e(V,We),e(V,oe),e(oe,He),e(V,Ue)},d(b){b&&t(l),b&&t(p),b&&t(f),b&&t(ae),b&&t(w),b&&t(L),b&&t(I),b&&t(qe),b&&t(V)}}}function e2(P){let l,T,d,g,v;return{c(){l=o("p"),T=s("Although the recipe for forward pass needs to be defined within this function, one should call the "),d=o("code"),g=s("Module"),v=s(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(p){l=n(p,"P",{});var f=r(l);T=a(f,"Although the recipe for forward pass needs to be defined within this function, one should call the "),d=n(f,"CODE",{});var x=r(d);g=a(x,"Module"),x.forEach(t),v=a(f,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),f.forEach(t)},m(p,f){u(p,l,f),e(l,T),e(l,d),e(d,g),e(l,v)},d(p){p&&t(l)}}}function t2(P){let l,T,d,g,v;return g=new ht({props:{code:`from transformers import TapasTokenizer, TapasForQuestionAnswering
import pandas as pd
...
<span class="hljs-meta">&gt;&gt;&gt; </span>logits = outputs.logits
<span class="hljs-meta">&gt;&gt;&gt; </span>logits_aggregation = outputs.logits_aggregation`}}),{c(){l=o("p"),T=s("Examples:"),d=c(),j(g.$$.fragment)},l(p){l=n(p,"P",{});var f=r(l);T=a(f,"Examples:"),f.forEach(t),d=h(p),q(g.$$.fragment,p)},m(p,f){u(p,l,f),e(l,T),u(p,d,f),$(g,p,f),v=!0},p:Ft,i(p){v||(E(g.$$.fragment,p),v=!0)},o(p){F(g.$$.fragment,p),v=!1},d(p){p&&t(l),p&&t(d),A(g,p)}}}function s2(P){let l,T,d,g,v,p,f,x,k,W,O,G,ae,w,J,Z,de,U,N,y,C,B,ee,pe,R,ge,he,X,_e,D,L,I,M,K,H,we,xe,ue,fe,Ae,se,ke,Te,Pe,Ce,je,Me,$e,ce,Se,ye,Y,qe,V,We,oe,He,Ue,b,S,Ve,ve,Ye,Je,Q,Le,ot,Qe,Ie,Xe,le,Ee,Ze,ze,ne,et,Be,re,Re,Fe,tt,Pt,Mt,Ws,St,vs,ts,Dt,bs,ut,De,Hs,Ot,ie,vt,ss,Us,Nt,ns,Bs,Lt,Qt,Rs,It,rs,Gs,Wt,is,Ks,Ht,Vs,st,Ut,ls,Ys,Bt,ds,Js,ps,lt,cs,Oe,hs,bt,Xs,Rt,Gt,Zs,ea,dt,ta,us,ms,gt,Kt,z,te,ka,sa,ja,ha,Vt,_t,aa,wt,qa,oa,$a,ua,nt,fs,ws,pt,Ea,ma,ys,na,gs,fa,be,Fa,ks,Aa,xa,ga,At,ra,_s,za,Ne,Ca,ia,Pa,Ma,Sa,me,Da,la,Oa,Na,_a,js,La,Ta,Ge,da,Yt,pa,el,Sc,Dc,tl,sl,Oc,Nc,al,ol,Lc,Qc,Qa,Ia,nl,Ic,Wc,rl,Hc,Uc,il,Bc,Rc,Wa,ll,Gc,Kc,dl,Vc,Yc,pl,Jc,Xc,Ha,cl,Zc,eh,hl,th,sh,ul,ah,op,vo,np,bo,oh,vn,nh,rh,rp,wo,ih,bn,lh,dh,ip,Br,ml,ph,lp,yo,ch,wn,hh,uh,dp,rt,Rr,fl,mh,fh,gh,Gr,gl,_h,Th,vh,Kr,_l,bh,wh,yh,Vr,Tl,kh,jh,qh,Yr,vl,$h,Eh,Fh,Jr,bl,Ah,xh,zh,Xr,wl,Ch,Ph,Mh,Zr,yl,Sh,Dh,Oh,ei,kl,Nh,Lh,pp,xt,Qh,yn,Ih,Wh,kn,Hh,Uh,jl,Bh,Rh,ql,Gh,Kh,$l,Vh,Yh,cp,ti,El,Jh,hp,ko,up,Ke,Xh,Fl,Zh,eu,Al,tu,su,xl,au,ou,zl,nu,ru,Cl,iu,lu,Pl,du,pu,si,cu,hu,jn,uu,mu,qn,fu,gu,mp,ai,_u,fp,jo,gp,Ua,qo,Ml,$n,Tu,Sl,vu,_p,$o,Tp,zt,bu,Dl,wu,yu,Ol,ku,ju,Nl,qu,$u,En,Eu,Fu,Fn,Au,xu,vp,Ba,Eo,Ll,An,zu,Ql,Cu,bp,Ra,xn,Pu,zn,Mu,oi,Su,Du,wp,Ga,Fo,Il,Cn,Ou,Wl,Nu,yp,Jt,Pn,Lu,Ka,Qu,ni,Iu,Wu,Mn,Hu,Uu,Bu,Va,Ru,Hl,Gu,Ku,ri,Vu,Yu,Ju,Sn,Xu,Dn,Zu,em,tm,Ao,kp,Ya,xo,Ul,On,sm,Bl,am,jp,ct,Nn,om,Rl,nm,rm,at,im,ii,lm,dm,li,pm,cm,Gl,hm,um,Kl,mm,fm,Vl,gm,_m,Yl,Tm,vm,Jl,bm,wm,Xl,ym,km,Zl,jm,qm,$m,yt,ed,Em,Fm,td,Am,xm,sd,zm,Cm,ad,Pm,Mm,od,Sm,Dm,nd,Om,Nm,rd,Lm,Qm,di,pi,Im,Wm,Hm,zo,Ln,Um,id,Bm,Rm,va,Qn,Gm,In,Km,ci,Vm,Ym,Jm,Wn,Xm,Hn,Zm,ef,tf,hi,Un,qp,Ja,Co,ld,Bn,sf,dd,af,$p,kt,Rn,of,Gn,nf,ui,rf,lf,df,Kn,pf,Vn,cf,hf,uf,Yn,mf,mi,ff,gf,_f,Jn,Tf,Xn,vf,bf,wf,qs,Zn,yf,Xa,kf,fi,jf,qf,pd,$f,Ef,Ff,Po,Af,Mo,Ep,Za,So,cd,er,xf,hd,zf,Fp,Ts,tr,Cf,eo,Pf,ud,Mf,Sf,gi,Df,Of,Nf,sr,Lf,ar,Qf,If,Wf,$s,or,Hf,to,Uf,_i,Bf,Rf,md,Gf,Kf,Vf,Do,Yf,Oo,Ap,so,No,fd,nr,Jf,gd,Xf,xp,Xt,rr,Zf,_d,eg,tg,ir,sg,Ti,ag,og,ng,lr,rg,dr,ig,lg,dg,Es,pr,pg,ao,cg,vi,hg,ug,Td,mg,fg,gg,Lo,_g,Qo,zp,oo,Io,vd,cr,Tg,bd,vg,Cp,Zt,hr,bg,no,wg,wd,yg,kg,yd,jg,qg,$g,ur,Eg,bi,Fg,Ag,xg,mr,zg,fr,Cg,Pg,Mg,Fs,gr,Sg,ro,Dg,wi,Og,Ng,kd,Lg,Qg,Ig,Wo,Wg,Ho,Pp,io,Uo,jd,_r,Hg,qd,Ug,Mp,jt,Tr,Bg,$d,Rg,Gg,vr,Kg,yi,Vg,Yg,Jg,br,Xg,wr,Zg,e_,t_,Bo,s_,As,yr,a_,lo,o_,ki,n_,r_,Ed,i_,l_,d_,Ro,p_,Go,Sp,po,Ko,Fd,kr,c_,Ad,h_,Dp,qt,jr,u_,qr,m_,xd,f_,g_,__,$r,T_,ji,v_,b_,w_,Er,y_,Fr,k_,j_,q_,Vo,$_,xs,Ar,E_,co,F_,qi,A_,x_,zd,z_,C_,P_,Yo,M_,Jo,Op,ho,Xo,Cd,xr,S_,Pd,D_,Np,$t,zr,O_,Md,N_,L_,Cr,Q_,$i,I_,W_,H_,Pr,U_,Mr,B_,R_,G_,Zo,K_,zs,Sr,V_,uo,Y_,Ei,J_,X_,Sd,Z_,eT,tT,en,sT,tn,Lp,mo,sn,Dd,Dr,aT,Od,oT,Qp,Et,Or,nT,fo,rT,Nd,iT,lT,Ld,dT,pT,cT,Nr,hT,Fi,uT,mT,fT,Lr,gT,Qr,_T,TT,vT,an,bT,Cs,Ir,wT,go,yT,Ai,kT,jT,Qd,qT,$T,ET,on,FT,nn,Ip;return p=new es({}),w=new es({}),wt=new es({}),vo=new Mc({props:{pytorch:!0,tensorflow:!0,jax:!1,$$slots:{tensorflow:[yy],pytorch:[by]},$$scope:{ctx:P}}}),ko=new Mc({props:{pytorch:!0,tensorflow:!0,jax:!1,$$slots:{tensorflow:[$y],pytorch:[jy]},$$scope:{ctx:P}}}),jo=new Mc({props:{pytorch:!0,tensorflow:!0,jax:!1,$$slots:{tensorflow:[xy],pytorch:[Fy]},$$scope:{ctx:P}}}),$n=new es({}),$o=new Mc({props:{pytorch:!0,tensorflow:!0,jax:!1,$$slots:{tensorflow:[My],pytorch:[Cy]},$$scope:{ctx:P}}}),An=new es({}),xn=new it({props:{name:"class transformers.models.tapas.modeling_tapas.TableQuestionAnsweringOutput",anchor:"transformers.models.tapas.modeling_tapas.TableQuestionAnsweringOutput",parameters:[{name:"loss",val:": typing.Optional[torch.FloatTensor] = None"},{name:"logits",val:": FloatTensor = None"},{name:"logits_aggregation",val:": FloatTensor = None"},{name:"hidden_states",val:": typing.Optional[typing.Tuple[torch.FloatTensor]] = None"},{name:"attentions",val:": typing.Optional[typing.Tuple[torch.FloatTensor]] = None"}],parametersDescription:[{anchor:"transformers.models.tapas.modeling_tapas.TableQuestionAnsweringOutput.loss",description:`<strong>loss</strong> (<code>torch.FloatTensor</code> of shape <code>(1,)</code>, <em>optional</em>, returned when <code>labels</code> (and possibly <code>answer</code>, <code>aggregation_labels</code>, <code>numeric_values</code> and <code>numeric_values_scale</code> are provided)) &#x2014;
...
this threshold will be selected.`,name:"cell_classification_threshold"}],source:"https://github.com/huggingface/transformers/blob/v4.22.2/src/transformers/models/tapas/tokenization_tapas.py#L1939",returnDescription:`
<ul>
...
`}}),Un=new it({props:{name:"save_vocabulary",anchor:"transformers.TapasTokenizer.save_vocabulary",parameters:[{name:"save_directory",val:": str"},{name:"filename_prefix",val:": typing.Optional[str] = None"}],source:"https://github.com/huggingface/transformers/blob/v4.22.2/src/transformers/models/tapas/tokenization_tapas.py#L444"}}),Bn=new es({}),Rn=new it({props:{name:"class transformers.TapasModel",anchor:"transformers.TapasModel",parameters:[{name:"config",val:""},{name:"add_pooling_layer",val:" = True"}],parametersDescription:[{anchor:"transformers.TapasModel.config",description:`<strong>config</strong> (<a href="/docs/transformers/v4.22.2/en/model_doc/tapas#transformers.TapasConfig">TapasConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/v4.22.2/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/v4.22.2/src/transformers/models/tapas/modeling_tapas.py#L853"}}),Zn=new it({props:{name:"forward",anchor:"transformers.TapasModel.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"encoder_hidden_states",val:" = None"},{name:"encoder_attention_mask",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],parametersDescription:[{anchor:"transformers.TapasModel.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. Indices can be obtained using <a href="/docs/transformers/v4.22.2/en/model_doc/tapas#transformers.TapasTokenizer">TapasTokenizer</a>. See
...
Token indices that encode tabular structure. Indices can be obtained using <a href="/docs/transformers/v4.22.2/en/model_doc/tapas#transformers.TapasTokenizer">TapasTokenizer</a>. See this
...
<code>reset_position_index_per_cell</code> of <a href="/docs/transformers/v4.22.2/en/model_doc/tapas#transformers.TapasConfig">TapasConfig</a> is set to <code>True</code>, relative position embeddings will be
...
elements depending on the configuration (<a
  href="/docs/transformers/v4.22.2/en/model_doc/tapas#transformers.TapasConfig"
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/v4.22.2/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/v4.22.2/src/transformers/models/tapas/modeling_tapas.py#L1006"}}),or=new it({props:{name:"forward",anchor:"transformers.TapasForMaskedLM.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"encoder_hidden_states",val:" = None"},{name:"encoder_attention_mask",val:" = None"},{name:"labels",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.TapasForMaskedLM.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. Indices can be obtained using <a href="/docs/transformers/v4.22.2/en/model_doc/tapas#transformers.TapasTokenizer">TapasTokenizer</a>. See
<a href="/docs/transformers/v4.22.2/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and <a href="/docs/transformers/v4.22.2/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.22.2/src/transformers/models/tapas/modeling_tapas.py#L1025",returnDescription:`
<p>A <a
...
&#x201C;classification_class_index&#x201D; in the original implementation.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.22.2/src/transformers/models/tapas/modeling_tapas.py#L1478",returnDescription:`
<p>A <a
...
answer appearing in the table. Can be obtained using <a href="/docs/transformers/v4.22.2/en/model_doc/tapas#transformers.TapasTokenizer">TapasTokenizer</a>.</p>
<ul>
...
<a href="/docs/transformers/v4.22.2/en/model_doc/tapas#transformers.TapasTokenizer">TapasTokenizer</a>. Only required in case of weak supervision for aggregation (WTQ) to calculate the
...
Scale of the numeric values of every token. Can be obtained using <a href="/docs/transformers/v4.22.2/en/model_doc/tapas#transformers.TapasTokenizer">TapasTokenizer</a>. Only required in case
of weak supervision for aggregation (WTQ) to calculate the regression loss.`,name:"numeric_values_scale"}],source:"https://github.com/huggingface/transformers/blob/v4.22.2/src/transformers/models/tapas/modeling_tapas.py#L1156",returnDescription:`
<p>A <a
  href="/docs/transformers/v4.22.2/en/model_doc/tapas#transformers.models.tapas.modeling_tapas.TableQuestionAnsweringOutput"
...
behaviors between training and evaluation).`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/v4.22.2/src/transformers/models/tapas/modeling_tf_tapas.py#L985",returnDescription:`
<p>A <a
...
Labels for computing the masked language modeling loss. Indices should be in <code>[-100, 0, ..., config.vocab_size]</code> (see <code>input_ids</code> docstring) Tokens with indices set to <code>-100</code> are ignored (masked), the
loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.22.2/src/transformers/models/tapas/modeling_tf_tapas.py#L1070",returnDescription:`
<p>A <a
...
`}}),Yo=new Is({props:{$$slots:{default:[Ky]},$$scope:{ctx:P}}}),Jo=new To({props:{anchor:"transformers.TFTapasForMaskedLM.call.example",$$slots:{default:[Vy]},$$scope:{ctx:P}}}),xr=new es({}),zr=new it({props:{name:"class transformers.TFTapasForSequenceClassification",anchor:"transformers.TFTapasForSequenceClassification",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.TFTapasForSequenceClassification.config",description:`<strong>config</strong> (<a href="/docs/transformers/v4.22.2/en/model_doc/tapas#transformers.TapasConfig">TapasConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/v4.22.2/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/v4.22.2/src/transformers/models/tapas/modeling_tf_tapas.py#L1596"}}),Zo=new Is({props:{$$slots:{default:[Yy]},$$scope:{ctx:P}}}),Sr=new it({props:{name:"call",anchor:"transformers.TFTapasForSequenceClassification.call",parameters:[{name:"input_ids",val:": typing.Union[typing.List[tensorflow.python.framework.ops.Tensor], typing.List[numpy.ndarray], typing.List[tensorflow.python.keras.engine.keras_tensor.KerasTensor], typing.Dict[str, tensorflow.python.framework.ops.Tensor], typing.Dict[str, numpy.ndarray], typing.Dict[str, tensorflow.python.keras.engine.keras_tensor.KerasTensor], tensorflow.python.framework.ops.Tensor, numpy.ndarray, tensorflow.python.keras.engine.keras_tensor.KerasTensor, NoneType] = None"},{name:"attention_mask",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"token_type_ids",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"position_ids",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"head_mask",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"inputs_embeds",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"labels",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"training",val:": typing.Optional[bool] = False"}],parametersDescription:[{anchor:"transformers.TFTapasForSequenceClassification.call.input_ids",description:`<strong>input_ids</strong> (<code>np.ndarray</code>, <code>tf.Tensor</code>, <code>List[tf.Tensor]</code> \`<code>Dict[str, tf.Tensor]</code> or <code>Dict[str, np.ndarray]</code> and each example must have the shape <code>(batch_size, num_choices, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/v4.22.2/en/model_doc/tapas#transformers.TapasTokenizer">TapasTokenizer</a>. See <a href="/docs/transformers/v4.22.2/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
<a href="/docs/transformers/v4.22.2/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> for details.</p>
...
Labels for computing the sequence classification/regression loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>. If <code>config.num_labels == 1</code> a regression loss is computed (Mean-Square loss), If
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy). Note: this is called
&#x201C;classification_class_index&#x201D; in the original implementation.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.22.2/src/transformers/models/tapas/modeling_tf_tapas.py#L1607",returnDescription:`
<p>A <a
...
Scale of the numeric values of every token. Can be obtained using <a href="/docs/transformers/v4.22.2/en/model_doc/tapas#transformers.TapasTokenizer">TapasTokenizer</a>. Only required in case
of weak supervision for aggregation (WTQ) to calculate the regression loss.`,name:"numeric_values_scale"}],source:"https://github.com/huggingface/transformers/blob/v4.22.2/src/transformers/models/tapas/modeling_tf_tapas.py#L1282",returnDescription:`
...
`}}),on=new Is({props:{$$slots:{default:[e2]},$$scope:{ctx:P}}}),nn=new To({props:{anchor:"transformers.TFTapasForQuestionAnswering.call.example",$$slots:{default:[t2]},$$scope:{ctx:P}}}),{c(){l=o("meta"),T=c(),d=o("h1"),g=o("a"),v=o("span"),j(p.$$.fragment),f=c(),x=o("span"),k=s("TAPAS"),W=c(),O=o("h2"),G=o("a"),ae=o("span"),j(w.$$.fragment),J=c(),Z=o("span"),de=s("Overview"),U=c(),N=o("p"),y=s("The TAPAS model was proposed in "),C=o("a"),B=s("TAPAS: Weakly Supervised Table Parsing via Pre-training"),ee=s(`
...
implementation. Original implementation available at `),Dn=o("a"),Zu=s("https://github.com/google-research/tapas/tree/master"),em=s("."),tm=c(),j(Ao.$$.fragment),kp=c(),Ya=o("h2"),xo=o("a"),Ul=o("span"),j(On.$$.fragment),sm=c(),Bl=o("span"),am=s("TapasTokenizer"),jp=c(),ct=o("div"),j(Nn.$$.fragment),om=c(),Rl=o("p"),nm=s(`Construct a TAPAS tokenizer. Based on WordPiece. Flattens a table and one or more related sentences to be used by
...
`),Kl=o("code"),mm=s("column_ids"),fm=s(", "),Vl=o("code"),gm=s("row_ids"),_m=s(", "),Yl=o("code"),Tm=s("prev_labels"),vm=s(", "),Jl=o("code"),bm=s("column_ranks"),wm=s(", "),Xl=o("code"),ym=s("inv_column_ranks"),km=s(" and "),Zl=o("code"),jm=s("numeric_relations"),qm=s(":"),$m=c(),yt=o("ul"),ed=o("li"),Em=s(`segment_ids: indicate whether a token belongs to the question (0) or the table (1). 0 for special tokens and
...
wordpiece.`),Hm=c(),zo=o("div"),j(Ln.$$.fragment),Um=c(),id=o("p"),Bm=s("Main method to tokenize and prepare for the model one or several sequence(s) related to a table."),Rm=c(),va=o("div"),j(Qn.$$.fragment),Gm=c(),In=o("p"),Km=s("Converts logits of "),ci=o("a"),Vm=s("TapasForQuestionAnswering"),Ym=s(` to actual predicted answer coordinates and optional
...
cross-attention is added between the self-attention layers, following the architecture described in `),Xn=o("a"),vf=s(`Attention is
all you need`),bf=s(` by Ashish Vaswani, Noam Shazeer, Niki Parmar, Jakob Uszkoreit,
Llion Jones, Aidan N. Gomez, Lukasz Kaiser and Illia Polosukhin.`),wf=c(),qs=o("div"),j(Zn.$$.fragment),yf=c(),Xa=o("p"),kf=s("The "),fi=o("a"),jf=s("TapasModel"),qf=s(" forward method, overrides the "),pd=o("code"),$f=s("__call__"),Ef=s(" special method."),Ff=c(),j(Po.$$.fragment),Af=c(),j(Mo.$$.fragment),Ep=c(),Za=o("h2"),So=o("a"),cd=o("span"),j(er.$$.fragment),xf=c(),hd=o("span"),zf=s("TapasForMaskedLM"),Fp=c(),Ts=o("div"),j(tr.$$.fragment),Cf=c(),eo=o("p"),Pf=s("Tapas Model with a "),ud=o("code"),Mf=s("language modeling"),Sf=s(` head on top.
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Wf=c(),$s=o("div"),j(or.$$.fragment),Hf=c(),to=o("p"),Uf=s("The "),_i=o("a"),Bf=s("TapasForMaskedLM"),Rf=s(" forward method, overrides the "),md=o("code"),Gf=s("__call__"),Kf=s(" special method."),Vf=c(),j(Do.$$.fragment),Yf=c(),j(Oo.$$.fragment),Ap=c(),so=o("h2"),No=o("a"),fd=o("span"),j(nr.$$.fragment),Jf=c(),gd=o("span"),Xf=s("TapasForSequenceClassification"),xp=c(),Xt=o("div"),j(rr.$$.fragment),Zf=c(),_d=o("p"),eg=s(`Tapas Model with a sequence classification head on top (a linear layer on top of the pooled output), e.g. for table
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),dg=c(),Es=o("div"),j(pr.$$.fragment),pg=c(),ao=o("p"),cg=s("The "),vi=o("a"),hg=s("TapasForSequenceClassification"),ug=s(" forward method, overrides the "),Td=o("code"),mg=s("__call__"),fg=s(" special method."),gg=c(),j(Lo.$$.fragment),_g=c(),j(Qo.$$.fragment),zp=c(),oo=o("h2"),Io=o("a"),vd=o("span"),j(cr.$$.fragment),Tg=c(),bd=o("span"),vg=s("TapasForQuestionAnswering"),Cp=c(),Zt=o("div"),j(hr.$$.fragment),bg=c(),no=o("p"),wg=s(`Tapas Model with a cell selection head and optional aggregation head on top for question-answering tasks on tables
(linear layers on top of the hidden-states output to compute `),wd=o("code"),yg=s("logits"),kg=s(" and optional "),yd=o("code"),jg=s("logits_aggregation"),qg=s(`), e.g. for
SQA, WTQ or WikiSQL-supervised tasks.`),$g=c(),ur=o("p"),Eg=s("This model inherits from "),bi=o("a"),Fg=s("PreTrainedModel"),Ag=s(`. Check the superclass documentation for the generic methods the
library implements for all its models (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),xg=c(),mr=o("p"),zg=s("This model is also a PyTorch "),fr=o("a"),Cg=s("torch.nn.Module"),Pg=s(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Mg=c(),Fs=o("div"),j(gr.$$.fragment),Sg=c(),ro=o("p"),Dg=s("The "),wi=o("a"),Og=s("TapasForQuestionAnswering"),Ng=s(" forward method, overrides the "),kd=o("code"),Lg=s("__call__"),Qg=s(" special method."),Ig=c(),j(Wo.$$.fragment),Wg=c(),j(Ho.$$.fragment),Pp=c(),io=o("h2"),Uo=o("a"),jd=o("span"),j(_r.$$.fragment),Hg=c(),qd=o("span"),Ug=s("TFTapasModel"),Mp=c(),jt=o("div"),j(Tr.$$.fragment),Bg=c(),$d=o("p"),Rg=s("The bare Tapas Model transformer outputting raw hidden-states without any specific head on top."),Gg=c(),vr=o("p"),Kg=s("This model inherits from "),yi=o("a"),Vg=s("TFPreTrainedModel"),Yg=s(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Jg=c(),br=o("p"),Xg=s("This model is also a "),wr=o("a"),Zg=s("tf.keras.Model"),e_=s(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),t_=c(),j(Bo.$$.fragment),s_=c(),As=o("div"),j(yr.$$.fragment),a_=c(),lo=o("p"),o_=s("The "),ki=o("a"),n_=s("TFTapasModel"),r_=s(" forward method, overrides the "),Ed=o("code"),i_=s("__call__"),l_=s(" special method."),d_=c(),j(Ro.$$.fragment),p_=c(),j(Go.$$.fragment),Sp=c(),po=o("h2"),Ko=o("a"),Fd=o("span"),j(kr.$$.fragment),c_=c(),Ad=o("span"),h_=s("TFTapasForMaskedLM"),Dp=c(),qt=o("div"),j(jr.$$.fragment),u_=c(),qr=o("p"),m_=s("Tapas Model with a "),xd=o("code"),f_=s("language modeling"),g_=s(" head on top."),__=c(),$r=o("p"),T_=s("This model inherits from "),ji=o("a"),v_=s("TFPreTrainedModel"),b_=s(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),w_=c(),Er=o("p"),y_=s("This model is also a "),Fr=o("a"),k_=s("tf.keras.Model"),j_=s(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),q_=c(),j(Vo.$$.fragment),$_=c(),xs=o("div"),j(Ar.$$.fragment),E_=c(),co=o("p"),F_=s("The "),qi=o("a"),A_=s("TFTapasForMaskedLM"),x_=s(" forward method, overrides the "),zd=o("code"),z_=s("__call__"),C_=s(" special method."),P_=c(),j(Yo.$$.fragment),M_=c(),j(Jo.$$.fragment),Op=c(),ho=o("h2"),Xo=o("a"),Cd=o("span"),j(xr.$$.fragment),S_=c(),Pd=o("span"),D_=s("TFTapasForSequenceClassification"),Np=c(),$t=o("div"),j(zr.$$.fragment),O_=c(),Md=o("p"),N_=s(`Tapas Model with a sequence classification head on top (a linear layer on top of the pooled output), e.g. for table
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),vT=c(),j(an.$$.fragment),bT=c(),Cs=o("div"),j(Ir.$$.fragment),wT=c(),go=o("p"),yT=s("The "),Ai=o("a"),kT=s("TFTapasForQuestionAnswering"),jT=s(" forward method, overrides the "),Qd=o("code"),qT=s("__call__"),$T=s(" special method."),ET=c(),j(on.$$.fragment),FT=c(),j(nn.$$.fragment),this.h()},l(i){const _=gy('[data-svelte="svelte-1phssyn"]',document.head);l=n(_,"META",{name:!0,content:!0}),_.forEach(t),T=h(i),d=n(i,"H1",{class:!0});var Wr=r(d);g=n(Wr,"A",{id:!0,class:!0,href:!0});var Id=r(g);v=n(Id,"SPAN",{});var Wd=r(v);q(p.$$.fragment,Wd),Wd.forEach(t),Id.forEach(t),f=h(Wr),x=n(Wr,"SPAN",{});var Hd=r(x);k=a(Hd,"TAPAS"),Hd.forEach(t),Wr.forEach(t),W=h(i),O=n(i,"H2",{class:!0});var Hr=r(O);G=n(Hr,"A",{id:!0,class:!0,href:!0});var Ud=r(G);ae=n(Ud,"SPAN",{});var Bd=r(ae);q(w.$$.fragment,Bd),Bd.forEach(t),Ud.forEach(t),J=h(Hr),Z=n(Hr,"SPAN",{});var Rd=r(Z);de=a(Rd,"Overview"),Rd.forEach(t),Hr.forEach(t),U=h(i),N=n(i,"P",{});var Ur=r(N);y=a(Ur,"The TAPAS model was proposed in "),C=n(Ur,"A",{href:!0,rel:!0});var Gd=r(C);B=a(Gd,"TAPAS: Weakly Supervised Table Parsing via Pre-training"),Gd.forEach(t),ee=a(Ur,`
by Jonathan Herzig, Pawe\u0142 Krzysztof Nowak, Thomas M\xFCller, Francesco Piccinno and Julian Martin Eisenschlos. It\u2019s a BERT-based model specifically
designed (and pre-trained) for answering questions about tabular data. Compared to BERT, TAPAS uses relative position embeddings and has 7
token types that encode tabular structure. TAPAS is pre-trained on the masked language modeling (MLM) objective on a large dataset comprising
millions of tables from English Wikipedia and corresponding texts.`),Ur.forEach(t),pe=h(i),R=n(i,"P",{});var Kd=r(R);ge=a(Kd,"For question answering, TAPAS has 2 heads on top: a cell selection head and an aggregation head, for (optionally) performing aggregations (such as counting or summing) among selected cells. TAPAS has been fine-tuned on several datasets:"),Kd.forEach(t),he=h(i),X=n(i,"UL",{});var _o=r(X);_e=n(_o,"LI",{});var xi=r(_e);D=n(xi,"A",{href:!0,rel:!0});var Vd=r(D);L=a(Vd,"SQA"),Vd.forEach(t),I=a(xi," (Sequential Question Answering by Microsoft)"),xi.forEach(t),M=h(_o),K=n(_o,"LI",{});var zi=r(K);H=n(zi,"A",{href:!0,rel:!0});var Yd=r(H);we=a(Yd,"WTQ"),Yd.forEach(t),xe=a(zi," (Wiki Table Questions by Stanford University)"),zi.forEach(t),ue=h(_o),fe=n(_o,"LI",{});var Ci=r(fe);Ae=n(Ci,"A",{href:!0,rel:!0});var Jd=r(Ae);se=a(Jd,"WikiSQL"),Jd.forEach(t),ke=a(Ci," (by Salesforce)."),Ci.forEach(t),_o.forEach(t),Te=h(i),Pe=n(i,"P",{});var Xd=r(Pe);Ce=a(Xd,"It achieves state-of-the-art on both SQA and WTQ, while having comparable performance to SOTA on WikiSQL, with a much simpler architecture."),Xd.forEach(t),je=h(i),Me=n(i,"P",{});var Zd=r(Me);$e=a(Zd,"The abstract from the paper is the following:"),Zd.forEach(t),ce=h(i),Se=n(i,"P",{});var ep=r(Se);ye=n(ep,"EM",{});var tp=r(ye);Y=a(tp,"Answering natural language questions over tables is usually seen as a semantic parsing task. To alleviate the collection cost of full logical forms, one popular approach focuses on weak supervision consisting of denotations instead of logical forms. However, training semantic parsers from weak supervision poses difficulties, and in addition, the generated logical forms are only used as an intermediate step prior to retrieving the denotation. In this paper, we present TAPAS, an approach to question answering over tables without generating logical forms. TAPAS trains from weak supervision, and predicts the denotation by selecting table cells and optionally applying a corresponding aggregation operator to such selection. TAPAS extends BERT\u2019s architecture to encode tables as input, initializes from an effective joint pre-training of text segments and tables crawled from Wikipedia, and is trained end-to-end. We experiment with three different semantic parsing datasets, and find that TAPAS outperforms or rivals semantic parsing models by improving state-of-the-art accuracy on SQA from 55.1 to 67.2 and performing on par with the state-of-the-art on WIKISQL and WIKITQ, but with a simpler model architecture. We additionally find that transfer learning, which is trivial in our setting, from WIKISQL to WIKITQ, yields 48.7 accuracy, 4.2 points above the state-of-the-art."),tp.forEach(t),ep.forEach(t),qe=h(i),V=n(i,"P",{});var ca=r(V);We=a(ca,"In addition, the authors have further pre-trained TAPAS to recognize "),oe=n(ca,"STRONG",{});var sp=r(oe);He=a(sp,"table entailment"),sp.forEach(t),Ue=a(ca,", by creating a balanced dataset of millions of automatically created training examples which are learned in an intermediate step prior to fine-tuning. The authors of TAPAS call this further pre-training intermediate pre-training (since TAPAS is first pre-trained on MLM, and then on another dataset). They found that intermediate pre-training further improves performance on SQA, achieving a new state-of-the-art as well as state-of-the-art on "),b=n(ca,"A",{href:!0,rel:!0});var ap=r(b);S=a(ap,"TabFact"),ap.forEach(t),Ve=a(ca,", a large-scale dataset with 16k Wikipedia tables for table entailment (a binary classification task). For more details, see their follow-up paper: "),ve=n(ca,"A",{href:!0,rel:!0});var LT=r(ve);Ye=a(LT,"Understanding tables with intermediate pre-training"),LT.forEach(t),Je=a(ca," by Julian Martin Eisenschlos, Syrine Krichene and Thomas M\xFCller."),ca.forEach(t),Q=h(i),Le=n(i,"IMG",{src:!0,alt:!0,width:!0}),Qe=h(i),Ie=n(i,"SMALL",{});var Wp=r(Ie);Xe=a(Wp,"TAPAS architecture. Taken from the "),le=n(Wp,"A",{href:!0});var QT=r(le);Ee=a(QT,"original blog post"),QT.forEach(t),Ze=a(Wp,"."),Wp.forEach(t),ze=h(i),ne=n(i,"P",{});var rn=r(ne);et=a(rn,"This model was contributed by "),Be=n(rn,"A",{href:!0,rel:!0});var IT=r(Be);re=a(IT,"nielsr"),IT.forEach(t),Re=a(rn,". The Tensorflow version of this model was contributed by "),Fe=n(rn,"A",{href:!0,rel:!0});var WT=r(Fe);tt=a(WT,"kamalkraj"),WT.forEach(t),Pt=a(rn,". The original code can be found "),Mt=n(rn,"A",{href:!0,rel:!0});var HT=r(Mt);Ws=a(HT,"here"),HT.forEach(t),St=a(rn,"."),rn.forEach(t),vs=h(i),ts=n(i,"P",{});var UT=r(ts);Dt=a(UT,"Tips:"),UT.forEach(t),bs=h(i),ut=n(i,"UL",{});var ln=r(ut);De=n(ln,"LI",{});var as=r(De);Hs=a(as,"TAPAS is a model that uses relative position embeddings by default (restarting the position embeddings at every cell of the table). Note that this is something that was added after the publication of the original TAPAS paper. According to the authors, this usually results in a slightly better performance, and allows you to encode longer sequences without running out of embeddings. This is reflected in the "),Ot=n(as,"CODE",{});var BT=r(Ot);ie=a(BT,"reset_position_index_per_cell"),BT.forEach(t),vt=a(as," parameter of "),ss=n(as,"A",{href:!0});var RT=r(ss);Us=a(RT,"TapasConfig"),RT.forEach(t),Nt=a(as,", which is set to "),ns=n(as,"CODE",{});var GT=r(ns);Bs=a(GT,"True"),GT.forEach(t),Lt=a(as," by default. The default versions of the models available on the "),Qt=n(as,"A",{href:!0,rel:!0});var KT=r(Qt);Rs=a(KT,"hub"),KT.forEach(t),It=a(as," all use relative position embeddings. You can still use the ones with absolute position embeddings by passing in an additional argument "),rs=n(as,"CODE",{});var VT=r(rs);Gs=a(VT,'revision="no_reset"'),VT.forEach(t),Wt=a(as," when calling the "),is=n(as,"CODE",{});var YT=r(is);Ks=a(YT,"from_pretrained()"),YT.forEach(t),Ht=a(as," method. Note that it\u2019s usually advised to pad the inputs on the right rather than the left."),as.forEach(t),Vs=h(ln),st=n(ln,"LI",{});var Ps=r(st);Ut=a(Ps,"TAPAS is based on BERT, so "),ls=n(Ps,"CODE",{});var JT=r(ls);Ys=a(JT,"TAPAS-base"),JT.forEach(t),Bt=a(Ps," for example corresponds to a "),ds=n(Ps,"CODE",{});var XT=r(ds);Js=a(XT,"BERT-base"),XT.forEach(t),ps=a(Ps," architecture. Of course, "),lt=n(Ps,"CODE",{});var ZT=r(lt);cs=a(ZT,"TAPAS-large"),ZT.forEach(t),Oe=a(Ps," will result in the best performance (the results reported in the paper are from "),hs=n(Ps,"CODE",{});var ev=r(hs);bt=a(ev,"TAPAS-large"),ev.forEach(t),Xs=a(Ps,"). Results of the various sized models are shown on the "),Rt=n(Ps,"A",{href:!0,rel:!0});var tv=r(Rt);Gt=a(tv,"original Github repository"),tv.forEach(t),Zs=a(Ps,"."),Ps.forEach(t),ea=h(ln),dt=n(ln,"LI",{});var Pi=r(dt);ta=a(Pi,"TAPAS has checkpoints fine-tuned on SQA, which are capable of answering questions related to a table in a conversational set-up. This means that you can ask follow-up questions such as \u201Cwhat is his age?\u201D related to the previous question. Note that the forward pass of TAPAS is a bit different in case of a conversational set-up: in that case, you have to feed every table-question pair one by one to the model, such that the "),us=n(Pi,"CODE",{});var sv=r(us);ms=a(sv,"prev_labels"),sv.forEach(t),gt=a(Pi," token type ids can be overwritten by the predicted "),Kt=n(Pi,"CODE",{});var av=r(Kt);z=a(av,"labels"),av.forEach(t),te=a(Pi," of the model to the previous question. See \u201CUsage\u201D section for more info."),Pi.forEach(t),ka=h(ln),sa=n(ln,"LI",{});var ov=r(sa);ja=a(ov,"TAPAS is similar to BERT and therefore relies on the masked language modeling (MLM) objective. It is therefore efficient at predicting masked tokens and at NLU in general, but is not optimal for text generation. Models trained with a causal language modeling (CLM) objective are better in that regard. Note that TAPAS can be used as an encoder in the EncoderDecoderModel framework, to combine it with an autoregressive text decoder such as GPT-2."),ov.forEach(t),ln.forEach(t),ha=h(i),Vt=n(i,"H2",{class:!0});var Hp=r(Vt);_t=n(Hp,"A",{id:!0,class:!0,href:!0});var nv=r(_t);aa=n(nv,"SPAN",{});var rv=r(aa);q(wt.$$.fragment,rv),rv.forEach(t),nv.forEach(t),qa=h(Hp),oa=n(Hp,"SPAN",{});var iv=r(oa);$a=a(iv,"Usage: fine-tuning"),iv.forEach(t),Hp.forEach(t),ua=h(i),nt=n(i,"P",{});var Up=r(nt);fs=a(Up,"Here we explain how you can fine-tune "),ws=n(Up,"A",{href:!0});var lv=r(ws);pt=a(lv,"TapasForQuestionAnswering"),lv.forEach(t),Ea=a(Up," on your own dataset."),Up.forEach(t),ma=h(i),ys=n(i,"P",{});var dv=r(ys);na=n(dv,"STRONG",{});var pv=r(na);gs=a(pv,"STEP 1: Choose one of the 3 ways in which you can use TAPAS - or experiment"),pv.forEach(t),dv.forEach(t),fa=h(i),be=n(i,"P",{});var Bp=r(be);Fa=a(Bp,"Basically, there are 3 different ways in which one can fine-tune "),ks=n(Bp,"A",{href:!0});var cv=r(ks);Aa=a(cv,"TapasForQuestionAnswering"),cv.forEach(t),xa=a(Bp,", corresponding to the different datasets on which Tapas was fine-tuned:"),Bp.forEach(t),ga=h(i),At=n(i,"OL",{});var Mi=r(At);ra=n(Mi,"LI",{});var hv=r(ra);_s=a(hv,"SQA: if you\u2019re interested in asking follow-up questions related to a table, in a conversational set-up. For example if you first ask \u201Cwhat\u2019s the name of the first actor?\u201D then you can ask a follow-up question such as \u201Chow old is he?\u201C. Here, questions do not involve any aggregation (all questions are cell selection questions)."),hv.forEach(t),za=h(Mi),Ne=n(Mi,"LI",{});var Rp=r(Ne);Ca=a(Rp,"WTQ: if you\u2019re not interested in asking questions in a conversational set-up, but rather just asking questions related to a table, which might involve aggregation, such as counting a number of rows, summing up cell values or averaging cell values. You can then for example ask \u201Cwhat\u2019s the total number of goals Cristiano Ronaldo made in his career?\u201C. This case is also called "),ia=n(Rp,"STRONG",{});var uv=r(ia);Pa=a(uv,"weak supervision"),uv.forEach(t),Ma=a(Rp,", since the model itself must learn the appropriate aggregation operator (SUM/COUNT/AVERAGE/NONE) given only the answer to the question as supervision."),Rp.forEach(t),Sa=h(Mi),me=n(Mi,"LI",{});var Gp=r(me);Da=a(Gp,"WikiSQL-supervised: this dataset is based on WikiSQL with the model being given the ground truth aggregation operator during training. This is also called "),la=n(Gp,"STRONG",{});var mv=r(la);Oa=a(mv,"strong supervision"),mv.forEach(t),Na=a(Gp,". Here, learning the appropriate aggregation operator is much easier."),Gp.forEach(t),Mi.forEach(t),_a=h(i),js=n(i,"P",{});var fv=r(js);La=a(fv,"To summarize:"),fv.forEach(t),Ta=h(i),Ge=n(i,"TABLE",{});var Kp=r(Ge);da=n(Kp,"THEAD",{});var gv=r(da);Yt=n(gv,"TR",{});var Si=r(Yt);pa=n(Si,"TH",{});var _v=r(pa);el=n(_v,"STRONG",{});var Tv=r(el);Sc=a(Tv,"Task"),Tv.forEach(t),_v.forEach(t),Dc=h(Si),tl=n(Si,"TH",{});var vv=r(tl);sl=n(vv,"STRONG",{});var bv=r(sl);Oc=a(bv,"Example dataset"),bv.forEach(t),vv.forEach(t),Nc=h(Si),al=n(Si,"TH",{});var wv=r(al);ol=n(wv,"STRONG",{});var yv=r(ol);Lc=a(yv,"Description"),yv.forEach(t),wv.forEach(t),Si.forEach(t),gv.forEach(t),Qc=h(Kp),Qa=n(Kp,"TBODY",{});var Di=r(Qa);Ia=n(Di,"TR",{});var Oi=r(Ia);nl=n(Oi,"TD",{});var kv=r(nl);Ic=a(kv,"Conversational"),kv.forEach(t),Wc=h(Oi),rl=n(Oi,"TD",{});var jv=r(rl);Hc=a(jv,"SQA"),jv.forEach(t),Uc=h(Oi),il=n(Oi,"TD",{});var qv=r(il);Bc=a(qv,"Conversational, only cell selection questions"),qv.forEach(t),Oi.forEach(t),Rc=h(Di),Wa=n(Di,"TR",{});var Ni=r(Wa);ll=n(Ni,"TD",{});var $v=r(ll);Gc=a($v,"Weak supervision for aggregation"),$v.forEach(t),Kc=h(Ni),dl=n(Ni,"TD",{});var Ev=r(dl);Vc=a(Ev,"WTQ"),Ev.forEach(t),Yc=h(Ni),pl=n(Ni,"TD",{});var Fv=r(pl);Jc=a(Fv,"Questions might involve aggregation, and the model must learn this given only the answer as supervision"),Fv.forEach(t),Ni.forEach(t),Xc=h(Di),Ha=n(Di,"TR",{});var Li=r(Ha);cl=n(Li,"TD",{});var Av=r(cl);Zc=a(Av,"Strong supervision for aggregation"),Av.forEach(t),eh=h(Li),hl=n(Li,"TD",{});var xv=r(hl);th=a(xv,"WikiSQL-supervised"),xv.forEach(t),sh=h(Li),ul=n(Li,"TD",{});var zv=r(ul);ah=a(zv,"Questions might involve aggregation, and the model must learn this given the gold aggregation operator"),zv.forEach(t),Li.forEach(t),Di.forEach(t),Kp.forEach(t),op=h(i),q(vo.$$.fragment,i),np=h(i),bo=n(i,"P",{});var Vp=r(bo);oh=a(Vp,"What you can also do is start from an already fine-tuned checkpoint. A note here is that the already fine-tuned checkpoint on WTQ has some issues due to the L2-loss which is somewhat brittle. See "),vn=n(Vp,"A",{href:!0,rel:!0});var Cv=r(vn);nh=a(Cv,"here"),Cv.forEach(t),rh=a(Vp," for more info."),Vp.forEach(t),rp=h(i),wo=n(i,"P",{});var Yp=r(wo);ih=a(Yp,"For a list of all pre-trained and fine-tuned TAPAS checkpoints available on HuggingFace\u2019s  hub, see "),bn=n(Yp,"A",{href:!0,rel:!0});var Pv=r(bn);lh=a(Pv,"here"),Pv.forEach(t),dh=a(Yp,"."),Yp.forEach(t),ip=h(i),Br=n(i,"P",{});var Mv=r(Br);ml=n(Mv,"STRONG",{});var Sv=r(ml);ph=a(Sv,"STEP 2: Prepare your data in the SQA format"),Sv.forEach(t),Mv.forEach(t),lp=h(i),yo=n(i,"P",{});var Jp=r(yo);ch=a(Jp,"Second, no matter what you picked above, you should prepare your dataset in the "),wn=n(Jp,"A",{href:!0,rel:!0});var Dv=r(wn);hh=a(Dv,"SQA"),Dv.forEach(t),uh=a(Jp," format. This format is a TSV/CSV file with the following columns:"),Jp.forEach(t),dp=h(i),rt=n(i,"UL",{});var Tt=r(rt);Rr=n(Tt,"LI",{});var AT=r(Rr);fl=n(AT,"CODE",{});var Ov=r(fl);mh=a(Ov,"id"),Ov.forEach(t),fh=a(AT,": optional, id of the table-question pair, for bookkeeping purposes."),AT.forEach(t),gh=h(Tt),Gr=n(Tt,"LI",{});var xT=r(Gr);gl=n(xT,"CODE",{});var Nv=r(gl);_h=a(Nv,"annotator"),Nv.forEach(t),Th=a(xT,": optional, id of the person who annotated the table-question pair, for bookkeeping purposes."),xT.forEach(t),vh=h(Tt),Kr=n(Tt,"LI",{});var zT=r(Kr);_l=n(zT,"CODE",{});var Lv=r(_l);bh=a(Lv,"position"),Lv.forEach(t),wh=a(zT,": integer indicating if the question is the first, second, third,\u2026 related to the table. Only required in case of conversational setup (SQA). You don\u2019t need this column in case you\u2019re going for WTQ/WikiSQL-supervised."),zT.forEach(t),yh=h(Tt),Vr=n(Tt,"LI",{});var CT=r(Vr);Tl=n(CT,"CODE",{});var Qv=r(Tl);kh=a(Qv,"question"),Qv.forEach(t),jh=a(CT,": string"),CT.forEach(t),qh=h(Tt),Yr=n(Tt,"LI",{});var PT=r(Yr);vl=n(PT,"CODE",{});var Iv=r(vl);$h=a(Iv,"table_file"),Iv.forEach(t),Eh=a(PT,": string, name of a csv file containing the tabular data"),PT.forEach(t),Fh=h(Tt),Jr=n(Tt,"LI",{});var MT=r(Jr);bl=n(MT,"CODE",{});var Wv=r(bl);Ah=a(Wv,"answer_coordinates"),Wv.forEach(t),xh=a(MT,": list of one or more tuples (each tuple being a cell coordinate, i.e. row, column pair that is part of the answer)"),MT.forEach(t),zh=h(Tt),Xr=n(Tt,"LI",{});var ST=r(Xr);wl=n(ST,"CODE",{});var Hv=r(wl);Ch=a(Hv,"answer_text"),Hv.forEach(t),Ph=a(ST,": list of one or more strings (each string being a cell value that is part of the answer)"),ST.forEach(t),Mh=h(Tt),Zr=n(Tt,"LI",{});var DT=r(Zr);yl=n(DT,"CODE",{});var Uv=r(yl);Sh=a(Uv,"aggregation_label"),Uv.forEach(t),Dh=a(DT,": index of the aggregation operator. Only required in case of strong supervision for aggregation (the WikiSQL-supervised case)"),DT.forEach(t),Oh=h(Tt),ei=n(Tt,"LI",{});var OT=r(ei);kl=n(OT,"CODE",{});var Bv=r(kl);Nh=a(Bv,"float_answer"),Bv.forEach(t),Lh=a(OT,": the float answer to the question, if there is one (np.nan if there isn\u2019t). Only required in case of weak supervision for aggregation (such as WTQ and WikiSQL)"),OT.forEach(t),Tt.forEach(t),pp=h(i),xt=n(i,"P",{});var Ms=r(xt);Qh=a(Ms,"The tables themselves should be present in a folder, each table being a separate csv file. Note that the authors of the TAPAS algorithm used conversion scripts with some automated logic to convert the other datasets (WTQ, WikiSQL) into the SQA format. The author explains this "),yn=n(Ms,"A",{href:!0,rel:!0});var Rv=r(yn);Ih=a(Rv,"here"),Rv.forEach(t),Wh=a(Ms,". A conversion of this script that works with HuggingFace\u2019s implementation can be found "),kn=n(Ms,"A",{href:!0,rel:!0});var Gv=r(kn);Hh=a(Gv,"here"),Gv.forEach(t),Uh=a(Ms,". Interestingly, these conversion scripts are not perfect (the "),jl=n(Ms,"CODE",{});var Kv=r(jl);Bh=a(Kv,"answer_coordinates"),Kv.forEach(t),Rh=a(Ms," and "),ql=n(Ms,"CODE",{});var Vv=r(ql);Gh=a(Vv,"float_answer"),Vv.forEach(t),Kh=a(Ms," fields are populated based on the "),$l=n(Ms,"CODE",{});var Yv=r($l);Vh=a(Yv,"answer_text"),Yv.forEach(t),Yh=a(Ms,"), meaning that WTQ and WikiSQL results could actually be improved."),Ms.forEach(t),cp=h(i),ti=n(i,"P",{});var Jv=r(ti);El=n(Jv,"STRONG",{});var Xv=r(El);Jh=a(Xv,"STEP 3: Convert your data into tensors using TapasTokenizer"),Xv.forEach(t),Jv.forEach(t),hp=h(i),q(ko.$$.fragment,i),up=h(i),Ke=n(i,"P",{});var mt=r(Ke);Xh=a(mt,"Note that here, we encode each table-question pair independently. This is fine as long as your dataset is "),Fl=n(mt,"STRONG",{});var Zv=r(Fl);Zh=a(Zv,"not conversational"),Zv.forEach(t),eu=a(mt,". In case your dataset involves conversational questions (such as in SQA), then you should first group together the "),Al=n(mt,"CODE",{});var eb=r(Al);tu=a(eb,"queries"),eb.forEach(t),su=a(mt,", "),xl=n(mt,"CODE",{});var tb=r(xl);au=a(tb,"answer_coordinates"),tb.forEach(t),ou=a(mt," and "),zl=n(mt,"CODE",{});var sb=r(zl);nu=a(sb,"answer_text"),sb.forEach(t),ru=a(mt," per table (in the order of their "),Cl=n(mt,"CODE",{});var ab=r(Cl);iu=a(ab,"position"),ab.forEach(t),lu=a(mt,`
index) and batch encode each table with its questions. This will make sure that the `),Pl=n(mt,"CODE",{});var ob=r(Pl);du=a(ob,"prev_labels"),ob.forEach(t),pu=a(mt," token types (see docs of "),si=n(mt,"A",{href:!0});var nb=r(si);cu=a(nb,"TapasTokenizer"),nb.forEach(t),hu=a(mt,") are set correctly. See "),jn=n(mt,"A",{href:!0,rel:!0});var rb=r(jn);uu=a(rb,"this notebook"),rb.forEach(t),mu=a(mt," for more info. See "),qn=n(mt,"A",{href:!0,rel:!0});var ib=r(qn);fu=a(ib,"this notebook"),ib.forEach(t),gu=a(mt," for more info regarding using the TensorFlow model."),mt.forEach(t),mp=h(i),ai=n(i,"P",{});var lb=r(ai);_u=a(lb,"**STEP 4: Train (fine-tune) the model"),lb.forEach(t),fp=h(i),q(jo.$$.fragment,i),gp=h(i),Ua=n(i,"H2",{class:!0});var Xp=r(Ua);qo=n(Xp,"A",{id:!0,class:!0,href:!0});var db=r(qo);Ml=n(db,"SPAN",{});var pb=r(Ml);q($n.$$.fragment,pb),pb.forEach(t),db.forEach(t),Tu=h(Xp),Sl=n(Xp,"SPAN",{});var cb=r(Sl);vu=a(cb,"Usage: inference"),cb.forEach(t),Xp.forEach(t),_p=h(i),q($o.$$.fragment,i),Tp=h(i),zt=n(i,"P",{});var Ss=r(zt);bu=a(Ss,"In case of a conversational set-up, then each table-question pair must be provided "),Dl=n(Ss,"STRONG",{});var hb=r(Dl);wu=a(hb,"sequentially"),hb.forEach(t),yu=a(Ss," to the model, such that the "),Ol=n(Ss,"CODE",{});var ub=r(Ol);ku=a(ub,"prev_labels"),ub.forEach(t),ju=a(Ss," token types can be overwritten by the predicted "),Nl=n(Ss,"CODE",{});var mb=r(Nl);qu=a(mb,"labels"),mb.forEach(t),$u=a(Ss," of the previous table-question pair. Again, more info can be found in "),En=n(Ss,"A",{href:!0,rel:!0});var fb=r(En);Eu=a(fb,"this notebook"),fb.forEach(t),Fu=a(Ss," (for PyTorch) and "),Fn=n(Ss,"A",{href:!0,rel:!0});var gb=r(Fn);Au=a(gb,"this notebook"),gb.forEach(t),xu=a(Ss," (for TensorFlow)."),Ss.forEach(t),vp=h(i),Ba=n(i,"H2",{class:!0});var Zp=r(Ba);Eo=n(Zp,"A",{id:!0,class:!0,href:!0});var _b=r(Eo);Ll=n(_b,"SPAN",{});var Tb=r(Ll);q(An.$$.fragment,Tb),Tb.forEach(t),_b.forEach(t),zu=h(Zp),Ql=n(Zp,"SPAN",{});var vb=r(Ql);Cu=a(vb,"TAPAS specific outputs"),vb.forEach(t),Zp.forEach(t),bp=h(i),Ra=n(i,"DIV",{class:!0});var ec=r(Ra);q(xn.$$.fragment,ec),Pu=h(ec),zn=n(ec,"P",{});var tc=r(zn);Mu=a(tc,"Output type of "),oi=n(tc,"A",{href:!0});var bb=r(oi);Su=a(bb,"TapasForQuestionAnswering"),bb.forEach(t),Du=a(tc,"."),tc.forEach(t),ec.forEach(t),wp=h(i),Ga=n(i,"H2",{class:!0});var sc=r(Ga);Fo=n(sc,"A",{id:!0,class:!0,href:!0});var wb=r(Fo);Il=n(wb,"SPAN",{});var yb=r(Il);q(Cn.$$.fragment,yb),yb.forEach(t),wb.forEach(t),Ou=h(sc),Wl=n(sc,"SPAN",{});var kb=r(Wl);Nu=a(kb,"TapasConfig"),kb.forEach(t),sc.forEach(t),yp=h(i),Jt=n(i,"DIV",{class:!0});var ba=r(Jt);q(Pn.$$.fragment,ba),Lu=h(ba),Ka=n(ba,"P",{});var Qi=r(Ka);Qu=a(Qi,"This is the configuration class to store the configuration of a "),ni=n(Qi,"A",{href:!0});var jb=r(ni);Iu=a(jb,"TapasModel"),jb.forEach(t),Wu=a(Qi,`. It is used to instantiate a TAPAS
model according to the specified arguments, defining the model architecture. Instantiating a configuration with the
defaults will yield a similar configuration to that of the TAPAS
`),Mn=n(Qi,"A",{href:!0,rel:!0});var qb=r(Mn);Hu=a(qb,"google/tapas-base-finetuned-sqa"),qb.forEach(t),Uu=a(Qi," architecture."),Qi.forEach(t),Bu=h(ba),Va=n(ba,"P",{});var Ii=r(Va);Ru=a(Ii,"Configuration objects inherit from "),Hl=n(Ii,"CODE",{});var $b=r(Hl);Gu=a($b,"PreTrainedConfig"),$b.forEach(t),Ku=a(Ii,` and can be used to control the model outputs. Read the
documentation from `),ri=n(Ii,"A",{href:!0});var Eb=r(ri);Vu=a(Eb,"PretrainedConfig"),Eb.forEach(t),Yu=a(Ii," for more information."),Ii.forEach(t),Ju=h(ba),Sn=n(ba,"P",{});var ac=r(Sn);Xu=a(ac,`Hyperparameters additional to BERT are taken from run_task_main.py and hparam_utils.py of the original
implementation. Original implementation available at `),Dn=n(ac,"A",{href:!0,rel:!0});var Fb=r(Dn);Zu=a(Fb,"https://github.com/google-research/tapas/tree/master"),Fb.forEach(t),em=a(ac,"."),ac.forEach(t),tm=h(ba),q(Ao.$$.fragment,ba),ba.forEach(t),kp=h(i),Ya=n(i,"H2",{class:!0});var oc=r(Ya);xo=n(oc,"A",{id:!0,class:!0,href:!0});var Ab=r(xo);Ul=n(Ab,"SPAN",{});var xb=r(Ul);q(On.$$.fragment,xb),xb.forEach(t),Ab.forEach(t),sm=h(oc),Bl=n(oc,"SPAN",{});var zb=r(Bl);am=a(zb,"TapasTokenizer"),zb.forEach(t),oc.forEach(t),jp=h(i),ct=n(i,"DIV",{class:!0});var Ct=r(ct);q(Nn.$$.fragment,Ct),om=h(Ct),Rl=n(Ct,"P",{});var Cb=r(Rl);nm=a(Cb,`Construct a TAPAS tokenizer. Based on WordPiece. Flattens a table and one or more related sentences to be used by
TAPAS models.`),Cb.forEach(t),rm=h(Ct),at=n(Ct,"P",{});var ft=r(at);im=a(ft,"This tokenizer inherits from "),ii=n(ft,"A",{href:!0});var Pb=r(ii);lm=a(Pb,"PreTrainedTokenizer"),Pb.forEach(t),dm=a(ft,` which contains most of the main methods. Users should refer to
this superclass for more information regarding those methods. `),li=n(ft,"A",{href:!0});var Mb=r(li);pm=a(Mb,"TapasTokenizer"),Mb.forEach(t),cm=a(ft,` creates several token type ids to
encode tabular structure. To be more precise, it adds 7 token type ids, in the following order: `),Gl=n(ft,"CODE",{});var Sb=r(Gl);hm=a(Sb,"segment_ids"),Sb.forEach(t),um=a(ft,`,
`),Kl=n(ft,"CODE",{});var Db=r(Kl);mm=a(Db,"column_ids"),Db.forEach(t),fm=a(ft,", "),Vl=n(ft,"CODE",{});var Ob=r(Vl);gm=a(Ob,"row_ids"),Ob.forEach(t),_m=a(ft,", "),Yl=n(ft,"CODE",{});var Nb=r(Yl);Tm=a(Nb,"prev_labels"),Nb.forEach(t),vm=a(ft,", "),Jl=n(ft,"CODE",{});var Lb=r(Jl);bm=a(Lb,"column_ranks"),Lb.forEach(t),wm=a(ft,", "),Xl=n(ft,"CODE",{});var Qb=r(Xl);ym=a(Qb,"inv_column_ranks"),Qb.forEach(t),km=a(ft," and "),Zl=n(ft,"CODE",{});var Ib=r(Zl);jm=a(Ib,"numeric_relations"),Ib.forEach(t),qm=a(ft,":"),ft.forEach(t),$m=h(Ct),yt=n(Ct,"UL",{});var os=r(yt);ed=n(os,"LI",{});var Wb=r(ed);Em=a(Wb,`segment_ids: indicate whether a token belongs to the question (0) or the table (1). 0 for special tokens and
padding.`),Wb.forEach(t),Fm=h(os),td=n(os,"LI",{});var Hb=r(td);Am=a(Hb,`column_ids: indicate to which column of the table a token belongs (starting from 1). Is 0 for all question
tokens, special tokens and padding.`),Hb.forEach(t),xm=h(os),sd=n(os,"LI",{});var Ub=r(sd);zm=a(Ub,`row_ids: indicate to which row of the table a token belongs (starting from 1). Is 0 for all question tokens,
special tokens and padding. Tokens of column headers are also 0.`),Ub.forEach(t),Cm=h(os),ad=n(os,"LI",{});var Bb=r(ad);Pm=a(Bb,`prev_labels: indicate whether a token was (part of) an answer to the previous question (1) or not (0). Useful in
a conversational setup (such as SQA).`),Bb.forEach(t),Mm=h(os),od=n(os,"LI",{});var Rb=r(od);Sm=a(Rb,`column_ranks: indicate the rank of a table token relative to a column, if applicable. For example, if you have a
column \u201Cnumber of movies\u201D with values 87, 53 and 69, then the column ranks of these tokens are 3, 1 and 2
respectively. 0 for all question tokens, special tokens and padding.`),Rb.forEach(t),Dm=h(os),nd=n(os,"LI",{});var Gb=r(nd);Om=a(Gb,`inv_column_ranks: indicate the inverse rank of a table token relative to a column, if applicable. For example, if
you have a column \u201Cnumber of movies\u201D with values 87, 53 and 69, then the inverse column ranks of these tokens are
1, 3 and 2 respectively. 0 for all question tokens, special tokens and padding.`),Gb.forEach(t),Nm=h(os),rd=n(os,"LI",{});var Kb=r(rd);Lm=a(Kb,`numeric_relations: indicate numeric relations between the question and the tokens of the table. 0 for all
question tokens, special tokens and padding.`),Kb.forEach(t),os.forEach(t),Qm=h(Ct),di=n(Ct,"P",{});var NT=r(di);pi=n(NT,"A",{href:!0});var Vb=r(pi);Im=a(Vb,"TapasTokenizer"),Vb.forEach(t),Wm=a(NT,` runs end-to-end tokenization on a table and associated sentences: punctuation splitting and
wordpiece.`),NT.forEach(t),Hm=h(Ct),zo=n(Ct,"DIV",{class:!0});var nc=r(zo);q(Ln.$$.fragment,nc),Um=h(nc),id=n(nc,"P",{});var Yb=r(id);Bm=a(Yb,"Main method to tokenize and prepare for the model one or several sequence(s) related to a table."),Yb.forEach(t),nc.forEach(t),Rm=h(Ct),va=n(Ct,"DIV",{class:!0});var Wi=r(va);q(Qn.$$.fragment,Wi),Gm=h(Wi),In=n(Wi,"P",{});var rc=r(In);Km=a(rc,"Converts logits of "),ci=n(rc,"A",{href:!0});var Jb=r(ci);Vm=a(Jb,"TapasForQuestionAnswering"),Jb.forEach(t),Ym=a(rc,` to actual predicted answer coordinates and optional
...
`),Hn=n(ic,"A",{href:!0,rel:!0});var Xb=r(Hn);Zm=a(Xb,"here"),Xb.forEach(t),ef=a(ic,"."),ic.forEach(t),Wi.forEach(t),tf=h(Ct),hi=n(Ct,"DIV",{class:!0});var Zb=r(hi);q(Un.$$.fragment,Zb),Zb.forEach(t),Ct.forEach(t),qp=h(i),Ja=n(i,"H2",{class:!0});var lc=r(Ja);Co=n(lc,"A",{id:!0,class:!0,href:!0});var ew=r(Co);ld=n(ew,"SPAN",{});var tw=r(ld);q(Bn.$$.fragment,tw),tw.forEach(t),ew.forEach(t),sf=h(lc),dd=n(lc,"SPAN",{});var sw=r(dd);af=a(sw,"TapasModel"),sw.forEach(t),lc.forEach(t),$p=h(i),kt=n(i,"DIV",{class:!0});var Ds=r(kt);q(Rn.$$.fragment,Ds),of=h(Ds),Gn=n(Ds,"P",{});var dc=r(Gn);nf=a(dc,`The bare Tapas Model transformer outputting raw hidden-states without any specific head on top.
...
library implements for all its models (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),dc.forEach(t),df=h(Ds),Kn=n(Ds,"P",{});var pc=r(Kn);pf=a(pc,"This model is also a PyTorch "),Vn=n(pc,"A",{href:!0,rel:!0});var ow=r(Vn);cf=a(ow,"torch.nn.Module"),ow.forEach(t),hf=a(pc,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
...
cross-attention is added between the self-attention layers, following the architecture described in `),Xn=n(hc,"A",{href:!0,rel:!0});var rw=r(Xn);vf=a(rw,`Attention is
all you need`),rw.forEach(t),bf=a(hc,` by Ashish Vaswani, Noam Shazeer, Niki Parmar, Jakob Uszkoreit,
Llion Jones, Aidan N. Gomez, Lukasz Kaiser and Illia Polosukhin.`),hc.forEach(t),wf=h(Ds),qs=n(Ds,"DIV",{class:!0});var dn=r(qs);q(Zn.$$.fragment,dn),yf=h(dn),Xa=n(dn,"P",{});var Hi=r(Xa);kf=a(Hi,"The "),fi=n(Hi,"A",{href:!0});var iw=r(fi);jf=a(iw,"TapasModel"),iw.forEach(t),qf=a(Hi," forward method, overrides the "),pd=n(Hi,"CODE",{});var lw=r(pd);$f=a(lw,"__call__"),lw.forEach(t),Ef=a(Hi," special method."),Hi.forEach(t),Ff=h(dn),q(Po.$$.fragment,dn),Af=h(dn),q(Mo.$$.fragment,dn),dn.forEach(t),Ds.forEach(t),Ep=h(i),Za=n(i,"H2",{class:!0});var uc=r(Za);So=n(uc,"A",{id:!0,class:!0,href:!0});var dw=r(So);cd=n(dw,"SPAN",{});var pw=r(cd);q(er.$$.fragment,pw),pw.forEach(t),dw.forEach(t),xf=h(uc),hd=n(uc,"SPAN",{});var cw=r(hd);zf=a(cw,"TapasForMaskedLM"),cw.forEach(t),uc.forEach(t),Fp=h(i),Ts=n(i,"DIV",{class:!0});var pn=r(Ts);q(tr.$$.fragment,pn),Cf=h(pn),eo=n(pn,"P",{});var Ui=r(eo);Pf=a(Ui,"Tapas Model with a "),ud=n(Ui,"CODE",{});var hw=r(ud);Mf=a(hw,"language modeling"),hw.forEach(t),Sf=a(Ui,` head on top.
This model inherits from `),gi=n(Ui,"A",{href:!0});var uw=r(gi);Df=a(uw,"PreTrainedModel"),uw.forEach(t),Of=a(Ui,`. Check the superclass documentation for the generic methods the
library implements for all its models (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Ui.forEach(t),Nf=h(pn),sr=n(pn,"P",{});var mc=r(sr);Lf=a(mc,"This model is also a PyTorch "),ar=n(mc,"A",{href:!0,rel:!0});var mw=r(ar);Qf=a(mw,"torch.nn.Module"),mw.forEach(t),If=a(mc,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),mc.forEach(t),Wf=h(pn),$s=n(pn,"DIV",{class:!0});var cn=r($s);q(or.$$.fragment,cn),Hf=h(cn),to=n(cn,"P",{});var Bi=r(to);Uf=a(Bi,"The "),_i=n(Bi,"A",{href:!0});var fw=r(_i);Bf=a(fw,"TapasForMaskedLM"),fw.forEach(t),Rf=a(Bi," forward method, overrides the "),md=n(Bi,"CODE",{});var gw=r(md);Gf=a(gw,"__call__"),gw.forEach(t),Kf=a(Bi," special method."),Bi.forEach(t),Vf=h(cn),q(Do.$$.fragment,cn),Yf=h(cn),q(Oo.$$.fragment,cn),cn.forEach(t),pn.forEach(t),Ap=h(i),so=n(i,"H2",{class:!0});var fc=r(so);No=n(fc,"A",{id:!0,class:!0,href:!0});var _w=r(No);fd=n(_w,"SPAN",{});var Tw=r(fd);q(nr.$$.fragment,Tw),Tw.forEach(t),_w.forEach(t),Jf=h(fc),gd=n(fc,"SPAN",{});var vw=r(gd);Xf=a(vw,"TapasForSequenceClassification"),vw.forEach(t),fc.forEach(t),xp=h(i),Xt=n(i,"DIV",{class:!0});var wa=r(Xt);q(rr.$$.fragment,wa),Zf=h(wa),_d=n(wa,"P",{});var bw=r(_d);eg=a(bw,`Tapas Model with a sequence classification head on top (a linear layer on top of the pooled output), e.g. for table
entailment tasks, such as TabFact (Chen et al., 2020).`),bw.forEach(t),tg=h(wa),ir=n(wa,"P",{});var gc=r(ir);sg=a(gc,"This model inherits from "),Ti=n(gc,"A",{href:!0});var ww=r(Ti);ag=a(ww,"PreTrainedModel"),ww.forEach(t),og=a(gc,`. Check the superclass documentation for the generic methods the
library implements for all its models (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),gc.forEach(t),ng=h(wa),lr=n(wa,"P",{});var _c=r(lr);rg=a(_c,"This model is also a PyTorch "),dr=n(_c,"A",{href:!0,rel:!0});var yw=r(dr);ig=a(yw,"torch.nn.Module"),yw.forEach(t),lg=a(_c,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),_c.forEach(t),dg=h(wa),Es=n(wa,"DIV",{class:!0});var hn=r(Es);q(pr.$$.fragment,hn),pg=h(hn),ao=n(hn,"P",{});var Ri=r(ao);cg=a(Ri,"The "),vi=n(Ri,"A",{href:!0});var kw=r(vi);hg=a(kw,"TapasForSequenceClassification"),kw.forEach(t),ug=a(Ri," forward method, overrides the "),Td=n(Ri,"CODE",{});var jw=r(Td);mg=a(jw,"__call__"),jw.forEach(t),fg=a(Ri," special method."),Ri.forEach(t),gg=h(hn),q(Lo.$$.fragment,hn),_g=h(hn),q(Qo.$$.fragment,hn),hn.forEach(t),wa.forEach(t),zp=h(i),oo=n(i,"H2",{class:!0});var Tc=r(oo);Io=n(Tc,"A",{id:!0,class:!0,href:!0});var qw=r(Io);vd=n(qw,"SPAN",{});var $w=r(vd);q(cr.$$.fragment,$w),$w.forEach(t),qw.forEach(t),Tg=h(Tc),bd=n(Tc,"SPAN",{});var Ew=r(bd);vg=a(Ew,"TapasForQuestionAnswering"),Ew.forEach(t),Tc.forEach(t),Cp=h(i),Zt=n(i,"DIV",{class:!0});var ya=r(Zt);q(hr.$$.fragment,ya),bg=h(ya),no=n(ya,"P",{});var Gi=r(no);wg=a(Gi,`Tapas Model with a cell selection head and optional aggregation head on top for question-answering tasks on tables
(linear layers on top of the hidden-states output to compute `),wd=n(Gi,"CODE",{});var Fw=r(wd);yg=a(Fw,"logits"),Fw.forEach(t),kg=a(Gi," and optional "),yd=n(Gi,"CODE",{});var Aw=r(yd);jg=a(Aw,"logits_aggregation"),Aw.forEach(t),qg=a(Gi,`), e.g. for
SQA, WTQ or WikiSQL-supervised tasks.`),Gi.forEach(t),$g=h(ya),ur=n(ya,"P",{});var vc=r(ur);Eg=a(vc,"This model inherits from "),bi=n(vc,"A",{href:!0});var xw=r(bi);Fg=a(xw,"PreTrainedModel"),xw.forEach(t),Ag=a(vc,`. Check the superclass documentation for the generic methods the
library implements for all its models (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),vc.forEach(t),xg=h(ya),mr=n(ya,"P",{});var bc=r(mr);zg=a(bc,"This model is also a PyTorch "),fr=n(bc,"A",{href:!0,rel:!0});var zw=r(fr);Cg=a(zw,"torch.nn.Module"),zw.forEach(t),Pg=a(bc,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),bc.forEach(t),Mg=h(ya),Fs=n(ya,"DIV",{class:!0});var un=r(Fs);q(gr.$$.fragment,un),Sg=h(un),ro=n(un,"P",{});var Ki=r(ro);Dg=a(Ki,"The "),wi=n(Ki,"A",{href:!0});var Cw=r(wi);Og=a(Cw,"TapasForQuestionAnswering"),Cw.forEach(t),Ng=a(Ki," forward method, overrides the "),kd=n(Ki,"CODE",{});var Pw=r(kd);Lg=a(Pw,"__call__"),Pw.forEach(t),Qg=a(Ki," special method."),Ki.forEach(t),Ig=h(un),q(Wo.$$.fragment,un),Wg=h(un),q(Ho.$$.fragment,un),un.forEach(t),ya.forEach(t),Pp=h(i),io=n(i,"H2",{class:!0});var wc=r(io);Uo=n(wc,"A",{id:!0,class:!0,href:!0});var Mw=r(Uo);jd=n(Mw,"SPAN",{});var Sw=r(jd);q(_r.$$.fragment,Sw),Sw.forEach(t),Mw.forEach(t),Hg=h(wc),qd=n(wc,"SPAN",{});var Dw=r(qd);Ug=a(Dw,"TFTapasModel"),Dw.forEach(t),wc.forEach(t),Mp=h(i),jt=n(i,"DIV",{class:!0});var Os=r(jt);q(Tr.$$.fragment,Os),Bg=h(Os),$d=n(Os,"P",{});var Ow=r($d);Rg=a(Ow,"The bare Tapas Model transformer outputting raw hidden-states without any specific head on top."),Ow.forEach(t),Gg=h(Os),vr=n(Os,"P",{});var yc=r(vr);Kg=a(yc,"This model inherits from "),yi=n(yc,"A",{href:!0});var Nw=r(yi);Vg=a(Nw,"TFPreTrainedModel"),Nw.forEach(t),Yg=a(yc,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),yc.forEach(t),Jg=h(Os),br=n(Os,"P",{});var kc=r(br);Xg=a(kc,"This model is also a "),wr=n(kc,"A",{href:!0,rel:!0});var Lw=r(wr);Zg=a(Lw,"tf.keras.Model"),Lw.forEach(t),e_=a(kc,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),kc.forEach(t),t_=h(Os),q(Bo.$$.fragment,Os),s_=h(Os),As=n(Os,"DIV",{class:!0});var mn=r(As);q(yr.$$.fragment,mn),a_=h(mn),lo=n(mn,"P",{});var Vi=r(lo);o_=a(Vi,"The "),ki=n(Vi,"A",{href:!0});var Qw=r(ki);n_=a(Qw,"TFTapasModel"),Qw.forEach(t),r_=a(Vi," forward method, overrides the "),Ed=n(Vi,"CODE",{});var Iw=r(Ed);i_=a(Iw,"__call__"),Iw.forEach(t),l_=a(Vi," special method."),Vi.forEach(t),d_=h(mn),q(Ro.$$.fragment,mn),p_=h(mn),q(Go.$$.fragment,mn),mn.forEach(t),Os.forEach(t),Sp=h(i),po=n(i,"H2",{class:!0});var jc=r(po);Ko=n(jc,"A",{id:!0,class:!0,href:!0});var Ww=r(Ko);Fd=n(Ww,"SPAN",{});var Hw=r(Fd);q(kr.$$.fragment,Hw),Hw.forEach(t),Ww.forEach(t),c_=h(jc),Ad=n(jc,"SPAN",{});var Uw=r(Ad);h_=a(Uw,"TFTapasForMaskedLM"),Uw.forEach(t),jc.forEach(t),Dp=h(i),qt=n(i,"DIV",{class:!0});var Ns=r(qt);q(jr.$$.fragment,Ns),u_=h(Ns),qr=n(Ns,"P",{});var qc=r(qr);m_=a(qc,"Tapas Model with a "),xd=n(qc,"CODE",{});var Bw=r(xd);f_=a(Bw,"language modeling"),Bw.forEach(t),g_=a(qc," head on top."),qc.forEach(t),__=h(Ns),$r=n(Ns,"P",{});var $c=r($r);T_=a($c,"This model inherits from "),ji=n($c,"A",{href:!0});var Rw=r(ji);v_=a(Rw,"TFPreTrainedModel"),Rw.forEach(t),b_=a($c,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),$c.forEach(t),w_=h(Ns),Er=n(Ns,"P",{});var Ec=r(Er);y_=a(Ec,"This model is also a "),Fr=n(Ec,"A",{href:!0,rel:!0});var Gw=r(Fr);k_=a(Gw,"tf.keras.Model"),Gw.forEach(t),j_=a(Ec,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Ec.forEach(t),q_=h(Ns),q(Vo.$$.fragment,Ns),$_=h(Ns),xs=n(Ns,"DIV",{class:!0});var fn=r(xs);q(Ar.$$.fragment,fn),E_=h(fn),co=n(fn,"P",{});var Yi=r(co);F_=a(Yi,"The "),qi=n(Yi,"A",{href:!0});var Kw=r(qi);A_=a(Kw,"TFTapasForMaskedLM"),Kw.forEach(t),x_=a(Yi," forward method, overrides the "),zd=n(Yi,"CODE",{});var Vw=r(zd);z_=a(Vw,"__call__"),Vw.forEach(t),C_=a(Yi," special method."),Yi.forEach(t),P_=h(fn),q(Yo.$$.fragment,fn),M_=h(fn),q(Jo.$$.fragment,fn),fn.forEach(t),Ns.forEach(t),Op=h(i),ho=n(i,"H2",{class:!0});var Fc=r(ho);Xo=n(Fc,"A",{id:!0,class:!0,href:!0});var Yw=r(Xo);Cd=n(Yw,"SPAN",{});var Jw=r(Cd);q(xr.$$.fragment,Jw),Jw.forEach(t),Yw.forEach(t),S_=h(Fc),Pd=n(Fc,"SPAN",{});var Xw=r(Pd);D_=a(Xw,"TFTapasForSequenceClassification"),Xw.forEach(t),Fc.forEach(t),Np=h(i),$t=n(i,"DIV",{class:!0});var Ls=r($t);q(zr.$$.fragment,Ls),O_=h(Ls),Md=n(Ls,"P",{});var Zw=r(Md);N_=a(Zw,`Tapas Model with a sequence classification head on top (a linear layer on top of the pooled output), e.g. for table
entailment tasks, such as TabFact (Chen et al., 2020).`),Zw.forEach(t),L_=h(Ls),Cr=n(Ls,"P",{});var Ac=r(Cr);Q_=a(Ac,"This model inherits from "),$i=n(Ac,"A",{href:!0});var ey=r($i);I_=a(ey,"TFPreTrainedModel"),ey.forEach(t),W_=a(Ac,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Ac.forEach(t),H_=h(Ls),Pr=n(Ls,"P",{});var xc=r(Pr);U_=a(xc,"This model is also a "),Mr=n(xc,"A",{href:!0,rel:!0});var ty=r(Mr);B_=a(ty,"tf.keras.Model"),ty.forEach(t),R_=a(xc,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),xc.forEach(t),G_=h(Ls),q(Zo.$$.fragment,Ls),K_=h(Ls),zs=n(Ls,"DIV",{class:!0});var gn=r(zs);q(Sr.$$.fragment,gn),V_=h(gn),uo=n(gn,"P",{});var Ji=r(uo);Y_=a(Ji,"The "),Ei=n(Ji,"A",{href:!0});var sy=r(Ei);J_=a(sy,"TFTapasForSequenceClassification"),sy.forEach(t),X_=a(Ji," forward method, overrides the "),Sd=n(Ji,"CODE",{});var ay=r(Sd);Z_=a(ay,"__call__"),ay.forEach(t),eT=a(Ji," special method."),Ji.forEach(t),tT=h(gn),q(en.$$.fragment,gn),sT=h(gn),q(tn.$$.fragment,gn),gn.forEach(t),Ls.forEach(t),Lp=h(i),mo=n(i,"H2",{class:!0});var zc=r(mo);sn=n(zc,"A",{id:!0,class:!0,href:!0});var oy=r(sn);Dd=n(oy,"SPAN",{});var ny=r(Dd);q(Dr.$$.fragment,ny),ny.forEach(t),oy.forEach(t),aT=h(zc),Od=n(zc,"SPAN",{});var ry=r(Od);oT=a(ry,"TFTapasForQuestionAnswering"),ry.forEach(t),zc.forEach(t),Qp=h(i),Et=n(i,"DIV",{class:!0});var Qs=r(Et);q(Or.$$.fragment,Qs),nT=h(Qs),fo=n(Qs,"P",{});var Xi=r(fo);rT=a(Xi,`Tapas Model with a cell selection head and optional aggregation head on top for question-answering tasks on tables
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Pc.forEach(t),vT=h(Qs),q(an.$$.fragment,Qs),bT=h(Qs),Cs=n(Qs,"DIV",{class:!0});var _n=r(Cs);q(Ir.$$.fragment,_n),wT=h(_n),go=n(_n,"P",{});var Zi=r(go);yT=a(Zi,"The "),Ai=n(Zi,"A",{href:!0});var cy=r(Ai);kT=a(cy,"TFTapasForQuestionAnswering"),cy.forEach(t),jT=a(Zi," forward method, overrides the "),Qd=n(Zi,"CODE",{});var hy=r(Qd);qT=a(hy,"__call__"),hy.forEach(t),$T=a(Zi," special method."),Zi.forEach(t),ET=h(_n),q(on.$$.fragment,_n),FT=h(_n),q(nn.$$.fragment,_n),_n.forEach(t),Qs.forEach(t),this.h()},h(){m(l,"name","hf:doc:metadata"),m(l,"content",JSON.stringify(a2)),m(g,"id","tapas"),m(g,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),m(g,"href","#tapas"),m(d,"class","relative group"),m(G,"id","overview"),m(G,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),m(G,"href","#overview"),m(O,"class","relative group"),m(C,"href","https://www.aclweb.org/anthology/2020.acl-main.398"),m(C,"rel","nofollow"),m(D,"href","https://www.microsoft.com/en-us/download/details.aspx?id=54253"),m(D,"rel","nofollow"),m(H,"href","https://github.com/ppasupat/WikiTableQuestions"),m(H,"rel","nofollow"),m(Ae,"href","https://github.com/salesforce/WikiSQL"),m(Ae,"rel","nofollow"),m(b,"href","https://github.com/wenhuchen/Table-Fact-Checking"),m(b,"rel","nofollow"),m(ve,"href","https://www.aclweb.org/anthology/2020.findings-emnlp.27/"),m(ve,"rel","nofollow"),_y(Le.src,ot="https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/tapas_architecture.png")||m(Le,"src",ot),m(Le,"alt","drawing"),m(Le,"width","600"),m(le,"href","https://ai.googleblog.com/2020/04/using-neural-networks-to-find-answers.html"),m(Be,"href","https://huggingface.co/nielsr"),m(Be,"rel","nofollow"),m(Fe,"href","https://huggingface.co/kamalkraj"),m(Fe,"rel","nofollow"),m(Mt,"href","https://github.com/google-research/tapas"),m(Mt,"rel","nofollow"),m(ss,"href","/docs/transformers/v4.22.2/en/model_doc/tapas#transformers.TapasConfig"),m(Qt,"href","https://huggingface.co/models?search=tapas"),m(Qt,"rel","nofollow"),m(Rt,"href","https://github.com/google-research/tapas%3E"),m(Rt,"rel","nofollow"),m(_t,"id","usage-finetuning"),m(_t,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),m(_t,"href","#usage-finetuning"),m(Vt,"class","relative group"),m(ws,"href","/docs/transformers/v4.22.2/en/model_doc/tapas#transformers.TapasForQuestionAnswering"),m(ks,"href","/docs/transformers/v4.22.2/en/model_doc/tapas#transformers.TapasForQuestionAnswering"),m(vn,"href","https://github.com/google-research/tapas/issues/91#issuecomment-735719340"),m(vn,"rel","nofollow"),m(bn,"href","https://huggingface.co/models?search=tapas"),m(bn,"rel","nofollow"),m(wn,"href","https://www.microsoft.com/en-us/download/details.aspx?id=54253"),m(wn,"rel","nofollow"),m(yn,"href","https://github.com/google-research/tapas/issues/50#issuecomment-705465960"),m(yn,"rel","nofollow"),m(kn,"href","https://github.com/NielsRogge/tapas_utils"),m(kn,"rel","nofollow"),m(si,"href","/docs/transformers/v4.22.2/en/model_doc/tapas#transformers.TapasTokenizer"),m(jn,"href","https://github.com/NielsRogge/Transformers-Tutorials/blob/master/TAPAS/Fine_tuning_TapasForQuestionAnswering_on_SQA.ipynb"),m(jn,"rel","nofollow"),m(qn,"href","https://github.com/kamalkraj/Tapas-Tutorial/blob/master/TAPAS/Fine_tuning_TapasForQuestionAnswering_on_SQA.ipynb"),m(qn,"rel","nofollow"),m(qo,"id","usage-inference"),m(qo,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),m(qo,"href","#usage-inference"),m(Ua,"class","relative group"),m(En,"href","https://github.com/NielsRogge/Transformers-Tutorials/blob/master/TAPAS/Fine_tuning_TapasForQuestionAnswering_on_SQA.ipynb"),m(En,"rel","nofollow"),m(Fn,"href","https://github.com/kamalkraj/Tapas-Tutorial/blob/master/TAPAS/Fine_tuning_TapasForQuestionAnswering_on_SQA.ipynb"),m(Fn,"rel","nofollow"),m(Eo,"id","transformers.models.tapas.modeling_tapas.TableQuestionAnsweringOutput"),m(Eo,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),m(Eo,"href","#transformers.models.tapas.modeling_tapas.TableQuestionAnsweringOutput"),m(Ba,"class","relative group"),m(oi,"href","/docs/transformers/v4.22.2/en/model_doc/tapas#transformers.TapasForQuestionAnswering"),m(Ra,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),m(Fo,"id","transformers.TapasConfig"),m(Fo,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),m(Fo,"href","#transformers.TapasConfig"),m(Ga,"class","relative group"),m(ni,"href","/docs/transformers/v4.22.2/en/model_doc/tapas#transformers.TapasModel"),m(Mn,"href","https://huggingface.co/google/tapas-base-finetuned-sqa"),m(Mn,"rel","nofollow"),m(ri,"href","/docs/transformers/v4.22.2/en/main_classes/configuration#transformers.PretrainedConfig"),m(Dn,"href","https://github.com/google-research/tapas/tree/master"),m(Dn,"rel","nofollow"),m(Jt,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),m(xo,"id","transformers.TapasTokenizer"),m(xo,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),m(xo,"href","#transformers.TapasTokenizer"),m(Ya,"class","relative group"),m(ii,"href","/docs/transformers/v4.22.2/en/main_classes/tokenizer#transformers.PreTrainedTokenizer"),m(li,"href","/docs/transformers/v4.22.2/en/model_doc/tapas#transformers.TapasTokenizer"),m(pi,"href","/docs/transformers/v4.22.2/en/model_doc/tapas#transformers.TapasTokenizer"),m(zo,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),m(ci,"href","/docs/transformers/v4.22.2/en/model_doc/tapas#transformers.TapasForQuestionAnswering"),m(Hn,"href","https://github.com/google-research/tapas/blob/4908213eb4df7aa988573350278b44c4dbe3f71b/tapas/experiments/prediction_utils.py#L288"),m(Hn,"rel","nofollow"),m(va,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),m(hi,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),m(ct,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),m(Co,"id","transformers.TapasModel"),m(Co,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),m(Co,"href","#transformers.TapasModel"),m(Ja,"class","relative group"),m(ui,"href","/docs/transformers/v4.22.2/en/main_classes/model#transformers.PreTrainedModel"),m(Vn,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),m(Vn,"rel","nofollow"),m(mi,"href","/docs/transformers/v4.22.2/en/model_doc/bert#transformers.BertModel"),m(Xn,"href","https://arxiv.org/abs/1706.03762"),m(Xn,"rel","nofollow"),m(fi,"href","/docs/transformers/v4.22.2/en/model_doc/tapas#transformers.TapasModel"),m(qs,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),m(kt,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),m(So,"id","transformers.TapasForMaskedLM"),m(So,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),m(So,"href","#transformers.TapasForMaskedLM"),m(Za,"class","relative group"),m(gi,"href","/docs/transformers/v4.22.2/en/main_classes/model#transformers.PreTrainedModel"),m(ar,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),m(ar,"rel","nofollow"),m(_i,"href","/docs/transformers/v4.22.2/en/model_doc/tapas#transformers.TapasForMaskedLM"),m($s,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),m(Ts,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),m(No,"id","transformers.TapasForSequenceClassification"),m(No,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),m(No,"href","#transformers.TapasForSequenceClassification"),m(so,"class","relative group"),m(Ti,"href","/docs/transformers/v4.22.2/en/main_classes/model#transformers.PreTrainedModel"),m(dr,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),m(dr,"rel","nofollow"),m(vi,"href","/docs/transformers/v4.22.2/en/model_doc/tapas#transformers.TapasForSequenceClassification"),m(Es,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),m(Xt,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),m(Io,"id","transformers.TapasForQuestionAnswering"),m(Io,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),m(Io,"href","#transformers.TapasForQuestionAnswering"),m(oo,"class","relative group"),m(bi,"href","/docs/transformers/v4.22.2/en/main_classes/model#transformers.PreTrainedModel"),m(fr,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),m(fr,"rel","nofollow"),m(wi,"href","/docs/transformers/v4.22.2/en/model_doc/tapas#transformers.TapasForQuestionAnswering"),m(Fs,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),m(Zt,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),m(Uo,"id","transformers.TFTapasModel"),m(Uo,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),m(Uo,"href","#transformers.TFTapasModel"),m(io,"class","relative group"),m(yi,"href","/docs/transformers/v4.22.2/en/main_classes/model#transformers.TFPreTrainedModel"),m(wr,"href","https://www.tensorflow.org/api_docs/python/tf/keras/Model"),m(wr,"rel","nofollow"),m(ki,"href","/docs/transformers/v4.22.2/en/model_doc/tapas#transformers.TFTapasModel"),m(As,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),m(jt,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),m(Ko,"id","transformers.TFTapasForMaskedLM"),m(Ko,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),m(Ko,"href","#transformers.TFTapasForMaskedLM"),m(po,"class","relative group"),m(ji,"href","/docs/transformers/v4.22.2/en/main_classes/model#transformers.TFPreTrainedModel"),m(Fr,"href","https://www.tensorflow.org/api_docs/python/tf/keras/Model"),m(Fr,"rel","nofollow"),m(qi,"href","/docs/transformers/v4.22.2/en/model_doc/tapas#transformers.TFTapasForMaskedLM"),m(xs,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),m(qt,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),m(Xo,"id","transformers.TFTapasForSequenceClassification"),m(Xo,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),m(Xo,"href","#transformers.TFTapasForSequenceClassification"),m(ho,"class","relative group"),m($i,"href","/docs/transformers/v4.22.2/en/main_classes/model#transformers.TFPreTrainedModel"),m(Mr,"href","https://www.tensorflow.org/api_docs/python/tf/keras/Model"),m(Mr,"rel","nofollow"),m(Ei,"href","/docs/transformers/v4.22.2/en/model_doc/tapas#transformers.TFTapasForSequenceClassification"),m(zs,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),m($t,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),m(sn,"id","transformers.TFTapasForQuestionAnswering"),m(sn,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),m(sn,"href","#transformers.TFTapasForQuestionAnswering"),m(mo,"class","relative group"),m(Fi,"href","/docs/transformers/v4.22.2/en/main_classes/model#transformers.TFPreTrainedModel"),m(Qr,"href","https://www.tensorflow.org/api_docs/python/tf/keras/Model"),m(Qr,"rel","nofollow"),m(Ai,"href","/docs/transformers/v4.22.2/en/model_doc/tapas#transformers.TFTapasForQuestionAnswering"),m(Cs,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),m(Et,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8")},m(i,_){e(document.head,l),u(i,T,_),u(i,d,_),e(d,g),e(g,v),$(p,v,null),e(d,f),e(d,x),e(x,k),u(i,W,_),u(i,O,_),e(O,G),e(G,ae),$(w,ae,null),e(O,J),e(O,Z),e(Z,de),u(i,U,_),u(i,N,_),e(N,y),e(N,C),e(C,B),e(N,ee),u(i,pe,_),u(i,R,_),e(R,ge),u(i,he,_),u(i,X,_),e(X,_e),e(_e,D),e(D,L),e(_e,I),e(X,M),e(X,K),e(K,H),e(H,we),e(K,xe),e(X,ue),e(X,fe),e(fe,Ae),e(Ae,se),e(fe,ke),u(i,Te,_),u(i,Pe,_),e(Pe,Ce),u(i,je,_),u(i,Me,_),e(Me,$e),u(i,ce,_),u(i,Se,_),e(Se,ye),e(ye,Y),u(i,qe,_),u(i,V,_),e(V,We),e(V,oe),e(oe,He),e(V,Ue),e(V,b),e(b,S),e(V,Ve),e(V,ve),e(ve,Ye),e(V,Je),u(i,Q,_),u(i,Le,_),u(i,Qe,_),u(i,Ie,_),e(Ie,Xe),e(Ie,le),e(le,Ee),e(Ie,Ze),u(i,ze,_),u(i,ne,_),e(ne,et),e(ne,Be),e(Be,re),e(ne,Re),e(ne,Fe),e(Fe,tt),e(ne,Pt),e(ne,Mt),e(Mt,Ws),e(ne,St),u(i,vs,_),u(i,ts,_),e(ts,Dt),u(i,bs,_),u(i,ut,_),e(ut,De),e(De,Hs),e(De,Ot),e(Ot,ie),e(De,vt),e(De,ss),e(ss,Us),e(De,Nt),e(De,ns),e(ns,Bs),e(De,Lt),e(De,Qt),e(Qt,Rs),e(De,It),e(De,rs),e(rs,Gs),e(De,Wt),e(De,is),e(is,Ks),e(De,Ht),e(ut,Vs),e(ut,st),e(st,Ut),e(st,ls),e(ls,Ys),e(st,Bt),e(st,ds),e(ds,Js),e(st,ps),e(st,lt),e(lt,cs),e(st,Oe),e(st,hs),e(hs,bt),e(st,Xs),e(st,Rt),e(Rt,Gt),e(st,Zs),e(ut,ea),e(ut,dt),e(dt,ta),e(dt,us),e(us,ms),e(dt,gt),e(dt,Kt),e(Kt,z),e(dt,te),e(ut,ka),e(ut,sa),e(sa,ja),u(i,ha,_),u(i,Vt,_),e(Vt,_t),e(_t,aa),$(wt,aa,null),e(Vt,qa),e(Vt,oa),e(oa,$a),u(i,ua,_),u(i,nt,_),e(nt,fs),e(nt,ws),e(ws,pt),e(nt,Ea),u(i,ma,_),u(i,ys,_),e(ys,na),e(na,gs),u(i,fa,_),u(i,be,_),e(be,Fa),e(be,ks),e(ks,Aa),e(be,xa),u(i,ga,_),u(i,At,_),e(At,ra),e(ra,_s),e(At,za),e(At,Ne),e(Ne,Ca),e(Ne,ia),e(ia,Pa),e(Ne,Ma),e(At,Sa),e(At,me),e(me,Da),e(me,la),e(la,Oa),e(me,Na),u(i,_a,_),u(i,js,_),e(js,La),u(i,Ta,_),u(i,Ge,_),e(Ge,da),e(da,Yt),e(Yt,pa),e(pa,el),e(el,Sc),e(Yt,Dc),e(Yt,tl),e(tl,sl),e(sl,Oc),e(Yt,Nc),e(Yt,al),e(al,ol),e(ol,Lc),e(Ge,Qc),e(Ge,Qa),e(Qa,Ia),e(Ia,nl),e(nl,Ic),e(Ia,Wc),e(Ia,rl),e(rl,Hc),e(Ia,Uc),e(Ia,il),e(il,Bc),e(Qa,Rc),e(Qa,Wa),e(Wa,ll),e(ll,Gc),e(Wa,Kc),e(Wa,dl),e(dl,Vc),e(Wa,Yc),e(Wa,pl),e(pl,Jc),e(Qa,Xc),e(Qa,Ha),e(Ha,cl),e(cl,Zc),e(Ha,eh),e(Ha,hl),e(hl,th),e(Ha,sh),e(Ha,ul),e(ul,ah),u(i,op,_),$(vo,i,_),u(i,np,_),u(i,bo,_),e(bo,oh),e(bo,vn),e(vn,nh),e(bo,rh),u(i,rp,_),u(i,wo,_),e(wo,ih),e(wo,bn),e(bn,lh),e(wo,dh),u(i,ip,_),u(i,Br,_),e(Br,ml),e(ml,ph),u(i,lp,_),u(i,yo,_),e(yo,ch),e(yo,wn),e(wn,hh),e(yo,uh),u(i,dp,_),u(i,rt,_),e(rt,Rr),e(Rr,fl),e(fl,mh),e(Rr,fh),e(rt,gh),e(rt,Gr),e(Gr,gl),e(gl,_h),e(Gr,Th),e(rt,vh),e(rt,Kr),e(Kr,_l),e(_l,bh),e(Kr,wh),e(rt,yh),e(rt,Vr),e(Vr,Tl),e(Tl,kh),e(Vr,jh),e(rt,qh),e(rt,Yr),e(Yr,vl),e(vl,$h),e(Yr,Eh),e(rt,Fh),e(rt,Jr),e(Jr,bl),e(bl,Ah),e(Jr,xh),e(rt,zh),e(rt,Xr),e(Xr,wl),e(wl,Ch),e(Xr,Ph),e(rt,Mh),e(rt,Zr),e(Zr,yl),e(yl,Sh),e(Zr,Dh),e(rt,Oh),e(rt,ei),e(ei,kl),e(kl,Nh),e(ei,Lh),u(i,pp,_),u(i,xt,_),e(xt,Qh),e(xt,yn),e(yn,Ih),e(xt,Wh),e(xt,kn),e(kn,Hh),e(xt,Uh),e(xt,jl),e(jl,Bh),e(xt,Rh),e(xt,ql),e(ql,Gh),e(xt,Kh),e(xt,$l),e($l,Vh),e(xt,Yh),u(i,cp,_),u(i,ti,_),e(ti,El),e(El,Jh),u(i,hp,_),$(ko,i,_),u(i,up,_),u(i,Ke,_),e(Ke,Xh),e(Ke,Fl),e(Fl,Zh),e(Ke,eu),e(Ke,Al),e(Al,tu),e(Ke,su),e(Ke,xl),e(xl,au),e(Ke,ou),e(Ke,zl),e(zl,nu),e(Ke,ru),e(Ke,Cl),e(Cl,iu),e(Ke,lu),e(Ke,Pl),e(Pl,du),e(Ke,pu),e(Ke,si),e(si,cu),e(Ke,hu),e(Ke,jn),e(jn,uu),e(Ke,mu),e(Ke,qn),e(qn,fu),e(Ke,gu),u(i,mp,_),u(i,ai,_),e(ai,_u),u(i,fp,_),$(jo,i,_),u(i,gp,_),u(i,Ua,_),e(Ua,qo),e(qo,Ml),$($n,Ml,null),e(Ua,Tu),e(Ua,Sl),e(Sl,vu),u(i,_p,_),$($o,i,_),u(i,Tp,_),u(i,zt,_),e(zt,bu),e(zt,Dl),e(Dl,wu),e(zt,yu),e(zt,Ol),e(Ol,ku),e(zt,ju),e(zt,Nl),e(Nl,qu),e(zt,$u),e(zt,En),e(En,Eu),e(zt,Fu),e(zt,Fn),e(Fn,Au),e(zt,xu),u(i,vp,_),u(i,Ba,_),e(Ba,Eo),e(Eo,Ll),$(An,Ll,null),e(Ba,zu),e(Ba,Ql),e(Ql,Cu),u(i,bp,_),u(i,Ra,_),$(xn,Ra,null),e(Ra,Pu),e(Ra,zn),e(zn,Mu),e(zn,oi),e(oi,Su),e(zn,Du),u(i,wp,_),u(i,Ga,_),e(Ga,Fo),e(Fo,Il),$(Cn,Il,null),e(Ga,Ou),e(Ga,Wl),e(Wl,Nu),u(i,yp,_),u(i,Jt,_),$(Pn,Jt,null),e(Jt,Lu),e(Jt,Ka),e(Ka,Qu),e(Ka,ni),e(ni,Iu),e(Ka,Wu),e(Ka,Mn),e(Mn,Hu),e(Ka,Uu),e(Jt,Bu),e(Jt,Va),e(Va,Ru),e(Va,Hl),e(Hl,Gu),e(Va,Ku),e(Va,ri),e(ri,Vu),e(Va,Yu),e(Jt,Ju),e(Jt,Sn),e(Sn,Xu),e(Sn,Dn),e(Dn,Zu),e(Sn,em),e(Jt,tm),$(Ao,Jt,null),u(i,kp,_),u(i,Ya,_),e(Ya,xo),e(xo,Ul),$(On,Ul,null),e(Ya,sm),e(Ya,Bl),e(Bl,am),u(i,jp,_),u(i,ct,_),$(Nn,ct,null),e(ct,om),e(ct,Rl),e(Rl,nm),e(ct,rm),e(ct,at),e(at,im),e(at,ii),e(ii,lm),e(at,dm),e(at,li),e(li,pm),e(at,cm),e(at,Gl),e(Gl,hm),e(at,um),e(at,Kl),e(Kl,mm),e(at,fm),e(at,Vl),e(Vl,gm),e(at,_m),e(at,Yl),e(Yl,Tm),e(at,vm),e(at,Jl),e(Jl,bm),e(at,wm),e(at,Xl),e(Xl,ym),e(at,km),e(at,Zl),e(Zl,jm),e(at,qm),e(ct,$m),e(ct,yt),e(yt,ed),e(ed,Em),e(yt,Fm),e(yt,td),e(td,Am),e(yt,xm),e(yt,sd),e(sd,zm),e(yt,Cm),e(yt,ad),e(ad,Pm),e(yt,Mm),e(yt,od),e(od,Sm),e(yt,Dm),e(yt,nd),e(nd,Om),e(yt,Nm),e(yt,rd),e(rd,Lm),e(ct,Qm),e(ct,di),e(di,pi),e(pi,Im),e(di,Wm),e(ct,Hm),e(ct,zo),$(Ln,zo,null),e(zo,Um),e(zo,id),e(id,Bm),e(ct,Rm),e(ct,va),$(Qn,va,null),e(va,Gm),e(va,In),e(In,Km),e(In,ci),e(ci,Vm),e(In,Ym),e(va,Jm),e(va,Wn),e(Wn,Xm),e(Wn,Hn),e(Hn,Zm),e(Wn,ef),e(ct,tf),e(ct,hi),$(Un,hi,null),u(i,qp,_),u(i,Ja,_),e(Ja,Co),e(Co,ld),$(Bn,ld,null),e(Ja,sf),e(Ja,dd),e(dd,af),u(i,$p,_),u(i,kt,_),$(Rn,kt,null),e(kt,of),e(kt,Gn),e(Gn,nf),e(Gn,ui),e(ui,rf),e(Gn,lf),e(kt,df),e(kt,Kn),e(Kn,pf),e(Kn,Vn),e(Vn,cf),e(Kn,hf),e(kt,uf),e(kt,Yn),e(Yn,mf),e(Yn,mi),e(mi,ff),e(Yn,gf),e(kt,_f),e(kt,Jn),e(Jn,Tf),e(Jn,Xn),e(Xn,vf),e(Jn,bf),e(kt,wf),e(kt,qs),$(Zn,qs,null),e(qs,yf),e(qs,Xa),e(Xa,kf),e(Xa,fi),e(fi,jf),e(Xa,qf),e(Xa,pd),e(pd,$f),e(Xa,Ef),e(qs,Ff),$(Po,qs,null),e(qs,Af),$(Mo,qs,null),u(i,Ep,_),u(i,Za,_),e(Za,So),e(So,cd),$(er,cd,null),e(Za,xf),e(Za,hd),e(hd,zf),u(i,Fp,_),u(i,Ts,_),$(tr,Ts,null),e(Ts,Cf),e(Ts,eo),e(eo,Pf),e(eo,ud),e(ud,Mf),e(eo,Sf),e(eo,gi),e(gi,Df),e(eo,Of),e(Ts,Nf),e(Ts,sr),e(sr,Lf),e(sr,ar),e(ar,Qf),e(sr,If),e(Ts,Wf),e(Ts,$s),$(or,$s,null),e($s,Hf),e($s,to),e(to,Uf),e(to,_i),e(_i,Bf),e(to,Rf),e(to,md),e(md,Gf),e(to,Kf),e($s,Vf),$(Do,$s,null),e($s,Yf),$(Oo,$s,null),u(i,Ap,_),u(i,so,_),e(so,No),e(No,fd),$(nr,fd,null),e(so,Jf),e(so,gd),e(gd,Xf),u(i,xp,_),u(i,Xt,_),$(rr,Xt,null),e(Xt,Zf),e(Xt,_d),e(_d,eg),e(Xt,tg),e(Xt,ir),e(ir,sg),e(ir,Ti),e(Ti,ag),e(ir,og),e(Xt,ng),e(Xt,lr),e(lr,rg),e(lr,dr),e(dr,ig),e(lr,lg),e(Xt,dg),e(Xt,Es),$(pr,Es,null),e(Es,pg),e(Es,ao),e(ao,cg),e(ao,vi),e(vi,hg),e(ao,ug),e(ao,Td),e(Td,mg),e(ao,fg),e(Es,gg),$(Lo,Es,null),e(Es,_g),$(Qo,Es,null),u(i,zp,_),u(i,oo,_),e(oo,Io),e(Io,vd),$(cr,vd,null),e(oo,Tg),e(oo,bd),e(bd,vg),u(i,Cp,_),u(i,Zt,_),$(hr,Zt,null),e(Zt,bg),e(Zt,no),e(no,wg),e(no,wd),e(wd,yg),e(no,kg),e(no,yd),e(yd,jg),e(no,qg),e(Zt,$g),e(Zt,ur),e(ur,Eg),e(ur,bi),e(bi,Fg),e(ur,Ag),e(Zt,xg),e(Zt,mr),e(mr,zg),e(mr,fr),e(fr,Cg),e(mr,Pg),e(Zt,Mg),e(Zt,Fs),$(gr,Fs,null),e(Fs,Sg),e(Fs,ro),e(ro,Dg),e(ro,wi),e(wi,Og),e(ro,Ng),e(ro,kd),e(kd,Lg),e(ro,Qg),e(Fs,Ig),$(Wo,Fs,null),e(Fs,Wg),$(Ho,Fs,null),u(i,Pp,_),u(i,io,_),e(io,Uo),e(Uo,jd),$(_r,jd,null),e(io,Hg),e(io,qd),e(qd,Ug),u(i,Mp,_),u(i,jt,_),$(Tr,jt,null),e(jt,Bg),e(jt,$d),e($d,Rg),e(jt,Gg),e(jt,vr),e(vr,Kg),e(vr,yi),e(yi,Vg),e(vr,Yg),e(jt,Jg),e(jt,br),e(br,Xg),e(br,wr),e(wr,Zg),e(br,e_),e(jt,t_),$(Bo,jt,null),e(jt,s_),e(jt,As),$(yr,As,null),e(As,a_),e(As,lo),e(lo,o_),e(lo,ki),e(ki,n_),e(lo,r_),e(lo,Ed),e(Ed,i_),e(lo,l_),e(As,d_),$(Ro,As,null),e(As,p_),$(Go,As,null),u(i,Sp,_),u(i,po,_),e(po,Ko),e(Ko,Fd),$(kr,Fd,null),e(po,c_),e(po,Ad),e(Ad,h_),u(i,Dp,_),u(i,qt,_),$(jr,qt,null),e(qt,u_),e(qt,qr),e(qr,m_),e(qr,xd),e(xd,f_),e(qr,g_),e(qt,__),e(qt,$r),e($r,T_),e($r,ji),e(ji,v_),e($r,b_),e(qt,w_),e(qt,Er),e(Er,y_),e(Er,Fr),e(Fr,k_),e(Er,j_),e(qt,q_),$(Vo,qt,null),e(qt,$_),e(qt,xs),$(Ar,xs,null),e(xs,E_),e(xs,co),e(co,F_),e(co,qi),e(qi,A_),e(co,x_),e(co,zd),e(zd,z_),e(co,C_),e(xs,P_),$(Yo,xs,null),e(xs,M_),$(Jo,xs,null),u(i,Op,_),u(i,ho,_),e(ho,Xo),e(Xo,Cd),$(xr,Cd,null),e(ho,S_),e(ho,Pd),e(Pd,D_),u(i,Np,_),u(i,$t,_),$(zr,$t,null),e($t,O_),e($t,Md),e(Md,N_),e($t,L_),e($t,Cr),e(Cr,Q_),e(Cr,$i),e($i,I_),e(Cr,W_),e($t,H_),e($t,Pr),e(Pr,U_),e(Pr,Mr),e(Mr,B_),e(Pr,R_),e($t,G_),$(Zo,$t,null),e($t,K_),e($t,zs),$(Sr,zs,null),e(zs,V_),e(zs,uo),e(uo,Y_),e(uo,Ei),e(Ei,J_),e(uo,X_),e(uo,Sd),e(Sd,Z_),e(uo,eT),e(zs,tT),$(en,zs,null),e(zs,sT),$(tn,zs,null),u(i,Lp,_),u(i,mo,_),e(mo,sn),e(sn,Dd),$(Dr,Dd,null),e(mo,aT),e(mo,Od),e(Od,oT),u(i,Qp,_),u(i,Et,_),$(Or,Et,null),e(Et,nT),e(Et,fo),e(fo,rT),e(fo,Nd),e(Nd,iT),e(fo,lT),e(fo,Ld),e(Ld,dT),e(fo,pT),e(Et,cT),e(Et,Nr),e(Nr,hT),e(Nr,Fi),e(Fi,uT),e(Nr,mT),e(Et,fT),e(Et,Lr),e(Lr,gT),e(Lr,Qr),e(Qr,_T),e(Lr,TT),e(Et,vT),$(an,Et,null),e(Et,bT),e(Et,Cs),$(Ir,Cs,null),e(Cs,wT),e(Cs,go),e(go,yT),e(go,Ai),e(Ai,kT),e(go,jT),e(go,Qd),e(Qd,qT),e(go,$T),e(Cs,ET),$(on,Cs,null),e(Cs,FT),$(nn,Cs,null),Ip=!0},p(i,[_]){const Wr={};_&2&&(Wr.$$scope={dirty:_,ctx:i}),vo.$set(Wr);const Id={};_&2&&(Id.$$scope={dirty:_,ctx:i}),ko.$set(Id);const Wd={};_&2&&(Wd.$$scope={dirty:_,ctx:i}),jo.$set(Wd);const Hd={};_&2&&(Hd.$$scope={dirty:_,ctx:i}),$o.$set(Hd);const Hr={};_&2&&(Hr.$$scope={dirty:_,ctx:i}),Ao.$set(Hr);const Ud={};_&2&&(Ud.$$scope={dirty:_,ctx:i}),Po.$set(Ud);const Bd={};_&2&&(Bd.$$scope={dirty:_,ctx:i}),Mo.$set(Bd);const Rd={};_&2&&(Rd.$$scope={dirty:_,ctx:i}),Do.$set(Rd);const Ur={};_&2&&(Ur.$$scope={dirty:_,ctx:i}),Oo.$set(Ur);const Gd={};_&2&&(Gd.$$scope={dirty:_,ctx:i}),Lo.$set(Gd);const Kd={};_&2&&(Kd.$$scope={dirty:_,ctx:i}),Qo.$set(Kd);const _o={};_&2&&(_o.$$scope={dirty:_,ctx:i}),Wo.$set(_o);const xi={};_&2&&(xi.$$scope={dirty:_,ctx:i}),Ho.$set(xi);const Vd={};_&2&&(Vd.$$scope={dirty:_,ctx:i}),Bo.$set(Vd);const zi={};_&2&&(zi.$$scope={dirty:_,ctx:i}),Ro.$set(zi);const Yd={};_&2&&(Yd.$$scope={dirty:_,ctx:i}),Go.$set(Yd);const Ci={};_&2&&(Ci.$$scope={dirty:_,ctx:i}),Vo.$set(Ci);const Jd={};_&2&&(Jd.$$scope={dirty:_,ctx:i}),Yo.$set(Jd);const Xd={};_&2&&(Xd.$$scope={dirty:_,ctx:i}),Jo.$set(Xd);const Zd={};_&2&&(Zd.$$scope={dirty:_,ctx:i}),Zo.$set(Zd);const ep={};_&2&&(ep.$$scope={dirty:_,ctx:i}),en.$set(ep);const tp={};_&2&&(tp.$$scope={dirty:_,ctx:i}),tn.$set(tp);const ca={};_&2&&(ca.$$scope={dirty:_,ctx:i}),an.$set(ca);const sp={};_&2&&(sp.$$scope={dirty:_,ctx:i}),on.$set(sp);const ap={};_&2&&(ap.$$scope={dirty:_,ctx:i}),nn.$set(ap)},i(i){Ip||(E(p.$$.fragment,i),E(w.$$.fragment,i),E(wt.$$.fragment,i),E(vo.$$.fragment,i),E(ko.$$.fragment,i),E(jo.$$.fragment,i),E($n.$$.fragment,i),E($o.$$.fragment,i),E(An.$$.fragment,i),E(xn.$$.fragment,i),E(Cn.$$.fragment,i),E(Pn.$$.fragment,i),E(Ao.$$.fragment,i),E(On.$$.fragment,i),E(Nn.$$.fragment,i),E(Ln.$$.fragment,i),E(Qn.$$.fragment,i),E(Un.$$.fragment,i),E(Bn.$$.fragment,i),E(Rn.$$.fragment,i),E(Zn.$$.fragment,i),E(Po.$$.fragment,i),E(Mo.$$.fragment,i),E(er.$$.fragment,i),E(tr.$$.fragment,i),E(or.$$.fragment,i),E(Do.$$.fragment,i),E(Oo.$$.fragment,i),E(nr.$$.fragment,i),E(rr.$$.fragment,i),E(pr.$$.fragment,i),E(Lo.$$.fragment,i),E(Qo.$$.fragment,i),E(cr.$$.fragment,i),E(hr.$$.fragment,i),E(gr.$$.fragment,i),E(Wo.$$.fragment,i),E(Ho.$$.fragment,i),E(_r.$$.fragment,i),E(Tr.$$.fragment,i),E(Bo.$$.fragment,i),E(yr.$$.fragment,i),E(Ro.$$.fragment,i),E(Go.$$.fragment,i),E(kr.$$.fragment,i),E(jr.$$.fragment,i),E(Vo.$$.fragment,i),E(Ar.$$.fragment,i),E(Yo.$$.fragment,i),E(Jo.$$.fragment,i),E(xr.$$.fragment,i),E(zr.$$.fragment,i),E(Zo.$$.fragment,i),E(Sr.$$.fragment,i),E(en.$$.fragment,i),E(tn.$$.fragment,i),E(Dr.$$.fragment,i),E(Or.$$.fragment,i),E(an.$$.fragment,i),E(Ir.$$.fragment,i),E(on.$$.fragment,i),E(nn.$$.fragment,i),Ip=!0)},o(i){F(p.$$.fragment,i),F(w.$$.fragment,i),F(wt.$$.fragment,i),F(vo.$$.fragment,i),F(ko.$$.fragment,i),F(jo.$$.fragment,i),F($n.$$.fragment,i),F($o.$$.fragment,i),F(An.$$.fragment,i),F(xn.$$.fragment,i),F(Cn.$$.fragment,i),F(Pn.$$.fragment,i),F(Ao.$$.fragment,i),F(On.$$.fragment,i),F(Nn.$$.fragment,i),F(Ln.$$.fragment,i),F(Qn.$$.fragment,i),F(Un.$$.fragment,i),F(Bn.$$.fragment,i),F(Rn.$$.fragment,i),F(Zn.$$.fragment,i),F(Po.$$.fragment,i),F(Mo.$$.fragment,i),F(er.$$.fragment,i),F(tr.$$.fragment,i),F(or.$$.fragment,i),F(Do.$$.fragment,i),F(Oo.$$.fragment,i),F(nr.$$.fragment,i),F(rr.$$.fragment,i),F(pr.$$.fragment,i),F(Lo.$$.fragment,i),F(Qo.$$.fragment,i),F(cr.$$.fragment,i),F(hr.$$.fragment,i),F(gr.$$.fragment,i),F(Wo.$$.fragment,i),F(Ho.$$.fragment,i),F(_r.$$.fragment,i),F(Tr.$$.fragment,i),F(Bo.$$.fragment,i),F(yr.$$.fragment,i),F(Ro.$$.fragment,i),F(Go.$$.fragment,i),F(kr.$$.fragment,i),F(jr.$$.fragment,i),F(Vo.$$.fragment,i),F(Ar.$$.fragment,i),F(Yo.$$.fragment,i),F(Jo.$$.fragment,i),F(xr.$$.fragment,i),F(zr.$$.fragment,i),F(Zo.$$.fragment,i),F(Sr.$$.fragment,i),F(en.$$.fragment,i),F(tn.$$.fragment,i),F(Dr.$$.fragment,i),F(Or.$$.fragment,i),F(an.$$.fragment,i),F(Ir.$$.fragment,i),F(on.$$.fragment,i),F(nn.$$.fragment,i),Ip=!1},d(i){t(l),i&&t(T),i&&t(d),A(p),i&&t(W),i&&t(O),A(w),i&&t(U),i&&t(N),i&&t(pe),i&&t(R),i&&t(he),i&&t(X),i&&t(Te),i&&t(Pe),i&&t(je),i&&t(Me),i&&t(ce),i&&t(Se),i&&t(qe),i&&t(V),i&&t(Q),i&&t(Le),i&&t(Qe),i&&t(Ie),i&&t(ze),i&&t(ne),i&&t(vs),i&&t(ts),i&&t(bs),i&&t(ut),i&&t(ha),i&&t(Vt),A(wt),i&&t(ua),i&&t(nt),i&&t(ma),i&&t(ys),i&&t(fa),i&&t(be),i&&t(ga),i&&t(At),i&&t(_a),i&&t(js),i&&t(Ta),i&&t(Ge),i&&t(op),A(vo,i),i&&t(np),i&&t(bo),i&&t(rp),i&&t(wo),i&&t(ip),i&&t(Br),i&&t(lp),i&&t(yo),i&&t(dp),i&&t(rt),i&&t(pp),i&&t(xt),i&&t(cp),i&&t(ti),i&&t(hp),A(ko,i),i&&t(up),i&&t(Ke),i&&t(mp),i&&t(ai),i&&t(fp),A(jo,i),i&&t(gp),i&&t(Ua),A($n),i&&t(_p),A($o,i),i&&t(Tp),i&&t(zt),i&&t(vp),i&&t(Ba),A(An),i&&t(bp),i&&t(Ra),A(xn),i&&t(wp),i&&t(Ga),A(Cn),i&&t(yp),i&&t(Jt),A(Pn),A(Ao),i&&t(kp),i&&t(Ya),A(On),i&&t(jp),i&&t(ct),A(Nn),A(Ln),A(Qn),A(Un),i&&t(qp),i&&t(Ja),A(Bn),i&&t($p),i&&t(kt),A(Rn),A(Zn),A(Po),A(Mo),i&&t(Ep),i&&t(Za),A(er),i&&t(Fp),i&&t(Ts),A(tr),A(or),A(Do),A(Oo),i&&t(Ap),i&&t(so),A(nr),i&&t(xp),i&&t(Xt),A(rr),A(pr),A(Lo),A(Qo),i&&t(zp),i&&t(oo),A(cr),i&&t(Cp),i&&t(Zt),A(hr),A(gr),A(Wo),A(Ho),i&&t(Pp),i&&t(io),A(_r),i&&t(Mp),i&&t(jt),A(Tr),A(Bo),A(yr),A(Ro),A(Go),i&&t(Sp),i&&t(po),A(kr),i&&t(Dp),i&&t(qt),A(jr),A(Vo),A(Ar),A(Yo),A(Jo),i&&t(Op),i&&t(ho),A(xr),i&&t(Np),i&&t($t),A(zr),A(Zo),A(Sr),A(en),A(tn),i&&t(Lp),i&&t(mo),A(Dr),i&&t(Qp),i&&t(Et),A(Or),A(an),A(Ir),A(on),A(nn)}}}const a2={local:"tapas",sections:[{local:"overview",title:"Overview"},{local:"usage-finetuning",title:"Usage: fine-tuning"},{local:"usage-inference",title:"Usage: inference"},{local:"transformers.models.tapas.modeling_tapas.TableQuestionAnsweringOutput",title:"TAPAS specific outputs"},{local:"transformers.TapasConfig",title:"TapasConfig"},{local:"transformers.TapasTokenizer",title:"TapasTokenizer"},{local:"transformers.TapasModel",title:"TapasModel"},{local:"transformers.TapasForMaskedLM",title:"TapasForMaskedLM"},{local:"transformers.TapasForSequenceClassification",title:"TapasForSequenceClassification"},{local:"transformers.TapasForQuestionAnswering",title:"TapasForQuestionAnswering"},{local:"transformers.TFTapasModel",title:"TFTapasModel"},{local:"transformers.TFTapasForMaskedLM",title:"TFTapasForMaskedLM"},{local:"transformers.TFTapasForSequenceClassification",title:"TFTapasForSequenceClassification"},{local:"transformers.TFTapasForQuestionAnswering",title:"TFTapasForQuestionAnswering"}],title:"TAPAS"};function o2(P){return Ty(()=>{new URLSearchParams(window.location.search).get("fw")}),[]}class h2 extends uy{constructor(l){super();my(this,l,o2,s2,fy,{})}}export{h2 as default,a2 as metadata};
