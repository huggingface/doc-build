...
instance of <a href="/docs/transformers/v4.22.2/en/model_doc/wav2vec2#transformers.Wav2Vec2ForCTC">Wav2Vec2ForCTC</a>.`,name:"ctc_loss_reduction"},{anchor:"transformers.Wav2Vec2Config.ctc_zero_infinity",description:`<strong>ctc_zero_infinity</strong> (<code>bool</code>, <em>optional</em>, defaults to <code>False</code>) &#x2014;
Whether to zero infinite losses and the associated gradients of <code>torch.nn.CTCLoss</code>. Infinite losses mainly
occur when the inputs are too short to be aligned to the targets. Only relevant when training an instance
of <a href="/docs/transformers/v4.22.2/en/model_doc/wav2vec2#transformers.Wav2Vec2ForCTC">Wav2Vec2ForCTC</a>.`,name:"ctc_zero_infinity"},{anchor:"transformers.Wav2Vec2Config.use_weighted_layer_sum",description:`<strong>use_weighted_layer_sum</strong> (<code>bool</code>, <em>optional</em>, defaults to <code>False</code>) &#x2014;
...
Will be passed to the underlying model specific decode method.`,name:"kwargs"}],source:"https://github.com/huggingface/transformers/blob/v4.22.2/src/transformers/models/wav2vec2/tokenization_wav2vec2.py#L490",returnDescription:`
...
Will be passed to the underlying model specific decode method.`,name:"kwargs"}],source:"https://github.com/huggingface/transformers/blob/v4.22.2/src/transformers/models/wav2vec2/tokenization_wav2vec2.py#L420",returnDescription:`
<p>The list of decoded
sentences. Will be a <code>Wav2Vec2CTCTokenizerOutput</code> when
<code>output_char_offsets == True</code> or <code>output_word_offsets == True</code>.</p>
`,returnType:`
...
Whether or not <a href="/docs/transformers/v4.22.2/en/model_doc/wav2vec2#transformers.Wav2Vec2FeatureExtractor.__call__"><strong>call</strong>()</a> should return <code>attention_mask</code>.</p>
<div class="course-tip  bg-gradient-to-br dark:bg-gradient-to-r before:border-green-500 dark:before:border-green-800 from-green-50 dark:from-gray-900 to-white dark:to-gray-950 border border-green-50 text-green-700 dark:text-gray-400">
...
be passed for batched inference.</p>
					...
					</div>`,name:"return_attention_mask"},{anchor:"transformers.Wav2Vec2FeatureExtractor.__call__.return_tensors",description:`<strong>return_tensors</strong> (<code>str</code> or <a href="/docs/transformers/v4.22.2/en/internal/file_utils#transformers.TensorType">TensorType</a>, <em>optional</em>) &#x2014;
If set, will return tensors instead of list of python integers. Acceptable values are:</p>
<ul>
<li><code>&apos;tf&apos;</code>: Return TensorFlow <code>tf.constant</code> objects.</li>
<li><code>&apos;pt&apos;</code>: Return PyTorch <code>torch.Tensor</code> objects.</li>
...
<code>sampling_rate</code> at the forward call to prevent silent errors.`,name:"sampling_rate"},{anchor:"transformers.Wav2Vec2FeatureExtractor.__call__.padding_value",description:"<strong>padding_value</strong> (<code>float</code>, defaults to 0.0) &#x2014;",name:"padding_value"}],source:"https://github.com/huggingface/transformers/blob/v4.22.2/src/transformers/models/wav2vec2/feature_extraction_wav2vec2.py#L102"}}),ys=new oe({}),ks=new F({props:{name:"class transformers.Wav2Vec2Processor",anchor:"transformers.Wav2Vec2Processor",parameters:[{name:"feature_extractor",val:""},{name:"tokenizer",val:""}],parametersDescription:[{anchor:"transformers.Wav2Vec2Processor.feature_extractor",description:`<strong>feature_extractor</strong> (<code>Wav2Vec2FeatureExtractor</code>) &#x2014;
...
An instance of <a href="/docs/transformers/v4.22.2/en/main_classes/tokenizer#transformers.PreTrainedTokenizer">PreTrainedTokenizer</a>. The tokenizer is a required input.`,name:"tokenizer"}],source:"https://github.com/huggingface/transformers/blob/v4.22.2/src/transformers/models/wav2vec2/processing_wav2vec2.py#L26"}}),$s=new F({props:{name:"__call__",anchor:"transformers.Wav2Vec2Processor.__call__",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/v4.22.2/src/transformers/models/wav2vec2/processing_wav2vec2.py#L67"}}),js=new F({props:{name:"pad",anchor:"transformers.Wav2Vec2Processor.pad",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/v4.22.2/src/transformers/models/wav2vec2/processing_wav2vec2.py#L104"}}),Vs=new F({props:{name:"from_pretrained",anchor:"transformers.Wav2Vec2Processor.from_pretrained",parameters:[{name:"pretrained_model_name_or_path",val:""},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/v4.22.2/src/transformers/models/wav2vec2/processing_wav2vec2.py#L48"}}),Fs=new F({props:{name:"save_pretrained",anchor:"transformers.Wav2Vec2Processor.save_pretrained",parameters:[{name:"save_directory",val:""},{name:"push_to_hub",val:": bool = False"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.Wav2Vec2Processor.save_pretrained.save_directory",description:`<strong>save_directory</strong> (<code>str</code> or <code>os.PathLike</code>) &#x2014;
...
<a href="/docs/transformers/v4.22.2/en/main_classes/feature_extractor#transformers.FeatureExtractionMixin.save_pretrained">save_pretrained()</a> method, e.g., <code>./my_model_directory/</code>.</li>
<li>a path or url to a saved feature extractor JSON <em>file</em>, e.g.,
<code>./my_model_directory/preprocessor_config.json</code>.
**kwargs &#x2014;
Additional keyword arguments passed along to both <a href="/docs/transformers/v4.22.2/en/main_classes/feature_extractor#transformers.SequenceFeatureExtractor">SequenceFeatureExtractor</a> and
<a href="/docs/transformers/v4.22.2/en/main_classes/tokenizer#transformers.PreTrainedTokenizer">PreTrainedTokenizer</a></li>
...
output.</p>
					...
					</div>`,name:"output_word_offsets"}],source:"https://github.com/huggingface/transformers/blob/v4.22.2/src/transformers/models/wav2vec2_with_lm/processing_wav2vec2_with_lm.py#L280",returnDescription:`
...
better understand how to make use of <code>output_word_offsets</code>.</p>
					...
					</div>`,name:"output_word_offsets"}],source:"https://github.com/huggingface/transformers/blob/v4.22.2/src/transformers/models/wav2vec2_with_lm/processing_wav2vec2_with_lm.py#L397",returnDescription:`
<p><code>Wav2Vec2DecoderWithLMOutput</code> or <code>tuple</code>.</p>
...
elements depending on the configuration (<a
  href="/docs/transformers/v4.22.2/en/model_doc/wav2vec2#transformers.Wav2Vec2Config"
...
All labels set to <code>-100</code> are ignored (masked), the loss is only computed for labels in <code>[0, ..., config.vocab_size - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.22.2/src/transformers/models/wav2vec2/modeling_wav2vec2.py#L1632",returnDescription:`
<p>A <a
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/v4.22.2/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/v4.22.2/src/transformers/models/wav2vec2/modeling_wav2vec2.py#L1721"}}),jn=new F({props:{name:"forward",anchor:"transformers.Wav2Vec2ForSequenceClassification.forward",parameters:[{name:"input_values",val:": typing.Optional[torch.Tensor]"},{name:"attention_mask",val:": typing.Optional[torch.Tensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"labels",val:": typing.Optional[torch.Tensor] = None"}],parametersDescription:[{anchor:"transformers.Wav2Vec2ForSequenceClassification.forward.input_values",description:`<strong>input_values</strong> (<code>torch.FloatTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Float values of input raw speech waveform. Values can be obtained by loading a <em>.flac</em> or <em>.wav</em> audio file
into an array of type <em>List[float]</em> or a <em>numpy.ndarray</em>, <em>e.g.</em> via the soundfile library (<em>pip install
soundfile</em>). To prepare the array into <em>input_values</em>, the <a href="/docs/transformers/v4.22.2/en/model_doc/wav2vec2#transformers.Wav2Vec2Processor">Wav2Vec2Processor</a> should be used for padding
...
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.22.2/src/transformers/models/wav2vec2/modeling_wav2vec2.py#L1766",returnDescription:`
<p>A <a
...
Labels for computing the sequence classification/regression loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>. If <code>config.num_labels == 1</code> a regression loss is computed (Mean-Square loss), If
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.22.2/src/transformers/models/wav2vec2/modeling_wav2vec2.py#L1888",returnDescription:`
<p>A <a
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/v4.22.2/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/v4.22.2/src/transformers/models/wav2vec2/modeling_wav2vec2.py#L2006"}}),Bn=new F({props:{name:"forward",anchor:"transformers.Wav2Vec2ForXVector.forward",parameters:[{name:"input_values",val:": typing.Optional[torch.Tensor]"},{name:"attention_mask",val:": typing.Optional[torch.Tensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"labels",val:": typing.Optional[torch.Tensor] = None"}],parametersDescription:[{anchor:"transformers.Wav2Vec2ForXVector.forward.input_values",description:`<strong>input_values</strong> (<code>torch.FloatTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Float values of input raw speech waveform. Values can be obtained by loading a <em>.flac</em> or <em>.wav</em> audio file
into an array of type <em>List[float]</em> or a <em>numpy.ndarray</em>, <em>e.g.</em> via the soundfile library (<em>pip install
soundfile</em>). To prepare the array into <em>input_values</em>, the <a href="/docs/transformers/v4.22.2/en/model_doc/wav2vec2#transformers.Wav2Vec2Processor">Wav2Vec2Processor</a> should be used for padding
...
Labels for computing the sequence classification/regression loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>. If <code>config.num_labels == 1</code> a regression loss is computed (Mean-Square loss), If
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.22.2/src/transformers/models/wav2vec2/modeling_wav2vec2.py#L2068",returnDescription:`
<p>A <a
...
Required input for pre-training.`,name:"sampled_negative_indices"}],source:"https://github.com/huggingface/transformers/blob/v4.22.2/src/transformers/models/wav2vec2/modeling_wav2vec2.py#L1392",returnDescription:`
<p>A <a
  href="/docs/transformers/v4.22.2/en/model_doc/wav2vec2#transformers.models.wav2vec2.modeling_wav2vec2.Wav2Vec2ForPreTrainingOutput"
...
behaviors between training and evaluation).`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/v4.22.2/src/transformers/models/wav2vec2/modeling_tf_wav2vec2.py#L1479",returnDescription:`
<p>A <a
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/v4.22.2/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/v4.22.2/src/transformers/models/wav2vec2/modeling_tf_wav2vec2.py#L1576"}}),Pa=new ge({props:{$$slots:{default:[x0]},$$scope:{ctx:j}}}),cr=new F({props:{name:"call",anchor:"transformers.TFWav2Vec2ForCTC.call",parameters:[{name:"input_values",val:": Tensor"},{name:"attention_mask",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"token_type_ids",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"position_ids",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"head_mask",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"inputs_embeds",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"labels",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"training",val:": typing.Optional[bool] = False"}],parametersDescription:[{anchor:"transformers.TFWav2Vec2ForCTC.call.input_values",description:`<strong>input_values</strong> (<code>np.ndarray</code>, <code>tf.Tensor</code>, <code>List[tf.Tensor]</code> \`<code>Dict[str, tf.Tensor]</code> or <code>Dict[str, np.ndarray]</code> and each example must have the shape <code>({0})</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/v4.22.2/en/model_doc/bert#transformers.BertTokenizer">BertTokenizer</a>. See <a href="/docs/transformers/v4.22.2/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
<a href="/docs/transformers/v4.22.2/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> for details.</p>
...
the loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.22.2/src/transformers/models/wav2vec2/modeling_tf_wav2vec2.py#L1603",returnDescription:`
<p>A <a
...
<a href="/docs/transformers/v4.22.2/en/main_classes/model#transformers.FlaxPreTrainedModel.to_bf16">to_bf16()</a>.`,name:"dtype"}],source:"https://github.com/huggingface/transformers/blob/v4.22.2/src/transformers/models/wav2vec2/modeling_flax_wav2vec2.py#L1058"}}),yr=new F({props:{name:"__call__",anchor:"transformers.FlaxWav2Vec2Model.__call__",parameters:[{name:"input_values",val:""},{name:"attention_mask",val:" = None"},{name:"mask_time_indices",val:" = None"},{name:"params",val:": dict = None"},{name:"dropout_rng",val:": PRNGKey = None"},{name:"train",val:": bool = False"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"freeze_feature_encoder",val:": bool = False"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.FlaxWav2Vec2Model.__call__.input_values",description:`<strong>input_values</strong> (<code>jnp.ndarray</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Float values of input raw speech waveform. Values can be obtained by loading a <em>.flac</em> or <em>.wav</em> audio file
into an array of type <em>List[float]</em> or a <em>numpy.ndarray</em>, <em>e.g.</em> via the soundfile library (<em>pip install
soundfile</em>). To prepare the array into <em>input_values</em>, the <a href="/docs/transformers/v4.22.2/en/model_doc/wav2vec2#transformers.Wav2Vec2Processor">Wav2Vec2Processor</a> should be used for padding
...
Whether or not to return a <a href="/docs/transformers/v4.22.2/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/v4.22.2/src/transformers/models/wav2vec2/modeling_flax_wav2vec2.py#L890",returnDescription:`
<p>A <a
  href="/docs/transformers/v4.22.2/en/model_doc/wav2vec2#transformers.models.wav2vec2.modeling_flax_wav2vec2.FlaxWav2Vec2BaseModelOutput"
...
parameters.</strong></p>
<p>If you wish to change the dtype of the model parameters, see <a href="/docs/transformers/v4.22.2/en/main_classes/model#transformers.FlaxPreTrainedModel.to_fp16">to_fp16()</a> and
<a href="/docs/transformers/v4.22.2/en/main_classes/model#transformers.FlaxPreTrainedModel.to_bf16">to_bf16()</a>.`,name:"dtype"}],source:"https://github.com/huggingface/transformers/blob/v4.22.2/src/transformers/models/wav2vec2/modeling_flax_wav2vec2.py#L1322"}}),Br=new F({props:{name:"__call__",anchor:"transformers.FlaxWav2Vec2ForPreTraining.__call__",parameters:[{name:"input_values",val:""},{name:"attention_mask",val:" = None"},{name:"mask_time_indices",val:" = None"},{name:"gumbel_temperature",val:": int = 1"},{name:"params",val:": dict = None"},{name:"dropout_rng",val:": PRNGKey = None"},{name:"gumbel_rng",val:": PRNGKey = None"},{name:"train",val:": bool = False"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"freeze_feature_encoder",val:": bool = False"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.FlaxWav2Vec2ForPreTraining.__call__.input_values",description:`<strong>input_values</strong> (<code>jnp.ndarray</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Float values of input raw speech waveform. Values can be obtained by loading a <em>.flac</em> or <em>.wav</em> audio file
into an array of type <em>List[float]</em> or a <em>numpy.ndarray</em>, <em>e.g.</em> via the soundfile library (<em>pip install
soundfile</em>). To prepare the array into <em>input_values</em>, the <a href="/docs/transformers/v4.22.2/en/model_doc/wav2vec2#transformers.Wav2Vec2Processor">Wav2Vec2Processor</a> should be used for padding
...
Whether or not to return a <a href="/docs/transformers/v4.22.2/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/v4.22.2/src/transformers/models/wav2vec2/modeling_flax_wav2vec2.py#L1325",returnDescription:`
<p>A <a
  href="/docs/transformers/v4.22.2/en/model_doc/wav2vec2#transformers.models.wav2vec2.modeling_flax_wav2vec2.FlaxWav2Vec2ForPreTrainingOutput"
...
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),jv=d(),Vc=a("p"),Vv=r("Finally, this model supports inherent JAX features such as:"),Fv=d(),Mt=a("ul"),Fc=a("li"),Vr=a("a"),Cv=r("Just-In-Time (JIT) compilation"),Ev=d(),Cc=a("li"),Fr=a("a"),qv=r("Automatic Differentiation"),Pv=d(),Ec=a("li"),Cr=a("a"),zv=r("Vectorization"),Mv=d(),qc=a("li"),Er=a("a"),Av=r("Parallelization"),Ov=d(),pt=a("div"),w(qr.$$.fragment),Lv=d(),Mo=a("p"),Dv=r("The "),Pc=a("code"),Sv=r("FlaxWav2Vec2PreTrainedModel"),Nv=r(" forward method, overrides the "),zc=a("code"),Iv=r("__call__"),Bv=r(" special method."),Uv=d(),w(Sa.$$.fragment),Rv=d(),w(Na.$$.fragment),Ud=d(),Ao=a("h2"),Ia=a("a"),Mc=a("span"),w(Pr.$$.fragment),Hv=d(),Ac=a("span"),Xv=r("FlaxWav2Vec2ForPreTraining"),Rd=d(),te=a("div"),w(zr.$$.fragment),Kv=d(),Oo=a("p"),Gv=r("Wav2Vec2 Model with a quantizer and "),Oc=a("code"),Jv=r("VQ"),Zv=r(` head on top.
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Jp.forEach(t),k2=p(_t),y(Pa.$$.fragment,_t),T2=p(_t),ct=s(_t,"DIV",{class:!0});var os=n(ct);y(cr.$$.fragment,os),$2=p(os),Co=s(os,"P",{});var Zi=n(Co);x2=i(Zi,"The "),Ei=s(Zi,"A",{href:!0});var Jy=n(Ei);W2=i(Jy,"TFWav2Vec2ForCTC"),Jy.forEach(t),j2=i(Zi," forward method, overrides the "),uc=s(Zi,"CODE",{});var Zy=n(uc);V2=i(Zy,"__call__"),Zy.forEach(t),F2=i(Zi," special method."),Zi.forEach(t),C2=p(os),y(za.$$.fragment,os),E2=p(os),y(Ma.$$.fragment,os),os.forEach(t),_t.forEach(t),Sd=p(o),Eo=s(o,"H2",{class:!0});var Zp=n(Eo);Aa=s(Zp,"A",{id:!0,class:!0,href:!0});var Qy=n(Aa);gc=s(Qy,"SPAN",{});var Yy=n(gc);y(dr.$$.fragment,Yy),Yy.forEach(t),Qy.forEach(t),q2=p(Zp),_c=s(Zp,"SPAN",{});var ek=n(_c);P2=i(ek,"FlaxWav2Vec2Model"),ek.forEach(t),Zp.forEach(t),Nd=p(o),Y=s(o,"DIV",{class:!0});var Ne=n(Y);y(pr.$$.fragment,Ne),z2=p(Ne),mr=s(Ne,"P",{});var Qp=n(mr);M2=i(Qp,`The bare Wav2Vec2 Model transformer outputting raw hidden-states without any specific head on top.
Wav2Vec2 was proposed in `),hr=s(Qp,"A",{href:!0,rel:!0});var tk=n(hr);A2=i(tk,`wav2vec 2.0: A Framework for Self-Supervised Learning of Speech
Representations`),tk.forEach(t),O2=i(Qp,` by Alexei Baevski, Henry Zhou, Abdelrahman Mohamed, Michael
Auli.`),Qp.forEach(t),L2=p(Ne),fr=s(Ne,"P",{});var Yp=n(fr);D2=i(Yp,"This model inherits from "),qi=s(Yp,"A",{href:!0});var ok=n(qi);S2=i(ok,"FlaxPreTrainedModel"),ok.forEach(t),N2=i(Yp,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Yp.forEach(t),I2=p(Ne),ur=s(Ne,"P",{});var em=n(ur);B2=i(em,`This model is also a Flax Linen
`),gr=s(em,"A",{href:!0,rel:!0});var ak=n(gr);U2=i(ak,"flax.nn.Module"),ak.forEach(t),R2=i(em,` subclass. Use it as a
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),em.forEach(t),H2=p(Ne),vc=s(Ne,"P",{});var sk=n(vc);X2=i(sk,"Finally, this model supports inherent JAX features such as:"),sk.forEach(t),K2=p(Ne),zt=s(Ne,"UL",{});var as=n(zt);bc=s(as,"LI",{});var nk=n(bc);_r=s(nk,"A",{href:!0,rel:!0});var rk=n(_r);G2=i(rk,"Just-In-Time (JIT) compilation"),rk.forEach(t),nk.forEach(t),J2=p(as),wc=s(as,"LI",{});var ik=n(wc);vr=s(ik,"A",{href:!0,rel:!0});var lk=n(vr);Z2=i(lk,"Automatic Differentiation"),lk.forEach(t),ik.forEach(t),Q2=p(as),yc=s(as,"LI",{});var ck=n(yc);br=s(ck,"A",{href:!0,rel:!0});var dk=n(br);Y2=i(dk,"Vectorization"),dk.forEach(t),ck.forEach(t),ev=p(as),kc=s(as,"LI",{});var pk=n(kc);wr=s(pk,"A",{href:!0,rel:!0});var mk=n(wr);tv=i(mk,"Parallelization"),mk.forEach(t),pk.forEach(t),as.forEach(t),ov=p(Ne),dt=s(Ne,"DIV",{class:!0});var ss=n(dt);y(yr.$$.fragment,ss),av=p(ss),qo=s(ss,"P",{});var Qi=n(qo);sv=i(Qi,"The "),Tc=s(Qi,"CODE",{});var hk=n(Tc);nv=i(hk,"FlaxWav2Vec2PreTrainedModel"),hk.forEach(t),rv=i(Qi," forward method, overrides the "),$c=s(Qi,"CODE",{});var fk=n($c);iv=i(fk,"__call__"),fk.forEach(t),lv=i(Qi," special method."),Qi.forEach(t),cv=p(ss),y(Oa.$$.fragment,ss),dv=p(ss),y(La.$$.fragment,ss),ss.forEach(t),Ne.forEach(t),Id=p(o),Po=s(o,"H2",{class:!0});var tm=n(Po);Da=s(tm,"A",{id:!0,class:!0,href:!0});var uk=n(Da);xc=s(uk,"SPAN",{});var gk=n(xc);y(kr.$$.fragment,gk),gk.forEach(t),uk.forEach(t),pv=p(tm),Wc=s(tm,"SPAN",{});var _k=n(Wc);mv=i(_k,"FlaxWav2Vec2ForCTC"),_k.forEach(t),tm.forEach(t),Bd=p(o),ee=s(o,"DIV",{class:!0});var Ie=n(ee);y(Tr.$$.fragment,Ie),hv=p(Ie),zo=s(Ie,"P",{});var Yi=n(zo);fv=i(Yi,"Wav2Vec2 Model with a "),jc=s(Yi,"CODE",{});var vk=n(jc);uv=i(vk,"language modeling"),vk.forEach(t),gv=i(Yi,` head on top for Connectionist Temporal Classification (CTC).
Wav2Vec2 was proposed in `),$r=s(Yi,"A",{href:!0,rel:!0});var bk=n($r);_v=i(bk,`wav2vec 2.0: A Framework for Self-Supervised Learning of Speech
Representations`),bk.forEach(t),vv=i(Yi,` by Alexei Baevski, Henry Zhou, Abdelrahman Mohamed, Michael
Auli.`),Yi.forEach(t),bv=p(Ie),xr=s(Ie,"P",{});var om=n(xr);wv=i(om,"This model inherits from "),Pi=s(om,"A",{href:!0});var wk=n(Pi);yv=i(wk,"FlaxPreTrainedModel"),wk.forEach(t),kv=i(om,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),om.forEach(t),Tv=p(Ie),Wr=s(Ie,"P",{});var am=n(Wr);$v=i(am,`This model is also a Flax Linen
`),jr=s(am,"A",{href:!0,rel:!0});var yk=n(jr);xv=i(yk,"flax.nn.Module"),yk.forEach(t),Wv=i(am,` subclass. Use it as a
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),am.forEach(t),jv=p(Ie),Vc=s(Ie,"P",{});var kk=n(Vc);Vv=i(kk,"Finally, this model supports inherent JAX features such as:"),kk.forEach(t),Fv=p(Ie),Mt=s(Ie,"UL",{});var ns=n(Mt);Fc=s(ns,"LI",{});var Tk=n(Fc);Vr=s(Tk,"A",{href:!0,rel:!0});var $k=n(Vr);Cv=i($k,"Just-In-Time (JIT) compilation"),$k.forEach(t),Tk.forEach(t),Ev=p(ns),Cc=s(ns,"LI",{});var xk=n(Cc);Fr=s(xk,"A",{href:!0,rel:!0});var Wk=n(Fr);qv=i(Wk,"Automatic Differentiation"),Wk.forEach(t),xk.forEach(t),Pv=p(ns),Ec=s(ns,"LI",{});var jk=n(Ec);Cr=s(jk,"A",{href:!0,rel:!0});var Vk=n(Cr);zv=i(Vk,"Vectorization"),Vk.forEach(t),jk.forEach(t),Mv=p(ns),qc=s(ns,"LI",{});var Fk=n(qc);Er=s(Fk,"A",{href:!0,rel:!0});var Ck=n(Er);Av=i(Ck,"Parallelization"),Ck.forEach(t),Fk.forEach(t),ns.forEach(t),Ov=p(Ie),pt=s(Ie,"DIV",{class:!0});var rs=n(pt);y(qr.$$.fragment,rs),Lv=p(rs),Mo=s(rs,"P",{});var el=n(Mo);Dv=i(el,"The "),Pc=s(el,"CODE",{});var Ek=n(Pc);Sv=i(Ek,"FlaxWav2Vec2PreTrainedModel"),Ek.forEach(t),Nv=i(el," forward method, overrides the "),zc=s(el,"CODE",{});var qk=n(zc);Iv=i(qk,"__call__"),qk.forEach(t),Bv=i(el," special method."),el.forEach(t),Uv=p(rs),y(Sa.$$.fragment,rs),Rv=p(rs),y(Na.$$.fragment,rs),rs.forEach(t),Ie.forEach(t),Ud=p(o),Ao=s(o,"H2",{class:!0});var sm=n(Ao);Ia=s(sm,"A",{id:!0,class:!0,href:!0});var Pk=n(Ia);Mc=s(Pk,"SPAN",{});var zk=n(Mc);y(Pr.$$.fragment,zk),zk.forEach(t),Pk.forEach(t),Hv=p(sm),Ac=s(sm,"SPAN",{});var Mk=n(Ac);Xv=i(Mk,"FlaxWav2Vec2ForPreTraining"),Mk.forEach(t),sm.forEach(t),Rd=p(o),te=s(o,"DIV",{class:!0});var Be=n(te);y(zr.$$.fragment,Be),Kv=p(Be),Oo=s(Be,"P",{});var tl=n(Oo);Gv=i(tl,"Wav2Vec2 Model with a quantizer and "),Oc=s(tl,"CODE",{});var Ak=n(Oc);Jv=i(Ak,"VQ"),Ak.forEach(t),Zv=i(tl,` head on top.
Wav2Vec2 was proposed in `),Mr=s(tl,"A",{href:!0,rel:!0});var Ok=n(Mr);Qv=i(Ok,`wav2vec 2.0: A Framework for Self-Supervised Learning of Speech
Representations`),Ok.forEach(t),Yv=i(tl,` by Alexei Baevski, Henry Zhou, Abdelrahman Mohamed, Michael
