...
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),u.forEach(t)},m(i,u){g(i,h,u),e(h,x),e(h,_),e(_,f),e(h,v)},d(i){i&&t(h)}}}function Xm(z){let h,x,_,f,v;return f=new U({props:{code:`from transformers import TrOCRProcessor, VisionEncoderDecoderModel
import requests
...
<span class="hljs-meta">&gt;&gt;&gt; </span>model = VisionEncoderDecoderModel.from_pretrained(<span class="hljs-string">&quot;./vit-bert&quot;</span>)`}}),{c(){h=a("p"),x=n("Example:"),_=l(),b(f.$$.fragment)},l(i){h=s(i,"P",{});var u=d(h);x=r(u,"Example:"),u.forEach(t),_=p(i),w(f.$$.fragment,i)},m(i,u){g(i,h,u),e(h,x),g(i,_,u),E(f,i,u),v=!0},p:mt,i(i){v||(T(f.$$.fragment,i),v=!0)},o(i){y(f.$$.fragment,i),v=!1},d(i){i&&t(h),i&&t(_),k(f,i)}}}function oh(z){let h,x,_,f,v;return{c(){h=a("p"),x=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),_=a("code"),f=n("Module"),v=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(i){h=s(i,"P",{});var u=d(h);x=r(u,"Although the recipe for forward pass needs to be defined within this function, one should call the "),_=s(u,"CODE",{});var I=d(_);f=r(I,"Module"),I.forEach(t),v=r(u,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),u.forEach(t)},m(i,u){g(i,h,u),e(h,x),e(h,_),e(_,f),e(h,v)},d(i){i&&t(h)}}}function th(z){let h,x,_,f,v;return f=new U({props:{code:`from transformers import AutoFeatureExtractor, AutoTokenizer, TFVisionEncoderDecoderModel
from PIL import Image
import requests
...
<span class="hljs-meta">&gt;&gt;&gt; </span>generated = model.generate(pixel_values, decoder_start_token_id=model.config.decoder.bos_token_id)`}}),{c(){h=a("p"),x=n("Examples:"),_=l(),b(f.$$.fragment)},l(i){h=s(i,"P",{});var u=d(h);x=r(u,"Examples:"),u.forEach(t),_=p(i),w(f.$$.fragment,i)},m(i,u){g(i,h,u),e(h,x),g(i,_,u),E(f,i,u),v=!0},p:mt,i(i){v||(T(f.$$.fragment,i),v=!0)},o(i){y(f.$$.fragment,i),v=!1},d(i){i&&t(h),i&&t(_),k(f,i)}}}function nh(z){let h,x,_,f,v;return f=new U({props:{code:`from transformers import TFVisionEncoderDecoderModel
...
<span class="hljs-meta">&gt;&gt;&gt; </span>model.save_pretrained(<span class="hljs-string">&quot;./vit-bert&quot;</span>)
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-comment"># load fine-tuned model</span>
<span class="hljs-meta">&gt;&gt;&gt; </span>model = TFVisionEncoderDecoderModel.from_pretrained(<span class="hljs-string">&quot;./vit-bert&quot;</span>)`}}),{c(){h=a("p"),x=n("Example:"),_=l(),b(f.$$.fragment)},l(i){h=s(i,"P",{});var u=d(h);x=r(u,"Example:"),u.forEach(t),_=p(i),w(f.$$.fragment,i)},m(i,u){g(i,h,u),e(h,x),g(i,_,u),E(f,i,u),v=!0},p:mt,i(i){v||(T(f.$$.fragment,i),v=!0)},o(i){y(f.$$.fragment,i),v=!1},d(i){i&&t(h),i&&t(_),k(f,i)}}}function rh(z){let h,x,_,f,v;return{c(){h=a("p"),x=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),_=a("code"),f=n("Module"),v=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(i){h=s(i,"P",{});var u=d(h);x=r(u,"Although the recipe for forward pass needs to be defined within this function, one should call the "),_=s(u,"CODE",{});var I=d(_);f=r(I,"Module"),I.forEach(t),v=r(u,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),u.forEach(t)},m(i,u){g(i,h,u),e(h,x),e(h,_),e(_,f),e(h,v)},d(i){i&&t(h)}}}function ah(z){let h,x,_,f,v;return f=new U({props:{code:`from transformers import FlaxVisionEncoderDecoderModel, ViTFeatureExtractor, GPT2Tokenizer
from PIL import Image
import requests
...
<span class="hljs-meta">&gt;&gt;&gt; </span>model.save_pretrained(<span class="hljs-string">&quot;./vit-gpt2&quot;</span>)
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-comment"># load fine-tuned model</span>
<span class="hljs-meta">&gt;&gt;&gt; </span>model = FlaxVisionEncoderDecoderModel.from_pretrained(<span class="hljs-string">&quot;./vit-gpt2&quot;</span>)`}}),{c(){h=a("p"),x=n("Example:"),_=l(),b(f.$$.fragment)},l(i){h=s(i,"P",{});var u=d(h);x=r(u,"Example:"),u.forEach(t),_=p(i),w(f.$$.fragment,i)},m(i,u){g(i,h,u),e(h,x),g(i,_,u),E(f,i,u),v=!0},p:mt,i(i){v||(T(f.$$.fragment,i),v=!0)},o(i){y(f.$$.fragment,i),v=!1},d(i){i&&t(h),i&&t(_),k(f,i)}}}function dh(z){let h,x,_,f,v,i,u,I,qa,yr,ne,ye,fn,to,za,gn,Fa,kr,$,Pa,ht,Aa,Ca,un,Sa,Ia,ft,La,Na,gt,Oa,Ra,ut,Ba,Ga,_t,Wa,Ha,_n,Ua,Za,vt,Ya,Ja,bt,Ka,Qa,wt,Xa,es,Et,os,ts,xr,ke,ns,no,rs,as,$r,xe,ss,Tt,ds,is,jr,J,cs,yt,ls,ps,kt,ms,hs,Mr,re,$e,vn,ro,fs,ao,gs,bn,us,_s,Vr,Z,xt,vs,bs,$t,ws,Es,wn,Ts,ys,Dr,so,qr,ae,je,En,io,ks,co,xs,Tn,$s,js,zr,M,jt,Ms,Vs,yn,Ds,qs,Mt,zs,Fs,kn,Ps,As,xn,Cs,Ss,$n,Is,Ls,Vt,Ns,Os,Me,Rs,jn,Bs,Gs,Mn,Ws,Hs,Dt,Us,Zs,Fr,lo,Pr,se,Ve,Vn,po,Ys,mo,Js,Dn,Ks,Qs,Ar,L,Xs,qn,ed,od,qt,td,nd,zn,rd,ad,Cr,De,sd,Fn,dd,id,Sr,ho,Ir,de,qe,Pn,fo,cd,go,ld,An,pd,md,Lr,ie,Cn,hd,fd,Sn,gd,ud,Nr,uo,Or,ce,ze,In,_o,_d,Ln,vd,Rr,N,bd,Nn,wd,Ed,On,Td,yd,Rn,kd,xd,Br,vo,Gr,K,$d,bo,jd,Md,wo,Vd,Dd,Wr,le,Fe,Bn,Eo,qd,Gn,zd,Hr,S,To,Fd,Pe,zt,Pd,Ad,Ft,Cd,Sd,Id,pe,Ld,Pt,Nd,Od,At,Rd,Bd,Gd,Ae,Wd,Ce,yo,Hd,ko,Ud,Ct,Zd,Yd,Jd,Se,xo,Kd,me,Qd,Wn,Xd,ei,Hn,oi,ti,Ur,he,Ie,Un,$o,ni,Zn,ri,Zr,V,jo,ai,fe,si,St,di,ii,It,ci,li,pi,Mo,mi,Vo,hi,fi,gi,Do,ui,qo,_i,vi,bi,Yn,wi,Ei,zo,Ti,Lt,yi,ki,xi,Fo,$i,Po,ji,Mi,Vi,Q,Nt,Di,qi,Jn,zi,Fi,Kn,Pi,Ai,Ci,O,Ao,Si,ge,Ii,Ot,Li,Ni,Qn,Oi,Ri,Bi,Le,Gi,Ne,Wi,R,Co,Hi,Xn,Ui,Zi,ue,Yi,er,Ji,Ki,or,Qi,Xi,ec,Oe,Yr,_e,Re,tr,So,oc,nr,tc,Jr,D,Io,nc,ve,rc,Rt,ac,sc,Bt,dc,ic,cc,Lo,lc,No,pc,mc,hc,Oo,fc,Ro,gc,uc,_c,rr,vc,bc,Bo,wc,Gt,Ec,Tc,yc,Go,kc,Wo,xc,$c,jc,X,Wt,Mc,Vc,Ht,Dc,qc,Ut,zc,Fc,Pc,B,Ho,Ac,be,Cc,Zt,Sc,Ic,ar,Lc,Nc,Oc,Be,Rc,Ge,Bc,ee,Uo,Gc,sr,Wc,Hc,We,Kr,we,He,dr,Zo,Uc,ir,Zc,Qr,q,Yo,Yc,Ee,Jc,Yt,Kc,Qc,Jt,Xc,el,ol,Jo,tl,Ko,nl,rl,al,Qo,sl,Xo,dl,il,cl,cr,ll,pl,et,ml,Kt,hl,fl,gl,ot,ul,tt,_l,vl,bl,oe,Qt,wl,El,lr,Tl,yl,pr,kl,xl,$l,G,nt,jl,Te,Ml,Xt,Vl,Dl,mr,ql,zl,Fl,Ue,Pl,Ze,Al,te,rt,Cl,hr,Sl,Il,Ye,Xr;return i=new Y({}),to=new Y({}),ro=new Y({}),so=new U({props:{code:`from transformers import BertConfig, ViTConfig, VisionEncoderDecoderConfig, VisionEncoderDecoderModel
...
</ul>`,name:"kwargs"}],source:"https://github.com/huggingface/transformers/blob/v4.22.2/src/transformers/models/vision_encoder_decoder/configuration_vision_encoder_decoder.py#L27"}}),Ae=new pt({props:{anchor:"transformers.VisionEncoderDecoderConfig.example",$$slots:{default:[Km]},$$scope:{ctx:z}}}),yo=new H({props:{name:"from_encoder_decoder_configs",anchor:"transformers.VisionEncoderDecoderConfig.from_encoder_decoder_configs",parameters:[{name:"encoder_config",val:": PretrainedConfig"},{name:"decoder_config",val:": PretrainedConfig"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/v4.22.2/src/transformers/models/vision_encoder_decoder/configuration_vision_encoder_decoder.py#L93",returnDescription:`
<p>An instance of a configuration object</p>
`,returnType:`
<p><a
  href="/docs/transformers/v4.22.2/en/model_doc/vision-encoder-decoder#transformers.VisionEncoderDecoderConfig"
>VisionEncoderDecoderConfig</a></p>
`}}),xo=new H({props:{name:"to_dict",anchor:"transformers.VisionEncoderDecoderConfig.to_dict",parameters:[],source:"https://github.com/huggingface/transformers/blob/v4.22.2/src/transformers/models/vision_encoder_decoder/configuration_vision_encoder_decoder.py#L110",returnDescription:`
...
</ul>`,name:"kwargs"}],source:"https://github.com/huggingface/transformers/blob/v4.22.2/src/transformers/models/vision_encoder_decoder/modeling_vision_encoder_decoder.py#L407",returnDescription:`
<p>A <a
...
<li>Without a prefix which will be input as <code>**encoder_kwargs</code> for the encoder forward function.</li>
<li>With a <em>decoder_</em> prefix which will be input as <code>**decoder_kwargs</code> for the decoder forward function.</li>
</ul>`,name:"kwargs"}],source:"https://github.com/huggingface/transformers/blob/v4.22.2/src/transformers/models/vision_encoder_decoder/modeling_tf_vision_encoder_decoder.py#L514",returnDescription:`
<p>A <a
...
If set to <code>True</code>, the model will return a <code>FlaxSeq2SeqLMOutput</code> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/v4.22.2/src/transformers/models/vision_encoder_decoder/modeling_flax_vision_encoder_decoder.py#L599",returnDescription:`
<p>A <a
...
<p>Behaves differently depending on whether a <code>config</code> is provided or automatically loaded.`,name:"kwargs"}],source:"https://github.com/huggingface/transformers/blob/v4.22.2/src/transformers/models/vision_encoder_decoder/modeling_flax_vision_encoder_decoder.py#L724"}}),Ye=new pt({props:{anchor:"transformers.FlaxVisionEncoderDecoderModel.from_encoder_decoder_pretrained.example",$$slots:{default:[sh]},$$scope:{ctx:z}}}),{c(){h=a("meta"),x=l(),_=a("h1"),f=a("a"),v=a("span"),b(i.$$.fragment),u=l(),I=a("span"),qa=n("Vision Encoder Decoder Models"),yr=l(),ne=a("h2"),ye=a("a"),fn=a("span"),b(to.$$.fragment),za=l(),gn=a("span"),Fa=n("Overview"),kr=l(),$=a("p"),Pa=n("The "),ht=a("a"),Aa=n("VisionEncoderDecoderModel"),Ca=n(` can be used to initialize an image-to-text model with any
...
To do so, the `),Mn=a("code"),Ws=n("VisionEncoderDecoderModel"),Hs=n(" class provides a "),Dt=a("a"),Us=n("VisionEncoderDecoderModel.from_encoder_decoder_pretrained()"),Zs=n(" method."),Fr=l(),b(lo.$$.fragment),Pr=l(),se=a("h2"),Ve=a("a"),Vn=a("span"),b(po.$$.fragment),Ys=l(),mo=a("span"),Js=n("Loading an existing "),Dn=a("code"),Ks=n("VisionEncoderDecoderModel"),Qs=n(" checkpoint and perform inference."),Ar=l(),L=a("p"),Xs=n("To load fine-tuned checkpoints of the "),qn=a("code"),ed=n("VisionEncoderDecoderModel"),od=n(" class, "),qt=a("a"),td=n("VisionEncoderDecoderModel"),nd=n(" provides the "),zn=a("code"),rd=n("from_pretrained(...)"),ad=n(" method just like any other model architecture in Transformers."),Cr=l(),De=a("p"),sd=n("To perform inference, one uses the "),Fn=a("code"),dd=n("generate"),id=n(" method, which allows to autoregressively generate text. This method supports various forms of decoding, such as greedy, beam search and multinomial sampling."),Sr=l(),b(ho.$$.fragment),Ir=l(),de=a("h2"),qe=a("a"),Pn=a("span"),b(fo.$$.fragment),cd=l(),go=a("span"),ld=n("Loading a PyTorch checkpoint into "),An=a("code"),pd=n("TFVisionEncoderDecoderModel"),md=n("."),Lr=l(),ie=a("p"),Cn=a("code"),hd=n("TFVisionEncoderDecoderModel.from_pretrained()"),fd=n(` currently doesn\u2019t support initializing the model from a
...
checkpoints for a particular vision encoder-decoder model, a workaround is:`),Nr=l(),b(uo.$$.fragment),Or=l(),ce=a("h2"),ze=a("a"),In=a("span"),b(_o.$$.fragment),_d=l(),Ln=a("span"),vd=n("Training"),Rr=l(),N=a("p"),bd=n(`Once the model is created, it can be fine-tuned similar to BART, T5 or any other encoder-decoder model on a dataset of (image, text) pairs.
...
images) and `),On=a("code"),Td=n("labels"),yd=n(" (which are the "),Rn=a("code"),kd=n("input_ids"),xd=n(" of the encoded target sequence)."),Br=l(),b(vo.$$.fragment),Gr=l(),K=a("p"),$d=n("This model was contributed by "),bo=a("a"),jd=n("nielsr"),Md=n(`. This model\u2019s TensorFlow and Flax versions
were contributed by `),wo=a("a"),Vd=n("ydshieh"),Dd=n("."),Wr=l(),le=a("h2"),Fe=a("a"),Bn=a("span"),b(Eo.$$.fragment),qd=l(),Gn=a("span"),zd=n("VisionEncoderDecoderConfig"),Hr=l(),S=a("div"),b(To.$$.fragment),Fd=l(),Pe=a("p"),zt=a("a"),Pd=n("VisionEncoderDecoderConfig"),Ad=n(` is the configuration class to store the configuration of a
`),Ft=a("a"),Cd=n("VisionEncoderDecoderModel"),Sd=n(`. It is used to instantiate a Vision-Encoder-Text-Decoder model according to the
...
documentation from `),At=a("a"),Rd=n("PretrainedConfig"),Bd=n(" for more information."),Gd=l(),b(Ae.$$.fragment),Wd=l(),Ce=a("div"),b(yo.$$.fragment),Hd=l(),ko=a("p"),Ud=n("Instantiate a "),Ct=a("a"),Zd=n("VisionEncoderDecoderConfig"),Yd=n(` (or a derived class) from a pre-trained encoder model
configuration and decoder model configuration.`),Jd=l(),Se=a("div"),b(xo.$$.fragment),Kd=l(),me=a("p"),Qd=n("Serializes this instance to a Python dictionary. Override the default "),Wn=a("em"),Xd=n("to_dict()"),ei=n(" from "),Hn=a("em"),oi=n("PretrainedConfig"),ti=n("."),Ur=l(),he=a("h2"),Ie=a("a"),Un=a("span"),b($o.$$.fragment),ni=l(),Zn=a("span"),ri=n("VisionEncoderDecoderModel"),Zr=l(),V=a("div"),b(jo.$$.fragment),ai=l(),fe=a("p"),si=n(`This class can be used to initialize an image-to-text-sequence model with any pretrained vision autoencoding model
...
generative task, like image captioning.`),pi=l(),Mo=a("p"),mi=n(`The effectiveness of initializing sequence-to-sequence models with pretrained checkpoints for sequence generation
...
other models (see the examples for more information).`),Ei=l(),zo=a("p"),Ti=n("This model inherits from "),Lt=a("a"),yi=n("PreTrainedModel"),ki=n(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),xi=l(),Fo=a("p"),$i=n("This model is also a PyTorch "),Po=a("a"),ji=n("torch.nn.Module"),Mi=n(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Vi=l(),Q=a("p"),Nt=a("a"),Di=n("VisionEncoderDecoderModel"),qi=n(` is a generic model class that will be instantiated as a transformer architecture with
one of the base vision model classes of the library as encoder and another one as decoder when created with the
:meth`),Jn=a("em"),zi=n("~transformers.AutoModel.from_pretrained"),Fi=n(` class method for the encoder and
:meth`),Kn=a("em"),Pi=n("~transformers.AutoModelForCausalLM.from_pretrained"),Ai=n(" class method for the decoder."),Ci=l(),O=a("div"),b(Ao.$$.fragment),Si=l(),ge=a("p"),Ii=n("The "),Ot=a("a"),Li=n("VisionEncoderDecoderModel"),Ni=n(" forward method, overrides the "),Qn=a("code"),Oi=n("__call__"),Ri=n(" special method."),Bi=l(),b(Le.$$.fragment),Gi=l(),b(Ne.$$.fragment),Wi=l(),R=a("div"),b(Co.$$.fragment),Hi=l(),Xn=a("p"),Ui=n(`Instantiate an encoder and a decoder from one or two base classes of the library from pretrained model
...
the caption. Another example is optical character recognition. Refer to `),yt=s(en,"A",{href:!0});var Xl=d(yt);ls=r(Xl,"TrOCR"),Xl.forEach(t),ps=r(en,", which is an instance of "),kt=s(en,"A",{href:!0});var ep=d(kt);ms=r(ep,"VisionEncoderDecoderModel"),ep.forEach(t),hs=r(en,"."),en.forEach(t),Mr=p(o),re=s(o,"H2",{class:!0});var ta=d(re);$e=s(ta,"A",{id:!0,class:!0,href:!0});var op=d($e);vn=s(op,"SPAN",{});var tp=d(vn);w(ro.$$.fragment,tp),tp.forEach(t),op.forEach(t),fs=p(ta),ao=s(ta,"SPAN",{});var na=d(ao);gs=r(na,"Randomly initializing "),bn=s(na,"CODE",{});var np=d(bn);us=r(np,"VisionEncoderDecoderModel"),np.forEach(t),_s=r(na," from model configurations."),na.forEach(t),ta.forEach(t),Vr=p(o),Z=s(o,"P",{});var dt=d(Z);xt=s(dt,"A",{href:!0});var rp=d(xt);vs=r(rp,"VisionEncoderDecoderModel"),rp.forEach(t),bs=r(dt," can be randomly initialized from an encoder and a decoder config. In the following example, we show how to do this using the default "),$t=s(dt,"A",{href:!0});var ap=d($t);ws=r(ap,"ViTModel"),ap.forEach(t),Es=r(dt,` configuration for the encoder
and the default `),wn=s(dt,"CODE",{});var sp=d(wn);Ts=r(sp,"BertForCausalLM"),sp.forEach(t),ys=r(dt," configuration for the decoder."),dt.forEach(t),Dr=p(o),w(so.$$.fragment,o),qr=p(o),ae=s(o,"H2",{class:!0});var ra=d(ae);je=s(ra,"A",{id:!0,class:!0,href:!0});var dp=d(je);En=s(dp,"SPAN",{});var ip=d(En);w(io.$$.fragment,ip),ip.forEach(t),dp.forEach(t),ks=p(ra),co=s(ra,"SPAN",{});var aa=d(co);xs=r(aa,"Initialising "),Tn=s(aa,"CODE",{});var cp=d(Tn);$s=r(cp,"VisionEncoderDecoderModel"),cp.forEach(t),js=r(aa," from a pretrained encoder and a pretrained decoder."),aa.forEach(t),ra.forEach(t),zr=p(o),M=s(o,"P",{});var F=d(M);jt=s(F,"A",{href:!0});var lp=d(jt);Ms=r(lp,"VisionEncoderDecoderModel"),lp.forEach(t),Vs=r(F," can be initialized from a pretrained encoder checkpoint and a pretrained decoder checkpoint. Note that any pretrained Transformer-based vision model, "),yn=s(F,"EM",{});var pp=d(yn);Ds=r(pp,"e.g."),pp.forEach(t),qs=p(F),Mt=s(F,"A",{href:!0});var mp=d(Mt);zs=r(mp,"Swin"),mp.forEach(t),Fs=r(F,", can serve as the encoder and both pretrained auto-encoding models, "),kn=s(F,"EM",{});var hp=d(kn);Ps=r(hp,"e.g."),hp.forEach(t),As=r(F," BERT, pretrained causal language models, "),xn=s(F,"EM",{});var fp=d(xn);Cs=r(fp,"e.g."),fp.forEach(t),Ss=r(F," GPT2, as well as the pretrained decoder part of sequence-to-sequence models, "),$n=s(F,"EM",{});var gp=d($n);Is=r(gp,"e.g."),gp.forEach(t),Ls=r(F,` decoder of BART, can be used as the decoder.
Depending on which architecture you choose as the decoder, the cross-attention layers might be randomly initialized.
Initializing `),Vt=s(F,"A",{href:!0});var up=d(Vt);Ns=r(up,"VisionEncoderDecoderModel"),up.forEach(t),Os=r(F," from a pretrained encoder and decoder checkpoint requires the model to be fine-tuned on a downstream task, as has been shown in "),Me=s(F,"A",{href:!0,rel:!0});var Ll=d(Me);Rs=r(Ll,"the "),jn=s(Ll,"EM",{});var _p=d(jn);Bs=r(_p,"Warm-starting-encoder-decoder blog post"),_p.forEach(t),Ll.forEach(t),Gs=r(F,`.
To do so, the `),Mn=s(F,"CODE",{});var vp=d(Mn);Ws=r(vp,"VisionEncoderDecoderModel"),vp.forEach(t),Hs=r(F," class provides a "),Dt=s(F,"A",{href:!0});var bp=d(Dt);Us=r(bp,"VisionEncoderDecoderModel.from_encoder_decoder_pretrained()"),bp.forEach(t),Zs=r(F," method."),F.forEach(t),Fr=p(o),w(lo.$$.fragment,o),Pr=p(o),se=s(o,"H2",{class:!0});var sa=d(se);Ve=s(sa,"A",{id:!0,class:!0,href:!0});var wp=d(Ve);Vn=s(wp,"SPAN",{});var Ep=d(Vn);w(po.$$.fragment,Ep),Ep.forEach(t),wp.forEach(t),Ys=p(sa),mo=s(sa,"SPAN",{});var da=d(mo);Js=r(da,"Loading an existing "),Dn=s(da,"CODE",{});var Tp=d(Dn);Ks=r(Tp,"VisionEncoderDecoderModel"),Tp.forEach(t),Qs=r(da," checkpoint and perform inference."),da.forEach(t),sa.forEach(t),Ar=p(o),L=s(o,"P",{});var Je=d(L);Xs=r(Je,"To load fine-tuned checkpoints of the "),qn=s(Je,"CODE",{});var yp=d(qn);ed=r(yp,"VisionEncoderDecoderModel"),yp.forEach(t),od=r(Je," class, "),qt=s(Je,"A",{href:!0});var kp=d(qt);td=r(kp,"VisionEncoderDecoderModel"),kp.forEach(t),nd=r(Je," provides the "),zn=s(Je,"CODE",{});var xp=d(zn);rd=r(xp,"from_pretrained(...)"),xp.forEach(t),ad=r(Je," method just like any other model architecture in Transformers."),Je.forEach(t),Cr=p(o),De=s(o,"P",{});var ia=d(De);sd=r(ia,"To perform inference, one uses the "),Fn=s(ia,"CODE",{});var $p=d(Fn);dd=r($p,"generate"),$p.forEach(t),id=r(ia," method, which allows to autoregressively generate text. This method supports various forms of decoding, such as greedy, beam search and multinomial sampling."),ia.forEach(t),Sr=p(o),w(ho.$$.fragment,o),Ir=p(o),de=s(o,"H2",{class:!0});var ca=d(de);qe=s(ca,"A",{id:!0,class:!0,href:!0});var jp=d(qe);Pn=s(jp,"SPAN",{});var Mp=d(Pn);w(fo.$$.fragment,Mp),Mp.forEach(t),jp.forEach(t),cd=p(ca),go=s(ca,"SPAN",{});var la=d(go);ld=r(la,"Loading a PyTorch checkpoint into "),An=s(la,"CODE",{});var Vp=d(An);pd=r(Vp,"TFVisionEncoderDecoderModel"),Vp.forEach(t),md=r(la,"."),la.forEach(t),ca.forEach(t),Lr=p(o),ie=s(o,"P",{});var Er=d(ie);Cn=s(Er,"CODE",{});var Dp=d(Cn);hd=r(Dp,"TFVisionEncoderDecoderModel.from_pretrained()"),Dp.forEach(t),fd=r(Er,` currently doesn\u2019t support initializing the model from a
...
checkpoints for a particular vision encoder-decoder model, a workaround is:`),Er.forEach(t),Nr=p(o),w(uo.$$.fragment,o),Or=p(o),ce=s(o,"H2",{class:!0});var pa=d(ce);ze=s(pa,"A",{id:!0,class:!0,href:!0});var zp=d(ze);In=s(zp,"SPAN",{});var Fp=d(In);w(_o.$$.fragment,Fp),Fp.forEach(t),zp.forEach(t),_d=p(pa),Ln=s(pa,"SPAN",{});var Pp=d(Ln);vd=r(Pp,"Training"),Pp.forEach(t),pa.forEach(t),Rr=p(o),N=s(o,"P",{});var Ke=d(N);bd=r(Ke,`Once the model is created, it can be fine-tuned similar to BART, T5 or any other encoder-decoder model on a dataset of (image, text) pairs.
As you can see, only 2 inputs are required for the model in order to compute a loss: `),Nn=s(Ke,"CODE",{});var Ap=d(Nn);wd=r(Ap,"pixel_values"),Ap.forEach(t),Ed=r(Ke,` (which are the
images) and `),On=s(Ke,"CODE",{});var Cp=d(On);Td=r(Cp,"labels"),Cp.forEach(t),yd=r(Ke," (which are the "),Rn=s(Ke,"CODE",{});var Sp=d(Rn);kd=r(Sp,"input_ids"),Sp.forEach(t),xd=r(Ke," of the encoded target sequence)."),Ke.forEach(t),Br=p(o),w(vo.$$.fragment,o),Gr=p(o),K=s(o,"P",{});var on=d(K);$d=r(on,"This model was contributed by "),bo=s(on,"A",{href:!0,rel:!0});var Ip=d(bo);jd=r(Ip,"nielsr"),Ip.forEach(t),Md=r(on,`. This model\u2019s TensorFlow and Flax versions
were contributed by `),wo=s(on,"A",{href:!0,rel:!0});var Lp=d(wo);Vd=r(Lp,"ydshieh"),Lp.forEach(t),Dd=r(on,"."),on.forEach(t),Wr=p(o),le=s(o,"H2",{class:!0});var ma=d(le);Fe=s(ma,"A",{id:!0,class:!0,href:!0});var Np=d(Fe);Bn=s(Np,"SPAN",{});var Op=d(Bn);w(Eo.$$.fragment,Op),Op.forEach(t),Np.forEach(t),qd=p(ma),Gn=s(ma,"SPAN",{});var Rp=d(Gn);zd=r(Rp,"VisionEncoderDecoderConfig"),Rp.forEach(t),ma.forEach(t),Hr=p(o),S=s(o,"DIV",{class:!0});var W=d(S);w(To.$$.fragment,W),Fd=p(W),Pe=s(W,"P",{});var Tr=d(Pe);zt=s(Tr,"A",{href:!0});var Bp=d(zt);Pd=r(Bp,"VisionEncoderDecoderConfig"),Bp.forEach(t),Ad=r(Tr,` is the configuration class to store the configuration of a
`),Ft=s(Tr,"A",{href:!0});var Gp=d(Ft);Cd=r(Gp,"VisionEncoderDecoderModel"),Gp.forEach(t),Sd=r(Tr,`. It is used to instantiate a Vision-Encoder-Text-Decoder model according to the
...
function. Cross-attention layers are automatically added to the decoder and should be fine-tuned on a downstream
generative task, like image captioning.`),rn.forEach(t),pi=p(P),Mo=s(P,"P",{});var _a=d(Mo);mi=r(_a,`The effectiveness of initializing sequence-to-sequence models with pretrained checkpoints for sequence generation
tasks was shown in `),Vo=s(_a,"A",{href:!0,rel:!0});var om=d(Vo);hi=r(om,`Leveraging Pre-trained Checkpoints for Sequence Generation
...
other models (see the examples for more information).`),nm.forEach(t),Ei=p(P),zo=s(P,"P",{});var ba=d(zo);Ti=r(ba,"This model inherits from "),Lt=s(ba,"A",{href:!0});var rm=d(Lt);yi=r(rm,"PreTrainedModel"),rm.forEach(t),ki=r(ba,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),ba.forEach(t),xi=p(P),Fo=s(P,"P",{});var wa=d(Fo);$i=r(wa,"This model is also a PyTorch "),Po=s(wa,"A",{href:!0,rel:!0});var am=d(Po);ji=r(am,"torch.nn.Module"),am.forEach(t),Mi=r(wa,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),wa.forEach(t),Vi=p(P),Q=s(P,"P",{});var it=d(Q);Nt=s(it,"A",{href:!0});var sm=d(Nt);Di=r(sm,"VisionEncoderDecoderModel"),sm.forEach(t),qi=r(it,` is a generic model class that will be instantiated as a transformer architecture with
one of the base vision model classes of the library as encoder and another one as decoder when created with the
:meth`),Jn=s(it,"EM",{});var dm=d(Jn);zi=r(dm,"~transformers.AutoModel.from_pretrained"),dm.forEach(t),Fi=r(it,` class method for the encoder and
:meth`),Kn=s(it,"EM",{});var im=d(Kn);Pi=r(im,"~transformers.AutoModelForCausalLM.from_pretrained"),im.forEach(t),Ai=r(it," class method for the decoder."),it.forEach(t),Ci=p(P),O=s(P,"DIV",{class:!0});var Qe=d(O);w(Ao.$$.fragment,Qe),Si=p(Qe),ge=s(Qe,"P",{});var an=d(ge);Ii=r(an,"The "),Ot=s(an,"A",{href:!0});var cm=d(Ot);Li=r(cm,"VisionEncoderDecoderModel"),cm.forEach(t),Ni=r(an," forward method, overrides the "),Qn=s(an,"CODE",{});var lm=d(Qn);Oi=r(lm,"__call__"),lm.forEach(t),Ri=r(an," special method."),an.forEach(t),Bi=p(Qe),w(Le.$$.fragment,Qe),Gi=p(Qe),w(Ne.$$.fragment,Qe),Qe.forEach(t),Wi=p(P),R=s(P,"DIV",{class:!0});var Xe=d(R);w(Co.$$.fragment,Xe),Hi=p(Xe),Xn=s(Xe,"P",{});var pm=d(Xn);Ui=r(pm,`Instantiate an encoder and a decoder from one or two base classes of the library from pretrained model
...
function. Cross-attention layers are automatically added to the decoder and should be fine-tuned on a downstream
generative task, like image captioning.`),dn.forEach(t),cc=p(A),Lo=s(A,"P",{});var Ta=d(Lo);lc=r(Ta,`The effectiveness of initializing sequence-to-sequence models with pretrained checkpoints for sequence generation
...
Zhou, Wei Li, Peter J. Liu.`),Ta.forEach(t),hc=p(A),Oo=s(A,"P",{});var ya=d(Oo);fc=r(ya,"Additionally, in "),Ro=s(ya,"A",{href:!0,rel:!0});var wm=d(Ro);gc=r(wm,`TrOCR: Transformer-based Optical Character Recognition with Pre-trained
Models`),wm.forEach(t),uc=r(ya,` it is shown how leveraging large pretrained vision models for optical
character recognition (OCR) yields a significant performance improvement.`),ya.forEach(t),_c=p(A),rr=s(A,"P",{});var Em=d(rr);vc=r(Em,`After such a Vision-Encoder-Text-Decoder model has been trained/fine-tuned, it can be saved/loaded just like any
other models (see the examples for more information).`),Em.forEach(t),bc=p(A),Bo=s(A,"P",{});var ka=d(Bo);wc=r(ka,"This model inherits from "),Gt=s(ka,"A",{href:!0});var Tm=d(Gt);Ec=r(Tm,"TFPreTrainedModel"),Tm.forEach(t),Tc=r(ka,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),ka.forEach(t),yc=p(A),Go=s(A,"P",{});var xa=d(Go);kc=r(xa,"This model is also a "),Wo=s(xa,"A",{href:!0,rel:!0});var ym=d(Wo);xc=r(ym,"tf.keras.Model"),ym.forEach(t),$c=r(xa,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),xa.forEach(t),jc=p(A),X=s(A,"P",{});var ct=d(X);Wt=s(ct,"A",{href:!0});var km=d(Wt);Mc=r(km,"TFVisionEncoderDecoderModel"),km.forEach(t),Vc=r(ct,` is a generic model class that will be instantiated as a transformer architecture
with one of the base vision model classes of the library as encoder and another one of the base model classes as
...
`),Ut=s(ct,"A",{href:!0});var $m=d(Ut);zc=r($m,"from_pretrained()"),$m.forEach(t),Fc=r(ct," class method for the decoder."),ct.forEach(t),Pc=p(A),B=s(A,"DIV",{class:!0});var eo=d(B);w(Ho.$$.fragment,eo),Ac=p(eo),be=s(eo,"P",{});var cn=d(be);Cc=r(cn,"The "),Zt=s(cn,"A",{href:!0});var jm=d(Zt);Sc=r(jm,"TFVisionEncoderDecoderModel"),jm.forEach(t),Ic=r(cn," forward method, overrides the "),ar=s(cn,"CODE",{});var Mm=d(ar);Lc=r(Mm,"__call__"),Mm.forEach(t),Nc=r(cn," special method."),cn.forEach(t),Oc=p(eo),w(Be.$$.fragment,eo),Rc=p(eo),w(Ge.$$.fragment,eo),eo.forEach(t),Bc=p(A),ee=s(A,"DIV",{class:!0});var ln=d(ee);w(Uo.$$.fragment,ln),Gc=p(ln),sr=s(ln,"P",{});var Vm=d(sr);Wc=r(Vm,`Instantiate an encoder and a decoder from one or two base classes of the library from pretrained model
checkpoints.`),Vm.forEach(t),Hc=p(ln),w(We.$$.fragment,ln),ln.forEach(t),A.forEach(t),Kr=p(o),we=s(o,"H2",{class:!0});var $a=d(we);He=s($a,"A",{id:!0,class:!0,href:!0});var Dm=d(He);dr=s(Dm,"SPAN",{});var qm=d(dr);w(Zo.$$.fragment,qm),qm.forEach(t),Dm.forEach(t),Uc=p($a),ir=s($a,"SPAN",{});var zm=d(ir);Zc=r(zm,"FlaxVisionEncoderDecoderModel"),zm.forEach(t),$a.forEach(t),Qr=p(o),q=s(o,"DIV",{class:!0});var C=d(q);w(Yo.$$.fragment,C),Yc=p(C),Ee=s(C,"P",{});var pn=d(Ee);Jc=r(pn,`This class can be used to initialize an image-to-text-sequence model with any pretrained vision autoencoding model
as the encoder and any pretrained text autoregressive model as the decoder. The encoder is loaded via
`),Yt=s(pn,"A",{href:!0});var Fm=d(Yt);Kc=r(Fm,"from_pretrained()"),Fm.forEach(t),Qc=r(pn," function and the decoder is loaded via "),Jt=s(pn,"A",{href:!0});var Pm=d(Jt);Xc=r(Pm,"from_pretrained()"),Pm.forEach(t),el=r(pn,`
function. Cross-attention layers are automatically added to the decoder and should be fine-tuned on a downstream
generative task, like image captioning.`),pn.forEach(t),ol=p(C),Jo=s(C,"P",{});var ja=d(Jo);tl=r(ja,`The effectiveness of initializing sequence-to-sequence models with pretrained checkpoints for sequence generation
tasks was shown in `),Ko=s(ja,"A",{href:!0,rel:!0});var Am=d(Ko);nl=r(Am,`Leveraging Pre-trained Checkpoints for Sequence Generation
Tasks`),Am.forEach(t),rl=r(ja,` by Sascha Rothe, Shashi Narayan, Aliaksei Severyn. Michael Matena, Yanqi
Zhou, Wei Li, Peter J. Liu.`),ja.forEach(t),al=p(C),Qo=s(C,"P",{});var Ma=d(Qo);sl=r(Ma,"Additionally, in "),Xo=s(Ma,"A",{href:!0,rel:!0});var Cm=d(Xo);dl=r(Cm,`TrOCR: Transformer-based Optical Character Recognition with Pre-trained
Models`),Cm.forEach(t),il=r(Ma,` it is shown how leveraging large pretrained vision models for optical
character recognition (OCR) yields a significant performance improvement.`),Ma.forEach(t),cl=p(C),cr=s(C,"P",{});var Sm=d(cr);ll=r(Sm,`After such a Vision-Encoder-Text-Decoder model has been trained/fine-tuned, it can be saved/loaded just like any
other models (see the examples for more information).`),Sm.forEach(t),pl=p(C),et=s(C,"P",{});var Va=d(et);ml=r(Va,"This model inherits from "),Kt=s(Va,"A",{href:!0});var Im=d(Kt);hl=r(Im,"FlaxPreTrainedModel"),Im.forEach(t),fl=r(Va,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Va.forEach(t),gl=p(C),ot=s(C,"P",{});var Da=d(ot);ul=r(Da,`This model is also a Flax Linen
`),tt=s(Da,"A",{href:!0,rel:!0});var Lm=d(tt);_l=r(Lm,"flax.nn.Module"),Lm.forEach(t),vl=r(Da,` subclass. Use it as a
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),Da.forEach(t),bl=p(C),oe=s(C,"P",{});var lt=d(oe);Qt=s(lt,"A",{href:!0});var Nm=d(Qt);wl=r(Nm,"FlaxVisionEncoderDecoderModel"),Nm.forEach(t),El=r(lt,` is a generic model class that will be instantiated as a transformer architecture
with the module (flax.nn.Module) of one of the base vision model classes of the library as encoder module and
