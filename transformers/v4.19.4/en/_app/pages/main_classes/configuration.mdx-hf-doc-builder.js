...
<span class="hljs-keyword">assert</span> config.output_attentions == <span class="hljs-literal">True</span>
<span class="hljs-keyword">assert</span> unused_kwargs == {<span class="hljs-string">&quot;foo&quot;</span>: <span class="hljs-literal">False</span>}`}}),{c(){f=r("p"),b=o("Examples:"),u=d(),y(g.$$.fragment)},l(c){f=a(c,"P",{});var _=s(f);b=n(_,"Examples:"),_.forEach(t),u=l(c),w(g.$$.fragment,c)},m(c,_){x(c,f,_),e(f,b),x(c,u,_),$(g,c,_),E=!0},p:Ps,i(c){E||(k(g.$$.fragment,c),E=!0)},o(c){P(g.$$.fragment,c),E=!1},d(c){c&&t(f),c&&t(u),C(g,c)}}}function Ss(z){let f,b;return{c(){f=r("p"),b=o("This API is experimental and may have some slight breaking changes in the next releases.")},l(u){f=a(u,"P",{});var g=s(f);b=n(g,"This API is experimental and may have some slight breaking changes in the next releases."),g.forEach(t)},m(u,g){x(u,f,g),e(f,b)},d(u){u&&t(f)}}}function Fs(z){let f,b,u,g,E,c,_,q,Do,ao,H,jo,Ge,zo,Ao,so,D,Oo,dt,qo,So,lt,Fo,Io,ct,Lo,No,ft,Wo,Mo,io,R,G,mt,$e,Bo,ht,Vo,lo,m,ke,Ro,ut,Uo,Jo,X,Ho,gt,Go,Xo,S,W,pt,Ko,Qo,_t,Yo,Zo,Xe,en,tn,on,j,bt,nn,rn,vt,an,sn,Ke,dn,ln,Qe,cn,fn,Ye,mn,hn,un,K,yt,gn,pn,wt,_n,bn,vn,Q,$t,yn,wn,kt,$n,kn,Pn,Pt,Cn,En,F,Y,Ct,xn,Tn,Et,Dn,jn,zn,Z,xt,An,On,Tt,qn,Sn,Fn,ee,Dt,In,Ln,jt,Nn,Wn,Mn,te,zt,Bn,Vn,At,Rn,Un,Jn,M,Pe,Hn,Ce,Gn,Ot,Xn,Kn,Qn,oe,Yn,ne,Ee,Zn,I,er,qt,tr,or,St,nr,rr,Ft,ar,sr,ir,re,xe,dr,Te,lr,Ze,cr,fr,mr,ae,De,hr,je,ur,et,gr,pr,_r,A,ze,br,Ae,vr,tt,yr,wr,$r,se,kr,ie,Pr,de,Oe,Cr,L,Er,It,xr,Tr,ot,Dr,jr,Lt,zr,Ar,Or,B,qe,qr,Se,Sr,Nt,Fr,Ir,Lr,le,Nr,ce,Fe,Wr,U,Mr,Wt,Br,Vr,nt,Rr,Ur,Jr,fe,Ie,Hr,Mt,Gr,Xr,me,Le,Kr,Bt,Qr,Yr,he,Ne,Zr,Vt,ea,ta,ue,We,oa,Rt,na,ra,ge,Me,aa,Be,sa,Ut,ia,da,la,O,Ve,ca,Re,fa,Jt,ma,ha,ua,J,ga,Ht,pa,_a,Gt,ba,va,ya,Xt,wa,co;return c=new $s({}),$e=new $s({}),ke=new T({props:{name:"class transformers.PretrainedConfig",anchor:"transformers.PretrainedConfig",parameters:[{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.PretrainedConfig.name_or_path",description:`<strong>name_or_path</strong> (<code>str</code>, <em>optional</em>, defaults to <code>&quot;&quot;</code>) &#x2014;
Store the string that was passed to <a href="/docs/transformers/v4.19.4/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">PreTrainedModel.from_pretrained()</a> or
<a href="/docs/transformers/v4.19.4/en/main_classes/model#transformers.TFPreTrainedModel.from_pretrained">TFPreTrainedModel.from_pretrained()</a> as <code>pretrained_model_name_or_path</code> if the configuration was created
...
that can be used as decoder models within the <a href="/docs/transformers/v4.19.4/en/model_doc/encoder-decoder#transformers.EncoderDecoderModel">EncoderDecoderModel</a> class, which consists of all models
...
Forward Chunking work?</a>.`,name:"chunk_size_feed_forward"}],source:"https://github.com/huggingface/transformers/blob/v4.19.4/src/transformers/configuration_utils.py#L54",parameterGroups:[{title:"Parameters for sequence generation",parametersDescription:`
<ul>
...
<code>repo_url</code> is not specified.`,name:"use_auth_token"}],source:"https://github.com/huggingface/transformers/blob/v4.19.4/src/transformers/utils/hub.py#L854",returnDescription:`
<p>The url of the commit of your config in the given repository.</p>
`,returnType:`
<p><code>str</code></p>
`}}),oe=new ks({props:{anchor:"transformers.PretrainedConfig.push_to_hub.example",$$slots:{default:[As]},$$scope:{ctx:z}}}),Ee=new T({props:{name:"dict_torch_dtype_to_str",anchor:"transformers.PretrainedConfig.dict_torch_dtype_to_str",parameters:[{name:"d",val:": typing.Dict[str, typing.Any]"}],source:"https://github.com/huggingface/transformers/blob/v4.19.4/src/transformers/configuration_utils.py#L874"}}),xe=new T({props:{name:"from_dict",anchor:"transformers.PretrainedConfig.from_dict",parameters:[{name:"config_dict",val:": typing.Dict[str, typing.Any]"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.PretrainedConfig.from_dict.config_dict",description:`<strong>config_dict</strong> (<code>Dict[str, Any]</code>) &#x2014;
Dictionary that will be used to instantiate the configuration object. Such a dictionary can be
retrieved from a pretrained checkpoint by leveraging the <a href="/docs/transformers/v4.19.4/en/main_classes/configuration#transformers.PretrainedConfig.get_config_dict">get_config_dict()</a> method.`,name:"config_dict"},{anchor:"transformers.PretrainedConfig.from_dict.kwargs",description:`<strong>kwargs</strong> (<code>Dict[str, Any]</code>) &#x2014;
Additional parameters from which to initialize the configuration object.`,name:"kwargs"}],source:"https://github.com/huggingface/transformers/blob/v4.19.4/src/transformers/configuration_utils.py#L663",returnDescription:`
<p>The configuration object instantiated from those parameters.</p>
`,returnType:`
<p><a
  href="/docs/transformers/v4.19.4/en/main_classes/configuration#transformers.PretrainedConfig"
...
Path to the JSON file containing the parameters.`,name:"json_file"}],source:"https://github.com/huggingface/transformers/blob/v4.19.4/src/transformers/configuration_utils.py#L714",returnDescription:`
...
<a href="/docs/transformers/v4.19.4/en/main_classes/configuration#transformers.PretrainedConfig.save_pretrained">save_pretrained()</a> method, e.g., <code>./my_model_directory/</code>.</li>
...
by the <code>return_unused_kwargs</code> keyword parameter.`,name:"kwargs"}],source:"https://github.com/huggingface/transformers/blob/v4.19.4/src/transformers/configuration_utils.py#L452",returnDescription:`
...
The identifier of the pre-trained checkpoint from which we want the dictionary of parameters.`,name:"pretrained_model_name_or_path"}],source:"https://github.com/huggingface/transformers/blob/v4.19.4/src/transformers/configuration_utils.py#L535",returnDescription:`
...
<p>kwargs &#x2014;
Additional key word arguments passed along to the <a href="/docs/transformers/v4.19.4/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.push_to_hub">push_to_hub()</a> method.`,name:"push_to_hub"}],source:"https://github.com/huggingface/transformers/blob/v4.19.4/src/transformers/configuration_utils.py#L406"}}),Ie=new T({props:{name:"to_dict",anchor:"transformers.PretrainedConfig.to_dict",parameters:[],source:"https://github.com/huggingface/transformers/blob/v4.19.4/src/transformers/configuration_utils.py#L774",returnDescription:`
<p>Dictionary of all the attributes that make up this configuration instance.</p>
`,returnType:`
<p><code>Dict[str, Any]</code></p>
`}}),Le=new T({props:{name:"to_diff_dict",anchor:"transformers.PretrainedConfig.to_diff_dict",parameters:[],source:"https://github.com/huggingface/transformers/blob/v4.19.4/src/transformers/configuration_utils.py#L742",returnDescription:`
<p>Dictionary of all the attributes that make up this configuration instance,</p>
`,returnType:`
<p><code>Dict[str, Any]</code></p>
...
`),ft=r("code"),Wo=o("vocab_size"),Mo=o("."),io=d(),R=r("h2"),G=r("a"),mt=r("span"),y($e.$$.fragment),Bo=d(),ht=r("span"),Vo=o("PretrainedConfig"),lo=d(),m=r("div"),y(ke.$$.fragment),Ro=d(),ut=r("p"),Uo=o(`Base class for all configuration classes. Handles a few parameters common to all models\u2019 configurations as well as
...
model.`),Mn=d(),te=r("li"),zt=r("strong"),Bn=o("num_hidden_layers"),Vn=o(" ("),At=r("code"),Rn=o("int"),Un=o(") \u2014 The number of blocks in the model."),Jn=d(),M=r("div"),y(Pe.$$.fragment),Hn=d(),Ce=r("p"),Gn=o(`Upload the configuration file to the \u{1F917} Model Hub while synchronizing a local clone of the repo in
...
`),ot=r("a"),Dr=o("PretrainedConfig"),jr=o(" using "),Lt=r("code"),zr=o("from_dict"),Ar=o("."),Or=d(),B=r("div"),y(qe.$$.fragment),qr=d(),Se=r("p"),Sr=o(`Register this class with a given auto class. This should only be used for custom configurations as the ones in
the library are already mapped with `),Nt=r("code"),Fr=o("AutoConfig"),Ir=o("."),Lr=d(),y(le.$$.fragment),Nr=d(),ce=r("div"),y(Fe.$$.fragment),Wr=d(),U=r("p"),Mr=o("Save a configuration object to the directory "),Wt=r("code"),Br=o("save_directory"),Vr=o(`, so that it can be re-loaded using the
`),nt=r("a"),Rr=o("from_pretrained()"),Ur=o(" class method."),Jr=d(),fe=r("div"),y(Ie.$$.fragment),Hr=d(),Mt=r("p"),Gr=o("Serializes this instance to a Python dictionary."),Xr=d(),me=r("div"),y(Le.$$.fragment),Kr=d(),Bt=r("p"),Qr=o(`Removes all attributes from config which correspond to the default config attributes for better readability and
serializes to a Python dictionary.`),Yr=d(),he=r("div"),y(Ne.$$.fragment),Zr=d(),Vt=r("p"),ea=o("Save this instance to a JSON file."),ta=d(),ue=r("div"),y(We.$$.fragment),oa=d(),Rt=r("p"),na=o("Serializes this instance to a JSON string."),ra=d(),ge=r("div"),y(Me.$$.fragment),aa=d(),Be=r("p"),sa=o("Updates attributes of this class with attributes from "),Ut=r("code"),ia=o("config_dict"),da=o("."),la=d(),O=r("div"),y(Ve.$$.fragment),ca=d(),Re=r("p"),fa=o("Updates attributes of this class with attributes from "),Jt=r("code"),ma=o("update_str"),ha=o("."),ua=d(),J=r("p"),ga=o("The expected format is ints, floats and strings as is, and for booleans use "),Ht=r("code"),pa=o("true"),_a=o(" or "),Gt=r("code"),ba=o("false"),va=o(`. For example:
...
outputs of the model during inference.`),Zt.forEach(t),vn=l(pe),Q=a(pe,"LI",{});var eo=s(Q);$t=a(eo,"STRONG",{});var Va=s($t);yn=n(Va,"attribute_map"),Va.forEach(t),wn=n(eo," ("),kt=a(eo,"CODE",{});var Ra=s(kt);$n=n(Ra,"Dict[str, str]"),Ra.forEach(t),kn=n(eo,`) \u2014 A dict that maps model specific attribute names to the standardized
...
\u201Cn_embd=10,resid_pdrop=0.2,scale_attn_weights=false,summary_type=cls_index\u201D`),it.forEach(t),ya=l(we),Xt=a(we,"P",{});var ws=s(Xt);wa=n(ws,"The keys to change have to already exist in the config object."),ws.forEach(t),we.forEach(t),h.forEach(t),this.h()},h(){p(f,"name","hf:doc:metadata"),p(f,"content",JSON.stringify(Is)),p(g,"id","configuration"),p(g,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),p(g,"href","#configuration"),p(u,"class","relative group"),p(Ge,"href","/docs/transformers/v4.19.4/en/main_classes/configuration#transformers.PretrainedConfig"),p(G,"id","transformers.PretrainedConfig"),p(G,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),p(G,"href","#transformers.PretrainedConfig"),p(R,"class","relative group"),p(Xe,"href","/docs/transformers/v4.19.4/en/model_doc/auto#transformers.AutoConfig"),p(Ke,"href","/docs/transformers/v4.19.4/en/main_classes/configuration#transformers.PretrainedConfig"),p(Qe,"href","/docs/transformers/v4.19.4/en/model_doc/encoder-decoder#transformers.EncoderDecoderConfig"),p(Ye,"href","/docs/transformers/v4.19.4/en/model_doc/rag#transformers.RagConfig"),p(M,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),p(ne,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),p(Ze,"href","/docs/transformers/v4.19.4/en/main_classes/configuration#transformers.PretrainedConfig"),p(re,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),p(et,"href","/docs/transformers/v4.19.4/en/main_classes/configuration#transformers.PretrainedConfig"),p(ae,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),p(tt,"href","/docs/transformers/v4.19.4/en/main_classes/configuration#transformers.PretrainedConfig"),p(A,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),p(ot,"href","/docs/transformers/v4.19.4/en/main_classes/configuration#transformers.PretrainedConfig"),p(de,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),p(B,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),p(nt,"href","/docs/transformers/v4.19.4/en/main_classes/configuration#transformers.PretrainedConfig.from_pretrained"),p(ce,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),p(fe,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),p(me,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),p(he,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),p(ue,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),p(ge,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),p(O,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),p(m,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8")},m(i,v){e(document.head,f),x(i,b,v),x(i,u,v),e(u,g),e(g,E),$(c,E,null),e(u,_),e(u,q),e(q,Do),x(i,ao,v),x(i,H,v),e(H,jo),e(H,Ge),e(Ge,zo),e(H,Ao),x(i,so,v),x(i,D,v),e(D,Oo),e(D,dt),e(dt,qo),e(D,So),e(D,lt),e(lt,Fo),e(D,Io),e(D,ct),e(ct,Lo),e(D,No),e(D,ft),e(ft,Wo),e(D,Mo),x(i,io,v),x(i,R,v),e(R,G),e(G,mt),$($e,mt,null),e(R,Bo),e(R,ht),e(ht,Vo),x(i,lo,v),x(i,m,v),$(ke,m,null),e(m,Ro),e(m,ut),e(ut,Uo),e(m,Jo),$(X,m,null),e(m,Ho),e(m,gt),e(gt,Go),e(m,Xo),e(m,S),e(S,W),e(W,pt),e(pt,Ko),e(W,Qo),e(W,_t),e(_t,Yo),e(W,Zo),e(W,Xe),e(Xe,en),e(W,tn),e(S,on),e(S,j),e(j,bt),e(bt,nn),e(j,rn),e(j,vt),e(vt,an),e(j,sn),e(j,Ke),e(Ke,dn),e(j,ln),e(j,Qe),e(Qe,cn),e(j,fn),e(j,Ye),e(Ye,mn),e(j,hn),e(S,un),e(S,K),e(K,yt),e(yt,gn),e(K,pn),e(K,wt),e(wt,_n),e(K,bn),e(S,vn),e(S,Q),e(Q,$t),e($t,yn),e(Q,wn),e(Q,kt),e(kt,$n),e(Q,kn),e(m,Pn),e(m,Pt),e(Pt,Cn),e(m,En),e(m,F),e(F,Y),e(Y,Ct),e(Ct,xn),e(Y,Tn),e(Y,Et),e(Et,Dn),e(Y,jn),e(F,zn),e(F,Z),e(Z,xt),e(xt,An),e(Z,On),e(Z,Tt),e(Tt,qn),e(Z,Sn),e(F,Fn),e(F,ee),e(ee,Dt),e(Dt,In),e(ee,Ln),e(ee,jt),e(jt,Nn),e(ee,Wn),e(F,Mn),e(F,te),e(te,zt),e(zt,Bn),e(te,Vn),e(te,At),e(At,Rn),e(te,Un),e(m,Jn),e(m,M),$(Pe,M,null),e(M,Hn),e(M,Ce),e(Ce,Gn),e(Ce,Ot),e(Ot,Xn),e(Ce,Kn),e(M,Qn),$(oe,M,null),e(m,Yn),e(m,ne),$(Ee,ne,null),e(ne,Zn),e(ne,I),e(I,er),e(I,qt),e(qt,tr),e(I,or),e(I,St),e(St,nr),e(I,rr),e(I,Ft),e(Ft,ar),e(I,sr),e(m,ir),e(m,re),$(xe,re,null),e(re,dr),e(re,Te),e(Te,lr),e(Te,Ze),e(Ze,cr),e(Te,fr),e(m,mr),e(m,ae),$(De,ae,null),e(ae,hr),e(ae,je),e(je,ur),e(je,et),e(et,gr),e(je,pr),e(m,_r),e(m,A),$(ze,A,null),e(A,br),e(A,Ae),e(Ae,vr),e(Ae,tt),e(tt,yr),e(Ae,wr),e(A,$r),$(se,A,null),e(A,kr),$(ie,A,null),e(m,Pr),e(m,de),$(Oe,de,null),e(de,Cr),e(de,L),e(L,Er),e(L,It),e(It,xr),e(L,Tr),e(L,ot),e(ot,Dr),e(L,jr),e(L,Lt),e(Lt,zr),e(L,Ar),e(m,Or),e(m,B),$(qe,B,null),e(B,qr),e(B,Se),e(Se,Sr),e(Se,Nt),e(Nt,Fr),e(Se,Ir),e(B,Lr),$(le,B,null),e(m,Nr),e(m,ce),$(Fe,ce,null),e(ce,Wr),e(ce,U),e(U,Mr),e(U,Wt),e(Wt,Br),e(U,Vr),e(U,nt),e(nt,Rr),e(U,Ur),e(m,Jr),e(m,fe),$(Ie,fe,null),e(fe,Hr),e(fe,Mt),e(Mt,Gr),e(m,Xr),e(m,me),$(Le,me,null),e(me,Kr),e(me,Bt),e(Bt,Qr),e(m,Yr),e(m,he),$(Ne,he,null),e(he,Zr),e(he,Vt),e(Vt,ea),e(m,ta),e(m,ue),$(We,ue,null),e(ue,oa),e(ue,Rt),e(Rt,na),e(m,ra),e(m,ge),$(Me,ge,null),e(ge,aa),e(ge,Be),e(Be,sa),e(Be,Ut),e(Ut,ia),e(Be,da),e(m,la),e(m,O),$(Ve,O,null),e(O,ca),e(O,Re),e(Re,fa),e(Re,Jt),e(Jt,ma),e(Re,ha),e(O,ua),e(O,J),e(J,ga),e(J,Ht),e(Ht,pa),e(J,_a),e(J,Gt),e(Gt,ba),e(J,va),e(O,ya),e(O,Xt),e(Xt,wa),co=!0},p(i,[v]){const Ue={};v&2&&(Ue.$$scope={dirty:v,ctx:i}),X.$set(Ue);const Kt={};v&2&&(Kt.$$scope={dirty:v,ctx:i}),oe.$set(Kt);const Qt={};v&2&&(Qt.$$scope={dirty:v,ctx:i}),se.$set(Qt);const Yt={};v&2&&(Yt.$$scope={dirty:v,ctx:i}),ie.$set(Yt);const Je={};v&2&&(Je.$$scope={dirty:v,ctx:i}),le.$set(Je)},i(i){co||(k(c.$$.fragment,i),k($e.$$.fragment,i),k(ke.$$.fragment,i),k(X.$$.fragment,i),k(Pe.$$.fragment,i),k(oe.$$.fragment,i),k(Ee.$$.fragment,i),k(xe.$$.fragment,i),k(De.$$.fragment,i),k(ze.$$.fragment,i),k(se.$$.fragment,i),k(ie.$$.fragment,i),k(Oe.$$.fragment,i),k(qe.$$.fragment,i),k(le.$$.fragment,i),k(Fe.$$.fragment,i),k(Ie.$$.fragment,i),k(Le.$$.fragment,i),k(Ne.$$.fragment,i),k(We.$$.fragment,i),k(Me.$$.fragment,i),k(Ve.$$.fragment,i),co=!0)},o(i){P(c.$$.fragment,i),P($e.$$.fragment,i),P(ke.$$.fragment,i),P(X.$$.fragment,i),P(Pe.$$.fragment,i),P(oe.$$.fragment,i),P(Ee.$$.fragment,i),P(xe.$$.fragment,i),P(De.$$.fragment,i),P(ze.$$.fragment,i),P(se.$$.fragment,i),P(ie.$$.fragment,i),P(Oe.$$.fragment,i),P(qe.$$.fragment,i),P(le.$$.fragment,i),P(Fe.$$.fragment,i),P(Ie.$$.fragment,i),P(Le.$$.fragment,i),P(Ne.$$.fragment,i),P(We.$$.fragment,i),P(Me.$$.fragment,i),P(Ve.$$.fragment,i),co=!1},d(i){t(f),i&&t(b),i&&t(u),C(c),i&&t(ao),i&&t(H),i&&t(so),i&&t(D),i&&t(io),i&&t(R),C($e),i&&t(lo),i&&t(m),C(ke),C(X),C(Pe),C(oe),C(Ee),C(xe),C(De),C(ze),C(se),C(ie),C(Oe),C(qe),C(le),C(Fe),C(Ie),C(Le),C(Ne),C(We),C(Me),C(Ve)}}}const Is={local:"configuration",sections:[{local:"transformers.PretrainedConfig",title:"PretrainedConfig"}],title:"Configuration"};function Ls(z){return js(()=>{new URLSearchParams(window.location.search).get("fw")}),[]}class Us extends Es{constructor(f){super();xs(this,f,Ls,Fs,Ts,{})}}export{Us as default,Is as metadata};
