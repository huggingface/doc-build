import{S as ls,i as ds,s as cs,e as n,k as m,w as b,t as s,M as hs,c as a,d as o,m as f,a as i,x as $,h as r,b as c,N as ps,G as e,g as _,y as S,q as y,o as T,B as x,v as ms,L as uo}from"../../chunks/vendor-hf-doc-builder.js";import{T as ua}from"../../chunks/Tip-hf-doc-builder.js";import{D as He}from"../../chunks/Docstring-hf-doc-builder.js";import{C as go}from"../../chunks/CodeBlock-hf-doc-builder.js";import{I as dt}from"../../chunks/IconCopyLink-hf-doc-builder.js";import{E as fo}from"../../chunks/ExampleCodeBlock-hf-doc-builder.js";function fs(M){let d,w;return d=new go({props:{code:`from transformers import SwinModel, SwinConfig
...
<span class="hljs-meta">&gt;&gt;&gt; </span>configuration = model.config`}}),{c(){b(d.$$.fragment)},l(p){$(d.$$.fragment,p)},m(p,u){S(d,p,u),w=!0},p:uo,i(p){w||(y(d.$$.fragment,p),w=!0)},o(p){T(d.$$.fragment,p),w=!1},d(p){x(d,p)}}}function us(M){let d,w,p,u,v;return{c(){d=n("p"),w=s("Although the recipe for forward pass needs to be defined within this function, one should call the "),p=n("code"),u=s("Module"),v=s(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(l){d=a(l,"P",{});var g=i(d);w=r(g,"Although the recipe for forward pass needs to be defined within this function, one should call the "),p=a(g,"CODE",{});var F=i(p);u=r(F,"Module"),F.forEach(o),v=r(g,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),g.forEach(o)},m(l,g){_(l,d,g),e(d,w),e(d,p),e(p,u),e(d,v)},d(l){l&&o(d)}}}function gs(M){let d,w,p,u,v;return u=new go({props:{code:`from transformers import AutoFeatureExtractor, SwinModel
import torch
...
[<span class="hljs-number">1</span>, <span class="hljs-number">49</span>, <span class="hljs-number">768</span>]`}}),{c(){d=n("p"),w=s("Example:"),p=m(),b(u.$$.fragment)},l(l){d=a(l,"P",{});var g=i(d);w=r(g,"Example:"),g.forEach(o),p=f(l),$(u.$$.fragment,l)},m(l,g){_(l,d,g),e(d,w),_(l,p,g),S(u,l,g),v=!0},p:uo,i(l){v||(y(u.$$.fragment,l),v=!0)},o(l){T(u.$$.fragment,l),v=!1},d(l){l&&o(d),l&&o(p),x(u,l)}}}function _s(M){let d,w,p,u,v;return{c(){d=n("p"),w=s("Although the recipe for forward pass needs to be defined within this function, one should call the "),p=n("code"),u=s("Module"),v=s(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(l){d=a(l,"P",{});var g=i(d);w=r(g,"Although the recipe for forward pass needs to be defined within this function, one should call the "),p=a(g,"CODE",{});var F=i(p);u=r(F,"Module"),F.forEach(o),v=r(g,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),g.forEach(o)},m(l,g){_(l,d,g),e(d,w),e(d,p),e(p,u),e(d,v)},d(l){l&&o(d)}}}function ws(M){let d,w,p,u,v;return u=new go({props:{code:`from transformers import AutoFeatureExtractor, SwinForMaskedImageModeling
import torch
...
[<span class="hljs-number">1</span>, <span class="hljs-number">3</span>, <span class="hljs-number">224</span>, <span class="hljs-number">224</span>]`}}),{c(){d=n("p"),w=s("Examples:"),p=m(),b(u.$$.fragment)},l(l){d=a(l,"P",{});var g=i(d);w=r(g,"Examples:"),g.forEach(o),p=f(l),$(u.$$.fragment,l)},m(l,g){_(l,d,g),e(d,w),_(l,p,g),S(u,l,g),v=!0},p:uo,i(l){v||(y(u.$$.fragment,l),v=!0)},o(l){T(u.$$.fragment,l),v=!1},d(l){l&&o(d),l&&o(p),x(u,l)}}}function vs(M){let d,w,p,u,v;return{c(){d=n("p"),w=s("Although the recipe for forward pass needs to be defined within this function, one should call the "),p=n("code"),u=s("Module"),v=s(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(l){d=a(l,"P",{});var g=i(d);w=r(g,"Although the recipe for forward pass needs to be defined within this function, one should call the "),p=a(g,"CODE",{});var F=i(p);u=r(F,"Module"),F.forEach(o),v=r(g,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),g.forEach(o)},m(l,g){_(l,d,g),e(d,w),e(d,p),e(p,u),e(d,v)},d(l){l&&o(d)}}}function bs(M){let d,w,p,u,v;return u=new go({props:{code:`from transformers import AutoFeatureExtractor, SwinForImageClassification
import torch
from datasets import load_dataset
...
tabby, tabby cat`}}),{c(){d=n("p"),w=s("Example:"),p=m(),b(u.$$.fragment)},l(l){d=a(l,"P",{});var g=i(d);w=r(g,"Example:"),g.forEach(o),p=f(l),$(u.$$.fragment,l)},m(l,g){_(l,d,g),e(d,w),_(l,p,g),S(u,l,g),v=!0},p:uo,i(l){v||(y(u.$$.fragment,l),v=!0)},o(l){T(u.$$.fragment,l),v=!1},d(l){l&&o(d),l&&o(p),x(u,l)}}}function $s(M){let d,w,p,u,v,l,g,F,_o,Lt,N,J,ct,ge,wo,ht,vo,Ht,L,bo,_e,$o,So,yo,Wt,We,To,Ut,Ue,pt,xo,Bt,Be,ko,Vt,O,we,Mo,Ve,Eo,Fo,Co,ve,jo,mt,Io,Ao,Po,k,qo,ft,zo,Oo,ut,Do,No,gt,Lo,Ho,_t,Wo,Uo,wt,Bo,Vo,vt,Ko,Ro,bt,Yo,Zo,Kt,Q,ga,Rt,X,Go,Ke,Jo,Qo,Yt,D,Xo,be,en,tn,$e,on,nn,Zt,H,ee,$t,Se,an,St,sn,Gt,C,ye,rn,W,ln,Re,dn,cn,Te,hn,pn,mn,U,fn,Ye,un,gn,Ze,_n,wn,vn,te,Jt,B,oe,yt,xe,bn,Tt,$n,Qt,q,ke,Sn,Me,yn,Ee,Tn,xn,kn,I,Fe,Mn,V,En,Ge,Fn,Cn,xt,jn,In,An,ne,Pn,ae,Xt,K,se,kt,Ce,qn,Mt,zn,eo,z,je,On,R,Dn,Et,Nn,Ln,Ie,Hn,Wn,Un,A,Ae,Bn,Y,Vn,Je,Kn,Rn,Ft,Yn,Zn,Gn,re,Jn,ie,to,Z,le,Ct,Pe,Qn,jt,Xn,oo,j,qe,ea,It,ta,oa,ze,na,Oe,aa,sa,ra,P,De,ia,G,la,Qe,da,ca,At,ha,pa,ma,de,fa,ce,no;return l=new dt({}),ge=new dt({}),Se=new dt({}),ye=new He({props:{name:"class transformers.SwinConfig",anchor:"transformers.SwinConfig",parameters:[{name:"image_size",val:" = 224"},{name:"patch_size",val:" = 4"},{name:"num_channels",val:" = 3"},{name:"embed_dim",val:" = 96"},{name:"depths",val:" = [2, 2, 6, 2]"},{name:"num_heads",val:" = [3, 6, 12, 24]"},{name:"window_size",val:" = 7"},{name:"mlp_ratio",val:" = 4.0"},{name:"qkv_bias",val:" = True"},{name:"hidden_dropout_prob",val:" = 0.0"},{name:"attention_probs_dropout_prob",val:" = 0.0"},{name:"drop_path_rate",val:" = 0.1"},{name:"hidden_act",val:" = 'gelu'"},{name:"use_absolute_embeddings",val:" = False"},{name:"patch_norm",val:" = True"},{name:"initializer_range",val:" = 0.02"},{name:"layer_norm_eps",val:" = 1e-05"},{name:"encoder_stride",val:" = 32"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.SwinConfig.image_size",description:`<strong>image_size</strong> (<code>int</code>, <em>optional</em>, defaults to 224) &#x2014;
...
<p>Example &#x2014;`,name:"encoder_stride"}],source:"https://github.com/huggingface/transformers/blob/v4.19.4/src/transformers/models/swin/configuration_swin.py#L29"}}),te=new fo({props:{anchor:"transformers.SwinConfig.example",$$slots:{default:[fs]},$$scope:{ctx:M}}}),xe=new dt({}),ke=new He({props:{name:"class transformers.SwinModel",anchor:"transformers.SwinModel",parameters:[{name:"config",val:""},{name:"add_pooling_layer",val:" = True"},{name:"use_mask_token",val:" = False"}],parametersDescription:[{anchor:"transformers.SwinModel.config",description:`<strong>config</strong> (<a href="/docs/transformers/v4.19.4/en/model_doc/swin#transformers.SwinConfig">SwinConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/v4.19.4/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/v4.19.4/src/transformers/models/swin/modeling_swin.py#L905"}}),Fe=new He({props:{name:"forward",anchor:"transformers.SwinModel.forward",parameters:[{name:"pixel_values",val:": typing.Optional[torch.FloatTensor] = None"},{name:"bool_masked_pos",val:": typing.Optional[torch.BoolTensor] = None"},{name:"head_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.SwinModel.forward.pixel_values",description:`<strong>pixel_values</strong> (<code>torch.FloatTensor</code> of shape <code>(batch_size, num_channels, height, width)</code>) &#x2014;
Pixel values. Pixel values can be obtained using <a href="/docs/transformers/v4.19.4/en/model_doc/auto#transformers.AutoFeatureExtractor">AutoFeatureExtractor</a>. See
...
Whether or not to return a <a href="/docs/transformers/v4.19.4/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/v4.19.4/src/transformers/models/swin/modeling_swin.py#L932",returnDescription:`
<p>A <code>transformers.models.swin.modeling_swin.SwinModelOutput</code> or a tuple of
<code>torch.FloatTensor</code> (if <code>return_dict=False</code> is passed or when <code>config.return_dict=False</code>) comprising various
elements depending on the configuration (<a
  href="/docs/transformers/v4.19.4/en/model_doc/swin#transformers.SwinConfig"
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/v4.19.4/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/v4.19.4/src/transformers/models/swin/modeling_swin.py#L1003"}}),Ae=new He({props:{name:"forward",anchor:"transformers.SwinForMaskedImageModeling.forward",parameters:[{name:"pixel_values",val:": typing.Optional[torch.FloatTensor] = None"},{name:"bool_masked_pos",val:": typing.Optional[torch.BoolTensor] = None"},{name:"head_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.SwinForMaskedImageModeling.forward.pixel_values",description:`<strong>pixel_values</strong> (<code>torch.FloatTensor</code> of shape <code>(batch_size, num_channels, height, width)</code>) &#x2014;
Pixel values. Pixel values can be obtained using <a href="/docs/transformers/v4.19.4/en/model_doc/auto#transformers.AutoFeatureExtractor">AutoFeatureExtractor</a>. See
...
Boolean masked positions. Indicates which patches are masked (1) and which aren&#x2019;t (0).`,name:"bool_masked_pos"}],source:"https://github.com/huggingface/transformers/blob/v4.19.4/src/transformers/models/swin/modeling_swin.py#L1018",returnDescription:`
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/v4.19.4/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/v4.19.4/src/transformers/models/swin/modeling_swin.py#L1113"}}),De=new He({props:{name:"forward",anchor:"transformers.SwinForImageClassification.forward",parameters:[{name:"pixel_values",val:": typing.Optional[torch.FloatTensor] = None"},{name:"head_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"labels",val:": typing.Optional[torch.LongTensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.SwinForImageClassification.forward.pixel_values",description:`<strong>pixel_values</strong> (<code>torch.FloatTensor</code> of shape <code>(batch_size, num_channels, height, width)</code>) &#x2014;
Pixel values. Pixel values can be obtained using <a href="/docs/transformers/v4.19.4/en/model_doc/auto#transformers.AutoFeatureExtractor">AutoFeatureExtractor</a>. See
...
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.19.4/src/transformers/models/swin/modeling_swin.py#L1128",returnDescription:`
...
`}}),de=new ua({props:{$$slots:{default:[vs]},$$scope:{ctx:M}}}),ce=new fo({props:{anchor:"transformers.SwinForImageClassification.forward.example",$$slots:{default:[bs]},$$scope:{ctx:M}}}),{c(){d=n("meta"),w=m(),p=n("h1"),u=n("a"),v=n("span"),b(l.$$.fragment),g=m(),F=n("span"),_o=s("Swin Transformer"),Lt=m(),N=n("h2"),J=n("a"),ct=n("span"),b(ge.$$.fragment),wo=m(),ht=n("span"),vo=s("Overview"),Ht=m(),L=n("p"),bo=s("The Swin Transformer was proposed in "),_e=n("a"),$o=s("Swin Transformer: Hierarchical Vision Transformer using Shifted Windows"),So=n("br"),yo=s(`
...
documentation from `),Ze=n("a"),_n=s("PretrainedConfig"),wn=s(" for more information."),vn=m(),b(te.$$.fragment),Jt=m(),B=n("h2"),oe=n("a"),yt=n("span"),b(xe.$$.fragment),bn=m(),Tt=n("span"),$n=s("SwinModel"),Qt=m(),q=n("div"),b(ke.$$.fragment),Sn=m(),Me=n("p"),yn=s(`The bare Swin Model transformer outputting raw hidden-states without any specific head on top.
This model is a PyTorch `),Ee=n("a"),Tn=s("torch.nn.Module"),xn=s(` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),kn=m(),I=n("div"),b(Fe.$$.fragment),Mn=m(),V=n("p"),En=s("The "),Ge=n("a"),Fn=s("SwinModel"),Cn=s(" forward method, overrides the "),xt=n("code"),jn=s("__call__"),In=s(" special method."),An=m(),b(ne.$$.fragment),Pn=m(),b(ae.$$.fragment),Xt=m(),K=n("h2"),se=n("a"),kt=n("span"),b(Ce.$$.fragment),qn=m(),Mt=n("span"),zn=s("SwinForMaskedImageModeling"),eo=m(),z=n("div"),b(je.$$.fragment),On=m(),R=n("p"),Dn=s("Swin Model with a decoder on top for masked image modeling, as proposed in "),Et=n("code"),Nn=s("SimMIM <https://arxiv.org/abs/2111.09886>"),Ln=s(`__.
This model is a PyTorch `),Ie=n("a"),Hn=s("torch.nn.Module"),Wn=s(` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),Un=m(),A=n("div"),b(Ae.$$.fragment),Bn=m(),Y=n("p"),Vn=s("The "),Je=n("a"),Kn=s("SwinForMaskedImageModeling"),Rn=s(" forward method, overrides the "),Ft=n("code"),Yn=s("__call__"),Zn=s(" special method."),Gn=m(),b(re.$$.fragment),Jn=m(),b(ie.$$.fragment),to=m(),Z=n("h2"),le=n("a"),Ct=n("span"),b(Pe.$$.fragment),Qn=m(),jt=n("span"),Xn=s("SwinForImageClassification"),oo=m(),j=n("div"),b(qe.$$.fragment),ea=m(),It=n("p"),ta=s(`Swin Model transformer with an image classification head on top (a linear layer on top of the final hidden state of
the [CLS] token) e.g. for ImageNet.`),oa=m(),ze=n("p"),na=s("This model is a PyTorch "),Oe=n("a"),aa=s("torch.nn.Module"),sa=s(` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),ra=m(),P=n("div"),b(De.$$.fragment),ia=m(),G=n("p"),la=s("The "),Qe=n("a"),da=s("SwinForImageClassification"),ca=s(" forward method, overrides the "),At=n("code"),ha=s("__call__"),pa=s(" special method."),ma=m(),b(de.$$.fragment),fa=m(),b(ce.$$.fragment),this.h()},l(t){const h=hs('[data-svelte="svelte-1phssyn"]',document.head);d=a(h,"META",{name:!0,content:!0}),h.forEach(o),w=f(t),p=a(t,"H1",{class:!0});var Ne=i(p);u=a(Ne,"A",{id:!0,class:!0,href:!0});var Pt=i(u);v=a(Pt,"SPAN",{});var qt=i(v);$(l.$$.fragment,qt),qt.forEach(o),Pt.forEach(o),g=f(Ne),F=a(Ne,"SPAN",{});var zt=i(F);_o=r(zt,"Swin Transformer"),zt.forEach(o),Ne.forEach(o),Lt=f(t),N=a(t,"H2",{class:!0});var Le=i(N);J=a(Le,"A",{id:!0,class:!0,href:!0});var Ot=i(J);ct=a(Ot,"SPAN",{});var Dt=i(ct);$(ge.$$.fragment,Dt),Dt.forEach(o),Ot.forEach(o),wo=f(Le),ht=a(Le,"SPAN",{});var _a=i(ht);vo=r(_a,"Overview"),_a.forEach(o),Le.forEach(o),Ht=f(t),L=a(t,"P",{});var Nt=i(L);bo=r(Nt,"The Swin Transformer was proposed in "),_e=a(Nt,"A",{href:!0,rel:!0});var wa=i(_e);$o=r(wa,"Swin Transformer: Hierarchical Vision Transformer using Shifted Windows"),wa.forEach(o),So=a(Nt,"BR",{}),yo=r(Nt,`
by Ze Liu, Yutong Lin, Yue Cao, Han Hu, Yixuan Wei, Zheng Zhang, Stephen Lin, Baining Guo.`),Nt.forEach(o),Wt=f(t),We=a(t,"P",{});var va=i(We);To=r(va,"The abstract from the paper is the following:"),va.forEach(o),Ut=f(t),Ue=a(t,"P",{});var ba=i(Ue);pt=a(ba,"EM",{});var $a=i(pt);xo=r($a,`This paper presents a new vision Transformer, called Swin Transformer, that capably serves as a general-purpose backbone
for computer vision. Challenges in adapting Transformer from language to vision arise from differences between the two domains,
such as large variations in the scale of visual entities and the high resolution of pixels in images compared to words in text.
To address these differences, we propose a hierarchical Transformer whose representation is computed with \\bold{S}hifted
\\bold{win}dows. The shifted windowing scheme brings greater efficiency by limiting self-attention computation to non-overlapping
...
documentation from `),Ze=a(ot,"A",{href:!0});var Ha=i(Ze);_n=r(Ha,"PretrainedConfig"),Ha.forEach(o),wn=r(ot," for more information."),ot.forEach(o),vn=f(he),$(te.$$.fragment,he),he.forEach(o),Jt=f(t),B=a(t,"H2",{class:!0});var lo=i(B);oe=a(lo,"A",{id:!0,class:!0,href:!0});var Wa=i(oe);yt=a(Wa,"SPAN",{});var Ua=i(yt);$(xe.$$.fragment,Ua),Ua.forEach(o),Wa.forEach(o),bn=f(lo),Tt=a(lo,"SPAN",{});var Ba=i(Tt);$n=r(Ba,"SwinModel"),Ba.forEach(o),lo.forEach(o),Qt=f(t),q=a(t,"DIV",{class:!0});var nt=i(q);$(ke.$$.fragment,nt),Sn=f(nt),Me=a(nt,"P",{});var co=i(Me);yn=r(co,`The bare Swin Model transformer outputting raw hidden-states without any specific head on top.
