import{S as H_,i as K_,s as X_,e as s,k as u,w as v,t as n,M as Y_,c as r,d as t,m as p,a as i,x as y,h as a,b as l,G as e,g as m,y as b,q as L,o as w,B as k,v as Z_,L as ua}from"../../chunks/vendor-hf-doc-builder.js";import{T as ji}from"../../chunks/Tip-hf-doc-builder.js";import{D as A}from"../../chunks/Docstring-hf-doc-builder.js";import{C as G}from"../../chunks/CodeBlock-hf-doc-builder.js";import{I as ie}from"../../chunks/IconCopyLink-hf-doc-builder.js";import{E as da}from"../../chunks/ExampleCodeBlock-hf-doc-builder.js";function J_(P){let h,T,_,g,x;return g=new G({props:{code:`from transformers import LayoutLMv2Model, LayoutLMv2Config
...
<span class="hljs-meta">&gt;&gt;&gt; </span>end_scores = outputs.end_logits`}}),{c(){h=s("p"),T=n("Examples:"),_=u(),v(g.$$.fragment)},l(d){h=r(d,"P",{});var f=i(h);T=a(f,"Examples:"),f.forEach(t),_=p(d),y(g.$$.fragment,d)},m(d,f){m(d,h,f),e(h,T),m(d,_,f),b(g,d,f),x=!0},p:ua,i(d){x||(L(g.$$.fragment,d),x=!0)},o(d){w(g.$$.fragment,d),x=!1},d(d){d&&t(h),d&&t(_),k(g,d)}}}function cv(P){let h,T,_,g,x,d,f,D,Ci,sr,xe,Be,pa,Mo,Ii,ma,Ai,rr,ue,Di,$o,Oi,Ni,Jt,Si,Ri,ir,pe,H,Ui,Eo,Bi,Wi,zo,Vi,Qi,qo,Gi,Hi,Fo,Ki,Xi,Yi,Po,Zi,jo,Ji,el,ol,Co,tl,Io,nl,al,lr,en,sl,cr,on,ha,rl,dr,tn,il,ur,B,fa,ll,cl,Ao,dl,Do,ul,pl,ml,Oo,hl,No,fl,gl,_l,Te,vl,So,yl,bl,Ro,Ll,wl,kl,M,xl,ga,Tl,Ml,nn,$l,El,_a,zl,ql,va,Fl,Pl,ya,jl,Cl,ba,Il,Al,La,Dl,Ol,wa,Nl,Sl,ka,Rl,Ul,an,Bl,Wl,Uo,Vl,Ql,Bo,Gl,Hl,pr,Wo,mr,me,Kl,xa,Xl,Yl,Ta,Zl,Jl,hr,Vo,fr,We,ec,sn,oc,tc,gr,he,I,nc,rn,ac,sc,Ma,rc,ic,$a,lc,cc,ln,dc,uc,Ea,pc,mc,za,hc,fc,qa,gc,_c,vc,Qo,yc,cn,bc,Lc,wc,Go,kc,Fa,xc,Tc,_r,Ve,Mc,dn,$c,Ec,vr,Me,Qe,Pa,Ho,zc,ja,qc,yr,W,Fc,un,Pc,jc,pn,Cc,Ic,mn,Ac,Dc,hn,Oc,Nc,br,Ko,Lr,E,Sc,fn,Rc,Uc,gn,Bc,Wc,Ca,Vc,Qc,_n,Gc,Hc,vn,Kc,Xc,Ia,Yc,Zc,Aa,Jc,ed,Da,od,td,Oa,nd,ad,Na,sd,rd,wr,R,yn,id,ld,Xo,cd,dd,bn,ud,pd,Sa,md,hd,Ra,fd,gd,kr,Ln,_d,xr,wn,Ua,vd,Tr,kn,yd,Mr,Yo,$r,xn,Ba,bd,Er,fe,Ld,Wa,wd,kd,Va,xd,Td,zr,Zo,qr,Tn,Qa,Md,Fr,V,$d,Ga,Ed,zd,Ha,qd,Fd,Ka,Pd,jd,Xa,Cd,Id,Pr,Jo,jr,Mn,Ya,Ad,Cr,$n,Dd,Ir,et,Ar,En,Za,Od,Dr,zn,Nd,Or,ot,Nr,$e,Ge,Ja,tt,Sd,es,Rd,Sr,K,nt,Ud,Ee,Bd,qn,Wd,Vd,at,Qd,Gd,Hd,ze,Kd,Fn,Xd,Yd,Pn,Zd,Jd,eu,He,Rr,qe,Ke,os,st,ou,ts,tu,Ur,X,rt,nu,ns,au,su,it,ru,as,iu,lu,cu,ge,lt,du,ss,uu,pu,Xe,Br,Fe,Ye,rs,ct,mu,is,hu,Wr,O,dt,fu,N,gu,jn,_u,vu,ls,yu,bu,cs,Lu,wu,ds,ku,xu,us,Tu,Mu,ps,$u,Eu,zu,ut,qu,Cn,Fu,Pu,ju,In,An,Cu,Iu,Au,Ze,pt,Du,ms,Ou,Nu,Dn,mt,Vr,Pe,Je,hs,ht,Su,fs,Ru,Qr,Y,ft,Uu,gt,Bu,gs,Wu,Vu,Qu,_t,Gu,On,Hu,Ku,Xu,eo,vt,Yu,_s,Zu,Gr,je,oo,vs,yt,Ju,ys,ep,Hr,U,bt,op,bs,tp,np,Nn,Sn,ap,sp,rp,F,ip,Rn,lp,cp,Un,dp,up,Bn,pp,mp,Ls,hp,fp,ws,gp,_p,ks,vp,yp,xs,bp,Lp,Ts,wp,kp,Ms,xp,Tp,Mp,_e,Lt,$p,$,Ep,$s,zp,qp,wt,Es,Fp,Pp,jp,Wn,Cp,Ip,zs,Ap,Dp,qs,Op,Np,kt,Fs,Sp,Rp,Up,Ps,Bp,Wp,Vn,Vp,Qp,js,Gp,Hp,Cs,Kp,Xp,Is,Yp,Zp,As,Jp,em,om,Ds,tm,Kr,Ce,to,Os,xt,nm,Ns,am,Xr,le,Tt,sm,Mt,rm,$t,im,lm,cm,te,Et,dm,Ie,um,Qn,pm,mm,Ss,hm,fm,gm,no,_m,ao,Yr,Ae,so,Rs,zt,vm,Us,ym,Zr,Z,qt,bm,Ft,Lm,Pt,wm,km,xm,jt,Tm,Ct,Mm,$m,Em,ne,It,zm,De,qm,Gn,Fm,Pm,Bs,jm,Cm,Im,ro,Am,io,Jr,Oe,lo,Ws,At,Dm,Vs,Om,ei,J,Dt,Nm,ee,Sm,Ot,Rm,Um,Nt,Bm,Wm,St,Vm,Qm,Rt,Gm,Hm,Km,Ut,Xm,Bt,Ym,Zm,Jm,ae,Wt,eh,Ne,oh,Hn,th,nh,Qs,ah,sh,rh,co,ih,uo,oi,Se,po,Gs,Vt,lh,Hs,ch,ti,oe,Qt,dh,ce,uh,Gt,ph,mh,Ks,hh,fh,Xs,gh,_h,vh,Ht,yh,Kt,bh,Lh,wh,se,Xt,kh,Re,xh,Kn,Th,Mh,Ys,$h,Eh,zh,mo,qh,ho,ni;return d=new ie({}),Mo=new ie({}),Wo=new G({props:{code:`def normalize_bbox(bbox, width, height):
    return [
...
The vocabulary size of the <code>token_type_ids</code> passed when calling <a href="/docs/transformers/v4.19.4/en/model_doc/layoutlmv2#transformers.LayoutLMv2Model">LayoutLMv2Model</a> or
...
</ul>`,name:"return_tensors"}],source:"https://github.com/huggingface/transformers/blob/v4.19.4/src/transformers/models/layoutlmv2/feature_extraction_layoutlmv2.py#L123",returnDescription:`
<p>A <a
  href="/docs/transformers/v4.19.4/en/main_classes/feature_extractor#transformers.BatchFeature"
>BatchFeature</a> with the following fields:</p>
<ul>
<li><strong>pixel_values</strong> \u2014 Pixel values to be fed to a model, of shape (batch_size, num_channels, height,
width).</li>
<li><strong>words</strong> \u2014 Optional words as identified by Tesseract OCR (only when <a
  href="/docs/transformers/v4.19.4/en/model_doc/layoutlmv2#transformers.LayoutLMv2FeatureExtractor"
...
lengths).</li>
</ul>`,name:"padding"},{anchor:"transformers.LayoutLMv2Tokenizer.__call__.truncation",description:`<strong>truncation</strong> (<code>bool</code>, <code>str</code> or <a href="/docs/transformers/v4.19.4/en/internal/tokenization_utils#transformers.tokenization_utils_base.TruncationStrategy">TruncationStrategy</a>, <em>optional</em>, defaults to <code>False</code>) &#x2014;
...
<li><code>&apos;pt&apos;</code>: Return PyTorch <code>torch.Tensor</code> objects.</li>
<li><code>&apos;np&apos;</code>: Return Numpy <code>np.ndarray</code> objects.</li>
</ul>`,name:"return_tensors"}],source:"https://github.com/huggingface/transformers/blob/v4.19.4/src/transformers/models/layoutlmv2/tokenization_layoutlmv2.py#L414"}}),mt=new A({props:{name:"save_vocabulary",anchor:"transformers.LayoutLMv2Tokenizer.save_vocabulary",parameters:[{name:"save_directory",val:": str"},{name:"filename_prefix",val:": typing.Optional[str] = None"}],source:"https://github.com/huggingface/transformers/blob/v4.19.4/src/transformers/models/layoutlmv2/tokenization_layoutlmv2.py#L394"}}),ht=new ie({}),ft=new A({props:{name:"class transformers.LayoutLMv2TokenizerFast",anchor:"transformers.LayoutLMv2TokenizerFast",parameters:[{name:"vocab_file",val:" = None"},{name:"tokenizer_file",val:" = None"},{name:"do_lower_case",val:" = True"},{name:"unk_token",val:" = '[UNK]'"},{name:"sep_token",val:" = '[SEP]'"},{name:"pad_token",val:" = '[PAD]'"},{name:"cls_token",val:" = '[CLS]'"},{name:"mask_token",val:" = '[MASK]'"},{name:"cls_token_box",val:" = [0, 0, 0, 0]"},{name:"sep_token_box",val:" = [1000, 1000, 1000, 1000]"},{name:"pad_token_box",val:" = [0, 0, 0, 0]"},{name:"pad_token_label",val:" = -100"},{name:"only_label_first_subword",val:" = True"},{name:"tokenize_chinese_chars",val:" = True"},{name:"strip_accents",val:" = None"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.LayoutLMv2TokenizerFast.vocab_file",description:`<strong>vocab_file</strong> (<code>str</code>) &#x2014;
...
An instance of <a href="/docs/transformers/v4.19.4/en/model_doc/layoutlmv2#transformers.LayoutLMv2Tokenizer">LayoutLMv2Tokenizer</a> or <a href="/docs/transformers/v4.19.4/en/model_doc/layoutlmv2#transformers.LayoutLMv2TokenizerFast">LayoutLMv2TokenizerFast</a>. The tokenizer is a required input.`,name:"tokenizer"}],source:"https://github.com/huggingface/transformers/blob/v4.19.4/src/transformers/models/layoutlmv2/processing_layoutlmv2.py#L25"}}),Lt=new A({props:{name:"__call__",anchor:"transformers.LayoutLMv2Processor.__call__",parameters:[{name:"images",val:""},{name:"text",val:": typing.Union[str, typing.List[str], typing.List[typing.List[str]]] = None"},{name:"text_pair",val:": typing.Union[typing.List[str], typing.List[typing.List[str]], NoneType] = None"},{name:"boxes",val:": typing.Union[typing.List[typing.List[int]], typing.List[typing.List[typing.List[int]]]] = None"},{name:"word_labels",val:": typing.Union[typing.List[int], typing.List[typing.List[int]], NoneType] = None"},{name:"add_special_tokens",val:": bool = True"},{name:"padding",val:": typing.Union[bool, str, transformers.utils.generic.PaddingStrategy] = False"},{name:"truncation",val:": typing.Union[bool, str, transformers.tokenization_utils_base.TruncationStrategy] = False"},{name:"max_length",val:": typing.Optional[int] = None"},{name:"stride",val:": int = 0"},{name:"pad_to_multiple_of",val:": typing.Optional[int] = None"},{name:"return_token_type_ids",val:": typing.Optional[bool] = None"},{name:"return_attention_mask",val:": typing.Optional[bool] = None"},{name:"return_overflowing_tokens",val:": bool = False"},{name:"return_special_tokens_mask",val:": bool = False"},{name:"return_offsets_mapping",val:": bool = False"},{name:"return_length",val:": bool = False"},{name:"verbose",val:": bool = True"},{name:"return_tensors",val:": typing.Union[str, transformers.utils.generic.TensorType, NoneType] = None"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/v4.19.4/src/transformers/models/layoutlmv2/processing_layoutlmv2.py#L47"}}),xt=new ie({}),Tt=new A({props:{name:"class transformers.LayoutLMv2Model",anchor:"transformers.LayoutLMv2Model",parameters:[{name:"config",val:""}],parametersDescription:[{anchor:"transformers.LayoutLMv2Model.config",description:`<strong>config</strong> (<a href="/docs/transformers/v4.19.4/en/model_doc/layoutlmv2#transformers.LayoutLMv2Config">LayoutLMv2Config</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/v4.19.4/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/v4.19.4/src/transformers/models/layoutlmv2/modeling_layoutlmv2.py#L709"}}),Et=new A({props:{name:"forward",anchor:"transformers.LayoutLMv2Model.forward",parameters:[{name:"input_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"bbox",val:": typing.Optional[torch.LongTensor] = None"},{name:"image",val:": typing.Optional[torch.FloatTensor] = None"},{name:"attention_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"token_type_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"position_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"head_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.LayoutLMv2Model.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/v4.19.4/en/model_doc/layoutlmv2#transformers.LayoutLMv2Tokenizer">LayoutLMv2Tokenizer</a>. See <a href="/docs/transformers/v4.19.4/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
...
elements depending on the configuration (<a
  href="/docs/transformers/v4.19.4/en/model_doc/layoutlmv2#transformers.LayoutLMv2Config"
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/v4.19.4/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/v4.19.4/src/transformers/models/layoutlmv2/modeling_layoutlmv2.py#L954"}}),It=new A({props:{name:"forward",anchor:"transformers.LayoutLMv2ForSequenceClassification.forward",parameters:[{name:"input_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"bbox",val:": typing.Optional[torch.LongTensor] = None"},{name:"image",val:": typing.Optional[torch.FloatTensor] = None"},{name:"attention_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"token_type_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"position_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"head_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"labels",val:": typing.Optional[torch.LongTensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.LayoutLMv2ForSequenceClassification.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>batch_size, sequence_length</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/v4.19.4/en/model_doc/layoutlmv2#transformers.LayoutLMv2Tokenizer">LayoutLMv2Tokenizer</a>. See <a href="/docs/transformers/v4.19.4/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/v4.19.4/en/model_doc/wav2vec2#transformers.Wav2Vec2CTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.19.4/src/transformers/models/layoutlmv2/modeling_layoutlmv2.py#L968",returnDescription:`
<p>A <a
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/v4.19.4/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/v4.19.4/src/transformers/models/layoutlmv2/modeling_layoutlmv2.py#L1123"}}),Wt=new A({props:{name:"forward",anchor:"transformers.LayoutLMv2ForTokenClassification.forward",parameters:[{name:"input_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"bbox",val:": typing.Optional[torch.LongTensor] = None"},{name:"image",val:": typing.Optional[torch.FloatTensor] = None"},{name:"attention_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"token_type_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"position_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"head_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"labels",val:": typing.Optional[torch.LongTensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.LayoutLMv2ForTokenClassification.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>batch_size, sequence_length</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/v4.19.4/en/model_doc/layoutlmv2#transformers.LayoutLMv2Tokenizer">LayoutLMv2Tokenizer</a>. See <a href="/docs/transformers/v4.19.4/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/v4.19.4/en/model_doc/wav2vec2#transformers.Wav2Vec2CTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.19.4/src/transformers/models/layoutlmv2/modeling_layoutlmv2.py#L1137",returnDescription:`
<p>A <a
...
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/v4.19.4/src/transformers/models/layoutlmv2/modeling_layoutlmv2.py#L1246",returnDescription:`
<p>A <a
...
`}}),mo=new ji({props:{$$slots:{default:[iv]},$$scope:{ctx:P}}}),ho=new da({props:{anchor:"transformers.LayoutLMv2ForQuestionAnswering.forward.example",$$slots:{default:[lv]},$$scope:{ctx:P}}}),{c(){h=s("meta"),T=u(),_=s("h1"),g=s("a"),x=s("span"),v(d.$$.fragment),f=u(),D=s("span"),Ci=n("LayoutLMV2"),sr=u(),xe=s("h2"),Be=s("a"),pa=s("span"),v(Mo.$$.fragment),Ii=u(),ma=s("span"),Ai=n("Overview"),rr=u(),ue=s("p"),Di=n("The LayoutLMV2 model was proposed in "),$o=s("a"),Oi=n("LayoutLMv2: Multi-modal Pre-training for Visually-Rich Document Understanding"),Ni=n(` by Yang Xu, Yiheng Xu, Tengchao Lv, Lei Cui, Furu Wei, Guoxin Wang, Yijuan Lu,
Dinei Florencio, Cha Zhang, Wanxiang Che, Min Zhang, Lidong Zhou. LayoutLMV2 improves `),Jt=s("a"),Si=n("LayoutLM"),Ri=n(` to obtain
state-of-the-art results across several document image understanding benchmarks:`),ir=u(),pe=s("ul"),H=s("li"),Ui=n("information extraction from scanned documents: the "),Eo=s("a"),Bi=n("FUNSD"),Wi=n(` dataset (a
...
a 0-1000 scale. To normalize, you can use the following function:`),pr=u(),v(Wo.$$.fragment),mr=u(),me=s("p"),Kl=n("Here, "),xa=s("code"),Xl=n("width"),Yl=n(" and "),Ta=s("code"),Zl=n("height"),Jl=n(` correspond to the width and height of the original document in which the token
...
`),qa=s("code"),gc=n("config.image_feature_pool_shape[1]"),_c=n("."),vc=u(),Qo=s("li"),yc=n("When calling "),cn=s("a"),bc=n("from_pretrained()"),Lc=n(`, a warning will be printed with a long list of
parameter names that are not initialized. This is not a problem, as these parameters are batch normalization
statistics, which are going to have values when fine-tuning on a custom dataset.`),wc=u(),Go=s("li"),kc=n("If you want to train the model in a distributed environment, make sure to call "),Fa=s("code"),xc=n("synchronize_batch_norm"),Tc=n(` on the
...
`),dn=s("a"),$c=n("LayoutXLM\u2019s documentation page"),Ec=n("."),vr=u(),Me=s("h2"),Qe=s("a"),Pa=s("span"),v(Ho.$$.fragment),zc=u(),ja=s("span"),qc=n("Usage: LayoutLMv2Processor"),yr=u(),W=s("p"),Fc=n("The easiest way to prepare data for the model is to use "),un=s("a"),Pc=n("LayoutLMv2Processor"),jc=n(`, which internally
...
the processor.`),zr=u(),v(Zo.$$.fragment),qr=u(),Tn=s("p"),Qa=s("strong"),Md=n("Use case 3: token classification (training), apply_ocr=False"),Fr=u(),V=s("p"),$d=n(`For token classification tasks (such as FUNSD, CORD, SROIE, Kleister-NDA), one can also provide the corresponding word
...
`),at=s("a"),Qd=n("microsoft/layoutlmv2-base-uncased"),Gd=n(" architecture."),Hd=u(),ze=s("p"),Kd=n("Configuration objects inherit from "),Fn=s("a"),Xd=n("PretrainedConfig"),Yd=n(` and can be used to control the model outputs. Read the
documentation from `),Pn=s("a"),Zd=n("PretrainedConfig"),Jd=n(" for more information."),eu=u(),v(He.$$.fragment),Rr=u(),qe=s("h2"),Ke=s("a"),os=s("span"),v(st.$$.fragment),ou=u(),ts=s("span"),tu=n("LayoutLMv2FeatureExtractor"),Ur=u(),X=s("div"),v(rt.$$.fragment),nu=u(),ns=s("p"),au=n(`Constructs a LayoutLMv2 feature extractor. This can be used to resize document images to the same size, as well as
...
optional `),ps=s("code"),$u=n("labels"),Eu=n(" (for token classification)."),zu=u(),ut=s("p"),qu=n("This tokenizer inherits from "),Cn=s("a"),Fu=n("PreTrainedTokenizer"),Pu=n(` which contains most of the main methods. Users should refer to
...
single processor.`),np=u(),Nn=s("p"),Sn=s("a"),ap=n("LayoutLMv2Processor"),sp=n(" offers all the functionalities you need to prepare data for the model."),rp=u(),F=s("p"),ip=n("It first uses "),Rn=s("a"),lp=n("LayoutLMv2FeatureExtractor"),cp=n(` to resize document images to a fixed size, and optionally applies OCR
to get words and normalized bounding boxes. These are then provided to `),Un=s("a"),dp=n("LayoutLMv2Tokenizer"),up=n(` or
`),Bn=s("a"),pp=n("LayoutLMv2TokenizerFast"),mp=n(", which turns the words and bounding boxes into token-level "),Ls=s("code"),hp=n("input_ids"),fp=n(`,
...
into token-level `),Ms=s("code"),xp=n("labels"),Tp=n(" for token classification tasks (such as FUNSD, CORD)."),Mp=u(),_e=s("div"),v(Lt.$$.fragment),$p=u(),$=s("p"),Ep=n("This method first forwards the "),$s=s("code"),zp=n("images"),qp=n(" argument to "),wt=s("a"),Es=s("strong"),Fp=n("call"),Pp=n("()"),jp=n(`. In case
`),Wn=s("a"),Cp=n("LayoutLMv2FeatureExtractor"),Ip=n(" was initialized with "),zs=s("code"),Ap=n("apply_ocr"),Dp=n(" set to "),qs=s("code"),Op=n("True"),Np=n(`, it passes the obtained words and
bounding boxes along with the additional arguments to `),kt=s("a"),Fs=s("strong"),Sp=n("call"),Rp=n("()"),Up=n(` and returns the output,
together with resized `),Ps=s("code"),Bp=n("images"),Wp=n(". In case "),Vn=s("a"),Vp=n("LayoutLMv2FeatureExtractor"),Qp=n(" was initialized with "),js=s("code"),Gp=n("apply_ocr"),Hp=n(` set to
...
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),Em=u(),ne=s("div"),v(It.$$.fragment),zm=u(),De=s("p"),qm=n("The "),Gn=s("a"),Fm=n("LayoutLMv2ForSequenceClassification"),Pm=n(" forward method, overrides the "),Bs=s("code"),jm=n("__call__"),Cm=n(" special method."),Im=u(),v(ro.$$.fragment),Am=u(),v(io.$$.fragment),Jr=u(),Oe=s("h2"),lo=s("a"),Ws=s("span"),v(At.$$.fragment),Dm=u(),Vs=s("span"),Om=n("LayoutLMv2ForTokenClassification"),ei=u(),J=s("div"),v(Dt.$$.fragment),Nm=u(),ee=s("p"),Sm=n(`LayoutLMv2 Model with a token classification head on top (a linear layer on top of the text part of the hidden
states) e.g. for sequence labeling (information extraction) tasks such as
`),Ot=s("a"),Rm=n("FUNSD"),Um=n(", "),Nt=s("a"),Bm=n("SROIE"),Wm=n(`,
`),St=s("a"),Vm=n("CORD"),Qm=n(" and "),Rt=s("a"),Gm=n("Kleister-NDA"),Hm=n("."),Km=u(),Ut=s("p"),Xm=n("This model is a PyTorch "),Bt=s("a"),Ym=n("torch.nn.Module"),Zm=n(` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),Jm=u(),ae=s("div"),v(Wt.$$.fragment),eh=u(),Ne=s("p"),oh=n("The "),Hn=s("a"),th=n("LayoutLMv2ForTokenClassification"),nh=n(" forward method, overrides the "),Qs=s("code"),ah=n("__call__"),sh=n(" special method."),rh=u(),v(co.$$.fragment),ih=u(),v(uo.$$.fragment),oi=u(),Se=s("h2"),po=s("a"),Gs=s("span"),v(Vt.$$.fragment),lh=u(),Hs=s("span"),ch=n("LayoutLMv2ForQuestionAnswering"),ti=u(),oe=s("div"),v(Qt.$$.fragment),dh=u(),ce=s("p"),uh=n(`LayoutLMv2 Model with a span classification head on top for extractive question-answering tasks such as
...
state-of-the-art results across several document image understanding benchmarks:`),Ue.forEach(t),ir=p(o),pe=r(o,"UL",{});var Xn=i(pe);H=r(Xn,"LI",{});var ve=i(H);Ui=a(ve,"information extraction from scanned documents: the "),Eo=r(ve,"A",{href:!0,rel:!0});var Ah=i(Eo);Bi=a(Ah,"FUNSD"),Ah.forEach(t),Wi=a(ve,` dataset (a
...
questions defined on 12,000+ document images).`),si.forEach(t),Xn.forEach(t),lr=p(o),en=r(o,"P",{});var Uh=i(en);sl=a(Uh,"The abstract from the paper is the following:"),Uh.forEach(t),cr=p(o),on=r(o,"P",{});var Bh=i(on);ha=r(Bh,"EM",{});var Wh=i(ha);rl=a(Wh,`Pre-training of text and layout has proved effective in a variety of visually-rich document understanding tasks due to
its effective model architecture and the advantage of large-scale unlabeled scanned/digital-born documents. In this
paper, we present LayoutLMv2 by pre-training text, layout and image in a multi-modal framework, where new model
architectures and pre-training tasks are leveraged. Specifically, LayoutLMv2 not only uses the existing masked
visual-language modeling task but also the new text-image alignment and text-image matching tasks in the pre-training
...
including FUNSD (0.7895 -> 0.8420), CORD (0.9493 -> 0.9601), SROIE (0.9524 -> 0.9781), Kleister-NDA (0.834 -> 0.852),
RVL-CDIP (0.9443 -> 0.9564), and DocVQA (0.7295 -> 0.8672). The pre-trained LayoutLMv2 model is publicly available at
this https URL.`),Wh.forEach(t),Bh.forEach(t),dr=p(o),tn=r(o,"P",{});var Vh=i(tn);il=a(Vh,"Tips:"),Vh.forEach(t),ur=p(o),B=r(o,"UL",{});var ye=i(B);fa=r(ye,"LI",{});var Qh=i(fa);ll=a(Qh,`The main difference between LayoutLMv1 and LayoutLMv2 is that the latter incorporates visual embeddings during
...
format, where (x0, y0) corresponds to the position of the upper left corner in the bounding box, and (x1, y1)
represents the position of the lower right corner. Note that one first needs to normalize the bounding boxes to be on
a 0-1000 scale. To normalize, you can use the following function:`),z.forEach(t),ye.forEach(t),pr=p(o),y(Wo.$$.fragment,o),mr=p(o),me=r(o,"P",{});var Zn=i(me);Kl=a(Zn,"Here, "),xa=r(Zn,"CODE",{});var df=i(xa);Xl=a(df,"width"),df.forEach(t),Yl=a(Zn," and "),Ta=r(Zn,"CODE",{});var uf=i(Ta);Zl=a(uf,"height"),uf.forEach(t),Jl=a(Zn,` correspond to the width and height of the original document in which the token
occurs (before resizing the image). Those can be obtained using the Python Image Library (PIL) library for example, as
follows:`),Zn.forEach(t),hr=p(o),y(Vo.$$.fragment,o),fr=p(o),We=r(o,"P",{});var li=i(We);ec=a(li,"However, this model includes a brand new "),sn=r(li,"A",{href:!0});var pf=i(sn);oc=a(pf,"LayoutLMv2Processor"),pf.forEach(t),tc=a(li,` which can be used to directly
prepare data for the model (including applying OCR under the hood). More information can be found in the \u201CUsage\u201D
...
`),dn=r(ui,"A",{href:!0});var wf=i(dn);$c=a(wf,"LayoutXLM\u2019s documentation page"),wf.forEach(t),Ec=a(ui,"."),ui.forEach(t),vr=p(o),Me=r(o,"H2",{class:!0});var pi=i(Me);Qe=r(pi,"A",{id:!0,class:!0,href:!0});var kf=i(Qe);Pa=r(kf,"SPAN",{});var xf=i(Pa);y(Ho.$$.fragment,xf),xf.forEach(t),kf.forEach(t),zc=p(pi),ja=r(pi,"SPAN",{});var Tf=i(ja);qc=a(Tf,"Usage: LayoutLMv2Processor"),Tf.forEach(t),pi.forEach(t),yr=p(o),W=r(o,"P",{});var be=i(W);Fc=a(be,"The easiest way to prepare data for the model is to use "),un=r(be,"A",{href:!0});var Mf=i(un);Pc=a(Mf,"LayoutLMv2Processor"),Mf.forEach(t),jc=a(be,`, which internally
...
handles the image modality, while the tokenizer handles the text modality. A processor combines both, which is ideal
for a multi-modal model like LayoutLMv2. Note that you can still use both separately, if you only want to handle one
modality.`),be.forEach(t),br=p(o),y(Ko.$$.fragment,o),Lr=p(o),E=r(o,"P",{});var j=i(E);Sc=a(j,"In short, one can provide a document image (and possibly additional data) to "),fn=r(j,"A",{href:!0});var qf=i(fn);Rc=a(qf,"LayoutLMv2Processor"),qf.forEach(t),Uc=a(j,`,
and it will create the inputs expected by the model. Internally, the processor first uses
...
the words and normalized bounding boxes.`),Hf.forEach(t),Mr=p(o),y(Yo.$$.fragment,o),$r=p(o),xn=r(o,"P",{});var Kf=i(xn);Ba=r(Kf,"STRONG",{});var Xf=i(Ba);bd=a(Xf,"Use case 2: document image classification (training, inference) + token classification (inference), apply_ocr=False"),Xf.forEach(t),Kf.forEach(t),Er=p(o),fe=r(o,"P",{});var ea=i(fe);Ld=a(ea,"In case one wants to do OCR themselves, one can initialize the feature extractor with "),Wa=r(ea,"CODE",{});var Yf=i(Wa);wd=a(Yf,"apply_ocr"),Yf.forEach(t),kd=a(ea,` set to
...
documentation from `),Pn=r(ta,"A",{href:!0});var _g=i(Pn);Zd=a(_g,"PretrainedConfig"),_g.forEach(t),Jd=a(ta," for more information."),ta.forEach(t),eu=p(fo),y(He.$$.fragment,fo),fo.forEach(t),Rr=p(o),qe=r(o,"H2",{class:!0});var hi=i(qe);Ke=r(hi,"A",{id:!0,class:!0,href:!0});var vg=i(Ke);os=r(vg,"SPAN",{});var yg=i(os);y(st.$$.fragment,yg),yg.forEach(t),vg.forEach(t),ou=p(hi),ts=r(hi,"SPAN",{});var bg=i(ts);tu=a(bg,"LayoutLMv2FeatureExtractor"),bg.forEach(t),hi.forEach(t),Ur=p(o),X=r(o,"DIV",{class:!0});var go=i(X);y(rt.$$.fragment,go),nu=p(go),ns=r(go,"P",{});var Lg=i(ns);au=a(Lg,`Constructs a LayoutLMv2 feature extractor. This can be used to resize document images to the same size, as well as
...
of the main methods. Users should refer to this superclass for more information regarding those methods.`),fi.forEach(t),cu=p(go),ge=r(go,"DIV",{class:!0});var na=i(ge);y(lt.$$.fragment,na),du=p(na),ss=r(na,"P",{});var kg=i(ss);uu=a(kg,"Main method to prepare for the model one or several image(s)."),kg.forEach(t),pu=p(na),y(Xe.$$.fragment,na),na.forEach(t),go.forEach(t),Br=p(o),Fe=r(o,"H2",{class:!0});var gi=i(Fe);Ye=r(gi,"A",{id:!0,class:!0,href:!0});var xg=i(Ye);rs=r(xg,"SPAN",{});var Tg=i(rs);y(ct.$$.fragment,Tg),Tg.forEach(t),xg.forEach(t),mu=p(gi),is=r(gi,"SPAN",{});var Mg=i(is);hu=a(Mg,"LayoutLMv2Tokenizer"),Mg.forEach(t),gi.forEach(t),Wr=p(o),O=r(o,"DIV",{class:!0});var re=i(O);y(dt.$$.fragment,re),fu=p(re),N=r(re,"P",{});var Q=i(N);gu=a(Q,"Construct a LayoutLMv2 tokenizer. Based on WordPiece. "),jn=r(Q,"A",{href:!0});var $g=i(jn);_u=a($g,"LayoutLMv2Tokenizer"),$g.forEach(t),vu=a(Q,` can be used to turn words, word-level
bounding boxes and optional word labels to token-level `),ls=r(Q,"CODE",{});var Eg=i(ls);yu=a(Eg,"input_ids"),Eg.forEach(t),bu=a(Q,", "),cs=r(Q,"CODE",{});var zg=i(cs);Lu=a(zg,"attention_mask"),zg.forEach(t),wu=a(Q,", "),ds=r(Q,"CODE",{});var qg=i(ds);ku=a(qg,"token_type_ids"),qg.forEach(t),xu=a(Q,", "),us=r(Q,"CODE",{});var Fg=i(us);Tu=a(Fg,"bbox"),Fg.forEach(t),Mu=a(Q,`, and
optional `),ps=r(Q,"CODE",{});var Pg=i(ps);$u=a(Pg,"labels"),Pg.forEach(t),Eu=a(Q," (for token classification)."),Q.forEach(t),zu=p(re),ut=r(re,"P",{});var _i=i(ut);qu=a(_i,"This tokenizer inherits from "),Cn=r(_i,"A",{href:!0});var jg=i(Cn);Fu=a(jg,"PreTrainedTokenizer"),jg.forEach(t),Pu=a(_i,` which contains most of the main methods. Users should refer to
this superclass for more information regarding those methods.`),_i.forEach(t),ju=p(re),In=r(re,"P",{});var Fh=i(In);An=r(Fh,"A",{href:!0});var Cg=i(An);Cu=a(Cg,"LayoutLMv2Tokenizer"),Cg.forEach(t),Iu=a(Fh,` runs end-to-end tokenization: punctuation splitting and wordpiece. It also turns the
word-level bounding boxes into token-level bounding boxes.`),Fh.forEach(t),Au=p(re),Ze=r(re,"DIV",{class:!0});var vi=i(Ze);y(pt.$$.fragment,vi),Du=p(vi),ms=r(vi,"P",{});var Ig=i(ms);Ou=a(Ig,`Main method to tokenize and prepare for the model one or several sequence(s) or one or several pair(s) of
sequences with word-level normalized bounding boxes and optional labels.`),Ig.forEach(t),vi.forEach(t),Nu=p(re),Dn=r(re,"DIV",{class:!0});var Ag=i(Dn);y(mt.$$.fragment,Ag),Ag.forEach(t),re.forEach(t),Vr=p(o),Pe=r(o,"H2",{class:!0});var yi=i(Pe);Je=r(yi,"A",{id:!0,class:!0,href:!0});var Dg=i(Je);hs=r(Dg,"SPAN",{});var Og=i(hs);y(ht.$$.fragment,Og),Og.forEach(t),Dg.forEach(t),Su=p(yi),fs=r(yi,"SPAN",{});var Ng=i(fs);Ru=a(Ng,"LayoutLMv2TokenizerFast"),Ng.forEach(t),yi.forEach(t),Qr=p(o),Y=r(o,"DIV",{class:!0});var _o=i(Y);y(ft.$$.fragment,_o),Uu=p(_o),gt=r(_o,"P",{});var bi=i(gt);Bu=a(bi,"Construct a \u201Cfast\u201D LayoutLMv2 tokenizer (backed by HuggingFace\u2019s "),gs=r(bi,"EM",{});var Sg=i(gs);Wu=a(Sg,"tokenizers"),Sg.forEach(t),Vu=a(bi," library). Based on WordPiece."),bi.forEach(t),Qu=p(_o),_t=r(_o,"P",{});var Li=i(_t);Gu=a(Li,"This tokenizer inherits from "),On=r(Li,"A",{href:!0});var Rg=i(On);Hu=a(Rg,"PreTrainedTokenizerFast"),Rg.forEach(t),Ku=a(Li,` which contains most of the main methods. Users should
...
sequences with word-level normalized bounding boxes and optional labels.`),Ug.forEach(t),wi.forEach(t),_o.forEach(t),Gr=p(o),je=r(o,"H2",{class:!0});var ki=i(je);oo=r(ki,"A",{id:!0,class:!0,href:!0});var Bg=i(oo);vs=r(Bg,"SPAN",{});var Wg=i(vs);y(yt.$$.fragment,Wg),Wg.forEach(t),Bg.forEach(t),Ju=p(ki),ys=r(ki,"SPAN",{});var Vg=i(ys);ep=a(Vg,"LayoutLMv2Processor"),Vg.forEach(t),ki.forEach(t),Hr=p(o),U=r(o,"DIV",{class:!0});var we=i(U);y(bt.$$.fragment,we),op=p(we),bs=r(we,"P",{});var Qg=i(bs);tp=a(Qg,`Constructs a LayoutLMv2 processor which combines a LayoutLMv2 feature extractor and a LayoutLMv2 tokenizer into a
single processor.`),Qg.forEach(t),np=p(we),Nn=r(we,"P",{});var Ph=i(Nn);Sn=r(Ph,"A",{href:!0});var Gg=i(Sn);ap=a(Gg,"LayoutLMv2Processor"),Gg.forEach(t),sp=a(Ph," offers all the functionalities you need to prepare data for the model."),Ph.forEach(t),rp=p(we),F=r(we,"P",{});var C=i(F);ip=a(C,"It first uses "),Rn=r(C,"A",{href:!0});var Hg=i(Rn);lp=a(Hg,"LayoutLMv2FeatureExtractor"),Hg.forEach(t),cp=a(C,` to resize document images to a fixed size, and optionally applies OCR
...
`),Bn=r(C,"A",{href:!0});var Xg=i(Bn);pp=a(Xg,"LayoutLMv2TokenizerFast"),Xg.forEach(t),mp=a(C,", which turns the words and bounding boxes into token-level "),Ls=r(C,"CODE",{});var Yg=i(Ls);hp=a(Yg,"input_ids"),Yg.forEach(t),fp=a(C,`,
...
into token-level `),Ms=r(C,"CODE",{});var t_=i(Ms);xp=a(t_,"labels"),t_.forEach(t),Tp=a(C," for token classification tasks (such as FUNSD, CORD)."),C.forEach(t),Mp=p(we),_e=r(we,"DIV",{class:!0});var aa=i(_e);y(Lt.$$.fragment,aa),$p=p(aa),$=r(aa,"P",{});var q=i($);Ep=a(q,"This method first forwards the "),$s=r(q,"CODE",{});var n_=i($s);zp=a(n_,"images"),n_.forEach(t),qp=a(q," argument to "),wt=r(q,"A",{href:!0});var jh=i(wt);Es=r(jh,"STRONG",{});var a_=i(Es);Fp=a(a_,"call"),a_.forEach(t),Pp=a(jh,"()"),jh.forEach(t),jp=a(q,`. In case
`),Wn=r(q,"A",{href:!0});var s_=i(Wn);Cp=a(s_,"LayoutLMv2FeatureExtractor"),s_.forEach(t),Ip=a(q," was initialized with "),zs=r(q,"CODE",{});var r_=i(zs);Ap=a(r_,"apply_ocr"),r_.forEach(t),Dp=a(q," set to "),qs=r(q,"CODE",{});var i_=i(qs);Op=a(i_,"True"),i_.forEach(t),Np=a(q,`, it passes the obtained words and
bounding boxes along with the additional arguments to `),kt=r(q,"A",{href:!0});var Ch=i(kt);Fs=r(Ch,"STRONG",{});var l_=i(Fs);Sp=a(l_,"call"),l_.forEach(t),Rp=a(Ch,"()"),Ch.forEach(t),Up=a(q,` and returns the output,
together with resized `),Ps=r(q,"CODE",{});var c_=i(Ps);Bp=a(c_,"images"),c_.forEach(t),Wp=a(q,". In case "),Vn=r(q,"A",{href:!0});var d_=i(Vn);Vp=a(d_,"LayoutLMv2FeatureExtractor"),d_.forEach(t),Qp=a(q," was initialized with "),js=r(q,"CODE",{});var u_=i(js);Gp=a(u_,"apply_ocr"),u_.forEach(t),Hp=a(q,` set to
`),Cs=r(q,"CODE",{});var p_=i(Cs);Kp=a(p_,"False"),p_.forEach(t),Xp=a(q,", it passes the words ("),Is=r(q,"CODE",{});var m_=i(Is);Yp=a(m_,"text"),m_.forEach(t),Zp=a(q,"/"),As=r(q,"CODE",{});var h_=i(As);Jp=a(h_,"text_pair`) and `boxes` specified by the user along with the additional arguments to [__call__()](/docs/transformers/v4.19.4/en/model_doc/layoutlmv2#transformers.LayoutLMv2Tokenizer.__call__) and returns the output, together with resized `images"),h_.forEach(t),em=a(q,"."),q.forEach(t),om=p(aa),Ds=r(aa,"P",{});var f_=i(Ds);tm=a(f_,"Please refer to the docstring of the above two methods for more information."),f_.forEach(t),aa.forEach(t),we.forEach(t),Kr=p(o),Ce=r(o,"H2",{class:!0});var xi=i(Ce);to=r(xi,"A",{id:!0,class:!0,href:!0});var g_=i(to);Os=r(g_,"SPAN",{});var __=i(Os);y(xt.$$.fragment,__),__.forEach(t),g_.forEach(t),nm=p(xi),Ns=r(xi,"SPAN",{});var v_=i(Ns);am=a(v_,"LayoutLMv2Model"),v_.forEach(t),xi.forEach(t),Xr=p(o),le=r(o,"DIV",{class:!0});var sa=i(le);y(Tt.$$.fragment,sa),sm=p(sa),Mt=r(sa,"P",{});var Ti=i(Mt);rm=a(Ti,`The bare LayoutLMv2 Model transformer outputting raw hidden-states without any specific head on top.
This model is a PyTorch `),$t=r(Ti,"A",{href:!0,rel:!0});var y_=i($t);im=a(y_,"torch.nn.Module"),y_.forEach(t),lm=a(Ti,` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),Ti.forEach(t),cm=p(sa),te=r(sa,"DIV",{class:!0});var vo=i(te);y(Et.$$.fragment,vo),dm=p(vo),Ie=r(vo,"P",{});var ra=i(Ie);um=a(ra,"The "),Qn=r(ra,"A",{href:!0});var b_=i(Qn);pm=a(b_,"LayoutLMv2Model"),b_.forEach(t),mm=a(ra," forward method, overrides the "),Ss=r(ra,"CODE",{});var L_=i(Ss);hm=a(L_,"__call__"),L_.forEach(t),fm=a(ra," special method."),ra.forEach(t),gm=p(vo),y(no.$$.fragment,vo),_m=p(vo),y(ao.$$.fragment,vo),vo.forEach(t),sa.forEach(t),Yr=p(o),Ae=r(o,"H2",{class:!0});var Mi=i(Ae);so=r(Mi,"A",{id:!0,class:!0,href:!0});var w_=i(so);Rs=r(w_,"SPAN",{});var k_=i(Rs);y(zt.$$.fragment,k_),k_.forEach(t),w_.forEach(t),vm=p(Mi),Us=r(Mi,"SPAN",{});var x_=i(Us);ym=a(x_,"LayoutLMv2ForSequenceClassification"),x_.forEach(t),Mi.forEach(t),Zr=p(o),Z=r(o,"DIV",{class:!0});var yo=i(Z);y(qt.$$.fragment,yo),bm=p(yo),Ft=r(yo,"P",{});var $i=i(Ft);Lm=a($i,`LayoutLMv2 Model with a sequence classification head on top (a linear layer on top of the concatenation of the
final hidden state of the [CLS] token, average-pooled initial visual embeddings and average-pooled final visual
embeddings, e.g. for document image classification tasks such as the
...
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),Ei.forEach(t),Em=p(yo),ne=r(yo,"DIV",{class:!0});var bo=i(ne);y(It.$$.fragment,bo),zm=p(bo),De=r(bo,"P",{});var ia=i(De);qm=a(ia,"The "),Gn=r(ia,"A",{href:!0});var $_=i(Gn);Fm=a($_,"LayoutLMv2ForSequenceClassification"),$_.forEach(t),Pm=a(ia," forward method, overrides the "),Bs=r(ia,"CODE",{});var E_=i(Bs);jm=a(E_,"__call__"),E_.forEach(t),Cm=a(ia," special method."),ia.forEach(t),Im=p(bo),y(ro.$$.fragment,bo),Am=p(bo),y(io.$$.fragment,bo),bo.forEach(t),yo.forEach(t),Jr=p(o),Oe=r(o,"H2",{class:!0});var zi=i(Oe);lo=r(zi,"A",{id:!0,class:!0,href:!0});var z_=i(lo);Ws=r(z_,"SPAN",{});var q_=i(Ws);y(At.$$.fragment,q_),q_.forEach(t),z_.forEach(t),Dm=p(zi),Vs=r(zi,"SPAN",{});var F_=i(Vs);Om=a(F_,"LayoutLMv2ForTokenClassification"),F_.forEach(t),zi.forEach(t),ei=p(o),J=r(o,"DIV",{class:!0});var Lo=i(J);y(Dt.$$.fragment,Lo),Nm=p(Lo),ee=r(Lo,"P",{});var ke=i(ee);Sm=a(ke,`LayoutLMv2 Model with a token classification head on top (a linear layer on top of the text part of the hidden
states) e.g. for sequence labeling (information extraction) tasks such as
...
`),St=r(ke,"A",{href:!0,rel:!0});var C_=i(St);Vm=a(C_,"CORD"),C_.forEach(t),Qm=a(ke," and "),Rt=r(ke,"A",{href:!0,rel:!0});var I_=i(Rt);Gm=a(I_,"Kleister-NDA"),I_.forEach(t),Hm=a(ke,"."),ke.forEach(t),Km=p(Lo),Ut=r(Lo,"P",{});var qi=i(Ut);Xm=a(qi,"This model is a PyTorch "),Bt=r(qi,"A",{href:!0,rel:!0});var A_=i(Bt);Ym=a(A_,"torch.nn.Module"),A_.forEach(t),Zm=a(qi,` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),qi.forEach(t),Jm=p(Lo),ae=r(Lo,"DIV",{class:!0});var wo=i(ae);y(Wt.$$.fragment,wo),eh=p(wo),Ne=r(wo,"P",{});var la=i(Ne);oh=a(la,"The "),Hn=r(la,"A",{href:!0});var D_=i(Hn);th=a(D_,"LayoutLMv2ForTokenClassification"),D_.forEach(t),nh=a(la," forward method, overrides the "),Qs=r(la,"CODE",{});var O_=i(Qs);ah=a(O_,"__call__"),O_.forEach(t),sh=a(la," special method."),la.forEach(t),rh=p(wo),y(co.$$.fragment,wo),ih=p(wo),y(uo.$$.fragment,wo),wo.forEach(t),Lo.forEach(t),oi=p(o),Se=r(o,"H2",{class:!0});var Fi=i(Se);po=r(Fi,"A",{id:!0,class:!0,href:!0});var N_=i(po);Gs=r(N_,"SPAN",{});var S_=i(Gs);y(Vt.$$.fragment,S_),S_.forEach(t),N_.forEach(t),lh=p(Fi),Hs=r(Fi,"SPAN",{});var R_=i(Hs);ch=a(R_,"LayoutLMv2ForQuestionAnswering"),R_.forEach(t),Fi.forEach(t),ti=p(o),oe=r(o,"DIV",{class:!0});var ko=i(oe);y(Qt.$$.fragment,ko),dh=p(ko),ce=r(ko,"P",{});var xo=i(ce);uh=a(xo,`LayoutLMv2 Model with a span classification head on top for extractive question-answering tasks such as
