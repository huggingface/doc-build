import{S as py,i as hy,s as my,e as r,k as h,w as k,t as n,M as uy,c as a,d as t,m,a as i,x as y,h as s,b,G as e,g,y as w,q as M,o as $,B as F,v as fy,L as xe}from"../../chunks/vendor-hf-doc-builder.js";import{T as qe}from"../../chunks/Tip-hf-doc-builder.js";import{D as ie}from"../../chunks/Docstring-hf-doc-builder.js";import{C as ze}from"../../chunks/CodeBlock-hf-doc-builder.js";import{I as Pe}from"../../chunks/IconCopyLink-hf-doc-builder.js";import{E as Ee}from"../../chunks/ExampleCodeBlock-hf-doc-builder.js";function gy(E){let d,_,c,p,T;return p=new ze({props:{code:`from transformers import MobileBertModel, MobileBertConfig
...
the latter silently ignores them.`)},l(l){d=a(l,"P",{});var u=i(d);_=s(u,"Although the recipe for forward pass needs to be defined within this function, one should call the "),c=a(u,"CODE",{});var x=i(c);p=s(x,"Module"),x.forEach(t),T=s(u,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),u.forEach(t)},m(l,u){g(l,d,u),e(d,_),e(d,c),e(c,p),e(d,T)},d(l){l&&t(d)}}}function vy(E){let d,_,c,p,T;return p=new ze({props:{code:`from transformers import MobileBertTokenizer, MobileBertForPreTraining
import torch
...
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-built_in">round</span>(<span class="hljs-built_in">float</span>(loss), <span class="hljs-number">2</span>)
<span class="hljs-number">3.98</span>`}}),{c(){k(d.$$.fragment)},l(c){y(d.$$.fragment,c)},m(c,p){w(d,c,p),_=!0},p:xe,i(c){_||(M(d.$$.fragment,c),_=!0)},o(c){$(d.$$.fragment,c),_=!1},d(c){F(d,c)}}}function mw(E){let d,_,c,p,T,l,u,x,he,V,z,J,L,X,me,D,ue,le,K,N,ee,G,q,C,ne,U,de,se,W,fe,ce,P,ge,R,Z,re,H,_e,ae,O,pe,A,be,f,B,Y,ke,$e,S,we,Te,ve,j,I,Fe,ye,Q,Me,te,oe,Be,Mt,Ep,ya,xp,zp,wa,qp,Pp,is,Cp,jp,Np,Wt,Op,Ma,Sp,Ap,$a,Ip,Lp,Dp,Co,Wp,Pi,Rp,Ad,Rt,jo,Ci,ls,Up,ji,Hp,Id,st,ds,Qp,Ni,Kp,Vp,No,Fa,Gp,Yp,Ba,Jp,Zp,Xp,cs,eh,Ea,th,oh,Ld,Ut,Oo,Oi,ps,nh,Si,sh,Dd,rt,hs,rh,ms,ah,Ai,ih,lh,dh,So,xa,ch,ph,za,hh,mh,uh,us,fh,qa,gh,_h,Wd,Ht,Ao,Ii,fs,bh,Li,Th,Rd,Qt,gs,vh,_s,kh,Pa,yh,wh,Ud,Kt,bs,Mh,Ts,$h,Ca,Fh,Bh,Hd,Vt,Io,Di,vs,Eh,Wi,xh,Qd,je,ks,zh,Ri,qh,Ph,ys,Ch,ja,jh,Nh,Oh,ws,Sh,Ms,Ah,Ih,Lh,Ui,$s,Dh,Wh,it,Fs,Rh,Gt,Uh,Na,Hh,Qh,Hi,Kh,Vh,Gh,Lo,Yh,Do,Kd,Yt,Wo,Qi,Bs,Jh,Ki,Zh,Vd,Re,Es,Xh,Jt,em,Vi,tm,om,Gi,nm,sm,rm,xs,am,Oa,im,lm,dm,zs,cm,qs,pm,hm,mm,lt,Ps,um,Zt,fm,Sa,gm,_m,Yi,bm,Tm,vm,Ro,km,Uo,Gd,Xt,Ho,Ji,Cs,ym,Zi,wm,Yd,Ue,js,Mm,Ns,$m,Xi,Fm,Bm,Em,Os,xm,Aa,zm,qm,Pm,Ss,Cm,As,jm,Nm,Om,Ye,Is,Sm,eo,Am,Ia,Im,Lm,el,Dm,Wm,Rm,Qo,Um,Ko,Hm,Vo,Jd,to,Go,tl,Ls,Qm,ol,Km,Zd,He,Ds,Vm,Ws,Gm,nl,Ym,Jm,Zm,Rs,Xm,La,eu,tu,ou,Us,nu,Hs,su,ru,au,dt,Qs,iu,oo,lu,Da,du,cu,sl,pu,hu,mu,Yo,uu,Jo,Xd,no,Zo,rl,Ks,fu,al,gu,ec,Qe,Vs,_u,il,bu,Tu,Gs,vu,Wa,ku,yu,wu,Ys,Mu,Js,$u,Fu,Bu,Ce,Zs,Eu,so,xu,Ra,zu,qu,ll,Pu,Cu,ju,Xo,Nu,en,Ou,tn,Su,on,Au,nn,tc,ro,sn,dl,Xs,Iu,cl,Lu,oc,Ke,er,Du,pl,Wu,Ru,tr,Uu,Ua,Hu,Qu,Ku,or,Vu,nr,Gu,Yu,Ju,ct,sr,Zu,ao,Xu,Ha,ef,tf,hl,of,nf,sf,rn,rf,an,nc,io,ln,ml,rr,af,ul,lf,sc,Ve,ar,df,fl,cf,pf,ir,hf,Qa,mf,uf,ff,lr,gf,dr,_f,bf,Tf,Je,cr,vf,lo,kf,Ka,yf,wf,gl,Mf,$f,Ff,dn,Bf,cn,Ef,pn,rc,co,hn,_l,pr,xf,bl,zf,ac,Ge,hr,qf,po,Pf,Tl,Cf,jf,vl,Nf,Of,Sf,mr,Af,Va,If,Lf,Df,ur,Wf,fr,Rf,Uf,Hf,Ze,gr,Qf,ho,Kf,Ga,Vf,Gf,kl,Yf,Jf,Zf,mn,Xf,un,eg,fn,ic,mo,gn,yl,_r,tg,wl,og,lc,Ne,br,ng,Ml,sg,rg,Tr,ag,Ya,ig,lg,dg,vr,cg,kr,pg,hg,mg,_n,ug,pt,yr,fg,uo,gg,Ja,_g,bg,$l,Tg,vg,kg,bn,yg,Tn,dc,fo,vn,Fl,wr,wg,Bl,Mg,cc,Oe,Mr,$g,go,Fg,El,Bg,Eg,xl,xg,zg,qg,$r,Pg,Za,Cg,jg,Ng,Fr,Og,Br,Sg,Ag,Ig,kn,Lg,ht,Er,Dg,_o,Wg,Xa,Rg,Ug,zl,Hg,Qg,Kg,yn,Vg,wn,pc,bo,Mn,ql,xr,Gg,Pl,Yg,hc,Se,zr,Jg,qr,Zg,Cl,Xg,e_,t_,Pr,o_,ei,n_,s_,r_,Cr,a_,jr,i_,l_,d_,$n,c_,Xe,Nr,p_,To,h_,ti,m_,u_,jl,f_,g_,__,Fn,b_,Bn,T_,En,mc,vo,xn,Nl,Or,v_,Ol,k_,uc,Ae,Sr,y_,Ar,w_,Sl,M_,$_,F_,Ir,B_,oi,E_,x_,z_,Lr,q_,Dr,P_,C_,j_,zn,N_,mt,Wr,O_,ko,S_,ni,A_,I_,Al,L_,D_,W_,qn,R_,Pn,fc,yo,Cn,Il,Rr,U_,Ll,H_,gc,Ie,Ur,Q_,Dl,K_,V_,Hr,G_,si,Y_,J_,Z_,Qr,X_,Kr,eb,tb,ob,jn,nb,et,Vr,sb,wo,rb,ri,ab,ib,Wl,lb,db,cb,Nn,pb,On,hb,Sn,_c,Mo,An,Rl,Gr,mb,Ul,ub,bc,Le,Yr,fb,Hl,gb,_b,Jr,bb,ai,Tb,vb,kb,Zr,yb,Xr,wb,Mb,$b,In,Fb,ut,ea,Bb,$o,Eb,ii,xb,zb,Ql,qb,Pb,Cb,Ln,jb,Dn,Tc,Fo,Wn,Kl,ta,Nb,Vl,Ob,vc,De,oa,Sb,Gl,Ab,Ib,na,Lb,li,Db,Wb,Rb,sa,Ub,ra,Hb,Qb,Kb,Rn,Vb,tt,aa,Gb,Bo,Yb,di,Jb,Zb,Yl,Xb,eT,tT,Un,oT,Hn,nT,Qn,kc,Eo,Kn,Jl,ia,sT,Zl,rT,yc,We,la,aT,xo,iT,Xl,lT,dT,ed,cT,pT,hT,da,mT,ci,uT,fT,gT,ca,_T,pa,bT,TT,vT,Vn,kT,ot,ha,yT,zo,wT,pi,MT,$T,td,FT,BT,ET,Gn,xT,Yn,zT,Jn,wc;return l=new Pe({}),X=new Pe({}),I=new Pe({}),oe=new ie({props:{name:"class transformers.MobileBertConfig",anchor:"transformers.MobileBertConfig",parameters:[{name:"vocab_size",val:" = 30522"},{name:"hidden_size",val:" = 512"},{name:"num_hidden_layers",val:" = 24"},{name:"num_attention_heads",val:" = 4"},{name:"intermediate_size",val:" = 512"},{name:"hidden_act",val:" = 'relu'"},{name:"hidden_dropout_prob",val:" = 0.0"},{name:"attention_probs_dropout_prob",val:" = 0.1"},{name:"max_position_embeddings",val:" = 512"},{name:"type_vocab_size",val:" = 2"},{name:"initializer_range",val:" = 0.02"},{name:"layer_norm_eps",val:" = 1e-12"},{name:"pad_token_id",val:" = 0"},{name:"embedding_size",val:" = 128"},{name:"trigram_input",val:" = True"},{name:"use_bottleneck",val:" = True"},{name:"intra_bottleneck_size",val:" = 128"},{name:"use_bottleneck_attention",val:" = False"},{name:"key_query_shared_bottleneck",val:" = True"},{name:"num_feedforward_networks",val:" = 4"},{name:"normalization_type",val:" = 'no_norm'"},{name:"classifier_activation",val:" = True"},{name:"classifier_dropout",val:" = None"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.MobileBertConfig.vocab_size",description:`<strong>vocab_size</strong> (<code>int</code>, <em>optional</em>, defaults to 30522) &#x2014;
...
The vocabulary size of the <code>token_type_ids</code> passed when calling <a href="/docs/transformers/v4.19.4/en/model_doc/mobilebert#transformers.MobileBertModel">MobileBertModel</a> or
<a href="/docs/transformers/v4.19.4/en/model_doc/mobilebert#transformers.TFMobileBertModel">TFMobileBertModel</a>.`,name:"type_vocab_size"},{anchor:"transformers.MobileBertConfig.initializer_range",description:`<strong>initializer_range</strong> (<code>float</code>, <em>optional</em>, defaults to 0.02) &#x2014;
...
<p>Attentions weights after the attention softmax, used to compute the weighted average in the self-attention
heads.`,name:"attentions"}],source:"https://github.com/huggingface/transformers/blob/v4.19.4/src/transformers/models/mobilebert/modeling_tf_mobilebert.py#L797"}}),vs=new Pe({}),ks=new ie({props:{name:"class transformers.MobileBertModel",anchor:"transformers.MobileBertModel",parameters:[{name:"config",val:""},{name:"add_pooling_layer",val:" = True"}],parametersDescription:[{anchor:"transformers.MobileBertModel.config",description:`<strong>config</strong> (<a href="/docs/transformers/v4.19.4/en/model_doc/mobilebert#transformers.MobileBertConfig">MobileBertConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
...
elements depending on the configuration (<a
  href="/docs/transformers/v4.19.4/en/model_doc/mobilebert#transformers.MobileBertConfig"
...
</ul>`,name:"next_sentence_label"}],source:"https://github.com/huggingface/transformers/blob/v4.19.4/src/transformers/models/mobilebert/modeling_mobilebert.py#L950",returnDescription:`
<p>A <a
  href="/docs/transformers/v4.19.4/en/model_doc/mobilebert#transformers.models.mobilebert.modeling_mobilebert.MobileBertForPreTrainingOutput"
...
`}}),Ro=new qe({props:{$$slots:{default:[Ty]},$$scope:{ctx:E}}}),Uo=new Ee({props:{anchor:"transformers.MobileBertForPreTraining.forward.example",$$slots:{default:[vy]},$$scope:{ctx:E}}}),Cs=new Pe({}),js=new ie({props:{name:"class transformers.MobileBertForMaskedLM",anchor:"transformers.MobileBertForMaskedLM",parameters:[{name:"config",val:""}],parametersDescription:[{anchor:"transformers.MobileBertForMaskedLM.config",description:`<strong>config</strong> (<a href="/docs/transformers/v4.19.4/en/model_doc/mobilebert#transformers.MobileBertConfig">MobileBertConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
...
Labels for computing the masked language modeling loss. Indices should be in <code>[-100, 0, ..., config.vocab_size]</code> (see <code>input_ids</code> docstring) Tokens with indices set to <code>-100</code> are ignored (masked), the
loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.19.4/src/transformers/models/mobilebert/modeling_mobilebert.py#L1059",returnDescription:`
<p>A <a
...
<li>0 indicates sequence B is a continuation of sequence A,</li>
<li>1 indicates sequence B is a random sequence.</li>
</ul>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.19.4/src/transformers/models/mobilebert/modeling_mobilebert.py#L1145",returnDescription:`
<p>A <a
  href="/docs/transformers/v4.19.4/en/main_classes/output#transformers.modeling_outputs.NextSentencePredictorOutput"
...
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.19.4/src/transformers/models/mobilebert/modeling_mobilebert.py#L1254",returnDescription:`
<p>A <a
...
<code>input_ids</code> above)`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.19.4/src/transformers/models/mobilebert/modeling_mobilebert.py#L1465",returnDescription:`
<p>A <a
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.19.4/src/transformers/models/mobilebert/modeling_mobilebert.py#L1567",returnDescription:`
<p>A <a
...
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/v4.19.4/src/transformers/models/mobilebert/modeling_mobilebert.py#L1357",returnDescription:`
<p>A <a
...
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/v4.19.4/en/model_doc/mobilebert#transformers.MobileBertTokenizer">MobileBertTokenizer</a>. See <a href="/docs/transformers/v4.19.4/en/model_doc/wav2vec2#transformers.Wav2Vec2CTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
...
behaviors between training and evaluation).`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/v4.19.4/src/transformers/models/mobilebert/modeling_tf_mobilebert.py#L929",returnDescription:`
<p>A <a
...
Whether or not to use the model in training mode (some modules like dropout modules have different
behaviors between training and evaluation).`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/v4.19.4/src/transformers/models/mobilebert/modeling_tf_mobilebert.py#L998",returnDescription:`
<p>A <a
  href="/docs/transformers/v4.19.4/en/model_doc/mobilebert#transformers.models.mobilebert.modeling_tf_mobilebert.TFMobileBertForPreTrainingOutput"
...
Labels for computing the masked language modeling loss. Indices should be in <code>[-100, 0, ..., config.vocab_size]</code> (see <code>input_ids</code> docstring) Tokens with indices set to <code>-100</code> are ignored (masked), the
loss is only computed for the tokens with labels`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.19.4/src/transformers/models/mobilebert/modeling_tf_mobilebert.py#L1090",returnDescription:`
<p>A <a
...
Whether or not to use the model in training mode (some modules like dropout modules have different
behaviors between training and evaluation).`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/v4.19.4/src/transformers/models/mobilebert/modeling_tf_mobilebert.py#L1180",returnDescription:`
<p>A <a
  href="/docs/transformers/v4.19.4/en/main_classes/output#transformers.modeling_tf_outputs.TFNextSentencePredictorOutput"
...
Labels for computing the sequence classification/regression loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>. If <code>config.num_labels == 1</code> a regression loss is computed (Mean-Square loss), If
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.19.4/src/transformers/models/mobilebert/modeling_tf_mobilebert.py#L1285",returnDescription:`
<p>A <a
...
where <code>num_choices</code> is the size of the second dimension of the input tensors. (See <code>input_ids</code> above)`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.19.4/src/transformers/models/mobilebert/modeling_tf_mobilebert.py#L1498",returnDescription:`
<p>A <a
...
Labels for computing the token classification loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.19.4/src/transformers/models/mobilebert/modeling_tf_mobilebert.py#L1627",returnDescription:`
<p>A <a
...
Labels for position (index) of the end of the labelled span for computing the token classification loss.
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/v4.19.4/src/transformers/models/mobilebert/modeling_tf_mobilebert.py#L1379",returnDescription:`
<p>A <a
...
`}}),Gn=new qe({props:{$$slots:{default:[cw]},$$scope:{ctx:E}}}),Yn=new Ee({props:{anchor:"transformers.TFMobileBertForQuestionAnswering.call.example",$$slots:{default:[pw]},$$scope:{ctx:E}}}),Jn=new Ee({props:{anchor:"transformers.TFMobileBertForQuestionAnswering.call.example-2",$$slots:{default:[hw]},$$scope:{ctx:E}}}),{c(){d=r("meta"),_=h(),c=r("h1"),p=r("a"),T=r("span"),k(l.$$.fragment),u=h(),x=r("span"),he=n("MobileBERT"),V=h(),z=r("h2"),J=r("a"),L=r("span"),k(X.$$.fragment),me=h(),D=r("span"),ue=n("Overview"),le=h(),K=r("p"),N=n("The MobileBERT model was proposed in "),ee=r("a"),G=n("MobileBERT: a Compact Task-Agnostic BERT for Resource-Limited Devices"),q=n(` by Zhiqing Sun, Hongkun Yu, Xiaodan Song, Renjie Liu, Yiming Yang, and Denny
...
documentation from `),$a=r("a"),Ip=n("PretrainedConfig"),Lp=n(" for more information."),Dp=h(),k(Co.$$.fragment),Wp=h(),Pi=r("p"),Rp=n(`Attributes: pretrained_config_archive_map (Dict[str, str]): A dictionary containing all the available pre-trained
...
splitting and wordpiece.`),uh=h(),us=r("p"),fh=n("Refer to superclass "),qa=r("a"),gh=n("BertTokenizerFast"),_h=n(" for usage examples and documentation concerning parameters."),Wd=h(),Ht=r("h2"),Ao=r("a"),Ii=r("span"),k(fs.$$.fragment),bh=h(),Li=r("span"),Th=n("MobileBert specific outputs"),Rd=h(),Qt=r("div"),k(gs.$$.fragment),vh=h(),_s=r("p"),kh=n("Output type of "),Pa=r("a"),yh=n("MobileBertForPreTraining"),wh=n("."),Ud=h(),Kt=r("div"),k(bs.$$.fragment),Mh=h(),Ts=r("p"),$h=n("Output type of "),Ca=r("a"),Fh=n("TFMobileBertForPreTraining"),Bh=n("."),Hd=h(),Vt=r("h2"),Io=r("a"),Di=r("span"),k(vs.$$.fragment),Eh=h(),Wi=r("span"),xh=n("MobileBertModel"),Qd=h(),je=r("div"),k(ks.$$.fragment),zh=h(),Ri=r("p"),qh=n("The bare MobileBert Model transformer outputting raw hidden-states without any specific head on top."),Ph=h(),ys=r("p"),Ch=n("This model inherits from "),ja=r("a"),jh=n("PreTrainedModel"),Nh=n(`. Check the superclass documentation for the generic methods the
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),mm=h(),lt=r("div"),k(Ps.$$.fragment),um=h(),Zt=r("p"),fm=n("The "),Sa=r("a"),gm=n("MobileBertForPreTraining"),_m=n(" forward method, overrides the "),Yi=r("code"),bm=n("__call__"),Tm=n(" special method."),vm=h(),k(Ro.$$.fragment),km=h(),k(Uo.$$.fragment),Gd=h(),Xt=r("h2"),Ho=r("a"),Ji=r("span"),k(Cs.$$.fragment),ym=h(),Zi=r("span"),wm=n("MobileBertForMaskedLM"),Yd=h(),Ue=r("div"),k(js.$$.fragment),Mm=h(),Ns=r("p"),$m=n("MobileBert Model with a "),Xi=r("code"),Fm=n("language modeling"),Bm=n(" head on top."),Em=h(),Os=r("p"),xm=n("This model inherits from "),Aa=r("a"),zm=n("PreTrainedModel"),qm=n(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Bu=h(),Ce=r("div"),k(Zs.$$.fragment),Eu=h(),so=r("p"),xu=n("The "),Ra=r("a"),zu=n("MobileBertForSequenceClassification"),qu=n(" forward method, overrides the "),ll=r("code"),Pu=n("__call__"),Cu=n(" special method."),ju=h(),k(Xo.$$.fragment),Nu=h(),k(en.$$.fragment),Ou=h(),k(tn.$$.fragment),Su=h(),k(on.$$.fragment),Au=h(),k(nn.$$.fragment),tc=h(),ro=r("h2"),sn=r("a"),dl=r("span"),k(Xs.$$.fragment),Iu=h(),cl=r("span"),Lu=n("MobileBertForMultipleChoice"),oc=h(),Ke=r("div"),k(er.$$.fragment),Du=h(),pl=r("p"),Wu=n(`MobileBert Model with a multiple choice classification head on top (a linear layer on top of the pooled output and
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Tf=h(),Je=r("div"),k(cr.$$.fragment),vf=h(),lo=r("p"),kf=n("The "),Ka=r("a"),yf=n("MobileBertForTokenClassification"),wf=n(" forward method, overrides the "),gl=r("code"),Mf=n("__call__"),$f=n(" special method."),Ff=h(),k(dn.$$.fragment),Bf=h(),k(cn.$$.fragment),Ef=h(),k(pn.$$.fragment),rc=h(),co=r("h2"),hn=r("a"),_l=r("span"),k(pr.$$.fragment),xf=h(),bl=r("span"),zf=n("MobileBertForQuestionAnswering"),ac=h(),Ge=r("div"),k(hr.$$.fragment),qf=h(),po=r("p"),Pf=n(`MobileBert Model with a span classification head on top for extractive question-answering tasks like SQuAD (a
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Ig=h(),k(kn.$$.fragment),Lg=h(),ht=r("div"),k(Er.$$.fragment),Dg=h(),_o=r("p"),Wg=n("The "),Xa=r("a"),Rg=n("TFMobileBertForPreTraining"),Ug=n(" forward method, overrides the "),zl=r("code"),Hg=n("__call__"),Qg=n(" special method."),Kg=h(),k(yn.$$.fragment),Vg=h(),k(wn.$$.fragment),pc=h(),bo=r("h2"),Mn=r("a"),ql=r("span"),k(xr.$$.fragment),Gg=h(),Pl=r("span"),Yg=n("TFMobileBertForMaskedLM"),hc=h(),Se=r("div"),k(zr.$$.fragment),Jg=h(),qr=r("p"),Zg=n("MobileBert Model with a "),Cl=r("code"),Xg=n("language modeling"),e_=n(" head on top."),t_=h(),Pr=r("p"),o_=n("This model inherits from "),ei=r("a"),n_=n("TFPreTrainedModel"),s_=n(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),j_=h(),k(zn.$$.fragment),N_=h(),mt=r("div"),k(Wr.$$.fragment),O_=h(),ko=r("p"),S_=n("The "),ni=r("a"),A_=n("TFMobileBertForNextSentencePrediction"),I_=n(" forward method, overrides the "),Al=r("code"),L_=n("__call__"),D_=n(" special method."),W_=h(),k(qn.$$.fragment),R_=h(),k(Pn.$$.fragment),fc=h(),yo=r("h2"),Cn=r("a"),Il=r("span"),k(Rr.$$.fragment),U_=h(),Ll=r("span"),H_=n("TFMobileBertForSequenceClassification"),gc=h(),Ie=r("div"),k(Ur.$$.fragment),Q_=h(),Dl=r("p"),K_=n(`MobileBert Model transformer with a sequence classification/regression head on top (a linear layer on top of the
...
efficient at predicting masked tokens and at NLU in general, but is not optimal for text generation. Models trained
with a causal language modeling (CLM) objective are better in that regard.`),ud.forEach(t),ga.forEach(t),pe=m(o),A=a(o,"P",{});var qo=i(A);be=s(qo,"This model was contributed by "),f=a(qo,"A",{href:!0,rel:!0});var fd=i(f);B=s(fd,"vshampor"),fd.forEach(t),Y=s(qo,". The original code can be found "),ke=a(qo,"A",{href:!0,rel:!0});var gd=i(ke);$e=s(gd,"here"),gd.forEach(t),S=s(qo,"."),qo.forEach(t),we=m(o),Te=a(o,"H2",{class:!0});var _a=i(Te);ve=a(_a,"A",{id:!0,class:!0,href:!0});var _d=i(ve);j=a(_d,"SPAN",{});var bd=i(j);y(I.$$.fragment,bd),bd.forEach(t),_d.forEach(t),Fe=m(_a),ye=a(_a,"SPAN",{});var Td=i(ye);Q=s(Td,"MobileBertConfig"),Td.forEach(t),_a.forEach(t),Me=m(o),te=a(o,"DIV",{class:!0});var at=i(te);y(oe.$$.fragment,at),Be=m(at),Mt=a(at,"P",{});var $t=i(Mt);Ep=s($t,"This is the configuration class to store the configuration of a "),ya=a($t,"A",{href:!0});var vd=i(ya);xp=s(vd,"MobileBertModel"),vd.forEach(t),zp=s($t," or a "),wa=a($t,"A",{href:!0});var kd=i(wa);qp=s(kd,"TFMobileBertModel"),kd.forEach(t),Pp=s($t,`. It
is used to instantiate a MobileBERT model according to the specified arguments, defining the model architecture.
Instantiating a configuration with the defaults will yield a similar configuration to that of the MobileBERT
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),jc.forEach(t),dm=m(Et),zs=a(Et,"P",{});var Nc=i(zs);cm=s(Nc,"This model is also a PyTorch "),qs=a(Nc,"A",{href:!0,rel:!0});var tv=i(qs);pm=s(tv,"torch.nn.Module"),tv.forEach(t),hm=s(Nc,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Nc.forEach(t),mm=m(Et),lt=a(Et,"DIV",{class:!0});var es=i(lt);y(Ps.$$.fragment,es),um=m(es),Zt=a(es,"P",{});var ui=i(Zt);fm=s(ui,"The "),Sa=a(ui,"A",{href:!0});var ov=i(Sa);gm=s(ov,"MobileBertForPreTraining"),ov.forEach(t),_m=s(ui," forward method, overrides the "),Yi=a(ui,"CODE",{});var nv=i(Yi);bm=s(nv,"__call__"),nv.forEach(t),Tm=s(ui," special method."),ui.forEach(t),vm=m(es),y(Ro.$$.fragment,es),km=m(es),y(Uo.$$.fragment,es),es.forEach(t),Et.forEach(t),Gd=m(o),Xt=a(o,"H2",{class:!0});var Oc=i(Xt);Ho=a(Oc,"A",{id:!0,class:!0,href:!0});var sv=i(Ho);Ji=a(sv,"SPAN",{});var rv=i(Ji);y(Cs.$$.fragment,rv),rv.forEach(t),sv.forEach(t),ym=m(Oc),Zi=a(Oc,"SPAN",{});var av=i(Zi);wm=s(av,"MobileBertForMaskedLM"),av.forEach(t),Oc.forEach(t),Yd=m(o),Ue=a(o,"DIV",{class:!0});var xt=i(Ue);y(js.$$.fragment,xt),Mm=m(xt),Ns=a(xt,"P",{});var Sc=i(Ns);$m=s(Sc,"MobileBert Model with a "),Xi=a(Sc,"CODE",{});var iv=i(Xi);Fm=s(iv,"language modeling"),iv.forEach(t),Bm=s(Sc," head on top."),Sc.forEach(t),Em=m(xt),Os=a(xt,"P",{});var Ac=i(Os);xm=s(Ac,"This model inherits from "),Aa=a(Ac,"A",{href:!0});var lv=i(Aa);zm=s(lv,"PreTrainedModel"),lv.forEach(t),qm=s(Ac,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Ac.forEach(t),Pm=m(xt),Ss=a(xt,"P",{});var Ic=i(Ss);Cm=s(Ic,"This model is also a PyTorch "),As=a(Ic,"A",{href:!0,rel:!0});var dv=i(As);jm=s(dv,"torch.nn.Module"),dv.forEach(t),Nm=s(Ic,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Ic.forEach(t),Om=m(xt),Ye=a(xt,"DIV",{class:!0});var zt=i(Ye);y(Is.$$.fragment,zt),Sm=m(zt),eo=a(zt,"P",{});var fi=i(eo);Am=s(fi,"The "),Ia=a(fi,"A",{href:!0});var cv=i(Ia);Im=s(cv,"MobileBertForMaskedLM"),cv.forEach(t),Lm=s(fi," forward method, overrides the "),el=a(fi,"CODE",{});var pv=i(el);Dm=s(pv,"__call__"),pv.forEach(t),Wm=s(fi," special method."),fi.forEach(t),Rm=m(zt),y(Qo.$$.fragment,zt),Um=m(zt),y(Ko.$$.fragment,zt),Hm=m(zt),y(Vo.$$.fragment,zt),zt.forEach(t),xt.forEach(t),Jd=m(o),to=a(o,"H2",{class:!0});var Lc=i(to);Go=a(Lc,"A",{id:!0,class:!0,href:!0});var hv=i(Go);tl=a(hv,"SPAN",{});var mv=i(tl);y(Ls.$$.fragment,mv),mv.forEach(t),hv.forEach(t),Qm=m(Lc),ol=a(Lc,"SPAN",{});var uv=i(ol);Km=s(uv,"MobileBertForNextSentencePrediction"),uv.forEach(t),Lc.forEach(t),Zd=m(o),He=a(o,"DIV",{class:!0});var qt=i(He);y(Ds.$$.fragment,qt),Vm=m(qt),Ws=a(qt,"P",{});var Dc=i(Ws);Gm=s(Dc,"MobileBert Model with a "),nl=a(Dc,"CODE",{});var fv=i(nl);Ym=s(fv,"next sentence prediction (classification)"),fv.forEach(t),Jm=s(Dc," head on top."),Dc.forEach(t),Zm=m(qt),Rs=a(qt,"P",{});var Wc=i(Rs);Xm=s(Wc,"This model inherits from "),La=a(Wc,"A",{href:!0});var gv=i(La);eu=s(gv,"PreTrainedModel"),gv.forEach(t),tu=s(Wc,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Wc.forEach(t),ou=m(qt),Us=a(qt,"P",{});var Rc=i(Us);nu=s(Rc,"This model is also a PyTorch "),Hs=a(Rc,"A",{href:!0,rel:!0});var _v=i(Hs);su=s(_v,"torch.nn.Module"),_v.forEach(t),ru=s(Rc,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Rc.forEach(t),au=m(qt),dt=a(qt,"DIV",{class:!0});var ts=i(dt);y(Qs.$$.fragment,ts),iu=m(ts),oo=a(ts,"P",{});var gi=i(oo);lu=s(gi,"The "),Da=a(gi,"A",{href:!0});var bv=i(Da);du=s(bv,"MobileBertForNextSentencePrediction"),bv.forEach(t),cu=s(gi," forward method, overrides the "),sl=a(gi,"CODE",{});var Tv=i(sl);pu=s(Tv,"__call__"),Tv.forEach(t),hu=s(gi," special method."),gi.forEach(t),mu=m(ts),y(Yo.$$.fragment,ts),uu=m(ts),y(Jo.$$.fragment,ts),ts.forEach(t),qt.forEach(t),Xd=m(o),no=a(o,"H2",{class:!0});var Uc=i(no);Zo=a(Uc,"A",{id:!0,class:!0,href:!0});var vv=i(Zo);rl=a(vv,"SPAN",{});var kv=i(rl);y(Ks.$$.fragment,kv),kv.forEach(t),vv.forEach(t),fu=m(Uc),al=a(Uc,"SPAN",{});var yv=i(al);gu=s(yv,"MobileBertForSequenceClassification"),yv.forEach(t),Uc.forEach(t),ec=m(o),Qe=a(o,"DIV",{class:!0});var Pt=i(Qe);y(Vs.$$.fragment,Pt),_u=m(Pt),il=a(Pt,"P",{});var wv=i(il);bu=s(wv,`MobileBert Model transformer with a sequence classification/regression head on top (a linear layer on top of the
pooled output) e.g. for GLUE tasks.`),wv.forEach(t),Tu=m(Pt),Gs=a(Pt,"P",{});var Hc=i(Gs);vu=s(Hc,"This model inherits from "),Wa=a(Hc,"A",{href:!0});var Mv=i(Wa);ku=s(Mv,"PreTrainedModel"),Mv.forEach(t),yu=s(Hc,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Hc.forEach(t),wu=m(Pt),Ys=a(Pt,"P",{});var Qc=i(Ys);Mu=s(Qc,"This model is also a PyTorch "),Js=a(Qc,"A",{href:!0,rel:!0});var $v=i(Js);$u=s($v,"torch.nn.Module"),$v.forEach(t),Fu=s(Qc,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Qc.forEach(t),Bu=m(Pt),Ce=a(Pt,"DIV",{class:!0});var nt=i(Ce);y(Zs.$$.fragment,nt),Eu=m(nt),so=a(nt,"P",{});var _i=i(so);xu=s(_i,"The "),Ra=a(_i,"A",{href:!0});var Fv=i(Ra);zu=s(Fv,"MobileBertForSequenceClassification"),Fv.forEach(t),qu=s(_i," forward method, overrides the "),ll=a(_i,"CODE",{});var Bv=i(ll);Pu=s(Bv,"__call__"),Bv.forEach(t),Cu=s(_i," special method."),_i.forEach(t),ju=m(nt),y(Xo.$$.fragment,nt),Nu=m(nt),y(en.$$.fragment,nt),Ou=m(nt),y(tn.$$.fragment,nt),Su=m(nt),y(on.$$.fragment,nt),Au=m(nt),y(nn.$$.fragment,nt),nt.forEach(t),Pt.forEach(t),tc=m(o),ro=a(o,"H2",{class:!0});var Kc=i(ro);sn=a(Kc,"A",{id:!0,class:!0,href:!0});var Ev=i(sn);dl=a(Ev,"SPAN",{});var xv=i(dl);y(Xs.$$.fragment,xv),xv.forEach(t),Ev.forEach(t),Iu=m(Kc),cl=a(Kc,"SPAN",{});var zv=i(cl);Lu=s(zv,"MobileBertForMultipleChoice"),zv.forEach(t),Kc.forEach(t),oc=m(o),Ke=a(o,"DIV",{class:!0});var Ct=i(Ke);y(er.$$.fragment,Ct),Du=m(Ct),pl=a(Ct,"P",{});var qv=i(pl);Wu=s(qv,`MobileBert Model with a multiple choice classification head on top (a linear layer on top of the pooled output and
a softmax) e.g. for RocStories/SWAG tasks.`),qv.forEach(t),Ru=m(Ct),tr=a(Ct,"P",{});var Vc=i(tr);Uu=s(Vc,"This model inherits from "),Ua=a(Vc,"A",{href:!0});var Pv=i(Ua);Hu=s(Pv,"PreTrainedModel"),Pv.forEach(t),Qu=s(Vc,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Zc.forEach(t),Tf=m(jt),Je=a(jt,"DIV",{class:!0});var Nt=i(Je);y(cr.$$.fragment,Nt),vf=m(Nt),lo=a(Nt,"P",{});var Ti=i(lo);kf=s(Ti,"The "),Ka=a(Ti,"A",{href:!0});var Wv=i(Ka);yf=s(Wv,"MobileBertForTokenClassification"),Wv.forEach(t),wf=s(Ti," forward method, overrides the "),gl=a(Ti,"CODE",{});var Rv=i(gl);Mf=s(Rv,"__call__"),Rv.forEach(t),$f=s(Ti," special method."),Ti.forEach(t),Ff=m(Nt),y(dn.$$.fragment,Nt),Bf=m(Nt),y(cn.$$.fragment,Nt),Ef=m(Nt),y(pn.$$.fragment,Nt),Nt.forEach(t),jt.forEach(t),rc=m(o),co=a(o,"H2",{class:!0});var Xc=i(co);hn=a(Xc,"A",{id:!0,class:!0,href:!0});var Uv=i(hn);_l=a(Uv,"SPAN",{});var Hv=i(_l);y(pr.$$.fragment,Hv),Hv.forEach(t),Uv.forEach(t),xf=m(Xc),bl=a(Xc,"SPAN",{});var Qv=i(bl);zf=s(Qv,"MobileBertForQuestionAnswering"),Qv.forEach(t),Xc.forEach(t),ac=m(o),Ge=a(o,"DIV",{class:!0});var Ot=i(Ge);y(hr.$$.fragment,Ot),qf=m(Ot),po=a(Ot,"P",{});var vi=i(po);Pf=s(vi,`MobileBert Model with a span classification head on top for extractive question-answering tasks like SQuAD (a
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),fp.forEach(t),j_=m(Tt),y(zn.$$.fragment,Tt),N_=m(Tt),mt=a(Tt,"DIV",{class:!0});var rs=i(mt);y(Wr.$$.fragment,rs),O_=m(rs),ko=a(rs,"P",{});var Fi=i(ko);S_=s(Fi,"The "),ni=a(Fi,"A",{href:!0});var zk=i(ni);A_=s(zk,"TFMobileBertForNextSentencePrediction"),zk.forEach(t),I_=s(Fi," forward method, overrides the "),Al=a(Fi,"CODE",{});var qk=i(Al);L_=s(qk,"__call__"),qk.forEach(t),D_=s(Fi," special method."),Fi.forEach(t),W_=m(rs),y(qn.$$.fragment,rs),R_=m(rs),y(Pn.$$.fragment,rs),rs.forEach(t),Tt.forEach(t),fc=m(o),yo=a(o,"H2",{class:!0});var gp=i(yo);Cn=a(gp,"A",{id:!0,class:!0,href:!0});var Pk=i(Cn);Il=a(Pk,"SPAN",{});var Ck=i(Il);y(Rr.$$.fragment,Ck),Ck.forEach(t),Pk.forEach(t),U_=m(gp),Ll=a(gp,"SPAN",{});var jk=i(Ll);H_=s(jk,"TFMobileBertForSequenceClassification"),jk.forEach(t),gp.forEach(t),gc=m(o),Ie=a(o,"DIV",{class:!0});var vt=i(Ie);y(Ur.$$.fragment,vt),Q_=m(vt),Dl=a(vt,"P",{});var Nk=i(Dl);K_=s(Nk,`MobileBert Model transformer with a sequence classification/regression head on top (a linear layer on top of the
