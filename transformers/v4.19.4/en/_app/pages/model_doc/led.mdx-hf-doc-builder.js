import{S as Pu,i as Iu,s as Gu,e as a,k as c,w as T,t as n,M as Bu,c as r,d as t,m as h,a as d,x as k,h as s,b as m,G as e,g,y as w,q as y,o as E,B as L,v as Qu,L as je}from"../../chunks/vendor-hf-doc-builder.js";import{T as Lo}from"../../chunks/Tip-hf-doc-builder.js";import{D as x}from"../../chunks/Docstring-hf-doc-builder.js";import{C as Ae}from"../../chunks/CodeBlock-hf-doc-builder.js";import{I as Ce}from"../../chunks/IconCopyLink-hf-doc-builder.js";import{E as Oe}from"../../chunks/ExampleCodeBlock-hf-doc-builder.js";function Wu($){let l,v,p,u,b;return u=new Ae({props:{code:`from transformers import LEDModel, LEDConfig
...
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-built_in">round</span>(loss.item(), <span class="hljs-number">2</span>)
`}}),{c(){T(l.$$.fragment)},l(p){k(l.$$.fragment,p)},m(p,u){w(l,p,u),v=!0},p:je,i(p){v||(y(l.$$.fragment,p),v=!0)},o(p){E(l.$$.fragment,p),v=!1},d(p){L(l,p)}}}function sm($){let l,v,p,u,b,i,f,D,Ne,pe,F,Z,W,ee,Pe,H,Ie,qe,I,V,te,be,C,j,ue,oe,$e,me,R,Ge,De,O,Be,K,S,M,G,Qe,We,N,He,ne,Te;return{c(){l=a("p"),v=n("TF 2.0 models accepts two formats as inputs:"),p=c(),u=a("ul"),b=a("li"),i=n("having all inputs as keyword arguments (like PyTorch models), or"),f=c(),D=a("li"),Ne=n("having all inputs as a list, tuple or dict in the first positional arguments."),pe=c(),F=a("p"),Z=n("This second option is useful when using "),W=a("code"),ee=n("tf.keras.Model.fit"),Pe=n(` method which currently requires having all the
...
`),K=a("code"),S=n("model([input_ids, attention_mask])"),M=n(" or "),G=a("code"),Qe=n("model([input_ids, attention_mask, token_type_ids])"),We=c(),N=a("li"),He=n(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),ne=a("code"),Te=n('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(q){l=r(q,"P",{});var z=d(l);v=s(z,"TF 2.0 models accepts two formats as inputs:"),z.forEach(t),p=h(q),u=r(q,"UL",{});var se=d(u);b=r(se,"LI",{});var ot=d(b);i=s(ot,"having all inputs as keyword arguments (like PyTorch models), or"),ot.forEach(t),f=h(se),D=r(se,"LI",{});var nt=d(D);Ne=s(nt,"having all inputs as a list, tuple or dict in the first positional arguments."),nt.forEach(t),se.forEach(t),pe=h(q),F=r(q,"P",{});var P=d(F);Z=s(P,"This second option is useful when using "),W=r(P,"CODE",{});var st=d(W);ee=s(st,"tf.keras.Model.fit"),st.forEach(t),Pe=s(P,` method which currently requires having all the
tensors in the first argument of the model call function: `),H=r(P,"CODE",{});var at=d(H);Ie=s(at,"model(inputs)"),at.forEach(t),qe=s(P,"."),P.forEach(t),I=h(q),V=r(q,"P",{});var Fe=d(V);te=s(Fe,`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
...
`),ne=r(Ve,"CODE",{});var Re=d(ne);Te=s(Re,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),Re.forEach(t),Ve.forEach(t),U.forEach(t)},m(q,z){g(q,l,z),e(l,v),g(q,p,z),g(q,u,z),e(u,b),e(b,i),e(u,f),e(u,D),e(D,Ne),g(q,pe,z),g(q,F,z),e(F,Z),e(F,W),e(W,ee),e(F,Pe),e(F,H),e(H,Ie),e(F,qe),g(q,I,z),g(q,V,z),e(V,te),g(q,be,z),g(q,C,z),e(C,j),e(j,ue),e(j,oe),e(oe,$e),e(j,me),e(j,R),e(R,Ge),e(C,De),e(C,O),e(O,Be),e(O,K),e(K,S),e(O,M),e(O,G),e(G,Qe),e(C,We),e(C,N),e(N,He),e(N,ne),e(ne,Te)},d(q){q&&t(l),q&&t(p),q&&t(u),q&&t(pe),q&&t(F),q&&t(I),q&&t(V),q&&t(be),q&&t(C)}}}function am($){let l,v,p,u,b;return{c(){l=a("p"),v=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),p=a("code"),u=n("Module"),b=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(i){l=r(i,"P",{});var f=d(l);v=s(f,"Although the recipe for forward pass needs to be defined within this function, one should call the "),p=r(f,"CODE",{});var D=d(p);u=s(D,"Module"),D.forEach(t),b=s(f,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),{c(){l=a("p"),v=n("Example:"),p=c(),T(u.$$.fragment)},l(i){l=r(i,"P",{});var f=d(l);v=s(f,"Example:"),f.forEach(t),p=h(i),k(u.$$.fragment,i)},m(i,f){g(i,l,f),e(l,v),g(i,p,f),w(u,i,f),b=!0},p:je,i(i){b||(y(u.$$.fragment,i),b=!0)},o(i){E(u.$$.fragment,i),b=!1},d(i){i&&t(l),i&&t(p),L(u,i)}}}function dm($){let l,v,p,u,b,i,f,D,Ne,pe,F,Z,W,ee,Pe,H,Ie,qe,I,V,te,be,C,j,ue,oe,$e,me,R,Ge,De,O,Be,K,S,M,G,Qe,We,N,He,ne,Te;return{c(){l=a("p"),v=n("TF 2.0 models accepts two formats as inputs:"),p=c(),u=a("ul"),b=a("li"),i=n("having all inputs as keyword arguments (like PyTorch models), or"),f=c(),D=a("li"),Ne=n("having all inputs as a list, tuple or dict in the first positional arguments."),pe=c(),F=a("p"),Z=n("This second option is useful when using "),W=a("code"),ee=n("tf.keras.Model.fit"),Pe=n(` method which currently requires having all the
tensors in the first argument of the model call function: `),H=a("code"),Ie=n("model(inputs)"),qe=n("."),I=c(),V=a("p"),te=n(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),be=c(),C=a("ul"),j=a("li"),ue=n("a single Tensor with "),oe=a("code"),$e=n("input_ids"),me=n(" only and nothing else: "),R=a("code"),Ge=n("model(input_ids)"),De=c(),O=a("li"),Be=n(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),K=a("code"),S=n("model([input_ids, attention_mask])"),M=n(" or "),G=a("code"),Qe=n("model([input_ids, attention_mask, token_type_ids])"),We=c(),N=a("li"),He=n(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),ne=a("code"),Te=n('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(q){l=r(q,"P",{});var z=d(l);v=s(z,"TF 2.0 models accepts two formats as inputs:"),z.forEach(t),p=h(q),u=r(q,"UL",{});var se=d(u);b=r(se,"LI",{});var ot=d(b);i=s(ot,"having all inputs as keyword arguments (like PyTorch models), or"),ot.forEach(t),f=h(se),D=r(se,"LI",{});var nt=d(D);Ne=s(nt,"having all inputs as a list, tuple or dict in the first positional arguments."),nt.forEach(t),se.forEach(t),pe=h(q),F=r(q,"P",{});var P=d(F);Z=s(P,"This second option is useful when using "),W=r(P,"CODE",{});var st=d(W);ee=s(st,"tf.keras.Model.fit"),st.forEach(t),Pe=s(P,` method which currently requires having all the
...
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-comment"># probs[5] is associated with the mask token</span>`}}),{c(){l=a("p"),v=n("Examples:"),p=c(),T(u.$$.fragment)},l(i){l=r(i,"P",{});var f=d(l);v=s(f,"Examples:"),f.forEach(t),p=h(i),k(u.$$.fragment,i)},m(i,f){g(i,l,f),e(l,v),g(i,p,f),w(u,i,f),b=!0},p:je,i(i){b||(y(u.$$.fragment,i),b=!0)},o(i){E(u.$$.fragment,i),b=!1},d(i){i&&t(l),i&&t(p),L(u,i)}}}function cm($){let l,v,p,u,b,i,f,D,Ne,pe,F,Z,W,ee,Pe,H,Ie,qe,I,V,te,be,C,j,ue,oe,$e,me,R,Ge,De,O,Be,K,S,M,G,Qe,We,N,He,ne,Te,q,z,se,ot,nt,P,st,at,Fe,U,ae,ze,rt,re,dt,de,Ve,Re,ad,rd,qs,dd,id,ld,ke,cd,$s,hd,pd,Ds,ud,md,Bn,fd,_d,Fs,gd,vd,bd,X,Td,zs,kd,wd,xs,yd,Ed,Qn,Ld,qd,Ss,$d,Dd,Ms,Fd,zd,Cs,xd,Sd,Md,it,Cd,Os,Od,jd,js,Ad,Nd,Pd,qo,Id,$o,Gd,Bd,Qd,Do,Wd,Fo,Hd,Vd,Wa,jt,Rd,zo,Ud,Xd,Ha,lt,At,As,xo,Jd,Ns,Zd,Va,we,So,Kd,ct,Yd,Wn,ei,ti,Mo,oi,ni,si,ht,ai,Hn,ri,di,Vn,ii,li,ci,Nt,Ra,pt,Pt,Ps,Co,hi,Is,pi,Ua,A,Oo,ui,Gs,mi,fi,It,Rn,_i,gi,Un,vi,bi,Ti,jo,ki,Xn,wi,yi,Ei,Ue,Ao,Li,Bs,qi,$i,No,Jn,Di,Qs,Fi,zi,Zn,xi,Ws,Si,Mi,Gt,Po,Ci,Io,Oi,Hs,ji,Ai,Ni,Bt,Go,Pi,Vs,Ii,Gi,Kn,Bo,Xa,ut,Qt,Rs,Qo,Bi,Us,Qi,Ja,ye,Wo,Wi,Ho,Hi,Xs,Vi,Ri,Ui,Wt,Yn,Xi,Ji,es,Zi,Ki,Yi,Vo,el,ts,tl,ol,Za,mt,Ht,Js,Ro,nl,Zs,sl,Ka,ft,Uo,al,Ks,rl,Ya,_t,Xo,dl,Ys,il,er,gt,Jo,ll,ea,cl,tr,vt,Zo,hl,ta,pl,or,bt,Ko,ul,oa,ml,nr,Tt,Yo,fl,na,_l,sr,kt,en,gl,sa,vl,ar,wt,tn,bl,aa,Tl,rr,yt,Vt,ra,on,kl,da,wl,dr,Ee,nn,yl,sn,El,os,Ll,ql,$l,an,Dl,rn,Fl,zl,xl,xe,dn,Sl,Et,Ml,ns,Cl,Ol,ia,jl,Al,Nl,Rt,Pl,Ut,ir,Lt,Xt,la,ln,Il,ca,Gl,lr,Le,cn,Bl,hn,Ql,ss,Wl,Hl,Vl,pn,Rl,un,Ul,Xl,Jl,fe,mn,Zl,qt,Kl,as,Yl,ec,ha,tc,oc,nc,Jt,sc,Zt,ac,Kt,cr,$t,Yt,pa,fn,rc,ua,dc,hr,ie,_n,ic,ma,lc,cc,gn,hc,rs,pc,uc,mc,vn,fc,bn,_c,gc,vc,B,Tn,bc,Dt,Tc,ds,kc,wc,fa,yc,Ec,Lc,eo,qc,to,$c,oo,Dc,no,Fc,so,pr,Ft,ao,_a,kn,zc,ga,xc,ur,le,wn,Sc,zt,Mc,va,Cc,Oc,ba,jc,Ac,Nc,yn,Pc,is,Ic,Gc,Bc,En,Qc,Ln,Wc,Hc,Vc,_e,qn,Rc,xt,Uc,ls,Xc,Jc,Ta,Zc,Kc,Yc,ro,eh,io,th,lo,mr,St,co,ka,$n,oh,wa,nh,fr,ce,Dn,sh,Fn,ah,cs,rh,dh,ih,zn,lh,xn,ch,hh,ph,ho,uh,Se,Sn,mh,Mt,fh,hs,_h,gh,ya,vh,bh,Th,po,kh,uo,_r,Ct,mo,Ea,Mn,wh,La,yh,gr,he,Cn,Eh,On,Lh,ps,qh,$h,Dh,jn,Fh,An,zh,xh,Sh,fo,Mh,Me,Nn,Ch,Ot,Oh,us,jh,Ah,qa,Nh,Ph,Ih,_o,Gh,go,vr;return i=new Ce({}),ee=new Ce({}),xo=new Ce({}),So=new x({props:{name:"class transformers.LEDConfig",anchor:"transformers.LEDConfig",parameters:[{name:"vocab_size",val:" = 50265"},{name:"max_encoder_position_embeddings",val:" = 16384"},{name:"max_decoder_position_embeddings",val:" = 1024"},{name:"encoder_layers",val:" = 12"},{name:"encoder_ffn_dim",val:" = 4096"},{name:"encoder_attention_heads",val:" = 16"},{name:"decoder_layers",val:" = 12"},{name:"decoder_ffn_dim",val:" = 4096"},{name:"decoder_attention_heads",val:" = 16"},{name:"encoder_layerdrop",val:" = 0.0"},{name:"decoder_layerdrop",val:" = 0.0"},{name:"use_cache",val:" = True"},{name:"is_encoder_decoder",val:" = True"},{name:"activation_function",val:" = 'gelu'"},{name:"d_model",val:" = 1024"},{name:"dropout",val:" = 0.1"},{name:"attention_dropout",val:" = 0.0"},{name:"activation_dropout",val:" = 0.0"},{name:"init_std",val:" = 0.02"},{name:"decoder_start_token_id",val:" = 2"},{name:"classifier_dropout",val:" = 0.0"},{name:"pad_token_id",val:" = 1"},{name:"bos_token_id",val:" = 0"},{name:"eos_token_id",val:" = 2"},{name:"attention_window",val:": typing.Union[typing.List[int], int] = 512"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.LEDConfig.vocab_size",description:`<strong>vocab_size</strong> (<code>int</code>, <em>optional</em>, defaults to 50265) &#x2014;
...
Whether or not the model should return the last key/values attentions (not used by all models)`,name:"use_cache"}],source:"https://github.com/huggingface/transformers/blob/v4.19.4/src/transformers/models/led/configuration_led.py#L31"}}),Nt=new Oe({props:{anchor:"transformers.LEDConfig.example",$$slots:{default:[Wu]},$$scope:{ctx:$}}}),Co=new Ce({}),Oo=new x({props:{name:"class transformers.LEDTokenizer",anchor:"transformers.LEDTokenizer",parameters:[{name:"vocab_file",val:""},{name:"merges_file",val:""},{name:"errors",val:" = 'replace'"},{name:"bos_token",val:" = '<s>'"},{name:"eos_token",val:" = '</s>'"},{name:"sep_token",val:" = '</s>'"},{name:"cls_token",val:" = '<s>'"},{name:"unk_token",val:" = '<unk>'"},{name:"pad_token",val:" = '<pad>'"},{name:"mask_token",val:" = '<mask>'"},{name:"add_prefix_space",val:" = False"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/v4.19.4/src/transformers/models/led/tokenization_led.py#L43"}}),Ao=new x({props:{name:"build_inputs_with_special_tokens",anchor:"transformers.LEDTokenizer.build_inputs_with_special_tokens",parameters:[{name:"token_ids_0",val:": typing.List[int]"},{name:"token_ids_1",val:": typing.Optional[typing.List[int]] = None"}],parametersDescription:[{anchor:"transformers.LEDTokenizer.build_inputs_with_special_tokens.token_ids_0",description:`<strong>token_ids_0</strong> (<code>List[int]</code>) &#x2014;
...
<p>Global attentions weights after the attention softmax, used to compute the weighted average in the
self-attention heads. Those are the attention weights from every token with global attention to every token
in the sequence.`,name:"encoder_global_attentions"}],source:"https://github.com/huggingface/transformers/blob/v4.19.4/src/transformers/models/led/modeling_tf_led.py#L1373"}}),tn=new x({props:{name:"class transformers.models.led.modeling_tf_led.TFLEDSeq2SeqLMOutput",anchor:"transformers.models.led.modeling_tf_led.TFLEDSeq2SeqLMOutput",parameters:[{name:"loss",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"logits",val:": Tensor = None"},{name:"past_key_values",val:": typing.Optional[typing.List[tensorflow.python.framework.ops.Tensor]] = None"},{name:"decoder_hidden_states",val:": typing.Optional[typing.Tuple[tensorflow.python.framework.ops.Tensor]] = None"},{name:"decoder_attentions",val:": typing.Optional[typing.Tuple[tensorflow.python.framework.ops.Tensor]] = None"},{name:"cross_attentions",val:": typing.Optional[typing.Tuple[tensorflow.python.framework.ops.Tensor]] = None"},{name:"encoder_last_hidden_state",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"encoder_hidden_states",val:": typing.Optional[typing.Tuple[tensorflow.python.framework.ops.Tensor]] = None"},{name:"encoder_attentions",val:": typing.Optional[typing.Tuple[tensorflow.python.framework.ops.Tensor]] = None"},{name:"encoder_global_attentions",val:": typing.Optional[typing.Tuple[tensorflow.python.framework.ops.Tensor]] = None"}],parametersDescription:[{anchor:"transformers.models.led.modeling_tf_led.TFLEDSeq2SeqLMOutput.loss",description:`<strong>loss</strong> (<code>tf.Tensor</code> of shape <code>(1,)</code>, <em>optional</em>, returned when <code>labels</code> is provided) &#x2014;
...
<p>Indices can be obtained using <code>LedTokenizer</code>. See <a href="/docs/transformers/v4.19.4/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/v4.19.4/en/model_doc/wav2vec2#transformers.Wav2Vec2CTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
Whether or not to return a <a href="/docs/transformers/v4.19.4/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/v4.19.4/src/transformers/models/led/modeling_led.py#L2184",returnDescription:`
<p>A <a
...
elements depending on the configuration (<a
  href="/docs/transformers/v4.19.4/en/model_doc/led#transformers.LEDConfig"
...
(masked), the loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.19.4/src/transformers/models/led/modeling_led.py#L2324",returnDescription:`
<p>A <a
...
Labels for computing the sequence classification/regression loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>. If <code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.19.4/src/transformers/models/led/modeling_led.py#L2484",returnDescription:`
<p>A <a
...
Positions are clamped to the length of the sequence (<em>sequence_length</em>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/v4.19.4/src/transformers/models/led/modeling_led.py#L2611",returnDescription:`
<p>A <a
...
behaviors between training and evaluation).`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/v4.19.4/src/transformers/models/led/modeling_tf_led.py#L2203",returnDescription:`
<p>A <a
  href="/docs/transformers/v4.19.4/en/model_doc/led#transformers.models.led.modeling_tf_led.TFLEDSeq2SeqModelOutput"
...
Whether or not to use the model in training mode (some modules like dropout modules have different
behaviors between training and evaluation).`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/v4.19.4/src/transformers/models/led/modeling_tf_led.py#L2312",returnDescription:`
<p>A <a
  href="/docs/transformers/v4.19.4/en/model_doc/led#transformers.models.led.modeling_tf_led.TFLEDSeq2SeqLMOutput"
...
`),N=a("a"),He=n("BartForConditionalGeneration"),ne=n(" exchanging the traditional "),Te=a("em"),q=n("self-attention"),z=n(` layer with
`),se=a("em"),ot=n("Longformer"),nt=n("\u2019s "),P=a("em"),st=n("chunked self-attention"),at=n(" layer. "),Fe=a("a"),U=n("LEDTokenizer"),ae=n(` is an alias of
...
documentation from `),Vn=a("a"),ii=n("PretrainedConfig"),li=n(" for more information."),ci=c(),T(Nt.$$.fragment),Ra=c(),pt=a("h2"),Pt=a("a"),Ps=a("span"),T(Co.$$.fragment),hi=c(),Is=a("span"),pi=n("LEDTokenizer"),Ua=c(),A=a("div"),T(Oo.$$.fragment),ui=c(),Gs=a("p"),mi=n("Construct a LED tokenizer."),fi=c(),It=a("p"),Rn=a("a"),_i=n("LEDTokenizer"),gi=n(" is identical to "),Un=a("a"),vi=n("BartTokenizer"),bi=n(` and runs end-to-end tokenization: punctuation splitting and
...
adding special tokens. A BART sequence has the following format:`),$i=c(),No=a("ul"),Jn=a("li"),Di=n("single sequence: "),Qs=a("code"),Fi=n("<s> X </s>"),zi=c(),Zn=a("li"),xi=n("pair of sequences: "),Ws=a("code"),Si=n("<s> A </s></s> B </s>"),Mi=c(),Gt=a("div"),T(Po.$$.fragment),Ci=c(),Io=a("p"),Oi=n(`Retrieve sequence ids from a token list that has no special tokens added. This method is called when adding
special tokens using the tokenizer `),Hs=a("code"),ji=n("prepare_for_model"),Ai=n(" method."),Ni=c(),Bt=a("div"),T(Go.$$.fragment),Pi=c(),Vs=a("p"),Ii=n(`Create a mask from the two sequences passed to be used in a sequence-pair classification task. BART does not
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for general usage and behavior.`),xl=c(),xe=a("div"),T(dn.$$.fragment),Sl=c(),Et=a("p"),Ml=n("The "),ns=a("a"),Cl=n("LEDModel"),Ol=n(" forward method, overrides the "),ia=a("code"),jl=n("__call__"),Al=n(" special method."),Nl=c(),T(Rt.$$.fragment),Pl=c(),T(Ut.$$.fragment),ir=c(),Lt=a("h2"),Xt=a("a"),la=a("span"),T(ln.$$.fragment),Il=c(),ca=a("span"),Gl=n("LEDForConditionalGeneration"),lr=c(),Le=a("div"),T(cn.$$.fragment),Bl=c(),hn=a("p"),Ql=n(`The LED Model with a language modeling head. Can be used for summarization.
...
on top of the hidden-states output to compute `),va=a("code"),Cc=n("span start logits"),Oc=n(" and "),ba=a("code"),jc=n("span end logits"),Ac=n(")."),Nc=c(),yn=a("p"),Pc=n("This model inherits from "),is=a("a"),Ic=n("PreTrainedModel"),Gc=n(`. See the superclass documentation for the generic methods the library
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Sh=c(),T(fo.$$.fragment),Mh=c(),Me=a("div"),T(Nn.$$.fragment),Ch=c(),Ot=a("p"),Oh=n("The "),us=a("a"),jh=n("TFLEDForConditionalGeneration"),Ah=n(" forward method, overrides the "),qa=a("code"),Nh=n("__call__"),Ph=n(" special method."),Ih=c(),T(_o.$$.fragment),Gh=c(),T(go.$$.fragment),this.h()},l(o){const _=Bu('[data-svelte="svelte-1phssyn"]',document.head);l=r(_,"META",{name:!0,content:!0}),_.forEach(t),v=h(o),p=r(o,"H1",{class:!0});var Pn=d(p);u=r(Pn,"A",{id:!0,class:!0,href:!0});var $a=d(u);b=r($a,"SPAN",{});var Da=d(b);k(i.$$.fragment,Da),Da.forEach(t),$a.forEach(t),f=h(Pn),D=r(Pn,"SPAN",{});var Fa=d(D);Ne=s(Fa,"LED"),Fa.forEach(t),Pn.forEach(t),pe=h(o),F=r(o,"H2",{class:!0});var In=d(F);Z=r(In,"A",{id:!0,class:!0,href:!0});var za=d(Z);W=r(za,"SPAN",{});var xa=d(W);k(ee.$$.fragment,xa),xa.forEach(t),za.forEach(t),Pe=h(In),H=r(In,"SPAN",{});var Sa=d(H);Ie=s(Sa,"Overview"),Sa.forEach(t),In.forEach(t),qe=h(o),I=r(o,"P",{});var Gn=d(I);V=s(Gn,"The LED model was proposed in "),te=r(Gn,"A",{href:!0,rel:!0});var Ma=d(te);be=s(Ma,"Longformer: The Long-Document Transformer"),Ma.forEach(t),C=s(Gn,` by Iz
...
WikiHop and TriviaQA. We finally introduce the Longformer-Encoder-Decoder (LED), a Longformer variant for supporting
long document generative sequence-to-sequence tasks, and demonstrate its effectiveness on the arXiv summarization
dataset.`),ja.forEach(t),Oa.forEach(t),De=h(o),O=r(o,"P",{});var Aa=d(O);Be=s(Aa,"Tips:"),Aa.forEach(t),K=h(o),S=r(o,"UL",{});var J=d(S);M=r(J,"LI",{});var Q=d(M);G=r(Q,"A",{href:!0});var Na=d(G);Qe=s(Na,"LEDForConditionalGeneration"),Na.forEach(t),We=s(Q,` is an extension of
`),N=r(Q,"A",{href:!0});var Pa=d(N);He=s(Pa,"BartForConditionalGeneration"),Pa.forEach(t),ne=s(Q," exchanging the traditional "),Te=r(Q,"EM",{});var Ia=d(Te);q=s(Ia,"self-attention"),Ia.forEach(t),z=s(Q,` layer with
`),se=r(Q,"EM",{});var Ga=d(se);ot=s(Ga,"Longformer"),Ga.forEach(t),nt=s(Q,"\u2019s "),P=r(Q,"EM",{});var Wh=d(P);st=s(Wh,"chunked self-attention"),Wh.forEach(t),at=s(Q," layer. "),Fe=r(Q,"A",{href:!0});var Hh=d(Fe);U=s(Hh,"LEDTokenizer"),Hh.forEach(t),ae=s(Q,` is an alias of
...
documentation from `),Vn=r(gs,"A",{href:!0});var _p=d(Vn);ii=s(_p,"PretrainedConfig"),_p.forEach(t),li=s(gs," for more information."),gs.forEach(t),ci=h(vo),k(Nt.$$.fragment,vo),vo.forEach(t),Ra=h(o),pt=r(o,"H2",{class:!0});var yr=d(pt);Pt=r(yr,"A",{id:!0,class:!0,href:!0});var gp=d(Pt);Ps=r(gp,"SPAN",{});var vp=d(Ps);k(Co.$$.fragment,vp),vp.forEach(t),gp.forEach(t),hi=h(yr),Is=r(yr,"SPAN",{});var bp=d(Is);pi=s(bp,"LEDTokenizer"),bp.forEach(t),yr.forEach(t),Ua=h(o),A=r(o,"DIV",{class:!0});var Y=d(A);k(Oo.$$.fragment,Y),ui=h(Y),Gs=r(Y,"P",{});var Tp=d(Gs);mi=s(Tp,"Construct a LED tokenizer."),Tp.forEach(t),fi=h(Y),It=r(Y,"P",{});var Ba=d(It);Rn=r(Ba,"A",{href:!0});var kp=d(Rn);_i=s(kp,"LEDTokenizer"),kp.forEach(t),gi=s(Ba," is identical to "),Un=r(Ba,"A",{href:!0});var wp=d(Un);vi=s(wp,"BartTokenizer"),wp.forEach(t),bi=s(Ba,` and runs end-to-end tokenization: punctuation splitting and
...
adding special tokens. A BART sequence has the following format:`),Ep.forEach(t),$i=h(vs),No=r(vs,"UL",{});var Lr=d(No);Jn=r(Lr,"LI",{});var Bh=d(Jn);Di=s(Bh,"single sequence: "),Qs=r(Bh,"CODE",{});var Lp=d(Qs);Fi=s(Lp,"<s> X </s>"),Lp.forEach(t),Bh.forEach(t),zi=h(Lr),Zn=r(Lr,"LI",{});var Qh=d(Zn);xi=s(Qh,"pair of sequences: "),Ws=r(Qh,"CODE",{});var qp=d(Ws);Si=s(qp,"<s> A </s></s> B </s>"),qp.forEach(t),Qh.forEach(t),Lr.forEach(t),vs.forEach(t),Mi=h(Y),Gt=r(Y,"DIV",{class:!0});var qr=d(Gt);k(Po.$$.fragment,qr),Ci=h(qr),Io=r(qr,"P",{});var $r=d(Io);Oi=s($r,`Retrieve sequence ids from a token list that has no special tokens added. This method is called when adding
special tokens using the tokenizer `),Hs=r($r,"CODE",{});var $p=d(Hs);ji=s($p,"prepare_for_model"),$p.forEach(t),Ai=s($r," method."),$r.forEach(t),qr.forEach(t),Ni=h(Y),Bt=r(Y,"DIV",{class:!0});var Dr=d(Bt);k(Go.$$.fragment,Dr),Pi=h(Dr),Vs=r(Dr,"P",{});var Dp=d(Vs);Ii=s(Dp,`Create a mask from the two sequences passed to be used in a sequence-pair classification task. BART does not
...
and wordpiece.`),Qa.forEach(t),Yi=h(bo),Vo=r(bo,"P",{});var xr=d(Vo);el=s(xr,"Refer to superclass "),ts=r(xr,"A",{href:!0});var jp=d(ts);tl=s(jp,"BartTokenizerFast"),jp.forEach(t),ol=s(xr," for usage examples and documentation concerning parameters."),xr.forEach(t),bo.forEach(t),Za=h(o),mt=r(o,"H2",{class:!0});var Sr=d(mt);Ht=r(Sr,"A",{id:!0,class:!0,href:!0});var Ap=d(Ht);Js=r(Ap,"SPAN",{});var Np=d(Js);k(Ro.$$.fragment,Np),Np.forEach(t),Ap.forEach(t),nl=h(Sr),Zs=r(Sr,"SPAN",{});var Pp=d(Zs);sl=s(Pp,"LED specific outputs"),Pp.forEach(t),Sr.forEach(t),Ka=h(o),ft=r(o,"DIV",{class:!0});var Mr=d(ft);k(Uo.$$.fragment,Mr),al=h(Mr),Ks=r(Mr,"P",{});var Ip=d(Ks);rl=s(Ip,"Base class for LEDEncoder\u2019s outputs, with potential hidden states, local and global attentions."),Ip.forEach(t),Mr.forEach(t),Ya=h(o),_t=r(o,"DIV",{class:!0});var Cr=d(_t);k(Xo.$$.fragment,Cr),dl=h(Cr),Ys=r(Cr,"P",{});var Gp=d(Ys);il=s(Gp,`Base class for model encoder\u2019s outputs that also contains : pre-computed hidden states that can speed up sequential
decoding.`),Gp.forEach(t),Cr.forEach(t),er=h(o),gt=r(o,"DIV",{class:!0});var Or=d(gt);k(Jo.$$.fragment,Or),ll=h(Or),ea=r(Or,"P",{});var Bp=d(ea);cl=s(Bp,"Base class for sequence-to-sequence language models outputs."),Bp.forEach(t),Or.forEach(t),tr=h(o),vt=r(o,"DIV",{class:!0});var jr=d(vt);k(Zo.$$.fragment,jr),hl=h(jr),ta=r(jr,"P",{});var Qp=d(ta);pl=s(Qp,"Base class for outputs of sequence-to-sequence sentence classification models."),Qp.forEach(t),jr.forEach(t),or=h(o),bt=r(o,"DIV",{class:!0});var Ar=d(bt);k(Ko.$$.fragment,Ar),ul=h(Ar),oa=r(Ar,"P",{});var Wp=d(oa);ml=s(Wp,"Base class for outputs of sequence-to-sequence question answering models."),Wp.forEach(t),Ar.forEach(t),nr=h(o),Tt=r(o,"DIV",{class:!0});var Nr=d(Tt);k(Yo.$$.fragment,Nr),fl=h(Nr),na=r(Nr,"P",{});var Hp=d(na);_l=s(Hp,"Base class for Longformer\u2019s outputs, with potential hidden states, local and global attentions."),Hp.forEach(t),Nr.forEach(t),sr=h(o),kt=r(o,"DIV",{class:!0});var Pr=d(kt);k(en.$$.fragment,Pr),gl=h(Pr),sa=r(Pr,"P",{});var Vp=d(sa);vl=s(Vp,`Base class for model encoder\u2019s outputs that also contains : pre-computed hidden states that can speed up sequential
decoding.`),Vp.forEach(t),Pr.forEach(t),ar=h(o),wt=r(o,"DIV",{class:!0});var Ir=d(wt);k(tn.$$.fragment,Ir),bl=h(Ir),aa=r(Ir,"P",{});var Rp=d(aa);Tl=s(Rp,"Base class for sequence-to-sequence language models outputs."),Rp.forEach(t),Ir.forEach(t),rr=h(o),yt=r(o,"H2",{class:!0});var Gr=d(yt);Vt=r(Gr,"A",{id:!0,class:!0,href:!0});var Up=d(Vt);ra=r(Up,"SPAN",{});var Xp=d(ra);k(on.$$.fragment,Xp),Xp.forEach(t),Up.forEach(t),kl=h(Gr),da=r(Gr,"SPAN",{});var Jp=d(da);wl=s(Jp,"LEDModel"),Jp.forEach(t),Gr.forEach(t),dr=h(o),Ee=r(o,"DIV",{class:!0});var To=d(Ee);k(nn.$$.fragment,To),yl=h(To),sn=r(To,"P",{});var Br=d(sn);El=s(Br,`The bare LED Model outputting raw hidden-states without any specific head on top.
...
on top of the hidden-states output to compute `),va=r(ws,"CODE",{});var bu=d(va);Cc=s(bu,"span start logits"),bu.forEach(t),Oc=s(ws," and "),ba=r(ws,"CODE",{});var Tu=d(ba);jc=s(Tu,"span end logits"),Tu.forEach(t),Ac=s(ws,")."),ws.forEach(t),Nc=h(Ke),yn=r(Ke,"P",{});var Zr=d(yn);Pc=s(Zr,"This model inherits from "),is=r(Zr,"A",{href:!0});var ku=d(is);Ic=s(ku,"PreTrainedModel"),ku.forEach(t),Gc=s(Zr,`. See the superclass documentation for the generic methods the library
