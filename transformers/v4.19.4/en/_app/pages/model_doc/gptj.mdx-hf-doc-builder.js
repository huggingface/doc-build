...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),{c(){d=a("p"),T=n("Example:"),c=h(),k(p.$$.fragment)},l(l){d=r(l,"P",{});var m=i(d);T=s(m,"Example:"),m.forEach(t),c=u(l),b(p.$$.fragment,l)},m(l,m){g(l,d,m),e(d,T),g(l,c,m),w(p,l,m),v=!0},p:Ee,i(l){v||($(p.$$.fragment,l),v=!0)},o(l){P(p.$$.fragment,l),v=!1},d(l){l&&t(d),l&&t(c),F(p,l)}}}function Gf(j){let d,T,c,p,v,l,m,x,he,K,J,X,D,Z,ue,W,me,re,I,L,ee,te,E,M,fe,Q,ie,Y,H,oe,ge,q,le,N,_e,de,O,U,Te,C,ve,R,ne;return{c(){d=a("p"),T=n("TF 2.0 models accepts two formats as inputs:"),c=h(),p=a("ul"),v=a("li"),l=n("having all inputs as keyword arguments (like PyTorch models), or"),m=h(),x=a("li"),he=n("having all inputs as a list, tuple or dict in the first positional arguments."),K=h(),J=a("p"),X=n("This second option is useful when using "),D=a("code"),Z=n("tf.keras.Model.fit"),ue=n(` method which currently requires having all the
tensors in the first argument of the model call function: `),W=a("code"),me=n("model(inputs)"),re=n("."),I=h(),L=a("p"),ee=n(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),te=h(),E=a("ul"),M=a("li"),fe=n("a single Tensor with "),Q=a("code"),ie=n("input_ids"),Y=n(" only and nothing else: "),H=a("code"),oe=n("model(inputs_ids)"),ge=h(),q=a("li"),le=n(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),N=a("code"),_e=n("model([input_ids, attention_mask])"),de=n(" or "),O=a("code"),U=n("model([input_ids, attention_mask, token_type_ids])"),Te=h(),C=a("li"),ve=n(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),R=a("code"),ne=n('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(y){d=r(y,"P",{});var G=i(d);T=s(G,"TF 2.0 models accepts two formats as inputs:"),G.forEach(t),c=u(y),p=r(y,"UL",{});var V=i(p);v=r(V,"LI",{});var Ce=i(v);l=s(Ce,"having all inputs as keyword arguments (like PyTorch models), or"),Ce.forEach(t),m=u(V),x=r(V,"LI",{});var ze=i(x);he=s(ze,"having all inputs as a list, tuple or dict in the first positional arguments."),ze.forEach(t),V.forEach(t),K=u(y),J=r(y,"P",{});var z=i(J);X=s(z,"This second option is useful when using "),D=r(z,"CODE",{});var Ae=i(D);Z=s(Ae,"tf.keras.Model.fit"),Ae.forEach(t),ue=s(z,` method which currently requires having all the
...
<span class="hljs-meta">&gt;&gt;&gt; </span>inputs = tokenizer(<span class="hljs-string">&quot;Hello, my dog is cute&quot;</span>, return_tensors=<span class="hljs-string">&quot;tf&quot;</span>)
<span class="hljs-meta">&gt;&gt;&gt; </span>outputs = model(inputs)
<span class="hljs-meta">&gt;&gt;&gt; </span>logits = outputs.logits`}}),{c(){d=a("p"),T=n("Example:"),c=h(),k(p.$$.fragment)},l(l){d=r(l,"P",{});var m=i(d);T=s(m,"Example:"),m.forEach(t),c=u(l),b(p.$$.fragment,l)},m(l,m){g(l,d,m),e(d,T),g(l,c,m),w(p,l,m),v=!0},p:Ee,i(l){v||($(p.$$.fragment,l),v=!0)},o(l){P(p.$$.fragment,l),v=!1},d(l){l&&t(d),l&&t(c),F(p,l)}}}function Mf(j){let d,T,c,p,v,l,m,x,he,K,J,X,D,Z,ue,W,me,re,I,L,ee,te,E,M,fe,Q,ie,Y,H,oe,ge,q,le,N,_e,de,O,U,Te,C,ve,R,ne;return{c(){d=a("p"),T=n("TF 2.0 models accepts two formats as inputs:"),c=h(),p=a("ul"),v=a("li"),l=n("having all inputs as keyword arguments (like PyTorch models), or"),m=h(),x=a("li"),he=n("having all inputs as a list, tuple or dict in the first positional arguments."),K=h(),J=a("p"),X=n("This second option is useful when using "),D=a("code"),Z=n("tf.keras.Model.fit"),ue=n(` method which currently requires having all the
tensors in the first argument of the model call function: `),W=a("code"),me=n("model(inputs)"),re=n("."),I=h(),L=a("p"),ee=n(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),te=h(),E=a("ul"),M=a("li"),fe=n("a single Tensor with "),Q=a("code"),ie=n("input_ids"),Y=n(" only and nothing else: "),H=a("code"),oe=n("model(inputs_ids)"),ge=h(),q=a("li"),le=n(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),N=a("code"),_e=n("model([input_ids, attention_mask])"),de=n(" or "),O=a("code"),U=n("model([input_ids, attention_mask, token_type_ids])"),Te=h(),C=a("li"),ve=n(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),R=a("code"),ne=n('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(y){d=r(y,"P",{});var G=i(d);T=s(G,"TF 2.0 models accepts two formats as inputs:"),G.forEach(t),c=u(y),p=r(y,"UL",{});var V=i(p);v=r(V,"LI",{});var Ce=i(v);l=s(Ce,"having all inputs as keyword arguments (like PyTorch models), or"),Ce.forEach(t),m=u(V),x=r(V,"LI",{});var ze=i(x);he=s(ze,"having all inputs as a list, tuple or dict in the first positional arguments."),ze.forEach(t),V.forEach(t),K=u(y),J=r(y,"P",{});var z=i(J);X=s(z,"This second option is useful when using "),D=r(z,"CODE",{});var Ae=i(D);Z=s(Ae,"tf.keras.Model.fit"),Ae.forEach(t),ue=s(z,` method which currently requires having all the
...
`}}),{c(){k(d.$$.fragment)},l(c){b(d.$$.fragment,c)},m(c,p){w(d,c,p),T=!0},p:Ee,i(c){T||($(d.$$.fragment,c),T=!0)},o(c){P(d.$$.fragment,c),T=!1},d(c){F(d,c)}}}function Af(j){let d,T,c,p,v,l,m,x,he,K,J,X,D,Z,ue,W,me,re,I,L,ee,te,E,M,fe,Q,ie,Y,H,oe,ge,q,le,N,_e,de,O,U,Te,C,ve,R,ne;return{c(){d=a("p"),T=n("TF 2.0 models accepts two formats as inputs:"),c=h(),p=a("ul"),v=a("li"),l=n("having all inputs as keyword arguments (like PyTorch models), or"),m=h(),x=a("li"),he=n("having all inputs as a list, tuple or dict in the first positional arguments."),K=h(),J=a("p"),X=n("This second option is useful when using "),D=a("code"),Z=n("tf.keras.Model.fit"),ue=n(` method which currently requires having all the
tensors in the first argument of the model call function: `),W=a("code"),me=n("model(inputs)"),re=n("."),I=h(),L=a("p"),ee=n(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),te=h(),E=a("ul"),M=a("li"),fe=n("a single Tensor with "),Q=a("code"),ie=n("input_ids"),Y=n(" only and nothing else: "),H=a("code"),oe=n("model(inputs_ids)"),ge=h(),q=a("li"),le=n(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),N=a("code"),_e=n("model([input_ids, attention_mask])"),de=n(" or "),O=a("code"),U=n("model([input_ids, attention_mask, token_type_ids])"),Te=h(),C=a("li"),ve=n(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),R=a("code"),ne=n('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(y){d=r(y,"P",{});var G=i(d);T=s(G,"TF 2.0 models accepts two formats as inputs:"),G.forEach(t),c=u(y),p=r(y,"UL",{});var V=i(p);v=r(V,"LI",{});var Ce=i(v);l=s(Ce,"having all inputs as keyword arguments (like PyTorch models), or"),Ce.forEach(t),m=u(V),x=r(V,"LI",{});var ze=i(x);he=s(ze,"having all inputs as a list, tuple or dict in the first positional arguments."),ze.forEach(t),V.forEach(t),K=u(y),J=r(y,"P",{});var z=i(J);X=s(z,"This second option is useful when using "),D=r(z,"CODE",{});var Ae=i(D);Z=s(Ae,"tf.keras.Model.fit"),Ae.forEach(t),ue=s(z,` method which currently requires having all the
...
<span class="hljs-meta">&gt;&gt;&gt; </span>next_token_logits = outputs.logits[:, -<span class="hljs-number">1</span>]`}}),{c(){d=a("p"),T=n("Example:"),c=h(),k(p.$$.fragment)},l(l){d=r(l,"P",{});var m=i(d);T=s(m,"Example:"),m.forEach(t),c=u(l),b(p.$$.fragment,l)},m(l,m){g(l,d,m),e(d,T),g(l,c,m),w(p,l,m),v=!0},p:Ee,i(l){v||($(p.$$.fragment,l),v=!0)},o(l){P(p.$$.fragment,l),v=!1},d(l){l&&t(d),l&&t(c),F(p,l)}}}function Uf(j){let d,T,c,p,v,l,m,x,he,K,J,X,D,Z,ue,W,me,re,I,L,ee,te,E,M,fe,Q,ie,Y,H,oe,ge,q,le,N,_e,de,O,U,Te,C,ve,R,ne,y,G,V,Ce,ze,z,Ae,Le,Me,A,B,ce,Pe,S,Ie,ye,ke,Ne,ta,ct,Ni,Ro,Oi,Si,oa,Di,Wi,na,Ui,Bi,Lr,bt,Ht,sa,Vo,Qi,aa,Hi,Ir,Rt,Ri,_s,Vi,Ki,Nr,Ko,Or,Ts,Xi,Sr,Xo,Dr,wt,Vt,ra,Yo,Yi,ia,Zi,Wr,pt,Zo,el,Re,tl,vs,ol,nl,en,sl,al,ys,rl,il,ks,ll,dl,cl,Kt,Ur,$t,Xt,la,tn,pl,da,hl,Br,ht,on,ul,nn,ml,sn,fl,gl,_l,et,an,Tl,Pt,vl,bs,yl,kl,ca,bl,wl,$l,Yt,Pl,Zt,Qr,Ft,eo,pa,rn,Fl,ha,jl,Hr,Ve,ln,xl,ua,Gl,Jl,dn,El,cn,Ml,ql,Cl,tt,pn,zl,jt,Al,ws,Ll,Il,ma,Nl,Ol,Sl,to,Dl,oo,Rr,xt,no,fa,hn,Wl,ga,Ul,Vr,Fe,un,Bl,_a,Ql,Hl,$s,Ps,Rl,Vl,Kl,Ke,Xl,Ta,Yl,Zl,va,ed,td,ya,od,nd,ka,sd,ad,rd,mn,id,fn,ld,dd,cd,$e,gn,pd,Gt,hd,Fs,ud,md,ba,fd,gd,_d,so,Td,ao,vd,ro,yd,io,kd,lo,Kr,Jt,co,wa,_n,bd,$a,wd,Xr,Xe,Tn,$d,Et,Pd,Pa,Fd,jd,Fa,xd,Gd,Jd,vn,Ed,yn,Md,qd,Cd,Oe,kn,zd,Mt,Ad,js,Ld,Id,ja,Nd,Od,Sd,po,Dd,ho,Wd,uo,Yr,qt,mo,xa,bn,Ud,Ga,Bd,Zr,je,wn,Qd,Ja,Hd,Rd,$n,Vd,xs,Kd,Xd,Yd,Pn,Zd,Fn,ec,tc,oc,fo,nc,ot,jn,sc,Ct,ac,Gs,rc,ic,Ea,lc,dc,cc,go,pc,_o,ei,zt,To,Ma,xn,hc,qa,uc,ti,xe,Gn,mc,Ca,fc,gc,Jn,_c,Js,Tc,vc,yc,En,kc,Mn,bc,wc,$c,vo,Pc,nt,qn,Fc,At,jc,Es,xc,Gc,za,Jc,Ec,Mc,yo,qc,ko,oi,Lt,bo,Aa,Cn,Cc,La,zc,ni,se,zn,Ac,Ia,Lc,Ic,Ms,qs,Nc,Oc,Sc,Ye,Dc,Na,Wc,Uc,Oa,Bc,Qc,Sa,Hc,Rc,Da,Vc,Kc,Xc,An,Yc,Cs,Zc,ep,tp,Ln,op,In,np,sp,ap,wo,rp,Se,Nn,ip,It,lp,zs,dp,cp,Wa,pp,hp,up,$o,mp,Po,fp,Fo,si,Nt,jo,Ua,On,gp,Ba,_p,ai,Ge,Sn,Tp,Ot,vp,Qa,yp,kp,Ha,bp,wp,$p,Dn,Pp,As,Fp,jp,xp,Wn,Gp,Un,Jp,Ep,Mp,xo,qp,De,Bn,Cp,St,zp,Ls,Ap,Lp,Ra,Ip,Np,Op,Go,Sp,Jo,Dp,Eo,ri,Dt,Mo,Va,Qn,Wp,Ka,Up,ii,be,Hn,Bp,Xa,Qp,Hp,Rn,Rp,Is,Vp,Kp,Xp,Vn,Yp,Kn,Zp,eh,th,Ya,oh,nh,ut,Za,Xn,sh,ah,er,Yn,rh,ih,tr,Zn,lh,dh,or,es,ch,ph,st,ts,hh,Wt,uh,nr,mh,fh,sr,gh,_h,Th,qo,vh,Co,li,Ut,zo,ar,os,yh,rr,kh,di,we,ns,bh,ir,wh,$h,ss,Ph,Ns,Fh,jh,xh,as,Gh,rs,Jh,Eh,Mh,lr,qh,Ch,mt,dr,is,zh,Ah,cr,ls,Lh,Ih,pr,ds,Nh,Oh,hr,cs,Sh,Dh,at,ps,Wh,Bt,Uh,ur,Bh,Qh,mr,Hh,Rh,Vh,Ao,Kh,Lo,ci;return l=new He({}),Z=new He({}),A=new pe({props:{code:`from transformers import GPTJForCausalLM
import torch
...
<code>inputs_ids</code> passed when calling <a href="/docs/transformers/v4.19.4/en/model_doc/gptj#transformers.GPTJModel">GPTJModel</a>.`,name:"vocab_size"},{anchor:"transformers.GPTJConfig.n_positions",description:`<strong>n_positions</strong> (<code>int</code>, <em>optional</em>, defaults to 2048) &#x2014;
...
Whether or not to return a <a href="/docs/transformers/v4.19.4/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/v4.19.4/src/transformers/models/gptj/modeling_gptj.py#L530",returnDescription:`
<p>A <a
  href="/docs/transformers/v4.19.4/en/main_classes/output#transformers.modeling_outputs.BaseModelOutputWithPast"
>transformers.modeling_outputs.BaseModelOutputWithPast</a> or a tuple of
<code>torch.FloatTensor</code> (if <code>return_dict=False</code> is passed or when <code>config.return_dict=False</code>) comprising various
elements depending on the configuration (<a
  href="/docs/transformers/v4.19.4/en/model_doc/gptj#transformers.GPTJConfig"
...
are ignored (masked), the loss is only computed for labels in <code>[0, ..., config.vocab_size]</code>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.19.4/src/transformers/models/gptj/modeling_gptj.py#L784",returnDescription:`
<p>A <a
  href="/docs/transformers/v4.19.4/en/main_classes/output#transformers.modeling_outputs.CausalLMOutputWithPast"
...
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.19.4/src/transformers/models/gptj/modeling_gptj.py#L906",returnDescription:`
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/v4.19.4/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/v4.19.4/src/transformers/models/gptj/modeling_gptj.py#L1017"}}),kn=new ae({props:{name:"forward",anchor:"transformers.GPTJForQuestionAnswering.forward",parameters:[{name:"input_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"attention_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"token_type_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"position_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"head_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"start_positions",val:": typing.Optional[torch.LongTensor] = None"},{name:"end_positions",val:": typing.Optional[torch.LongTensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.GPTJForQuestionAnswering.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <code>GPTJTokenizer</code>. See <a href="/docs/transformers/v4.19.4/en/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/v4.19.4/en/model_doc/wav2vec2#transformers.Wav2Vec2CTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/v4.19.4/src/transformers/models/gptj/modeling_gptj.py#L1033",returnDescription:`
<p>A <a
...
<p>Indices can be obtained using <code>GPTJTokenizer</code>. See <a href="/docs/transformers/v4.19.4/en/model_doc/wav2vec2#transformers.Wav2Vec2CTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
...
Whether or not to return a <a href="/docs/transformers/v4.19.4/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple. This argument can be used
...
<code>past</code>). Set to <code>False</code> during training, <code>True</code> during generation`,name:"use_cache"}],source:"https://github.com/huggingface/transformers/blob/v4.19.4/src/transformers/models/gptj/modeling_tf_gptj.py#L652",returnDescription:`
<p>A <a
  href="/docs/transformers/v4.19.4/en/main_classes/output#transformers.modeling_tf_outputs.TFBaseModelOutputWithPast"
...
Labels for language modeling. Note that the labels <strong>are shifted</strong> inside the model, i.e. you can set
<code>labels = input_ids</code> Indices are selected in <code>[-100, 0, ..., config.vocab_size]</code> All labels set to <code>-100</code>
are ignored (masked), the loss is only computed for labels in <code>[0, ..., config.vocab_size]</code>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.19.4/src/transformers/models/gptj/modeling_tf_gptj.py#L759",returnDescription:`
<p>A <a
  href="/docs/transformers/v4.19.4/en/main_classes/output#transformers.modeling_tf_outputs.TFCausalLMOutputWithPast"
...
Labels for computing the sequence classification/regression loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>. If <code>config.num_labels == 1</code> a regression loss is computed (Mean-Square loss), If
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.19.4/src/transformers/models/gptj/modeling_tf_gptj.py#L863",returnDescription:`
<p>A <a
...
Labels for position (index) of the end of the labelled span for computing the token classification loss.
Positions are clamped to the length of the sequence (<code>sequence_length</code>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/v4.19.4/src/transformers/models/gptj/modeling_tf_gptj.py#L986",returnDescription:`
<p>A <a
...
causal language model trained on `),M=a("a"),fe=n("the Pile"),Q=n(" dataset."),ie=h(),Y=a("p"),H=n("This model was contributed by "),oe=a("a"),ge=n("Stella Biderman"),q=n("."),le=h(),N=a("p"),_e=n("Tips:"),de=h(),O=a("ul"),U=a("li"),Te=n("To load "),C=a("a"),ve=n("GPT-J"),R=n(` in float32 one would need at least 2x model size CPU
...
behavior.`),_l=h(),et=a("div"),k(an.$$.fragment),Tl=h(),Pt=a("p"),vl=n("The "),bs=a("a"),yl=n("GPTJModel"),kl=n(" forward method, overrides the "),ca=a("code"),bl=n("__call__"),wl=n(" special method."),$l=h(),k(Yt.$$.fragment),Pl=h(),k(Zt.$$.fragment),Qr=h(),Ft=a("h2"),eo=a("a"),pa=a("span"),k(rn.$$.fragment),Fl=h(),ha=a("span"),jl=n("GPTJForCausalLM"),Hr=h(),Ve=a("div"),k(ln.$$.fragment),xl=h(),ua=a("p"),Gl=n("The GPT-J Model transformer with a language modeling head on top."),Jl=h(),dn=a("p"),El=n("This model is a PyTorch "),cn=a("a"),Ml=n("torch.nn.Module"),ql=n(` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),$c=h(),k(vo.$$.fragment),Pc=h(),nt=a("div"),k(qn.$$.fragment),Fc=h(),At=a("p"),jc=n("The "),Es=a("a"),xc=n("TFGPTJForCausalLM"),Gc=n(" forward method, overrides the "),za=a("code"),Jc=n("__call__"),Ec=n(" special method."),Mc=h(),k(yo.$$.fragment),qc=h(),k(ko.$$.fragment),oi=h(),Lt=a("h2"),bo=a("a"),Aa=a("span"),k(Cn.$$.fragment),Cc=h(),La=a("span"),zc=n("TFGPTJForSequenceClassification"),ni=h(),se=a("div"),k(zn.$$.fragment),Ac=h(),Ia=a("p"),Lc=n("The GPT-J Model transformer with a sequence classification head on top (linear layer)."),Ic=h(),Ms=a("p"),qs=a("a"),Nc=n("GPTJForSequenceClassification"),Oc=n(` uses the last token in order to do the classification, as other causal models
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),ap=h(),k(wo.$$.fragment),rp=h(),Se=a("div"),k(Nn.$$.fragment),ip=h(),It=a("p"),lp=n("The "),zs=a("a"),dp=n("TFGPTJForSequenceClassification"),cp=n(" forward method, overrides the "),Wa=a("code"),pp=n("__call__"),hp=n(" special method."),up=h(),k($o.$$.fragment),mp=h(),k(Po.$$.fragment),fp=h(),k(Fo.$$.fragment),si=h(),Nt=a("h2"),jo=a("a"),Ua=a("span"),k(On.$$.fragment),gp=h(),Ba=a("span"),_p=n("TFGPTJForQuestionAnswering"),ai=h(),Ge=a("div"),k(Sn.$$.fragment),Tp=h(),Ot=a("p"),vp=n(`The GPT-J Model transformer with a span classification head on top for extractive question-answering tasks like
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Gi.forEach(t),ap=u(qe),b(wo.$$.fragment,qe),rp=u(qe),Se=r(qe,"DIV",{class:!0});var yt=i(Se);b(Nn.$$.fragment,yt),ip=u(yt),It=r(yt,"P",{});var Ks=i(It);lp=s(Ks,"The "),zs=r(Ks,"A",{href:!0});var gm=i(zs);dp=s(gm,"TFGPTJForSequenceClassification"),gm.forEach(t),cp=s(Ks," forward method, overrides the "),Wa=r(Ks,"CODE",{});var _m=i(Wa);pp=s(_m,"__call__"),_m.forEach(t),hp=s(Ks," special method."),Ks.forEach(t),up=u(yt),b($o.$$.fragment,yt),mp=u(yt),b(Po.$$.fragment,yt),fp=u(yt),b(Fo.$$.fragment,yt),yt.forEach(t),qe.forEach(t),si=u(o),Nt=r(o,"H2",{class:!0});var Ji=i(Nt);jo=r(Ji,"A",{id:!0,class:!0,href:!0});var Tm=i(jo);Ua=r(Tm,"SPAN",{});var vm=i(Ua);b(On.$$.fragment,vm),vm.forEach(t),Tm.forEach(t),gp=u(Ji),Ba=r(Ji,"SPAN",{});var ym=i(Ba);_p=s(ym,"TFGPTJForQuestionAnswering"),ym.forEach(t),Ji.forEach(t),ai=u(o),Ge=r(o,"DIV",{class:!0});var dt=i(Ge);b(Sn.$$.fragment,dt),Tp=u(dt),Ot=r(dt,"P",{});var Xs=i(Ot);vp=s(Xs,`The GPT-J Model transformer with a span classification head on top for extractive question-answering tasks like
