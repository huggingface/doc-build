import{S as Km,i as Qm,s as Zm,e as r,k as d,w as u,t as o,M as eh,c as s,d as t,m as c,a,x as f,h as n,b as l,F as e,g as $,y as _,q as g,o as k,B as v,v as th}from"../../chunks/vendor-6b77c823.js";import{T as Pr}from"../../chunks/Tip-39098574.js";import{D as z}from"../../chunks/Docstring-abef54e3.js";import{C as _s}from"../../chunks/CodeBlock-3a8b25a8.js";import{I as gs}from"../../chunks/IconCopyLink-7a11ce68.js";function oh(M){let h,P,b,w,E;return{c(){h=r("p"),P=o("This method is deprecated, "),b=r("code"),w=o("__call__"),E=o(" should be used instead.")},l(y){h=s(y,"P",{});var x=a(h);P=n(x,"This method is deprecated, "),b=s(x,"CODE",{});var B=a(b);w=n(B,"__call__"),B.forEach(t),E=n(x," should be used instead."),x.forEach(t)},m(y,x){$(y,h,x),e(h,P),e(h,b),e(b,w),e(h,E)},d(y){y&&t(h)}}}function nh(M){let h,P,b,w,E;return{c(){h=r("p"),P=o("This method is deprecated, "),b=r("code"),w=o("__call__"),E=o(" should be used instead.")},l(y){h=s(y,"P",{});var x=a(h);P=n(x,"This method is deprecated, "),b=s(x,"CODE",{});var B=a(b);w=n(B,"__call__"),B.forEach(t),E=n(x," should be used instead."),x.forEach(t)},m(y,x){$(y,h,x),e(h,P),e(h,b),e(b,w),e(h,E)},d(y){y&&t(h)}}}function rh(M){let h,P,b,w,E;return{c(){h=r("p"),P=o("Passing "),b=r("code"),w=o("use_auth_token=True"),E=o(" is required when you want to use a private model.")},l(y){h=s(y,"P",{});var x=a(h);P=n(x,"Passing "),b=s(x,"CODE",{});var B=a(b);w=n(B,"use_auth_token=True"),B.forEach(t),E=n(x," is required when you want to use a private model."),x.forEach(t)},m(y,x){$(y,h,x),e(h,P),e(h,b),e(b,w),e(h,E)},d(y){y&&t(h)}}}function sh(M){let h,P,b,w,E,y,x,B;return{c(){h=r("p"),P=o("If the "),b=r("code"),w=o("encoded_inputs"),E=o(` passed are dictionary of numpy arrays, PyTorch tensors or TensorFlow tensors, the
...
PyTorch tensors, you will lose the specific device of your tensors however.`)},l(ge){h=s(ge,"P",{});var W=a(h);P=n(W,"If the "),b=s(W,"CODE",{});var D=a(b);w=n(D,"encoded_inputs"),D.forEach(t),E=n(W,` passed are dictionary of numpy arrays, PyTorch tensors or TensorFlow tensors, the
...
PyTorch tensors, you will lose the specific device of your tensors however.`),W.forEach(t)},m(ge,W){$(ge,h,W),e(h,P),e(h,b),e(b,w),e(h,E),e(h,y),e(y,x),e(h,B)},d(ge){ge&&t(h)}}}function ah(M){let h,P;return{c(){h=r("p"),P=o("This API is experimental and may have some slight breaking changes in the next releases.")},l(b){h=s(b,"P",{});var w=a(h);P=n(w,"This API is experimental and may have some slight breaking changes in the next releases."),w.forEach(t)},m(b,w){$(b,h,w),e(h,P)},d(b){b&&t(h)}}}function ih(M){let h,P,b,w,E,y,x,B,ge,W,D,ro,so,ks,vs,ao,bs,Ts,io,ys,zs,co,ws,xs,qr,lo,$s,Er,ke,De,So,ot,Ps,Co,qs,Br,p,nt,Es,ve,Bs,po,Ls,Ds,mo,Is,Ns,As,Oo,Fs,Ss,Wo,Cs,Os,I,te,jo,Ws,js,Ro,Rs,Us,Uo,Ms,Vs,Gs,F,Mo,Hs,Xs,Vo,Ys,Js,Go,Ks,Qs,Ho,Zs,ea,Xo,ta,oa,na,V,Yo,ra,sa,Jo,aa,ia,Ko,da,ca,Qo,la,pa,ma,S,Zo,ha,ua,en,fa,_a,tn,ga,ka,on,va,ba,ho,Ta,ya,za,Ie,nn,wa,xa,rn,$a,Pa,qa,G,sn,Ea,Ba,an,La,Da,dn,Ia,Na,cn,Aa,Fa,Sa,H,ln,Ca,Oa,pn,Wa,ja,mn,Ra,Ua,hn,Ma,Va,Ga,Ne,rt,Ha,un,Xa,Ya,Ae,st,Ja,fn,Ka,Qa,Fe,at,Za,_n,ei,ti,oe,it,oi,gn,ni,ri,Se,si,ne,dt,ai,kn,ii,di,vn,ci,li,Ce,ct,pi,bn,mi,hi,Oe,lt,ui,pt,fi,Tn,_i,gi,ki,re,mt,vi,uo,bi,fo,Ti,yi,yn,zi,wi,se,ht,xi,zn,$i,Pi,ut,qi,wn,Ei,Bi,Li,ae,ft,Di,xn,Ii,Ni,_t,Ai,$n,Fi,Si,Ci,ie,gt,Oi,Pn,Wi,ji,We,Ri,C,kt,Ui,vt,Mi,_o,Vi,Gi,Hi,je,Xi,qn,Yi,Ji,bt,Ki,Re,Tt,Qi,be,Zi,En,ed,td,Bn,od,nd,rd,de,yt,sd,Ln,ad,id,ce,Dn,dd,cd,In,ld,pd,Nn,md,hd,ud,X,zt,fd,An,_d,gd,Q,kd,Fn,vd,bd,Sn,Td,yd,Cn,zd,wd,xd,Ue,$d,Me,wt,Pd,j,qd,On,Ed,Bd,Wn,Ld,Dd,jn,Id,Nd,Rn,Ad,Fd,Sd,Ve,xt,Cd,Un,Od,Wd,Y,$t,jd,Pt,Rd,Mn,Ud,Md,Vd,Vn,Gd,Hd,qt,Xd,le,Et,Yd,Bt,Jd,Gn,Kd,Qd,Zd,Ge,ec,J,Lt,tc,Hn,oc,nc,Dt,rc,Xn,sc,ac,ic,It,dc,Yn,cc,lc,pc,pe,Nt,mc,Jn,hc,uc,At,fc,Kn,_c,gc,kc,He,Ft,vc,St,bc,Qn,Tc,yc,zc,Xe,Ct,wc,Zn,xc,Lr,Te,Ye,er,Ot,$c,tr,Pc,Dr,A,Wt,qc,ye,Ec,go,Bc,Lc,ko,Dc,Ic,Nc,q,jt,Ac,or,Fc,Sc,nr,Cc,Oc,Rt,Wc,vo,jc,Rc,Uc,Ut,Mc,rr,Vc,Gc,Hc,Mt,sr,Xc,Yc,Vt,Jc,ar,Kc,Qc,Zc,R,el,bo,tl,ol,ir,nl,rl,dr,sl,al,cr,il,dl,cl,lr,ll,pl,Gt,ml,N,Ht,hl,pr,ul,fl,mr,_l,gl,Xt,kl,To,vl,bl,Tl,hr,yl,zl,Yt,wl,me,Jt,xl,ze,$l,ur,Pl,ql,fr,El,Bl,Ll,_r,Dl,Ir,we,Je,gr,Kt,Il,kr,Nl,Nr,xe,Qt,Al,$e,Fl,vr,Sl,Cl,Ke,Ol,br,Wl,jl,Rl,Ar,Pe,Zt,Ul,Tr,Ml,Fr,qe,eo,Vl,yr,Gl,Sr;return y=new gs({}),ot=new gs({}),nt=new z({props:{name:"class transformers.PreTrainedTokenizerBase",anchor:"transformers.PreTrainedTokenizerBase",parameters:[{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/v4.18.0/src/transformers/tokenization_utils_base.py#L1428",parametersDescription:[{anchor:"transformers.PreTrainedTokenizerBase.model_max_length",description:`<strong>model_max_length</strong> (<code>int</code>, <em>optional</em>) &#x2014;
...
`}}),yt=new z({props:{name:"get_vocab",anchor:"transformers.PreTrainedTokenizerBase.get_vocab",parameters:[],source:"https://github.com/huggingface/transformers/blob/v4.18.0/src/transformers/tokenization_utils_base.py#L1534",returnDescription:`
<p>The vocabulary.</p>
`,returnType:`
...
<a href="/docs/transformers/v4.18.0/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.__call__"><strong>call</strong>()</a>`,name:"kwargs"}],returnDescription:`
...
matrix of the model so that its embedding matrix matches the tokenizer.`),gl=d(),Xt=r("p"),kl=o("In order to do that, please use the "),To=r("a"),vl=o("resize_token_embeddings()"),bl=o(" method."),Tl=d(),hr=r("p"),yl=o("Examples:"),zl=d(),u(Yt.$$.fragment),wl=d(),me=r("div"),u(Jt.$$.fragment),xl=d(),ze=r("p"),$l=o("Make sure that all the special tokens attributes of the tokenizer ("),ur=r("code"),Pl=o("tokenizer.mask_token"),ql=o(`,
`),fr=r("code"),El=o("tokenizer.cls_token"),Bl=o(", etc.) are in the vocabulary."),Ll=d(),_r=r("p"),Dl=o("Add the missing ones to the vocabulary if needed."),Ir=d(),we=r("h2"),Je=r("a"),gr=r("span"),u(Kt.$$.fragment),Il=d(),kr=r("span"),Nl=o("Enums and namedtuples"),Nr=d(),xe=r("div"),u(Qt.$$.fragment),Al=d(),$e=r("p"),Fl=o("Possible values for the "),vr=r("code"),Sl=o("truncation"),Cl=o(" argument in "),Ke=r("a"),Ol=o("PreTrainedTokenizerBase."),br=r("strong"),Wl=o("call"),jl=o("()"),Rl=o(`. Useful for tab-completion in
an IDE.`),Ar=d(),Pe=r("div"),u(Zt.$$.fragment),Ul=d(),Tr=r("p"),Ml=o("Character span in the original string."),Fr=d(),qe=r("div"),u(eo.$$.fragment),Vl=d(),yr=r("p"),Gl=o("Token span in an encoded string (list of tokens)."),this.h()},l(i){const T=eh('[data-svelte="svelte-1phssyn"]',document.head);h=s(T,"META",{name:!0,content:!0}),T.forEach(t),P=c(i),b=s(i,"H1",{class:!0});var to=a(b);w=s(to,"A",{id:!0,class:!0,href:!0});var zr=a(w);E=s(zr,"SPAN",{});var wr=a(E);f(y.$$.fragment,wr),wr.forEach(t),zr.forEach(t),x=c(to),B=s(to,"SPAN",{});var xr=a(B);ge=n(xr,"Utilities for Tokenizers"),xr.forEach(t),to.forEach(t),W=c(i),D=s(i,"P",{});var U=a(D);ro=n(U,`This page lists all the utility functions used by the tokenizers, mainly the class
...
`),ao=s(U,"A",{href:!0});var Yl=a(ao);bs=n(Yl,"PreTrainedTokenizer"),Yl.forEach(t),Ts=n(U," and "),io=s(U,"A",{href:!0});var Jl=a(io);ys=n(Jl,"PreTrainedTokenizerFast"),Jl.forEach(t),zs=n(U,` and the mixin
...
adding special tokens.`),Sp.forEach(t),di=c(wo),vn=s(wo,"P",{});var Cp=a(vn);ci=n(Cp,"This implementation does not add special tokens and this method should be overridden in a subclass."),Cp.forEach(t),wo.forEach(t),li=c(m),Ce=s(m,"DIV",{class:!0});var Rr=a(Ce);f(ct.$$.fragment,Rr),pi=c(Rr),bn=s(Rr,"P",{});var Op=a(bn);mi=n(Op,"Clean up a list of simple English tokenization artifacts like spaces before punctuations and abbreviated forms."),Op.forEach(t),Rr.forEach(t),hi=c(m),Oe=s(m,"DIV",{class:!0});var Ur=a(Oe);f(lt.$$.fragment,Ur),ui=c(Ur),pt=s(Ur,"P",{});var Mr=a(pt);fi=n(Mr,"Converts a sequence of tokens in a single string. The most simple way to do it is "),Tn=s(Mr,"CODE",{});var Wp=a(Tn);_i=n(Wp,'" ".join(tokens)'),Wp.forEach(t),gi=n(Mr,` but we
