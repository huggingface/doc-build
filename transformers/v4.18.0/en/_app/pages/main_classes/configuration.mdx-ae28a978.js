import{S as As,i as Os,s as qs,e as r,k as d,w as u,t as o,M as Ss,c as a,d as t,m as l,a as s,x as p,h as n,b as h,F as e,g as z,y as _,q as b,o as v,B as y,v as Fs}from"../../chunks/vendor-6b77c823.js";import{T as xa}from"../../chunks/Tip-39098574.js";import{D as E}from"../../chunks/Docstring-17b815d9.js";import{C as js}from"../../chunks/CodeBlock-3a8b25a8.js";import{I as zs}from"../../chunks/IconCopyLink-7a11ce68.js";function Is(H){let m,C,g,w,j;return{c(){m=r("p"),C=o(`A configuration file can be loaded and saved to disk. Loading the configuration file and using this file to
...
`),ct=r("code"),Mo=o("vocab_size"),Vo=o("."),io=d(),R=r("h2"),X=r("a"),ft=r("span"),u(we.$$.fragment),Bo=d(),ht=r("span"),Ro=o("PretrainedConfig"),lo=d(),c=r("div"),u($e.$$.fragment),Uo=d(),mt=r("p"),Jo=o(`Base class for all configuration classes. Handles a few parameters common to all models\u2019 configurations as well as
...
serializes to a Python dictionary.`),na=d(),he=r("div"),u(We.$$.fragment),ra=d(),Rt=r("p"),aa=o("Save this instance to a JSON file."),sa=d(),me=r("div"),u(Me.$$.fragment),ia=d(),Ut=r("p"),da=o("Serializes this instance to a JSON string."),la=d(),ge=r("div"),u(Ve.$$.fragment),ca=d(),Be=r("p"),fa=o("Updates attributes of this class with attributes from "),Jt=r("code"),ha=o("config_dict"),ma=o("."),ga=d(),O=r("div"),u(Re.$$.fragment),ua=d(),Ue=r("p"),pa=o("Updates attributes of this class with attributes from "),Ht=r("code"),_a=o("update_str"),ba=o("."),va=d(),J=r("p"),ya=o("The expected format is ints, floats and strings as is, and for booleans use "),Gt=r("code"),wa=o("true"),$a=o(" or "),Xt=r("code"),ka=o("false"),Pa=o(`. For example:
\u201Cn_embd=10,resid_pdrop=0.2,scale_attn_weights=false,summary_type=cls_index\u201D`),Ca=d(),Kt=r("p"),Ea=o("The keys to change have to already exist in the config object."),this.h()},l(i){const $=Ss('[data-svelte="svelte-1phssyn"]',document.head);m=a($,"META",{name:!0,content:!0}),$.forEach(t),C=l(i),g=a(i,"H1",{class:!0});var Je=s(g);w=a(Je,"A",{id:!0,class:!0,href:!0});var Qt=s(w);j=a(Qt,"SPAN",{});var Yt=s(j);p(k.$$.fragment,Yt),Yt.forEach(t),Qt.forEach(t),P=l(Je),q=a(Je,"SPAN",{});var Ta=s(q);jo=n(Ta,"Configuration"),Ta.forEach(t),Je.forEach(t),ao=l(i),G=a(i,"P",{});var fo=s(G);zo=n(fo,"The base class "),Ge=a(fo,"A",{href:!0});var Da=s(Ge);Ao=n(Da,"PretrainedConfig"),Da.forEach(t),Oo=n(fo,` implements the common methods for loading/saving a configuration
either from a local file or directory, or from a pretrained model configuration provided by the library (downloaded
...
`),ct=a(V,"CODE",{});var Oa=s(ct);Mo=n(Oa,"vocab_size"),Oa.forEach(t),Vo=n(V,"."),V.forEach(t),io=l(i),R=a(i,"H2",{class:!0});var ho=s(R);X=a(ho,"A",{id:!0,class:!0,href:!0});var qa=s(X);ft=a(qa,"SPAN",{});var Sa=s(ft);p(we.$$.fragment,Sa),Sa.forEach(t),qa.forEach(t),Bo=l(ho),ht=a(ho,"SPAN",{});var Fa=s(ht);Ro=n(Fa,"PretrainedConfig"),Fa.forEach(t),ho.forEach(t),lo=l(i),c=a(i,"DIV",{class:!0});var f=s(c);p($e.$$.fragment,f),Uo=l(f),mt=a(f,"P",{});var Ia=s(mt);Jo=n(Ia,`Base class for all configuration classes. Handles a few parameters common to all models\u2019 configurations as well as
...
`),Qe=a(N,"A",{href:!0});var Ua=s(Qe);fn=n(Ua,"EncoderDecoderConfig"),Ua.forEach(t),hn=n(N," or "),Ye=a(N,"A",{href:!0});var Ja=s(Ye);mn=n(Ja,"~RagConfig"),Ja.forEach(t),gn=n(N,"."),N.forEach(t),un=l(ue),Q=a(ue,"LI",{});var Zt=s(Q);vt=a(Zt,"STRONG",{});var Ha=s(vt);pn=n(Ha,"keys_to_ignore_at_inference"),Ha.forEach(t),_n=n(Zt," ("),yt=a(Zt,"CODE",{});var Ga=s(yt);bn=n(Ga,"List[str]"),Ga.forEach(t),vn=n(Zt,`) \u2014 A list of keys to ignore by default when looking at dictionary
outputs of the model during inference.`),Zt.forEach(t),yn=l(ue),Y=a(ue,"LI",{});var eo=s(Y);wt=a(eo,"STRONG",{});var Xa=s(wt);wn=n(Xa,"attribute_map"),Xa.forEach(t),$n=n(eo," ("),$t=a(eo,"CODE",{});var Ka=s($t);kn=n(Ka,"Dict[str, str]"),Ka.forEach(t),Pn=n(eo,`) \u2014 A dict that maps model specific attribute names to the standardized
...
model.`),no.forEach(t),Vn=l(pe),oe=a(pe,"LI",{});var ro=s(oe);jt=a(ro,"STRONG",{});var rs=s(jt);Bn=n(rs,"num_hidden_layers"),rs.forEach(t),Rn=n(ro," ("),zt=a(ro,"CODE",{});var as=s(zt);Un=n(as,"int"),as.forEach(t),Jn=n(ro,") \u2014 The number of blocks in the model."),ro.forEach(t),pe.forEach(t),Hn=l(f),A=a(f,"DIV",{class:!0});var _e=s(A);p(ke.$$.fragment,_e),Gn=l(_e),Pe=a(_e,"P",{});var mo=s(Pe);Xn=n(mo,`Upload the configuration file to the \u{1F917} Model Hub while synchronizing a local clone of the repo in
`),At=a(mo,"CODE",{});var ss=s(At);Kn=n(ss,"repo_path_or_name"),ss.forEach(t),Qn=n(mo,"."),mo.forEach(t),Yn=l(_e),Ot=a(_e,"P",{});var is=s(Ot);Zn=n(is,"Examples:"),is.forEach(t),er=l(_e),p(Ce.$$.fragment,_e),_e.forEach(t),tr=l(f),ne=a(f,"DIV",{class:!0});var go=s(ne);p(Ee.$$.fragment,go),or=l(go),I=a(go,"P",{});var be=s(I);nr=n(be,"Checks whether the passed dictionary and its nested dicts have a "),qt=a(be,"EM",{});var ds=s(qt);rr=n(ds,"torch_dtype"),ds.forEach(t),ar=n(be,` key and if it\u2019s not None,
...
string, which can then be stored in the json format.`),be.forEach(t),go.forEach(t),cr=l(f),re=a(f,"DIV",{class:!0});var uo=s(re);p(xe.$$.fragment,uo),fr=l(uo),Te=a(uo,"P",{});var po=s(Te);hr=n(po,"Instantiates a "),Ze=a(po,"A",{href:!0});var fs=s(Ze);mr=n(fs,"PretrainedConfig"),fs.forEach(t),gr=n(po," from a Python dictionary of parameters."),po.forEach(t),uo.forEach(t),ur=l(f),ae=a(f,"DIV",{class:!0});var _o=s(ae);p(De.$$.fragment,_o),pr=l(_o),je=a(_o,"P",{});var bo=s(je);_r=n(bo,"Instantiates a "),et=a(bo,"A",{href:!0});var hs=s(et);br=n(hs,"PretrainedConfig"),hs.forEach(t),vr=n(bo," from the path to a JSON file of parameters."),bo.forEach(t),_o.forEach(t),yr=l(f),D=a(f,"DIV",{class:!0});var B=s(D);p(ze.$$.fragment,B),wr=l(B),Ae=a(B,"P",{});var vo=s(Ae);$r=n(vo,"Instantiate a "),tt=a(vo,"A",{href:!0});var ms=s(tt);kr=n(ms,"PretrainedConfig"),ms.forEach(t),Pr=n(vo," (or a derived class) from a pretrained model configuration."),vo.forEach(t),Cr=l(B),p(se.$$.fragment,B),Er=l(B),It=a(B,"P",{});var gs=s(It);xr=n(gs,"Examples:"),gs.forEach(t),Tr=l(B),p(Oe.$$.fragment,B),B.forEach(t),Dr=l(f),ie=a(f,"DIV",{class:!0});var yo=s(ie);p(qe.$$.fragment,yo),jr=l(yo),L=a(yo,"P",{});var ve=s(L);zr=n(ve,"From a "),Lt=a(ve,"CODE",{});var us=s(Lt);Ar=n(us,"pretrained_model_name_or_path"),us.forEach(t),Or=n(ve,`, resolve to a dictionary of parameters, to be used for instantiating a
`),ot=a(ve,"A",{href:!0});var ps=s(ot);qr=n(ps,"PretrainedConfig"),ps.forEach(t),Sr=n(ve," using "),Nt=a(ve,"CODE",{});var _s=s(Nt);Fr=n(_s,"from_dict"),_s.forEach(t),Ir=n(ve,"."),ve.forEach(t),yo.forEach(t),Lr=l(f),M=a(f,"DIV",{class:!0});var rt=s(M);p(Se.$$.fragment,rt),Nr=l(rt),Fe=a(rt,"P",{});var wo=s(Fe);Wr=n(wo,`Register this class with a given auto class. This should only be used for custom configurations as the ones in
...
`),nt=a(at,"A",{href:!0});var ys=s(nt);Xr=n(ys,"from_pretrained()"),ys.forEach(t),Kr=n(at," class method."),at.forEach(t),$o.forEach(t),Qr=l(f),ce=a(f,"DIV",{class:!0});var ko=s(ce);p(Le.$$.fragment,ko),Yr=l(ko),Vt=a(ko,"P",{});var ws=s(Vt);Zr=n(ws,"Serializes this instance to a Python dictionary."),ws.forEach(t),ko.forEach(t),ea=l(f),fe=a(f,"DIV",{class:!0});var Po=s(fe);p(Ne.$$.fragment,Po),ta=l(Po),Bt=a(Po,"P",{});var $s=s(Bt);oa=n($s,`Removes all attributes from config which correspond to the default config attributes for better readability and
serializes to a Python dictionary.`),$s.forEach(t),Po.forEach(t),na=l(f),he=a(f,"DIV",{class:!0});var Co=s(he);p(We.$$.fragment,Co),ra=l(Co),Rt=a(Co,"P",{});var ks=s(Rt);aa=n(ks,"Save this instance to a JSON file."),ks.forEach(t),Co.forEach(t),sa=l(f),me=a(f,"DIV",{class:!0});var Eo=s(me);p(Me.$$.fragment,Eo),ia=l(Eo),Ut=a(Eo,"P",{});var Ps=s(Ut);da=n(Ps,"Serializes this instance to a JSON string."),Ps.forEach(t),Eo.forEach(t),la=l(f),ge=a(f,"DIV",{class:!0});var xo=s(ge);p(Ve.$$.fragment,xo),ca=l(xo),Be=a(xo,"P",{});var To=s(Be);fa=n(To,"Updates attributes of this class with attributes from "),Jt=a(To,"CODE",{});var Cs=s(Jt);ha=n(Cs,"config_dict"),Cs.forEach(t),ma=n(To,"."),To.forEach(t),xo.forEach(t),ga=l(f),O=a(f,"DIV",{class:!0});var ye=s(O);p(Re.$$.fragment,ye),ua=l(ye),Ue=a(ye,"P",{});var Do=s(Ue);pa=n(Do,"Updates attributes of this class with attributes from "),Ht=a(Do,"CODE",{});var Es=s(Ht);_a=n(Es,"update_str"),Es.forEach(t),ba=n(Do,"."),Do.forEach(t),va=l(ye),J=a(ye,"P",{});var st=s(J);ya=n(st,"The expected format is ints, floats and strings as is, and for booleans use "),Gt=a(st,"CODE",{});var xs=s(Gt);wa=n(xs,"true"),xs.forEach(t),$a=n(st," or "),Xt=a(st,"CODE",{});var Ts=s(Xt);ka=n(Ts,"false"),Ts.forEach(t),Pa=n(st,`. For example:
\u201Cn_embd=10,resid_pdrop=0.2,scale_attn_weights=false,summary_type=cls_index\u201D`),st.forEach(t),Ca=l(ye),Kt=a(ye,"P",{});var Ds=s(Kt);Ea=n(Ds,"The keys to change have to already exist in the config object."),Ds.forEach(t),ye.forEach(t),f.forEach(t),this.h()},h(){h(m,"name","hf:doc:metadata"),h(m,"content",JSON.stringify(Ms)),h(w,"id","configuration"),h(w,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),h(w,"href","#configuration"),h(g,"class","relative group"),h(Ge,"href","/docs/transformers/v4.18.0/en/main_classes/configuration#transformers.PretrainedConfig"),h(X,"id","transformers.PretrainedConfig"),h(X,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),h(X,"href","#transformers.PretrainedConfig"),h(R,"class","relative group"),h(Xe,"href","/docs/transformers/v4.18.0/en/model_doc/auto#transformers.AutoConfig"),h(Ke,"href","/docs/transformers/v4.18.0/en/main_classes/configuration#transformers.PretrainedConfig"),h(Qe,"href","/docs/transformers/v4.18.0/en/model_doc/encoder-decoder#transformers.EncoderDecoderConfig"),h(Ye,"href","/docs/transformers/v4.18.0/en/model_doc/rag#transformers.RagConfig"),h(A,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),h(ne,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),h(Ze,"href","/docs/transformers/v4.18.0/en/main_classes/configuration#transformers.PretrainedConfig"),h(re,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),h(et,"href","/docs/transformers/v4.18.0/en/main_classes/configuration#transformers.PretrainedConfig"),h(ae,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),h(tt,"href","/docs/transformers/v4.18.0/en/main_classes/configuration#transformers.PretrainedConfig"),h(D,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),h(ot,"href","/docs/transformers/v4.18.0/en/main_classes/configuration#transformers.PretrainedConfig"),h(ie,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),h(M,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),h(nt,"href","/docs/transformers/v4.18.0/en/main_classes/configuration#transformers.PretrainedConfig.from_pretrained"),h(le,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),h(ce,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),h(fe,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),h(he,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),h(me,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),h(ge,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),h(O,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),h(c,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8")},m(i,$){e(document.head,m),z(i,C,$),z(i,g,$),e(g,w),e(w,j),_(k,j,null),e(g,P),e(g,q),e(q,jo),z(i,ao,$),z(i,G,$),e(G,zo),e(G,Ge),e(Ge,Ao),e(G,Oo),z(i,so,$),z(i,x,$),e(x,qo),e(x,it),e(it,So),e(x,Fo),e(x,dt),e(dt,Io),e(x,Lo),e(x,lt),e(lt,No),e(x,Wo),e(x,ct),e(ct,Mo),e(x,Vo),z(i,io,$),z(i,R,$),e(R,X),e(X,ft),_(we,ft,null),e(R,Bo),e(R,ht),e(ht,Ro),z(i,lo,$),z(i,c,$),_($e,c,null),e(c,Uo),e(c,mt),e(mt,Jo),e(c,Ho),_(K,c,null),e(c,Go),e(c,gt),e(gt,Xo),e(c,Ko),e(c,S),e(S,W),e(W,ut),e(ut,Qo),e(W,Yo),e(W,pt),e(pt,Zo),e(W,en),e(W,Xe),e(Xe,tn),e(W,on),e(S,nn),e(S,T),e(T,_t),e(_t,rn),e(T,an),e(T,bt),e(bt,sn),e(T,dn),e(T,Ke),e(Ke,ln),e(T,cn),e(T,Qe),e(Qe,fn),e(T,hn),e(T,Ye),e(Ye,mn),e(T,gn),e(S,un),e(S,Q),e(Q,vt),e(vt,pn),e(Q,_n),e(Q,yt),e(yt,bn),e(Q,vn),e(S,yn),e(S,Y),e(Y,wt),e(wt,wn),e(Y,$n),e(Y,$t),e($t,kn),e(Y,Pn),e(c,Cn),e(c,kt),e(kt,En),e(c,xn),e(c,F),e(F,Z),e(Z,Pt),e(Pt,Tn),e(Z,Dn),e(Z,Ct),e(Ct,jn),e(Z,zn),e(F,An),e(F,ee),e(ee,Et),e(Et,On),e(ee,qn),e(ee,xt),e(xt,Sn),e(ee,Fn),e(F,In),e(F,te),e(te,Tt),e(Tt,Ln),e(te,Nn),e(te,Dt),e(Dt,Wn),e(te,Mn),e(F,Vn),e(F,oe),e(oe,jt),e(jt,Bn),e(oe,Rn),e(oe,zt),e(zt,Un),e(oe,Jn),e(c,Hn),e(c,A),_(ke,A,null),e(A,Gn),e(A,Pe),e(Pe,Xn),e(Pe,At),e(At,Kn),e(Pe,Qn),e(A,Yn),e(A,Ot),e(Ot,Zn),e(A,er),_(Ce,A,null),e(c,tr),e(c,ne),_(Ee,ne,null),e(ne,or),e(ne,I),e(I,nr),e(I,qt),e(qt,rr),e(I,ar),e(I,St),e(St,sr),e(I,ir),e(I,Ft),e(Ft,dr),e(I,lr),e(c,cr),e(c,re),_(xe,re,null),e(re,fr),e(re,Te),e(Te,hr),e(Te,Ze),e(Ze,mr),e(Te,gr),e(c,ur),e(c,ae),_(De,ae,null),e(ae,pr),e(ae,je),e(je,_r),e(je,et),e(et,br),e(je,vr),e(c,yr),e(c,D),_(ze,D,null),e(D,wr),e(D,Ae),e(Ae,$r),e(Ae,tt),e(tt,kr),e(Ae,Pr),e(D,Cr),_(se,D,null),e(D,Er),e(D,It),e(It,xr),e(D,Tr),_(Oe,D,null),e(c,Dr),e(c,ie),_(qe,ie,null),e(ie,jr),e(ie,L),e(L,zr),e(L,Lt),e(Lt,Ar),e(L,Or),e(L,ot),e(ot,qr),e(L,Sr),e(L,Nt),e(Nt,Fr),e(L,Ir),e(c,Lr),e(c,M),_(Se,M,null),e(M,Nr),e(M,Fe),e(Fe,Wr),e(Fe,Wt),e(Wt,Mr),e(Fe,Vr),e(M,Br),_(de,M,null),e(c,Rr),e(c,le),_(Ie,le,null),e(le,Ur),e(le,U),e(U,Jr),e(U,Mt),e(Mt,Hr),e(U,Gr),e(U,nt),e(nt,Xr),e(U,Kr),e(c,Qr),e(c,ce),_(Le,ce,null),e(ce,Yr),e(ce,Vt),e(Vt,Zr),e(c,ea),e(c,fe),_(Ne,fe,null),e(fe,ta),e(fe,Bt),e(Bt,oa),e(c,na),e(c,he),_(We,he,null),e(he,ra),e(he,Rt),e(Rt,aa),e(c,sa),e(c,me),_(Me,me,null),e(me,ia),e(me,Ut),e(Ut,da),e(c,la),e(c,ge),_(Ve,ge,null),e(ge,ca),e(ge,Be),e(Be,fa),e(Be,Jt),e(Jt,ha),e(Be,ma),e(c,ga),e(c,O),_(Re,O,null),e(O,ua),e(O,Ue),e(Ue,pa),e(Ue,Ht),e(Ht,_a),e(Ue,ba),e(O,va),e(O,J),e(J,ya),e(J,Gt),e(Gt,wa),e(J,$a),e(J,Xt),e(Xt,ka),e(J,Pa),e(O,Ca),e(O,Kt),e(Kt,Ea),co=!0},p(i,[$]){const Je={};$&2&&(Je.$$scope={dirty:$,ctx:i}),K.$set(Je);const Qt={};$&2&&(Qt.$$scope={dirty:$,ctx:i}),se.$set(Qt);const Yt={};$&2&&(Yt.$$scope={dirty:$,ctx:i}),de.$set(Yt)},i(i){co||(b(k.$$.fragment,i),b(we.$$.fragment,i),b($e.$$.fragment,i),b(K.$$.fragment,i),b(ke.$$.fragment,i),b(Ce.$$.fragment,i),b(Ee.$$.fragment,i),b(xe.$$.fragment,i),b(De.$$.fragment,i),b(ze.$$.fragment,i),b(se.$$.fragment,i),b(Oe.$$.fragment,i),b(qe.$$.fragment,i),b(Se.$$.fragment,i),b(de.$$.fragment,i),b(Ie.$$.fragment,i),b(Le.$$.fragment,i),b(Ne.$$.fragment,i),b(We.$$.fragment,i),b(Me.$$.fragment,i),b(Ve.$$.fragment,i),b(Re.$$.fragment,i),co=!0)},o(i){v(k.$$.fragment,i),v(we.$$.fragment,i),v($e.$$.fragment,i),v(K.$$.fragment,i),v(ke.$$.fragment,i),v(Ce.$$.fragment,i),v(Ee.$$.fragment,i),v(xe.$$.fragment,i),v(De.$$.fragment,i),v(ze.$$.fragment,i),v(se.$$.fragment,i),v(Oe.$$.fragment,i),v(qe.$$.fragment,i),v(Se.$$.fragment,i),v(de.$$.fragment,i),v(Ie.$$.fragment,i),v(Le.$$.fragment,i),v(Ne.$$.fragment,i),v(We.$$.fragment,i),v(Me.$$.fragment,i),v(Ve.$$.fragment,i),v(Re.$$.fragment,i),co=!1},d(i){t(m),i&&t(C),i&&t(g),y(k),i&&t(ao),i&&t(G),i&&t(so),i&&t(x),i&&t(io),i&&t(R),y(we),i&&t(lo),i&&t(c),y($e),y(K),y(ke),y(Ce),y(Ee),y(xe),y(De),y(ze),y(se),y(Oe),y(qe),y(Se),y(de),y(Ie),y(Le),y(Ne),y(We),y(Me),y(Ve),y(Re)}}}const Ms={local:"configuration",sections:[{local:"transformers.PretrainedConfig",title:"PretrainedConfig"}],title:"Configuration"};function Vs(H){return Fs(()=>{new URLSearchParams(window.location.search).get("fw")}),[]}class Gs extends As{constructor(m){super();Os(this,m,Vs,Ws,qs,{})}}export{Gs as default,Ms as metadata};
