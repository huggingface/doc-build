...
breaking changes to fix it in the future. If you see something strange, file a `),f=a("a"),g=r("Github Issue"),v=r("."),this.h()},l(_){h=s(_,"P",{});var u=n(h);T=i(u,`This is a recently introduced model so the API hasn\u2019t been tested extensively. There may be some bugs or slight
...
PIL images.`)},l(f){h=s(f,"P",{});var g=n(h);T=i(g,`NumPy arrays and PyTorch tensors are converted to PIL images when resizing, so the most efficient is to pass
...
the latter silently ignores them.`)},l(_){h=s(_,"P",{});var u=n(h);T=i(u,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=s(u,"CODE",{});var V=n(f);g=i(V,"Module"),V.forEach(t),v=i(u,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
the latter silently ignores them.`)},l(_){h=s(_,"P",{});var u=n(h);T=i(u,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=s(u,"CODE",{});var V=n(f);g=i(V,"Module"),V.forEach(t),v=i(u,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),u.forEach(t)},m(_,u){m(_,h,u),e(h,T),e(h,f),e(f,g),e(h,v)},d(_){_&&t(h)}}}function Im(I){let h,T,f,g,v,_,u,V,he,R,k,ie,j,B,oe,C,pe,ae,E,M,z,Me,se,L,je,Te,Xo,tr,sn,Zo,Da,or,nn,Qo,ar,rn,N,Vt,sr,Et,nr,rr,ir,Oa,lr,dr,kt,cr,Yo,hr,pr,mr,Pe,fr,Sa,ur,gr,It,_r,vr,Tr,Ce,br,Mt,wr,yr,jt,$r,xr,Fr,Ae,Vr,Pt,Er,kr,Ct,Ir,Mr,jr,Wa,Pr,ln,ea,Cr,dn,le,Ba,P,ta,Ar,qr,oa,zr,Nr,aa,Lr,Dr,Ua,Or,Sr,Ra,Wr,Br,Ha,Ur,Rr,Ja,Hr,Jr,sa,Kr,Gr,Xr,Ka,na,ra,Zr,Qr,Yr,Ga,At,ei,qt,ti,oi,ai,Xa,ia,la,si,ni,cn,be,ri,zt,ii,li,Nt,di,ci,hn,et,hi,Lt,pi,mi,pn,qe,tt,Za,Dt,fi,Qa,ui,mn,U,Ot,gi,ze,_i,da,vi,Ti,St,bi,wi,yi,Ne,$i,ca,xi,Fi,ha,Vi,Ei,ki,Ya,Ii,Mi,Wt,fn,Le,ot,es,Bt,ji,ts,Pi,un,ne,Ut,Ci,os,Ai,qi,Rt,zi,pa,Ni,Li,Di,we,Ht,Oi,as,Si,Wi,at,gn,De,st,ss,Jt,Bi,ns,Ui,_n,me,Kt,Ri,Gt,Hi,Xt,Ji,Ki,Gi,H,Zt,Xi,Oe,Zi,ma,Qi,Yi,rs,el,tl,ol,nt,al,is,sl,nl,Qt,vn,Se,rt,ls,Yt,rl,ds,il,Tn,fe,eo,ll,We,dl,cs,cl,hl,to,pl,ml,fl,J,oo,ul,Be,gl,fa,_l,vl,hs,Tl,bl,wl,it,yl,ps,$l,xl,ao,bn,Ue,lt,ms,so,Fl,fs,Vl,wn,re,no,El,us,kl,Il,ro,Ml,io,jl,Pl,Cl,K,lo,Al,Re,ql,ua,zl,Nl,gs,Ll,Dl,Ol,dt,Sl,_s,Wl,Bl,co,yn,He,ct,vs,ho,Ul,Ts,Rl,$n,D,po,Hl,bs,Jl,Kl,mo,Gl,ga,Xl,Zl,Ql,fo,Yl,uo,ed,td,od,ht,ad,G,go,sd,Je,nd,_a,rd,id,ws,ld,dd,cd,pt,hd,ys,pd,md,_o,xn,Ke,mt,$s,vo,fd,xs,ud,Fn,O,To,gd,Fs,_d,vd,bo,Td,va,bd,wd,yd,wo,$d,yo,xd,Fd,Vd,ft,Ed,X,$o,kd,Ge,Id,Ta,Md,jd,Vs,Pd,Cd,Ad,ut,qd,Es,zd,Nd,xo,Vn,Xe,gt,ks,Fo,Ld,Is,Dd,En,A,Vo,Od,Ms,Sd,Wd,Eo,Bd,ba,Ud,Rd,Hd,ko,Jd,Io,Kd,Gd,Xd,js,Zd,Qd,ue,Ps,Mo,Yd,ec,Cs,jo,tc,oc,As,Po,ac,sc,qs,Co,nc,rc,Z,Ao,ic,Ze,lc,zs,dc,cc,Ns,hc,pc,mc,_t,fc,Ls,uc,gc,qo,kn,Qe,vt,Ds,zo,_c,Os,vc,In,q,No,Tc,Ss,bc,wc,Lo,yc,wa,$c,xc,Fc,Do,Vc,Oo,Ec,kc,Ic,Ws,Mc,jc,ge,Bs,So,Pc,Cc,Us,Wo,Ac,qc,Rs,Bo,zc,Nc,Hs,Uo,Lc,Dc,Q,Ro,Oc,Ye,Sc,Js,Wc,Bc,Ks,Uc,Rc,Hc,Tt,Jc,Gs,Kc,Gc,Ho,Mn;return _=new ve({}),k=new _e({props:{$$slots:{default:[vm]},$$scope:{ctx:I}}}),C=new ve({}),Dt=new ve({}),Ot=new W({props:{name:"class transformers.ViTConfig",anchor:"transformers.ViTConfig",parameters:[{name:"hidden_size",val:" = 768"},{name:"num_hidden_layers",val:" = 12"},{name:"num_attention_heads",val:" = 12"},{name:"intermediate_size",val:" = 3072"},{name:"hidden_act",val:" = 'gelu'"},{name:"hidden_dropout_prob",val:" = 0.0"},{name:"attention_probs_dropout_prob",val:" = 0.0"},{name:"initializer_range",val:" = 0.02"},{name:"layer_norm_eps",val:" = 1e-12"},{name:"is_encoder_decoder",val:" = False"},{name:"image_size",val:" = 224"},{name:"patch_size",val:" = 16"},{name:"num_channels",val:" = 3"},{name:"qkv_bias",val:" = True"},{name:"encoder_stride",val:" = 16"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/v4.18.0/src/transformers/models/vit/configuration_vit.py#L35",parametersDescription:[{anchor:"transformers.ViTConfig.hidden_size",description:`<strong>hidden_size</strong> (<code>int</code>, <em>optional</em>, defaults to 768) &#x2014;
...
[<span class="hljs-number">1</span>, <span class="hljs-number">197</span>, <span class="hljs-number">768</span>]`}}),Yt=new ve({}),eo=new W({props:{name:"class transformers.ViTForMaskedImageModeling",anchor:"transformers.ViTForMaskedImageModeling",parameters:[{name:"config",val:": ViTConfig"}],source:"https://github.com/huggingface/transformers/blob/v4.18.0/src/transformers/models/vit/modeling_vit.py#L616",parametersDescription:[{anchor:"transformers.ViTForMaskedImageModeling.config",description:`<strong>config</strong> (<a href="/docs/transformers/v4.18.0/en/model_doc/vit#transformers.ViTConfig">ViTConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/v4.18.0/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),oo=new W({props:{name:"forward",anchor:"transformers.ViTForMaskedImageModeling.forward",parameters:[{name:"pixel_values",val:": typing.Optional[torch.Tensor] = None"},{name:"bool_masked_pos",val:": typing.Optional[torch.BoolTensor] = None"},{name:"head_mask",val:": typing.Optional[torch.Tensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"interpolate_pos_encoding",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],source:"https://github.com/huggingface/transformers/blob/v4.18.0/src/transformers/models/vit/modeling_vit.py#L630",parametersDescription:[{anchor:"transformers.ViTForMaskedImageModeling.forward.pixel_values",description:`<strong>pixel_values</strong> (<code>torch.FloatTensor</code> of shape <code>(batch_size, num_channels, height, width)</code>) &#x2014;
Pixel values. Pixel values can be obtained using <a href="/docs/transformers/v4.18.0/en/model_doc/vit#transformers.ViTFeatureExtractor">ViTFeatureExtractor</a>. See
...
[<span class="hljs-number">1</span>, <span class="hljs-number">3</span>, <span class="hljs-number">224</span>, <span class="hljs-number">224</span>]`}}),so=new ve({}),no=new W({props:{name:"class transformers.ViTForImageClassification",anchor:"transformers.ViTForImageClassification",parameters:[{name:"config",val:": ViTConfig"}],source:"https://github.com/huggingface/transformers/blob/v4.18.0/src/transformers/models/vit/modeling_vit.py#L726",parametersDescription:[{anchor:"transformers.ViTForImageClassification.config",description:`<strong>config</strong> (<a href="/docs/transformers/v4.18.0/en/model_doc/vit#transformers.ViTConfig">ViTConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/v4.18.0/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),lo=new W({props:{name:"forward",anchor:"transformers.ViTForImageClassification.forward",parameters:[{name:"pixel_values",val:": typing.Optional[torch.Tensor] = None"},{name:"head_mask",val:": typing.Optional[torch.Tensor] = None"},{name:"labels",val:": typing.Optional[torch.Tensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"interpolate_pos_encoding",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],source:"https://github.com/huggingface/transformers/blob/v4.18.0/src/transformers/models/vit/modeling_vit.py#L739",parametersDescription:[{anchor:"transformers.ViTForImageClassification.forward.pixel_values",description:`<strong>pixel_values</strong> (<code>torch.FloatTensor</code> of shape <code>(batch_size, num_channels, height, width)</code>) &#x2014;
Pixel values. Pixel values can be obtained using <a href="/docs/transformers/v4.18.0/en/model_doc/vit#transformers.ViTFeatureExtractor">ViTFeatureExtractor</a>. See
...
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-built_in">print</span>(<span class="hljs-string">&quot;Predicted class:&quot;</span>, model.config.id2label[predicted_class_idx.item()])`}}),{c(){h=a("meta"),T=d(),f=a("h1"),g=a("a"),v=a("span"),b(_.$$.fragment),u=d(),V=a("span"),he=r("Vision Transformer (ViT)"),R=d(),b(k.$$.fragment),ie=d(),j=a("h2"),B=a("a"),oe=a("span"),b(C.$$.fragment),pe=d(),ae=a("span"),E=r("Overview"),M=d(),z=a("p"),Me=r("The Vision Transformer (ViT) model was proposed in "),se=a("a"),L=r(`An Image is Worth 16x16 Words: Transformers for Image Recognition
...
go to him!`),pn=d(),qe=a("h2"),tt=a("a"),Za=a("span"),b(Dt.$$.fragment),fi=d(),Qa=a("span"),ui=r("ViTConfig"),mn=d(),U=a("div"),b(Ot.$$.fragment),gi=d(),ze=a("p"),_i=r("This is the configuration class to store the configuration of a "),da=a("a"),vi=r("ViTModel"),Ti=r(`. It is used to instantiate an ViT
...
behavior.`),Gi=d(),H=a("div"),b(Zt.$$.fragment),Xi=d(),Oe=a("p"),Zi=r("The "),ma=a("a"),Qi=r("ViTModel"),Yi=r(" forward method, overrides the "),rs=a("code"),el=r("__call__"),tl=r(" special method."),ol=d(),b(nt.$$.fragment),al=d(),is=a("p"),sl=r("Example:"),nl=d(),b(Qt.$$.fragment),vn=d(),Se=a("h2"),rt=a("a"),ls=a("span"),b(Yt.$$.fragment),rl=d(),ds=a("span"),il=r("ViTForMaskedImageModeling"),Tn=d(),fe=a("div"),b(eo.$$.fragment),ll=d(),We=a("p"),dl=r("ViT Model with a decoder on top for masked image modeling, as proposed in "),cs=a("code"),cl=r("SimMIM <https://arxiv.org/abs/2111.09886>"),hl=r(`__.
This model is a PyTorch `),to=a("a"),pl=r("torch.nn.Module"),ml=r(` subclass. Use it
as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),fl=d(),J=a("div"),b(oo.$$.fragment),ul=d(),Be=a("p"),gl=r("The "),fa=a("a"),_l=r("ViTForMaskedImageModeling"),vl=r(" forward method, overrides the "),hs=a("code"),Tl=r("__call__"),bl=r(" special method."),wl=d(),b(it.$$.fragment),yl=d(),ps=a("p"),$l=r("Examples:"),xl=d(),b(ao.$$.fragment),bn=d(),Ue=a("h2"),lt=a("a"),ms=a("span"),b(so.$$.fragment),Fl=d(),fs=a("span"),Vl=r("ViTForImageClassification"),wn=d(),re=a("div"),b(no.$$.fragment),El=d(),us=a("p"),kl=r(`ViT Model transformer with an image classification head on top (a linear layer on top of the final hidden state of
the [CLS] token) e.g. for ImageNet.`),Il=d(),ro=a("p"),Ml=r("This model is a PyTorch "),io=a("a"),jl=r("torch.nn.Module"),Pl=r(` subclass. Use it
as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),Cl=d(),K=a("div"),b(lo.$$.fragment),Al=d(),Re=a("p"),ql=r("The "),ua=a("a"),zl=r("ViTForImageClassification"),Nl=r(" forward method, overrides the "),gs=a("code"),Ll=r("__call__"),Dl=r(" special method."),Ol=d(),b(dt.$$.fragment),Sl=d(),_s=a("p"),Wl=r("Example:"),Bl=d(),b(co.$$.fragment),yn=d(),He=a("h2"),ct=a("a"),vs=a("span"),b(ho.$$.fragment),Ul=d(),Ts=a("span"),Rl=r("TFViTModel"),$n=d(),D=a("div"),b(po.$$.fragment),Hl=d(),bs=a("p"),Jl=r("The bare ViT Model transformer outputting raw hidden-states without any specific head on top."),Kl=d(),mo=a("p"),Gl=r("This model inherits from "),ga=a("a"),Xl=r("TFPreTrainedModel"),Zl=r(`. Check the superclass documentation for the generic methods the
...
general usage and behavior.`),Xd=d(),js=a("p"),Zd=r("Finally, this model supports inherent JAX features such as:"),Qd=d(),ue=a("ul"),Ps=a("li"),Mo=a("a"),Yd=r("Just-In-Time (JIT) compilation"),ec=d(),Cs=a("li"),jo=a("a"),tc=r("Automatic Differentiation"),oc=d(),As=a("li"),Po=a("a"),ac=r("Vectorization"),sc=d(),qs=a("li"),Co=a("a"),nc=r("Parallelization"),rc=d(),Z=a("div"),b(Ao.$$.fragment),ic=d(),Ze=a("p"),lc=r("The "),zs=a("code"),dc=r("FlaxViTPreTrainedModel"),cc=r(" forward method, overrides the "),Ns=a("code"),hc=r("__call__"),pc=r(" special method."),mc=d(),b(_t.$$.fragment),fc=d(),Ls=a("p"),uc=r("Examples:"),gc=d(),b(qo.$$.fragment),kn=d(),Qe=a("h2"),vt=a("a"),Ds=a("span"),b(zo.$$.fragment),_c=d(),Os=a("span"),vc=r("FlaxViTForImageClassification"),In=d(),q=a("div"),b(No.$$.fragment),Tc=d(),Ss=a("p"),bc=r(`ViT Model transformer with an image classification head on top (a linear layer on top of the final hidden state of
...
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),Ic=d(),Ws=a("p"),Mc=r("Finally, this model supports inherent JAX features such as:"),jc=d(),ge=a("ul"),Bs=a("li"),So=a("a"),Pc=r("Just-In-Time (JIT) compilation"),Cc=d(),Us=a("li"),Wo=a("a"),Ac=r("Automatic Differentiation"),qc=d(),Rs=a("li"),Bo=a("a"),zc=r("Vectorization"),Nc=d(),Hs=a("li"),Uo=a("a"),Lc=r("Parallelization"),Dc=d(),Q=a("div"),b(Ro.$$.fragment),Oc=d(),Ye=a("p"),Sc=r("The "),Js=a("code"),Wc=r("FlaxViTPreTrainedModel"),Bc=r(" forward method, overrides the "),Ks=a("code"),Uc=r("__call__"),Rc=r(" special method."),Hc=d(),b(Tt.$$.fragment),Jc=d(),Gs=a("p"),Kc=r("Example:"),Gc=d(),b(Ho.$$.fragment),this.h()},l(o){const p=gm('[data-svelte="svelte-1phssyn"]',document.head);h=s(p,"META",{name:!0,content:!0}),p.forEach(t),T=c(o),f=s(o,"H1",{class:!0});var Jo=n(f);g=s(Jo,"A",{id:!0,class:!0,href:!0});var Xs=n(g);v=s(Xs,"SPAN",{});var Zs=n(v);w(_.$$.fragment,Zs),Zs.forEach(t),Xs.forEach(t),u=c(Jo),V=s(Jo,"SPAN",{});var Qs=n(V);he=i(Qs,"Vision Transformer (ViT)"),Qs.forEach(t),Jo.forEach(t),R=c(o),w(k.$$.fragment,o),ie=c(o),j=s(o,"H2",{class:!0});var Ko=n(j);B=s(Ko,"A",{id:!0,class:!0,href:!0});var Ys=n(B);oe=s(Ys,"SPAN",{});var en=n(oe);w(C.$$.fragment,en),en.forEach(t),Ys.forEach(t),pe=c(Ko),ae=s(Ko,"SPAN",{});var tn=n(ae);E=i(tn,"Overview"),tn.forEach(t),Ko.forEach(t),M=c(o),z=s(o,"P",{});var Go=n(z);Me=i(Go,"The Vision Transformer (ViT) model was proposed in "),se=s(Go,"A",{href:!0,rel:!0});var on=n(se);L=i(on,`An Image is Worth 16x16 Words: Transformers for Image Recognition
...
resolution of 16x16 and fine-tuning resolution of 224x224. All checkpoints can be found on the `),It=s(ya,"A",{href:!0,rel:!0});var nh=n(It);_r=i(nh,"hub"),nh.forEach(t),vr=i(ya,"."),ya.forEach(t),Tr=c(Y),Ce=s(Y,"LI",{});var $a=n(Ce);br=i($a,"The available checkpoints are either (1) pre-trained on "),Mt=s($a,"A",{href:!0,rel:!0});var rh=n(Mt);wr=i(rh,"ImageNet-21k"),rh.forEach(t),yr=i($a,` (a collection of
...
an experiment with a self-supervised pre-training objective, namely masked patched prediction (inspired by masked
language modeling). With this approach, the smaller ViT-B/16 model achieves 79.9% accuracy on ImageNet, a significant
improvement of 2% to training from scratch, but still 4% behind supervised pre-training.`),ch.forEach(t),Y.forEach(t),ln=c(o),ea=s(o,"P",{});var hh=n(ea);Cr=i(hh,"Following the original Vision Transformer, some follow-up works have been made:"),hh.forEach(t),dn=c(o),le=s(o,"UL",{});var bt=n(le);Ba=s(bt,"LI",{});var ph=n(Ba);P=s(ph,"P",{});var S=n(P);ta=s(S,"A",{href:!0});var mh=n(ta);Ar=i(mh,"DeiT"),mh.forEach(t),qr=i(S,` (Data-efficient Image Transformers) by Facebook AI. DeiT models are distilled vision transformers.
...
use `),sa=s(S,"A",{href:!0});var bh=n(sa);Kr=i(bh,"DeiTFeatureExtractor"),bh.forEach(t),Gr=i(S," in order to prepare images for the model."),S.forEach(t),ph.forEach(t),Xr=c(bt),Ka=s(bt,"LI",{});var wh=n(Ka);na=s(wh,"P",{});var Xc=n(na);ra=s(Xc,"A",{href:!0});var yh=n(ra);Zr=i(yh,"BEiT"),yh.forEach(t),Qr=i(Xc,` (BERT pre-training of Image Transformers) by Microsoft Research. BEiT models outperform supervised pre-trained
vision transformers using a self-supervised method inspired by BERT (masked image modeling) and based on a VQ-VAE.`),Xc.forEach(t),wh.forEach(t),Yr=c(bt),Ga=s(bt,"LI",{});var $h=n(Ga);At=s($h,"P",{});var Cn=n(At);ei=i(Cn,`DINO (a method for self-supervised training of Vision Transformers) by Facebook AI. Vision Transformers trained using
the DINO method show very interesting properties not seen with convolutional models. They are capable of segmenting
objects, without having ever been trained to do so. DINO checkpoints can be found on the `),qt=s(Cn,"A",{href:!0,rel:!0});var xh=n(qt);ti=i(xh,"hub"),xh.forEach(t),oi=i(Cn,"."),Cn.forEach(t),$h.forEach(t),ai=c(bt),Xa=s(bt,"LI",{});var Fh=n(Xa);ia=s(Fh,"P",{});var Zc=n(ia);la=s(Zc,"A",{href:!0});var Vh=n(la);si=i(Vh,"MAE"),Vh.forEach(t),ni=i(Zc,` (Masked Autoencoders) by Facebook AI. By pre-training Vision Transformers to reconstruct pixel values for a high portion
(75%) of masked patches (using an asymmetric encoder-decoder architecture), the authors show that this simple method outperforms
supervised pre-training after fine-tuning.`),Zc.forEach(t),Fh.forEach(t),bt.forEach(t),cn=c(o),be=s(o,"P",{});var Fa=n(be);ri=i(Fa,"This model was contributed by "),zt=s(Fa,"A",{href:!0,rel:!0});var Eh=n(zt);ii=i(Eh,"nielsr"),Eh.forEach(t),li=i(Fa,`. The original code (written in JAX) can be
found `),Nt=s(Fa,"A",{href:!0,rel:!0});var kh=n(Nt);di=i(kh,"here"),kh.forEach(t),ci=i(Fa,"."),Fa.forEach(t),hn=c(o),et=s(o,"P",{});var An=n(et);hi=i(An,"Note that we converted the weights from Ross Wightman\u2019s "),Lt=s(An,"A",{href:!0,rel:!0});var Ih=n(Lt);pi=i(Ih,"timm library"),Ih.forEach(t),mi=i(An,`, who already converted the weights from JAX to PyTorch. Credits
go to him!`),An.forEach(t),pn=c(o),qe=s(o,"H2",{class:!0});var qn=n(qe);tt=s(qn,"A",{id:!0,class:!0,href:!0});var Mh=n(tt);Za=s(Mh,"SPAN",{});var jh=n(Za);w(Dt.$$.fragment,jh),jh.forEach(t),Mh.forEach(t),fi=c(qn),Qa=s(qn,"SPAN",{});var Ph=n(Qa);ui=i(Ph,"ViTConfig"),Ph.forEach(t),qn.forEach(t),mn=c(o),U=s(o,"DIV",{class:!0});var ye=n(U);w(Ot.$$.fragment,ye),gi=c(ye),ze=s(ye,"P",{});var Va=n(ze);_i=i(Va,"This is the configuration class to store the configuration of a "),da=s(Va,"A",{href:!0});var Ch=n(da);vi=i(Ch,"ViTModel"),Ch.forEach(t),Ti=i(Va,`. It is used to instantiate an ViT
model according to the specified arguments, defining the model architecture. Instantiating a configuration with the
defaults will yield a similar configuration to that of the ViT
`),St=s(Va,"A",{href:!0,rel:!0});var Ah=n(St);bi=i(Ah,"google/vit-base-patch16-224"),Ah.forEach(t),wi=i(Va," architecture."),Va.forEach(t),yi=c(ye),Ne=s(ye,"P",{});var Ea=n(Ne);$i=i(Ea,"Configuration objects inherit from "),ca=s(Ea,"A",{href:!0});var qh=n(ca);xi=i(qh,"PretrainedConfig"),qh.forEach(t),Fi=i(Ea,` and can be used to control the model outputs. Read the
documentation from `),ha=s(Ea,"A",{href:!0});var zh=n(ha);Vi=i(zh,"PretrainedConfig"),zh.forEach(t),Ei=i(Ea," for more information."),Ea.forEach(t),ki=c(ye),Ya=s(ye,"P",{});var Nh=n(Ya);Ii=i(Nh,"Example:"),Nh.forEach(t),Mi=c(ye),w(Wt.$$.fragment,ye),ye.forEach(t),fn=c(o),Le=s(o,"H2",{class:!0});var zn=n(Le);ot=s(zn,"A",{id:!0,class:!0,href:!0});var Lh=n(ot);es=s(Lh,"SPAN",{});var Dh=n(es);w(Bt.$$.fragment,Dh),Dh.forEach(t),Lh.forEach(t),ji=c(zn),ts=s(zn,"SPAN",{});var Oh=n(ts);Pi=i(Oh,"ViTFeatureExtractor"),Oh.forEach(t),zn.forEach(t),un=c(o),ne=s(o,"DIV",{class:!0});var wt=n(ne);w(Ut.$$.fragment,wt),Ci=c(wt),os=s(wt,"P",{});var Sh=n(os);Ai=i(Sh,"Constructs a ViT feature extractor."),Sh.forEach(t),qi=c(wt),Rt=s(wt,"P",{});var Nn=n(Rt);zi=i(Nn,"This feature extractor inherits from "),pa=s(Nn,"A",{href:!0});var Wh=n(pa);Ni=i(Wh,"FeatureExtractionMixin"),Wh.forEach(t),Li=i(Nn,` which contains most of the main methods. Users
should refer to this superclass for more information regarding those methods.`),Nn.forEach(t),Di=c(wt),we=s(wt,"DIV",{class:!0});var ka=n(we);w(Ht.$$.fragment,ka),Oi=c(ka),as=s(ka,"P",{});var Bh=n(as);Si=i(Bh,"Main method to prepare for the model one or several image(s)."),Bh.forEach(t),Wi=c(ka),w(at.$$.fragment,ka),ka.forEach(t),wt.forEach(t),gn=c(o),De=s(o,"H2",{class:!0});var Ln=n(De);st=s(Ln,"A",{id:!0,class:!0,href:!0});var Uh=n(st);ss=s(Uh,"SPAN",{});var Rh=n(ss);w(Jt.$$.fragment,Rh),Rh.forEach(t),Uh.forEach(t),Bi=c(Ln),ns=s(Ln,"SPAN",{});var Hh=n(ns);Ui=i(Hh,"ViTModel"),Hh.forEach(t),Ln.forEach(t),_n=c(o),me=s(o,"DIV",{class:!0});var Ia=n(me);w(Kt.$$.fragment,Ia),Ri=c(Ia),Gt=s(Ia,"P",{});var Dn=n(Gt);Hi=i(Dn,`The bare ViT Model transformer outputting raw hidden-states without any specific head on top.
This model is a PyTorch `),Xt=s(Dn,"A",{href:!0,rel:!0});var Jh=n(Xt);Ji=i(Jh,"torch.nn.Module"),Jh.forEach(t),Ki=i(Dn,` subclass. Use it
as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),Dn.forEach(t),Gi=c(Ia),H=s(Ia,"DIV",{class:!0});var $e=n(H);w(Zt.$$.fragment,$e),Xi=c($e),Oe=s($e,"P",{});var Ma=n(Oe);Zi=i(Ma,"The "),ma=s(Ma,"A",{href:!0});var Kh=n(ma);Qi=i(Kh,"ViTModel"),Kh.forEach(t),Yi=i(Ma," forward method, overrides the "),rs=s(Ma,"CODE",{});var Gh=n(rs);el=i(Gh,"__call__"),Gh.forEach(t),tl=i(Ma," special method."),Ma.forEach(t),ol=c($e),w(nt.$$.fragment,$e),al=c($e),is=s($e,"P",{});var Xh=n(is);sl=i(Xh,"Example:"),Xh.forEach(t),nl=c($e),w(Qt.$$.fragment,$e),$e.forEach(t),Ia.forEach(t),vn=c(o),Se=s(o,"H2",{class:!0});var On=n(Se);rt=s(On,"A",{id:!0,class:!0,href:!0});var Zh=n(rt);ls=s(Zh,"SPAN",{});var Qh=n(ls);w(Yt.$$.fragment,Qh),Qh.forEach(t),Zh.forEach(t),rl=c(On),ds=s(On,"SPAN",{});var Yh=n(ds);il=i(Yh,"ViTForMaskedImageModeling"),Yh.forEach(t),On.forEach(t),Tn=c(o),fe=s(o,"DIV",{class:!0});var ja=n(fe);w(eo.$$.fragment,ja),ll=c(ja),We=s(ja,"P",{});var Pa=n(We);dl=i(Pa,"ViT Model with a decoder on top for masked image modeling, as proposed in "),cs=s(Pa,"CODE",{});var ep=n(cs);cl=i(ep,"SimMIM <https://arxiv.org/abs/2111.09886>"),ep.forEach(t),hl=i(Pa,`__.
This model is a PyTorch `),to=s(Pa,"A",{href:!0,rel:!0});var tp=n(to);pl=i(tp,"torch.nn.Module"),tp.forEach(t),ml=i(Pa,` subclass. Use it
as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),Pa.forEach(t),fl=c(ja),J=s(ja,"DIV",{class:!0});var xe=n(J);w(oo.$$.fragment,xe),ul=c(xe),Be=s(xe,"P",{});var Ca=n(Be);gl=i(Ca,"The "),fa=s(Ca,"A",{href:!0});var op=n(fa);_l=i(op,"ViTForMaskedImageModeling"),op.forEach(t),vl=i(Ca," forward method, overrides the "),hs=s(Ca,"CODE",{});var ap=n(hs);Tl=i(ap,"__call__"),ap.forEach(t),bl=i(Ca," special method."),Ca.forEach(t),wl=c(xe),w(it.$$.fragment,xe),yl=c(xe),ps=s(xe,"P",{});var sp=n(ps);$l=i(sp,"Examples:"),sp.forEach(t),xl=c(xe),w(ao.$$.fragment,xe),xe.forEach(t),ja.forEach(t),bn=c(o),Ue=s(o,"H2",{class:!0});var Sn=n(Ue);lt=s(Sn,"A",{id:!0,class:!0,href:!0});var np=n(lt);ms=s(np,"SPAN",{});var rp=n(ms);w(so.$$.fragment,rp),rp.forEach(t),np.forEach(t),Fl=c(Sn),fs=s(Sn,"SPAN",{});var ip=n(fs);Vl=i(ip,"ViTForImageClassification"),ip.forEach(t),Sn.forEach(t),wn=c(o),re=s(o,"DIV",{class:!0});var yt=n(re);w(no.$$.fragment,yt),El=c(yt),us=s(yt,"P",{});var lp=n(us);kl=i(lp,`ViT Model transformer with an image classification head on top (a linear layer on top of the final hidden state of
...
as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),Wn.forEach(t),Cl=c(yt),K=s(yt,"DIV",{class:!0});var Fe=n(K);w(lo.$$.fragment,Fe),Al=c(Fe),Re=s(Fe,"P",{});var Aa=n(Re);ql=i(Aa,"The "),ua=s(Aa,"A",{href:!0});var cp=n(ua);zl=i(cp,"ViTForImageClassification"),cp.forEach(t),Nl=i(Aa," forward method, overrides the "),gs=s(Aa,"CODE",{});var hp=n(gs);Ll=i(hp,"__call__"),hp.forEach(t),Dl=i(Aa," special method."),Aa.forEach(t),Ol=c(Fe),w(dt.$$.fragment,Fe),Sl=c(Fe),_s=s(Fe,"P",{});var pp=n(_s);Wl=i(pp,"Example:"),pp.forEach(t),Bl=c(Fe),w(co.$$.fragment,Fe),Fe.forEach(t),yt.forEach(t),yn=c(o),He=s(o,"H2",{class:!0});var Bn=n(He);ct=s(Bn,"A",{id:!0,class:!0,href:!0});var mp=n(ct);vs=s(mp,"SPAN",{});var fp=n(vs);w(ho.$$.fragment,fp),fp.forEach(t),mp.forEach(t),Ul=c(Bn),Ts=s(Bn,"SPAN",{});var up=n(Ts);Rl=i(up,"TFViTModel"),up.forEach(t),Bn.forEach(t),$n=c(o),D=s(o,"DIV",{class:!0});var de=n(D);w(po.$$.fragment,de),Hl=c(de),bs=s(de,"P",{});var gp=n(bs);Jl=i(gp,"The bare ViT Model transformer outputting raw hidden-states without any specific head on top."),gp.forEach(t),Kl=c(de),mo=s(de,"P",{});var Un=n(mo);Gl=i(Un,"This model inherits from "),ga=s(Un,"A",{href:!0});var _p=n(ga);Xl=i(_p,"TFPreTrainedModel"),_p.forEach(t),Zl=i(Un,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Un.forEach(t),Ql=c(de),fo=s(de,"P",{});var Rn=n(fo);Yl=i(Rn,"This model is also a "),uo=s(Rn,"A",{href:!0,rel:!0});var vp=n(uo);ed=i(vp,"tf.keras.Model"),vp.forEach(t),td=i(Rn,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Rn.forEach(t),od=c(de),w(ht.$$.fragment,de),ad=c(de),G=s(de,"DIV",{class:!0});var Ve=n(G);w(go.$$.fragment,Ve),sd=c(Ve),Je=s(Ve,"P",{});var qa=n(Je);nd=i(qa,"The "),_a=s(qa,"A",{href:!0});var Tp=n(_a);rd=i(Tp,"TFViTModel"),Tp.forEach(t),id=i(qa," forward method, overrides the "),ws=s(qa,"CODE",{});var bp=n(ws);ld=i(bp,"__call__"),bp.forEach(t),dd=i(qa," special method."),qa.forEach(t),cd=c(Ve),w(pt.$$.fragment,Ve),hd=c(Ve),ys=s(Ve,"P",{});var wp=n(ys);pd=i(wp,"Examples:"),wp.forEach(t),md=c(Ve),w(_o.$$.fragment,Ve),Ve.forEach(t),de.forEach(t),xn=c(o),Ke=s(o,"H2",{class:!0});var Hn=n(Ke);mt=s(Hn,"A",{id:!0,class:!0,href:!0});var yp=n(mt);$s=s(yp,"SPAN",{});var $p=n($s);w(vo.$$.fragment,$p),$p.forEach(t),yp.forEach(t),fd=c(Hn),xs=s(Hn,"SPAN",{});var xp=n(xs);ud=i(xp,"TFViTForImageClassification"),xp.forEach(t),Hn.forEach(t),Fn=c(o),O=s(o,"DIV",{class:!0});var ce=n(O);w(To.$$.fragment,ce),gd=c(ce),Fs=s(ce,"P",{});var Fp=n(Fs);_d=i(Fp,`ViT Model transformer with an image classification head on top (a linear layer on top of the final hidden state of
the [CLS] token) e.g. for ImageNet.`),Fp.forEach(t),vd=c(ce),bo=s(ce,"P",{});var Jn=n(bo);Td=i(Jn,"This model inherits from "),va=s(Jn,"A",{href:!0});var Vp=n(va);bd=i(Vp,"TFPreTrainedModel"),Vp.forEach(t),wd=i(Jn,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Jn.forEach(t),yd=c(ce),wo=s(ce,"P",{});var Kn=n(wo);$d=i(Kn,"This model is also a "),yo=s(Kn,"A",{href:!0,rel:!0});var Ep=n(yo);xd=i(Ep,"tf.keras.Model"),Ep.forEach(t),Fd=i(Kn,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Kn.forEach(t),Vd=c(ce),w(ft.$$.fragment,ce),Ed=c(ce),X=s(ce,"DIV",{class:!0});var Ee=n(X);w($o.$$.fragment,Ee),kd=c(Ee),Ge=s(Ee,"P",{});var za=n(Ge);Id=i(za,"The "),Ta=s(za,"A",{href:!0});var kp=n(Ta);Md=i(kp,"TFViTForImageClassification"),kp.forEach(t),jd=i(za," forward method, overrides the "),Vs=s(za,"CODE",{});var Ip=n(Vs);Pd=i(Ip,"__call__"),Ip.forEach(t),Cd=i(za," special method."),za.forEach(t),Ad=c(Ee),w(ut.$$.fragment,Ee),qd=c(Ee),Es=s(Ee,"P",{});var Mp=n(Es);zd=i(Mp,"Examples:"),Mp.forEach(t),Nd=c(Ee),w(xo.$$.fragment,Ee),Ee.forEach(t),ce.forEach(t),Vn=c(o),Xe=s(o,"H2",{class:!0});var Gn=n(Xe);gt=s(Gn,"A",{id:!0,class:!0,href:!0});var jp=n(gt);ks=s(jp,"SPAN",{});var Pp=n(ks);w(Fo.$$.fragment,Pp),Pp.forEach(t),jp.forEach(t),Ld=c(Gn),Is=s(Gn,"SPAN",{});var Cp=n(Is);Dd=i(Cp,"FlaxVitModel"),Cp.forEach(t),Gn.forEach(t),En=c(o),A=s(o,"DIV",{class:!0});var ee=n(A);w(Vo.$$.fragment,ee),Od=c(ee),Ms=s(ee,"P",{});var Ap=n(Ms);Sd=i(Ap,"The bare ViT Model transformer outputting raw hidden-states without any specific head on top."),Ap.forEach(t),Wd=c(ee),Eo=s(ee,"P",{});var Xn=n(Eo);Bd=i(Xn,"This model inherits from "),ba=s(Xn,"A",{href:!0});var qp=n(ba);Ud=i(qp,"FlaxPreTrainedModel"),qp.forEach(t),Rd=i(Xn,`. Check the superclass documentation for the generic methods the
...
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),Zn.forEach(t),Xd=c(ee),js=s(ee,"P",{});var Np=n(js);Zd=i(Np,"Finally, this model supports inherent JAX features such as:"),Np.forEach(t),Qd=c(ee),ue=s(ee,"UL",{});var $t=n(ue);Ps=s($t,"LI",{});var Lp=n(Ps);Mo=s(Lp,"A",{href:!0,rel:!0});var Dp=n(Mo);Yd=i(Dp,"Just-In-Time (JIT) compilation"),Dp.forEach(t),Lp.forEach(t),ec=c($t),Cs=s($t,"LI",{});var Op=n(Cs);jo=s(Op,"A",{href:!0,rel:!0});var Sp=n(jo);tc=i(Sp,"Automatic Differentiation"),Sp.forEach(t),Op.forEach(t),oc=c($t),As=s($t,"LI",{});var Wp=n(As);Po=s(Wp,"A",{href:!0,rel:!0});var Bp=n(Po);ac=i(Bp,"Vectorization"),Bp.forEach(t),Wp.forEach(t),sc=c($t),qs=s($t,"LI",{});var Up=n(qs);Co=s(Up,"A",{href:!0,rel:!0});var Rp=n(Co);nc=i(Rp,"Parallelization"),Rp.forEach(t),Up.forEach(t),$t.forEach(t),rc=c(ee),Z=s(ee,"DIV",{class:!0});var ke=n(Z);w(Ao.$$.fragment,ke),ic=c(ke),Ze=s(ke,"P",{});var Na=n(Ze);lc=i(Na,"The "),zs=s(Na,"CODE",{});var Hp=n(zs);dc=i(Hp,"FlaxViTPreTrainedModel"),Hp.forEach(t),cc=i(Na," forward method, overrides the "),Ns=s(Na,"CODE",{});var Jp=n(Ns);hc=i(Jp,"__call__"),Jp.forEach(t),pc=i(Na," special method."),Na.forEach(t),mc=c(ke),w(_t.$$.fragment,ke),fc=c(ke),Ls=s(ke,"P",{});var Kp=n(Ls);uc=i(Kp,"Examples:"),Kp.forEach(t),gc=c(ke),w(qo.$$.fragment,ke),ke.forEach(t),ee.forEach(t),kn=c(o),Qe=s(o,"H2",{class:!0});var Qn=n(Qe);vt=s(Qn,"A",{id:!0,class:!0,href:!0});var Gp=n(vt);Ds=s(Gp,"SPAN",{});var Xp=n(Ds);w(zo.$$.fragment,Xp),Xp.forEach(t),Gp.forEach(t),_c=c(Qn),Os=s(Qn,"SPAN",{});var Zp=n(Os);vc=i(Zp,"FlaxViTForImageClassification"),Zp.forEach(t),Qn.forEach(t),In=c(o),q=s(o,"DIV",{class:!0});var te=n(q);w(No.$$.fragment,te),Tc=c(te),Ss=s(te,"P",{});var Qp=n(Ss);bc=i(Qp,`ViT Model transformer with an image classification head on top (a linear layer on top of the final hidden state of
the [CLS] token) e.g. for ImageNet.`),Qp.forEach(t),wc=c(te),Lo=s(te,"P",{});var Yn=n(Lo);yc=i(Yn,"This model inherits from "),wa=s(Yn,"A",{href:!0});var Yp=n(wa);$c=i(Yp,"FlaxPreTrainedModel"),Yp.forEach(t),xc=i(Yn,`. Check the superclass documentation for the generic methods the
