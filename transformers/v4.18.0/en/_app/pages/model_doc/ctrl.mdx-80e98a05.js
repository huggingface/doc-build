...
first positional argument :`),He.forEach(t),ne=d(p),F=r(p,"UL",{});var N=i(F);q=r(N,"LI",{});var x=i(q);be=s(x,"a single Tensor with "),U=r(x,"CODE",{});var We=i(U);he=s(We,"input_ids"),We.forEach(t),se=s(x," only and nothing else: "),V=r(x,"CODE",{});var ze=i(V);ue=s(ze,"model(inputs_ids)"),ze.forEach(t),x.forEach(t),ae=d(N),z=r(N,"LI",{});var K=i(z);ke=s(K,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
...
`),G=r(we,"CODE",{});var Ue=i(G);Ce=s(Ue,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),Ue.forEach(t),we.forEach(t),N.forEach(t)},m(p,$){u(p,h,$),e(h,E),u(p,f,$),u(p,g,$),e(g,v),e(v,T),e(g,_),e(g,M),e(M,_e),u(p,Y,$),u(p,R,$),e(R,Q),e(R,D),e(D,Z),e(R,Te),e(R,A),e(A,ve),e(R,pe),u(p,P,$),u(p,j,$),e(j,ee),u(p,ne,$),u(p,F,$),e(F,q),e(q,be),e(q,U),e(U,he),e(q,se),e(q,V),e(V,ue),e(F,ae),e(F,z),e(z,ke),e(z,H),e(H,re),e(z,ye),e(z,W),e(W,S),e(F,te),e(F,I),e(I,oe),e(I,G),e(G,Ce)},d(p){p&&t(h),p&&t(f),p&&t(g),p&&t(Y),p&&t(R),p&&t(P),p&&t(j),p&&t(ne),p&&t(F)}}}function op(J){let h,E,f,g,v;return{c(){h=a("p"),E=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=a("code"),g=n("Module"),v=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(T){h=r(T,"P",{});var _=i(h);E=s(_,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=r(_,"CODE",{});var M=i(f);g=s(M,"Module"),M.forEach(t),v=s(_,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),_.forEach(t)},m(T,_){u(T,h,_),e(h,E),e(h,f),e(f,g),e(h,v)},d(T){T&&t(h)}}}function np(J){let h,E,f,g,v,T,_,M,_e,Y,R,Q,D,Z,Te,A,ve,pe,P,j,ee,ne,F,q,be,U,he,se,V,ue,ae,z,ke,H,re,ye,W,S,te,I,oe,G,Ce;return{c(){h=a("p"),E=n("TF 2.0 models accepts two formats as inputs:"),f=l(),g=a("ul"),v=a("li"),T=n("having all inputs as keyword arguments (like PyTorch models), or"),_=l(),M=a("li"),_e=n("having all inputs as a list, tuple or dict in the first positional arguments."),Y=l(),R=a("p"),Q=n("This second option is useful when using "),D=a("code"),Z=n("tf.keras.Model.fit"),Te=n(` method which currently requires having all the
tensors in the first argument of the model call function: `),A=a("code"),ve=n("model(inputs)"),pe=n("."),P=l(),j=a("p"),ee=n(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),ne=l(),F=a("ul"),q=a("li"),be=n("a single Tensor with "),U=a("code"),he=n("input_ids"),se=n(" only and nothing else: "),V=a("code"),ue=n("model(inputs_ids)"),ae=l(),z=a("li"),ke=n(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),H=a("code"),re=n("model([input_ids, attention_mask])"),ye=n(" or "),W=a("code"),S=n("model([input_ids, attention_mask, token_type_ids])"),te=l(),I=a("li"),oe=n(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),G=a("code"),Ce=n('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(p){h=r(p,"P",{});var $=i(h);E=s($,"TF 2.0 models accepts two formats as inputs:"),$.forEach(t),f=d(p),g=r(p,"UL",{});var ie=i(g);v=r(ie,"LI",{});var De=i(v);T=s(De,"having all inputs as keyword arguments (like PyTorch models), or"),De.forEach(t),_=d(ie),M=r(ie,"LI",{});var me=i(M);_e=s(me,"having all inputs as a list, tuple or dict in the first positional arguments."),me.forEach(t),ie.forEach(t),Y=d(p),R=r(p,"P",{});var O=i(R);Q=s(O,"This second option is useful when using "),D=r(O,"CODE",{});var qe=i(D);Z=s(qe,"tf.keras.Model.fit"),qe.forEach(t),Te=s(O,` method which currently requires having all the
...
Whether or not the model should return the last key/values attentions (not used by all models).`,name:"use_cache"}],source:"https://github.com/huggingface/transformers/blob/v4.18.0/src/transformers/models/ctrl/configuration_ctrl.py#L26"}}),Yt=new Qe({props:{code:`from transformers import CTRLModel, CTRLConfig
...
configuration. Check out the <a href="/docs/transformers/v4.18.0/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/v4.18.0/src/transformers/models/ctrl/modeling_ctrl.py#L320"}}),lo=new Fe({props:{name:"forward",anchor:"transformers.CTRLModel.forward",parameters:[{name:"input_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"past_key_values",val:": typing.Optional[typing.Tuple[typing.Tuple[torch.FloatTensor]]] = None"},{name:"attention_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"token_type_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"position_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"head_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"use_cache",val:": typing.Optional[bool] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.CTRLModel.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),po=new dt({}),ho=new Fe({props:{name:"class transformers.CTRLLMHeadModel",anchor:"transformers.CTRLLMHeadModel",parameters:[{name:"config",val:""}],parametersDescription:[{anchor:"transformers.CTRLLMHeadModel.config",description:`<strong>config</strong> (<a href="/docs/transformers/v4.18.0/en/model_doc/ctrl#transformers.CTRLConfig">CTRLConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/v4.18.0/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/v4.18.0/src/transformers/models/ctrl/modeling_ctrl.py#L493"}}),go=new Fe({props:{name:"forward",anchor:"transformers.CTRLLMHeadModel.forward",parameters:[{name:"input_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"past_key_values",val:": typing.Optional[typing.Tuple[typing.Tuple[torch.FloatTensor]]] = None"},{name:"attention_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"token_type_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"position_ids",val:": LongTensor = None"},{name:"head_mask",val:": FloatTensor = None"},{name:"inputs_embeds",val:": FloatTensor = None"},{name:"labels",val:": typing.Optional[torch.LongTensor] = None"},{name:"use_cache",val:": typing.Optional[bool] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.CTRLLMHeadModel.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
<code>input_ids_length</code> = <code>sequence_length</code> if <code>past_key_values</code> is <code>None</code> else <code>past_key_values[0].shape[-2]</code>
(<code>sequence_length</code> of input past key value states). Indices of input sequence tokens in the vocabulary.</p>
<p>If <code>past_key_values</code> is used, only input IDs that do not have their past calculated should be passed as
<code>input_ids</code>.</p>
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/v4.18.0/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/v4.18.0/src/transformers/models/ctrl/modeling_tf_ctrl.py#L516"}}),St=new $t({props:{$$slots:{default:[tp]},$$scope:{ctx:J}}}),xo=new Fe({props:{name:"call",anchor:"transformers.TFCTRLModel.call",parameters:[{name:"input_ids",val:" = None"},{name:"past_key_values",val:" = None"},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"},{name:"training",val:" = False"}],parametersDescription:[{anchor:"transformers.TFCTRLModel.call.input_ids",description:`<strong>input_ids</strong> (<code>Numpy array</code> or <code>tf.Tensor</code> of shape <code>(batch_size, input_ids_length)</code>) &#x2014;
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),jo=new dt({}),So=new Fe({props:{name:"class transformers.TFCTRLLMHeadModel",anchor:"transformers.TFCTRLLMHeadModel",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.TFCTRLLMHeadModel.config",description:`<strong>config</strong> (<a href="/docs/transformers/v4.18.0/en/model_doc/ctrl#transformers.CTRLConfig">CTRLConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
...
`}}),{c(){h=a("meta"),E=l(),f=a("h1"),g=a("a"),v=a("span"),b(T.$$.fragment),_=l(),M=a("span"),_e=n("CTRL"),Y=l(),R=a("h2"),Q=a("a"),D=a("span"),b(Z.$$.fragment),Te=l(),A=a("span"),ve=n("Overview"),pe=l(),P=a("p"),j=n("CTRL model was proposed in "),ee=a("a"),ne=n("CTRL: A Conditional Transformer Language Model for Controllable Generation"),F=n(" by Nitish Shirish Keskar"),q=a("em"),be=n(", Bryan McCann"),U=n(`, Lav R. Varshney, Caiming Xiong and
...
documentation from `),on=a("a"),Ia=n("PretrainedConfig"),Oa=n(" for more information."),Na=l(),xn=a("p"),Da=n("Examples:"),Aa=l(),b(Yt.$$.fragment),Fs=l(),ht=a("h2"),Mt=a("a"),Pn=a("span"),b(Zt.$$.fragment),Ha=l(),jn=a("span"),Wa=n("CTRLTokenizer"),qs=l(),Oe=a("div"),b(eo.$$.fragment),Ba=l(),Sn=a("p"),Ua=n("Construct a CTRL tokenizer. Based on Byte-Pair-Encoding."),Va=l(),to=a("p"),Ga=n("This tokenizer inherits from "),nn=a("a"),Ka=n("PreTrainedTokenizer"),Xa=n(` which contains most of the main methods. Users should refer to
this superclass for more information regarding those methods.`),Ja=l(),sn=a("div"),b(oo.$$.fragment),zs=l(),ut=a("h2"),Et=a("a"),In=a("span"),b(no.$$.fragment),Qa=l(),On=a("span"),Ya=n("CTRLModel"),xs=l(),$e=a("div"),b(so.$$.fragment),Za=l(),Nn=a("p"),er=n("The bare CTRL Model transformer outputting raw hidden-states without any specific head on top."),tr=l(),ao=a("p"),or=n("This model inherits from "),an=a("a"),nr=n("PreTrainedModel"),sr=n(`. Check the superclass documentation for the generic methods the
...
and behavior.`),dr=l(),Pe=a("div"),b(lo.$$.fragment),cr=l(),mt=a("p"),pr=n("The "),rn=a("a"),hr=n("CTRLModel"),ur=n(" forward method, overrides the "),Dn=a("code"),mr=n("__call__"),fr=n(" special method."),gr=l(),b(Ft.$$.fragment),_r=l(),An=a("p"),Tr=n("Example:"),vr=l(),b(co.$$.fragment),Ps=l(),ft=a("h2"),qt=a("a"),Hn=a("span"),b(po.$$.fragment),br=l(),Wn=a("span"),kr=n("CTRLLMHeadModel"),js=l(),Re=a("div"),b(ho.$$.fragment),yr=l(),Bn=a("p"),Cr=n(`The CTRL Model transformer with a language modeling head on top (linear layer with weights tied to the input
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),zr=l(),je=a("div"),b(go.$$.fragment),xr=l(),gt=a("p"),Pr=n("The "),dn=a("a"),jr=n("CTRLLMHeadModel"),Sr=n(" forward method, overrides the "),Un=a("code"),Ir=n("__call__"),Or=n(" special method."),Nr=l(),b(zt.$$.fragment),Dr=l(),Vn=a("p"),Ar=n("Example:"),Hr=l(),b(_o.$$.fragment),Ss=l(),_t=a("h2"),xt=a("a"),Gn=a("span"),b(To.$$.fragment),Wr=l(),Kn=a("span"),Br=n("CTRLForSequenceClassification"),Is=l(),Me=a("div"),b(vo.$$.fragment),Ur=l(),Ee=a("p"),Vr=n(`The CTRL Model transformer with a sequence classification head on top (linear layer).
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),pi=l(),B=a("div"),b(Co.$$.fragment),hi=l(),Tt=a("p"),ui=n("The "),hn=a("a"),mi=n("CTRLForSequenceClassification"),fi=n(" forward method, overrides the "),Zn=a("code"),gi=n("__call__"),_i=n(" special method."),Ti=l(),b(Pt.$$.fragment),vi=l(),es=a("p"),bi=n("Example of single-label classification:"),ki=l(),b(wo.$$.fragment),yi=l(),b(Lo.$$.fragment),Ci=l(),ts=a("p"),wi=n("Example of multi-label classification:"),Li=l(),b($o.$$.fragment),$i=l(),b(Ro.$$.fragment),Os=l(),vt=a("h2"),jt=a("a"),os=a("span"),b(Mo.$$.fragment),Ri=l(),ns=a("span"),Mi=n("TFCTRLModel"),Ns=l(),de=a("div"),b(Eo.$$.fragment),Ei=l(),ss=a("p"),Fi=n("The bare CTRL Model transformer outputting raw hidden-states without any specific head on top."),qi=l(),Fo=a("p"),zi=n("This model inherits from "),un=a("a"),xi=n("TFPreTrainedModel"),Pi=n(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),ji=l(),qo=a("p"),Si=n("This model is also a "),zo=a("a"),Ii=n("tf.keras.Model"),Oi=n(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Ni=l(),b(St.$$.fragment),Di=l(),Se=a("div"),b(xo.$$.fragment),Ai=l(),bt=a("p"),Hi=n("The "),mn=a("a"),Wi=n("TFCTRLModel"),Bi=n(" forward method, overrides the "),as=a("code"),Ui=n("__call__"),Vi=n(" special method."),Gi=l(),b(It.$$.fragment),Ki=l(),rs=a("p"),Xi=n("Example:"),Ji=l(),b(Po.$$.fragment),Ds=l(),kt=a("h2"),Ot=a("a"),is=a("span"),b(jo.$$.fragment),Qi=l(),ls=a("span"),Yi=n("TFCTRLLMHeadModel"),As=l(),ce=a("div"),b(So.$$.fragment),Zi=l(),ds=a("p"),el=n(`The CTRL Model transformer with a language modeling head on top (linear layer with weights tied to the input
...
documentation from `),on=r(yn,"A",{href:!0});var Ed=i(on);Ia=s(Ed,"PretrainedConfig"),Ed.forEach(t),Oa=s(yn," for more information."),yn.forEach(t),Na=d(et),xn=r(et,"P",{});var Fd=i(xn);Da=s(Fd,"Examples:"),Fd.forEach(t),Aa=d(et),k(Yt.$$.fragment,et),et.forEach(t),Fs=d(o),ht=r(o,"H2",{class:!0});var Ks=i(ht);Mt=r(Ks,"A",{id:!0,class:!0,href:!0});var qd=i(Mt);Pn=r(qd,"SPAN",{});var zd=i(Pn);k(Zt.$$.fragment,zd),zd.forEach(t),qd.forEach(t),Ha=d(Ks),jn=r(Ks,"SPAN",{});var xd=i(jn);Wa=s(xd,"CTRLTokenizer"),xd.forEach(t),Ks.forEach(t),qs=d(o),Oe=r(o,"DIV",{class:!0});var Vt=i(Oe);k(eo.$$.fragment,Vt),Ba=d(Vt),Sn=r(Vt,"P",{});var Pd=i(Sn);Ua=s(Pd,"Construct a CTRL tokenizer. Based on Byte-Pair-Encoding."),Pd.forEach(t),Va=d(Vt),to=r(Vt,"P",{});var Xs=i(to);Ga=s(Xs,"This tokenizer inherits from "),nn=r(Xs,"A",{href:!0});var jd=i(nn);Ka=s(jd,"PreTrainedTokenizer"),jd.forEach(t),Xa=s(Xs,` which contains most of the main methods. Users should refer to
this superclass for more information regarding those methods.`),Xs.forEach(t),Ja=d(Vt),sn=r(Vt,"DIV",{class:!0});var Sd=i(sn);k(oo.$$.fragment,Sd),Sd.forEach(t),Vt.forEach(t),zs=d(o),ut=r(o,"H2",{class:!0});var Js=i(ut);Et=r(Js,"A",{id:!0,class:!0,href:!0});var Id=i(Et);In=r(Id,"SPAN",{});var Od=i(In);k(no.$$.fragment,Od),Od.forEach(t),Id.forEach(t),Qa=d(Js),On=r(Js,"SPAN",{});var Nd=i(On);Ya=s(Nd,"CTRLModel"),Nd.forEach(t),Js.forEach(t),xs=d(o),$e=r(o,"DIV",{class:!0});var tt=i($e);k(so.$$.fragment,tt),Za=d(tt),Nn=r(tt,"P",{});var Dd=i(Nn);er=s(Dd,"The bare CTRL Model transformer outputting raw hidden-states without any specific head on top."),Dd.forEach(t),tr=d(tt),ao=r(tt,"P",{});var Qs=i(ao);or=s(Qs,"This model inherits from "),an=r(Qs,"A",{href:!0});var Ad=i(an);nr=s(Ad,"PreTrainedModel"),Ad.forEach(t),sr=s(Qs,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Ys.forEach(t),dr=d(tt),Pe=r(tt,"DIV",{class:!0});var ot=i(Pe);k(lo.$$.fragment,ot),cr=d(ot),mt=r(ot,"P",{});var Cn=i(mt);pr=s(Cn,"The "),rn=r(Cn,"A",{href:!0});var Wd=i(rn);hr=s(Wd,"CTRLModel"),Wd.forEach(t),ur=s(Cn," forward method, overrides the "),Dn=r(Cn,"CODE",{});var Bd=i(Dn);mr=s(Bd,"__call__"),Bd.forEach(t),fr=s(Cn," special method."),Cn.forEach(t),gr=d(ot),k(Ft.$$.fragment,ot),_r=d(ot),An=r(ot,"P",{});var Ud=i(An);Tr=s(Ud,"Example:"),Ud.forEach(t),vr=d(ot),k(co.$$.fragment,ot),ot.forEach(t),tt.forEach(t),Ps=d(o),ft=r(o,"H2",{class:!0});var Zs=i(ft);qt=r(Zs,"A",{id:!0,class:!0,href:!0});var Vd=i(qt);Hn=r(Vd,"SPAN",{});var Gd=i(Hn);k(po.$$.fragment,Gd),Gd.forEach(t),Vd.forEach(t),br=d(Zs),Wn=r(Zs,"SPAN",{});var Kd=i(Wn);kr=s(Kd,"CTRLLMHeadModel"),Kd.forEach(t),Zs.forEach(t),js=d(o),Re=r(o,"DIV",{class:!0});var nt=i(Re);k(ho.$$.fragment,nt),yr=d(nt),Bn=r(nt,"P",{});var Xd=i(Bn);Cr=s(Xd,`The CTRL Model transformer with a language modeling head on top (linear layer with weights tied to the input
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),ta.forEach(t),zr=d(nt),je=r(nt,"DIV",{class:!0});var st=i(je);k(go.$$.fragment,st),xr=d(st),gt=r(st,"P",{});var wn=i(gt);Pr=s(wn,"The "),dn=r(wn,"A",{href:!0});var Yd=i(dn);jr=s(Yd,"CTRLLMHeadModel"),Yd.forEach(t),Sr=s(wn," forward method, overrides the "),Un=r(wn,"CODE",{});var Zd=i(Un);Ir=s(Zd,"__call__"),Zd.forEach(t),Or=s(wn," special method."),wn.forEach(t),Nr=d(st),k(zt.$$.fragment,st),Dr=d(st),Vn=r(st,"P",{});var ec=i(Vn);Ar=s(ec,"Example:"),ec.forEach(t),Hr=d(st),k(_o.$$.fragment,st),st.forEach(t),nt.forEach(t),Ss=d(o),_t=r(o,"H2",{class:!0});var oa=i(_t);xt=r(oa,"A",{id:!0,class:!0,href:!0});var tc=i(xt);Gn=r(tc,"SPAN",{});var oc=i(Gn);k(To.$$.fragment,oc),oc.forEach(t),tc.forEach(t),Wr=d(oa),Kn=r(oa,"SPAN",{});var nc=i(Kn);Br=s(nc,"CTRLForSequenceClassification"),nc.forEach(t),oa.forEach(t),Is=d(o),Me=r(o,"DIV",{class:!0});var at=i(Me);k(vo.$$.fragment,at),Ur=d(at),Ee=r(at,"P",{});var Ve=i(Ee);Vr=s(Ve,`The CTRL Model transformer with a sequence classification head on top (linear layer).
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),sa.forEach(t),pi=d(at),B=r(at,"DIV",{class:!0});var le=i(B);k(Co.$$.fragment,le),hi=d(le),Tt=r(le,"P",{});var Ln=i(Tt);ui=s(Ln,"The "),hn=r(Ln,"A",{href:!0});var pc=i(hn);mi=s(pc,"CTRLForSequenceClassification"),pc.forEach(t),fi=s(Ln," forward method, overrides the "),Zn=r(Ln,"CODE",{});var hc=i(Zn);gi=s(hc,"__call__"),hc.forEach(t),_i=s(Ln," special method."),Ln.forEach(t),Ti=d(le),k(Pt.$$.fragment,le),vi=d(le),es=r(le,"P",{});var uc=i(es);bi=s(uc,"Example of single-label classification:"),uc.forEach(t),ki=d(le),k(wo.$$.fragment,le),yi=d(le),k(Lo.$$.fragment,le),Ci=d(le),ts=r(le,"P",{});var mc=i(ts);wi=s(mc,"Example of multi-label classification:"),mc.forEach(t),Li=d(le),k($o.$$.fragment,le),$i=d(le),k(Ro.$$.fragment,le),le.forEach(t),at.forEach(t),Os=d(o),vt=r(o,"H2",{class:!0});var aa=i(vt);jt=r(aa,"A",{id:!0,class:!0,href:!0});var fc=i(jt);os=r(fc,"SPAN",{});var gc=i(os);k(Mo.$$.fragment,gc),gc.forEach(t),fc.forEach(t),Ri=d(aa),ns=r(aa,"SPAN",{});var _c=i(ns);Mi=s(_c,"TFCTRLModel"),_c.forEach(t),aa.forEach(t),Ns=d(o),de=r(o,"DIV",{class:!0});var Ge=i(de);k(Eo.$$.fragment,Ge),Ei=d(Ge),ss=r(Ge,"P",{});var Tc=i(ss);Fi=s(Tc,"The bare CTRL Model transformer outputting raw hidden-states without any specific head on top."),Tc.forEach(t),qi=d(Ge),Fo=r(Ge,"P",{});var ra=i(Fo);zi=s(ra,"This model inherits from "),un=r(ra,"A",{href:!0});var vc=i(un);xi=s(vc,"TFPreTrainedModel"),vc.forEach(t),Pi=s(ra,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),ia.forEach(t),Ni=d(Ge),k(St.$$.fragment,Ge),Di=d(Ge),Se=r(Ge,"DIV",{class:!0});var rt=i(Se);k(xo.$$.fragment,rt),Ai=d(rt),bt=r(rt,"P",{});var $n=i(bt);Hi=s($n,"The "),mn=r($n,"A",{href:!0});var kc=i(mn);Wi=s(kc,"TFCTRLModel"),kc.forEach(t),Bi=s($n," forward method, overrides the "),as=r($n,"CODE",{});var yc=i(as);Ui=s(yc,"__call__"),yc.forEach(t),Vi=s($n," special method."),$n.forEach(t),Gi=d(rt),k(It.$$.fragment,rt),Ki=d(rt),rs=r(rt,"P",{});var Cc=i(rs);Xi=s(Cc,"Example:"),Cc.forEach(t),Ji=d(rt),k(Po.$$.fragment,rt),rt.forEach(t),Ge.forEach(t),Ds=d(o),kt=r(o,"H2",{class:!0});var la=i(kt);Ot=r(la,"A",{id:!0,class:!0,href:!0});var wc=i(Ot);is=r(wc,"SPAN",{});var Lc=i(is);k(jo.$$.fragment,Lc),Lc.forEach(t),wc.forEach(t),Qi=d(la),ls=r(la,"SPAN",{});var $c=i(ls);Yi=s($c,"TFCTRLLMHeadModel"),$c.forEach(t),la.forEach(t),As=d(o),ce=r(o,"DIV",{class:!0});var Ke=i(ce);k(So.$$.fragment,Ke),Zi=d(Ke),ds=r(Ke,"P",{});var Rc=i(ds);el=s(Rc,`The CTRL Model transformer with a language modeling head on top (linear layer with weights tied to the input
