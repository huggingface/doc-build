import{S as hi,i as mi,s as fi,e as s,k as c,w as C,t as o,M as pi,c as n,d as r,m as h,a as i,x as w,h as a,b as l,N as ui,F as e,g as f,y as k,q as $,o as y,B as O,v as gi,L as ci}from"../../chunks/vendor-6b77c823.js";import{T as li}from"../../chunks/Tip-39098574.js";import{D as Z}from"../../chunks/Docstring-1088f2fb.js";import{C as Bs}from"../../chunks/CodeBlock-3a8b25a8.js";import{I as jt}from"../../chunks/IconCopyLink-7a11ce68.js";import{E as di}from"../../chunks/ExampleCodeBlock-5212b321.js";function _i(S){let p,R,u,g,T;return g=new Bs({props:{code:`from transformers import TrOCRForCausalLM, TrOCRConfig
...
<span class="hljs-string">&#x27;industry, &quot; Mr. Brown commented icily. &quot; Let us have a&#x27;</span>`}}),{c(){p=s("p"),R=o("Example:"),u=c(),C(g.$$.fragment)},l(m){p=n(m,"P",{});var _=i(p);R=a(_,"Example:"),_.forEach(r),u=h(m),w(g.$$.fragment,m)},m(m,_){f(m,p,_),e(p,R),f(m,u,_),k(g,m,_),T=!0},p:ci,i(m){T||($(g.$$.fragment,m),T=!0)},o(m){y(g.$$.fragment,m),T=!1},d(m){m&&r(p),m&&r(u),O(g,m)}}}function Ci(S){let p,R,u,g,T,m,_,D,j,x,L,F,Lt,$e,ro,zt,oo,ur,W,ao,ye,so,no,Oe,io,lo,gr,st,co,_r,nt,Ft,ho,vr,re,Us,Tr,oe,mo,it,fo,po,br,ae,uo,Dt,go,_o,Cr,H,vo,xe,To,bo,Re,Co,wo,wr,lt,ko,kr,B,Ee,$o,Pe,yo,Oo,xo,I,Ro,Me,Eo,Po,je,Mo,jo,Le,Lo,zo,Fo,ze,Do,dt,qo,Ao,$r,J,se,qt,Fe,Io,At,Vo,yr,U,No,It,So,Wo,ct,Ho,Bo,Or,v,Uo,Vt,Xo,Go,Nt,Zo,Jo,St,Yo,Ko,Wt,Qo,ea,ht,ta,ra,Ht,oa,aa,Bt,sa,na,Ut,ia,la,Xt,da,ca,xr,mt,Gt,ha,Rr,De,Er,ne,ma,qe,fa,pa,Pr,Y,ie,Zt,Ae,ua,Jt,ga,Mr,q,Ie,_a,K,va,ft,Ta,ba,Ve,Ca,wa,ka,Q,$a,pt,ya,Oa,ut,xa,Ra,Ea,le,jr,ee,de,Yt,Ne,Pa,Kt,Ma,Lr,b,Se,ja,Qt,La,za,P,gt,Fa,Da,er,qa,Aa,tr,Ia,Va,rr,Na,Sa,or,Wa,Ha,We,ar,Ba,Ua,Xa,_t,Ga,Za,Ja,ce,He,Ya,V,Ka,sr,Qa,es,vt,ts,rs,nr,os,as,ss,X,Be,ns,ir,is,ls,he,ds,G,Ue,cs,Xe,hs,Tt,ms,fs,ps,me,us,fe,Ge,gs,Ze,_s,bt,vs,Ts,bs,pe,Je,Cs,Ye,ws,Ct,ks,$s,ys,ue,Ke,Os,lr,xs,zr,te,ge,dr,Qe,Rs,cr,Es,Fr,A,et,Ps,N,Ms,wt,js,Ls,hr,zs,Fs,kt,Ds,qs,As,tt,Is,rt,Vs,Ns,Ss,_e,ot,Ws,ve,Dr;return m=new jt({}),$e=new jt({}),Fe=new jt({}),De=new Bs({props:{code:`from transformers import TrOCRProcessor, VisionEncoderDecoderModel
import requests 
from PIL import Image
...
An instance of [<code>RobertaTokenizer</code>/<code>XLMRobertaTokenizer</code>]. The tokenizer is a required input.`,name:"tokenizer"}],source:"https://github.com/huggingface/transformers/blob/v4.18.0/src/transformers/models/trocr/processing_trocr.py#L23"}}),He=new Z({props:{name:"__call__",anchor:"transformers.TrOCRProcessor.__call__",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/v4.18.0/src/transformers/models/trocr/processing_trocr.py#L44"}}),Be=new Z({props:{name:"from_pretrained",anchor:"transformers.TrOCRProcessor.from_pretrained",parameters:[{name:"pretrained_model_name_or_path",val:""},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.TrOCRProcessor.from_pretrained.pretrained_model_name_or_path",description:`<strong>pretrained_model_name_or_path</strong> (<code>str</code> or <code>os.PathLike</code>) &#x2014;
...
`),Ve=s("a"),Ca=o("microsoft/trocr-base"),wa=o(" architecture."),ka=c(),Q=s("p"),$a=o("Configuration objects inherit from "),pt=s("a"),ya=o("PretrainedConfig"),Oa=o(` and can be used to control the model outputs. Read the
