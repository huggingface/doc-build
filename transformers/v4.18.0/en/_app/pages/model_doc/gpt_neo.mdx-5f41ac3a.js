import{S as td,i as od,s as nd,e as n,k as d,w as _,t as r,M as sd,c as s,d as o,m as c,a,x as v,h as i,b as l,F as e,g as u,y as T,q as y,o as b,B as k,v as ad}from"../../chunks/vendor-6b77c823.js";import{T as dn}from"../../chunks/Tip-39098574.js";import{D as U}from"../../chunks/Docstring-af1d0ae0.js";import{C as oe}from"../../chunks/CodeBlock-3a8b25a8.js";import{I as ve}from"../../chunks/IconCopyLink-7a11ce68.js";function rd(W){let p,N,m,P,w;return{c(){p=n("p"),N=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),m=n("code"),P=r("Module"),w=r(`
...
the latter silently ignores them.`)},l(g){p=s(g,"P",{});var f=a(p);N=i(f,"Although the recipe for forward pass needs to be defined within this function, one should call the "),m=s(f,"CODE",{});var G=a(m);P=i(G,"Module"),G.forEach(o),w=i(f,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),f.forEach(o)},m(g,f){u(g,p,f),e(p,N),e(p,m),e(m,P),e(p,w)},d(g){g&&o(p)}}}function pd(W){let p,N,m,P,w,g,f,G,Xn,cn,ne,Te,lo,Ae,Kn,co,Qn,pn,J,Yn,Ie,Zn,es,Le,ts,os,hn,Ot,ns,un,ye,ss,Se,as,rs,mn,se,be,po,Oe,is,ho,ls,fn,ke,ds,uo,cs,ps,gn,De,_n,ae,Pe,mo,Be,hs,fo,us,vn,E,We,ms,re,fs,Dt,gs,_s,He,vs,Ts,ys,ie,bs,Bt,ks,Ps,Wt,ws,Ns,$s,go,Gs,xs,Ve,Tn,le,we,_o,Ue,Ms,vo,Fs,yn,q,Je,Cs,To,Es,qs,Re,zs,Ht,js,As,Is,Xe,Ls,Ke,Ss,Os,Ds,j,Qe,Bs,de,Ws,Vt,Hs,Vs,yo,Us,Js,Rs,Ne,Xs,bo,Ks,Qs,Ye,bn,ce,$e,ko,Ze,Ys,Po,Zs,kn,z,et,ea,wo,ta,oa,tt,na,Ut,sa,aa,ra,ot,ia,nt,la,da,ca,A,st,pa,pe,ha,Jt,ua,ma,No,fa,ga,_a,Ge,va,$o,Ta,ya,at,Pn,he,xe,Go,rt,ba,xo,ka,wn,x,it,Pa,Mo,wa,Na,Rt,Xt,$a,Ga,xa,B,Ma,Fo,Fa,Ca,Co,Ea,qa,Eo,za,ja,qo,Aa,Ia,La,lt,Sa,Kt,Oa,Da,Ba,dt,Wa,ct,Ha,Va,Ua,$,pt,Ja,ue,Ra,Qt,Xa,Ka,zo,Qa,Ya,Za,Me,er,jo,tr,or,ht,nr,ut,sr,Ao,ar,rr,mt,ir,ft,Nn,me,Fe,Io,gt,lr,Lo,dr,$n,M,_t,cr,So,pr,hr,vt,ur,Yt,mr,fr,gr,Tt,_r,yt,vr,Tr,yr,Oo,br,kr,H,Do,bt,Pr,wr,Bo,kt,Nr,$r,Wo,Pt,Gr,xr,Ho,wt,Mr,Fr,I,Nt,Cr,fe,Er,Vo,qr,zr,Uo,jr,Ar,Ir,Ce,Lr,Jo,Sr,Or,$t,Gn,ge,Ee,Ro,Gt,Dr,Xo,Br,xn,F,xt,Wr,Ko,Hr,Vr,Mt,Ur,Zt,Jr,Rr,Xr,Ft,Kr,Ct,Qr,Yr,Zr,Qo,ei,ti,V,Yo,Et,oi,ni,Zo,qt,si,ai,en,zt,ri,ii,tn,jt,li,di,L,At,ci,_e,pi,on,hi,ui,nn,mi,fi,gi,qe,_i,sn,vi,Ti,It,Mn;return g=new ve({}),Ae=new ve({}),Oe=new ve({}),De=new oe({props:{code:`from transformers import GPTNeoForCausalLM, GPT2Tokenizer
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),Ze=new ve({}),et=new U({props:{name:"class transformers.GPTNeoForCausalLM",anchor:"transformers.GPTNeoForCausalLM",parameters:[{name:"config",val:""}],source:"https://github.com/huggingface/transformers/blob/v4.18.0/src/transformers/models/gpt_neo/modeling_gpt_neo.py#L662",parametersDescription:[{anchor:"transformers.GPTNeoForCausalLM.config",description:`<strong>config</strong> (<a href="/docs/transformers/v4.18.0/en/model_doc/gpt_neo#transformers.GPTNeoConfig">GPTNeoConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/v4.18.0/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),st=new U({props:{name:"forward",anchor:"transformers.GPTNeoForCausalLM.forward",parameters:[{name:"input_ids",val:": typing.Optional[torch.Tensor] = None"},{name:"past_key_values",val:": typing.Optional[typing.Tuple[torch.FloatTensor]] = None"},{name:"attention_mask",val:": typing.Optional[torch.Tensor] = None"},{name:"token_type_ids",val:": typing.Optional[torch.Tensor] = None"},{name:"position_ids",val:": typing.Optional[torch.Tensor] = None"},{name:"head_mask",val:": typing.Optional[torch.Tensor] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.Tensor] = None"},{name:"labels",val:": typing.Optional[torch.Tensor] = None"},{name:"use_cache",val:": typing.Optional[bool] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],source:"https://github.com/huggingface/transformers/blob/v4.18.0/src/transformers/models/gpt_neo/modeling_gpt_neo.py#L712",parametersDescription:[{anchor:"transformers.GPTNeoForCausalLM.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, input_ids_length)</code>) &#x2014;
<code>input_ids_length</code> = <code>sequence_length</code> if <code>past_key_values</code> is <code>None</code> else
<code>past_key_values[0][0].shape[-2]</code> (<code>sequence_length</code> of input past key value states). Indices of input
sequence tokens in the vocabulary.</p>
<p>If <code>past_key_values</code> is used, only <code>input_ids</code> that do not have their past calculated should be passed as
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),Gt=new ve({}),xt=new U({props:{name:"class transformers.FlaxGPTNeoForCausalLM",anchor:"transformers.FlaxGPTNeoForCausalLM",parameters:[{name:"config",val:": GPTNeoConfig"},{name:"input_shape",val:": typing.Tuple = (1, 1)"},{name:"seed",val:": int = 0"},{name:"dtype",val:": dtype = <class 'jax._src.numpy.lax_numpy.float32'>"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/v4.18.0/src/transformers/models/gpt_neo/modeling_flax_gpt_neo.py#L645",parametersDescription:[{anchor:"transformers.FlaxGPTNeoForCausalLM.config",description:`<strong>config</strong> (<a href="/docs/transformers/v4.18.0/en/model_doc/gpt_neo#transformers.GPTNeoConfig">GPTNeoConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
...
documentation from `),Wt=n("a"),ws=r("PretrainedConfig"),Ns=r(" for more information."),$s=d(),go=n("p"),Gs=r("Example:"),xs=d(),_(Ve.$$.fragment),Tn=d(),le=n("h2"),we=n("a"),_o=n("span"),_(Ue.$$.fragment),Ms=d(),vo=n("span"),Fs=r("GPTNeoModel"),yn=d(),q=n("div"),_(Je.$$.fragment),Cs=d(),To=n("p"),Es=r("The bare GPT Neo Model transformer outputting raw hidden-states without any specific head on top."),qs=d(),Re=n("p"),zs=r("This model inherits from "),Ht=n("a"),js=r("PreTrainedModel"),As=r(`. Check the superclass documentation for the generic methods the
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),ca=d(),A=n("div"),_(st.$$.fragment),pa=d(),pe=n("p"),ha=r("The "),Jt=n("a"),ua=r("GPTNeoForCausalLM"),ma=r(" forward method, overrides the "),No=n("code"),fa=r("__call__"),ga=r(" special method."),_a=d(),_(Ge.$$.fragment),va=d(),$o=n("p"),Ta=r("Example:"),ya=d(),_(at.$$.fragment),Pn=d(),he=n("h2"),xe=n("a"),Go=n("span"),_(rt.$$.fragment),ba=d(),xo=n("span"),ka=r("GPTNeoForSequenceClassification"),wn=d(),x=n("div"),_(it.$$.fragment),Pa=d(),Mo=n("p"),wa=r("The GPTNeo Model transformer with a sequence classification head on top (linear layer)."),Na=d(),Rt=n("p"),Xt=n("a"),$a=r("GPTNeoForSequenceClassification"),Ga=r(` uses the last token in order to do the classification, as other causal models
...
documentation from `),Wt=s(oo,"A",{href:!0});var Li=a(Wt);ws=i(Li,"PretrainedConfig"),Li.forEach(o),Ns=i(oo," for more information."),oo.forEach(o),$s=c(R),go=s(R,"P",{});var Si=a(go);Gs=i(Si,"Example:"),Si.forEach(o),xs=c(R),v(Ve.$$.fragment,R),R.forEach(o),Tn=c(t),le=s(t,"H2",{class:!0});var zn=a(le);we=s(zn,"A",{id:!0,class:!0,href:!0});var Oi=a(we);_o=s(Oi,"SPAN",{});var Di=a(_o);v(Ue.$$.fragment,Di),Di.forEach(o),Oi.forEach(o),Ms=c(zn),vo=s(zn,"SPAN",{});var Bi=a(vo);Fs=i(Bi,"GPTNeoModel"),Bi.forEach(o),zn.forEach(o),yn=c(t),q=s(t,"DIV",{class:!0});var X=a(q);v(Je.$$.fragment,X),Cs=c(X),To=s(X,"P",{});var Wi=a(To);Es=i(Wi,"The bare GPT Neo Model transformer outputting raw hidden-states without any specific head on top."),Wi.forEach(o),qs=c(X),Re=s(X,"P",{});var jn=a(Re);zs=i(jn,"This model inherits from "),Ht=s(jn,"A",{href:!0});var Hi=a(Ht);js=i(Hi,"PreTrainedModel"),Hi.forEach(o),As=i(jn,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
