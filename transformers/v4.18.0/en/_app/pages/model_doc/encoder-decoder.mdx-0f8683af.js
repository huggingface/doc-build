import{S as Di,i as xi,s as $i,e as a,k as c,w as f,t as n,M as ji,c as s,d as o,m as l,a as d,x as u,h as r,b as i,F as e,g as h,y as g,q as _,o as v,B as b,v as Fi}from"../../chunks/vendor-6b77c823.js";import{T as dd}from"../../chunks/Tip-39098574.js";import{D as O}from"../../chunks/Docstring-abef54e3.js";import{C as qe}from"../../chunks/CodeBlock-3a8b25a8.js";import{I as Wt}from"../../chunks/IconCopyLink-7a11ce68.js";function Pi(pe){let m,F,y,z,j;return{c(){m=a("p"),F=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),y=a("code"),z=n("Module"),j=n(`
...
the latter silently ignores them.`)},l(k){m=s(k,"P",{});var T=d(m);F=r(T,"Although the recipe for forward pass needs to be defined within this function, one should call the "),y=s(T,"CODE",{});var P=d(y);z=r(P,"Module"),P.forEach(o),j=r(T,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),T.forEach(o)},m(k,T){h(k,m,T),e(m,F),e(m,y),e(y,z),e(m,j)},d(k){k&&o(m)}}}function Si(pe){let m,F,y,z,j,k,T,P,zn,Rt,me,qn,wo,Dn,xn,Gt,he,$n,De,jn,Fn,Ut,fe,Pn,Eo,An,Cn,Ht,V,Sn,Mo,Nn,In,xe,Ln,Bn,Yt,W,On,st,Vn,Wn,dt,Rn,Gn,Jt,$e,Zt,R,Un,je,Hn,Yn,Fe,Jn,Zn,Kt,Q,ue,it,Pe,Kn,ct,Qn,Qt,q,Ae,Xn,ge,zo,er,or,qo,tr,nr,rr,X,ar,Do,sr,dr,xo,ir,cr,lr,lt,pr,mr,Ce,hr,_e,Se,fr,Ne,ur,$o,gr,_r,vr,ve,Ie,br,ee,yr,pt,kr,Tr,mt,wr,Er,Xt,oe,be,ht,Le,Mr,ft,zr,en,w,Be,qr,te,Dr,jo,xr,$r,Fo,jr,Fr,Pr,Oe,Ar,Ve,Cr,Sr,Nr,ut,Ir,Lr,We,Br,Po,Or,Vr,Wr,Re,Rr,Ge,Gr,Ur,Hr,G,Ao,Yr,Jr,gt,Zr,Kr,_t,Qr,Xr,ea,A,Ue,oa,ne,ta,Co,na,ra,vt,aa,sa,da,ye,ia,bt,ca,la,He,pa,C,Ye,ma,yt,ha,fa,re,ua,kt,ga,_a,Tt,va,ba,ya,wt,ka,Ta,Je,on,ae,ke,Et,Ze,wa,Mt,Ea,tn,E,Ke,Ma,se,za,So,qa,Da,No,xa,$a,ja,Qe,Fa,Xe,Pa,Aa,Ca,zt,Sa,Na,eo,Ia,Io,La,Ba,Oa,oo,Va,to,Wa,Ra,Ga,U,Lo,Ua,Ha,Bo,Ya,Ja,Oo,Za,Ka,Qa,S,no,Xa,de,es,Vo,os,ts,qt,ns,rs,as,Te,ss,Dt,ds,is,ro,cs,L,ao,ls,xt,ps,ms,$t,hs,fs,so,nn,ie,we,jt,io,us,Ft,gs,rn,M,co,_s,ce,vs,Wo,bs,ys,Ro,ks,Ts,ws,lo,Es,po,Ms,zs,qs,Pt,Ds,xs,mo,$s,Go,js,Fs,Ps,ho,As,fo,Cs,Ss,Ns,H,Uo,Is,Ls,At,Bs,Os,Ct,Vs,Ws,Rs,N,uo,Gs,le,Us,Ho,Hs,Ys,St,Js,Zs,Ks,Ee,Qs,Nt,Xs,ed,go,od,B,_o,td,It,nd,rd,Lt,ad,sd,vo,an;return k=new Wt({}),$e=new qe({props:{code:`# a workaround to load from pytorch checkpoint
...
<p>Behaves differently depending on whether a <code>config</code> is provided or automatically loaded.`,name:"kwargs"}]}}),vo=new qe({props:{code:`from transformers import FlaxEncoderDecoderModel
...
decoder model configuration.`),vr=c(),ve=a("div"),f(Ie.$$.fragment),br=c(),ee=a("p"),yr=n("Serializes this instance to a Python dictionary. Override the default "),pt=a("em"),kr=n("to_dict()"),Tr=n(" from "),mt=a("em"),wr=n("PretrainedConfig"),Er=n("."),Xt=c(),oe=a("h2"),be=a("a"),ht=a("span"),f(Le.$$.fragment),Mr=c(),ft=a("span"),zr=n("EncoderDecoderModel"),en=c(),w=a("div"),f(Be.$$.fragment),qr=c(),te=a("p"),Dr=n(`This class can be used to initialize a sequence-to-sequence model with any pretrained autoencoding model as the
...
checkpoints.`),rd=c(),Lt=a("p"),ad=n("Example:"),sd=c(),f(vo.$$.fragment),this.h()},l(t){const p=ji('[data-svelte="svelte-1phssyn"]',document.head);m=s(p,"META",{name:!0,content:!0}),p.forEach(o),F=l(t),y=s(t,"H1",{class:!0});var bo=d(y);z=s(bo,"A",{id:!0,class:!0,href:!0});var Bt=d(z);j=s(Bt,"SPAN",{});var Ot=d(j);u(k.$$.fragment,Ot),Ot.forEach(o),Bt.forEach(o),T=l(bo),P=s(bo,"SPAN",{});var id=d(P);zn=r(id,"Encoder Decoder Models"),id.forEach(o),bo.forEach(o),Rt=l(t),me=s(t,"P",{});var sn=d(me);qn=r(sn,"The "),wo=s(sn,"A",{href:!0});var cd=d(wo);Dn=r(cd,"EncoderDecoderModel"),cd.forEach(o),xn=r(sn,` can be used to initialize a sequence-to-sequence model with any
...
Zhou, Wei Li, Peter J. Liu.`),bn.forEach(o),Ca=l(x),zt=s(x,"P",{});var ei=d(zt);Sa=r(ei,`After such an Encoder Decoder model has been trained/fine-tuned, it can be saved/loaded just like any other models
