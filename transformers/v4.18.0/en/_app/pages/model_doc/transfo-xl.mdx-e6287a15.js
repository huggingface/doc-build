...
tensors in the first argument of the model call function: `),U=s(H,"CODE",{});var me=a(U);$e=i(me,"model(inputs)"),me.forEach(t),ge=i(H,"."),H.forEach(t),V=d(h),N=s(h,"P",{});var He=a(N);ne=i(He,`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
...
`),j=s(ye,"CODE",{});var D=a(j);Ee=i(D,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),D.forEach(t),ye.forEach(t),P.forEach(t)},m(h,E){f(h,m,E),e(m,M),f(h,u,E),f(h,g,E),e(g,$),e($,_),e(g,T),e(g,X),e(X,I),f(h,W,E),f(h,x,E),e(x,C),e(x,O),e(O,K),e(x,ae),e(x,U),e(U,$e),e(x,ge),f(h,V,E),f(h,N,E),e(N,ne),f(h,re,E),f(h,F,E),e(F,z),e(z,ie),e(z,Q),e(Q,_e),e(z,le),e(z,B),e(B,xe),e(F,Te),e(F,q),e(q,Xe),e(q,G),e(G,oe),e(q,fe),e(q,Z),e(Z,Me),e(F,he),e(F,A),e(A,ve),e(A,j),e(j,Ee)},d(h){h&&t(m),h&&t(u),h&&t(g),h&&t(W),h&&t(x),h&&t(V),h&&t(N),h&&t(re),h&&t(F)}}}function Wf(R){let m,M,u,g,$;return{c(){m=n("p"),M=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),u=n("code"),g=r("Module"),$=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(_){m=s(_,"P",{});var T=a(m);M=i(T,"Although the recipe for forward pass needs to be defined within this function, one should call the "),u=s(T,"CODE",{});var X=a(u);g=i(X,"Module"),X.forEach(t),$=i(T,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),T.forEach(t)},m(_,T){f(_,m,T),e(m,M),e(m,u),e(u,g),e(m,$)},d(_){_&&t(m)}}}function Uf(R){let m,M,u,g,$,_,T,X,I,W,x,C,O,K,ae,U,$e,ge,V,N,ne,re,F,z,ie,Q,_e,le,B,xe,Te,q,Xe,G,oe,fe,Z,Me,he,A,ve,j,Ee;return{c(){m=n("p"),M=r("TF 2.0 models accepts two formats as inputs:"),u=l(),g=n("ul"),$=n("li"),_=r("having all inputs as keyword arguments (like PyTorch models), or"),T=l(),X=n("li"),I=r("having all inputs as a list, tuple or dict in the first positional arguments."),W=l(),x=n("p"),C=r("This second option is useful when using "),O=n("code"),K=r("tf.keras.Model.fit"),ae=r(` method which currently requires having all the
tensors in the first argument of the model call function: `),U=n("code"),$e=r("model(inputs)"),ge=r("."),V=l(),N=n("p"),ne=r(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),re=l(),F=n("ul"),z=n("li"),ie=r("a single Tensor with "),Q=n("code"),_e=r("input_ids"),le=r(" only and nothing else: "),B=n("code"),xe=r("model(inputs_ids)"),Te=l(),q=n("li"),Xe=r(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),G=n("code"),oe=r("model([input_ids, attention_mask])"),fe=r(" or "),Z=n("code"),Me=r("model([input_ids, attention_mask, token_type_ids])"),he=l(),A=n("li"),ve=r(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),j=n("code"),Ee=r('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(h){m=s(h,"P",{});var E=a(m);M=i(E,"TF 2.0 models accepts two formats as inputs:"),E.forEach(t),u=d(h),g=s(h,"UL",{});var de=a(g);$=s(de,"LI",{});var be=a($);_=i(be,"having all inputs as keyword arguments (like PyTorch models), or"),be.forEach(t),T=d(de),X=s(de,"LI",{});var Ue=a(X);I=i(Ue,"having all inputs as a list, tuple or dict in the first positional arguments."),Ue.forEach(t),de.forEach(t),W=d(h),x=s(h,"P",{});var H=a(x);C=i(H,"This second option is useful when using "),O=s(H,"CODE",{});var Ae=a(O);K=i(Ae,"tf.keras.Model.fit"),Ae.forEach(t),ae=i(H,` method which currently requires having all the
...
first positional argument :`),He.forEach(t),re=d(h),F=s(h,"UL",{});var P=a(F);z=s(P,"LI",{});var S=a(z);ie=i(S,"a single Tensor with "),Q=s(S,"CODE",{});var ze=a(Q);_e=i(ze,"input_ids"),ze.forEach(t),le=i(S," only and nothing else: "),B=s(S,"CODE",{});var we=a(B);xe=i(we,"model(inputs_ids)"),we.forEach(t),S.forEach(t),Te=d(P),q=s(P,"LI",{});var J=a(q);Xe=i(J,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),G=s(J,"CODE",{});var Ce=a(G);oe=i(Ce,"model([input_ids, attention_mask])"),Ce.forEach(t),fe=i(J," or "),Z=s(J,"CODE",{});var Ve=a(Z);Me=i(Ve,"model([input_ids, attention_mask, token_type_ids])"),Ve.forEach(t),J.forEach(t),he=d(P),A=s(P,"LI",{});var ye=a(A);ve=i(ye,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),j=s(ye,"CODE",{});var D=a(j);Ee=i(D,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),D.forEach(t),ye.forEach(t),P.forEach(t)},m(h,E){f(h,m,E),e(m,M),f(h,u,E),f(h,g,E),e(g,$),e($,_),e(g,T),e(g,X),e(X,I),f(h,W,E),f(h,x,E),e(x,C),e(x,O),e(O,K),e(x,ae),e(x,U),e(U,$e),e(x,ge),f(h,V,E),f(h,N,E),e(N,ne),f(h,re,E),f(h,F,E),e(F,z),e(z,ie),e(z,Q),e(Q,_e),e(z,le),e(z,B),e(B,xe),e(F,Te),e(F,q),e(q,Xe),e(q,G),e(G,oe),e(q,fe),e(q,Z),e(Z,Me),e(F,he),e(F,A),e(A,ve),e(A,j),e(j,Ee)},d(h){h&&t(m),h&&t(u),h&&t(g),h&&t(W),h&&t(x),h&&t(V),h&&t(N),h&&t(re),h&&t(F)}}}function Vf(R){let m,M,u,g,$;return{c(){m=n("p"),M=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),u=n("code"),g=r("Module"),$=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(_){m=s(_,"P",{});var T=a(m);M=i(T,"Although the recipe for forward pass needs to be defined within this function, one should call the "),u=s(T,"CODE",{});var X=a(u);g=i(X,"Module"),X.forEach(t),$=i(T,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),T.forEach(t)},m(_,T){f(_,m,T),e(m,M),e(m,u),e(u,g),e(m,$)},d(_){_&&t(m)}}}function Bf(R){let m,M,u,g,$,_,T,X,I,W,x,C,O,K,ae,U,$e,ge,V,N,ne,re,F,z,ie,Q,_e,le,B,xe,Te,q,Xe,G,oe,fe,Z,Me,he,A,ve,j,Ee;return{c(){m=n("p"),M=r("TF 2.0 models accepts two formats as inputs:"),u=l(),g=n("ul"),$=n("li"),_=r("having all inputs as keyword arguments (like PyTorch models), or"),T=l(),X=n("li"),I=r("having all inputs as a list, tuple or dict in the first positional arguments."),W=l(),x=n("p"),C=r("This second option is useful when using "),O=n("code"),K=r("tf.keras.Model.fit"),ae=r(` method which currently requires having all the
tensors in the first argument of the model call function: `),U=n("code"),$e=r("model(inputs)"),ge=r("."),V=l(),N=n("p"),ne=r(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),re=l(),F=n("ul"),z=n("li"),ie=r("a single Tensor with "),Q=n("code"),_e=r("input_ids"),le=r(" only and nothing else: "),B=n("code"),xe=r("model(inputs_ids)"),Te=l(),q=n("li"),Xe=r(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),G=n("code"),oe=r("model([input_ids, attention_mask])"),fe=r(" or "),Z=n("code"),Me=r("model([input_ids, attention_mask, token_type_ids])"),he=l(),A=n("li"),ve=r(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),j=n("code"),Ee=r('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(h){m=s(h,"P",{});var E=a(m);M=i(E,"TF 2.0 models accepts two formats as inputs:"),E.forEach(t),u=d(h),g=s(h,"UL",{});var de=a(g);$=s(de,"LI",{});var be=a($);_=i(be,"having all inputs as keyword arguments (like PyTorch models), or"),be.forEach(t),T=d(de),X=s(de,"LI",{});var Ue=a(X);I=i(Ue,"having all inputs as a list, tuple or dict in the first positional arguments."),Ue.forEach(t),de.forEach(t),W=d(h),x=s(h,"P",{});var H=a(x);C=i(H,"This second option is useful when using "),O=s(H,"CODE",{});var Ae=a(O);K=i(Ae,"tf.keras.Model.fit"),Ae.forEach(t),ae=i(H,` method which currently requires having all the
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/v4.18.0/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),Ht=new it({props:{$$slots:{default:[Uf]},$$scope:{ctx:R}}}),Vo=new te({props:{name:"call",anchor:"transformers.TFTransfoXLLMHeadModel.call",parameters:[{name:"input_ids",val:" = None"},{name:"mems",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"},{name:"labels",val:" = None"},{name:"training",val:" = False"}],source:"https://github.com/huggingface/transformers/blob/v4.18.0/src/transformers/models/transfo_xl/modeling_tf_transfo_xl.py#L961",parametersDescription:[{anchor:"transformers.TFTransfoXLLMHeadModel.call.input_ids",description:`<strong>input_ids</strong> (<code>tf.Tensor</code> or <code>Numpy array</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/v4.18.0/en/model_doc/bert#transformers.BertTokenizer">BertTokenizer</a>. See <a href="/docs/transformers/v4.18.0/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
<a href="/docs/transformers/v4.18.0/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> for details.</p>
...
documentation from `),mn=n("a"),Ja=r("PretrainedConfig"),er=r(" for more information."),tr=l(),Hn=n("p"),or=r("Examples:"),nr=l(),v(Yt.$$.fragment),Ws=l(),dt=n("h2"),Mt=n("a"),Dn=n("span"),v(Qt.$$.fragment),sr=l(),In=n("span"),ar=r("TransfoXLTokenizer"),Us=l(),De=n("div"),v(Zt.$$.fragment),rr=l(),Jt=n("p"),ir=r("Construct a Transformer-XL tokenizer adapted from Vocab class in "),eo=n("a"),lr=r(`the original
...
this superclass for more information regarding those methods.`),pr=l(),un=n("div"),v(oo.$$.fragment),Vs=l(),ct=n("h2"),Et=n("a"),Wn=n("span"),v(no.$$.fragment),ur=l(),Un=n("span"),gr=r("TransfoXL specific outputs"),Bs=l(),ft=n("div"),v(so.$$.fragment),_r=l(),Vn=n("p"),Tr=r("Base class for model\u2019s outputs that may also contain a past key/values (to speed up sequential decoding)."),Rs=l(),ht=n("div"),v(ao.$$.fragment),vr=l(),Bn=n("p"),br=r("Base class for model\u2019s outputs that may also contain a past key/values (to speed up sequential decoding)."),Ks=l(),mt=n("div"),v(ro.$$.fragment),wr=l(),Rn=n("p"),yr=r("Base class for model\u2019s outputs that may also contain a past key/values (to speed up sequential decoding)."),Gs=l(),pt=n("div"),v(io.$$.fragment),Lr=l(),Kn=n("p"),kr=r("Base class for model\u2019s outputs that may also contain a past key/values (to speed up sequential decoding)."),Ys=l(),ut=n("h2"),Ft=n("a"),Gn=n("span"),v(lo.$$.fragment),$r=l(),Yn=n("span"),xr=r("TransfoXLModel"),Qs=l(),Fe=n("div"),v(co.$$.fragment),Xr=l(),Qn=n("p"),Mr=r("The bare Bert Model transformer outputting raw hidden-states without any specific head on top."),Er=l(),fo=n("p"),Fr=r("This model inherits from "),gn=n("a"),qr=r("PreTrainedModel"),zr=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Cr=l(),ho=n("p"),Pr=r("This model is also a PyTorch "),mo=n("a"),jr=r("torch.nn.Module"),Or=r(` subclass.
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Ii=l(),Y=n("div"),v(Mo.$$.fragment),Wi=l(),bt=n("p"),Ui=r("The "),Ln=n("a"),Vi=r("TransfoXLForSequenceClassification"),Bi=r(" forward method, overrides the "),hs=n("code"),Ri=r("__call__"),Ki=r(" special method."),Gi=l(),v(jt.$$.fragment),Yi=l(),ms=n("p"),Qi=r("Example of single-label classification:"),Zi=l(),v(Eo.$$.fragment),Ji=l(),v(Fo.$$.fragment),el=l(),ps=n("p"),tl=r("Example of multi-label classification:"),ol=l(),v(qo.$$.fragment),nl=l(),v(zo.$$.fragment),oa=l(),wt=n("h2"),Ot=n("a"),us=n("span"),v(Co.$$.fragment),sl=l(),gs=n("span"),al=r("TFTransfoXLModel"),na=l(),pe=n("div"),v(Po.$$.fragment),rl=l(),_s=n("p"),il=r("The bare Bert Model transformer outputting raw hidden-states without any specific head on top."),ll=l(),jo=n("p"),dl=r("This model inherits from "),kn=n("a"),cl=r("TFPreTrainedModel"),fl=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
original implementation trains on SQuAD with padding on the left, therefore the padding defaults are set to left.`),Ud.forEach(t),Me=d(ha),he=s(ha,"LI",{});var Vd=a(he);A=i(Vd,"Transformer-XL is one of the few models that has no sequence length limit."),Vd.forEach(t),ha.forEach(t),ve=d(o),j=s(o,"P",{});var zn=a(j);Ee=i(zn,"This model was contributed by "),h=s(zn,"A",{href:!0,rel:!0});var Bd=a(h);E=i(Bd,"thomwolf"),Bd.forEach(t),de=i(zn,". The original code can be found "),be=s(zn,"A",{href:!0,rel:!0});var Rd=a(be);Ue=i(Rd,"here"),Rd.forEach(t),H=i(zn,"."),zn.forEach(t),Ae=d(o),b(me.$$.fragment,o),He=d(o),P=s(o,"H2",{class:!0});var ma=a(P);S=s(ma,"A",{id:!0,class:!0,href:!0});var Kd=a(S);ze=s(Kd,"SPAN",{});var Gd=a(ze);b(we.$$.fragment,Gd),Gd.forEach(t),Kd.forEach(t),J=d(ma),Ce=s(ma,"SPAN",{});var Yd=a(Ce);Ve=i(Yd,"TransfoXLConfig"),Yd.forEach(t),ma.forEach(t),ye=d(o),D=s(o,"DIV",{class:!0});var Ze=a(D);b(Kt.$$.fragment,Ze),Da=d(Ze),Ye=s(Ze,"P",{});var Bt=a(Ye);Ia=i(Bt,"This is the configuration class to store the configuration of a "),cn=s(Bt,"A",{href:!0});var Qd=a(cn);Wa=i(Qd,"TransfoXLModel"),Qd.forEach(t),Ua=i(Bt," or a "),fn=s(Bt,"A",{href:!0});var Zd=a(fn);Va=i(Zd,"TFTransfoXLModel"),Zd.forEach(t),Ba=i(Bt,`. It is
used to instantiate a Transformer-XL model according to the specified arguments, defining the model architecture.
...
documentation from `),mn=s(Cn,"A",{href:!0});var tc=a(mn);Ja=i(tc,"PretrainedConfig"),tc.forEach(t),er=i(Cn," for more information."),Cn.forEach(t),tr=d(Ze),Hn=s(Ze,"P",{});var oc=a(Hn);or=i(oc,"Examples:"),oc.forEach(t),nr=d(Ze),b(Yt.$$.fragment,Ze),Ze.forEach(t),Ws=d(o),dt=s(o,"H2",{class:!0});var pa=a(dt);Mt=s(pa,"A",{id:!0,class:!0,href:!0});var nc=a(Mt);Dn=s(nc,"SPAN",{});var sc=a(Dn);b(Qt.$$.fragment,sc),sc.forEach(t),nc.forEach(t),sr=d(pa),In=s(pa,"SPAN",{});var ac=a(In);ar=i(ac,"TransfoXLTokenizer"),ac.forEach(t),pa.forEach(t),Us=d(o),De=s(o,"DIV",{class:!0});var Rt=a(De);b(Zt.$$.fragment,Rt),rr=d(Rt),Jt=s(Rt,"P",{});var ua=a(Jt);ir=i(ua,"Construct a Transformer-XL tokenizer adapted from Vocab class in "),eo=s(ua,"A",{href:!0,rel:!0});var rc=a(eo);lr=i(rc,`the original
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Fa.forEach(t),Ii=d(Ne),Y=s(Ne,"DIV",{class:!0});var ce=a(Y);b(Mo.$$.fragment,ce),Wi=d(ce),bt=s(ce,"P",{});var On=a(bt);Ui=i(On,"The "),Ln=s(On,"A",{href:!0});var Vc=a(Ln);Vi=i(Vc,"TransfoXLForSequenceClassification"),Vc.forEach(t),Bi=i(On," forward method, overrides the "),hs=s(On,"CODE",{});var Bc=a(hs);Ri=i(Bc,"__call__"),Bc.forEach(t),Ki=i(On," special method."),On.forEach(t),Gi=d(ce),b(jt.$$.fragment,ce),Yi=d(ce),ms=s(ce,"P",{});var Rc=a(ms);Qi=i(Rc,"Example of single-label classification:"),Rc.forEach(t),Zi=d(ce),b(Eo.$$.fragment,ce),Ji=d(ce),b(Fo.$$.fragment,ce),el=d(ce),ps=s(ce,"P",{});var Kc=a(ps);tl=i(Kc,"Example of multi-label classification:"),Kc.forEach(t),ol=d(ce),b(qo.$$.fragment,ce),nl=d(ce),b(zo.$$.fragment,ce),ce.forEach(t),Ne.forEach(t),oa=d(o),wt=s(o,"H2",{class:!0});var qa=a(wt);Ot=s(qa,"A",{id:!0,class:!0,href:!0});var Gc=a(Ot);us=s(Gc,"SPAN",{});var Yc=a(us);b(Co.$$.fragment,Yc),Yc.forEach(t),Gc.forEach(t),sl=d(qa),gs=s(qa,"SPAN",{});var Qc=a(gs);al=i(Qc,"TFTransfoXLModel"),Qc.forEach(t),qa.forEach(t),na=d(o),pe=s(o,"DIV",{class:!0});var Be=a(pe);b(Po.$$.fragment,Be),rl=d(Be),_s=s(Be,"P",{});var Zc=a(_s);il=i(Zc,"The bare Bert Model transformer outputting raw hidden-states without any specific head on top."),Zc.forEach(t),ll=d(Be),jo=s(Be,"P",{});var za=a(jo);dl=i(za,"This model inherits from "),kn=s(za,"A",{href:!0});var Jc=a(kn);cl=i(Jc,"TFPreTrainedModel"),Jc.forEach(t),fl=i(za,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),za.forEach(t),hl=d(Be),Oo=s(Be,"P",{});var Ca=a(Oo);ml=i(Ca,"This model is also a "),So=s(Ca,"A",{href:!0,rel:!0});var ef=a(So);pl=i(ef,"tf.keras.Model"),ef.forEach(t),ul=i(Ca,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
