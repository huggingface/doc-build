import{S as td,i as od,s as nd,e as n,k as d,w as _,t as r,M as sd,c as s,d as o,m as c,a,x as v,h as i,b as l,F as e,g as u,y as T,q as y,o as b,B as k,v as ad}from"../../chunks/vendor-6b77c823.js";import{T as dn}from"../../chunks/Tip-39098574.js";import{D as U}from"../../chunks/Docstring-17b815d9.js";import{C as oe}from"../../chunks/CodeBlock-3a8b25a8.js";import{I as ve}from"../../chunks/IconCopyLink-7a11ce68.js";function rd(W){let p,N,m,P,w;return{c(){p=n("p"),N=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),m=n("code"),P=r("Module"),w=r(`
...
the latter silently ignores them.`)},l(g){p=s(g,"P",{});var f=a(p);N=i(f,"Although the recipe for forward pass needs to be defined within this function, one should call the "),m=s(f,"CODE",{});var x=a(m);P=i(x,"Module"),x.forEach(o),w=i(f,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),f.forEach(o)},m(g,f){u(g,p,f),e(p,N),e(p,m),e(m,P),e(p,w)},d(g){g&&o(p)}}}function pd(W){let p,N,m,P,w,g,f,x,Xn,cn,ne,Te,lo,Ae,Kn,co,Qn,pn,J,Yn,Ie,Zn,es,Le,ts,os,hn,Ot,ns,un,ye,ss,Se,as,rs,mn,se,be,po,Oe,is,ho,ls,fn,ke,ds,uo,cs,ps,gn,De,_n,ae,Pe,mo,Be,hs,fo,us,vn,E,We,ms,re,fs,Dt,gs,_s,He,vs,Ts,ys,ie,bs,Bt,ks,Ps,Wt,ws,Ns,$s,go,xs,Gs,Ve,Tn,le,we,_o,Ue,Ms,vo,Fs,yn,q,Je,Cs,To,Es,qs,Re,zs,Ht,js,As,Is,Xe,Ls,Ke,Ss,Os,Ds,j,Qe,Bs,de,Ws,Vt,Hs,Vs,yo,Us,Js,Rs,Ne,Xs,bo,Ks,Qs,Ye,bn,ce,$e,ko,Ze,Ys,Po,Zs,kn,z,et,ea,wo,ta,oa,tt,na,Ut,sa,aa,ra,ot,ia,nt,la,da,ca,A,st,pa,pe,ha,Jt,ua,ma,No,fa,ga,_a,xe,va,$o,Ta,ya,at,Pn,he,Ge,xo,rt,ba,Go,ka,wn,G,it,Pa,Mo,wa,Na,Rt,Xt,$a,xa,Ga,B,Ma,Fo,Fa,Ca,Co,Ea,qa,Eo,za,ja,qo,Aa,Ia,La,lt,Sa,Kt,Oa,Da,Ba,dt,Wa,ct,Ha,Va,Ua,$,pt,Ja,ue,Ra,Qt,Xa,Ka,zo,Qa,Ya,Za,Me,er,jo,tr,or,ht,nr,ut,sr,Ao,ar,rr,mt,ir,ft,Nn,me,Fe,Io,gt,lr,Lo,dr,$n,M,_t,cr,So,pr,hr,vt,ur,Yt,mr,fr,gr,Tt,_r,yt,vr,Tr,yr,Oo,br,kr,H,Do,bt,Pr,wr,Bo,kt,Nr,$r,Wo,Pt,xr,Gr,Ho,wt,Mr,Fr,I,Nt,Cr,fe,Er,Vo,qr,zr,Uo,jr,Ar,Ir,Ce,Lr,Jo,Sr,Or,$t,xn,ge,Ee,Ro,xt,Dr,Xo,Br,Gn,F,Gt,Wr,Ko,Hr,Vr,Mt,Ur,Zt,Jr,Rr,Xr,Ft,Kr,Ct,Qr,Yr,Zr,Qo,ei,ti,V,Yo,Et,oi,ni,Zo,qt,si,ai,en,zt,ri,ii,tn,jt,li,di,L,At,ci,_e,pi,on,hi,ui,nn,mi,fi,gi,qe,_i,sn,vi,Ti,It,Mn;return g=new ve({}),Ae=new ve({}),Oe=new ve({}),De=new oe({props:{code:`from transformers import GPTNeoForCausalLM, GPT2Tokenizer
...
relevant if <code>config.is_decoder=True</code>.`,name:"use_cache"}],source:"https://github.com/huggingface/transformers/blob/v4.18.0/src/transformers/models/gpt_neo/configuration_gpt_neo.py#L34"}}),Ve=new oe({props:{code:`from transformers import GPTNeoModel, GPTNeoConfig
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),Ze=new ve({}),et=new U({props:{name:"class transformers.GPTNeoForCausalLM",anchor:"transformers.GPTNeoForCausalLM",parameters:[{name:"config",val:""}],parametersDescription:[{anchor:"transformers.GPTNeoForCausalLM.config",description:`<strong>config</strong> (<a href="/docs/transformers/v4.18.0/en/model_doc/gpt_neo#transformers.GPTNeoConfig">GPTNeoConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/v4.18.0/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/v4.18.0/src/transformers/models/gpt_neo/modeling_gpt_neo.py#L662"}}),st=new U({props:{name:"forward",anchor:"transformers.GPTNeoForCausalLM.forward",parameters:[{name:"input_ids",val:": typing.Optional[torch.Tensor] = None"},{name:"past_key_values",val:": typing.Optional[typing.Tuple[torch.FloatTensor]] = None"},{name:"attention_mask",val:": typing.Optional[torch.Tensor] = None"},{name:"token_type_ids",val:": typing.Optional[torch.Tensor] = None"},{name:"position_ids",val:": typing.Optional[torch.Tensor] = None"},{name:"head_mask",val:": typing.Optional[torch.Tensor] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.Tensor] = None"},{name:"labels",val:": typing.Optional[torch.Tensor] = None"},{name:"use_cache",val:": typing.Optional[bool] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.GPTNeoForCausalLM.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, input_ids_length)</code>) &#x2014;
<code>input_ids_length</code> = <code>sequence_length</code> if <code>past_key_values</code> is <code>None</code> else
<code>past_key_values[0][0].shape[-2]</code> (<code>sequence_length</code> of input past key value states). Indices of input
sequence tokens in the vocabulary.</p>
<p>If <code>past_key_values</code> is used, only <code>input_ids</code> that do not have their past calculated should be passed as
...
are ignored (masked), the loss is only computed for labels in <code>[0, ..., config.vocab_size]</code>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.18.0/src/transformers/models/gpt_neo/modeling_gpt_neo.py#L712",returnDescription:`
<p>A <a
...
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.18.0/src/transformers/models/gpt_neo/modeling_gpt_neo.py#L827",returnDescription:`
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),xt=new ve({}),Gt=new U({props:{name:"class transformers.FlaxGPTNeoForCausalLM",anchor:"transformers.FlaxGPTNeoForCausalLM",parameters:[{name:"config",val:": GPTNeoConfig"},{name:"input_shape",val:": typing.Tuple = (1, 1)"},{name:"seed",val:": int = 0"},{name:"dtype",val:": dtype = <class 'jax._src.numpy.lax_numpy.float32'>"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.FlaxGPTNeoForCausalLM.config",description:`<strong>config</strong> (<a href="/docs/transformers/v4.18.0/en/model_doc/gpt_neo#transformers.GPTNeoConfig">GPTNeoConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
...
256 tokens.`),un=d(),ye=n("p"),ss=r("This model was contributed by "),Se=n("a"),as=r("valhalla"),rs=r("."),mn=d(),se=n("h3"),be=n("a"),po=n("span"),_(Oe.$$.fragment),is=d(),ho=n("span"),ls=r("Generation"),fn=d(),ke=n("p"),ds=r("The "),uo=n("code"),cs=r("generate()"),ps=r(" method can be used to generate text using GPT Neo model."),gn=d(),_(De.$$.fragment),_n=d(),ae=n("h2"),Pe=n("a"),mo=n("span"),_(Be.$$.fragment),hs=d(),fo=n("span"),us=r("GPTNeoConfig"),vn=d(),E=n("div"),_(We.$$.fragment),ms=d(),re=n("p"),fs=r("This is the configuration class to store the configuration of a "),Dt=n("a"),gs=r("GPTNeoModel"),_s=r(`. It is used to instantiate a GPT
...
`),He=n("a"),vs=r("gpt-neo-1.3B"),Ts=r(" architecture."),ys=d(),ie=n("p"),bs=r("Configuration objects inherit from "),Bt=n("a"),ks=r("PretrainedConfig"),Ps=r(` and can be used to control the model outputs. Read the
documentation from `),Wt=n("a"),ws=r("PretrainedConfig"),Ns=r(" for more information."),$s=d(),go=n("p"),xs=r("Example:"),Gs=d(),_(Ve.$$.fragment),Tn=d(),le=n("h2"),we=n("a"),_o=n("span"),_(Ue.$$.fragment),Ms=d(),vo=n("span"),Fs=r("GPTNeoModel"),yn=d(),q=n("div"),_(Je.$$.fragment),Cs=d(),To=n("p"),Es=r("The bare GPT Neo Model transformer outputting raw hidden-states without any specific head on top."),qs=d(),Re=n("p"),zs=r("This model inherits from "),Ht=n("a"),js=r("PreTrainedModel"),As=r(`. Check the superclass documentation for the generic methods the
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),ca=d(),A=n("div"),_(st.$$.fragment),pa=d(),pe=n("p"),ha=r("The "),Jt=n("a"),ua=r("GPTNeoForCausalLM"),ma=r(" forward method, overrides the "),No=n("code"),fa=r("__call__"),ga=r(" special method."),_a=d(),_(xe.$$.fragment),va=d(),$o=n("p"),Ta=r("Example:"),ya=d(),_(at.$$.fragment),Pn=d(),he=n("h2"),Ge=n("a"),xo=n("span"),_(rt.$$.fragment),ba=d(),Go=n("span"),ka=r("GPTNeoForSequenceClassification"),wn=d(),G=n("div"),_(it.$$.fragment),Pa=d(),Mo=n("p"),wa=r("The GPTNeo Model transformer with a sequence classification head on top (linear layer)."),Na=d(),Rt=n("p"),Xt=n("a"),$a=r("GPTNeoForSequenceClassification"),xa=r(` uses the last token in order to do the classification, as other causal models
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Ua=d(),$=n("div"),_(pt.$$.fragment),Ja=d(),ue=n("p"),Ra=r("The "),Qt=n("a"),Xa=r("GPTNeoForSequenceClassification"),Ka=r(" forward method, overrides the "),zo=n("code"),Qa=r("__call__"),Ya=r(" special method."),Za=d(),_(Me.$$.fragment),er=d(),jo=n("p"),tr=r("Example of single-label classification:"),or=d(),_(ht.$$.fragment),nr=d(),_(ut.$$.fragment),sr=d(),Ao=n("p"),ar=r("Example of multi-label classification:"),rr=d(),_(mt.$$.fragment),ir=d(),_(ft.$$.fragment),Nn=d(),me=n("h2"),Fe=n("a"),Io=n("span"),_(gt.$$.fragment),lr=d(),Lo=n("span"),dr=r("FlaxGPTNeoModel"),$n=d(),M=n("div"),_(_t.$$.fragment),cr=d(),So=n("p"),pr=r("The bare GPTNeo Model transformer outputting raw hidden-states without any specific head on top."),hr=d(),vt=n("p"),ur=r("This model inherits from "),Yt=n("a"),mr=r("FlaxPreTrainedModel"),fr=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),gr=d(),Tt=n("p"),_r=r(`This model is also a Flax Linen
`),yt=n("a"),vr=r("flax.nn.Module"),Tr=r(` subclass. Use it as a
...
256 tokens.`),$i.forEach(o),un=c(t),ye=s(t,"P",{});var Fn=a(ye);ss=i(Fn,"This model was contributed by "),Se=s(Fn,"A",{href:!0,rel:!0});var xi=a(Se);as=i(xi,"valhalla"),xi.forEach(o),rs=i(Fn,"."),Fn.forEach(o),mn=c(t),se=s(t,"H3",{class:!0});var Cn=a(se);be=s(Cn,"A",{id:!0,class:!0,href:!0});var Gi=a(be);po=s(Gi,"SPAN",{});var Mi=a(po);v(Oe.$$.fragment,Mi),Mi.forEach(o),Gi.forEach(o),is=c(Cn),ho=s(Cn,"SPAN",{});var Fi=a(ho);ls=i(Fi,"Generation"),Fi.forEach(o),Cn.forEach(o),fn=c(t),ke=s(t,"P",{});var En=a(ke);ds=i(En,"The "),uo=s(En,"CODE",{});var Ci=a(uo);cs=i(Ci,"generate()"),Ci.forEach(o),ps=i(En," method can be used to generate text using GPT Neo model."),En.forEach(o),gn=c(t),v(De.$$.fragment,t),_n=c(t),ae=s(t,"H2",{class:!0});var qn=a(ae);Pe=s(qn,"A",{id:!0,class:!0,href:!0});var Ei=a(Pe);mo=s(Ei,"SPAN",{});var qi=a(mo);v(Be.$$.fragment,qi),qi.forEach(o),Ei.forEach(o),hs=c(qn),fo=s(qn,"SPAN",{});var zi=a(fo);us=i(zi,"GPTNeoConfig"),zi.forEach(o),qn.forEach(o),vn=c(t),E=s(t,"DIV",{class:!0});var R=a(E);v(We.$$.fragment,R),ms=c(R),re=s(R,"P",{});var to=a(re);fs=i(to,"This is the configuration class to store the configuration of a "),Dt=s(to,"A",{href:!0});var ji=a(Dt);gs=i(ji,"GPTNeoModel"),ji.forEach(o),_s=i(to,`. It is used to instantiate a GPT
Neo model according to the specified arguments, defining the model architecture. Instantiating a configuration with
the defaults will yield a similar configuration to that of the GPTNeo
`),He=s(to,"A",{href:!0,rel:!0});var Ai=a(He);vs=i(Ai,"gpt-neo-1.3B"),Ai.forEach(o),Ts=i(to," architecture."),to.forEach(o),ys=c(R),ie=s(R,"P",{});var oo=a(ie);bs=i(oo,"Configuration objects inherit from "),Bt=s(oo,"A",{href:!0});var Ii=a(Bt);ks=i(Ii,"PretrainedConfig"),Ii.forEach(o),Ps=i(oo,` and can be used to control the model outputs. Read the
documentation from `),Wt=s(oo,"A",{href:!0});var Li=a(Wt);ws=i(Li,"PretrainedConfig"),Li.forEach(o),Ns=i(oo," for more information."),oo.forEach(o),$s=c(R),go=s(R,"P",{});var Si=a(go);xs=i(Si,"Example:"),Si.forEach(o),Gs=c(R),v(Ve.$$.fragment,R),R.forEach(o),Tn=c(t),le=s(t,"H2",{class:!0});var zn=a(le);we=s(zn,"A",{id:!0,class:!0,href:!0});var Oi=a(we);_o=s(Oi,"SPAN",{});var Di=a(_o);v(Ue.$$.fragment,Di),Di.forEach(o),Oi.forEach(o),Ms=c(zn),vo=s(zn,"SPAN",{});var Bi=a(vo);Fs=i(Bi,"GPTNeoModel"),Bi.forEach(o),zn.forEach(o),yn=c(t),q=s(t,"DIV",{class:!0});var X=a(q);v(Je.$$.fragment,X),Cs=c(X),To=s(X,"P",{});var Wi=a(To);Es=i(Wi,"The bare GPT Neo Model transformer outputting raw hidden-states without any specific head on top."),Wi.forEach(o),qs=c(X),Re=s(X,"P",{});var jn=a(Re);zs=i(jn,"This model inherits from "),Ht=s(jn,"A",{href:!0});var Hi=a(Ht);js=i(Hi,"PreTrainedModel"),Hi.forEach(o),As=i(jn,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),An.forEach(o),Ds=c(X),j=s(X,"DIV",{class:!0});var K=a(j);v(Qe.$$.fragment,K),Bs=c(K),de=s(K,"P",{});var no=a(de);Ws=i(no,"The "),Vt=s(no,"A",{href:!0});var Ui=a(Vt);Hs=i(Ui,"GPTNeoModel"),Ui.forEach(o),Vs=i(no," forward method, overrides the "),yo=s(no,"CODE",{});var Ji=a(yo);Us=i(Ji,"__call__"),Ji.forEach(o),Js=i(no," special method."),no.forEach(o),Rs=c(K),v(Ne.$$.fragment,K),Xs=c(K),bo=s(K,"P",{});var Ri=a(bo);Ks=i(Ri,"Example:"),Ri.forEach(o),Qs=c(K),v(Ye.$$.fragment,K),K.forEach(o),X.forEach(o),bn=c(t),ce=s(t,"H2",{class:!0});var In=a(ce);$e=s(In,"A",{id:!0,class:!0,href:!0});var Xi=a($e);ko=s(Xi,"SPAN",{});var Ki=a(ko);v(Ze.$$.fragment,Ki),Ki.forEach(o),Xi.forEach(o),Ys=c(In),Po=s(In,"SPAN",{});var Qi=a(Po);Zs=i(Qi,"GPTNeoForCausalLM"),Qi.forEach(o),In.forEach(o),kn=c(t),z=s(t,"DIV",{class:!0});var Q=a(z);v(et.$$.fragment,Q),ea=c(Q),wo=s(Q,"P",{});var Yi=a(wo);ta=i(Yi,`The GPT Neo Model transformer with a language modeling head on top (linear layer with weights tied to the input
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Sn.forEach(o),ca=c(Q),A=s(Q,"DIV",{class:!0});var Y=a(A);v(st.$$.fragment,Y),pa=c(Y),pe=s(Y,"P",{});var so=a(pe);ha=i(so,"The "),Jt=s(so,"A",{href:!0});var tl=a(Jt);ua=i(tl,"GPTNeoForCausalLM"),tl.forEach(o),ma=i(so," forward method, overrides the "),No=s(so,"CODE",{});var ol=a(No);fa=i(ol,"__call__"),ol.forEach(o),ga=i(so," special method."),so.forEach(o),_a=c(Y),v(xe.$$.fragment,Y),va=c(Y),$o=s(Y,"P",{});var nl=a($o);Ta=i(nl,"Example:"),nl.forEach(o),ya=c(Y),v(at.$$.fragment,Y),Y.forEach(o),Q.forEach(o),Pn=c(t),he=s(t,"H2",{class:!0});var On=a(he);Ge=s(On,"A",{id:!0,class:!0,href:!0});var sl=a(Ge);xo=s(sl,"SPAN",{});var al=a(xo);v(rt.$$.fragment,al),al.forEach(o),sl.forEach(o),ba=c(On),Go=s(On,"SPAN",{});var rl=a(Go);ka=i(rl,"GPTNeoForSequenceClassification"),rl.forEach(o),On.forEach(o),wn=c(t),G=s(t,"DIV",{class:!0});var S=a(G);v(it.$$.fragment,S),Pa=c(S),Mo=s(S,"P",{});var il=a(Mo);wa=i(il,"The GPTNeo Model transformer with a sequence classification head on top (linear layer)."),il.forEach(o),Na=c(S),Rt=s(S,"P",{});var yi=a(Rt);Xt=s(yi,"A",{href:!0});var ll=a(Xt);$a=i(ll,"GPTNeoForSequenceClassification"),ll.forEach(o),xa=i(yi,` uses the last token in order to do the classification, as other causal models
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Bn.forEach(o),Ua=c(S),$=s(S,"DIV",{class:!0});var C=a($);v(pt.$$.fragment,C),Ja=c(C),ue=s(C,"P",{});var ao=a(ue);Ra=i(ao,"The "),Qt=s(ao,"A",{href:!0});var fl=a(Qt);Xa=i(fl,"GPTNeoForSequenceClassification"),fl.forEach(o),Ka=i(ao," forward method, overrides the "),zo=s(ao,"CODE",{});var gl=a(zo);Qa=i(gl,"__call__"),gl.forEach(o),Ya=i(ao," special method."),ao.forEach(o),Za=c(C),v(Me.$$.fragment,C),er=c(C),jo=s(C,"P",{});var _l=a(jo);tr=i(_l,"Example of single-label classification:"),_l.forEach(o),or=c(C),v(ht.$$.fragment,C),nr=c(C),v(ut.$$.fragment,C),sr=c(C),Ao=s(C,"P",{});var vl=a(Ao);ar=i(vl,"Example of multi-label classification:"),vl.forEach(o),rr=c(C),v(mt.$$.fragment,C),ir=c(C),v(ft.$$.fragment,C),C.forEach(o),S.forEach(o),Nn=c(t),me=s(t,"H2",{class:!0});var Wn=a(me);Fe=s(Wn,"A",{id:!0,class:!0,href:!0});var Tl=a(Fe);Io=s(Tl,"SPAN",{});var yl=a(Io);v(gt.$$.fragment,yl),yl.forEach(o),Tl.forEach(o),lr=c(Wn),Lo=s(Wn,"SPAN",{});var bl=a(Lo);dr=i(bl,"FlaxGPTNeoModel"),bl.forEach(o),Wn.forEach(o),$n=c(t),M=s(t,"DIV",{class:!0});var O=a(M);v(_t.$$.fragment,O),cr=c(O),So=s(O,"P",{});var kl=a(So);pr=i(kl,"The bare GPTNeo Model transformer outputting raw hidden-states without any specific head on top."),kl.forEach(o),hr=c(O),vt=s(O,"P",{});var Hn=a(vt);ur=i(Hn,"This model inherits from "),Yt=s(Hn,"A",{href:!0});var Pl=a(Yt);mr=i(Pl,"FlaxPreTrainedModel"),Pl.forEach(o),fr=i(Hn,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Hn.forEach(o),gr=c(O),Tt=s(O,"P",{});var Vn=a(Tt);_r=i(Vn,`This model is also a Flax Linen
`),yt=s(Vn,"A",{href:!0,rel:!0});var wl=a(yt);vr=i(wl,"flax.nn.Module"),wl.forEach(o),Tr=i(Vn,` subclass. Use it as a
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),Vn.forEach(o),yr=c(O),Oo=s(O,"P",{});var Nl=a(Oo);br=i(Nl,"Finally, this model supports inherent JAX features such as:"),Nl.forEach(o),kr=c(O),H=s(O,"UL",{});var ze=a(H);Do=s(ze,"LI",{});var $l=a(Do);bt=s($l,"A",{href:!0,rel:!0});var xl=a(bt);Pr=i(xl,"Just-In-Time (JIT) compilation"),xl.forEach(o),$l.forEach(o),wr=c(ze),Bo=s(ze,"LI",{});var Gl=a(Bo);kt=s(Gl,"A",{href:!0,rel:!0});var Ml=a(kt);Nr=i(Ml,"Automatic Differentiation"),Ml.forEach(o),Gl.forEach(o),$r=c(ze),Wo=s(ze,"LI",{});var Fl=a(Wo);Pt=s(Fl,"A",{href:!0,rel:!0});var Cl=a(Pt);xr=i(Cl,"Vectorization"),Cl.forEach(o),Fl.forEach(o),Gr=c(ze),Ho=s(ze,"LI",{});var El=a(Ho);wt=s(El,"A",{href:!0,rel:!0});var ql=a(wt);Mr=i(ql,"Parallelization"),ql.forEach(o),El.forEach(o),ze.forEach(o),Fr=c(O),I=s(O,"DIV",{class:!0});var ee=a(I);v(Nt.$$.fragment,ee),Cr=c(ee),fe=s(ee,"P",{});var ro=a(fe);Er=i(ro,"The "),Vo=s(ro,"CODE",{});var zl=a(Vo);qr=i(zl,"FlaxGPTNeoPreTrainedModel"),zl.forEach(o),zr=i(ro," forward method, overrides the "),Uo=s(ro,"CODE",{});var jl=a(Uo);jr=i(jl,"__call__"),jl.forEach(o),Ar=i(ro," special method."),ro.forEach(o),Ir=c(ee),v(Ce.$$.fragment,ee),Lr=c(ee),Jo=s(ee,"P",{});var Al=a(Jo);Sr=i(Al,"Example:"),Al.forEach(o),Or=c(ee),v($t.$$.fragment,ee),ee.forEach(o),O.forEach(o),xn=c(t),ge=s(t,"H2",{class:!0});var Un=a(ge);Ee=s(Un,"A",{id:!0,class:!0,href:!0});var Il=a(Ee);Ro=s(Il,"SPAN",{});var Ll=a(Ro);v(xt.$$.fragment,Ll),Ll.forEach(o),Il.forEach(o),Dr=c(Un),Xo=s(Un,"SPAN",{});var Sl=a(Xo);Br=i(Sl,"FlaxGPTNeoForCausalLM"),Sl.forEach(o),Un.forEach(o),Gn=c(t),F=s(t,"DIV",{class:!0});var D=a(F);v(Gt.$$.fragment,D),Wr=c(D),Ko=s(D,"P",{});var Ol=a(Ko);Hr=i(Ol,`The GPTNeo Model transformer with a language modeling head on top (linear layer with weights tied to the input
