import{S as Cf,i as Of,s as Pf,e as n,k as i,w as f,t as r,M as Af,c as s,d as t,m as l,a,x as _,h as d,b as c,F as e,g as h,y as g,q as v,o as b,B as T,v as Nf}from"../../chunks/vendor-6b77c823.js";import{T as go}from"../../chunks/Tip-39098574.js";import{D as F}from"../../chunks/Docstring-17b815d9.js";import{C as Ne}from"../../chunks/CodeBlock-3a8b25a8.js";import{I as _e}from"../../chunks/IconCopyLink-7a11ce68.js";function jf(G){let u,L,k,E,q;return{c(){u=n("p"),L=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),k=n("code"),E=r("Module"),q=r(`
...
first positional argument :`),Le=i(),S=n("ul"),P=n("li"),ve=r("a single Tensor with "),ae=n("code"),Se=r("input_ids"),be=r(" only and nothing else: "),X=n("code"),Be=r("model(input_ids)"),Ce=i(),C=n("li"),Qe=r(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
...
`),re=s(Ve,"CODE",{});var Re=a(re);De=d(Re,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),Re.forEach(t),Ve.forEach(t),J.forEach(t)},m(m,$){h(m,u,$),e(u,L),h(m,k,$),h(m,E,$),e(E,q),e(q,y),e(E,w),e(E,D),e(D,je),h(m,ge,$),h(m,z,$),e(z,Y),e(z,V),e(V,ne),e(z,Ie),e(z,R),e(R,Ge),e(z,Me),h(m,B,$),h(m,K,$),e(K,se),h(m,Le,$),h(m,S,$),e(S,P),e(P,ve),e(P,ae),e(ae,Se),e(P,be),e(P,X),e(X,Be),e(S,Ce),e(S,C),e(C,Qe),e(C,ee),e(ee,x),e(C,M),e(C,Q),e(Q,He),e(S,We),e(S,j),e(j,Ue),e(j,re),e(re,De)},d(m){m&&t(u),m&&t(k),m&&t(E),m&&t(ge),m&&t(z),m&&t(B),m&&t(K),m&&t(Le),m&&t(S)}}}function Hf(G){let u,L,k,E,q;return{c(){u=n("p"),L=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),k=n("code"),E=r("Module"),q=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(y){u=s(y,"P",{});var w=a(u);L=d(w,"Although the recipe for forward pass needs to be defined within this function, one should call the "),k=s(w,"CODE",{});var D=a(k);E=d(D,"Module"),D.forEach(t),q=d(w,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),w.forEach(t)},m(y,w){h(y,u,w),e(u,L),e(u,k),e(k,E),e(u,q)},d(y){y&&t(u)}}}function Wf(G){let u,L,k,E,q,y,w,D,je,ge,z,Y,V,ne,Ie,R,Ge,Me,B,K,se,Le,S,P,ve,ae,Se,be,X,Be,Ce,C,Qe,ee,x,M,Q,He,We,j,Ue,re,De;return{c(){u=n("p"),L=r("TF 2.0 models accepts two formats as inputs:"),k=i(),E=n("ul"),q=n("li"),y=r("having all inputs as keyword arguments (like PyTorch models), or"),w=i(),D=n("li"),je=r("having all inputs as a list, tuple or dict in the first positional arguments."),ge=i(),z=n("p"),Y=r("This second option is useful when using "),V=n("code"),ne=r("tf.keras.Model.fit"),Ie=r(` method which currently requires having all the
tensors in the first argument of the model call function: `),R=n("code"),Ge=r("model(inputs)"),Me=r("."),B=i(),K=n("p"),se=r(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),Le=i(),S=n("ul"),P=n("li"),ve=r("a single Tensor with "),ae=n("code"),Se=r("input_ids"),be=r(" only and nothing else: "),X=n("code"),Be=r("model(input_ids)"),Ce=i(),C=n("li"),Qe=r(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),ee=n("code"),x=r("model([input_ids, attention_mask])"),M=r(" or "),Q=n("code"),He=r("model([input_ids, attention_mask, token_type_ids])"),We=i(),j=n("li"),Ue=r(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),re=n("code"),De=r('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(m){u=s(m,"P",{});var $=a(u);L=d($,"TF 2.0 models accepts two formats as inputs:"),$.forEach(t),k=l(m),E=s(m,"UL",{});var de=a(E);q=s(de,"LI",{});var st=a(q);y=d(st,"having all inputs as keyword arguments (like PyTorch models), or"),st.forEach(t),w=l(de),D=s(de,"LI",{});var at=a(D);je=d(at,"having all inputs as a list, tuple or dict in the first positional arguments."),at.forEach(t),de.forEach(t),ge=l(m),z=s(m,"P",{});var I=a(z);Y=d(I,"This second option is useful when using "),V=s(I,"CODE",{});var rt=a(V);ne=d(rt,"tf.keras.Model.fit"),rt.forEach(t),Ie=d(I,` method which currently requires having all the
...
first positional argument :`),Oe.forEach(t),Le=l(m),S=s(m,"UL",{});var J=a(S);P=s(J,"LI",{});var ie=a(P);ve=d(ie,"a single Tensor with "),ae=s(ie,"CODE",{});var Pe=a(ae);Se=d(Pe,"input_ids"),Pe.forEach(t),be=d(ie," only and nothing else: "),X=s(ie,"CODE",{});var it=a(X);Be=d(it,"model(input_ids)"),it.forEach(t),ie.forEach(t),Ce=l(J),C=s(J,"LI",{});var le=a(C);Qe=d(le,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),ee=s(le,"CODE",{});var lt=a(ee);x=d(lt,"model([input_ids, attention_mask])"),lt.forEach(t),M=d(le," or "),Q=s(le,"CODE",{});var ce=a(Q);He=d(ce,"model([input_ids, attention_mask, token_type_ids])"),ce.forEach(t),le.forEach(t),We=l(J),j=s(J,"LI",{});var Ve=a(j);Ue=d(Ve,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),re=s(Ve,"CODE",{});var Re=a(re);De=d(Re,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),Re.forEach(t),Ve.forEach(t),J.forEach(t)},m(m,$){h(m,u,$),e(u,L),h(m,k,$),h(m,E,$),e(E,q),e(q,y),e(E,w),e(E,D),e(D,je),h(m,ge,$),h(m,z,$),e(z,Y),e(z,V),e(V,ne),e(z,Ie),e(z,R),e(R,Ge),e(z,Me),h(m,B,$),h(m,K,$),e(K,se),h(m,Le,$),h(m,S,$),e(S,P),e(P,ve),e(P,ae),e(ae,Se),e(P,be),e(P,X),e(X,Be),e(S,Ce),e(S,C),e(C,Qe),e(C,ee),e(ee,x),e(C,M),e(C,Q),e(Q,He),e(S,We),e(S,j),e(j,Ue),e(j,re),e(re,De)},d(m){m&&t(u),m&&t(k),m&&t(E),m&&t(ge),m&&t(z),m&&t(B),m&&t(K),m&&t(Le),m&&t(S)}}}function Uf(G){let u,L,k,E,q;return{c(){u=n("p"),L=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),k=n("code"),E=r("Module"),q=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(y){u=s(y,"P",{});var w=a(u);L=d(w,"Although the recipe for forward pass needs to be defined within this function, one should call the "),k=s(w,"CODE",{});var D=a(k);E=d(D,"Module"),D.forEach(t),q=d(w,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),w.forEach(t)},m(y,w){h(y,u,w),e(u,L),e(u,k),e(k,E),e(u,q)},d(y){y&&t(u)}}}function Vf(G){let u,L,k,E,q,y,w,D,je,ge,z,Y,V,ne,Ie,R,Ge,Me,B,K,se,Le,S,P,ve,ae,Se,be,X,Be,Ce,C,Qe,ee,x,M,Q,He,We,j,Ue,re,De,m,$,de,st,at,I,rt,dt,Oe,J,ie,Pe,it,le,lt,ce,Ve,Re,Pd,Ad,Ss,Nd,jd,Id,ze,Gd,Cs,Bd,Qd,Os,Hd,Wd,Kn,Ud,Vd,Ps,Rd,Kd,Xd,Z,Jd,As,Zd,Yd,Ns,ei,ti,Xn,oi,ni,js,si,ai,Is,ri,di,Gs,ii,li,ci,ct,hi,Bs,pi,ui,Qs,mi,fi,_i,vo,gi,bo,vi,bi,Ti,To,ki,ko,wi,yi,_r,Nt,Ei,wo,qi,Li,gr,ht,jt,Hs,yo,Di,Ws,zi,vr,O,Eo,$i,pt,Fi,Jn,xi,Mi,qo,Si,Ci,Oi,ut,Pi,Zn,Ai,Ni,Yn,ji,Ii,Gi,Us,Bi,Qi,Lo,Hi,Vs,Rs,Ks,Xs,Wi,Ui,Js,Zs,Ys,It,Gt,ea,Do,Vi,ta,Ri,Ki,oa,na,zo,Bt,Qt,sa,$o,Xi,aa,Ji,Zi,ra,Yi,el,da,ia,la,Ht,Wt,ca,Fo,tl,ha,ol,br,mt,Ut,pa,xo,nl,ua,sl,Tr,N,Mo,al,ma,rl,dl,Vt,es,il,ll,ts,cl,hl,pl,So,ul,os,ml,fl,_l,Ke,Co,gl,fa,vl,bl,Oo,ns,Tl,_a,kl,wl,ss,yl,ga,El,ql,Rt,Po,Ll,Ao,Dl,va,zl,$l,Fl,Kt,No,xl,ba,Ml,Sl,as,jo,kr,ft,Xt,Ta,Io,Cl,ka,Ol,wr,$e,Go,Pl,Bo,Al,wa,Nl,jl,Il,Jt,rs,Gl,Bl,ds,Ql,Hl,Wl,Qo,Ul,is,Vl,Rl,yr,_t,Zt,ya,Ho,Kl,Ea,Xl,Er,gt,Wo,Jl,qa,Zl,qr,vt,Uo,Yl,La,ec,Lr,bt,Vo,tc,Da,oc,Dr,Tt,Ro,nc,za,sc,zr,kt,Ko,ac,$a,rc,$r,wt,Xo,dc,Fa,ic,Fr,yt,Jo,lc,xa,cc,xr,Et,Zo,hc,Ma,pc,Mr,qt,Yt,Sa,Yo,uc,Ca,mc,Sr,Fe,en,fc,tn,_c,ls,gc,vc,bc,on,Tc,nn,kc,wc,yc,Te,sn,Ec,Lt,qc,cs,Lc,Dc,Oa,zc,$c,Fc,eo,xc,Pa,Mc,Sc,an,Cr,Dt,to,Aa,rn,Cc,Na,Oc,Or,xe,dn,Pc,ln,Ac,hs,Nc,jc,Ic,cn,Gc,hn,Bc,Qc,Hc,H,pn,Wc,zt,Uc,ps,Vc,Rc,ja,Kc,Xc,Jc,oo,Zc,Ia,Yc,eh,un,th,Ga,oh,nh,mn,Pr,$t,no,Ba,fn,sh,Qa,ah,Ar,he,_n,rh,Ha,dh,ih,gn,lh,us,ch,hh,ph,vn,uh,bn,mh,fh,_h,A,Tn,gh,Ft,vh,ms,bh,Th,Wa,kh,wh,yh,so,Eh,Ua,qh,Lh,kn,Dh,wn,zh,Va,$h,Fh,yn,xh,En,Nr,xt,ao,Ra,qn,Mh,Ka,Sh,jr,pe,Ln,Ch,Mt,Oh,Xa,Ph,Ah,Ja,Nh,jh,Ih,Dn,Gh,fs,Bh,Qh,Hh,zn,Wh,$n,Uh,Vh,Rh,te,Fn,Kh,St,Xh,_s,Jh,Zh,Za,Yh,ep,tp,ro,op,Ya,np,sp,xn,ap,Mn,Ir,Ct,io,er,Sn,rp,tr,dp,Gr,ue,Cn,ip,On,lp,gs,cp,hp,pp,Pn,up,An,mp,fp,_p,lo,gp,ke,Nn,vp,Ot,bp,vs,Tp,kp,or,wp,yp,Ep,co,qp,nr,Lp,Dp,jn,Br,Pt,ho,sr,In,zp,ar,$p,Qr,me,Gn,Fp,Bn,xp,bs,Mp,Sp,Cp,Qn,Op,Hn,Pp,Ap,Np,po,jp,we,Wn,Ip,At,Gp,Ts,Bp,Qp,rr,Hp,Wp,Up,uo,Vp,dr,Rp,Kp,Un,Hr;return y=new _e({}),ne=new _e({}),yo=new _e({}),Eo=new F({props:{name:"class transformers.LEDConfig",anchor:"transformers.LEDConfig",parameters:[{name:"vocab_size",val:" = 50265"},{name:"max_encoder_position_embeddings",val:" = 16384"},{name:"max_decoder_position_embeddings",val:" = 1024"},{name:"encoder_layers",val:" = 12"},{name:"encoder_ffn_dim",val:" = 4096"},{name:"encoder_attention_heads",val:" = 16"},{name:"decoder_layers",val:" = 12"},{name:"decoder_ffn_dim",val:" = 4096"},{name:"decoder_attention_heads",val:" = 16"},{name:"encoder_layerdrop",val:" = 0.0"},{name:"decoder_layerdrop",val:" = 0.0"},{name:"use_cache",val:" = True"},{name:"is_encoder_decoder",val:" = True"},{name:"activation_function",val:" = 'gelu'"},{name:"d_model",val:" = 1024"},{name:"dropout",val:" = 0.1"},{name:"attention_dropout",val:" = 0.0"},{name:"activation_dropout",val:" = 0.0"},{name:"init_std",val:" = 0.02"},{name:"decoder_start_token_id",val:" = 2"},{name:"classifier_dropout",val:" = 0.0"},{name:"pad_token_id",val:" = 1"},{name:"bos_token_id",val:" = 0"},{name:"eos_token_id",val:" = 2"},{name:"attention_window",val:": typing.Union[typing.List[int], int] = 512"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.LEDConfig.vocab_size",description:`<strong>vocab_size</strong> (<code>int</code>, <em>optional</em>, defaults to 50265) &#x2014;
...
Whether or not the model should return the last key/values attentions (not used by all models)`,name:"use_cache"}],source:"https://github.com/huggingface/transformers/blob/v4.18.0/src/transformers/models/led/configuration_led.py#L31"}}),Lo=new Ne({props:{code:"",highlighted:""}}),Do=new _e({}),$o=new _e({}),Fo=new _e({}),xo=new _e({}),Mo=new F({props:{name:"class transformers.LEDTokenizer",anchor:"transformers.LEDTokenizer",parameters:[{name:"vocab_file",val:""},{name:"merges_file",val:""},{name:"errors",val:" = 'replace'"},{name:"bos_token",val:" = '<s>'"},{name:"eos_token",val:" = '</s>'"},{name:"sep_token",val:" = '</s>'"},{name:"cls_token",val:" = '<s>'"},{name:"unk_token",val:" = '<unk>'"},{name:"pad_token",val:" = '<pad>'"},{name:"mask_token",val:" = '<mask>'"},{name:"add_prefix_space",val:" = False"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/v4.18.0/src/transformers/models/led/tokenization_led.py#L43"}}),Co=new F({props:{name:"build_inputs_with_special_tokens",anchor:"transformers.LEDTokenizer.build_inputs_with_special_tokens",parameters:[{name:"token_ids_0",val:": typing.List[int]"},{name:"token_ids_1",val:": typing.Optional[typing.List[int]] = None"}],parametersDescription:[{anchor:"transformers.LEDTokenizer.build_inputs_with_special_tokens.token_ids_0",description:`<strong>token_ids_0</strong> (<code>List[int]</code>) &#x2014;
...
`,returnType:`
<p><code>List[int]</code></p>
`}}),No=new F({props:{name:"create_token_type_ids_from_sequences",anchor:"transformers.LEDTokenizer.create_token_type_ids_from_sequences",parameters:[{name:"token_ids_0",val:": typing.List[int]"},{name:"token_ids_1",val:": typing.Optional[typing.List[int]] = None"}],parametersDescription:[{anchor:"transformers.LEDTokenizer.create_token_type_ids_from_sequences.token_ids_0",description:`<strong>token_ids_0</strong> (<code>List[int]</code>) &#x2014;
...
<p>Global attentions weights after the attention softmax, used to compute the weighted average in the
self-attention heads. Those are the attention weights from every token with global attention to every token
in the sequence.`,name:"encoder_global_attentions"}],source:"https://github.com/huggingface/transformers/blob/v4.18.0/src/transformers/models/led/modeling_tf_led.py#L1373"}}),Zo=new F({props:{name:"class transformers.models.led.modeling_tf_led.TFLEDSeq2SeqLMOutput",anchor:"transformers.models.led.modeling_tf_led.TFLEDSeq2SeqLMOutput",parameters:[{name:"loss",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"logits",val:": Tensor = None"},{name:"past_key_values",val:": typing.Optional[typing.List[tensorflow.python.framework.ops.Tensor]] = None"},{name:"decoder_hidden_states",val:": typing.Optional[typing.Tuple[tensorflow.python.framework.ops.Tensor]] = None"},{name:"decoder_attentions",val:": typing.Optional[typing.Tuple[tensorflow.python.framework.ops.Tensor]] = None"},{name:"cross_attentions",val:": typing.Optional[typing.Tuple[tensorflow.python.framework.ops.Tensor]] = None"},{name:"encoder_last_hidden_state",val:": typing.Optional[tensorflow.python.framework.ops.Tensor] = None"},{name:"encoder_hidden_states",val:": typing.Optional[typing.Tuple[tensorflow.python.framework.ops.Tensor]] = None"},{name:"encoder_attentions",val:": typing.Optional[typing.Tuple[tensorflow.python.framework.ops.Tensor]] = None"},{name:"encoder_global_attentions",val:": typing.Optional[typing.Tuple[tensorflow.python.framework.ops.Tensor]] = None"}],parametersDescription:[{anchor:"transformers.models.led.modeling_tf_led.TFLEDSeq2SeqLMOutput.loss",description:`<strong>loss</strong> (<code>tf.Tensor</code> of shape <code>(1,)</code>, <em>optional</em>, returned when <code>labels</code> is provided) &#x2014;
...
<p>Global attentions weights after the attention softmax, used to compute the weighted average in the
self-attention heads. Those are the attention weights from every token with global attention to every token
in the sequence.`,name:"encoder_global_attentions"}],source:"https://github.com/huggingface/transformers/blob/v4.18.0/src/transformers/models/led/modeling_tf_led.py#L1441"}}),Yo=new _e({}),en=new F({props:{name:"class transformers.LEDModel",anchor:"transformers.LEDModel",parameters:[{name:"config",val:": LEDConfig"}],parametersDescription:[{anchor:"transformers.LEDModel.config",description:`<strong>config</strong> (<a href="/docs/transformers/v4.18.0/en/model_doc/led#transformers.LEDConfig">LEDConfig</a>) &#x2014;
Model configuration class with all the parameters of the model. Initializing with a config file does not
load the weights associated with the model, only the configuration. Check out the
<a href="/docs/transformers/v4.18.0/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/v4.18.0/src/transformers/models/led/modeling_led.py#L2154"}}),sn=new F({props:{name:"forward",anchor:"transformers.LEDModel.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"decoder_input_ids",val:" = None"},{name:"decoder_attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"decoder_head_mask",val:" = None"},{name:"cross_attn_head_mask",val:" = None"},{name:"encoder_outputs",val:" = None"},{name:"global_attention_mask",val:" = None"},{name:"past_key_values",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"decoder_inputs_embeds",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],parametersDescription:[{anchor:"transformers.LEDModel.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. Padding will be ignored by default should you provide
it.</p>
<p>Indices can be obtained using <a href="/docs/transformers/v4.18.0/en/model_doc/led#transformers.LEDTokenizer">LEDTokenizer</a>. See <a href="/docs/transformers/v4.18.0/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
...
<p>Indices can be obtained using <code>LedTokenizer</code>. See <a href="/docs/transformers/v4.18.0/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/v4.18.0/en/model_doc/wav2vec2_phoneme#transformers.Wav2Vec2PhonemeCTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
Whether or not to return a <a href="/docs/transformers/v4.18.0/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/v4.18.0/src/transformers/models/led/modeling_led.py#L2181",returnDescription:`
<p>A <a
...
elements depending on the configuration (<a
  href="/docs/transformers/v4.18.0/en/model_doc/led#transformers.LEDConfig"
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),rn=new _e({}),dn=new F({props:{name:"class transformers.LEDForConditionalGeneration",anchor:"transformers.LEDForConditionalGeneration",parameters:[{name:"config",val:": LEDConfig"}],parametersDescription:[{anchor:"transformers.LEDForConditionalGeneration.config",description:`<strong>config</strong> (<a href="/docs/transformers/v4.18.0/en/model_doc/led#transformers.LEDConfig">LEDConfig</a>) &#x2014;
Model configuration class with all the parameters of the model. Initializing with a config file does not
load the weights associated with the model, only the configuration. Check out the
<a href="/docs/transformers/v4.18.0/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/v4.18.0/src/transformers/models/led/modeling_led.py#L2277"}}),pn=new F({props:{name:"forward",anchor:"transformers.LEDForConditionalGeneration.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"decoder_input_ids",val:" = None"},{name:"decoder_attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"decoder_head_mask",val:" = None"},{name:"cross_attn_head_mask",val:" = None"},{name:"encoder_outputs",val:" = None"},{name:"global_attention_mask",val:" = None"},{name:"past_key_values",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"decoder_inputs_embeds",val:" = None"},{name:"labels",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],parametersDescription:[{anchor:"transformers.LEDForConditionalGeneration.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. Padding will be ignored by default should you provide
it.</p>
<p>Indices can be obtained using <a href="/docs/transformers/v4.18.0/en/model_doc/led#transformers.LEDTokenizer">LEDTokenizer</a>. See <a href="/docs/transformers/v4.18.0/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/v4.18.0/en/model_doc/wav2vec2_phoneme#transformers.Wav2Vec2PhonemeCTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
(masked), the loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.18.0/src/transformers/models/led/modeling_led.py#L2321",returnDescription:`
<p>A <a
...
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-built_in">print</span>(tokenizer.decode(summary_ids[<span class="hljs-number">0</span>], skip_special_tokens=<span class="hljs-literal">True</span>, clean_up_tokenization_spaces=<span class="hljs-literal">True</span>))`}}),fn=new _e({}),_n=new F({props:{name:"class transformers.LEDForSequenceClassification",anchor:"transformers.LEDForSequenceClassification",parameters:[{name:"config",val:": LEDConfig"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.LEDForSequenceClassification.config",description:`<strong>config</strong> (<a href="/docs/transformers/v4.18.0/en/model_doc/led#transformers.LEDConfig">LEDConfig</a>) &#x2014;
Model configuration class with all the parameters of the model. Initializing with a config file does not
load the weights associated with the model, only the configuration. Check out the
<a href="/docs/transformers/v4.18.0/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/v4.18.0/src/transformers/models/led/modeling_led.py#L2468"}}),Tn=new F({props:{name:"forward",anchor:"transformers.LEDForSequenceClassification.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"decoder_input_ids",val:" = None"},{name:"decoder_attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"decoder_head_mask",val:" = None"},{name:"cross_attn_head_mask",val:" = None"},{name:"encoder_outputs",val:" = None"},{name:"global_attention_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"decoder_inputs_embeds",val:" = None"},{name:"labels",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],parametersDescription:[{anchor:"transformers.LEDForSequenceClassification.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. Padding will be ignored by default should you provide
it.</p>
<p>Indices can be obtained using <a href="/docs/transformers/v4.18.0/en/model_doc/led#transformers.LEDTokenizer">LEDTokenizer</a>. See <a href="/docs/transformers/v4.18.0/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/v4.18.0/en/model_doc/wav2vec2_phoneme#transformers.Wav2Vec2PhonemeCTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
Labels for computing the sequence classification/regression loss. Indices should be in <code>[0, ..., config.num_labels - 1]</code>. If <code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.18.0/src/transformers/models/led/modeling_led.py#L2481",returnDescription:`
<p>A <a
...
<span class="hljs-meta">&gt;&gt;&gt; </span>loss = model(**inputs, labels=labels).loss
<span class="hljs-meta">&gt;&gt;&gt; </span>loss.backward()`}}),qn=new _e({}),Ln=new F({props:{name:"class transformers.LEDForQuestionAnswering",anchor:"transformers.LEDForQuestionAnswering",parameters:[{name:"config",val:""}],parametersDescription:[{anchor:"transformers.LEDForQuestionAnswering.config",description:`<strong>config</strong> (<a href="/docs/transformers/v4.18.0/en/model_doc/led#transformers.LEDConfig">LEDConfig</a>) &#x2014;
Model configuration class with all the parameters of the model. Initializing with a config file does not
load the weights associated with the model, only the configuration. Check out the
<a href="/docs/transformers/v4.18.0/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/v4.18.0/src/transformers/models/led/modeling_led.py#L2596"}}),Fn=new F({props:{name:"forward",anchor:"transformers.LEDForQuestionAnswering.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"decoder_input_ids",val:" = None"},{name:"decoder_attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"decoder_head_mask",val:" = None"},{name:"cross_attn_head_mask",val:" = None"},{name:"encoder_outputs",val:" = None"},{name:"global_attention_mask",val:" = None"},{name:"start_positions",val:" = None"},{name:"end_positions",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"decoder_inputs_embeds",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],parametersDescription:[{anchor:"transformers.LEDForQuestionAnswering.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. Padding will be ignored by default should you provide
it.</p>
<p>Indices can be obtained using <a href="/docs/transformers/v4.18.0/en/model_doc/led#transformers.LEDTokenizer">LEDTokenizer</a>. See <a href="/docs/transformers/v4.18.0/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/v4.18.0/en/model_doc/wav2vec2_phoneme#transformers.Wav2Vec2PhonemeCTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
Positions are clamped to the length of the sequence (<em>sequence_length</em>). Position outside of the sequence
are not taken into account for computing the loss.`,name:"end_positions"}],source:"https://github.com/huggingface/transformers/blob/v4.18.0/src/transformers/models/led/modeling_led.py#L2608",returnDescription:`
<p>A <a
...
behaviors between training and evaluation).`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/v4.18.0/src/transformers/models/led/modeling_tf_led.py#L2203",returnDescription:`
<p>A <a
  href="/docs/transformers/v4.18.0/en/model_doc/led#transformers.models.led.modeling_tf_led.TFLEDSeq2SeqModelOutput"
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),In=new _e({}),Gn=new F({props:{name:"class transformers.TFLEDForConditionalGeneration",anchor:"transformers.TFLEDForConditionalGeneration",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.TFLEDForConditionalGeneration.config",description:`<strong>config</strong> (<a href="/docs/transformers/v4.18.0/en/model_doc/led#transformers.LEDConfig">LEDConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/v4.18.0/en/main_classes/model#transformers.TFPreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/v4.18.0/src/transformers/models/led/modeling_tf_led.py#L2279"}}),po=new go({props:{$$slots:{default:[Wf]},$$scope:{ctx:G}}}),Wn=new F({props:{name:"call",anchor:"transformers.TFLEDForConditionalGeneration.call",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"decoder_input_ids",val:" = None"},{name:"decoder_attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"decoder_head_mask",val:" = None"},{name:"encoder_outputs",val:": typing.Optional[transformers.models.led.modeling_tf_led.TFLEDEncoderBaseModelOutput] = None"},{name:"global_attention_mask",val:" = None"},{name:"past_key_values",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"decoder_inputs_embeds",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"},{name:"labels",val:" = None"},{name:"training",val:" = False"}],parametersDescription:[{anchor:"transformers.TFLEDForConditionalGeneration.call.input_ids",description:`<strong>input_ids</strong> (<code>tf.Tensor</code> of shape <code>({0})</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/v4.18.0/en/model_doc/bert#transformers.BertTokenizer">BertTokenizer</a>. See <a href="/docs/transformers/v4.18.0/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/v4.18.0/en/model_doc/wav2vec2_phoneme#transformers.Wav2Vec2PhonemeCTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
Whether or not to use the model in training mode (some modules like dropout modules have different
behaviors between training and evaluation).`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/v4.18.0/src/transformers/models/led/modeling_tf_led.py#L2312",returnDescription:`
<p>A <a
  href="/docs/transformers/v4.18.0/en/model_doc/led#transformers.models.led.modeling_tf_led.TFLEDSeq2SeqLMOutput"
...
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-comment"># probs[5] is associated with the mask token</span>`}}),{c(){u=n("meta"),L=i(),k=n("h1"),E=n("a"),q=n("span"),f(y.$$.fragment),w=i(),D=n("span"),je=r("LED"),ge=i(),z=n("h2"),Y=n("a"),V=n("span"),f(ne.$$.fragment),Ie=i(),R=n("span"),Ge=r("Overview"),Me=i(),B=n("p"),K=r("The LED model was proposed in "),se=n("a"),Le=r("Longformer: The Long-Document Transformer"),S=r(` by Iz
Beltagy, Matthew E. Peters, Arman Cohan.`),P=i(),ve=n("p"),ae=r("The abstract from the paper is the following:"),Se=i(),be=n("p"),X=n("em"),Be=r(`Transformer-based models are unable to process long sequences due to their self-attention operation, which scales
...
`),Pe=n("a"),it=r("BartTokenizer"),le=r("."),lt=i(),ce=n("li"),Ve=r("LED works very well on long-range "),Re=n("em"),Pd=r("sequence-to-sequence"),Ad=r(" tasks where the "),Ss=n("code"),Nd=r("input_ids"),jd=r(` largely exceed a length of
...
gained, when `),Kn=n("a"),Ud=r("LEDTokenizer"),Vd=r(" is used with the "),Ps=n("code"),Rd=r("pad_to_multiple_of"),Kd=r(" argument."),Xd=i(),Z=n("li"),Jd=r("LED makes use of "),As=n("em"),Zd=r("global attention"),Yd=r(" by means of the "),Ns=n("code"),ei=r("global_attention_mask"),ti=r(` (see
...
`),Qs=n("code"),mi=r("model.gradient_checkpointing_enable()"),fi=r("."),_i=i(),vo=n("li"),gi=r("A notebook showing how to evaluate LED, can be accessed "),bo=n("a"),vi=r("here"),bi=r("."),Ti=i(),To=n("li"),ki=r("A notebook showing how to fine-tune LED, can be accessed "),ko=n("a"),wi=r("here"),yi=r("."),_r=i(),Nt=n("p"),Ei=r("This model was contributed by "),wo=n("a"),qi=r("patrickvonplaten"),Li=r("."),gr=i(),ht=n("h2"),jt=n("a"),Hs=n("span"),f(yo.$$.fragment),Di=i(),Ws=n("span"),zi=r("LEDConfig"),vr=i(),O=n("div"),f(Eo.$$.fragment),$i=i(),pt=n("p"),Fi=r("This is the configuration class to store the configuration of a "),Jn=n("a"),xi=r("LEDModel"),Mi=r(`. It is used to instantiate an LED
...
adding special tokens. A BART sequence has the following format:`),bl=i(),Oo=n("ul"),ns=n("li"),Tl=r("single sequence: "),_a=n("code"),kl=r("<s> X </s>"),wl=i(),ss=n("li"),yl=r("pair of sequences: "),ga=n("code"),El=r("<s> A </s></s> B </s>"),ql=i(),Rt=n("div"),f(Po.$$.fragment),Ll=i(),Ao=n("p"),Dl=r(`Retrieve sequence ids from a token list that has no special tokens added. This method is called when adding
special tokens using the tokenizer `),va=n("code"),zl=r("prepare_for_model"),$l=r(" method."),Fl=i(),Kt=n("div"),f(No.$$.fragment),xl=i(),ba=n("p"),Ml=r(`Create a mask from the two sequences passed to be used in a sequence-pair classification task. BART does not
make use of token type ids, therefore a list of zeros is returned.`),Sl=i(),as=n("div"),f(jo.$$.fragment),kr=i(),ft=n("h2"),Xt=n("a"),Ta=n("span"),f(Io.$$.fragment),Cl=i(),ka=n("span"),Ol=r("LEDTokenizerFast"),wr=i(),$e=n("div"),f(Go.$$.fragment),Pl=i(),Bo=n("p"),Al=r("Construct a \u201Cfast\u201D LED tokenizer (backed by HuggingFace\u2019s "),wa=n("em"),Nl=r("tokenizers"),jl=r(" library)."),Il=i(),Jt=n("p"),rs=n("a"),Gl=r("LEDTokenizerFast"),Bl=r(" is identical to "),ds=n("a"),Ql=r("BartTokenizerFast"),Hl=r(` and runs end-to-end tokenization: punctuation splitting
...
etc.)`),bc=i(),on=n("p"),Tc=r("This model is also a PyTorch "),nn=n("a"),kc=r("torch.nn.Module"),wc=r(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),yc=i(),Te=n("div"),f(sn.$$.fragment),Ec=i(),Lt=n("p"),qc=r("The "),cs=n("a"),Lc=r("LEDModel"),Dc=r(" forward method, overrides the "),Oa=n("code"),zc=r("__call__"),$c=r(" special method."),Fc=i(),f(eo.$$.fragment),xc=i(),Pa=n("p"),Mc=r("Example:"),Sc=i(),f(an.$$.fragment),Cr=i(),Dt=n("h2"),to=n("a"),Aa=n("span"),f(rn.$$.fragment),Cc=i(),Na=n("span"),Oc=r("LEDForConditionalGeneration"),Or=i(),xe=n("div"),f(dn.$$.fragment),Pc=i(),ln=n("p"),Ac=r(`The LED Model with a language modeling head. Can be used for summarization.
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Hc=i(),H=n("div"),f(pn.$$.fragment),Wc=i(),zt=n("p"),Uc=r("The "),ps=n("a"),Vc=r("LEDForConditionalGeneration"),Rc=r(" forward method, overrides the "),ja=n("code"),Kc=r("__call__"),Xc=r(" special method."),Jc=i(),f(oo.$$.fragment),Zc=i(),Ia=n("p"),Yc=r("Conditional generation example:"),eh=i(),f(un.$$.fragment),th=i(),Ga=n("p"),oh=r("Summarization example:"),nh=i(),f(mn.$$.fragment),Pr=i(),$t=n("h2"),no=n("a"),Ba=n("span"),f(fn.$$.fragment),sh=i(),Qa=n("span"),ah=r("LEDForSequenceClassification"),Ar=i(),he=n("div"),f(_n.$$.fragment),rh=i(),Ha=n("p"),dh=r(`LED model with a sequence classification/head on top (a linear layer on top of the pooled output) e.g. for GLUE
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),ph=i(),vn=n("p"),uh=r("This model is also a PyTorch "),bn=n("a"),mh=r("torch.nn.Module"),fh=r(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),_h=i(),A=n("div"),f(Tn.$$.fragment),gh=i(),Ft=n("p"),vh=r("The "),ms=n("a"),bh=r("LEDForSequenceClassification"),Th=r(" forward method, overrides the "),Wa=n("code"),kh=r("__call__"),wh=r(" special method."),yh=i(),f(so.$$.fragment),Eh=i(),Ua=n("p"),qh=r("Example of single-label classification:"),Lh=i(),f(kn.$$.fragment),Dh=i(),f(wn.$$.fragment),zh=i(),Va=n("p"),$h=r("Example of multi-label classification:"),Fh=i(),f(yn.$$.fragment),xh=i(),f(En.$$.fragment),Nr=i(),xt=n("h2"),ao=n("a"),Ra=n("span"),f(qn.$$.fragment),Mh=i(),Ka=n("span"),Sh=r("LEDForQuestionAnswering"),jr=i(),pe=n("div"),f(Ln.$$.fragment),Ch=i(),Mt=n("p"),Oh=r(`LED Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear layer
...
behavior.`),_p=i(),f(lo.$$.fragment),gp=i(),ke=n("div"),f(Nn.$$.fragment),vp=i(),Ot=n("p"),bp=r("The "),vs=n("a"),Tp=r("TFLEDModel"),kp=r(" forward method, overrides the "),or=n("code"),wp=r("__call__"),yp=r(" special method."),Ep=i(),f(co.$$.fragment),qp=i(),nr=n("p"),Lp=r("Example:"),Dp=i(),f(jn.$$.fragment),Br=i(),Pt=n("h2"),ho=n("a"),sr=n("span"),f(In.$$.fragment),zp=i(),ar=n("span"),$p=r("TFLEDForConditionalGeneration"),Qr=i(),me=n("div"),f(Gn.$$.fragment),Fp=i(),Bn=n("p"),xp=r(`The LED Model with a language modeling head. Can be used for summarization.
This model inherits from `),bs=n("a"),Mp=r("TFPreTrainedModel"),Sp=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Cp=i(),Qn=n("p"),Op=r("This model is also a "),Hn=n("a"),Pp=r("tf.keras.Model"),Ap=r(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Np=i(),f(po.$$.fragment),jp=i(),we=n("div"),f(Wn.$$.fragment),Ip=i(),At=n("p"),Gp=r("The "),Ts=n("a"),Bp=r("TFLEDForConditionalGeneration"),Qp=r(" forward method, overrides the "),rr=n("code"),Hp=r("__call__"),Wp=r(" special method."),Up=i(),f(uo.$$.fragment),Vp=i(),dr=n("p"),Rp=r("Examples:"),Kp=i(),f(Un.$$.fragment),this.h()},l(o){const p=Af('[data-svelte="svelte-1phssyn"]',document.head);u=s(p,"META",{name:!0,content:!0}),p.forEach(t),L=l(o),k=s(o,"H1",{class:!0});var Vn=a(k);E=s(Vn,"A",{id:!0,class:!0,href:!0});var ir=a(E);q=s(ir,"SPAN",{});var lr=a(q);_(y.$$.fragment,lr),lr.forEach(t),ir.forEach(t),w=l(Vn),D=s(Vn,"SPAN",{});var cr=a(D);je=d(cr,"LED"),cr.forEach(t),Vn.forEach(t),ge=l(o),z=s(o,"H2",{class:!0});var Rn=a(z);Y=s(Rn,"A",{id:!0,class:!0,href:!0});var hr=a(Y);V=s(hr,"SPAN",{});var pr=a(V);_(ne.$$.fragment,pr),pr.forEach(t),hr.forEach(t),Ie=l(Rn),R=s(Rn,"SPAN",{});var ur=a(R);Ge=d(ur,"Overview"),ur.forEach(t),Rn.forEach(t),Me=l(o),B=s(o,"P",{});var Wr=a(B);K=d(Wr,"The LED model was proposed in "),se=s(Wr,"A",{href:!0,rel:!0});var Zp=a(se);Le=d(Zp,"Longformer: The Long-Document Transformer"),Zp.forEach(t),S=d(Wr,` by Iz
Beltagy, Matthew E. Peters, Arman Cohan.`),Wr.forEach(t),P=l(o),ve=s(o,"P",{});var Yp=a(ve);ae=d(Yp,"The abstract from the paper is the following:"),Yp.forEach(t),Se=l(o),be=s(o,"P",{});var eu=a(be);X=s(eu,"EM",{});var tu=a(X);Be=d(tu,`Transformer-based models are unable to process long sequences due to their self-attention operation, which scales
quadratically with the sequence length. To address this limitation, we introduce the Longformer with an attention
mechanism that scales linearly with sequence length, making it easy to process documents of thousands of tokens or
longer. Longformer\u2019s attention mechanism is a drop-in replacement for the standard self-attention and combines a local
windowed attention with a task motivated global attention. Following prior work on long-sequence transformers, we
...
`),Pe=s(fe,"A",{href:!0});var lu=a(Pe);it=d(lu,"BartTokenizer"),lu.forEach(t),le=d(fe,"."),fe.forEach(t),lt=l(ye),ce=s(ye,"LI",{});var ks=a(ce);Ve=d(ks,"LED works very well on long-range "),Re=s(ks,"EM",{});var cu=a(Re);Pd=d(cu,"sequence-to-sequence"),cu.forEach(t),Ad=d(ks," tasks where the "),Ss=s(ks,"CODE",{});var hu=a(Ss);Nd=d(hu,"input_ids"),hu.forEach(t),jd=d(ks,` largely exceed a length of
1024 tokens.`),ks.forEach(t),Id=l(ye),ze=s(ye,"LI",{});var Xe=a(ze);Gd=d(Xe,"LED pads the "),Cs=s(Xe,"CODE",{});var pu=a(Cs);Bd=d(pu,"input_ids"),pu.forEach(t),Qd=d(Xe," to be a multiple of "),Os=s(Xe,"CODE",{});var uu=a(Os);Hd=d(uu,"config.attention_window"),uu.forEach(t),Wd=d(Xe,` if required. Therefore a small speed-up is
gained, when `),Kn=s(Xe,"A",{href:!0});var mu=a(Kn);Ud=d(mu,"LEDTokenizer"),mu.forEach(t),Vd=d(Xe," is used with the "),Ps=s(Xe,"CODE",{});var fu=a(Ps);Rd=d(fu,"pad_to_multiple_of"),fu.forEach(t),Kd=d(Xe," argument."),Xe.forEach(t),Xd=l(ye),Z=s(ye,"LI",{});var Ee=a(Z);Jd=d(Ee,"LED makes use of "),As=s(Ee,"EM",{});var _u=a(As);Zd=d(_u,"global attention"),_u.forEach(t),Yd=d(Ee," by means of the "),Ns=s(Ee,"CODE",{});var gu=a(Ns);ei=d(gu,"global_attention_mask"),gu.forEach(t),ti=d(Ee,` (see
`),Xn=s(Ee,"A",{href:!0});var vu=a(Xn);oi=d(vu,"LongformerModel"),vu.forEach(t),ni=d(Ee,"). For summarization, it is advised to put "),js=s(Ee,"EM",{});var bu=a(js);si=d(bu,"global attention"),bu.forEach(t),ai=d(Ee,` only on the first
`),Is=s(Ee,"CODE",{});var Tu=a(Is);ri=d(Tu,"<s>"),Tu.forEach(t),di=d(Ee," token. For question answering, it is advised to put "),Gs=s(Ee,"EM",{});var ku=a(Gs);ii=d(ku,"global attention"),ku.forEach(t),li=d(Ee," on all tokens of the question."),Ee.forEach(t),ci=l(ye),ct=s(ye,"LI",{});var ws=a(ct);hi=d(ws,"To fine-tune LED on all 16384, it is necessary to enable "),Bs=s(ws,"EM",{});var wu=a(Bs);pi=d(wu,"gradient checkpointing"),wu.forEach(t),ui=d(ws,` by executing
`),Qs=s(ws,"CODE",{});var yu=a(Qs);mi=d(yu,"model.gradient_checkpointing_enable()"),yu.forEach(t),fi=d(ws,"."),ws.forEach(t),_i=l(ye),vo=s(ye,"LI",{});var Ur=a(vo);gi=d(Ur,"A notebook showing how to evaluate LED, can be accessed "),bo=s(Ur,"A",{href:!0,rel:!0});var Eu=a(bo);vi=d(Eu,"here"),Eu.forEach(t),bi=d(Ur,"."),Ur.forEach(t),Ti=l(ye),To=s(ye,"LI",{});var Vr=a(To);ki=d(Vr,"A notebook showing how to fine-tune LED, can be accessed "),ko=s(Vr,"A",{href:!0,rel:!0});var qu=a(ko);wi=d(qu,"here"),qu.forEach(t),yi=d(Vr,"."),Vr.forEach(t),ye.forEach(t),_r=l(o),Nt=s(o,"P",{});var Rr=a(Nt);Ei=d(Rr,"This model was contributed by "),wo=s(Rr,"A",{href:!0,rel:!0});var Lu=a(wo);qi=d(Lu,"patrickvonplaten"),Lu.forEach(t),Li=d(Rr,"."),Rr.forEach(t),gr=l(o),ht=s(o,"H2",{class:!0});var Kr=a(ht);jt=s(Kr,"A",{id:!0,class:!0,href:!0});var Du=a(jt);Hs=s(Du,"SPAN",{});var zu=a(Hs);_(yo.$$.fragment,zu),zu.forEach(t),Du.forEach(t),Di=l(Kr),Ws=s(Kr,"SPAN",{});var $u=a(Ws);zi=d($u,"LEDConfig"),$u.forEach(t),Kr.forEach(t),vr=l(o),O=s(o,"DIV",{class:!0});var W=a(O);_(Eo.$$.fragment,W),$i=l(W),pt=s(W,"P",{});var ys=a(pt);Fi=d(ys,"This is the configuration class to store the configuration of a "),Jn=s(ys,"A",{href:!0});var Fu=a(Jn);xi=d(Fu,"LEDModel"),Fu.forEach(t),Mi=d(ys,`. It is used to instantiate an LED
model according to the specified arguments, defining the model architecture. Instantiating a configuration with the
defaults will yield a similar configuration to that of the LED
...
adding special tokens. A BART sequence has the following format:`),cm.forEach(t),bl=l(qs),Oo=s(qs,"UL",{});var od=a(Oo);ns=s(od,"LI",{});var Xp=a(ns);Tl=d(Xp,"single sequence: "),_a=s(Xp,"CODE",{});var hm=a(_a);kl=d(hm,"<s> X </s>"),hm.forEach(t),Xp.forEach(t),wl=l(od),ss=s(od,"LI",{});var Jp=a(ss);yl=d(Jp,"pair of sequences: "),ga=s(Jp,"CODE",{});var pm=a(ga);El=d(pm,"<s> A </s></s> B </s>"),pm.forEach(t),Jp.forEach(t),od.forEach(t),qs.forEach(t),ql=l(oe),Rt=s(oe,"DIV",{class:!0});var nd=a(Rt);_(Po.$$.fragment,nd),Ll=l(nd),Ao=s(nd,"P",{});var sd=a(Ao);Dl=d(sd,`Retrieve sequence ids from a token list that has no special tokens added. This method is called when adding
special tokens using the tokenizer `),va=s(sd,"CODE",{});var um=a(va);zl=d(um,"prepare_for_model"),um.forEach(t),$l=d(sd," method."),sd.forEach(t),nd.forEach(t),Fl=l(oe),Kt=s(oe,"DIV",{class:!0});var ad=a(Kt);_(No.$$.fragment,ad),xl=l(ad),ba=s(ad,"P",{});var mm=a(ba);Ml=d(mm,`Create a mask from the two sequences passed to be used in a sequence-pair classification task. BART does not
make use of token type ids, therefore a list of zeros is returned.`),mm.forEach(t),ad.forEach(t),Sl=l(oe),as=s(oe,"DIV",{class:!0});var fm=a(as);_(jo.$$.fragment,fm),fm.forEach(t),oe.forEach(t),kr=l(o),ft=s(o,"H2",{class:!0});var rd=a(ft);Xt=s(rd,"A",{id:!0,class:!0,href:!0});var _m=a(Xt);Ta=s(_m,"SPAN",{});var gm=a(Ta);_(Io.$$.fragment,gm),gm.forEach(t),_m.forEach(t),Cl=l(rd),ka=s(rd,"SPAN",{});var vm=a(ka);Ol=d(vm,"LEDTokenizerFast"),vm.forEach(t),rd.forEach(t),wr=l(o),$e=s(o,"DIV",{class:!0});var mo=a($e);_(Go.$$.fragment,mo),Pl=l(mo),Bo=s(mo,"P",{});var dd=a(Bo);Al=d(dd,"Construct a \u201Cfast\u201D LED tokenizer (backed by HuggingFace\u2019s "),wa=s(dd,"EM",{});var bm=a(wa);Nl=d(bm,"tokenizers"),bm.forEach(t),jl=d(dd," library)."),dd.forEach(t),Il=l(mo),Jt=s(mo,"P",{});var fr=a(Jt);rs=s(fr,"A",{href:!0});var Tm=a(rs);Gl=d(Tm,"LEDTokenizerFast"),Tm.forEach(t),Bl=d(fr," is identical to "),ds=s(fr,"A",{href:!0});var km=a(ds);Ql=d(km,"BartTokenizerFast"),km.forEach(t),Hl=d(fr,` and runs end-to-end tokenization: punctuation splitting
...
decoding.`),Dm.forEach(t),hd.forEach(t),Lr=l(o),bt=s(o,"DIV",{class:!0});var pd=a(bt);_(Vo.$$.fragment,pd),tc=l(pd),Da=s(pd,"P",{});var zm=a(Da);oc=d(zm,"Base class for sequence-to-sequence language models outputs."),zm.forEach(t),pd.forEach(t),Dr=l(o),Tt=s(o,"DIV",{class:!0});var ud=a(Tt);_(Ro.$$.fragment,ud),nc=l(ud),za=s(ud,"P",{});var $m=a(za);sc=d($m,"Base class for outputs of sequence-to-sequence sentence classification models."),$m.forEach(t),ud.forEach(t),zr=l(o),kt=s(o,"DIV",{class:!0});var md=a(kt);_(Ko.$$.fragment,md),ac=l(md),$a=s(md,"P",{});var Fm=a($a);rc=d(Fm,"Base class for outputs of sequence-to-sequence question answering models."),Fm.forEach(t),md.forEach(t),$r=l(o),wt=s(o,"DIV",{class:!0});var fd=a(wt);_(Xo.$$.fragment,fd),dc=l(fd),Fa=s(fd,"P",{});var xm=a(Fa);ic=d(xm,"Base class for Longformer\u2019s outputs, with potential hidden states, local and global attentions."),xm.forEach(t),fd.forEach(t),Fr=l(o),yt=s(o,"DIV",{class:!0});var _d=a(yt);_(Jo.$$.fragment,_d),lc=l(_d),xa=s(_d,"P",{});var Mm=a(xa);cc=d(Mm,`Base class for model encoder\u2019s outputs that also contains : pre-computed hidden states that can speed up sequential
decoding.`),Mm.forEach(t),_d.forEach(t),xr=l(o),Et=s(o,"DIV",{class:!0});var gd=a(Et);_(Zo.$$.fragment,gd),hc=l(gd),Ma=s(gd,"P",{});var Sm=a(Ma);pc=d(Sm,"Base class for sequence-to-sequence language models outputs."),Sm.forEach(t),gd.forEach(t),Mr=l(o),qt=s(o,"H2",{class:!0});var vd=a(qt);Yt=s(vd,"A",{id:!0,class:!0,href:!0});var Cm=a(Yt);Sa=s(Cm,"SPAN",{});var Om=a(Sa);_(Yo.$$.fragment,Om),Om.forEach(t),Cm.forEach(t),uc=l(vd),Ca=s(vd,"SPAN",{});var Pm=a(Ca);mc=d(Pm,"LEDModel"),Pm.forEach(t),vd.forEach(t),Sr=l(o),Fe=s(o,"DIV",{class:!0});var fo=a(Fe);_(en.$$.fragment,fo),fc=l(fo),tn=s(fo,"P",{});var bd=a(tn);_c=d(bd,`The bare LED Model outputting raw hidden-states without any specific head on top.
This model inherits from `),ls=s(bd,"A",{href:!0});var Am=a(ls);gc=d(Am,"PreTrainedModel"),Am.forEach(t),vc=d(bd,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),bd.forEach(t),bc=l(fo),on=s(fo,"P",{});var Td=a(on);Tc=d(Td,"This model is also a PyTorch "),nn=s(Td,"A",{href:!0,rel:!0});var Nm=a(nn);kc=d(Nm,"torch.nn.Module"),Nm.forEach(t),wc=d(Td,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Td.forEach(t),yc=l(fo),Te=s(fo,"DIV",{class:!0});var Je=a(Te);_(sn.$$.fragment,Je),Ec=l(Je),Lt=s(Je,"P",{});var Ls=a(Lt);qc=d(Ls,"The "),cs=s(Ls,"A",{href:!0});var jm=a(cs);Lc=d(jm,"LEDModel"),jm.forEach(t),Dc=d(Ls," forward method, overrides the "),Oa=s(Ls,"CODE",{});var Im=a(Oa);zc=d(Im,"__call__"),Im.forEach(t),$c=d(Ls," special method."),Ls.forEach(t),Fc=l(Je),_(eo.$$.fragment,Je),xc=l(Je),Pa=s(Je,"P",{});var Gm=a(Pa);Mc=d(Gm,"Example:"),Gm.forEach(t),Sc=l(Je),_(an.$$.fragment,Je),Je.forEach(t),fo.forEach(t),Cr=l(o),Dt=s(o,"H2",{class:!0});var kd=a(Dt);to=s(kd,"A",{id:!0,class:!0,href:!0});var Bm=a(to);Aa=s(Bm,"SPAN",{});var Qm=a(Aa);_(rn.$$.fragment,Qm),Qm.forEach(t),Bm.forEach(t),Cc=l(kd),Na=s(kd,"SPAN",{});var Hm=a(Na);Oc=d(Hm,"LEDForConditionalGeneration"),Hm.forEach(t),kd.forEach(t),Or=l(o),xe=s(o,"DIV",{class:!0});var _o=a(xe);_(dn.$$.fragment,_o),Pc=l(_o),ln=s(_o,"P",{});var wd=a(ln);Ac=d(wd,`The LED Model with a language modeling head. Can be used for summarization.
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),yd.forEach(t),Hc=l(_o),H=s(_o,"DIV",{class:!0});var qe=a(H);_(pn.$$.fragment,qe),Wc=l(qe),zt=s(qe,"P",{});var Ds=a(zt);Uc=d(Ds,"The "),ps=s(Ds,"A",{href:!0});var Vm=a(ps);Vc=d(Vm,"LEDForConditionalGeneration"),Vm.forEach(t),Rc=d(Ds," forward method, overrides the "),ja=s(Ds,"CODE",{});var Rm=a(ja);Kc=d(Rm,"__call__"),Rm.forEach(t),Xc=d(Ds," special method."),Ds.forEach(t),Jc=l(qe),_(oo.$$.fragment,qe),Zc=l(qe),Ia=s(qe,"P",{});var Km=a(Ia);Yc=d(Km,"Conditional generation example:"),Km.forEach(t),eh=l(qe),_(un.$$.fragment,qe),th=l(qe),Ga=s(qe,"P",{});var Xm=a(Ga);oh=d(Xm,"Summarization example:"),Xm.forEach(t),nh=l(qe),_(mn.$$.fragment,qe),qe.forEach(t),_o.forEach(t),Pr=l(o),$t=s(o,"H2",{class:!0});var Ed=a($t);no=s(Ed,"A",{id:!0,class:!0,href:!0});var Jm=a(no);Ba=s(Jm,"SPAN",{});var Zm=a(Ba);_(fn.$$.fragment,Zm),Zm.forEach(t),Jm.forEach(t),sh=l(Ed),Qa=s(Ed,"SPAN",{});var Ym=a(Qa);ah=d(Ym,"LEDForSequenceClassification"),Ym.forEach(t),Ed.forEach(t),Ar=l(o),he=s(o,"DIV",{class:!0});var Ze=a(he);_(_n.$$.fragment,Ze),rh=l(Ze),Ha=s(Ze,"P",{});var ef=a(Ha);dh=d(ef,`LED model with a sequence classification/head on top (a linear layer on top of the pooled output) e.g. for GLUE
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),qd.forEach(t),ph=l(Ze),vn=s(Ze,"P",{});var Ld=a(vn);uh=d(Ld,"This model is also a PyTorch "),bn=s(Ld,"A",{href:!0,rel:!0});var of=a(bn);mh=d(of,"torch.nn.Module"),of.forEach(t),fh=d(Ld,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Ld.forEach(t),_h=l(Ze),A=s(Ze,"DIV",{class:!0});var U=a(A);_(Tn.$$.fragment,U),gh=l(U),Ft=s(U,"P",{});var zs=a(Ft);vh=d(zs,"The "),ms=s(zs,"A",{href:!0});var nf=a(ms);bh=d(nf,"LEDForSequenceClassification"),nf.forEach(t),Th=d(zs," forward method, overrides the "),Wa=s(zs,"CODE",{});var sf=a(Wa);kh=d(sf,"__call__"),sf.forEach(t),wh=d(zs," special method."),zs.forEach(t),yh=l(U),_(so.$$.fragment,U),Eh=l(U),Ua=s(U,"P",{});var af=a(Ua);qh=d(af,"Example of single-label classification:"),af.forEach(t),Lh=l(U),_(kn.$$.fragment,U),Dh=l(U),_(wn.$$.fragment,U),zh=l(U),Va=s(U,"P",{});var rf=a(Va);$h=d(rf,"Example of multi-label classification:"),rf.forEach(t),Fh=l(U),_(yn.$$.fragment,U),xh=l(U),_(En.$$.fragment,U),U.forEach(t),Ze.forEach(t),Nr=l(o),xt=s(o,"H2",{class:!0});var Dd=a(xt);ao=s(Dd,"A",{id:!0,class:!0,href:!0});var df=a(ao);Ra=s(df,"SPAN",{});var lf=a(Ra);_(qn.$$.fragment,lf),lf.forEach(t),df.forEach(t),Mh=l(Dd),Ka=s(Dd,"SPAN",{});var cf=a(Ka);Sh=d(cf,"LEDForQuestionAnswering"),cf.forEach(t),Dd.forEach(t),jr=l(o),pe=s(o,"DIV",{class:!0});var Ye=a(pe);_(Ln.$$.fragment,Ye),Ch=l(Ye),Mt=s(Ye,"P",{});var $s=a(Mt);Oh=d($s,`LED Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear layer
on top of the hidden-states output to compute `),Xa=s($s,"CODE",{});var hf=a(Xa);Ph=d(hf,"span start logits"),hf.forEach(t),Ah=d($s," and "),Ja=s($s,"CODE",{});var pf=a(Ja);Nh=d(pf,"span end logits"),pf.forEach(t),jh=d($s,")."),$s.forEach(t),Ih=l(Ye),Dn=s(Ye,"P",{});var zd=a(Dn);Gh=d(zd,"This model inherits from "),fs=s(zd,"A",{href:!0});var uf=a(fs);Bh=d(uf,"PreTrainedModel"),uf.forEach(t),Qh=d(zd,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),$d.forEach(t),Rh=l(Ye),te=s(Ye,"DIV",{class:!0});var Ae=a(te);_(Fn.$$.fragment,Ae),Kh=l(Ae),St=s(Ae,"P",{});var Fs=a(St);Xh=d(Fs,"The "),_s=s(Fs,"A",{href:!0});var ff=a(_s);Jh=d(ff,"LEDForQuestionAnswering"),ff.forEach(t),Zh=d(Fs," forward method, overrides the "),Za=s(Fs,"CODE",{});var _f=a(Za);Yh=d(_f,"__call__"),_f.forEach(t),ep=d(Fs," special method."),Fs.forEach(t),tp=l(Ae),_(ro.$$.fragment,Ae),op=l(Ae),Ya=s(Ae,"P",{});var gf=a(Ya);np=d(gf,"Example:"),gf.forEach(t),sp=l(Ae),_(xn.$$.fragment,Ae),ap=l(Ae),_(Mn.$$.fragment,Ae),Ae.forEach(t),Ye.forEach(t),Ir=l(o),Ct=s(o,"H2",{class:!0});var Fd=a(Ct);io=s(Fd,"A",{id:!0,class:!0,href:!0});var vf=a(io);er=s(vf,"SPAN",{});var bf=a(er);_(Sn.$$.fragment,bf),bf.forEach(t),vf.forEach(t),rp=l(Fd),tr=s(Fd,"SPAN",{});var Tf=a(tr);dp=d(Tf,"TFLEDModel"),Tf.forEach(t),Fd.forEach(t),Gr=l(o),ue=s(o,"DIV",{class:!0});var et=a(ue);_(Cn.$$.fragment,et),ip=l(et),On=s(et,"P",{});var xd=a(On);lp=d(xd,`The bare LED Model outputting raw hidden-states without any specific head on top.
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Md.forEach(t),_p=l(et),_(lo.$$.fragment,et),gp=l(et),ke=s(et,"DIV",{class:!0});var tt=a(ke);_(Nn.$$.fragment,tt),vp=l(tt),Ot=s(tt,"P",{});var xs=a(Ot);bp=d(xs,"The "),vs=s(xs,"A",{href:!0});var yf=a(vs);Tp=d(yf,"TFLEDModel"),yf.forEach(t),kp=d(xs," forward method, overrides the "),or=s(xs,"CODE",{});var Ef=a(or);wp=d(Ef,"__call__"),Ef.forEach(t),yp=d(xs," special method."),xs.forEach(t),Ep=l(tt),_(co.$$.fragment,tt),qp=l(tt),nr=s(tt,"P",{});var qf=a(nr);Lp=d(qf,"Example:"),qf.forEach(t),Dp=l(tt),_(jn.$$.fragment,tt),tt.forEach(t),et.forEach(t),Br=l(o),Pt=s(o,"H2",{class:!0});var Sd=a(Pt);ho=s(Sd,"A",{id:!0,class:!0,href:!0});var Lf=a(ho);sr=s(Lf,"SPAN",{});var Df=a(sr);_(In.$$.fragment,Df),Df.forEach(t),Lf.forEach(t),zp=l(Sd),ar=s(Sd,"SPAN",{});var zf=a(ar);$p=d(zf,"TFLEDForConditionalGeneration"),zf.forEach(t),Sd.forEach(t),Qr=l(o),me=s(o,"DIV",{class:!0});var ot=a(me);_(Gn.$$.fragment,ot),Fp=l(ot),Bn=s(ot,"P",{});var Cd=a(Bn);xp=d(Cd,`The LED Model with a language modeling head. Can be used for summarization.
This model inherits from `),bs=s(Cd,"A",{href:!0});var $f=a(bs);Mp=d($f,"TFPreTrainedModel"),$f.forEach(t),Sp=d(Cd,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Od.forEach(t),Np=l(ot),_(po.$$.fragment,ot),jp=l(ot),we=s(ot,"DIV",{class:!0});var nt=a(we);_(Wn.$$.fragment,nt),Ip=l(nt),At=s(nt,"P",{});var Ms=a(At);Gp=d(Ms,"The "),Ts=s(Ms,"A",{href:!0});var xf=a(Ts);Bp=d(xf,"TFLEDForConditionalGeneration"),xf.forEach(t),Qp=d(Ms," forward method, overrides the "),rr=s(Ms,"CODE",{});var Mf=a(rr);Hp=d(Mf,"__call__"),Mf.forEach(t),Wp=d(Ms," special method."),Ms.forEach(t),Up=l(nt),_(uo.$$.fragment,nt),Vp=l(nt),dr=s(nt,"P",{});var Sf=a(dr);Rp=d(Sf,"Examples:"),Sf.forEach(t),Kp=l(nt),_(Un.$$.fragment,nt),nt.forEach(t),ot.forEach(t),this.h()},h(){c(u,"name","hf:doc:metadata"),c(u,"content",JSON.stringify(Rf)),c(E,"id","led"),c(E,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(E,"href","#led"),c(k,"class","relative group"),c(Y,"id","overview"),c(Y,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(Y,"href","#overview"),c(z,"class","relative group"),c(se,"href","https://arxiv.org/abs/2004.05150"),c(se,"rel","nofollow"),c(Q,"href","/docs/transformers/v4.18.0/en/model_doc/led#transformers.LEDForConditionalGeneration"),c(j,"href","/docs/transformers/v4.18.0/en/model_doc/bart#transformers.BartForConditionalGeneration"),c(Oe,"href","/docs/transformers/v4.18.0/en/model_doc/led#transformers.LEDTokenizer"),c(Pe,"href","/docs/transformers/v4.18.0/en/model_doc/bart#transformers.BartTokenizer"),c(Kn,"href","/docs/transformers/v4.18.0/en/model_doc/led#transformers.LEDTokenizer"),c(Xn,"href","/docs/transformers/v4.18.0/en/model_doc/longformer#transformers.LongformerModel"),c(bo,"href","https://colab.research.google.com/drive/12INTTR6n64TzS4RrXZxMSXfrOd9Xzamo?usp=sharing"),c(bo,"rel","nofollow"),c(ko,"href","https://colab.research.google.com/drive/12LjJazBl7Gam0XBPy_y0CTOJZeZ34c2v?usp=sharing"),c(ko,"rel","nofollow"),c(wo,"href","https://huggingface.co/patrickvonplaten"),c(wo,"rel","nofollow"),c(jt,"id","transformers.LEDConfig"),c(jt,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(jt,"href","#transformers.LEDConfig"),c(ht,"class","relative group"),c(Jn,"href","/docs/transformers/v4.18.0/en/model_doc/led#transformers.LEDModel"),c(qo,"href","https://huggingface.co/allenai/led-base-16384"),c(qo,"rel","nofollow"),c(Zn,"href","/docs/transformers/v4.18.0/en/main_classes/configuration#transformers.PretrainedConfig"),c(Yn,"href","/docs/transformers/v4.18.0/en/main_classes/configuration#transformers.PretrainedConfig"),c(Gt,"id","initializing-a-led-allenai/led-base-16384-style-configuration->>>-configuration-=-ledconfig()"),c(Gt,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(Gt,"href","#initializing-a-led-allenai/led-base-16384-style-configuration->>>-configuration-=-ledconfig()"),c(It,"class","relative group"),c(Qt,"id","initializing-a-model-from-the-allenai/led-base-16384-style-configuration->>>-model-="),c(Qt,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(Qt,"href","#initializing-a-model-from-the-allenai/led-base-16384-style-configuration->>>-model-="),c(Bt,"class","relative group"),c(Wt,"id","accessing-the-model-configuration->>>-configuration-=-model.config"),c(Wt,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(Wt,"href","#accessing-the-model-configuration->>>-configuration-=-model.config"),c(Ht,"class","relative group"),c(O,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),c(Ut,"id","transformers.LEDTokenizer"),c(Ut,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(Ut,"href","#transformers.LEDTokenizer"),c(mt,"class","relative group"),c(es,"href","/docs/transformers/v4.18.0/en/model_doc/led#transformers.LEDTokenizer"),c(ts,"href","/docs/transformers/v4.18.0/en/model_doc/bart#transformers.BartTokenizer"),c(os,"href","/docs/transformers/v4.18.0/en/model_doc/bart#transformers.BartTokenizer"),c(Ke,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),c(Rt,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),c(Kt,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),c(as,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),c(N,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),c(Xt,"id","transformers.LEDTokenizerFast"),c(Xt,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(Xt,"href","#transformers.LEDTokenizerFast"),c(ft,"class","relative group"),c(rs,"href","/docs/transformers/v4.18.0/en/model_doc/led#transformers.LEDTokenizerFast"),c(ds,"href","/docs/transformers/v4.18.0/en/model_doc/bart#transformers.BartTokenizerFast"),c(is,"href","/docs/transformers/v4.18.0/en/model_doc/bart#transformers.BartTokenizerFast"),c($e,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),c(Zt,"id","transformers.models.led.modeling_led.LEDEncoderBaseModelOutput"),c(Zt,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(Zt,"href","#transformers.models.led.modeling_led.LEDEncoderBaseModelOutput"),c(_t,"class","relative group"),c(gt,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),c(vt,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),c(bt,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),c(Tt,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),c(kt,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),c(wt,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),c(yt,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),c(Et,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),c(Yt,"id","transformers.LEDModel"),c(Yt,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(Yt,"href","#transformers.LEDModel"),c(qt,"class","relative group"),c(ls,"href","/docs/transformers/v4.18.0/en/main_classes/model#transformers.PreTrainedModel"),c(nn,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),c(nn,"rel","nofollow"),c(cs,"href","/docs/transformers/v4.18.0/en/model_doc/led#transformers.LEDModel"),c(Te,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),c(Fe,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),c(to,"id","transformers.LEDForConditionalGeneration"),c(to,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(to,"href","#transformers.LEDForConditionalGeneration"),c(Dt,"class","relative group"),c(hs,"href","/docs/transformers/v4.18.0/en/main_classes/model#transformers.PreTrainedModel"),c(hn,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),c(hn,"rel","nofollow"),c(ps,"href","/docs/transformers/v4.18.0/en/model_doc/led#transformers.LEDForConditionalGeneration"),c(H,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),c(xe,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),c(no,"id","transformers.LEDForSequenceClassification"),c(no,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(no,"href","#transformers.LEDForSequenceClassification"),c($t,"class","relative group"),c(us,"href","/docs/transformers/v4.18.0/en/main_classes/model#transformers.PreTrainedModel"),c(bn,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),c(bn,"rel","nofollow"),c(ms,"href","/docs/transformers/v4.18.0/en/model_doc/led#transformers.LEDForSequenceClassification"),c(A,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),c(he,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),c(ao,"id","transformers.LEDForQuestionAnswering"),c(ao,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(ao,"href","#transformers.LEDForQuestionAnswering"),c(xt,"class","relative group"),c(fs,"href","/docs/transformers/v4.18.0/en/main_classes/model#transformers.PreTrainedModel"),c($n,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),c($n,"rel","nofollow"),c(_s,"href","/docs/transformers/v4.18.0/en/model_doc/led#transformers.LEDForQuestionAnswering"),c(te,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),c(pe,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),c(io,"id","transformers.TFLEDModel"),c(io,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(io,"href","#transformers.TFLEDModel"),c(Ct,"class","relative group"),c(gs,"href","/docs/transformers/v4.18.0/en/main_classes/model#transformers.TFPreTrainedModel"),c(An,"href","https://www.tensorflow.org/api_docs/python/tf/keras/Model"),c(An,"rel","nofollow"),c(vs,"href","/docs/transformers/v4.18.0/en/model_doc/led#transformers.TFLEDModel"),c(ke,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),c(ue,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),c(ho,"id","transformers.TFLEDForConditionalGeneration"),c(ho,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(ho,"href","#transformers.TFLEDForConditionalGeneration"),c(Pt,"class","relative group"),c(bs,"href","/docs/transformers/v4.18.0/en/main_classes/model#transformers.TFPreTrainedModel"),c(Hn,"href","https://www.tensorflow.org/api_docs/python/tf/keras/Model"),c(Hn,"rel","nofollow"),c(Ts,"href","/docs/transformers/v4.18.0/en/model_doc/led#transformers.TFLEDForConditionalGeneration"),c(we,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),c(me,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8")},m(o,p){e(document.head,u),h(o,L,p),h(o,k,p),e(k,E),e(E,q),g(y,q,null),e(k,w),e(k,D),e(D,je),h(o,ge,p),h(o,z,p),e(z,Y),e(Y,V),g(ne,V,null),e(z,Ie),e(z,R),e(R,Ge),h(o,Me,p),h(o,B,p),e(B,K),e(B,se),e(se,Le),e(B,S),h(o,P,p),h(o,ve,p),e(ve,ae),h(o,Se,p),h(o,be,p),e(be,X),e(X,Be),h(o,Ce,p),h(o,C,p),e(C,Qe),h(o,ee,p),h(o,x,p),e(x,M),e(M,Q),e(Q,He),e(M,We),e(M,j),e(j,Ue),e(M,re),e(M,De),e(De,m),e(M,$),e(M,de),e(de,st),e(M,at),e(M,I),e(I,rt),e(M,dt),e(M,Oe),e(Oe,J),e(M,ie),e(M,Pe),e(Pe,it),e(M,le),e(x,lt),e(x,ce),e(ce,Ve),e(ce,Re),e(Re,Pd),e(ce,Ad),e(ce,Ss),e(Ss,Nd),e(ce,jd),e(x,Id),e(x,ze),e(ze,Gd),e(ze,Cs),e(Cs,Bd),e(ze,Qd),e(ze,Os),e(Os,Hd),e(ze,Wd),e(ze,Kn),e(Kn,Ud),e(ze,Vd),e(ze,Ps),e(Ps,Rd),e(ze,Kd),e(x,Xd),e(x,Z),e(Z,Jd),e(Z,As),e(As,Zd),e(Z,Yd),e(Z,Ns),e(Ns,ei),e(Z,ti),e(Z,Xn),e(Xn,oi),e(Z,ni),e(Z,js),e(js,si),e(Z,ai),e(Z,Is),e(Is,ri),e(Z,di),e(Z,Gs),e(Gs,ii),e(Z,li),e(x,ci),e(x,ct),e(ct,hi),e(ct,Bs),e(Bs,pi),e(ct,ui),e(ct,Qs),e(Qs,mi),e(ct,fi),e(x,_i),e(x,vo),e(vo,gi),e(vo,bo),e(bo,vi),e(vo,bi),e(x,Ti),e(x,To),e(To,ki),e(To,ko),e(ko,wi),e(To,yi),h(o,_r,p),h(o,Nt,p),e(Nt,Ei),e(Nt,wo),e(wo,qi),e(Nt,Li),h(o,gr,p),h(o,ht,p),e(ht,jt),e(jt,Hs),g(yo,Hs,null),e(ht,Di),e(ht,Ws),e(Ws,zi),h(o,vr,p),h(o,O,p),g(Eo,O,null),e(O,$i),e(O,pt),e(pt,Fi),e(pt,Jn),e(Jn,xi),e(pt,Mi),e(pt,qo),e(qo,Si),e(pt,Ci),e(O,Oi),e(O,ut),e(ut,Pi),e(ut,Zn),e(Zn,Ai),e(ut,Ni),e(ut,Yn),e(Yn,ji),e(ut,Ii),e(O,Gi),e(O,Us),e(Us,Bi),e(O,Qi),g(Lo,O,null),e(O,Hi),e(O,Vs),e(Vs,Rs),e(Rs,Ks),e(Ks,Xs),e(Xs,Wi),e(O,Ui),e(O,Js),e(Js,Zs),e(Zs,Ys),e(Ys,It),e(It,Gt),e(Gt,ea),g(Do,ea,null),e(It,Vi),e(It,ta),e(ta,Ri),e(O,Ki),e(O,oa),e(oa,na),e(na,zo),e(zo,Bt),e(Bt,Qt),e(Qt,sa),g($o,sa,null),e(Bt,Xi),e(Bt,aa),e(aa,Ji),e(zo,Zi),e(zo,ra),e(ra,Yi),e(O,el),e(O,da),e(da,ia),e(ia,la),e(la,Ht),e(Ht,Wt),e(Wt,ca),g(Fo,ca,null),e(Ht,tl),e(Ht,ha),e(ha,ol),h(o,br,p),h(o,mt,p),e(mt,Ut),e(Ut,pa),g(xo,pa,null),e(mt,nl),e(mt,ua),e(ua,sl),h(o,Tr,p),h(o,N,p),g(Mo,N,null),e(N,al),e(N,ma),e(ma,rl),e(N,dl),e(N,Vt),e(Vt,es),e(es,il),e(Vt,ll),e(Vt,ts),e(ts,cl),e(Vt,hl),e(N,pl),e(N,So),e(So,ul),e(So,os),e(os,ml),e(So,fl),e(N,_l),e(N,Ke),g(Co,Ke,null),e(Ke,gl),e(Ke,fa),e(fa,vl),e(Ke,bl),e(Ke,Oo),e(Oo,ns),e(ns,Tl),e(ns,_a),e(_a,kl),e(Oo,wl),e(Oo,ss),e(ss,yl),e(ss,ga),e(ga,El),e(N,ql),e(N,Rt),g(Po,Rt,null),e(Rt,Ll),e(Rt,Ao),e(Ao,Dl),e(Ao,va),e(va,zl),e(Ao,$l),e(N,Fl),e(N,Kt),g(No,Kt,null),e(Kt,xl),e(Kt,ba),e(ba,Ml),e(N,Sl),e(N,as),g(jo,as,null),h(o,kr,p),h(o,ft,p),e(ft,Xt),e(Xt,Ta),g(Io,Ta,null),e(ft,Cl),e(ft,ka),e(ka,Ol),h(o,wr,p),h(o,$e,p),g(Go,$e,null),e($e,Pl),e($e,Bo),e(Bo,Al),e(Bo,wa),e(wa,Nl),e(Bo,jl),e($e,Il),e($e,Jt),e(Jt,rs),e(rs,Gl),e(Jt,Bl),e(Jt,ds),e(ds,Ql),e(Jt,Hl),e($e,Wl),e($e,Qo),e(Qo,Ul),e(Qo,is),e(is,Vl),e(Qo,Rl),h(o,yr,p),h(o,_t,p),e(_t,Zt),e(Zt,ya),g(Ho,ya,null),e(_t,Kl),e(_t,Ea),e(Ea,Xl),h(o,Er,p),h(o,gt,p),g(Wo,gt,null),e(gt,Jl),e(gt,qa),e(qa,Zl),h(o,qr,p),h(o,vt,p),g(Uo,vt,null),e(vt,Yl),e(vt,La),e(La,ec),h(o,Lr,p),h(o,bt,p),g(Vo,bt,null),e(bt,tc),e(bt,Da),e(Da,oc),h(o,Dr,p),h(o,Tt,p),g(Ro,Tt,null),e(Tt,nc),e(Tt,za),e(za,sc),h(o,zr,p),h(o,kt,p),g(Ko,kt,null),e(kt,ac),e(kt,$a),e($a,rc),h(o,$r,p),h(o,wt,p),g(Xo,wt,null),e(wt,dc),e(wt,Fa),e(Fa,ic),h(o,Fr,p),h(o,yt,p),g(Jo,yt,null),e(yt,lc),e(yt,xa),e(xa,cc),h(o,xr,p),h(o,Et,p),g(Zo,Et,null),e(Et,hc),e(Et,Ma),e(Ma,pc),h(o,Mr,p),h(o,qt,p),e(qt,Yt),e(Yt,Sa),g(Yo,Sa,null),e(qt,uc),e(qt,Ca),e(Ca,mc),h(o,Sr,p),h(o,Fe,p),g(en,Fe,null),e(Fe,fc),e(Fe,tn),e(tn,_c),e(tn,ls),e(ls,gc),e(tn,vc),e(Fe,bc),e(Fe,on),e(on,Tc),e(on,nn),e(nn,kc),e(on,wc),e(Fe,yc),e(Fe,Te),g(sn,Te,null),e(Te,Ec),e(Te,Lt),e(Lt,qc),e(Lt,cs),e(cs,Lc),e(Lt,Dc),e(Lt,Oa),e(Oa,zc),e(Lt,$c),e(Te,Fc),g(eo,Te,null),e(Te,xc),e(Te,Pa),e(Pa,Mc),e(Te,Sc),g(an,Te,null),h(o,Cr,p),h(o,Dt,p),e(Dt,to),e(to,Aa),g(rn,Aa,null),e(Dt,Cc),e(Dt,Na),e(Na,Oc),h(o,Or,p),h(o,xe,p),g(dn,xe,null),e(xe,Pc),e(xe,ln),e(ln,Ac),e(ln,hs),e(hs,Nc),e(ln,jc),e(xe,Ic),e(xe,cn),e(cn,Gc),e(cn,hn),e(hn,Bc),e(cn,Qc),e(xe,Hc),e(xe,H),g(pn,H,null),e(H,Wc),e(H,zt),e(zt,Uc),e(zt,ps),e(ps,Vc),e(zt,Rc),e(zt,ja),e(ja,Kc),e(zt,Xc),e(H,Jc),g(oo,H,null),e(H,Zc),e(H,Ia),e(Ia,Yc),e(H,eh),g(un,H,null),e(H,th),e(H,Ga),e(Ga,oh),e(H,nh),g(mn,H,null),h(o,Pr,p),h(o,$t,p),e($t,no),e(no,Ba),g(fn,Ba,null),e($t,sh),e($t,Qa),e(Qa,ah),h(o,Ar,p),h(o,he,p),g(_n,he,null),e(he,rh),e(he,Ha),e(Ha,dh),e(he,ih),e(he,gn),e(gn,lh),e(gn,us),e(us,ch),e(gn,hh),e(he,ph),e(he,vn),e(vn,uh),e(vn,bn),e(bn,mh),e(vn,fh),e(he,_h),e(he,A),g(Tn,A,null),e(A,gh),e(A,Ft),e(Ft,vh),e(Ft,ms),e(ms,bh),e(Ft,Th),e(Ft,Wa),e(Wa,kh),e(Ft,wh),e(A,yh),g(so,A,null),e(A,Eh),e(A,Ua),e(Ua,qh),e(A,Lh),g(kn,A,null),e(A,Dh),g(wn,A,null),e(A,zh),e(A,Va),e(Va,$h),e(A,Fh),g(yn,A,null),e(A,xh),g(En,A,null),h(o,Nr,p),h(o,xt,p),e(xt,ao),e(ao,Ra),g(qn,Ra,null),e(xt,Mh),e(xt,Ka),e(Ka,Sh),h(o,jr,p),h(o,pe,p),g(Ln,pe,null),e(pe,Ch),e(pe,Mt),e(Mt,Oh),e(Mt,Xa),e(Xa,Ph),e(Mt,Ah),e(Mt,Ja),e(Ja,Nh),e(Mt,jh),e(pe,Ih),e(pe,Dn),e(Dn,Gh),e(Dn,fs),e(fs,Bh),e(Dn,Qh),e(pe,Hh),e(pe,zn),e(zn,Wh),e(zn,$n),e($n,Uh),e(zn,Vh),e(pe,Rh),e(pe,te),g(Fn,te,null),e(te,Kh),e(te,St),e(St,Xh),e(St,_s),e(_s,Jh),e(St,Zh),e(St,Za),e(Za,Yh),e(St,ep),e(te,tp),g(ro,te,null),e(te,op),e(te,Ya),e(Ya,np),e(te,sp),g(xn,te,null),e(te,ap),g(Mn,te,null),h(o,Ir,p),h(o,Ct,p),e(Ct,io),e(io,er),g(Sn,er,null),e(Ct,rp),e(Ct,tr),e(tr,dp),h(o,Gr,p),h(o,ue,p),g(Cn,ue,null),e(ue,ip),e(ue,On),e(On,lp),e(On,gs),e(gs,cp),e(On,hp),e(ue,pp),e(ue,Pn),e(Pn,up),e(Pn,An),e(An,mp),e(Pn,fp),e(ue,_p),g(lo,ue,null),e(ue,gp),e(ue,ke),g(Nn,ke,null),e(ke,vp),e(ke,Ot),e(Ot,bp),e(Ot,vs),e(vs,Tp),e(Ot,kp),e(Ot,or),e(or,wp),e(Ot,yp),e(ke,Ep),g(co,ke,null),e(ke,qp),e(ke,nr),e(nr,Lp),e(ke,Dp),g(jn,ke,null),h(o,Br,p),h(o,Pt,p),e(Pt,ho),e(ho,sr),g(In,sr,null),e(Pt,zp),e(Pt,ar),e(ar,$p),h(o,Qr,p),h(o,me,p),g(Gn,me,null),e(me,Fp),e(me,Bn),e(Bn,xp),e(Bn,bs),e(bs,Mp),e(Bn,Sp),e(me,Cp),e(me,Qn),e(Qn,Op),e(Qn,Hn),e(Hn,Pp),e(Qn,Ap),e(me,Np),g(po,me,null),e(me,jp),e(me,we),g(Wn,we,null),e(we,Ip),e(we,At),e(At,Gp),e(At,Ts),e(Ts,Bp),e(At,Qp),e(At,rr),e(rr,Hp),e(At,Wp),e(we,Up),g(uo,we,null),e(we,Vp),e(we,dr),e(dr,Rp),e(we,Kp),g(Un,we,null),Hr=!0},p(o,[p]){const Vn={};p&2&&(Vn.$$scope={dirty:p,ctx:o}),eo.$set(Vn);const ir={};p&2&&(ir.$$scope={dirty:p,ctx:o}),oo.$set(ir);const lr={};p&2&&(lr.$$scope={dirty:p,ctx:o}),so.$set(lr);const cr={};p&2&&(cr.$$scope={dirty:p,ctx:o}),ro.$set(cr);const Rn={};p&2&&(Rn.$$scope={dirty:p,ctx:o}),lo.$set(Rn);const hr={};p&2&&(hr.$$scope={dirty:p,ctx:o}),co.$set(hr);const pr={};p&2&&(pr.$$scope={dirty:p,ctx:o}),po.$set(pr);const ur={};p&2&&(ur.$$scope={dirty:p,ctx:o}),uo.$set(ur)},i(o){Hr||(v(y.$$.fragment,o),v(ne.$$.fragment,o),v(yo.$$.fragment,o),v(Eo.$$.fragment,o),v(Lo.$$.fragment,o),v(Do.$$.fragment,o),v($o.$$.fragment,o),v(Fo.$$.fragment,o),v(xo.$$.fragment,o),v(Mo.$$.fragment,o),v(Co.$$.fragment,o),v(Po.$$.fragment,o),v(No.$$.fragment,o),v(jo.$$.fragment,o),v(Io.$$.fragment,o),v(Go.$$.fragment,o),v(Ho.$$.fragment,o),v(Wo.$$.fragment,o),v(Uo.$$.fragment,o),v(Vo.$$.fragment,o),v(Ro.$$.fragment,o),v(Ko.$$.fragment,o),v(Xo.$$.fragment,o),v(Jo.$$.fragment,o),v(Zo.$$.fragment,o),v(Yo.$$.fragment,o),v(en.$$.fragment,o),v(sn.$$.fragment,o),v(eo.$$.fragment,o),v(an.$$.fragment,o),v(rn.$$.fragment,o),v(dn.$$.fragment,o),v(pn.$$.fragment,o),v(oo.$$.fragment,o),v(un.$$.fragment,o),v(mn.$$.fragment,o),v(fn.$$.fragment,o),v(_n.$$.fragment,o),v(Tn.$$.fragment,o),v(so.$$.fragment,o),v(kn.$$.fragment,o),v(wn.$$.fragment,o),v(yn.$$.fragment,o),v(En.$$.fragment,o),v(qn.$$.fragment,o),v(Ln.$$.fragment,o),v(Fn.$$.fragment,o),v(ro.$$.fragment,o),v(xn.$$.fragment,o),v(Mn.$$.fragment,o),v(Sn.$$.fragment,o),v(Cn.$$.fragment,o),v(lo.$$.fragment,o),v(Nn.$$.fragment,o),v(co.$$.fragment,o),v(jn.$$.fragment,o),v(In.$$.fragment,o),v(Gn.$$.fragment,o),v(po.$$.fragment,o),v(Wn.$$.fragment,o),v(uo.$$.fragment,o),v(Un.$$.fragment,o),Hr=!0)},o(o){b(y.$$.fragment,o),b(ne.$$.fragment,o),b(yo.$$.fragment,o),b(Eo.$$.fragment,o),b(Lo.$$.fragment,o),b(Do.$$.fragment,o),b($o.$$.fragment,o),b(Fo.$$.fragment,o),b(xo.$$.fragment,o),b(Mo.$$.fragment,o),b(Co.$$.fragment,o),b(Po.$$.fragment,o),b(No.$$.fragment,o),b(jo.$$.fragment,o),b(Io.$$.fragment,o),b(Go.$$.fragment,o),b(Ho.$$.fragment,o),b(Wo.$$.fragment,o),b(Uo.$$.fragment,o),b(Vo.$$.fragment,o),b(Ro.$$.fragment,o),b(Ko.$$.fragment,o),b(Xo.$$.fragment,o),b(Jo.$$.fragment,o),b(Zo.$$.fragment,o),b(Yo.$$.fragment,o),b(en.$$.fragment,o),b(sn.$$.fragment,o),b(eo.$$.fragment,o),b(an.$$.fragment,o),b(rn.$$.fragment,o),b(dn.$$.fragment,o),b(pn.$$.fragment,o),b(oo.$$.fragment,o),b(un.$$.fragment,o),b(mn.$$.fragment,o),b(fn.$$.fragment,o),b(_n.$$.fragment,o),b(Tn.$$.fragment,o),b(so.$$.fragment,o),b(kn.$$.fragment,o),b(wn.$$.fragment,o),b(yn.$$.fragment,o),b(En.$$.fragment,o),b(qn.$$.fragment,o),b(Ln.$$.fragment,o),b(Fn.$$.fragment,o),b(ro.$$.fragment,o),b(xn.$$.fragment,o),b(Mn.$$.fragment,o),b(Sn.$$.fragment,o),b(Cn.$$.fragment,o),b(lo.$$.fragment,o),b(Nn.$$.fragment,o),b(co.$$.fragment,o),b(jn.$$.fragment,o),b(In.$$.fragment,o),b(Gn.$$.fragment,o),b(po.$$.fragment,o),b(Wn.$$.fragment,o),b(uo.$$.fragment,o),b(Un.$$.fragment,o),Hr=!1},d(o){t(u),o&&t(L),o&&t(k),T(y),o&&t(ge),o&&t(z),T(ne),o&&t(Me),o&&t(B),o&&t(P),o&&t(ve),o&&t(Se),o&&t(be),o&&t(Ce),o&&t(C),o&&t(ee),o&&t(x),o&&t(_r),o&&t(Nt),o&&t(gr),o&&t(ht),T(yo),o&&t(vr),o&&t(O),T(Eo),T(Lo),T(Do),T($o),T(Fo),o&&t(br),o&&t(mt),T(xo),o&&t(Tr),o&&t(N),T(Mo),T(Co),T(Po),T(No),T(jo),o&&t(kr),o&&t(ft),T(Io),o&&t(wr),o&&t($e),T(Go),o&&t(yr),o&&t(_t),T(Ho),o&&t(Er),o&&t(gt),T(Wo),o&&t(qr),o&&t(vt),T(Uo),o&&t(Lr),o&&t(bt),T(Vo),o&&t(Dr),o&&t(Tt),T(Ro),o&&t(zr),o&&t(kt),T(Ko),o&&t($r),o&&t(wt),T(Xo),o&&t(Fr),o&&t(yt),T(Jo),o&&t(xr),o&&t(Et),T(Zo),o&&t(Mr),o&&t(qt),T(Yo),o&&t(Sr),o&&t(Fe),T(en),T(sn),T(eo),T(an),o&&t(Cr),o&&t(Dt),T(rn),o&&t(Or),o&&t(xe),T(dn),T(pn),T(oo),T(un),T(mn),o&&t(Pr),o&&t($t),T(fn),o&&t(Ar),o&&t(he),T(_n),T(Tn),T(so),T(kn),T(wn),T(yn),T(En),o&&t(Nr),o&&t(xt),T(qn),o&&t(jr),o&&t(pe),T(Ln),T(Fn),T(ro),T(xn),T(Mn),o&&t(Ir),o&&t(Ct),T(Sn),o&&t(Gr),o&&t(ue),T(Cn),T(lo),T(Nn),T(co),T(jn),o&&t(Br),o&&t(Pt),T(In),o&&t(Qr),o&&t(me),T(Gn),T(po),T(Wn),T(uo),T(Un)}}}const Rf={local:"led",sections:[{local:"overview",title:"Overview"},{local:"transformers.LEDConfig",title:"LEDConfig"},{local:"transformers.LEDTokenizer",title:"LEDTokenizer"},{local:"transformers.LEDTokenizerFast",title:"LEDTokenizerFast"},{local:"transformers.models.led.modeling_led.LEDEncoderBaseModelOutput",title:"LED specific outputs"},{local:"transformers.LEDModel",title:"LEDModel"},{local:"transformers.LEDForConditionalGeneration",title:"LEDForConditionalGeneration"},{local:"transformers.LEDForSequenceClassification",title:"LEDForSequenceClassification"},{local:"transformers.LEDForQuestionAnswering",title:"LEDForQuestionAnswering"},{local:"transformers.TFLEDModel",title:"TFLEDModel"},{local:"transformers.TFLEDForConditionalGeneration",title:"TFLEDForConditionalGeneration"}],title:"LED"};function Kf(G){return Nf(()=>{new URLSearchParams(window.location.search).get("fw")}),[]}class t_ extends Cf{constructor(u){super();Of(this,u,Kf,Vf,Pf,{})}}export{t_ as default,Rf as metadata};
