...
<p><a
  href="/docs/transformers/v4.18.0/en/main_classes/tokenizer#transformers.BatchEncoding"
>BatchEncoding</a></p>
`}}),H=new qt({props:{name:"save_vocabulary",anchor:"transformers.MLukeTokenizer.save_vocabulary",parameters:[{name:"save_directory",val:": str"},{name:"filename_prefix",val:": typing.Optional[str] = None"}],source:"https://github.com/huggingface/transformers/blob/v4.18.0/src/transformers/models/mluke/tokenization_mluke.py#L1492"}}),{c(){k=o("meta"),fe=p(),y=o("h1"),w=o("a"),ae=o("span"),E(U.$$.fragment),We=p(),le=o("span"),Ke=r("mLUKE"),ge=p(),v=o("h2"),T=o("a"),ce=o("span"),E(S.$$.fragment),Re=p(),de=o("span"),De=r("Overview"),_e=p(),f=o("p"),Fe=r("The mLUKE model was proposed in "),W=o("a"),Oe=r("mLUKE: The Power of Entity Representations in Multilingual Pretrained Language Models"),Be=r(` by Ryokan Ri, Ikuya Yamada, and Yoshimasa Tsuruoka. It\u2019s a multilingual extension
...
tips, code examples and notebooks.`),xe=p(),g=o("p"),nt=r("This model was contributed by "),F=o("a"),ot=r("ryo0634"),st=r(". The original code can be found "),O=o("a"),it=r("here"),rt=r("."),ze=p(),b=o("h2"),x=o("a"),ue=o("span"),E(B.$$.fragment),at=p(),me=o("span"),lt=r("MLukeTokenizer"),Me=p(),m=o("div"),E(j.$$.fragment),ct=p(),h=o("p"),dt=r("Adapted from "),te=o("a"),pt=r("XLMRobertaTokenizer"),ut=r(" and "),ne=o("a"),mt=r("LukeTokenizer"),ht=r(`. Based on
...
sequences, depending on the task you want to prepare them for.`),Lt=p(),se=o("div"),E(H.$$.fragment),this.h()},l(e){const c=sn('[data-svelte="svelte-1phssyn"]',document.head);k=s(c,"META",{name:!0,content:!0}),c.forEach(n),fe=u(e),y=s(e,"H1",{class:!0});var $e=i(y);w=s($e,"A",{id:!0,class:!0,href:!0});var Mt=i(w);ae=s(Mt,"SPAN",{});var Et=i(ae);$(U.$$.fragment,Et),Et.forEach(n),Mt.forEach(n),We=u($e),le=s($e,"SPAN",{});var $t=i(le);Ke=a($t,"mLUKE"),$t.forEach(n),$e.forEach(n),ge=u(e),v=s(e,"H2",{class:!0});var Pe=i(v);T=s(Pe,"A",{id:!0,class:!0,href:!0});var Pt=i(T);ce=s(Pt,"SPAN",{});var At=i(ce);$(S.$$.fragment,At),At.forEach(n),Pt.forEach(n),Re=u(Pe),de=s(Pe,"SPAN",{});var Nt=i(de);De=a(Nt,"Overview"),Nt.forEach(n),Pe.forEach(n),_e=u(e),f=s(e,"P",{});var ie=i(f);Fe=a(ie,"The mLUKE model was proposed in "),W=s(ie,"A",{href:!0,rel:!0});var It=i(W);Oe=a(It,"mLUKE: The Power of Entity Representations in Multilingual Pretrained Language Models"),It.forEach(n),Be=a(ie,` by Ryokan Ri, Ikuya Yamada, and Yoshimasa Tsuruoka. It\u2019s a multilingual extension
...
tips, code examples and notebooks.`),Ne.forEach(n),xe=u(e),g=s(e,"P",{});var re=i(g);nt=a(re,"This model was contributed by "),F=s(re,"A",{href:!0,rel:!0});var Bt=i(F);ot=a(Bt,"ryo0634"),Bt.forEach(n),st=a(re,". The original code can be found "),O=s(re,"A",{href:!0,rel:!0});var jt=i(O);it=a(jt,"here"),jt.forEach(n),rt=a(re,"."),re.forEach(n),ze=u(e),b=s(e,"H2",{class:!0});var Ie=i(b);x=s(Ie,"A",{id:!0,class:!0,href:!0});var Xt=i(x);ue=s(Xt,"SPAN",{});var Ct=i(ue);$(B.$$.fragment,Ct),Ct.forEach(n),Xt.forEach(n),at=u(Ie),me=s(Ie,"SPAN",{});var Yt=i(me);lt=a(Yt,"MLukeTokenizer"),Yt.forEach(n),Ie.forEach(n),Me=u(e),m=s(e,"DIV",{class:!0});var _=i(m);$(j.$$.fragment,_),ct=u(_),h=s(_,"P",{});var M=i(h);dt=a(M,"Adapted from "),te=s(M,"A",{href:!0});var Ht=i(te);pt=a(Ht,"XLMRobertaTokenizer"),Ht.forEach(n),ut=a(M," and "),ne=s(M,"A",{href:!0});var Vt=i(ne);mt=a(Vt,"LukeTokenizer"),Vt.forEach(n),ht=a(M,`. Based on
`),X=s(M,"A",{href:!0,rel:!0});var Jt=i(X);ft=a(Jt,"SentencePiece"),Jt.forEach(n),gt=a(M,"."),M.forEach(n),_t=u(_),C=s(_,"P",{});var Ue=i(C);kt=a(Ue,"This tokenizer inherits from "),oe=s(Ue,"A",{href:!0});var Gt=i(oe);yt=a(Gt,"PreTrainedTokenizer"),Gt.forEach(n),vt=a(Ue,` which contains most of the main methods. Users should refer to
