...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),vp=l(),Je=n("div"),v(xn.$$.fragment),bp=l(),St=n("p"),Tp=r("The "),da=n("a"),Mp=r("MPNetForMultipleChoice"),wp=r(" forward method, overrides the "),br=n("code"),Pp=r("__call__"),$p=r(" special method."),Np=l(),v(_o.$$.fragment),yp=l(),Tr=n("p"),Fp=r("Example:"),Ep=l(),v(An.$$.fragment),Ii=l(),Dt=n("h2"),ko=n("a"),Mr=n("span"),v(Ln.$$.fragment),zp=l(),wr=n("span"),qp=r("MPNetForTokenClassification"),Si=l(),Be=n("div"),v(In.$$.fragment),Cp=l(),Pr=n("p"),jp=r(`MPNet Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g. for
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Cu=l(),v(Ao.$$.fragment),ju=l(),We=n("div"),v(xs.$$.fragment),xu=l(),Zt=n("p"),Au=r("The "),wa=n("a"),Lu=r("TFMPNetForTokenClassification"),Iu=r(" forward method, overrides the "),oi=n("code"),Su=r("__call__"),Du=r(" special method."),Ou=l(),v(Lo.$$.fragment),Wu=l(),ni=n("p"),Qu=r("Example:"),Hu=l(),v(As.$$.fragment),Ru=l(),v(Ls.$$.fragment),Gi=l(),eo=n("h2"),Io=n("a"),si=n("span"),v(Is.$$.fragment),Uu=l(),ai=n("span"),Vu=r("TFMPNetForQuestionAnswering"),Yi=l(),xe=n("div"),v(Ss.$$.fragment),Bu=l(),to=n("p"),Ku=r(`MPNet Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
...
layers on top of the hidden-states output to compute `),Er=s(ja,"CODE",{});var Hg=a(Er);sh=i(Hg,"span start logits"),Hg.forEach(t),ah=i(ja," and "),zr=s(ja,"CODE",{});var Rg=a(zr);rh=i(Rg,"span end logits"),Rg.forEach(t),ih=i(ja,")."),ja.forEach(t),lh=d(Pt),Vn=s(Pt,"P",{});var yl=a(Vn);dh=i(yl,"This model inherits from "),ha=s(yl,"A",{href:!0});var Ug=a(ha);ch=i(Ug,"PreTrainedModel"),Ug.forEach(t),ph=i(yl,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
