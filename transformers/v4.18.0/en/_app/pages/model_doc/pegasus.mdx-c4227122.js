import{S as jv,i as Sv,s as Ov,e as n,k as d,w as m,t as r,M as Av,c as s,d as t,m as l,a,x as g,h as i,b as c,F as e,g as u,y as f,q as _,o as v,B as k,v as Iv}from"../../chunks/vendor-6b77c823.js";import{T as $o}from"../../chunks/Tip-39098574.js";import{D as C}from"../../chunks/Docstring-af1d0ae0.js";import{C as Se}from"../../chunks/CodeBlock-3a8b25a8.js";import{I as Z}from"../../chunks/IconCopyLink-7a11ce68.js";function Lv(B){let h,z,b,P,x;return{c(){h=n("p"),z=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),b=n("code"),P=r("Module"),x=r(`
...
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),T.forEach(t)},m(w,T){u(w,h,T),e(h,z),e(h,b),e(b,P),e(h,x)},d(w){w&&t(h)}}}function Gv(B){let h,z,b,P,x;return{c(){h=n("p"),z=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),b=n("code"),P=r("Module"),x=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(w){h=s(w,"P",{});var T=a(h);z=i(T,"Although the recipe for forward pass needs to be defined within this function, one should call the "),b=s(T,"CODE",{});var F=a(b);P=i(F,"Module"),F.forEach(t),x=i(T,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),T.forEach(t)},m(w,T){u(w,h,T),e(h,z),e(h,b),e(b,P),e(h,x)},d(w){w&&t(h)}}}function Nv(B){let h,z,b,P,x,w,T,F,Oe,me,q,Pe,ae,Ae,re,ie,Ie,Ce,N,O,xe,H,j,S,Le,Y,ee,Ge,D,Ne,De,A,ge,de,Me,te,K,Ue,We,U,Be,oe,V;return{c(){h=n("p"),z=r("TF 2.0 models accepts two formats as inputs:"),b=d(),P=n("ul"),x=n("li"),w=r("having all inputs as keyword arguments (like PyTorch models), or"),T=d(),F=n("li"),Oe=r("having all inputs as a list, tuple or dict in the first positional arguments."),me=d(),q=n("p"),Pe=r("This second option is useful when using "),ae=n("code"),Ae=r("tf.keras.Model.fit"),re=r(` method which currently requires having all the
...
`),oe=s(R,"CODE",{});var vt=a(oe);V=i(vt,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),vt.forEach(t),R.forEach(t),I.forEach(t)},m(y,$){u(y,h,$),e(h,z),u(y,b,$),u(y,P,$),e(P,x),e(x,w),e(P,T),e(P,F),e(F,Oe),u(y,me,$),u(y,q,$),e(q,Pe),e(q,ae),e(ae,Ae),e(q,re),e(q,ie),e(ie,Ie),e(q,Ce),u(y,N,$),u(y,O,$),e(O,xe),u(y,H,$),u(y,j,$),e(j,S),e(S,Le),e(S,Y),e(Y,ee),e(S,Ge),e(S,D),e(D,Ne),e(j,De),e(j,A),e(A,ge),e(A,de),e(de,Me),e(A,te),e(A,K),e(K,Ue),e(j,We),e(j,U),e(U,Be),e(U,oe),e(oe,V)},d(y){y&&t(h),y&&t(b),y&&t(P),y&&t(me),y&&t(q),y&&t(N),y&&t(O),y&&t(H),y&&t(j)}}}function Dv(B){let h,z,b,P,x;return{c(){h=n("p"),z=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),b=n("code"),P=r("Module"),x=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(w){h=s(w,"P",{});var T=a(h);z=i(T,"Although the recipe for forward pass needs to be defined within this function, one should call the "),b=s(T,"CODE",{});var F=a(b);P=i(F,"Module"),F.forEach(t),x=i(T,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),T.forEach(t)},m(w,T){u(w,h,T),e(h,z),e(h,b),e(b,P),e(h,x)},d(w){w&&t(h)}}}function Uv(B){let h,z,b,P,x,w,T,F,Oe,me,q,Pe,ae,Ae,re,ie,Ie,Ce,N,O,xe,H,j,S,Le,Y,ee,Ge,D,Ne,De,A,ge,de,Me,te,K,Ue,We,U,Be,oe,V;return{c(){h=n("p"),z=r("TF 2.0 models accepts two formats as inputs:"),b=d(),P=n("ul"),x=n("li"),w=r("having all inputs as keyword arguments (like PyTorch models), or"),T=d(),F=n("li"),Oe=r("having all inputs as a list, tuple or dict in the first positional arguments."),me=d(),q=n("p"),Pe=r("This second option is useful when using "),ae=n("code"),Ae=r("tf.keras.Model.fit"),re=r(` method which currently requires having all the
tensors in the first argument of the model call function: `),ie=n("code"),Ie=r("model(inputs)"),Ce=r("."),N=d(),O=n("p"),xe=r(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),H=d(),j=n("ul"),S=n("li"),Le=r("a single Tensor with "),Y=n("code"),ee=r("input_ids"),Ge=r(" only and nothing else: "),D=n("code"),Ne=r("model(input_ids)"),De=d(),A=n("li"),ge=r(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),de=n("code"),Me=r("model([input_ids, attention_mask])"),te=r(" or "),K=n("code"),Ue=r("model([input_ids, attention_mask, token_type_ids])"),We=d(),U=n("li"),Be=r(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),oe=n("code"),V=r('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(y){h=s(y,"P",{});var $=a(h);z=i($,"TF 2.0 models accepts two formats as inputs:"),$.forEach(t),b=l(y),P=s(y,"UL",{});var ze=a(P);x=s(ze,"LI",{});var mt=a(x);w=i(mt,"having all inputs as keyword arguments (like PyTorch models), or"),mt.forEach(t),T=l(ze),F=s(ze,"LI",{});var Fe=a(F);Oe=i(Fe,"having all inputs as a list, tuple or dict in the first positional arguments."),Fe.forEach(t),ze.forEach(t),me=l(y),q=s(y,"P",{});var Q=a(q);Pe=i(Q,"This second option is useful when using "),ae=s(Q,"CODE",{});var gt=a(ae);Ae=i(gt,"tf.keras.Model.fit"),gt.forEach(t),re=i(Q,` method which currently requires having all the
...
first positional argument :`),le.forEach(t),H=l(y),j=s(y,"UL",{});var I=a(j);S=s(I,"LI",{});var J=a(S);Le=i(J,"a single Tensor with "),Y=s(J,"CODE",{});var $e=a(Y);ee=i($e,"input_ids"),$e.forEach(t),Ge=i(J," only and nothing else: "),D=s(J,"CODE",{});var ft=a(D);Ne=i(ft,"model(input_ids)"),ft.forEach(t),J.forEach(t),De=l(I),A=s(I,"LI",{});var X=a(A);ge=i(X,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),de=s(X,"CODE",{});var _t=a(de);Me=i(_t,"model([input_ids, attention_mask])"),_t.forEach(t),te=i(X," or "),K=s(X,"CODE",{});var Qe=a(K);Ue=i(Qe,"model([input_ids, attention_mask, token_type_ids])"),Qe.forEach(t),X.forEach(t),We=l(I),U=s(I,"LI",{});var R=a(U);Be=i(R,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),oe=s(R,"CODE",{});var vt=a(oe);V=i(vt,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),vt.forEach(t),R.forEach(t),I.forEach(t)},m(y,$){u(y,h,$),e(h,z),u(y,b,$),u(y,P,$),e(P,x),e(x,w),e(P,T),e(P,F),e(F,Oe),u(y,me,$),u(y,q,$),e(q,Pe),e(q,ae),e(ae,Ae),e(q,re),e(q,ie),e(ie,Ie),e(q,Ce),u(y,N,$),u(y,O,$),e(O,xe),u(y,H,$),u(y,j,$),e(j,S),e(S,Le),e(S,Y),e(Y,ee),e(S,Ge),e(S,D),e(D,Ne),e(j,De),e(j,A),e(A,ge),e(A,de),e(de,Me),e(A,te),e(A,K),e(K,Ue),e(j,We),e(j,U),e(U,Be),e(U,oe),e(oe,V)},d(y){y&&t(h),y&&t(b),y&&t(P),y&&t(me),y&&t(q),y&&t(N),y&&t(O),y&&t(H),y&&t(j)}}}function Wv(B){let h,z,b,P,x;return{c(){h=n("p"),z=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),b=n("code"),P=r("Module"),x=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(w){h=s(w,"P",{});var T=a(h);z=i(T,"Although the recipe for forward pass needs to be defined within this function, one should call the "),b=s(T,"CODE",{});var F=a(b);P=i(F,"Module"),F.forEach(t),x=i(T,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),T.forEach(t)},m(w,T){u(w,h,T),e(h,z),e(h,b),e(b,P),e(h,x)},d(w){w&&t(h)}}}function Bv(B){let h,z,b,P,x;return{c(){h=n("p"),z=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),b=n("code"),P=r("Module"),x=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(w){h=s(w,"P",{});var T=a(h);z=i(T,"Although the recipe for forward pass needs to be defined within this function, one should call the "),b=s(T,"CODE",{});var F=a(b);P=i(F,"Module"),F.forEach(t),x=i(T,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),T.forEach(t)},m(w,T){u(w,h,T),e(h,z),e(h,b),e(b,P),e(h,x)},d(w){w&&t(h)}}}function Vv(B){let h,z,b,P,x;return{c(){h=n("p"),z=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),b=n("code"),P=r("Module"),x=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(w){h=s(w,"P",{});var T=a(h);z=i(T,"Although the recipe for forward pass needs to be defined within this function, one should call the "),b=s(T,"CODE",{});var F=a(b);P=i(F,"Module"),F.forEach(t),x=i(T,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),T.forEach(t)},m(w,T){u(w,h,T),e(h,z),e(h,b),e(b,P),e(h,x)},d(w){w&&t(h)}}}function Rv(B){let h,z,b,P,x,w,T,F,Oe,me,q,Pe,ae,Ae,re,ie,Ie,Ce,N,O,xe,H,j,S,Le,Y,ee,Ge,D,Ne,De,A,ge,de,Me,te,K,Ue,We,U,Be,oe,V,y,$,ze,mt,Fe,Q,gt,Ke,le,I,J,$e,ft,X,_t,Qe,R,vt,qo,Yd,el,ca,tl,ol,Ci,fe,ua,nl,sl,pa,al,rl,ha,il,dl,Eo,ll,Co,cl,ul,pl,Bt,Mo,hl,ml,jo,gl,fl,Mi,kt,Vt,ma,So,_l,ga,vl,ji,Je,Rt,Oo,kl,yl,Ao,bl,Tl,wl,fa,Pl,xl,_a,zl,Si,yt,Ht,va,Io,Fl,ka,$l,Oi,_e,ya,ba,ql,El,Ta,xs,Cl,zs,Ml,jl,Lo,wa,Sl,Ol,bt,Pa,Al,Il,xa,Ll,Gl,Go,Nl,za,Dl,Ul,Wl,Fa,Ve,Bl,$a,Vl,Rl,qa,Hl,Kl,Ea,Ql,Jl,Xl,Ca,Tt,Zl,No,Yl,ec,Ma,tc,oc,Ai,wt,Kt,ja,Do,nc,Sa,sc,Ii,Uo,Li,Pt,Qt,Oa,Wo,ac,Aa,rc,Gi,ce,Bo,ic,xt,dc,Fs,lc,cc,Vo,uc,pc,hc,zt,mc,$s,gc,fc,qs,_c,vc,kc,Ia,yc,bc,Ro,Ni,Ft,Jt,La,Ho,Tc,Ga,wc,Di,Xt,Pc,Na,xc,zc,Ui,W,Ko,Fc,Qo,$c,Jo,qc,Ec,Cc,Xo,Mc,Es,jc,Sc,Oc,je,Zo,Ac,Yo,Ic,Da,Lc,Gc,Nc,en,Cs,Dc,Ua,Uc,Wc,tn,Bc,Wa,Vc,Rc,Hc,Ba,Kc,Qc,Zt,on,Jc,Va,Xc,Zc,Yt,nn,Yc,Ra,eu,tu,eo,sn,ou,Ha,nu,Wi,$t,to,Ka,an,su,Qa,au,Bi,ue,rn,ru,qt,iu,Ja,du,lu,dn,cu,uu,pu,ln,hu,Ms,mu,gu,fu,Xe,cn,_u,Xa,vu,ku,un,js,yu,Za,bu,Tu,pn,wu,Ya,Pu,xu,zu,oo,hn,Fu,er,$u,Vi,Et,no,tr,mn,qu,or,Eu,Ri,qe,gn,Cu,fn,Mu,Ss,ju,Su,Ou,_n,Au,vn,Iu,Lu,Gu,ve,kn,Nu,Ct,Du,Os,Uu,Wu,nr,Bu,Vu,Ru,so,Hu,sr,Ku,Qu,yn,Hi,Mt,ao,ar,bn,Ju,rr,Xu,Ki,Ee,Tn,Zu,wn,Yu,As,ep,tp,op,Pn,np,xn,sp,ap,rp,ke,zn,ip,jt,dp,Is,lp,cp,ir,up,pp,hp,ro,mp,dr,gp,fp,Fn,Qi,St,io,lr,$n,_p,cr,vp,Ji,Ot,qn,kp,Ze,En,yp,ur,bp,Tp,Cn,Xi,At,lo,pr,Mn,wp,hr,Pp,Zi,pe,jn,xp,Sn,zp,Ls,Fp,$p,qp,On,Ep,An,Cp,Mp,jp,co,Sp,ye,In,Op,It,Ap,Gs,Ip,Lp,mr,Gp,Np,Dp,uo,Up,gr,Wp,Bp,Ln,Yi,Lt,po,fr,Gn,Vp,_r,Rp,ed,he,Nn,Hp,Dn,Kp,Ns,Qp,Jp,Xp,Un,Zp,Wn,Yp,eh,th,ho,oh,be,Bn,nh,Gt,sh,Ds,ah,rh,vr,ih,dh,lh,mo,ch,kr,uh,ph,Vn,td,Nt,go,yr,Rn,hh,br,mh,od,L,Hn,gh,Kn,fh,Us,_h,vh,kh,Qn,yh,Jn,bh,Th,wh,Tr,Ph,xh,Re,wr,Xn,zh,Fh,Pr,Zn,$h,qh,xr,Yn,Eh,Ch,zr,es,Mh,jh,Te,ts,Sh,Dt,Oh,Fr,Ah,Ih,$r,Lh,Gh,Nh,fo,Dh,qr,Uh,Wh,os,Bh,Ye,ns,Vh,Er,Rh,Hh,ss,Kh,et,as,Qh,Cr,Jh,Xh,rs,nd,Ut,_o,Mr,is,Zh,jr,Yh,sd,G,ds,em,ls,tm,Ws,om,nm,sm,cs,am,us,rm,im,dm,Sr,lm,cm,He,Or,ps,um,pm,Ar,hs,hm,mm,Ir,ms,gm,fm,Lr,gs,_m,vm,E,fs,km,Wt,ym,Gr,bm,Tm,Nr,wm,Pm,xm,vo,zm,Dr,Fm,$m,Ur,Wr,Br,Vr,qm,Em,Rr,Hr,Kr,Qr,Cm,Mm,Jr,Xr,Zr,Yr,jm,Sm,ei,ti,_s,ko,yo,oi,vs,Om,ni,Am,Im,si,Lm,Gm,ai,Nm,Dm,ri,ii,di,li,Um,Wm,ci,ui,pi,hi,Bm,Vm,mi,gi,fi,_i,Rm,Hm,vi,ki,yi,bi,Km,Qm,tt,ks,Jm,Ti,Xm,Zm,ys,Ym,ot,bs,eg,wi,tg,og,Ts,ad;return w=new Z({}),H=new Z({}),$e=new Z({}),So=new Z({}),Io=new Z({}),Do=new Z({}),Uo=new Se({props:{code:`from transformers import PegasusForConditionalGeneration, PegasusTokenizer
import torch
...
`,returnType:`
<p><code>List[int]</code></p>
`}}),hn=new C({props:{name:"get_special_tokens_mask",anchor:"transformers.PegasusTokenizerFast.get_special_tokens_mask",parameters:[{name:"token_ids_0",val:": typing.List"},{name:"token_ids_1",val:": typing.Optional[typing.List] = None"},{name:"already_has_special_tokens",val:": bool = False"}],source:"https://github.com/huggingface/transformers/blob/v4.18.0/src/transformers/models/pegasus/tokenization_pegasus_fast.py#L164"}}),mn=new Z({}),gn=new C({props:{name:"class transformers.PegasusModel",anchor:"transformers.PegasusModel",parameters:[{name:"config",val:": PegasusConfig"}],source:"https://github.com/huggingface/transformers/blob/v4.18.0/src/transformers/models/pegasus/modeling_pegasus.py#L1133",parametersDescription:[{anchor:"transformers.PegasusModel.config",description:`<strong>config</strong> (<a href="/docs/transformers/v4.18.0/en/model_doc/pegasus#transformers.PegasusConfig">PegasusConfig</a>) &#x2014;
Model configuration class with all the parameters of the model. Initializing with a config file does not
load the weights associated with the model, only the configuration. Check out the
<a href="/docs/transformers/v4.18.0/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),kn=new C({props:{name:"forward",anchor:"transformers.PegasusModel.forward",parameters:[{name:"input_ids",val:": typing.Optional[torch.Tensor] = None"},{name:"attention_mask",val:": typing.Optional[torch.Tensor] = None"},{name:"decoder_input_ids",val:": typing.Optional[torch.Tensor] = None"},{name:"decoder_attention_mask",val:": typing.Optional[torch.Tensor] = None"},{name:"head_mask",val:": typing.Optional[torch.Tensor] = None"},{name:"decoder_head_mask",val:": typing.Optional[torch.Tensor] = None"},{name:"cross_attn_head_mask",val:": typing.Optional[torch.Tensor] = None"},{name:"encoder_outputs",val:": typing.Optional[typing.Tuple[torch.FloatTensor]] = None"},{name:"past_key_values",val:": typing.Optional[typing.Tuple[torch.FloatTensor]] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.Tensor] = None"},{name:"decoder_inputs_embeds",val:": typing.Optional[torch.Tensor] = None"},{name:"use_cache",val:": typing.Optional[bool] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],source:"https://github.com/huggingface/transformers/blob/v4.18.0/src/transformers/models/pegasus/modeling_pegasus.py#L1183",parametersDescription:[{anchor:"transformers.PegasusModel.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. Padding will be ignored by default should you provide
it.</p>
<p>Indices can be obtained using <a href="/docs/transformers/v4.18.0/en/model_doc/pegasus#transformers.PegasusTokenizer">PegasusTokenizer</a>. See <a href="/docs/transformers/v4.18.0/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
...
elements depending on the configuration (<a
  href="/docs/transformers/v4.18.0/en/model_doc/pegasus#transformers.PegasusConfig"
...
`}}),so=new $o({props:{$$slots:{default:[Lv]},$$scope:{ctx:B}}}),yn=new Se({props:{code:`from transformers import PegasusTokenizer, PegasusModel
...
[<span class="hljs-number">1</span>, <span class="hljs-number">4</span>, <span class="hljs-number">1024</span>]`}}),bn=new Z({}),Tn=new C({props:{name:"class transformers.PegasusForConditionalGeneration",anchor:"transformers.PegasusForConditionalGeneration",parameters:[{name:"config",val:": PegasusConfig"}],source:"https://github.com/huggingface/transformers/blob/v4.18.0/src/transformers/models/pegasus/modeling_pegasus.py#L1282",parametersDescription:[{anchor:"transformers.PegasusForConditionalGeneration.config",description:`<strong>config</strong> (<a href="/docs/transformers/v4.18.0/en/model_doc/pegasus#transformers.PegasusConfig">PegasusConfig</a>) &#x2014;
Model configuration class with all the parameters of the model. Initializing with a config file does not
load the weights associated with the model, only the configuration. Check out the
<a href="/docs/transformers/v4.18.0/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),zn=new C({props:{name:"forward",anchor:"transformers.PegasusForConditionalGeneration.forward",parameters:[{name:"input_ids",val:": typing.Optional[torch.Tensor] = None"},{name:"attention_mask",val:": typing.Optional[torch.Tensor] = None"},{name:"decoder_input_ids",val:": typing.Optional[torch.Tensor] = None"},{name:"decoder_attention_mask",val:": typing.Optional[torch.Tensor] = None"},{name:"head_mask",val:": typing.Optional[torch.Tensor] = None"},{name:"decoder_head_mask",val:": typing.Optional[torch.Tensor] = None"},{name:"cross_attn_head_mask",val:": typing.Optional[torch.Tensor] = None"},{name:"encoder_outputs",val:": typing.Optional[typing.Tuple[torch.FloatTensor]] = None"},{name:"past_key_values",val:": typing.Optional[typing.Tuple[torch.FloatTensor]] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.Tensor] = None"},{name:"decoder_inputs_embeds",val:": typing.Optional[torch.Tensor] = None"},{name:"labels",val:": typing.Optional[torch.Tensor] = None"},{name:"use_cache",val:": typing.Optional[bool] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],source:"https://github.com/huggingface/transformers/blob/v4.18.0/src/transformers/models/pegasus/modeling_pegasus.py#L1350",parametersDescription:[{anchor:"transformers.PegasusForConditionalGeneration.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. Padding will be ignored by default should you provide
it.</p>
<p>Indices can be obtained using <a href="/docs/transformers/v4.18.0/en/model_doc/pegasus#transformers.PegasusTokenizer">PegasusTokenizer</a>. See <a href="/docs/transformers/v4.18.0/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/v4.18.0/en/model_doc/wav2vec2_phoneme#transformers.Wav2Vec2PhonemeCTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
`}}),ro=new $o({props:{$$slots:{default:[Gv]},$$scope:{ctx:B}}}),Fn=new Se({props:{code:`from transformers import PegasusTokenizer, PegasusForConditionalGeneration
...
`}}),uo=new $o({props:{$$slots:{default:[Dv]},$$scope:{ctx:B}}}),Ln=new Se({props:{code:`from transformers import PegasusTokenizer, TFPegasusModel
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),Gn=new Z({}),Nn=new C({props:{name:"class transformers.TFPegasusForConditionalGeneration",anchor:"transformers.TFPegasusForConditionalGeneration",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/v4.18.0/src/transformers/models/pegasus/modeling_tf_pegasus.py#L1250",parametersDescription:[{anchor:"transformers.TFPegasusForConditionalGeneration.config",description:`<strong>config</strong> (<a href="/docs/transformers/v4.18.0/en/model_doc/pegasus#transformers.PegasusConfig">PegasusConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/v4.18.0/en/main_classes/model#transformers.TFPreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),ho=new $o({props:{$$slots:{default:[Uv]},$$scope:{ctx:B}}}),Bn=new C({props:{name:"call",anchor:"transformers.TFPegasusForConditionalGeneration.call",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"decoder_input_ids",val:" = None"},{name:"decoder_attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"decoder_head_mask",val:" = None"},{name:"cross_attn_head_mask",val:" = None"},{name:"encoder_outputs",val:": typing.Optional[transformers.modeling_tf_outputs.TFBaseModelOutput] = None"},{name:"past_key_values",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"decoder_inputs_embeds",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"},{name:"labels",val:" = None"},{name:"training",val:" = False"}],source:"https://github.com/huggingface/transformers/blob/v4.18.0/src/transformers/models/pegasus/modeling_tf_pegasus.py#L1283",parametersDescription:[{anchor:"transformers.TFPegasusForConditionalGeneration.call.input_ids",description:`<strong>input_ids</strong> (<code>tf.Tensor</code> of shape <code>({0})</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/v4.18.0/en/model_doc/pegasus#transformers.PegasusTokenizer">PegasusTokenizer</a>. See <a href="/docs/transformers/v4.18.0/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/v4.18.0/en/model_doc/wav2vec2_phoneme#transformers.Wav2Vec2PhonemeCTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
`}}),mo=new $o({props:{$$slots:{default:[Wv]},$$scope:{ctx:B}}}),Vn=new Se({props:{code:`from transformers import PegasusTokenizer, TFPegasusForConditionalGeneration
...
`}}),fo=new $o({props:{$$slots:{default:[Bv]},$$scope:{ctx:B}}}),os=new Se({props:{code:`from transformers import PegasusTokenizer, FlaxPegasusModel
...
parameters.</strong></p>
<p>If you wish to change the dtype of the model parameters, see <a href="/docs/transformers/v4.18.0/en/main_classes/model#transformers.FlaxPreTrainedModel.to_fp16">to_fp16()</a> and
<a href="/docs/transformers/v4.18.0/en/main_classes/model#transformers.FlaxPreTrainedModel.to_bf16">to_bf16()</a>.`,name:"dtype"}]}}),fs=new C({props:{name:"__call__",anchor:"transformers.FlaxPegasusForConditionalGeneration.__call__",parameters:[{name:"input_ids",val:": ndarray"},{name:"attention_mask",val:": typing.Optional[jax._src.numpy.ndarray.ndarray] = None"},{name:"decoder_input_ids",val:": typing.Optional[jax._src.numpy.ndarray.ndarray] = None"},{name:"decoder_attention_mask",val:": typing.Optional[jax._src.numpy.ndarray.ndarray] = None"},{name:"position_ids",val:": typing.Optional[jax._src.numpy.ndarray.ndarray] = None"},{name:"decoder_position_ids",val:": typing.Optional[jax._src.numpy.ndarray.ndarray] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"train",val:": bool = False"},{name:"params",val:": dict = None"},{name:"dropout_rng",val:": PRNGKey = None"}],source:"https://github.com/huggingface/transformers/blob/v4.18.0/src/transformers/models/pegasus/modeling_flax_pegasus.py#L1151",parametersDescription:[{anchor:"transformers.FlaxPegasusForConditionalGeneration.__call__.input_ids",description:`<strong>input_ids</strong> (<code>jnp.ndarray</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. Padding will be ignored by default should you provide
it.</p>
<p>Indices can be obtained using <a href="/docs/transformers/v4.18.0/en/model_doc/pegasus#transformers.PegasusTokenizer">PegasusTokenizer</a>. See <a href="/docs/transformers/v4.18.0/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/v4.18.0/en/model_doc/wav2vec2_phoneme#transformers.Wav2Vec2PhonemeCTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
`}}),vo=new $o({props:{$$slots:{default:[Vv]},$$scope:{ctx:B}}}),vs=new Z({}),ks=new C({props:{name:"encode",anchor:"transformers.FlaxPegasusForConditionalGeneration.encode",parameters:[{name:"input_ids",val:": ndarray"},{name:"attention_mask",val:": typing.Optional[jax._src.numpy.ndarray.ndarray] = None"},{name:"position_ids",val:": typing.Optional[jax._src.numpy.ndarray.ndarray] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"train",val:": bool = False"},{name:"params",val:": dict = None"},{name:"dropout_rng",val:": PRNGKey = None"}],source:"https://github.com/huggingface/transformers/blob/v4.18.0/src/transformers/models/pegasus/modeling_flax_pegasus.py#L974",parametersDescription:[{anchor:"transformers.FlaxPegasusForConditionalGeneration.encode.input_ids",description:`<strong>input_ids</strong> (<code>jnp.ndarray</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. Padding will be ignored by default should you provide
it.</p>
<p>Indices can be obtained using <a href="/docs/transformers/v4.18.0/en/model_doc/pegasus#transformers.PegasusTokenizer">PegasusTokenizer</a>. See <a href="/docs/transformers/v4.18.0/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/v4.18.0/en/model_doc/wav2vec2_phoneme#transformers.Wav2Vec2PhonemeCTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
`),Vo=n("a"),uc=r("google/pegasus-large"),pc=r(" architecture."),hc=d(),zt=n("p"),mc=r("Configuration objects inherit from "),$s=n("a"),gc=r("PretrainedConfig"),fc=r(` and can be used to control the model outputs. Read the
documentation from `),qs=n("a"),_c=r("PretrainedConfig"),vc=r(" for more information."),kc=d(),Ia=n("p"),yc=r("Example:"),bc=d(),m(Ro.$$.fragment),Ni=d(),Ft=n("h2"),Jt=n("a"),La=n("span"),m(Ho.$$.fragment),Tc=d(),Ga=n("span"),wc=r("PegasusTokenizer"),Di=d(),Xt=n("p"),Pc=r("warning: "),Na=n("code"),xc=r("add_tokens"),zc=r(" does not work at the moment."),Ui=d(),W=n("div"),m(Ko.$$.fragment),Fc=d(),Qo=n("p"),$c=r("Construct a PEGASUS tokenizer. Based on "),Jo=n("a"),qc=r("SentencePiece"),Ec=r("."),Cc=d(),Xo=n("p"),Mc=r("This tokenizer inherits from "),Es=n("a"),jc=r("PreTrainedTokenizer"),Sc=r(` which contains most of the main methods. Users should refer to
...
separator.`),Qc=d(),Zt=n("div"),m(on.$$.fragment),Jc=d(),Va=n("p"),Xc=r("Converts a sequence of tokens (string) in a single string."),Zc=d(),Yt=n("div"),m(nn.$$.fragment),Yc=d(),Ra=n("p"),eu=r("Get list where entries are [1] if a token is [eos] or [pad] else 0."),tu=d(),eo=n("div"),m(sn.$$.fragment),ou=d(),Ha=n("p"),nu=r("Just EOS"),Wi=d(),$t=n("h2"),to=n("a"),Ka=n("span"),m(an.$$.fragment),su=d(),Qa=n("span"),au=r("PegasusTokenizerFast"),Bi=d(),ue=n("div"),m(rn.$$.fragment),ru=d(),qt=n("p"),iu=r("Construct a \u201Cfast\u201D PEGASUS tokenizer (backed by HuggingFace\u2019s "),Ja=n("em"),du=r("tokenizers"),lu=r(` library). Based on
...
refer to this superclass for more information regarding those methods.`),fu=d(),Xe=n("div"),m(cn.$$.fragment),_u=d(),Xa=n("p"),vu=r("Build model inputs from a sequence by adding eos to the end. no bos token is added to the front."),ku=d(),un=n("ul"),js=n("li"),yu=r("single sequence: "),Za=n("code"),bu=r("X </s>"),Tu=d(),pn=n("li"),wu=r("pair of sequences: "),Ya=n("code"),Pu=r("A B </s>"),xu=r(" (not intended use)"),zu=d(),oo=n("div"),m(hn.$$.fragment),Fu=d(),er=n("p"),$u=r("Get list where entries are [1] if a token is [eos] or [pad] else 0."),Vi=d(),Et=n("h2"),no=n("a"),tr=n("span"),m(mn.$$.fragment),qu=d(),or=n("span"),Eu=r("PegasusModel"),Ri=d(),qe=n("div"),m(gn.$$.fragment),Cu=d(),fn=n("p"),Mu=r(`The bare PEGASUS Model outputting raw hidden-states without any specific head on top.
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),rp=d(),ke=n("div"),m(zn.$$.fragment),ip=d(),jt=n("p"),dp=r("The "),Is=n("a"),lp=r("PegasusForConditionalGeneration"),cp=r(" forward method, overrides the "),ir=n("code"),up=r("__call__"),pp=r(" special method."),hp=d(),m(ro.$$.fragment),mp=d(),dr=n("p"),gp=r("Summarization example:"),fp=d(),m(Fn.$$.fragment),Qi=d(),St=n("h2"),io=n("a"),lr=n("span"),m($n.$$.fragment),_p=d(),cr=n("span"),vp=r("PegasusForCausalLM"),Ji=d(),Ot=n("div"),m(qn.$$.fragment),kp=d(),Ze=n("div"),m(En.$$.fragment),yp=d(),ur=n("p"),bp=r("Example:"),Tp=d(),m(Cn.$$.fragment),Xi=d(),At=n("h2"),lo=n("a"),pr=n("span"),m(Mn.$$.fragment),wp=d(),hr=n("span"),Pp=r("TFPegasusModel"),Zi=d(),pe=n("div"),m(jn.$$.fragment),xp=d(),Sn=n("p"),zp=r(`The bare PEGASUS Model outputting raw hidden-states without any specific head on top.
This model inherits from `),Ls=n("a"),Fp=r("TFPreTrainedModel"),$p=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),th=d(),m(ho.$$.fragment),oh=d(),be=n("div"),m(Bn.$$.fragment),nh=d(),Gt=n("p"),sh=r("The "),Ds=n("a"),ah=r("TFPegasusForConditionalGeneration"),rh=r(" forward method, overrides the "),vr=n("code"),ih=r("__call__"),dh=r(" special method."),lh=d(),m(mo.$$.fragment),ch=d(),kr=n("p"),uh=r("Summarization example:"),ph=d(),m(Vn.$$.fragment),td=d(),Nt=n("h2"),go=n("a"),yr=n("span"),m(Rn.$$.fragment),hh=d(),br=n("span"),mh=r("FlaxPegasusModel"),od=d(),L=n("div"),m(Hn.$$.fragment),gh=d(),Kn=n("p"),fh=r(`The bare Pegasus Model transformer outputting raw hidden-states without any specific head on top.
This model inherits from `),Us=n("a"),_h=r("FlaxPreTrainedModel"),vh=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),kh=d(),Qn=n("p"),yh=r(`This model is also a Flax Linen
...
tokenizer([ARTICLE_TO_SUMMARIZE], max_length=1024, return_tensors=\u2018np\u2019)`),Sm=d(),ei=n("blockquote"),ti=n("blockquote"),_s=n("blockquote"),ko=n("h1"),yo=n("a"),oi=n("span"),m(vs.$$.fragment),Om=d(),ni=n("span"),Am=r("Generate Summary >>> summary_ids = model.generate(inputs[\u2018input_ids\u2019]).sequences >>>"),Im=d(),si=n("p"),Lm=r("print(tokenizer.batch_decode(summary_ids, skip_special_tokens=True, clean_up_tokenization_spaces=False))"),Gm=d(),ai=n("p"),Nm=r("Mask filling example:"),Dm=d(),ri=n("blockquote"),ii=n("blockquote"),di=n("blockquote"),li=n("p"),Um=r(`from transformers import PegasusTokenizer, FlaxPegasusForConditionalGeneration >>> tokenizer =
...
documentation from `),qs=s(Js,"A",{href:!0});var rf=a(qs);_c=i(rf,"PretrainedConfig"),rf.forEach(t),vc=i(Js," for more information."),Js.forEach(t),kc=l(at),Ia=s(at,"P",{});var df=a(Ia);yc=i(df,"Example:"),df.forEach(t),bc=l(at),g(Ro.$$.fragment,at),at.forEach(t),Ni=l(o),Ft=s(o,"H2",{class:!0});var fd=a(Ft);Jt=s(fd,"A",{id:!0,class:!0,href:!0});var lf=a(Jt);La=s(lf,"SPAN",{});var cf=a(La);g(Ho.$$.fragment,cf),cf.forEach(t),lf.forEach(t),Tc=l(fd),Ga=s(fd,"SPAN",{});var uf=a(Ga);wc=i(uf,"PegasusTokenizer"),uf.forEach(t),fd.forEach(t),Di=l(o),Xt=s(o,"P",{});var _d=a(Xt);Pc=i(_d,"warning: "),Na=s(_d,"CODE",{});var pf=a(Na);xc=i(pf,"add_tokens"),pf.forEach(t),zc=i(_d," does not work at the moment."),_d.forEach(t),Ui=l(o),W=s(o,"DIV",{class:!0});var we=a(W);g(Ko.$$.fragment,we),Fc=l(we),Qo=s(we,"P",{});var vd=a(Qo);$c=i(vd,"Construct a PEGASUS tokenizer. Based on "),Jo=s(vd,"A",{href:!0,rel:!0});var hf=a(Jo);qc=i(hf,"SentencePiece"),hf.forEach(t),Ec=i(vd,"."),vd.forEach(t),Cc=l(we),Xo=s(we,"P",{});var kd=a(Xo);Mc=i(kd,"This tokenizer inherits from "),Es=s(kd,"A",{href:!0});var mf=a(Es);jc=i(mf,"PreTrainedTokenizer"),mf.forEach(t),Sc=i(kd,` which contains most of the main methods. Users should refer to
this superclass for more information regarding those methods.`),kd.forEach(t),Oc=l(we),je=s(we,"DIV",{class:!0});var wo=a(je);g(Zo.$$.fragment,wo),Ac=l(wo),Yo=s(wo,"P",{});var yd=a(Yo);Ic=i(yd,`Build model inputs from a sequence or a pair of sequences for sequence classification tasks by concatenating
and adding special tokens. A PEGASUS sequence has the following format, where `),Da=s(yd,"CODE",{});var gf=a(Da);Lc=i(gf,"X"),gf.forEach(t),Gc=i(yd," represents the sequence:"),yd.forEach(t),Nc=l(wo),en=s(wo,"UL",{});var bd=a(en);Cs=s(bd,"LI",{});var sg=a(Cs);Dc=i(sg,"single sequence: "),Ua=s(sg,"CODE",{});var ff=a(Ua);Uc=i(ff,"X </s>"),ff.forEach(t),sg.forEach(t),Wc=l(bd),tn=s(bd,"LI",{});var Td=a(tn);Bc=i(Td,"pair of sequences: "),Wa=s(Td,"CODE",{});var _f=a(Wa);Vc=i(_f,"A B </s>"),_f.forEach(t),Rc=i(Td," (not intended use)"),Td.forEach(t),bd.forEach(t),Hc=l(wo),Ba=s(wo,"P",{});var vf=a(Ba);Kc=i(vf,`BOS is never used. Pairs of sequences are not the expected use case, but they will be handled without a
separator.`),vf.forEach(t),wo.forEach(t),Qc=l(we),Zt=s(we,"DIV",{class:!0});var wd=a(Zt);g(on.$$.fragment,wd),Jc=l(wd),Va=s(wd,"P",{});var kf=a(Va);Xc=i(kf,"Converts a sequence of tokens (string) in a single string."),kf.forEach(t),wd.forEach(t),Zc=l(we),Yt=s(we,"DIV",{class:!0});var Pd=a(Yt);g(nn.$$.fragment,Pd),Yc=l(Pd),Ra=s(Pd,"P",{});var yf=a(Ra);eu=i(yf,"Get list where entries are [1] if a token is [eos] or [pad] else 0."),yf.forEach(t),Pd.forEach(t),tu=l(we),eo=s(we,"DIV",{class:!0});var xd=a(eo);g(sn.$$.fragment,xd),ou=l(xd),Ha=s(xd,"P",{});var bf=a(Ha);nu=i(bf,"Just EOS"),bf.forEach(t),xd.forEach(t),we.forEach(t),Wi=l(o),$t=s(o,"H2",{class:!0});var zd=a($t);to=s(zd,"A",{id:!0,class:!0,href:!0});var Tf=a(to);Ka=s(Tf,"SPAN",{});var wf=a(Ka);g(an.$$.fragment,wf),wf.forEach(t),Tf.forEach(t),su=l(zd),Qa=s(zd,"SPAN",{});var Pf=a(Qa);au=i(Pf,"PegasusTokenizerFast"),Pf.forEach(t),zd.forEach(t),Bi=l(o),ue=s(o,"DIV",{class:!0});var rt=a(ue);g(rn.$$.fragment,rt),ru=l(rt),qt=s(rt,"P",{});var Xs=a(qt);iu=i(Xs,"Construct a \u201Cfast\u201D PEGASUS tokenizer (backed by HuggingFace\u2019s "),Ja=s(Xs,"EM",{});var xf=a(Ja);du=i(xf,"tokenizers"),xf.forEach(t),lu=i(Xs,` library). Based on
`),dn=s(Xs,"A",{href:!0,rel:!0});var zf=a(dn);cu=i(zf,"Unigram"),zf.forEach(t),uu=i(Xs,"."),Xs.forEach(t),pu=l(rt),ln=s(rt,"P",{});var Fd=a(ln);hu=i(Fd,"This tokenizer inherits from "),Ms=s(Fd,"A",{href:!0});var Ff=a(Ms);mu=i(Ff,"PreTrainedTokenizerFast"),Ff.forEach(t),gu=i(Fd,` which contains most of the main methods. Users should
refer to this superclass for more information regarding those methods.`),Fd.forEach(t),fu=l(rt),Xe=s(rt,"DIV",{class:!0});var Zs=a(Xe);g(cn.$$.fragment,Zs),_u=l(Zs),Xa=s(Zs,"P",{});var $f=a(Xa);vu=i($f,"Build model inputs from a sequence by adding eos to the end. no bos token is added to the front."),$f.forEach(t),ku=l(Zs),un=s(Zs,"UL",{});var $d=a(un);js=s($d,"LI",{});var ag=a(js);yu=i(ag,"single sequence: "),Za=s(ag,"CODE",{});var qf=a(Za);bu=i(qf,"X </s>"),qf.forEach(t),ag.forEach(t),Tu=l($d),pn=s($d,"LI",{});var qd=a(pn);wu=i(qd,"pair of sequences: "),Ya=s(qd,"CODE",{});var Ef=a(Ya);Pu=i(Ef,"A B </s>"),Ef.forEach(t),xu=i(qd," (not intended use)"),qd.forEach(t),$d.forEach(t),Zs.forEach(t),zu=l(rt),oo=s(rt,"DIV",{class:!0});var Ed=a(oo);g(hn.$$.fragment,Ed),Fu=l(Ed),er=s(Ed,"P",{});var Cf=a(er);$u=i(Cf,"Get list where entries are [1] if a token is [eos] or [pad] else 0."),Cf.forEach(t),Ed.forEach(t),rt.forEach(t),Vi=l(o),Et=s(o,"H2",{class:!0});var Cd=a(Et);no=s(Cd,"A",{id:!0,class:!0,href:!0});var Mf=a(no);tr=s(Mf,"SPAN",{});var jf=a(tr);g(mn.$$.fragment,jf),jf.forEach(t),Mf.forEach(t),qu=l(Cd),or=s(Cd,"SPAN",{});var Sf=a(or);Eu=i(Sf,"PegasusModel"),Sf.forEach(t),Cd.forEach(t),Ri=l(o),qe=s(o,"DIV",{class:!0});var Po=a(qe);g(gn.$$.fragment,Po),Cu=l(Po),fn=s(Po,"P",{});var Md=a(fn);Mu=i(Md,`The bare PEGASUS Model outputting raw hidden-states without any specific head on top.
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Ad.forEach(t),rp=l(xo),ke=s(xo,"DIV",{class:!0});var dt=a(ke);g(zn.$$.fragment,dt),ip=l(dt),jt=s(dt,"P",{});var ea=a(jt);dp=i(ea,"The "),Is=s(ea,"A",{href:!0});var Vf=a(Is);lp=i(Vf,"PegasusForConditionalGeneration"),Vf.forEach(t),cp=i(ea," forward method, overrides the "),ir=s(ea,"CODE",{});var Rf=a(ir);up=i(Rf,"__call__"),Rf.forEach(t),pp=i(ea," special method."),ea.forEach(t),hp=l(dt),g(ro.$$.fragment,dt),mp=l(dt),dr=s(dt,"P",{});var Hf=a(dr);gp=i(Hf,"Summarization example:"),Hf.forEach(t),fp=l(dt),g(Fn.$$.fragment,dt),dt.forEach(t),xo.forEach(t),Qi=l(o),St=s(o,"H2",{class:!0});var Id=a(St);io=s(Id,"A",{id:!0,class:!0,href:!0});var Kf=a(io);lr=s(Kf,"SPAN",{});var Qf=a(lr);g($n.$$.fragment,Qf),Qf.forEach(t),Kf.forEach(t),_p=l(Id),cr=s(Id,"SPAN",{});var Jf=a(cr);vp=i(Jf,"PegasusForCausalLM"),Jf.forEach(t),Id.forEach(t),Ji=l(o),Ot=s(o,"DIV",{class:!0});var Ld=a(Ot);g(qn.$$.fragment,Ld),kp=l(Ld),Ze=s(Ld,"DIV",{class:!0});var ta=a(Ze);g(En.$$.fragment,ta),yp=l(ta),ur=s(ta,"P",{});var Xf=a(ur);bp=i(Xf,"Example:"),Xf.forEach(t),Tp=l(ta),g(Cn.$$.fragment,ta),ta.forEach(t),Ld.forEach(t),Xi=l(o),At=s(o,"H2",{class:!0});var Gd=a(At);lo=s(Gd,"A",{id:!0,class:!0,href:!0});var Zf=a(lo);pr=s(Zf,"SPAN",{});var Yf=a(pr);g(Mn.$$.fragment,Yf),Yf.forEach(t),Zf.forEach(t),wp=l(Gd),hr=s(Gd,"SPAN",{});var e_=a(hr);Pp=i(e_,"TFPegasusModel"),e_.forEach(t),Gd.forEach(t),Zi=l(o),pe=s(o,"DIV",{class:!0});var lt=a(pe);g(jn.$$.fragment,lt),xp=l(lt),Sn=s(lt,"P",{});var Nd=a(Sn);zp=i(Nd,`The bare PEGASUS Model outputting raw hidden-states without any specific head on top.
This model inherits from `),Ls=s(Nd,"A",{href:!0});var t_=a(Ls);Fp=i(t_,"TFPreTrainedModel"),t_.forEach(t),$p=i(Nd,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Bd.forEach(t),th=l(ut),g(ho.$$.fragment,ut),oh=l(ut),be=s(ut,"DIV",{class:!0});var pt=a(be);g(Bn.$$.fragment,pt),nh=l(pt),Gt=s(pt,"P",{});var na=a(Gt);sh=i(na,"The "),Ds=s(na,"A",{href:!0});var u_=a(Ds);ah=i(u_,"TFPegasusForConditionalGeneration"),u_.forEach(t),rh=i(na," forward method, overrides the "),vr=s(na,"CODE",{});var p_=a(vr);ih=i(p_,"__call__"),p_.forEach(t),dh=i(na," special method."),na.forEach(t),lh=l(pt),g(mo.$$.fragment,pt),ch=l(pt),kr=s(pt,"P",{});var h_=a(kr);uh=i(h_,"Summarization example:"),h_.forEach(t),ph=l(pt),g(Vn.$$.fragment,pt),pt.forEach(t),ut.forEach(t),td=l(o),Nt=s(o,"H2",{class:!0});var Vd=a(Nt);go=s(Vd,"A",{id:!0,class:!0,href:!0});var m_=a(go);yr=s(m_,"SPAN",{});var g_=a(yr);g(Rn.$$.fragment,g_),g_.forEach(t),m_.forEach(t),hh=l(Vd),br=s(Vd,"SPAN",{});var f_=a(br);mh=i(f_,"FlaxPegasusModel"),f_.forEach(t),Vd.forEach(t),od=l(o),L=s(o,"DIV",{class:!0});var ne=a(L);g(Hn.$$.fragment,ne),gh=l(ne),Kn=s(ne,"P",{});var Rd=a(Kn);fh=i(Rd,`The bare Pegasus Model transformer outputting raw hidden-states without any specific head on top.
This model inherits from `),Us=s(Rd,"A",{href:!0});var __=a(Us);_h=i(__,"FlaxPreTrainedModel"),__.forEach(t),vh=i(Rd,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Rd.forEach(t),kh=l(ne),Qn=s(ne,"P",{});var Hd=a(Qn);yh=i(Hd,`This model is also a Flax Linen
`),Jn=s(Hd,"A",{href:!0,rel:!0});var v_=a(Jn);bh=i(v_,"flax.nn.Module"),v_.forEach(t),Th=i(Hd,` subclass. Use it as a
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),Hd.forEach(t),wh=l(ne),Tr=s(ne,"P",{});var k_=a(Tr);Ph=i(k_,"Finally, this model supports inherent JAX features such as:"),k_.forEach(t),xh=l(ne),Re=s(ne,"UL",{});var zo=a(Re);wr=s(zo,"LI",{});var y_=a(wr);Xn=s(y_,"A",{href:!0,rel:!0});var b_=a(Xn);zh=i(b_,"Just-In-Time (JIT) compilation"),b_.forEach(t),y_.forEach(t),Fh=l(zo),Pr=s(zo,"LI",{});var T_=a(Pr);Zn=s(T_,"A",{href:!0,rel:!0});var w_=a(Zn);$h=i(w_,"Automatic Differentiation"),w_.forEach(t),T_.forEach(t),qh=l(zo),xr=s(zo,"LI",{});var P_=a(xr);Yn=s(P_,"A",{href:!0,rel:!0});var x_=a(Yn);Eh=i(x_,"Vectorization"),x_.forEach(t),P_.forEach(t),Ch=l(zo),zr=s(zo,"LI",{});var z_=a(zr);es=s(z_,"A",{href:!0,rel:!0});var F_=a(es);Mh=i(F_,"Parallelization"),F_.forEach(t),z_.forEach(t),zo.forEach(t),jh=l(ne),Te=s(ne,"DIV",{class:!0});var ht=a(Te);g(ts.$$.fragment,ht),Sh=l(ht),Dt=s(ht,"P",{});var sa=a(Dt);Oh=i(sa,"The "),Fr=s(sa,"CODE",{});var $_=a(Fr);Ah=i($_,"FlaxPegasusPreTrainedModel"),$_.forEach(t),Ih=i(sa," forward method, overrides the "),$r=s(sa,"CODE",{});var q_=a($r);Lh=i(q_,"__call__"),q_.forEach(t),Gh=i(sa," special method."),sa.forEach(t),Nh=l(ht),g(fo.$$.fragment,ht),Dh=l(ht),qr=s(ht,"P",{});var E_=a(qr);Uh=i(E_,"Example:"),E_.forEach(t),Wh=l(ht),g(os.$$.fragment,ht),ht.forEach(t),Bh=l(ne),Ye=s(ne,"DIV",{class:!0});var aa=a(Ye);g(ns.$$.fragment,aa),Vh=l(aa),Er=s(aa,"P",{});var C_=a(Er);Rh=i(C_,"Example:"),C_.forEach(t),Hh=l(aa),g(ss.$$.fragment,aa),aa.forEach(t),Kh=l(ne),et=s(ne,"DIV",{class:!0});var ra=a(et);g(as.$$.fragment,ra),Qh=l(ra),Cr=s(ra,"P",{});var M_=a(Cr);Jh=i(M_,"Example:"),M_.forEach(t),Xh=l(ra),g(rs.$$.fragment,ra),ra.forEach(t),ne.forEach(t),nd=l(o),Ut=s(o,"H2",{class:!0});var Kd=a(Ut);_o=s(Kd,"A",{id:!0,class:!0,href:!0});var j_=a(_o);Mr=s(j_,"SPAN",{});var S_=a(Mr);g(is.$$.fragment,S_),S_.forEach(t),j_.forEach(t),Zh=l(Kd),jr=s(Kd,"SPAN",{});var O_=a(jr);Yh=i(O_,"FlaxPegasusForConditionalGeneration"),O_.forEach(t),Kd.forEach(t),sd=l(o),G=s(o,"DIV",{class:!0});var se=a(G);g(ds.$$.fragment,se),em=l(se),ls=s(se,"P",{});var Qd=a(ls);tm=i(Qd,`The PEGASUS Model with a language modeling head. Can be used for summarization.
...
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),Jd.forEach(t),dm=l(se),Sr=s(se,"P",{});var L_=a(Sr);lm=i(L_,"Finally, this model supports inherent JAX features such as:"),L_.forEach(t),cm=l(se),He=s(se,"UL",{});var Fo=a(He);Or=s(Fo,"LI",{});var G_=a(Or);ps=s(G_,"A",{href:!0,rel:!0});var N_=a(ps);um=i(N_,"Just-In-Time (JIT) compilation"),N_.forEach(t),G_.forEach(t),pm=l(Fo),Ar=s(Fo,"LI",{});var D_=a(Ar);hs=s(D_,"A",{href:!0,rel:!0});var U_=a(hs);hm=i(U_,"Automatic Differentiation"),U_.forEach(t),D_.forEach(t),mm=l(Fo),Ir=s(Fo,"LI",{});var W_=a(Ir);ms=s(W_,"A",{href:!0,rel:!0});var B_=a(ms);gm=i(B_,"Vectorization"),B_.forEach(t),W_.forEach(t),fm=l(Fo),Lr=s(Fo,"LI",{});var V_=a(Lr);gs=s(V_,"A",{href:!0,rel:!0});var R_=a(gs);_m=i(R_,"Parallelization"),R_.forEach(t),V_.forEach(t),Fo.forEach(t),vm=l(se),E=s(se,"DIV",{class:!0});var M=a(E);g(fs.$$.fragment,M),km=l(M),Wt=s(M,"P",{});var ia=a(Wt);ym=i(ia,"The "),Gr=s(ia,"CODE",{});var H_=a(Gr);bm=i(H_,"FlaxPegasusPreTrainedModel"),H_.forEach(t),Tm=i(ia," forward method, overrides the "),Nr=s(ia,"CODE",{});var K_=a(Nr);wm=i(K_,"__call__"),K_.forEach(t),Pm=i(ia," special method."),ia.forEach(t),xm=l(M),g(vo.$$.fragment,M),zm=l(M),Dr=s(M,"P",{});var Q_=a(Dr);Fm=i(Q_,"Summarization example:"),Q_.forEach(t),$m=l(M),Ur=s(M,"BLOCKQUOTE",{});var J_=a(Ur);Wr=s(J_,"BLOCKQUOTE",{});var X_=a(Wr);Br=s(X_,"BLOCKQUOTE",{});var Z_=a(Br);Vr=s(Z_,"P",{});var Y_=a(Vr);qm=i(Y_,"from transformers import PegasusTokenizer, FlaxPegasusForConditionalGeneration"),Y_.forEach(t),Z_.forEach(t),X_.forEach(t),J_.forEach(t),Em=l(M),Rr=s(M,"BLOCKQUOTE",{});var ev=a(Rr);Hr=s(ev,"BLOCKQUOTE",{});var tv=a(Hr);Kr=s(tv,"BLOCKQUOTE",{});var ov=a(Kr);Qr=s(ov,"P",{});var nv=a(Qr);Cm=i(nv,`model = FlaxPegasusForConditionalGeneration.from_pretrained(\u2018google/pegasus-large\u2019) >>> tokenizer =
PegasusTokenizer.from_pretrained(\u2018google/pegasus-large\u2019)`),nv.forEach(t),ov.forEach(t),tv.forEach(t),ev.forEach(t),Mm=l(M),Jr=s(M,"BLOCKQUOTE",{});var sv=a(Jr);Xr=s(sv,"BLOCKQUOTE",{});var av=a(Xr);Zr=s(av,"BLOCKQUOTE",{});var rv=a(Zr);Yr=s(rv,"P",{});var iv=a(Yr);jm=i(iv,`ARTICLE_TO_SUMMARIZE = \u201CMy friends are cool but they eat too many carbs.\u201D >>> inputs =
tokenizer([ARTICLE_TO_SUMMARIZE], max_length=1024, return_tensors=\u2018np\u2019)`),iv.forEach(t),rv.forEach(t),av.forEach(t),sv.forEach(t),Sm=l(M),ei=s(M,"BLOCKQUOTE",{});var dv=a(ei);ti=s(dv,"BLOCKQUOTE",{});var lv=a(ti);_s=s(lv,"BLOCKQUOTE",{});var Xd=a(_s);ko=s(Xd,"H1",{class:!0});var Zd=a(ko);yo=s(Zd,"A",{id:!0,class:!0,href:!0});var cv=a(yo);oi=s(cv,"SPAN",{});var uv=a(oi);g(vs.$$.fragment,uv),uv.forEach(t),cv.forEach(t),Om=l(Zd),ni=s(Zd,"SPAN",{});var pv=a(ni);Am=i(pv,"Generate Summary >>> summary_ids = model.generate(inputs[\u2018input_ids\u2019]).sequences >>>"),pv.forEach(t),Zd.forEach(t),Im=l(Xd),si=s(Xd,"P",{});var hv=a(si);Lm=i(hv,"print(tokenizer.batch_decode(summary_ids, skip_special_tokens=True, clean_up_tokenization_spaces=False))"),hv.forEach(t),Xd.forEach(t),lv.forEach(t),dv.forEach(t),Gm=l(M),ai=s(M,"P",{});var mv=a(ai);Nm=i(mv,"Mask filling example:"),mv.forEach(t),Dm=l(M),ri=s(M,"BLOCKQUOTE",{});var gv=a(ri);ii=s(gv,"BLOCKQUOTE",{});var fv=a(ii);di=s(fv,"BLOCKQUOTE",{});var _v=a(di);li=s(_v,"P",{});var vv=a(li);Um=i(vv,`from transformers import PegasusTokenizer, FlaxPegasusForConditionalGeneration >>> tokenizer =
PegasusTokenizer.from_pretrained(\u2018google/pegasus-large\u2019) >>> TXT = \u201CMy friends are <mask> but they eat too many
carbs.\u201D`),vv.forEach(t),_v.forEach(t),fv.forEach(t),gv.forEach(t),Wm=l(M),ci=s(M,"BLOCKQUOTE",{});var kv=a(ci);ui=s(kv,"BLOCKQUOTE",{});var yv=a(ui);pi=s(yv,"BLOCKQUOTE",{});var bv=a(pi);hi=s(bv,"P",{});var Tv=a(hi);Bm=i(Tv,`model = FlaxPegasusForConditionalGeneration.from_pretrained(\u2018google/pegasus-large\u2019) >>> input_ids =
tokenizer([TXT], return_tensors=\u2018np\u2019)[\u2018input_ids\u2019] >>> logits = model(input_ids).logits`),Tv.forEach(t),bv.forEach(t),yv.forEach(t),kv.forEach(t),Vm=l(M),mi=s(M,"BLOCKQUOTE",{});var wv=a(mi);gi=s(wv,"BLOCKQUOTE",{});var Pv=a(gi);fi=s(Pv,"BLOCKQUOTE",{});var xv=a(fi);_i=s(xv,"P",{});var zv=a(_i);Rm=i(zv,`masked_index = (input_ids[0] == tokenizer.mask_token_id).nonzero().item() >>> probs =
jax.nn.softmax(logits[0, masked_index], axis=0) >>> values, predictions = jax.lax.top_k(probs)`),zv.forEach(t),xv.forEach(t),Pv.forEach(t),wv.forEach(t),Hm=l(M),vi=s(M,"BLOCKQUOTE",{});var Fv=a(vi);ki=s(Fv,"BLOCKQUOTE",{});var $v=a(ki);yi=s($v,"BLOCKQUOTE",{});var qv=a(yi);bi=s(qv,"P",{});var Ev=a(bi);Km=i(Ev,"tokenizer.decode(predictions).split()"),Ev.forEach(t),qv.forEach(t),$v.forEach(t),Fv.forEach(t),M.forEach(t),Qm=l(se),tt=s(se,"DIV",{class:!0});var da=a(tt);g(ks.$$.fragment,da),Jm=l(da),Ti=s(da,"P",{});var Cv=a(Ti);Xm=i(Cv,"Example:"),Cv.forEach(t),Zm=l(da),g(ys.$$.fragment,da),da.forEach(t),Ym=l(se),ot=s(se,"DIV",{class:!0});var la=a(ot);g(bs.$$.fragment,la),eg=l(la),wi=s(la,"P",{});var Mv=a(wi);tg=i(Mv,"Example:"),Mv.forEach(t),og=l(la),g(Ts.$$.fragment,la),la.forEach(t),se.forEach(t),this.h()},h(){c(h,"name","hf:doc:metadata"),c(h,"content",JSON.stringify(Hv)),c(P,"id","pegasus"),c(P,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(P,"href","#pegasus"),c(b,"class","relative group"),c(re,"href","https://github.com/huggingface/transformers/issues/new?assignees=sshleifer&labels=&template=bug-report.md&title"),c(re,"rel","nofollow"),c(O,"id","overview"),c(O,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(O,"href","#overview"),c(N,"class","relative group"),c(D,"href","https://arxiv.org/pdf/1912.08777.pdf"),c(D,"rel","nofollow"),c($,"href","https://huggingface.co/sshleifer"),c($,"rel","nofollow"),c(Fe,"href","https://github.com/google-research/pegasus"),c(Fe,"rel","nofollow"),c(I,"id","checkpoints"),c(I,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(I,"href","#checkpoints"),c(le,"class","relative group"),c(qo,"href","https://huggingface.co/models?search=pegasus"),c(qo,"rel","nofollow"),c(Co,"href","https://github.com/huggingface/transformers/issues/6844#issue-689259666"),c(Co,"rel","nofollow"),c(Mo,"href","https://huggingface.co/models?search=distill-pegasus"),c(Mo,"rel","nofollow"),c(jo,"href","https://arxiv.org/abs/2010.13002"),c(jo,"rel","nofollow"),c(Vt,"id","examples"),c(Vt,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(Vt,"href","#examples"),c(kt,"class","relative group"),c(Oo,"href","https://github.com/huggingface/transformers/tree/main/examples/research_projects/seq2seq-distillation/finetune_pegasus_xsum.sh"),c(Oo,"rel","nofollow"),c(Ao,"href","https://github.com/huggingface/transformers/tree/main/examples/pytorch/summarization/README.md"),c(Ao,"rel","nofollow"),c(Ht,"id","implementation-notes"),c(Ht,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(Ht,"href","#implementation-notes"),c(yt,"class","relative group"),c(zs,"href","/docs/transformers/v4.18.0/en/model_doc/bart#transformers.BartForConditionalGeneration"),c(No,"href","https://github.com/google-research/pegasus"),c(No,"rel","nofollow"),c(Kt,"id","usage-example"),c(Kt,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(Kt,"href","#usage-example"),c(wt,"class","relative group"),c(Qt,"id","transformers.PegasusConfig"),c(Qt,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(Qt,"href","#transformers.PegasusConfig"),c(Pt,"class","relative group"),c(Fs,"href","/docs/transformers/v4.18.0/en/model_doc/pegasus#transformers.PegasusModel"),c(Vo,"href","https://huggingface.co/google/pegasus-large"),c(Vo,"rel","nofollow"),c($s,"href","/docs/transformers/v4.18.0/en/main_classes/configuration#transformers.PretrainedConfig"),c(qs,"href","/docs/transformers/v4.18.0/en/main_classes/configuration#transformers.PretrainedConfig"),c(ce,"class","docstring"),c(Jt,"id","transformers.PegasusTokenizer"),c(Jt,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(Jt,"href","#transformers.PegasusTokenizer"),c(Ft,"class","relative group"),c(Jo,"href","https://github.com/google/sentencepiece"),c(Jo,"rel","nofollow"),c(Es,"href","/docs/transformers/v4.18.0/en/main_classes/tokenizer#transformers.PreTrainedTokenizer"),c(je,"class","docstring"),c(Zt,"class","docstring"),c(Yt,"class","docstring"),c(eo,"class","docstring"),c(W,"class","docstring"),c(to,"id","transformers.PegasusTokenizerFast"),c(to,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(to,"href","#transformers.PegasusTokenizerFast"),c($t,"class","relative group"),c(dn,"href","https://huggingface.co/docs/tokenizers/python/latest/components.html?highlight=unigram#models"),c(dn,"rel","nofollow"),c(Ms,"href","/docs/transformers/v4.18.0/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast"),c(Xe,"class","docstring"),c(oo,"class","docstring"),c(ue,"class","docstring"),c(no,"id","transformers.PegasusModel"),c(no,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(no,"href","#transformers.PegasusModel"),c(Et,"class","relative group"),c(Ss,"href","/docs/transformers/v4.18.0/en/main_classes/model#transformers.PreTrainedModel"),c(vn,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),c(vn,"rel","nofollow"),c(Os,"href","/docs/transformers/v4.18.0/en/model_doc/pegasus#transformers.PegasusModel"),c(ve,"class","docstring"),c(qe,"class","docstring"),c(ao,"id","transformers.PegasusForConditionalGeneration"),c(ao,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(ao,"href","#transformers.PegasusForConditionalGeneration"),c(Mt,"class","relative group"),c(As,"href","/docs/transformers/v4.18.0/en/main_classes/model#transformers.PreTrainedModel"),c(xn,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),c(xn,"rel","nofollow"),c(Is,"href","/docs/transformers/v4.18.0/en/model_doc/pegasus#transformers.PegasusForConditionalGeneration"),c(ke,"class","docstring"),c(Ee,"class","docstring"),c(io,"id","transformers.PegasusForCausalLM"),c(io,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(io,"href","#transformers.PegasusForCausalLM"),c(St,"class","relative group"),c(Ze,"class","docstring"),c(Ot,"class","docstring"),c(lo,"id","transformers.TFPegasusModel"),c(lo,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(lo,"href","#transformers.TFPegasusModel"),c(At,"class","relative group"),c(Ls,"href","/docs/transformers/v4.18.0/en/main_classes/model#transformers.TFPreTrainedModel"),c(An,"href","https://www.tensorflow.org/api_docs/python/tf/keras/Model"),c(An,"rel","nofollow"),c(Gs,"href","/docs/transformers/v4.18.0/en/model_doc/pegasus#transformers.TFPegasusModel"),c(ye,"class","docstring"),c(pe,"class","docstring"),c(po,"id","transformers.TFPegasusForConditionalGeneration"),c(po,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(po,"href","#transformers.TFPegasusForConditionalGeneration"),c(Lt,"class","relative group"),c(Ns,"href","/docs/transformers/v4.18.0/en/main_classes/model#transformers.TFPreTrainedModel"),c(Wn,"href","https://www.tensorflow.org/api_docs/python/tf/keras/Model"),c(Wn,"rel","nofollow"),c(Ds,"href","/docs/transformers/v4.18.0/en/model_doc/pegasus#transformers.TFPegasusForConditionalGeneration"),c(be,"class","docstring"),c(he,"class","docstring"),c(go,"id","transformers.FlaxPegasusModel"),c(go,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(go,"href","#transformers.FlaxPegasusModel"),c(Nt,"class","relative group"),c(Us,"href","/docs/transformers/v4.18.0/en/main_classes/model#transformers.FlaxPreTrainedModel"),c(Jn,"href","https://flax.readthedocs.io/en/latest/_autosummary/flax.nn.module.html"),c(Jn,"rel","nofollow"),c(Xn,"href","https://jax.readthedocs.io/en/latest/jax.html#just-in-time-compilation-jit"),c(Xn,"rel","nofollow"),c(Zn,"href","https://jax.readthedocs.io/en/latest/jax.html#automatic-differentiation"),c(Zn,"rel","nofollow"),c(Yn,"href","https://jax.readthedocs.io/en/latest/jax.html#vectorization-vmap"),c(Yn,"rel","nofollow"),c(es,"href","https://jax.readthedocs.io/en/latest/jax.html#parallelization-pmap"),c(es,"rel","nofollow"),c(Te,"class","docstring"),c(Ye,"class","docstring"),c(et,"class","docstring"),c(L,"class","docstring"),c(_o,"id","transformers.FlaxPegasusForConditionalGeneration"),c(_o,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(_o,"href","#transformers.FlaxPegasusForConditionalGeneration"),c(Ut,"class","relative group"),c(Ws,"href","/docs/transformers/v4.18.0/en/main_classes/model#transformers.FlaxPreTrainedModel"),c(us,"href","https://flax.readthedocs.io/en/latest/_autosummary/flax.nn.module.html"),c(us,"rel","nofollow"),c(ps,"href","https://jax.readthedocs.io/en/latest/jax.html#just-in-time-compilation-jit"),c(ps,"rel","nofollow"),c(hs,"href","https://jax.readthedocs.io/en/latest/jax.html#automatic-differentiation"),c(hs,"rel","nofollow"),c(ms,"href","https://jax.readthedocs.io/en/latest/jax.html#vectorization-vmap"),c(ms,"rel","nofollow"),c(gs,"href","https://jax.readthedocs.io/en/latest/jax.html#parallelization-pmap"),c(gs,"rel","nofollow"),c(yo,"id","generate-summary->>>-summary_ids-=-model.generate(inputs[\u2018input_ids\u2019]).sequences->>>"),c(yo,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(yo,"href","#generate-summary->>>-summary_ids-=-model.generate(inputs[\u2018input_ids\u2019]).sequences->>>"),c(ko,"class","relative group"),c(E,"class","docstring"),c(tt,"class","docstring"),c(ot,"class","docstring"),c(G,"class","docstring")},m(o,p){e(document.head,h),u(o,z,p),u(o,b,p),e(b,P),e(P,x),f(w,x,null),e(b,T),e(b,F),e(F,Oe),u(o,me,p),u(o,q,p),e(q,Pe),e(Pe,ae),e(q,Ae),e(q,re),e(re,ie),e(q,Ie),u(o,Ce,p),u(o,N,p),e(N,O),e(O,xe),f(H,xe,null),e(N,j),e(N,S),e(S,Le),u(o,Y,p),u(o,ee,p),e(ee,Ge),e(ee,D),e(D,Ne),e(ee,De),u(o,A,p),u(o,ge,p),e(ge,de),u(o,Me,p),u(o,te,p),e(te,K),e(K,Ue),e(te,We),e(te,U),e(U,Be),u(o,oe,p),u(o,V,p),e(V,y),e(V,$),e($,ze),e(V,mt),e(V,Fe),e(Fe,Q),e(V,gt),u(o,Ke,p),u(o,le,p),e(le,I),e(I,J),f($e,J,null),e(le,ft),e(le,X),e(X,_t),u(o,Qe,p),u(o,R,p),e(R,vt),e(R,qo),e(qo,Yd),e(R,el),e(R,ca),e(ca,tl),e(R,ol),u(o,Ci,p),u(o,fe,p),e(fe,ua),e(ua,nl),e(fe,sl),e(fe,pa),e(pa,al),e(fe,rl),e(fe,ha),e(ha,il),e(fe,dl),e(fe,Eo),e(Eo,ll),e(Eo,Co),e(Co,cl),e(Eo,ul),e(fe,pl),e(fe,Bt),e(Bt,Mo),e(Mo,hl),e(Bt,ml),e(Bt,jo),e(jo,gl),e(Bt,fl),u(o,Mi,p),u(o,kt,p),e(kt,Vt),e(Vt,ma),f(So,ma,null),e(kt,_l),e(kt,ga),e(ga,vl),u(o,ji,p),u(o,Je,p),e(Je,Rt),e(Rt,Oo),e(Oo,kl),e(Rt,yl),e(Rt,Ao),e(Ao,bl),e(Rt,Tl),e(Je,wl),e(Je,fa),e(fa,Pl),e(Je,xl),e(Je,_a),e(_a,zl),u(o,Si,p),u(o,yt,p),e(yt,Ht),e(Ht,va),f(Io,va,null),e(yt,Fl),e(yt,ka),e(ka,$l),u(o,Oi,p),u(o,_e,p),e(_e,ya),e(ya,ba),e(ba,ql),e(_e,El),e(_e,Ta),e(Ta,xs),e(xs,Cl),e(xs,zs),e(zs,Ml),e(_e,jl),e(_e,Lo),e(Lo,wa),e(wa,Sl),e(Lo,Ol),e(Lo,bt),e(bt,Pa),e(Pa,Al),e(bt,Il),e(bt,xa),e(xa,Ll),e(bt,Gl),e(bt,Go),e(Go,Nl),e(Go,za),e(za,Dl),e(Go,Ul),e(_e,Wl),e(_e,Fa),e(Fa,Ve),e(Ve,Bl),e(Ve,$a),e($a,Vl),e(Ve,Rl),e(Ve,qa),e(qa,Hl),e(Ve,Kl),e(Ve,Ea),e(Ea,Ql),e(Ve,Jl),e(_e,Xl),e(_e,Ca),e(Ca,Tt),e(Tt,Zl),e(Tt,No),e(No,Yl),e(Tt,ec),e(Tt,Ma),e(Ma,tc),e(Tt,oc),u(o,Ai,p),u(o,wt,p),e(wt,Kt),e(Kt,ja),f(Do,ja,null),e(wt,nc),e(wt,Sa),e(Sa,sc),u(o,Ii,p),f(Uo,o,p),u(o,Li,p),u(o,Pt,p),e(Pt,Qt),e(Qt,Oa),f(Wo,Oa,null),e(Pt,ac),e(Pt,Aa),e(Aa,rc),u(o,Gi,p),u(o,ce,p),f(Bo,ce,null),e(ce,ic),e(ce,xt),e(xt,dc),e(xt,Fs),e(Fs,lc),e(xt,cc),e(xt,Vo),e(Vo,uc),e(xt,pc),e(ce,hc),e(ce,zt),e(zt,mc),e(zt,$s),e($s,gc),e(zt,fc),e(zt,qs),e(qs,_c),e(zt,vc),e(ce,kc),e(ce,Ia),e(Ia,yc),e(ce,bc),f(Ro,ce,null),u(o,Ni,p),u(o,Ft,p),e(Ft,Jt),e(Jt,La),f(Ho,La,null),e(Ft,Tc),e(Ft,Ga),e(Ga,wc),u(o,Di,p),u(o,Xt,p),e(Xt,Pc),e(Xt,Na),e(Na,xc),e(Xt,zc),u(o,Ui,p),u(o,W,p),f(Ko,W,null),e(W,Fc),e(W,Qo),e(Qo,$c),e(Qo,Jo),e(Jo,qc),e(Qo,Ec),e(W,Cc),e(W,Xo),e(Xo,Mc),e(Xo,Es),e(Es,jc),e(Xo,Sc),e(W,Oc),e(W,je),f(Zo,je,null),e(je,Ac),e(je,Yo),e(Yo,Ic),e(Yo,Da),e(Da,Lc),e(Yo,Gc),e(je,Nc),e(je,en),e(en,Cs),e(Cs,Dc),e(Cs,Ua),e(Ua,Uc),e(en,Wc),e(en,tn),e(tn,Bc),e(tn,Wa),e(Wa,Vc),e(tn,Rc),e(je,Hc),e(je,Ba),e(Ba,Kc),e(W,Qc),e(W,Zt),f(on,Zt,null),e(Zt,Jc),e(Zt,Va),e(Va,Xc),e(W,Zc),e(W,Yt),f(nn,Yt,null),e(Yt,Yc),e(Yt,Ra),e(Ra,eu),e(W,tu),e(W,eo),f(sn,eo,null),e(eo,ou),e(eo,Ha),e(Ha,nu),u(o,Wi,p),u(o,$t,p),e($t,to),e(to,Ka),f(an,Ka,null),e($t,su),e($t,Qa),e(Qa,au),u(o,Bi,p),u(o,ue,p),f(rn,ue,null),e(ue,ru),e(ue,qt),e(qt,iu),e(qt,Ja),e(Ja,du),e(qt,lu),e(qt,dn),e(dn,cu),e(qt,uu),e(ue,pu),e(ue,ln),e(ln,hu),e(ln,Ms),e(Ms,mu),e(ln,gu),e(ue,fu),e(ue,Xe),f(cn,Xe,null),e(Xe,_u),e(Xe,Xa),e(Xa,vu),e(Xe,ku),e(Xe,un),e(un,js),e(js,yu),e(js,Za),e(Za,bu),e(un,Tu),e(un,pn),e(pn,wu),e(pn,Ya),e(Ya,Pu),e(pn,xu),e(ue,zu),e(ue,oo),f(hn,oo,null),e(oo,Fu),e(oo,er),e(er,$u),u(o,Vi,p),u(o,Et,p),e(Et,no),e(no,tr),f(mn,tr,null),e(Et,qu),e(Et,or),e(or,Eu),u(o,Ri,p),u(o,qe,p),f(gn,qe,null),e(qe,Cu),e(qe,fn),e(fn,Mu),e(fn,Ss),e(Ss,ju),e(fn,Su),e(qe,Ou),e(qe,_n),e(_n,Au),e(_n,vn),e(vn,Iu),e(_n,Lu),e(qe,Gu),e(qe,ve),f(kn,ve,null),e(ve,Nu),e(ve,Ct),e(Ct,Du),e(Ct,Os),e(Os,Uu),e(Ct,Wu),e(Ct,nr),e(nr,Bu),e(Ct,Vu),e(ve,Ru),f(so,ve,null),e(ve,Hu),e(ve,sr),e(sr,Ku),e(ve,Qu),f(yn,ve,null),u(o,Hi,p),u(o,Mt,p),e(Mt,ao),e(ao,ar),f(bn,ar,null),e(Mt,Ju),e(Mt,rr),e(rr,Xu),u(o,Ki,p),u(o,Ee,p),f(Tn,Ee,null),e(Ee,Zu),e(Ee,wn),e(wn,Yu),e(wn,As),e(As,ep),e(wn,tp),e(Ee,op),e(Ee,Pn),e(Pn,np),e(Pn,xn),e(xn,sp),e(Pn,ap),e(Ee,rp),e(Ee,ke),f(zn,ke,null),e(ke,ip),e(ke,jt),e(jt,dp),e(jt,Is),e(Is,lp),e(jt,cp),e(jt,ir),e(ir,up),e(jt,pp),e(ke,hp),f(ro,ke,null),e(ke,mp),e(ke,dr),e(dr,gp),e(ke,fp),f(Fn,ke,null),u(o,Qi,p),u(o,St,p),e(St,io),e(io,lr),f($n,lr,null),e(St,_p),e(St,cr),e(cr,vp),u(o,Ji,p),u(o,Ot,p),f(qn,Ot,null),e(Ot,kp),e(Ot,Ze),f(En,Ze,null),e(Ze,yp),e(Ze,ur),e(ur,bp),e(Ze,Tp),f(Cn,Ze,null),u(o,Xi,p),u(o,At,p),e(At,lo),e(lo,pr),f(Mn,pr,null),e(At,wp),e(At,hr),e(hr,Pp),u(o,Zi,p),u(o,pe,p),f(jn,pe,null),e(pe,xp),e(pe,Sn),e(Sn,zp),e(Sn,Ls),e(Ls,Fp),e(Sn,$p),e(pe,qp),e(pe,On),e(On,Ep),e(On,An),e(An,Cp),e(On,Mp),e(pe,jp),f(co,pe,null),e(pe,Sp),e(pe,ye),f(In,ye,null),e(ye,Op),e(ye,It),e(It,Ap),e(It,Gs),e(Gs,Ip),e(It,Lp),e(It,mr),e(mr,Gp),e(It,Np),e(ye,Dp),f(uo,ye,null),e(ye,Up),e(ye,gr),e(gr,Wp),e(ye,Bp),f(Ln,ye,null),u(o,Yi,p),u(o,Lt,p),e(Lt,po),e(po,fr),f(Gn,fr,null),e(Lt,Vp),e(Lt,_r),e(_r,Rp),u(o,ed,p),u(o,he,p),f(Nn,he,null),e(he,Hp),e(he,Dn),e(Dn,Kp),e(Dn,Ns),e(Ns,Qp),e(Dn,Jp),e(he,Xp),e(he,Un),e(Un,Zp),e(Un,Wn),e(Wn,Yp),e(Un,eh),e(he,th),f(ho,he,null),e(he,oh),e(he,be),f(Bn,be,null),e(be,nh),e(be,Gt),e(Gt,sh),e(Gt,Ds),e(Ds,ah),e(Gt,rh),e(Gt,vr),e(vr,ih),e(Gt,dh),e(be,lh),f(mo,be,null),e(be,ch),e(be,kr),e(kr,uh),e(be,ph),f(Vn,be,null),u(o,td,p),u(o,Nt,p),e(Nt,go),e(go,yr),f(Rn,yr,null),e(Nt,hh),e(Nt,br),e(br,mh),u(o,od,p),u(o,L,p),f(Hn,L,null),e(L,gh),e(L,Kn),e(Kn,fh),e(Kn,Us),e(Us,_h),e(Kn,vh),e(L,kh),e(L,Qn),e(Qn,yh),e(Qn,Jn),e(Jn,bh),e(Qn,Th),e(L,wh),e(L,Tr),e(Tr,Ph),e(L,xh),e(L,Re),e(Re,wr),e(wr,Xn),e(Xn,zh),e(Re,Fh),e(Re,Pr),e(Pr,Zn),e(Zn,$h),e(Re,qh),e(Re,xr),e(xr,Yn),e(Yn,Eh),e(Re,Ch),e(Re,zr),e(zr,es),e(es,Mh),e(L,jh),e(L,Te),f(ts,Te,null),e(Te,Sh),e(Te,Dt),e(Dt,Oh),e(Dt,Fr),e(Fr,Ah),e(Dt,Ih),e(Dt,$r),e($r,Lh),e(Dt,Gh),e(Te,Nh),f(fo,Te,null),e(Te,Dh),e(Te,qr),e(qr,Uh),e(Te,Wh),f(os,Te,null),e(L,Bh),e(L,Ye),f(ns,Ye,null),e(Ye,Vh),e(Ye,Er),e(Er,Rh),e(Ye,Hh),f(ss,Ye,null),e(L,Kh),e(L,et),f(as,et,null),e(et,Qh),e(et,Cr),e(Cr,Jh),e(et,Xh),f(rs,et,null),u(o,nd,p),u(o,Ut,p),e(Ut,_o),e(_o,Mr),f(is,Mr,null),e(Ut,Zh),e(Ut,jr),e(jr,Yh),u(o,sd,p),u(o,G,p),f(ds,G,null),e(G,em),e(G,ls),e(ls,tm),e(ls,Ws),e(Ws,om),e(ls,nm),e(G,sm),e(G,cs),e(cs,am),e(cs,us),e(us,rm),e(cs,im),e(G,dm),e(G,Sr),e(Sr,lm),e(G,cm),e(G,He),e(He,Or),e(Or,ps),e(ps,um),e(He,pm),e(He,Ar),e(Ar,hs),e(hs,hm),e(He,mm),e(He,Ir),e(Ir,ms),e(ms,gm),e(He,fm),e(He,Lr),e(Lr,gs),e(gs,_m),e(G,vm),e(G,E),f(fs,E,null),e(E,km),e(E,Wt),e(Wt,ym),e(Wt,Gr),e(Gr,bm),e(Wt,Tm),e(Wt,Nr),e(Nr,wm),e(Wt,Pm),e(E,xm),f(vo,E,null),e(E,zm),e(E,Dr),e(Dr,Fm),e(E,$m),e(E,Ur),e(Ur,Wr),e(Wr,Br),e(Br,Vr),e(Vr,qm),e(E,Em),e(E,Rr),e(Rr,Hr),e(Hr,Kr),e(Kr,Qr),e(Qr,Cm),e(E,Mm),e(E,Jr),e(Jr,Xr),e(Xr,Zr),e(Zr,Yr),e(Yr,jm),e(E,Sm),e(E,ei),e(ei,ti),e(ti,_s),e(_s,ko),e(ko,yo),e(yo,oi),f(vs,oi,null),e(ko,Om),e(ko,ni),e(ni,Am),e(_s,Im),e(_s,si),e(si,Lm),e(E,Gm),e(E,ai),e(ai,Nm),e(E,Dm),e(E,ri),e(ri,ii),e(ii,di),e(di,li),e(li,Um),e(E,Wm),e(E,ci),e(ci,ui),e(ui,pi),e(pi,hi),e(hi,Bm),e(E,Vm),e(E,mi),e(mi,gi),e(gi,fi),e(fi,_i),e(_i,Rm),e(E,Hm),e(E,vi),e(vi,ki),e(ki,yi),e(yi,bi),e(bi,Km),e(G,Qm),e(G,tt),f(ks,tt,null),e(tt,Jm),e(tt,Ti),e(Ti,Xm),e(tt,Zm),f(ys,tt,null),e(G,Ym),e(G,ot),f(bs,ot,null),e(ot,eg),e(ot,wi),e(wi,tg),e(ot,og),f(Ts,ot,null),ad=!0},p(o,[p]){const ws={};p&2&&(ws.$$scope={dirty:p,ctx:o}),so.$set(ws);const Pi={};p&2&&(Pi.$$scope={dirty:p,ctx:o}),ro.$set(Pi);const xi={};p&2&&(xi.$$scope={dirty:p,ctx:o}),co.$set(xi);const zi={};p&2&&(zi.$$scope={dirty:p,ctx:o}),uo.$set(zi);const bo={};p&2&&(bo.$$scope={dirty:p,ctx:o}),ho.$set(bo);const Fi={};p&2&&(Fi.$$scope={dirty:p,ctx:o}),mo.$set(Fi);const $i={};p&2&&($i.$$scope={dirty:p,ctx:o}),fo.$set($i);const Ps={};p&2&&(Ps.$$scope={dirty:p,ctx:o}),vo.$set(Ps)},i(o){ad||(_(w.$$.fragment,o),_(H.$$.fragment,o),_($e.$$.fragment,o),_(So.$$.fragment,o),_(Io.$$.fragment,o),_(Do.$$.fragment,o),_(Uo.$$.fragment,o),_(Wo.$$.fragment,o),_(Bo.$$.fragment,o),_(Ro.$$.fragment,o),_(Ho.$$.fragment,o),_(Ko.$$.fragment,o),_(Zo.$$.fragment,o),_(on.$$.fragment,o),_(nn.$$.fragment,o),_(sn.$$.fragment,o),_(an.$$.fragment,o),_(rn.$$.fragment,o),_(cn.$$.fragment,o),_(hn.$$.fragment,o),_(mn.$$.fragment,o),_(gn.$$.fragment,o),_(kn.$$.fragment,o),_(so.$$.fragment,o),_(yn.$$.fragment,o),_(bn.$$.fragment,o),_(Tn.$$.fragment,o),_(zn.$$.fragment,o),_(ro.$$.fragment,o),_(Fn.$$.fragment,o),_($n.$$.fragment,o),_(qn.$$.fragment,o),_(En.$$.fragment,o),_(Cn.$$.fragment,o),_(Mn.$$.fragment,o),_(jn.$$.fragment,o),_(co.$$.fragment,o),_(In.$$.fragment,o),_(uo.$$.fragment,o),_(Ln.$$.fragment,o),_(Gn.$$.fragment,o),_(Nn.$$.fragment,o),_(ho.$$.fragment,o),_(Bn.$$.fragment,o),_(mo.$$.fragment,o),_(Vn.$$.fragment,o),_(Rn.$$.fragment,o),_(Hn.$$.fragment,o),_(ts.$$.fragment,o),_(fo.$$.fragment,o),_(os.$$.fragment,o),_(ns.$$.fragment,o),_(ss.$$.fragment,o),_(as.$$.fragment,o),_(rs.$$.fragment,o),_(is.$$.fragment,o),_(ds.$$.fragment,o),_(fs.$$.fragment,o),_(vo.$$.fragment,o),_(vs.$$.fragment,o),_(ks.$$.fragment,o),_(ys.$$.fragment,o),_(bs.$$.fragment,o),_(Ts.$$.fragment,o),ad=!0)},o(o){v(w.$$.fragment,o),v(H.$$.fragment,o),v($e.$$.fragment,o),v(So.$$.fragment,o),v(Io.$$.fragment,o),v(Do.$$.fragment,o),v(Uo.$$.fragment,o),v(Wo.$$.fragment,o),v(Bo.$$.fragment,o),v(Ro.$$.fragment,o),v(Ho.$$.fragment,o),v(Ko.$$.fragment,o),v(Zo.$$.fragment,o),v(on.$$.fragment,o),v(nn.$$.fragment,o),v(sn.$$.fragment,o),v(an.$$.fragment,o),v(rn.$$.fragment,o),v(cn.$$.fragment,o),v(hn.$$.fragment,o),v(mn.$$.fragment,o),v(gn.$$.fragment,o),v(kn.$$.fragment,o),v(so.$$.fragment,o),v(yn.$$.fragment,o),v(bn.$$.fragment,o),v(Tn.$$.fragment,o),v(zn.$$.fragment,o),v(ro.$$.fragment,o),v(Fn.$$.fragment,o),v($n.$$.fragment,o),v(qn.$$.fragment,o),v(En.$$.fragment,o),v(Cn.$$.fragment,o),v(Mn.$$.fragment,o),v(jn.$$.fragment,o),v(co.$$.fragment,o),v(In.$$.fragment,o),v(uo.$$.fragment,o),v(Ln.$$.fragment,o),v(Gn.$$.fragment,o),v(Nn.$$.fragment,o),v(ho.$$.fragment,o),v(Bn.$$.fragment,o),v(mo.$$.fragment,o),v(Vn.$$.fragment,o),v(Rn.$$.fragment,o),v(Hn.$$.fragment,o),v(ts.$$.fragment,o),v(fo.$$.fragment,o),v(os.$$.fragment,o),v(ns.$$.fragment,o),v(ss.$$.fragment,o),v(as.$$.fragment,o),v(rs.$$.fragment,o),v(is.$$.fragment,o),v(ds.$$.fragment,o),v(fs.$$.fragment,o),v(vo.$$.fragment,o),v(vs.$$.fragment,o),v(ks.$$.fragment,o),v(ys.$$.fragment,o),v(bs.$$.fragment,o),v(Ts.$$.fragment,o),ad=!1},d(o){t(h),o&&t(z),o&&t(b),k(w),o&&t(me),o&&t(q),o&&t(Ce),o&&t(N),k(H),o&&t(Y),o&&t(ee),o&&t(A),o&&t(ge),o&&t(Me),o&&t(te),o&&t(oe),o&&t(V),o&&t(Ke),o&&t(le),k($e),o&&t(Qe),o&&t(R),o&&t(Ci),o&&t(fe),o&&t(Mi),o&&t(kt),k(So),o&&t(ji),o&&t(Je),o&&t(Si),o&&t(yt),k(Io),o&&t(Oi),o&&t(_e),o&&t(Ai),o&&t(wt),k(Do),o&&t(Ii),k(Uo,o),o&&t(Li),o&&t(Pt),k(Wo),o&&t(Gi),o&&t(ce),k(Bo),k(Ro),o&&t(Ni),o&&t(Ft),k(Ho),o&&t(Di),o&&t(Xt),o&&t(Ui),o&&t(W),k(Ko),k(Zo),k(on),k(nn),k(sn),o&&t(Wi),o&&t($t),k(an),o&&t(Bi),o&&t(ue),k(rn),k(cn),k(hn),o&&t(Vi),o&&t(Et),k(mn),o&&t(Ri),o&&t(qe),k(gn),k(kn),k(so),k(yn),o&&t(Hi),o&&t(Mt),k(bn),o&&t(Ki),o&&t(Ee),k(Tn),k(zn),k(ro),k(Fn),o&&t(Qi),o&&t(St),k($n),o&&t(Ji),o&&t(Ot),k(qn),k(En),k(Cn),o&&t(Xi),o&&t(At),k(Mn),o&&t(Zi),o&&t(pe),k(jn),k(co),k(In),k(uo),k(Ln),o&&t(Yi),o&&t(Lt),k(Gn),o&&t(ed),o&&t(he),k(Nn),k(ho),k(Bn),k(mo),k(Vn),o&&t(td),o&&t(Nt),k(Rn),o&&t(od),o&&t(L),k(Hn),k(ts),k(fo),k(os),k(ns),k(ss),k(as),k(rs),o&&t(nd),o&&t(Ut),k(is),o&&t(sd),o&&t(G),k(ds),k(fs),k(vo),k(vs),k(ks),k(ys),k(bs),k(Ts)}}}const Hv={local:"pegasus",sections:[{local:"overview",title:"Overview"},{local:"checkpoints",sections:[{local:"examples",title:"Examples"}],title:"Checkpoints"},{local:"implementation-notes",title:"Implementation Notes"},{local:"usage-example",title:"Usage Example"},{local:"transformers.PegasusConfig",title:"PegasusConfig"},{local:"transformers.PegasusTokenizer",title:"PegasusTokenizer"},{local:"transformers.PegasusTokenizerFast",title:"PegasusTokenizerFast"},{local:"transformers.PegasusModel",title:"PegasusModel"},{local:"transformers.PegasusForConditionalGeneration",title:"PegasusForConditionalGeneration"},{local:"transformers.PegasusForCausalLM",title:"PegasusForCausalLM"},{local:"transformers.TFPegasusModel",title:"TFPegasusModel"},{local:"transformers.TFPegasusForConditionalGeneration",title:"TFPegasusForConditionalGeneration"},{local:"transformers.FlaxPegasusModel",title:"FlaxPegasusModel"},{local:"transformers.FlaxPegasusForConditionalGeneration",title:"FlaxPegasusForConditionalGeneration"}],title:"Pegasus"};function Kv(B){return Iv(()=>{new URLSearchParams(window.location.search).get("fw")}),[]}class ek extends jv{constructor(h){super();Sv(this,h,Kv,Rv,Ov,{})}}export{ek as default,Hv as metadata};
