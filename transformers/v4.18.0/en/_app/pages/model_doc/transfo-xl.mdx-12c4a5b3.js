...
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),T.forEach(t)},m(_,T){f(_,m,T),e(m,M),e(m,u),e(u,g),e(m,$)},d(_){_&&t(m)}}}function Hf(R){let m,M,u,g,$;return{c(){m=n("p"),M=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),u=n("code"),g=r("Module"),$=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(_){m=s(_,"P",{});var T=a(m);M=i(T,"Although the recipe for forward pass needs to be defined within this function, one should call the "),u=s(T,"CODE",{});var X=a(u);g=i(X,"Module"),X.forEach(t),$=i(T,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),T.forEach(t)},m(_,T){f(_,m,T),e(m,M),e(m,u),e(u,g),e(m,$)},d(_){_&&t(m)}}}function Df(R){let m,M,u,g,$;return{c(){m=n("p"),M=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),u=n("code"),g=r("Module"),$=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(_){m=s(_,"P",{});var T=a(m);M=i(T,"Although the recipe for forward pass needs to be defined within this function, one should call the "),u=s(T,"CODE",{});var X=a(u);g=i(X,"Module"),X.forEach(t),$=i(T,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),T.forEach(t)},m(_,T){f(_,m,T),e(m,M),e(m,u),e(u,g),e(m,$)},d(_){_&&t(m)}}}function If(R){let m,M,u,g,$,_,T,X,I,W,x,z,O,K,ae,V,$e,ge,U,N,ne,re,F,C,ie,Q,_e,le,B,xe,Te,q,Xe,G,oe,fe,Z,Me,he,A,ve,j,Ee;return{c(){m=n("p"),M=r("TF 2.0 models accepts two formats as inputs:"),u=l(),g=n("ul"),$=n("li"),_=r("having all inputs as keyword arguments (like PyTorch models), or"),T=l(),X=n("li"),I=r("having all inputs as a list, tuple or dict in the first positional arguments."),W=l(),x=n("p"),z=r("This second option is useful when using "),O=n("code"),K=r("tf.keras.Model.fit"),ae=r(` method which currently requires having all the
...
`),j=s(ye,"CODE",{});var D=a(j);Ee=i(D,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),D.forEach(t),ye.forEach(t),P.forEach(t)},m(h,E){f(h,m,E),e(m,M),f(h,u,E),f(h,g,E),e(g,$),e($,_),e(g,T),e(g,X),e(X,I),f(h,W,E),f(h,x,E),e(x,z),e(x,O),e(O,K),e(x,ae),e(x,V),e(V,$e),e(x,ge),f(h,U,E),f(h,N,E),e(N,ne),f(h,re,E),f(h,F,E),e(F,C),e(C,ie),e(C,Q),e(Q,_e),e(C,le),e(C,B),e(B,xe),e(F,Te),e(F,q),e(q,Xe),e(q,G),e(G,oe),e(q,fe),e(q,Z),e(Z,Me),e(F,he),e(F,A),e(A,ve),e(A,j),e(j,Ee)},d(h){h&&t(m),h&&t(u),h&&t(g),h&&t(W),h&&t(x),h&&t(U),h&&t(N),h&&t(re),h&&t(F)}}}function Wf(R){let m,M,u,g,$;return{c(){m=n("p"),M=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),u=n("code"),g=r("Module"),$=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(_){m=s(_,"P",{});var T=a(m);M=i(T,"Although the recipe for forward pass needs to be defined within this function, one should call the "),u=s(T,"CODE",{});var X=a(u);g=i(X,"Module"),X.forEach(t),$=i(T,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),T.forEach(t)},m(_,T){f(_,m,T),e(m,M),e(m,u),e(u,g),e(m,$)},d(_){_&&t(m)}}}function Vf(R){let m,M,u,g,$,_,T,X,I,W,x,z,O,K,ae,V,$e,ge,U,N,ne,re,F,C,ie,Q,_e,le,B,xe,Te,q,Xe,G,oe,fe,Z,Me,he,A,ve,j,Ee;return{c(){m=n("p"),M=r("TF 2.0 models accepts two formats as inputs:"),u=l(),g=n("ul"),$=n("li"),_=r("having all inputs as keyword arguments (like PyTorch models), or"),T=l(),X=n("li"),I=r("having all inputs as a list, tuple or dict in the first positional arguments."),W=l(),x=n("p"),z=r("This second option is useful when using "),O=n("code"),K=r("tf.keras.Model.fit"),ae=r(` method which currently requires having all the
tensors in the first argument of the model call function: `),V=n("code"),$e=r("model(inputs)"),ge=r("."),U=l(),N=n("p"),ne=r(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),re=l(),F=n("ul"),C=n("li"),ie=r("a single Tensor with "),Q=n("code"),_e=r("input_ids"),le=r(" only and nothing else: "),B=n("code"),xe=r("model(inputs_ids)"),Te=l(),q=n("li"),Xe=r(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),G=n("code"),oe=r("model([input_ids, attention_mask])"),fe=r(" or "),Z=n("code"),Me=r("model([input_ids, attention_mask, token_type_ids])"),he=l(),A=n("li"),ve=r(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),j=n("code"),Ee=r('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(h){m=s(h,"P",{});var E=a(m);M=i(E,"TF 2.0 models accepts two formats as inputs:"),E.forEach(t),u=d(h),g=s(h,"UL",{});var de=a(g);$=s(de,"LI",{});var be=a($);_=i(be,"having all inputs as keyword arguments (like PyTorch models), or"),be.forEach(t),T=d(de),X=s(de,"LI",{});var Ve=a(X);I=i(Ve,"having all inputs as a list, tuple or dict in the first positional arguments."),Ve.forEach(t),de.forEach(t),W=d(h),x=s(h,"P",{});var H=a(x);z=i(H,"This second option is useful when using "),O=s(H,"CODE",{});var Ae=a(O);K=i(Ae,"tf.keras.Model.fit"),Ae.forEach(t),ae=i(H,` method which currently requires having all the
...
first positional argument :`),He.forEach(t),re=d(h),F=s(h,"UL",{});var P=a(F);C=s(P,"LI",{});var S=a(C);ie=i(S,"a single Tensor with "),Q=s(S,"CODE",{});var Ce=a(Q);_e=i(Ce,"input_ids"),Ce.forEach(t),le=i(S," only and nothing else: "),B=s(S,"CODE",{});var we=a(B);xe=i(we,"model(inputs_ids)"),we.forEach(t),S.forEach(t),Te=d(P),q=s(P,"LI",{});var J=a(q);Xe=i(J,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),G=s(J,"CODE",{});var ze=a(G);oe=i(ze,"model([input_ids, attention_mask])"),ze.forEach(t),fe=i(J," or "),Z=s(J,"CODE",{});var Ue=a(Z);Me=i(Ue,"model([input_ids, attention_mask, token_type_ids])"),Ue.forEach(t),J.forEach(t),he=d(P),A=s(P,"LI",{});var ye=a(A);ve=i(ye,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),j=s(ye,"CODE",{});var D=a(j);Ee=i(D,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),D.forEach(t),ye.forEach(t),P.forEach(t)},m(h,E){f(h,m,E),e(m,M),f(h,u,E),f(h,g,E),e(g,$),e($,_),e(g,T),e(g,X),e(X,I),f(h,W,E),f(h,x,E),e(x,z),e(x,O),e(O,K),e(x,ae),e(x,V),e(V,$e),e(x,ge),f(h,U,E),f(h,N,E),e(N,ne),f(h,re,E),f(h,F,E),e(F,C),e(C,ie),e(C,Q),e(Q,_e),e(C,le),e(C,B),e(B,xe),e(F,Te),e(F,q),e(q,Xe),e(q,G),e(G,oe),e(q,fe),e(q,Z),e(Z,Me),e(F,he),e(F,A),e(A,ve),e(A,j),e(j,Ee)},d(h){h&&t(m),h&&t(u),h&&t(g),h&&t(W),h&&t(x),h&&t(U),h&&t(N),h&&t(re),h&&t(F)}}}function Uf(R){let m,M,u,g,$;return{c(){m=n("p"),M=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),u=n("code"),g=r("Module"),$=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(_){m=s(_,"P",{});var T=a(m);M=i(T,"Although the recipe for forward pass needs to be defined within this function, one should call the "),u=s(T,"CODE",{});var X=a(u);g=i(X,"Module"),X.forEach(t),$=i(T,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),T.forEach(t)},m(_,T){f(_,m,T),e(m,M),e(m,u),e(u,g),e(m,$)},d(_){_&&t(m)}}}function Bf(R){let m,M,u,g,$,_,T,X,I,W,x,z,O,K,ae,V,$e,ge,U,N,ne,re,F,C,ie,Q,_e,le,B,xe,Te,q,Xe,G,oe,fe,Z,Me,he,A,ve,j,Ee;return{c(){m=n("p"),M=r("TF 2.0 models accepts two formats as inputs:"),u=l(),g=n("ul"),$=n("li"),_=r("having all inputs as keyword arguments (like PyTorch models), or"),T=l(),X=n("li"),I=r("having all inputs as a list, tuple or dict in the first positional arguments."),W=l(),x=n("p"),z=r("This second option is useful when using "),O=n("code"),K=r("tf.keras.Model.fit"),ae=r(` method which currently requires having all the
tensors in the first argument of the model call function: `),V=n("code"),$e=r("model(inputs)"),ge=r("."),U=l(),N=n("p"),ne=r(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),re=l(),F=n("ul"),C=n("li"),ie=r("a single Tensor with "),Q=n("code"),_e=r("input_ids"),le=r(" only and nothing else: "),B=n("code"),xe=r("model(inputs_ids)"),Te=l(),q=n("li"),Xe=r(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),G=n("code"),oe=r("model([input_ids, attention_mask])"),fe=r(" or "),Z=n("code"),Me=r("model([input_ids, attention_mask, token_type_ids])"),he=l(),A=n("li"),ve=r(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),j=n("code"),Ee=r('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(h){m=s(h,"P",{});var E=a(m);M=i(E,"TF 2.0 models accepts two formats as inputs:"),E.forEach(t),u=d(h),g=s(h,"UL",{});var de=a(g);$=s(de,"LI",{});var be=a($);_=i(be,"having all inputs as keyword arguments (like PyTorch models), or"),be.forEach(t),T=d(de),X=s(de,"LI",{});var Ve=a(X);I=i(Ve,"having all inputs as a list, tuple or dict in the first positional arguments."),Ve.forEach(t),de.forEach(t),W=d(h),x=s(h,"P",{});var H=a(x);z=i(H,"This second option is useful when using "),O=s(H,"CODE",{});var Ae=a(O);K=i(Ae,"tf.keras.Model.fit"),Ae.forEach(t),ae=i(H,` method which currently requires having all the
...
first positional argument :`),He.forEach(t),re=d(h),F=s(h,"UL",{});var P=a(F);C=s(P,"LI",{});var S=a(C);ie=i(S,"a single Tensor with "),Q=s(S,"CODE",{});var Ce=a(Q);_e=i(Ce,"input_ids"),Ce.forEach(t),le=i(S," only and nothing else: "),B=s(S,"CODE",{});var we=a(B);xe=i(we,"model(inputs_ids)"),we.forEach(t),S.forEach(t),Te=d(P),q=s(P,"LI",{});var J=a(q);Xe=i(J,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),G=s(J,"CODE",{});var ze=a(G);oe=i(ze,"model([input_ids, attention_mask])"),ze.forEach(t),fe=i(J," or "),Z=s(J,"CODE",{});var Ue=a(Z);Me=i(Ue,"model([input_ids, attention_mask, token_type_ids])"),Ue.forEach(t),J.forEach(t),he=d(P),A=s(P,"LI",{});var ye=a(A);ve=i(ye,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),j=s(ye,"CODE",{});var D=a(j);Ee=i(D,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),D.forEach(t),ye.forEach(t),P.forEach(t)},m(h,E){f(h,m,E),e(m,M),f(h,u,E),f(h,g,E),e(g,$),e($,_),e(g,T),e(g,X),e(X,I),f(h,W,E),f(h,x,E),e(x,z),e(x,O),e(O,K),e(x,ae),e(x,V),e(V,$e),e(x,ge),f(h,U,E),f(h,N,E),e(N,ne),f(h,re,E),f(h,F,E),e(F,C),e(C,ie),e(C,Q),e(Q,_e),e(C,le),e(C,B),e(B,xe),e(F,Te),e(F,q),e(q,Xe),e(q,G),e(G,oe),e(q,fe),e(q,Z),e(Z,Me),e(F,he),e(F,A),e(A,ve),e(A,j),e(j,Ee)},d(h){h&&t(m),h&&t(u),h&&t(g),h&&t(W),h&&t(x),h&&t(U),h&&t(N),h&&t(re),h&&t(F)}}}function Rf(R){let m,M,u,g,$;return{c(){m=n("p"),M=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),u=n("code"),g=r("Module"),$=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(_){m=s(_,"P",{});var T=a(m);M=i(T,"Although the recipe for forward pass needs to be defined within this function, one should call the "),u=s(T,"CODE",{});var X=a(u);g=i(X,"Module"),X.forEach(t),$=i(T,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),T.forEach(t)},m(_,T){f(_,m,T),e(m,M),e(m,u),e(u,g),e(m,$)},d(_){_&&t(m)}}}function Kf(R){let m,M,u,g,$,_,T,X,I,W,x,z,O,K,ae,V,$e,ge,U,N,ne,re,F,C,ie,Q,_e,le,B,xe,Te,q,Xe,G,oe,fe,Z,Me,he,A,ve,j,Ee,h,E,de,be,Ve,H,Ae,me,He,P,S,Ce,we,J,ze,Ue,ye,D,Kt,Da,Ye,Ia,cn,Wa,Va,fn,Ua,Ba,Gt,Ra,Ka,Ga,lt,Ya,hn,Qa,Za,mn,Ja,er,tr,Hn,or,nr,Yt,Ws,dt,Mt,Dn,Qt,sr,In,ar,Vs,De,Zt,rr,Jt,ir,eo,lr,dr,cr,to,fr,pn,hr,mr,pr,un,oo,Us,ct,Et,Wn,no,ur,Vn,gr,Bs,ft,so,_r,Un,Tr,Rs,ht,ao,vr,Bn,br,Ks,mt,ro,wr,Rn,yr,Gs,pt,io,Lr,Kn,kr,Ys,ut,Ft,Gn,lo,$r,Yn,xr,Qs,Fe,co,Xr,Qn,Mr,Er,fo,Fr,gn,qr,Cr,zr,ho,Pr,mo,jr,Or,Sr,Pe,po,Nr,gt,Ar,_n,Hr,Dr,Zn,Ir,Wr,Vr,qt,Ur,Jn,Br,Rr,uo,Zs,_t,Ct,es,go,Kr,ts,Gr,Js,qe,_o,Yr,os,Qr,Zr,To,Jr,Tn,ei,ti,oi,vo,ni,bo,si,ai,ri,je,wo,ii,Tt,li,vn,di,ci,ns,fi,hi,mi,zt,pi,ss,ui,gi,yo,ea,vt,Pt,as,Lo,_i,rs,Ti,ta,se,ko,vi,is,bi,wi,bn,wn,yi,Li,ki,Ie,$i,ls,xi,Xi,ds,Mi,Ei,cs,Fi,qi,fs,Ci,zi,Pi,$o,ji,yn,Oi,Si,Ni,xo,Ai,Xo,Hi,Di,Ii,Y,Mo,Wi,bt,Vi,Ln,Ui,Bi,hs,Ri,Ki,Gi,jt,Yi,ms,Qi,Zi,Eo,Ji,Fo,el,ps,tl,ol,qo,nl,Co,oa,wt,Ot,us,zo,sl,gs,al,na,pe,Po,rl,_s,il,ll,jo,dl,kn,cl,fl,hl,Oo,ml,So,pl,ul,gl,St,_l,Oe,No,Tl,yt,vl,$n,bl,wl,Ts,yl,Ll,kl,Nt,$l,vs,xl,Xl,Ao,sa,Lt,At,bs,Ho,Ml,ws,El,aa,ue,Do,Fl,ys,ql,Cl,Io,zl,xn,Pl,jl,Ol,Wo,Sl,Vo,Nl,Al,Hl,Ht,Dl,Se,Uo,Il,kt,Wl,Xn,Vl,Ul,Ls,Bl,Rl,Kl,Dt,Gl,ks,Yl,Ql,Bo,ra,$t,It,$s,Ro,Zl,xs,Jl,ia,ee,Ko,ed,Xs,td,od,Mn,En,nd,sd,ad,We,rd,Ms,id,ld,Es,dd,cd,Fs,fd,hd,qs,md,pd,ud,Go,gd,Fn,_d,Td,vd,Yo,bd,Qo,wd,yd,Ld,Wt,kd,Le,Zo,$d,xt,xd,qn,Xd,Md,Cs,Ed,Fd,qd,Vt,Cd,zs,zd,Pd,Jo,jd,en,la,Xt,Ut,Ps,tn,Od,js,Sd,da,on,nn,ca,sn,an,fa;return _=new Ge({}),K=new Ge({}),me=new it({props:{warning:!0,$$slots:{default:[Nf]},$$scope:{ctx:R}}}),we=new Ge({}),Kt=new te({props:{name:"class transformers.TransfoXLConfig",anchor:"transformers.TransfoXLConfig",parameters:[{name:"vocab_size",val:" = 267735"},{name:"cutoffs",val:" = [20000, 40000, 200000]"},{name:"d_model",val:" = 1024"},{name:"d_embed",val:" = 1024"},{name:"n_head",val:" = 16"},{name:"d_head",val:" = 64"},{name:"d_inner",val:" = 4096"},{name:"div_val",val:" = 4"},{name:"pre_lnorm",val:" = False"},{name:"n_layer",val:" = 18"},{name:"mem_len",val:" = 1600"},{name:"clamp_len",val:" = 1000"},{name:"same_length",val:" = True"},{name:"proj_share_all_but_first",val:" = True"},{name:"attn_type",val:" = 0"},{name:"sample_softmax",val:" = -1"},{name:"adaptive",val:" = True"},{name:"dropout",val:" = 0.1"},{name:"dropatt",val:" = 0.0"},{name:"untie_r",val:" = True"},{name:"init",val:" = 'normal'"},{name:"init_range",val:" = 0.01"},{name:"proj_init_std",val:" = 0.01"},{name:"init_std",val:" = 0.02"},{name:"layer_norm_epsilon",val:" = 1e-05"},{name:"eos_token_id",val:" = 0"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.TransfoXLConfig.vocab_size",description:`<strong>vocab_size</strong> (<code>int</code>, <em>optional</em>, defaults to 267735) &#x2014;
...
The epsilon to use in the layer normalization layers`,name:"layer_norm_epsilon"}],source:"https://github.com/huggingface/transformers/blob/v4.18.0/src/transformers/models/transfo_xl/configuration_transfo_xl.py#L29"}}),Yt=new Qe({props:{code:`from transformers import TransfoXLConfig, TransfoXLModel
...
Tuple of <code>tf.Tensor</code> (one for each layer) of shape <code>(batch_size, num_heads, sequence_length, sequence_length)</code>.</p>
<p>Attentions weights after the attention softmax, used to compute the weighted average in the self-attention
heads.`,name:"attentions"}],source:"https://github.com/huggingface/transformers/blob/v4.18.0/src/transformers/models/transfo_xl/modeling_tf_transfo_xl.py#L731"}}),lo=new Ge({}),co=new te({props:{name:"class transformers.TransfoXLModel",anchor:"transformers.TransfoXLModel",parameters:[{name:"config",val:""}],parametersDescription:[{anchor:"transformers.TransfoXLModel.config",description:`<strong>config</strong> (<a href="/docs/transformers/v4.18.0/en/model_doc/transfo-xl#transformers.TransfoXLConfig">TransfoXLConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/v4.18.0/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/v4.18.0/src/transformers/models/transfo_xl/modeling_transfo_xl.py#L771"}}),po=new te({props:{name:"forward",anchor:"transformers.TransfoXLModel.forward",parameters:[{name:"input_ids",val:" = None"},{name:"mems",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],parametersDescription:[{anchor:"transformers.TransfoXLModel.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/v4.18.0/en/model_doc/transfo-xl#transformers.TransfoXLTokenizer">TransfoXLTokenizer</a>. See <a href="/docs/transformers/v4.18.0/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
...
Whether or not to return a <a href="/docs/transformers/v4.18.0/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/v4.18.0/src/transformers/models/transfo_xl/modeling_transfo_xl.py#L875",returnDescription:`
<p>A <a
  href="/docs/transformers/v4.18.0/en/model_doc/transfo-xl#transformers.models.transfo_xl.modeling_transfo_xl.TransfoXLModelOutput"
...
elements depending on the configuration (<a
  href="/docs/transformers/v4.18.0/en/model_doc/transfo-xl#transformers.TransfoXLConfig"
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/v4.18.0/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/v4.18.0/src/transformers/models/transfo_xl/modeling_transfo_xl.py#L1013"}}),wo=new te({props:{name:"forward",anchor:"transformers.TransfoXLLMHeadModel.forward",parameters:[{name:"input_ids",val:" = None"},{name:"mems",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"labels",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],parametersDescription:[{anchor:"transformers.TransfoXLLMHeadModel.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/v4.18.0/en/model_doc/transfo-xl#transformers.TransfoXLTokenizer">TransfoXLTokenizer</a>. See <a href="/docs/transformers/v4.18.0/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/v4.18.0/en/model_doc/wav2vec2_phoneme#transformers.Wav2Vec2PhonemeCTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
are ignored (masked), the loss is only computed for labels in <code>[0, ..., config.vocab_size]</code>`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.18.0/src/transformers/models/transfo_xl/modeling_transfo_xl.py#L1065",returnDescription:`
<p>A <a
  href="/docs/transformers/v4.18.0/en/model_doc/transfo-xl#transformers.models.transfo_xl.modeling_transfo_xl.TransfoXLLMHeadModelOutput"
...
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.18.0/src/transformers/models/transfo_xl/modeling_transfo_xl.py#L1209",returnDescription:`
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/v4.18.0/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/v4.18.0/src/transformers/models/transfo_xl/modeling_tf_transfo_xl.py#L877"}}),St=new it({props:{$$slots:{default:[If]},$$scope:{ctx:R}}}),No=new te({props:{name:"call",anchor:"transformers.TFTransfoXLModel.call",parameters:[{name:"input_ids",val:" = None"},{name:"mems",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"},{name:"training",val:" = False"}],parametersDescription:[{anchor:"transformers.TFTransfoXLModel.call.input_ids",description:`<strong>input_ids</strong> (<code>tf.Tensor</code> or <code>Numpy array</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
...
behaviors between training and evaluation).`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/v4.18.0/src/transformers/models/transfo_xl/modeling_tf_transfo_xl.py#L882",returnDescription:`
<p>A <a
  href="/docs/transformers/v4.18.0/en/model_doc/transfo-xl#transformers.models.transfo_xl.modeling_tf_transfo_xl.TFTransfoXLModelOutput"
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/v4.18.0/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/v4.18.0/src/transformers/models/transfo_xl/modeling_tf_transfo_xl.py#L933"}}),Ht=new it({props:{$$slots:{default:[Vf]},$$scope:{ctx:R}}}),Uo=new te({props:{name:"call",anchor:"transformers.TFTransfoXLLMHeadModel.call",parameters:[{name:"input_ids",val:" = None"},{name:"mems",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"},{name:"labels",val:" = None"},{name:"training",val:" = False"}],parametersDescription:[{anchor:"transformers.TFTransfoXLLMHeadModel.call.input_ids",description:`<strong>input_ids</strong> (<code>tf.Tensor</code> or <code>Numpy array</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/v4.18.0/en/model_doc/bert#transformers.BertTokenizer">BertTokenizer</a>. See <a href="/docs/transformers/v4.18.0/en/model_doc/wav2vec2_phoneme#transformers.Wav2Vec2PhonemeCTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
<a href="/docs/transformers/v4.18.0/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> for details.</p>
...
Whether or not to use the model in training mode (some modules like dropout modules have different
behaviors between training and evaluation).`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/v4.18.0/src/transformers/models/transfo_xl/modeling_tf_transfo_xl.py#L961",returnDescription:`
<p>A <a
  href="/docs/transformers/v4.18.0/en/model_doc/transfo-xl#transformers.models.transfo_xl.modeling_tf_transfo_xl.TFTransfoXLLMHeadModelOutput"
...
Labels for computing the cross entropy classification loss. Indices should be in <code>[0, ..., config.vocab_size - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.18.0/src/transformers/models/transfo_xl/modeling_tf_transfo_xl.py#L1070",returnDescription:`
...
documentation from `),mn=n("a"),Ja=r("PretrainedConfig"),er=r(" for more information."),tr=l(),Hn=n("p"),or=r("Examples:"),nr=l(),v(Yt.$$.fragment),Ws=l(),dt=n("h2"),Mt=n("a"),Dn=n("span"),v(Qt.$$.fragment),sr=l(),In=n("span"),ar=r("TransfoXLTokenizer"),Vs=l(),De=n("div"),v(Zt.$$.fragment),rr=l(),Jt=n("p"),ir=r("Construct a Transformer-XL tokenizer adapted from Vocab class in "),eo=n("a"),lr=r(`the original
code`),dr=r(`. The Transformer-XL tokenizer is a word-level tokenizer (no
sub-word tokenization).`),cr=l(),to=n("p"),fr=r("This tokenizer inherits from "),pn=n("a"),hr=r("PreTrainedTokenizer"),mr=r(` which contains most of the main methods. Users should refer to
this superclass for more information regarding those methods.`),pr=l(),un=n("div"),v(oo.$$.fragment),Us=l(),ct=n("h2"),Et=n("a"),Wn=n("span"),v(no.$$.fragment),ur=l(),Vn=n("span"),gr=r("TransfoXL specific outputs"),Bs=l(),ft=n("div"),v(so.$$.fragment),_r=l(),Un=n("p"),Tr=r("Base class for model\u2019s outputs that may also contain a past key/values (to speed up sequential decoding)."),Rs=l(),ht=n("div"),v(ao.$$.fragment),vr=l(),Bn=n("p"),br=r("Base class for model\u2019s outputs that may also contain a past key/values (to speed up sequential decoding)."),Ks=l(),mt=n("div"),v(ro.$$.fragment),wr=l(),Rn=n("p"),yr=r("Base class for model\u2019s outputs that may also contain a past key/values (to speed up sequential decoding)."),Gs=l(),pt=n("div"),v(io.$$.fragment),Lr=l(),Kn=n("p"),kr=r("Base class for model\u2019s outputs that may also contain a past key/values (to speed up sequential decoding)."),Ys=l(),ut=n("h2"),Ft=n("a"),Gn=n("span"),v(lo.$$.fragment),$r=l(),Yn=n("span"),xr=r("TransfoXLModel"),Qs=l(),Fe=n("div"),v(co.$$.fragment),Xr=l(),Qn=n("p"),Mr=r("The bare Bert Model transformer outputting raw hidden-states without any specific head on top."),Er=l(),fo=n("p"),Fr=r("This model inherits from "),gn=n("a"),qr=r("PreTrainedModel"),Cr=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),zr=l(),ho=n("p"),Pr=r("This model is also a PyTorch "),mo=n("a"),jr=r("torch.nn.Module"),Or=r(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Sr=l(),Pe=n("div"),v(po.$$.fragment),Nr=l(),gt=n("p"),Ar=r("The "),_n=n("a"),Hr=r("TransfoXLModel"),Dr=r(" forward method, overrides the "),Zn=n("code"),Ir=r("__call__"),Wr=r(" special method."),Vr=l(),v(qt.$$.fragment),Ur=l(),Jn=n("p"),Br=r("Example:"),Rr=l(),v(uo.$$.fragment),Zs=l(),_t=n("h2"),Ct=n("a"),es=n("span"),v(go.$$.fragment),Kr=l(),ts=n("span"),Gr=r("TransfoXLLMHeadModel"),Js=l(),qe=n("div"),v(_o.$$.fragment),Yr=l(),os=n("p"),Qr=r(`The Transformer-XL Model with a language modeling head on top (adaptive softmax with weights tied to the adaptive
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Ii=l(),Y=n("div"),v(Mo.$$.fragment),Wi=l(),bt=n("p"),Vi=r("The "),Ln=n("a"),Ui=r("TransfoXLForSequenceClassification"),Bi=r(" forward method, overrides the "),hs=n("code"),Ri=r("__call__"),Ki=r(" special method."),Gi=l(),v(jt.$$.fragment),Yi=l(),ms=n("p"),Qi=r("Example of single-label classification:"),Zi=l(),v(Eo.$$.fragment),Ji=l(),v(Fo.$$.fragment),el=l(),ps=n("p"),tl=r("Example of multi-label classification:"),ol=l(),v(qo.$$.fragment),nl=l(),v(Co.$$.fragment),oa=l(),wt=n("h2"),Ot=n("a"),us=n("span"),v(zo.$$.fragment),sl=l(),gs=n("span"),al=r("TFTransfoXLModel"),na=l(),pe=n("div"),v(Po.$$.fragment),rl=l(),_s=n("p"),il=r("The bare Bert Model transformer outputting raw hidden-states without any specific head on top."),ll=l(),jo=n("p"),dl=r("This model inherits from "),kn=n("a"),cl=r("TFPreTrainedModel"),fl=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),hl=l(),Oo=n("p"),ml=r("This model is also a "),So=n("a"),pl=r("tf.keras.Model"),ul=r(` subclass. Use it
...
padding tokens when `),Fs=n("code"),fd=r("inputs_embeds"),hd=r(" are passed instead of "),qs=n("code"),md=r("input_ids"),pd=r(`, it does the same (take the last value in
...
original implementation trains on SQuAD with padding on the left, therefore the padding defaults are set to left.`),Vd.forEach(t),Me=d(ha),he=s(ha,"LI",{});var Ud=a(he);A=i(Ud,"Transformer-XL is one of the few models that has no sequence length limit."),Ud.forEach(t),ha.forEach(t),ve=d(o),j=s(o,"P",{});var Cn=a(j);Ee=i(Cn,"This model was contributed by "),h=s(Cn,"A",{href:!0,rel:!0});var Bd=a(h);E=i(Bd,"thomwolf"),Bd.forEach(t),de=i(Cn,". The original code can be found "),be=s(Cn,"A",{href:!0,rel:!0});var Rd=a(be);Ve=i(Rd,"here"),Rd.forEach(t),H=i(Cn,"."),Cn.forEach(t),Ae=d(o),b(me.$$.fragment,o),He=d(o),P=s(o,"H2",{class:!0});var ma=a(P);S=s(ma,"A",{id:!0,class:!0,href:!0});var Kd=a(S);Ce=s(Kd,"SPAN",{});var Gd=a(Ce);b(we.$$.fragment,Gd),Gd.forEach(t),Kd.forEach(t),J=d(ma),ze=s(ma,"SPAN",{});var Yd=a(ze);Ue=i(Yd,"TransfoXLConfig"),Yd.forEach(t),ma.forEach(t),ye=d(o),D=s(o,"DIV",{class:!0});var Ze=a(D);b(Kt.$$.fragment,Ze),Da=d(Ze),Ye=s(Ze,"P",{});var Bt=a(Ye);Ia=i(Bt,"This is the configuration class to store the configuration of a "),cn=s(Bt,"A",{href:!0});var Qd=a(cn);Wa=i(Qd,"TransfoXLModel"),Qd.forEach(t),Va=i(Bt," or a "),fn=s(Bt,"A",{href:!0});var Zd=a(fn);Ua=i(Zd,"TFTransfoXLModel"),Zd.forEach(t),Ba=i(Bt,`. It is
used to instantiate a Transformer-XL model according to the specified arguments, defining the model architecture.
...
documentation from `),mn=s(zn,"A",{href:!0});var tc=a(mn);Ja=i(tc,"PretrainedConfig"),tc.forEach(t),er=i(zn," for more information."),zn.forEach(t),tr=d(Ze),Hn=s(Ze,"P",{});var oc=a(Hn);or=i(oc,"Examples:"),oc.forEach(t),nr=d(Ze),b(Yt.$$.fragment,Ze),Ze.forEach(t),Ws=d(o),dt=s(o,"H2",{class:!0});var pa=a(dt);Mt=s(pa,"A",{id:!0,class:!0,href:!0});var nc=a(Mt);Dn=s(nc,"SPAN",{});var sc=a(Dn);b(Qt.$$.fragment,sc),sc.forEach(t),nc.forEach(t),sr=d(pa),In=s(pa,"SPAN",{});var ac=a(In);ar=i(ac,"TransfoXLTokenizer"),ac.forEach(t),pa.forEach(t),Vs=d(o),De=s(o,"DIV",{class:!0});var Rt=a(De);b(Zt.$$.fragment,Rt),rr=d(Rt),Jt=s(Rt,"P",{});var ua=a(Jt);ir=i(ua,"Construct a Transformer-XL tokenizer adapted from Vocab class in "),eo=s(ua,"A",{href:!0,rel:!0});var rc=a(eo);lr=i(rc,`the original
code`),rc.forEach(t),dr=i(ua,`. The Transformer-XL tokenizer is a word-level tokenizer (no
sub-word tokenization).`),ua.forEach(t),cr=d(Rt),to=s(Rt,"P",{});var ga=a(to);fr=i(ga,"This tokenizer inherits from "),pn=s(ga,"A",{href:!0});var ic=a(pn);hr=i(ic,"PreTrainedTokenizer"),ic.forEach(t),mr=i(ga,` which contains most of the main methods. Users should refer to
this superclass for more information regarding those methods.`),ga.forEach(t),pr=d(Rt),un=s(Rt,"DIV",{class:!0});var lc=a(un);b(oo.$$.fragment,lc),lc.forEach(t),Rt.forEach(t),Us=d(o),ct=s(o,"H2",{class:!0});var _a=a(ct);Et=s(_a,"A",{id:!0,class:!0,href:!0});var dc=a(Et);Wn=s(dc,"SPAN",{});var cc=a(Wn);b(no.$$.fragment,cc),cc.forEach(t),dc.forEach(t),ur=d(_a),Vn=s(_a,"SPAN",{});var fc=a(Vn);gr=i(fc,"TransfoXL specific outputs"),fc.forEach(t),_a.forEach(t),Bs=d(o),ft=s(o,"DIV",{class:!0});var Ta=a(ft);b(so.$$.fragment,Ta),_r=d(Ta),Un=s(Ta,"P",{});var hc=a(Un);Tr=i(hc,"Base class for model\u2019s outputs that may also contain a past key/values (to speed up sequential decoding)."),hc.forEach(t),Ta.forEach(t),Rs=d(o),ht=s(o,"DIV",{class:!0});var va=a(ht);b(ao.$$.fragment,va),vr=d(va),Bn=s(va,"P",{});var mc=a(Bn);br=i(mc,"Base class for model\u2019s outputs that may also contain a past key/values (to speed up sequential decoding)."),mc.forEach(t),va.forEach(t),Ks=d(o),mt=s(o,"DIV",{class:!0});var ba=a(mt);b(ro.$$.fragment,ba),wr=d(ba),Rn=s(ba,"P",{});var pc=a(Rn);yr=i(pc,"Base class for model\u2019s outputs that may also contain a past key/values (to speed up sequential decoding)."),pc.forEach(t),ba.forEach(t),Gs=d(o),pt=s(o,"DIV",{class:!0});var wa=a(pt);b(io.$$.fragment,wa),Lr=d(wa),Kn=s(wa,"P",{});var uc=a(Kn);kr=i(uc,"Base class for model\u2019s outputs that may also contain a past key/values (to speed up sequential decoding)."),uc.forEach(t),wa.forEach(t),Ys=d(o),ut=s(o,"H2",{class:!0});var ya=a(ut);Ft=s(ya,"A",{id:!0,class:!0,href:!0});var gc=a(Ft);Gn=s(gc,"SPAN",{});var _c=a(Gn);b(lo.$$.fragment,_c),_c.forEach(t),gc.forEach(t),$r=d(ya),Yn=s(ya,"SPAN",{});var Tc=a(Yn);xr=i(Tc,"TransfoXLModel"),Tc.forEach(t),ya.forEach(t),Qs=d(o),Fe=s(o,"DIV",{class:!0});var Je=a(Fe);b(co.$$.fragment,Je),Xr=d(Je),Qn=s(Je,"P",{});var vc=a(Qn);Mr=i(vc,"The bare Bert Model transformer outputting raw hidden-states without any specific head on top."),vc.forEach(t),Er=d(Je),fo=s(Je,"P",{});var La=a(fo);Fr=i(La,"This model inherits from "),gn=s(La,"A",{href:!0});var bc=a(gn);qr=i(bc,"PreTrainedModel"),bc.forEach(t),Cr=i(La,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),La.forEach(t),zr=d(Je),ho=s(Je,"P",{});var ka=a(ho);Pr=i(ka,"This model is also a PyTorch "),mo=s(ka,"A",{href:!0,rel:!0});var wc=a(mo);jr=i(wc,"torch.nn.Module"),wc.forEach(t),Or=i(ka,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Xa.forEach(t),ri=d(tt),je=s(tt,"DIV",{class:!0});var ot=a(je);b(wo.$$.fragment,ot),ii=d(ot),Tt=s(ot,"P",{});var jn=a(Tt);li=i(jn,"The "),vn=s(jn,"A",{href:!0});var qc=a(vn);di=i(qc,"TransfoXLLMHeadModel"),qc.forEach(t),ci=i(jn," forward method, overrides the "),ns=s(jn,"CODE",{});var Cc=a(ns);fi=i(Cc,"__call__"),Cc.forEach(t),hi=i(jn," special method."),jn.forEach(t),mi=d(ot),b(zt.$$.fragment,ot),pi=d(ot),ss=s(ot,"P",{});var zc=a(ss);ui=i(zc,"Example:"),zc.forEach(t),gi=d(ot),b(yo.$$.fragment,ot),ot.forEach(t),tt.forEach(t),ea=d(o),vt=s(o,"H2",{class:!0});var Ma=a(vt);Pt=s(Ma,"A",{id:!0,class:!0,href:!0});var Pc=a(Pt);as=s(Pc,"SPAN",{});var jc=a(as);b(Lo.$$.fragment,jc),jc.forEach(t),Pc.forEach(t),_i=d(Ma),rs=s(Ma,"SPAN",{});var Oc=a(rs);Ti=i(Oc,"TransfoXLForSequenceClassification"),Oc.forEach(t),Ma.forEach(t),ta=d(o),se=s(o,"DIV",{class:!0});var Ne=a(se);b(ko.$$.fragment,Ne),vi=d(Ne),is=s(Ne,"P",{});var Sc=a(is);bi=i(Sc,"The Transformer-XL Model transformer with a sequence classification head on top (linear layer)."),Sc.forEach(t),wi=d(Ne),bn=s(Ne,"P",{});var Nd=a(bn);wn=s(Nd,"A",{href:!0});var Nc=a(wn);yi=i(Nc,"TransfoXLForSequenceClassification"),Nc.forEach(t),Li=i(Nd,` uses the last token in order to do the classification, as other causal
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Fa.forEach(t),Ii=d(Ne),Y=s(Ne,"DIV",{class:!0});var ce=a(Y);b(Mo.$$.fragment,ce),Wi=d(ce),bt=s(ce,"P",{});var On=a(bt);Vi=i(On,"The "),Ln=s(On,"A",{href:!0});var Uc=a(Ln);Ui=i(Uc,"TransfoXLForSequenceClassification"),Uc.forEach(t),Bi=i(On," forward method, overrides the "),hs=s(On,"CODE",{});var Bc=a(hs);Ri=i(Bc,"__call__"),Bc.forEach(t),Ki=i(On," special method."),On.forEach(t),Gi=d(ce),b(jt.$$.fragment,ce),Yi=d(ce),ms=s(ce,"P",{});var Rc=a(ms);Qi=i(Rc,"Example of single-label classification:"),Rc.forEach(t),Zi=d(ce),b(Eo.$$.fragment,ce),Ji=d(ce),b(Fo.$$.fragment,ce),el=d(ce),ps=s(ce,"P",{});var Kc=a(ps);tl=i(Kc,"Example of multi-label classification:"),Kc.forEach(t),ol=d(ce),b(qo.$$.fragment,ce),nl=d(ce),b(Co.$$.fragment,ce),ce.forEach(t),Ne.forEach(t),oa=d(o),wt=s(o,"H2",{class:!0});var qa=a(wt);Ot=s(qa,"A",{id:!0,class:!0,href:!0});var Gc=a(Ot);us=s(Gc,"SPAN",{});var Yc=a(us);b(zo.$$.fragment,Yc),Yc.forEach(t),Gc.forEach(t),sl=d(qa),gs=s(qa,"SPAN",{});var Qc=a(gs);al=i(Qc,"TFTransfoXLModel"),Qc.forEach(t),qa.forEach(t),na=d(o),pe=s(o,"DIV",{class:!0});var Be=a(pe);b(Po.$$.fragment,Be),rl=d(Be),_s=s(Be,"P",{});var Zc=a(_s);il=i(Zc,"The bare Bert Model transformer outputting raw hidden-states without any specific head on top."),Zc.forEach(t),ll=d(Be),jo=s(Be,"P",{});var Ca=a(jo);dl=i(Ca,"This model inherits from "),kn=s(Ca,"A",{href:!0});var Jc=a(kn);cl=i(Jc,"TFPreTrainedModel"),Jc.forEach(t),fl=i(Ca,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Ca.forEach(t),hl=d(Be),Oo=s(Be,"P",{});var za=a(Oo);ml=i(za,"This model is also a "),So=s(za,"A",{href:!0,rel:!0});var ef=a(So);pl=i(ef,"tf.keras.Model"),ef.forEach(t),ul=i(za,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
...
padding tokens when `),Fs=s(rt,"CODE",{});var wf=a(Fs);fd=i(wf,"inputs_embeds"),wf.forEach(t),hd=i(rt," are passed instead of "),qs=s(rt,"CODE",{});var yf=a(qs);md=i(yf,"input_ids"),yf.forEach(t),pd=i(rt,`, it does the same (take the last value in
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Aa.forEach(t),Ld=d(ke),b(Wt.$$.fragment,ke),kd=d(ke),Le=s(ke,"DIV",{class:!0});var Ke=a(Le);b(Zo.$$.fragment,Ke),$d=d(Ke),xt=s(Ke,"P",{});var An=a(xt);xd=i(An,"The "),qn=s(An,"A",{href:!0});var $f=a(qn);Xd=i($f,"TFTransfoXLForSequenceClassification"),$f.forEach(t),Md=i(An," forward method, overrides the "),Cs=s(An,"CODE",{});var xf=a(Cs);Ed=i(xf,"__call__"),xf.forEach(t),Fd=i(An," special method."),An.forEach(t),qd=d(Ke),b(Vt.$$.fragment,Ke),Cd=d(Ke),zs=s(Ke,"P",{});var Xf=a(zs);zd=i(Xf,"Example:"),Xf.forEach(t),Pd=d(Ke),b(Jo.$$.fragment,Ke),jd=d(Ke),b(en.$$.fragment,Ke),Ke.forEach(t),ke.forEach(t),la=d(o),Xt=s(o,"H2",{class:!0});var Ha=a(Xt);Ut=s(Ha,"A",{id:!0,class:!0,href:!0});var Mf=a(Ut);Ps=s(Mf,"SPAN",{});var Ef=a(Ps);b(tn.$$.fragment,Ef),Ef.forEach(t),Mf.forEach(t),Od=d(Ha),js=s(Ha,"SPAN",{});var Ff=a(js);Sd=i(Ff,"Internal Layers"),Ff.forEach(t),Ha.forEach(t),da=d(o),on=s(o,"DIV",{class:!0});var qf=a(on);b(nn.$$.fragment,qf),qf.forEach(t),ca=d(o),sn=s(o,"DIV",{class:!0});var Cf=a(sn);b(an.$$.fragment,Cf),Cf.forEach(t),this.h()},h(){c(m,"name","hf:doc:metadata"),c(m,"content",JSON.stringify(Gf)),c(g,"id","transformer-xl"),c(g,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(g,"href","#transformer-xl"),c(u,"class","relative group"),c(z,"id","overview"),c(z,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(z,"href","#overview"),c(x,"class","relative group"),c(ne,"href","https://arxiv.org/abs/1901.02860"),c(ne,"rel","nofollow"),c(h,"href","https://huggingface.co/thomwolf"),c(h,"rel","nofollow"),c(be,"href","https://github.com/kimiyoung/transformer-xl"),c(be,"rel","nofollow"),c(S,"id","transformers.TransfoXLConfig"),c(S,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(S,"href","#transformers.TransfoXLConfig"),c(P,"class","relative group"),c(cn,"href","/docs/transformers/v4.18.0/en/model_doc/transfo-xl#transformers.TransfoXLModel"),c(fn,"href","/docs/transformers/v4.18.0/en/model_doc/transfo-xl#transformers.TFTransfoXLModel"),c(Gt,"href","https://huggingface.co/transfo-xl-wt103"),c(Gt,"rel","nofollow"),c(hn,"href","/docs/transformers/v4.18.0/en/main_classes/configuration#transformers.PretrainedConfig"),c(mn,"href","/docs/transformers/v4.18.0/en/main_classes/configuration#transformers.PretrainedConfig"),c(D,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),c(Mt,"id","transformers.TransfoXLTokenizer"),c(Mt,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(Mt,"href","#transformers.TransfoXLTokenizer"),c(dt,"class","relative group"),c(eo,"href","https://github.com/kimiyoung/transformer-xl"),c(eo,"rel","nofollow"),c(pn,"href","/docs/transformers/v4.18.0/en/main_classes/tokenizer#transformers.PreTrainedTokenizer"),c(un,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),c(De,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),c(Et,"id","transformers.models.transfo_xl.modeling_transfo_xl.TransfoXLModelOutput"),c(Et,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(Et,"href","#transformers.models.transfo_xl.modeling_transfo_xl.TransfoXLModelOutput"),c(ct,"class","relative group"),c(ft,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),c(ht,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),c(mt,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),c(pt,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),c(Ft,"id","transformers.TransfoXLModel"),c(Ft,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(Ft,"href","#transformers.TransfoXLModel"),c(ut,"class","relative group"),c(gn,"href","/docs/transformers/v4.18.0/en/main_classes/model#transformers.PreTrainedModel"),c(mo,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),c(mo,"rel","nofollow"),c(_n,"href","/docs/transformers/v4.18.0/en/model_doc/transfo-xl#transformers.TransfoXLModel"),c(Pe,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),c(Fe,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),c(Ct,"id","transformers.TransfoXLLMHeadModel"),c(Ct,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(Ct,"href","#transformers.TransfoXLLMHeadModel"),c(_t,"class","relative group"),c(Tn,"href","/docs/transformers/v4.18.0/en/main_classes/model#transformers.PreTrainedModel"),c(bo,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),c(bo,"rel","nofollow"),c(vn,"href","/docs/transformers/v4.18.0/en/model_doc/transfo-xl#transformers.TransfoXLLMHeadModel"),c(je,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),c(qe,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),c(Pt,"id","transformers.TransfoXLForSequenceClassification"),c(Pt,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(Pt,"href","#transformers.TransfoXLForSequenceClassification"),c(vt,"class","relative group"),c(wn,"href","/docs/transformers/v4.18.0/en/model_doc/transfo-xl#transformers.TransfoXLForSequenceClassification"),c(yn,"href","/docs/transformers/v4.18.0/en/main_classes/model#transformers.PreTrainedModel"),c(Xo,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),c(Xo,"rel","nofollow"),c(Ln,"href","/docs/transformers/v4.18.0/en/model_doc/transfo-xl#transformers.TransfoXLForSequenceClassification"),c(Y,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),c(se,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),c(Ot,"id","transformers.TFTransfoXLModel"),c(Ot,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(Ot,"href","#transformers.TFTransfoXLModel"),c(wt,"class","relative group"),c(kn,"href","/docs/transformers/v4.18.0/en/main_classes/model#transformers.TFPreTrainedModel"),c(So,"href","https://www.tensorflow.org/api_docs/python/tf/keras/Model"),c(So,"rel","nofollow"),c($n,"href","/docs/transformers/v4.18.0/en/model_doc/transfo-xl#transformers.TFTransfoXLModel"),c(Oe,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),c(pe,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),c(At,"id","transformers.TFTransfoXLLMHeadModel"),c(At,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(At,"href","#transformers.TFTransfoXLLMHeadModel"),c(Lt,"class","relative group"),c(xn,"href","/docs/transformers/v4.18.0/en/main_classes/model#transformers.TFPreTrainedModel"),c(Vo,"href","https://www.tensorflow.org/api_docs/python/tf/keras/Model"),c(Vo,"rel","nofollow"),c(Xn,"href","/docs/transformers/v4.18.0/en/model_doc/transfo-xl#transformers.TFTransfoXLLMHeadModel"),c(Se,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),c(ue,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),c(It,"id","transformers.TFTransfoXLForSequenceClassification"),c(It,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(It,"href","#transformers.TFTransfoXLForSequenceClassification"),c($t,"class","relative group"),c(En,"href","/docs/transformers/v4.18.0/en/model_doc/transfo-xl#transformers.TFTransfoXLForSequenceClassification"),c(Fn,"href","/docs/transformers/v4.18.0/en/main_classes/model#transformers.TFPreTrainedModel"),c(Qo,"href","https://www.tensorflow.org/api_docs/python/tf/keras/Model"),c(Qo,"rel","nofollow"),c(qn,"href","/docs/transformers/v4.18.0/en/model_doc/transfo-xl#transformers.TFTransfoXLForSequenceClassification"),c(Le,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),c(ee,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),c(Ut,"id","transformers.AdaptiveEmbedding"),c(Ut,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(Ut,"href","#transformers.AdaptiveEmbedding"),c(Xt,"class","relative group"),c(on,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),c(sn,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8")},m(o,p){e(document.head,m),f(o,M,p),f(o,u,p),e(u,g),e(g,$),w(_,$,null),e(u,T),e(u,X),e(X,I),f(o,W,p),f(o,x,p),e(x,z),e(z,O),w(K,O,null),e(x,ae),e(x,V),e(V,$e),f(o,ge,p),f(o,U,p),e(U,N),e(U,ne),e(ne,re),e(U,F),f(o,C,p),f(o,ie,p),e(ie,Q),f(o,_e,p),f(o,le,p),e(le,B),e(B,xe),f(o,Te,p),f(o,q,p),e(q,Xe),f(o,G,p),f(o,oe,p),e(oe,fe),e(fe,Z),e(oe,Me),e(oe,he),e(he,A),f(o,ve,p),f(o,j,p),e(j,Ee),e(j,h),e(h,E),e(j,de),e(j,be),e(be,Ve),e(j,H),f(o,Ae,p),w(me,o,p),f(o,He,p),f(o,P,p),e(P,S),e(S,Ce),w(we,Ce,null),e(P,J),e(P,ze),e(ze,Ue),f(o,ye,p),f(o,D,p),w(Kt,D,null),e(D,Da),e(D,Ye),e(Ye,Ia),e(Ye,cn),e(cn,Wa),e(Ye,Va),e(Ye,fn),e(fn,Ua),e(Ye,Ba),e(Ye,Gt),e(Gt,Ra),e(Ye,Ka),e(D,Ga),e(D,lt),e(lt,Ya),e(lt,hn),e(hn,Qa),e(lt,Za),e(lt,mn),e(mn,Ja),e(lt,er),e(D,tr),e(D,Hn),e(Hn,or),e(D,nr),w(Yt,D,null),f(o,Ws,p),f(o,dt,p),e(dt,Mt),e(Mt,Dn),w(Qt,Dn,null),e(dt,sr),e(dt,In),e(In,ar),f(o,Vs,p),f(o,De,p),w(Zt,De,null),e(De,rr),e(De,Jt),e(Jt,ir),e(Jt,eo),e(eo,lr),e(Jt,dr),e(De,cr),e(De,to),e(to,fr),e(to,pn),e(pn,hr),e(to,mr),e(De,pr),e(De,un),w(oo,un,null),f(o,Us,p),f(o,ct,p),e(ct,Et),e(Et,Wn),w(no,Wn,null),e(ct,ur),e(ct,Vn),e(Vn,gr),f(o,Bs,p),f(o,ft,p),w(so,ft,null),e(ft,_r),e(ft,Un),e(Un,Tr),f(o,Rs,p),f(o,ht,p),w(ao,ht,null),e(ht,vr),e(ht,Bn),e(Bn,br),f(o,Ks,p),f(o,mt,p),w(ro,mt,null),e(mt,wr),e(mt,Rn),e(Rn,yr),f(o,Gs,p),f(o,pt,p),w(io,pt,null),e(pt,Lr),e(pt,Kn),e(Kn,kr),f(o,Ys,p),f(o,ut,p),e(ut,Ft),e(Ft,Gn),w(lo,Gn,null),e(ut,$r),e(ut,Yn),e(Yn,xr),f(o,Qs,p),f(o,Fe,p),w(co,Fe,null),e(Fe,Xr),e(Fe,Qn),e(Qn,Mr),e(Fe,Er),e(Fe,fo),e(fo,Fr),e(fo,gn),e(gn,qr),e(fo,Cr),e(Fe,zr),e(Fe,ho),e(ho,Pr),e(ho,mo),e(mo,jr),e(ho,Or),e(Fe,Sr),e(Fe,Pe),w(po,Pe,null),e(Pe,Nr),e(Pe,gt),e(gt,Ar),e(gt,_n),e(_n,Hr),e(gt,Dr),e(gt,Zn),e(Zn,Ir),e(gt,Wr),e(Pe,Vr),w(qt,Pe,null),e(Pe,Ur),e(Pe,Jn),e(Jn,Br),e(Pe,Rr),w(uo,Pe,null),f(o,Zs,p),f(o,_t,p),e(_t,Ct),e(Ct,es),w(go,es,null),e(_t,Kr),e(_t,ts),e(ts,Gr),f(o,Js,p),f(o,qe,p),w(_o,qe,null),e(qe,Yr),e(qe,os),e(os,Qr),e(qe,Zr),e(qe,To),e(To,Jr),e(To,Tn),e(Tn,ei),e(To,ti),e(qe,oi),e(qe,vo),e(vo,ni),e(vo,bo),e(bo,si),e(vo,ai),e(qe,ri),e(qe,je),w(wo,je,null),e(je,ii),e(je,Tt),e(Tt,li),e(Tt,vn),e(vn,di),e(Tt,ci),e(Tt,ns),e(ns,fi),e(Tt,hi),e(je,mi),w(zt,je,null),e(je,pi),e(je,ss),e(ss,ui),e(je,gi),w(yo,je,null),f(o,ea,p),f(o,vt,p),e(vt,Pt),e(Pt,as),w(Lo,as,null),e(vt,_i),e(vt,rs),e(rs,Ti),f(o,ta,p),f(o,se,p),w(ko,se,null),e(se,vi),e(se,is),e(is,bi),e(se,wi),e(se,bn),e(bn,wn),e(wn,yi),e(bn,Li),e(se,ki),e(se,Ie),e(Ie,$i),e(Ie,ls),e(ls,xi),e(Ie,Xi),e(Ie,ds),e(ds,Mi),e(Ie,Ei),e(Ie,cs),e(cs,Fi),e(Ie,qi),e(Ie,fs),e(fs,Ci),e(Ie,zi),e(se,Pi),e(se,$o),e($o,ji),e($o,yn),e(yn,Oi),e($o,Si),e(se,Ni),e(se,xo),e(xo,Ai),e(xo,Xo),e(Xo,Hi),e(xo,Di),e(se,Ii),e(se,Y),w(Mo,Y,null),e(Y,Wi),e(Y,bt),e(bt,Vi),e(bt,Ln),e(Ln,Ui),e(bt,Bi),e(bt,hs),e(hs,Ri),e(bt,Ki),e(Y,Gi),w(jt,Y,null),e(Y,Yi),e(Y,ms),e(ms,Qi),e(Y,Zi),w(Eo,Y,null),e(Y,Ji),w(Fo,Y,null),e(Y,el),e(Y,ps),e(ps,tl),e(Y,ol),w(qo,Y,null),e(Y,nl),w(Co,Y,null),f(o,oa,p),f(o,wt,p),e(wt,Ot),e(Ot,us),w(zo,us,null),e(wt,sl),e(wt,gs),e(gs,al),f(o,na,p),f(o,pe,p),w(Po,pe,null),e(pe,rl),e(pe,_s),e(_s,il),e(pe,ll),e(pe,jo),e(jo,dl),e(jo,kn),e(kn,cl),e(jo,fl),e(pe,hl),e(pe,Oo),e(Oo,ml),e(Oo,So),e(So,pl),e(Oo,ul),e(pe,gl),w(St,pe,null),e(pe,_l),e(pe,Oe),w(No,Oe,null),e(Oe,Tl),e(Oe,yt),e(yt,vl),e(yt,$n),e($n,bl),e(yt,wl),e(yt,Ts),e(Ts,yl),e(yt,Ll),e(Oe,kl),w(Nt,Oe,null),e(Oe,$l),e(Oe,vs),e(vs,xl),e(Oe,Xl),w(Ao,Oe,null),f(o,sa,p),f(o,Lt,p),e(Lt,At),e(At,bs),w(Ho,bs,null),e(Lt,Ml),e(Lt,ws),e(ws,El),f(o,aa,p),f(o,ue,p),w(Do,ue,null),e(ue,Fl),e(ue,ys),e(ys,ql),e(ue,Cl),e(ue,Io),e(Io,zl),e(Io,xn),e(xn,Pl),e(Io,jl),e(ue,Ol),e(ue,Wo),e(Wo,Sl),e(Wo,Vo),e(Vo,Nl),e(Wo,Al),e(ue,Hl),w(Ht,ue,null),e(ue,Dl),e(ue,Se),w(Uo,Se,null),e(Se,Il),e(Se,kt),e(kt,Wl),e(kt,Xn),e(Xn,Vl),e(kt,Ul),e(kt,Ls),e(Ls,Bl),e(kt,Rl),e(Se,Kl),w(Dt,Se,null),e(Se,Gl),e(Se,ks),e(ks,Yl),e(Se,Ql),w(Bo,Se,null),f(o,ra,p),f(o,$t,p),e($t,It),e(It,$s),w(Ro,$s,null),e($t,Zl),e($t,xs),e(xs,Jl),f(o,ia,p),f(o,ee,p),w(Ko,ee,null),e(ee,ed),e(ee,Xs),e(Xs,td),e(ee,od),e(ee,Mn),e(Mn,En),e(En,nd),e(Mn,sd),e(ee,ad),e(ee,We),e(We,rd),e(We,Ms),e(Ms,id),e(We,ld),e(We,Es),e(Es,dd),e(We,cd),e(We,Fs),e(Fs,fd),e(We,hd),e(We,qs),e(qs,md),e(We,pd),e(ee,ud),e(ee,Go),e(Go,gd),e(Go,Fn),e(Fn,_d),e(Go,Td),e(ee,vd),e(ee,Yo),e(Yo,bd),e(Yo,Qo),e(Qo,wd),e(Yo,yd),e(ee,Ld),w(Wt,ee,null),e(ee,kd),e(ee,Le),w(Zo,Le,null),e(Le,$d),e(Le,xt),e(xt,xd),e(xt,qn),e(qn,Xd),e(xt,Md),e(xt,Cs),e(Cs,Ed),e(xt,Fd),e(Le,qd),w(Vt,Le,null),e(Le,Cd),e(Le,zs),e(zs,zd),e(Le,Pd),w(Jo,Le,null),e(Le,jd),w(en,Le,null),f(o,la,p),f(o,Xt,p),e(Xt,Ut),e(Ut,Ps),w(tn,Ps,null),e(Xt,Od),e(Xt,js),e(js,Sd),f(o,da,p),f(o,on,p),w(nn,on,null),f(o,ca,p),f(o,sn,p),w(an,sn,null),fa=!0},p(o,[p]){const rn={};p&2&&(rn.$$scope={dirty:p,ctx:o}),me.$set(rn);const Os={};p&2&&(Os.$$scope={dirty:p,ctx:o}),qt.$set(Os);const Ss={};p&2&&(Ss.$$scope={dirty:p,ctx:o}),zt.$set(Ss);const Ns={};p&2&&(Ns.$$scope={dirty:p,ctx:o}),jt.$set(Ns);const ln={};p&2&&(ln.$$scope={dirty:p,ctx:o}),St.$set(ln);const As={};p&2&&(As.$$scope={dirty:p,ctx:o}),Nt.$set(As);const Hs={};p&2&&(Hs.$$scope={dirty:p,ctx:o}),Ht.$set(Hs);const Ds={};p&2&&(Ds.$$scope={dirty:p,ctx:o}),Dt.$set(Ds);const dn={};p&2&&(dn.$$scope={dirty:p,ctx:o}),Wt.$set(dn);const Is={};p&2&&(Is.$$scope={dirty:p,ctx:o}),Vt.$set(Is)},i(o){fa||(y(_.$$.fragment,o),y(K.$$.fragment,o),y(me.$$.fragment,o),y(we.$$.fragment,o),y(Kt.$$.fragment,o),y(Yt.$$.fragment,o),y(Qt.$$.fragment,o),y(Zt.$$.fragment,o),y(oo.$$.fragment,o),y(no.$$.fragment,o),y(so.$$.fragment,o),y(ao.$$.fragment,o),y(ro.$$.fragment,o),y(io.$$.fragment,o),y(lo.$$.fragment,o),y(co.$$.fragment,o),y(po.$$.fragment,o),y(qt.$$.fragment,o),y(uo.$$.fragment,o),y(go.$$.fragment,o),y(_o.$$.fragment,o),y(wo.$$.fragment,o),y(zt.$$.fragment,o),y(yo.$$.fragment,o),y(Lo.$$.fragment,o),y(ko.$$.fragment,o),y(Mo.$$.fragment,o),y(jt.$$.fragment,o),y(Eo.$$.fragment,o),y(Fo.$$.fragment,o),y(qo.$$.fragment,o),y(Co.$$.fragment,o),y(zo.$$.fragment,o),y(Po.$$.fragment,o),y(St.$$.fragment,o),y(No.$$.fragment,o),y(Nt.$$.fragment,o),y(Ao.$$.fragment,o),y(Ho.$$.fragment,o),y(Do.$$.fragment,o),y(Ht.$$.fragment,o),y(Uo.$$.fragment,o),y(Dt.$$.fragment,o),y(Bo.$$.fragment,o),y(Ro.$$.fragment,o),y(Ko.$$.fragment,o),y(Wt.$$.fragment,o),y(Zo.$$.fragment,o),y(Vt.$$.fragment,o),y(Jo.$$.fragment,o),y(en.$$.fragment,o),y(tn.$$.fragment,o),y(nn.$$.fragment,o),y(an.$$.fragment,o),fa=!0)},o(o){L(_.$$.fragment,o),L(K.$$.fragment,o),L(me.$$.fragment,o),L(we.$$.fragment,o),L(Kt.$$.fragment,o),L(Yt.$$.fragment,o),L(Qt.$$.fragment,o),L(Zt.$$.fragment,o),L(oo.$$.fragment,o),L(no.$$.fragment,o),L(so.$$.fragment,o),L(ao.$$.fragment,o),L(ro.$$.fragment,o),L(io.$$.fragment,o),L(lo.$$.fragment,o),L(co.$$.fragment,o),L(po.$$.fragment,o),L(qt.$$.fragment,o),L(uo.$$.fragment,o),L(go.$$.fragment,o),L(_o.$$.fragment,o),L(wo.$$.fragment,o),L(zt.$$.fragment,o),L(yo.$$.fragment,o),L(Lo.$$.fragment,o),L(ko.$$.fragment,o),L(Mo.$$.fragment,o),L(jt.$$.fragment,o),L(Eo.$$.fragment,o),L(Fo.$$.fragment,o),L(qo.$$.fragment,o),L(Co.$$.fragment,o),L(zo.$$.fragment,o),L(Po.$$.fragment,o),L(St.$$.fragment,o),L(No.$$.fragment,o),L(Nt.$$.fragment,o),L(Ao.$$.fragment,o),L(Ho.$$.fragment,o),L(Do.$$.fragment,o),L(Ht.$$.fragment,o),L(Uo.$$.fragment,o),L(Dt.$$.fragment,o),L(Bo.$$.fragment,o),L(Ro.$$.fragment,o),L(Ko.$$.fragment,o),L(Wt.$$.fragment,o),L(Zo.$$.fragment,o),L(Vt.$$.fragment,o),L(Jo.$$.fragment,o),L(en.$$.fragment,o),L(tn.$$.fragment,o),L(nn.$$.fragment,o),L(an.$$.fragment,o),fa=!1},d(o){t(m),o&&t(M),o&&t(u),k(_),o&&t(W),o&&t(x),k(K),o&&t(ge),o&&t(U),o&&t(C),o&&t(ie),o&&t(_e),o&&t(le),o&&t(Te),o&&t(q),o&&t(G),o&&t(oe),o&&t(ve),o&&t(j),o&&t(Ae),k(me,o),o&&t(He),o&&t(P),k(we),o&&t(ye),o&&t(D),k(Kt),k(Yt),o&&t(Ws),o&&t(dt),k(Qt),o&&t(Vs),o&&t(De),k(Zt),k(oo),o&&t(Us),o&&t(ct),k(no),o&&t(Bs),o&&t(ft),k(so),o&&t(Rs),o&&t(ht),k(ao),o&&t(Ks),o&&t(mt),k(ro),o&&t(Gs),o&&t(pt),k(io),o&&t(Ys),o&&t(ut),k(lo),o&&t(Qs),o&&t(Fe),k(co),k(po),k(qt),k(uo),o&&t(Zs),o&&t(_t),k(go),o&&t(Js),o&&t(qe),k(_o),k(wo),k(zt),k(yo),o&&t(ea),o&&t(vt),k(Lo),o&&t(ta),o&&t(se),k(ko),k(Mo),k(jt),k(Eo),k(Fo),k(qo),k(Co),o&&t(oa),o&&t(wt),k(zo),o&&t(na),o&&t(pe),k(Po),k(St),k(No),k(Nt),k(Ao),o&&t(sa),o&&t(Lt),k(Ho),o&&t(aa),o&&t(ue),k(Do),k(Ht),k(Uo),k(Dt),k(Bo),o&&t(ra),o&&t($t),k(Ro),o&&t(ia),o&&t(ee),k(Ko),k(Wt),k(Zo),k(Vt),k(Jo),k(en),o&&t(la),o&&t(Xt),k(tn),o&&t(da),o&&t(on),k(nn),o&&t(ca),o&&t(sn),k(an)}}}const Gf={local:"transformer-xl",sections:[{local:"overview",title:"Overview"},{local:"transformers.TransfoXLConfig",title:"TransfoXLConfig"},{local:"transformers.TransfoXLTokenizer",title:"TransfoXLTokenizer"},{local:"transformers.models.transfo_xl.modeling_transfo_xl.TransfoXLModelOutput",title:"TransfoXL specific outputs"},{local:"transformers.TransfoXLModel",title:"TransfoXLModel"},{local:"transformers.TransfoXLLMHeadModel",title:"TransfoXLLMHeadModel"},{local:"transformers.TransfoXLForSequenceClassification",title:"TransfoXLForSequenceClassification"},{local:"transformers.TFTransfoXLModel",title:"TFTransfoXLModel"},{local:"transformers.TFTransfoXLLMHeadModel",title:"TFTransfoXLLMHeadModel"},{local:"transformers.TFTransfoXLForSequenceClassification",title:"TFTransfoXLForSequenceClassification"},{local:"transformers.AdaptiveEmbedding",title:"Internal Layers"}],title:"Transformer XL"};function Yf(R){return Sf(()=>{new URLSearchParams(window.location.search).get("fw")}),[]}class oh extends zf{constructor(m){super();Pf(this,m,Yf,Kf,jf,{})}}export{oh as default,Gf as metadata};
