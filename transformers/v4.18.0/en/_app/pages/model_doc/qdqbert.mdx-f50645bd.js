import{S as am,i as rm,s as im,e as a,k as l,w as g,t as n,M as lm,c as r,d as o,m as d,a as i,x as _,h as s,b as c,F as e,g as u,y as b,q as v,o as k,B as Q,v as dm}from"../../chunks/vendor-6b77c823.js";import{T as ut}from"../../chunks/Tip-39098574.js";import{D as E}from"../../chunks/Docstring-17b815d9.js";import{C as x}from"../../chunks/CodeBlock-3a8b25a8.js";import{I as Y}from"../../chunks/IconCopyLink-7a11ce68.js";function cm(B){let h,q,f,T,y;return{c(){h=a("p"),q=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=a("code"),T=n("Module"),y=n(`
...
the latter silently ignores them.`)},l(w){h=r(w,"P",{});var m=i(h);q=s(m,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=r(m,"CODE",{});var $=i(f);T=s($,"Module"),$.forEach(o),y=s(m,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),m.forEach(o)},m(w,m){u(w,h,m),e(h,q),e(h,f),e(f,T),e(h,y)},d(w){w&&o(h)}}}function bm(B){let h,q,f,T,y,w,m,$,yr,sa,_e,Ie,Fn,mt,qr,Pn,$r,aa,Oe,Dr,ft,zr,Br,ra,Ko,Mr,ia,Go,Cn,xr,la,Yo,jr,da,Z,An,Nn,Er,Fr,Sn,We,Pr,gt,Cr,Ar,Ln,Nr,Sr,In,_t,Lr,On,Ir,Or,Wr,Wn,bt,Hr,Zo,Rr,Ur,ca,He,Vr,vt,Xr,Jr,pa,be,Re,Hn,kt,Kr,Rn,Gr,ha,F,Yr,Un,Zr,ei,Qt,ti,oi,Vn,ni,si,Xn,ai,ri,wt,ii,li,ua,Ue,di,Jn,ci,pi,ma,en,hi,fa,Tt,ga,ve,Ve,Kn,yt,ui,Gn,mi,_a,tn,fi,ba,qt,va,ke,Xe,Yn,$t,gi,Zn,_i,ka,se,bi,Dt,vi,ki,zt,Qi,wi,Qa,Bt,wa,Qe,Je,es,Mt,Ti,ts,yi,Ta,N,xt,qi,we,$i,on,Di,zi,jt,Bi,Mi,xi,Te,ji,nn,Ei,Fi,sn,Pi,Ci,Ai,os,Ni,Si,Et,ya,ye,Ke,ns,Ft,Li,ss,Ii,qa,z,Pt,Oi,as,Wi,Hi,Ct,Ri,an,Ui,Vi,Xi,At,Ji,Nt,Ki,Gi,Yi,St,Zi,Lt,el,tl,ol,j,nl,rs,sl,al,is,rl,il,ls,ll,dl,ds,cl,pl,cs,hl,ul,ps,ml,fl,gl,U,It,_l,qe,bl,rn,vl,kl,hs,Ql,wl,Tl,Ge,yl,us,ql,$l,Ot,$a,$e,Ye,ms,Wt,Dl,fs,zl,Da,S,Ht,Bl,Rt,Ml,gs,xl,jl,El,Ut,Fl,ln,Pl,Cl,Al,Vt,Nl,Xt,Sl,Ll,Il,V,Jt,Ol,De,Wl,dn,Hl,Rl,_s,Ul,Vl,Xl,Ze,Jl,bs,Kl,Gl,Kt,za,ze,et,vs,Gt,Yl,ks,Zl,Ba,L,Yt,ed,Zt,td,Qs,od,nd,sd,eo,ad,cn,rd,id,ld,to,dd,oo,cd,pd,hd,P,no,ud,Be,md,pn,fd,gd,ws,_d,bd,vd,tt,kd,Ts,Qd,wd,so,Td,ao,Ma,Me,ot,ys,ro,yd,qs,qd,xa,I,io,$d,$s,Dd,zd,lo,Bd,hn,Md,xd,jd,co,Ed,po,Fd,Pd,Cd,D,ho,Ad,xe,Nd,un,Sd,Ld,Ds,Id,Od,Wd,nt,Hd,zs,Rd,Ud,uo,Vd,mo,Xd,Bs,Jd,Kd,fo,Gd,go,ja,je,st,Ms,_o,Yd,xs,Zd,Ea,O,bo,ec,vo,tc,js,oc,nc,sc,ko,ac,mn,rc,ic,lc,Qo,dc,wo,cc,pc,hc,X,To,uc,Ee,mc,fn,fc,gc,Es,_c,bc,vc,at,kc,Fs,Qc,wc,yo,Fa,Fe,rt,Ps,qo,Tc,Cs,yc,Pa,W,$o,qc,As,$c,Dc,Do,zc,gn,Bc,Mc,xc,zo,jc,Bo,Ec,Fc,Pc,J,Mo,Cc,Pe,Ac,_n,Nc,Sc,Ns,Lc,Ic,Oc,it,Wc,Ss,Hc,Rc,xo,Ca,Ce,lt,Ls,jo,Uc,Is,Vc,Aa,H,Eo,Xc,Os,Jc,Kc,Fo,Gc,bn,Yc,Zc,ep,Po,tp,Co,op,np,sp,C,Ao,ap,Ae,rp,vn,ip,lp,Ws,dp,cp,pp,dt,hp,Hs,up,mp,No,fp,So,Na,Ne,ct,Rs,Lo,gp,Us,_p,Sa,R,Io,bp,Se,vp,Vs,kp,Qp,Xs,wp,Tp,yp,Oo,qp,kn,$p,Dp,zp,Wo,Bp,Ho,Mp,xp,jp,A,Ro,Ep,Le,Fp,Qn,Pp,Cp,Js,Ap,Np,Sp,pt,Lp,Ks,Ip,Op,Uo,Wp,Vo,La;return w=new Y({}),mt=new Y({}),kt=new Y({}),Tt=new x({props:{code:`import pytorch_quantization.nn as quant_nn
...
relevant if <code>config.is_decoder=True</code>.`,name:"use_cache"}],source:"https://github.com/huggingface/transformers/blob/v4.18.0/src/transformers/models/qdqbert/configuration_qdqbert.py#L29"}}),Et=new x({props:{code:`from transformers import QDQBertModel, QDQBertConfig
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/v4.18.0/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/v4.18.0/src/transformers/models/qdqbert/modeling_qdqbert.py#L1012"}}),Jt=new E({props:{name:"forward",anchor:"transformers.QDQBertLMHeadModel.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"encoder_hidden_states",val:" = None"},{name:"encoder_attention_mask",val:" = None"},{name:"labels",val:" = None"},{name:"past_key_values",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],parametersDescription:[{anchor:"transformers.QDQBertLMHeadModel.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/v4.18.0/en/model_doc/bert#transformers.BertTokenizer">BertTokenizer</a>. See <a href="/docs/transformers/v4.18.0/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/v4.18.0/en/model_doc/wav2vec2_phoneme#transformers.Wav2Vec2PhonemeCTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/v4.18.0/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/v4.18.0/src/transformers/models/qdqbert/modeling_qdqbert.py#L1160"}}),no=new E({props:{name:"forward",anchor:"transformers.QDQBertForMaskedLM.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"encoder_hidden_states",val:" = None"},{name:"encoder_attention_mask",val:" = None"},{name:"labels",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],parametersDescription:[{anchor:"transformers.QDQBertForMaskedLM.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/v4.18.0/en/model_doc/bert#transformers.BertTokenizer">BertTokenizer</a>. See <a href="/docs/transformers/v4.18.0/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/v4.18.0/en/model_doc/wav2vec2_phoneme#transformers.Wav2Vec2PhonemeCTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/v4.18.0/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/v4.18.0/src/transformers/models/qdqbert/modeling_qdqbert.py#L1374"}}),ho=new E({props:{name:"forward",anchor:"transformers.QDQBertForSequenceClassification.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"labels",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],parametersDescription:[{anchor:"transformers.QDQBertForSequenceClassification.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/v4.18.0/en/model_doc/bert#transformers.BertTokenizer">BertTokenizer</a>. See <a href="/docs/transformers/v4.18.0/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/v4.18.0/en/model_doc/wav2vec2_phoneme#transformers.Wav2Vec2PhonemeCTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/v4.18.0/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/v4.18.0/src/transformers/models/qdqbert/modeling_qdqbert.py#L1271"}}),To=new E({props:{name:"forward",anchor:"transformers.QDQBertForNextSentencePrediction.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"labels",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.QDQBertForNextSentencePrediction.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/v4.18.0/en/model_doc/bert#transformers.BertTokenizer">BertTokenizer</a>. See <a href="/docs/transformers/v4.18.0/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/v4.18.0/en/model_doc/wav2vec2_phoneme#transformers.Wav2Vec2PhonemeCTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
SQUAD task can be found at `),Zo=a("a"),Rr=n("transformers/examples/research_projects/quantization-qdqbert/"),Ur=n("."),ca=l(),He=a("p"),Vr=n("This model was contributed by "),vt=a("a"),Xr=n("shangz"),Jr=n("."),pa=l(),be=a("h3"),Re=a("a"),Hn=a("span"),g(kt.$$.fragment),Kr=l(),Rn=a("span"),Gr=n("Set default quantizers"),ha=l(),F=a("p"),Yr=n(`QDQBERT model adds fake quantization operations (pair of QuantizeLinear/DequantizeLinear ops) to BERT by
...
Quantization Toolkit userguide`),li=n(" for more details."),ua=l(),Ue=a("p"),di=n("Before creating QDQBERT model, one has to set the default "),Jn=a("code"),ci=n("QuantDescriptor"),pi=n(" defining default tensor quantizers."),ma=l(),en=a("p"),hi=n("Example:"),fa=l(),g(Tt.$$.fragment),ga=l(),ve=a("h3"),Ve=a("a"),Kn=a("span"),g(yt.$$.fragment),ui=l(),Gn=a("span"),mi=n("Calibration"),_a=l(),tn=a("p"),fi=n(`Calibration is the terminology of passing data samples to the quantizer and deciding the best scaling factors for
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),hc=l(),X=a("div"),g(To.$$.fragment),uc=l(),Ee=a("p"),mc=n("The "),fn=a("a"),fc=n("QDQBertForNextSentencePrediction"),gc=n(" forward method, overrides the "),Es=a("code"),_c=n("__call__"),bc=n(" special method."),vc=l(),g(at.$$.fragment),kc=l(),Fs=a("p"),Qc=n("Example:"),wc=l(),g(yo.$$.fragment),Fa=l(),Fe=a("h2"),rt=a("a"),Ps=a("span"),g(qo.$$.fragment),Tc=l(),Cs=a("span"),yc=n("QDQBertForMultipleChoice"),Pa=l(),W=a("div"),g($o.$$.fragment),qc=l(),As=a("p"),$c=n(`Bert Model with a multiple choice classification head on top (a linear layer on top of the pooled output and a
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),sp=l(),C=a("div"),g(Ao.$$.fragment),ap=l(),Ae=a("p"),rp=n("The "),vn=a("a"),ip=n("QDQBertForTokenClassification"),lp=n(" forward method, overrides the "),Ws=a("code"),dp=n("__call__"),cp=n(" special method."),pp=l(),g(dt.$$.fragment),hp=l(),Hs=a("p"),up=n("Example:"),mp=l(),g(No.$$.fragment),fp=l(),g(So.$$.fragment),Na=l(),Ne=a("h2"),ct=a("a"),Rs=a("span"),g(Lo.$$.fragment),gp=l(),Us=a("span"),_p=n("QDQBertForQuestionAnswering"),Sa=l(),R=a("div"),g(Io.$$.fragment),bp=l(),Se=a("p"),vp=n(`QDQBERT Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
layers on top of the hidden-states output to compute `),Vs=a("code"),kp=n("span start logits"),Qp=n(" and "),Xs=a("code"),wp=n("span end logits"),Tp=n(")."),yp=l(),Oo=a("p"),qp=n("This model inherits from "),kn=a("a"),$p=n("PreTrainedModel"),Dp=n(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
SQUAD task can be found at `),Zo=r(Wa,"A",{href:!0});var nh=i(Zo);Rr=s(nh,"transformers/examples/research_projects/quantization-qdqbert/"),nh.forEach(o),Ur=s(Wa,"."),Wa.forEach(o),oh.forEach(o),ht.forEach(o),ca=d(t),He=r(t,"P",{});var Ha=i(He);Vr=s(Ha,"This model was contributed by "),vt=r(Ha,"A",{href:!0,rel:!0});var sh=i(vt);Xr=s(sh,"shangz"),sh.forEach(o),Jr=s(Ha,"."),Ha.forEach(o),pa=d(t),be=r(t,"H3",{class:!0});var Ra=i(be);Re=r(Ra,"A",{id:!0,class:!0,href:!0});var ah=i(Re);Hn=r(ah,"SPAN",{});var rh=i(Hn);_(kt.$$.fragment,rh),rh.forEach(o),ah.forEach(o),Kr=d(Ra),Rn=r(Ra,"SPAN",{});var ih=i(Rn);Gr=s(ih,"Set default quantizers"),ih.forEach(o),Ra.forEach(o),ha=d(t),F=r(t,"P",{});var ee=i(F);Yr=s(ee,`QDQBERT model adds fake quantization operations (pair of QuantizeLinear/DequantizeLinear ops) to BERT by
...
Quantization Toolkit userguide`),hh.forEach(o),li=s(ee," for more details."),ee.forEach(o),ua=d(t),Ue=r(t,"P",{});var Ua=i(Ue);di=s(Ua,"Before creating QDQBERT model, one has to set the default "),Jn=r(Ua,"CODE",{});var uh=i(Jn);ci=s(uh,"QuantDescriptor"),uh.forEach(o),pi=s(Ua," defining default tensor quantizers."),Ua.forEach(o),ma=d(t),en=r(t,"P",{});var mh=i(en);hi=s(mh,"Example:"),mh.forEach(o),fa=d(t),_(Tt.$$.fragment,t),ga=d(t),ve=r(t,"H3",{class:!0});var Va=i(ve);Ve=r(Va,"A",{id:!0,class:!0,href:!0});var fh=i(Ve);Kn=r(fh,"SPAN",{});var gh=i(Kn);_(yt.$$.fragment,gh),gh.forEach(o),fh.forEach(o),ui=d(Va),Gn=r(Va,"SPAN",{});var _h=i(Gn);mi=s(_h,"Calibration"),_h.forEach(o),Va.forEach(o),_a=d(t),tn=r(t,"P",{});var bh=i(tn);fi=s(bh,`Calibration is the terminology of passing data samples to the quantizer and deciding the best scaling factors for
tensors. After setting up the tensor quantizers, one can use the following example to calibrate the model:`),bh.forEach(o),ba=d(t),_(qt.$$.fragment,t),va=d(t),ke=r(t,"H3",{class:!0});var Xa=i(ke);Xe=r(Xa,"A",{id:!0,class:!0,href:!0});var vh=i(Xe);Yn=r(vh,"SPAN",{});var kh=i(Yn);_($t.$$.fragment,kh),kh.forEach(o),vh.forEach(o),gi=d(Xa),Zn=r(Xa,"SPAN",{});var Qh=i(Zn);_i=s(Qh,"Export to ONNX"),Qh.forEach(o),Xa.forEach(o),ka=d(t),se=r(t,"P",{});var wn=i(se);bi=s(wn,"The goal of exporting to ONNX is to deploy inference by "),Dt=r(wn,"A",{href:!0,rel:!0});var wh=i(Dt);vi=s(wh,"TensorRT"),wh.forEach(o),ki=s(wn,`. Fake
quantization will be broken into a pair of QuantizeLinear/DequantizeLinear ONNX ops. After setting static member of
TensorQuantizer to use Pytorch\u2019s own fake quantization functions, fake quantized model can be exported to ONNX, follow
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),cr.forEach(o),Cd=d(ce),D=r(ce,"DIV",{class:!0});var M=i(D);_(ho.$$.fragment,M),Ad=d(M),xe=r(M,"P",{});var zn=i(xe);Nd=s(zn,"The "),un=r(zn,"A",{href:!0});var bu=i(un);Sd=s(bu,"QDQBertForSequenceClassification"),bu.forEach(o),Ld=s(zn," forward method, overrides the "),Ds=r(zn,"CODE",{});var vu=i(Ds);Id=s(vu,"__call__"),vu.forEach(o),Od=s(zn," special method."),zn.forEach(o),Wd=d(M),_(nt.$$.fragment,M),Hd=d(M),zs=r(M,"P",{});var ku=i(zs);Rd=s(ku,"Example of single-label classification:"),ku.forEach(o),Ud=d(M),_(uo.$$.fragment,M),Vd=d(M),_(mo.$$.fragment,M),Xd=d(M),Bs=r(M,"P",{});var Qu=i(Bs);Jd=s(Qu,"Example of multi-label classification:"),Qu.forEach(o),Kd=d(M),_(fo.$$.fragment,M),Gd=d(M),_(go.$$.fragment,M),M.forEach(o),ce.forEach(o),ja=d(t),je=r(t,"H2",{class:!0});var pr=i(je);st=r(pr,"A",{id:!0,class:!0,href:!0});var wu=i(st);Ms=r(wu,"SPAN",{});var Tu=i(Ms);_(_o.$$.fragment,Tu),Tu.forEach(o),wu.forEach(o),Yd=d(pr),xs=r(pr,"SPAN",{});var yu=i(xs);Zd=s(yu,"QDQBertForNextSentencePrediction"),yu.forEach(o),pr.forEach(o),Ea=d(t),O=r(t,"DIV",{class:!0});var pe=i(O);_(bo.$$.fragment,pe),ec=d(pe),vo=r(pe,"P",{});var hr=i(vo);tc=s(hr,"Bert Model with a "),js=r(hr,"CODE",{});var qu=i(js);oc=s(qu,"next sentence prediction (classification)"),qu.forEach(o),nc=s(hr," head on top."),hr.forEach(o),sc=d(pe),ko=r(pe,"P",{});var ur=i(ko);ac=s(ur,"This model inherits from "),mn=r(ur,"A",{href:!0});var $u=i(mn);rc=s($u,"PreTrainedModel"),$u.forEach(o),ic=s(ur,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),mr.forEach(o),hc=d(pe),X=r(pe,"DIV",{class:!0});var he=i(X);_(To.$$.fragment,he),uc=d(he),Ee=r(he,"P",{});var Bn=i(Ee);mc=s(Bn,"The "),fn=r(Bn,"A",{href:!0});var zu=i(fn);fc=s(zu,"QDQBertForNextSentencePrediction"),zu.forEach(o),gc=s(Bn," forward method, overrides the "),Es=r(Bn,"CODE",{});var Bu=i(Es);_c=s(Bu,"__call__"),Bu.forEach(o),bc=s(Bn," special method."),Bn.forEach(o),vc=d(he),_(at.$$.fragment,he),kc=d(he),Fs=r(he,"P",{});var Mu=i(Fs);Qc=s(Mu,"Example:"),Mu.forEach(o),wc=d(he),_(yo.$$.fragment,he),he.forEach(o),pe.forEach(o),Fa=d(t),Fe=r(t,"H2",{class:!0});var fr=i(Fe);rt=r(fr,"A",{id:!0,class:!0,href:!0});var xu=i(rt);Ps=r(xu,"SPAN",{});var ju=i(Ps);_(qo.$$.fragment,ju),ju.forEach(o),xu.forEach(o),Tc=d(fr),Cs=r(fr,"SPAN",{});var Eu=i(Cs);yc=s(Eu,"QDQBertForMultipleChoice"),Eu.forEach(o),fr.forEach(o),Pa=d(t),W=r(t,"DIV",{class:!0});var ue=i(W);_($o.$$.fragment,ue),qc=d(ue),As=r(ue,"P",{});var Fu=i(As);$c=s(Fu,`Bert Model with a multiple choice classification head on top (a linear layer on top of the pooled output and a
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),vr.forEach(o),ep=d(fe),Po=r(fe,"P",{});var kr=i(Po);tp=s(kr,"This model is also a PyTorch "),Co=r(kr,"A",{href:!0,rel:!0});var Ru=i(Co);op=s(Ru,"torch.nn.Module"),Ru.forEach(o),np=s(kr,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),kr.forEach(o),sp=d(fe),C=r(fe,"DIV",{class:!0});var oe=i(C);_(Ao.$$.fragment,oe),ap=d(oe),Ae=r(oe,"P",{});var xn=i(Ae);rp=s(xn,"The "),vn=r(xn,"A",{href:!0});var Uu=i(vn);ip=s(Uu,"QDQBertForTokenClassification"),Uu.forEach(o),lp=s(xn," forward method, overrides the "),Ws=r(xn,"CODE",{});var Vu=i(Ws);dp=s(Vu,"__call__"),Vu.forEach(o),cp=s(xn," special method."),xn.forEach(o),pp=d(oe),_(dt.$$.fragment,oe),hp=d(oe),Hs=r(oe,"P",{});var Xu=i(Hs);up=s(Xu,"Example:"),Xu.forEach(o),mp=d(oe),_(No.$$.fragment,oe),fp=d(oe),_(So.$$.fragment,oe),oe.forEach(o),fe.forEach(o),Na=d(t),Ne=r(t,"H2",{class:!0});var Qr=i(Ne);ct=r(Qr,"A",{id:!0,class:!0,href:!0});var Ju=i(ct);Rs=r(Ju,"SPAN",{});var Ku=i(Rs);_(Lo.$$.fragment,Ku),Ku.forEach(o),Ju.forEach(o),gp=d(Qr),Us=r(Qr,"SPAN",{});var Gu=i(Us);_p=s(Gu,"QDQBertForQuestionAnswering"),Gu.forEach(o),Qr.forEach(o),Sa=d(t),R=r(t,"DIV",{class:!0});var ge=i(R);_(Io.$$.fragment,ge),bp=d(ge),Se=r(ge,"P",{});var jn=i(Se);vp=s(jn,`QDQBERT Model with a span classification head on top for extractive question-answering tasks like SQuAD (a linear
layers on top of the hidden-states output to compute `),Vs=r(jn,"CODE",{});var Yu=i(Vs);kp=s(Yu,"span start logits"),Yu.forEach(o),Qp=s(jn," and "),Xs=r(jn,"CODE",{});var Zu=i(Xs);wp=s(Zu,"span end logits"),Zu.forEach(o),Tp=s(jn,")."),jn.forEach(o),yp=d(ge),Oo=r(ge,"P",{});var wr=i(Oo);qp=s(wr,"This model inherits from "),kn=r(wr,"A",{href:!0});var em=i(kn);$p=s(em,"PreTrainedModel"),em.forEach(o),Dp=s(wr,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
