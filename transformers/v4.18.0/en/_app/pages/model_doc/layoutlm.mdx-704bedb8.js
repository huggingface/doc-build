import{S as Wh,i as Hh,s as Bh,e as a,k as l,w as L,t as n,M as Rh,c as r,d as t,m as d,a as i,x as v,h as s,b as c,F as e,g as u,y as w,q as T,o as M,B as x,v as Kh}from"../../chunks/vendor-6b77c823.js";import{T as Qe}from"../../chunks/Tip-39098574.js";import{D as _e}from"../../chunks/Docstring-abef54e3.js";import{C as tt}from"../../chunks/CodeBlock-3a8b25a8.js";import{I as Ve}from"../../chunks/IconCopyLink-7a11ce68.js";function Vh(K){let h,$,f,g,b;return{c(){h=a("p"),$=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=a("code"),g=n("Module"),b=n(`
...
the latter silently ignores them.`)},l(y){h=r(y,"P",{});var _=i(h);$=s(_,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=r(_,"CODE",{});var j=i(f);g=s(j,"Module"),j.forEach(t),b=s(_,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),_.forEach(t)},m(y,_){u(y,h,_),e(h,$),e(h,f),e(f,g),e(h,b)},d(y){y&&t(h)}}}function am(K){let h,$,f,g,b,y,_,j,re,Y,z,ae,I,Z,ne,D,ie,se,J,O,G,Q,F,E,le,W,V,ee,H,te,de,q,ce,A,pe,oe,B,ue,he,P,me,U,fe,p,k,X,$e,Me,N,be,Fe,xe,S,R,je,ye,C,ze,ke,ge,Ee,Yn,Hr,Br,Cs,Rr,Kr,go,Vr,Xr,_o,Yr,Zr,Ia,yo,Oa,ot,Gr,Ps,Jr,Qr,Ns,ei,ti,Da,bo,Aa,Zn,et,oi,Gn,ni,si,ko,ai,ri,Lo,ii,li,Ua,nt,di,vo,ci,pi,wo,ui,hi,Wa,ft,Dt,Ss,To,mi,Is,fi,Ha,qe,Mo,gi,gt,_i,Jn,yi,bi,xo,ki,Li,vi,_t,wi,Qn,Ti,Mi,es,xi,ji,$i,Os,Fi,zi,jo,Ba,yt,At,Ds,$o,Ei,As,qi,Ra,He,Fo,Ci,Us,Pi,Ni,Ut,ts,Si,Ii,os,Oi,Di,Ai,zo,Ui,ns,Wi,Hi,Ka,bt,Wt,Ws,Eo,Bi,Hs,Ri,Va,Be,qo,Ki,Bs,Vi,Xi,Ht,ss,Yi,Zi,as,Gi,Ji,Qi,Co,el,rs,tl,ol,Xa,kt,Bt,Rs,Po,nl,Ks,sl,Ya,Re,No,al,So,rl,Io,il,ll,dl,Oo,cl,Do,pl,ul,hl,Ne,Ao,ml,Lt,fl,is,gl,_l,Vs,yl,bl,kl,Rt,Ll,Xs,vl,wl,Uo,Za,vt,Kt,Ys,Wo,Tl,Zs,Ml,Ga,Ke,Ho,xl,wt,jl,Gs,$l,Fl,Bo,zl,El,ql,Ro,Cl,Ko,Pl,Nl,Sl,Se,Vo,Il,Tt,Ol,ls,Dl,Al,Js,Ul,Wl,Hl,Vt,Bl,Qs,Rl,Kl,Xo,Ja,Mt,Xt,ea,Yo,Vl,ta,Xl,Qa,Ce,Zo,Yl,Go,Zl,Jo,Gl,Jl,Ql,Qo,ed,en,td,od,nd,tn,sd,on,ad,rd,id,Ie,nn,ld,xt,dd,ds,cd,pd,oa,ud,hd,md,Yt,fd,na,gd,_d,sn,er,jt,Zt,sa,an,yd,aa,bd,tr,Pe,rn,kd,$t,Ld,ln,vd,wd,dn,Td,Md,xd,cn,jd,pn,$d,Fd,zd,un,Ed,hn,qd,Cd,Pd,Oe,mn,Nd,Ft,Sd,cs,Id,Od,ra,Dd,Ad,Ud,Gt,Wd,ia,Hd,Bd,fn,or,zt,Jt,la,gn,Rd,da,Kd,nr,Le,_n,Vd,ca,Xd,Yd,yn,Zd,ps,Gd,Jd,Qd,bn,ec,kn,tc,oc,nc,Qt,sc,De,Ln,ac,Et,rc,us,ic,lc,pa,dc,cc,pc,eo,uc,ua,hc,mc,vn,sr,qt,to,ha,wn,fc,ma,gc,ar,ve,Tn,_c,Mn,yc,fa,bc,kc,Lc,xn,vc,hs,wc,Tc,Mc,jn,xc,$n,jc,$c,Fc,oo,zc,Ae,Fn,Ec,Ct,qc,ms,Cc,Pc,ga,Nc,Sc,Ic,no,Oc,_a,Dc,Ac,zn,rr,Pt,so,ya,En,Uc,ba,Wc,ir,we,qn,Hc,ka,Bc,Rc,Cn,Kc,fs,Vc,Xc,Yc,Pn,Zc,Nn,Gc,Jc,Qc,ao,ep,Ue,Sn,tp,Nt,op,gs,np,sp,La,ap,rp,ip,ro,lp,va,dp,cp,In,lr,St,io,wa,On,pp,Ta,up,dr,Te,Dn,hp,Ma,mp,fp,An,gp,_s,_p,yp,bp,Un,kp,Wn,Lp,vp,wp,lo,Tp,We,Hn,Mp,It,xp,ys,jp,$p,xa,Fp,zp,Ep,co,qp,ja,Cp,Pp,Bn,cr;return y=new Ve({}),D=new Ve({}),yo=new tt({props:{code:`def normalize_bbox(bbox, width, height):
    return [
...
`}}),eo=new Qe({props:{$$slots:{default:[Jh]},$$scope:{ctx:K}}}),vn=new tt({props:{code:`from transformers import LayoutLMTokenizer, TFLayoutLMModel
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/v4.18.0/en/main_classes/model#transformers.TFPreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),lo=new Qe({props:{$$slots:{default:[nm]},$$scope:{ctx:K}}}),Hn=new _e({props:{name:"call",anchor:"transformers.TFLayoutLMForTokenClassification.call",parameters:[{name:"input_ids",val:": typing.Union[typing.List[tensorflow.python.framework.ops.Tensor], typing.List[numpy.ndarray], typing.List[tensorflow.python.keras.engine.keras_tensor.KerasTensor], typing.Dict[str, tensorflow.python.framework.ops.Tensor], typing.Dict[str, numpy.ndarray], typing.Dict[str, tensorflow.python.keras.engine.keras_tensor.KerasTensor], tensorflow.python.framework.ops.Tensor, numpy.ndarray, tensorflow.python.keras.engine.keras_tensor.KerasTensor, NoneType] = None"},{name:"bbox",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"attention_mask",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"token_type_ids",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"position_ids",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"head_mask",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"inputs_embeds",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"labels",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"training",val:": typing.Optional[bool] = False"}],source:"https://github.com/huggingface/transformers/blob/v4.18.0/src/transformers/models/layoutlm/modeling_tf_layoutlm.py#L1285",parametersDescription:[{anchor:"transformers.TFLayoutLMForTokenClassification.call.input_ids",description:`<strong>input_ids</strong> (<code>Numpy array</code> or <code>tf.Tensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/v4.18.0/en/model_doc/layoutlm#transformers.LayoutLMTokenizer">LayoutLMTokenizer</a>. See <a href="/docs/transformers/v4.18.0/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
<a href="/docs/transformers/v4.18.0/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> for details.</p>
...
It includes an inference part, which shows how to use Google\u2019s Tesseract on a new document.`),Ua=l(),nt=a("p"),di=n("This model was contributed by "),vo=a("a"),ci=n("liminghao1630"),pi=n(`. The original code can be found
`),wo=a("a"),ui=n("here"),hi=n("."),Wa=l(),ft=a("h2"),Dt=a("a"),Ss=a("span"),L(To.$$.fragment),mi=l(),Is=a("span"),fi=n("LayoutLMConfig"),Ha=l(),qe=a("div"),L(Mo.$$.fragment),gi=l(),gt=a("p"),_i=n("This is the configuration class to store the configuration of a "),Jn=a("a"),yi=n("LayoutLMModel"),bi=n(`. It is used to instantiate a
LayoutLM model according to the specified arguments, defining the model architecture. Instantiating a configuration
with the defaults will yield a similar configuration to that of the LayoutLM
`),xo=a("a"),ki=n("layoutlm-base-uncased"),Li=n(" architecture."),vi=l(),_t=a("p"),wi=n("Configuration objects inherit from "),Qn=a("a"),Ti=n("BertConfig"),Mi=n(` and can be used to control the model outputs. Read the
...
behavior.`),hl=l(),Ne=a("div"),L(Ao.$$.fragment),ml=l(),Lt=a("p"),fl=n("The "),is=a("a"),gl=n("LayoutLMModel"),_l=n(" forward method, overrides the "),Vs=a("code"),yl=n("__call__"),bl=n(" special method."),kl=l(),L(Rt.$$.fragment),Ll=l(),Xs=a("p"),vl=n("Examples:"),wl=l(),L(Uo.$$.fragment),Za=l(),vt=a("h2"),Kt=a("a"),Ys=a("span"),L(Wo.$$.fragment),Tl=l(),Zs=a("span"),Ml=n("LayoutLMForMaskedLM"),Ga=l(),Ke=a("div"),L(Ho.$$.fragment),xl=l(),wt=a("p"),jl=n("LayoutLM Model with a "),Gs=a("code"),$l=n("language modeling"),Fl=n(` head on top.
...
behavior.`),nc=l(),L(Qt.$$.fragment),sc=l(),De=a("div"),L(Ln.$$.fragment),ac=l(),Et=a("p"),rc=n("The "),us=a("a"),ic=n("TFLayoutLMModel"),lc=n(" forward method, overrides the "),pa=a("code"),dc=n("__call__"),cc=n(" special method."),pc=l(),L(eo.$$.fragment),uc=l(),ua=a("p"),hc=n("Examples:"),mc=l(),L(vn.$$.fragment),sr=l(),qt=a("h2"),to=a("a"),ha=a("span"),L(wn.$$.fragment),fc=l(),ma=a("span"),gc=n("TFLayoutLMForMaskedLM"),ar=l(),ve=a("div"),L(Tn.$$.fragment),_c=l(),Mn=a("p"),yc=n("LayoutLM Model with a "),fa=a("code"),bc=n("language modeling"),kc=n(" head on top."),Lc=l(),xn=a("p"),vc=n("This model inherits from "),hs=a("a"),wc=n("TFPreTrainedModel"),Tc=n(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Qc=l(),L(ao.$$.fragment),ep=l(),Ue=a("div"),L(Sn.$$.fragment),tp=l(),Nt=a("p"),op=n("The "),gs=a("a"),np=n("TFLayoutLMForSequenceClassification"),sp=n(" forward method, overrides the "),La=a("code"),ap=n("__call__"),rp=n(" special method."),ip=l(),L(ro.$$.fragment),lp=l(),va=a("p"),dp=n("Examples:"),cp=l(),L(In.$$.fragment),lr=l(),St=a("h2"),io=a("a"),wa=a("span"),L(On.$$.fragment),pp=l(),Ta=a("span"),up=n("TFLayoutLMForTokenClassification"),dr=l(),Te=a("div"),L(Dn.$$.fragment),hp=l(),Ma=a("p"),mp=n(`LayoutLM Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g. for
...
(x0, y0) corresponds to the position of the upper left corner in the bounding box, and (x1, y1) represents the
position of the lower right corner. Note that one first needs to normalize the bounding boxes to be on a 0-1000
scale. To normalize, you can use the following function:`),Xe.forEach(t),Wp.forEach(t),Ia=d(o),v(yo.$$.fragment,o),Oa=d(o),ot=r(o,"P",{});var bs=i(ot);Gr=s(bs,"Here, "),Ps=r(bs,"CODE",{});var Xp=i(Ps);Jr=s(Xp,"width"),Xp.forEach(t),Qr=s(bs," and "),Ns=r(bs,"CODE",{});var Yp=i(Ns);ei=s(Yp,"height"),Yp.forEach(t),ti=s(bs,` correspond to the width and height of the original document in which the token
occurs. Those can be obtained using the Python Image Library (PIL) library for example, as follows:`),bs.forEach(t),Da=d(o),v(bo.$$.fragment,o),Aa=d(o),Zn=r(o,"UL",{});var Zp=i(Zn);et=r(Zp,"LI",{});var po=i(et);oi=s(po,"For a demo which shows how to fine-tune "),Gn=r(po,"A",{href:!0});var Gp=i(Gn);ni=s(Gp,"LayoutLMForTokenClassification"),Gp.forEach(t),si=s(po," on the "),ko=r(po,"A",{href:!0,rel:!0});var Jp=i(ko);ai=s(Jp,"FUNSD dataset"),Jp.forEach(t),ri=s(po," (a collection of annotated forms), see "),Lo=r(po,"A",{href:!0,rel:!0});var Qp=i(Lo);ii=s(Qp,"this notebook"),Qp.forEach(t),li=s(po,`.
It includes an inference part, which shows how to use Google\u2019s Tesseract on a new document.`),po.forEach(t),Zp.forEach(t),Ua=d(o),nt=r(o,"P",{});var ks=i(nt);di=s(ks,"This model was contributed by "),vo=r(ks,"A",{href:!0,rel:!0});var eu=i(vo);ci=s(eu,"liminghao1630"),eu.forEach(t),pi=s(ks,`. The original code can be found
`),wo=r(ks,"A",{href:!0,rel:!0});var tu=i(wo);ui=s(tu,"here"),tu.forEach(t),hi=s(ks,"."),ks.forEach(t),Wa=d(o),ft=r(o,"H2",{class:!0});var hr=i(ft);Dt=r(hr,"A",{id:!0,class:!0,href:!0});var ou=i(Dt);Ss=r(ou,"SPAN",{});var nu=i(Ss);v(To.$$.fragment,nu),nu.forEach(t),ou.forEach(t),mi=d(hr),Is=r(hr,"SPAN",{});var su=i(Is);fi=s(su,"LayoutLMConfig"),su.forEach(t),hr.forEach(t),Ha=d(o),qe=r(o,"DIV",{class:!0});var st=i(qe);v(Mo.$$.fragment,st),gi=d(st),gt=r(st,"P",{});var Ls=i(gt);_i=s(Ls,"This is the configuration class to store the configuration of a "),Jn=r(Ls,"A",{href:!0});var au=i(Jn);yi=s(au,"LayoutLMModel"),au.forEach(t),bi=s(Ls,`. It is used to instantiate a
LayoutLM model according to the specified arguments, defining the model architecture. Instantiating a configuration
with the defaults will yield a similar configuration to that of the LayoutLM
`),xo=r(Ls,"A",{href:!0,rel:!0});var ru=i(xo);ki=s(ru,"layoutlm-base-uncased"),ru.forEach(t),Li=s(Ls," architecture."),Ls.forEach(t),vi=d(st),_t=r(st,"P",{});var vs=i(_t);wi=s(vs,"Configuration objects inherit from "),Qn=r(vs,"A",{href:!0});var iu=i(Qn);Ti=s(iu,"BertConfig"),iu.forEach(t),Mi=s(vs,` and can be used to control the model outputs. Read the
documentation from `),es=r(vs,"A",{href:!0});var lu=i(es);xi=s(lu,"BertConfig"),lu.forEach(t),ji=s(vs," for more information."),vs.forEach(t),$i=d(st),Os=r(st,"P",{});var du=i(Os);Fi=s(du,"Examples:"),du.forEach(t),zi=d(st),v(jo.$$.fragment,st),st.forEach(t),Ba=d(o),yt=r(o,"H2",{class:!0});var mr=i(yt);At=r(mr,"A",{id:!0,class:!0,href:!0});var cu=i(At);Ds=r(cu,"SPAN",{});var pu=i(Ds);v($o.$$.fragment,pu),pu.forEach(t),cu.forEach(t),Ei=d(mr),As=r(mr,"SPAN",{});var uu=i(As);qi=s(uu,"LayoutLMTokenizer"),uu.forEach(t),mr.forEach(t),Ra=d(o),He=r(o,"DIV",{class:!0});var uo=i(He);v(Fo.$$.fragment,uo),Ci=d(uo),Us=r(uo,"P",{});var hu=i(Us);Pi=s(hu,"Constructs a LayoutLM tokenizer."),hu.forEach(t),Ni=d(uo),Ut=r(uo,"P",{});var Na=i(Ut);ts=r(Na,"A",{href:!0});var mu=i(ts);Si=s(mu,"LayoutLMTokenizer"),mu.forEach(t),Ii=s(Na," is identical to "),os=r(Na,"A",{href:!0});var fu=i(os);Oi=s(fu,"BertTokenizer"),fu.forEach(t),Di=s(Na,` and runs end-to-end tokenization: punctuation splitting +
wordpiece.`),Na.forEach(t),Ai=d(uo),zo=r(uo,"P",{});var fr=i(zo);Ui=s(fr,"Refer to superclass "),ns=r(fr,"A",{href:!0});var gu=i(ns);Wi=s(gu,"BertTokenizer"),gu.forEach(t),Hi=s(fr," for usage examples and documentation concerning parameters."),fr.forEach(t),uo.forEach(t),Ka=d(o),bt=r(o,"H2",{class:!0});var gr=i(bt);Wt=r(gr,"A",{id:!0,class:!0,href:!0});var _u=i(Wt);Ws=r(_u,"SPAN",{});var yu=i(Ws);v(Eo.$$.fragment,yu),yu.forEach(t),_u.forEach(t),Bi=d(gr),Hs=r(gr,"SPAN",{});var bu=i(Hs);Ri=s(bu,"LayoutLMTokenizerFast"),bu.forEach(t),gr.forEach(t),Va=d(o),Be=r(o,"DIV",{class:!0});var ho=i(Be);v(qo.$$.fragment,ho),Ki=d(ho),Bs=r(ho,"P",{});var ku=i(Bs);Vi=s(ku,"Constructs a \u201CFast\u201D LayoutLMTokenizer."),ku.forEach(t),Xi=d(ho),Ht=r(ho,"P",{});var Sa=i(Ht);ss=r(Sa,"A",{href:!0});var Lu=i(ss);Yi=s(Lu,"LayoutLMTokenizerFast"),Lu.forEach(t),Zi=s(Sa," is identical to "),as=r(Sa,"A",{href:!0});var vu=i(as);Gi=s(vu,"BertTokenizerFast"),vu.forEach(t),Ji=s(Sa,` and runs end-to-end tokenization: punctuation
splitting + wordpiece.`),Sa.forEach(t),Qi=d(ho),Co=r(ho,"P",{});var _r=i(Co);el=s(_r,"Refer to superclass "),rs=r(_r,"A",{href:!0});var wu=i(rs);tl=s(wu,"BertTokenizerFast"),wu.forEach(t),ol=s(_r," for usage examples and documentation concerning parameters."),_r.forEach(t),ho.forEach(t),Xa=d(o),kt=r(o,"H2",{class:!0});var yr=i(kt);Bt=r(yr,"A",{id:!0,class:!0,href:!0});var Tu=i(Bt);Rs=r(Tu,"SPAN",{});var Mu=i(Rs);v(Po.$$.fragment,Mu),Mu.forEach(t),Tu.forEach(t),nl=d(yr),Ks=r(yr,"SPAN",{});var xu=i(Ks);sl=s(xu,"LayoutLMModel"),xu.forEach(t),yr.forEach(t),Ya=d(o),Re=r(o,"DIV",{class:!0});var mo=i(Re);v(No.$$.fragment,mo),al=d(mo),So=r(mo,"P",{});var br=i(So);rl=s(br,`The bare LayoutLM Model transformer outputting raw hidden-states without any specific head on top.
...
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),kr.forEach(t),hl=d(mo),Ne=r(mo,"DIV",{class:!0});var at=i(Ne);v(Ao.$$.fragment,at),ml=d(at),Lt=r(at,"P",{});var ws=i(Lt);fl=s(ws,"The "),is=r(ws,"A",{href:!0});var Fu=i(is);gl=s(Fu,"LayoutLMModel"),Fu.forEach(t),_l=s(ws," forward method, overrides the "),Vs=r(ws,"CODE",{});var zu=i(Vs);yl=s(zu,"__call__"),zu.forEach(t),bl=s(ws," special method."),ws.forEach(t),kl=d(at),v(Rt.$$.fragment,at),Ll=d(at),Xs=r(at,"P",{});var Eu=i(Xs);vl=s(Eu,"Examples:"),Eu.forEach(t),wl=d(at),v(Uo.$$.fragment,at),at.forEach(t),mo.forEach(t),Za=d(o),vt=r(o,"H2",{class:!0});var Lr=i(vt);Kt=r(Lr,"A",{id:!0,class:!0,href:!0});var qu=i(Kt);Ys=r(qu,"SPAN",{});var Cu=i(Ys);v(Wo.$$.fragment,Cu),Cu.forEach(t),qu.forEach(t),Tl=d(Lr),Zs=r(Lr,"SPAN",{});var Pu=i(Zs);Ml=s(Pu,"LayoutLMForMaskedLM"),Pu.forEach(t),Lr.forEach(t),Ga=d(o),Ke=r(o,"DIV",{class:!0});var fo=i(Ke);v(Ho.$$.fragment,fo),xl=d(fo),wt=r(fo,"P",{});var Ts=i(wt);jl=s(Ts,"LayoutLM Model with a "),Gs=r(Ts,"CODE",{});var Nu=i(Gs);$l=s(Nu,"language modeling"),Nu.forEach(t),Fl=s(Ts,` head on top.
The LayoutLM model was proposed in `),Bo=r(Ts,"A",{href:!0,rel:!0});var Su=i(Bo);zl=s(Su,`LayoutLM: Pre-training of Text and Layout for Document Image
Understanding`),Su.forEach(t),El=s(Ts,` by Yiheng Xu, Minghao Li, Lei Cui, Shaohan Huang, Furu Wei and
Ming Zhou.`),Ts.forEach(t),ql=d(fo),Ro=r(fo,"P",{});var vr=i(Ro);Cl=s(vr,"This model is a PyTorch "),Ko=r(vr,"A",{href:!0,rel:!0});var Iu=i(Ko);Pl=s(Iu,"torch.nn.Module"),Iu.forEach(t),Nl=s(vr,` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),vr.forEach(t),Sl=d(fo),Se=r(fo,"DIV",{class:!0});var rt=i(Se);v(Vo.$$.fragment,rt),Il=d(rt),Tt=r(rt,"P",{});var Ms=i(Tt);Ol=s(Ms,"The "),ls=r(Ms,"A",{href:!0});var Ou=i(ls);Dl=s(Ou,"LayoutLMForMaskedLM"),Ou.forEach(t),Al=s(Ms," forward method, overrides the "),Js=r(Ms,"CODE",{});var Du=i(Js);Ul=s(Du,"__call__"),Du.forEach(t),Wl=s(Ms," special method."),Ms.forEach(t),Hl=d(rt),v(Vt.$$.fragment,rt),Bl=d(rt),Qs=r(rt,"P",{});var Au=i(Qs);Rl=s(Au,"Examples:"),Au.forEach(t),Kl=d(rt),v(Xo.$$.fragment,rt),rt.forEach(t),fo.forEach(t),Ja=d(o),Mt=r(o,"H2",{class:!0});var wr=i(Mt);Xt=r(wr,"A",{id:!0,class:!0,href:!0});var Uu=i(Xt);ea=r(Uu,"SPAN",{});var Wu=i(ea);v(Yo.$$.fragment,Wu),Wu.forEach(t),Uu.forEach(t),Vl=d(wr),ta=r(wr,"SPAN",{});var Hu=i(ta);Xl=s(Hu,"LayoutLMForSequenceClassification"),Hu.forEach(t),wr.forEach(t),Qa=d(o),Ce=r(o,"DIV",{class:!0});var it=i(Ce);v(Zo.$$.fragment,it),Yl=d(it),Go=r(it,"P",{});var Tr=i(Go);Zl=s(Tr,`LayoutLM Model with a sequence classification head on top (a linear layer on top of the pooled output) e.g. for
document image classification tasks such as the `),Jo=r(Tr,"A",{href:!0,rel:!0});var Bu=i(Jo);Gl=s(Bu,"RVL-CDIP"),Bu.forEach(t),Jl=s(Tr," dataset."),Tr.forEach(t),Ql=d(it),Qo=r(it,"P",{});var Mr=i(Qo);ed=s(Mr,"The LayoutLM model was proposed in "),en=r(Mr,"A",{href:!0,rel:!0});var Ru=i(en);td=s(Ru,`LayoutLM: Pre-training of Text and Layout for Document Image
...
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),xr.forEach(t),id=d(it),Ie=r(it,"DIV",{class:!0});var lt=i(Ie);v(nn.$$.fragment,lt),ld=d(lt),xt=r(lt,"P",{});var xs=i(xt);dd=s(xs,"The "),ds=r(xs,"A",{href:!0});var Vu=i(ds);cd=s(Vu,"LayoutLMForSequenceClassification"),Vu.forEach(t),pd=s(xs," forward method, overrides the "),oa=r(xs,"CODE",{});var Xu=i(oa);ud=s(Xu,"__call__"),Xu.forEach(t),hd=s(xs," special method."),xs.forEach(t),md=d(lt),v(Yt.$$.fragment,lt),fd=d(lt),na=r(lt,"P",{});var Yu=i(na);gd=s(Yu,"Examples:"),Yu.forEach(t),_d=d(lt),v(sn.$$.fragment,lt),lt.forEach(t),it.forEach(t),er=d(o),jt=r(o,"H2",{class:!0});var jr=i(jt);Zt=r(jr,"A",{id:!0,class:!0,href:!0});var Zu=i(Zt);sa=r(Zu,"SPAN",{});var Gu=i(sa);v(an.$$.fragment,Gu),Gu.forEach(t),Zu.forEach(t),yd=d(jr),aa=r(jr,"SPAN",{});var Ju=i(aa);bd=s(Ju,"LayoutLMForTokenClassification"),Ju.forEach(t),jr.forEach(t),tr=d(o),Pe=r(o,"DIV",{class:!0});var dt=i(Pe);v(rn.$$.fragment,dt),kd=d(dt),$t=r(dt,"P",{});var js=i($t);Ld=s(js,`LayoutLM Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g. for
sequence labeling (information extraction) tasks such as the `),ln=r(js,"A",{href:!0,rel:!0});var Qu=i(ln);vd=s(Qu,"FUNSD"),Qu.forEach(t),wd=s(js,`
...
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),Fr.forEach(t),Pd=d(dt),Oe=r(dt,"DIV",{class:!0});var ct=i(Oe);v(mn.$$.fragment,ct),Nd=d(ct),Ft=r(ct,"P",{});var $s=i(Ft);Sd=s($s,"The "),cs=r($s,"A",{href:!0});var nh=i(cs);Id=s(nh,"LayoutLMForTokenClassification"),nh.forEach(t),Od=s($s," forward method, overrides the "),ra=r($s,"CODE",{});var sh=i(ra);Dd=s(sh,"__call__"),sh.forEach(t),Ad=s($s," special method."),$s.forEach(t),Ud=d(ct),v(Gt.$$.fragment,ct),Wd=d(ct),ia=r(ct,"P",{});var ah=i(ia);Hd=s(ah,"Examples:"),ah.forEach(t),Bd=d(ct),v(fn.$$.fragment,ct),ct.forEach(t),dt.forEach(t),or=d(o),zt=r(o,"H2",{class:!0});var zr=i(zt);Jt=r(zr,"A",{id:!0,class:!0,href:!0});var rh=i(Jt);la=r(rh,"SPAN",{});var ih=i(la);v(gn.$$.fragment,ih),ih.forEach(t),rh.forEach(t),Rd=d(zr),da=r(zr,"SPAN",{});var lh=i(da);Kd=s(lh,"TFLayoutLMModel"),lh.forEach(t),zr.forEach(t),nr=d(o),Le=r(o,"DIV",{class:!0});var Ye=i(Le);v(_n.$$.fragment,Ye),Vd=d(Ye),ca=r(Ye,"P",{});var dh=i(ca);Xd=s(dh,"The bare LayoutLM Model transformer outputting raw hidden-states without any specific head on top."),dh.forEach(t),Yd=d(Ye),yn=r(Ye,"P",{});var Er=i(yn);Zd=s(Er,"This model inherits from "),ps=r(Er,"A",{href:!0});var ch=i(ps);Gd=s(ch,"TFPreTrainedModel"),ch.forEach(t),Jd=s(Er,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),qr.forEach(t),nc=d(Ye),v(Qt.$$.fragment,Ye),sc=d(Ye),De=r(Ye,"DIV",{class:!0});var pt=i(De);v(Ln.$$.fragment,pt),ac=d(pt),Et=r(pt,"P",{});var Fs=i(Et);rc=s(Fs,"The "),us=r(Fs,"A",{href:!0});var uh=i(us);ic=s(uh,"TFLayoutLMModel"),uh.forEach(t),lc=s(Fs," forward method, overrides the "),pa=r(Fs,"CODE",{});var hh=i(pa);dc=s(hh,"__call__"),hh.forEach(t),cc=s(Fs," special method."),Fs.forEach(t),pc=d(pt),v(eo.$$.fragment,pt),uc=d(pt),ua=r(pt,"P",{});var mh=i(ua);hc=s(mh,"Examples:"),mh.forEach(t),mc=d(pt),v(vn.$$.fragment,pt),pt.forEach(t),Ye.forEach(t),sr=d(o),qt=r(o,"H2",{class:!0});var Cr=i(qt);to=r(Cr,"A",{id:!0,class:!0,href:!0});var fh=i(to);ha=r(fh,"SPAN",{});var gh=i(ha);v(wn.$$.fragment,gh),gh.forEach(t),fh.forEach(t),fc=d(Cr),ma=r(Cr,"SPAN",{});var _h=i(ma);gc=s(_h,"TFLayoutLMForMaskedLM"),_h.forEach(t),Cr.forEach(t),ar=d(o),ve=r(o,"DIV",{class:!0});var Ze=i(ve);v(Tn.$$.fragment,Ze),_c=d(Ze),Mn=r(Ze,"P",{});var Pr=i(Mn);yc=s(Pr,"LayoutLM Model with a "),fa=r(Pr,"CODE",{});var yh=i(fa);bc=s(yh,"language modeling"),yh.forEach(t),kc=s(Pr," head on top."),Pr.forEach(t),Lc=d(Ze),xn=r(Ze,"P",{});var Nr=i(xn);vc=s(Nr,"This model inherits from "),hs=r(Nr,"A",{href:!0});var bh=i(hs);wc=s(bh,"TFPreTrainedModel"),bh.forEach(t),Tc=s(Nr,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Sr.forEach(t),Fc=d(Ze),v(oo.$$.fragment,Ze),zc=d(Ze),Ae=r(Ze,"DIV",{class:!0});var ut=i(Ae);v(Fn.$$.fragment,ut),Ec=d(ut),Ct=r(ut,"P",{});var zs=i(Ct);qc=s(zs,"The "),ms=r(zs,"A",{href:!0});var Lh=i(ms);Cc=s(Lh,"TFLayoutLMForMaskedLM"),Lh.forEach(t),Pc=s(zs," forward method, overrides the "),ga=r(zs,"CODE",{});var vh=i(ga);Nc=s(vh,"__call__"),vh.forEach(t),Sc=s(zs," special method."),zs.forEach(t),Ic=d(ut),v(no.$$.fragment,ut),Oc=d(ut),_a=r(ut,"P",{});var wh=i(_a);Dc=s(wh,"Examples:"),wh.forEach(t),Ac=d(ut),v(zn.$$.fragment,ut),ut.forEach(t),Ze.forEach(t),rr=d(o),Pt=r(o,"H2",{class:!0});var Ir=i(Pt);so=r(Ir,"A",{id:!0,class:!0,href:!0});var Th=i(so);ya=r(Th,"SPAN",{});var Mh=i(ya);v(En.$$.fragment,Mh),Mh.forEach(t),Th.forEach(t),Uc=d(Ir),ba=r(Ir,"SPAN",{});var xh=i(ba);Wc=s(xh,"TFLayoutLMForSequenceClassification"),xh.forEach(t),Ir.forEach(t),ir=d(o),we=r(o,"DIV",{class:!0});var Ge=i(we);v(qn.$$.fragment,Ge),Hc=d(Ge),ka=r(Ge,"P",{});var jh=i(ka);Bc=s(jh,`LayoutLM Model transformer with a sequence classification/regression head on top (a linear layer on top of the
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Dr.forEach(t),Qc=d(Ge),v(ao.$$.fragment,Ge),ep=d(Ge),Ue=r(Ge,"DIV",{class:!0});var ht=i(Ue);v(Sn.$$.fragment,ht),tp=d(ht),Nt=r(ht,"P",{});var Es=i(Nt);op=s(Es,"The "),gs=r(Es,"A",{href:!0});var zh=i(gs);np=s(zh,"TFLayoutLMForSequenceClassification"),zh.forEach(t),sp=s(Es," forward method, overrides the "),La=r(Es,"CODE",{});var Eh=i(La);ap=s(Eh,"__call__"),Eh.forEach(t),rp=s(Es," special method."),Es.forEach(t),ip=d(ht),v(ro.$$.fragment,ht),lp=d(ht),va=r(ht,"P",{});var qh=i(va);dp=s(qh,"Examples:"),qh.forEach(t),cp=d(ht),v(In.$$.fragment,ht),ht.forEach(t),Ge.forEach(t),lr=d(o),St=r(o,"H2",{class:!0});var Ar=i(St);io=r(Ar,"A",{id:!0,class:!0,href:!0});var Ch=i(io);wa=r(Ch,"SPAN",{});var Ph=i(wa);v(On.$$.fragment,Ph),Ph.forEach(t),Ch.forEach(t),pp=d(Ar),Ta=r(Ar,"SPAN",{});var Nh=i(Ta);up=s(Nh,"TFLayoutLMForTokenClassification"),Nh.forEach(t),Ar.forEach(t),dr=d(o),Te=r(o,"DIV",{class:!0});var Je=i(Te);v(Dn.$$.fragment,Je),hp=d(Je),Ma=r(Je,"P",{});var Sh=i(Ma);mp=s(Sh,`LayoutLM Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g. for
