import{S as zf,i as Ff,s as Bf,e as n,k as i,w as f,t as r,M as xf,c as s,d as t,m as l,a,x as _,h as d,b as c,F as e,g as p,y as g,q as b,o as v,B as k,v as $f}from"../../chunks/vendor-6b77c823.js";import{T as ho}from"../../chunks/Tip-39098574.js";import{D as O}from"../../chunks/Docstring-abef54e3.js";import{C as Ke}from"../../chunks/CodeBlock-3a8b25a8.js";import{I as pe}from"../../chunks/IconCopyLink-7a11ce68.js";function qf(U){let u,B,y,z,F;return{c(){u=n("p"),B=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),y=n("code"),z=r("Module"),F=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(w){u=s(w,"P",{});var T=a(u);B=d(T,"Although the recipe for forward pass needs to be defined within this function, one should call the "),y=s(T,"CODE",{});var x=a(y);z=d(x,"Module"),x.forEach(t),F=d(T,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),T.forEach(t)},m(w,T){p(w,u,T),e(u,B),e(u,y),e(y,z),e(u,F)},d(w){w&&t(u)}}}function Ef(U){let u,B,y,z,F;return{c(){u=n("p"),B=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),y=n("code"),z=r("Module"),F=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(w){u=s(w,"P",{});var T=a(u);B=d(T,"Although the recipe for forward pass needs to be defined within this function, one should call the "),y=s(T,"CODE",{});var x=a(y);z=d(x,"Module"),x.forEach(t),F=d(T,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),T.forEach(t)},m(w,T){p(w,u,T),e(u,B),e(u,y),e(y,z),e(u,F)},d(w){w&&t(u)}}}function Mf(U){let u,B,y,z,F,w,T,x,Me,he,q,ke,te,Ce,oe,ne,je,xe,D,P,ye,R,E,C,Oe,J,Q,Pe,G,Ne,Ae,N,ue,se,$e,me,H,Ie,qe,M,Le,W,Se;return{c(){u=n("p"),B=r("TF 2.0 models accepts two formats as inputs:"),y=i(),z=n("ul"),F=n("li"),w=r("having all inputs as keyword arguments (like PyTorch models), or"),T=i(),x=n("li"),Me=r("having all inputs as a list, tuple or dict in the first positional arguments."),he=i(),q=n("p"),ke=r("This second option is useful when using "),te=n("code"),Ce=r("tf.keras.Model.fit"),oe=r(` method which currently requires having all the
...
`),W=n("code"),Se=r('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(m){u=s(m,"P",{});var $=a(u);B=d($,"TF 2.0 models accepts two formats as inputs:"),$.forEach(t),y=l(m),z=s(m,"UL",{});var Te=a(z);F=s(Te,"LI",{});var ht=a(F);w=d(ht,"having all inputs as keyword arguments (like PyTorch models), or"),ht.forEach(t),T=l(Te),x=s(Te,"LI",{});var Ve=a(x);Me=d(Ve,"having all inputs as a list, tuple or dict in the first positional arguments."),Ve.forEach(t),Te.forEach(t),he=l(m),q=s(m,"P",{});var j=a(q);ke=d(j,"This second option is useful when using "),te=s(j,"CODE",{});var fe=a(te);Ce=d(fe,"tf.keras.Model.fit"),fe.forEach(t),oe=d(j,` method which currently requires having all the
...
first positional argument :`),we.forEach(t),R=l(m),E=s(m,"UL",{});var K=a(E);C=s(K,"LI",{});var V=a(C);Oe=d(V,"a single Tensor with "),J=s(V,"CODE",{});var ut=a(J);Q=d(ut,"input_ids"),ut.forEach(t),Pe=d(V," only and nothing else: "),G=s(V,"CODE",{});var Je=a(G);Ne=d(Je,"model(input_ids)"),Je.forEach(t),V.forEach(t),Ae=l(K),N=s(K,"LI",{});var A=a(N);ue=d(A,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
...
`),W=s(ae,"CODE",{});var ft=a(W);Se=d(ft,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),ft.forEach(t),ae.forEach(t),K.forEach(t)},m(m,$){p(m,u,$),e(u,B),p(m,y,$),p(m,z,$),e(z,F),e(F,w),e(z,T),e(z,x),e(x,Me),p(m,he,$),p(m,q,$),e(q,ke),e(q,te),e(te,Ce),e(q,oe),e(q,ne),e(ne,je),e(q,xe),p(m,D,$),p(m,P,$),e(P,ye),p(m,R,$),p(m,E,$),e(E,C),e(C,Oe),e(C,J),e(J,Q),e(C,Pe),e(C,G),e(G,Ne),e(E,Ae),e(E,N),e(N,ue),e(N,se),e(se,$e),e(N,me),e(N,H),e(H,Ie),e(E,qe),e(E,M),e(M,Le),e(M,W),e(W,Se)},d(m){m&&t(u),m&&t(y),m&&t(z),m&&t(he),m&&t(q),m&&t(D),m&&t(P),m&&t(R),m&&t(E)}}}function Cf(U){let u,B,y,z,F;return{c(){u=n("p"),B=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),y=n("code"),z=r("Module"),F=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(w){u=s(w,"P",{});var T=a(u);B=d(T,"Although the recipe for forward pass needs to be defined within this function, one should call the "),y=s(T,"CODE",{});var x=a(y);z=d(x,"Module"),x.forEach(t),F=d(T,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),T.forEach(t)},m(w,T){p(w,u,T),e(u,B),e(u,y),e(y,z),e(u,F)},d(w){w&&t(u)}}}function jf(U){let u,B,y,z,F,w,T,x,Me,he,q,ke,te,Ce,oe,ne,je,xe,D,P,ye,R,E,C,Oe,J,Q,Pe,G,Ne,Ae,N,ue,se,$e,me,H,Ie,qe,M,Le,W,Se;return{c(){u=n("p"),B=r("TF 2.0 models accepts two formats as inputs:"),y=i(),z=n("ul"),F=n("li"),w=r("having all inputs as keyword arguments (like PyTorch models), or"),T=i(),x=n("li"),Me=r("having all inputs as a list, tuple or dict in the first positional arguments."),he=i(),q=n("p"),ke=r("This second option is useful when using "),te=n("code"),Ce=r("tf.keras.Model.fit"),oe=r(` method which currently requires having all the
tensors in the first argument of the model call function: `),ne=n("code"),je=r("model(inputs)"),xe=r("."),D=i(),P=n("p"),ye=r(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),R=i(),E=n("ul"),C=n("li"),Oe=r("a single Tensor with "),J=n("code"),Q=r("input_ids"),Pe=r(" only and nothing else: "),G=n("code"),Ne=r("model(input_ids)"),Ae=i(),N=n("li"),ue=r(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),se=n("code"),$e=r("model([input_ids, attention_mask])"),me=r(" or "),H=n("code"),Ie=r("model([input_ids, attention_mask, token_type_ids])"),qe=i(),M=n("li"),Le=r(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),W=n("code"),Se=r('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(m){u=s(m,"P",{});var $=a(u);B=d($,"TF 2.0 models accepts two formats as inputs:"),$.forEach(t),y=l(m),z=s(m,"UL",{});var Te=a(z);F=s(Te,"LI",{});var ht=a(F);w=d(ht,"having all inputs as keyword arguments (like PyTorch models), or"),ht.forEach(t),T=l(Te),x=s(Te,"LI",{});var Ve=a(x);Me=d(Ve,"having all inputs as a list, tuple or dict in the first positional arguments."),Ve.forEach(t),Te.forEach(t),he=l(m),q=s(m,"P",{});var j=a(q);ke=d(j,"This second option is useful when using "),te=s(j,"CODE",{});var fe=a(te);Ce=d(fe,"tf.keras.Model.fit"),fe.forEach(t),oe=d(j,` method which currently requires having all the
...
the latter silently ignores them.`)},l(w){u=s(w,"P",{});var T=a(u);B=d(T,"Although the recipe for forward pass needs to be defined within this function, one should call the "),y=s(T,"CODE",{});var x=a(y);z=d(x,"Module"),x.forEach(t),F=d(T,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),T.forEach(t)},m(w,T){p(w,u,T),e(u,B),e(u,y),e(y,z),e(u,F)},d(w){w&&t(u)}}}function Pf(U){let u,B,y,z,F;return{c(){u=n("p"),B=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),y=n("code"),z=r("Module"),F=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(w){u=s(w,"P",{});var T=a(u);B=d(T,"Although the recipe for forward pass needs to be defined within this function, one should call the "),y=s(T,"CODE",{});var x=a(y);z=d(x,"Module"),x.forEach(t),F=d(T,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),T.forEach(t)},m(w,T){p(w,u,T),e(u,B),e(u,y),e(y,z),e(u,F)},d(w){w&&t(u)}}}function Nf(U){let u,B,y,z,F;return{c(){u=n("p"),B=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),y=n("code"),z=r("Module"),F=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(w){u=s(w,"P",{});var T=a(u);B=d(T,"Although the recipe for forward pass needs to be defined within this function, one should call the "),y=s(T,"CODE",{});var x=a(y);z=d(x,"Module"),x.forEach(t),F=d(T,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),T.forEach(t)},m(w,T){p(w,u,T),e(u,B),e(u,y),e(y,z),e(u,F)},d(w){w&&t(u)}}}function Af(U){let u,B,y,z,F,w,T,x,Me,he,q,ke,te,Ce,oe,ne,je,xe,D,P,ye,R,E,C,Oe,J,Q,Pe,G,Ne,Ae,N,ue,se,$e,me,H,Ie,qe,M,Le,W,Se,m,$,Te,ht,Ve,j,fe,De,we,K,V,ut,Je,A,ze,mt,ae,ft,$d,qd,uo,Ed,mo,Md,Cd,jd,Ge,Od,qs,Pd,Nd,Es,Ad,Id,Un,Ld,Sd,Tr,_t,Nt,Ms,fo,Dd,Cs,Gd,wr,Rn,Wd,zr,_o,Fr,gt,At,js,go,Ud,Os,Rd,Br,re,bo,Hd,bt,Kd,Hn,Vd,Jd,vo,Qd,Xd,Yd,vt,Zd,Kn,ei,ti,Vn,oi,ni,si,Ps,ai,ri,ko,xr,kt,It,Ns,yo,di,As,ii,$r,de,To,li,Is,ci,pi,Lt,Ls,hi,ui,Jn,mi,fi,_i,wo,gi,Qn,bi,vi,ki,Qe,zo,yi,Ss,Ti,wi,Ds,Xn,zi,Gs,Fi,qr,yt,St,Ws,Fo,Bi,Us,xi,Er,ie,Bo,$i,xo,qi,Rs,Ei,Mi,Ci,Dt,Hs,ji,Oi,Yn,Pi,Ni,Ai,$o,Ii,Zn,Li,Si,Di,Xe,qo,Gi,Ks,Wi,Ui,Vs,es,Ri,Js,Hi,Mr,Tt,Gt,Qs,Eo,Ki,Xs,Vi,Cr,We,Ji,Ys,Qi,Xi,Zs,Yi,Zi,ea,el,jr,Fe,Mo,tl,Co,ol,ts,nl,sl,al,jo,rl,Oo,dl,il,ll,_e,Po,cl,wt,pl,os,hl,ul,ta,ml,fl,_l,Wt,gl,oa,bl,vl,No,Or,zt,Ut,na,Ao,kl,sa,yl,Pr,Ue,Tl,ns,wl,zl,aa,Fl,Bl,ra,xl,Nr,Be,Io,$l,Lo,ql,ss,El,Ml,Cl,So,jl,Do,Ol,Pl,Nl,ge,Go,Al,Ft,Il,as,Ll,Sl,da,Dl,Gl,Wl,Rt,Ul,ia,Rl,Hl,Wo,Ar,Bt,Ht,la,Uo,Kl,ca,Vl,Ir,xt,Ro,Jl,Ye,Ho,Ql,pa,Xl,Yl,Ko,Lr,$t,Kt,ha,Vo,Zl,ua,ec,Sr,le,Jo,tc,Qo,oc,rs,nc,sc,ac,Xo,rc,Yo,dc,ic,lc,Vt,cc,be,Zo,pc,qt,hc,ds,uc,mc,ma,fc,_c,gc,Jt,bc,fa,vc,kc,en,Dr,Et,Qt,_a,tn,yc,ga,Tc,Gr,ce,on,wc,nn,zc,is,Fc,Bc,xc,sn,$c,an,qc,Ec,Mc,Xt,Cc,X,rn,jc,Mt,Oc,ls,Pc,Nc,ba,Ac,Ic,Lc,Yt,Sc,va,Dc,Gc,ka,ya,Ta,wa,Wc,Uc,za,Fa,Ba,dn,Rc,xa,Hc,Kc,Wr,Ct,Zt,$a,ln,Vc,qa,Jc,Ur,I,cn,Qc,pn,Xc,cs,Yc,Zc,ep,hn,tp,un,op,np,sp,Ea,ap,rp,Re,Ma,mn,dp,ip,Ca,fn,lp,cp,ja,_n,pp,hp,Oa,gn,up,mp,ve,bn,fp,jt,_p,Pa,gp,bp,Na,vp,kp,yp,eo,Tp,Aa,wp,zp,vn,Fp,Ze,kn,Bp,Ia,xp,$p,yn,qp,et,Tn,Ep,La,Mp,Cp,wn,Rr,Ot,to,Sa,zn,jp,Da,Op,Hr,L,Fn,Pp,Bn,Np,ps,Ap,Ip,Lp,xn,Sp,$n,Dp,Gp,Wp,Ga,Up,Rp,He,Wa,qn,Hp,Kp,Ua,En,Vp,Jp,Ra,Mn,Qp,Xp,Ha,Cn,Yp,Zp,S,jn,eh,Pt,th,Ka,oh,nh,Va,sh,ah,rh,oo,dh,Ja,ih,lh,Qa,Xa,Ya,Za,ch,ph,er,tr,or,nr,hh,uh,sr,ar,rr,dr,mh,fh,ir,lr,On,no,so,cr,Pn,_h,pr,gh,bh,hr,vh,kh,tt,Nn,yh,ur,Th,wh,An,zh,ot,In,Fh,mr,Bh,xh,Ln,Kr;return w=new pe({}),R=new pe({}),we=new pe({}),fo=new pe({}),_o=new Ke({props:{code:`from transformers import BlenderbotTokenizer, BlenderbotForConditionalGeneration
...
<code>eos_token_id</code>.`,name:"forced_eos_token_id"}]}}),ko=new Ke({props:{code:`from transformers import BlenderbotModel, BlenderbotConfig
...
`}}),eo=new ho({props:{$$slots:{default:[Pf]},$$scope:{ctx:U}}}),vn=new Ke({props:{code:`from transformers import BlenderbotTokenizer, FlaxBlenderbotModel
...
`),Un=n("a"),Ld=r("BlenderbotSmall"),Sd=r("."),Tr=i(),_t=n("h2"),Nt=n("a"),Ms=n("span"),f(fo.$$.fragment),Dd=i(),Cs=n("span"),Gd=r("Usage"),wr=i(),Rn=n("p"),Wd=r("Here is an example of model usage:"),zr=i(),f(_o.$$.fragment),Fr=i(),gt=n("h2"),At=n("a"),js=n("span"),f(go.$$.fragment),Ud=i(),Os=n("span"),Rd=r("BlenderbotConfig"),Br=i(),re=n("div"),f(bo.$$.fragment),Hd=i(),bt=n("p"),Kd=r("This is the configuration class to store the configuration of a "),Hn=n("a"),Vd=r("BlenderbotModel"),Jd=r(`. It is used to instantiate an
Blenderbot model according to the specified arguments, defining the model architecture. Instantiating a
configuration with the defaults will yield a similar configuration to that of the Blenderbot
`),vo=n("a"),Qd=r("facebook/blenderbot-3B"),Xd=r(" architecture."),Yd=i(),vt=n("p"),Zd=r("Configuration objects inherit from "),Kn=n("a"),ei=r("PretrainedConfig"),ti=r(` and can be used to control the model outputs. Read the
documentation from `),Vn=n("a"),oi=r("PretrainedConfig"),ni=r(" for more information."),si=i(),Ps=n("p"),ai=r("Example:"),ri=i(),f(ko.$$.fragment),xr=i(),kt=n("h2"),It=n("a"),Ns=n("span"),f(yo.$$.fragment),di=i(),As=n("span"),ii=r("BlenderbotTokenizer"),$r=i(),de=n("div"),f(To.$$.fragment),li=i(),Is=n("p"),ci=r("Construct a Blenderbot tokenizer."),pi=i(),Lt=n("p"),Ls=n("code"),hi=r("Blenderbot"),ui=r(" is nearly identical to "),Jn=n("a"),mi=r("RobertaTokenizer"),fi=r(` and runs end-to-end tokenization: punctuation splitting
...
adding special tokens. A Blenderbot sequence has the following format:`),wi=i(),Ds=n("ul"),Xn=n("li"),zi=r("single sequence: "),Gs=n("code"),Fi=r("X </s>"),qr=i(),yt=n("h2"),St=n("a"),Ws=n("span"),f(Fo.$$.fragment),Bi=i(),Us=n("span"),xi=r("BlenderbotTokenizerFast"),Er=i(),ie=n("div"),f(Bo.$$.fragment),$i=i(),xo=n("p"),qi=r("Construct a \u201Cfast\u201D Blenderbot tokenizer (backed by HuggingFace\u2019s "),Rs=n("em"),Ei=r("tokenizers"),Mi=r(" library)."),Ci=i(),Dt=n("p"),Hs=n("code"),ji=r("BlenderbotFast"),Oi=r(" is nearly identical to "),Yn=n("a"),Pi=r("RobertaTokenizerFast"),Ni=r(` and runs end-to-end tokenization: punctuation
splitting and wordpiece. The only difference is that it doesn\u2019t add BOS token to the beginning of sequences.`),Ai=i(),$o=n("p"),Ii=r("Refer to superclass "),Zn=n("a"),Li=r("RobertaTokenizerFast"),Si=r(" for usage examples and documentation concerning parameters."),Di=i(),Xe=n("div"),f(qo.$$.fragment),Gi=i(),Ks=n("p"),Wi=r(`Build model inputs from a sequence or a pair of sequence for sequence classification tasks by concatenating and
adding special tokens. A Blenderbot sequence has the following format:`),Ui=i(),Vs=n("ul"),es=n("li"),Ri=r("single sequence: "),Js=n("code"),Hi=r("X </s>"),Mr=i(),Tt=n("h2"),Gt=n("a"),Qs=n("span"),f(Eo.$$.fragment),Ki=i(),Xs=n("span"),Vi=r("BlenderbotModel"),Cr=i(),We=n("p"),Ji=r("See "),Ys=n("code"),Qi=r("transformers.BartModel"),Xi=r(" for arguments to "),Zs=n("em"),Yi=r("forward"),Zi=r(" and "),ea=n("em"),el=r("generate"),jr=i(),Fe=n("div"),f(Mo.$$.fragment),tl=i(),Co=n("p"),ol=r(`The bare Blenderbot Model outputting raw hidden-states without any specific head on top.
...
and behavior.`),ll=i(),_e=n("div"),f(Po.$$.fragment),cl=i(),wt=n("p"),pl=r("The "),os=n("a"),hl=r("BlenderbotModel"),ul=r(" forward method, overrides the "),ta=n("code"),ml=r("__call__"),fl=r(" special method."),_l=i(),f(Wt.$$.fragment),gl=i(),oa=n("p"),bl=r("Example:"),vl=i(),f(No.$$.fragment),Or=i(),zt=n("h2"),Ut=n("a"),na=n("span"),f(Ao.$$.fragment),kl=i(),sa=n("span"),yl=r("BlenderbotForConditionalGeneration"),Pr=i(),Ue=n("p"),Tl=r("See "),ns=n("a"),wl=r("BartForConditionalGeneration"),zl=r(" for arguments to "),aa=n("em"),Fl=r("forward"),Bl=r(" and "),ra=n("em"),xl=r("generate"),Nr=i(),Be=n("div"),f(Io.$$.fragment),$l=i(),Lo=n("p"),ql=r(`The Blenderbot Model with a language modeling head. Can be used for summarization.
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Nl=i(),ge=n("div"),f(Go.$$.fragment),Al=i(),Ft=n("p"),Il=r("The "),as=n("a"),Ll=r("BlenderbotForConditionalGeneration"),Sl=r(" forward method, overrides the "),da=n("code"),Dl=r("__call__"),Gl=r(" special method."),Wl=i(),f(Rt.$$.fragment),Ul=i(),ia=n("p"),Rl=r("Conversation example:"),Hl=i(),f(Wo.$$.fragment),Ar=i(),Bt=n("h2"),Ht=n("a"),la=n("span"),f(Uo.$$.fragment),Kl=i(),ca=n("span"),Vl=r("BlenderbotForCausalLM"),Ir=i(),xt=n("div"),f(Ro.$$.fragment),Jl=i(),Ye=n("div"),f(Ho.$$.fragment),Ql=i(),pa=n("p"),Xl=r("Example:"),Yl=i(),f(Ko.$$.fragment),Lr=i(),$t=n("h2"),Kt=n("a"),ha=n("span"),f(Vo.$$.fragment),Zl=i(),ua=n("span"),ec=r("TFBlenderbotModel"),Sr=i(),le=n("div"),f(Jo.$$.fragment),tc=i(),Qo=n("p"),oc=r(`The bare BLENDERBOT Model outputting raw hidden-states without any specific head on top.
...
behavior.`),lc=i(),f(Vt.$$.fragment),cc=i(),be=n("div"),f(Zo.$$.fragment),pc=i(),qt=n("p"),hc=r("The "),ds=n("a"),uc=r("TFBlenderbotModel"),mc=r(" forward method, overrides the "),ma=n("code"),fc=r("__call__"),_c=r(" special method."),gc=i(),f(Jt.$$.fragment),bc=i(),fa=n("p"),vc=r("Example:"),kc=i(),f(en.$$.fragment),Dr=i(),Et=n("h2"),Qt=n("a"),_a=n("span"),f(tn.$$.fragment),yc=i(),ga=n("span"),Tc=r("TFBlenderbotForConditionalGeneration"),Gr=i(),ce=n("div"),f(on.$$.fragment),wc=i(),nn=n("p"),zc=r(`The BLENDERBOT Model with a language modeling head. Can be used for summarization.
This model inherits from `),is=n("a"),Fc=r("TFPreTrainedModel"),Bc=r(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
skip_special_tokens=True)[0])`),Uc=i(),za=n("blockquote"),Fa=n("blockquote"),Ba=n("blockquote"),dn=n("p"),Rc=r(`REPLY = \u201CI\u2019m not sure\u201D >>> print(\u201CHuman: \u201D, REPLY) >>> NEXT_UTTERANCE = ( \u2026 \u201CMy friends are cool but they
...
skip_special_tokens=True)[0])`),Wr=i(),Ct=n("h2"),Zt=n("a"),$a=n("span"),f(ln.$$.fragment),Vc=i(),qa=n("span"),Jc=r("FlaxBlenderbotModel"),Ur=i(),I=n("div"),f(cn.$$.fragment),Qc=i(),pn=n("p"),Xc=r(`The bare MBart Model transformer outputting raw hidden-states without any specific head on top.
...
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),Wp=i(),Ga=n("p"),Up=r("Finally, this model supports inherent JAX features such as:"),Rp=i(),He=n("ul"),Wa=n("li"),qn=n("a"),Hp=r("Just-In-Time (JIT) compilation"),Kp=i(),Ua=n("li"),En=n("a"),Vp=r("Automatic Differentiation"),Jp=i(),Ra=n("li"),Mn=n("a"),Qp=r("Vectorization"),Xp=i(),Ha=n("li"),Cn=n("a"),Yp=r("Parallelization"),Zp=i(),S=n("div"),f(jn.$$.fragment),eh=i(),Pt=n("p"),th=r("The "),Ka=n("code"),oh=r("FlaxBlenderbotPreTrainedModel"),nh=r(" forward method, overrides the "),Va=n("code"),sh=r("__call__"),ah=r(" special method."),rh=i(),f(oo.$$.fragment),dh=i(),Ja=n("p"),ih=r("Conversation example::"),lh=i(),Qa=n("blockquote"),Xa=n("blockquote"),Ya=n("blockquote"),Za=n("p"),ch=r("from transformers import BlenderbotTokenizer, FlaxBlenderbotForConditionalGeneration, BlenderbotConfig"),ph=i(),er=n("blockquote"),tr=n("blockquote"),or=n("blockquote"),nr=n("p"),hh=r(`model = FlaxBlenderbotForConditionalGeneration.from_pretrained(\u2018facebook/blenderbot-400M-distill\u2019) >>>
...
clean_up_tokenization_spaces=False) for g in reply_ids])`),kh=i(),tt=n("div"),f(Nn.$$.fragment),yh=i(),ur=n("p"),Th=r("Example:"),wh=i(),f(An.$$.fragment),zh=i(),ot=n("div"),f(In.$$.fragment),Fh=i(),mr=n("p"),Bh=r("Example:"),xh=i(),f(Ln.$$.fragment),this.h()},l(o){const h=xf('[data-svelte="svelte-1phssyn"]',document.head);u=s(h,"META",{name:!0,content:!0}),h.forEach(t),B=l(o),y=s(o,"H1",{class:!0});var Sn=a(y);z=s(Sn,"A",{id:!0,class:!0,href:!0});var fr=a(z);F=s(fr,"SPAN",{});var _r=a(F);_(w.$$.fragment,_r),_r.forEach(t),fr.forEach(t),T=l(Sn),x=s(Sn,"SPAN",{});var gr=a(x);Me=d(gr,"Blenderbot"),gr.forEach(t),Sn.forEach(t),he=l(o),q=s(o,"P",{});var ao=a(q);ke=s(ao,"STRONG",{});var br=a(ke);te=d(br,"DISCLAIMER:"),br.forEach(t),Ce=d(ao," If you see something strange, file a "),oe=s(ao,"A",{href:!0,rel:!0});var vr=a(oe);ne=d(vr,"Github Issue"),vr.forEach(t),je=d(ao," ."),ao.forEach(t),xe=l(o),D=s(o,"H2",{class:!0});var Dn=a(D);P=s(Dn,"A",{id:!0,class:!0,href:!0});var Eh=a(P);ye=s(Eh,"SPAN",{});var Mh=a(ye);_(R.$$.fragment,Mh),Mh.forEach(t),Eh.forEach(t),E=l(Dn),C=s(Dn,"SPAN",{});var Ch=a(C);Oe=d(Ch,"Overview"),Ch.forEach(t),Dn.forEach(t),J=l(o),Q=s(o,"P",{});var Vr=a(Q);Pe=d(Vr,"The Blender chatbot model was proposed in "),G=s(Vr,"A",{href:!0,rel:!0});var jh=a(G);Ne=d(jh,"Recipes for building an open-domain chatbot"),jh.forEach(t),Ae=d(Vr,` Stephen Roller, Emily Dinan, Naman Goyal, Da Ju, Mary Williamson, Yinhan Liu,
Jing Xu, Myle Ott, Kurt Shuster, Eric M. Smith, Y-Lan Boureau, Jason Weston on 30 Apr 2020.`),Vr.forEach(t),N=l(o),ue=s(o,"P",{});var Oh=a(ue);se=d(Oh,"The abstract of the paper is the following:"),Oh.forEach(t),$e=l(o),me=s(o,"P",{});var Ph=a(me);H=s(Ph,"EM",{});var Nh=a(H);Ie=d(Nh,`Building open-domain chatbots is a challenging area for machine learning research. While prior work has shown that
scaling neural models in the number of parameters and the size of the data they are trained on gives improved results,
we show that other ingredients are important for a high-performing chatbot. Good conversation requires a number of
skills that an expert conversationalist blends in a seamless way: providing engaging talking points and listening to
their partners, and displaying knowledge, empathy and personality appropriately, while maintaining a consistent
...
`),Un=s(ro,"A",{href:!0});var Hh=a(Un);Ld=d(Hh,"BlenderbotSmall"),Hh.forEach(t),Sd=d(ro,"."),ro.forEach(t),us.forEach(t),Tr=l(o),_t=s(o,"H2",{class:!0});var Yr=a(_t);Nt=s(Yr,"A",{id:!0,class:!0,href:!0});var Kh=a(Nt);Ms=s(Kh,"SPAN",{});var Vh=a(Ms);_(fo.$$.fragment,Vh),Vh.forEach(t),Kh.forEach(t),Dd=l(Yr),Cs=s(Yr,"SPAN",{});var Jh=a(Cs);Gd=d(Jh,"Usage"),Jh.forEach(t),Yr.forEach(t),wr=l(o),Rn=s(o,"P",{});var Qh=a(Rn);Wd=d(Qh,"Here is an example of model usage:"),Qh.forEach(t),zr=l(o),_(_o.$$.fragment,o),Fr=l(o),gt=s(o,"H2",{class:!0});var Zr=a(gt);At=s(Zr,"A",{id:!0,class:!0,href:!0});var Xh=a(At);js=s(Xh,"SPAN",{});var Yh=a(js);_(go.$$.fragment,Yh),Yh.forEach(t),Xh.forEach(t),Ud=l(Zr),Os=s(Zr,"SPAN",{});var Zh=a(Os);Rd=d(Zh,"BlenderbotConfig"),Zh.forEach(t),Zr.forEach(t),Br=l(o),re=s(o,"DIV",{class:!0});var nt=a(re);_(bo.$$.fragment,nt),Hd=l(nt),bt=s(nt,"P",{});var ms=a(bt);Kd=d(ms,"This is the configuration class to store the configuration of a "),Hn=s(ms,"A",{href:!0});var eu=a(Hn);Vd=d(eu,"BlenderbotModel"),eu.forEach(t),Jd=d(ms,`. It is used to instantiate an
Blenderbot model according to the specified arguments, defining the model architecture. Instantiating a
configuration with the defaults will yield a similar configuration to that of the Blenderbot
`),vo=s(ms,"A",{href:!0,rel:!0});var tu=a(vo);Qd=d(tu,"facebook/blenderbot-3B"),tu.forEach(t),Xd=d(ms," architecture."),ms.forEach(t),Yd=l(nt),vt=s(nt,"P",{});var fs=a(vt);Zd=d(fs,"Configuration objects inherit from "),Kn=s(fs,"A",{href:!0});var ou=a(Kn);ei=d(ou,"PretrainedConfig"),ou.forEach(t),ti=d(fs,` and can be used to control the model outputs. Read the
documentation from `),Vn=s(fs,"A",{href:!0});var nu=a(Vn);oi=d(nu,"PretrainedConfig"),nu.forEach(t),ni=d(fs," for more information."),fs.forEach(t),si=l(nt),Ps=s(nt,"P",{});var su=a(Ps);ai=d(su,"Example:"),su.forEach(t),ri=l(nt),_(ko.$$.fragment,nt),nt.forEach(t),xr=l(o),kt=s(o,"H2",{class:!0});var ed=a(kt);It=s(ed,"A",{id:!0,class:!0,href:!0});var au=a(It);Ns=s(au,"SPAN",{});var ru=a(Ns);_(yo.$$.fragment,ru),ru.forEach(t),au.forEach(t),di=l(ed),As=s(ed,"SPAN",{});var du=a(As);ii=d(du,"BlenderbotTokenizer"),du.forEach(t),ed.forEach(t),$r=l(o),de=s(o,"DIV",{class:!0});var st=a(de);_(To.$$.fragment,st),li=l(st),Is=s(st,"P",{});var iu=a(Is);ci=d(iu,"Construct a Blenderbot tokenizer."),iu.forEach(t),pi=l(st),Lt=s(st,"P",{});var kr=a(Lt);Ls=s(kr,"CODE",{});var lu=a(Ls);hi=d(lu,"Blenderbot"),lu.forEach(t),ui=d(kr," is nearly identical to "),Jn=s(kr,"A",{href:!0});var cu=a(Jn);mi=d(cu,"RobertaTokenizer"),cu.forEach(t),fi=d(kr,` and runs end-to-end tokenization: punctuation splitting
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),cd.forEach(t),Nl=l(lo),ge=s(lo,"DIV",{class:!0});var dt=a(ge);_(Go.$$.fragment,dt),Al=l(dt),Ft=s(dt,"P",{});var vs=a(Ft);Il=d(vs,"The "),as=s(vs,"A",{href:!0});var Uu=a(as);Ll=d(Uu,"BlenderbotForConditionalGeneration"),Uu.forEach(t),Sl=d(vs," forward method, overrides the "),da=s(vs,"CODE",{});var Ru=a(da);Dl=d(Ru,"__call__"),Ru.forEach(t),Gl=d(vs," special method."),vs.forEach(t),Wl=l(dt),_(Rt.$$.fragment,dt),Ul=l(dt),ia=s(dt,"P",{});var Hu=a(ia);Rl=d(Hu,"Conversation example:"),Hu.forEach(t),Hl=l(dt),_(Wo.$$.fragment,dt),dt.forEach(t),lo.forEach(t),Ar=l(o),Bt=s(o,"H2",{class:!0});var pd=a(Bt);Ht=s(pd,"A",{id:!0,class:!0,href:!0});var Ku=a(Ht);la=s(Ku,"SPAN",{});var Vu=a(la);_(Uo.$$.fragment,Vu),Vu.forEach(t),Ku.forEach(t),Kl=l(pd),ca=s(pd,"SPAN",{});var Ju=a(ca);Vl=d(Ju,"BlenderbotForCausalLM"),Ju.forEach(t),pd.forEach(t),Ir=l(o),xt=s(o,"DIV",{class:!0});var hd=a(xt);_(Ro.$$.fragment,hd),Jl=l(hd),Ye=s(hd,"DIV",{class:!0});var ks=a(Ye);_(Ho.$$.fragment,ks),Ql=l(ks),pa=s(ks,"P",{});var Qu=a(pa);Xl=d(Qu,"Example:"),Qu.forEach(t),Yl=l(ks),_(Ko.$$.fragment,ks),ks.forEach(t),hd.forEach(t),Lr=l(o),$t=s(o,"H2",{class:!0});var ud=a($t);Kt=s(ud,"A",{id:!0,class:!0,href:!0});var Xu=a(Kt);ha=s(Xu,"SPAN",{});var Yu=a(ha);_(Vo.$$.fragment,Yu),Yu.forEach(t),Xu.forEach(t),Zl=l(ud),ua=s(ud,"SPAN",{});var Zu=a(ua);ec=d(Zu,"TFBlenderbotModel"),Zu.forEach(t),ud.forEach(t),Sr=l(o),le=s(o,"DIV",{class:!0});var it=a(le);_(Jo.$$.fragment,it),tc=l(it),Qo=s(it,"P",{});var md=a(Qo);oc=d(md,`The bare BLENDERBOT Model outputting raw hidden-states without any specific head on top.
...
many carbs.\u201D >>> print(\u201CHuman: \u201D, UTTERANCE) >>> inputs = tokenizer([UTTERANCE], return_tensors=\u2018tf\u2019) >>>
reply_ids = model.generate(**inputs) >>> print(\u201CBot: \u201D, tokenizer.batch_decode(reply_ids,
skip_special_tokens=True)[0])`),_m.forEach(t),fm.forEach(t),mm.forEach(t),um.forEach(t),Uc=l(Ee),za=s(Ee,"BLOCKQUOTE",{});var gm=a(za);Fa=s(gm,"BLOCKQUOTE",{});var bm=a(Fa);Ba=s(bm,"BLOCKQUOTE",{});var vm=a(Ba);dn=s(vm,"P",{});var vd=a(dn);Rc=d(vd,`REPLY = \u201CI\u2019m not sure\u201D >>> print(\u201CHuman: \u201D, REPLY) >>> NEXT_UTTERANCE = ( \u2026 \u201CMy friends are cool but they
...
be healthier?`),km.forEach(t),Kc=d(vd,` \u201D \u2026 \u201D<s> I\u2019m not sure.\u201D \u2026 ) >>> inputs = tokenizer([NEXT_UTTERANCE], return_tensors=\u2018tf\u2019)
next_reply_ids = model.generate(**inputs) >>> print(\u201CBot: \u201D, tokenizer.batch_decode(next_reply_ids,
skip_special_tokens=True)[0])`),vd.forEach(t),vm.forEach(t),bm.forEach(t),gm.forEach(t),Ee.forEach(t),ct.forEach(t),Wr=l(o),Ct=s(o,"H2",{class:!0});var kd=a(Ct);Zt=s(kd,"A",{id:!0,class:!0,href:!0});var ym=a(Zt);$a=s(ym,"SPAN",{});var Tm=a($a);_(ln.$$.fragment,Tm),Tm.forEach(t),ym.forEach(t),Vc=l(kd),qa=s(kd,"SPAN",{});var wm=a(qa);Jc=d(wm,"FlaxBlenderbotModel"),wm.forEach(t),kd.forEach(t),Ur=l(o),I=s(o,"DIV",{class:!0});var Y=a(I);_(cn.$$.fragment,Y),Qc=l(Y),pn=s(Y,"P",{});var yd=a(pn);Xc=d(yd,`The bare MBart Model transformer outputting raw hidden-states without any specific head on top.
...
`),un=s(Td,"A",{href:!0,rel:!0});var Fm=a(un);op=d(Fm,"flax.nn.Module"),Fm.forEach(t),np=d(Td,` subclass. Use it as a
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),Td.forEach(t),sp=l(Y),Ea=s(Y,"P",{});var Bm=a(Ea);ap=d(Bm,"Finally, this model supports inherent JAX features such as:"),Bm.forEach(t),rp=l(Y),Re=s(Y,"UL",{});var co=a(Re);Ma=s(co,"LI",{});var xm=a(Ma);mn=s(xm,"A",{href:!0,rel:!0});var $m=a(mn);dp=d($m,"Just-In-Time (JIT) compilation"),$m.forEach(t),xm.forEach(t),ip=l(co),Ca=s(co,"LI",{});var qm=a(Ca);fn=s(qm,"A",{href:!0,rel:!0});var Em=a(fn);lp=d(Em,"Automatic Differentiation"),Em.forEach(t),qm.forEach(t),cp=l(co),ja=s(co,"LI",{});var Mm=a(ja);_n=s(Mm,"A",{href:!0,rel:!0});var Cm=a(_n);pp=d(Cm,"Vectorization"),Cm.forEach(t),Mm.forEach(t),hp=l(co),Oa=s(co,"LI",{});var jm=a(Oa);gn=s(jm,"A",{href:!0,rel:!0});var Om=a(gn);up=d(Om,"Parallelization"),Om.forEach(t),jm.forEach(t),co.forEach(t),mp=l(Y),ve=s(Y,"DIV",{class:!0});var pt=a(ve);_(bn.$$.fragment,pt),fp=l(pt),jt=s(pt,"P",{});var ws=a(jt);_p=d(ws,"The "),Pa=s(ws,"CODE",{});var Pm=a(Pa);gp=d(Pm,"FlaxBlenderbotPreTrainedModel"),Pm.forEach(t),bp=d(ws," forward method, overrides the "),Na=s(ws,"CODE",{});var Nm=a(Na);vp=d(Nm,"__call__"),Nm.forEach(t),kp=d(ws," special method."),ws.forEach(t),yp=l(pt),_(eo.$$.fragment,pt),Tp=l(pt),Aa=s(pt,"P",{});var Am=a(Aa);wp=d(Am,"Example:"),Am.forEach(t),zp=l(pt),_(vn.$$.fragment,pt),pt.forEach(t),Fp=l(Y),Ze=s(Y,"DIV",{class:!0});var zs=a(Ze);_(kn.$$.fragment,zs),Bp=l(zs),Ia=s(zs,"P",{});var Im=a(Ia);xp=d(Im,"Example:"),Im.forEach(t),$p=l(zs),_(yn.$$.fragment,zs),zs.forEach(t),qp=l(Y),et=s(Y,"DIV",{class:!0});var Fs=a(et);_(Tn.$$.fragment,Fs),Ep=l(Fs),La=s(Fs,"P",{});var Lm=a(La);Mp=d(Lm,"Example:"),Lm.forEach(t),Cp=l(Fs),_(wn.$$.fragment,Fs),Fs.forEach(t),Y.forEach(t),Rr=l(o),Ot=s(o,"H2",{class:!0});var wd=a(Ot);to=s(wd,"A",{id:!0,class:!0,href:!0});var Sm=a(to);Sa=s(Sm,"SPAN",{});var Dm=a(Sa);_(zn.$$.fragment,Dm),Dm.forEach(t),Sm.forEach(t),jp=l(wd),Da=s(wd,"SPAN",{});var Gm=a(Da);Op=d(Gm,"FlaxBlenderbotForConditionalGeneration"),Gm.forEach(t),wd.forEach(t),Hr=l(o),L=s(o,"DIV",{class:!0});var Z=a(L);_(Fn.$$.fragment,Z),Pp=l(Z),Bn=s(Z,"P",{});var zd=a(Bn);Np=d(zd,`The Blenderbot Model with a language modeling head. Can be used for summarization.
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),zd.forEach(t),Lp=l(Z),xn=s(Z,"P",{});var Fd=a(xn);Sp=d(Fd,`This model is also a Flax Linen
`),$n=s(Fd,"A",{href:!0,rel:!0});var Um=a($n);Dp=d(Um,"flax.nn.Module"),Um.forEach(t),Gp=d(Fd,` subclass. Use it as a
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),Fd.forEach(t),Wp=l(Z),Ga=s(Z,"P",{});var Rm=a(Ga);Up=d(Rm,"Finally, this model supports inherent JAX features such as:"),Rm.forEach(t),Rp=l(Z),He=s(Z,"UL",{});var po=a(He);Wa=s(po,"LI",{});var Hm=a(Wa);qn=s(Hm,"A",{href:!0,rel:!0});var Km=a(qn);Hp=d(Km,"Just-In-Time (JIT) compilation"),Km.forEach(t),Hm.forEach(t),Kp=l(po),Ua=s(po,"LI",{});var Vm=a(Ua);En=s(Vm,"A",{href:!0,rel:!0});var Jm=a(En);Vp=d(Jm,"Automatic Differentiation"),Jm.forEach(t),Vm.forEach(t),Jp=l(po),Ra=s(po,"LI",{});var Qm=a(Ra);Mn=s(Qm,"A",{href:!0,rel:!0});var Xm=a(Mn);Qp=d(Xm,"Vectorization"),Xm.forEach(t),Qm.forEach(t),Xp=l(po),Ha=s(po,"LI",{});var Ym=a(Ha);Cn=s(Ym,"A",{href:!0,rel:!0});var Zm=a(Cn);Yp=d(Zm,"Parallelization"),Zm.forEach(t),Ym.forEach(t),po.forEach(t),Zp=l(Z),S=s(Z,"DIV",{class:!0});var ee=a(S);_(jn.$$.fragment,ee),eh=l(ee),Pt=s(ee,"P",{});var Bs=a(Pt);th=d(Bs,"The "),Ka=s(Bs,"CODE",{});var ef=a(Ka);oh=d(ef,"FlaxBlenderbotPreTrainedModel"),ef.forEach(t),nh=d(Bs," forward method, overrides the "),Va=s(Bs,"CODE",{});var tf=a(Va);sh=d(tf,"__call__"),tf.forEach(t),ah=d(Bs," special method."),Bs.forEach(t),rh=l(ee),_(oo.$$.fragment,ee),dh=l(ee),Ja=s(ee,"P",{});var of=a(Ja);ih=d(of,"Conversation example::"),of.forEach(t),lh=l(ee),Qa=s(ee,"BLOCKQUOTE",{});var nf=a(Qa);Xa=s(nf,"BLOCKQUOTE",{});var sf=a(Xa);Ya=s(sf,"BLOCKQUOTE",{});var af=a(Ya);Za=s(af,"P",{});var rf=a(Za);ch=d(rf,"from transformers import BlenderbotTokenizer, FlaxBlenderbotForConditionalGeneration, BlenderbotConfig"),rf.forEach(t),af.forEach(t),sf.forEach(t),nf.forEach(t),ph=l(ee),er=s(ee,"BLOCKQUOTE",{});var df=a(er);tr=s(df,"BLOCKQUOTE",{});var lf=a(tr);or=s(lf,"BLOCKQUOTE",{});var cf=a(or);nr=s(cf,"P",{});var pf=a(nr);hh=d(pf,`model = FlaxBlenderbotForConditionalGeneration.from_pretrained(\u2018facebook/blenderbot-400M-distill\u2019) >>>
