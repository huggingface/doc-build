...
<code>eos_token_id</code>.`,name:"forced_eos_token_id"}],source:"https://github.com/huggingface/transformers/blob/v4.18.0/src/transformers/models/bart/configuration_bart.py#L35"}}),An=new C({props:{code:`from transformers import BartModel, BartConfig
...
other word. (BART tokenizer detect beginning of words by the preceding space).`,name:"add_prefix_space"}],source:"https://github.com/huggingface/transformers/blob/v4.18.0/src/transformers/models/bart/tokenization_bart.py#L101"}}),In=new C({props:{code:`from transformers import BartTokenizer
...
Whether the post processing step should trim offsets to avoid including whitespaces.`,name:"trim_offsets"}],source:"https://github.com/huggingface/transformers/blob/v4.18.0/src/transformers/models/bart/tokenization_bart_fast.py#L70"}}),Xn=new C({props:{code:`from transformers import BartTokenizerFast
