import{S as pp,i as mp,s as up,e as a,k as c,w as v,t as n,M as fp,c as r,d as t,m as l,a as i,x as T,h as s,b as d,F as e,g as p,y as b,q as x,o as k,B as y,v as _p}from"../../chunks/vendor-6b77c823.js";import{T as Yt}from"../../chunks/Tip-39098574.js";import{D}from"../../chunks/Docstring-17b815d9.js";import{C as ln}from"../../chunks/CodeBlock-3a8b25a8.js";import{I as We}from"../../chunks/IconCopyLink-7a11ce68.js";function gp(U){let h,q,f,g,S,_,w,$;return{c(){h=a("p"),q=n(`This class method is simply calling the feature extractor
...
the latter silently ignores them.`)},l(_){h=r(_,"P",{});var w=i(h);q=s(w,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=r(w,"CODE",{});var $=i(f);g=s($,"Module"),$.forEach(t),S=s(w,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),w.forEach(t)},m(_,w){p(_,h,w),e(h,q),e(h,f),e(f,g),e(h,S)},d(_){_&&t(h)}}}function Sp(U){let h,q,f,g,S,_,w,$,A,z,E,N,H,ee,Fe,B,Ce,$e,M,J,te,ye,P,j,Pe,oe,ne,je,se,ae,Me,O,Ee,L,Ae,re,ie,Ie,de,K,De,Z,Y,u,F,X,st,Ne,Q,Ve,_e,at,G,ce,rt,Ue,C,it,qe,Le,dt,hn,tr,or,pn,nr,sr,mn,ar,rr,Zs,W,ir,Yn,dr,cr,Xn,lr,hr,Qn,pr,mr,Zn,ur,fr,es,_r,gr,Xt,vr,Tr,ts,br,ea,un,os,xr,ta,Qt,oa,fn,Zt,ns,kr,yr,le,wr,ss,Sr,$r,as,Er,qr,rs,zr,Fr,is,Cr,Pr,ds,jr,Mr,na,eo,sa,yt,Ar,to,Ir,Dr,aa,ct,wt,cs,oo,Nr,ls,Lr,ra,he,no,Or,lt,Gr,_n,Wr,Vr,so,Ur,Rr,Hr,ht,Br,gn,Jr,Kr,vn,Yr,Xr,Qr,hs,Zr,ei,ao,ia,pt,St,ps,ro,ti,ms,oi,da,V,io,ni,us,si,ai,co,ri,Tn,ii,di,ci,$t,lo,li,fs,hi,pi,Et,ho,mi,po,ui,_s,fi,_i,gi,Re,mo,vi,bn,Ti,xn,bi,xi,gs,ki,yi,kn,uo,ca,mt,qt,vs,fo,wi,Ts,Si,la,pe,_o,$i,bs,Ei,qi,go,zi,yn,Fi,Ci,Pi,xs,ji,Mi,zt,vo,Ai,ks,Ii,ha,ut,Ft,ys,To,Di,ws,Ni,pa,I,bo,Li,Ss,Oi,Gi,ge,wn,Wi,Vi,Sn,Ui,Ri,$n,Hi,Bi,xo,$s,Ji,Ki,Yi,En,Xi,Qi,Zi,Ct,ko,ed,Oe,td,yo,Es,od,nd,sd,qn,ad,rd,wo,qs,id,dd,cd,ld,He,So,hd,zs,pd,md,Pt,ud,Be,$o,fd,Eo,_d,zn,gd,vd,Td,jt,bd,Mt,qo,xd,zo,kd,Fn,yd,wd,Sd,At,Fo,$d,Co,Ed,Cn,qd,zd,Fd,It,Po,Cd,Fs,Pd,ma,ft,Dt,Cs,jo,jd,Ps,Md,ua,we,Mo,Ad,Ao,Id,Pn,Dd,Nd,Ld,Io,Od,Do,Gd,Wd,Vd,ve,No,Ud,_t,Rd,jn,Hd,Bd,js,Jd,Kd,Yd,Nt,Xd,Ms,Qd,Zd,Lo,fa,gt,Lt,As,Oo,ec,Is,tc,_a,Se,Go,oc,Wo,nc,Mn,sc,ac,rc,Vo,ic,Uo,dc,cc,lc,Te,Ro,hc,vt,pc,An,mc,uc,Ds,fc,_c,gc,Ot,vc,Ns,Tc,bc,Ho,ga,Tt,Gt,Ls,Bo,xc,Os,kc,va,me,Jo,yc,Ko,wc,In,Sc,$c,Ec,Yo,qc,Xo,zc,Fc,Cc,Wt,Pc,be,Qo,jc,bt,Mc,Dn,Ac,Ic,Gs,Dc,Nc,Lc,Vt,Oc,Ws,Gc,Wc,Zo,Ta,xt,Ut,Vs,en,Vc,Us,Uc,ba,ue,tn,Rc,on,Hc,Nn,Bc,Jc,Kc,nn,Yc,sn,Xc,Qc,Zc,Rt,el,xe,an,tl,kt,ol,Ln,nl,sl,Rs,al,rl,il,Ht,dl,Hs,cl,ll,rn,xa;return _=new We({}),ee=new We({}),X=new We({}),Qt=new ln({props:{code:`import torch
...
documentation from `),vn=a("a"),Yr=n("PretrainedConfig"),Xr=n(" for more information."),Qr=c(),hs=a("p"),Zr=n("Example:"),ei=c(),v(ao.$$.fragment),ia=c(),pt=a("h2"),St=a("a"),ps=a("span"),v(ro.$$.fragment),ti=c(),ms=a("span"),oi=n("Speech2TextTokenizer"),da=c(),V=a("div"),v(io.$$.fragment),ni=c(),us=a("p"),si=n("Construct an Speech2Text tokenizer."),ai=c(),co=a("p"),ri=n("This tokenizer inherits from "),Tn=a("a"),ii=n("PreTrainedTokenizer"),di=n(` which contains some of the main methods. Users should refer to
the superclass for more information regarding such methods.`),ci=c(),$t=a("div"),v(lo.$$.fragment),li=c(),fs=a("p"),hi=n("Build model inputs from a sequence by appending eos_token_id."),pi=c(),Et=a("div"),v(ho.$$.fragment),mi=c(),po=a("p"),ui=n(`Retrieve sequence ids from a token list that has no special tokens added. This method is called when adding
special tokens using the tokenizer `),_s=a("code"),fi=n("prepare_for_model"),_i=n(" method."),gi=c(),Re=a("div"),v(mo.$$.fragment),vi=c(),bn=a("p"),Ti=n("Create the token type IDs corresponding to the sequences passed. "),xn=a("a"),bi=n(`What are token type
IDs?`),xi=c(),gs=a("p"),ki=n("Should be overridden in a subclass if the model has a special way of building those."),yi=c(),kn=a("div"),v(uo.$$.fragment),ca=c(),mt=a("h2"),qt=a("a"),vs=a("span"),v(fo.$$.fragment),wi=c(),Ts=a("span"),Si=n("Speech2TextFeatureExtractor"),la=c(),pe=a("div"),v(_o.$$.fragment),$i=c(),bs=a("p"),Ei=n("Constructs a Speech2Text feature extractor."),qi=c(),go=a("p"),zi=n("This feature extractor inherits from "),yn=a("a"),Fi=n("Speech2TextFeatureExtractor"),Ci=n(` which contains most of the main methods. Users
...
mean and variance normalization to the extracted features.`),Mi=c(),zt=a("div"),v(vo.$$.fragment),Ai=c(),ks=a("p"),Ii=n("Main method to featurize and prepare for the model one or several sequence(s). sequences."),ha=c(),ut=a("h2"),Ft=a("a"),ys=a("span"),v(To.$$.fragment),Di=c(),ws=a("span"),Ni=n("Speech2TextProcessor"),pa=c(),I=a("div"),v(bo.$$.fragment),Li=c(),Ss=a("p"),Oi=n(`Constructs a Speech2Text processor which wraps a Speech2Text feature extractor and a Speech2Text tokenizer into a
...
information.`),Zi=c(),Ct=a("div"),v(ko.$$.fragment),ed=c(),Oe=a("p"),td=n(`When used in normal mode, this method forwards all its arguments to Speech2TextFeatureExtractor\u2019s
...
information.`),ld=c(),He=a("div"),v(So.$$.fragment),hd=c(),zs=a("p"),pd=n("Instantiate a processor associated with a pretrained model."),md=c(),v(Pt.$$.fragment),ud=c(),Be=a("div"),v($o.$$.fragment),fd=c(),Eo=a("p"),_d=n(`Saves the attributes of this processor (feature extractor, tokenizer\u2026) in the specified directory so that it
can be reloaded using the `),zn=a("a"),gd=n("from_pretrained()"),vd=n(" method."),Td=c(),v(jt.$$.fragment),bd=c(),Mt=a("div"),v(qo.$$.fragment),xd=c(),zo=a("p"),kd=n("This method forwards all its arguments to Speech2TextTokenizer\u2019s "),Fn=a("a"),yd=n("batch_decode()"),wd=n(`. Please
...
Speech2Text.`),ma=c(),ft=a("h2"),Dt=a("a"),Cs=a("span"),v(jo.$$.fragment),jd=c(),Ps=a("span"),Md=n("Speech2TextModel"),ua=c(),we=a("div"),v(Mo.$$.fragment),Ad=c(),Ao=a("p"),Id=n(`The bare Speech2Text Model outputting raw hidden-states without any specific head on top.
...
and behavior.`),Vd=c(),ve=a("div"),v(No.$$.fragment),Ud=c(),_t=a("p"),Rd=n("The "),jn=a("a"),Hd=n("Speech2TextModel"),Bd=n(" forward method, overrides the "),js=a("code"),Jd=n("__call__"),Kd=n(" special method."),Yd=c(),v(Nt.$$.fragment),Xd=c(),Ms=a("p"),Qd=n("Example:"),Zd=c(),v(Lo.$$.fragment),fa=c(),gt=a("h2"),Lt=a("a"),As=a("span"),v(Oo.$$.fragment),ec=c(),Is=a("span"),tc=n("Speech2TextForConditionalGeneration"),_a=c(),Se=a("div"),v(Go.$$.fragment),oc=c(),Wo=a("p"),nc=n(`The Speech2Text Model with a language modeling head. Can be used for summarization.
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),lc=c(),Te=a("div"),v(Ro.$$.fragment),hc=c(),vt=a("p"),pc=n("The "),An=a("a"),mc=n("Speech2TextForConditionalGeneration"),uc=n(" forward method, overrides the "),Ds=a("code"),fc=n("__call__"),_c=n(" special method."),gc=c(),v(Ot.$$.fragment),vc=c(),Ns=a("p"),Tc=n("Example:"),bc=c(),v(Ho.$$.fragment),ga=c(),Tt=a("h2"),Gt=a("a"),Ls=a("span"),v(Bo.$$.fragment),xc=c(),Os=a("span"),kc=n("TFSpeech2TextModel"),va=c(),me=a("div"),v(Jo.$$.fragment),yc=c(),Ko=a("p"),wc=n(`The bare Speech2Text Model outputting raw hidden-states without any specific head on top.
...
behavior.`),Cc=c(),v(Wt.$$.fragment),Pc=c(),be=a("div"),v(Qo.$$.fragment),jc=c(),bt=a("p"),Mc=n("The "),Dn=a("a"),Ac=n("TFSpeech2TextModel"),Ic=n(" forward method, overrides the "),Gs=a("code"),Dc=n("__call__"),Nc=n(" special method."),Lc=c(),v(Vt.$$.fragment),Oc=c(),Ws=a("p"),Gc=n("Example:"),Wc=c(),v(Zo.$$.fragment),Ta=c(),xt=a("h2"),Ut=a("a"),Vs=a("span"),v(en.$$.fragment),Vc=c(),Us=a("span"),Uc=n("TFSpeech2TextForConditionalGeneration"),ba=c(),ue=a("div"),v(tn.$$.fragment),Rc=c(),on=a("p"),Hc=n(`The Speech2Text Model with a language modeling head. Can be used for summarization.
...
documentation from `),vn=r(Wn,"A",{href:!0});var Ql=i(vn);Yr=s(Ql,"PretrainedConfig"),Ql.forEach(t),Xr=s(Wn," for more information."),Wn.forEach(t),Qr=l(Ye),hs=r(Ye,"P",{});var Zl=i(hs);Zr=s(Zl,"Example:"),Zl.forEach(t),ei=l(Ye),T(ao.$$.fragment,Ye),Ye.forEach(t),ia=l(o),pt=r(o,"H2",{class:!0});var Ea=i(pt);St=r(Ea,"A",{id:!0,class:!0,href:!0});var eh=i(St);ps=r(eh,"SPAN",{});var th=i(ps);T(ro.$$.fragment,th),th.forEach(t),eh.forEach(t),ti=l(Ea),ms=r(Ea,"SPAN",{});var oh=i(ms);oi=s(oh,"Speech2TextTokenizer"),oh.forEach(t),Ea.forEach(t),da=l(o),V=r(o,"DIV",{class:!0});var ke=i(V);T(io.$$.fragment,ke),ni=l(ke),us=r(ke,"P",{});var nh=i(us);si=s(nh,"Construct an Speech2Text tokenizer."),nh.forEach(t),ai=l(ke),co=r(ke,"P",{});var qa=i(co);ri=s(qa,"This tokenizer inherits from "),Tn=r(qa,"A",{href:!0});var sh=i(Tn);ii=s(sh,"PreTrainedTokenizer"),sh.forEach(t),di=s(qa,` which contains some of the main methods. Users should refer to
the superclass for more information regarding such methods.`),qa.forEach(t),ci=l(ke),$t=r(ke,"DIV",{class:!0});var za=i($t);T(lo.$$.fragment,za),li=l(za),fs=r(za,"P",{});var ah=i(fs);hi=s(ah,"Build model inputs from a sequence by appending eos_token_id."),ah.forEach(t),za.forEach(t),pi=l(ke),Et=r(ke,"DIV",{class:!0});var Fa=i(Et);T(ho.$$.fragment,Fa),mi=l(Fa),po=r(Fa,"P",{});var Ca=i(po);ui=s(Ca,`Retrieve sequence ids from a token list that has no special tokens added. This method is called when adding
special tokens using the tokenizer `),_s=r(Ca,"CODE",{});var rh=i(_s);fi=s(rh,"prepare_for_model"),rh.forEach(t),_i=s(Ca," method."),Ca.forEach(t),Fa.forEach(t),gi=l(ke),Re=r(ke,"DIV",{class:!0});var Vn=i(Re);T(mo.$$.fragment,Vn),vi=l(Vn),bn=r(Vn,"P",{});var hl=i(bn);Ti=s(hl,"Create the token type IDs corresponding to the sequences passed. "),xn=r(hl,"A",{href:!0});var ih=i(xn);bi=s(ih,`What are token type
IDs?`),ih.forEach(t),hl.forEach(t),xi=l(Vn),gs=r(Vn,"P",{});var dh=i(gs);ki=s(dh,"Should be overridden in a subclass if the model has a special way of building those."),dh.forEach(t),Vn.forEach(t),yi=l(ke),kn=r(ke,"DIV",{class:!0});var ch=i(kn);T(uo.$$.fragment,ch),ch.forEach(t),ke.forEach(t),ca=l(o),mt=r(o,"H2",{class:!0});var Pa=i(mt);qt=r(Pa,"A",{id:!0,class:!0,href:!0});var lh=i(qt);vs=r(lh,"SPAN",{});var hh=i(vs);T(fo.$$.fragment,hh),hh.forEach(t),lh.forEach(t),wi=l(Pa),Ts=r(Pa,"SPAN",{});var ph=i(Ts);Si=s(ph,"Speech2TextFeatureExtractor"),ph.forEach(t),Pa.forEach(t),la=l(o),pe=r(o,"DIV",{class:!0});var Xe=i(pe);T(_o.$$.fragment,Xe),$i=l(Xe),bs=r(Xe,"P",{});var mh=i(bs);Ei=s(mh,"Constructs a Speech2Text feature extractor."),mh.forEach(t),qi=l(Xe),go=r(Xe,"P",{});var ja=i(go);zi=s(ja,"This feature extractor inherits from "),yn=r(ja,"A",{href:!0});var uh=i(yn);Fi=s(uh,"Speech2TextFeatureExtractor"),uh.forEach(t),Ci=s(ja,` which contains most of the main methods. Users
...
mean and variance normalization to the extracted features.`),fh.forEach(t),Mi=l(Xe),zt=r(Xe,"DIV",{class:!0});var Ma=i(zt);T(vo.$$.fragment,Ma),Ai=l(Ma),ks=r(Ma,"P",{});var _h=i(ks);Ii=s(_h,"Main method to featurize and prepare for the model one or several sequence(s). sequences."),_h.forEach(t),Ma.forEach(t),Xe.forEach(t),ha=l(o),ut=r(o,"H2",{class:!0});var Aa=i(ut);Ft=r(Aa,"A",{id:!0,class:!0,href:!0});var gh=i(Ft);ys=r(gh,"SPAN",{});var vh=i(ys);T(To.$$.fragment,vh),vh.forEach(t),gh.forEach(t),Di=l(Aa),ws=r(Aa,"SPAN",{});var Th=i(ws);Ni=s(Th,"Speech2TextProcessor"),Th.forEach(t),Aa.forEach(t),pa=l(o),I=r(o,"DIV",{class:!0});var R=i(I);T(bo.$$.fragment,R),Li=l(R),Ss=r(R,"P",{});var bh=i(Ss);Oi=s(bh,`Constructs a Speech2Text processor which wraps a Speech2Text feature extractor and a Speech2Text tokenizer into a
...
information.`),Ge.forEach(t),Zi=l(R),Ct=r(R,"DIV",{class:!0});var Ia=i(Ct);T(ko.$$.fragment,Ia),ed=l(Ia),Oe=r(Ia,"P",{});var Bt=i(Oe);td=s(Bt,`When used in normal mode, this method forwards all its arguments to Speech2TextFeatureExtractor\u2019s
...
information.`),Bt.forEach(t),Ia.forEach(t),ld=l(R),He=r(R,"DIV",{class:!0});var Un=i(He);T(So.$$.fragment,Un),hd=l(Un),zs=r(Un,"P",{});var zh=i(zs);pd=s(zh,"Instantiate a processor associated with a pretrained model."),zh.forEach(t),md=l(Un),T(Pt.$$.fragment,Un),Un.forEach(t),ud=l(R),Be=r(R,"DIV",{class:!0});var Rn=i(Be);T($o.$$.fragment,Rn),fd=l(Rn),Eo=r(Rn,"P",{});var Da=i(Eo);_d=s(Da,`Saves the attributes of this processor (feature extractor, tokenizer\u2026) in the specified directory so that it
can be reloaded using the `),zn=r(Da,"A",{href:!0});var Fh=i(zn);gd=s(Fh,"from_pretrained()"),Fh.forEach(t),vd=s(Da," method."),Da.forEach(t),Td=l(Rn),T(jt.$$.fragment,Rn),Rn.forEach(t),bd=l(R),Mt=r(R,"DIV",{class:!0});var Na=i(Mt);T(qo.$$.fragment,Na),xd=l(Na),zo=r(Na,"P",{});var La=i(zo);kd=s(La,"This method forwards all its arguments to Speech2TextTokenizer\u2019s "),Fn=r(La,"A",{href:!0});var Ch=i(Fn);yd=s(Ch,"batch_decode()"),Ch.forEach(t),wd=s(La,`. Please
...
Speech2Text.`),jh.forEach(t),Wa.forEach(t),R.forEach(t),ma=l(o),ft=r(o,"H2",{class:!0});var Va=i(ft);Dt=r(Va,"A",{id:!0,class:!0,href:!0});var Mh=i(Dt);Cs=r(Mh,"SPAN",{});var Ah=i(Cs);T(jo.$$.fragment,Ah),Ah.forEach(t),Mh.forEach(t),jd=l(Va),Ps=r(Va,"SPAN",{});var Ih=i(Ps);Md=s(Ih,"Speech2TextModel"),Ih.forEach(t),Va.forEach(t),ua=l(o),we=r(o,"DIV",{class:!0});var Jt=i(we);T(Mo.$$.fragment,Jt),Ad=l(Jt),Ao=r(Jt,"P",{});var Ua=i(Ao);Id=s(Ua,`The bare Speech2Text Model outputting raw hidden-states without any specific head on top.
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Ja.forEach(t),lc=l(Kt),Te=r(Kt,"DIV",{class:!0});var Ze=i(Te);T(Ro.$$.fragment,Ze),hc=l(Ze),vt=r(Ze,"P",{});var Bn=i(vt);pc=s(Bn,"The "),An=r(Bn,"A",{href:!0});var Bh=i(An);mc=s(Bh,"Speech2TextForConditionalGeneration"),Bh.forEach(t),uc=s(Bn," forward method, overrides the "),Ds=r(Bn,"CODE",{});var Jh=i(Ds);fc=s(Jh,"__call__"),Jh.forEach(t),_c=s(Bn," special method."),Bn.forEach(t),gc=l(Ze),T(Ot.$$.fragment,Ze),vc=l(Ze),Ns=r(Ze,"P",{});var Kh=i(Ns);Tc=s(Kh,"Example:"),Kh.forEach(t),bc=l(Ze),T(Ho.$$.fragment,Ze),Ze.forEach(t),Kt.forEach(t),ga=l(o),Tt=r(o,"H2",{class:!0});var Ka=i(Tt);Gt=r(Ka,"A",{id:!0,class:!0,href:!0});var Yh=i(Gt);Ls=r(Yh,"SPAN",{});var Xh=i(Ls);T(Bo.$$.fragment,Xh),Xh.forEach(t),Yh.forEach(t),xc=l(Ka),Os=r(Ka,"SPAN",{});var Qh=i(Os);kc=s(Qh,"TFSpeech2TextModel"),Qh.forEach(t),Ka.forEach(t),va=l(o),me=r(o,"DIV",{class:!0});var et=i(me);T(Jo.$$.fragment,et),yc=l(et),Ko=r(et,"P",{});var Ya=i(Ko);wc=s(Ya,`The bare Speech2Text Model outputting raw hidden-states without any specific head on top.
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Xa.forEach(t),Cc=l(et),T(Wt.$$.fragment,et),Pc=l(et),be=r(et,"DIV",{class:!0});var tt=i(be);T(Qo.$$.fragment,tt),jc=l(tt),bt=r(tt,"P",{});var Jn=i(bt);Mc=s(Jn,"The "),Dn=r(Jn,"A",{href:!0});var tp=i(Dn);Ac=s(tp,"TFSpeech2TextModel"),tp.forEach(t),Ic=s(Jn," forward method, overrides the "),Gs=r(Jn,"CODE",{});var op=i(Gs);Dc=s(op,"__call__"),op.forEach(t),Nc=s(Jn," special method."),Jn.forEach(t),Lc=l(tt),T(Vt.$$.fragment,tt),Oc=l(tt),Ws=r(tt,"P",{});var np=i(Ws);Gc=s(np,"Example:"),np.forEach(t),Wc=l(tt),T(Zo.$$.fragment,tt),tt.forEach(t),et.forEach(t),Ta=l(o),xt=r(o,"H2",{class:!0});var Qa=i(xt);Ut=r(Qa,"A",{id:!0,class:!0,href:!0});var sp=i(Ut);Vs=r(sp,"SPAN",{});var ap=i(Vs);T(en.$$.fragment,ap),ap.forEach(t),sp.forEach(t),Vc=l(Qa),Us=r(Qa,"SPAN",{});var rp=i(Us);Uc=s(rp,"TFSpeech2TextForConditionalGeneration"),rp.forEach(t),Qa.forEach(t),ba=l(o),ue=r(o,"DIV",{class:!0});var ot=i(ue);T(tn.$$.fragment,ot),Rc=l(ot),on=r(ot,"P",{});var Za=i(on);Hc=s(Za,`The Speech2Text Model with a language modeling head. Can be used for summarization.
