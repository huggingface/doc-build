...
first positional argument :`),te=l(),x=a("ul"),J=a("li"),ge=n("a single Tensor with "),Q=a("code"),le=n("input_ids"),Y=n(" only and nothing else: "),H=a("code"),oe=n("model(inputs_ids)"),_e=l(),M=a("li"),de=n(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
...
`),R=r(we,"CODE",{});var De=i(R);se=s(De,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),De.forEach(t),we.forEach(t),z.forEach(t)},m(h,G){u(h,p,G),e(p,F),u(h,f,G),u(h,_,G),e(_,v),e(v,T),e(_,g),e(_,j),e(j,ue),u(h,K,G),u(h,E,G),e(E,X),e(E,O),e(O,Z),e(E,me),e(E,W),e(W,fe),e(E,ie),u(h,L,G),u(h,A,G),e(A,ee),u(h,te,G),u(h,x,G),e(x,J),e(J,ge),e(J,Q),e(Q,le),e(J,Y),e(J,H),e(H,oe),e(x,_e),e(x,M),e(M,de),e(M,N),e(N,Te),e(M,ce),e(M,S),e(S,U),e(x,ve),e(x,q),e(q,ye),e(q,R),e(R,se)},d(h){h&&t(p),h&&t(f),h&&t(_),h&&t(K),h&&t(E),h&&t(L),h&&t(A),h&&t(te),h&&t(x)}}}function cg(I){let p,F,f,_,v;return{c(){p=a("p"),F=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=a("code"),_=n("Module"),v=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(T){p=r(T,"P",{});var g=i(p);F=s(g,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=r(g,"CODE",{});var j=i(f);_=s(j,"Module"),j.forEach(t),v=s(g,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),g.forEach(t)},m(T,g){u(T,p,g),e(p,F),e(p,f),e(f,_),e(p,v)},d(T){T&&t(p)}}}function pg(I){let p,F,f,_,v,T,g,j,ue,K,E,X,O,Z,me,W,fe,ie,L,A,ee,te,x,J,ge,Q,le,Y,H,oe,_e,M,de,N,Te,ce,S,U,ve,q,ye,R,se;return{c(){p=a("p"),F=n("TF 2.0 models accepts two formats as inputs:"),f=l(),_=a("ul"),v=a("li"),T=n("having all inputs as keyword arguments (like PyTorch models), or"),g=l(),j=a("li"),ue=n("having all inputs as a list, tuple or dict in the first positional arguments."),K=l(),E=a("p"),X=n("This second option is useful when using "),O=a("code"),Z=n("tf.keras.Model.fit"),me=n(` method which currently requires having all the
tensors in the first argument of the model call function: `),W=a("code"),fe=n("model(inputs)"),ie=n("."),L=l(),A=a("p"),ee=n(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),te=l(),x=a("ul"),J=a("li"),ge=n("a single Tensor with "),Q=a("code"),le=n("input_ids"),Y=n(" only and nothing else: "),H=a("code"),oe=n("model(inputs_ids)"),_e=l(),M=a("li"),de=n(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),N=a("code"),Te=n("model([input_ids, attention_mask])"),ce=n(" or "),S=a("code"),U=n("model([input_ids, attention_mask, token_type_ids])"),ve=l(),q=a("li"),ye=n(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),R=a("code"),se=n('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(h){p=r(h,"P",{});var G=i(p);F=s(G,"TF 2.0 models accepts two formats as inputs:"),G.forEach(t),f=d(h),_=r(h,"UL",{});var V=i(_);v=r(V,"LI",{});var Ae=i(v);T=s(Ae,"having all inputs as keyword arguments (like PyTorch models), or"),Ae.forEach(t),g=d(V),j=r(V,"LI",{});var Ie=i(j);ue=s(Ie,"having all inputs as a list, tuple or dict in the first positional arguments."),Ie.forEach(t),V.forEach(t),K=d(h),E=r(h,"P",{});var C=i(E);X=s(C,"This second option is useful when using "),O=r(C,"CODE",{});var Le=i(O);Z=s(Le,"tf.keras.Model.fit"),Le.forEach(t),me=s(C,` method which currently requires having all the
...
first positional argument :`),Je.forEach(t),te=d(h),x=r(h,"UL",{});var z=i(x);J=r(z,"LI",{});var B=i(J);ge=s(B,"a single Tensor with "),Q=r(B,"CODE",{});var pe=i(Q);le=s(pe,"input_ids"),pe.forEach(t),Y=s(B," only and nothing else: "),H=r(B,"CODE",{});var Fe=i(H);oe=s(Fe,"model(inputs_ids)"),Fe.forEach(t),B.forEach(t),_e=d(z),M=r(z,"LI",{});var D=i(M);de=s(D,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),N=r(D,"CODE",{});var Se=i(N);Te=s(Se,"model([input_ids, attention_mask])"),Se.forEach(t),ce=s(D," or "),S=r(D,"CODE",{});var ke=i(S);U=s(ke,"model([input_ids, attention_mask, token_type_ids])"),ke.forEach(t),D.forEach(t),ve=d(z),q=r(z,"LI",{});var we=i(q);ye=s(we,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),R=r(we,"CODE",{});var De=i(R);se=s(De,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),De.forEach(t),we.forEach(t),z.forEach(t)},m(h,G){u(h,p,G),e(p,F),u(h,f,G),u(h,_,G),e(_,v),e(v,T),e(_,g),e(_,j),e(j,ue),u(h,K,G),u(h,E,G),e(E,X),e(E,O),e(O,Z),e(E,me),e(E,W),e(W,fe),e(E,ie),u(h,L,G),u(h,A,G),e(A,ee),u(h,te,G),u(h,x,G),e(x,J),e(J,ge),e(J,Q),e(Q,le),e(J,Y),e(J,H),e(H,oe),e(x,_e),e(x,M),e(M,de),e(M,N),e(N,Te),e(M,ce),e(M,S),e(S,U),e(x,ve),e(x,q),e(q,ye),e(q,R),e(R,se)},d(h){h&&t(p),h&&t(f),h&&t(_),h&&t(K),h&&t(E),h&&t(L),h&&t(A),h&&t(te),h&&t(x)}}}function hg(I){let p,F,f,_,v;return{c(){p=a("p"),F=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=a("code"),_=n("Module"),v=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(T){p=r(T,"P",{});var g=i(p);F=s(g,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=r(g,"CODE",{});var j=i(f);_=s(j,"Module"),j.forEach(t),v=s(g,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),g.forEach(t)},m(T,g){u(T,p,g),e(p,F),e(p,f),e(f,_),e(p,v)},d(T){T&&t(p)}}}function ug(I){let p,F,f,_,v,T,g,j,ue,K,E,X,O,Z,me,W,fe,ie,L,A,ee,te,x,J,ge,Q,le,Y,H,oe,_e,M,de,N,Te,ce,S,U,ve,q,ye,R,se;return{c(){p=a("p"),F=n("TF 2.0 models accepts two formats as inputs:"),f=l(),_=a("ul"),v=a("li"),T=n("having all inputs as keyword arguments (like PyTorch models), or"),g=l(),j=a("li"),ue=n("having all inputs as a list, tuple or dict in the first positional arguments."),K=l(),E=a("p"),X=n("This second option is useful when using "),O=a("code"),Z=n("tf.keras.Model.fit"),me=n(` method which currently requires having all the
tensors in the first argument of the model call function: `),W=a("code"),fe=n("model(inputs)"),ie=n("."),L=l(),A=a("p"),ee=n(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),te=l(),x=a("ul"),J=a("li"),ge=n("a single Tensor with "),Q=a("code"),le=n("input_ids"),Y=n(" only and nothing else: "),H=a("code"),oe=n("model(inputs_ids)"),_e=l(),M=a("li"),de=n(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),N=a("code"),Te=n("model([input_ids, attention_mask])"),ce=n(" or "),S=a("code"),U=n("model([input_ids, attention_mask, token_type_ids])"),ve=l(),q=a("li"),ye=n(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),R=a("code"),se=n('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(h){p=r(h,"P",{});var G=i(p);F=s(G,"TF 2.0 models accepts two formats as inputs:"),G.forEach(t),f=d(h),_=r(h,"UL",{});var V=i(_);v=r(V,"LI",{});var Ae=i(v);T=s(Ae,"having all inputs as keyword arguments (like PyTorch models), or"),Ae.forEach(t),g=d(V),j=r(V,"LI",{});var Ie=i(j);ue=s(Ie,"having all inputs as a list, tuple or dict in the first positional arguments."),Ie.forEach(t),V.forEach(t),K=d(h),E=r(h,"P",{});var C=i(E);X=s(C,"This second option is useful when using "),O=r(C,"CODE",{});var Le=i(O);Z=s(Le,"tf.keras.Model.fit"),Le.forEach(t),me=s(C,` method which currently requires having all the
...
first positional argument :`),Je.forEach(t),te=d(h),x=r(h,"UL",{});var z=i(x);J=r(z,"LI",{});var B=i(J);ge=s(B,"a single Tensor with "),Q=r(B,"CODE",{});var pe=i(Q);le=s(pe,"input_ids"),pe.forEach(t),Y=s(B," only and nothing else: "),H=r(B,"CODE",{});var Fe=i(H);oe=s(Fe,"model(inputs_ids)"),Fe.forEach(t),B.forEach(t),_e=d(z),M=r(z,"LI",{});var D=i(M);de=s(D,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),N=r(D,"CODE",{});var Se=i(N);Te=s(Se,"model([input_ids, attention_mask])"),Se.forEach(t),ce=s(D," or "),S=r(D,"CODE",{});var ke=i(S);U=s(ke,"model([input_ids, attention_mask, token_type_ids])"),ke.forEach(t),D.forEach(t),ve=d(z),q=r(z,"LI",{});var we=i(q);ye=s(we,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),R=r(we,"CODE",{});var De=i(R);se=s(De,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),De.forEach(t),we.forEach(t),z.forEach(t)},m(h,G){u(h,p,G),e(p,F),u(h,f,G),u(h,_,G),e(_,v),e(v,T),e(_,g),e(_,j),e(j,ue),u(h,K,G),u(h,E,G),e(E,X),e(E,O),e(O,Z),e(E,me),e(E,W),e(W,fe),e(E,ie),u(h,L,G),u(h,A,G),e(A,ee),u(h,te,G),u(h,x,G),e(x,J),e(J,ge),e(J,Q),e(Q,le),e(J,Y),e(J,H),e(H,oe),e(x,_e),e(x,M),e(M,de),e(M,N),e(N,Te),e(M,ce),e(M,S),e(S,U),e(x,ve),e(x,q),e(q,ye),e(q,R),e(R,se)},d(h){h&&t(p),h&&t(f),h&&t(_),h&&t(K),h&&t(E),h&&t(L),h&&t(A),h&&t(te),h&&t(x)}}}function mg(I){let p,F,f,_,v;return{c(){p=a("p"),F=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=a("code"),_=n("Module"),v=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(T){p=r(T,"P",{});var g=i(p);F=s(g,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=r(g,"CODE",{});var j=i(f);_=s(j,"Module"),j.forEach(t),v=s(g,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),g.forEach(t)},m(T,g){u(T,p,g),e(p,F),e(p,f),e(f,_),e(p,v)},d(T){T&&t(p)}}}function fg(I){let p,F,f,_,v,T,g,j,ue,K,E,X,O,Z,me,W,fe,ie,L,A,ee,te,x,J,ge,Q,le,Y,H,oe,_e,M,de,N,Te,ce,S,U,ve,q,ye,R,se;return{c(){p=a("p"),F=n("TF 2.0 models accepts two formats as inputs:"),f=l(),_=a("ul"),v=a("li"),T=n("having all inputs as keyword arguments (like PyTorch models), or"),g=l(),j=a("li"),ue=n("having all inputs as a list, tuple or dict in the first positional arguments."),K=l(),E=a("p"),X=n("This second option is useful when using "),O=a("code"),Z=n("tf.keras.Model.fit"),me=n(` method which currently requires having all the
tensors in the first argument of the model call function: `),W=a("code"),fe=n("model(inputs)"),ie=n("."),L=l(),A=a("p"),ee=n(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),te=l(),x=a("ul"),J=a("li"),ge=n("a single Tensor with "),Q=a("code"),le=n("input_ids"),Y=n(" only and nothing else: "),H=a("code"),oe=n("model(inputs_ids)"),_e=l(),M=a("li"),de=n(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),N=a("code"),Te=n("model([input_ids, attention_mask])"),ce=n(" or "),S=a("code"),U=n("model([input_ids, attention_mask, token_type_ids])"),ve=l(),q=a("li"),ye=n(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),R=a("code"),se=n('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(h){p=r(h,"P",{});var G=i(p);F=s(G,"TF 2.0 models accepts two formats as inputs:"),G.forEach(t),f=d(h),_=r(h,"UL",{});var V=i(_);v=r(V,"LI",{});var Ae=i(v);T=s(Ae,"having all inputs as keyword arguments (like PyTorch models), or"),Ae.forEach(t),g=d(V),j=r(V,"LI",{});var Ie=i(j);ue=s(Ie,"having all inputs as a list, tuple or dict in the first positional arguments."),Ie.forEach(t),V.forEach(t),K=d(h),E=r(h,"P",{});var C=i(E);X=s(C,"This second option is useful when using "),O=r(C,"CODE",{});var Le=i(O);Z=s(Le,"tf.keras.Model.fit"),Le.forEach(t),me=s(C,` method which currently requires having all the
...
first positional argument :`),Je.forEach(t),te=d(h),x=r(h,"UL",{});var z=i(x);J=r(z,"LI",{});var B=i(J);ge=s(B,"a single Tensor with "),Q=r(B,"CODE",{});var pe=i(Q);le=s(pe,"input_ids"),pe.forEach(t),Y=s(B," only and nothing else: "),H=r(B,"CODE",{});var Fe=i(H);oe=s(Fe,"model(inputs_ids)"),Fe.forEach(t),B.forEach(t),_e=d(z),M=r(z,"LI",{});var D=i(M);de=s(D,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),N=r(D,"CODE",{});var Se=i(N);Te=s(Se,"model([input_ids, attention_mask])"),Se.forEach(t),ce=s(D," or "),S=r(D,"CODE",{});var ke=i(S);U=s(ke,"model([input_ids, attention_mask, token_type_ids])"),ke.forEach(t),D.forEach(t),ve=d(z),q=r(z,"LI",{});var we=i(q);ye=s(we,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),R=r(we,"CODE",{});var De=i(R);se=s(De,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),De.forEach(t),we.forEach(t),z.forEach(t)},m(h,G){u(h,p,G),e(p,F),u(h,f,G),u(h,_,G),e(_,v),e(v,T),e(_,g),e(_,j),e(j,ue),u(h,K,G),u(h,E,G),e(E,X),e(E,O),e(O,Z),e(E,me),e(E,W),e(W,fe),e(E,ie),u(h,L,G),u(h,A,G),e(A,ee),u(h,te,G),u(h,x,G),e(x,J),e(J,ge),e(J,Q),e(Q,le),e(J,Y),e(J,H),e(H,oe),e(x,_e),e(x,M),e(M,de),e(M,N),e(N,Te),e(M,ce),e(M,S),e(S,U),e(x,ve),e(x,q),e(q,ye),e(q,R),e(R,se)},d(h){h&&t(p),h&&t(f),h&&t(_),h&&t(K),h&&t(E),h&&t(L),h&&t(A),h&&t(te),h&&t(x)}}}function gg(I){let p,F,f,_,v;return{c(){p=a("p"),F=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),f=a("code"),_=n("Module"),v=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(T){p=r(T,"P",{});var g=i(p);F=s(g,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=r(g,"CODE",{});var j=i(f);_=s(j,"Module"),j.forEach(t),v=s(g,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
the latter silently ignores them.`)},l(T){p=r(T,"P",{});var g=i(p);F=s(g,"Although the recipe for forward pass needs to be defined within this function, one should call the "),f=r(g,"CODE",{});var j=i(f);_=s(j,"Module"),j.forEach(t),v=s(g,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),g.forEach(t)},m(T,g){u(T,p,g),e(p,F),e(p,f),e(f,_),e(p,v)},d(T){T&&t(p)}}}function vg(I){let p,F,f,_,v,T,g,j,ue,K,E,X,O,Z,me,W,fe,ie,L,A,ee,te,x,J,ge,Q,le,Y,H,oe,_e,M,de,N,Te,ce,S,U,ve,q,ye,R,se,h,G,V,Ae,Ie,C,Le,Ne,Je,z,B,pe,Fe,D,Se,ke,we,De,Ks,pt,Ai,xo,Ii,Li,Xs,Ni,Si,Ys,Di,Oi,Mr,$t,Kt,Zs,Jo,Wi,ea,Ui,qr,Xt,Bi,ms,Qi,Hi,Cr,Mo,zr,fs,Ri,Ar,qo,Ir,Ft,Yt,ta,Co,Vi,oa,Ki,Lr,Ye,zo,Xi,Ze,Yi,gs,Zi,el,Ao,tl,ol,_s,nl,sl,Ts,al,rl,il,na,ll,dl,Io,Nr,jt,Zt,sa,Lo,cl,aa,pl,Sr,ht,No,hl,So,ul,Do,ml,fl,gl,Oe,Oo,_l,Gt,Tl,vs,vl,yl,ra,kl,wl,bl,eo,Pl,ia,$l,Fl,Wo,Dr,Et,to,la,Uo,jl,da,Gl,Or,et,Bo,El,ca,xl,Jl,Qo,Ml,Ho,ql,Cl,zl,We,Ro,Al,xt,Il,ys,Ll,Nl,pa,Sl,Dl,Ol,oo,Wl,ha,Ul,Bl,Vo,Wr,Jt,no,ua,Ko,Ql,ma,Hl,Ur,je,Xo,Rl,fa,Vl,Kl,ks,ws,Xl,Yl,Zl,tt,ed,ga,td,od,_a,nd,sd,Ta,ad,rd,va,id,ld,dd,Yo,cd,Zo,pd,hd,ud,ne,en,md,Mt,fd,bs,gd,_d,ya,Td,vd,yd,so,kd,ka,wd,bd,tn,Pd,on,$d,wa,Fd,jd,nn,Gd,sn,Br,qt,ao,ba,an,Ed,Pa,xd,Qr,ot,rn,Jd,Ct,Md,$a,qd,Cd,Fa,zd,Ad,Id,ln,Ld,dn,Nd,Sd,Dd,Me,cn,Od,zt,Wd,Ps,Ud,Bd,ja,Qd,Hd,Rd,ro,Vd,Ga,Kd,Xd,pn,Yd,hn,Hr,At,io,Ea,un,Zd,xa,ec,Rr,Ge,mn,tc,Ja,oc,nc,fn,sc,$s,ac,rc,ic,gn,lc,_n,dc,cc,pc,lo,hc,Ue,Tn,uc,It,mc,Fs,fc,gc,Ma,_c,Tc,vc,co,yc,qa,kc,wc,vn,Vr,Lt,po,Ca,yn,bc,za,Pc,Kr,Ee,kn,$c,Aa,Fc,jc,wn,Gc,js,Ec,xc,Jc,bn,Mc,Pn,qc,Cc,zc,ho,Ac,Be,$n,Ic,Nt,Lc,Gs,Nc,Sc,Ia,Dc,Oc,Wc,uo,Uc,La,Bc,Qc,Fn,Xr,St,mo,Na,jn,Hc,Sa,Rc,Yr,ae,Gn,Vc,Da,Kc,Xc,Es,xs,Yc,Zc,ep,nt,tp,Oa,op,np,Wa,sp,ap,Ua,rp,ip,Ba,lp,dp,cp,En,pp,Js,hp,up,mp,xn,fp,Jn,gp,_p,Tp,fo,vp,qe,Mn,yp,Dt,kp,Ms,wp,bp,Qa,Pp,$p,Fp,go,jp,Ha,Gp,Ep,qn,xp,Cn,Zr,Ot,_o,Ra,zn,Jp,Va,Mp,ei,xe,An,qp,Wt,Cp,Ka,zp,Ap,Xa,Ip,Lp,Np,In,Sp,qs,Dp,Op,Wp,Ln,Up,Nn,Bp,Qp,Hp,To,Rp,Ce,Sn,Vp,Ut,Kp,Cs,Xp,Yp,Ya,Zp,eh,th,vo,oh,Za,nh,sh,Dn,ah,On,ti,Bt,yo,er,Wn,rh,tr,ih,oi,be,Un,lh,or,dh,ch,Bn,ph,zs,hh,uh,mh,Qn,fh,Hn,gh,_h,Th,nr,vh,yh,ut,sr,Rn,kh,wh,ar,Vn,bh,Ph,rr,Kn,$h,Fh,ir,Xn,jh,Gh,Qe,Yn,Eh,Qt,xh,lr,Jh,Mh,dr,qh,Ch,zh,ko,Ah,cr,Ih,Lh,Zn,ni,Ht,wo,pr,es,Nh,hr,Sh,si,Pe,ts,Dh,ur,Oh,Wh,os,Uh,As,Bh,Qh,Hh,ns,Rh,ss,Vh,Kh,Xh,mr,Yh,Zh,mt,fr,as,eu,tu,gr,rs,ou,nu,_r,is,su,au,Tr,ls,ru,iu,He,ds,lu,Rt,du,vr,cu,pu,yr,hu,uu,mu,bo,fu,kr,gu,_u,cs,ai;return T=new Xe({}),Z=new Xe({}),z=new he({props:{code:`from transformers import GPTJForCausalLM
import torch
...
Whether or not the model should return the last key/values attentions (not used by all models).`,name:"use_cache"}],source:"https://github.com/huggingface/transformers/blob/v4.18.0/src/transformers/models/gptj/configuration_gptj.py#L33"}}),Io=new he({props:{code:`from transformers import GPTJModel, GPTJConfig
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),Uo=new Xe({}),Bo=new re({props:{name:"class transformers.GPTJForCausalLM",anchor:"transformers.GPTJForCausalLM",parameters:[{name:"config",val:""}],parametersDescription:[{anchor:"transformers.GPTJForCausalLM.config",description:`<strong>config</strong> (<a href="/docs/transformers/v4.18.0/en/model_doc/gptj#transformers.GPTJConfig">GPTJConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/v4.18.0/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/v4.18.0/src/transformers/models/gptj/modeling_gptj.py#L700"}}),Ro=new re({props:{name:"forward",anchor:"transformers.GPTJForCausalLM.forward",parameters:[{name:"input_ids",val:" = None"},{name:"past_key_values",val:" = None"},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"labels",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],parametersDescription:[{anchor:"transformers.GPTJForCausalLM.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <code>GPTJTokenizer</code>. See <a href="/docs/transformers/v4.18.0/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/v4.18.0/en/model_doc/wav2vec2_phoneme#transformers.Wav2Vec2PhonemeCTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/v4.18.0/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/v4.18.0/src/transformers/models/gptj/modeling_gptj.py#L1001"}}),cn=new re({props:{name:"forward",anchor:"transformers.GPTJForQuestionAnswering.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:" = None"},{name:"position_ids",val:" = None"},{name:"head_mask",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"start_positions",val:" = None"},{name:"end_positions",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],parametersDescription:[{anchor:"transformers.GPTJForQuestionAnswering.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <code>GPTJTokenizer</code>. See <a href="/docs/transformers/v4.18.0/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/v4.18.0/en/model_doc/wav2vec2_phoneme#transformers.Wav2Vec2PhonemeCTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
causal language model trained on `),J=a("a"),ge=n("the Pile"),Q=n(" dataset."),le=l(),Y=a("p"),H=n("This model was contributed by "),oe=a("a"),_e=n("Stella Biderman"),M=n("."),de=l(),N=a("p"),Te=n("Tips:"),ce=l(),S=a("ul"),U=a("li"),ve=n("To load "),q=a("a"),ye=n("GPT-J"),R=n(` in float32 one would need at least 2x model size CPU
...
12.1GB of CPU RAM to load the model.`),Je=l(),y(z.$$.fragment),B=l(),pe=a("ul"),Fe=a("li"),D=a("p"),Se=n(`The model should fit on 16GB GPU for inference. For training/fine-tuning it would take much more GPU RAM. Adam
...
`),Xs=a("code"),Ni=n("<|extratoken_1|>... <|extratoken_143|>"),Si=n(", so the "),Ys=a("code"),Di=n("vocab_size"),Oi=n(" of tokenizer also becomes 50400."),Mr=l(),$t=a("h3"),Kt=a("a"),Zs=a("span"),y(Jo.$$.fragment),Wi=l(),ea=a("span"),Ui=n("Generation"),qr=l(),Xt=a("p"),Bi=n("The "),ms=a("a"),Qi=n("generate()"),Hi=n(` method can be used to generate text using GPT-J
...
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),ud=l(),ne=a("div"),y(en.$$.fragment),md=l(),Mt=a("p"),fd=n("The "),bs=a("a"),gd=n("GPTJForSequenceClassification"),_d=n(" forward method, overrides the "),ya=a("code"),Td=n("__call__"),vd=n(" special method."),yd=l(),y(so.$$.fragment),kd=l(),ka=a("p"),wd=n("Example of single-label classification:"),bd=l(),y(tn.$$.fragment),Pd=l(),y(on.$$.fragment),$d=l(),wa=a("p"),Fd=n("Example of multi-label classification:"),jd=l(),y(nn.$$.fragment),Gd=l(),y(sn.$$.fragment),Br=l(),qt=a("h2"),ao=a("a"),ba=a("span"),y(an.$$.fragment),Ed=l(),Pa=a("span"),xd=n("GPTJForQuestionAnswering"),Qr=l(),ot=a("div"),y(rn.$$.fragment),Jd=l(),Ct=a("p"),Md=n(`The GPT-J Model transformer with a span classification head on top for extractive question-answering tasks like
...
each row of the batch).`),cp=l(),En=a("p"),pp=n("This model inherits from "),Js=a("a"),hp=n("TFPreTrainedModel"),up=n(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),mp=l(),xn=a("p"),fp=n("This model is also a "),Jn=a("a"),gp=n("tf.keras.Model"),_p=n(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Tp=l(),y(fo.$$.fragment),vp=l(),qe=a("div"),y(Mn.$$.fragment),yp=l(),Dt=a("p"),kp=n("The "),Ms=a("a"),wp=n("TFGPTJForSequenceClassification"),bp=n(" forward method, overrides the "),Qa=a("code"),Pp=n("__call__"),$p=n(" special method."),Fp=l(),y(go.$$.fragment),jp=l(),Ha=a("p"),Gp=n("Example:"),Ep=l(),y(qn.$$.fragment),xp=l(),y(Cn.$$.fragment),Zr=l(),Ot=a("h2"),_o=a("a"),Ra=a("span"),y(zn.$$.fragment),Jp=l(),Va=a("span"),Mp=n("TFGPTJForQuestionAnswering"),ei=l(),xe=a("div"),y(An.$$.fragment),qp=l(),Wt=a("p"),Cp=n(`The GPT-J Model transformer with a span classification head on top for extractive question-answering tasks like
...
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),Th=l(),nr=a("p"),vh=n("Finally, this model supports inherent JAX features such as:"),yh=l(),ut=a("ul"),sr=a("li"),Rn=a("a"),kh=n("Just-In-Time (JIT) compilation"),wh=l(),ar=a("li"),Vn=a("a"),bh=n("Automatic Differentiation"),Ph=l(),rr=a("li"),Kn=a("a"),$h=n("Vectorization"),Fh=l(),ir=a("li"),Xn=a("a"),jh=n("Parallelization"),Gh=l(),Qe=a("div"),y(Yn.$$.fragment),Eh=l(),Qt=a("p"),xh=n("The "),lr=a("code"),Jh=n("FlaxGPTJPreTrainedModel"),Mh=n(" forward method, overrides the "),dr=a("code"),qh=n("__call__"),Ch=n(" special method."),zh=l(),y(ko.$$.fragment),Ah=l(),cr=a("p"),Ih=n("Example:"),Lh=l(),y(Zn.$$.fragment),ni=l(),Ht=a("h2"),wo=a("a"),pr=a("span"),y(es.$$.fragment),Nh=l(),hr=a("span"),Sh=n("FlaxGPTJForCausalLM"),si=l(),Pe=a("div"),y(ts.$$.fragment),Dh=l(),ur=a("p"),Oh=n("The GPTJ Model transformer with a language modeling head on top."),Wh=l(),os=a("p"),Uh=n("This model inherits from "),As=a("a"),Bh=n("FlaxPreTrainedModel"),Qh=n(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
causal language model trained on `),J=r(Vt,"A",{href:!0,rel:!0});var Er=i(J);ge=s(Er,"the Pile"),Er.forEach(t),Q=s(Vt," dataset."),Vt.forEach(t),le=d(o),Y=r(o,"P",{});var us=i(Y);H=s(us,"This model was contributed by "),oe=r(us,"A",{href:!0,rel:!0});var xr=i(oe);_e=s(xr,"Stella Biderman"),xr.forEach(t),M=s(us,"."),us.forEach(t),de=d(o),N=r(o,"P",{});var Jr=i(N);Te=s(Jr,"Tips:"),Jr.forEach(t),ce=d(o),S=r(o,"UL",{});var ku=i(S);U=r(ku,"LI",{});var ft=i(U);ve=s(ft,"To load "),q=r(ft,"A",{href:!0,rel:!0});var wu=i(q);ye=s(wu,"GPT-J"),wu.forEach(t),R=s(ft,` in float32 one would need at least 2x model size CPU
RAM: 1x for initial weights and another 1x to load the checkpoint. So for GPT-J it would take at least 48GB of CPU
...
the fp16 weights, which could be used to further minimize the RAM usage. Combining all this it should take roughly
12.1GB of CPU RAM to load the model.`),ft.forEach(t),ku.forEach(t),Je=d(o),k(z.$$.fragment,o),B=d(o),pe=r(o,"UL",{});var ri=i(pe);Fe=r(ri,"LI",{});var Fu=i(Fe);D=r(Fu,"P",{});var Tu=i(D);Se=s(Tu,`The model should fit on 16GB GPU for inference. For training/fine-tuning it would take much more GPU RAM. Adam
optimizer for example makes four copies of the model: model, gradients, average and squared average of the gradients.
So it would need at least 4x model size GPU memory, even with mixed precision as gradient updates are in fp32. This
is not including the activations and data batches, which would again require some more GPU RAM. So one should explore
solutions such as DeepSpeed, to train/fine-tune the model. Another option is to use the original codebase to
...
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),_i.forEach(t),Dd=d(jo),Me=r(jo,"DIV",{class:!0});var at=i(Me);k(cn.$$.fragment,at),Od=d(at),zt=r(at,"P",{});var Os=i(zt);Wd=s(Os,"The "),Ps=r(Os,"A",{href:!0});var Fm=i(Ps);Ud=s(Fm,"GPTJForQuestionAnswering"),Fm.forEach(t),Bd=s(Os," forward method, overrides the "),ja=r(Os,"CODE",{});var jm=i(ja);Qd=s(jm,"__call__"),jm.forEach(t),Hd=s(Os," special method."),Os.forEach(t),Rd=d(at),k(ro.$$.fragment,at),Vd=d(at),Ga=r(at,"P",{});var Gm=i(Ga);Kd=s(Gm,"Example:"),Gm.forEach(t),Xd=d(at),k(pn.$$.fragment,at),Yd=d(at),k(hn.$$.fragment,at),at.forEach(t),jo.forEach(t),Hr=d(o),At=r(o,"H2",{class:!0});var Ti=i(At);io=r(Ti,"A",{id:!0,class:!0,href:!0});var Em=i(io);Ea=r(Em,"SPAN",{});var xm=i(Ea);k(un.$$.fragment,xm),xm.forEach(t),Em.forEach(t),Zd=d(Ti),xa=r(Ti,"SPAN",{});var Jm=i(xa);ec=s(Jm,"TFGPTJModel"),Jm.forEach(t),Ti.forEach(t),Rr=d(o),Ge=r(o,"DIV",{class:!0});var rt=i(Ge);k(mn.$$.fragment,rt),tc=d(rt),Ja=r(rt,"P",{});var Mm=i(Ja);oc=s(Mm,"The bare GPT-J Model transformer outputting raw hidden-states without any specific head on top."),Mm.forEach(t),nc=d(rt),fn=r(rt,"P",{});var vi=i(fn);sc=s(vi,"This model inherits from "),$s=r(vi,"A",{href:!0});var qm=i($s);ac=s(qm,"TFPreTrainedModel"),qm.forEach(t),rc=s(vi,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
each row of the batch).`),wt.forEach(t),cp=d(ze),En=r(ze,"P",{});var $i=i(En);pp=s($i,"This model inherits from "),Js=r($i,"A",{href:!0});var of=i(Js);hp=s(of,"TFPreTrainedModel"),of.forEach(t),up=s($i,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),$i.forEach(t),mp=d(ze),xn=r(ze,"P",{});var Fi=i(xn);fp=s(Fi,"This model is also a "),Jn=r(Fi,"A",{href:!0,rel:!0});var nf=i(Jn);gp=s(nf,"tf.keras.Model"),nf.forEach(t),_p=s(Fi,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Fi.forEach(t),Tp=d(ze),k(fo.$$.fragment,ze),vp=d(ze),qe=r(ze,"DIV",{class:!0});var lt=i(qe);k(Mn.$$.fragment,lt),yp=d(lt),Dt=r(lt,"P",{});var Bs=i(Dt);kp=s(Bs,"The "),Ms=r(Bs,"A",{href:!0});var sf=i(Ms);wp=s(sf,"TFGPTJForSequenceClassification"),sf.forEach(t),bp=s(Bs," forward method, overrides the "),Qa=r(Bs,"CODE",{});var af=i(Qa);Pp=s(af,"__call__"),af.forEach(t),$p=s(Bs," special method."),Bs.forEach(t),Fp=d(lt),k(go.$$.fragment,lt),jp=d(lt),Ha=r(lt,"P",{});var rf=i(Ha);Gp=s(rf,"Example:"),rf.forEach(t),Ep=d(lt),k(qn.$$.fragment,lt),xp=d(lt),k(Cn.$$.fragment,lt),lt.forEach(t),ze.forEach(t),Zr=d(o),Ot=r(o,"H2",{class:!0});var ji=i(Ot);_o=r(ji,"A",{id:!0,class:!0,href:!0});var lf=i(_o);Ra=r(lf,"SPAN",{});var df=i(Ra);k(zn.$$.fragment,df),df.forEach(t),lf.forEach(t),Jp=d(ji),Va=r(ji,"SPAN",{});var cf=i(Va);Mp=s(cf,"TFGPTJForQuestionAnswering"),cf.forEach(t),ji.forEach(t),ei=d(o),xe=r(o,"DIV",{class:!0});var dt=i(xe);k(An.$$.fragment,dt),qp=d(dt),Wt=r(dt,"P",{});var Qs=i(Wt);Cp=s(Qs,`The GPT-J Model transformer with a span classification head on top for extractive question-answering tasks like
