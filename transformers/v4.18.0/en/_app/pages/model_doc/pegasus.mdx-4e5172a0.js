import{S as jv,i as Sv,s as Ov,e as n,k as d,w as m,t as r,M as Av,c as s,d as t,m as l,a,x as g,h as i,b as c,F as e,g as p,y as f,q as _,o as v,B as k,v as Iv}from"../../chunks/vendor-6b77c823.js";import{T as $o}from"../../chunks/Tip-39098574.js";import{D as C}from"../../chunks/Docstring-17b815d9.js";import{C as Se}from"../../chunks/CodeBlock-3a8b25a8.js";import{I as Z}from"../../chunks/IconCopyLink-7a11ce68.js";function Lv(B){let h,z,y,P,x;return{c(){h=n("p"),z=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),y=n("code"),P=r("Module"),x=r(`
...
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),T.forEach(t)},m(w,T){p(w,h,T),e(h,z),e(h,y),e(y,P),e(h,x)},d(w){w&&t(h)}}}function Gv(B){let h,z,y,P,x;return{c(){h=n("p"),z=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),y=n("code"),P=r("Module"),x=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(w){h=s(w,"P",{});var T=a(h);z=i(T,"Although the recipe for forward pass needs to be defined within this function, one should call the "),y=s(T,"CODE",{});var F=a(y);P=i(F,"Module"),F.forEach(t),x=i(T,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),T.forEach(t)},m(w,T){p(w,h,T),e(h,z),e(h,y),e(y,P),e(h,x)},d(w){w&&t(h)}}}function Nv(B){let h,z,y,P,x,w,T,F,Oe,me,q,Pe,ae,Ae,re,ie,Ie,Ce,N,O,xe,H,j,S,Le,Y,ee,Ge,D,Ne,De,A,ge,de,Me,te,K,Ue,We,U,Be,oe,V;return{c(){h=n("p"),z=r("TF 2.0 models accepts two formats as inputs:"),y=d(),P=n("ul"),x=n("li"),w=r("having all inputs as keyword arguments (like PyTorch models), or"),T=d(),F=n("li"),Oe=r("having all inputs as a list, tuple or dict in the first positional arguments."),me=d(),q=n("p"),Pe=r("This second option is useful when using "),ae=n("code"),Ae=r("tf.keras.Model.fit"),re=r(` method which currently requires having all the
...
`),oe=s(R,"CODE",{});var vt=a(oe);V=i(vt,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),vt.forEach(t),R.forEach(t),I.forEach(t)},m(b,$){p(b,h,$),e(h,z),p(b,y,$),p(b,P,$),e(P,x),e(x,w),e(P,T),e(P,F),e(F,Oe),p(b,me,$),p(b,q,$),e(q,Pe),e(q,ae),e(ae,Ae),e(q,re),e(q,ie),e(ie,Ie),e(q,Ce),p(b,N,$),p(b,O,$),e(O,xe),p(b,H,$),p(b,j,$),e(j,S),e(S,Le),e(S,Y),e(Y,ee),e(S,Ge),e(S,D),e(D,Ne),e(j,De),e(j,A),e(A,ge),e(A,de),e(de,Me),e(A,te),e(A,K),e(K,Ue),e(j,We),e(j,U),e(U,Be),e(U,oe),e(oe,V)},d(b){b&&t(h),b&&t(y),b&&t(P),b&&t(me),b&&t(q),b&&t(N),b&&t(O),b&&t(H),b&&t(j)}}}function Dv(B){let h,z,y,P,x;return{c(){h=n("p"),z=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),y=n("code"),P=r("Module"),x=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(w){h=s(w,"P",{});var T=a(h);z=i(T,"Although the recipe for forward pass needs to be defined within this function, one should call the "),y=s(T,"CODE",{});var F=a(y);P=i(F,"Module"),F.forEach(t),x=i(T,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),T.forEach(t)},m(w,T){p(w,h,T),e(h,z),e(h,y),e(y,P),e(h,x)},d(w){w&&t(h)}}}function Uv(B){let h,z,y,P,x,w,T,F,Oe,me,q,Pe,ae,Ae,re,ie,Ie,Ce,N,O,xe,H,j,S,Le,Y,ee,Ge,D,Ne,De,A,ge,de,Me,te,K,Ue,We,U,Be,oe,V;return{c(){h=n("p"),z=r("TF 2.0 models accepts two formats as inputs:"),y=d(),P=n("ul"),x=n("li"),w=r("having all inputs as keyword arguments (like PyTorch models), or"),T=d(),F=n("li"),Oe=r("having all inputs as a list, tuple or dict in the first positional arguments."),me=d(),q=n("p"),Pe=r("This second option is useful when using "),ae=n("code"),Ae=r("tf.keras.Model.fit"),re=r(` method which currently requires having all the
tensors in the first argument of the model call function: `),ie=n("code"),Ie=r("model(inputs)"),Ce=r("."),N=d(),O=n("p"),xe=r(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),H=d(),j=n("ul"),S=n("li"),Le=r("a single Tensor with "),Y=n("code"),ee=r("input_ids"),Ge=r(" only and nothing else: "),D=n("code"),Ne=r("model(input_ids)"),De=d(),A=n("li"),ge=r(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),de=n("code"),Me=r("model([input_ids, attention_mask])"),te=r(" or "),K=n("code"),Ue=r("model([input_ids, attention_mask, token_type_ids])"),We=d(),U=n("li"),Be=r(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),oe=n("code"),V=r('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(b){h=s(b,"P",{});var $=a(h);z=i($,"TF 2.0 models accepts two formats as inputs:"),$.forEach(t),y=l(b),P=s(b,"UL",{});var ze=a(P);x=s(ze,"LI",{});var mt=a(x);w=i(mt,"having all inputs as keyword arguments (like PyTorch models), or"),mt.forEach(t),T=l(ze),F=s(ze,"LI",{});var Fe=a(F);Oe=i(Fe,"having all inputs as a list, tuple or dict in the first positional arguments."),Fe.forEach(t),ze.forEach(t),me=l(b),q=s(b,"P",{});var Q=a(q);Pe=i(Q,"This second option is useful when using "),ae=s(Q,"CODE",{});var gt=a(ae);Ae=i(gt,"tf.keras.Model.fit"),gt.forEach(t),re=i(Q,` method which currently requires having all the
...
first positional argument :`),le.forEach(t),H=l(b),j=s(b,"UL",{});var I=a(j);S=s(I,"LI",{});var J=a(S);Le=i(J,"a single Tensor with "),Y=s(J,"CODE",{});var $e=a(Y);ee=i($e,"input_ids"),$e.forEach(t),Ge=i(J," only and nothing else: "),D=s(J,"CODE",{});var ft=a(D);Ne=i(ft,"model(input_ids)"),ft.forEach(t),J.forEach(t),De=l(I),A=s(I,"LI",{});var X=a(A);ge=i(X,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),de=s(X,"CODE",{});var _t=a(de);Me=i(_t,"model([input_ids, attention_mask])"),_t.forEach(t),te=i(X," or "),K=s(X,"CODE",{});var Qe=a(K);Ue=i(Qe,"model([input_ids, attention_mask, token_type_ids])"),Qe.forEach(t),X.forEach(t),We=l(I),U=s(I,"LI",{});var R=a(U);Be=i(R,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),oe=s(R,"CODE",{});var vt=a(oe);V=i(vt,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),vt.forEach(t),R.forEach(t),I.forEach(t)},m(b,$){p(b,h,$),e(h,z),p(b,y,$),p(b,P,$),e(P,x),e(x,w),e(P,T),e(P,F),e(F,Oe),p(b,me,$),p(b,q,$),e(q,Pe),e(q,ae),e(ae,Ae),e(q,re),e(q,ie),e(ie,Ie),e(q,Ce),p(b,N,$),p(b,O,$),e(O,xe),p(b,H,$),p(b,j,$),e(j,S),e(S,Le),e(S,Y),e(Y,ee),e(S,Ge),e(S,D),e(D,Ne),e(j,De),e(j,A),e(A,ge),e(A,de),e(de,Me),e(A,te),e(A,K),e(K,Ue),e(j,We),e(j,U),e(U,Be),e(U,oe),e(oe,V)},d(b){b&&t(h),b&&t(y),b&&t(P),b&&t(me),b&&t(q),b&&t(N),b&&t(O),b&&t(H),b&&t(j)}}}function Wv(B){let h,z,y,P,x;return{c(){h=n("p"),z=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),y=n("code"),P=r("Module"),x=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(w){h=s(w,"P",{});var T=a(h);z=i(T,"Although the recipe for forward pass needs to be defined within this function, one should call the "),y=s(T,"CODE",{});var F=a(y);P=i(F,"Module"),F.forEach(t),x=i(T,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),T.forEach(t)},m(w,T){p(w,h,T),e(h,z),e(h,y),e(y,P),e(h,x)},d(w){w&&t(h)}}}function Bv(B){let h,z,y,P,x;return{c(){h=n("p"),z=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),y=n("code"),P=r("Module"),x=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(w){h=s(w,"P",{});var T=a(h);z=i(T,"Although the recipe for forward pass needs to be defined within this function, one should call the "),y=s(T,"CODE",{});var F=a(y);P=i(F,"Module"),F.forEach(t),x=i(T,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),T.forEach(t)},m(w,T){p(w,h,T),e(h,z),e(h,y),e(y,P),e(h,x)},d(w){w&&t(h)}}}function Vv(B){let h,z,y,P,x;return{c(){h=n("p"),z=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),y=n("code"),P=r("Module"),x=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(w){h=s(w,"P",{});var T=a(h);z=i(T,"Although the recipe for forward pass needs to be defined within this function, one should call the "),y=s(T,"CODE",{});var F=a(y);P=i(F,"Module"),F.forEach(t),x=i(T,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),T.forEach(t)},m(w,T){p(w,h,T),e(h,z),e(h,y),e(y,P),e(h,x)},d(w){w&&t(h)}}}function Rv(B){let h,z,y,P,x,w,T,F,Oe,me,q,Pe,ae,Ae,re,ie,Ie,Ce,N,O,xe,H,j,S,Le,Y,ee,Ge,D,Ne,De,A,ge,de,Me,te,K,Ue,We,U,Be,oe,V,b,$,ze,mt,Fe,Q,gt,Ke,le,I,J,$e,ft,X,_t,Qe,R,vt,qo,Yd,el,ca,tl,ol,Ci,fe,pa,nl,sl,ua,al,rl,ha,il,dl,Eo,ll,Co,cl,pl,ul,Bt,Mo,hl,ml,jo,gl,fl,Mi,kt,Vt,ma,So,_l,ga,vl,ji,Je,Rt,Oo,kl,bl,Ao,yl,Tl,wl,fa,Pl,xl,_a,zl,Si,bt,Ht,va,Io,Fl,ka,$l,Oi,_e,ba,ya,ql,El,Ta,xs,Cl,zs,Ml,jl,Lo,wa,Sl,Ol,yt,Pa,Al,Il,xa,Ll,Gl,Go,Nl,za,Dl,Ul,Wl,Fa,Ve,Bl,$a,Vl,Rl,qa,Hl,Kl,Ea,Ql,Jl,Xl,Ca,Tt,Zl,No,Yl,ec,Ma,tc,oc,Ai,wt,Kt,ja,Do,nc,Sa,sc,Ii,Uo,Li,Pt,Qt,Oa,Wo,ac,Aa,rc,Gi,ce,Bo,ic,xt,dc,Fs,lc,cc,Vo,pc,uc,hc,zt,mc,$s,gc,fc,qs,_c,vc,kc,Ia,bc,yc,Ro,Ni,Ft,Jt,La,Ho,Tc,Ga,wc,Di,Xt,Pc,Na,xc,zc,Ui,W,Ko,Fc,Qo,$c,Jo,qc,Ec,Cc,Xo,Mc,Es,jc,Sc,Oc,je,Zo,Ac,Yo,Ic,Da,Lc,Gc,Nc,en,Cs,Dc,Ua,Uc,Wc,tn,Bc,Wa,Vc,Rc,Hc,Ba,Kc,Qc,Zt,on,Jc,Va,Xc,Zc,Yt,nn,Yc,Ra,ep,tp,eo,sn,op,Ha,np,Wi,$t,to,Ka,an,sp,Qa,ap,Bi,pe,rn,rp,qt,ip,Ja,dp,lp,dn,cp,pp,up,ln,hp,Ms,mp,gp,fp,Xe,cn,_p,Xa,vp,kp,pn,js,bp,Za,yp,Tp,un,wp,Ya,Pp,xp,zp,oo,hn,Fp,er,$p,Vi,Et,no,tr,mn,qp,or,Ep,Ri,qe,gn,Cp,fn,Mp,Ss,jp,Sp,Op,_n,Ap,vn,Ip,Lp,Gp,ve,kn,Np,Ct,Dp,Os,Up,Wp,nr,Bp,Vp,Rp,so,Hp,sr,Kp,Qp,bn,Hi,Mt,ao,ar,yn,Jp,rr,Xp,Ki,Ee,Tn,Zp,wn,Yp,As,eu,tu,ou,Pn,nu,xn,su,au,ru,ke,zn,iu,jt,du,Is,lu,cu,ir,pu,uu,hu,ro,mu,dr,gu,fu,Fn,Qi,St,io,lr,$n,_u,cr,vu,Ji,Ot,qn,ku,Ze,En,bu,pr,yu,Tu,Cn,Xi,At,lo,ur,Mn,wu,hr,Pu,Zi,ue,jn,xu,Sn,zu,Ls,Fu,$u,qu,On,Eu,An,Cu,Mu,ju,co,Su,be,In,Ou,It,Au,Gs,Iu,Lu,mr,Gu,Nu,Du,po,Uu,gr,Wu,Bu,Ln,Yi,Lt,uo,fr,Gn,Vu,_r,Ru,ed,he,Nn,Hu,Dn,Ku,Ns,Qu,Ju,Xu,Un,Zu,Wn,Yu,eh,th,ho,oh,ye,Bn,nh,Gt,sh,Ds,ah,rh,vr,ih,dh,lh,mo,ch,kr,ph,uh,Vn,td,Nt,go,br,Rn,hh,yr,mh,od,L,Hn,gh,Kn,fh,Us,_h,vh,kh,Qn,bh,Jn,yh,Th,wh,Tr,Ph,xh,Re,wr,Xn,zh,Fh,Pr,Zn,$h,qh,xr,Yn,Eh,Ch,zr,es,Mh,jh,Te,ts,Sh,Dt,Oh,Fr,Ah,Ih,$r,Lh,Gh,Nh,fo,Dh,qr,Uh,Wh,os,Bh,Ye,ns,Vh,Er,Rh,Hh,ss,Kh,et,as,Qh,Cr,Jh,Xh,rs,nd,Ut,_o,Mr,is,Zh,jr,Yh,sd,G,ds,em,ls,tm,Ws,om,nm,sm,cs,am,ps,rm,im,dm,Sr,lm,cm,He,Or,us,pm,um,Ar,hs,hm,mm,Ir,ms,gm,fm,Lr,gs,_m,vm,E,fs,km,Wt,bm,Gr,ym,Tm,Nr,wm,Pm,xm,vo,zm,Dr,Fm,$m,Ur,Wr,Br,Vr,qm,Em,Rr,Hr,Kr,Qr,Cm,Mm,Jr,Xr,Zr,Yr,jm,Sm,ei,ti,_s,ko,bo,oi,vs,Om,ni,Am,Im,si,Lm,Gm,ai,Nm,Dm,ri,ii,di,li,Um,Wm,ci,pi,ui,hi,Bm,Vm,mi,gi,fi,_i,Rm,Hm,vi,ki,bi,yi,Km,Qm,tt,ks,Jm,Ti,Xm,Zm,bs,Ym,ot,ys,eg,wi,tg,og,Ts,ad;return w=new Z({}),H=new Z({}),$e=new Z({}),So=new Z({}),Io=new Z({}),Do=new Z({}),Uo=new Se({props:{code:`from transformers import PegasusForConditionalGeneration, PegasusTokenizer
import torch
...
<code>eos_token_id</code>.`,name:"forced_eos_token_id"}],source:"https://github.com/huggingface/transformers/blob/v4.18.0/src/transformers/models/pegasus/configuration_pegasus.py#L29"}}),Ro=new Se({props:{code:`from transformers import PegasusModel, PegasusConfig
...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/v4.18.0/src/transformers/models/pegasus/tokenization_pegasus.py#L255",returnDescription:`
...
`}}),so=new $o({props:{$$slots:{default:[Lv]},$$scope:{ctx:B}}}),bn=new Se({props:{code:`from transformers import PegasusTokenizer, PegasusModel
...
(masked), the loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.18.0/src/transformers/models/pegasus/modeling_pegasus.py#L1350",returnDescription:`
<p>A <a
...
Whether or not to return a <a href="/docs/transformers/v4.18.0/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/v4.18.0/src/transformers/models/pegasus/modeling_pegasus.py#L1542",returnDescription:`
<p>A <a
...
behaviors between training and evaluation).`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/v4.18.0/src/transformers/models/pegasus/modeling_tf_pegasus.py#L1175",returnDescription:`
<p>A <a
...
`}}),po=new $o({props:{$$slots:{default:[Dv]},$$scope:{ctx:B}}}),Ln=new Se({props:{code:`from transformers import PegasusTokenizer, TFPegasusModel
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/v4.18.0/en/main_classes/model#transformers.TFPreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/v4.18.0/src/transformers/models/pegasus/modeling_tf_pegasus.py#L1250"}}),ho=new $o({props:{$$slots:{default:[Uv]},$$scope:{ctx:B}}}),Bn=new C({props:{name:"call",anchor:"transformers.TFPegasusForConditionalGeneration.call",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"decoder_input_ids",val:" = None"},{name:"decoder_attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"decoder_head_mask",val:" = None"},{name:"cross_attn_head_mask",val:" = None"},{name:"encoder_outputs",val:": typing.Optional[transformers.modeling_tf_outputs.TFBaseModelOutput] = None"},{name:"past_key_values",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"decoder_inputs_embeds",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"},{name:"labels",val:" = None"},{name:"training",val:" = False"}],parametersDescription:[{anchor:"transformers.TFPegasusForConditionalGeneration.call.input_ids",description:`<strong>input_ids</strong> (<code>tf.Tensor</code> of shape <code>({0})</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/v4.18.0/en/model_doc/pegasus#transformers.PegasusTokenizer">PegasusTokenizer</a>. See <a href="/docs/transformers/v4.18.0/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/v4.18.0/en/model_doc/wav2vec2_phoneme#transformers.Wav2Vec2PhonemeCTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
Labels for computing the masked language modeling loss. Indices should either be in <code>[0, ..., config.vocab_size]</code> or -100 (see <code>input_ids</code> docstring). Tokens with indices set to <code>-100</code> are ignored
(masked), the loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.18.0/src/transformers/models/pegasus/modeling_tf_pegasus.py#L1283",returnDescription:`
<p>A <a
...
Whether or not to return a <a href="/docs/transformers/v4.18.0/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/v4.18.0/src/transformers/models/pegasus/modeling_flax_pegasus.py#L1151",returnDescription:`
<p>A <a
...
Whether or not to return a <a href="/docs/transformers/v4.18.0/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/v4.18.0/src/transformers/models/pegasus/modeling_flax_pegasus.py#L974",returnDescription:`
<p>A <a
...
Whether or not to return a <a href="/docs/transformers/v4.18.0/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/v4.18.0/src/transformers/models/pegasus/modeling_flax_pegasus.py#L1307",returnDescription:`
<p>A <a
...
documentation from `),qs=n("a"),_c=r("PretrainedConfig"),vc=r(" for more information."),kc=d(),Ia=n("p"),bc=r("Example:"),yc=d(),m(Ro.$$.fragment),Ni=d(),Ft=n("h2"),Jt=n("a"),La=n("span"),m(Ho.$$.fragment),Tc=d(),Ga=n("span"),wc=r("PegasusTokenizer"),Di=d(),Xt=n("p"),Pc=r("warning: "),Na=n("code"),xc=r("add_tokens"),zc=r(" does not work at the moment."),Ui=d(),W=n("div"),m(Ko.$$.fragment),Fc=d(),Qo=n("p"),$c=r("Construct a PEGASUS tokenizer. Based on "),Jo=n("a"),qc=r("SentencePiece"),Ec=r("."),Cc=d(),Xo=n("p"),Mc=r("This tokenizer inherits from "),Es=n("a"),jc=r("PreTrainedTokenizer"),Sc=r(` which contains most of the main methods. Users should refer to
...
etc.)`),Op=d(),_n=n("p"),Ap=r("This model is also a PyTorch "),vn=n("a"),Ip=r("torch.nn.Module"),Lp=r(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Gp=d(),ve=n("div"),m(kn.$$.fragment),Np=d(),Ct=n("p"),Dp=r("The "),Os=n("a"),Up=r("PegasusModel"),Wp=r(" forward method, overrides the "),nr=n("code"),Bp=r("__call__"),Vp=r(" special method."),Rp=d(),m(so.$$.fragment),Hp=d(),sr=n("p"),Kp=r("Example:"),Qp=d(),m(bn.$$.fragment),Hi=d(),Mt=n("h2"),ao=n("a"),ar=n("span"),m(yn.$$.fragment),Jp=d(),rr=n("span"),Xp=r("PegasusForConditionalGeneration"),Ki=d(),Ee=n("div"),m(Tn.$$.fragment),Zp=d(),wn=n("p"),Yp=r(`The PEGASUS Model with a language modeling head. Can be used for summarization.
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),ru=d(),ke=n("div"),m(zn.$$.fragment),iu=d(),jt=n("p"),du=r("The "),Is=n("a"),lu=r("PegasusForConditionalGeneration"),cu=r(" forward method, overrides the "),ir=n("code"),pu=r("__call__"),uu=r(" special method."),hu=d(),m(ro.$$.fragment),mu=d(),dr=n("p"),gu=r("Summarization example:"),fu=d(),m(Fn.$$.fragment),Qi=d(),St=n("h2"),io=n("a"),lr=n("span"),m($n.$$.fragment),_u=d(),cr=n("span"),vu=r("PegasusForCausalLM"),Ji=d(),Ot=n("div"),m(qn.$$.fragment),ku=d(),Ze=n("div"),m(En.$$.fragment),bu=d(),pr=n("p"),yu=r("Example:"),Tu=d(),m(Cn.$$.fragment),Xi=d(),At=n("h2"),lo=n("a"),ur=n("span"),m(Mn.$$.fragment),wu=d(),hr=n("span"),Pu=r("TFPegasusModel"),Zi=d(),ue=n("div"),m(jn.$$.fragment),xu=d(),Sn=n("p"),zu=r(`The bare PEGASUS Model outputting raw hidden-states without any specific head on top.
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),kh=d(),Qn=n("p"),bh=r(`This model is also a Flax Linen
...
tokenizer([ARTICLE_TO_SUMMARIZE], max_length=1024, return_tensors=\u2018np\u2019)`),Sm=d(),ei=n("blockquote"),ti=n("blockquote"),_s=n("blockquote"),ko=n("h1"),bo=n("a"),oi=n("span"),m(vs.$$.fragment),Om=d(),ni=n("span"),Am=r("Generate Summary >>> summary_ids = model.generate(inputs[\u2018input_ids\u2019]).sequences >>>"),Im=d(),si=n("p"),Lm=r("print(tokenizer.batch_decode(summary_ids, skip_special_tokens=True, clean_up_tokenization_spaces=False))"),Gm=d(),ai=n("p"),Nm=r("Mask filling example:"),Dm=d(),ri=n("blockquote"),ii=n("blockquote"),di=n("blockquote"),li=n("p"),Um=r(`from transformers import PegasusTokenizer, FlaxPegasusForConditionalGeneration >>> tokenizer =
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Ad.forEach(t),ru=l(xo),ke=s(xo,"DIV",{class:!0});var dt=a(ke);g(zn.$$.fragment,dt),iu=l(dt),jt=s(dt,"P",{});var ea=a(jt);du=i(ea,"The "),Is=s(ea,"A",{href:!0});var Vf=a(Is);lu=i(Vf,"PegasusForConditionalGeneration"),Vf.forEach(t),cu=i(ea," forward method, overrides the "),ir=s(ea,"CODE",{});var Rf=a(ir);pu=i(Rf,"__call__"),Rf.forEach(t),uu=i(ea," special method."),ea.forEach(t),hu=l(dt),g(ro.$$.fragment,dt),mu=l(dt),dr=s(dt,"P",{});var Hf=a(dr);gu=i(Hf,"Summarization example:"),Hf.forEach(t),fu=l(dt),g(Fn.$$.fragment,dt),dt.forEach(t),xo.forEach(t),Qi=l(o),St=s(o,"H2",{class:!0});var Id=a(St);io=s(Id,"A",{id:!0,class:!0,href:!0});var Kf=a(io);lr=s(Kf,"SPAN",{});var Qf=a(lr);g($n.$$.fragment,Qf),Qf.forEach(t),Kf.forEach(t),_u=l(Id),cr=s(Id,"SPAN",{});var Jf=a(cr);vu=i(Jf,"PegasusForCausalLM"),Jf.forEach(t),Id.forEach(t),Ji=l(o),Ot=s(o,"DIV",{class:!0});var Ld=a(Ot);g(qn.$$.fragment,Ld),ku=l(Ld),Ze=s(Ld,"DIV",{class:!0});var ta=a(Ze);g(En.$$.fragment,ta),bu=l(ta),pr=s(ta,"P",{});var Xf=a(pr);yu=i(Xf,"Example:"),Xf.forEach(t),Tu=l(ta),g(Cn.$$.fragment,ta),ta.forEach(t),Ld.forEach(t),Xi=l(o),At=s(o,"H2",{class:!0});var Gd=a(At);lo=s(Gd,"A",{id:!0,class:!0,href:!0});var Zf=a(lo);ur=s(Zf,"SPAN",{});var Yf=a(ur);g(Mn.$$.fragment,Yf),Yf.forEach(t),Zf.forEach(t),wu=l(Gd),hr=s(Gd,"SPAN",{});var e_=a(hr);Pu=i(e_,"TFPegasusModel"),e_.forEach(t),Gd.forEach(t),Zi=l(o),ue=s(o,"DIV",{class:!0});var lt=a(ue);g(jn.$$.fragment,lt),xu=l(lt),Sn=s(lt,"P",{});var Nd=a(Sn);zu=i(Nd,`The bare PEGASUS Model outputting raw hidden-states without any specific head on top.
