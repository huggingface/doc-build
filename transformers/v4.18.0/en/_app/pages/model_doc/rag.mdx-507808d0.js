...
the latter silently ignores them.`)},l(i){c=a(i,"P",{});var m=d(c);b=n(m,"Although the recipe for forward pass needs to be defined within this function, one should call the "),u=a(m,"CODE",{});var R=d(u);g=n(R,"Module"),R.forEach(t),f=n(m,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),m.forEach(t)},m(i,m){v(i,c,m),e(c,b),e(c,u),e(u,g),e(c,f)},d(i){i&&t(c)}}}function Ob(F){let c,b,u,g,f;return g=new ln({props:{code:`from transformers import RagTokenizer, RagRetriever, RagModel
import torch
...
the latter silently ignores them.`)},l(i){c=a(i,"P",{});var m=d(c);b=n(m,"Although the recipe for forward pass needs to be defined within this function, one should call the "),u=a(m,"CODE",{});var R=d(u);g=n(R,"Module"),R.forEach(t),f=n(m,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),m.forEach(t)},m(i,m){v(i,c,m),e(c,b),e(c,u),e(u,g),e(c,f)},d(i){i&&t(c)}}}function Lb(F){let c,b,u,g,f;return{c(){c=s("p"),b=o("Although the recipe for forward pass needs to be defined within this function, one should call the "),u=s("code"),g=o("Module"),f=o(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(i){c=a(i,"P",{});var m=d(c);b=n(m,"Although the recipe for forward pass needs to be defined within this function, one should call the "),u=a(m,"CODE",{});var R=d(u);g=n(R,"Module"),R.forEach(t),f=n(m,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
<span class="hljs-meta">... </span>    doc_scores=doc_scores,
<span class="hljs-meta">... </span>)
<span class="hljs-meta">&gt;&gt;&gt; </span>generated_string = tokenizer.batch_decode(generated, skip_special_tokens=<span class="hljs-literal">True</span>)`}}),{c(){c=s("p"),b=o("Example:"),u=p(),T(g.$$.fragment)},l(i){c=a(i,"P",{});var m=d(c);b=n(m,"Example:"),m.forEach(t),u=h(i),w(g.$$.fragment,i)},m(i,m){v(i,c,m),e(c,b),v(i,u,m),k(g,i,m),f=!0},p:cn,i(i){f||(q(g.$$.fragment,i),f=!0)},o(i){y(g.$$.fragment,i),f=!1},d(i){i&&t(c),i&&t(u),x(g,i)}}}function eT(F){let c,b,u,g,f,i,m,R,ti,Wa,qe,Ye,jr,Bt,oi,Gr,ni,Ha,pn,ri,Ba,Je,si,Qt,ai,di,Qa,hn,ii,Ua,mn,Mr,ci,Va,Xe,li,Ut,pi,hi,Ka,ye,Ze,Ar,Vt,mi,Pr,ui,Ya,ee,Kt,gi,de,un,_i,fi,Nr,vi,bi,gn,Ti,wi,_n,ki,qi,yi,et,Yt,xi,Jt,Ri,fn,Fi,$i,zi,tt,Xt,Ei,Zt,ji,vn,Gi,Mi,Ja,xe,ot,Cr,eo,Ai,Or,Pi,Xa,Re,to,Ni,nt,oo,Ci,Sr,Oi,Za,Fe,rt,Lr,no,Si,Dr,Li,ed,$e,ro,Di,Ir,Ii,td,so,ao,od,ze,st,Wr,io,Wi,Hr,Hi,nd,Z,co,Bi,Br,Qi,Ui,at,Vi,dt,lo,Ki,Qr,Yi,Ji,it,po,Xi,Ee,Zi,Ur,ec,tc,Vr,oc,nc,rc,ct,ho,sc,mo,ac,Kr,dc,ic,rd,je,lt,Yr,uo,cc,Jr,lc,sd,S,go,pc,Ge,hc,bn,mc,uc,Xr,gc,_c,fc,pt,vc,Zr,bc,Tc,te,wc,es,kc,qc,Tn,yc,xc,ts,Rc,Fc,wn,$c,zc,Ec,M,jc,kn,Gc,Mc,os,Ac,Pc,ns,Nc,Cc,rs,Oc,Sc,ss,Lc,Dc,qn,Ic,Wc,as,Hc,Bc,yn,Qc,Uc,xn,Vc,Kc,ds,Yc,Jc,Xc,_o,Zc,Rn,el,tl,ol,fo,nl,vo,rl,sl,al,ie,bo,dl,Me,il,Fn,cl,ll,is,pl,hl,ml,ht,ul,mt,ad,Ae,ut,cs,To,gl,ls,_l,dd,E,wo,fl,Pe,vl,$n,bl,Tl,ps,wl,kl,ql,gt,yl,hs,xl,Rl,ms,Fl,$l,oe,zl,us,El,jl,zn,Gl,Ml,gs,Al,Pl,En,Nl,Cl,Ol,A,Sl,jn,Ll,Dl,_s,Il,Wl,fs,Hl,Bl,vs,Ql,Ul,bs,Vl,Kl,Gn,Yl,Jl,Ts,Xl,Zl,Mn,ep,tp,An,op,np,ws,rp,sp,ap,ko,dp,Pn,ip,cp,lp,qo,pp,yo,hp,mp,up,ce,xo,gp,Ne,_p,Nn,fp,vp,ks,bp,Tp,wp,_t,kp,ft,qp,vt,Ro,yp,Fo,xp,Cn,Rp,Fp,id,Ce,bt,qs,$o,$p,ys,zp,cd,j,zo,Ep,Oe,jp,On,Gp,Mp,xs,Ap,Pp,Np,Tt,Cp,Rs,Op,Sp,Fs,Lp,Dp,ne,Ip,$s,Wp,Hp,Sn,Bp,Qp,zs,Up,Vp,Ln,Kp,Yp,Jp,P,Xp,Dn,Zp,eh,Es,th,oh,js,nh,rh,Gs,sh,ah,Ms,dh,ih,In,ch,lh,As,ph,hh,Wn,mh,uh,Hn,gh,_h,Ps,fh,vh,bh,Eo,Th,Bn,wh,kh,qh,jo,yh,Go,xh,Rh,Fh,le,Mo,$h,Se,zh,Qn,Eh,jh,Ns,Gh,Mh,Ah,wt,Ph,kt,Nh,qt,Ao,Ch,Cs,Oh,ld,Le,yt,Os,Po,Sh,Ss,Lh,pd,N,No,Dh,De,Ih,Un,Wh,Hh,Ls,Bh,Qh,Uh,xt,Vh,Ds,Kh,Yh,re,Jh,Is,Xh,Zh,Vn,em,tm,Ws,om,nm,Kn,rm,sm,am,L,dm,Yn,im,cm,Hs,lm,pm,Bs,hm,mm,Qs,um,gm,Us,_m,fm,Jn,vm,bm,Vs,Tm,wm,Xn,km,qm,Ks,ym,xm,Rm,Co,Fm,Zn,$m,zm,Em,Oo,jm,So,Gm,Mm,Am,Ys,Pm,Nm,pe,Lo,Cm,Ie,Om,er,Sm,Lm,Js,Dm,Im,Wm,Rt,Hm,Ft,hd,We,$t,Xs,Do,Bm,Zs,Qm,md,$,Io,Um,He,Vm,tr,Km,Ym,ea,Jm,Xm,Zm,zt,eu,ta,tu,ou,oa,nu,ru,se,su,na,au,du,or,iu,cu,ra,lu,pu,nr,hu,mu,uu,D,gu,rr,_u,fu,sa,vu,bu,aa,Tu,wu,da,ku,qu,ia,yu,xu,sr,Ru,Fu,ca,$u,zu,ar,Eu,ju,la,Gu,Mu,Au,Wo,Pu,dr,Nu,Cu,Ou,Ho,Su,Bo,Lu,Du,Iu,pa,Wu,Hu,he,Qo,Bu,Be,Qu,ir,Uu,Vu,ha,Ku,Yu,Ju,Et,Xu,jt,Zu,Gt,Uo,eg,Vo,tg,cr,og,ng,ud,Qe,Mt,ma,Ko,rg,ua,sg,gd,z,Yo,ag,Ue,dg,lr,ig,cg,ga,lg,pg,hg,At,mg,_a,ug,gg,fa,_g,fg,ae,vg,va,bg,Tg,pr,wg,kg,ba,qg,yg,hr,xg,Rg,Fg,I,$g,mr,zg,Eg,Ta,jg,Gg,wa,Mg,Ag,ka,Pg,Ng,qa,Cg,Og,ur,Sg,Lg,ya,Dg,Ig,gr,Wg,Hg,xa,Bg,Qg,Ug,Jo,Vg,_r,Kg,Yg,Jg,Xo,Xg,Zo,Zg,e_,t_,Ra,o_,n_,me,en,r_,Ve,s_,fr,a_,d_,Fa,i_,c_,l_,Pt,p_,Nt,h_,Ct,tn,m_,$a,u_,_d;return i=new _e({}),Bt=new _e({}),Vt=new _e({}),Kt=new G({props:{name:"class transformers.RagConfig",anchor:"transformers.RagConfig",parameters:[{name:"vocab_size",val:" = None"},{name:"is_encoder_decoder",val:" = True"},{name:"prefix",val:" = None"},{name:"bos_token_id",val:" = None"},{name:"pad_token_id",val:" = None"},{name:"eos_token_id",val:" = None"},{name:"decoder_start_token_id",val:" = None"},{name:"title_sep",val:" = ' / '"},{name:"doc_sep",val:" = ' // '"},{name:"n_docs",val:" = 5"},{name:"max_combined_length",val:" = 300"},{name:"retrieval_vector_size",val:" = 768"},{name:"retrieval_batch_size",val:" = 8"},{name:"dataset",val:" = 'wiki_dpr'"},{name:"dataset_split",val:" = 'train'"},{name:"index_name",val:" = 'compressed'"},{name:"index_path",val:" = None"},{name:"passages_path",val:" = None"},{name:"use_dummy_dataset",val:" = False"},{name:"reduce_loss",val:" = False"},{name:"label_smoothing",val:" = 0.0"},{name:"do_deduplication",val:" = True"},{name:"exclude_bos_score",val:" = False"},{name:"do_marginalize",val:" = False"},{name:"output_retrieved",val:" = False"},{name:"use_cache",val:" = True"},{name:"forced_eos_token_id",val:" = None"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.RagConfig.title_sep",description:`<strong>title_sep</strong> (<code>str</code>, <em>optional</em>, defaults to  <code>&quot; / &quot;</code>) &#x2014;
...
<code>eos_token_id</code>.`,name:"forced_eos_token_id"}],source:"https://github.com/huggingface/transformers/blob/v4.18.0/src/transformers/models/rag/configuration_rag.py#L82"}}),Yt=new G({props:{name:"from_question_encoder_generator_configs",anchor:"transformers.RagConfig.from_question_encoder_generator_configs",parameters:[{name:"question_encoder_config",val:": PretrainedConfig"},{name:"generator_config",val:": PretrainedConfig"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/v4.18.0/src/transformers/models/rag/configuration_rag.py#L170",returnDescription:`
...
Prefix added at the beginning of each input, typically used with T5-based models.`,name:"prefix"}],source:"https://github.com/huggingface/transformers/blob/v4.18.0/src/transformers/models/rag/retrieval_rag.py#L466",returnDescription:`
...
The number of docs retrieved per query.`,name:"n_docs"}],source:"https://github.com/huggingface/transformers/blob/v4.18.0/src/transformers/models/rag/retrieval_rag.py#L538",returnDescription:`
...
<code>context_attention_mask</code>. See returned tensors for more detail.`,name:"output_retrieved(bool,"},{anchor:"transformers.RagModel.forward.n_docs",description:"<strong>n_docs</strong> (<code>int</code>, <em>optional</em>, defaults to `config.n_docs&#x201C;) &#x2014;\nNumber of documents to retrieve and/or number of documents for which to generate an answer.",name:"n_docs"}],source:"https://github.com/huggingface/transformers/blob/v4.18.0/src/transformers/models/rag/modeling_rag.py#L536",returnDescription:`
<p>A <a
...
`}}),ht=new ge({props:{$$slots:{default:[Cb]},$$scope:{ctx:F}}}),mt=new dn({props:{anchor:"transformers.RagModel.forward.example",$$slots:{default:[Ob]},$$scope:{ctx:F}}}),To=new _e({}),wo=new G({props:{name:"class transformers.RagSequenceForGeneration",anchor:"transformers.RagSequenceForGeneration",parameters:[{name:"config",val:": typing.Optional[transformers.configuration_utils.PretrainedConfig] = None"},{name:"question_encoder",val:": typing.Optional[transformers.modeling_utils.PreTrainedModel] = None"},{name:"generator",val:": typing.Optional[transformers.modeling_utils.PreTrainedModel] = None"},{name:"retriever",val:": typing.Optional = None"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.RagSequenceForGeneration.config",description:`<strong>config</strong> (<a href="/docs/transformers/v4.18.0/en/model_doc/rag#transformers.RagConfig">RagConfig</a>) &#x2014;
Model configuration class with all the parameters of the model. Initializing with a config file does not
load the weights associated with the model, only the configuration. Check out the
...
Legacy dictionary, which is required so that model can use <em>generate()</em> function.`,name:"kwargs"}],source:"https://github.com/huggingface/transformers/blob/v4.18.0/src/transformers/models/rag/modeling_rag.py#L766",returnDescription:`
<p>A <a
...
`}}),_t=new ge({props:{$$slots:{default:[Lb]},$$scope:{ctx:F}}}),ft=new dn({props:{anchor:"transformers.RagSequenceForGeneration.forward.example",$$slots:{default:[Db]},$$scope:{ctx:F}}}),Ro=new G({props:{name:"generate",anchor:"transformers.RagSequenceForGeneration.generate",parameters:[{name:"input_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"attention_mask",val:": typing.Optional[torch.LongTensor] = None"},{name:"context_input_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"context_attention_mask",val:": typing.Optional[torch.LongTensor] = None"},{name:"doc_scores",val:": typing.Optional[torch.FloatTensor] = None"},{name:"do_deduplication",val:": typing.Optional[bool] = None"},{name:"num_return_sequences",val:": typing.Optional[int] = None"},{name:"num_beams",val:": typing.Optional[int] = None"},{name:"n_docs",val:": typing.Optional[int] = None"},{name:"**model_kwargs",val:""}],parametersDescription:[{anchor:"transformers.RagSequenceForGeneration.generate.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>, <em>optional</em>) &#x2014;
...
kwargs &#x2014;
Additional kwargs will be passed to <a href="/docs/transformers/v4.18.0/en/main_classes/text_generation#transformers.generation_utils.GenerationMixin.generate">generate()</a>.`,name:"n_docs"}],source:"https://github.com/huggingface/transformers/blob/v4.18.0/src/transformers/models/rag/modeling_rag.py#L908",returnDescription:`
<p>The generated
...
Legacy dictionary, which is required so that model can use <em>generate()</em> function.`,name:"kwargs"}],source:"https://github.com/huggingface/transformers/blob/v4.18.0/src/transformers/models/rag/modeling_rag.py#L1233",returnDescription:`
<p>A <a
  href="/docs/transformers/v4.18.0/en/model_doc/rag#transformers.models.rag.modeling_rag.RetrievAugLMMarginOutput"
>transformers.models.rag.modeling_rag.RetrievAugLMMarginOutput</a> or a tuple of
<code>torch.FloatTensor</code> (if <code>return_dict=False</code> is passed or when <code>config.return_dict=False</code>) comprising various
...
crash. Note that using <code>remove_invalid_values</code> can slow down generation.`,name:"remove_invalid_values"}],source:"https://github.com/huggingface/transformers/blob/v4.18.0/src/transformers/models/rag/modeling_rag.py#L1375",returnDescription:`
<p>The generated
...
Whether or not to return a <code>TFRetrievAugLMOutput</code> instead of a plain tuple.`,name:"return_dict"},{anchor:"transformers.TFRagModel.call.n_docs",description:"<strong>n_docs</strong> (<code>int</code>, <em>optional</em>, defaults to `config.n_docs&#x201C;) &#x2014;\nNumber of documents to retrieve and/or number of documents for which to generate an answer.",name:"n_docs"}],source:"https://github.com/huggingface/transformers/blob/v4.18.0/src/transformers/models/rag/modeling_tf_rag.py#L534",returnDescription:`
...
Legacy dictionary, which is required so that model can use <em>generate()</em> function.`,name:"kwargs"}],source:"https://github.com/huggingface/transformers/blob/v4.18.0/src/transformers/models/rag/modeling_tf_rag.py#L1406",returnDescription:`
...
Legacy dictionary, which is required so that model can use <em>generate()</em> function.`,name:"kwargs"}],source:"https://github.com/huggingface/transformers/blob/v4.18.0/src/transformers/models/rag/modeling_tf_rag.py#L820",returnDescription:`
<p>A <code>transformers.models.rag.modeling_tf_rag.TFRetrievAugLMMarginOutput</code> or a tuple of <code>tf.Tensor</code> (if
<code>return_dict=False</code> is passed or when <code>config.return_dict=False</code>) comprising various elements depending on the
configuration (<a
  href="/docs/transformers/v4.18.0/en/model_doc/rag#transformers.RagConfig"
...
Additional model specific kwargs will be forwarded to the <code>forward</code> function of the model.`,name:"return_dict_in_generate"}],source:"https://github.com/huggingface/transformers/blob/v4.18.0/src/transformers/models/rag/modeling_tf_rag.py#L975",returnDescription:`
<p>The generated sequences. The
...
decoder model configuration.`),zi=p(),tt=s("div"),T(Xt.$$.fragment),Ei=p(),Zt=s("p"),ji=o("Serializes this instance to a Python dictionary. Override the default "),vn=s("a"),Gi=o("to_dict()"),Mi=o("."),Ja=p(),xe=s("h2"),ot=s("a"),Cr=s("span"),T(eo.$$.fragment),Ai=p(),Or=s("span"),Pi=o("RagTokenizer"),Xa=p(),Re=s("div"),T(to.$$.fragment),Ni=p(),nt=s("div"),T(oo.$$.fragment),Ci=p(),Sr=s("p"),Oi=o(`Temporarily sets the tokenizer for encoding the targets. Useful for tokenizer associated to
sequence-to-sequence models that need a slightly different processing for the labels.`),Za=p(),Fe=s("h2"),rt=s("a"),Lr=s("span"),T(no.$$.fragment),Si=p(),Dr=s("span"),Li=o("Rag specific outputs"),ed=p(),$e=s("div"),T(ro.$$.fragment),Di=p(),Ir=s("p"),Ii=o("Base class for retriever augmented marginalized models outputs."),td=p(),so=s("div"),T(ao.$$.fragment),od=p(),ze=s("h2"),st=s("a"),Wr=s("span"),T(io.$$.fragment),Wi=p(),Hr=s("span"),Hi=o("RagRetriever"),nd=p(),Z=s("div"),T(co.$$.fragment),Bi=p(),Br=s("p"),Qi=o(`Retriever used to get documents from vector queries. It retrieves the documents embeddings as well as the documents
contents, and it formats them to be used with a RagModel.`),Ui=p(),T(at.$$.fragment),Vi=p(),dt=s("div"),T(lo.$$.fragment),Ki=p(),Qr=s("p"),Yi=o("Retriever initialization function. It loads the index into memory."),Ji=p(),it=s("div"),T(po.$$.fragment),Xi=p(),Ee=s("p"),Zi=o("Postprocessing retrieved "),Ur=s("code"),ec=o("docs"),tc=o(" and combining them with "),Vr=s("code"),oc=o("input_strings"),nc=o("."),rc=p(),ct=s("div"),T(ho.$$.fragment),sc=p(),mo=s("p"),ac=o("Retrieves documents for specified "),Kr=s("code"),dc=o("question_hidden_states"),ic=o("."),rd=p(),je=s("h2"),lt=s("a"),Yr=s("span"),T(uo.$$.fragment),cc=p(),Jr=s("span"),lc=o("RagModel"),sd=p(),S=s("div"),T(go.$$.fragment),pc=p(),Ge=s("p"),hc=o("The "),bn=s("a"),mc=o("RagModel"),uc=o(" forward method, overrides the "),Xr=s("code"),gc=o("__call__"),_c=o(" special method."),fc=p(),T(pt.$$.fragment),vc=p(),Zr=s("p"),bc=o(`RAG is a seq2seq model which encapsulates two core components: a question encoder and a generator. During a forward
...
`),os=s("em"),Ac=o("autoencoding"),Pc=o(" model as the "),ns=s("code"),Nc=o("question_encoder"),Cc=o(" and any "),rs=s("em"),Oc=o("seq2seq"),Sc=o(" model with language model head as the "),ss=s("code"),Lc=o("generator"),Dc=o(`.
...
any `),gs=s("em"),Al=o("seq2seq"),Pl=o(" model, preferably "),En=s("a"),Nl=o("BartForConditionalGeneration"),Cl=o("."),Ol=p(),A=s("p"),Sl=o("The model can be initialized with a "),jn=s("a"),Ll=o("RagRetriever"),Dl=o(` for end-to-end generation or used in combination with the
outputs of a retriever in multiple steps---see examples for more details. The model is compatible any
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),up=p(),ce=s("div"),T(xo.$$.fragment),gp=p(),Ne=s("p"),_p=o("The "),Nn=s("a"),fp=o("RagSequenceForGeneration"),vp=o(" forward method, overrides the "),ks=s("code"),bp=o("__call__"),Tp=o(" special method."),wp=p(),T(_t.$$.fragment),kp=p(),T(ft.$$.fragment),qp=p(),vt=s("div"),T(Ro.$$.fragment),yp=p(),Fo=s("p"),xp=o("Implements RAG sequence \u201Cthorough\u201D decoding. Read the "),Cn=s("a"),Rp=o("generate()"),Fp=o("`\ndocumentation for more information on how to set other generate input parameters."),id=p(),Ce=s("h2"),bt=s("a"),qs=s("span"),T($o.$$.fragment),$p=p(),ys=s("span"),zp=o("RagTokenForGeneration"),cd=p(),j=s("div"),T(zo.$$.fragment),Ep=p(),Oe=s("p"),jp=o("The "),On=s("a"),Gp=o("RagTokenForGeneration"),Mp=o(" forward method, overrides the "),xs=s("code"),Ap=o("__call__"),Pp=o(" special method."),Np=p(),T(Tt.$$.fragment),Cp=p(),Rs=s("p"),Op=o("A RAG-token model implementation. It performs RAG-token specific marginalization in the forward pass."),Sp=p(),Fs=s("p"),Lp=o(`RAG is a seq2seq model which encapsulates two core components: a question encoder and a generator. During a forward
pass, we encode the input with the question encoder and pass it to the retriever to extract relevant context
documents. The documents are then prepended to the input. Such contextualized inputs is passed to the generator.`),Dp=p(),ne=s("p"),Ip=o("The question encoder can be any "),$s=s("em"),Wp=o("autoencoding"),Hp=o(" model, preferably "),Sn=s("a"),Bp=o("DPRQuestionEncoder"),Qp=o(`, and the generator can be
any `),zs=s("em"),Up=o("seq2seq"),Vp=o(" model, preferably "),Ln=s("a"),Kp=o("BartForConditionalGeneration"),Yp=o("."),Jp=p(),P=s("p"),Xp=o("The model can be initialized with a "),Dn=s("a"),Zp=o("RagRetriever"),eh=o(` for end-to-end generation or used in combination with the
outputs of a retriever in multiple steps---see examples for more details. The model is compatible any
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Fh=p(),le=s("div"),T(Mo.$$.fragment),$h=p(),Se=s("p"),zh=o("The "),Qn=s("a"),Eh=o("RagTokenForGeneration"),jh=o(" forward method, overrides the "),Ns=s("code"),Gh=o("__call__"),Mh=o(" special method."),Ah=p(),T(wt.$$.fragment),Ph=p(),T(kt.$$.fragment),Nh=p(),qt=s("div"),T(Ao.$$.fragment),Ch=p(),Cs=s("p"),Oh=o("Implements RAG token decoding."),ld=p(),Le=s("h2"),yt=s("a"),Os=s("span"),T(Po.$$.fragment),Sh=p(),Ss=s("span"),Lh=o("TFRagModel"),pd=p(),N=s("div"),T(No.$$.fragment),Dh=p(),De=s("p"),Ih=o("The "),Un=s("a"),Wh=o("TFRagModel"),Hh=o(" forward method, overrides the "),Ls=s("code"),Bh=o("__call__"),Qh=o(" special method."),Uh=p(),T(xt.$$.fragment),Vh=p(),Ds=s("p"),Kh=o(`RAG is a sequence-to-sequence model which encapsulates two core components: a question encoder and a generator.
...
any `),Ws=s("em"),om=o("seq2seq"),nm=o(" model, preferably "),Kn=s("a"),rm=o("TFBartForConditionalGeneration"),sm=o("."),am=p(),L=s("p"),dm=o("The model can be initialized with a "),Yn=s("a"),im=o("RagRetriever"),cm=o(` for end-to-end generation or used in combination with the
outputs of a retriever in multiple steps---see examples for more details. The model is compatible any
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Em=p(),Oo=s("p"),jm=o("This model is also a Tensorflow "),So=s("a"),Gm=o("tf.keras.Model"),Mm=o(`
...
SavedModel format.`),Nm=p(),pe=s("div"),T(Lo.$$.fragment),Cm=p(),Ie=s("p"),Om=o("The "),er=s("a"),Sm=o("TFRagModel"),Lm=o(" forward method, overrides the "),Js=s("code"),Dm=o("__call__"),Im=o(" special method."),Wm=p(),T(Rt.$$.fragment),Hm=p(),T(Ft.$$.fragment),hd=p(),We=s("h2"),$t=s("a"),Xs=s("span"),T(Do.$$.fragment),Bm=p(),Zs=s("span"),Qm=o("TFRagSequenceForGeneration"),md=p(),$=s("div"),T(Io.$$.fragment),Um=p(),He=s("p"),Vm=o("The "),tr=s("a"),Km=o("TFRagSequenceForGeneration"),Ym=o(" forward method, overrides the "),ea=s("code"),Jm=o("__call__"),Xm=o(" special method."),Zm=p(),T(zt.$$.fragment),eu=p(),ta=s("p"),tu=o("A TF RAG-sequence model implementation. It performs RAG-sequence specific marginalization in the forward pass."),ou=p(),oa=s("p"),nu=o(`RAG is a sequence-to-sequence model which encapsulates two core components: a question encoder and a generator.
During a forward pass, we encode the input with the question encoder and pass it to the retriever to extract
relevant context documents. The documents are then prepended to the input. Such contextualized inputs is passed to
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Ou=p(),Ho=s("p"),Su=o("This model is also a Tensorflow "),Bo=s("a"),Lu=o("tf.keras.Model"),Du=o(`
subclass. Use it as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to
...
outputs of a retriever in multiple steps---see examples for more details. The model is compatible any
`),Ta=s("em"),jg=o("autoencoding"),Gg=o(" model as the "),wa=s("code"),Mg=o("question_encoder"),Ag=o(" and any "),ka=s("em"),Pg=o("seq2seq"),Ng=o(" model with language model head as the "),qa=s("code"),Cg=o("generator"),Og=o(`.
It has been tested with `),ur=s("a"),Sg=o("TFDPRQuestionEncoder"),Lg=o(" as the "),ya=s("code"),Dg=o("question_encoder"),Ig=o(" and "),gr=s("a"),Wg=o("TFBartForConditionalGeneration"),Hg=o(`
...
outperforming parametric seq2seq models and task-specific retrieve-and-extract architectures. For language generation
tasks, we find that RAG models generate more specific, diverse and factual language than a state-of-the-art
parametric-only seq2seq baseline.`),Sa.forEach(t),Oa.forEach(t),Va=h(r),Xe=a(r,"P",{});var sn=d(Xe);li=n(sn,"This model was contributed by "),Ut=a(sn,"A",{href:!0,rel:!0});var La=d(Ut);pi=n(La,"ola13"),La.forEach(t),hi=n(sn,"."),sn.forEach(t),Ka=h(r),ye=a(r,"H2",{class:!0});var an=d(ye);Ze=a(an,"A",{id:!0,class:!0,href:!0});var Da=d(Ze);Ar=a(Da,"SPAN",{});var Ia=d(Ar);w(Vt.$$.fragment,Ia),Ia.forEach(t),Da.forEach(t),mi=h(an),Pr=a(an,"SPAN",{});var g_=d(Pr);ui=n(g_,"RagConfig"),g_.forEach(t),an.forEach(t),Ya=h(r),ee=a(r,"DIV",{class:!0});var Ot=d(ee);w(Kt.$$.fragment,Ot),gi=h(Ot),de=a(Ot,"P",{});var Ke=d(de);un=a(Ke,"A",{href:!0});var __=d(un);_i=n(__,"RagConfig"),__.forEach(t),fi=n(Ke," stores the configuration of a "),Nr=a(Ke,"EM",{});var f_=d(Nr);vi=n(f_,"RagModel"),f_.forEach(t),bi=n(Ke,". Configuration objects inherit from "),gn=a(Ke,"A",{href:!0});var v_=d(gn);Ti=n(v_,"PretrainedConfig"),v_.forEach(t),wi=n(Ke,` and
can be used to control the model outputs. Read the documentation from `),_n=a(Ke,"A",{href:!0});var b_=d(_n);ki=n(b_,"PretrainedConfig"),b_.forEach(t),qi=n(Ke," for more information."),Ke.forEach(t),yi=h(Ot),et=a(Ot,"DIV",{class:!0});var fd=d(et);w(Yt.$$.fragment,fd),xi=h(fd),Jt=a(fd,"P",{});var vd=d(Jt);Ri=n(vd,"Instantiate a "),fn=a(vd,"A",{href:!0});var T_=d(fn);Fi=n(T_,"EncoderDecoderConfig"),T_.forEach(t),$i=n(vd,` (or a derived class) from a pre-trained encoder model configuration and
decoder model configuration.`),vd.forEach(t),fd.forEach(t),zi=h(Ot),tt=a(Ot,"DIV",{class:!0});var bd=d(tt);w(Xt.$$.fragment,bd),Ei=h(bd),Zt=a(bd,"P",{});var Td=d(Zt);ji=n(Td,"Serializes this instance to a Python dictionary. Override the default "),vn=a(Td,"A",{href:!0});var w_=d(vn);Gi=n(w_,"to_dict()"),w_.forEach(t),Mi=n(Td,"."),Td.forEach(t),bd.forEach(t),Ot.forEach(t),Ja=h(r),xe=a(r,"H2",{class:!0});var wd=d(xe);ot=a(wd,"A",{id:!0,class:!0,href:!0});var k_=d(ot);Cr=a(k_,"SPAN",{});var q_=d(Cr);w(eo.$$.fragment,q_),q_.forEach(t),k_.forEach(t),Ai=h(wd),Or=a(wd,"SPAN",{});var y_=d(Or);Pi=n(y_,"RagTokenizer"),y_.forEach(t),wd.forEach(t),Xa=h(r),Re=a(r,"DIV",{class:!0});var kd=d(Re);w(to.$$.fragment,kd),Ni=h(kd),nt=a(kd,"DIV",{class:!0});var qd=d(nt);w(oo.$$.fragment,qd),Ci=h(qd),Sr=a(qd,"P",{});var x_=d(Sr);Oi=n(x_,`Temporarily sets the tokenizer for encoding the targets. Useful for tokenizer associated to
sequence-to-sequence models that need a slightly different processing for the labels.`),x_.forEach(t),qd.forEach(t),kd.forEach(t),Za=h(r),Fe=a(r,"H2",{class:!0});var yd=d(Fe);rt=a(yd,"A",{id:!0,class:!0,href:!0});var R_=d(rt);Lr=a(R_,"SPAN",{});var F_=d(Lr);w(no.$$.fragment,F_),F_.forEach(t),R_.forEach(t),Si=h(yd),Dr=a(yd,"SPAN",{});var $_=d(Dr);Li=n($_,"Rag specific outputs"),$_.forEach(t),yd.forEach(t),ed=h(r),$e=a(r,"DIV",{class:!0});var xd=d($e);w(ro.$$.fragment,xd),Di=h(xd),Ir=a(xd,"P",{});var z_=d(Ir);Ii=n(z_,"Base class for retriever augmented marginalized models outputs."),z_.forEach(t),xd.forEach(t),td=h(r),so=a(r,"DIV",{class:!0});var E_=d(so);w(ao.$$.fragment,E_),E_.forEach(t),od=h(r),ze=a(r,"H2",{class:!0});var Rd=d(ze);st=a(Rd,"A",{id:!0,class:!0,href:!0});var j_=d(st);Wr=a(j_,"SPAN",{});var G_=d(Wr);w(io.$$.fragment,G_),G_.forEach(t),j_.forEach(t),Wi=h(Rd),Hr=a(Rd,"SPAN",{});var M_=d(Hr);Hi=n(M_,"RagRetriever"),M_.forEach(t),Rd.forEach(t),nd=h(r),Z=a(r,"DIV",{class:!0});var ue=d(Z);w(co.$$.fragment,ue),Bi=h(ue),Br=a(ue,"P",{});var A_=d(Br);Qi=n(A_,`Retriever used to get documents from vector queries. It retrieves the documents embeddings as well as the documents
contents, and it formats them to be used with a RagModel.`),A_.forEach(t),Ui=h(ue),w(at.$$.fragment,ue),Vi=h(ue),dt=a(ue,"DIV",{class:!0});var Fd=d(dt);w(lo.$$.fragment,Fd),Ki=h(Fd),Qr=a(Fd,"P",{});var P_=d(Qr);Yi=n(P_,"Retriever initialization function. It loads the index into memory."),P_.forEach(t),Fd.forEach(t),Ji=h(ue),it=a(ue,"DIV",{class:!0});var $d=d(it);w(po.$$.fragment,$d),Xi=h($d),Ee=a($d,"P",{});var vr=d(Ee);Zi=n(vr,"Postprocessing retrieved "),Ur=a(vr,"CODE",{});var N_=d(Ur);ec=n(N_,"docs"),N_.forEach(t),tc=n(vr," and combining them with "),Vr=a(vr,"CODE",{});var C_=d(Vr);oc=n(C_,"input_strings"),C_.forEach(t),nc=n(vr,"."),vr.forEach(t),$d.forEach(t),rc=h(ue),ct=a(ue,"DIV",{class:!0});var zd=d(ct);w(ho.$$.fragment,zd),sc=h(zd),mo=a(zd,"P",{});var Ed=d(mo);ac=n(Ed,"Retrieves documents for specified "),Kr=a(Ed,"CODE",{});var O_=d(Kr);dc=n(O_,"question_hidden_states"),O_.forEach(t),ic=n(Ed,"."),Ed.forEach(t),zd.forEach(t),ue.forEach(t),rd=h(r),je=a(r,"H2",{class:!0});var jd=d(je);lt=a(jd,"A",{id:!0,class:!0,href:!0});var S_=d(lt);Yr=a(S_,"SPAN",{});var L_=d(Yr);w(uo.$$.fragment,L_),L_.forEach(t),S_.forEach(t),cc=h(jd),Jr=a(jd,"SPAN",{});var D_=d(Jr);lc=n(D_,"RagModel"),D_.forEach(t),jd.forEach(t),sd=h(r),S=a(r,"DIV",{class:!0});var X=d(S);w(go.$$.fragment,X),pc=h(X),Ge=a(X,"P",{});var br=d(Ge);hc=n(br,"The "),bn=a(br,"A",{href:!0});var I_=d(bn);mc=n(I_,"RagModel"),I_.forEach(t),uc=n(br," forward method, overrides the "),Xr=a(br,"CODE",{});var W_=d(Xr);gc=n(W_,"__call__"),W_.forEach(t),_c=n(br," special method."),br.forEach(t),fc=h(X),w(pt.$$.fragment,X),vc=h(X),Zr=a(X,"P",{});var H_=d(Zr);bc=n(H_,`RAG is a seq2seq model which encapsulates two core components: a question encoder and a generator. During a forward
pass, we encode the input with the question encoder and pass it to the retriever to extract relevant context
...
any `),gs=a(ve,"EM",{});var bf=d(gs);Al=n(bf,"seq2seq"),bf.forEach(t),Pl=n(ve," model, preferably "),En=a(ve,"A",{href:!0});var Tf=d(En);Nl=n(Tf,"BartForConditionalGeneration"),Tf.forEach(t),Cl=n(ve,"."),ve.forEach(t),Ol=h(H),A=a(H,"P",{});var B=d(A);Sl=n(B,"The model can be initialized with a "),jn=a(B,"A",{href:!0});var wf=d(jn);Ll=n(wf,"RagRetriever"),wf.forEach(t),Dl=n(B,` for end-to-end generation or used in combination with the
outputs of a retriever in multiple steps---see examples for more details. The model is compatible any
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Nd.forEach(t),up=h(H),ce=a(H,"DIV",{class:!0});var Lt=d(ce);w(xo.$$.fragment,Lt),gp=h(Lt),Ne=a(Lt,"P",{});var kr=d(Ne);_p=n(kr,"The "),Nn=a(kr,"A",{href:!0});var Mf=d(Nn);fp=n(Mf,"RagSequenceForGeneration"),Mf.forEach(t),vp=n(kr," forward method, overrides the "),ks=a(kr,"CODE",{});var Af=d(ks);bp=n(Af,"__call__"),Af.forEach(t),Tp=n(kr," special method."),kr.forEach(t),wp=h(Lt),w(_t.$$.fragment,Lt),kp=h(Lt),w(ft.$$.fragment,Lt),Lt.forEach(t),qp=h(H),vt=a(H,"DIV",{class:!0});var Cd=d(vt);w(Ro.$$.fragment,Cd),yp=h(Cd),Fo=a(Cd,"P",{});var Od=d(Fo);xp=n(Od,"Implements RAG sequence \u201Cthorough\u201D decoding. Read the "),Cn=a(Od,"A",{href:!0});var Pf=d(Cn);Rp=n(Pf,"generate()"),Pf.forEach(t),Fp=n(Od,"`\ndocumentation for more information on how to set other generate input parameters."),Od.forEach(t),Cd.forEach(t),H.forEach(t),id=h(r),Ce=a(r,"H2",{class:!0});var Sd=d(Ce);bt=a(Sd,"A",{id:!0,class:!0,href:!0});var Nf=d(bt);qs=a(Nf,"SPAN",{});var Cf=d(qs);w($o.$$.fragment,Cf),Cf.forEach(t),Nf.forEach(t),$p=h(Sd),ys=a(Sd,"SPAN",{});var Of=d(ys);zp=n(Of,"RagTokenForGeneration"),Of.forEach(t),Sd.forEach(t),cd=h(r),j=a(r,"DIV",{class:!0});var Q=d(j);w(zo.$$.fragment,Q),Ep=h(Q),Oe=a(Q,"P",{});var qr=d(Oe);jp=n(qr,"The "),On=a(qr,"A",{href:!0});var Sf=d(On);Gp=n(Sf,"RagTokenForGeneration"),Sf.forEach(t),Mp=n(qr," forward method, overrides the "),xs=a(qr,"CODE",{});var Lf=d(xs);Ap=n(Lf,"__call__"),Lf.forEach(t),Pp=n(qr," special method."),qr.forEach(t),Np=h(Q),w(Tt.$$.fragment,Q),Cp=h(Q),Rs=a(Q,"P",{});var Df=d(Rs);Op=n(Df,"A RAG-token model implementation. It performs RAG-token specific marginalization in the forward pass."),Df.forEach(t),Sp=h(Q),Fs=a(Q,"P",{});var If=d(Fs);Lp=n(If,`RAG is a seq2seq model which encapsulates two core components: a question encoder and a generator. During a forward
pass, we encode the input with the question encoder and pass it to the retriever to extract relevant context
documents. The documents are then prepended to the input. Such contextualized inputs is passed to the generator.`),If.forEach(t),Dp=h(Q),ne=a(Q,"P",{});var be=d(ne);Ip=n(be,"The question encoder can be any "),$s=a(be,"EM",{});var Wf=d($s);Wp=n(Wf,"autoencoding"),Wf.forEach(t),Hp=n(be," model, preferably "),Sn=a(be,"A",{href:!0});var Hf=d(Sn);Bp=n(Hf,"DPRQuestionEncoder"),Hf.forEach(t),Qp=n(be,`, and the generator can be
any `),zs=a(be,"EM",{});var Bf=d(zs);Up=n(Bf,"seq2seq"),Bf.forEach(t),Vp=n(be," model, preferably "),Ln=a(be,"A",{href:!0});var Qf=d(Ln);Kp=n(Qf,"BartForConditionalGeneration"),Qf.forEach(t),Yp=n(be,"."),be.forEach(t),Jp=h(Q),P=a(Q,"P",{});var U=d(P);Xp=n(U,"The model can be initialized with a "),Dn=a(U,"A",{href:!0});var Uf=d(Dn);Zp=n(Uf,"RagRetriever"),Uf.forEach(t),eh=n(U,` for end-to-end generation or used in combination with the
outputs of a retriever in multiple steps---see examples for more details. The model is compatible any
...
`),Hn=a(U,"A",{href:!0});var tv=d(Hn);gh=n(tv,"T5ForConditionalGeneration"),tv.forEach(t),_h=n(U," as the "),Ps=a(U,"CODE",{});var ov=d(Ps);fh=n(ov,"generator"),ov.forEach(t),vh=n(U,"."),U.forEach(t),bh=h(Q),Eo=a(Q,"P",{});var Ld=d(Eo);Th=n(Ld,"This model inherits from "),Bn=a(Ld,"A",{href:!0});var nv=d(Bn);wh=n(nv,"PreTrainedModel"),nv.forEach(t),kh=n(Ld,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Ld.forEach(t),qh=h(Q),jo=a(Q,"P",{});var Dd=d(jo);yh=n(Dd,"This model is also a PyTorch "),Go=a(Dd,"A",{href:!0,rel:!0});var rv=d(Go);xh=n(rv,"torch.nn.Module"),rv.forEach(t),Rh=n(Dd,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Dd.forEach(t),Fh=h(Q),le=a(Q,"DIV",{class:!0});var Dt=d(le);w(Mo.$$.fragment,Dt),$h=h(Dt),Se=a(Dt,"P",{});var yr=d(Se);zh=n(yr,"The "),Qn=a(yr,"A",{href:!0});var sv=d(Qn);Eh=n(sv,"RagTokenForGeneration"),sv.forEach(t),jh=n(yr," forward method, overrides the "),Ns=a(yr,"CODE",{});var av=d(Ns);Gh=n(av,"__call__"),av.forEach(t),Mh=n(yr," special method."),yr.forEach(t),Ah=h(Dt),w(wt.$$.fragment,Dt),Ph=h(Dt),w(kt.$$.fragment,Dt),Dt.forEach(t),Nh=h(Q),qt=a(Q,"DIV",{class:!0});var Id=d(qt);w(Ao.$$.fragment,Id),Ch=h(Id),Cs=a(Id,"P",{});var dv=d(Cs);Oh=n(dv,"Implements RAG token decoding."),dv.forEach(t),Id.forEach(t),Q.forEach(t),ld=h(r),Le=a(r,"H2",{class:!0});var Wd=d(Le);yt=a(Wd,"A",{id:!0,class:!0,href:!0});var iv=d(yt);Os=a(iv,"SPAN",{});var cv=d(Os);w(Po.$$.fragment,cv),cv.forEach(t),iv.forEach(t),Sh=h(Wd),Ss=a(Wd,"SPAN",{});var lv=d(Ss);Lh=n(lv,"TFRagModel"),lv.forEach(t),Wd.forEach(t),pd=h(r),N=a(r,"DIV",{class:!0});var V=d(N);w(No.$$.fragment,V),Dh=h(V),De=a(V,"P",{});var xr=d(De);Ih=n(xr,"The "),Un=a(xr,"A",{href:!0});var pv=d(Un);Wh=n(pv,"TFRagModel"),pv.forEach(t),Hh=n(xr," forward method, overrides the "),Ls=a(xr,"CODE",{});var hv=d(Ls);Bh=n(hv,"__call__"),hv.forEach(t),Qh=n(xr," special method."),xr.forEach(t),Uh=h(V),w(xt.$$.fragment,V),Vh=h(V),Ds=a(V,"P",{});var mv=d(Ds);Kh=n(mv,`RAG is a sequence-to-sequence model which encapsulates two core components: a question encoder and a generator.
During a forward pass, we encode the input with the question encoder and pass it to the retriever to extract
relevant context documents. The documents are then prepended to the input. Such contextualized inputs is passed to
...
any `),Ws=a(Te,"EM",{});var _v=d(Ws);om=n(_v,"seq2seq"),_v.forEach(t),nm=n(Te," model, preferably "),Kn=a(Te,"A",{href:!0});var fv=d(Kn);rm=n(fv,"TFBartForConditionalGeneration"),fv.forEach(t),sm=n(Te,"."),Te.forEach(t),am=h(V),L=a(V,"P",{});var K=d(L);dm=n(K,"The model can be initialized with a "),Yn=a(K,"A",{href:!0});var vv=d(Yn);im=n(vv,"RagRetriever"),vv.forEach(t),cm=n(K,` for end-to-end generation or used in combination with the
outputs of a retriever in multiple steps---see examples for more details. The model is compatible any
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Hd.forEach(t),Em=h(V),Oo=a(V,"P",{});var Bd=d(Oo);jm=n(Bd,"This model is also a Tensorflow "),So=a(Bd,"A",{href:!0,rel:!0});var $v=d(So);Gm=n($v,"tf.keras.Model"),$v.forEach(t),Mm=n(Bd,`
subclass. Use it as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to
...
SavedModel format.`),zv.forEach(t),Nm=h(V),pe=a(V,"DIV",{class:!0});var It=d(pe);w(Lo.$$.fragment,It),Cm=h(It),Ie=a(It,"P",{});var Rr=d(Ie);Om=n(Rr,"The "),er=a(Rr,"A",{href:!0});var Ev=d(er);Sm=n(Ev,"TFRagModel"),Ev.forEach(t),Lm=n(Rr," forward method, overrides the "),Js=a(Rr,"CODE",{});var jv=d(Js);Dm=n(jv,"__call__"),jv.forEach(t),Im=n(Rr," special method."),Rr.forEach(t),Wm=h(It),w(Rt.$$.fragment,It),Hm=h(It),w(Ft.$$.fragment,It),It.forEach(t),V.forEach(t),hd=h(r),We=a(r,"H2",{class:!0});var Qd=d(We);$t=a(Qd,"A",{id:!0,class:!0,href:!0});var Gv=d($t);Xs=a(Gv,"SPAN",{});var Mv=d(Xs);w(Do.$$.fragment,Mv),Mv.forEach(t),Gv.forEach(t),Bm=h(Qd),Zs=a(Qd,"SPAN",{});var Av=d(Zs);Qm=n(Av,"TFRagSequenceForGeneration"),Av.forEach(t),Qd.forEach(t),md=h(r),$=a(r,"DIV",{class:!0});var C=d($);w(Io.$$.fragment,C),Um=h(C),He=a(C,"P",{});var Fr=d(He);Vm=n(Fr,"The "),tr=a(Fr,"A",{href:!0});var Pv=d(tr);Km=n(Pv,"TFRagSequenceForGeneration"),Pv.forEach(t),Ym=n(Fr," forward method, overrides the "),ea=a(Fr,"CODE",{});var Nv=d(ea);Jm=n(Nv,"__call__"),Nv.forEach(t),Xm=n(Fr," special method."),Fr.forEach(t),Zm=h(C),w(zt.$$.fragment,C),eu=h(C),ta=a(C,"P",{});var Cv=d(ta);tu=n(Cv,"A TF RAG-sequence model implementation. It performs RAG-sequence specific marginalization in the forward pass."),Cv.forEach(t),ou=h(C),oa=a(C,"P",{});var Ov=d(oa);nu=n(Ov,`RAG is a sequence-to-sequence model which encapsulates two core components: a question encoder and a generator.
During a forward pass, we encode the input with the question encoder and pass it to the retriever to extract
relevant context documents. The documents are then prepended to the input. Such contextualized inputs is passed to
the generator.`),Ov.forEach(t),ru=h(C),se=a(C,"P",{});var we=d(se);su=n(we,"The question encoder can be any "),na=a(we,"EM",{});var Sv=d(na);au=n(Sv,"autoencoding"),Sv.forEach(t),du=n(we," model, preferably "),or=a(we,"A",{href:!0});var Lv=d(or);iu=n(Lv,"TFDPRQuestionEncoder"),Lv.forEach(t),cu=n(we,`, and the generator can be
any `),ra=a(we,"EM",{});var Dv=d(ra);lu=n(Dv,"seq2seq"),Dv.forEach(t),pu=n(we," model, preferably "),nr=a(we,"A",{href:!0});var Iv=d(nr);hu=n(Iv,"TFBartForConditionalGeneration"),Iv.forEach(t),mu=n(we,"."),we.forEach(t),uu=h(C),D=a(C,"P",{});var Y=d(D);gu=n(Y,"The model can be initialized with a "),rr=a(Y,"A",{href:!0});var Wv=d(rr);_u=n(Wv,"RagRetriever"),Wv.forEach(t),fu=n(Y,` for end-to-end generation or used in combination with the
outputs of a retriever in multiple steps---see examples for more details. The model is compatible any
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Ud.forEach(t),Ou=h(C),Ho=a(C,"P",{});var Vd=d(Ho);Su=n(Vd,"This model is also a Tensorflow "),Bo=a(Vd,"A",{href:!0,rel:!0});var Zv=d(Bo);Lu=n(Zv,"tf.keras.Model"),Zv.forEach(t),Du=n(Vd,`
subclass. Use it as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to
general usage and behavior.`),Vd.forEach(t),Iu=h(C),pa=a(C,"P",{});var eb=d(pa);Wu=n(eb,`The model is in a developing state as it is now fully supports in eager-mode only, and may not be exported in
SavedModel format.`),eb.forEach(t),Hu=h(C),he=a(C,"DIV",{class:!0});var Wt=d(he);w(Qo.$$.fragment,Wt),Bu=h(Wt),Be=a(Wt,"P",{});var $r=d(Be);Qu=n($r,"The "),ir=a($r,"A",{href:!0});var tb=d(ir);Uu=n(tb,"TFRagSequenceForGeneration"),tb.forEach(t),Vu=n($r," forward method, overrides the "),ha=a($r,"CODE",{});var ob=d(ha);Ku=n(ob,"__call__"),ob.forEach(t),Yu=n($r," special method."),$r.forEach(t),Ju=h(Wt),w(Et.$$.fragment,Wt),Xu=h(Wt),w(jt.$$.fragment,Wt),Wt.forEach(t),Zu=h(C),Gt=a(C,"DIV",{class:!0});var Kd=d(Gt);w(Uo.$$.fragment,Kd),eg=h(Kd),Vo=a(Kd,"P",{});var Yd=d(Vo);tg=n(Yd,"Implements RAG sequence \u201Cthorough\u201D decoding. Read the "),cr=a(Yd,"A",{href:!0});var nb=d(cr);og=n(nb,"generate()"),nb.forEach(t),ng=n(Yd,"`\ndocumentation for more information on how to set other generate input parameters"),Yd.forEach(t),Kd.forEach(t),C.forEach(t),ud=h(r),Qe=a(r,"H2",{class:!0});var Jd=d(Qe);Mt=a(Jd,"A",{id:!0,class:!0,href:!0});var rb=d(Mt);ma=a(rb,"SPAN",{});var sb=d(ma);w(Ko.$$.fragment,sb),sb.forEach(t),rb.forEach(t),rg=h(Jd),ua=a(Jd,"SPAN",{});var ab=d(ua);sg=n(ab,"TFRagTokenForGeneration"),ab.forEach(t),Jd.forEach(t),gd=h(r),z=a(r,"DIV",{class:!0});var O=d(z);w(Yo.$$.fragment,O),ag=h(O),Ue=a(O,"P",{});var zr=d(Ue);dg=n(zr,"The "),lr=a(zr,"A",{href:!0});var db=d(lr);ig=n(db,"TFRagTokenForGeneration"),db.forEach(t),cg=n(zr," forward method, overrides the "),ga=a(zr,"CODE",{});var ib=d(ga);lg=n(ib,"__call__"),ib.forEach(t),pg=n(zr," special method."),zr.forEach(t),hg=h(O),w(At.$$.fragment,O),mg=h(O),_a=a(O,"P",{});var cb=d(_a);ug=n(cb,"A TF RAG-token model implementation. It performs RAG-token specific marginalization in the forward pass."),cb.forEach(t),gg=h(O),fa=a(O,"P",{});var lb=d(fa);_g=n(lb,`RAG is a sequence-to-sequence model which encapsulates two core components: a question encoder and a generator.
During a forward pass, we encode the input with the question encoder and pass it to the retriever to extract
relevant context documents. The documents are then prepended to the input. Such contextualized inputs is passed to
the generator.`),lb.forEach(t),fg=h(O),ae=a(O,"P",{});var ke=d(ae);vg=n(ke,"The question encoder can be any "),va=a(ke,"EM",{});var pb=d(va);bg=n(pb,"autoencoding"),pb.forEach(t),Tg=n(ke," model, preferably "),pr=a(ke,"A",{href:!0});var hb=d(pr);wg=n(hb,"TFDPRQuestionEncoder"),hb.forEach(t),kg=n(ke,`, and the generator can be
any `),ba=a(ke,"EM",{});var mb=d(ba);qg=n(mb,"seq2seq"),mb.forEach(t),yg=n(ke," model, preferably "),hr=a(ke,"A",{href:!0});var ub=d(hr);xg=n(ub,"TFBartForConditionalGeneration"),ub.forEach(t),Rg=n(ke,"."),ke.forEach(t),Fg=h(O),I=a(O,"P",{});var J=d(I);$g=n(J,"The model can be initialized with a "),mr=a(J,"A",{href:!0});var gb=d(mr);zg=n(gb,"RagRetriever"),gb.forEach(t),Eg=n(J,` for end-to-end generation or used in combination with the
outputs of a retriever in multiple steps---see examples for more details. The model is compatible any
