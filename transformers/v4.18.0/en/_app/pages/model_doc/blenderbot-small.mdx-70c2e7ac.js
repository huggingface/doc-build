import{S as Hu,i as Ku,s as Vu,e as n,k as l,w as f,t as r,M as Qu,c as a,d as o,m as i,a as s,x as _,h as d,b as c,F as e,g as p,y as g,q as b,o as k,B as v,v as Ju}from"../../chunks/vendor-6b77c823.js";import{T as xn}from"../../chunks/Tip-39098574.js";import{D as M}from"../../chunks/Docstring-af1d0ae0.js";import{C as ro}from"../../chunks/CodeBlock-3a8b25a8.js";import{I as qe}from"../../chunks/IconCopyLink-7a11ce68.js";function Xu(Y){let m,z,y,T,B;return{c(){m=n("p"),z=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),y=n("code"),T=r("Module"),B=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(S){m=a(S,"P",{});var w=s(m);z=d(w,"Although the recipe for forward pass needs to be defined within this function, one should call the "),y=a(w,"CODE",{});var F=s(y);T=d(F,"Module"),F.forEach(o),B=d(w,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),w.forEach(o)},m(S,w){p(S,m,w),e(m,z),e(m,y),e(y,T),e(m,B)},d(S){S&&o(m)}}}function Yu(Y){let m,z,y,T,B;return{c(){m=n("p"),z=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),y=n("code"),T=r("Module"),B=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(S){m=a(S,"P",{});var w=s(m);z=d(w,"Although the recipe for forward pass needs to be defined within this function, one should call the "),y=a(w,"CODE",{});var F=s(y);T=d(F,"Module"),F.forEach(o),B=d(w,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),w.forEach(o)},m(S,w){p(S,m,w),e(m,z),e(m,y),e(y,T),e(m,B)},d(S){S&&o(m)}}}function Zu(Y){let m,z,y,T,B,S,w,F,Ce,ue,x,je,U,Oe,Pe,W,Le,Ne,K,V,Ie,Z,C,P,fe,ae,$e,Q,A,Te,se,L,we,re,Ee,ee,de,le,Ae,J,Me,R,De;return{c(){m=n("p"),z=r("TF 2.0 models accepts two formats as inputs:"),y=l(),T=n("ul"),B=n("li"),S=r("having all inputs as keyword arguments (like PyTorch models), or"),w=l(),F=n("li"),Ce=r("having all inputs as a list, tuple or dict in the first positional arguments."),ue=l(),x=n("p"),je=r("This second option is useful when using "),U=n("code"),Oe=r("tf.keras.Model.fit"),Pe=r(` method which currently requires having all the
...
`),R=a(Be,"CODE",{});var xe=s(R);De=d(xe,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),xe.forEach(o),Be.forEach(o),X.forEach(o)},m(u,q){p(u,m,q),e(m,z),p(u,y,q),p(u,T,q),e(T,B),e(B,S),e(T,w),e(T,F),e(F,Ce),p(u,ue,q),p(u,x,q),e(x,je),e(x,U),e(U,Oe),e(x,Pe),e(x,W),e(W,Le),e(x,Ne),p(u,K,q),p(u,V,q),e(V,Ie),p(u,Z,q),p(u,C,q),e(C,P),e(P,fe),e(P,ae),e(ae,$e),e(P,Q),e(P,A),e(A,Te),e(C,se),e(C,L),e(L,we),e(L,re),e(re,Ee),e(L,ee),e(L,de),e(de,le),e(C,Ae),e(C,J),e(J,Me),e(J,R),e(R,De)},d(u){u&&o(m),u&&o(y),u&&o(T),u&&o(ue),u&&o(x),u&&o(K),u&&o(V),u&&o(Z),u&&o(C)}}}function ef(Y){let m,z,y,T,B;return{c(){m=n("p"),z=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),y=n("code"),T=r("Module"),B=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(S){m=a(S,"P",{});var w=s(m);z=d(w,"Although the recipe for forward pass needs to be defined within this function, one should call the "),y=a(w,"CODE",{});var F=s(y);T=d(F,"Module"),F.forEach(o),B=d(w,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),w.forEach(o)},m(S,w){p(S,m,w),e(m,z),e(m,y),e(y,T),e(m,B)},d(S){S&&o(m)}}}function of(Y){let m,z,y,T,B,S,w,F,Ce,ue,x,je,U,Oe,Pe,W,Le,Ne,K,V,Ie,Z,C,P,fe,ae,$e,Q,A,Te,se,L,we,re,Ee,ee,de,le,Ae,J,Me,R,De;return{c(){m=n("p"),z=r("TF 2.0 models accepts two formats as inputs:"),y=l(),T=n("ul"),B=n("li"),S=r("having all inputs as keyword arguments (like PyTorch models), or"),w=l(),F=n("li"),Ce=r("having all inputs as a list, tuple or dict in the first positional arguments."),ue=l(),x=n("p"),je=r("This second option is useful when using "),U=n("code"),Oe=r("tf.keras.Model.fit"),Pe=r(` method which currently requires having all the
tensors in the first argument of the model call function: `),W=n("code"),Le=r("model(inputs)"),Ne=r("."),K=l(),V=n("p"),Ie=r(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),Z=l(),C=n("ul"),P=n("li"),fe=r("a single Tensor with "),ae=n("code"),$e=r("input_ids"),Q=r(" only and nothing else: "),A=n("code"),Te=r("model(input_ids)"),se=l(),L=n("li"),we=r(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),re=n("code"),Ee=r("model([input_ids, attention_mask])"),ee=r(" or "),de=n("code"),le=r("model([input_ids, attention_mask, token_type_ids])"),Ae=l(),J=n("li"),Me=r(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),R=n("code"),De=r('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(u){m=a(u,"P",{});var q=s(m);z=d(q,"TF 2.0 models accepts two formats as inputs:"),q.forEach(o),y=i(u),T=a(u,"UL",{});var ie=s(T);B=a(ie,"LI",{});var lo=s(B);S=d(lo,"having all inputs as keyword arguments (like PyTorch models), or"),lo.forEach(o),w=i(ie),F=a(ie,"LI",{});var Re=s(F);Ce=d(Re,"having all inputs as a list, tuple or dict in the first positional arguments."),Re.forEach(o),ie.forEach(o),ue=i(u),x=a(u,"P",{});var j=s(x);je=d(j,"This second option is useful when using "),U=a(j,"CODE",{});var io=s(U);Oe=d(io,"tf.keras.Model.fit"),io.forEach(o),Pe=d(j,` method which currently requires having all the
...
first positional argument :`),co.forEach(o),Z=i(u),C=a(u,"UL",{});var X=s(C);P=a(X,"LI",{});var D=s(P);fe=d(D,"a single Tensor with "),ae=a(D,"CODE",{});var po=s(ae);$e=d(po,"input_ids"),po.forEach(o),Q=d(D," only and nothing else: "),A=a(D,"CODE",{});var ho=s(A);Te=d(ho,"model(input_ids)"),ho.forEach(o),D.forEach(o),se=i(X),L=a(X,"LI",{});var oe=s(L);we=d(oe,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),re=a(oe,"CODE",{});var ce=s(re);Ee=d(ce,"model([input_ids, attention_mask])"),ce.forEach(o),ee=d(oe," or "),de=a(oe,"CODE",{});var _e=s(de);le=d(_e,"model([input_ids, attention_mask, token_type_ids])"),_e.forEach(o),oe.forEach(o),Ae=i(X),J=a(X,"LI",{});var Be=s(J);Me=d(Be,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),R=a(Be,"CODE",{});var xe=s(R);De=d(xe,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),xe.forEach(o),Be.forEach(o),X.forEach(o)},m(u,q){p(u,m,q),e(m,z),p(u,y,q),p(u,T,q),e(T,B),e(B,S),e(T,w),e(T,F),e(F,Ce),p(u,ue,q),p(u,x,q),e(x,je),e(x,U),e(U,Oe),e(x,Pe),e(x,W),e(W,Le),e(x,Ne),p(u,K,q),p(u,V,q),e(V,Ie),p(u,Z,q),p(u,C,q),e(C,P),e(P,fe),e(P,ae),e(ae,$e),e(P,Q),e(P,A),e(A,Te),e(C,se),e(C,L),e(L,we),e(L,re),e(re,Ee),e(L,ee),e(L,de),e(de,le),e(C,Ae),e(C,J),e(J,Me),e(J,R),e(R,De)},d(u){u&&o(m),u&&o(y),u&&o(T),u&&o(ue),u&&o(x),u&&o(K),u&&o(V),u&&o(Z),u&&o(C)}}}function tf(Y){let m,z,y,T,B;return{c(){m=n("p"),z=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),y=n("code"),T=r("Module"),B=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(S){m=a(S,"P",{});var w=s(m);z=d(w,"Although the recipe for forward pass needs to be defined within this function, one should call the "),y=a(w,"CODE",{});var F=s(y);T=d(F,"Module"),F.forEach(o),B=d(w,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),w.forEach(o)},m(S,w){p(S,m,w),e(m,z),e(m,y),e(y,T),e(m,B)},d(S){S&&o(m)}}}function nf(Y){let m,z,y,T,B;return{c(){m=n("p"),z=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),y=n("code"),T=r("Module"),B=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(S){m=a(S,"P",{});var w=s(m);z=d(w,"Although the recipe for forward pass needs to be defined within this function, one should call the "),y=a(w,"CODE",{});var F=s(y);T=d(F,"Module"),F.forEach(o),B=d(w,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),w.forEach(o)},m(S,w){p(S,m,w),e(m,z),e(m,y),e(y,T),e(m,B)},d(S){S&&o(m)}}}function af(Y){let m,z,y,T,B,S,w,F,Ce,ue,x,je,U,Oe,Pe,W,Le,Ne,K,V,Ie,Z,C,P,fe,ae,$e,Q,A,Te,se,L,we,re,Ee,ee,de,le,Ae,J,Me,R,De,u,q,ie,lo,Re,j,io,Se,co,X,D,po,ho,oe,ce,_e,Be,xe,hd,la,md,ur,pe,ot,ud,mo,fd,zn,_d,gd,tt,bd,kd,vd,uo,yd,Fn,Td,wd,qn,Sd,Bd,xd,ia,zd,Fd,nt,fr,fo,Eo,ca,at,qd,pa,$d,_r,G,st,Ed,ha,Md,Cd,rt,jd,$n,Od,Pd,Ld,He,dt,Nd,ma,Id,Ad,ua,Dd,Gd,Mo,lt,Ud,_o,Wd,fa,Rd,Hd,_a,Kd,Vd,Qd,Ke,it,Jd,En,Xd,Mn,Yd,Zd,ga,el,ol,Cn,ct,gr,go,Co,ba,pt,tl,ka,nl,br,Ge,ht,al,mt,sl,va,rl,dl,ll,jo,ut,il,ya,cl,kr,bo,Oo,Ta,ft,pl,wa,hl,vr,ze,_t,ml,gt,ul,jn,fl,_l,gl,bt,bl,kt,kl,vl,yl,ge,vt,Tl,ko,wl,On,Sl,Bl,Sa,xl,zl,Fl,Po,ql,Ba,$l,El,yt,yr,vo,Lo,xa,Tt,Ml,za,Cl,Tr,Fe,wt,jl,St,Ol,Pn,Pl,Ll,Nl,Bt,Il,xt,Al,Dl,Gl,be,zt,Ul,yo,Wl,Ln,Rl,Hl,Fa,Kl,Vl,Ql,No,Jl,qa,Xl,Yl,Ft,wr,To,Io,$a,qt,Zl,Ea,ei,Sr,wo,$t,oi,Ve,Et,ti,Ma,ni,ai,Mt,Br,So,Ao,Ca,Ct,si,ja,ri,xr,he,jt,di,Ot,li,Nn,ii,ci,pi,Pt,hi,Lt,mi,ui,fi,Do,_i,ke,Nt,gi,Bo,bi,In,ki,vi,Oa,yi,Ti,wi,Go,Si,Pa,Bi,xi,It,zr,xo,Uo,La,At,zi,Na,Fi,Fr,me,Dt,qi,Gt,$i,An,Ei,Mi,Ci,Ut,ji,Wt,Oi,Pi,Li,Wo,Ni,O,Rt,Ii,zo,Ai,Dn,Di,Gi,Ia,Ui,Wi,Ri,Ro,Hi,Aa,Ki,Vi,Da,Ga,Ua,Wa,Qi,Ji,Ra,Ha,Ka,Va,Xi,Yi,Qa,Ja,Xa,Ya,Zi,ec,Za,es,os,Ht,oc,ts,tc,nc,ac,ns,as,ss,rs,sc,qr,Fo,Ho,ds,Kt,rc,ls,dc,$r,N,Vt,lc,Qt,ic,Gn,cc,pc,hc,Jt,mc,Xt,uc,fc,_c,is,gc,bc,Ue,cs,Yt,kc,vc,ps,Zt,yc,Tc,hs,en,wc,Sc,ms,on,Bc,xc,Qe,tn,zc,us,Fc,qc,nn,$c,Je,an,Ec,fs,Mc,Cc,sn,jc,Xe,rn,Oc,_s,Pc,Lc,dn,Er,qo,Ko,gs,ln,Nc,bs,Ic,Mr,I,cn,Ac,pn,Dc,Un,Gc,Uc,Wc,hn,Rc,mn,Hc,Kc,Vc,ks,Qc,Jc,We,vs,un,Xc,Yc,ys,fn,Zc,ep,Ts,_n,op,tp,ws,gn,np,ap,$,bn,sp,$o,rp,Ss,dp,lp,Bs,ip,cp,pp,Vo,hp,xs,mp,up,zs,Fs,qs,$s,fp,_p,Es,Ms,Cs,js,gp,bp,Os,Ps,Ls,Ns,kp,vp,Is,As,kn,Qo,Jo,Ds,vn,yp,Gs,Tp,wp,Us,Sp,Bp,Ws,xp,zp,Rs,Hs,Ks,Vs,Fp,qp,Qs,Js,Xs,Ys,$p,Ep,Zs,er,or,tr,Mp,Cp,nr,ar,sr,rr,jp,Op,Ye,yn,Pp,dr,Lp,Np,Tn,Ip,Ze,wn,Ap,lr,Dp,Gp,Sn,Cr;return S=new qe({}),se=new qe({}),xe=new qe({}),ot=new M({props:{name:"class transformers.BlenderbotSmallConfig",anchor:"transformers.BlenderbotSmallConfig",parameters:[{name:"vocab_size",val:" = 50265"},{name:"max_position_embeddings",val:" = 512"},{name:"encoder_layers",val:" = 8"},{name:"encoder_ffn_dim",val:" = 2048"},{name:"encoder_attention_heads",val:" = 16"},{name:"decoder_layers",val:" = 8"},{name:"decoder_ffn_dim",val:" = 2048"},{name:"decoder_attention_heads",val:" = 16"},{name:"encoder_layerdrop",val:" = 0.0"},{name:"decoder_layerdrop",val:" = 0.0"},{name:"use_cache",val:" = True"},{name:"is_encoder_decoder",val:" = True"},{name:"activation_function",val:" = 'gelu'"},{name:"d_model",val:" = 512"},{name:"dropout",val:" = 0.1"},{name:"attention_dropout",val:" = 0.0"},{name:"activation_dropout",val:" = 0.0"},{name:"init_std",val:" = 0.02"},{name:"decoder_start_token_id",val:" = 1"},{name:"classifier_dropout",val:" = 0.0"},{name:"scale_embedding",val:" = False"},{name:"pad_token_id",val:" = 0"},{name:"bos_token_id",val:" = 1"},{name:"eos_token_id",val:" = 2"},{name:"forced_eos_token_id",val:" = 2"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/v4.18.0/src/transformers/models/blenderbot_small/configuration_blenderbot_small.py#L36",parametersDescription:[{anchor:"transformers.BlenderbotSmallConfig.vocab_size",description:`<strong>vocab_size</strong> (<code>int</code>, <em>optional</em>, defaults to 50265) &#x2014;
...
`}}),Po=new xn({props:{$$slots:{default:[Xu]},$$scope:{ctx:Y}}}),yt=new ro({props:{code:`from transformers import BlenderbotSmallTokenizer, BlenderbotSmallModel
...
<span class="hljs-meta">&gt;&gt;&gt; </span>outputs = model.decode(decoder_input_ids, encoder_outputs)
<span class="hljs-meta">&gt;&gt;&gt; </span>logits = outputs.logits`}}),{c(){m=n("meta"),z=l(),y=n("h1"),T=n("a"),B=n("span"),f(S.$$.fragment),w=l(),F=n("span"),Ce=r("Blenderbot Small"),ue=l(),x=n("p"),je=r("Note that "),U=n("a"),Oe=r("BlenderbotSmallModel"),Pe=r(` and
...
and behavior.`),yl=l(),ge=n("div"),f(vt.$$.fragment),Tl=l(),ko=n("p"),wl=r("The "),On=n("a"),Sl=r("BlenderbotSmallModel"),Bl=r(" forward method, overrides the "),Sa=n("code"),xl=r("__call__"),zl=r(" special method."),Fl=l(),f(Po.$$.fragment),ql=l(),Ba=n("p"),$l=r("Example:"),El=l(),f(yt.$$.fragment),yr=l(),vo=n("h2"),Lo=n("a"),xa=n("span"),f(Tt.$$.fragment),Ml=l(),za=n("span"),Cl=r("BlenderbotSmallForConditionalGeneration"),Tr=l(),Fe=n("div"),f(wt.$$.fragment),jl=l(),St=n("p"),Ol=r(`The BlenderbotSmall Model with a language modeling head. Can be used for summarization.
...
tokenizer([ARTICLE_TO_SUMMARIZE], max_length=1024, return_tensors=\u2018np\u2019)`),vp=l(),Is=n("blockquote"),As=n("blockquote"),kn=n("blockquote"),Qo=n("h1"),Jo=n("a"),Ds=n("span"),f(vn.$$.fragment),yp=l(),Gs=n("span"),Tp=r("Generate Summary >>> summary_ids = model.generate(inputs[\u2018input_ids\u2019]).sequences >>>"),wp=l(),Us=n("p"),Sp=r("print(tokenizer.batch_decode(summary_ids, skip_special_tokens=True, clean_up_tokenization_spaces=False))"),Bp=l(),Ws=n("p"),xp=r("Mask filling example:"),zp=l(),Rs=n("blockquote"),Hs=n("blockquote"),Ks=n("blockquote"),Vs=n("p"),Fp=r(`from transformers import BlenderbotSmallTokenizer, FlaxBlenderbotSmallForConditionalGeneration >>>
...
jax.nn.softmax(logits[0, masked_index], axis=0) >>> values, predictions = jax.lax.top_k(probs)`),Cp=l(),nr=n("blockquote"),ar=n("blockquote"),sr=n("blockquote"),rr=n("p"),jp=r("tokenizer.decode(predictions).split()"),Op=l(),Ye=n("div"),f(yn.$$.fragment),Pp=l(),dr=n("p"),Lp=r("Example:"),Np=l(),f(Tn.$$.fragment),Ip=l(),Ze=n("div"),f(wn.$$.fragment),Ap=l(),lr=n("p"),Dp=r("Example:"),Gp=l(),f(Sn.$$.fragment),this.h()},l(t){const h=Qu('[data-svelte="svelte-1phssyn"]',document.head);m=a(h,"META",{name:!0,content:!0}),h.forEach(o),z=i(t),y=a(t,"H1",{class:!0});var Bn=s(y);T=a(Bn,"A",{id:!0,class:!0,href:!0});var ir=s(T);B=a(ir,"SPAN",{});var cr=s(B);_(S.$$.fragment,cr),cr.forEach(o),ir.forEach(o),w=i(Bn),F=a(Bn,"SPAN",{});var pr=s(F);Ce=d(pr,"Blenderbot Small"),pr.forEach(o),Bn.forEach(o),ue=i(t),x=a(t,"P",{});var ve=s(x);je=d(ve,"Note that "),U=a(ve,"A",{href:!0});var hr=s(U);Oe=d(hr,"BlenderbotSmallModel"),hr.forEach(o),Pe=d(ve,` and
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Rr.forEach(o),yl=i(Xo),ge=a(Xo,"DIV",{class:!0});var oo=s(ge);_(vt.$$.fragment,oo),Tl=i(oo),ko=a(oo,"P",{});var Xn=s(ko);wl=d(Xn,"The "),On=a(Xn,"A",{href:!0});var Mh=s(On);Sl=d(Mh,"BlenderbotSmallModel"),Mh.forEach(o),Bl=d(Xn," forward method, overrides the "),Sa=a(Xn,"CODE",{});var Ch=s(Sa);xl=d(Ch,"__call__"),Ch.forEach(o),zl=d(Xn," special method."),Xn.forEach(o),Fl=i(oo),_(Po.$$.fragment,oo),ql=i(oo),Ba=a(oo,"P",{});var jh=s(Ba);$l=d(jh,"Example:"),jh.forEach(o),El=i(oo),_(yt.$$.fragment,oo),oo.forEach(o),Xo.forEach(o),yr=i(t),vo=a(t,"H2",{class:!0});var Hr=s(vo);Lo=a(Hr,"A",{id:!0,class:!0,href:!0});var Oh=s(Lo);xa=a(Oh,"SPAN",{});var Ph=s(xa);_(Tt.$$.fragment,Ph),Ph.forEach(o),Oh.forEach(o),Ml=i(Hr),za=a(Hr,"SPAN",{});var Lh=s(za);Cl=d(Lh,"BlenderbotSmallForConditionalGeneration"),Lh.forEach(o),Hr.forEach(o),Tr=i(t),Fe=a(t,"DIV",{class:!0});var Yo=s(Fe);_(wt.$$.fragment,Yo),jl=i(Yo),St=a(Yo,"P",{});var Kr=s(St);Ol=d(Kr,`The BlenderbotSmall Model with a language modeling head. Can be used for summarization.
...
\u201D<s>I\u2019m not sure.\u201D \u2026 )`),nd.forEach(o),wm.forEach(o),Tm.forEach(o),ym.forEach(o),ac=i(H),ns=a(H,"BLOCKQUOTE",{});var Bm=s(ns);as=a(Bm,"BLOCKQUOTE",{});var xm=s(as);ss=a(xm,"BLOCKQUOTE",{});var zm=s(ss);rs=a(zm,"P",{});var Fm=s(rs);sc=d(Fm,`inputs = tokenizer([NEXT_UTTERANCE], return_tensors=\u2018tf\u2019) >>> inputs.pop(\u201Ctoken_type_ids\u201D) >>>
next_reply_ids = model.generate(**inputs) >>> print(\u201CBot: \u201D, tokenizer.batch_decode(next_reply_ids,
