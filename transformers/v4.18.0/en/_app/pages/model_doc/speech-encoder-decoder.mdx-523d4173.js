...
<span class="hljs-meta">&gt;&gt;&gt; </span>model = SpeechEncoderDecoderModel.from_pretrained(<span class="hljs-string">&quot;./wav2vec2bert&quot;</span>)`}}),{c(){i=a("p"),v=n("Example:"),u=h(),E(p.$$.fragment)},l(d){i=s(d,"P",{});var f=c(i);v=t(f,"Example:"),f.forEach(o),u=m(d),k(p.$$.fragment,d)},m(d,f){b(d,i,f),e(i,v),b(d,u,f),S(p,d,f),g=!0},p:en,i(d){g||($(p.$$.fragment,d),g=!0)},o(d){x(p.$$.fragment,d),g=!1},d(d){d&&o(i),d&&o(u),T(p,d)}}}function gs(q){let i,v,u,p,g;return{c(){i=a("p"),v=n("Although the recipe for forward pass needs to be defined within this function, one should call the "),u=a("code"),p=n("Module"),g=n(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(d){i=s(d,"P",{});var f=c(i);v=t(f,"Although the recipe for forward pass needs to be defined within this function, one should call the "),u=s(f,"CODE",{});var N=c(u);p=t(N,"Module"),N.forEach(o),g=t(f,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
<span class="hljs-comment"># Assert something? More interesting input? dtype correct?</span>`}}),{c(){i=a("p"),v=n("Examples:"),u=h(),E(p.$$.fragment)},l(d){i=s(d,"P",{});var f=c(i);v=t(f,"Examples:"),f.forEach(o),u=m(d),k(p.$$.fragment,d)},m(d,f){b(d,i,f),e(i,v),b(d,u,f),S(p,d,f),g=!0},p:en,i(d){g||($(p.$$.fragment,d),g=!0)},o(d){x(p.$$.fragment,d),g=!1},d(d){d&&o(i),d&&o(u),T(p,d)}}}function vs(q){let i,v,u,p,g;return p=new on({props:{code:`from transformers import FlaxSpeechEncoderDecoderModel
...
</ul>`,name:"kwargs"}],source:"https://github.com/huggingface/transformers/blob/v4.18.0/src/transformers/models/speech_encoder_decoder/configuration_speech_encoder_decoder.py#L27"}}),te=new Xo({props:{anchor:"transformers.SpeechEncoderDecoderConfig.example",$$slots:{default:[hs]},$$scope:{ctx:q}}}),ye=new ee({props:{name:"from_encoder_decoder_configs",anchor:"transformers.SpeechEncoderDecoderConfig.from_encoder_decoder_configs",parameters:[{name:"encoder_config",val:": PretrainedConfig"},{name:"decoder_config",val:": PretrainedConfig"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/v4.18.0/src/transformers/models/speech_encoder_decoder/configuration_speech_encoder_decoder.py#L92",returnDescription:`
<p>An instance of a configuration object</p>
`,returnType:`
<p><a
  href="/docs/transformers/v4.18.0/en/model_doc/speech-encoder-decoder#transformers.SpeechEncoderDecoderConfig"
>SpeechEncoderDecoderConfig</a></p>
`}}),Ee=new ee({props:{name:"to_dict",anchor:"transformers.SpeechEncoderDecoderConfig.to_dict",parameters:[],source:"https://github.com/huggingface/transformers/blob/v4.18.0/src/transformers/models/speech_encoder_decoder/configuration_speech_encoder_decoder.py#L109",returnDescription:`
...
library (<em>pip install soundfile</em>). To prepare the array into <em>inputs</em>, either the <a href="/docs/transformers/v4.18.0/en/model_doc/wav2vec2#transformers.Wav2Vec2Processor">Wav2Vec2Processor</a> or
<a href="/docs/transformers/v4.18.0/en/model_doc/speech_to_text#transformers.Speech2TextProcessor">Speech2TextProcessor</a> should be used for padding and conversion into a tensor of type
...
</ul>`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/v4.18.0/src/transformers/models/speech_encoder_decoder/modeling_speech_encoder_decoder.py#L441",returnDescription:`
<p>A <a
...
<p>Behaves differently depending on whether a <code>config</code> is provided or automatically loaded.`,name:"kwargs"}],source:"https://github.com/huggingface/transformers/blob/v4.18.0/src/transformers/models/speech_encoder_decoder/modeling_speech_encoder_decoder.py#L285"}}),ie=new Xo({props:{anchor:"transformers.SpeechEncoderDecoderModel.from_encoder_decoder_pretrained.example",$$slots:{default:[us]},$$scope:{ctx:q}}}),Fe=new Tn({}),Ce=new ee({props:{name:"class transformers.FlaxSpeechEncoderDecoderModel",anchor:"transformers.FlaxSpeechEncoderDecoderModel",parameters:[{name:"config",val:": SpeechEncoderDecoderConfig"},{name:"input_shape",val:": typing.Optional[typing.Tuple] = None"},{name:"seed",val:": int = 0"},{name:"dtype",val:": dtype = <class 'jax._src.numpy.lax_numpy.float32'>"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.FlaxSpeechEncoderDecoderModel.config",description:`<strong>config</strong> (<a href="/docs/transformers/v4.18.0/en/model_doc/speech-encoder-decoder#transformers.SpeechEncoderDecoderConfig">SpeechEncoderDecoderConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
...
If set to <code>True</code>, the model will return a <code>FlaxSeq2SeqLMOutput</code> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/v4.18.0/src/transformers/models/speech_encoder_decoder/modeling_flax_speech_encoder_decoder.py#L633",returnDescription:`
<p>A <a
...
loaded via `),ro=a("a"),St=n("from_pretrained()"),$t=n(` function and the decoder is loaded via
`),ao=a("a"),xt=n("from_pretrained()"),Tt=n(` function. Cross-attention layers are automatically added to the decoder
and should be fine-tuned on a downstream generative task, like summarization.`),Mt=h(),$e=a("p"),Dt=n(`The effectiveness of initializing sequence-to-sequence models with pretrained checkpoints for sequence generation
tasks was shown in `),xe=a("a"),jt=n(`Leveraging Pre-trained Checkpoints for Sequence Generation
...
`),po=a("a"),Sr=n("from_pretrained()"),$r=n(` function. Cross-attention layers are automatically added to the decoder
and should be fine-tuned on a downstream generative task, like summarization.`),xr=h(),Ae=a("p"),Tr=n(`The effectiveness of initializing sequence-to-sequence models with pretrained checkpoints for sequence generation
...
with any pretrained speech autoencoding model as the encoder (`),$o=s(z,"EM",{});var Ko=c($o);Pn=t(Ko,"e.g."),Ko.forEach(o),zn=m(z),Ye=s(z,"A",{href:!0});var la=c(Ye);Fn=t(la,"Wav2Vec2"),la.forEach(o),Cn=t(z,", "),Ze=s(z,"A",{href:!0});var pa=c(Ze);An=t(pa,"Hubert"),pa.forEach(o),Ln=t(z,") and any pretrained autoregressive model as the decoder."),z.forEach(o),tn=m(r),I=s(r,"P",{});var uo=c(I);Nn=t(uo,`The effectiveness of initializing speech-sequence-to-text-sequence models with pretrained checkpoints for speech
recognition and speech translation has `),xo=s(uo,"EM",{});var ha=c(xo);In=t(ha,"e.g."),ha.forEach(o),Vn=t(uo," been shown in "),_e=s(uo,"A",{href:!0,rel:!0});var ma=c(_e);Wn=t(ma,`Large-Scale Self- and Semi-Supervised Learning for Speech
...
configuration and decoder model configuration.`),un.forEach(o),fn.forEach(o),mt=m(L),ae=s(L,"DIV",{class:!0});var gn=c(ae);k(Ee.$$.fragment,gn),ft=m(gn),H=s(gn,"P",{});var vo=c(H);ut=t(vo,"Serializes this instance to a Python dictionary. Override the default "),Do=s(vo,"EM",{});var Sa=c(Do);gt=t(Sa,"to_dict()"),Sa.forEach(o),_t=t(vo," from "),jo=s(vo,"EM",{});var $a=c(jo);vt=t($a,"PretrainedConfig"),$a.forEach(o),bt=t(vo,"."),vo.forEach(o),gn.forEach(o),L.forEach(o),dn=m(r),G=s(r,"H2",{class:!0});var _n=c(G);se=s(_n,"A",{id:!0,class:!0,href:!0});var xa=c(se);qo=s(xa,"SPAN",{});var Ta=c(qo);k(ke.$$.fragment,Ta),Ta.forEach(o),xa.forEach(o),yt=m(_n),Po=s(_n,"SPAN",{});var Ma=c(Po);wt=t(Ma,"SpeechEncoderDecoderModel"),Ma.forEach(o),_n.forEach(o),cn=m(r),y=s(r,"DIV",{class:!0});var M=c(y);k(Se.$$.fragment,M),Et=m(M),J=s(M,"P",{});var bo=c(J);kt=t(bo,`This class can be used to initialize a speech-sequence-to-text-sequence model with any pretrained speech
autoencoding model as the encoder and any pretrained text autoregressive model as the decoder. The encoder is
loaded via `),ro=s(bo,"A",{href:!0});var Da=c(ro);St=t(Da,"from_pretrained()"),Da.forEach(o),$t=t(bo,` function and the decoder is loaded via
`),ao=s(bo,"A",{href:!0});var ja=c(ao);xt=t(ja,"from_pretrained()"),ja.forEach(o),Tt=t(bo,` function. Cross-attention layers are automatically added to the decoder
and should be fine-tuned on a downstream generative task, like summarization.`),bo.forEach(o),Mt=m(M),$e=s(M,"P",{});var vn=c($e);Dt=t(vn,`The effectiveness of initializing sequence-to-sequence models with pretrained checkpoints for sequence generation
tasks was shown in `),xe=s(vn,"A",{href:!0,rel:!0});var qa=c(xe);jt=t(qa,`Leveraging Pre-trained Checkpoints for Sequence Generation
...
`),po=s(Eo,"A",{href:!0});var Ja=c(po);Sr=t(Ja,"from_pretrained()"),Ja.forEach(o),$r=t(Eo,` function. Cross-attention layers are automatically added to the decoder
and should be fine-tuned on a downstream generative task, like summarization.`),Eo.forEach(o),xr=m(D),Ae=s(D,"P",{});var kn=c(Ae);Tr=t(kn,`The effectiveness of initializing sequence-to-sequence models with pretrained checkpoints for sequence generation
...
models (see the examples for more information).`),Ka.forEach(o),Ar=m(D),Ve=s(D,"P",{});var $n=c(Ve);Lr=t($n,"This model inherits from "),ho=s($n,"A",{href:!0});var Qa=c(ho);Nr=t(Qa,"FlaxPreTrainedModel"),Qa.forEach(o),Ir=t($n,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),$n.forEach(o),Vr=m(D),We=s(D,"P",{});var xn=c(We);Wr=t(xn,`This model is also a Flax Linen
`),Oe=s(xn,"A",{href:!0,rel:!0});var Xa=c(Oe);Or=t(Xa,"flax.nn.Module"),Xa.forEach(o),Br=t(xn,` subclass. Use it as a
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),xn.forEach(o),Rr=m(D),O=s(D,"P",{});var Ge=c(O);mo=s(Ge,"A",{href:!0});var es=c(mo);Ur=t(es,"FlaxSpeechEncoderDecoderModel"),es.forEach(o),Hr=t(Ge,` is a generic model class that will be instantiated as a transformer architecture
with the module (flax.nn.Module) of one of the base model classes of the library as encoder module and another one
