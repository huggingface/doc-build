import{S as jk,i as Sk,s as Ok,e as n,k as d,w as m,t as r,M as Ak,c as s,d as t,m as l,a,x as g,h as i,b as c,F as e,g as u,y as f,q as _,o as k,B as v,v as Ik}from"../../chunks/vendor-6b77c823.js";import{T as $o}from"../../chunks/Tip-39098574.js";import{D as M}from"../../chunks/Docstring-abef54e3.js";import{C as Se}from"../../chunks/CodeBlock-3a8b25a8.js";import{I as Z}from"../../chunks/IconCopyLink-7a11ce68.js";function Lk(B){let h,z,b,P,x;return{c(){h=n("p"),z=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),b=n("code"),P=r("Module"),x=r(`
...
`),oe=s(H,"CODE",{});var kt=a(oe);R=i(kt,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),kt.forEach(t),H.forEach(t),I.forEach(t)},m(y,$){u(y,h,$),e(h,z),u(y,b,$),u(y,P,$),e(P,x),e(x,w),e(P,T),e(P,F),e(F,Oe),u(y,me,$),u(y,q,$),e(q,Pe),e(q,ae),e(ae,Ae),e(q,re),e(q,ie),e(ie,Ie),e(q,Me),u(y,N,$),u(y,O,$),e(O,xe),u(y,K,$),u(y,j,$),e(j,S),e(S,Le),e(S,Y),e(Y,ee),e(S,Ge),e(S,D),e(D,Ne),e(j,De),e(j,A),e(A,ge),e(A,de),e(de,Ce),e(A,te),e(A,V),e(V,Ue),e(j,We),e(j,U),e(U,Be),e(U,oe),e(oe,R)},d(y){y&&t(h),y&&t(b),y&&t(P),y&&t(me),y&&t(q),y&&t(N),y&&t(O),y&&t(K),y&&t(j)}}}function Dk(B){let h,z,b,P,x;return{c(){h=n("p"),z=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),b=n("code"),P=r("Module"),x=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(w){h=s(w,"P",{});var T=a(h);z=i(T,"Although the recipe for forward pass needs to be defined within this function, one should call the "),b=s(T,"CODE",{});var F=a(b);P=i(F,"Module"),F.forEach(t),x=i(T,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),T.forEach(t)},m(w,T){u(w,h,T),e(h,z),e(h,b),e(b,P),e(h,x)},d(w){w&&t(h)}}}function Uk(B){let h,z,b,P,x,w,T,F,Oe,me,q,Pe,ae,Ae,re,ie,Ie,Me,N,O,xe,K,j,S,Le,Y,ee,Ge,D,Ne,De,A,ge,de,Ce,te,V,Ue,We,U,Be,oe,R;return{c(){h=n("p"),z=r("TF 2.0 models accepts two formats as inputs:"),b=d(),P=n("ul"),x=n("li"),w=r("having all inputs as keyword arguments (like PyTorch models), or"),T=d(),F=n("li"),Oe=r("having all inputs as a list, tuple or dict in the first positional arguments."),me=d(),q=n("p"),Pe=r("This second option is useful when using "),ae=n("code"),Ae=r("tf.keras.Model.fit"),re=r(` method which currently requires having all the
tensors in the first argument of the model call function: `),ie=n("code"),Ie=r("model(inputs)"),Me=r("."),N=d(),O=n("p"),xe=r(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),K=d(),j=n("ul"),S=n("li"),Le=r("a single Tensor with "),Y=n("code"),ee=r("input_ids"),Ge=r(" only and nothing else: "),D=n("code"),Ne=r("model(input_ids)"),De=d(),A=n("li"),ge=r(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),de=n("code"),Ce=r("model([input_ids, attention_mask])"),te=r(" or "),V=n("code"),Ue=r("model([input_ids, attention_mask, token_type_ids])"),We=d(),U=n("li"),Be=r(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),oe=n("code"),R=r('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(y){h=s(y,"P",{});var $=a(h);z=i($,"TF 2.0 models accepts two formats as inputs:"),$.forEach(t),b=l(y),P=s(y,"UL",{});var ze=a(P);x=s(ze,"LI",{});var mt=a(x);w=i(mt,"having all inputs as keyword arguments (like PyTorch models), or"),mt.forEach(t),T=l(ze),F=s(ze,"LI",{});var Fe=a(F);Oe=i(Fe,"having all inputs as a list, tuple or dict in the first positional arguments."),Fe.forEach(t),ze.forEach(t),me=l(y),q=s(y,"P",{});var Q=a(q);Pe=i(Q,"This second option is useful when using "),ae=s(Q,"CODE",{});var gt=a(ae);Ae=i(gt,"tf.keras.Model.fit"),gt.forEach(t),re=i(Q,` method which currently requires having all the
...
the latter silently ignores them.`)},l(w){h=s(w,"P",{});var T=a(h);z=i(T,"Although the recipe for forward pass needs to be defined within this function, one should call the "),b=s(T,"CODE",{});var F=a(b);P=i(F,"Module"),F.forEach(t),x=i(T,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),T.forEach(t)},m(w,T){u(w,h,T),e(h,z),e(h,b),e(b,P),e(h,x)},d(w){w&&t(h)}}}function Rk(B){let h,z,b,P,x;return{c(){h=n("p"),z=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),b=n("code"),P=r("Module"),x=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(w){h=s(w,"P",{});var T=a(h);z=i(T,"Although the recipe for forward pass needs to be defined within this function, one should call the "),b=s(T,"CODE",{});var F=a(b);P=i(F,"Module"),F.forEach(t),x=i(T,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),T.forEach(t)},m(w,T){u(w,h,T),e(h,z),e(h,b),e(b,P),e(h,x)},d(w){w&&t(h)}}}function Hk(B){let h,z,b,P,x,w,T,F,Oe,me,q,Pe,ae,Ae,re,ie,Ie,Me,N,O,xe,K,j,S,Le,Y,ee,Ge,D,Ne,De,A,ge,de,Ce,te,V,Ue,We,U,Be,oe,R,y,$,ze,mt,Fe,Q,gt,Ve,le,I,J,$e,ft,X,_t,Qe,H,kt,qo,Yd,el,ca,tl,ol,Mi,fe,ua,nl,sl,pa,al,rl,ha,il,dl,Eo,ll,Mo,cl,ul,pl,Bt,Co,hl,ml,jo,gl,fl,Ci,vt,Rt,ma,So,_l,ga,kl,ji,Je,Ht,Oo,vl,yl,Ao,bl,Tl,wl,fa,Pl,xl,_a,zl,Si,yt,Kt,ka,Io,Fl,va,$l,Oi,_e,ya,ba,ql,El,Ta,xs,Ml,zs,Cl,jl,Lo,wa,Sl,Ol,bt,Pa,Al,Il,xa,Ll,Gl,Go,Nl,za,Dl,Ul,Wl,Fa,Re,Bl,$a,Rl,Hl,qa,Kl,Vl,Ea,Ql,Jl,Xl,Ma,Tt,Zl,No,Yl,ec,Ca,tc,oc,Ai,wt,Vt,ja,Do,nc,Sa,sc,Ii,Uo,Li,Pt,Qt,Oa,Wo,ac,Aa,rc,Gi,ce,Bo,ic,xt,dc,Fs,lc,cc,Ro,uc,pc,hc,zt,mc,$s,gc,fc,qs,_c,kc,vc,Ia,yc,bc,Ho,Ni,Ft,Jt,La,Ko,Tc,Ga,wc,Di,Xt,Pc,Na,xc,zc,Ui,W,Vo,Fc,Qo,$c,Jo,qc,Ec,Mc,Xo,Cc,Es,jc,Sc,Oc,je,Zo,Ac,Yo,Ic,Da,Lc,Gc,Nc,en,Ms,Dc,Ua,Uc,Wc,tn,Bc,Wa,Rc,Hc,Kc,Ba,Vc,Qc,Zt,on,Jc,Ra,Xc,Zc,Yt,nn,Yc,Ha,eu,tu,eo,sn,ou,Ka,nu,Wi,$t,to,Va,an,su,Qa,au,Bi,ue,rn,ru,qt,iu,Ja,du,lu,dn,cu,uu,pu,ln,hu,Cs,mu,gu,fu,Xe,cn,_u,Xa,ku,vu,un,js,yu,Za,bu,Tu,pn,wu,Ya,Pu,xu,zu,oo,hn,Fu,er,$u,Ri,Et,no,tr,mn,qu,or,Eu,Hi,qe,gn,Mu,fn,Cu,Ss,ju,Su,Ou,_n,Au,kn,Iu,Lu,Gu,ke,vn,Nu,Mt,Du,Os,Uu,Wu,nr,Bu,Ru,Hu,so,Ku,sr,Vu,Qu,yn,Ki,Ct,ao,ar,bn,Ju,rr,Xu,Vi,Ee,Tn,Zu,wn,Yu,As,ep,tp,op,Pn,np,xn,sp,ap,rp,ve,zn,ip,jt,dp,Is,lp,cp,ir,up,pp,hp,ro,mp,dr,gp,fp,Fn,Qi,St,io,lr,$n,_p,cr,kp,Ji,Ot,qn,vp,Ze,En,yp,ur,bp,Tp,Mn,Xi,At,lo,pr,Cn,wp,hr,Pp,Zi,pe,jn,xp,Sn,zp,Ls,Fp,$p,qp,On,Ep,An,Mp,Cp,jp,co,Sp,ye,In,Op,It,Ap,Gs,Ip,Lp,mr,Gp,Np,Dp,uo,Up,gr,Wp,Bp,Ln,Yi,Lt,po,fr,Gn,Rp,_r,Hp,ed,he,Nn,Kp,Dn,Vp,Ns,Qp,Jp,Xp,Un,Zp,Wn,Yp,eh,th,ho,oh,be,Bn,nh,Gt,sh,Ds,ah,rh,kr,ih,dh,lh,mo,ch,vr,uh,ph,Rn,td,Nt,go,yr,Hn,hh,br,mh,od,L,Kn,gh,Vn,fh,Us,_h,kh,vh,Qn,yh,Jn,bh,Th,wh,Tr,Ph,xh,He,wr,Xn,zh,Fh,Pr,Zn,$h,qh,xr,Yn,Eh,Mh,zr,es,Ch,jh,Te,ts,Sh,Dt,Oh,Fr,Ah,Ih,$r,Lh,Gh,Nh,fo,Dh,qr,Uh,Wh,os,Bh,Ye,ns,Rh,Er,Hh,Kh,ss,Vh,et,as,Qh,Mr,Jh,Xh,rs,nd,Ut,_o,Cr,is,Zh,jr,Yh,sd,G,ds,em,ls,tm,Ws,om,nm,sm,cs,am,us,rm,im,dm,Sr,lm,cm,Ke,Or,ps,um,pm,Ar,hs,hm,mm,Ir,ms,gm,fm,Lr,gs,_m,km,E,fs,vm,Wt,ym,Gr,bm,Tm,Nr,wm,Pm,xm,ko,zm,Dr,Fm,$m,Ur,Wr,Br,Rr,qm,Em,Hr,Kr,Vr,Qr,Mm,Cm,Jr,Xr,Zr,Yr,jm,Sm,ei,ti,_s,vo,yo,oi,ks,Om,ni,Am,Im,si,Lm,Gm,ai,Nm,Dm,ri,ii,di,li,Um,Wm,ci,ui,pi,hi,Bm,Rm,mi,gi,fi,_i,Hm,Km,ki,vi,yi,bi,Vm,Qm,tt,vs,Jm,Ti,Xm,Zm,ys,Ym,ot,bs,eg,wi,tg,og,Ts,ad;return w=new Z({}),K=new Z({}),$e=new Z({}),So=new Z({}),Io=new Z({}),Do=new Z({}),Uo=new Se({props:{code:`from transformers import PegasusForConditionalGeneration, PegasusTokenizer
import torch
...
Model configuration class with all the parameters of the model. Initializing with a config file does not
load the weights associated with the model, only the configuration. Check out the
<a href="/docs/transformers/v4.18.0/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),zn=new M({props:{name:"forward",anchor:"transformers.PegasusForConditionalGeneration.forward",parameters:[{name:"input_ids",val:": typing.Optional[torch.Tensor] = None"},{name:"attention_mask",val:": typing.Optional[torch.Tensor] = None"},{name:"decoder_input_ids",val:": typing.Optional[torch.Tensor] = None"},{name:"decoder_attention_mask",val:": typing.Optional[torch.Tensor] = None"},{name:"head_mask",val:": typing.Optional[torch.Tensor] = None"},{name:"decoder_head_mask",val:": typing.Optional[torch.Tensor] = None"},{name:"cross_attn_head_mask",val:": typing.Optional[torch.Tensor] = None"},{name:"encoder_outputs",val:": typing.Optional[typing.Tuple[torch.FloatTensor]] = None"},{name:"past_key_values",val:": typing.Optional[typing.Tuple[torch.FloatTensor]] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.Tensor] = None"},{name:"decoder_inputs_embeds",val:": typing.Optional[torch.Tensor] = None"},{name:"labels",val:": typing.Optional[torch.Tensor] = None"},{name:"use_cache",val:": typing.Optional[bool] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],source:"https://github.com/huggingface/transformers/blob/v4.18.0/src/transformers/models/pegasus/modeling_pegasus.py#L1350",parametersDescription:[{anchor:"transformers.PegasusForConditionalGeneration.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. Padding will be ignored by default should you provide
it.</p>
<p>Indices can be obtained using <a href="/docs/transformers/v4.18.0/en/model_doc/pegasus#transformers.PegasusTokenizer">PegasusTokenizer</a>. See <a href="/docs/transformers/v4.18.0/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/v4.18.0/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
`}}),uo=new $o({props:{$$slots:{default:[Dk]},$$scope:{ctx:B}}}),Ln=new Se({props:{code:`from transformers import PegasusTokenizer, TFPegasusModel
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/v4.18.0/en/main_classes/model#transformers.TFPreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),ho=new $o({props:{$$slots:{default:[Uk]},$$scope:{ctx:B}}}),Bn=new M({props:{name:"call",anchor:"transformers.TFPegasusForConditionalGeneration.call",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"decoder_input_ids",val:" = None"},{name:"decoder_attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"decoder_head_mask",val:" = None"},{name:"cross_attn_head_mask",val:" = None"},{name:"encoder_outputs",val:": typing.Optional[transformers.modeling_tf_outputs.TFBaseModelOutput] = None"},{name:"past_key_values",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"decoder_inputs_embeds",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"},{name:"labels",val:" = None"},{name:"training",val:" = False"}],source:"https://github.com/huggingface/transformers/blob/v4.18.0/src/transformers/models/pegasus/modeling_tf_pegasus.py#L1283",parametersDescription:[{anchor:"transformers.TFPegasusForConditionalGeneration.call.input_ids",description:`<strong>input_ids</strong> (<code>tf.Tensor</code> of shape <code>({0})</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/v4.18.0/en/model_doc/pegasus#transformers.PegasusTokenizer">PegasusTokenizer</a>. See <a href="/docs/transformers/v4.18.0/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/v4.18.0/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
`),Ro=n("a"),uc=r("google/pegasus-large"),pc=r(" architecture."),hc=d(),zt=n("p"),mc=r("Configuration objects inherit from "),$s=n("a"),gc=r("PretrainedConfig"),fc=r(` and can be used to control the model outputs. Read the
...
separator.`),Qc=d(),Zt=n("div"),m(on.$$.fragment),Jc=d(),Ra=n("p"),Xc=r("Converts a sequence of tokens (string) in a single string."),Zc=d(),Yt=n("div"),m(nn.$$.fragment),Yc=d(),Ha=n("p"),eu=r("Get list where entries are [1] if a token is [eos] or [pad] else 0."),tu=d(),eo=n("div"),m(sn.$$.fragment),ou=d(),Ka=n("p"),nu=r("Just EOS"),Wi=d(),$t=n("h2"),to=n("a"),Va=n("span"),m(an.$$.fragment),su=d(),Qa=n("span"),au=r("PegasusTokenizerFast"),Bi=d(),ue=n("div"),m(rn.$$.fragment),ru=d(),qt=n("p"),iu=r("Construct a \u201Cfast\u201D PEGASUS tokenizer (backed by HuggingFace\u2019s "),Ja=n("em"),du=r("tokenizers"),lu=r(` library). Based on
`),dn=n("a"),cu=r("Unigram"),uu=r("."),pu=d(),ln=n("p"),hu=r("This tokenizer inherits from "),Cs=n("a"),mu=r("PreTrainedTokenizerFast"),gu=r(` which contains most of the main methods. Users should
refer to this superclass for more information regarding those methods.`),fu=d(),Xe=n("div"),m(cn.$$.fragment),_u=d(),Xa=n("p"),ku=r("Build model inputs from a sequence by adding eos to the end. no bos token is added to the front."),vu=d(),un=n("ul"),js=n("li"),yu=r("single sequence: "),Za=n("code"),bu=r("X </s>"),Tu=d(),pn=n("li"),wu=r("pair of sequences: "),Ya=n("code"),Pu=r("A B </s>"),xu=r(" (not intended use)"),zu=d(),oo=n("div"),m(hn.$$.fragment),Fu=d(),er=n("p"),$u=r("Get list where entries are [1] if a token is [eos] or [pad] else 0."),Ri=d(),Et=n("h2"),no=n("a"),tr=n("span"),m(mn.$$.fragment),qu=d(),or=n("span"),Eu=r("PegasusModel"),Hi=d(),qe=n("div"),m(gn.$$.fragment),Mu=d(),fn=n("p"),Cu=r(`The bare PEGASUS Model outputting raw hidden-states without any specific head on top.
...
and behavior.`),Gu=d(),ke=n("div"),m(vn.$$.fragment),Nu=d(),Mt=n("p"),Du=r("The "),Os=n("a"),Uu=r("PegasusModel"),Wu=r(" forward method, overrides the "),nr=n("code"),Bu=r("__call__"),Ru=r(" special method."),Hu=d(),m(so.$$.fragment),Ku=d(),sr=n("p"),Vu=r("Example:"),Qu=d(),m(yn.$$.fragment),Ki=d(),Ct=n("h2"),ao=n("a"),ar=n("span"),m(bn.$$.fragment),Ju=d(),rr=n("span"),Xu=r("PegasusForConditionalGeneration"),Vi=d(),Ee=n("div"),m(Tn.$$.fragment),Zu=d(),wn=n("p"),Yu=r(`The PEGASUS Model with a language modeling head. Can be used for summarization.
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),rp=d(),ve=n("div"),m(zn.$$.fragment),ip=d(),jt=n("p"),dp=r("The "),Is=n("a"),lp=r("PegasusForConditionalGeneration"),cp=r(" forward method, overrides the "),ir=n("code"),up=r("__call__"),pp=r(" special method."),hp=d(),m(ro.$$.fragment),mp=d(),dr=n("p"),gp=r("Summarization example:"),fp=d(),m(Fn.$$.fragment),Qi=d(),St=n("h2"),io=n("a"),lr=n("span"),m($n.$$.fragment),_p=d(),cr=n("span"),kp=r("PegasusForCausalLM"),Ji=d(),Ot=n("div"),m(qn.$$.fragment),vp=d(),Ze=n("div"),m(En.$$.fragment),yp=d(),ur=n("p"),bp=r("Example:"),Tp=d(),m(Mn.$$.fragment),Xi=d(),At=n("h2"),lo=n("a"),pr=n("span"),m(Cn.$$.fragment),wp=d(),hr=n("span"),Pp=r("TFPegasusModel"),Zi=d(),pe=n("div"),m(jn.$$.fragment),xp=d(),Sn=n("p"),zp=r(`The bare PEGASUS Model outputting raw hidden-states without any specific head on top.
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),qp=d(),On=n("p"),Ep=r("This model is also a "),An=n("a"),Mp=r("tf.keras.Model"),Cp=r(` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),jp=d(),m(co.$$.fragment),Sp=d(),ye=n("div"),m(In.$$.fragment),Op=d(),It=n("p"),Ap=r("The "),Gs=n("a"),Ip=r("TFPegasusModel"),Lp=r(" forward method, overrides the "),mr=n("code"),Gp=r("__call__"),Np=r(" special method."),Dp=d(),m(uo.$$.fragment),Up=d(),gr=n("p"),Wp=r("Example:"),Bp=d(),m(Ln.$$.fragment),Yi=d(),Lt=n("h2"),po=n("a"),fr=n("span"),m(Gn.$$.fragment),Rp=d(),_r=n("span"),Hp=r("TFPegasusForConditionalGeneration"),ed=d(),he=n("div"),m(Nn.$$.fragment),Kp=d(),Dn=n("p"),Vp=r(`The PEGASUS Model with a language modeling head. Can be used for summarization.
...
separator.`),kf.forEach(t),wo.forEach(t),Qc=l(we),Zt=s(we,"DIV",{class:!0});var wd=a(Zt);g(on.$$.fragment,wd),Jc=l(wd),Ra=s(wd,"P",{});var vf=a(Ra);Xc=i(vf,"Converts a sequence of tokens (string) in a single string."),vf.forEach(t),wd.forEach(t),Zc=l(we),Yt=s(we,"DIV",{class:!0});var Pd=a(Yt);g(nn.$$.fragment,Pd),Yc=l(Pd),Ha=s(Pd,"P",{});var yf=a(Ha);eu=i(yf,"Get list where entries are [1] if a token is [eos] or [pad] else 0."),yf.forEach(t),Pd.forEach(t),tu=l(we),eo=s(we,"DIV",{class:!0});var xd=a(eo);g(sn.$$.fragment,xd),ou=l(xd),Ka=s(xd,"P",{});var bf=a(Ka);nu=i(bf,"Just EOS"),bf.forEach(t),xd.forEach(t),we.forEach(t),Wi=l(o),$t=s(o,"H2",{class:!0});var zd=a($t);to=s(zd,"A",{id:!0,class:!0,href:!0});var Tf=a(to);Va=s(Tf,"SPAN",{});var wf=a(Va);g(an.$$.fragment,wf),wf.forEach(t),Tf.forEach(t),su=l(zd),Qa=s(zd,"SPAN",{});var Pf=a(Qa);au=i(Pf,"PegasusTokenizerFast"),Pf.forEach(t),zd.forEach(t),Bi=l(o),ue=s(o,"DIV",{class:!0});var rt=a(ue);g(rn.$$.fragment,rt),ru=l(rt),qt=s(rt,"P",{});var Xs=a(qt);iu=i(Xs,"Construct a \u201Cfast\u201D PEGASUS tokenizer (backed by HuggingFace\u2019s "),Ja=s(Xs,"EM",{});var xf=a(Ja);du=i(xf,"tokenizers"),xf.forEach(t),lu=i(Xs,` library). Based on
`),dn=s(Xs,"A",{href:!0,rel:!0});var zf=a(dn);cu=i(zf,"Unigram"),zf.forEach(t),uu=i(Xs,"."),Xs.forEach(t),pu=l(rt),ln=s(rt,"P",{});var Fd=a(ln);hu=i(Fd,"This tokenizer inherits from "),Cs=s(Fd,"A",{href:!0});var Ff=a(Cs);mu=i(Ff,"PreTrainedTokenizerFast"),Ff.forEach(t),gu=i(Fd,` which contains most of the main methods. Users should
refer to this superclass for more information regarding those methods.`),Fd.forEach(t),fu=l(rt),Xe=s(rt,"DIV",{class:!0});var Zs=a(Xe);g(cn.$$.fragment,Zs),_u=l(Zs),Xa=s(Zs,"P",{});var $f=a(Xa);ku=i($f,"Build model inputs from a sequence by adding eos to the end. no bos token is added to the front."),$f.forEach(t),vu=l(Zs),un=s(Zs,"UL",{});var $d=a(un);js=s($d,"LI",{});var ag=a(js);yu=i(ag,"single sequence: "),Za=s(ag,"CODE",{});var qf=a(Za);bu=i(qf,"X </s>"),qf.forEach(t),ag.forEach(t),Tu=l($d),pn=s($d,"LI",{});var qd=a(pn);wu=i(qd,"pair of sequences: "),Ya=s(qd,"CODE",{});var Ef=a(Ya);Pu=i(Ef,"A B </s>"),Ef.forEach(t),xu=i(qd," (not intended use)"),qd.forEach(t),$d.forEach(t),Zs.forEach(t),zu=l(rt),oo=s(rt,"DIV",{class:!0});var Ed=a(oo);g(hn.$$.fragment,Ed),Fu=l(Ed),er=s(Ed,"P",{});var Mf=a(er);$u=i(Mf,"Get list where entries are [1] if a token is [eos] or [pad] else 0."),Mf.forEach(t),Ed.forEach(t),rt.forEach(t),Ri=l(o),Et=s(o,"H2",{class:!0});var Md=a(Et);no=s(Md,"A",{id:!0,class:!0,href:!0});var Cf=a(no);tr=s(Cf,"SPAN",{});var jf=a(tr);g(mn.$$.fragment,jf),jf.forEach(t),Cf.forEach(t),qu=l(Md),or=s(Md,"SPAN",{});var Sf=a(or);Eu=i(Sf,"PegasusModel"),Sf.forEach(t),Md.forEach(t),Hi=l(o),qe=s(o,"DIV",{class:!0});var Po=a(qe);g(gn.$$.fragment,Po),Mu=l(Po),fn=s(Po,"P",{});var Cd=a(fn);Cu=i(Cd,`The bare PEGASUS Model outputting raw hidden-states without any specific head on top.
This model inherits from `),Ss=s(Cd,"A",{href:!0});var Of=a(Ss);ju=i(Of,"PreTrainedModel"),Of.forEach(t),Su=i(Cd,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Cd.forEach(t),Ou=l(Po),_n=s(Po,"P",{});var jd=a(_n);Au=i(jd,"This model is also a PyTorch "),kn=s(jd,"A",{href:!0,rel:!0});var Af=a(kn);Iu=i(Af,"torch.nn.Module"),Af.forEach(t),Lu=i(jd,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),jd.forEach(t),Gu=l(Po),ke=s(Po,"DIV",{class:!0});var it=a(ke);g(vn.$$.fragment,it),Nu=l(it),Mt=s(it,"P",{});var Ys=a(Mt);Du=i(Ys,"The "),Os=s(Ys,"A",{href:!0});var If=a(Os);Uu=i(If,"PegasusModel"),If.forEach(t),Wu=i(Ys," forward method, overrides the "),nr=s(Ys,"CODE",{});var Lf=a(nr);Bu=i(Lf,"__call__"),Lf.forEach(t),Ru=i(Ys," special method."),Ys.forEach(t),Hu=l(it),g(so.$$.fragment,it),Ku=l(it),sr=s(it,"P",{});var Gf=a(sr);Vu=i(Gf,"Example:"),Gf.forEach(t),Qu=l(it),g(yn.$$.fragment,it),it.forEach(t),Po.forEach(t),Ki=l(o),Ct=s(o,"H2",{class:!0});var Sd=a(Ct);ao=s(Sd,"A",{id:!0,class:!0,href:!0});var Nf=a(ao);ar=s(Nf,"SPAN",{});var Df=a(ar);g(bn.$$.fragment,Df),Df.forEach(t),Nf.forEach(t),Ju=l(Sd),rr=s(Sd,"SPAN",{});var Uf=a(rr);Xu=i(Uf,"PegasusForConditionalGeneration"),Uf.forEach(t),Sd.forEach(t),Vi=l(o),Ee=s(o,"DIV",{class:!0});var xo=a(Ee);g(Tn.$$.fragment,xo),Zu=l(xo),wn=s(xo,"P",{});var Od=a(wn);Yu=i(Od,`The PEGASUS Model with a language modeling head. Can be used for summarization.
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Ad.forEach(t),rp=l(xo),ve=s(xo,"DIV",{class:!0});var dt=a(ve);g(zn.$$.fragment,dt),ip=l(dt),jt=s(dt,"P",{});var ea=a(jt);dp=i(ea,"The "),Is=s(ea,"A",{href:!0});var Rf=a(Is);lp=i(Rf,"PegasusForConditionalGeneration"),Rf.forEach(t),cp=i(ea," forward method, overrides the "),ir=s(ea,"CODE",{});var Hf=a(ir);up=i(Hf,"__call__"),Hf.forEach(t),pp=i(ea," special method."),ea.forEach(t),hp=l(dt),g(ro.$$.fragment,dt),mp=l(dt),dr=s(dt,"P",{});var Kf=a(dr);gp=i(Kf,"Summarization example:"),Kf.forEach(t),fp=l(dt),g(Fn.$$.fragment,dt),dt.forEach(t),xo.forEach(t),Qi=l(o),St=s(o,"H2",{class:!0});var Id=a(St);io=s(Id,"A",{id:!0,class:!0,href:!0});var Vf=a(io);lr=s(Vf,"SPAN",{});var Qf=a(lr);g($n.$$.fragment,Qf),Qf.forEach(t),Vf.forEach(t),_p=l(Id),cr=s(Id,"SPAN",{});var Jf=a(cr);kp=i(Jf,"PegasusForCausalLM"),Jf.forEach(t),Id.forEach(t),Ji=l(o),Ot=s(o,"DIV",{class:!0});var Ld=a(Ot);g(qn.$$.fragment,Ld),vp=l(Ld),Ze=s(Ld,"DIV",{class:!0});var ta=a(Ze);g(En.$$.fragment,ta),yp=l(ta),ur=s(ta,"P",{});var Xf=a(ur);bp=i(Xf,"Example:"),Xf.forEach(t),Tp=l(ta),g(Mn.$$.fragment,ta),ta.forEach(t),Ld.forEach(t),Xi=l(o),At=s(o,"H2",{class:!0});var Gd=a(At);lo=s(Gd,"A",{id:!0,class:!0,href:!0});var Zf=a(lo);pr=s(Zf,"SPAN",{});var Yf=a(pr);g(Cn.$$.fragment,Yf),Yf.forEach(t),Zf.forEach(t),wp=l(Gd),hr=s(Gd,"SPAN",{});var e_=a(hr);Pp=i(e_,"TFPegasusModel"),e_.forEach(t),Gd.forEach(t),Zi=l(o),pe=s(o,"DIV",{class:!0});var lt=a(pe);g(jn.$$.fragment,lt),xp=l(lt),Sn=s(lt,"P",{});var Nd=a(Sn);zp=i(Nd,`The bare PEGASUS Model outputting raw hidden-states without any specific head on top.
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Nd.forEach(t),qp=l(lt),On=s(lt,"P",{});var Dd=a(On);Ep=i(Dd,"This model is also a "),An=s(Dd,"A",{href:!0,rel:!0});var o_=a(An);Mp=i(o_,"tf.keras.Model"),o_.forEach(t),Cp=i(Dd,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Dd.forEach(t),jp=l(lt),g(co.$$.fragment,lt),Sp=l(lt),ye=s(lt,"DIV",{class:!0});var ct=a(ye);g(In.$$.fragment,ct),Op=l(ct),It=s(ct,"P",{});var oa=a(It);Ap=i(oa,"The "),Gs=s(oa,"A",{href:!0});var n_=a(Gs);Ip=i(n_,"TFPegasusModel"),n_.forEach(t),Lp=i(oa," forward method, overrides the "),mr=s(oa,"CODE",{});var s_=a(mr);Gp=i(s_,"__call__"),s_.forEach(t),Np=i(oa," special method."),oa.forEach(t),Dp=l(ct),g(uo.$$.fragment,ct),Up=l(ct),gr=s(ct,"P",{});var a_=a(gr);Wp=i(a_,"Example:"),a_.forEach(t),Bp=l(ct),g(Ln.$$.fragment,ct),ct.forEach(t),lt.forEach(t),Yi=l(o),Lt=s(o,"H2",{class:!0});var Ud=a(Lt);po=s(Ud,"A",{id:!0,class:!0,href:!0});var r_=a(po);fr=s(r_,"SPAN",{});var i_=a(fr);g(Gn.$$.fragment,i_),i_.forEach(t),r_.forEach(t),Rp=l(Ud),_r=s(Ud,"SPAN",{});var d_=a(_r);Hp=i(d_,"TFPegasusForConditionalGeneration"),d_.forEach(t),Ud.forEach(t),ed=l(o),he=s(o,"DIV",{class:!0});var ut=a(he);g(Nn.$$.fragment,ut),Kp=l(ut),Dn=s(ut,"P",{});var Wd=a(Dn);Vp=i(Wd,`The PEGASUS Model with a language modeling head. Can be used for summarization.
...
PegasusTokenizer.from_pretrained(\u2018google/pegasus-large\u2019) >>> TXT = \u201CMy friends are <mask> but they eat too many
carbs.\u201D`),kk.forEach(t),_k.forEach(t),fk.forEach(t),gk.forEach(t),Wm=l(C),ci=s(C,"BLOCKQUOTE",{});var vk=a(ci);ui=s(vk,"BLOCKQUOTE",{});var yk=a(ui);pi=s(yk,"BLOCKQUOTE",{});var bk=a(pi);hi=s(bk,"P",{});var Tk=a(hi);Bm=i(Tk,`model = FlaxPegasusForConditionalGeneration.from_pretrained(\u2018google/pegasus-large\u2019) >>> input_ids =
