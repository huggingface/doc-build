import{S as Hu,i as Ku,s as Vu,e as n,k as l,w as f,t as r,M as Qu,c as a,d as o,m as i,a as s,x as _,h as d,b as c,F as e,g as p,y as g,q as b,o as k,B as v,v as Ju}from"../../chunks/vendor-6b77c823.js";import{T as Bn}from"../../chunks/Tip-39098574.js";import{D as M}from"../../chunks/Docstring-17b815d9.js";import{C as ro}from"../../chunks/CodeBlock-3a8b25a8.js";import{I as qe}from"../../chunks/IconCopyLink-7a11ce68.js";function Xu(Y){let m,z,y,T,x;return{c(){m=n("p"),z=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),y=n("code"),T=r("Module"),x=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(S){m=a(S,"P",{});var w=s(m);z=d(w,"Although the recipe for forward pass needs to be defined within this function, one should call the "),y=a(w,"CODE",{});var F=s(y);T=d(F,"Module"),F.forEach(o),x=d(w,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),w.forEach(o)},m(S,w){p(S,m,w),e(m,z),e(m,y),e(y,T),e(m,x)},d(S){S&&o(m)}}}function Yu(Y){let m,z,y,T,x;return{c(){m=n("p"),z=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),y=n("code"),T=r("Module"),x=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(S){m=a(S,"P",{});var w=s(m);z=d(w,"Although the recipe for forward pass needs to be defined within this function, one should call the "),y=a(w,"CODE",{});var F=s(y);T=d(F,"Module"),F.forEach(o),x=d(w,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),w.forEach(o)},m(S,w){p(S,m,w),e(m,z),e(m,y),e(y,T),e(m,x)},d(S){S&&o(m)}}}function Zu(Y){let m,z,y,T,x,S,w,F,Ce,ue,B,je,U,Oe,Pe,W,Le,Ne,K,V,Ie,Z,C,P,fe,ae,$e,Q,A,Te,se,L,we,re,Ee,ee,de,le,Ae,J,Me,R,De;return{c(){m=n("p"),z=r("TF 2.0 models accepts two formats as inputs:"),y=l(),T=n("ul"),x=n("li"),S=r("having all inputs as keyword arguments (like PyTorch models), or"),w=l(),F=n("li"),Ce=r("having all inputs as a list, tuple or dict in the first positional arguments."),ue=l(),B=n("p"),je=r("This second option is useful when using "),U=n("code"),Oe=r("tf.keras.Model.fit"),Pe=r(` method which currently requires having all the
...
`),R=a(xe,"CODE",{});var Be=s(R);De=d(Be,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),Be.forEach(o),xe.forEach(o),X.forEach(o)},m(u,q){p(u,m,q),e(m,z),p(u,y,q),p(u,T,q),e(T,x),e(x,S),e(T,w),e(T,F),e(F,Ce),p(u,ue,q),p(u,B,q),e(B,je),e(B,U),e(U,Oe),e(B,Pe),e(B,W),e(W,Le),e(B,Ne),p(u,K,q),p(u,V,q),e(V,Ie),p(u,Z,q),p(u,C,q),e(C,P),e(P,fe),e(P,ae),e(ae,$e),e(P,Q),e(P,A),e(A,Te),e(C,se),e(C,L),e(L,we),e(L,re),e(re,Ee),e(L,ee),e(L,de),e(de,le),e(C,Ae),e(C,J),e(J,Me),e(J,R),e(R,De)},d(u){u&&o(m),u&&o(y),u&&o(T),u&&o(ue),u&&o(B),u&&o(K),u&&o(V),u&&o(Z),u&&o(C)}}}function ef(Y){let m,z,y,T,x;return{c(){m=n("p"),z=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),y=n("code"),T=r("Module"),x=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(S){m=a(S,"P",{});var w=s(m);z=d(w,"Although the recipe for forward pass needs to be defined within this function, one should call the "),y=a(w,"CODE",{});var F=s(y);T=d(F,"Module"),F.forEach(o),x=d(w,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),w.forEach(o)},m(S,w){p(S,m,w),e(m,z),e(m,y),e(y,T),e(m,x)},d(S){S&&o(m)}}}function of(Y){let m,z,y,T,x,S,w,F,Ce,ue,B,je,U,Oe,Pe,W,Le,Ne,K,V,Ie,Z,C,P,fe,ae,$e,Q,A,Te,se,L,we,re,Ee,ee,de,le,Ae,J,Me,R,De;return{c(){m=n("p"),z=r("TF 2.0 models accepts two formats as inputs:"),y=l(),T=n("ul"),x=n("li"),S=r("having all inputs as keyword arguments (like PyTorch models), or"),w=l(),F=n("li"),Ce=r("having all inputs as a list, tuple or dict in the first positional arguments."),ue=l(),B=n("p"),je=r("This second option is useful when using "),U=n("code"),Oe=r("tf.keras.Model.fit"),Pe=r(` method which currently requires having all the
tensors in the first argument of the model call function: `),W=n("code"),Le=r("model(inputs)"),Ne=r("."),K=l(),V=n("p"),Ie=r(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),Z=l(),C=n("ul"),P=n("li"),fe=r("a single Tensor with "),ae=n("code"),$e=r("input_ids"),Q=r(" only and nothing else: "),A=n("code"),Te=r("model(input_ids)"),se=l(),L=n("li"),we=r(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),re=n("code"),Ee=r("model([input_ids, attention_mask])"),ee=r(" or "),de=n("code"),le=r("model([input_ids, attention_mask, token_type_ids])"),Ae=l(),J=n("li"),Me=r(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),R=n("code"),De=r('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(u){m=a(u,"P",{});var q=s(m);z=d(q,"TF 2.0 models accepts two formats as inputs:"),q.forEach(o),y=i(u),T=a(u,"UL",{});var ie=s(T);x=a(ie,"LI",{});var lo=s(x);S=d(lo,"having all inputs as keyword arguments (like PyTorch models), or"),lo.forEach(o),w=i(ie),F=a(ie,"LI",{});var Re=s(F);Ce=d(Re,"having all inputs as a list, tuple or dict in the first positional arguments."),Re.forEach(o),ie.forEach(o),ue=i(u),B=a(u,"P",{});var j=s(B);je=d(j,"This second option is useful when using "),U=a(j,"CODE",{});var io=s(U);Oe=d(io,"tf.keras.Model.fit"),io.forEach(o),Pe=d(j,` method which currently requires having all the
...
first positional argument :`),co.forEach(o),Z=i(u),C=a(u,"UL",{});var X=s(C);P=a(X,"LI",{});var D=s(P);fe=d(D,"a single Tensor with "),ae=a(D,"CODE",{});var po=s(ae);$e=d(po,"input_ids"),po.forEach(o),Q=d(D," only and nothing else: "),A=a(D,"CODE",{});var ho=s(A);Te=d(ho,"model(input_ids)"),ho.forEach(o),D.forEach(o),se=i(X),L=a(X,"LI",{});var oe=s(L);we=d(oe,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),re=a(oe,"CODE",{});var ce=s(re);Ee=d(ce,"model([input_ids, attention_mask])"),ce.forEach(o),ee=d(oe," or "),de=a(oe,"CODE",{});var _e=s(de);le=d(_e,"model([input_ids, attention_mask, token_type_ids])"),_e.forEach(o),oe.forEach(o),Ae=i(X),J=a(X,"LI",{});var xe=s(J);Me=d(xe,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),R=a(xe,"CODE",{});var Be=s(R);De=d(Be,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),Be.forEach(o),xe.forEach(o),X.forEach(o)},m(u,q){p(u,m,q),e(m,z),p(u,y,q),p(u,T,q),e(T,x),e(x,S),e(T,w),e(T,F),e(F,Ce),p(u,ue,q),p(u,B,q),e(B,je),e(B,U),e(U,Oe),e(B,Pe),e(B,W),e(W,Le),e(B,Ne),p(u,K,q),p(u,V,q),e(V,Ie),p(u,Z,q),p(u,C,q),e(C,P),e(P,fe),e(P,ae),e(ae,$e),e(P,Q),e(P,A),e(A,Te),e(C,se),e(C,L),e(L,we),e(L,re),e(re,Ee),e(L,ee),e(L,de),e(de,le),e(C,Ae),e(C,J),e(J,Me),e(J,R),e(R,De)},d(u){u&&o(m),u&&o(y),u&&o(T),u&&o(ue),u&&o(B),u&&o(K),u&&o(V),u&&o(Z),u&&o(C)}}}function tf(Y){let m,z,y,T,x;return{c(){m=n("p"),z=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),y=n("code"),T=r("Module"),x=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(S){m=a(S,"P",{});var w=s(m);z=d(w,"Although the recipe for forward pass needs to be defined within this function, one should call the "),y=a(w,"CODE",{});var F=s(y);T=d(F,"Module"),F.forEach(o),x=d(w,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),w.forEach(o)},m(S,w){p(S,m,w),e(m,z),e(m,y),e(y,T),e(m,x)},d(S){S&&o(m)}}}function nf(Y){let m,z,y,T,x;return{c(){m=n("p"),z=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),y=n("code"),T=r("Module"),x=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(S){m=a(S,"P",{});var w=s(m);z=d(w,"Although the recipe for forward pass needs to be defined within this function, one should call the "),y=a(w,"CODE",{});var F=s(y);T=d(F,"Module"),F.forEach(o),x=d(w,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),w.forEach(o)},m(S,w){p(S,m,w),e(m,z),e(m,y),e(y,T),e(m,x)},d(S){S&&o(m)}}}function af(Y){let m,z,y,T,x,S,w,F,Ce,ue,B,je,U,Oe,Pe,W,Le,Ne,K,V,Ie,Z,C,P,fe,ae,$e,Q,A,Te,se,L,we,re,Ee,ee,de,le,Ae,J,Me,R,De,u,q,ie,lo,Re,j,io,Se,co,X,D,po,ho,oe,ce,_e,xe,Be,hd,la,md,ur,pe,ot,ud,mo,fd,zn,_d,gd,tt,bd,kd,vd,uo,yd,Fn,Td,wd,qn,Sd,xd,Bd,ia,zd,Fd,nt,fr,fo,Eo,ca,at,qd,pa,$d,_r,G,st,Ed,ha,Md,Cd,rt,jd,$n,Od,Pd,Ld,He,dt,Nd,ma,Id,Ad,ua,Dd,Gd,Mo,lt,Ud,_o,Wd,fa,Rd,Hd,_a,Kd,Vd,Qd,Ke,it,Jd,En,Xd,Mn,Yd,Zd,ga,el,ol,Cn,ct,gr,go,Co,ba,pt,tl,ka,nl,br,Ge,ht,al,mt,sl,va,rl,dl,ll,jo,ut,il,ya,cl,kr,bo,Oo,Ta,ft,pl,wa,hl,vr,ze,_t,ml,gt,ul,jn,fl,_l,gl,bt,bl,kt,kl,vl,yl,ge,vt,Tl,ko,wl,On,Sl,xl,Sa,Bl,zl,Fl,Po,ql,xa,$l,El,yt,yr,vo,Lo,Ba,Tt,Ml,za,Cl,Tr,Fe,wt,jl,St,Ol,Pn,Pl,Ll,Nl,xt,Il,Bt,Al,Dl,Gl,be,zt,Ul,yo,Wl,Ln,Rl,Hl,Fa,Kl,Vl,Ql,No,Jl,qa,Xl,Yl,Ft,wr,To,Io,$a,qt,Zl,Ea,ei,Sr,wo,$t,oi,Ve,Et,ti,Ma,ni,ai,Mt,xr,So,Ao,Ca,Ct,si,ja,ri,Br,he,jt,di,Ot,li,Nn,ii,ci,pi,Pt,hi,Lt,mi,ui,fi,Do,_i,ke,Nt,gi,xo,bi,In,ki,vi,Oa,yi,Ti,wi,Go,Si,Pa,xi,Bi,It,zr,Bo,Uo,La,At,zi,Na,Fi,Fr,me,Dt,qi,Gt,$i,An,Ei,Mi,Ci,Ut,ji,Wt,Oi,Pi,Li,Wo,Ni,O,Rt,Ii,zo,Ai,Dn,Di,Gi,Ia,Ui,Wi,Ri,Ro,Hi,Aa,Ki,Vi,Da,Ga,Ua,Wa,Qi,Ji,Ra,Ha,Ka,Va,Xi,Yi,Qa,Ja,Xa,Ya,Zi,ec,Za,es,os,Ht,oc,ts,tc,nc,ac,ns,as,ss,rs,sc,qr,Fo,Ho,ds,Kt,rc,ls,dc,$r,N,Vt,lc,Qt,ic,Gn,cc,pc,hc,Jt,mc,Xt,uc,fc,_c,is,gc,bc,Ue,cs,Yt,kc,vc,ps,Zt,yc,Tc,hs,en,wc,Sc,ms,on,xc,Bc,Qe,tn,zc,us,Fc,qc,nn,$c,Je,an,Ec,fs,Mc,Cc,sn,jc,Xe,rn,Oc,_s,Pc,Lc,dn,Er,qo,Ko,gs,ln,Nc,bs,Ic,Mr,I,cn,Ac,pn,Dc,Un,Gc,Uc,Wc,hn,Rc,mn,Hc,Kc,Vc,ks,Qc,Jc,We,vs,un,Xc,Yc,ys,fn,Zc,ep,Ts,_n,op,tp,ws,gn,np,ap,$,bn,sp,$o,rp,Ss,dp,lp,xs,ip,cp,pp,Vo,hp,Bs,mp,up,zs,Fs,qs,$s,fp,_p,Es,Ms,Cs,js,gp,bp,Os,Ps,Ls,Ns,kp,vp,Is,As,kn,Qo,Jo,Ds,vn,yp,Gs,Tp,wp,Us,Sp,xp,Ws,Bp,zp,Rs,Hs,Ks,Vs,Fp,qp,Qs,Js,Xs,Ys,$p,Ep,Zs,er,or,tr,Mp,Cp,nr,ar,sr,rr,jp,Op,Ye,yn,Pp,dr,Lp,Np,Tn,Ip,Ze,wn,Ap,lr,Dp,Gp,Sn,Cr;return S=new qe({}),se=new qe({}),Be=new qe({}),ot=new M({props:{name:"class transformers.BlenderbotSmallConfig",anchor:"transformers.BlenderbotSmallConfig",parameters:[{name:"vocab_size",val:" = 50265"},{name:"max_position_embeddings",val:" = 512"},{name:"encoder_layers",val:" = 8"},{name:"encoder_ffn_dim",val:" = 2048"},{name:"encoder_attention_heads",val:" = 16"},{name:"decoder_layers",val:" = 8"},{name:"decoder_ffn_dim",val:" = 2048"},{name:"decoder_attention_heads",val:" = 16"},{name:"encoder_layerdrop",val:" = 0.0"},{name:"decoder_layerdrop",val:" = 0.0"},{name:"use_cache",val:" = True"},{name:"is_encoder_decoder",val:" = True"},{name:"activation_function",val:" = 'gelu'"},{name:"d_model",val:" = 512"},{name:"dropout",val:" = 0.1"},{name:"attention_dropout",val:" = 0.0"},{name:"activation_dropout",val:" = 0.0"},{name:"init_std",val:" = 0.02"},{name:"decoder_start_token_id",val:" = 1"},{name:"classifier_dropout",val:" = 0.0"},{name:"scale_embedding",val:" = False"},{name:"pad_token_id",val:" = 0"},{name:"bos_token_id",val:" = 1"},{name:"eos_token_id",val:" = 2"},{name:"forced_eos_token_id",val:" = 2"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.BlenderbotSmallConfig.vocab_size",description:`<strong>vocab_size</strong> (<code>int</code>, <em>optional</em>, defaults to 50265) &#x2014;
...
<code>eos_token_id</code>.`,name:"forced_eos_token_id"}],source:"https://github.com/huggingface/transformers/blob/v4.18.0/src/transformers/models/blenderbot_small/configuration_blenderbot_small.py#L36"}}),nt=new ro({props:{code:`from transformers import BlenderbotSmallModel, BlenderbotSmallConfig
...
Whether or not the token list is already formatted with special tokens for the model.`,name:"already_has_special_tokens"}],source:"https://github.com/huggingface/transformers/blob/v4.18.0/src/transformers/tokenization_utils.py#L842",returnDescription:`
...
Optional second list of IDs for sequence pairs.`,name:"token_ids_1"}],source:"https://github.com/huggingface/transformers/blob/v4.18.0/src/transformers/models/blenderbot_small/tokenization_blenderbot_small_fast.py#L96",returnDescription:`
<p>List of zeros.</p>
`,returnType:`
<p><code>List[int]</code></p>
...
(masked), the loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.18.0/src/transformers/models/blenderbot_small/modeling_blenderbot_small.py#L1244",returnDescription:`
<p>A <a
...
behaviors between training and evaluation).`,name:"training"}],source:"https://github.com/huggingface/transformers/blob/v4.18.0/src/transformers/models/blenderbot_small/modeling_tf_blenderbot_small.py#L1123",returnDescription:`
<p>A <a
...
Labels for computing the masked language modeling loss. Indices should either be in <code>[0, ..., config.vocab_size]</code> or -100 (see <code>input_ids</code> docstring). Tokens with indices set to <code>-100</code> are ignored
(masked), the loss is only computed for the tokens with labels in <code>[0, ..., config.vocab_size]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.18.0/src/transformers/models/blenderbot_small/modeling_tf_blenderbot_small.py#L1231",returnDescription:`
<p>A <a
...
Whether or not to return a <a href="/docs/transformers/v4.18.0/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/v4.18.0/src/transformers/models/blenderbot_small/modeling_flax_blenderbot_small.py#L960",returnDescription:`
<p>A <a
...
Whether or not to return a <a href="/docs/transformers/v4.18.0/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/v4.18.0/src/transformers/models/blenderbot_small/modeling_flax_blenderbot_small.py#L1295",returnDescription:`
<p>A <a
...
<span class="hljs-meta">&gt;&gt;&gt; </span>outputs = model.decode(decoder_input_ids, encoder_outputs)
<span class="hljs-meta">&gt;&gt;&gt; </span>logits = outputs.logits`}}),{c(){m=n("meta"),z=l(),y=n("h1"),T=n("a"),x=n("span"),f(S.$$.fragment),w=l(),F=n("span"),Ce=r("Blenderbot Small"),ue=l(),B=n("p"),je=r("Note that "),U=n("a"),Oe=r("BlenderbotSmallModel"),Pe=r(` and
...
found `),D=n("a"),po=r("here"),ho=r(" ."),oe=l(),ce=n("h2"),_e=n("a"),xe=n("span"),f(Be.$$.fragment),hd=l(),la=n("span"),md=r("BlenderbotSmallConfig"),ur=l(),pe=n("div"),f(ot.$$.fragment),ud=l(),mo=n("p"),fd=r("This is the configuration class to store the configuration of a "),zn=n("a"),_d=r("BlenderbotSmallModel"),gd=r(`. It is used to instantiate
...
does not make use of token type ids, therefore a list of zeros is returned.`),kr=l(),bo=n("h2"),Oo=n("a"),Ta=n("span"),f(ft.$$.fragment),pl=l(),wa=n("span"),hl=r("BlenderbotSmallModel"),vr=l(),ze=n("div"),f(_t.$$.fragment),ml=l(),gt=n("p"),ul=r(`The bare BlenderbotSmall Model outputting raw hidden-states without any specific head on top.
...
and behavior.`),yl=l(),ge=n("div"),f(vt.$$.fragment),Tl=l(),ko=n("p"),wl=r("The "),On=n("a"),Sl=r("BlenderbotSmallModel"),xl=r(" forward method, overrides the "),Sa=n("code"),Bl=r("__call__"),zl=r(" special method."),Fl=l(),f(Po.$$.fragment),ql=l(),xa=n("p"),$l=r("Example:"),El=l(),f(yt.$$.fragment),yr=l(),vo=n("h2"),Lo=n("a"),Ba=n("span"),f(Tt.$$.fragment),Ml=l(),za=n("span"),Cl=r("BlenderbotSmallForConditionalGeneration"),Tr=l(),Fe=n("div"),f(wt.$$.fragment),jl=l(),St=n("p"),Ol=r(`The BlenderbotSmall Model with a language modeling head. Can be used for summarization.
...
behavior.`),fi=l(),f(Do.$$.fragment),_i=l(),ke=n("div"),f(Nt.$$.fragment),gi=l(),xo=n("p"),bi=r("The "),In=n("a"),ki=r("TFBlenderbotSmallModel"),vi=r(" forward method, overrides the "),Oa=n("code"),yi=r("__call__"),Ti=r(" special method."),wi=l(),f(Go.$$.fragment),Si=l(),Pa=n("p"),xi=r("Example:"),Bi=l(),f(It.$$.fragment),zr=l(),Bo=n("h2"),Uo=n("a"),La=n("span"),f(At.$$.fragment),zi=l(),Na=n("span"),Fi=r("TFBlenderbotSmallForConditionalGeneration"),Fr=l(),me=n("div"),f(Dt.$$.fragment),qi=l(),Gt=n("p"),$i=r(`The BLENDERBOT_SMALL Model with a language modeling head. Can be used for summarization.
...
regular Flax Module and refer to the Flax documentation for all matter related to general usage and behavior.`),Vc=l(),ks=n("p"),Qc=r("Finally, this model supports inherent JAX features such as:"),Jc=l(),We=n("ul"),vs=n("li"),un=n("a"),Xc=r("Just-In-Time (JIT) compilation"),Yc=l(),ys=n("li"),fn=n("a"),Zc=r("Automatic Differentiation"),ep=l(),Ts=n("li"),_n=n("a"),op=r("Vectorization"),tp=l(),ws=n("li"),gn=n("a"),np=r("Parallelization"),ap=l(),$=n("div"),f(bn.$$.fragment),sp=l(),$o=n("p"),rp=r("The "),Ss=n("code"),dp=r("FlaxBlenderbotSmallPreTrainedModel"),lp=r(" forward method, overrides the "),xs=n("code"),ip=r("__call__"),cp=r(" special method."),pp=l(),f(Vo.$$.fragment),hp=l(),Bs=n("p"),mp=r("Summarization example:"),up=l(),zs=n("blockquote"),Fs=n("blockquote"),qs=n("blockquote"),$s=n("p"),fp=r("from transformers import BlenderbotSmallTokenizer, FlaxBlenderbotSmallForConditionalGeneration"),_p=l(),Es=n("blockquote"),Ms=n("blockquote"),Cs=n("blockquote"),js=n("p"),gp=r(`model = FlaxBlenderbotSmallForConditionalGeneration.from_pretrained(\u2018facebook/blenderbot_small-90M\u2019) >>>
...
tokenizer([ARTICLE_TO_SUMMARIZE], max_length=1024, return_tensors=\u2018np\u2019)`),vp=l(),Is=n("blockquote"),As=n("blockquote"),kn=n("blockquote"),Qo=n("h1"),Jo=n("a"),Ds=n("span"),f(vn.$$.fragment),yp=l(),Gs=n("span"),Tp=r("Generate Summary >>> summary_ids = model.generate(inputs[\u2018input_ids\u2019]).sequences >>>"),wp=l(),Us=n("p"),Sp=r("print(tokenizer.batch_decode(summary_ids, skip_special_tokens=True, clean_up_tokenization_spaces=False))"),xp=l(),Ws=n("p"),Bp=r("Mask filling example:"),zp=l(),Rs=n("blockquote"),Hs=n("blockquote"),Ks=n("blockquote"),Vs=n("p"),Fp=r(`from transformers import BlenderbotSmallTokenizer, FlaxBlenderbotSmallForConditionalGeneration >>>
...
jax.nn.softmax(logits[0, masked_index], axis=0) >>> values, predictions = jax.lax.top_k(probs)`),Cp=l(),nr=n("blockquote"),ar=n("blockquote"),sr=n("blockquote"),rr=n("p"),jp=r("tokenizer.decode(predictions).split()"),Op=l(),Ye=n("div"),f(yn.$$.fragment),Pp=l(),dr=n("p"),Lp=r("Example:"),Np=l(),f(Tn.$$.fragment),Ip=l(),Ze=n("div"),f(wn.$$.fragment),Ap=l(),lr=n("p"),Dp=r("Example:"),Gp=l(),f(Sn.$$.fragment),this.h()},l(t){const h=Qu('[data-svelte="svelte-1phssyn"]',document.head);m=a(h,"META",{name:!0,content:!0}),h.forEach(o),z=i(t),y=a(t,"H1",{class:!0});var xn=s(y);T=a(xn,"A",{id:!0,class:!0,href:!0});var ir=s(T);x=a(ir,"SPAN",{});var cr=s(x);_(S.$$.fragment,cr),cr.forEach(o),ir.forEach(o),w=i(xn),F=a(xn,"SPAN",{});var pr=s(F);Ce=d(pr,"Blenderbot Small"),pr.forEach(o),xn.forEach(o),ue=i(t),B=a(t,"P",{});var ve=s(B);je=d(ve,"Note that "),U=a(ve,"A",{href:!0});var hr=s(U);Oe=d(hr,"BlenderbotSmallModel"),hr.forEach(o),Pe=d(ve,` and
...
adding special tokens.`),fh.forEach(o),Ad=i(Kn),ua=a(Kn,"P",{});var _h=s(ua);Dd=d(_h,"This implementation does not add special tokens and this method should be overridden in a subclass."),_h.forEach(o),Kn.forEach(o),Gd=i(ye),Mo=a(ye,"DIV",{class:!0});var Ir=s(Mo);_(lt.$$.fragment,Ir),Ud=i(Ir),_o=a(Ir,"P",{});var Vn=s(_o);Wd=d(Vn,`Retrieves sequence ids from a token list that has no special tokens added. This method is called when adding
special tokens using the tokenizer `),fa=a(Vn,"CODE",{});var gh=s(fa);Rd=d(gh,"prepare_for_model"),gh.forEach(o),Hd=d(Vn," or "),_a=a(Vn,"CODE",{});var bh=s(_a);Kd=d(bh,"encode_plus"),bh.forEach(o),Vd=d(Vn," methods."),Vn.forEach(o),Ir.forEach(o),Qd=i(ye),Ke=a(ye,"DIV",{class:!0});var Qn=s(Ke);_(it.$$.fragment,Qn),Jd=i(Qn),En=a(Qn,"P",{});var Up=s(En);Xd=d(Up,"Create the token type IDs corresponding to the sequences passed. "),Mn=a(Up,"A",{href:!0});var kh=s(Mn);Yd=d(kh,`What are token type
IDs?`),kh.forEach(o),Up.forEach(o),Zd=i(Qn),ga=a(Qn,"P",{});var vh=s(ga);el=d(vh,"Should be overridden in a subclass if the model has a special way of building those."),vh.forEach(o),Qn.forEach(o),ol=i(ye),Cn=a(ye,"DIV",{class:!0});var yh=s(Cn);_(ct.$$.fragment,yh),yh.forEach(o),ye.forEach(o),gr=i(t),go=a(t,"H2",{class:!0});var Ar=s(go);Co=a(Ar,"A",{id:!0,class:!0,href:!0});var Th=s(Co);ba=a(Th,"SPAN",{});var wh=s(ba);_(pt.$$.fragment,wh),wh.forEach(o),Th.forEach(o),tl=i(Ar),ka=a(Ar,"SPAN",{});var Sh=s(ka);nl=d(Sh,"BlenderbotSmallTokenizerFast"),Sh.forEach(o),Ar.forEach(o),br=i(t),Ge=a(t,"DIV",{class:!0});var Jn=s(Ge);_(ht.$$.fragment,Jn),al=i(Jn),mt=a(Jn,"P",{});var Dr=s(mt);sl=d(Dr,"Construct a \u201Cfast\u201D BlenderbotSmall tokenizer (backed by HuggingFace\u2019s "),va=a(Dr,"EM",{});var xh=s(va);rl=d(xh,"tokenizers"),xh.forEach(o),dl=d(Dr," library)."),Dr.forEach(o),ll=i(Jn),jo=a(Jn,"DIV",{class:!0});var Gr=s(jo);_(ut.$$.fragment,Gr),il=i(Gr),ya=a(Gr,"P",{});var Bh=s(ya);cl=d(Bh,`Create a mask from the two sequences passed to be used in a sequence-pair classification task. BlenderbotSmall
does not make use of token type ids, therefore a list of zeros is returned.`),Bh.forEach(o),Gr.forEach(o),Jn.forEach(o),kr=i(t),bo=a(t,"H2",{class:!0});var Ur=s(bo);Oo=a(Ur,"A",{id:!0,class:!0,href:!0});var zh=s(Oo);Ta=a(zh,"SPAN",{});var Fh=s(Ta);_(ft.$$.fragment,Fh),Fh.forEach(o),zh.forEach(o),pl=i(Ur),wa=a(Ur,"SPAN",{});var qh=s(wa);hl=d(qh,"BlenderbotSmallModel"),qh.forEach(o),Ur.forEach(o),vr=i(t),ze=a(t,"DIV",{class:!0});var Xo=s(ze);_(_t.$$.fragment,Xo),ml=i(Xo),gt=a(Xo,"P",{});var Wr=s(gt);ul=d(Wr,`The bare BlenderbotSmall Model outputting raw hidden-states without any specific head on top.
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Rr.forEach(o),yl=i(Xo),ge=a(Xo,"DIV",{class:!0});var oo=s(ge);_(vt.$$.fragment,oo),Tl=i(oo),ko=a(oo,"P",{});var Xn=s(ko);wl=d(Xn,"The "),On=a(Xn,"A",{href:!0});var Mh=s(On);Sl=d(Mh,"BlenderbotSmallModel"),Mh.forEach(o),xl=d(Xn," forward method, overrides the "),Sa=a(Xn,"CODE",{});var Ch=s(Sa);Bl=d(Ch,"__call__"),Ch.forEach(o),zl=d(Xn," special method."),Xn.forEach(o),Fl=i(oo),_(Po.$$.fragment,oo),ql=i(oo),xa=a(oo,"P",{});var jh=s(xa);$l=d(jh,"Example:"),jh.forEach(o),El=i(oo),_(yt.$$.fragment,oo),oo.forEach(o),Xo.forEach(o),yr=i(t),vo=a(t,"H2",{class:!0});var Hr=s(vo);Lo=a(Hr,"A",{id:!0,class:!0,href:!0});var Oh=s(Lo);Ba=a(Oh,"SPAN",{});var Ph=s(Ba);_(Tt.$$.fragment,Ph),Ph.forEach(o),Oh.forEach(o),Ml=i(Hr),za=a(Hr,"SPAN",{});var Lh=s(za);Cl=d(Lh,"BlenderbotSmallForConditionalGeneration"),Lh.forEach(o),Hr.forEach(o),Tr=i(t),Fe=a(t,"DIV",{class:!0});var Yo=s(Fe);_(wt.$$.fragment,Yo),jl=i(Yo),St=a(Yo,"P",{});var Kr=s(St);Ol=d(Kr,`The BlenderbotSmall Model with a language modeling head. Can be used for summarization.
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Kr.forEach(o),Nl=i(Yo),xt=a(Yo,"P",{});var Vr=s(xt);Il=d(Vr,"This model is also a PyTorch "),Bt=a(Vr,"A",{href:!0,rel:!0});var Ih=s(Bt);Al=d(Ih,"torch.nn.Module"),Ih.forEach(o),Dl=d(Vr,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Vr.forEach(o),Gl=i(Yo),be=a(Yo,"DIV",{class:!0});var to=s(be);_(zt.$$.fragment,to),Ul=i(to),yo=a(to,"P",{});var Yn=s(yo);Wl=d(Yn,"The "),Ln=a(Yn,"A",{href:!0});var Ah=s(Ln);Rl=d(Ah,"BlenderbotSmallForConditionalGeneration"),Ah.forEach(o),Hl=d(Yn," forward method, overrides the "),Fa=a(Yn,"CODE",{});var Dh=s(Fa);Kl=d(Dh,"__call__"),Dh.forEach(o),Vl=d(Yn," special method."),Yn.forEach(o),Ql=i(to),_(No.$$.fragment,to),Jl=i(to),qa=a(to,"P",{});var Gh=s(qa);Xl=d(Gh,"Conversation example:"),Gh.forEach(o),Yl=i(to),_(Ft.$$.fragment,to),to.forEach(o),Yo.forEach(o),wr=i(t),To=a(t,"H2",{class:!0});var Qr=s(To);Io=a(Qr,"A",{id:!0,class:!0,href:!0});var Uh=s(Io);$a=a(Uh,"SPAN",{});var Wh=s($a);_(qt.$$.fragment,Wh),Wh.forEach(o),Uh.forEach(o),Zl=i(Qr),Ea=a(Qr,"SPAN",{});var Rh=s(Ea);ei=d(Rh,"BlenderbotSmallForCausalLM"),Rh.forEach(o),Qr.forEach(o),Sr=i(t),wo=a(t,"DIV",{class:!0});var Jr=s(wo);_($t.$$.fragment,Jr),oi=i(Jr),Ve=a(Jr,"DIV",{class:!0});var Zn=s(Ve);_(Et.$$.fragment,Zn),ti=i(Zn),Ma=a(Zn,"P",{});var Hh=s(Ma);ni=d(Hh,"Example:"),Hh.forEach(o),ai=i(Zn),_(Mt.$$.fragment,Zn),Zn.forEach(o),Jr.forEach(o),xr=i(t),So=a(t,"H2",{class:!0});var Xr=s(So);Ao=a(Xr,"A",{id:!0,class:!0,href:!0});var Kh=s(Ao);Ca=a(Kh,"SPAN",{});var Vh=s(Ca);_(Ct.$$.fragment,Vh),Vh.forEach(o),Kh.forEach(o),si=i(Xr),ja=a(Xr,"SPAN",{});var Qh=s(ja);ri=d(Qh,"TFBlenderbotSmallModel"),Qh.forEach(o),Xr.forEach(o),Br=i(t),he=a(t,"DIV",{class:!0});var no=s(he);_(jt.$$.fragment,no),di=i(no),Ot=a(no,"P",{});var Yr=s(Ot);li=d(Yr,`The bare BLENDERBOT_SMALL Model outputting raw hidden-states without any specific head on top.
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Zr.forEach(o),fi=i(no),_(Do.$$.fragment,no),_i=i(no),ke=a(no,"DIV",{class:!0});var ao=s(ke);_(Nt.$$.fragment,ao),gi=i(ao),xo=a(ao,"P",{});var ea=s(xo);bi=d(ea,"The "),In=a(ea,"A",{href:!0});var Yh=s(In);ki=d(Yh,"TFBlenderbotSmallModel"),Yh.forEach(o),vi=d(ea," forward method, overrides the "),Oa=a(ea,"CODE",{});var Zh=s(Oa);yi=d(Zh,"__call__"),Zh.forEach(o),Ti=d(ea," special method."),ea.forEach(o),wi=i(ao),_(Go.$$.fragment,ao),Si=i(ao),Pa=a(ao,"P",{});var em=s(Pa);xi=d(em,"Example:"),em.forEach(o),Bi=i(ao),_(It.$$.fragment,ao),ao.forEach(o),no.forEach(o),zr=i(t),Bo=a(t,"H2",{class:!0});var ed=s(Bo);Uo=a(ed,"A",{id:!0,class:!0,href:!0});var om=s(Uo);La=a(om,"SPAN",{});var tm=s(La);_(At.$$.fragment,tm),tm.forEach(o),om.forEach(o),zi=i(ed),Na=a(ed,"SPAN",{});var nm=s(Na);Fi=d(nm,"TFBlenderbotSmallForConditionalGeneration"),nm.forEach(o),ed.forEach(o),Fr=i(t),me=a(t,"DIV",{class:!0});var so=s(me);_(Dt.$$.fragment,so),qi=i(so),Gt=a(so,"P",{});var od=s(Gt);$i=d(od,`The BLENDERBOT_SMALL Model with a language modeling head. Can be used for summarization.
...
tokenizer([UTTERANCE], return_tensors=\u2018tf\u2019)`),_m.forEach(o),fm.forEach(o),um.forEach(o),mm.forEach(o),Yi=i(H),Qa=a(H,"BLOCKQUOTE",{});var gm=s(Qa);Ja=a(gm,"BLOCKQUOTE",{});var bm=s(Ja);Xa=a(bm,"BLOCKQUOTE",{});var km=s(Xa);Ya=a(km,"P",{});var vm=s(Ya);Zi=d(vm,`reply_ids = model.generate(**inputs) >>> print(\u201CBot: \u201D, tokenizer.batch_decode(reply_ids,
...
\u201D<s>I\u2019m not sure.\u201D \u2026 )`),nd.forEach(o),wm.forEach(o),Tm.forEach(o),ym.forEach(o),ac=i(H),ns=a(H,"BLOCKQUOTE",{});var xm=s(ns);as=a(xm,"BLOCKQUOTE",{});var Bm=s(as);ss=a(Bm,"BLOCKQUOTE",{});var zm=s(ss);rs=a(zm,"P",{});var Fm=s(rs);sc=d(Fm,`inputs = tokenizer([NEXT_UTTERANCE], return_tensors=\u2018tf\u2019) >>> inputs.pop(\u201Ctoken_type_ids\u201D) >>>
next_reply_ids = model.generate(**inputs) >>> print(\u201CBot: \u201D, tokenizer.batch_decode(next_reply_ids,
skip_special_tokens=True)[0])`),Fm.forEach(o),zm.forEach(o),Bm.forEach(o),xm.forEach(o),H.forEach(o),so.forEach(o),qr=i(t),Fo=a(t,"H2",{class:!0});var ad=s(Fo);Ho=a(ad,"A",{id:!0,class:!0,href:!0});var qm=s(Ho);ds=a(qm,"SPAN",{});var $m=s(ds);_(Kt.$$.fragment,$m),$m.forEach(o),qm.forEach(o),rc=i(ad),ls=a(ad,"SPAN",{});var Em=s(ls);dc=d(Em,"FlaxBlenderbotSmallModel"),Em.forEach(o),ad.forEach(o),$r=i(t),N=a(t,"DIV",{class:!0});var te=s(N);_(Vt.$$.fragment,te),lc=i(te),Qt=a(te,"P",{});var sd=s(Qt);ic=d(sd,`The bare BlenderbotSmall Model transformer outputting raw hidden-states without any specific head on top.
...
tokenizer([ARTICLE_TO_SUMMARIZE], max_length=1024, return_tensors=\u2018np\u2019)`),vu.forEach(o),ku.forEach(o),bu.forEach(o),gu.forEach(o),vp=i(E),Is=a(E,"BLOCKQUOTE",{});var yu=s(Is);As=a(yu,"BLOCKQUOTE",{});var Tu=s(As);kn=a(Tu,"BLOCKQUOTE",{});var cd=s(kn);Qo=a(cd,"H1",{class:!0});var pd=s(Qo);Jo=a(pd,"A",{id:!0,class:!0,href:!0});var wu=s(Jo);Ds=a(wu,"SPAN",{});var Su=s(Ds);_(vn.$$.fragment,Su),Su.forEach(o),wu.forEach(o),yp=i(pd),Gs=a(pd,"SPAN",{});var xu=s(Gs);Tp=d(xu,"Generate Summary >>> summary_ids = model.generate(inputs[\u2018input_ids\u2019]).sequences >>>"),xu.forEach(o),pd.forEach(o),wp=i(cd),Us=a(cd,"P",{});var Bu=s(Us);Sp=d(Bu,"print(tokenizer.batch_decode(summary_ids, skip_special_tokens=True, clean_up_tokenization_spaces=False))"),Bu.forEach(o),cd.forEach(o),Tu.forEach(o),yu.forEach(o),xp=i(E),Ws=a(E,"P",{});var zu=s(Ws);Bp=d(zu,"Mask filling example:"),zu.forEach(o),zp=i(E),Rs=a(E,"BLOCKQUOTE",{});var Fu=s(Rs);Hs=a(Fu,"BLOCKQUOTE",{});var qu=s(Hs);Ks=a(qu,"BLOCKQUOTE",{});var $u=s(Ks);Vs=a($u,"P",{});var Eu=s(Vs);Fp=d(Eu,`from transformers import BlenderbotSmallTokenizer, FlaxBlenderbotSmallForConditionalGeneration >>>
tokenizer = BlenderbotSmallTokenizer.from_pretrained(\u2018facebook/blenderbot_small-90M\u2019) >>> TXT = \u201CMy friends are
