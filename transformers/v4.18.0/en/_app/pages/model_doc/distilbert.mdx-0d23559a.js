...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),xh.forEach(t),ng=d(Kt),st=n(Kt,"DIV",{class:!0});var Jt=r(st);k(Un.$$.fragment,Jt),rg=d(Jt),_s=n(Jt,"P",{});var ll=r(_s);ag=i(ll,"The "),Pi=n(ll,"A",{href:!0});var Zy=r(Pi);ig=i(Zy,"DistilBertForMultipleChoice"),Zy.forEach(t),lg=i(ll," forward method, overrides the "),ed=n(ll,"CODE",{});var e0=r(ed);dg=i(e0,"__call__"),e0.forEach(t),cg=i(ll," special method."),ll.forEach(t),pg=d(Jt),k(io.$$.fragment,Jt),hg=d(Jt),td=n(Jt,"P",{});var t0=r(td);ug=i(t0,"Examples:"),t0.forEach(t),mg=d(Jt),k(Qn.$$.fragment,Jt),Jt.forEach(t),Kt.forEach(t),Op=d(s),vs=n(s,"H2",{class:!0});var zh=r(vs);lo=n(zh,"A",{id:!0,class:!0,href:!0});var s0=r(lo);sd=n(s0,"SPAN",{});var o0=r(sd);k(Hn.$$.fragment,o0),o0.forEach(t),s0.forEach(t),fg=d(zh),od=n(zh,"SPAN",{});var n0=r(od);gg=i(n0,"DistilBertForTokenClassification"),n0.forEach(t),zh.forEach(t),Np=d(s),Ze=n(s,"DIV",{class:!0});var Gt=r(Ze);k(Vn.$$.fragment,Gt),_g=d(Gt),nd=n(Gt,"P",{});var r0=r(nd);vg=i(r0,`DistilBert Model with a token classification head on top (a linear layer on top of the hidden-states output) e.g.
for Named-Entity-Recognition (NER) tasks.`),r0.forEach(t),bg=d(Gt),Kn=n(Gt,"P",{});var jh=r(Kn);kg=i(jh,"This model inherits from "),Ai=n(jh,"A",{href:!0});var a0=r(Ai);Tg=i(a0,"PreTrainedModel"),a0.forEach(t),wg=i(jh,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Ah.forEach(t),t_=d(Xt),Re=n(Xt,"DIV",{class:!0});var wt=r(Re);k(rr.$$.fragment,wt),s_=d(wt),ws=n(wt,"P",{});var pl=r(ws);o_=i(pl,"The "),Li=n(pl,"A",{href:!0});var v0=r(Li);n_=i(v0,"DistilBertForQuestionAnswering"),v0.forEach(t),r_=i(pl," forward method, overrides the "),pd=n(pl,"CODE",{});var b0=r(pd);a_=i(b0,"__call__"),b0.forEach(t),i_=i(pl," special method."),pl.forEach(t),l_=d(wt),k(ho.$$.fragment,wt),d_=d(wt),hd=n(wt,"P",{});var k0=r(hd);c_=i(k0,"Example:"),k0.forEach(t),p_=d(wt),k(ar.$$.fragment,wt),h_=d(wt),k(ir.$$.fragment,wt),wt.forEach(t),Xt.forEach(t),Ip=d(s),ys=n(s,"H2",{class:!0});var Oh=r(ys);uo=n(Oh,"A",{id:!0,class:!0,href:!0});var T0=r(uo);ud=n(T0,"SPAN",{});var w0=r(ud);k(lr.$$.fragment,w0),w0.forEach(t),T0.forEach(t),u_=d(Oh),md=n(Oh,"SPAN",{});var y0=r(md);m_=i(y0,"TFDistilBertModel"),y0.forEach(t),Oh.forEach(t),Wp=d(s),Pe=n(s,"DIV",{class:!0});var yt=r(Pe);k(dr.$$.fragment,yt),f_=d(yt),fd=n(yt,"P",{});var $0=r(fd);g_=i($0,"The bare DistilBERT encoder/transformer outputting raw hidden-states without any specific head on top."),$0.forEach(t),__=d(yt),cr=n(yt,"P",{});var Nh=r(cr);v_=i(Nh,"This model inherits from "),Si=n(Nh,"A",{href:!0});var F0=r(Si);b_=i(F0,"TFPreTrainedModel"),F0.forEach(t),k_=i(Nh,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Lh.forEach(t),F_=d(yt),k(mo.$$.fragment,yt),D_=d(yt),ot=n(yt,"DIV",{class:!0});var Yt=r(ot);k(ur.$$.fragment,Yt),B_=d(Yt),$s=n(Yt,"P",{});var hl=r($s);M_=i(hl,"The "),Ii=n(hl,"A",{href:!0});var B0=r(Ii);E_=i(B0,"TFDistilBertModel"),B0.forEach(t),x_=i(hl," forward method, overrides the "),gd=n(hl,"CODE",{});var M0=r(gd);z_=i(M0,"__call__"),M0.forEach(t),j_=i(hl," special method."),hl.forEach(t),C_=d(Yt),k(fo.$$.fragment,Yt),q_=d(Yt),_d=n(Yt,"P",{});var E0=r(_d);P_=i(E0,"Example:"),E0.forEach(t),A_=d(Yt),k(mr.$$.fragment,Yt),Yt.forEach(t),yt.forEach(t),Rp=d(s),Fs=n(s,"H2",{class:!0});var Sh=r(Fs);go=n(Sh,"A",{id:!0,class:!0,href:!0});var x0=r(go);vd=n(x0,"SPAN",{});var z0=r(vd);k(fr.$$.fragment,z0),z0.forEach(t),x0.forEach(t),O_=d(Sh),bd=n(Sh,"SPAN",{});var j0=r(bd);N_=i(j0,"TFDistilBertForMaskedLM"),j0.forEach(t),Sh.forEach(t),Up=d(s),Ae=n(s,"DIV",{class:!0});var $t=r(Ae);k(gr.$$.fragment,$t),L_=d($t),_r=n($t,"P",{});var Ih=r(_r);S_=i(Ih,"DistilBert Model with a "),kd=n(Ih,"CODE",{});var C0=r(kd);I_=i(C0,"masked language modeling"),C0.forEach(t),W_=i(Ih," head on top."),Ih.forEach(t),R_=d($t),vr=n($t,"P",{});var Wh=r(vr);U_=i(Wh,"This model inherits from "),Wi=n(Wh,"A",{href:!0});var q0=r(Wi);Q_=i(q0,"TFPreTrainedModel"),q0.forEach(t),H_=i(Wh,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Wh.forEach(t),V_=d($t),br=n($t,"P",{});var Rh=r(br);K_=i(Rh,"This model is also a "),kr=n(Rh,"A",{href:!0,rel:!0});var P0=r(kr);J_=i(P0,"tf.keras.Model"),P0.forEach(t),G_=i(Rh,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Rh.forEach(t),X_=d($t),k(_o.$$.fragment,$t),Y_=d($t),Ue=n($t,"DIV",{class:!0});var Ft=r(Ue);k(Tr.$$.fragment,Ft),Z_=d(Ft),Ds=n(Ft,"P",{});var ul=r(Ds);ev=i(ul,"The "),Ri=n(ul,"A",{href:!0});var A0=r(Ri);tv=i(A0,"TFDistilBertForMaskedLM"),A0.forEach(t),sv=i(ul," forward method, overrides the "),Td=n(ul,"CODE",{});var O0=r(Td);ov=i(O0,"__call__"),O0.forEach(t),nv=i(ul," special method."),ul.forEach(t),rv=d(Ft),k(vo.$$.fragment,Ft),av=d(Ft),wd=n(Ft,"P",{});var N0=r(wd);iv=i(N0,"Example:"),N0.forEach(t),lv=d(Ft),k(wr.$$.fragment,Ft),dv=d(Ft),k(yr.$$.fragment,Ft),Ft.forEach(t),$t.forEach(t),Qp=d(s),Bs=n(s,"H2",{class:!0});var Uh=r(Bs);bo=n(Uh,"A",{id:!0,class:!0,href:!0});var L0=r(bo);yd=n(L0,"SPAN",{});var S0=r(yd);k($r.$$.fragment,S0),S0.forEach(t),L0.forEach(t),cv=d(Uh),$d=n(Uh,"SPAN",{});var I0=r($d);pv=i(I0,"TFDistilBertForSequenceClassification"),I0.forEach(t),Uh.forEach(t),Hp=d(s),Oe=n(s,"DIV",{class:!0});var Dt=r(Oe);k(Fr.$$.fragment,Dt),hv=d(Dt),Fd=n(Dt,"P",{});var W0=r(Fd);uv=i(W0,`DistilBert Model transformer with a sequence classification/regression head on top (a linear layer on top of the
pooled output) e.g. for GLUE tasks.`),W0.forEach(t),mv=d(Dt),Dr=n(Dt,"P",{});var Qh=r(Dr);fv=i(Qh,"This model inherits from "),Ui=n(Qh,"A",{href:!0});var R0=r(Ui);gv=i(R0,"TFPreTrainedModel"),R0.forEach(t),_v=i(Qh,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Qh.forEach(t),vv=d(Dt),Br=n(Dt,"P",{});var Hh=r(Br);bv=i(Hh,"This model is also a "),Mr=n(Hh,"A",{href:!0,rel:!0});var U0=r(Mr);kv=i(U0,"tf.keras.Model"),U0.forEach(t),Tv=i(Hh,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Hh.forEach(t),wv=d(Dt),k(ko.$$.fragment,Dt),yv=d(Dt),Qe=n(Dt,"DIV",{class:!0});var Bt=r(Qe);k(Er.$$.fragment,Bt),$v=d(Bt),Ms=n(Bt,"P",{});var ml=r(Ms);Fv=i(ml,"The "),Qi=n(ml,"A",{href:!0});var Q0=r(Qi);Dv=i(Q0,"TFDistilBertForSequenceClassification"),Q0.forEach(t),Bv=i(ml," forward method, overrides the "),Dd=n(ml,"CODE",{});var H0=r(Dd);Mv=i(H0,"__call__"),H0.forEach(t),Ev=i(ml," special method."),ml.forEach(t),xv=d(Bt),k(To.$$.fragment,Bt),zv=d(Bt),Bd=n(Bt,"P",{});var V0=r(Bd);jv=i(V0,"Example:"),V0.forEach(t),Cv=d(Bt),k(xr.$$.fragment,Bt),qv=d(Bt),k(zr.$$.fragment,Bt),Bt.forEach(t),Dt.forEach(t),Vp=d(s),Es=n(s,"H2",{class:!0});var Vh=r(Es);wo=n(Vh,"A",{id:!0,class:!0,href:!0});var K0=r(wo);Md=n(K0,"SPAN",{});var J0=r(Md);k(jr.$$.fragment,J0),J0.forEach(t),K0.forEach(t),Pv=d(Vh),Ed=n(Vh,"SPAN",{});var G0=r(Ed);Av=i(G0,"TFDistilBertForMultipleChoice"),G0.forEach(t),Vh.forEach(t),Kp=d(s),Ne=n(s,"DIV",{class:!0});var Mt=r(Ne);k(Cr.$$.fragment,Mt),Ov=d(Mt),xd=n(Mt,"P",{});var X0=r(xd);Nv=i(X0,`DistilBert Model with a multiple choice classification head on top (a linear layer on top of the pooled output and
a softmax) e.g. for RocStories/SWAG tasks.`),X0.forEach(t),Lv=d(Mt),qr=n(Mt,"P",{});var Kh=r(qr);Sv=i(Kh,"This model inherits from "),Hi=n(Kh,"A",{href:!0});var Y0=r(Hi);Iv=i(Y0,"TFPreTrainedModel"),Y0.forEach(t),Wv=i(Kh,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Kh.forEach(t),Rv=d(Mt),Pr=n(Mt,"P",{});var Jh=r(Pr);Uv=i(Jh,"This model is also a "),Ar=n(Jh,"A",{href:!0,rel:!0});var Z0=r(Ar);Qv=i(Z0,"tf.keras.Model"),Z0.forEach(t),Hv=i(Jh,` subclass. Use it
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
...
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),lu.forEach(t),Yk=d(ht),nc=n(ht,"P",{});var H2=r(nc);Zk=i(H2,"Finally, this model supports inherent JAX features such as:"),H2.forEach(t),eT=d(ht),Pt=n(ht,"UL",{});var Vo=r(Pt);rc=n(Vo,"LI",{});var V2=r(rc);va=n(V2,"A",{href:!0,rel:!0});var K2=r(va);tT=i(K2,"Just-In-Time (JIT) compilation"),K2.forEach(t),V2.forEach(t),sT=d(Vo),ac=n(Vo,"LI",{});var J2=r(ac);ba=n(J2,"A",{href:!0,rel:!0});var G2=r(ba);oT=i(G2,"Automatic Differentiation"),G2.forEach(t),J2.forEach(t),nT=d(Vo),ic=n(Vo,"LI",{});var X2=r(ic);ka=n(X2,"A",{href:!0,rel:!0});var Y2=r(ka);rT=i(Y2,"Vectorization"),Y2.forEach(t),X2.forEach(t),aT=d(Vo),lc=n(Vo,"LI",{});var Z2=r(lc);Ta=n(Z2,"A",{href:!0,rel:!0});var e$=r(Ta);iT=i(e$,"Parallelization"),e$.forEach(t),Z2.forEach(t),Vo.forEach(t),lT=d(ht),at=n(ht,"DIV",{class:!0});var ts=r(at);k(wa.$$.fragment,ts),dT=d(ts),Ls=n(ts,"P",{});var kl=r(Ls);cT=i(kl,"The "),dc=n(kl,"CODE",{});var t$=r(dc);pT=i(t$,"FlaxDistilBertPreTrainedModel"),t$.forEach(t),hT=i(kl," forward method, overrides the "),cc=n(kl,"CODE",{});var s$=r(cc);uT=i(s$,"__call__"),s$.forEach(t),mT=i(kl," special method."),kl.forEach(t),fT=d(ts),k(qo.$$.fragment,ts),gT=d(ts),pc=n(ts,"P",{});var o$=r(pc);_T=i(o$,"Example:"),o$.forEach(t),vT=d(ts),k(ya.$$.fragment,ts),ts.forEach(t),ht.forEach(t),oh=d(s),Ss=n(s,"H2",{class:!0});var du=r(Ss);Po=n(du,"A",{id:!0,class:!0,href:!0});var n$=r(Po);hc=n(n$,"SPAN",{});var r$=r(hc);k($a.$$.fragment,r$),r$.forEach(t),n$.forEach(t),bT=d(du),uc=n(du,"SPAN",{});var a$=r(uc);kT=i(a$,"FlaxDistilBertForSequenceClassification"),a$.forEach(t),du.forEach(t),nh=d(s),xe=n(s,"DIV",{class:!0});var ut=r(xe);k(Fa.$$.fragment,ut),TT=d(ut),mc=n(ut,"P",{});var i$=r(mc);wT=i(i$,`DistilBert Model transformer with a sequence classification/regression head on top (a linear layer on top of the
...
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),pu.forEach(t),zT=d(ut),fc=n(ut,"P",{});var c$=r(fc);jT=i(c$,"Finally, this model supports inherent JAX features such as:"),c$.forEach(t),CT=d(ut),At=n(ut,"UL",{});var Ko=r(At);gc=n(Ko,"LI",{});var p$=r(gc);Ea=n(p$,"A",{href:!0,rel:!0});var h$=r(Ea);qT=i(h$,"Just-In-Time (JIT) compilation"),h$.forEach(t),p$.forEach(t),PT=d(Ko),_c=n(Ko,"LI",{});var u$=r(_c);xa=n(u$,"A",{href:!0,rel:!0});var m$=r(xa);AT=i(m$,"Automatic Differentiation"),m$.forEach(t),u$.forEach(t),OT=d(Ko),vc=n(Ko,"LI",{});var f$=r(vc);za=n(f$,"A",{href:!0,rel:!0});var g$=r(za);NT=i(g$,"Vectorization"),g$.forEach(t),f$.forEach(t),LT=d(Ko),bc=n(Ko,"LI",{});var _$=r(bc);ja=n(_$,"A",{href:!0,rel:!0});var v$=r(ja);ST=i(v$,"Parallelization"),v$.forEach(t),_$.forEach(t),Ko.forEach(t),IT=d(ut),it=n(ut,"DIV",{class:!0});var ss=r(it);k(Ca.$$.fragment,ss),WT=d(ss),Is=n(ss,"P",{});var Tl=r(Is);RT=i(Tl,"The "),kc=n(Tl,"CODE",{});var b$=r(kc);UT=i(b$,"FlaxDistilBertPreTrainedModel"),b$.forEach(t),QT=i(Tl," forward method, overrides the "),Tc=n(Tl,"CODE",{});var k$=r(Tc);HT=i(k$,"__call__"),k$.forEach(t),VT=i(Tl," special method."),Tl.forEach(t),KT=d(ss),k(Ao.$$.fragment,ss),JT=d(ss),wc=n(ss,"P",{});var T$=r(wc);GT=i(T$,"Example:"),T$.forEach(t),XT=d(ss),k(qa.$$.fragment,ss),ss.forEach(t),ut.forEach(t),rh=d(s),Ws=n(s,"H2",{class:!0});var hu=r(Ws);Oo=n(hu,"A",{id:!0,class:!0,href:!0});var w$=r(Oo);yc=n(w$,"SPAN",{});var y$=r(yc);k(Pa.$$.fragment,y$),y$.forEach(t),w$.forEach(t),YT=d(hu),$c=n(hu,"SPAN",{});var $$=r($c);ZT=i($$,"FlaxDistilBertForMultipleChoice"),$$.forEach(t),hu.forEach(t),ah=d(s),ze=n(s,"DIV",{class:!0});var mt=r(ze);k(Aa.$$.fragment,mt),ew=d(mt),Fc=n(mt,"P",{});var F$=r(Fc);tw=i(F$,`DistilBert Model with a multiple choice classification head on top (a linear layer on top of the pooled output and
