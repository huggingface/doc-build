import{S as uw,i as mw,s as fw,e as o,k as d,w as f,t as r,M as _w,c as s,d as t,m as l,a,x as _,h as i,b as c,F as e,g as p,y as g,q as T,o as v,B as b,v as gw}from"../../chunks/vendor-6b77c823.js";import{T as $t}from"../../chunks/Tip-39098574.js";import{D as M}from"../../chunks/Docstring-17b815d9.js";import{C as B}from"../../chunks/CodeBlock-3a8b25a8.js";import{I as ve}from"../../chunks/IconCopyLink-7a11ce68.js";function Tw(L){let u,z,k,w,$;return{c(){u=o("p"),z=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),k=o("code"),w=r("Module"),$=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(x){u=s(x,"P",{});var y=a(u);z=i(y,"Although the recipe for forward pass needs to be defined within this function, one should call the "),k=s(y,"CODE",{});var q=a(k);w=i(q,"Module"),q.forEach(t),$=i(y,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),y.forEach(t)},m(x,y){p(x,u,y),e(u,z),e(u,k),e(k,w),e(u,$)},d(x){x&&t(u)}}}function vw(L){let u,z,k,w,$;return{c(){u=o("p"),z=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),k=o("code"),w=r("Module"),$=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(x){u=s(x,"P",{});var y=a(u);z=i(y,"Although the recipe for forward pass needs to be defined within this function, one should call the "),k=s(y,"CODE",{});var q=a(k);w=i(q,"Module"),q.forEach(t),$=i(y,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),y.forEach(t)},m(x,y){p(x,u,y),e(u,z),e(u,k),e(k,w),e(u,$)},d(x){x&&t(u)}}}function bw(L){let u,z,k,w,$;return{c(){u=o("p"),z=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),k=o("code"),w=r("Module"),$=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(x){u=s(x,"P",{});var y=a(u);z=i(y,"Although the recipe for forward pass needs to be defined within this function, one should call the "),k=s(y,"CODE",{});var q=a(k);w=i(q,"Module"),q.forEach(t),$=i(y,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),y.forEach(t)},m(x,y){p(x,u,y),e(u,z),e(u,k),e(k,w),e(u,$)},d(x){x&&t(u)}}}function kw(L){let u,z,k,w,$,x,y,q,qe,oe,E,ee,S,se,Ee,G,je,be,U,A,ae,pe,F,P,he,K,ke,ue,W,Fe,ye,C,Me,H,V,me,N,Ce,fe,I,Pe,R,Ne;return{c(){u=o("p"),z=r("TF 2.0 models accepts two formats as inputs:"),k=d(),w=o("ul"),$=o("li"),x=r("having all inputs as keyword arguments (like PyTorch models), or"),y=d(),q=o("li"),qe=r("having all inputs as a list, tuple or dict in the first positional arguments."),oe=d(),E=o("p"),ee=r("This second option is useful when using "),S=o("code"),se=r("tf.keras.Model.fit"),Ee=r(` method which currently requires having all the
tensors in the first argument of the model call function: `),G=o("code"),je=r("model(inputs)"),be=r("."),U=d(),A=o("p"),ae=r(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),pe=d(),F=o("ul"),P=o("li"),he=r("a single Tensor with "),K=o("code"),ke=r("input_ids"),ue=r(" only and nothing else: "),W=o("code"),Fe=r("model(inputs_ids)"),ye=d(),C=o("li"),Me=r(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
...
`),R=s(Ae,"CODE",{});var ft=a(R);Ne=i(ft,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),ft.forEach(t),Ae.forEach(t),O.forEach(t)},m(m,j){p(m,u,j),e(u,z),p(m,k,j),p(m,w,j),e(w,$),e($,x),e(w,y),e(w,q),e(q,qe),p(m,oe,j),p(m,E,j),e(E,ee),e(E,S),e(S,se),e(E,Ee),e(E,G),e(G,je),e(E,be),p(m,U,j),p(m,A,j),e(A,ae),p(m,pe,j),p(m,F,j),e(F,P),e(P,he),e(P,K),e(K,ke),e(P,ue),e(P,W),e(W,Fe),e(F,ye),e(F,C),e(C,Me),e(C,H),e(H,V),e(C,me),e(C,N),e(N,Ce),e(F,fe),e(F,I),e(I,Pe),e(I,R),e(R,Ne)},d(m){m&&t(u),m&&t(k),m&&t(w),m&&t(oe),m&&t(E),m&&t(U),m&&t(A),m&&t(pe),m&&t(F)}}}function yw(L){let u,z,k,w,$;return{c(){u=o("p"),z=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),k=o("code"),w=r("Module"),$=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(x){u=s(x,"P",{});var y=a(u);z=i(y,"Although the recipe for forward pass needs to be defined within this function, one should call the "),k=s(y,"CODE",{});var q=a(k);w=i(q,"Module"),q.forEach(t),$=i(y,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),y.forEach(t)},m(x,y){p(x,u,y),e(u,z),e(u,k),e(k,w),e(u,$)},d(x){x&&t(u)}}}function ww(L){let u,z,k,w,$,x,y,q,qe,oe,E,ee,S,se,Ee,G,je,be,U,A,ae,pe,F,P,he,K,ke,ue,W,Fe,ye,C,Me,H,V,me,N,Ce,fe,I,Pe,R,Ne;return{c(){u=o("p"),z=r("TF 2.0 models accepts two formats as inputs:"),k=d(),w=o("ul"),$=o("li"),x=r("having all inputs as keyword arguments (like PyTorch models), or"),y=d(),q=o("li"),qe=r("having all inputs as a list, tuple or dict in the first positional arguments."),oe=d(),E=o("p"),ee=r("This second option is useful when using "),S=o("code"),se=r("tf.keras.Model.fit"),Ee=r(` method which currently requires having all the
tensors in the first argument of the model call function: `),G=o("code"),je=r("model(inputs)"),be=r("."),U=d(),A=o("p"),ae=r(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),pe=d(),F=o("ul"),P=o("li"),he=r("a single Tensor with "),K=o("code"),ke=r("input_ids"),ue=r(" only and nothing else: "),W=o("code"),Fe=r("model(inputs_ids)"),ye=d(),C=o("li"),Me=r(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),H=o("code"),V=r("model([input_ids, attention_mask])"),me=r(" or "),N=o("code"),Ce=r("model([input_ids, attention_mask, token_type_ids])"),fe=d(),I=o("li"),Pe=r(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),R=o("code"),Ne=r('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(m){u=s(m,"P",{});var j=a(u);z=i(j,"TF 2.0 models accepts two formats as inputs:"),j.forEach(t),k=l(m),w=s(m,"UL",{});var te=a(w);$=s(te,"LI",{});var Se=a($);x=i(Se,"having all inputs as keyword arguments (like PyTorch models), or"),Se.forEach(t),y=l(te),q=s(te,"LI",{});var pt=a(q);qe=i(pt,"having all inputs as a list, tuple or dict in the first positional arguments."),pt.forEach(t),te.forEach(t),oe=l(m),E=s(m,"P",{});var D=a(E);ee=i(D,"This second option is useful when using "),S=s(D,"CODE",{});var Ge=a(S);se=i(Ge,"tf.keras.Model.fit"),Ge.forEach(t),Ee=i(D,` method which currently requires having all the
...
first positional argument :`),ht.forEach(t),pe=l(m),F=s(m,"UL",{});var O=a(F);P=s(O,"LI",{});var Y=a(P);he=i(Y,"a single Tensor with "),K=s(Y,"CODE",{});var ut=a(K);ke=i(ut,"input_ids"),ut.forEach(t),ue=i(Y," only and nothing else: "),W=s(Y,"CODE",{});var Oe=a(W);Fe=i(Oe,"model(inputs_ids)"),Oe.forEach(t),Y.forEach(t),ye=l(O),C=s(O,"LI",{});var Z=a(C);Me=i(Z,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),H=s(Z,"CODE",{});var mt=a(H);V=i(mt,"model([input_ids, attention_mask])"),mt.forEach(t),me=i(Z," or "),N=s(Z,"CODE",{});var Le=a(N);Ce=i(Le,"model([input_ids, attention_mask, token_type_ids])"),Le.forEach(t),Z.forEach(t),fe=l(O),I=s(O,"LI",{});var Ae=a(I);Pe=i(Ae,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),R=s(Ae,"CODE",{});var ft=a(R);Ne=i(ft,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),ft.forEach(t),Ae.forEach(t),O.forEach(t)},m(m,j){p(m,u,j),e(u,z),p(m,k,j),p(m,w,j),e(w,$),e($,x),e(w,y),e(w,q),e(q,qe),p(m,oe,j),p(m,E,j),e(E,ee),e(E,S),e(S,se),e(E,Ee),e(E,G),e(G,je),e(E,be),p(m,U,j),p(m,A,j),e(A,ae),p(m,pe,j),p(m,F,j),e(F,P),e(P,he),e(P,K),e(K,ke),e(P,ue),e(P,W),e(W,Fe),e(F,ye),e(F,C),e(C,Me),e(C,H),e(H,V),e(C,me),e(C,N),e(N,Ce),e(F,fe),e(F,I),e(I,Pe),e(I,R),e(R,Ne)},d(m){m&&t(u),m&&t(k),m&&t(w),m&&t(oe),m&&t(E),m&&t(U),m&&t(A),m&&t(pe),m&&t(F)}}}function xw(L){let u,z,k,w,$;return{c(){u=o("p"),z=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),k=o("code"),w=r("Module"),$=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(x){u=s(x,"P",{});var y=a(u);z=i(y,"Although the recipe for forward pass needs to be defined within this function, one should call the "),k=s(y,"CODE",{});var q=a(k);w=i(q,"Module"),q.forEach(t),$=i(y,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),y.forEach(t)},m(x,y){p(x,u,y),e(u,z),e(u,k),e(k,w),e(u,$)},d(x){x&&t(u)}}}function $w(L){let u,z,k,w,$,x,y,q,qe,oe,E,ee,S,se,Ee,G,je,be,U,A,ae,pe,F,P,he,K,ke,ue,W,Fe,ye,C,Me,H,V,me,N,Ce,fe,I,Pe,R,Ne;return{c(){u=o("p"),z=r("TF 2.0 models accepts two formats as inputs:"),k=d(),w=o("ul"),$=o("li"),x=r("having all inputs as keyword arguments (like PyTorch models), or"),y=d(),q=o("li"),qe=r("having all inputs as a list, tuple or dict in the first positional arguments."),oe=d(),E=o("p"),ee=r("This second option is useful when using "),S=o("code"),se=r("tf.keras.Model.fit"),Ee=r(` method which currently requires having all the
tensors in the first argument of the model call function: `),G=o("code"),je=r("model(inputs)"),be=r("."),U=d(),A=o("p"),ae=r(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in the
first positional argument :`),pe=d(),F=o("ul"),P=o("li"),he=r("a single Tensor with "),K=o("code"),ke=r("input_ids"),ue=r(" only and nothing else: "),W=o("code"),Fe=r("model(inputs_ids)"),ye=d(),C=o("li"),Me=r(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),H=o("code"),V=r("model([input_ids, attention_mask])"),me=r(" or "),N=o("code"),Ce=r("model([input_ids, attention_mask, token_type_ids])"),fe=d(),I=o("li"),Pe=r(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),R=o("code"),Ne=r('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(m){u=s(m,"P",{});var j=a(u);z=i(j,"TF 2.0 models accepts two formats as inputs:"),j.forEach(t),k=l(m),w=s(m,"UL",{});var te=a(w);$=s(te,"LI",{});var Se=a($);x=i(Se,"having all inputs as keyword arguments (like PyTorch models), or"),Se.forEach(t),y=l(te),q=s(te,"LI",{});var pt=a(q);qe=i(pt,"having all inputs as a list, tuple or dict in the first positional arguments."),pt.forEach(t),te.forEach(t),oe=l(m),E=s(m,"P",{});var D=a(E);ee=i(D,"This second option is useful when using "),S=s(D,"CODE",{});var Ge=a(S);se=i(Ge,"tf.keras.Model.fit"),Ge.forEach(t),Ee=i(D,` method which currently requires having all the
...
first positional argument :`),ht.forEach(t),pe=l(m),F=s(m,"UL",{});var O=a(F);P=s(O,"LI",{});var Y=a(P);he=i(Y,"a single Tensor with "),K=s(Y,"CODE",{});var ut=a(K);ke=i(ut,"input_ids"),ut.forEach(t),ue=i(Y," only and nothing else: "),W=s(Y,"CODE",{});var Oe=a(W);Fe=i(Oe,"model(inputs_ids)"),Oe.forEach(t),Y.forEach(t),ye=l(O),C=s(O,"LI",{});var Z=a(C);Me=i(Z,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),H=s(Z,"CODE",{});var mt=a(H);V=i(mt,"model([input_ids, attention_mask])"),mt.forEach(t),me=i(Z," or "),N=s(Z,"CODE",{});var Le=a(N);Ce=i(Le,"model([input_ids, attention_mask, token_type_ids])"),Le.forEach(t),Z.forEach(t),fe=l(O),I=s(O,"LI",{});var Ae=a(I);Pe=i(Ae,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),R=s(Ae,"CODE",{});var ft=a(R);Ne=i(ft,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),ft.forEach(t),Ae.forEach(t),O.forEach(t)},m(m,j){p(m,u,j),e(u,z),p(m,k,j),p(m,w,j),e(w,$),e($,x),e(w,y),e(w,q),e(q,qe),p(m,oe,j),p(m,E,j),e(E,ee),e(E,S),e(S,se),e(E,Ee),e(E,G),e(G,je),e(E,be),p(m,U,j),p(m,A,j),e(A,ae),p(m,pe,j),p(m,F,j),e(F,P),e(P,he),e(P,K),e(K,ke),e(P,ue),e(P,W),e(W,Fe),e(F,ye),e(F,C),e(C,Me),e(C,H),e(H,V),e(C,me),e(C,N),e(N,Ce),e(F,fe),e(F,I),e(I,Pe),e(I,R),e(R,Ne)},d(m){m&&t(u),m&&t(k),m&&t(w),m&&t(oe),m&&t(E),m&&t(U),m&&t(A),m&&t(pe),m&&t(F)}}}function zw(L){let u,z,k,w,$;return{c(){u=o("p"),z=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),k=o("code"),w=r("Module"),$=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(x){u=s(x,"P",{});var y=a(u);z=i(y,"Although the recipe for forward pass needs to be defined within this function, one should call the "),k=s(y,"CODE",{});var q=a(k);w=i(q,"Module"),q.forEach(t),$=i(y,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),y.forEach(t)},m(x,y){p(x,u,y),e(u,z),e(u,k),e(k,w),e(u,$)},d(x){x&&t(u)}}}function qw(L){let u,z,k,w,$;return{c(){u=o("p"),z=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),k=o("code"),w=r("Module"),$=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(x){u=s(x,"P",{});var y=a(u);z=i(y,"Although the recipe for forward pass needs to be defined within this function, one should call the "),k=s(y,"CODE",{});var q=a(k);w=i(q,"Module"),q.forEach(t),$=i(y,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),y.forEach(t)},m(x,y){p(x,u,y),e(u,z),e(u,k),e(k,w),e(u,$)},d(x){x&&t(u)}}}function Ew(L){let u,z,k,w,$;return{c(){u=o("p"),z=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),k=o("code"),w=r("Module"),$=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(x){u=s(x,"P",{});var y=a(u);z=i(y,"Although the recipe for forward pass needs to be defined within this function, one should call the "),k=s(y,"CODE",{});var q=a(k);w=i(q,"Module"),q.forEach(t),$=i(y,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),y.forEach(t)},m(x,y){p(x,u,y),e(u,z),e(u,k),e(k,w),e(u,$)},d(x){x&&t(u)}}}function jw(L){let u,z,k,w,$,x,y,q,qe,oe,E,ee,S,se,Ee,G,je,be,U,A,ae,pe,F,P,he,K,ke,ue,W,Fe,ye,C,Me,H,V,me,N,Ce,fe,I,Pe,R,Ne,m,j,te,Se,pt,D,Ge,ne,ht,O,Y,ut,Oe,Z,mt,Le,Ae,ft,Vl,Xa,Dp,Kl,Ue,di,li,To,Sp,Gp,ci,pi,vo,Up,Wp,hi,ui,bo,Rp,Bp,mi,fi,ko,Hp,Vp,_i,Qa,yo,Kp,Yp,Yl,er,Zp,Zl,zt,gi,$n,Ti,Jp,Xp,tr,Qp,eh,th,vi,zn,bi,nh,oh,nr,sh,ah,rh,ki,qn,yi,ih,dh,or,lh,ch,Jl,En,ph,wo,hh,uh,Xl,qt,mh,xo,fh,_h,$o,gh,Th,Ql,sr,ec,Zt,jn,wi,zo,vh,xi,bh,tc,_t,kh,$i,yh,wh,zi,xh,$h,qi,zh,qh,nc,Fn,Eh,ar,jh,Fh,oc,Mn,dt,Ei,Mh,Ch,_e,Ph,ji,Nh,Oh,Fi,Lh,Ah,Mi,Ih,Dh,Ci,Sh,Gh,Pi,Uh,Wh,rr,Rh,Bh,Hh,Ni,Vh,Kh,qo,Yh,Eo,Zh,jo,Jh,Xh,Qh,ge,Oi,eu,tu,Li,nu,ou,Fo,su,re,au,Ai,ru,iu,Ii,du,lu,Di,cu,pu,Si,hu,uu,Gi,mu,fu,Ui,_u,gu,Wi,Tu,vu,bu,Jt,ku,Ri,yu,wu,Bi,xu,$u,zu,Te,qu,Hi,Eu,ju,Vi,Fu,Mu,Ki,Cu,Pu,Yi,Nu,Ou,Mo,Lu,Au,Zi,Iu,Du,Su,Co,sc,ir,Gu,ac,Et,Ji,Po,Uu,Xi,Wu,Ru,Bu,Qi,Xt,Hu,No,Vu,Ku,Oo,Yu,Zu,Ju,ed,Lo,Xu,td,Qu,em,rc,dr,ic,Qt,Cn,nd,Ao,tm,od,nm,dc,gt,om,lr,sm,am,Io,rm,im,Do,dm,lm,lc,So,cc,We,cm,sd,pm,hm,ad,um,mm,cr,fm,_m,rd,gm,Tm,pc,pr,vm,hc,Go,uc,hr,mc,en,Pn,id,Uo,bm,dd,km,fc,Tt,ym,Wo,wm,xm,ld,$m,zm,cd,qm,Em,_c,tn,Nn,pd,Ro,jm,hd,Fm,gc,ur,Mm,Tc,On,ud,nn,Cm,Bo,Pm,Nm,Ho,Om,Lm,Am,md,Ie,Im,Vo,Dm,Sm,Ko,Gm,Um,Yo,Wm,Rm,Zo,Bm,Hm,Jo,Vm,Km,vc,on,Ln,fd,Xo,Ym,_d,Zm,bc,wt,Qo,Jm,xt,Xm,mr,Qm,ef,fr,tf,nf,es,of,sf,af,sn,rf,_r,df,lf,gr,cf,pf,kc,an,An,gd,ts,hf,Td,uf,yc,ie,ns,mf,os,ff,ss,_f,gf,Tf,as,vf,Tr,bf,kf,yf,jt,rs,wf,vd,xf,$f,is,vr,zf,bd,qf,Ef,br,jf,kd,Ff,Mf,In,ds,Cf,ls,Pf,yd,Nf,Of,Lf,Dn,cs,Af,wd,If,Df,kr,ps,wc,rn,Sn,xd,hs,Sf,$d,Gf,xc,De,us,Uf,dn,Wf,zd,Rf,Bf,ms,Hf,Vf,Kf,fs,Yf,yr,Zf,Jf,Xf,Ft,_s,Qf,qd,e_,t_,gs,wr,n_,Ed,o_,s_,xr,a_,jd,r_,i_,Gn,Ts,d_,Fd,l_,$c,ln,Un,Md,vs,c_,Cd,p_,zc,J,bs,h_,Pd,u_,m_,ks,f_,ys,__,g_,T_,ws,v_,$r,b_,k_,y_,xs,w_,$s,x_,$_,z_,Re,zs,q_,cn,E_,zr,j_,F_,Nd,M_,C_,P_,Wn,N_,Od,O_,L_,qs,A_,Be,Es,I_,Ld,D_,S_,Ad,G_,U_,Id,W_,R_,js,B_,vt,Fs,H_,Dd,V_,K_,Sd,Y_,Z_,Ms,qc,pn,Rn,Gd,Cs,J_,Ud,X_,Ec,X,Ps,Q_,Ns,eg,Wd,tg,ng,og,Os,sg,Ls,ag,rg,ig,As,dg,qr,lg,cg,pg,Is,hg,Ds,ug,mg,fg,He,Ss,_g,hn,gg,Er,Tg,vg,Rd,bg,kg,yg,Bn,wg,Bd,xg,$g,Gs,zg,Ve,Us,qg,Hd,Eg,jg,Vd,Fg,Mg,Kd,Cg,Pg,Ws,Ng,bt,Rs,Og,Yd,Lg,Ag,Zd,Ig,Dg,Bs,jc,un,Hn,Jd,Hs,Sg,Xd,Gg,Fc,Q,Vs,Ug,Qd,Wg,Rg,Ks,Bg,Ys,Hg,Vg,Kg,Zs,Yg,jr,Zg,Jg,Xg,Js,Qg,Xs,eT,tT,nT,Ke,Qs,oT,mn,sT,Fr,aT,rT,el,iT,dT,lT,Vn,cT,tl,pT,hT,ea,uT,Ye,ta,mT,nl,fT,_T,ol,gT,TT,sl,vT,bT,na,kT,kt,oa,yT,al,wT,xT,rl,$T,zT,sa,Mc,fn,Kn,il,aa,qT,dl,ET,Cc,de,ra,jT,ll,FT,MT,ia,CT,da,PT,NT,OT,la,LT,Mr,AT,IT,DT,ca,ST,pa,GT,UT,WT,Yn,RT,Ze,ha,BT,_n,HT,Cr,VT,KT,cl,YT,ZT,JT,Zn,XT,pl,QT,ev,ua,Pc,gn,Jn,hl,ma,tv,ul,nv,Nc,le,fa,ov,_a,sv,ml,av,rv,iv,ga,dv,Ta,lv,cv,pv,va,hv,Pr,uv,mv,fv,ba,_v,ka,gv,Tv,vv,Xn,bv,Je,ya,kv,Tn,yv,Nr,wv,xv,fl,$v,zv,qv,Qn,Ev,_l,jv,Fv,wa,Oc,vn,eo,gl,xa,Mv,Tl,Cv,Lc,ce,$a,Pv,vl,Nv,Ov,za,Lv,qa,Av,Iv,Dv,Ea,Sv,Or,Gv,Uv,Wv,ja,Rv,Fa,Bv,Hv,Vv,to,Kv,Xe,Ma,Yv,bn,Zv,Lr,Jv,Xv,bl,Qv,eb,tb,no,nb,kl,ob,sb,Ca,Ac,kn,oo,yl,Pa,ab,wl,rb,Ic,lt,Na,ib,Qe,Oa,db,yn,lb,xl,cb,pb,$l,hb,ub,mb,so,fb,zl,_b,gb,La,Tb,Mt,Aa,vb,ql,bb,kb,Ia,yb,Ct,Da,wb,El,xb,$b,Sa,Dc,wn,ao,jl,Ga,zb,Fl,qb,Sc,ct,Ua,Eb,et,Wa,jb,xn,Fb,Ml,Mb,Cb,Cl,Pb,Nb,Ob,ro,Lb,Pl,Ab,Ib,Ra,Db,Pt,Ba,Sb,Nl,Gb,Ub,Ha,Wb,Nt,Va,Rb,Ol,Bb,Hb,Ka,Gc;return x=new ve({}),se=new ve({}),zo=new ve({}),qo=new B({props:{code:`from transformers import T5Tokenizer, T5ForConditionalGeneration
...
`,returnType:`
<p><code>List[int]</code></p>
`}}),cs=new M({props:{name:"create_token_type_ids_from_sequences",anchor:"transformers.T5Tokenizer.create_token_type_ids_from_sequences",parameters:[{name:"token_ids_0",val:": typing.List[int]"},{name:"token_ids_1",val:": typing.Optional[typing.List[int]] = None"}],parametersDescription:[{anchor:"transformers.T5Tokenizer.create_token_type_ids_from_sequences.token_ids_0",description:`<strong>token_ids_0</strong> (<code>List[int]</code>) &#x2014;
...
`,returnType:`
<p><code>List[int]</code></p>
`}}),ps=new M({props:{name:"save_vocabulary",anchor:"transformers.T5Tokenizer.save_vocabulary",parameters:[{name:"save_directory",val:": str"},{name:"filename_prefix",val:": typing.Optional[str] = None"}],source:"https://github.com/huggingface/transformers/blob/v4.18.0/src/transformers/models/t5/tokenization_t5.py#L298"}}),hs=new ve({}),us=new M({props:{name:"class transformers.T5TokenizerFast",anchor:"transformers.T5TokenizerFast",parameters:[{name:"vocab_file",val:" = None"},{name:"tokenizer_file",val:" = None"},{name:"eos_token",val:" = '</s>'"},{name:"unk_token",val:" = '<unk>'"},{name:"pad_token",val:" = '<pad>'"},{name:"extra_ids",val:" = 100"},{name:"additional_special_tokens",val:" = None"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.T5TokenizerFast.vocab_file",description:`<strong>vocab_file</strong> (<code>str</code>) &#x2014;
<a href="https://github.com/google/sentencepiece" rel="nofollow">SentencePiece</a> file (generally has a <em>.spm</em> extension) that
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),Es=new M({props:{name:"parallelize",anchor:"transformers.T5Model.parallelize",parameters:[{name:"device_map",val:" = None"}],parametersDescription:[{anchor:"transformers.T5Model.parallelize.device_map",description:`<strong>device_map</strong> (<code>Dict[int, list]</code>, optional, defaults to None) &#x2014;
...
<li>t5-3b: 24</li>
<li>t5-11b: 24</li>
</ul>`,name:"device_map"}],source:"https://github.com/huggingface/transformers/blob/v4.18.0/src/transformers/models/t5/modeling_t5.py#L1299"}}),js=new B({props:{code:`# Here is an example of a device map on a machine with 4 GPUs using t5-3b, which has a total of 24 attention modules:
...
model.deparallelize()  <span class="hljs-comment"># Put the model back on cpu and cleans memory by calling torch.cuda.empty_cache()</span>`}}),Cs=new ve({}),Ps=new M({props:{name:"class transformers.T5ForConditionalGeneration",anchor:"transformers.T5ForConditionalGeneration",parameters:[{name:"config",val:": T5Config"}],parametersDescription:[{anchor:"transformers.T5ForConditionalGeneration.config",description:`<strong>config</strong> (<a href="/docs/transformers/v4.18.0/en/model_doc/t5#transformers.T5Config">T5Config</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/v4.18.0/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/v4.18.0/src/transformers/models/t5/modeling_t5.py#L1456"}}),Ss=new M({props:{name:"forward",anchor:"transformers.T5ForConditionalGeneration.forward",parameters:[{name:"input_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"attention_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"decoder_input_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"decoder_attention_mask",val:": typing.Optional[torch.BoolTensor] = None"},{name:"head_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"decoder_head_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"cross_attn_head_mask",val:": typing.Optional[torch.Tensor] = None"},{name:"encoder_outputs",val:": typing.Optional[typing.Tuple[typing.Tuple[torch.Tensor]]] = None"},{name:"past_key_values",val:": typing.Optional[typing.Tuple[typing.Tuple[torch.Tensor]]] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"decoder_inputs_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"labels",val:": typing.Optional[torch.LongTensor] = None"},{name:"use_cache",val:": typing.Optional[bool] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.T5ForConditionalGeneration.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. T5 is a model with relative position embeddings so you
should be able to pad the inputs on both the right and the left.</p>
<p>Indices can be obtained using <a href="/docs/transformers/v4.18.0/en/model_doc/mt5#transformers.T5Tokenizer">T5Tokenizer</a>. See <a href="/docs/transformers/v4.18.0/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/v4.18.0/en/model_doc/wav2vec2_phoneme#transformers.Wav2Vec2PhonemeCTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for detail.</p>
...
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-comment"># studies have shown that owning a dog is good for you.</span>`}}),Us=new M({props:{name:"parallelize",anchor:"transformers.T5ForConditionalGeneration.parallelize",parameters:[{name:"device_map",val:" = None"}],parametersDescription:[{anchor:"transformers.T5ForConditionalGeneration.parallelize.device_map",description:`<strong>device_map</strong> (<code>Dict[int, list]</code>, optional, defaults to None) &#x2014;
A dictionary that maps attention modules to devices. Note that the embedding module and LMHead are always
automatically mapped to the first device (for esoteric reasons). That means that the first device should
have fewer attention modules mapped to it than other devices. For reference, the t5 models have the
following number of attention modules:</p>
...
<li>t5-3b: 24</li>
<li>t5-11b: 24</li>
</ul>`,name:"device_map"}],source:"https://github.com/huggingface/transformers/blob/v4.18.0/src/transformers/models/t5/modeling_t5.py#L1493"}}),Ws=new B({props:{code:`# Here is an example of a device map on a machine with 4 GPUs using t5-3b, which has a total of 24 attention modules:
model = T5ForConditionalGeneration.from_pretrained("t5-3b")
device_map = {
    0: [0, 1, 2],
    1: [3, 4, 5, 6, 7, 8, 9],
...
model.parallelize(device_map)  <span class="hljs-comment"># Splits the model across several devices</span>
model.deparallelize()  <span class="hljs-comment"># Put the model back on cpu and cleans memory by calling torch.cuda.empty_cache()</span>`}}),Hs=new ve({}),Vs=new M({props:{name:"class transformers.T5EncoderModel",anchor:"transformers.T5EncoderModel",parameters:[{name:"config",val:": T5Config"}],parametersDescription:[{anchor:"transformers.T5EncoderModel.config",description:`<strong>config</strong> (<a href="/docs/transformers/v4.18.0/en/model_doc/t5#transformers.T5Config">T5Config</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/v4.18.0/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/v4.18.0/src/transformers/models/t5/modeling_t5.py#L1750"}}),Qs=new M({props:{name:"forward",anchor:"transformers.T5EncoderModel.forward",parameters:[{name:"input_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"attention_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"head_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],parametersDescription:[{anchor:"transformers.T5EncoderModel.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. T5 is a model with relative position embeddings so you
should be able to pad the inputs on both the right and the left.</p>
<p>Indices can be obtained using <a href="/docs/transformers/v4.18.0/en/model_doc/mt5#transformers.T5Tokenizer">T5Tokenizer</a>. See <a href="/docs/transformers/v4.18.0/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/v4.18.0/en/model_doc/wav2vec2_phoneme#transformers.Wav2Vec2PhonemeCTCTokenizer.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for detail.</p>
...
`}}),Vn=new $t({props:{$$slots:{default:[bw]},$$scope:{ctx:L}}}),ea=new B({props:{code:`from transformers import T5Tokenizer, T5EncoderModel
...
<span class="hljs-meta">&gt;&gt;&gt; </span>last_hidden_states = outputs.last_hidden_state`}}),ta=new M({props:{name:"parallelize",anchor:"transformers.T5EncoderModel.parallelize",parameters:[{name:"device_map",val:" = None"}],parametersDescription:[{anchor:"transformers.T5EncoderModel.parallelize.device_map",description:`<strong>device_map</strong> (<code>Dict[int, list]</code>, optional, defaults to None) &#x2014;
A dictionary that maps attention modules to devices. Note that the embedding module and LMHead are always
automatically mapped to the first device (for esoteric reasons). That means that the first device should
have fewer attention modules mapped to it than other devices. For reference, the t5 models have the
following number of attention modules:</p>
...
<li>t5-3b: 24</li>
<li>t5-11b: 24</li>
</ul>`,name:"device_map"}],source:"https://github.com/huggingface/transformers/blob/v4.18.0/src/transformers/models/t5/modeling_t5.py#L1771"}}),na=new B({props:{code:`# Here is an example of a device map on a machine with 4 GPUs using t5-3b, which has a total of 24 attention modules:
model = T5ForConditionalGeneration.from_pretrained("t5-3b")
device_map = {
    0: [0, 1, 2],
    1: [3, 4, 5, 6, 7, 8, 9],
...
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-built_in">print</span>(tokenizer.decode(outputs[<span class="hljs-number">0</span>], skip_special_tokens=<span class="hljs-literal">True</span>))
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-comment"># studies have shown that owning a dog is good for you</span>`}}),xa=new ve({}),$a=new M({props:{name:"class transformers.TFT5EncoderModel",anchor:"transformers.TFT5EncoderModel",parameters:[{name:"*args",val:""},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.TFT5EncoderModel.config",description:`<strong>config</strong> (<a href="/docs/transformers/v4.18.0/en/model_doc/t5#transformers.T5Config">T5Config</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/v4.18.0/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}],source:"https://github.com/huggingface/transformers/blob/v4.18.0/src/transformers/models/t5/modeling_tf_t5.py#L1596"}}),to=new $t({props:{$$slots:{default:[$w]},$$scope:{ctx:L}}}),Ma=new M({props:{name:"call",anchor:"transformers.TFT5EncoderModel.call",parameters:[{name:"input_ids",val:": typing.Union[typing.List[tensorflow.python.framework.ops.Tensor], typing.List[numpy.ndarray], typing.List[tensorflow.python.keras.engine.keras_tensor.KerasTensor], typing.Dict[str, tensorflow.python.framework.ops.Tensor], typing.Dict[str, numpy.ndarray], typing.Dict[str, tensorflow.python.keras.engine.keras_tensor.KerasTensor], tensorflow.python.framework.ops.Tensor, numpy.ndarray, tensorflow.python.keras.engine.keras_tensor.KerasTensor, NoneType] = None"},{name:"attention_mask",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"head_mask",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"inputs_embeds",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"training",val:": typing.Optional[bool] = False"}],parametersDescription:[{anchor:"transformers.TFT5EncoderModel.call.inputs",description:`<strong>inputs</strong> (<code>tf.Tensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. T5 is a model with relative position embeddings so you
should be able to pad the inputs on the right or the left.</p>
...
<span class="hljs-meta">&gt;&gt;&gt; </span>outputs = model.decode(decoder_input_ids, encoder_outputs)
<span class="hljs-meta">&gt;&gt;&gt; </span>logits = outputs.logits`}}),{c(){u=o("meta"),z=d(),k=o("h1"),w=o("a"),$=o("span"),f(x.$$.fragment),y=d(),q=o("span"),qe=r("T5"),oe=d(),E=o("h2"),ee=o("a"),S=o("span"),f(se.$$.fragment),Ee=d(),G=o("span"),je=r("Overview"),be=d(),U=o("p"),A=r("The T5 model was presented in "),ae=o("a"),pe=r("Exploring the Limits of Transfer Learning with a Unified Text-to-Text Transformer"),F=r(` by Colin Raffel, Noam Shazeer, Adam Roberts, Katherine Lee, Sharan Narang,
Michael Matena, Yanqi Zhou, Wei Li, Peter J. Liu.`),P=d(),he=o("p"),K=r("The abstract from the paper is the following:"),ke=d(),ue=o("p"),W=o("em"),Fe=r(`Transfer learning, where a model is first pre-trained on a data-rich task before being fine-tuned on a downstream
...
for summarization: `),R=o("em"),Ne=r("summarize: \u2026"),m=r("."),j=d(),te=o("li"),Se=o("p"),pt=r("T5 uses relative scalar embeddings. Encoder input padding can be done on the left and on the right."),D=d(),Ge=o("li"),ne=o("p"),ht=r("See the "),O=o("a"),Y=r("training"),ut=r(", "),Oe=o("a"),Z=r("inference"),mt=r(" and "),Le=o("a"),Ae=r("scripts"),ft=r(" sections below for all details regarding usage."),Vl=d(),Xa=o("p"),Dp=r("T5 comes in different sizes:"),Kl=d(),Ue=o("ul"),di=o("li"),li=o("p"),To=o("a"),Sp=r("t5-small"),Gp=d(),ci=o("li"),pi=o("p"),vo=o("a"),Up=r("t5-base"),Wp=d(),hi=o("li"),ui=o("p"),bo=o("a"),Rp=r("t5-large"),Bp=d(),mi=o("li"),fi=o("p"),ko=o("a"),Hp=r("t5-3b"),Vp=d(),_i=o("li"),Qa=o("p"),yo=o("a"),Kp=r("t5-11b"),Yp=r("."),Yl=d(),er=o("p"),Zp=r("Based on the original T5 model, Google has released some follow-up works:"),Zl=d(),zt=o("ul"),gi=o("li"),$n=o("p"),Ti=o("strong"),Jp=r("T5v1.1"),Xp=r(`: T5v1.1 is an improved version of T5 with some architectural tweaks, and is pre-trained on C4 only without
mixing in the supervised tasks. Refer to the documentation of T5v1.1 which can be found `),tr=o("a"),Qp=r("here"),eh=r("."),th=d(),vi=o("li"),zn=o("p"),bi=o("strong"),nh=r("mT5"),oh=r(`: mT5 is a multilingual T5 model. It is pre-trained on the mC4 corpus, which includes 101 languages. Refer to
the documentation of mT5 which can be found `),nr=o("a"),sh=r("here"),ah=r("."),rh=d(),ki=o("li"),qn=o("p"),yi=o("strong"),ih=r("byT5"),dh=r(`: byT5 is a T5 model pre-trained on byte sequences rather than SentencePiece subword token sequences. Refer
to the documentation of byT5 which can be found `),or=o("a"),lh=r("here"),ch=r("."),Jl=d(),En=o("p"),ph=r("All checkpoints can be found on the "),wo=o("a"),hh=r("hub"),uh=r("."),Xl=d(),qt=o("p"),mh=r("This model was contributed by "),xo=o("a"),fh=r("thomwolf"),_h=r(". The original code can be found "),$o=o("a"),gh=r("here"),Th=r("."),Ql=d(),sr=o("a"),ec=d(),Zt=o("h2"),jn=o("a"),wi=o("span"),f(zo.$$.fragment),vh=d(),xi=o("span"),bh=r("Training"),tc=d(),_t=o("p"),kh=r(`T5 is an encoder-decoder model and converts all NLP problems into a text-to-text format. It is trained using teacher
...
during T5\u2019s pre-training.`),bu=d(),Jt=o("p"),ku=r(`However, the example above only shows a single training example. In practice, one trains deep learning models in
...
you to easily fine-tune T5 on custom data for summarization/translation.`),vc=d(),on=o("h2"),Ln=o("a"),fd=o("span"),f(Xo.$$.fragment),Ym=d(),_d=o("span"),Zm=r("T5Config"),bc=d(),wt=o("div"),f(Qo.$$.fragment),Jm=d(),xt=o("p"),Xm=r("This is the configuration class to store the configuration of a "),mr=o("a"),Qm=r("T5Model"),ef=r(" or a "),fr=o("a"),tf=r("TFT5Model"),nf=r(`. It is used to
...
documentation from `),gr=o("a"),cf=r("PretrainedConfig"),pf=r(" for more information."),kc=d(),an=o("h2"),An=o("a"),gd=o("span"),f(ts.$$.fragment),hf=d(),Td=o("span"),uf=r("T5Tokenizer"),yc=d(),ie=o("div"),f(ns.$$.fragment),mf=d(),os=o("p"),ff=r("Construct a T5 tokenizer. Based on "),ss=o("a"),_f=r("SentencePiece"),gf=r("."),Tf=d(),as=o("p"),vf=r("This tokenizer inherits from "),Tr=o("a"),bf=r("PreTrainedTokenizer"),kf=r(` which contains most of the main methods. Users should refer to
...
adding special tokens. A sequence has the following format:`),$f=d(),is=o("ul"),vr=o("li"),zf=r("single sequence: "),bd=o("code"),qf=r("X </s>"),Ef=d(),br=o("li"),jf=r("pair of sequences: "),kd=o("code"),Ff=r("A </s> B </s>"),Mf=d(),In=o("div"),f(ds.$$.fragment),Cf=d(),ls=o("p"),Pf=r(`Retrieve sequence ids from a token list that has no special tokens added. This method is called when adding
...
use of token type ids, therefore a list of zeros is returned.`),Df=d(),kr=o("div"),f(ps.$$.fragment),wc=d(),rn=o("h2"),Sn=o("a"),xd=o("span"),f(hs.$$.fragment),Sf=d(),$d=o("span"),Gf=r("T5TokenizerFast"),xc=d(),De=o("div"),f(us.$$.fragment),Uf=d(),dn=o("p"),Wf=r("Construct a \u201Cfast\u201D T5 tokenizer (backed by HuggingFace\u2019s "),zd=o("em"),Rf=r("tokenizers"),Bf=r(` library). Based on
...
use of token type ids, therefore a list of zeros is returned.`),$c=d(),ln=o("h2"),Un=o("a"),Md=o("span"),f(vs.$$.fragment),c_=d(),Cd=o("span"),p_=r("T5Model"),zc=d(),J=o("div"),f(bs.$$.fragment),h_=d(),Pd=o("p"),u_=r("The bare T5 Model transformer outputting raw hidden-states without any specific head on top."),m_=d(),ks=o("p"),f_=r("The T5 model was proposed in "),ys=o("a"),__=r(`Exploring the Limits of Transfer Learning with a Unified Text-to-Text
Transformer`),g_=r(` by Colin Raffel, Noam Shazeer, Adam Roberts, Katherine Lee, Sharan
Narang, Michael Matena, Yanqi Zhou, Wei Li, Peter J. Liu. It\u2019s an encoder decoder transformer pre-trained in a
text-to-text denoising generative setting.`),T_=d(),ws=o("p"),v_=r("This model inherits from "),$r=o("a"),b_=r("PreTrainedModel"),k_=r(`. Check the superclass documentation for the generic methods the
...
it will evenly distribute blocks across all devices.`),TT=d(),sl=o("p"),vT=r("Example:"),bT=d(),f(na.$$.fragment),kT=d(),kt=o("div"),f(oa.$$.fragment),yT=d(),al=o("p"),wT=r("Moves the model to cpu from a model parallel state."),xT=d(),rl=o("p"),$T=r("Example:"),zT=d(),f(sa.$$.fragment),Mc=d(),fn=o("h2"),Kn=o("a"),il=o("span"),f(aa.$$.fragment),qT=d(),dl=o("span"),ET=r("TFT5Model"),Cc=d(),de=o("div"),f(ra.$$.fragment),jT=d(),ll=o("p"),FT=r("The bare T5 Model transformer outputting raw hidden-stateswithout any specific head on top."),MT=d(),ia=o("p"),CT=r("The T5 model was proposed in "),da=o("a"),PT=r(`Exploring the Limits of Transfer Learning with a Unified Text-to-Text
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Vv=d(),f(to.$$.fragment),Kv=d(),Xe=o("div"),f(Ma.$$.fragment),Yv=d(),bn=o("p"),Zv=r("The "),Lr=o("a"),Jv=r("TFT5EncoderModel"),Xv=r(" forward method, overrides the "),bl=o("code"),Qv=r("__call__"),eb=r(" special method."),tb=d(),f(no.$$.fragment),nb=d(),kl=o("p"),ob=r("Examples:"),sb=d(),f(Ca.$$.fragment),Ac=d(),kn=o("h2"),oo=o("a"),yl=o("span"),f(Pa.$$.fragment),ab=d(),wl=o("span"),rb=r("FlaxT5Model"),Ic=d(),lt=o("div"),f(Na.$$.fragment),ib=d(),Qe=o("div"),f(Oa.$$.fragment),db=d(),yn=o("p"),lb=r("The "),xl=o("code"),cb=r("FlaxT5PreTrainedModel"),pb=r(" forward method, overrides the "),$l=o("code"),hb=r("__call__"),ub=r(" special method."),mb=d(),f(so.$$.fragment),fb=d(),zl=o("p"),_b=r("Example:"),gb=d(),f(La.$$.fragment),Tb=d(),Mt=o("div"),f(Aa.$$.fragment),vb=d(),ql=o("p"),bb=r("Example:"),kb=d(),f(Ia.$$.fragment),yb=d(),Ct=o("div"),f(Da.$$.fragment),wb=d(),El=o("p"),xb=r("Example:"),$b=d(),f(Sa.$$.fragment),Dc=d(),wn=o("h2"),ao=o("a"),jl=o("span"),f(Ga.$$.fragment),zb=d(),Fl=o("span"),qb=r("FlaxT5ForConditionalGeneration"),Sc=d(),ct=o("div"),f(Ua.$$.fragment),Eb=d(),et=o("div"),f(Wa.$$.fragment),jb=d(),xn=o("p"),Fb=r("The "),Ml=o("code"),Mb=r("FlaxT5PreTrainedModel"),Cb=r(" forward method, overrides the "),Cl=o("code"),Pb=r("__call__"),Nb=r(" special method."),Ob=d(),f(ro.$$.fragment),Lb=d(),Pl=o("p"),Ab=r("Example:"),Ib=d(),f(Ra.$$.fragment),Db=d(),Pt=o("div"),f(Ba.$$.fragment),Sb=d(),Nl=o("p"),Gb=r("Example:"),Ub=d(),f(Ha.$$.fragment),Wb=d(),Nt=o("div"),f(Va.$$.fragment),Rb=d(),Ol=o("p"),Bb=r("Example:"),Hb=d(),f(Ka.$$.fragment),this.h()},l(n){const h=_w('[data-svelte="svelte-1phssyn"]',document.head);u=s(h,"META",{name:!0,content:!0}),h.forEach(t),z=l(n),k=s(n,"H1",{class:!0});var Ya=a(k);w=s(Ya,"A",{id:!0,class:!0,href:!0});var Ll=a(w);$=s(Ll,"SPAN",{});var Al=a($);_(x.$$.fragment,Al),Al.forEach(t),Ll.forEach(t),y=l(Ya),q=s(Ya,"SPAN",{});var Il=a(q);qe=i(Il,"T5"),Il.forEach(t),Ya.forEach(t),oe=l(n),E=s(n,"H2",{class:!0});var Za=a(E);ee=s(Za,"A",{id:!0,class:!0,href:!0});var Dl=a(ee);S=s(Dl,"SPAN",{});var Sl=a(S);_(se.$$.fragment,Sl),Sl.forEach(t),Dl.forEach(t),Ee=l(Za),G=s(Za,"SPAN",{});var Gl=a(G);je=i(Gl,"Overview"),Gl.forEach(t),Za.forEach(t),be=l(n),U=s(n,"P",{});var Ja=a(U);A=i(Ja,"The T5 model was presented in "),ae=s(Ja,"A",{href:!0,rel:!0});var Ul=a(ae);pe=i(Ul,"Exploring the Limits of Transfer Learning with a Unified Text-to-Text Transformer"),Ul.forEach(t),F=i(Ja,` by Colin Raffel, Noam Shazeer, Adam Roberts, Katherine Lee, Sharan Narang,
Michael Matena, Yanqi Zhou, Wei Li, Peter J. Liu.`),Ja.forEach(t),P=l(n),he=s(n,"P",{});var Wl=a(he);K=i(Wl,"The abstract from the paper is the following:"),Wl.forEach(t),ke=l(n),ue=s(n,"P",{});var Xb=a(ue);W=s(Xb,"EM",{});var Qb=a(W);Fe=i(Qb,`Transfer learning, where a model is first pre-trained on a data-rich task before being fine-tuned on a downstream
task, has emerged as a powerful technique in natural language processing (NLP). The effectiveness of transfer learning
has given rise to a diversity of approaches, methodology, and practice. In this paper, we explore the landscape of
transfer learning techniques for NLP by introducing a unified framework that converts every language problem into a
text-to-text format. Our systematic study compares pretraining objectives, architectures, unlabeled datasets, transfer
...
for summarization: `),R=s(Ir,"EM",{});var ok=a(R);Ne=i(ok,"summarize: \u2026"),ok.forEach(t),m=i(Ir,"."),Ir.forEach(t),tk.forEach(t),j=l(Ar),te=s(Ar,"LI",{});var sk=a(te);Se=s(sk,"P",{});var ak=a(Se);pt=i(ak,"T5 uses relative scalar embeddings. Encoder input padding can be done on the left and on the right."),ak.forEach(t),sk.forEach(t),D=l(Ar),Ge=s(Ar,"LI",{});var rk=a(Ge);ne=s(rk,"P",{});var io=a(ne);ht=i(io,"See the "),O=s(io,"A",{href:!0});var ik=a(O);Y=i(ik,"training"),ik.forEach(t),ut=i(io,", "),Oe=s(io,"A",{href:!0});var dk=a(Oe);Z=i(dk,"inference"),dk.forEach(t),mt=i(io," and "),Le=s(io,"A",{href:!0});var lk=a(Le);Ae=i(lk,"scripts"),lk.forEach(t),ft=i(io," sections below for all details regarding usage."),io.forEach(t),rk.forEach(t),Ar.forEach(t),Vl=l(n),Xa=s(n,"P",{});var ck=a(Xa);Dp=i(ck,"T5 comes in different sizes:"),ck.forEach(t),Kl=l(n),Ue=s(n,"UL",{});var Ot=a(Ue);di=s(Ot,"LI",{});var pk=a(di);li=s(pk,"P",{});var hk=a(li);To=s(hk,"A",{href:!0,rel:!0});var uk=a(To);Sp=i(uk,"t5-small"),uk.forEach(t),hk.forEach(t),pk.forEach(t),Gp=l(Ot),ci=s(Ot,"LI",{});var mk=a(ci);pi=s(mk,"P",{});var fk=a(pi);vo=s(fk,"A",{href:!0,rel:!0});var _k=a(vo);Up=i(_k,"t5-base"),_k.forEach(t),fk.forEach(t),mk.forEach(t),Wp=l(Ot),hi=s(Ot,"LI",{});var gk=a(hi);ui=s(gk,"P",{});var Tk=a(ui);bo=s(Tk,"A",{href:!0,rel:!0});var vk=a(bo);Rp=i(vk,"t5-large"),vk.forEach(t),Tk.forEach(t),gk.forEach(t),Bp=l(Ot),mi=s(Ot,"LI",{});var bk=a(mi);fi=s(bk,"P",{});var kk=a(fi);ko=s(kk,"A",{href:!0,rel:!0});var yk=a(ko);Hp=i(yk,"t5-3b"),yk.forEach(t),kk.forEach(t),bk.forEach(t),Vp=l(Ot),_i=s(Ot,"LI",{});var wk=a(_i);Qa=s(wk,"P",{});var Vb=a(Qa);yo=s(Vb,"A",{href:!0,rel:!0});var xk=a(yo);Kp=i(xk,"t5-11b"),xk.forEach(t),Yp=i(Vb,"."),Vb.forEach(t),wk.forEach(t),Ot.forEach(t),Yl=l(n),er=s(n,"P",{});var $k=a(er);Zp=i($k,"Based on the original T5 model, Google has released some follow-up works:"),$k.forEach(t),Zl=l(n),zt=s(n,"UL",{});var Dr=a(zt);gi=s(Dr,"LI",{});var zk=a(gi);$n=s(zk,"P",{});var Rl=a($n);Ti=s(Rl,"STRONG",{});var qk=a(Ti);Jp=i(qk,"T5v1.1"),qk.forEach(t),Xp=i(Rl,`: T5v1.1 is an improved version of T5 with some architectural tweaks, and is pre-trained on C4 only without
mixing in the supervised tasks. Refer to the documentation of T5v1.1 which can be found `),tr=s(Rl,"A",{href:!0});var Ek=a(tr);Qp=i(Ek,"here"),Ek.forEach(t),eh=i(Rl,"."),Rl.forEach(t),zk.forEach(t),th=l(Dr),vi=s(Dr,"LI",{});var jk=a(vi);zn=s(jk,"P",{});var Bl=a(zn);bi=s(Bl,"STRONG",{});var Fk=a(bi);nh=i(Fk,"mT5"),Fk.forEach(t),oh=i(Bl,`: mT5 is a multilingual T5 model. It is pre-trained on the mC4 corpus, which includes 101 languages. Refer to
the documentation of mT5 which can be found `),nr=s(Bl,"A",{href:!0});var Mk=a(nr);sh=i(Mk,"here"),Mk.forEach(t),ah=i(Bl,"."),Bl.forEach(t),jk.forEach(t),rh=l(Dr),ki=s(Dr,"LI",{});var Ck=a(ki);qn=s(Ck,"P",{});var Hl=a(qn);yi=s(Hl,"STRONG",{});var Pk=a(yi);ih=i(Pk,"byT5"),Pk.forEach(t),dh=i(Hl,`: byT5 is a T5 model pre-trained on byte sequences rather than SentencePiece subword token sequences. Refer
to the documentation of byT5 which can be found `),or=s(Hl,"A",{href:!0});var Nk=a(or);lh=i(Nk,"here"),Nk.forEach(t),ch=i(Hl,"."),Hl.forEach(t),Ck.forEach(t),Dr.forEach(t),Jl=l(n),En=s(n,"P",{});var Uc=a(En);ph=i(Uc,"All checkpoints can be found on the "),wo=s(Uc,"A",{href:!0,rel:!0});var Ok=a(wo);hh=i(Ok,"hub"),Ok.forEach(t),uh=i(Uc,"."),Uc.forEach(t),Xl=l(n),qt=s(n,"P",{});var Sr=a(qt);mh=i(Sr,"This model was contributed by "),xo=s(Sr,"A",{href:!0,rel:!0});var Lk=a(xo);fh=i(Lk,"thomwolf"),Lk.forEach(t),_h=i(Sr,". The original code can be found "),$o=s(Sr,"A",{href:!0,rel:!0});var Ak=a($o);gh=i(Ak,"here"),Ak.forEach(t),Th=i(Sr,"."),Sr.forEach(t),Ql=l(n),sr=s(n,"A",{id:!0}),a(sr).forEach(t),ec=l(n),Zt=s(n,"H2",{class:!0});var Wc=a(Zt);jn=s(Wc,"A",{id:!0,class:!0,href:!0});var Ik=a(jn);wi=s(Ik,"SPAN",{});var Dk=a(wi);_(zo.$$.fragment,Dk),Dk.forEach(t),Ik.forEach(t),vh=l(Wc),xi=s(Wc,"SPAN",{});var Sk=a(xi);bh=i(Sk,"Training"),Sk.forEach(t),Wc.forEach(t),tc=l(n),_t=s(n,"P",{});var lo=a(_t);kh=i(lo,`T5 is an encoder-decoder model and converts all NLP problems into a text-to-text format. It is trained using teacher
forcing. This means that for training, we always need an input sequence and a corresponding target sequence. The input
...
equal to 0 (i.e. the id of the pad token). Also note the task prefix: we prepend the input sequence with \u2018translate
English to German: \u2019 before encoding it. This will help in improving the performance, as this task prefix was used
during T5\u2019s pre-training.`),we.forEach(t),bu=l(nt),Jt=s(nt,"P",{});var Gr=a(Jt);ku=i(Gr,`However, the example above only shows a single training example. In practice, one trains deep learning models in
batches. This entails that we must pad/truncate examples to the same length. For encoder-decoder models, one
...
optimizer. Typically, 1e-4 and 3e-4 work well for most problems (classification, summarization, translation, question
answering, question generation). Note that T5 was pre-trained using the AdaFactor optimizer.`),Vc.forEach(t),Ty.forEach(t),Bu=l(Ur),Qi=s(Ur,"LI",{});var by=a(Qi);Xt=s(by,"P",{});var Wr=a(Xt);Hu=i(Wr,"According to "),No=s(Wr,"A",{href:!0,rel:!0});var ky=a(No);Vu=i(ky,"this forum post"),ky.forEach(t),Ku=i(Wr,`, task prefixes matter when
(1) doing multi-task training (2) your task is similar or related to one of the supervised tasks used in T5\u2019s
...
used).`),Wr.forEach(t),by.forEach(t),Ju=l(Ur),ed=s(Ur,"LI",{});var wy=a(ed);Lo=s(wy,"P",{});var Kc=a(Lo);Xu=i(Kc,`If training on TPU, it is recommended to pad all examples of the dataset to the same length or make use of
...
documentation from `),gr=s(Hr,"A",{href:!0});var d1=a(gr);cf=i(d1,"PretrainedConfig"),d1.forEach(t),pf=i(Hr," for more information."),Hr.forEach(t),Br.forEach(t),kc=l(n),an=s(n,"H2",{class:!0});var ep=a(an);An=s(ep,"A",{id:!0,class:!0,href:!0});var l1=a(An);gd=s(l1,"SPAN",{});var c1=a(gd);_(ts.$$.fragment,c1),c1.forEach(t),l1.forEach(t),hf=l(ep),Td=s(ep,"SPAN",{});var p1=a(Td);uf=i(p1,"T5Tokenizer"),p1.forEach(t),ep.forEach(t),yc=l(n),ie=s(n,"DIV",{class:!0});var st=a(ie);_(ns.$$.fragment,st),mf=l(st),os=s(st,"P",{});var tp=a(os);ff=i(tp,"Construct a T5 tokenizer. Based on "),ss=s(tp,"A",{href:!0,rel:!0});var h1=a(ss);_f=i(h1,"SentencePiece"),h1.forEach(t),gf=i(tp,"."),tp.forEach(t),Tf=l(st),as=s(st,"P",{});var np=a(as);vf=i(np,"This tokenizer inherits from "),Tr=s(np,"A",{href:!0});var u1=a(Tr);bf=i(u1,"PreTrainedTokenizer"),u1.forEach(t),kf=i(np,` which contains most of the main methods. Users should refer to
...
adding special tokens. A sequence has the following format:`),m1.forEach(t),$f=l(Vr),is=s(Vr,"UL",{});var op=a(is);vr=s(op,"LI",{});var Kb=a(vr);zf=i(Kb,"single sequence: "),bd=s(Kb,"CODE",{});var f1=a(bd);qf=i(f1,"X </s>"),f1.forEach(t),Kb.forEach(t),Ef=l(op),br=s(op,"LI",{});var Yb=a(br);jf=i(Yb,"pair of sequences: "),kd=s(Yb,"CODE",{});var _1=a(kd);Ff=i(_1,"A </s> B </s>"),_1.forEach(t),Yb.forEach(t),op.forEach(t),Vr.forEach(t),Mf=l(st),In=s(st,"DIV",{class:!0});var sp=a(In);_(ds.$$.fragment,sp),Cf=l(sp),ls=s(sp,"P",{});var ap=a(ls);Pf=i(ap,`Retrieve sequence ids from a token list that has no special tokens added. This method is called when adding
...
use of token type ids, therefore a list of zeros is returned.`),T1.forEach(t),rp.forEach(t),Df=l(st),kr=s(st,"DIV",{class:!0});var v1=a(kr);_(ps.$$.fragment,v1),v1.forEach(t),st.forEach(t),wc=l(n),rn=s(n,"H2",{class:!0});var ip=a(rn);Sn=s(ip,"A",{id:!0,class:!0,href:!0});var b1=a(Sn);xd=s(b1,"SPAN",{});var k1=a(xd);_(hs.$$.fragment,k1),k1.forEach(t),b1.forEach(t),Sf=l(ip),$d=s(ip,"SPAN",{});var y1=a($d);Gf=i(y1,"T5TokenizerFast"),y1.forEach(t),ip.forEach(t),xc=l(n),De=s(n,"DIV",{class:!0});var It=a(De);_(us.$$.fragment,It),Uf=l(It),dn=s(It,"P",{});var Kr=a(dn);Wf=i(Kr,"Construct a \u201Cfast\u201D T5 tokenizer (backed by HuggingFace\u2019s "),zd=s(Kr,"EM",{});var w1=a(zd);Rf=i(w1,"tokenizers"),w1.forEach(t),Bf=i(Kr,` library). Based on
...
adding special tokens. A sequence has the following format:`),z1.forEach(t),t_=l(Yr),gs=s(Yr,"UL",{});var lp=a(gs);wr=s(lp,"LI",{});var Zb=a(wr);n_=i(Zb,"single sequence: "),Ed=s(Zb,"CODE",{});var q1=a(Ed);o_=i(q1,"X </s>"),q1.forEach(t),Zb.forEach(t),s_=l(lp),xr=s(lp,"LI",{});var Jb=a(xr);a_=i(Jb,"pair of sequences: "),jd=s(Jb,"CODE",{});var E1=a(jd);r_=i(E1,"A </s> B </s>"),E1.forEach(t),Jb.forEach(t),lp.forEach(t),Yr.forEach(t),i_=l(It),Gn=s(It,"DIV",{class:!0});var cp=a(Gn);_(Ts.$$.fragment,cp),d_=l(cp),Fd=s(cp,"P",{});var j1=a(Fd);l_=i(j1,`Create a mask from the two sequences passed to be used in a sequence-pair classification task. T5 does not make
use of token type ids, therefore a list of zeros is returned.`),j1.forEach(t),cp.forEach(t),It.forEach(t),$c=l(n),ln=s(n,"H2",{class:!0});var pp=a(ln);Un=s(pp,"A",{id:!0,class:!0,href:!0});var F1=a(Un);Md=s(F1,"SPAN",{});var M1=a(Md);_(vs.$$.fragment,M1),M1.forEach(t),F1.forEach(t),c_=l(pp),Cd=s(pp,"SPAN",{});var C1=a(Cd);p_=i(C1,"T5Model"),C1.forEach(t),pp.forEach(t),zc=l(n),J=s(n,"DIV",{class:!0});var xe=a(J);_(bs.$$.fragment,xe),h_=l(xe),Pd=s(xe,"P",{});var P1=a(Pd);u_=i(P1,"The bare T5 Model transformer outputting raw hidden-states without any specific head on top."),P1.forEach(t),m_=l(xe),ks=s(xe,"P",{});var hp=a(ks);f_=i(hp,"The T5 model was proposed in "),ys=s(hp,"A",{href:!0,rel:!0});var N1=a(ys);__=i(N1,`Exploring the Limits of Transfer Learning with a Unified Text-to-Text
Transformer`),N1.forEach(t),g_=i(hp,` by Colin Raffel, Noam Shazeer, Adam Roberts, Katherine Lee, Sharan
Narang, Michael Matena, Yanqi Zhou, Wei Li, Peter J. Liu. It\u2019s an encoder decoder transformer pre-trained in a
text-to-text denoising generative setting.`),hp.forEach(t),T_=l(xe),ws=s(xe,"P",{});var up=a(ws);v_=i(up,"This model inherits from "),$r=s(up,"A",{href:!0});var O1=a($r);b_=i(O1,"PreTrainedModel"),O1.forEach(t),k_=i(up,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),vp.forEach(t),fg=l($e),He=s($e,"DIV",{class:!0});var Gt=a(He);_(Ss.$$.fragment,Gt),_g=l(Gt),hn=s(Gt,"P",{});var Jr=a(hn);gg=i(Jr,"The "),Er=s(Jr,"A",{href:!0});var X1=a(Er);Tg=i(X1,"T5ForConditionalGeneration"),X1.forEach(t),vg=i(Jr," forward method, overrides the "),Rd=s(Jr,"CODE",{});var Q1=a(Rd);bg=i(Q1,"__call__"),Q1.forEach(t),kg=i(Jr," special method."),Jr.forEach(t),yg=l(Gt),_(Bn.$$.fragment,Gt),wg=l(Gt),Bd=s(Gt,"P",{});var e5=a(Bd);xg=i(e5,"Examples:"),e5.forEach(t),$g=l(Gt),_(Gs.$$.fragment,Gt),Gt.forEach(t),zg=l($e),Ve=s($e,"DIV",{class:!0});var Ut=a(Ve);_(Us.$$.fragment,Ut),qg=l(Ut),Hd=s(Ut,"P",{});var t5=a(Hd);Eg=i(t5,"This is an experimental feature and is a subject to change at a moment\u2019s notice."),t5.forEach(t),jg=l(Ut),Vd=s(Ut,"P",{});var n5=a(Vd);Fg=i(n5,`Uses a device map to distribute attention modules of the model across several devices. If no device map is given,
it will evenly distribute blocks across all devices.`),n5.forEach(t),Mg=l(Ut),Kd=s(Ut,"P",{});var o5=a(Kd);Cg=i(o5,"Example:"),o5.forEach(t),Pg=l(Ut),_(Ws.$$.fragment,Ut),Ut.forEach(t),Ng=l($e),bt=s($e,"DIV",{class:!0});var mo=a(bt);_(Rs.$$.fragment,mo),Og=l(mo),Yd=s(mo,"P",{});var s5=a(Yd);Lg=i(s5,"Moves the model to cpu from a model parallel state."),s5.forEach(t),Ag=l(mo),Zd=s(mo,"P",{});var a5=a(Zd);Ig=i(a5,"Example:"),a5.forEach(t),Dg=l(mo),_(Bs.$$.fragment,mo),mo.forEach(t),$e.forEach(t),jc=l(n),un=s(n,"H2",{class:!0});var bp=a(un);Hn=s(bp,"A",{id:!0,class:!0,href:!0});var r5=a(Hn);Jd=s(r5,"SPAN",{});var i5=a(Jd);_(Hs.$$.fragment,i5),i5.forEach(t),r5.forEach(t),Sg=l(bp),Xd=s(bp,"SPAN",{});var d5=a(Xd);Gg=i(d5,"T5EncoderModel"),d5.forEach(t),bp.forEach(t),Fc=l(n),Q=s(n,"DIV",{class:!0});var ze=a(Q);_(Vs.$$.fragment,ze),Ug=l(ze),Qd=s(ze,"P",{});var l5=a(Qd);Wg=i(l5,"The bare T5 Model transformer outputting encoder\u2019s raw hidden-states without any specific head on top."),l5.forEach(t),Rg=l(ze),Ks=s(ze,"P",{});var kp=a(Ks);Bg=i(kp,"The T5 model was proposed in "),Ys=s(kp,"A",{href:!0,rel:!0});var c5=a(Ys);Hg=i(c5,`Exploring the Limits of Transfer Learning with a Unified Text-to-Text
Transformer`),c5.forEach(t),Vg=i(kp,` by Colin Raffel, Noam Shazeer, Adam Roberts, Katherine Lee, Sharan
Narang, Michael Matena, Yanqi Zhou, Wei Li, Peter J. Liu. It\u2019s an encoder decoder transformer pre-trained in a
text-to-text denoising generative setting.`),kp.forEach(t),Kg=l(ze),Zs=s(ze,"P",{});var yp=a(Zs);Yg=i(yp,"This model inherits from "),jr=s(yp,"A",{href:!0});var p5=a(jr);Zg=i(p5,"PreTrainedModel"),p5.forEach(t),Jg=i(yp,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
it will evenly distribute blocks across all devices.`),g5.forEach(t),TT=l(Rt),sl=s(Rt,"P",{});var T5=a(sl);vT=i(T5,"Example:"),T5.forEach(t),bT=l(Rt),_(na.$$.fragment,Rt),Rt.forEach(t),kT=l(ze),kt=s(ze,"DIV",{class:!0});var fo=a(kt);_(oa.$$.fragment,fo),yT=l(fo),al=s(fo,"P",{});var v5=a(al);wT=i(v5,"Moves the model to cpu from a model parallel state."),v5.forEach(t),xT=l(fo),rl=s(fo,"P",{});var b5=a(rl);$T=i(b5,"Example:"),b5.forEach(t),zT=l(fo),_(sa.$$.fragment,fo),fo.forEach(t),ze.forEach(t),Mc=l(n),fn=s(n,"H2",{class:!0});var xp=a(fn);Kn=s(xp,"A",{id:!0,class:!0,href:!0});var k5=a(Kn);il=s(k5,"SPAN",{});var y5=a(il);_(aa.$$.fragment,y5),y5.forEach(t),k5.forEach(t),qT=l(xp),dl=s(xp,"SPAN",{});var w5=a(dl);ET=i(w5,"TFT5Model"),w5.forEach(t),xp.forEach(t),Cc=l(n),de=s(n,"DIV",{class:!0});var at=a(de);_(ra.$$.fragment,at),jT=l(at),ll=s(at,"P",{});var x5=a(ll);FT=i(x5,"The bare T5 Model transformer outputting raw hidden-stateswithout any specific head on top."),x5.forEach(t),MT=l(at),ia=s(at,"P",{});var $p=a(ia);CT=i($p,"The T5 model was proposed in "),da=s($p,"A",{href:!0,rel:!0});var $5=a(da);PT=i($5,`Exploring the Limits of Transfer Learning with a Unified Text-to-Text
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Lp.forEach(t),Vv=l(it),_(to.$$.fragment,it),Kv=l(it),Xe=s(it,"DIV",{class:!0});var Vt=a(Xe);_(Ma.$$.fragment,Vt),Yv=l(Vt),bn=s(Vt,"P",{});var ti=a(bn);Zv=i(ti,"The "),Lr=s(ti,"A",{href:!0});var K5=a(Lr);Jv=i(K5,"TFT5EncoderModel"),K5.forEach(t),Xv=i(ti," forward method, overrides the "),bl=s(ti,"CODE",{});var Y5=a(bl);Qv=i(Y5,"__call__"),Y5.forEach(t),eb=i(ti," special method."),ti.forEach(t),tb=l(Vt),_(no.$$.fragment,Vt),nb=l(Vt),kl=s(Vt,"P",{});var Z5=a(kl);ob=i(Z5,"Examples:"),Z5.forEach(t),sb=l(Vt),_(Ca.$$.fragment,Vt),Vt.forEach(t),it.forEach(t),Ac=l(n),kn=s(n,"H2",{class:!0});var Ap=a(kn);oo=s(Ap,"A",{id:!0,class:!0,href:!0});var J5=a(oo);yl=s(J5,"SPAN",{});var X5=a(yl);_(Pa.$$.fragment,X5),X5.forEach(t),J5.forEach(t),ab=l(Ap),wl=s(Ap,"SPAN",{});var Q5=a(wl);rb=i(Q5,"FlaxT5Model"),Q5.forEach(t),Ap.forEach(t),Ic=l(n),lt=s(n,"DIV",{class:!0});var _o=a(lt);_(Na.$$.fragment,_o),ib=l(_o),Qe=s(_o,"DIV",{class:!0});var Kt=a(Qe);_(Oa.$$.fragment,Kt),db=l(Kt),yn=s(Kt,"P",{});var ni=a(yn);lb=i(ni,"The "),xl=s(ni,"CODE",{});var ew=a(xl);cb=i(ew,"FlaxT5PreTrainedModel"),ew.forEach(t),pb=i(ni," forward method, overrides the "),$l=s(ni,"CODE",{});var tw=a($l);hb=i(tw,"__call__"),tw.forEach(t),ub=i(ni," special method."),ni.forEach(t),mb=l(Kt),_(so.$$.fragment,Kt),fb=l(Kt),zl=s(Kt,"P",{});var nw=a(zl);_b=i(nw,"Example:"),nw.forEach(t),gb=l(Kt),_(La.$$.fragment,Kt),Kt.forEach(t),Tb=l(_o),Mt=s(_o,"DIV",{class:!0});var oi=a(Mt);_(Aa.$$.fragment,oi),vb=l(oi),ql=s(oi,"P",{});var ow=a(ql);bb=i(ow,"Example:"),ow.forEach(t),kb=l(oi),_(Ia.$$.fragment,oi),oi.forEach(t),yb=l(_o),Ct=s(_o,"DIV",{class:!0});var si=a(Ct);_(Da.$$.fragment,si),wb=l(si),El=s(si,"P",{});var sw=a(El);xb=i(sw,"Example:"),sw.forEach(t),$b=l(si),_(Sa.$$.fragment,si),si.forEach(t),_o.forEach(t),Dc=l(n),wn=s(n,"H2",{class:!0});var Ip=a(wn);ao=s(Ip,"A",{id:!0,class:!0,href:!0});var aw=a(ao);jl=s(aw,"SPAN",{});var rw=a(jl);_(Ga.$$.fragment,rw),rw.forEach(t),aw.forEach(t),zb=l(Ip),Fl=s(Ip,"SPAN",{});var iw=a(Fl);qb=i(iw,"FlaxT5ForConditionalGeneration"),iw.forEach(t),Ip.forEach(t),Sc=l(n),ct=s(n,"DIV",{class:!0});var go=a(ct);_(Ua.$$.fragment,go),Eb=l(go),et=s(go,"DIV",{class:!0});var Yt=a(et);_(Wa.$$.fragment,Yt),jb=l(Yt),xn=s(Yt,"P",{});var ai=a(xn);Fb=i(ai,"The "),Ml=s(ai,"CODE",{});var dw=a(Ml);Mb=i(dw,"FlaxT5PreTrainedModel"),dw.forEach(t),Cb=i(ai," forward method, overrides the "),Cl=s(ai,"CODE",{});var lw=a(Cl);Pb=i(lw,"__call__"),lw.forEach(t),Nb=i(ai," special method."),ai.forEach(t),Ob=l(Yt),_(ro.$$.fragment,Yt),Lb=l(Yt),Pl=s(Yt,"P",{});var cw=a(Pl);Ab=i(cw,"Example:"),cw.forEach(t),Ib=l(Yt),_(Ra.$$.fragment,Yt),Yt.forEach(t),Db=l(go),Pt=s(go,"DIV",{class:!0});var ri=a(Pt);_(Ba.$$.fragment,ri),Sb=l(ri),Nl=s(ri,"P",{});var pw=a(Nl);Gb=i(pw,"Example:"),pw.forEach(t),Ub=l(ri),_(Ha.$$.fragment,ri),ri.forEach(t),Wb=l(go),Nt=s(go,"DIV",{class:!0});var ii=a(Nt);_(Va.$$.fragment,ii),Rb=l(ii),Ol=s(ii,"P",{});var hw=a(Ol);Bb=i(hw,"Example:"),hw.forEach(t),Hb=l(ii),_(Ka.$$.fragment,ii),ii.forEach(t),go.forEach(t),this.h()},h(){c(u,"name","hf:doc:metadata"),c(u,"content",JSON.stringify(Fw)),c(w,"id","t5"),c(w,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(w,"href","#t5"),c(k,"class","relative group"),c(ee,"id","overview"),c(ee,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(ee,"href","#overview"),c(E,"class","relative group"),c(ae,"href","https://arxiv.org/pdf/1910.10683.pdf"),c(ae,"rel","nofollow"),c(O,"href","#training"),c(Oe,"href","#inference"),c(Le,"href","#scripts"),c(To,"href","https://huggingface.co/t5-small"),c(To,"rel","nofollow"),c(vo,"href","https://huggingface.co/t5-base"),c(vo,"rel","nofollow"),c(bo,"href","https://huggingface.co/t5-large"),c(bo,"rel","nofollow"),c(ko,"href","https://huggingface.co/t5-3b"),c(ko,"rel","nofollow"),c(yo,"href","https://huggingface.co/t5-11b"),c(yo,"rel","nofollow"),c(tr,"href","t5v1.1"),c(nr,"href","mt5"),c(or,"href","byt5"),c(wo,"href","https://huggingface.co/models?search=t5"),c(wo,"rel","nofollow"),c(xo,"href","https://huggingface.co/thomwolf"),c(xo,"rel","nofollow"),c($o,"href","https://github.com/google-research/text-to-text-transfer-transformer"),c($o,"rel","nofollow"),c(sr,"id","training"),c(jn,"id","training"),c(jn,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(jn,"href","#training"),c(Zt,"class","relative group"),c(ar,"href","/docs/transformers/v4.18.0/en/model_doc/t5#transformers.T5ForConditionalGeneration"),c(rr,"href","/docs/transformers/v4.18.0/en/model_doc/mt5#transformers.T5Tokenizer"),c(jo,"href","https://github.com/huggingface/transformers/tree/main/examples/flax/language-modeling"),c(jo,"rel","nofollow"),c(Mo,"href","https://github.com/huggingface/transformers/tree/main/examples/flax/summarization"),c(Mo,"rel","nofollow"),c(No,"href","https://discuss.huggingface.co/t/t5-finetuning-tips/684"),c(No,"rel","nofollow"),c(Oo,"href","https://arxiv.org/pdf/1910.10683.pdf"),c(Oo,"rel","nofollow"),c(dr,"id","inference"),c(Cn,"id","inference"),c(Cn,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(Cn,"href","#inference"),c(Qt,"class","relative group"),c(lr,"href","/docs/transformers/v4.18.0/en/main_classes/text_generation#transformers.generation_utils.GenerationMixin.generate"),c(Io,"href","https://huggingface.co/blog/how-to-generate"),c(Io,"rel","nofollow"),c(Do,"href","https://huggingface.co/blog/encoder-decoder#encoder-decoder"),c(Do,"rel","nofollow"),c(cr,"href","/docs/transformers/v4.18.0/en/main_classes/text_generation#transformers.generation_utils.GenerationMixin.generate"),c(hr,"id","scripts"),c(Pn,"id","performance"),c(Pn,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(Pn,"href","#performance"),c(en,"class","relative group"),c(Wo,"href","https://github.com/NVIDIA/apex#quick-start"),c(Wo,"rel","nofollow"),c(Nn,"id","example-scripts"),c(Nn,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(Nn,"href","#example-scripts"),c(tn,"class","relative group"),c(Bo,"href","https://github.com/huggingface/transformers/blob/main/examples/flax/language-modeling/run_t5_mlm_flax.py"),c(Bo,"rel","nofollow"),c(Ho,"href","https://github.com/huggingface/transformers/blob/main/examples/flax/language-modeling/t5_tokenizer_model.py"),c(Ho,"rel","nofollow"),c(Vo,"href","https://github.com/huggingface/transformers/tree/main/examples/pytorch/summarization"),c(Vo,"rel","nofollow"),c(Ko,"href","https://github.com/huggingface/transformers/tree/main/examples/tensorflow/summarization"),c(Ko,"rel","nofollow"),c(Yo,"href","https://github.com/huggingface/transformers/tree/main/examples/flax/summarization"),c(Yo,"rel","nofollow"),c(Zo,"href","https://github.com/huggingface/transformers/tree/main/examples/pytorch/translation"),c(Zo,"rel","nofollow"),c(Jo,"href","https://github.com/huggingface/transformers/tree/main/examples/tensorflow/translation"),c(Jo,"rel","nofollow"),c(Ln,"id","transformers.T5Config"),c(Ln,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(Ln,"href","#transformers.T5Config"),c(on,"class","relative group"),c(mr,"href","/docs/transformers/v4.18.0/en/model_doc/t5#transformers.T5Model"),c(fr,"href","/docs/transformers/v4.18.0/en/model_doc/t5#transformers.TFT5Model"),c(es,"href","https://huggingface.co/t5-small"),c(es,"rel","nofollow"),c(_r,"href","/docs/transformers/v4.18.0/en/main_classes/configuration#transformers.PretrainedConfig"),c(gr,"href","/docs/transformers/v4.18.0/en/main_classes/configuration#transformers.PretrainedConfig"),c(wt,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),c(An,"id","transformers.T5Tokenizer"),c(An,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(An,"href","#transformers.T5Tokenizer"),c(an,"class","relative group"),c(ss,"href","https://github.com/google/sentencepiece"),c(ss,"rel","nofollow"),c(Tr,"href","/docs/transformers/v4.18.0/en/main_classes/tokenizer#transformers.PreTrainedTokenizer"),c(jt,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),c(In,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),c(Dn,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),c(kr,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),c(ie,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),c(Sn,"id","transformers.T5TokenizerFast"),c(Sn,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(Sn,"href","#transformers.T5TokenizerFast"),c(rn,"class","relative group"),c(ms,"href","https://huggingface.co/docs/tokenizers/python/latest/components.html?highlight=unigram#models"),c(ms,"rel","nofollow"),c(yr,"href","/docs/transformers/v4.18.0/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast"),c(Ft,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),c(Gn,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),c(De,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),c(Un,"id","transformers.T5Model"),c(Un,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(Un,"href","#transformers.T5Model"),c(ln,"class","relative group"),c(ys,"href","https://arxiv.org/abs/1910.10683"),c(ys,"rel","nofollow"),c($r,"href","/docs/transformers/v4.18.0/en/main_classes/model#transformers.PreTrainedModel"),c($s,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),c($s,"rel","nofollow"),c(zr,"href","/docs/transformers/v4.18.0/en/model_doc/t5#transformers.T5Model"),c(Re,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),c(Be,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),c(vt,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),c(J,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),c(Rn,"id","transformers.T5ForConditionalGeneration"),c(Rn,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(Rn,"href","#transformers.T5ForConditionalGeneration"),c(pn,"class","relative group"),c(Ls,"href","https://arxiv.org/abs/1910.10683"),c(Ls,"rel","nofollow"),c(qr,"href","/docs/transformers/v4.18.0/en/main_classes/model#transformers.PreTrainedModel"),c(Ds,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),c(Ds,"rel","nofollow"),c(Er,"href","/docs/transformers/v4.18.0/en/model_doc/t5#transformers.T5ForConditionalGeneration"),c(He,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),c(Ve,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),c(bt,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),c(X,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),c(Hn,"id","transformers.T5EncoderModel"),c(Hn,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(Hn,"href","#transformers.T5EncoderModel"),c(un,"class","relative group"),c(Ys,"href","https://arxiv.org/abs/1910.10683"),c(Ys,"rel","nofollow"),c(jr,"href","/docs/transformers/v4.18.0/en/main_classes/model#transformers.PreTrainedModel"),c(Xs,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),c(Xs,"rel","nofollow"),c(Fr,"href","/docs/transformers/v4.18.0/en/model_doc/t5#transformers.T5EncoderModel"),c(Ke,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),c(Ye,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),c(kt,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),c(Q,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),c(Kn,"id","transformers.TFT5Model"),c(Kn,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(Kn,"href","#transformers.TFT5Model"),c(fn,"class","relative group"),c(da,"href","https://arxiv.org/abs/1910.10683"),c(da,"rel","nofollow"),c(Mr,"href","/docs/transformers/v4.18.0/en/main_classes/model#transformers.TFPreTrainedModel"),c(pa,"href","https://www.tensorflow.org/api_docs/python/tf/keras/Model"),c(pa,"rel","nofollow"),c(Cr,"href","/docs/transformers/v4.18.0/en/model_doc/t5#transformers.TFT5Model"),c(Ze,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),c(de,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),c(Jn,"id","transformers.TFT5ForConditionalGeneration"),c(Jn,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(Jn,"href","#transformers.TFT5ForConditionalGeneration"),c(gn,"class","relative group"),c(Ta,"href","https://arxiv.org/abs/1910.10683"),c(Ta,"rel","nofollow"),c(Pr,"href","/docs/transformers/v4.18.0/en/main_classes/model#transformers.TFPreTrainedModel"),c(ka,"href","https://www.tensorflow.org/api_docs/python/tf/keras/Model"),c(ka,"rel","nofollow"),c(Nr,"href","/docs/transformers/v4.18.0/en/model_doc/t5#transformers.TFT5ForConditionalGeneration"),c(Je,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),c(le,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),c(eo,"id","transformers.TFT5EncoderModel"),c(eo,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(eo,"href","#transformers.TFT5EncoderModel"),c(vn,"class","relative group"),c(qa,"href","https://arxiv.org/abs/1910.10683"),c(qa,"rel","nofollow"),c(Or,"href","/docs/transformers/v4.18.0/en/main_classes/model#transformers.TFPreTrainedModel"),c(Fa,"href","https://www.tensorflow.org/api_docs/python/tf/keras/Model"),c(Fa,"rel","nofollow"),c(Lr,"href","/docs/transformers/v4.18.0/en/model_doc/t5#transformers.TFT5EncoderModel"),c(Xe,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),c(ce,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),c(oo,"id","transformers.FlaxT5Model"),c(oo,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(oo,"href","#transformers.FlaxT5Model"),c(kn,"class","relative group"),c(Qe,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),c(Mt,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),c(Ct,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),c(lt,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),c(ao,"id","transformers.FlaxT5ForConditionalGeneration"),c(ao,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),c(ao,"href","#transformers.FlaxT5ForConditionalGeneration"),c(wn,"class","relative group"),c(et,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),c(Pt,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),c(Nt,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),c(ct,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8")},m(n,h){e(document.head,u),p(n,z,h),p(n,k,h),e(k,w),e(w,$),g(x,$,null),e(k,y),e(k,q),e(q,qe),p(n,oe,h),p(n,E,h),e(E,ee),e(ee,S),g(se,S,null),e(E,Ee),e(E,G),e(G,je),p(n,be,h),p(n,U,h),e(U,A),e(U,ae),e(ae,pe),e(U,F),p(n,P,h),p(n,he,h),e(he,K),p(n,ke,h),p(n,ue,h),e(ue,W),e(W,Fe),p(n,ye,h),p(n,C,h),e(C,Me),p(n,H,h),p(n,V,h),e(V,me),e(me,N),e(N,Ce),e(N,fe),e(fe,I),e(N,Pe),e(N,R),e(R,Ne),e(N,m),e(V,j),e(V,te),e(te,Se),e(Se,pt),e(V,D),e(V,Ge),e(Ge,ne),e(ne,ht),e(ne,O),e(O,Y),e(ne,ut),e(ne,Oe),e(Oe,Z),e(ne,mt),e(ne,Le),e(Le,Ae),e(ne,ft),p(n,Vl,h),p(n,Xa,h),e(Xa,Dp),p(n,Kl,h),p(n,Ue,h),e(Ue,di),e(di,li),e(li,To),e(To,Sp),e(Ue,Gp),e(Ue,ci),e(ci,pi),e(pi,vo),e(vo,Up),e(Ue,Wp),e(Ue,hi),e(hi,ui),e(ui,bo),e(bo,Rp),e(Ue,Bp),e(Ue,mi),e(mi,fi),e(fi,ko),e(ko,Hp),e(Ue,Vp),e(Ue,_i),e(_i,Qa),e(Qa,yo),e(yo,Kp),e(Qa,Yp),p(n,Yl,h),p(n,er,h),e(er,Zp),p(n,Zl,h),p(n,zt,h),e(zt,gi),e(gi,$n),e($n,Ti),e(Ti,Jp),e($n,Xp),e($n,tr),e(tr,Qp),e($n,eh),e(zt,th),e(zt,vi),e(vi,zn),e(zn,bi),e(bi,nh),e(zn,oh),e(zn,nr),e(nr,sh),e(zn,ah),e(zt,rh),e(zt,ki),e(ki,qn),e(qn,yi),e(yi,ih),e(qn,dh),e(qn,or),e(or,lh),e(qn,ch),p(n,Jl,h),p(n,En,h),e(En,ph),e(En,wo),e(wo,hh),e(En,uh),p(n,Xl,h),p(n,qt,h),e(qt,mh),e(qt,xo),e(xo,fh),e(qt,_h),e(qt,$o),e($o,gh),e(qt,Th),p(n,Ql,h),p(n,sr,h),p(n,ec,h),p(n,Zt,h),e(Zt,jn),e(jn,wi),g(zo,wi,null),e(Zt,vh),e(Zt,xi),e(xi,bh),p(n,tc,h),p(n,_t,h),e(_t,kh),e(_t,$i),e($i,yh),e(_t,wh),e(_t,zi),e(zi,xh),e(_t,$h),e(_t,qi),e(qi,zh),e(_t,qh),p(n,nc,h),p(n,Fn,h),e(Fn,Eh),e(Fn,ar),e(ar,jh),e(Fn,Fh),p(n,oc,h),p(n,Mn,h),e(Mn,dt),e(dt,Ei),e(Ei,Mh),e(dt,Ch),e(dt,_e),e(_e,Ph),e(_e,ji),e(ji,Nh),e(_e,Oh),e(_e,Fi),e(Fi,Lh),e(_e,Ah),e(_e,Mi),e(Mi,Ih),e(_e,Dh),e(_e,Ci),e(Ci,Sh),e(_e,Gh),e(_e,Pi),e(Pi,Uh),e(_e,Wh),e(_e,rr),e(rr,Rh),e(_e,Bh),e(dt,Hh),e(dt,Ni),e(Ni,Vh),e(dt,Kh),g(qo,dt,null),e(dt,Yh),e(dt,Eo),e(Eo,Zh),e(Eo,jo),e(jo,Jh),e(Eo,Xh),e(Mn,Qh),e(Mn,ge),e(ge,Oi),e(Oi,eu),e(ge,tu),e(ge,Li),e(Li,nu),e(ge,ou),g(Fo,ge,null),e(ge,su),e(ge,re),e(re,au),e(re,Ai),e(Ai,ru),e(re,iu),e(re,Ii),e(Ii,du),e(re,lu),e(re,Di),e(Di,cu),e(re,pu),e(re,Si),e(Si,hu),e(re,uu),e(re,Gi),e(Gi,mu),e(re,fu),e(re,Ui),e(Ui,_u),e(re,gu),e(re,Wi),e(Wi,Tu),e(re,vu),e(ge,bu),e(ge,Jt),e(Jt,ku),e(Jt,Ri),e(Ri,yu),e(Jt,wu),e(Jt,Bi),e(Bi,xu),e(Jt,$u),e(ge,zu),e(ge,Te),e(Te,qu),e(Te,Hi),e(Hi,Eu),e(Te,ju),e(Te,Vi),e(Vi,Fu),e(Te,Mu),e(Te,Ki),e(Ki,Cu),e(Te,Pu),e(Te,Yi),e(Yi,Nu),e(Te,Ou),e(Te,Mo),e(Mo,Lu),e(Te,Au),e(Te,Zi),e(Zi,Iu),e(Te,Du),e(ge,Su),g(Co,ge,null),p(n,sc,h),p(n,ir,h),e(ir,Gu),p(n,ac,h),p(n,Et,h),e(Et,Ji),e(Ji,Po),e(Po,Uu),e(Po,Xi),e(Xi,Wu),e(Po,Ru),e(Et,Bu),e(Et,Qi),e(Qi,Xt),e(Xt,Hu),e(Xt,No),e(No,Vu),e(Xt,Ku),e(Xt,Oo),e(Oo,Yu),e(Xt,Zu),e(Et,Ju),e(Et,ed),e(ed,Lo),e(Lo,Xu),e(Lo,td),e(td,Qu),e(Lo,em),p(n,rc,h),p(n,dr,h),p(n,ic,h),p(n,Qt,h),e(Qt,Cn),e(Cn,nd),g(Ao,nd,null),e(Qt,tm),e(Qt,od),e(od,nm),p(n,dc,h),p(n,gt,h),e(gt,om),e(gt,lr),e(lr,sm),e(gt,am),e(gt,Io),e(Io,rm),e(gt,im),e(gt,Do),e(Do,dm),e(gt,lm),p(n,lc,h),g(So,n,h),p(n,cc,h),p(n,We,h),e(We,cm),e(We,sd),e(sd,pm),e(We,hm),e(We,ad),e(ad,um),e(We,mm),e(We,cr),e(cr,fm),e(We,_m),e(We,rd),e(rd,gm),e(We,Tm),p(n,pc,h),p(n,pr,h),e(pr,vm),p(n,hc,h),g(Go,n,h),p(n,uc,h),p(n,hr,h),p(n,mc,h),p(n,en,h),e(en,Pn),e(Pn,id),g(Uo,id,null),e(en,bm),e(en,dd),e(dd,km),p(n,fc,h),p(n,Tt,h),e(Tt,ym),e(Tt,Wo),e(Wo,wm),e(Tt,xm),e(Tt,ld),e(ld,$m),e(Tt,zm),e(Tt,cd),e(cd,qm),e(Tt,Em),p(n,_c,h),p(n,tn,h),e(tn,Nn),e(Nn,pd),g(Ro,pd,null),e(tn,jm),e(tn,hd),e(hd,Fm),p(n,gc,h),p(n,ur,h),e(ur,Mm),p(n,Tc,h),p(n,On,h),e(On,ud),e(ud,nn),e(nn,Cm),e(nn,Bo),e(Bo,Pm),e(nn,Nm),e(nn,Ho),e(Ho,Om),e(nn,Lm),e(On,Am),e(On,md),e(md,Ie),e(Ie,Im),e(Ie,Vo),e(Vo,Dm),e(Ie,Sm),e(Ie,Ko),e(Ko,Gm),e(Ie,Um),e(Ie,Yo),e(Yo,Wm),e(Ie,Rm),e(Ie,Zo),e(Zo,Bm),e(Ie,Hm),e(Ie,Jo),e(Jo,Vm),e(Ie,Km),p(n,vc,h),p(n,on,h),e(on,Ln),e(Ln,fd),g(Xo,fd,null),e(on,Ym),e(on,_d),e(_d,Zm),p(n,bc,h),p(n,wt,h),g(Qo,wt,null),e(wt,Jm),e(wt,xt),e(xt,Xm),e(xt,mr),e(mr,Qm),e(xt,ef),e(xt,fr),e(fr,tf),e(xt,nf),e(xt,es),e(es,of),e(xt,sf),e(wt,af),e(wt,sn),e(sn,rf),e(sn,_r),e(_r,df),e(sn,lf),e(sn,gr),e(gr,cf),e(sn,pf),p(n,kc,h),p(n,an,h),e(an,An),e(An,gd),g(ts,gd,null),e(an,hf),e(an,Td),e(Td,uf),p(n,yc,h),p(n,ie,h),g(ns,ie,null),e(ie,mf),e(ie,os),e(os,ff),e(os,ss),e(ss,_f),e(os,gf),e(ie,Tf),e(ie,as),e(as,vf),e(as,Tr),e(Tr,bf),e(as,kf),e(ie,yf),e(ie,jt),g(rs,jt,null),e(jt,wf),e(jt,vd),e(vd,xf),e(jt,$f),e(jt,is),e(is,vr),e(vr,zf),e(vr,bd),e(bd,qf),e(is,Ef),e(is,br),e(br,jf),e(br,kd),e(kd,Ff),e(ie,Mf),e(ie,In),g(ds,In,null),e(In,Cf),e(In,ls),e(ls,Pf),e(ls,yd),e(yd,Nf),e(ls,Of),e(ie,Lf),e(ie,Dn),g(cs,Dn,null),e(Dn,Af),e(Dn,wd),e(wd,If),e(ie,Df),e(ie,kr),g(ps,kr,null),p(n,wc,h),p(n,rn,h),e(rn,Sn),e(Sn,xd),g(hs,xd,null),e(rn,Sf),e(rn,$d),e($d,Gf),p(n,xc,h),p(n,De,h),g(us,De,null),e(De,Uf),e(De,dn),e(dn,Wf),e(dn,zd),e(zd,Rf),e(dn,Bf),e(dn,ms),e(ms,Hf),e(dn,Vf),e(De,Kf),e(De,fs),e(fs,Yf),e(fs,yr),e(yr,Zf),e(fs,Jf),e(De,Xf),e(De,Ft),g(_s,Ft,null),e(Ft,Qf),e(Ft,qd),e(qd,e_),e(Ft,t_),e(Ft,gs),e(gs,wr),e(wr,n_),e(wr,Ed),e(Ed,o_),e(gs,s_),e(gs,xr),e(xr,a_),e(xr,jd),e(jd,r_),e(De,i_),e(De,Gn),g(Ts,Gn,null),e(Gn,d_),e(Gn,Fd),e(Fd,l_),p(n,$c,h),p(n,ln,h),e(ln,Un),e(Un,Md),g(vs,Md,null),e(ln,c_),e(ln,Cd),e(Cd,p_),p(n,zc,h),p(n,J,h),g(bs,J,null),e(J,h_),e(J,Pd),e(Pd,u_),e(J,m_),e(J,ks),e(ks,f_),e(ks,ys),e(ys,__),e(ks,g_),e(J,T_),e(J,ws),e(ws,v_),e(ws,$r),e($r,b_),e(ws,k_),e(J,y_),e(J,xs),e(xs,w_),e(xs,$s),e($s,x_),e(xs,$_),e(J,z_),e(J,Re),g(zs,Re,null),e(Re,q_),e(Re,cn),e(cn,E_),e(cn,zr),e(zr,j_),e(cn,F_),e(cn,Nd),e(Nd,M_),e(cn,C_),e(Re,P_),g(Wn,Re,null),e(Re,N_),e(Re,Od),e(Od,O_),e(Re,L_),g(qs,Re,null),e(J,A_),e(J,Be),g(Es,Be,null),e(Be,I_),e(Be,Ld),e(Ld,D_),e(Be,S_),e(Be,Ad),e(Ad,G_),e(Be,U_),e(Be,Id),e(Id,W_),e(Be,R_),g(js,Be,null),e(J,B_),e(J,vt),g(Fs,vt,null),e(vt,H_),e(vt,Dd),e(Dd,V_),e(vt,K_),e(vt,Sd),e(Sd,Y_),e(vt,Z_),g(Ms,vt,null),p(n,qc,h),p(n,pn,h),e(pn,Rn),e(Rn,Gd),g(Cs,Gd,null),e(pn,J_),e(pn,Ud),e(Ud,X_),p(n,Ec,h),p(n,X,h),g(Ps,X,null),e(X,Q_),e(X,Ns),e(Ns,eg),e(Ns,Wd),e(Wd,tg),e(Ns,ng),e(X,og),e(X,Os),e(Os,sg),e(Os,Ls),e(Ls,ag),e(Os,rg),e(X,ig),e(X,As),e(As,dg),e(As,qr),e(qr,lg),e(As,cg),e(X,pg),e(X,Is),e(Is,hg),e(Is,Ds),e(Ds,ug),e(Is,mg),e(X,fg),e(X,He),g(Ss,He,null),e(He,_g),e(He,hn),e(hn,gg),e(hn,Er),e(Er,Tg),e(hn,vg),e(hn,Rd),e(Rd,bg),e(hn,kg),e(He,yg),g(Bn,He,null),e(He,wg),e(He,Bd),e(Bd,xg),e(He,$g),g(Gs,He,null),e(X,zg),e(X,Ve),g(Us,Ve,null),e(Ve,qg),e(Ve,Hd),e(Hd,Eg),e(Ve,jg),e(Ve,Vd),e(Vd,Fg),e(Ve,Mg),e(Ve,Kd),e(Kd,Cg),e(Ve,Pg),g(Ws,Ve,null),e(X,Ng),e(X,bt),g(Rs,bt,null),e(bt,Og),e(bt,Yd),e(Yd,Lg),e(bt,Ag),e(bt,Zd),e(Zd,Ig),e(bt,Dg),g(Bs,bt,null),p(n,jc,h),p(n,un,h),e(un,Hn),e(Hn,Jd),g(Hs,Jd,null),e(un,Sg),e(un,Xd),e(Xd,Gg),p(n,Fc,h),p(n,Q,h),g(Vs,Q,null),e(Q,Ug),e(Q,Qd),e(Qd,Wg),e(Q,Rg),e(Q,Ks),e(Ks,Bg),e(Ks,Ys),e(Ys,Hg),e(Ks,Vg),e(Q,Kg),e(Q,Zs),e(Zs,Yg),e(Zs,jr),e(jr,Zg),e(Zs,Jg),e(Q,Xg),e(Q,Js),e(Js,Qg),e(Js,Xs),e(Xs,eT),e(Js,tT),e(Q,nT),e(Q,Ke),g(Qs,Ke,null),e(Ke,oT),e(Ke,mn),e(mn,sT),e(mn,Fr),e(Fr,aT),e(mn,rT),e(mn,el),e(el,iT),e(mn,dT),e(Ke,lT),g(Vn,Ke,null),e(Ke,cT),e(Ke,tl),e(tl,pT),e(Ke,hT),g(ea,Ke,null),e(Q,uT),e(Q,Ye),g(ta,Ye,null),e(Ye,mT),e(Ye,nl),e(nl,fT),e(Ye,_T),e(Ye,ol),e(ol,gT),e(Ye,TT),e(Ye,sl),e(sl,vT),e(Ye,bT),g(na,Ye,null),e(Q,kT),e(Q,kt),g(oa,kt,null),e(kt,yT),e(kt,al),e(al,wT),e(kt,xT),e(kt,rl),e(rl,$T),e(kt,zT),g(sa,kt,null),p(n,Mc,h),p(n,fn,h),e(fn,Kn),e(Kn,il),g(aa,il,null),e(fn,qT),e(fn,dl),e(dl,ET),p(n,Cc,h),p(n,de,h),g(ra,de,null),e(de,jT),e(de,ll),e(ll,FT),e(de,MT),e(de,ia),e(ia,CT),e(ia,da),e(da,PT),e(ia,NT),e(de,OT),e(de,la),e(la,LT),e(la,Mr),e(Mr,AT),e(la,IT),e(de,DT),e(de,ca),e(ca,ST),e(ca,pa),e(pa,GT),e(ca,UT),e(de,WT),g(Yn,de,null),e(de,RT),e(de,Ze),g(ha,Ze,null),e(Ze,BT),e(Ze,_n),e(_n,HT),e(_n,Cr),e(Cr,VT),e(_n,KT),e(_n,cl),e(cl,YT),e(_n,ZT),e(Ze,JT),g(Zn,Ze,null),e(Ze,XT),e(Ze,pl),e(pl,QT),e(Ze,ev),g(ua,Ze,null),p(n,Pc,h),p(n,gn,h),e(gn,Jn),e(Jn,hl),g(ma,hl,null),e(gn,tv),e(gn,ul),e(ul,nv),p(n,Nc,h),p(n,le,h),g(fa,le,null),e(le,ov),e(le,_a),e(_a,sv),e(_a,ml),e(ml,av),e(_a,rv),e(le,iv),e(le,ga),e(ga,dv),e(ga,Ta),e(Ta,lv),e(ga,cv),e(le,pv),e(le,va),e(va,hv),e(va,Pr),e(Pr,uv),e(va,mv),e(le,fv),e(le,ba),e(ba,_v),e(ba,ka),e(ka,gv),e(ba,Tv),e(le,vv),g(Xn,le,null),e(le,bv),e(le,Je),g(ya,Je,null),e(Je,kv),e(Je,Tn),e(Tn,yv),e(Tn,Nr),e(Nr,wv),e(Tn,xv),e(Tn,fl),e(fl,$v),e(Tn,zv),e(Je,qv),g(Qn,Je,null),e(Je,Ev),e(Je,_l),e(_l,jv),e(Je,Fv),g(wa,Je,null),p(n,Oc,h),p(n,vn,h),e(vn,eo),e(eo,gl),g(xa,gl,null),e(vn,Mv),e(vn,Tl),e(Tl,Cv),p(n,Lc,h),p(n,ce,h),g($a,ce,null),e(ce,Pv),e(ce,vl),e(vl,Nv),e(ce,Ov),e(ce,za),e(za,Lv),e(za,qa),e(qa,Av),e(za,Iv),e(ce,Dv),e(ce,Ea),e(Ea,Sv),e(Ea,Or),e(Or,Gv),e(Ea,Uv),e(ce,Wv),e(ce,ja),e(ja,Rv),e(ja,Fa),e(Fa,Bv),e(ja,Hv),e(ce,Vv),g(to,ce,null),e(ce,Kv),e(ce,Xe),g(Ma,Xe,null),e(Xe,Yv),e(Xe,bn),e(bn,Zv),e(bn,Lr),e(Lr,Jv),e(bn,Xv),e(bn,bl),e(bl,Qv),e(bn,eb),e(Xe,tb),g(no,Xe,null),e(Xe,nb),e(Xe,kl),e(kl,ob),e(Xe,sb),g(Ca,Xe,null),p(n,Ac,h),p(n,kn,h),e(kn,oo),e(oo,yl),g(Pa,yl,null),e(kn,ab),e(kn,wl),e(wl,rb),p(n,Ic,h),p(n,lt,h),g(Na,lt,null),e(lt,ib),e(lt,Qe),g(Oa,Qe,null),e(Qe,db),e(Qe,yn),e(yn,lb),e(yn,xl),e(xl,cb),e(yn,pb),e(yn,$l),e($l,hb),e(yn,ub),e(Qe,mb),g(so,Qe,null),e(Qe,fb),e(Qe,zl),e(zl,_b),e(Qe,gb),g(La,Qe,null),e(lt,Tb),e(lt,Mt),g(Aa,Mt,null),e(Mt,vb),e(Mt,ql),e(ql,bb),e(Mt,kb),g(Ia,Mt,null),e(lt,yb),e(lt,Ct),g(Da,Ct,null),e(Ct,wb),e(Ct,El),e(El,xb),e(Ct,$b),g(Sa,Ct,null),p(n,Dc,h),p(n,wn,h),e(wn,ao),e(ao,jl),g(Ga,jl,null),e(wn,zb),e(wn,Fl),e(Fl,qb),p(n,Sc,h),p(n,ct,h),g(Ua,ct,null),e(ct,Eb),e(ct,et),g(Wa,et,null),e(et,jb),e(et,xn),e(xn,Fb),e(xn,Ml),e(Ml,Mb),e(xn,Cb),e(xn,Cl),e(Cl,Pb),e(xn,Nb),e(et,Ob),g(ro,et,null),e(et,Lb),e(et,Pl),e(Pl,Ab),e(et,Ib),g(Ra,et,null),e(ct,Db),e(ct,Pt),g(Ba,Pt,null),e(Pt,Sb),e(Pt,Nl),e(Nl,Gb),e(Pt,Ub),g(Ha,Pt,null),e(ct,Wb),e(ct,Nt),g(Va,Nt,null),e(Nt,Rb),e(Nt,Ol),e(Ol,Bb),e(Nt,Hb),g(Ka,Nt,null),Gc=!0},p(n,[h]){const Ya={};h&2&&(Ya.$$scope={dirty:h,ctx:n}),Wn.$set(Ya);const Ll={};h&2&&(Ll.$$scope={dirty:h,ctx:n}),Bn.$set(Ll);const Al={};h&2&&(Al.$$scope={dirty:h,ctx:n}),Vn.$set(Al);const Il={};h&2&&(Il.$$scope={dirty:h,ctx:n}),Yn.$set(Il);const Za={};h&2&&(Za.$$scope={dirty:h,ctx:n}),Zn.$set(Za);const Dl={};h&2&&(Dl.$$scope={dirty:h,ctx:n}),Xn.$set(Dl);const Sl={};h&2&&(Sl.$$scope={dirty:h,ctx:n}),Qn.$set(Sl);const Gl={};h&2&&(Gl.$$scope={dirty:h,ctx:n}),to.$set(Gl);const Ja={};h&2&&(Ja.$$scope={dirty:h,ctx:n}),no.$set(Ja);const Ul={};h&2&&(Ul.$$scope={dirty:h,ctx:n}),so.$set(Ul);const Wl={};h&2&&(Wl.$$scope={dirty:h,ctx:n}),ro.$set(Wl)},i(n){Gc||(T(x.$$.fragment,n),T(se.$$.fragment,n),T(zo.$$.fragment,n),T(qo.$$.fragment,n),T(Fo.$$.fragment,n),T(Co.$$.fragment,n),T(Ao.$$.fragment,n),T(So.$$.fragment,n),T(Go.$$.fragment,n),T(Uo.$$.fragment,n),T(Ro.$$.fragment,n),T(Xo.$$.fragment,n),T(Qo.$$.fragment,n),T(ts.$$.fragment,n),T(ns.$$.fragment,n),T(rs.$$.fragment,n),T(ds.$$.fragment,n),T(cs.$$.fragment,n),T(ps.$$.fragment,n),T(hs.$$.fragment,n),T(us.$$.fragment,n),T(_s.$$.fragment,n),T(Ts.$$.fragment,n),T(vs.$$.fragment,n),T(bs.$$.fragment,n),T(zs.$$.fragment,n),T(Wn.$$.fragment,n),T(qs.$$.fragment,n),T(Es.$$.fragment,n),T(js.$$.fragment,n),T(Fs.$$.fragment,n),T(Ms.$$.fragment,n),T(Cs.$$.fragment,n),T(Ps.$$.fragment,n),T(Ss.$$.fragment,n),T(Bn.$$.fragment,n),T(Gs.$$.fragment,n),T(Us.$$.fragment,n),T(Ws.$$.fragment,n),T(Rs.$$.fragment,n),T(Bs.$$.fragment,n),T(Hs.$$.fragment,n),T(Vs.$$.fragment,n),T(Qs.$$.fragment,n),T(Vn.$$.fragment,n),T(ea.$$.fragment,n),T(ta.$$.fragment,n),T(na.$$.fragment,n),T(oa.$$.fragment,n),T(sa.$$.fragment,n),T(aa.$$.fragment,n),T(ra.$$.fragment,n),T(Yn.$$.fragment,n),T(ha.$$.fragment,n),T(Zn.$$.fragment,n),T(ua.$$.fragment,n),T(ma.$$.fragment,n),T(fa.$$.fragment,n),T(Xn.$$.fragment,n),T(ya.$$.fragment,n),T(Qn.$$.fragment,n),T(wa.$$.fragment,n),T(xa.$$.fragment,n),T($a.$$.fragment,n),T(to.$$.fragment,n),T(Ma.$$.fragment,n),T(no.$$.fragment,n),T(Ca.$$.fragment,n),T(Pa.$$.fragment,n),T(Na.$$.fragment,n),T(Oa.$$.fragment,n),T(so.$$.fragment,n),T(La.$$.fragment,n),T(Aa.$$.fragment,n),T(Ia.$$.fragment,n),T(Da.$$.fragment,n),T(Sa.$$.fragment,n),T(Ga.$$.fragment,n),T(Ua.$$.fragment,n),T(Wa.$$.fragment,n),T(ro.$$.fragment,n),T(Ra.$$.fragment,n),T(Ba.$$.fragment,n),T(Ha.$$.fragment,n),T(Va.$$.fragment,n),T(Ka.$$.fragment,n),Gc=!0)},o(n){v(x.$$.fragment,n),v(se.$$.fragment,n),v(zo.$$.fragment,n),v(qo.$$.fragment,n),v(Fo.$$.fragment,n),v(Co.$$.fragment,n),v(Ao.$$.fragment,n),v(So.$$.fragment,n),v(Go.$$.fragment,n),v(Uo.$$.fragment,n),v(Ro.$$.fragment,n),v(Xo.$$.fragment,n),v(Qo.$$.fragment,n),v(ts.$$.fragment,n),v(ns.$$.fragment,n),v(rs.$$.fragment,n),v(ds.$$.fragment,n),v(cs.$$.fragment,n),v(ps.$$.fragment,n),v(hs.$$.fragment,n),v(us.$$.fragment,n),v(_s.$$.fragment,n),v(Ts.$$.fragment,n),v(vs.$$.fragment,n),v(bs.$$.fragment,n),v(zs.$$.fragment,n),v(Wn.$$.fragment,n),v(qs.$$.fragment,n),v(Es.$$.fragment,n),v(js.$$.fragment,n),v(Fs.$$.fragment,n),v(Ms.$$.fragment,n),v(Cs.$$.fragment,n),v(Ps.$$.fragment,n),v(Ss.$$.fragment,n),v(Bn.$$.fragment,n),v(Gs.$$.fragment,n),v(Us.$$.fragment,n),v(Ws.$$.fragment,n),v(Rs.$$.fragment,n),v(Bs.$$.fragment,n),v(Hs.$$.fragment,n),v(Vs.$$.fragment,n),v(Qs.$$.fragment,n),v(Vn.$$.fragment,n),v(ea.$$.fragment,n),v(ta.$$.fragment,n),v(na.$$.fragment,n),v(oa.$$.fragment,n),v(sa.$$.fragment,n),v(aa.$$.fragment,n),v(ra.$$.fragment,n),v(Yn.$$.fragment,n),v(ha.$$.fragment,n),v(Zn.$$.fragment,n),v(ua.$$.fragment,n),v(ma.$$.fragment,n),v(fa.$$.fragment,n),v(Xn.$$.fragment,n),v(ya.$$.fragment,n),v(Qn.$$.fragment,n),v(wa.$$.fragment,n),v(xa.$$.fragment,n),v($a.$$.fragment,n),v(to.$$.fragment,n),v(Ma.$$.fragment,n),v(no.$$.fragment,n),v(Ca.$$.fragment,n),v(Pa.$$.fragment,n),v(Na.$$.fragment,n),v(Oa.$$.fragment,n),v(so.$$.fragment,n),v(La.$$.fragment,n),v(Aa.$$.fragment,n),v(Ia.$$.fragment,n),v(Da.$$.fragment,n),v(Sa.$$.fragment,n),v(Ga.$$.fragment,n),v(Ua.$$.fragment,n),v(Wa.$$.fragment,n),v(ro.$$.fragment,n),v(Ra.$$.fragment,n),v(Ba.$$.fragment,n),v(Ha.$$.fragment,n),v(Va.$$.fragment,n),v(Ka.$$.fragment,n),Gc=!1},d(n){t(u),n&&t(z),n&&t(k),b(x),n&&t(oe),n&&t(E),b(se),n&&t(be),n&&t(U),n&&t(P),n&&t(he),n&&t(ke),n&&t(ue),n&&t(ye),n&&t(C),n&&t(H),n&&t(V),n&&t(Vl),n&&t(Xa),n&&t(Kl),n&&t(Ue),n&&t(Yl),n&&t(er),n&&t(Zl),n&&t(zt),n&&t(Jl),n&&t(En),n&&t(Xl),n&&t(qt),n&&t(Ql),n&&t(sr),n&&t(ec),n&&t(Zt),b(zo),n&&t(tc),n&&t(_t),n&&t(nc),n&&t(Fn),n&&t(oc),n&&t(Mn),b(qo),b(Fo),b(Co),n&&t(sc),n&&t(ir),n&&t(ac),n&&t(Et),n&&t(rc),n&&t(dr),n&&t(ic),n&&t(Qt),b(Ao),n&&t(dc),n&&t(gt),n&&t(lc),b(So,n),n&&t(cc),n&&t(We),n&&t(pc),n&&t(pr),n&&t(hc),b(Go,n),n&&t(uc),n&&t(hr),n&&t(mc),n&&t(en),b(Uo),n&&t(fc),n&&t(Tt),n&&t(_c),n&&t(tn),b(Ro),n&&t(gc),n&&t(ur),n&&t(Tc),n&&t(On),n&&t(vc),n&&t(on),b(Xo),n&&t(bc),n&&t(wt),b(Qo),n&&t(kc),n&&t(an),b(ts),n&&t(yc),n&&t(ie),b(ns),b(rs),b(ds),b(cs),b(ps),n&&t(wc),n&&t(rn),b(hs),n&&t(xc),n&&t(De),b(us),b(_s),b(Ts),n&&t($c),n&&t(ln),b(vs),n&&t(zc),n&&t(J),b(bs),b(zs),b(Wn),b(qs),b(Es),b(js),b(Fs),b(Ms),n&&t(qc),n&&t(pn),b(Cs),n&&t(Ec),n&&t(X),b(Ps),b(Ss),b(Bn),b(Gs),b(Us),b(Ws),b(Rs),b(Bs),n&&t(jc),n&&t(un),b(Hs),n&&t(Fc),n&&t(Q),b(Vs),b(Qs),b(Vn),b(ea),b(ta),b(na),b(oa),b(sa),n&&t(Mc),n&&t(fn),b(aa),n&&t(Cc),n&&t(de),b(ra),b(Yn),b(ha),b(Zn),b(ua),n&&t(Pc),n&&t(gn),b(ma),n&&t(Nc),n&&t(le),b(fa),b(Xn),b(ya),b(Qn),b(wa),n&&t(Oc),n&&t(vn),b(xa),n&&t(Lc),n&&t(ce),b($a),b(to),b(Ma),b(no),b(Ca),n&&t(Ac),n&&t(kn),b(Pa),n&&t(Ic),n&&t(lt),b(Na),b(Oa),b(so),b(La),b(Aa),b(Ia),b(Da),b(Sa),n&&t(Dc),n&&t(wn),b(Ga),n&&t(Sc),n&&t(ct),b(Ua),b(Wa),b(ro),b(Ra),b(Ba),b(Ha),b(Va),b(Ka)}}}const Fw={local:"t5",sections:[{local:"overview",title:"Overview"},{local:"training",title:"Training"},{local:"inference",title:"Inference"},{local:"performance",title:"Performance"},{local:"example-scripts",title:"Example scripts"},{local:"transformers.T5Config",title:"T5Config"},{local:"transformers.T5Tokenizer",title:"T5Tokenizer"},{local:"transformers.T5TokenizerFast",title:"T5TokenizerFast"},{local:"transformers.T5Model",title:"T5Model"},{local:"transformers.T5ForConditionalGeneration",title:"T5ForConditionalGeneration"},{local:"transformers.T5EncoderModel",title:"T5EncoderModel"},{local:"transformers.TFT5Model",title:"TFT5Model"},{local:"transformers.TFT5ForConditionalGeneration",title:"TFT5ForConditionalGeneration"},{local:"transformers.TFT5EncoderModel",title:"TFT5EncoderModel"},{local:"transformers.FlaxT5Model",title:"FlaxT5Model"},{local:"transformers.FlaxT5ForConditionalGeneration",title:"FlaxT5ForConditionalGeneration"}],title:"T5"};function Mw(L){return gw(()=>{new URLSearchParams(window.location.search).get("fw")}),[]}class Aw extends uw{constructor(u){super();mw(this,u,Mw,jw,fw,{})}}export{Aw as default,Fw as metadata};
