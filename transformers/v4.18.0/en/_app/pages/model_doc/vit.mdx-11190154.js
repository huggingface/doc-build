...
tensors in the first argument of the model call function: `),C=a("code"),he=n("model(inputs)"),G=n(".")},l(E){d=s(E,"P",{});var M=r(d);T=i(M,"TF 2.0 models accepts two formats as inputs:"),M.forEach(t),u=h(E),m=s(E,"UL",{});var z=r(m);v=s(z,"LI",{});var $e=r(v);l=i($e,"having all inputs as keyword arguments (like PyTorch models), or"),$e.forEach(t),f=h(z),V=s(z,"LI",{});var X=r(V);pe=i(X,"having all inputs as a list, tuple or dict in the first positional arguments."),X.forEach(t),z.forEach(t),R=h(E),I=s(E,"P",{});var L=r(I);ee=i(L,"This second option is useful when using "),j=s(L,"CODE",{});var ye=r(j);U=i(ye,"tf.keras.Model.fit"),ye.forEach(t),K=i(L,` method which currently requires having all the
...
<span class="hljs-meta">&gt;&gt;&gt; </span><span class="hljs-built_in">print</span>(<span class="hljs-string">&quot;Predicted class:&quot;</span>, model.config.id2label[predicted_class_idx.item()])`}}),{c(){d=a("p"),T=n("Example:"),u=p(),b(m.$$.fragment)},l(l){d=s(l,"P",{});var f=r(d);T=i(f,"Example:"),f.forEach(t),u=h(l),w(m.$$.fragment,l)},m(l,f){_(l,d,f),e(d,T),_(l,u,f),$(m,l,f),v=!0},p:At,i(l){v||(y(m.$$.fragment,l),v=!0)},o(l){x(m.$$.fragment,l),v=!1},d(l){l&&t(d),l&&t(u),F(m,l)}}}function im(k){let d,T,u,m,v,l,f,V,pe,R,I,ee,j,U,K,C,he,G,E,M,z,$e,X,L,ye,Te,ea,Yr,rr,ta,Ba,en,nr,oa,tn,ir,N,zt,on,Nt,an,sn,rn,Ua,nn,ln,Lt,dn,aa,cn,pn,hn,xe,mn,Ra,fn,un,Dt,gn,_n,vn,Fe,Tn,Ot,bn,wn,St,$n,yn,xn,Ve,Fn,Wt,Vn,kn,Bt,En,In,Mn,Ha,jn,lr,sa,Pn,dr,te,Ja,P,ra,Cn,An,na,qn,zn,ia,Nn,Ln,Ka,Dn,On,Ga,Sn,Wn,Xa,Bn,Un,Za,Rn,Hn,la,Jn,Kn,Gn,Qa,da,ca,Xn,Zn,Qn,Ya,Ut,Yn,Rt,ei,ti,oi,es,pa,ha,ai,si,cr,be,ri,Ht,ni,ii,Jt,li,di,pr,He,ci,Kt,pi,hi,hr,ke,Je,ts,Gt,mi,os,fi,mr,Z,Xt,ui,Ee,gi,ma,_i,vi,Zt,Ti,bi,wi,Ie,$i,fa,yi,xi,ua,Fi,Vi,ki,Ke,fr,Me,Ge,as,Qt,Ei,ss,Ii,ur,Q,Yt,Mi,rs,ji,Pi,eo,Ci,ga,Ai,qi,zi,we,to,Ni,ns,Li,Di,Xe,gr,je,Ze,is,oo,Oi,ls,Si,_r,me,ao,Wi,so,Bi,ro,Ui,Ri,Hi,oe,no,Ji,Pe,Ki,_a,Gi,Xi,ds,Zi,Qi,Yi,Qe,el,Ye,vr,Ce,et,cs,io,tl,ps,ol,Tr,fe,lo,al,Ae,sl,hs,rl,nl,co,il,ll,dl,ae,po,cl,qe,pl,va,hl,ml,ms,fl,ul,gl,tt,_l,ot,br,ze,at,fs,ho,vl,us,Tl,wr,Y,mo,bl,gs,wl,$l,fo,yl,uo,xl,Fl,Vl,se,go,kl,Ne,El,Ta,Il,Ml,_s,jl,Pl,Cl,st,Al,rt,$r,Le,nt,vs,_o,ql,Ts,zl,yr,D,vo,Nl,bs,Ll,Dl,To,Ol,ba,Sl,Wl,Bl,bo,Ul,wo,Rl,Hl,Jl,it,Kl,re,$o,Gl,De,Xl,wa,Zl,Ql,ws,Yl,ed,td,lt,od,dt,xr,Oe,ct,$s,yo,ad,ys,sd,Fr,O,xo,rd,xs,nd,id,Fo,ld,$a,dd,cd,pd,Vo,hd,ko,md,fd,ud,pt,gd,ne,Eo,_d,Se,vd,ya,Td,bd,Fs,wd,$d,yd,ht,xd,mt,Vr,We,ft,Vs,Io,Fd,ks,Vd,kr,A,Mo,kd,Es,Ed,Id,jo,Md,xa,jd,Pd,Cd,Po,Ad,Co,qd,zd,Nd,Is,Ld,Dd,ue,Ms,Ao,Od,Sd,js,qo,Wd,Bd,Ps,zo,Ud,Rd,Cs,No,Hd,Jd,ie,Lo,Kd,Be,Gd,As,Xd,Zd,qs,Qd,Yd,ec,ut,tc,gt,Er,Ue,_t,zs,Do,oc,Ns,ac,Ir,q,Oo,sc,Ls,rc,nc,So,ic,Fa,lc,dc,cc,Wo,pc,Bo,hc,mc,fc,Ds,uc,gc,ge,Os,Uo,_c,vc,Ss,Ro,Tc,bc,Ws,Ho,wc,$c,Bs,Jo,yc,xc,le,Ko,Fc,Re,Vc,Us,kc,Ec,Rs,Ic,Mc,jc,vt,Pc,Tt,Mr;return l=new ve({}),I=new _e({props:{$$slots:{default:[Wh]},$$scope:{ctx:k}}}),C=new ve({}),Gt=new ve({}),Xt=new B({props:{name:"class transformers.ViTConfig",anchor:"transformers.ViTConfig",parameters:[{name:"hidden_size",val:" = 768"},{name:"num_hidden_layers",val:" = 12"},{name:"num_attention_heads",val:" = 12"},{name:"intermediate_size",val:" = 3072"},{name:"hidden_act",val:" = 'gelu'"},{name:"hidden_dropout_prob",val:" = 0.0"},{name:"attention_probs_dropout_prob",val:" = 0.0"},{name:"initializer_range",val:" = 0.02"},{name:"layer_norm_eps",val:" = 1e-12"},{name:"is_encoder_decoder",val:" = False"},{name:"image_size",val:" = 224"},{name:"patch_size",val:" = 16"},{name:"num_channels",val:" = 3"},{name:"qkv_bias",val:" = True"},{name:"encoder_stride",val:" = 16"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.ViTConfig.hidden_size",description:`<strong>hidden_size</strong> (<code>int</code>, <em>optional</em>, defaults to 768) &#x2014;
...
<a href="/docs/transformers/v4.18.0/en/main_classes/model#transformers.FlaxPreTrainedModel.to_bf16">to_bf16()</a>.`,name:"dtype"}],source:"https://github.com/huggingface/transformers/blob/v4.18.0/src/transformers/models/vit/modeling_flax_vit.py#L510"}}),Lo=new B({props:{name:"__call__",anchor:"transformers.FlaxViTModel.__call__",parameters:[{name:"pixel_values",val:""},{name:"params",val:": dict = None"},{name:"dropout_rng",val:": PRNGKey = None"},{name:"train",val:": bool = False"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],source:"https://github.com/huggingface/transformers/blob/v4.18.0/src/transformers/models/vit/modeling_flax_vit.py#L425",returnDescription:`
<p>A <a
...
`}}),ut=new _e({props:{$$slots:{default:[am]},$$scope:{ctx:k}}}),gt=new Ct({props:{anchor:"transformers.FlaxViTModel.__call__.example",$$slots:{default:[sm]},$$scope:{ctx:k}}}),Do=new ve({}),Oo=new B({props:{name:"class transformers.FlaxViTForImageClassification",anchor:"transformers.FlaxViTForImageClassification",parameters:[{name:"config",val:": ViTConfig"},{name:"input_shape",val:" = None"},{name:"seed",val:": int = 0"},{name:"dtype",val:": dtype = <class 'jax._src.numpy.lax_numpy.float32'>"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.FlaxViTForImageClassification.config",description:`<strong>config</strong> (<a href="/docs/transformers/v4.18.0/en/model_doc/vit#transformers.ViTConfig">ViTConfig</a>) &#x2014; Model configuration class with all the parameters of the model.
Initializing with a config file does not load the weights associated with the model, only the
...
parameters.</strong></p>
<p>If you wish to change the dtype of the model parameters, see <a href="/docs/transformers/v4.18.0/en/main_classes/model#transformers.FlaxPreTrainedModel.to_fp16">to_fp16()</a> and
<a href="/docs/transformers/v4.18.0/en/main_classes/model#transformers.FlaxPreTrainedModel.to_bf16">to_bf16()</a>.`,name:"dtype"}],source:"https://github.com/huggingface/transformers/blob/v4.18.0/src/transformers/models/vit/modeling_flax_vit.py#L591"}}),Ko=new B({props:{name:"__call__",anchor:"transformers.FlaxViTForImageClassification.__call__",parameters:[{name:"pixel_values",val:""},{name:"params",val:": dict = None"},{name:"dropout_rng",val:": PRNGKey = None"},{name:"train",val:": bool = False"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],source:"https://github.com/huggingface/transformers/blob/v4.18.0/src/transformers/models/vit/modeling_flax_vit.py#L425",returnDescription:`
<p>A <a
...
improvement of 2% to training from scratch, but still 4% behind supervised pre-training.`),lr=p(),sa=a("p"),Pn=n("Following the original Vision Transformer, some follow-up works have been made:"),dr=p(),te=a("ul"),Ja=a("li"),P=a("p"),ra=a("a"),Cn=n("DeiT"),An=n(` (Data-efficient Image Transformers) by Facebook AI. DeiT models are distilled vision transformers.
...
documentation from `),ua=a("a"),Fi=n("PretrainedConfig"),Vi=n(" for more information."),ki=p(),b(Ke.$$.fragment),fr=p(),Me=a("h2"),Ge=a("a"),as=a("span"),b(Qt.$$.fragment),Ei=p(),ss=a("span"),Ii=n("ViTFeatureExtractor"),ur=p(),Q=a("div"),b(Yt.$$.fragment),Mi=p(),rs=a("p"),ji=n("Constructs a ViT feature extractor."),Pi=p(),eo=a("p"),Ci=n("This feature extractor inherits from "),ga=a("a"),Ai=n("FeatureExtractionMixin"),qi=n(` which contains most of the main methods. Users
...
behavior.`),Hi=p(),oe=a("div"),b(no.$$.fragment),Ji=p(),Pe=a("p"),Ki=n("The "),_a=a("a"),Gi=n("ViTModel"),Xi=n(" forward method, overrides the "),ds=a("code"),Zi=n("__call__"),Qi=n(" special method."),Yi=p(),b(Qe.$$.fragment),el=p(),b(Ye.$$.fragment),vr=p(),Ce=a("h2"),et=a("a"),cs=a("span"),b(io.$$.fragment),tl=p(),ps=a("span"),ol=n("ViTForMaskedImageModeling"),Tr=p(),fe=a("div"),b(lo.$$.fragment),al=p(),Ae=a("p"),sl=n("ViT Model with a decoder on top for masked image modeling, as proposed in "),hs=a("code"),rl=n("SimMIM <https://arxiv.org/abs/2111.09886>"),nl=n(`__.
...
as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),Vl=p(),se=a("div"),b(go.$$.fragment),kl=p(),Ne=a("p"),El=n("The "),Ta=a("a"),Il=n("ViTForImageClassification"),Ml=n(" forward method, overrides the "),_s=a("code"),jl=n("__call__"),Pl=n(" special method."),Cl=p(),b(st.$$.fragment),Al=p(),b(rt.$$.fragment),$r=p(),Le=a("h2"),nt=a("a"),vs=a("span"),b(_o.$$.fragment),ql=p(),Ts=a("span"),zl=n("TFViTModel"),yr=p(),D=a("div"),b(vo.$$.fragment),Nl=p(),bs=a("p"),Ll=n("The bare ViT Model transformer outputting raw hidden-states without any specific head on top."),Dl=p(),To=a("p"),Ol=n("This model inherits from "),ba=a("a"),Sl=n("TFPreTrainedModel"),Wl=n(`. Check the superclass documentation for the generic methods the
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),ud=p(),b(pt.$$.fragment),gd=p(),ne=a("div"),b(Eo.$$.fragment),_d=p(),Se=a("p"),vd=n("The "),ya=a("a"),Td=n("TFViTForImageClassification"),bd=n(" forward method, overrides the "),Fs=a("code"),wd=n("__call__"),$d=n(" special method."),yd=p(),b(ht.$$.fragment),xd=p(),b(mt.$$.fragment),Vr=p(),We=a("h2"),ft=a("a"),Vs=a("span"),b(Io.$$.fragment),Fd=p(),ks=a("span"),Vd=n("FlaxVitModel"),kr=p(),A=a("div"),b(Mo.$$.fragment),kd=p(),Es=a("p"),Ed=n("The bare ViT Model transformer outputting raw hidden-states without any specific head on top."),Id=p(),jo=a("p"),Md=n("This model inherits from "),xa=a("a"),jd=n("FlaxPreTrainedModel"),Pd=n(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),Cd=p(),Po=a("p"),Ad=n("This model is also a Flax Linen "),Co=a("a"),qd=n("flax.linen.Module"),zd=n(`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),Nd=p(),Is=a("p"),Ld=n("Finally, this model supports inherent JAX features such as:"),Dd=p(),ue=a("ul"),Ms=a("li"),Ao=a("a"),Od=n("Just-In-Time (JIT) compilation"),Sd=p(),js=a("li"),qo=a("a"),Wd=n("Automatic Differentiation"),Bd=p(),Ps=a("li"),zo=a("a"),Ud=n("Vectorization"),Rd=p(),Cs=a("li"),No=a("a"),Hd=n("Parallelization"),Jd=p(),ie=a("div"),b(Lo.$$.fragment),Kd=p(),Be=a("p"),Gd=n("The "),As=a("code"),Xd=n("FlaxViTPreTrainedModel"),Zd=n(" forward method, overrides the "),qs=a("code"),Qd=n("__call__"),Yd=n(" special method."),ec=p(),b(ut.$$.fragment),tc=p(),b(gt.$$.fragment),Er=p(),Ue=a("h2"),_t=a("a"),zs=a("span"),b(Do.$$.fragment),oc=p(),Ns=a("span"),ac=n("FlaxViTForImageClassification"),Ir=p(),q=a("div"),b(Oo.$$.fragment),sc=p(),Ls=a("p"),rc=n(`ViT Model transformer with an image classification head on top (a linear layer on top of the final hidden state of
...
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),fc=p(),Ds=a("p"),uc=n("Finally, this model supports inherent JAX features such as:"),gc=p(),ge=a("ul"),Os=a("li"),Uo=a("a"),_c=n("Just-In-Time (JIT) compilation"),vc=p(),Ss=a("li"),Ro=a("a"),Tc=n("Automatic Differentiation"),bc=p(),Ws=a("li"),Ho=a("a"),wc=n("Vectorization"),$c=p(),Bs=a("li"),Jo=a("a"),yc=n("Parallelization"),xc=p(),le=a("div"),b(Ko.$$.fragment),Fc=p(),Re=a("p"),Vc=n("The "),Us=a("code"),kc=n("FlaxViTPreTrainedModel"),Ec=n(" forward method, overrides the "),Rs=a("code"),Ic=n("__call__"),Mc=n(" special method."),jc=p(),b(vt.$$.fragment),Pc=p(),b(Tt.$$.fragment),this.h()},l(o){const g=Oh('[data-svelte="svelte-1phssyn"]',document.head);d=s(g,"META",{name:!0,content:!0}),g.forEach(t),T=h(o),u=s(o,"H1",{class:!0});var Go=r(u);m=s(Go,"A",{id:!0,class:!0,href:!0});var Hs=r(m);v=s(Hs,"SPAN",{});var Js=r(v);w(l.$$.fragment,Js),Js.forEach(t),Hs.forEach(t),f=h(Go),V=s(Go,"SPAN",{});var Ks=r(V);pe=i(Ks,"Vision Transformer (ViT)"),Ks.forEach(t),Go.forEach(t),R=h(o),w(I.$$.fragment,o),ee=h(o),j=s(o,"H2",{class:!0});var Xo=r(j);U=s(Xo,"A",{id:!0,class:!0,href:!0});var Gs=r(U);K=s(Gs,"SPAN",{});var Xs=r(K);w(C.$$.fragment,Xs),Xs.forEach(t),Gs.forEach(t),he=h(Xo),G=s(Xo,"SPAN",{});var Zs=r(G);E=i(Zs,"Overview"),Zs.forEach(t),Xo.forEach(t),M=h(o),z=s(o,"P",{});var Zo=r(z);$e=i(Zo,"The Vision Transformer (ViT) model was proposed in "),X=s(Zo,"A",{href:!0,rel:!0});var Qs=r(X);L=i(Qs,`An Image is Worth 16x16 Words: Transformers for Image Recognition
...
2D interpolation of the pre-trained position embeddings, according to their location in the original image.`),Ea.forEach(t),Mn=h(S),Ha=s(S,"LI",{});var Wc=r(Ha);jn=i(Wc,`The best results are obtained with supervised pre-training, which is not the case in NLP. The authors also performed
an experiment with a self-supervised pre-training objective, namely masked patched prediction (inspired by masked
language modeling). With this approach, the smaller ViT-B/16 model achieves 79.9% accuracy on ImageNet, a significant
improvement of 2% to training from scratch, but still 4% behind supervised pre-training.`),Wc.forEach(t),S.forEach(t),lr=h(o),sa=s(o,"P",{});var Bc=r(sa);Pn=i(Bc,"Following the original Vision Transformer, some follow-up works have been made:"),Bc.forEach(t),dr=h(o),te=s(o,"UL",{});var bt=r(te);Ja=s(bt,"LI",{});var Uc=r(Ja);P=s(Uc,"P",{});var W=r(P);ra=s(W,"A",{href:!0});var Rc=r(ra);Cn=i(Rc,"DeiT"),Rc.forEach(t),An=i(W,` (Data-efficient Image Transformers) by Facebook AI. DeiT models are distilled vision transformers.
...
found `),Jt=s(Ia,"A",{href:!0,rel:!0});var np=r(Jt);li=i(np,"here"),np.forEach(t),di=i(Ia,"."),Ia.forEach(t),pr=h(o),He=s(o,"P",{});var Pr=r(He);ci=i(Pr,"Note that we converted the weights from Ross Wightman\u2019s "),Kt=s(Pr,"A",{href:!0,rel:!0});var ip=r(Kt);pi=i(ip,"timm library"),ip.forEach(t),hi=i(Pr,`, who already converted the weights from JAX to PyTorch. Credits
go to him!`),Pr.forEach(t),hr=h(o),ke=s(o,"H2",{class:!0});var Cr=r(ke);Je=s(Cr,"A",{id:!0,class:!0,href:!0});var lp=r(Je);ts=s(lp,"SPAN",{});var dp=r(ts);w(Gt.$$.fragment,dp),dp.forEach(t),lp.forEach(t),mi=h(Cr),os=s(Cr,"SPAN",{});var cp=r(os);fi=i(cp,"ViTConfig"),cp.forEach(t),Cr.forEach(t),mr=h(o),Z=s(o,"DIV",{class:!0});var wt=r(Z);w(Xt.$$.fragment,wt),ui=h(wt),Ee=s(wt,"P",{});var Ma=r(Ee);gi=i(Ma,"This is the configuration class to store the configuration of a "),ma=s(Ma,"A",{href:!0});var pp=r(ma);_i=i(pp,"ViTModel"),pp.forEach(t),vi=i(Ma,`. It is used to instantiate an ViT
model according to the specified arguments, defining the model architecture. Instantiating a configuration with the
defaults will yield a similar configuration to that of the ViT
`),Zt=s(Ma,"A",{href:!0,rel:!0});var hp=r(Zt);Ti=i(hp,"google/vit-base-patch16-224"),hp.forEach(t),bi=i(Ma," architecture."),Ma.forEach(t),wi=h(wt),Ie=s(wt,"P",{});var ja=r(Ie);$i=i(ja,"Configuration objects inherit from "),fa=s(ja,"A",{href:!0});var mp=r(fa);yi=i(mp,"PretrainedConfig"),mp.forEach(t),xi=i(ja,` and can be used to control the model outputs. Read the
documentation from `),ua=s(ja,"A",{href:!0});var fp=r(ua);Fi=i(fp,"PretrainedConfig"),fp.forEach(t),Vi=i(ja," for more information."),ja.forEach(t),ki=h(wt),w(Ke.$$.fragment,wt),wt.forEach(t),fr=h(o),Me=s(o,"H2",{class:!0});var Ar=r(Me);Ge=s(Ar,"A",{id:!0,class:!0,href:!0});var up=r(Ge);as=s(up,"SPAN",{});var gp=r(as);w(Qt.$$.fragment,gp),gp.forEach(t),up.forEach(t),Ei=h(Ar),ss=s(Ar,"SPAN",{});var _p=r(ss);Ii=i(_p,"ViTFeatureExtractor"),_p.forEach(t),Ar.forEach(t),ur=h(o),Q=s(o,"DIV",{class:!0});var $t=r(Q);w(Yt.$$.fragment,$t),Mi=h($t),rs=s($t,"P",{});var vp=r(rs);ji=i(vp,"Constructs a ViT feature extractor."),vp.forEach(t),Pi=h($t),eo=s($t,"P",{});var qr=r(eo);Ci=i(qr,"This feature extractor inherits from "),ga=s(qr,"A",{href:!0});var Tp=r(ga);Ai=i(Tp,"FeatureExtractionMixin"),Tp.forEach(t),qi=i(qr,` which contains most of the main methods. Users
should refer to this superclass for more information regarding those methods.`),qr.forEach(t),zi=h($t),we=s($t,"DIV",{class:!0});var Pa=r(we);w(to.$$.fragment,Pa),Ni=h(Pa),ns=s(Pa,"P",{});var bp=r(ns);Li=i(bp,"Main method to prepare for the model one or several image(s)."),bp.forEach(t),Di=h(Pa),w(Xe.$$.fragment,Pa),Pa.forEach(t),$t.forEach(t),gr=h(o),je=s(o,"H2",{class:!0});var zr=r(je);Ze=s(zr,"A",{id:!0,class:!0,href:!0});var wp=r(Ze);is=s(wp,"SPAN",{});var $p=r(is);w(oo.$$.fragment,$p),$p.forEach(t),wp.forEach(t),Oi=h(zr),ls=s(zr,"SPAN",{});var yp=r(ls);Si=i(yp,"ViTModel"),yp.forEach(t),zr.forEach(t),_r=h(o),me=s(o,"DIV",{class:!0});var Ca=r(me);w(ao.$$.fragment,Ca),Wi=h(Ca),so=s(Ca,"P",{});var Nr=r(so);Bi=i(Nr,`The bare ViT Model transformer outputting raw hidden-states without any specific head on top.
This model is a PyTorch `),ro=s(Nr,"A",{href:!0,rel:!0});var xp=r(ro);Ui=i(xp,"torch.nn.Module"),xp.forEach(t),Ri=i(Nr,` subclass. Use it
as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),Nr.forEach(t),Hi=h(Ca),oe=s(Ca,"DIV",{class:!0});var yt=r(oe);w(no.$$.fragment,yt),Ji=h(yt),Pe=s(yt,"P",{});var Aa=r(Pe);Ki=i(Aa,"The "),_a=s(Aa,"A",{href:!0});var Fp=r(_a);Gi=i(Fp,"ViTModel"),Fp.forEach(t),Xi=i(Aa," forward method, overrides the "),ds=s(Aa,"CODE",{});var Vp=r(ds);Zi=i(Vp,"__call__"),Vp.forEach(t),Qi=i(Aa," special method."),Aa.forEach(t),Yi=h(yt),w(Qe.$$.fragment,yt),el=h(yt),w(Ye.$$.fragment,yt),yt.forEach(t),Ca.forEach(t),vr=h(o),Ce=s(o,"H2",{class:!0});var Lr=r(Ce);et=s(Lr,"A",{id:!0,class:!0,href:!0});var kp=r(et);cs=s(kp,"SPAN",{});var Ep=r(cs);w(io.$$.fragment,Ep),Ep.forEach(t),kp.forEach(t),tl=h(Lr),ps=s(Lr,"SPAN",{});var Ip=r(ps);ol=i(Ip,"ViTForMaskedImageModeling"),Ip.forEach(t),Lr.forEach(t),Tr=h(o),fe=s(o,"DIV",{class:!0});var qa=r(fe);w(lo.$$.fragment,qa),al=h(qa),Ae=s(qa,"P",{});var za=r(Ae);sl=i(za,"ViT Model with a decoder on top for masked image modeling, as proposed in "),hs=s(za,"CODE",{});var Mp=r(hs);rl=i(Mp,"SimMIM <https://arxiv.org/abs/2111.09886>"),Mp.forEach(t),nl=i(za,`__.
This model is a PyTorch `),co=s(za,"A",{href:!0,rel:!0});var jp=r(co);il=i(jp,"torch.nn.Module"),jp.forEach(t),ll=i(za,` subclass. Use it
as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
behavior.`),za.forEach(t),dl=h(qa),ae=s(qa,"DIV",{class:!0});var xt=r(ae);w(po.$$.fragment,xt),cl=h(xt),qe=s(xt,"P",{});var Na=r(qe);pl=i(Na,"The "),va=s(Na,"A",{href:!0});var Pp=r(va);hl=i(Pp,"ViTForMaskedImageModeling"),Pp.forEach(t),ml=i(Na," forward method, overrides the "),ms=s(Na,"CODE",{});var Cp=r(ms);fl=i(Cp,"__call__"),Cp.forEach(t),ul=i(Na," special method."),Na.forEach(t),gl=h(xt),w(tt.$$.fragment,xt),_l=h(xt),w(ot.$$.fragment,xt),xt.forEach(t),qa.forEach(t),br=h(o),ze=s(o,"H2",{class:!0});var Dr=r(ze);at=s(Dr,"A",{id:!0,class:!0,href:!0});var Ap=r(at);fs=s(Ap,"SPAN",{});var qp=r(fs);w(ho.$$.fragment,qp),qp.forEach(t),Ap.forEach(t),vl=h(Dr),us=s(Dr,"SPAN",{});var zp=r(us);Tl=i(zp,"ViTForImageClassification"),zp.forEach(t),Dr.forEach(t),wr=h(o),Y=s(o,"DIV",{class:!0});var Ft=r(Y);w(mo.$$.fragment,Ft),bl=h(Ft),gs=s(Ft,"P",{});var Np=r(gs);wl=i(Np,`ViT Model transformer with an image classification head on top (a linear layer on top of the final hidden state of
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Hr.forEach(t),ud=h(ce),w(pt.$$.fragment,ce),gd=h(ce),ne=s(ce,"DIV",{class:!0});var Et=r(ne);w(Eo.$$.fragment,Et),_d=h(Et),Se=s(Et,"P",{});var Oa=r(Se);vd=i(Oa,"The "),ya=s(Oa,"A",{href:!0});var th=r(ya);Td=i(th,"TFViTForImageClassification"),th.forEach(t),bd=i(Oa," forward method, overrides the "),Fs=s(Oa,"CODE",{});var oh=r(Fs);wd=i(oh,"__call__"),oh.forEach(t),$d=i(Oa," special method."),Oa.forEach(t),yd=h(Et),w(ht.$$.fragment,Et),xd=h(Et),w(mt.$$.fragment,Et),Et.forEach(t),ce.forEach(t),Vr=h(o),We=s(o,"H2",{class:!0});var Jr=r(We);ft=s(Jr,"A",{id:!0,class:!0,href:!0});var ah=r(ft);Vs=s(ah,"SPAN",{});var sh=r(Vs);w(Io.$$.fragment,sh),sh.forEach(t),ah.forEach(t),Fd=h(Jr),ks=s(Jr,"SPAN",{});var rh=r(ks);Vd=i(rh,"FlaxVitModel"),rh.forEach(t),Jr.forEach(t),kr=h(o),A=s(o,"DIV",{class:!0});var H=r(A);w(Mo.$$.fragment,H),kd=h(H),Es=s(H,"P",{});var nh=r(Es);Ed=i(nh,"The bare ViT Model transformer outputting raw hidden-states without any specific head on top."),nh.forEach(t),Id=h(H),jo=s(H,"P",{});var Kr=r(jo);Md=i(Kr,"This model inherits from "),xa=s(Kr,"A",{href:!0});var ih=r(xa);jd=i(ih,"FlaxPreTrainedModel"),ih.forEach(t),Pd=i(Kr,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading, saving and converting weights from PyTorch models)`),Kr.forEach(t),Cd=h(H),Po=s(H,"P",{});var Gr=r(Po);Ad=i(Gr,"This model is also a Flax Linen "),Co=s(Gr,"A",{href:!0,rel:!0});var lh=r(Co);qd=i(lh,"flax.linen.Module"),lh.forEach(t),zd=i(Gr,`
subclass. Use it as a regular Flax linen Module and refer to the Flax documentation for all matter related to
general usage and behavior.`),Gr.forEach(t),Nd=h(H),Is=s(H,"P",{});var dh=r(Is);Ld=i(dh,"Finally, this model supports inherent JAX features such as:"),dh.forEach(t),Dd=h(H),ue=s(H,"UL",{});var It=r(ue);Ms=s(It,"LI",{});var ch=r(Ms);Ao=s(ch,"A",{href:!0,rel:!0});var ph=r(Ao);Od=i(ph,"Just-In-Time (JIT) compilation"),ph.forEach(t),ch.forEach(t),Sd=h(It),js=s(It,"LI",{});var hh=r(js);qo=s(hh,"A",{href:!0,rel:!0});var mh=r(qo);Wd=i(mh,"Automatic Differentiation"),mh.forEach(t),hh.forEach(t),Bd=h(It),Ps=s(It,"LI",{});var fh=r(Ps);zo=s(fh,"A",{href:!0,rel:!0});var uh=r(zo);Ud=i(uh,"Vectorization"),uh.forEach(t),fh.forEach(t),Rd=h(It),Cs=s(It,"LI",{});var gh=r(Cs);No=s(gh,"A",{href:!0,rel:!0});var _h=r(No);Hd=i(_h,"Parallelization"),_h.forEach(t),gh.forEach(t),It.forEach(t),Jd=h(H),ie=s(H,"DIV",{class:!0});var Mt=r(ie);w(Lo.$$.fragment,Mt),Kd=h(Mt),Be=s(Mt,"P",{});var Sa=r(Be);Gd=i(Sa,"The "),As=s(Sa,"CODE",{});var vh=r(As);Xd=i(vh,"FlaxViTPreTrainedModel"),vh.forEach(t),Zd=i(Sa," forward method, overrides the "),qs=s(Sa,"CODE",{});var Th=r(qs);Qd=i(Th,"__call__"),Th.forEach(t),Yd=i(Sa," special method."),Sa.forEach(t),ec=h(Mt),w(ut.$$.fragment,Mt),tc=h(Mt),w(gt.$$.fragment,Mt),Mt.forEach(t),H.forEach(t),Er=h(o),Ue=s(o,"H2",{class:!0});var Xr=r(Ue);_t=s(Xr,"A",{id:!0,class:!0,href:!0});var bh=r(_t);zs=s(bh,"SPAN",{});var wh=r(zs);w(Do.$$.fragment,wh),wh.forEach(t),bh.forEach(t),oc=h(Xr),Ns=s(Xr,"SPAN",{});var $h=r(Ns);ac=i($h,"FlaxViTForImageClassification"),$h.forEach(t),Xr.forEach(t),Ir=h(o),q=s(o,"DIV",{class:!0});var J=r(q);w(Oo.$$.fragment,J),sc=h(J),Ls=s(J,"P",{});var yh=r(Ls);rc=i(yh,`ViT Model transformer with an image classification head on top (a linear layer on top of the final hidden state of
