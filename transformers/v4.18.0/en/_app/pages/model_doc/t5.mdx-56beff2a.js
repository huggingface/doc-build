import{S as uw,i as mw,s as fw,e as o,k as d,w as f,t as r,M as _w,c as s,d as t,m as l,a,x as _,h as i,b as c,F as e,g as p,y as g,q as T,o as v,B as k,v as gw}from"../../chunks/vendor-6b77c823.js";import{T as zt}from"../../chunks/Tip-39098574.js";import{D as M}from"../../chunks/Docstring-abef54e3.js";import{C as B}from"../../chunks/CodeBlock-3a8b25a8.js";import{I as ve}from"../../chunks/IconCopyLink-7a11ce68.js";function Tw(L){let u,$,b,w,z;return{c(){u=o("p"),$=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),b=o("code"),w=r("Module"),z=r(`
...
`),R=s(Ae,"CODE",{});var ft=a(R);Ne=i(ft,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),ft.forEach(t),Ae.forEach(t),O.forEach(t)},m(m,j){p(m,u,j),e(u,$),p(m,b,j),p(m,w,j),e(w,z),e(z,x),e(w,y),e(w,q),e(q,qe),p(m,oe,j),p(m,E,j),e(E,ee),e(E,S),e(S,se),e(E,Ee),e(E,G),e(G,je),e(E,ke),p(m,U,j),p(m,A,j),e(A,ae),p(m,pe,j),p(m,F,j),e(F,P),e(P,he),e(P,K),e(K,be),e(P,ue),e(P,W),e(W,Fe),e(F,ye),e(F,C),e(C,Me),e(C,H),e(H,V),e(C,me),e(C,N),e(N,Ce),e(F,fe),e(F,I),e(I,Pe),e(I,R),e(R,Ne)},d(m){m&&t(u),m&&t(b),m&&t(w),m&&t(oe),m&&t(E),m&&t(U),m&&t(A),m&&t(pe),m&&t(F)}}}function yw(L){let u,$,b,w,z;return{c(){u=o("p"),$=r("Although the recipe for forward pass needs to be defined within this function, one should call the "),b=o("code"),w=r("Module"),z=r(`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`)},l(x){u=s(x,"P",{});var y=a(u);$=i(y,"Although the recipe for forward pass needs to be defined within this function, one should call the "),b=s(y,"CODE",{});var q=a(b);w=i(q,"Module"),q.forEach(t),z=i(y,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
...
the latter silently ignores them.`)},l(x){u=s(x,"P",{});var y=a(u);$=i(y,"Although the recipe for forward pass needs to be defined within this function, one should call the "),b=s(y,"CODE",{});var q=a(b);w=i(q,"Module"),q.forEach(t),z=i(y,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),y.forEach(t)},m(x,y){p(x,u,y),e(u,$),e(u,b),e(b,w),e(u,z)},d(x){x&&t(u)}}}function jw(L){let u,$,b,w,z,x,y,q,qe,oe,E,ee,S,se,Ee,G,je,ke,U,A,ae,pe,F,P,he,K,be,ue,W,Fe,ye,C,Me,H,V,me,N,Ce,fe,I,Pe,R,Ne,m,j,te,Se,pt,D,Ge,ne,ht,O,Y,ut,Oe,Z,mt,Le,Ae,ft,Vl,Xa,Dp,Kl,Ue,di,li,To,Sp,Gp,ci,pi,vo,Up,Wp,hi,ui,ko,Rp,Bp,mi,fi,bo,Hp,Vp,_i,Qa,yo,Kp,Yp,Yl,er,Zp,Zl,$t,gi,zn,Ti,Jp,Xp,tr,Qp,eh,th,vi,$n,ki,nh,oh,nr,sh,ah,rh,bi,qn,yi,ih,dh,or,lh,ch,Jl,En,ph,wo,hh,uh,Xl,qt,mh,xo,fh,_h,zo,gh,Th,Ql,sr,ec,Zt,jn,wi,$o,vh,xi,kh,tc,_t,bh,zi,yh,wh,$i,xh,zh,qi,$h,qh,nc,Fn,Eh,ar,jh,Fh,oc,Mn,dt,Ei,Mh,Ch,_e,Ph,ji,Nh,Oh,Fi,Lh,Ah,Mi,Ih,Dh,Ci,Sh,Gh,Pi,Uh,Wh,rr,Rh,Bh,Hh,Ni,Vh,Kh,qo,Yh,Eo,Zh,jo,Jh,Xh,Qh,ge,Oi,eu,tu,Li,nu,ou,Fo,su,re,au,Ai,ru,iu,Ii,du,lu,Di,cu,pu,Si,hu,uu,Gi,mu,fu,Ui,_u,gu,Wi,Tu,vu,ku,Jt,bu,Ri,yu,wu,Bi,xu,zu,$u,Te,qu,Hi,Eu,ju,Vi,Fu,Mu,Ki,Cu,Pu,Yi,Nu,Ou,Mo,Lu,Au,Zi,Iu,Du,Su,Co,sc,ir,Gu,ac,Et,Ji,Po,Uu,Xi,Wu,Ru,Bu,Qi,Xt,Hu,No,Vu,Ku,Oo,Yu,Zu,Ju,ed,Lo,Xu,td,Qu,em,rc,dr,ic,Qt,Cn,nd,Ao,tm,od,nm,dc,gt,om,lr,sm,am,Io,rm,im,Do,dm,lm,lc,So,cc,We,cm,sd,pm,hm,ad,um,mm,cr,fm,_m,rd,gm,Tm,pc,pr,vm,hc,Go,uc,hr,mc,en,Pn,id,Uo,km,dd,bm,fc,Tt,ym,Wo,wm,xm,ld,zm,$m,cd,qm,Em,_c,tn,Nn,pd,Ro,jm,hd,Fm,gc,ur,Mm,Tc,On,ud,nn,Cm,Bo,Pm,Nm,Ho,Om,Lm,Am,md,Ie,Im,Vo,Dm,Sm,Ko,Gm,Um,Yo,Wm,Rm,Zo,Bm,Hm,Jo,Vm,Km,vc,on,Ln,fd,Xo,Ym,_d,Zm,kc,wt,Qo,Jm,xt,Xm,mr,Qm,ef,fr,tf,nf,es,of,sf,af,sn,rf,_r,df,lf,gr,cf,pf,bc,an,An,gd,ts,hf,Td,uf,yc,ie,ns,mf,os,ff,ss,_f,gf,Tf,as,vf,Tr,kf,bf,yf,jt,rs,wf,vd,xf,zf,is,vr,$f,kd,qf,Ef,kr,jf,bd,Ff,Mf,In,ds,Cf,ls,Pf,yd,Nf,Of,Lf,Dn,cs,Af,wd,If,Df,br,ps,wc,rn,Sn,xd,hs,Sf,zd,Gf,xc,De,us,Uf,dn,Wf,$d,Rf,Bf,ms,Hf,Vf,Kf,fs,Yf,yr,Zf,Jf,Xf,Ft,_s,Qf,qd,e_,t_,gs,wr,n_,Ed,o_,s_,xr,a_,jd,r_,i_,Gn,Ts,d_,Fd,l_,zc,ln,Un,Md,vs,c_,Cd,p_,$c,J,ks,h_,Pd,u_,m_,bs,f_,ys,__,g_,T_,ws,v_,zr,k_,b_,y_,xs,w_,zs,x_,z_,$_,Re,$s,q_,cn,E_,$r,j_,F_,Nd,M_,C_,P_,Wn,N_,Od,O_,L_,qs,A_,Be,Es,I_,Ld,D_,S_,Ad,G_,U_,Id,W_,R_,js,B_,vt,Fs,H_,Dd,V_,K_,Sd,Y_,Z_,Ms,qc,pn,Rn,Gd,Cs,J_,Ud,X_,Ec,X,Ps,Q_,Ns,eg,Wd,tg,ng,og,Os,sg,Ls,ag,rg,ig,As,dg,qr,lg,cg,pg,Is,hg,Ds,ug,mg,fg,He,Ss,_g,hn,gg,Er,Tg,vg,Rd,kg,bg,yg,Bn,wg,Bd,xg,zg,Gs,$g,Ve,Us,qg,Hd,Eg,jg,Vd,Fg,Mg,Kd,Cg,Pg,Ws,Ng,kt,Rs,Og,Yd,Lg,Ag,Zd,Ig,Dg,Bs,jc,un,Hn,Jd,Hs,Sg,Xd,Gg,Fc,Q,Vs,Ug,Qd,Wg,Rg,Ks,Bg,Ys,Hg,Vg,Kg,Zs,Yg,jr,Zg,Jg,Xg,Js,Qg,Xs,eT,tT,nT,Ke,Qs,oT,mn,sT,Fr,aT,rT,el,iT,dT,lT,Vn,cT,tl,pT,hT,ea,uT,Ye,ta,mT,nl,fT,_T,ol,gT,TT,sl,vT,kT,na,bT,bt,oa,yT,al,wT,xT,rl,zT,$T,sa,Mc,fn,Kn,il,aa,qT,dl,ET,Cc,de,ra,jT,ll,FT,MT,ia,CT,da,PT,NT,OT,la,LT,Mr,AT,IT,DT,ca,ST,pa,GT,UT,WT,Yn,RT,Ze,ha,BT,_n,HT,Cr,VT,KT,cl,YT,ZT,JT,Zn,XT,pl,QT,ev,ua,Pc,gn,Jn,hl,ma,tv,ul,nv,Nc,le,fa,ov,_a,sv,ml,av,rv,iv,ga,dv,Ta,lv,cv,pv,va,hv,Pr,uv,mv,fv,ka,_v,ba,gv,Tv,vv,Xn,kv,Je,ya,bv,Tn,yv,Nr,wv,xv,fl,zv,$v,qv,Qn,Ev,_l,jv,Fv,wa,Oc,vn,eo,gl,xa,Mv,Tl,Cv,Lc,ce,za,Pv,vl,Nv,Ov,$a,Lv,qa,Av,Iv,Dv,Ea,Sv,Or,Gv,Uv,Wv,ja,Rv,Fa,Bv,Hv,Vv,to,Kv,Xe,Ma,Yv,kn,Zv,Lr,Jv,Xv,kl,Qv,ek,tk,no,nk,bl,ok,sk,Ca,Ac,bn,oo,yl,Pa,ak,wl,rk,Ic,lt,Na,ik,Qe,Oa,dk,yn,lk,xl,ck,pk,zl,hk,uk,mk,so,fk,$l,_k,gk,La,Tk,Mt,Aa,vk,ql,kk,bk,Ia,yk,Ct,Da,wk,El,xk,zk,Sa,Dc,wn,ao,jl,Ga,$k,Fl,qk,Sc,ct,Ua,Ek,et,Wa,jk,xn,Fk,Ml,Mk,Ck,Cl,Pk,Nk,Ok,ro,Lk,Pl,Ak,Ik,Ra,Dk,Pt,Ba,Sk,Nl,Gk,Uk,Ha,Wk,Nt,Va,Rk,Ol,Bk,Hk,Ka,Gc;return x=new ve({}),se=new ve({}),$o=new ve({}),qo=new B({props:{code:`from transformers import T5Tokenizer, T5ForConditionalGeneration
...
`}}),Bn=new zt({props:{$$slots:{default:[vw]},$$scope:{ctx:L}}}),Gs=new B({props:{code:`from transformers import T5Tokenizer, T5ForConditionalGeneration
...
`}}),Vn=new zt({props:{$$slots:{default:[kw]},$$scope:{ctx:L}}}),ea=new B({props:{code:`from transformers import T5Tokenizer, T5EncoderModel
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/v4.18.0/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),Xn=new zt({props:{$$slots:{default:[ww]},$$scope:{ctx:L}}}),ya=new M({props:{name:"call",anchor:"transformers.TFT5ForConditionalGeneration.call",parameters:[{name:"input_ids",val:": typing.Union[typing.List[tensorflow.python.framework.ops.Tensor], typing.List[numpy.ndarray], typing.List[tensorflow.python.keras.engine.keras_tensor.KerasTensor], typing.Dict[str, tensorflow.python.framework.ops.Tensor], typing.Dict[str, numpy.ndarray], typing.Dict[str, tensorflow.python.keras.engine.keras_tensor.KerasTensor], tensorflow.python.framework.ops.Tensor, numpy.ndarray, tensorflow.python.keras.engine.keras_tensor.KerasTensor, NoneType] = None"},{name:"attention_mask",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"decoder_input_ids",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"decoder_attention_mask",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"head_mask",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"decoder_head_mask",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"encoder_outputs",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"past_key_values",val:": typing.Union[typing.Tuple[typing.Tuple[typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor]]], NoneType] = None"},{name:"inputs_embeds",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"decoder_inputs_embeds",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"labels",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"use_cache",val:": typing.Optional[bool] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"training",val:": typing.Optional[bool] = False"}],source:"https://github.com/huggingface/transformers/blob/v4.18.0/src/transformers/models/t5/modeling_tf_t5.py#L1309",parametersDescription:[{anchor:"transformers.TFT5ForConditionalGeneration.call.input_ids",description:`<strong>input_ids</strong> (<code>tf.Tensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. T5 is a model with relative position embeddings so you
should be able to pad the inputs on the right or the left.</p>
<p>Indices can be obtained using <a href="/docs/transformers/v4.18.0/en/model_doc/bert#transformers.BertTokenizer">BertTokenizer</a>. See <a href="/docs/transformers/v4.18.0/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
<a href="/docs/transformers/v4.18.0/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> for details.</p>
...
Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/v4.18.0/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),to=new zt({props:{$$slots:{default:[zw]},$$scope:{ctx:L}}}),Ma=new M({props:{name:"call",anchor:"transformers.TFT5EncoderModel.call",parameters:[{name:"input_ids",val:": typing.Union[typing.List[tensorflow.python.framework.ops.Tensor], typing.List[numpy.ndarray], typing.List[tensorflow.python.keras.engine.keras_tensor.KerasTensor], typing.Dict[str, tensorflow.python.framework.ops.Tensor], typing.Dict[str, numpy.ndarray], typing.Dict[str, tensorflow.python.keras.engine.keras_tensor.KerasTensor], tensorflow.python.framework.ops.Tensor, numpy.ndarray, tensorflow.python.keras.engine.keras_tensor.KerasTensor, NoneType] = None"},{name:"attention_mask",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"head_mask",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"inputs_embeds",val:": typing.Union[numpy.ndarray, tensorflow.python.framework.ops.Tensor, NoneType] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"},{name:"training",val:": typing.Optional[bool] = False"}],source:"https://github.com/huggingface/transformers/blob/v4.18.0/src/transformers/models/t5/modeling_tf_t5.py#L1618",parametersDescription:[{anchor:"transformers.TFT5EncoderModel.call.inputs",description:`<strong>inputs</strong> (<code>tf.Tensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary. T5 is a model with relative position embeddings so you
should be able to pad the inputs on the right or the left.</p>
<p>Indices can be obtained using <a href="/docs/transformers/v4.18.0/en/model_doc/t5#transformers.T5Tokenizer">T5Tokenizer</a>. See <a href="/docs/transformers/v4.18.0/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> and
<a href="/docs/transformers/v4.18.0/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> for details.</p>
...
<span class="hljs-meta">&gt;&gt;&gt; </span>outputs = model.decode(decoder_input_ids, encoder_outputs)
<span class="hljs-meta">&gt;&gt;&gt; </span>logits = outputs.logits`}}),{c(){u=o("meta"),$=d(),b=o("h1"),w=o("a"),z=o("span"),f(x.$$.fragment),y=d(),q=o("span"),qe=r("T5"),oe=d(),E=o("h2"),ee=o("a"),S=o("span"),f(se.$$.fragment),Ee=d(),G=o("span"),je=r("Overview"),ke=d(),U=o("p"),A=r("The T5 model was presented in "),ae=o("a"),pe=r("Exploring the Limits of Transfer Learning with a Unified Text-to-Text Transformer"),F=r(` by Colin Raffel, Noam Shazeer, Adam Roberts, Katherine Lee, Sharan Narang,
...
for summarization: `),R=o("em"),Ne=r("summarize: \u2026"),m=r("."),j=d(),te=o("li"),Se=o("p"),pt=r("T5 uses relative scalar embeddings. Encoder input padding can be done on the left and on the right."),D=d(),Ge=o("li"),ne=o("p"),ht=r("See the "),O=o("a"),Y=r("training"),ut=r(", "),Oe=o("a"),Z=r("inference"),mt=r(" and "),Le=o("a"),Ae=r("scripts"),ft=r(" sections below for all details regarding usage."),Vl=d(),Xa=o("p"),Dp=r("T5 comes in different sizes:"),Kl=d(),Ue=o("ul"),di=o("li"),li=o("p"),To=o("a"),Sp=r("t5-small"),Gp=d(),ci=o("li"),pi=o("p"),vo=o("a"),Up=r("t5-base"),Wp=d(),hi=o("li"),ui=o("p"),ko=o("a"),Rp=r("t5-large"),Bp=d(),mi=o("li"),fi=o("p"),bo=o("a"),Hp=r("t5-3b"),Vp=d(),_i=o("li"),Qa=o("p"),yo=o("a"),Kp=r("t5-11b"),Yp=r("."),Yl=d(),er=o("p"),Zp=r("Based on the original T5 model, Google has released some follow-up works:"),Zl=d(),$t=o("ul"),gi=o("li"),zn=o("p"),Ti=o("strong"),Jp=r("T5v1.1"),Xp=r(`: T5v1.1 is an improved version of T5 with some architectural tweaks, and is pre-trained on C4 only without
...
adding special tokens. A sequence has the following format:`),zf=d(),is=o("ul"),vr=o("li"),$f=r("single sequence: "),kd=o("code"),qf=r("X </s>"),Ef=d(),kr=o("li"),jf=r("pair of sequences: "),bd=o("code"),Ff=r("A </s> B </s>"),Mf=d(),In=o("div"),f(ds.$$.fragment),Cf=d(),ls=o("p"),Pf=r(`Retrieve sequence ids from a token list that has no special tokens added. This method is called when adding
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),fg=d(),He=o("div"),f(Ss.$$.fragment),_g=d(),hn=o("p"),gg=r("The "),Er=o("a"),Tg=r("T5ForConditionalGeneration"),vg=r(" forward method, overrides the "),Rd=o("code"),kg=r("__call__"),bg=r(" special method."),yg=d(),f(Bn.$$.fragment),wg=d(),Bd=o("p"),xg=r("Examples:"),zg=d(),f(Gs.$$.fragment),$g=d(),Ve=o("div"),f(Us.$$.fragment),qg=d(),Hd=o("p"),Eg=r("This is an experimental feature and is a subject to change at a moment\u2019s notice."),jg=d(),Vd=o("p"),Fg=r(`Uses a device map to distribute attention modules of the model across several devices. If no device map is given,
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),vv=d(),f(Xn.$$.fragment),kv=d(),Je=o("div"),f(ya.$$.fragment),bv=d(),Tn=o("p"),yv=r("The "),Nr=o("a"),wv=r("TFT5ForConditionalGeneration"),xv=r(" forward method, overrides the "),fl=o("code"),zv=r("__call__"),$v=r(" special method."),qv=d(),f(Qn.$$.fragment),Ev=d(),_l=o("p"),jv=r("Examples:"),Fv=d(),f(wa.$$.fragment),Oc=d(),vn=o("h2"),eo=o("a"),gl=o("span"),f(xa.$$.fragment),Mv=d(),Tl=o("span"),Cv=r("TFT5EncoderModel"),Lc=d(),ce=o("div"),f(za.$$.fragment),Pv=d(),vl=o("p"),Nv=r("The bare T5 Model transformer outputting encoder\u2019s raw hidden-stateswithout any specific head on top."),Ov=d(),$a=o("p"),Lv=r("The T5 model was proposed in "),qa=o("a"),Av=r(`Exploring the Limits of Transfer Learning with a Unified Text-to-Text
...
to the documentation of byT5 which can be found `),or=s(Hl,"A",{href:!0});var Nb=a(or);lh=i(Nb,"here"),Nb.forEach(t),ch=i(Hl,"."),Hl.forEach(t),Cb.forEach(t),Dr.forEach(t),Jl=l(n),En=s(n,"P",{});var Uc=a(En);ph=i(Uc,"All checkpoints can be found on the "),wo=s(Uc,"A",{href:!0,rel:!0});var Ob=a(wo);hh=i(Ob,"hub"),Ob.forEach(t),uh=i(Uc,"."),Uc.forEach(t),Xl=l(n),qt=s(n,"P",{});var Sr=a(qt);mh=i(Sr,"This model was contributed by "),xo=s(Sr,"A",{href:!0,rel:!0});var Lb=a(xo);fh=i(Lb,"thomwolf"),Lb.forEach(t),_h=i(Sr,". The original code can be found "),zo=s(Sr,"A",{href:!0,rel:!0});var Ab=a(zo);gh=i(Ab,"here"),Ab.forEach(t),Th=i(Sr,"."),Sr.forEach(t),Ql=l(n),sr=s(n,"A",{id:!0}),a(sr).forEach(t),ec=l(n),Zt=s(n,"H2",{class:!0});var Wc=a(Zt);jn=s(Wc,"A",{id:!0,class:!0,href:!0});var Ib=a(jn);wi=s(Ib,"SPAN",{});var Db=a(wi);_($o.$$.fragment,Db),Db.forEach(t),Ib.forEach(t),vh=l(Wc),xi=s(Wc,"SPAN",{});var Sb=a(xi);kh=i(Sb,"Training"),Sb.forEach(t),Wc.forEach(t),tc=l(n),_t=s(n,"P",{});var lo=a(_t);bh=i(lo,`T5 is an encoder-decoder model and converts all NLP problems into a text-to-text format. It is trained using teacher
forcing. This means that for training, we always need an input sequence and a corresponding target sequence. The input
...
use of token type ids, therefore a list of zeros is returned.`),j1.forEach(t),cp.forEach(t),It.forEach(t),zc=l(n),ln=s(n,"H2",{class:!0});var pp=a(ln);Un=s(pp,"A",{id:!0,class:!0,href:!0});var F1=a(Un);Md=s(F1,"SPAN",{});var M1=a(Md);_(vs.$$.fragment,M1),M1.forEach(t),F1.forEach(t),c_=l(pp),Cd=s(pp,"SPAN",{});var C1=a(Cd);p_=i(C1,"T5Model"),C1.forEach(t),pp.forEach(t),$c=l(n),J=s(n,"DIV",{class:!0});var xe=a(J);_(ks.$$.fragment,xe),h_=l(xe),Pd=s(xe,"P",{});var P1=a(Pd);u_=i(P1,"The bare T5 Model transformer outputting raw hidden-states without any specific head on top."),P1.forEach(t),m_=l(xe),bs=s(xe,"P",{});var hp=a(bs);f_=i(hp,"The T5 model was proposed in "),ys=s(hp,"A",{href:!0,rel:!0});var N1=a(ys);__=i(N1,`Exploring the Limits of Transfer Learning with a Unified Text-to-Text
Transformer`),N1.forEach(t),g_=i(hp,` by Colin Raffel, Noam Shazeer, Adam Roberts, Katherine Lee, Sharan
Narang, Michael Matena, Yanqi Zhou, Wei Li, Peter J. Liu. It\u2019s an encoder decoder transformer pre-trained in a
text-to-text denoising generative setting.`),hp.forEach(t),T_=l(xe),ws=s(xe,"P",{});var up=a(ws);v_=i(up,"This model inherits from "),zr=s(up,"A",{href:!0});var O1=a(zr);k_=i(O1,"PreTrainedModel"),O1.forEach(t),b_=i(up,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Tp.forEach(t),pg=l(ze),Is=s(ze,"P",{});var vp=a(Is);hg=i(vp,"This model is also a PyTorch "),Ds=s(vp,"A",{href:!0,rel:!0});var J1=a(Ds);ug=i(J1,"torch.nn.Module"),J1.forEach(t),mg=i(vp,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
...
it will evenly distribute blocks across all devices.`),g5.forEach(t),TT=l(Rt),sl=s(Rt,"P",{});var T5=a(sl);vT=i(T5,"Example:"),T5.forEach(t),kT=l(Rt),_(na.$$.fragment,Rt),Rt.forEach(t),bT=l($e),bt=s($e,"DIV",{class:!0});var fo=a(bt);_(oa.$$.fragment,fo),yT=l(fo),al=s(fo,"P",{});var v5=a(al);wT=i(v5,"Moves the model to cpu from a model parallel state."),v5.forEach(t),xT=l(fo),rl=s(fo,"P",{});var k5=a(rl);zT=i(k5,"Example:"),k5.forEach(t),$T=l(fo),_(sa.$$.fragment,fo),fo.forEach(t),$e.forEach(t),Mc=l(n),fn=s(n,"H2",{class:!0});var xp=a(fn);Kn=s(xp,"A",{id:!0,class:!0,href:!0});var b5=a(Kn);il=s(b5,"SPAN",{});var y5=a(il);_(aa.$$.fragment,y5),y5.forEach(t),b5.forEach(t),qT=l(xp),dl=s(xp,"SPAN",{});var w5=a(dl);ET=i(w5,"TFT5Model"),w5.forEach(t),xp.forEach(t),Cc=l(n),de=s(n,"DIV",{class:!0});var at=a(de);_(ra.$$.fragment,at),jT=l(at),ll=s(at,"P",{});var x5=a(ll);FT=i(x5,"The bare T5 Model transformer outputting raw hidden-stateswithout any specific head on top."),x5.forEach(t),MT=l(at),ia=s(at,"P",{});var zp=a(ia);CT=i(zp,"The T5 model was proposed in "),da=s(zp,"A",{href:!0,rel:!0});var z5=a(da);PT=i(z5,`Exploring the Limits of Transfer Learning with a Unified Text-to-Text
...
as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage and
behavior.`),Cp.forEach(t),vv=l(rt),_(Xn.$$.fragment,rt),kv=l(rt),Je=s(rt,"DIV",{class:!0});var Ht=a(Je);_(ya.$$.fragment,Ht),bv=l(Ht),Tn=s(Ht,"P",{});var ei=a(Tn);yv=i(ei,"The "),Nr=s(ei,"A",{href:!0});var I5=a(Nr);wv=i(I5,"TFT5ForConditionalGeneration"),I5.forEach(t),xv=i(ei," forward method, overrides the "),fl=s(ei,"CODE",{});var D5=a(fl);zv=i(D5,"__call__"),D5.forEach(t),$v=i(ei," special method."),ei.forEach(t),qv=l(Ht),_(Qn.$$.fragment,Ht),Ev=l(Ht),_l=s(Ht,"P",{});var S5=a(_l);jv=i(S5,"Examples:"),S5.forEach(t),Fv=l(Ht),_(wa.$$.fragment,Ht),Ht.forEach(t),rt.forEach(t),Oc=l(n),vn=s(n,"H2",{class:!0});var Pp=a(vn);eo=s(Pp,"A",{id:!0,class:!0,href:!0});var G5=a(eo);gl=s(G5,"SPAN",{});var U5=a(gl);_(xa.$$.fragment,U5),U5.forEach(t),G5.forEach(t),Mv=l(Pp),Tl=s(Pp,"SPAN",{});var W5=a(Tl);Cv=i(W5,"TFT5EncoderModel"),W5.forEach(t),Pp.forEach(t),Lc=l(n),ce=s(n,"DIV",{class:!0});var it=a(ce);_(za.$$.fragment,it),Pv=l(it),vl=s(it,"P",{});var R5=a(vl);Nv=i(R5,"The bare T5 Model transformer outputting encoder\u2019s raw hidden-stateswithout any specific head on top."),R5.forEach(t),Ov=l(it),$a=s(it,"P",{});var Np=a($a);Lv=i(Np,"The T5 model was proposed in "),qa=s(Np,"A",{href:!0,rel:!0});var B5=a(qa);Av=i(B5,`Exploring the Limits of Transfer Learning with a Unified Text-to-Text
