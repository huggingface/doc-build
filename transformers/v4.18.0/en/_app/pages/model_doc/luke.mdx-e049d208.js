...
the latter silently ignores them.`)},l(g){h=i(g,"P",{});var f=r(h);E=s(f,"Although the recipe for forward pass needs to be defined within this function, one should call the "),m=i(f,"CODE",{});var z=r(m);L=s(z,"Module"),z.forEach(t),w=s(f,`
instance afterwards instead of this since the former takes care of running the pre and post processing steps while
the latter silently ignores them.`),f.forEach(t)},m(g,f){u(g,h,f),e(h,E),e(h,m),e(m,L),e(h,w)},d(g){g&&t(h)}}}function up(K){let h,E,m,L,w,g,f,z,Ds,Ho,le,xe,Nn,He,Ws,Dn,Us,Vo,$e,Bs,Ve,Ks,Rs,Yo,Jt,Hs,Qo,Xt,Wn,Vs,Jo,Gt,Ys,Xo,R,Un,Ye,Qs,Zt,Js,Xs,Gs,Bn,F,Zs,Kn,ea,ta,Rn,na,oa,Hn,sa,aa,Vn,ia,ra,en,da,la,ca,Qe,H,tn,pa,ha,Yn,ua,ma,Qn,fa,ga,Jn,_a,ka,ya,Je,nn,Xn,va,ba,Ta,on,Gn,La,wa,Ea,B,Zn,za,xa,ce,Fe,sn,$a,Fa,Xe,qa,Ma,Ca,qe,an,Pa,ja,Ge,Aa,Ia,Oa,rn,dn,Sa,Na,Da,O,ln,Wa,Ua,eo,Ba,Ka,to,Ra,Ha,no,Va,Ya,oo,Qa,Ja,Xa,pe,Ga,cn,Za,ei,Ze,ti,ni,oi,et,si,tt,ai,ii,Go,pn,ri,Zo,nt,es,V,di,ot,li,ci,st,pi,hi,at,ui,mi,ts,he,Me,so,it,fi,ao,gi,ns,q,rt,_i,dt,ki,hn,yi,vi,bi,ue,Ti,un,Li,wi,mn,Ei,zi,xi,io,$i,Fi,lt,os,me,Ce,ro,ct,qi,lo,Mi,ss,M,pt,Ci,co,Pi,ji,x,Ai,fn,Ii,Oi,gn,Si,Ni,_n,Di,Wi,po,Ui,Bi,ho,Ki,Ri,uo,Hi,Vi,mo,Yi,Qi,Ji,Pe,ht,Xi,fo,Gi,Zi,kn,ut,as,fe,je,go,mt,er,_o,tr,is,C,ft,nr,ko,or,sr,gt,ar,yn,ir,rr,dr,_t,lr,kt,cr,pr,hr,S,yt,ur,ge,mr,vn,fr,gr,yo,_r,kr,yr,Ae,vr,vo,br,Tr,vt,rs,_e,Ie,bo,bt,Lr,To,wr,ds,P,Tt,Er,Lo,zr,xr,Lt,$r,bn,Fr,qr,Mr,wt,Cr,Et,Pr,jr,Ar,J,zt,Ir,ke,Or,Tn,Sr,Nr,wo,Dr,Wr,Ur,Oe,ls,ye,Se,Eo,xt,Br,zo,Kr,cs,j,$t,Rr,xo,Hr,Vr,Ft,Yr,Ln,Qr,Jr,Xr,qt,Gr,Mt,Zr,ed,td,N,Ct,nd,ve,od,wn,sd,ad,$o,id,rd,dd,Ne,ld,Fo,cd,pd,Pt,ps,be,De,qo,jt,hd,Mo,ud,hs,A,At,md,Co,fd,gd,It,_d,En,kd,yd,vd,Ot,bd,St,Td,Ld,wd,D,Nt,Ed,Te,zd,zn,xd,$d,Po,Fd,qd,Md,We,Cd,jo,Pd,jd,Dt,us,Le,Ue,Ao,Wt,Ad,Io,Id,ms,I,Ut,Od,Oo,Sd,Nd,Bt,Dd,xn,Wd,Ud,Bd,Kt,Kd,Rt,Rd,Hd,Vd,W,Ht,Yd,we,Qd,$n,Jd,Xd,So,Gd,Zd,el,Be,tl,No,nl,ol,Vt,fs;return g=new ze({}),He=new ze({}),nt=new Sn({props:{code:`from transformers import LukeTokenizer, LukeModel, LukeForEntityPairClassification
...
model. Initializing with a config file does not load the weights associated with the model, only the
configuration. Check out the <a href="/docs/transformers/v4.18.0/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),Ht=new U({props:{name:"forward",anchor:"transformers.LukeForEntitySpanClassification.forward",parameters:[{name:"input_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"attention_mask",val:" = None"},{name:"token_type_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"position_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"entity_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"entity_attention_mask",val:": typing.Optional[torch.LongTensor] = None"},{name:"entity_token_type_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"entity_position_ids",val:": typing.Optional[torch.LongTensor] = None"},{name:"entity_start_positions",val:": typing.Optional[torch.LongTensor] = None"},{name:"entity_end_positions",val:": typing.Optional[torch.LongTensor] = None"},{name:"head_mask",val:": typing.Optional[torch.FloatTensor] = None"},{name:"inputs_embeds",val:": typing.Optional[torch.FloatTensor] = None"},{name:"labels",val:": typing.Optional[torch.LongTensor] = None"},{name:"output_attentions",val:": typing.Optional[bool] = None"},{name:"output_hidden_states",val:": typing.Optional[bool] = None"},{name:"return_dict",val:": typing.Optional[bool] = None"}],source:"https://github.com/huggingface/transformers/blob/v4.18.0/src/transformers/models/luke/modeling_luke.py#L1516",parametersDescription:[{anchor:"transformers.LukeForEntitySpanClassification.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
Indices of input sequence tokens in the vocabulary.</p>
<p>Indices can be obtained using <a href="/docs/transformers/v4.18.0/en/model_doc/luke#transformers.LukeTokenizer">LukeTokenizer</a>. See <a href="/docs/transformers/v4.18.0/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.encode">PreTrainedTokenizer.encode()</a> and
<a href="/docs/transformers/v4.18.0/en/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.__call__">PreTrainedTokenizer.<strong>call</strong>()</a> for details.</p>
...
the HuggingFace implementation of LUKE. They can be found `),tt=a("a"),ai=o("here"),ii=o("."),Go=l(),pn=a("p"),ri=o("Example:"),Zo=l(),_(nt.$$.fragment),es=l(),V=a("p"),di=o("This model was contributed by "),ot=a("a"),li=o("ikuyamada"),ci=o(" and "),st=a("a"),pi=o("nielsr"),hi=o(". The original code can be found "),at=a("a"),ui=o("here"),mi=o("."),ts=l(),he=a("h2"),Me=a("a"),so=a("span"),_(it.$$.fragment),fi=l(),ao=a("span"),gi=o("LukeConfig"),ns=l(),q=a("div"),_(rt.$$.fragment),_i=l(),dt=a("p"),ki=o("This is the configuration class to store the configuration of a "),hn=a("a"),yi=o("LukeModel"),vi=o(`. It is used to instantiate a LUKE
model according to the specified arguments, defining the model architecture.`),bi=l(),ue=a("p"),Ti=o("Configuration objects inherit from "),un=a("a"),Li=o("PretrainedConfig"),wi=o(` and can be used to control the model outputs. Read the
documentation from `),mn=a("a"),Ei=o("PretrainedConfig"),zi=o(" for more information."),xi=l(),io=a("p"),$i=o("Examples:"),Fi=l(),_(lt.$$.fragment),os=l(),me=a("h2"),Ce=a("a"),ro=a("span"),_(ct.$$.fragment),qi=l(),lo=a("span"),Mi=o("LukeTokenizer"),ss=l(),M=a("div"),_(pt.$$.fragment),Ci=l(),co=a("p"),Pi=o("Construct a LUKE tokenizer."),ji=l(),x=a("p"),Ai=o("This tokenizer inherits from "),fn=a("a"),Ii=o("RobertaTokenizer"),Oi=o(` which contains most of the main methods. Users should refer to
...
also creates entity sequences, namely `),po=a("code"),Ui=o("entity_ids"),Bi=o(", "),ho=a("code"),Ki=o("entity_attention_mask"),Ri=o(", "),uo=a("code"),Hi=o("entity_token_type_ids"),Vi=o(`, and
...
sequences, depending on the task you want to prepare them for.`),Zi=l(),kn=a("div"),_(ut.$$.fragment),as=l(),fe=a("h2"),je=a("a"),go=a("span"),_(mt.$$.fragment),er=l(),_o=a("span"),tr=o("LukeModel"),is=l(),C=a("div"),_(ft.$$.fragment),nr=l(),ko=a("p"),or=o("The bare LUKE model transformer outputting raw hidden-states for both word tokens and entities without any specific head on top."),sr=l(),gt=a("p"),ar=o("This model inherits from "),yn=a("a"),ir=o("PreTrainedModel"),rr=o(`. Check the superclass documentation for the generic methods the
...
and behavior.`),hr=l(),S=a("div"),_(yt.$$.fragment),ur=l(),ge=a("p"),mr=o("The "),vn=a("a"),fr=o("LukeModel"),gr=o(" forward method, overrides the "),yo=a("code"),_r=o("__call__"),kr=o(" special method."),yr=l(),_(Ae.$$.fragment),vr=l(),vo=a("p"),br=o("Examples:"),Tr=l(),_(vt.$$.fragment),rs=l(),_e=a("h2"),Ie=a("a"),bo=a("span"),_(bt.$$.fragment),Lr=l(),To=a("span"),wr=o("LukeForMaskedLM"),ds=l(),P=a("div"),_(Tt.$$.fragment),Er=l(),Lo=a("p"),zr=o(`The LUKE model with a language modeling head and entity prediction head on top for masked language modeling and
masked entity prediction.`),xr=l(),Lt=a("p"),$r=o("This model inherits from "),bn=a("a"),Fr=o("PreTrainedModel"),qr=o(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Mr=l(),wt=a("p"),Cr=o("This model is also a PyTorch "),Et=a("a"),Pr=o("torch.nn.Module"),jr=o(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Ar=l(),J=a("div"),_(zt.$$.fragment),Ir=l(),ke=a("p"),Or=o("The "),Tn=a("a"),Sr=o("LukeForMaskedLM"),Nr=o(" forward method, overrides the "),wo=a("code"),Dr=o("__call__"),Wr=o(" special method."),Ur=l(),_(Oe.$$.fragment),ls=l(),ye=a("h2"),Se=a("a"),Eo=a("span"),_(xt.$$.fragment),Br=l(),zo=a("span"),Kr=o("LukeForEntityClassification"),cs=l(),j=a("div"),_($t.$$.fragment),Rr=l(),xo=a("p"),Hr=o(`The LUKE model with a classification head on top (a linear layer on top of the hidden state of the first entity
token) for entity classification tasks, such as Open Entity.`),Vr=l(),Ft=a("p"),Yr=o("This model inherits from "),Ln=a("a"),Qr=o("PreTrainedModel"),Jr=o(`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Xr=l(),qt=a("p"),Gr=o("This model is also a PyTorch "),Mt=a("a"),Zr=o("torch.nn.Module"),ed=o(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),td=l(),N=a("div"),_(Ct.$$.fragment),nd=l(),ve=a("p"),od=o("The "),wn=a("a"),sd=o("LukeForEntityClassification"),ad=o(" forward method, overrides the "),$o=a("code"),id=o("__call__"),rd=o(" special method."),dd=l(),_(Ne.$$.fragment),ld=l(),Fo=a("p"),cd=o("Examples:"),pd=l(),_(Pt.$$.fragment),ps=l(),be=a("h2"),De=a("a"),qo=a("span"),_(jt.$$.fragment),hd=l(),Mo=a("span"),ud=o("LukeForEntityPairClassification"),hs=l(),A=a("div"),_(At.$$.fragment),md=l(),Co=a("p"),fd=o(`The LUKE model with a classification head on top (a linear layer on top of the hidden states of the two entity
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),vd=l(),Ot=a("p"),bd=o("This model is also a PyTorch "),St=a("a"),Td=o("torch.nn.Module"),Ld=o(` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Vd=l(),W=a("div"),_(Ht.$$.fragment),Yd=l(),we=a("p"),Qd=o("The "),$n=a("a"),Jd=o("LukeForEntitySpanClassification"),Xd=o(" forward method, overrides the "),So=a("code"),Gd=o("__call__"),Zd=o(" special method."),el=l(),_(Be.$$.fragment),tl=l(),No=a("p"),nl=o("Examples:"),ol=l(),_(Vt.$$.fragment),this.h()},l(n){const p=ip('[data-svelte="svelte-1phssyn"]',document.head);h=i(p,"META",{name:!0,content:!0}),p.forEach(t),E=c(n),m=i(n,"H1",{class:!0});var Yt=r(m);L=i(Yt,"A",{id:!0,class:!0,href:!0});var Do=r(L);w=i(Do,"SPAN",{});var Wo=r(w);k(g.$$.fragment,Wo),Wo.forEach(t),Do.forEach(t),f=c(Yt),z=i(Yt,"SPAN",{});var Uo=r(z);Ds=s(Uo,"LUKE"),Uo.forEach(t),Yt.forEach(t),Ho=c(n),le=i(n,"H2",{class:!0});var Qt=r(le);xe=i(Qt,"A",{id:!0,class:!0,href:!0});var rl=r(xe);Nn=i(rl,"SPAN",{});var dl=r(Nn);k(He.$$.fragment,dl),dl.forEach(t),rl.forEach(t),Ws=c(Qt),Dn=i(Qt,"SPAN",{});var ll=r(Dn);Us=s(ll,"Overview"),ll.forEach(t),Qt.forEach(t),Vo=c(n),$e=i(n,"P",{});var gs=r($e);Bs=s(gs,"The LUKE model was proposed in "),Ve=i(gs,"A",{href:!0,rel:!0});var cl=r(Ve);Ks=s(cl,"LUKE: Deep Contextualized Entity Representations with Entity-aware Self-attention"),cl.forEach(t),Rs=s(gs,` by Ikuya Yamada, Akari Asai, Hiroyuki Shindo, Hideaki Takeda and Yuji Matsumoto.
It is based on RoBERTa and adds entity embeddings as well as an entity-aware self-attention mechanism, which helps
improve performance on various downstream tasks involving reasoning about entities such as named entity recognition,
...
`),en=i(Y,"A",{href:!0});var Tl=r(en);da=s(Tl,"LukeTokenizer"),Tl.forEach(t),la=s(Y,"."),Y.forEach(t),_l.forEach(t),ca=c(Ke),Qe=i(Ke,"LI",{});var ks=r(Qe);H=i(ks,"P",{});var Ee=r(H);tn=i(Ee,"A",{href:!0});var Ll=r(tn);pa=s(Ll,"LukeTokenizer"),Ll.forEach(t),ha=s(Ee," takes "),Yn=i(Ee,"CODE",{});var wl=r(Yn);ua=s(wl,"entities"),wl.forEach(t),ma=s(Ee," and "),Qn=i(Ee,"CODE",{});var El=r(Qn);fa=s(El,"entity_spans"),El.forEach(t),ga=s(Ee,` (character-based start and end
...
gathering the information about the entity from the input text. Therefore, the [MASK] entity can be used to address
downstream tasks requiring the information of entities in text such as entity typing, relation classification, and
named entity recognition.`),sl.forEach(t),Ta=c(ys),on=i(ys,"LI",{});var al=r(on);Gn=i(al,"EM",{});var $l=r(Gn);La=s($l,"Inputting Wikipedia entities to compute knowledge-enhanced token representations"),$l.forEach(t),wa=s(al,`: LUKE learns rich information
(or knowledge) about Wikipedia entities during pretraining and stores the information in its entity embedding. By
using Wikipedia entities as input tokens, LUKE outputs token representations enriched by the information stored in
the embeddings of these entities. This is particularly effective for tasks requiring real-world knowledge, such as
...
entity typing, e.g. the `),Xe=i(Bo,"A",{href:!0,rel:!0});var Ml=r(Xe);qa=s(Ml,"Open Entity dataset"),Ml.forEach(t),Ma=s(Bo,`.
This model places a linear head on top of the output entity representation.`),Bo.forEach(t),Ca=c(Fn),qe=i(Fn,"LI",{});var Ko=r(qe);an=i(Ko,"A",{href:!0});var Cl=r(an);Pa=s(Cl,"LukeForEntityPairClassification"),Cl.forEach(t),ja=s(Ko,`, for tasks to classify the relationship between two entities
...
head models by specifying `),to=i(Q,"CODE",{});var Ol=r(to);Ra=s(Ol,'task="entity_classification"'),Ol.forEach(t),Ha=s(Q,", "),no=i(Q,"CODE",{});var Sl=r(no);Va=s(Sl,'task="entity_pair_classification"'),Sl.forEach(t),Ya=s(Q,`, or
...
the HuggingFace implementation of LUKE. They can be found `),tt=i(vs,"A",{href:!0,rel:!0});var Ul=r(tt);ai=s(Ul,"here"),Ul.forEach(t),ii=s(vs,"."),vs.forEach(t),X.forEach(t),Ke.forEach(t),Go=c(n),pn=i(n,"P",{});var Bl=r(pn);ri=s(Bl,"Example:"),Bl.forEach(t),Zo=c(n),k(nt.$$.fragment,n),es=c(n),V=i(n,"P",{});var Re=r(V);di=s(Re,"This model was contributed by "),ot=i(Re,"A",{href:!0,rel:!0});var Kl=r(ot);li=s(Kl,"ikuyamada"),Kl.forEach(t),ci=s(Re," and "),st=i(Re,"A",{href:!0,rel:!0});var Rl=r(st);pi=s(Rl,"nielsr"),Rl.forEach(t),hi=s(Re,". The original code can be found "),at=i(Re,"A",{href:!0,rel:!0});var Hl=r(at);ui=s(Hl,"here"),Hl.forEach(t),mi=s(Re,"."),Re.forEach(t),ts=c(n),he=i(n,"H2",{class:!0});var bs=r(he);Me=i(bs,"A",{id:!0,class:!0,href:!0});var Vl=r(Me);so=i(Vl,"SPAN",{});var Yl=r(so);k(it.$$.fragment,Yl),Yl.forEach(t),Vl.forEach(t),fi=c(bs),ao=i(bs,"SPAN",{});var Ql=r(ao);gi=s(Ql,"LukeConfig"),Ql.forEach(t),bs.forEach(t),ns=c(n),q=i(n,"DIV",{class:!0});var G=r(q);k(rt.$$.fragment,G),_i=c(G),dt=i(G,"P",{});var Ts=r(dt);ki=s(Ts,"This is the configuration class to store the configuration of a "),hn=i(Ts,"A",{href:!0});var Jl=r(hn);yi=s(Jl,"LukeModel"),Jl.forEach(t),vi=s(Ts,`. It is used to instantiate a LUKE
model according to the specified arguments, defining the model architecture.`),Ts.forEach(t),bi=c(G),ue=i(G,"P",{});var Mn=r(ue);Ti=s(Mn,"Configuration objects inherit from "),un=i(Mn,"A",{href:!0});var Xl=r(un);Li=s(Xl,"PretrainedConfig"),Xl.forEach(t),wi=s(Mn,` and can be used to control the model outputs. Read the
documentation from `),mn=i(Mn,"A",{href:!0});var Gl=r(mn);Ei=s(Gl,"PretrainedConfig"),Gl.forEach(t),zi=s(Mn," for more information."),Mn.forEach(t),xi=c(G),io=i(G,"P",{});var Zl=r(io);$i=s(Zl,"Examples:"),Zl.forEach(t),Fi=c(G),k(lt.$$.fragment,G),G.forEach(t),os=c(n),me=i(n,"H2",{class:!0});var Ls=r(me);Ce=i(Ls,"A",{id:!0,class:!0,href:!0});var ec=r(Ce);ro=i(ec,"SPAN",{});var tc=r(ro);k(ct.$$.fragment,tc),tc.forEach(t),ec.forEach(t),qi=c(Ls),lo=i(Ls,"SPAN",{});var nc=r(lo);Mi=s(nc,"LukeTokenizer"),nc.forEach(t),Ls.forEach(t),ss=c(n),M=i(n,"DIV",{class:!0});var Z=r(M);k(pt.$$.fragment,Z),Ci=c(Z),co=i(Z,"P",{});var oc=r(co);Pi=s(oc,"Construct a LUKE tokenizer."),oc.forEach(t),ji=c(Z),x=i(Z,"P",{});var $=r(x);Ai=s($,"This tokenizer inherits from "),fn=i($,"A",{href:!0});var sc=r(fn);Ii=s(sc,"RobertaTokenizer"),sc.forEach(t),Oi=s($,` which contains most of the main methods. Users should refer to
...
also creates entity sequences, namely `),po=i($,"CODE",{});var rc=r(po);Ui=s(rc,"entity_ids"),rc.forEach(t),Bi=s($,", "),ho=i($,"CODE",{});var dc=r(ho);Ki=s(dc,"entity_attention_mask"),dc.forEach(t),Ri=s($,", "),uo=i($,"CODE",{});var lc=r(uo);Hi=s(lc,"entity_token_type_ids"),lc.forEach(t),Vi=s($,`, and
`),mo=i($,"CODE",{});var cc=r(mo);Yi=s(cc,"entity_position_ids"),cc.forEach(t),Qi=s($," to be used by the LUKE model."),$.forEach(t),Ji=c(Z),Pe=i(Z,"DIV",{class:!0});var ws=r(Pe);k(ht.$$.fragment,ws),Xi=c(ws),fo=i(ws,"P",{});var pc=r(fo);Gi=s(pc,`Main method to tokenize and prepare for the model one or several sequence(s) or one or several pair(s) of
sequences, depending on the task you want to prepare them for.`),pc.forEach(t),ws.forEach(t),Zi=c(Z),kn=i(Z,"DIV",{class:!0});var hc=r(kn);k(ut.$$.fragment,hc),hc.forEach(t),Z.forEach(t),as=c(n),fe=i(n,"H2",{class:!0});var Es=r(fe);je=i(Es,"A",{id:!0,class:!0,href:!0});var uc=r(je);go=i(uc,"SPAN",{});var mc=r(go);k(mt.$$.fragment,mc),mc.forEach(t),uc.forEach(t),er=c(Es),_o=i(Es,"SPAN",{});var fc=r(_o);tr=s(fc,"LukeModel"),fc.forEach(t),Es.forEach(t),is=c(n),C=i(n,"DIV",{class:!0});var ee=r(C);k(ft.$$.fragment,ee),nr=c(ee),ko=i(ee,"P",{});var gc=r(ko);or=s(gc,"The bare LUKE model transformer outputting raw hidden-states for both word tokens and entities without any specific head on top."),gc.forEach(t),sr=c(ee),gt=i(ee,"P",{});var zs=r(gt);ar=s(zs,"This model inherits from "),yn=i(zs,"A",{href:!0});var _c=r(yn);ir=s(_c,"PreTrainedModel"),_c.forEach(t),rr=s(zs,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
...
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),xs.forEach(t),hr=c(ee),S=i(ee,"DIV",{class:!0});var te=r(S);k(yt.$$.fragment,te),ur=c(te),ge=i(te,"P",{});var Cn=r(ge);mr=s(Cn,"The "),vn=i(Cn,"A",{href:!0});var yc=r(vn);fr=s(yc,"LukeModel"),yc.forEach(t),gr=s(Cn," forward method, overrides the "),yo=i(Cn,"CODE",{});var vc=r(yo);_r=s(vc,"__call__"),vc.forEach(t),kr=s(Cn," special method."),Cn.forEach(t),yr=c(te),k(Ae.$$.fragment,te),vr=c(te),vo=i(te,"P",{});var bc=r(vo);br=s(bc,"Examples:"),bc.forEach(t),Tr=c(te),k(vt.$$.fragment,te),te.forEach(t),ee.forEach(t),rs=c(n),_e=i(n,"H2",{class:!0});var $s=r(_e);Ie=i($s,"A",{id:!0,class:!0,href:!0});var Tc=r(Ie);bo=i(Tc,"SPAN",{});var Lc=r(bo);k(bt.$$.fragment,Lc),Lc.forEach(t),Tc.forEach(t),Lr=c($s),To=i($s,"SPAN",{});var wc=r(To);wr=s(wc,"LukeForMaskedLM"),wc.forEach(t),$s.forEach(t),ds=c(n),P=i(n,"DIV",{class:!0});var ne=r(P);k(Tt.$$.fragment,ne),Er=c(ne),Lo=i(ne,"P",{});var Ec=r(Lo);zr=s(Ec,`The LUKE model with a language modeling head and entity prediction head on top for masked language modeling and
masked entity prediction.`),Ec.forEach(t),xr=c(ne),Lt=i(ne,"P",{});var Fs=r(Lt);$r=s(Fs,"This model inherits from "),bn=i(Fs,"A",{href:!0});var zc=r(bn);Fr=s(zc,"PreTrainedModel"),zc.forEach(t),qr=s(Fs,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Fs.forEach(t),Mr=c(ne),wt=i(ne,"P",{});var qs=r(wt);Cr=s(qs,"This model is also a PyTorch "),Et=i(qs,"A",{href:!0,rel:!0});var xc=r(Et);Pr=s(xc,"torch.nn.Module"),xc.forEach(t),jr=s(qs,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),qs.forEach(t),Ar=c(ne),J=i(ne,"DIV",{class:!0});var Pn=r(J);k(zt.$$.fragment,Pn),Ir=c(Pn),ke=i(Pn,"P",{});var jn=r(ke);Or=s(jn,"The "),Tn=i(jn,"A",{href:!0});var $c=r(Tn);Sr=s($c,"LukeForMaskedLM"),$c.forEach(t),Nr=s(jn," forward method, overrides the "),wo=i(jn,"CODE",{});var Fc=r(wo);Dr=s(Fc,"__call__"),Fc.forEach(t),Wr=s(jn," special method."),jn.forEach(t),Ur=c(Pn),k(Oe.$$.fragment,Pn),Pn.forEach(t),ne.forEach(t),ls=c(n),ye=i(n,"H2",{class:!0});var Ms=r(ye);Se=i(Ms,"A",{id:!0,class:!0,href:!0});var qc=r(Se);Eo=i(qc,"SPAN",{});var Mc=r(Eo);k(xt.$$.fragment,Mc),Mc.forEach(t),qc.forEach(t),Br=c(Ms),zo=i(Ms,"SPAN",{});var Cc=r(zo);Kr=s(Cc,"LukeForEntityClassification"),Cc.forEach(t),Ms.forEach(t),cs=c(n),j=i(n,"DIV",{class:!0});var oe=r(j);k($t.$$.fragment,oe),Rr=c(oe),xo=i(oe,"P",{});var Pc=r(xo);Hr=s(Pc,`The LUKE model with a classification head on top (a linear layer on top of the hidden state of the first entity
token) for entity classification tasks, such as Open Entity.`),Pc.forEach(t),Vr=c(oe),Ft=i(oe,"P",{});var Cs=r(Ft);Yr=s(Cs,"This model inherits from "),Ln=i(Cs,"A",{href:!0});var jc=r(Ln);Qr=s(jc,"PreTrainedModel"),jc.forEach(t),Jr=s(Cs,`. Check the superclass documentation for the generic methods the
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),Cs.forEach(t),Xr=c(oe),qt=i(oe,"P",{});var Ps=r(qt);Gr=s(Ps,"This model is also a PyTorch "),Mt=i(Ps,"A",{href:!0,rel:!0});var Ac=r(Mt);Zr=s(Ac,"torch.nn.Module"),Ac.forEach(t),ed=s(Ps,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Ps.forEach(t),td=c(oe),N=i(oe,"DIV",{class:!0});var se=r(N);k(Ct.$$.fragment,se),nd=c(se),ve=i(se,"P",{});var An=r(ve);od=s(An,"The "),wn=i(An,"A",{href:!0});var Ic=r(wn);sd=s(Ic,"LukeForEntityClassification"),Ic.forEach(t),ad=s(An," forward method, overrides the "),$o=i(An,"CODE",{});var Oc=r($o);id=s(Oc,"__call__"),Oc.forEach(t),rd=s(An," special method."),An.forEach(t),dd=c(se),k(Ne.$$.fragment,se),ld=c(se),Fo=i(se,"P",{});var Sc=r(Fo);cd=s(Sc,"Examples:"),Sc.forEach(t),pd=c(se),k(Pt.$$.fragment,se),se.forEach(t),oe.forEach(t),ps=c(n),be=i(n,"H2",{class:!0});var js=r(be);De=i(js,"A",{id:!0,class:!0,href:!0});var Nc=r(De);qo=i(Nc,"SPAN",{});var Dc=r(qo);k(jt.$$.fragment,Dc),Dc.forEach(t),Nc.forEach(t),hd=c(js),Mo=i(js,"SPAN",{});var Wc=r(Mo);ud=s(Wc,"LukeForEntityPairClassification"),Wc.forEach(t),js.forEach(t),hs=c(n),A=i(n,"DIV",{class:!0});var ae=r(A);k(At.$$.fragment,ae),md=c(ae),Co=i(ae,"P",{});var Uc=r(Co);fd=s(Uc,`The LUKE model with a classification head on top (a linear layer on top of the hidden states of the two entity
...
library implements for all its model (such as downloading or saving, resizing the input embeddings, pruning heads
etc.)`),As.forEach(t),vd=c(ae),Ot=i(ae,"P",{});var Is=r(Ot);bd=s(Is,"This model is also a PyTorch "),St=i(Is,"A",{href:!0,rel:!0});var Kc=r(St);Td=s(Kc,"torch.nn.Module"),Kc.forEach(t),Ld=s(Is,` subclass.
Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage
and behavior.`),Is.forEach(t),wd=c(ae),D=i(ae,"DIV",{class:!0});var ie=r(D);k(Nt.$$.fragment,ie),Ed=c(ie),Te=i(ie,"P",{});var In=r(Te);zd=s(In,"The "),zn=i(In,"A",{href:!0});var Rc=r(zn);xd=s(Rc,"LukeForEntityPairClassification"),Rc.forEach(t),$d=s(In," forward method, overrides the "),Po=i(In,"CODE",{});var Hc=r(Po);Fd=s(Hc,"__call__"),Hc.forEach(t),qd=s(In," special method."),In.forEach(t),Md=c(ie),k(We.$$.fragment,ie),Cd=c(ie),jo=i(ie,"P",{});var Vc=r(jo);Pd=s(Vc,"Examples:"),Vc.forEach(t),jd=c(ie),k(Dt.$$.fragment,ie),ie.forEach(t),ae.forEach(t),us=c(n),Le=i(n,"H2",{class:!0});var Os=r(Le);Ue=i(Os,"A",{id:!0,class:!0,href:!0});var Yc=r(Ue);Ao=i(Yc,"SPAN",{});var Qc=r(Ao);k(Wt.$$.fragment,Qc),Qc.forEach(t),Yc.forEach(t),Ad=c(Os),Io=i(Os,"SPAN",{});var Jc=r(Io);Id=s(Jc,"LukeForEntitySpanClassification"),Jc.forEach(t),Os.forEach(t),ms=c(n),I=i(n,"DIV",{class:!0});var re=r(I);k(Ut.$$.fragment,re),Od=c(re),Oo=i(re,"P",{});var Xc=r(Oo);Sd=s(Xc,`The LUKE model with a span classification head on top (a linear layer on top of the hidden states output) for tasks
