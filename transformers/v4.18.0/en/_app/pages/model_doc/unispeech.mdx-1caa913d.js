...
instance of <a href="/docs/transformers/v4.18.0/en/model_doc/unispeech#transformers.UniSpeechForCTC">UniSpeechForCTC</a>.`,name:"ctc_loss_reduction"},{anchor:"transformers.UniSpeechConfig.ctc_zero_infinity",description:`<strong>ctc_zero_infinity</strong> (<code>bool</code>, <em>optional</em>, defaults to <code>False</code>) &#x2014;
Whether to zero infinite losses and the associated gradients of <code>torch.nn.CTCLoss</code>. Infinite losses mainly
occur when the inputs are too short to be aligned to the targets. Only relevant when training an instance
of <a href="/docs/transformers/v4.18.0/en/model_doc/unispeech#transformers.UniSpeechForCTC">UniSpeechForCTC</a>.`,name:"ctc_zero_infinity"},{anchor:"transformers.UniSpeechConfig.use_weighted_layer_sum",description:`<strong>use_weighted_layer_sum</strong> (<code>bool</code>, <em>optional</em>, defaults to <code>False</code>) &#x2014;
...
Whether or not to return a <a href="/docs/transformers/v4.18.0/en/main_classes/output#transformers.utils.ModelOutput">ModelOutput</a> instead of a plain tuple.`,name:"return_dict"}],source:"https://github.com/huggingface/transformers/blob/v4.18.0/src/transformers/models/unispeech/modeling_unispeech.py#L1152",returnDescription:`
<p>A <a
  href="/docs/transformers/v4.18.0/en/model_doc/unispeech#transformers.models.unispeech.modeling_unispeech.UniSpeechBaseModelOutput"
...
elements depending on the configuration (<a
  href="/docs/transformers/v4.18.0/en/model_doc/unispeech#transformers.UniSpeechConfig"
...
All labels set to <code>-100</code> are ignored (masked), the loss is only computed for labels in <code>[0, ..., config.vocab_size - 1]</code>.`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.18.0/src/transformers/models/unispeech/modeling_unispeech.py#L1404",returnDescription:`
<p>A <a
...
<code>config.num_labels &gt; 1</code> a classification loss is computed (Cross-Entropy).`,name:"labels"}],source:"https://github.com/huggingface/transformers/blob/v4.18.0/src/transformers/models/unispeech/modeling_unispeech.py#L1539",returnDescription:`
<p>A <a
...
Required input for pre-training.`,name:"sampled_negative_indices"}],source:"https://github.com/huggingface/transformers/blob/v4.18.0/src/transformers/models/unispeech/modeling_unispeech.py#L1273",returnDescription:`
<p>A <a
  href="/docs/transformers/v4.18.0/en/model_doc/unispeech#transformers.models.unispeech.modeling_unispeech.UniSpeechForPreTrainingOutput"
...
`}}),Ue=new Sn({props:{$$slots:{default:[vi]},$$scope:{ctx:k}}}),ke=new Ut({props:{anchor:"transformers.UniSpeechForPreTraining.forward.example",$$slots:{default:[bi]},$$scope:{ctx:k}}}),{c(){c=n("meta"),v=h(),p=n("h1"),u=n("a"),b=n("span"),w(l.$$.fragment),g=h(),C=n("span"),$n=r("UniSpeech"),Fo=h(),H=n("h2"),ie=n("a"),Jt=n("span"),w(qe.$$.fragment),Tn=h(),Gt=n("span"),Un=r("Overview"),qo=h(),le=n("p"),kn=r("The UniSpeech model was proposed in "),Pe=n("a"),Cn=r("UniSpeech: Unified Speech Representation Learning with Labeled and Unlabeled Data"),xn=r(` by Chengyi Wang, Yu Wu, Yao Qian, Kenichi Kumatani, Shujie Liu, Furu Wei, Michael
...
`),We=n("a"),Xn=r("facebook/unispeech-base-960h"),Zn=r(" architecture."),Jn=h(),R=n("p"),Gn=r("Configuration objects inherit from "),Mt=n("a"),ea=r("PretrainedConfig"),ta=r(` and can be used to control the model outputs. Read the
documentation from `),zt=n("a"),oa=r("PretrainedConfig"),na=r(" for more information."),aa=h(),w(pe.$$.fragment),Wo=h(),Q=n("h2"),he=n("a"),no=n("span"),w(Le.$$.fragment),sa=h(),ao=n("span"),ra=r("UniSpeech specific outputs"),Lo=h(),X=n("div"),w(Ne.$$.fragment),ia=h(),Ve=n("p"),la=r("Output type of "),so=n("code"),ca=r("UniSpeechBaseModelOutput"),da=r(", with potential hidden states and attentions."),No=h(),Z=n("div"),w(Ie.$$.fragment),pa=h(),Be=n("p"),ha=r("Output type of "),ro=n("code"),ma=r("UniSpeechForPreTrainingOutput"),ua=r(", with potential hidden states and attentions."),Vo=h(),J=n("h2"),me=n("a"),io=n("span"),w(He.$$.fragment),fa=h(),lo=n("span"),ga=r("UniSpeechModel"),Io=h(),j=n("div"),w(Ke.$$.fragment),_a=h(),Ye=n("p"),va=r(`The bare UniSpeech Model transformer outputting raw hidden-states without any specific head on top.
...
behavior.`),ja=h(),z=n("div"),w(Je.$$.fragment),Fa=h(),G=n("p"),qa=r("The "),Dt=n("a"),Pa=r("UniSpeechModel"),Ea=r(" forward method, overrides the "),co=n("code"),Ma=r("__call__"),za=r(" special method."),Oa=h(),w(ue.$$.fragment),Da=h(),w(fe.$$.fragment),Bo=h(),ee=n("h2"),ge=n("a"),po=n("span"),w(Ge.$$.fragment),Aa=h(),ho=n("span"),Wa=r("UniSpeechForCTC"),Ho=h(),F=n("div"),w(et.$$.fragment),La=h(),te=n("p"),Na=r("UniSpeech Model with a "),mo=n("code"),Va=r("language modeling"),Ia=r(` head on top for Connectionist Temporal Classification (CTC).
...
library implements for all its model (such as downloading or saving etc.).`),Xa=h(),nt=n("p"),Za=r("This model is a PyTorch "),at=n("a"),Ja=r("torch.nn.Module"),Ga=r(` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
...
recognition by a maximum of 13.4% and 17.8% relative phone error rate reductions respectively (averaged over all
testing languages). The transferability of UniSpeech is also demonstrated on a domain-shift speech recognition task,
i.e., a relative word error rate reduction of 6% against the previous approach.`),rr.forEach(o),sr.forEach(o),Mo=m(t),Ft=a(t,"P",{});var ir=s(Ft);qn=i(ir,"Tips:"),ir.forEach(o),zo=m(t),ce=a(t,"UL",{});var Zo=s(ce);Ee=a(Zo,"LI",{});var Jo=s(Ee);Pn=i(Jo,`UniSpeech is a speech model that accepts a float array corresponding to the raw waveform of the speech signal. Please
use `),qt=a(Jo,"A",{href:!0});var lr=s(qt);En=i(lr,"Wav2Vec2Processor"),lr.forEach(o),Mn=i(Jo," for the feature extraction."),Jo.forEach(o),zn=m(Zo),Me=a(Zo,"LI",{});var Go=s(Me);On=i(Go,`UniSpeech model can be fine-tuned using connectionist temporal classification (CTC) so the model output has to be
decoded using `),Pt=a(Go,"A",{href:!0});var cr=s(Pt);Dn=i(cr,"Wav2Vec2CTCTokenizer"),cr.forEach(o),An=i(Go,"."),Go.forEach(o),Zo.forEach(o),Oo=m(t),W=a(t,"P",{});var Bt=s(W);Wn=i(Bt,"This model was contributed by "),ze=a(Bt,"A",{href:!0,rel:!0});var dr=s(ze);Ln=i(dr,"patrickvonplaten"),dr.forEach(o),Nn=i(Bt,`. The Authors\u2019 code can be
...
library implements for all its model (such as downloading or saving etc.).`),hn.forEach(o),Xa=m(N),nt=a(N,"P",{});var mn=s(nt);Za=i(mn,"This model is a PyTorch "),at=a(mn,"A",{href:!0,rel:!0});var Ar=s(at);Ja=i(Ar,"torch.nn.Module"),Ar.forEach(o),Ga=i(mn,` sub-class. Use
it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to general usage and
