...
![data types](/docs/transformers/v4.14.1/en/imgs/tf32-bf16-fp16-fp32.png)
...
![MoE Transformer 2x block](/docs/transformers/v4.14.1/en/imgs/perf-moe-transformer.png)
