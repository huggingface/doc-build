import{S as ir,i as cr,s as hr,e as r,k as i,w as j,t as n,M as dr,c as o,d as s,m as c,a as p,x as _,h as t,b as E,F as a,g as u,y as v,q as y,o as g,B as $}from"../chunks/vendor-ab4e3193.js";import{T as Vt}from"../chunks/Tip-b5c6375a.js";import{I as Xt}from"../chunks/IconCopyLink-d992940d.js";import{C as F}from"../chunks/CodeBlock-516df0c5.js";import"../chunks/CopyButton-204b56db.js";function fr(I){let h,w;return{c(){h=r("p"),w=n("This feature is currently available for PyTorch-only.")},l(d){h=o(d,"P",{});var f=p(h);w=t(f,"This feature is currently available for PyTorch-only."),f.forEach(s)},m(d,f){u(d,h,f),a(h,w)},d(d){d&&s(h)}}}function mr(I){let h,w,d,f,x;return{c(){h=r("p"),w=n("For multi-GPU training it requires DDP ("),d=r("code"),f=n("torch.distributed.launch"),x=n(").")},l(b){h=o(b,"P",{});var D=p(h);w=t(D,"For multi-GPU training it requires DDP ("),d=o(D,"CODE",{});var N=p(d);f=t(N,"torch.distributed.launch"),N.forEach(s),x=t(D,")."),D.forEach(s)},m(b,D){u(b,h,D),a(h,w),a(h,d),a(d,f),a(h,x)},d(b){b&&s(h)}}}function br(I){let h,w,d,f,x;return{c(){h=r("p"),w=n("This feature can be used with any "),d=r("code"),f=n("nn.Module"),x=n("-based model.")},l(b){h=o(b,"P",{});var D=p(h);w=t(D,"This feature can be used with any "),d=o(D,"CODE",{});var N=p(d);f=t(N,"nn.Module"),N.forEach(s),x=t(D,"-based model."),D.forEach(s)},m(b,D){u(b,h,D),a(h,w),a(h,d),a(d,f),a(h,x)},d(b){b&&s(h)}}}function wr(I){let h,w,d,f,x,b,D,N,Ga,Ss,q,Y,Me,re,Ua,He,Ia,Rs,K,Fs,z,Ns,B,Gs,C,qa,Ye,Ma,Ha,Ke,Ya,Ka,ze,za,Ba,Us,W,Wa,ge,Ja,Qa,Is,oe,qs,G,Va,Be,Xa,Za,$e,en,sn,Ms,De,an,Hs,pe,Ys,T,Ee,nn,tn,We,ln,rn,Je,on,pn,Qe,un,cn,Ks,ue,zs,ke,hn,Bs,m,dn,Ve,fn,mn,Xe,bn,wn,Ze,jn,_n,es,vn,yn,ss,gn,$n,as,Dn,En,ns,kn,On,Ws,J,xn,ts,Tn,Cn,Js,Oe,Pn,Qs,ie,Vs,xe,Ln,Xs,P,An,ls,Sn,Rn,rs,Fn,Nn,os,Gn,Un,Zs,Te,In,ea,ce,sa,k,qn,ps,Mn,Hn,us,Yn,Kn,is,zn,Bn,cs,Wn,Jn,hs,Qn,Vn,aa,L,Xn,ds,Zn,et,fs,st,at,ms,nt,tt,na,Ce,lt,ta,Q,rt,bs,ot,pt,la,he,ra,V,ut,ws,it,ct,oa,X,ht,js,dt,ft,pa,A,mt,_s,bt,wt,vs,jt,_t,ys,vt,yt,ua,de,ia,U,gt,gs,$t,Dt,$s,Et,kt,ca,fe,ha,S,Ot,Ds,xt,Tt,Es,Ct,Pt,ks,Lt,At,da,Pe,St,fa,Le,Rt,ma,me,ba,M,Z,Os,be,Ft,xs,Nt,wa,Ae,Gt,ja,ee,Ut,Ts,It,qt,_a,we,va,Se,Mt,ya,Re,Ht,ga,Fe,Yt,$a,je,Da,Ne,Kt,Ea,_e,Cs,Ps,zt,Bt,ka,Ge,Wt,Oa,Ue,Jt,xa,ve,Ta;return b=new Xt({}),re=new Xt({}),K=new Vt({props:{$$slots:{default:[fr]},$$scope:{ctx:I}}}),z=new Vt({props:{$$slots:{default:[mr]},$$scope:{ctx:I}}}),B=new Vt({props:{$$slots:{default:[br]},$$scope:{ctx:I}}}),oe=new F({props:{code:"--debug underflow_overflow,",highlighted:"--debug underflow_overflow"}}),pe=new F({props:{code:`from .debug_utils import DebugUnderflowOverflow
...
you can accomplish that easily by activating a special module that will do the detection automatically.`),Us=i(),W=r("p"),Wa=n("If you\u2019re using "),ge=r("a"),Ja=n("Trainer"),Qa=n(", you just need to add:"),Is=i(),j(oe.$$.fragment),qs=i(),G=r("p"),Va=n("to the normal command line arguments, or pass "),Be=r("code"),Xa=n('debug="underflow_overflow"'),Za=n(` when creating the
...
forward call will test input and output variables and also the corresponding module\u2019s weights. As soon as `),We=r("code"),ln=n("inf"),rn=n(` or
`),Je=r("code"),on=n("nan"),pn=n(` is detected in at least one element of the activations or weights, the program will assert and print a report
...
large activations is going to lead to a numerical overflow condition.`),Ws=i(),J=r("p"),xn=n("At the very start of the trace you can discover at which batch number the problem occurred (here "),ts=r("code"),Tn=n("Detected inf/nan during batch_number=0"),Cn=n(" means the problem occurred on the first batch)."),Js=i(),Oe=r("p"),Pn=n(`Each reported frame starts by declaring the fully qualified entry for the corresponding module this frame is reporting
...
input elements was `),cs=r("code"),Wn=n("6.27e+04"),Jn=n(" and same for the output was "),hs=r("code"),Qn=n("inf"),Vn=n("."),aa=i(),L=r("p"),Xn=n("You can see here, that "),ds=r("code"),Zn=n("T5DenseGatedGeluDense.forward"),et=n(` resulted in output activations, whose absolute max value was
...
forward call will test input and output variables and also the corresponding module\u2019s weights. As soon as `),We=o(H,"CODE",{});var cl=p(We);ln=t(cl,"inf"),cl.forEach(s),rn=t(H,` or
`),Je=o(H,"CODE",{});var hl=p(Je);on=t(hl,"nan"),hl.forEach(s),pn=t(H,` is detected in at least one element of the activations or weights, the program will assert and print a report
...
large activations is going to lead to a numerical overflow condition.`),O.forEach(s),Ws=c(e),J=o(e,"P",{});var La=p(J);xn=t(La,"At the very start of the trace you can discover at which batch number the problem occurred (here "),ts=o(La,"CODE",{});var gl=p(ts);Tn=t(gl,"Detected inf/nan during batch_number=0"),gl.forEach(s),Cn=t(La," means the problem occurred on the first batch)."),La.forEach(s),Js=c(e),Oe=o(e,"P",{});var $l=p(Oe);Pn=t($l,`Each reported frame starts by declaring the fully qualified entry for the corresponding module this frame is reporting
...
`),$s=o(qe,"CODE",{});var Kl=p($s);Et=t(Kl,"detect_overflow"),Kl.forEach(s),kt=t(qe," helper function to inject the detector where you want it, for example:"),qe.forEach(s),ca=c(e),_(fe.$$.fragment,e),ha=c(e),S=o(e,"P",{});var le=p(S);Ot=t(le,"You can see that we added 2 of these and now we track if "),Ds=o(le,"CODE",{});var zl=p(Ds);xt=t(zl,"inf"),zl.forEach(s),Tt=t(le," or "),Es=o(le,"CODE",{});var Bl=p(Es);Ct=t(Bl,"nan"),Bl.forEach(s),Pt=t(le," for "),ks=o(le,"CODE",{});var Wl=p(ks);Lt=t(Wl,"forwarded_states"),Wl.forEach(s),At=t(le,` was detected
somewhere in between.`),le.forEach(s),da=c(e),Pe=o(e,"P",{});var Jl=p(Pe);St=t(Jl,"Actually, the detector already reports these because each of the calls in the example above is a `nn.Module\u201C, but\nlet\u2019s say if you had some local direct calculations this is how you\u2019d do that."),Jl.forEach(s),fa=c(e),Le=o(e,"P",{});var Ql=p(Le);Rt=t(Ql,`Additionally, if you\u2019re instantiating the debugger in your own code, you can adjust the number of frames printed from
...
0.00e+00 2.78e+04 input[0]
5.36e-05 7.92e+02 output
[\u2026]`),Qt.forEach(s),ka=c(e),Ge=o(e,"P",{});var pr=p(Ge);Wt=t(pr,`Here you will get a huge number of frames dumped - as many as there were forward calls in your model, so it may or may
not what you want, but sometimes it can be easier to use for debugging purposes than a normal debugger. For example, if
a problem starts happening at batch number 150. So you can dump traces for batches 149 and 150 and compare where
numbers started to diverge.`),pr.forEach(s),Oa=c(e),Ue=o(e,"P",{});var ur=p(Ue);Jt=t(ur,"You can also specify the batch number after which to stop the training, with:"),ur.forEach(s),xa=c(e),_(ve.$$.fragment,e),this.h()},h(){E(h,"name","hf:doc:metadata"),E(h,"content",JSON.stringify(jr)),E(f,"id","debugging"),E(f,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),E(f,"href","#debugging"),E(d,"class","relative group"),E(Y,"id","underflow-and-overflow-detection"),E(Y,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),E(Y,"href","#underflow-and-overflow-detection"),E(q,"class","relative group"),E(ge,"href","/docs/transformers/v4.14.1/en/main_classes/trainer#transformers.Trainer"),E($e,"href","/docs/transformers/v4.14.1/en/main_classes/trainer#transformers.TrainingArguments"),E(Ee,"href","/docs/transformers/v4.14.1/en/internal/trainer_utils#transformers.debug_utils.DebugUnderflowOverflow"),E(Z,"id","specific-batch-absolute-mix-and-max-value-tracing"),E(Z,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),E(Z,"href","#specific-batch-absolute-mix-and-max-value-tracing"),E(M,"class","relative group")},m(e,l){a(document.head,h),u(e,w,l),u(e,d,l),a(d,f),a(f,x),v(b,x,null),a(d,D),a(d,N),a(N,Ga),u(e,Ss,l),u(e,q,l),a(q,Y),a(Y,Me),v(re,Me,null),a(q,Ua),a(q,He),a(He,Ia),u(e,Rs,l),v(K,e,l),u(e,Fs,l),v(z,e,l),u(e,Ns,l),v(B,e,l),u(e,Gs,l),u(e,C,l),a(C,qa),a(C,Ye),a(Ye,Ma),a(C,Ha),a(C,Ke),a(Ke,Ya),a(C,Ka),a(C,ze),a(ze,za),a(C,Ba),u(e,Us,l),u(e,W,l),a(W,Wa),a(W,ge),a(ge,Ja),a(W,Qa),u(e,Is,l),v(oe,e,l),u(e,qs,l),u(e,G,l),a(G,Va),a(G,Be),a(Be,Xa),a(G,Za),a(G,$e),a($e,en),a(G,sn),u(e,Ms,l),u(e,De,l),a(De,an),u(e,Hs,l),v(pe,e,l),u(e,Ys,l),u(e,T,l),a(T,Ee),a(Ee,nn),a(T,tn),a(T,We),a(We,ln),a(T,rn),a(T,Je),a(Je,on),a(T,pn),a(T,Qe),a(Qe,un),a(T,cn),u(e,Ks,l),v(ue,e,l),u(e,zs,l),u(e,ke,l),a(ke,hn),u(e,Bs,l),u(e,m,l),a(m,dn),a(m,Ve),a(Ve,fn),a(m,mn),a(m,Xe),a(Xe,bn),a(m,wn),a(m,Ze),a(Ze,jn),a(m,_n),a(m,es),a(es,vn),a(m,yn),a(m,ss),a(ss,gn),a(m,$n),a(m,as),a(as,Dn),a(m,En),a(m,ns),a(ns,kn),a(m,On),u(e,Ws,l),u(e,J,l),a(J,xn),a(J,ts),a(ts,Tn),a(J,Cn),u(e,Js,l),u(e,Oe,l),a(Oe,Pn),u(e,Qs,l),v(ie,e,l),u(e,Vs,l),u(e,xe,l),a(xe,Ln),u(e,Xs,l),u(e,P,l),a(P,An),a(P,ls),a(ls,Sn),a(P,Rn),a(P,rs),a(rs,Fn),a(P,Nn),a(P,os),a(os,Gn),a(P,Un),u(e,Zs,l),u(e,Te,l),a(Te,In),u(e,ea,l),v(ce,e,l),u(e,sa,l),u(e,k,l),a(k,qn),a(k,ps),a(ps,Mn),a(k,Hn),a(k,us),a(us,Yn),a(k,Kn),a(k,is),a(is,zn),a(k,Bn),a(k,cs),a(cs,Wn),a(k,Jn),a(k,hs),a(hs,Qn),a(k,Vn),u(e,aa,l),u(e,L,l),a(L,Xn),a(L,ds),a(ds,Zn),a(L,et),a(L,fs),a(fs,st),a(L,at),a(L,ms),a(ms,nt),a(L,tt),u(e,na,l),u(e,Ce,l),a(Ce,lt),u(e,ta,l),u(e,Q,l),a(Q,rt),a(Q,bs),a(bs,ot),a(Q,pt),u(e,la,l),v(he,e,l),u(e,ra,l),u(e,V,l),a(V,ut),a(V,ws),a(ws,it),a(V,ct),u(e,oa,l),u(e,X,l),a(X,ht),a(X,js),a(js,dt),a(X,ft),u(e,pa,l),u(e,A,l),a(A,mt),a(A,_s),a(_s,bt),a(A,wt),a(A,vs),a(vs,jt),a(A,_t),a(A,ys),a(ys,vt),a(A,yt),u(e,ua,l),v(de,e,l),u(e,ia,l),u(e,U,l),a(U,gt),a(U,gs),a(gs,$t),a(U,Dt),a(U,$s),a($s,Et),a(U,kt),u(e,ca,l),v(fe,e,l),u(e,ha,l),u(e,S,l),a(S,Ot),a(S,Ds),a(Ds,xt),a(S,Tt),a(S,Es),a(Es,Ct),a(S,Pt),a(S,ks),a(ks,Lt),a(S,At),u(e,da,l),u(e,Pe,l),a(Pe,St),u(e,fa,l),u(e,Le,l),a(Le,Rt),u(e,ma,l),v(me,e,l),u(e,ba,l),u(e,M,l),a(M,Z),a(Z,Os),v(be,Os,null),a(M,Ft),a(M,xs),a(xs,Nt),u(e,wa,l),u(e,Ae,l),a(Ae,Gt),u(e,ja,l),u(e,ee,l),a(ee,Ut),a(ee,Ts),a(Ts,It),a(ee,qt),u(e,_a,l),v(we,e,l),u(e,va,l),u(e,Se,l),a(Se,Mt),u(e,ya,l),u(e,Re,l),a(Re,Ht),u(e,ga,l),u(e,Fe,l),a(Fe,Yt),u(e,$a,l),v(je,e,l),u(e,Da,l),u(e,Ne,l),a(Ne,Kt),u(e,Ea,l),u(e,_e,l),a(_e,Cs),a(Cs,Ps),a(Ps,zt),a(_e,Bt),u(e,ka,l),u(e,Ge,l),a(Ge,Wt),u(e,Oa,l),u(e,Ue,l),a(Ue,Jt),u(e,xa,l),v(ve,e,l),Ta=!0},p(e,[l]){const ye={};l&2&&(ye.$$scope={dirty:l,ctx:e}),K.$set(ye);const Ls={};l&2&&(Ls.$$scope={dirty:l,ctx:e}),z.$set(Ls);const As={};l&2&&(As.$$scope={dirty:l,ctx:e}),B.$set(As)},i(e){Ta||(y(b.$$.fragment,e),y(re.$$.fragment,e),y(K.$$.fragment,e),y(z.$$.fragment,e),y(B.$$.fragment,e),y(oe.$$.fragment,e),y(pe.$$.fragment,e),y(ue.$$.fragment,e),y(ie.$$.fragment,e),y(ce.$$.fragment,e),y(he.$$.fragment,e),y(de.$$.fragment,e),y(fe.$$.fragment,e),y(me.$$.fragment,e),y(be.$$.fragment,e),y(we.$$.fragment,e),y(je.$$.fragment,e),y(ve.$$.fragment,e),Ta=!0)},o(e){g(b.$$.fragment,e),g(re.$$.fragment,e),g(K.$$.fragment,e),g(z.$$.fragment,e),g(B.$$.fragment,e),g(oe.$$.fragment,e),g(pe.$$.fragment,e),g(ue.$$.fragment,e),g(ie.$$.fragment,e),g(ce.$$.fragment,e),g(he.$$.fragment,e),g(de.$$.fragment,e),g(fe.$$.fragment,e),g(me.$$.fragment,e),g(be.$$.fragment,e),g(we.$$.fragment,e),g(je.$$.fragment,e),g(ve.$$.fragment,e),Ta=!1},d(e){s(h),e&&s(w),e&&s(d),$(b),e&&s(Ss),e&&s(q),$(re),e&&s(Rs),$(K,e),e&&s(Fs),$(z,e),e&&s(Ns),$(B,e),e&&s(Gs),e&&s(C),e&&s(Us),e&&s(W),e&&s(Is),$(oe,e),e&&s(qs),e&&s(G),e&&s(Ms),e&&s(De),e&&s(Hs),$(pe,e),e&&s(Ys),e&&s(T),e&&s(Ks),$(ue,e),e&&s(zs),e&&s(ke),e&&s(Bs),e&&s(m),e&&s(Ws),e&&s(J),e&&s(Js),e&&s(Oe),e&&s(Qs),$(ie,e),e&&s(Vs),e&&s(xe),e&&s(Xs),e&&s(P),e&&s(Zs),e&&s(Te),e&&s(ea),$(ce,e),e&&s(sa),e&&s(k),e&&s(aa),e&&s(L),e&&s(na),e&&s(Ce),e&&s(ta),e&&s(Q),e&&s(la),$(he,e),e&&s(ra),e&&s(V),e&&s(oa),e&&s(X),e&&s(pa),e&&s(A),e&&s(ua),$(de,e),e&&s(ia),e&&s(U),e&&s(ca),$(fe,e),e&&s(ha),e&&s(S),e&&s(da),e&&s(Pe),e&&s(fa),e&&s(Le),e&&s(ma),$(me,e),e&&s(ba),e&&s(M),$(be),e&&s(wa),e&&s(Ae),e&&s(ja),e&&s(ee),e&&s(_a),$(we,e),e&&s(va),e&&s(Se),e&&s(ya),e&&s(Re),e&&s(ga),e&&s(Fe),e&&s($a),$(je,e),e&&s(Da),e&&s(Ne),e&&s(Ea),e&&s(_e),e&&s(ka),e&&s(Ge),e&&s(Oa),e&&s(Ue),e&&s(xa),$(ve,e)}}}const jr={local:"debugging",sections:[{local:"underflow-and-overflow-detection",sections:[{local:"specific-batch-absolute-mix-and-max-value-tracing",title:"Specific batch absolute mix and max value tracing"}],title:"Underflow and Overflow Detection"}],title:"Debugging"};function _r(I,h,w){let{fw:d}=h;return I.$$set=f=>{"fw"in f&&w(0,d=f.fw)},[d]}class Er extends ir{constructor(h){super();cr(this,h,_r,wr,hr,{fw:0})}}export{Er as default,jr as metadata};
