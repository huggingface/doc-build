import{S as Xf,i as Zf,s as Qf,e as l,k as p,w as h,t as r,M as Vf,c as i,d as t,m,a as f,x as u,h as o,b as d,F as a,g as n,y as c,L as ep,q as _,o as w,B as v}from"../chunks/vendor-ab4e3193.js";import{Y as Zr}from"../chunks/Youtube-19eb1a09.js";import{I as aa}from"../chunks/IconCopyLink-d992940d.js";import{C as y}from"../chunks/CodeBlock-516df0c5.js";import{C as tp}from"../chunks/ColabDropdown-ee6d20de.js";import"../chunks/CopyButton-204b56db.js";function ap(Qr){let x,ot,g,P,sa,_e,Vr,ra,eo,Ja,we,Xa,z,to,oa,ao,so,nt,ro,oo,Za,F,no,ve,lo,io,lt,fo,po,Qa,it,Va,N,H,na,ye,mo,la,ho,es,be,ts,k,uo,$e,co,_o,ge,wo,vo,ft,yo,bo,as,K,$o,ia,go,ko,ss,ke,rs,C,Eo,fa,To,jo,pa,Ao,Po,os,b,qo,ma,xo,zo,da,Fo,Co,ha,Do,So,ua,Io,Mo,ca,No,Oo,_a,Lo,Wo,ns,pt,Bo,ls,Ee,is,G,Ho,mt,Ko,Go,fs,Te,ps,dt,Uo,ms,U,Yo,wa,Ro,Jo,ds,je,hs,Y,Xo,Ae,Zo,Qo,us,ht,Vo,cs,Pe,_s,E,en,va,tn,an,ya,sn,rn,ba,on,nn,ws,ut,vs,O,R,$a,qe,ln,ga,fn,ys,xe,bs,J,pn,ct,mn,dn,$s,_t,hn,gs,ze,ks,wt,un,Es,T,cn,vt,_n,wn,yt,vn,yn,bt,bn,$n,Ts,Fe,js,X,gn,$t,kn,En,As,Ce,Ps,gt,Tn,qs,De,xs,Z,jn,kt,An,Pn,zs,j,qn,Et,xn,zn,ka,Fn,Cn,Tt,Dn,Sn,Fs,A,In,Ea,Mn,Nn,Ta,On,Ln,ja,Wn,Bn,Cs,Se,Ds,jt,Hn,Ss,Q,Kn,At,Gn,Un,Is,Ie,Ms,Pt,Yn,Ns,qt,Rn,Os,Me,Ls,V,Jn,xt,Xn,Zn,Ws,zt,Bs,L,ee,Aa,Ne,Qn,Pa,Vn,Hs,Oe,Ks,Ft,el,Gs,Le,Us,D,tl,qa,al,sl,xa,rl,ol,Ys,We,Rs,te,nl,za,ll,il,Js,Be,Xs,Ct,fl,Zs,He,Qs,Dt,pl,Vs,Ke,er,St,tr,W,ae,Fa,Ge,ml,Ca,dl,ar,Ue,sr,It,hl,rr,Ye,or,S,ul,Mt,cl,_l,Da,wl,vl,nr,I,Re,yl,Sa,bl,$l,gl,q,kl,Ia,El,Tl,Ma,jl,Al,Na,Pl,ql,xl,Oa,zl,lr,se,Fl,La,Cl,Dl,ir,Je,fr,Nt,Sl,pr,Xe,mr,Ot,Il,dr,Ze,hr,M,Ml,Lt,Nl,Ol,Wt,Ll,Wl,ur,Qe,cr,Bt,Bl,_r,Ve,wr,re,Hl,Wa,Kl,Gl,vr,et,yr,oe,Ul,Ba,Yl,Rl,br,tt,$r,Ht,Jl,gr,ne,Xl,Kt,Zl,Ql,kr,at,Er,Gt,Tr,B,le,Ha,st,Vl,Ka,ei,jr,Ut,ti,Ar,ie,Ga,Yt,rt,ai,si,ri,Ua,fe,Rt,oi,ni,Ya,li,ii,Pr;return _e=new aa({}),we=new tp({props:{classNames:"absolute z-10 right-0 top-0",options:[{label:"Mixed",value:"https://colab.research.google.com/github/huggingface/notebooks/blob/master/transformers_doc/training.ipynb"},{label:"PyTorch",value:"https://colab.research.google.com/github/huggingface/notebooks/blob/master/transformers_doc/pytorch/training.ipynb"},{label:"TensorFlow",value:"https://colab.research.google.com/github/huggingface/notebooks/blob/master/transformers_doc/tensorflow/training.ipynb"}]}}),ye=new aa({}),be=new Zr({props:{id:"_BZearw7f0w"}}),ke=new y({props:{code:`from datasets import load_dataset
...
metric.compute()`}}),st=new aa({}),{c(){x=l("meta"),ot=p(),g=l("h1"),P=l("a"),sa=l("span"),h(_e.$$.fragment),Vr=p(),ra=l("span"),eo=r("Fine-tuning a pretrained model"),Ja=p(),h(we.$$.fragment),Xa=p(),z=l("p"),to=r(`In this tutorial, we will show you how to fine-tune a pretrained model from the Transformers library. In TensorFlow,
...
predictions/labels.`),Ss=p(),Q=l("p"),Kn=r("To check if this works on practice, let\u2019s create a new "),At=l("a"),Gn=r("Trainer"),Un=r(" with our fine-tuned model:"),Is=p(),h(Ie.$$.fragment),Ms=p(),Pt=l("p"),Yn=r("which showed an accuracy of 87.5% in our case."),Ns=p(),qt=l("p"),Rn=r(`If you want to fine-tune your model and regularly report the evaluation metrics (for instance at the end of each
epoch), here is how you should define your training arguments:`),Os=p(),h(Me.$$.fragment),Ls=p(),V=l("p"),Jn=r("See the documentation of "),xt=l("a"),Xn=r("TrainingArguments"),Zn=r(" for more options."),Ws=p(),zt=l("a"),Bs=p(),L=l("h2"),ee=l("a"),Aa=l("span"),h(Ne.$$.fragment),Qn=p(),Pa=l("span"),Vn=r("Fine-tuning with Keras"),Hs=p(),h(Oe.$$.fragment),Ks=p(),Ft=l("p"),el=r("Models can also be trained natively in TensorFlow using the Keras API. First, let\u2019s define our model:"),Gs=p(),h(Le.$$.fragment),Us=p(),D=l("p"),tl=r("Then we will need to convert our datasets from before in standard "),qa=l("code"),al=r("tf.data.Dataset"),sl=r(`. Since we have fixed shapes,
...
training steps, using the `),Ba=l("em"),Yl=r("tqdm"),Rl=r(" library."),br=p(),h(tt.$$.fragment),$r=p(),Ht=l("p"),Jl=r(`Note that if you are used to freezing the body of your pretrained model (like in computer vision) the above may seem a
...
to train on all common NLP tasks in PyTorch and TensorFlow.`),ri=p(),Ua=l("li"),fe=l("p"),Rt=l("a"),oi=r("\u{1F917} Transformers Notebooks"),ni=r(` which contains various notebooks and in particular one per task (look for
the `),Ya=l("em"),li=r("how to finetune a model on xxx"),ii=r(")."),this.h()},l(e){const s=Vf('[data-svelte="svelte-1phssyn"]',document.head);x=i(s,"META",{name:!0,content:!0}),s.forEach(t),ot=m(e),g=i(e,"H1",{class:!0});var qr=f(g);P=i(qr,"A",{id:!0,class:!0,href:!0});var pi=f(P);sa=i(pi,"SPAN",{});var mi=f(sa);u(_e.$$.fragment,mi),mi.forEach(t),pi.forEach(t),Vr=m(qr),ra=i(qr,"SPAN",{});var di=f(ra);eo=o(di,"Fine-tuning a pretrained model"),di.forEach(t),qr.forEach(t),Ja=m(e),u(we.$$.fragment,e),Xa=m(e),z=i(e,"P",{});var Jt=f(z);to=o(Jt,`In this tutorial, we will show you how to fine-tune a pretrained model from the Transformers library. In TensorFlow,
models can be directly trained using Keras and the `),oa=i(Jt,"CODE",{});var hi=f(oa);ao=o(hi,"fit"),hi.forEach(t),so=o(Jt,` method. In PyTorch, there is no generic training loop so
the \u{1F917} Transformers library provides an API with the class `),nt=i(Jt,"A",{href:!0});var ui=f(nt);ro=o(ui,"Trainer"),ui.forEach(t),oo=o(Jt,` to let you fine-tune or train
a model from scratch easily. Then we will show you how to alternatively write the whole training loop in PyTorch.`),Jt.forEach(t),Za=m(e),F=i(e,"P",{});var Xt=f(F);no=o(Xt,`Before we can fine-tune a model, we need a dataset. In this tutorial, we will show you how to fine-tune BERT on the
...
`),yt=i(de,"A",{href:!0});var Ri=f(yt);vn=o(Ri,"TrainingArguments"),Ri.forEach(t),yn=o(de,`. This class contains all the hyperparameters we can tune for the
`),bt=i(de,"A",{href:!0});var Ji=f(bt);bn=o(Ji,"Trainer"),Ji.forEach(t),$n=o(de,` or the flags to activate the different training options it supports. Let\u2019s begin by
...
training steps, using the `),Ba=i(Yr,"EM",{});var Nf=f(Ba);Yl=o(Nf,"tqdm"),Nf.forEach(t),Rl=o(Yr," library."),Yr.forEach(t),br=m(e),u(tt.$$.fragment,e),$r=m(e),Ht=i(e,"P",{});var Of=f(Ht);Jl=o(Of,`Note that if you are used to freezing the body of your pretrained model (like in computer vision) the above may seem a
bit strange, as we are directly fine-tuning the whole model without taking any precaution. It actually works better
this way for Transformers model (so this is not an oversight on our side). If you\u2019re not familiar with what \u201Cfreezing
the body\u201D of the model means, forget you read this paragraph.`),Of.forEach(t),gr=m(e),ne=i(e,"P",{});var Rr=f(ne);Xl=o(Rr,"Now to check the results, we need to write the evaluation loop. Like in the "),Kt=i(Rr,"A",{href:!0});var Lf=f(Kt);Zl=o(Lf,"trainer section"),Lf.forEach(t),Ql=o(Rr,` we will
use a metric from the datasets library. Here we accumulate the predictions at each batch before computing the final
result when the loop is finished.`),Rr.forEach(t),kr=m(e),u(at.$$.fragment,e),Er=m(e),Gt=i(e,"A",{id:!0}),f(Gt).forEach(t),Tr=m(e),B=i(e,"H2",{class:!0});var Jr=f(B);le=i(Jr,"A",{id:!0,class:!0,href:!0});var Wf=f(le);Ha=i(Wf,"SPAN",{});var Bf=f(Ha);u(st.$$.fragment,Bf),Bf.forEach(t),Wf.forEach(t),Vl=m(Jr),Ka=i(Jr,"SPAN",{});var Hf=f(Ka);ei=o(Hf,"Additional resources"),Hf.forEach(t),Jr.forEach(t),jr=m(e),Ut=i(e,"P",{});var Kf=f(Ut);ti=o(Kf,"To look at more fine-tuning examples you can refer to:"),Kf.forEach(t),Ar=m(e),ie=i(e,"UL",{});var Xr=f(ie);Ga=i(Xr,"LI",{});var Gf=f(Ga);Yt=i(Gf,"P",{});var fi=f(Yt);rt=i(fi,"A",{href:!0,rel:!0});var Uf=f(rt);ai=o(Uf,"\u{1F917} Transformers Examples"),Uf.forEach(t),si=o(fi,` which includes scripts
to train on all common NLP tasks in PyTorch and TensorFlow.`),fi.forEach(t),Gf.forEach(t),ri=m(Xr),Ua=i(Xr,"LI",{});var Yf=f(Ua);fe=i(Yf,"P",{});var Ra=f(fe);Rt=i(Ra,"A",{href:!0});var Rf=f(Rt);oi=o(Rf,"\u{1F917} Transformers Notebooks"),Rf.forEach(t),ni=o(Ra,` which contains various notebooks and in particular one per task (look for
the `),Ya=i(Ra,"EM",{});var Jf=f(Ya);li=o(Jf,"how to finetune a model on xxx"),Jf.forEach(t),ii=o(Ra,")."),Ra.forEach(t),Yf.forEach(t),Xr.forEach(t),this.h()},h(){d(x,"name","hf:doc:metadata"),d(x,"content",JSON.stringify(sp)),d(P,"id","finetuning-a-pretrained-model"),d(P,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),d(P,"href","#finetuning-a-pretrained-model"),d(g,"class","relative group"),d(nt,"href","/docs/transformers/v4.14.1/en/main_classes/trainer#transformers.Trainer"),d(ve,"href","https://www.imdb.com/interfaces/"),d(ve,"rel","nofollow"),d(lt,"href","#additional-resources"),d(it,"id","data-processing"),d(H,"id","preparing-the-datasets"),d(H,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),d(H,"href","#preparing-the-datasets"),d(N,"class","relative group"),d($e,"href","https://github.com/huggingface/datasets/"),d($e,"rel","nofollow"),d(ge,"href","https://huggingface.co/docs/datasets/"),d(ge,"rel","nofollow"),d(ft,"href","preprocessing"),d(mt,"href","preprocessing"),d(Ae,"href","https://huggingface.co/docs/datasets/"),d(Ae,"rel","nofollow"),d(ut,"id","trainer"),d(R,"id","finetuning-in-pytorch-with-the-trainer-api"),d(R,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),d(R,"href","#finetuning-in-pytorch-with-the-trainer-api"),d(O,"class","relative group"),d(ct,"href","/docs/transformers/v4.14.1/en/main_classes/trainer#transformers.Trainer"),d(vt,"href","/docs/transformers/v4.14.1/en/main_classes/trainer#transformers.Trainer"),d(yt,"href","/docs/transformers/v4.14.1/en/main_classes/trainer#transformers.TrainingArguments"),d(bt,"href","/docs/transformers/v4.14.1/en/main_classes/trainer#transformers.Trainer"),d($t,"href","/docs/transformers/v4.14.1/en/main_classes/trainer#transformers.Trainer"),d(kt,"href","/docs/transformers/v4.14.1/en/main_classes/trainer#transformers.Trainer"),d(Et,"href","/docs/transformers/v4.14.1/en/main_classes/trainer#transformers.Trainer"),d(Tt,"href","/docs/transformers/v4.14.1/en/internal/trainer_utils#transformers.EvalPrediction"),d(At,"href","/docs/transformers/v4.14.1/en/main_classes/trainer#transformers.Trainer"),d(xt,"href","/docs/transformers/v4.14.1/en/main_classes/trainer#transformers.TrainingArguments"),d(zt,"id","keras"),d(ee,"id","finetuning-with-keras"),d(ee,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),d(ee,"href","#finetuning-with-keras"),d(L,"class","relative group"),d(St,"id","pytorch_native"),d(ae,"id","finetuning-in-native-pytorch"),d(ae,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),d(ae,"href","#finetuning-in-native-pytorch"),d(W,"class","relative group"),d(Mt,"href","#trainer"),d(Lt,"href","/docs/transformers/v4.14.1/en/main_classes/trainer#transformers.Trainer"),d(Wt,"href","/docs/transformers/v4.14.1/en/main_classes/optimizer_schedules#transformers.AdamW"),d(Kt,"href","#trainer"),d(Gt,"id","additional-resources"),d(le,"id","additional-resources"),d(le,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),d(le,"href","#additional-resources"),d(B,"class","relative group"),d(rt,"href","https://github.com/huggingface/transformers/tree/master/examples"),d(rt,"rel","nofollow"),d(Rt,"href","notebooks")},m(e,s){a(document.head,x),n(e,ot,s),n(e,g,s),a(g,P),a(P,sa),c(_e,sa,null),a(g,Vr),a(g,ra),a(ra,eo),n(e,Ja,s),c(we,e,s),n(e,Xa,s),n(e,z,s),a(z,to),a(z,oa),a(oa,ao),a(z,so),a(z,nt),a(nt,ro),a(z,oo),n(e,Za,s),n(e,F,s),a(F,no),a(F,ve),a(ve,lo),a(F,io),a(F,lt),a(lt,fo),a(F,po),n(e,Qa,s),n(e,it,s),n(e,Va,s),n(e,N,s),a(N,H),a(H,na),c(ye,na,null),a(N,mo),a(N,la),a(la,ho),n(e,es,s),c(be,e,s),n(e,ts,s),n(e,k,s),a(k,uo),a(k,$e),a($e,co),a(k,_o),a(k,ge),a(ge,wo),a(k,vo),a(k,ft),a(ft,yo),a(k,bo),n(e,as,s),n(e,K,s),a(K,$o),a(K,ia),a(ia,go),a(K,ko),n(e,ss,s),c(ke,e,s),n(e,rs,s),n(e,C,s),a(C,Eo),a(C,fa),a(fa,To),a(C,jo),a(C,pa),a(pa,Ao),a(C,Po),n(e,os,s),n(e,b,s),a(b,qo),a(b,ma),a(ma,xo),a(b,zo),a(b,da),a(da,Fo),a(b,Co),a(b,ha),a(ha,Do),a(b,So),a(b,ua),a(ua,Io),a(b,Mo),a(b,ca),a(ca,No),a(b,Oo),a(b,_a),a(_a,Lo),a(b,Wo),n(e,ns,s),n(e,pt,s),a(pt,Bo),n(e,ls,s),c(Ee,e,s),n(e,is,s),n(e,G,s),a(G,Ho),a(G,mt),a(mt,Ko),a(G,Go),n(e,fs,s),c(Te,e,s),n(e,ps,s),n(e,dt,s),a(dt,Uo),n(e,ms,s),n(e,U,s),a(U,Yo),a(U,wa),a(wa,Ro),a(U,Jo),n(e,ds,s),c(je,e,s),n(e,hs,s),n(e,Y,s),a(Y,Xo),a(Y,Ae),a(Ae,Zo),a(Y,Qo),n(e,us,s),n(e,ht,s),a(ht,Vo),n(e,cs,s),c(Pe,e,s),n(e,_s,s),n(e,E,s),a(E,en),a(E,va),a(va,tn),a(E,an),a(E,ya),a(ya,sn),a(E,rn),a(E,ba),a(ba,on),a(E,nn),n(e,ws,s),n(e,ut,s),n(e,vs,s),n(e,O,s),a(O,R),a(R,$a),c(qe,$a,null),a(O,ln),a(O,ga),a(ga,fn),n(e,ys,s),c(xe,e,s),n(e,bs,s),n(e,J,s),a(J,pn),a(J,ct),a(ct,mn),a(J,dn),n(e,$s,s),n(e,_t,s),a(_t,hn),n(e,gs,s),c(ze,e,s),n(e,ks,s),n(e,wt,s),a(wt,un),n(e,Es,s),n(e,T,s),a(T,cn),a(T,vt),a(vt,_n),a(T,wn),a(T,yt),a(yt,vn),a(T,yn),a(T,bt),a(bt,bn),a(T,$n),n(e,Ts,s),c(Fe,e,s),n(e,js,s),n(e,X,s),a(X,gn),a(X,$t),a($t,kn),a(X,En),n(e,As,s),c(Ce,e,s),n(e,Ps,s),n(e,gt,s),a(gt,Tn),n(e,qs,s),c(De,e,s),n(e,xs,s),n(e,Z,s),a(Z,jn),a(Z,kt),a(kt,An),a(Z,Pn),n(e,zs,s),n(e,j,s),a(j,qn),a(j,Et),a(Et,xn),a(j,zn),a(j,ka),a(ka,Fn),a(j,Cn),a(j,Tt),a(Tt,Dn),a(j,Sn),n(e,Fs,s),n(e,A,s),a(A,In),a(A,Ea),a(Ea,Mn),a(A,Nn),a(A,Ta),a(Ta,On),a(A,Ln),a(A,ja),a(ja,Wn),a(A,Bn),n(e,Cs,s),c(Se,e,s),n(e,Ds,s),n(e,jt,s),a(jt,Hn),n(e,Ss,s),n(e,Q,s),a(Q,Kn),a(Q,At),a(At,Gn),a(Q,Un),n(e,Is,s),c(Ie,e,s),n(e,Ms,s),n(e,Pt,s),a(Pt,Yn),n(e,Ns,s),n(e,qt,s),a(qt,Rn),n(e,Os,s),c(Me,e,s),n(e,Ls,s),n(e,V,s),a(V,Jn),a(V,xt),a(xt,Xn),a(V,Zn),n(e,Ws,s),n(e,zt,s),n(e,Bs,s),n(e,L,s),a(L,ee),a(ee,Aa),c(Ne,Aa,null),a(L,Qn),a(L,Pa),a(Pa,Vn),n(e,Hs,s),c(Oe,e,s),n(e,Ks,s),n(e,Ft,s),a(Ft,el),n(e,Gs,s),c(Le,e,s),n(e,Us,s),n(e,D,s),a(D,tl),a(D,qa),a(qa,al),a(D,sl),a(D,xa),a(xa,rl),a(D,ol),n(e,Ys,s),c(We,e,s),n(e,Rs,s),n(e,te,s),a(te,nl),a(te,za),a(za,ll),a(te,il),n(e,Js,s),c(Be,e,s),n(e,Xs,s),n(e,Ct,s),a(Ct,fl),n(e,Zs,s),c(He,e,s),n(e,Qs,s),n(e,Dt,s),a(Dt,pl),n(e,Vs,s),c(Ke,e,s),n(e,er,s),n(e,St,s),n(e,tr,s),n(e,W,s),a(W,ae),a(ae,Fa),c(Ge,Fa,null),a(W,ml),a(W,Ca),a(Ca,dl),n(e,ar,s),c(Ue,e,s),n(e,sr,s),n(e,It,s),a(It,hl),n(e,rr,s),c(Ye,e,s),n(e,or,s),n(e,S,s),a(S,ul),a(S,Mt),a(Mt,cl),a(S,_l),a(S,Da),a(Da,wl),a(S,vl),n(e,nr,s),n(e,I,s),a(I,Re),a(Re,yl),a(Re,Sa),a(Sa,bl),a(Re,$l),a(I,gl),a(I,q),a(q,kl),a(q,Ia),a(Ia,El),a(q,Tl),a(q,Ma),a(Ma,jl),a(q,Al),a(q,Na),a(Na,Pl),a(q,ql),a(I,xl),a(I,Oa),a(Oa,zl),n(e,lr,s),n(e,se,s),a(se,Fl),a(se,La),a(La,Cl),a(se,Dl),n(e,ir,s),c(Je,e,s),n(e,fr,s),n(e,Nt,s),a(Nt,Sl),n(e,pr,s),c(Xe,e,s),n(e,mr,s),n(e,Ot,s),a(Ot,Il),n(e,dr,s),c(Ze,e,s),n(e,hr,s),n(e,M,s),a(M,Ml),a(M,Lt),a(Lt,Nl),a(M,Ol),a(M,Wt),a(Wt,Ll),a(M,Wl),n(e,ur,s),c(Qe,e,s),n(e,cr,s),n(e,Bt,s),a(Bt,Bl),n(e,_r,s),c(Ve,e,s),n(e,wr,s),n(e,re,s),a(re,Hl),a(re,Wa),a(Wa,Kl),a(re,Gl),n(e,vr,s),c(et,e,s),n(e,yr,s),n(e,oe,s),a(oe,Ul),a(oe,Ba),a(Ba,Yl),a(oe,Rl),n(e,br,s),c(tt,e,s),n(e,$r,s),n(e,Ht,s),a(Ht,Jl),n(e,gr,s),n(e,ne,s),a(ne,Xl),a(ne,Kt),a(Kt,Zl),a(ne,Ql),n(e,kr,s),c(at,e,s),n(e,Er,s),n(e,Gt,s),n(e,Tr,s),n(e,B,s),a(B,le),a(le,Ha),c(st,Ha,null),a(B,Vl),a(B,Ka),a(Ka,ei),n(e,jr,s),n(e,Ut,s),a(Ut,ti),n(e,Ar,s),n(e,ie,s),a(ie,Ga),a(Ga,Yt),a(Yt,rt),a(rt,ai),a(Yt,si),a(ie,ri),a(ie,Ua),a(Ua,fe),a(fe,Rt),a(Rt,oi),a(fe,ni),a(fe,Ya),a(Ya,li),a(fe,ii),Pr=!0},p:ep,i(e){Pr||(_(_e.$$.fragment,e),_(we.$$.fragment,e),_(ye.$$.fragment,e),_(be.$$.fragment,e),_(ke.$$.fragment,e),_(Ee.$$.fragment,e),_(Te.$$.fragment,e),_(je.$$.fragment,e),_(Pe.$$.fragment,e),_(qe.$$.fragment,e),_(xe.$$.fragment,e),_(ze.$$.fragment,e),_(Fe.$$.fragment,e),_(Ce.$$.fragment,e),_(De.$$.fragment,e),_(Se.$$.fragment,e),_(Ie.$$.fragment,e),_(Me.$$.fragment,e),_(Ne.$$.fragment,e),_(Oe.$$.fragment,e),_(Le.$$.fragment,e),_(We.$$.fragment,e),_(Be.$$.fragment,e),_(He.$$.fragment,e),_(Ke.$$.fragment,e),_(Ge.$$.fragment,e),_(Ue.$$.fragment,e),_(Ye.$$.fragment,e),_(Je.$$.fragment,e),_(Xe.$$.fragment,e),_(Ze.$$.fragment,e),_(Qe.$$.fragment,e),_(Ve.$$.fragment,e),_(et.$$.fragment,e),_(tt.$$.fragment,e),_(at.$$.fragment,e),_(st.$$.fragment,e),Pr=!0)},o(e){w(_e.$$.fragment,e),w(we.$$.fragment,e),w(ye.$$.fragment,e),w(be.$$.fragment,e),w(ke.$$.fragment,e),w(Ee.$$.fragment,e),w(Te.$$.fragment,e),w(je.$$.fragment,e),w(Pe.$$.fragment,e),w(qe.$$.fragment,e),w(xe.$$.fragment,e),w(ze.$$.fragment,e),w(Fe.$$.fragment,e),w(Ce.$$.fragment,e),w(De.$$.fragment,e),w(Se.$$.fragment,e),w(Ie.$$.fragment,e),w(Me.$$.fragment,e),w(Ne.$$.fragment,e),w(Oe.$$.fragment,e),w(Le.$$.fragment,e),w(We.$$.fragment,e),w(Be.$$.fragment,e),w(He.$$.fragment,e),w(Ke.$$.fragment,e),w(Ge.$$.fragment,e),w(Ue.$$.fragment,e),w(Ye.$$.fragment,e),w(Je.$$.fragment,e),w(Xe.$$.fragment,e),w(Ze.$$.fragment,e),w(Qe.$$.fragment,e),w(Ve.$$.fragment,e),w(et.$$.fragment,e),w(tt.$$.fragment,e),w(at.$$.fragment,e),w(st.$$.fragment,e),Pr=!1},d(e){t(x),e&&t(ot),e&&t(g),v(_e),e&&t(Ja),v(we,e),e&&t(Xa),e&&t(z),e&&t(Za),e&&t(F),e&&t(Qa),e&&t(it),e&&t(Va),e&&t(N),v(ye),e&&t(es),v(be,e),e&&t(ts),e&&t(k),e&&t(as),e&&t(K),e&&t(ss),v(ke,e),e&&t(rs),e&&t(C),e&&t(os),e&&t(b),e&&t(ns),e&&t(pt),e&&t(ls),v(Ee,e),e&&t(is),e&&t(G),e&&t(fs),v(Te,e),e&&t(ps),e&&t(dt),e&&t(ms),e&&t(U),e&&t(ds),v(je,e),e&&t(hs),e&&t(Y),e&&t(us),e&&t(ht),e&&t(cs),v(Pe,e),e&&t(_s),e&&t(E),e&&t(ws),e&&t(ut),e&&t(vs),e&&t(O),v(qe),e&&t(ys),v(xe,e),e&&t(bs),e&&t(J),e&&t($s),e&&t(_t),e&&t(gs),v(ze,e),e&&t(ks),e&&t(wt),e&&t(Es),e&&t(T),e&&t(Ts),v(Fe,e),e&&t(js),e&&t(X),e&&t(As),v(Ce,e),e&&t(Ps),e&&t(gt),e&&t(qs),v(De,e),e&&t(xs),e&&t(Z),e&&t(zs),e&&t(j),e&&t(Fs),e&&t(A),e&&t(Cs),v(Se,e),e&&t(Ds),e&&t(jt),e&&t(Ss),e&&t(Q),e&&t(Is),v(Ie,e),e&&t(Ms),e&&t(Pt),e&&t(Ns),e&&t(qt),e&&t(Os),v(Me,e),e&&t(Ls),e&&t(V),e&&t(Ws),e&&t(zt),e&&t(Bs),e&&t(L),v(Ne),e&&t(Hs),v(Oe,e),e&&t(Ks),e&&t(Ft),e&&t(Gs),v(Le,e),e&&t(Us),e&&t(D),e&&t(Ys),v(We,e),e&&t(Rs),e&&t(te),e&&t(Js),v(Be,e),e&&t(Xs),e&&t(Ct),e&&t(Zs),v(He,e),e&&t(Qs),e&&t(Dt),e&&t(Vs),v(Ke,e),e&&t(er),e&&t(St),e&&t(tr),e&&t(W),v(Ge),e&&t(ar),v(Ue,e),e&&t(sr),e&&t(It),e&&t(rr),v(Ye,e),e&&t(or),e&&t(S),e&&t(nr),e&&t(I),e&&t(lr),e&&t(se),e&&t(ir),v(Je,e),e&&t(fr),e&&t(Nt),e&&t(pr),v(Xe,e),e&&t(mr),e&&t(Ot),e&&t(dr),v(Ze,e),e&&t(hr),e&&t(M),e&&t(ur),v(Qe,e),e&&t(cr),e&&t(Bt),e&&t(_r),v(Ve,e),e&&t(wr),e&&t(re),e&&t(vr),v(et,e),e&&t(yr),e&&t(oe),e&&t(br),v(tt,e),e&&t($r),e&&t(Ht),e&&t(gr),e&&t(ne),e&&t(kr),v(at,e),e&&t(Er),e&&t(Gt),e&&t(Tr),e&&t(B),v(st),e&&t(jr),e&&t(Ut),e&&t(Ar),e&&t(ie)}}}const sp={local:"finetuning-a-pretrained-model",sections:[{local:"preparing-the-datasets",title:"Preparing the datasets"},{local:"finetuning-in-pytorch-with-the-trainer-api",title:"Fine-tuning in PyTorch with the Trainer API"},{local:"finetuning-with-keras",title:"Fine-tuning with Keras"},{local:"finetuning-in-native-pytorch",title:"Fine-tuning in native PyTorch"},{local:"additional-resources",title:"Additional resources"}],title:"Fine-tuning a pretrained model"};function rp(Qr,x,ot){let{fw:g}=x;return Qr.$$set=P=>{"fw"in P&&ot(0,g=P.fw)},[g]}class mp extends Xf{constructor(x){super();Zf(this,x,rp,ap,Qf,{fw:0})}}export{mp as default,sp as metadata};
