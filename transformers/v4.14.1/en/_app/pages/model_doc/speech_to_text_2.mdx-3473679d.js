import{S as di,i as hi,s as pi,e as s,k as l,w as m,t as r,M as fi,c as a,d as o,m as d,a as c,x as u,h as n,b as i,F as e,g as p,y as _,q as g,o as v,B as T}from"../../chunks/vendor-ab4e3193.js";import{T as li}from"../../chunks/Tip-b5c6375a.js";import{D as I}from"../../chunks/Docstring-b69c0bd4.js";import{C as Va}from"../../chunks/CodeBlock-516df0c5.js";import{I as ut}from"../../chunks/IconCopyLink-d992940d.js";import"../../chunks/CopyButton-204b56db.js";function mi(ye){let f,q,k,S,L,w,N,j;return{c(){f=s("p"),q=r(`This class method is simply calling AutoFeatureExtractor\u2019s
`),k=s("code"),S=r("from_pretrained"),L=r(` and Speech2Text2Tokenizer\u2019s
...
`),k=a(b,"CODE",{});var C=c(k);S=n(C,"from_pretrained"),C.forEach(o),L=n(b,` and Speech2Text2Tokenizer\u2019s
`),w=a(b,"CODE",{});var A=c(w);N=n(A,"from_pretrained"),A.forEach(o),j=n(b,`. Please refer to the
docstrings of the methods above for more information.`),b.forEach(o)},m(z,b){p(z,f,b),e(f,q),e(f,k),e(k,S),e(f,L),e(f,w),e(w,N),e(f,j)},d(z){z&&o(f)}}}function ui(ye){let f,q,k,S,L,w,N,j;return{c(){f=s("p"),q=r("This class method is simply calling "),k=s("code"),S=r("save_pretrained"),L=r(` and
`),w=s("code"),N=r("save_pretrained"),j=r(`. Please refer to the
docstrings of the methods above for more information.`)},l(z){f=a(z,"P",{});var b=c(f);q=n(b,"This class method is simply calling "),k=a(b,"CODE",{});var C=c(k);S=n(C,"save_pretrained"),C.forEach(o),L=n(b,` and
`),w=a(b,"CODE",{});var A=c(w);N=n(A,"save_pretrained"),A.forEach(o),j=n(b,`. Please refer to the
docstrings of the methods above for more information.`),b.forEach(o)},m(z,b){p(z,f,b),e(f,q),e(f,k),e(k,S),e(f,L),e(f,w),e(w,N),e(f,j)},d(z){z&&o(f)}}}function _i(ye){let f,q,k,S,L,w,N,j,z,b,C,A,no,$e,Cr,so,qr,Do,H,Ar,_t,Mr,Fr,Ee,Lr,jr,Io,y,Dr,ao,Ir,Wr,co,Vr,Nr,gt,Br,Or,vt,Ur,Rr,Tt,Hr,Jr,io,Gr,Kr,Wo,ce,Qr,Pe,Xr,Yr,Vo,ie,Zr,ze,en,tn,No,kt,on,Bo,J,Ce,rn,qe,nn,sn,an,Ae,cn,xt,ln,dn,hn,Me,pn,bt,fn,Fe,mn,un,Oo,Z,le,lo,Le,_n,ho,gn,Uo,G,vn,St,Tn,kn,wt,xn,bn,Ro,P,Sn,yt,wn,yn,$t,$n,En,Et,Pn,zn,Pt,Cn,qn,zt,An,Mn,Ho,Ct,po,Fn,Jo,je,Go,qt,De,fo,Ln,jn,mo,Dn,Ko,Ie,Qo,de,In,We,Wn,Vn,Xo,ee,he,uo,Ve,Nn,_o,Bn,Yo,B,Ne,On,te,Un,At,Rn,Hn,Be,Jn,Gn,Kn,oe,Qn,Mt,Xn,Yn,Ft,Zn,es,Zo,re,pe,go,Oe,ts,vo,os,er,E,Ue,rs,To,ns,ss,Re,as,Lt,cs,is,ls,fe,He,ds,ko,hs,ps,K,Je,fs,xo,ms,us,Ge,_s,bo,gs,vs,Ts,So,tr,ne,me,wo,Ke,ks,yo,xs,or,x,Qe,bs,$o,Ss,ws,M,jt,ys,$s,Dt,Es,Ps,It,zs,Cs,Xe,Eo,qs,As,Ms,Wt,Fs,Ls,js,ue,Ye,Ds,O,Is,Po,Ws,Vs,Vt,Ns,Bs,Ze,zo,Os,Us,Rs,Hs,Q,et,Js,tt,Gs,Nt,Ks,Qs,Xs,_e,Ys,X,ot,Zs,se,ea,Co,ta,oa,Bt,ra,na,sa,ge,aa,ve,rt,ca,nt,ia,Ot,la,da,ha,Te,st,pa,at,fa,Ut,ma,ua,_a,ke,ct,ga,qo,va,rr,ae,xe,Ao,it,Ta,Mo,ka,nr,D,lt,xa,U,ba,Rt,Sa,wa,Fo,ya,$a,Ht,Ea,Pa,za,dt,Ca,ht,qa,Aa,Ma,Y,pt,Fa,Lo,La,ja,ft,sr;return w=new ut({}),$e=new ut({}),Le=new ut({}),je=new Va({props:{code:`import torch
...
<span class="hljs-meta">&gt;&gt;&gt; </span>model = SpeechEncoderDecoderModel(encoder=encoder, decoder=decoder)`}}),{c(){f=s("meta"),q=l(),k=s("h1"),S=s("a"),L=s("span"),m(w.$$.fragment),N=l(),j=s("span"),z=r("Speech2Text2"),b=l(),C=s("h2"),A=s("a"),no=s("span"),m($e.$$.fragment),Cr=l(),so=s("span"),qr=r("Overview"),Do=l(),H=s("p"),Ar=r("The Speech2Text2 model is used together with "),_t=s("a"),Mr=r("Wav2Vec2"),Fr=r(` for Speech Translation models proposed in
`),Ee=s("a"),Lr=r("Large-Scale Self- and Semi-Supervised Learning for Speech Translation"),jr=r(` by
...
the `),qe=s("a"),nn=r("official models"),sn=r(" ."),an=l(),Ae=s("li"),cn=r("Speech2Text2 is always used within the "),xt=s("a"),ln=r("SpeechEncoderDecoder"),dn=r(" framework."),hn=l(),Me=s("li"),pn=r("Speech2Text2\u2019s tokenizer is based on "),bt=s("em"),fn=r("fastBPE <"),Fe=s("a"),mn=r("https://github.com/glample/fastBPE>"),un=r("."),Oo=l(),Z=s("h2"),le=s("a"),lo=s("span"),m(Le.$$.fragment),_n=l(),ho=s("span"),gn=r("Inference"),Uo=l(),G=s("p"),vn=r("Speech2Text2\u2019s "),St=s("a"),Tn=r("SpeechEncoderDecoderModel"),kn=r(` model accepts raw waveform input values from speech and
...
outputs. Read the documentation from `),Ft=s("a"),Zn=r("PretrainedConfig"),es=r(" for more information."),Zo=l(),re=s("h2"),pe=s("a"),go=s("span"),m(Oe.$$.fragment),ts=l(),vo=s("span"),os=r("Speech2TextTokenizer"),er=l(),E=s("div"),m(Ue.$$.fragment),rs=l(),To=s("p"),ns=r("Constructs a Speech2Text2Tokenizer."),ss=l(),Re=s("p"),as=r("This tokenizer inherits from "),Lt=s("a"),cs=r("PreTrainedTokenizer"),is=r(` which contains some of the main methods.
...
`),Xe=s("a"),Eo=s("strong"),qs=r("call"),As=r("()"),Ms=r(" and "),Wt=s("a"),Fs=r("decode()"),Ls=r(` for
...
general usage and behavior.`),Ma=l(),Y=s("div"),m(pt.$$.fragment),Fa=l(),Lo=s("p"),La=r("Example:"),ja=l(),m(ft.$$.fragment),this.h()},l(t){const h=fi('[data-svelte="svelte-1phssyn"]',document.head);f=a(h,"META",{name:!0,content:!0}),h.forEach(o),q=d(t),k=a(t,"H1",{class:!0});var mt=c(k);S=a(mt,"A",{id:!0,class:!0,href:!0});var jo=c(S);L=a(jo,"SPAN",{});var Na=c(L);u(w.$$.fragment,Na),Na.forEach(o),jo.forEach(o),N=d(mt),j=a(mt,"SPAN",{});var Ba=c(j);z=n(Ba,"Speech2Text2"),Ba.forEach(o),mt.forEach(o),b=d(t),C=a(t,"H2",{class:!0});var ar=c(C);A=a(ar,"A",{id:!0,class:!0,href:!0});var Oa=c(A);no=a(Oa,"SPAN",{});var Ua=c(no);u($e.$$.fragment,Ua),Ua.forEach(o),Oa.forEach(o),Cr=d(ar),so=a(ar,"SPAN",{});var Ra=c(so);qr=n(Ra,"Overview"),Ra.forEach(o),ar.forEach(o),Do=d(t),H=a(t,"P",{});var Jt=c(H);Ar=n(Jt,"The Speech2Text2 model is used together with "),_t=a(Jt,"A",{href:!0});var Ha=c(_t);Mr=n(Ha,"Wav2Vec2"),Ha.forEach(o),Fr=n(Jt,` for Speech Translation models proposed in
`),Ee=a(Jt,"A",{href:!0,rel:!0});var Ja=c(Ee);Lr=n(Ja,"Large-Scale Self- and Semi-Supervised Learning for Speech Translation"),Ja.forEach(o),jr=n(Jt,` by
Changhan Wang, Anne Wu, Juan Pino, Alexei Baevski, Michael Auli, Alexis Conneau.`),Jt.forEach(o),Io=d(t),y=a(t,"P",{});var F=c(y);Dr=n(F,"Speech2Text2 is a "),ao=a(F,"EM",{});var Ga=c(ao);Ir=n(Ga,"decoder-only"),Ga.forEach(o),Wr=n(F," transformer model that can be used with any speech "),co=a(F,"EM",{});var Ka=c(co);Vr=n(Ka,"encoder-only"),Ka.forEach(o),Nr=n(F,`, such as
`),gt=a(F,"A",{href:!0});var Qa=c(gt);Br=n(Qa,"Wav2Vec2"),Qa.forEach(o),Or=n(F," or "),vt=a(F,"A",{href:!0});var Xa=c(vt);Ur=n(Xa,"HuBERT"),Xa.forEach(o),Rr=n(F,` for Speech-to-Text tasks. Please refer to the
`),Tt=a(F,"A",{href:!0});var Ya=c(Tt);Hr=n(Ya,"SpeechEncoderDecoder"),Ya.forEach(o),Jr=n(F," class on how to combine Speech2Text2 with any speech "),io=a(F,"EM",{});var Za=c(io);Gr=n(Za,"encoder-only"),Za.forEach(o),Kr=n(F,`
model.`),F.forEach(o),Wo=d(t),ce=a(t,"P",{});var cr=c(ce);Qr=n(cr,"This model was contributed by "),Pe=a(cr,"A",{href:!0,rel:!0});var ec=c(Pe);Xr=n(ec,"Patrick von Platen"),ec.forEach(o),Yr=n(cr,"."),cr.forEach(o),Vo=d(t),ie=a(t,"P",{});var ir=c(ie);Zr=n(ir,"The original code can be found "),ze=a(ir,"A",{href:!0,rel:!0});var tc=c(ze);en=n(tc,"here"),tc.forEach(o),tn=n(ir,"."),ir.forEach(o),No=d(t),kt=a(t,"P",{});var oc=c(kt);on=n(oc,"Tips:"),oc.forEach(o),Bo=d(t),J=a(t,"UL",{});var Gt=c(J);Ce=a(Gt,"LI",{});var lr=c(Ce);rn=n(lr,`Speech2Text2 achieves state-of-the-art results on the CoVoST Speech Translation dataset. For more information, see
the `),qe=a(lr,"A",{href:!0,rel:!0});var rc=c(qe);nn=n(rc,"official models"),rc.forEach(o),sn=n(lr," ."),lr.forEach(o),an=d(Gt),Ae=a(Gt,"LI",{});var dr=c(Ae);cn=n(dr,"Speech2Text2 is always used within the "),xt=a(dr,"A",{href:!0});var nc=c(xt);ln=n(nc,"SpeechEncoderDecoder"),nc.forEach(o),dn=n(dr," framework."),dr.forEach(o),hn=d(Gt),Me=a(Gt,"LI",{});var hr=c(Me);pn=n(hr,"Speech2Text2\u2019s tokenizer is based on "),bt=a(hr,"EM",{});var Da=c(bt);fn=n(Da,"fastBPE <"),Fe=a(Da,"A",{href:!0,rel:!0});var sc=c(Fe);mn=n(sc,"https://github.com/glample/fastBPE>"),sc.forEach(o),Da.forEach(o),un=n(hr,"."),hr.forEach(o),Gt.forEach(o),Oo=d(t),Z=a(t,"H2",{class:!0});var pr=c(Z);le=a(pr,"A",{id:!0,class:!0,href:!0});var ac=c(le);lo=a(ac,"SPAN",{});var cc=c(lo);u(Le.$$.fragment,cc),cc.forEach(o),ac.forEach(o),_n=d(pr),ho=a(pr,"SPAN",{});var ic=c(ho);gn=n(ic,"Inference"),ic.forEach(o),pr.forEach(o),Uo=d(t),G=a(t,"P",{});var Kt=c(G);vn=n(Kt,"Speech2Text2\u2019s "),St=a(Kt,"A",{href:!0});var lc=c(St);Tn=n(lc,"SpeechEncoderDecoderModel"),lc.forEach(o),kn=n(Kt,` model accepts raw waveform input values from speech and
...
`),Xe=a(R,"A",{href:!0});var Ia=c(Xe);Eo=a(Ia,"STRONG",{});var Uc=c(Eo);qs=n(Uc,"call"),Uc.forEach(o),As=n(Ia,"()"),Ia.forEach(o),Ms=n(R," and "),Wt=a(R,"A",{href:!0});var Rc=c(Wt);Fs=n(Rc,"decode()"),Rc.forEach(o),Ls=n(R,` for
