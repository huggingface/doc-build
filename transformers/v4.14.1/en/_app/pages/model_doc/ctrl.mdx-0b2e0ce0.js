import{S as xc,i as Pc,s as Sc,e as a,k as l,w,t as n,M as jc,c as r,d as t,m as d,a as i,x as L,h as s,b as c,F as e,g as u,y as $,q as R,o as M,B as E}from"../../chunks/vendor-ab4e3193.js";import{T as wt}from"../../chunks/Tip-b5c6375a.js";import{D as Ie}from"../../chunks/Docstring-b69c0bd4.js";import{C as Vt}from"../../chunks/CodeBlock-516df0c5.js";import{I as it}from"../../chunks/IconCopyLink-d992940d.js";import"../../chunks/CopyButton-204b56db.js";function Ic(B){let p,C,m,g,v;return{c(){p=a("p"),C=n(`Although the recipe for forward pass needs to be defined within this function, one should call the
...
`),m=r(_,"CODE",{});var y=i(m);g=s(y,"Module"),y.forEach(t),v=s(_,` instance afterwards instead of this since the former takes care of running the pre and post
processing steps while the latter silently ignores them.`),_.forEach(t)},m(T,_){u(T,p,_),e(p,C),e(p,m),e(m,g),e(p,v)},d(T){T&&t(p)}}}function Nc(B){let p,C,m,g,v;return{c(){p=a("p"),C=n(`Although the recipe for forward pass needs to be defined within this function, one should call the
`),m=a("code"),g=n("Module"),v=n(` instance afterwards instead of this since the former takes care of running the pre and post
processing steps while the latter silently ignores them.`)},l(T){p=r(T,"P",{});var _=i(p);C=s(_,`Although the recipe for forward pass needs to be defined within this function, one should call the
`),m=r(_,"CODE",{});var y=i(m);g=s(y,"Module"),y.forEach(t),v=s(_,` instance afterwards instead of this since the former takes care of running the pre and post
processing steps while the latter silently ignores them.`),_.forEach(t)},m(T,_){u(T,p,_),e(p,C),e(p,m),e(m,g),e(p,v)},d(T){T&&t(p)}}}function Dc(B){let p,C,m,g,v;return{c(){p=a("p"),C=n(`Although the recipe for forward pass needs to be defined within this function, one should call the
`),m=a("code"),g=n("Module"),v=n(` instance afterwards instead of this since the former takes care of running the pre and post
processing steps while the latter silently ignores them.`)},l(T){p=r(T,"P",{});var _=i(p);C=s(_,`Although the recipe for forward pass needs to be defined within this function, one should call the
`),m=r(_,"CODE",{});var y=i(m);g=s(y,"Module"),y.forEach(t),v=s(_,` instance afterwards instead of this since the former takes care of running the pre and post
processing steps while the latter silently ignores them.`),_.forEach(t)},m(T,_){u(T,p,_),e(p,C),e(p,m),e(m,g),e(p,v)},d(T){T&&t(p)}}}function Ac(B){let p,C,m,g,v,T,_,y,me,Q,b,J,A,Y,ge,H,_e,ce,P,S,Z,oe,F,z,Te,U,he,ne,V,pe,se,q,ve,O,ae,ke,W,j,ee,I,te,G,Ce;return{c(){p=a("p"),C=n("TF 2.0 models accepts two formats as inputs:"),m=l(),g=a("ul"),v=a("li"),T=n("having all inputs as keyword arguments (like PyTorch models), or"),_=l(),y=a("li"),me=n("having all inputs as a list, tuple or dict in the first positional arguments."),Q=l(),b=a("p"),J=n("This second option is useful when using "),A=a("code"),Y=n("tf.keras.Model.fit"),ge=n(` method which currently requires having all
...
`),G=r(be,"CODE",{});var Ue=i(G);Ce=s(Ue,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),Ue.forEach(t),be.forEach(t),D.forEach(t)},m(h,k){u(h,p,k),e(p,C),u(h,m,k),u(h,g,k),e(g,v),e(v,T),e(g,_),e(g,y),e(y,me),u(h,Q,k),u(h,b,k),e(b,J),e(b,A),e(A,Y),e(b,ge),e(b,H),e(H,_e),e(b,ce),u(h,P,k),u(h,S,k),e(S,Z),u(h,oe,k),u(h,F,k),e(F,z),e(z,Te),e(z,U),e(U,he),e(z,ne),e(z,V),e(V,pe),e(F,se),e(F,q),e(q,ve),e(q,O),e(O,ae),e(q,ke),e(q,W),e(W,j),e(F,ee),e(F,I),e(I,te),e(I,G),e(G,Ce)},d(h){h&&t(p),h&&t(m),h&&t(g),h&&t(Q),h&&t(b),h&&t(P),h&&t(S),h&&t(oe),h&&t(F)}}}function Hc(B){let p,C,m,g,v;return{c(){p=a("p"),C=n(`Although the recipe for forward pass needs to be defined within this function, one should call the
`),m=a("code"),g=n("Module"),v=n(` instance afterwards instead of this since the former takes care of running the pre and post
processing steps while the latter silently ignores them.`)},l(T){p=r(T,"P",{});var _=i(p);C=s(_,`Although the recipe for forward pass needs to be defined within this function, one should call the
`),m=r(_,"CODE",{});var y=i(m);g=s(y,"Module"),y.forEach(t),v=s(_,` instance afterwards instead of this since the former takes care of running the pre and post
processing steps while the latter silently ignores them.`),_.forEach(t)},m(T,_){u(T,p,_),e(p,C),e(p,m),e(m,g),e(p,v)},d(T){T&&t(p)}}}function Oc(B){let p,C,m,g,v,T,_,y,me,Q,b,J,A,Y,ge,H,_e,ce,P,S,Z,oe,F,z,Te,U,he,ne,V,pe,se,q,ve,O,ae,ke,W,j,ee,I,te,G,Ce;return{c(){p=a("p"),C=n("TF 2.0 models accepts two formats as inputs:"),m=l(),g=a("ul"),v=a("li"),T=n("having all inputs as keyword arguments (like PyTorch models), or"),_=l(),y=a("li"),me=n("having all inputs as a list, tuple or dict in the first positional arguments."),Q=l(),b=a("p"),J=n("This second option is useful when using "),A=a("code"),Y=n("tf.keras.Model.fit"),ge=n(` method which currently requires having all
the tensors in the first argument of the model call function: `),H=a("code"),_e=n("model(inputs)"),ce=n("."),P=l(),S=a("p"),Z=n(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in
the first positional argument :`),oe=l(),F=a("ul"),z=a("li"),Te=n("a single Tensor with "),U=a("code"),he=n("input_ids"),ne=n(" only and nothing else: "),V=a("code"),pe=n("model(inputs_ids)"),se=l(),q=a("li"),ve=n(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),O=a("code"),ae=n("model([input_ids, attention_mask])"),ke=n(" or "),W=a("code"),j=n("model([input_ids, attention_mask, token_type_ids])"),ee=l(),I=a("li"),te=n(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),G=a("code"),Ce=n('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(h){p=r(h,"P",{});var k=i(p);C=s(k,"TF 2.0 models accepts two formats as inputs:"),k.forEach(t),m=d(h),g=r(h,"UL",{});var re=i(g);v=r(re,"LI",{});var Ae=i(v);T=s(Ae,"having all inputs as keyword arguments (like PyTorch models), or"),Ae.forEach(t),_=d(re),y=r(re,"LI",{});var ue=i(y);me=s(ue,"having all inputs as a list, tuple or dict in the first positional arguments."),ue.forEach(t),re.forEach(t),Q=d(h),b=r(h,"P",{});var N=i(b);J=s(N,"This second option is useful when using "),A=r(N,"CODE",{});var Me=i(A);Y=s(Me,"tf.keras.Model.fit"),Me.forEach(t),ge=s(N,` method which currently requires having all
...
the first positional argument :`),Oe.forEach(t),oe=d(h),F=r(h,"UL",{});var D=i(F);z=r(D,"LI",{});var x=i(z);Te=s(x,"a single Tensor with "),U=r(x,"CODE",{});var We=i(U);he=s(We,"input_ids"),We.forEach(t),ne=s(x," only and nothing else: "),V=r(x,"CODE",{});var Ee=i(V);pe=s(Ee,"model(inputs_ids)"),Ee.forEach(t),x.forEach(t),se=d(D),q=r(D,"LI",{});var K=i(q);ve=s(K,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),O=r(K,"CODE",{});var Be=i(O);ae=s(Be,"model([input_ids, attention_mask])"),Be.forEach(t),ke=s(K," or "),W=r(K,"CODE",{});var Fe=i(W);j=s(Fe,"model([input_ids, attention_mask, token_type_ids])"),Fe.forEach(t),K.forEach(t),ee=d(D),I=r(D,"LI",{});var be=i(I);te=s(be,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),G=r(be,"CODE",{});var Ue=i(G);Ce=s(Ue,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),Ue.forEach(t),be.forEach(t),D.forEach(t)},m(h,k){u(h,p,k),e(p,C),u(h,m,k),u(h,g,k),e(g,v),e(v,T),e(g,_),e(g,y),e(y,me),u(h,Q,k),u(h,b,k),e(b,J),e(b,A),e(A,Y),e(b,ge),e(b,H),e(H,_e),e(b,ce),u(h,P,k),u(h,S,k),e(S,Z),u(h,oe,k),u(h,F,k),e(F,z),e(z,Te),e(z,U),e(U,he),e(z,ne),e(z,V),e(V,pe),e(F,se),e(F,q),e(q,ve),e(q,O),e(O,ae),e(q,ke),e(q,W),e(W,j),e(F,ee),e(F,I),e(I,te),e(I,G),e(G,Ce)},d(h){h&&t(p),h&&t(m),h&&t(g),h&&t(Q),h&&t(b),h&&t(P),h&&t(S),h&&t(oe),h&&t(F)}}}function Wc(B){let p,C,m,g,v;return{c(){p=a("p"),C=n(`Although the recipe for forward pass needs to be defined within this function, one should call the
`),m=a("code"),g=n("Module"),v=n(` instance afterwards instead of this since the former takes care of running the pre and post
processing steps while the latter silently ignores them.`)},l(T){p=r(T,"P",{});var _=i(p);C=s(_,`Although the recipe for forward pass needs to be defined within this function, one should call the
`),m=r(_,"CODE",{});var y=i(m);g=s(y,"Module"),y.forEach(t),v=s(_,` instance afterwards instead of this since the former takes care of running the pre and post
processing steps while the latter silently ignores them.`),_.forEach(t)},m(T,_){u(T,p,_),e(p,C),e(p,m),e(m,g),e(p,v)},d(T){T&&t(p)}}}function Bc(B){let p,C,m,g,v,T,_,y,me,Q,b,J,A,Y,ge,H,_e,ce,P,S,Z,oe,F,z,Te,U,he,ne,V,pe,se,q,ve,O,ae,ke,W,j,ee,I,te,G,Ce;return{c(){p=a("p"),C=n("TF 2.0 models accepts two formats as inputs:"),m=l(),g=a("ul"),v=a("li"),T=n("having all inputs as keyword arguments (like PyTorch models), or"),_=l(),y=a("li"),me=n("having all inputs as a list, tuple or dict in the first positional arguments."),Q=l(),b=a("p"),J=n("This second option is useful when using "),A=a("code"),Y=n("tf.keras.Model.fit"),ge=n(` method which currently requires having all
the tensors in the first argument of the model call function: `),H=a("code"),_e=n("model(inputs)"),ce=n("."),P=l(),S=a("p"),Z=n(`If you choose this second option, there are three possibilities you can use to gather all the input Tensors in
the first positional argument :`),oe=l(),F=a("ul"),z=a("li"),Te=n("a single Tensor with "),U=a("code"),he=n("input_ids"),ne=n(" only and nothing else: "),V=a("code"),pe=n("model(inputs_ids)"),se=l(),q=a("li"),ve=n(`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),O=a("code"),ae=n("model([input_ids, attention_mask])"),ke=n(" or "),W=a("code"),j=n("model([input_ids, attention_mask, token_type_ids])"),ee=l(),I=a("li"),te=n(`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),G=a("code"),Ce=n('model({"input_ids": input_ids, "token_type_ids": token_type_ids})')},l(h){p=r(h,"P",{});var k=i(p);C=s(k,"TF 2.0 models accepts two formats as inputs:"),k.forEach(t),m=d(h),g=r(h,"UL",{});var re=i(g);v=r(re,"LI",{});var Ae=i(v);T=s(Ae,"having all inputs as keyword arguments (like PyTorch models), or"),Ae.forEach(t),_=d(re),y=r(re,"LI",{});var ue=i(y);me=s(ue,"having all inputs as a list, tuple or dict in the first positional arguments."),ue.forEach(t),re.forEach(t),Q=d(h),b=r(h,"P",{});var N=i(b);J=s(N,"This second option is useful when using "),A=r(N,"CODE",{});var Me=i(A);Y=s(Me,"tf.keras.Model.fit"),Me.forEach(t),ge=s(N,` method which currently requires having all
...
the first positional argument :`),Oe.forEach(t),oe=d(h),F=r(h,"UL",{});var D=i(F);z=r(D,"LI",{});var x=i(z);Te=s(x,"a single Tensor with "),U=r(x,"CODE",{});var We=i(U);he=s(We,"input_ids"),We.forEach(t),ne=s(x," only and nothing else: "),V=r(x,"CODE",{});var Ee=i(V);pe=s(Ee,"model(inputs_ids)"),Ee.forEach(t),x.forEach(t),se=d(D),q=r(D,"LI",{});var K=i(q);ve=s(K,`a list of varying length with one or several input Tensors IN THE ORDER given in the docstring:
`),O=r(K,"CODE",{});var Be=i(O);ae=s(Be,"model([input_ids, attention_mask])"),Be.forEach(t),ke=s(K," or "),W=r(K,"CODE",{});var Fe=i(W);j=s(Fe,"model([input_ids, attention_mask, token_type_ids])"),Fe.forEach(t),K.forEach(t),ee=d(D),I=r(D,"LI",{});var be=i(I);te=s(be,`a dictionary with one or several input Tensors associated to the input names given in the docstring:
`),G=r(be,"CODE",{});var Ue=i(G);Ce=s(Ue,'model({"input_ids": input_ids, "token_type_ids": token_type_ids})'),Ue.forEach(t),be.forEach(t),D.forEach(t)},m(h,k){u(h,p,k),e(p,C),u(h,m,k),u(h,g,k),e(g,v),e(v,T),e(g,_),e(g,y),e(y,me),u(h,Q,k),u(h,b,k),e(b,J),e(b,A),e(A,Y),e(b,ge),e(b,H),e(H,_e),e(b,ce),u(h,P,k),u(h,S,k),e(S,Z),u(h,oe,k),u(h,F,k),e(F,z),e(z,Te),e(z,U),e(U,he),e(z,ne),e(z,V),e(V,pe),e(F,se),e(F,q),e(q,ve),e(q,O),e(O,ae),e(q,ke),e(q,W),e(W,j),e(F,ee),e(F,I),e(I,te),e(I,G),e(G,Ce)},d(h){h&&t(p),h&&t(m),h&&t(g),h&&t(Q),h&&t(b),h&&t(P),h&&t(S),h&&t(oe),h&&t(F)}}}function Uc(B){let p,C,m,g,v;return{c(){p=a("p"),C=n(`Although the recipe for forward pass needs to be defined within this function, one should call the
`),m=a("code"),g=n("Module"),v=n(` instance afterwards instead of this since the former takes care of running the pre and post
processing steps while the latter silently ignores them.`)},l(T){p=r(T,"P",{});var _=i(p);C=s(_,`Although the recipe for forward pass needs to be defined within this function, one should call the
`),m=r(_,"CODE",{});var y=i(m);g=s(y,"Module"),y.forEach(t),v=s(_,` instance afterwards instead of this since the former takes care of running the pre and post
processing steps while the latter silently ignores them.`),_.forEach(t)},m(T,_){u(T,p,_),e(p,C),e(p,m),e(m,g),e(p,v)},d(T){T&&t(p)}}}function Vc(B){let p,C,m,g,v,T,_,y,me,Q,b,J,A,Y,ge,H,_e,ce,P,S,Z,oe,F,z,Te,U,he,ne,V,pe,se,q,ve,O,ae,ke,W,j,ee,I,te,G,Ce,h,k,re,Ae,ue,N,Me,He,Oe,D,x,We,Ee,K,Be,Fe,be,Ue,Ko,la,da,Cs,Je,ca,Gt,ha,pa,Kt,ua,fa,bs,lt,Lt,wn,Xt,ma,Ln,ga,ys,ye,Jt,_a,Xe,Ta,Xo,va,ka,Jo,Ca,ba,Qt,ya,wa,La,dt,$a,Qo,Ra,Ma,Yo,Ea,Fa,za,$n,qa,xa,Yt,ws,ct,$t,Rn,Zt,Pa,Mn,Sa,Ls,Ne,eo,ja,En,Ia,Na,to,Da,Zo,Aa,Ha,Oa,Fn,$s,ht,Rt,zn,oo,Wa,qn,Ba,Rs,we,no,Ua,xn,Va,Ga,so,Ka,en,Xa,Ja,Qa,ao,Ya,ro,Za,er,tr,ze,io,or,pt,nr,tn,sr,ar,Pn,rr,ir,lr,Mt,dr,Sn,cr,hr,lo,Ms,ut,Et,jn,co,pr,In,ur,Es,Le,ho,fr,Nn,mr,gr,po,_r,on,Tr,vr,kr,uo,Cr,fo,br,yr,wr,qe,mo,Lr,ft,$r,nn,Rr,Mr,Dn,Er,Fr,zr,Ft,qr,An,xr,Pr,go,Fs,mt,zt,Hn,_o,Sr,On,jr,zs,$e,To,Ir,Re,Nr,sn,Dr,Ar,Wn,Hr,Or,Bn,Wr,Br,Un,Ur,Vr,Vn,Gr,Kr,Xr,vo,Jr,an,Qr,Yr,Zr,ko,ei,Co,ti,oi,ni,ie,bo,si,gt,ai,rn,ri,ii,Gn,li,di,ci,qt,hi,Kn,pi,ui,yo,fi,Xn,mi,gi,wo,qs,_t,xt,Jn,Lo,_i,Qn,Ti,xs,le,$o,vi,Yn,ki,Ci,Ro,bi,ln,yi,wi,Li,Mo,$i,Eo,Ri,Mi,Ei,Pt,Fi,xe,Fo,zi,Tt,qi,dn,xi,Pi,Zn,Si,ji,Ii,St,Ni,es,Di,Ai,zo,Ps,vt,jt,ts,qo,Hi,os,Oi,Ss,de,xo,Wi,ns,Bi,Ui,Po,Vi,cn,Gi,Ki,Xi,So,Ji,jo,Qi,Yi,Zi,It,el,Pe,Io,tl,kt,ol,hn,nl,sl,ss,al,rl,il,Nt,ll,as,dl,cl,No,js,Ct,Dt,rs,Do,hl,is,pl,Is,X,Ao,ul,ls,fl,ml,pn,un,gl,_l,Tl,De,vl,ds,kl,Cl,cs,bl,yl,hs,wl,Ll,ps,$l,Rl,Ml,Ho,El,fn,Fl,zl,ql,Oo,xl,Wo,Pl,Sl,jl,At,Il,Se,Bo,Nl,bt,Dl,mn,Al,Hl,us,Ol,Wl,Bl,Ht,Ul,fs,Vl,Gl,Uo,Ns;return T=new it({}),Y=new it({}),Xt=new it({}),Jt=new Ie({props:{name:"class transformers.CTRLConfig",anchor:"transformers.CTRLConfig",parameters:[{name:"vocab_size",val:" = 246534"},{name:"n_positions",val:" = 256"},{name:"n_embd",val:" = 1280"},{name:"dff",val:" = 8192"},{name:"n_layer",val:" = 48"},{name:"n_head",val:" = 16"},{name:"resid_pdrop",val:" = 0.1"},{name:"embd_pdrop",val:" = 0.1"},{name:"attn_pdrop",val:" = 0.1"},{name:"layer_norm_epsilon",val:" = 1e-06"},{name:"initializer_range",val:" = 0.02"},{name:"summary_type",val:" = 'cls_index'"},{name:"summary_use_proj",val:" = True"},{name:"summary_activation",val:" = None"},{name:"summary_proj_to_labels",val:" = True"},{name:"summary_first_dropout",val:" = 0.1"},{name:"use_cache",val:" = True"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/v4.14.1/src/transformers/models/ctrl/configuration_ctrl.py#L26",parametersDescription:[{anchor:"transformers.CTRLConfig.vocab_size",description:`<strong>vocab_size</strong> (<code>int</code>, <em>optional</em>, defaults to 246534) &#x2014;
Vocabulary size of the CTRL model. Defines the number of different tokens that can be represented by the
<code>inputs_ids</code> passed when calling <a href="/docs/transformers/v4.14.1/en/model_doc/ctrl#transformers.CTRLModel">CTRLModel</a> or
<a href="/docs/transformers/v4.14.1/en/model_doc/ctrl#transformers.TFCTRLModel">TFCTRLModel</a>.`,name:"vocab_size"},{anchor:"transformers.CTRLConfig.n_positions",description:`<strong>n_positions</strong> (<code>int</code>, <em>optional</em>, defaults to 256) &#x2014;
...
<p>Indices can be obtained using <a href="/docs/transformers/v4.14.1/en/model_doc/ctrl#transformers.CTRLTokenizer">CTRLTokenizer</a>. See
...
<p>A <a
  href="/docs/transformers/v4.14.1/en/main_classes/output#transformers.modeling_outputs.BaseModelOutputWithPast"
...
various elements depending on the configuration (<a
  href="/docs/transformers/v4.14.1/en/model_doc/ctrl#transformers.CTRLConfig"
...
<p>A <a
  href="/docs/transformers/v4.14.1/en/main_classes/output#transformers.modeling_outputs.CausalLMOutputWithPast"
...
<p>A <a
  href="/docs/transformers/v4.14.1/en/main_classes/output#transformers.modeling_tf_outputs.TFBaseModelOutputWithPast"
...
<p>A <a
  href="/docs/transformers/v4.14.1/en/main_classes/output#transformers.modeling_tf_outputs.TFCausalLMOutputWithPast"
...
<span class="hljs-meta">&gt;&gt;&gt; </span>outputs = model(inputs)
<span class="hljs-meta">&gt;&gt;&gt; </span>loss = outputs.loss
<span class="hljs-meta">&gt;&gt;&gt; </span>logits = outputs.logits`}}),{c(){p=a("meta"),C=l(),m=a("h1"),g=a("a"),v=a("span"),w(T.$$.fragment),_=l(),y=a("span"),me=n("CTRL"),Q=l(),b=a("h2"),J=a("a"),A=a("span"),w(Y.$$.fragment),ge=l(),H=a("span"),_e=n("Overview"),ce=l(),P=a("p"),S=n("CTRL model was proposed in "),Z=a("a"),oe=n("CTRL: A Conditional Transformer Language Model for Controllable Generation"),F=n(" by Nitish Shirish Keskar"),z=a("em"),Te=n(", Bryan McCann"),U=n(`, Lav R. Varshney, Caiming Xiong and
...
`),Kt=a("a"),ua=n("here"),fa=n("."),bs=l(),lt=a("h2"),Lt=a("a"),wn=a("span"),w(Xt.$$.fragment),ma=l(),Ln=a("span"),ga=n("CTRLConfig"),ys=l(),ye=a("div"),w(Jt.$$.fragment),_a=l(),Xe=a("p"),Ta=n("This is the configuration class to store the configuration of a "),Xo=a("a"),va=n("CTRLModel"),ka=n(` or a
...
`),Kt=r(gn,"A",{href:!0,rel:!0});var ld=i(Kt);ua=s(ld,"here"),ld.forEach(t),fa=s(gn,"."),gn.forEach(t),bs=d(o),lt=r(o,"H2",{class:!0});var Hs=i(lt);Lt=r(Hs,"A",{id:!0,class:!0,href:!0});var dd=i(Lt);wn=r(dd,"SPAN",{});var cd=i(wn);L(Xt.$$.fragment,cd),cd.forEach(t),dd.forEach(t),ma=d(Hs),Ln=r(Hs,"SPAN",{});var hd=i(Ln);ga=s(hd,"CTRLConfig"),hd.forEach(t),Hs.forEach(t),ys=d(o),ye=r(o,"DIV",{class:!0});var Qe=i(ye);L(Jt.$$.fragment,Qe),_a=d(Qe),Xe=r(Qe,"P",{});var Bt=i(Xe);Ta=s(Bt,"This is the configuration class to store the configuration of a "),Xo=r(Bt,"A",{href:!0});var pd=i(Xo);va=s(pd,"CTRLModel"),pd.forEach(t),ka=s(Bt,` or a
...
embeddings).`),uc.forEach(t),Ui=d(Ke),Po=r(Ke,"P",{});var na=i(Po);Vi=s(na,"This model inherits from "),cn=r(na,"A",{href:!0});var fc=i(cn);Gi=s(fc,"TFPreTrainedModel"),fc.forEach(t),Ki=s(na,`. Check the superclass documentation for the
generic methods the library implements for all its model (such as downloading or saving, resizing the input
embeddings, pruning heads etc.)`),na.forEach(t),Xi=d(Ke),So=r(Ke,"P",{});var sa=i(So);Ji=s(sa,"This model is also a "),jo=r(sa,"A",{href:!0,rel:!0});var mc=i(jo);Qi=s(mc,"tf.keras.Model"),mc.forEach(t),Yi=s(sa,` subclass. Use
it as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage
and behavior.`),sa.forEach(t),Zi=d(Ke),L(It.$$.fragment,Ke),el=d(Ke),Pe=r(Ke,"DIV",{class:!0});var st=i(Pe);L(Io.$$.fragment,st),tl=d(st),kt=r(st,"P",{});var bn=i(kt);ol=s(bn,"The "),hn=r(bn,"A",{href:!0});var gc=i(hn);nl=s(gc,"TFCTRLLMHeadModel"),gc.forEach(t),sl=s(bn," forward method, overrides the "),ss=r(bn,"CODE",{});var _c=i(ss);al=s(_c,"__call__"),_c.forEach(t),rl=s(bn," special method."),bn.forEach(t),il=d(st),L(Nt.$$.fragment,st),ll=d(st),as=r(st,"P",{});var Tc=i(as);dl=s(Tc,"Example:"),Tc.forEach(t),cl=d(st),L(No.$$.fragment,st),st.forEach(t),Ke.forEach(t),js=d(o),Ct=r(o,"H2",{class:!0});var aa=i(Ct);Dt=r(aa,"A",{id:!0,class:!0,href:!0});var vc=i(Dt);rs=r(vc,"SPAN",{});var kc=i(rs);L(Do.$$.fragment,kc),kc.forEach(t),vc.forEach(t),hl=d(aa),is=r(aa,"SPAN",{});var Cc=i(is);pl=s(Cc,"TFCTRLForSequenceClassification"),Cc.forEach(t),aa.forEach(t),Is=d(o),X=r(o,"DIV",{class:!0});var fe=i(X);L(Ao.$$.fragment,fe),ul=d(fe),ls=r(fe,"P",{});var bc=i(ls);fl=s(bc,"The CTRL Model transformer with a sequence classification head on top (linear layer)."),bc.forEach(t),ml=d(fe),pn=r(fe,"P",{});var Kl=i(pn);un=r(Kl,"A",{href:!0});var yc=i(un);gl=s(yc,"TFCTRLForSequenceClassification"),yc.forEach(t),_l=s(Kl,` uses the last token in order to do the classification, as
other causal models (e.g. GPT-1, GPT-2) do.`),Kl.forEach(t),Tl=d(fe),De=r(fe,"P",{});var at=i(De);vl=s(at,`Since it does classification on the last token, it requires to know the position of the last token. If a
