import{S as vs,i as ws,s as bs,e as n,k as d,w as v,t as r,M as ys,c as a,d as o,m as c,a as s,x as w,h as i,b as l,F as e,g as f,y as b,q as y,o as E,B as S}from"../../chunks/vendor-ab4e3193.js";import{T as Ea}from"../../chunks/Tip-b5c6375a.js";import{D as Ue}from"../../chunks/Docstring-b69c0bd4.js";import{C as uo}from"../../chunks/CodeBlock-516df0c5.js";import{I as pt}from"../../chunks/IconCopyLink-d992940d.js";import"../../chunks/CopyButton-204b56db.js";function Es(O){let m,W,h,_,D;return{c(){m=n("p"),W=r(`Although the recipe for forward pass needs to be defined within this function, one should call the
`),h=n("code"),_=r("Module"),D=r(` instance afterwards instead of this since the former takes care of running the pre and post
processing steps while the latter silently ignores them.`)},l(u){m=a(u,"P",{});var g=s(m);W=i(g,`Although the recipe for forward pass needs to be defined within this function, one should call the
...
instance of <a href="/docs/transformers/v4.14.1/en/model_doc/sew_d#transformers.SEWDForCTC">SEWDForCTC</a>.`,name:"ctc_loss_reduction"},{anchor:"transformers.SEWDConfig.ctc_zero_infinity",description:`<strong>ctc_zero_infinity</strong> (<code>bool</code>, <em>optional</em>, defaults to <code>False</code>) &#x2014;
...
instance of <a href="/docs/transformers/v4.14.1/en/model_doc/sew_d#transformers.SEWDForCTC">SEWDForCTC</a>.`,name:"ctc_zero_infinity"},{anchor:"transformers.SEWDConfig.use_weighted_layer_sum",description:`<strong>use_weighted_layer_sum</strong> (<code>bool</code>, <em>optional</em>, defaults to <code>False</code>) &#x2014;
...
various elements depending on the configuration (<a
  href="/docs/transformers/v4.14.1/en/model_doc/sew_d#transformers.SEWDConfig"
...
Artzi.`),mo.forEach(o),na=c(F),Ne=a(F,"P",{});var fo=s(Ne);aa=i(fo,"This model inherits from "),nt=a(fo,"A",{href:!0});var fs=s(nt);sa=i(fs,"PreTrainedModel"),fs.forEach(o),ra=i(fo,`. Check the superclass documentation for the generic
