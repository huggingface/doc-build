import{S as yi,i as ki,s as Ti,e as s,k as c,w as _,t as r,M as Pi,c as n,d as t,m as l,a,x as b,h as i,b as d,F as e,g as p,y as v,q as w,o as B,B as y}from"../../chunks/vendor-ab4e3193.js";import{T as gs}from"../../chunks/Tip-b5c6375a.js";import{D as V}from"../../chunks/Docstring-b69c0bd4.js";import{C as Do}from"../../chunks/CodeBlock-516df0c5.js";import{I as Te}from"../../chunks/IconCopyLink-d992940d.js";import"../../chunks/CopyButton-204b56db.js";function qi(I){let h,T,g,k,P;return{c(){h=s("p"),T=r(`Although the recipe for forward pass needs to be defined within this function, one should call the
...
processing steps while the latter silently ignores them.`)},l(m){h=n(m,"P",{});var f=a(h);T=i(f,`Although the recipe for forward pass needs to be defined within this function, one should call the
`),g=n(f,"CODE",{});var x=a(g);k=i(x,"Module"),x.forEach(t),P=i(f,` instance afterwards instead of this since the former takes care of running the pre and post
processing steps while the latter silently ignores them.`),f.forEach(t)},m(m,f){p(m,h,f),e(h,T),e(h,g),e(g,k),e(h,P)},d(m){m&&t(h)}}}function Fi(I){let h,T,g,k,P,m,f,x,ms,zt,J,ce,Go,Pe,fs,Wo,_s,xt,le,bs,qe,vs,ws,$t,bo,Bs,Ft,vo,Qo,ys,Ct,wo,ks,Mt,q,ze,Ts,xe,Ps,qs,zs,j,xs,Ho,$s,Fs,Ro,Cs,Ms,Uo,Es,Ss,Vo,As,js,Ns,Jo,Ls,Is,Zo,Os,Ds,$e,Gs,Ko,Ws,Qs,Hs,Fe,Rs,Yo,Us,Vs,Js,Ce,Zs,Me,Ks,Ys,Et,ue,Xs,Ee,en,on,St,Z,he,Xo,Se,tn,et,sn,At,O,Ae,nn,K,an,Bo,rn,dn,je,cn,ln,un,Y,hn,yo,pn,gn,ko,mn,fn,jt,X,pe,ot,Ne,_n,tt,bn,Nt,N,Le,vn,Ie,wn,To,Bn,yn,kn,Oe,Tn,De,Pn,qn,zn,C,Ge,xn,ee,$n,Po,Fn,Cn,st,Mn,En,Sn,ge,An,nt,jn,Nn,We,Lt,oe,me,at,Qe,Ln,rt,In,It,L,He,On,Re,Dn,qo,Gn,Wn,Qn,Ue,Hn,Ve,Rn,Un,Vn,M,Je,Jn,te,Zn,zo,Kn,Yn,it,Xn,ea,oa,fe,ta,dt,sa,na,Ze,Ot,se,_e,ct,Ke,aa,lt,ra,Dt,$,Ye,ia,ut,da,ca,Xe,la,xo,ua,ha,pa,eo,ga,oo,ma,fa,_a,z,to,ba,ne,va,$o,wa,Ba,ht,ya,ka,Ta,be,Pa,pt,qa,za,so,xa,gt,$a,Fa,no,Gt,ae,ve,mt,ao,Ca,ft,Ma,Wt,F,ro,Ea,re,Sa,_t,Aa,ja,bt,Na,La,Ia,io,Oa,Fo,Da,Ga,Wa,co,Qa,lo,Ha,Ra,Ua,E,uo,Va,ie,Ja,Co,Za,Ka,vt,Ya,Xa,er,we,or,wt,tr,sr,ho,Qt,de,Be,Bt,po,nr,yt,ar,Ht,go,D,mo,rr,kt,ir,dr,fo,Rt;return m=new Te({}),Pe=new Te({}),Se=new Te({}),Ae=new V({props:{name:"class transformers.BigBirdPegasusConfig",anchor:"transformers.BigBirdPegasusConfig",parameters:[{name:"vocab_size",val:" = 96103"},{name:"max_position_embeddings",val:" = 4096"},{name:"encoder_layers",val:" = 16"},{name:"encoder_ffn_dim",val:" = 4096"},{name:"encoder_attention_heads",val:" = 16"},{name:"decoder_layers",val:" = 16"},{name:"decoder_ffn_dim",val:" = 4096"},{name:"decoder_attention_heads",val:" = 16"},{name:"encoder_layerdrop",val:" = 0.0"},{name:"decoder_layerdrop",val:" = 0.0"},{name:"use_cache",val:" = True"},{name:"is_encoder_decoder",val:" = True"},{name:"activation_function",val:" = 'gelu_new'"},{name:"d_model",val:" = 1024"},{name:"dropout",val:" = 0.1"},{name:"attention_dropout",val:" = 0.0"},{name:"activation_dropout",val:" = 0.0"},{name:"init_std",val:" = 0.02"},{name:"decoder_start_token_id",val:" = 2"},{name:"classifier_dropout",val:" = 0.0"},{name:"scale_embedding",val:" = True"},{name:"pad_token_id",val:" = 0"},{name:"bos_token_id",val:" = 2"},{name:"eos_token_id",val:" = 1"},{name:"attention_type",val:" = 'block_sparse'"},{name:"block_size",val:" = 64"},{name:"num_random_blocks",val:" = 3"},{name:"use_bias",val:" = False"},{name:"**kwargs",val:""}],source:"https://github.com/huggingface/transformers/blob/v4.14.1/src/transformers/models/bigbird_pegasus/configuration_bigbird_pegasus.py#L31",parametersDescription:[{anchor:"transformers.BigBirdPegasusConfig.vocab_size",description:`<strong>vocab_size</strong> (<code>int</code>, <em>optional</em>, defaults to 96103) &#x2014;
...
<a href="/docs/transformers/v4.14.1/en/main_classes/model#transformers.PreTrainedModel.from_pretrained">from_pretrained()</a> method to load the model weights.`,name:"config"}]}}),Ge=new V({props:{name:"forward",anchor:"transformers.BigBirdPegasusModel.forward",parameters:[{name:"input_ids",val:" = None"},{name:"attention_mask",val:" = None"},{name:"decoder_input_ids",val:" = None"},{name:"decoder_attention_mask",val:" = None"},{name:"head_mask",val:" = None"},{name:"decoder_head_mask",val:" = None"},{name:"cross_attn_head_mask",val:" = None"},{name:"encoder_outputs",val:" = None"},{name:"past_key_values",val:" = None"},{name:"inputs_embeds",val:" = None"},{name:"decoder_inputs_embeds",val:" = None"},{name:"use_cache",val:" = None"},{name:"output_attentions",val:" = None"},{name:"output_hidden_states",val:" = None"},{name:"return_dict",val:" = None"}],source:"https://github.com/huggingface/transformers/blob/v4.14.1/src/transformers/models/bigbird_pegasus/modeling_bigbird_pegasus.py#L2349",parametersDescription:[{anchor:"transformers.BigBirdPegasusModel.forward.input_ids",description:`<strong>input_ids</strong> (<code>torch.LongTensor</code> of shape <code>(batch_size, sequence_length)</code>) &#x2014;
...
various elements depending on the configuration (<a
  href="/docs/transformers/v4.14.1/en/model_doc/bigbird_pegasus#transformers.BigBirdPegasusConfig"
...
`}}),we=new gs({props:{$$slots:{default:[$i]},$$scope:{ctx:I}}}),ho=new Do({props:{code:`from transformers import PegasusTokenizer, BigBirdPegasusForQuestionAnswering
import torch
...
`}}),fo=new Do({props:{code:`from transformers import PegasusTokenizer, BigBirdPegasusForCausalLM
...
<span class="hljs-meta">&gt;&gt;&gt; </span>logits = outputs.logits`}}),{c(){h=s("meta"),T=c(),g=s("h1"),k=s("a"),P=s("span"),_(m.$$.fragment),f=c(),x=s("span"),ms=r("BigBirdPegasus"),zt=c(),J=s("h2"),ce=s("a"),Go=s("span"),_(Pe.$$.fragment),fs=c(),Wo=s("span"),_s=r("Overview"),xt=c(),le=s("p"),bs=r("The BigBird model was proposed in "),qe=s("a"),vs=r("Big Bird: Transformers for Longer Sequences"),ws=r(` by
...
summarization, compared to BERT or RoBERTa.`),$t=c(),bo=s("p"),Bs=r("The abstract from the paper is the following:"),Ft=c(),vo=s("p"),Qo=s("em"),ys=r(`Transformers-based models, such as BERT, have been one of the most successful deep learning models for NLP.
...
outputs. Read the documentation from `),ko=s("a"),mn=r("PretrainedConfig"),fn=r(" for more information."),jt=c(),X=s("h2"),pe=s("a"),ot=s("span"),_(Ne.$$.fragment),_n=c(),tt=s("span"),bn=r("BigBirdPegasusModel"),Nt=c(),N=s("div"),_(Le.$$.fragment),vn=c(),Ie=s("p"),wn=r(`The bare BigBirdPegasus Model outputting raw hidden-states without any specific head on top.
This model inherits from `),To=s("a"),Bn=r("PreTrainedModel"),yn=r(`. Check the superclass documentation for the generic
...
subclass. Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to
general usage and behavior.`),_a=c(),z=s("div"),_(to.$$.fragment),ba=c(),ne=s("p"),va=r("The "),$o=s("a"),wa=r("BigBirdPegasusForSequenceClassification"),Ba=r(" forward method, overrides the "),ht=s("code"),ya=r("__call__"),ka=r(" special method."),Ta=c(),_(be.$$.fragment),Pa=c(),pt=s("p"),qa=r("Example of single-label classification:"),za=c(),_(so.$$.fragment),xa=c(),gt=s("p"),$a=r("Example of multi-label classification:"),Fa=c(),_(no.$$.fragment),Gt=c(),ae=s("h2"),ve=s("a"),mt=s("span"),_(ao.$$.fragment),Ca=c(),ft=s("span"),Ma=r("BigBirdPegasusForQuestionAnswering"),Wt=c(),F=s("div"),_(ro.$$.fragment),Ea=c(),re=s("p"),Sa=r(`BigBirdPegasus Model with a span classification head on top for extractive question-answering tasks like SQuAD (a
...
subclass. Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to
general usage and behavior.`),hs.forEach(t),Ua=l(R),E=n(R,"DIV",{class:!0});var U=a(E);b(uo.$$.fragment,U),Va=l(U),ie=n(U,"P",{});var Io=a(ie);Ja=i(Io,"The "),Co=n(Io,"A",{href:!0});var gi=a(Co);Za=i(gi,"BigBirdPegasusForQuestionAnswering"),gi.forEach(t),Ka=i(Io," forward method, overrides the "),vt=n(Io,"CODE",{});var mi=a(vt);Ya=i(mi,"__call__"),mi.forEach(t),Xa=i(Io," special method."),Io.forEach(t),er=l(U),b(we.$$.fragment,U),or=l(U),wt=n(U,"P",{});var fi=a(wt);tr=i(fi,"Example:"),fi.forEach(t),sr=l(U),b(ho.$$.fragment,U),U.forEach(t),R.forEach(t),Qt=l(o),de=n(o,"H2",{class:!0});var ps=a(de);Be=n(ps,"A",{id:!0,class:!0,href:!0});var _i=a(Be);Bt=n(_i,"SPAN",{});var bi=a(Bt);b(po.$$.fragment,bi),bi.forEach(t),_i.forEach(t),nr=l(ps),yt=n(ps,"SPAN",{});var vi=a(yt);ar=i(vi,"BigBirdPegasusForCausalLM"),vi.forEach(t),ps.forEach(t),Ht=l(o),go=n(o,"DIV",{class:!0});var wi=a(go);D=n(wi,"DIV",{class:!0});var Oo=a(D);b(mo.$$.fragment,Oo),rr=l(Oo),kt=n(Oo,"P",{});var Bi=a(kt);ir=i(Bi,"Example:"),Bi.forEach(t),dr=l(Oo),b(fo.$$.fragment,Oo),Oo.forEach(t),wi.forEach(t),this.h()},h(){d(h,"name","hf:doc:metadata"),d(h,"content",JSON.stringify(Ci)),d(k,"id","bigbirdpegasus"),d(k,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),d(k,"href","#bigbirdpegasus"),d(g,"class","relative group"),d(ce,"id","overview"),d(ce,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),d(ce,"href","#overview"),d(J,"class","relative group"),d(qe,"href","https://arxiv.org/abs/2007.14062"),d(qe,"rel","nofollow"),d(xe,"href","https://huggingface.co/blog/big-bird"),d(xe,"rel","nofollow"),d(Me,"href","https://github.com/huggingface/transformers/blob/master/src/transformers/models/pegasus/tokenization_pegasus.py"),d(Me,"rel","nofollow"),d(Ee,"href","https://github.com/google-research/bigbird"),d(Ee,"rel","nofollow"),d(he,"id","transformers.BigBirdPegasusConfig"),d(he,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),d(he,"href","#transformers.BigBirdPegasusConfig"),d(Z,"class","relative group"),d(Bo,"href","/docs/transformers/v4.14.1/en/model_doc/bigbird_pegasus#transformers.BigBirdPegasusModel"),d(je,"href","https://huggingface.co/google/bigbird-pegasus-large-arxiv"),d(je,"rel","nofollow"),d(yo,"href","/docs/transformers/v4.14.1/en/main_classes/configuration#transformers.PretrainedConfig"),d(ko,"href","/docs/transformers/v4.14.1/en/main_classes/configuration#transformers.PretrainedConfig"),d(O,"class","docstring"),d(pe,"id","transformers.BigBirdPegasusModel"),d(pe,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),d(pe,"href","#transformers.BigBirdPegasusModel"),d(X,"class","relative group"),d(To,"href","/docs/transformers/v4.14.1/en/main_classes/model#transformers.PreTrainedModel"),d(De,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),d(De,"rel","nofollow"),d(Po,"href","/docs/transformers/v4.14.1/en/model_doc/bigbird_pegasus#transformers.BigBirdPegasusModel"),d(C,"class","docstring"),d(N,"class","docstring"),d(me,"id","transformers.BigBirdPegasusForConditionalGeneration"),d(me,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),d(me,"href","#transformers.BigBirdPegasusForConditionalGeneration"),d(oe,"class","relative group"),d(qo,"href","/docs/transformers/v4.14.1/en/main_classes/model#transformers.PreTrainedModel"),d(Ve,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),d(Ve,"rel","nofollow"),d(zo,"href","/docs/transformers/v4.14.1/en/model_doc/bigbird_pegasus#transformers.BigBirdPegasusForConditionalGeneration"),d(M,"class","docstring"),d(L,"class","docstring"),d(_e,"id","transformers.BigBirdPegasusForSequenceClassification"),d(_e,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),d(_e,"href","#transformers.BigBirdPegasusForSequenceClassification"),d(se,"class","relative group"),d(xo,"href","/docs/transformers/v4.14.1/en/main_classes/model#transformers.PreTrainedModel"),d(oo,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),d(oo,"rel","nofollow"),d($o,"href","/docs/transformers/v4.14.1/en/model_doc/bigbird_pegasus#transformers.BigBirdPegasusForSequenceClassification"),d(z,"class","docstring"),d($,"class","docstring"),d(ve,"id","transformers.BigBirdPegasusForQuestionAnswering"),d(ve,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),d(ve,"href","#transformers.BigBirdPegasusForQuestionAnswering"),d(ae,"class","relative group"),d(Fo,"href","/docs/transformers/v4.14.1/en/main_classes/model#transformers.PreTrainedModel"),d(lo,"href","https://pytorch.org/docs/stable/nn.html#torch.nn.Module"),d(lo,"rel","nofollow"),d(Co,"href","/docs/transformers/v4.14.1/en/model_doc/bigbird_pegasus#transformers.BigBirdPegasusForQuestionAnswering"),d(E,"class","docstring"),d(F,"class","docstring"),d(Be,"id","transformers.BigBirdPegasusForCausalLM"),d(Be,"class","header-link block pr-1.5 text-lg no-hover:hidden with-hover:absolute with-hover:p-1.5 with-hover:opacity-0 with-hover:group-hover:opacity-100 with-hover:right-full"),d(Be,"href","#transformers.BigBirdPegasusForCausalLM"),d(de,"class","relative group"),d(D,"class","docstring"),d(go,"class","docstring")},m(o,u){e(document.head,h),p(o,T,u),p(o,g,u),e(g,k),e(k,P),v(m,P,null),e(g,f),e(g,x),e(x,ms),p(o,zt,u),p(o,J,u),e(J,ce),e(ce,Go),v(Pe,Go,null),e(J,fs),e(J,Wo),e(Wo,_s),p(o,xt,u),p(o,le,u),e(le,bs),e(le,qe),e(qe,vs),e(le,ws),p(o,$t,u),p(o,bo,u),e(bo,Bs),p(o,Ft,u),p(o,vo,u),e(vo,Qo),e(Qo,ys),p(o,Ct,u),p(o,wo,u),e(wo,ks),p(o,Mt,u),p(o,q,u),e(q,ze),e(ze,Ts),e(ze,xe),e(xe,Ps),e(ze,qs),e(q,zs),e(q,j),e(j,xs),e(j,Ho),e(Ho,$s),e(j,Fs),e(j,Ro),e(Ro,Cs),e(j,Ms),e(j,Uo),e(Uo,Es),e(j,Ss),e(j,Vo),e(Vo,As),e(j,js),e(q,Ns),e(q,Jo),e(Jo,Ls),e(q,Is),e(q,Zo),e(Zo,Os),e(q,Ds),e(q,$e),e($e,Gs),e($e,Ko),e(Ko,Ws),e($e,Qs),e(q,Hs),e(q,Fe),e(Fe,Rs),e(Fe,Yo),e(Yo,Us),e(Fe,Vs),e(q,Js),e(q,Ce),e(Ce,Zs),e(Ce,Me),e(Me,Ks),e(Ce,Ys),p(o,Et,u),p(o,ue,u),e(ue,Xs),e(ue,Ee),e(Ee,en),e(ue,on),p(o,St,u),p(o,Z,u),e(Z,he),e(he,Xo),v(Se,Xo,null),e(Z,tn),e(Z,et),e(et,sn),p(o,At,u),p(o,O,u),v(Ae,O,null),e(O,nn),e(O,K),e(K,an),e(K,Bo),e(Bo,rn),e(K,dn),e(K,je),e(je,cn),e(K,ln),e(O,un),e(O,Y),e(Y,hn),e(Y,yo),e(yo,pn),e(Y,gn),e(Y,ko),e(ko,mn),e(Y,fn),p(o,jt,u),p(o,X,u),e(X,pe),e(pe,ot),v(Ne,ot,null),e(X,_n),e(X,tt),e(tt,bn),p(o,Nt,u),p(o,N,u),v(Le,N,null),e(N,vn),e(N,Ie),e(Ie,wn),e(Ie,To),e(To,Bn),e(Ie,yn),e(N,kn),e(N,Oe),e(Oe,Tn),e(Oe,De),e(De,Pn),e(Oe,qn),e(N,zn),e(N,C),v(Ge,C,null),e(C,xn),e(C,ee),e(ee,$n),e(ee,Po),e(Po,Fn),e(ee,Cn),e(ee,st),e(st,Mn),e(ee,En),e(C,Sn),v(ge,C,null),e(C,An),e(C,nt),e(nt,jn),e(C,Nn),v(We,C,null),p(o,Lt,u),p(o,oe,u),e(oe,me),e(me,at),v(Qe,at,null),e(oe,Ln),e(oe,rt),e(rt,In),p(o,It,u),p(o,L,u),v(He,L,null),e(L,On),e(L,Re),e(Re,Dn),e(Re,qo),e(qo,Gn),e(Re,Wn),e(L,Qn),e(L,Ue),e(Ue,Hn),e(Ue,Ve),e(Ve,Rn),e(Ue,Un),e(L,Vn),e(L,M),v(Je,M,null),e(M,Jn),e(M,te),e(te,Zn),e(te,zo),e(zo,Kn),e(te,Yn),e(te,it),e(it,Xn),e(te,ea),e(M,oa),v(fe,M,null),e(M,ta),e(M,dt),e(dt,sa),e(M,na),v(Ze,M,null),p(o,Ot,u),p(o,se,u),e(se,_e),e(_e,ct),v(Ke,ct,null),e(se,aa),e(se,lt),e(lt,ra),p(o,Dt,u),p(o,$,u),v(Ye,$,null),e($,ia),e($,ut),e(ut,da),e($,ca),e($,Xe),e(Xe,la),e(Xe,xo),e(xo,ua),e(Xe,ha),e($,pa),e($,eo),e(eo,ga),e(eo,oo),e(oo,ma),e(eo,fa),e($,_a),e($,z),v(to,z,null),e(z,ba),e(z,ne),e(ne,va),e(ne,$o),e($o,wa),e(ne,Ba),e(ne,ht),e(ht,ya),e(ne,ka),e(z,Ta),v(be,z,null),e(z,Pa),e(z,pt),e(pt,qa),e(z,za),v(so,z,null),e(z,xa),e(z,gt),e(gt,$a),e(z,Fa),v(no,z,null),p(o,Gt,u),p(o,ae,u),e(ae,ve),e(ve,mt),v(ao,mt,null),e(ae,Ca),e(ae,ft),e(ft,Ma),p(o,Wt,u),p(o,F,u),v(ro,F,null),e(F,Ea),e(F,re),e(re,Sa),e(re,_t),e(_t,Aa),e(re,ja),e(re,bt),e(bt,Na),e(re,La),e(F,Ia),e(F,io),e(io,Oa),e(io,Fo),e(Fo,Da),e(io,Ga),e(F,Wa),e(F,co),e(co,Qa),e(co,lo),e(lo,Ha),e(co,Ra),e(F,Ua),e(F,E),v(uo,E,null),e(E,Va),e(E,ie),e(ie,Ja),e(ie,Co),e(Co,Za),e(ie,Ka),e(ie,vt),e(vt,Ya),e(ie,Xa),e(E,er),v(we,E,null),e(E,or),e(E,wt),e(wt,tr),e(E,sr),v(ho,E,null),p(o,Qt,u),p(o,de,u),e(de,Be),e(Be,Bt),v(po,Bt,null),e(de,nr),e(de,yt),e(yt,ar),p(o,Ht,u),p(o,go,u),e(go,D),v(mo,D,null),e(D,rr),e(D,kt),e(kt,ir),e(D,dr),v(fo,D,null),Rt=!0},p(o,[u]){const _o={};u&2&&(_o.$$scope={dirty:u,ctx:o}),ge.$set(_o);const Tt={};u&2&&(Tt.$$scope={dirty:u,ctx:o}),fe.$set(Tt);const Pt={};u&2&&(Pt.$$scope={dirty:u,ctx:o}),be.$set(Pt);const qt={};u&2&&(qt.$$scope={dirty:u,ctx:o}),we.$set(qt)},i(o){Rt||(w(m.$$.fragment,o),w(Pe.$$.fragment,o),w(Se.$$.fragment,o),w(Ae.$$.fragment,o),w(Ne.$$.fragment,o),w(Le.$$.fragment,o),w(Ge.$$.fragment,o),w(ge.$$.fragment,o),w(We.$$.fragment,o),w(Qe.$$.fragment,o),w(He.$$.fragment,o),w(Je.$$.fragment,o),w(fe.$$.fragment,o),w(Ze.$$.fragment,o),w(Ke.$$.fragment,o),w(Ye.$$.fragment,o),w(to.$$.fragment,o),w(be.$$.fragment,o),w(so.$$.fragment,o),w(no.$$.fragment,o),w(ao.$$.fragment,o),w(ro.$$.fragment,o),w(uo.$$.fragment,o),w(we.$$.fragment,o),w(ho.$$.fragment,o),w(po.$$.fragment,o),w(mo.$$.fragment,o),w(fo.$$.fragment,o),Rt=!0)},o(o){B(m.$$.fragment,o),B(Pe.$$.fragment,o),B(Se.$$.fragment,o),B(Ae.$$.fragment,o),B(Ne.$$.fragment,o),B(Le.$$.fragment,o),B(Ge.$$.fragment,o),B(ge.$$.fragment,o),B(We.$$.fragment,o),B(Qe.$$.fragment,o),B(He.$$.fragment,o),B(Je.$$.fragment,o),B(fe.$$.fragment,o),B(Ze.$$.fragment,o),B(Ke.$$.fragment,o),B(Ye.$$.fragment,o),B(to.$$.fragment,o),B(be.$$.fragment,o),B(so.$$.fragment,o),B(no.$$.fragment,o),B(ao.$$.fragment,o),B(ro.$$.fragment,o),B(uo.$$.fragment,o),B(we.$$.fragment,o),B(ho.$$.fragment,o),B(po.$$.fragment,o),B(mo.$$.fragment,o),B(fo.$$.fragment,o),Rt=!1},d(o){t(h),o&&t(T),o&&t(g),y(m),o&&t(zt),o&&t(J),y(Pe),o&&t(xt),o&&t(le),o&&t($t),o&&t(bo),o&&t(Ft),o&&t(vo),o&&t(Ct),o&&t(wo),o&&t(Mt),o&&t(q),o&&t(Et),o&&t(ue),o&&t(St),o&&t(Z),y(Se),o&&t(At),o&&t(O),y(Ae),o&&t(jt),o&&t(X),y(Ne),o&&t(Nt),o&&t(N),y(Le),y(Ge),y(ge),y(We),o&&t(Lt),o&&t(oe),y(Qe),o&&t(It),o&&t(L),y(He),y(Je),y(fe),y(Ze),o&&t(Ot),o&&t(se),y(Ke),o&&t(Dt),o&&t($),y(Ye),y(to),y(be),y(so),y(no),o&&t(Gt),o&&t(ae),y(ao),o&&t(Wt),o&&t(F),y(ro),y(uo),y(we),y(ho),o&&t(Qt),o&&t(de),y(po),o&&t(Ht),o&&t(go),y(mo),y(fo)}}}const Ci={local:"bigbirdpegasus",sections:[{local:"overview",title:"Overview"},{local:"transformers.BigBirdPegasusConfig",title:"BigBirdPegasusConfig"},{local:"transformers.BigBirdPegasusModel",title:"BigBirdPegasusModel"},{local:"transformers.BigBirdPegasusForConditionalGeneration",title:"BigBirdPegasusForConditionalGeneration"},{local:"transformers.BigBirdPegasusForSequenceClassification",title:"BigBirdPegasusForSequenceClassification"},{local:"transformers.BigBirdPegasusForQuestionAnswering",title:"BigBirdPegasusForQuestionAnswering"},{local:"transformers.BigBirdPegasusForCausalLM",title:"BigBirdPegasusForCausalLM"}],title:"BigBirdPegasus"};function Mi(I,h,T){let{fw:g}=h;return I.$$set=k=>{"fw"in k&&T(0,g=k.fw)},[g]}class Ii extends yi{constructor(h){super();ki(this,h,Mi,Fi,Ti,{fw:0})}}export{Ii as default,Ci as metadata};
