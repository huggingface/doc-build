import{S as la,i as ca,s as ha,e as s,k as l,w as v,t as o,M as pa,c as a,d as n,m as c,a as i,x as b,h as r,b as d,F as e,g as p,y as k,q as y,o as T,B as w}from"../../chunks/vendor-ab4e3193.js";import{T as da}from"../../chunks/Tip-b5c6375a.js";import{D as gt}from"../../chunks/Docstring-b69c0bd4.js";import{C as Vt}from"../../chunks/CodeBlock-516df0c5.js";import{I as _t}from"../../chunks/IconCopyLink-d992940d.js";import"../../chunks/CopyButton-204b56db.js";function ua(ie){let u,q,f,g,D;return{c(){u=s("p"),q=o(`Although the recipe for forward pass needs to be defined within this function, one should call the
...
processing steps while the latter silently ignores them.`)},l(_){u=a(_,"P",{});var E=i(u);q=r(E,`Although the recipe for forward pass needs to be defined within this function, one should call the
`),f=a(E,"CODE",{});var S=i(f);g=r(S,"Module"),S.forEach(n),D=r(E,` instance afterwards instead of this since the former takes care of running the pre and post
processing steps while the latter silently ignores them.`),E.forEach(n)},m(_,E){p(_,u,E),e(u,q),e(u,f),e(f,g),e(u,D)},d(_){_&&n(u)}}}function ma(ie){let u,q,f,g,D,_,E,S,Dn,Jt,R,Y,vt,de,jn,bt,Sn,Kt,M,Mn,Ue,An,Nn,le,Ln,Fn,Qt,He,In,Xt,Ve,kt,On,Yt,Je,Rn,Zt,Ke,ce,Wn,Qe,Un,Hn,en,he,tn,Xe,pe,Vn,Ye,Jn,Kn,nn,ue,on,Ze,Qn,rn,Z,A,et,Xn,Yn,tt,Zn,eo,yt,to,no,oo,Tt,ro,sn,N,so,fe,ao,io,me,lo,co,an,W,ee,wt,ge,ho,Et,po,dn,$,_e,uo,ve,fo,Bt,mo,go,_o,U,vo,nt,bo,ko,ot,yo,To,wo,zt,Eo,Bo,be,ln,H,te,$t,ke,zo,Gt,$o,cn,j,ye,Go,Te,qo,we,xo,Po,Co,Ee,Do,rt,jo,So,Mo,qt,hn,V,ne,xt,Be,Ao,Pt,No,pn,m,ze,Lo,Ct,Fo,Io,$e,Oo,st,Ro,Wo,Uo,Ge,Ho,qe,Vo,Jo,Ko,xe,Qo,Pe,Xo,Yo,Zo,J,er,at,tr,nr,Ce,or,rr,sr,B,ar,Dt,ir,dr,jt,lr,cr,St,hr,pr,Mt,ur,fr,At,mr,gr,Nt,_r,vr,br,x,De,kr,K,yr,it,Tr,wr,Lt,Er,Br,zr,oe,$r,Ft,Gr,qr,je,un,Q,re,It,Se,xr,Ot,Pr,fn,G,Me,Cr,Ae,Dr,Rt,jr,Sr,Mr,Ne,Ar,dt,Nr,Lr,Fr,Le,Ir,Fe,Or,Rr,Wr,P,Ie,Ur,X,Hr,lt,Vr,Jr,Wt,Kr,Qr,Xr,se,Yr,Ut,Zr,es,Oe,mn;return _=new _t({}),de=new _t({}),he=new Vt({props:{code:`# leverage checkpoints for Bert2Bert model...
...
<span class="hljs-meta">&gt;&gt;&gt; </span>prediction_logits = outputs.logits`}}),{c(){u=s("meta"),q=l(),f=s("h1"),g=s("a"),D=s("span"),v(_.$$.fragment),E=l(),S=s("span"),Dn=o("BertGeneration"),Jt=l(),R=s("h2"),Y=s("a"),vt=s("span"),v(de.$$.fragment),jn=l(),bt=s("span"),Sn=o("Overview"),Kt=l(),M=s("p"),Mn=o(`The BertGeneration model is a BERT model that can be leveraged for sequence-to-sequence tasks using
...
BERT checkpoints for subsequent fine-tuning.`),en=l(),v(he.$$.fragment),tn=l(),Xe=s("ul"),pe=s("li"),Vn=o("Pretrained "),Ye=s("a"),Jn=o("EncoderDecoderModel"),Kn=o(" are also directly available in the model hub, e.g.,"),nn=l(),v(ue.$$.fragment),on=l(),Ze=s("p"),Qn=o("Tips:"),rn=l(),Z=s("ul"),A=s("li"),et=s("a"),Xn=o("BertGenerationEncoder"),Yn=o(" and "),tt=s("a"),Zn=o("BertGenerationDecoder"),eo=o(` should be used in
...
Users should refer to this superclass for more information regarding those methods.`),Mo=l(),qt=s("div"),hn=l(),V=s("h2"),ne=s("a"),xt=s("span"),v(Be.$$.fragment),Ao=l(),Pt=s("span"),No=o("BertGenerationEncoder"),pn=l(),m=s("div"),v(ze.$$.fragment),Lo=l(),Ct=s("p"),Fo=o("The bare BertGeneration model transformer outputting raw hidden-states without any specific head on top."),Io=l(),$e=s("p"),Oo=o("This model inherits from "),st=s("a"),Ro=o("PreTrainedModel"),Wo=o(`. Check the superclass documentation for the generic
...
argument and `),Mt=s("code"),ur=o("add_cross_attention"),fr=o(" set to "),At=s("code"),mr=o("True"),gr=o("; an "),Nt=s("code"),_r=o("encoder_hidden_states"),vr=o(` is then expected as an
input to the forward pass.`),br=l(),x=s("div"),v(De.$$.fragment),kr=l(),K=s("p"),yr=o("The "),it=s("a"),Tr=o("BertGenerationEncoder"),wr=o(" forward method, overrides the "),Lt=s("code"),Er=o("__call__"),Br=o(" special method."),zr=l(),v(oe.$$.fragment),$r=l(),Ft=s("p"),Gr=o("Example:"),qr=l(),v(je.$$.fragment),un=l(),Q=s("h2"),re=s("a"),It=s("span"),v(Se.$$.fragment),xr=l(),Ot=s("span"),Pr=o("BertGenerationDecoder"),fn=l(),G=s("div"),v(Me.$$.fragment),Cr=l(),Ae=s("p"),Dr=o("BertGeneration Model with a "),Rt=s("em"),jr=o("language modeling"),Sr=o(" head on top for CLM fine-tuning."),Mr=l(),Ne=s("p"),Ar=o("This model inherits from "),dt=s("a"),Nr=o("PreTrainedModel"),Lr=o(`. Check the superclass documentation for the generic
methods the library implements for all its model (such as downloading or saving, resizing the input embeddings,
pruning heads etc.)`),Fr=l(),Le=s("p"),Ir=o("This model is also a PyTorch "),Fe=s("a"),Or=o("torch.nn.Module"),Rr=o(`
subclass. Use it as a regular PyTorch Module and refer to the PyTorch documentation for all matter related to
general usage and behavior.`),Wr=l(),P=s("div"),v(Ie.$$.fragment),Ur=l(),X=s("p"),Hr=o("The "),lt=s("a"),Vr=o("BertGenerationDecoder"),Jr=o(" forward method, overrides the "),Wt=s("code"),Kr=o("__call__"),Qr=o(" special method."),Xr=l(),v(se.$$.fragment),Yr=l(),Ut=s("p"),Zr=o("Example:"),es=l(),v(Oe.$$.fragment),this.h()},l(t){const h=pa('[data-svelte="svelte-1phssyn"]',document.head);u=a(h,"META",{name:!0,content:!0}),h.forEach(n),q=c(t),f=a(t,"H1",{class:!0});var Re=i(f);g=a(Re,"A",{id:!0,class:!0,href:!0});var Ht=i(g);D=a(Ht,"SPAN",{});var ts=i(D);b(_.$$.fragment,ts),ts.forEach(n),Ht.forEach(n),E=c(Re),S=a(Re,"SPAN",{});var ns=i(S);Dn=r(ns,"BertGeneration"),ns.forEach(n),Re.forEach(n),Jt=c(t),R=a(t,"H2",{class:!0});var gn=i(R);Y=a(gn,"A",{id:!0,class:!0,href:!0});var os=i(Y);vt=a(os,"SPAN",{});var rs=i(vt);b(de.$$.fragment,rs),rs.forEach(n),os.forEach(n),jn=c(gn),bt=a(gn,"SPAN",{});var ss=i(bt);Sn=r(ss,"Overview"),ss.forEach(n),gn.forEach(n),Kt=c(t),M=a(t,"P",{});var ct=i(M);Mn=r(ct,`The BertGeneration model is a BERT model that can be leveraged for sequence-to-sequence tasks using
