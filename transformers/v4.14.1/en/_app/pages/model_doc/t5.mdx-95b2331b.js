import{S as Vy,i as Ky,s as Yy,e as o,k as d,w as f,t as r,M as Zy,c as s,d as t,m as l,a,x as _,h as i,b as c,F as e,g as p,y as g,q as T,o as v,B as k}from"../../chunks/vendor-ab4e3193.js";import{T as xt}from"../../chunks/Tip-b5c6375a.js";import{D as P}from"../../chunks/Docstring-b69c0bd4.js";import{C as se}from"../../chunks/CodeBlock-516df0c5.js";import{I as pe}from"../../chunks/IconCopyLink-d992940d.js";import"../../chunks/CopyButton-204b56db.js";function Jy(L){let u,z,b,y,$;return{c(){u=o("p"),z=r(`Although the recipe for forward pass needs to be defined within this function, one should call the
...
it as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage
and behavior.`),Wv=d(),f(to.$$.fragment),Hv=d(),et=o("div"),f(Ta.$$.fragment),Rv=d(),_n=o("p"),Vv=r("The "),qr=o("a"),Kv=r("TFT5ForConditionalGeneration"),Yv=r(" forward method, overrides the "),yl=o("code"),Zv=r("__call__"),Jv=r(" special method."),Xv=d(),f(no.$$.fragment),Qv=d(),xl=o("p"),e1=r("Examples:"),t1=d(),f(va.$$.fragment),Yc=d(),gn=o("h2"),oo=o("a"),$l=o("span"),f(ka.$$.fragment),n1=d(),zl=o("span"),o1=r("TFT5EncoderModel"),Zc=d(),ce=o("div"),f(ba.$$.fragment),s1=d(),El=o("p"),a1=r("The bare T5 Model transformer outputting encoder\u2019s raw hidden-stateswithout any specific head on top."),r1=d(),wa=o("p"),i1=r("The T5 model was proposed in "),ya=o("a"),d1=r("Exploring the Limits of Transfer Learning with a Unified Text-to-Text Transformer"),l1=r(` by Colin Raffel, Noam Shazeer, Adam Roberts, Katherine Lee, Sharan Narang,
Michael Matena, Yanqi Zhou, Wei Li, Peter J. Liu. It\u2019s an encoder decoder transformer pre-trained in a text-to-text
...
language modeling head on top of the decoder.`),sp.forEach(t),pc=l(n),er=s(n,"UL",{});var m5=a(er);Zt=s(m5,"LI",{});var Lr=a(Zt);zi=s(Lr,"P",{});var f5=a(zi);Yh=i(f5,"Unsupervised denoising training"),f5.forEach(t),Zh=l(Lr),Te=s(Lr,"P",{});var st=a(Te);Jh=i(st,"In this setup, spans of the input sequence are masked by so-called sentinel tokens ("),Ei=s(st,"EM",{});var _5=a(Ei);Xh=i(_5,"a.k.a"),_5.forEach(t),Qh=i(st,` unique mask tokens) and
...
`),Ki=s(at,"CODE",{});var G5=a(Ki);Yu=i(G5,"attention_mask"),G5.forEach(t),Zu=i(at,` as additional input to the model, which makes sure that padding tokens of the inputs are
ignored. The code example below illustrates all of this.`),at.forEach(t),vc=l(n),_(qo.$$.fragment,n),kc=l(n),or=s(n,"P",{});var B5=a(or);Ju=i(B5,"Additional training tips:"),B5.forEach(t),bc=l(n),jt=s(n,"UL",{});var Sr=a(jt);Yi=s(Sr,"LI",{});var U5=a(Yi);Fo=s(U5,"P",{});var ip=a(Fo);Xu=i(ip,"T5 models need a slightly higher learning rate than the default one set in the "),Zi=s(ip,"CODE",{});var W5=a(Zi);Qu=i(W5,"Trainer"),W5.forEach(t),em=i(ip,` when using the AdamW
optimizer. Typically, 1e-4 and 3e-4 work well for most problems (classification, summarization, translation, question
answering, question generation). Note that T5 was pre-trained using the AdaFactor optimizer.`),ip.forEach(t),U5.forEach(t),tm=l(Sr),Ji=s(Sr,"LI",{});var H5=a(Ji);Jt=s(H5,"P",{});var Dr=a(Jt);nm=i(Dr,"According to "),Mo=s(Dr,"A",{href:!0,rel:!0});var R5=a(Mo);om=i(R5,"this forum post"),R5.forEach(t),sm=i(Dr,`, task prefixes matter when
(1) doing multi-task training (2) your task is similar or related to one of the supervised tasks used in T5\u2019s
...
batches to the longest example is not recommended on TPU as it triggers a recompilation for every batch shape that is
encountered during training thus significantly slowing down the training. only padding up to the longest example in a
batch) leads to very slow training on TPU.`),dp.forEach(t),K5.forEach(t),Sr.forEach(t),wc=l(n),sr=s(n,"A",{id:!0}),a(sr).forEach(t),yc=l(n),Xt=s(n,"H2",{class:!0});var lp=a(Xt);Fn=s(lp,"A",{id:!0,class:!0,href:!0});var Z5=a(Fn);ed=s(Z5,"SPAN",{});var J5=a(ed);_(Ao.$$.fragment,J5),J5.forEach(t),Z5.forEach(t),pm=l(lp),td=s(lp,"SPAN",{});var X5=a(td);hm=i(X5,"Inference"),X5.forEach(t),lp.forEach(t),xc=l(n),ft=s(n,"P",{});var uo=a(ft);um=i(uo,"At inference time, it is recommended to use "),ar=s(uo,"A",{href:!0});var Q5=a(ar);mm=i(Q5,"generate()"),Q5.forEach(t),fm=i(uo,`. This
method takes care of encoding the input and feeding the encoded hidden states via cross-attention layers to the decoder
...
you to easily fine-tune T5 on custom data for summarization/translation.`),_t.forEach(t),mb.forEach(t),pp.forEach(t),Cc=l(n),tn=s(n,"H2",{class:!0});var hp=a(tn);Cn=s(hp,"A",{id:!0,class:!0,href:!0});var kb=a(Cn);ld=s(kb,"SPAN",{});var bb=a(ld);_(Vo.$$.fragment,bb),bb.forEach(t),kb.forEach(t),Zm=l(hp),cd=s(hp,"SPAN",{});var wb=a(cd);Jm=i(wb,"T5Config"),wb.forEach(t),hp.forEach(t),Ac=l(n),kt=s(n,"DIV",{class:!0});var Gr=a(kt);_(Ko.$$.fragment,Gr),Xm=l(Gr),bt=s(Gr,"P",{});var mo=a(bt);Qm=i(mo,"This is the configuration class to store the configuration of a "),cr=s(mo,"A",{href:!0});var yb=a(cr);ef=i(yb,"T5Model"),yb.forEach(t),tf=i(mo,` or a
...
outputs. Read the documentation from `),ur=s(Br,"A",{href:!0});var Eb=a(ur);pf=i(Eb,"PretrainedConfig"),Eb.forEach(t),hf=i(Br," for more information."),Br.forEach(t),Gr.forEach(t),Nc=l(n),on=s(n,"H2",{class:!0});var up=a(on);An=s(up,"A",{id:!0,class:!0,href:!0});var jb=a(An);pd=s(jb,"SPAN",{});var qb=a(pd);_(Zo.$$.fragment,qb),qb.forEach(t),jb.forEach(t),uf=l(up),hd=s(up,"SPAN",{});var Fb=a(hd);mf=i(Fb,"T5Tokenizer"),Fb.forEach(t),up.forEach(t),Lc=l(n),Z=s(n,"DIV",{class:!0});var ze=a(Z);_(Jo.$$.fragment,ze),ff=l(ze),Xo=s(ze,"P",{});var mp=a(Xo);_f=i(mp,"Construct a T5 tokenizer. Based on "),Qo=s(mp,"A",{href:!0,rel:!0});var Mb=a(Qo);gf=i(Mb,"SentencePiece"),Mb.forEach(t),Tf=i(mp,"."),mp.forEach(t),vf=l(ze),es=s(ze,"P",{});var fp=a(es);kf=i(fp,"This tokenizer inherits from "),mr=s(fp,"A",{href:!0});var Pb=a(mr);bf=i(Pb,"PreTrainedTokenizer"),Pb.forEach(t),wf=i(fp,` which contains most of the main methods.
...
use of token type ids, therefore a list of zeros is returned.`),Sb.forEach(t),bp.forEach(t),Rf=l(ze),vd=s(ze,"DIV",{class:!0}),a(vd).forEach(t),ze.forEach(t),Ic=l(n),sn=s(n,"H2",{class:!0});var wp=a(sn);In=s(wp,"A",{id:!0,class:!0,href:!0});var Db=a(In);kd=s(Db,"SPAN",{});var Ob=a(kd);_(ds.$$.fragment,Ob),Ob.forEach(t),Db.forEach(t),Vf=l(wp),bd=s(wp,"SPAN",{});var Gb=a(bd);Kf=i(Gb,"T5TokenizerFast"),Gb.forEach(t),wp.forEach(t),Sc=l(n),Be=s(n,"DIV",{class:!0});var It=a(Be);_(ls.$$.fragment,It),Yf=l(It),an=s(It,"P",{});var Wr=a(an);Zf=i(Wr,"Construct a \u201Cfast\u201D T5 tokenizer (backed by HuggingFace\u2019s "),wd=s(Wr,"EM",{});var Bb=a(wd);Jf=i(Bb,"tokenizers"),Bb.forEach(t),Xf=i(Wr," library). Based on "),cs=s(Wr,"A",{href:!0,rel:!0});var Ub=a(cs);Qf=i(Ub,"Unigram"),Ub.forEach(t),e_=i(Wr,"."),Wr.forEach(t),t_=l(It),ps=s(It,"P",{});var yp=a(ps);n_=i(yp,"This tokenizer inherits from "),gr=s(yp,"A",{href:!0});var Wb=a(gr);o_=i(Wb,"PreTrainedTokenizerFast"),Wb.forEach(t),s_=i(yp,` which contains most of the main
...
use of token type ids, therefore a list of zeros is returned.`),Kb.forEach(t),$p.forEach(t),It.forEach(t),Dc=l(n),rn=s(n,"H2",{class:!0});var zp=a(rn);Dn=s(zp,"A",{id:!0,class:!0,href:!0});var Yb=a(Dn);Ed=s(Yb,"SPAN",{});var Zb=a(Ed);_(fs.$$.fragment,Zb),Zb.forEach(t),Yb.forEach(t),g_=l(zp),jd=s(zp,"SPAN",{});var Jb=a(jd);T_=i(Jb,"T5Model"),Jb.forEach(t),zp.forEach(t),Oc=l(n),J=s(n,"DIV",{class:!0});var Ee=a(J);_(_s.$$.fragment,Ee),v_=l(Ee),qd=s(Ee,"P",{});var Xb=a(qd);k_=i(Xb,"The bare T5 Model transformer outputting raw hidden-states without any specific head on top."),Xb.forEach(t),b_=l(Ee),gs=s(Ee,"P",{});var Ep=a(gs);w_=i(Ep,"The T5 model was proposed in "),Ts=s(Ep,"A",{href:!0,rel:!0});var Qb=a(Ts);y_=i(Qb,"Exploring the Limits of Transfer Learning with a Unified Text-to-Text Transformer"),Qb.forEach(t),x_=i(Ep,` by Colin Raffel, Noam Shazeer, Adam Roberts, Katherine Lee, Sharan Narang,
Michael Matena, Yanqi Zhou, Wei Li, Peter J. Liu. It\u2019s an encoder decoder transformer pre-trained in a text-to-text
...
it as a regular TF 2.0 Keras Model and refer to the TF 2.0 documentation for all matter related to general usage
and behavior.`),Zp.forEach(t),Wv=l(it),_(to.$$.fragment,it),Hv=l(it),et=s(it,"DIV",{class:!0});var Ht=a(et);_(Ta.$$.fragment,Ht),Rv=l(Ht),_n=s(Ht,"P",{});var Zr=a(_n);Vv=i(Zr,"The "),qr=s(Zr,"A",{href:!0});var Ty=a(qr);Kv=i(Ty,"TFT5ForConditionalGeneration"),Ty.forEach(t),Yv=i(Zr," forward method, overrides the "),yl=s(Zr,"CODE",{});var vy=a(yl);Zv=i(vy,"__call__"),vy.forEach(t),Jv=i(Zr," special method."),Zr.forEach(t),Xv=l(Ht),_(no.$$.fragment,Ht),Qv=l(Ht),xl=s(Ht,"P",{});var ky=a(xl);e1=i(ky,"Examples:"),ky.forEach(t),t1=l(Ht),_(va.$$.fragment,Ht),Ht.forEach(t),it.forEach(t),Yc=l(n),gn=s(n,"H2",{class:!0});var Jp=a(gn);oo=s(Jp,"A",{id:!0,class:!0,href:!0});var by=a(oo);$l=s(by,"SPAN",{});var wy=a($l);_(ka.$$.fragment,wy),wy.forEach(t),by.forEach(t),n1=l(Jp),zl=s(Jp,"SPAN",{});var yy=a(zl);o1=i(yy,"TFT5EncoderModel"),yy.forEach(t),Jp.forEach(t),Zc=l(n),ce=s(n,"DIV",{class:!0});var dt=a(ce);_(ba.$$.fragment,dt),s1=l(dt),El=s(dt,"P",{});var xy=a(El);a1=i(xy,"The bare T5 Model transformer outputting encoder\u2019s raw hidden-stateswithout any specific head on top."),xy.forEach(t),r1=l(dt),wa=s(dt,"P",{});var Xp=a(wa);i1=i(Xp,"The T5 model was proposed in "),ya=s(Xp,"A",{href:!0,rel:!0});var $y=a(ya);d1=i($y,"Exploring the Limits of Transfer Learning with a Unified Text-to-Text Transformer"),$y.forEach(t),l1=i(Xp,` by Colin Raffel, Noam Shazeer, Adam Roberts, Katherine Lee, Sharan Narang,
Michael Matena, Yanqi Zhou, Wei Li, Peter J. Liu. It\u2019s an encoder decoder transformer pre-trained in a text-to-text
